...
module FAU ( 
  ...
  assign new_n74_ = (~x26 | (new_n59_ & new_n75_ & ~x24 & ~x25)) & (~new_n71_ | ~new_n75_ | x24 | x25 | x26);
  assign new_n75_ = ~x22 & ~x23;
  assign z08 = (x20 & (x18 | (x16 & x27))) | (~x18 & (x16 ? ~new_n77_ : ~x07));
  assign new_n77_ = (~x27 | (new_n78_ & new_n79_)) & (~new_n60_ | ~new_n80_);
  ...
  assign new_n82_ = new_n63_ & (x18 | (new_n66_ & new_n83_ & ~x26 & ~x27));
  assign new_n83_ = ~x24 & ~x25;
  assign new_n84_ = new_n60_ & new_n83_ & ~x23 & ~x26 & ~x27 & ~x28;
  assign z10 = (x20 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n86_ : ~x05));
  assign new_n86_ = (~x29 | (new_n88_ & new_n89_)) & (~new_n87_ | ~new_n90_);
  ...
  assign z11 = (x20 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n92_ : ~x04));
  assign new_n92_ = (~x30 | (new_n88_ & new_n90_)) & (~new_n87_ | ~new_n93_ | ~new_n94_);
  assign new_n93_ = ~x24 & ~x25 & ~x26;
  assign new_n94_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n101_ | (~x18 & (x16 ? (new_n96_ | new_n99_) : ~x03));
  assign new_n96_ = x31 & (~new_n98_ | ~new_n97_ | x28 | x29 | x30);
  assign new_n97_ = ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n99_ = new_n63_ & new_n67_ & new_n97_ & new_n100_;
  assign new_n100_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = x20 & (x18 | (x16 & x31));
  assign z13 = new_n107_ | (~x18 & (x16 ? (new_n103_ | new_n104_) : ~x02));
  assign new_n103_ = x32 & (~new_n98_ | ~new_n97_ | ~new_n100_);
  assign new_n104_ = new_n63_ & new_n67_ & new_n105_ & new_n106_;
  assign new_n105_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n107_ = x20 & (x18 | (x16 & x32));
  assign z14 = (x16 & (new_n109_ | (new_n70_ & new_n111_))) | x18 | (~x01 & ~x16);
  assign new_n109_ = x33 & (~new_n63_ | (~x18 & (~new_n110_ | ~new_n66_ | ~new_n93_)));
  ...
  assign new_n115_ = x34 & (~new_n59_ | ~new_n72_ | ~new_n112_ | ~new_n113_);
  assign new_n116_ = new_n71_ & new_n72_ & new_n112_ & new_n117_;
