...
module FAU ( 
  ...
  assign new_n70_ = new_n62_ & (x18 | (new_n71_ & ~x22 & ~x23 & ~x24));
  assign new_n71_ = ~x20 & ~x21;
  assign new_n72_ = new_n57_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (~new_n74_ & x16) | x18 | (~x08 & ~x16);
  assign new_n74_ = (~x26 | (new_n62_ & (new_n75_ | x18))) & (~new_n76_ | ~new_n62_ | ~new_n71_);
  assign new_n75_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x16 ? (~new_n78_ & ~x18) : (~x07 | x18);
  assign new_n78_ = (~x27 | (new_n56_ & (new_n79_ | x19))) & (~new_n80_ | ~new_n81_);
  ...
  assign new_n83_ = new_n62_ & (x18 | (new_n66_ & new_n84_));
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n85_ = new_n80_ & new_n86_;
  assign new_n86_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x16 ? (~x18 & (new_n88_ | (new_n90_ & new_n63_))) : (~x05 | x18);
  assign new_n88_ = x29 & (~new_n56_ | (~x19 & (~new_n68_ | ~new_n89_)));
  ...
  assign new_n93_ = new_n56_ & (x19 | (new_n68_ & new_n91_ & ~x25 & ~x26));
  ...
  assign new_n103_ = x32 & (~new_n62_ | (~x18 & (~new_n75_ | ~new_n104_)));
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n56_ & new_n68_ & new_n89_ & new_n106_;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x16 ? (~x18 & (new_n108_ | (new_n72_ & new_n110_))) : (~x01 | x18);
  assign new_n108_ = x33 & (~new_n56_ | (~x19 & (~new_n79_ | ~new_n109_)));
  assign new_n109_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n110_ = new_n111_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n111_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x16 ? (~x18 & (new_n113_ | (new_n72_ & new_n114_))) : (~x00 | x18);
  assign new_n113_ = x34 & (~new_n56_ | (~x19 & (~new_n79_ | ~new_n91_ | ~new_n111_)));
