...
module FAU ( 
  ...
  assign z05 = (x24 & (new_n63_ | ~new_n57_)) | ~x16 | (new_n57_ & new_n65_) | x18;
  ...
  assign z09 = ~x16 | (new_n75_ & new_n80_) | x18 | (~new_n79_ & x28);
  ...
  assign new_n94_ = new_n57_ & new_n65_;
  assign new_n95_ = new_n57_ & ((new_n72_ & new_n96_) | x19);
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n97_ = new_n83_ & ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~new_n99_ & x33) | ~x16 | x18 | (new_n68_ & new_n101_);
  assign new_n99_ = new_n57_ & ((new_n77_ & new_n100_) | x19);
  assign new_n100_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n101_ = new_n102_ & new_n76_ & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & (new_n104_ | (new_n68_ & new_n105_)));
