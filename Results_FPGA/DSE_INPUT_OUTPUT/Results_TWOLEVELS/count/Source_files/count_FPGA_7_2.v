...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n67_ | new_n69_)) | x08 | x18 | (~x09 & ~x16);
  ...
  assign z07 = ~new_n72_ | (x26 & (~new_n58_ | (~new_n74_ & ~x19)));
  assign new_n72_ = ~x08 & x16 & ~x18 & (~new_n59_ | ~new_n70_ | ~new_n73_);
  ...
  assign z09 = x18 | (~x08 & (x16 ? (new_n81_ | new_n83_) : ~x06));
  assign new_n81_ = x28 & (~new_n58_ | (~x19 & (~new_n82_ | ~new_n70_ | x21)));
  assign new_n82_ = ~x26 & ~x27 & ~x24 & ~x25;
  assign new_n83_ = new_n78_ & new_n84_;
  assign new_n84_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x08 & (x16 ? (new_n86_ | new_n88_) : ~x05));
  assign new_n86_ = x29 & (~new_n58_ | (~x19 & (~new_n68_ | ~new_n87_)));
  assign new_n87_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n88_ = new_n89_ & new_n73_ & new_n90_;
  assign new_n89_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n90_ = ~x27 & ~x28 & ~x29;
  assign z11 = ~new_n95_ | (x16 & (new_n93_ | (~new_n92_ & x30)));
  assign new_n92_ = new_n58_ & (x19 | (new_n68_ & new_n90_ & ~x25 & ~x26));
  assign new_n93_ = new_n89_ & new_n73_ & new_n94_ & ~x27 & ~x28;
  assign new_n94_ = ~x29 & ~x30;
  assign new_n95_ = ~x08 & ~x18 & (x04 | x16);
  assign z12 = ~new_n100_ | (x16 & (new_n98_ | (x31 & (new_n97_ | ~new_n58_))));
  assign new_n97_ = ~x19 & (~new_n74_ | x26 | x27 | ~new_n94_ | x28);
  assign new_n98_ = new_n58_ & new_n68_ & new_n99_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n100_ = ~x08 & ~x18 & (x03 | x16);
  assign z13 = x18 | (~x08 & (x16 ? (new_n102_ | new_n104_) : ~x02));
  assign new_n102_ = x32 & (~new_n58_ | (~x19 & (~new_n74_ | ~new_n103_)));
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n104_ = new_n58_ & new_n68_ & new_n87_ & new_n94_ & ~x31 & ~x32;
  assign z14 = ~new_n110_ | (x16 & ((~new_n106_ & x33) | (new_n69_ & new_n108_)));
  assign new_n106_ = new_n58_ & (x19 | (new_n77_ & new_n107_));
  assign new_n107_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n108_ = new_n109_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n109_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n110_ = ~x08 & ~x18 & (x01 | x16);
  assign z15 = ~new_n115_ | (x16 & (new_n112_ | (new_n69_ & new_n113_)));
  assign new_n112_ = x34 & (~new_n58_ | (~x19 & (~new_n77_ | ~new_n90_ | ~new_n109_)));
  assign new_n113_ = new_n114_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n114_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n115_ = ~x08 & ~x18 & (x00 | x16);
endmodule
