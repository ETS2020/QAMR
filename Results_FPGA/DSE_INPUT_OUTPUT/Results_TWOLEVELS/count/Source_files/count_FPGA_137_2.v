...
module FAU ( 
  ...
  assign new_n104_ = x33 & (~new_n56_ | (~x19 & (~new_n72_ | ~new_n101_)));
  assign new_n105_ = new_n57_ & new_n69_ & new_n106_ & new_n107_;
  assign new_n106_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n108_ = x32 & (x18 | (x16 & x33));
  assign z15 = new_n114_ | (~x18 & (x16 ? (new_n110_ | new_n112_) : ~x00));
  assign new_n110_ = x34 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n111_)));
  assign new_n111_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x33;
  assign new_n112_ = new_n57_ & new_n69_ & new_n106_ & new_n113_;
  assign new_n113_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n114_ = x32 & (x18 | (x16 & x34));
endmodule
