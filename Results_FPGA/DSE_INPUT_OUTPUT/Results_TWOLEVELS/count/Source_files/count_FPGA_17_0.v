...
module FAU ( 
  ...
  assign new_n55_ = x04 & (x16 ? ((x20 & (x17 | x19)) | (~x17 & ~x19 & ~x20)) : ~x14);
  ...
  assign z09 = x18 | (x04 & (x16 ? (new_n82_ | new_n84_) : ~x06));
  ...
  assign z11 = x18 | (x04 & x16 & (new_n95_ | (~new_n94_ & x30)));
  assign new_n94_ = new_n58_ & (x19 | (new_n67_ & new_n92_ & ~x25 & ~x26));
  assign new_n95_ = new_n90_ & new_n91_ & new_n96_ & ~x27 & ~x28;
  assign new_n96_ = ~x29 & ~x30;
  assign z12 = ~new_n101_ | (x16 & (new_n99_ | (x31 & (new_n98_ | ~new_n58_))));
  assign new_n98_ = ~x19 & (~new_n74_ | x26 | x27 | ~new_n96_ | x28);
  assign new_n99_ = new_n58_ & new_n67_ & new_n100_ & ~x25 & ~x26 & ~x27;
  assign new_n100_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = x04 & ~x18 & (x03 | x16);
  assign z13 = (x16 & (new_n103_ | new_n105_)) | ~x04 | x18 | (~x02 & ~x16);
  assign new_n103_ = x32 & (~new_n58_ | (~x19 & (~new_n74_ | ~new_n104_)));
  assign new_n104_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n105_ = new_n58_ & new_n67_ & new_n88_ & new_n96_ & ~x31 & ~x32;
  assign z14 = x18 | (x04 & (x16 ? (new_n107_ | new_n109_) : ~x01));
  assign new_n107_ = x33 & (~new_n58_ | (~x19 & (~new_n78_ | ~new_n108_)));
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x27 & ~x28 & ~x29;
  assign new_n109_ = new_n59_ & new_n71_ & new_n110_ & new_n111_;
  assign new_n110_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n111_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x04 & (x16 ? (new_n113_ | new_n114_) : ~x00));
  assign new_n113_ = x34 & (~new_n58_ | (~x19 & (~new_n78_ | ~new_n92_ | ~new_n111_)));
  assign new_n114_ = new_n59_ & new_n71_ & new_n110_ & new_n115_;
