...
module FAU ( 
  ...
  assign new_n56_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20 | ~x24);
  ...
  assign new_n60_ = (~x24 | ((x17 | x19 | x20 | x21 | x22) & (~x22 | (~x17 & ~x19 & ~x21)))) & (~x20 | ~x22);
  assign z04 = (~new_n54_ & x18) | new_n62_ | (~x11 & ~x16) | (new_n64_ & x16);
  assign new_n62_ = ~x20 & (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23 & x24));
  assign new_n63_ = x16 & ~x17 & ~x19;
  assign new_n64_ = x23 & (x17 | x19 | x20 | x21 | x22);
  assign z05 = (x18 & (x20 | x24)) | (x16 & ~new_n66_ & x24) | (~x10 & ~x16) | (~x20 & ~x24);
  assign new_n66_ = ~x17 & ~x19 & ~x20 & (x17 | x19 | x20 | (~x21 & (x21 | (~x22 & (x22 | ~x23)))));
  assign z06 = ~new_n54_ & ((~x09 & ~x16) | x18 | (x16 & x25));
  assign z07 = (~new_n54_ & x18) | (~x08 & ~x16) | new_n54_ | (x16 & x26);
