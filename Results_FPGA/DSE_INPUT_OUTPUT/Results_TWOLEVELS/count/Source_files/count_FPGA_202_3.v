...
module FAU ( 
  ...
  assign new_n70_ = x25 & (~new_n64_ | (~new_n71_ & ~x18));
  ...
  assign z07 = x16 ? (~x18 & (new_n76_ | (~new_n72_ & x26))) : (~x08 | x18);
  assign new_n76_ = new_n73_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x16 ? (~x18 & (new_n78_ | (~new_n76_ & x27))) : (~x07 | x18);
  assign new_n78_ = new_n60_ & new_n79_ & ~x23 & ~x24;
  assign new_n79_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n83_ | (~new_n81_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n81_ = new_n64_ & (x18 | (new_n65_ & new_n82_ & ~x26 & ~x27));
  assign new_n82_ = ~x24 & ~x25;
  assign new_n83_ = new_n60_ & ~x26 & ~x27 & ~x28 & new_n82_ & ~x23;
  assign z10 = (x16 & (new_n85_ | (new_n61_ & new_n87_))) | x18 | (~x05 & ~x16);
  assign new_n85_ = x29 & (~new_n64_ | (~x18 & (~new_n65_ | ~new_n86_)));
  ...
  assign new_n89_ = new_n64_ & (x18 | (new_n71_ & new_n90_));
  assign new_n90_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = new_n61_ & new_n92_ & ~x24 & ~x25 & ~x26;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n94_ | new_n96_));
  assign new_n94_ = x31 & (~new_n64_ | (~x18 & (~new_n71_ | ~new_n95_)));
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x25 & ~x26 & ~x27;
  assign new_n96_ = new_n67_ & new_n68_ & new_n79_ & new_n97_;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x16 ? (~x18 & (new_n99_ | (new_n66_ & new_n100_))) : (~x02 | x18);
  assign new_n99_ = x32 & (~new_n67_ | ~new_n68_ | ~new_n79_ | ~new_n97_);
  assign new_n100_ = new_n101_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n108_ | (x16 & (new_n105_ | (x33 & (new_n103_ | ~new_n64_))));
  assign new_n103_ = ~x18 & (~new_n104_ | ~new_n101_ | x26 | x27 | x28);
  assign new_n104_ = ~x23 & ~x24 & ~x25 & ~x20 & ~x21 & ~x22;
  assign new_n105_ = new_n73_ & new_n74_ & new_n106_ & new_n107_;
  assign new_n106_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n108_ = ~x18 & (x01 | x16);
  assign z15 = x16 ? (~new_n110_ & ~x18) : (~x00 | x18);
  assign new_n110_ = (~x34 | (new_n73_ & new_n74_ & new_n106_ & new_n107_)) & (~new_n106_ | ~new_n111_ | ~new_n73_ | ~new_n74_);
