...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n67_ | (new_n69_ & new_n70_))) | x18 | (~x09 & ~x16);
  assign new_n67_ = x25 & (~new_n61_ | (~new_n68_ & ~x18));
  ...
  assign new_n72_ = x26 & (~new_n61_ | (~new_n73_ & ~x18));
  assign new_n73_ = ~x23 & ~x24 & ~x25 & ~x20 & ~x21 & ~x22;
  assign new_n74_ = new_n69_ & new_n75_ & ~x22 & ~x23;
  assign new_n75_ = ~x24 & ~x25 & ~x26;
  assign z08 = x16 ? (~x18 & (new_n77_ | (~new_n74_ & x27))) : (~x07 | x18);
  assign new_n77_ = new_n78_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n78_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z09 = ~new_n84_ | (x16 & (new_n82_ | (x28 & (new_n80_ | ~new_n61_))));
  ...
  assign new_n86_ = new_n62_ & new_n75_ & ~x27 & ~x28 & ~x29;
  assign z11 = ~new_n91_ | (x16 & (new_n90_ | (x30 & (new_n88_ | ~new_n61_))));
  assign new_n88_ = ~x18 & (~new_n68_ | ~new_n89_);
  assign new_n89_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n90_ = new_n62_ & new_n75_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n91_ = ~x18 & (x04 | x16);
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n93_ | (new_n64_ & new_n95_)));
  assign new_n93_ = x31 & (~new_n61_ | (~x18 & (~new_n68_ | ~new_n94_)));
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x25 & ~x26 & ~x27;
  assign new_n95_ = new_n96_ & ~x25 & ~x26 & ~x27;
  assign new_n96_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n98_ | (new_n64_ & new_n100_)));
  assign new_n98_ = x32 & (~new_n61_ | (~x18 & (~new_n73_ | ~new_n99_)));
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n100_ = new_n101_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n107_ | (x16 & (new_n104_ | (x33 & (new_n103_ | ~new_n61_))));
  assign new_n103_ = ~x18 & (~new_n73_ | ~new_n101_ | x26 | x27 | x28);
  assign new_n104_ = new_n69_ & new_n70_ & new_n105_ & new_n106_;
  assign new_n105_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n107_ = ~x18 & (x01 | x16);
  assign z15 = x16 ? (~new_n109_ & ~x18) : (~x00 | x18);
  assign new_n109_ = (~x34 | (new_n69_ & new_n70_ & new_n105_ & new_n106_)) & (~new_n105_ | ~new_n110_ | ~new_n69_ | ~new_n70_);
