...
module FAU ( 
  ...
  assign new_n78_ = new_n60_ & (x18 | (new_n79_ & ~x20 & ~x21 & ~x22));
  ...
  assign new_n84_ = new_n62_ & new_n85_ & ~x23 & ~x24 & ~x25;
  assign new_n85_ = ~x26 & ~x27 & ~x28;
  assign z10 = x16 ? (~x18 & (new_n87_ | (new_n89_ & new_n65_))) : (~x05 | x18);
  ...
  assign new_n92_ = new_n56_ & (x19 | (new_n69_ & new_n90_ & ~x25 & ~x26));
  assign new_n93_ = new_n65_ & new_n94_ & ~x24 & ~x25 & ~x26;
  assign new_n94_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x16 ? (~x18 & (new_n96_ | new_n99_)) : (~x03 | x18);
  assign new_n96_ = x31 & (~new_n56_ | (~x19 & (~new_n97_ | ~new_n98_)));
  assign new_n97_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n99_ = new_n56_ & new_n69_ & new_n100_ & ~x25 & ~x26 & ~x27;
  assign new_n100_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n102_ | new_n104_));
  assign new_n102_ = x32 & (~new_n60_ | (~x18 & (~new_n75_ | ~new_n103_)));
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n104_ = new_n56_ & new_n69_ & new_n88_ & new_n105_;
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n107_ | (new_n72_ & new_n108_))) | x18 | (~x01 & ~x16);
  assign new_n107_ = x33 & (~new_n60_ | (~x18 & (~new_n75_ | ~new_n85_ | ~new_n105_)));
  assign new_n108_ = new_n109_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n109_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x16 ? (~x18 & (new_n111_ | (new_n72_ & new_n113_))) : (~x00 | x18);
  assign new_n111_ = x34 & (~new_n56_ | (~x19 & (~new_n112_ | ~new_n90_ | ~new_n109_)));
