...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n73_ | (~new_n71_ & x25))) | x18 | (~x09 & ~x16);
  assign new_n71_ = new_n61_ & (new_n72_ | x18);
  ...
  assign new_n77_ = new_n61_ & (new_n78_ | x18);
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x20 & ~x21 & ~x22;
  assign new_n79_ = new_n74_ & new_n80_ & ~x22 & ~x23;
  assign new_n80_ = ~x24 & ~x25 & ~x26;
  assign z08 = (~new_n82_ & x16) | x18 | (~x07 & ~x16);
  assign new_n82_ = (~x27 | (new_n61_ & (x18 | (new_n62_ & new_n83_)))) & (~new_n84_ | ~new_n61_ | ~new_n62_);
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n84_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n88_ | (~new_n86_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n86_ = new_n61_ & (x18 | (new_n66_ & new_n87_ & ~x24 & ~x25));
  ...
  assign new_n92_ = x16 & ((x29 & (~new_n89_ | ~new_n90_)) | (new_n63_ & new_n93_));
  assign new_n93_ = ~x27 & ~x28 & ~x29 & ~x24 & ~x25 & ~x26;
  assign z11 = (x16 & (new_n97_ | (~new_n95_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n95_ = new_n61_ & (x18 | (new_n72_ & new_n96_));
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n97_ = new_n63_ & new_n80_ & new_n98_ & ~x29 & ~x30;
  assign new_n98_ = ~x27 & ~x28;
  assign z12 = x18 ? ~x13 : (x16 ? (new_n100_ | new_n101_) : ~x03);
  assign new_n100_ = x31 & (~new_n63_ | ~new_n80_ | ~new_n98_ | x29 | x30);
  assign new_n101_ = new_n68_ & new_n69_ & new_n102_ & new_n87_ & ~x25;
  assign new_n102_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n104_ | new_n106_));
  assign new_n104_ = x32 & (~new_n61_ | (~x18 & (~new_n78_ | ~new_n105_)));
  ...
  assign z14 = x18 ? ~x13 : (x16 ? (new_n110_ | new_n111_) : ~x01);
  assign new_n110_ = x33 & (~new_n68_ | ~new_n69_ | ~new_n107_ | ~new_n108_);
  assign new_n111_ = new_n74_ & new_n75_ & new_n112_ & new_n113_;
  assign new_n112_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n113_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 ? ~x13 : (x16 ? ~new_n115_ : ~x00);
  assign new_n115_ = (~x34 | (new_n74_ & new_n75_ & new_n112_ & new_n113_)) & (~new_n74_ | ~new_n75_ | ~new_n112_ | ~new_n116_);
