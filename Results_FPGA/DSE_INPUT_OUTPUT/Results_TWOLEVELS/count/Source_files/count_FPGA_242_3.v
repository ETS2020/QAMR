...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n65_ | new_n67_)) | x18 | (~x09 & ~x16);
  assign new_n65_ = x25 & (x17 | x19 | (~x18 & (x20 | (~new_n66_ & ~x19))));
  ...
  assign new_n70_ = x26 & (x17 | x19 | (~x18 & (x20 | (~new_n71_ & ~x19))));
  assign new_n71_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n72_ = new_n57_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (x16 & (new_n74_ | new_n76_)) | x18 | (~x07 & ~x16);
  assign new_n74_ = x27 & (x17 | x19 | (~x18 & (x20 | (~new_n75_ & ~x19))));
  ...
  assign new_n86_ = new_n87_ & new_n88_ & ~x24 & ~x25 & ~x26;
  assign new_n87_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n88_ = ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (new_n92_ | (~new_n90_ & x30)));
  assign new_n90_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n66_ & new_n91_))));
  assign new_n91_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n92_ = new_n87_ & ~x24 & ~x25 & ~x26 & new_n82_ & new_n93_;
  assign new_n93_ = ~x29 & ~x30;
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n97_ | (~new_n95_ & x31)));
  assign new_n95_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n71_ & new_n96_))));
  ...
  assign new_n102_ = new_n56_ & new_n66_ & new_n85_ & new_n93_ & ~x31 & ~x32;
  assign z14 = x16 ? (~x18 & (new_n104_ | (new_n67_ & new_n106_))) : (~x01 | x18);
  ...
  assign z15 = ~new_n114_ | (x16 & (new_n111_ | (x34 & (new_n110_ | ~new_n113_))));
  assign new_n110_ = ~x18 & (x20 | (~x19 & (~new_n75_ | ~new_n88_ | ~new_n108_)));
