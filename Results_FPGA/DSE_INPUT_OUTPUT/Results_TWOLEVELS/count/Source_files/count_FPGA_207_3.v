...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n65_ | new_n68_)) | (~x09 & ~x16 & ~x18) | (x18 & ~x20);
  ...
  assign z07 = (x16 & (new_n70_ | new_n72_)) | (~x08 & ~x16 & ~x18) | (x18 & ~x20);
  assign new_n70_ = x26 & (new_n66_ | (~new_n71_ & ~x18));
  assign new_n71_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n72_ = new_n57_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = ~new_n79_ | (x16 & (new_n77_ | (x27 & (new_n74_ | new_n66_))));
  assign new_n74_ = ~x18 & (~new_n75_ | ~new_n76_);
  ...
  assign new_n79_ = (x07 | x16 | x18) & (~x18 | x20);
  ...
  assign z10 = ~new_n91_ | (x16 & (new_n88_ | (x29 & (new_n86_ | new_n66_))));
  assign new_n86_ = ~x18 & (~new_n87_ | x22 | x23 | x20 | x21);
  ...
  assign new_n91_ = (x05 | x16 | x18) & (~x18 | x20);
  assign z11 = (x16 & (new_n93_ | new_n95_)) | (~x04 & ~x16 & ~x18) | (x18 & ~x20);
  assign new_n93_ = x30 & (new_n66_ | (~x18 & (~new_n67_ | ~new_n94_)));
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = new_n89_ & new_n96_ & ~x24 & ~x25 & ~x26;
  assign new_n96_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n98_ | new_n100_)) | (~x03 & ~x16 & ~x18) | (x18 & ~x20);
  assign new_n98_ = x31 & (new_n66_ | (~x18 & (~new_n67_ | ~new_n99_)));
  ...
  assign z13 = ~new_n109_ | (x16 & (new_n106_ | (x32 & (new_n104_ | ~new_n56_))));
  assign new_n104_ = ~x19 & (~new_n105_ | ~new_n84_ | x29 | x30 | x31);
  assign new_n105_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n106_ = new_n56_ & new_n101_ & new_n107_ & new_n108_;
  assign new_n107_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n108_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n109_ = ~x18 & (x02 | x16);
  assign z14 = ~new_n114_ | (x16 & (new_n111_ | (new_n68_ & new_n112_ & new_n113_)));
  assign new_n111_ = x33 & (new_n66_ | (~x18 & (~new_n71_ | ~new_n84_ | ~new_n108_)));
  assign new_n112_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n113_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n114_ = (x01 | x16 | x18) & (~x18 | x20);
  assign z15 = ~new_n118_ | (x16 & ((~new_n116_ & x34) | (new_n68_ & new_n117_)));
  assign new_n116_ = ~new_n66_ & (x18 | (new_n90_ & new_n113_ & new_n75_ & new_n76_));
