...
module FAU ( 
  ...
  assign z14 = (x16 & (new_n106_ | (new_n69_ & new_n108_))) | x18 | (~x01 & ~x16);
  ...
  assign z15 = x18 ? x14 : (x16 ? (new_n112_ | new_n113_) : ~x00);
  assign new_n112_ = x34 & (~new_n57_ | (~x19 & (~new_n77_ | ~new_n91_ | ~new_n110_)));
  assign new_n113_ = new_n58_ & new_n70_ & new_n109_ & new_n114_;
