...
module FAU ( 
  ...
  assign z05 = (~x10 & ~x16 & ~x18) | (x16 & (new_n63_ | new_n64_ | x18));
  ...
  assign z07 = (~x08 & ~x16 & ~x18) | (x16 & ((~new_n70_ & x26) | new_n72_ | x18));
  assign new_n70_ = new_n56_ & (new_n71_ | x19);
  assign new_n71_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n72_ = new_n57_ & new_n73_ & ~x22 & ~x23;
  assign new_n73_ = ~x24 & ~x25 & ~x26;
  assign z08 = (~x07 & ~x16 & ~x18) | (x16 & ((~new_n75_ & x27) | new_n77_ | x18));
  assign new_n75_ = new_n56_ & (new_n76_ | x19);
  assign new_n76_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n77_ = new_n78_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n78_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z09 = (~x06 & ~x16 & ~x18) | (x16 & ((~new_n80_ & x28) | new_n82_ | x18));
  assign new_n80_ = new_n56_ & (x19 | (new_n81_ & ~x21 & ~x22 & ~x23));
  assign new_n81_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n82_ = new_n78_ & new_n83_ & ~x26 & ~x27 & ~x28;
  assign new_n83_ = ~x23 & ~x24 & ~x25;
  assign z10 = (~x05 & ~x16 & ~x18) | (x16 & (new_n85_ | x18 | (new_n87_ & new_n89_)));
  assign new_n85_ = x29 & (~new_n56_ | (~x19 & (~new_n65_ | ~new_n86_)));
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = new_n73_ & new_n88_;
  assign new_n88_ = ~x27 & ~x28 & ~x29;
  assign new_n89_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z11 = (~x04 & ~x16 & ~x18) | (x16 & ((~new_n91_ & x30) | new_n92_ | x18));
  assign new_n91_ = new_n56_ & (x19 | (new_n65_ & new_n88_ & ~x25 & ~x26));
  assign new_n92_ = new_n89_ & new_n73_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = (x16 & (new_n96_ | (~new_n94_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n94_ = new_n56_ & (x19 | (new_n71_ & new_n95_));
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n96_ = new_n56_ & new_n65_ & new_n97_ & ~x25 & ~x26 & ~x27;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x02 & ~x16 & ~x18) | (x16 & (new_n99_ | x18 | (new_n64_ & new_n101_)));
  assign new_n99_ = x32 & (~new_n56_ | (~x19 & (~new_n71_ | ~new_n100_)));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = new_n86_ & ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~x01 & ~x16 & ~x18) | (x16 & (new_n103_ | x18 | (new_n68_ & new_n105_)));
  assign new_n103_ = x33 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n104_)));
  assign new_n104_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n105_ = new_n106_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~x00 & ~x16 & ~x18) | (x16 & (new_n108_ | x18 | (new_n68_ & new_n109_)));
  assign new_n108_ = x34 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n88_ | ~new_n106_)));
