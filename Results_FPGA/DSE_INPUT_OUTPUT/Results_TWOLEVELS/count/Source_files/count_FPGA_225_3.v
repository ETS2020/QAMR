...
module FAU ( 
  ...
  assign new_n74_ = (~x26 | (new_n72_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n72_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = (x16 & (new_n78_ | (~new_n76_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n76_ = new_n61_ & (x18 | (new_n62_ & new_n77_));
  ...
  assign z10 = ~new_n90_ | (x16 & (new_n87_ | (x29 & (new_n85_ | ~new_n61_))));
  assign new_n85_ = ~x18 & (~new_n86_ | x22 | x23 | x20 | x21);
  assign new_n86_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = new_n63_ & new_n88_ & new_n89_;
  assign new_n88_ = ~x24 & ~x25 & ~x26;
  assign new_n89_ = ~x27 & ~x28 & ~x29;
  assign new_n90_ = ~x18 & (x05 | x16);
  assign z11 = x18 ? ~x34 : (x16 ? ~new_n92_ : ~x04);
  assign new_n92_ = (~x30 | (new_n63_ & new_n88_ & new_n89_)) & (~new_n63_ | ~new_n88_ | ~new_n93_);
  assign new_n93_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 ? ~x34 : (x16 ? (new_n95_ | new_n96_) : ~x03);
  assign new_n95_ = x31 & (~new_n63_ | ~new_n88_ | ~new_n93_);
  assign new_n96_ = new_n66_ & new_n67_ & new_n80_ & new_n97_;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? ~x34 : (x16 ? (new_n99_ | new_n100_) : ~x02);
  assign new_n99_ = x32 & (~new_n66_ | ~new_n67_ | ~new_n80_ | ~new_n97_);
  assign new_n100_ = new_n66_ & new_n67_ & new_n101_ & new_n102_;
  assign new_n101_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n104_ | (new_n71_ & new_n107_))) | x18 | (~x01 & ~x16);
  assign new_n104_ = x33 & (~new_n61_ | (~x18 & (~new_n106_ | ~new_n105_ | ~new_n102_)));
  assign new_n105_ = ~x26 & ~x27 & ~x28;
  assign new_n106_ = ~x23 & ~x24 & ~x25 & ~x20 & ~x21 & ~x22;
  assign new_n107_ = new_n108_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n113_ | (x16 & ((new_n71_ & new_n111_) | (~new_n110_ & x34)));
  assign new_n110_ = new_n61_ & (x18 | (new_n62_ & new_n77_ & new_n89_ & new_n108_));
