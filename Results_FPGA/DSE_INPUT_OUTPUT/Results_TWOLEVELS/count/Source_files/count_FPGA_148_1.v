...
module FAU ( 
  ...
  assign z09 = x18 ? x09 : (x16 ? (new_n82_ | new_n84_) : ~x06);
  ...
  assign z11 = x18 ? x09 : (x16 ? (new_n92_ | new_n94_) : ~x04);
  assign new_n92_ = x30 & (~new_n57_ | (~x19 & (~new_n67_ | ~new_n93_)));
  ...
  assign new_n97_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n74_ & new_n98_))));
  ...
  assign z13 = x18 ? x09 : (x16 ? (new_n102_ | new_n104_) : ~x02);
  ...
  assign z14 = ~new_n112_ | (x16 & ((new_n70_ & new_n109_) | (~new_n107_ & x33)));
  assign new_n107_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n78_ & new_n108_))));
  ...
  assign new_n114_ = x34 & (~new_n57_ | (~x19 & (~new_n78_ | ~new_n90_ | ~new_n111_)));
  assign new_n115_ = new_n58_ & new_n71_ & new_n110_ & new_n116_;
