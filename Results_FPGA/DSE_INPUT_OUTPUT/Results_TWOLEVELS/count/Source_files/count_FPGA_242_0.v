...
module FAU ( 
  ...
  assign z06 = (x25 & (~new_n69_ | (~new_n65_ & x16))) | ~x16 | new_n67_ | x18;
  assign new_n65_ = ~x20 & (new_n66_ | x19);
  ...
  assign z08 = new_n76_ | ~x16 | new_n78_ | x18;
  assign new_n76_ = x27 & (x17 | x19 | (x16 & (x20 | (~new_n77_ & ~x19))));
  ...
  assign z10 = x18 | (x16 & (new_n86_ | (new_n88_ & new_n74_ & new_n89_)));
  assign new_n86_ = x29 & (~new_n56_ | (~x19 & (~new_n66_ | ~new_n87_)));
  assign new_n87_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n88_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n89_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x30 & (~new_n69_ | (~new_n91_ & x16))) | ~x16 | new_n92_ | x18;
  assign new_n91_ = ~x20 & (x19 | (new_n66_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n88_ & new_n74_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x31 & (~new_n69_ | (~new_n94_ & x16))) | ~x16 | new_n96_ | x18;
  ...
  assign new_n99_ = x32 & (~new_n56_ | (~x19 & (~new_n72_ | ~new_n100_)));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = new_n56_ & new_n66_ & new_n87_ & new_n102_ & ~x29 & ~x30;
  assign new_n102_ = ~x31 & ~x32;
  assign z14 = x18 | (x16 & ((~new_n104_ & x33) | (new_n67_ & new_n105_)));
  assign new_n104_ = new_n56_ & (x19 | (new_n77_ & new_n89_ & new_n102_ & ~x30));
  assign new_n105_ = new_n106_ & new_n107_;
  assign new_n106_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n110_ | (x34 & (new_n109_ | ~new_n69_));
  assign new_n109_ = x16 & (x20 | (~x19 & (~new_n77_ | ~new_n89_ | ~new_n107_)));
  assign new_n110_ = x16 & ~x18 & (~new_n57_ | ~new_n68_ | ~new_n106_ | ~new_n111_);
