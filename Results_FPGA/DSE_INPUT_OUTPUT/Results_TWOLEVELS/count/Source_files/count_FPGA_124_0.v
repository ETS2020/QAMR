...
module FAU ( 
  ...
  assign z00 = (~new_n54_ & x16) | (~x15 & ~x16) | x18 | ~x28;
  assign new_n54_ = x17 ? ~x19 : (x19 | (~x20 & (x20 | ~x28)));
  assign z01 = new_n56_ | x18;
  assign new_n56_ = x28 & (x16 ? ((x20 & (x17 | x19)) | (~x17 & ~x19 & ~x20)) : ~x14);
  assign z02 = x18 | (~new_n58_ & x28);
  assign new_n58_ = x16 ? ((x17 | x19 | x20 | x21) & (~x21 | (~x17 & ~x19 & ~x20))) : x13;
  assign z03 = (~new_n60_ & x16) | (~x12 & ~x16) | x18 | ~x28;
  ...
  assign z06 = (~new_n68_ & x16) | (~x09 & ~x16) | x18 | ~x28;
  assign new_n68_ = (x17 | x19 | ~new_n69_ | x20) & (~x25 | (new_n70_ & ~x17 & ~x19 & ~x20));
  assign new_n69_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & x28;
  assign new_n70_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z07 = x18 | (x28 & (x16 ? (new_n72_ | new_n74_) : ~x08));
  ...
  assign z08 = x18 | (x28 & (x16 ? (new_n77_ | new_n79_) : ~x07));
  assign new_n77_ = x27 & (~new_n75_ | ~new_n78_);
  assign new_n78_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n79_ = new_n80_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n80_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z09 = (~new_n82_ & x16) | (~x06 & ~x16) | x18 | ~x28;
  assign new_n82_ = ~x17 & ~x19 & (x17 | x19 | (~x20 & (x20 | ~x28 | (~x21 & (new_n83_ | x21)))));
  ...
  assign z12 = x18 | ~x28 | (~x03 & ~x16) | (x16 & x31);
