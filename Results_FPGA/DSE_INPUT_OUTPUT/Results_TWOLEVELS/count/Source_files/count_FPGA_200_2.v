...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n68_ | new_n71_)) | x18 | (~x09 & ~x16);
  assign new_n68_ = x25 & (~new_n69_ | (~new_n70_ & ~x18));
  ...
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (new_n96_ | (~new_n95_ & x30)));
  assign new_n95_ = new_n69_ & (x18 | (new_n70_ & new_n93_ & ~x25 & ~x26));
  ...
  assign z13 = (x16 & (new_n103_ | new_n106_)) | x18 | (~x02 & ~x16);
  assign new_n103_ = x32 & (~new_n69_ | (~x18 & (~new_n104_ | ~new_n105_)));
  ...
  assign z14 = (x16 & (new_n109_ | (new_n71_ & new_n110_))) | x18 | (~x01 & ~x16);
  assign new_n109_ = x33 & (~new_n69_ | (~x18 & (~new_n104_ | ~new_n86_ | ~new_n107_)));
  assign new_n110_ = new_n111_ & new_n112_;
  assign new_n111_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n112_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~x18 & (new_n114_ | (~x00 & ~x16))) | (x34 & (x18 | (~new_n117_ & x16)));
  assign new_n114_ = new_n75_ & new_n115_ & new_n111_ & new_n116_;
  assign new_n115_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n116_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n117_ = new_n64_ & (x19 | (new_n65_ & new_n92_ & new_n93_ & new_n112_));
endmodule
