...
module FAU ( 
  ...
  assign z10 = new_n84_ | ~x16 | x18 | (new_n62_ & new_n86_ & new_n87_);
  ...
  assign new_n90_ = new_n62_ & new_n86_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (x16 & (new_n95_ | (~new_n92_ & x31)));
  assign new_n92_ = new_n56_ & (x19 | (new_n93_ & new_n94_ & ~x26 & ~x27));
  assign new_n93_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n94_ = ~x28 & ~x29 & ~x30;
  assign new_n95_ = new_n56_ & new_n65_ & new_n96_ & ~x25 & ~x26 & ~x27;
  assign new_n96_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~x16 | x18 | (new_n98_ & new_n101_) | (~new_n99_ & x32);
  assign new_n98_ = new_n56_ & new_n65_;
  assign new_n99_ = new_n56_ & (x19 | (new_n93_ & new_n100_));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = new_n85_ & ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = ~x16 | x18 | (new_n68_ & new_n105_) | (~new_n103_ & x33);
  assign new_n103_ = new_n56_ & (x19 | (new_n75_ & new_n104_));
  assign new_n104_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n105_ = new_n106_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & (new_n108_ | (new_n68_ & new_n109_)));
