...
module FAU ( 
  ...
  assign z06 = x18 ? x34 : (x16 ? (new_n67_ | new_n68_) : ~x09);
  ...
  assign z08 = x18 ? x34 : (x16 ? ~new_n74_ : ~x07);
  ...
  assign z09 = x18 ? x34 : (x16 ? (new_n79_ | new_n81_) : ~x06);
  ...
  assign z10 = x18 ? x34 : (x16 ? (new_n84_ | new_n86_) : ~x05);
  ...
  assign z11 = x18 ? x34 : (x16 ? (new_n91_ | new_n93_) : ~x04);
  ...
  assign z15 = (~x18 & (new_n111_ | (~x00 & ~x16))) | (x34 & (x18 | (~new_n114_ & x16)));
  assign new_n111_ = new_n71_ & new_n112_ & new_n108_ & new_n113_;
  assign new_n112_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n113_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n114_ = new_n56_ & (x19 | (new_n75_ & new_n89_ & new_n109_));
endmodule
