...
module FAU ( 
  ...
  assign z03 = (~x12 & (~x16 | x18)) | (x16 & ~new_n58_ & ~x18);
  ...
  assign z05 = x18 ? ~x12 : (x16 ? ~new_n62_ : ~x10);
  ...
  assign z06 = x18 ? ~x12 : (x16 ? (new_n67_ | new_n68_) : ~x09);
  ...
  assign z11 = x18 ? ~x12 : (x16 ? (new_n93_ | new_n95_) : ~x04);
  assign new_n93_ = x30 & (~new_n63_ | (~x19 & (~new_n65_ | ~new_n94_)));
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = new_n89_ & new_n90_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 ? ~x12 : (x16 ? (new_n97_ | new_n99_) : ~x03);
  assign new_n97_ = x31 & (~new_n63_ | (~x19 & (~new_n73_ | ~new_n98_)));
  ...
  assign z13 = x18 ? ~x12 : (x16 ? (new_n102_ | new_n104_) : ~x02);
  assign new_n102_ = x32 & (~new_n63_ | (~x19 & (~new_n73_ | ~new_n103_)));
  ...
  assign z14 = x18 ? ~x12 : (x16 ? (new_n107_ | new_n109_) : ~x01);
  assign new_n107_ = x33 & (~new_n63_ | (~x19 & (~new_n77_ | ~new_n108_)));
  ...
  assign z15 = x18 ? ~x12 : (x16 ? (new_n113_ | new_n114_) : ~x00);
  assign new_n113_ = x34 & (~new_n63_ | (~x19 & (~new_n77_ | ~new_n91_ | ~new_n111_)));
  assign new_n114_ = new_n69_ & new_n70_ & new_n110_ & new_n115_;
