...
module FAU ( 
  ...
  assign z05 = (x16 & (new_n65_ | (~new_n62_ & x24))) | x18 | (~x10 & ~x16);
  assign new_n62_ = new_n63_ & (new_n64_ | x18);
  assign new_n63_ = ~x17 & ~x19;
  assign new_n64_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n65_ = new_n66_ & new_n67_;
  assign new_n66_ = ~x17 & ~x19 & ~x20;
  assign new_n67_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z06 = x18 | (~x09 & ~x16) | (x16 & (new_n69_ | new_n71_));
  assign new_n69_ = x25 & (~new_n63_ | (~new_n70_ & ~x18));
  assign new_n70_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n71_ = new_n72_ & new_n73_ & ~x22 & ~x23;
  assign new_n72_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n73_ = ~x24 & ~x25;
  assign z07 = x16 ? (~x18 & (new_n76_ | (~new_n75_ & x26))) : (~x08 | x18);
  assign new_n75_ = new_n66_ & (x19 | (~x21 & ~x22 & new_n73_ & ~x23));
  assign new_n76_ = new_n72_ & new_n77_ & ~x22 & ~x23;
  assign new_n77_ = ~x24 & ~x25 & ~x26;
  assign z08 = x16 ? (~x18 & (new_n81_ | (~new_n79_ & x27))) : (~x07 | x18);
  assign new_n79_ = new_n66_ & (x19 | (new_n80_ & new_n77_));
  ...
  assign z09 = x16 ? (~x18 & (new_n86_ | (~new_n85_ & x28))) : (~x06 | x18);
  assign new_n85_ = new_n66_ & (x19 | (new_n80_ & new_n73_ & ~x26 & ~x27));
  assign new_n86_ = new_n82_ & ~x26 & ~x27 & ~x28 & new_n73_ & ~x23;
  assign z10 = (x16 & (new_n88_ | (new_n90_ & new_n92_))) | x18 | (~x05 & ~x16);
  assign new_n88_ = x29 & (~new_n63_ | (~x18 & (~new_n64_ | ~new_n89_)));
  ...
  assign new_n94_ = new_n63_ & (x18 | (new_n70_ & new_n91_ & ~x25 & ~x26));
  assign new_n95_ = new_n92_ & new_n77_ & new_n96_ & ~x27 & ~x28;
  assign new_n96_ = ~x29 & ~x30;
  assign z12 = (x16 & (new_n99_ | (~new_n98_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n98_ = new_n63_ & (x18 | (new_n70_ & new_n83_ & new_n96_ & ~x28));
  assign new_n99_ = new_n66_ & new_n67_ & new_n83_ & new_n100_;
  assign new_n100_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n102_ | (new_n65_ & new_n105_)));
  assign new_n102_ = x32 & (~new_n63_ | (~x18 & (~new_n103_ | ~new_n104_)));
  assign new_n103_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n106_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n106_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x16 ? (~x18 & (new_n108_ | (new_n71_ & new_n110_))) : (~x01 | x18);
  assign new_n108_ = x33 & (~new_n66_ | (~x19 & (~new_n109_ | ~new_n80_ | ~new_n77_)));
  assign new_n109_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n110_ = new_n111_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n111_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = ~new_n118_ | (x16 & ((new_n71_ & new_n116_) | (~new_n113_ & x34)));
  assign new_n113_ = new_n63_ & (x18 | (new_n91_ & new_n111_ & new_n114_ & new_n115_));
  assign new_n114_ = ~x20 & ~x21 & ~x22;
  assign new_n115_ = ~x25 & ~x26 & ~x23 & ~x24;
