...
module FAU ( 
  ...
  assign z03 = x16 ? (~new_n59_ & ~x18) : (~x12 | x18);
  ...
  assign z06 = x16 ? (~x18 & (new_n67_ | (~new_n65_ & x25))) : (~x09 | x18);
  ...
  assign new_n69_ = (~x26 | (new_n70_ & (new_n71_ | x18))) & (~new_n57_ | ~new_n72_);
  assign new_n70_ = ~x17 & ~x19;
  assign new_n71_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n72_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x16 ? (~x18 & (new_n76_ | (~new_n74_ & x27))) : (~x07 | x18);
  assign new_n74_ = new_n56_ & (x19 | (new_n75_ & ~x21 & ~x22 & ~x23));
  assign new_n75_ = ~x24 & ~x25 & ~x26;
  assign new_n76_ = new_n77_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z09 = x16 ? (~x18 & (new_n81_ | (~new_n79_ & x28))) : (~x06 | x18);
  assign new_n79_ = new_n56_ & (x19 | (new_n80_ & ~x21 & ~x22 & ~x23));
  assign new_n80_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n81_ = new_n77_ & new_n82_ & ~x23 & ~x24 & ~x25;
  assign new_n82_ = ~x26 & ~x27 & ~x28;
  assign z10 = x16 ? (~x18 & (new_n86_ | (~new_n84_ & x29))) : (~x05 | x18);
  assign new_n84_ = new_n56_ & (x19 | (new_n66_ & new_n85_ & ~x27 & ~x28));
  assign new_n85_ = ~x25 & ~x26;
  assign new_n86_ = new_n87_ & new_n75_ & new_n88_;
  assign new_n87_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n88_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n92_ | (~new_n90_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n90_ = new_n70_ & (x18 | (new_n91_ & new_n85_ & new_n88_));
  assign new_n91_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n92_ = new_n87_ & new_n75_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = (x16 & (new_n96_ | (~new_n94_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n94_ = new_n70_ & (x18 | (new_n91_ & new_n95_));
  ...
  assign z13 = x16 ? (~x18 & (new_n99_ | new_n102_)) : (~x02 | x18);
  assign new_n99_ = x32 & (~new_n56_ | (~x19 & (~new_n100_ | ~new_n101_)));
  assign new_n100_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n56_ & new_n66_ & new_n103_ & new_n85_ & ~x27 & ~x28;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n105_ | (new_n67_ & new_n106_))) | x18 | (~x01 & ~x16);
  assign new_n105_ = x33 & (~new_n70_ | (~x18 & (~new_n71_ | ~new_n82_ | ~new_n103_)));
  assign new_n106_ = new_n107_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n114_ | (x16 & ((new_n67_ & new_n112_) | (~new_n109_ & x34)));
  assign new_n109_ = new_n70_ & (x18 | (new_n88_ & new_n107_ & new_n110_ & new_n111_));
  assign new_n110_ = ~x20 & ~x21 & ~x22;
