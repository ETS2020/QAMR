...
module FAU ( 
  ...
  assign z09 = (x16 & (new_n84_ | (~new_n81_ & x28))) | ~new_n55_ | (~x06 & ~x16);
  assign new_n81_ = new_n76_ & (x31 | (new_n83_ & new_n82_ & ~x26 & ~x27));
  assign new_n82_ = ~x24 & ~x25;
  assign new_n83_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n84_ = new_n62_ & new_n85_ & new_n82_ & ~x23;
  assign new_n85_ = ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n88_ | (~new_n87_ & x29))) | ~new_n55_ | (~x05 & ~x16);
  assign new_n87_ = new_n76_ & (x31 | (new_n83_ & new_n82_ & new_n85_));
  assign new_n88_ = new_n65_ & new_n89_ & ~x27 & ~x28 & ~x29;
  assign new_n89_ = ~x24 & ~x25 & ~x26;
  assign z11 = x18 | (~x31 & (x16 ? ~new_n91_ : ~x04));
  assign new_n91_ = (~x30 | (new_n65_ & new_n89_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n89_ | x29 | x30 | x27 | x28);
  assign z12 = x18 | (~x31 & ((~x03 & ~x16) | (new_n93_ & new_n95_)));
  assign new_n93_ = new_n89_ & new_n94_ & ~x29 & ~x30;
  assign new_n94_ = ~x27 & ~x28;
  assign new_n95_ = new_n83_ & new_n76_ & x16;
  assign z13 = x18 | (~x31 & (x16 ? (new_n97_ | new_n98_) : ~x02));
  assign new_n97_ = x32 & (~new_n65_ | ~new_n89_ | ~new_n94_ | x29 | x30);
  assign new_n98_ = new_n58_ & new_n68_ & new_n79_ & new_n99_;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign z14 = x18 | (~x31 & (x16 ? (new_n101_ | new_n102_) : ~x01));
  assign new_n101_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n79_ | ~new_n99_);
  assign new_n102_ = new_n58_ & new_n68_ & new_n103_ & new_n94_ & ~x25 & ~x26;
  assign new_n103_ = ~x29 & ~x30 & ~x32 & ~x33;
  assign z15 = (x16 & (new_n106_ | (new_n105_ & new_n108_))) | ~new_n55_ | (~x00 & ~x16);
  assign new_n105_ = new_n59_ & new_n71_;
  assign new_n106_ = x34 & (~new_n76_ | (~x31 & (~new_n107_ | ~new_n85_ | ~new_n103_)));
  assign new_n107_ = ~x23 & ~x24 & ~x25 & ~x20 & ~x21 & ~x22;
  assign new_n108_ = new_n109_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n109_ = ~x30 & ~x32 & ~x33 & ~x34;
endmodule
