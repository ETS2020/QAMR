...
module FAU ( 
  ...
  assign z13 = x18 ? x02 : (x16 ? (new_n101_ | (~new_n98_ & x32)) : ~x02);
  assign new_n101_ = new_n87_ & new_n102_ & new_n64_ & new_n66_;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? x02 : (x16 ? (new_n104_ | new_n106_) : ~x01);
  assign new_n104_ = x33 & (~new_n64_ | (~x19 & (~new_n77_ | ~new_n105_)));
  assign new_n105_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = new_n107_ & new_n108_ & new_n69_ & new_n70_;
  assign new_n107_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 ? x02 : (x16 ? (new_n110_ | new_n111_) : ~x00);
  assign new_n110_ = x34 & (~new_n64_ | (~x19 & (~new_n77_ | ~new_n89_ | ~new_n108_)));
  assign new_n111_ = new_n107_ & new_n112_ & new_n69_ & new_n70_;
