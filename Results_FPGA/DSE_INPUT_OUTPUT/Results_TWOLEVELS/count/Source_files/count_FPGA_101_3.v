...
module FAU ( 
  ...
  assign z03 = (~x12 & (~x16 | x18)) | (x16 & ~new_n60_ & ~x18);
  ...
  assign new_n65_ = (~x24 | (~new_n66_ & ~x17 & ~x19)) & (~new_n67_ | x17 | x19 | x20);
  ...
  assign z08 = x18 ? ~x12 : (x16 ? ~new_n77_ : ~x07);
  assign new_n77_ = (~x27 | (new_n57_ & (new_n78_ | x19))) & (~new_n79_ | ~new_n80_);
  assign new_n78_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 ? ~x12 : (x16 ? (new_n82_ | new_n85_) : ~x06);
  assign new_n82_ = x28 & (~new_n57_ | (~x19 & (~new_n83_ | ~new_n84_)));
  ...
  assign new_n93_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n67_ & new_n94_))));
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = new_n63_ & new_n96_ & ~x24 & ~x25 & ~x26;
  assign new_n96_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 ? ~x12 : (x16 ? (new_n98_ | new_n100_) : ~x03);
  assign new_n98_ = x31 & (~new_n57_ | (~x19 & (~new_n74_ | ~new_n99_)));
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n100_ = new_n57_ & new_n67_ & new_n101_ & ~x25 & ~x26 & ~x27;
  assign new_n101_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n105_ | (~new_n103_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n103_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n74_ & new_n104_))));
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n57_ & new_n67_ & new_n89_ & new_n106_;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n113_ | (x16 & ((~new_n108_ & x33) | (new_n70_ & new_n110_)));
  assign new_n108_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n78_ & new_n109_))));
  ...
  assign z15 = x18 ? ~x12 : (x16 ? (new_n115_ | new_n116_) : ~x00);
  assign new_n115_ = x34 & (~new_n57_ | (~x19 & (~new_n78_ | ~new_n91_ | ~new_n112_)));
  assign new_n116_ = new_n58_ & new_n71_ & new_n111_ & new_n117_;
