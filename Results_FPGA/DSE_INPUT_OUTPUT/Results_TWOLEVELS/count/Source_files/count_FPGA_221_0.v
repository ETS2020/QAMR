...
module FAU ( 
  ...
  assign new_n54_ = x17 ? ~x19 : (x19 | (~x20 & (x20 | (~x21 & (x21 | ~x34)))));
  assign new_n55_ = ~x18 & x34;
  assign z01 = (~new_n57_ & x16) | ~new_n55_ | (~x14 & ~x16);
  assign new_n57_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20 | (~x21 & (x21 | ~x34)));
  assign z02 = x18 | (~new_n59_ & x34);
  ...
  assign new_n70_ = (x17 | ~new_n72_ | x19) & (new_n71_ | ~x25);
  ...
  assign new_n86_ = x28 & (~new_n87_ | ~new_n67_ | x25 | x26 | x27);
  assign new_n87_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z10 = (~new_n89_ & x16) | ~new_n55_ | (~x05 & ~x16);
  assign new_n89_ = (x17 | ~new_n90_ | x19) & (~x29 | (new_n87_ & new_n92_));
  ...
  assign z11 = (~new_n94_ & x16) | ~new_n55_ | (~x04 & ~x16);
  ...
  assign new_n97_ = x30 & (~new_n68_ | ~new_n76_ | x27 | x28 | x29);
  ...
  assign z13 = (x16 & (new_n104_ | (~new_n107_ & x32))) | ~new_n55_ | (~x02 & ~x16);
  assign new_n104_ = ~x17 & ~x19 & ~x20 & ~x21 & new_n105_ & ~x22;
  assign new_n105_ = ~x23 & ~x24 & ~x25 & ~x26 & new_n106_ & ~x27;
  assign new_n106_ = ~x28 & ~x29 & ~x30 & ~x31 & ~x32 & x34;
  assign new_n107_ = new_n71_ & new_n108_ & ~x25 & ~x26 & ~x27;
  assign new_n108_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z14 = ~new_n55_ | (~x01 & ~x16) | (x16 & (new_n112_ | (~new_n110_ & x33)));
  assign new_n110_ = new_n71_ & new_n111_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n111_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n112_ = new_n77_ & new_n113_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n113_ = ~x30 & ~x31 & ~x32 & ~x33 & x34;
  assign z15 = ~new_n55_ | (~x00 & ~x16) | (x16 & (x17 | x19 | (~x17 & ~new_n115_ & ~x19)));
  assign new_n115_ = ~x20 & (x20 | (~x21 & (x21 | ~x34 | (~x22 & (new_n116_ | x22)))));
