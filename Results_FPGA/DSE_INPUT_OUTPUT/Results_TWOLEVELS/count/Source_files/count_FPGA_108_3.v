...
module FAU ( 
  ...
  assign z06 = x18 | (~x09 & ~x16) | (x16 & (new_n66_ | new_n68_));
  assign new_n66_ = x25 & (x17 | x19 | (~x18 & (x20 | (~new_n67_ & ~x19))));
  assign new_n67_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n68_ = new_n69_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n69_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z07 = x16 ? (~new_n71_ & ~x18) : (~x08 | x18);
  assign new_n71_ = (~x26 | (new_n64_ & (new_n72_ | x19))) & (~new_n69_ | ~new_n73_);
  assign new_n72_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n73_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x16 ? (~new_n75_ & ~x18) : (~x07 | x18);
  assign new_n75_ = (~x27 | (new_n64_ & (new_n76_ | x19))) & (~new_n77_ | ~new_n78_);
  assign new_n76_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x16 ? (~x18 & (new_n82_ | (~new_n80_ & x28))) : (~x06 | x18);
  assign new_n80_ = new_n64_ & (x19 | (new_n81_ & ~x21 & ~x22 & ~x23));
  assign new_n81_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n82_ = new_n77_ & ~x23 & ~x24 & ~x25 & new_n83_ & ~x26;
  assign new_n83_ = ~x27 & ~x28;
  assign z10 = x16 ? (~x18 & (new_n87_ | (~new_n85_ & x29))) : (~x05 | x18);
  assign new_n85_ = new_n64_ & (x19 | (new_n67_ & new_n86_));
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = new_n61_ & new_n88_ & new_n89_;
  assign new_n88_ = ~x24 & ~x25 & ~x26;
  assign new_n89_ = ~x27 & ~x28 & ~x29;
  assign z11 = x16 ? (~x18 & (new_n92_ | (~new_n91_ & x30))) : (~x04 | x18);
  assign new_n91_ = new_n64_ & (x19 | (new_n67_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n61_ & new_n88_ & new_n83_ & ~x29 & ~x30;
  assign z12 = (x16 & (new_n96_ | (~new_n94_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n94_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n72_ & new_n95_))));
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n96_ = new_n64_ & new_n67_ & new_n97_ & ~x25 & ~x26 & ~x27;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x16 ? (~x18 & (new_n99_ | new_n101_)) : (~x02 | x18);
  assign new_n99_ = x32 & (~new_n64_ | (~x19 & (~new_n72_ | ~new_n100_)));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n101_ = new_n86_ & new_n102_ & new_n64_ & new_n67_;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x16 ? (~x18 & (new_n104_ | (new_n68_ & new_n106_))) : (~x01 | x18);
  assign new_n104_ = x33 & (~new_n64_ | (~x19 & (~new_n76_ | ~new_n105_)));
  assign new_n105_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = new_n107_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x16 ? (~x18 & (new_n109_ | (new_n68_ & new_n110_))) : (~x00 | x18);
  assign new_n109_ = x34 & (~new_n64_ | (~x19 & (~new_n76_ | ~new_n89_ | ~new_n107_)));
