...
module FAU ( 
  ...
  assign z05 = (x24 & (~new_n68_ | (~new_n69_ & ~x10))) | ~new_n65_ | x10 | ~x16;
  assign new_n65_ = ~x18 & (~new_n66_ | ~new_n67_);
  ...
  assign new_n71_ = x25 & (~new_n68_ | (~new_n72_ & ~x10));
  ...
  assign z09 = ~new_n86_ | (x16 & (new_n84_ | (x28 & (new_n83_ | ~new_n68_))));
  assign new_n83_ = ~x10 & (~new_n69_ | x24 | x25 | x26 | x27);
  assign new_n84_ = new_n62_ & new_n85_;
  assign new_n85_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = ~x10 & ~x18 & (x06 | x16);
  assign z10 = x18 | (~x10 & (new_n88_ | (~x05 & ~x16)));
  assign new_n88_ = x16 & ((new_n63_ & new_n89_) | (x29 & (~new_n62_ | ~new_n85_)));
  assign new_n89_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n91_ | new_n93_)) | x10 | x18 | (~x04 & ~x16);
  assign new_n91_ = x30 & (~new_n68_ | (~x10 & (~new_n72_ | ~new_n92_)));
