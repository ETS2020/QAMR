...
module FAU ( 
  ...
  assign new_n74_ = new_n63_ & (new_n75_ | x18);
  assign new_n75_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n76_ = new_n71_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x16 ? (~x18 & (new_n78_ | new_n80_)) : (~x07 | x18);
  assign new_n78_ = x27 & (~new_n66_ | (~new_n79_ & ~x19));
  ...
  assign new_n83_ = new_n63_ & (x18 | (new_n64_ & new_n72_ & ~x26 & ~x27));
  assign new_n84_ = new_n81_ & new_n72_ & ~x23 & new_n85_ & ~x26;
  assign new_n85_ = ~x27 & ~x28;
  assign z10 = (x16 & (new_n87_ | (new_n89_ & new_n91_))) | x18 | (~x05 & ~x16);
  assign new_n87_ = x29 & (~new_n63_ | (~x18 & (~new_n64_ | ~new_n88_)));
  ...
  assign new_n93_ = new_n63_ & (x18 | (new_n94_ & new_n90_ & ~x25 & ~x26));
  assign new_n94_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n95_ = new_n91_ & ~x24 & ~x25 & ~x26 & new_n85_ & new_n96_;
  assign new_n96_ = ~x29 & ~x30;
  assign z12 = x16 ? (~x18 & (new_n98_ | new_n101_)) : (~x03 | x18);
  assign new_n98_ = x31 & (~new_n66_ | (~x19 & (~new_n99_ | ~new_n100_)));
  ...
  assign z13 = x16 ? (~x18 & (new_n104_ | (new_n65_ & new_n106_))) : (~x02 | x18);
  assign new_n104_ = x32 & (~new_n66_ | (~x19 & (~new_n99_ | ~new_n105_)));
  assign new_n105_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n106_ = new_n96_ & ~x31 & ~x32 & new_n85_ & ~x25 & ~x26;
  assign z14 = x16 ? (~x18 & (new_n108_ | (new_n70_ & new_n110_))) : (~x01 | x18);
  assign new_n108_ = x33 & (~new_n66_ | (~x19 & (~new_n79_ | ~new_n109_)));
  assign new_n109_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n110_ = new_n111_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n111_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = x16 ? (~x18 & (new_n113_ | (new_n70_ & new_n114_))) : (~x00 | x18);
  assign new_n113_ = x34 & (~new_n66_ | (~x19 & (~new_n79_ | ~new_n90_ | ~new_n111_)));
