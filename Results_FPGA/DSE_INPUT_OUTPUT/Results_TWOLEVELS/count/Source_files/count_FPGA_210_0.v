...
module FAU ( 
  ...
  assign z02 = (~new_n57_ & x16) | x18 | ~x27 | (~x13 & ~x16);
  assign new_n57_ = (x17 | x19 | x20 | x21 | ~x27) & (~x21 | (~x17 & ~x19 & ~x20));
  ...
  assign new_n71_ = x26 & (~new_n72_ | x24 | x25 | x22 | x23);
  ...
  assign z15 = x18 | ~x27 | (~x00 & ~x16) | (x16 & x34);
endmodule
