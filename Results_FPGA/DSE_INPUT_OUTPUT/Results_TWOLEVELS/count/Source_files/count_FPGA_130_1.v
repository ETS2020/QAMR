...
module FAU ( 
  ...
  assign z12 = (x16 & (new_n98_ | (~new_n97_ & x31))) | ~new_n54_ | (~x03 & ~x16);
  assign new_n97_ = new_n58_ & (x19 | (new_n73_ & new_n82_ & new_n95_ & ~x28));
  assign new_n98_ = new_n58_ & new_n67_ & new_n99_ & new_n82_ & ~x25;
  ...
  assign new_n103_ = new_n58_ & new_n67_ & new_n87_ & new_n95_ & ~x31 & ~x32;
  assign z14 = ~new_n54_ | (~x01 & ~x16) | (new_n105_ & new_n106_);
  assign new_n105_ = new_n67_ & ~x19 & ~x20 & x16 & ~x17;
  assign new_n106_ = new_n87_ & new_n95_ & ~x31 & ~x32 & ~x33;
  assign z15 = (x16 & (new_n108_ | (new_n70_ & new_n110_))) | ~new_n54_ | (~x00 & ~x16);
  assign new_n108_ = x34 & (~new_n58_ | (~x19 & (~new_n77_ | ~new_n109_)));
  assign new_n109_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n110_ = new_n111_ & new_n82_ & ~x28 & ~x29;
  assign new_n111_ = ~x30 & ~x31 & ~x32 & ~x34;
endmodule
