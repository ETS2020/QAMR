...
module FAU ( 
  ...
  assign z09 = ~new_n81_ | ~x16 | (x28 & (~new_n59_ | (~new_n80_ & x16)));
  assign new_n80_ = new_n65_ & ~x26 & ~x27 & ~x24 & ~x25;
  assign new_n81_ = ~x18 & (~new_n78_ | ~new_n82_ | x23 | x24 | x25);
  assign new_n82_ = ~x26 & ~x27 & ~x28;
  assign z10 = (x29 & (~new_n59_ | (~new_n84_ & x16))) | ~x16 | new_n85_ | x18;
  assign new_n84_ = new_n65_ & new_n82_ & ~x24 & ~x25;
  assign new_n85_ = new_n86_ & new_n88_ & new_n87_ & ~x24;
  assign new_n86_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n87_ = ~x25 & ~x26;
  assign new_n88_ = ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (x16 & (new_n91_ | (x30 & (new_n90_ | ~new_n56_))));
  assign new_n90_ = ~x19 & (~new_n64_ | ~new_n87_ | ~new_n88_);
  assign new_n91_ = new_n86_ & new_n92_ & new_n87_ & ~x24;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (x16 & (new_n97_ | (~new_n94_ & x31)));
  assign new_n94_ = new_n56_ & (x19 | (new_n95_ & new_n96_ & ~x26 & ~x27));
  assign new_n95_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n96_ = ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n56_ & new_n64_ & new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x32 & (~new_n59_ | (~new_n100_ & x16))) | ~x16 | new_n102_ | x18;
  assign new_n100_ = new_n101_ & new_n82_ & ~x29 & ~x30 & ~x31;
  assign new_n101_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n102_ = new_n56_ & new_n64_ & new_n103_ & new_n87_ & ~x27 & ~x28;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = new_n105_ | ~x16 | x18 | (new_n68_ & new_n106_ & new_n107_);
  assign new_n105_ = x33 & (~new_n59_ | (x16 & (~new_n101_ | ~new_n82_ | ~new_n103_)));
  assign new_n106_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~new_n109_ & x34) | ~x16 | x18 | (new_n68_ & new_n110_);
  assign new_n109_ = new_n59_ & (~x16 | (new_n75_ & new_n76_ & new_n88_ & new_n107_));
  assign new_n110_ = new_n106_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
