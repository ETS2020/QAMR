...
module FAU ( 
  ...
  assign z04 = (~new_n63_ & x16) | x05 | x18 | (~x11 & ~x16);
  assign new_n63_ = ~new_n65_ & (new_n64_ | ~x23);
  assign new_n64_ = ~x17 & ~x19 & (x05 | (~x20 & ~x21 & ~x22));
  ...
  assign new_n69_ = ~x05 & (x20 | x21 | x22 | x23);
  ...
  assign z10 = (x29 & (~new_n68_ | (~new_n91_ & ~x05))) | ~new_n93_ | x05 | ~x16;
  assign new_n91_ = new_n92_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n92_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n93_ = ~x18 & (~new_n65_ | ~new_n94_ | ~new_n95_);
  assign new_n94_ = ~x24 & ~x25 & ~x26;
  assign new_n95_ = ~x27 & ~x28 & ~x29;
  assign z11 = ~new_n100_ | (x16 & (new_n99_ | (~new_n97_ & x30)));
  assign new_n97_ = new_n68_ & (x05 | (new_n98_ & new_n95_ & ~x25 & ~x26));
  assign new_n98_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n99_ = new_n65_ & new_n94_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n100_ = ~x05 & ~x18 & (x04 | x16);
  assign z12 = (x16 & (new_n102_ | new_n104_)) | x05 | x18 | (~x03 & ~x16);
  assign new_n102_ = x31 & (~new_n68_ | (~x05 & (~new_n98_ | ~new_n103_)));
  assign new_n103_ = ~x28 & ~x29 & ~x30 & ~x25 & ~x26 & ~x27;
  assign new_n104_ = new_n58_ & new_n70_ & new_n105_ & ~x25 & ~x26 & ~x27;
  assign new_n105_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n107_ | new_n110_)) | x05 | x18 | (~x02 & ~x16);
  assign new_n107_ = x32 & (~new_n68_ | (~x05 & (~new_n108_ | ~new_n109_)));
  assign new_n108_ = ~x23 & ~x24 & ~x25 & ~x20 & ~x21 & ~x22;
  assign new_n109_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n110_ = new_n58_ & new_n70_ & new_n111_ & new_n112_;
  assign new_n111_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n112_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n117_ | (x16 & (new_n114_ | (new_n73_ & new_n115_ & new_n116_)));
  assign new_n114_ = x33 & (~new_n68_ | (~x05 & (~new_n108_ | ~new_n89_ | ~new_n112_)));
  assign new_n115_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n116_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n117_ = ~x05 & ~x18 & (x01 | x16);
  assign z15 = x18 | (~x05 & (x16 ? (new_n119_ | new_n120_) : ~x00));
  assign new_n119_ = x34 & (~new_n58_ | (~x19 & (~new_n82_ | ~new_n95_ | ~new_n116_)));
  assign new_n120_ = new_n59_ & new_n74_ & new_n115_ & new_n121_;
