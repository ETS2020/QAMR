...
module FAU ( 
  ...
  assign z05 = (x24 & (~new_n57_ | (~new_n65_ & x16))) | ~new_n62_ | ~x16;
  assign new_n62_ = ~x18 & (~new_n63_ | ~new_n64_);
  ...
  assign new_n71_ = x16 & ((new_n69_ & new_n73_) | (x26 & (~new_n63_ | new_n72_)));
  assign new_n72_ = ~x19 & (x23 | x24 | x25 | x21 | x22);
  assign new_n73_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~new_n75_ & x16);
  assign new_n75_ = (~new_n76_ | ~new_n78_) & (~x27 | (new_n63_ & (new_n77_ | x19)));
  assign new_n76_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n77_ = ~x24 & ~x25 & ~x26 & ~x21 & ~x22 & ~x23;
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = ~new_n81_ | ~x16 | (x28 & (~new_n57_ | (~new_n80_ & x16)));
  assign new_n80_ = new_n65_ & ~x26 & ~x27 & ~x24 & ~x25;
  assign new_n81_ = ~x18 & (~new_n76_ | ~new_n82_ | ~new_n83_);
  assign new_n82_ = ~x23 & ~x24 & ~x25;
  assign new_n83_ = ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (x16 & (new_n85_ | (new_n60_ & new_n87_ & new_n88_)));
  assign new_n85_ = x29 & (~new_n63_ | (~x19 & (~new_n64_ | ~new_n86_)));
  ...
  assign new_n91_ = new_n60_ & new_n87_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 | (x16 & (new_n96_ | (~new_n93_ & x31)));
  assign new_n93_ = new_n63_ & (x19 | (new_n94_ & new_n95_ & ~x26 & ~x27));
  ...
  assign z13 = x18 | (x16 & (new_n100_ | (x32 & (new_n99_ | ~new_n63_))));
  assign new_n99_ = ~x19 & (~new_n94_ | ~new_n83_ | x29 | x30 | x31);
  assign new_n100_ = new_n63_ & new_n64_ & new_n86_ & new_n101_;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (~new_n103_ & x33) | ~x16 | x18 | (new_n68_ & new_n104_);
  assign new_n103_ = new_n57_ & (~x16 | (new_n59_ & new_n82_ & new_n83_ & new_n101_));
  assign new_n104_ = new_n105_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & ((~new_n107_ & x34) | (new_n68_ & new_n108_)));
  assign new_n107_ = new_n63_ & (x19 | (new_n77_ & new_n88_ & new_n105_));
