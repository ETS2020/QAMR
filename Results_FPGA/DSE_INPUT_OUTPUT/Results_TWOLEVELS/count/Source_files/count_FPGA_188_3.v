...
module FAU ( 
  ...
  assign z08 = (~new_n75_ & x16) | (~x07 & ~x16 & ~x18) | (x18 & ~x21);
  assign new_n75_ = (~x27 | (~new_n71_ & (new_n76_ | x18))) & (~new_n77_ | ~new_n78_);
  ...
  assign new_n85_ = new_n63_ & (x19 | (new_n66_ & new_n86_));
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = new_n88_ & new_n89_ & ~x24 & ~x25 & ~x26;
  assign new_n88_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n89_ = ~x27 & ~x28 & ~x29;
  assign z11 = ~new_n94_ | (x16 & (new_n92_ | (~new_n91_ & x30)));
  assign new_n91_ = ~new_n71_ & (x18 | (new_n66_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n88_ & ~x24 & ~x25 & ~x26 & new_n83_ & new_n93_;
  assign new_n93_ = ~x29 & ~x30;
  assign new_n94_ = (~x18 | x21) & (x04 | x16 | x18);
  assign z12 = (x16 & (new_n96_ | new_n98_)) | (~x03 & ~x16 & ~x18) | (x18 & ~x21);
  assign new_n96_ = x31 & (new_n71_ | (~x18 & (~new_n72_ | ~new_n97_)));
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n98_ = new_n63_ & new_n66_ & new_n99_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n101_ | new_n103_)) | (~x02 & ~x16 & ~x18) | (x18 & ~x21);
  assign new_n101_ = x32 & (new_n71_ | (~x18 & (~new_n72_ | ~new_n102_)));
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n103_ = new_n63_ & new_n66_ & new_n86_ & new_n93_ & ~x31 & ~x32;
  assign z14 = ~new_n109_ | (x16 & ((~new_n105_ & x33) | (new_n67_ & new_n107_)));
  assign new_n105_ = ~new_n71_ & (x18 | (new_n76_ & new_n106_));
  ...
  assign new_n111_ = x34 & (~new_n63_ | (~x19 & (~new_n76_ | ~new_n89_ | ~new_n108_)));
