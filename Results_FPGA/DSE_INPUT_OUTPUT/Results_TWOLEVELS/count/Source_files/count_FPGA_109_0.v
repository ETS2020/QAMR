...
module FAU ( 
  ...
  wire new_n54_, new_n56_, new_n58_, new_n59_, new_n60_, new_n62_, new_n63_,
    ...
    new_n84_, new_n86_, new_n87_, new_n88_, new_n90_;
  ...
  assign z06 = (~new_n54_ & x18) | (~new_n71_ & x16) | new_n54_ | (~x09 & ~x16);
  assign new_n71_ = (new_n69_ | ~x25) & (~new_n60_ | x24 | x25 | x22 | x23);
  ...
  assign z08 = (~new_n75_ & ~new_n54_) | (x16 & ~x17 & new_n80_ & ~x19);
  assign new_n75_ = ~x18 & (x07 | x16) & (~x16 | (~new_n78_ & (new_n76_ | ~x27)));
  assign new_n76_ = new_n60_ & new_n77_ & ~x22 & ~x23;
  ...
  assign new_n81_ = ~x25 & ~x26 & ~x27 & ~x28 & (x29 | (~x29 & x30));
  assign z09 = (~new_n83_ & x16) | (~new_n54_ & x18) | new_n54_ | (~x06 & ~x16);
  assign new_n83_ = (new_n84_ | ~x28) & (x17 | ~new_n80_ | x19);
  assign new_n84_ = new_n63_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z10 = (~new_n86_ & x16) | (~new_n54_ & (x18 | (~x05 & ~x16)));
  assign new_n86_ = (new_n84_ | ~x29) & (x17 | ~new_n87_ | x19);
  assign new_n87_ = ~x20 & ~x21 & ~x22 & ~x23 & new_n88_ & ~x24;
  assign new_n88_ = ~x25 & ~x26 & ~x27 & (x28 ? x29 : (~x29 & x30));
  assign z11 = ((x29 | x30) & (x18 | (~x04 & ~x16))) | (x16 & ~new_n90_ & x30);
  assign new_n90_ = new_n66_ & new_n77_ & ~x27 & ~new_n78_ & ~x29;
