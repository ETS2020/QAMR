...
module FAU ( 
  ...
  assign z02 = (~x13 & (~x01 | ~x16)) | (x18 & (x01 | x13)) | (~new_n58_ & x16);
  ...
  assign z14 = new_n111_ | new_n80_ | (x16 & (new_n108_ | (~new_n104_ & x33)));
  assign new_n108_ = new_n60_ & new_n73_ & new_n109_ & new_n110_;
  assign new_n109_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n111_ = ~x01 & (~x13 | ~x16);
  assign z15 = ~new_n54_ & (~new_n116_ | (x16 & (new_n113_ | (new_n72_ & new_n115_))));
  assign new_n113_ = x34 & (~new_n59_ | (~x19 & (~new_n114_ | ~new_n93_ | ~new_n110_)));
  assign new_n114_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n115_ = new_n109_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
