...
module FAU ( 
  ...
  assign new_n65_ = (~x24 | (new_n61_ & (new_n67_ | x18))) & (~new_n66_ | ~new_n68_);
  ...
  assign new_n70_ = new_n66_ & (new_n68_ | x19);
  assign new_n71_ = new_n72_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n72_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z07 = (x16 & (new_n75_ | (~new_n74_ & x26))) | x18 | (~x08 & ~x16);
  assign new_n74_ = new_n61_ & (x18 | (new_n62_ & ~x23 & ~x24 & ~x25));
  assign new_n75_ = new_n72_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (x16 & (new_n79_ | (~new_n77_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n77_ = new_n61_ & (x18 | (new_n62_ & new_n78_));
  ...
  assign new_n82_ = new_n61_ & (x18 | (new_n67_ & new_n83_));
  assign new_n83_ = ~x26 & ~x27 & ~x24 & ~x25;
  assign new_n84_ = new_n80_ & new_n85_;
  assign new_n85_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x16 ? (~x18 & (new_n87_ | (new_n89_ & new_n63_))) : (~x05 | x18);
  assign new_n87_ = x29 & (~new_n66_ | (~x19 & (~new_n68_ | ~new_n88_)));
  ...
  assign new_n92_ = new_n66_ & (x19 | (new_n68_ & new_n90_ & ~x25 & ~x26));
  assign new_n93_ = new_n63_ & new_n94_ & ~x24 & ~x25 & ~x26;
  assign new_n94_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n96_ | new_n99_));
  assign new_n96_ = x31 & (~new_n61_ | (~x18 & (~new_n97_ | ~new_n98_)));
  assign new_n97_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n98_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n99_ = new_n66_ & new_n68_ & new_n100_ & ~x25 & ~x26 & ~x27;
  assign new_n100_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = x16 ? (~x18 & (new_n102_ | new_n105_)) : (~x02 | x18);
  assign new_n102_ = x32 & (~new_n66_ | (~x19 & (~new_n103_ | ~new_n104_)));
  assign new_n103_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n66_ & new_n68_ & new_n88_ & new_n106_;
  assign new_n106_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x16 ? (~x18 & (new_n108_ | (new_n71_ & new_n111_))) : (~x01 | x18);
  assign new_n108_ = x33 & (~new_n66_ | (~x19 & (~new_n109_ | ~new_n110_)));
  assign new_n109_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n110_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n111_ = new_n112_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n112_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = x16 ? (~x18 & (new_n114_ | (new_n71_ & new_n115_))) : (~x00 | x18);
  assign new_n114_ = x34 & (~new_n66_ | (~x19 & (~new_n109_ | ~new_n90_ | ~new_n112_)));
