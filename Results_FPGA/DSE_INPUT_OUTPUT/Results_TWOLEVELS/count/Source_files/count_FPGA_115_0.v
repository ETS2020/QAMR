...
module FAU ( 
  ...
  assign z09 = ~new_n84_ | (x16 & (new_n82_ | (x28 & (new_n80_ | ~new_n58_))));
  ...
  assign new_n84_ = x01 & ~x18 & (x06 | x16);
  assign z10 = (x16 & (new_n86_ | new_n88_)) | ~x01 | x18 | (~x05 & ~x16);
  ...
  assign new_n95_ = x01 & ~x18 & (x04 | x16);
  assign z12 = x18 | (x01 & (x16 ? (new_n97_ | new_n99_) : ~x03));
  assign new_n97_ = x31 & (~new_n58_ | (~x19 & (~new_n72_ | ~new_n98_)));
  ...
  assign z13 = x18 | (x01 & (x16 ? (new_n102_ | new_n104_) : ~x02));
  assign new_n102_ = x32 & (~new_n58_ | (~x19 & (~new_n72_ | ~new_n103_)));
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n104_ = new_n87_ & new_n105_ & new_n58_ & new_n68_;
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (x01 & x16 & (new_n107_ | (new_n69_ & new_n109_)));
  assign new_n107_ = x33 & (~new_n58_ | (~x19 & (~new_n76_ | ~new_n108_)));
  ...
  assign new_n112_ = x34 & (~new_n58_ | (~x19 & (~new_n76_ | ~new_n91_ | ~new_n110_)));
  assign new_n113_ = new_n114_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n114_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n115_ = x01 & ~x18 & (x00 | x16);
endmodule
