...
module FAU ( 
  ...
  assign new_n84_ = x29 & (~new_n56_ | (~x19 & (~new_n85_ | ~new_n86_)));
  assign new_n85_ = ~x22 & ~x23 & ~x24;
  ...
  assign new_n91_ = x21 & (x18 | (x16 & x29));
  assign z11 = new_n96_ | (~x18 & (x16 ? (new_n93_ | new_n95_) : ~x04));
  assign new_n93_ = x30 & (~new_n56_ | (~x19 & (~new_n68_ | ~new_n94_)));
  assign new_n94_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = new_n88_ & new_n89_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n96_ = x21 & (x18 | (x16 & x30));
  assign z12 = new_n102_ | (~x18 & (x16 ? (new_n98_ | new_n100_) : ~x03));
  assign new_n98_ = x31 & (~new_n56_ | (~x19 & (~new_n68_ | ~new_n99_)));
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n100_ = new_n56_ & new_n66_ & new_n101_ & ~x25 & ~x26 & ~x27;
  assign new_n101_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = x21 & (x18 | (x16 & x31));
  assign z13 = new_n108_ | (~x18 & (x16 ? (new_n104_ | new_n106_) : ~x02));
  assign new_n104_ = x32 & (~new_n56_ | (~x19 & (~new_n72_ | ~new_n105_)));
  assign new_n105_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n106_ = new_n56_ & new_n66_ & new_n86_ & new_n107_;
  assign new_n107_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n108_ = x21 & (x18 | (x16 & x32));
  assign z14 = new_n114_ | (~x18 & (x16 ? (new_n110_ | new_n112_) : ~x01));
  assign new_n110_ = x33 & (~new_n56_ | (~x19 & (~new_n72_ | ~new_n111_)));
  assign new_n111_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n112_ = new_n57_ & new_n68_ & new_n94_ & new_n113_;
  assign new_n113_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n114_ = x21 & (x18 | (x16 & x33));
  assign z15 = (x16 & (new_n116_ | (new_n67_ & new_n117_))) | x18 | (~x00 & ~x16);
  assign new_n116_ = x34 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n90_ | ~new_n113_)));
  assign new_n117_ = new_n94_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
