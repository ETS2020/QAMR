...
module FAU ( 
  ...
  assign new_n74_ = new_n75_ & ~x25 & ~x26 & ~x27 & ~x23 & ~x24;
  assign new_n75_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z09 = x18 | (x16 & ((~new_n74_ & x28) | (new_n77_ & new_n75_)));
  assign new_n77_ = new_n78_ & ~x23 & ~x24 & ~x25;
  assign new_n78_ = ~x26 & ~x27 & ~x28;
  assign z10 = ~new_n81_ | ~x16 | (x29 & (~new_n57_ | (~new_n80_ & x16)));
  assign new_n80_ = new_n64_ & new_n78_ & ~x24 & ~x25;
  assign new_n81_ = ~x18 & (~new_n60_ | ~new_n71_ | x27 | x28 | x29);
  assign z11 = x18 | (~new_n83_ & x16);
  assign new_n83_ = (~x30 | (new_n60_ & new_n71_ & ~x27 & ~x28 & ~x29)) & (~new_n60_ | ~new_n71_ | x29 | x30 | x27 | x28);
  ...
  assign z14 = new_n93_ | ~x16 | x18 | (new_n66_ & new_n94_);
  assign new_n93_ = x33 & (~new_n57_ | (x16 & (~new_n72_ | ~new_n78_ | ~new_n91_)));
  assign new_n94_ = new_n95_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = x18 | (x16 & ((new_n66_ & new_n97_) | (x34 & (~new_n66_ | ~new_n94_))));
