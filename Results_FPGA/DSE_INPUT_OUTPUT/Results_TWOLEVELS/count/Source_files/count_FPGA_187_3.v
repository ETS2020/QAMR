...
module FAU ( 
  ...
  assign z07 = x16 ? (~new_n69_ & ~x18) : (~x08 | x18);
  ...
  assign z09 = x16 ? (~x18 & (new_n80_ | (~new_n78_ & x28))) : (~x06 | x18);
  ...
  assign new_n83_ = new_n56_ & (x19 | (new_n66_ & new_n84_));
  ...
  assign z11 = x16 ? (~x18 & (new_n91_ | (~new_n90_ & x30))) : (~x04 | x18);
  assign new_n90_ = new_n56_ & (x19 | (new_n66_ & new_n88_ & ~x25 & ~x26));
  assign new_n91_ = new_n86_ & new_n87_ & new_n81_ & ~x29 & ~x30;
  assign z12 = x16 ? (~x18 & (new_n95_ | (~new_n93_ & x31))) : (~x03 | x18);
  ...
  assign z13 = x16 ? (~x18 & (new_n98_ | new_n100_)) : (~x02 | x18);
  assign new_n98_ = x32 & (~new_n56_ | (~x19 & (~new_n70_ | ~new_n99_)));
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n100_ = new_n84_ & new_n101_ & new_n56_ & new_n66_;
  ...
  assign z15 = x16 ? (~x18 & (new_n108_ | (new_n67_ & new_n109_))) : (~x00 | x18);
