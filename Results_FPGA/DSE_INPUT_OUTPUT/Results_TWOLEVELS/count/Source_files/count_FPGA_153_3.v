...
module FAU ( 
  ...
  assign new_n67_ = new_n68_ & (new_n65_ | x19);
  ...
  assign new_n76_ = (~x27 | (new_n68_ & (new_n77_ | x19))) & (~new_n78_ | ~new_n79_);
  assign new_n77_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n78_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x16 ? (~x18 & (new_n83_ | (~new_n81_ & x28))) : (~x06 | x18);
  assign new_n81_ = new_n68_ & (x19 | (new_n82_ & ~x21 & ~x22 & ~x23));
  ...
  assign new_n86_ = new_n68_ & (x19 | (new_n65_ & new_n87_));
  ...
  assign new_n91_ = new_n68_ & (x19 | (new_n65_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n61_ & ~x24 & ~x25 & ~x26 & new_n84_ & new_n93_;
  assign new_n93_ = ~x29 & ~x30;
  assign z12 = x16 ? (~x18 & (new_n97_ | (~new_n95_ & x31))) : (~x03 | x18);
  assign new_n95_ = new_n68_ & (x19 | (new_n73_ & new_n96_));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n68_ & new_n65_ & new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n102_ | (~new_n100_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n100_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n73_ & new_n101_))));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n68_ & new_n65_ & new_n87_ & new_n93_ & ~x31 & ~x32;
  assign z14 = ~new_n108_ | (x16 & ((~new_n104_ & x33) | (new_n69_ & new_n106_)));
  assign new_n104_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n77_ & new_n105_))));
  ...
  assign new_n110_ = x34 & (~new_n68_ | (~x19 & (~new_n77_ | ~new_n89_ | ~new_n107_)));
