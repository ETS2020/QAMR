...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n56_, new_n57_, new_n58_, new_n60_, new_n62_, new_n64_, new_n66_,
  ...
  assign z04 = x18 ? ~x08 : (x16 ? ~new_n62_ : ~x11);
  ...
  assign z08 = x18 ? ~x08 : (x16 ? ~new_n75_ : ~x07);
  ...
  assign new_n85_ = new_n57_ & (x19 | (new_n67_ & new_n86_));
  ...
  assign new_n92_ = new_n57_ & (x19 | (new_n67_ & new_n90_ & ~x25 & ~x26));
  assign new_n93_ = new_n88_ & new_n89_ & new_n83_ & ~x29 & ~x30;
  assign z12 = (x16 & (new_n97_ | (~new_n95_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n95_ = new_n57_ & (x19 | (new_n72_ & new_n96_));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n57_ & new_n67_ & new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? ~x08 : (x16 ? (new_n100_ | new_n102_) : ~x02);
  assign new_n100_ = x32 & (~new_n57_ | (~x19 & (~new_n72_ | ~new_n101_)));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n57_ & new_n67_ & new_n86_ & new_n103_;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? ~x08 : (x16 ? (new_n105_ | new_n107_) : ~x01);
  assign new_n105_ = x33 & (~new_n57_ | (~x19 & (~new_n76_ | ~new_n106_)));
  assign new_n106_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n107_ = new_n58_ & new_n69_ & new_n108_ & new_n109_;
  assign new_n108_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n109_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 ? ~x08 : (x16 ? (new_n111_ | new_n112_) : ~x00);
  assign new_n111_ = x34 & (~new_n57_ | (~x19 & (~new_n76_ | ~new_n90_ | ~new_n109_)));
  assign new_n112_ = new_n58_ & new_n69_ & new_n108_ & new_n113_;
