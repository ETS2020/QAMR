...
module FAU ( 
  ...
  assign z11 = x18 ? x04 : (x16 ? (new_n90_ | new_n92_) : ~x04);
  assign new_n90_ = x30 & (~new_n56_ | (~x19 & (~new_n66_ | ~new_n91_)));
  ...
  assign new_n94_ = x31 & (~new_n95_ | (~x19 & (~new_n66_ | ~new_n91_)));
  assign new_n95_ = ~x17 & ~x19 & ~x20 & ~x30;
  ...
  assign new_n99_ = x32 & (~new_n95_ | (~x19 & (~new_n71_ | ~new_n100_)));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x31;
  ...
  assign new_n104_ = x33 & (~new_n95_ | (~x19 & (~new_n71_ | ~new_n105_)));
  assign new_n105_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x31 & ~x32;
  assign new_n106_ = new_n57_ & new_n68_ & new_n107_ & new_n108_;
  assign new_n107_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 ? x04 : (x16 ? (new_n110_ | new_n112_) : ~x00);
  assign new_n110_ = x34 & (~new_n95_ | (~x19 & (~new_n75_ | ~new_n111_)));
  assign new_n111_ = ~x27 & ~x28 & ~x29 & ~x31 & ~x32 & ~x33;
  assign new_n112_ = new_n57_ & new_n68_ & new_n107_ & new_n113_;
