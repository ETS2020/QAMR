...
module FAU ( 
  ...
  assign new_n80_ = x28 & (~new_n56_ | (~x19 & (~new_n64_ | ~new_n81_)));
  ...
  assign z13 = (~x18 & (new_n100_ | (~x02 & ~x16))) | (x32 & (x18 | (~new_n103_ & x16)));
  assign new_n100_ = new_n65_ & new_n101_ & new_n86_ & new_n102_;
  assign new_n101_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n103_ = new_n56_ & (x19 | (new_n72_ & new_n104_));
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign z14 = new_n110_ | (~x18 & (x16 ? (new_n106_ | new_n107_) : ~x01));
  assign new_n106_ = x33 & (~new_n56_ | (~x19 & (~new_n72_ | ~new_n104_)));
  assign new_n107_ = new_n57_ & new_n69_ & new_n108_ & new_n109_;
  assign new_n108_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n109_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n110_ = x32 & (x18 | (x16 & x33));
  assign z15 = new_n116_ | (~x18 & (x16 ? (new_n112_ | new_n114_) : ~x00));
  assign new_n112_ = x34 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n113_)));
  assign new_n113_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x33;
  assign new_n114_ = new_n57_ & new_n69_ & new_n108_ & new_n115_;
