...
module FAU ( 
  ...
  assign z08 = (x16 & (new_n76_ | new_n78_)) | x18 | (~x07 & ~x16);
  ...
  assign new_n83_ = new_n79_ & new_n84_;
  ...
  assign z11 = ~new_n97_ | (x16 & (new_n94_ | (x30 & (new_n92_ | ~new_n96_))));
  assign new_n92_ = ~x18 & (x20 | (~x19 & (~new_n66_ | ~new_n93_)));
  ...
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n101_ | (~new_n99_ & x31)));
  assign new_n99_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n73_ & new_n100_))));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n101_ = new_n57_ & new_n66_ & new_n102_ & ~x25 & ~x26 & ~x27;
  ...
  assign new_n106_ = new_n57_ & new_n66_ & new_n87_ & new_n107_;
  assign new_n107_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? ~x00 : (x16 ? (new_n109_ | new_n111_) : ~x01);
  assign new_n109_ = x33 & (~new_n57_ | (~x19 & (~new_n77_ | ~new_n110_)));
  ...
  assign z15 = ~new_n118_ | (x16 & (new_n116_ | (x34 & (new_n115_ | ~new_n96_))));
  assign new_n115_ = ~x18 & (x20 | (~x19 & (~new_n77_ | ~new_n90_ | ~new_n113_)));
