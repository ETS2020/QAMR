...
module FAU ( 
  ...
  assign z06 = (x25 & (~new_n61_ | (~new_n70_ & x16))) | ~x16 | new_n69_ | x18;
  ...
  assign z08 = x18 | (x16 & (new_n77_ | new_n79_));
  assign new_n77_ = x27 & (~new_n56_ | (~new_n78_ & ~x19));
  assign new_n78_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n79_ = new_n80_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n80_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z09 = ~new_n83_ | ~x16 | (x28 & (~new_n61_ | (~new_n82_ & x16)));
  assign new_n82_ = new_n67_ & ~x26 & ~x27 & ~x24 & ~x25;
  assign new_n83_ = ~x18 & (~new_n80_ | ~new_n73_ | x26 | x27 | x28);
  ...
  assign new_n92_ = ~x19 & (~new_n93_ | ~new_n73_ | x21 | x22);
  assign new_n93_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n94_ = new_n56_ & new_n66_ & new_n95_ & ~x25 & ~x26 & ~x27;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x32 & (~new_n61_ | (x16 & (~new_n72_ | ~new_n99_)))) | ~new_n97_ | ~x16;
  assign new_n97_ = ~x18 & (~new_n56_ | ~new_n66_ | ~new_n86_ | ~new_n98_);
  ...
  assign new_n106_ = new_n56_ & (x19 | (new_n78_ & new_n87_ & new_n104_));
