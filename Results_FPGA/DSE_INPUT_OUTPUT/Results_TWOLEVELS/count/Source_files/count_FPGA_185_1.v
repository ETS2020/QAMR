...
module FAU ( 
  ...
  assign z09 = x18 | (~x28 & (new_n82_ | (~x06 & ~x16)));
  assign new_n82_ = new_n83_ & ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign new_n83_ = ~x25 & ~x26 & ~x27 & ~x22 & ~x23 & ~x24;
  assign z10 = (x16 & (new_n87_ | (~new_n85_ & x29))) | ~new_n54_ | (~x05 & ~x16);
  assign new_n85_ = new_n58_ & (x19 | (new_n66_ & new_n86_ & ~x24 & ~x25));
  assign new_n86_ = ~x26 & ~x27;
  assign new_n87_ = new_n79_ & ~x23 & ~x24 & ~x25 & new_n88_ & ~x26;
  assign new_n88_ = ~x27 & ~x29;
  assign z11 = (x16 & (new_n90_ | (new_n92_ & new_n93_))) | ~new_n54_ | (~x04 & ~x16);
  assign new_n90_ = x30 & (~new_n58_ | (~x19 & (~new_n67_ | ~new_n91_)));
  assign new_n91_ = ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n92_ = ~x21 & ~x22 & ~x23 & ~x17 & ~x19 & ~x20;
  assign new_n93_ = ~x27 & ~x29 & ~x30 & ~x24 & ~x25 & ~x26;
  assign z12 = x18 | (~x28 & (x16 ? (new_n95_ | new_n97_) : ~x03));
  assign new_n95_ = x31 & (~new_n58_ | (~x19 & (~new_n67_ | ~new_n96_)));
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x29 & ~x30;
  assign new_n97_ = new_n92_ & ~x24 & ~x25 & ~x26 & new_n88_ & new_n98_;
  assign new_n98_ = ~x30 & ~x31;
  assign z13 = (x16 & (new_n101_ | (~new_n100_ & x32))) | ~new_n54_ | (~x02 & ~x16);
  assign new_n100_ = new_n58_ & (x19 | (new_n74_ & new_n86_ & new_n98_ & ~x29));
  assign new_n101_ = new_n58_ & new_n67_ & new_n102_ & new_n86_ & ~x25;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n54_ | (~x01 & ~x16) | (x16 & (new_n104_ | new_n106_));
  assign new_n104_ = x33 & (~new_n58_ | (~x19 & (~new_n74_ | ~new_n105_)));
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x26 & ~x27 & ~x29;
  assign new_n106_ = new_n58_ & new_n67_ & new_n91_ & new_n98_ & ~x32 & ~x33;
  assign z15 = x18 | (~x28 & (x16 ? (new_n108_ | new_n110_) : ~x00));
  assign new_n108_ = x34 & (~new_n58_ | (~x19 & (~new_n78_ | ~new_n109_)));
  assign new_n109_ = ~x31 & ~x32 & ~x33 & ~x27 & ~x29 & ~x30;
  assign new_n110_ = new_n59_ & new_n71_ & new_n111_ & new_n112_;
  assign new_n111_ = ~x26 & ~x27 & ~x29 & ~x30;
