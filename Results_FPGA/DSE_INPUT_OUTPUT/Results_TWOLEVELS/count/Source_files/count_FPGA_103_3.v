...
module FAU ( 
  ...
  assign z05 = x18 ? ~x13 : (x16 ? ~new_n67_ : ~x10);
  assign new_n67_ = (~x24 | (new_n57_ & (x19 | (~x21 & ~x22 & ~x23)))) & (~new_n57_ | x21 | x22 | x23 | x24);
  assign z06 = (x16 & (new_n70_ | (~new_n69_ & x25))) | x18 | (~x09 & ~x16);
  assign new_n69_ = new_n61_ & (x18 | (new_n62_ & ~x22 & ~x23 & ~x24));
  assign new_n70_ = new_n58_ & new_n71_;
  assign new_n71_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = (~new_n73_ & x16) | x18 | (~x08 & ~x16);
  assign new_n73_ = (~x26 | (new_n61_ & (new_n74_ | x18))) & (~new_n75_ | ~new_n61_ | ~new_n62_);
  assign new_n74_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n75_ = ~x24 & ~x25 & ~x26 & ~x22 & ~x23;
  assign z08 = x18 ? ~x13 : (x16 ? ~new_n77_ : ~x07);
  assign new_n77_ = (~x27 | (new_n57_ & (new_n78_ | x19))) & (~new_n63_ | ~new_n79_);
  ...
  assign new_n81_ = ~x18 & (~new_n82_ | x24 | x25 | x26 | x27);
  assign new_n82_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n83_ = new_n63_ & new_n84_ & ~x23 & ~x24 & ~x25;
  assign new_n84_ = ~x26 & ~x27 & ~x28;
  assign new_n85_ = ~x18 & (x06 | x16);
  assign z10 = (x16 & (new_n87_ | (new_n89_ & new_n91_))) | x18 | (~x05 & ~x16);
  assign new_n87_ = x29 & (~new_n61_ | (~x18 & (~new_n82_ | ~new_n88_)));
  ...
  assign z11 = x18 ? ~x13 : (x16 ? (new_n93_ | new_n96_) : ~x04);
  assign new_n93_ = x30 & (~new_n57_ | (~x19 & (~new_n94_ | ~new_n95_)));
  assign new_n94_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign new_n95_ = ~x27 & ~x28 & ~x29 & ~x25 & ~x26;
  ...
  assign new_n100_ = ~x23 & ~x24 & ~x25 & ~x21 & ~x22;
  assign new_n101_ = ~x28 & ~x29 & ~x30 & ~x26 & ~x27;
  assign new_n102_ = new_n57_ & new_n94_ & new_n103_ & ~x25 & ~x26 & ~x27;
  assign new_n103_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = (x16 & (new_n107_ | (~new_n105_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n105_ = new_n61_ & (x18 | (new_n74_ & new_n106_));
  assign new_n106_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n107_ = new_n57_ & new_n94_ & new_n108_ & new_n109_;
  assign new_n108_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n109_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n111_ | (new_n70_ & new_n112_)));
  assign new_n111_ = x33 & (~new_n61_ | (~x18 & (~new_n74_ | ~new_n84_ | ~new_n109_)));
  ...
  assign new_n116_ = x34 & (~new_n57_ | (~x19 & (~new_n78_ | ~new_n90_ | ~new_n114_)));
  assign new_n117_ = new_n58_ & new_n71_ & new_n113_ & new_n118_;
