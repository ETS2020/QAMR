...
module FAU ( 
  ...
  assign z05 = (x24 & (~new_n57_ | (~new_n64_ & x16))) | ~x16 | new_n61_ | x18;
  ...
  assign z07 = ~new_n72_ | ~x16 | (x26 & (~new_n57_ | (~new_n70_ & x16)));
  assign new_n70_ = new_n71_ & ~x23 & ~x24 & ~x25;
  assign new_n71_ = ~x20 & ~x21 & ~x22;
  assign new_n72_ = ~x18 & (~new_n68_ | ~new_n73_ | x22 | x23);
  ...
  assign z10 = ~new_n85_ | ~x16 | (x29 & (~new_n57_ | (~new_n84_ & x16)));
  assign new_n84_ = new_n64_ & new_n82_ & ~x24 & ~x25;
  assign new_n85_ = ~x18 & (~new_n86_ | ~new_n73_ | ~new_n87_);
  ...
  assign new_n90_ = new_n86_ & new_n73_ & new_n91_ & ~x27 & ~x28;
  assign new_n91_ = ~x29 & ~x30;
  assign z12 = x18 | (x16 & (new_n95_ | (x31 & (new_n93_ | ~new_n62_))));
  assign new_n93_ = ~x19 & (~new_n94_ | x26 | x27 | ~new_n91_ | x28);
  assign new_n94_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n95_ = new_n62_ & new_n63_ & new_n96_ & ~x25 & ~x26 & ~x27;
  assign new_n96_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & ((~new_n98_ & x32) | (new_n61_ & new_n100_)));
  assign new_n98_ = new_n62_ & (x19 | (new_n94_ & new_n99_));
  assign new_n99_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n100_ = new_n101_ & ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (x16 & ((~new_n103_ & x33) | (new_n67_ & new_n105_)));
  assign new_n103_ = new_n62_ & (x19 | (new_n76_ & new_n104_));
  assign new_n104_ = ~x30 & ~x31 & ~x32 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = new_n106_ & ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (~new_n108_ & x34) | ~x16 | x18 | (new_n67_ & new_n110_);
  assign new_n108_ = new_n57_ & (~x16 | (new_n71_ & new_n109_ & new_n87_ & new_n106_));
