...
module FAU ( 
  ...
  assign z07 = x18 ? ~x07 : (x16 ? ~new_n72_ : ~x08);
  ...
  assign z08 = (~x07 & (~x16 | x18)) | (x16 & ~new_n76_ & ~x18);
  ...
  assign z10 = x18 ? ~x07 : (x16 ? (new_n86_ | new_n88_) : ~x05);
  assign new_n86_ = x29 & (~new_n63_ | (~x19 & (~new_n65_ | ~new_n87_)));
  ...
  assign z11 = x18 ? ~x07 : (x16 ? (new_n92_ | new_n94_) : ~x04);
  assign new_n92_ = x30 & (~new_n63_ | (~x19 & (~new_n65_ | ~new_n93_)));
  ...
  assign new_n99_ = new_n63_ & new_n65_ & new_n100_ & ~x25 & ~x26 & ~x27;
  ...
  assign new_n104_ = new_n63_ & new_n65_ & new_n87_ & new_n105_;
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n112_ | (x16 & ((new_n68_ & new_n109_) | (~new_n107_ & x33)));
  assign new_n107_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n77_ & new_n108_))));
  ...
  assign z15 = ~new_n118_ | (x16 & (new_n115_ | (x34 & (new_n114_ | ~new_n117_))));
  assign new_n114_ = ~x18 & (x20 | (~x19 & (~new_n77_ | ~new_n90_ | ~new_n111_)));
  assign new_n115_ = new_n69_ & new_n70_ & new_n110_ & new_n116_;
