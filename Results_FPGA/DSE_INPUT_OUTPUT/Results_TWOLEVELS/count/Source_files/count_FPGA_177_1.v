...
module FAU ( 
  ...
  assign z06 = x18 ? x06 : (x16 ? (new_n69_ | new_n70_) : ~x09);
  assign new_n69_ = x25 & (~new_n57_ | (~new_n67_ & ~x19));
  ...
  assign z10 = x18 ? x06 : (x16 ? (new_n88_ | new_n90_) : ~x05);
  assign new_n88_ = x29 & (~new_n57_ | (~x19 & (~new_n67_ | ~new_n89_)));
  assign new_n89_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n90_ = new_n63_ & new_n91_ & ~x24 & ~x25 & ~x26;
  assign new_n91_ = ~x27 & ~x28 & ~x29;
  assign z11 = x18 ? x06 : (x16 ? (new_n93_ | new_n95_) : ~x04);
  assign new_n93_ = x30 & (~new_n57_ | (~x19 & (~new_n67_ | ~new_n94_)));
  ...
  assign new_n98_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n74_ & new_n99_))));
  ...
  assign z13 = x18 ? x06 : (x16 ? (new_n103_ | new_n105_) : ~x02);
  ...
  assign z15 = x18 ? x06 : (x16 ? (new_n115_ | new_n116_) : ~x00);
