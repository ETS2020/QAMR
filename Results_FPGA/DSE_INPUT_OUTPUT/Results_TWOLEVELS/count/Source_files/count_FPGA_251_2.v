...
module FAU ( 
  ...
  assign z04 = x18 ? x31 : (x16 ? ~new_n60_ : ~x11);
  assign new_n60_ = (~x23 | (~x17 & ~x19 & ~x20 & (x19 | (~x21 & ~x22)))) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z05 = x18 ? x31 : (x16 ? ~new_n62_ : ~x10);
  ...
  assign z06 = x18 ? x31 : (x16 ? (new_n67_ | new_n68_) : ~x09);
  ...
  assign z11 = x18 ? x31 : (x16 ? (new_n92_ | new_n94_) : ~x04);
  ...
  assign z12 = (x16 & (new_n96_ | new_n98_)) | x18 | (~x03 & ~x16);
  assign new_n96_ = x31 & (~new_n63_ | (~x19 & (~new_n73_ | ~new_n97_)));
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n98_ = new_n63_ & new_n65_ & new_n99_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n103_ | (~new_n101_ & x32)));
  assign new_n101_ = new_n102_ & (x18 | (~x20 & (x19 | (new_n73_ & new_n97_))));
  assign new_n102_ = ~x17 & ~x19 & (x19 | ~x31);
  assign new_n103_ = new_n63_ & new_n65_ & new_n87_ & new_n104_;
  assign new_n104_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n110_ | (x16 & ((new_n68_ & new_n108_) | (~new_n106_ & x33)));
  assign new_n106_ = new_n102_ & (x18 | (~x20 & (x19 | (new_n73_ & new_n107_))));
  assign new_n107_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x32;
  ...
  assign new_n112_ = x34 & (~new_n63_ | (~x19 & (~new_n77_ | ~new_n113_)));
  assign new_n113_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x32 & ~x33;
  assign new_n114_ = new_n69_ & new_n70_ & new_n109_ & new_n115_;
  assign new_n115_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n116_ = x31 & (x18 | (x16 & x34));
endmodule
