...
module FAU ( 
  ...
  assign z09 = (x16 & (new_n81_ | (new_n84_ & new_n78_))) | x18 | (~x06 & ~x16);
  assign new_n81_ = x28 & (~new_n57_ | (~x19 & (~new_n65_ | ~new_n82_ | ~new_n83_)));
  assign new_n82_ = ~x24 & ~x25;
  assign new_n83_ = ~x26 & ~x27;
  assign new_n84_ = ~x26 & ~x27 & ~x28 & new_n82_ & ~x23;
  assign z10 = (~x18 & (x16 ? ~new_n86_ : ~x05)) | (x27 & (x18 | (x16 & x29)));
  assign new_n86_ = (~x29 | (new_n57_ & (x19 | (new_n65_ & new_n87_)))) & (~new_n88_ | ~new_n57_ | ~new_n65_);
  assign new_n87_ = ~x24 & ~x25 & ~x26 & ~x28;
  assign new_n88_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n92_ | (~new_n90_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n90_ = new_n57_ & (x19 | (new_n66_ & new_n91_ & ~x25 & ~x26));
  assign new_n91_ = ~x27 & ~x28 & ~x29;
  assign new_n92_ = new_n57_ & new_n65_ & new_n93_ & ~x24 & ~x25 & ~x26;
  assign new_n93_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n97_ | (~new_n95_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n95_ = new_n57_ & (x19 | (new_n73_ & new_n96_));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n57_ & new_n66_ & new_n98_ & new_n83_ & ~x25;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n105_ | (~x18 & (x16 ? (new_n100_ | new_n102_) : ~x02));
  assign new_n100_ = x32 & (~new_n57_ | (~x19 & (~new_n73_ | ~new_n101_)));
  assign new_n101_ = ~x26 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n57_ & new_n66_ & new_n103_ & new_n104_;
  assign new_n103_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n104_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n105_ = x27 & (x18 | (x16 & x32));
  assign z14 = new_n112_ | (~x18 & (x16 ? (new_n107_ | new_n109_) : ~x01));
  assign new_n107_ = x33 & (~new_n57_ | (~x19 & (~new_n73_ | ~new_n108_)));
  assign new_n108_ = ~x26 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n109_ = new_n58_ & new_n70_ & new_n110_ & new_n111_;
  assign new_n110_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n111_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n112_ = x27 & (x18 | (x16 & x33));
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n114_ | (new_n69_ & new_n115_)));
