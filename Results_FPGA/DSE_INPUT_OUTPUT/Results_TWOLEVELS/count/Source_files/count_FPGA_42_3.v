...
module FAU ( 
  ...
  assign z06 = x18 ? ~x26 : (x16 ? ~new_n68_ : ~x09);
  assign new_n68_ = (~x25 | (new_n56_ & new_n66_)) & (~new_n57_ | ~new_n69_);
  assign new_n69_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (~x26 & (new_n71_ | x18)) | (~x18 & (x16 ? (~new_n73_ & x26) : ~x08));
  assign new_n71_ = new_n72_ & ~x19 & ~x20 & x16 & ~x17;
  assign new_n72_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n73_ = new_n56_ & (new_n72_ | x19);
  assign z08 = (~new_n75_ & x16) | x18 | (~x07 & ~x16);
  assign new_n75_ = (~new_n62_ | ~new_n77_) & (~x27 | (new_n56_ & (new_n76_ | x19)));
  assign new_n76_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = ~new_n83_ | (x16 & (new_n81_ | (x28 & (new_n79_ | ~new_n56_))));
  assign new_n79_ = ~x19 & (~new_n80_ | x21 | x22 | x23);
  assign new_n80_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n81_ = new_n62_ & new_n82_ & ~x23 & ~x24 & ~x25;
  assign new_n82_ = ~x26 & ~x27 & ~x28;
  assign new_n83_ = ~x18 & (x06 | x16);
  assign z10 = (x16 & (new_n85_ | (new_n63_ & new_n87_))) | x18 | (~x05 & ~x16);
  ...
  assign new_n89_ = new_n56_ & (x19 | (new_n66_ & new_n90_));
  assign new_n90_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = new_n63_ & new_n92_ & ~x24 & ~x25 & ~x26;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = ~new_n99_ | (x16 & ((new_n94_ & new_n97_) | (~new_n95_ & x31)));
  assign new_n94_ = new_n56_ & new_n66_;
  assign new_n95_ = ~new_n96_ & (x26 | (new_n57_ & new_n69_));
  assign new_n96_ = ~x18 & (x26 | x27 | x28 | x29 | x30);
  assign new_n97_ = new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n99_ = (x03 | x16 | x18) & (~x18 | x26);
  assign z13 = ~new_n104_ | (x16 & (new_n101_ | (new_n94_ & new_n103_)));
  assign new_n101_ = x32 & ((~new_n102_ & ~x18) | (~x26 & (~new_n57_ | ~new_n69_)));
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n103_ = new_n86_ & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n104_ = (x02 | x16 | x18) & (~x18 | x26);
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n107_ | (new_n106_ & new_n109_)));
  assign new_n106_ = new_n57_ & new_n69_;
  assign new_n107_ = x33 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n108_)));
  ...
  assign z15 = ~new_n115_ | (x16 & ((new_n106_ & new_n114_) | (~new_n113_ & x34)));
  assign new_n113_ = (x26 | (new_n57_ & new_n69_)) & (x18 | (new_n110_ & new_n111_));
  assign new_n114_ = new_n110_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n115_ = (x00 | x16 | x18) & (~x18 | x26);
endmodule
