...
module FAU ( 
  ...
  assign z10 = x18 ? x05 : (x16 ? (new_n91_ | (~new_n88_ & x29)) : ~x05);
  assign new_n91_ = new_n92_ & new_n93_ & new_n77_ & ~x24;
  ...
  assign new_n99_ = new_n66_ & (x18 | (new_n71_ & new_n100_));
  ...
  assign z13 = (x16 & (new_n107_ | (~new_n104_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n104_ = new_n66_ & (x18 | (new_n105_ & new_n106_));
  ...
  assign z14 = (x16 & (new_n110_ | (new_n72_ & new_n111_))) | x18 | (~x01 & ~x16);
  assign new_n110_ = x33 & (~new_n66_ | (~x18 & (~new_n105_ | ~new_n89_ | ~new_n108_)));
  assign new_n111_ = new_n112_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n112_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = ~new_n117_ | (x16 & ((new_n72_ & new_n115_) | (~new_n114_ & x34)));
  assign new_n114_ = new_n66_ & (x18 | (new_n80_ & new_n81_ & new_n93_ & new_n112_));
