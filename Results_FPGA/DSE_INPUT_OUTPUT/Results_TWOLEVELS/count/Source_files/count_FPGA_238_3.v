...
module FAU ( 
  ...
  assign z10 = x16 ? (~x18 & (new_n86_ | (new_n88_ & new_n62_))) : (~x05 | x18);
  assign new_n86_ = x29 & (~new_n56_ | (~x19 & (~new_n67_ | ~new_n87_)));
  assign new_n87_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n88_ = new_n89_ & ~x24 & ~x25 & ~x26;
  assign new_n89_ = ~x27 & ~x28 & ~x29;
  assign z11 = ~new_n95_ | (x16 & (new_n93_ | (x30 & (new_n91_ | ~new_n65_))));
  assign new_n91_ = ~x18 & (x20 | (~x19 & (~new_n67_ | ~new_n92_)));
  ...
  assign new_n97_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n73_ & new_n98_))));
  ...
  assign new_n102_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n73_ & new_n103_))));
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n104_ = new_n56_ & new_n67_ & new_n87_ & new_n105_;
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x16 ? (~x18 & (new_n107_ | (new_n70_ & new_n109_))) : (~x01 | x18);
  assign new_n107_ = x33 & (~new_n56_ | (~x19 & (~new_n78_ | ~new_n108_)));
  ...
  assign new_n112_ = x34 & (~new_n56_ | (~x19 & (~new_n78_ | ~new_n89_ | ~new_n110_)));
