...
module FAU ( 
  ...
  assign z06 = (~new_n68_ & x25) | ~x16 | new_n69_ | x18;
  assign new_n68_ = new_n56_ & (new_n66_ | x19);
  assign new_n69_ = new_n57_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = ~new_n71_ | (x26 & (~new_n56_ | (~new_n73_ & ~x19)));
  assign new_n71_ = x16 & ~x18 & (~new_n57_ | ~new_n72_ | x22 | x23);
  assign new_n72_ = ~x24 & ~x25 & ~x26;
  assign new_n73_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z08 = (x27 & (~new_n56_ | (~new_n78_ & ~x19))) | ~new_n75_ | ~x16;
  ...
  assign z09 = (~new_n80_ & x28) | ~x16 | x18 | (new_n76_ & new_n81_);
  assign new_n80_ = new_n56_ & (x19 | (new_n65_ & new_n77_ & ~x24 & ~x25));
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (x16 & (new_n83_ | (new_n62_ & new_n72_ & new_n85_)));
  ...
  assign new_n87_ = new_n56_ & (x19 | (new_n66_ & new_n85_ & ~x25 & ~x26));
  assign new_n88_ = new_n62_ & new_n72_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (x16 & (new_n91_ | (x31 & (new_n90_ | ~new_n56_))));
  assign new_n90_ = ~x19 & (~new_n73_ | ~new_n77_ | x28 | x29 | x30);
  assign new_n91_ = new_n56_ & new_n66_ & new_n92_ & new_n77_ & ~x25;
  assign new_n92_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n94_ | new_n96_));
  assign new_n94_ = x32 & (~new_n56_ | (~x19 & (~new_n73_ | ~new_n95_)));
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = new_n56_ & new_n66_ & new_n84_ & new_n97_ & ~x29 & ~x30;
  assign new_n97_ = ~x31 & ~x32;
  assign z14 = x18 | (x16 & (new_n99_ | (new_n69_ & new_n101_ & new_n102_)));
  assign new_n99_ = x33 & (~new_n56_ | (~x19 & (~new_n78_ | ~new_n100_)));
  assign new_n100_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & (new_n104_ | (new_n69_ & new_n105_)));
  assign new_n104_ = x34 & (~new_n56_ | (~x19 & (~new_n78_ | ~new_n85_ | ~new_n102_)));
