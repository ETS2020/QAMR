...
module FAU ( 
  ...
  assign new_n64_ = (~x24 | (new_n65_ & ~new_n66_)) & (~new_n56_ | ~new_n67_);
  ...
  assign new_n73_ = (~new_n57_ | ~new_n75_) & (~x26 | (new_n56_ & (new_n74_ | x19)));
  ...
  assign z09 = x16 ? (~x18 & (new_n84_ | (~new_n82_ & x28))) : (~x06 | x18);
  assign new_n82_ = new_n56_ & (x19 | (new_n83_ & ~x21 & ~x22 & ~x23));
  assign new_n83_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n84_ = new_n80_ & new_n85_;
  assign new_n85_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n89_ | (~new_n87_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n87_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n67_ & new_n88_))));
  assign new_n88_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n89_ = new_n62_ & new_n90_ & ~x24 & ~x25 & ~x26;
  ...
  assign new_n93_ = new_n62_ & new_n94_ & ~x24 & ~x25 & ~x26;
  assign new_n94_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n98_ | (~new_n96_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n96_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n74_ & new_n97_))));
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n98_ = new_n56_ & new_n67_ & new_n99_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n103_ | (~new_n101_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n101_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n74_ & new_n102_))));
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n103_ = new_n56_ & new_n67_ & new_n88_ & new_n104_;
  assign new_n104_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x16 ? (~x18 & (new_n106_ | (new_n70_ & new_n108_))) : (~x01 | x18);
  assign new_n106_ = x33 & (~new_n56_ | (~x19 & (~new_n78_ | ~new_n107_)));
  ...
  assign z15 = ~new_n115_ | (x16 & (new_n113_ | (x34 & (new_n112_ | ~new_n65_))));
  assign new_n112_ = ~x18 & (x20 | (~x19 & (~new_n78_ | ~new_n90_ | ~new_n110_)));
  assign new_n113_ = new_n57_ & new_n71_ & new_n109_ & new_n114_;
