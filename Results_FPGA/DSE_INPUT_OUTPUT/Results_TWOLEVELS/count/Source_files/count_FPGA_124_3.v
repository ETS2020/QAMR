...
module FAU ( 
  ...
  assign new_n93_ = new_n58_ & (x19 | (new_n67_ & new_n94_));
  ...
  assign z13 = ~new_n107_ | (x16 & ((new_n102_ & new_n106_) | (~new_n103_ & x32)));
  assign new_n102_ = new_n58_ & new_n67_;
  assign new_n103_ = new_n105_ & (x19 | (~new_n104_ & (x28 | (new_n66_ & new_n82_))));
  assign new_n104_ = ~x18 & (x30 | x31 | x28 | x29);
  assign new_n105_ = (~x20 | x28) & (x18 | (~x17 & ~x19));
  assign new_n106_ = new_n87_ & ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n107_ = (x02 | x16 | x18) & (~x18 | x28);
  assign z14 = (x16 & (new_n109_ | (new_n70_ & new_n111_))) | (~x01 & ~x16) | x18;
  assign new_n109_ = x33 & (~new_n58_ | (~x19 & (~new_n77_ | ~new_n110_)));
  assign new_n110_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n111_ = new_n112_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n112_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = ~new_n118_ | (x16 & ((new_n70_ & new_n117_) | (~new_n114_ & x34)));
  assign new_n114_ = new_n105_ & (x19 | (~new_n115_ & (x28 | (new_n67_ & new_n116_))));
  assign new_n115_ = ~x18 & (x28 | x29 | x30 | x31 | x33);
  assign new_n116_ = ~x25 & ~x26 & ~x27 & ~x32;
  assign new_n117_ = new_n112_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n118_ = (x00 | x16 | x18) & (~x18 | x28);
endmodule
