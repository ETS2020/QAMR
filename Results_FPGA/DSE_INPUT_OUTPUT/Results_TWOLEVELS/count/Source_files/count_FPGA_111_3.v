...
module FAU ( 
  ...
  assign z10 = x16 ? (~x18 & (new_n85_ | (new_n87_ & new_n90_))) : (~x05 | x18);
  assign new_n85_ = x29 & (~new_n56_ | (~x19 & (~new_n66_ | ~new_n86_)));
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = new_n89_ & new_n88_ & ~x24;
  assign new_n88_ = ~x25 & ~x26;
  assign new_n89_ = ~x27 & ~x28 & ~x29;
  assign new_n90_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (new_n92_ | new_n94_));
  assign new_n92_ = x30 & (~new_n70_ | (~x18 & (~new_n93_ | ~new_n88_ | ~new_n89_)));
  assign new_n93_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n94_ = new_n90_ & new_n95_ & new_n88_ & ~x24;
  ...
  assign new_n103_ = x32 & (~new_n70_ | (~x18 & (~new_n71_ | ~new_n104_)));
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n56_ & new_n66_ & new_n86_ & new_n106_;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n108_ | (new_n67_ & new_n109_))) | x18 | (~x01 & ~x16);
  assign new_n108_ = x33 & (~new_n70_ | (~x18 & (~new_n71_ | ~new_n82_ | ~new_n106_)));
  assign new_n109_ = new_n110_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x16 ? (~x18 & (new_n112_ | (new_n67_ & new_n114_))) : (~x00 | x18);
  assign new_n112_ = x34 & (~new_n56_ | (~x19 & (~new_n113_ | ~new_n89_ | ~new_n110_)));
