...
module FAU ( 
  ...
  assign z05 = (~new_n62_ & x16) | (~x10 & ~x16 & ~x18) | (x18 & ~x21);
  assign new_n62_ = (~x24 | ((new_n63_ | x21) & (x18 | (~x21 & ~x22 & ~x23)))) & (~new_n63_ | x23 | x24 | x21 | x22);
  ...
  assign new_n80_ = new_n63_ & (x19 | (new_n81_ & ~x21 & ~x22 & ~x23));
  assign new_n81_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n82_ = new_n77_ & new_n83_;
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n85_ | new_n87_)) | (~x05 & ~x16 & ~x18) | (x18 & ~x21);
  assign new_n85_ = x29 & (new_n71_ | (~x18 & (~new_n66_ | ~new_n86_)));
  ...
  assign new_n92_ = new_n63_ & (x19 | (new_n66_ & new_n90_ & ~x25 & ~x26));
  assign new_n93_ = new_n88_ & new_n89_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = (x16 & (new_n95_ | new_n97_)) | (~x03 & ~x16 & ~x18) | (x18 & ~x21);
  assign new_n95_ = x31 & (new_n71_ | (~x18 & (~new_n72_ | ~new_n96_)));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n63_ & new_n66_ & new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n100_ | new_n102_));
  assign new_n100_ = x32 & (~new_n63_ | (~x19 & (~new_n72_ | ~new_n101_)));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n63_ & new_n66_ & new_n86_ & new_n103_ & ~x29 & ~x30;
  assign new_n103_ = ~x31 & ~x32;
  assign z14 = ~new_n109_ | (x16 & (new_n105_ | (new_n67_ & new_n107_ & new_n108_)));
  assign new_n105_ = x33 & (new_n71_ | (~x18 & (~new_n76_ | ~new_n106_)));
  assign new_n106_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n107_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n109_ = (~x18 | x21) & (x01 | x16 | x18);
  assign z15 = (x16 & (new_n111_ | (new_n67_ & new_n112_))) | x18 | (~x00 & ~x16);
  assign new_n111_ = x34 & (~new_n63_ | (~x19 & (~new_n76_ | ~new_n90_ | ~new_n108_)));
