...
module FAU ( 
  ...
  assign z10 = x18 ? x33 : (x16 ? (new_n84_ | new_n86_) : ~x05);
  ...
  assign z11 = x18 ? x33 : (x16 ? (new_n91_ | new_n93_) : ~x04);
  assign new_n91_ = x30 & (~new_n57_ | (~x19 & (~new_n67_ | ~new_n92_)));
  assign new_n92_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n93_ = new_n87_ & new_n88_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n97_ | (~new_n95_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n95_ = new_n57_ & (x19 | (new_n71_ & new_n96_));
  ...
  assign z14 = (x16 & (new_n105_ | (new_n68_ & new_n107_))) | (~x01 & ~x16) | x18;
  ...
  assign z15 = (x16 & (new_n110_ | (new_n68_ & new_n111_))) | (~x00 & ~x16) | x18;
