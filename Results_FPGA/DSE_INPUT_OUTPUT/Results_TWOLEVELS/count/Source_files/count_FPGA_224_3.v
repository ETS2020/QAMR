...
module FAU ( 
  ...
  assign z09 = x18 ? ~x15 : (x16 ? (new_n79_ | new_n81_) : ~x06);
  assign new_n79_ = x28 & (~new_n56_ | (~x19 & (~new_n64_ | ~new_n80_)));
  assign new_n80_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n81_ = new_n76_ & new_n82_;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? ~x15 : (x16 ? (new_n84_ | new_n86_) : ~x05);
  ...
  assign z11 = x18 ? ~x15 : (x16 ? (new_n91_ | new_n93_) : ~x04);
  assign new_n91_ = x30 & (~new_n56_ | (~x19 & (~new_n65_ | ~new_n92_)));
  assign new_n92_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n93_ = new_n87_ & new_n88_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = (x16 & (new_n97_ | (~new_n95_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n95_ = new_n56_ & (x19 | (new_n71_ & new_n96_));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n56_ & new_n65_ & new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n100_ | new_n102_));
  assign new_n100_ = x32 & (~new_n56_ | (~x19 & (~new_n71_ | ~new_n101_)));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n85_ & new_n103_ & new_n56_ & new_n65_;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n105_ | (new_n68_ & new_n107_))) | x18 | (~x01 & ~x16);
  assign new_n105_ = x33 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n106_)));
  assign new_n106_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n107_ = new_n108_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = (x16 & (new_n110_ | (new_n68_ & new_n111_))) | x18 | (~x00 & ~x16);
