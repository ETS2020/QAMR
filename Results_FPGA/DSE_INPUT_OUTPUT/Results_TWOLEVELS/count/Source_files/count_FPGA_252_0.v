...
module FAU ( 
  ...
  assign new_n85_ = x08 & ~x18 & (x06 | x16);
  assign z10 = (x16 & (new_n87_ | new_n89_)) | ~x08 | x18 | (~x05 & ~x16);
  ...
  assign z12 = ~new_n103_ | (x16 & (new_n101_ | (x31 & (new_n99_ | ~new_n58_))));
  assign new_n99_ = ~x19 & (~new_n100_ | x26 | x27 | ~new_n96_ | x28);
  ...
  assign new_n107_ = new_n58_ & new_n68_ & new_n88_ & new_n96_ & ~x31 & ~x32;
  assign z14 = x18 | (x08 & (x16 ? (new_n109_ | new_n111_) : ~x01));
  ...
  assign z15 = x18 | (x08 & (x16 ? (new_n115_ | new_n116_) : ~x00));
  assign new_n115_ = x34 & (~new_n58_ | (~x19 & (~new_n77_ | ~new_n92_ | ~new_n113_)));
  assign new_n116_ = new_n59_ & new_n70_ & new_n112_ & new_n117_;
