...
module FAU ( 
  ...
  assign new_n75_ = new_n64_ & (x18 | (new_n76_ & new_n77_));
  ...
  assign new_n80_ = new_n60_ & new_n81_ & ~x23 & ~x24 & ~x25;
  assign new_n81_ = ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n84_ | (~new_n83_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n83_ = new_n64_ & (x18 | (new_n65_ & new_n81_ & ~x24 & ~x25));
  assign new_n84_ = new_n61_ & new_n85_ & new_n86_;
  assign new_n85_ = ~x24 & ~x25 & ~x26;
  assign new_n86_ = ~x27 & ~x28 & ~x29;
  assign z11 = x16 ? (~new_n88_ & ~x18) : (~x04 | x18);
  assign new_n88_ = (~x30 | (new_n61_ & new_n85_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n85_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n90_ | (new_n66_ & new_n93_))) | x18 | (~x03 & ~x16);
  assign new_n90_ = x31 & (~new_n64_ | (~x18 & (~new_n91_ | ~new_n92_)));
  ...
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n96_ | new_n99_));
  assign new_n96_ = x32 & (~new_n64_ | (~x18 & (~new_n97_ | ~new_n98_)));
  assign new_n97_ = ~x23 & ~x24 & ~x25 & ~x20 & ~x21 & ~x22;
  ...
  assign z15 = ~new_n109_ | (x16 & ((new_n69_ & new_n108_) | (~new_n107_ & x34)));
  assign new_n107_ = new_n64_ & (x18 | (new_n76_ & new_n77_ & new_n86_ & new_n105_));
