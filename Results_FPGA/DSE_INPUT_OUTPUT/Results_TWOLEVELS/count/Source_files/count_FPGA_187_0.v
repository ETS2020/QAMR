...
module FAU ( 
  ...
  assign z05 = (x24 & (~new_n56_ | new_n63_)) | ~x16 | x18 | (new_n56_ & new_n64_);
  assign new_n63_ = ~x19 & (x21 | x22 | x23);
  assign new_n64_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (~new_n66_ & x25) | ~x16 | new_n67_ | x18;
  assign new_n66_ = new_n56_ & (new_n64_ | x19);
  assign new_n67_ = new_n57_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = new_n69_ | x18;
  assign new_n69_ = x16 & ((new_n57_ & new_n71_) | ((~new_n56_ | new_n70_) & x26));
  assign new_n70_ = ~x19 & (x21 | x22 | x23 | x24 | x25);
  assign new_n71_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (x27 & (~new_n56_ | (~new_n76_ & ~x19))) | ~new_n73_ | ~x16;
  assign new_n73_ = ~x18 & (~new_n74_ | x23 | x24 | ~new_n75_ | x25);
  ...
  assign new_n80_ = new_n74_ & new_n81_;
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = new_n83_ | ~x16 | x18 | (new_n85_ & new_n86_ & new_n87_);
  ...
  assign new_n89_ = new_n56_ & (x19 | (new_n64_ & new_n87_ & ~x25 & ~x26));
  assign new_n90_ = new_n85_ & new_n86_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (x16 & (new_n94_ | (x31 & (new_n92_ | ~new_n56_))));
  assign new_n92_ = ~x19 & (~new_n93_ | ~new_n75_ | x28 | x29 | x30);
  assign new_n93_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n94_ = new_n56_ & new_n64_ & new_n95_ & new_n75_ & ~x25;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (new_n97_ | new_n99_));
  assign new_n97_ = x32 & (~new_n56_ | (~x19 & (~new_n93_ | ~new_n98_)));
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n99_ = new_n56_ & new_n64_ & new_n84_ & new_n100_ & ~x29 & ~x30;
  assign new_n100_ = ~x31 & ~x32;
  assign z14 = new_n102_ | ~x16 | x18 | (new_n67_ & new_n104_ & new_n105_);
  assign new_n102_ = x33 & (~new_n56_ | (~x19 & (~new_n76_ | ~new_n103_)));
  assign new_n103_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x16 & (new_n107_ | (new_n67_ & new_n108_)));
