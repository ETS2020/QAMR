...
module FAU ( 
  ...
  assign z05 = (~new_n68_ & x16) | ~x10 | x18;
  assign new_n68_ = (~x24 | (new_n64_ & ~new_n69_)) & (~new_n58_ | ~new_n70_);
  assign new_n69_ = x10 & (x20 | x21 | x22 | x23);
  ...
  assign new_n76_ = (~new_n59_ | ~new_n78_) & (~x26 | (new_n64_ & (new_n77_ | ~x10)));
