...
module FAU ( 
  ...
  assign z06 = (~x09 & (~x16 | x18)) | (x16 & ~x18 & (new_n68_ | (~new_n66_ & x25)));
  assign new_n66_ = new_n57_ & (new_n67_ | x19);
  ...
  assign z10 = x18 ? ~x09 : (x16 ? (new_n85_ | new_n87_) : ~x05);
  ...
  assign new_n93_ = new_n88_ & new_n89_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 ? ~x09 : (x16 ? (new_n95_ | new_n97_) : ~x03);
  ...
  assign z13 = x18 ? ~x09 : (x16 ? (new_n100_ | new_n102_) : ~x02);
  ...
  assign z14 = x18 ? ~x09 : (x16 ? (new_n105_ | new_n107_) : ~x01);
  ...
  assign z15 = x18 ? ~x09 : (x16 ? (new_n111_ | new_n112_) : ~x00);
