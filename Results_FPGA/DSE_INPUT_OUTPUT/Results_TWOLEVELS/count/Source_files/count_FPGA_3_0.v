...
module FAU ( 
  ...
  assign new_n64_ = (new_n62_ | ~x23) & (~new_n65_ | x17);
  assign new_n65_ = ~x19 & ~x20 & ~x21 & ~x22 & ~x23 & x29;
  assign z05 = (~new_n54_ & x18) | (~new_n67_ & x16) | new_n54_ | (~x10 & ~x16);
  assign new_n67_ = (new_n69_ | ~x24) & (x17 | ~new_n68_ | x19);
  assign new_n68_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & x29;
  ...
  assign new_n72_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & x29;
  ...
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & x29;
  assign new_n77_ = x26 & (~new_n61_ | x22 | x23 | x24 | x25);
  assign z08 = new_n79_ | (x16 & (new_n83_ | (x29 & (new_n80_ | new_n82_))));
  assign new_n79_ = ~new_n54_ & (x18 | (~x07 & ~x16));
  assign new_n80_ = ~x17 & ~x19 & ~x20 & new_n81_ & ~x21;
  assign new_n81_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n82_ = x27 & (~new_n61_ | x22 | x24 | x25 | x26);
  assign new_n83_ = x23 & x27;
  assign z09 = new_n85_ | new_n86_ | (~x06 & ~x16) | (x16 & ~new_n89_ & x28);
  assign new_n85_ = ~new_n54_ & x18;
  assign new_n86_ = ~x23 & (~x29 | (new_n87_ & new_n88_));
  assign new_n87_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n88_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & x29;
  assign new_n89_ = new_n62_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z10 = (~new_n93_ & (x23 | x29)) | (x16 & x29 & (new_n91_ | ~new_n69_));
  assign new_n91_ = ~x17 & ~x19 & ~x20 & ~x21 & new_n92_ & ~x22;
  assign new_n92_ = ~x23 & (x24 | (~x24 & (x25 | (~x25 & (x26 | (~x26 & (x27 | (~x27 & x28))))))));
