...
module FAU ( 
  ...
  assign new_n61_ = (~x23 | (~x19 & ~x20 & (x19 | (~x21 & ~x22)))) & (x17 | x19 | x20 | x21 | x22 | x23);
  ...
  assign z07 = (x17 & (x18 | (x16 & x26))) | (~x18 & (x16 ? ~new_n70_ : ~x08));
  assign new_n70_ = (~new_n57_ | ~new_n72_) & (~x26 | (~x19 & ~x20 & (new_n71_ | x19)));
  ...
  assign new_n90_ = x17 & (x18 | (x16 & x29));
  assign z11 = (x16 & (new_n93_ | (~new_n92_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n92_ = new_n56_ & (x19 | (new_n65_ & new_n89_ & ~x25 & ~x26));
  ...
  assign new_n96_ = x31 & (x19 | x20 | (~x19 & (~new_n71_ | ~new_n97_)));
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n98_ = new_n56_ & new_n65_ & new_n99_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n100_ = x17 & (x18 | (x16 & x31));
  assign z13 = new_n106_ | (~x18 & (x16 ? (new_n102_ | new_n104_) : ~x02));
  assign new_n102_ = x32 & (x19 | x20 | (~x19 & (~new_n71_ | ~new_n103_)));
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n104_ = new_n56_ & new_n65_ & new_n86_ & new_n105_ & ~x29 & ~x30;
  assign new_n105_ = ~x31 & ~x32;
  assign new_n106_ = x17 & (x18 | (x16 & x32));
  ...
  assign new_n113_ = x34 & (~new_n56_ | (~x19 & (~new_n75_ | ~new_n89_ | ~new_n111_)));
