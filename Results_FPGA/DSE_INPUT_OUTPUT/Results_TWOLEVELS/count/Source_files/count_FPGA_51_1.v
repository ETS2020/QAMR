...
module FAU ( 
  ...
  assign z06 = x18 ? x05 : (x16 ? (new_n69_ | new_n70_) : ~x09);
  ...
  assign z08 = x18 ? x05 : (x16 ? ~new_n77_ : ~x07);
  ...
  assign z09 = x18 ? x05 : (x16 ? (new_n82_ | new_n84_) : ~x06);
  ...
  assign z10 = x18 ? x05 : (x16 ? (new_n87_ | (~new_n84_ & x29)) : ~x05);
  ...
  assign new_n92_ = new_n58_ & (x19 | (new_n67_ & new_n90_ & ~x25 & ~x26));
  assign new_n93_ = new_n88_ & new_n89_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n97_ | (~new_n95_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n95_ = new_n58_ & (x19 | (new_n74_ & new_n96_));
  assign new_n96_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = new_n58_ & new_n67_ & new_n98_ & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? x05 : (x16 ? (new_n100_ | new_n102_) : ~x02);
  assign new_n100_ = x32 & (~new_n58_ | (~x19 & (~new_n74_ | ~new_n101_)));
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n58_ & new_n67_ & new_n103_ & new_n104_;
  assign new_n103_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n104_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n106_ | (new_n70_ & new_n108_))) | (~x01 & ~x16) | x18;
  assign new_n106_ = x33 & (~new_n58_ | (~x19 & (~new_n78_ | ~new_n107_)));
  ...
  assign z15 = x18 ? x05 : (x16 ? (new_n112_ | new_n113_) : ~x00);
  assign new_n112_ = x34 & (~new_n58_ | (~x19 & (~new_n78_ | ~new_n90_ | ~new_n110_)));
  assign new_n113_ = new_n59_ & new_n71_ & new_n109_ & new_n114_;
