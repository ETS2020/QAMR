...
module FAU ( 
  ...
  assign new_n67_ = new_n58_ & new_n68_ & ~x24 & ~x25;
  assign new_n68_ = ~x22 & ~x23;
  assign z07 = (~new_n70_ & x16) | x18 | (~x08 & ~x16);
  assign new_n70_ = (~x26 | (new_n58_ & new_n68_ & ~x24 & ~x25)) & (~new_n58_ | ~new_n68_ | x24 | x25 | x26);
  assign z08 = x18 ? x33 : (x16 ? ~new_n72_ : ~x07);
  assign new_n72_ = (~x27 | (new_n58_ & new_n68_ & new_n73_)) & (~new_n60_ | ~new_n74_);
  assign new_n73_ = ~x24 & ~x25 & ~x26;
  assign new_n74_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 ? x33 : (x16 ? ~new_n76_ : ~x06);
  assign new_n76_ = (~x28 | (new_n60_ & new_n74_)) & (~new_n60_ | ~new_n77_);
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? x33 : (x16 ? (new_n79_ | new_n80_) : ~x05);
  assign new_n79_ = x29 & (~new_n60_ | ~new_n77_);
  assign new_n80_ = new_n62_ & new_n73_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n82_ & x16) | x18 | (~x04 & ~x16);
  assign new_n82_ = (~x30 | (new_n62_ & new_n73_ & ~x27 & ~x28 & ~x29)) & (~new_n62_ | ~new_n73_ | x27 | x28 | x29 | x30);
  assign z12 = x18 ? x33 : (x16 ? (new_n84_ | new_n86_) : ~x03);
  assign new_n84_ = x31 & (~new_n62_ | ~new_n73_ | ~new_n85_);
  assign new_n85_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n86_ = new_n57_ & new_n65_ & new_n87_ & ~x25 & ~x26 & ~x27;
  assign new_n87_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n89_ | (~new_n86_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n89_ = new_n57_ & new_n65_ & new_n90_ & new_n91_;
  assign new_n90_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n91_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n95_ | (x16 & ((~new_n89_ & x33) | (new_n67_ & new_n93_)));
  assign new_n93_ = new_n94_ & ~x32 & ~x33 & ~x30 & ~x31;
  assign new_n94_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = ~x18 & (x01 | x16);
  assign z15 = new_n100_ | (~x18 & (x16 ? (new_n97_ | new_n98_) : ~x00));
  assign new_n97_ = x34 & (~new_n57_ | ~new_n65_ | ~new_n90_ | ~new_n91_);
  assign new_n98_ = new_n94_ & new_n99_ & new_n58_ & new_n68_ & ~x24 & ~x25;
  assign new_n99_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n100_ = x33 & (x18 | (x16 & x34));
endmodule
