...
module FAU ( 
  ...
  assign new_n61_ = (~x24 | (new_n62_ & (new_n63_ | x19))) & (~new_n62_ | ~new_n64_);
  ...
  assign z15 = ~new_n114_ | (x34 & (new_n113_ | ~new_n84_));
  assign new_n113_ = x16 & (x20 | (~x19 & (~new_n76_ | ~new_n90_ | ~new_n111_)));
  assign new_n114_ = x16 & ~x18 & (~new_n68_ | ~new_n69_ | ~new_n110_ | ~new_n115_);
