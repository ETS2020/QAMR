...
module FAU ( 
  ...
  assign new_n55_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20 | ~x29);
  assign new_n56_ = ~x18 & x29;
  assign z02 = (~new_n58_ & x16) | ~new_n56_ | (~x13 & ~x16);
  assign new_n58_ = (x17 | x19 | x20 | x21 | ~x29) & (~x21 | (~x17 & ~x19 & ~x20));
  ...
  assign z05 = (~new_n66_ & x16) | ~new_n56_ | (~x10 & ~x16);
  assign new_n66_ = (x17 | ~new_n67_ | x19) & (new_n68_ | ~x24);
  assign new_n67_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & x29;
  ...
  assign new_n76_ = x26 & (~new_n77_ | x22 | x23 | x24 | x25);
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z08 = x18 | (x29 & (x16 ? (new_n79_ | new_n81_) : ~x07));
  assign new_n79_ = ~x17 & ~x19 & ~x20 & new_n80_ & ~x21;
  assign new_n80_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n81_ = x27 & (~new_n77_ | ~new_n82_ | x22 | x23);
  assign new_n82_ = ~x24 & ~x25 & ~x26;
  assign z09 = (x16 & (new_n85_ | (~new_n84_ & x28))) | ~new_n56_ | (~x06 & ~x16);
  assign new_n84_ = new_n63_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n85_ = new_n68_ & new_n82_ & ~x27 & ~x28 & x29;
  ...
  assign z11 = ~new_n56_ | (~x04 & ~x16) | (x16 & x30);
  assign z12 = ~new_n56_ | (~x03 & ~x16) | (x16 & x31);
