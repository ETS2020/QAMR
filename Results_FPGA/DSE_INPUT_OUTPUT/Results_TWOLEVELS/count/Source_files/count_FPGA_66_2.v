...
module FAU ( 
  ...
  assign z07 = x18 ? x32 : (x16 ? ~new_n71_ : ~x08);
  ...
  assign z10 = x18 ? x32 : (x16 ? (new_n85_ | new_n87_) : ~x05);
  ...
  assign new_n93_ = new_n88_ & new_n89_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 ? x32 : (x16 ? (new_n95_ | new_n97_) : ~x03);
  ...
  assign new_n105_ = x33 & (~new_n57_ | (~x19 & (~new_n72_ | ~new_n101_)));
  assign new_n106_ = new_n58_ & new_n69_ & new_n107_ & new_n108_;
  assign new_n107_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n109_ = x32 & (x18 | (x16 & x33));
  assign z15 = (x16 & (new_n111_ | (new_n68_ & new_n112_))) | x18 | (~x00 & ~x16);
  assign new_n111_ = x34 & (~new_n57_ | (~x19 & (~new_n76_ | ~new_n90_ | ~new_n108_)));
