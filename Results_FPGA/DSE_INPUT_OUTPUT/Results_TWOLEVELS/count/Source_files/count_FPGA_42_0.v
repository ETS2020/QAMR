...
module FAU ( 
  ...
  assign z06 = x18 | (x26 & (x16 ? ~new_n67_ : ~x09));
  assign new_n67_ = (~x25 | (new_n68_ & new_n70_)) & (~new_n69_ | ~new_n71_);
  ...
  assign new_n73_ = x26 & (x16 ? (x17 | x19 | (~x17 & ~new_n74_ & ~x19)) : ~x08);
  assign new_n74_ = ~x20 & (x20 | (~x21 & (x21 | (~x22 & (x22 | (~x23 & (x23 | (~x24 & (x24 | ~x25)))))))));
