...
module FAU ( 
  ...
  assign new_n63_ = (~x24 | (~new_n64_ & ~x17 & ~x19)) & (~new_n65_ | x17 | x19 | x20);
  assign new_n64_ = ~x18 & (x20 | (~x19 & (x21 | x22 | x23)));
  assign new_n65_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = x18 ? x08 : (x16 ? (new_n67_ | new_n69_) : ~x09);
  assign new_n67_ = x25 & (~new_n68_ | (~new_n65_ & ~x19));
  assign new_n68_ = ~x17 & ~x19 & ~x20;
  assign new_n69_ = new_n70_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n70_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z07 = x18 ? x08 : (x16 ? ~new_n72_ : ~x08);
  assign new_n72_ = (~new_n70_ | ~new_n74_) & (~x26 | (new_n68_ & (new_n73_ | x19)));
  assign new_n73_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n74_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (x16 & (new_n78_ | (~new_n76_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n76_ = ~x17 & ~x19 & (x18 | (new_n77_ & (new_n73_ | x19)));
  assign new_n77_ = ~x20 & ~x26;
  assign new_n78_ = new_n79_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z09 = x18 ? x08 : (x16 ? ~new_n81_ : ~x06);
  assign new_n81_ = (~x28 | (new_n83_ & (new_n82_ | x19))) & (~new_n79_ | ~new_n84_);
  assign new_n82_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x27;
  assign new_n83_ = ~x17 & ~x19 & ~x20 & ~x26;
  assign new_n84_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? x08 : (x16 ? (new_n86_ | new_n89_) : ~x05);
  assign new_n86_ = x29 & (~new_n83_ | (~x19 & (~new_n87_ | ~new_n88_)));
  assign new_n87_ = ~x21 & ~x22 & ~x23;
  assign new_n88_ = ~x24 & ~x25 & ~x27 & ~x28;
  assign new_n89_ = new_n61_ & new_n90_ & ~x27 & ~x28 & ~x29;
  assign new_n90_ = ~x24 & ~x25 & ~x26;
  assign z11 = (x16 & (new_n94_ | (~new_n92_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n92_ = ~x17 & ~x19 & (x18 | (new_n77_ & (x19 | (new_n65_ & new_n93_))));
  assign new_n93_ = ~x25 & ~x27 & ~x28 & ~x29;
  assign new_n94_ = new_n61_ & new_n90_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = (x16 & (new_n98_ | (~new_n96_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n96_ = ~x17 & ~x19 & (x18 | (new_n77_ & (x19 | (new_n65_ & new_n97_))));
  assign new_n97_ = ~x25 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n98_ = new_n68_ & new_n65_ & new_n99_ & ~x25 & ~x26 & ~x27;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n106_ | (x16 & ((new_n101_ & new_n104_) | (~new_n102_ & x32)));
  assign new_n101_ = new_n68_ & new_n65_;
  assign new_n102_ = ~x17 & ~x19 & (x18 | (new_n77_ & (x19 | (new_n73_ & new_n103_))));
  assign new_n103_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n104_ = new_n105_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n106_ = ~x18 & (x02 | x16);
  assign z14 = ~new_n112_ | (x16 & ((new_n69_ & new_n110_) | (~new_n108_ & x33)));
  assign new_n108_ = ~x17 & ~x19 & (x18 | (new_n77_ & (x19 | (new_n73_ & new_n109_))));
  assign new_n109_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n110_ = new_n111_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n111_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n112_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n117_ | (x16 & ((new_n69_ & new_n116_) | (~new_n114_ & x34)));
  assign new_n114_ = ~x17 & ~x19 & (x18 | (new_n77_ & (x19 | (new_n82_ & new_n115_))));
