...
module FAU ( 
  ...
  assign z02 = (x18 & (x20 | x21)) | (x16 & ~new_n58_ & x21) | (~x20 & ~x21) | (~x13 & ~x16);
  assign new_n58_ = ~x17 & ~x19 & ~x20;
  assign z03 = (x20 | x21) & ((~x12 & ~x16) | x18 | (x16 & x22));
  assign z04 = (x18 & (x20 | x21)) | (~x11 & ~x16) | (~x20 & ~x21) | (x16 & x23);
  assign z05 = (x20 | x21) & ((~x10 & ~x16) | x18 | (x16 & x24));
  assign z06 = (x18 & (x20 | x21)) | (~x09 & ~x16) | (~x20 & ~x21) | (x16 & x25);
  assign z07 = (x20 | x21) & ((~x08 & ~x16) | x18 | (x16 & x26));
  assign z08 = (x18 & (x20 | x21)) | (~x07 & ~x16) | (~x20 & ~x21) | (x16 & x27);
  assign z09 = (x18 & (x20 | x21)) | (~x06 & ~x16) | (~x20 & ~x21) | (x16 & x28);
  assign z10 = (x18 & (x20 | x21)) | (~x05 & ~x16) | (~x20 & ~x21) | (x16 & x29);
  assign z11 = (x18 & (x20 | x21)) | (~x04 & ~x16) | (~x20 & ~x21) | (x16 & x30);
  assign z12 = (x20 | x21) & ((~x03 & ~x16) | x18 | (x16 & x31));
  assign z13 = (x18 & (x20 | x21)) | (~x02 & ~x16) | (~x20 & ~x21) | (x16 & x32);
