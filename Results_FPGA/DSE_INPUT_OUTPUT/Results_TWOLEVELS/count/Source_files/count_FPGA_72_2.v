...
module FAU ( 
  ...
  assign z06 = (x16 & (new_n67_ | new_n68_)) | x18 | (~x09 & ~x16);
  assign new_n67_ = x25 & (~new_n61_ | (~x18 & ~new_n65_ & ~x19));
  ...
  assign new_n72_ = x26 & (~new_n61_ | (~x18 & ~new_n73_ & ~x19));
  ...
  assign z11 = ~new_n97_ | (x16 & (new_n95_ | (x30 & (new_n94_ | ~new_n61_))));
  assign new_n94_ = ~x18 & ~x19 & (~new_n65_ | ~new_n91_ | x25 | x26);
  assign new_n95_ = new_n90_ & new_n96_ & ~x24 & ~x25 & ~x26;
  assign new_n96_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n97_ = ~x18 & (x04 | x16);
  assign z12 = (x16 & (new_n99_ | new_n101_)) | x18 | (~x03 & ~x16);
  assign new_n99_ = x31 & (~new_n61_ | (~x18 & ~x19 & (~new_n73_ | ~new_n100_)));
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n101_ = new_n61_ & new_n65_ & new_n102_ & ~x25 & ~x26 & ~x27;
  assign new_n102_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = (x16 & (new_n104_ | new_n106_)) | x18 | (~x02 & ~x16);
  assign new_n104_ = x32 & (~new_n61_ | (~x18 & ~x19 & (~new_n73_ | ~new_n105_)));
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n106_ = new_n61_ & new_n65_ & new_n88_ & new_n107_;
  assign new_n107_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = (x16 & (new_n109_ | (new_n68_ & new_n111_))) | x18 | (~x01 & ~x16);
  assign new_n109_ = x33 & (~new_n61_ | (~x18 & ~x19 & (~new_n77_ | ~new_n110_)));
  ...
  assign new_n115_ = x34 & (x17 | x19 | (~x19 & (~new_n77_ | ~new_n91_ | ~new_n113_)));
  assign new_n116_ = new_n69_ & new_n70_ & new_n112_ & new_n117_;
