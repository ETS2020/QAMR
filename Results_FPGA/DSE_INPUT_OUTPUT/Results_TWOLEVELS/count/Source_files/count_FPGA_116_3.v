...
module FAU ( 
  ...
  assign new_n67_ = (~x24 | (new_n58_ & (x19 | (~x21 & ~x22 & ~x23)))) & (~new_n58_ | x21 | x22 | x23 | x24);
  assign z06 = (x16 & (new_n69_ | (new_n59_ & new_n71_))) | x18 | (~x09 & ~x16);
  assign new_n69_ = x25 & (~new_n64_ | (~new_n70_ & ~x18));
  assign new_n70_ = ~x22 & ~x23 & ~x24 & ~x20 & ~x21;
  ...
  assign new_n75_ = new_n59_ & new_n76_ & ~x24 & ~x25 & ~x26;
  assign new_n76_ = ~x22 & ~x23;
  assign z08 = (~x07 & (~x16 | x18)) | (x16 & ~x18 & (new_n78_ | new_n80_));
  assign new_n78_ = x27 & (~new_n58_ | (~new_n79_ & ~x19));
  assign new_n79_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n80_ = new_n81_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n81_ = ~x20 & ~x21 & ~x22 & ~x17 & ~x19;
  assign z09 = x18 ? ~x07 : (x16 ? (new_n83_ | new_n85_) : ~x06);
  assign new_n83_ = x28 & (~new_n58_ | (~x19 & (~new_n84_ | ~new_n76_ | x21)));
  assign new_n84_ = ~x26 & ~x27 & ~x24 & ~x25;
  assign new_n85_ = new_n81_ & new_n86_ & ~x23 & ~x24 & ~x25;
  assign new_n86_ = ~x26 & ~x27 & ~x28;
  assign z10 = ~new_n92_ | (x16 & (new_n90_ | (x29 & (new_n88_ | ~new_n64_))));
  assign new_n88_ = ~x18 & (~new_n89_ | ~new_n76_ | x20 | x21);
  assign new_n89_ = ~x26 & ~x27 & ~x28 & ~x24 & ~x25;
  ...
  assign new_n94_ = new_n64_ & (x18 | (new_n70_ & new_n91_ & ~x25 & ~x26));
  assign new_n95_ = new_n65_ & new_n96_ & ~x24 & ~x25 & ~x26;
  assign new_n96_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n100_ | (new_n98_ & new_n102_)));
  assign new_n98_ = new_n58_ & new_n99_;
  assign new_n99_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign new_n100_ = x31 & (~new_n64_ | (~x18 & (~new_n70_ | ~new_n101_)));
  assign new_n101_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n102_ = new_n103_ & ~x25 & ~x26 & ~x27;
  assign new_n103_ = ~x30 & ~x31 & ~x28 & ~x29;
  assign z13 = x18 ? ~x07 : (x16 ? (new_n105_ | new_n108_) : ~x02);
  assign new_n105_ = x32 & (~new_n58_ | (~x19 & (~new_n106_ | ~new_n107_)));
  assign new_n106_ = ~x23 & ~x24 & ~x25 & ~x21 & ~x22;
  assign new_n107_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n108_ = new_n58_ & new_n99_ & new_n109_ & new_n110_;
  assign new_n109_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n110_ = ~x31 & ~x32 & ~x29 & ~x30;
  assign z14 = x18 ? ~x07 : (x16 ? (new_n112_ | new_n114_) : ~x01);
  assign new_n112_ = x33 & (~new_n58_ | (~x19 & (~new_n79_ | ~new_n113_)));
  assign new_n113_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n114_ = new_n59_ & new_n71_ & new_n115_ & new_n116_;
  assign new_n115_ = ~x28 & ~x29 & ~x26 & ~x27;
  assign new_n116_ = ~x32 & ~x33 & ~x30 & ~x31;
  assign z15 = x18 ? ~x07 : (x16 ? (new_n118_ | new_n119_) : ~x00);
  assign new_n118_ = x34 & (~new_n58_ | (~x19 & (~new_n79_ | ~new_n91_ | ~new_n116_)));
  assign new_n119_ = new_n59_ & new_n71_ & new_n115_ & new_n120_;
