...
module FAU ( 
  ...
  assign z05 = x18 ? ~x34 : (x16 ? ~new_n66_ : ~x10);
  ...
  assign new_n70_ = new_n58_ & new_n71_ & ~x24 & ~x25;
  assign new_n71_ = ~x22 & ~x23;
  assign z07 = x18 ? ~x34 : (x16 ? ~new_n73_ : ~x08);
  assign new_n73_ = (~x26 | (new_n58_ & new_n71_ & ~x24 & ~x25)) & (~new_n58_ | ~new_n71_ | x24 | x25 | x26);
  ...
  assign z09 = x18 ? ~x34 : (x16 ? (new_n80_ | new_n81_) : ~x06);
  assign new_n80_ = x28 & (~new_n61_ | ~new_n78_ | x23 | x24);
  assign new_n81_ = new_n61_ & new_n82_;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? ~x34 : (x16 ? ~new_n84_ : ~x05);
  assign new_n84_ = (~x29 | (new_n61_ & new_n82_)) & (~new_n64_ | ~new_n85_ | ~new_n86_);
  assign new_n85_ = ~x24 & ~x25 & ~x26;
  assign new_n86_ = ~x27 & ~x28 & ~x29;
  assign z11 = ~new_n93_ | (x16 & (new_n90_ | (x30 & (new_n88_ | ~new_n92_))));
  assign new_n88_ = ~x18 & (x20 | (~x19 & (~new_n67_ | ~new_n89_ | ~new_n86_)));
  assign new_n89_ = ~x25 & ~x26;
  assign new_n90_ = new_n64_ & new_n85_ & new_n91_ & ~x29 & ~x30;
  assign new_n91_ = ~x27 & ~x28;
  assign new_n92_ = ~x17 & ~x19;
  assign new_n93_ = ~x18 & (x04 | x16);
  assign z12 = x18 ? ~x34 : (x16 ? (new_n95_ | new_n96_) : ~x03);
  assign new_n95_ = x31 & (~new_n64_ | ~new_n85_ | ~new_n91_ | x29 | x30);
  assign new_n96_ = new_n57_ & new_n67_ & new_n78_ & new_n97_;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? ~x34 : (x16 ? (new_n99_ | new_n100_) : ~x02);
  assign new_n99_ = x32 & (~new_n57_ | ~new_n67_ | ~new_n78_ | ~new_n97_);
  assign new_n100_ = new_n57_ & new_n67_ & new_n101_ & new_n89_ & new_n91_;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? ~x34 : (x16 ? (new_n103_ | new_n104_) : ~x01);
  assign new_n103_ = x33 & (~new_n57_ | ~new_n67_ | ~new_n101_ | ~new_n89_ | ~new_n91_);
  assign new_n104_ = new_n105_ & new_n106_ & new_n58_ & new_n71_ & ~x24 & ~x25;
  assign new_n105_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n111_ | (x16 & (new_n109_ | (x34 & (new_n108_ | ~new_n92_))));
  assign new_n108_ = ~x18 & (x20 | (~x19 & (~new_n76_ | ~new_n86_ | ~new_n106_)));
  assign new_n109_ = new_n105_ & new_n110_ & new_n58_ & new_n71_ & ~x24 & ~x25;
