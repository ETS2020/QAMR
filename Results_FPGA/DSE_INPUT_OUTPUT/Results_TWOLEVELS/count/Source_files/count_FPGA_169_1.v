...
module FAU ( 
  ...
  assign z03 = x18 | (~x32 & (x16 ? ~new_n60_ : ~x12));
  ...
  assign z09 = x18 | (~x32 & (x16 ? (new_n80_ | new_n82_) : ~x06));
  ...
  assign new_n85_ = x29 & (~new_n57_ | (~x19 & (~new_n66_ | ~new_n86_)));
  assign new_n86_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = new_n88_ & new_n89_ & ~x27 & ~x28 & ~x29;
  assign new_n88_ = ~x21 & ~x22 & ~x23 & ~x17 & ~x19 & ~x20;
  assign new_n89_ = ~x24 & ~x25 & ~x26;
  assign z11 = (x16 & (new_n93_ | (~new_n91_ & x30))) | ~new_n54_ | (~x04 & ~x16);
  assign new_n91_ = new_n57_ & (x19 | (new_n66_ & new_n92_));
  assign new_n92_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n93_ = new_n88_ & new_n89_ & new_n94_ & ~x27 & ~x28;
  assign new_n94_ = ~x29 & ~x30;
  assign z12 = (x16 & (new_n98_ | (~new_n96_ & x31))) | ~new_n54_ | (~x03 & ~x16);
  assign new_n96_ = new_n57_ & (x19 | (new_n72_ & new_n97_));
  assign new_n97_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n98_ = new_n57_ & new_n66_ & new_n86_ & new_n94_ & ~x31 & ~x32;
  assign z13 = x18 | (~x32 & ((~x02 & ~x16) | (new_n100_ & new_n102_)));
  assign new_n100_ = new_n101_ & x16 & ~x17 & ~x19;
  assign new_n101_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n102_ = new_n81_ & ~x30 & ~x31 & ~x28 & ~x29;
  assign z14 = x18 | (~x32 & (x16 ? (new_n104_ | new_n106_) : ~x01));
  assign new_n104_ = x33 & (~new_n57_ | (~x19 & (~new_n72_ | ~new_n105_)));
  assign new_n105_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n106_ = new_n57_ & new_n66_ & new_n86_ & new_n94_ & ~x31 & ~x33;
  assign z15 = x18 | (~x32 & (x16 ? (new_n108_ | new_n110_) : ~x00));
  assign new_n108_ = x34 & (~new_n57_ | (~x19 & (~new_n76_ | ~new_n109_)));
  assign new_n109_ = ~x30 & ~x31 & ~x33 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = new_n111_ & new_n112_ & new_n58_ & new_n69_;
  assign new_n111_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n112_ = ~x30 & ~x31 & ~x33 & ~x34;
endmodule
