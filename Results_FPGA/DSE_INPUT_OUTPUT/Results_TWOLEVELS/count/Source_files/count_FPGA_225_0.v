...
module FAU ( 
  ...
  assign new_n58_ = (x17 | x19 | x20 | x21 | ~x34) & (~x21 | (~x17 & ~x19 & ~x20));
  assign z03 = (~new_n60_ & x16) | ~new_n56_ | (~x12 & ~x16);
  assign new_n60_ = (x17 | x19 | x20 | x21 | x22 | ~x34) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  ...
  assign new_n74_ = (x17 | x19 | ~new_n77_ | x20) & (new_n75_ | ~x26);
  assign new_n75_ = new_n76_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n76_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n77_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (x16 & (new_n79_ | (~new_n81_ & x27))) | ~new_n56_ | (~x07 & ~x16);
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~x21 & new_n80_ & ~x22;
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & x34;
  assign new_n81_ = new_n76_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z09 = x18 | (x34 & (x16 ? ~new_n83_ : ~x06));
  assign new_n83_ = (new_n86_ | ~x28) & (~new_n84_ | x17);
  ...
  assign z10 = (~new_n89_ & x16) | ~new_n56_ | (~x05 & ~x16);
  assign new_n89_ = (x17 | ~new_n90_ | x19) & (~x29 | (new_n63_ & new_n92_));
  ...
  assign z11 = x18 | (x34 & (x16 ? ~new_n94_ : ~x04));
  assign new_n94_ = (x17 | ~new_n95_ | x19) & (~x30 | (new_n68_ & new_n97_));
  ...
  assign z12 = x18 | (x34 & (x16 ? ~new_n99_ : ~x03));
  assign new_n99_ = (new_n102_ | ~x31) & (x17 | x19 | ~new_n100_ | x20);
  assign new_n100_ = ~x21 & ~x22 & ~x23 & ~x24 & new_n101_ & ~x25;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n102_ = new_n68_ & new_n103_ & ~x24 & ~x25 & ~x26;
  ...
  assign new_n108_ = x32 & (~new_n109_ | ~new_n72_ | ~new_n87_ | ~new_n110_);
  assign new_n109_ = ~x17 & ~x19 & ~x20;
  assign new_n110_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z14 = ~new_n56_ | (~x01 & ~x16) | (x16 & (new_n115_ | (~new_n112_ & x33)));
  assign new_n112_ = new_n113_ & new_n109_ & new_n72_;
  assign new_n113_ = new_n114_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n114_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n115_ = new_n75_ & new_n116_ & ~x26 & ~x27 & ~x28 & ~x29;
