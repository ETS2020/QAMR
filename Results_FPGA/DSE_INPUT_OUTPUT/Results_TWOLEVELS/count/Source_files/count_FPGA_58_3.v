...
module FAU ( 
  ...
  assign new_n65_ = (~x24 | (new_n66_ & new_n67_)) & (~new_n66_ | ~new_n68_);
  ...
  assign new_n70_ = x25 & (x17 | x19 | (~x18 & (x20 | (~new_n68_ & ~x19))));
  assign new_n71_ = new_n59_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (x16 & (new_n73_ | (new_n59_ & new_n75_))) | x18 | (~x08 & ~x16);
  ...
  assign new_n77_ = (~x27 | (new_n59_ & new_n75_)) & (~new_n60_ | ~new_n78_);
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n82_ | (~new_n80_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n80_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n67_ & new_n81_))));
  assign new_n81_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n82_ = new_n60_ & new_n83_;
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? ~x33 : (new_n85_ | (~x05 & ~x16));
  assign new_n85_ = x16 & ((new_n63_ & new_n86_) | (x29 & (~new_n60_ | ~new_n83_)));
  assign new_n86_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n90_ | (~new_n88_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n88_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n68_ & new_n89_))));
  assign new_n89_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n90_ = new_n63_ & new_n91_ & ~x24 & ~x25 & ~x26;
  assign new_n91_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n95_ | (~new_n93_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n93_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n74_ & new_n94_))));
  assign new_n94_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n95_ = new_n66_ & new_n68_ & new_n96_ & new_n97_;
  assign new_n96_ = ~x25 & ~x26 & ~x27;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? ~x33 : (x16 ? (new_n99_ | new_n100_) : ~x02);
  assign new_n99_ = x32 & (~new_n66_ | ~new_n68_ | ~new_n96_ | ~new_n97_);
  assign new_n100_ = new_n66_ & new_n68_ & new_n101_ & new_n102_;
  assign new_n101_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n109_ | (x16 & ((new_n71_ & new_n107_) | (~new_n104_ & x33)));
  assign new_n104_ = ~x17 & ~x19 & (x18 | (~x20 & (x19 | (new_n105_ & new_n106_))));
  assign new_n105_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  ...
  assign z15 = ~new_n114_ | (x16 & ((new_n71_ & new_n113_) | (~new_n111_ & x34)));
  assign new_n111_ = new_n112_ & (x19 | (x33 ? x18 : (new_n105_ & new_n106_)));
  assign new_n112_ = ~x17 & ~x19 & (~x20 | x33);
