...
module FAU ( 
  ...
  assign new_n75_ = (~x27 | (new_n56_ & (new_n76_ | x19))) & (~new_n60_ | ~new_n77_);
  assign new_n76_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~x18 & (x16 ? (x27 & x28) : ~x06)) | (~x27 & (x18 | (~new_n79_ & x16)));
  assign new_n79_ = (~new_n60_ | ~new_n80_) & (~x28 | (new_n57_ & new_n73_));
  assign new_n80_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x28;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n82_ | new_n84_));
  assign new_n82_ = x29 & (~new_n56_ | (~x19 & (~new_n67_ | ~new_n83_)));
  ...
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (new_n89_ | new_n91_));
  assign new_n89_ = x30 & (~new_n56_ | (~x19 & (~new_n67_ | ~new_n90_)));
  assign new_n90_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = new_n85_ & new_n86_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = (x16 & (new_n93_ | new_n95_)) | (~x03 & ~x16 & ~x18) | (x18 & ~x27);
  assign new_n93_ = x31 & (new_n94_ | (~x27 & (~new_n57_ | ~new_n73_)));
  assign new_n94_ = ~x18 & (x27 | x28 | x29 | x30);
  assign new_n95_ = new_n56_ & new_n67_ & new_n96_ & ~x25 & ~x26 & ~x27;
  assign new_n96_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n98_ | new_n100_)) | (~x02 & ~x16 & ~x18) | (x18 & ~x27);
  assign new_n98_ = x32 & (new_n99_ | (~x27 & (~new_n57_ | ~new_n73_)));
  assign new_n99_ = ~x18 & (x27 | x28 | x29 | x30 | x31);
  assign new_n100_ = new_n56_ & new_n67_ & new_n83_ & new_n101_;
  ...
  assign z15 = ~new_n111_ | (x16 & ((new_n68_ & new_n109_) | (~new_n108_ & x34)));
  assign new_n108_ = (x27 | (new_n57_ & new_n73_)) & (x18 | (new_n87_ & new_n106_));
  assign new_n109_ = new_n110_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n111_ = (x00 | x16 | x18) & (~x18 | x27);
endmodule
