...
module FAU ( 
  ...
  assign z09 = x18 ? x06 : (x16 ? (new_n84_ | (~new_n82_ & x28)) : ~x06);
  ...
  assign new_n87_ = new_n88_ & (x19 | (new_n66_ & new_n83_ & ~x24 & ~x25));
  assign new_n88_ = ~x17 & ~x19 & ~x20 & (x18 | ~x28);
  ...
  assign new_n93_ = new_n88_ & (x19 | (new_n67_ & new_n94_ & ~x27 & ~x29));
  assign new_n94_ = ~x25 & ~x26;
  assign new_n95_ = new_n90_ & new_n91_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 ? x06 : (x16 ? (new_n97_ | new_n100_) : ~x03);
  assign new_n97_ = x31 & (~new_n99_ | (~x19 & (~new_n67_ | ~new_n98_)));
  assign new_n98_ = ~x25 & ~x26 & ~x27 & ~x29 & ~x30;
  assign new_n99_ = ~x17 & ~x19 & ~x20 & ~x28;
  assign new_n100_ = new_n58_ & new_n67_ & new_n101_ & new_n83_ & ~x25;
  assign new_n101_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 ? x06 : (x16 ? (new_n103_ | new_n105_) : ~x02);
  assign new_n103_ = x32 & (~new_n99_ | (~x19 & (~new_n74_ | ~new_n104_)));
  assign new_n104_ = ~x26 & ~x27 & ~x29 & ~x30 & ~x31;
  assign new_n105_ = new_n58_ & new_n67_ & new_n106_ & new_n94_ & ~x27 & ~x28;
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 ? x06 : (x16 ? (new_n108_ | new_n110_) : ~x01);
  assign new_n108_ = x33 & (~new_n99_ | (~x19 & (~new_n74_ | ~new_n109_)));
  assign new_n109_ = ~x26 & ~x27 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n110_ = new_n59_ & new_n71_ & new_n111_ & new_n112_;
  assign new_n111_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n112_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 ? x06 : (x16 ? (new_n114_ | new_n116_) : ~x00);
  assign new_n114_ = x34 & (~new_n99_ | (~x19 & (~new_n78_ | ~new_n115_)));
  assign new_n115_ = ~x27 & ~x29 & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n116_ = new_n59_ & new_n71_ & new_n111_ & new_n117_;
