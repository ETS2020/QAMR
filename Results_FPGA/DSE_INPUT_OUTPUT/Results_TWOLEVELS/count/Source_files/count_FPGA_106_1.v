...
module FAU ( 
  ...
  assign z06 = (x16 & ((~new_n67_ & x25) | new_n68_ | x18)) | (~x09 & ~x16 & ~x18);
  assign new_n67_ = new_n56_ & (new_n65_ | x19);
  assign new_n68_ = new_n57_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign z07 = (x16 & ((~new_n70_ & x26) | new_n72_ | x18)) | (~x08 & ~x16 & ~x18);
  ...
  assign z08 = (x16 & ((~new_n75_ & x27) | new_n77_ | x18)) | (~x07 & ~x16 & ~x18);
  ...
  assign z09 = (x16 & ((~new_n80_ & x28) | new_n82_ | x18)) | (~x06 & ~x16 & ~x18);
  ...
  assign z11 = (x16 & ((~new_n91_ & x30) | new_n92_ | x18)) | (~x04 & ~x16 & ~x18);
  assign new_n91_ = new_n56_ & (x19 | (new_n65_ & new_n88_ & ~x25 & ~x26));
  assign new_n92_ = new_n89_ & new_n73_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = (x16 & ((~new_n94_ & x31) | new_n96_ | x18)) | (~x03 & ~x16 & ~x18);
  ...
  assign new_n101_ = new_n86_ & ~x31 & ~x32 & ~x29 & ~x30;
