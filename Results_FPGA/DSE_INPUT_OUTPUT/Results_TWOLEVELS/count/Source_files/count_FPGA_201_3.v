...
module FAU ( 
  ...
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n73_ | (~new_n71_ & x26)));
  assign new_n71_ = new_n66_ & (x18 | (new_n72_ & new_n69_ & ~x23));
  ...
  assign new_n76_ = new_n56_ & (new_n77_ | x19);
  assign new_n77_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n78_ = new_n79_ & new_n80_ & ~x23 & ~x24;
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n80_ = ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n84_ | (~new_n82_ & x28)));
  assign new_n82_ = new_n66_ & (x18 | (new_n83_ & new_n69_ & ~x26 & ~x27));
  assign new_n83_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n84_ = new_n79_ & ~x26 & ~x27 & ~x28 & new_n69_ & ~x23;
  assign z10 = (x16 & (new_n86_ | (new_n88_ & new_n90_))) | x18 | (~x05 & ~x16);
  assign new_n86_ = x29 & (~new_n66_ | (~x18 & (~new_n83_ | ~new_n87_)));
  ...
  assign new_n93_ = new_n90_ & new_n74_ & new_n94_ & ~x27 & ~x28;
  assign new_n94_ = ~x29 & ~x30;
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n97_ | (~new_n96_ & x31)));
  assign new_n96_ = new_n66_ & (x18 | (new_n67_ & new_n80_ & new_n94_ & ~x28));
  assign new_n97_ = new_n56_ & new_n98_ & new_n80_ & new_n99_;
  assign new_n98_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x16 ? (~x18 & (new_n102_ | (new_n101_ & new_n105_))) : (~x02 | x18);
  assign new_n101_ = new_n56_ & new_n98_;
  assign new_n102_ = x32 & (~new_n56_ | (~x19 & (~new_n103_ | ~new_n104_)));
  ...
  assign z14 = x16 ? (~x18 & (new_n108_ | (new_n68_ & new_n110_))) : (~x01 | x18);
  ...
  assign z15 = ~new_n117_ | (x16 & ((new_n68_ & new_n115_) | (~new_n113_ & x34)));
  assign new_n113_ = new_n66_ & (x18 | (new_n89_ & new_n111_ & new_n72_ & new_n114_));
