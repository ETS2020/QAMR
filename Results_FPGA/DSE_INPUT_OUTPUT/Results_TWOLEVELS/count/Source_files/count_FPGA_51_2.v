...
module FAU ( 
  ...
  assign z11 = (~new_n85_ & x16) | x05 | x18 | (~x04 & ~x16);
  assign new_n85_ = (~x30 | (new_n65_ & new_n83_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n83_ | x29 | x30 | x27 | x28);
  assign z12 = ~new_n92_ | (x16 & ((new_n87_ & new_n89_) | (~new_n88_ & x31)));
  assign new_n87_ = new_n58_ & new_n68_;
  assign new_n88_ = new_n65_ & new_n83_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n89_ = new_n90_ & new_n91_;
  assign new_n90_ = ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n92_ = ~x05 & ~x18 & (x03 | x16);
  ...
  assign new_n103_ = ~x05 & ~x18 & (x01 | x16);
  assign z15 = x18 | (~x05 & (x16 ? ~new_n105_ : ~x00));
