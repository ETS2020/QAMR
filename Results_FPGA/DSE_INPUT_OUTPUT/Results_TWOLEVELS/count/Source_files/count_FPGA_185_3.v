...
module FAU ( 
  ...
  assign z08 = (x16 & (new_n74_ | (new_n61_ & new_n76_))) | x18 | (~x07 & ~x16);
  assign new_n74_ = x27 & (~new_n57_ | (~x19 & (~new_n66_ | ~new_n75_)));
  assign new_n75_ = ~x24 & ~x25 & ~x26;
  assign new_n76_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~x28 & (new_n78_ | x18)) | (~x18 & (x16 ? (~new_n80_ & x28) : ~x06));
  assign new_n78_ = new_n79_ & x16 & ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n79_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n80_ = new_n57_ & (x19 | (new_n66_ & new_n81_));
  assign new_n81_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign z10 = (x16 & (new_n83_ | (new_n85_ & new_n86_))) | x18 | (~x05 & ~x16);
  assign new_n83_ = x29 & (~new_n57_ | (~x19 & (~new_n67_ | ~new_n84_)));
  assign new_n84_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n85_ = new_n75_ & ~x27 & ~x28 & ~x29;
  assign new_n86_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z11 = (x16 & (new_n90_ | (~new_n88_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n88_ = new_n57_ & (x19 | (new_n67_ & new_n89_));
  assign new_n89_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n90_ = new_n86_ & new_n75_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = (x16 & (new_n92_ | new_n94_)) | (~x03 & ~x16 & ~x18) | (x18 & ~x28);
  assign new_n92_ = x31 & (new_n93_ | (~x28 & (~new_n61_ | ~new_n76_)));
  assign new_n93_ = ~x18 & (x28 | x29 | x30);
  assign new_n94_ = new_n57_ & new_n67_ & new_n95_ & ~x25 & ~x26 & ~x27;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n97_ | new_n100_));
  assign new_n97_ = x32 & (~new_n57_ | (~x19 & (~new_n98_ | ~new_n99_)));
  assign new_n98_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n100_ = new_n57_ & new_n67_ & new_n84_ & new_n101_;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n103_ | (new_n70_ & new_n105_)));
  assign new_n103_ = x33 & (~new_n57_ | (~x19 & (~new_n104_ | ~new_n66_ | ~new_n75_)));
  assign new_n104_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n105_ = new_n106_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n106_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = ~new_n111_ | (x16 & (new_n108_ | (new_n70_ & new_n110_)));
  assign new_n108_ = x34 & ((~new_n109_ & ~x18) | (~x28 & (~new_n61_ | ~new_n76_)));
  assign new_n109_ = ~x28 & ~x29 & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n110_ = new_n106_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n111_ = (x00 | x16 | x18) & (~x18 | x28);
endmodule
