...
module FAU ( 
  ...
  assign z07 = x18 | (~x32 & (x16 ? ~new_n72_ : ~x08));
  ...
  assign z08 = (~new_n76_ & x16) | ~new_n54_ | (~x07 & ~x16);
  ...
  assign z09 = (x16 & (new_n83_ | (~new_n81_ & x28))) | ~new_n54_ | (~x06 & ~x16);
  assign new_n81_ = new_n58_ & (x19 | (new_n66_ & new_n82_ & ~x24 & ~x25));
  assign new_n82_ = ~x26 & ~x27;
  assign new_n83_ = new_n78_ & new_n84_;
  assign new_n84_ = ~x26 & ~x27 & ~x28 & ~x23 & ~x24 & ~x25;
  assign z10 = x18 | (~x32 & (x16 ? (new_n86_ | new_n88_) : ~x05));
  ...
  assign z12 = x18 | (~x32 & (x16 ? (new_n97_ | new_n99_) : ~x03));
  assign new_n97_ = x31 & (~new_n58_ | (~x19 & (~new_n73_ | ~new_n98_)));
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n99_ = new_n58_ & new_n67_ & new_n100_ & new_n82_ & ~x25;
  assign new_n100_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n54_ | new_n102_ | (~x02 & ~x16);
  assign new_n102_ = new_n87_ & new_n95_ & ~x31 & ~x32 & new_n67_ & new_n103_;
  assign new_n103_ = ~x19 & ~x20 & x16 & ~x17;
  assign z14 = x18 | (~x32 & (x16 ? (new_n105_ | new_n107_) : ~x01));
  assign new_n105_ = x33 & (~new_n58_ | (~x19 & (~new_n73_ | ~new_n106_)));
  assign new_n106_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n107_ = new_n58_ & new_n67_ & new_n87_ & new_n95_ & ~x31 & ~x33;
  assign z15 = (x16 & (new_n109_ | (new_n70_ & new_n111_))) | ~new_n54_ | (~x00 & ~x16);
  assign new_n109_ = x34 & (~new_n58_ | (~x19 & (~new_n77_ | ~new_n110_)));
  assign new_n110_ = ~x30 & ~x31 & ~x33 & ~x27 & ~x28 & ~x29;
  assign new_n111_ = new_n112_ & new_n82_ & ~x28 & ~x29;
