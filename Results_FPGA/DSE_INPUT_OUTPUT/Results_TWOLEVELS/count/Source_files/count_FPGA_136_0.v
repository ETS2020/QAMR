...
module FAU ( 
  ...
  assign z05 = new_n68_ | (~new_n54_ & ((~new_n66_ & x16) | x18 | (~x10 & ~x16)));
  assign new_n66_ = (~x24 | (new_n59_ & new_n67_ & ~x21)) & (~new_n60_ | ~new_n67_ | x24 | ~x25);
  assign new_n67_ = ~x22 & ~x23;
  assign new_n68_ = x16 & ~x17 & ~x19 & ~x20 & new_n69_ & ~x21;
  assign new_n69_ = ~x22 & ~x23 & ~x24 & ~x25 & (x26 | (~x26 & x28));
  assign z06 = new_n68_ | (~new_n54_ & (x18 | (~x09 & ~x16) | (new_n71_ & x16)));
  assign new_n71_ = x25 & (~new_n59_ | x21 | x22 | x23 | x24);
  assign z07 = new_n73_ | ~new_n78_ | (x16 & (new_n76_ | (~new_n74_ & ~x19)));
  assign new_n73_ = ~new_n54_ & x18;
  assign new_n74_ = (x17 | x20 | ~new_n75_ | x21) & (~x26 | (new_n67_ & ~x21));
  assign new_n75_ = ~x22 & ~x23 & ~x24 & (x25 ? x26 : (~x26 & x28));
  assign new_n76_ = ~new_n77_ & x26;
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x24;
  assign new_n78_ = ~new_n54_ & (x08 | x16);
  assign z08 = new_n80_ | (x16 & (new_n82_ | (x27 & (new_n81_ | x26))));
  assign new_n80_ = ~new_n54_ & (x18 | (~x07 & ~x16));
  assign new_n81_ = x28 & (~new_n60_ | ~new_n67_ | x24 | x25);
  assign new_n82_ = new_n83_ & ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & x28;
  assign z09 = new_n85_ | (x16 & x28 & (~new_n77_ | (~new_n86_ & ~x19)));
  assign new_n85_ = ~new_n54_ & (x18 | (~x06 & ~x16));
  assign new_n86_ = (x17 | x20 | x21 | ~new_n87_ | x22) & new_n88_ & ~x21 & ~x22;
  assign new_n87_ = ~x23 & ~x24 & (x25 | (~x25 & ~x26 & x27));
  assign new_n88_ = ~x23 & ~x26;
