...
module FAU ( 
  ...
  assign new_n79_ = ~new_n82_ & (x17 | x19 | x20 | ~new_n80_ | x21);
  assign new_n80_ = ~x22 & ~x23 & new_n81_ & ~x24;
  assign new_n81_ = ~x25 & ~x26 & ~x27;
  assign new_n82_ = x27 & (~new_n77_ | ~new_n75_ | x22 | x23);
  assign z09 = (x16 & (new_n86_ | (new_n84_ & ~x17))) | ~new_n55_ | (~x06 & ~x16);
  assign new_n84_ = ~x19 & ~x20 & ~x21 & ~x22 & new_n85_ & ~x23;
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & x33;
  assign new_n86_ = x28 & (~new_n87_ | ~new_n81_ | x23 | x24);
  assign new_n87_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign z10 = x18 | (x33 & (x16 ? ~new_n89_ : ~x05));
  assign new_n89_ = (~new_n90_ | x17) & (~x29 | (new_n87_ & new_n92_));
  ...
  assign z11 = x18 | (~new_n94_ & x33);
  assign new_n94_ = x16 ? (~new_n97_ & (x17 | ~new_n95_ | x19)) : x04;
  assign new_n95_ = ~x20 & ~x21 & ~x22 & ~x23 & new_n96_ & ~x24;
  assign new_n96_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n97_ = x30 & (~new_n67_ | ~new_n75_ | x27 | x28 | x29);
  assign z12 = ~new_n55_ | (~x03 & ~x16) | (x16 & (new_n99_ | (~new_n102_ & x31)));
  ...
  assign new_n102_ = new_n67_ & new_n75_ & new_n103_ & ~x27 & ~x28;
  assign new_n103_ = ~x29 & ~x30;
  assign z13 = x18 | (x33 & (x16 ? ~new_n105_ : ~x02));
  assign new_n105_ = ((new_n106_ & new_n107_) | ~x32) & (~new_n106_ | ~new_n108_ | ~new_n103_ | x31 | x32);
  assign new_n106_ = new_n71_ & ~x17 & ~x19 & ~x20;
  assign new_n107_ = new_n81_ & ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n108_ = ~x27 & ~x28 & ~x25 & ~x26;
  assign z14 = (~new_n110_ & x16) | ~new_n55_ | (~x01 & ~x16);
  assign new_n110_ = ~x17 & ~x19 & (x17 | x19 | (~x20 & (x20 | ~x33 | (~x21 & (new_n111_ | x21)))));
