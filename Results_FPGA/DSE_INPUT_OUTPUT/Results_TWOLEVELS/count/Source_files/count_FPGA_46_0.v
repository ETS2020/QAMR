...
module FAU ( 
  ...
  assign z06 = (~new_n54_ & x18) | (x16 & (new_n69_ | new_n70_)) | new_n54_ | (~x09 & ~x16);
  assign new_n69_ = x25 & (~new_n59_ | x21 | x22 | x23 | x24);
  assign new_n70_ = new_n60_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (x16 & (new_n72_ | new_n75_)) | (~new_n54_ & (x18 | (~x08 & ~x16)));
  assign new_n72_ = ~x19 & (new_n74_ | (~x17 & ~x20 & new_n73_ & ~x21));
  assign new_n73_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & x29;
  assign new_n74_ = x26 & (x21 | x22 | x23 | x24 | x25);
  assign new_n75_ = ~new_n59_ & x26;
  assign z08 = new_n77_ | (x16 & (new_n81_ | (x29 & (new_n78_ | new_n80_))));
  assign new_n77_ = ~new_n54_ & (x18 | (~x07 & ~x16));
  assign new_n78_ = ~x17 & ~x19 & ~x20 & new_n79_ & ~x21;
  assign new_n79_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n80_ = x27 & (~new_n60_ | x22 | x23 | x24 | x25);
  assign new_n81_ = x26 & x27;
  assign z09 = (x18 & (x26 | x29)) | ~new_n83_ | (~x26 & (~x29 | (new_n85_ & new_n86_)));
  assign new_n83_ = x16 ? (~x28 | (new_n63_ & new_n84_)) : x06;
  assign new_n84_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n85_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n86_ = ~x23 & ~x24 & ~x25 & ~x27 & ~x28 & x29;
  assign z10 = ~new_n92_ | (x29 & (x18 | (x16 & (new_n88_ | ~new_n90_))));
  assign new_n88_ = ~x19 & (x21 | (~x17 & ~x20 & ~x21 & new_n89_ & ~x22));
  assign new_n89_ = ~x23 & ~x24 & ~x25 & ~x26 & (x27 | (~x27 & x28));
  assign new_n90_ = new_n91_ & ~x17 & ~x19 & ~x20 & ~x22;
  assign new_n91_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n92_ = (x05 | x16) & (x26 | x29) & (~x18 | ~x26);
