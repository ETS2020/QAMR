...
module FAU ( 
  ...
  assign z06 = x18 ? x32 : (x16 ? (new_n68_ | new_n69_) : ~x09);
  ...
  assign new_n95_ = new_n89_ & new_n90_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign z13 = (x16 & (new_n102_ | new_n104_)) | x18 | (~x02 & ~x16);
  ...
  assign z14 = new_n111_ | (~x18 & (x16 ? (new_n107_ | new_n108_) : ~x01));
  assign new_n107_ = x33 & (~new_n57_ | (~x19 & (~new_n73_ | ~new_n103_)));
  assign new_n108_ = new_n58_ & new_n70_ & new_n109_ & new_n110_;
  assign new_n109_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n111_ = x32 & (x18 | (x16 & x33));
  assign z15 = (x16 & (new_n113_ | (new_n69_ & new_n114_))) | x18 | (~x00 & ~x16);
  assign new_n113_ = x34 & (~new_n57_ | (~x19 & (~new_n77_ | ~new_n91_ | ~new_n110_)));
