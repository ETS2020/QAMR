...
module FAU ( 
  ...
  assign z07 = (x16 & (new_n71_ | new_n73_)) | (x18 & ~x20) | (~x08 & ~x16 & ~x18);
  assign new_n71_ = x26 & (new_n64_ | (~new_n72_ & ~x18));
  assign new_n72_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n73_ = new_n57_ & new_n74_ & ~x22 & ~x23;
  assign new_n74_ = ~x24 & ~x25 & ~x26;
  assign z08 = ~new_n80_ | (x16 & (new_n78_ | (x27 & (new_n76_ | new_n64_))));
  assign new_n76_ = ~x18 & (~new_n77_ | x20 | x21 | x22);
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n78_ = new_n79_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n79_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n80_ = (x07 | x16 | x18) & (~x18 | x20);
  ...
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n87_ | new_n89_));
  assign new_n87_ = x29 & (~new_n56_ | (~x19 & (~new_n66_ | ~new_n88_)));
  assign new_n88_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n89_ = new_n90_ & new_n74_ & new_n91_;
  assign new_n90_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n91_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n94_ | (~new_n93_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n93_ = new_n56_ & (x19 | (new_n66_ & new_n91_ & ~x25 & ~x26));
  assign new_n94_ = new_n90_ & new_n74_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = (x16 & (new_n96_ | new_n99_)) | (x18 & ~x20) | (~x03 & ~x16 & ~x18);
  assign new_n96_ = x31 & (new_n64_ | (~x18 & (~new_n97_ | ~new_n98_)));
  ...
  assign z13 = ~new_n107_ | (x16 & (new_n105_ | (x32 & (new_n102_ | ~new_n56_))));
  assign new_n102_ = ~x19 & (~new_n103_ | ~new_n104_);
  ...
  assign z14 = (x16 & (new_n109_ | (new_n69_ & new_n112_))) | x18 | (~x01 & ~x16);
  ...
  assign z15 = (x16 & (new_n115_ | (new_n69_ & new_n116_))) | x18 | (~x00 & ~x16);
  assign new_n115_ = x34 & (~new_n56_ | (~x19 & (~new_n110_ | ~new_n91_ | ~new_n113_)));
