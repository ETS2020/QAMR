...
module FAU ( 
  ...
  assign new_n75_ = new_n76_ & (x18 | (new_n77_ & ~x20 & ~x21 & ~x22));
  ...
  assign z13 = ~new_n105_ | (x16 & (new_n102_ | (x32 & (new_n99_ | ~new_n76_))));
  assign new_n99_ = ~x18 & (~new_n100_ | ~new_n101_);
  assign new_n100_ = ~x23 & ~x24 & ~x25 & ~x20 & ~x21 & ~x22;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x26 & ~x27 & ~x28;
  assign new_n102_ = new_n65_ & new_n66_ & new_n103_ & new_n104_;
  assign new_n103_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n104_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n105_ = ~x18 & (x02 | x16);
  assign z14 = x18 ? ~x04 : (x16 ? (new_n107_ | new_n108_) : ~x01);
  assign new_n107_ = x33 & (~new_n65_ | ~new_n66_ | ~new_n103_ | ~new_n104_);
  assign new_n108_ = new_n70_ & new_n71_ & new_n109_ & new_n110_;
  assign new_n109_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 ? ~x04 : (x16 ? ~new_n112_ : ~x00);
  assign new_n112_ = (~x34 | (new_n70_ & new_n71_ & new_n109_ & new_n110_)) & (~new_n70_ | ~new_n71_ | ~new_n109_ | ~new_n113_);
