...
module FAU ( 
  ...
  assign new_n33_ = (~x1 | ((~x5 | x8 | ~x9) & (~x4 | x9))) & (x5 | (~new_n34_ & x9));
  assign new_n34_ = x2 & x7 & ~x8;
  assign new_n35_ = ~new_n37_ & ~new_n38_ & (new_n36_ | ~x0);
  assign new_n36_ = (~x1 | ~x7) & (x1 | x2 | ~x3 | x5 | x7 | ~x9);
  assign new_n37_ = x1 & ((x7 & ~x9) | (x3 & ~x4 & x5));
  assign new_n38_ = ~x7 & ~x8 & x9 & ~x1 & x3 & ~x5;
