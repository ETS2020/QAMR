...
module FAU ( 
  ...
  assign z4 = ~x6 & x9 & (new_n43_ | ~new_n48_ | (~new_n46_ & x0));
  assign new_n43_ = x4 & (x5 ? ~new_n45_ : ~new_n44_);
  assign new_n44_ = (~x1 | ~x2 | x8) & (~x3 | ((~x2 | x8) & (~x0 | (x8 & (~x2 | ~x7)))));
  assign new_n45_ = x7 & ((x1 & x3) | (x0 & x2));
  assign new_n46_ = ~new_n47_ & (x8 | ((~x1 | (x5 & x7)) & (x3 | ~x5 | x7)));
  assign new_n47_ = x2 & x7 & ((x1 & ~x5) | (~x3 & ~x4 & x5));
  assign new_n48_ = ~new_n49_ & (~x1 | ~x3 | ~x7 | (x4 & x5));
  assign new_n49_ = ~x2 & x5 & ~x8 & (~x3 | (x1 & ~x7));
