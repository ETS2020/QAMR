...
module FAU ( 
  ...
  assign new_n43_ = x9 & (x8 | (~x6 & ~x7 & x4 & x5));
  assign z2 = (x1 & x3 & (~x8 | ~x9)) | (x8 & x9) | (~x1 & ~x3);
  assign z3 = x1 & x3 & (~x8 | ~x9);
  assign z4 = x9 & (new_n47_ | ~new_n53_ | (~new_n51_ & x0));
  assign new_n47_ = x5 & (new_n49_ | new_n50_ | (~new_n48_ & ~x3));
  assign new_n48_ = (~x0 | ((x4 | ~x7) & (x1 | ~x2 | x7))) & (x2 | (x6 & (x0 | x1))) & (~x1 | x4 | ~x6 | ~x7);
  assign new_n49_ = ~x0 & (x1 ? (~x2 & x3 & (~x4 | ~x7)) : x4);
  assign new_n50_ = x4 & ~x6 & ~x1 & ~x2;
  assign new_n51_ = ~new_n52_ & (x4 | ((x5 | ~x6) & (~x1 | ~x7))) & (~x1 | (x5 & (x6 | x7)));
  assign new_n52_ = x3 & ((x4 & ~x5) | (x1 & x2 & ~x7));
  assign new_n53_ = (new_n54_ | x5) & new_n56_ & (~new_n55_ | ~x1);
  assign new_n54_ = (~x1 | ((~x3 | x6 | ~x7) & (~x4 | ~x6))) & (~x6 | x7) & (~x2 | ~x3 | ~x4);
  assign new_n55_ = ~x6 & ((~x3 & x4 & ~x0 & x2) | (x3 & ~x4 & x7));
  assign new_n56_ = ~x8 & (~x4 | x7 | ~x2 | ~x3);
