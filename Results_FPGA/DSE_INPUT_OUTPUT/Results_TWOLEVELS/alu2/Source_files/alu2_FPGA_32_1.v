...
module FAU ( 
  ...
  assign new_n28_ = x3 & ((~new_n29_ & ~x4) | new_n31_ | (~new_n30_ & x4));
  assign new_n29_ = (~x1 | x7 | ~x8) & (~x5 | x8 | ~x0 | x1);
  assign new_n30_ = (~x1 | (x8 ? ~x0 : ~x7)) & (x1 | ((x0 | ~x8) & (x5 | ~x6 | x7 | x8))) & (x7 | ~x8 | (~x5 & x6));
  assign new_n31_ = x0 & x1 & (x5 ? x8 : (x7 & ~x8));
  ...
  assign new_n36_ = (x0 | ~x1 | (x5 ? ~x3 : ~x7)) & (x1 | x5 | ~x8 | (~x0 & x7));
  ...
  assign z4 = x2 & x9 & (new_n42_ | ~new_n49_ | (~new_n46_ & x0));
  assign new_n42_ = x4 & ((~new_n43_ & ~x5) | new_n45_ | (~new_n44_ & x5));
  assign new_n43_ = (~x1 | (x8 & (~x6 | ~x7))) & (~x3 | (x8 & (~x0 | ~x7))) & (x0 | ~x6 | x7);
  assign new_n44_ = (x0 | (x1 & (x3 | x6))) & (x7 | (x6 & (~x3 | ~x8)));
  assign new_n45_ = x3 & ~x7 & (~x8 | (~x1 & x6));
  assign new_n46_ = (new_n47_ | ~x5) & (new_n48_ | x8) & (~x1 | x5 | ~x7);
  assign new_n47_ = (x3 | ((x1 | ((~x6 | x7) & (x4 | x8))) & (x4 | x6 | ~x7))) & (~x6 | x7 | ~x1 | ~x3);
  assign new_n48_ = (x4 | x5 | ~x6) & (~x1 | ((~x3 | x4) & (x6 | x7)));
  assign new_n49_ = ~new_n50_ & (x7 | x8 | x5 | ~x6);
  assign new_n50_ = x1 & ((x7 & ((x3 & ~x6 & (~x4 | ~x5)) | (x5 & x6 & ~x3 & ~x4))) | (x6 & ~x7 & ~x3 & ~x5));
