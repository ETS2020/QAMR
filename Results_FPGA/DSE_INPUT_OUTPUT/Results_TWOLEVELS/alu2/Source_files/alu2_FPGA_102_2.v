...
module FAU ( 
  ...
  assign new_n42_ = ~new_n43_ & (new_n47_ | ~x4) & (new_n51_ | ~x1) & (new_n54_ | x4);
  ...
  assign new_n51_ = (new_n53_ | x0) & (x2 | ~x5 | ~new_n52_ | x6);
  assign new_n52_ = x7 & ~x8;
  assign new_n53_ = (~x2 | ((~x6 | ~x7 | x8) & (x4 | ~x5 | x7))) & (~x8 | ((x4 | ~x6) & (x2 | x7)));
  ...
  assign new_n61_ = x5 & ((~new_n62_ & ~x7) | ~new_n67_ | (~new_n65_ & ~x3));
  assign new_n62_ = (~new_n63_ | ~x6) & (~new_n64_ | x6) & (~x4 | (x6 & (~x2 | ~x3)));
  assign new_n63_ = (~x1 ^ x3) & (x0 ^ ~x2);
  assign new_n64_ = ~x8 & ((x1 & ~x2) | (x0 & ~x3));
  assign new_n65_ = (~new_n66_ | x4) & (x6 | ((x0 | ~x4) & (x2 | (~x4 & x8))));
  assign new_n66_ = x7 & ((x0 & (x2 ^ x6)) | (~x2 & ~x8) | (x1 & x6));
  assign new_n67_ = (x1 | ~x4 | (x0 & (x2 | x6))) & (~x1 | x2 | ~new_n52_ | x4);
  assign new_n68_ = x0 & ((~new_n69_ & x6) | new_n72_ | (new_n71_ & ~x5));
  assign new_n69_ = new_n70_ & (x2 | ((x5 | x7) & (~x1 | x4 | ~x7)));
  assign new_n70_ = (x4 | x8 | (x5 & (x3 | ~x7))) & (x5 | ~x7 | ~x3 | ~x4);
