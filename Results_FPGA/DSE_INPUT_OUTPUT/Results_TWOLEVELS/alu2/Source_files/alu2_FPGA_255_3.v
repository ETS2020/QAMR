// Benchmark "FAU" written by ABC on Fri Aug 21 00:12:40 2020
...
module FAU ( 
  ...
  assign new_n21_ = x7 & ((~x4 & x8 & (x1 ? x9 : ~x5)) | ~x9 | (x4 & ~x8));
  ...
  assign new_n35_ = (~x0 | ((~x4 | ~x7) & (x2 | x3 | x7))) & (x0 | ((x4 | ~x7) & (~x4 | x7 | ~x2 | x3))) & (x8 | (x7 ? x4 : x3));
  ...
  assign new_n41_ = (~x2 | ((x0 | ~x3 | ~x6 | x7) & (x3 | x6 | x8))) & (~x3 | ((x0 | (x8 ? ~x7 : x2)) & (~x6 | x7 | x8) & (x2 | x6 | ~x8)));
  ...
  assign z4 = x9 & (new_n52_ | ~new_n56_ | (new_n59_ & x0));
  assign new_n52_ = x6 & (~new_n53_ | new_n55_);
  assign new_n53_ = ~new_n54_ & (x7 | x8) & (~x0 | ((x2 | x7) & (x4 | x8)));
  assign new_n54_ = x1 & ((~x3 & ~x7) | (x0 & ~x4 & x7 & x8));
  assign new_n55_ = x4 & ((x3 & (x7 ? x0 : ~x1)) | (x1 & x7) | (~x0 & x2 & ~x7));
  assign new_n56_ = (~x1 | ((~new_n58_ | ~x3) & (~new_n57_ | ~x2))) & ~x5 & (~new_n57_ | ~x2 | ~x3);
