...
module FAU ( 
  ...
  assign z4 = x9 & (new_n63_ | (x5 & (~new_n57_ | (~new_n68_ & x4))));
  assign new_n57_ = (x3 | (new_n58_ & (new_n60_ | x1))) & (~x1 | (~new_n62_ & (new_n61_ | ~x3)));
  assign new_n58_ = (x4 | new_n59_ | ~x7) & (~x0 | x6 | x7 | x8);
  assign new_n59_ = (~x6 | (~x1 & (~x0 | x2))) & (~x0 | (x8 & (~x2 | x6)));
  assign new_n60_ = (~x0 | ~x2 | ~x6 | x7) & (x0 | x2 | (x8 & (~x6 | x7)));
  assign new_n61_ = (~x0 | ~x2 | ((x4 | x8) & (~x6 | x7))) & (x0 | x2 | ~x6 | x7) & (x4 | x6 | ~x7);
  assign new_n62_ = ~x2 & ~x8 & (x7 ? ~x4 : ~x6);
  assign new_n63_ = x8 & (new_n64_ | (~x5 & ~new_n67_ & x7));
  assign new_n64_ = x6 & ((~new_n66_ & ~x5) | (~new_n65_ & x0));
  assign new_n65_ = (x2 | ((x5 | x7) & (~x1 | x4 | ~x7))) & (x5 | ~x7 | ~x3 | ~x4);
  assign new_n66_ = (~x1 | (x7 ? ~x4 : x3)) & (~x4 | x7 | ((x1 | ~x3) & (x0 | ~x2)));
  assign new_n67_ = (~x0 | ~x2 | (~x1 & (~x3 | ~x4))) & (~x1 | ~x3 | x6);
  assign new_n68_ = (x0 | (x1 & (x3 | x6))) & (x6 | (x7 & (x2 | (x1 & x3)))) & (~x2 | ~x3 | x7);
