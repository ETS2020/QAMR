...
module FAU ( 
  ...
  assign z20 = (~x32 & x38) | (~x10 & (x09 ? x32 : x31));
  assign z21 = ~x10 & ((x32 & (~x09 | x33)) | (x09 & x33 & ~x38));
  ...
  assign z26 = ~x10 & ((x32 & x38 & (x09 | x37)) | (~x09 & x37 & ~x38));
  assign z27 = ~new_n114_ & ~x10;
  assign new_n114_ = ((x38 ? ~x32 : ~x09) | (x14 ? ~x00 : ~x39)) & (x09 | ~x32 | ~x38);
