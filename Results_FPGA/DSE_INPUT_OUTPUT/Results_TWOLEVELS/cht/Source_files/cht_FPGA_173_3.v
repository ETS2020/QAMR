...
module FAU ( 
  ...
  assign z01 = x10 ? x09 : (x07 ? x05 : x12);
  assign z02 = ~x10 & (x07 ? x06 : x13);
  assign z03 = x10 ? x09 : (x07 ? x01 : x14);
  assign z04 = ~x10 & (x07 ? x02 : x15);
  assign z05 = x10 ? x09 : (x07 ? x03 : x16);
  assign z06 = x10 ? x09 : (x08 ? x18 : x17);
  ...
  assign z13 = x10 ? x09 : (x08 ? x25 : x24);
  assign z14 = x10 ? x09 : (x08 ? x26 : x25);
  assign z15 = ~x10 & (x08 ? x27 : x26);
  assign z16 = ~x10 & (x08 ? x28 : x27);
  assign z17 = ~x10 & (x08 ? x29 : x28);
  assign z18 = x10 ? x09 : (x08 ? x30 : x29);
  assign z19 = ~x10 & (x08 ? x00 : x30);
  assign z20 = x09 ? (x10 | x32) : (~x10 & x31);
  assign z21 = ~x10 & (x09 ? x33 : x32);
  assign z22 = x09 ? (x10 | x34) : (~x10 & x33);
  assign z23 = x09 ? (x10 | x35) : (~x10 & x34);
  assign z24 = x09 ? (x10 | x36) : (~x10 & x35);
  assign z25 = ~x10 & (x09 ? x37 : x36);
  assign z26 = x09 ? (x10 | x38) : (~x10 & x37);
  assign z27 = x09 ? (x10 | (x00 & x14) | (~x14 & x39)) : (~x10 & x38);
  assign z28 = ~x10 & ((x39 & (~x09 | x14)) | (x09 & ~x14 & x40));
  assign z29 = ~x10 & ((x40 & (~x09 | x14)) | (x09 & ~x14 & x41));
  assign z30 = ~x10 & ((x41 & (~x09 | x14)) | (x09 & ~x14 & x42));
  assign z31 = (x09 & (x10 | (~x14 & x43))) | (~x10 & x42 & (~x09 | x14));
