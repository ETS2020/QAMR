// Benchmark "FAU" written by ABC on Sat Aug 22 04:09:35 2020
...
module FAU ( 
  ...
  wire new_n79_, new_n81_, new_n82_, new_n84_, new_n86_, new_n88_, new_n91_,
    new_n97_, new_n100_, new_n101_, new_n102_, new_n105_, new_n106_,
  ...
  assign z16 = ~x4 & (~x5 | (new_n86_ & x0 & new_n82_ & x3 & x5));
  assign z17 = ~x5 & x4 & ~x2 & x0 & ~x1;
  assign z18 = ~x5 & (~x4 | (~x0 & ~x1 & x2 & x3 & x4));
  assign z19 = z04 | (~x0 & ~x1 & new_n97_ & ~x2);
  ...
  assign z33 = ~new_n105_ | (x2 & (new_n97_ | (x0 & ~x1 & x5)));
  assign new_n105_ = (x5 | (x4 & (x1 | ~x4))) & (~x5 | ((new_n106_ | x4) & (x1 | (~x4 & (x2 | x3))))) & (~x1 | ~x4 | (~x3 & (x2 | x3)));
  assign new_n106_ = (~x6 | (x7 & (~x0 | x2 | ~x7 | (~x1 & (x1 | ~x3))))) & x0 & x6;
  ...
  assign z37 = (x3 & ((x0 & ((x2 & x4) | (x1 & ~x4 & x5))) | ((~x0 | x1) & x4))) | (~x0 & (x4 ? x1 : x5)) | (~x1 & ((x4 & ~x5) | (~x2 & ~x3 & x5))) | (x2 & (x4 ? ~x3 : x5));
  ...
  assign z44 = ~x4 | (x4 & (x3 | (~x3 & (x0 | x2 | (x1 & ~x2)))));
  assign z45 = x4 ? (~x1 | (~x3 & (x0 | (x1 & ~x2))) | (x3 & (x0 | (~x0 & ~x2)))) : x5;
  assign z46 = ~x4 | (x4 & (~x1 | (x1 & x3) | (~x3 & (x0 | x2))));
  assign z47 = new_n127_ | new_n123_ | new_n125_ | new_n128_ | (~x1 & x4);
  assign new_n123_ = ~x2 & ((x1 & ((~x3 & x4) | (new_n124_ & x0 & x3 & ~x4))) | (x0 & x3 & (x4 | (new_n124_ & ~x1 & ~x4))));
  assign new_n124_ = x5 & x6 & x7;
  assign new_n125_ = x0 & (new_n126_ | (~x3 & (x4 | (~x4 & x5))));
  assign new_n126_ = x2 & ((x3 & x4) | (~x1 & x5));
  assign new_n127_ = ~x0 & ((~x4 & x5) | (~x2 & x3 & x4));
  assign new_n128_ = ~x4 & x5 & (~x6 | (x6 & ~x7));
  assign z48 = new_n130_ | (x4 & ((~x0 & (x1 | (x2 & x3))) | x0 | (~x1 & ~x3)));
  assign new_n130_ = x5 & ((~new_n131_ & ~x4) | (~x1 & ~x2 & ~x3));
  assign new_n131_ = (~x6 | (x7 & (x2 | ~x7 | (x0 ? (x1 | ~x3) : ~x1)))) & (~x0 | (x3 & (~x1 | ~x3))) & ~x2 & x6;
  assign z49 = ~x4 | (x4 & (x3 | (~x0 & (x1 | (~x1 & ~x2 & ~x3))) | (x0 & ~x3)));
  assign z50 = new_n114_ | (~x4 & x5);
  assign z51 = (~x0 & (x4 ? x1 : x5)) | ~new_n135_ | (x2 & (x4 ? ~x1 : x5));
  assign new_n135_ = ~new_n128_ & ~new_n137_ & (x1 | (~new_n97_ & (~new_n136_ | x2)));
  assign new_n136_ = x5 & (~x3 | (x0 & x3 & ~x4 & x6 & x7));
  assign new_n137_ = x0 & x3 & ((x1 & ~x4 & x5) | (~x2 & x4));
  assign z52 = (~new_n139_ & x4) | (~x4 & ~x5) | (~new_n140_ & x5);
  assign new_n139_ = (x2 | (x0 ? (~x3 & (x1 | x5)) : (x1 | x3))) & (x0 | (~x1 & (~x2 | ~x3))) & (~x0 | ~x2 | ~x3);
  ...
  assign z54 = (~new_n146_ & ~x2) | new_n149_ | ~new_n148_ | (~new_n147_ & x2);
  assign new_n146_ = x3 ? (x0 ? (~x4 & (x1 | x4 | ~new_n82_ | ~x5)) : ~x4) : (~x5 | (x1 & (x0 | ~x1 | ~new_n82_ | x4)));
  assign new_n147_ = (~x0 | ((~x3 | ~x4) & (~new_n124_ | x1 | x3 | x4))) & (x3 | ~x4) & (x1 | ~x3);
  assign new_n148_ = ~new_n128_ & (~x0 | ((x3 | ~x4) & (~x1 | ~x3 | x4 | ~x5)));
  assign new_n149_ = ~x5 & (~x4 | (~x1 & x4));
  assign z55 = (x5 & ((~new_n151_ & ~x1) | (~new_n106_ & ~x4))) | (x4 & (new_n152_ | (~x1 & ~x5)));
  assign new_n151_ = (~x0 | ~x2) & ~x4 & (x2 | x3);
  assign new_n152_ = x0 & (~x3 | (x2 & x3));
  assign z56 = (~x5 & (~x4 | (~x1 & x4))) | ~new_n156_ | (x5 & ((new_n155_ & ~x1) | (~new_n154_ & ~x4)));
  assign new_n154_ = (~x6 | (x7 & (x2 | ~x7 | (x0 ? (x1 | ~x3) : ~x1)))) & x6 & (~x0 | (x3 & (~x1 | ~x3)));
  assign new_n155_ = ~x2 & (~x3 | (~x0 & x3));
  assign new_n156_ = (x1 | ~x2 | ~x3) & (~x4 | (x3 ? (~x0 & (x0 | ~x2)) : (~x2 & (~x1 | x2))));
  assign z57 = (~x5 & (~x4 | (~x1 & x4))) | (~new_n160_ & x4) | (x5 & ((~new_n159_ & ~x4) | (~new_n158_ & ~x1)));
  assign new_n158_ = (~x0 | (~x2 & (x2 | ~x3 | ~new_n82_ | x4))) & (x2 | (x3 & (x0 | ~x3))) & ~x4 & (~x2 | x3);
  assign new_n159_ = (~x0 | (x3 & (~x1 | ~x3))) & x6 & (~x6 | (x7 & (x0 | ~x1 | x2 | ~x7)));
  assign new_n160_ = (~x0 | (x3 & (~x2 | ~x3))) & (~x2 | x3) & (x0 | ~x3);
  assign z58 = new_n127_ | new_n123_ | ~new_n162_;
  assign new_n162_ = ~new_n163_ & (~new_n126_ | ~x0) & ~new_n128_ & (x1 | ~x4);
  assign new_n163_ = ~x3 & ((x2 & x4) | (x0 & ~x4 & x5));
  assign z59 = ~x4 | (x4 & ((~x3 & (~x1 | (x1 & ~x2))) | (x1 & (~x0 | x3)) | (x3 & (~x0 | (x0 & ~x2)))));
  assign z60 = (~x5 & (~x4 | (~x1 & x4))) | (x5 & ((~new_n168_ & ~x4) | (~new_n166_ & ~x1))) | (x1 & ~new_n167_ & x4);
  assign new_n166_ = (~x0 | (~x2 & (x2 | ~x3 | ~new_n82_ | x4))) & ~x4 & (~x2 | x3) & (x0 | x2 | ~x3);
  assign new_n167_ = x0 & ~x3;
  assign new_n168_ = (~x0 | (x3 & (~x1 | ~x3))) & x6 & (~x6 | (x7 & (x0 | ~x1 | ~x7)));
