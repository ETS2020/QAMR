// Benchmark "FAU" written by ABC on Fri Aug 21 12:27:55 2020
...
module FAU ( 
  ...
  assign new_n183_ = ~x09 & ~x18 & ~x20 & new_n157_ & x21 & x22;
  ...
  assign new_n192_ = new_n141_ & new_n157_ & x22;
  ...
  assign new_n223_ = ~x21 & (x21 | (~new_n209_ & ~new_n212_));
  assign new_n224_ = (new_n225_ | ~x29) & (~x21 | ~x26 | ~x19 | x20);
  assign new_n225_ = (~x20 | ((~new_n226_ | x19) & (~new_n162_ | ~x19 | x21))) & (~x19 | x20 | new_n161_ | x21);
  assign new_n226_ = x26 & ~x28 & (x21 ? ~x11 : ~x17);
  assign new_n227_ = new_n158_ & x11 & x21 & x26 & ~x28 & x29;
  assign z15 = (~x21 & (x29 ? ~new_n229_ : ~new_n236_)) | (~x20 & new_n245_ & x21);
  ...
  assign new_n236_ = x30 ? (x18 ? new_n243_ : new_n237_) : new_n240_;
  assign new_n237_ = x19 ? ~new_n238_ : ((~x20 | ~x24) & (new_n239_ | ~x28));
  assign new_n238_ = x22 & (~x20 | (new_n203_ & x20 & x28));
  assign new_n239_ = (~x00 | x03 | (~x02 ^ x20)) & (~x06 | ~x20 | (x02 & ~x03));
  assign new_n240_ = ~new_n241_ & (~x14 | x27 | x28);
  assign new_n241_ = x18 & x19 & ~new_n242_ & x20;
  assign new_n242_ = (~x00 | ~x03 | ~x27) & (x27 | ~x28);
  assign new_n243_ = (~x19 | (x20 ? ~x27 : ~new_n244_)) & (~new_n244_ | ~x20 | ~x17 | x19);
  assign new_n244_ = x26 & ~x28;
  assign new_n245_ = x30 & ((~new_n246_ & ~x18) | (x00 & x18 & new_n204_ & ~x19));
  ...
  assign new_n253_ = x20 ? (x27 | (~x28 & (~x05 | x28))) : new_n161_;
  ...
  assign new_n262_ = x18 ? (~x20 | ~x26 | x28) : ((~x20 | ~x22) & (new_n239_ | ~x28));
  ...
  assign new_n267_ = x30 & (x18 | x19 | ~new_n153_ | x20);
  assign z17 = (x30 & (~new_n269_ | (~new_n286_ & ~new_n152_))) | (~x21 & ~new_n283_ & ~x30);
  assign new_n269_ = (~x29 | (new_n274_ & (new_n270_ | ~x20))) & (new_n277_ | x29) & (~new_n282_ | x20);
  assign new_n270_ = x21 ? (x19 ? (~x18 & (~new_n116_ | x18)) : (~new_n271_ & x18)) : new_n272_;
  ...
  assign new_n275_ = ~x20 & ~new_n161_ & ~x21;
  assign new_n276_ = (x19 | ~x21 | (x20 & ~x22)) & (~x19 | x20 | x21 | ~x26);
  assign new_n277_ = x18 ? ((new_n243_ | x21) & (~new_n281_ | ~x21 | ~x28)) : new_n278_;
  ...
  assign new_n289_ = (~x20 | ~x26 | ~new_n117_ | x28) & (new_n152_ | ((~new_n117_ | ~x20 | x28) & (x20 | (~new_n290_ & ~new_n117_))));
  ...
  assign new_n300_ = (~x18 | x19 | ~x28) & (x28 | ((~x00 | ~x18 | x19) & (~x01 | x18 | new_n152_ | ~x19)));
  ...
  assign new_n315_ = new_n121_ & ~x03 & new_n211_ & x20;
  ...
  assign z21 = ~x30 & (x21 | (new_n158_ & x18 & new_n177_ & ~x21 & x26));
  assign z22 = (x30 & (new_n214_ | (~new_n322_ & ~x21) | (~new_n331_ & x21))) | (~x21 & ~new_n344_ & ~x30);
  ...
  assign new_n345_ = (~x20 | (x18 ? ~new_n346_ : ~x24)) & (x18 | x20 | new_n234_ | x28);
  assign new_n346_ = x26 & (x28 | (x17 & ~x28));
  assign new_n347_ = (~x14 | x27 | x28) & (~x18 | (~new_n348_ & (new_n314_ | ~x28)));
  assign new_n348_ = x19 & x20 & x27 & (~x03 | (x00 & x03));
  assign z24 = (x21 & ~x30) | (new_n158_ & ~x18 & ~x29 & x30 & ~x21 & x22);
  ...
  assign new_n353_ = (x10 | ~x21 | ~x25) & (x21 | x29 | (~new_n244_ & ~x22));
  ...
  assign new_n358_ = (~x20 | (~new_n359_ & (~x18 | new_n152_ | x21))) & (~x18 | x20 | new_n161_ | x21);
  ...
  assign new_n366_ = (~x28 | x29 | new_n239_ | ~x30) & (x20 | x28 | ~x29 | new_n234_ | x30);
  ...
  assign new_n382_ = new_n158_ & ~x18 & new_n120_ & ~x21 & x24;
  ...
  assign new_n387_ = new_n121_ & x03 & ~x21 & x27 & ~x30;
  assign new_n388_ = ~x02 & ~x03 & ~x18 & ~x19 & ~x21 & x28;
  assign new_n389_ = (new_n390_ | x19) & (~new_n120_ | ~new_n244_ | ~x18 | ~x19 | x21);
  assign new_n390_ = (x03 | x18 | new_n125_ | x21) & (~new_n140_ | ~x18 | ~x21);
  ...
  assign new_n396_ = (new_n397_ | ~x00) & (~new_n144_ | ~new_n162_ | x00 | x04 | ~x18);
  assign new_n397_ = (new_n398_ | ~x20) & (~x18 | ~x19 | new_n124_ | x20);
  assign new_n398_ = (~new_n254_ | x18 | ~x19) & (~new_n244_ | x19 | x17 | ~x18);
  assign z31 = ~x21 & x28 & (new_n402_ | (~new_n400_ & x00));
  assign new_n400_ = (~new_n401_ | ~x18) & (~new_n144_ | x18 | ~new_n120_ | ~x22);
  assign new_n401_ = x26 & ~x29 & x30 & (~x19 ^ ~x20);
  assign new_n402_ = new_n121_ & ~x00 & ~x04 & new_n120_ & x20 & ~x27;
  ...
  assign new_n430_ = (new_n431_ | new_n124_) & ~new_n433_ & (~x18 | (~new_n435_ & ~new_n436_));
  assign new_n431_ = ~new_n432_ & (~new_n121_ | x20 | x21);
  assign new_n432_ = new_n115_ & x00 & new_n158_ & x21 & ~x28;
  assign new_n433_ = new_n434_ & new_n244_ & x20 & x21;
  ...
  assign new_n438_ = ~x03 & (new_n439_ | (new_n121_ & new_n211_ & x20));
  ...
  assign new_n451_ = new_n204_ & ~x27 & new_n281_ & ~x14;
  ...
  assign new_n483_ = (~x00 | ((x19 | ~x21 | x28) & (~x19 | x21 | ~x26 | ~x28))) & (new_n326_ | x21) & (x19 | ~x21 | ~x28);
  ...
  assign new_n491_ = (x18 | (~x20 & (x20 | ~x22 | x28))) & (~x26 | x28 | ~x11 | ~x20);
  ...
  assign new_n518_ = new_n121_ & x03 & x20 & ~x21 & x27;
  ...
  assign new_n522_ = (~x19 | new_n191_ | x20) & (~x20 | ((~new_n244_ | x19) & (~new_n162_ | x04 | ~x19)));
  assign new_n523_ = new_n121_ & ~x05 & new_n157_ & x20 & ~x27;
  ...
  assign new_n528_ = x29 & ((~new_n161_ & x30) | (x26 & x28 & ~x30));
  assign new_n529_ = (~new_n117_ | ~x27) & (~new_n119_ | ~x04 | x27);
  ...
  assign new_n533_ = (new_n534_ | ~x05) & (~new_n120_ | x21 | ~new_n281_ | ~x03);
  assign new_n534_ = (~x19 | ~x20 | ~x22 | (x21 ? (x29 | ~x30) : (~x29 | x30))) & (x19 | x20 | x21 | ~x29 | x30);
  assign new_n535_ = (x27 | ~x29 | ~x19 | x21) & (x19 | ~x21 | new_n340_ | x29);
  assign z41 = x21 & (~x30 | (new_n537_ & new_n140_ & x20 & x22));
