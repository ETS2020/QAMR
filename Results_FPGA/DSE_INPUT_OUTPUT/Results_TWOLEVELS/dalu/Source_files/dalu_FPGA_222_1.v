...
module FAU ( 
  ...
  assign z07 = ~x69 & ((~new_n197_ & ~x65) | (~x64 & new_n206_ & x65));
  assign new_n197_ = (~x64 | ~new_n205_ | x68) & (~x68 | (x64 ? ~new_n201_ : ~new_n198_));
  ...
  assign new_n206_ = x68 & ((~new_n207_ & ~x70) | (~x66 & new_n200_ & ~x67));
  assign new_n207_ = (x71 | new_n202_ | (~x66 & ~x67)) & (x66 | ~new_n199_ | x67);
  ...
  assign new_n230_ = x70 & ~x71 & ((x41 & (new_n151_ | ~x32)) | (x32 & ~new_n151_ & ~x41));
  ...
  assign new_n244_ = (~x50 | ~x73 | x74) & (x73 | (x74 ? ~x53 : ~x54));
  ...
  assign new_n256_ = (~x51 | ~x73 | x74) & (x73 | (x74 ? ~x54 : ~x55));
  ...
  assign new_n302_ = (~x55 | ~x73 | x74) & (x73 | (x74 ? ~x58 : ~x59));
