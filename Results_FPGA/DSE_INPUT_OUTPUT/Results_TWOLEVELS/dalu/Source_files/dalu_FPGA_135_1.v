// Benchmark "FAU" written by ABC on Sun Aug 23 20:14:51 2020
...
module FAU ( 
  ...
  assign z03 = (~new_n145_ & ~x65) | (~x68 & x69) | (~x64 & x65 & x68 & ~new_n156_ & ~x69);
  assign new_n145_ = (~x68 | x69 | (x64 ? ~new_n152_ : ~new_n146_)) & (~x64 | ~new_n155_ | x68);
  ...
  assign new_n150_ = (~x35 | (x32 & (~new_n151_ | ~new_n115_ | ~new_n114_ | x36))) & (~x32 | x35 | (new_n151_ & new_n115_ & new_n114_ & ~x36));
  ...
  assign new_n156_ = (x66 | new_n157_ | x67) & (x70 | x71 | new_n153_ | (~x66 & ~x67));
  assign new_n157_ = x70 ? (new_n150_ | x71) : (new_n147_ | ~x71);
  ...
  assign new_n161_ = x00 ? (x04 | (~x05 & ~x06 & ~x07 & (x05 | x06 | new_n124_ | x07))) : ~x04;
  assign new_n162_ = x32 ? (x36 | (~x37 & ~x38 & ~x39 & (x37 | x38 | new_n128_ | x39))) : ~x36;
  ...
  assign z05 = ~x69 & ((~new_n170_ & ~x65) | (~x64 & x65 & ~new_n180_ & x68));
  ...
  assign new_n174_ = x32 ? (x37 | (~x38 & ~x39 & (x38 | x39 | (~x36 & (new_n128_ | x36))))) : ~x37;
  ...
  assign new_n191_ = (~x48 | ~x73 | x74) & (x73 | (x74 ? ~x49 : ~x50));
  ...
  assign z08 = (~new_n209_ & ~x65) | (~x68 & x69) | (~x64 & x65 & x68 & ~new_n218_ & ~x69);
  assign new_n209_ = (~x68 | x69 | (x64 ? ~new_n213_ : ~new_n210_)) & (~x64 | ~new_n217_ | x68);
  assign new_n210_ = ~new_n104_ & (new_n212_ | (new_n211_ & ~x70));
  assign new_n211_ = x71 & ((x08 & (~x00 | (new_n123_ & new_n124_))) | (x00 & ~x08 & (~new_n123_ | ~new_n124_)));
  assign new_n212_ = x70 & ~x71 & ((x40 & (~x32 | (new_n127_ & new_n128_))) | (x32 & ~x40 & (~new_n127_ | ~new_n128_)));
  ...
  assign new_n215_ = (~x48 | ~x73 | x74) & (x73 | (x74 ? ~x51 : ~x52));
  assign new_n216_ = (~x73 | (x74 ? ~x53 : ~x54)) & (~x55 | x73 | ~x74);
  assign new_n217_ = ~new_n106_ & ((x70 & (x71 ? x40 : x24)) | (x08 & ~x70 & x71));
  assign new_n218_ = ~new_n219_ & (x66 | ~new_n212_ | x67);
  assign new_n219_ = ~x70 & ((~x71 & ~new_n214_ & (x66 | x67)) | (~x66 & new_n211_ & ~x67));
  ...
  assign new_n227_ = (~x49 | ~x73 | x74) & (x73 | (x74 ? ~x52 : ~x53));
  ...
  assign z10 = ~new_n243_ | (~x65 & ((new_n233_ & x68) | (x64 & new_n246_ & ~x68)));
  assign new_n233_ = ~x69 & (x64 ? (~x70 & ~new_n239_ & ~x71) : new_n234_);
  assign new_n234_ = ~new_n104_ & (new_n237_ | (new_n235_ & ~x70));
  ...
  assign new_n239_ = (~x42 | (~x66 ^ x67)) & (x66 | x67 | (~new_n240_ & ~new_n241_ & ~new_n242_));
  assign new_n240_ = x58 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n241_ = x72 & ((~x73 & (x74 ? x53 : x54)) | (x50 & x73 & ~x74));
  assign new_n242_ = ~x72 & ((x73 & (x74 ? x55 : x56)) | (x57 & ~x73 & x74));
  assign new_n243_ = (x68 | ~x69) & (x64 | ~x65 | ~x68 | new_n244_ | x69);
  assign new_n244_ = (x66 | ~new_n237_ | x67) & (x70 | (~new_n245_ & (x66 | ~new_n235_ | x67)));
  assign new_n245_ = ~x71 & ~new_n104_ & (new_n240_ | new_n241_ | new_n242_);
  ...
  assign new_n254_ = (~x51 | ~x73 | x74) & (x73 | (x74 ? ~x54 : ~x55));
  ...
  assign z14 = (~new_n286_ & ~x65) | (~x68 & x69) | (~x64 & x65 & x68 & ~new_n295_ & ~x69);
  assign new_n286_ = (~x64 | ~new_n294_ | x68) & (~x68 | x69 | (x64 ? ~new_n287_ : ~new_n291_));
  ...
  assign new_n289_ = (~x54 | ~x73 | x74) & (x73 | (x74 ? ~x57 : ~x58));
  assign new_n290_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n291_ = ~new_n104_ & (new_n293_ | (new_n292_ & ~x70));
  assign new_n292_ = x71 & ((x14 & (~x00 | ~x15)) | (x00 & ~x14 & x15));
  assign new_n293_ = x70 & ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n294_ = ~new_n106_ & ((x70 & (x71 ? x46 : x30)) | (x14 & ~x70 & x71));
  assign new_n295_ = ~new_n296_ & (x66 | ~new_n293_ | x67);
  assign new_n296_ = ~x70 & ((~x66 & new_n292_ & ~x67) | (~x71 & ~new_n288_ & (x66 | x67)));
  assign z15 = (~new_n298_ & ~x65) | (~x68 & x69) | (~x64 & x65 & x68 & ~new_n307_ & ~x69);
  assign new_n298_ = x64 ? ((new_n305_ | (~x66 ^ x67)) & (x66 | ~new_n299_ | x67)) : ~new_n303_;
  assign new_n299_ = x68 & ~x69 & ~x70 & ~new_n300_ & ~x71;
  assign new_n300_ = (~x63 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n301_ | ~x72) & (new_n302_ | x72);
  assign new_n301_ = (~x55 | ~x73 | x74) & (x73 | (x74 ? ~x58 : ~x59));
  assign new_n302_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n303_ = x68 & new_n304_ & ~x69;
  assign new_n304_ = ~new_n104_ & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n305_ = (new_n306_ | x68) & (~x47 | ((x68 | ~x70 | ~x71) & (~x68 | x69 | x70 | x71)));
  assign new_n306_ = (~x15 | x70 | ~x71) & (~x31 | ~x70 | x71);
  assign new_n307_ = (new_n308_ | x70) & (~x47 | x66 | x67 | ~x70 | x71);
  assign new_n308_ = (x71 | new_n300_ | (~x66 & ~x67)) & (~x15 | x66 | x67 | ~x71);
endmodule
