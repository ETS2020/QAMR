// Benchmark "FAU" written by ABC on Sun Aug 23 20:14:37 2020
...
module FAU ( 
  ...
  assign z13 = ~new_n229_ | (x64 & ~x65 & (new_n221_ | (new_n124_ & x29)));
  ...
  assign new_n228_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x61 | ~x69 | x70 | x71) & (~x45 | ~x70 | ~x71);
  assign new_n229_ = (~x68 | x69) & (x64 | ~x65 | x68 | ~x69 | new_n222_ | new_n100_);
  assign z14 = ~new_n239_ | (x64 & ~x65 & (new_n231_ | (new_n124_ & x30)));
  assign new_n231_ = ~x68 & (x66 ? (~new_n238_ & ~x67) : (x67 ? ~new_n238_ : (~new_n232_ & x69)));
  assign new_n232_ = ~new_n233_ & (new_n151_ | (~new_n236_ & ~new_n237_ & (new_n120_ | ~x30)));
  ...
  assign new_n239_ = (~x68 | x69) & (x64 | ~x65 | x68 | ~x69 | new_n232_ | new_n100_);
  assign z15 = ~new_n249_ | (x64 & ~x65 & (new_n241_ | (new_n124_ & x31)));
  assign new_n241_ = ~x68 & (x66 ? (~new_n248_ & ~x67) : (x67 ? ~new_n248_ : (~new_n242_ & x69)));
  assign new_n242_ = ~new_n243_ & (new_n151_ | (~new_n246_ & ~new_n247_ & (new_n120_ | ~x31)));
