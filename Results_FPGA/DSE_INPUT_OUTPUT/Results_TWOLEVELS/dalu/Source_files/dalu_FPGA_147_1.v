// Benchmark "FAU" written by ABC on Sun Aug 23 20:15:22 2020
...
module FAU ( 
  ...
  assign new_n142_ = (x70 | x71 | ~x68 | x69) & (~x69 | ~x70 | ~x71 | ~x31 | x68);
  ...
  assign new_n179_ = x69 & ((~new_n180_ & (x70 ^ x71)) | (x70 & x71 & (new_n183_ | ~new_n184_)));
  assign new_n180_ = (new_n146_ | ~x19) & ~new_n182_ & (new_n181_ | ~x16);
  assign new_n181_ = (x72 | ~x73 | ~x74) & (~x31 | ~x72 | (x74 & (x73 | ~x74)));
  assign new_n182_ = ~x72 & ((x18 & ~x73 & x74) | (x17 & x73 & ~x74));
  assign new_n183_ = ~new_n181_ & x48;
  ...
  assign new_n237_ = (x73 | (x74 ? ~x49 : ~x50)) & (~x31 | ~x48 | ~x73 | x74);
  ...
  assign new_n258_ = (x73 | (x74 ? ~x50 : ~x51)) & (~x31 | ~x48 | ~x73 | x74);
  ...
  assign new_n346_ = (~x19 | ~x73 | x74) & (x73 | (x74 ? ~x22 : ~x23));
  ...
  assign z13 = (~new_n389_ & ~x64) | new_n112_ | (x64 & ~new_n404_ & ~x65);
  ...
  assign new_n403_ = x68 & ~x69 & (x70 ? new_n402_ : (~new_n392_ & x71));
  assign new_n404_ = x66 ? ~new_n412_ : (x68 ? ~new_n410_ : new_n405_);
  assign new_n405_ = x67 ? new_n407_ : (~x69 | (~new_n409_ & (new_n406_ | new_n144_)));
  assign new_n406_ = ~new_n397_ & ~new_n398_ & (new_n146_ | ~x29);
  assign new_n407_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n408_ | ~x70);
  assign new_n408_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n409_ = x70 & x71 & (new_n393_ | new_n394_ | new_n395_);
  assign new_n410_ = ~x69 & ~x70 & ~x71 & (x67 ? x45 : ~new_n411_);
  assign new_n411_ = ~new_n393_ & ~new_n394_ & ~new_n395_;
  assign new_n412_ = ~x67 & ((~new_n407_ & ~x68) | (new_n109_ & x45 & x68));
  ...
  assign z15 = (~new_n436_ & ~x65) | new_n112_ | (~x64 & ~new_n452_ & x65);
  assign new_n436_ = x64 ? (x66 ? ~new_n449_ : (~new_n437_ & ~new_n447_)) : ~new_n450_;
  assign new_n437_ = ~x68 & (x67 ? ~new_n438_ : (x69 & (new_n440_ | new_n444_)));
  assign new_n438_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n439_ | ~x70);
  assign new_n439_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n440_ = ~new_n144_ & (new_n441_ | new_n442_ | ~new_n443_);
  assign new_n441_ = x72 & ((x26 & x74) | (x73 & (x23 | x74)));
  assign new_n442_ = ~x72 & ((x29 & ~x74) | (~x73 & (x30 | ~x74)));
  assign new_n443_ = (~x28 | ~x73 | ~x74) & (~x27 | x73 | x74);
  assign new_n444_ = x71 & ((~new_n146_ & x63) | (x70 & (new_n445_ | new_n446_)));
  assign new_n445_ = x72 & ((x55 & x73 & ~x74) | (~x73 & (x74 ? x58 : x59)));
  assign new_n446_ = ~x72 & ((x62 & ~x73 & x74) | (x73 & (x74 ? x60 : x61)));
  assign new_n447_ = x68 & ~x69 & ~x70 & ~new_n448_ & ~x71;
  assign new_n448_ = x67 ? ~x47 : (~new_n445_ & ~new_n446_ & (new_n146_ | ~x63));
  assign new_n449_ = ~x67 & ((~new_n438_ & ~x68) | (new_n109_ & x47 & x68));
  assign new_n450_ = x68 & new_n451_ & ~x69;
  assign new_n451_ = ~new_n114_ & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n452_ = x68 ? (x69 | (~new_n454_ & ~new_n456_)) : (~x69 | new_n453_ | new_n114_);
  assign new_n453_ = ~new_n440_ & ~new_n444_;
  assign new_n454_ = ~x70 & ((~x71 & ~new_n455_ & (x66 | x67)) | (x15 & ~x66 & ~x67 & x71));
  assign new_n455_ = ~new_n445_ & ~new_n446_ & (new_n146_ | ~x63);
  assign new_n456_ = ~x67 & x70 & ~x71 & x47 & ~x66;
endmodule
