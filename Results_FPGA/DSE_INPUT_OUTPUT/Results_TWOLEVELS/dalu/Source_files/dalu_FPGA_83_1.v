...
module FAU ( 
  ...
  assign new_n213_ = new_n128_ & new_n129_;
  assign new_n214_ = x71 & ((x08 & (~x00 | (new_n124_ & new_n125_))) | (x00 & ~x08 & (~new_n124_ | ~new_n125_)));
  ...
  assign new_n227_ = x70 & ~x71 & ((x41 & (new_n154_ | ~x32)) | (x32 & ~new_n154_ & ~x41));
  ...
  assign new_n252_ = (~x11 | (~new_n125_ & x00)) & (~x00 | new_n125_ | x11);
  assign new_n253_ = x70 & ~x71 & ((x43 & (new_n129_ | ~x32)) | (x32 & ~new_n129_ & ~x43));
