// Benchmark "FAU" written by ABC on Sun Aug 23 20:19:20 2020
...
module FAU ( 
  ...
  assign z07 = ~new_n165_ | (x64 & ~x65 & (new_n157_ | (new_n124_ & x23)));
  ...
  assign z12 = ~new_n220_ | (x64 & ~x65 & (new_n212_ | (new_n124_ & x28)));
  assign new_n212_ = ~x68 & (x66 ? (~new_n219_ & ~x67) : (x67 ? ~new_n219_ : (~new_n213_ & x69)));
  assign new_n213_ = ~new_n214_ & (new_n150_ | (~new_n217_ & ~new_n218_ & (new_n120_ | ~x28)));
  ...
  assign new_n219_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x60 | ~x69 | x70 | x71) & (~x44 | ~x70 | ~x71);
  assign new_n220_ = (~x68 | x69) & (x64 | ~x65 | x68 | ~x69 | new_n213_ | new_n100_);
  assign z13 = ~new_n230_ | (x64 & ~x65 & (new_n222_ | (new_n124_ & x29)));
  assign new_n222_ = ~x68 & (x66 ? (~new_n229_ & ~x67) : (x67 ? ~new_n229_ : (~new_n223_ & x69)));
  assign new_n223_ = ~new_n224_ & (new_n150_ | (~new_n227_ & ~new_n228_ & (new_n120_ | ~x29)));
  ...
  assign new_n229_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x61 | ~x69 | x70 | x71) & (~x45 | ~x70 | ~x71);
  assign new_n230_ = (~x68 | x69) & (x64 | ~x65 | x68 | ~x69 | new_n223_ | new_n100_);
  ...
  assign z15 = ~new_n251_ | (x64 & ~x65 & (new_n243_ | (new_n124_ & x31)));
  assign new_n243_ = ~x68 & (x66 ? (~new_n250_ & ~x67) : (x67 ? ~new_n250_ : (~new_n244_ & x69)));
  assign new_n244_ = ~new_n245_ & (new_n150_ | (~new_n248_ & ~new_n249_ & (new_n120_ | ~x31)));
  ...
  assign new_n250_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x63 | ~x69 | x70 | x71) & (~x47 | ~x70 | ~x71);
  assign new_n251_ = (~x68 | x69) & (x64 | ~x65 | x68 | ~x69 | new_n244_ | new_n100_);
endmodule
