...
module FAU ( 
  ...
  assign z04 = ~x69 & ((~new_n162_ & ~x65) | (~x64 & x65 & ~new_n170_ & x68));
  assign new_n162_ = (~x68 | (x64 ? ~new_n166_ : ~new_n163_)) & (~x64 | ~new_n169_ | x68);
  ...
  assign new_n200_ = (~x64 | ~new_n208_ | x68) & (~x68 | x69 | (x64 ? ~new_n204_ : ~new_n201_));
  ...
  assign z08 = (~new_n212_ & ~x65) | (~x68 & x69) | (~x64 & x65 & x68 & ~new_n221_ & ~x69);
  assign new_n212_ = (~x64 | ~new_n220_ | x68) & (~x68 | x69 | (x64 ? ~new_n216_ : ~new_n213_));
  assign new_n213_ = ~new_n104_ & (new_n215_ | (new_n214_ & ~x70));
  assign new_n214_ = x71 & ((x08 & (~x00 | (new_n122_ & new_n123_))) | (x00 & ~x08 & (~new_n122_ | ~new_n123_)));
  assign new_n215_ = x70 & ~x71 & ((x40 & (~x32 | (new_n126_ & new_n127_))) | (x32 & ~x40 & (~new_n126_ | ~new_n127_)));
  ...
  assign new_n221_ = ~new_n222_ & (x66 | ~new_n215_ | x67);
  assign new_n222_ = ~x70 & ((~x71 & ~new_n217_ & (x66 | x67)) | (~x66 & new_n214_ & ~x67));
  ...
  assign new_n226_ = x71 & ((x09 & (new_n152_ | ~x00)) | (x00 & ~new_n152_ & ~x09));
  assign new_n227_ = x70 & ~x71 & ((x41 & (new_n155_ | ~x32)) | (x32 & ~new_n155_ & ~x41));
  ...
  assign new_n250_ = (~x64 | ~new_n258_ | x68) & (~x68 | x69 | (x64 ? ~new_n254_ : ~new_n251_));
  assign new_n251_ = ~new_n104_ & (new_n253_ | (new_n252_ & ~x70));
  assign new_n252_ = x71 & ((x11 & (new_n123_ | ~x00)) | (x00 & ~new_n123_ & ~x11));
