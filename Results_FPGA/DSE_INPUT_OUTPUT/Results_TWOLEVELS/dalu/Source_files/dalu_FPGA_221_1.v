...
module FAU ( 
  ...
  assign new_n173_ = (~x64 | ~new_n182_ | x68) & (~x68 | x69 | (x64 ? ~new_n178_ : ~new_n174_));
  ...
  assign new_n186_ = (~x64 | ~new_n196_ | x68) & (~x68 | x69 | (x64 ? ~new_n192_ : ~new_n187_));
  ...
  assign new_n200_ = (~x68 | (x64 ? ~new_n204_ : ~new_n201_)) & (~x64 | ~new_n208_ | x68);
  ...
  assign new_n253_ = (~x64 | ~new_n261_ | x68) & (~x68 | x69 | (x64 ? ~new_n257_ : ~new_n254_));
