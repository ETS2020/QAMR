// Benchmark "FAU" written by ABC on Sun Aug 23 20:12:15 2020
...
module FAU ( 
  ...
  assign new_n190_ = ~new_n191_ & ((~x65 & (x66 | (x67 & x68))) | (x65 & ~x66 & ~x67 & x68));
  ...
  assign new_n212_ = x71 & (x04 | (~x04 & (x14 | x15 | x12 | x13)));
  assign new_n213_ = x32 & ~x37 & ~x38 & ~x39 & new_n214_ & x70;
  assign new_n214_ = ~x71 & (x36 | (~x36 & (x46 | x47 | x44 | x45)));
  ...
  assign z08 = x64 ? new_n280_ : (new_n279_ | (~new_n267_ & ~new_n105_));
  assign new_n267_ = (~x68 | x69 | (x65 ? ~new_n271_ : new_n268_)) & (~x65 | x68 | new_n275_ | ~x69);
  assign new_n268_ = x70 ? (new_n270_ | x71) : (new_n269_ | ~x71);
  assign new_n269_ = (~x08 | (x00 & (~new_n116_ | ~new_n117_))) & (~x00 | x08 | (new_n116_ & new_n117_));
  assign new_n270_ = (~x40 | (x32 & (~new_n121_ | ~new_n122_))) & (~x32 | x40 | (new_n121_ & new_n122_));
  assign new_n271_ = ~x70 & ~new_n272_ & ~x71;
  assign new_n272_ = (new_n227_ | ~x56) & (new_n274_ | x72) & (new_n273_ | ~x72);
  assign new_n273_ = (x73 | (x74 ? ~x51 : ~x52)) & (~x48 | ~x73 | x74);
  assign new_n274_ = (~x73 | (x74 ? ~x53 : ~x54)) & (~x55 | x73 | ~x74);
  assign new_n275_ = (new_n276_ | (~x70 ^ x71)) & (~x70 | new_n272_ | ~x71);
  assign new_n276_ = (new_n227_ | ~x24) & (new_n278_ | x72) & (new_n277_ | ~x72);
  ...
  assign new_n280_ = ~x65 & (x68 ? (new_n284_ & ~x69) : (x69 & (new_n281_ | ~new_n282_)));
  assign new_n281_ = (x70 ^ x71) & ((~x66 & ~new_n276_ & ~x67) | (x08 & (x66 ^ x67)));
  assign new_n282_ = (new_n283_ | (~x66 ^ x67)) & (x66 | x67 | ~x70 | new_n272_ | ~x71);
  assign new_n283_ = (~x56 | x70 | x71) & (~x40 | ~x70 | ~x71);
  assign new_n284_ = ~x70 & ~x71 & ((~x66 & ~new_n272_ & ~x67) | (x40 & (x66 ^ x67)));
  assign z09 = x64 ? new_n298_ : (new_n297_ | (~new_n286_ & ~new_n105_));
  assign new_n286_ = (~x68 | x69 | (x65 ? ~new_n289_ : new_n287_)) & (~x65 | x68 | new_n293_ | ~x69);
  assign new_n287_ = x70 ? (new_n288_ | x71) : (~x71 | ((~x00 | new_n154_ | x09) & (~x09 | (~new_n154_ & x00))));
  assign new_n288_ = (~x41 | (~new_n157_ & x32)) & (~x32 | new_n157_ | x41);
  assign new_n289_ = ~x70 & ~new_n290_ & ~x71;
  assign new_n290_ = (new_n227_ | ~x57) & (new_n292_ | x72) & (new_n291_ | ~x72);
  assign new_n291_ = (x73 | (x74 ? ~x52 : ~x53)) & (~x49 | ~x73 | x74);
  assign new_n292_ = (~x73 | (x74 ? ~x54 : ~x55)) & (~x56 | x73 | ~x74);
  assign new_n293_ = (new_n294_ | (~x70 ^ x71)) & (~x70 | new_n290_ | ~x71);
  assign new_n294_ = (new_n227_ | ~x25) & (new_n296_ | x72) & (new_n295_ | ~x72);
  ...
  assign new_n298_ = ~x65 & (x68 ? (new_n302_ & ~x69) : (x69 & (new_n299_ | ~new_n300_)));
  assign new_n299_ = (x70 ^ x71) & ((~x66 & ~new_n294_ & ~x67) | (x09 & (x66 ^ x67)));
  assign new_n300_ = (new_n301_ | (~x66 ^ x67)) & (x66 | x67 | ~x70 | new_n290_ | ~x71);
  assign new_n301_ = (~x57 | x70 | x71) & (~x41 | ~x70 | ~x71);
  assign new_n302_ = ~x70 & ~x71 & ((~x66 & ~new_n290_ & ~x67) | (x41 & (x66 ^ x67)));
  assign z10 = ~new_n333_ | (~x64 & (new_n323_ | (~new_n304_ & ~new_n105_)));
  assign new_n304_ = x70 ? (x65 ? (new_n317_ | x68) : ~new_n319_) : new_n305_;
  assign new_n305_ = (~new_n313_ | ~x65) & (x69 | (x65 ? (new_n309_ | x71) : (new_n306_ | ~x71)));
  assign new_n306_ = (~x10 | (~new_n307_ & x00)) & (~x00 | new_n308_ | x10);
  assign new_n307_ = ~x11 & ~x12 & ~x13 & ~x14 & ~x15;
  assign new_n308_ = ~x12 & ~x14 & ~x15 & (~x11 | ~x68);
  ...
  assign new_n312_ = ~x72 & ((x73 & (x74 ? x55 : x56)) | (x57 & ~x73 & x74));
  assign new_n313_ = ~x68 & x71 & (new_n314_ | new_n315_ | new_n316_);
  assign new_n314_ = x26 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n315_ = x72 & ((~x73 & (x74 ? x21 : x22)) | (x18 & x73 & ~x74));
  assign new_n316_ = ~x72 & ((x73 & (x74 ? x23 : x24)) | (x25 & ~x73 & x74));
  assign new_n317_ = new_n318_ & (new_n227_ | (x71 ? ~x58 : ~x26));
  assign new_n318_ = x71 ? (~new_n311_ & ~new_n312_) : (~new_n315_ & ~new_n316_);
  assign new_n319_ = ~x69 & ~x71 & ((x42 & (new_n320_ | ~x32)) | (x32 & ~new_n322_ & ~x42));
  assign new_n320_ = new_n321_ & ~x43 & ~x44;
  assign new_n321_ = ~x45 & ~x46 & ~x47;
  assign new_n322_ = ~x44 & ~x46 & ~x47 & (~x43 | ~x68);
  assign new_n323_ = ~x69 & (x65 ? (~x66 & ~new_n324_ & ~x67) : new_n330_);
  assign new_n324_ = x70 ? (new_n328_ | x71) : (~x71 | (~new_n325_ & (~new_n326_ | ~x00)));
  assign new_n325_ = x10 & (new_n307_ | ~x00);
  assign new_n326_ = ~x10 & (~new_n327_ | x12 | (x68 & (x11 | x13)));
  assign new_n327_ = ~x14 & ~x15;
  assign new_n328_ = (~x32 | new_n329_ | x42) & (~x42 | (x32 & (~new_n321_ | x43 | x44)));
  assign new_n329_ = (~x68 | (~x43 & ~x45)) & ~x44 & ~x46 & ~x47;
  assign new_n330_ = ~new_n331_ & (x66 | (x67 & x68));
  assign new_n331_ = ~new_n332_ & (~x00 | x10 | ~x13 | x70 | ~x71);
  assign new_n332_ = x32 & ~x42 & x45 & x70 & ~x71;
  assign new_n333_ = (x68 | x69) & (~x64 | x65 | ((~new_n338_ | x69) & (new_n334_ | x68)));
  assign new_n334_ = (new_n335_ | (~x70 ^ x71)) & ~new_n337_ & (~new_n336_ | x66);
  assign new_n335_ = (~x10 | (~x66 ^ x67)) & (x66 | x67 | (~new_n314_ & ~new_n315_ & ~new_n316_));
  assign new_n336_ = ~x67 & x70 & x71 & (new_n310_ | new_n311_ | new_n312_);
  assign new_n337_ = (x66 ^ x67) & ((x42 & x70 & x71) | (x58 & ~x70 & ~x71));
  assign new_n338_ = ~x70 & ~x71 & ((~x66 & ~new_n309_ & ~x67) | (x42 & (x66 ^ x67)));
  assign z11 = x64 ? new_n357_ : (new_n355_ | (~new_n105_ & (new_n340_ | new_n352_)));
  assign new_n340_ = ~x70 & ((x68 & ~new_n341_ & ~x69) | (x65 & ~x68 & new_n347_ & x69));
  assign new_n341_ = x65 ? (x71 | (new_n343_ & ~new_n346_)) : (new_n342_ | ~x71);
  assign new_n342_ = (~x11 | (~new_n117_ & x00)) & (~x00 | new_n117_ | x11);
  ...
  assign new_n347_ = x71 & (~new_n348_ | new_n351_);
  ...
  assign new_n352_ = x70 & (x65 ? (~x68 & ~new_n353_ & x69) : (x68 & new_n354_ & ~x69));
  assign new_n353_ = (new_n227_ | (x71 ? ~x59 : ~x27)) & (new_n348_ | x71) & (new_n343_ | ~x71);
  assign new_n354_ = ~x71 & ((x43 & (new_n122_ | ~x32)) | (x32 & ~new_n122_ & ~x43));
  assign new_n355_ = x65 & ~x66 & ~x67 & x68 & ~new_n356_ & ~x69;
  assign new_n356_ = x70 ? ~new_n354_ : (new_n342_ | ~x71);
  assign new_n357_ = ~x65 & (x68 ? (~x69 & new_n362_ & ~x70) : (~new_n358_ & x69));
  assign new_n358_ = (new_n359_ | (~x70 ^ x71)) & ~new_n361_ & (~new_n360_ | x66);
  assign new_n359_ = (~x11 | (~x66 ^ x67)) & (x66 | x67 | (~new_n351_ & ~new_n349_ & ~new_n350_));
  assign new_n360_ = ~x67 & x70 & x71 & (new_n346_ | new_n344_ | new_n345_);
  assign new_n361_ = (x66 ^ x67) & ((x43 & x70 & x71) | (x59 & ~x70 & ~x71));
  assign new_n362_ = ~x71 & ((x43 & (x66 ^ x67)) | (~x66 & ~x67 & (~new_n343_ | new_n346_)));
  assign z12 = x64 ? new_n380_ : (new_n378_ | (~new_n105_ & (new_n364_ | new_n374_)));
  assign new_n364_ = ~x70 & ((x68 & ~new_n365_ & ~x69) | (x65 & ~x68 & new_n370_ & x69));
  assign new_n365_ = x65 ? (new_n367_ | x71) : ~new_n366_;
  assign new_n366_ = x71 & ((x12 & (~x00 | (new_n327_ & ~x13))) | (x00 & ~x12 & (~new_n327_ | x13)));
  assign new_n367_ = ~new_n368_ & ~new_n369_ & (new_n227_ | ~x60);
  ...
  assign new_n371_ = ~new_n372_ & ~new_n373_ & (new_n227_ | ~x28);
  ...
  assign new_n375_ = new_n376_ & (new_n227_ | (x71 ? ~x60 : ~x28));
  assign new_n376_ = x71 ? (~new_n368_ & ~new_n369_) : (~new_n372_ & ~new_n373_);
  assign new_n377_ = ~x71 & ((x44 & (new_n321_ | ~x32)) | (x32 & ~new_n321_ & ~x44));
  assign new_n378_ = x65 & ~x66 & ~x67 & x68 & ~new_n379_ & ~x69;
  assign new_n379_ = x70 ? ~new_n377_ : ~new_n366_;
  assign new_n380_ = ~x65 & (x68 ? (new_n384_ & ~x69) : (x69 & (new_n381_ | ~new_n382_)));
  assign new_n381_ = (x70 ^ x71) & ((~x66 & ~new_n371_ & ~x67) | (x12 & (x66 ^ x67)));
  assign new_n382_ = (new_n383_ | (~x66 ^ x67)) & (x66 | x67 | ~x70 | new_n367_ | ~x71);
  assign new_n383_ = (~x60 | x70 | x71) & (~x44 | ~x70 | ~x71);
  assign new_n384_ = ~x70 & ~x71 & ((~x66 & ~new_n367_ & ~x67) | (x44 & (x66 ^ x67)));
  assign z13 = x64 ? new_n399_ : (new_n404_ | (~new_n105_ & (new_n386_ | new_n395_)));
  assign new_n386_ = ~x70 & ((x68 & ~new_n387_ & ~x69) | (x65 & ~x68 & new_n391_ & x69));
  assign new_n387_ = x65 ? (new_n388_ | x71) : (~x71 | ((~x00 | new_n327_ | x13) & (~x13 | (~new_n327_ & x00))));
  assign new_n388_ = ~new_n389_ & ~new_n390_ & (new_n227_ | ~x61);
  assign new_n389_ = x72 & ((~x73 & (x74 ? x56 : x57)) | (x53 & x73 & ~x74));
  assign new_n390_ = ~x72 & ((x73 & (x74 ? x58 : x59)) | (x60 & ~x73 & x74));
  assign new_n391_ = ~new_n392_ & x71;
  assign new_n392_ = ~new_n393_ & ~new_n394_ & (new_n227_ | ~x29);
  ...
  assign new_n396_ = new_n397_ & (new_n227_ | (x71 ? ~x61 : ~x29));
  assign new_n397_ = x71 ? (~new_n389_ & ~new_n390_) : (~new_n393_ & ~new_n394_);
  assign new_n398_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n399_ = ~x65 & (x68 ? (new_n403_ & ~x69) : (x69 & (new_n400_ | ~new_n401_)));
  assign new_n400_ = (x70 ^ x71) & ((~x66 & ~new_n392_ & ~x67) | (x13 & (x66 ^ x67)));
  assign new_n401_ = (new_n402_ | (~x66 ^ x67)) & (x66 | x67 | ~x70 | new_n388_ | ~x71);
  assign new_n402_ = (~x61 | x70 | x71) & (~x45 | ~x70 | ~x71);
  assign new_n403_ = ~x70 & ~x71 & ((~x66 & ~new_n388_ & ~x67) | (x45 & (x66 ^ x67)));
  assign new_n404_ = x65 & ~x66 & ~x67 & x68 & ~new_n405_ & ~x69;
  assign new_n405_ = x70 ? ~new_n398_ : (~x71 | ((~x13 | (~new_n327_ & x00)) & (~x00 | new_n327_ | x13)));
  assign z14 = (~new_n407_ & ~x64) | new_n198_ | (new_n421_ & x64);
  assign new_n407_ = (~new_n420_ | ~x65) & (new_n105_ | (x70 ? new_n416_ : new_n408_));
  assign new_n408_ = (~new_n412_ | ~x65) & (x69 | (x65 ? (new_n409_ | x71) : ~new_n415_));
  assign new_n409_ = (new_n227_ | ~x62) & (new_n411_ | x72) & (new_n410_ | ~x72);
  assign new_n410_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n411_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n412_ = ~x68 & x71 & (new_n413_ | new_n414_ | (~new_n227_ & x30));
  assign new_n413_ = x72 & ((~x73 & (x74 ? x25 : x26)) | (x22 & x73 & ~x74));
  assign new_n414_ = ~x72 & ((x73 & (x74 ? x27 : x28)) | (x29 & ~x73 & x74));
  assign new_n415_ = x71 & ((x14 & (~x15 | (~x00 & x68))) | (x00 & ~x14 & x15));
  assign new_n416_ = x65 ? (x68 | (~new_n417_ & new_n418_)) : (~new_n419_ | x69);
  assign new_n417_ = ~new_n227_ & (x71 ? x62 : x30);
  assign new_n418_ = x71 ? (x72 ? new_n410_ : new_n411_) : (~new_n413_ & ~new_n414_);
  assign new_n419_ = ~x71 & ((x46 & (~x47 | (~x32 & x68))) | (x32 & ~x46 & x47));
  assign new_n420_ = ~x66 & ~x67 & ~x69 & (x70 ? new_n419_ : new_n415_);
  assign new_n421_ = ~x65 & ((new_n426_ & ~x69) | (~x68 & (new_n422_ | ~new_n424_)));
  assign new_n422_ = (x70 ^ x71) & ((~x66 & ~new_n423_ & ~x67) | (x14 & (x66 ^ x67)));
  assign new_n423_ = ~new_n413_ & ~new_n414_ & (new_n227_ | ~x30);
  assign new_n424_ = (new_n425_ | (~x66 ^ x67)) & (x66 | x67 | ~x70 | new_n409_ | ~x71);
  assign new_n425_ = (~x62 | x70 | x71) & (~x46 | ~x70 | ~x71);
  assign new_n426_ = ~x70 & ~x71 & ((~x66 & ~new_n409_ & ~x67) | (x46 & (x66 ^ x67)));
  assign z15 = x68 ? (~new_n438_ & ~x69) : (x69 & (x64 ? new_n428_ : new_n442_));
  assign new_n428_ = ~x65 & (new_n429_ | (~x66 & new_n433_ & ~x67) | (~new_n437_ & (x66 ^ x67)));
  assign new_n429_ = (x70 ^ x71) & ((~x66 & ~new_n430_ & ~x67) | (x15 & (x66 ^ x67)));
  assign new_n430_ = (new_n227_ | ~x31) & (new_n432_ | x72) & (new_n431_ | ~x72);
  assign new_n431_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n432_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n433_ = x70 & ~new_n434_ & x71;
  assign new_n434_ = (new_n227_ | ~x63) & (new_n436_ | x72) & (new_n435_ | ~x72);
  assign new_n435_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n436_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n437_ = (~x63 | x70 | x71) & (~x47 | ~x70 | ~x71);
  assign new_n438_ = x64 ? (~new_n440_ | x65) : ((new_n439_ | new_n105_) & (~new_n441_ | ~x65));
  assign new_n439_ = (x70 | ((~x65 | new_n434_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n440_ = ~x70 & ~x71 & ((~x66 & ~new_n434_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n441_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n442_ = x65 & ~new_n105_ & ((~new_n430_ & (x70 ^ x71)) | (x70 & ~new_n434_ & x71));
endmodule
