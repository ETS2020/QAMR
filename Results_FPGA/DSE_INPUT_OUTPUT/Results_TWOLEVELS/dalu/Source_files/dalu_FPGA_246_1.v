...
module FAU ( 
  ...
  assign z04 = (~new_n161_ & ~x65) | (~x68 & x69) | (~x64 & x65 & x68 & ~new_n169_ & ~x69);
  assign new_n161_ = (~x68 | x69 | (x64 ? ~new_n165_ : ~new_n162_)) & (~x64 | ~new_n168_ | x68);
  ...
  assign z10 = (~new_n236_ & ~x65) | (~x68 & x69) | (~x64 & x65 & x68 & ~new_n247_ & ~x69);
  assign new_n236_ = (~x68 | x69 | (x64 ? ~new_n242_ : ~new_n237_)) & (~x64 | ~new_n246_ | x68);
  ...
  assign new_n262_ = (~x64 | ~new_n270_ | x68) & (~x68 | (x64 ? ~new_n266_ : ~new_n263_));
  ...
  assign new_n272_ = (x71 | new_n267_ | (~x66 & ~x67)) & (x66 | ~new_n264_ | x67);
  ...
  assign new_n283_ = x68 & ((~new_n284_ & ~x70) | (~x66 & new_n281_ & ~x67));
