// Benchmark "FAU" written by ABC on Sun Aug 23 20:17:36 2020
...
module FAU ( 
  ...
  assign new_n159_ = (~x68 | (x64 ? ~new_n163_ : ~new_n160_)) & (~x64 | ~new_n166_ | x68);
  ...
  assign new_n170_ = (~x68 | (x64 ? ~new_n175_ : ~new_n171_)) & (~x64 | ~new_n179_ | x68);
  ...
  assign new_n183_ = (~x68 | (x64 ? ~new_n189_ : ~new_n184_)) & (~x64 | ~new_n193_ | x68);
  ...
  assign new_n197_ = (~x64 | ~new_n205_ | x68) & (~x68 | x69 | (x64 ? ~new_n201_ : ~new_n198_));
  ...
  assign new_n209_ = (~x64 | ~new_n217_ | x68) & (~x68 | x69 | (x64 ? ~new_n213_ : ~new_n210_));
  assign new_n210_ = ~new_n104_ & (new_n212_ | (new_n211_ & ~x70));
  assign new_n211_ = x71 & ((x08 & (~x00 | (new_n121_ & new_n122_))) | (x00 & ~x08 & (~new_n121_ | ~new_n122_)));
  assign new_n212_ = x70 & ~x71 & ((x40 & (~x32 | (new_n125_ & new_n126_))) | (x32 & ~x40 & (~new_n125_ | ~new_n126_)));
  ...
  assign new_n249_ = (~x68 | (x64 ? ~new_n253_ : ~new_n250_)) & (~x64 | ~new_n257_ | x68);
  ...
  assign new_n261_ = (~x68 | (x64 ? ~new_n265_ : ~new_n262_)) & (~x64 | ~new_n269_ | x68);
