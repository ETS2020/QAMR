// Benchmark "FAU" written by ABC on Sun Aug 23 20:17:09 2020
...
module FAU ( 
  ...
  assign new_n250_ = (~x64 | ~new_n258_ | x68) & (~x68 | (x64 ? ~new_n254_ : ~new_n251_));
  assign new_n251_ = ~new_n104_ & (new_n253_ | (~x70 & ~new_n252_ & x71));
  assign new_n252_ = (~x11 | (~new_n123_ & x00)) & (~x00 | new_n123_ | x11);
  assign new_n253_ = x70 & ~x71 & ((x43 & (new_n127_ | ~x32)) | (x32 & ~new_n127_ & ~x43));
