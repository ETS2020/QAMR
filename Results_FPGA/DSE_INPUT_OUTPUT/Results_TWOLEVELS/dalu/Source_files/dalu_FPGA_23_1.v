// Benchmark "FAU" written by ABC on Sun Aug 23 20:09:38 2020
...
module FAU ( 
  ...
  assign z03 = (~new_n143_ & ~x65) | (~x68 & x69) | (~x64 & x65 & x68 & ~new_n155_ & ~x69);
  assign new_n143_ = (~x68 | x69 | (x64 ? ~new_n151_ : ~new_n144_)) & (~x64 | ~new_n154_ | x68);
  assign new_n144_ = ~new_n104_ & (x70 ? (~new_n148_ & ~x71) : (~new_n145_ & x71));
  assign new_n145_ = (~x03 | (x00 & (~new_n146_ | ~new_n147_))) & (~x00 | x03 | (new_n146_ & new_n147_));
  assign new_n146_ = ~x07 & ~x08 & ~x09 & ~x04 & ~x05 & ~x06;
  ...
  assign new_n152_ = (~x51 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n153_ | x72) & (~x48 | (x72 ? (x74 & (x73 | ~x74)) : (~x73 | ~x74)));
  assign new_n153_ = (~x50 | x73 | ~x74) & (~x49 | ~x73 | x74);
  assign new_n154_ = ~new_n106_ & ((x70 & (x71 ? x35 : x19)) | (x03 & ~x70 & x71));
  assign new_n155_ = (x66 | new_n156_ | x67) & (x70 | x71 | new_n152_ | (~x66 & ~x67));
  assign new_n156_ = x70 ? (new_n148_ | x71) : (new_n145_ | ~x71);
  ...
  assign new_n160_ = x00 ? (x04 | (~x05 & ~x06 & ~x07 & (x05 | x06 | new_n122_ | x07))) : ~x04;
  assign new_n161_ = x32 ? (x36 | (~x37 & ~x38 & ~x39 & (x37 | x38 | new_n126_ | x39))) : ~x36;
  ...
  assign new_n173_ = x32 ? (x37 | (~x38 & ~x39 & (x38 | x39 | (~x36 & (new_n126_ | x36))))) : ~x37;
  ...
  assign z07 = ~x69 & ((~new_n196_ & ~x65) | (~x64 & new_n205_ & x65));
  assign new_n196_ = (~x64 | ~new_n204_ | x68) & (~x68 | (x64 ? ~new_n200_ : ~new_n197_));
  ...
  assign new_n205_ = x68 & ((~new_n206_ & ~x70) | (~x66 & new_n199_ & ~x67));
  assign new_n206_ = (x71 | new_n201_ | (~x66 & ~x67)) & (x66 | ~new_n198_ | x67);
  ...
  assign new_n210_ = x71 & ((x08 & (~x00 | (new_n121_ & new_n122_))) | (x00 & ~x08 & (~new_n121_ | ~new_n122_)));
  assign new_n211_ = x70 & ~x71 & ((x40 & (~x32 | (new_n125_ & new_n126_))) | (x32 & ~x40 & (~new_n125_ | ~new_n126_)));
  ...
  assign new_n222_ = x71 & ((x09 & (new_n147_ | ~x00)) | (x00 & ~new_n147_ & ~x09));
  ...
  assign new_n228_ = x70 & ~x71 & ((x41 & (new_n150_ | ~x32)) | (x32 & ~new_n150_ & ~x41));
  ...
  assign new_n267_ = x72 & ((x52 & x73 & ~x74) | (~x73 & (x74 ? x55 : x56)));
  ...
  assign z15 = (~new_n297_ & ~x65) | (~x68 & x69) | (~x64 & x65 & x68 & ~new_n306_ & ~x69);
  assign new_n297_ = x64 ? ((new_n304_ | (~x66 ^ x67)) & (x66 | ~new_n298_ | x67)) : ~new_n302_;
  ...
  assign new_n302_ = x68 & new_n303_ & ~x69;
  assign new_n303_ = ~new_n104_ & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n304_ = (new_n305_ | x68) & (~x47 | ((x68 | ~x70 | ~x71) & (~x68 | x69 | x70 | x71)));
  assign new_n305_ = (~x15 | x70 | ~x71) & (~x31 | ~x70 | x71);
  assign new_n306_ = (new_n307_ | x70) & (~x47 | x66 | x67 | ~x70 | x71);
  assign new_n307_ = (x71 | new_n299_ | (~x66 & ~x67)) & (~x15 | x66 | x67 | ~x71);
endmodule
