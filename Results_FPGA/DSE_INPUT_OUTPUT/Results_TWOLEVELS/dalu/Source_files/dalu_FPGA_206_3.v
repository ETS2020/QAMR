// Benchmark "FAU" written by ABC on Sun Aug 23 20:18:06 2020
...
module FAU ( 
  ...
  assign new_n127_ = ~x30 & x65 & new_n128_ & ~x68;
  ...
  assign new_n136_ = (x30 | ~x69 | (x70 ? ~x01 : ~x49)) & (~x17 | x69 | ~x70);
  assign new_n137_ = (new_n138_ | ~x48) & (~x16 | x30 | ~new_n143_ | x68);
  assign new_n138_ = x74 ? (~new_n140_ & (~new_n139_ | x30)) : (new_n141_ | new_n142_);
  assign new_n139_ = ~x68 & x69 & x70 & x71 & (~x72 | (x72 & ~x73));
  assign new_n140_ = x68 & ~x69 & ~x70 & ~x71 & (~x73 | (~x72 & x73));
  assign new_n141_ = ~x72 & ~x73;
  assign new_n142_ = (x70 | x71 | ~x68 | x69) & (x30 | x68 | ~x69 | ~x70 | ~x71);
  assign new_n143_ = x69 & ~new_n144_ & ((x72 & (~x74 | (~x73 & x74))) | (x73 & ~x74) | (~x72 & x74));
  assign new_n144_ = ~x70 ^ x71;
  assign new_n145_ = (x30 | x68 | new_n129_ | ~x69) & (~new_n109_ | ~x49 | ~x68);
  ...
  assign new_n158_ = (x73 | ~x74 | ~x17 | x72) & (~x16 | ((x30 | ((~x73 | x74) & (~x72 | (x74 & (x73 | ~x74))))) & (x72 | ~x73 | ~x74)));
  assign new_n159_ = (x73 | ~x74 | ~x49 | x72) & (~x48 | ((x72 | ~x73 | ~x74) & (x30 | ((~x73 | x74) & (~x72 | (x74 & (x73 | ~x74)))))));
  ...
  assign new_n181_ = x16 & ((~x72 & x73 & x74) | (~x30 & x72 & (~x74 | (~x73 & x74))));
  assign new_n182_ = (~x18 | x73 | ~x74) & (~x17 | ~x73 | x74);
  assign new_n183_ = new_n184_ & (~x48 | ((x72 | ~x73 | ~x74) & (x30 | ~x72 | (x74 & (x73 | ~x74)))));
  ...
  assign new_n194_ = (~x68 | ~new_n201_ | x69) & (x30 | x68 | ~x69 | (~new_n195_ & ~new_n198_));
  ...
  assign new_n208_ = (x30 | ~x69 | (x70 ? ~x04 : ~x52)) & (~x20 | x69 | ~x70);
  ...
  assign new_n213_ = (~x16 | x30 | (~x73 ^ x74)) & (~x17 | x73 | x74) & (~x21 | ~x73 | ~x74);
  assign new_n214_ = x73 ? (x74 ? ~x18 : ~x19) : (x74 ? ~x20 : ~x21);
  assign new_n215_ = x70 & x71 & (x72 ? ~new_n216_ : ~new_n217_);
  assign new_n216_ = (x30 | ~x48 | (~x73 ^ x74)) & (~x53 | ~x73 | ~x74) & (~x49 | x73 | x74);
  ...
  assign new_n253_ = (~x68 | ~new_n261_ | x69) & (x30 | x68 | ~x69 | (~new_n254_ & ~new_n257_));
  assign new_n254_ = ~new_n144_ & (new_n255_ | new_n256_ | (~new_n146_ & x23));
  assign new_n255_ = x72 & ((x16 & x73 & ~x74) | (~x73 & (x74 ? x18 : x19)));
  ...
  assign new_n266_ = (x68 | (x71 ? ~new_n267_ : new_n268_)) & (~new_n109_ | ~x39 | ~x68);
  assign new_n267_ = ~new_n112_ & (x70 ? x39 : x07);
  assign new_n268_ = (x30 | ~x69 | (x70 ? ~x07 : ~x55)) & (~x23 | x69 | ~x70);
  assign z08 = (~x64 & (new_n270_ | new_n284_)) | new_n112_ | (new_n286_ & x64);
  assign new_n270_ = ~new_n114_ & ((x68 & ~new_n271_ & ~x69) | (x65 & ~x68 & ~new_n278_ & x69));
  ...
  assign new_n279_ = ~new_n144_ & ((~new_n146_ & x24) | (~new_n281_ & ~x72) | (~new_n280_ & x72));
  assign new_n280_ = (x73 | (x74 ? ~x19 : ~x20)) & (~x73 | x74 | ~x16 | x30);
  assign new_n281_ = (~x73 | (x74 ? ~x21 : ~x22)) & (~x23 | x73 | ~x74);
  assign new_n282_ = x70 & x71 & (new_n275_ | new_n277_ | (~new_n283_ & x72));
  assign new_n283_ = (x73 | (x74 ? ~x51 : ~x52)) & (~x73 | x74 | x30 | ~x48);
  ...
  assign new_n287_ = ~x68 & (x67 ? ~new_n288_ : (x69 & (new_n279_ | new_n282_)));
  ...
  assign new_n291_ = ~x71 & (x67 ? x40 : (new_n275_ | new_n276_ | new_n277_));
  assign new_n292_ = ~x67 & ((~new_n288_ & ~x68) | (new_n109_ & x40 & x68));
  assign z09 = (~new_n294_ & ~x64) | new_n112_ | (x64 & ~x65 & (new_n308_ | new_n312_));
  ...
  assign new_n296_ = ~x70 & x71 & ((x09 & (new_n173_ | ~x00)) | (x00 & ~new_n173_ & ~x09));
  assign new_n297_ = x70 & ~x71 & ((x41 & (new_n176_ | ~x32)) | (x32 & ~new_n176_ & ~x41));
  ...
  assign new_n304_ = (new_n146_ | ~x25) & (new_n305_ | ~x72) & (new_n306_ | x72);
  ...
  assign new_n314_ = ~new_n114_ & (x70 ? ~new_n325_ : (new_n315_ | new_n321_));
  ...
  assign new_n318_ = ~x71 & (new_n319_ | new_n320_ | (~new_n146_ & x58));
  assign new_n319_ = x72 & ((x50 & x73 & ~x74) | (~x73 & (x74 ? x53 : x54)));
  assign new_n320_ = ~x72 & ((x57 & ~x73 & x74) | (x73 & (x74 ? x55 : x56)));
  assign new_n321_ = ~x30 & x65 & ~x68 & x69 & ~new_n322_ & x71;
  assign new_n322_ = ~new_n323_ & ~new_n324_ & (new_n146_ | ~x26);
  assign new_n323_ = x72 & ((x18 & x73 & ~x74) | (~x73 & (x74 ? x21 : x22)));
  assign new_n324_ = ~x72 & ((x25 & ~x73 & x74) | (x73 & (x74 ? x23 : x24)));
  assign new_n325_ = (x30 | ~x65 | x68 | new_n326_ | ~x69) & (x65 | ~x68 | ~new_n328_ | x69);
  ...
  assign new_n330_ = x66 ? (new_n334_ | x67) : (x67 ? new_n334_ : (~new_n333_ & (~new_n331_ | x30)));
  assign new_n331_ = ~x68 & x69 & ((x70 & ~new_n332_ & x71) | (~new_n322_ & (x70 ^ x71)));
  assign new_n332_ = ~new_n319_ & ~new_n320_ & (new_n146_ | ~x58);
  ...
  assign new_n336_ = (x30 | ~x69 | (x70 ? ~x10 : ~x58)) & (~x26 | x69 | ~x70);
  ...
  assign new_n346_ = x71 & (new_n347_ | new_n348_ | (~new_n146_ & x27));
  assign new_n347_ = x72 & ((x19 & x73 & ~x74) | (~x73 & (x74 ? x22 : x23)));
  ...
  assign new_n355_ = x69 & (new_n357_ | (~new_n144_ & (~new_n356_ | (~new_n146_ & x27))));
  ...
  assign z13 = x64 ? new_n405_ : (new_n413_ | (~new_n114_ & (new_n389_ | new_n400_)));
  assign new_n389_ = ~x70 & ((new_n390_ & x68) | (~x30 & x65 & new_n396_ & ~x68));
  assign new_n390_ = ~x69 & (x65 ? (~x71 & (~new_n391_ | new_n395_)) : (~new_n394_ & x71));
  assign new_n391_ = ~new_n392_ & ~new_n393_;
  assign new_n392_ = x72 & ((x53 & x73 & ~x74) | (~x73 & (x74 ? x56 : x57)));
  ...
  assign new_n396_ = x69 & x71 & (~new_n397_ | (~new_n146_ & x29));
  ...
  assign new_n400_ = x70 & ((~x65 & new_n403_ & x68) | (~x30 & x65 & new_n401_ & ~x68));
  assign new_n401_ = x69 & (new_n402_ | (~new_n391_ & x71) | (~new_n397_ & ~x71));
  assign new_n402_ = ~new_n146_ & (x71 ? x61 : x29);
  ...
  assign new_n406_ = (~x68 | ~new_n409_ | x69) & (x30 | x68 | ~x69 | (~new_n407_ & ~new_n408_));
  assign new_n407_ = ~new_n144_ & ((~new_n146_ & x29) | (~new_n399_ & ~x72) | (~new_n398_ & x72));
  assign new_n408_ = x70 & x71 & (new_n395_ | new_n392_ | new_n393_);
  assign new_n409_ = ~x70 & ~x71 & (new_n395_ | new_n392_ | new_n393_);
  assign new_n410_ = (x68 | (x71 ? ~new_n411_ : new_n412_)) & (~new_n109_ | ~x45 | ~x68);
  assign new_n411_ = ~new_n112_ & (x70 ? x45 : x13);
  assign new_n412_ = (x30 | ~x69 | (x70 ? ~x13 : ~x61)) & (~x29 | x69 | ~x70);
  assign new_n413_ = x65 & ~x66 & new_n414_ & ~x67;
  assign new_n414_ = x68 & ~x69 & (x70 ? (~new_n404_ & ~x71) : (~new_n394_ & x71));
  assign z14 = (~new_n416_ & ~x64) | new_n112_ | (x64 & ~x65 & (new_n432_ | new_n437_));
  assign new_n416_ = ~new_n430_ & (new_n114_ | (x70 ? (~new_n426_ & ~new_n428_) : new_n417_));
  ...
  assign new_n424_ = (~x22 | ~x73 | x74) & (x73 | (x74 ? ~x25 : ~x26));
  assign new_n425_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n426_ = ~x71 & (x65 ? (~x68 & ~new_n423_ & x69) : (x68 & ~new_n427_ & ~x69));
  assign new_n427_ = (~x46 | (x32 & x47)) & (~x32 | x46 | ~x47);
  assign new_n428_ = x65 & ~x68 & x69 & ~new_n429_ & x71;
  assign new_n429_ = ~new_n420_ & ~new_n421_ & ~new_n422_;
  assign new_n430_ = x65 & ~x66 & ~x67 & x68 & ~new_n431_ & ~x69;
  assign new_n431_ = x70 ? (new_n427_ | x71) : (new_n419_ | ~x71);
  assign new_n432_ = ~x66 & (x68 ? new_n434_ : (x67 ? ~new_n435_ : new_n433_));
  assign new_n433_ = x69 & ((~new_n423_ & (x70 ^ x71)) | (x70 & ~new_n429_ & x71));
  assign new_n434_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n429_);
  assign new_n435_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n436_ | ~x70);
  assign new_n436_ = x71 ? ~x46 : ~x30;
  assign new_n437_ = x66 & ~x67 & ((~new_n435_ & ~x68) | (new_n109_ & x46 & x68));
  assign z15 = x68 ? (~new_n451_ & ~x69) : ~new_n439_;
  assign new_n439_ = (~x64 | ~new_n449_ | x65) & (x30 | (x64 ? (new_n440_ | x65) : (~new_n448_ | ~x65)));
  assign new_n440_ = x66 ? (new_n447_ | x67) : (x67 ? new_n447_ : (~x69 | (~new_n441_ & ~new_n444_)));
  assign new_n441_ = ~new_n144_ & (new_n442_ | new_n443_ | (~new_n146_ & x31));
  assign new_n442_ = x73 & ((~x72 & (x74 ? x28 : x29)) | (x23 & x72 & ~x74));
  assign new_n443_ = x72 & ~x73 & (x74 ? x26 : x27);
  assign new_n444_ = x70 & x71 & (new_n445_ | new_n446_ | (~new_n146_ & x63));
  assign new_n445_ = x72 & ((x55 & x73 & ~x74) | (~x73 & (x74 ? x58 : x59)));
  assign new_n446_ = ~x72 & ((x62 & ~x73 & x74) | (x73 & (x74 ? x60 : x61)));
  assign new_n447_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (~x47 | ~x70 | ~x71);
  assign new_n448_ = x69 & ~new_n114_ & (new_n441_ | new_n444_);
  ...
  assign new_n453_ = ~new_n445_ & ~new_n446_ & (new_n146_ | ~x63);
