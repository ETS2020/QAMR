...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n41_, new_n44_, new_n46_, new_n49_;
  assign z00 = (~x12 & (x01 | x11)) | (x09 & (new_n32_ | (~x11 & x12)));
  assign new_n32_ = x11 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08));
  assign z01 = (~x12 & (~x00 | x10 | x11 | (x00 & ~x10 & ~x11))) | (new_n32_ & x09) | (~x09 & x12);
  assign z02 = (~x11 & ((x09 & x12) | (x00 & ~x10 & ~x12))) | (~x12 & (~x00 | x10 | x11)) | (~x09 & x12) | (x09 & ~new_n35_ & x11);
  assign new_n35_ = x05 & x06 & x07 & x08;
  assign z03 = (~x12 & (~x00 | x10 | x11 | (x00 & ~x10 & ~x11))) | (x09 & (new_n37_ | (~x11 & x12)));
  ...
  assign z08 = (x00 & ~x10 & ((new_n44_ & x09 & x11 & x12) | (~x11 & ~x12))) | ((~x00 | x10) & (x09 | ~x12)) | (x09 & ~x11 & x12);
  assign new_n44_ = x02 & x03 & x04;
  assign z09 = x00 & ~new_n46_ & ~x10;
  assign new_n46_ = (x11 | x12) & (~x09 | ~x11 | ~x12 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = x12 & (~x09 | (x00 & x09 & ~x10 & ~new_n44_ & x11));
  assign z11 = (~x09 & x12) | (x00 & new_n49_ & ~x10);
