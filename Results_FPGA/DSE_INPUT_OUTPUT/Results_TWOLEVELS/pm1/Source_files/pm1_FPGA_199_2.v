// Benchmark "FAU" written by ABC on Mon Aug 24 16:54:21 2020
...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n43_, new_n45_, new_n47_, new_n49_;
  ...
  assign new_n45_ = (x02 | ((~x09 | ~x11 | ~x12) & (x11 | x12))) & (~x11 | ~x12 | (x09 & (~x09 | (x03 & x04 & (~x02 | ~x03 | ~x04)))));
  assign z10 = (x02 & ~x11) | (x00 & x09 & ~x10 & new_n47_ & x11);
  assign new_n47_ = x12 & (~x02 | ~x03 | ~x04);
  assign z11 = (x02 & ~x11) | (x00 & ~x10 & ~new_n49_ & x11);
