...
module FAU ( 
  ...
  assign z06 = (new_n41_ & x01) | (~x12 & x14);
  assign new_n41_ = x09 & (~x02 | ~x03 | ~x04 | (~x11 & x12));
  assign z07 = ~x15 & (x12 | ~x14);
  assign z08 = (x00 & ~new_n44_ & ~x10) | ~x00 | (~x11 & x12) | x10 | (~x12 & x14);
  assign new_n44_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (~x12 & (x14 | (x00 & ~x10 & ~x11))) | (x00 & ~x10 & x11 & ~new_n46_ & x12);
  ...
  assign new_n50_ = ~x12 & (x14 | (~x10 & x11 & x00 & ~x01));
