...
module FAU ( 
  ...
  assign z00 = (x01 & (~x12 | (x11 & (~new_n32_ | ~x07 | ~x08 | (new_n32_ & x07 & x08))))) | (~x11 & x12);
  ...
  assign z06 = x01 ? (x09 & (~new_n41_ | ~x04 | (~x11 & x12))) : x11;
  ...
  assign z10 = x00 & x01 & x09 & ~x10 & new_n48_ & x11;
  assign new_n48_ = x12 & (~x02 | ~x03 | ~x04);
  assign z11 = x11 & (~x01 | (x00 & x01 & x09 & new_n48_ & ~x10));
