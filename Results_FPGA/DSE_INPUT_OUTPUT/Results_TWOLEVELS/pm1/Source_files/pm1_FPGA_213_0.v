...
module FAU ( 
  ...
  assign z01 = (x11 & x12 & (~new_n33_ | ~x07 | ~x08 | (new_n33_ & x07 & x08))) | (x02 & ~x12);
  ...
  assign z08 = (x02 & ((x00 & ~new_n43_ & ~x10) | ~x00 | x10)) | (x12 & (~x00 | x10 | ~x11));
  assign new_n43_ = (~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (x00 & ~new_n45_ & ~x10) | (~x02 & ~x12);
  assign new_n45_ = (~x02 | ((~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12))) & (~x11 | ~x12 | (x09 & (~x09 | (x02 & x03 & x04))));
