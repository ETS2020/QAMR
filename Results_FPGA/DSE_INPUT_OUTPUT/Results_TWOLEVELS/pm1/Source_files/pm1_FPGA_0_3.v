...
module FAU ( 
  ...
  wire new_n32_, new_n33_, new_n35_, new_n37_, new_n44_, new_n45_, new_n46_,
    new_n47_, new_n49_, new_n51_;
  assign z00 = x01 | (~new_n32_ & ~x01) | (~new_n33_ & x11);
  assign new_n32_ = (~x05 | ~x06 | ~x07 | ~x08 | ~x11) & (x11 | ~x12);
  assign new_n33_ = x05 & x06 & x07 & x08;
  assign z01 = x01 | (~x12 & (~x00 | x10 | (x00 & ~x10 & ~x11))) | (~new_n35_ & x11);
  assign new_n35_ = x05 & x06 & x07 & x08 & (~x06 | ~x07 | ~x08 | x01 | ~x05);
  assign z02 = new_n37_ | (~x01 & (~x09 | (~x11 & x12))) | (~new_n33_ & x11) | (x01 & x12);
  assign new_n37_ = ~x12 & ((x00 & ~x10 & (~x11 | (~x01 & x11))) | ~x00 | x01 | x10);
  assign z03 = new_n37_ | (~x01 & (~new_n32_ | ~x09));
  ...
  assign new_n47_ = ((x01 & x12) | (x00 & ~x10)) & (x01 | x11 | ~x12);
  assign z09 = (x01 & x12) | (x00 & ~x10 & ((~x11 & ~x12) | (~x01 & x11 & ~new_n49_ & x12)));
