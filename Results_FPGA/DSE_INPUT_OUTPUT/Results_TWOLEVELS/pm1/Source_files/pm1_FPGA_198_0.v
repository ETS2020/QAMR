...
module FAU ( 
  ...
  assign z02 = (~x07 & (~x12 | (x11 & x12))) | (~x11 & (x12 | (x00 & x07 & ~x10 & ~x12))) | ~new_n36_ | (x07 & ~x12 & (~x00 | x10 | x11));
  assign new_n36_ = x09 & (~x11 | ~x12 | (x05 & x06 & x08));
  assign z03 = (x07 & ((~new_n34_ & ~x12) | (x11 & (new_n38_ | ~x12)))) | (~x07 & ~x12) | ~x09 | (~x11 & x12);
