...
module FAU ( 
  ...
  assign z01 = (~x12 & (~x00 | x10 | x11 | (x00 & ~x10 & ~x11))) | (x04 & ~new_n32_ & x11);
  assign z02 = (~x11 & ((x04 & x12) | (x00 & ~x10 & ~x12))) | (~new_n35_ & x04) | (~x12 & (~x00 | x10 | x11));
  assign new_n35_ = x09 & ((x05 & x06 & x07 & x08) | ~x11);
  assign z03 = (x11 & (new_n37_ | ~x12)) | (x04 & (~x09 | (~x11 & x12))) | (~new_n38_ & ~x12);
  ...
  assign z08 = (x00 & ~new_n45_ & ~x10) | ((~x00 | x10) & (x04 | ~x12)) | (x04 & ~x11 & x12);
  ...
  assign z10 = x00 & new_n49_ & x04;
  assign new_n49_ = x09 & ~x10 & x11 & (~x02 | ~x03) & x12;
  assign z11 = (~x04 & x12) | (x00 & new_n51_ & ~x10);
