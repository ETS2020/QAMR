...
module FAU ( 
  ...
  assign z06 = x01 & x09 & ((~new_n41_ & (x12 | ~x14)) | (~x11 & x12));
  assign new_n41_ = x02 & x03 & x04;
  assign z07 = ~x15 & (x12 | ~x14);
  assign z08 = (x00 & ~x10 & (new_n44_ | (~x11 & ~x12 & ~x14))) | ~x00 | (~x11 & x12) | x10 | (~x12 & x14);
  assign new_n44_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = x00 & ~x10 & (x11 ? (~new_n46_ & x12) : (~x12 & ~x14));
  ...
  assign new_n50_ = ~x12 & (x14 | (x00 & ~x01 & ~x10 & x11));
