...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n40_, new_n43_, new_n44_, new_n45_, new_n47_,
    new_n49_, new_n51_;
  assign z00 = x12 ? ~x13 : (x01 | x11);
  assign z01 = ~x12 | x11 | (x12 & x13);
  ...
  assign z05 = ~x13 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08));
  assign z06 = x01 & x09 & ((~new_n40_ & (~x12 | ~x13)) | (~x11 & x12 & ~x13));
  assign new_n40_ = x02 & x03 & x04;
  assign z07 = ~x15 | (x12 & x13);
  assign z08 = ~new_n45_ | (x00 & ~x10 & (new_n43_ | (new_n40_ & new_n44_)));
  assign new_n43_ = ~x11 & ~x12;
  assign new_n44_ = x12 & ~x13 & x09 & x11;
  assign new_n45_ = x00 & (x11 | x13) & ~x10 & (~x12 | ~x13);
