...
module FAU ( 
  ...
  assign z02 = (x12 & (~x11 | ~x14)) | (~new_n35_ & x11) | ~x09 | ~x12;
  assign new_n35_ = x05 & x06 & x07 & x08;
  assign z03 = ~z01 | ~x09 | new_n37_ | ~x12;
  ...
  assign z08 = (x00 & ~x10 & (new_n43_ | (new_n40_ & new_n44_))) | ~z01 | ~x00 | x10;
  assign new_n43_ = ~x11 & ~x12;
  assign new_n44_ = x09 & x11 & x12 & x14;
  assign z09 = x00 & ~x10 & (x11 ? (new_n46_ & x12) : ~x12);
  assign new_n46_ = x14 & (~x09 | (x09 & (~x02 | ~x03 | ~x04 | (x02 & x03 & x04))));
