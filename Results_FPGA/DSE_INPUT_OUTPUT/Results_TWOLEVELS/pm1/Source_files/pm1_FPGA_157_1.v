...
module FAU ( 
  ...
  assign z08 = ~new_n44_ | (x03 & (~x02 | (new_n43_ & x00 & x02 & x04)));
  assign new_n43_ = x11 & x12 & x09 & ~x10;
  assign new_n44_ = (x11 | (~x02 & x03) | (~x12 & (~x00 | x10 | x12))) & x00 & ~x10;
  assign z09 = x00 & ~new_n46_ & ~x10;
  assign new_n46_ = ((~x02 & x03) | ((x09 | ~x11 | ~x12) & (x11 | x12))) & (~x09 | ~x11 | ~x12 | (x03 & (~x02 | (x04 & (~x03 | ~x04)))));
  assign z10 = x00 & new_n48_ & x09;
  assign new_n48_ = ~x10 & x11 & x12 & (~x03 | (x02 & ~x04));
  assign z11 = x00 & ~x10 & ~new_n50_ & x11;
  assign new_n50_ = x01 ? (~x09 | ~x12 | (x03 & (~x02 | x04))) : ((~x02 & x03) | x12);
