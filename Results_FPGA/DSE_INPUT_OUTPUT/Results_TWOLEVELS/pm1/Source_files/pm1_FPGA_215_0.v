...
module FAU ( 
  ...
  assign z00 = (~x12 & (~x13 | (x11 & x13))) | x01 | (x12 & (~x11 | (~new_n32_ & x11)));
  assign new_n32_ = x05 & x06 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z01 = (~x12 & x13 & (~x00 | x10 | x11 | (x00 & ~x10 & ~x11))) | (x11 & ~new_n32_ & x12);
  assign z02 = (~x11 & (new_n36_ | x12)) | (~new_n37_ & ~x12) | ~x09 | (x11 & ~new_n35_ & x12);
  assign new_n35_ = x05 & x06 & x07 & x08;
  assign new_n36_ = x00 & ~x10 & ~x12 & x13;
  assign new_n37_ = x13 & (~x13 | (x00 & ~x10 & ~x11));
  assign z03 = (x11 & (new_n40_ | (~x12 & x13))) | (~x11 & (x12 | (new_n39_ & ~x12 & x13))) | ~x09 | (~x12 & (~x13 | (~new_n39_ & x13)));
  assign new_n39_ = x00 & ~x10;
  assign new_n40_ = x05 & x06 & x07 & x08 & x12;
  assign z04 = ~x14 | (~x12 & ~x13);
  assign z05 = x12 & ~x13;
  assign z06 = (new_n44_ & x01) | (~x12 & ~x13);
  assign new_n44_ = x09 & (~x02 | ~x03 | ~x04 | (~x11 & x12));
  assign z07 = ~x15 | (~x12 & ~x13);
  assign z08 = (x00 & ~x10 & (new_n47_ | (~x11 & ~x12 & x13))) | (~x11 & x12) | ((~x00 | x10) & (x12 | (~x12 & x13)));
  assign new_n47_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = x00 & ~x10 & (x11 ? (~new_n49_ & x12) : (~x12 & x13));
