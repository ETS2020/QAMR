...
module FAU ( 
  ...
  assign z01 = (~x02 & ~new_n33_ & ~x12) | (x11 & ~new_n34_ & x12);
  ...
  assign new_n36_ = ~x12 & (x02 | (~new_n33_ & ~x02));
  ...
  assign z06 = (x02 & ~x12) | (x01 & x09 & (~new_n43_ | ~x02 | ~x03));
  assign new_n43_ = x04 & x11;
  assign z07 = ~x15 | (x02 & ~x12);
  assign z08 = (x00 & ~new_n46_ & ~x10) | (~x11 & x12) | ((x12 | (~x02 & ~x12)) & (~x00 | x10));
  assign new_n46_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x02 | x11 | x12);
  assign z09 = (~new_n48_ & x02) | (x00 & ~new_n50_ & ~x10);
  assign new_n48_ = x12 & (~new_n49_ | ~x11 | ~x12 | ~x09 | x10);
  assign new_n49_ = x00 & x03 & x04;
  assign new_n50_ = (x02 | ((~x09 | ~x11 | ~x12) & (x11 | x12))) & (~x11 | ~x12 | (x09 & (~x09 | (x03 & x04))));
  assign z10 = (x02 & ~x12) | (x00 & new_n52_ & x09);
  assign new_n52_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = (x02 & ~x12) | (x00 & ~x10 & ~new_n54_ & x11);
  assign new_n54_ = (x02 | (x01 ? (~x09 | ~x12) : x12)) & (~x01 | ~x09 | (x03 & x04) | ~x12);
