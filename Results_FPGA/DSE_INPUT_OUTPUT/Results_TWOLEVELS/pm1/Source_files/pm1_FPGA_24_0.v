...
module FAU ( 
  ...
  assign z01 = (x05 & (~x12 | (x06 & x07 & x08 & x11))) | (~x05 & (~x12 | (x11 & x12))) | (x11 & x12 & (~x06 | ~x07 | ~x08));
  assign z02 = x12 ? (~x09 | ~x11 | (x11 & (~new_n34_ | ~x05 | ~x06))) : x05;
  assign new_n34_ = x07 & x08;
  assign z03 = (x05 & (new_n36_ | ~x12)) | (x12 & (~x09 | ~x11)) | (~x05 & ~x12);
  assign new_n36_ = x08 & x11 & x06 & x07;
