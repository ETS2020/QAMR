...
module FAU ( 
  ...
  wire new_n33_, new_n35_, new_n37_, new_n42_, new_n46_, new_n49_;
  ...
  assign z12 = ~x09 & x12;
  assign z05 = z12 | ~x13;
  assign z06 = (x01 & ~new_n42_ & x09) | (x12 & (~x09 | (x01 & ~x11)));
  assign new_n42_ = x02 & x03 & x04;
  assign z07 = z12 | ~x15;
  assign z08 = (x00 & ~x10 & ((new_n42_ & x09 & x11 & x12) | (~x11 & ~x12))) | ~x00 | x10 | (x12 & (~x09 | ~x11));
