...
module FAU ( 
  ...
  assign z01 = new_n32_ | (~x12 & ~x13);
  assign z02 = (x11 & (~new_n35_ | ~x07 | ~x08)) | ~x09 | ~x11 | ~x12;
  assign new_n35_ = x05 & x06;
  assign z03 = ~x11 | ~x12 | ~x09 | (new_n35_ & x07 & x08 & x11);
  ...
  assign z08 = x10 | ~x11 | ~x00 | (new_n43_ & x11 & x12 & x09 & ~x10);
