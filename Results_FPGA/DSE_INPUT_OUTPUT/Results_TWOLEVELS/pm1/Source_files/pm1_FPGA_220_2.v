...
module FAU ( 
  ...
  assign z06 = (x02 & ~x12) | (x01 & x09 & (~new_n39_ | ~x02 | ~x03));
  assign new_n39_ = x04 & x11;
  assign z07 = ~x15 | (x02 & ~x12);
  assign z08 = (x02 & (new_n42_ | ~x12)) | ~x00 | x10 | ~x11;
  assign new_n42_ = x00 & x03 & x04 & x09 & ~x10 & x11;
  assign z09 = (x02 & (new_n42_ | ~x12)) | (x00 & ~new_n44_ & ~x10);
  assign new_n44_ = x11 ? (~x12 | (x09 & (~x09 | (x02 & x03 & x04)))) : x12;
