...
module FAU ( 
  ...
  wire new_n32_, new_n34_, new_n36_, new_n38_, new_n42_, new_n48_;
  assign z00 = (~x12 & (x01 | x11)) | (~x10 & (x11 ? ~new_n32_ : x12));
  assign new_n32_ = x05 & x06 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z01 = new_n34_ | ~x12;
  assign new_n34_ = ~x10 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08)) & x11;
  assign z02 = ~x12 | (~x10 & ((~new_n36_ & x11) | ~x09 | (~x11 & x12)));
  assign new_n36_ = x05 & x06 & x07 & x08;
  assign z03 = (x12 & (x10 | (~x10 & ~x11))) | ~x12 | (~new_n38_ & ~x10);
  assign new_n38_ = x09 & (~x05 | ~x06 | ~x07 | ~x08 | ~x11);
  assign z04 = ~x14 & (~x10 | ~x12);
  assign z05 = ~x13 & (~x10 | ~x12);
  assign z06 = x01 & x09 & ((~new_n42_ & (~x10 | ~x12)) | (~x10 & ~x11 & x12));
  assign new_n42_ = x02 & x03 & x04;
  assign z07 = ~x15 & (~x10 | ~x12);
  assign z08 = (x00 & ((new_n42_ & x09 & x11 & x12) | (~x10 & ~x11 & ~x12))) | (~x10 & ~x11 & x12) | ~x00 | x10;
  assign z09 = (x10 & x12) | (x00 & ((~x10 & ~x11 & ~x12) | (x11 & x12 & (~x09 | (x09 & (new_n42_ | (~new_n42_ & ~x10)))))));
