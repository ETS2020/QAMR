...
module FAU ( 
  ...
  assign z12 = ~x09 & x12;
  assign z05 = z12 | ~x13;
  assign z06 = (x01 & ~new_n41_ & x09) | (x12 & (~x09 | (x01 & ~x11)));
  assign new_n41_ = x02 & x03 & x04;
  assign z07 = z12 | ~x15;
  assign z08 = (x00 & ~x10 & ((new_n41_ & x09 & x11 & x12) | (~x11 & ~x12))) | ~x00 | x10 | (x12 & (~x09 | (x09 & ~x11)));
  assign z09 = x00 & ~new_n45_ & ~x10;
  assign new_n45_ = (x11 | x12) & (~x09 | ~x11 | ~x12 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = x00 & x09 & ~x10 & x11 & ~new_n41_ & x12;
  assign z11 = z12 | (x00 & new_n48_ & ~x10);
