...
module FAU ( 
  ...
  assign new_n32_ = ~x02 & ((x12 & (~x11 | (x00 & x09 & ~x10 & x11))) | (x11 & (~x00 | ~x09 | x10)));
  assign z01 = (x00 & ~x10 & ((~x02 & x09 & x11 & x12) | (~x11 & ~x12))) | ((~x12 | (~x02 & x11)) & (~x00 | x10)) | (x11 & ((~x02 & ~x09) | ~x12));
  ...
  assign z09 = (x02 & x12) | (x00 & ~x10 & ((~x11 & ~x12) | (~x02 & x11 & x12)));
