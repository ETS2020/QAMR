...
module FAU ( 
  ...
  assign z01 = (x05 & ~new_n32_ & x11) | ~x12 | (~x05 & x12);
  assign z02 = ~x12 | (x05 & ((~new_n35_ & x11) | ~x09 | (~x11 & x12)));
  assign new_n35_ = x06 & x07 & x08;
  assign z03 = (x12 & (~x05 | (x05 & ~x11))) | ~x12 | (x05 & (~x09 | (new_n37_ & x08 & x11)));
  assign new_n37_ = x06 & x07;
  assign z04 = ~x14 & (x05 | ~x12);
  assign z05 = ~x13 & (x05 | ~x12);
  assign z06 = x01 & ~new_n41_ & x09;
  assign new_n41_ = ((x02 & x03 & x04) | (~x05 & x12)) & (~x05 | x11 | ~x12);
  assign z07 = ~x15 | (~x05 & x12);
  assign z08 = (x00 & ~new_n44_ & ~x10) | (x12 & (~x05 | (x05 & ~x11))) | ~x00 | x10;
  assign new_n44_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (~x05 & x12) | (x00 & ~x10 & (x11 ? (~new_n46_ & x12) : ~x12));
  assign new_n46_ = x09 ? (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)) : ~x05;
  assign z10 = x12 & (~x05 | (new_n48_ & x00));
