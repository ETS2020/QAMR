...
module FAU ( 
  ...
  assign z05 = (~x13 & (~x12 | (x11 & (~new_n33_ | ~x07 | ~x08 | (new_n33_ & x07 & x08))))) | (x12 & (~x11 | x13));
  assign z06 = (x12 & (x13 | (x01 & x09 & ~x11))) | (x01 & ~new_n41_ & x09);
  assign new_n41_ = x02 & x03 & x04;
  assign z07 = ~x15 | (x12 & x13);
  assign z08 = (x00 & ~new_n44_ & ~x10) | (x12 & (~x11 | x13)) | ~x00 | x10;
  assign new_n44_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (x12 & x13) | (x00 & ~x10 & (x11 ? (~new_n46_ & x12) : ~x12));
  assign new_n46_ = x09 & (~x09 | ((~x02 | ~x03 | ~x04) & (x13 | (x02 & x03 & x04))));
  assign z10 = x00 & x09 & new_n48_ & ~x10;
  assign new_n48_ = x11 & x12 & ~x13 & (~x02 | ~x03 | ~x04);
  assign z11 = (x12 & x13) | (x00 & ~x10 & ~new_n50_ & x11);
  assign new_n50_ = x01 ? (~x09 | ~x12 | (x02 & x03 & x04)) : x12;
  assign z12 = x12 & (x13 | (~x10 & x11 & x00 & ~x09));
endmodule
