...
module FAU ( 
  ...
  wire new_n32_, new_n34_, new_n36_, new_n37_, new_n39_, new_n45_, new_n46_,
    new_n47_, new_n48_, new_n50_, new_n52_;
  assign z00 = x01 | (~new_n32_ & ~x01);
  assign new_n32_ = x11 ? (x05 & x06 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08)) : ~x12;
  assign z01 = (~x12 & (~x00 | x01 | x10 | (x00 & ~x10 & ~x11))) | (~x01 & ~new_n34_ & x11);
  assign new_n34_ = x05 & x06 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z02 = new_n37_ | (x12 & (x01 | (~x01 & ~x11))) | ~x09 | (~x01 & ~new_n36_ & x11);
  assign new_n36_ = x05 & x06 & x07 & x08;
  assign new_n37_ = ~x12 & ((x00 & ~x10 & (~x11 | (~x01 & x11))) | ~x00 | x01 | x10);
  assign z03 = new_n37_ | (~new_n39_ & ~x01) | ~x09 | (x01 & x12);
  assign new_n39_ = (x11 | ~x12) & (~x05 | ~x06 | ~x07 | ~x08 | ~x11);
  ...
  assign new_n48_ = ((x01 & x12) | (x00 & ~x10)) & (x01 | x11 | ~x12);
  assign z09 = (x01 & x12) | (x00 & ~x10 & (x11 ? (~new_n50_ & x12) : ~x12));
  assign new_n50_ = (x01 | (x09 & (~x04 | ~x09 | ~x02 | ~x03))) & (~x09 | (x02 & x03 & x04));
  assign z10 = x12 & (x01 | (new_n52_ & x00));
