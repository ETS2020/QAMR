...
module FAU ( 
  ...
  assign z01 = new_n36_ | (x11 & x12 & (~new_n35_ | ~x07 | ~x08 | (new_n35_ & x07 & x08)));
  assign new_n35_ = x05 & x06;
  assign new_n36_ = ~x09 & ((x11 & (~x00 | x10 | (x00 & ~x01 & ~x10 & ~x12))) | (~x12 & (x01 | ~x11)));
  assign z02 = (x11 & ((~new_n39_ & ~x09) | (~new_n38_ & x12))) | (~x09 & ~x12 & (x01 | ~x11)) | (~x11 & x12);
  assign new_n38_ = x05 & x06 & x07 & x08;
  assign new_n39_ = x00 & ~x10 & (~x00 | x10 | (~x12 & (x01 | x12)));
  assign z03 = new_n41_ | (x12 & (~x11 | (new_n35_ & x07 & x08 & x11)));
  assign new_n41_ = ~x09 & ((~x12 & (x01 | ~x11)) | (x11 & (~x00 | x10 | (x00 & ~x10 & (x12 | (~x01 & ~x12))))));
  assign z04 = ~x14 & (~x09 | x12);
  assign z05 = ~x13 | (x09 & ~x12);
  assign z06 = new_n45_ & x01;
  assign new_n45_ = x09 & x12 & (~x02 | ~x03 | ~x04 | ~x11);
