...
module FAU ( 
  ...
  assign z00 = x01 | x11 | (x02 & ~x12) | (~x11 & x12);
  assign z01 = x11 | ~x12;
  ...
  assign z08 = (x00 & ~new_n43_ & ~x10) | ~x00 | x10 | (x02 & ~x12) | (~x11 & x12);
  assign new_n43_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x02 | x11 | x12);
  ...
  assign new_n49_ = (x02 | (x01 ? (~x09 | ~x12) : x12)) & (~x01 | ~x09 | ~x12 | (x03 & x04));
