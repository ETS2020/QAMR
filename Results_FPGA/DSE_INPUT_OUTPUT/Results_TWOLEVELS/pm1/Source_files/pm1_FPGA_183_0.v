...
module FAU ( 
  ...
  wire new_n32_, new_n33_, new_n40_, new_n43_, new_n44_, new_n46_, new_n49_;
  assign z00 = (x08 & (new_n32_ | (~x11 & x12))) | ~x08 | x01 | (~new_n33_ & x11);
  assign new_n32_ = x05 & x06 & x07 & x11;
  assign new_n33_ = x05 & x06 & x07;
  assign z01 = (x08 & (new_n32_ | (~x11 & ~x12))) | ~x08 | (~new_n33_ & x11);
  assign z02 = x11 ? (~new_n33_ | ~x08 | ~x09 | ~x12) : x08;
  assign z03 = (x08 & (new_n32_ | ~x11)) | (x11 & (~x09 | ~x12));
  assign z04 = ~x14 | (~x08 & ~x11);
  assign z05 = ~x13 | (~x08 & ~x11);
  assign z06 = (~x11 & (~x08 | (x01 & x09 & x12))) | (x01 & ~new_n40_ & x09);
  assign new_n40_ = x02 & x03 & x04;
  assign z07 = ~x15 | (~x08 & ~x11);
  assign z08 = x11 ? (~x00 | x10 | (new_n44_ & new_n43_ & x00)) : x08;
  assign new_n43_ = x02 & x03;
  assign new_n44_ = x04 & x09 & ~x10 & x12;
  assign z09 = (~x11 & (~x08 | (x00 & ~x10 & ~x12))) | (x00 & ~x10 & x11 & ~new_n46_ & x12);
