...
module FAU ( 
  ...
  assign z00 = (~x09 & (~x12 | (x11 & x12))) | (x01 & ~x12) | (x09 & x11) | (~x11 & x12);
  assign z01 = (x11 & (x09 | (~x09 & x12))) | (x09 & ~x12 & (~x00 | x10 | (x00 & ~x10 & ~x11)));
  assign z02 = new_n34_ | ~new_n35_ | (x12 & (~x11 | (~x09 & x11)));
  assign new_n34_ = ~x12 & ((x00 & ~x10 & (x11 ? ~x01 : x09)) | (x09 & (~x00 | x10)) | x01 | ~x09);
  assign new_n35_ = x07 & x08 & x05 & x06;
  assign z03 = new_n34_ | new_n35_ | (x12 & (~x11 | (~x09 & x11)));
  ...
  assign z08 = (x09 & ((x00 & ~new_n43_ & ~x10) | (~x12 & (~x00 | x10)))) | (x12 & (~x00 | x10 | ~x11));
