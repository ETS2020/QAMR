...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n40_, new_n43_, new_n45_, new_n48_,
    new_n49_;
  ...
  assign z06 = x01 & x09 & ((~new_n40_ & (x12 | ~x14)) | (~x11 & x12));
  assign new_n40_ = x02 & x03 & x04;
  assign z07 = ~x15 | (~x12 & x14);
  assign z08 = (x00 & ~x10 & (new_n43_ | (~x11 & ~x12 & ~x14))) | (~x11 & x12) | ((x12 | ~x14) & (~x00 | x10));
  assign new_n43_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = (~x12 & (x14 | (x00 & ~x10 & ~x11 & ~x14))) | (x00 & ~x10 & x11 & ~new_n45_ & x12);
