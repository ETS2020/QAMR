...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n41_, new_n45_, new_n48_;
  assign z00 = (~x12 & (x01 | x11)) | (~x10 & (x11 ? ~new_n32_ : x12));
  ...
  assign z06 = x01 & x09 & ((~new_n41_ & (~x10 | ~x12)) | (~x10 & ~x11 & x12));
  assign new_n41_ = x02 & x03 & x04;
  assign z07 = ~x15 & (~x10 | ~x12);
  assign z08 = x10 ? ~x12 : ((x00 & ((new_n41_ & x09 & x11 & x12) | (~x11 & ~x12))) | ~x00 | (~x11 & x12));
  assign z09 = (x10 & x12) | (x00 & ((~x10 & ((~x11 & ~x12) | (x09 & x11 & ~new_n45_ & x12))) | (~x09 & x11 & x12)));
