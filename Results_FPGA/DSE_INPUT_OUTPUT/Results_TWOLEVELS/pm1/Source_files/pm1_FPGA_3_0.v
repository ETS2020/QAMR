...
module FAU ( 
  ...
  assign z00 = (x13 & (x01 | (~x11 & x12))) | (~new_n32_ & x11);
  assign new_n32_ = x05 & x06 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z01 = (~x12 & x13) | (~new_n32_ & x11);
  assign z02 = (~x11 & (~x13 | (x12 & x13))) | (~new_n35_ & x11) | ~x09 | ~x12;
  assign new_n35_ = x05 & x06 & x07 & x08;
  assign z03 = (~x11 & (~x13 | (x12 & x13))) | ~x09 | new_n37_ | ~x12;
  ...
  assign z08 = (x00 & ~x10 & (new_n43_ | (~x11 & ~x12 & x13))) | (~x11 & (~x13 | (x12 & x13))) | ~x00 | x10;
