...
module FAU ( 
  ...
  assign z03 = new_n32_ | ~x09 | ~x12;
  assign z04 = ~x14 | (x08 & x12);
  assign z05 = ~x13 & (~x08 | ~x12);
  assign z06 = x01 & x09 & ((~new_n39_ & (~x08 | ~x12)) | (~x08 & ~x11 & x12));
  assign new_n39_ = x02 & x03 & x04;
  assign z07 = ~x15 | (x08 & x12);
  assign z08 = (x00 & ~x10 & ((new_n39_ & new_n42_) | new_n43_)) | new_n32_ | ~x00 | x10;
  assign new_n42_ = ~x08 & x09 & x11 & x12;
  assign new_n43_ = ~x11 & ~x12;
  assign z09 = x00 & ~x10 & ((~x11 & ~x12) | (~x08 & x11 & ~new_n45_ & x12));
  assign new_n45_ = x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = x12 & (x08 | (x00 & new_n47_ & ~x08));
  assign new_n47_ = x09 & ~x10 & x11 & (~x02 | ~x03 | ~x04);
  assign z11 = (x08 & x12) | (x00 & ~x10 & ~new_n49_ & x11);
