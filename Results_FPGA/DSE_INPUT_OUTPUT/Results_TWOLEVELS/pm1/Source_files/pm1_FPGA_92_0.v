...
module FAU ( 
  ...
  assign z01 = (x11 & ~new_n32_ & x12) | (x02 & ~x12);
  ...
  assign new_n41_ = x09 & ((x02 & (~x03 | ~x04)) | (x12 & (~x02 | ~x11)));
  assign z07 = ~x15 | (~x02 & ~x12);
  assign z08 = (x00 & ~new_n44_ & ~x10) | ~x00 | (~x11 & x12) | x10 | (~x02 & ~x12);
  ...
  assign z12 = (~x02 & ~x12) | (~x10 & x11 & x12 & x00 & ~x09);
endmodule
