...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n41_, new_n44_, new_n45_, new_n46_,
    new_n48_, new_n50_;
  assign z00 = ~x12 | new_n32_ | ~x11;
  assign new_n32_ = x11 & x12 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08));
  assign z01 = new_n32_ | (x01 & ~x12);
  assign z02 = ~x12 | (x11 & ~new_n35_ & x12) | ~x09 | ~x11;
  assign new_n35_ = x05 & x06 & x07 & x08;
  assign z03 = ~x12 | ~x09 | ~x11 | (new_n37_ & x08 & x11 & x12);
