// Benchmark "FAU" written by ABC on Mon Aug 24 16:54:35 2020
...
module FAU ( 
  ...
  assign z00 = (~x09 & (~x12 | (x11 & x12 & (~x00 | x10 | (x00 & ~x10))))) | x01 | (x09 & x11) | (~x11 & x12);
  assign z01 = x09 ? (x11 | ~x12) : (x11 & x12 & (~x00 | x10 | (x00 & ~x10)));
  assign z02 = x12 ? (~new_n34_ | (~x09 & x11 & (~x00 | x10 | (x00 & ~x10)))) : x09;
  assign new_n34_ = x05 & x06 & x07 & x08 & x11;
  assign z03 = x12 ? ((~x09 & x11 & (~x00 | x10 | (x00 & ~x10))) | new_n36_ | ~x11) : x09;
