...
module FAU ( 
  ...
  assign z00 = x01 | x11 | (~x05 & ~x12) | (~x11 & x12);
  assign z01 = (x05 & (~x12 | (x06 & x07 & x08 & x11))) | (x11 & x12 & (~x05 | ~x06 | ~x07 | ~x08));
  assign z02 = x12 ? ~new_n34_ : x05;
  assign new_n34_ = (~x11 | (x05 & x06 & x07 & x08)) & x09 & x11;
  assign z03 = new_n36_ | (x12 & (~x09 | ~x11));
  assign new_n36_ = x05 & (~x12 | (x06 & x07 & x08 & x11));
  ...
  assign z08 = (x00 & ~new_n43_ & ~x10) | ~x00 | (~x11 & x12) | x10 | (~x05 & ~x12);
  assign new_n43_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (~x12 & (~x05 | (x00 & ~x10 & ~x11))) | (x00 & ~x10 & x11 & ~new_n45_ & x12);
  ...
  assign new_n49_ = ~x12 & (~x05 | (x00 & ~x01 & ~x10 & x11));
