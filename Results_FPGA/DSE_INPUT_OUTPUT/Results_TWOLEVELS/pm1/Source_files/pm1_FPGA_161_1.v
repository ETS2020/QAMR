...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n36_, new_n41_, new_n44_, new_n47_, new_n49_;
  ...
  assign z08 = (~new_n32_ & ~x11) | new_n32_ | new_n44_ | ~x00 | x10;
  assign new_n44_ = x02 & x03 & x04 & x09 & x12;
  assign z09 = x00 & ~x10 & ~new_n32_ & (~x11 ^ x12);
  assign z10 = x00 & x09 & ~x10 & new_n47_ & x11;
  assign new_n47_ = x12 & (x14 | ~x15) & (~x02 | ~x03 | ~x04);
  assign z11 = x00 & ~x10 & x11 & ~new_n32_ & ~new_n49_;
