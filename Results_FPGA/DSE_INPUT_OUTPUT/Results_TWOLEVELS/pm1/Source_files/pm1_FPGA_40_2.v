...
module FAU ( 
  ...
  assign new_n43_ = x09 & (~x03 | (x12 & (~x02 | ~x04 | ~x11)));
  assign z07 = ~x15 & (~x03 | x12);
  assign z08 = (x00 & ~new_n46_ & ~x10) | (~x11 & x12) | ((x12 | (~x03 & ~x12)) & (~x00 | x10));
  assign new_n46_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x03 | x11 | x12);
  assign z09 = x00 & ~new_n48_ & ~x10;
  assign new_n48_ = (x03 | ((~x09 | ~x11 | ~x12) & (x11 | x12))) & (~x11 | ~x12 | (x09 & (~x09 | (x02 & x04 & (~x02 | ~x03 | ~x04)))));
  assign z10 = x00 & new_n50_ & x09;
  assign new_n50_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = (x03 & ~x12) | (x00 & ~x10 & ~new_n52_ & x11);
