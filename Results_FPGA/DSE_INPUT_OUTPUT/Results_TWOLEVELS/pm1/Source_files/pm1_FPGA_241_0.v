...
module FAU ( 
  ...
  assign new_n41_ = x09 & (x02 ? (~x03 | ~x04 | (~x11 & x12)) : x11);
  ...
  assign new_n47_ = ~x02 & (~x11 | (x00 & x09 & ~x10 & x11 & x12));
  assign new_n48_ = x11 ? (~x12 | (x09 & (~x09 | (x03 & x04 & (~x02 | ~x03 | ~x04))))) : x12;
  ...
  assign z12 = (~x02 & ~x11) | (~x10 & x11 & x12 & x00 & ~x09);
endmodule
