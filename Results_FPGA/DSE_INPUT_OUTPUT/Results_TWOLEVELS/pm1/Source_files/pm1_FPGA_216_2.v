...
module FAU ( 
  ...
  assign z03 = (~x09 & (x11 | ~x12)) | (x09 & ~x12) | (x12 & (~x11 | (new_n35_ & x07 & x08 & x11)));
  assign z04 = ~x14 & (~x09 | x12);
  assign z05 = ~x13 & (~x09 | x12);
  assign z06 = new_n40_ & x01;
  assign new_n40_ = x09 & x12 & (~x02 | ~x03 | ~x04 | ~x11);
  ...
  assign new_n45_ = x09 ? (~x11 | ~x12 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04))) : (x11 ^ x12);
  assign z10 = x09 & (~x12 | (x00 & ~x10 & x11 & ~new_n43_ & x12));
