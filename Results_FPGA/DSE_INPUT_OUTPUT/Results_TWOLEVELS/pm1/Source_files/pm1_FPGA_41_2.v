...
module FAU ( 
  ...
  wire new_n33_, new_n39_, new_n42_, new_n43_, new_n45_, new_n47_;
  assign z00 = x12 | (x01 & ~x11);
  assign z01 = ~x12 | (x11 & (~new_n33_ | ~x07 | ~x08 | (new_n33_ & x07 & x08)));
  assign new_n33_ = x05 & x06;
  assign z02 = (x11 & (~new_n33_ | ~x07 | ~x08)) | ~x09 | ~x11 | ~x12;
  ...
  assign new_n45_ = x11 ? (~x12 | (x09 & (~x09 | (x04 & (~x02 | ~x03 | ~x04) & x02 & x03)))) : x12;
