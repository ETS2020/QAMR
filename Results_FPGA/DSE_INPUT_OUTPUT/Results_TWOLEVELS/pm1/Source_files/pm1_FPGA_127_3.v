...
module FAU ( 
  ...
  assign z03 = (~new_n37_ & ~x13) | ~x12 | (x12 & x13);
  assign new_n37_ = x09 & x11 & (~x05 | ~x06 | ~x07 | ~x08 | ~x11);
  assign z04 = ~x14 | (x12 & x13);
  assign z05 = x13 ? x12 : (~x11 | (x11 & (~new_n33_ | ~x07 | ~x08 | (new_n33_ & x07 & x08))));
  ...
  assign new_n46_ = x00 & (x11 | x13) & ~x10 & (~x12 | ~x13);
  assign z09 = x00 & ~x10 & (x11 ? (new_n48_ & x12) : ~x12);
  assign new_n48_ = ~x13 & (~x09 | (x09 & (~x04 | (x02 & x03 & x04) | ~x02 | ~x03)));
  assign z10 = x12 & (x13 | (x00 & new_n50_ & x09));
  assign new_n50_ = ~x10 & x11 & ~x13 & (~x02 | ~x03 | ~x04);
