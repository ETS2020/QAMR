...
module FAU ( 
  ...
  assign z02 = (~new_n35_ & ~x14) | ~x09 | ~x12 | (x12 & x14);
  assign new_n35_ = x11 & (~x11 | (x05 & x06 & x07 & x08));
  assign z03 = (~new_n37_ & ~x14) | ~x09 | ~x12 | (x12 & x14);
  assign new_n37_ = x11 & (~x05 | ~x06 | ~x07 | ~x08 | ~x11);
