...
module FAU ( 
  ...
  assign z08 = (x00 & ~new_n44_ & ~x10) | (~x11 & x12) | ((~x00 | x10) & (~x04 | x12));
  assign new_n44_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x04 | x11 | x12);
  assign z09 = x00 & ~new_n46_ & ~x10;
  assign new_n46_ = (x04 | ((~x09 | ~x11 | ~x12) & (x11 | x12))) & (~x11 | ~x12 | (x09 & (~x09 | (x02 & x03 & (~x02 | ~x03 | ~x04)))));
