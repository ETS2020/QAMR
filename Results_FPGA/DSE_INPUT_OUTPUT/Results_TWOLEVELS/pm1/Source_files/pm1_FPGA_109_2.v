...
module FAU ( 
  ...
  wire new_n32_, new_n33_, new_n36_, new_n41_, new_n44_, new_n45_, new_n47_,
    new_n49_;
  assign z00 = (~new_n32_ & x12) | new_n33_ | x01 | (x00 & ~x12);
  assign new_n32_ = x11 & (~x05 | ~x06 | ~x07 | ~x08 | ~x11);
  assign new_n33_ = (~x00 | ~x05 | ~x06 | ~x07 | ~x08) & x11;
  assign z01 = ~x12 | (x11 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08 & x12)));
  assign z02 = (x12 & (~x09 | ~x11)) | ~x12 | (~new_n36_ & x11);
  assign new_n36_ = x05 & x06 & x07 & x08;
  assign z03 = x12 ? (~new_n32_ | ~x09) : ~x00;
  assign z04 = ~x14 & (~x00 | x12);
  assign z05 = ~x13 & (~x00 | x12);
  assign z06 = x01 & x09 & ((~new_n41_ & (~x00 | x12)) | (~x11 & x12));
