...
module FAU ( 
  ...
  assign z02 = (x12 & (x02 | (~x02 & ~x11))) | (~x02 & ~new_n35_ & x11) | ~x09 | ~x12;
  assign new_n35_ = x05 & x06 & x07 & x08;
  assign z03 = (~new_n37_ & ~x02) | ~x09 | ~x12 | (x02 & x12);
  ...
  assign z09 = (x02 & x12) | (x00 & ~x10 & ((~x02 & x11 & x12) | (~x11 & ~x12)));
  assign z10 = x12 & x11 & ~x10 & x09 & x00 & ~x02;
  assign z11 = new_n46_ & x00;
  assign new_n46_ = ~x10 & x11 & ((x01 & ~x02 & x09 & x12) | (~x01 & ~x12));
