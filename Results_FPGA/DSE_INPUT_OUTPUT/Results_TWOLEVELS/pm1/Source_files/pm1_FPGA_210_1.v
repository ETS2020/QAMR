...
module FAU ( 
  ...
  assign new_n41_ = x09 & (x04 ? (~x02 | ~x03 | (~x11 & x12)) : ~x12);
  assign z07 = ~x15 & (x04 | ~x12);
  assign z08 = (x00 & ~new_n44_ & ~x10) | ~x00 | x10 | (x12 & (~x04 | (x04 & ~x11)));
  assign new_n44_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = x00 & ~new_n46_ & ~x10;
  assign new_n46_ = (x11 | x12) & (~x04 | ~x11 | ~x12 | (x09 & (~x09 | (x02 & x03 & (~x02 | ~x03)))));
  assign z10 = x12 & (~x04 | (x00 & new_n48_ & x04));
  assign new_n48_ = x09 & ~x10 & x11 & (~x02 | ~x03);
  assign z11 = x00 & ~x10 & ~new_n50_ & x11;
  assign new_n50_ = x01 ? (~x04 | ~x09 | ~x12 | (x02 & x03)) : x12;
