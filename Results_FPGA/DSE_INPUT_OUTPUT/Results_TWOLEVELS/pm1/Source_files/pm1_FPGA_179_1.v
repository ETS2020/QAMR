...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n41_, new_n44_, new_n45_, new_n47_,
    new_n50_;
  assign z00 = (~x12 & (x01 | (~x00 & x11))) | (x00 & (x11 ? ~new_n32_ : x12));
  ...
  assign z03 = ~x12 | (x00 & (~new_n37_ | ~x09));
  ...
  assign z08 = (x11 & ((new_n44_ & x00 & new_n45_ & ~x10 & x12) | (~x00 & ~x12))) | (x00 & (x10 | (~x11 & x12))) | (~x11 & ~x12);
  assign new_n44_ = x02 & x03;
  assign new_n45_ = x04 & x09;
  assign z09 = x00 ? (~x10 & (x11 ? (~new_n47_ & x12) : ~x12)) : x12;
