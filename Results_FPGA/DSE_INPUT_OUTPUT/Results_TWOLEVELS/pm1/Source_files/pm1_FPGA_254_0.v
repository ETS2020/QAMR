...
module FAU ( 
  ...
  wire new_n32_, new_n33_, new_n34_, new_n35_, new_n37_, new_n38_, new_n39_,
    new_n40_, new_n42_, new_n43_, new_n44_, new_n45_, new_n49_, new_n52_,
    new_n55_, new_n57_;
  ...
  assign z06 = x01 & x09 & ~new_n42_ & ~new_n49_;
  assign new_n49_ = x02 & x03 & x04 & (x11 | ~x12);
  assign z07 = new_n42_ | ~x15;
  assign z08 = x00 ? ((x10 & (x11 | ~x12)) | (~new_n52_ & ~x10) | (~x11 & x12)) : x14;
  assign new_n52_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = x00 ? (~x10 & (new_n39_ | (~x11 & ~x12))) : ~x14;
  assign z10 = x00 ? (new_n55_ & x09) : ~x14;
  assign new_n55_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = x00 ? (~x10 & ~new_n57_ & x11) : ~x14;
  assign new_n57_ = x01 ? (~x09 | ~x12 | (x02 & x03 & x04)) : x12;
