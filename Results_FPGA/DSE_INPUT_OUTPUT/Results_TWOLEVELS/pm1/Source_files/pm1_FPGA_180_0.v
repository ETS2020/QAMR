...
module FAU ( 
  ...
  wire new_n33_, new_n35_, new_n40_, new_n43_, new_n45_, new_n47_, new_n49_;
  assign z00 = x01 | x11 | (~x12 & ~x13) | (~x11 & x12);
  assign z01 = (x11 & x12 & (~new_n33_ | ~x07 | ~x08 | (new_n33_ & x07 & x08))) | (~x12 & x13);
  ...
  assign z05 = x12 & ~x13;
  assign z06 = x01 & x09 & ((~x11 & x12) | (~new_n40_ & (x12 | x13)));
  assign new_n40_ = x02 & x03 & x04;
  assign z07 = ~x15 & (x12 | x13);
  assign z08 = (x00 & ~x10 & (new_n43_ | (~x11 & ~x12 & x13))) | ~x00 | (~x11 & x12) | x10 | (~x12 & ~x13);
  assign new_n43_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = x00 & ~x10 & (x11 ? (~new_n45_ & x12) : (~x12 & x13));
  assign new_n45_ = x09 & (~x09 | (x04 & (~x02 | ~x03 | ~x04) & x02 & x03));
  assign z10 = x00 & new_n47_ & x09;
  assign new_n47_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = new_n49_ | (x00 & x01 & new_n47_ & x09);
  assign new_n49_ = ~x12 & (~x13 | (x00 & ~x01 & ~x10 & x11));
