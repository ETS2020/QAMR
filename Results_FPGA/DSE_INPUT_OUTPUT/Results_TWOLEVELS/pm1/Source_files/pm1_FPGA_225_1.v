...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n38_, new_n41_, new_n44_, new_n46_,
    new_n48_, new_n50_;
  ...
  assign z03 = (x11 & (new_n38_ | (~x12 & ~x13))) | (~x11 & (x12 | (new_n37_ & ~x12 & ~x13))) | (~x12 & (x13 | (~new_n37_ & ~x13))) | (~x09 & x12);
  assign new_n37_ = x00 & ~x10;
  assign new_n38_ = x05 & x06 & x07 & x08 & x12;
  assign z04 = ~x14 | (~x12 & x13);
  assign z06 = (new_n41_ & x01) | (~x12 & x13);
  assign new_n41_ = x09 & (~x02 | ~x03 | ~x04 | (~x11 & x12));
  assign z07 = ~x15 & (x12 | ~x13);
  assign z08 = (x00 & ~x10 & (new_n44_ | (~x11 & ~x12 & ~x13))) | (~x11 & x12) | ((~x00 | x10) & (x12 | (~x12 & ~x13)));
