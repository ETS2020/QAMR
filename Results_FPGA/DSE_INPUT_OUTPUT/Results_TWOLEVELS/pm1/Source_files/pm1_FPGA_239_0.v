...
module FAU ( 
  ...
  wire new_n32_, new_n34_, new_n35_, new_n37_, new_n42_, new_n45_, new_n47_,
    new_n49_, new_n51_, new_n52_;
  assign z00 = (x11 & ((x06 & (~x12 | (new_n32_ & x05))) | (x12 & (~new_n32_ | ~x05 | ~x06)))) | x01 | (~x06 & ~x12) | (~x11 & x12);
  assign new_n32_ = x07 & x08;
  assign z01 = (~x06 & (~x12 | (x11 & x12))) | (x11 & (new_n34_ | (~new_n34_ & x06))) | (x06 & ~new_n35_ & ~x12);
  assign new_n34_ = x12 & (~x05 | ~x07 | ~x08);
  assign new_n35_ = x00 & ~x10 & (~x00 | x10 | x11);
  assign z02 = (~x11 & (x12 | (~x10 & ~x12 & x00 & x06))) | (x06 & ~x12 & (~x00 | x10 | x11)) | (~new_n37_ & x12);
  assign new_n37_ = x09 & (~x11 | (x07 & x08 & x05 & x06));
  assign z03 = (x06 & ((~new_n35_ & ~x12) | (~new_n34_ & x11))) | (~x06 & ~x12) | (x12 & (~x09 | ~x11));
  ...
  assign z08 = (x00 & ~x10 & (new_n45_ | (x06 & ~x11 & ~x12))) | (~x11 & x12) | ((x12 | (x06 & ~x12)) & (~x00 | x10));
  assign new_n45_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = (~x12 & (~x06 | (x00 & x06 & ~x10 & ~x11))) | (x00 & ~x10 & x11 & ~new_n47_ & x12);
