...
module FAU ( 
  ...
  wire new_n32_, new_n33_, new_n40_, new_n43_, new_n45_, new_n47_, new_n49_,
    new_n50_;
  assign z00 = new_n32_ | (x11 & (~x07 | (~new_n33_ & x12))) | x01 | (~x11 & x12);
  assign new_n32_ = x07 & (~x12 | (x05 & x06 & x08 & x11));
  assign new_n33_ = x05 & x06 & x08;
  assign z01 = new_n32_ | (~x07 & (x11 | ~x12)) | (x11 & ~new_n33_ & x12);
  assign z02 = (~x07 & (x11 | ~x12)) | (x12 & ((~new_n33_ & x11) | ~x09 | ~x11));
  assign z03 = new_n32_ | (x12 & (~x09 | ~x11)) | (~x07 & ~x12);
  ...
  assign z08 = (x00 & ~new_n43_ & ~x10) | ~x00 | (~x11 & x12) | x10 | (x07 & ~x12);
  assign new_n43_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (~x12 & (x07 | (x00 & ~x10 & ~x11))) | (x00 & ~x10 & x11 & ~new_n45_ & x12);
