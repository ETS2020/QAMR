...
module FAU ( 
  ...
  assign z08 = (~new_n43_ & x11) | ~x00 | ~x12 | (~x11 & x12);
  assign new_n43_ = ~x10 & (~x00 | ~x02 | ~x03 | ~x04 | ~x09 | x10);
  assign z09 = ~x10 & (~x12 | (x00 & x11 & (x09 ? ~new_n45_ : x12)));
  assign new_n45_ = x02 & x03 & x04 & (~x02 | ~x03 | ~x04);
  assign z10 = ~x10 & (new_n47_ | ~x12);
  assign new_n47_ = x00 & x09 & x11 & (~x02 | ~x03 | ~x04);
