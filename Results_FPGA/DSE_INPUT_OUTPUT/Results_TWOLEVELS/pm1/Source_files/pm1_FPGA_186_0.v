...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n41_, new_n44_, new_n46_, new_n48_,
    new_n50_, new_n51_;
  assign z00 = (x03 & (x01 | x11)) | (x12 & (~x11 | (~new_n32_ & x11)));
  ...
  assign z03 = x12 ? ~new_n37_ : x03;
  assign new_n37_ = x09 & x11 & (~x05 | ~x06 | ~x07 | ~x08 | ~x11);
  assign z04 = ~x14 | (~x03 & ~x12);
  assign z05 = ~x13 | (~x03 & ~x12);
  assign z06 = new_n41_ & x01;
  assign new_n41_ = x09 & ((x03 & (~x02 | ~x04)) | (x12 & (~x03 | ~x11)));
  assign z07 = ~x15 | (~x03 & ~x12);
  assign z08 = (x00 & x03 & ~new_n44_ & ~x10) | ~x00 | (~x11 & x12) | x10 | (~x03 & ~x12);
  assign new_n44_ = (~x02 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = x00 & ~new_n46_ & ~x10;
  assign new_n46_ = (~x03 | ((~x02 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12))) & (~x11 | ~x12 | (x09 & (~x09 | (x02 & x03 & x04))));
  assign z10 = x00 & new_n48_ & x09;
  assign new_n48_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = (~new_n50_ & ~x03) | (x00 & new_n51_ & ~x10);
  assign new_n50_ = x12 & (~x00 | ~x01 | ~x09 | x10 | ~x11);
  assign new_n51_ = x11 & (x01 ? (x09 & x12 & (~x02 | ~x04)) : ~x12);
