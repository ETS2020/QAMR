...
module FAU ( 
  ...
  assign new_n41_ = x09 & (x02 ? (~x03 | ~x04 | (~x11 & x12)) : ~x12);
  assign z07 = ~x15 | (~x02 & x12);
  assign z08 = (x00 & ~new_n44_ & ~x10) | (x12 & (~x02 | (x02 & ~x11))) | ~x00 | x10;
  assign new_n44_ = (~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (~x02 & x12) | (x00 & ~x10 & (x11 ? (~new_n46_ & x12) : ~x12));
  assign new_n46_ = x09 ? (x03 & x04 & (~x03 | ~x04)) : ~x02;
  assign z10 = x12 & (new_n48_ | ~x02);
  assign new_n48_ = x00 & x09 & ~x10 & x11 & (~x03 | ~x04);
  assign z11 = (~x02 & x12) | (x00 & new_n50_ & ~x10);
  assign new_n50_ = x11 & (x01 ? (x09 & x12 & (~x03 | ~x04)) : ~x12);
