...
module FAU ( 
  ...
  wire new_n33_, new_n34_, new_n36_, new_n38_, new_n43_, new_n47_, new_n50_;
  ...
  assign z12 = ~x09 & x12;
  assign z05 = ~z12 & ~x13;
  assign z06 = (x12 & (~x09 | (x01 & ~x11))) | (x01 & ~new_n43_ & x09);
  assign new_n43_ = x02 & x03 & x04;
  assign z07 = z12 | ~x15;
  assign z08 = (x00 & ~x10 & ((new_n43_ & x09 & x11 & x12) | (~x11 & ~x12))) | ((~x00 | x10) & (x09 | ~x12)) | (x09 & ~x11 & x12);
