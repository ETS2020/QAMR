...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n41_, new_n44_, new_n45_, new_n48_,
    new_n50_, new_n52_;
  ...
  assign z07 = ~x14 & ~x15;
  assign z08 = new_n44_ | ~x00 | x10 | new_n45_ | (x14 & ~x15);
  assign new_n44_ = ~x11 & (x12 | (x00 & ~x10 & ~x12 & (~x14 | x15)));
  assign new_n45_ = x02 & x03 & x04 & x09 & x12;
  assign z09 = x00 & ~x10 & (~x14 | x15) & (~x11 ^ x12);
  assign z10 = (x14 & ~x15) | (x00 & new_n48_ & x09);
  assign new_n48_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = (x14 & ~x15) | (x00 & ~x10 & ~new_n50_ & x11);
  assign new_n50_ = x01 ? (~x09 | ~x12 | (x02 & x03 & x04)) : x12;
  assign z12 = new_n52_ & x00;
  assign new_n52_ = ~x09 & ~x10 & x11 & x12 & (~x14 | x15);
endmodule
