...
module FAU ( 
  ...
  wire new_n32_, new_n34_, new_n35_, new_n41_, new_n44_, new_n46_, new_n48_,
    new_n50_, new_n51_;
  assign z00 = (~x06 & (x11 | ~x12)) | (~new_n32_ & x11) | x01 | (~x11 & x12);
  assign new_n32_ = x05 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z01 = new_n34_ | (~x06 & (x11 | ~x12)) | (~new_n35_ & x11);
  assign new_n34_ = x06 & (~x12 | (x05 & x07 & x08 & x11));
  ...
  assign z06 = (new_n41_ & x01) | (~x06 & ~x12);
