...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n38_, new_n42_, new_n45_, new_n47_,
    new_n49_, new_n51_;
  assign z00 = (~x07 & (x11 | (x01 & ~x12))) | (x12 & (~x11 | (~new_n32_ & x11)));
  assign new_n32_ = x05 & x06 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z01 = (~x07 & (x11 | (~x12 & (~x00 | x10 | (x00 & ~x10 & ~x11))))) | (x11 & ~new_n32_ & x12);
  assign z02 = (~x11 & (x12 | (x00 & ~x07 & ~x10 & ~x12))) | (~x07 & (x11 | (~x12 & (~x00 | x10)))) | (~new_n35_ & x12) | (x07 & ~x12);
  assign new_n35_ = x09 & (~x11 | (x05 & x06 & x08));
  assign z03 = (~new_n38_ & x12) | (~x07 & ~new_n37_ & ~x12);
  assign new_n37_ = (~x00 | x10 | (x11 & (x01 | ~x11))) & x00 & ~x01 & ~x10;
  ...
  assign z08 = (x00 & ~x10 & (new_n45_ | (~x07 & ~x11 & ~x12))) | (~x11 & x12) | ((~x00 | x10) & (x12 | (~x07 & ~x12)));
  assign new_n45_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = (~x12 & (x07 | (~x10 & ~x11 & x00 & ~x07))) | (x00 & ~x10 & x11 & ~new_n47_ & x12);
  ...
  assign new_n51_ = ~x12 & (x07 | (x00 & ~x01 & ~x07 & ~x10 & x11));
