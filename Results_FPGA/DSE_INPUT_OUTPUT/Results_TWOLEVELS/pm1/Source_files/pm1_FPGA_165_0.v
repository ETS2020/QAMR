...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n40_, new_n43_, new_n45_, new_n47_, new_n49_,
    new_n50_;
  assign z00 = (x06 & (x01 | x11)) | (x12 & (~x11 | (~x06 & x11)));
  assign z01 = (x06 & (~x12 | (x05 & x07 & x08 & x11))) | (~x06 & (~x12 | (x11 & x12))) | (x11 & x12 & (~x05 | ~x07 | ~x08));
  assign z02 = x12 ? (~x09 | ~x11 | (x11 & (~new_n34_ | ~x05 | ~x06))) : x06;
  assign new_n34_ = x07 & x08;
  assign z03 = (x06 & (new_n36_ | ~x12)) | (x12 & (~x09 | ~x11)) | (~x06 & ~x12);
  assign new_n36_ = x08 & x11 & x05 & x07;
  assign z04 = ~x14 & (x06 | x12);
  assign z05 = ~x13 | (~x06 & ~x12);
  assign z06 = (new_n40_ & x01) | (~x06 & ~x12);
  assign new_n40_ = x09 & (~x02 | ~x03 | ~x04 | (~x11 & x12));
  assign z07 = ~x15 | (~x06 & ~x12);
  assign z08 = (x00 & ~x10 & (new_n43_ | (x06 & ~x11 & ~x12))) | (~x11 & x12) | ((x06 | x12) & (~x00 | x10));
  assign new_n43_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = (~x12 & (~x06 | (x00 & x06 & ~x10 & ~x11))) | (x00 & ~x10 & x11 & ~new_n45_ & x12);
  assign new_n45_ = x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = (~x06 & ~x12) | (x00 & new_n47_ & x09);
  assign new_n47_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = x00 & ~x10 & x11 & (new_n49_ | new_n50_);
  assign new_n49_ = x01 & x09 & x12 & (~x02 | ~x03 | ~x04);
  assign new_n50_ = ~x01 & x06 & ~x12;
