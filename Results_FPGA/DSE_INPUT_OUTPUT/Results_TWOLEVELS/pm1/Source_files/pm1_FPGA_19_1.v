...
module FAU ( 
  ...
  assign z00 = (~x12 & (x01 | x11)) | (x10 & (new_n32_ | (~x11 & x12)));
  assign new_n32_ = x11 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08));
  assign z01 = ~x12 | (new_n32_ & x10);
  assign z02 = (~x11 & (~x12 | (x10 & x12))) | (x10 & (~x09 | (~new_n35_ & x11))) | (x11 & ~x12);
  assign new_n35_ = x05 & x06 & x07 & x08;
  assign z03 = (x11 & (new_n37_ | ~x12)) | (x10 & (~x09 | (~x11 & x12))) | (~x10 & x12) | (~x11 & ~x12);
  assign new_n37_ = x05 & x06 & x07 & x08 & x10;
  ...
  assign z08 = (~x11 & (~x12 | (x10 & x12))) | (new_n32_ & x10) | (~x00 & ~x12);
