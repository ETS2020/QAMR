...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n41_, new_n44_, new_n45_, new_n47_,
    new_n49_, new_n51_;
  assign z00 = new_n32_ | (~x13 & (x01 | x12));
  ...
  assign z06 = (~x11 & (x13 | (x01 & x09 & x12))) | (x01 & ~new_n41_ & x09);
  assign new_n41_ = x02 & x03 & x04;
  assign z07 = ~x15 | (~x11 & x13);
  assign z08 = x11 ? (~x00 | x10 | (new_n45_ & new_n44_ & x00)) : ~x13;
  assign new_n44_ = x02 & x03;
  assign new_n45_ = x04 & x09 & ~x10 & x12;
  assign z09 = (~x11 & (x13 | (x00 & ~x10 & ~x12))) | (x00 & ~x10 & x11 & ~new_n47_ & x12);
  assign new_n47_ = x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = (~x11 & x13) | (x00 & x09 & ~x10 & new_n49_ & x11);
  assign new_n49_ = x12 & (~x02 | ~x03 | ~x04);
  assign z11 = (~x11 & x13) | (x00 & ~x10 & ~new_n51_ & x11);
