...
module FAU ( 
  ...
  assign z01 = ~x12 | (x11 & (new_n33_ | (~new_n33_ & x12)));
  assign new_n33_ = x05 & x06 & x07 & x08;
  assign z02 = x12 ? ((~new_n33_ & x11) | ~x09 | ~x11) : x09;
  assign z03 = ~x09 | (x09 & ~x12) | (~x11 & x12) | (new_n36_ & x07 & x08 & x11);
  ...
  assign z08 = (x00 & ~x10 & ((new_n43_ & x09 & x11 & x12) | (~x11 & ~x12))) | ~x00 | (~x11 & x12) | x10 | (~x09 & ~x12);
  assign new_n43_ = x02 & x03 & x04;
  assign z09 = (~x09 & (~x12 | (x00 & ~x10 & x11 & x12))) | (x00 & ~x10 & ((~x11 & ~x12) | (x09 & x11 & ~new_n45_ & x12)));
  assign new_n45_ = x02 & x03 & x04 & (~x02 | ~x03 | ~x04);
  assign z10 = (~x09 & ~x12) | (x00 & new_n47_ & x09);
