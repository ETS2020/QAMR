...
module FAU ( 
  ...
  assign z08 = ~new_n44_ | (x09 & (~x12 | (new_n43_ & new_n40_ & x00)));
  assign new_n43_ = x11 & x12 & x04 & ~x10;
  assign new_n44_ = (x11 | (~x12 & (x09 | x12))) & x00 & ~x10;
  assign z09 = x00 & ~new_n46_ & ~x10;
  assign new_n46_ = x09 ? (~x11 | ~x12 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04))) : (~x11 ^ ~x12);
  assign z10 = x00 & new_n48_ & x09;
  assign new_n48_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = (~x12 & (x09 | (new_n50_ & x00 & ~x01))) | (x00 & x01 & new_n51_ & x09);
  assign new_n50_ = ~x10 & x11;
  assign new_n51_ = ~x10 & x11 & (~x02 | ~x03 | ~x04);
