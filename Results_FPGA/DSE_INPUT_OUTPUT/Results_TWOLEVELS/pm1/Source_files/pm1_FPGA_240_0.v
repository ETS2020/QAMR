...
module FAU ( 
  ...
  assign z01 = (x07 & (~x12 | (new_n33_ & x08 & x11))) | (x11 & x12 & (~new_n33_ | ~x07 | ~x08));
  assign new_n33_ = x05 & x06;
  assign z02 = (~x07 & (~x12 | (x11 & x12))) | (x12 & (~x11 | (~new_n35_ & x11))) | ~x09 | (x07 & ~x12);
  assign new_n35_ = x05 & x06 & x08;
  assign z03 = (x07 & (~x12 | (new_n33_ & x08 & x11))) | (~x07 & ~x12) | ~x09 | (~x11 & x12);
