...
module FAU ( 
  ...
  assign z06 = (~x02 & (~x11 | (x01 & x09))) | (x01 & ~new_n41_ & x09);
  assign new_n41_ = x03 & x04 & (x11 | ~x12);
  assign z07 = ~x15 | (~x02 & ~x11);
  assign z08 = (x02 & (~x11 | (new_n45_ & new_n44_ & x00))) | (x11 & (~x00 | x10));
  assign new_n44_ = x03 & x04;
  assign new_n45_ = x11 & x12 & x09 & ~x10;
  assign z09 = x00 & ~new_n47_ & ~x10;
  assign new_n47_ = (~x02 | ((~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12))) & (~x11 | ~x12 | (x09 & (~x09 | (x02 & x03 & x04))));
  assign z10 = (~x02 & (~x11 | (new_n49_ & x00 & x09))) | (x00 & new_n50_ & x09);
  assign new_n49_ = ~x10 & x11 & x12;
  assign new_n50_ = ~x10 & x11 & x12 & (~x03 | ~x04);
  assign z11 = (~x02 & (new_n52_ | ~x11)) | (x00 & ~x10 & ~new_n53_ & x11);
  assign new_n52_ = x00 & x01 & x09 & ~x10 & x12;
  assign new_n53_ = x01 ? (~x09 | ~x12 | (x03 & x04)) : x12;
  assign z12 = (~x02 & ~x11) | (new_n49_ & x00 & ~x09);
endmodule
