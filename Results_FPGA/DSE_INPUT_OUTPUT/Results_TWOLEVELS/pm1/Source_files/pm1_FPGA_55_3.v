...
module FAU ( 
  ...
  assign z06 = (x03 & x12) | (x01 & x09 & (~x02 | ~x03 | ~x04));
  assign z07 = ~x15 & (~x03 | ~x12);
  assign z08 = (~x11 & ((~x03 & x12) | (x00 & ~x10 & ~x12))) | ~x00 | x10 | (x03 & x12);
  assign z09 = x00 & ~x10 & ((~x03 & x11 & x12) | (~x11 & ~x12));
  assign z10 = x12 & (x03 | (x00 & ~x03 & x09 & ~x10 & x11));
  assign z11 = new_n46_ & x00;
  assign new_n46_ = ~x10 & x11 & ((x01 & ~x03 & x09 & x12) | (~x01 & ~x12));
