...
module FAU ( 
  ...
  assign z01 = x11 ? (x12 & (~new_n32_ | ~x07 | ~x08 | (new_n32_ & x07 & x08))) : ~x12;
  assign z02 = ~x11 | ~x09 | (x11 & (~x12 | (x12 & (~new_n32_ | ~x07 | ~x08))));
  assign z03 = (x11 & (~x12 | (new_n32_ & x07 & x08 & x12))) | ~x09 | ~x11;
  ...
  assign z09 = (x11 & ~x12) | (x00 & ~x10 & (~x12 | (~new_n45_ & x11)));
  assign new_n45_ = (~x12 | (x09 & (~x04 | ~x09 | ~x02 | ~x03))) & (~x09 | (x02 & x03 & x04));
  assign z10 = x11 & (~x12 | (x00 & x09 & ~new_n39_ & ~x10));
