...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n40_, new_n42_, new_n43_, new_n46_,
    new_n48_, new_n50_;
  ...
  assign z06 = (~x14 & x15) | (new_n40_ & x01);
  assign new_n40_ = x09 & (~x02 | ~x03 | ~x04 | (~x11 & x12));
  assign z08 = new_n42_ | ~x00 | x10 | new_n43_ | (~x14 & x15);
  assign new_n42_ = ~x11 & (x12 | (x00 & ~x10 & ~x12 & (x14 | ~x15)));
