...
module FAU ( 
  ...
  assign z00 = x11 ? (~new_n32_ | ~x07 | ~x08 | (new_n32_ & x07 & x08)) : x12;
  ...
  assign z08 = (x12 & (~x11 | (new_n42_ & x00 & new_n43_ & ~x10 & x11))) | (x11 & (~x00 | x10));
  ...
  assign z10 = (~x11 & ~x12) | (x00 & x09 & ~x10 & x11 & ~new_n39_ & x12);
