...
module FAU ( 
  ...
  assign z01 = ~x12 | (x11 & ~x15 & (~new_n33_ | ~x07 | ~x08 | (new_n33_ & x07 & x08)));
  ...
  assign z06 = (x12 & (x15 | (x01 & x09 & ~x11))) | (x01 & ~new_n41_ & x09);
  assign new_n41_ = x02 & x03 & x04;
  assign z07 = x15 ? x12 : (~x11 | (x11 & (~new_n33_ | ~x07 | ~x08 | (new_n33_ & x07 & x08))));
  assign z08 = ~new_n46_ | (x00 & ~x10 & (new_n44_ | (new_n41_ & new_n45_)));
  assign new_n44_ = ~x11 & ~x12;
  assign new_n45_ = x12 & ~x15 & x09 & x11;
  assign new_n46_ = x00 & (x11 | x15) & ~x10 & (~x12 | ~x15);
  assign z09 = x00 & ~x10 & (x11 ? (new_n48_ & x12) : ~x12);
  assign new_n48_ = ~x15 & (~x09 | (x09 & (~x04 | (x02 & x03 & x04) | ~x02 | ~x03)));
  assign z10 = x12 & (x15 | (x00 & new_n50_ & x09));
  assign new_n50_ = ~x10 & x11 & ~x15 & (~x02 | ~x03 | ~x04);
  assign z11 = (x12 & x15) | (x00 & ~x10 & ~new_n52_ & x11);
