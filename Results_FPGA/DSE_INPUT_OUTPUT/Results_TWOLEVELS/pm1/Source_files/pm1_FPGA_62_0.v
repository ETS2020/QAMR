...
module FAU ( 
  ...
  assign z03 = ~x12 | (~new_n37_ & x12);
  assign new_n37_ = x09 & x11 & (~x05 | ~x06 | ~x07 | ~x08 | ~x11);
  assign z04 = ~x14 & (x12 | x15);
  assign z05 = ~x13 | (~x12 & ~x15);
  assign z06 = (new_n41_ & x01) | (~x12 & ~x15);
  assign new_n41_ = x09 & (~x02 | ~x03 | ~x04 | (~x11 & x12));
  assign z07 = x12 & ~x15;
  assign z08 = (x00 & ~new_n44_ & ~x10) | ~x00 | (~x11 & x12) | x10 | (~x12 & ~x15);
  assign new_n44_ = (x11 | x12) & (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12);
  assign z09 = (~x12 & (~x15 | (x00 & ~x10 & ~x11))) | (x00 & ~x10 & x11 & ~new_n46_ & x12);
  ...
  assign new_n50_ = ~x12 & (~x15 | (x00 & ~x01 & ~x10 & x11));
