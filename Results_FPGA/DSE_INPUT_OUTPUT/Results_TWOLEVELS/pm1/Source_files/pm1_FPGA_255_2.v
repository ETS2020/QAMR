...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n36_, new_n38_, new_n42_, new_n44_, new_n45_,
    new_n46_, new_n48_, new_n50_, new_n52_;
  assign z00 = (x12 & (~x15 | (~x11 & x15))) | new_n32_ | (~x12 & (x01 | x11));
  assign new_n32_ = x11 & x15 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08));
  assign z01 = new_n32_ | (~x12 & (~x00 | x10 | x11 | (x00 & ~x10 & ~x11)));
  assign z02 = new_n36_ | (x12 & (~x15 | (~x11 & x15))) | (x15 & (~x09 | (~new_n35_ & x11)));
  assign new_n35_ = x05 & x06 & x07 & x08;
  assign new_n36_ = ~x12 & ((x00 & ~x10 & (~x11 | (~x01 & x11))) | ~x00 | x01 | x10);
  assign z03 = new_n36_ | (x15 & (~new_n38_ | ~x09));
