...
module FAU ( 
  ...
  assign z02 = x12 ? ((x11 & (~new_n35_ | ~x07 | ~x08)) | ~x09 | ~x11) : x09;
  assign new_n35_ = x05 & x06;
  assign z03 = x12 ? (~x09 | ~x11 | (new_n35_ & x07 & x08 & x11)) : x09;
  ...
  assign z09 = (~x09 & (~x12 | (x00 & ~x10 & x11))) | (x00 & ~x10 & ((~x11 & ~x12) | (x09 & x11 & ~new_n45_ & x12)));
  ...
  assign z12 = ~x09 & (~x12 | (new_n49_ & x00));
endmodule
