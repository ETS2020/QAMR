...
module FAU ( 
  ...
  assign z01 = (x11 & (~x12 | (~new_n32_ & x08))) | (~new_n34_ & ~x12);
  assign new_n34_ = x00 & ~x10 & (~x00 | x10 | x11);
  assign z02 = (~x11 & ((x08 & x12) | (x00 & ~x10 & ~x12))) | (~x12 & (~x00 | x10 | x11)) | (~new_n36_ & x08) | (~x08 & x12);
  assign new_n36_ = x09 & (~x11 | (x05 & x06 & x07));
  assign z03 = (x11 & (new_n38_ | ~x12)) | (~new_n34_ & ~x12) | (x08 & (~x09 | (~x11 & x12)));
  ...
  assign new_n49_ = x09 & (~x08 | ~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
