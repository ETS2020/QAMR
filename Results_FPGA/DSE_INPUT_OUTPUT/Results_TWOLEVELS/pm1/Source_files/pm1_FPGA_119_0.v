...
module FAU ( 
  ...
  assign z00 = (~x07 & (x11 | ~x12)) | (x11 & (~new_n32_ | ~x08 | (new_n32_ & x07 & x08))) | (~x11 & x12) | (x01 & ~x12);
  assign new_n32_ = x05 & x06;
  assign z01 = (~x07 & (x11 | ~x12)) | (x07 & (new_n35_ | (~new_n34_ & ~x12))) | (~new_n36_ & x11);
  assign new_n34_ = x00 & ~x10 & (~x00 | x10 | x11);
  assign new_n35_ = x08 & x11 & x05 & x06;
  assign new_n36_ = x05 & x06 & x08;
  assign z02 = new_n39_ | (~new_n38_ & x11) | ~x09 | (~x11 & x12);
  assign new_n38_ = x07 & x08 & x05 & x06;
  assign new_n39_ = ~x12 & ((x00 & ~x10 & (x11 ? ~x01 : x07)) | (x07 & (~x00 | x10)) | x01 | ~x07);
  assign z03 = new_n39_ | new_n41_ | ~x09 | (~x11 & x12);
  assign new_n41_ = x05 & x06 & x07 & x08 & x11;
  assign z04 = ~x14 | (~x07 & ~x12);
  assign z05 = ~x13 & (x07 | x12);
  assign z06 = x01 & x09 & ((~x11 & x12) | (~new_n45_ & (x07 | x12)));
  assign new_n45_ = x02 & x03 & x04;
  assign z07 = ~x15 & (x07 | x12);
  assign z08 = (x00 & ~x10 & (new_n48_ | (x07 & ~x11 & ~x12))) | (~x11 & x12) | ((~x00 | x10) & (x12 | (x07 & ~x12)));
  assign new_n48_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = (~x12 & (~x07 | (x00 & x07 & ~x10 & ~x11))) | (x00 & ~x10 & x11 & ~new_n50_ & x12);
  ...
  assign new_n54_ = ~x12 & (~x07 | (~x10 & x11 & x00 & ~x01));
