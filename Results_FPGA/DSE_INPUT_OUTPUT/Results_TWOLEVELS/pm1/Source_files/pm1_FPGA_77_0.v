...
module FAU ( 
  ...
  wire new_n32_, new_n34_, new_n35_, new_n38_, new_n42_, new_n45_, new_n48_,
    new_n50_, new_n52_;
  assign z00 = (~x05 & (x11 | ~x14)) | (~new_n32_ & x11) | x01 | (~x11 & x12);
  assign new_n32_ = x06 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z01 = (x05 & (new_n34_ | ~x12)) | (~x05 & (x11 | ~x14)) | new_n35_ | (~x12 & x14);
  assign new_n34_ = x06 & x07 & x08 & x11;
  assign new_n35_ = x11 & (~x06 | ~x07 | ~x08);
  assign z02 = (x05 & (~x09 | ~x12)) | (~x05 & (x11 | ~x14)) | new_n35_ | (~x11 & x12) | (~x12 & x14);
  assign z03 = new_n38_ | ((~x09 | ~x11 | ~x12) & (x05 | x14));
