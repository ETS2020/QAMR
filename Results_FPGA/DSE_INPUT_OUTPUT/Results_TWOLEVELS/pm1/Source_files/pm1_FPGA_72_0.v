...
module FAU ( 
  ...
  assign z06 = (new_n39_ & x01) | (~x12 & ~x13);
  assign new_n39_ = x09 & (~x02 | ~x03 | ~x04 | (~x11 & x12));
  assign z07 = ~x15 & (x12 | x13);
  assign z08 = (x00 & ~x10 & (new_n42_ | (~x11 & ~x12 & x13))) | (~x11 & x12) | ((x12 | x13) & (~x00 | x10));
  assign new_n42_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = x00 & ~x10 & (x11 ? (~new_n44_ & x12) : (~x12 & x13));
  ...
  assign new_n48_ = ~x12 & (~x13 | (x00 & ~x01 & ~x10 & x11));
