...
module FAU ( 
  ...
  assign z00 = (x01 & (new_n32_ | ~x11)) | (x11 & ~x12);
  assign new_n32_ = x11 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08));
  assign z01 = (~x12 & (~x00 | x10 | x11 | (x00 & ~x10 & ~x11))) | (new_n32_ & x01) | (~x01 & x12);
  assign z02 = (~x11 & (x01 | (x00 & ~x10 & ~x12))) | (~x12 & (~x00 | x10 | x11)) | (~new_n35_ & x01) | (~x01 & x12);
  assign new_n35_ = x09 & ((x05 & x06 & x07 & x08) | ~x11);
  assign z03 = (x11 & (new_n37_ | ~x12)) | (x01 & (~x09 | ~x11)) | (~new_n38_ & ~x12);
  assign new_n37_ = x01 & x05 & x06 & x07 & x08;
  assign new_n38_ = x00 & ~x10 & (~x00 | x10 | x11);
  assign z04 = ~x14 & (x01 | ~x12);
  assign z05 = ~x13 & (x01 | ~x12);
  assign z06 = (x12 & (~x01 | (x09 & ~x11))) | (x01 & ~new_n42_ & x09);
  ...
  assign new_n48_ = (~x01 | x11) & ((x00 & ~x10) | (~x01 & x12));
  assign z09 = (~x01 & x12) | (x00 & ~x10 & (x11 ? (~new_n50_ & x12) : ~x12));
  assign new_n50_ = x09 & (~x01 | ~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
