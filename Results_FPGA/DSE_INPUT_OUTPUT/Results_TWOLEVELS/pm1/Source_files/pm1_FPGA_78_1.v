...
module FAU ( 
  ...
  assign z02 = ~x12 | (x06 & ((~new_n34_ & x11) | ~x09 | (~x11 & x12)));
  assign new_n34_ = x05 & x07 & x08;
  assign z03 = ~x12 | (x06 & (~x09 | (~x11 & x12) | (new_n36_ & x08 & x11)));
  ...
  assign z08 = (x00 & ~new_n43_ & ~x10) | (x12 & (~x06 | (x06 & ~x11))) | ~x00 | x10;
  assign new_n43_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (~x06 & x12) | (x00 & ~x10 & (x11 ? (~new_n45_ & x12) : ~x12));
  assign new_n45_ = x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = x12 & (~x06 | (new_n47_ & x00));
