...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n38_, new_n40_, new_n43_, new_n44_, new_n46_,
    new_n48_, new_n50_;
  assign z00 = (x01 & (~x13 | x15)) | (x11 & (x15 | (~x13 & ~x15))) | (x12 & (~x13 | (~x11 & x15)));
  assign z01 = (x11 & (x15 | (~x13 & ~x15))) | (x13 & ~x15) | (~x12 & (~x13 | x15));
  assign z02 = ((~x13 | x15) & (~x09 | ~x12)) | ~new_n34_ | (~x11 & (x15 ? x12 : ~x13));
  assign new_n34_ = x05 & x06 & x07 & x08 & (~x13 | x15);
  assign z03 = (~x11 & (x15 ? x12 : ~x13)) | ((~x13 | x15) & (new_n36_ | ~x09 | ~x12));
  assign new_n36_ = x05 & x06 & x07 & x08;
  assign z04 = ~new_n38_ & ~x14;
  assign new_n38_ = x13 & ~x15;
  assign z06 = new_n38_ | (new_n40_ & x01);
  ...
  assign new_n44_ = (x11 | (x15 ? ~x12 : x13)) & x00 & ~x10 & (~x13 | x15);
