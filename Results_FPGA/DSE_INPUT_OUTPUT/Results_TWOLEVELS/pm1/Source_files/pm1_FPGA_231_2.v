...
module FAU ( 
  ...
  assign z09 = (~x12 & (x11 | (x00 & ~x10))) | (x00 & ~x10 & x11 & (x09 ? ~new_n44_ : x12));
  assign new_n44_ = x02 & x03 & x04 & (~x02 | ~x03 | ~x04);
  assign z10 = x11 & (~x12 | (new_n46_ & x00));
  assign new_n46_ = x09 & ~x10 & (~x02 | ~x03 | ~x04);
  assign z11 = x11 & (~x12 | (x00 & new_n46_ & x01));
