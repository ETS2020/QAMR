...
module FAU ( 
  ...
  assign z00 = (~new_n32_ & x11) | x01 | (~x11 & x12) | (~x12 & x13);
  assign new_n32_ = x05 & x06 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z01 = ~x12 | (~new_n32_ & x11);
  assign z02 = (x11 & (~new_n35_ | ~x07 | ~x08)) | ~x09 | ~x12 | (~x11 & x12);
  assign new_n35_ = x05 & x06;
  assign z03 = ~x09 | ~x12 | (~x11 & x12) | (new_n35_ & x07 & x08 & x11);
  assign z04 = ~x14 & (x12 | ~x13);
  assign z05 = ~x13 | (~x12 & x13);
  assign z06 = (~x12 & x13) | (new_n40_ & x01);
  assign new_n40_ = x09 & (~x02 | ~x03 | ~x04 | (~x11 & x12));
  assign z07 = ~x15 | (~x12 & x13);
  assign z08 = (x00 & ~new_n43_ & ~x10) | ~x00 | (~x11 & x12) | x10 | (~x12 & x13);
  assign new_n43_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (~x12 & (x13 | (x00 & ~x10 & ~x11))) | (x00 & ~x10 & x11 & ~new_n45_ & x12);
  ...
  assign new_n49_ = ~x12 & (x13 | (~x10 & x11 & x00 & ~x01));
