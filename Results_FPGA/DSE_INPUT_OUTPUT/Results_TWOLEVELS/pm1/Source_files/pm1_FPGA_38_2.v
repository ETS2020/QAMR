...
module FAU ( 
  ...
  assign z00 = (~x08 & (x01 | x11)) | (x12 & (~x11 | (x11 & (~new_n32_ | ~x07 | (new_n32_ & x07 & x08)))));
  assign new_n32_ = x05 & x06;
  assign z01 = (~x08 & (x11 | ~x12)) | (x11 & x12 & (~new_n32_ | ~x07 | (new_n32_ & x07 & x08)));
  assign z02 = (~x08 & (x11 | ~x12)) | (x12 & (~x09 | ~x11 | (~new_n35_ & x11)));
