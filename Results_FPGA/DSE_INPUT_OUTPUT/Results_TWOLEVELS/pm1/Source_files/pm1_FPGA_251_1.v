...
module FAU ( 
  ...
  assign new_n47_ = x00 & (~x01 | x11) & ~x10 & (x01 | ~x12);
  assign z09 = x00 & ~x10 & ((~x11 & ~x12) | (x01 & x11 & ~new_n49_ & x12));
