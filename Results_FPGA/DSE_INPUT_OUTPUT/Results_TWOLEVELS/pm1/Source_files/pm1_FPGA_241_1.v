...
module FAU ( 
  ...
  assign z01 = x11 ? (~x02 | (~new_n32_ & x02)) : ~x12;
  assign z02 = ~x11 | (x02 & ((~new_n35_ & x11) | ~x09 | ~x12));
  assign new_n35_ = x05 & x06 & x07 & x08;
  assign z03 = (x11 & (~x02 | (new_n37_ & x02 & x05))) | ~x11 | (x02 & (~x09 | ~x12));
  assign new_n37_ = x06 & x07 & x08;
  assign z04 = ~x14 | (~x02 & x11);
  assign z05 = ~x13 | (~x02 & x11);
  assign z06 = x01 & x09 & ((~new_n41_ & x02) | (~x11 & (~x02 | x12)));
  assign new_n41_ = x03 & x04;
  assign z07 = ~x15 | (~x02 & x11);
  assign z08 = ~x11 | (x02 & (~x00 | x10 | (new_n44_ & new_n41_ & x00)));
  assign new_n44_ = x11 & x12 & x09 & ~x10;
  assign z09 = (~x02 & x11) | (x00 & ~x10 & (x11 ? (~new_n46_ & x12) : ~x12));
  assign new_n46_ = x09 & (~x02 | ~x09 | (x03 & x04 & (~x03 | ~x04)));
  assign z10 = x00 & new_n48_ & x02;
  assign new_n48_ = x09 & ~x10 & x11 & (~x03 | ~x04) & x12;
  assign z11 = x11 & (~x02 | (new_n50_ & x00));
  assign new_n50_ = ~x10 & (x01 ? (x09 & x12 & (~x03 | ~x04)) : ~x12);
  assign z12 = x11 & (~x02 | (x00 & ~x09 & ~x10 & x12));
endmodule
