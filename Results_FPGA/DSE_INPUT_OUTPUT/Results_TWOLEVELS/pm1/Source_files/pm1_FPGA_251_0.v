...
module FAU ( 
  ...
  assign z00 = ~x12 | (x12 & (~x11 | (~new_n32_ & x11)));
  assign new_n32_ = x05 & x06 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z01 = (x11 & ~new_n32_ & x12) | (x01 & ~x12);
  ...
  assign z06 = x01 ? (x09 & (~new_n41_ | ~x04 | (~x11 & x12))) : ~x12;
  assign new_n41_ = x02 & x03;
  assign z07 = ~x15 & (x01 | x12);
  assign z08 = (x00 & ~x10 & (new_n44_ | (x01 & ~x11 & ~x12))) | ~x00 | (~x11 & x12) | x10 | (~x01 & ~x12);
  assign new_n44_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = x00 & ~x10 & ((x01 & ~x11 & ~x12) | (x11 & ~new_n46_ & x12));
