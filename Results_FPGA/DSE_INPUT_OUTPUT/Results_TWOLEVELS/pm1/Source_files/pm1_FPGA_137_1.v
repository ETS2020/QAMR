...
module FAU ( 
  ...
  assign z01 = (x11 & (~x12 | (~new_n32_ & x08))) | (~x12 & (~x00 | x10 | (x00 & ~x10 & ~x11))) | (~x08 & x12);
  assign z02 = (~x11 & ((x08 & x12) | (x00 & ~x10 & ~x12))) | (~new_n35_ & x08) | (~x12 & (~x00 | x10 | x11));
  assign new_n35_ = x09 & (~x11 | (x05 & x06 & x07));
  assign z03 = new_n37_ | ~new_n38_;
  assign new_n37_ = x11 & (~x12 | (x05 & x06 & x07 & x08));
  assign new_n38_ = (x12 | (x00 & ~x10 & (~x00 | x10 | x11))) & (x08 | ~x12) & (~x08 | (x09 & (x11 | ~x12)));
  ...
  assign z09 = (~x08 & x12) | (x00 & ~x10 & (x11 ? (~new_n49_ & x12) : ~x12));
  assign new_n49_ = x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04 | ~x08)));
  assign z10 = x12 & (~x08 | (new_n51_ & x00));
  assign new_n51_ = x09 & ~x10 & (~x02 | ~x03 | ~x04) & x11;
  assign z11 = (~x08 & x12) | (x00 & ~x10 & ~new_n53_ & x11);
