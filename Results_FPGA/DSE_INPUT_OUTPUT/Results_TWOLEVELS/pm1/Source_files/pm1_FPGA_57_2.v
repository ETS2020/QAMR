...
module FAU ( 
  ...
  assign new_n41_ = ~x01 & ~x07 & (x07 | (x00 & ~x10 & (~x00 | x10 | (x11 & (x01 | ~x11)))));
  assign new_n42_ = x05 & x06 & x07 & x08 & x11;
  assign z04 = ~x14 & (~x07 | x12);
  assign z05 = ~x13 & (~x07 | x12);
  assign z06 = x01 & ~new_n46_ & x09;
  assign new_n46_ = (x11 | ~x12) & ((x02 & x03 & x04) | (x07 & ~x12));
