...
module FAU ( 
  ...
  assign z01 = (x11 & ~new_n32_ & x15) | ~x12 | (x12 & ~x15);
  ...
  assign new_n41_ = ((x12 & ~x15) | (x02 & x03 & x04)) & (x11 | ~x12 | ~x15);
  assign z07 = ~x12 & ~x15;
  assign z08 = (x00 & ~new_n44_ & ~x10) | (x12 & (~x15 | (~x11 & x15))) | ~x00 | x10;
  assign new_n44_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (x12 & ~x15) | (x00 & ~x10 & (x11 ? (~new_n46_ & x12) : ~x12));
  assign new_n46_ = x09 & (~x09 | ((~x02 | ~x03 | ~x04) & (~x15 | (x02 & x03 & x04))));
