...
module FAU ( 
  ...
  assign z00 = (~x12 & (x01 | x11)) | (~x03 & (x11 ? ~new_n32_ : x12));
  assign new_n32_ = x05 & x06 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z01 = (~x03 & ~new_n32_ & x11) | ~x12 | (x03 & x12);
  assign z02 = (x12 & (x03 | (~x03 & ~x11))) | ~x12 | (~x03 & (~x09 | (~new_n35_ & x11)));
