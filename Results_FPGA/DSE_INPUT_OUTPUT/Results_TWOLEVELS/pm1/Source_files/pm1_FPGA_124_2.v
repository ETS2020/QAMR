...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n37_, new_n41_, new_n44_, new_n46_, new_n48_,
    new_n50_, new_n51_;
  assign z00 = (~x06 & (x01 | x11)) | (x12 & (~x11 | (~new_n32_ & x11)));
  assign new_n32_ = x05 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z01 = (~x06 & (x11 | ~x12)) | (x11 & ~new_n32_ & x12);
  assign z02 = (~x06 & (x11 | ~x12)) | (x12 & ((~new_n35_ & x11) | ~x09 | ~x11));
  assign new_n35_ = x05 & x07 & x08;
  assign z03 = (x06 & (~x12 | (new_n37_ & x08 & x11 & x12))) | (x12 & (~x09 | ~x11)) | (~x06 & ~x12);
  ...
  assign z08 = (x00 & ~x10 & (new_n44_ | (~x06 & ~x11 & ~x12))) | ~x00 | (~x11 & x12) | x10 | (x06 & ~x12);
  assign new_n44_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = x00 & ~x10 & ((~x06 & ~x11 & ~x12) | (x11 & ~new_n46_ & x12));
