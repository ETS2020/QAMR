...
module FAU ( 
  ...
  wire new_n33_, new_n35_, new_n37_, new_n41_, new_n45_, new_n48_;
  ...
  assign z08 = (x00 & ((new_n41_ & x09 & x11 & x12) | (~x10 & ~x11 & ~x12))) | (~x10 & ~x11 & x12) | ~x00 | x10;
  assign z09 = (x10 & x12) | (x00 & ((~x10 & ((~x11 & ~x12) | (~x09 & x11 & x12))) | (x09 & x11 & ~new_n45_ & x12)));
  assign new_n45_ = x02 & x03 & x04 & (~x02 | ~x03 | ~x04);
  assign z10 = x12 & (x10 | (x00 & x09 & ~new_n41_ & x11));
  assign z11 = (x10 & x12) | (x00 & x11 & (x01 ? new_n48_ : (~x10 & ~x12)));
