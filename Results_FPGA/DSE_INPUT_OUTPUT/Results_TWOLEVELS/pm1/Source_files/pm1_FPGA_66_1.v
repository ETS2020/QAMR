...
module FAU ( 
  ...
  assign z01 = (x11 & (~x12 | (~new_n32_ & x06))) | (~new_n34_ & ~x12) | (~x06 & x12);
  assign new_n34_ = x00 & ~x10 & (~x00 | x10 | x11);
  assign z02 = (~x11 & ((x06 & x12) | (x00 & ~x10 & ~x12))) | (~x12 & (~x00 | x10 | x11)) | (~new_n36_ & x06) | (~x06 & x12);
  assign new_n36_ = x09 & (~x11 | (x05 & x07 & x08));
  assign z03 = (x11 & (new_n38_ | ~x12)) | (~new_n34_ & ~x12) | (x06 & (~x09 | (~x11 & x12)));
  assign new_n38_ = x05 & x06 & x07 & x08;
  assign z04 = ~x14 | (~x06 & x12);
  assign z05 = ~x13 | (~x06 & x12);
  assign z06 = x01 & x09 & ((~new_n42_ & (x06 | ~x12)) | (x06 & ~x11 & x12));
  ...
  assign new_n47_ = (~x06 | x11 | ~x12) & ((~x06 & x12) | (x00 & ~x10));
  assign z09 = x00 & ~x10 & ((~x11 & ~x12) | (x06 & x11 & ~new_n49_ & x12));
  assign new_n49_ = x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = x12 & (~x06 | (x00 & new_n51_ & x06));
  assign new_n51_ = x09 & ~x10 & (~x02 | ~x03 | ~x04) & x11;
  assign z11 = (~x06 & x12) | (x00 & ~x10 & ~new_n53_ & x11);
