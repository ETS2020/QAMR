...
module FAU ( 
  ...
  wire new_n33_, new_n34_, new_n36_, new_n38_, new_n43_, new_n46_, new_n48_,
    new_n51_;
  ...
  assign z07 = z12 | ~x15;
  assign z08 = (x00 & ~x10 & ((new_n46_ & x09 & x11 & x12) | (~x11 & ~x12))) | ((x09 | ~x12) & (~x00 | x10)) | (x09 & ~x11 & x12);
  assign new_n46_ = x02 & x03 & x04;
  assign z09 = x00 & ~new_n48_ & ~x10;
  assign new_n48_ = (x11 | x12) & (~x09 | ~x11 | ~x12 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = x12 & (~x09 | (x00 & x09 & ~x10 & ~new_n46_ & x11));
