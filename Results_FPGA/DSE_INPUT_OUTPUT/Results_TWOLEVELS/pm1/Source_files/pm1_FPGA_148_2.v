...
module FAU ( 
  ...
  assign z00 = (x11 & (~x00 | (~new_n32_ & x12))) | x01 | (~x11 & x12) | (x00 & ~x12);
  ...
  assign z08 = (x00 & (~x12 | (new_n44_ & x11 & x12 & x09 & ~x10))) | (~x00 & (x11 | ~x12)) | x10 | (~x11 & x12);
  assign new_n44_ = x02 & x03 & x04;
  assign z09 = x00 & new_n46_ & ~x10;
  assign new_n46_ = x11 & x12 & (~x09 | (x09 & (~x02 | ~x03 | ~x04 | (x02 & x03 & x04))));
  assign z10 = x00 & (~x12 | (x09 & ~x10 & x11 & ~new_n44_ & x12));
  assign z11 = x00 & (~x12 | (new_n49_ & x01));
