...
module FAU ( 
  ...
  assign z00 = (x12 & (~x06 | (x06 & ~x11))) | x11 | (x01 & ~x12);
  assign z01 = (~x12 & (~x00 | x10 | (x00 & ~x10 & ~x11))) | x11 | (~x06 & x12);
  assign z02 = new_n34_ | (~new_n35_ & x06);
  assign new_n34_ = ~x12 & ((x00 & ~x10 & (~x11 | (~x01 & x11))) | ~x00 | x01 | x10);
  assign new_n35_ = x05 & x07 & x08 & x09 & (x11 | ~x12);
  assign z03 = new_n34_ | (x06 & (~x09 | (~x11 & x12))) | new_n37_ | (~x06 & x12);
  assign new_n37_ = x05 & x07 & x08;
  ...
  assign new_n44_ = x06 & x09 & x11 & x12;
  assign new_n45_ = ~x11 & ~x12;
  assign new_n46_ = ((~x06 & x12) | (x00 & ~x10)) & (~x06 | x11 | ~x12);
  assign z09 = (~x06 & x12) | (x00 & ~x10 & ((~x11 & ~x12) | (x06 & x11 & ~new_n48_ & x12)));
  assign new_n48_ = x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = x00 & x06 & new_n50_ & x09;
  assign new_n50_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = x00 & ~x10 & x11 & (x01 ? new_n52_ : ~x12);
  assign new_n52_ = x06 & x09 & x12 & (~x02 | ~x03 | ~x04);
