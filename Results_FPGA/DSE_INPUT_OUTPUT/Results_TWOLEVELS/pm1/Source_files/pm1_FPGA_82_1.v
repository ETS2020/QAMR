...
module FAU ( 
  ...
  assign new_n36_ = ~x12 & ~x13 & x00 & ~x10;
  ...
  assign z06 = x01 & x09 & ((~new_n43_ & (x12 | ~x13)) | (~x11 & x12));
  assign new_n43_ = x02 & x03 & x04;
  assign z07 = ~x15 | (~x12 & x13);
  assign z08 = (x00 & ~x10 & (new_n46_ | (~x11 & ~x12 & ~x13))) | (~x11 & x12) | ((~x00 | x10) & (x12 | (~x12 & ~x13)));
  assign new_n46_ = x02 & x03 & x04 & x09 & x11 & x12;
  assign z09 = x00 & ~x10 & (x11 ? (~new_n48_ & x12) : (~x12 & ~x13));
