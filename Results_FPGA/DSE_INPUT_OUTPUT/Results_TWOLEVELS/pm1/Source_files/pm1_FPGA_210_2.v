...
module FAU ( 
  ...
  assign new_n40_ = x09 & (~x04 | (x12 & (~x02 | ~x03 | ~x11)));
  assign z07 = ~x15 & (~x04 | x12);
  assign z08 = (x00 & ~new_n43_ & ~x10) | ~x00 | x10 | (x04 & ~x12) | (~x11 & x12);
  assign new_n43_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x04 | x11 | x12);
  assign z09 = x00 & ~new_n45_ & ~x10;
  assign new_n45_ = (x04 | ((~x09 | ~x11 | ~x12) & (x11 | x12))) & (~x11 | ~x12 | (x09 & (~x09 | (x02 & x03 & (~x02 | ~x03 | ~x04)))));
  assign z10 = (x04 & ~x12) | (x00 & new_n47_ & x09);
  assign new_n47_ = ~x10 & x11 & x12 & (~x02 | ~x03 | ~x04);
  assign z11 = x00 & ~x10 & ~new_n49_ & x11;
  assign new_n49_ = (x04 | (x01 ? (~x09 | ~x12) : x12)) & (~x01 | ~x09 | ~x12 | (x02 & x03));
