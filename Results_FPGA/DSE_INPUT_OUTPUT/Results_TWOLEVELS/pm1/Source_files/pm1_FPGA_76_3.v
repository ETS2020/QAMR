...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n36_, new_n38_, new_n44_, new_n45_, new_n46_,
    new_n47_, new_n49_, new_n51_;
  assign z00 = x01 ? ~x12 : (x11 ? ~new_n32_ : x12);
  assign new_n32_ = x05 & x06 & x07 & x08 & (~x05 | ~x06 | ~x07 | ~x08);
  assign z01 = x01 | (~x12 & (~x00 | x10 | (x00 & ~x10 & ~x11))) | (~x01 & ~new_n32_ & x11);
  assign z02 = new_n36_ | (x12 & (x01 | (~x01 & ~x11))) | (~x01 & (~x09 | (~new_n35_ & x11)));
  assign new_n35_ = x05 & x06 & x07 & x08;
  assign new_n36_ = ~x12 & ((x00 & ~x10 & (~x11 | (~x01 & x11))) | ~x00 | x01 | x10);
  assign z03 = new_n36_ | (~x01 & (~new_n38_ | ~x09));
  ...
  assign new_n49_ = x09 & (~x09 | (x02 & x03 & x04 & (~x03 | ~x04 | x01 | ~x02)));
  assign z10 = x12 & (x01 | (new_n51_ & x00));
