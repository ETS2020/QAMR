...
module FAU ( 
  ...
  assign new_n34_ = x02 & x11 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08));
  assign z02 = (x12 & (~x02 | (x02 & ~x11))) | ~x12 | (x02 & (~x09 | (~new_n36_ & x11)));
  assign new_n36_ = x05 & x06 & x07 & x08;
  assign z03 = ~x12 | (x02 & (~new_n38_ | ~x09));
  ...
  assign z08 = (x00 & ~new_n45_ & ~x10) | ~x00 | x10 | (x12 & (~x02 | (x02 & ~x11)));
  assign new_n45_ = (~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (~x02 & x12) | (x00 & ~x10 & (x11 ? (~new_n47_ & x12) : ~x12));
  assign new_n47_ = x09 & (~x09 | ((~x03 | ~x04) & (~x02 | (x03 & x04))));
  assign z10 = x00 & new_n49_ & x02;
  assign new_n49_ = x09 & ~x10 & x11 & (~x03 | ~x04) & x12;
