// Benchmark "FAU" written by ABC on Mon Aug 24 16:54:02 2020
...
module FAU ( 
  ...
  assign z01 = (~x12 & (~x00 | x10 | x11 | (x00 & ~x10 & ~x11))) | (x11 & ~new_n32_ & x15) | (x12 & ~x15);
  ...
  assign new_n46_ = x09 & x11 & x12 & x15;
  assign new_n47_ = ((x00 & ~x10) | (x12 & ~x15)) & (x11 | ~x12 | ~x15);
  ...
  assign new_n51_ = x11 & x12 & x15 & (~x02 | ~x03 | ~x04);
