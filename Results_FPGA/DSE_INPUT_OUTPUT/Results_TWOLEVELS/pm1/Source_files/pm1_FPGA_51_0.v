...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n40_, new_n43_, new_n44_, new_n46_, new_n49_;
  assign z00 = ~x11 | (x11 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08)));
  assign z01 = x11 ? (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08)) : ~x12;
  ...
  assign z06 = (~x11 & (~x12 | (x01 & x09))) | (x01 & ~new_n40_ & x09);
  ...
  assign z09 = (~x11 & ~x12) | (x00 & ~x10 & x11 & ~new_n46_ & x12);
  assign new_n46_ = x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = (~x11 & ~x12) | (x00 & x09 & ~x10 & x11 & ~new_n40_ & x12);
