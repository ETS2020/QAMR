...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n41_, new_n44_, new_n46_, new_n48_, new_n50_;
  ...
  assign z03 = (x09 & ((~x11 & x12) | (new_n35_ & x07 & x08 & x11))) | ~x12 | (~x09 & x12);
  assign z04 = ~z12 & ~x14;
  assign z12 = ~x09 & x12;
  assign z05 = ~z12 & ~x13;
  ...
  assign z07 = z12 | ~x15;
  assign z08 = (x00 & ~new_n44_ & ~x10) | (x12 & (~x09 | (x09 & ~x11))) | ~x00 | x10;
  assign new_n44_ = (~x02 | ~x03 | ~x04 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (~x09 & x12) | (x00 & ~x10 & (x11 ? (~new_n46_ & x12) : ~x12));
  assign new_n46_ = x02 & x03 & x04 & (~x02 | ~x03 | ~x04);
  assign z10 = x12 & (new_n48_ | ~x09);
  assign new_n48_ = x00 & ~x10 & x11 & (~x02 | ~x03 | ~x04);
  assign z11 = z12 | (x00 & new_n50_ & ~x10);
