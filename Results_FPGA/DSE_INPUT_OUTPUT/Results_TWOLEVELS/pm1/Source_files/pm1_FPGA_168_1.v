...
module FAU ( 
  ...
  wire new_n32_, new_n35_, new_n40_, new_n43_, new_n47_;
  ...
  assign z06 = (x01 & ~new_n40_ & x09) | (x12 & (~x09 | (x01 & ~x11)));
  ...
  assign z09 = (~x09 & x12) | (x00 & ~x10 & (x11 ? (x12 & (new_n40_ | (~new_n40_ & x09))) : ~x12));
