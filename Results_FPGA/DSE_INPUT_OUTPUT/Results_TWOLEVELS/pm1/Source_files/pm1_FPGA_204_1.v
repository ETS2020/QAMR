...
module FAU ( 
  ...
  wire new_n33_, new_n35_, new_n37_, new_n41_, new_n44_, new_n46_, new_n49_;
  assign z00 = x11 | x01 | (~x11 & x12);
  assign z01 = new_n33_ | ~x12;
  assign new_n33_ = x09 & x11 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08));
  assign z02 = (x12 & (~x09 | ~x11)) | ~x12 | (x09 & ~new_n35_ & x11);
  assign new_n35_ = x05 & x06 & x07 & x08;
  assign z03 = (x12 & (~x09 | ~x11)) | ~x12 | (new_n37_ & x08 & x09 & x11);
  ...
  assign z08 = (x00 & ~x10 & ((new_n44_ & x09 & x11 & x12) | (~x11 & ~x12))) | (x12 & (~x09 | ~x11)) | ~x00 | x10;
