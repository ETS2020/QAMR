...
module FAU ( 
  ...
  assign z01 = (~x09 & ~x12) | (x11 & ~new_n32_ & x12);
  assign z02 = (~x09 & (x11 | ~x12)) | (x12 & (~x11 | (x11 & (~new_n35_ | ~x07 | ~x08)))) | (x09 & ~x12);
  ...
  assign z08 = (x00 & ~x10 & (new_n43_ | (~x11 & ~x12))) | x10 | (~x11 & x12) | ~x00 | (x09 & ~x12);
