...
module FAU ( 
  ...
  assign z01 = new_n33_ | ~x12 | (~x02 & x12);
  assign new_n33_ = x11 & (~x05 | ~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08));
  assign z02 = (~new_n35_ & x11) | ~x09 | ~x11 | (~x02 & x12);
  assign new_n35_ = x05 & x06 & x07 & x08 & x12;
  assign z03 = ~x09 | ~x11 | (~x02 & x12) | (x11 & (new_n37_ | ~x12));
  assign new_n37_ = x05 & x06 & x07 & x08;
  assign z04 = ~x14 | (~x02 & x12);
  assign z05 = ~x13 | (~x02 & x12);
  assign z06 = (~x02 & ((x01 & x09) | x12)) | (x01 & ~new_n41_ & x09);
  assign new_n41_ = x03 & x04 & (x11 | ~x12);
  assign z07 = ~x15 | (~x02 & x12);
  assign z08 = (x12 & (new_n44_ | ~x02)) | ~x00 | x10 | ~x11;
  assign new_n44_ = x00 & x03 & x04 & x09 & ~x10 & x11;
  assign z09 = (~x02 & x12) | (x00 & ~x10 & (x11 ? (~new_n46_ & x12) : ~x12));
  assign new_n46_ = (~x02 | (x09 & (~x09 | (x03 & x04)))) & (~x03 | ~x04 | ~x09);
