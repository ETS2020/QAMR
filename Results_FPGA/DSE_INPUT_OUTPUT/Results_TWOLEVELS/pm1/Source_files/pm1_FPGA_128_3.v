...
module FAU ( 
  ...
  assign z01 = (x11 & ~x14 & (~new_n33_ | ~x07 | ~x08 | (new_n33_ & x07 & x08))) | ~x12 | (x12 & x14);
  assign new_n33_ = x05 & x06;
  assign z02 = ~x12 | (~new_n35_ & ~x14);
  assign new_n35_ = x09 & x11 & (~x11 | (x05 & x06 & x07 & x08));
  assign z03 = (~new_n37_ & ~x14) | ~x12 | (x12 & x14);
  ...
  assign z08 = (x00 & ~new_n44_ & ~x10) | ~x00 | x10 | (x12 & x14) | (~x11 & ~x14);
  assign new_n44_ = (~x02 | ~x03 | ~x04 | ~x09 | ~x11 | ~x12) & (x11 | x12);
  assign z09 = (x12 & x14) | (x00 & ~x10 & (x11 ? (~new_n46_ & x12) : ~x12));
  assign new_n46_ = x09 & (~x09 | ((~x02 | ~x03 | ~x04) & (x14 | (x02 & x03 & x04))));
  assign z10 = x00 & x09 & new_n48_ & ~x10;
  assign new_n48_ = x11 & x12 & ~x14 & (~x02 | ~x03 | ~x04);
