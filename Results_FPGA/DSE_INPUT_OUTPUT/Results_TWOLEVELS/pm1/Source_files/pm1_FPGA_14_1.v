// Benchmark "FAU" written by ABC on Mon Aug 24 16:53:30 2020
...
module FAU ( 
  ...
  wire new_n32_, new_n39_, new_n43_, new_n46_;
  ...
  assign z03 = (x11 & (~x09 | (new_n32_ & x07 & x08))) | ~x12 | (~x11 & x12);
  ...
  assign z09 = x00 & ~new_n43_ & ~x10;
  assign new_n43_ = x11 ? (~x12 | (x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04))))) : x12;
  assign z10 = x00 & x09 & ~x10 & x11 & ~new_n39_ & x12;
  assign z11 = (~x11 & x12) | (x00 & ~x10 & (x01 ? new_n46_ : (x11 & ~x12)));
  assign new_n46_ = x09 & x12 & (~x02 | ~x03 | ~x04);
  assign z12 = x12 & (~x11 | (x00 & ~x09 & ~x10 & x11));
endmodule
