...
module FAU ( 
  ...
  wire new_n32_, new_n33_, new_n37_, new_n41_, new_n44_, new_n46_, new_n48_,
    new_n50_;
  assign z00 = (x05 & (new_n32_ | ~x12)) | (x11 & (~x05 | (~new_n33_ & x12))) | x01 | (~x11 & x12);
  assign new_n32_ = x06 & x07 & x08 & x11 & x12;
  assign new_n33_ = x06 & x07 & x08;
  assign z01 = (~x05 & (x11 | ~x12)) | (x11 & x12 & (~x06 | ~x07 | ~x08 | (x05 & x06 & x07 & x08)));
  assign z02 = (~x05 & (x11 | ~x12)) | (x12 & (~x09 | ~x11 | (~new_n33_ & x11)));
  assign z03 = x12 ? ~new_n37_ : ~x05;
  assign new_n37_ = x09 & x11 & (~x05 | ~x06 | ~x07 | ~x08 | ~x11);
  assign z04 = ~x14 | (x05 & ~x12);
  assign z05 = ~x13 | (x05 & ~x12);
  assign z06 = (new_n41_ & x01) | (x05 & ~x12);
