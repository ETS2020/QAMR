...
module FAU ( 
  ...
  assign z01 = x21 ? x19 : (~x19 | (~x17 & (x02 | x18) & (~x18 | ~x22)));
  assign z02 = new_n57_ | (x19 & x21) | (~x19 & ~x22);
  ...
  assign z06 = new_n63_ | (x19 & x21) | (~x19 & ~x26);
  assign new_n63_ = (~x18 | ~x27) & (x05 | x18) & ~x17 & x19;
  assign z07 = (~x19 & ~x27) | (new_n59_ & (~x18 | ~x20) & (x04 | x18));
  assign z08 = new_n66_ | (x19 & x21) | (~x19 & ~x28);
  ...
  assign z11 = new_n70_ | (x19 & x21) | (~x19 & ~x31);
  assign new_n70_ = (~x18 | ~x24) & (x08 | x18) & ~x17 & x19;
  assign z12 = new_n72_ | (x19 & x21) | (~x19 & ~x32);
  ...
  assign z15 = (~x19 & ~x35) | (new_n59_ & (~x18 | ~x28) & (x12 | x18));
endmodule
