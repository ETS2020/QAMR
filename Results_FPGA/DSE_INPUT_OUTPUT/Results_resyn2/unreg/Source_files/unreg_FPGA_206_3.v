...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n58_, new_n61_, new_n67_, new_n70_, new_n73_, new_n75_,
    new_n77_;
  ...
  assign new_n67_ = ~x05 & ((x18 & x30) | x17 | (~x10 & ~x18));
  assign z10 = (~x19 & ~x30) | (new_n55_ & (x09 | x18) & (~x18 | ~x31));
  assign z11 = x19 ? ~new_n70_ : ~x31;
  assign new_n70_ = ~x05 & ((x18 & x24) | x17 | (~x08 & ~x18));
  ...
  assign new_n77_ = ~x05 & ((x18 & x28) | x17 | (~x12 & ~x18));
endmodule
