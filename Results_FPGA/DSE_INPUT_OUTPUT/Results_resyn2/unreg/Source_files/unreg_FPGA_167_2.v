...
module FAU ( 
  ...
  assign new_n62_ = ~x07 & x23;
  assign z04 = (~x19 | (~x17 & (~x18 | ~x25))) & ((x18 & x19) | x07 | (~x19 & ~x24));
  assign z05 = (~new_n65_ & ~x19) | ((~x18 | ~x26) & ~x17 & x19 & (x06 | x18));
  assign new_n65_ = ~x07 & x25;
