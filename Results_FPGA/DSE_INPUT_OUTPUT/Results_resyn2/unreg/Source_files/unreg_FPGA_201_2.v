...
module FAU ( 
  ...
  assign z03 = new_n61_ | (x18 & ~x24) | (~x19 & ~x23);
  assign new_n61_ = (x16 | ~x18) & ~x17 & x19 & (x00 | x18);
  assign z04 = (~x24 & (x18 | ~x19)) | (~x17 & x19 & (x07 | x18) & (~x18 | ~x25));
  ...
  assign z07 = new_n68_ | (x18 & ~x24) | (~x19 & ~x27);
  assign new_n68_ = (~x18 | ~x20) & ~x17 & x19 & (x04 | x18);
  assign z08 = new_n70_ | (x18 & ~x24) | (~x19 & ~x28);
  assign new_n70_ = (~x18 | ~x29) & ~x17 & x19 & (x11 | x18);
  assign z09 = (~new_n72_ & ~x17 & x19) | ((~x18 | x24) & ~x19 & ~x29);
  assign new_n72_ = (~x10 | x18) & (x30 | ~x18 | ~x24);
  assign z10 = (~new_n74_ & ~x17 & x19) | ((~x18 | x24) & ~x19 & ~x30);
  assign new_n74_ = (~x09 | x18) & (x31 | ~x18 | ~x24);
  assign z11 = (x08 & ~x17 & ~x18 & x19) | (x18 & ~x24) | (~x19 & ~x31);
  assign z12 = (~new_n77_ & ~x17 & x19) | ((~x18 | x24) & ~x19 & ~x32);
  assign new_n77_ = (~x15 | x18) & (x33 | ~x18 | ~x24);
  assign z13 = (~new_n79_ & ~x17 & x19) | ((~x18 | x24) & ~x19 & ~x33);
  assign new_n79_ = (~x14 | x18) & (x34 | ~x18 | ~x24);
