...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n59_, new_n62_, new_n65_, new_n70_, new_n72_,
    new_n75_, new_n77_, new_n79_;
  assign z00 = (~x19 & ~x20) | (new_n55_ & (x03 | x18) & (~x18 | ~x21));
  assign new_n55_ = x19 & ~x06 & ~x17;
  assign z01 = x19 ? ~new_n57_ : ~x21;
  assign new_n57_ = ~x06 & ((x18 & x22) | x17 | (~x02 & ~x18));
  assign z02 = x19 ? ~new_n59_ : ~x22;
  assign new_n59_ = ~x06 & ((x18 & x23) | x17 | (~x01 & ~x18));
  assign z03 = (~x19 & ~x23) | (new_n55_ & (x00 | x18) & (x16 | ~x18));
  assign z04 = x19 ? ~new_n62_ : ~x24;
  assign new_n62_ = ~x06 & ((x18 & x25) | x17 | (~x07 & ~x18));
  assign z05 = x19 ? (x06 | (~x26 & ~x17 & x18)) : ~x25;
  assign z06 = x19 ? ~new_n65_ : ~x26;
  assign new_n65_ = ~x06 & ((x18 & x27) | x17 | (~x05 & ~x18));
  ...
  assign new_n70_ = ~x06 & ((x18 & x31) | x17 | (~x09 & ~x18));
  assign z11 = x19 ? ~new_n72_ : ~x31;
  assign new_n72_ = ~x06 & ((x18 & x24) | x17 | (~x08 & ~x18));
  assign z12 = (~x19 & ~x32) | (new_n55_ & (x15 | x18) & (~x18 | ~x33));
  assign z13 = x19 ? ~new_n75_ : ~x33;
  assign new_n75_ = ~x06 & ((x18 & x34) | x17 | (~x14 & ~x18));
  assign z14 = x19 ? ~new_n77_ : ~x34;
  assign new_n77_ = ~x06 & ((x18 & x35) | x17 | (~x13 & ~x18));
  assign z15 = x19 ? ~new_n79_ : ~x35;
  assign new_n79_ = ~x06 & ((x18 & x28) | x17 | (~x12 & ~x18));
endmodule
