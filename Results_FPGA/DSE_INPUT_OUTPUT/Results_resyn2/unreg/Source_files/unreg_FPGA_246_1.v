...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n56_, new_n63_, new_n65_, new_n70_, new_n74_;
  ...
  assign z06 = (~new_n63_ & ~x19) | ((~x18 | ~x27) & ~x17 & x19 & (x05 | x18));
  assign new_n63_ = x26 & ~x33;
  assign z07 = (~new_n65_ & ~x19) | ((~x18 | ~x20) & ~x17 & x19 & (x04 | x18));
  assign new_n65_ = x27 & ~x33;
  ...
  assign z13 = new_n55_ | (new_n56_ & (x14 | x18) & (~x18 | ~x34));
  assign z14 = (~new_n74_ & ~x19) | ((~x18 | ~x35) & ~x17 & x19 & (x13 | x18));
  assign new_n74_ = ~x33 & x34;
