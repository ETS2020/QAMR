// Benchmark "FAU" written by ABC on Thu Aug 13 17:28:19 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n63_, new_n70_, new_n72_,
    new_n74_, new_n76_, new_n78_, new_n80_;
  assign z00 = x19 ? ~new_n55_ : ~x20;
  assign new_n55_ = ~x05 & ((x18 & x21) | x17 | (~x03 & ~x18));
  assign z01 = x19 ? ~new_n57_ : ~x21;
  assign new_n57_ = ~x05 & ((x18 & x22) | x17 | (~x02 & ~x18));
  assign z02 = (~x19 & ~x22) | (new_n59_ & (x01 | x18) & (~x18 | ~x23));
  assign new_n59_ = x19 & ~x05 & ~x17;
  assign z03 = x19 ? ~new_n61_ : ~x23;
  assign new_n61_ = ~x05 & ((~x16 & x18) | x17 | (~x00 & ~x18));
  assign z04 = x19 ? ~new_n63_ : ~x24;
  assign new_n63_ = ~x05 & ((x18 & x25) | x17 | (~x07 & ~x18));
  assign z05 = (~x19 & ~x25) | (new_n59_ & (x06 | x18) & (~x18 | ~x26));
  assign z06 = x19 ? (x05 | (~x27 & ~x17 & x18)) : ~x26;
  ...
  assign new_n72_ = ~x05 & ((x18 & x24) | x17 | (~x08 & ~x18));
  assign z12 = x19 ? ~new_n74_ : ~x32;
  assign new_n74_ = ~x05 & ((x18 & x33) | x17 | (~x15 & ~x18));
  assign z13 = x19 ? ~new_n76_ : ~x33;
  assign new_n76_ = ~x05 & ((x18 & x34) | x17 | (~x14 & ~x18));
  assign z14 = x19 ? ~new_n78_ : ~x34;
  assign new_n78_ = ~x05 & ((x18 & x35) | x17 | (~x13 & ~x18));
  assign z15 = x19 ? ~new_n80_ : ~x35;
  assign new_n80_ = ~x05 & ((x18 & x28) | x17 | (~x12 & ~x18));
endmodule
