...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n60_, new_n63_, new_n69_, new_n74_;
  ...
  assign new_n60_ = x14 & ((x18 & x25) | x17 | (~x07 & ~x18));
  assign z05 = (~x19 & ~x25) | (new_n55_ & (x06 | x18) & (~x18 | ~x26));
  assign z06 = x19 ? ~new_n63_ : ~x26;
  assign new_n63_ = x14 & ((x18 & x27) | x17 | (~x05 & ~x18));
  ...
  assign new_n69_ = x14 & ((x18 & x24) | x17 | (~x08 & ~x18));
  ...
  assign z15 = x19 ? ~new_n74_ : ~x35;
  assign new_n74_ = x14 & ((x18 & x28) | x17 | (~x12 & ~x18));
endmodule
