...
module FAU ( 
  ...
  assign new_n75_ = x10 & ((x18 & x34) | x17 | (~x14 & ~x18));
  assign z14 = (~x19 & ~x34) | (new_n57_ & (x13 | x18) & (~x18 | ~x35));
  assign z15 = x19 ? ~new_n78_ : ~x35;
  assign new_n78_ = x10 & ((x18 & x28) | x17 | (~x12 & ~x18));
endmodule
