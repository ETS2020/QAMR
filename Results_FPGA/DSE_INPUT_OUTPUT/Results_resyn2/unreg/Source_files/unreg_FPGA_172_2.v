...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n63_, new_n65_, new_n67_,
    new_n69_, new_n72_, new_n79_;
  assign z00 = x19 ? ~new_n55_ : ~x20;
  assign new_n55_ = x31 & ((x18 & x21) | x17 | (~x03 & ~x18));
  assign z01 = (~x19 & ~x21) | (new_n57_ & (x02 | x18) & (~x18 | ~x22));
  assign new_n57_ = x31 & ~x17 & x19;
  assign z02 = x19 ? ~new_n59_ : ~x22;
  assign new_n59_ = x31 & ((x18 & x23) | x17 | (~x01 & ~x18));
  assign z03 = x19 ? ~new_n61_ : ~x23;
  assign new_n61_ = x31 & ((~x16 & x18) | x17 | (~x00 & ~x18));
  assign z04 = x19 ? ~new_n63_ : ~x24;
  assign new_n63_ = x31 & ((x18 & x25) | x17 | (~x07 & ~x18));
  assign z05 = x19 ? ~new_n65_ : ~x25;
  assign new_n65_ = x31 & ((x18 & x26) | x17 | (~x06 & ~x18));
  assign z06 = x19 ? ~new_n67_ : ~x26;
  assign new_n67_ = x31 & ((x18 & x27) | x17 | (~x05 & ~x18));
  assign z07 = x19 ? ~new_n69_ : ~x27;
  assign new_n69_ = x31 & ((x18 & x20) | x17 | (~x04 & ~x18));
  assign z08 = (~x19 & ~x28) | (new_n57_ & (x11 | x18) & (~x18 | ~x29));
  assign z09 = x19 ? ~new_n72_ : ~x29;
  assign new_n72_ = x31 & ((x18 & x30) | x17 | (~x10 & ~x18));
  assign z10 = (~x19 & ~x30) | (new_n57_ & x09 & ~x18);
  ...
  assign new_n79_ = x31 & ((x18 & x28) | x17 | (~x12 & ~x18));
endmodule
