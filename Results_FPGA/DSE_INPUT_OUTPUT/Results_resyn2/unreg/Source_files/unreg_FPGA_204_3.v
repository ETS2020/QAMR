...
module FAU ( 
  ...
  assign new_n74_ = ~x28 & (x17 | (~x14 & ~x18) | (x18 & x34));
  assign z14 = (~x19 & ~x34) | (new_n55_ & (x13 | x18) & (~x18 | ~x35));
  assign z15 = (x19 | ~x35) & ((~x17 & (x12 | x18)) | ~x19 | x28);
endmodule
