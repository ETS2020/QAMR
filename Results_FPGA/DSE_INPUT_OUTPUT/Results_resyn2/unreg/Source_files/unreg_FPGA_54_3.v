...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n61_, new_n70_, new_n72_, new_n74_;
  ...
  assign new_n61_ = ~x12 & ((x18 & x25) | x17 | (~x07 & ~x18));
  ...
  assign z12 = x19 ? ~new_n70_ : ~x32;
  assign new_n70_ = ~x12 & ((x18 & x33) | x17 | (~x15 & ~x18));
  assign z13 = x19 ? ~new_n72_ : ~x33;
  assign new_n72_ = ~x12 & ((x18 & x34) | x17 | (~x14 & ~x18));
  assign z14 = x19 ? ~new_n74_ : ~x34;
  assign new_n74_ = ~x12 & ((x18 & x35) | x17 | (~x13 & ~x18));
