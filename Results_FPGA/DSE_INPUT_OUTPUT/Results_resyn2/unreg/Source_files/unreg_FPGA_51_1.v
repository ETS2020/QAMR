...
module FAU ( 
  ...
  assign z04 = new_n63_ | (~x19 & ~x24) | (~x08 & x18);
  assign new_n63_ = (~x18 | ~x25) & ~x17 & x19 & (x07 | x18);
  assign z05 = new_n65_ | (~x19 & ~x25) | (~x08 & x18);
  assign new_n65_ = (~x18 | ~x26) & ~x17 & x19 & (x06 | x18);
  assign z06 = new_n67_ | (~x19 & ~x26) | (~x08 & x18);
  ...
  assign z10 = new_n75_ | (~x19 & ~x30) | (~x08 & x18);
  assign new_n75_ = (~x18 | ~x31) & ~x17 & x19 & (x09 | x18);
  assign z11 = (~x19 & ~x31 & (x08 | ~x18)) | ((~x18 | ~x24) & x08 & ~x17 & x19);
  ...
  assign z14 = new_n82_ | (~x19 & ~x34) | (~x08 & x18);
  assign new_n82_ = (~x18 | ~x35) & ~x17 & x19 & (x13 | x18);
  assign z15 = new_n84_ | (~x19 & ~x35) | (~x08 & x18);
