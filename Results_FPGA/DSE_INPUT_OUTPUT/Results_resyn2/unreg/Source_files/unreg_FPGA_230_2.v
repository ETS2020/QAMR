...
module FAU ( 
  ...
  assign new_n59_ = x24 & ((x18 & x23) | x17 | (~x01 & ~x18));
  assign z03 = x19 ? ~new_n61_ : ~x23;
  assign new_n61_ = x24 & ((~x16 & x18) | x17 | (~x00 & ~x18));
  assign z04 = ~x24 | ((x07 | x18) & (~x18 | ~x25) & ~x17 & x19);
