...
module FAU ( 
  ...
  assign new_n65_ = ~x21 & (x17 | (~x05 & ~x18) | (x18 & x27));
  ...
  assign new_n71_ = ~x21 & (x17 | (~x09 & ~x18) | (x18 & x31));
  assign z11 = (~x19 & ~x31) | (new_n57_ & (x08 | x18) & (~x18 | ~x24));
  assign z12 = x19 ? ~new_n74_ : ~x32;
  assign new_n74_ = ~x21 & (x17 | (~x15 & ~x18) | (x18 & x33));
  assign z13 = x19 ? ~new_n76_ : ~x33;
  assign new_n76_ = ~x21 & (x17 | (~x14 & ~x18) | (x18 & x34));
  assign z14 = x19 ? ~new_n78_ : ~x34;
  assign new_n78_ = ~x21 & (x17 | (~x13 & ~x18) | (x18 & x35));
  assign z15 = x19 ? ~new_n80_ : ~x35;
  assign new_n80_ = ~x21 & (x17 | (~x12 & ~x18) | (x18 & x28));
endmodule
