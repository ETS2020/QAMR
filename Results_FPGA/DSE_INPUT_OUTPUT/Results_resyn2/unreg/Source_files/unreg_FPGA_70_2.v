...
module FAU ( 
  ...
  assign new_n66_ = x26 & (x17 | (~x11 & ~x18) | (x18 & x29));
  ...
  assign new_n71_ = x26 & (x17 | (~x15 & ~x18) | (x18 & x33));
  assign z13 = (~x19 & ~x33) | (new_n59_ & (x14 | x18) & (~x18 | ~x34));
  assign z14 = x19 ? ~new_n74_ : ~x34;
  assign new_n74_ = x26 & (x17 | (~x13 & ~x18) | (x18 & x35));
