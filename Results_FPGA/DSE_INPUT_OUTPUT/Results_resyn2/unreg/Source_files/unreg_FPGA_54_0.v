...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n58_, new_n62_, new_n71_, new_n73_, new_n75_;
  ...
  assign new_n71_ = x12 & x32;
  assign z13 = (~new_n73_ & ~x19) | ((~x18 | ~x34) & ~x17 & x19 & (x14 | x18));
  assign new_n73_ = x12 & x33;
  assign z14 = (~new_n75_ & ~x19) | ((~x18 | ~x35) & ~x17 & x19 & (x13 | x18));
  assign new_n75_ = x12 & x34;
  assign z15 = (x12 & ((~x18 & ~x17 & x19) | (~x19 & ~x35))) | (~x17 & x19 & x18 & ~x28);
endmodule
