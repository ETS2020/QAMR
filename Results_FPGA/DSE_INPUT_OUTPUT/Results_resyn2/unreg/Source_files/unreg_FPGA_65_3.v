...
module FAU ( 
  ...
  assign z11 = new_n72_ | (~x19 & ~x31) | (x19 & x26);
  assign new_n72_ = (~x18 | ~x24) & (x08 | x18) & ~x17 & x19;
  assign z12 = new_n74_ | (~x19 & ~x32) | (x19 & x26);
  assign new_n74_ = (~x18 | ~x33) & (x15 | x18) & ~x17 & x19;
  assign z13 = new_n76_ | (~x19 & ~x33) | (x19 & x26);
  assign new_n76_ = (~x18 | ~x34) & (x14 | x18) & ~x17 & x19;
  assign z14 = new_n78_ | (~x19 & ~x34) | (x19 & x26);
  assign new_n78_ = (~x18 | ~x35) & (x13 | x18) & ~x17 & x19;
