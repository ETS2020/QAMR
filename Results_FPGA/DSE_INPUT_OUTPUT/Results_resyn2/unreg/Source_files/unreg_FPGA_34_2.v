...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n59_, new_n65_, new_n67_, new_n75_;
  assign z00 = x19 ? ~new_n55_ : ~x20;
  assign new_n55_ = x25 & ((x18 & x21) | x17 | (~x03 & ~x18));
  assign z01 = (~x19 & ~x21) | (new_n57_ & (x02 | x18) & (~x18 | ~x22));
  assign new_n57_ = x25 & ~x17 & x19;
  assign z02 = x19 ? ~new_n59_ : ~x22;
  assign new_n59_ = x25 & ((x18 & x23) | x17 | (~x01 & ~x18));
  assign z03 = (~x19 & ~x23) | (new_n57_ & (x00 | x18) & (x16 | ~x18));
  assign z04 = (~x19 & ~x24) | (new_n57_ & x07 & ~x18);
  assign z05 = ~x25 | ((~x18 | ~x26) & (x06 | x18) & ~x17 & x19);
  assign z06 = (~x19 & ~x26) | (new_n57_ & (x05 | x18) & (~x18 | ~x27));
  assign z07 = x19 ? ~new_n65_ : ~x27;
  assign new_n65_ = x25 & ((x18 & x20) | x17 | (~x04 & ~x18));
  assign z08 = x19 ? ~new_n67_ : ~x28;
  assign new_n67_ = x25 & (x17 | (~x11 & ~x18) | (x18 & x29));
  ...
  assign z15 = x19 ? ~new_n75_ : ~x35;
  assign new_n75_ = x25 & (x17 | (~x12 & ~x18) | (x18 & x28));
endmodule
