...
module FAU ( 
  ...
  assign z02 = new_n59_ | (~x19 & ~x22) | (x19 & x33);
  assign new_n59_ = (~x18 | ~x23) & (x01 | x18) & ~x17 & x19;
  assign z03 = new_n61_ | (~x19 & ~x23) | (x19 & x33);
  ...
  assign z11 = new_n76_ | (~x19 & ~x31) | (x19 & x33);
  assign new_n76_ = (~x18 | ~x24) & (x08 | x18) & ~x17 & x19;
  assign z12 = (~x19 & ~x32) | (new_n63_ & (x15 | x18));
  assign z13 = x33 ? x19 : (~x19 | ((~x18 | ~x34) & ~x17 & (x14 | x18)));
  assign z14 = new_n80_ | (x19 & x33) | (~x19 & ~x34);
  assign new_n80_ = (~x18 | ~x35) & (x13 | x18) & ~x17 & x19;
