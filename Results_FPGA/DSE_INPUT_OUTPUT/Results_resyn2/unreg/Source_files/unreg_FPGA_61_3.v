...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n59_, new_n62_, new_n65_, new_n68_, new_n74_,
    new_n76_, new_n78_;
  assign z00 = new_n55_ | (~x19 & ~x20) | (x19 & x31);
  assign new_n55_ = (~x18 | ~x21) & (x03 | x18) & ~x17 & x19;
  assign z01 = new_n57_ | (~x19 & ~x21) | (x19 & x31);
  ...
  assign z04 = new_n62_ | (~x19 & ~x24) | (x19 & x31);
  ...
  assign z13 = new_n74_ | (~x19 & ~x33) | (x19 & x31);
  assign new_n74_ = (~x18 | ~x34) & (x14 | x18) & ~x17 & x19;
  assign z14 = new_n76_ | (~x19 & ~x34) | (x19 & x31);
  assign new_n76_ = (~x18 | ~x35) & (x13 | x18) & ~x17 & x19;
  assign z15 = new_n78_ | (~x19 & ~x35) | (x19 & x31);
