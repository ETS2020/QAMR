...
module FAU ( 
  ...
  assign z06 = new_n63_ | (~x19 & ~x26) | (x19 & x24);
  assign new_n63_ = (~x18 | ~x27) & ~x17 & x19 & (x05 | x18);
  assign z07 = new_n65_ | (~x19 & ~x27) | (x19 & x24);
  ...
  assign z11 = (~x17 & x19 & (x08 | x18)) | (x19 & x24) | (~x19 & ~x31);
  assign z12 = new_n71_ | (~x19 & ~x32) | (x19 & x24);
  assign new_n71_ = (~x18 | ~x33) & ~x17 & x19 & (x15 | x18);
  assign z13 = new_n73_ | (~x19 & ~x33) | (x19 & x24);
  assign new_n73_ = (~x18 | ~x34) & ~x17 & x19 & (x14 | x18);
  assign z14 = new_n75_ | (~x19 & ~x34) | (x19 & x24);
  assign new_n75_ = (~x18 | ~x35) & ~x17 & x19 & (x13 | x18);
