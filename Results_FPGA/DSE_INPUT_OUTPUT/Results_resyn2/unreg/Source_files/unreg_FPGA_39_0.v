...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n56_, new_n58_, new_n60_, new_n63_, new_n68_, new_n71_, new_n73_,
    new_n75_, new_n77_;
  assign z00 = (~x20 & ~x19 & x21) | ((~x18 | ~x21) & ~x17 & x19 & (x03 | x18));
  assign z01 = (~x18 | ~x22) & new_n56_ & (x02 | x18);
  assign new_n56_ = ~x17 & x19;
  assign z02 = (~new_n58_ & ~x19) | ((~x18 | ~x23) & ~x17 & x19 & (x01 | x18));
  assign new_n58_ = x21 & x22;
  assign z03 = (new_n60_ & ~x23) | ((x16 | ~x18) & new_n56_ & (x00 | x18));
  assign new_n60_ = ~x19 & x21;
  assign z04 = (new_n60_ & ~x24) | ((~x18 | ~x25) & new_n56_ & (x07 | x18));
  assign z05 = (~new_n63_ & ~x19) | ((~x18 | ~x26) & ~x17 & x19 & (x06 | x18));
  assign new_n63_ = x21 & x25;
  assign z06 = (new_n60_ & ~x26) | ((~x18 | ~x27) & new_n56_ & (x05 | x18));
  assign z07 = (new_n60_ & ~x27) | (new_n56_ & (x04 | x18) & (~x18 | ~x20));
  assign z08 = (new_n60_ & ~x28) | ((~x18 | ~x29) & new_n56_ & (x11 | x18));
  assign z09 = (~new_n68_ & ~x19) | ((~x18 | ~x30) & ~x17 & x19 & (x10 | x18));
  assign new_n68_ = x21 & x29;
  assign z10 = (new_n60_ & ~x30) | ((~x18 | ~x31) & new_n56_ & (x09 | x18));
  ...
  assign z15 = (new_n60_ & ~x35) | (new_n56_ & (x12 | x18) & (~x18 | ~x28));
endmodule
