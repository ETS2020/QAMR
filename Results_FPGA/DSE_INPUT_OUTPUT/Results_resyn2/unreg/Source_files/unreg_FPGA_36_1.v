...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n63_, new_n64_, new_n66_,
    new_n71_, new_n73_, new_n75_, new_n77_, new_n80_, new_n82_;
  ...
  assign new_n66_ = x25 & ~x27;
  assign z06 = (~x26 & ~x19 & ~x27) | ((~x18 | ~x27) & ~x17 & x19 & (x05 | x18));
  assign z07 = new_n64_ | (new_n63_ & (x04 | x18) & (~x18 | ~x20));
  assign z08 = (new_n64_ & ~x28) | ((~x18 | ~x29) & new_n63_ & (x11 | x18));
  assign z09 = (~new_n71_ & ~x19) | ((~x18 | ~x30) & ~x17 & x19 & (x10 | x18));
  assign new_n71_ = ~x27 & x29;
  assign z10 = (~new_n73_ & ~x19) | ((~x18 | ~x31) & ~x17 & x19 & (x09 | x18));
  assign new_n73_ = ~x27 & x30;
  assign z11 = (~new_n75_ & ~x19) | ((~x18 | ~x24) & ~x17 & x19 & (x08 | x18));
  assign new_n75_ = ~x27 & x31;
  assign z12 = (~new_n77_ & ~x19) | ((~x18 | ~x33) & ~x17 & x19 & (x15 | x18));
  assign new_n77_ = ~x27 & x32;
  assign z13 = (new_n64_ & ~x33) | ((~x18 | ~x34) & new_n63_ & (x14 | x18));
  assign z14 = (~new_n80_ & ~x19) | ((~x18 | ~x35) & ~x17 & x19 & (x13 | x18));
  assign new_n80_ = ~x27 & x34;
  assign z15 = (~new_n82_ & ~x19) | ((~x18 | ~x28) & ~x17 & x19 & (x12 | x18));
  assign new_n82_ = ~x27 & x35;
endmodule
