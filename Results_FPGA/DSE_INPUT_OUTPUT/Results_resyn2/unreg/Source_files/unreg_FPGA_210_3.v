// Benchmark "FAU" written by ABC on Thu Aug 13 17:28:31 2020
...
module FAU ( 
  ...
  assign new_n59_ = ~x35 & ((x18 & x23) | x17 | (~x01 & ~x18));
  assign z03 = (~x19 & ~x23) | (new_n57_ & (x00 | x18) & (x16 | ~x18));
  assign z04 = (~x19 & ~x24) | (new_n57_ & (x07 | x18) & (~x18 | ~x25));
  assign z05 = x19 ? ~new_n63_ : ~x25;
  assign new_n63_ = ~x35 & ((x18 & x26) | x17 | (~x06 & ~x18));
  assign z06 = x19 ? ~new_n65_ : ~x26;
  assign new_n65_ = ~x35 & ((x18 & x27) | x17 | (~x05 & ~x18));
  assign z07 = x19 ? ~new_n67_ : ~x27;
  assign new_n67_ = ~x35 & ((x18 & x20) | x17 | (~x04 & ~x18));
  assign z08 = x19 ? ~new_n69_ : ~x28;
  assign new_n69_ = ~x35 & ((x18 & x29) | x17 | (~x11 & ~x18));
