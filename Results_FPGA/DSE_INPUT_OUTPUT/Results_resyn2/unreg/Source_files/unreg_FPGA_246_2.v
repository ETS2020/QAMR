...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n62_, new_n64_, new_n69_, new_n73_;
  assign z00 = (~x19 & ~x20) | (new_n55_ & (x03 | x18) & (~x18 | ~x21));
  assign new_n55_ = x33 & ~x17 & x19;
  ...
  assign z06 = x19 ? ~new_n62_ : ~x26;
  assign new_n62_ = x33 & ((x18 & x27) | x17 | (~x05 & ~x18));
  assign z07 = x19 ? ~new_n64_ : ~x27;
  assign new_n64_ = x33 & ((x18 & x20) | x17 | (~x04 & ~x18));
  ...
  assign new_n69_ = x33 & ((x18 & x24) | x17 | (~x08 & ~x18));
  assign z12 = (~x19 & ~x32) | (new_n55_ & x15 & ~x18);
  assign z13 = (~x19 & ~x33) | (x33 & ~x17 & x19 & (~x18 | ~x34) & (x14 | x18));
  assign z14 = x19 ? ~new_n73_ : ~x34;
  assign new_n73_ = x33 & (x17 | (~x13 & ~x18) | (x18 & x35));
