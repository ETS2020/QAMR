...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n59_, new_n61_, new_n65_, new_n67_, new_n72_, new_n74_,
    new_n76_, new_n78_;
  assign z00 = (~x19 & ~x20) | (new_n55_ & (x03 | x18) & (~x18 | ~x21));
  assign new_n55_ = ~x26 & ~x17 & x19;
  assign z01 = (~x19 & ~x21) | (new_n55_ & (x02 | x18) & (~x18 | ~x22));
  assign z02 = (~x19 & ~x22) | (new_n55_ & (x01 | x18) & (~x18 | ~x23));
  assign z03 = x19 ? ~new_n59_ : ~x23;
  assign new_n59_ = ~x26 & ((~x16 & x18) | x17 | (~x00 & ~x18));
  assign z04 = x19 ? ~new_n61_ : ~x24;
  assign new_n61_ = ~x26 & ((x18 & x25) | x17 | (~x07 & ~x18));
  assign z05 = (~x19 & ~x25) | (new_n55_ & (x06 | x18));
  assign z06 = ~x26 & (~x19 | ((~x18 | ~x27) & ~x17 & (x05 | x18)));
  assign z07 = x19 ? ~new_n65_ : ~x27;
  assign new_n65_ = ~x26 & ((x18 & x20) | x17 | (~x04 & ~x18));
  assign z08 = x19 ? ~new_n67_ : ~x28;
  assign new_n67_ = ~x26 & (x17 | (~x11 & ~x18) | (x18 & x29));
  ...
  assign new_n72_ = ~x26 & (x17 | (~x15 & ~x18) | (x18 & x33));
  assign z13 = x19 ? ~new_n74_ : ~x33;
  assign new_n74_ = ~x26 & (x17 | (~x14 & ~x18) | (x18 & x34));
  assign z14 = x19 ? ~new_n76_ : ~x34;
  assign new_n76_ = ~x26 & (x17 | (~x13 & ~x18) | (x18 & x35));
  assign z15 = x19 ? ~new_n78_ : ~x35;
  assign new_n78_ = ~x26 & (x17 | (~x12 & ~x18) | (x18 & x28));
endmodule
