...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n64_, new_n66_, new_n68_,
    ...
    new_n84_;
  assign z00 = new_n55_ | (~x07 & x18) | (~x19 & ~x20);
  assign new_n55_ = (~x18 | ~x21) & ~x17 & x19 & (x03 | x18);
  assign z01 = new_n57_ | (~x18 & ((~x19 & ~x21) | (x02 & ~x17 & x19)));
  assign new_n57_ = x07 & ((~x19 & ~x21) | (x18 & x19 & ~x17 & ~x22));
  assign z02 = new_n59_ | (~x07 & x18) | (~x19 & ~x22);
  assign new_n59_ = (~x18 | ~x23) & ~x17 & x19 & (x01 | x18);
  assign z03 = new_n61_ | (~x18 & ((~x19 & ~x23) | (x00 & ~x17 & x19)));
  assign new_n61_ = x07 & ((~x19 & ~x23) | (~x17 & x19 & x16 & x18));
  assign z04 = (~x19 & ~x24 & (x07 | ~x18)) | ((~x18 | ~x25) & x07 & ~x17 & x19);
  assign z05 = new_n64_ | (~x07 & x18) | (~x19 & ~x25);
  assign new_n64_ = (~x18 | ~x26) & ~x17 & x19 & (x06 | x18);
  assign z06 = new_n66_ | (~x07 & x18) | (~x19 & ~x26);
  assign new_n66_ = (~x18 | ~x27) & ~x17 & x19 & (x05 | x18);
  assign z07 = new_n68_ | (~x18 & ((~x19 & ~x27) | (x04 & ~x17 & x19)));
  assign new_n68_ = x07 & ((~x19 & ~x27) | (x18 & x19 & ~x17 & ~x20));
  assign z08 = new_n70_ | (~x07 & x18) | (~x19 & ~x28);
  assign new_n70_ = (~x18 | ~x29) & ~x17 & x19 & (x11 | x18);
  assign z09 = new_n72_ | (~x07 & x18) | (~x19 & ~x29);
  assign new_n72_ = (~x18 | ~x30) & ~x17 & x19 & (x10 | x18);
  assign z10 = new_n74_ | (~x07 & x18) | (~x19 & ~x30);
  assign new_n74_ = (~x18 | ~x31) & ~x17 & x19 & (x09 | x18);
  assign z11 = new_n76_ | (~x07 & x18) | (~x19 & ~x31);
  assign new_n76_ = (~x18 | ~x24) & ~x17 & x19 & (x08 | x18);
  assign z12 = new_n78_ | (~x18 & ((~x19 & ~x32) | (x15 & ~x17 & x19)));
  assign new_n78_ = x07 & ((~x19 & ~x32) | (x18 & x19 & ~x17 & ~x33));
  assign z13 = new_n80_ | (~x07 & x18) | (~x19 & ~x33);
  assign new_n80_ = (~x18 | ~x34) & ~x17 & x19 & (x14 | x18);
  assign z14 = new_n82_ | (~x07 & x18) | (~x19 & ~x34);
  assign new_n82_ = (~x18 | ~x35) & ~x17 & x19 & (x13 | x18);
  assign z15 = new_n84_ | (~x07 & x18) | (~x19 & ~x35);
