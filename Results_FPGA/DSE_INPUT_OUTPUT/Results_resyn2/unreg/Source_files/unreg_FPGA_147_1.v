...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n60_, new_n62_, new_n72_, new_n75_;
  assign z00 = (new_n55_ & (~x18 | ~x21)) | (~x19 & ~x20);
  assign new_n55_ = x19 & x03 & ~x17;
  assign z01 = x19 ? ~new_n57_ : ~x21;
  assign new_n57_ = x03 & ((x18 & x22) | x17 | (~x02 & ~x18));
  ...
  assign new_n72_ = x03 & ((x18 & x34) | x17 | (~x14 & ~x18));
  assign z14 = (~x19 & ~x34) | (new_n55_ & (x13 | x18) & (~x18 | ~x35));
  assign z15 = x19 ? ~new_n75_ : ~x35;
  assign new_n75_ = x03 & ((x18 & x28) | x17 | (~x12 & ~x18));
endmodule
