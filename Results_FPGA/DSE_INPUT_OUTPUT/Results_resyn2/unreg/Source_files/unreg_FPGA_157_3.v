...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n64_, new_n68_, new_n71_,
    new_n74_;
  assign z00 = (~x19 & ~x20) | (new_n55_ & (x03 | x18) & (~x18 | ~x21));
  assign new_n55_ = x19 & ~x10 & ~x17;
  assign z01 = x19 ? ~new_n57_ : ~x21;
  assign new_n57_ = ~x10 & ((x18 & x22) | x17 | (~x02 & ~x18));
  assign z02 = x19 ? ~new_n59_ : ~x22;
  assign new_n59_ = ~x10 & ((x18 & x23) | x17 | (~x01 & ~x18));
  assign z03 = x19 ? ~new_n61_ : ~x23;
  assign new_n61_ = ~x10 & ((~x16 & x18) | x17 | (~x00 & ~x18));
  assign z04 = (~x19 & ~x24) | (new_n55_ & (x07 | x18) & (~x18 | ~x25));
  assign z05 = x19 ? ~new_n64_ : ~x25;
  assign new_n64_ = ~x10 & ((x18 & x26) | x17 | (~x06 & ~x18));
  assign z06 = (~x19 & ~x26) | (new_n55_ & (x05 | x18) & (~x18 | ~x27));
  assign z07 = (~x19 & ~x27) | (new_n55_ & (x04 | x18) & (~x18 | ~x20));
  assign z08 = x19 ? ~new_n68_ : ~x28;
  assign new_n68_ = ~x10 & ((x18 & x29) | x17 | (~x11 & ~x18));
  assign z09 = x19 ? (x10 | (~x30 & ~x17 & x18)) : ~x29;
  assign z10 = x19 ? ~new_n71_ : ~x30;
  assign new_n71_ = ~x10 & ((x18 & x31) | x17 | (~x09 & ~x18));
