...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n63_, new_n65_, new_n68_,
    ...
    new_n84_;
  assign z00 = new_n55_ | (x18 & ((~x19 & ~x20) | (~x21 & ~x17 & x19)));
  assign new_n55_ = x05 & ((~x19 & ~x20) | (~x17 & x19 & x03 & ~x18));
  ...
  assign new_n61_ = x05 & ((~x19 & ~x23) | (~x17 & x19 & x00 & ~x18));
  ...
  assign z06 = (~x19 | (~x17 & (~x18 | ~x27))) & (x05 | x18) & (x19 | ~x26);
  assign z07 = new_n68_ | (x18 & ((~x19 & ~x27) | (~x20 & ~x17 & x19)));
  assign new_n68_ = x05 & ((~x19 & ~x27) | (~x17 & x19 & x04 & ~x18));
  ...
  assign new_n76_ = x05 & ((~x19 & ~x31) | (~x17 & x19 & x08 & ~x18));
  assign z12 = new_n78_ | (~x19 & ~x32) | (~x05 & ~x18);
  assign new_n78_ = (~x18 | ~x33) & ~x17 & x19 & (x15 | x18);
  assign z13 = new_n80_ | (x18 & ((~x19 & ~x33) | (~x34 & ~x17 & x19)));
  assign new_n80_ = x05 & ((~x19 & ~x33) | (~x17 & x19 & x14 & ~x18));
  assign z14 = new_n82_ | (x18 & ((~x19 & ~x34) | (~x35 & ~x17 & x19)));
  assign new_n82_ = x05 & ((~x19 & ~x34) | (~x17 & x19 & x13 & ~x18));
  assign z15 = new_n84_ | (x18 & ((~x19 & ~x35) | (~x28 & ~x17 & x19)));
  assign new_n84_ = x05 & ((~x19 & ~x35) | (~x17 & x19 & x12 & ~x18));
endmodule
