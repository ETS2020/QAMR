...
module FAU ( 
  ...
  assign new_n57_ = x29 & ((x18 & x22) | x17 | (~x02 & ~x18));
  ...
  assign new_n62_ = x29 & ((x18 & x26) | x17 | (~x06 & ~x18));
  assign z06 = x19 ? ~new_n64_ : ~x26;
  assign new_n64_ = x29 & ((x18 & x27) | x17 | (~x05 & ~x18));
  assign z07 = (~x19 & ~x27) | (new_n55_ & (x04 | x18) & (~x18 | ~x20));
  assign z08 = (~x19 & ~x28) | (new_n55_ & x11 & ~x18);
  assign z09 = ~x29 | ((~x18 | ~x30) & (x10 | x18) & ~x17 & x19);
  assign z10 = (~x19 & ~x30) | (new_n55_ & (x09 | x18) & (~x18 | ~x31));
  assign z11 = x19 ? ~new_n70_ : ~x31;
  assign new_n70_ = x29 & ((x18 & x24) | x17 | (~x08 & ~x18));
  assign z12 = x19 ? ~new_n72_ : ~x32;
  assign new_n72_ = x29 & (x17 | (~x15 & ~x18) | (x18 & x33));
  assign z13 = x19 ? ~new_n74_ : ~x33;
  assign new_n74_ = x29 & (x17 | (~x14 & ~x18) | (x18 & x34));
