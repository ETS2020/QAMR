...
module FAU ( 
  ...
  assign z04 = new_n60_ | (~x19 & ~x24) | (x19 & x21);
  ...
  assign z10 = new_n67_ | (~x19 & ~x30) | (x19 & x21);
  assign new_n67_ = (~x18 | ~x31) & (x09 | x18) & ~x17 & x19;
  assign z11 = new_n69_ | (~x19 & ~x31) | (x19 & x21);
  assign new_n69_ = (~x18 | ~x24) & (x08 | x18) & ~x17 & x19;
  assign z12 = (~x19 & ~x32) | (new_n55_ & (x15 | x18) & (~x18 | ~x33));
  assign z13 = new_n72_ | (~x19 & ~x33) | (x19 & x21);
  assign new_n72_ = (~x18 | ~x34) & (x14 | x18) & ~x17 & x19;
  assign z14 = new_n74_ | (~x19 & ~x34) | (x19 & x21);
  assign new_n74_ = (~x18 | ~x35) & (x13 | x18) & ~x17 & x19;
