// Benchmark "FAU" written by ABC on Thu Aug 13 17:27:57 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n58_, new_n60_, new_n63_, new_n68_, new_n74_;
  ...
  assign new_n68_ = ~x31 & ((x18 & x30) | x17 | (~x10 & ~x18));
  assign z10 = (x19 | ~x30) & ((~x17 & (x09 | x18)) | ~x19 | x31);
  assign z11 = ~x31 & (~x19 | (~x17 & (x08 | x18) & (~x18 | ~x24)));
  assign z12 = (~x19 & ~x32) | (new_n55_ & (x15 | x18) & (~x18 | ~x33));
  assign z13 = (~x19 & ~x33) | (new_n55_ & (x14 | x18) & (~x18 | ~x34));
  assign z14 = x19 ? ~new_n74_ : ~x34;
  assign new_n74_ = ~x31 & (x17 | (~x13 & ~x18) | (x18 & x35));
