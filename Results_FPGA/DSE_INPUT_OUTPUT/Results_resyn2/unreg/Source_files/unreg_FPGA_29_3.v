...
module FAU ( 
  ...
  assign new_n59_ = ~x02 & ((x18 & x23) | x17 | (~x01 & ~x18));
  ...
  assign new_n64_ = ~x02 & ((x18 & x26) | x17 | (~x06 & ~x18));
  assign z06 = x19 ? ~new_n66_ : ~x26;
  assign new_n66_ = ~x02 & ((x18 & x27) | x17 | (~x05 & ~x18));
  assign z07 = x19 ? ~new_n68_ : ~x27;
  assign new_n68_ = ~x02 & ((x18 & x20) | x17 | (~x04 & ~x18));
  assign z08 = x19 ? ~new_n70_ : ~x28;
  assign new_n70_ = ~x02 & ((x18 & x29) | x17 | (~x11 & ~x18));
  assign z09 = x19 ? ~new_n72_ : ~x29;
  assign new_n72_ = ~x02 & ((x18 & x30) | x17 | (~x10 & ~x18));
  assign z10 = x19 ? ~new_n74_ : ~x30;
  assign new_n74_ = ~x02 & ((x18 & x31) | x17 | (~x09 & ~x18));
  assign z11 = (~x19 & ~x31) | (new_n57_ & (x08 | x18) & (~x18 | ~x24));
  assign z12 = x19 ? ~new_n77_ : ~x32;
  assign new_n77_ = ~x02 & ((x18 & x33) | x17 | (~x15 & ~x18));
  assign z13 = x19 ? ~new_n79_ : ~x33;
  assign new_n79_ = ~x02 & ((x18 & x34) | x17 | (~x14 & ~x18));
