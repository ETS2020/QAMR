...
module FAU ( 
  ...
  assign new_n60_ = x21 & ((~x16 & x18) | x17 | (~x00 & ~x18));
  ...
  assign new_n67_ = x21 & ((x18 & x29) | x17 | (~x11 & ~x18));
  ...
  assign new_n73_ = x21 & ((x18 & x33) | x17 | (~x15 & ~x18));
  assign z13 = x19 ? ~new_n75_ : ~x33;
  assign new_n75_ = x21 & ((x18 & x34) | x17 | (~x14 & ~x18));
  assign z14 = (~x19 & ~x34) | (new_n55_ & (~x18 | ~x35) & (x13 | x18));
