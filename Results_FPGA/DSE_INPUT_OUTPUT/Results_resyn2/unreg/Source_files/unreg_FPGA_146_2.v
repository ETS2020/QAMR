...
module FAU ( 
  ...
  assign z00 = ~x20 | ((x03 | x18) & ~x17 & x19 & (~x18 | ~x21));
  ...
  assign new_n60_ = x20 & ((x18 & x25) | x17 | (~x07 & ~x18));
  ...
  assign new_n67_ = x20 & ((x18 & x31) | x17 | (~x09 & ~x18));
  assign z11 = x19 ? ~new_n69_ : ~x31;
  assign new_n69_ = x20 & ((x18 & x24) | x17 | (~x08 & ~x18));
  assign z12 = (~x19 & ~x32) | (new_n56_ & (~x18 | ~x33) & (x15 | x18));
  assign z13 = x19 ? ~new_n72_ : ~x33;
  assign new_n72_ = x20 & ((x18 & x34) | x17 | (~x14 & ~x18));
