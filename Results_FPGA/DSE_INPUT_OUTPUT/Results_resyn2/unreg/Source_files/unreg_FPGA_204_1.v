...
module FAU ( 
  ...
  assign z08 = new_n55_ | (new_n56_ & (x11 | x18) & (~x18 | ~x29));
  assign z09 = (~new_n70_ & ~x19) | ((~x18 | ~x30) & ~x17 & x19 & (x10 | x18));
  assign new_n70_ = ~x28 & x29;
  ...
  assign new_n75_ = ~x28 & x33;
  assign z14 = (new_n55_ & ~x34) | ((~x18 | ~x35) & new_n56_ & (x13 | x18));
  assign z15 = (~x19 & (x28 | ~x35)) | ((~x18 | ~x28) & ~x17 & x19 & (x12 | x18));
endmodule
