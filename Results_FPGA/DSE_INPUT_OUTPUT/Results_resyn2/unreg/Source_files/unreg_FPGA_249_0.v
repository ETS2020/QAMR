...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n59_, new_n63_, new_n65_, new_n67_, new_n69_,
    new_n74_;
  assign z00 = (~x19 & (~x03 | ~x20)) | ((~x18 | ~x21) & ~x17 & x19 & (x03 | x18));
  ...
  assign z04 = (new_n57_ & ~x24) | ((~x18 | ~x25) & new_n56_ & (x07 | x18));
  ...
  assign z10 = (new_n57_ & ~x30) | ((~x18 | ~x31) & new_n56_ & (x09 | x18));
  assign z11 = (new_n57_ & ~x31) | (new_n56_ & (x08 | x18) & (~x18 | ~x24));
