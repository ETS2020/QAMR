...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n60_, new_n62_, new_n65_, new_n67_, new_n69_, new_n71_,
    new_n73_, new_n77_, new_n79_;
  assign z00 = (~x19 & ~x20) | (new_n55_ & x18 & ~x21);
  ...
  assign new_n60_ = ~x03 & ((x18 & x25) | x17 | (~x07 & ~x18));
  ...
  assign new_n65_ = ~x03 & ((x18 & x20) | x17 | (~x04 & ~x18));
  assign z08 = x19 ? ~new_n67_ : ~x28;
  assign new_n67_ = ~x03 & ((x18 & x29) | x17 | (~x11 & ~x18));
  assign z09 = x19 ? ~new_n69_ : ~x29;
  assign new_n69_ = ~x03 & ((x18 & x30) | x17 | (~x10 & ~x18));
  assign z10 = x19 ? ~new_n71_ : ~x30;
  assign new_n71_ = ~x03 & ((x18 & x31) | x17 | (~x09 & ~x18));
  assign z11 = x19 ? ~new_n73_ : ~x31;
  assign new_n73_ = ~x03 & ((x18 & x24) | x17 | (~x08 & ~x18));
  assign z12 = (~x19 & ~x32) | (new_n55_ & (x15 | x18) & (~x18 | ~x33));
  assign z13 = (~x19 & ~x33) | (new_n55_ & (x14 | x18) & (~x18 | ~x34));
  assign z14 = x19 ? ~new_n77_ : ~x34;
  assign new_n77_ = ~x03 & ((x18 & x35) | x17 | (~x13 & ~x18));
  assign z15 = x19 ? ~new_n79_ : ~x35;
  assign new_n79_ = ~x03 & ((x18 & x28) | x17 | (~x12 & ~x18));
endmodule
