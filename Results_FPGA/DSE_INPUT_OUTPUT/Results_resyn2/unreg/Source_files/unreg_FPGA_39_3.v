...
module FAU ( 
  ...
  assign new_n67_ = ~x21 & (x17 | (~x10 & ~x18) | (x18 & x30));
  assign z10 = (~x19 & ~x30) | (new_n55_ & (x09 | x18) & (~x18 | ~x31));
  assign z11 = x19 ? ~new_n70_ : ~x31;
  assign new_n70_ = ~x21 & (x17 | (~x08 & ~x18) | (x18 & x24));
  assign z12 = x19 ? ~new_n72_ : ~x32;
  assign new_n72_ = ~x21 & (x17 | (~x15 & ~x18) | (x18 & x33));
  assign z13 = x19 ? ~new_n74_ : ~x33;
  assign new_n74_ = ~x21 & (x17 | (~x14 & ~x18) | (x18 & x34));
  assign z14 = x19 ? ~new_n76_ : ~x34;
  assign new_n76_ = ~x21 & (x17 | (~x13 & ~x18) | (x18 & x35));
