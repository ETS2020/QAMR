...
module FAU ( 
  ...
  assign new_n63_ = x28 & ((x18 & x27) | x17 | (~x05 & ~x18));
  assign z07 = x19 ? ~new_n65_ : ~x27;
  assign new_n65_ = x28 & ((x18 & x20) | x17 | (~x04 & ~x18));
  assign z08 = ~x28 | ((x11 | x18) & (~x18 | ~x29) & ~x17 & x19);
  assign z09 = x19 ? ~new_n68_ : ~x29;
  assign new_n68_ = x28 & (x17 | (~x10 & ~x18) | (x18 & x30));
  assign z10 = x19 ? ~new_n70_ : ~x30;
  assign new_n70_ = x28 & (x17 | (~x09 & ~x18) | (x18 & x31));
