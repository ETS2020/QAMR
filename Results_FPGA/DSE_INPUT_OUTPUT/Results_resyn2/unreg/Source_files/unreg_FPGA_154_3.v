...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n64_, new_n69_;
  assign z00 = new_n55_ | (~x19 & ~x20) | (x19 & x24);
  assign new_n55_ = (~x18 | ~x21) & (x03 | x18) & ~x17 & x19;
  assign z01 = new_n57_ | (~x19 & ~x21) | (x19 & x24);
  assign new_n57_ = (~x18 | ~x22) & (x02 | x18) & ~x17 & x19;
  assign z02 = new_n59_ | (~x19 & ~x22) | (x19 & x24);
  assign new_n59_ = (~x18 | ~x23) & (x01 | x18) & ~x17 & x19;
  assign z03 = (~x19 & ~x23) | (new_n61_ & (x00 | x18) & (x16 | ~x18));
  assign new_n61_ = ~x24 & ~x17 & x19;
  assign z04 = x24 ? x19 : (~x19 | ((~x18 | ~x25) & ~x17 & (x07 | x18)));
  assign z05 = new_n64_ | (~x19 & ~x25) | (x19 & x24);
  assign new_n64_ = (~x18 | ~x26) & (x06 | x18) & ~x17 & x19;
  assign z06 = (~x19 & ~x26) | (new_n61_ & (x05 | x18) & (~x18 | ~x27));
  assign z07 = (~x19 & ~x27) | (new_n61_ & (x04 | x18) & (~x18 | ~x20));
  assign z08 = (~x19 & ~x28) | (new_n61_ & (x11 | x18) & (~x18 | ~x29));
  assign z09 = new_n69_ | (~x19 & ~x29) | (x19 & x24);
  assign new_n69_ = (~x18 | ~x30) & (x10 | x18) & ~x17 & x19;
  assign z10 = (~x19 & ~x30) | (new_n61_ & (x09 | x18) & (~x18 | ~x31));
  assign z11 = (~x19 & ~x31) | (new_n61_ & (x08 | x18));
  assign z12 = (~x19 & ~x32) | (new_n61_ & (x15 | x18) & (~x18 | ~x33));
  assign z13 = (~x19 & ~x33) | (new_n61_ & (x14 | x18) & (~x18 | ~x34));
  assign z14 = (~x19 & ~x34) | (new_n61_ & (x13 | x18) & (~x18 | ~x35));
