...
module FAU ( 
  ...
  assign z04 = new_n63_ | (x18 & ((~x19 & ~x24) | (~x25 & ~x17 & x19)));
  assign new_n63_ = ~x05 & ((~x19 & ~x24) | (~x17 & x19 & x07 & ~x18));
  assign z05 = new_n65_ | (x18 & ((~x19 & ~x25) | (~x26 & ~x17 & x19)));
  assign new_n65_ = ~x05 & ((~x19 & ~x25) | (~x17 & x19 & x06 & ~x18));
  assign z06 = (~x17 & x19 & x18 & ~x27) | (~x19 & ~x26) | (x05 & ~x18);
  assign z07 = new_n68_ | (x18 & ((~x19 & ~x27) | (~x20 & ~x17 & x19)));
  assign new_n68_ = ~x05 & ((~x19 & ~x27) | (~x17 & x19 & x04 & ~x18));
  assign z08 = new_n70_ | (x18 & ((~x19 & ~x28) | (~x29 & ~x17 & x19)));
  assign new_n70_ = ~x05 & ((~x19 & ~x28) | (~x17 & x19 & x11 & ~x18));
  assign z09 = new_n72_ | (~x19 & ~x29) | (x05 & ~x18);
  assign new_n72_ = (~x18 | ~x30) & ~x17 & x19 & (x10 | x18);
  assign z10 = new_n74_ | (x18 & ((~x19 & ~x30) | (~x31 & ~x17 & x19)));
  assign new_n74_ = ~x05 & ((~x19 & ~x30) | (~x17 & x19 & x09 & ~x18));
