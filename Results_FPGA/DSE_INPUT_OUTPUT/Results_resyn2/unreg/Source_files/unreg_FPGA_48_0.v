...
module FAU ( 
  ...
  assign new_n71_ = x28 & x33;
  assign z09 = (~new_n73_ & ~x19) | ((~x18 | ~x30) & ~x17 & x19 & (x10 | x18));
  assign new_n73_ = x29 & x33;
  assign z10 = (~new_n75_ & ~x19) | ((~x18 | ~x31) & ~x17 & x19 & (x09 | x18));
  assign new_n75_ = x30 & x33;
  assign z11 = (new_n60_ & ~x31) | (new_n59_ & (x08 | x18) & (~x18 | ~x24));
  assign z12 = (~x32 & ~x19 & x33) | ((~x18 | ~x33) & ~x17 & x19 & (x15 | x18));
  assign z13 = ((~x18 | ~x34) & ~x17 & x19 & (x14 | x18)) | (~x19 & ~x33);
