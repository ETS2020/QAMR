...
module FAU ( 
  ...
  assign z05 = (new_n57_ & ~x25) | ((~x18 | ~x26) & new_n56_ & (x06 | x18));
  assign z06 = (new_n57_ & ~x26) | ((~x18 | ~x27) & new_n56_ & (x05 | x18));
  assign z07 = (~x19 | (~x17 & (x04 | x18))) & ((~x18 & x19) | ~x20 | (~x19 & ~x27));
  assign z08 = (new_n57_ & ~x28) | ((~x18 | ~x29) & new_n56_ & (x11 | x18));
  assign z09 = (new_n57_ & ~x29) | ((~x18 | ~x30) & new_n56_ & (x10 | x18));
  ...
  assign z14 = (new_n57_ & ~x34) | ((~x18 | ~x35) & new_n56_ & (x13 | x18));
  assign z15 = (new_n57_ & ~x35) | (new_n56_ & (x12 | x18) & (~x18 | ~x28));
endmodule
