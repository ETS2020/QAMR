...
module FAU ( 
  ...
  assign new_n58_ = x32 & ((x18 & x23) | x17 | (~x01 & ~x18));
  assign z03 = x19 ? ~new_n60_ : ~x23;
  assign new_n60_ = x32 & ((~x16 & x18) | x17 | (~x00 & ~x18));
  ...
  assign new_n72_ = x32 & ((x18 & x24) | x17 | (~x08 & ~x18));
  assign z12 = ~x32 | ((x15 | x18) & (~x18 | ~x33) & ~x17 & x19);
  assign z13 = x19 ? ~new_n75_ : ~x33;
  assign new_n75_ = x32 & (x17 | (~x14 & ~x18) | (x18 & x34));
