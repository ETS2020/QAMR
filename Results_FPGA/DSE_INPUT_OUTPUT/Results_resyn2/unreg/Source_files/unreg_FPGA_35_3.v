...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n59_, new_n61_, new_n65_, new_n67_, new_n71_, new_n73_,
    new_n76_;
  assign z00 = (~x19 & ~x20) | (new_n55_ & (x03 | x18) & (~x18 | ~x21));
  assign new_n55_ = ~x22 & ~x17 & x19;
  assign z01 = (x19 | ~x21) & ((~x17 & (x02 | x18)) | ~x19 | x22);
  assign z02 = x22 ? x19 : (~x19 | ((~x18 | ~x23) & ~x17 & (x01 | x18)));
  assign z03 = new_n59_ | (x19 & x22) | (~x19 & ~x23);
  assign new_n59_ = (x16 | ~x18) & ~x17 & x19 & (x00 | x18);
  assign z04 = new_n61_ | (x19 & x22) | (~x19 & ~x24);
  ...
  assign z07 = new_n65_ | (x19 & x22) | (~x19 & ~x27);
  assign new_n65_ = (~x18 | ~x20) & (x04 | x18) & ~x17 & x19;
  assign z08 = new_n67_ | (x19 & x22) | (~x19 & ~x28);
  ...
  assign z11 = new_n71_ | (x19 & x22) | (~x19 & ~x31);
  assign new_n71_ = (~x18 | ~x24) & (x08 | x18) & ~x17 & x19;
  assign z12 = new_n73_ | (x19 & x22) | (~x19 & ~x32);
