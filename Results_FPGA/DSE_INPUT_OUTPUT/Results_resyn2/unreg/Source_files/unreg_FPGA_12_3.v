...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n58_, new_n64_, new_n66_, new_n72_, new_n74_;
  ...
  assign new_n58_ = ~x09 & ((x18 & x23) | x17 | (~x01 & ~x18));
  ...
  assign new_n64_ = ~x09 & ((x18 & x20) | x17 | (~x04 & ~x18));
  assign z08 = x19 ? ~new_n66_ : ~x28;
  assign new_n66_ = ~x09 & ((x18 & x29) | x17 | (~x11 & ~x18));
  ...
  assign new_n72_ = ~x09 & ((x18 & x34) | x17 | (~x14 & ~x18));
  assign z14 = x19 ? ~new_n74_ : ~x34;
  assign new_n74_ = ~x09 & ((x18 & x35) | x17 | (~x13 & ~x18));
