...
module FAU ( 
  ...
  assign new_n55_ = x22 & ((x18 & x21) | x17 | (~x03 & ~x18));
  assign z01 = x19 ? (~x22 | (~x18 & x02 & ~x17)) : ~x21;
  assign z02 = ~x22 | ((x01 | x18) & ~x17 & x19 & (~x18 | ~x23));
  assign z03 = x19 ? ~new_n59_ : ~x23;
  assign new_n59_ = x22 & ((~x16 & x18) | x17 | (~x00 & ~x18));
  ...
  assign new_n64_ = x22 & (x17 | (~x05 & ~x18) | (x18 & x27));
  assign z07 = x19 ? ~new_n66_ : ~x27;
  assign new_n66_ = x22 & ((x18 & x20) | x17 | (~x04 & ~x18));
  ...
  assign new_n72_ = x22 & (x17 | (~x15 & ~x18) | (x18 & x33));
  assign z13 = x19 ? ~new_n74_ : ~x33;
  assign new_n74_ = x22 & (x17 | (~x14 & ~x18) | (x18 & x34));
  assign z14 = x19 ? ~new_n76_ : ~x34;
  assign new_n76_ = x22 & (x17 | (~x13 & ~x18) | (x18 & x35));
