...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n63_, new_n65_, new_n71_, new_n73_, new_n75_;
  assign z00 = (~x19 & ~x20) | (new_n55_ & (x03 | x18) & (~x18 | ~x21));
  assign new_n55_ = x24 & ~x17 & x19;
  assign z01 = x19 ? ~new_n57_ : ~x21;
  assign new_n57_ = x24 & ((x18 & x22) | x17 | (~x02 & ~x18));
  ...
  assign new_n63_ = x24 & (x17 | (~x05 & ~x18) | (x18 & x27));
  assign z07 = x19 ? ~new_n65_ : ~x27;
  assign new_n65_ = x24 & ((x18 & x20) | x17 | (~x04 & ~x18));
  ...
  assign new_n71_ = x24 & (x17 | (~x15 & ~x18) | (x18 & x33));
  assign z13 = x19 ? ~new_n73_ : ~x33;
  assign new_n73_ = x24 & (x17 | (~x14 & ~x18) | (x18 & x34));
  assign z14 = x19 ? ~new_n75_ : ~x34;
  assign new_n75_ = x24 & (x17 | (~x13 & ~x18) | (x18 & x35));
