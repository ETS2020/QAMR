...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n61_, new_n66_, new_n70_, new_n73_, new_n75_;
  assign z00 = (~x19 & ~x20) | (new_n55_ & (x03 | x18) & (~x18 | ~x21));
  assign new_n55_ = x23 & ~x17 & x19;
  assign z01 = x19 ? ~new_n57_ : ~x21;
  assign new_n57_ = x23 & ((x18 & x22) | x17 | (~x02 & ~x18));
  assign z02 = (~x19 & ~x22) | (new_n55_ & x01 & ~x18);
  assign z03 = (~x19 & ~x23) | (x23 & ~x17 & x19 & (x00 | x18) & (x16 | ~x18));
  assign z04 = x19 ? ~new_n61_ : ~x24;
  assign new_n61_ = x23 & (x17 | (~x07 & ~x18) | (x18 & x25));
