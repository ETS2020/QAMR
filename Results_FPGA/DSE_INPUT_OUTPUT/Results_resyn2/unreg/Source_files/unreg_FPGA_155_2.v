...
module FAU ( 
  ...
  assign new_n71_ = x31 & (x17 | (~x15 & ~x18) | (x18 & x33));
  assign z13 = x19 ? ~new_n73_ : ~x33;
  assign new_n73_ = x31 & (x17 | (~x14 & ~x18) | (x18 & x34));
  assign z14 = (~x19 & ~x34) | (new_n57_ & (x13 | x18) & (~x18 | ~x35));
  assign z15 = x19 ? ~new_n76_ : ~x35;
  assign new_n76_ = x31 & ((x18 & x28) | x17 | (~x12 & ~x18));
endmodule
