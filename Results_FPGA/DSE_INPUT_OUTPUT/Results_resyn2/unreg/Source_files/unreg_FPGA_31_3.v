...
module FAU ( 
  ...
  assign z01 = new_n57_ | (~x19 & ~x21) | (x19 & x34);
  assign new_n57_ = (~x18 | ~x22) & ~x17 & x19 & (x02 | x18);
  assign z02 = new_n59_ | (~x19 & ~x22) | (x19 & x34);
  assign new_n59_ = (~x18 | ~x23) & ~x17 & x19 & (x01 | x18);
  assign z03 = new_n61_ | (~x19 & ~x23) | (x19 & x34);
  assign new_n61_ = (x16 | ~x18) & ~x17 & x19 & (x00 | x18);
  assign z04 = new_n63_ | (~x19 & ~x24) | (x19 & x34);
  ...
  assign z11 = new_n72_ | (~x19 & ~x31) | (x19 & x34);
  assign new_n72_ = (~x18 | ~x24) & ~x17 & x19 & (x08 | x18);
  assign z12 = new_n74_ | (~x19 & ~x32) | (x19 & x34);
