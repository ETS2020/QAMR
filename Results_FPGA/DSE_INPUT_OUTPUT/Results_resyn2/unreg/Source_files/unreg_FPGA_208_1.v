...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n59_, new_n61_, new_n67_, new_n70_, new_n72_, new_n74_,
    new_n76_;
  ...
  assign new_n59_ = x01 & ((~x16 & x18) | x17 | (~x00 & ~x18));
  assign z04 = x19 ? ~new_n61_ : ~x24;
  assign new_n61_ = x01 & ((x18 & x25) | x17 | (~x07 & ~x18));
  ...
  assign new_n67_ = x01 & ((x18 & x30) | x17 | (~x10 & ~x18));
  assign z10 = (~x19 & ~x30) | (new_n55_ & (x09 | x18) & (~x18 | ~x31));
  assign z11 = x19 ? ~new_n70_ : ~x31;
  assign new_n70_ = x01 & ((x18 & x24) | x17 | (~x08 & ~x18));
  assign z12 = x19 ? ~new_n72_ : ~x32;
  assign new_n72_ = x01 & ((x18 & x33) | x17 | (~x15 & ~x18));
  assign z13 = x19 ? ~new_n74_ : ~x33;
  assign new_n74_ = x01 & ((x18 & x34) | x17 | (~x14 & ~x18));
  assign z14 = x19 ? ~new_n76_ : ~x34;
  assign new_n76_ = x01 & ((x18 & x35) | x17 | (~x13 & ~x18));
