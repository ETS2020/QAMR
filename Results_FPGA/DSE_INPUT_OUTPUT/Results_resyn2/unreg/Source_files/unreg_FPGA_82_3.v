...
module FAU ( 
  ...
  assign z03 = x19 ? (x16 | (~x18 & x00 & ~x17)) : ~x23;
  assign z04 = x19 ? ~new_n60_ : ~x24;
  assign new_n60_ = ~x16 & ((x18 & x25) | x17 | (~x07 & ~x18));
  assign z05 = x19 ? ~new_n62_ : ~x25;
  assign new_n62_ = ~x16 & ((x18 & x26) | x17 | (~x06 & ~x18));
  assign z06 = x19 ? ~new_n64_ : ~x26;
  assign new_n64_ = ~x16 & ((x18 & x27) | x17 | (~x05 & ~x18));
  assign z07 = x19 ? ~new_n66_ : ~x27;
  assign new_n66_ = ~x16 & ((x18 & x20) | x17 | (~x04 & ~x18));
