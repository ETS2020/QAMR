...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n59_, new_n66_, new_n68_, new_n70_, new_n72_,
    new_n74_;
  assign z00 = x19 ? ~new_n55_ : ~x20;
  assign new_n55_ = ~x00 & ((x18 & x21) | x17 | (~x03 & ~x18));
  assign z01 = (~x19 & ~x21) | (new_n57_ & (x02 | x18) & (~x18 | ~x22));
  assign new_n57_ = x19 & ~x00 & ~x17;
  assign z02 = x19 ? ~new_n59_ : ~x22;
  assign new_n59_ = ~x00 & ((x18 & x23) | x17 | (~x01 & ~x18));
  assign z03 = x19 ? (x00 | (x18 & x16 & ~x17)) : ~x23;
  ...
  assign new_n66_ = ~x00 & ((x18 & x29) | x17 | (~x11 & ~x18));
  assign z09 = x19 ? ~new_n68_ : ~x29;
  assign new_n68_ = ~x00 & ((x18 & x30) | x17 | (~x10 & ~x18));
  assign z10 = x19 ? ~new_n70_ : ~x30;
  assign new_n70_ = ~x00 & ((x18 & x31) | x17 | (~x09 & ~x18));
  assign z11 = x19 ? ~new_n72_ : ~x31;
  assign new_n72_ = ~x00 & ((x18 & x24) | x17 | (~x08 & ~x18));
  assign z12 = x19 ? ~new_n74_ : ~x32;
  assign new_n74_ = ~x00 & ((x18 & x33) | x17 | (~x15 & ~x18));
