...
module FAU ( 
  ...
  assign new_n64_ = ~x31 & ((x18 & x26) | x17 | (~x06 & ~x18));
  assign z06 = x19 ? ~new_n66_ : ~x26;
  assign new_n66_ = ~x31 & ((x18 & x27) | x17 | (~x05 & ~x18));
  assign z07 = x19 ? ~new_n68_ : ~x27;
  assign new_n68_ = ~x31 & ((x18 & x20) | x17 | (~x04 & ~x18));
  assign z08 = x19 ? ~new_n70_ : ~x28;
  assign new_n70_ = ~x31 & ((x18 & x29) | x17 | (~x11 & ~x18));
  ...
  assign new_n77_ = ~x31 & (x17 | (~x13 & ~x18) | (x18 & x35));
