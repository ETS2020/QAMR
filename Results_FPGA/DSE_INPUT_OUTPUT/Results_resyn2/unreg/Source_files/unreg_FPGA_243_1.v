...
module FAU ( 
  ...
  assign new_n78_ = x07 & ((x18 & x35) | x17 | (~x13 & ~x18));
  assign z15 = x19 ? ~new_n80_ : ~x35;
  assign new_n80_ = x07 & ((x18 & x28) | x17 | (~x12 & ~x18));
endmodule
