...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n59_, new_n67_, new_n70_;
  ...
  assign new_n59_ = x14 & ((~x16 & x18) | x17 | (~x00 & ~x18));
  ...
  assign new_n67_ = x14 & ((x18 & x31) | x17 | (~x09 & ~x18));
  assign z11 = (~x19 & ~x31) | (new_n55_ & (x08 | x18) & (~x18 | ~x24));
  assign z12 = x19 ? ~new_n70_ : ~x32;
  assign new_n70_ = x14 & ((x18 & x33) | x17 | (~x15 & ~x18));
