...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n63_, new_n69_, new_n72_,
    new_n74_;
  ...
  assign new_n61_ = x34 & ((~x16 & x18) | x17 | (~x00 & ~x18));
  assign z04 = x19 ? ~new_n63_ : ~x24;
  assign new_n63_ = x34 & ((x18 & x25) | x17 | (~x07 & ~x18));
  ...
  assign new_n72_ = x34 & ((x18 & x24) | x17 | (~x08 & ~x18));
  assign z12 = x19 ? ~new_n74_ : ~x32;
  assign new_n74_ = x34 & ((x18 & x33) | x17 | (~x15 & ~x18));
