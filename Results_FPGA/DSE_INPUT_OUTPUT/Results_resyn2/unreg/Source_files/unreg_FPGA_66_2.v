...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n62_, new_n64_, new_n66_, new_n70_, new_n72_;
  ...
  assign new_n62_ = x35 & ((x18 & x26) | x17 | (~x06 & ~x18));
  assign z06 = x19 ? ~new_n64_ : ~x26;
  assign new_n64_ = x35 & ((x18 & x27) | x17 | (~x05 & ~x18));
  assign z07 = x19 ? ~new_n66_ : ~x27;
  assign new_n66_ = x35 & ((x18 & x20) | x17 | (~x04 & ~x18));
