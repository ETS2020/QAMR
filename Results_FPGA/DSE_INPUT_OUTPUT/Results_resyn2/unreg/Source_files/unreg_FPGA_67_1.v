...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n58_, new_n60_, new_n64_, new_n66_, new_n74_;
  ...
  assign new_n58_ = x14 & ((x18 & x23) | x17 | (~x01 & ~x18));
  ...
  assign new_n66_ = x14 & ((x18 & x20) | x17 | (~x04 & ~x18));
  ...
  assign z13 = (x19 | ~x33) & ((~x17 & (~x18 | ~x34)) | ~x14 | ~x19);
  assign z14 = x19 ? ~new_n74_ : ~x34;
  assign new_n74_ = x14 & ((x18 & x35) | x17 | (~x13 & ~x18));
