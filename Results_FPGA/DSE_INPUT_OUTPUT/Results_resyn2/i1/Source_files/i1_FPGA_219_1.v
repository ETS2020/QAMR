...
module FAU ( 
  ...
  assign z05 = (x10 & (x18 | ~x19)) | (new_n45_ & new_n46_ & ~x08 & x18 & x19);
  assign z06 = x18 & x19;
  assign z07 = x18 & x24;
  assign z08 = x11 | (~x18 & x19);
  assign z09 = (x11 | (~x18 & x19)) & ((~x18 & x19) | x24);
  assign z10 = (~x18 & x19) | (x22 & x14 & ~x24);
  assign z11 = x22 & x17 & (x18 | ~x19) & ~x24;
  assign z12 = (~x18 & x19) | (x23 & x14 & ~x24);
  assign z13 = x23 & x17 & (x18 | ~x19) & ~x24;
