...
module FAU ( 
  ...
  assign z01 = x19 ? (~x00 | (new_n47_ & new_n45_ & new_n46_)) : ~x11;
  assign new_n45_ = ~x07 & ~x05 & ~x06;
  assign new_n46_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n47_ = x08 ^ ~x09;
  assign z02 = (~x11 & ~x19) | ((x00 | (new_n45_ & new_n46_)) & x19 & (new_n49_ | ~new_n45_ | ~new_n46_));
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 & (x11 | x19);
  assign z04 = (x20 & (x11 | x19)) | (x21 & (x11 | x19));
  assign z05 = (new_n45_ & new_n46_ & ~x08 & x19) | x10 | (~x11 & ~x19);
  assign z07 = (x24 | (~x11 & ~x19)) & (x18 | (~x11 & ~x19));
  assign z08 = x11 | ~x19;
  assign z09 = x11 & x24;
  assign z10 = ~x24 & (x11 | x19) & x14 & x22;
  assign z11 = (~x11 & ~x19) | (x22 & x17 & ~x24);
  assign z12 = (~x11 & ~x19) | (~x24 & x14 & x23);
