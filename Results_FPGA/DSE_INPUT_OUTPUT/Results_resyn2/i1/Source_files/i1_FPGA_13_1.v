...
module FAU ( 
  ...
  assign z01 = x19 ? (~x00 | (new_n47_ & new_n45_ & new_n46_)) : x24;
  assign new_n45_ = ~x07 & ~x05 & ~x06;
  assign new_n46_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n47_ = x08 ^ ~x09;
  assign z02 = (~x19 & x24) | ((x00 | (new_n45_ & new_n46_)) & x19 & (new_n49_ | ~new_n45_ | ~new_n46_));
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 | (~x19 & x24);
  assign z04 = z03 | x21;
  assign z05 = (x10 & (x19 | ~x24)) | (new_n45_ & new_n46_ & ~x08 & x19);
  assign z06 = x19 | x24;
  ...
  assign z15 = (x19 | ~x24) & (x12 | x13 | x14 | x15);
endmodule
