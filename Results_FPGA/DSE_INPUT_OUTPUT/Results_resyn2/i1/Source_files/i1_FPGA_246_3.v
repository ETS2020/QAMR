...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_;
  assign z00 = x00 & (~x01 | ~x05);
  assign z01 = x19 & (new_n48_ | (new_n45_ & (~x08 | x09) & (x08 | ~x09)));
  assign new_n45_ = new_n46_ & new_n47_ & ~x01 & ~x02;
  assign new_n46_ = ~x07 & ~x05 & ~x06;
  assign new_n47_ = ~x03 & ~x04;
  assign new_n48_ = ~x00 & (~x01 | ~x05);
  assign z02 = (x01 & (x05 | (x00 & x19))) | (~new_n50_ & x19);
  assign new_n50_ = (~x00 | (new_n46_ & new_n47_ & ~x02)) & (~new_n51_ | ~new_n46_ | ~new_n47_ | x01 | x02);
  assign new_n51_ = x08 & ~x09;
  assign z03 = x20 | (x01 & x05);
  assign z04 = (x20 | x21) & (~x01 | ~x05);
  assign z05 = (new_n45_ & ~x08 & x19) | (x01 & x05) | x10;
