// Benchmark "FAU" written by ABC on Wed Aug 12 17:39:06 2020
...
module FAU ( 
  ...
  assign z02 = (~x19 & x24) | ((x00 | (new_n45_ & new_n46_)) & x19 & (new_n48_ | ~new_n45_ | ~new_n46_));
  assign new_n48_ = x08 & ~x09;
  assign z03 = x20 & (x19 | ~x24);
  assign z04 = (x20 & (x19 | ~x24)) | (x21 & (x19 | ~x24));
  assign z05 = (new_n45_ & new_n46_ & ~x08 & x19) | x10 | (~x19 & x24);
  assign z06 = x19 | x24;
