...
module FAU ( 
  ...
  assign z01 = ~x07 & x19 & (~x00 | (new_n45_ & (~x08 | x09) & (x08 | ~x09)));
  assign new_n45_ = ~x01 & ~x02 & ~x03 & ~x04 & ~x05 & ~x06;
  assign z02 = (~new_n45_ | (x08 & ~x09)) & ~x07 & x19 & (new_n45_ | x00);
  assign z03 = x20 | (x07 & x19);
  assign z04 = (x20 | x21) & (~x07 | ~x19);
  assign z05 = (~x07 | ~x19) & (x10 | (new_n45_ & ~x08 & ~x07 & x19));
  assign z07 = (x24 | (x07 & x19)) & (x18 | (x07 & x19));
  assign z08 = x11 & (~x07 | ~x19);
  assign z09 = z08 & x24;
  assign z10 = ~x24 & (~x07 | ~x19) & x14 & x22;
