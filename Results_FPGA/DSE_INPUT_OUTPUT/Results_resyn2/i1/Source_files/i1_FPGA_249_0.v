// Benchmark "FAU" written by ABC on Wed Aug 12 17:39:47 2020
...
module FAU ( 
  ...
  assign z05 = (x10 & (x07 | x19)) | (new_n45_ & new_n46_ & ~x08 & x19);
  assign z06 = ~x07 | x19;
  assign z07 = (x24 | (~x07 & ~x19)) & (x18 | (~x07 & ~x19));
  assign z08 = x11 & (x07 | x19);
  assign z09 = z08 & x24;
  assign z10 = (~x07 & ~x19) | (x22 & x14 & ~x24);
  assign z11 = ~x24 & (x07 | x19) & x17 & x22;
  assign z12 = x14 & ~x24 & x23 & (x07 | x19);
  assign z13 = (~x07 & ~x19) | (~x24 & x17 & x23);
