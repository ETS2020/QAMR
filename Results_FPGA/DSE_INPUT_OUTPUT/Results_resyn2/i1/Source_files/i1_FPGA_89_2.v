...
module FAU ( 
  ...
  assign z02 = x19 & ((x00 & (~new_n46_ | ~new_n47_)) | ~x22 | (new_n49_ & new_n46_ & new_n47_));
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 | (x19 & ~x22);
  assign z04 = (~x19 | x22) & (x20 | x21);
  assign z05 = x10 | (x19 & (~x22 | (~x08 & new_n46_ & new_n47_)));
  assign z07 = (~x19 | x22) & x18 & x24;
  assign z08 = x11 | (x19 & ~x22);
  assign z09 = (x11 | (x19 & ~x22)) & ((x19 & ~x22) | x24);
  assign z10 = x22 ? (x14 & ~x24) : x19;
  assign z11 = ~x24 & x17 & x22;
  assign z12 = x14 & ~x24 & (~x19 | x22) & x23;
  assign z13 = (x19 & ~x22) | (~x24 & x17 & x23);
