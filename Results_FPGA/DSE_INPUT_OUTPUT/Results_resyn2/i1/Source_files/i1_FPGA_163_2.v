...
module FAU ( 
  ...
  assign new_n47_ = x00 & x22;
  assign z02 = x19 & ((x00 & (~new_n45_ | ~new_n46_)) | ~x22 | (new_n49_ & new_n45_ & new_n46_));
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 | (x19 & ~x22);
  assign z04 = (~x19 | x22) & (x20 | x21);
  assign z05 = (x10 & (~x19 | x22)) | (new_n45_ & new_n46_ & ~x08 & x19 & x22);
  assign z06 = x19 & x22;
  assign z07 = (x19 & ~x22) | (x18 & x24);
  assign z08 = x11 & (~x19 | x22);
  assign z09 = (x19 & ~x22) | (x11 & x24);
  assign z10 = ~x24 & x14 & x22;
  assign z11 = x22 ? (x17 & ~x24) : x19;
  assign z12 = (x19 & ~x22) | (~x24 & x14 & x23);
  assign z13 = (x19 & ~x22) | (x23 & x17 & ~x24);
