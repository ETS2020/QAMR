...
module FAU ( 
  ...
  assign z02 = x19 & ((x00 & (~new_n46_ | ~new_n47_)) | ~x18 | (new_n49_ & new_n46_ & new_n47_));
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 & (x18 | ~x19);
  assign z04 = (x20 & (x18 | ~x19)) | (x21 & (x18 | ~x19));
  assign z05 = x10 | (x19 & (~x18 | (~x08 & new_n46_ & new_n47_)));
  ...
  assign z12 = (x18 | ~x19) & ~x24 & x14 & x23;
  assign z13 = (~x18 & x19) | (~x24 & x17 & x23);
