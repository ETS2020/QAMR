// Benchmark "FAU" written by ABC on Wed Aug 12 17:39:35 2020
...
module FAU ( 
  ...
  assign new_n47_ = ~x01 & ~x02 & ~x05 & ~x06;
  assign z02 = x19 & ((x00 & (~new_n46_ | ~new_n47_)) | x07 | (new_n47_ & new_n46_ & new_n49_));
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 | (x07 & x19);
  assign z04 = z03 | x21;
  assign z05 = x10 | (x19 & (x07 | (new_n47_ & new_n46_ & ~x08)));
