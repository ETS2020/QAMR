...
module FAU ( 
  ...
  assign z01 = (~x03 & (~x19 | (new_n45_ & (~x08 | x09) & (x08 | ~x09)))) | (~x00 & x19);
  assign new_n45_ = ~x01 & ~x02 & ~x04 & ~x05 & ~x06 & ~x07;
  assign z02 = (~x03 & (~x19 | (new_n45_ & x08 & ~x09))) | ((~new_n45_ | x03) & x00 & x19);
  assign z03 = x20 & (x03 | x19);
  assign z04 = (~x03 & ~x19) | x20 | x21;
  assign z05 = (x10 & (x03 | x19)) | (new_n45_ & ~x03 & ~x08 & x19);
  assign z06 = ~x03 | x19;
  assign z07 = (x24 | (~x03 & ~x19)) & (x18 | (~x03 & ~x19));
  assign z08 = x11 | (~x03 & ~x19);
  assign z09 = (x24 | (~x03 & ~x19)) & (x11 | (~x03 & ~x19));
  assign z10 = ~x24 & (x03 | x19) & x14 & x22;
