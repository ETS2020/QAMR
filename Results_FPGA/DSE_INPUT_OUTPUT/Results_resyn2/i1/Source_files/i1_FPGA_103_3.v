...
module FAU ( 
  ...
  assign z01 = ~x03 & x19 & (~x00 | (new_n45_ & (~x08 | x09) & (x08 | ~x09)));
  assign new_n45_ = ~x06 & ~x07 & ~x01 & ~x02 & ~x04 & ~x05;
  assign z02 = x19 & ((~new_n45_ & x00) | x03 | (new_n47_ & new_n48_));
  assign new_n47_ = ~x01 & ~x02 & ~x04 & ~x05;
  assign new_n48_ = ~x06 & ~x07 & x08 & ~x09;
  assign z03 = x20 & (~x03 | ~x19);
  assign z04 = (x20 & (~x03 | ~x19)) | (x21 & (~x03 | ~x19));
  assign z05 = (x10 & (~x03 | ~x19)) | (new_n45_ & ~x08 & ~x03 & x19);
  ...
  assign z13 = ~x24 & (~x03 | ~x19) & x17 & x23;
