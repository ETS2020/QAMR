...
module FAU ( 
  ...
  assign z02 = x19 & ((x00 & (~new_n46_ | ~new_n47_)) | x24 | (new_n49_ & new_n46_ & new_n47_));
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 | (x19 & x24);
  assign z04 = z03 | x21;
  assign z05 = (x10 & (~x19 | ~x24)) | (new_n46_ & new_n47_ & ~x08 & x19 & ~x24);
  assign z07 = x24 & x18 & ~x19;
  assign z08 = x11 | (x19 & x24);
  assign z09 = x24 & x11 & ~x19;
  assign z10 = (x19 & x24) | (x22 & x14 & ~x24);
  assign z11 = ~x24 & x17 & x22;
  assign z12 = (x19 & x24) | (x23 & x14 & ~x24);
