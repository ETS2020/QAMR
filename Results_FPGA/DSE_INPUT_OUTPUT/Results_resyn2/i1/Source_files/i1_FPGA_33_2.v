...
module FAU ( 
  ...
  assign z01 = (new_n47_ & new_n45_ & new_n46_ & ~x06) | (x06 & ~x19) | (~x00 & x19);
  assign new_n45_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n46_ = ~x05 & ~x07;
  assign new_n47_ = (x08 | ~x09) & x19 & (~x08 | x09);
  assign z02 = (x06 & (x00 | ~x19)) | (x19 & ((new_n49_ & new_n45_ & new_n46_ & ~x06) | (x00 & (~new_n45_ | ~new_n46_))));
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 & (~x06 | x19);
  assign z04 = x20 | x21 | (x06 & ~x19);
  assign z05 = (x10 & (~x06 | x19)) | (new_n45_ & new_n46_ & x19 & ~x06 & ~x08);
  assign z06 = x06 | x19;
  assign z07 = (~x06 | x19) & x18 & x24;
  assign z08 = x11 & (~x06 | x19);
  assign z09 = (x24 | (x06 & ~x19)) & (x11 | (x06 & ~x19));
