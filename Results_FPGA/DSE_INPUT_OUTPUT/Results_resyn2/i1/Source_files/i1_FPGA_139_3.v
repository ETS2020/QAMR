// Benchmark "FAU" written by ABC on Wed Aug 12 17:39:02 2020
...
module FAU ( 
  ...
  assign new_n47_ = x00 & ~x15;
  assign z02 = x19 & ((x00 & (~new_n45_ | ~new_n46_)) | x15 | (new_n49_ & new_n45_ & new_n46_));
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 & (~x15 | ~x19);
  assign z04 = (x15 & x19) | x20 | x21;
  assign z05 = (x10 & (~x15 | ~x19)) | (new_n45_ & new_n46_ & ~x08 & ~x15 & x19);
  assign z06 = ~x15 & x19;
