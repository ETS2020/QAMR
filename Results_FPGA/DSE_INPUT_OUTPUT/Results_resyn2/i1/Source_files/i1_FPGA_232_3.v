...
module FAU ( 
  ...
  assign new_n45_ = ~x04 & ~x05 & ~x02 & ~x03 & ~x06 & ~x07;
  assign z02 = x19 & ((x00 & (~new_n47_ | ~new_n48_)) | x01 | (new_n48_ & new_n47_ & new_n49_));
  assign new_n47_ = ~x04 & ~x05;
  assign new_n48_ = ~x06 & ~x07 & ~x02 & ~x03;
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 | (x01 & x19);
  assign z04 = (x20 | x21) & (~x01 | ~x19);
  assign z05 = x10 | (x19 & (x01 | (new_n48_ & new_n47_ & ~x08)));
