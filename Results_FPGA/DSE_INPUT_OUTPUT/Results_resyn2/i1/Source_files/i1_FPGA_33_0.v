...
module FAU ( 
  ...
  assign z01 = (~x06 & (~x19 | (new_n45_ & (~x08 | x09) & (x08 | ~x09)))) | (~x00 & x19);
  assign new_n45_ = ~x01 & ~x02 & ~x03 & ~x04 & ~x05 & ~x07;
  assign z02 = (~x06 & (~x19 | (new_n45_ & x08 & ~x09))) | ((~new_n45_ | x06) & x00 & x19);
  assign z03 = x20 & (x06 | x19);
  assign z04 = (~x06 & ~x19) | x20 | x21;
  assign z05 = (x10 & (x06 | x19)) | (new_n45_ & ~x06 & ~x08 & x19);
  assign z06 = ~x06 | x19;
