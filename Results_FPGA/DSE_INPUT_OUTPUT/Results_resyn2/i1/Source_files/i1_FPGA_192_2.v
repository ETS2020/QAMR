...
module FAU ( 
  ...
  assign z01 = new_n46_ | (~x07 & (x03 | (new_n45_ & (x08 | ~x09) & (~x08 | x09))));
  assign new_n45_ = ~x06 & x19 & ~x01 & ~x02 & ~x04 & ~x05;
  assign new_n46_ = ~x00 & x19;
  assign z02 = (~x07 & (x03 | (new_n45_ & new_n48_))) | (~new_n49_ & new_n50_);
  assign new_n48_ = x08 & ~x09;
  assign new_n49_ = ~x01 & ~x02 & ~x04 & ~x05 & ~x06 & ~x07;
