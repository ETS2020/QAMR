...
module FAU ( 
  ...
  assign z01 = (~x05 & (~x19 | (new_n45_ & new_n46_))) | (~x00 & x19);
  assign new_n45_ = ~x04 & ~x03 & ~x01 & ~x02;
  assign new_n46_ = (x08 | ~x09) & ~x06 & ~x07 & (~x08 | x09);
  ...
  assign z04 = z03 | x21;
  assign z05 = x10 | (~x05 & (~x19 | (new_n45_ & new_n53_)));
