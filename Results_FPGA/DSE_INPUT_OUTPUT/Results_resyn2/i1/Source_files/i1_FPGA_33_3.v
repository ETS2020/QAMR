...
module FAU ( 
  ...
  assign z01 = x19 & ((new_n45_ & (~x08 | x09) & (x08 | ~x09)) | ~x00 | x06);
  assign new_n45_ = ~x05 & ~x07 & ~x01 & ~x02 & ~x03 & ~x04;
  assign z02 = x19 & ((~new_n45_ & x00) | x06 | (new_n47_ & new_n48_));
  assign new_n47_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n48_ = ~x05 & ~x07 & x08 & ~x09;
  assign z03 = x20 & (~x06 | ~x19);
  assign z04 = x20 | x21 | (x06 & x19);
  assign z05 = (x10 & (~x06 | ~x19)) | (new_n45_ & x19 & ~x06 & ~x08);
