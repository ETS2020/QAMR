...
module FAU ( 
  ...
  assign z01 = (new_n45_ & (x08 | ~x09) & x19 & (~x08 | x09)) | (x03 & ~x19) | (~x00 & x19);
  assign new_n45_ = new_n46_ & ~x07 & ~x05 & ~x06;
  assign new_n46_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign z02 = (x03 & (x00 | ~x19)) | (x19 & ((~new_n49_ & x00) | (new_n45_ & new_n48_)));
  assign new_n48_ = x08 & ~x09;
  assign new_n49_ = ~x07 & ~x05 & ~x06 & ~x04 & ~x01 & ~x02;
  assign z03 = x20 | (x03 & ~x19);
  assign z04 = z03 | x21;
  assign z05 = (new_n45_ & ~x08 & x19) | x10 | (x03 & ~x19);
  assign z06 = x03 | x19;
