...
module FAU ( 
  ...
  assign z04 = (~x19 | ~x23) & (x20 | x21);
  assign z05 = x10 | (x19 & (x23 | (new_n45_ & new_n53_)));
  assign new_n53_ = ~x05 & ~x06 & ~x07 & ~x08;
  assign z07 = (~x19 | ~x23) & x18 & x24;
  assign z08 = x11 & (~x19 | ~x23);
  assign z09 = ((x19 & x23) | x24) & (x11 | (x19 & x23));
  assign z10 = (x19 & x23) | (x22 & x14 & ~x24);
  assign z11 = x17 & ~x24 & x22 & (~x19 | ~x23);
  assign z12 = x14 & ~x24 & ~x19 & x23;
