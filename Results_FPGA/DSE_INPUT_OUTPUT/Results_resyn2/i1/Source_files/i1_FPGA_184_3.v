...
module FAU ( 
  ...
  assign z02 = x19 & ((x00 & (~new_n46_ | ~new_n47_)) | x12 | (new_n49_ & new_n46_ & new_n47_));
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 & (~x12 | ~x19);
  assign z04 = x20 | x21 | (x12 & x19);
  assign z05 = (x10 & (~x12 | ~x19)) | (new_n46_ & new_n47_ & ~x08 & ~x12 & x19);
  ...
  assign z12 = x14 & (~x12 | ~x19) & x23 & ~x24;
  assign z13 = x17 & (~x12 | ~x19) & x23 & ~x24;
