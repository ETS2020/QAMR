// Benchmark "FAU" written by ABC on Wed Aug 12 17:39:21 2020
...
module FAU ( 
  ...
  assign z05 = x10 | (x19 & (~x23 | (new_n45_ & new_n52_)));
  assign new_n52_ = ~x05 & ~x06 & ~x07 & ~x08;
  assign z07 = (~x19 | x23) & x18 & x24;
  assign z08 = x11 & (~x19 | x23);
  assign z09 = z08 & x24;
  assign z10 = x14 & (~x19 | x23) & x22 & ~x24;
  assign z11 = x17 & (~x19 | x23) & x22 & ~x24;
