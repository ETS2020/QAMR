...
module FAU ( 
  ...
  assign z01 = (~x00 & x19) | (~x01 & (~x19 | (new_n45_ & new_n46_)));
  assign new_n45_ = ~x02 & ~x03 & ~x05 & ~x06;
  assign new_n46_ = (~x08 | x09) & ~x04 & ~x07 & (x08 | ~x09);
  assign z02 = (~new_n48_ | ~new_n49_ | (x08 & ~x09)) & x19 & (x00 | (new_n48_ & new_n49_));
  assign new_n48_ = ~x01 & ~x02 & ~x03;
  assign new_n49_ = ~x05 & ~x06 & ~x04 & ~x07;
  assign z03 = x20 & (x01 | x19);
  assign z04 = (~x01 & ~x19) | x20 | x21;
  assign z05 = x10 | (~x01 & (~x19 | (new_n45_ & new_n53_)));
  assign new_n53_ = ~x08 & ~x04 & ~x07;
  assign z06 = ~x01 | x19;
