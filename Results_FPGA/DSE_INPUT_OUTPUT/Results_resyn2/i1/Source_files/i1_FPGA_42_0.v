...
module FAU ( 
  ...
  assign z01 = x19 ? (~x00 | (new_n47_ & new_n45_ & new_n46_)) : ~x20;
  ...
  assign z06 = x19 | ~x20;
  assign z07 = (x18 | (~x19 & ~x20)) & ((~x19 & ~x20) | x24);
  assign z08 = x11 | (~x19 & ~x20);
  assign z09 = (x19 | x20) & x11 & x24;
  assign z10 = (~x19 & ~x20) | (x22 & x14 & ~x24);
  assign z11 = x17 & x22 & (x19 | x20) & ~x24;
  assign z12 = (~x19 & ~x20) | (x23 & x14 & ~x24);
  assign z13 = (~x19 & ~x20) | (~x24 & x17 & x23);
