...
module FAU ( 
  ...
  assign new_n45_ = ~x01 & ~x02 & ~x05 & ~x06 & ~x03 & ~x04;
  assign z02 = (~new_n45_ | (x08 & ~x09)) & (new_n45_ | x00) & ~x07 & x19;
  assign z03 = x20 & (~x07 | ~x19);
  assign z04 = (x20 & (~x07 | ~x19)) | (x21 & (~x07 | ~x19));
  assign z05 = x10 | (x19 & (x07 | (new_n50_ & new_n51_)));
  assign new_n50_ = ~x01 & ~x02 & ~x05 & ~x06;
  assign new_n51_ = ~x08 & ~x03 & ~x04;
