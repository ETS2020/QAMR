// Benchmark "FAU" written by ABC on Wed Aug 12 17:39:19 2020
...
module FAU ( 
  ...
  assign z02 = (~x11 & ~x19) | ((x00 | (new_n45_ & new_n46_)) & x19 & (new_n48_ | ~new_n45_ | ~new_n46_));
  assign new_n48_ = x08 & ~x09;
  assign z03 = x20 & (x11 | x19);
  assign z04 = (~x11 & ~x19) | x20 | x21;
  assign z05 = (x10 & (x11 | x19)) | (new_n45_ & new_n46_ & ~x08 & x19);
  assign z06 = ~x11 | x19;
  assign z07 = (x24 | (~x11 & ~x19)) & (x18 | (~x11 & ~x19));
  assign z09 = x11 ? x24 : ~x19;
  assign z10 = (~x11 & ~x19) | (x22 & x14 & ~x24);
  assign z11 = ~x24 & (x11 | x19) & x17 & x22;
  assign z12 = (~x11 & ~x19) | (x23 & x14 & ~x24);
  assign z13 = (~x11 & ~x19) | (~x24 & x17 & x23);
