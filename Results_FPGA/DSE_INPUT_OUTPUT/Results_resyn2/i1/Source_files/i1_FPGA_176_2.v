...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n46_, new_n47_, new_n51_;
  assign z00 = x00 & x04;
  assign z01 = ~x00 & x19;
  assign z02 = (new_n46_ & new_n47_) | (x00 & (~x04 | x19));
  assign new_n46_ = ~x01 & ~x02 & ~x06 & ~x07;
  assign new_n47_ = ~x03 & ~x05 & ~x04 & x08 & ~x09 & x19;
  assign z03 = x20 & (~x00 | x04);
  assign z04 = x20 | x21 | (x00 & ~x04);
  assign z05 = x10 | (~x04 & ((new_n46_ & new_n51_) | x00));
  assign new_n51_ = ~x03 & ~x05 & ~x08 & x19;
  ...
  assign z15 = (x00 & ~x04) | x12 | x13 | x14 | x15;
endmodule
