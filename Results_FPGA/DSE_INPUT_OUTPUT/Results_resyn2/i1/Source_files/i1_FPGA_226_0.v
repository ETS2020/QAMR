...
module FAU ( 
  ...
  assign new_n45_ = ~x01 & ~x02 & ~x06 & ~x07;
  assign new_n46_ = ~x03 & ~x04 & ~x05;
  assign z02 = (~x03 & (~x19 | (new_n45_ & new_n48_ & new_n49_))) | ((~new_n45_ | ~new_n48_ | x03) & x00 & x19);
  assign new_n48_ = ~x04 & ~x05;
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 | (~x03 & ~x19);
  assign z04 = (x03 | x19) & (x20 | x21);
  assign z05 = x10 | (~x03 & (~x19 | (new_n45_ & new_n48_ & ~x08)));
