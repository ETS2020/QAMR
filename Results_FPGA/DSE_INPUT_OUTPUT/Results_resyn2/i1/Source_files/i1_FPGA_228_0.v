...
module FAU ( 
  ...
  assign z01 = x19 & (~x00 | (new_n46_ & new_n45_ & ~x01));
  assign new_n45_ = ~x02 & ~x03;
  assign new_n46_ = ~x05 & ~x06 & ~x04 & ~x07 & (~x08 | x09) & (x08 | ~x09);
  assign z02 = (~x01 & (~x19 | (new_n48_ & new_n45_ & new_n49_))) | ((~new_n48_ | ~new_n45_ | x01) & x00 & x19);
  assign new_n48_ = ~x05 & ~x06 & ~x04 & ~x07;
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 & (x01 | x19);
  assign z04 = (x20 & (x01 | x19)) | (x21 & (x01 | x19));
  assign z05 = (x10 & (x01 | x19)) | (new_n48_ & new_n45_ & ~x01 & ~x08 & x19);
  assign z06 = ~x01 | x19;
  assign z07 = (x01 | x19) & x18 & x24;
  assign z08 = x11 & (x01 | x19);
  assign z09 = (x24 | (~x01 & ~x19)) & (x11 | (~x01 & ~x19));
