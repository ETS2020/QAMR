...
module FAU ( 
  ...
  assign new_n45_ = ~x01 & ~x02 & ~x03 & ~x04 & ~x06 & ~x07;
  assign z02 = (new_n45_ | x00) & ~x05 & x19 & (~new_n45_ | (x08 & ~x09));
  assign z03 = x20 & (~x05 | ~x19);
  assign z04 = (x20 & (~x05 | ~x19)) | (x21 & (~x05 | ~x19));
  assign z05 = (x10 & (~x05 | ~x19)) | (new_n45_ & ~x08 & ~x05 & x19);
  ...
  assign z12 = ~x24 & (~x05 | ~x19) & x14 & x23;
