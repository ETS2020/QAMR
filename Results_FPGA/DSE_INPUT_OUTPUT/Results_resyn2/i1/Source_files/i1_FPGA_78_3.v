...
module FAU ( 
  ...
  assign z02 = (x00 | (new_n45_ & new_n48_ & ~x07)) & z06 & (~new_n45_ | ~new_n48_ | x07 | x08);
  assign new_n48_ = ~x05 & ~x06;
  assign z06 = ~x09 & x19;
  assign z03 = x20 & (~x09 | ~x19);
  assign z04 = (x09 & x19) | x20 | x21;
  assign z05 = x10 | (x19 & (x09 | (new_n45_ & new_n46_)));
  ...
  assign z13 = (x09 & x19) | (~x24 & x17 & x23);
