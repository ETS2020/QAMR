...
module FAU ( 
  ...
  assign z02 = (x01 & (x00 | ~x19)) | (x19 & ((~new_n47_ & x00) | (new_n45_ & new_n48_)));
  assign new_n47_ = ~x06 & ~x02 & ~x05 & ~x07 & ~x03 & ~x04;
  assign new_n48_ = ~x09 & ~x07 & x08;
  assign z03 = x20 & (~x01 | x19);
  assign z04 = (x20 & (~x01 | x19)) | (x21 & (~x01 | x19));
  assign z05 = (x10 & (~x01 | x19)) | (new_n47_ & x19 & ~x01 & ~x08);
  assign z06 = x01 | x19;
  ...
  assign z15 = (x01 & ~x19) | x14 | x15 | x12 | x13;
endmodule
