...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n44_, new_n47_, new_n48_, new_n50_;
  assign z00 = new_n44_ | x00;
  assign new_n44_ = x09 & ~x23;
  assign z01 = z06 & (~x00 | (new_n47_ & new_n48_ & (~x08 | x09) & (x08 | ~x09)));
  assign z06 = x19 & (~x09 | x23);
  assign new_n47_ = ~x05 & ~x06 & ~x07;
  assign new_n48_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign z02 = new_n44_ | ((x00 | (new_n47_ & new_n48_)) & x19 & (new_n50_ | ~new_n47_ | ~new_n48_));
  assign new_n50_ = x08 & ~x09;
  assign z03 = ~new_n44_ & x20;
  assign z04 = new_n44_ | x20 | x21;
  assign z05 = (new_n47_ & new_n48_ & ~x08 & x19) | new_n44_ | x10;
  ...
  assign z12 = (x09 & ~x23) | (x14 & x23 & ~x24);
  assign z13 = (x09 & ~x23) | (x17 & x23 & ~x24);
