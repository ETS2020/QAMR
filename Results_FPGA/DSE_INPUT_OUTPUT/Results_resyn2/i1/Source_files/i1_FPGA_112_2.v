...
module FAU ( 
  ...
  assign z01 = x19 ? (~x00 | (new_n47_ & new_n45_ & new_n46_)) : x01;
  ...
  assign z05 = (new_n45_ & new_n46_ & ~x08 & x19) | x10 | (x01 & ~x19);
  assign z06 = x01 | x19;
  assign z07 = (x24 | (x01 & ~x19)) & (x18 | (x01 & ~x19));
  ...
  assign z13 = (x01 & ~x19) | (x23 & x17 & ~x24);
