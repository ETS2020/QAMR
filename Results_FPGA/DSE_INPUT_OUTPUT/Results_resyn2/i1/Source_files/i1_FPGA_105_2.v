...
module FAU ( 
  ...
  assign z01 = (new_n45_ & ~new_n46_ & ~x07 & x19) | (x01 & ~x19) | (~x00 & x19);
  assign new_n45_ = ~x06 & ~x02 & ~x05 & ~x01 & ~x03 & ~x04;
  assign new_n46_ = ~x08 ^ ~x09;
  assign z02 = (x01 & (x00 | ~x19)) | (x19 & ((~new_n48_ & x00) | (new_n45_ & new_n49_)));
  assign new_n48_ = ~x06 & ~x02 & ~x05 & ~x07 & ~x03 & ~x04;
  assign new_n49_ = ~x09 & ~x07 & x08;
  assign z03 = x20 | (x01 & ~x19);
  assign z04 = z03 | x21;
  assign z05 = (x10 & (~x01 | x19)) | (new_n48_ & x19 & ~x01 & ~x08);
