...
module FAU ( 
  ...
  assign new_n45_ = ~x04 & ~x05 & ~x01 & ~x02 & ~x06 & ~x07;
  assign z02 = x19 & ((x00 & (~new_n47_ | ~new_n48_)) | x03 | (new_n48_ & new_n47_ & new_n49_));
  assign new_n47_ = ~x04 & ~x05;
  assign new_n48_ = ~x06 & ~x07 & ~x01 & ~x02;
  assign new_n49_ = x08 & ~x09;
  assign z03 = x20 | (x03 & x19);
  assign z04 = z03 | x21;
  assign z05 = x10 | (x19 & (x03 | (new_n48_ & new_n47_ & ~x08)));
