...
module FAU ( 
  ...
  assign z01 = new_n46_ | (~x03 & (x07 | (new_n45_ & (~x08 | x09) & (x08 | ~x09))));
  assign new_n45_ = ~x06 & ~x04 & ~x05 & x19 & ~x01 & ~x02;
  assign new_n46_ = ~x00 & x19;
  assign z02 = (~x03 & (x07 | (new_n45_ & new_n48_))) | (~new_n49_ & new_n50_);
  assign new_n48_ = x08 & ~x09;
  assign new_n49_ = ~x01 & ~x02 & ~x03 & ~x06 & ~x04 & ~x05;
  assign new_n50_ = x00 & x19;
  assign z03 = x20 & (x03 | ~x07);
  assign z04 = (x20 & (x03 | ~x07)) | (x21 & (x03 | ~x07));
  assign z05 = (x10 & (x03 | ~x07)) | (new_n54_ & ~x03 & new_n55_ & ~x07 & ~x08);
  assign new_n54_ = ~x06 & ~x04 & ~x05;
  assign new_n55_ = x19 & ~x01 & ~x02;
