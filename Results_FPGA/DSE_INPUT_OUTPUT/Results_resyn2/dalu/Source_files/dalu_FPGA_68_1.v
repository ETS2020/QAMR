// Benchmark "FAU" written by ABC on Thu Aug 13 12:02:54 2020
...
module FAU ( 
  ...
  assign z03 = ~x69 & ((~new_n145_ & ~x65) | (~new_n155_ & new_n117_));
  assign new_n145_ = ~new_n154_ & (~x68 | (~new_n151_ & (new_n146_ | ~new_n96_)));
  ...
  assign z04 = (~x65 & (new_n168_ | (~new_n157_ & x68 & ~x69))) | new_n165_ | (~x68 & x69);
  ...
  assign new_n163_ = (~x32 | (~x36 & (~new_n164_ | x39))) & new_n101_ & (x32 | x36);
  assign new_n164_ = ~x37 & ~x38 & ~x46 & ~x47 & ~x44 & ~x45;
  assign new_n165_ = ~new_n166_ & new_n167_;
  assign new_n166_ = (~new_n163_ | ~new_n97_) & (x70 | ((~new_n161_ | ~new_n97_) & (new_n159_ | new_n97_ | x71)));
  assign new_n167_ = x68 & ~x69 & ~x64 & x65;
  assign new_n168_ = new_n119_ & ((x04 & ~x70 & x71) | ((x36 | ~x71) & x70 & (x20 | x71)));
  assign z05 = (~x65 & (new_n179_ | (~new_n170_ & x68 & ~x69))) | new_n177_ | (~x68 & x69);
  assign new_n170_ = ~new_n171_ & (~new_n96_ | (~new_n176_ & (~new_n175_ | x70)));
  ...
  assign new_n175_ = (x05 | (x00 & (~new_n107_ | ~new_n162_ | x04))) & x71 & (~x00 | ~x05);
  assign new_n176_ = new_n101_ & (x36 | ~new_n164_ | x39) & (~x32 ^ ~x37);
  assign new_n177_ = ~new_n178_ & new_n167_;
  assign new_n178_ = (~new_n176_ | ~new_n97_) & (x70 | ((~new_n175_ | ~new_n97_) & (new_n172_ | new_n97_ | x71)));
  assign new_n179_ = new_n119_ & ((x05 & ~x70 & x71) | ((x37 | ~x71) & x70 & (x21 | x71)));
  assign z06 = ~x69 & ((~x65 & (new_n181_ | new_n190_)) | (~new_n189_ & new_n117_));
  assign new_n181_ = x68 & (new_n184_ | (new_n96_ & (new_n188_ | (new_n182_ & ~x70))));
  assign new_n182_ = (~x00 | (~new_n183_ & ~x06)) & x71 & (x00 | x06);
  assign new_n183_ = new_n107_ & ~x07 & ~x04 & ~x05;
  ...
  assign new_n188_ = new_n101_ & (x36 | ~new_n164_ | x39) & (~x32 ^ ~x38);
  assign new_n189_ = (~new_n188_ | ~new_n97_) & (x70 | ((~new_n182_ | ~new_n97_) & (new_n185_ | new_n97_ | x71)));
  ...
  assign new_n193_ = ~new_n194_ & ((x00 & (x07 | (new_n104_ & new_n107_))) | ~new_n109_ | (~x00 & ~x07));
  assign new_n194_ = (~x32 | (~x39 & (~new_n164_ | x36))) & new_n101_ & (x32 | x39);
  ...
  assign new_n209_ = new_n167_ & ((new_n204_ & new_n97_) | (~new_n210_ & ~x70));
  ...
  assign new_n218_ = (~x41 | new_n150_ | ~x32) & new_n101_ & (x41 | (~new_n150_ & x32));
  assign new_n219_ = (~x09 | new_n148_ | ~x00) & x71 & (x09 | (~new_n148_ & x00));
  assign new_n220_ = new_n167_ & (new_n221_ | (new_n218_ & new_n97_));
  ...
  assign new_n231_ = new_n167_ & (new_n232_ | (new_n97_ & (new_n227_ | x42) & new_n101_ & (~new_n227_ | ~x42)));
  ...
  assign new_n242_ = new_n167_ & ((~new_n236_ & new_n97_) | (~new_n239_ & ~x70 & ~new_n97_ & ~x71));
  assign new_n243_ = new_n119_ & ((x11 & ~x70 & x71) | ((x43 | ~x71) & x70 & (x27 | x71)));
  assign z12 = ~x69 & ((~x65 & (new_n245_ | new_n253_)) | (~new_n252_ & new_n117_));
  ...
  assign new_n257_ = (x45 | (x32 & (x46 | x47))) & new_n101_ & (~x45 | ~x32 | (~x46 & ~x47));
  ...
  assign new_n262_ = new_n167_ & (new_n263_ | (new_n257_ & new_n97_));
  ...
  assign z14 = ~x69 & ((~x65 & (new_n266_ | new_n274_)) | (~new_n273_ & new_n117_));
  ...
  assign z15 = ~x69 & ((~new_n276_ & ~x65) | (~new_n283_ & new_n117_));
