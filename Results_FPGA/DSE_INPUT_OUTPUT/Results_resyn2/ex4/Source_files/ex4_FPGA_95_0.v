...
module FAU ( 
  ...
  assign new_n179_ = (~x035 | ~x085 | x003 | x083) & (~new_n177_ | ~x051);
  ...
  assign z06 = z17 | (x046 & (~new_n220_ | (~new_n207_ & ~new_n226_)));
  ...
  assign z08 = z17 | (~x040 & (~new_n241_ | (~x048 & (new_n228_ | ~new_n236_))));
  ...
  assign z11 = ~z17 & ~x043 & (new_n256_ | (x011 & x075));
  assign new_n256_ = (x035 | ((new_n257_ | new_n258_) & ((new_n258_ & ~x011) | ~x051 | (new_n257_ & ~x075)))) & ((new_n257_ & ~x011) | ~x035 | x051 | (new_n258_ & ~x075));
  ...
  assign z13 = ~x045 & ((~new_n264_ & x051) | (~new_n283_ & x085));
