// Benchmark "FAU" written by ABC on Wed Aug 26 09:27:43 2020
...
module FAU ( 
  ...
  assign z14 = (z07 | ~x046) & (~new_n282_ | (~x054 & (new_n270_ | ~new_n278_)));
  ...
  assign new_n285_ = (new_n286_ | (x022 & x070)) & (~x014 | (x022 & x070 & (~x038 | x054)));
  assign new_n286_ = x006 & x086;
  assign new_n287_ = (~x078 | (~x014 & (~new_n286_ | x038))) & ~z07 & (~x038 | ~x054);
  assign z16 = 1'b0;
  assign z17 = 1'b0;
  assign z18 = 1'b0;
  assign z20 = 1'b0;
