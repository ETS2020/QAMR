...
module FAU ( 
  ...
  assign z05 = x045 & (~new_n195_ | (x053 & (~new_n191_ | (~new_n183_ & x077))));
  assign new_n183_ = (new_n184_ | ~x085) & (x005 | (new_n189_ & (new_n187_ | ~x069)));
  assign new_n184_ = (x069 | (new_n185_ & (~x021 | x029))) & (~new_n186_ | x029 | (~x021 & (~x013 | ~x069)));
  assign new_n185_ = x061 & x093;
  assign new_n186_ = (x061 | x093) & (~x101 | ~x125);
  assign new_n187_ = ((~x013 & ~x021) | (x029 & x061 & x093)) & (new_n188_ | (~x021 & ~x061 & ~x093));
  assign new_n188_ = x101 & x125;
  assign new_n189_ = new_n190_ & (x101 | ~x037 | x069);
  ...
  assign new_n194_ = ~x077 & ~x021 & ~x069;
  assign new_n195_ = new_n198_ & (~x077 | (new_n197_ & (new_n196_ | x037 | ~x085)));
  assign new_n196_ = new_n185_ & (x029 | (~x021 & (~x013 | ~x069)));
  ...
  assign z13 = (new_n255_ | ~new_n267_ | (~new_n266_ & ~x077)) & ~x045 & ~x085;
  ...
  assign new_n258_ = (new_n259_ | (x013 & x021)) & (~new_n260_ | (new_n185_ & x021));
  assign new_n259_ = ~x061 & ~x093 & (x021 | ~x125 | (x109 & x117));
  ...
  assign new_n266_ = (new_n262_ | ~x037) & ((x013 & x037) | ((~x021 | ~x069) & (~x029 | ~x037)));
