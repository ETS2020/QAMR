// Benchmark "FAU" written by ABC on Wed Aug 26 09:27:41 2020
...
module FAU ( 
  ...
  assign z05 = z15 | (x045 & (~new_n197_ | (x053 & (new_n183_ | ~new_n189_))));
  ...
  assign z13 = ~x045 & (new_n272_ | (~x085 & (~new_n268_ | (~new_n257_ & ~x053))));
  assign new_n257_ = ~new_n265_ & (x077 | (~new_n258_ & ~new_n263_ & (new_n262_ | new_n267_)));
  assign new_n258_ = x005 & (new_n260_ | new_n261_ | (~new_n259_ & (~x013 | ~x021)));
  assign new_n259_ = ~x061 & ~x093;
  assign new_n260_ = x029 & (~x021 | (~x013 & ~x069));
  assign new_n261_ = ~x021 & x125 & (~x109 | ~x117);
  assign new_n262_ = (new_n185_ | ~x029 | (x021 & (x013 | x069))) & ((new_n185_ & x021) | ~x005 | x069);
  assign new_n263_ = x069 & (~new_n264_ | (x101 & x005 & ~x037));
  assign new_n264_ = ~x061 & ~x093 & (x021 | ~x029);
  assign new_n265_ = (x109 | x117) & (x013 | (~x077 & (new_n266_ | x021)));
  assign new_n266_ = (~x069 | (x005 & ~x037)) & (x005 | (x029 & (~x061 | ~x093)));
  ...
  assign new_n272_ = ~x097 & ((~new_n273_ & ~x077) | ~new_n271_ | new_n275_);
