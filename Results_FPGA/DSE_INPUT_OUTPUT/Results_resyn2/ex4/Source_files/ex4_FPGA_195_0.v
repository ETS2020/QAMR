...
module FAU ( 
  ...
  assign z05 = x045 & ((x102 & (new_n200_ | ~new_n204_)) | (~new_n185_ & x085));
  ...
  assign z06 = z16 | (x046 & (~new_n222_ | (x054 & (new_n207_ | ~new_n214_))));
  assign new_n207_ = ~x006 & (new_n213_ | (x078 & (~new_n210_ | (~new_n208_ & x070))));
  assign new_n208_ = ~new_n209_ & ((~x062 & ~x094) | (x102 & x126)) & (~x022 | (x102 & x126));
  assign new_n209_ = (x022 | (x014 & x038)) & (~x030 | ~x062 | ~x094);
  assign new_n210_ = new_n212_ & (new_n211_ | ~x022 | x126);
  assign new_n211_ = ~x110 & ~x118;
  assign new_n212_ = x086 & (x102 | ~x038 | x070);
  assign new_n213_ = x038 & ~x086;
  assign new_n214_ = new_n217_ & ((x110 & x118) | (~new_n215_ & (x014 | ~x086)));
  assign new_n215_ = x078 & (new_n216_ | (~x006 & (x070 ? x022 : x038)));
  assign new_n216_ = x086 & (~x022 | (~x030 & x070 & (x062 | x094)));
  assign new_n217_ = (x070 | (~new_n218_ & ~new_n219_)) & (~new_n220_ | ~new_n221_);
  assign new_n218_ = x078 & x086 & (~x062 | ~x094 | (x022 & ~x030));
  assign new_n219_ = ~x022 & (~x078 | x014 | x038);
  assign new_n220_ = ~x030 & (x022 | (x014 & x070));
  assign new_n221_ = x078 & x086 & (x062 | x094) & (~x102 | ~x126);
  assign new_n222_ = new_n225_ & (new_n223_ | x038 | ~x078);
  assign new_n223_ = (new_n224_ | ~x086) & (x006 | ~x070 | (x102 & x126));
  assign new_n224_ = x062 & x094 & (x030 | (~x022 & (~x014 | ~x070)));
  assign new_n225_ = (x014 | x078) & (x054 | (new_n226_ & (~x078 | x022 | x070)));
  assign new_n226_ = x038 & (x086 | x006 | ~x014);
  assign z08 = z16 | (~x040 & (~new_n241_ | (~x048 & (new_n228_ | ~new_n236_))));
  ...
  assign new_n248_ = ((~new_n249_ & ~x009) | (~x033 & x049) | (~new_n250_ & x009)) & ((~new_n250_ & ~x009) | (~new_n249_ & x009) | x033) & ((~new_n249_ & ~new_n250_) | x009 | x073) & (~x009 | ~x073) & (~x033 | ~x049);
  assign new_n249_ = x017 & x065;
  assign new_n250_ = x001 & x081;
  assign z10 = ~new_n252_ & ~z16 & ~x042;
  assign new_n252_ = ((~new_n253_ & ~x010) | (~x034 & x050) | (~new_n254_ & x010)) & ((~new_n254_ & ~x010) | (~new_n253_ & x010) | x034) & ((~new_n253_ & ~new_n254_) | x010 | x074) & (~x010 | ~x074) & (~x034 | ~x050);
  assign new_n253_ = x018 & x066;
  assign new_n254_ = x002 & x082;
  assign z11 = z16 | (~new_n256_ & ~x043);
  assign new_n256_ = ((~new_n257_ & ~x011) | (~x035 & x051) | (~new_n258_ & x011)) & ((~new_n258_ & ~x011) | (~new_n257_ & x011) | x035) & ((~new_n257_ & ~new_n258_) | x011 | x075) & (~x011 | ~x075) & (~x035 | ~x051);
  assign new_n257_ = x019 & x067;
  assign new_n258_ = x003 & x083;
  assign z12 = ~new_n260_ & ~z16 & ~x044;
  assign new_n260_ = ((~new_n261_ & ~x012) | (~x036 & x052) | (~new_n262_ & x012)) & ((~new_n262_ & ~x012) | (~new_n261_ & x012) | x036) & ((~new_n261_ & ~new_n262_) | x012 | x076) & (~x012 | ~x076) & (~x036 | ~x052);
  assign new_n261_ = x020 & x068;
  assign new_n262_ = x004 & x084;
  assign z13 = ~x045 & ((~new_n282_ & x085) | (~new_n264_ & x102));
  ...
  assign z14 = ~x046 & ((~new_n308_ & ~z16) | (~x078 & (new_n284_ | ~new_n296_)));
  assign new_n284_ = ~x054 & (~new_n293_ | (~x070 & (new_n291_ | (~new_n285_ & x085))));
  assign new_n285_ = (~new_n286_ | new_n287_) & (~x006 | (~new_n288_ & (new_n289_ | new_n290_)));
  assign new_n286_ = (~x062 | ~x094) & x030 & ~x086;
  ...
  assign new_n291_ = new_n292_ & (~x014 | (x006 & (~x022 | ~x062 | ~x094)));
  assign new_n292_ = x102 & (x006 | ((~x062 | ~x094) & x030 & ~x086));
  assign new_n293_ = (~new_n294_ | (~x102 & (~x085 | ~x126))) & (~new_n295_ | (~x102 & (new_n211_ | ~x085)));
  assign new_n294_ = ~x022 & (~x062 | ~x094) & x030 & ~x086;
  assign new_n295_ = x070 & x006 & ~x038;
  assign new_n296_ = ~new_n297_ & (z16 | (~new_n304_ & ~new_n306_ & (new_n301_ | x086)));
  assign new_n297_ = x038 & (new_n300_ | (~x070 & (new_n298_ | new_n299_)));
  assign new_n298_ = x006 & (x102 | (x085 & x126));
  assign new_n299_ = ~x014 & x085 & x030 & ~x086;
  assign new_n300_ = x030 & ~x086 & ((~x022 & x085) | (x102 & ~x014 & x022));
  assign new_n301_ = ~new_n303_ & (x054 | (~new_n302_ & (new_n211_ | ~x022)));
  assign new_n302_ = x070 & (x062 | x094 | (~x022 & x030));
  assign new_n303_ = x038 & (x062 | x094);
  assign new_n304_ = (new_n305_ | (x006 & x086)) & (~x014 | (new_n305_ & (~x038 | x054)));
  assign new_n305_ = x022 & x070;
  assign new_n306_ = ~new_n307_ & x006 & ~x054;
  assign new_n307_ = ~x086 & (x022 | ~x126 | (x110 & x118));
  assign new_n308_ = (new_n309_ | ~x078) & (~x038 | ~x054) & (~x014 | (~new_n310_ & ~x078));
  assign new_n309_ = (~new_n305_ | x054) & (x038 | ~x006 | ~x086);
  assign new_n310_ = ~new_n211_ & ~x054 & ~x086;
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z17 = 1'b0;
  assign z18 = 1'b0;
