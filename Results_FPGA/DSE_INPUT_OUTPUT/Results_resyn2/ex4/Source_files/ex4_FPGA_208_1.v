...
module FAU ( 
  ...
  assign z13 = ~x045 & ~x085 & (new_n263_ | ~new_n272_ | (~new_n271_ & ~x077));
  assign new_n263_ = ~x053 & (new_n264_ | (~x077 & (~new_n269_ | (~new_n266_ & x005))));
  assign new_n264_ = (x109 | x117) & (x013 | (~x077 & (new_n265_ | x021)));
  assign new_n265_ = (~x037 | ~x069) & (x005 | (x029 & ~x069 & (~x061 | ~x093)));
  assign new_n266_ = ~new_n267_ & new_n268_ & (x021 | (new_n189_ & (new_n185_ | ~x125)));
  assign new_n267_ = (~x021 | ~x061 | ~x093) & ~x069 & (x101 | x125);
  assign new_n268_ = (x013 | (~x061 & ~x093)) & (~x101 | x037 | ~x069);
  assign new_n269_ = (~x069 | (new_n189_ & (x021 | ~x029))) & (new_n270_ | ~x029 | (x021 & (x013 | x069)));
  assign new_n270_ = ~x005 & ((~x101 & ~x125) | (x061 & x093));
  assign new_n271_ = (~x037 | (new_n189_ & (x021 | ~x029))) & (((~x021 | ~x069) & (~x029 | ~x037)) | (x013 & x037));
