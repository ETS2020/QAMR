...
module FAU ( 
  ...
  assign z06 = z15 | (x046 & (new_n207_ | ~new_n225_ | (~new_n222_ & x078)));
  ...
  assign new_n277_ = ~x077 & (~new_n278_ | (x029 & ~x069 & (~x061 | ~x093)));
  ...
  assign new_n291_ = (~new_n293_ | ~x078) & (new_n292_ | (~new_n294_ & (x078 | (~new_n295_ & ~new_n296_))));
  assign new_n292_ = ~x110 & ~x118;
  assign new_n293_ = x022 & x070;
  assign new_n294_ = x014 & ~x086;
  assign new_n295_ = x006 & (x070 ? ~x038 : ~x022);
  assign new_n296_ = ~x086 & (x022 | (x030 & ~x070 & (~x062 | ~x094)));
