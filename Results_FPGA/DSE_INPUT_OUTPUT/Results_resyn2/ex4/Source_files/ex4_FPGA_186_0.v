...
module FAU ( 
  ...
  assign z05 = z15 | (x045 & (~new_n197_ | (~new_n181_ & (~x037 | x053))));
  ...
  assign new_n216_ = (~x078 | (~new_n217_ & new_n220_)) & ~z15 & (new_n221_ | x078);
  ...
  assign z13 = ~x045 & ((~new_n260_ & x057) | (~new_n279_ & x085));
  ...
  assign z14 = ~z15 & ~x046 & (~new_n294_ | (~new_n281_ & (x038 | ~x054)));
