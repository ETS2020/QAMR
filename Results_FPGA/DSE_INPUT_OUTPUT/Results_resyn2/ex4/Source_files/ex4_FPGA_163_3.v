// Benchmark "FAU" written by ABC on Wed Aug 26 09:28:18 2020
...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n207_ & ~x085) | (~new_n189_ & ~x105));
  assign new_n189_ = new_n202_ & (~x053 | (~new_n190_ & (~x077 | (~new_n194_ & ~new_n197_))));
  assign new_n190_ = (~x109 | ~x117) & (new_n193_ | (x077 & (new_n191_ | new_n192_)));
  assign new_n191_ = ~x005 & (x069 ? (x021 & x061) : x037);
  assign new_n192_ = x085 & (~x021 | (x069 & ~x029 & (x061 | x093)));
  assign new_n193_ = ~x013 & x085;
  assign new_n194_ = x085 & ((~new_n195_ & ~x069) | (new_n196_ & (x021 | (x013 & x069))));
  assign new_n195_ = (~x021 | x029) & x061 & x093;
  assign new_n196_ = ~x029 & (x061 | x093) & (~x101 | ~x125);
  assign new_n197_ = ~x005 & ((~new_n198_ & ~x125) | ~new_n199_ | new_n200_ | new_n201_);
  assign new_n198_ = (~x069 | (~x061 & (x021 | ~x093))) & ((~x109 & ~x117) | ~x021 | x069);
  assign new_n199_ = (~x037 | ((x069 | x101) & (x061 | ~x021 | ~x069))) & (~x061 | ~x069 | x101);
  assign new_n200_ = ~x021 & ((x013 & ~x061) | (x093 & x069 & ~x101));
  assign new_n201_ = (~x029 | ~x093) & ((x069 & x021 & x061) | (x013 & ~x021));
  assign new_n202_ = new_n206_ & (~x077 | (~new_n204_ & ~new_n205_ & (~new_n203_ | ~x037)));
  assign new_n203_ = ~x021 & ~x069;
  assign new_n204_ = x013 & ((~x021 & ~x069) | (~x029 & ~x037 & x085));
  assign new_n205_ = ((x021 & ~x029) | ~x061 | ~x093) & ~x037 & x085;
  assign new_n206_ = (x037 | x053) & (x077 | (x013 & (~x053 | x021 | x069)));
  assign new_n207_ = (x077 | (x013 & (~new_n203_ | ~x053) & (x005 | (~x037 & x053)))) & (x037 | x053) & (~x077 | ((x005 | (~x013 & ~x053)) & (~new_n203_ | (~x013 & ~x037))));
  ...
  assign new_n222_ = (~x078 | (~new_n223_ & new_n226_)) & ~z07 & (new_n227_ | x078);
  ...
  assign new_n234_ = (~x056 | ~x088) & (x096 | x120);
  ...
  assign new_n281_ = (x085 | (new_n203_ & x061)) & x005 & (~x053 | (~x013 & x085));
