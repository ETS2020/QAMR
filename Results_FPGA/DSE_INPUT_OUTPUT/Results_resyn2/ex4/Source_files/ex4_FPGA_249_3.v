...
module FAU ( 
  ...
  assign z06 = (z07 | x046) & (~new_n202_ | (x054 & (new_n190_ | ~new_n198_)));
  ...
  assign new_n207_ = (x078 | (x014 & (~new_n206_ | ~x038))) & ~z07 & (x038 | x054);
  ...
  assign z14 = ~z07 & ~x046 & (~new_n278_ | (~new_n265_ & ~x054));
