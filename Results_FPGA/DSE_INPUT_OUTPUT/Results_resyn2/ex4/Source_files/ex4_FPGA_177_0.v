...
module FAU ( 
  ...
  assign new_n177_ = ((~new_n178_ & x011) | (~new_n179_ & ~x011) | (x035 & ~x051)) & ((~new_n179_ & x011) | ~x035 | (~new_n178_ & ~x011)) & ((~new_n178_ & ~new_n179_) | ~x011 | ~x075) & (x035 | x051) & (x011 | x075);
  ...
  assign z13 = ~new_n257_ & ~x045 & x085;
  assign new_n257_ = (~x077 | ((~new_n258_ | x053) & ~x013 & (~x005 | (x037 & ~x053)))) & (~x037 | ~x053) & (x077 | ((~x005 | (x013 & x053)) & (~new_n258_ | (x013 & x037))));
  assign new_n258_ = x021 & x069;
  assign z14 = (~new_n272_ | (~x054 & (new_n260_ | ~new_n268_))) & (z07 | ~x046);
  assign new_n260_ = ~x078 & (new_n261_ | (x006 & (~new_n266_ | (~new_n264_ & ~x070))));
  ...
  assign new_n264_ = ~new_n265_ & ((~x102 & ~x126) | (x022 & x062 & x094));
  assign new_n265_ = (~x022 | (~x014 & ~x038)) & (x030 | x062 | x094);
  assign new_n266_ = new_n267_ & (x038 | ~x070 | ~x102);
  assign new_n267_ = ~x086 & (x022 | ~x126 | (x110 & x118));
  assign new_n268_ = ~new_n271_ & ((~x110 & ~x118) | (~new_n269_ & (~x014 | x086)));
  assign new_n269_ = ~x078 & (new_n270_ | (x006 & (x070 ? ~x038 : ~x022)));
  assign new_n270_ = ~x086 & (x022 | ((~x062 | ~x094) & x030 & ~x070));
  assign new_n271_ = x078 & x022 & x070;
  assign new_n272_ = new_n277_ & (x078 | (~new_n273_ & ~new_n275_));
  assign new_n273_ = x038 & ((~new_n274_ & ~x070) | (~new_n262_ & ~x086));
  assign new_n274_ = (~x006 | (~x102 & ~x126)) & (x014 | ~x030 | x086);
  assign new_n275_ = (new_n276_ | (x022 & x070)) & (~x014 | (x022 & x070 & (~x038 | x054)));
  assign new_n276_ = x006 & x086;
  assign new_n277_ = (~x078 | (~x014 & (~new_n276_ | x038))) & ~z07 & (~x038 | ~x054);
  assign z16 = 1'b0;
  assign z20 = 1'b0;
  assign z21 = 1'b0;
  assign z22 = 1'b0;
