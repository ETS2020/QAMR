...
module FAU ( 
  ...
  assign z06 = ~z07 & x046 & (new_n223_ | ~new_n227_ | (~new_n210_ & x054));
  ...
  assign new_n223_ = x078 & (~new_n226_ | (~new_n224_ & ~x038));
  assign new_n224_ = (new_n214_ | ~x086) & (~x070 | (~new_n225_ & (~x086 | ~x014 | x030)));
  assign new_n225_ = ~x006 & (~x102 | ~x126);
  ...
  assign new_n288_ = new_n289_ & (new_n222_ | x022 | ~x126);
  ...
  assign new_n295_ = ~new_n297_ & (~x038 | ((new_n284_ | x086) & (new_n296_ | x070)));
