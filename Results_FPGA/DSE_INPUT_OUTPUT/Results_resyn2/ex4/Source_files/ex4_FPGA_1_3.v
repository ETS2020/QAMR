...
module FAU ( 
  ...
  assign new_n254_ = ~x085 & (x021 | ~x125 | (x109 & x117));
  assign new_n255_ = (new_n245_ | ~x013 | x085) & (~x077 | ~x021 | ~x069);
