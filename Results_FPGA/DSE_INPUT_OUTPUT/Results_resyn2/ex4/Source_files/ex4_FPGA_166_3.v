// Benchmark "FAU" written by ABC on Wed Aug 26 09:28:19 2020
...
module FAU ( 
  ...
  assign z08 = ~z07 & ~x040 & (~new_n219_ | (~x048 & (new_n206_ | ~new_n214_)));
  ...
  assign new_n212_ = (new_n213_ | ~x064) & (~new_n208_ | ~x024 | (x016 & (x008 | x064)));
  ...
  assign z14 = ~z07 & ~x046 & (new_n258_ | ~new_n276_ | (~new_n273_ & ~x078));
