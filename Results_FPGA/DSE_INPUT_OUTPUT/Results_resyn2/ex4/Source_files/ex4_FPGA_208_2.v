...
module FAU ( 
  ...
  assign z06 = z15 | (x046 & (new_n202_ | ~new_n220_ | (~new_n217_ & x078)));
  ...
  assign new_n232_ = ~x080 & (x016 | ~x120 | (x104 & x112));
  ...
  assign z13 = ~x045 & (~new_n269_ | (~x053 & (~new_n268_ | (~new_n259_ & ~x077))));
  assign new_n259_ = ~new_n260_ & ~new_n262_ & (~x005 | (new_n267_ & (new_n265_ | x069)));
  assign new_n260_ = ~new_n189_ & (new_n261_ | (x005 & (new_n193_ | new_n199_)));
  assign new_n261_ = ~x085 & (x021 | (~x069 & x029 & (~x061 | ~x093)));
  assign new_n262_ = ~x085 & ((~new_n263_ & x069) | (new_n264_ & (~x021 | (~x013 & ~x069))));
  ...
  assign new_n267_ = (~new_n193_ | ~x101) & ~x085 & (new_n200_ | x021 | ~x125);
  assign new_n268_ = (~x077 | ~x021 | ~x069) & (new_n189_ | ~x013 | x085);
  assign new_n269_ = new_n272_ & (x077 | (new_n271_ & (new_n270_ | ~x037 | x085)));
  assign new_n270_ = ~x061 & ~x093 & (~x029 | (x021 & (x013 | x069)));
  assign new_n271_ = (~x021 | x037 | ~x069) & (x013 | ((~x021 | ~x069) & (~x005 | ~x085)));
  assign new_n272_ = (~x037 | ~x053) & (~x077 | (~x013 & (x037 | ~x005 | ~x085)));
  assign z14 = z15 | (~x046 & (new_n274_ | ~new_n292_ | (~new_n289_ & ~x078)));
