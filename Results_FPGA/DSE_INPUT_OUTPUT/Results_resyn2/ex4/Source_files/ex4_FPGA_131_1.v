// Benchmark "FAU" written by ABC on Wed Aug 26 09:27:39 2020
...
module FAU ( 
  ...
  assign new_n252_ = ((~new_n253_ & ~x010) | (~new_n254_ & x010) | (~x034 & x050)) & ((~new_n254_ & ~x010) | x034 | (~new_n253_ & x010)) & (x010 | x074 | (~new_n253_ & ~new_n254_)) & (~x010 | ~x074) & (~x034 | ~x050);
  assign new_n253_ = x018 & x066;
  assign new_n254_ = x002 & x082;
  assign z11 = z07 | (~new_n256_ & ~x043);
  assign new_n256_ = ((~new_n257_ & ~x011) | (~new_n258_ & x011) | (~x035 & x051)) & ((~new_n258_ & ~x011) | x035 | (~new_n257_ & x011)) & (x011 | x075 | (~new_n257_ & ~new_n258_)) & (~x011 | ~x075) & (~x035 | ~x051);
  assign new_n257_ = x019 & x067;
  assign new_n258_ = x003 & x083;
  assign z12 = ~new_n260_ & ~z07 & ~x044;
  assign new_n260_ = ((~new_n261_ & ~x012) | (~new_n262_ & x012) | (~x036 & x052)) & ((~new_n262_ & ~x012) | x036 | (~new_n261_ & x012)) & (x012 | x076 | (~new_n261_ & ~new_n262_)) & (~x012 | ~x076) & (~x036 | ~x052);
  assign new_n261_ = x020 & x068;
  assign new_n262_ = x004 & x084;
  assign z13 = ~x045 & ((~new_n283_ & x085) | (~new_n264_ & ~x121));
