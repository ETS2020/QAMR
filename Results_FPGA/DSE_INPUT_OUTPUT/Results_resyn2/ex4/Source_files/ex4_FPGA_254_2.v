// Benchmark "FAU" written by ABC on Wed Aug 26 09:29:33 2020
...
module FAU ( 
  ...
  assign z02 = z07 | (x042 & (new_n173_ | (~x010 & ~x074)));
  ...
  assign z05 = x045 & ((~new_n203_ & ~x085) | (~new_n185_ & x108));
  ...
  assign new_n197_ = (~x029 | ~x093) & ((x013 & ~x021) | (x069 & x021 & x061));
  ...
  assign z13 = z07 | (~x045 & (~new_n278_ | (~new_n262_ & (x037 | ~x053))));
  ...
  assign new_n266_ = ~x085 & ((~x021 & x029) | x061 | x093);
  ...
  assign new_n274_ = ~x085 & (x021 | (x029 & ~x069 & (~x061 | ~x093)));
  ...
  assign new_n282_ = ~x013 & ((x037 & ~x053) | ~x005 | ~x085);
  assign z14 = z07 | (~x046 & (~new_n297_ | (~new_n284_ & (x038 | ~x054))));
