// Benchmark "FAU" written by ABC on Wed Aug 26 09:25:50 2020
...
module FAU ( 
  ...
  assign z05 = z15 | (x045 & (new_n181_ | ~new_n199_ | (~new_n196_ & x077)));
  assign new_n181_ = x053 & (~new_n190_ | (x077 & (new_n182_ | new_n185_)));
  ...
  assign new_n185_ = ~x005 & ((x069 & (new_n186_ | new_n187_)) | new_n188_ | ~new_n189_);
  assign new_n186_ = (x021 | (x013 & x037)) & (~x029 | ~x061 | ~x093);
  assign new_n187_ = (~x101 | ~x125) & (x021 | x061 | x093);
  assign new_n188_ = ~x101 & x037 & ~x069;
  assign new_n189_ = x085 & ((~x109 & ~x117) | ~x021 | x125);
  assign new_n190_ = (new_n191_ | (~new_n194_ & (~x077 | (~new_n192_ & ~new_n193_)))) & (~new_n195_ | x077);
  assign new_n191_ = x109 & x117;
  assign new_n192_ = ~x005 & (x069 ? x021 : x037);
  assign new_n193_ = x085 & (~x021 | ((x061 | x093) & ~x029 & x069));
  assign new_n194_ = ~x013 & x085;
  assign new_n195_ = ~x021 & ~x069;
  assign new_n196_ = (new_n197_ | x037) & (x005 | ~x013 | x085) & (~new_n195_ | (~x013 & ~x037));
  assign new_n197_ = (new_n198_ | ~x069) & (new_n183_ | ~x085);
  assign new_n198_ = (x005 | (x101 & x125)) & (~x085 | ~x013 | x029);
  assign new_n199_ = (x037 | x053) & (x077 | (x013 & (x085 | x005 | ~x037)));
  assign z06 = z15 | (x046 & (new_n201_ | ~new_n219_ | (~new_n216_ & x078)));
  ...
  assign z13 = z15 | (~x045 & (new_n258_ | ~new_n276_ | (~new_n273_ & ~x077)));
  assign new_n258_ = ~x053 & (~new_n267_ | (~x077 & (new_n259_ | new_n262_)));
  ...
  assign new_n265_ = x101 & ~x037 & x069;
  assign new_n266_ = ~x085 & ((x109 & x117) | x021 | ~x125);
  assign new_n267_ = (~new_n269_ | ~x077) & (new_n268_ | (~new_n270_ & (x077 | (~new_n271_ & ~new_n272_))));
  assign new_n268_ = ~x109 & ~x117;
  assign new_n269_ = x021 & x069;
  assign new_n270_ = x013 & ~x085;
  assign new_n271_ = x005 & (x069 ? ~x037 : ~x021);
  assign new_n272_ = ~x085 & (x021 | ((~x061 | ~x093) & x029 & ~x069));
  assign new_n273_ = (new_n274_ | ~x037) & ((x013 & x037) | (~new_n269_ & (x013 | ~x005 | ~x085)));
  assign new_n274_ = (new_n260_ | x085) & (new_n275_ | x069);
  assign new_n275_ = (~x005 | (~x101 & ~x125)) & (x013 | ~x029 | x085);
  assign new_n276_ = (~x037 | ~x053) & (~x077 | (~x013 & (x037 | ~x005 | ~x085)));
  assign z14 = z15 | (~x046 & (new_n278_ | ~new_n296_ | (~new_n293_ & ~x078)));
  ...
  assign new_n292_ = ~x086 & (x022 | ((~x062 | ~x094) & x030 & ~x070));
  assign new_n293_ = (new_n294_ | ~x038) & ((x014 & x038) | (~new_n289_ & (x014 | ~x006 | ~x086)));
  assign new_n294_ = (new_n280_ | x086) & (new_n295_ | x070);
