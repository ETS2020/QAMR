...
module FAU ( 
  ...
  assign z06 = z17 | (x046 & (new_n214_ | ~new_n218_ | (~new_n201_ & x054)));
  ...
  assign z11 = ~x043 & (new_n249_ | (~new_n251_ & x011) | new_n254_ | (~new_n253_ & ~x011));
  assign new_n249_ = ~x085 & ((x035 & x051) | (~x075 & new_n250_ & ~x035));
  assign new_n250_ = x019 & x067;
  assign new_n251_ = (x035 | x085 | (~new_n250_ & ~x075)) & (x051 | (~new_n252_ & ~x075));
  assign new_n252_ = x003 & x083;
  assign new_n253_ = (~new_n252_ | x035 | x085) & (~new_n250_ | x051);
  assign new_n254_ = ~x051 & (~x035 | ~x075) & (new_n252_ | (new_n250_ & ~x035));
