...
module FAU ( 
  ...
  assign z14 = (z15 | ~x046) & (~new_n268_ | (~x054 & (new_n256_ | ~new_n264_)));
  ...
  assign new_n273_ = (~x078 | (~x014 & (~new_n272_ | x038))) & ~z15 & (~x038 | ~x054);
  assign z07 = 1'b0;
  assign z17 = 1'b0;
  assign z18 = 1'b0;
  assign z19 = 1'b0;
