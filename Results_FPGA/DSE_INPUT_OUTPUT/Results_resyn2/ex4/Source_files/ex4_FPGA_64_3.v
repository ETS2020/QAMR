...
module FAU ( 
  ...
  assign z06 = ~z15 & x046 & (new_n201_ | ~new_n205_ | (~new_n188_ & x054));
  ...
  assign z08 = z15 | (~x040 & (~new_n220_ | (~x048 & (new_n207_ | ~new_n215_))));
  ...
  assign new_n271_ = (new_n272_ | ~x014 | x086) & (~x078 | ~x022 | ~x070);
