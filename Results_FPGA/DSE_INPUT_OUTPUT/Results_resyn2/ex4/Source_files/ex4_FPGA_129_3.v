...
module FAU ( 
  ...
  assign z06 = ~z07 & x046 & (new_n199_ | ~new_n203_ | (~new_n186_ & x054));
  ...
  assign new_n199_ = x078 & (~new_n202_ | (~new_n200_ & ~x038));
  assign new_n200_ = (new_n190_ | ~x086) & (~x070 | (~new_n201_ & (~x086 | ~x014 | x030)));
  assign new_n201_ = ~x006 & (~x102 | ~x126);
  ...
  assign new_n251_ = ~x085 & ((x109 & x117) | x021 | ~x125);
  ...
  assign new_n273_ = (~x006 | (~x102 & ~x126)) & (x086 | x014 | ~x030);
