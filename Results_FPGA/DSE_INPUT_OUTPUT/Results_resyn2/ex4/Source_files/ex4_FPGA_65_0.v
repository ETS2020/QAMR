...
module FAU ( 
  ...
  assign new_n200_ = x038 & (new_n201_ | ~new_n203_ | new_n204_);
  ...
  assign z06 = x046 & (~new_n217_ | (x054 & (~new_n227_ | (~new_n206_ & x078))));
  assign new_n206_ = (new_n207_ | ~x086) & (x006 | (~new_n212_ & (~x085 | (~new_n216_ & x086))));
  assign new_n207_ = (z15 | new_n208_) & (x030 | (~new_n209_ & (new_n210_ | ~new_n211_)));
  assign new_n208_ = (x022 | (x110 & x118)) & (x070 | (x062 & x094));
  assign new_n209_ = ~x070 & (x038 | (x022 & x085));
  assign new_n210_ = x110 & x118 & ((x102 & x126) | (~x014 & ~x022));
  assign new_n211_ = x038 & (x062 | x094);
  assign new_n212_ = x038 & (new_n215_ | (~new_n213_ & ~new_n214_));
  assign new_n213_ = ~x022 & x070 & ((~x062 & ~x094) | (x102 & x126));
  assign new_n214_ = x102 & x126 & x110 & x118;
  assign new_n215_ = (~x030 | ~x062 | ~x094) & x070 & (x014 | x022);
  assign new_n216_ = (x070 | (~x126 & (x110 | x118))) & x022 & (~x102 | ~x126 | ~x110 | ~x118);
  assign new_n217_ = (new_n218_ | x038 | ~x085) & new_n223_ & (new_n221_ | x014);
  assign new_n218_ = x054 & (~x078 | (~new_n220_ & (new_n219_ | ~x070)));
  assign new_n219_ = (x006 | (x102 & x126)) & (~x086 | ~x014 | x030);
  assign new_n220_ = x086 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n221_ = (x078 | (~x038 & (~x054 | ~x085))) & (new_n222_ | ~x054 | ~x086 | (~x038 & ~x085));
  assign new_n222_ = x110 & x118;
  assign new_n223_ = (~new_n224_ | ~x078) & ((~new_n225_ & ~new_n226_) | (~x014 & x078));
  assign new_n224_ = ~x022 & x038 & ~x070;
  assign new_n225_ = ~x086 & ~x006 & x038;
  assign new_n226_ = ~x022 & ~x070 & x054 & x085;
  ...
  assign new_n279_ = new_n280_ & ((new_n192_ & ~new_n277_) | ~x037 | x077 | x085);
  assign new_n280_ = (~x013 | ~x077) & (~x053 | (new_n281_ & (~x085 | ~x005 | x013)));
  assign new_n281_ = ~x037 & (x077 | ~x021 | ~x069);
  assign z14 = z15 | (~x046 & (~new_n293_ | (~new_n283_ & ~x078)));
  assign new_n283_ = new_n289_ & (x054 | (~new_n286_ & ~new_n292_ & (new_n284_ | ~x006)));
  assign new_n284_ = (~x126 | (~new_n285_ & (new_n222_ | x022))) & ~x086 & (~new_n285_ | ~x102);
  assign new_n285_ = ~x038 & (~x062 | ~x094);
  assign new_n286_ = (~x014 | ~x022) & (new_n288_ | (~new_n287_ & (x102 | x126)));
  assign new_n287_ = (~x006 | x038) & ((x062 & x094) | ~x030 | x086);
  assign new_n288_ = x006 & ~x038 & (x030 | x062 | x094);
  assign new_n289_ = ~new_n290_ & (~x038 | (~new_n291_ & (~x102 | ~x006 | x070)));
  assign new_n290_ = x022 & ((x054 & x070) | (x038 & x126 & x006 & ~x070));
  assign new_n291_ = ~x086 & (x062 | x094 | (x030 & (~x014 | ~x022)));
  assign new_n292_ = x070 & ~x086 & (x062 | x094 | (x030 & ~x038));
  assign new_n293_ = new_n297_ & (new_n294_ | (~x110 & ~x118));
  assign new_n294_ = (x078 | (~new_n295_ & (new_n296_ | x054 | x086))) & (~x014 | x054 | x086);
  assign new_n295_ = x006 & ((~x022 & ~x038 & ~x054) | (x038 & ~x070));
  assign new_n296_ = ~x022 & (~x030 | x038 | (x062 & x094));
  assign new_n297_ = (~x054 | (~x038 & (~x070 | ~x014 | ~x022))) & new_n298_ & ((x014 & x038) | ~x070 | ~x022 | x054);
  assign new_n298_ = (~x014 | ~x078) & (~x006 | ~x086 | (x054 ? x014 : x038));
  assign z07 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
  assign z18 = 1'b0;
