// Benchmark "FAU" written by ABC on Wed Aug 26 09:26:13 2020
...
module FAU ( 
  ...
  assign z01 = z16 | (x041 & (new_n167_ | (~x009 & ~x073)));
  ...
  assign new_n182_ = (new_n183_ | ~x012 | ~x076) & (x036 | x052) & ~z16 & (x012 | x076);
  assign new_n183_ = (x020 | x068) & (x004 | x084);
  assign new_n184_ = ~x020 & ~x068;
  assign new_n185_ = ~x004 & ~x084;
  assign z05 = z16 | (x045 & (~new_n201_ | (x077 & (new_n187_ | ~new_n194_))));
  assign new_n187_ = ~x005 & (new_n193_ | (x053 & (~new_n191_ | (~new_n188_ & x069))));
  assign new_n188_ = new_n190_ & ((~x013 & ~x021) | (new_n189_ & x029));
  assign new_n189_ = x061 & x093;
  assign new_n190_ = ((~x061 & ~x093) | (x101 & x125)) & (~x021 | (x101 & x117));
  assign new_n191_ = ~new_n192_ & x085 & (~x021 | x125);
  assign new_n192_ = x037 & ~x069 & (~x101 | ~x117);
  assign new_n193_ = x013 & ~x085;
  assign new_n194_ = (~x085 | (~new_n195_ & new_n198_)) & (~new_n200_ | (~x013 & ~x037));
  assign new_n195_ = ~x029 & ((~new_n196_ & new_n197_) | (~x037 & x013 & x069));
  assign new_n196_ = ((x101 & x125) | (~x021 & (~x013 | ~x069))) & (~x069 | x117);
  assign new_n197_ = x053 & (x061 | x093);
  assign new_n198_ = (new_n199_ | (x037 & (~x053 | x069))) & (x117 | x021 | ~x053);
  assign new_n199_ = (~x021 | x029) & x061 & x093;
  assign new_n200_ = ~x021 & ~x069;
  assign new_n201_ = (~x053 | (~new_n202_ & (~new_n200_ | x077))) & (new_n203_ | x077) & (x053 | (x037 & (~new_n200_ | ~x077)));
  assign new_n202_ = ~x117 & ~x013 & x085;
  assign new_n203_ = x013 & (x085 | x005 | ~x037);
  assign z06 = ~z16 & x046 & (~new_n218_ | (~new_n205_ & (~x038 | x054)));
  ...
  assign z08 = new_n164_ & (~new_n238_ | (~x048 & (~new_n233_ | (~new_n225_ & ~x072))));
  assign new_n225_ = (new_n226_ | x080) & (~x000 | (~new_n232_ & ~x080 & (new_n228_ | new_n230_)));
  ...
  assign new_n233_ = (~new_n236_ | ~x072) & (new_n237_ | ((~x008 | x080) & (new_n234_ | x072)));
  ...
  assign z13 = z16 | (~x045 & (~new_n276_ | (~x077 & (new_n261_ | ~new_n266_))));
  assign new_n261_ = ~x085 & (new_n262_ | (~new_n264_ & ~new_n189_ & x029 & ~x053));
  assign new_n262_ = ~new_n263_ & x037 & (x029 | x061 | x093);
  assign new_n263_ = ~x109 & (x069 | (~x061 & ~x093 & x013 & x021));
  assign new_n264_ = (new_n265_ | (x021 & (x013 | x069))) & ~x109 & (x069 | ~x117);
  assign new_n265_ = ~x101 & ~x125;
  assign new_n266_ = (new_n267_ | ~x069) & (~new_n275_ | (new_n271_ & ~new_n273_ & ~new_n274_));
  assign new_n267_ = ~new_n268_ & ~new_n269_ & new_n270_;
  assign new_n268_ = ~x037 & (x021 | (x101 & x005 & ~x053));
  assign new_n269_ = (x021 | ~x053) & ~x085 & (x061 | x093);
  assign new_n270_ = (~x029 | x053 | x021 | x109) & (~x021 | (x013 & ~x053));
  assign new_n271_ = ~new_n272_ & ~x085 & (~x125 | ~x109 | x117);
  assign new_n272_ = x029 & ((~x013 & ~x069) | (~x021 & ~x109));
  assign new_n273_ = (~new_n189_ | (~x021 & x101)) & ~x069 & (x101 | x125);
  assign new_n274_ = (x061 | x093 | (~x021 & x125)) & ~x109 & (~x013 | ~x021);
  assign new_n275_ = x005 & (~x053 | (~x013 & x085));
  assign new_n276_ = new_n279_ & (new_n277_ | (~x109 & ~x117));
  assign new_n277_ = (new_n278_ | x077) & (~new_n193_ | x053);
  assign new_n278_ = (~x005 | x053 | (x037 & x069)) & ((x053 & ~x069) | ~x021 | x085);
  assign new_n279_ = (~x037 | ~x053) & (~x077 | (new_n280_ & (~x085 | ~x005 | x037)));
  assign new_n280_ = ~x013 & (~x069 | ~x021 | x053);
  assign z14 = (z16 | ~x046) & (~new_n295_ | (~new_n282_ & ~x054));
  assign new_n282_ = new_n293_ & (x078 | (~new_n283_ & ~new_n288_ & (new_n286_ | x086)));
  assign new_n283_ = (new_n284_ | new_n285_) & (x110 | x118);
  ...
  assign new_n293_ = (~new_n294_ | ~x078) & (~x014 | x086 | (~x110 & ~x118));
  ...
  assign new_n300_ = ~new_n301_ & ~z16 & (~x038 | ~x054);
