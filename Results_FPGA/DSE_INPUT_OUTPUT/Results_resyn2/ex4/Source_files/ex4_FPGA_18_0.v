...
module FAU ( 
  ...
  assign z06 = (z07 | x046) & (~new_n216_ | (x054 & (new_n204_ | ~new_n212_)));
  ...
  assign new_n217_ = ~x038 & ((~new_n218_ & x070) | (~new_n206_ & x086));
  ...
  assign new_n221_ = (x078 | (x014 & (~new_n220_ | ~x038))) & ~z07 & (x038 | x054);
  ...
  assign new_n235_ = x032 & ((~new_n236_ & ~x080) | (~new_n237_ & ~x064));
  ...
  assign new_n271_ = ~x077 & ~x085 & (~x061 | ~x093) & (x101 | x125);
