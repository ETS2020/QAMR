...
module FAU ( 
  ...
  assign z05 = (~x053 & ~x085) | (x045 & (~new_n197_ | (x053 & (new_n183_ | ~new_n190_))));
  assign new_n183_ = x077 & (new_n188_ | (x069 & (new_n186_ | (~new_n184_ & ~x005))));
  assign new_n184_ = ((~x013 & ~x021) | (x029 & x061 & x093)) & (new_n185_ | (~x021 & ~x061 & ~x093));
  assign new_n185_ = x101 & x125;
  assign new_n186_ = new_n187_ & ~new_n185_ & x013;
  assign new_n187_ = ~x029 & x085 & (x061 | x093);
  assign new_n188_ = ~new_n185_ & x021 & (new_n187_ | new_n189_);
  assign new_n189_ = ~x005 & ~x125 & (x109 | x117);
  ...
  assign new_n193_ = ~x069 & (new_n194_ | (x077 & (new_n195_ | new_n196_)));
  assign new_n194_ = ~x021 & (x013 | x037);
  assign new_n195_ = x085 & (~x061 | ~x093 | (x021 & ~x029));
  assign new_n196_ = ~x101 & ~x005 & x037;
  assign new_n197_ = ~new_n198_ & ~new_n201_ & (x037 | x053) & (~x037 | x005 | x085);
  assign new_n198_ = x077 & ((~new_n199_ & ~x037 & x085) | new_n200_ | (~x005 & ~x085));
  assign new_n199_ = x061 & x093 & (x029 | (~x021 & (~x013 | ~x069)));
  assign new_n200_ = ~x053 & ~x021 & ~x069;
  assign new_n201_ = ~x077 & (~x013 | (x053 & ~x021 & ~x069));
  assign z06 = ~z16 & x046 & (new_n216_ | ~new_n220_ | (~new_n203_ & x054));
  ...
  assign z13 = z16 | (~x045 & (~new_n258_ | new_n257_ | (x013 & x077)));
  assign new_n257_ = (x053 | (x021 & x069)) & ~x013 & (~x053 | (x005 & x085));
  assign new_n258_ = (~x053 | (~x037 & (x077 | ~x021 | ~x069))) & ((x037 & (~x005 | x077)) | x053 | (~x005 & (~x021 | ~x069)));
  assign z14 = ~z16 & ~x046 & (~new_n273_ | (~new_n260_ & ~x054));
  ...
  assign new_n267_ = (x030 | x062 | x094) & (~x022 | (~x014 & ~x038));
