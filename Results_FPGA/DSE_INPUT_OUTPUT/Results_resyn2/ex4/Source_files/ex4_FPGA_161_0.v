...
module FAU ( 
  ...
  assign z05 = z15 | (x045 & (~new_n203_ | (~new_n187_ & (~x037 | x053))));
  assign new_n187_ = new_n196_ & (~x077 | (~new_n190_ & ~new_n192_ & (new_n188_ | new_n202_)));
  assign new_n188_ = ((~x061 & ~x093) | (~new_n189_ & (x005 | ~x069))) & (x005 | ~x021 | ~x069);
  assign new_n189_ = x085 & ~x029 & (x021 | (x013 & x069));
  assign new_n190_ = ~x069 & (new_n191_ | (~x005 & x037 & ~x101));
  assign new_n191_ = x085 & (~x061 | ~x093 | (x021 & ~x029));
  assign new_n192_ = (new_n193_ | new_n194_ | ~new_n195_) & ~x005;
  assign new_n193_ = ~x029 & (x021 | (x013 & x069));
  assign new_n194_ = (x013 | x021) & (~x061 | ~x093);
  assign new_n195_ = x085 & ((~x109 & ~x117) | ~x021 | x125);
  assign new_n196_ = new_n201_ & (new_n197_ | (~new_n200_ & (~x077 | (~new_n198_ & ~new_n199_))));
  assign new_n197_ = x109 & x117;
  assign new_n198_ = ~x005 & (x037 | x069);
  assign new_n199_ = x085 & (~x021 | (~x029 & x069 & (x061 | x093)));
  assign new_n200_ = ~x013 & x085;
  assign new_n201_ = x053 & (x077 | x021 | x069);
  assign new_n202_ = x101 & x125;
  assign new_n203_ = x077 ? new_n204_ : new_n207_;
  assign new_n204_ = (new_n205_ | x037 | ~x085) & ~new_n206_ & (~x013 | x005 | x085);
  assign new_n205_ = (x029 | (~x021 & (~x013 | ~x069))) & x061 & x093;
  assign new_n206_ = ~x021 & ~x069 & (x013 | x037 | ~x053);
  assign new_n207_ = x013 & ((~x037 & x053) | x005 | x085);
  assign z06 = ~z15 & x046 & (~new_n222_ | (~new_n209_ & ~new_n228_));
  ...
  assign z08 = ~z15 & ~x040 & (~new_n243_ | (~x048 & (new_n230_ | ~new_n238_)));
  ...
  assign z13 = ~x045 & ((~new_n285_ & x085) | (~new_n266_ & x121));
  ...
  assign new_n270_ = ~x021 & (x069 | ~x029 | (x061 & x093));
  ...
  assign new_n279_ = x125 & (~x061 | x069 | (x021 & ~x093));
  assign new_n280_ = new_n284_ & (x077 | (~new_n282_ & ~new_n283_ & (~new_n281_ | x037)));
  assign new_n281_ = x021 & x069;
  assign new_n282_ = ~x013 & ((x021 & x069) | (x029 & x037 & ~x085));
  assign new_n283_ = (x061 | x093 | (~x021 & x029)) & x037 & ~x085;
  assign new_n284_ = (~x037 | ~x053) & (~x077 | (~x013 & (x053 | ~x021 | ~x069)));
  assign new_n285_ = (~x077 | (~x013 & (~new_n281_ | x053) & (~x005 | (x037 & ~x053)))) & (~x037 | ~x053) & (x077 | ((~x005 | (x013 & x053)) & (~new_n281_ | (x013 & x037))));
  assign z14 = z15 | (~x046 & (~new_n300_ | (~new_n287_ & (x038 | ~x054))));
