// Benchmark "FAU" written by ABC on Wed Aug 26 09:27:47 2020
...
module FAU ( 
  ...
  assign z05 = (~new_n198_ | (~new_n185_ & ~new_n204_)) & ~z16 & x045;
  assign new_n185_ = new_n196_ & (~x077 | (~new_n186_ & ~new_n191_ & (new_n189_ | ~x085)));
  ...
  assign new_n189_ = (x069 | (x061 & x093 & (~x021 | x029))) & (~new_n190_ | x029 | (~x061 & ~x093));
  assign new_n190_ = (~x101 | ~x125) & (x021 | (x013 & x069));
  ...
  assign new_n194_ = ~x101 & x037 & ~x069;
  assign new_n195_ = x085 & ((~x109 & ~x117) | ~x021 | x125);
  assign new_n196_ = (new_n187_ | x013 | ~x085) & x053 & (~new_n197_ | x077);
  assign new_n197_ = ~x021 & ~x069;
  assign new_n198_ = x077 ? (~new_n199_ & new_n202_) : new_n203_;
  assign new_n199_ = ~x037 & ((~new_n201_ & x069) | (~new_n200_ & x085));
  assign new_n200_ = (~x021 | x029) & x061 & x093;
  assign new_n201_ = (x005 | (x101 & x125)) & (~x085 | ~x013 | x029);
  assign new_n202_ = (x005 | ~x013 | x085) & (~new_n197_ | (x053 & ~x013 & ~x037));
  assign new_n203_ = x013 & ((~x037 & x053) | x005 | x085);
  assign new_n204_ = x037 & ~x053;
  assign z06 = x046 & ((~new_n228_ & ~x054) | (~x087 & (~new_n225_ | (~new_n206_ & x054))));
  assign new_n206_ = ~new_n216_ & new_n220_ & (~x078 | (~new_n207_ & new_n212_));
  assign new_n207_ = x070 & ((~new_n208_ & ~new_n209_ & ~x006) | (new_n211_ & (new_n210_ | ~x006)));
  assign new_n208_ = (~x022 | (x102 & x126)) & x030 & x062 & x094;
  assign new_n209_ = ~x022 & (~x014 | ~x038);
  assign new_n210_ = x086 & x014 & ~x030;
  assign new_n211_ = (x062 | x094) & (~x102 | ~x126);
  assign new_n212_ = ~new_n213_ & ((~new_n214_ & ~new_n215_) | ~x022 | (x102 & x126));
  assign new_n213_ = ~x006 & ~x086;
  assign new_n214_ = ~x030 & x086 & (x062 | x094);
  assign new_n215_ = (x110 | x118) & ~x006 & ~x126;
  assign new_n216_ = (~x110 | ~x118) & (new_n219_ | (x078 & (new_n217_ | new_n218_)));
  assign new_n217_ = ~x006 & (x070 ? x022 : x038);
  assign new_n218_ = x086 & (~x022 | ((x062 | x094) & ~x030 & x070));
  assign new_n219_ = ~x014 & x086;
  assign new_n220_ = ~new_n224_ & (x070 | (~new_n221_ & (~x078 | (~new_n222_ & ~new_n223_))));
  assign new_n221_ = ~x022 & (x014 | x038);
  assign new_n222_ = x086 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n223_ = ~x102 & ~x006 & x038;
  assign new_n224_ = x038 & ~x006 & ~x086;
  assign new_n225_ = (new_n227_ | x078) & (new_n226_ | x038 | ~x078);
  assign new_n226_ = ~new_n222_ & ((~new_n210_ & x102 & x126) | ~x070 | (~new_n210_ & x006));
  assign new_n227_ = x014 & (~x054 | x022 | x070);
  assign new_n228_ = (~new_n213_ | ~x014) & (~x078 | x022 | x070) & x038 & (x014 | x078);
  ...
  assign z13 = ~z16 & ~x045 & (~new_n279_ | (~new_n266_ & (x037 | ~x053)));
  assign new_n266_ = new_n277_ & (x077 | (~new_n267_ & ~new_n272_ & (new_n270_ | x085)));
  assign new_n267_ = ~new_n268_ & (new_n269_ | (x005 & (x069 ? ~x037 : ~x021)));
  assign new_n268_ = ~x109 & ~x117;
  assign new_n269_ = ~x085 & (x021 | (~x069 & x029 & (~x061 | ~x093)));
  assign new_n270_ = (~x069 | (~x061 & ~x093 & (x021 | ~x029))) & (~new_n271_ | ~x029 | (x061 & x093));
  assign new_n271_ = (x101 | x125) & (~x021 | (~x013 & ~x069));
  ...
  assign new_n275_ = x101 & ~x037 & x069;
  assign new_n276_ = ~x085 & (x021 | ~x125 | (x109 & x117));
  assign new_n277_ = (new_n268_ | ~x013 | x085) & ~x053 & (~new_n278_ | ~x077);
  assign new_n278_ = x021 & x069;
  assign new_n279_ = x077 ? (~x013 & (new_n204_ | ~new_n283_)) : (~new_n280_ & ((~new_n278_ & ~new_n283_) | (x013 & (new_n204_ | ~new_n278_))));
  assign new_n280_ = x037 & ((~new_n282_ & ~x069) | (~new_n281_ & ~x085));
  assign new_n281_ = (x021 | ~x029) & ~x061 & ~x093;
  assign new_n282_ = (~x005 | (~x101 & ~x125)) & (x085 | x013 | ~x029);
  assign new_n283_ = x005 & x085;
  assign z14 = ~x046 & (~new_n297_ | (~x054 & (new_n301_ | (~new_n285_ & ~x078))));
  assign new_n285_ = (new_n286_ | ~x006) & (x086 | (new_n294_ & (new_n292_ | ~x030)));
  assign new_n286_ = ~new_n290_ & new_n291_ & (x070 | (~new_n287_ & (new_n288_ | new_n289_)));
  assign new_n287_ = (x102 | x126) & (~x022 | x038 | ~x062 | ~x094);
  assign new_n288_ = x022 & (x014 | x038);
  assign new_n289_ = (x022 | (~x110 & ~x118)) & ~x030 & ~x062 & ~x094;
  assign new_n290_ = ~x038 & x070 & (x102 | x110 | x118);
  assign new_n291_ = ~x086 & (x022 | ~x126 | (x110 & x118));
  assign new_n292_ = (x014 | ~x038 | x070) & (~new_n293_ | (x022 & (x014 | x070)));
  assign new_n293_ = (~x062 | ~x094) & (x102 | x126);
  assign new_n294_ = ~new_n295_ & (new_n296_ | (~x110 & ~x118));
  assign new_n295_ = (x038 | x070) & (x062 | x094 | (~x022 & x030));
  assign new_n296_ = ~x022 & (~x030 | x070 | (x062 & x094));
  assign new_n297_ = ~new_n298_ & (new_n299_ | ~x014) & (new_n300_ | x014);
  assign new_n298_ = x054 & ~x087 & (x038 | (~x078 & x022 & x070));
  assign new_n299_ = (~x078 | (x054 & x087)) & (x054 | x086 | (~x110 & ~x118));
  assign new_n300_ = (x054 | ~x022 | ~x070) & (~x054 | x087 | ~x006 | ~x086);
  assign new_n301_ = ~x038 & ((x022 & x070) | (x006 & x086));
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z17 = 1'b0;
  assign z19 = 1'b0;
