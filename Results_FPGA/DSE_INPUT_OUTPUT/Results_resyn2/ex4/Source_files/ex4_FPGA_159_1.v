...
module FAU ( 
  ...
  assign new_n218_ = (new_n204_ | ~x086) & (new_n219_ | ~x070);
  ...
  assign z13 = z07 | (~x045 & (~new_n270_ | (~x053 & (new_n257_ | ~new_n262_))));
  assign new_n257_ = x005 & ((~x037 & x085) | (~x077 & (new_n258_ | ~new_n260_)));
  assign new_n258_ = ~x069 & (new_n259_ | ((x101 | x125) & (~new_n189_ | ~x021)));
  assign new_n259_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n260_ = new_n261_ & (new_n193_ | x021 | ~x125);
  assign new_n261_ = ~x085 & (~x101 | x037 | ~x069);
  ...
  assign new_n266_ = ~x077 & ~x085 & ((~x021 & x029) | x061 | x093);
  assign new_n267_ = x021 & (x077 | ~x013 | ~x037);
  assign new_n268_ = x029 & (~x021 | (~x013 & ~x069));
  assign new_n269_ = ~x077 & ~x085 & (x101 | x125) & (~x061 | ~x093);
  assign new_n270_ = new_n271_ & ((new_n183_ & ~new_n268_) | ~x037 | x077 | x085);
  assign new_n271_ = (~x013 | ~x077) & (~x053 | (new_n272_ & (~x005 | x013 | ~x085)));
  assign new_n272_ = ~x037 & (x077 | ~x021 | ~x069);
