...
module FAU ( 
  ...
  assign new_n183_ = (new_n184_ | ~x085) & (x005 | (new_n189_ & (new_n188_ | ~x069)));
  assign new_n184_ = ~new_n185_ & (~new_n186_ | new_n187_ | (~x061 & ~x093));
  assign new_n185_ = ~x069 & (~x061 | ~x093 | (x021 & ~x029));
  assign new_n186_ = ~x029 & (x021 | (x013 & x069));
  assign new_n187_ = x101 & x125;
  assign new_n188_ = ((~x013 & ~x021) | (x029 & x061 & x093)) & (new_n187_ | (~x021 & ~x061 & ~x093));
  ...
  assign new_n196_ = ~new_n186_ & x061 & x093;
  ...
  assign new_n263_ = (x030 | x062 | x094) & (~x022 | (~x014 & ~x038));
