...
module FAU ( 
  ...
  assign z05 = z16 | (x045 & (~new_n196_ | (x053 & (new_n183_ | ~new_n188_))));
  ...
  assign z06 = (z16 | x046) & (~new_n214_ | (~new_n201_ & x054));
  ...
  assign new_n219_ = ~z16 & (x038 | x054);
  ...
  assign new_n274_ = x090 & ((~new_n275_ & ~x077) | ~new_n273_ | new_n277_);
  ...
  assign z14 = ~z16 & ~x046 & (~new_n292_ | (~new_n279_ & (x038 | ~x054)));
