...
module FAU ( 
  ...
  assign z06 = ~z17 & x046 & (~new_n201_ | (~new_n188_ & x054));
  ...
  assign z08 = z17 | (~x040 & (~new_n220_ | (~x048 & (new_n207_ | ~new_n215_))));
  ...
  assign z14 = (~new_n274_ | (~x054 & (new_n262_ | ~new_n270_))) & (z17 | ~x046);
  ...
  assign new_n279_ = (~x078 | (~x014 & (~new_n278_ | x038))) & ~z17 & (~x038 | ~x054);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z21 = 1'b0;
