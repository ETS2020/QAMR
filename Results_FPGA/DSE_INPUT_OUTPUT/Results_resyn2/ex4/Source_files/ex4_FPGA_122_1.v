...
module FAU ( 
  ...
  assign new_n178_ = (new_n179_ | ~x012 | ~x076) & (x036 | x052) & ~z16 & (x012 | x076);
  ...
  assign z06 = ~z16 & x046 & (~new_n219_ | (~new_n206_ & x054));
  ...
  assign z14 = (z16 | ~x046) & (~new_n283_ | (~x054 & (new_n271_ | ~new_n279_)));
  ...
  assign new_n288_ = (~x078 | (~x014 & (~new_n287_ | x038))) & ~z16 & (~x038 | ~x054);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z18 = 1'b0;
  assign z21 = 1'b0;
