...
module FAU ( 
  ...
  assign z09 = z07 | (~new_n227_ & ~x041);
  assign new_n227_ = ((~new_n228_ & ~x009) | (~x033 & x049) | (~new_n229_ & x009)) & ((~new_n229_ & ~x009) | x033 | (~new_n228_ & x009)) & (x009 | x073 | (~new_n228_ & ~new_n229_)) & (~x009 | ~x073) & (~x033 | ~x049);
  assign new_n228_ = x017 & x065;
  assign new_n229_ = x001 & x081;
  assign z10 = ~new_n231_ & ~z07 & ~x042;
  assign new_n231_ = ((~new_n232_ & ~x010) | (~x034 & x050) | (~new_n233_ & x010)) & ((~new_n233_ & ~x010) | x034 | (~new_n232_ & x010)) & (x010 | x074 | (~new_n232_ & ~new_n233_)) & (~x010 | ~x074) & (~x034 | ~x050);
  assign new_n232_ = x018 & x066;
  assign new_n233_ = x002 & x082;
  assign z11 = z07 | (~new_n235_ & ~x043);
  assign new_n235_ = ((~new_n236_ & ~x011) | (~x035 & x051) | (~new_n237_ & x011)) & ((~new_n237_ & ~x011) | x035 | (~new_n236_ & x011)) & (x011 | x075 | (~new_n236_ & ~new_n237_)) & (~x011 | ~x075) & (~x035 | ~x051);
  assign new_n236_ = x019 & x067;
  assign new_n237_ = x003 & x083;
  assign z12 = z07 | (~new_n239_ & ~x044);
  assign new_n239_ = ((~new_n240_ & ~x012) | (~x036 & x052) | (~new_n241_ & x012)) & ((~new_n241_ & ~x012) | x036 | (~new_n240_ & x012)) & (x012 | x076 | (~new_n240_ & ~new_n241_)) & (~x012 | ~x076) & (~x036 | ~x052);
