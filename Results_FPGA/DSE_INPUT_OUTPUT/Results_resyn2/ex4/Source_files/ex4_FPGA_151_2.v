...
module FAU ( 
  ...
  assign z00 = x040 & (~new_n159_ | (x085 & (new_n162_ | (~x032 & ~x048))));
  assign new_n159_ = (new_n160_ | (x032 & ~x048)) & (new_n161_ | ~x032) & (x008 | (x072 & (x032 | x048)));
  assign new_n160_ = (x008 | x000 | x080) & (x016 | x064 | ~x008 | ~x085);
  assign new_n161_ = (x008 | x016 | x064) & (x000 | x080 | ~x008 | ~x085);
  assign new_n162_ = ((~x016 & ~x064) | (~x000 & ~x080)) & x008 & x072;
  ...
  assign new_n181_ = ((~new_n182_ & x012) | (x036 & ~x052) | (~new_n183_ & ~x012)) & ((~new_n183_ & x012) | ~x036 | (~new_n182_ & ~x012)) & ((~new_n182_ & ~new_n183_) | ~x012 | ~x076) & (x036 | x052) & (x012 | x076);
  ...
  assign z08 = ~x040 & (~new_n239_ | (~x048 & (new_n226_ | new_n235_ | ~new_n246_)));
  assign new_n226_ = ~x072 & (new_n232_ | (x000 & (new_n227_ | ~new_n230_)));
  assign new_n227_ = (new_n228_ | ~x008) & ~x064 & (new_n229_ | x096 | x120);
  assign new_n228_ = x085 & (~x016 | ((x096 | x120) & (~x056 | ~x088)));
  assign new_n229_ = (~x016 | ~x032) & (x024 | x056 | x088);
  assign new_n230_ = new_n231_ & (x032 | ~x096 | (x008 & (~x064 | ~x085)));
  assign new_n231_ = (~x080 | ~x085) & ((x104 & x112) | x008 | ~x120);
  assign new_n232_ = ~new_n233_ & ~new_n234_ & ~z07 & ~x080;
  assign new_n233_ = (~x064 | (~x056 & ~x088)) & (~x024 | (x008 & x016));
  assign new_n234_ = ~x064 & ((~x096 & ~x120) | (x056 & x088));
  assign new_n235_ = ~new_n238_ & ((~new_n236_ & ~x008 & ~x072) | (~x080 & x008 & x085));
  assign new_n236_ = (~x000 | (x064 ? x032 : x016)) & (x080 | (~new_n237_ & ~x016));
  assign new_n237_ = x024 & (~x056 | ~x088);
  assign new_n238_ = ~x104 & ~x112;
  assign new_n239_ = new_n244_ & (x072 | (new_n242_ & (~x032 | (~new_n240_ & ~new_n245_))));
  assign new_n240_ = ~new_n241_ & ~x080;
  assign new_n241_ = (~x085 | ((x016 | ~x024) & ~x056 & ~x088)) & (x008 | (~x024 & ~x056 & ~x088));
  assign new_n242_ = (x008 | (~new_n243_ & (~x016 | ~x064))) & (~x064 | ~x085 | ~x016 | x032);
  assign new_n243_ = x000 & x080;
  assign new_n244_ = (~x085 | ~x008 | ~x072) & ((~new_n243_ & ~x032) | x008 | (x032 & ~x048));
  assign new_n245_ = x085 & (x048 | ((x096 | x120) & x000 & ~x064));
  assign new_n246_ = (x008 | ~x016 | ~x064) & (~x008 | ~x085 | ~x120 | ~x000 | x016);
  ...
  assign new_n265_ = ~x021 & (new_n266_ | (~new_n197_ & x125));
  assign new_n266_ = ~x069 & (x101 | x125 | x029 | x061 | x093);
  assign new_n267_ = (new_n268_ | x069) & ~x085 & (~x101 | x037 | ~x069);
  ...
  assign new_n273_ = ~x077 & ~x085 & (x061 | x093 | (~x021 & x029));
  assign new_n274_ = new_n275_ & ~x077 & ~x085 & ~new_n189_ & (x101 | x125);
