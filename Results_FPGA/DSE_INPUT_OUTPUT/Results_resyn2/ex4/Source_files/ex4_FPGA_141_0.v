...
module FAU ( 
  ...
  assign z13 = ~x045 & (~new_n260_ | new_n258_ | ~x085 | (x013 & x077));
  assign new_n258_ = x053 & (x037 | (new_n259_ & ~x077));
  assign new_n259_ = x021 & x069;
  assign new_n260_ = (x013 | (x053 ? ~x005 : ~new_n259_)) & ((~new_n259_ & ~x005) | x053 | (x037 & (~x005 | x077)));
