...
module FAU ( 
  ...
  assign z03 = x043 & ((~new_n175_ & ~x035) | (~x011 & ~x075) | (~new_n177_ & x035));
  ...
  assign z11 = ~new_n251_ & ~x043 & ~x085;
  ...
  assign new_n274_ = x043 & (~new_n273_ | new_n277_ | (~new_n275_ & ~x077));
  ...
  assign new_n292_ = x078 ? (~x014 & (new_n220_ | ~new_n296_)) : (~new_n293_ & ((~new_n291_ & ~new_n296_) | ((new_n220_ | ~new_n291_) & x014)));
