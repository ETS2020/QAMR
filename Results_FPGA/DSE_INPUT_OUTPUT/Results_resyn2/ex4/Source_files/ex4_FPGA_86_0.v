...
module FAU ( 
  ...
  assign z04 = x044 & ((~new_n179_ & x085) | new_n181_ | (~new_n183_ & x036));
  assign new_n179_ = (x012 | x076) & (x036 | (x052 & (~new_n180_ | ~x076)));
  assign new_n180_ = ~x004 & ~x084;
  assign new_n181_ = x012 & ((new_n182_ & ~x036 & x085) | (new_n180_ & x036));
  assign new_n182_ = ~x020 & ~x068;
  assign new_n183_ = (~x052 | (~new_n180_ & ~new_n182_)) & (x012 | x076) & (~new_n182_ | ~x076);
  assign z05 = x045 & ((~new_n185_ & x085) | ((new_n200_ | ~new_n204_) & x036));
  ...
  assign z12 = ~x044 & (~new_n260_ | (x085 & (new_n263_ | (x012 & x076))));
  assign new_n260_ = (new_n261_ | x012) & (~x036 | ((~new_n262_ | x076) & ~x052 & (~x012 | ~x076)));
  assign new_n261_ = (~new_n262_ | x036 | ~x085) & (~x036 | ~x020 | ~x068);
  assign new_n262_ = x004 & x084;
  assign new_n263_ = (~x052 | (~x076 & x020 & x068)) & ~x036 & (new_n262_ | (x020 & x068));
  ...
  assign new_n279_ = new_n282_ & (x077 | (~new_n280_ & ~new_n281_ & (~new_n202_ | x037)));
  assign new_n280_ = ~x013 & ((x021 & x069) | (x029 & x037 & ~x085));
  assign new_n281_ = ((~x021 & x029) | x061 | x093) & x037 & ~x085;
  assign new_n282_ = (~x037 | ~x053) & (~x077 | (~x013 & (x053 | ~x021 | ~x069)));
  assign new_n283_ = (~x077 | (~x013 & (~new_n202_ | x053) & (~x005 | (x037 & ~x053)))) & (~x037 | ~x053) & (x077 | ((~x005 | (x013 & x053)) & (~new_n202_ | (x013 & x037))));
