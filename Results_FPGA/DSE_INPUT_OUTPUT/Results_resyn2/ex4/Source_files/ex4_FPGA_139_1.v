...
module FAU ( 
  ...
  assign z13 = ~x045 & ~x085 & (new_n262_ | ~new_n271_ | (~new_n270_ & ~x077));
  ...
  assign new_n265_ = ~new_n266_ & new_n267_ & (x021 | (new_n189_ & (new_n185_ | ~x125)));
  assign new_n266_ = (~x021 | ~x061 | ~x093) & ~x069 & (x101 | x125);
  assign new_n267_ = (x013 | (~x061 & ~x093)) & (~x101 | x037 | ~x069);
  assign new_n268_ = (~x069 | (new_n189_ & (x021 | ~x029))) & (new_n269_ | ~x029 | (x021 & (x013 | x069)));
  assign new_n269_ = ~x005 & ((~x101 & ~x125) | (x061 & x093));
  assign new_n270_ = (~x037 | (new_n189_ & (x021 | ~x029))) & (((~x021 | ~x069) & (~x029 | ~x037)) | (x013 & x037));
