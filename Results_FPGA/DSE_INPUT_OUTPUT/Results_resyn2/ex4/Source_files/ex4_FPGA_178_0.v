// Benchmark "FAU" written by ABC on Wed Aug 26 09:28:25 2020
...
module FAU ( 
  ...
  assign z05 = z15 | (x045 & (~new_n201_ | (~new_n185_ & (~x037 | x053))));
  assign new_n185_ = new_n194_ & (~x077 | (~new_n188_ & ~new_n190_ & (new_n186_ | new_n200_)));
  assign new_n186_ = ((~x061 & ~x093) | (~new_n187_ & (x005 | ~x069))) & (x005 | ~x021 | ~x069);
  ...
  assign new_n194_ = new_n199_ & (new_n195_ | (~new_n198_ & (~x077 | (~new_n196_ & ~new_n197_))));
  ...
  assign new_n199_ = x053 & (x077 | x021 | x069);
  assign new_n200_ = x101 & x125;
  assign new_n201_ = x077 ? new_n202_ : new_n205_;
  assign new_n202_ = (new_n203_ | x037 | ~x085) & ~new_n204_ & (~x013 | x005 | x085);
  assign new_n203_ = (x029 | (~x021 & (~x013 | ~x069))) & x061 & x093;
  assign new_n204_ = ~x021 & ~x069 & (x013 | x037 | ~x053);
  assign new_n205_ = x013 & ((~x037 & x053) | x005 | x085);
  assign z06 = (~new_n220_ | (~new_n207_ & ~new_n226_)) & ~z15 & x046;
  ...
  assign new_n248_ = ((~new_n249_ & ~x009) | (~new_n250_ & x009) | (~x033 & x049)) & ((~new_n250_ & ~x009) | x033 | (~new_n249_ & x009)) & (x009 | x073 | (~new_n249_ & ~new_n250_)) & (~x009 | ~x073) & (~x033 | ~x049);
  assign new_n249_ = x017 & x065;
  assign new_n250_ = x001 & x081;
  assign z10 = ~x042 & (new_n252_ | (~z15 & ~new_n253_));
  assign new_n252_ = (x034 | ~x050 | x010 | ~x074) & (~x010 | ~x034) & x018 & x066;
  assign new_n253_ = ((x010 & ~x034 & x050) | (x034 & x074) | ~x002 | ~x082) & (~x034 | ~x050) & (~x010 | ~x074);
  assign z11 = z15 | (~new_n255_ & ~x043);
  assign new_n255_ = ((~new_n256_ & ~x011) | (~new_n257_ & x011) | (~x035 & x051)) & ((~new_n257_ & ~x011) | x035 | (~new_n256_ & x011)) & (x011 | x075 | (~new_n256_ & ~new_n257_)) & (~x011 | ~x075) & (~x035 | ~x051);
  assign new_n256_ = x019 & x067;
  assign new_n257_ = x003 & x083;
  assign z12 = ~new_n259_ & ~z15 & ~x044;
  assign new_n259_ = ((~new_n260_ & ~x012) | (~new_n261_ & x012) | (~x036 & x052)) & ((~new_n261_ & ~x012) | x036 | (~new_n260_ & x012)) & (x012 | x076 | (~new_n260_ & ~new_n261_)) & (~x012 | ~x076) & (~x036 | ~x052);
  assign new_n260_ = x020 & x068;
  assign new_n261_ = x004 & x084;
  assign z13 = ~x045 & ((~new_n263_ & x018) | (~new_n282_ & x085));
  assign new_n263_ = new_n277_ & (x053 | (~new_n264_ & (x077 | (~new_n268_ & ~new_n271_))));
  assign new_n264_ = ~new_n265_ & ((x013 & ~x085) | (~x077 & (new_n266_ | (~new_n267_ & ~x085))));
  assign new_n265_ = ~x109 & ~x117;
  assign new_n266_ = x005 & ((~x037 & x069) | (~x061 & ~x021 & ~x069));
  assign new_n267_ = ~x021 & (x069 | ~x029 | (x061 & x093));
  assign new_n268_ = ~x085 & ((~new_n269_ & x069) | (new_n270_ & (~x021 | (~x013 & ~x069))));
  assign new_n269_ = (x021 | ~x029) & ~x061 & ~x093;
  assign new_n270_ = (x101 | x125) & x029 & (~x061 | ~x093);
  ...
  assign new_n276_ = x125 & (~x061 | x069 | (x021 & ~x093));
  assign new_n277_ = new_n281_ & (x077 | (~new_n279_ & ~new_n280_ & (~new_n278_ | x037)));
  assign new_n278_ = x021 & x069;
  assign new_n279_ = ~x013 & ((x021 & x069) | (x029 & x037 & ~x085));
  assign new_n280_ = (x061 | x093 | (~x021 & x029)) & x037 & ~x085;
  assign new_n281_ = (~x037 | ~x053) & (~x077 | (~x013 & (x053 | ~x021 | ~x069)));
  assign new_n282_ = (~x077 | (~x013 & (~new_n278_ | x053) & (~x005 | (x037 & ~x053)))) & (~x037 | ~x053) & (x077 | ((~x005 | (x013 & x053)) & (~new_n278_ | (x013 & x037))));
