...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n205_ & ~x085) | (~new_n187_ & x111));
  ...
  assign new_n199_ = (~x029 | ~x093) & ((x013 & ~x021) | (x069 & x021 & x061));
  ...
  assign new_n220_ = (~x078 | (~new_n221_ & new_n224_)) & ~z15 & (new_n225_ | x078);
  ...
  assign new_n284_ = ~x013 & ((x037 & ~x053) | ~x005 | ~x085);
