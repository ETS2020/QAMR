...
module FAU ( 
  ...
  assign new_n194_ = new_n188_ & (new_n197_ | ~new_n198_ | (x069 & (new_n195_ | new_n196_)));
  ...
  assign z13 = ~x045 & ~x085 & (new_n264_ | ~new_n273_ | (~new_n272_ & ~x077));
  assign new_n264_ = ~x053 & (new_n265_ | (~x077 & (~new_n270_ | (~new_n267_ & x005))));
  assign new_n265_ = (x109 | x117) & (x013 | (~x077 & (new_n266_ | x021)));
  assign new_n266_ = (~x037 | ~x069) & (x005 | ((~x061 | ~x093) & x029 & ~x069));
  assign new_n267_ = ~new_n268_ & new_n269_ & (x021 | (new_n191_ & (new_n187_ | ~x125)));
  assign new_n268_ = (~x021 | ~x061 | ~x093) & ~x069 & (x101 | x125);
  assign new_n269_ = (x013 | (~x061 & ~x093)) & (~x101 | x037 | ~x069);
  assign new_n270_ = (~x069 | (new_n191_ & (x021 | ~x029))) & (new_n271_ | ~x029 | (x021 & (x013 | x069)));
  assign new_n271_ = ~x005 & ((~x101 & ~x125) | (x061 & x093));
  assign new_n272_ = (~x037 | (new_n191_ & (x021 | ~x029))) & (((~x021 | ~x069) & (~x029 | ~x037)) | (x013 & x037));
