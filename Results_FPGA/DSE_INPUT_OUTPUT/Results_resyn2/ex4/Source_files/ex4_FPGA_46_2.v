...
module FAU ( 
  ...
  assign z05 = z07 | (x045 & (~new_n204_ | (x053 & (new_n189_ | ~new_n196_))));
  ...
  assign new_n193_ = new_n195_ & (new_n194_ | ~x021 | x125);
  assign new_n194_ = ~x109 & ~x117;
  assign new_n195_ = x085 & (x101 | ~x037 | x069);
  assign new_n196_ = new_n199_ & ((x109 & x117) | (~new_n197_ & (x013 | ~x085)));
  assign new_n197_ = x077 & (new_n198_ | (~x005 & (x069 ? x021 : x037)));
  assign new_n198_ = x085 & (~x021 | ((x061 | x093) & ~x029 & x069));
  assign new_n199_ = (x069 | (~new_n200_ & ~new_n201_)) & (~new_n202_ | ~new_n203_);
  assign new_n200_ = x077 & x085 & (~x061 | ~x093 | (x021 & ~x029));
  assign new_n201_ = ~x021 & (~x077 | x013 | x037);
  assign new_n202_ = ~x029 & (x021 | (x013 & x069));
  assign new_n203_ = x077 & x085 & (x061 | x093) & (~x101 | ~x125);
  assign new_n204_ = new_n205_ & ((new_n191_ & ~new_n202_) | x037 | ~x077 | ~x085);
  assign new_n205_ = (x013 | x077) & (x053 | (new_n206_ & (x005 | ~x013 | x085)));
  assign new_n206_ = x037 & (~x077 | x021 | x069);
  assign z06 = ~z07 & x046 & (~new_n221_ | (~new_n208_ & x054));
  assign new_n208_ = new_n219_ & (~x078 | (~new_n211_ & ~new_n214_ & (new_n209_ | new_n220_)));
  assign new_n209_ = (x006 | (x070 ? ~x022 : ~x038)) & (~x086 | (x022 & (~new_n210_ | ~x070)));
  ...
  assign new_n219_ = (x078 | x022 | x070) & (new_n220_ | x014 | ~x086);
  assign new_n220_ = x110 & x118;
  assign new_n221_ = new_n225_ & (new_n222_ | ~x078);
  assign new_n222_ = new_n224_ & (x038 | ((new_n223_ | ~x070) & (new_n212_ | ~x086)));
  assign new_n223_ = (x006 | (x102 & x126)) & (~x086 | ~x014 | x030);
  assign new_n224_ = (x006 | ~x014 | x086) & ((~x014 & ~x038) | x022 | x070);
  ...
  assign new_n237_ = ~x080 & ((x104 & x112) | x016 | ~x120);
  ...
  assign z13 = z07 | (~x045 & (~new_n275_ | (~new_n263_ & ~x053)));
  assign new_n263_ = ~new_n272_ & (x077 | (~new_n264_ & new_n269_ & (new_n267_ | ~x005)));
  assign new_n264_ = ~new_n265_ & ~new_n266_ & (x101 | x125);
  assign new_n265_ = (~x005 | x069) & (~x029 | x085 | (x021 & (x013 | x069)));
  assign new_n266_ = x061 & x093 & (~x005 | x021 | x069);
  assign new_n267_ = new_n268_ & (~x029 | (x021 & (x013 | x069)));
  assign new_n268_ = ~x085 & ((x109 & x117) | x021 | ~x125);
  assign new_n269_ = (new_n271_ | ~x069) & ((~x061 & ~x093) | (~new_n270_ & (~x069 | x085)));
  assign new_n270_ = x005 & (~x013 | ~x021);
  assign new_n271_ = (x021 | ~x029 | x085) & (~x101 | ~x005 | x037);
  assign new_n272_ = ~new_n194_ & ((x013 & ~x085) | (~x077 & (new_n273_ | (~new_n274_ & ~x085))));
  assign new_n273_ = x005 & (~x037 | ~x069);
  assign new_n274_ = ~x021 & (~x029 | x069 | (x061 & x093));
  assign new_n275_ = new_n279_ & (x077 | (~new_n276_ & (new_n280_ | ~x037 | x085)));
  assign new_n276_ = (new_n277_ | new_n278_) & (~x013 | (new_n277_ & (~x037 | x053)));
  assign new_n277_ = x021 & x069;
  assign new_n278_ = x005 & x085;
  assign new_n279_ = (~x037 | ~x053) & (~x077 | ((~new_n278_ | x037) & ~x013 & (~new_n277_ | x053)));
  assign new_n280_ = ~x061 & ~x093 & (~x029 | (x021 & (x013 | x069)));
