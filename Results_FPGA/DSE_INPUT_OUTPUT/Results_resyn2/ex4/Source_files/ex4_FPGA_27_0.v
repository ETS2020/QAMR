...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n184_ & x085) | (x072 & (new_n199_ | ~new_n203_)));
  ...
  assign z06 = (~new_n219_ | (~new_n206_ & ~new_n225_)) & ~z16 & x046;
  ...
  assign z08 = z16 | (~x040 & (~new_n240_ | (~x048 & (new_n227_ | ~new_n235_))));
  ...
  assign new_n233_ = (~x104 | ~x112) & ~x016 & x120;
  ...
  assign z13 = ~x045 & ((~new_n263_ & x072) | (~new_n281_ & x085));
  ...
  assign new_n296_ = x078 ? (~x014 & (new_n225_ | ~new_n300_)) : (~new_n297_ & ((~new_n295_ & ~new_n300_) | (x014 & (new_n225_ | ~new_n295_))));
