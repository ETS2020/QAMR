...
module FAU ( 
  ...
  assign z06 = z07 | (x046 & (~new_n217_ | (x054 & (new_n204_ | ~new_n213_))));
  assign new_n204_ = x078 & (new_n207_ | (x086 & (new_n212_ | (~new_n205_ & ~x030))));
  assign new_n205_ = (~x022 | x070) & ((~x022 & (~x014 | (~x070 & x094))) | new_n206_ | (~x062 & ~x094));
  assign new_n206_ = x102 & x126;
  assign new_n207_ = ~x006 & (new_n208_ | new_n209_ | new_n210_ | ~new_n211_);
  assign new_n208_ = (x014 | x022) & (~x094 | (x070 & (~x030 | ~x062)));
  assign new_n209_ = (~x102 | ~x126) & (x070 | ~x094) & (x062 | x094);
  assign new_n210_ = ~x102 & x038 & x094;
  assign new_n211_ = x086 & ((~x110 & ~x118) | ~x022 | x126);
  assign new_n212_ = ~x070 & (~x062 | ~x094);
  assign new_n213_ = (new_n214_ | (x110 & x118)) & (x078 | x022 | x070);
  assign new_n214_ = (~x078 | (~new_n216_ & (new_n215_ | ~x086))) & (x014 | ~x086);
  assign new_n215_ = x022 & (x030 | (~x070 & x094) | (~x062 & ~x094));
  assign new_n216_ = ~x006 & ((x022 & x070) | (x038 & ~x070 & x094));
  assign new_n217_ = new_n222_ & (~x078 | (~new_n220_ & new_n218_ & ~new_n221_));
  assign new_n218_ = (new_n219_ | x038 | ~x086) & ((~x038 & x054) | x022 | x070);
  assign new_n219_ = (~x022 | x030) & x062 & x094;
  assign new_n220_ = x014 & ((~x022 & ~x070) | (~x038 & x086 & ~x030 & x070));
  assign new_n221_ = ~x006 & ((x014 & ~x086) | (~x038 & ~x094));
  ...
  assign new_n261_ = ~x021 & (new_n262_ | (~new_n196_ & x125));
  ...
  assign new_n265_ = ~new_n268_ & ~new_n270_ & (new_n272_ | (~new_n266_ & (~x013 | x085)));
  ...
  assign new_n270_ = new_n271_ & ~x077 & ~x085 & ~new_n192_ & (x101 | x125);
  assign new_n271_ = x029 & (~x021 | (~x013 & ~x069));
  assign new_n272_ = ~x109 & ~x117;
  assign new_n273_ = new_n274_ & ((new_n186_ & ~new_n271_) | ~x037 | x077 | x085);
  ...
  assign new_n289_ = x022 & ((~new_n290_ & ~x054) | (~z07 & x070 & (new_n294_ | x054)));
  ...
  assign new_n293_ = x006 & ~x062 & (x102 | x126);
  ...
  assign new_n298_ = x030 & ~x054 & ~x062 & ~x086;
