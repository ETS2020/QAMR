...
module FAU ( 
  ...
  assign z06 = (z07 | x046) & (~new_n215_ | (x054 & (new_n203_ | ~new_n211_)));
  ...
  assign new_n220_ = (x078 | (x014 & (~new_n219_ | ~x038))) & ~z07 & (x038 | x054);
  ...
  assign new_n273_ = ~x069 & (new_n274_ | (~x013 & x029 & ~x085));
  assign new_n274_ = (x101 | x125) & x005 & ~x045;
