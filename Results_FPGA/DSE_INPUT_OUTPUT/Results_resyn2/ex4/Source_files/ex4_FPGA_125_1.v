...
module FAU ( 
  ...
  assign z05 = z16 | (x045 & (~new_n199_ | (~new_n183_ & (~x037 | x053))));
  ...
  assign new_n254_ = ((~new_n255_ & ~x011) | (~x035 & x051) | (~new_n256_ & x011)) & ((~new_n256_ & ~x011) | (~new_n255_ & x011) | x035) & ((~new_n255_ & ~new_n256_) | x011 | x075) & (~x011 | ~x075) & (~x035 | ~x051);
