...
module FAU ( 
  ...
  assign new_n201_ = (x038 | x054) & (x078 | (x014 & (x006 | ~x038 | x086)));
  ...
  assign new_n222_ = ((~new_n223_ & ~x009) | (~new_n224_ & x009) | (~x033 & x049)) & ((~new_n224_ & ~x009) | (~new_n223_ & x009) | x033) & ((~new_n223_ & ~new_n224_) | x009 | x073) & (~x009 | ~x073) & (~x033 | ~x049);
  assign new_n223_ = x017 & x065;
  assign new_n224_ = x001 & x081;
  assign z10 = z07 | (~new_n226_ & ~x042);
  assign new_n226_ = ((~new_n227_ & ~x010) | (~new_n228_ & x010) | (~x034 & x050)) & ((~new_n228_ & ~x010) | (~new_n227_ & x010) | x034) & ((~new_n227_ & ~new_n228_) | x010 | x074) & (~x010 | ~x074) & (~x034 | ~x050);
  assign new_n227_ = x018 & x066;
  assign new_n228_ = x002 & x082;
  assign z11 = z07 | (~new_n230_ & ~x043);
  assign new_n230_ = ((~new_n231_ & ~x011) | (~new_n232_ & x011) | (~x035 & x051)) & ((~new_n232_ & ~x011) | (~new_n231_ & x011) | x035) & ((~new_n231_ & ~new_n232_) | x011 | x075) & (~x011 | ~x075) & (~x035 | ~x051);
  assign new_n231_ = x019 & x067;
  assign new_n232_ = x003 & x083;
  assign z12 = ~new_n234_ & ~z07 & ~x044;
  assign new_n234_ = ((~new_n235_ & ~x012) | (~new_n236_ & x012) | (~x036 & x052)) & ((~new_n236_ & ~x012) | (~new_n235_ & x012) | x036) & ((~new_n235_ & ~new_n236_) | x012 | x076) & (~x012 | ~x076) & (~x036 | ~x052);
