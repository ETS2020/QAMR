...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n185_ & x060) | (~new_n203_ & ~x085));
  ...
  assign z13 = ~x045 & ((~new_n276_ & x060) | (~new_n262_ & ~x085));
  assign new_n262_ = new_n272_ & (x053 | (~new_n263_ & ((~new_n265_ & new_n269_) | x077)));
  assign new_n263_ = (x109 | x117) & (x013 | (~x077 & (new_n264_ | x021)));
  assign new_n264_ = (~x037 | ~x069) & (x005 | (x029 & ~x069 & (~x061 | ~x093)));
  assign new_n265_ = (new_n266_ | new_n267_ | ~new_n268_) & x005;
  ...
  assign new_n273_ = x037 & ((~x021 & x029) | x061 | x093);
