...
module FAU ( 
  ...
  assign z13 = z16 | (~x045 & (~new_n275_ | (~x053 & (new_n262_ | ~new_n267_))));
  ...
  assign new_n281_ = (x110 | x118) & (new_n282_ | new_n283_);
  ...
  assign new_n291_ = (~new_n292_ | ~x078) & ((~x110 & ~x118) | ~x014 | x086);
