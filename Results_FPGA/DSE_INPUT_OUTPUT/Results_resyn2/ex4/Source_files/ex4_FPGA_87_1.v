...
module FAU ( 
  ...
  assign z01 = x041 ? ~new_n167_ : x085;
  assign new_n167_ = (x033 | ((~new_n168_ | ~x073) & x049 & (~new_n169_ | ~x009))) & (x009 | x073) & (~x033 | ((~x049 | (~new_n168_ & ~new_n169_)) & (~new_n169_ | ~x073) & (~new_n168_ | ~x009)));
  ...
  assign z05 = x045 & ((~new_n185_ & x041) | (~new_n203_ & ~x085));
  ...
  assign new_n246_ = (new_n247_ | x009) & ~x033 & (new_n248_ | ~x009);
  ...
  assign z13 = z15 | (~x045 & (~new_n279_ | (~new_n263_ & (x037 | ~x053))));
  ...
  assign new_n275_ = ~x085 & (x021 | (x029 & ~x069 & (~x061 | ~x093)));
  ...
  assign new_n283_ = ~x013 & ((x037 & ~x053) | ~x005 | ~x085);
  assign z14 = ~z15 & ~x046 & (~new_n298_ | (~new_n285_ & (x038 | ~x054)));
