// Benchmark "FAU" written by ABC on Wed Aug 26 09:26:03 2020
...
module FAU ( 
  ...
  assign z00 = x040 & ((~new_n162_ & (~x032 | x048)) | ~new_n159_ | (~new_n163_ & x032));
  assign new_n159_ = ((~x072 & x085) | ((x032 | x048) & (x008 | x072))) & (new_n160_ | ~x008 | ~x072);
  assign new_n160_ = ~new_n161_ & (x000 | x080);
  assign new_n161_ = ~x016 & ~x064;
  assign new_n162_ = (~new_n161_ | ~x008 | x085) & (~x072 | x000 | x080);
  assign new_n163_ = (~new_n161_ | ~x072) & (x000 | x080 | ~x008 | x085);
  assign z01 = ~new_n165_ & (z16 | x041);
  assign new_n165_ = ((~new_n169_ & x009) | ~x049 | (~new_n170_ & ~x009)) & new_n166_ & ((~new_n170_ & x009) | ~x033 | (~new_n169_ & ~x009));
  assign new_n166_ = (new_n168_ | ~x009 | ~x073) & (x033 | x049) & ~z16 & (x009 | x073);
  assign z16 = ~x072 & x085;
  assign new_n168_ = (x017 | x065) & (x001 | x081);
  assign new_n169_ = ~x017 & ~x065;
  assign new_n170_ = ~x001 & ~x081;
  assign z02 = ~new_n172_ & ~z16 & x042;
  assign new_n172_ = ((~new_n173_ & x010) | (~new_n174_ & ~x010) | (x034 & ~x050)) & ((~new_n174_ & x010) | ~x034 | (~new_n173_ & ~x010)) & ((~new_n173_ & ~new_n174_) | ~x010 | ~x074) & (x034 | x050) & (x010 | x074);
  assign new_n173_ = ~x018 & ~x066;
  assign new_n174_ = ~x002 & ~x082;
  assign z03 = ~new_n176_ & ~z16 & x043;
  assign new_n176_ = ((~new_n177_ & x011) | (~new_n178_ & ~x011) | (x035 & ~x051)) & ((~new_n178_ & x011) | ~x035 | (~new_n177_ & ~x011)) & ((~new_n177_ & ~new_n178_) | ~x011 | ~x075) & (x035 | x051) & (x011 | x075);
  ...
  assign z05 = x045 & ((~new_n202_ & ~x085) | (~new_n184_ & x072));
  ...
  assign z08 = z16 | (~x040 & (~new_n238_ | (~x048 & (new_n225_ | ~new_n233_))));
  ...
  assign z13 = ~x045 & ((~new_n275_ & x072) | (~new_n261_ & ~x085));
  assign new_n261_ = new_n271_ & (x053 | (~new_n262_ & (x077 | (~new_n264_ & new_n268_))));
  assign new_n262_ = (x109 | x117) & (x013 | (~x077 & (new_n263_ | x021)));
  assign new_n263_ = (~x037 | ~x069) & (x005 | ((~x061 | ~x093) & x029 & ~x069));
  ...
  assign z14 = ~z16 & ~x046 & (~new_n294_ | (~new_n281_ & (x038 | ~x054)));
  ...
  assign new_n294_ = x078 ? (~x014 & (new_n223_ | ~new_n298_)) : (~new_n295_ & ((~new_n293_ & ~new_n298_) | (x014 & (new_n223_ | ~new_n293_))));
