...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n182_ & x085) | ((new_n197_ | ~new_n201_) & x001));
  ...
  assign z09 = z07 | (~x041 & (~new_n247_ | (~new_n245_ & ~x033) | (x033 & x049)));
  assign new_n245_ = (~new_n246_ | ~x009) & (~x081 | ~x001 | x009);
  assign new_n246_ = x017 & x065;
  assign new_n247_ = x009 ? (~x073 & (~x081 | ~x001 | x049)) : ((~new_n246_ | (x049 & x073)) & (~x081 | ~x001 | x073));
  ...
  assign z13 = ~x045 & ((~new_n261_ & x001) | (~new_n279_ & x085));
