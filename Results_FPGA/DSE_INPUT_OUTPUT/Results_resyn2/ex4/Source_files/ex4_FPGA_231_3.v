...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n186_ & ~x044) | (~new_n204_ & ~x085));
  ...
  assign z12 = ~x044 & (~new_n259_ | ((new_n260_ | x012) & ~new_n262_ & (new_n261_ | ~x012)));
  assign new_n259_ = ((~new_n261_ & ~x012) | x036 | (~new_n260_ & x012)) & (x012 | x076 | (~new_n260_ & ~new_n261_)) & (~x012 | ~x076) & (~x036 | ~x052);
  assign new_n260_ = x020 & x068;
  assign new_n261_ = x004 & x084;
  assign new_n262_ = ~x036 & x052;
  assign z13 = ~x045 & ((~new_n278_ & ~x044) | (~new_n264_ & ~x085));
  assign new_n264_ = new_n274_ & (x053 | (~new_n265_ & ((~new_n267_ & new_n271_) | x077)));
  assign new_n265_ = (x109 | x117) & (x013 | (~x077 & (new_n266_ | x021)));
  assign new_n266_ = (~x037 | ~x069) & (x005 | (x029 & ~x069 & (~x061 | ~x093)));
  ...
  assign new_n279_ = (x085 | (new_n200_ & x061)) & x005 & (~x053 | (~x013 & x085));
  ...
  assign new_n297_ = x078 ? (~x014 & (new_n225_ | ~new_n301_)) : (~new_n298_ & ((~new_n296_ & ~new_n301_) | ((new_n225_ | ~new_n296_) & x014)));
