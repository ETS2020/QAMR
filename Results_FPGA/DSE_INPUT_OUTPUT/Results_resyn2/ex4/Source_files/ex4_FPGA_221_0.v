...
module FAU ( 
  ...
  assign z01 = x041 & ((~new_n168_ & (~x033 | x049)) | ~new_n165_ | (~new_n169_ & x033));
  assign new_n165_ = (new_n166_ | ~x009 | ~x073) & ((~x073 & ~x085) | ((x033 | x049) & (x009 | x073)));
  assign new_n166_ = ~new_n167_ & (x017 | x065);
  assign new_n167_ = ~x001 & ~x081;
  assign new_n168_ = (x017 | x065 | ~x009 | ~x085) & (~new_n167_ | ~x073);
  assign new_n169_ = (~x073 | x017 | x065) & (~new_n167_ | ~x009 | ~x085);
  assign z02 = z07 | (x042 & (new_n171_ | (~x010 & ~x074)));
  assign new_n171_ = ((new_n172_ & (x050 | x074)) | ~x034 | (new_n173_ & (x010 | x050))) & ((new_n172_ & x010) | (new_n173_ & x074) | x034 | ~x050);
  ...
  assign z05 = x045 & ((~new_n183_ & x085) | ((new_n198_ | ~new_n202_) & x073));
  ...
  assign z13 = ~x045 & ((~new_n262_ & x073) | (~new_n280_ & x085));
