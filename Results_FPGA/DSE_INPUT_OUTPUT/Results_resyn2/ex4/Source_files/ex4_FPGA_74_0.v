...
module FAU ( 
  ...
  assign z01 = x041 & ((~new_n168_ & (~x009 | x073)) | ~new_n165_ | (~new_n169_ & x009));
  assign new_n165_ = ((~x049 & ~x085) | ((x033 | x049) & (x009 | x073))) & (new_n166_ | ~x033 | ~x049);
  assign new_n166_ = ~new_n167_ & (x001 | x081);
  assign new_n167_ = ~x017 & ~x065;
  assign new_n168_ = (~new_n167_ | ~x033 | ~x085) & (~x049 | x001 | x081);
  assign new_n169_ = (x001 | x081 | ~x033 | ~x085) & (~new_n167_ | ~x049);
  ...
  assign z05 = x045 & ((~new_n183_ & x085) | ((new_n198_ | ~new_n202_) & x049));
  ...
  assign z09 = ~z07 & ~x041 & (new_n246_ | (x009 & x073));
  assign new_n246_ = (x033 | ((new_n247_ | new_n248_) & ((new_n248_ & ~x009) | ~x049 | (new_n247_ & ~x073)))) & ((new_n247_ & ~x009) | ~x033 | x049 | (new_n248_ & ~x073));
  ...
  assign z13 = ~x045 & ((~new_n262_ & x049) | (~new_n280_ & x085));
