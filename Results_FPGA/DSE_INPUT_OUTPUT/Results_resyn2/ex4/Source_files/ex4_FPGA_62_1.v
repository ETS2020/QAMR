...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n185_ & x068) | (~new_n203_ & ~x085));
  ...
  assign z12 = ~x044 & (new_n258_ | (~z07 & ~new_n259_));
  assign new_n258_ = (x036 | ~x052 | x012 | ~x076) & (~x012 | ~x036) & x020 & x068;
  assign new_n259_ = ((x012 & ~x036 & x052) | (x036 & x076) | ~x004 | ~x084) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = ~x045 & ((~new_n275_ & x068) | (~new_n261_ & ~x085));
  ...
  assign new_n276_ = (x085 | (new_n199_ & x061)) & x005 & (~x053 | (~x013 & x085));
  ...
  assign new_n294_ = x078 ? (~x014 & (new_n224_ | ~new_n298_)) : (~new_n295_ & ((~new_n293_ & ~new_n298_) | ((new_n224_ | ~new_n293_) & x014)));
