...
module FAU ( 
  ...
  assign new_n180_ = (new_n181_ | ~x012 | ~x076) & (x036 | x052) & ~z15 & (x012 | x076);
  ...
  assign z06 = (z15 | x046) & (~new_n215_ | (x054 & (new_n203_ | ~new_n211_)));
  ...
  assign new_n220_ = (x078 | (x014 & (~new_n219_ | ~x038))) & ~z15 & (x038 | x054);
  ...
  assign new_n289_ = (~x078 | ~x022 | ~x070) & (new_n290_ | ~x014 | x086);
