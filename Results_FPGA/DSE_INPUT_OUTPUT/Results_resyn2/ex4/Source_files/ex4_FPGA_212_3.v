...
module FAU ( 
  ...
  assign z06 = ~z07 & x046 & (~new_n197_ | (~new_n184_ & x054));
  ...
  assign z08 = z07 | (~x040 & (~new_n216_ | (~x048 & (new_n203_ | ~new_n211_))));
  ...
  assign z13 = ~x045 & ((~new_n238_ & ~x053) | ~new_n254_ | (~new_n251_ & ~x077));
  assign new_n238_ = new_n250_ & (x077 | (~new_n239_ & ~new_n245_ & (new_n242_ | x085)));
  assign new_n239_ = ~new_n240_ & (new_n241_ | (x005 & (x069 ? ~x037 : ~x021)));
  assign new_n240_ = ~x109 & ~x117;
  assign new_n241_ = ~x085 & (x021 | (~x069 & x029 & (~x061 | ~x093)));
  assign new_n242_ = (~x069 | (new_n243_ & (x021 | ~x029))) & (~new_n244_ | (x021 & (x013 | x069)));
  assign new_n243_ = ~x061 & ~x093;
  assign new_n244_ = (x101 | x125) & x029 & (~x061 | ~x093);
  assign new_n245_ = x005 & (new_n248_ | ~new_n249_ | (~x069 & (new_n246_ | new_n247_)));
  assign new_n246_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n247_ = (x101 | x125) & (~x021 | ~x061 | ~x093);
  assign new_n248_ = x101 & ~x037 & x069;
  assign new_n249_ = ~x085 & (x021 | ~x125 | (x109 & x117));
  assign new_n250_ = (new_n240_ | ~x013 | x085) & (~x077 | ~x021 | ~x069);
  assign new_n251_ = new_n253_ & (new_n252_ | ~x037 | x085);
  assign new_n252_ = new_n243_ & (~x029 | (x021 & (x013 | x069)));
  assign new_n253_ = (~x021 | x037 | ~x069) & (x013 | ((~x021 | ~x069) & (~x005 | ~x085)));
  assign new_n254_ = (~x037 | ~x053) & (~x077 | (~x013 & (x037 | ~x005 | ~x085)));
  assign z14 = (z07 | ~x046) & (~new_n268_ | (~x054 & (new_n256_ | ~new_n264_)));
