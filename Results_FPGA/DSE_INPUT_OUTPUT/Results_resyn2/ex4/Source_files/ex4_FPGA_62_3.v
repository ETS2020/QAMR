...
module FAU ( 
  ...
  assign z12 = (~new_n259_ | (~new_n258_ & x020 & x068)) & ~x044 & (~x068 | ~x085);
  assign new_n258_ = (x036 | (~x012 & x076)) & (x012 | (~x036 & x052));
  assign new_n259_ = ((x012 & ~x036 & x052) | ~x004 | ~x084 | (x036 & ~x012 & x076)) & (~x036 | ~x052) & (~x012 | ~x076);
