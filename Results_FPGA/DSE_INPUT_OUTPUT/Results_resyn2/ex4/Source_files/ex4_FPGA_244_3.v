...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n183_ & ~x003) | (~new_n201_ & ~x085));
  ...
  assign z11 = z07 | (~x043 & (~new_n254_ | new_n252_ | (x035 & x051)));
  assign new_n252_ = ~x035 & (new_n253_ | ~x011) & (x011 | (x003 & x083));
  assign new_n253_ = x019 & x067;
  assign new_n254_ = (~x011 | (~x075 & (x051 | ~x003 | ~x083))) & ((x075 & (~new_n253_ | x051)) | x011 | (~new_n253_ & (~x003 | ~x083)));
  ...
  assign z13 = ~x045 & ((~new_n274_ & ~x003) | (~new_n260_ & ~x085));
