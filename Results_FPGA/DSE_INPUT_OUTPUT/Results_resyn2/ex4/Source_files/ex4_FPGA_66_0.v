...
module FAU ( 
  ...
  assign z05 = z20 | (x045 & (~new_n199_ | (~new_n183_ & (~x037 | x053))));
  ...
  assign z06 = (~new_n218_ | (~new_n205_ & ~new_n224_)) & ~z20 & x046;
  ...
  assign z11 = ~z20 & ~x043 & (new_n254_ | (x011 & x075));
  ...
  assign z14 = z20 | (~x046 & (~new_n296_ | (~new_n283_ & (x038 | ~x054))));
