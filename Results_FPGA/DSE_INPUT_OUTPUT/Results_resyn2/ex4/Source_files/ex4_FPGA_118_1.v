...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n185_ & x085) | (~x107 & (new_n200_ | ~new_n204_)));
  assign new_n185_ = new_n196_ & (~x053 | (~new_n186_ & (~x077 | (~new_n189_ & new_n193_))));
  ...
  assign new_n189_ = ~x005 & (new_n190_ | new_n191_ | ~new_n192_);
  ...
  assign new_n204_ = (x037 | x053) & (x077 | (new_n205_ & (x085 | x005 | ~x037)));
  ...
  assign new_n220_ = (~x078 | (~new_n221_ & new_n224_)) & ~z07 & (new_n225_ | x078);
  ...
  assign z13 = ~x045 & ((~new_n282_ & x085) | (~new_n264_ & ~x107));
