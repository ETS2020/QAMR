// Benchmark "FAU" written by ABC on Wed Aug 26 09:28:22 2020
...
module FAU ( 
  ...
  assign new_n185_ = x053 & ((~new_n186_ & ~new_n197_) | ((new_n188_ | ~new_n192_) & x077));
  assign new_n186_ = x013 & (~x077 | (~new_n187_ & x021 & (x005 | ~x037)));
  assign new_n187_ = x069 & (~x005 | (~x029 & (x061 | x093)));
  assign new_n188_ = ~x005 & (new_n190_ | new_n191_ | (~new_n189_ & x013));
  ...
  assign new_n194_ = ~x101 & ~x005 & x037;
  ...
  assign new_n199_ = (x037 | (new_n189_ & (~x021 | x029))) & (((x029 | x037) & (x021 | x069)) | (~x013 & ~x037));
  assign new_n200_ = ~x057 & (new_n201_ | ~new_n203_ | new_n204_);
  ...
  assign z06 = z07 | (x046 & (new_n219_ | ~new_n223_ | (~new_n206_ & x054)));
  ...
  assign z08 = z07 | (~x040 & (~new_n239_ | (~new_n225_ & ~x048)));
  ...
  assign new_n231_ = x000 & (new_n235_ | ~new_n236_ | (new_n234_ & (new_n232_ | ~new_n233_)));
  ...
  assign z13 = z07 | (~x045 & (~new_n275_ | (~x053 & (new_n262_ | ~new_n267_))));
  assign new_n262_ = x005 & ((~x037 & x085) | (~x077 & (new_n263_ | ~new_n265_)));
  assign new_n263_ = ~x021 & (new_n264_ | (~new_n197_ & x125));
  assign new_n264_ = ~x069 & (x101 | x125 | x029 | x061 | x093);
  assign new_n265_ = (new_n266_ | x069) & ~x085 & (x037 | ~x069 | ~x101);
  assign new_n266_ = ((~x101 & ~x125) | (x061 & x093)) & (x013 | (~x029 & ~x061 & ~x093));
  assign new_n267_ = ~new_n270_ & ~new_n272_ & ((~x109 & ~x117) | (~new_n268_ & ~new_n274_));
  assign new_n268_ = ~x077 & (new_n269_ | (x005 & (x069 ? ~x037 : ~x021)));
  assign new_n269_ = ~x085 & (x021 | ((~x061 | ~x093) & x029 & ~x069));
  assign new_n270_ = x069 & (new_n271_ | (x021 & (x077 | ~x013 | ~x037)));
  assign new_n271_ = ~x077 & ~x085 & (x061 | x093 | (~x021 & x029));
  assign new_n272_ = new_n273_ & ~x077 & ~x085 & ~new_n189_ & (x101 | x125);
  assign new_n273_ = x029 & (~x021 | (~x013 & ~x069));
  assign new_n274_ = x013 & ~x085;
  assign new_n275_ = new_n277_ & (new_n276_ | ~x037 | x077 | x085);
  assign new_n276_ = ~new_n273_ & ~x061 & ~x093;
  assign new_n277_ = (~x013 | ~x077) & (~x053 | (new_n278_ & (~x085 | ~x005 | x013)));
  assign new_n278_ = ~x037 & (x077 | ~x021 | ~x069);
  assign z14 = z07 | (~x046 & (~new_n293_ | (~new_n280_ & ~x054)));
  ...
  assign new_n284_ = ~x062 & ~x094 & (x022 | ~x030);
