...
module FAU ( 
  ...
  assign z04 = x044 & ((~new_n180_ & (~x036 | x052)) | ~new_n177_ | (~new_n181_ & x036));
  assign new_n177_ = (new_n178_ | ~x012 | ~x076) & (~x085 | x012 | x076) & ((~x076 & ~x085) | x036 | x052);
  assign new_n178_ = ~new_n179_ & (x020 | x068);
  assign new_n179_ = ~x004 & ~x084;
  assign new_n180_ = (x020 | x068 | ~x012 | ~x085) & (~new_n179_ | ~x076);
  assign new_n181_ = (~x076 | x020 | x068) & (~new_n179_ | ~x012 | ~x085);
  ...
  assign z12 = ~x044 & (new_n258_ | new_n262_ | ~new_n264_ | (~new_n263_ & ~x052));
  assign new_n258_ = x036 & (~new_n259_ | (new_n261_ & (x076 | (~x012 & x085))));
  assign new_n259_ = (~new_n260_ | ~x012 | ~x085) & (~x052 | (~x076 & ~x085));
  assign new_n260_ = x004 & x084;
  assign new_n261_ = x020 & x068;
  assign new_n262_ = x012 & (x076 | (new_n261_ & ~x036 & x085));
  assign new_n263_ = (~new_n261_ | ~x076) & (~new_n260_ | ~x012 | ~x085);
  assign new_n264_ = (~new_n261_ | ~x085 | x012 | x076) & ((~x076 & (x012 | ~x085)) | ~new_n260_ | (x036 & x076));
  assign z13 = ~x045 & ((~new_n266_ & x076) | (~new_n285_ & x085));
  ...
  assign z14 = z07 | (~x046 & (~new_n300_ | (~new_n287_ & (x038 | ~x054))));
  ...
  assign new_n300_ = x078 ? (~x014 & (new_n224_ | ~new_n304_)) : (~new_n301_ & ((~new_n299_ & ~new_n304_) | ((new_n224_ | ~new_n299_) & x014)));
