...
module FAU ( 
  ...
  assign z04 = z15 | (x044 & (new_n181_ | (~x012 & ~x076)));
  ...
  assign z05 = x045 & ((~new_n203_ & ~x085) | (~new_n185_ & ~x095));
  ...
  assign new_n201_ = ((x021 & ~x029) | ~x061 | ~x093) & ~x037 & x085;
  ...
  assign z06 = z15 | (x046 & (~new_n218_ | (~new_n205_ & ~new_n224_)));
  ...
  assign new_n230_ = (~x056 | ~x088) & (x096 | x120);
  ...
  assign z13 = ~x045 & ((~new_n262_ & ~x085) | (~new_n276_ & ~x095));
  assign new_n262_ = new_n272_ & (x053 | (~new_n263_ & (x077 | (~new_n265_ & new_n269_))));
  ...
  assign new_n266_ = ~x021 & (x061 | x093 | (x125 & (~x109 | ~x117)));
  assign new_n267_ = (~x093 | ~x021 | ~x061) & ~x069 & (x101 | x125);
  assign new_n268_ = (x013 | (~x061 & ~x093)) & (~x101 | x037 | ~x069);
  assign new_n269_ = (~x069 | (new_n270_ & (x021 | ~x029))) & (new_n271_ | ~x029 | (x021 & (x013 | x069)));
  assign new_n270_ = ~x061 & ~x093;
  assign new_n271_ = ~x005 & ((~x101 & ~x125) | (x061 & x093));
  assign new_n272_ = new_n275_ & (x077 | (~new_n273_ & ~new_n274_));
  assign new_n273_ = x037 & (x061 | x093 | (~x021 & x029));
  assign new_n274_ = (~x013 | ~x037) & ((x029 & x037) | (x021 & x069));
  assign new_n275_ = (~x037 | ~x053) & (~x077 | (~x013 & (x053 | ~x021 | ~x069)));
  assign new_n276_ = new_n278_ & (x077 | (~new_n277_ & (new_n280_ | ~x021 | ~x069)));
  assign new_n277_ = (x085 | (new_n199_ & x061)) & x005 & (~x053 | (~x013 & x085));
  assign new_n278_ = (~x037 | ~x053) & (~x077 | (new_n279_ & (~x005 | x037 | ~x085)));
  assign new_n279_ = ~x013 & (x053 | ~x021 | ~x069);
  assign new_n280_ = ~x053 & x013 & x037;
  assign z14 = z15 | (~x046 & (~new_n295_ | (~new_n282_ & (x038 | ~x054))));
  ...
  assign new_n295_ = x078 ? (~x014 & (new_n224_ | ~new_n299_)) : (~new_n296_ & ((~new_n294_ & ~new_n299_) | (x014 & (new_n224_ | ~new_n294_))));
