...
module FAU ( 
  ...
  assign z06 = (z16 | x046) & (~new_n200_ | (x054 & (new_n188_ | ~new_n196_)));
  ...
  assign new_n205_ = (x078 | (x014 & (~new_n204_ | ~x038))) & ~z16 & (x038 | x054);
  ...
  assign z14 = ~z16 & ~x046 & (~new_n275_ | (~new_n262_ & ~x054));
