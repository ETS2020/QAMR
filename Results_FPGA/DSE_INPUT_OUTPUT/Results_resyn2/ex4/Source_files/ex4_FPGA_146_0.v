// Benchmark "FAU" written by ABC on Wed Aug 26 09:28:06 2020
...
module FAU ( 
  ...
  assign new_n203_ = x013 & (x005 | x085 | (~x037 & x053));
  assign z06 = (~new_n218_ | (~new_n205_ & ~new_n224_)) & ~z07 & x046;
  ...
  assign new_n223_ = x014 & (x006 | x086 | (~x038 & x054));
  ...
  assign z13 = ~x045 & ((~new_n281_ & x085) | (~new_n262_ & x090));
  ...
  assign new_n297_ = x038 & ((~new_n298_ & ~x086) | (~new_n299_ & ~x070));
