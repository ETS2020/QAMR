...
module FAU ( 
  ...
  assign new_n200_ = ~x071 & (new_n201_ | ~new_n203_ | new_n204_);
  ...
  assign new_n219_ = (~x078 | (~new_n220_ & new_n223_)) & new_n224_ & (new_n225_ | x078);
  ...
  assign new_n224_ = ~z16 & (x038 | x054);
  assign new_n225_ = x014 & (x086 | x006 | ~x038);
  ...
  assign new_n294_ = x078 ? (~x014 & (~new_n298_ | new_n299_)) : (~new_n295_ & ((~new_n293_ & ~new_n298_) | (x014 & (~new_n293_ | new_n299_))));
