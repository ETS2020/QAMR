// Benchmark "FAU" written by ABC on Wed Aug 26 09:27:24 2020
...
module FAU ( 
  ...
  assign z05 = z16 | (x045 & (~new_n203_ | (~new_n187_ & (~x037 | x053))));
  ...
  assign z06 = (~new_n222_ | (~new_n209_ & ~new_n228_)) & ~z16 & x046;
  ...
  assign z13 = ~x045 & ((~new_n285_ & x085) | (~new_n266_ & x099));
  ...
  assign new_n291_ = (~x070 | (~x062 & ~x094 & (x022 | ~x030))) & (~new_n292_ | ~x030 | (x062 & x094));
  ...
  assign new_n300_ = x078 ? (~x014 & (new_n228_ | ~new_n304_)) : (~new_n301_ & ((~new_n299_ & ~new_n304_) | (x014 & (new_n228_ | ~new_n299_))));
  assign new_n301_ = x038 & ((~new_n303_ & ~x070) | (~new_n302_ & ~x086));
  assign new_n302_ = (x022 | ~x030) & ~x062 & ~x094;
