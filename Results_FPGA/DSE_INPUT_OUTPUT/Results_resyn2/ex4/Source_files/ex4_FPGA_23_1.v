...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n203_ & ~x085) | (~new_n187_ & x077));
  assign new_n187_ = ~new_n199_ & new_n201_ & (~x053 | (~new_n188_ & ~new_n193_ & ~new_n196_));
  assign new_n188_ = ~x005 & (new_n191_ | ~new_n192_ | (x069 & (new_n189_ | new_n190_)));
  assign new_n189_ = (x021 | (x013 & x037)) & (~x029 | ~x061 | ~x093);
  assign new_n190_ = (x021 | x061 | x093) & (~x101 | ~x125);
  assign new_n191_ = (x109 | x117) & x021 & ~x125;
  assign new_n192_ = x085 & (x101 | ~x037 | x069);
  assign new_n193_ = (~x109 | ~x117) & (new_n194_ | (~new_n195_ & x085));
  assign new_n194_ = ~x005 & (x069 ? x021 : x037);
  assign new_n195_ = x013 & x021 & (~x069 | x029 | (~x061 & ~x093));
  assign new_n196_ = x085 & ((~new_n197_ & ~x069) | (new_n198_ & (x021 | (x013 & x069))));
  assign new_n197_ = (~x021 | x029) & x061 & x093;
  assign new_n198_ = ~x029 & (x061 | x093) & (~x101 | ~x125);
  assign new_n199_ = ~x037 & ((~new_n200_ & x069) | ~x053 | (~new_n197_ & x085));
  assign new_n200_ = (x005 | (x101 & x125)) & (~x085 | ~x013 | x029);
  assign new_n201_ = (~new_n202_ | (x053 & ~x013 & ~x037)) & (x085 | x005 | ~x013);
  assign new_n202_ = ~x021 & ~x069;
  assign new_n203_ = (x037 | x053) & (x077 | ((~new_n202_ | ~x053) & x013 & (x005 | ~x037)));
  assign z06 = ~z07 & x046 & (~new_n218_ | (~new_n205_ & (~x038 | x054)));
  ...
  assign z13 = ~x045 & (~new_n272_ | (~x085 & (new_n276_ | (~new_n261_ & ~x053))));
  assign new_n261_ = ~new_n270_ & (x077 | (~new_n262_ & ~new_n268_ & (new_n265_ | ~x005)));
  assign new_n262_ = new_n264_ & ((x005 & ~x069) | (new_n263_ & (~x061 | ~x093)));
  assign new_n263_ = x029 & (~x021 | (~x013 & ~x069));
  assign new_n264_ = (x101 | x125) & (~x021 | ~x061 | ~x093);
  assign new_n265_ = ~new_n263_ & ~new_n267_ & (new_n266_ | (x013 & x021));
  ...
  assign new_n272_ = ~new_n273_ & ~new_n274_ & (new_n275_ | z07 | (x037 & ~x053));
  assign new_n273_ = (x053 | (~x077 & (~new_n266_ | new_n263_))) & x037 & (x077 | ~x085);
  assign new_n274_ = x077 & (x013 | (~x053 & x021 & x069));
  assign new_n275_ = (~x005 | ~x085) & (x077 | ~x021 | ~x069);
  assign new_n276_ = ~x013 & ~x077 & x021 & x069;
  assign z14 = (z07 | ~x046) & (~new_n291_ | (~new_n278_ & ~x054));
  assign new_n278_ = new_n289_ & (x078 | (~new_n279_ & ~new_n284_ & (new_n282_ | x086)));
  assign new_n279_ = (new_n280_ | new_n281_) & (x110 | x118);
  assign new_n280_ = x006 & (x070 ? ~x038 : ~x022);
  assign new_n281_ = ~x086 & (x022 | (~x070 & x030 & (~x062 | ~x094)));
  assign new_n282_ = (~x070 | (~x062 & ~x094 & (x022 | ~x030))) & (~new_n283_ | ~x030 | (x062 & x094));
  ...
  assign new_n289_ = (~new_n290_ | ~x078) & (~x014 | x086 | (~x110 & ~x118));
  ...
  assign new_n296_ = ~new_n297_ & ~z07 & (~x038 | ~x054);
