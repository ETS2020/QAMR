...
module FAU ( 
  ...
  assign z05 = z16 | (x045 & (new_n185_ | ~new_n204_ | (~new_n202_ & x077)));
  assign new_n185_ = x053 & (~new_n196_ | (x077 & (new_n186_ | new_n190_ | ~new_n192_)));
  assign new_n186_ = (~x101 | ~x125) & ((~new_n187_ & (new_n188_ | new_n189_)) | (new_n189_ & x021));
  assign new_n187_ = ~x061 & ~x093;
  assign new_n188_ = ~x029 & x085 & (x021 | (x013 & x069));
  assign new_n189_ = ~x005 & x069;
  assign new_n190_ = ~x069 & (new_n191_ | (~x101 & ~x005 & x037));
  assign new_n191_ = x085 & (~x061 | ~x093 | (x021 & ~x029));
  assign new_n192_ = (x005 | (~new_n194_ & new_n195_)) & ((~x013 & ~x021) | new_n193_ | x005);
  assign new_n193_ = x061 & x093;
  assign new_n194_ = ~x029 & (x021 | (x013 & x069));
  assign new_n195_ = x085 & ((~x109 & ~x117) | ~x021 | x125);
  assign new_n196_ = (new_n197_ | (~new_n200_ & (~x077 | (~new_n198_ & ~new_n199_)))) & (~new_n201_ | x077);
  ...
  assign new_n202_ = new_n203_ & (x037 | ~x085 | (new_n193_ & ~new_n194_));
  assign new_n203_ = (~new_n201_ | (~x037 & x053)) & (~x013 | (~new_n201_ & (x005 | x085)));
  assign new_n204_ = (x037 | x053) & (x077 | (x013 & (~x037 | x005 | x085)));
  assign z06 = ~z16 & x046 & (new_n219_ | ~new_n223_ | (~new_n206_ & x054));
  ...
  assign z13 = z16 | (~x045 & (~new_n273_ | (~x053 & (new_n260_ | ~new_n265_))));
  assign new_n260_ = x005 & ((~x037 & x085) | (~x077 & (new_n261_ | ~new_n263_)));
  assign new_n261_ = ~x069 & (new_n262_ | ((x101 | x125) & (~new_n193_ | ~x021)));
  assign new_n262_ = (~x013 | ~x021) & (x029 | x061 | x093);
  assign new_n263_ = new_n264_ & (new_n197_ | x021 | ~x125);
  assign new_n264_ = ~x085 & (~x101 | x037 | ~x069);
  assign new_n265_ = new_n268_ & ((~x109 & ~x117) | (~new_n266_ & (~x013 | x085)));
  ...
  assign new_n270_ = x021 & (x077 | ~x013 | ~x037);
  assign new_n271_ = x029 & (~x021 | (~x013 & ~x069));
  assign new_n272_ = ~x077 & ~x085 & (x101 | x125) & (~x061 | ~x093);
  assign new_n273_ = new_n274_ & ((new_n187_ & ~new_n271_) | ~x037 | x077 | x085);
