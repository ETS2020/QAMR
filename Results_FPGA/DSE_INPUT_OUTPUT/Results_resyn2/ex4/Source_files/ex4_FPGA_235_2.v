// Benchmark "FAU" written by ABC on Wed Aug 26 09:29:19 2020
...
module FAU ( 
  ...
  assign z04 = (~x076 | (new_n179_ & (new_n177_ | x012))) & x044 & (new_n180_ | ~x012);
  assign new_n177_ = (x052 | new_n178_ | ~x036) & (x036 | ~x052 | (~x004 & ~x084));
  assign new_n178_ = ~x020 & ~x068;
  assign new_n179_ = x085 & ((~x004 & ~x084) | new_n178_ | ~x036);
  assign new_n180_ = (x076 | (((~x004 & ~x084) | ~x036 | x052) & (new_n178_ | x036 | ~x052))) & (new_n178_ | ~x052 | (~x004 & ~x084));
  assign z05 = z07 | (x045 & (~new_n198_ | (~new_n182_ & (~x037 | x053))));
  assign new_n182_ = new_n191_ & (~x077 | (~new_n185_ & ~new_n187_ & (new_n183_ | new_n197_)));
  assign new_n183_ = ((~x061 & ~x093) | (~new_n184_ & (x005 | ~x069))) & (x005 | ~x021 | ~x069);
  assign new_n184_ = x085 & ~x029 & (x021 | (x013 & x069));
  assign new_n185_ = ~x069 & (new_n186_ | (~x005 & x037 & ~x101));
  assign new_n186_ = x085 & ((x021 & ~x029) | ~x061 | ~x093);
  ...
  assign new_n190_ = x085 & ((~x109 & ~x117) | ~x021 | x125);
  assign new_n191_ = new_n196_ & (new_n192_ | (~new_n195_ & (~x077 | (~new_n193_ & ~new_n194_))));
  ...
  assign new_n196_ = x053 & (x077 | x021 | x069);
  assign new_n197_ = x101 & x125;
  assign new_n198_ = x077 ? new_n199_ : new_n202_;
  assign new_n199_ = (new_n200_ | x037 | ~x085) & ~new_n201_ & (~x013 | x005 | x085);
  assign new_n200_ = (x029 | (~x021 & (~x013 | ~x069))) & x061 & x093;
  assign new_n201_ = ~x021 & ~x069 & (x013 | x037 | ~x053);
  assign new_n202_ = x013 & ((~x037 & x053) | x005 | x085);
  ...
  assign z12 = ~x044 & (new_n257_ | (~new_n259_ & x036) | new_n262_ | (~new_n261_ & ~x036));
  assign new_n257_ = x085 & ((~x052 & new_n258_ & ~x012) | (x012 & x076));
  assign new_n258_ = x020 & x068;
  assign new_n259_ = ((~new_n258_ & ~x052) | x012 | ~x085) & (x076 | (~new_n260_ & ~x052));
  assign new_n260_ = x004 & x084;
  assign new_n261_ = (~new_n258_ | x076) & (~new_n260_ | x012 | ~x085);
  assign new_n262_ = (new_n260_ | (new_n258_ & ~x012)) & ~x076 & (~x012 | ~x052);
  assign z13 = ~x045 & ((~new_n264_ & ~x076) | (~new_n283_ & x085));
  ...
  assign new_n298_ = x078 ? (~x014 & (new_n223_ | ~new_n302_)) : (~new_n299_ & ((~new_n297_ & ~new_n302_) | ((new_n223_ | ~new_n297_) & x014)));
