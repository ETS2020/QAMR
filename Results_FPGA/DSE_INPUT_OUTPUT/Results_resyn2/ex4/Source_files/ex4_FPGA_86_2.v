// Benchmark "FAU" written by ABC on Wed Aug 26 09:27:12 2020
...
module FAU ( 
  ...
  assign z04 = x044 & (~new_n179_ | (x085 & (new_n182_ | (~x012 & ~x076))));
  assign new_n179_ = (new_n180_ | ~x012) & (x036 | ((~new_n181_ | ~x076) & x052 & (x012 | x076)));
  assign new_n180_ = (~new_n181_ | ~x036 | ~x085) & (x036 | x020 | x068);
  assign new_n181_ = ~x004 & ~x084;
  assign new_n182_ = x036 & ((~x020 & ~x068 & (x052 | x076)) | (new_n181_ & x052));
  assign z05 = x045 & ((~new_n184_ & x085) | ((new_n199_ | ~new_n203_) & ~x036));
  ...
  assign z12 = ~x044 & ((~new_n259_ & x085) | new_n261_ | (~new_n263_ & ~x036));
  assign new_n259_ = (~x012 | ~x076) & (~x036 | (~x052 & (~new_n260_ | x076)));
  assign new_n260_ = x004 & x084;
  assign new_n261_ = ~x012 & ((new_n260_ & ~x036) | (new_n262_ & x036 & x085));
  assign new_n262_ = x020 & x068;
  assign new_n263_ = (x052 | (~new_n260_ & ~new_n262_)) & (~new_n262_ | x076) & (~x012 | ~x076);
  assign z13 = ~x045 & ((~new_n265_ & ~x036) | (~new_n283_ & x085));
  assign new_n265_ = new_n279_ & (x053 | (~new_n266_ & (x077 | (~new_n270_ & ~new_n273_))));
  assign new_n266_ = (x109 | x117) & (new_n267_ | (~x077 & (new_n268_ | new_n269_)));
  assign new_n267_ = x013 & ~x085;
  assign new_n268_ = x005 & ((~x037 & x069) | (~x061 & ~x021 & ~x069));
  assign new_n269_ = ~x085 & (x021 | (~x069 & x029 & (~x061 | ~x093)));
  ...
  assign new_n278_ = x125 & ((x021 & ~x093) | ~x061 | x069);
  assign new_n279_ = new_n282_ & (x077 | (~new_n280_ & ~new_n281_ & (~new_n201_ | x037)));
  ...
  assign new_n283_ = (~x077 | (~x013 & (~new_n201_ | x053) & (~x005 | (x037 & ~x053)))) & (~x037 | ~x053) & (x077 | ((~x005 | (x013 & x053)) & (~new_n201_ | (x013 & x037))));
