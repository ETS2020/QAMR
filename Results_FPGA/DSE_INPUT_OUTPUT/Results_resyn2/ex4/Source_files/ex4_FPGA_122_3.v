...
module FAU ( 
  ...
  assign z06 = ~z16 & x046 & (~new_n201_ | (~new_n188_ & x054));
  ...
  assign z14 = (~new_n272_ | (~x054 & (new_n260_ | ~new_n268_))) & (z16 | ~x046);
  ...
  assign new_n275_ = (new_n276_ | (x022 & x070)) & (~x014 | ((~x038 | x054) & x022 & x070));
  assign new_n276_ = x006 & x086;
  assign new_n277_ = (~x078 | (~x014 & (~new_n276_ | x038))) & ~z16 & (~x038 | ~x054);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z18 = 1'b0;
  assign z21 = 1'b0;
