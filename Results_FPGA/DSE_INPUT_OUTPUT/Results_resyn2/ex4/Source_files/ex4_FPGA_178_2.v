...
module FAU ( 
  ...
  assign z10 = ~x042 & ((~new_n252_ & (~x018 | x085)) | (~new_n253_ & x085 & x018 & x066));
  assign new_n252_ = ((x074 & ~x010 & x034) | (x050 & x010 & ~x034) | ~x002 | ~x082) & (~x034 | ~x050) & (~x010 | ~x074);
  assign new_n253_ = x010 ? x034 : (x074 & ~x034 & x050);
