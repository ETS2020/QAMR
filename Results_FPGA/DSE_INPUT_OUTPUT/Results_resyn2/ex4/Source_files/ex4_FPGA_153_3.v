...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n185_ & ~x050) | (~new_n203_ & ~x085));
  ...
  assign z10 = ~x042 & (new_n250_ | (~new_n252_ & x010) | new_n255_ | (~new_n254_ & ~x010));
  assign new_n250_ = ~x085 & ((x034 & x050) | (~x074 & new_n251_ & ~x034));
  assign new_n251_ = x018 & x066;
  assign new_n252_ = (x034 | x085 | (~new_n251_ & ~x074)) & (x050 | (~new_n253_ & ~x074));
  assign new_n253_ = x002 & x082;
  assign new_n254_ = (~new_n253_ | x034 | x085) & (~new_n251_ | x050);
  assign new_n255_ = ~x050 & (~x034 | ~x074) & (new_n253_ | (new_n251_ & ~x034));
  ...
  assign new_n280_ = (x085 | (new_n199_ & x061)) & x005 & (~x053 | (~x013 & x085));
  ...
  assign new_n298_ = x078 ? (~x014 & (new_n224_ | ~new_n302_)) : (~new_n299_ & ((~new_n297_ & ~new_n302_) | (x014 & (new_n224_ | ~new_n297_))));
