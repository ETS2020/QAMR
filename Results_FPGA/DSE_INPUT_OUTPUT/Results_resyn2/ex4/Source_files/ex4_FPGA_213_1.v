...
module FAU ( 
  ...
  assign z06 = ~z17 & x046 & (~new_n218_ | (~new_n205_ & x054));
  ...
  assign z14 = (z17 | ~x046) & (~new_n290_ | (~x054 & (new_n278_ | ~new_n286_)));
  ...
  assign new_n295_ = (~x078 | (~x014 & (~new_n294_ | x038))) & ~z17 & (~x038 | ~x054);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z21 = 1'b0;
