...
module FAU ( 
  ...
  assign z06 = (x054 & ~x085) | (x046 & (new_n220_ | ~new_n223_ | (~new_n205_ & x054)));
  assign new_n205_ = ~new_n206_ & ~new_n210_ & ~new_n219_ & (new_n216_ | ~x078 | ~x086);
  assign new_n206_ = (~x110 | ~x118) & (new_n209_ | (x078 & (new_n207_ | new_n208_)));
  assign new_n207_ = x086 & (~x022 | (~x030 & x070 & (x062 | x094)));
  assign new_n208_ = (x022 | ~x070) & ~x006 & (x038 | x070);
  assign new_n209_ = ~x014 & x086;
  assign new_n210_ = new_n215_ & (new_n213_ | ~new_n214_ | (x070 & (new_n211_ | new_n212_)));
  assign new_n211_ = (x022 | (x014 & x038)) & (~x030 | ~x062 | ~x094);
  assign new_n212_ = (~x102 | ~x126) & (x022 | x062 | x094);
  assign new_n213_ = (x110 | x118) & x022 & ~x126;
  assign new_n214_ = x086 & (x102 | ~x038 | x070);
  assign new_n215_ = ~x006 & (x078 | (x038 & ~x086));
  assign new_n216_ = ~new_n217_ & (~new_n218_ | x030 | (x102 & x126));
  assign new_n217_ = ~x070 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n218_ = (x062 | x094) & (x014 | x022);
  assign new_n219_ = ~x022 & ~x070 & (~x078 | x014 | x038);
  assign new_n220_ = ~new_n221_ & ~x038 & x078;
  assign new_n221_ = (new_n222_ | ~x086) & (x006 | ~x070 | (x102 & x126));
  assign new_n222_ = x062 & x094 & (~x022 | x030) & (~x014 | x030 | ~x070);
  assign new_n223_ = (new_n224_ | x054) & (x014 | x078) & (x022 | x054 | x070 | ~x078);
  assign new_n224_ = x038 & (x086 | x006 | ~x014);
  ...
  assign z13 = ~x045 & ((~new_n262_ & ~x054) | (~new_n281_ & x085));
  ...
  assign z14 = ~x046 & (~new_n297_ | (~x054 & (new_n283_ | ~new_n291_)));
  assign new_n283_ = new_n290_ & (~new_n288_ | (~x070 & (new_n284_ | new_n286_)));
  assign new_n284_ = (~new_n285_ | x030) & (~x022 | (~x014 & ~x038));
  assign new_n285_ = ~x062 & ~x094;
  assign new_n286_ = ~new_n287_ & (x126 | x102 | x110 | x118);
  assign new_n287_ = (~x038 | (~x102 & ~x126)) & x022 & ((~x102 & ~x126) | (x062 & x094));
  assign new_n288_ = new_n289_ & (x038 | ~x070 | (~x102 & ~x110 & ~x118));
  assign new_n289_ = ~x086 & ((x110 & x118) | x022 | ~x126);
  assign new_n290_ = x006 & (~x078 | (~x038 & x086));
  assign new_n291_ = ~new_n295_ & (x078 | x086 | (new_n292_ & ~new_n296_));
  assign new_n292_ = (~new_n294_ | (~new_n293_ & ~x038 & (x022 | ~x070))) & (new_n285_ | (~x038 & ~x070));
  assign new_n293_ = (x102 | x126) & (~x062 | ~x094);
  assign new_n294_ = x030 & (~x022 | (~x014 & ~x070));
  assign new_n295_ = ~x038 & x022 & x070;
  assign new_n296_ = (x110 | x118) & (x022 | (x030 & (~x062 | ~x094)));
  assign new_n297_ = ~new_n298_ & (new_n300_ | x014) & (new_n299_ | ~x014);
  assign new_n298_ = x054 & x085 & (x038 | (~x078 & x022 & x070));
  assign new_n299_ = (~x078 | (x054 & ~x085)) & ((~x110 & ~x118) | x054 | x086);
  assign new_n300_ = (x054 | ~x022 | ~x070) & (~x054 | ~x085 | ~x006 | ~x086);
  assign z17 = 1'b0;
  assign z20 = 1'b0;
  assign z23 = 1'b0;
  assign z25 = 1'b0;
