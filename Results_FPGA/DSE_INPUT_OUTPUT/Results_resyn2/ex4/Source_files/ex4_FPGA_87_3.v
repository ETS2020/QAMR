...
module FAU ( 
  ...
  assign z01 = x041 & (~new_n170_ | new_n167_ | x085 | (~x033 & ~x049));
  assign new_n167_ = (new_n168_ | ~x009) & x033 & (new_n169_ | x009);
  assign new_n168_ = ~x001 & ~x081;
  assign new_n169_ = ~x017 & ~x065;
  assign new_n170_ = ((~new_n169_ & x009) | (~new_n168_ & ~x009) | (x033 & ~x049)) & ((~new_n168_ & ~new_n169_ & x009) | (x009 ^ x073));
  assign z02 = ~new_n172_ & (z15 | x042);
  assign new_n172_ = ((~new_n175_ & x010) | ~x050 | (~new_n176_ & ~x010)) & new_n173_ & ((~new_n176_ & x010) | ~x034 | (~new_n175_ & ~x010));
  assign new_n173_ = (new_n174_ | ~x010 | ~x074) & (x034 | x050) & ~z15 & (x010 | x074);
  assign new_n174_ = (x018 | x066) & (x002 | x082);
  assign new_n175_ = ~x018 & ~x066;
  assign new_n176_ = ~x002 & ~x082;
  assign z03 = ~new_n178_ & ~z15 & x043;
  assign new_n178_ = ((~new_n179_ & x011) | (~new_n180_ & ~x011) | (x035 & ~x051)) & ((~new_n180_ & x011) | ~x035 | (~new_n179_ & ~x011)) & (~x011 | ~x075 | (~new_n179_ & ~new_n180_)) & (x035 | x051) & (x011 | x075);
  assign new_n179_ = ~x019 & ~x067;
  assign new_n180_ = ~x003 & ~x083;
  assign z04 = ~new_n182_ & ~z15 & x044;
  assign new_n182_ = ((~new_n183_ & x012) | (~new_n184_ & ~x012) | (x036 & ~x052)) & ((~new_n184_ & x012) | ~x036 | (~new_n183_ & ~x012)) & (~x012 | ~x076 | (~new_n183_ & ~new_n184_)) & (x036 | x052) & (x012 | x076);
  assign new_n183_ = ~x020 & ~x068;
  assign new_n184_ = ~x004 & ~x084;
  assign z05 = x045 & ((~new_n186_ & ~x041) | (~new_n204_ & ~x085));
  ...
  assign new_n202_ = ((x021 & ~x029) | ~x061 | ~x093) & ~x037 & x085;
  ...
  assign z06 = ~z15 & x046 & (~new_n219_ | (~new_n206_ & ~new_n225_));
  ...
  assign new_n231_ = (~x056 | ~x088) & (x096 | x120);
  ...
  assign new_n270_ = (~x013 | ~x021) & (x061 | x093);
  ...
  assign new_n298_ = x078 ? (~x014 & (new_n225_ | ~new_n302_)) : (~new_n299_ & ((~new_n297_ & ~new_n302_) | (x014 & (new_n225_ | ~new_n297_))));
