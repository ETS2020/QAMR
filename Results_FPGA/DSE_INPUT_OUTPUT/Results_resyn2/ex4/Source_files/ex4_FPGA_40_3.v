// Benchmark "FAU" written by ABC on Wed Aug 26 09:26:11 2020
...
module FAU ( 
  ...
  assign z06 = ~z15 & x046 & (~new_n197_ | (~new_n184_ & x054));
  assign new_n184_ = new_n195_ & (~x078 | (~new_n187_ & ~new_n190_ & (new_n185_ | new_n196_)));
  assign new_n185_ = (x006 | (x070 ? ~x022 : ~x038)) & (~x086 | (x022 & (~new_n186_ | ~x070)));
  ...
  assign new_n190_ = ~x006 & (new_n193_ | ~new_n194_ | (x070 & (new_n191_ | new_n192_)));
  ...
  assign new_n195_ = (x078 | x022 | x070) & (new_n196_ | x014 | ~x086);
  assign new_n196_ = x110 & x118;
  assign new_n197_ = new_n201_ & (new_n198_ | ~x078);
  assign new_n198_ = new_n200_ & (x038 | ((new_n199_ | ~x070) & (new_n188_ | ~x086)));
  assign new_n199_ = (x006 | (x102 & x126)) & (~x086 | ~x014 | x030);
  assign new_n200_ = (x006 | ~x014 | x086) & ((~x014 & ~x038) | x022 | x070);
  assign new_n201_ = (x038 | x054) & (x078 | (x014 & (x086 | x006 | ~x038)));
  assign z08 = z15 | (~x040 & (~new_n216_ | (~x048 & (new_n203_ | ~new_n211_))));
  ...
  assign new_n207_ = new_n208_ & ((x104 & x112) | x016 | ~x120);
  ...
  assign z14 = (z15 | ~x046) & (~new_n270_ | (~x054 & (new_n258_ | ~new_n266_)));
  ...
  assign new_n264_ = new_n265_ & (x038 | ~x070 | ~x102);
  ...
  assign new_n272_ = (~x006 | (~x102 & ~x126)) & (x014 | ~x030 | x086);
  assign new_n273_ = (new_n274_ | (x022 & x070)) & (~x014 | ((~x038 | x054) & x022 & x070));
  assign new_n274_ = x006 & x086;
  assign new_n275_ = (~x078 | (~x014 & (~new_n274_ | x038))) & ~z15 & (~x038 | ~x054);
  assign z07 = 1'b0;
  assign z17 = 1'b0;
  assign z18 = 1'b0;
  assign z19 = 1'b0;
