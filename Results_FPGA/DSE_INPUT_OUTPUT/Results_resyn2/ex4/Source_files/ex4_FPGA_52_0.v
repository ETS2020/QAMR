...
module FAU ( 
  ...
  assign z04 = (z17 | x044) & (~new_n183_ | new_n181_ | z17 | (~x012 & ~x076));
  assign new_n181_ = (x052 | (~x004 & ~x084)) & x012 & (new_n182_ | ~x052);
  assign new_n182_ = ~x020 & ~x068;
  assign new_n183_ = x052 ? ((~new_n182_ | ~x036) & ((~x036 & ~x076) | x004 | x084)) : (x036 & (~new_n182_ | ~x076));
  assign z05 = z17 | (x045 & (~new_n201_ | (~new_n185_ & (~x037 | x053))));
  ...
  assign z12 = ~z17 & ~x044 & (new_n260_ | (x012 & x076));
  assign new_n260_ = (x036 | ((new_n261_ | new_n262_) & ((new_n262_ & ~x012) | ~x052 | (new_n261_ & ~x076)))) & ((new_n261_ & ~x012) | ~x036 | x052 | (new_n262_ & ~x076));
  assign new_n261_ = x020 & x068;
  assign new_n262_ = x004 & x084;
  assign z13 = ~x045 & ((~new_n264_ & x052) | (~new_n283_ & x085));
  ...
  assign z14 = ~z17 & ~x046 & (~new_n298_ | (~new_n285_ & (x038 | ~x054)));
