// Benchmark "FAU" written by ABC on Wed Aug 26 09:26:02 2020
...
module FAU ( 
  ...
  assign z20 = ~x073 & ~x085;
  assign z01 = z20 | (~new_n165_ & x041);
  assign new_n165_ = (x073 | ((~new_n166_ | ~x033) & x009 & (~new_n167_ | (x033 & ~x049)))) & (x033 | x049) & (~x073 | ((~x009 | (~new_n166_ & ~new_n167_)) & (~new_n167_ | ~x033) & (~new_n166_ | ~x049)));
  assign new_n166_ = ~x001 & ~x081;
  assign new_n167_ = ~x017 & ~x065;
  assign z02 = ~new_n169_ & (z20 | x042);
  assign new_n169_ = ((~new_n172_ & x010) | ~x050 | (~new_n173_ & ~x010)) & new_n170_ & ((~new_n173_ & x010) | ~x034 | (~new_n172_ & ~x010));
  assign new_n170_ = (new_n171_ | ~x010 | ~x074) & (x034 | x050) & ~z20 & (x010 | x074);
  assign new_n171_ = (x002 | x082) & (x018 | x066);
  assign new_n172_ = ~x018 & ~x066;
  assign new_n173_ = ~x002 & ~x082;
  assign z03 = ~new_n175_ & ~z20 & x043;
  assign new_n175_ = ((~new_n176_ & x011) | (x035 & ~x051) | (~new_n177_ & ~x011)) & ((~new_n177_ & x011) | ~x035 | (~new_n176_ & ~x011)) & ((~new_n176_ & ~new_n177_) | ~x011 | ~x075) & (x035 | x051) & (x011 | x075);
  assign new_n176_ = ~x019 & ~x067;
  assign new_n177_ = ~x003 & ~x083;
  assign z04 = ~new_n179_ & (z20 | x044);
  assign new_n179_ = ((~new_n182_ & x012) | ~x052 | (~new_n183_ & ~x012)) & new_n180_ & ((~new_n183_ & x012) | ~x036 | (~new_n182_ & ~x012));
  assign new_n180_ = (new_n181_ | ~x012 | ~x076) & (x036 | x052) & ~z20 & (x012 | x076);
  assign new_n181_ = (x004 | x084) & (x020 | x068);
  assign new_n182_ = ~x020 & ~x068;
  assign new_n183_ = ~x004 & ~x084;
  assign z05 = z20 | (x045 & (~new_n201_ | (~new_n185_ & (~x037 | x053))));
  ...
  assign z06 = ~z20 & x046 & (~new_n220_ | (~new_n207_ & ~new_n226_));
  ...
  assign z08 = ~z20 & ~x040 & (~new_n241_ | (~x048 & (new_n228_ | ~new_n236_)));
  ...
  assign z09 = z20 | (~x041 & (~new_n250_ | new_n248_ | (x033 & x049)));
  assign new_n248_ = (x009 | (x001 & x081)) & ~x033 & (new_n249_ | ~x009);
  assign new_n249_ = x017 & x065;
  assign new_n250_ = (~x009 | (~x073 & (x049 | ~x001 | ~x081))) & ((x073 & (~new_n249_ | x049)) | x009 | (~new_n249_ & (~x001 | ~x081)));
  assign z10 = ~new_n252_ & ~z20 & ~x042;
  ...
  assign z13 = ~x045 & ((~new_n264_ & x073) | (~new_n283_ & x085));
  ...
  assign new_n283_ = (~x077 | ((~x005 | (x037 & ~x053)) & ~x013 & (~new_n279_ | x053))) & (~x037 | ~x053) & (x077 | ((~x005 | (x013 & x053)) & (~new_n279_ | (x013 & x037))));
  assign z14 = z20 | (~x046 & (~new_n298_ | (~new_n285_ & (x038 | ~x054))));
  ...
  assign new_n298_ = x078 ? (~x014 & (new_n226_ | ~new_n302_)) : (~new_n299_ & ((~new_n297_ & ~new_n302_) | ((new_n226_ | ~new_n297_) & x014)));
