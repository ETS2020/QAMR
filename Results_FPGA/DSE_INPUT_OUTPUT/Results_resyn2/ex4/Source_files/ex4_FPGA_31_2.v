// Benchmark "FAU" written by ABC on Wed Aug 26 09:26:05 2020
...
module FAU ( 
  ...
  assign z04 = ~new_n179_ & x044 & x085;
  ...
  assign z05 = x045 & (new_n197_ | (x085 & (new_n183_ | new_n195_ | ~new_n200_)));
  assign new_n183_ = x053 & (new_n184_ | (x077 & (~new_n191_ | (~new_n186_ & ~x005))));
  assign new_n184_ = (~x109 | ~x117) & (~x013 | (x077 & (new_n185_ | ~x021)));
  assign new_n185_ = (x069 | (~x005 & x037)) & (~x005 | (~x029 & (x061 | x093)));
  ...
  assign new_n189_ = (x109 | x117) & x021 & ~x125;
  assign new_n190_ = (x013 | x021) & (~x061 | ~x093);
  assign new_n191_ = (x069 | (~new_n192_ & new_n193_)) & (~new_n194_ | (~x021 & (~x013 | ~x069)));
  assign new_n192_ = ~x101 & ~x005 & x037;
  assign new_n193_ = (~x021 | x029) & x061 & x093;
  assign new_n194_ = ~x029 & (x061 | x093) & (~x101 | ~x125);
  assign new_n195_ = ~new_n196_ & x077;
  assign new_n196_ = (new_n193_ | x037) & (((x029 | x037) & (x021 | x069)) | (~x013 & ~x037));
  assign new_n197_ = ~x044 & (new_n198_ | ~new_n200_ | new_n201_);
  assign new_n198_ = x077 & ((~new_n199_ & ~x005) | (x013 & ~x021 & ~x069));
  assign new_n199_ = (~x013 | x085) & (~x053 | (x085 & (x061 | ~x021 | ~x069)));
  assign new_n200_ = (x037 | x053) & (x077 | (x013 & (~x053 | x021 | x069)));
  assign new_n201_ = x037 & ((x077 & ~x021 & ~x069) | (~x005 & ~x077 & ~x085));
  assign z06 = (new_n216_ | ~new_n220_ | (~new_n203_ & x054)) & ~z16 & x046;
  ...
  assign z12 = x044 ? ~x085 : ~new_n254_;
  ...
  assign z13 = z16 | (~x045 & (~new_n272_ | (~x053 & (new_n258_ | ~new_n264_))));
  assign new_n258_ = x005 & (new_n263_ | (~x077 & (~new_n261_ | (~new_n259_ & ~x069))));
  assign new_n259_ = ((x013 & x021) | (~x029 & ~x061 & ~x093)) & (new_n260_ | (x021 & x061 & x093));
  assign new_n260_ = ~x101 & ~x125;
  assign new_n261_ = new_n262_ & ((x109 & x117) | x021 | ~x125);
  assign new_n262_ = ~x085 & (~x101 | x037 | ~x069);
  assign new_n263_ = ~x037 & x085;
  ...
  assign new_n271_ = (x101 | x125) & ~x077 & ~x085 & (~x061 | ~x093);
  ...
  assign z14 = ~z16 & ~x046 & (~new_n290_ | (~new_n277_ & ~x054));
