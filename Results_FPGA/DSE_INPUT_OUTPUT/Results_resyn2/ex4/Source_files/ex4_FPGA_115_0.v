// Benchmark "FAU" written by ABC on Wed Aug 26 09:27:30 2020
...
module FAU ( 
  ...
  assign new_n186_ = x085 & (~x021 | (~x029 & x069 & (x061 | x093)));
  ...
  assign new_n223_ = (x038 | x054) & (x078 | (x014 & (x006 | ~x038 | x086)));
  ...
  assign z14 = (~new_n275_ | (~x054 & (new_n263_ | ~new_n271_))) & (z07 | ~x046);
  ...
  assign new_n280_ = (~x078 | (~x014 & (~new_n279_ | x038))) & ~z07 & (~x038 | ~x054);
  assign z17 = 1'b0;
  assign z19 = 1'b0;
  assign z20 = 1'b0;
  assign z24 = 1'b0;
