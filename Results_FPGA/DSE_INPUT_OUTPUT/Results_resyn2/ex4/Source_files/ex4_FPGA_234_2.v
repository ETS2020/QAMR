...
module FAU ( 
  ...
  assign new_n189_ = (~x101 | ~x125) & ((~x005 & x021) | x061 | x093);
  ...
  assign z13 = (~new_n261_ & ~x053) | new_n274_ | (x045 & ~x085) | (~new_n280_ & ~x045);
  assign new_n261_ = new_n272_ & (x077 | (~new_n262_ & ~new_n267_ & (new_n265_ | x085)));
  assign new_n262_ = ~new_n193_ & (new_n264_ | (new_n263_ & (x069 ? ~x037 : ~x021)));
  assign new_n263_ = x005 & ~x045;
  ...
  assign new_n267_ = new_n263_ & (new_n270_ | ~new_n271_ | (~x069 & (new_n268_ | new_n269_)));
  ...
  assign new_n272_ = (~new_n273_ | x045 | ~x077) & (new_n193_ | ~x013 | x085);
  assign new_n273_ = x021 & x069;
  assign new_n274_ = ~x077 & (new_n278_ | (x037 & (new_n275_ | new_n277_)));
  assign new_n275_ = ~x069 & (new_n276_ | (~x085 & ~x013 & x029));
  assign new_n276_ = x005 & ~x045 & (x101 | x125);
  assign new_n277_ = ~x085 & (~new_n200_ | (~x021 & x029));
  assign new_n278_ = new_n279_ & (~x013 | (new_n273_ & (~x037 | x053)));
  assign new_n279_ = ~x045 & ((x021 & x069) | (x005 & x085));
  assign new_n280_ = (~x037 | ~x053) & (~x077 | (~x013 & (x037 | ~x005 | ~x085)));
  assign z14 = z07 | (~x046 & (new_n282_ | ~new_n300_ | (~new_n297_ & ~x078)));
