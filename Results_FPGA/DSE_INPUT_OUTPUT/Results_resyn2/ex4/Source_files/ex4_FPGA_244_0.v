...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n184_ & x085) | ((new_n199_ | ~new_n203_) & x003));
  ...
  assign new_n196_ = ~x037 & (~x061 | ~x093 | (x021 & ~x029));
  ...
  assign new_n219_ = (~x078 | (~new_n220_ & new_n223_)) & ~z07 & (new_n224_ | x078);
  ...
  assign z11 = z07 | (~x043 & (~new_n257_ | (~new_n255_ & ~x035) | (x035 & x051)));
  assign new_n255_ = (~new_n256_ | ~x011) & (~x083 | ~x003 | x011);
  assign new_n256_ = x019 & x067;
  assign new_n257_ = x011 ? (~x075 & (~x083 | ~x003 | x051)) : ((~new_n256_ | (x051 & x075)) & (~x083 | ~x003 | x075));
  ...
  assign z13 = ~x045 & ((~new_n263_ & x003) | (~new_n281_ & x085));
