...
module FAU ( 
  ...
  assign z06 = ~z07 & x046 & (new_n201_ | ~new_n205_ | (~new_n188_ & x054));
  ...
  assign z13 = (~new_n259_ & x085) | (~x045 & (~new_n255_ | (~new_n242_ & ~x053)));
  ...
  assign new_n273_ = (new_n274_ | ~x014 | x086) & (~x078 | ~x022 | ~x070);
