...
module FAU ( 
  ...
  assign new_n252_ = ~x085 & (x021 | ~x125 | (x109 & x117));
  assign new_n253_ = (new_n243_ | ~x013 | x085) & (~x077 | ~x021 | ~x069);
