...
module FAU ( 
  ...
  assign z06 = (z15 | x046) & (~new_n198_ | (x054 & (new_n186_ | ~new_n194_)));
  ...
  assign new_n203_ = (x078 | (x014 & (~new_n202_ | ~x038))) & ~z15 & (x038 | x054);
  ...
  assign new_n224_ = ~z15 & ~x040;
  assign z09 = ~new_n226_ & ~z15 & ~x041;
  ...
  assign z14 = ~z15 & ~x046 & (~new_n273_ | (~new_n260_ & ~x054));
