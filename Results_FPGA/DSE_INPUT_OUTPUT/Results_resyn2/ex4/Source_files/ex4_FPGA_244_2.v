...
module FAU ( 
  ...
  assign z03 = z07 | (x043 & (new_n175_ | (~x035 & ~x051)));
  assign new_n175_ = ((x075 & (new_n176_ | new_n177_)) | (new_n177_ & x051) | ~x011 | (new_n176_ & x035)) & ((new_n177_ & x035) | (new_n176_ & x051) | x011 | ~x075);
  ...
  assign z05 = x045 & ((~new_n183_ & x085) | ((new_n198_ | ~new_n202_) & ~x003));
  ...
  assign new_n195_ = ~x037 & ((x021 & ~x029) | ~x061 | ~x093);
  ...
  assign new_n218_ = (~x078 | (~new_n219_ & new_n222_)) & ~z07 & (new_n223_ | x078);
  ...
  assign z11 = z07 | (~x043 & (~new_n256_ | new_n254_ | (x035 & x051)));
  assign new_n254_ = ~x035 & (new_n255_ | ~x011) & (x011 | (x003 & x083));
  assign new_n255_ = x019 & x067;
  assign new_n256_ = (~x011 | (~x075 & (x051 | ~x003 | ~x083))) & ((x075 & (~new_n255_ | x051)) | x011 | (~new_n255_ & (~x003 | ~x083)));
  ...
  assign z13 = ~x045 & ((~new_n262_ & ~x003) | (~new_n280_ & x085));
