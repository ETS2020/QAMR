...
module FAU ( 
  ...
  assign z06 = ~z15 & x046 & (~new_n203_ | (~new_n190_ & x054));
  assign new_n190_ = new_n201_ & (~x078 | (~new_n193_ & ~new_n196_ & (new_n191_ | new_n202_)));
  assign new_n191_ = (x006 | (x070 ? ~x022 : ~x038)) & (~x086 | (x022 & (~new_n192_ | ~x070)));
  ...
  assign new_n201_ = (x078 | x022 | x070) & (new_n202_ | x014 | ~x086);
  assign new_n202_ = x110 & x118;
  assign new_n203_ = new_n207_ & (new_n204_ | ~x078);
  assign new_n204_ = new_n206_ & (x038 | ((new_n194_ | ~x086) & (new_n205_ | ~x070)));
  assign new_n205_ = (x006 | (x102 & x126)) & (~x086 | ~x014 | x030);
  assign new_n206_ = (x006 | ~x014 | x086) & ((~x014 & ~x038) | x022 | x070);
  assign new_n207_ = (x038 | x054) & (x078 | (x014 & (x086 | x006 | ~x038)));
  ...
  assign new_n219_ = ~x080 & (x016 | ~x120 | (x104 & x112));
  ...
  assign new_n271_ = new_n272_ & (~x102 | x038 | ~x070);
  ...
  assign new_n275_ = ~x086 & (x022 | (x030 & ~x070 & (~x062 | ~x094)));
  ...
  assign new_n280_ = (new_n281_ | (x022 & x070)) & (~x014 | (x022 & x070 & (~x038 | x054)));
