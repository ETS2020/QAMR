// Benchmark "FAU" written by ABC on Wed Aug 26 09:26:24 2020
...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n185_ & x085) | ((new_n200_ | ~new_n204_) & x068));
  ...
  assign z12 = ~x044 & (new_n260_ | (~z07 & ~new_n261_));
  assign new_n260_ = (x036 | ~x052 | x012 | ~x076) & (~x012 | ~x036) & x020 & x068;
  assign new_n261_ = ((x012 & ~x036 & x052) | (x036 & x076) | ~x004 | ~x084) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = ~x045 & ((~new_n263_ & x068) | (~new_n281_ & x085));
  ...
  assign new_n277_ = new_n280_ & (x077 | (~new_n278_ & ~new_n279_ & (~new_n202_ | x037)));
  ...
  assign new_n281_ = (~x077 | (~x013 & (~new_n202_ | x053) & (~x005 | (x037 & ~x053)))) & (~x037 | ~x053) & (x077 | ((~x005 | (x013 & x053)) & (~new_n202_ | (x013 & x037))));
  ...
  assign new_n296_ = x078 ? (~x014 & (new_n226_ | ~new_n300_)) : (~new_n297_ & ((~new_n295_ & ~new_n300_) | ((new_n226_ | ~new_n295_) & x014)));
