...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n185_ & x036) | (~new_n203_ & ~x085));
  ...
  assign z12 = ~x044 & (~new_n258_ | (~x085 & (new_n261_ | (x012 & x076))));
  assign new_n258_ = (new_n259_ | x012) & (~x036 | ((~new_n260_ | x076) & ~x052 & (~x012 | ~x076)));
  assign new_n259_ = (~new_n260_ | x036 | x085) & (~x036 | ~x020 | ~x068);
  assign new_n260_ = x004 & x084;
  assign new_n261_ = (~x052 | (~x076 & x020 & x068)) & ~x036 & (new_n260_ | (x020 & x068));
  ...
  assign new_n274_ = x037 & ((~x021 & x029) | x061 | x093);
  assign new_n275_ = (~x013 | ~x037) & ((x021 & x069) | (x029 & x037));
  assign new_n276_ = (~x037 | ~x053) & (~x077 | (~x013 & (x053 | ~x021 | ~x069)));
  assign new_n277_ = new_n279_ & (x077 | (~new_n278_ & (new_n281_ | ~x021 | ~x069)));
  assign new_n278_ = (x085 | (new_n199_ & x061)) & x005 & (~x053 | (~x013 & x085));
