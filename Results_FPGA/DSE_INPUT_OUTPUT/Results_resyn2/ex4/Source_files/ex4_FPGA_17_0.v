...
module FAU ( 
  ...
  wire new_n159_, new_n160_, new_n161_, new_n162_, new_n164_, new_n165_,
    ...
    new_n299_, new_n300_;
  assign z00 = x040 & (new_n159_ | new_n162_ | (~x032 & ~x048) | (~new_n161_ & x032));
  assign new_n159_ = x008 & ((x072 & (new_n160_ | (~x000 & ~x080))) | (new_n160_ & x048));
  assign new_n160_ = ~x016 & ~x064;
  assign new_n161_ = (~new_n160_ | x008) & (x000 | ~x008 | x080);
  assign new_n162_ = ~x008 & (~x072 | (x048 & ~x000 & ~x080));
  ...
  assign new_n183_ = new_n192_ & (~x077 | ((new_n184_ | new_n198_) & ~new_n186_ & ~new_n188_));
  ...
  assign z08 = (~new_n239_ | (~x048 & (new_n226_ | ~new_n234_))) & ~x040 & x085;
  ...
  assign z13 = ~x045 & ((~new_n262_ & x040) | (~new_n281_ & x085));
