// Benchmark "FAU" written by ABC on Wed Aug 26 09:27:46 2020
...
module FAU ( 
  ...
  assign z06 = ~z07 & x046 & (~new_n215_ | (~new_n202_ & x054));
  ...
  assign new_n215_ = new_n219_ & (new_n216_ | ~x078);
  assign new_n216_ = new_n218_ & (x038 | ((new_n217_ | ~x070) & (new_n206_ | ~x086)));
  ...
  assign z13 = ~x045 & (~new_n268_ | (~x053 & (~new_n267_ | (~new_n258_ & ~x077))));
  assign new_n258_ = ~new_n259_ & ~new_n261_ & (~x005 | (new_n266_ & (new_n264_ | x069)));
  assign new_n259_ = ~new_n189_ & (new_n260_ | (x005 & (new_n193_ | new_n199_)));
  assign new_n260_ = ~x085 & (x021 | (~x069 & x029 & (~x061 | ~x093)));
  assign new_n261_ = ~x085 & ((~new_n262_ & x069) | (new_n263_ & (~x021 | (~x013 & ~x069))));
  assign new_n262_ = ~x061 & ~x093 & (x021 | ~x029);
  assign new_n263_ = (x101 | x125) & x029 & (~x061 | ~x093);
  assign new_n264_ = ((x013 & x021) | (~x029 & ~x061 & ~x093)) & (new_n265_ | (x021 & x061 & x093));
  assign new_n265_ = ~x101 & ~x125;
  assign new_n266_ = (~new_n193_ | ~x101) & ~x085 & (new_n200_ | x021 | ~x125);
  assign new_n267_ = (new_n189_ | ~x013 | x085) & (~x077 | ~x021 | ~x069);
  assign new_n268_ = new_n271_ & (x077 | (new_n270_ & (new_n269_ | ~x037 | x085)));
  assign new_n269_ = ~x061 & ~x093 & (~x029 | (x021 & (x013 | x069)));
  assign new_n270_ = (~x021 | x037 | ~x069) & (x013 | ((~x021 | ~x069) & (~x005 | ~x085)));
  assign new_n271_ = (~x037 | ~x053) & (~x077 | (~x013 & (x037 | ~x005 | ~x085)));
  assign z14 = (z07 | ~x046) & (~new_n285_ | (~x054 & (new_n273_ | ~new_n281_)));
  ...
  assign new_n279_ = new_n280_ & (x038 | ~x070 | ~x102);
