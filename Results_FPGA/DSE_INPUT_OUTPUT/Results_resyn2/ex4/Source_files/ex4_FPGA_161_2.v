...
module FAU ( 
  ...
  assign z05 = z15 | (x045 & (~new_n201_ | (x053 & (new_n187_ | ~new_n193_))));
  assign new_n187_ = ~x005 & ((x077 & (new_n188_ | ~new_n191_)) | (x037 & ~x085));
  ...
  assign new_n191_ = new_n192_ & ((~x109 & ~x117) | ~x021 | x125);
  assign new_n192_ = x085 & (x101 | ~x037 | x069);
  assign new_n193_ = new_n196_ & ((x109 & x117) | (~new_n194_ & (x013 | ~x085)));
  assign new_n194_ = x077 & (new_n195_ | (~x005 & (x069 ? x021 : x037)));
  assign new_n195_ = x085 & (~x021 | (~x029 & x069 & (x061 | x093)));
  assign new_n196_ = (x069 | (~new_n197_ & ~new_n198_)) & (~new_n199_ | ~new_n200_);
  assign new_n197_ = x077 & x085 & ((x021 & ~x029) | ~x061 | ~x093);
  assign new_n198_ = ~x021 & (~x077 | x013 | x037);
  assign new_n199_ = ~x029 & (x021 | (x013 & x069));
  assign new_n200_ = x077 & x085 & (x061 | x093) & (~x101 | ~x125);
  assign new_n201_ = new_n202_ & ((new_n189_ & ~new_n199_) | x037 | ~x077 | ~x085);
  assign new_n202_ = (x013 | x077) & (x053 | (new_n203_ & (x005 | ~x013 | x085)));
  assign new_n203_ = x037 & (~x077 | x021 | x069);
  assign z06 = ~z15 & x046 & (~new_n218_ | (~new_n205_ & (~x038 | x054)));
  ...
  assign new_n225_ = ~new_n226_ & (~x000 | (~new_n231_ & new_n234_)) & (new_n229_ | x080);
  ...
  assign z13 = ~x045 & (new_n277_ | (~x085 & (~new_n273_ | (~new_n262_ & ~x053))));
  assign new_n262_ = ~new_n270_ & (x077 | (~new_n263_ & ~new_n268_ & (new_n267_ | new_n272_)));
  assign new_n263_ = x005 & (new_n265_ | new_n266_ | (~new_n264_ & (~x013 | ~x021)));
  assign new_n264_ = ~x061 & ~x093;
  assign new_n265_ = x029 & (~x021 | (~x013 & ~x069));
  assign new_n266_ = ~x021 & x125 & (~x109 | ~x117);
  assign new_n267_ = (new_n189_ | ~x029 | (x021 & (x013 | x069))) & ((new_n189_ & x021) | ~x005 | x069);
  assign new_n268_ = x069 & (~new_n269_ | (x101 & x005 & ~x037));
  assign new_n269_ = ~x061 & ~x093 & (x021 | ~x029);
  assign new_n270_ = (x109 | x117) & (x013 | (~x077 & (new_n271_ | x021)));
  assign new_n271_ = (~x069 | (x005 & ~x037)) & (x005 | (x029 & (~x061 | ~x093)));
  ...
  assign new_n277_ = x121 & ((~new_n278_ & ~x077) | ~new_n276_ | new_n280_);
  ...
  assign z14 = (z15 | ~x046) & (~new_n295_ | (~new_n282_ & ~x054));
  ...
  assign new_n300_ = ~new_n301_ & ~z15 & (~x038 | ~x054);
