...
module FAU ( 
  ...
  assign new_n261_ = (~x005 | (~x029 & (new_n185_ | ~x125))) & ((~x101 & ~x125) | new_n196_ | ~x029);
  ...
  assign new_n266_ = x005 & ~x053 & (x061 | x093);
  assign new_n267_ = new_n270_ & (new_n272_ | ((new_n268_ | x053) & (~new_n271_ | x077)));
  assign new_n268_ = ~x013 & (x077 | (new_n269_ & (new_n196_ | ~x029 | x069)));
  ...
  assign new_n290_ = (new_n291_ | x070) & (new_n276_ | x086);
