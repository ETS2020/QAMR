...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n182_ & x085) | ((new_n197_ | ~new_n201_) & ~x034));
  ...
  assign z10 = z07 | (~x042 & (~new_n251_ | new_n249_ | (x010 & x074)));
  assign new_n249_ = (x034 | (x002 & x082)) & ~x010 & (new_n250_ | ~x034);
  assign new_n250_ = x018 & x066;
  assign new_n251_ = (~x034 | (~x050 & (x074 | ~x002 | ~x082))) & ((x050 & (~new_n250_ | x074)) | x034 | (~new_n250_ & (~x002 | ~x082)));
  ...
  assign z13 = ~x045 & ((~new_n261_ & ~x034) | (~new_n279_ & x085));
