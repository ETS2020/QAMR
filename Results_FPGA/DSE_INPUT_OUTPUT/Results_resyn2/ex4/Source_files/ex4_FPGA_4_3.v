// Benchmark "FAU" written by ABC on Wed Aug 26 09:25:45 2020
...
module FAU ( 
  ...
  assign z06 = ~z15 & x046 & (~new_n214_ | (~new_n201_ & (~x038 | x054)));
  ...
  assign new_n205_ = (x070 | ((~x022 | x030) & x062 & x094)) & (~new_n206_ | x030 | (~x062 & ~x094));
  ...
  assign new_n214_ = x078 ? (~new_n215_ & (~x014 | (~new_n213_ & ~new_n219_)) & (~new_n213_ | new_n218_)) : (x014 & (new_n218_ | ~new_n219_));
  assign new_n215_ = ~x038 & ((~new_n217_ & x070) | (~new_n216_ & x086));
  assign new_n216_ = x062 & x094 & (~x022 | x030);
  assign new_n217_ = (x006 | (x102 & x126)) & (~x086 | ~x014 | x030);
  assign new_n218_ = ~x038 & x054;
  assign new_n219_ = ~x006 & ~x086;
  assign z08 = z15 | (~x040 & (~new_n235_ | (~new_n221_ & ~x048)));
  ...
  assign new_n273_ = ~x100 & ((~new_n274_ & ~x077) | ~new_n272_ | new_n276_);
  ...
  assign z14 = (z15 | ~x046) & (~new_n291_ | (~new_n278_ & ~x054));
  assign new_n278_ = new_n289_ & (x078 | (~new_n279_ & ~new_n284_ & (new_n282_ | x086)));
  assign new_n279_ = (x110 | x118) & (new_n280_ | new_n281_);
  ...
  assign new_n289_ = (~new_n290_ | ~x078) & ((~x110 & ~x118) | ~x014 | x086);
  assign new_n290_ = x022 & x070;
  assign new_n291_ = new_n296_ & (x078 | (~new_n292_ & ~new_n295_));
  ...
  assign new_n295_ = (new_n290_ | (x006 & x086)) & (~x014 | (new_n290_ & (~x038 | x054)));
  assign new_n296_ = ~new_n297_ & ~z15 & (~x038 | ~x054);
  assign new_n297_ = x078 & (x014 | (~x038 & x006 & x086));
  assign z07 = 1'b0;
  assign z17 = 1'b0;
  assign z19 = 1'b0;
  assign z20 = 1'b0;
