...
module FAU ( 
  ...
  assign z11 = ~x043 & (~new_n251_ | ((new_n252_ | x011) & ~new_n254_ & (new_n253_ | ~x011)));
  assign new_n251_ = ((~new_n253_ & ~x011) | x035 | (~new_n252_ & x011)) & ((~new_n252_ & ~new_n253_) | x011 | x075) & (~x011 | ~x075) & (~x035 | ~x051);
  assign new_n252_ = x019 & x067;
  assign new_n253_ = x003 & x083;
  assign new_n254_ = ~x035 & x051;
  ...
  assign new_n275_ = ~x043 & ((~new_n276_ & ~x077) | ~new_n274_ | new_n278_);
