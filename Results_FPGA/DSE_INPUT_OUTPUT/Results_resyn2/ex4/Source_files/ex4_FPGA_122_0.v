...
module FAU ( 
  ...
  assign z14 = (~new_n275_ | (~x054 & (new_n263_ | ~new_n271_))) & (z16 | ~x046);
  ...
  assign new_n278_ = (new_n279_ | (x022 & x070)) & (~x014 | ((~x038 | x054) & x022 & x070));
  assign new_n279_ = x006 & x086;
  assign new_n280_ = (~x078 | (~x014 & (~new_n279_ | x038))) & ~z16 & (~x038 | ~x054);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z18 = 1'b0;
  assign z21 = 1'b0;
