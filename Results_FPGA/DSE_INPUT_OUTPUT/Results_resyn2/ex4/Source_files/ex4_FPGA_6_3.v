...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n205_ & ~x085) | (~new_n187_ & ~x114));
  ...
  assign new_n203_ = ((x021 & ~x029) | ~x061 | ~x093) & ~x037 & x085;
  ...
  assign new_n232_ = (~x056 | ~x088) & (x096 | x120);
  ...
  assign z13 = ~x045 & ((~new_n264_ & ~x085) | (~new_n278_ & ~x114));
  assign new_n264_ = new_n274_ & (x053 | (~new_n265_ & (x077 | (~new_n267_ & new_n271_))));
  assign new_n265_ = (x109 | x117) & (x013 | (~x077 & (new_n266_ | x021)));
  assign new_n266_ = (~x037 | ~x069) & (x005 | ((~x061 | ~x093) & x029 & ~x069));
  assign new_n267_ = x005 & (new_n268_ | new_n269_ | ~new_n270_);
  assign new_n268_ = ~x021 & (x061 | x093 | (x125 & (~x109 | ~x117)));
  assign new_n269_ = (~x093 | ~x021 | ~x061) & ~x069 & (x101 | x125);
  assign new_n270_ = (x013 | (~x061 & ~x093)) & (~x101 | x037 | ~x069);
  assign new_n271_ = (~x069 | (new_n272_ & (x021 | ~x029))) & (new_n273_ | ~x029 | (x021 & (x013 | x069)));
  assign new_n272_ = ~x061 & ~x093;
  assign new_n273_ = ~x005 & ((~x101 & ~x125) | (x061 & x093));
  assign new_n274_ = new_n277_ & (x077 | (~new_n275_ & ~new_n276_));
  assign new_n275_ = x037 & (x061 | x093 | (~x021 & x029));
  assign new_n276_ = (~x013 | ~x037) & ((x029 & x037) | (x021 & x069));
  assign new_n277_ = (~x037 | ~x053) & (~x077 | (~x013 & (x053 | ~x021 | ~x069)));
  assign new_n278_ = new_n280_ & (x077 | (~new_n279_ & (new_n282_ | ~x021 | ~x069)));
  assign new_n279_ = (x085 | (new_n201_ & x061)) & x005 & (~x053 | (~x013 & x085));
  assign new_n280_ = (~x037 | ~x053) & (~x077 | (new_n281_ & (~x005 | x037 | ~x085)));
  assign new_n281_ = ~x013 & (x053 | ~x021 | ~x069);
  assign new_n282_ = ~x053 & x013 & x037;
