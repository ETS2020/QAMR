...
module FAU ( 
  ...
  assign new_n267_ = (~x077 | ~x021 | ~x069) & (new_n189_ | ~x013 | x085);
  ...
  assign z14 = z07 | (~x046 & (new_n273_ | ~new_n291_ | (~new_n288_ & ~x078)));
  assign new_n273_ = ~x054 & (~new_n282_ | (~x078 & (new_n274_ | new_n277_)));
  assign new_n274_ = ~x086 & ((~new_n275_ & x070) | (new_n276_ & (~x022 | (~x014 & ~x070))));
  assign new_n275_ = (x022 | ~x030) & ~x062 & ~x094;
  ...
  assign new_n282_ = (~new_n284_ | ~x078) & (new_n283_ | (~new_n285_ & (x078 | (~new_n286_ & ~new_n287_))));
  assign new_n283_ = ~x110 & ~x118;
  assign new_n284_ = x022 & x070;
  assign new_n285_ = x014 & ~x086;
  assign new_n286_ = x006 & (x070 ? ~x038 : ~x022);
  assign new_n287_ = ~x086 & (x022 | (x030 & ~x070 & (~x062 | ~x094)));
  assign new_n288_ = (new_n289_ | ~x038) & ((x014 & x038) | (~new_n284_ & (x014 | ~x006 | ~x086)));
  assign new_n289_ = (new_n290_ | x070) & (new_n275_ | x086);
  assign new_n290_ = (~x006 | (~x102 & ~x126)) & (x086 | x014 | ~x030);
  assign new_n291_ = (~x038 | ~x054) & (~x078 | (~x014 & (x038 | ~x006 | ~x086)));
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
  assign z22 = 1'b0;
