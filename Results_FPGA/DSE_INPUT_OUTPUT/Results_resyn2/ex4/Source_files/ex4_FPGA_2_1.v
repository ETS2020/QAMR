// Benchmark "FAU" written by ABC on Wed Aug 26 09:25:27 2020
...
module FAU ( 
  ...
  assign z03 = x043 & ((~new_n175_ & ~x035) | (~new_n177_ & x035) | (~x011 & ~x075));
  assign new_n175_ = (~new_n176_ | ~x075) & x051 & (~x011 | x019 | x067);
  assign new_n176_ = ~x003 & ~x083;
  assign new_n177_ = (~x051 | (~new_n176_ & (x019 | x067))) & (~x075 | x019 | x067) & (~new_n176_ | ~x011);
  ...
  assign new_n228_ = x000 & (new_n232_ | ~new_n233_ | (new_n231_ & (new_n229_ | ~new_n230_)));
  ...
  assign z11 = ~x043 & (~new_n254_ | new_n251_ | x085 | (x035 & x051));
  assign new_n251_ = (new_n252_ | x011) & (new_n253_ | ~x011) & ~x035;
  assign new_n252_ = x003 & x083;
  assign new_n253_ = x019 & x067;
  assign new_n254_ = ((~new_n253_ & ~x011) | (~new_n252_ & x011) | (~x035 & x051)) & ((~new_n252_ & ~new_n253_ & ~x011) | (x011 ^ x075));
  ...
  assign z13 = ~x045 & (new_n275_ | (~x085 & (new_n260_ | ~new_n271_)));
  assign new_n260_ = ~x053 & (new_n261_ | (~x077 & (~new_n266_ | (~new_n263_ & x005))));
  assign new_n261_ = (x109 | x117) & (x013 | (~x077 & (new_n262_ | x021)));
  assign new_n262_ = (~x069 | (x005 & ~x037)) & (x005 | (x029 & (~x061 | ~x093)));
  assign new_n263_ = (new_n264_ | (x013 & x021)) & (~new_n265_ | (x021 & x061 & x093));
  assign new_n264_ = ~x061 & ~x093 & ((x109 & x117) | x021 | ~x125);
  assign new_n265_ = ~x069 & (x101 | x125);
  assign new_n266_ = (new_n269_ | ~new_n270_) & (~x069 | (new_n267_ & ~new_n268_));
  assign new_n267_ = ~x061 & ~x093 & (x021 | ~x029);
  assign new_n268_ = x101 & x005 & ~x037;
  assign new_n269_ = ~x005 & ((~x101 & ~x125) | (x061 & x093));
  assign new_n270_ = x029 & (~x021 | (~x013 & ~x069));
  assign new_n271_ = new_n274_ & (new_n272_ | x077);
  assign new_n272_ = (new_n267_ | ~x037) & ((x013 & x037) | (~new_n273_ & (~x029 | ~x037)));
  assign new_n273_ = x021 & x069;
  assign new_n274_ = (~x037 | ~x053) & (~x077 | (~x013 & (~new_n273_ | x053)));
  assign new_n275_ = x043 & (~new_n274_ | new_n278_ | (~new_n276_ & ~x077));
  assign new_n276_ = (~new_n273_ | x013) & ((~new_n277_ & ~x085) | ~x005 | (x053 & (x013 | ~x085)));
  assign new_n277_ = x061 & ~x021 & ~x069;
  assign new_n278_ = ~x037 & ((new_n273_ & ~x077) | (x005 & x077 & x085));
