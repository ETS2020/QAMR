...
module FAU ( 
  ...
  assign new_n160_ = (new_n162_ | ~x008 | ~x072) & (x032 | x048) & ~z19 & (x008 | x072);
  assign z19 = x045 & x085;
  assign new_n162_ = (x016 | x064) & (x000 | x080);
  assign new_n163_ = ~x016 & ~x064;
  assign new_n164_ = ~z19 & ~x040;
  assign new_n165_ = (new_n163_ | ~x008) & (~x032 | x048);
  assign z01 = ~new_n167_ & ~z19 & x041;
  ...
  assign z06 = (z19 | x046) & (~new_n198_ | (x054 & (new_n186_ | ~new_n194_)));
  ...
  assign new_n190_ = ~new_n191_ & ((x102 & x126) | (~x022 & ~x062 & ~x094));
  ...
  assign new_n203_ = (x078 | (x014 & (~new_n202_ | ~x038))) & ~z19 & (x038 | x054);
  ...
  assign z14 = ~z19 & ~x046 & (~new_n274_ | (~new_n261_ & ~x054));
