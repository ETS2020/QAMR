...
module FAU ( 
  ...
  assign new_n207_ = ~new_n210_ & ~new_n212_ & ((~new_n208_ & ~new_n215_) | (x110 & x118));
  assign new_n208_ = x078 & (new_n209_ | (~x006 & (x070 ? x022 : x038)));
  assign new_n209_ = x086 & (~x022 | (x070 & ~x030 & (x062 | x094)));
  assign new_n210_ = ~x070 & ((~x022 & (~x078 | x014 | x038)) | (new_n211_ & x078));
  assign new_n211_ = x086 & (~x062 | ~x094 | (x022 & ~x030));
  assign new_n212_ = new_n213_ & new_n214_ & (x022 | (x014 & x070));
  assign new_n213_ = ~x030 & (x062 | x094);
  assign new_n214_ = x078 & x086 & (~x102 | ~x126);
  assign new_n215_ = ~x014 & x086;
  assign new_n216_ = (x038 | (~new_n217_ & x054)) & new_n220_ & (new_n218_ | ~x014);
  assign new_n217_ = x078 & (new_n211_ | (~x006 & x070 & (~x102 | ~x126)));
  assign new_n218_ = (x086 | x006 | x054) & (~new_n219_ | x030 | ~x078 | ~x086);
  assign new_n219_ = ~x038 & x070;
  assign new_n220_ = (x014 | x078) & (x022 | x070 | x054 | ~x078);
  ...
  assign new_n274_ = ~x054 & (~new_n273_ | new_n277_ | (~new_n275_ & ~x077));
  ...
  assign z14 = (x054 & x085) | (~x046 & (~new_n295_ | (~new_n279_ & ~x054)));
  assign new_n279_ = ~new_n280_ & ~new_n289_ & ~new_n291_ & (~x006 | (~new_n284_ & ~new_n294_));
  assign new_n280_ = (x110 | x118) & (new_n283_ | (~x078 & (new_n281_ | new_n282_)));
  assign new_n281_ = x006 & (x070 ? ~x038 : ~x022);
  assign new_n282_ = ~x086 & (x022 | (~x070 & x030 & (~x062 | ~x094)));
  assign new_n283_ = x014 & ~x086;
  assign new_n284_ = ~x078 & (new_n287_ | ~new_n288_ | (~x070 & (new_n285_ | new_n286_)));
  ...
  assign new_n288_ = ~x086 & (~x102 | x038 | ~x070);
  assign new_n289_ = x070 & (new_n290_ | (x022 & (~x014 | ~x038 | x078)));
  assign new_n290_ = ~x078 & ~x086 & (x062 | x094 | (~x022 & x030));
  assign new_n291_ = new_n292_ & new_n293_ & (~x022 | (~x014 & ~x070));
  assign new_n292_ = x030 & (~x062 | ~x094);
  assign new_n293_ = (x102 | x126) & ~x078 & ~x086;
  assign new_n294_ = ~x038 & x086;
  assign new_n295_ = new_n298_ & (new_n296_ | ~x038 | x078);
  assign new_n296_ = (new_n297_ | x086) & ((~x102 & ~x126) | ~x006 | x070);
  assign new_n297_ = (x022 | ~x030) & ~x062 & ~x094 & (~x030 | x014 | x070);
  assign new_n298_ = (new_n299_ | ~x054) & (~x014 | ~x078) & (~x054 | x078 | ~x022 | ~x070);
  assign new_n299_ = ~x038 & (~x006 | x014 | ~x086);
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
  assign z21 = 1'b0;
