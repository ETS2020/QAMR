// Benchmark "FAU" written by ABC on Wed Aug 26 09:28:12 2020
...
module FAU ( 
  ...
  assign new_n200_ = ~x047 & (new_n201_ | ~new_n203_ | new_n204_);
  ...
  assign z08 = z07 | (~x040 & (~new_n240_ | (~new_n226_ & ~x048)));
  assign new_n226_ = new_n238_ & (x072 | (~new_n227_ & ~new_n232_ & (new_n230_ | x080)));
  assign new_n227_ = (x104 | x112) & (new_n228_ | new_n229_);
  ...
  assign new_n232_ = x000 & (new_n236_ | ~new_n237_ | (new_n235_ & (new_n233_ | ~new_n234_)));
  ...
  assign new_n238_ = (~new_n239_ | ~x072) & ((~x104 & ~x112) | ~x008 | x080);
  ...
  assign new_n244_ = (new_n239_ | (x000 & x080)) & (~x008 | (new_n239_ & (~x032 | x048)));
  assign new_n245_ = (~x032 | ~x048) & (~x072 | (~x008 & (x032 | ~x000 | ~x080)));
  assign z09 = ~new_n247_ & ~z07 & ~x041;
  assign new_n247_ = ((~new_n248_ & ~x009) | (~new_n249_ & x009) | (~x033 & x049)) & ((~new_n249_ & ~x009) | (~new_n248_ & x009) | x033) & (x009 | x073 | (~new_n248_ & ~new_n249_)) & (~x009 | ~x073) & (~x033 | ~x049);
  assign new_n248_ = x017 & x065;
  assign new_n249_ = x001 & x081;
  assign z10 = ~new_n251_ & ~z07 & ~x042;
  assign new_n251_ = ((~new_n252_ & ~x010) | (~new_n253_ & x010) | (~x034 & x050)) & ((~new_n253_ & ~x010) | (~new_n252_ & x010) | x034) & (x010 | x074 | (~new_n252_ & ~new_n253_)) & (~x010 | ~x074) & (~x034 | ~x050);
  assign new_n252_ = x018 & x066;
  assign new_n253_ = x002 & x082;
  assign z11 = z07 | (~new_n255_ & ~x043);
  assign new_n255_ = ((~new_n256_ & ~x011) | (~new_n257_ & x011) | (~x035 & x051)) & ((~new_n257_ & ~x011) | (~new_n256_ & x011) | x035) & (x011 | x075 | (~new_n256_ & ~new_n257_)) & (~x011 | ~x075) & (~x035 | ~x051);
  assign new_n256_ = x019 & x067;
  assign new_n257_ = x003 & x083;
  assign z12 = z07 | (~new_n259_ & ~x044);
  assign new_n259_ = ((~new_n260_ & ~x012) | (~new_n261_ & x012) | (~x036 & x052)) & ((~new_n261_ & ~x012) | (~new_n260_ & x012) | x036) & (x012 | x076 | (~new_n260_ & ~new_n261_)) & (~x012 | ~x076) & (~x036 | ~x052);
  ...
  assign new_n264_ = ~x021 & (new_n265_ | (~new_n197_ & x125));
  ...
  assign new_n268_ = ~new_n271_ & ~new_n273_ & ((~x109 & ~x117) | (~new_n269_ & ~new_n275_));
  ...
  assign new_n273_ = new_n274_ & ~x077 & ~x085 & ~new_n189_ & (x101 | x125);
  assign new_n274_ = x029 & (~x021 | (~x013 & ~x069));
  assign new_n275_ = x013 & ~x085;
  assign new_n276_ = new_n278_ & (new_n277_ | ~x037 | x077 | x085);
  assign new_n277_ = ~new_n274_ & ~x061 & ~x093;
  assign new_n278_ = (~x013 | ~x077) & (~x053 | (new_n279_ & (~x085 | ~x005 | x013)));
  assign new_n279_ = ~x037 & (x077 | ~x021 | ~x069);
  assign z14 = (z07 | ~x046) & (~new_n294_ | (~new_n281_ & ~x054));
  assign new_n281_ = new_n292_ & (x078 | (~new_n282_ & ~new_n287_ & (new_n285_ | x086)));
  assign new_n282_ = (x110 | x118) & (new_n283_ | new_n284_);
  ...
  assign new_n292_ = (~new_n293_ | ~x078) & ((~x110 & ~x118) | ~x014 | x086);
  assign new_n293_ = x022 & x070;
  assign new_n294_ = new_n299_ & (x078 | (~new_n295_ & ~new_n298_));
  ...
  assign new_n298_ = (new_n293_ | (x006 & x086)) & (~x014 | (new_n293_ & (~x038 | x054)));
  assign new_n299_ = ~new_n300_ & ~z07 & (~x038 | ~x054);
  assign new_n300_ = x078 & (x014 | (~x038 & x006 & x086));
  assign z16 = 1'b0;
  assign z17 = 1'b0;
  assign z18 = 1'b0;
  assign z20 = 1'b0;
