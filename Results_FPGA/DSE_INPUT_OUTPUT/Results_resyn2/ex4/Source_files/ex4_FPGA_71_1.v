// Benchmark "FAU" written by ABC on Wed Aug 26 09:26:32 2020
...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n183_ & x085) | (~x113 & (new_n198_ | ~new_n202_)));
  ...
  assign new_n196_ = (x013 | x037) & ((~x021 & ~x069) | (~x029 & ~x037));
  ...
  assign z06 = (~new_n218_ | (~new_n205_ & ~new_n224_)) & ~z15 & x046;
  ...
  assign z13 = ~x045 & ((~new_n280_ & x085) | (~new_n262_ & ~x113));
  assign new_n262_ = new_n276_ & (x053 | (~new_n263_ & (x077 | (~new_n267_ & ~new_n270_))));
  assign new_n263_ = (x109 | x117) & (new_n264_ | (~x077 & (new_n265_ | new_n266_)));
  assign new_n264_ = x013 & ~x085;
  assign new_n265_ = x005 & ((~x037 & x069) | (~x061 & ~x021 & ~x069));
  assign new_n266_ = ~x085 & (x021 | (~x069 & x029 & (~x061 | ~x093)));
  assign new_n267_ = ~x085 & ((~new_n268_ & x069) | (new_n269_ & (~x021 | (~x013 & ~x069))));
  assign new_n268_ = (x021 | ~x029) & ~x061 & ~x093;
  ...
  assign new_n275_ = x125 & ((x021 & ~x093) | ~x061 | x069);
  assign new_n276_ = new_n279_ & (x077 | (~new_n277_ & ~new_n278_ & (~new_n200_ | x037)));
  ...
  assign new_n280_ = (~x077 | (~x013 & (~new_n200_ | x053) & (~x005 | (x037 & ~x053)))) & (~x037 | ~x053) & (x077 | ((~x005 | (x013 & x053)) & (~new_n200_ | (x013 & x037))));
  ...
  assign new_n292_ = ~x086 & (x022 | ~x126 | (x110 & x118));
