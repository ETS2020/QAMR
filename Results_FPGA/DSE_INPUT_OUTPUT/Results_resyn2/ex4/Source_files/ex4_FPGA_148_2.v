// Benchmark "FAU" written by ABC on Wed Aug 26 09:28:07 2020
...
module FAU ( 
  ...
  assign new_n187_ = (~x101 | ~x125) & (x061 | x093 | (~x005 & x021));
  ...
  assign z06 = ~z07 & x046 & (~new_n216_ | (~new_n203_ & x054));
  ...
  assign new_n207_ = (~x022 | x030) & x062 & x094;
  ...
  assign new_n216_ = new_n220_ & (new_n217_ | ~x078);
  assign new_n217_ = new_n219_ & (x038 | ((new_n218_ | ~x070) & (new_n207_ | ~x086)));
  ...
  assign new_n228_ = (new_n229_ | ~x064) & (~new_n224_ | ~x024 | (x016 & (x008 | x064)));
  ...
  assign new_n241_ = ((~new_n242_ & ~x009) | (~new_n243_ & x009) | (~x033 & x049)) & ((~new_n243_ & ~x009) | (~new_n242_ & x009) | x033) & (x009 | x073 | (~new_n242_ & ~new_n243_)) & (~x009 | ~x073) & (~x033 | ~x049);
  assign new_n242_ = x017 & x065;
  assign new_n243_ = x001 & x081;
  assign z10 = ~new_n245_ & ~z07 & ~x042;
  assign new_n245_ = ((~new_n246_ & ~x010) | (~new_n247_ & x010) | (~x034 & x050)) & ((~new_n247_ & ~x010) | (~new_n246_ & x010) | x034) & (x010 | x074 | (~new_n246_ & ~new_n247_)) & (~x010 | ~x074) & (~x034 | ~x050);
  assign new_n246_ = x018 & x066;
  assign new_n247_ = x002 & x082;
  assign z11 = ~new_n249_ & ~z07 & ~x043;
  assign new_n249_ = ((~new_n250_ & ~x011) | (~new_n251_ & x011) | (~x035 & x051)) & ((~new_n251_ & ~x011) | (~new_n250_ & x011) | x035) & (x011 | x075 | (~new_n250_ & ~new_n251_)) & (~x011 | ~x075) & (~x035 | ~x051);
  assign new_n250_ = x019 & x067;
  assign new_n251_ = x003 & x083;
  assign z12 = z07 | (~new_n253_ & ~x044);
  assign new_n253_ = ((~new_n254_ & ~x012) | (~new_n255_ & x012) | (~x036 & x052)) & ((~new_n255_ & ~x012) | (~new_n254_ & x012) | x036) & (x012 | x076 | (~new_n254_ & ~new_n255_)) & (~x012 | ~x076) & (~x036 | ~x052);
  assign new_n254_ = x020 & x068;
  assign new_n255_ = x004 & x084;
  assign z13 = (~new_n257_ & ~x053) | new_n270_ | (~new_n276_ & ~x045) | (x045 & ~x085);
  assign new_n257_ = new_n268_ & (x077 | (~new_n258_ & ~new_n263_ & (new_n261_ | x085)));
  assign new_n258_ = ~new_n191_ & (new_n260_ | (new_n259_ & (x069 ? ~x037 : ~x021)));
  assign new_n259_ = x005 & ~x045;
  assign new_n260_ = ~x085 & (x021 | (~x069 & x029 & (~x061 | ~x093)));
  assign new_n261_ = (~x069 | ((x021 | ~x029) & ~x061 & ~x093)) & (~new_n262_ | ~x029 | (x061 & x093));
  assign new_n262_ = (x101 | x125) & (~x021 | (~x013 & ~x069));
  assign new_n263_ = new_n259_ & (new_n266_ | ~new_n267_ | (~x069 & (new_n264_ | new_n265_)));
  assign new_n264_ = (~x021 | (~x013 & ~x037)) & (x029 | x061 | x093);
  assign new_n265_ = (x101 | x125) & (~x021 | ~x061 | ~x093);
  assign new_n266_ = x101 & ~x037 & x069;
  assign new_n267_ = ~x085 & ((x109 & x117) | x021 | ~x125);
  assign new_n268_ = (~new_n269_ | x045 | ~x077) & (new_n191_ | ~x013 | x085);
  assign new_n269_ = x021 & x069;
  assign new_n270_ = ~x077 & (new_n274_ | (x037 & (new_n271_ | new_n273_)));
  assign new_n271_ = ~x069 & (new_n272_ | (~x085 & ~x013 & x029));
  assign new_n272_ = (x101 | x125) & x005 & ~x045;
  assign new_n273_ = ~x085 & (~new_n198_ | (~x021 & x029));
  assign new_n274_ = new_n275_ & (~x013 | (new_n269_ & (~x037 | x053)));
  assign new_n275_ = ~x045 & ((x021 & x069) | (x005 & x085));
  assign new_n276_ = (~x037 | ~x053) & (~x077 | (~x013 & (x037 | ~x005 | ~x085)));
  assign z14 = (z07 | ~x046) & (~new_n290_ | (~x054 & (new_n278_ | ~new_n286_)));
  ...
  assign new_n284_ = new_n285_ & (~x102 | x038 | ~x070);
  ...
  assign new_n293_ = (new_n294_ | (x022 & x070)) & (~x014 | (x022 & x070 & (~x038 | x054)));
  assign new_n294_ = x006 & x086;
  assign new_n295_ = (~x078 | (~x014 & (~new_n294_ | x038))) & ~z07 & (~x038 | ~x054);
  assign z15 = 1'b0;
  assign z18 = 1'b0;
  assign z19 = 1'b0;
  assign z20 = 1'b0;
