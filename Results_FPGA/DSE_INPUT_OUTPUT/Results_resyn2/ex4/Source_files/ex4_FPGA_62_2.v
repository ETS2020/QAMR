...
module FAU ( 
  ...
  assign new_n197_ = ~x037 & ((x021 & ~x029) | ~x061 | ~x093);
  ...
  assign z12 = (~new_n261_ | (~new_n260_ & x020 & x068)) & ~x044 & (~x068 | x085);
  assign new_n260_ = (x012 | (~x036 & x052)) & (x036 | (~x012 & x076));
  assign new_n261_ = ((x012 & ~x036 & x052) | ~x004 | ~x084 | (x036 & ~x012 & x076)) & (~x036 | ~x052) & (~x012 | ~x076);
