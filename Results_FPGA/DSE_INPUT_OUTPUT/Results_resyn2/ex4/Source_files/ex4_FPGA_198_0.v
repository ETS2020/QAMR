// Benchmark "FAU" written by ABC on Wed Aug 26 09:28:37 2020
...
module FAU ( 
  ...
  assign z06 = (~x054 & ~x085) | (x046 & (~new_n220_ | (x054 & (new_n205_ | ~new_n211_))));
  ...
  assign new_n218_ = (~x102 | ~x126) & x078 & x086;
  ...
  assign z14 = (~x054 & ~x085) | (~x046 & (~new_n299_ | (~new_n283_ & ~x054)));
  assign new_n283_ = ~new_n284_ & ~new_n293_ & ~new_n295_ & (~x006 | (~new_n288_ & ~new_n298_));
  assign new_n284_ = (x110 | x118) & (new_n287_ | (~x078 & (new_n285_ | new_n286_)));
  ...
  assign new_n292_ = ~x086 & (~x102 | x038 | ~x070);
  assign new_n293_ = x070 & (new_n294_ | (x022 & (~x014 | ~x038 | x078)));
  assign new_n294_ = ~x078 & ~x086 & (x062 | x094 | (~x022 & x030));
  ...
  assign new_n299_ = new_n302_ & (new_n300_ | ~x038 | x078);
  assign new_n300_ = (new_n301_ | x086) & ((~x102 & ~x126) | ~x006 | x070);
  assign new_n301_ = (x022 | ~x030) & ~x062 & ~x094 & (~x030 | x014 | x070);
  assign new_n302_ = (new_n303_ | ~x054) & (~x014 | ~x078) & (~x054 | x078 | ~x022 | ~x070);
  assign new_n303_ = ~x038 & (~x006 | x014 | ~x086);
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
  assign z21 = 1'b0;
