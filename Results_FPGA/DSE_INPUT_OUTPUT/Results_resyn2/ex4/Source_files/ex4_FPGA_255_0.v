// Benchmark "FAU" written by ABC on Wed Aug 26 09:29:34 2020
...
module FAU ( 
  ...
  assign new_n196_ = x079 & (new_n197_ | ~new_n199_ | new_n200_);
  ...
  assign z06 = ~z15 & x046 & (~new_n215_ | (~new_n202_ & (~x038 | x054)));
  ...
  assign new_n215_ = x078 ? (~new_n216_ & (~new_n214_ | new_n219_) & (~x014 | (~new_n214_ & ~new_n220_))) : (x014 & (new_n219_ | ~new_n220_));
  ...
  assign z08 = z15 | (~x040 & (~new_n236_ | (~new_n222_ & ~x048)));
  ...
  assign z13 = z15 | (~x045 & (~new_n272_ | (~x053 & (new_n259_ | ~new_n264_))));
  assign new_n259_ = x005 & ((~x037 & x085) | (~x077 & (new_n260_ | ~new_n262_)));
  assign new_n260_ = ~x021 & (new_n261_ | (~new_n193_ & x125));
  assign new_n261_ = ~x069 & (x101 | x125 | x029 | x061 | x093);
  assign new_n262_ = (new_n263_ | x069) & ~x085 & (x037 | ~x069 | ~x101);
  assign new_n263_ = ((~x101 & ~x125) | (x061 & x093)) & (x013 | (~x029 & ~x061 & ~x093));
  assign new_n264_ = ~new_n267_ & ~new_n269_ & ((~x109 & ~x117) | (~new_n265_ & ~new_n271_));
  assign new_n265_ = ~x077 & (new_n266_ | (x005 & (x069 ? ~x037 : ~x021)));
  assign new_n266_ = ~x085 & (x021 | ((~x061 | ~x093) & x029 & ~x069));
  assign new_n267_ = x069 & (new_n268_ | (x021 & (x077 | ~x013 | ~x037)));
  assign new_n268_ = ~x077 & ~x085 & (x061 | x093 | (~x021 & x029));
  assign new_n269_ = new_n270_ & ~x077 & ~x085 & ~new_n185_ & (x101 | x125);
  assign new_n270_ = x029 & (~x021 | (~x013 & ~x069));
  assign new_n271_ = x013 & ~x085;
  assign new_n272_ = new_n274_ & (new_n273_ | ~x037 | x077 | x085);
  assign new_n273_ = ~new_n270_ & ~x061 & ~x093;
  assign new_n274_ = (~x013 | ~x077) & (~x053 | (new_n275_ & (~x085 | ~x005 | x013)));
  assign new_n275_ = ~x037 & (x077 | ~x021 | ~x069);
  assign z14 = z15 | (~x046 & (~new_n290_ | (~new_n277_ & ~x054)));
  assign new_n277_ = new_n288_ & (x078 | (~new_n278_ & ~new_n283_ & (new_n281_ | x086)));
  assign new_n278_ = (x110 | x118) & (new_n279_ | new_n280_);
  assign new_n279_ = x006 & (x070 ? ~x038 : ~x022);
  assign new_n280_ = ~x086 & (x022 | (~x070 & x030 & (~x062 | ~x094)));
  assign new_n281_ = (~x070 | ((x022 | ~x030) & ~x062 & ~x094)) & (~new_n282_ | ~x030 | (x062 & x094));
  assign new_n282_ = (x102 | x126) & (~x022 | (~x014 & ~x070));
  ...
  assign new_n288_ = (~new_n289_ | ~x078) & ((~x110 & ~x118) | ~x014 | x086);
  assign new_n289_ = x022 & x070;
  assign new_n290_ = (x078 | (~new_n294_ & (new_n291_ | ~x038))) & (~x038 | ~x054) & (new_n295_ | ~x078);
  assign new_n291_ = ~new_n293_ & (new_n292_ | x070);
  assign new_n292_ = (~x006 | (~x102 & ~x126)) & (x014 | ~x030 | x086);
  assign new_n293_ = ~x086 & (x062 | x094 | (~x022 & x030));
  assign new_n294_ = (new_n289_ | (x006 & x086)) & (~x014 | (new_n289_ & (~x038 | x054)));
  assign new_n295_ = ~x014 & (x038 | ~x006 | ~x086);
  assign z07 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
  assign z19 = 1'b0;
