...
module FAU ( 
  ...
  assign z05 = z07 | (x045 & (~new_n201_ | (~new_n185_ & (~x037 | x053))));
  ...
  assign z06 = (~new_n220_ | (~new_n207_ & ~new_n226_)) & ~z07 & x046;
  ...
  assign new_n277_ = x125 & (~x061 | x069 | (x021 & ~x093));
  assign new_n278_ = new_n282_ & (x077 | (~new_n280_ & ~new_n281_ & (~new_n279_ | x037)));
  assign new_n279_ = x021 & x069;
  assign new_n280_ = ~x013 & ((x021 & x069) | (x029 & x037 & ~x085));
  assign new_n281_ = (x061 | x093 | (~x021 & x029)) & x037 & ~x085;
  assign new_n282_ = (~x037 | ~x053) & (~x077 | (~x013 & (x053 | ~x021 | ~x069)));
  assign new_n283_ = (~x077 | (~x013 & (~new_n279_ | x053) & (~x005 | (x037 & ~x053)))) & (~x037 | ~x053) & (x077 | ((~x005 | (x013 & x053)) & (~new_n279_ | (x013 & x037))));
  ...
  assign new_n289_ = (~x070 | (~x062 & ~x094 & (x022 | ~x030))) & (~new_n290_ | ~x030 | (x062 & x094));
  ...
  assign new_n298_ = x078 ? (~x014 & (new_n226_ | ~new_n302_)) : (~new_n299_ & ((~new_n297_ & ~new_n302_) | (x014 & (new_n226_ | ~new_n297_))));
