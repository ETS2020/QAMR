...
module FAU ( 
  ...
  assign z05 = z23 | (x045 & (~new_n196_ | (x053 & (new_n183_ | ~new_n188_))));
  ...
  assign z06 = (z23 | x046) & (~new_n214_ | (~new_n201_ & x054));
  ...
  assign new_n219_ = ~z23 & (x038 | x054);
  assign new_n220_ = x014 & (x006 | ~x038 | x086);
  assign z08 = z23 | (~x040 & (~new_n236_ | (~new_n222_ & ~x048)));
  ...
  assign z11 = ~z23 & ~x043 & (new_n251_ | (x011 & x075));
  assign new_n251_ = (x035 | ((new_n252_ | new_n253_) & ((new_n253_ & ~x011) | ~x051 | (new_n252_ & ~x075)))) & ((new_n252_ & ~x011) | ~x035 | x051 | (new_n253_ & ~x075));
  assign new_n252_ = x019 & x067;
  assign new_n253_ = x003 & x083;
  assign z12 = z23 | (~new_n255_ & ~x044);
  ...
  assign new_n274_ = x051 & ((~new_n275_ & ~x077) | ~new_n273_ | new_n277_);
  ...
  assign z14 = ~z23 & ~x046 & (~new_n292_ | (~new_n279_ & (x038 | ~x054)));
