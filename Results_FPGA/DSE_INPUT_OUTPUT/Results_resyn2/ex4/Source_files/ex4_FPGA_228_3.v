...
module FAU ( 
  ...
  assign z06 = (z18 | x046) & (~new_n200_ | (x054 & (new_n188_ | ~new_n196_)));
  ...
  assign new_n205_ = (x078 | (x014 & (~new_n204_ | ~x038))) & ~z18 & (x038 | x054);
  assign z08 = z18 | (~x040 & (~new_n220_ | (~x048 & (new_n207_ | ~new_n215_))));
  ...
  assign z14 = ~z18 & ~x046 & (~new_n273_ | (~new_n260_ & ~x054));
