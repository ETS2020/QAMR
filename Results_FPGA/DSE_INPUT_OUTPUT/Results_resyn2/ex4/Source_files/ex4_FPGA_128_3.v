// Benchmark "FAU" written by ABC on Wed Aug 26 09:27:38 2020
...
module FAU ( 
  ...
  assign z08 = z15 | (~x040 & (~new_n221_ | (~x048 & (new_n208_ | ~new_n216_))));
  assign new_n208_ = ~x072 & ((~new_n214_ & ~x080) | (x000 & (new_n209_ | ~new_n212_)));
  assign new_n209_ = new_n211_ & (new_n210_ | ~x016 | (~x008 & ~x032));
  assign new_n210_ = (x096 | x120) & (~x056 | ~x088);
  assign new_n211_ = ~x064 & (x096 | x120 | x024 | x056 | x088);
  assign new_n212_ = new_n213_ & ((x104 & x112) | x016 | ~x120);
  assign new_n213_ = ~x080 & (~x096 | x032 | ~x064);
  assign new_n214_ = (new_n215_ | ~x064) & ((x016 & (x008 | x064)) | ~new_n210_ | ~x024);
  assign new_n215_ = ~x056 & ~x088 & (x016 | ~x024);
  assign new_n216_ = (~new_n220_ | ~x072) & (new_n219_ | ((new_n217_ | x072) & (~x008 | x080)));
  assign new_n217_ = ~new_n218_ & (~x000 | (x064 ? x032 : x016));
  assign new_n218_ = ~x080 & (x016 | ((~x056 | ~x088) & x024 & ~x064));
  assign new_n219_ = ~x104 & ~x112;
  assign new_n220_ = x016 & x064;
  assign new_n221_ = (x072 | (~new_n224_ & (new_n222_ | ~x032))) & (~x032 | ~x048) & (new_n225_ | ~x072);
  assign new_n222_ = (new_n215_ | x080) & (x064 | (~new_n223_ & (x080 | x008 | ~x024)));
  assign new_n223_ = x000 & (x096 | x120);
  assign new_n224_ = (new_n220_ | (x000 & x080)) & (~x008 | (new_n220_ & (~x032 | x048)));
  assign new_n225_ = ~x008 & (x032 | ~x000 | ~x080);
  assign z09 = ~new_n227_ & ~z15 & ~x041;
  assign new_n227_ = ((~new_n228_ & ~x009) | (~new_n229_ & x009) | (~x033 & x049)) & ((~new_n229_ & ~x009) | x033 | (~new_n228_ & x009)) & ((~new_n228_ & ~new_n229_) | x009 | x073) & (~x009 | ~x073) & (~x033 | ~x049);
  assign new_n228_ = x017 & x065;
  assign new_n229_ = x001 & x081;
  assign z10 = ~new_n231_ & ~z15 & ~x042;
  assign new_n231_ = ((~new_n232_ & ~x010) | (~new_n233_ & x010) | (~x034 & x050)) & ((~new_n233_ & ~x010) | x034 | (~new_n232_ & x010)) & ((~new_n232_ & ~new_n233_) | x010 | x074) & (~x010 | ~x074) & (~x034 | ~x050);
  assign new_n232_ = x018 & x066;
  assign new_n233_ = x002 & x082;
  assign z11 = ~new_n235_ & ~z15 & ~x043;
  assign new_n235_ = ((~new_n236_ & ~x011) | (~new_n237_ & x011) | (~x035 & x051)) & ((~new_n237_ & ~x011) | x035 | (~new_n236_ & x011)) & ((~new_n236_ & ~new_n237_) | x011 | x075) & (~x011 | ~x075) & (~x035 | ~x051);
  assign new_n236_ = x019 & x067;
  assign new_n237_ = x003 & x083;
  assign z12 = z15 | (~new_n239_ & ~x044);
  assign new_n239_ = ((~new_n240_ & ~x012) | (~new_n241_ & x012) | (~x036 & x052)) & ((~new_n241_ & ~x012) | x036 | (~new_n240_ & x012)) & ((~new_n240_ & ~new_n241_) | x012 | x076) & (~x012 | ~x076) & (~x036 | ~x052);
  assign new_n240_ = x020 & x068;
  assign new_n241_ = x004 & x084;
  assign z13 = (~new_n260_ & x085) | (~x045 & (~new_n256_ | (~new_n243_ & ~x053)));
  ...
  assign new_n246_ = ~x085 & (x021 | ((~x061 | ~x093) & x029 & ~x069));
  assign new_n247_ = x013 & ~x085;
  assign new_n248_ = (~x005 | (~new_n249_ & ~new_n250_)) & (~new_n251_ | ~new_n252_);
  assign new_n249_ = (~x021 | (~x013 & ~x037)) & (x029 | x061 | x093);
  assign new_n250_ = (x101 | x125) & (~x021 | ~x061 | ~x093);
  assign new_n251_ = (x101 | x125) & (~x061 | ~x093);
  assign new_n252_ = ~x013 & x029 & ~x085;
  assign new_n253_ = ~x021 & (new_n254_ | ((new_n251_ | x069) & x029 & ~x085));
