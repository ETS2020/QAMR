...
module FAU ( 
  ...
  assign new_n177_ = (new_n178_ | ~x012 | ~x076) & (x085 | x012 | x076) & (x036 | x052 | (~x076 & x085));
  ...
  assign z06 = ~z07 & x046 & (~new_n214_ | (~new_n201_ & (~x038 | x054)));
  ...
  assign new_n221_ = ~new_n222_ & (~x000 | (~new_n227_ & new_n230_)) & (new_n225_ | x080);
  ...
  assign z12 = ~x044 & (new_n254_ | new_n258_ | ~new_n260_ | (~new_n259_ & ~x052));
  assign new_n254_ = x036 & (~new_n255_ | (new_n257_ & (x076 | (~x012 & ~x085))));
  assign new_n255_ = (~new_n256_ | ~x012 | x085) & (~x052 | (~x076 & x085));
  assign new_n256_ = x004 & x084;
  assign new_n257_ = x020 & x068;
  assign new_n258_ = x012 & (x076 | (new_n257_ & ~x036 & ~x085));
  assign new_n259_ = (~new_n257_ | ~x076) & (~new_n256_ | ~x012 | x085);
  assign new_n260_ = (~new_n257_ | x085 | x012 | x076) & ((~x076 & (x012 | x085)) | ~new_n256_ | (x036 & x076));
  ...
  assign new_n267_ = (new_n185_ | ~x029 | (x021 & (x013 | x069))) & (~x005 | x069 | (new_n185_ & x021));
  ...
  assign new_n277_ = x076 & ((~new_n278_ & ~x077) | ~new_n276_ | new_n280_);
  ...
  assign new_n300_ = ~new_n301_ & ~z07 & (~x038 | ~x054);
