...
module FAU ( 
  ...
  assign z06 = x046 & ((~new_n205_ & x085) | (~new_n223_ & ~x086));
  assign new_n205_ = new_n218_ & (~x054 | (~new_n206_ & (~x078 | (~new_n210_ & ~new_n213_))));
  assign new_n206_ = ~new_n207_ & ((x078 & (new_n208_ | (~new_n209_ & x086))) | (~x014 & x086));
  assign new_n207_ = x110 & x118;
  assign new_n208_ = ~x006 & (x070 ? (x022 & x062) : x038);
  assign new_n209_ = x022 & (~x070 | x030 | (~x062 & ~x094));
  ...
  assign new_n213_ = ~x006 & ((~new_n214_ & ~x126) | ~new_n215_ | new_n216_ | new_n217_);
  assign new_n214_ = (~x070 | (~x062 & (x022 | ~x094))) & ((~x110 & ~x118) | ~x022 | x070);
  assign new_n215_ = (~x038 | ((x070 | x102) & (x062 | ~x022 | ~x070))) & (~x062 | ~x070 | x102);
  assign new_n216_ = ~x022 & ((x014 & ~x062) | (x094 & x070 & ~x102));
  assign new_n217_ = (~x030 | ~x094) & ((x014 & ~x022) | (x070 & x022 & x062));
  assign new_n218_ = new_n222_ & (~x078 | (~new_n220_ & ~new_n221_ & (~new_n219_ | ~x038)));
  assign new_n219_ = ~x022 & ~x070;
  assign new_n220_ = x014 & ((~x022 & ~x070) | (~x030 & ~x038 & x086));
  assign new_n221_ = ~x038 & x086 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n222_ = (x038 | x054) & (x078 | (x014 & (~x054 | x022 | x070)));
  assign new_n223_ = (x078 | (x014 & (~new_n219_ | ~x054) & (x006 | (~x038 & x054)))) & (x038 | x054) & (~x078 | ((x006 | (~x014 & ~x054)) & (~new_n219_ | (~x014 & ~x038))));
  ...
  assign z13 = ~x045 & ((~new_n280_ & x085) | (~new_n261_ & ~x086));
  ...
  assign new_n278_ = x037 & ~x085 & ((~x021 & x029) | x061 | x093);
  ...
  assign z14 = z17 | (~x046 & (~new_n298_ | (~new_n282_ & (x038 | ~x054))));
  assign new_n282_ = new_n291_ & (x078 | (~new_n285_ & ~new_n287_ & (new_n283_ | new_n297_)));
  assign new_n283_ = ((x062 & x094) | (~new_n284_ & (~x006 | x070))) & (~x006 | x022 | x070);
  assign new_n284_ = ~x086 & x030 & (~x022 | (~x014 & ~x070));
  assign new_n285_ = x070 & (new_n286_ | (x102 & x006 & ~x038));
  assign new_n286_ = ~x086 & ((~x022 & x030) | x062 | x094);
  assign new_n287_ = (new_n288_ | new_n289_ | ~new_n290_) & x006;
  assign new_n288_ = x030 & (~x022 | (~x014 & ~x070));
  assign new_n289_ = (x062 | x094) & (~x014 | ~x022);
  assign new_n290_ = ~x086 & ((x110 & x118) | x022 | ~x126);
  assign new_n291_ = new_n296_ & (new_n292_ | (~new_n295_ & (x078 | (~new_n293_ & ~new_n294_))));
  ...
  assign new_n296_ = ~x054 & (~x078 | ~x022 | ~x070);
  assign new_n297_ = ~x102 & ~x126;
  assign new_n298_ = x078 ? new_n302_ : (~new_n299_ & (new_n301_ | ~x038 | x086));
  assign new_n299_ = (new_n300_ | (x006 & x086)) & (~x014 | (new_n300_ & (~x038 | x054)));
  assign new_n300_ = x022 & x070;
  assign new_n301_ = ~new_n288_ & ~x062 & ~x094;
  assign new_n302_ = ~x014 & (~x006 | ~x086 | (x038 & ~x054));
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z18 = 1'b0;
