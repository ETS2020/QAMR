...
module FAU ( 
  ...
  assign z17 = ~x085 & x105;
  assign z01 = z17 | (x041 & (new_n165_ | (~x009 & ~x073)));
  ...
  assign z03 = z17 | (x043 & (new_n173_ | (~x011 & ~x075)));
  ...
  assign new_n178_ = (new_n179_ | ~x012 | ~x076) & (x036 | x052) & ~z17 & (x012 | x076);
  assign new_n179_ = (x004 | x084) & (x020 | x068);
  assign new_n180_ = ~x020 & ~x068;
  assign new_n181_ = ~x004 & ~x084;
  assign z05 = x045 & ((~new_n183_ & x085) | ((new_n198_ | ~new_n202_) & ~x105));
  ...
  assign z13 = ~x045 & ((~new_n280_ & x085) | (~new_n262_ & ~x105));
  ...
  assign new_n278_ = ((~x021 & x029) | x061 | x093) & x037 & ~x085;
  ...
  assign z14 = z17 | (~x046 & (~new_n295_ | (~new_n282_ & (x038 | ~x054))));
  ...
  assign new_n295_ = x078 ? (~x014 & (new_n224_ | ~new_n299_)) : (~new_n296_ & ((~new_n294_ & ~new_n299_) | ((new_n224_ | ~new_n294_) & x014)));
