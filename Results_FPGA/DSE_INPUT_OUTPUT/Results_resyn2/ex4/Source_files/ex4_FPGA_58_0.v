...
module FAU ( 
  ...
  assign z06 = (z07 | x046) & (~new_n213_ | (x054 & (new_n201_ | ~new_n209_)));
  ...
  assign new_n218_ = (x078 | (x014 & (~new_n217_ | ~x038))) & ~z07 & (x038 | x054);
  ...
  assign z14 = ~z07 & ~x046 & (~new_n274_ | (~new_n261_ & ~x054));
