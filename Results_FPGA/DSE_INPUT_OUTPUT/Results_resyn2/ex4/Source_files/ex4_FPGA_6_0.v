// Benchmark "FAU" written by ABC on Wed Aug 26 09:25:46 2020
...
module FAU ( 
  ...
  assign z05 = x045 & ((x114 & (new_n202_ | ~new_n206_)) | (~new_n187_ & x085));
  ...
  assign z06 = (~new_n222_ | (~new_n209_ & ~new_n228_)) & ~z07 & x046;
  ...
  assign z13 = ~x045 & ((~new_n284_ & x085) | (~new_n266_ & x114));
