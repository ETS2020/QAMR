...
module FAU ( 
  ...
  assign new_n200_ = (x021 | ~x037 | x069) & (~x013 | ((x021 | x069) & (x005 | x085)));
  ...
  assign new_n268_ = new_n269_ & (~x102 | x038 | ~x070);
  ...
  assign new_n272_ = ~x086 & (x022 | (x030 & ~x070 & (~x062 | ~x094)));
  ...
  assign new_n277_ = (new_n278_ | (x022 & x070)) & (~x014 | (x022 & x070 & (~x038 | x054)));
