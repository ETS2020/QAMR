...
module FAU ( 
  ...
  assign z06 = (z16 | x046) & (~new_n220_ | (~new_n207_ & ~new_n226_));
  ...
  assign new_n212_ = (x022 | (x014 & x070)) & (~x102 | ~x126);
  ...
  assign new_n220_ = (~x078 | (~new_n221_ & new_n224_)) & ~z16 & (new_n225_ | x078);
  ...
  assign z13 = ~x045 & ((~new_n264_ & ~x071) | (~new_n283_ & x085));
