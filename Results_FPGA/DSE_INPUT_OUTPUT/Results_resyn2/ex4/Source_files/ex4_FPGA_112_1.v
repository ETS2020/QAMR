...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n185_ & x073) | (~new_n203_ & ~x085));
  ...
  assign z09 = z07 | (~x041 & (~new_n248_ | new_n246_ | (x033 & x049)));
  assign new_n246_ = (x009 | (x001 & x081)) & ~x033 & (new_n247_ | ~x009);
  assign new_n247_ = x017 & x065;
  assign new_n248_ = (~x009 | (~x073 & (x049 | ~x001 | ~x081))) & ((x073 & (~new_n247_ | x049)) | x009 | (~new_n247_ & (~x001 | ~x081)));
