...
module FAU ( 
  ...
  assign z05 = z15 | (x045 & (~new_n198_ | (x053 & (new_n183_ | ~new_n190_))));
  ...
  assign z13 = z15 | (~x045 & (~new_n271_ | (~new_n259_ & ~x053)));
  assign new_n259_ = ~new_n268_ & (x077 | (~new_n260_ & new_n265_ & (new_n263_ | ~x005)));
  assign new_n260_ = ~new_n261_ & ~new_n262_ & (x101 | x125);
  assign new_n261_ = (~x005 | x069) & (~x029 | x085 | (x021 & (x013 | x069)));
  assign new_n262_ = x061 & x093 & (~x005 | x021 | x069);
  assign new_n263_ = new_n264_ & (~x029 | (x021 & (x013 | x069)));
  assign new_n264_ = ~x085 & ((x109 & x117) | x021 | ~x125);
  assign new_n265_ = (new_n267_ | ~x069) & ((~x061 & ~x093) | (~new_n266_ & (~x069 | x085)));
  assign new_n266_ = x005 & (~x013 | ~x021);
  assign new_n267_ = (x021 | ~x029 | x085) & (~x101 | ~x005 | x037);
  assign new_n268_ = ~new_n188_ & ((x013 & ~x085) | (~x077 & (new_n269_ | (~new_n270_ & ~x085))));
  assign new_n269_ = x005 & (~x037 | ~x069);
  assign new_n270_ = ~x021 & ((x061 & x093) | ~x029 | x069);
  assign new_n271_ = new_n275_ & (x077 | (~new_n272_ & (new_n276_ | ~x037 | x085)));
  assign new_n272_ = (new_n273_ | new_n274_) & (~x013 | (new_n273_ & (~x037 | x053)));
  assign new_n273_ = x021 & x069;
  assign new_n274_ = x005 & x085;
  assign new_n275_ = (~x037 | ~x053) & (~x077 | ((~new_n274_ | x037) & ~x013 & (~new_n273_ | x053)));
