...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n181_ & ~x049) | (~new_n199_ & ~x085));
  ...
  assign z09 = ~x041 & (new_n242_ | (~new_n244_ & x009) | new_n247_ | (~new_n246_ & ~x009));
  assign new_n242_ = ~x085 & ((x033 & x049) | (~x073 & new_n243_ & ~x033));
  assign new_n243_ = x017 & x065;
  assign new_n244_ = (x033 | x085 | (~new_n243_ & ~x073)) & (x049 | (~new_n245_ & ~x073));
  assign new_n245_ = x001 & x081;
  assign new_n246_ = (~new_n245_ | x033 | x085) & (~new_n243_ | x049);
  assign new_n247_ = ~x049 & (~x033 | ~x073) & (new_n245_ | (new_n243_ & ~x033));
  ...
  assign z13 = ~x045 & ((~new_n275_ & ~x049) | (~new_n261_ & ~x085));
  ...
  assign new_n272_ = x037 & (x061 | x093 | (~x021 & x029));
  ...
  assign new_n276_ = (x085 | (new_n195_ & x061)) & x005 & (~x053 | (~x013 & x085));
  ...
  assign new_n294_ = x078 ? (~x014 & (new_n220_ | ~new_n298_)) : (~new_n295_ & ((~new_n293_ & ~new_n298_) | ((new_n220_ | ~new_n293_) & x014)));
