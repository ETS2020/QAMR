...
module FAU ( 
  ...
  assign new_n62_ = new_n51_ & ~x15 & ~x25;
  ...
  assign z14 = x15 | (~x25 & ((~new_n67_ & x21) | ~new_n51_ | new_n68_));
  ...
  assign z17 = x15 | (~x25 & (new_n72_ | ~new_n73_));
  assign new_n72_ = x24 & (~new_n68_ | x22 | x23);
  assign new_n73_ = new_n51_ & (~new_n67_ | x22 | x23 | x21 | x24);
  assign z18 = x15 | (~new_n73_ & ~x25);
endmodule
