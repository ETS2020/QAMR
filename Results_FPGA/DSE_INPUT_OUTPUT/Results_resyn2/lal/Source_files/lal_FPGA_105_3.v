...
module FAU ( 
  ...
  assign z14 = x07 ? ~x15 : ((~new_n69_ & x21) | x15 | (x04 & x05) | (new_n69_ & ~x21));
  assign new_n69_ = ~x20 & x19 & x17 & x18;
  assign z15 = x07 ? ~x15 : ((~new_n71_ & x22) | new_n62_ | x15 | (new_n71_ & ~x22));
  assign new_n71_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = (x07 & ~x15) | (~x07 & x15) | (~x07 & ((x23 & (~new_n71_ | x22)) | new_n62_ | (new_n71_ & ~x22 & ~x23)));
