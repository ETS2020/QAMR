...
module FAU ( 
  ...
  assign z14 = (~x21 & ~x20 & x19 & x17 & x18) | ~new_n67_ | (x21 & (x20 | ~x19 | ~x17 | ~x18));
  assign new_n67_ = (~x04 | ~x05) & ~x07 & ~x15 & (x22 | x23);
  assign z15 = (new_n69_ & ~x22) | ~new_n67_ | (~new_n69_ & x22);
  assign new_n69_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = (~new_n62_ & (x22 | x23)) | ((~new_n69_ | x22) & x23);
  assign z17 = (~new_n48_ & ~new_n62_) | (~new_n48_ & x24);
  assign z18 = (~new_n48_ & ~new_n62_) | (~new_n48_ & x25);
