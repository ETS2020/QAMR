// Benchmark "FAU" written by ABC on Wed Aug 12 18:11:38 2020
...
module FAU ( 
  ...
  assign z11 = ~x15 & (x17 | (new_n51_ & x18));
  assign z12 = ~x15 & (x17 | (new_n51_ & x19));
  assign z13 = x15 | (~x17 & (~new_n51_ | x20));
  assign z14 = x21 | (x04 & x05) | x17 | x07 | x15;
  assign z15 = x15 | (~x17 & (~new_n51_ | x22));
  assign z16 = x23 | (x04 & x05) | x17 | x07 | x15;
  assign z17 = x24 | (x04 & x05) | x17 | x07 | x15;
