...
module FAU ( 
  ...
  assign z14 = x15 | (~x07 & ((~new_n69_ & x21) | (x04 & x05) | (new_n69_ & ~x21)));
  ...
  assign z17 = (x24 & (~new_n71_ | x22 | x23)) | ~new_n65_ | (~x24 & new_n71_ & ~x22 & ~x23);
  assign z18 = (~x25 & ~x24 & new_n71_ & ~x22 & ~x23) | ~new_n65_ | (x25 & (x24 | ~new_n71_ | x22 | x23));
endmodule
