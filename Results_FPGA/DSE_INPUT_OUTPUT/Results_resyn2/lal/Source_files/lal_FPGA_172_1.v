...
module FAU ( 
  ...
  assign new_n48_ = ~x11 & x25;
  assign z01 = (~x25 & (~x24 | (~new_n50_ & ~x23))) | ~new_n51_ | (~x11 & x25);
  assign new_n50_ = (x20 | (~x19 & ~x17 & ~x18)) & x21 & x22;
  assign new_n51_ = ~x07 & (~x04 | ~x05);
  assign z02 = new_n48_ | x16;
  assign z03 = ~x25 & (~x24 | (~new_n50_ & ~x23));
  assign z04 = ~x08 & (x11 | ~x25) & (~new_n55_ | ~new_n56_ | (~x02 ^ ~x11));
  assign new_n55_ = (~x01 | x10) & (x01 | ~x10) & (x03 | ~x12) & (~x00 | x09);
  assign new_n56_ = (x00 | ~x09) & (~x03 | x12);
  ...
  assign new_n65_ = (x11 | ~x25) & ~x15 & ~x07 & (~x04 | ~x05);
  ...
  assign z16 = ~new_n48_ & ((~x23 & new_n69_ & ~x22) | ~new_n62_ | (x23 & (~new_n69_ | x22)));
  assign z17 = ~new_n48_ & ((x24 & (x23 | ~new_n69_ | x22)) | ~new_n62_ | (new_n69_ & ~x24 & ~x22 & ~x23));
  assign z18 = (x25 & (~new_n69_ | x24 | x22 | x23)) | ~new_n65_ | (~x25 & new_n69_ & ~x24 & ~x22 & ~x23);
