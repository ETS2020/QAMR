...
module FAU ( 
  ...
  assign z08 = (~x15 & (x25 | (new_n50_ & x24))) | (x23 & (x24 | x25));
  ...
  assign z14 = (~x15 | x23) & ((x21 & (~new_n67_ | x20)) | ~new_n51_ | x15 | (new_n67_ & ~x20 & ~x21));
  assign z15 = ~new_n48_ & ((~x21 & ~x22 & new_n67_ & ~x20) | ~new_n63_ | (x22 & (~new_n67_ | x20 | x21)));
  assign z16 = (~x23 & new_n71_ & new_n72_) | ~new_n63_ | (x23 & (~new_n71_ | ~new_n72_));
  assign new_n71_ = ~x20 & x19 & x17 & x18;
  assign new_n72_ = ~x21 & ~x22;
  assign z17 = (x23 & (x15 | x24)) | (~x15 & ((x24 & (~new_n71_ | ~new_n72_)) | ~new_n51_ | (new_n71_ & new_n72_ & ~x23 & ~x24)));
  assign z18 = (~x25 & new_n71_ & new_n72_ & ~x23 & ~x24) | ~new_n63_ | (x25 & (~new_n71_ | ~new_n72_ | x23 | x24));
endmodule
