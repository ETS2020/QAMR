...
module FAU ( 
  ...
  assign z04 = ~x08 & (x00 | x15) & (~new_n56_ | ~new_n55_ | (x00 & ~x09) | (~x00 & x09));
  ...
  assign z09 = ~x15 & (~x00 | (~x07 & x04 & x05));
  assign z10 = new_n62_ & ~x17;
  assign new_n62_ = ~x07 & (~x04 | ~x05) & x00 & ~x15;
  assign z11 = ~x15 & (~x00 | (new_n51_ & (x17 | x18) & (~x17 | ~x18)));
  assign z12 = new_n62_ & (x19 | (x17 & x18)) & (~x19 | ~x17 | ~x18);
  assign z13 = (~x20 & x19 & x17 & x18) | ~new_n62_ | (x20 & (~x19 | ~x17 | ~x18));
  assign z14 = x15 | (x00 & ((~new_n67_ & x21) | ~new_n51_ | (new_n67_ & ~x21)));
  assign new_n67_ = ~x20 & x19 & x17 & x18;
  assign z15 = x15 | (x00 & ((x22 & (~new_n67_ | x21)) | ~new_n51_ | (~x22 & new_n67_ & ~x21)));
