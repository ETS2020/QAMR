...
module FAU ( 
  ...
  assign z12 = new_n50_ & ~x15 & x20 & (~x19 | ~x17 | ~x18) & (x19 | (x17 & x18));
  assign z13 = ~new_n50_ | x15 | ~x20 | ~x19 | ~x17 | ~x18;
  assign z14 = x15 | (x20 & (~new_n50_ | x21));
  assign z15 = x22 | ~new_n50_ | x15 | ~x20;
  assign z16 = x15 | (x20 & (~new_n50_ | x23));
  assign z17 = x15 | (x20 & (~new_n50_ | x24));
  assign z18 = x15 | (x20 & (~new_n50_ | x25));
endmodule
