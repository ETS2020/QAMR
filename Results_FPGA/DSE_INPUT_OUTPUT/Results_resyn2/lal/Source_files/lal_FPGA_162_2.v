...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n51_, new_n54_, new_n55_, new_n65_, new_n67_,
  ...
  assign z13 = x15 ? x16 : ~new_n65_;
  assign new_n65_ = (x20 | ~x19 | ~x17 | ~x18) & new_n51_ & (~x20 | (x19 & x17 & x18));
  assign z14 = x15 ? x16 : ((~new_n67_ & x21) | ~new_n51_ | (new_n67_ & ~x21));
  assign new_n67_ = ~x20 & x19 & x17 & x18;
  assign z15 = x15 ? x16 : ((x22 & (~new_n67_ | x21)) | ~new_n51_ | (new_n67_ & ~x21 & ~x22));
  assign z16 = x15 ? x16 : ((~new_n70_ & x23) | ~new_n51_ | (new_n70_ & ~x23));
  assign new_n70_ = new_n67_ & ~x21 & ~x22;
  assign z17 = x15 ? x16 : ~new_n72_;
  assign new_n72_ = (~x24 | (~x23 & new_n67_ & ~x21 & ~x22)) & new_n51_ & (~new_n67_ | x21 | x22 | x23 | x24);
  assign z18 = (~x15 | x16) & ((new_n74_ & ~x25) | ~new_n51_ | x15 | (~new_n74_ & x25));
  assign new_n74_ = new_n67_ & ~x23 & ~x24 & ~x21 & ~x22;
  assign z02 = x16;
endmodule
