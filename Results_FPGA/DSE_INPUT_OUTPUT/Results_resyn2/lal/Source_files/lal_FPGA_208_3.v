...
module FAU ( 
  ...
  assign z11 = (x15 & x22) | (new_n50_ & ~x15 & (~x17 | ~x18) & (x17 | x18));
  assign z12 = (x15 & x22) | (new_n50_ & ~x15 & (~x19 | ~x17 | ~x18) & (x19 | (x17 & x18)));
  assign z13 = (~x15 | ~x22) & ((~new_n66_ & x20) | (new_n66_ & ~x20) | ~new_n50_ | x15);
  ...
  assign z16 = (~x22 & (x15 | (new_n70_ & ~x23))) | (~x15 & (~new_n50_ | (x23 & (~new_n70_ | x22))));
  assign z17 = (x24 & (x22 | ~new_n70_ | x23)) | ~new_n68_ | (~x24 & ~x22 & new_n70_ & ~x23);
  assign z18 = (x25 & (x24 | x22 | ~new_n70_ | x23)) | ~new_n68_ | (~x22 & new_n70_ & ~x23 & ~x24 & ~x25);
endmodule
