...
module FAU ( 
  ...
  assign z10 = (x07 & x15) | (~x17 & ~x15 & ~new_n62_ & ~x07);
  assign z11 = new_n51_ & ~x15 & (x17 | x18) & (~x17 | ~x18);
  assign z12 = new_n51_ & ~x15 & (~x19 | ~x17 | ~x18) & (x19 | (x17 & x18));
  assign z13 = x07 ? ~x15 : ((new_n67_ & ~x20) | x15 | (x04 & x05) | (~new_n67_ & x20));
  ...
  assign z17 = (x07 & ~x15) | (~x07 & x15) | (~x07 & ((x24 & (~new_n72_ | x23)) | new_n62_ | (new_n72_ & ~x23 & ~x24)));
