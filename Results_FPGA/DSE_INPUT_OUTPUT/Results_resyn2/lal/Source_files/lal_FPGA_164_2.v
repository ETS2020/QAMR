...
module FAU ( 
  ...
  assign z12 = ~x15 & (x07 | ((x19 | (x17 & x18)) & ~new_n62_ & (~x19 | ~x17 | ~x18)));
  assign z13 = (~x20 & x19 & x17 & x18) | ~new_n64_ | (x20 & (~x19 | ~x17 | ~x18));
  assign z14 = x15 | (~x07 & ((~new_n68_ & x21) | (x04 & x05) | (new_n68_ & ~x21)));
  assign new_n68_ = ~x20 & x19 & x17 & x18;
  assign z15 = x15 | (~x07 & ((~new_n70_ & x22) | new_n62_ | (new_n70_ & ~x22)));
  assign new_n70_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = x15 | (~x07 & ((x23 & (~new_n70_ | x22)) | new_n62_ | (new_n70_ & ~x22 & ~x23)));
