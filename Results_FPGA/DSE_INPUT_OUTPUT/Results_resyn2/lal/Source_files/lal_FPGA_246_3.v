...
module FAU ( 
  ...
  assign z09 = x05 & (x15 | (x04 & ~x07));
  assign z10 = (x05 & x15) | (new_n62_ & ~x17);
  assign new_n62_ = (~x04 | ~x05) & ~x07 & ~x15;
  assign z11 = (x05 & x15) | (new_n62_ & (x17 | x18) & (~x17 | ~x18));
  ...
  assign z18 = (~x25 & new_n70_ & ~x23 & ~x24) | ~new_n62_ | (x25 & (~new_n70_ | x23 | x24));
endmodule
