...
module FAU ( 
  ...
  assign z08 = (x15 & (x25 | (x24 & (new_n50_ | x23)))) | (~x22 & (x25 | (x23 & x24)));
  ...
  assign z15 = x15 | (~x22 & (~new_n51_ | new_n70_));
  assign new_n70_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = x15 | (~x22 & ((~new_n70_ & x23) | ~new_n51_ | (new_n70_ & ~x23)));
  assign z17 = (~new_n73_ & x24) | ~new_n63_ | (new_n73_ & ~x24);
  assign new_n73_ = ~x23 & ~x21 & ~x20 & x19 & x17 & x18;
  assign z18 = (~x25 & new_n73_ & ~x24) | ~new_n63_ | (x25 & (~new_n73_ | x24));
endmodule
