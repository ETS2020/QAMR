...
module FAU ( 
  ...
  assign z04 = ~x08 & (x03 | ~x07) & (~new_n56_ | ~new_n55_ | (x03 & ~x12) | (~x03 & x12));
  ...
  assign z09 = (~x03 & x07) | (new_n61_ & ~x07 & ~x15);
  ...
  assign z13 = x07 ? x03 : ((new_n67_ & ~x20) | (~new_n67_ & x20) | new_n61_ | x15);
  assign new_n67_ = x19 & x17 & x18;
  assign z14 = x07 ? x03 : ((~new_n69_ & x21) | ~new_n70_ | (new_n69_ & ~x21));
  ...
  assign z17 = x07 ? x03 : ((x24 & (~new_n73_ | x23)) | ~new_n70_ | (new_n73_ & ~x23 & ~x24));
  assign z18 = ~new_n48_ & ((~x25 & new_n73_ & ~x23 & ~x24) | ~new_n63_ | (x25 & (~new_n73_ | x23 | x24)));
