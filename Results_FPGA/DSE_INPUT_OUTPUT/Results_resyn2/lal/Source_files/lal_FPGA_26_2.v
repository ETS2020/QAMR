...
module FAU ( 
  ...
  assign z15 = (x21 & (x15 | x22)) | (~x15 & ((~x22 & new_n67_ & ~x21) | ~new_n51_ | (~new_n67_ & x22)));
  ...
  assign z18 = (x25 & (x24 | ~new_n70_ | x22 | x23)) | ~new_n62_ | (~x24 & ~x25 & new_n70_ & ~x22 & ~x23);
  assign z08 = (~new_n48_ & (x25 | (x23 & x24))) | (new_n50_ & x24);
endmodule
