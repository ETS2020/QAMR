...
module FAU ( 
  ...
  assign z10 = ~x17 & ~new_n48_ & new_n62_;
  ...
  assign z13 = ~new_n48_ & (((~x19 | ~x17 | ~x18) & x20) | ~new_n62_ | (x19 & x17 & x18 & ~x20));
  assign z14 = (x22 | x23) & ((~new_n67_ & x21) | ~new_n62_ | (new_n67_ & ~x21));
  assign new_n67_ = ~x20 & x19 & x17 & x18;
  assign z15 = (~new_n69_ & x22) | (new_n69_ & ~x22) | ~new_n62_ | (~x22 & ~x23);
  assign new_n69_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = (x23 & (~new_n69_ | x22)) | (~new_n62_ & (x22 | x23));
  assign z17 = (~new_n48_ & ~new_n62_) | (~new_n48_ & x24);
  assign z18 = x25 | new_n48_ | ~new_n62_;
  assign z08 = ((new_n50_ | x23) & x24) | x25 | (~x22 & ~x23);
endmodule
