...
module FAU ( 
  ...
  assign z14 = (~x15 | ~x25) & ((~new_n67_ & x21) | new_n68_ | ~new_n51_ | x15);
  assign new_n67_ = ~x20 & x19 & x17 & x18;
  assign new_n68_ = x19 & x17 & x18 & ~x20 & ~x21;
  assign z15 = (~new_n68_ & x22) | ~new_n62_ | (new_n68_ & ~x22);
  assign z16 = x15 ? ~x25 : ((x23 & (~new_n68_ | x22)) | ~new_n51_ | (new_n68_ & ~x22 & ~x23));
  assign z17 = (~x15 | ~x25) & (new_n72_ | ~new_n73_ | ~new_n51_);
  assign new_n72_ = x24 & (~new_n68_ | x22 | x23);
  assign new_n73_ = ~x15 & (~new_n67_ | x22 | x23 | x21 | x24);
  assign z18 = (~new_n73_ & ~x25) | (~new_n51_ & ~x15) | (new_n73_ & x25);
endmodule
