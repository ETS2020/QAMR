...
module FAU ( 
  ...
  assign new_n50_ = x19 & (~x15 | (~x25 & ~x20 & ~x23));
  assign new_n51_ = ~x07 & (~x04 | ~x05);
  assign z02 = x16 & (x15 | ~x19);
  assign z03 = (~x24 | (~new_n54_ & ~x23)) & (x15 | ~x19) & ~x25;
  assign new_n54_ = x21 & x22 & (x20 | (~x19 & ~x17 & ~x18));
  assign z04 = (~new_n56_ | ~new_n57_) & ~x08 & (x15 | ~x19);
  ...
  assign z08 = (~new_n62_ & (x15 | ~x19)) | (new_n63_ & ~x19 & ~x17 & ~x18);
  assign new_n62_ = ~x25 & (~x24 | (~x23 & (~x20 | ~x21 | ~x22)));
  assign new_n63_ = x24 & x21 & x22;
  assign z09 = ~x19 & ~x07 & ~x15 & x04 & x05;
  assign z10 = new_n66_ & ~x17;
  assign new_n66_ = ~x19 & ~x07 & ~x15 & (~x04 | ~x05);
  assign z11 = ~x15 & (x19 | (new_n51_ & (x17 | x18) & (~x17 | ~x18)));
  assign z12 = new_n66_ & x17 & x18;
  assign z13 = ~new_n66_ | x20;
  assign z14 = x15 | (~x19 & (~new_n51_ | x21));
  assign z15 = x15 | (~x19 & (~new_n51_ | x22));
  assign z16 = ~new_n66_ | x23;
  assign z17 = x15 | (~x19 & (~new_n51_ | x24));
  assign z18 = x15 | (~x19 & (~new_n51_ | x25));
endmodule
