...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n51_, new_n55_, new_n56_;
  ...
  assign z04 = (~x08 & (~new_n55_ | ~new_n56_)) | (~x15 & x18);
  ...
  assign z10 = ~x15 & (x18 | (new_n51_ & ~x17));
  assign z11 = ~x15 & (x18 | (new_n51_ & x17));
  assign z12 = x19 & new_n51_ & ~x15 & ~x18;
  assign z13 = x20 | ~new_n51_ | x15 | x18;
  assign z14 = x15 | (~x18 & (~new_n51_ | x21));
  assign z15 = x15 | (~x18 & (~new_n51_ | x22));
  assign z16 = x23 | ~new_n51_ | x15 | x18;
  assign z17 = x24 | ~new_n51_ | x15 | x18;
  assign z18 = x25 | ~new_n51_ | x15 | x18;
