...
module FAU ( 
  ...
  assign z10 = ~x17 & new_n51_ & ~x15 & ~x20;
  assign z11 = new_n51_ & ~x15 & ~x20 & (x17 | x18) & (~x17 | ~x18);
  assign z12 = new_n51_ & ~x15 & ~x20 & (~x19 | ~x17 | ~x18) & (x19 | (x17 & x18));
  assign z13 = x15 | (~x20 & (~new_n51_ | new_n66_));
  assign new_n66_ = x19 & x17 & x18;
  assign z14 = x15 | (~x20 & ((new_n66_ & ~x21) | ~new_n51_ | (~new_n66_ & x21)));
  assign z15 = x15 | (~x20 & ((x22 & (~new_n66_ | x21)) | ~new_n51_ | (new_n66_ & ~x21 & ~x22)));
  ...
  assign z18 = x15 | (~new_n73_ & ~x20);
  assign new_n73_ = (~x25 | (new_n74_ & new_n66_ & ~x21 & ~x22)) & new_n51_ & (~new_n66_ | x21 | ~new_n74_ | x22 | x25);
