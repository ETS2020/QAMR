...
module FAU ( 
  ...
  assign z08 = (x24 & (new_n50_ | x23)) | x25 | (~x22 & x23);
  ...
  assign z14 = (x21 & (x20 | ~x19 | ~x17 | ~x18)) | ~new_n68_ | (x19 & x17 & x18 & ~x20 & ~x21);
  assign new_n68_ = (~x04 | ~x05) & ~x07 & ~x15 & (x22 | ~x23);
  assign z15 = (new_n70_ & ~x22) | ~new_n68_ | (~new_n70_ & x22);
  assign new_n70_ = ~x20 & ~x21 & x19 & x17 & x18;
  assign z16 = (x22 | ~x23) & ((new_n70_ & ~x22) | ~new_n63_ | x23);
  assign z17 = (x22 | ~x23) & ((new_n70_ & ~x22 & ~x24) | ~new_n63_ | ((~new_n70_ | x22) & x24));
  assign z18 = ((~new_n70_ | x24 | (~x22 & ~x25)) & ~x23 & (x25 | (new_n70_ & ~x24))) | (x22 & x25) | (~new_n63_ & (x22 | ~x23));
endmodule
