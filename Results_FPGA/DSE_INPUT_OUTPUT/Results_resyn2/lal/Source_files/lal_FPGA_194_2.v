...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n52_, new_n55_, new_n57_, new_n58_,
    new_n63_, new_n64_, new_n67_, new_n71_, new_n75_;
  ...
  assign z13 = (~new_n71_ & x20) | ~new_n67_ | (new_n71_ & ~x20);
  assign new_n71_ = x19 & x17 & x18;
  assign z14 = (~x15 | x20) & ((new_n71_ & ~x20 & ~x21) | ~new_n50_ | ((~new_n71_ | x20) & (x15 | x21)));
  assign z15 = (x20 & (x15 | x22)) | (~x15 & ((new_n71_ & ~x20 & ~x21 & ~x22) | ~new_n50_ | (x22 & (~new_n71_ | x21))));
  assign z16 = (~new_n75_ & x23) | ~new_n67_ | (new_n75_ & ~x23);
  assign new_n75_ = ~x21 & ~x22 & ~x20 & x19 & x17 & x18;
  assign z17 = (~x15 | x20) & (((x15 | x24) & (~new_n75_ | x23)) | ~new_n50_ | (new_n75_ & ~x23 & ~x24));
  assign z18 = (~x25 & new_n75_ & ~x23 & ~x24) | ~new_n67_ | (x25 & (~new_n75_ | x23 | x24));
endmodule
