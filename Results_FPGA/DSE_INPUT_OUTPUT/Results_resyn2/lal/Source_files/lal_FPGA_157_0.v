...
module FAU ( 
  ...
  assign z03 = ~new_n50_ & ~x23 & x24 & ~x25;
  ...
  assign z15 = (x22 & (~new_n67_ | x21)) | ~new_n62_ | (~x24 & ~x25) | (new_n67_ & ~x21 & ~x22);
  assign z16 = (~new_n70_ & x23) | new_n48_ | ~new_n62_ | (new_n70_ & ~x23);
  assign new_n70_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = (~new_n62_ & (x24 | x25)) | (x24 ? (~new_n70_ | x23) : (new_n70_ & ~x23 & x25));
  assign z18 = (~x24 & (~new_n70_ | x23 | ~x25)) | ~new_n62_ | (x24 & x25);
  assign z08 = new_n50_ | x23 | ~x24 | x25;
endmodule
