...
module FAU ( 
  ...
  assign z14 = (x21 & (x20 | ~x19 | ~x17 | ~x18)) | ~new_n67_ | (x19 & x17 & x18 & ~x20 & ~x21);
  assign new_n67_ = (~x04 | ~x05) & (x13 | x25) & ~x07 & ~x15;
  assign z15 = (~new_n69_ & x22) | ~new_n67_ | (new_n69_ & ~x22);
  assign new_n69_ = ~x20 & ~x21 & x19 & x17 & x18;
  assign z16 = ~new_n48_ & ((x23 & (~new_n69_ | x22)) | ~new_n62_ | (new_n69_ & ~x22 & ~x23));
  assign z17 = ~new_n48_ & ((x24 & (~new_n69_ | x22 | x23)) | ~new_n62_ | (~x24 & new_n69_ & ~x22 & ~x23));
  assign z18 = (~x25 & ~x24 & new_n69_ & ~x22 & ~x23) | ~new_n67_ | (x25 & (x24 | ~new_n69_ | x22 | x23));
  assign z08 = (x24 & (new_n50_ | x23)) | ~x13 | x25;
endmodule
