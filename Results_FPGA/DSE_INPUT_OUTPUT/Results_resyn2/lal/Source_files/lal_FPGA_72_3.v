...
module FAU ( 
  ...
  assign z14 = (~x15 | ~x22) & (x15 | (new_n68_ & ~x21) | ~new_n51_ | (~new_n68_ & x21));
  assign new_n68_ = ~x20 & x19 & x17 & x18;
  assign z15 = (~x22 & (new_n70_ | x15)) | (~new_n51_ & ~x15) | (x22 & ~new_n70_ & ~x15);
  assign new_n70_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = (~x22 & (x15 | (new_n70_ & ~x23))) | (~x15 & (~new_n51_ | (x23 & (~new_n70_ | x22))));
  assign z17 = (x24 & (x22 | ~new_n70_ | x23)) | ~new_n63_ | (new_n70_ & ~x22 & ~x23 & ~x24);
