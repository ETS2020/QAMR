...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n55_, new_n56_, new_n63_, new_n67_,
    new_n69_, new_n71_, new_n72_, new_n75_;
  ...
  assign z15 = x07 ? ~x15 : ((~new_n72_ & x22) | ~new_n71_ | (new_n72_ & ~x22));
  assign new_n71_ = ~x15 & (~x04 | ~x05);
  assign new_n72_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = x07 ? ~x15 : ((x23 & (~new_n72_ | x22)) | ~new_n71_ | (new_n72_ & ~x22 & ~x23));
  assign z17 = x07 ? ~x15 : ((x24 & (~new_n72_ | ~new_n75_)) | ~new_n71_ | (~x24 & new_n72_ & new_n75_));
  assign new_n75_ = ~x22 & ~x23;
  assign z18 = (~x25 & ~x24 & new_n72_ & new_n75_) | ~new_n63_ | (x25 & (x24 | ~new_n72_ | ~new_n75_));
endmodule
