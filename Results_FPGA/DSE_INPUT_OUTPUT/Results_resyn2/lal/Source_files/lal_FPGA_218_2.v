...
module FAU ( 
  ...
  assign z11 = ~x15 & (x07 | ((~x17 | ~x18) & (~x04 | ~x05) & (x17 | x18)));
  assign z12 = new_n62_ & (x19 | (x17 & x18)) & (~x19 | ~x17 | ~x18);
  assign z13 = (~x20 & x19 & x17 & x18) | ~new_n62_ | (x20 & (~x19 | ~x17 | ~x18));
  assign z14 = (x21 & (x20 | ~x19 | ~x17 | ~x18)) | ~new_n62_ | (~x20 & ~x21 & x19 & x17 & x18);
  assign z15 = x15 | (~x07 & ((~new_n68_ & x22) | (x04 & x05) | (new_n68_ & ~x22)));
  assign new_n68_ = x19 & x17 & x18 & ~x20 & ~x21;
  assign z16 = (x23 & (~new_n68_ | x22)) | ~new_n62_ | (new_n68_ & ~x22 & ~x23);
  assign z17 = x15 | (~x07 & (new_n71_ | new_n72_ | (x04 & x05)));
