// Benchmark "FAU" written by ABC on Wed Aug 12 18:11:52 2020
...
module FAU ( 
  ...
  assign z04 = (~x03 & (~x15 | (~x08 & x12))) | (~x08 & (~new_n55_ | ~new_n56_));
  assign new_n55_ = (x00 | ~x09) & (x02 | ~x11) & (~x00 | x09);
  ...
  assign z09 = ~x15 & (~x03 | (~x07 & x04 & x05));
  assign z10 = new_n62_ & ~x17;
  assign new_n62_ = ~x07 & (~x04 | ~x05) & x03 & ~x15;
  ...
  assign z14 = x15 | (x03 & ((~new_n67_ & x21) | ~new_n51_ | (new_n67_ & ~x21)));
  assign new_n67_ = ~x20 & x19 & x17 & x18;
  assign z15 = ((~new_n67_ | x21) & x22) | ~new_n62_ | (new_n67_ & ~x21 & ~x22);
  ...
  assign z18 = x15 | (x03 & ((~x25 & new_n67_ & new_n72_) | ~new_n51_ | (x25 & (~new_n67_ | ~new_n72_))));
