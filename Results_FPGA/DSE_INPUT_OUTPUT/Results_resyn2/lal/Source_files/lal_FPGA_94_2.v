...
module FAU ( 
  ...
  assign z01 = ~new_n50_ | ((new_n48_ | (~x25 & (~x23 | ~x24))) & (~new_n51_ | ~x24));
  ...
  assign z13 = ~new_n48_ & ((x20 & (~x19 | ~x17 | ~x18)) | ~new_n62_ | (x17 & x18 & x19 & ~x20));
  assign z14 = (~x21 & x17 & x18 & x19 & ~x20) | ~new_n62_ | (x21 & (~x17 | ~x18 | ~x19 | x20));
  assign z15 = (~x15 | x22) & ((~x15 & new_n68_ & ~x22) | ~new_n50_ | ((~new_n68_ | x15) & x22));
  assign new_n68_ = ~x21 & x17 & x18 & x19 & ~x20;
  assign z16 = (~new_n70_ & x23) | ~new_n62_ | (new_n70_ & ~x23);
  assign new_n70_ = ~x22 & ~x21 & x17 & x18 & x19 & ~x20;
  assign z17 = ((~new_n70_ | x23) & x24) | ~new_n62_ | (new_n70_ & ~x23 & ~x24);
