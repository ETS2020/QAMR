...
module FAU ( 
  ...
  assign z01 = (x17 | (~x15 & (~new_n49_ | ~new_n50_))) & (~new_n49_ | new_n51_);
  assign new_n49_ = ~x07 & (~x04 | ~x05);
  assign new_n50_ = x21 & x22 & x24 & ~x18 & ~x19;
  assign new_n51_ = ~x25 & (~x24 | (~x23 & (~x20 | ~x21 | ~x22)));
  assign z02 = x16 | (x15 & ~x17);
  assign z03 = new_n51_ & (x17 | (~new_n50_ & ~x15));
  assign z04 = ~new_n55_ & ~x08 & (~x15 | x17);
  ...
  assign z15 = ~new_n62_ | new_n69_ | ((~new_n67_ | x21) & x22);
  assign new_n69_ = x19 & x17 & x18 & ~x20 & ~x21 & ~x22;
  assign z16 = (x17 & (new_n71_ | x15)) | (~x15 & (~new_n49_ | (~new_n69_ & x23)));
  assign new_n71_ = ~x20 & ~x21 & ~x22 & x18 & x19 & ~x23;
  assign z17 = ~new_n62_ | new_n73_ | (x24 & (~new_n71_ | ~x17));
  assign new_n73_ = new_n67_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (x17 & (new_n75_ | x15)) | (~x15 & (~new_n49_ | (~new_n73_ & x25)));
