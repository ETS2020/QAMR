...
module FAU ( 
  ...
  assign z13 = x15 ? ~x04 : ((new_n67_ & ~x20) | x07 | (x04 & x05) | (~new_n67_ & x20));
  assign new_n67_ = x19 & x17 & x18;
  assign z14 = x15 ? ~x04 : ((~new_n69_ & x21) | ~new_n51_ | (new_n69_ & ~x21));
  assign new_n69_ = ~x20 & x19 & x17 & x18;
  assign z15 = x15 ? ~x04 : ((x22 & (~new_n69_ | x21)) | ~new_n51_ | (new_n69_ & ~x21 & ~x22));
  ...
  assign z18 = ~new_n48_ & ((~x25 & new_n72_ & ~x23 & ~x24) | ~new_n63_ | (x25 & (~new_n72_ | x23 | x24)));
endmodule
