...
module FAU ( 
  ...
  assign z04 = (~x11 & (~x15 | (x02 & ~x08))) | (~x08 & (~new_n55_ | ~new_n56_));
  assign new_n55_ = (x00 | ~x09) & (~x03 | x12) & (~x00 | x09);
  ...
  assign z09 = x04 & x05 & ~x15 & ~x07 & x11;
  assign z10 = new_n62_ & ~x17;
  assign new_n62_ = (~x04 | ~x05) & ~x15 & ~x07 & x11;
  assign z11 = ~x15 & (~x11 | (new_n51_ & (x17 | x18) & (~x17 | ~x18)));
  ...
  assign z18 = x15 | (x11 & ((~x25 & new_n67_ & new_n72_) | ~new_n51_ | (x25 & (~new_n67_ | ~new_n72_))));
