...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n50_, new_n51_, new_n54_, new_n55_, new_n62_, new_n65_, new_n68_,
    new_n71_;
  assign z00 = ~z02 & x08;
  ...
  assign z11 = ~x07 & (x15 | ((~x17 | ~x18) & (~x04 | ~x05) & (x17 | x18)));
  assign z12 = ~new_n65_ & ~x07;
  assign new_n65_ = ~x15 & ((~x19 & (~x17 | ~x18)) | (x04 & x05) | (x19 & x17 & x18));
  assign z13 = (~x20 & x19 & x17 & x18) | ~new_n62_ | (x20 & (~x19 | ~x17 | ~x18));
  assign z14 = x07 | (~x15 & ((~new_n68_ & x21) | (x04 & x05) | (new_n68_ & ~x21)));
  assign new_n68_ = ~x20 & x19 & x17 & x18;
  assign z15 = (x22 & (~new_n68_ | x21)) | ~new_n62_ | (~x22 & new_n68_ & ~x21);
  assign z16 = (~new_n71_ & x23) | ~new_n62_ | (new_n71_ & ~x23);
  assign new_n71_ = ~x22 & new_n68_ & ~x21;
  assign z17 = (x24 & (~new_n71_ | x23)) | ~new_n62_ | (~x24 & new_n71_ & ~x23);
  assign z18 = (~x25 & ~x24 & new_n71_ & ~x23) | ~new_n62_ | (x25 & (x24 | ~new_n71_ | x23));
endmodule
