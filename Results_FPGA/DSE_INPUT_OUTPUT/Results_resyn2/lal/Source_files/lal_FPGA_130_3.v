...
module FAU ( 
  ...
  assign new_n54_ = (~x03 | x12) & (x02 | ~x11) & (~x02 | x11) & (x03 | ~x12);
  ...
  assign z16 = (~new_n70_ & x23) | ~new_n50_ | x15 | (new_n70_ & ~x23);
  assign new_n70_ = ~x22 & x19 & x17 & x18 & ~x20 & ~x21;
  assign z17 = x15 | (new_n70_ & ~x23 & ~x24) | ~new_n50_ | (x24 & (~new_n70_ | x23));
  assign z18 = (~x25 & (x15 | (new_n70_ & ~x23 & ~x24))) | (~new_n50_ & (~x15 | ~x25)) | ((~new_n70_ | x23 | x24) & ~x15 & x25);
endmodule
