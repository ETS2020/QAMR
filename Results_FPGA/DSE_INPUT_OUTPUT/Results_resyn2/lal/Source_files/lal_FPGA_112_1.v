...
module FAU ( 
  ...
  assign z10 = ~x17 & ~new_n51_ & ~x07 & ~x15;
  assign z11 = ~new_n51_ & ~x07 & ~x15 & (x17 | x18) & (~x17 | ~x18);
  assign z12 = ~x07 & (x15 | ((x19 | (x17 & x18)) & ~new_n51_ & (~x19 | ~x17 | ~x18)));
  assign z13 = x07 | (~x15 & ((new_n66_ & ~x20) | new_n51_ | (~new_n66_ & x20)));
  assign new_n66_ = x19 & x17 & x18;
  assign z14 = x07 | (~x15 & ((x21 & (~new_n66_ | x20)) | new_n51_ | (new_n66_ & ~x20 & ~x21)));
  assign z15 = (~new_n69_ & x22) | (new_n69_ & ~x22) | new_n51_ | x07 | x15;
  assign new_n69_ = ~x20 & ~x21 & x19 & x17 & x18;
  assign z16 = x07 | (~x15 & ((x23 & (~new_n69_ | x22)) | new_n51_ | (new_n69_ & ~x22 & ~x23)));
  assign z17 = x07 | (~x15 & (new_n72_ | new_n73_ | new_n51_));
  assign new_n72_ = x24 & (~new_n69_ | x22 | x23);
  assign new_n73_ = new_n66_ & ~x20 & ~x22 & ~x23 & ~x21 & ~x24;
  assign z18 = (new_n73_ & ~x25) | new_n51_ | x07 | x15 | (~new_n73_ & x25);
endmodule
