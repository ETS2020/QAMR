...
module FAU ( 
  ...
  assign z12 = new_n48_ | ((~x19 | ~x17 | ~x18) & new_n62_ & (x19 | (x17 & x18)));
  assign z13 = (~x20 & x19 & x17 & x18) | ~new_n62_ | (x20 & (~x19 | ~x17 | ~x18));
  assign z14 = (x07 & x15) ^ ((~new_n67_ & x21) | (new_n67_ & ~x21) | ~new_n51_ | x15);
  assign new_n67_ = ~x20 & x19 & x17 & x18;
  assign z15 = (x22 & (~new_n67_ | x21)) | ~new_n62_ | (~x22 & new_n67_ & ~x21);
  assign z16 = (~new_n70_ & x23) | ~new_n62_ | (new_n70_ & ~x23);
  assign new_n70_ = ~x22 & ~x21 & ~x20 & x19 & x17 & x18;
