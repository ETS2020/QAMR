// Benchmark "FAU" written by ABC on Wed Aug 12 18:11:09 2020
...
module FAU ( 
  ...
  assign z00 = (x08 | (x06 & ~x15)) & (~x16 | (x06 & ~x15));
  ...
  assign z05 = ~x13 & ~x08 & (~x06 | x15);
  assign z06 = (x06 & ~x15) | (~x08 & x14);
  assign z07 = ~x15 | ~x06 | x08;
  assign z09 = x04 & x05 & ~x15 & ~x06 & ~x07;
  assign z10 = new_n62_ & ~x17;
  assign new_n62_ = (~x04 | ~x05) & ~x15 & ~x06 & ~x07;
  assign z11 = new_n62_ & (x17 | x18) & (~x17 | ~x18);
  assign z12 = new_n62_ & (~x19 | ~x17 | ~x18) & (x19 | (x17 & x18));
  assign z13 = x15 | (~x06 & ((new_n66_ & ~x20) | ~new_n51_ | (~new_n66_ & x20)));
  assign new_n66_ = x19 & x17 & x18;
  assign z14 = x15 | (~x06 & ((x21 & (~new_n66_ | x20)) | ~new_n51_ | (new_n66_ & ~x20 & ~x21)));
  assign z15 = x15 | (~x06 & ((~new_n69_ & x22) | ~new_n51_ | (new_n69_ & ~x22)));
  assign new_n69_ = x19 & x17 & x18 & ~x20 & ~x21;
  assign z16 = (x23 & (~new_n69_ | x22)) | ~new_n62_ | (new_n69_ & ~x22 & ~x23);
  assign z17 = x15 | (~x06 & (new_n72_ | new_n73_ | ~new_n51_));
  assign new_n72_ = x24 & (~new_n69_ | x22 | x23);
  assign new_n73_ = new_n66_ & ~x20 & ~x22 & ~x23 & ~x21 & ~x24;
  assign z18 = (new_n73_ & ~x25) | ~new_n62_ | (~new_n73_ & x25);
