...
module FAU ( 
  ...
  assign z01 = (~x25 & (~x24 | (~new_n50_ & ~x23))) | (~new_n51_ & (x00 | ~x25));
  ...
  assign z16 = (~x23 & new_n69_ & ~x22) | ~new_n65_ | (x23 & (~new_n69_ | x22));
  assign z17 = ~new_n48_ & ((x24 & (x23 | ~new_n69_ | x22)) | ~new_n62_ | (new_n69_ & ~x24 & ~x22 & ~x23));
  assign z18 = (x25 & (~x00 | ~new_n69_ | ~new_n73_)) | ~new_n62_ | (~x25 & new_n69_ & new_n73_);
