...
module FAU ( 
  ...
  assign z11 = new_n50_ & ~x15 & ~x19 & (x17 | x18) & (~x17 | ~x18);
  assign z12 = ~x15 & (x19 | (new_n50_ & x17 & x18));
  assign z13 = x15 | (~x19 & (~new_n50_ | x20));
  assign z14 = x21 | ~new_n50_ | x15 | x19;
  assign z15 = x15 | (~x19 & (~new_n50_ | x22));
  assign z16 = x15 | (~x19 & (~new_n50_ | x23));
  assign z17 = x15 | (~x19 & (~new_n50_ | x24));
  assign z18 = x15 | (~x19 & (~new_n50_ | x25));
endmodule
