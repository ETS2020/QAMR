...
module FAU ( 
  ...
  assign new_n51_ = ~x25 & ~x20 & ~x23 & (x17 | x18 | x19);
  ...
  assign z04 = (~new_n57_ | ~new_n58_) & ~x08 & (x15 | ~x17);
  ...
  assign z10 = ~x15 & (new_n50_ | x17);
  assign z11 = ~x15 & (x17 | (new_n50_ & x18));
  assign z12 = ~x15 & (x17 | (new_n50_ & x19));
  assign z13 = x20 | ~new_n50_ | x15 | x17;
  assign z14 = x15 | (~x17 & (~new_n50_ | x21));
  assign z15 = x22 | ~new_n50_ | x15 | x17;
  assign z16 = x23 | ~new_n50_ | x15 | x17;
  assign z17 = x15 | (~x17 & (~new_n50_ | x24));
  assign z18 = x15 | (~x17 & (~new_n50_ | x25));
