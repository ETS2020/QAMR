...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n48_, new_n50_, new_n51_, new_n55_, new_n56_, new_n62_, new_n68_,
    new_n69_;
  ...
  assign z04 = ~x08 & (~x07 | x10) & (~new_n56_ | ~new_n55_ | (x01 & ~x10) | (~x01 & x10));
  ...
  assign z09 = (x07 & ~x10) | (x04 & x05 & ~x07 & ~x15);
  ...
  assign z15 = new_n48_ ^ (new_n68_ | new_n69_ | ~new_n51_ | x15);
  assign new_n68_ = x22 & (x21 | x20 | ~x19 | ~x17 | ~x18);
  assign new_n69_ = ~x22 & ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = (~new_n69_ & x23) | ~new_n62_ | (new_n69_ & ~x23);
  assign z17 = ((~new_n69_ | x23) & x24) | ~new_n62_ | (new_n69_ & ~x23 & ~x24);
  assign z18 = (~x25 & new_n69_ & ~x23 & ~x24) | ~new_n62_ | (x25 & (~new_n69_ | x23 | x24));
