...
module FAU ( 
  ...
  assign z15 = x07 | (~x15 & ((x22 & (~new_n67_ | x21)) | new_n51_ | (~x22 & new_n67_ & ~x21)));
  assign z16 = x07 | (~x15 & ((~new_n70_ & x23) | new_n51_ | (new_n70_ & ~x23)));
  assign new_n70_ = ~x22 & new_n67_ & ~x21;
  assign z17 = (x24 & (~new_n70_ | x23)) | ~new_n63_ | (~x24 & new_n70_ & ~x23);
  assign z18 = (~x25 & ~x24 & new_n70_ & ~x23) | ~new_n63_ | (x25 & (x24 | ~new_n70_ | x23));
