...
module FAU ( 
  ...
  assign z13 = x07 ? ~x15 : ((new_n65_ & ~x20) | (~new_n65_ & x20) | (x04 & x05) | x15);
  assign new_n65_ = x19 & x17 & x18;
  assign z14 = (x21 & (~new_n65_ | x20)) | ~new_n61_ | new_n67_;
  assign new_n67_ = x19 & x17 & x18 & ~x20 & ~x21;
  assign z15 = x07 ? ~x15 : ((~new_n67_ & x22) | (new_n67_ & ~x22) | (x04 & x05) | x15);
  ...
  assign z18 = (new_n72_ & ~x25) | ~new_n61_ | (~new_n72_ & x25);
