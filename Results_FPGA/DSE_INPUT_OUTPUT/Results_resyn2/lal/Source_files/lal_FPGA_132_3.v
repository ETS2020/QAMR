...
module FAU ( 
  ...
  assign z13 = x07 ? ~x15 : ((new_n67_ & ~x20) | (~new_n67_ & x20) | x15 | (x04 & x05));
  assign new_n67_ = x19 & x17 & x18;
  assign z14 = x07 ? ~x15 : ((~new_n69_ & x21) | (new_n69_ & ~x21) | x15 | (x04 & x05));
  ...
  assign z17 = x07 ? ~x15 : ((x24 & (~new_n71_ | ~new_n74_)) | new_n61_ | x15 | (~x24 & new_n71_ & new_n74_));
