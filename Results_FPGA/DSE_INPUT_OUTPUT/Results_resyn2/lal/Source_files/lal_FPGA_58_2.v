...
module FAU ( 
  ...
  assign new_n62_ = ~x15 & ~x05 & ~x07;
  assign z12 = ~x15 & (x05 | ((x19 | (x17 & x18)) & ~x07 & (~x19 | ~x17 | ~x18)));
  assign z13 = x15 | (~x05 & ((new_n65_ & ~x20) | x07 | (~new_n65_ & x20)));
  assign new_n65_ = x19 & x17 & x18;
  assign z14 = x15 | (~x05 & ((x21 & (~new_n65_ | x20)) | x07 | (~x21 & new_n65_ & ~x20)));
  assign z15 = x15 | (~x05 & ((~new_n68_ & x22) | x07 | (new_n68_ & ~x22)));
