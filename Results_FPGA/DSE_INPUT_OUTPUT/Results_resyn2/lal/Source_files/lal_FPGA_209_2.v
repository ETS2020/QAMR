...
module FAU ( 
  ...
  assign z01 = (~new_n48_ & ~new_n51_) | (~new_n48_ & ~x25 & (~x24 | (~new_n50_ & ~x23)));
  ...
  assign z15 = x15 | (~x07 & ((x22 & (~new_n69_ | x21)) | new_n65_ | (new_n69_ & ~x21 & ~x22)));
  assign z16 = (~new_n72_ & x23) | (new_n72_ & ~x23) | ~new_n51_ | x15;
  assign new_n72_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = x15 | (~x07 & ((x24 & (~new_n72_ | x23)) | new_n65_ | (new_n72_ & ~x23 & ~x24)));
  assign z18 = x15 | (~x07 & ((~x25 & new_n72_ & new_n75_) | new_n65_ | (x25 & (~new_n72_ | ~new_n75_))));
