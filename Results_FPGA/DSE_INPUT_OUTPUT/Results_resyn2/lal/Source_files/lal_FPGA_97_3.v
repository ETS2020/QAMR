...
module FAU ( 
  ...
  assign z15 = x07 ? ~x15 : ((x22 & (~new_n68_ | x21)) | ~new_n70_ | (new_n68_ & ~x21 & ~x22));
  assign new_n70_ = ~x15 & (~x04 | ~x05);
  assign z16 = x07 ? ~x15 : ((~new_n72_ & x23) | ~new_n70_ | (new_n72_ & ~x23));
  assign new_n72_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = x07 ? ~x15 : ((x24 & (~new_n72_ | x23)) | ~new_n70_ | (new_n72_ & ~x23 & ~x24));
  assign z18 = x07 ? ~x15 : ((~x25 & new_n72_ & new_n75_) | ~new_n70_ | (x25 & (~new_n72_ | ~new_n75_)));
