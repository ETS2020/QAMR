...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n55_, new_n56_, new_n61_, new_n62_,
    new_n66_, new_n71_, new_n72_, new_n75_;
  ...
  assign z12 = (x15 & x19) | ((x19 | (~x15 & x17 & x18)) & new_n50_ & (~x19 | ~x17 | ~x18));
  assign z13 = (~x15 | ~x19) & ((~x20 & x19 & x17 & x18) | ~new_n50_ | ((~x19 | ~x17 | ~x18) & (x15 | x20)));
  assign z14 = (x21 & (x20 | ~x19 | ~x17 | ~x18)) | ~new_n66_ | (~x20 & ~x21 & x19 & x17 & x18);
  assign z15 = (~x19 & (x15 | x22)) | (~x15 & (new_n71_ | ~new_n50_ | (~new_n72_ & x22)));
  assign new_n71_ = ~x22 & ~x20 & ~x21 & x19 & x17 & x18;
  assign new_n72_ = x17 & x18 & ~x20 & ~x21;
  assign z16 = (~x19 & (x15 | x23)) | (~x15 & ((x23 & (~new_n72_ | x22)) | ~new_n50_ | (new_n72_ & ~x23 & x19 & ~x22)));
  assign z17 = (new_n71_ & ~x23 & ~x24) | ~new_n66_ | (x24 & (~new_n72_ | ~new_n75_ | x23));
