...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n55_, new_n56_, new_n61_, new_n62_,
    new_n67_, new_n71_, new_n73_, new_n75_, new_n76_;
  ...
  assign new_n51_ = (x19 | x17 | x18) & (~x15 | ~x19) & ~x20 & ~x23;
  ...
  assign z08 = (~new_n61_ & (~x15 | ~x19)) | (new_n62_ & ~x19 & ~x17 & ~x18);
  ...
  assign z12 = (x15 & x19) | ((x19 | (new_n67_ & ~x15)) & new_n50_ & (~new_n67_ | ~x19));
  assign new_n67_ = x17 & x18;
  assign z13 = (~x15 | ~x19) & ((new_n67_ & x19 & ~x20) | ~new_n50_ | ((~new_n67_ | ~x19) & (x15 | x20)));
  assign z14 = (x21 & (~new_n67_ | ~x19 | x20)) | ~new_n50_ | x15 | (new_n67_ & x19 & ~x20 & ~x21);
  assign z15 = (~x19 & (x15 | x22)) | (~x15 & ((new_n71_ & ~x22 & new_n67_ & x19) | ~new_n50_ | (x22 & (~new_n67_ | ~new_n71_))));
  assign new_n71_ = ~x20 & ~x21;
  assign z16 = (~new_n73_ & ~x15) | (~x19 & (x15 | x23));
  assign new_n73_ = (~x23 | (new_n67_ & new_n71_ & ~x22)) & new_n50_ & (~x19 | x22 | x23 | ~new_n67_ | ~new_n71_);
  assign z17 = (~x19 & (x15 | x24)) | (~x15 & ((new_n76_ & x19) | ~new_n50_ | (~new_n75_ & x24)));
  assign new_n75_ = new_n67_ & new_n71_ & ~x22 & ~x23;
  assign new_n76_ = new_n71_ & ~x24 & new_n67_ & ~x22 & ~x23;
