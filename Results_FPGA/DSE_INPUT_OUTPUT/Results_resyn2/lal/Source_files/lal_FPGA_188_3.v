...
module FAU ( 
  ...
  assign z08 = (x20 & x23) | x25 | (x24 & (new_n50_ | x23));
  ...
  assign z14 = ((~new_n66_ | x20) & (x21 | (x20 & x23))) | ~new_n62_ | (~x21 & new_n66_ & ~x20);
  assign z15 = (x22 & (~new_n66_ | x21)) | (~x21 & ~x22 & new_n66_ & ~x20) | ~new_n62_ | (x20 & (x22 | x23));
  assign z16 = (~new_n62_ & (~x20 | ~x23)) | (~x20 & (new_n70_ | (~new_n71_ & x23)));
  assign new_n70_ = ~x22 & ~x23 & new_n66_ & ~x21;
  assign new_n71_ = ~x21 & ~x22 & x19 & x17 & x18;
  assign z17 = (new_n73_ & ~x23 & ~x24) | (~new_n70_ & x24) | ~new_n62_ | (x20 & (x23 | x24));
  assign new_n73_ = ~x21 & ~x22 & new_n66_ & ~x20;
  assign z18 = ~new_n75_ | (~x23 & ((new_n73_ & ~x24 & ~x25) | (x20 & x25)));
  assign new_n75_ = (new_n62_ | (x20 & (x23 | x25))) & ((new_n71_ & ~x23 & ~x24) | x20 | ~x25);
endmodule
