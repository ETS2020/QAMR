...
module FAU ( 
  ...
  assign z16 = x07 | (~x15 & ((~new_n71_ & x23) | (x04 & x05) | (new_n71_ & ~x23)));
  assign new_n71_ = new_n69_ & ~x22;
  assign z17 = (x24 & (~new_n71_ | x23)) | ~new_n61_ | (~x24 & new_n71_ & ~x23);
  assign z18 = (~x25 & ~x24 & new_n71_ & ~x23) | ~new_n61_ | (x25 & (x24 | ~new_n71_ | x23));
