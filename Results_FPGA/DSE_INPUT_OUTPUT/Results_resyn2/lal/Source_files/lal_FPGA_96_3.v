...
module FAU ( 
  ...
  assign z15 = (~x21 & (x15 | (new_n68_ & ~x22))) | (~x15 & (~new_n51_ | (x22 & (~new_n68_ | x21))));
  assign z16 = (~x21 & (x15 | (~x23 & new_n68_ & ~x22))) | (~x15 & (~new_n51_ | (x23 & (x22 | ~new_n68_ | x21))));
  assign z17 = (~x21 & (x15 | (~x24 & new_n72_ & ~x23))) | (~x15 & (~new_n51_ | (x24 & (~new_n72_ | x21 | x23))));
  assign new_n72_ = ~x22 & ~x20 & x19 & x17 & x18;
  assign z18 = (~x25 & new_n74_ & ~x23 & ~x24) | ~new_n63_ | (x25 & (~new_n74_ | x23 | x24));
  assign new_n74_ = ~x22 & ~x21 & ~x20 & x19 & x17 & x18;
endmodule
