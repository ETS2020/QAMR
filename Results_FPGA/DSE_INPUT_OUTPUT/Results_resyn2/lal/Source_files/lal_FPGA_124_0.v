...
module FAU ( 
  ...
  assign z10 = ~x17 & new_n63_ & x04 & ~x15;
  assign new_n63_ = ~x05 & ~x07;
  assign z11 = ~x15 & (~x04 | ((~x17 | ~x18) & new_n63_ & (x17 | x18)));
  assign z12 = ~x15 & (~x04 | ((x19 | (x17 & x18)) & new_n63_ & (~x19 | ~x17 | ~x18)));
  assign z13 = x15 | (~new_n67_ & x04);
  assign new_n67_ = (x20 | ~x19 | ~x17 | ~x18) & ~x05 & ~x07 & (~x20 | (x19 & x17 & x18));
  assign z14 = x15 | (x04 & ((~new_n69_ & x21) | ~new_n63_ | (new_n69_ & ~x21)));
  assign new_n69_ = ~x20 & x19 & x17 & x18;
  assign z15 = x15 | (x04 & ((x22 & (~new_n69_ | x21)) | ~new_n63_ | (new_n69_ & ~x21 & ~x22)));
  assign z16 = (~new_n72_ & x23) | (new_n72_ & ~x23) | ~new_n63_ | ~x04 | x15;
  assign new_n72_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = (x24 & (~new_n72_ | x23)) | (new_n72_ & ~x23 & ~x24) | ~new_n63_ | ~x04 | x15;
  assign z18 = x15 | (x04 & ((~x25 & new_n72_ & new_n75_) | ~new_n63_ | (x25 & (~new_n72_ | ~new_n75_))));
