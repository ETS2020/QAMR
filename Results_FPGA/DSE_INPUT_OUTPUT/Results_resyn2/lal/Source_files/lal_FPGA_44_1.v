// Benchmark "FAU" written by ABC on Wed Aug 12 18:10:53 2020
...
module FAU ( 
  ...
  assign z04 = (~x08 | (~x09 & x15)) & (~new_n55_ | ~new_n56_ | (~x09 & (x00 | x15)));
  assign new_n55_ = (x03 | ~x12) & (~x01 | x10) & (~x03 | x12);
  assign new_n56_ = (~x02 | x11) & (x00 | ~x09) & (x01 | ~x10) & (x02 | ~x11);
  ...
  assign z13 = x15 ? x09 : ((new_n67_ & ~x20) | ~new_n51_ | (~new_n67_ & x20));
  ...
  assign z17 = x15 ? x09 : ((x24 & (~new_n69_ | ~new_n73_)) | ~new_n51_ | (~x24 & new_n69_ & new_n73_));
