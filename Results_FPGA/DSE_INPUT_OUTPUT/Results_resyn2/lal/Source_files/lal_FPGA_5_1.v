...
module FAU ( 
  ...
  assign z10 = ~x17 & ~x07 & ~new_n51_ & ~x15;
  ...
  assign z15 = x07 | (~x15 & ((~new_n69_ & x22) | new_n51_ | (new_n69_ & ~x22)));
  assign new_n69_ = ~x20 & ~x21 & x19 & x17 & x18;
  assign z16 = (x23 & (~new_n69_ | x22)) | (new_n69_ & ~x22 & ~x23) | x07 | new_n51_ | x15;
  ...
  assign z18 = (new_n73_ & ~x25) | x07 | new_n51_ | x15 | (~new_n73_ & x25);
endmodule
