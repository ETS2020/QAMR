...
module FAU ( 
  ...
  assign z11 = ~x15 & (x22 | (new_n50_ & (x17 | x18) & (~x17 | ~x18)));
  ...
  assign new_n68_ = (~x04 | ~x05) & ~x22 & ~x07 & ~x15;
  assign z15 = ~new_n68_ | new_n70_;
  assign new_n70_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = x15 | (~x22 & ((~new_n70_ & x23) | ~new_n50_ | (new_n70_ & ~x23)));
  assign z17 = (~new_n73_ & x24) | ~new_n68_ | (new_n73_ & ~x24);
  assign new_n73_ = ~x23 & ~x21 & ~x20 & x19 & x17 & x18;
  assign z18 = (~x25 & new_n73_ & ~x24) | ~new_n68_ | (x25 & (~new_n73_ | x24));
endmodule
