...
module FAU ( 
  ...
  assign z11 = ~x15 & (x07 | ((~x17 | ~x18) & ~new_n65_ & (x17 | x18)));
  assign new_n65_ = x04 & x05;
  assign z12 = ~x15 & (x07 | ((x19 | (x17 & x18)) & ~new_n65_ & (~x19 | ~x17 | ~x18)));
  assign z13 = x15 | (~x07 & ((new_n68_ & ~x20) | new_n65_ | (~new_n68_ & x20)));
  assign new_n68_ = x19 & x17 & x18;
  assign z14 = x15 | (~x07 & ((x21 & (~new_n68_ | x20)) | new_n65_ | (new_n68_ & ~x20 & ~x21)));
  assign z15 = x15 | (~x07 & ((~new_n71_ & x22) | new_n65_ | (new_n71_ & ~x22)));
  assign new_n71_ = ~x20 & ~x21 & x19 & x17 & x18;
  assign z16 = x15 | (~x07 & ((x23 & (~new_n71_ | x22)) | new_n65_ | (new_n71_ & ~x22 & ~x23)));
  assign z17 = x15 | (~x07 & ((x24 & (~new_n71_ | ~new_n74_)) | new_n65_ | (~x24 & new_n71_ & new_n74_)));
