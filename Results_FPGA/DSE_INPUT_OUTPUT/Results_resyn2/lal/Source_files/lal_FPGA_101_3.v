...
module FAU ( 
  ...
  assign z01 = (~new_n50_ & (~x23 | ~x25)) | (~x25 & (~x24 | (~new_n51_ & ~x23)));
  ...
  assign z10 = (new_n48_ | new_n62_) & (new_n48_ | ~x17);
  assign new_n62_ = (~x04 | ~x05) & ~x07 & ~x15;
  assign z11 = new_n64_ & (x17 | x18) & (~x17 | ~x18);
  assign new_n64_ = (~x23 | ~x25) & (~x04 | ~x05) & ~x07 & ~x15;
  ...
  assign z16 = ((~new_n69_ | x22) & x23 & ~x25) | (~new_n62_ & (~x23 | ~x25)) | (new_n69_ & ~x22 & ~x23);
  assign z17 = (~x23 & (((~new_n69_ | x22) & x24) | (new_n69_ & ~x22 & ~x24))) | ((~x23 | ~x25) & (~new_n62_ | (x23 & x24)));
  assign z18 = (~new_n62_ & (~x23 | ~x25)) | ((~x25 | ~new_n69_ | x22 | x24) & ~x23 & (x25 | (new_n69_ & ~x22 & ~x24)));
