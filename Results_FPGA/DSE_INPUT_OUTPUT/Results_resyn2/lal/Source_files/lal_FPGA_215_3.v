...
module FAU ( 
  ...
  assign z01 = (~x25 & (~x24 | (~new_n50_ & ~x23))) | new_n51_ | x07 | (x23 & x25);
  assign new_n50_ = (x20 | (~x19 & ~x17 & ~x18)) & x21 & x22;
  assign new_n51_ = x04 & x05;
  assign z02 = new_n48_ | x16;
  assign z03 = x25 ? x23 : (~x24 | (~new_n50_ & ~x23));
  ...
  assign z09 = new_n48_ | (new_n51_ & ~x07 & ~x15);
  assign z10 = ~x17 & ~new_n48_ & new_n63_;
  ...
  assign z13 = (~x20 & x19 & x17 & x18) | new_n48_ | ~new_n63_ | (x20 & (~x19 | ~x17 | ~x18));
  assign z14 = ~new_n48_ & ((~new_n68_ & x21) | ~new_n63_ | (new_n68_ & ~x21));
  assign new_n68_ = ~x20 & x19 & x17 & x18;
  assign z15 = ~new_n48_ & ((x22 & (~new_n68_ | x21)) | ~new_n63_ | (new_n68_ & ~x21 & ~x22));
  assign z16 = (x23 & (x25 | ~new_n68_ | ~new_n71_)) | ~new_n63_ | (new_n68_ & new_n71_ & ~x23);
  assign new_n71_ = ~x21 & ~x22;
  assign z17 = ((~x23 | ~x25) & (~new_n63_ | (x23 & x24))) | ((~x24 | ~new_n68_ | ~new_n71_) & ~x23 & (x24 | (new_n68_ & new_n71_)));
  assign z18 = (~x25 & ~x24 & new_n68_ & new_n71_ & ~x23) | ~new_n63_ | (x25 & (x24 | ~new_n68_ | ~new_n71_ | x23));
endmodule
