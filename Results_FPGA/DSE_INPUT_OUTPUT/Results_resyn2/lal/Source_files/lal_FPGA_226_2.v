...
module FAU ( 
  ...
  assign z16 = x15 ? x16 : ((x23 & (~new_n69_ | x22)) | ~new_n51_ | (new_n69_ & ~x22 & ~x23));
  assign z17 = x15 ? x16 : ~new_n72_;
  assign new_n72_ = (~x24 | (new_n67_ & ~x21 & ~x22 & ~x23)) & new_n51_ & (~new_n67_ | x22 | x23 | x21 | x24);
  assign z18 = (~x15 | x16) & ((~x25 & new_n67_ & new_n74_) | ~new_n51_ | x15 | (x25 & (~new_n67_ | ~new_n74_)));
