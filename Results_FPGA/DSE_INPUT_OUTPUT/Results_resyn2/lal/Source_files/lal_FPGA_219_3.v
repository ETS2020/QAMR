...
module FAU ( 
  ...
  assign z12 = (x07 & x15) | ((~x19 | ~x17 | ~x18) & new_n62_ & (x19 | (x17 & x18)));
  assign z13 = (~x20 & x19 & x17 & x18) | ~new_n62_ | (x20 & (~x19 | ~x17 | ~x18));
  assign z14 = x07 ? ~x15 : ((~new_n67_ & x21) | x15 | (x04 & x05) | (new_n67_ & ~x21));
  ...
  assign z17 = x07 ? ~x15 : ((~new_n72_ & x24) | x15 | (x04 & x05) | (new_n72_ & ~x24));
