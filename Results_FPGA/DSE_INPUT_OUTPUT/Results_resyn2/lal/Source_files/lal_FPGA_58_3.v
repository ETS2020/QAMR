// Benchmark "FAU" written by ABC on Wed Aug 12 18:11:00 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n48_, new_n50_, new_n51_, new_n55_, new_n56_, new_n62_, new_n66_,
    new_n68_, new_n70_;
  assign z00 = (new_n48_ | ~x16) & (new_n48_ | x08);
  assign new_n48_ = x05 & x15;
  ...
  assign z12 = new_n48_ | (new_n62_ & (~x19 | ~x17 | ~x18) & (x19 | (x17 & x18)));
  assign z13 = x15 ? ~x05 : ((new_n66_ & ~x20) | x07 | (x04 & x05) | (~new_n66_ & x20));
  assign new_n66_ = x19 & x17 & x18;
  assign z14 = x15 ? ~x05 : ((~new_n68_ & x21) | (new_n68_ & ~x21) | x07 | (x04 & x05));
  assign new_n68_ = ~x20 & x19 & x17 & x18;
  assign z15 = x15 ? ~x05 : ((~new_n70_ & x22) | ~new_n51_ | (new_n70_ & ~x22));
  assign new_n70_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = x15 ? ~x05 : ((x23 & (~new_n70_ | x22)) | ~new_n51_ | (new_n70_ & ~x22 & ~x23));
  assign z17 = (x24 & (~new_n70_ | x22 | x23)) | ~new_n62_ | (~x24 & new_n70_ & ~x22 & ~x23);
  assign z18 = (~x25 & ~x24 & new_n70_ & ~x22 & ~x23) | ~new_n62_ | (x25 & (x24 | ~new_n70_ | x22 | x23));
