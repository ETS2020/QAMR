...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n55_, new_n56_, new_n61_, new_n63_,
    new_n67_, new_n69_, new_n72_, new_n75_;
  ...
  assign z14 = x07 ? ~x15 : ((~new_n69_ & x21) | new_n61_ | x15 | (new_n69_ & ~x21));
  assign new_n69_ = ~x20 & x19 & x17 & x18;
  assign z15 = (x22 & (~new_n69_ | x21)) | ~new_n63_ | (new_n69_ & ~x21 & ~x22);
  assign z16 = x07 ? ~x15 : ((~new_n72_ & x23) | new_n61_ | x15 | (new_n72_ & ~x23));
  assign new_n72_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = (x24 & (~new_n72_ | x23)) | ~new_n63_ | (new_n72_ & ~x23 & ~x24);
  assign z18 = x07 ? ~x15 : ((~x25 & new_n72_ & new_n75_) | new_n61_ | x15 | (x25 & (~new_n72_ | ~new_n75_)));
