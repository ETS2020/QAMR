...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n51_, new_n55_, new_n56_, new_n68_, new_n71_,
    new_n72_, new_n73_;
  ...
  assign z14 = (x21 & (x20 | ~x19 | ~x17 | ~x18)) | ~new_n51_ | (x19 & x17 & x18 & ~x20 & ~x21);
  assign z15 = x07 | (~x15 & ((~new_n68_ & x22) | (x04 & x05) | (new_n68_ & ~x22)));
  assign new_n68_ = x19 & x17 & x18 & ~x20 & ~x21;
  assign z16 = (x23 & (~new_n68_ | x22)) | ~new_n51_ | (new_n68_ & ~x22 & ~x23);
  assign z17 = x07 | (~x15 & (new_n71_ | new_n72_ | (x04 & x05)));
  assign new_n71_ = x24 & (~new_n68_ | x22 | x23);
  assign new_n72_ = new_n73_ & ~x20 & x19 & x17 & x18;
  assign new_n73_ = ~x22 & ~x23 & ~x21 & ~x24;
  assign z18 = (new_n72_ & ~x25) | ~new_n51_ | (~new_n72_ & x25);
endmodule
