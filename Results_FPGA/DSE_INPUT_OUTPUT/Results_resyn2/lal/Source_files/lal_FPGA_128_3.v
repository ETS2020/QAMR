...
module FAU ( 
  ...
  assign z08 = x25 ? ~x20 : (x24 & (new_n50_ | x23));
  ...
  assign z13 = (~x20 | ~x25) & ((~new_n67_ & x20) | ~new_n63_ | (new_n67_ & ~x20));
  assign new_n67_ = x19 & x17 & x18;
  assign z14 = (~new_n69_ & (new_n48_ | x21)) | ~new_n63_ | (new_n69_ & ~x21);
  assign new_n69_ = ~x20 & x19 & x17 & x18;
  assign z15 = (x22 & (~new_n67_ | x21)) | (new_n67_ & ~x20 & ~x21 & ~x22) | ~new_n63_ | (x20 & (x22 | x25));
  assign z16 = ~new_n48_ & ((~x23 & new_n69_ & new_n72_) | ~new_n63_ | (x23 & (~new_n69_ | ~new_n72_)));
  assign new_n72_ = ~x21 & ~x22;
  assign z17 = ((x23 | ~new_n69_ | ~new_n72_) & (new_n48_ | x24)) | ~new_n63_ | (new_n69_ & new_n72_ & ~x23 & ~x24);
  assign z18 = (~x25 & new_n69_ & new_n72_ & ~x23 & ~x24) | ~new_n63_ | (x25 & (~new_n69_ | ~new_n72_ | x23 | x24));
endmodule
