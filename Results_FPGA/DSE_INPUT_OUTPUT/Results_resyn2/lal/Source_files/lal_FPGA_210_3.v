...
module FAU ( 
  ...
  assign new_n48_ = x21 & x25;
  assign z01 = (~new_n50_ & (~x21 | ~x25)) | (~x25 & (~x24 | (~new_n51_ & ~x23)));
  assign new_n50_ = ~x07 & (~x04 | ~x05);
  assign new_n51_ = (x20 | (~x19 & ~x17 & ~x18)) & x21 & x22;
  assign z02 = ~new_n48_ & x16;
  assign z08 = x25 ? ~x21 : (x24 & (new_n51_ | x23));
  ...
  assign z14 = (~x21 | ~x25) & ((~new_n67_ & x21) | ~new_n62_ | (new_n67_ & ~x21));
  assign new_n67_ = ~x20 & x19 & x17 & x18;
  assign z15 = new_n48_ | (new_n69_ & ~x22) | ~new_n62_ | (~new_n69_ & x22);
  assign new_n69_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = (~x23 & (new_n48_ | (new_n69_ & ~x22))) | ~new_n62_ | (x23 & (~new_n69_ | x22));
  assign z17 = ((new_n48_ | x24) & (~new_n69_ | x22 | x23)) | ~new_n62_ | (new_n69_ & ~x24 & ~x22 & ~x23);
  assign z18 = (~x25 & new_n69_ & ~x24 & ~x22 & ~x23) | ~new_n62_ | (x25 & (~new_n69_ | x24 | x22 | x23));
  assign z03 = x25 ? x21 : (~x24 | (~new_n51_ & ~x23));
endmodule
