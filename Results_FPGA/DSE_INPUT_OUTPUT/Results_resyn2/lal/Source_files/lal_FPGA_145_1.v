...
module FAU ( 
  ...
  assign new_n65_ = (~x04 | ~x05) & ~x16 & ~x07 & ~x15;
  assign z14 = x15 | (~x16 & ((x21 & (~new_n64_ | x20)) | ~new_n51_ | (new_n64_ & ~x20 & ~x21)));
  assign z15 = (~new_n68_ & x22) | ~new_n65_ | (new_n68_ & ~x22);
  assign new_n68_ = ~x20 & ~x21 & x19 & x17 & x18;
  assign z16 = (x23 & (~new_n68_ | x22)) | ~new_n65_ | (new_n68_ & ~x22 & ~x23);
  ...
  assign z18 = (new_n72_ & ~x25) | ~new_n65_ | (~new_n72_ & x25);
