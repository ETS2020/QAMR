...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n50_, new_n51_, new_n54_, new_n55_, new_n61_, new_n65_, new_n69_,
    new_n72_;
  assign z00 = ~z02 & x08;
  ...
  assign z13 = x07 | (~x15 & ((new_n65_ & ~x20) | (x04 & x05) | (~new_n65_ & x20)));
  assign new_n65_ = x19 & x17 & x18;
  assign z14 = (x21 & (~new_n65_ | x20)) | ~new_n61_ | (~x21 & new_n65_ & ~x20);
  assign z15 = (x22 & (x21 | ~new_n65_ | x20)) | ~new_n61_ | (new_n65_ & ~x20 & ~x21 & ~x22);
  assign z16 = x07 | (~x15 & ((~new_n69_ & x23) | (x04 & x05) | (new_n69_ & ~x23)));
  assign new_n69_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = (x24 & (~new_n69_ | x23)) | ~new_n61_ | (new_n69_ & ~x23 & ~x24);
  assign z18 = x07 | (~new_n72_ & ~x15);
  assign new_n72_ = (x25 | ~new_n69_ | x23 | x24) & (~x04 | ~x05) & (~x25 | (new_n69_ & ~x23 & ~x24));
