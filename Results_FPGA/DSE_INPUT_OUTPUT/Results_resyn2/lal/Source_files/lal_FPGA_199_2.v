...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n48_, new_n50_, new_n51_, new_n55_, new_n56_, new_n61_, new_n66_,
  ...
  assign z10 = ~x15 & (x07 | (~new_n61_ & ~x17));
  assign z11 = new_n50_ & ~x15 & (x17 | x18) & (~x17 | ~x18);
  assign z12 = ~x15 & (x07 | ((x19 | (x17 & x18)) & ~new_n61_ & (~x19 | ~x17 | ~x18)));
  assign z13 = x15 | (~new_n66_ & ~x07);
  assign new_n66_ = (x20 | ~x19 | ~x17 | ~x18) & (~x04 | ~x05) & (~x20 | (x19 & x17 & x18));
  assign z14 = (~new_n68_ & x21) | (new_n68_ & ~x21) | ~new_n50_ | x15;
  assign new_n68_ = ~x20 & x19 & x17 & x18;
  assign z15 = (x22 & (~new_n68_ | x21)) | x15 | new_n61_ | x07 | (new_n68_ & ~x21 & ~x22);
  ...
  assign z18 = x15 | (~x07 & ((~x25 & new_n71_ & new_n74_) | new_n61_ | (x25 & (~new_n71_ | ~new_n74_))));
