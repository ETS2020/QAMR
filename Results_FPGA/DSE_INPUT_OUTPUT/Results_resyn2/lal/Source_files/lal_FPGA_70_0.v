...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n48_, new_n50_, new_n51_, new_n55_, new_n56_, new_n64_, new_n67_,
    new_n69_, new_n74_;
  ...
  assign z09 = x04 & x05 & ~x15 & ~x07 & x14;
  assign z10 = ~x15 & (~x14 | (new_n51_ & ~x17));
  assign z11 = new_n64_ & (x17 | x18) & (~x17 | ~x18);
  assign new_n64_ = (~x04 | ~x05) & ~x15 & ~x07 & x14;
  assign z12 = ~x15 & (~x14 | ((x19 | (x17 & x18)) & new_n51_ & (~x19 | ~x17 | ~x18)));
  assign z13 = x15 | (x14 & ((new_n67_ & ~x20) | ~new_n51_ | (~new_n67_ & x20)));
  assign new_n67_ = x19 & x17 & x18;
  assign z14 = x15 | (x14 & ((~new_n69_ & x21) | ~new_n51_ | (new_n69_ & ~x21)));
  assign new_n69_ = ~x20 & x19 & x17 & x18;
  assign z15 = x15 | (x14 & ((x22 & (~new_n69_ | x21)) | ~new_n51_ | (new_n69_ & ~x21 & ~x22)));
  ...
  assign z18 = x15 | (x14 & ((~x25 & new_n69_ & new_n74_) | ~new_n51_ | (x25 & (~new_n69_ | ~new_n74_))));
