...
module FAU ( 
  ...
  assign z13 = x15 ? x16 : ((new_n66_ & ~x20) | ~new_n50_ | (~new_n66_ & x20));
  ...
  assign z16 = (x23 & (~new_n68_ | x21 | x22)) | ~new_n62_ | (~x23 & new_n68_ & ~x21 & ~x22);
  assign z17 = (x24 & (x23 | ~new_n68_ | x21 | x22)) | ~new_n62_ | (new_n68_ & ~x21 & ~x22 & ~x23 & ~x24);
  assign z18 = ~new_n49_ & ((~x25 & new_n68_ & new_n73_) | ~new_n62_ | (x25 & (~new_n68_ | ~new_n73_)));
