...
module FAU ( 
  ...
  assign z14 = (~new_n67_ & x21) | new_n51_ | x07 | x15 | (new_n67_ & ~x21);
  assign new_n67_ = ~x20 & x19 & x17 & x18;
  assign z15 = (x22 & (~new_n67_ | x21)) | new_n51_ | x07 | x15 | (new_n67_ & ~x21 & ~x22);
  assign z16 = (~new_n70_ & x23) | new_n51_ | x07 | x15 | (new_n70_ & ~x23);
  assign new_n70_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = (x24 & (~new_n70_ | x23)) | new_n51_ | x07 | x15 | (new_n70_ & ~x23 & ~x24);
