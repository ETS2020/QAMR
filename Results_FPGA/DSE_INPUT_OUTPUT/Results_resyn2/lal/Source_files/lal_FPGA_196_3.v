...
module FAU ( 
  ...
  assign z01 = (~x25 & (~x24 | (~new_n50_ & ~x23))) | ~new_n51_ | (x22 & x25);
  ...
  assign z08 = x25 ? ~x22 : ((new_n50_ | x23) & x24);
  ...
  assign new_n66_ = (~x04 | ~x05) & (~x22 | ~x25) & ~x07 & ~x15;
  assign z13 = ~new_n48_ & ((~x20 & x19 & x17 & x18) | ~new_n63_ | (x20 & (~x19 | ~x17 | ~x18)));
  assign z14 = (x21 & (x20 | ~x19 | ~x17 | ~x18)) | ~new_n66_ | (x19 & x17 & x18 & ~x20 & ~x21);
  assign z15 = (~x22 & (~new_n63_ | new_n70_)) | (~x25 & ((~new_n63_ & ~x21) | (~new_n70_ & x22)));
  assign new_n70_ = ~x20 & ~x21 & x19 & x17 & x18;
  assign z16 = (~x22 & new_n70_ & ~x23) | (x23 & (~new_n70_ | x22)) | ~new_n63_ | (x22 & x25);
  assign z17 = ((~x22 | ~x25) & (~new_n63_ | (x22 & x24))) | ((~x24 | ~new_n70_ | x23) & ~x22 & (x24 | (new_n70_ & ~x23)));
