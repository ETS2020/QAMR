...
module FAU ( 
  ...
  assign z13 = x15 | (~x07 & ((new_n67_ & ~x20) | new_n66_ | (~new_n67_ & x20)));
  assign new_n66_ = x04 & x05;
  assign new_n67_ = x19 & x17 & x18;
  assign z14 = (x21 & (~new_n67_ | x20)) | ~new_n62_ | (~x21 & new_n67_ & ~x20);
  assign z15 = (x22 & (x21 | ~new_n67_ | x20)) | ~new_n62_ | (new_n67_ & ~x20 & ~x21 & ~x22);
  assign z16 = x15 | (~x07 & ((~new_n71_ & x23) | new_n66_ | (new_n71_ & ~x23)));
  assign new_n71_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = (x24 & (~new_n71_ | x23)) | ~new_n62_ | (new_n71_ & ~x23 & ~x24);
  assign z18 = x15 | (~x07 & ((~x25 & new_n71_ & new_n74_) | new_n66_ | (x25 & (~new_n71_ | ~new_n74_))));
