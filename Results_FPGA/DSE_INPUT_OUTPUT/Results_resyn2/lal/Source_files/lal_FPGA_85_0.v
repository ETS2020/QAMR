...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n54_, new_n55_, new_n57_, new_n58_,
    new_n65_, new_n70_, new_n73_, new_n76_, new_n77_;
  ...
  assign z09 = x04 & x05 & ~x07 & ~x15 & x19;
  assign z10 = new_n65_ & ~x17;
  assign new_n65_ = (~x04 | ~x05) & ~x07 & ~x15 & x19;
  assign z11 = ~x15 & (~x19 | (new_n51_ & (x17 | x18) & (~x17 | ~x18)));
  assign z12 = new_n65_ & (~x17 | ~x18);
  assign z13 = ~new_n65_ | (x20 & (~x17 | ~x18)) | (~x20 & x17 & x18);
  assign z14 = x15 | (x19 & ((new_n70_ & ~x21) | ~new_n51_ | (~new_n70_ & x21)));
  assign new_n70_ = ~x20 & x17 & x18;
  assign z15 = x15 | (x19 & ((x22 & (~new_n70_ | x21)) | ~new_n51_ | (new_n70_ & ~x21 & ~x22)));
  assign z16 = (~new_n73_ & x23) | ~new_n65_ | (new_n73_ & ~x23);
  assign new_n73_ = new_n70_ & ~x21 & ~x22;
  assign z17 = x15 | (x19 & ((x24 & (~new_n73_ | x23)) | ~new_n51_ | (new_n73_ & ~x23 & ~x24)));
  assign z18 = x15 | (~new_n76_ & x19);
  assign new_n76_ = (~x25 | (new_n77_ & new_n70_ & ~x21 & ~x22)) & new_n51_ & (~new_n70_ | x21 | ~new_n77_ | x22 | x25);
