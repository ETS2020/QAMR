...
module FAU ( 
  ...
  assign z11 = ~x15 & (x07 | ((~x17 | ~x18) & ~new_n61_ & (x17 | x18)));
  ...
  assign z14 = x15 | (~x07 & ((~new_n68_ & x21) | new_n61_ | (new_n68_ & ~x21)));
  assign new_n68_ = ~x20 & x19 & x17 & x18;
  assign z15 = x15 | (~x07 & ((x22 & (~new_n68_ | x21)) | new_n61_ | (new_n68_ & ~x21 & ~x22)));
