...
module FAU ( 
  ...
  assign z14 = (~new_n68_ & x21) | ~new_n63_ | (new_n68_ & ~x21);
  assign new_n68_ = ~x20 & x19 & x17 & x18;
  assign z15 = x15 ? ~x14 : ((x22 & (~new_n68_ | x21)) | ~new_n51_ | (new_n68_ & ~x21 & ~x22));
  assign z16 = x15 ? ~x14 : ((~new_n71_ & x23) | ~new_n51_ | (new_n71_ & ~x23));
  assign new_n71_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = (x24 & (x23 | ~new_n68_ | x21 | x22)) | ~new_n63_ | (new_n68_ & ~x23 & ~x24 & ~x21 & ~x22);
  assign z18 = ~new_n48_ & ((~x25 & new_n68_ & new_n74_) | ~new_n63_ | (x25 & (~new_n68_ | ~new_n74_)));
