...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n52_, new_n55_, new_n56_, new_n63_, new_n68_,
    new_n69_, new_n74_, new_n75_;
  assign z00 = ~z02 & x08;
  assign z02 = x16 | (x15 & x23);
  assign z01 = new_n50_ | ~new_n52_ | (x15 & x23);
  ...
  assign z17 = (~x23 & (x15 | (~x24 & new_n69_ & ~x22))) | (~x15 & (~new_n52_ | (x24 & (~new_n69_ | x22 | x23))));
  assign z18 = new_n74_ | (~x15 & (~new_n52_ | ((~new_n68_ | ~new_n75_) & x25)));
  assign new_n74_ = ~x23 & (x15 | (new_n69_ & ~x22 & ~x24 & ~x25));
