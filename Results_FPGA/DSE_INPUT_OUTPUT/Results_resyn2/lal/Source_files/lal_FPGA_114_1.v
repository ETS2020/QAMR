...
module FAU ( 
  ...
  assign z01 = (x06 | ~x15) & (new_n49_ | ~new_n51_);
  ...
  assign z04 = ~new_n55_ & ~x08 & (x06 | ~x15);
  ...
  assign z10 = (~x06 & x15) | (~x17 & new_n51_ & ~x15);
  assign z11 = (~x06 & x15) | (new_n51_ & ~x15 & (x17 | x18) & (~x17 | ~x18));
  assign z12 = (~x06 & x15) | (new_n51_ & ~x15 & (x19 | (x17 & x18)) & (~x19 | ~x17 | ~x18));
  assign z13 = x15 ? x06 : ~new_n66_;
  assign new_n66_ = (x20 | ~x19 | ~x17 | ~x18) & new_n51_ & (~x20 | (x19 & x17 & x18));
  assign z14 = x15 ? x06 : ((~new_n68_ & x21) | ~new_n51_ | (new_n68_ & ~x21));
  assign new_n68_ = ~x20 & x19 & x17 & x18;
  assign z15 = x15 ? x06 : ((x22 & (~new_n68_ | x21)) | ~new_n51_ | (new_n68_ & ~x21 & ~x22));
  assign z16 = x15 ? x06 : ((~new_n71_ & x23) | ~new_n51_ | (new_n71_ & ~x23));
  assign new_n71_ = new_n68_ & ~x21 & ~x22;
  assign z17 = x15 ? x06 : ~new_n73_;
  assign new_n73_ = (~x24 | (~x23 & new_n68_ & ~x21 & ~x22)) & new_n51_ & (~new_n68_ | x21 | x22 | x23 | x24);
  assign z18 = (x06 | ~x15) & ((new_n75_ & ~x25) | ~new_n51_ | x15 | (~new_n75_ & x25));
