...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n50_, new_n51_, new_n52_, new_n55_, new_n57_, new_n58_, new_n64_,
    new_n68_, new_n70_;
  ...
  assign z04 = z10 | (~x08 & (~new_n57_ | ~new_n58_));
  ...
  assign z13 = x15 | (x17 & ((x20 & (~x18 | ~x19)) | ~new_n50_ | (~x20 & x18 & x19)));
  assign z14 = x15 | (x17 & ((new_n68_ & ~x21) | ~new_n50_ | (~new_n68_ & x21)));
  assign new_n68_ = ~x20 & x18 & x19;
  assign z15 = ~new_n64_ | new_n70_ | (x22 & (~new_n68_ | x21));
  assign new_n70_ = ~x20 & x18 & x19 & ~x21 & ~x22;
  assign z16 = x15 | (x17 & ((~new_n70_ & x23) | ~new_n50_ | (new_n70_ & ~x23)));
  ...
  assign z03 = z10 | (~x25 & (~x24 | (~new_n55_ & ~x23)));
endmodule
