...
module FAU ( 
  ...
  assign z13 = x07 ? ~x15 : ((new_n68_ & ~x20) | x15 | (x04 & x05) | (~new_n68_ & x20));
  assign new_n68_ = x19 & x17 & x18;
  assign z14 = x07 ? ~x15 : ((~new_n70_ & x21) | new_n62_ | x15 | (new_n70_ & ~x21));
  assign new_n70_ = ~x20 & x19 & x17 & x18;
  assign z15 = (x07 & ~x15) | (~x07 & x15) | (~x07 & ((x22 & (~new_n70_ | x21)) | new_n62_ | (new_n70_ & ~x21 & ~x22)));
  assign z16 = x07 ? ~x15 : ((~new_n73_ & x23) | new_n62_ | x15 | (new_n73_ & ~x23));
  assign new_n73_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = ((~new_n73_ | x23) & x24) | ~new_n64_ | (new_n73_ & ~x23 & ~x24);
  assign z18 = x07 ? ~x15 : ((~x25 & new_n73_ & new_n76_) | new_n62_ | x15 | (x25 & (~new_n73_ | ~new_n76_)));
