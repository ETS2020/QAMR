...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n54_, new_n55_, new_n57_, new_n58_,
    new_n64_, new_n67_, new_n70_, new_n73_, new_n75_;
  ...
  assign z13 = ~new_n64_ | (~new_n67_ & x20) | (new_n67_ & ~x20);
  assign new_n67_ = x18 & x19;
  assign z14 = (x21 & (x20 | ~x18 | ~x19)) | ~new_n64_ | (x18 & x19 & ~x20 & ~x21);
  assign z15 = (~new_n70_ & x22) | ~new_n64_ | (new_n70_ & ~x22);
  assign new_n70_ = ~x20 & ~x21 & x18 & x19;
  assign z16 = x15 | (x17 & ((x23 & (~new_n70_ | x22)) | ~new_n50_ | (new_n70_ & ~x22 & ~x23)));
  assign z17 = new_n73_ | ~new_n64_ | (x24 & (~new_n70_ | x22 | x23));
  assign new_n73_ = new_n67_ & ~x20 & ~x22 & ~x23 & ~x21 & ~x24;
  assign z18 = x15 | (x17 & (~new_n75_ | (~new_n73_ & x25)));
  assign new_n75_ = new_n50_ & (~new_n70_ | x22 | x23 | x24 | x25);
  assign z10 = 1'b0;
  assign z08 = ~z03;
endmodule
