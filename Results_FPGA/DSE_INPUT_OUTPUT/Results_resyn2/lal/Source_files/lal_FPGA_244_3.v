...
module FAU ( 
  ...
  assign z13 = x07 ? ~x15 : ~new_n66_;
  assign new_n66_ = (~x20 | (x19 & x17 & x18)) & new_n67_ & (~x17 | ~x18 | ~x19 | x20);
  assign new_n67_ = ~x15 & (~x04 | ~x05);
  assign z14 = (~new_n69_ & x21) | ~new_n62_ | (new_n69_ & ~x21);
  assign new_n69_ = x17 & x18 & x19 & ~x20;
  assign z15 = (new_n71_ & ~x22) | ~new_n62_ | (~new_n71_ & x22);
  assign new_n71_ = new_n69_ & ~x21;
  assign z16 = x07 ? ~x15 : ((x23 & (~new_n71_ | x22)) | ~new_n67_ | (new_n71_ & ~x22 & ~x23));
  assign z17 = x07 ? ~x15 : ~new_n74_;
  assign new_n74_ = (~x24 | (new_n69_ & ~x21 & ~x22 & ~x23)) & new_n67_ & (~new_n69_ | x22 | x23 | x21 | x24);
  assign z18 = x07 ? ~x15 : ((new_n69_ & new_n76_ & ~x25) | ~new_n67_ | ((~new_n69_ | ~new_n76_) & x25));
  assign new_n76_ = ~x22 & ~x23 & ~x21 & ~x24;
endmodule
