...
module FAU ( 
  ...
  assign z09 = (x15 | (x04 & x05)) & (~x07 ^ x15);
  ...
  assign z15 = x07 ? ~x15 : ((~new_n69_ & x22) | (new_n69_ & ~x22) | x15 | (x04 & x05));
  assign new_n69_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = (x23 & (~new_n69_ | x22)) | ~new_n62_ | (new_n69_ & ~x22 & ~x23);
  assign z17 = x07 ? ~x15 : ((~new_n72_ & x24) | (new_n72_ & ~x24) | x15 | (x04 & x05));
  assign new_n72_ = new_n69_ & ~x22 & ~x23;
  assign z18 = (~x25 & new_n72_ & ~x24) | ~new_n62_ | (x25 & (~new_n72_ | x24));
endmodule
