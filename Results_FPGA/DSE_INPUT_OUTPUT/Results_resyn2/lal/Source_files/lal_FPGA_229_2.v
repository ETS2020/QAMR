...
module FAU ( 
  ...
  assign z14 = x15 | (~x07 & ((~new_n68_ & x21) | new_n67_ | (new_n68_ & ~x21)));
  assign new_n67_ = x04 & x05;
  assign new_n68_ = ~x20 & x19 & x17 & x18;
  assign z15 = (x22 & (~new_n68_ | x21)) | ~new_n62_ | (new_n68_ & ~x21 & ~x22);
  assign z16 = x15 | (~x07 & ((~new_n71_ & x23) | new_n67_ | (new_n71_ & ~x23)));
  assign new_n71_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = (x24 & (~new_n71_ | x23)) | ~new_n62_ | (new_n71_ & ~x23 & ~x24);
  assign z18 = x15 | (~x07 & ((~x25 & new_n71_ & new_n74_) | new_n67_ | (x25 & (~new_n71_ | ~new_n74_))));
