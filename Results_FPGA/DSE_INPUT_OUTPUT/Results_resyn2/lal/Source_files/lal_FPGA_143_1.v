...
module FAU ( 
  ...
  assign z11 = ~x07 & ~new_n51_ & ~x15 & (x17 | x18) & (~x17 | ~x18);
  ...
  assign z16 = (~new_n71_ & x23) | (new_n71_ & ~x23) | x07 | new_n51_ | x15;
  assign new_n71_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = x07 | (~x15 & ((x24 & (~new_n71_ | x23)) | new_n51_ | (new_n71_ & ~x23 & ~x24)));
