...
module FAU ( 
  ...
  assign z15 = x15 | (~x07 & ((~new_n71_ & x22) | new_n70_ | (new_n71_ & ~x22)));
  assign new_n70_ = x04 & x05;
  assign new_n71_ = x19 & x17 & x18 & ~x20 & ~x21;
  assign z16 = (x23 & (~new_n71_ | x22)) | ~new_n63_ | (new_n71_ & ~x22 & ~x23);
  assign z17 = x15 | (~x07 & ((x24 & (~new_n71_ | ~new_n74_)) | new_n70_ | (~x24 & new_n71_ & new_n74_)));
