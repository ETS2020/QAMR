...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n50_, new_n51_, new_n55_, new_n56_, new_n65_, new_n67_, new_n70_,
    new_n73_;
  ...
  assign z12 = ~x15 & (x04 | ((x19 | (x17 & x18)) & ~x07 & (~x19 | ~x17 | ~x18)));
  assign z13 = new_n65_ | x15;
  assign new_n65_ = ~x04 & ((~x20 & x19 & x17 & x18) | x07 | (x20 & (~x19 | ~x17 | ~x18)));
  assign z14 = x15 | (~x04 & ((~new_n67_ & x21) | x07 | (new_n67_ & ~x21)));
  assign new_n67_ = ~x20 & x19 & x17 & x18;
  assign z15 = x15 | (~x04 & ((x22 & (~new_n67_ | x21)) | x07 | (new_n67_ & ~x21 & ~x22)));
  assign z16 = (~new_n70_ & x23) | (new_n70_ & ~x23) | x15 | x04 | x07;
  assign new_n70_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = (x24 & (~new_n70_ | x23)) | (new_n70_ & ~x23 & ~x24) | x15 | x04 | x07;
  assign z18 = x15 | (~x04 & ((~x25 & new_n70_ & new_n73_) | x07 | (x25 & (~new_n70_ | ~new_n73_))));
