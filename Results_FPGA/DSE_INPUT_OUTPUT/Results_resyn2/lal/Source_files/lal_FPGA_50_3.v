...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n48_, new_n50_, new_n51_, new_n55_, new_n56_, new_n65_, new_n67_,
  ...
  assign z10 = (x07 & x15) | (~x17 & new_n51_ & ~x15);
  assign z11 = new_n51_ & ~x15 & (x17 | x18) & (~x17 | ~x18);
  assign z12 = new_n51_ & ~x15 & (~x19 | ~x17 | ~x18) & (x19 | (x17 & x18));
  assign z13 = x07 ? ~x15 : ((new_n65_ & ~x20) | (~new_n65_ & x20) | x15 | (x04 & x05));
  assign new_n65_ = x19 & x17 & x18;
  assign z14 = x07 ? ~x15 : ((~new_n67_ & x21) | ~new_n68_ | (new_n67_ & ~x21));
  assign new_n67_ = ~x20 & x19 & x17 & x18;
  assign new_n68_ = ~x15 & (~x04 | ~x05);
  assign z15 = x07 ? ~x15 : ((x22 & (~new_n67_ | x21)) | ~new_n68_ | (new_n67_ & ~x21 & ~x22));
  assign z16 = x07 ? ~x15 : ((~new_n71_ & x23) | ~new_n68_ | (new_n71_ & ~x23));
  assign new_n71_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = x07 ? ~x15 : ((x24 & (~new_n71_ | x23)) | ~new_n68_ | (new_n71_ & ~x23 & ~x24));
  assign z18 = x07 ? ~x15 : ((~x25 & new_n71_ & new_n74_) | ~new_n68_ | (x25 & (~new_n71_ | ~new_n74_)));
