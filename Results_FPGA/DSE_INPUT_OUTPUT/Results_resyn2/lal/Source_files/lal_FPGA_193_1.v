...
module FAU ( 
  ...
  assign z09 = (~x03 & x07) | (x04 & x05 & ~x07 & ~x15);
  ...
  assign z13 = x07 ? x03 : ((new_n66_ & ~x20) | ~new_n67_ | (~new_n66_ & x20));
  assign new_n66_ = x19 & x17 & x18;
  assign new_n67_ = ~x15 & (~x04 | ~x05);
  assign z14 = x07 ? x03 : ((x21 & (~new_n66_ | x20)) | ~new_n67_ | (~x21 & new_n66_ & ~x20));
  assign z15 = x07 ? x03 : ((~new_n70_ & x22) | ~new_n67_ | (new_n70_ & ~x22));
  assign new_n70_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = x07 ? x03 : ((x23 & (~new_n70_ | x22)) | ~new_n67_ | (new_n70_ & ~x22 & ~x23));
  assign z17 = x07 ? x03 : ((x24 & (~new_n70_ | ~new_n73_)) | ~new_n67_ | (~x24 & new_n70_ & new_n73_));
  assign new_n73_ = ~x22 & ~x23;
  assign z18 = (~x25 & ~x24 & new_n70_ & new_n73_) | ~new_n62_ | (x25 & (x24 | ~new_n70_ | ~new_n73_));
