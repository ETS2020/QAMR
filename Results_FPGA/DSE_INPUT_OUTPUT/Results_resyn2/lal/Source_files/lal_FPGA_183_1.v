...
module FAU ( 
  ...
  assign z07 = ~x06 | x08;
  assign z08 = (~x06 & x23) | x25 | (x24 & (new_n50_ | x23));
  ...
  assign z14 = (x21 & (x20 | ~x19 | ~x17 | ~x18)) | ~new_n68_ | (~x21 & ~x20 & x19 & x17 & x18);
  assign new_n68_ = (x06 | ~x23) & (~x04 | ~x05) & ~x07 & ~x15;
  assign z15 = ~new_n48_ & ((~new_n70_ & x22) | ~new_n63_ | (new_n70_ & ~x22));
  assign new_n70_ = ~x21 & ~x20 & x19 & x17 & x18;
  assign z16 = ((~new_n70_ | x22) & x06 & x23) | (~new_n63_ & (x06 | ~x23)) | (new_n70_ & ~x22 & ~x23);
  assign z17 = (x24 & (~new_n70_ | x22)) | (~x24 & new_n70_ & ~x22 & ~x23) | ~new_n63_ | (x23 & (~x06 | x24));
  assign z18 = ((x24 | ~new_n70_ | ~new_n74_) & (new_n48_ | x25)) | ~new_n63_ | (new_n70_ & new_n74_ & ~x24 & ~x25);
