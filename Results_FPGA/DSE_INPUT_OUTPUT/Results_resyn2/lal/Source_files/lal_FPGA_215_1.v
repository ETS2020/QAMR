...
module FAU ( 
  ...
  assign z13 = (x20 & (~x19 | ~x17 | ~x18)) | new_n48_ | ~new_n63_ | (x17 & x18 & x19 & ~x20);
  ...
  assign z16 = (~x23 & (new_n71_ | x25)) | ~new_n63_ | (~new_n71_ & x23);
  assign new_n71_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z17 = (x24 & (x23 | (~new_n71_ & ~x25))) | (~new_n63_ & (x23 | ~x25)) | (~x25 & new_n71_ & ~x23 & ~x24);
  assign z18 = ~new_n63_ | x25 | (new_n71_ & ~x23 & ~x24);
endmodule
