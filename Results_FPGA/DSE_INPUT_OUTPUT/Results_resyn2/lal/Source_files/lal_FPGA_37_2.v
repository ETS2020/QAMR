...
module FAU ( 
  ...
  assign z15 = new_n49_ ^ ((x22 & (~new_n66_ | x21)) | ~new_n61_ | (new_n66_ & ~x21 & ~x22));
  assign z16 = (x23 & (~new_n66_ | x21 | x22)) | ~new_n61_ | (~x23 & new_n66_ & ~x21 & ~x22);
  assign z17 = (x24 & (x23 | ~new_n66_ | x21 | x22)) | ~new_n61_ | (new_n66_ & ~x21 & ~x22 & ~x23 & ~x24);
  assign z18 = ~new_n49_ & ((~x25 & new_n66_ & new_n71_) | ~new_n61_ | (x25 & (~new_n66_ | ~new_n71_)));
