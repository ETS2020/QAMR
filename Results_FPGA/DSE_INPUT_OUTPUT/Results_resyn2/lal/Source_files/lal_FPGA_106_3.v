...
module FAU ( 
  ...
  assign z09 = (new_n61_ | x07) & (x07 ^ ~x15);
  ...
  assign z13 = x07 ? ~x15 : ((new_n67_ & ~x20) | new_n61_ | x15 | (~new_n67_ & x20));
  assign new_n67_ = x19 & x17 & x18;
  assign z14 = (x21 & (~new_n67_ | x20)) | ~new_n63_ | (~x21 & new_n67_ & ~x20);
  assign z15 = (x22 & (x21 | ~new_n67_ | x20)) | ~new_n63_ | (new_n67_ & ~x20 & ~x21 & ~x22);
  assign z16 = x07 ? ~x15 : ((~new_n71_ & x23) | new_n61_ | x15 | (new_n71_ & ~x23));
  assign new_n71_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = (x24 & (~new_n71_ | x23)) | ~new_n63_ | (new_n71_ & ~x23 & ~x24);
  assign z18 = x07 ? ~x15 : ((~x25 & new_n71_ & new_n74_) | new_n61_ | x15 | (x25 & (~new_n71_ | ~new_n74_)));
