// Benchmark "FAU" written by ABC on Wed Aug 12 18:11:48 2020
...
module FAU ( 
  ...
  assign z12 = ~x15 & (x07 | ((x19 | (x17 & x18)) & ~new_n63_ & (~x19 | ~x17 | ~x18)));
  assign z13 = x15 | (~new_n66_ & ~x07);
  assign new_n66_ = (x20 | ~x19 | ~x17 | ~x18) & (~x04 | ~x05) & (~x20 | (x19 & x17 & x18));
  assign z14 = x15 | (~x07 & ((~new_n68_ & x21) | new_n63_ | (new_n68_ & ~x21)));
  assign new_n68_ = ~x20 & x19 & x17 & x18;
  assign z15 = (x22 & (~new_n68_ | x21)) | new_n63_ | x07 | x15 | (new_n68_ & ~x21 & ~x22);
  assign z16 = (~new_n71_ & x23) | (new_n71_ & ~x23) | ~new_n50_ | x15;
  assign new_n71_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = x15 | (~x07 & ((x24 & (~new_n71_ | x23)) | new_n63_ | (new_n71_ & ~x23 & ~x24)));
  assign z18 = x15 | (~x07 & ((~x25 & new_n71_ & new_n74_) | new_n63_ | (x25 & (~new_n71_ | ~new_n74_))));
