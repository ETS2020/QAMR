...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n54_, new_n55_, new_n64_, new_n66_, new_n68_,
  ...
  assign z11 = ~x15 & ~x07 & (~x04 | ~x05) & (~x17 | ~x18) & (x17 | x18);
  assign z12 = (x07 & x15) | (~x07 & (~x04 | ~x05) & ~x15 & (~new_n64_ | ~x19) & (new_n64_ | x19));
  assign new_n64_ = x17 & x18;
  assign z13 = x07 ? ~x15 : ((x20 & (~new_n64_ | ~x19)) | ~new_n66_ | (new_n64_ & x19 & ~x20));
  assign new_n66_ = ~x15 & (~x04 | ~x05);
  assign z14 = x07 ? ~x15 : ((~new_n68_ & x21) | ~new_n66_ | (new_n68_ & ~x21));
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign z15 = (new_n70_ & ~x22) | x07 | (x04 & x05) | x15 | (~new_n70_ & x22);
  assign new_n70_ = new_n68_ & ~x21;
  assign z16 = x07 ? ~x15 : ((x23 & (~new_n70_ | x22)) | ~new_n66_ | (new_n70_ & ~x22 & ~x23));
  assign z17 = x07 ? ~x15 : ~new_n73_;
  assign new_n73_ = (~x24 | (new_n68_ & ~x21 & ~x22 & ~x23)) & new_n66_ & (~new_n68_ | x22 | x23 | x21 | x24);
  assign z18 = x07 ? ~x15 : ((new_n75_ & ~x25) | ~new_n66_ | (~new_n75_ & x25));
