...
module FAU ( 
  ...
  assign z09 = (new_n61_ | x15) & (~x07 | x15) & (x07 | ~x15);
  assign new_n61_ = x04 & x05;
  assign z10 = ~x17 & new_n51_ & ~x15;
  assign z11 = (x07 & x15) | (~x15 & ~new_n61_ & ~x07 & (x17 | x18) & (~x17 | ~x18));
  assign z12 = (x07 & x15) | (~x15 & ~new_n61_ & ~x07 & (x19 | (x17 & x18)) & (~x19 | ~x17 | ~x18));
  assign z13 = x07 ? ~x15 : ((new_n66_ & ~x20) | x15 | (x04 & x05) | (~new_n66_ & x20));
  assign new_n66_ = x19 & x17 & x18;
  assign z14 = x07 ? ~x15 : ((~new_n68_ & x21) | new_n61_ | x15 | (new_n68_ & ~x21));
  ...
  assign z17 = (x07 & ~x15) | (~x07 & x15) | (~x07 & ((x24 & (~new_n71_ | x23)) | new_n61_ | (new_n71_ & ~x23 & ~x24)));
