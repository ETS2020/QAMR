...
module FAU ( 
  ...
  assign z00 = (~x16 | (x14 & x15)) & (x08 | (x14 & x15));
  assign z01 = new_n49_ | ~new_n51_ | (x14 & x15);
  ...
  assign z17 = x15 ? ~x14 : ~new_n72_;
  assign new_n72_ = (~x24 | (new_n67_ & ~x21 & ~x22 & ~x23)) & new_n51_ & (~new_n67_ | x22 | x23 | x21 | x24);
  assign z18 = (~x14 | ~x15) & ((new_n67_ & new_n74_ & ~x25) | ~new_n51_ | x15 | ((~new_n67_ | ~new_n74_) & x25));
