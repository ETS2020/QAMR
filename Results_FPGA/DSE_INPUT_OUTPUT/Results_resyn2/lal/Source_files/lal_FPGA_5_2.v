...
module FAU ( 
  ...
  assign z13 = x15 | (~x07 & ((new_n66_ & ~x20) | new_n51_ | (~new_n66_ & x20)));
  assign new_n66_ = x19 & x17 & x18;
  assign z14 = x15 | (~x07 & ((x21 & (~new_n66_ | x20)) | new_n51_ | (new_n66_ & ~x20 & ~x21)));
  assign z15 = x15 | (~x07 & ((~new_n69_ & x22) | new_n51_ | (new_n69_ & ~x22)));
  assign new_n69_ = ~x20 & ~x21 & x19 & x17 & x18;
  assign z16 = (x23 & (~new_n69_ | x22)) | (new_n69_ & ~x22 & ~x23) | x15 | new_n51_ | x07;
  assign z17 = x15 | (~x07 & (new_n72_ | new_n73_ | new_n51_));
