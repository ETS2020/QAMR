...
module FAU ( 
  ...
  assign z13 = (~x15 | x20) & ((x20 & (~new_n67_ | x15)) | ~new_n51_ | (new_n67_ & ~x20));
  assign new_n67_ = x19 & x17 & x18;
  assign z14 = (~x15 | x20) & ((new_n67_ & ~x20 & ~x21) | ~new_n51_ | ((~new_n67_ | x20) & (x15 | x21)));
  assign z15 = (x20 & (x15 | x22)) | (~x15 & ((new_n67_ & ~x20 & ~x21 & ~x22) | ~new_n51_ | (x22 & (~new_n67_ | x21))));
  assign z16 = (~new_n71_ & ~x15) | (x20 & (x15 | x23));
  assign new_n71_ = (~x23 | (new_n67_ & ~x21 & ~x22)) & new_n51_ & (~new_n67_ | x20 | x23 | x21 | x22);
  assign z17 = (~new_n73_ & ~x15) | (x20 & (x15 | x24));
  assign new_n73_ = (x20 | ~new_n67_ | ~new_n74_ | x23 | x24) & new_n51_ & (~x24 | (new_n67_ & new_n74_ & ~x23));
  assign new_n74_ = ~x21 & ~x22;
  assign z18 = (x20 & (x15 | x25)) | (~x15 & ((~x25 & new_n76_ & ~x20) | ~new_n51_ | (~new_n76_ & x25)));
  assign new_n76_ = new_n67_ & new_n74_ & ~x23 & ~x24;
endmodule
