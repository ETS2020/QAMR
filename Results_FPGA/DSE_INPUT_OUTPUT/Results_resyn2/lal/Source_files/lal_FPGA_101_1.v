...
module FAU ( 
  ...
  assign new_n64_ = (~x04 | ~x05) & ~x07 & ~x15 & (x23 | ~x25);
  ...
  assign z15 = ~new_n48_ & ((x22 & (~new_n68_ | x21)) | ~new_n62_ | (new_n68_ & ~x21 & ~x22));
  assign z16 = (new_n71_ & ~x23 & ~x25) | (~new_n71_ & x23) | (~new_n62_ & (x23 | ~x25));
  assign new_n71_ = ~x20 & x19 & x17 & x18 & ~x21 & ~x22;
  assign z17 = (x24 & (x23 | (~new_n71_ & ~x25))) | (~new_n62_ & (x23 | ~x25)) | (new_n71_ & ~x24 & ~x23 & ~x25);
  assign z18 = (new_n71_ & ~x24 & ~x23 & ~x25) | (x23 & x25) | (~new_n62_ & ~x25);
