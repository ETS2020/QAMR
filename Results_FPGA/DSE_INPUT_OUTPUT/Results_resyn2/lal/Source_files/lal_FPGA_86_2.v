// Benchmark "FAU" written by ABC on Wed Aug 12 18:11:14 2020
...
module FAU ( 
  ...
  assign z10 = ~x17 & ~x15 & ~new_n51_ & ~x07;
  assign z11 = ~x15 & ~new_n51_ & ~x07 & (x17 | x18) & (~x17 | ~x18);
  assign z12 = ~x15 & (x07 | ((x19 | (x17 & x18)) & ~new_n51_ & (~x19 | ~x17 | ~x18)));
  assign z13 = x15 | (~new_n66_ & ~x07);
  assign new_n66_ = (~x20 | (x19 & x17 & x18)) & ~new_n51_ & (~x17 | ~x18 | ~x19 | x20);
  assign z14 = x15 | (~x07 & ((~new_n68_ & x21) | new_n51_ | (new_n68_ & ~x21)));
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign z15 = (new_n70_ & ~x22) | x15 | new_n51_ | x07 | (~new_n70_ & x22);
  assign new_n70_ = new_n68_ & ~x21;
  assign z16 = x15 | (~x07 & ((x23 & (~new_n70_ | x22)) | new_n51_ | (new_n70_ & ~x22 & ~x23)));
  assign z17 = x15 | (~new_n73_ & ~x07);
  assign new_n73_ = (~x24 | (new_n68_ & ~x21 & ~x22 & ~x23)) & ~new_n51_ & (~new_n68_ | x22 | x23 | x21 | x24);
  assign z18 = x15 | (~x07 & ((new_n75_ & ~x25) | new_n51_ | (~new_n75_ & x25)));
