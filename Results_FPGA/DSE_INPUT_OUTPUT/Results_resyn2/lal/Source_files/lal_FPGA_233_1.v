...
module FAU ( 
  ...
  assign z10 = (~x17 | (~x20 & x25)) & (new_n64_ | (~x20 & x25));
  assign new_n64_ = (~x04 | ~x05) & ~x07 & ~x15;
  assign z11 = new_n64_ & (~x17 | ~x18) & (x17 | x18) & (x20 | ~x25);
  assign z12 = (~x20 & x25) | ((x19 | (x17 & x18)) & new_n64_ & (~x19 | ~x17 | ~x18));
  assign z13 = ~new_n64_ | (~new_n68_ & x20) | (~x20 & (new_n68_ | x25));
  assign new_n68_ = x19 & x17 & x18;
  assign z14 = (x21 & (x20 | (~new_n68_ & ~x25))) | (~new_n64_ & (x20 | ~x25)) | (~x21 & ~x25 & new_n68_ & ~x20);
  assign z15 = (x22 & (x21 | x25 | ~new_n68_ | x20)) | ~new_n64_ | (~x20 & (x25 | (new_n68_ & ~x21 & ~x22)));
  assign z16 = (x23 & (x20 | (~x25 & (~new_n68_ | ~new_n72_)))) | (~new_n64_ & (x20 | ~x25)) | (~x25 & new_n68_ & ~x20 & new_n72_ & ~x23);
  assign new_n72_ = ~x21 & ~x22;
  assign z17 = (~x20 & (x25 | (new_n68_ & new_n74_ & ~x24))) | ~new_n64_ | (x24 & (~new_n74_ | x25 | ~new_n68_ | x20));
