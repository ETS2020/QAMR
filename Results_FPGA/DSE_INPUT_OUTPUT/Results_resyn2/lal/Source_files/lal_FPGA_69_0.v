...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n54_, new_n55_, new_n62_, new_n67_, new_n70_,
    new_n73_;
  assign z00 = ~z02 & x08;
  assign z02 = x16 | (~x14 & ~x25);
  assign z01 = (~new_n50_ & (x14 | x25)) | ((~x24 | (~new_n51_ & ~x23)) & x14 & ~x25);
  assign new_n50_ = ~x07 & (~x04 | ~x05);
  assign new_n51_ = (x20 | (~x19 & ~x17 & ~x18)) & x21 & x22;
  assign z03 = ~x25 & (~x14 | (~new_n51_ & ~x23) | ~x24);
  assign z04 = (~new_n54_ | ~new_n55_) & ~x08 & (x14 | x25);
  assign new_n54_ = (~x03 | x12) & (x03 | ~x12) & (~x02 | x11) & (x02 | ~x11);
  assign new_n55_ = (~x01 | x10) & (x01 | ~x10) & (x00 ^ ~x09);
  assign z05 = (~x08 & ~x13) | (~x14 & ~x25);
  assign z06 = ~x08 & x14;
  assign z07 = ~x06 | x08 | (~x14 & ~x25);
  assign z08 = ((new_n51_ | x23) & x24) | ~x14 | x25;
  assign z09 = x04 & x05 & (x14 | x25) & ~x07 & ~x15;
  assign z10 = new_n62_ & ~x17;
  assign new_n62_ = (~x04 | ~x05) & (x14 | x25) & ~x07 & ~x15;
  ...
  assign z18 = ((~x14 | x25) & (~new_n70_ | x23 | x24)) | ~new_n73_ | (~x25 & new_n70_ & ~x23 & ~x24);
  assign new_n73_ = ~x15 & ~x07 & (~x04 | ~x05);
endmodule
