...
module FAU ( 
  ...
  assign z11 = (~x23 & x27) | ((~x08 | x23) & ~x10 & (x08 | x22));
  assign z12 = ((~x08 | x24) & ~x10 & (x08 | x23)) | (~x23 & x27);
  assign z13 = new_n86_ | ((~x08 | x25) & ~x10 & (x08 | x24));
  assign z14 = new_n86_ | ((~x08 | x26) & ~x10 & (x08 | x25));
  assign z15 = ~x10 & (x23 | ~x27) & (x08 | x26) & (~x08 | x27);
  assign z16 = (x08 | x27) & (~x08 | x28) & ~x10 & (x23 | ~x27);
