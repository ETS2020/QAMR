...
module FAU ( 
  ...
  assign z24 = ~x10 & (~x36 | ~x38) & (x09 | x35) & (~x09 | x36);
  assign z25 = (x09 | x36) & (~x09 | x37) & ~x10 & (~x36 | ~x38);
  assign z26 = ~x10 & (~x36 | ~x38) & (x09 | x37) & (~x09 | x38);
  assign z27 = new_n114_ & ((x00 & x14) | ~x09 | (~x14 & x39));
  assign new_n114_ = (x09 | x38) & ~x10 & (~x36 | ~x38);
