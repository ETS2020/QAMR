...
module FAU ( 
  ...
  assign z11 = (x23 & ~x27) | ((x08 | x22) & ~x10 & (~x08 | x23));
  assign z12 = (x23 & ~x27) | ((~x08 | x24) & ~x10 & (x08 | x23));
  assign z13 = new_n86_ | ((~x08 | x25) & ~x10 & (x08 | x24));
  assign z14 = new_n86_ | ((~x08 | x26) & ~x10 & (x08 | x25));
  assign z15 = (x27 | (~x08 & ~x23)) & ~x10 & (x08 | x26);
  assign z16 = (x27 | (x08 & ~x23)) & ~x10 & (~x08 | x28);
