// Benchmark "FAU" written by ABC on Wed Aug 12 15:22:49 2020
...
module FAU ( 
  ...
  assign z18 = ~x10 & (~x30 | ~x38) & (x08 | x29) & (~x08 | x30);
  assign z19 = (x30 & x38) | (~x10 & (x08 | x30) & (x00 | ~x08));
  ...
  assign z26 = (x30 & x38) | ((~x09 | x38) & ~x10 & (x09 | x37));
