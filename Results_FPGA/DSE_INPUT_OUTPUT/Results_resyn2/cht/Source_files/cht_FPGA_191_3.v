...
module FAU ( 
  ...
  assign z30 = (x42 | ~x09 | x14) & ~x10 & (~x42 | ~x46) & (x41 | (x09 & ~x14));
  assign z31 = (x42 & x46) | ((x43 | ~x09 | x14) & ~x10 & (x42 | (x09 & ~x14)));
  assign z32 = new_n86_ | ((x44 | ~x09 | x14) & ~x10 & (x43 | (x09 & ~x14)));
  assign z33 = new_n86_ | ((x45 | ~x09 | x14) & ~x10 & (x44 | (x09 & ~x14)));
  assign z34 = (x46 | ~x09 | x14) & ~x10 & (~x42 | ~x46) & (x45 | (x09 & ~x14));
  assign z35 = (x42 & x46) | ((x00 | ~x09 | x14) & ~x10 & (x46 | (x09 & ~x14)));
endmodule
