...
module FAU ( 
  ...
  assign z01 = new_n87_ & (x05 | ~x07) & (x07 | x12);
  assign new_n87_ = ~x10 & (x20 | ~x38);
  assign z02 = new_n87_ & (x06 | ~x07) & (x07 | x13);
  assign z03 = new_n87_ & (x01 | ~x07) & (x07 | x14);
  assign z04 = new_n87_ & (x02 | ~x07) & (x07 | x15);
  ...
  assign z19 = new_n87_ & (x00 | ~x08) & (x08 | x30);
