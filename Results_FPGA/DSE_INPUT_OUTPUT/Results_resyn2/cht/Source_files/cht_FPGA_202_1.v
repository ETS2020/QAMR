...
module FAU ( 
  ...
  assign z21 = (~x33 & x38) | ((~x09 | x33) & ~x10 & (x09 | x32));
  assign z22 = (x33 | (x09 & ~x38)) & ~x10 & (~x09 | x34);
  assign z23 = ~new_n86_ & ~x10 & (x09 | x34) & (~x09 | x35);
  assign z24 = new_n86_ | ((~x09 | x36) & ~x10 & (x09 | x35));
  assign z25 = ~new_n86_ & ~x10 & (x09 | x36) & (~x09 | x37);
  assign z26 = (~x33 & x38) | ((x09 | x37) & ~x10 & (~x09 | x38));
  assign z27 = (new_n114_ | ~x09) & ~x10 & (x33 | ~x38) & (x09 | x38);
