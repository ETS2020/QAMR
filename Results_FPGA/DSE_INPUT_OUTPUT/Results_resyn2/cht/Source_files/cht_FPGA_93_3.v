// Benchmark "FAU" written by ABC on Wed Aug 12 15:23:06 2020
...
module FAU ( 
  ...
  assign z23 = ~x10 & (~x35 | ~x38) & (x09 | x34) & (~x09 | x35);
  assign z24 = (x09 | x35) & (~x09 | x36) & ~x10 & (~x35 | ~x38);
  assign z25 = new_n86_ | ((~x09 | x37) & ~x10 & (x09 | x36));
  assign z26 = ~x10 & (~x35 | ~x38) & (x09 | x37) & (~x09 | x38);
