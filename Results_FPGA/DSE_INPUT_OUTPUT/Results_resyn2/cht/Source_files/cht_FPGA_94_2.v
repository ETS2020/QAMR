// Benchmark "FAU" written by ABC on Wed Aug 12 15:23:07 2020
...
module FAU ( 
  ...
  assign z01 = (x12 & ~x39) | ((x05 | ~x07) & ~x10 & (x07 | x12));
  ...
  assign z26 = ~new_n86_ & ~x10 & (x09 | x37) & (~x09 | x38);
  assign z27 = new_n86_ | new_n114_;
  assign new_n114_ = ((x00 & x14) | ~x09 | (~x14 & x39)) & ~x10 & (x09 | x38);
  assign z28 = (x39 | (~x12 & x09 & ~x14)) & ~x10 & (x40 | ~x09 | x14);
