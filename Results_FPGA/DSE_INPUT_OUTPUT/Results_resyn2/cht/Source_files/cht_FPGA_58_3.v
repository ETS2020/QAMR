...
module FAU ( 
  ...
  assign z27 = (~x09 | (x14 ? x00 : x39)) & new_n87_ & (x09 | x38);
  assign z28 = (x20 & x38) | ((~new_n115_ | x40) & ~x10 & (new_n115_ | x39));
  assign new_n115_ = x09 & ~x14;
  assign z29 = (~new_n115_ | x41) & new_n87_ & (new_n115_ | x40);
  assign z30 = (~new_n115_ | x42) & new_n87_ & (new_n115_ | x41);
  assign z31 = (x20 & x38) | ((~new_n115_ | x43) & ~x10 & (new_n115_ | x42));
  assign z32 = (~new_n115_ | x44) & new_n87_ & (new_n115_ | x43);
  assign z33 = (~new_n115_ | x45) & new_n87_ & (new_n115_ | x44);
  assign z34 = (x20 & x38) | ((~new_n115_ | x46) & ~x10 & (new_n115_ | x45));
  assign z35 = (~new_n115_ | x00) & new_n87_ & (new_n115_ | x46);
endmodule
