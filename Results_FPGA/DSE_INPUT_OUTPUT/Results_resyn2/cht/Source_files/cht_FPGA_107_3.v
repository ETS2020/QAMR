...
module FAU ( 
  ...
  assign z14 = ~x10 & (~x26 | ~x38) & (x08 | x25) & (~x08 | x26);
  assign z15 = (x08 | x26) & (~x08 | x27) & ~x10 & (~x26 | ~x38);
  ...
  assign z26 = (x26 & x38) | ((~x09 | x38) & ~x10 & (x09 | x37));
  assign z27 = (new_n114_ | ~x09) & ~x10 & (~x26 | ~x38) & (x09 | x38);
