...
module FAU ( 
  ...
  assign z15 = (~x27 & ~x39) | ((~x08 | x27) & ~x10 & (x08 | x26));
  assign z16 = (~x27 & ~x39) | ((~x08 | x28) & ~x10 & (x08 | x27));
  ...
  assign z27 = (x39 | (x27 & (~x09 | x14))) & new_n114_ & (~x14 | x00 | ~x09);
  assign new_n114_ = ~x10 & (x09 | x38);
  assign z28 = (~x09 | x14 | ((x27 | x39) & x40)) & ~x10 & (x39 | (x09 & ~x14));
