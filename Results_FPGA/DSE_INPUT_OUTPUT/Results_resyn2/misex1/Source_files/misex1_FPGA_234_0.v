...
module FAU ( 
  ...
  assign new_n24_ = (x0 | ~x1 | ~x7 | x2 | x4) & (~x2 | (~x4 & ~x7) | x1 | (~x0 & x5));
  assign new_n25_ = ~x2 & x4 & ~x7 & ~x0 & x1;
  assign z4 = (~x1 & ((x2 & ~x3) | (x0 & ~x2 & x3))) | new_n18_ | (~x0 & (~x2 | x3) & (~x3 | x1 | x2));
  assign z5 = ~new_n18_ & ~new_n28_;
  assign new_n28_ = (x1 | ((~x0 | (x2 ^ ~x3)) & (~x2 | x0 | ~x5))) & (((x3 | ~x6) & ~x1 & ~x2) | x0 | (x2 & ~x3));
  assign z6 = (~x0 & x1 & x7 & ~x2 & ~x4) | (~new_n30_ & (x4 | x7));
  assign new_n30_ = (~x3 | x0 | ~x1) & (x1 | ((~x0 | (x2 ^ ~x3)) & (~x2 | x3 | x5)));
endmodule
