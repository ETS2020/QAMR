...
module FAU ( 
  ...
  assign z1 = new_n19_ | (~x2 & (~x7 | (~x1 & x0 & x3)));
  assign new_n19_ = (~x2 | (~x1 & (x3 | x5))) & ~x0 & ((~x3 & x6) | x1 | x2);
  assign z2 = (~x0 & (new_n23_ | (~new_n22_ & ~x1 & ~x3))) | (~x1 & new_n21_ & x0 & x3);
  assign new_n21_ = ~x2 & x7;
  assign new_n22_ = (~x2 | x5) & (x6 | x2 | ~x7);
  assign new_n23_ = (x3 | (~x2 & x4)) & x1 & (x2 | x7);
  assign z3 = ~new_n25_ & ~x3;
  assign new_n25_ = (x2 | ~x7 | x4 | x0 | ~x1) & ((~x0 & x5) | x1 | ~x2);
  assign z4 = (~x1 & ((x0 & x3 & ~x2 & x7) | (x2 & ~x3))) | (~x0 & (~x2 | x3) & (x2 | x7) & (x1 | x2 | ~x3));
  assign z5 = ~new_n28_ | (~x1 & ((x0 & (x2 ^ x3)) | (x2 & ~x0 & x5)));
  assign new_n28_ = (x2 | x7) & (x0 | (x2 & ~x3) | (~x1 & ~x2 & (x3 | ~x6)));
