...
module FAU ( 
  ...
  assign new_n21_ = (~x2 | (~x5 & x7)) & ~x1 & ~x3 & (x2 | ~x6);
  assign new_n22_ = (~x2 | (x3 & x7)) & x1 & (x3 | x4);
  assign z3 = (x2 & (new_n25_ | ~x7)) | ((~x7 | (~x3 & ~x4)) & new_n24_ & ~x2);
  assign new_n24_ = ~x0 & x1;
  assign new_n25_ = ~x1 & ~x3 & (x0 | ~x5);
  assign z4 = (~x1 & ((x0 & ~x2 & x3) | (x7 & x2 & ~x3))) | ((~x2 | (x3 & x7)) & ~x0 & (x1 | x2 | ~x3));
  assign z5 = ~new_n28_ | (~x1 & ((x0 & (x2 ^ x3)) | (x2 & ~x0 & x5)));
  assign new_n28_ = (~x2 | (x7 & (x0 | (x2 & ~x3)))) & (x0 | (x2 & ~x3) | (~x1 & (x3 | ~x6)));
  assign z6 = new_n30_ | ((~x2 | (x3 & x7)) & new_n24_ & (x3 | ~x4));
  assign new_n30_ = ~x1 & ((x0 & ~x2 & x3) | (x7 & x2 & ~x3)) & ((x0 & ~x2 & x3) | x0 | ~x5);
endmodule
