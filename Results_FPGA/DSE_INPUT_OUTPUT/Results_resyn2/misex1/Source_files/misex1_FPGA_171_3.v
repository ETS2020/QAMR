...
module FAU ( 
  ...
  assign new_n23_ = (~x2 | x3) & (~x3 | ~x7) & x1 & (x3 | x4);
  assign z3 = ~new_n25_ | ((x0 | ~x5) & x2 & ~x1 & ~x3);
  assign new_n25_ = (~x3 | ~x7) & ((x4 & x7) | x2 | x0 | ~x1);
  ...
  assign new_n29_ = (~x3 | ~x7) & (x0 | (x2 & ~x3) | (~x1 & ~x2 & (x3 | ~x6)));
  assign z6 = new_n31_ | new_n32_;
  assign new_n31_ = ~x1 & ((x0 & (x2 ? ~x3 : (x3 & ~x7))) | (x2 & ~x3 & ~x5));
  assign new_n32_ = (~x4 | (x3 & ~x7)) & ~x0 & x1 & (~x3 | ~x7) & (~x2 | x3);
endmodule
