...
module FAU ( 
  ...
  assign z1 = ~new_n19_ & (~x6 | x7);
  assign new_n19_ = (x0 | (~x5 & x2 & ~x3) | (~x1 & ~x2) | (x1 & x2)) & (x0 | x2 | x3 | ~x6) & (~x0 | x1 | x2 | ~x3);
  assign z2 = (~new_n21_ & (~x6 | x7)) | (new_n22_ & (~x6 | (x2 & x7)));
  assign new_n21_ = (~x0 | x1 | x2 | ~x3) & (x0 | ~x1 | (~x3 & (x2 | ~x4)));
  assign new_n22_ = ~x0 & (~x2 | ~x5) & ~x1 & ~x3;
  ...
  assign z5 = ~new_n28_ | ((~x0 | (x2 & ~x3) | (~x2 & x3)) & ~x1 & (x0 | (x2 & x5)));
  assign new_n28_ = (~x6 | x7) & (x0 | ((x2 ? ~x3 : ~x1) & (x2 | x3 | ~x6)));
  assign z6 = new_n30_ | new_n31_ | (x6 & ~x7);
  assign new_n30_ = (x0 | (~x5 & x2 & ~x3)) & ~x1 & (~x2 ^ ~x3);
