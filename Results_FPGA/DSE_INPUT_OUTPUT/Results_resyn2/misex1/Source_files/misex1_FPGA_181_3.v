...
module FAU ( 
  ...
  assign new_n20_ = (~x1 | x2 | (~x3 & ~x4)) & ((~x3 & (x1 | (x2 & x5))) | x6 | (~x1 & x3));
  assign z3 = new_n22_ | new_n23_;
  assign new_n22_ = x2 & (x6 | (~x1 & ~x3 & (x0 | ~x5)));
  assign new_n23_ = (~x7 | (~x3 & ~x4)) & ~x0 & x1 & ~x2;
  assign z4 = (~x1 & ((x0 & ~x2 & x3) | (x2 & ~x3))) | ((x2 | (~x0 & (x1 | ~x3))) & (x6 | (~x0 & (~x2 | x3))));
  assign z5 = (~x1 & ((x0 & (x2 ^ x3)) | (x2 & ~x0 & x5))) | (x2 & x6) | (~x0 & ((x2 & x3) | (~x3 & x6) | (x1 & ~x2)));
