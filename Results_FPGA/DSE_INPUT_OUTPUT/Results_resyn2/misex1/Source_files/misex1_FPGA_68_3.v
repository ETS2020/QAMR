...
module FAU ( 
  ...
  assign z3 = new_n24_ | (~new_n25_ & ~x2 & ~x0 & x1);
  assign new_n24_ = (~x5 | (x0 & ~x7)) & x2 & ~x1 & ~x3;
  assign new_n25_ = x7 & (x4 | x3 | x5);
  ...
  assign z6 = new_n31_ | new_n18_ | new_n32_;
  assign new_n31_ = ~x1 & ((x0 & (~x2 ^ ~x3)) | (~x5 & x2 & ~x3));
