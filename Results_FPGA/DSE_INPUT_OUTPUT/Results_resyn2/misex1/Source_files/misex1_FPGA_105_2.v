...
module FAU ( 
  ...
  assign z5 = (~x1 & ((x0 & (x2 ^ x3)) | (x2 & ~x0 & x5))) | ((x1 | (~x3 & x6)) & ~x0 & ~x2) | (x2 & ((~x0 & x3) | ~x6));
  assign z6 = new_n27_ | new_n28_;
  assign new_n27_ = ~x1 & ((x0 & ~x2 & x3) | (x2 & ~x3 & x6 & (x0 | ~x5)));
  assign new_n28_ = (~x2 | (x3 & x6)) & (x3 | ~x4) & ~x0 & x1;
endmodule
