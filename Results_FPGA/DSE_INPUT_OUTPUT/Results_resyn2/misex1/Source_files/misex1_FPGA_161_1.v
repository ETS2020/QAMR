...
module FAU ( 
  ...
  assign z1 = (~new_n19_ & (x6 | ~x7)) | (~x0 & x6 & ~x2 & ~x3);
  assign new_n19_ = (x1 | ~x0 | x2 | ~x3) & ((~x5 & x2 & ~x3) | x0 | (~x1 ^ x2));
  assign z2 = (~new_n21_ & (x6 | ~x7)) | (new_n22_ & ~x0 & ~x3 & ~x6 & ~x7);
  assign new_n21_ = (x1 | ~x0 | x2 | ~x3) & (x0 | ((~x1 | (~x3 & (x2 | ~x4))) & (x5 | x1 | ~x2 | x3)));
  assign new_n22_ = ~x1 & ~x2;
  assign z3 = new_n24_ | new_n25_ | (~x6 & x7);
  assign new_n24_ = (~x7 | (~x3 & ~x4)) & ~x0 & x1 & ~x2;
  assign new_n25_ = ~x1 & x2 & ~x3 & (x0 | ~x5);
  assign z4 = (~x1 & ((x0 & ~x2 & x3) | (x2 & ~x3))) | (~x6 & x7) | (~x0 & (~x2 | x3) & (x1 | x2 | ~x3));
  assign z5 = ~new_n28_ | (~x1 & ((x0 & (x2 ^ x3)) | (x2 & ~x0 & x5)));
  assign new_n28_ = (x6 | ~x7) & (x0 | (x2 & ~x3) | ((~x6 | x2 | x3) & ~x1 & ~x2));
