// Benchmark "FAU" written by ABC on Wed Aug 12 17:50:28 2020
...
module FAU ( 
  ...
  assign new_n20_ = (~x0 | x1 | x2 | ~x3) & ((~x5 & x2 & ~x3) | ((x3 | ~x6) & ~x1 & ~x2) | x0 | (x1 & x2));
  assign z2 = (~new_n22_ & ~x0) | new_n18_ | (x0 & ~x1 & ~x2 & x3);
  assign new_n22_ = (~x1 | (~x3 & (x2 | ~x4))) & ((x2 & x5) | x1 | x3 | (~x2 & x6));
  assign z3 = (new_n24_ & (~x7 | (~x3 & ~x4))) | new_n25_ | (x4 & ~x7);
