...
module FAU ( 
  ...
  assign z07 = ~new_n39_ | new_n47_ | (~new_n49_ & (x11 | (x00 & x06)));
  assign new_n47_ = new_n48_ & ~x11 & ~x09 & ~x10;
  assign new_n48_ = x08 & x06 & x07;
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x00 & ~x10;
  assign z08 = ~new_n39_ | (new_n47_ ? (x00 | ~x12) : (x12 | (x00 & x06)));
  ...
  assign new_n55_ = (~new_n56_ | new_n40_ | ~new_n48_) & (~new_n40_ | ~x14 | (x00 & x06));
  assign new_n56_ = ~x11 & ~x12 & ~x09 & ~x10 & ~x00 & ~x13;
