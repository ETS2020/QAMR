...
module FAU ( 
  ...
  assign z05 = (~x06 | x13) & ((~x09 & x08 & x06 & x07) | ~new_n39_ | (x09 & (~x08 | ~x06 | ~x07)));
  ...
  assign new_n48_ = x13 & (~new_n49_ | x11 | x09 | x10);
  assign new_n49_ = x07 & x08;
  assign z08 = new_n51_ | ~new_n39_ | (x06 & (new_n52_ | ~x13));
  assign new_n51_ = x12 & (~new_n46_ | x11);
  assign new_n52_ = ~x11 & ~x09 & ~x10 & new_n49_ & ~x12;
  assign z09 = (~new_n39_ & (~x06 | x13)) | (x13 & (~new_n52_ | ~x06));
  assign z10 = new_n55_ | (x06 & ~x13);
  assign new_n55_ = x04 & ((new_n40_ & x14) | (new_n45_ & ~new_n40_ & x00 & x06));
