...
module FAU ( 
  ...
  assign z06 = (x06 & (new_n44_ ? (x08 & ~x10) : x10)) | (~new_n39_ & (x06 | ~x08)) | (~x08 & x10);
  assign new_n44_ = x07 & ~x09;
  assign z07 = (x06 & ((x11 & (~new_n44_ | x10)) | (x08 & new_n44_ & ~x10 & ~x11))) | (~new_n39_ & (x06 | ~x08)) | (~x08 & x11);
  assign z08 = (~new_n39_ & (x06 | ~x08)) | (~x08 & x12) | (x06 & (x12 ? ~new_n47_ : (new_n47_ & x08)));
  assign new_n47_ = x07 & ~x09 & ~x10 & ~x11;
  assign z09 = (~new_n50_ & x13) | (new_n49_ & new_n51_) | ~new_n39_ | new_n52_;
  assign new_n49_ = ~x09 & x07 & x08;
  assign new_n50_ = ~x12 & x08 & x07 & ~x09 & ~x10 & ~x11;
  assign new_n51_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign new_n52_ = ~x06 & (x08 | x13);
  ...
  assign z12 = (x04 | (~x06 & x08)) & ((~x02 & x16) | x03 | (~x06 & x08));
