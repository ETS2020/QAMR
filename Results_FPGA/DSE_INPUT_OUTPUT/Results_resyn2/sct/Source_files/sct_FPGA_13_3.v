...
module FAU ( 
  ...
  assign z04 = x04 & (~x16 | (x02 & ~x03)) & ~new_n37_ & x08;
  assign z05 = ~x04 | (x16 & (~x02 | x03)) | new_n37_ | x09;
  assign z06 = ~x04 | (x16 & (~x02 | x03)) | new_n37_ | x10;
  assign z07 = ~new_n37_ & ((x16 & (~x02 | x03)) | ~x04 | x11);
  assign z08 = ~new_n37_ & ((x16 & (~x02 | x03)) | ~x04 | x12);
  assign z09 = ~x04 | (x16 & (~x02 | x03)) | new_n37_ | x13;
