...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n37_, new_n40_, new_n42_, new_n46_, new_n48_, new_n49_, new_n52_,
    new_n53_, new_n55_;
  ...
  assign z05 = ((x08 | ~x12) & (~new_n42_ | (~x08 & x09))) | ((~x06 | ~x07 | ~x09) & x08 & ((x06 & x07) | x09));
  assign z06 = (~new_n46_ & (x10 | (~x08 & x12))) | ~new_n42_ | (new_n46_ & ~x10);
  assign new_n46_ = x06 & x07 & x08 & ~x09;
  assign z07 = (new_n48_ & ~x11) | (~new_n49_ & x11) | ~new_n42_ | (~x08 & (x11 | x12));
  assign new_n48_ = ~x10 & x06 & x07 & x08 & ~x09;
  assign new_n49_ = ~x09 & ~x10 & x06 & x07;
  assign z08 = (x12 & (~new_n48_ | x11)) | ~new_n42_ | (new_n48_ & ~x11 & ~x12);
  assign z09 = (~x13 & new_n48_ & new_n52_) | ((~new_n49_ | ~new_n52_) & x13) | ~new_n42_ | new_n53_;
  assign new_n52_ = ~x11 & ~x12;
  assign new_n53_ = ~x08 & (x12 | x13);
  assign z10 = new_n37_ | (x04 & ((~new_n55_ & ~new_n40_ & new_n46_) | (new_n40_ & x14)));
