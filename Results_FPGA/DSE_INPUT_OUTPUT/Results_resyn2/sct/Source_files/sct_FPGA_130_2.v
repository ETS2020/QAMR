...
module FAU ( 
  ...
  assign z06 = ~x04 | (x06 & ((new_n46_ & ~x10) | new_n40_ | (~new_n46_ & x10)));
  assign new_n46_ = ~x09 & x07 & x08;
  assign z07 = (x11 & (~new_n46_ | x10)) | ~new_n42_ | (new_n46_ & ~x10 & ~x11);
  assign z08 = (x12 & (~new_n46_ | x10 | x11)) | ~new_n42_ | (new_n46_ & ~x12 & ~x10 & ~x11);
  assign z09 = ~x04 | (~new_n50_ & x06);
  assign new_n50_ = ((new_n46_ & ~x12 & ~x10 & ~x11) | ~x13) & ~new_n40_ & (~new_n46_ | x10 | x11 | x12 | x13);
