...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n45_, new_n46_, new_n48_, new_n50_, new_n51_, new_n53_,
  ...
  assign z07 = (x08 & (new_n45_ | (~x06 & x11))) | ((x06 | (x08 & ~x11)) & (~new_n39_ | (~new_n46_ & x11)));
  assign new_n45_ = x06 & x07 & ~x09 & ~x10 & ~x11;
  assign new_n46_ = ~x10 & ~x09 & x07 & x08;
  assign z08 = ((x06 | (x08 & ~x12)) & (~new_n39_ | (x12 & (~new_n48_ | ~x07 | ~x08)))) | ((x12 | (new_n48_ & x06 & x07)) & x08 & (~x06 | ~x12));
  assign new_n48_ = ~x09 & ~x10 & ~x11;
  assign z09 = ((~new_n50_ | ~new_n51_) & (x13 | (~x06 & ~x08))) | ~new_n39_ | (new_n50_ & new_n51_ & ~x13);
