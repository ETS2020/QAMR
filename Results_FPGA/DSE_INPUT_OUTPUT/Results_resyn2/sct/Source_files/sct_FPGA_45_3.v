...
module FAU ( 
  ...
  assign z03 = new_n39_ & (x06 | x07) & (~x06 | ~x07) & (~x06 | ~x09);
  assign z04 = (x06 & x09) | (new_n39_ & (~x08 | ~x06 | ~x07) & (x08 | (x06 & x07)));
  assign z05 = x09 ? ~x06 : (~new_n39_ | new_n43_);
  assign new_n43_ = x08 & x06 & x07;
  assign z06 = (x10 & (x09 | ~x08 | ~x06 | ~x07)) | ~new_n39_ | (x06 & (x09 | (x07 & x08 & ~x10)));
  assign z07 = (~new_n46_ & ~x09) | (~new_n39_ & (~x06 | ~x09)) | (~x06 & x11);
  assign new_n46_ = (~x11 | (~x10 & x07 & x08)) & (~x08 | ~x06 | ~x07 | x10 | x11);
  assign z08 = (~new_n48_ & x06) | ~new_n39_ | (~new_n49_ & x12);
  assign new_n48_ = ~x09 & (~x07 | ~x08 | x12 | x10 | x11);
  assign new_n49_ = ~x09 & x08 & x06 & x07 & ~x10 & ~x11;
  assign z09 = new_n51_ | new_n54_ | (~x09 & (new_n52_ | (new_n43_ & new_n53_)));
  assign new_n51_ = (~x06 | ~x09) & (~x04 | ((~x02 | x03) & x16));
  assign new_n52_ = x13 & (~x07 | ~x08 | x12 | x10 | x11);
  assign new_n53_ = ~x13 & ~x12 & ~x10 & ~x11;
  assign new_n54_ = ~x06 & x13;
  assign z10 = z13 & ((new_n56_ & x14) | (~new_n56_ & new_n57_ & (new_n53_ | x00)));
  assign new_n56_ = x16 & (~x02 | x03);
  assign new_n57_ = ~x09 & x08 & x06 & x07;
