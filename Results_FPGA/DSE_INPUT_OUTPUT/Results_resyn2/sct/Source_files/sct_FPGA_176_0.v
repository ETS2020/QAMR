...
module FAU ( 
  ...
  assign z07 = (x11 & (~new_n45_ | x10)) | ~new_n41_ | (new_n45_ & ~x10 & ~x11);
  assign z08 = (x06 & (new_n49_ | ~x04)) | (x04 & (new_n39_ | (~new_n48_ & x12)));
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n49_ = x08 & ~x09 & ~x11 & ~x12 & x07 & ~x10;
  assign z09 = (~x13 & new_n48_ & ~x12) | ~new_n41_ | (x13 & (~new_n48_ | x12));
  assign z10 = x04 & ((new_n39_ & x14) | (~new_n52_ & ~new_n39_ & new_n45_));
