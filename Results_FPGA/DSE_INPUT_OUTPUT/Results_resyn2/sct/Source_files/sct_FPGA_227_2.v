...
module FAU ( 
  ...
  assign z03 = ~x07 & ~new_n39_ & x04 & x06;
  assign new_n39_ = x16 & (~x02 | x03);
  assign z04 = x04 & (~x06 | (~new_n39_ & (~x07 | ~x08) & (x07 | x08)));
  assign z05 = new_n39_ | ~x04 | ~x06 | ((~x07 | ~x08) & x09) | (x07 & x08 & ~x09);
  assign z06 = (~new_n43_ & x10) | new_n39_ | ~x04 | ~x06 | (new_n43_ & ~x10);
  assign new_n43_ = ~x09 & x07 & x08;
  assign z07 = ~x04 | (x06 & ((x11 & (~new_n43_ | x10)) | new_n39_ | (new_n43_ & ~x10 & ~x11)));
  assign z08 = ~x04 | (x06 & (((~new_n43_ | ~new_n46_) & x12) | new_n39_ | (new_n43_ & new_n46_ & ~x12)));
