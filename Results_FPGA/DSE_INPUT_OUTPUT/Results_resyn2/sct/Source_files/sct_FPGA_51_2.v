...
module FAU ( 
  ...
  assign z02 = x06 ? ~x09 : new_n40_;
  assign new_n40_ = x04 & (~x16 | (x02 & ~x03));
  assign z03 = (x06 & ~x09) | (new_n40_ & (~x06 | ~x07) & (x06 | x07));
  assign z04 = (x06 & ~x09) | (new_n40_ & (x08 | (x06 & x07)) & (~x08 | ~x06 | ~x07));
  assign z05 = (x09 & (~x08 | ~x06 | ~x07)) | ~new_n40_ | (x06 & ~x09);
  assign z06 = ~new_n37_ & (~new_n40_ | x10);
  assign z07 = x11 | new_n37_ | ~new_n40_;
  assign z08 = x12 | new_n37_ | ~new_n40_;
  assign z09 = x13 | new_n37_ | ~new_n40_;
