...
module FAU ( 
  ...
  assign z03 = (~x04 & x06) | ((x06 | (x04 & x07)) & ((x02 & ~x03) | ~x16) & (~x06 | ~x07));
  ...
  assign z09 = (x13 & (x12 | ~new_n44_ | x10 | x11)) | ~new_n39_ | (new_n44_ & ~x10 & ~x11 & ~x12 & ~x13);
  assign z10 = new_n51_ | (x06 & (~x04 | (~new_n49_ & new_n50_)));
  assign new_n49_ = ~x00 & (x10 | x11 | x12 | x13);
  assign new_n50_ = ((x02 & ~x03) | ~x16) & ~x09 & x07 & x08;
  assign new_n51_ = x04 & x14 & x16 & (~x02 | x03);
