...
module FAU ( 
  ...
  assign z06 = ~x04 | (x06 & ((~new_n45_ & x10) | new_n42_ | (new_n45_ & ~x10)));
  assign new_n45_ = ~x09 & x07 & x08;
  assign z07 = ~x04 | (x06 & (((~new_n45_ | x10) & x11) | new_n42_ | (new_n45_ & ~x10 & ~x11)));
  assign z08 = ~x04 | (x06 & (new_n48_ | new_n42_ | new_n49_));
  ...
  assign z10 = x04 & (~new_n53_ | (~new_n52_ & ~new_n42_ & new_n45_));
