...
module FAU ( 
  ...
  assign z05 = (x06 | ~x09) & (~new_n39_ | (x06 & ((x09 & (~x07 | ~x08)) | (x07 & x08 & ~x09))));
  assign z06 = (~x09 | (x06 & (~new_n39_ | x10))) & ((new_n44_ & x06 & (x09 | ~x10)) | ~new_n39_ | (x10 & (~new_n44_ | ~x06)));
  assign new_n44_ = x07 & x08;
  assign z07 = ~new_n46_ | (x11 & (x10 | ~x07 | ~x08 | x09));
  assign new_n46_ = (~new_n44_ | ~x06 | x10 | x09 | x11) & new_n39_ & (x06 | (~x09 & ~x11));
  assign z08 = new_n50_ | ((x06 | (~x09 & ~x12)) & (~new_n39_ | (~new_n48_ & x12)));
  assign new_n48_ = new_n49_ & x07 & x08 & ~x09;
  assign new_n49_ = ~x10 & ~x11;
  assign new_n50_ = (x12 | (x08 & x06 & x07)) & ~x09 & (~x06 | (new_n49_ & ~x12));
  assign z09 = (~x09 & (new_n52_ | (~x06 & x13))) | ((x06 | (~x09 & ~x13)) & (~new_n39_ | (~new_n54_ & x13)));
  assign new_n52_ = new_n53_ & x08 & new_n49_ & ~x12 & ~x13;
  assign new_n53_ = x06 & x07;
  assign new_n54_ = new_n49_ & ~x12 & x07 & x08 & ~x09;
  assign z10 = (~x06 & x09) | (~new_n56_ & x04);
  assign new_n56_ = (new_n58_ | new_n57_ | ~new_n53_ | ~x08 | x09) & (~new_n57_ | ~x14);
