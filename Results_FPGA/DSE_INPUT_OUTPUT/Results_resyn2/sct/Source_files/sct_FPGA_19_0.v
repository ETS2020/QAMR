...
module FAU ( 
  ...
  assign z06 = (x11 & new_n45_ & ~x10) | (~new_n45_ & x10) | (~new_n40_ & (x10 | x11));
  assign new_n45_ = ~x09 & x08 & x06 & x07;
  assign z07 = (x11 & (~new_n45_ | x10)) | ~new_n40_ | (~x10 & ~x11);
  assign z08 = x12 | new_n37_ | ~new_n40_;
  assign z09 = x13 | new_n37_ | ~new_n40_;
  assign z10 = (new_n37_ | x04) & ((new_n45_ & ~new_n50_ & x00) | new_n37_ | (new_n50_ & x14));
