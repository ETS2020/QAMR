...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n40_, new_n44_, new_n45_, new_n48_, new_n49_, new_n53_;
  ...
  assign z06 = ~x04 | (x06 & ((~new_n45_ & x10) | new_n44_ | (new_n45_ & ~x10)));
  assign new_n44_ = x16 & (~x02 | x03);
  assign new_n45_ = ~x09 & x07 & x08;
  assign z07 = ~x04 | (x06 & (((~new_n45_ | x10) & x11) | new_n44_ | (new_n45_ & ~x10 & ~x11)));
  assign z08 = ~x04 | (x06 & (new_n48_ | new_n44_ | new_n49_));
  assign new_n48_ = x12 & (x09 | ~x07 | ~x08 | x10 | x11);
  assign new_n49_ = ~x09 & x07 & x08 & ~x12 & ~x10 & ~x11;
  assign z09 = (new_n45_ & ~x13 & ~x12 & ~x10 & ~x11) | ~new_n40_ | (x13 & (~new_n45_ | x12 | x10 | x11));
  assign z10 = z13 & ((~new_n53_ & ~new_n44_ & new_n45_) | (new_n44_ & x14));
  assign z13 = x04 & x06;
