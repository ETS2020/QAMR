...
module FAU ( 
  ...
  assign z06 = (x06 & (~x04 | (new_n44_ & ~x10))) | ((new_n39_ | ~new_n44_ | ~x06) & x04 & (new_n39_ | x10));
  assign new_n44_ = ~x09 & x07 & x08;
  assign z07 = (x11 & (~new_n46_ | x09 | x10)) | (new_n46_ & ~x09 & ~x10 & ~x11) | new_n39_ | ~x04;
  assign new_n46_ = x06 & x07 & x08;
  assign z08 = (x06 & (new_n49_ | ~x04)) | (x04 & (new_n39_ | (~new_n48_ & x12)));
  assign new_n48_ = ~x09 & ~x10 & ~x11 & x06 & x07 & x08;
  assign new_n49_ = ~x09 & x07 & x08 & ~x10 & ~x11 & ~x12;
  assign z09 = (x13 & (~new_n48_ | x12)) | ~new_n52_ | (new_n51_ & new_n53_);
  assign new_n51_ = x06 & ~x09 & x07 & x08;
  assign new_n52_ = x04 & (~x16 | (x02 & ~x03));
  assign new_n53_ = ~x13 & ~x12 & ~x10 & ~x11;
  assign z10 = x04 & (((new_n53_ | x00) & ~new_n39_ & new_n51_) | (new_n39_ & x14));
