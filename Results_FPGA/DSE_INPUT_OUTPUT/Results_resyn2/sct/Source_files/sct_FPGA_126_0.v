...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n42_, new_n45_, new_n48_, new_n49_, new_n52_;
  ...
  assign z04 = (~x04 & ~x06) | (~new_n42_ & (x04 | ~x06) & (~x08 | ~x06 | ~x07) & (x08 | (x06 & x07)));
  ...
  assign z08 = (x06 & (new_n49_ | ~x04)) | (x04 & (new_n42_ | (~new_n48_ & x12)));
  assign new_n48_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n49_ = x08 & ~x09 & ~x11 & ~x12 & x07 & ~x10;
  assign z09 = (~x13 & new_n48_ & ~x12) | ~new_n39_ | (x13 & (~new_n48_ | x12));
  assign z10 = x04 & ((new_n42_ & x14) | (~new_n52_ & ~new_n42_ & new_n45_));
