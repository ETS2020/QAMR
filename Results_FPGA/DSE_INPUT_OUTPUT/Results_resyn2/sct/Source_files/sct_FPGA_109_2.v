...
module FAU ( 
  ...
  assign z05 = (x09 & (~x07 | (x11 & (~x06 | ~x08)))) | (~new_n40_ & (~x07 | x11)) | (x08 & ~x09 & x06 & x07 & x11);
  assign z06 = new_n45_ | (~new_n40_ & (~x07 | x11)) | (new_n46_ & x11 & x06 & x07);
  assign new_n45_ = x10 & (~x07 | (x11 & (x09 | ~x06 | ~x08)));
  assign new_n46_ = ~x10 & x08 & ~x09;
  assign z07 = (~new_n40_ & (~x07 | x11)) | (x11 & (~new_n46_ | ~x06 | ~x07));
  ...
  assign new_n53_ = (~x07 | x11) & (~x14 | (x02 & ~x03) | ~x16);
