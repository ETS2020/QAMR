...
module FAU ( 
  ...
  assign z06 = ((~new_n44_ | ~x06) & (x10 | (~x06 & x08))) | ~new_n39_ | (new_n44_ & ~x10);
  assign new_n44_ = ~x09 & x07 & x08;
  assign z07 = (x11 & (~new_n44_ | x10)) | (new_n44_ & ~x10 & ~x11) | ~new_n39_ | (~x06 & (x08 | x11));
  assign z08 = (~new_n47_ & x06) | ((x06 | ~x08) & (~new_n39_ | (~x08 & x12)));
  assign new_n47_ = x12 ? (~x10 & ~x11 & x07 & ~x09) : (x09 | ~x07 | ~x08 | x10 | x11);
  assign z09 = (~new_n49_ ^ ~x13) | ~new_n39_ | (~x06 & (x08 | x13));
  assign new_n49_ = ~x12 & ~x09 & x07 & x08 & ~x10 & ~x11;
  assign z10 = x04 & ((~new_n52_ & ~new_n51_ & new_n44_ & x06) | (new_n51_ & new_n53_));
  assign new_n51_ = x16 & (~x02 | x03);
  assign new_n52_ = ~x00 & (x10 | x11 | x12 | x13);
  assign new_n53_ = x14 & (x06 | ~x08);
