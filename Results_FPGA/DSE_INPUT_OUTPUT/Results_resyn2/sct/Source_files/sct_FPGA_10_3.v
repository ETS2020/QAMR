...
module FAU ( 
  ...
  wire new_n39_, new_n40_, new_n44_, new_n45_, new_n46_, new_n48_, new_n50_,
    new_n51_, new_n53_, new_n54_, new_n57_, new_n58_;
  assign z00 = (~x01 | ~x02) & (~x06 | ~x18) & (x01 | ~x14);
  assign z01 = (~x05 | ~x04 | (x06 & x18)) & (x05 | x06 | x15 | ~x18);
  ...
  assign new_n44_ = x06 & (new_n45_ | x18);
  assign new_n45_ = ~x09 & x07 & x08;
  assign new_n46_ = ~x18 & x08 & x06 & x07;
  assign z06 = (~new_n44_ & x10) | new_n48_ | (new_n46_ & ~x09 & ~x10);
  assign new_n48_ = (new_n40_ | ~x04) & (~x06 | ~x18);
  assign z07 = (~new_n50_ & x11) | new_n48_ | (new_n51_ & ~x10 & ~x11);
  assign new_n50_ = x06 & (x18 | (new_n45_ & ~x10));
  assign new_n51_ = new_n46_ & ~x09;
  assign z08 = ~new_n39_ | new_n53_ | (x12 & (~new_n51_ | x10 | x11));
  assign new_n53_ = x06 & (x18 | (new_n45_ & new_n54_));
  assign new_n54_ = ~x12 & ~x10 & ~x11;
  assign z09 = (~new_n53_ & x13) | new_n48_ | (new_n51_ & new_n54_ & ~x13);
  assign z10 = ~new_n57_ & x04 & (~x06 | ~x18);
  assign new_n57_ = (~new_n40_ | ~x14) & (new_n58_ | ~new_n46_ | new_n40_ | x09);
  assign new_n58_ = ~x00 & (x13 | x12 | x10 | x11);
