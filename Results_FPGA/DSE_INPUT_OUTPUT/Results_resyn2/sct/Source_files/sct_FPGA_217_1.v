...
module FAU ( 
  ...
  assign z04 = ((x06 & x07) | (x08 & (x06 | ~x11))) & new_n40_ & (~x08 | ~x06 | ~x07);
  assign z05 = (x06 | ~x11) & ((x09 & (~x08 | ~x06 | ~x07)) | ~new_n40_ | (x06 & x07 & x08 & ~x09));
  assign z06 = (~new_n45_ & (x10 | (~x06 & x11))) | ~new_n40_ | (new_n45_ & ~x10);
  assign new_n45_ = x06 & x07 & x08 & ~x09;
  assign z07 = (x11 & (~new_n45_ | x10)) | ~new_n40_ | (new_n45_ & ~x10 & ~x11);
  assign z08 = ((x06 | (~x11 & ~x12)) & (~new_n40_ | (~new_n49_ & x12))) | ((new_n48_ | x12) & ~x11 & (~x06 | ~x12));
