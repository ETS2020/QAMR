...
module FAU ( 
  ...
  assign z02 = (x09 & x14) | (new_n39_ & ~x06);
  ...
  assign z05 = ~new_n39_ | (x09 & x14) | (~new_n43_ & x09) | (new_n43_ & ~x09);
  assign new_n43_ = x08 & x06 & x07;
  assign z06 = (~x09 | ~x14) & ((x10 & (~new_n43_ | x09)) | ~new_n39_ | (~x10 & new_n43_ & ~x09));
  assign z07 = (~x11 & ~x10 & new_n43_ & ~x09) | ~new_n39_ | ((x10 | ~new_n43_ | x09) & (x11 | (x09 & x14)));
  assign z08 = (x12 & (~new_n43_ | ~new_n47_)) | (new_n43_ & ~x09 & new_n47_ & ~x12) | ~new_n39_ | (x09 & (x12 | x14));
  assign new_n47_ = ~x10 & ~x11;
  assign z09 = ((~new_n39_ | (x09 & x13)) & (~x09 | ~x14)) | ((new_n49_ | x13) & ~x09 & (~new_n49_ | ~x13));
  assign new_n49_ = x08 & x06 & x07 & ~x12 & ~x10 & ~x11;
  assign z10 = (x04 | (x09 & x14)) & ((x14 & (new_n51_ | x09)) | (~new_n52_ & ~new_n51_ & new_n43_ & ~x09));
  ...
  assign z14 = (x17 | (x09 & x14)) & (x04 | (x09 & x14));
endmodule
