...
module FAU ( 
  ...
  assign z07 = (~x06 & (~x04 | x11)) | (x04 & ((new_n46_ & ~x11) | new_n39_ | (~new_n47_ & x11)));
  assign new_n46_ = new_n44_ & ~x10;
  assign new_n47_ = x08 & ~x09 & x07 & ~x10;
  assign z08 = (~x06 & (~x04 | x12)) | (x04 & ((x12 & (~new_n47_ | x11)) | new_n39_ | (new_n47_ & x06 & ~x11 & ~x12)));
  assign z09 = (~new_n50_ & x04) | (~x06 & (~x04 | x13));
  assign new_n50_ = ~new_n39_ & (~new_n44_ | ~new_n51_ | x10 | x13) & ((new_n47_ & new_n51_) | ~x13);
