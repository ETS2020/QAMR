...
module FAU ( 
  ...
  assign z06 = (~x00 & (new_n45_ | (~new_n44_ & x10))) | (~new_n39_ & (~x00 | ~x06)) | (~x06 & x10);
  assign new_n44_ = ~x09 & x07 & x08;
  assign new_n45_ = ~x10 & ~x09 & x08 & x06 & x07;
  assign z07 = (~new_n39_ & (~x00 | ~x06)) | (~x06 & x11) | (~x00 & (x11 ? ~new_n47_ : new_n45_));
  assign new_n47_ = ~x10 & ~x09 & x07 & x08;
  assign z08 = (x12 & (~new_n45_ | x11)) | (new_n45_ & ~x11 & ~x12) | ~new_n39_ | (x00 & (x06 | x12));
  assign z09 = ~new_n52_ | (x06 & (x00 | (new_n50_ & x04)));
  assign new_n50_ = new_n47_ & ~new_n51_ & ~x13 & ~x11 & ~x12;
  assign new_n51_ = x16 & (~x02 | x03);
  assign new_n52_ = new_n39_ & (~x13 | (new_n45_ & ~x11 & ~x12));
