...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n37_, new_n40_, new_n45_, new_n48_, new_n49_, new_n51_, new_n52_,
  ...
  assign z05 = ((~x08 | ~x06 | ~x07) & (x09 | (~x06 & x11))) | ~new_n40_ | (x06 & x07 & x08 & ~x09);
  assign z06 = (new_n45_ & ~x10) | ~new_n40_ | (~new_n45_ & (x10 | (~x06 & x11)));
  assign new_n45_ = x06 & x07 & x08 & ~x09;
  assign z07 = (x11 & (~new_n45_ | x10)) | ~new_n40_ | (new_n45_ & ~x10 & ~x11);
  assign z08 = ((new_n48_ | x12) & ~x11 & (~x06 | ~x12)) | (~new_n40_ & (x06 | (~x11 & ~x12))) | (~new_n49_ & x06 & x12);
  assign new_n48_ = ~x10 & x06 & x07 & x08 & ~x09;
  assign new_n49_ = ~x10 & ~x11 & x07 & x08 & ~x09;
  assign z09 = (~new_n51_ & x13) | (new_n45_ & new_n52_) | ~new_n40_ | new_n53_;
  assign new_n51_ = ~x12 & ~x10 & ~x11 & x07 & x08 & ~x09;
  ...
  assign new_n56_ = ~x00 & (x10 | x12 | x11 | x13);
