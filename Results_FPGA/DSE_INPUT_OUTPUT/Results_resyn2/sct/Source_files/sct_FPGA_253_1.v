...
module FAU ( 
  ...
  assign z03 = ((x07 & ((x02 & ~x03) | ~x16)) | (~x16 & x03 & x06)) & x04 & (~x06 | ~x07);
  assign z04 = new_n41_ | (~x03 & (x06 | (x08 & x02 & x04)));
  assign new_n41_ = ((x06 & x07) | (x08 & (x03 | ~x06))) & x04 & ~x16 & (~x06 | ~x07 | ~x08);
  assign z05 = (x03 | ~x06) & (~new_n44_ | (x03 & ((new_n43_ & x06 & ~x09) | x16 | (~new_n43_ & x09))));
  assign new_n43_ = x07 & x08;
  assign new_n44_ = x04 & (x06 | (~x09 & (x02 | ~x16)));
  ...
  assign z07 = (x11 & (~new_n46_ | x10)) | (x16 & (~new_n49_ | x11)) | ~new_n50_ | (new_n46_ & ~x10 & ~x11);
  assign new_n49_ = x02 & ~x03;
  assign new_n50_ = x04 & (x03 | (~x06 & ~x11));
  assign z08 = (x12 & (~new_n46_ | x10 | x11)) | ~new_n52_ | (~x12 & new_n46_ & ~x10 & ~x11);
  assign new_n52_ = (~x16 | (~x12 & x02 & ~x03)) & x04 & (x03 | (~x06 & ~x12));
  assign z09 = (x13 & (x12 | ~new_n46_ | x10 | x11)) | ~new_n54_ | (new_n46_ & ~x10 & ~x11 & ~x12 & ~x13);
  assign new_n54_ = (x03 | (~x06 & ~x13)) & x04 & ((x02 & ~x03) | ~x16);
  assign z10 = (~x03 & x06) | (x04 & (new_n58_ | (~new_n56_ & new_n57_)));
  assign new_n56_ = ~x00 & (x12 | x13 | x10 | x11);
  assign new_n57_ = ~x16 & x07 & x08 & x06 & ~x09;
