...
module FAU ( 
  ...
  assign z05 = (~x09 & x08 & x06 & x07) | ~new_n39_ | ((~x08 | ~x06 | ~x07) & (x09 | (~x01 & ~x06)));
  assign z06 = (x01 | x06) & ((new_n44_ & ~x10) | ~new_n39_ | (~new_n44_ & x10));
  assign new_n44_ = ~x09 & x08 & x06 & x07;
  assign z07 = (x01 | x06) & ((x06 & (~new_n46_ ^ ~x11)) | ~new_n39_ | (~x06 & x11));
  assign new_n46_ = x07 & x08 & ~x09 & ~x10;
  assign z08 = new_n48_ | (new_n44_ & new_n49_) | ~new_n39_ | new_n50_;
  assign new_n48_ = x12 & (x11 | ~x07 | ~x08 | x09 | x10);
  assign new_n49_ = ~x10 & ~x11 & ~x12;
  assign new_n50_ = ~x06 & (~x01 | x12);
  assign z09 = (~new_n52_ & x13) | ~new_n39_ | new_n53_ | (new_n44_ & new_n49_ & ~x13);
  assign new_n52_ = x07 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n53_ = ~x06 & (~x01 | x13);
  assign z10 = x04 & ((~new_n56_ & ~new_n55_ & new_n44_) | (new_n55_ & new_n57_));
  assign new_n55_ = x16 & (~x02 | x03);
  assign new_n56_ = ~x00 & (x13 | x10 | x11 | x12);
  assign new_n57_ = x14 & (x01 | x06);
