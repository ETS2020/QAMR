...
module FAU ( 
  ...
  assign z03 = ~new_n37_ & x04 & ~new_n42_ & (~x06 | ~x07) & (x06 | x07);
  ...
  assign z07 = ~new_n37_ & ((x11 & (~new_n46_ | x10)) | ~new_n40_ | (new_n46_ & ~x10 & ~x11));
  assign z08 = (~new_n49_ & x12) | ~new_n40_ | (new_n49_ & (~x12 | ~x17));
  assign new_n49_ = x08 & ~x09 & x06 & x07 & ~x10 & ~x11;
  assign z09 = ((~x12 | x17) & (~new_n40_ | (x12 & x13))) | ((~new_n49_ | ~x13) & ~x12 & (new_n49_ | x13));
  assign z10 = new_n37_ | (x04 & ((~new_n52_ & ~new_n42_ & new_n46_) | (new_n42_ & x14)));
