...
module FAU ( 
  ...
  assign z01 = (~x18 | x05 | x15) & (x06 | ~x11) & (~x04 | ~x05);
  assign z02 = new_n39_ & ~x06 & ~x11;
  ...
  assign z05 = ((~x08 | ~x06 | ~x07) & (x09 | (~x06 & x11))) | ~new_n39_ | (x06 & x07 & x08 & ~x09);
  assign z06 = ((x06 | ~x11) & (~new_n39_ | (~x06 & x10))) | ((~new_n44_ | ~x10) & x06 & (new_n44_ | x10));
  assign new_n44_ = x07 & x08 & ~x09;
  assign z07 = (x11 & (~new_n46_ | ~x08 | x09 | x10)) | ~new_n39_ | (new_n46_ & x08 & ~x09 & ~x10 & ~x11);
  assign new_n46_ = x06 & x07;
  assign z08 = (x12 & (~new_n44_ | x10 | x11)) | ~new_n48_ | (~x12 & new_n49_ & ~x10 & ~x11);
  assign new_n48_ = new_n39_ & (x06 | (~x11 & ~x12));
  assign new_n49_ = x06 & x07 & x08 & ~x09;
  assign z09 = (~x11 & (new_n51_ | (~x06 & x13))) | (~new_n39_ & (x06 | (~x11 & ~x13))) | (~new_n52_ & x06 & x13);
  assign new_n51_ = new_n46_ & x08 & ~x12 & ~x13 & ~x09 & ~x10;
  assign new_n52_ = new_n44_ & ~x10 & ~x11 & ~x12;
  assign z10 = ~new_n54_ & x04;
  assign new_n54_ = (new_n56_ | new_n55_ | ~new_n49_) & (~new_n55_ | ~x14 | (~x06 & x11));
