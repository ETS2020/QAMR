...
module FAU ( 
  ...
  assign z05 = (~new_n44_ & x09) | ~new_n41_ | (new_n44_ & ~x09);
  assign new_n44_ = x08 & x06 & x07;
  assign z06 = (x10 & (~new_n44_ | x09)) | ~new_n41_ | (new_n44_ & ~x09 & ~x10);
  assign z07 = (~x06 & (~x04 | x11)) | (x04 & (new_n47_ | new_n39_ | (~new_n48_ & x11)));
  assign new_n47_ = ~x09 & x08 & x06 & x07 & ~x10 & ~x11;
  assign new_n48_ = x07 & x08 & ~x09 & ~x10;
  assign z08 = new_n50_ | (x04 & (new_n51_ | new_n39_ | (new_n44_ & new_n52_)));
  assign new_n50_ = ~x06 & (~x04 | x12);
  assign new_n51_ = x12 & (x11 | ~x07 | ~x08 | x09 | x10);
  assign new_n52_ = ~x11 & ~x12 & ~x09 & ~x10;
  assign z09 = (x13 & (~new_n44_ | ~new_n54_ | x09 | x10)) | ~new_n41_ | (new_n44_ & ~x09 & new_n54_ & ~x10 & ~x13);
