...
module FAU ( 
  ...
  assign z06 = (x06 & (~x04 | (new_n45_ & x07 & ~x10))) | ((new_n39_ | x10) & x04 & (new_n39_ | ~new_n45_ | ~x06 | ~x07));
  assign new_n45_ = x08 & ~x09;
  assign z07 = (x06 & (new_n47_ | ~x04)) | (x04 & (new_n39_ | new_n48_));
  assign new_n47_ = ~x11 & x08 & ~x09 & x07 & ~x10;
  assign new_n48_ = x11 & (x10 | ~x06 | ~x07 | ~x08 | x09);
  assign z08 = (x06 & (~x04 | (new_n47_ & ~x12))) | (x04 & (new_n39_ | (~new_n50_ & x12)));
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = (x13 & (~new_n53_ | ~x06)) | ~new_n41_ | (new_n52_ & new_n54_);
  assign new_n52_ = x06 & x07 & x08 & ~x09;
  assign new_n53_ = ~x12 & ~x11 & x08 & ~x09 & x07 & ~x10;
  assign new_n54_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = x04 ? ((~new_n56_ & ~new_n39_ & new_n52_) | (new_n39_ & x14)) : ~x06;
