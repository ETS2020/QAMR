...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n45_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_,
  ...
  assign z05 = ~new_n39_ | (~x09 & x07 & x08) | ~x06 | (x09 & (~x07 | ~x08));
  assign z06 = ((~x09 | x10) & (~x06 | (~x10 & x07 & x08))) | ~new_n39_ | (x10 & (x09 | ~x07 | ~x08));
  assign z07 = (x06 & ((x11 & (~new_n45_ | x10)) | (~x09 & new_n45_ & ~x10 & ~x11))) | (~new_n39_ & (x06 | x09)) | (x09 & x11);
  assign new_n45_ = x07 & x08;
  assign z08 = (x06 & (x12 ? ~new_n47_ : (new_n47_ & ~x09))) | (~new_n39_ & (x06 | x09)) | (x09 & x12);
  assign new_n47_ = x07 & x08 & ~x10 & ~x11;
  assign z09 = (~new_n50_ & x13) | (new_n49_ & new_n51_) | ~new_n39_ | new_n52_;
  assign new_n49_ = ~x09 & x07 & x08;
  assign new_n50_ = ~x12 & ~x09 & x07 & x08 & ~x10 & ~x11;
  assign new_n51_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign new_n52_ = ~x06 & (~x09 | x13);
  assign z10 = x04 & ((~new_n55_ & new_n49_ & ~new_n54_ & x06) | (new_n54_ & new_n56_));
  assign new_n54_ = x16 & (~x02 | x03);
  assign new_n55_ = ~x00 & (x10 | x11 | x12 | x13);
  assign new_n56_ = x14 & (x06 | x09);
