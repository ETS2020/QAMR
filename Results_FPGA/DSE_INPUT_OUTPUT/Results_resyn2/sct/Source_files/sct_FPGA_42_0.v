...
module FAU ( 
  ...
  assign z04 = (~x06 & (new_n40_ | ~x08)) | (new_n40_ & (~x07 | ~x08) & (x07 | x08));
  assign z05 = ((~x06 | ~x07 | ~x08) & ((~x06 & ~x08) | x09)) | ~new_n40_ | (x06 & x07 & x08 & ~x09);
  assign z06 = ~new_n40_ | (~x06 & (~x08 | x10)) | (x10 & (~x07 | ~x08 | x09)) | (x06 & x07 & x08 & ~x09 & ~x10);
  assign z07 = new_n46_ | ~new_n40_ | new_n47_;
  ...
  assign z10 = new_n37_ | (x04 & ((~new_n58_ & ~new_n57_ & new_n52_) | (new_n57_ & x14)));
