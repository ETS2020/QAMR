...
module FAU ( 
  ...
  assign z05 = new_n40_ | ~x04 | ~x06 | ((~x07 | ~x08) & x09) | (x07 & x08 & ~x09);
  ...
  assign z08 = ~x04 | (x06 & ((x12 & (~new_n44_ | ~new_n47_)) | new_n40_ | (new_n44_ & new_n47_ & ~x12)));
  assign new_n47_ = ~x10 & ~x11;
  assign z09 = ~x04 | (~new_n49_ & x06);
  assign new_n49_ = (~x13 | (new_n44_ & new_n47_ & ~x12)) & ~new_n40_ & (~new_n44_ | ~new_n47_ | x12 | x13);
