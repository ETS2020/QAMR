...
module FAU ( 
  ...
  assign z05 = (~new_n39_ & (x06 | (x08 & ~x09))) | ((~x08 | ~x06 | ~x07) & x09 & (x06 | x08)) | (x06 & x07 & x08 & ~x09);
  assign z06 = ((x10 | (~x09 & x06 & x07)) & x08 & (~x06 | ~x10)) | (x06 & x10 & (~x07 | ~x08 | x09)) | (~new_n39_ & (x06 | (x08 & ~x10)));
  assign z07 = (~new_n45_ & x08) | ((x06 | (x08 & ~x11)) & (~new_n39_ | (~new_n46_ & x11)));
  assign new_n45_ = (x06 | ~x11) & (x09 | ~x06 | ~x07 | x10 | x11);
  assign new_n46_ = ~x10 & x07 & x08 & ~x09;
  assign z08 = new_n49_ | (new_n48_ & new_n50_) | ~new_n39_ | new_n51_;
  assign new_n48_ = x06 & x07 & x08 & ~x09;
  assign new_n49_ = x12 & (x11 | x10 | ~x07 | ~x08 | x09);
  assign new_n50_ = ~x12 & ~x10 & ~x11;
  assign new_n51_ = ~x06 & (~x08 | x12);
  assign z09 = (new_n48_ & new_n50_ & ~x13) | ~new_n39_ | ((~new_n48_ | ~new_n50_) & (x13 | (~x06 & ~x08)));
  assign z10 = x04 & ((~new_n55_ & ~new_n54_ & new_n48_) | (new_n54_ & new_n56_));
