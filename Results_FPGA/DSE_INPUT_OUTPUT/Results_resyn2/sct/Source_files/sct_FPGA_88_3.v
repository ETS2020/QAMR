...
module FAU ( 
  ...
  assign z07 = (~x10 | ~x12) & ((x11 & (~new_n45_ | x10)) | ~new_n40_ | (new_n45_ & ~x10 & ~x11));
  assign z08 = (x12 & (~new_n45_ | x10 | x11)) | ~new_n40_ | (~x10 & new_n45_ & ~x11 & ~x12);
  assign z09 = ((~x10 | (~x12 & ~x13)) & (~new_n40_ | (x13 & (~new_n45_ | x11 | x12)))) | ((x13 | (new_n45_ & ~x10 & ~x11)) & ~x12 & (x10 | ~x13));
