...
module FAU ( 
  ...
  assign z06 = (x06 & new_n45_ & ~x10) | ~new_n39_ | (~new_n44_ & (x10 | (~x05 & ~x06)));
  assign new_n44_ = ~x09 & x08 & x06 & x07;
  assign new_n45_ = ~x09 & x07 & x08;
  assign z07 = (x06 & ((x11 & (~new_n45_ | x10)) | (new_n45_ & ~x10 & ~x11))) | ((x05 | x06) & (~new_n39_ | (~x06 & x11)));
  assign z08 = (x06 & (~new_n48_ ^ ~x12)) | ((x05 | x06) & (~new_n39_ | (~x06 & x12)));
  assign new_n48_ = ~x10 & ~x11 & ~x09 & x07 & x08;
  assign z09 = (~new_n50_ & x13) | (new_n44_ & new_n51_) | ~new_n39_ | new_n52_;
  assign new_n50_ = ~x12 & ~x10 & ~x11 & ~x09 & x07 & x08;
  assign new_n51_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign new_n52_ = ~x06 & (~x05 | x13);
