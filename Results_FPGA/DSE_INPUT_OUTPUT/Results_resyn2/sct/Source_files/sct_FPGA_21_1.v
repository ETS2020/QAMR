...
module FAU ( 
  ...
  assign z06 = (~new_n46_ & (x10 | x11)) | ~new_n43_ | (new_n46_ & ~x10);
  assign new_n46_ = x06 & x07 & x08 & ~x09;
  assign z07 = x11 ? x10 : (~new_n43_ | (new_n46_ & ~x10));
  assign z08 = (~x10 & (x11 | (new_n46_ & ~x12))) | ~new_n43_ | (x12 & (x11 | ~new_n46_ | x10));
  assign z09 = (~x11 & ((x13 & (~new_n46_ | x12)) | (new_n46_ & ~x10 & ~x12 & ~x13))) | (~new_n43_ & (x10 | ~x11)) | (x10 & x13);
