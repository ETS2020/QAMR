...
module FAU ( 
  ...
  assign z05 = (x06 & ~x09 & x07 & x08) | ~new_n39_ | (x09 & (~x08 | ~x06 | ~x07));
  assign z06 = ((x06 | (~x09 & ~x10)) & (~new_n39_ | (x10 & (x09 | ~x07 | ~x08)))) | ((x10 | (x08 & x06 & x07)) & ~x09 & (~x06 | ~x10));
  assign z07 = ~new_n45_ | ~new_n39_ | (~x06 & (x09 | x11));
  assign new_n45_ = (~x08 | ~x06 | ~x07 | x11 | x09 | x10) & (~x11 | (x07 & x08 & ~x09 & ~x10));
  assign z08 = (new_n47_ & ~x12) | (~new_n48_ & x12) | ~new_n39_ | (~x06 & (x09 | x12));
  assign new_n47_ = x08 & x06 & x07 & ~x11 & ~x09 & ~x10;
  assign new_n48_ = ~x11 & x07 & x08 & ~x09 & ~x10;
  assign z09 = (~new_n51_ & (~new_n52_ | ~new_n53_)) | ~new_n39_ | (new_n50_ & new_n54_);
  assign new_n50_ = x06 & ~x09 & x07 & x08;
  assign new_n51_ = ~x13 & (x06 | ~x09);
  assign new_n52_ = x06 & x07 & x08;
  assign new_n53_ = ~x10 & ~x11 & ~x09 & ~x12;
  assign new_n54_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = x04 & ((~new_n56_ & new_n50_ & (new_n54_ | x00)) | (new_n56_ & new_n57_));
