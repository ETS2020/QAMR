...
module FAU ( 
  ...
  assign z04 = new_n39_ & (~x06 | ~x07 | ~x08) & (~x06 | ~x09) & (x08 | (x06 & x07));
  assign z05 = x09 ? ~x06 : (~new_n39_ | (new_n43_ & x06));
  assign new_n43_ = x07 & x08;
  assign z06 = (~x06 | ~x09) & ((~x10 & new_n43_ & x06) | ~new_n39_ | (x10 & (~new_n43_ | ~x06)));
  assign z07 = (x11 & (x09 | x10 | ~new_n43_ | ~x06)) | ~new_n39_ | (x06 & (x09 | (new_n43_ & ~x10 & ~x11)));
  assign z08 = (~new_n47_ & ~x09) | (~new_n39_ & (~x06 | ~x09)) | (~x06 & x12);
  assign new_n47_ = (~x12 | (x07 & x08 & ~x10 & ~x11)) & (~x06 | ~x07 | ~x08 | x12 | x10 | x11);
  assign z09 = ((x13 | (new_n49_ & new_n43_ & x06)) & ~x09 & (~new_n49_ | ~new_n43_ | ~x13)) | (~new_n39_ & (~x06 | ~x09)) | (~x06 & x13);
  assign new_n49_ = ~x12 & ~x10 & ~x11;
  assign z10 = (x06 & x09) | (x04 & (new_n53_ | (~new_n51_ & new_n52_)));
  assign new_n51_ = ~x00 & (x10 | x11 | x12 | x13);
  assign new_n52_ = (~x16 | (x02 & ~x03)) & x06 & x07 & x08;
