...
module FAU ( 
  ...
  assign z06 = (x06 & (x18 | (new_n44_ & ~x10))) | ~new_n39_ | (x10 & (~new_n45_ | x18));
  assign new_n44_ = x07 & x08 & ~x09;
  assign new_n45_ = x06 & x07 & x08 & ~x09;
  assign z07 = (x11 & (~x06 | (~x18 & (~new_n44_ | x10)))) | (~new_n39_ & (~x06 | ~x18)) | (new_n44_ & ~x10 & ~x18 & x06 & ~x11);
  assign z08 = (x06 & (x18 | (new_n44_ & new_n49_))) | new_n48_ | ~new_n39_;
  assign new_n48_ = x12 & (~new_n44_ | x10 | x18 | ~x06 | x11);
