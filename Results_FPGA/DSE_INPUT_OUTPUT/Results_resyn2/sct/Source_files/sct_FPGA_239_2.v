...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n40_, new_n42_, new_n45_, new_n48_, new_n52_;
  ...
  assign z05 = ~x04 | (x06 & (((~x07 | ~x08) & x09) | new_n42_ | (x07 & x08 & ~x09)));
  assign z06 = ~x04 | (x06 & ((x10 & (~new_n45_ | x09)) | new_n42_ | (new_n45_ & ~x09 & ~x10)));
  assign new_n45_ = x07 & x08;
  assign z07 = (~x10 & ~x11 & ~x09 & x07 & x08) | ~new_n40_ | (x11 & (~x07 | ~x08 | x09 | x10));
  ...
  assign z10 = z13 & ((~new_n52_ & ~new_n42_ & new_n48_) | (new_n42_ & x14));
  assign z13 = x04 & x06;
