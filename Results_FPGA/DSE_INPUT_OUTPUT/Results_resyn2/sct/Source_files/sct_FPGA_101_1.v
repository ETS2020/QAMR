...
module FAU ( 
  ...
  assign z07 = (x06 & ((x11 & (~new_n47_ | x10)) | (new_n47_ & ~x10 & ~x11))) | ((x06 | ~x17) & (~new_n40_ | (~x06 & x11)));
  assign new_n47_ = x07 & x08 & ~x09;
  assign z08 = (x06 & (new_n49_ ^ x12)) | ((x06 | ~x17) & (~new_n40_ | (~x06 & x12)));
