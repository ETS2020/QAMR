...
module FAU ( 
  ...
  assign z05 = (x00 | x06) & ((x06 & ~x09 & x07 & x08) | ~new_n40_ | ((~x08 | ~x06 | ~x07) & x09));
  assign z06 = ~new_n37_ & ((new_n45_ & ~x10) | ~new_n40_ | (~new_n45_ & x10));
  assign new_n45_ = x06 & ~x09 & x07 & x08;
  assign z07 = (x06 & ((x11 & (~new_n47_ | x10)) | (new_n47_ & ~x10 & ~x11))) | ((x00 | x06) & (~new_n40_ | (~x06 & x11)));
  assign new_n47_ = ~x09 & x07 & x08;
  assign z08 = (x06 & (~new_n49_ ^ ~x12)) | ((x00 | x06) & (~new_n40_ | (~x06 & x12)));
  assign new_n49_ = ~x09 & x07 & x08 & ~x10 & ~x11;
  assign z09 = (~new_n51_ & x13) | (new_n45_ & new_n52_) | ~new_n40_ | new_n53_;
  assign new_n51_ = ~x12 & ~x09 & x07 & x08 & ~x10 & ~x11;
