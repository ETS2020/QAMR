...
module FAU ( 
  ...
  assign z06 = ~new_n39_ | (~x06 & (x08 | x10)) | (new_n44_ & ~x10) | (~new_n44_ & x10);
  assign new_n44_ = ~x09 & x07 & x08;
  assign z07 = (~new_n46_ & x06) | (~new_n39_ & (x06 | ~x08)) | (~x08 & x11);
  assign new_n46_ = (~x11 | (~x10 & x07 & ~x09)) & (x10 | x11 | x09 | ~x07 | ~x08);
  assign z08 = (x12 & (~new_n44_ | ~new_n48_)) | (new_n44_ & new_n48_ & ~x12) | ~new_n39_ | (~x06 & (x08 | x12));
  assign new_n48_ = ~x10 & ~x11;
  assign z09 = (x06 & (new_n51_ | (new_n44_ & new_n52_))) | new_n50_ | new_n53_;
  assign new_n50_ = (x06 | ~x08) & (~x04 | ((~x02 | x03) & x16));
  assign new_n51_ = x13 & (~x07 | x09 | x12 | x10 | x11);
  assign new_n52_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign new_n53_ = ~x08 & x13;
  assign z10 = z13 & (~new_n57_ | (new_n56_ & (new_n52_ | x00)));
  assign z13 = x04 | (~x06 & x08);
  assign new_n56_ = ~x09 & x07 & x08 & ((x02 & ~x03) | ~x16);
  assign new_n57_ = (x06 | ~x08) & (~x14 | (x02 & ~x03) | ~x16);
