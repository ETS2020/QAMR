...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n42_, new_n45_, new_n46_, new_n48_, new_n52_;
  ...
  assign z06 = (x06 & (new_n46_ | ~x04)) | ((new_n39_ | x10) & x04 & (new_n39_ | ~new_n45_));
  assign new_n45_ = x06 & x07 & x08 & ~x09;
  assign new_n46_ = x08 & ~x09 & x07 & ~x10;
  assign z07 = (x06 & (~x04 | (new_n46_ & ~x11))) | (x04 & (new_n39_ | (~new_n48_ & x11)));
  assign new_n48_ = ~x10 & x06 & x07 & x08 & ~x09;
  assign z08 = (~x12 & new_n48_ & ~x11) | ~new_n42_ | (x12 & (~new_n48_ | x11));
  assign z09 = (x13 & (x12 | x11 | ~new_n45_ | x10)) | ~new_n42_ | (new_n45_ & ~x10 & ~x11 & ~x12 & ~x13);
  assign z10 = x04 ? ((~new_n52_ & ~new_n39_ & new_n45_) | (new_n39_ & x14)) : ~x06;
