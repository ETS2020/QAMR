...
module FAU ( 
  ...
  assign z06 = ((~new_n46_ | ~x05) & (x10 | (~x05 & x06))) | new_n44_ | ~new_n39_;
  assign new_n44_ = new_n45_ & x06 & ~x09 & ~x10;
  assign new_n45_ = x07 & x08;
  assign new_n46_ = x06 & x07 & x08 & ~x09;
  assign z07 = ~new_n39_ | (new_n44_ ? (~x05 | ~x11) : (x11 | (~x05 & x06)));
  assign z08 = (~new_n49_ & x05) | (~x06 & x12) | (~new_n39_ & (x05 | ~x06));
  assign new_n49_ = (~x12 | (~x09 & ~x10 & new_n45_ & ~x11)) & (~new_n45_ | ~x06 | x09 | x10 | x11 | x12);
  assign z09 = (~new_n51_ & x05) | (~x06 & x13) | (~new_n39_ & (x05 | ~x06));
