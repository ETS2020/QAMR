...
module FAU ( 
  ...
  assign z05 = (~x06 & (~x04 | x09)) | (x04 & ((~x09 & x08 & x06 & x07) | new_n41_ | (x09 & (~x07 | ~x08))));
  assign z06 = (new_n45_ & ~x10) | ~new_n39_ | (~new_n45_ & x10);
  assign new_n45_ = ~x09 & x08 & x06 & x07;
  assign z07 = (~x06 & (~x04 | x11)) | (x04 & (new_n47_ | new_n41_ | (~new_n48_ & x11)));
  assign new_n47_ = ~x09 & x08 & x06 & x07 & ~x10 & ~x11;
  assign new_n48_ = x07 & x08 & ~x09 & ~x10;
  assign z08 = new_n51_ | (x04 & (new_n52_ | new_n41_ | (new_n50_ & new_n53_)));
  ...
  assign z09 = ((~new_n50_ | ~new_n53_) & x13) | ~new_n39_ | (new_n55_ & new_n50_ & ~x09);
  assign new_n55_ = ~x11 & ~x12 & ~x10 & ~x13;
  assign z10 = x04 & ((new_n41_ & x14) | ((new_n55_ | x00) & ~new_n41_ & new_n45_));
