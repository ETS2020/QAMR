...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n42_, new_n44_, new_n45_, new_n49_, new_n50_, new_n51_,
    new_n53_;
  ...
  assign z05 = (~new_n44_ & x09) | ~new_n39_ | new_n45_;
  assign new_n44_ = x06 & x07 & x08;
  assign new_n45_ = x06 & x07 & x08 & ~x09;
  assign z06 = (~new_n45_ & x10) | ~new_n39_ | (new_n44_ & ~x09 & ~x10);
  assign z07 = (x11 & (~new_n44_ | x09 | x10)) | ~new_n39_ | (new_n44_ & ~x09 & ~x10 & ~x11);
  assign z08 = new_n49_ | (x04 & (new_n50_ | new_n42_ | (new_n44_ & new_n51_)));
  assign new_n49_ = ~x06 & (~x04 | x12);
  assign new_n50_ = x12 & (~x07 | ~x08 | x09 | x10 | x11);
  assign new_n51_ = ~x10 & ~x11 & ~x09 & ~x12;
  assign z09 = (x13 & (~new_n44_ | ~new_n51_)) | ~new_n39_ | (new_n45_ & new_n53_);
  assign new_n53_ = ~x12 & ~x13 & ~x10 & ~x11;
  assign z10 = x04 & ((new_n42_ & x14) | ((new_n53_ | x00) & ~new_n42_ & new_n45_));
