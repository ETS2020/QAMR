// Benchmark "FAU" written by ABC on Thu Aug 13 17:23:15 2020
...
module FAU ( 
  ...
  assign new_n37_ = ~x17 & ~x18;
  assign z01 = (~x05 | ~x04 | (~x17 & ~x18)) & (~x18 | x05 | x15);
  assign z02 = new_n40_ & ~x06;
  assign new_n40_ = x04 & (x17 | x18) & (~x16 | (x02 & ~x03));
  ...
  assign z08 = (~x12 & new_n46_ & ~x10 & ~x11) | ~new_n40_ | (x12 & (~new_n46_ | x10 | x11));
  assign z09 = (x13 & (x12 | ~new_n46_ | x10 | x11)) | ~new_n40_ | (new_n46_ & ~x12 & ~x13 & ~x10 & ~x11);
  assign z10 = (new_n37_ | x04) & ((~new_n52_ & ~new_n51_ & new_n46_) | new_n37_ | (new_n51_ & x14));
