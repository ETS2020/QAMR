...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n45_, new_n47_, new_n49_, new_n50_, new_n52_, new_n53_,
    new_n54_;
  ...
  assign z05 = ~new_n39_ | (x09 & (~x07 | ~x08)) | (~x06 & x08) | (~x09 & x07 & x08);
  assign z06 = (x06 & (x10 ? (~x07 | x09) : (~x09 & x07 & x08))) | (~new_n39_ & (x06 | ~x08)) | (~x08 & x10);
  assign z07 = (x11 & (~new_n45_ | x10)) | (new_n45_ & ~x10 & ~x11) | ~new_n39_ | (~x06 & (x08 | x11));
  assign new_n45_ = ~x09 & x07 & x08;
  assign z08 = (~new_n47_ & x06) | (~new_n39_ & (x06 | ~x08)) | (~x08 & x12);
  assign new_n47_ = x12 ? (x07 & ~x09 & ~x10 & ~x11) : (x09 | ~x07 | ~x08 | x10 | x11);
  assign z09 = (x13 & (x12 | ~new_n45_ | ~new_n49_)) | (new_n45_ & new_n49_ & ~x12 & ~x13) | ~new_n39_ | new_n50_;
  assign new_n49_ = ~x10 & ~x11;
  assign new_n50_ = ~x06 & (x08 | x13);
  assign z10 = (~x06 & x08) | (x04 & (new_n54_ | (~new_n52_ & new_n53_)));
  assign new_n52_ = ~x00 & (x10 | x11 | x12 | x13);
  assign new_n53_ = ~x09 & x07 & x08 & (~x16 | (x02 & ~x03));
