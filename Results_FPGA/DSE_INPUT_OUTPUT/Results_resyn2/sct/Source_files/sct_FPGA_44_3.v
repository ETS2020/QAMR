...
module FAU ( 
  ...
  assign z02 = (x06 & x07) | ((~x16 | (x02 & ~x03)) & x04 & ~x06);
  assign z03 = (x06 & x07) | ((~x16 | (x02 & ~x03)) & x04 & (x06 | x07));
  assign z04 = ~new_n37_ & x04 & x08 & (~x16 | (x02 & ~x03));
  assign z05 = new_n37_ | ~x04 | x09 | (x16 & (~x02 | x03));
  assign z06 = ~new_n37_ & ((x16 & (~x02 | x03)) | ~x04 | x10);
  assign z07 = new_n37_ | ~x04 | x11 | (x16 & (~x02 | x03));
  assign z08 = ~new_n37_ & ((x16 & (~x02 | x03)) | ~x04 | x12);
  assign z09 = new_n37_ | ~x04 | x13 | (x16 & (~x02 | x03));
