...
module FAU ( 
  ...
  assign z01 = (x05 | x06 | x15 | ~x18) & (~x04 | ~x05 | (x06 & ~x15));
  assign z02 = x06 ? ~x15 : new_n39_;
  assign new_n39_ = x04 & (~x16 | (x02 & ~x03));
  assign z03 = new_n39_ & (x06 | x07) & (~x06 | x15) & (~x06 | ~x07);
  assign z04 = (x06 & ~x15) | (new_n39_ & (~x08 | ~x06 | ~x07) & (x08 | (x06 & x07)));
  assign z05 = (x09 & (~x08 | ~x06 | ~x07 | ~x15)) | ~new_n39_ | (x06 & (~x15 | (x07 & x08 & ~x09)));
  assign z06 = (x06 & ((new_n44_ & ~x10) | ~x15)) | ~new_n39_ | (x10 & (~new_n45_ | ~x15));
  assign new_n44_ = x07 & x08 & ~x09;
  assign new_n45_ = x06 & x07 & x08 & ~x09;
  assign z07 = (x11 & (~x06 | ((~new_n44_ | x10) & x15))) | (~new_n39_ & (~x06 | x15)) | (new_n44_ & ~x10 & x06 & ~x11 & x15);
  assign z08 = (x06 & (~x15 | (new_n44_ & new_n49_))) | new_n48_ | ~new_n39_;
  assign new_n48_ = x12 & (~new_n44_ | x10 | ~x06 | x11 | ~x15);
