...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n45_, new_n47_, new_n48_, new_n50_, new_n52_, new_n53_,
    new_n55_, new_n56_;
  ...
  assign z08 = (x08 & (new_n48_ | (~x06 & x12))) | ((x06 | (x08 & ~x12)) & (~new_n39_ | (~new_n47_ & x12)));
  assign new_n47_ = ~x09 & x07 & x08 & ~x10 & ~x11;
  assign new_n48_ = ~x09 & x06 & x07 & ~x12 & ~x10 & ~x11;
  assign z09 = ((new_n48_ | x13) & x08 & (~x06 | ~x13)) | ((x06 | (x08 & ~x13)) & (~new_n39_ | (~new_n50_ & x13)));
  assign new_n50_ = ~x09 & x07 & x08 & ~x12 & ~x10 & ~x11;
  assign z10 = z13 & (~new_n56_ | (~new_n55_ & ~new_n52_ & new_n53_));
  assign new_n52_ = x16 & (~x02 | x03);
  assign new_n53_ = ~x09 & x08 & x06 & x07;
  assign z13 = x04 | (~x06 & ~x08);
  assign new_n55_ = ~x00 & (x13 | x12 | x10 | x11);
  assign new_n56_ = (x06 | x08) & (~x14 | (x02 & ~x03) | ~x16);
