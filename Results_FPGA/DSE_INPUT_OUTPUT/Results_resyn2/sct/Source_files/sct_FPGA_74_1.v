...
module FAU ( 
  ...
  assign z04 = new_n39_ & (x08 | (x06 & x07)) & (x01 | ~x06) & (~x06 | ~x07 | ~x08);
  assign z05 = (~x01 & x06) | (~x09 & x06 & x07 & x08) | ~new_n39_ | (x09 & (~x06 | ~x07 | ~x08));
  ...
  assign new_n49_ = x12 ? (new_n50_ & x07 & x08) : (~new_n50_ | ~x06 | ~x07 | ~x08);
