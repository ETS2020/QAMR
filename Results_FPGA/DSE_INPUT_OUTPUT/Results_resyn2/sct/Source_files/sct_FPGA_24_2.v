...
module FAU ( 
  ...
  assign z07 = (x11 & (~new_n47_ | x10)) | (new_n45_ & ~x10 & ~x11) | ~new_n40_ | new_n48_;
  assign new_n47_ = x07 & x08 & ~x09;
  assign new_n48_ = ~x06 & (x05 | x11);
  assign z08 = (~new_n50_ & x06) | ((~x05 | x06) & (~new_n40_ | (~x06 & x12)));
  assign new_n50_ = (~x12 | (x07 & x08 & ~x09 & ~x10 & ~x11)) & (~x07 | ~x08 | x09 | x12 | x10 | x11);
  assign z09 = ((~x05 | x06) & (~new_n40_ | (~x06 & x13))) | ((~new_n52_ | ~x13) & x06 & (new_n52_ | x13));
