...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n37_, new_n40_, new_n44_, new_n46_, new_n50_, new_n52_, new_n53_;
  ...
  assign z05 = ~new_n40_ | (x09 & x17) | (new_n44_ & ~x09) | (~new_n44_ & x09);
  assign new_n44_ = x08 & x06 & x07;
  assign z06 = ~new_n37_ & ((new_n46_ & ~x10) | ~new_n40_ | (~new_n46_ & x10));
  assign new_n46_ = ~x09 & x08 & x06 & x07;
  assign z07 = ~new_n40_ | (x09 & x17) | (x09 & x11) | (x11 & (~new_n44_ | x10)) | (new_n44_ & ~x09 & ~x10 & ~x11);
  assign z08 = ~new_n37_ & ((~x12 & new_n46_ & ~x10 & ~x11) | ~new_n40_ | (x12 & (~new_n46_ | x10 | x11)));
  assign z09 = ((~new_n40_ | (x09 & x13)) & (~x09 | ~x17)) | ((new_n50_ | x13) & ~x09 & (~new_n50_ | ~x13));
  assign new_n50_ = x08 & x06 & x07 & ~x12 & ~x10 & ~x11;
  assign z10 = ((new_n52_ & x14) | (~new_n53_ & ~new_n52_ & new_n46_)) & ~new_n37_ & x04;
