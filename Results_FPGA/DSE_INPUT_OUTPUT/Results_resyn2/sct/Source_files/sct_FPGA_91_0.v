...
module FAU ( 
  ...
  assign z08 = (x06 & (new_n50_ | ~x04)) | (x04 & (new_n39_ | (~new_n51_ & x12)));
  assign new_n50_ = x07 & x08 & ~x09 & ~x10 & ~x11 & ~x12;
  assign new_n51_ = ~x09 & ~x10 & ~x11 & x06 & x07 & x08;
  assign z09 = (x13 & (~new_n51_ | x12)) | ~new_n54_ | (new_n45_ & new_n53_);
  assign new_n53_ = ~x13 & ~x12 & ~x10 & ~x11;
  assign new_n54_ = x04 & (~x16 | (x02 & ~x03));
  assign z10 = x04 & (((new_n53_ | x00) & ~new_n39_ & new_n45_) | (new_n39_ & x14));
