...
module FAU ( 
  ...
  assign z07 = ~new_n39_ | ((new_n44_ & ~x10) ? (~x06 | ~x11) : ((~x06 & x08) | x11));
  assign z08 = (x06 & ((~new_n47_ & x12) | (x08 & new_n47_ & ~x12))) | (~x08 & x12) | (~new_n39_ & (x06 | ~x08));
  assign new_n47_ = x07 & ~x09 & ~x10 & ~x11;
  assign z09 = (x06 & (new_n50_ | (new_n44_ & new_n51_))) | new_n49_ | new_n52_;
  assign new_n49_ = (x06 | ~x08) & (~x04 | ((~x02 | x03) & x16));
  assign new_n50_ = x13 & (x12 | ~x07 | x09 | x10 | x11);
