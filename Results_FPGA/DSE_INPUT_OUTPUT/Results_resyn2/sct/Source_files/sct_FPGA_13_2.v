...
module FAU ( 
  ...
  assign z06 = (x06 & (~x07 | (~x10 & x08 & ~x09))) | ~new_n39_ | (x10 & (x09 | ~x07 | ~x06 | ~x08));
  assign z07 = (x07 & ((x11 & (~new_n45_ | x10)) | (x06 & new_n45_ & ~x10 & ~x11))) | (~new_n39_ & (~x06 | x07)) | (~x06 & x11);
  assign new_n45_ = x08 & ~x09;
  assign z08 = (x07 & (new_n47_ ? (x06 & ~x12) : x12)) | (~new_n39_ & (~x06 | x07)) | (~x06 & x12);
  assign new_n47_ = x08 & ~x09 & ~x10 & ~x11;
  assign z09 = (x06 & (~x07 | (new_n47_ & ~x12 & ~x13))) | ~new_n39_ | (x13 & (~x07 | ~new_n47_ | ~x06 | x12));
  assign z10 = (x04 | (x06 & ~x07)) & ((~new_n50_ & new_n51_) | new_n52_ | (x06 & ~x07));
  assign new_n50_ = ~x00 & (x10 | x11 | x12 | x13);
  assign new_n51_ = (~x16 | (x02 & ~x03)) & x06 & x08 & ~x09;
