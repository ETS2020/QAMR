...
module FAU ( 
  ...
  assign z06 = ~new_n40_ | new_n37_ | (new_n46_ & ~x10) | (~new_n46_ & x10);
  assign new_n46_ = x08 & ~x09 & x06 & x07;
  assign z07 = (x11 & (~new_n46_ | x10)) | ~new_n40_ | (~x13 & ~x17) | (~x11 & new_n46_ & ~x10);
  assign z08 = (~new_n49_ & x12) | ~new_n40_ | new_n37_ | (new_n49_ & ~x12);
  assign new_n49_ = ~x11 & ~x10 & x08 & ~x09 & x06 & x07;
  assign z09 = (x13 & (~new_n49_ | x12)) | (~new_n40_ & (x13 | x17)) | (new_n49_ & x17 & ~x12 & ~x13);
