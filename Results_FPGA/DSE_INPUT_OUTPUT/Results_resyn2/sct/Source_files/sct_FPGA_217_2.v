...
module FAU ( 
  ...
  assign z05 = (x09 & (~x06 | ((~x07 | ~x08) & x11))) | (~new_n40_ & (~x06 | x11)) | (x11 & x06 & ~x09 & x07 & x08);
  assign z06 = (x06 & (~x11 | (new_n45_ & ~x10))) | ~new_n40_ | (x10 & (~x11 | ~new_n45_ | ~x06));
  assign new_n45_ = ~x09 & x07 & x08;
  assign z07 = (x11 & (~new_n45_ | x10)) | ~x04 | (x06 & ~x11) | new_n47_ | (~x06 & x11);
  assign new_n47_ = x16 & (~x02 | x03);
  assign z08 = (~new_n37_ & ~new_n40_) | (~new_n37_ & x12);
  assign z09 = new_n47_ | x13 | new_n37_ | ~x04;
  assign z10 = new_n37_ | (x04 & ((new_n47_ & x14) | (new_n51_ & ~new_n47_ & x00)));
