...
module FAU ( 
  ...
  assign z03 = ~x07 & ~new_n40_ & x04 & x06;
  ...
  assign z07 = (x11 & (~new_n44_ | x10)) | new_n40_ | ~x04 | ~x06 | (new_n44_ & ~x10 & ~x11);
  assign z08 = new_n47_ | ~x04;
  assign new_n47_ = x06 & ((x12 & (~new_n44_ | x10 | x11)) | new_n40_ | (new_n44_ & ~x10 & ~x11 & ~x12));
  assign z09 = ~x04 | (~new_n49_ & x06);
  assign new_n49_ = (~x13 | (new_n44_ & ~x12 & ~x10 & ~x11)) & ~new_n40_ & (~new_n44_ | x12 | x13 | x10 | x11);
  assign z10 = x04 & x06 & ((new_n40_ & x14) | (~new_n51_ & ~new_n40_ & new_n44_));
