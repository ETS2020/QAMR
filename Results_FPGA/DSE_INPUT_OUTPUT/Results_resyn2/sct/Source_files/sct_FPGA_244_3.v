...
module FAU ( 
  ...
  assign z02 = ((x02 & ~x03) | ~x16) & ~x06 & x04 & ~x07;
  assign z03 = ((x02 & ~x03) | ~x16) & x06 & x04 & ~x07;
  assign z04 = x04 & (x07 | (x08 & ((x02 & ~x03) | ~x16)));
  assign z05 = ((~x02 | x03) & x16) | x09 | ~x04 | x07;
  assign z06 = ((~x02 | x03) & x16) | x10 | ~x04 | x07;
  assign z07 = ~x04 | (~x07 & (x11 | ((~x02 | x03) & x16)));
  assign z08 = ((~x02 | x03) & x16) | x12 | ~x04 | x07;
