...
module FAU ( 
  ...
  assign z06 = (~x06 & (~x04 | x10)) | (x04 & ((~new_n45_ & x10) | new_n44_ | (new_n45_ & x06 & ~x10)));
  assign new_n44_ = x16 & (~x02 | x03);
  assign new_n45_ = ~x09 & x07 & x08;
  assign z07 = (x04 | ~x06) & ((~new_n47_ & (~x04 | x11)) | new_n44_ | (new_n47_ & ~x11));
  assign new_n47_ = ~x09 & x07 & x08 & x06 & ~x10;
  assign z08 = (new_n49_ & ~x12) | ~new_n39_ | (~new_n49_ & x12);
  assign new_n49_ = ~x09 & x07 & x08 & x06 & ~x10 & ~x11;
  assign z09 = ((~new_n49_ | x12) & x13) | ~new_n39_ | (new_n51_ & new_n52_);
  assign new_n51_ = ~x09 & x08 & x06 & x07;
  assign new_n52_ = ~x10 & ~x11 & ~x12 & ~x13;
  assign z10 = (x06 & (~x04 | (~new_n54_ & ~new_n44_ & new_n45_))) | (new_n44_ & x04 & x14);
