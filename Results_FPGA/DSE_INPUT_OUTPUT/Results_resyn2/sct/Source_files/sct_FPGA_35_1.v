...
module FAU ( 
  ...
  assign z04 = ((x06 & x07) | (x08 & (x06 | ~x10))) & new_n40_ & (~x08 | ~x06 | ~x07);
  ...
  assign z07 = ~new_n40_ | (~x06 & (x10 | x11)) | (~x10 & ~x11 & new_n47_ & x06 & x07) | (x11 & (~new_n47_ | ~x07 | x10));
  assign new_n47_ = x08 & ~x09;
  assign z08 = (~x10 & (new_n49_ | (~x06 & x12))) | ((x06 | (~x10 & ~x12)) & (~new_n40_ | (~new_n50_ & x12)));
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x11 & ~x12;
  assign new_n50_ = ~x11 & x08 & ~x09 & x07 & ~x10;
  assign z09 = (~x10 | (x06 & (~new_n40_ | x13))) & ((~new_n49_ & x13) | ~new_n40_ | (new_n49_ & (x10 | ~x13)));
  assign z10 = new_n37_ | (x04 & ((~new_n54_ & ~new_n53_ & new_n45_) | (new_n53_ & x14)));
  assign new_n53_ = x16 & (~x02 | x03);
  assign new_n54_ = ~x00 & (x10 | x12 | x11 | x13);
