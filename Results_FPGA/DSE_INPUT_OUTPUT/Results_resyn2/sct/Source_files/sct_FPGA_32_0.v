...
module FAU ( 
  ...
  assign z02 = ~x06 & (new_n39_ | ~x00);
  assign new_n39_ = x04 & (~x16 | (x02 & ~x03));
  assign z03 = (~x00 & ~x06) | (new_n39_ & (~x06 | ~x07) & (x06 | x07));
  assign z04 = ((x06 & x07) | (x08 & (x00 | x06))) & new_n39_ & (~x08 | ~x06 | ~x07);
  assign z05 = (x00 | x06) & ((~x09 & x08 & x06 & x07) | ~new_n39_ | (x09 & (~x08 | ~x06 | ~x07)));
  assign z06 = (~new_n39_ | new_n44_) & (x00 | x06);
  assign new_n44_ = (x10 | (~x09 & x08 & x06 & x07)) & (~x08 | x09 | ~x10 | ~x06 | ~x07);
  assign z07 = (x06 & ((x11 & (~new_n46_ | x10)) | (new_n46_ & ~x10 & ~x11))) | ((x00 | x06) & (~new_n39_ | (~x06 & x11)));
  assign new_n46_ = x07 & x08 & ~x09;
  assign z08 = (x06 & new_n48_ & ~x12) | ~new_n39_ | ((x12 | (~x00 & ~x06)) & (~new_n48_ | ~x06));
  ...
  assign new_n57_ = (x00 | x06) & (~x14 | ~x16 | (x02 & ~x03));
