...
module FAU ( 
  ...
  assign z06 = ~new_n37_ & (new_n46_ | ~new_n40_ | (~new_n45_ & x10));
  assign new_n45_ = x06 & x07 & x08 & ~x09;
  assign new_n46_ = x08 & x06 & x07 & ~x09 & ~x10;
  assign z07 = (new_n46_ & ~x11) | (~new_n48_ & x11) | ~new_n40_ | (~x06 & (x11 | x12));
  assign new_n48_ = x08 & ~x09 & x07 & ~x10;
  assign z08 = (x12 & (~new_n46_ | x11)) | ~new_n40_ | (x06 & new_n48_ & ~x11 & ~x12);
