...
module FAU ( 
  ...
  assign z04 = (x03 & x06) | (((x06 & x07) | (x08 & (~x03 | (~x06 & ~x16)))) & new_n41_ & (~x08 | ~x06 | ~x07));
  assign new_n41_ = x04 & (x02 | ~x16);
  assign z05 = ~new_n43_ | (x06 & (new_n44_ | x03)) | (x03 & x16);
  assign new_n43_ = new_n41_ & (~x09 | (~x03 & x08 & x06 & x07));
  assign new_n44_ = ~x09 & x07 & x08;
  assign z06 = (~x10 & ((x06 & (new_n44_ | x03)) | (x03 & x16))) | ~new_n41_ | (x10 & (x03 | ~new_n44_ | ~x06));
  assign z07 = (~new_n47_ & ~x03) | (~x04 & (~x03 | ~x06)) | (~x06 & (x11 | (x03 & x16)));
  assign new_n47_ = (~x11 | (new_n44_ & ~x10)) & (x02 | ~x16) & (~new_n44_ | ~x06 | x10 | x11);
  assign z08 = new_n51_ | (~new_n49_ & x12) | ~new_n41_ | (x03 & (x12 | x16));
  assign new_n49_ = new_n50_ & ~x10 & ~x11;
  assign new_n50_ = x06 & ~x09 & x07 & x08;
  assign new_n51_ = x06 & (x03 | (new_n44_ & new_n52_));
  assign new_n52_ = ~x12 & ~x10 & ~x11;
  assign z09 = (~new_n54_ & ~x03) | (~x04 & (~x03 | ~x06)) | (~x06 & (x13 | (x03 & x16)));
  assign new_n54_ = (~new_n44_ | ~x06 | ~new_n52_ | x13) & (x02 | ~x16) & (~x13 | (new_n44_ & new_n52_));
  assign z10 = (x04 | (x03 & x06)) & (new_n56_ | new_n57_ | (x03 & x06));
  assign new_n56_ = (x00 | (new_n52_ & ~x13)) & new_n50_ & (x02 | ~x16);
