...
module FAU ( 
  ...
  assign z08 = (~x12 & ((new_n46_ & new_n49_) | x17)) | ~new_n40_ | (x12 & (~new_n46_ | ~new_n49_));
  assign new_n49_ = ~x10 & ~x11;
  assign z09 = (x13 & (x12 | ((~new_n46_ | ~new_n49_) & ~x17))) | (~new_n40_ & (x12 | ~x17)) | (new_n49_ & ~x12 & ~x13 & new_n46_ & ~x17);
