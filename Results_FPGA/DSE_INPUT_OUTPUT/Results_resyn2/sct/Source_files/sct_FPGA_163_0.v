...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n43_, new_n45_, new_n47_, new_n51_;
  ...
  assign z05 = (x06 & (~x04 | (x07 & x08 & ~x09))) | (x04 & (new_n43_ | (x09 & (~x08 | ~x06 | ~x07))));
  ...
  assign z08 = (~x12 & new_n47_ & ~x11) | ~new_n39_ | (x12 & (~new_n47_ | x11));
  assign z09 = (x13 & (x12 | x11 | ~new_n45_ | x10)) | ~new_n39_ | (new_n45_ & ~x10 & ~x11 & ~x12 & ~x13);
  assign z10 = x04 ? ((~new_n51_ & ~new_n43_ & new_n45_) | (new_n43_ & x14)) : ~x06;
