...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n38_, new_n40_, new_n44_, new_n45_, new_n46_, new_n50_, new_n51_,
  ...
  assign z05 = ~new_n38_ & ((~new_n45_ & x09) | ~new_n44_ | new_n46_);
  ...
  assign z07 = ~new_n38_ & ((x11 & (~new_n46_ | x10)) | ~new_n44_ | (new_n46_ & ~x10 & ~x11));
  assign z08 = ~new_n38_ & ((~new_n50_ & x12) | ~new_n44_ | (new_n45_ & new_n51_));
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign new_n51_ = ~x10 & ~x11 & ~x09 & ~x12;
  assign z09 = (new_n53_ & (~new_n45_ | ~new_n51_)) | new_n54_ | (new_n50_ & new_n55_);
  assign new_n53_ = x13 & ~x14;
  assign new_n54_ = (~x13 | ~x14) & (~x04 | ((~x02 | x03) & x16));
  assign new_n55_ = ~x12 & ~x13;
  assign z10 = x04 & ((~new_n58_ & ~new_n57_ & new_n46_) | (new_n57_ & ~x13 & x14));
  assign new_n57_ = x16 & (~x02 | x03);
  assign new_n58_ = (x10 | x11 | x12 | x13) & (~x00 | (x13 & x14));
