...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n40_, new_n42_, new_n46_, new_n51_, new_n52_;
  assign z00 = (x14 & ~x18) | (~x01 & ~x14) | (x01 & ~x02);
  assign z01 = (~x05 | ~x04 | (x14 & ~x18)) & (~x18 | x05 | x15);
  assign z02 = new_n39_ | (new_n40_ & ~x06);
  assign new_n39_ = x14 & ~x18;
  assign new_n40_ = x04 & (~x16 | (x02 & ~x03));
  assign z03 = new_n42_ & (~x06 | ~x07) & (x06 | x07);
  assign new_n42_ = x04 & (~x14 | x18) & ((x02 & ~x03) | ~x16);
  assign z04 = new_n39_ | (new_n40_ & (~x08 | ~x06 | ~x07) & (x08 | (x06 & x07)));
  assign z05 = ~new_n39_ & ((x09 & (~x08 | ~x06 | ~x07)) | ~new_n40_ | (x06 & x07 & x08 & ~x09));
  assign z06 = ~new_n39_ & ((~new_n46_ & x10) | ~new_n40_ | (new_n46_ & ~x10));
  assign new_n46_ = x08 & ~x09 & x06 & x07;
  assign z07 = ~new_n39_ & ((new_n46_ & ~x10 & ~x11) | ~new_n40_ | ((~new_n46_ | x10) & x11));
  ...
  assign z10 = (x14 & ~x18) | (x04 & ((~new_n52_ & ~new_n51_ & new_n46_) | (new_n51_ & x14)));
  assign new_n51_ = x16 & (~x02 | x03);
  assign new_n52_ = ~x00 & (x10 | x11 | x12 | x13);
  assign z11 = new_n39_ | x02;
  assign z12 = ~new_n39_ & x04 & (x03 | (~x02 & x16));
