...
module FAU ( 
  ...
  assign z02 = (x06 & x07) | (~new_n39_ & x04 & ~x06);
  assign new_n39_ = x16 & (~x02 | x03);
  assign z03 = x04 & (~x06 | ~x07) & ~new_n39_ & (x06 | x07);
  assign z04 = ~new_n39_ & x08 & x04 & (~x06 | ~x07);
  assign z05 = ~x04 | (x06 & x07) | new_n39_ | x09;
  assign z06 = (~x06 | ~x07) & (new_n39_ | ~x04 | x10);
  assign z07 = ~x04 | (x06 & x07) | new_n39_ | x11;
  assign z08 = ~x04 | (x06 & x07) | new_n39_ | x12;
  assign z09 = (~x06 | ~x07) & (new_n39_ | ~x04 | x13);
  assign z10 = x04 & (~x06 | ~x07) & new_n39_ & x14;
