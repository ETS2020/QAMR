...
module FAU ( 
  ...
  assign z06 = (x06 | ~x07) & ((x06 & (x10 ? (~x08 | x09) : (~x09 & x07 & x08))) | ~new_n39_ | (~x07 & x10));
  assign z07 = (x11 & (~new_n45_ | x10)) | (new_n45_ & ~x10 & ~x11) | ~new_n39_ | (~x06 & (x07 | x11));
  assign new_n45_ = ~x09 & x07 & x08;
  assign z08 = ((x12 | (~x06 & x07)) & (~new_n47_ | ~x06)) | ~new_n39_ | (new_n47_ & ~x12);
  assign new_n47_ = ~x09 & x07 & x08 & ~x10 & ~x11;
  assign z09 = (x13 & (~new_n47_ | x12)) | (new_n47_ & ~x12 & ~x13) | ~new_n39_ | (~x06 & (x07 | x13));
