...
module FAU ( 
  ...
  assign z07 = (x11 & (~new_n46_ | x10)) | (~new_n43_ & (x10 | x11));
  assign z08 = ~new_n40_ | x12;
  assign z09 = (~new_n37_ & ~new_n43_) | (~new_n37_ & x13);
  assign z10 = z13 & ((new_n51_ & x14) | (new_n46_ & ~new_n51_ & x00));
  assign new_n51_ = x16 & (~x02 | x03);
  assign z13 = x04 & (x10 | x11);
