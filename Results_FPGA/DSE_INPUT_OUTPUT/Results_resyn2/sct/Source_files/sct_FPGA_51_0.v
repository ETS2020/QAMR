...
module FAU ( 
  ...
  assign z06 = (x09 | (x06 & (~new_n39_ | ~x10 | ~x07 | ~x08))) & (x10 | ~new_n39_ | (~x09 & x07 & x08));
  assign z07 = (x11 & (~new_n45_ | x10)) | (new_n45_ & ~x10 & ~x11) | ~new_n39_ | (~x06 & (~x09 | x11));
  assign new_n45_ = ~x09 & x07 & x08;
  assign z08 = (new_n47_ & ~x12) | (~new_n47_ & x12) | ~new_n39_ | (~x06 & (~x09 | x12));
  assign new_n47_ = ~x09 & x07 & x08 & ~x10 & ~x11;
  assign z09 = ~new_n39_ | (~x06 & (~x09 | x13)) | (~x13 ^ (~new_n47_ | x12));
