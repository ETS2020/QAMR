...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n40_, new_n42_, new_n44_, new_n46_, new_n47_, new_n48_, new_n52_,
    new_n53_, new_n55_;
  ...
  assign z05 = (x06 | ~x16) & ((~new_n44_ & x06) | ~x04 | (~x06 & x09));
  assign new_n44_ = (~x09 | (x07 & x08)) & (~x16 | (x02 & ~x03)) & (~x07 | ~x08 | x09);
  assign z06 = new_n47_ | (x06 & ((~new_n46_ & x10) | new_n40_ | new_n48_));
  assign new_n46_ = x07 & x08 & ~x09;
  assign new_n47_ = (x06 | ~x16) & (~x04 | (~x06 & x10));
  assign new_n48_ = x07 & x08 & ~x09 & ~x10;
  assign z07 = (x06 & new_n48_ & ~x11) | (~new_n48_ & x11) | ~new_n42_ | (~x06 & (x11 | x16));
  assign z08 = (~x12 & x06 & new_n48_ & ~x11) | (x12 & (~new_n48_ | x11)) | ~new_n42_ | (~x06 & (x12 | x16));
  assign z09 = (~x13 & new_n52_ & new_n53_) | ~new_n42_ | ((~new_n52_ | ~new_n53_) & (x13 | (~x06 & x16)));
  assign new_n52_ = ~x12 & ~x10 & ~x11;
  assign new_n53_ = x06 & x07 & x08 & ~x09;
  assign z10 = ((~new_n55_ & ~new_n40_ & new_n46_) | (new_n40_ & x14)) & x04 & x06;
