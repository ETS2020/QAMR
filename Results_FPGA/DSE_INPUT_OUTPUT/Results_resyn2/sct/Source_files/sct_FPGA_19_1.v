...
module FAU ( 
  ...
  assign z06 = (x10 | ~x11) & ((~x11 & new_n45_ & ~x10) | ~new_n40_ | (~new_n45_ & x10));
  assign new_n45_ = x06 & x07 & x08 & ~x09;
  assign z07 = (new_n45_ & ~x10) | ~new_n40_ | x11;
  assign z08 = (x12 & (x11 | ~new_n45_ | x10)) | ~new_n40_ | (~x10 & (x11 | (new_n45_ & ~x12)));
  assign z09 = (x13 & (x12 | x11 | ~new_n45_ | x10)) | ~new_n40_ | (~x10 & (x11 | (new_n45_ & ~x12 & ~x13)));
  assign z10 = (new_n37_ | x04) & ((~new_n51_ & ~new_n50_ & new_n45_) | new_n37_ | (new_n50_ & x14));
  assign new_n50_ = x16 & (~x02 | x03);
  assign new_n51_ = ~x00 & (x10 | x12 | x13);
