// Benchmark "FAU" written by ABC on Tue Aug 11 11:05:42 2020
...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n58_, new_n59_, new_n60_,
    new_n61_, new_n62_, new_n63_, new_n64_, new_n65_, new_n67_;
  ...
  assign z8 = (x32 | (~new_n58_ & new_n65_)) & x00 & ~x26 & (~new_n62_ | ~new_n65_ | ~x32);
  assign new_n58_ = ~new_n59_ & (new_n61_ | ~x15 | (~new_n60_ & x16));
  assign new_n59_ = x10 & ~x15 & x18 & x19 & x16 & x17;
  assign new_n60_ = x17 ? ((x18 | (x13 & x19)) & (x14 | x19) & (~x18 | ~x19)) : (x12 & x18 & x19);
  assign new_n61_ = ~x16 & (~x18 | ~x19 | ~x11 | ~x17);
  assign new_n62_ = ~new_n63_ & ~new_n61_ & new_n64_;
  assign new_n63_ = (x18 & x19 & x16 & x17) ? (~x10 | x15) : ~x15;
  assign new_n64_ = (x17 | (x12 & x18 & x19)) & (x14 | x19) & (x18 | (x13 & x19));
  assign new_n65_ = (~x30 | ~x29 | (~x27 & ~x28)) & x31 & (x30 | (x29 & (x27 | x28)));
  assign z9 = (x33 | (~new_n58_ & ~new_n67_)) & x00 & ~x26 & (~new_n62_ | new_n67_ | ~x33);
  assign new_n67_ = x31 ? (~x30 | ~x29 | (~x27 & ~x28)) : (x30 | (x29 & (x27 | x28)));
  assign z0 = ~x32;
endmodule
