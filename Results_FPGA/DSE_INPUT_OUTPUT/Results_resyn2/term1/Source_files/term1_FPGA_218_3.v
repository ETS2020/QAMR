...
module FAU ( 
  ...
  assign z3 = (x26 & x27) | (new_n52_ & ~x26 & ~x27);
  ...
  assign z6 = (x26 & x27) | (new_n52_ & ((x29 & x27 & x28) | (~x26 & x30)) & (~x27 | ~x30 | ~x28 | ~x29));
  assign z7 = (~x27 & (x26 | x31)) | (~x26 & (~new_n52_ | (~new_n59_ & x31) | (~x31 & new_n59_ & x27)));
  assign new_n59_ = x30 & x28 & x29;
