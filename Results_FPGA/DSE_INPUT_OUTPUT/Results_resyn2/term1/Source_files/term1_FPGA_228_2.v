...
module FAU ( 
  ...
  assign new_n52_ = new_n54_ & (~new_n53_ | ~x18 | (~x15 & ~x20));
  assign new_n53_ = (x17 | x22) & (x16 | x21) & (x19 | x24);
  ...
  assign z6 = ~x26 & (x23 | (new_n52_ & (new_n58_ | x30) & (~new_n58_ | ~x30)));
