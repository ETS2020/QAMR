...
module FAU ( 
  ...
  assign z8 = x00 & (((new_n61_ | x30) & new_n70_ & (~x30 | x32)) | ~new_n66_ | ((new_n61_ | ~x30) & ~new_n70_ & (x30 | x32)));
  ...
  assign new_n64_ = x10 & x16 & x17 & x18 & ~x15 & x19;
  assign new_n65_ = x31 & ~x32;
  assign new_n66_ = ~x26 & (~x32 | (new_n69_ & ~new_n67_ & new_n68_));
  ...
  assign z9 = x00 & (x26 | (~new_n74_ & (x33 | (~new_n72_ & new_n73_))));
  assign new_n72_ = ~new_n64_ & (~x15 | (~new_n63_ & (new_n62_ | ~x16)));
  assign new_n73_ = new_n70_ ? (x30 & x31) : (~x30 & ~x31);
  assign new_n74_ = ~new_n67_ & new_n68_ & new_n75_ & (~new_n70_ | (x30 & x31)) & (new_n70_ | (~x30 & ~x31));
