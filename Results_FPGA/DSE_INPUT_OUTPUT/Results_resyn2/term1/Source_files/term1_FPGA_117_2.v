...
module FAU ( 
  ...
  assign new_n50_ = x08 & ~x09 & (~x26 | x29);
  ...
  assign z4 = (x26 & ~x29) | (new_n52_ & ~x26 & (x27 | x28) & (~x27 | ~x28));
  assign z5 = (x26 & ~x29) | (new_n52_ & (~x29 | ~x27 | ~x28) & ((~x26 & x29) | (x27 & x28)));
  assign z6 = (x26 & ~x29) | (new_n52_ & (x30 | (x29 & x27 & x28)) & (~x26 | ~x29) & (~x30 | ~x29 | ~x27 | ~x28));
