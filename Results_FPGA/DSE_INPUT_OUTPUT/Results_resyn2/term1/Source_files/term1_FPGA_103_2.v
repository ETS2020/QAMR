// Benchmark "FAU" written by ABC on Thu Aug 13 18:46:03 2020
...
module FAU ( 
  ...
  assign new_n58_ = ~x21 & (~new_n52_ | (x30 & x29 & x27 & x28) | (~x30 & (~x29 | ~x27 | ~x28)));
  assign z7 = ~new_n60_ | ~new_n52_ | x21 | x26;
  assign new_n60_ = ~x31 ^ (x30 & x29 & x27 & x28);
  assign z8 = ~x26 & (x21 | (~new_n62_ & x00));
  ...
  assign new_n73_ = (~new_n74_ | new_n68_ | ~new_n69_) & x00 & ~x21 & ~x26;
