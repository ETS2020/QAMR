...
module FAU ( 
  ...
  assign z4 = new_n56_ & (x27 | x28) & (~x27 | ~x28);
  assign new_n56_ = new_n52_ & ~x23 & ~x26;
  assign z5 = new_n56_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28));
  assign z6 = new_n56_ & (~x30 | ~x29 | ~x27 | ~x28) & (x30 | (x29 & x27 & x28));
  assign z7 = x26 | (~new_n60_ & ~x23);
  assign new_n60_ = new_n52_ & (~x31 | (x30 & x29 & x27 & x28)) & (x31 | ~x30 | ~x29 | ~x27 | ~x28);
  ...
  assign new_n73_ = (~new_n74_ | new_n68_ | ~new_n69_) & x00 & ~x23 & ~x26;
