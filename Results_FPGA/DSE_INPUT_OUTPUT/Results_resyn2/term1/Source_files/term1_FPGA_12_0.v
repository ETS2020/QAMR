...
module FAU ( 
  ...
  assign z8 = ~x26 & (((new_n60_ | x30) & new_n69_ & (~x30 | x32)) | ~new_n65_ | ((new_n60_ | ~x30) & ~new_n69_ & (x30 | x32)));
  ...
  assign new_n65_ = x00 & (~x32 | (new_n68_ & ~new_n66_ & new_n67_));
  ...
  assign z9 = (x33 | (~new_n71_ & new_n73_)) & new_n74_ & (~new_n72_ | ~new_n73_ | ~new_n75_);
