...
module FAU ( 
  ...
  assign z8 = new_n64_ & (x32 | (~new_n60_ & new_n65_ & x31));
  assign new_n60_ = ~new_n63_ & (~x15 | ((new_n61_ | ~x16) & (~new_n62_ | x16 | ~x19)));
  ...
  assign new_n64_ = x00 & ~x26 & (new_n66_ | new_n67_ | ~new_n65_ | ~new_n68_);
  assign new_n65_ = ~x30 ^ ((~x27 & ~x28) | ~x29);
  assign new_n66_ = (~x15 | (~x16 & (~x11 | ~x17 | ~x18))) & (~x17 | ~x18 | ~x10 | ~x16);
  assign new_n67_ = (x15 & x16 & x17 & x18) ? (~x14 | x19) : ~x19;
  assign new_n68_ = x31 & x32 & ((x12 & x18) | (x17 & (x13 | x18)));
  assign z9 = new_n47_ | (new_n72_ & (new_n70_ | (~new_n60_ & new_n73_)));
  assign new_n70_ = x33 & (new_n66_ | new_n67_ | new_n65_ | ~new_n71_);
  assign new_n71_ = (~x30 ^ x31) & ((x12 & x18) | (x17 & (x13 | x18)));
  assign new_n72_ = x00 & (~x26 | (new_n63_ & ~x33));
  assign new_n73_ = (((x27 | x28) & x29) | (~x30 & ~x31)) & ~x33 & ((x30 & x31) | (~x27 & ~x28) | ~x29);
endmodule
