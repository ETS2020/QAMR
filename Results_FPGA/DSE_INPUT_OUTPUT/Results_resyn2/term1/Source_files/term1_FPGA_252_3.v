...
module FAU ( 
  ...
  assign z2 = new_n48_ | ((~new_n49_ | (~x04 ^ x07)) & (new_n49_ | (~x04 & x07) | (x04 & ~x07)) & x08 & ~x09);
  assign new_n48_ = x26 & x32;
  ...
  assign z6 = new_n48_ | (new_n51_ & (~x30 | ~x29 | ~x27 | ~x28) & (x30 | (x29 & x27 & x28)));
  assign z7 = new_n58_ ^ ~new_n48_;
  assign new_n58_ = new_n51_ & (~x31 | (x30 & x29 & x27 & x28)) & (x31 | ~x30 | ~x29 | ~x27 | ~x28);
  assign z8 = new_n48_ | (~new_n60_ & x00);
  assign new_n60_ = (~new_n70_ | ((~x30 | ~x32) & (~new_n61_ | x26 | x30))) & (new_n66_ | ~x32) & (new_n70_ | ((x30 | ~x32) & (~new_n61_ | x26 | ~x30)));
  ...
  assign z9 = ~new_n72_ & x00 & ~x26 & (~new_n75_ | new_n67_ | ~new_n68_);
  assign new_n72_ = ~x33 & (new_n73_ | ~new_n74_);
