...
module FAU ( 
  ...
  assign z3 = new_n48_ | (new_n51_ & ~x27);
  ...
  assign z7 = new_n48_ ^ (~new_n51_ | ~new_n58_);
  assign new_n58_ = (x29 & x27 & x28) ? (x30 ^ ~x31) : ~x31;
  assign z8 = (x26 & ~x32) | (x00 & ((~new_n60_ & ~x26 & x32) | (~new_n65_ & new_n69_)));
  assign new_n60_ = new_n63_ & new_n64_ & ~new_n61_ & new_n62_;
  ...
  assign z9 = (x33 | (~new_n65_ & new_n72_)) & new_n74_ & (~new_n71_ | ~new_n72_ | ~new_n73_);
