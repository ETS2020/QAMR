...
module FAU ( 
  ...
  assign new_n52_ = new_n54_ & (~new_n53_ | ~x19 | (~x17 & ~x22));
  ...
  assign z6 = ~x26 & (x24 | (new_n52_ & (~new_n58_ | ~x30) & (new_n58_ | x30)));
  assign new_n58_ = x29 & x27 & x28;
  assign z7 = ~new_n52_ | (~x31 & new_n58_ & x30) | (x31 & (~new_n58_ | ~x30)) | x24 | x26;
