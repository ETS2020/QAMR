// Benchmark "FAU" written by ABC on Thu Aug 13 18:46:43 2020
...
module FAU ( 
  ...
  assign z1 = (~x07 | x26) & (((~x03 | ~x33) & x02 & (x03 | ~x32)) | ((~x03 | ~x32) & ~x02 & (x03 | ~x33)));
  assign z2 = (x07 & ~x26) | ((new_n49_ | (x04 ^ x07)) & (~new_n49_ | (x04 & x07) | (~x04 & ~x07)) & x08 & ~x09);
  assign new_n49_ = ((~x02 & x06 & (x03 | ~x05)) | x01 | ((x02 | ~x06) & ~x03 & x05)) & ((x02 & x03) | ~x01 | (~x02 & ~x03));
  ...
  assign z4 = ~x26 & (x07 | (new_n51_ & (~x27 | ~x28) & (x27 | x28)));
  assign z5 = ~x26 & (x07 | (new_n51_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28))));
  assign z6 = new_n57_ & new_n51_ & ~x07 & ~x26;
  assign new_n57_ = ~x30 ^ (~x29 | ~x27 | ~x28);
  assign z7 = ~new_n59_ | ~new_n51_ | x07 | x26;
