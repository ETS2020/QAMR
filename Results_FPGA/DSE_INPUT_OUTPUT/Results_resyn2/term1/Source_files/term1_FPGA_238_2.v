...
module FAU ( 
  ...
  assign new_n65_ = x31 & ~new_n66_ & ~new_n67_ & ~new_n68_ & ~new_n69_;
  assign new_n66_ = (~x15 | ~x16 | ~x17 | ~x18) & (~x19 | (~x16 & (~x11 | ~x17 | ~x18)));
  assign new_n67_ = (~x12 | ~x18) & (~x17 | (~x13 & ~x18));
  assign new_n68_ = x15 & x16 & x17 & x18 & (~x14 | x19);
  assign new_n69_ = ~x15 & (~x17 | ~x18 | ~x10 | ~x16);
  assign new_n70_ = x29 & (x27 | x28);
  assign new_n71_ = x00 & ~x26;
  assign z9 = new_n47_ | (x00 & (new_n74_ | (~new_n73_ & new_n77_)));
  assign new_n73_ = ~new_n63_ & (~x15 | (~new_n62_ & (new_n61_ | ~x16)));
  assign new_n74_ = new_n76_ & (new_n75_ | new_n66_ | new_n67_ | new_n68_ | new_n69_);
  assign new_n75_ = (x29 & (x27 | x28)) ? (~x30 | ~x31) : (x30 | x31);
  assign new_n76_ = x33 & (~x26 | ~x31);
  assign new_n77_ = (~x26 | (~new_n70_ & ~x30 & ~x31)) & ~x33 & (new_n70_ ? (x30 & x31) : (~x30 & ~x31));
endmodule
