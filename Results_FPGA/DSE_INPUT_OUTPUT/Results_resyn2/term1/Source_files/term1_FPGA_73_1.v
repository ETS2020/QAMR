...
module FAU ( 
  ...
  assign z8 = (~x11 & (new_n71_ | x26)) | (~new_n61_ & x00 & ~x26);
  ...
  assign new_n64_ = x19 & x17 & x18 & x11 & ~x16;
  assign new_n65_ = x19 & x17 & x18 & x16 & x10 & ~x15;
  assign new_n66_ = x31 & ~x32;
  assign new_n67_ = (x16 | (x15 & new_n68_ & x19)) & (~new_n68_ | ~x15 | ~x16 | (x14 & ~x19)) & (x19 | (new_n68_ & x15)) & (x15 | (new_n68_ & x10));
  assign new_n68_ = x17 & x18;
  assign new_n69_ = (x27 | x28) & x29;
  assign new_n70_ = (x17 | (x12 & x18)) & x31 & (x13 | x18);
  assign new_n71_ = x32 & ~x16 & x00 & x15;
  assign z9 = new_n73_ | new_n78_;
  assign new_n73_ = (x33 | (~new_n74_ & new_n75_)) & new_n76_ & (~new_n67_ | ~new_n75_ | ~new_n77_);
  assign new_n74_ = ~new_n65_ & (~x15 | (~new_n64_ & (new_n63_ | ~x16)));
  assign new_n75_ = new_n69_ ? (x30 & x31) : (~x30 & ~x31);
  assign new_n76_ = x00 & ~x26;
  assign new_n77_ = (x17 | (x12 & x18)) & x33 & (x13 | x18);
  assign new_n78_ = ~x11 & (x26 | (x33 & ~x16 & x00 & x15));
endmodule
