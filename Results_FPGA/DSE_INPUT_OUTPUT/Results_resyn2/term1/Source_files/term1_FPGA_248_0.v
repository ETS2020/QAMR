...
module FAU ( 
  ...
  assign z3 = ~x26 & (~x01 | (~x27 & ~new_n52_ & new_n54_));
  ...
  assign new_n56_ = new_n54_ & x01 & ~x26;
  assign z5 = ~new_n52_ & new_n56_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28));
  assign z6 = ~x26 & (~x01 | (new_n59_ & ~new_n52_ & new_n54_));
  assign new_n59_ = ~x30 ^ (~x29 | ~x27 | ~x28);
  assign z7 = x26 | (x01 & (~new_n61_ | new_n52_ | ~new_n54_));
