...
module FAU ( 
  ...
  assign z4 = (~x11 & x26) | (new_n52_ & (~x27 | ~x28) & (x27 | x28));
  ...
  assign z8 = (~x11 & (new_n70_ | x26)) | (~new_n60_ & x00 & ~x26);
  assign new_n60_ = ((~new_n61_ & ~x30) | ~new_n68_ | (x30 & ~x32)) & ((~new_n61_ & x30) | new_n68_ | (~x30 & ~x32)) & (~x32 | (new_n66_ & new_n69_));
  assign new_n61_ = new_n65_ & (new_n64_ | (x15 & (new_n63_ | (~new_n62_ & x16))));
  assign new_n62_ = (~x17 | ((~x18 | ~x14 | x19) & (~x19 | ~x13 | x18))) & (~x12 | ~x18 | x17 | ~x19);
  assign new_n63_ = x11 & ~x16 & x19 & x17 & x18;
  assign new_n64_ = x19 & x17 & x18 & x16 & x10 & ~x15;
  assign new_n65_ = x31 & ~x32;
  assign new_n66_ = (x16 | (x15 & new_n67_ & x19)) & (~new_n67_ | ~x15 | ~x16 | (x14 & ~x19)) & (x19 | (new_n67_ & x15)) & (x15 | (new_n67_ & x10));
  assign new_n67_ = x17 & x18;
  assign new_n68_ = x29 & (x27 | x28);
  assign new_n69_ = (x17 | (x12 & x18)) & x31 & (x13 | x18);
  assign new_n70_ = x32 & ~x16 & x00 & x15;
  assign z9 = new_n72_ | new_n77_;
  assign new_n72_ = (x33 | (~new_n73_ & new_n74_)) & new_n75_ & (~new_n66_ | ~new_n74_ | ~new_n76_);
  assign new_n73_ = ~new_n64_ & (~x15 | (~new_n63_ & (new_n62_ | ~x16)));
  assign new_n74_ = new_n68_ ? (x30 & x31) : (~x30 & ~x31);
  assign new_n75_ = x00 & ~x26;
  assign new_n76_ = (x17 | (x12 & x18)) & x33 & (x13 | x18);
  assign new_n77_ = ~x11 & (x26 | (x33 & ~x16 & x00 & x15));
endmodule
