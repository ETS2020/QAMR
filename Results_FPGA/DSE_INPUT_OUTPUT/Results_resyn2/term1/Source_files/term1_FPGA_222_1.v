...
module FAU ( 
  ...
  assign z3 = new_n52_ & x01 & x25 & ~x26 & ~x27;
  assign new_n52_ = (~x02 | ~x03) & (~new_n53_ | ~new_n54_);
  assign new_n53_ = (x15 | x20) & (x19 | x24);
  assign new_n54_ = (x18 | x23) & (x17 | x22) & (x16 | x21);
  assign z4 = z3 & x28;
  assign z5 = ~x26 & (x27 | (new_n52_ & x29 & x01 & x25));
  assign z6 = z3 & x30;
  assign z7 = ~z3 | x31;
  assign z8 = ~x26 & (x27 | (x00 & (new_n60_ | new_n66_ | ~new_n70_)));
  assign new_n60_ = x15 & (new_n64_ | (x16 & (new_n63_ | (~new_n61_ & x17))));
  ...
  assign new_n72_ = (~x17 | ~x18 | ~x10 | ~x16) & (~x15 | (~x16 & (~x11 | ~x17 | ~x18)));
  assign new_n73_ = ~x19 & (~x17 | ~x18 | ~x15 | ~x16);
  assign new_n74_ = (x17 | (x12 & x18)) & x31 & (x13 | x18);
  assign z9 = ~x26 & (x27 | (~new_n76_ & x00 & (~new_n77_ | new_n72_)));
  assign new_n76_ = ~x33 & (new_n67_ | (x31 ? ~x30 : (x28 & x29)) | (x30 & (~x28 | ~x29)));
  assign new_n77_ = new_n78_ & (~x30 | (x31 & x28 & x29)) & ~new_n79_ & (x30 | (~x31 & (~x28 | ~x29)));
  assign new_n78_ = ~new_n73_ & (x17 | (x12 & x18)) & x33 & (x13 | x18);
