...
module FAU ( 
  ...
  assign new_n64_ = x10 & ~x15 & x19 & x16 & x17 & x18;
  ...
  assign z9 = new_n71_ | (~x10 & (x26 | (x33 & x00 & ~x15)));
  assign new_n71_ = (new_n72_ | x33) & x00 & ~x26 & (~new_n66_ | ~new_n74_);
  assign new_n72_ = new_n73_ & (new_n64_ | (x15 & (new_n63_ | (~new_n62_ & x16))));
