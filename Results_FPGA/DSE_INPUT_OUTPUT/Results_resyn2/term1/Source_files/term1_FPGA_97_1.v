// Benchmark "FAU" written by ABC on Thu Aug 13 18:46:00 2020
...
module FAU ( 
  ...
  assign z1 = (~x33 & (~x02 | x03) & (x02 | ~x03)) | (~x00 & x26) | (~x32 & (~x02 ^ ~x03));
  ...
  assign z5 = (~x00 & x26) | (new_n52_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28)));
  ...
  assign z9 = (~x00 & x26) | (((~new_n72_ & new_n73_) | x33) & ~new_n74_ & x00 & ~x26);
  assign new_n72_ = ~new_n63_ & (~x15 | (~new_n62_ & (new_n61_ | ~x16)));
  assign new_n73_ = new_n69_ ? (x30 & x31) : (~x30 & ~x31);
  assign new_n74_ = ~new_n66_ & new_n67_ & new_n75_ & (~new_n69_ | (x30 & x31)) & (new_n69_ | (~x30 & ~x31));
