...
module FAU ( 
  ...
  assign new_n54_ = (x17 | x22) & (x18 | x23);
  assign z4 = new_n52_ & x24 & ~x26 & (~x27 | ~x28) & (x27 | x28);
  assign z5 = new_n52_ & x24 & ~x26 & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28));
  assign z6 = ~new_n58_ & ~x26;
  assign new_n58_ = x24 & (~new_n52_ | (x30 & x29 & x27 & x28) | (~x30 & (~x29 | ~x27 | ~x28)));
  ...
  assign new_n73_ = (~new_n74_ | new_n68_ | ~new_n69_) & x00 & x24 & ~x26;
