...
module FAU ( 
  ...
  assign z7 = ~new_n52_ | ((x31 | (x30 & x29 & x27 & x28)) & (~x27 | ~x28 | ~x29 | ~x30 | ~x31));
  ...
  assign new_n65_ = ~new_n68_ & x31 & ~new_n66_ & new_n67_;
  ...
  assign z9 = (x26 & ~x27) | (x00 & (new_n74_ | (~x26 & (new_n71_ | ~new_n72_))));
  assign new_n71_ = (x33 | (~new_n61_ & x30 & x31)) & new_n69_ & (~x30 | ~x33);
  assign new_n72_ = (new_n73_ | ~x33) & (x29 | new_n61_ | x33 | x30 | x31);
  assign new_n73_ = ~new_n66_ & new_n67_ & ~new_n68_ & ((x29 & x30 & x31) | (~x30 & ~x31));
  assign new_n74_ = ~x27 & ~x28 & ((x30 & x33) | (~new_n61_ & ~x33 & ~x30 & ~x31));
endmodule
