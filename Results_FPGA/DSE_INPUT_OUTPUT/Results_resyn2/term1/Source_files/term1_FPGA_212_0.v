// Benchmark "FAU" written by ABC on Thu Aug 13 18:46:48 2020
...
module FAU ( 
  ...
  assign z3 = ~x27 & new_n52_ & x00 & ~x26;
  ...
  assign z5 = new_n52_ & x00 & ~x26 & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28));
  assign z6 = ~x26 & (~x00 | (new_n52_ & new_n58_));
  assign new_n58_ = x30 ^ (x29 & x27 & x28);
  assign z7 = ~new_n60_ | ~new_n52_ | ~x00 | x26;
