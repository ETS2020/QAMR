...
module FAU ( 
  ...
  assign new_n66_ = ~new_n67_ & new_n68_ & ~new_n69_ & ~new_n70_ & x31;
  assign new_n67_ = (~x14 | x19) & x15 & x16 & x17 & x18;
  assign new_n68_ = (x17 | (x12 & x18)) & (x16 | (x11 & x17 & x18));
  assign new_n69_ = (~x10 | ~x16 | ~x17 | ~x18) & (~x15 | (~x13 & ~x18));
  assign new_n70_ = ~x19 & (~x15 | ~x16 | ~x17 | ~x18);
  assign new_n71_ = (x27 | x28) & x29;
  assign new_n72_ = x00 & ~x26;
  assign z9 = new_n79_ | ((new_n75_ | x33) & new_n72_ & (~new_n74_ | ~new_n77_));
  assign new_n74_ = ~new_n67_ & new_n68_;
  assign new_n75_ = new_n76_ & (new_n64_ | (x15 & (new_n63_ | (~new_n62_ & x16))));
  assign new_n76_ = (~x30 | x31) & (x30 | ~x31) & (~x30 | ((x27 | x28) & x29)) & (x30 | (~x27 & ~x28) | ~x29);
  assign new_n77_ = (new_n71_ | ~x30) & (~new_n71_ | x30) & ~new_n70_ & ~new_n78_ & x33 & (~x30 | x31) & (x30 | ~x31);
  assign new_n78_ = (~x16 | ~x17 | ~x18) & (~x15 | (~x13 & ~x18));
  assign new_n79_ = ~x10 & (x26 | (x33 & x00 & ~x15));
endmodule
