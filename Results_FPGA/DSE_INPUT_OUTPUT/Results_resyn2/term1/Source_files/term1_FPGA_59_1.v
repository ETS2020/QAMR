...
module FAU ( 
  ...
  assign z1 = (~x33 & (x02 | ~x03) & (~x02 | x03)) | (~x08 & x26) | (~x32 & (x02 ^ x03));
  ...
  assign z3 = (~x08 & x26) | (new_n51_ & ~x27);
