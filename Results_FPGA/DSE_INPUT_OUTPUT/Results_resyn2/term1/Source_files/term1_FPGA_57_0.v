...
module FAU ( 
  ...
  assign z7 = ~new_n52_ | (~new_n60_ & x31) | ~new_n61_ | (new_n60_ & ~x31);
  assign new_n60_ = x30 & x29 & x27 & x28;
  assign new_n61_ = x00 & ~x26;
  assign z8 = new_n61_ & (((new_n63_ | x30) & new_n72_ & (~x30 | x32)) | (~new_n68_ & x32) | ((new_n63_ | ~x30) & ~new_n72_ & (x30 | x32)));
  ...
  assign z9 = (x33 | (~new_n74_ & new_n76_)) & new_n61_ & (~new_n75_ | ~new_n76_ | ~new_n77_);
