// Benchmark "FAU" written by ABC on Thu Aug 13 18:46:15 2020
...
module FAU ( 
  ...
  assign z9 = (x33 | (~new_n72_ & new_n74_)) & new_n76_ & (~new_n73_ | ~new_n74_ | ~new_n75_);
  assign new_n72_ = ~new_n64_ & (~x15 | (~new_n63_ & (new_n62_ | ~x16)));
  assign new_n73_ = ~new_n67_ & new_n68_;
