...
module FAU ( 
  ...
  assign new_n60_ = new_n64_ & (x26 | ((~x30 | ~x32) & (~new_n61_ | ~x17 | x30)));
  assign new_n61_ = x31 & ~x32 & (new_n63_ | (~new_n62_ & x15));
  assign new_n62_ = (~x16 | ((~x18 | ~x14 | x19) & (~x19 | ~x13 | x18))) & (~x18 | ~x19 | ~x11 | x16);
  assign new_n63_ = x10 & x16 & ~x15 & x18 & x19;
  assign new_n64_ = new_n67_ & (~new_n66_ | ~new_n65_ | x30);
  assign new_n65_ = x18 & x19;
  assign new_n66_ = x31 & ~x32 & x15 & x16 & x12 & ~x17;
  assign new_n67_ = x29 & (x27 | x28);
  assign new_n68_ = new_n69_ & (x26 | ((~new_n61_ | ~x17 | ~x30) & (x30 | ~x32)));
  assign new_n69_ = ~new_n67_ & (~new_n66_ | ~new_n65_ | ~x30);
  assign new_n70_ = (~new_n71_ | ~new_n74_) & ~x26 & x32;
  assign new_n71_ = new_n72_ & new_n73_;
  assign new_n72_ = (x15 | (x17 & x18 & x10 & x16)) & (x16 | (x11 & x17 & x18));
  assign new_n73_ = (x15 & x16 & x17 & x18) ? (x14 & ~x19) : x19;
  assign new_n74_ = (x17 | (x12 & x18)) & x31 & (x13 | x18);
  assign z9 = (x12 & x26) | (x00 & (new_n76_ | (~new_n84_ & ~x26 & x33)));
  assign new_n76_ = (~new_n79_ | (~new_n77_ & ~x26)) & (~new_n83_ | (~new_n81_ & ~x26));
  assign new_n77_ = (x30 | ~x33) & (~new_n78_ | (~new_n63_ & (new_n62_ | ~x15)));
  assign new_n78_ = x17 & x30 & x31 & ~x33;
  assign new_n79_ = new_n67_ & (~new_n65_ | ~x30 | ~new_n80_ | ~x31 | x33);
  assign new_n80_ = x15 & x16 & x12 & ~x17;
  assign new_n81_ = (~x30 | ~x33) & (~new_n82_ | (~new_n63_ & (new_n62_ | ~x15)));
  assign new_n82_ = x17 & ~x30 & ~x31 & ~x33;
