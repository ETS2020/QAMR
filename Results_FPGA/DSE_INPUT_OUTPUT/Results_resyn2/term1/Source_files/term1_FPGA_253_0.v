...
module FAU ( 
  ...
  assign z6 = new_n52_ & x24 & ~x26 & (~new_n58_ | ~x30) & (new_n58_ | x30);
  assign new_n58_ = x29 & x27 & x28;
  assign z7 = x26 | (x24 & ((~x31 & new_n58_ & x30) | ~new_n52_ | (x31 & (~new_n58_ | ~x30))));
  ...
  assign new_n72_ = (~new_n73_ | new_n67_ | ~new_n68_) & x00 & x24 & ~x26;
