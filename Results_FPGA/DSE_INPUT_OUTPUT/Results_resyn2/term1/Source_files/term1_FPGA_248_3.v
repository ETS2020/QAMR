...
module FAU ( 
  ...
  assign z3 = x01 & (x26 | (~x27 & new_n54_ & (~new_n52_ | ~new_n53_)));
  assign new_n52_ = (x18 | x23) & (x17 | x22);
  assign new_n53_ = (x19 | x24) & (x16 | x21) & (x15 | x20);
  assign new_n54_ = x25 & (~x02 | ~x03);
  assign z4 = new_n56_ & (~x27 | ~x28) & ~x26 & (x27 | x28);
  assign new_n56_ = x01 & new_n54_ & (~new_n52_ | ~new_n53_);
  assign z5 = new_n56_ & (x29 | (x27 & x28)) & ~x26 & (~x29 | ~x27 | ~x28);
  assign z6 = x01 & (x26 | (new_n59_ & new_n54_ & (~new_n52_ | ~new_n53_)));
  assign new_n59_ = ~x30 ^ (~x29 | ~x27 | ~x28);
  assign z7 = ~x01 | (~x26 & (~new_n61_ | ~new_n54_ | (new_n52_ & new_n53_)));
