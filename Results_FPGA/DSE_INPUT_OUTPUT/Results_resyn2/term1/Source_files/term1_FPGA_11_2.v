...
module FAU ( 
  ...
  assign z0 = ~z8 & ~x32;
  assign z8 = x00 & ~x26;
  assign z1 = (~x32 & (~x02 | ~x03) & (x02 | x03)) | z8 | (~x33 & (~x02 ^ x03));
  assign z2 = z8 | ((~new_n50_ | (~x04 & ~x07) | (x04 & x07)) & (new_n50_ | (~x04 ^ ~x07)) & x08 & ~x09);
  ...
  assign z6 = ~x26 & (x00 | (new_n60_ & new_n54_ & (~new_n52_ | ~new_n53_)));
