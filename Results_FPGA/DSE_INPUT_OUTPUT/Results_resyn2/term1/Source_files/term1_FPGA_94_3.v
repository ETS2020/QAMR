...
module FAU ( 
  ...
  assign new_n65_ = ~x26 & (~x32 | (~new_n66_ & new_n67_ & new_n68_));
  ...
  assign z9 = x00 & (x26 | (~new_n73_ & ((~new_n71_ & new_n72_) | x33)));
  assign new_n71_ = ~new_n63_ & (~x15 | (~new_n62_ & (new_n61_ | ~x16)));
  assign new_n72_ = new_n69_ ? (x30 & x31) : (~x30 & ~x31);
  assign new_n73_ = ~new_n66_ & new_n67_ & new_n74_ & (~new_n69_ | (x30 & x31)) & (new_n69_ | (~x30 & ~x31));
