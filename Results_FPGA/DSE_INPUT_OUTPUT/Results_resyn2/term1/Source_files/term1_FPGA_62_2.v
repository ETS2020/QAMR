...
module FAU ( 
  ...
  assign z1 = (~x05 | x26) & (((~x03 | ~x33) & x02 & (x03 | ~x32)) | ((~x03 | ~x32) & ~x02 & (x03 | ~x33)));
  assign z2 = new_n51_ & (~x05 | (~new_n49_ & x26)) & x08 & ~x09;
  assign new_n49_ = new_n50_ & ~x02 & x06 & ~x01 & ~x03;
  assign new_n50_ = x04 ^ ~x07;
  assign new_n51_ = (~new_n50_ | (((~x02 & ~x03) | ~x01 | (x02 & x03)) & (x01 | (~x02 & x06) | (~x03 & x05)))) & ((~x01 & ((~x02 & x06) ^ (x03 | ~x05))) | new_n50_ | ((x02 | x03) & x01 & (~x02 | ~x03)));
  assign z3 = ~x26 & (x05 | (new_n53_ & ~x27));
  assign new_n53_ = (~new_n54_ | ~new_n55_) & x25 & x01 & (~x02 | ~x03);
  assign new_n54_ = (x18 | x23) & (x16 | x21);
  assign new_n55_ = (x17 | x22) & (x19 | x24) & (x15 | x20);
  assign z4 = new_n53_ & ~x05 & ~x26 & (~x27 | ~x28) & (x27 | x28);
  assign z5 = new_n53_ & ~x05 & ~x26 & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28));
  assign z6 = new_n53_ & ~x05 & ~x26 & (~new_n59_ | ~x30) & (new_n59_ | x30);
  assign new_n59_ = x29 & x27 & x28;
  assign z7 = x26 | (~x05 & (~new_n53_ | (x31 & (~new_n59_ | ~x30)) | (~x31 & new_n59_ & x30)));
  assign z8 = ~x26 & (x05 | (~new_n62_ & x00));
  ...
  assign new_n73_ = (~new_n74_ | new_n68_ | ~new_n69_) & x00 & ~x05 & ~x26;
