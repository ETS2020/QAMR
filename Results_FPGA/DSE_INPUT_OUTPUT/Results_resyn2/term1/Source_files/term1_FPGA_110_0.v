...
module FAU ( 
  ...
  assign z1 = (~x32 & (x02 | x03) & (~x02 | ~x03)) | (~x24 & ~x26) | (~x33 & (x02 ^ ~x03));
  ...
  assign z6 = new_n58_ & new_n52_ & x24 & ~x26;
  assign new_n58_ = x30 ^ (x29 & x27 & x28);
  assign z7 = ~new_n60_ | ~new_n52_ | ~x24 | x26;
  assign new_n60_ = x31 ^ (~x30 | ~x29 | ~x27 | ~x28);
  assign z8 = ~x26 & (~x24 | (~new_n62_ & x00));
