...
module FAU ( 
  ...
  assign new_n50_ = x08 & ~x09 & (~x24 | x26);
  assign z3 = ~x26 & (x24 | (new_n52_ & ~x27));
  assign new_n52_ = new_n54_ & (~new_n53_ | ~x19 | (~x15 & ~x20));
  assign new_n53_ = (x18 | x23) & (x17 | x22) & (x16 | x21);
  assign new_n54_ = (~x02 | ~x03) & x01 & x25;
  assign z4 = ~x26 & (x24 | (new_n52_ & (x27 | x28) & (~x27 | ~x28)));
  assign z5 = ~x26 & (x24 | (new_n52_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28))));
  assign z6 = new_n52_ & (~new_n58_ | ~x30) & (new_n58_ | x30) & ~x24 & ~x26;
  assign new_n58_ = x29 & x27 & x28;
  assign z7 = x26 | (~x24 & (~new_n52_ | (new_n58_ & (~x30 ^ ~x31)) | (~new_n58_ & x31)));
  ...
  assign new_n69_ = x00 & ~x24 & ~x26;
  assign z9 = ~x26 & (x24 | (new_n71_ & (x33 | (~new_n64_ & new_n72_))));
  assign new_n71_ = x00 & (~new_n72_ | ~new_n73_ | ~new_n62_ | ~new_n63_);
  assign new_n72_ = (x30 ^ (~x29 | (~x27 & ~x28))) & (~x30 | x31) & (x30 | ~x31);
