...
module FAU ( 
  ...
  assign z4 = ~x26 & (x27 | (new_n52_ & x28));
  assign z5 = new_n52_ & x29 & ~x26 & ~x27;
  ...
  assign new_n74_ = x28 & x29 & ((x30 & x32) | (new_n69_ & ~x32 & ~x30 & x31));
  assign new_n75_ = ~x27 & x00 & ~x26;
  assign z9 = (x33 | (~new_n67_ & new_n78_)) & new_n75_ & (~new_n71_ | ~new_n77_);
  assign new_n77_ = new_n78_ & ~new_n79_ & ~new_n73_ & x33 & (x13 | x18);
  assign new_n78_ = (x28 & x29) ? (x30 & x31) : (~x30 & ~x31);
