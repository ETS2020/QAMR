...
module FAU ( 
  ...
  assign z6 = new_n49_ | (new_n52_ & (x30 | (x29 & x27 & x28)) & (~x30 | ~x29 | ~x27 | ~x28));
  assign z7 = new_n49_ ^ (~new_n52_ | ~new_n59_);
  assign new_n59_ = (x29 & x27 & x28) ? (x30 ^ ~x31) : ~x31;
  assign z8 = (x26 & ~x32) | (x00 & ((~new_n61_ & ~x26 & x32) | (~new_n66_ & new_n70_)));
  assign new_n61_ = new_n64_ & new_n65_ & ~new_n62_ & new_n63_;
  assign new_n62_ = (~x17 | ~x18 | ~x10 | ~x16) & (~x15 | (~x16 & (~x11 | ~x17 | ~x18)));
  ...
  assign new_n70_ = new_n64_ & x31 & ~x32;
  assign z9 = (x33 | (~new_n66_ & new_n73_)) & new_n75_ & (~new_n72_ | ~new_n73_ | ~new_n74_);
  assign new_n72_ = ~new_n62_ & new_n63_;
  assign new_n73_ = ~new_n64_ & (x30 | ~x31) & (~x30 | x31);
