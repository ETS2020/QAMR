...
module FAU ( 
  ...
  assign z1 = ((~x03 | ~x32) & ~x02 & (x03 | ~x33)) | ((x03 | ~x32) & (~x03 | ~x33) & x02 & ~x26);
  assign z2 = (x02 & x26) | (~new_n49_ & x08 & ~x09);
  assign new_n49_ = (~new_n50_ | ((~x01 | (x02 ^ x03)) & ((x01 & (~x05 | x02 | x03)) | ((x03 | ~x05) & (x02 | ~x06)) | (~x03 & x05 & ~x02 & x06)))) & ((~x01 & ((~x03 & x05) | (~x02 & x06)) & (x03 | ~x05 | x02 | ~x06)) | new_n50_ | (x01 & (~x02 ^ x03)));
  assign new_n50_ = x04 ^ ~x07;
  assign z3 = (x02 & x26) | (new_n52_ & ~x27);
  ...
  assign z4 = (x02 & x26) | (new_n52_ & (~x27 | ~x28) & (x27 | x28));
  assign z5 = (x02 & x26) | (new_n52_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28)));
  assign z6 = new_n52_ & (~x30 | ~x29 | ~x27 | ~x28) & (x30 | (x29 & x27 & x28));
  assign z7 = ~new_n52_ | (x31 & (~x30 | ~x29 | ~x27 | ~x28)) | (~x31 & x30 & x29 & x27 & x28);
  assign z8 = (x02 & x26) | (~new_n60_ & x00 & ~x26);
