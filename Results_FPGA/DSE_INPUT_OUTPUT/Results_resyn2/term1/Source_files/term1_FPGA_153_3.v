...
module FAU ( 
  ...
  assign z8 = ~new_n60_ & x00 & ~x26;
  assign new_n60_ = ((~x32 & (new_n61_ | ~x30 | ~x31)) | new_n69_ | (x30 & x32)) & (~new_n69_ | ((~x30 | ~x32) & (new_n61_ | x32 | x30 | ~x31))) & (new_n65_ | ~x32);
  ...
  assign new_n65_ = ~new_n66_ & new_n67_ & new_n68_;
  ...
  assign z9 = (x26 & x33) | (x00 & (new_n71_ | new_n72_ | (~new_n73_ & x33)));
  assign new_n71_ = (x33 | (~new_n61_ & ~x26 & ~x30 & ~x31)) & ~new_n69_ & (x30 | ~x33);
  assign new_n72_ = new_n69_ & ((~x30 & x33) | (~new_n61_ & ~x26 & ~x33 & x30 & x31));
  assign new_n73_ = ~new_n66_ & new_n67_ & new_n74_;
  assign new_n74_ = (~x30 ^ x31) & (x17 | (x12 & x18)) & (x13 | x18);
endmodule
