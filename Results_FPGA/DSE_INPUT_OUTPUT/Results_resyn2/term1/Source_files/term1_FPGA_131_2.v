...
module FAU ( 
  ...
  assign new_n49_ = (~new_n50_ | (((x02 & ~x03) | ~x01 | (~x02 & x03)) & ((x01 & (x02 | x03 | ~x05)) | (x06 & ~x02 & ~x03 & x05) | (x02 & (x03 | ~x05)) | (~x06 & (x03 | ~x05))))) & (((~x06 | x02 | x03 | ~x05) & (x06 | x02 | ~x03) & (~x02 | (~x03 & x05)) & ~x01 & (x05 | x06)) | new_n50_ | ((~x02 | x03) & x01 & (x02 | ~x03)));
  ...
  assign new_n64_ = (~x17 | ((~x18 | ~x14 | x19) & (~x13 | x18 | ~x19))) & (x17 | ~x19 | ~x12 | ~x18);
