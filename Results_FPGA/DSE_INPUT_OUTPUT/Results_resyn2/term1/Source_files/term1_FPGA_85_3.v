...
module FAU ( 
  ...
  assign new_n59_ = (x30 & x27 & x28 & x29) ? (x31 & ~x33) : ~x31;
  assign z8 = ((~new_n61_ & ~x33) | (~x31 & x32)) & x00 & ~x26;
  ...
  assign new_n66_ = ~new_n67_ & ~new_n68_ & ~new_n69_ & (new_n65_ | x15);
  assign new_n67_ = (~x19 | (~x16 & (~x11 | ~x17 | ~x18))) & (~x15 | ~x16 | ~x17 | ~x18);
  assign new_n68_ = (~x12 | ~x18) & (~x17 | (~x13 & ~x18));
  assign new_n69_ = x15 & x16 & x17 & x18 & (~x14 | x19);
  assign new_n70_ = x29 & (x27 | x28);
  assign z9 = (x31 & x33) | (new_n72_ & (x33 | (~new_n62_ & (~new_n70_ | (x30 & x31)) & (new_n70_ | (~x30 & ~x31)))));
  assign new_n72_ = x00 & ~x26 & (~new_n66_ | new_n70_ | x30 | ~x33);
endmodule
