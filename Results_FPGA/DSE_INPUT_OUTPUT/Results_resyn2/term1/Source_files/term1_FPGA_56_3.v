...
module FAU ( 
  ...
  assign z8 = new_n47_ | ((new_n60_ | x32) & ~new_n64_ & ~new_n69_ & new_n70_);
  assign new_n60_ = x31 & (new_n63_ | (x15 & (new_n62_ | (~new_n61_ & x16))));
  ...
  assign new_n64_ = (~x32 | (new_n65_ & new_n66_ & new_n67_ & ~x30)) & new_n68_ & (x30 | x32);
  assign new_n65_ = (x16 | (x11 & x17 & x18)) & (x15 | (x17 & x18 & x10 & x16));
  assign new_n66_ = (x15 & x16 & x17 & x18) ? (x14 & ~x19) : x19;
  assign new_n67_ = (x17 | (x12 & x18)) & x31 & (x13 | x18);
  assign new_n68_ = x29 & (x27 | x28);
  assign new_n69_ = ~new_n68_ & ((~x30 & ~x32) | (new_n65_ & new_n66_ & new_n67_ & x30 & x32));
  assign new_n70_ = x00 & (~x26 | (new_n63_ & ~x32));
  assign z9 = (x33 | (~new_n72_ & new_n74_)) & new_n76_ & (~new_n73_ | ~new_n74_ | ~new_n75_);
  assign new_n72_ = ~new_n63_ & (~x15 | (~new_n62_ & (new_n61_ | ~x16)));
  assign new_n73_ = new_n65_ & new_n66_;
