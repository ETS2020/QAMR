...
module FAU ( 
  ...
  assign z1 = (~x33 & (x02 | ~x03) & (~x02 | x03)) | (~x05 & x26) | (~x32 & (x02 ^ x03));
  assign z2 = ((~x04 ^ ~x07) ? ~new_n49_ : ~new_n50_) & x08 & ~x09;
  assign new_n49_ = (((x02 | ~x06) & (x05 ? ~x03 : x26)) | x01 | ((x03 | ~x05) & ~x02 & x06)) & (~x01 | (~x05 & x26) | (~x02 & ~x03) | (x02 & x03));
  assign new_n50_ = ((~x02 & x06 & (x05 ? ~x03 : x26)) | x01 | ((x03 | ~x05) & (x02 | ~x06))) & (~x01 | (~x05 & x26) | (x02 & ~x03) | (~x02 & x03));
  ...
  assign z5 = (~x05 & x26) | (new_n52_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28)));
