...
module FAU ( 
  ...
  assign new_n50_ = (x21 | x26) & x08 & ~x09;
  assign z3 = new_n52_ & ~x27;
  assign new_n52_ = new_n54_ & (~new_n53_ | (~x15 & ~x20) | (~x17 & ~x22));
  assign new_n53_ = (x18 | x23) & (x19 | x24);
  assign new_n54_ = x01 & (~x02 | ~x03) & ~x26 & x21 & x25;
  ...
  assign z8 = ~x26 & (~x21 | (~new_n60_ & x00));
  ...
  assign z9 = new_n71_ & (x33 | (~new_n61_ & new_n73_));
  assign new_n71_ = ~x26 & x00 & x21 & (~new_n72_ | new_n66_ | ~new_n67_);
  assign new_n72_ = new_n73_ & (x17 | (x12 & x18)) & x33 & (x13 | x18);
