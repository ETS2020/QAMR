...
module FAU ( 
  ...
  assign z3 = ~x26 & (~x25 | (new_n52_ & ~x27));
  assign new_n52_ = ~new_n53_ & x01 & (~x02 | ~x03);
  assign new_n53_ = new_n54_ & (x18 | x23) & (x17 | x22);
  assign new_n54_ = (x19 | x24) & (x16 | x21) & (x15 | x20);
  assign z4 = ~new_n53_ & new_n56_ & (x27 | x28) & (~x27 | ~x28);
  assign new_n56_ = x01 & (~x02 | ~x03) & x25 & ~x26;
  assign z5 = ~new_n53_ & new_n56_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28));
  assign z6 = ~x26 & (~x25 | (new_n52_ & (~new_n59_ | ~x30) & (new_n59_ | x30)));
  assign new_n59_ = x29 & x27 & x28;
  assign z7 = x26 | (x25 & (~new_n52_ | (x31 & (~new_n59_ | ~x30)) | (~x31 & new_n59_ & x30)));
  assign z8 = ~x26 & (~x25 | (~new_n62_ & x00));
  ...
  assign new_n73_ = (~new_n74_ | new_n68_ | ~new_n69_) & x00 & x25 & ~x26;
