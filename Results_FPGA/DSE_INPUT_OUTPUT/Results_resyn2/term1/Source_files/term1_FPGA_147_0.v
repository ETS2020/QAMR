...
module FAU ( 
  ...
  assign z4 = new_n51_ & x09 & ~x26 & (~x27 | ~x28) & (x27 | x28);
  assign z5 = new_n51_ & x09 & ~x26 & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28));
  assign z6 = ~x26 & (~x09 | (new_n51_ & new_n57_));
  assign new_n57_ = x30 ^ (x29 & x27 & x28);
  assign z7 = ~new_n59_ | ~new_n51_ | ~x09 | x26;
