...
module FAU ( 
  ...
  assign z7 = ~new_n52_ | (x29 & x27 & x28 & (~x30 ^ ~x31)) | (x31 & (~x29 | ~x27 | ~x28));
  assign z8 = new_n47_ | (x00 & (new_n60_ | new_n65_));
  assign new_n60_ = ~x26 & x32 & (new_n61_ | ~new_n62_ | ~new_n63_ | ~new_n64_);
  ...
  assign new_n65_ = new_n69_ & (new_n68_ | (x15 & (new_n67_ | (~new_n66_ & x16))));
  assign new_n66_ = (~x17 | ((~x18 | ~x14 | x19) & (~x19 | ~x13 | x18))) & (~x12 | ~x18 | x17 | ~x19);
  assign new_n67_ = ~x16 & x19 & x11 & x17 & x18;
  assign new_n68_ = x17 & x18 & x10 & x16 & ~x15 & x19;
  assign new_n69_ = x31 & ~x32 & (x30 | (x29 & (x27 | x28))) & (~x30 | ~x29 | (~x27 & ~x28));
  assign z9 = (x33 | (~new_n72_ & new_n73_)) & new_n75_ & (~new_n71_ | ~new_n73_ | ~new_n74_);
  assign new_n71_ = ~new_n61_ & new_n62_;
  assign new_n72_ = ~new_n68_ & (~x15 | (~new_n67_ & (new_n66_ | ~x16)));
  assign new_n73_ = ~new_n63_ & (x30 | ~x31) & (~x30 | x31);
