...
module FAU ( 
  ...
  assign z7 = ~new_n52_ | (x31 & (~x29 | ~x27 | ~x28)) | (x29 & x27 & x28 & (~x30 | ~x31) & (x30 | x31));
  assign z8 = (x26 & x33) | (~new_n60_ & x00 & ~x26);
  ...
  assign new_n62_ = (~x17 | ((~x18 | ~x14 | x19) & (~x13 | x18 | ~x19))) & (x17 | ~x19 | ~x12 | ~x18);
  ...
  assign new_n73_ = ~new_n66_ & new_n67_ & ~new_n68_ & (~x30 ^ x31);
endmodule
