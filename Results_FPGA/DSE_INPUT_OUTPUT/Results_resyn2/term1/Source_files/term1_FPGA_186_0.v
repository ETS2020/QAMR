...
module FAU ( 
  ...
  assign new_n49_ = (((x02 | ~x06) & (x05 ? ~x03 : ~x26)) | x01 | (~x02 & x06 & (x03 | ~x05))) & (~x01 | (~x05 & ~x26) | (~x02 & ~x03) | (x02 & x03));
  assign new_n50_ = ((~x02 & x06 & (x05 ? ~x03 : ~x26)) | x01 | ((x02 | ~x06) & (x03 | ~x05))) & (~x01 | (~x05 & ~x26) | (x02 & ~x03) | (~x02 & x03));
  assign z3 = ~x26 & (~x05 | (new_n52_ & ~x27));
  assign new_n52_ = (~new_n53_ | ~new_n54_) & (~x02 | ~x03) & x01 & x25;
  assign new_n53_ = (x15 | x20) & (x19 | x24);
  assign new_n54_ = (x18 | x23) & (x17 | x22) & (x16 | x21);
  assign z4 = ~x26 & (~x05 | (new_n52_ & (~x27 | ~x28) & (x27 | x28)));
  assign z5 = ~x26 & (~x05 | (new_n52_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28))));
  assign z6 = new_n58_ & new_n52_ & x05 & ~x26;
  assign new_n58_ = x30 ^ (x29 & x27 & x28);
  assign z7 = ~new_n60_ | ~new_n52_ | ~x05 | x26;
