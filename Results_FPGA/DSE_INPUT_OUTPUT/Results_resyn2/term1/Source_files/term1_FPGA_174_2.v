...
module FAU ( 
  ...
  assign z1 = (~x33 & (~x02 | x03) & (x02 | ~x03)) | (x04 & ~x26) | (~x32 & (~x02 ^ ~x03));
  assign z2 = (x04 & ~x26) | ((~new_n49_ | (x04 ^ ~x07)) & (new_n49_ | (x04 & ~x07) | (~x04 & x07)) & x08 & ~x09);
  assign new_n49_ = ((~x02 & ~x03) | ~x01 | (x02 & x03)) & (((x03 | ~x05) & ~x02 & x06) | x01 | (~x03 & x05 & (x02 | ~x06)));
  assign z3 = ~x26 & (x04 | (new_n51_ & ~x27));
  assign new_n51_ = (~new_n52_ | ~new_n53_) & x25 & x01 & (~x02 | ~x03);
  assign new_n52_ = (x18 | x23) & (x17 | x22);
  assign new_n53_ = (x19 | x24) & (x16 | x21) & (x15 | x20);
  assign z4 = ~x26 & (x04 | (new_n51_ & (~x27 | ~x28) & (x27 | x28)));
  assign z5 = new_n51_ & (x29 | (x27 & x28)) & ~x04 & ~x26 & (~x29 | ~x27 | ~x28);
  assign z6 = ~x26 & (x04 | (new_n51_ & new_n57_));
  assign new_n57_ = x30 ^ (x29 & x27 & x28);
  assign z7 = x26 | (~x04 & (~new_n51_ | ~new_n59_));
