...
module FAU ( 
  ...
  assign z9 = (x26 & x28) | (x00 & (new_n73_ | (~new_n71_ & ~x26)));
  assign new_n71_ = (new_n72_ | ~x33) & (new_n69_ | ((~x30 | ~x33) & (new_n61_ | x33 | x30 | x31)));
  assign new_n72_ = ~new_n66_ & new_n67_ & ~new_n68_ & (~x30 ^ x31);
  assign new_n73_ = (x33 | (~new_n61_ & x30 & x31)) & ~new_n74_ & x29 & (~x30 | ~x33);
