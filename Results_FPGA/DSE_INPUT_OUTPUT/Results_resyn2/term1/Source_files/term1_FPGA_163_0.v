...
module FAU ( 
  ...
  assign new_n54_ = x01 & (~x02 | ~x03) & x25 & x00 & ~x26;
  ...
  assign z8 = new_n69_ & (((new_n60_ | x30) & new_n70_ & (~x30 | x32)) | (~new_n65_ & x32) | ((new_n60_ | ~x30) & ~new_n70_ & (x30 | x32)));
  ...
  assign z9 = ~x26 & (~x00 | (~new_n74_ & (x33 | (~new_n72_ & new_n73_))));
  assign new_n72_ = ~new_n63_ & (~x15 | (~new_n62_ & (new_n61_ | ~x16)));
  assign new_n73_ = new_n70_ ? (x30 & x31) : (~x30 & ~x31);
  assign new_n74_ = ~new_n66_ & new_n67_ & new_n75_ & (~new_n70_ | (x30 & x31)) & (new_n70_ | (~x30 & ~x31));
