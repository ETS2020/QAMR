...
module FAU ( 
  ...
  assign new_n61_ = ((~new_n62_ & ~x30) | ~new_n71_ | (x30 & ~x32)) & ((~new_n62_ & x30) | new_n71_ | (~x30 & ~x32)) & (~x32 | (new_n67_ & new_n69_));
  ...
  assign new_n65_ = x10 & x16 & x17 & x18 & ~x15 & x19;
  assign new_n66_ = x31 & ~x32;
  assign new_n67_ = ((x14 & ~x19) | ~x15 | ~new_n68_ | ~x16) & (x16 | (new_n68_ & x11));
  assign new_n68_ = x17 & x18;
  assign new_n69_ = (x19 | (x15 & new_n68_ & x16)) & new_n70_ & (x15 | (new_n68_ & x16));
  assign new_n70_ = (x17 | (x12 & x18)) & x31 & (x13 | x18);
  assign new_n71_ = x29 & (x27 | x28);
  assign z9 = ~new_n73_ & (~new_n75_ | ~new_n67_) & x00 & ~x26;
  assign new_n73_ = ~x33 & (new_n74_ | (~x30 & x31) | (x30 & ~x31) | (~new_n71_ & x30) | (new_n71_ & ~x30));
  assign new_n74_ = ~new_n65_ & (~x15 | (~new_n64_ & (new_n63_ | ~x16)));
  assign new_n75_ = new_n77_ & ~new_n76_ & new_n79_ & (x17 | (x12 & x18));
  assign new_n76_ = ~x19 & (~x15 | ~new_n68_ | ~x16);
  assign new_n77_ = (~new_n71_ | x30) & (new_n71_ | ~x30) & (new_n78_ | x15);
  assign new_n78_ = x10 & x16 & x17 & x18;
  assign new_n79_ = (x30 | ~x31) & (~x30 | x31) & x33 & (x13 | x18);
endmodule
