...
module FAU ( 
  ...
  assign new_n54_ = (x18 | x23) & (x16 | x21) & (x19 | x24);
  assign z4 = new_n52_ & x01 & ~x26 & (~x27 | ~x28) & (x27 | x28);
  assign z5 = ~x26 & (~x01 | (new_n52_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28))));
  assign z6 = ~new_n58_ & ~x26;
  assign new_n58_ = x01 & (~new_n52_ | (x30 & x29 & x27 & x28) | (~x30 & (~x29 | ~x27 | ~x28)));
  assign z7 = ~new_n60_ | ~new_n52_ | ~x01 | x26;
  assign new_n60_ = x31 ^ (~x30 | ~x29 | ~x27 | ~x28);
  assign z8 = ~x26 & (~x01 | (~new_n62_ & x00));
