...
module FAU ( 
  ...
  assign new_n50_ = (~x26 | ~x32) & x08 & ~x09;
  ...
  assign z4 = (x26 & x32) | (new_n52_ & (~x27 | ~x28) & (x27 | x28));
  assign z5 = (x26 & x32) | (new_n52_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28)));
  assign z6 = new_n52_ & (x30 | (x29 & x27 & x28)) & (~x30 | ~x29 | ~x27 | ~x28);
  assign z7 = new_n59_ ^ (~x26 | ~x32);
  assign new_n59_ = new_n52_ & (~x31 | (x30 & x29 & x27 & x28)) & (x31 | ~x30 | ~x29 | ~x27 | ~x28);
  assign z8 = (~new_n61_ & x00) | (x26 & x32);
  assign new_n61_ = (~new_n71_ | ((~x30 | ~x32) & (~new_n62_ | x26 | x30))) & (new_n67_ | ~x32) & (new_n71_ | ((x30 | ~x32) & (~new_n62_ | x26 | ~x30)));
  ...
  assign z9 = new_n73_ | (x26 & x32);
  assign new_n73_ = (x33 | (~new_n74_ & new_n76_)) & new_n78_ & (~new_n75_ | ~new_n76_ | ~new_n77_);
