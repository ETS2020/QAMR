...
module FAU ( 
  ...
  assign new_n66_ = (x17 & x18 & x15 & x16) ? (~x14 | x19) : ~x19;
  assign new_n67_ = x31 & ((x11 & x18) | (x16 & (x13 | x18)));
  assign new_n68_ = (x15 | (x18 & x10 & x16)) & (x17 | (x18 & x15 & x16));
  assign new_n69_ = (x27 | x28) & x29;
  assign new_n70_ = x15 & x16 & x32 & x00 & ~x17;
  assign z9 = (x33 | (~new_n61_ & new_n73_)) & ~new_n72_ & x00 & ~x26;
  assign new_n72_ = ~new_n66_ & ~new_n74_ & (new_n64_ | x15) & new_n73_ & x33;
  assign new_n73_ = new_n69_ ? (x30 & x31) : (~x30 & ~x31);
  assign new_n74_ = (~x16 | ((~x12 | ~x18) & (~x17 | (~x13 & ~x18)))) & (~x11 | ~x17 | ~x18);
endmodule
