...
module FAU ( 
  ...
  assign z1 = (~x33 & (~x02 | x03) & (x02 | ~x03)) | (x23 & x26) | (~x32 & (~x02 ^ ~x03));
  ...
  assign z3 = (x23 & x26) | (new_n52_ & ~x27);
  assign new_n52_ = new_n54_ & (~new_n53_ | (~x18 & ~x23) | (~x17 & ~x22));
  assign new_n53_ = (x15 | x20) & (x19 | x24) & (x16 | x21);
  assign new_n54_ = x25 & ~x26 & x01 & (~x02 | ~x03);
  assign z4 = (x23 & x26) | (new_n52_ & (~x27 | ~x28) & (x27 | x28));
  assign z5 = (x23 & x26) | (new_n52_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28)));
  assign z6 = new_n52_ & (~x30 | ~x29 | ~x27 | ~x28) & (x30 | (x29 & x27 & x28));
  assign z7 = ~new_n52_ | (x31 & (~x30 | ~x29 | ~x27 | ~x28)) | (~x31 & x30 & x29 & x27 & x28);
  assign z8 = (x23 & x26) | (~new_n60_ & x00 & ~x26);
