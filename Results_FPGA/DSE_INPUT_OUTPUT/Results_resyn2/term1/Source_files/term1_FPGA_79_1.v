...
module FAU ( 
  ...
  wire new_n47_, new_n50_, new_n52_, new_n53_, new_n54_, new_n55_, new_n58_,
    new_n59_, new_n61_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_,
  ...
  assign z3 = new_n47_ | (new_n52_ & ~x27 & x01 & x25);
  assign new_n52_ = new_n55_ & (~new_n53_ | ~new_n54_);
  assign new_n53_ = (x15 | x20) & (x16 | x21);
  assign new_n54_ = (x18 | x23) & (x17 | x22) & (x19 | x24);
  assign new_n55_ = (~x02 | ~x03) & (~x26 | (~x18 & ~x23));
  assign z4 = new_n47_ | (new_n52_ & (x27 | x28) & x01 & x25 & (~x27 | ~x28));
  assign z5 = new_n58_ & (x29 | (x27 & x28)) & (~x29 | ~x27 | ~x28);
  assign new_n58_ = new_n59_ & (~new_n53_ | ~new_n54_);
  assign new_n59_ = x01 & x25 & ~x26 & (~x02 | ~x03);
  assign z6 = new_n47_ | (new_n52_ & new_n61_);
  assign new_n61_ = (~x30 | ~x29 | ~x27 | ~x28) & x01 & x25 & (x30 | (x29 & x27 & x28));
  assign z7 = ~new_n58_ | (~x31 ^ (~x30 | ~x29 | ~x27 | ~x28));
