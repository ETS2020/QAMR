...
module FAU ( 
  ...
  wire new_n47_, new_n50_, new_n52_, new_n53_, new_n54_, new_n57_, new_n61_,
  ...
  assign new_n54_ = (x19 | x24) & (x17 | x22) & (x15 | x20);
  assign z4 = new_n52_ & ~x26 & (~x27 | ~x28) & (x27 | x28);
  assign z5 = (~x24 & x26) | (new_n52_ & (new_n57_ | x29) & (~x26 | (~x19 & ~x24)) & (~new_n57_ | ~x29));
  assign new_n57_ = x27 & x28;
  assign z6 = new_n52_ & ~x26 & (~x30 | ~new_n57_ | ~x29) & (x30 | (new_n57_ & x29));
  assign z7 = ~new_n52_ | x26 | (x31 & (~x30 | ~new_n57_ | ~x29)) | (~x31 & x30 & new_n57_ & x29);
