...
module FAU ( 
  ...
  assign z1 = (x22 | x26) & (((~x03 | ~x33) & x02 & (x03 | ~x32)) | ((~x03 | ~x32) & ~x02 & (x03 | ~x33)));
  ...
  assign z3 = ~x26 & (~x22 | (new_n52_ & ~x27));
  ...
  assign z5 = new_n52_ & (x29 | (x27 & x28)) & (~x29 | ~x27 | ~x28) & x22 & ~x26;
  assign z6 = ~x26 & (~x22 | (new_n52_ & (~new_n58_ | ~x30) & (new_n58_ | x30)));
  assign new_n58_ = x29 & x27 & x28;
  assign z7 = x26 | (x22 & ((~x31 & new_n58_ & x30) | ~new_n52_ | (x31 & (~new_n58_ | ~x30))));
