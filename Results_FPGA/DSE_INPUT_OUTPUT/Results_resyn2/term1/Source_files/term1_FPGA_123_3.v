...
module FAU ( 
  ...
  assign new_n52_ = new_n54_ & (~new_n53_ | (~x18 & ~x23) | (~x16 & ~x21));
  assign new_n53_ = (x19 | x24) & (x15 | x20) & (x17 | x22);
