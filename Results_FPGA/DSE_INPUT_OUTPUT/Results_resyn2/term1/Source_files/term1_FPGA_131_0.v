...
module FAU ( 
  ...
  assign new_n49_ = (new_n50_ | ((x01 | ((x05 | x06) & ((~x03 & x05) ? (x02 | ~x06) : ~x02))) & (~x01 | (x02 ^ ~x03)) & (x06 | x02 | ~x03))) & ((((~x03 & x05) | x02 | ~x06) & ~x01 & (x03 | ~x05 | (~x02 & x06))) | ~new_n50_ | (x01 & (~x02 ^ ~x03)));
  assign new_n50_ = x04 ^ ~x07;
  assign z3 = ~x26 & (~x02 | (new_n52_ & ~x27));
  assign new_n52_ = (~new_n53_ | ~new_n54_) & x25 & x01 & ~x03;
  assign new_n53_ = (x18 | x23) & (x17 | x22);
  assign new_n54_ = (x19 | x24) & (x16 | x21) & (x15 | x20);
  assign z4 = ~x26 & (~x02 | (new_n52_ & (~x27 | ~x28) & (x27 | x28)));
  assign z5 = ~x26 & (~x02 | (new_n52_ & (x29 | (x27 & x28)) & (~x29 | ~x27 | ~x28)));
  assign z6 = new_n58_ & new_n52_ & x02 & ~x26;
  assign new_n58_ = ~x30 ^ (~x29 | ~x27 | ~x28);
  assign z7 = ~new_n60_ | ~new_n52_ | ~x02 | x26;
  assign new_n60_ = x31 ^ (~x30 | ~x29 | ~x27 | ~x28);
  assign z8 = ~x26 & (~x02 | (~new_n62_ & x00));
  ...
  assign new_n73_ = (~new_n74_ | new_n68_ | ~new_n69_) & x00 & x02 & ~x26;
