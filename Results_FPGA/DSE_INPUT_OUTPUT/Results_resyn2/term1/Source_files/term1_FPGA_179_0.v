// Benchmark "FAU" written by ABC on Thu Aug 13 18:46:33 2020
...
module FAU ( 
  ...
  assign new_n50_ = (x00 | x26) & x08 & ~x09;
  assign z3 = ~x26 & (~x00 | (new_n52_ & ~x27));
  assign new_n52_ = (~new_n53_ | ~new_n54_) & (~x02 | ~x03) & x01 & x25;
  assign new_n53_ = (x16 | x21) & (x18 | x23);
  assign new_n54_ = (x17 | x22) & (x15 | x20) & (x19 | x24);
  assign z4 = ~x26 & (~x00 | (new_n52_ & (~x27 | ~x28) & (x27 | x28)));
  assign z5 = ~x26 & (~x00 | (new_n52_ & (~x29 | ~x27 | ~x28) & (x29 | (x27 & x28))));
  assign z6 = new_n52_ & (~x30 | ~x29 | ~x27 | ~x28) & new_n58_ & (x30 | (x29 & x27 & x28));
  assign new_n58_ = x00 & ~x26;
  assign z7 = x26 | (x00 & (~new_n52_ | ~new_n60_));
  assign new_n60_ = x31 ^ (~x30 | ~x29 | ~x27 | ~x28);
  assign z8 = new_n58_ & (((new_n62_ | x30) & new_n71_ & (~x30 | x32)) | (~new_n67_ & x32) | ((new_n62_ | ~x30) & ~new_n71_ & (x30 | x32)));
  ...
  assign z9 = (x33 | (~new_n73_ & new_n75_)) & new_n58_ & (~new_n74_ | ~new_n75_ | ~new_n76_);
