...
module FAU ( 
  ...
  assign new_n54_ = new_n55_ & x00 & ~x26;
  assign new_n55_ = x25 & x01 & (~x02 | ~x03);
  assign z4 = ~new_n52_ & new_n54_ & (~x27 | ~x28) & (x27 | x28);
  assign z5 = ~x26 & (~x00 | (~new_n52_ & new_n55_ & (~new_n58_ | ~x29) & (new_n58_ | x29)));
  assign new_n58_ = x27 & x28;
  assign z6 = ~new_n52_ & new_n54_ & (~x30 | ~new_n58_ | ~x29) & (x30 | (new_n58_ & x29));
  assign z7 = new_n52_ | ~new_n54_ | (x31 & (~x30 | ~new_n58_ | ~x29)) | (~x31 & x30 & new_n58_ & x29);
