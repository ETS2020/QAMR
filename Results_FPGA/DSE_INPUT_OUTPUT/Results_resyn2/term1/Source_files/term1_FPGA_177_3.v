...
module FAU ( 
  ...
  assign new_n53_ = (x17 | x22) & (x18 | x23) & (x15 | x20);
  assign new_n54_ = (~x02 | ~x03) & ~x26 & x01 & x25;
  assign z4 = new_n52_ & (x27 | x28) & ~new_n47_ & (~x27 | ~x28);
  ...
  assign z9 = x00 & (x24 | (new_n74_ & (x33 | (~new_n73_ & new_n75_))));
  assign new_n73_ = ~new_n64_ & (~x15 | (~new_n63_ & (new_n62_ | ~x16)));
  assign new_n74_ = ~x26 & (~new_n75_ | ~new_n76_ | new_n67_ | ~new_n68_);
