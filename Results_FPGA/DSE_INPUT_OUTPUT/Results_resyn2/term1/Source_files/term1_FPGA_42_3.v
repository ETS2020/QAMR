...
module FAU ( 
  ...
  assign z8 = new_n47_ | ((new_n61_ | x32) & ~new_n65_ & ~new_n70_ & new_n71_);
  assign new_n61_ = x31 & (new_n64_ | (x15 & (new_n63_ | (~new_n62_ & x16))));
  ...
  assign new_n65_ = (~x32 | (new_n66_ & new_n67_ & new_n68_ & ~x30)) & new_n69_ & (x30 | x32);
  ...
  assign new_n70_ = ~new_n69_ & ((~x30 & ~x32) | (new_n66_ & new_n67_ & new_n68_ & x30 & x32));
  assign new_n71_ = x00 & (~x26 | (new_n64_ & ~x32));
  assign z9 = (x33 | (~new_n73_ & new_n75_)) & new_n77_ & (~new_n74_ | ~new_n75_ | ~new_n76_);
  assign new_n73_ = ~new_n64_ & (~x15 | (~new_n63_ & (new_n62_ | ~x16)));
  assign new_n74_ = new_n66_ & new_n67_;
