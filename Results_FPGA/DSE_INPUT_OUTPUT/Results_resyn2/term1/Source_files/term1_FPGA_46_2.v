...
module FAU ( 
  ...
  assign new_n60_ = ((~x32 & (new_n61_ | ~x30 | ~x31)) | new_n69_ | (x30 & x32)) & (new_n65_ | ~x32) & (~new_n69_ | ((~x30 | ~x32) & (new_n61_ | x32 | x30 | ~x31)));
  ...
  assign z9 = (x26 & ~x28) | (x00 & (new_n74_ | (~x26 & (new_n71_ | ~new_n72_))));
