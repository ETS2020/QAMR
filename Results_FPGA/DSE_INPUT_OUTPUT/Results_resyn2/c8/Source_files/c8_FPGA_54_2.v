...
module FAU ( 
  ...
  assign z09 = ((~x17 | x19) & x16 & (x17 | ~x19)) | (~x18 & (x08 | x16)) | (x00 & ~x16 & x18);
  assign z10 = (x16 & (new_n59_ ^ x20)) | (~x18 & (x09 | x16)) | (x01 & ~x16 & x18);
  assign new_n59_ = ~x17 & ~x19;
  assign z11 = (~new_n61_ & x16 & x18) | ((x02 | ~x18) & ~x16 & (x10 | x18));
  assign new_n61_ = (~x21 | (~x20 & ~x17 & ~x19)) & (x20 | x21 | x17 | x19);
  assign z12 = ((x03 | ~x18) & ~x16 & (x11 | x18)) | ((new_n63_ ^ x22) & x16 & x18);
  ...
  assign z15 = (~x18 & (x14 | x16)) | (x06 & ~x16 & x18) | (~new_n70_ & x16);
  assign new_n70_ = (~x25 | (new_n59_ & ~x20 & new_n68_ & ~x21 & ~x24)) & (~new_n59_ | x20 | x21 | ~new_n68_ | x24 | x25);
  assign z16 = (~x18 & (x15 | x16)) | (x07 & ~x16 & x18) | ((~new_n72_ | ~x26) & x16 & (new_n72_ | x26));
