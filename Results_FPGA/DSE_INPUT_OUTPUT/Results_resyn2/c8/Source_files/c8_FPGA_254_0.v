...
module FAU ( 
  ...
  assign z12 = (x16 & (new_n62_ ^ x22)) | (x03 & ~x16 & x18);
  assign new_n62_ = new_n59_ & ~x20 & ~x21;
  assign z13 = (x04 & ~x16 & x18) | (x16 & (((~new_n62_ | x22) & x23) | (new_n62_ & ~x22 & ~x23)));
  ...
  assign z16 = ((~x26 & new_n62_ & new_n70_) | ~x16 | (x26 & (~new_n62_ | ~new_n70_))) & (x07 | x16 | ~x18);
