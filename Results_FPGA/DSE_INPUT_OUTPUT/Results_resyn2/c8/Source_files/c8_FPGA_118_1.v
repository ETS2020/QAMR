...
module FAU ( 
  ...
  assign z11 = x16 ? (new_n62_ ? ~x21 : (x18 & x21)) : ((x02 & x18) | (x10 & ~x18 & ~x21));
  ...
  assign z13 = ~new_n66_ & (x16 | ((x04 | ~x18) & (x12 | x18 | x21)));
  ...
  assign new_n69_ = (~x05 | ~x18) & (~x13 | x18 | x21);
  ...
  assign new_n73_ = (~x06 | ~x18) & (~x14 | x18 | x21);
  assign z16 = new_n75_ | new_n76_;
  assign new_n75_ = x16 & ((~x25 & ~x26 & new_n72_ & new_n62_ & ~x21) | (x26 & (~new_n72_ | ~new_n62_ | x25)));
  assign new_n76_ = (x21 | (~x16 & (x15 | x18))) & ((x16 & x26) | ~x18 | (x07 & ~x16));
