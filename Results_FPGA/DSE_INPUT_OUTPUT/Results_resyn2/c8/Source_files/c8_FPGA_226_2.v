...
module FAU ( 
  ...
  assign z12 = ~new_n63_ | (~x19 & (x18 | (new_n65_ & x16)));
  assign new_n63_ = ((~x03 & x18) | x16 | (~x11 & ~x18)) & (~x16 | ~x22 | (new_n64_ & ~x18));
  assign new_n64_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n65_ = ~x17 & ~x20 & ~x21 & ~x22;
  assign z13 = (~new_n67_ & ~x16) | ((~new_n68_ | ~x23) & x16 & (~x18 | x19) & (new_n68_ | x23));
  assign new_n67_ = (~x12 | x18) & (~x04 | ~x18 | ~x19);
  assign new_n68_ = ~x21 & ~x22 & ~x20 & ~x17 & ~x19;
  assign z14 = x16 ? ~new_n70_ : ((x13 & ~x18) | (x05 & x18 & x19));
  assign new_n70_ = (~x19 | ~x24) & (x18 | ((~x24 | (new_n65_ & ~x23)) & (~new_n68_ | x23 | x24)));
  assign z15 = x16 ? ((x19 & x25) | (~new_n72_ & ~x18)) : ~new_n73_;
  assign new_n72_ = (~x25 | (new_n65_ & ~x23 & ~x24)) & (~new_n64_ | x23 | x24 | x22 | x25);
  assign new_n73_ = (~x14 | x18) & (~x06 | ~x18 | ~x19);
  assign z16 = x16 ? new_n75_ : ((x15 | x18) & (x07 | ~x18 | ~x19));
  assign new_n75_ = ((new_n64_ & new_n76_) | x26 | (x18 & ~x19)) & (~new_n64_ | x18 | ~new_n76_ | ~x26);
  assign new_n76_ = ~x22 & ~x25 & ~x23 & ~x24;
  assign z17 = x16 & (new_n78_ | (z08 & x17));
  assign new_n78_ = new_n76_ & ~x20 & ~x21 & ~x26 & ~x17 & x19;
endmodule
