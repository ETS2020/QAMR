...
module FAU ( 
  ...
  assign z07 = (x26 ? x27 : x25) & (~x15 | ~x27);
  ...
  assign z11 = ~new_n63_ | (x16 & (~x21 ^ (x17 | x19 | x20)));
  assign new_n63_ = (x25 | x26) & ((~x02 & x18) | x16 | (~x10 & ~x18));
  ...
  assign new_n70_ = (x25 | x26) & ((~x05 & x18) | x16 | (~x13 & ~x18));
  assign z15 = (~x25 & (~x26 | (new_n69_ & x16 & ~x24))) | new_n72_ | ((~new_n69_ | x24) & x16 & x25);
