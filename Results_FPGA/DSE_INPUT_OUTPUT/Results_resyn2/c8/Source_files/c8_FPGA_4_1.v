...
module FAU ( 
  ...
  wire new_n57_, new_n59_, new_n60_, new_n62_, new_n64_, new_n66_, new_n68_,
    new_n69_, new_n71_, new_n73_, new_n74_, new_n75_, new_n77_;
  ...
  assign z09 = (~x16 & ((x00 & x18) | (x08 & ~x18 & ~x27))) | (new_n57_ & x16 & (x18 | ~x27));
  assign new_n57_ = ~x17 ^ x19;
  assign z10 = (~x16 & ((x01 & x18) | (x09 & ~x18 & ~x27))) | (~new_n59_ & x16 & (x18 | ~x27));
