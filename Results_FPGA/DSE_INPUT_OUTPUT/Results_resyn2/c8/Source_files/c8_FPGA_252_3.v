// Benchmark "FAU" written by ABC on Wed Aug 12 14:35:27 2020
...
module FAU ( 
  ...
  assign z13 = (~x16 & ((x12 & ~x18) | (x04 & x18 & ~x23))) | ((~new_n67_ | ~x23) & x16 & (~x18 | ~x23) & (new_n67_ | x23));
  assign new_n67_ = new_n65_ & ~x22;
  assign z14 = new_n70_ | (x16 & ((~new_n67_ & x24) | (new_n69_ & ~x23)));
  assign new_n69_ = ~x20 & ~x17 & ~x19 & ~x21 & ~x22 & ~x24;
  assign new_n70_ = (x23 | (~x16 & (x05 | ~x18))) & ((x16 & x24) | x18 | (x13 & ~x16));
  assign z15 = new_n73_ | (x16 & ((~new_n69_ & x25) | (new_n65_ & new_n72_)));
  assign new_n72_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n73_ = (x23 | (~x16 & (x06 | ~x18))) & ((x16 & x25) | x18 | (x14 & ~x16));
  assign z16 = new_n77_ | (x16 & ((~new_n75_ & x26) | (new_n65_ & new_n72_ & ~x26)));
  assign new_n75_ = new_n76_ & ~x20 & ~x17 & ~x19;
  assign new_n76_ = ~x21 & ~x22 & ~x24 & ~x25;
  assign new_n77_ = (x23 | (~x16 & (x07 | ~x18))) & ((x16 & x26) | x18 | (x15 & ~x16));
  assign z17 = x16 & (new_n79_ | (z08 & x17));
  assign new_n79_ = new_n72_ & ~x26 & ~x20 & ~x21 & ~x17 & x19;
endmodule
