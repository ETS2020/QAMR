...
module FAU ( 
  ...
  assign new_n66_ = (~x20 | ~x23) & (x18 | ((~x23 | (new_n67_ & ~x17 & ~x19)) & (x17 | x19 | x20 | ~new_n67_ | x23)));
  assign new_n67_ = ~x21 & ~x22;
  assign z14 = new_n70_ | ((~new_n69_ | ~x24) & x16 & (new_n69_ | x24));
  assign new_n69_ = ~x17 & ~x19 & ~x20 & new_n67_ & ~x23;
  assign new_n70_ = (x18 | (x13 & ~x16)) & ((~x16 & (x05 | ~x18)) | ~x20 | (x16 & x24));
  assign z15 = x16 ? ~new_n72_ : ((x14 & ~x18) | (x06 & x18 & x20));
  assign new_n72_ = (~x20 | ~x25) & (x18 | ((new_n74_ | ~x25) & (~new_n73_ | ~new_n75_)));
  assign new_n73_ = ~x21 & ~x17 & ~x19 & ~x20;
  assign new_n74_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n75_ = ~x22 & ~x25 & ~x23 & ~x24;
  assign z16 = x16 ? (new_n77_ ? (x18 | ~x26) : ((x18 & ~x20) | x26)) : new_n78_;
  assign new_n77_ = new_n73_ & new_n75_;
  assign new_n78_ = (x15 | x18) & (x07 | ~x18 | ~x20);
  assign z17 = x16 & ((z08 & x17) | (new_n75_ & new_n80_ & ~x17 & ~x18));
  assign new_n80_ = x19 & ~x20 & ~x21 & ~x26;
endmodule
