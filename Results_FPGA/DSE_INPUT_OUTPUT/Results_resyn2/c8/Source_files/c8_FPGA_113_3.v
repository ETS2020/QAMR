...
module FAU ( 
  ...
  assign z11 = (~new_n62_ & x16) | ((x02 | ~x18) & ~x16 & (x10 | x18)) | (x18 & x27);
  ...
  assign z15 = (~x16 & ((x14 & ~x18) | (x06 & x18 & ~x27))) | (~new_n71_ & x16 & (~x18 | ~x27));
  assign new_n71_ = (~x25 | (new_n60_ & ~x20 & new_n72_ & ~x21 & ~x24)) & (~new_n60_ | x20 | x21 | ~new_n72_ | x24 | x25);
  assign new_n72_ = ~x22 & ~x23;
  assign z16 = new_n74_ | ((x07 | ~x18) & ~x16 & (x15 | x18)) | (x18 & x27);
  assign new_n74_ = (~x26 | ~new_n65_ | ~new_n72_ | x24 | x25) & x16 & (x26 | (new_n65_ & new_n72_ & ~x24 & ~x25));
  assign z17 = x16 & ((new_n78_ & x17) | (new_n76_ & ~x26 & ~x17 & x19));
  assign new_n76_ = new_n77_ & new_n72_ & ~x24 & ~x25;
  assign new_n77_ = ~x20 & ~x21 & (~x18 | ~x27);
