...
module FAU ( 
  ...
  assign z13 = new_n68_ & ((~x23 & new_n67_ & ~x21 & ~x22) | ~x16 | (x23 & (~new_n67_ | x21 | x22)));
  assign new_n67_ = ~x20 & ~x17 & ~x19;
  assign new_n68_ = (x24 | x26) & ((x04 & x18) | x16 | (x12 & ~x18));
  assign z14 = (x16 & (new_n70_ ? (~x24 & x26) : x24)) | (new_n71_ & ~x16 & (x24 | x26));
  assign new_n70_ = ~x23 & ~x20 & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n71_ = x18 ? x05 : x13;
  assign z15 = ((x24 | ~x25 | (~new_n70_ & x26)) & x16 & (x25 | (new_n70_ & ~x24 & x26))) | (new_n73_ & ~x16 & (x24 | x26));
  assign new_n73_ = x18 ? x06 : x14;
  assign z16 = ((~new_n70_ | x24 | x25) & x16 & (~x24 | x26)) | new_n75_ | (~x24 & ~x26);
