...
module FAU ( 
  ...
  assign new_n60_ = (x17 | (~x16 & (x01 | ~x18))) & ((x16 & x20) | x18 | (x09 & ~x16));
  assign z11 = new_n62_ | (x16 & (x21 ? (x19 | x20) : (~x17 & ~x19 & ~x20)));
  assign new_n62_ = (x17 | (~x16 & (x02 | ~x18))) & ((x16 & x21) | x18 | (x10 & ~x16));
  assign z12 = (~new_n65_ & ~x16) | ((~new_n64_ | ~x22) & ~new_n49_ & x16 & (new_n64_ | x22));
  ...
  assign new_n69_ = (x17 | (~x16 & (x04 | ~x18))) & ((x16 & x23) | x18 | (x12 & ~x16));
  assign z14 = new_n71_ | ((new_n68_ | x24) & x16 & (~new_n67_ | x23 | ~x24));
  assign new_n71_ = (x17 | (~x16 & (x05 | ~x18))) & ((x16 & x24) | x18 | (x13 & ~x16));
  assign z15 = (~new_n73_ & ~x16) | ((~new_n64_ | ~new_n74_ | ~x25) & ~new_n49_ & x16 & ((new_n64_ & new_n74_) | x25));
  assign new_n73_ = (~x06 | x17 | ~x18) & (~x14 | x18);
  ...
  assign new_n78_ = (x16 | ((~x15 | (~x17 & x18)) & (~x07 | ~x18))) & (~x17 | (~x18 & (~x16 | ~x26)));
  assign z17 = (x17 & x18) | (x16 & ((new_n80_ & new_n81_) | (x17 & x27)));
