...
module FAU ( 
  ...
  assign z07 = (~x15 & x27) | (~x26 & (x14 | ~x27));
  ...
  assign z16 = (x16 & ((x26 & (~new_n69_ | ~new_n74_)) | (new_n69_ & ~x14 & new_n74_ & ~x26))) | (new_n75_ & ~x16 & (~x14 | x26));
  assign new_n74_ = ~x24 & ~x25;
  assign new_n75_ = x18 ? x07 : x15;
  assign z17 = (x16 | (x14 & ~x26)) & ((new_n77_ & new_n74_ & ~x26) | new_n78_ | (x14 & ~x26));
  assign new_n77_ = ~x22 & ~x23 & ~x20 & ~x21 & ~x17 & x19;
