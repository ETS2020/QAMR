...
module FAU ( 
  ...
  assign z07 = (~x15 | ~x27) & (x26 ? x27 : x25);
  ...
  assign new_n65_ = (~x22 | (~x21 & ~x20 & ~x17 & ~x19)) & (x20 | x17 | x19 | x21 | x22);
  assign z13 = ~new_n49_ & ((~new_n67_ & x16) | ((x04 | ~x18) & ~x16 & (x12 | x18)));
  assign new_n67_ = (~x23 | (~x20 & ~x17 & ~x19 & ~x21 & ~x22)) & (x20 | x17 | x19 | x23 | x21 | x22);
  assign z14 = ~new_n49_ & (new_n70_ | (x16 & (new_n69_ ^ x24)));
  assign new_n69_ = ~x20 & ~x17 & ~x19 & ~x23 & ~x21 & ~x22;
  assign new_n70_ = (x05 | ~x18) & ~x16 & (x13 | x18);
  assign z15 = (~x25 & (~x26 | (x16 & new_n69_ & ~x24))) | new_n72_ | ((~new_n69_ | x24) & x16 & x25);
  assign new_n72_ = (x06 | ~x18) & ~x16 & (x14 | x18);
  assign z16 = ((x25 | ~new_n69_ | x24) & x16 & (~x25 | x26)) | new_n74_ | (~x25 & ~x26);
  assign new_n74_ = (x07 | ~x18) & ~x16 & (x15 | x18);
  assign z17 = new_n49_ | (x27 & x16 & x17);
endmodule
