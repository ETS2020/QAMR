...
module FAU ( 
  ...
  assign z05 = (~x24 & ~x27) | (x24 & x26) | (~x13 & x27);
  assign z06 = (~x14 & x27) | new_n49_ | (~x25 & ~x27);
  assign z07 = (~x26 & ~x27) | (x24 & x26) | (~x15 & x27);
  ...
  assign z13 = ~new_n49_ & (((x04 | ~x18) & ~x16 & (x12 | x18)) | (~new_n68_ & x16));
  assign new_n68_ = (~x23 | (new_n66_ & ~x22)) & (~new_n66_ | x22 | x23);
  assign z14 = ((~new_n70_ | ~x24) & x16 & (new_n70_ | x24)) | new_n71_ | (x24 & x26);
  assign new_n70_ = new_n66_ & ~x22 & ~x23;
  assign new_n71_ = (x05 | ~x18) & ~x16 & (x13 | x18);
  assign z15 = (x16 & ((~new_n70_ & x25) | (~x24 & new_n70_ & ~x25))) | new_n73_ | (x24 & (x26 | (x16 & x25)));
  assign new_n73_ = (x06 | ~x18) & ~x16 & (x14 | x18);
  assign z16 = (~new_n75_ & x16) | new_n49_ | ((x07 | ~x18) & ~x16 & (x15 | x18));
  assign new_n75_ = (~x26 | (~x25 & new_n66_ & ~x22 & ~x23)) & (~new_n66_ | x22 | x23 | x26 | x24 | x25);
  assign z17 = x16 & ((z08 & x17) | (new_n78_ & new_n77_ & ~x17 & x19));
