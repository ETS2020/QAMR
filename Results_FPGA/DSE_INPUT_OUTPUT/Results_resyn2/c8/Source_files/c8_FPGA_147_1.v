...
module FAU ( 
  ...
  assign z04 = (~x23 | x27) & (x12 | ~x14) & (~x12 | ~x27);
  assign z05 = (~x13 | ~x27) & ~new_n49_ & (~x24 | x27);
  assign z06 = (~x25 | x27) & (~x14 | (x12 & ~x27));
  ...
  assign z13 = (~new_n67_ & x16 & (x12 | ~x14)) | ((x12 | (~x14 & x18)) & ~x16 & (x04 | ~x18));
  assign new_n67_ = x23 ^ (x22 | x20 | x21 | x17 | x19);
  assign z14 = ~new_n70_ | (x16 & ((x24 & (~new_n69_ | x22 | x23)) | (new_n69_ & ~x22 & ~x23 & ~x24)));
  ...
  assign new_n73_ = (~x14 | (x12 & (x16 | x18))) & (~x06 | x16 | ~x18);
