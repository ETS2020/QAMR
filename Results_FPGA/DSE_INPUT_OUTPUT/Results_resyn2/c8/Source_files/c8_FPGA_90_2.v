...
module FAU ( 
  ...
  wire new_n49_, new_n59_, new_n61_, new_n63_, new_n65_, new_n67_, new_n69_,
    new_n70_, new_n72_, new_n74_, new_n76_, new_n77_, new_n78_;
  ...
  assign new_n67_ = (~x23 | (~x22 & ~x20 & ~x21 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = (x16 & (new_n69_ ? ~x24 : (x24 & x26))) | (new_n70_ & ~x16 & (~x24 | x26));
  assign new_n69_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n70_ = x18 ? x05 : x13;
  assign z15 = (new_n72_ & ~x16 & (~x24 | x26)) | ((~x25 | ~new_n69_ | x24) & (x25 | (new_n69_ & ~x24)) & x16 & (~x24 | x26));
  assign new_n72_ = x18 ? x06 : x14;
  assign z16 = ((x26 | (new_n69_ & ~x25)) & x16 & (~x26 | ~new_n69_ | x25)) | new_n74_ | (x24 & (x16 | ~x26));
  assign new_n74_ = (x07 | ~x18) & ~x16 & (x15 | x18);
  assign z17 = (x16 | (x24 & ~x26)) & (new_n77_ | (~x26 & (x24 | (new_n76_ & new_n78_))));
  assign new_n76_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n77_ = x17 & x27;
  assign new_n78_ = ~x25 & ~x17 & x19;
endmodule
