...
module FAU ( 
  ...
  assign new_n72_ = (x25 | ~x26) & ((~x05 & x18) | x16 | (~x13 & ~x18));
  assign z15 = (~x25 & (x26 | (x16 & new_n69_ & new_n71_))) | new_n74_ | ((~new_n69_ | ~new_n71_) & x16 & x25);
  assign new_n74_ = (x06 | ~x18) & ~x16 & (x14 | x18);
  assign z16 = (x16 & (x26 | (new_n70_ & ~x24 & ~x25))) | new_n76_ | (~x25 & x26);
