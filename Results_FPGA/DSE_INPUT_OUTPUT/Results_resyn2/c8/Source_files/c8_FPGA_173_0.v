...
module FAU ( 
  ...
  assign new_n61_ = (x21 | x23) & ((~x01 & x18) | x16 | (~x09 & ~x18));
  assign z11 = (~x21 & (~x23 | (new_n63_ & x16))) | new_n64_ | (~new_n63_ & x16 & x21);
  assign new_n63_ = ~x20 & ~x17 & ~x19;
  assign new_n64_ = (x02 | ~x18) & ~x16 & (x10 | x18);
  assign z12 = ((x22 ^ (new_n63_ & ~x21)) & x16 & (x21 | x23)) | (new_n66_ & ~x16 & (x21 | x23));
  assign new_n66_ = x18 ? x03 : x11;
  assign z13 = (new_n68_ & ~x16 & (x21 | x23)) | ((x22 | ~new_n63_ | x21) & x16 & x23);
