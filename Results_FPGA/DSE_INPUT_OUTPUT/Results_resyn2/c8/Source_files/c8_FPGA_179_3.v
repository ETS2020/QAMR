...
module FAU ( 
  ...
  assign z09 = (~x16 & ((x08 & ~x18) | (x00 & x18 & ~x19))) | (x16 & (~x18 | ~x19) & (x17 | ~x19) & (~x17 | x19));
  ...
  assign new_n66_ = (~x12 | x18) & (~x04 | ~x18 | x19);
  ...
  assign new_n71_ = (x19 | (~x16 & (x05 | ~x18))) & ((x16 & x24) | x18 | (x13 & ~x16));
  ...
  assign new_n79_ = new_n76_ & ~x20 & ~x21 & ~x26 & ~x17 & x19;
endmodule
