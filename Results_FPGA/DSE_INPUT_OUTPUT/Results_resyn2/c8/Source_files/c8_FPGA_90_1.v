...
module FAU ( 
  ...
  assign new_n70_ = (x24 | ~x26) & ((x05 & x18) | x16 | (x13 & ~x18));
  assign z15 = (new_n72_ & ~x16 & (x24 | ~x26)) | (x16 & (x24 | ~x26) & (x25 ^ (new_n69_ & ~x24)));
  assign new_n72_ = x18 ? x06 : x14;
  assign z16 = (x16 & (x26 | (~x25 & new_n69_ & ~x24))) | new_n74_ | (~x24 & x26);
  assign new_n74_ = (x07 | ~x18) & ~x16 & (x15 | x18);
  assign z17 = (new_n49_ | x16) & ((new_n76_ & new_n77_) | new_n49_ | (x17 & x27));
  assign new_n76_ = ~x24 & ~x25 & ~x17 & x19;
