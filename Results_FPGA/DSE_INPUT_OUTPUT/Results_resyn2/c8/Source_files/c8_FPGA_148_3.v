// Benchmark "FAU" written by ABC on Wed Aug 12 14:34:54 2020
...
module FAU ( 
  ...
  assign z11 = (x10 & ~x16 & ~x18) | (x18 & (x02 | x16)) | (~new_n61_ & x16);
  ...
  assign z13 = (~new_n65_ & x16 & ~x18) | ((x04 | ~x18) & ~x16 & (x12 | x18));
  assign new_n65_ = (~x23 | (new_n63_ & ~x22)) & (~new_n63_ | x22 | x23);
  assign z14 = (~new_n67_ & x16 & ~x18) | ((x05 | ~x18) & ~x16 & (x13 | x18));
  assign new_n67_ = (~x24 | (~x22 & ~x23 & new_n59_ & ~x20 & ~x21)) & (~new_n59_ | x20 | x22 | x23 | x21 | x24);
  assign z15 = (~new_n69_ & x16 & ~x18) | ((x06 | ~x18) & ~x16 & (x14 | x18));
