...
module FAU ( 
  ...
  assign z05 = (~x13 & x27) | (x24 & ~x26) | (~x24 & ~x27);
  assign z06 = (~x14 & x27) | new_n49_ | (~x25 & ~x27);
  assign z07 = (~x15 & x27) | (~x26 & (x24 | ~x27));
  ...
  assign z13 = ~new_n49_ & ((~new_n67_ & x16) | ((x04 | ~x18) & ~x16 & (x12 | x18)));
  assign new_n67_ = (~x23 | (~x22 & ~x20 & ~x21 & ~x17 & ~x19)) & (x20 | x21 | x17 | x19 | x22 | x23);
  assign z14 = (~new_n69_ & x16) | new_n49_ | ((x05 | ~x18) & ~x16 & (x13 | x18));
  assign new_n69_ = new_n70_ ^ ~x24;
  assign new_n70_ = ~x20 & ~x21 & ~x17 & ~x19 & ~x22 & ~x23;
  assign z15 = ((x25 | (new_n70_ & ~x24)) & x16 & (~new_n70_ | ~x25)) | new_n72_ | (x24 & (~x26 | (x16 & x25)));
  assign new_n72_ = (x06 | ~x18) & ~x16 & (x14 | x18);
  assign z16 = ~new_n76_ | (~new_n74_ & x16);
  assign new_n74_ = (~x26 | (new_n70_ & ~x25)) & (~new_n75_ | x17 | x19);
  assign new_n75_ = ~x22 & ~x23 & ~x20 & ~x21 & ~x25 & ~x26;
  assign new_n76_ = ((~x07 & x18) | x16 | (~x15 & ~x18)) & (~x24 | (~x16 & x26));
  assign z17 = x16 & ((z08 & x17) | (new_n75_ & ~x24 & ~x17 & x19));
endmodule
