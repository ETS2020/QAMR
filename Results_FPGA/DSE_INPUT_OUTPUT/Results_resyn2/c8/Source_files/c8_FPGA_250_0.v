...
module FAU ( 
  ...
  assign z09 = ((x00 | ~x18) & ~x16 & (x08 | x18)) | (~x04 & ~x18) | (~new_n59_ & x16);
  assign new_n59_ = ~x17 ^ ~x19;
  assign z10 = (~new_n61_ & x16) | ((x01 | ~x18) & ~x16 & (x09 | x18)) | (~x04 & ~x18);
  ...
  assign new_n65_ = x22 ^ (x17 | x19 | x20 | x21);
  assign z13 = (~new_n67_ & x16 & (x04 | x18)) | ((x12 | x18) & x04 & ~x16);
  assign new_n67_ = (~x23 | (~x22 & ~x17 & ~x19 & ~x20 & ~x21)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = ~new_n70_ | (x16 & (new_n69_ ^ x24));
  assign new_n69_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n70_ = (x04 | x18) & ((~x05 & x18) | x16 | (~x13 & ~x18));
  assign z15 = (~new_n72_ & ~x16) | (~new_n49_ & x16 & ((x25 & (~new_n69_ | x24)) | (new_n69_ & ~x24 & ~x25)));
  assign new_n72_ = (~x06 | ~x18) & (~x14 | ~x04 | x18);
  assign z16 = new_n75_ | ((~x26 | ~new_n69_ | x24 | x25) & new_n74_ & (x26 | (new_n69_ & ~x24 & ~x25)));
  assign new_n74_ = x16 & (x04 | x18);
  assign new_n75_ = ~x16 & ((x07 & x18) | (x15 & x04 & ~x18));
