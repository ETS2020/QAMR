...
module FAU ( 
  ...
  assign z09 = (~new_n58_ & x16) | ((x00 | ~x18) & ~x16 & (x08 | x18));
  assign new_n58_ = (~x17 | ~x19) & x21 & (x17 | x19);
  assign z10 = ((x01 | ~x18) & ~x16 & (x09 | x18)) | (~new_n60_ & x16 & x21);
  assign new_n60_ = x20 ^ (x17 | x19);
  assign z11 = (~new_n62_ | ~x16 | ~x21) & ((x02 & x18) | x16 | (x10 & ~x18));
  assign new_n62_ = ~x20 & ~x17 & ~x19;
  assign z12 = (x22 & x16 & x21) | ((x03 | ~x18) & ~x16 & (x11 | x18));
  assign z13 = ((x04 & x18) | x16 | (x12 & ~x18)) & (x23 | ~x16 | ~x21);
  assign z14 = ((x05 & x18) | x16 | (x13 & ~x18)) & (x24 | ~x16 | ~x21);
  assign z15 = (x25 & x16 & x21) | ((x06 | ~x18) & ~x16 & (x14 | x18));
  assign z16 = (x26 & x16 & x21) | ((x07 | ~x18) & ~x16 & (x15 | x18));
