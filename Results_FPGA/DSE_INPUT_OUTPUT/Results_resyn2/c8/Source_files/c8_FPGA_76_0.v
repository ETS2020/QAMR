...
module FAU ( 
  ...
  assign z10 = (x16 & (new_n59_ ^ x20)) | (x01 & ~x16 & x18);
  assign new_n59_ = ~x17 & ~x19;
  assign z11 = (((~new_n59_ | x20) & x21) | ~x16 | (new_n59_ & ~x20 & ~x21)) & (x02 | x16 | ~x18);
  assign z12 = (x03 | x16 | ~x18) & ((~new_n62_ & x22) | ~x16 | (new_n62_ & ~x22));
  assign new_n62_ = new_n59_ & ~x20 & ~x21;
  assign z13 = (x16 & (((~new_n62_ | x22) & x23) | (new_n62_ & ~x22 & ~x23))) | (~x16 & ~x18) | (x04 & ~x16);
  assign z14 = (~x16 & ~x18) | (x05 & ~x16) | (~new_n65_ & x16);
  assign new_n65_ = (~x24 | (new_n66_ & new_n59_ & ~x20 & ~x21)) & (~new_n59_ | x20 | ~new_n66_ | x21 | x24);
  assign new_n66_ = ~x22 & ~x23;
  assign z15 = (~x16 & ~x18) | (x06 & ~x16) | (~new_n68_ & x16);
