...
module FAU ( 
  ...
  assign z12 = (new_n64_ | x16) & (((~new_n65_ | x20) & (x22 | (x18 & x20))) | ~x16 | (~x22 & new_n65_ & ~x20));
  assign new_n64_ = (x11 | x18) & (x03 | ~x18 | x20);
  assign new_n65_ = ~x21 & ~x17 & ~x19;
  assign z13 = x16 ? ~new_n67_ : ((x12 & ~x18) | (x04 & x18 & ~x20));
  assign new_n67_ = ((new_n65_ & ~x20 & ~x22) | ~x23 | (x18 & x20)) & (x22 | x23 | ~new_n65_ | x20);
  assign z14 = (~new_n71_ & ~x16) | ((~new_n69_ | ~x24) & x16 & (~x18 | ~x20) & (new_n69_ | x24));
  assign new_n69_ = new_n65_ & new_n70_ & ~x20;
  assign new_n70_ = ~x22 & ~x23;
  assign new_n71_ = (~x13 | x18) & (~x05 | ~x18 | x20);
  assign z15 = (~new_n74_ & ~x16) | ((~new_n73_ | ~x25) & x16 & (~x18 | ~x20) & (new_n73_ | x25));
  assign new_n73_ = new_n65_ & ~x20 & new_n70_ & ~x24;
  assign new_n74_ = (~x14 | x18) & (~x06 | ~x18 | x20);
  assign z16 = new_n77_ | (~new_n76_ & x16);
  assign new_n76_ = (~x26 | (new_n65_ & ~x25 & new_n70_ & ~x24)) & (~new_n65_ | x20 | ~new_n70_ | x24 | x25 | x26);
  assign new_n77_ = (x20 | (~x16 & (x07 | ~x18))) & ((x16 & x26) | x18 | (x15 & ~x16));
  assign z17 = x16 & (new_n80_ | (new_n79_ & ~x25 & new_n70_ & ~x24));
  assign new_n79_ = ~x20 & ~x21 & ~x26 & ~x17 & x19;
