...
module FAU ( 
  ...
  assign new_n67_ = (x19 | (~x16 & (x12 | x18))) & ((x16 & x23) | ~x18 | (x04 & ~x16));
  assign z14 = new_n69_ | new_n70_;
  assign new_n69_ = (x24 | (new_n63_ & ~x22 & ~x23)) & x16 & (~new_n66_ | x22 | x23 | ~x24);
  assign new_n70_ = (x19 | (~x16 & (x13 | x18))) & ((x16 & x24) | ~x18 | (x05 & ~x16));
  assign z15 = new_n73_ | (~new_n72_ & x16);
  assign new_n72_ = (~x25 | (~x23 & ~x24 & new_n66_ & ~x22)) & (~new_n63_ | x24 | x25 | x22 | x23);
  assign new_n73_ = (x19 | (~x16 & (x14 | x18))) & ((x16 & x25) | ~x18 | (x06 & ~x16));
  assign z16 = x16 ? ((~new_n75_ & ~x19) | (x26 & x18 & x19)) : ~new_n76_;
  assign new_n75_ = (~x26 | (new_n66_ & ~x24 & ~x25 & ~x22 & ~x23)) & (x25 | x26 | x23 | x24 | ~new_n66_ | x22);
  assign new_n76_ = (~x07 | ~x18) & (~x15 | x18 | x19);
  assign z17 = x16 & ((new_n78_ & x18 & x19) | (x17 & x27 & (x18 | ~x19)));
  assign new_n78_ = ~x25 & ~x26 & ~x23 & ~x24 & new_n66_ & ~x22;
endmodule
