...
module FAU ( 
  ...
  wire new_n49_, new_n59_, new_n61_, new_n63_, new_n65_, new_n67_, new_n69_,
    new_n70_, new_n72_, new_n74_, new_n76_, new_n77_;
  assign z00 = (~x08 | ~x27) & ~new_n49_ & (~x19 | x27);
  assign new_n49_ = x14 & x26;
  ...
  assign z06 = (~x14 & x27) | (x14 & x26) | (~x25 & ~x27);
  assign z07 = (~x15 & x27) | (~x26 & ~x27) | (x14 & x26);
  ...
  assign new_n61_ = (~x14 | ~x26) & ((~x01 & x18) | x16 | (~x09 & ~x18));
  ...
  assign z14 = ~new_n49_ & (new_n70_ | (x16 & (new_n69_ ^ x24)));
  assign new_n69_ = ~x20 & ~x21 & ~x17 & ~x19 & ~x22 & ~x23;
  assign new_n70_ = (x05 | ~x18) & ~x16 & (x13 | x18);
  assign z15 = ~new_n72_ | (x16 & ((x25 & (~new_n69_ | x24)) | (new_n69_ & ~x24 & ~x25)));
  assign new_n72_ = (~x14 | ((x16 | x18) & ~x26)) & (~x18 | ~x06 | x16);
  assign z16 = new_n74_ & ((~x26 & new_n69_ & ~x24 & ~x25) | ~x16 | (x26 & (~new_n69_ | x24 | x25)));
  assign new_n74_ = (~x14 | ~x26) & ((x07 & x18) | x16 | (x15 & ~x18));
  assign z17 = new_n49_ | (x16 & ((x17 & x27) | (new_n76_ & new_n77_)));
  assign new_n76_ = ~x26 & ~x17 & x19;
  assign new_n77_ = ~x22 & ~x23 & ~x20 & ~x21 & ~x24 & ~x25;
endmodule
