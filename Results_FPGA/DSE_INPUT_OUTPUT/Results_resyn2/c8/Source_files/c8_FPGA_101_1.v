...
module FAU ( 
  ...
  assign z10 = (x18 | x09 | x16) & ((~new_n59_ & x20) | ~x16 | (new_n59_ & ~x20));
  assign new_n59_ = ~x17 & ~x19;
  assign z11 = (x18 | x10 | x16) & (((~new_n59_ | x20) & x21) | ~x16 | (new_n59_ & ~x20 & ~x21));
  assign z12 = (x18 | x11 | x16) & ((~new_n62_ & x22) | ~x16 | (new_n62_ & ~x22));
  ...
  assign z16 = (x18 | x15 | x16) & ((new_n68_ & ~x26) | ~x16 | (~new_n68_ & x26));
