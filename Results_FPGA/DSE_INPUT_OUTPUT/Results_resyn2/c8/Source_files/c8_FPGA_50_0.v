...
module FAU ( 
  ...
  assign new_n66_ = (~x18 | ((~x23 | (new_n60_ & ~x21 & ~x22)) & (~new_n60_ | x20 | x21 | x22 | x23))) & (~x20 | ~x23);
  assign z14 = x16 ? ~new_n68_ : ((x05 & x18) | (x13 & ~x18 & x20));
  assign new_n68_ = (~x18 | ((x20 | x23 | x24 | ~new_n60_ | ~new_n69_) & (~x24 | (new_n60_ & new_n69_ & ~x23)))) & (~x20 | ~x24);
  assign new_n69_ = ~x21 & ~x22;
  assign z15 = x16 ? ((~new_n71_ & x18) | (x20 & x25)) : ~new_n74_;
  assign new_n71_ = (~x25 | (new_n73_ & ~x23 & ~x24)) & (~new_n72_ | x23 | x24 | x22 | x25);
  assign new_n72_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n73_ = ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n74_ = (~x06 | ~x18) & (~x14 | x18 | ~x20);
  assign z16 = x16 ? ~new_n76_ : ((x07 & x18) | (x15 & ~x18 & x20));
  assign new_n76_ = (~x20 | ~x26) & (~x18 | ((~x26 | (new_n77_ & new_n60_ & ~x21)) & (~new_n60_ | x20 | x21 | ~new_n77_ | x26)));
  assign new_n77_ = ~x23 & ~x24 & ~x22 & ~x25;
  assign z17 = (~x18 & ~x20) | (x16 & (new_n79_ | (x17 & x27)));
  assign new_n79_ = new_n77_ & ~x26 & ~x20 & ~x21 & ~x17 & x19;
endmodule
