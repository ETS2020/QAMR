// Benchmark "FAU" written by ABC on Wed Aug 12 14:35:15 2020
...
module FAU ( 
  ...
  assign z11 = ((x02 | ~x18) & ~x16 & (x10 | x18)) | (~new_n61_ & x16 & ~x18);
  ...
  assign z15 = (x14 & ~x16 & ~x18) | (x18 & (x06 | x16)) | (~new_n69_ & x16);
