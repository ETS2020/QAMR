...
module FAU ( 
  ...
  assign z07 = (~x15 | ~x27) & (~x26 | x27) & (~x25 | x26);
  ...
  assign new_n61_ = (~x25 | x26) & ((~x01 & x18) | x16 | (~x09 & ~x18));
  ...
  assign z15 = ((~x25 | ~new_n69_ | x24) & x16 & (x25 | (new_n69_ & ~x24))) | new_n72_ | (x25 & ~x26);
  assign new_n72_ = (x06 | ~x18) & ~x16 & (x14 | x18);
  assign z16 = ((~x26 | ~new_n69_ | x24) & x16 & (x26 | (new_n69_ & ~x24))) | new_n74_ | (x25 & (x16 | ~x26));
  assign new_n74_ = (x07 | ~x18) & ~x16 & (x15 | x18);
  assign z17 = new_n49_ | (x16 & ((x17 & x27) | (new_n76_ & new_n77_)));
  assign new_n76_ = ~x24 & ~x26 & ~x17 & x19;
