...
module FAU ( 
  ...
  assign new_n66_ = (x19 | ((~x23 | (~x22 & new_n62_ & ~x21)) & (x22 | x23 | ~new_n62_ | x21))) & (~x23 | ~x18 | ~x19);
  ...
  assign z15 = new_n71_ | (~x16 & ((x06 & x18) | (x14 & ~x18 & ~x19)));
  ...
  assign new_n76_ = (x19 | (~x16 & (x15 | x18))) & ((x16 & x26) | ~x18 | (x07 & ~x16));
