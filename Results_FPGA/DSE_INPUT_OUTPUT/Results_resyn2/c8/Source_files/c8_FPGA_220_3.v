// Benchmark "FAU" written by ABC on Wed Aug 12 14:35:19 2020
...
module FAU ( 
  ...
  assign z13 = (~new_n65_ & x16) | (x18 & (x04 | x16)) | (x12 & ~x16 & ~x18);
  ...
  assign z15 = ((x06 | ~x18) & ~x16 & (x14 | x18)) | (~new_n70_ & x16 & ~x18);
  assign new_n70_ = (~x25 | (new_n59_ & ~x20 & new_n68_ & ~x21 & ~x24)) & (~new_n59_ | x20 | x21 | ~new_n68_ | x24 | x25);
  assign z16 = (x18 & (x07 | x16)) | (x15 & ~x16 & ~x18) | ((~new_n72_ | ~x26) & x16 & (new_n72_ | x26));
