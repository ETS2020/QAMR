...
module FAU ( 
  ...
  assign z13 = (x18 | ((x12 | x16) & (x23 | new_n68_ | ~x16))) & ((~new_n68_ & x16) | ~x23 | (~x16 & (x04 | ~x18)));
  assign new_n68_ = ~x22 & ~x17 & ~x19 & ~x20 & ~x21;
  assign z14 = (~x16 & ((x13 & ~x18) | (x05 & x18 & x23))) | (~new_n70_ & x16 & (~x18 | x23));
  ...
  assign new_n77_ = (~x15 | x18) & (~x07 | ~x18 | ~x23);
  assign z17 = (x18 & ~x23) | (~new_n79_ & x16);
