...
module FAU ( 
  ...
  assign z11 = (((~new_n59_ | x20) & x21) | ~x16 | (new_n59_ & ~x20 & ~x21)) & (x10 | x16 | x18);
  assign z12 = (x16 & (new_n62_ ^ x22)) | (x11 & ~x16 & ~x18);
  assign new_n62_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z13 = (x12 & ~x16 & ~x18) | (x16 & (((~new_n62_ | x22) & x23) | (new_n62_ & ~x22 & ~x23)));
  assign z14 = (x13 & ~x16 & ~x18) | (~new_n65_ & x16);
  assign new_n65_ = (~x24 | (~x22 & ~x23 & new_n59_ & ~x20 & ~x21)) & (~new_n59_ | x20 | x22 | x23 | x21 | x24);
  assign z15 = (x16 & (new_n68_ | (~new_n67_ & x25))) | (x14 & ~x16 & ~x18);
