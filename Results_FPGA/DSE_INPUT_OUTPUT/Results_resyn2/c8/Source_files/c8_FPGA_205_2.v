...
module FAU ( 
  ...
  assign z09 = x16 ? (x19 ? (x17 & x18) : ~x17) : ((x00 & x18) | (x08 & ~x17 & ~x18));
  ...
  assign new_n63_ = (x17 | (~x16 & (x10 | x18))) & ((x16 & x21) | ~x18 | (x02 & ~x16));
  assign z12 = x16 ? ~new_n65_ : ((x03 & x18) | (x11 & ~x17 & ~x18));
  assign new_n65_ = (x17 | ((~x22 | (~x21 & ~x19 & ~x20)) & (x21 | x22 | x19 | x20))) & (~x22 | ~x17 | ~x18);
  assign z13 = (~new_n68_ & ~x16) | ((x23 | (new_n67_ & ~x17)) & (~x23 | ~new_n67_ | x17) & x16 & (~x17 | x18));
  assign new_n67_ = ~x21 & ~x22 & ~x19 & ~x20;
  assign new_n68_ = (~x04 | ~x18) & (~x12 | x17 | x18);
  assign z14 = x16 ? ~new_n70_ : ((x05 & x18) | (x13 & ~x17 & ~x18));
  ...
  assign z16 = x16 ? ((x26 & x17 & x18) | (~new_n76_ & ~x17)) : ~new_n77_;
  assign new_n76_ = (~x26 | (new_n73_ & ~x22 & ~x25 & new_n61_ & ~x21)) & (x25 | x26 | ~new_n73_ | ~new_n61_ | x21 | x22);
  assign new_n77_ = (~x07 | ~x18) & (~x15 | x17 | x18);
