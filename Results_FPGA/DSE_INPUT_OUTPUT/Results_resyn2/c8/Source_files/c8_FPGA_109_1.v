...
module FAU ( 
  ...
  assign z12 = (~x16 & ((x03 & x18) | (x11 & ~x18 & ~x20))) | (~new_n64_ & x16 & (x18 | ~x20));
  ...
  assign new_n68_ = (~x05 | ~x18) & (~x13 | x18 | x20);
  assign new_n69_ = ~x23 & ~x22 & ~x21 & ~x17 & ~x19;
  assign z15 = new_n71_ | (x16 & ((x25 & (~new_n69_ | x24)) | (~x24 & ~x25 & new_n69_ & ~x20)));
  assign new_n71_ = (x20 | (~x16 & (x14 | x18))) & ((x16 & x25) | ~x18 | (x06 & ~x16));
