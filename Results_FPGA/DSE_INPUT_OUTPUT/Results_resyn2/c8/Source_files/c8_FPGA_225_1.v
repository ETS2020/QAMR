...
module FAU ( 
  ...
  assign z09 = (~x16 & ((x00 & x13 & x18) | (x08 & ~x18))) | (new_n59_ & x16 & (x13 | ~x18));
  assign new_n59_ = ~x17 ^ x19;
  assign z10 = (~x16 & ((x01 & x13 & x18) | (x09 & ~x18))) | (~new_n61_ & x16 & (x13 | ~x18));
  ...
  assign z14 = (x16 & (x13 | ~x18) & (new_n69_ ^ x24)) | (x13 & ~x16 & (x05 | ~x18));
  assign new_n69_ = ~x20 & ~x21 & ~x17 & ~x19 & ~x22 & ~x23;
  assign z15 = ~new_n71_ | (x16 & ((x25 & (~new_n69_ | x24)) | (new_n69_ & ~x24 & ~x25)));
  assign new_n71_ = (x13 | ~x18) & ((~x06 & x18) | x16 | (~x14 & ~x18));
  assign z16 = new_n77_ | (new_n73_ & ((x26 & (~new_n76_ | ~new_n74_ | ~new_n75_)) | (new_n74_ & new_n76_ & new_n75_ & ~x26)));
  assign new_n73_ = x16 & (x13 | ~x18);
  assign new_n74_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n75_ = ~x22 & ~x23;
  assign new_n76_ = ~x24 & ~x25;
  assign new_n77_ = ~x16 & ((x07 & x13 & x18) | (x15 & ~x18));
  assign z17 = new_n49_ | (x16 & ((new_n79_ & new_n80_) | (x17 & x27)));
