...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n49_, new_n59_, new_n61_, new_n63_, new_n64_, new_n66_;
  assign z00 = (~x08 & x27) | new_n49_ | (~x19 & ~x27);
  assign new_n49_ = ~x21 & ~x22;
  assign z01 = (~x09 & x27) | new_n49_ | (~x20 & ~x27);
  assign z02 = (~x21 & (~x22 | ~x27)) | (~x10 & x27);
  assign z03 = (x22 ? x27 : x21) & (~x11 | ~x27);
  ...
  assign new_n61_ = (x21 | x22) & ((~x01 & x18) | x16 | (~x09 & ~x18));
  assign z11 = (~x21 & (~x22 | (new_n63_ & x16))) | new_n64_ | (~new_n63_ & x16 & x21);
  assign new_n63_ = ~x20 & ~x17 & ~x19;
  assign new_n64_ = (x02 | ~x18) & ~x16 & (x10 | x18);
  assign z12 = new_n66_ | new_n49_ | ((x03 | ~x18) & ~x16 & (x11 | x18));
  assign new_n66_ = (x21 | x20 | x17 | x19) & x16 & (~x21 | x22);
