...
module FAU ( 
  ...
  assign z02 = (~x10 & x27) | (~x18 & x21) | (~x21 & ~x27);
  ...
  assign z11 = (~x18 & x21) | ((x02 | ~x18) & ~x16 & (x10 | x18)) | (x16 & (~new_n62_ ^ ~x21));
  assign new_n62_ = ~x20 & ~x17 & ~x19;
  assign z12 = (~new_n64_ & ~x16) | ((~x22 | ~new_n62_ | x21) & x16 & ((new_n62_ & ~x21) | (x22 & (x18 | ~x21))));
  assign new_n64_ = (~x03 | ~x18) & (~x11 | x18 | x21);
  assign z13 = x16 ? ~new_n66_ : ((x04 & x18) | (x12 & ~x18 & ~x21));
  assign new_n66_ = (x21 | ((~x23 | (new_n62_ & ~x22)) & (~new_n62_ | x22 | x23))) & (~x23 | ~x18 | ~x21);
  assign z14 = x16 ? ~new_n68_ : ((x05 & x18) | (x13 & ~x18 & ~x21));
  assign new_n68_ = (x21 | ((~x24 | (new_n62_ & new_n69_)) & (~new_n62_ | ~new_n69_ | x24))) & (~x24 | ~x18 | ~x21);
  assign new_n69_ = ~x22 & ~x23;
  assign z15 = x16 ? ~new_n71_ : ((x06 & x18) | (x14 & ~x18 & ~x21));
  assign new_n71_ = (x21 | ((~x25 | (new_n62_ & new_n69_ & ~x24)) & (~new_n62_ | ~new_n69_ | x24 | x25))) & (~x25 | ~x18 | ~x21);
  assign z16 = x16 ? ((~new_n73_ & ~x21) | (x26 & x18 & x21)) : ~new_n74_;
  assign new_n73_ = (~x26 | (new_n62_ & new_n69_ & ~x24 & ~x25)) & (x25 | x26 | ~new_n62_ | ~new_n69_ | x24);
  assign new_n74_ = (~x07 | ~x18) & (~x15 | x18 | x21);
  assign z17 = x16 & ((z08 & x17) | (new_n76_ & new_n69_ & ~x24));
  assign new_n76_ = ~x25 & ~x26 & ~x20 & ~x21 & ~x17 & x19;
endmodule
