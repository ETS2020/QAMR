...
module FAU ( 
  ...
  assign z09 = ((x00 | ~x18) & ~x16 & (x08 | x18)) | (~new_n57_ & x16) | (~x18 & ~x27);
  ...
  assign z11 = (~x16 & ((x02 & x18) | (x27 & x10 & ~x18))) | (~new_n62_ & x16 & (x18 | x27));
  ...
  assign z13 = (~new_n66_ & x16) | ((x04 | ~x18) & ~x16 & (x12 | x18)) | (~x18 & ~x27);
  assign new_n66_ = (~x23 | (~x22 & new_n60_ & ~x20 & ~x21)) & (~new_n60_ | x20 | x21 | x22 | x23);
  assign z14 = (~new_n68_ & x16 & (x18 | x27)) | ((x18 | (x13 & x27)) & ~x16 & (x05 | ~x18));
