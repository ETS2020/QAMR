...
module FAU ( 
  ...
  assign z09 = (x08 & ~x16 & ~x18) | ((~x16 | (~x17 ^ x19)) & x18 & (x00 | x16));
  assign z10 = ((new_n59_ ^ x20) & x16 & x18) | ((x01 | ~x18) & ~x16 & (x09 | x18));
  assign new_n59_ = ~x17 & ~x19;
  assign z11 = ((x02 | ~x18) & ~x16 & (x10 | x18)) | (~new_n61_ & x16 & x18);
  assign new_n61_ = (~x21 | (~x20 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21);
  assign z12 = ((new_n63_ ^ x22) & x16 & x18) | ((x03 | ~x18) & ~x16 & (x11 | x18));
  assign new_n63_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z13 = (~new_n65_ & x16) | ((x12 | x16 | x18) & (~x18 | (x04 & ~x16)));
  ...
  assign z15 = (~new_n70_ & x16) | ((x14 | x16 | x18) & (~x18 | (x06 & ~x16)));
  assign new_n70_ = (~x25 | (new_n59_ & ~x20 & new_n68_ & ~x21 & ~x24)) & (~new_n59_ | x20 | x21 | ~new_n68_ | x24 | x25);
  assign z16 = ((x15 | x16 | x18) & (~x18 | (x07 & ~x16))) | ((~new_n72_ | ~x26) & x16 & (new_n72_ | x26));
  assign new_n72_ = new_n63_ & new_n68_ & ~x24 & ~x25;
  assign z17 = x16 & x18 & (new_n74_ | (x17 & x27));
