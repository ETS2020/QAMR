...
module FAU ( 
  ...
  assign z09 = (x16 & (~x17 ^ x19)) | (~x16 & ~x18) | (x00 & ~x16);
  assign z10 = (x16 & (new_n59_ ^ x20)) | (x01 & ~x16 & x18);
  assign new_n59_ = ~x17 & ~x19;
  assign z11 = (x02 & ~x16 & x18) | (x16 & (((~new_n59_ | x20) & x21) | (new_n59_ & ~x20 & ~x21)));
