...
module FAU ( 
  ...
  assign new_n77_ = (x23 | (~x16 & (x15 | x18))) & ((x16 & x26) | ~x18 | (x07 & ~x16));
  assign z17 = x16 & (new_n79_ | (z08 & x17));
  assign new_n79_ = new_n72_ & ~x26 & ~x17 & x19 & ~x20 & ~x21;
endmodule
