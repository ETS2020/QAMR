...
module FAU ( 
  ...
  assign z04 = (~x12 & x27) | (~x18 & x23) | (~x23 & ~x27);
  ...
  assign z09 = ((x00 | ~x18) & ~x16 & (x08 | x18)) | (~new_n58_ & x16) | (~x18 & x23);
  assign new_n58_ = ~x17 ^ ~x19;
  assign z10 = (~x16 & ((x01 & x18) | (x09 & ~x18 & ~x23))) | (~new_n60_ & x16 & (x18 | ~x23));
  assign new_n60_ = x20 ^ (x17 | x19);
  assign z11 = (~new_n62_ & x16) | ((x02 | ~x18) & ~x16 & (x10 | x18)) | (~x18 & x23);
  ...
  assign new_n66_ = ~x22 & ~x20 & ~x21 & ~x17 & ~x19;
  assign z14 = x16 ? ~new_n68_ : ((x05 & x18) | (x13 & ~x18 & ~x23));
  ...
  assign new_n71_ = (~x06 | ~x18) & (~x14 | x18 | x23);
  assign z16 = new_n75_ | (x16 & (new_n73_ | (x26 & (~new_n69_ | x25))));
  assign new_n73_ = new_n74_ & ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n74_ = ~x22 & ~x23 & ~x26 & ~x24 & ~x25;
  assign new_n75_ = (x23 | (~x16 & (x15 | x18))) & ((x16 & x26) | ~x18 | (x07 & ~x16));
  assign z17 = x16 & (new_n77_ | ((x18 | ~x23) & x17 & x27));
  assign new_n77_ = new_n74_ & ~x17 & x19 & ~x20 & ~x21;
endmodule
