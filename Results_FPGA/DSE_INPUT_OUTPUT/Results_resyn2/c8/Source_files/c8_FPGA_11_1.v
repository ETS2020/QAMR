...
module FAU ( 
  ...
  assign new_n58_ = (x01 | ~x17) & (~x16 | (~x17 ^ x19));
  assign z10 = (x16 & ((x19 & x20) | (~x17 & ~x19 & ~x20))) | new_n60_ | (x17 & (~x01 | (x16 & x20)));
  assign new_n60_ = (x01 | ~x18) & ~x16 & (x09 | x18);
  assign z11 = (x16 & (x21 ? ~new_n62_ : (new_n62_ & ~x17))) | new_n63_ | (x17 & (~x01 | (x16 & x21)));
  ...
  assign new_n66_ = (~x22 | (~x21 & ~x17 & ~x19 & ~x20)) & (x17 | x22 | x21 | x19 | x20);
  assign z13 = (~new_n68_ & x16) | new_n71_ | (x17 & (~x01 | (x16 & x23)));
  ...
  assign new_n76_ = (~x25 | (new_n62_ & ~x21 & ~x24 & ~x22 & ~x23)) & (x21 | x22 | x23 | ~new_n62_ | x24 | x25);
  ...
  assign new_n84_ = ~x24 & ~x25 & ~x17 & x19 & ~x20 & ~x26;
endmodule
