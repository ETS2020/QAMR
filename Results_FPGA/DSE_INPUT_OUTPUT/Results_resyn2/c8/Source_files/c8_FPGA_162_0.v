...
module FAU ( 
  ...
  assign z09 = (x00 & ~x16 & x18) | ((~x17 | x19) & x16 & (x17 | ~x19));
  assign z10 = ((~new_n59_ & x20) | ~x16 | (new_n59_ & ~x20)) & (x01 | x16 | ~x18);
  assign new_n59_ = ~x17 & ~x19;
  assign z11 = (x16 & (((~new_n59_ | x20) & x21) | (new_n59_ & ~x20 & ~x21))) | (x02 & ~x16 & x18);
  assign z12 = ((~new_n62_ & x22) | ~x16 | (new_n62_ & ~x22)) & (x03 | x16 | ~x18);
  assign new_n62_ = new_n59_ & ~x20 & ~x21;
  assign z13 = (x16 & (((~new_n62_ | x22) & x23) | (new_n62_ & ~x22 & ~x23))) | (x04 & ~x16 & x18);
  assign z14 = (~new_n65_ & x16) | (~x16 & ~x18) | (x05 & ~x16);
  assign new_n65_ = (~x24 | (new_n66_ & new_n59_ & ~x20 & ~x21)) & (~new_n59_ | x20 | ~new_n66_ | x21 | x24);
  assign new_n66_ = ~x22 & ~x23;
  assign z15 = (~new_n68_ & x16) | (~x16 & ~x18) | (x06 & ~x16);
  assign new_n68_ = (~x25 | (new_n59_ & ~x20 & new_n66_ & ~x21 & ~x24)) & (~new_n59_ | x20 | x21 | ~new_n66_ | x24 | x25);
  assign z16 = (x07 & ~x16 & x18) | ((~x26 | ~new_n62_ | ~new_n70_) & x16 & (x26 | (new_n62_ & new_n70_)));
  assign new_n70_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z17 = x16 & (new_n72_ | (x17 & x27));
  assign new_n72_ = new_n70_ & ~x20 & ~x21 & ~x26 & ~x17 & x19;
endmodule
