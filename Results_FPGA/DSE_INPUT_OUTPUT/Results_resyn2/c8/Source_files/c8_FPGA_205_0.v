...
module FAU ( 
  ...
  assign z10 = (~x16 & ((x01 & x18) | (x09 & x17 & ~x18))) | (~new_n59_ & x16 & (x17 | x18));
  ...
  assign z14 = x16 ? ((~new_n70_ & x18) | (x17 & x24)) : ~new_n72_;
  ...
  assign z16 = x16 ? ~new_n79_ : ((x07 & x18) | (x15 & x17 & ~x18));
  assign new_n79_ = (~x18 | ((~x26 | (new_n63_ & new_n75_)) & (~new_n63_ | x17 | ~new_n75_ | x26))) & (~x17 | ~x26);
  assign z17 = x16 & (new_n81_ | (x17 & x27));
  assign new_n81_ = new_n75_ & ~x26 & new_n68_ & x19 & ~x17 & x18;
endmodule
