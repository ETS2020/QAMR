...
module FAU ( 
  ...
  assign z09 = (~new_n57_ & x16 & (x18 | x27)) | ((x18 | (x08 & x27)) & ~x16 & (x00 | ~x18));
  assign new_n57_ = x17 ^ x19;
  assign z10 = (~new_n59_ & x16 & (x18 | x27)) | ((x18 | (x09 & x27)) & ~x16 & (x01 | ~x18));
  assign new_n59_ = ~new_n60_ ^ x20;
  assign new_n60_ = ~x17 & ~x19;
  assign z11 = (~new_n62_ & x16 & (x18 | x27)) | (~x16 & ((x02 & x18) | (x27 & x10 & ~x18)));
  assign new_n62_ = (~x21 | (~x20 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21);
  assign z12 = (~new_n64_ & x16 & (x18 | x27)) | ((x18 | (x11 & x27)) & ~x16 & (x03 | ~x18));
  assign new_n64_ = ~new_n65_ ^ x22;
  assign new_n65_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z13 = (~new_n67_ & x16 & (x18 | x27)) | ((x18 | (x12 & x27)) & ~x16 & (x04 | ~x18));
  assign new_n67_ = (~x23 | (new_n65_ & ~x22)) & (~new_n65_ | x22 | x23);
  assign z14 = (~new_n69_ & x16 & (x18 | x27)) | ((x18 | (x13 & x27)) & ~x16 & (x05 | ~x18));
  ...
  assign z16 = new_n75_ | ((~new_n74_ | ~x26) & x16 & (x18 | x27) & (new_n74_ | x26));
  assign new_n74_ = new_n65_ & new_n72_ & ~x24 & ~x25;
  assign new_n75_ = (x18 | (x15 & x27)) & ~x16 & (x07 | ~x18);
