...
module FAU ( 
  ...
  assign z12 = (x11 & ~x16 & ~x18) | (x16 & (new_n62_ ^ x22));
  assign new_n62_ = new_n59_ & ~x20 & ~x21;
  assign z13 = (x16 & (((~new_n62_ | x22) & x23) | (new_n62_ & ~x22 & ~x23))) | (x12 & ~x16 & ~x18);
  assign z14 = (~new_n65_ & x16) | (~x16 & x18) | (x13 & ~x16);
  assign new_n65_ = (~x24 | (new_n66_ & new_n59_ & ~x20 & ~x21)) & (~new_n59_ | x20 | ~new_n66_ | x21 | x24);
  assign new_n66_ = ~x22 & ~x23;
  assign z15 = (~new_n68_ & x16) | (~x16 & x18) | (x14 & ~x16);
  assign new_n68_ = (~x25 | (new_n59_ & ~x20 & new_n66_ & ~x21 & ~x24)) & (~new_n59_ | x20 | x21 | ~new_n66_ | x24 | x25);
  assign z16 = (x15 & ~x16 & ~x18) | ((~x26 | ~new_n62_ | ~new_n70_) & x16 & (x26 | (new_n62_ & new_n70_)));
