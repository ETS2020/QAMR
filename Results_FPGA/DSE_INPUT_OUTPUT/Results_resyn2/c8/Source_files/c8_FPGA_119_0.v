...
module FAU ( 
  ...
  assign z11 = x16 ? ((x18 & new_n62_ & ~x21) | (~new_n62_ & x21)) : ((x02 & x18) | (x10 & ~x18 & x21));
  ...
  assign new_n66_ = (x23 | x21 | ~new_n62_ | x22) & x16 & (x18 | x21) & (~x23 | (~x21 & new_n62_ & ~x22));
  assign z14 = x16 ? ~new_n68_ : ((x05 & x18) | (x13 & ~x18 & x21));
  assign new_n68_ = (~x21 | ~x24) & (~x18 | ((~x24 | (new_n62_ & ~x22 & ~x23)) & (~new_n62_ | x21 | x22 | x23 | x24)));
  assign z15 = x16 ? new_n70_ : ((x06 | ~x18) & (x14 | x18 | ~x21));
  assign new_n70_ = ((new_n71_ & new_n62_ & ~x21) | x25 | (~x18 & ~x21)) & (~new_n71_ | ~x25 | ~x18 | ~new_n62_ | x21);
  assign new_n71_ = ~x24 & ~x22 & ~x23;
  ...
  assign z17 = (~new_n76_ & x16) | (~x18 & ~x21);
  assign new_n76_ = (~x17 | ~x27) & (~new_n77_ | x20 | x21 | x17 | ~x19);
  assign new_n77_ = ~x26 & ~x22 & ~x23 & ~x24 & ~x25;
endmodule
