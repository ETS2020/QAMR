...
module FAU ( 
  ...
  assign z09 = ((x00 | ~x18 | x19) & ~x16 & (x08 | x18)) | ((x17 | x18 | ~x19) & x16 & (~x17 | x19));
  ...
  assign new_n63_ = x16 & ((x22 & (x17 | x20 | x21)) | (~x19 & ~x17 & ~x20 & ~x21 & ~x22));
  ...
  assign z15 = x16 ? ~new_n74_ : ((x14 & ~x18) | (x06 & x18 & ~x19));
