...
module FAU ( 
  ...
  assign z01 = (x30 | ~x32) & (~x04 | (~x30 & (~x27 | (~new_n70_ & ~x36))));
  ...
  assign z10 = (new_n67_ & x05 & x30) | (~new_n82_ & x27 & (x30 | ~x32));
  assign new_n82_ = (~x06 | ~x37) & (~new_n83_ | x04 | (~new_n70_ & ~x36));
  assign new_n83_ = (x39 & x40) ? (x05 & ~x32) : x07;
  assign z11 = new_n85_ & ~x30 & ~x32;
  assign new_n85_ = (~x08 | (~new_n70_ & ~new_n86_) | (~new_n86_ & x27)) & ~x09 & (~new_n70_ | x04 | ~x27);
  assign new_n86_ = x29 & x39 & x40;
  assign z12 = new_n65_ & ~new_n68_;
  assign z14 = (~x27 | (~new_n89_ & (new_n90_ | ~new_n91_))) & (~new_n91_ | ~x30) & (x30 | ~x32);
  ...
  assign z20 = ~x30 & (x32 | (new_n97_ & (~x08 | (~new_n70_ & ~new_n86_))));
  assign new_n97_ = ~x09 & (~x27 | ~x35);
  assign z13 = (x27 & (new_n89_ | (~new_n90_ & new_n91_))) | (new_n91_ & x30) | (~x30 & x32);
  assign z19 = new_n85_ & ~x30 & ~x32;
endmodule
