...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n69_, new_n70_, new_n72_, new_n77_,
    ...
    new_n90_, new_n91_, new_n93_, new_n94_, new_n99_, new_n101_;
  ...
  assign z10 = new_n83_ | (x27 & (new_n82_ | (~new_n80_ & new_n81_)));
  assign new_n80_ = (~x05 | ~x39 | ~x40) & (~x07 | x40);
  assign new_n81_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n82_ = (x39 | ~x40) & x06 & x37;
  assign new_n83_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = ~new_n85_ & new_n86_ & (~new_n69_ | x04 | ~x27);
  ...
  assign z18 = ~new_n68_ & (~new_n99_ | ((~x04 | ~x27) & new_n69_ & (x08 | x27)));
  assign new_n99_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x40);
  assign z20 = new_n101_ & (~x08 | (~new_n69_ & (~x29 | ~x40)));
  assign new_n101_ = (x39 | ~x40) & ~x09 & ~x30 & (~x27 | ~x35);
  assign z06 = new_n68_ | (~x37 & (~x27 | ~x28));
  assign z19 = new_n68_ | (new_n99_ & ((x04 & x27) | ~new_n69_ | (~x08 & ~x27)));
  assign z08 = x40;
endmodule
