...
module FAU ( 
  ...
  assign new_n68_ = x16 & (~x21 | x32);
  assign z01 = (~x04 & (~x21 | x32)) | (~new_n70_ & ~x21 & ~x30 & ~x32);
  ...
  assign new_n84_ = ~x04 & (~x21 | x32) & (x36 | (~x28 & x35));
  assign new_n85_ = (x39 & x40) ? (x05 & ~x21) : x07;
  assign new_n86_ = (~x21 | x32) & x06 & x37;
  assign new_n87_ = ~x32 & (x21 | ~x30);
  assign new_n88_ = x05 & ~x04 & x39 & x40;
  ...
  assign z14 = (~x27 | (~new_n97_ & (~new_n95_ | new_n96_))) & ~new_n73_ & (new_n94_ | ~new_n95_);
  ...
  assign z13 = (x27 & (new_n97_ | (new_n95_ & ~new_n96_))) | new_n73_ | (~new_n94_ & new_n95_);
