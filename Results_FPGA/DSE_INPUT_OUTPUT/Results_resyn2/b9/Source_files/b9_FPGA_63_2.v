...
module FAU ( 
  ...
  assign new_n82_ = (new_n70_ | (new_n72_ & ~new_n83_)) & (~new_n72_ | x05) & ~x04 & (new_n72_ | x07);
  ...
  assign z13 = (~new_n90_ & new_n91_) | new_n92_ | new_n68_;
  assign new_n90_ = new_n83_ & (~x27 | (x28 & (~x35 | ~x36)));
  assign new_n91_ = new_n72_ & ~x04 & ~x13;
  assign new_n92_ = ~new_n66_ & ~x19 & x20 & ~x18 & x27;
  assign z14 = (~new_n92_ & (~new_n91_ | new_n94_)) | (~new_n95_ & ~x32);
  assign new_n94_ = x28 & (~x35 | ~x36) & new_n83_ & (x19 | ~x20);
  assign new_n95_ = ~x18 & (x30 | (x27 & (x37 | ~x28 | x35)));
