...
module FAU ( 
  ...
  assign z10 = ~new_n85_ | (new_n84_ & (new_n70_ | (new_n72_ & (x30 | x32))));
  assign new_n84_ = (x07 | (x39 & x40)) & ~x04 & (x05 | ~x39 | ~x40);
  assign new_n85_ = (x18 | x32) & (~x37 | ~x06 | ~x27);
  ...
  assign z13 = (x27 & (new_n93_ | (~new_n91_ & new_n92_))) | new_n73_ | new_n94_;
  ...
  assign z14 = (~new_n96_ & ~x32) | (~new_n92_ & (~new_n93_ | ~x27));
  assign new_n96_ = x18 & (x30 | (x27 & (~x28 | (x35 & x36))));
  ...
  assign z20 = new_n73_ | (~new_n87_ & ~x09 & ~x30 & (~x27 | ~x35));
