...
module FAU ( 
  ...
  assign z10 = (~new_n83_ & x27) | (new_n67_ & (x30 | x32) & x05 & (~x30 | ~x32));
  ...
  assign z13 = (~x30 | ~x32) & (new_n93_ | (x27 & (new_n92_ | (new_n91_ & ~x30))));
  assign new_n91_ = (~x28 | (x35 & x36)) & new_n73_ & ~x04 & ~x13;
  assign new_n92_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n93_ = ~x13 & new_n67_ & (x30 | x32);
  assign z14 = ~new_n93_ & ~new_n68_ & (~new_n92_ | ~x27) & (~new_n91_ | ~x27);
