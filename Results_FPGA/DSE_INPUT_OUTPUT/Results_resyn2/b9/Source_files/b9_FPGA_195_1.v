...
module FAU ( 
  ...
  assign z01 = (new_n71_ & (new_n70_ | ~x27)) | new_n68_ | ~x04;
  ...
  assign z10 = (~new_n83_ & x27) | (new_n85_ & ~x04 & x05);
  assign new_n83_ = (new_n68_ | ~x06 | ~x37) & (new_n84_ | new_n70_ | x04);
  assign new_n84_ = (~x07 | (x39 & x40) | (~x09 & x32)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n85_ = ~new_n71_ & ~new_n68_ & x39 & x40;
  assign z11 = ~x09 & (x32 | (~new_n87_ & ~new_n89_ & ~x30));
  assign new_n87_ = new_n88_ & (~x27 | (x29 & x39 & x40));
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n89_ = ~x04 & x27 & ~x28 & x35;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = new_n93_ | (x27 & (new_n92_ | (~new_n94_ & new_n95_ & ~x32)));
  assign new_n92_ = ~new_n66_ & ~new_n68_ & x20 & ~x18 & ~x19;
  assign new_n93_ = ~x04 & ~x13 & ~new_n71_ & ~new_n68_ & x39 & x40;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = (~new_n97_ & (~x20 | x18 | x19)) | new_n98_ | new_n68_;
  assign new_n97_ = new_n95_ & (~new_n71_ | ~new_n94_);
  ...
  assign z19 = ~new_n87_ & ~new_n89_ & ~x32 & ~x09 & ~x30;
  assign z20 = ~new_n88_ & ~x32 & ~x09 & ~x30 & (~x27 | ~x35);
  assign z18 = new_n87_ | new_n89_ | x32 | x09 | x30;
endmodule
