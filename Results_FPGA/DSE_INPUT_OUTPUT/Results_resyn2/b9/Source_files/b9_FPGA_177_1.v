...
module FAU ( 
  ...
  assign new_n84_ = (~x07 | (~x30 & x32) | (x39 & x40)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n85_ = (x30 | ~x32) & x06 & x37;
  assign z11 = ~x30 & (new_n87_ | x32);
  assign new_n87_ = new_n88_ & (~x08 | (~new_n70_ & (~new_n73_ | ~x29)) | (x27 & (~new_n73_ | ~x29)));
  assign new_n88_ = ~x09 & (~x27 | ~x35 | x04 | x28);
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (x27 | (new_n92_ & x30)) & ((~new_n93_ & new_n92_ & ~x32) | new_n91_ | (new_n92_ & x30));
  assign new_n91_ = ~new_n68_ & ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n92_ = ~x04 & ~x13 & x39 & x40;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign z14 = ~new_n96_ | (~new_n95_ & (~x20 | x18 | x19));
  assign new_n95_ = new_n92_ & (~new_n93_ | x30);
  assign new_n96_ = (~new_n66_ | (new_n92_ & (~x28 | x30))) & (x30 | ~x32) & (x27 | (new_n92_ & x30));
  assign z15 = new_n68_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z20 = new_n101_ & (~x08 | (~new_n70_ & (~new_n73_ | ~x29)));
  assign new_n101_ = (~x27 | ~x35) & ~x32 & ~x09 & ~x30;
  assign z18 = x30 | (~new_n87_ & ~x32);
  assign z19 = ~x30 & (new_n87_ | x32);
endmodule
