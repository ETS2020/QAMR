...
module FAU ( 
  ...
  assign z10 = ~new_n70_ & (new_n86_ | (~x04 & (new_n84_ | (new_n71_ & ~new_n85_))));
  assign new_n84_ = (x30 | x32) & x05 & x39 & x40;
  assign new_n85_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n86_ = x37 & x06 & x27;
  assign z11 = new_n70_ | (new_n89_ & (~new_n88_ | (x27 & (~new_n74_ | ~x29))));
  ...
  assign z18 = new_n70_ | ~new_n89_ | (new_n88_ & (~x27 | (new_n74_ & x29)));
  assign z20 = ~new_n88_ & (~x27 | ~x35) & ~new_n70_ & ~x09 & ~x30;
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z19 = new_n70_ | (new_n89_ & (~new_n88_ | (x27 & (~new_n74_ | ~x29))));
endmodule
