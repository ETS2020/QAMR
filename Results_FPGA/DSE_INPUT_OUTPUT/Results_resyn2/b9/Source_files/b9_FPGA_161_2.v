...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n90_, new_n91_, new_n94_, new_n95_, new_n96_, new_n97_;
  ...
  assign z11 = x30 ? ~x32 : (new_n91_ & (~new_n89_ | new_n90_));
  ...
  assign z14 = new_n97_ & (~x27 | (~new_n96_ & (~new_n94_ | new_n95_)));
  ...
  assign z19 = ~x30 & new_n91_ & (~new_n89_ | new_n90_);
  assign z20 = ~new_n89_ & (~x27 | ~x35) & ~x09 & ~x30;
  assign z13 = ~new_n97_ | (x27 & (new_n96_ | (new_n94_ & ~new_n95_)));
