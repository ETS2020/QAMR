...
module FAU ( 
  ...
  assign z01 = (new_n72_ & (~x27 | (~new_n71_ & ~x36))) | new_n70_ | ~x04;
  assign new_n70_ = x11 & ~x40;
  assign new_n71_ = ~x28 & x35;
  assign new_n72_ = ~x30 & ~x32;
  assign z02 = ~new_n74_ | (x04 & (~new_n71_ | (~x08 & ~x27)));
  ...
  assign z08 = x39 & x40;
  assign z09 = x11 & (~x40 | (x34 & x26 & x27));
  assign z10 = new_n86_ | (x27 & (new_n85_ | (~new_n83_ & new_n84_)));
  assign new_n83_ = (~x05 | ~x39 | ~x40) & ((x11 & ~x40) | ~x07 | (x39 & x40));
  assign new_n84_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n85_ = (~x11 | x40) & x06 & x37;
  assign new_n86_ = ~x04 & x39 & x40 & x05 & (x30 | x32);
  assign z11 = (~x08 | (~new_n71_ & ~new_n88_) | (~new_n88_ & x27)) & new_n89_ & (~new_n71_ | x04 | ~x27);
  assign new_n88_ = x40 & x29 & x39;
  assign new_n89_ = (~x11 | x40) & ~x09 & ~x30;
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = (x27 & (new_n94_ | (new_n92_ & ~new_n93_))) | new_n70_ | (~new_n72_ & new_n92_);
  assign new_n92_ = ~x13 & ~x04 & x39 & x40;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (new_n97_ & (~new_n92_ | (new_n72_ & ~new_n96_))) | (new_n98_ & (~new_n92_ | (new_n72_ & new_n93_)));
  assign new_n96_ = x27 & ~x28;
  assign new_n97_ = (~x11 | x40) & (~x27 | (~x37 & (~x28 | ~x35)));
  assign new_n98_ = (~x11 | x40) & (~x20 | x18 | x19);
  assign z15 = ~new_n70_ & x12 & x34 & x26 & x27;
  assign z16 = x01 & x22 & ~new_n70_ & ~x23;
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z20 = ~new_n103_ & new_n89_ & (~x27 | ~x35);
  assign new_n103_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z18 = (x08 & (new_n71_ | new_n88_) & (new_n88_ | ~x27)) | ~new_n89_ | (new_n71_ & ~x04 & x27);
  assign z19 = (~x08 | (~new_n71_ & ~new_n88_) | (~new_n88_ & x27)) & new_n89_ & (~new_n71_ | x04 | ~x27);
endmodule
