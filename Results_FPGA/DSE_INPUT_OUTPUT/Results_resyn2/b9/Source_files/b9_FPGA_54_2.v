...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n71_, new_n73_,
    new_n74_, new_n80_, new_n84_, new_n86_, new_n87_, new_n88_, new_n91_,
    new_n92_, new_n93_, new_n94_, new_n96_, new_n97_;
  assign z00 = (~new_n65_ & ~x15) | ~x16 | ~x23;
  ...
  assign z02 = new_n74_ | ~new_n73_ | new_n69_ | (~x02 & (~x08 | ~x29));
  assign new_n73_ = x39 & x40;
  assign new_n74_ = x04 & (x28 | ~x35 | (~x08 & ~x27));
  assign z03 = (x27 & (~x28 | ~x35)) | (~x27 & ~x37) | new_n69_ | ~x21;
  ...
  assign z08 = new_n73_ | new_n69_;
  assign z09 = ~new_n69_ & x11 & x26 & x27 & x34;
  assign z10 = new_n84_ | new_n69_ | (x06 & x27 & x37);
  assign new_n84_ = ((new_n73_ & ~new_n71_) | (new_n70_ & (new_n73_ | x07))) & ~x04 & (~new_n73_ | x05);
  assign z11 = new_n86_ & ~new_n69_;
  assign new_n86_ = new_n88_ & (~new_n87_ | (x27 & (~new_n73_ | ~x29)));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n88_ = (~x27 | ~x35 | x04 | x28) & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n69_;
  assign z13 = new_n69_ | new_n94_ | (~new_n91_ & x27);
  assign new_n91_ = (~new_n92_ | (x28 & (~x35 | ~x36))) & (~new_n93_ | ((~x28 | ~x35) & ~x37));
  assign new_n92_ = ~x04 & ~x13 & x39 & x40;
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign new_n94_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = new_n96_ | new_n69_ | (~new_n97_ & ~new_n93_);
  assign new_n96_ = ~new_n94_ & (~x27 | (new_n66_ & (~new_n92_ | x28)));
  assign new_n97_ = new_n92_ & (~new_n71_ | ~x28 | (x35 & x36));
  assign z15 = new_n69_ | (x12 & x26 & x27 & x34);
  assign z16 = ~x16 & ~x23 & x01 & x22;
  assign z17 = x01 & x22 & x23 & ~x24;
  assign z18 = ~new_n86_ & ~new_n69_;
  assign z20 = ~new_n87_ & ~x09 & ~x30 & ~new_n69_ & (~x27 | ~x35);
