...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n92_, new_n93_, new_n95_, new_n96_, new_n102_;
  ...
  assign new_n83_ = (new_n84_ | new_n72_ | ~x07 | ~x27) & (new_n70_ | ~new_n72_ | ~x05);
  assign new_n84_ = ~x36 & (x28 | ~x35);
  assign z11 = (~x32 & x35) | (new_n86_ & (x04 | ~x27 | x28 | ~x35));
  assign new_n86_ = ~x09 & ~x30 & (~new_n88_ | (~new_n87_ & x27));
  assign new_n87_ = x29 & x39 & x40;
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (~new_n92_ & x27) | (~x32 & x35) | (new_n91_ & (x30 | x32));
  assign new_n91_ = new_n72_ & ~x04 & ~x13;
  assign new_n92_ = ~new_n93_ & (x28 | ~new_n72_ | x04 | x13);
  assign new_n93_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = new_n95_ | (~x32 & (x35 | (~new_n96_ & ~x30)));
  assign new_n95_ = (~new_n72_ | x04 | x13) & (~new_n93_ | ~x27);
  assign new_n96_ = x27 & (~x28 | (~x18 & ~x19 & x20 & x37));
  assign z15 = new_n68_ | (x12 & x26 & x27 & x34);
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n86_ | (x35 & (~x32 | (~x28 & ~x04 & x27)));
  assign z19 = ~new_n102_ & (new_n68_ | (~x09 & ~x30 & (~new_n87_ | ~x08)));
  assign new_n102_ = x32 & (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z20 = ~new_n88_ & ~x09 & ~x30 & (~x35 | (~x27 & x32));
endmodule
