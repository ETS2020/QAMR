...
module FAU ( 
  ...
  assign z02 = ~x40 | (x39 & (new_n74_ | (~x02 & (~x08 | ~x29))));
  ...
  assign new_n86_ = new_n87_ & (~x08 | (~new_n71_ & (~x29 | ~x40)) | (x27 & (~x29 | ~x40)));
  assign new_n87_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n89_ | (~x39 & x40) | (~new_n69_ & (x04 | ~x40));
  assign new_n89_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = new_n91_ | (x40 & (~x39 | (~new_n72_ & ~x04 & ~x13)));
  ...
  assign new_n96_ = (x39 | ~x40) & ((new_n69_ & new_n92_) | (~x04 & ~x13 & x40));
  ...
  assign z20 = (~x39 & x40) | (new_n102_ & (~x08 | (~new_n71_ & (~x29 | ~x40))));
