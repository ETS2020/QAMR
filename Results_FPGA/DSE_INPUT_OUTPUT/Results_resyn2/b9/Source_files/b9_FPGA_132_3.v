...
module FAU ( 
  ...
  assign z03 = (x27 & (~x28 | ~x35)) | (~x27 & ~x37) | z17 | ~x21;
  assign z04 = ~z17 & ((x27 & (~x28 | ~x35)) | x21 | (~x27 & ~x37));
  ...
  assign z09 = ~z17 & x11 & x34 & x26 & x27;
  ...
  assign z13 = ~z17 & ((~new_n72_ & new_n94_) | (x27 & (new_n95_ | (~new_n93_ & new_n94_))));
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = x39 & x40 & ~x04 & ~x13;
  assign new_n95_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = ~z17 & (new_n72_ | ~new_n94_) & (~x27 | (~new_n95_ & (new_n93_ | ~new_n94_)));
  assign z15 = z17 | (x12 & x34 & x26 & x27);
