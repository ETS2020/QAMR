...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n74_, new_n79_, new_n83_, new_n85_, new_n86_, new_n89_, new_n90_,
  ...
  assign new_n83_ = ((~x32 & ~new_n70_ & ~x30) | ~new_n74_ | ~x05) & (~new_n70_ | new_n74_ | ~x07);
  ...
  assign z13 = (~new_n89_ & x27) | (new_n91_ & (x32 | (x29 & x30)));
  assign new_n89_ = (~new_n90_ | new_n66_ | (~x29 & ~x32)) & (~new_n91_ | new_n92_ | ~x29);
  assign new_n90_ = x20 & ~x18 & ~x19;
  assign new_n91_ = ~x13 & ~x04 & x39 & x40;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign z14 = new_n94_ | (~new_n96_ & ~x32);
  assign new_n94_ = (~new_n90_ | ~new_n95_) & (~new_n91_ | (new_n92_ & ~new_n90_ & ~x30 & ~x32));
  assign new_n95_ = x27 & (x37 | (x28 & x35));
  assign new_n96_ = x29 & (x30 | (x27 & (x37 | ~x28 | x35)));
