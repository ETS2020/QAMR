...
module FAU ( 
  ...
  assign z03 = (~x21 & (x35 | (~x27 & ~x32))) | ((~x27 | ~x28 | ~x35) & (~x32 | x35) & (x27 | ~x37));
  assign z04 = ((~x27 | ~x28 | ~x35) & (~x32 | x35) & (x27 | ~x37)) | (x21 & (x35 | (~x27 & ~x32)));
  assign z06 = (new_n68_ | ~x27 | ~x28) & (new_n68_ | ~x37);
  ...
  assign z10 = (~new_n82_ & ~x04) | new_n84_ | (x37 & x06 & x27);
  assign new_n82_ = (~x30 | ~x05 | ~x39 | ~x40) & (~new_n83_ | ((x39 & x40) ? ~x05 : ~x07));
  assign new_n83_ = x27 & (x36 | (~x28 & x35));
  assign new_n84_ = x32 & (~x35 | (new_n67_ & x05));
  ...
  assign z13 = (new_n93_ & new_n95_) | (x27 & ((new_n91_ & ~new_n92_) | (new_n93_ & new_n94_)));
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = (~x28 | ~x35) & (~x37 | (x32 & ~x35));
  assign new_n93_ = ~x04 & ~x13 & x39 & x40;
  assign new_n94_ = (x28 | ~x32) & (~x28 | x36) & (~x28 | x35);
  assign new_n95_ = x32 ? x35 : x30;
  assign z14 = (~new_n97_ & ~x30) | new_n99_ | new_n68_;
  assign new_n97_ = new_n98_ & (new_n91_ | ~x28 | (x35 & (x32 | x36)));
  assign new_n98_ = (x27 | x32) & (x37 | ~x28 | x35);
  assign new_n99_ = ~new_n93_ & (~new_n91_ | new_n66_ | ~x27);
  ...
  assign z20 = (x32 & ~x35) | (~new_n87_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z05 = ~z06;
