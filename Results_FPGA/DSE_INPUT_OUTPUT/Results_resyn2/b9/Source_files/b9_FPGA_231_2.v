...
module FAU ( 
  ...
  assign new_n84_ = (new_n70_ | (new_n73_ & ~new_n85_)) & (~new_n73_ | x05) & ~x04 & (new_n73_ | x07);
  assign new_n85_ = ~x30 & ~x32;
  assign z11 = new_n88_ & (~new_n87_ | (x27 & (~new_n73_ | ~x29)));
  assign new_n87_ = x08 & (new_n74_ | (new_n73_ & x29));
  assign new_n88_ = (~new_n74_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = (~new_n91_ & new_n92_) | new_n93_ | new_n68_;
  assign new_n91_ = new_n85_ & (~x27 | (x28 & (~x35 | ~x36)));
  assign new_n92_ = new_n73_ & ~x04 & ~x13;
  assign new_n93_ = ~new_n66_ & ~x19 & x20 & ~x18 & x27;
  assign z14 = (~new_n96_ & ~x32) | (~new_n93_ & (~new_n92_ | new_n95_));
  assign new_n95_ = x28 & (~x35 | ~x36) & new_n85_ & (x19 | ~x20);
  assign new_n96_ = ~x18 & (x30 | (x27 & (x37 | ~x28 | x35)));
  assign z15 = x12 & ~new_n68_ & x34 & x26 & x27;
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z20 = ~new_n87_ & ~new_n68_ & ~x09 & ~x30 & (~x27 | ~x35);
  assign z18 = ~new_n88_ | (new_n87_ & (~x27 | (new_n73_ & x29)));
  assign z19 = new_n88_ & (~new_n87_ | (x27 & (~new_n73_ | ~x29)));
endmodule
