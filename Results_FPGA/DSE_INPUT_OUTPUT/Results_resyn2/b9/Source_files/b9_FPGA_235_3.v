...
module FAU ( 
  ...
  assign new_n83_ = ~x04 & (((new_n70_ | x32) & new_n74_ & x05) | (new_n70_ & ~new_n74_ & x07));
  ...
  assign new_n87_ = (~new_n73_ | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = new_n90_ | (new_n74_ & (~x30 | ~x32) & (x30 | x32) & ~x04 & ~x13);
  assign new_n90_ = (new_n91_ | (~new_n92_ & new_n93_ & ~x30)) & x27 & (~x30 | ~x32);
  ...
  assign new_n95_ = new_n93_ & (~new_n92_ | x30 | x32);
  assign new_n96_ = (~x30 | ~x32) & ((~new_n66_ & x27) | (new_n93_ & (x30 | x32 | (x27 & ~x28))));
