...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    new_n74_, new_n79_, new_n83_, new_n85_, new_n86_, new_n87_, new_n90_,
  ...
  assign z02 = new_n74_ | (~x02 & (~x08 | ~x29)) | ~new_n73_ | new_n68_;
  ...
  assign new_n83_ = (~new_n70_ | (new_n73_ ? ~x05 : ~x07)) & (new_n71_ | ~new_n73_ | ~x05);
  ...
  assign z13 = (~x23 & (new_n90_ | (~new_n71_ & new_n92_))) | ((new_n94_ | ~new_n71_) & new_n92_ & ~x20);
  assign new_n90_ = x27 & (new_n93_ | (~new_n91_ & new_n92_));
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = ~x04 & ~x13 & x39 & x40;
  assign new_n93_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n94_ = ~new_n91_ & x27;
  assign z14 = new_n97_ | (~new_n96_ & (~x20 | (~x23 & (x18 | x19))));
  assign new_n96_ = new_n92_ & ((~new_n91_ & x20) | ~new_n71_ | (~new_n91_ & x27));
  assign new_n97_ = (~new_n92_ | (new_n71_ & (~x27 | x28))) & ~x23 & (new_n66_ | ~x27);
  assign z15 = ~new_n68_ & x12 & x26 & x27 & x34;
  assign z16 = x23 ? x20 : (x01 & x22);
  assign z17 = x01 & x22 & ~x20 & x23 & ~x24;
