...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (~x32 | x37)) | (new_n68_ & (x37 | (~new_n66_ & ~new_n67_ & ~x32)));
  assign new_n65_ = x16 & (x15 | ~x10 | x04 | ~x39 | ~x40);
  assign new_n66_ = (x04 | ~x39 | ~x40) & (~x28 | ~x35);
  assign new_n67_ = ~x35 & ~x36;
  assign new_n68_ = ~x15 & x27;
  ...
  assign z03 = (~x32 | x37) & (~x21 | ((x27 | ~x37) & (~x28 | ~x27 | ~x35)));
  assign z04 = (~x32 | x37) & (x21 | ((x27 | ~x37) & (~x28 | ~x27 | ~x35)));
  assign z06 = ~x37 & (x32 | ~x27 | ~x28);
  assign z07 = (new_n79_ | ~x14) & new_n80_ & ((x00 & ~x25) | ~x38 | (~x14 & x25));
  assign new_n79_ = (x15 | ~x17) & ~x31 & ~x33;
  assign new_n80_ = x03 & (~x32 | x37);
  assign z08 = ~new_n70_ & new_n73_;
  assign z09 = new_n70_ | (x27 & x34 & x11 & x26);
  assign z10 = new_n87_ | (~new_n84_ & ~new_n71_ & ~new_n85_ & new_n86_);
  ...
  assign z11 = ~new_n70_ & new_n90_ & (~new_n89_ | (x27 & (~new_n73_ | ~x29)));
  assign new_n89_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n90_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = new_n93_ & (~x27 | (~new_n92_ & ~x37 & (~x28 | ~x35)));
  assign new_n92_ = ~x04 & x39 & x40 & (x35 | x36);
  assign new_n93_ = (~x10 | x04 | ~x39 | ~x40) & (~x32 | x37);
  assign z13 = (x27 & (new_n98_ | (~new_n96_ & new_n97_))) | new_n70_ | (~new_n95_ & new_n97_);
  assign new_n95_ = ~x30 & ~x32;
  assign new_n96_ = x28 & (~x35 | ~x36);
  assign new_n97_ = ~x13 & ~x04 & x39 & x40;
  assign new_n98_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~new_n100_ & (~new_n97_ | new_n101_)) | new_n102_ | new_n70_ | (~new_n97_ & ~new_n103_);
  assign new_n100_ = x20 & ~x18 & ~x19;
  assign new_n101_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n102_ = ~x30 & ((~x27 & ~x32) | (~x37 & x28 & ~x35));
  ...
  assign z19 = new_n70_ | (new_n90_ & (~new_n89_ | (x27 & (~new_n73_ | ~x29))));
  assign z20 = new_n70_ | (~new_n89_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z05 = ~z06;
  assign z18 = new_n70_ | ~new_n90_ | (new_n89_ & (~x27 | (new_n73_ & x29)));
endmodule
