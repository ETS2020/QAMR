...
module FAU ( 
  ...
  assign z13 = new_n94_ | (new_n68_ & ~new_n67_ & new_n96_);
  assign new_n94_ = ~new_n95_ & z08 & ~x04 & ~x13;
  assign new_n95_ = ~x30 & ~x32 & (~x27 | (x28 & (~x35 | ~x36)));
  assign new_n96_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n96_ & (~x40 | (~new_n98_ & x26))) | (~new_n68_ & ~x40) | (~new_n100_ & ~new_n68_ & x26);
  ...
  assign z18 = ~new_n67_ & (~new_n105_ | (new_n89_ & x08));
  assign new_n105_ = new_n90_ & ((~x08 & ~x27) | ~new_n70_ | (x04 & x27));
  assign z19 = (new_n105_ | new_n67_) & (~z08 | ~x08 | ~x29);
  assign z20 = new_n108_ & (~x08 | (~new_n70_ & ~new_n89_));
  assign new_n108_ = (~x27 | ~x35) & ~new_n67_ & new_n90_;
endmodule
