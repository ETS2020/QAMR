...
module FAU ( 
  ...
  assign z07 = new_n81_ & (~x14 | (~x31 & ~x33 & (x15 | ~x17)));
  assign new_n81_ = ((x00 & ~x25) | ~x38 | (~x14 & x25)) & ~new_n68_ & x03;
  assign z08 = ~new_n68_ & new_n74_;
  assign z09 = x11 & ~new_n68_ & x27 & x26 & x34;
  assign z10 = (~new_n85_ & x27 & (~x05 | x32)) | (new_n67_ & x05 & x32);
  assign new_n85_ = (~x06 | ~x37) & (new_n70_ | new_n74_ | x04 | ~x07);
  assign z11 = new_n88_ & (~new_n87_ | (x27 & (~new_n74_ | ~x29)));
  assign new_n87_ = x08 & (new_n75_ | (new_n74_ & x29));
  assign new_n88_ = (~new_n75_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (~new_n91_ & x27) | (new_n94_ & (x32 | (~x05 & x30)));
  assign new_n91_ = (~new_n92_ | new_n66_ | (x05 & ~x32)) & (new_n93_ | ~new_n94_ | x05);
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = new_n96_ | (~new_n92_ & ((new_n71_ & new_n93_) | (~new_n68_ & ~new_n94_)));
  assign new_n96_ = (~new_n94_ | (new_n71_ & (~x27 | x28))) & ~new_n68_ & (new_n66_ | ~x27);
