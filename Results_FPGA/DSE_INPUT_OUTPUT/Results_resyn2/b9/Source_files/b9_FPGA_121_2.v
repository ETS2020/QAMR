...
module FAU ( 
  ...
  assign z01 = ~new_n70_ & (~x04 | (new_n72_ & (~x27 | (~new_n71_ & ~x36))));
  ...
  assign new_n83_ = (~x05 | ~x39 | ~x40) & (~x07 | (x39 & x40) | (x21 & ~x40));
  assign new_n84_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n85_ = (~x21 | x40) & x06 & x37;
  ...
  assign new_n89_ = (~x21 | x40) & ~x09 & ~x30;
  ...
  assign z14 = (~new_n96_ & (~new_n92_ | new_n97_)) | new_n70_ | (~new_n98_ & (~new_n92_ | new_n99_));
  assign new_n96_ = x20 & ~x18 & ~x19;
  assign new_n97_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n98_ = x27 & (x37 | (x28 & x35));
  ...
  assign z20 = ~new_n104_ & new_n89_ & (~x27 | ~x35);
