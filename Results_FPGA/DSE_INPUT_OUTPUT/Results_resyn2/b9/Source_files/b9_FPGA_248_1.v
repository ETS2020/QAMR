...
module FAU ( 
  ...
  assign z01 = (~x04 & (x31 | ~x32)) | (~new_n70_ & ~x30 & ~x32);
  ...
  assign new_n84_ = x32 & (~x31 | (new_n67_ & x05));
  ...
  assign z13 = new_n93_ | (x27 & ((new_n91_ & (x31 | ~x32)) | (new_n92_ & ~x32)));
  assign new_n91_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n92_ = new_n72_ & ~x04 & ~x13 & (~x28 | (x35 & x36));
  assign new_n93_ = new_n72_ & ~x04 & ~x13 & (x31 | ~x32) & (x30 | x32);
