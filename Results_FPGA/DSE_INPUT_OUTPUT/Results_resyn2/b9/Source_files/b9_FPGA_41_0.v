...
module FAU ( 
  ...
  assign z02 = (x40 & (new_n73_ | (~new_n74_ & ~x02))) | (x40 ? ~x39 : x34);
  ...
  assign z10 = ~new_n84_ | (new_n83_ & ((new_n68_ & ~new_n71_) | (new_n70_ & (new_n68_ | x07))));
  assign new_n83_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n84_ = (x34 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = ~new_n65_ & new_n87_ & (~new_n86_ | (x27 & (~new_n68_ | ~x29)));
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n87_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = (x40 & (new_n90_ | (~new_n89_ & (x04 | ~x39)))) | (~new_n89_ & x34 & ~x40);
  assign new_n89_ = x27 & (x37 | (x28 & x35));
  assign new_n90_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = (x27 & (new_n92_ | (~new_n93_ & new_n94_))) | new_n65_ | (~new_n71_ & new_n94_);
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = ~new_n65_ & ((~new_n96_ & (~new_n94_ | new_n97_)) | (~new_n89_ & (~new_n94_ | new_n98_)));
  ...
  assign z18 = (new_n68_ & new_n74_) | (~new_n65_ & (new_n103_ | x09 | x30));
  assign new_n103_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z19 = new_n65_ | (new_n87_ & (~new_n86_ | (x27 & (~new_n68_ | ~x29))));
