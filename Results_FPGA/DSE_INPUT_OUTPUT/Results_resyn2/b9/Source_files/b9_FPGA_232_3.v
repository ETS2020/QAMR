...
module FAU ( 
  ...
  assign new_n80_ = x03 & (~x06 | ~x32);
  assign z08 = new_n72_ | new_n73_;
  assign z09 = new_n73_ | (x27 & x34 & x11 & x26);
  assign z10 = new_n87_ | ((new_n70_ | new_n84_) & ~new_n85_ & new_n86_);
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign new_n85_ = ~x07 & (~x39 | ~x40);
  assign new_n86_ = (x05 | ~x39 | ~x40) & ~x04 & (~x06 | ~x32);
  ...
  assign new_n90_ = (~x27 | ~x35 | x04 | x28) & ~x09 & ~x30;
  assign z12 = new_n73_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = new_n73_ | new_n93_ | (x27 & (new_n94_ | (~new_n95_ & new_n96_)));
  ...
  assign z14 = new_n73_ | (~new_n93_ & (~x27 | (~new_n94_ & (new_n95_ | ~new_n96_))));
  ...
  assign z20 = ~new_n89_ & ~x09 & ~x30 & ~new_n73_ & (~x27 | ~x35);
