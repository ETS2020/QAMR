...
module FAU ( 
  ...
  assign new_n93_ = x32 & x39 & x40 & ~x04 & ~x13;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = ~x30 & x39 & x40 & ~x04 & ~x13;
  ...
  assign new_n100_ = ~x27 & (~x32 | ~x39 | ~x40 | x04 | x13);
  assign new_n101_ = ~x32 & x28 & (~x35 | ~x36);
  assign new_n102_ = ~x32 & (x30 | (~x37 & x28 & ~x35));
