...
module FAU ( 
  ...
  assign z02 = new_n73_ | ~new_n72_ | new_n70_ | (~x02 & (~x08 | ~x29));
  ...
  assign new_n80_ = x03 & (x30 | x32);
  assign z08 = new_n72_ & ~new_n70_;
  assign z09 = new_n70_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n70_ & (new_n87_ | (~x04 & (new_n84_ | (~new_n85_ & new_n86_))));
  assign new_n84_ = x05 & x39 & x40;
  assign new_n85_ = ~x36 & (x28 | ~x35);
  assign new_n86_ = x07 & x27 & (~x39 | ~x40);
  assign new_n87_ = x37 & x06 & x27;
  assign z11 = (~new_n89_ | new_n90_) & ~new_n91_ & x32 & ~x09 & ~x30;
  assign new_n89_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n90_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n91_ = x27 & x35 & ~x04 & ~x28;
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = ~new_n70_ & ((~new_n65_ & new_n94_) | (~x13 & new_n72_ & ~x04));
  ...
  assign z19 = ~x30 & (~x32 | ((~new_n89_ | new_n90_) & ~new_n91_ & ~x09));
  assign z20 = ~new_n89_ & (~x27 | ~x35) & x32 & ~x09 & ~x30;
  assign z14 = new_n70_ | ((new_n65_ | ~new_n94_) & (x13 | ~new_n72_ | x04));
  assign z18 = x30 | (x32 & ((new_n89_ & ~new_n90_) | new_n91_ | x09));
endmodule
