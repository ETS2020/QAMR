...
module FAU ( 
  ...
  assign new_n78_ = ((x00 & ~x25) | ~x38 | (~x14 & x25)) & x03 & x32;
  assign z08 = new_n68_ | (x39 & x40);
  assign z09 = x34 & x26 & x27 & ~new_n68_ & x11;
  assign z10 = new_n82_ | new_n68_ | (x37 & x06 & x27);
  assign new_n82_ = new_n83_ & (new_n70_ | ((x30 | x32) & x39 & x40));
  assign new_n83_ = (x07 | (x39 & x40)) & ~x04 & (x05 | ~x39 | ~x40);
  ...
  assign z14 = (new_n90_ | ~x27) & (~new_n91_ | (~x30 & ~x32)) & (~x03 | x32);
  ...
  assign z13 = (~new_n90_ & x27) | (new_n91_ & (x30 | x32)) | (x03 & ~x32);
