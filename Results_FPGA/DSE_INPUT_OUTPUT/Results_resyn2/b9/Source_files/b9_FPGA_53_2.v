...
module FAU ( 
  ...
  assign new_n84_ = (~x05 | ~x39 | ~x40) & ((x13 & ~x40) | ~x07 | (x39 & x40));
  ...
  assign z12 = (x40 & (new_n91_ | (~new_n92_ & (x04 | ~x39)))) | (~new_n92_ & ~x13 & ~x40);
  ...
  assign new_n97_ = (~x13 | x40) & ((~x30 & ~x32) | x13 | x04 | ~x39 | ~x40);
  ...
  assign z18 = new_n70_ | ~new_n89_ | (new_n88_ & (~x27 | (z08 & x29)));
endmodule
