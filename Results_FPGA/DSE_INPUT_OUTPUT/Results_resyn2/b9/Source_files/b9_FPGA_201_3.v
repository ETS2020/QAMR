...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n92_, new_n93_, new_n94_, new_n96_, new_n97_, new_n102_;
  ...
  assign new_n84_ = ~x04 & (((new_n70_ | x32) & new_n74_ & x05) | (new_n70_ & ~new_n74_ & x07));
  assign new_n85_ = x30 & (x32 | (new_n67_ & x05));
  assign z11 = x30 ? x32 : new_n87_;
  assign new_n87_ = (~x08 | (~new_n73_ & ~new_n88_) | (~new_n88_ & x27)) & ~x09 & (~new_n73_ | x04 | ~x27);
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = new_n91_ | (new_n74_ & (~x30 | ~x32) & (x30 | x32) & ~x04 & ~x13);
  ...
  assign z20 = x30 ? x32 : (new_n102_ & (~x08 | (~new_n73_ & ~new_n88_)));
  assign new_n102_ = ~x09 & (~x27 | ~x35);
