...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n72_,
    new_n74_, new_n75_, new_n77_, new_n82_, new_n86_, new_n87_, new_n88_,
  ...
  assign new_n68_ = x39 & x40 & ~x04 & x10;
  assign z01 = ~new_n70_ & (~x04 | (~new_n71_ & new_n72_));
  assign new_n70_ = x37 & ~x40;
  assign new_n71_ = x27 & (x36 | (~x28 & x35));
  assign new_n72_ = ~x30 & ~x32;
  assign z02 = x40 ? (new_n74_ | ~new_n75_) : ~x37;
  assign new_n74_ = x04 & ((~x08 & ~x27) | x28 | ~x35);
  assign new_n75_ = x39 & (x02 | (x08 & x29));
  assign z03 = (~x27 & ~x37) | (~new_n77_ & ~x37) | (~new_n77_ & x27 & x40) | (~x21 & (~x37 | x40));
  assign new_n77_ = x28 & x35;
  assign z04 = x21 | (x37 & ~x40) | ((~new_n77_ | ~x27) & (~x37 | x27 | ~x40));
  assign z05 = x37 | (x27 & x28);
  assign z06 = new_n70_ | ~z05;
  assign z07 = new_n70_ | (new_n82_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  assign new_n82_ = x03 & (~x14 | ((x15 | ~x17) & ~x31 & ~x33));
  assign z08 = x40 ? x39 : x37;
  assign z09 = new_n70_ | (x11 & x26 & x27 & x34);
  assign z10 = new_n88_ | (~x04 & ((new_n86_ & (new_n71_ | ~new_n72_)) | (new_n71_ & new_n87_)));
  assign new_n86_ = x05 & x39 & x40;
  assign new_n87_ = x07 & (~x39 | ~x40) & (~x37 | x40);
  assign new_n88_ = x06 & x37 & x27 & x40;
  assign z11 = new_n70_ | (new_n92_ & (~new_n91_ | (~new_n90_ & x27)));
  assign new_n90_ = x40 & x29 & x39;
  assign new_n91_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign new_n92_ = (x28 | ~x35 | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = new_n95_ | (~x37 & ~x40 & (~new_n77_ | ~x27)) | (~new_n94_ & ((~x27 & x40) | (~new_n77_ & ~x37)));
  assign new_n94_ = ~x04 & x39;
  assign new_n95_ = ~x10 & ((~x27 & x40) | (~x37 & ~x35 & ~x36));
  assign z13 = (~new_n72_ & new_n98_) | (x27 & (new_n99_ | (~new_n97_ & new_n98_)) & (~new_n70_ | (~new_n97_ & new_n98_)));
  assign new_n97_ = x28 & (~x35 | ~x36);
  assign new_n98_ = x39 & x40 & ~x04 & ~x13;
  assign new_n99_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~x27 | (~new_n99_ & (new_n97_ | ~new_n98_))) & ~new_n70_ & (new_n72_ | ~new_n98_);
  assign z15 = new_n70_ | (x12 & x26 & x27 & x34);
  assign z16 = x01 & x22 & ~new_n70_ & ~x23;
  assign z17 = x01 & x22 & ~new_n70_ & x23 & ~x24;
  assign z19 = ~new_n70_ & new_n92_ & (~new_n91_ | (~new_n90_ & x27));
  assign z20 = ~new_n91_ & (~x27 | ~x35) & ~new_n70_ & ~x09 & ~x30;
  assign z18 = new_n70_ | ~new_n92_ | (new_n91_ & (new_n90_ | ~x27));
endmodule
