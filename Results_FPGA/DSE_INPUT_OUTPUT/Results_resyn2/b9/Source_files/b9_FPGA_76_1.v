...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n69_, new_n71_, new_n77_, new_n78_,
    ...
    new_n92_, new_n93_, new_n94_, new_n99_, new_n100_;
  ...
  assign z10 = new_n84_ | (x27 & (new_n83_ | (~new_n82_ & ~new_n69_ & ~x04)));
  assign new_n82_ = (~x05 | ~x39 | ~x40) & (~x07 | x40);
  assign new_n83_ = x06 & x37 & (x39 | ~x40);
  assign new_n84_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = (~x39 & x40) | (new_n87_ & (~new_n86_ | (x27 & (~x29 | ~x40))));
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x40));
  assign new_n87_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = new_n90_ | (~x39 & x40) | (~new_n89_ & (x04 | ~x40));
  assign new_n89_ = x27 & (x37 | (x28 & x35));
  assign new_n90_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z14 = ~new_n94_ & (~x27 | (~new_n92_ & ~new_n93_));
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n93_ = (~x28 | (x35 & x36)) & x40 & ~x04 & ~x13;
  assign new_n94_ = x40 & (~x39 | ((x30 | x32) & ~x04 & ~x13));
  assign z15 = x12 & ~new_n68_ & x34 & x26 & x27;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z18 = ~new_n68_ & (new_n99_ | ~new_n100_);
  assign new_n99_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  ...
  assign z19 = (~x39 & x40) | (new_n87_ & (~new_n86_ | (x27 & (~x29 | ~x40))));
endmodule
