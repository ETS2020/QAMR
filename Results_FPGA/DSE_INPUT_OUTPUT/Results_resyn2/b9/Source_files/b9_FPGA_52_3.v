...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x26 | ~x32)) | (~x30 & ~x32 & (new_n70_ | ~x27));
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n68_ & (new_n72_ | new_n73_ | ~x39 | ~x40);
  ...
  assign z10 = (~new_n82_ & x27) | (new_n84_ & new_n67_ & x05);
  assign new_n82_ = (new_n83_ | new_n70_ | x04) & (new_n68_ | ~x06 | ~x37);
  assign new_n83_ = (~x07 | (x26 & x32) | (x39 & x40)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n84_ = x32 ? ~x26 : x30;
  ...
  assign z13 = (new_n91_ & (~x32 | (new_n93_ & ~x26))) | (new_n92_ & (x30 | x32) & (~x26 | ~x32));
  assign new_n91_ = x27 & (new_n93_ | (new_n92_ & (~x28 | (x35 & x36))));
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~new_n84_ | ~new_n92_) & (~new_n91_ | new_n68_);
  assign z15 = x26 & (x32 | (x34 & x12 & x27));
