...
module FAU ( 
  ...
  assign z10 = new_n83_ | (x27 & (new_n82_ | (~new_n68_ & x06 & x37)));
  assign new_n82_ = ((new_n73_ & x05) | (~new_n68_ & ~new_n73_ & x07)) & ~new_n70_ & ~x04;
  assign new_n83_ = new_n73_ & x05 & ~x04 & (x30 | x32);
  assign z11 = new_n85_ & ~new_n68_;
  assign new_n85_ = new_n87_ & (~new_n86_ | (x27 & (~new_n73_ | ~x29)));
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n87_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = new_n92_ | (x27 & (new_n90_ | (new_n93_ & ~new_n67_ & ~new_n68_)));
  assign new_n90_ = ~new_n91_ & new_n73_ & ~x04 & ~x13;
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = ~x04 & ~x13 & new_n73_ & (x30 | x32);
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign z14 = new_n96_ | (new_n98_ & (new_n95_ | ~x27));
  assign new_n95_ = new_n67_ & (~new_n73_ | x28 | x04 | x13);
  assign new_n96_ = ((new_n91_ & ~x30) | ~x40 | (~new_n97_ & x40)) & ~new_n93_ & (~x32 | (~new_n97_ & x40));
  assign new_n97_ = x39 & ~x04 & ~x13;
  assign new_n98_ = (x04 | x13 | ~x30 | ~x39 | ~x40) & (~x32 | (x40 & (~x39 | x04 | x13)));
  assign z15 = new_n68_ | (x27 & x34 & x12 & x26);
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z18 = (~new_n103_ & ~new_n68_) | (new_n73_ & x08 & x29);
  assign new_n103_ = ~new_n104_ & ~x09 & ~x30;
  assign new_n104_ = (~x04 | ~x27) & ~x28 & x35 & (x08 | x27);
  assign z19 = new_n85_ | new_n68_;
  assign z20 = new_n68_ | (~new_n86_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z05 = ~z06;
endmodule
