...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    new_n74_, new_n79_, new_n83_, new_n84_, new_n87_, new_n88_, new_n91_,
  ...
  assign z02 = (~x02 & (~x29 | (~x08 & ~x30))) | (~new_n73_ & (~x29 | ~x30));
  assign new_n73_ = x39 & x40 & (~x04 | (new_n74_ & (x08 | x27)));
  ...
  assign z20 = (x29 & x30) | (~new_n87_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z06 = ~z05;
  assign z18 = ~z19;
endmodule
