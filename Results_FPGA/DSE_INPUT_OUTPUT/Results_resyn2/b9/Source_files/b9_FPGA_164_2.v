...
module FAU ( 
  ...
  assign new_n68_ = x16 & (~x00 | x40);
  assign z01 = new_n71_ | new_n70_ | ~x04;
  assign new_n70_ = x00 & ~x40;
  ...
  assign new_n83_ = (~x05 | ~x39 | ~x40) & (~x07 | (x39 & x40) | (x00 & ~x40));
  assign new_n84_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n85_ = x06 & x37 & (~x00 | x40);
  ...
  assign z13 = (x27 & (new_n95_ | (new_n93_ & ~new_n94_))) | new_n70_ | (~new_n92_ & new_n93_);
  assign new_n92_ = ~x30 & ~x32;
  assign new_n93_ = ~x13 & ~x04 & x39 & x40;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (new_n98_ & (~new_n93_ | (new_n92_ & ~new_n97_))) | (new_n99_ & (~new_n93_ | (new_n92_ & new_n94_)));
  assign new_n97_ = x27 & ~x28;
  assign new_n98_ = (~x00 | x40) & (~x27 | (~x37 & (~x28 | ~x35)));
  assign new_n99_ = (~x00 | x40) & (~x20 | x18 | x19);
