...
module FAU ( 
  ...
  assign z10 = ~new_n70_ & (new_n87_ | (~x04 & (new_n86_ | (new_n71_ & ~new_n85_))));
  assign new_n85_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n86_ = (x30 | x32) & x05 & x39 & x40;
  assign new_n87_ = x37 & x06 & x27;
  assign z18 = ~new_n70_ & (~new_n90_ | (new_n89_ & (~x27 | (new_n74_ & x29))));
  ...
  assign z14 = (~x27 | (~new_n95_ & (~new_n93_ | new_n94_))) & ~new_n70_ & (new_n72_ | ~new_n93_);
  ...
  assign z17 = x23 & (x24 | (x01 & x22));
  assign z19 = ~new_n70_ & new_n90_ & (~new_n89_ | (x27 & (~new_n74_ | ~x29)));
  assign z20 = new_n70_ | (~new_n89_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z11 = new_n70_ | (new_n90_ & (~new_n89_ | (x27 & (~new_n74_ | ~x29))));
  assign z13 = (x27 & (new_n95_ | (new_n93_ & ~new_n94_))) | new_n70_ | (~new_n72_ & new_n93_);
endmodule
