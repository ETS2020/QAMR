...
module FAU ( 
  ...
  assign new_n87_ = (~x37 | ~x06 | ~x27) & (x38 | ~x40);
  ...
  assign z13 = (x27 & ((new_n98_ & new_n99_) | (new_n96_ & new_n97_))) | (new_n85_ & new_n98_);
  assign new_n96_ = x20 & ~x18 & ~x19;
  assign new_n97_ = (x37 | (x28 & x35)) & (x38 | ~x40);
  assign new_n98_ = x38 & ~x04 & ~x13;
  assign new_n99_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (~new_n96_ & (new_n101_ | ~new_n102_)) | new_n70_ | (~new_n103_ & (~new_n102_ | new_n104_));
