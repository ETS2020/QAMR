...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n78_,
    ...
    new_n92_, new_n94_, new_n95_, new_n96_, new_n102_;
  ...
  assign z01 = (~x04 & (~x32 | ~x35)) | (~new_n70_ & ~x30 & ~x32);
  assign new_n70_ = x27 & (x36 | (~x28 & x35));
  assign z02 = ~new_n72_ | (x04 & ((~x08 & ~x27) | x28 | ~x35));
  assign new_n72_ = (x02 | (x08 & x29)) & ~new_n68_ & x39 & x40;
  assign z03 = ~x21 | (x32 & x35) | (x27 ? (~x28 | ~x35) : ~x37);
  assign z04 = (x21 & (~x32 | ~x35)) | ((~x32 | ~x35) & (x27 | ~x37) & (~x27 | ~x28 | ~x35));
  ...
  assign new_n83_ = x32 & (x35 | (new_n67_ & x05));
  assign z11 = (x32 & x35) | (new_n85_ & (x04 | ~x27 | x28 | ~x35));
  assign new_n85_ = ~x09 & ~x30 & (~new_n87_ | (~new_n86_ & x27));
  ...
  assign z14 = (~new_n94_ & ~new_n92_) | ~new_n95_ | new_n96_;
  assign new_n94_ = new_n91_ & (x30 | x32 | ~x28 | (x35 & x36));
  assign new_n95_ = ~new_n68_ & (new_n91_ | (~new_n66_ & x27));
  ...
  assign z19 = ~new_n102_ & (new_n68_ | (~x09 & ~x30 & (~new_n86_ | ~x08)));
  assign new_n102_ = ~x32 & ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign z20 = ~new_n87_ & ~x09 & ~x30 & (~x35 | (~x27 & ~x32));
endmodule
