...
module FAU ( 
  ...
  assign new_n82_ = ((~new_n69_ & ~x30 & ~x32) | ~x05 | ~x40) & (~new_n69_ | ~x07 | x40);
  assign z11 = new_n84_ & (~x08 | (~new_n72_ & (~x29 | ~x40)) | (x27 & (~x29 | ~x40)));
  assign new_n84_ = (~new_n72_ | x04 | ~x27) & ~new_n67_ & ~x09 & ~x30;
  assign z12 = (new_n86_ | ~x40) & (~x27 | (~x37 & (~x28 | ~x35)));
  assign new_n86_ = x39 & (x04 | (~x10 & (~x27 | (~x35 & ~x36))));
  assign z13 = new_n88_ | (x40 & (~x39 | (~new_n90_ & ~x04 & ~x13)));
  ...
  assign z19 = new_n84_ & (~x08 | (~new_n72_ & (~x29 | ~x40)) | (x27 & (~x29 | ~x40)));
endmodule
