...
module FAU ( 
  ...
  assign z01 = ~x04 | (~new_n70_ & ~x30);
  assign new_n70_ = ~x40 & (x32 | (x27 & (x36 | (~x28 & x35))));
  assign z02 = ~x40 | (x30 & (new_n72_ | ~new_n73_));
  ...
  assign new_n81_ = x40 & (~x30 | x39);
  assign new_n82_ = ~x04 & x07 & (x36 | (~x28 & x35));
  assign new_n83_ = (x30 | ~x40) & x06 & x37;
  assign new_n84_ = ~x04 & x05 & x40 & x30 & x39;
  assign z11 = ~x30 & (x40 | (~new_n86_ & ~x09));
  ...
  assign z13 = new_n91_ | (~new_n65_ & new_n88_ & x20 & ~x18 & ~x19);
  assign new_n91_ = ~x04 & ~x13 & x40 & x30 & x39;
  assign z14 = ~new_n93_ & (~new_n88_ | ~x20 | x18 | x19);
  assign new_n93_ = x40 & (~x30 | (x39 & ~x04 & ~x13));
  assign z15 = x27 & x34 & ~new_n65_ & x12 & x26;
  assign z16 = x01 & x22 & ~new_n65_ & ~x23;
  assign z17 = new_n65_ | (x01 & x22 & x23 & ~x24);
  assign z19 = ~new_n86_ & ~x40 & ~x09 & ~x30;
  assign z20 = ~new_n99_ & ~x40 & ~x09 & ~x30;
  assign new_n99_ = x35 & (x27 | (x08 & ~x28));
  assign z05 = (x27 & x28) | new_n65_ | x37;
  assign z18 = new_n86_ | x40 | x09 | x30;
endmodule
