...
module FAU ( 
  ...
  assign new_n68_ = x16 & (x06 | ~x32);
  assign z01 = (~new_n71_ & new_n72_) | new_n70_ | ~x04;
  assign new_n70_ = ~x06 & x32;
  ...
  assign new_n81_ = x03 & (x06 | ~x32);
  assign z08 = new_n74_ | new_n70_;
  assign z09 = new_n70_ | (x27 & x34 & x11 & x26);
  assign z10 = new_n85_ | ((new_n71_ | new_n86_) & (new_n71_ | ~new_n72_) & new_n88_ & (new_n86_ | new_n87_));
  assign new_n85_ = x37 & x06 & x27;
  assign new_n86_ = x40 & x05 & x39;
  assign new_n87_ = x07 & (~x39 | ~x40);
  assign new_n88_ = ~x04 & (x06 | ~x32);
  assign z11 = ~new_n70_ & new_n91_ & (~new_n90_ | (x27 & (~new_n74_ | ~x29)));
  assign new_n90_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n91_ = (~x27 | x28 | x04 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = new_n70_ | (~new_n72_ & new_n94_) | (x27 & (new_n96_ | (new_n94_ & ~new_n95_)));
  assign new_n94_ = ~x13 & ~x04 & x39 & x40;
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~new_n99_ & (~new_n94_ | new_n100_)) | new_n70_ | (~new_n98_ & (~new_n94_ | new_n101_));
  ...
  assign z19 = new_n70_ | (new_n91_ & (~new_n90_ | (x27 & (~new_n74_ | ~x29))));
  assign z20 = ~new_n90_ & (~x27 | ~x35) & ~new_n70_ & ~x09 & ~x30;
  assign z06 = new_n70_ | (~x37 & (~x27 | ~x28));
  assign z18 = new_n70_ | ~new_n91_ | (new_n90_ & (~x27 | (new_n74_ & x29)));
endmodule
