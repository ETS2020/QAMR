...
module FAU ( 
  ...
  assign z07 = (x32 & ~x38) | (new_n78_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  assign new_n78_ = x03 & (~x14 | (~x31 & ~x33 & (x15 | ~x17)));
  assign z08 = ~new_n68_ & x39 & x40;
  assign z09 = new_n68_ | (x11 & x26 & x27 & x34);
  assign z10 = (~new_n82_ & x27) | (z08 & ~new_n71_ & ~x04 & x05);
  assign new_n82_ = (new_n68_ | ~x06 | ~x37) & (~new_n83_ | new_n70_ | new_n68_ | x04);
  ...
  assign z13 = new_n91_ | (x27 & (new_n90_ | (~new_n92_ & new_n93_ & ~x32)));
  assign new_n90_ = ~new_n66_ & ~new_n68_ & x20 & ~x18 & ~x19;
  assign new_n91_ = ~x04 & ~x13 & ~new_n71_ & ~new_n68_ & x39 & x40;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = (~new_n95_ & (~x20 | x18 | x19)) | new_n96_ | new_n68_;
  assign new_n95_ = new_n93_ & (~new_n71_ | ~new_n92_);
  assign new_n96_ = (new_n66_ | ~x27) & (~new_n93_ | (new_n71_ & (~x27 | x28)));
