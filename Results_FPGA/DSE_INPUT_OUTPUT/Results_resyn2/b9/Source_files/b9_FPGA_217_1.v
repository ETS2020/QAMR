...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n73_, new_n74_,
    new_n80_, new_n83_, new_n84_, new_n86_, new_n87_, new_n88_, new_n91_,
    new_n92_, new_n93_;
  ...
  assign new_n84_ = x32 & (~x24 | (new_n67_ & x05));
  ...
  assign z13 = new_n93_ | (x27 & ((new_n91_ & (x24 | ~x32)) | (new_n92_ & ~x32)));
  assign new_n91_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n92_ = new_n73_ & ~x04 & ~x13 & (~x28 | (x35 & x36));
  assign new_n93_ = new_n73_ & ~x04 & ~x13 & (x30 | x32) & (x24 | ~x32);
