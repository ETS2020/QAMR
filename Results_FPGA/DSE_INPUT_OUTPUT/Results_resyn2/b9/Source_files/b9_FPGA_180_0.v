...
module FAU ( 
  ...
  assign z01 = (~x04 & (x25 | x32)) | (~new_n70_ & x25 & ~x30 & ~x32);
  ...
  assign z07 = (~x25 & ~x32) | (new_n78_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  ...
  assign z13 = (~new_n90_ & x27) | new_n68_ | (new_n83_ & ~x04 & ~x13);
  assign new_n90_ = (~new_n91_ | (x28 & (~x35 | ~x36))) & (~new_n92_ | (~x37 & (~x28 | ~x35)));
  assign new_n91_ = ~x04 & ~x13 & x39 & x40;
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n92_ & (new_n94_ | new_n95_)) | ((new_n66_ | ~x27) & (new_n94_ | new_n96_));
  assign new_n94_ = ~new_n68_ & ~new_n91_;
  assign new_n95_ = x25 & ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n96_ = x25 & ~x30 & ~x32 & (~x27 | x28);
