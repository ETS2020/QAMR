...
module FAU ( 
  ...
  assign new_n70_ = ~x30 & ((~x36 & (x28 | ~x35)) | ~x27 | x32);
  ...
  assign z13 = new_n99_ | (x27 & ((new_n95_ & new_n96_) | (~new_n97_ & new_n98_)));
  assign new_n95_ = x20 & ~x18 & ~x19;
  assign new_n96_ = (x30 | ~x32) & (x37 | (x28 & x35));
  assign new_n97_ = x28 & (~x35 | ~x36);
  assign new_n98_ = ~x32 & x39 & x40 & ~x04 & ~x13;
  assign new_n99_ = x30 & x39 & x40 & ~x04 & ~x13;
  assign z14 = (~new_n95_ & (~new_n101_ | (new_n97_ & ~x30))) | (~new_n102_ & ~x30) | (~new_n101_ & ~new_n103_);
  assign new_n101_ = x39 & x40 & ~x04 & ~x13;
  assign new_n102_ = x27 & ~x32 & (x37 | ~x28 | x35);
  ...
  assign z19 = new_n92_ & (~new_n90_ | new_n91_) & ~x30 & ~x32;
  assign z20 = ~x30 & (x32 | (~new_n90_ & ~x09 & (~x27 | ~x35)));
