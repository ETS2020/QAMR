...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n73_, new_n78_,
    new_n79_, new_n82_, new_n83_, new_n84_, new_n86_, new_n87_, new_n88_,
    new_n90_, new_n91_, new_n93_, new_n94_, new_n95_, new_n101_;
  ...
  assign new_n79_ = x03 & (x20 | x40);
  assign z09 = new_n65_ | (x27 & x34 & x11 & x26);
  assign z10 = new_n84_ | (x27 & (new_n83_ | (~new_n82_ & ~new_n70_ & ~x04)));
  assign new_n82_ = (x39 & x40) ? ~x05 : (~x07 | (~x20 & ~x40));
  assign new_n83_ = (x20 | x40) & x06 & x37;
  assign new_n84_ = x05 & (x30 | x32) & ~x04 & x39 & x40;
  assign z11 = new_n65_ | (new_n88_ & (~new_n87_ | (~new_n86_ & x27)));
  ...
  assign z18 = new_n65_ | ~new_n88_ | (new_n87_ & (new_n86_ | ~x27));
  assign z19 = (new_n65_ | (~new_n101_ & ~x09 & ~x30)) & (~new_n86_ | ~x08);
  assign new_n101_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign z20 = ~new_n87_ & (~x27 | ~x35) & ~new_n65_ & ~x09 & ~x30;
