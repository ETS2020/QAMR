...
module FAU ( 
  ...
  assign z10 = ~new_n84_ | (new_n83_ & ((z08 & ~new_n72_) | (new_n71_ & (z08 | x07))));
  ...
  assign z13 = new_n94_ | (x27 & ((new_n92_ & new_n93_) | (~new_n90_ & new_n91_)));
  assign new_n90_ = x28 & (~x35 | ~x36);
  assign new_n91_ = x39 & x40 & ~x04 & ~x13;
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign new_n93_ = (x37 | (x28 & x35)) & (x39 | x40);
  assign new_n94_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
  assign z14 = (new_n97_ & (~new_n91_ | (new_n72_ & ~new_n96_))) | (new_n98_ & (~new_n91_ | (new_n72_ & new_n90_)));
  assign new_n96_ = x27 & ~x28;
  assign new_n97_ = (x39 | x40) & (~x27 | (~x37 & (~x28 | ~x35)));
  assign new_n98_ = (x39 | x40) & (~x20 | x18 | x19);
  assign z15 = new_n70_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n70_ & ~x23;
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ((x39 | x40) & (new_n104_ | x09 | x30)) | (new_n103_ & x39 & x40);
  assign new_n103_ = x08 & x29;
  assign new_n104_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z20 = new_n70_ | (~new_n86_ & ~x09 & ~x30 & (~x27 | ~x35));
