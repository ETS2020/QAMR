...
module FAU ( 
  ...
  assign new_n82_ = new_n83_ & (new_n72_ | x07) & (~new_n72_ | (x05 & x20));
  assign new_n83_ = ~x04 & (x20 | x32) & (x36 | (~x28 & x35));
  assign new_n84_ = new_n67_ & x05 & (x32 | (x20 & x30));
  ...
  assign z13 = (x20 & (new_n91_ | (new_n93_ & x30))) | (new_n93_ & x32);
  assign new_n91_ = x27 & (new_n94_ | (~new_n92_ & new_n93_));
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x04 & ~x13 & x39 & x40;
  assign new_n94_ = ~x18 & ~x19 & (x37 | (x28 & x35));
  assign z14 = (~new_n91_ | (~x20 & (new_n92_ | ~new_n93_))) & (x20 | x32) & (~new_n93_ | (~x30 & ~x32));
