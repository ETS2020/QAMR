...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n72_,
    new_n74_, new_n75_, new_n83_, new_n84_, new_n86_, new_n87_, new_n90_,
  ...
  assign z07 = (~x38 | x00 | x25) & ~new_n70_ & x03 & ~x14;
  assign z08 = new_n74_ & ~new_n70_;
  assign z09 = new_n70_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n84_ | (new_n83_ & ((new_n74_ & ~new_n72_) | (new_n71_ & (new_n74_ | x07))));
  assign new_n83_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n84_ = (x31 | x33) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n70_ | (new_n87_ & (~new_n86_ | (x27 & (~new_n74_ | ~x29))));
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n87_ = ~x09 & ~x30 & (x04 | x28 | ~x27 | ~x35);
  assign z12 = ~new_n70_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z14 = (~x27 | (~new_n90_ & (new_n91_ | ~new_n92_))) & ~new_n70_ & ~new_n93_;
  ...
  assign z18 = new_n70_ | ~new_n87_ | (new_n86_ & (~x27 | (new_n74_ & x29)));
  assign z20 = ~new_n86_ & ~x09 & ~x30 & ~new_n70_ & (~x27 | ~x35);
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z13 = (x27 & (new_n90_ | (~new_n91_ & new_n92_))) | new_n70_ | new_n93_;
  assign z19 = new_n70_ | (new_n87_ & (~new_n86_ | (x27 & (~new_n74_ | ~x29))));
endmodule
