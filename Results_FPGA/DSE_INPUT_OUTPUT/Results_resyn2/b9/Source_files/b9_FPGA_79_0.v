...
module FAU ( 
  ...
  assign new_n73_ = x39 & x40 & (x30 | x32);
  assign z03 = (x27 & (~x28 | ~x35)) | (~x27 & ~x37) | new_n70_ | ~x21;
  ...
  assign z10 = ~new_n87_ | (~x04 & (new_n85_ | (new_n86_ & (new_n84_ | x36))));
  assign new_n84_ = ~x28 & x35;
  assign new_n85_ = x05 & x39 & x40;
  assign new_n86_ = x07 & x27 & (~x39 | ~x40);
  assign new_n87_ = (x30 | x32) & (~x37 | ~x06 | ~x27);
  assign z11 = (~x08 | (~new_n84_ & ~new_n89_) | (~new_n89_ & x27)) & new_n90_ & (~new_n84_ | x04 | ~x27);
  assign new_n89_ = x29 & x39 & x40;
  assign new_n90_ = x32 & ~x09 & ~x30;
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z14 = new_n93_ & (new_n65_ | x18 | x19 | ~x20 | ~x27);
  assign new_n93_ = (x30 | x32) & (x13 | x04 | ~x39 | ~x40);
  assign z15 = x27 & x34 & ~new_n70_ & x12 & x26;
  assign z16 = x01 & x22 & ~new_n70_ & ~x23;
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z20 = ~x30 & (~x32 | (~new_n98_ & ~x09 & (~x27 | ~x35)));
  assign new_n98_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z13 = ~new_n93_ | (~new_n65_ & ~x18 & ~x19 & x20 & x27);
  assign z18 = (x08 & (new_n84_ | new_n89_) & (new_n89_ | ~x27)) | ~new_n90_ | (new_n84_ & ~x04 & x27);
  assign z19 = (~x08 | (~new_n84_ & ~new_n89_) | (~new_n89_ & x27)) & new_n90_ & (~new_n84_ | x04 | ~x27);
endmodule
