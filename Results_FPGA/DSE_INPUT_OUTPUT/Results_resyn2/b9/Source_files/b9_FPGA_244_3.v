...
module FAU ( 
  ...
  assign z10 = new_n82_ | (new_n67_ & (x30 | x32) & x05 & (~x32 | ~x34));
  assign new_n82_ = x27 & ((~new_n83_ & new_n84_) | (x06 & ~new_n68_ & x37));
  assign new_n83_ = (~x07 | (x39 & x40) | (x32 & x34)) & (~x39 | ~x40 | ~x05 | x32);
