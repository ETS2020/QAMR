...
module FAU ( 
  ...
  assign z03 = (~x37 & (~x27 | ~x28 | ~x35)) | ((~x28 | ~x35) & x27 & x40) | (~x21 & (~x37 | x40));
  assign z04 = (x27 ? (~x28 | ~x35) : ~x40) | (~x37 & (~x27 | ~x28 | ~x35)) | x21 | (x37 & ~x40);
  assign z05 = ~new_n70_ & ~z06;
  assign z06 = ~x37 & (~x27 | ~x28);
  assign z07 = (new_n81_ | ~x14) & new_n82_ & ((x00 & ~x25) | ~x38 | (~x14 & x25));
  assign new_n81_ = (x15 | ~x17) & ~x31 & ~x33;
  assign new_n82_ = x03 & (~x37 | x40);
  assign z08 = x39 & x40;
  assign z09 = new_n70_ | (x11 & x26 & x27 & x34);
  assign z10 = new_n86_ | (new_n87_ & ((~new_n72_ & z08) | (new_n71_ & (z08 | x07))));
  assign new_n86_ = x37 & (~x40 | (x06 & x27));
  assign new_n87_ = ~x04 & (x05 | ~x39 | ~x40);
  assign z11 = new_n70_ | (new_n90_ & (~new_n89_ | (x27 & (~z08 | ~x29))));
  assign new_n89_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n90_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n92_ | new_n93_ | (~new_n94_ & (x04 | ~x39));
  assign new_n92_ = ~x10 & ((~x27 & x40) | (~x37 & ~x35 & ~x36));
  assign new_n93_ = ~x37 & ~x40 & (~x27 | ~x28 | ~x35);
  assign new_n94_ = (x37 | (x28 & x35)) & (x27 | ~x40);
  assign z13 = new_n99_ | (x27 & (new_n98_ | (~new_n96_ & new_n97_)) & (~new_n70_ | (~new_n96_ & new_n97_)));
  assign new_n96_ = x28 & (~x35 | ~x36);
  assign new_n97_ = ~x13 & x40 & ~x04 & x39;
  assign new_n98_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n99_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
  assign z14 = (~x27 | (~new_n98_ & (new_n96_ | ~new_n97_))) & ~new_n70_ & ~new_n99_;
  assign z15 = new_n70_ | (x12 & x26 & x27 & x34);
  assign z16 = x01 & x22 & ~new_n70_ & ~x23;
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z19 = ~new_n70_ & new_n90_ & (~new_n89_ | (x27 & (~z08 | ~x29)));
  assign z20 = new_n70_ | (~new_n89_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z18 = new_n70_ | ~new_n90_ | (new_n89_ & (~x27 | (z08 & x29)));
endmodule
