...
module FAU ( 
  ...
  assign new_n83_ = ((~new_n70_ & ~x32) | ~x05 | ~x39 | ~x40) & (~new_n70_ | ~x07 | (x39 & x40));
  assign new_n84_ = x30 & (x32 | (new_n67_ & x05));
  assign z11 = x30 ? x32 : new_n86_;
  assign new_n86_ = (~x08 | (~new_n73_ & ~new_n87_) | (~new_n87_ & x27)) & ~x09 & (~new_n73_ | x04 | ~x27);
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (x27 & (~x30 | ~x32) & (new_n90_ | (~new_n91_ & new_n92_ & ~x30))) | (new_n92_ & (x30 | x32) & (~x30 | ~x32));
  assign new_n90_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign z14 = ~new_n95_ | (~new_n94_ & (~x20 | x18 | x19));
  assign new_n94_ = new_n92_ & (~new_n91_ | x30 | x32);
  assign new_n95_ = (~x30 | ~x32) & ((~new_n66_ & x27) | (new_n92_ & (x30 | x32 | (x27 & ~x28))));
  assign z15 = x12 & ~new_n68_ & x27 & x26 & x34;
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z20 = x30 ? x32 : (new_n100_ & (~x08 | (~new_n73_ & ~new_n87_)));
  assign new_n100_ = ~x09 & (~x27 | ~x35);
  assign z18 = x30 ? ~x32 : ~new_n86_;
  assign z19 = x30 ? x32 : new_n86_;
endmodule
