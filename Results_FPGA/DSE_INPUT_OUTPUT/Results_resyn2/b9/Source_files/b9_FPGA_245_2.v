...
module FAU ( 
  ...
  assign new_n72_ = ((new_n74_ & (x08 | x27)) | new_n68_ | ~x04) & (new_n68_ | new_n73_);
  ...
  assign z11 = new_n86_ & (~new_n85_ | (x27 & (~new_n73_ | ~x29)));
  assign new_n85_ = x08 & (new_n74_ | (new_n73_ & x29));
  assign new_n86_ = (~new_n74_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  ...
  assign z06 = ~z05;
  assign z18 = ~new_n86_ | (new_n85_ & (~x27 | (new_n73_ & x29)));
  assign z19 = new_n86_ & (~new_n85_ | (x27 & (~new_n73_ | ~x29)));
endmodule
