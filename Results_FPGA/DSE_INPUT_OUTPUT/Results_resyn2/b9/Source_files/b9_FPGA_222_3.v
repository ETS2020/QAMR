...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n91_, new_n92_, new_n93_, new_n95_, new_n96_, new_n97_;
  ...
  assign new_n68_ = x21 & x32;
  assign z01 = (~x04 & (~x21 | ~x32)) | (~x30 & ~x32 & (new_n70_ | ~x27));
  ...
  assign z03 = ~x21 | (~x32 & (x27 | ~x37) & (~x35 | ~x27 | ~x28));
  assign z04 = x21 | ((x27 | ~x37) & (~x35 | ~x27 | ~x28));
  ...
  assign z10 = (~new_n82_ & x27) | (new_n84_ & ~new_n68_ & x05);
  assign new_n82_ = (~new_n83_ | new_n70_ | new_n68_ | x04) & (new_n68_ | ~x06 | ~x37);
  assign new_n83_ = (x39 & x40) ? (x05 & ~x32) : x07;
  assign new_n84_ = new_n67_ & (x30 | x32);
  assign z11 = new_n86_ & ~new_n68_;
  assign new_n86_ = new_n88_ & (~new_n87_ | (x27 & (~new_n72_ | ~x29)));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n88_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (~new_n91_ & x27) | new_n68_ | (new_n84_ & ~x13);
  assign new_n91_ = (~new_n92_ | (x28 & (~x35 | ~x36))) & (~new_n93_ | (~x37 & (~x28 | ~x35)));
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign z14 = new_n95_ | (~new_n68_ & (~new_n84_ | x13) & (new_n97_ | ~x27));
  assign new_n95_ = ~new_n93_ & (new_n96_ | (~new_n68_ & ~new_n92_));
  assign new_n96_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n97_ = new_n66_ & (~new_n92_ | x28);
