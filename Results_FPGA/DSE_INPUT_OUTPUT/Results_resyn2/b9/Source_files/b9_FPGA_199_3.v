...
module FAU ( 
  ...
  assign z07 = ~new_n80_ & x03 & ((x00 & ~x25) | ~x38 | (~x14 & x25));
  ...
  assign z19 = (~new_n108_ | new_n109_) & ~new_n110_ & new_n111_;
  assign new_n108_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n109_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n110_ = ~x04 & x27 & ~x28 & x35;
  assign new_n111_ = ~x09 & ~x30 & (~x31 | ~x40);
  assign z20 = new_n70_ | (~new_n108_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z18 = (new_n108_ & ~new_n109_) | new_n110_ | ~new_n111_;
endmodule
