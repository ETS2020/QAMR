...
module FAU ( 
  ...
  assign new_n67_ = (~x27 | (~x37 & (~x28 | ~x35))) & (x04 | ~x40);
  assign z01 = (~new_n69_ & new_n70_) | new_n65_ | ~x04;
  ...
  assign new_n79_ = x03 & (x39 | ~x40);
  assign z09 = new_n65_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n83_ | ((new_n82_ | (~new_n70_ & x40)) & ~x04 & (x05 | ~x40));
  assign new_n82_ = x27 & (x36 | (~x28 & x35)) & (x07 | x40);
  assign new_n83_ = (x39 | ~x40) & (~x37 | ~x06 | ~x27);
  ...
  assign z13 = new_n91_ | (~new_n65_ & x27 & (new_n89_ | new_n90_));
  assign new_n89_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n90_ = (~x28 | (x35 & x36)) & x40 & ~x04 & ~x13;
  assign new_n91_ = (x30 | x32) & x40 & x39 & ~x04 & ~x13;
  assign z14 = ~new_n93_ & (~x27 | (~new_n89_ & ~new_n90_));
  ...
  assign z20 = new_n65_ | (~new_n98_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign new_n98_ = x08 & ((~x28 & x35) | (x29 & x40));
  assign z18 = new_n85_ | ~new_n86_ | (~x28 & x35 & ~x04 & x27);
  assign z08 = x40;
  assign z19 = ~new_n85_ & new_n86_ & (x28 | ~x35 | x04 | ~x27);
endmodule
