...
module FAU ( 
  ...
  assign new_n73_ = ~new_n69_ & x39 & x40 & (x02 | (x08 & x29));
  ...
  assign new_n84_ = (~x07 | (x39 & x40) | (~x16 & x32)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n85_ = ~new_n71_ & ~new_n69_ & x39 & x40;
  ...
  assign z13 = (~new_n92_ & x27) | (new_n85_ & ~x04 & ~x13);
  assign new_n92_ = (~new_n93_ | new_n66_ | (~x16 & x32)) & (new_n94_ | ~new_n95_ | x32);
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = new_n97_ | (~new_n93_ & ((~new_n69_ & ~new_n95_) | (new_n71_ & new_n94_)));
  assign new_n97_ = (~new_n95_ | (new_n71_ & (~x27 | x28))) & ~new_n69_ & (new_n66_ | ~x27);
