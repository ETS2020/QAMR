...
module FAU ( 
  ...
  assign new_n81_ = (~x07 | x40) & (~x05 | ~x39 | ~x40);
  ...
  assign new_n95_ = x40 & (~x39 | (~x04 & ~x13));
  assign new_n96_ = x20 & ~x18 & ~x19 & (x35 | x37);
  assign new_n97_ = x39 & ~x30 & ~x32;
  ...
  assign z20 = new_n67_ | (~new_n86_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z18 = (~x39 & x40) | ~new_n87_ | (new_n86_ & (~x27 | (x29 & x40)));
  assign z08 = x40;
endmodule
