...
module FAU ( 
  ...
  assign z11 = new_n82_ & (~x08 | (~new_n71_ & (~x29 | ~x39)) | (x27 & (~x29 | ~x39)));
  assign new_n82_ = (~new_n71_ | x04 | ~x27) & ~new_n67_ & ~x09 & ~x30;
  assign z12 = ~new_n84_ & (new_n85_ | ~x39);
  assign new_n84_ = x27 & (x37 | (x28 & x35));
  assign new_n85_ = x40 & (x04 | (~x10 & (~x27 | (~x35 & ~x36))));
  assign z13 = new_n87_ | (new_n90_ & (x30 | x32));
  ...
  assign z14 = new_n93_ | (~new_n94_ & x40 & ~x30 & ~x32);
  assign new_n93_ = (~new_n84_ | ~new_n91_) & (~x39 | (x40 & (x04 | x13)));
  assign new_n94_ = x27 & (~new_n89_ | (new_n91_ & (x35 | x37)));
  assign z15 = new_n67_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n67_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n67_ & x23 & ~x24;
  assign z18 = ~new_n67_ & (~new_n99_ | (new_n71_ & (x08 | x27) & (~x04 | ~x27)));
  assign new_n99_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x39);
  assign z20 = new_n101_ & (~x08 | (~new_n71_ & (~x29 | ~x39)));
