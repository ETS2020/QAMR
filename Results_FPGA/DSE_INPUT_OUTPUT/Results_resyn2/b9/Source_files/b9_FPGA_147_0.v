// Benchmark "FAU" written by ABC on Tue Aug 11 21:46:24 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n71_, new_n72_, new_n73_,
    new_n78_, new_n82_, new_n84_, new_n87_, new_n93_;
  ...
  assign z02 = ~new_n68_ & (new_n71_ | ~new_n73_ | (~x02 & (~x08 | ~x29)));
  ...
  assign new_n82_ = (~new_n73_ | ~x05) & ((~new_n72_ & ~x36) | new_n73_ | ~x07 | ~x27);
  assign z11 = ~x30 & (~x32 | (new_n84_ & ~x09));
  assign new_n84_ = (~x08 | (~new_n72_ & (~new_n73_ | ~x29)) | (x27 & (~new_n73_ | ~x29))) & (~new_n72_ | x04 | ~x27);
  assign z12 = new_n65_ | new_n68_;
  assign z13 = ~new_n68_ & (new_n87_ | (new_n67_ & ~x13));
  assign new_n87_ = ~new_n66_ & x20 & x27 & ~x18 & ~x19;
  assign z15 = ~new_n68_ & x12 & x26 & x27 & x34;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z19 = new_n84_ & x32 & ~x09 & ~x30;
  assign z20 = new_n93_ & (~x08 | (~new_n72_ & (~new_n73_ | ~x29)));
  assign new_n93_ = x32 & ~x09 & ~x30 & (~x27 | ~x35);
  assign z06 = ~z05;
  assign z14 = new_n68_ | (~new_n87_ & (~new_n67_ | x13));
  assign z18 = x30 | (x32 & (~new_n84_ | x09));
endmodule
