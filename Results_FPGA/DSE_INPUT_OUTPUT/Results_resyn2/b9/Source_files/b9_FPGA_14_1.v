...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n73_, new_n74_,
    new_n79_, new_n80_, new_n83_, new_n85_, new_n86_, new_n89_, new_n90_,
  ...
  assign z07 = new_n79_ & (~x38 | (~x14 & x25) | (x00 & ~x25));
  assign new_n79_ = (new_n80_ | ~x14) & x03 & (~x33 | (~x14 & x26));
  assign new_n80_ = ~x31 & (x15 | ~x17);
  assign z09 = x11 & x26 & x27 & x34;
  assign z10 = ~new_n68_ & ((~new_n83_ & ~x04) | (x37 & x06 & x27));
  assign new_n83_ = (~new_n70_ | (new_n73_ ? ~x05 : ~x07)) & ((~x30 & ~x32) | ~new_n73_ | ~x05);
