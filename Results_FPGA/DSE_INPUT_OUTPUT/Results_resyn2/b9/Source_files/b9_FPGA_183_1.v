...
module FAU ( 
  ...
  assign new_n68_ = x16 & (x13 | ~x17);
  assign z01 = ~new_n70_ & (~x04 | (~new_n71_ & ~x30 & ~x32));
  assign new_n70_ = ~x13 & x17;
  ...
  assign z07 = ~new_n79_ & new_n80_ & ((x00 & ~x25) | ~x38 | (~x14 & x25));
  assign new_n79_ = x17 & (~x13 | (x14 & ~x15));
  assign new_n80_ = x03 & (~x14 | (~x31 & ~x33));
  assign z08 = new_n73_ | new_n70_;
  assign z09 = ~new_n70_ & x11 & x34 & x26 & x27;
  assign z10 = ~new_n86_ | (new_n85_ & (new_n84_ | (new_n71_ & (new_n73_ | x07))));
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign new_n85_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n86_ = (x13 | ~x17) & (~x37 | ~x06 | ~x27);
  assign z11 = ~new_n70_ & new_n89_ & (~new_n88_ | (x27 & (~new_n73_ | ~x29)));
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n89_ = (~x27 | x28 | x04 | ~x35) & ~x09 & ~x30;
  assign z12 = ~new_n70_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = (new_n84_ & new_n94_) | (x27 & ((new_n94_ & new_n95_) | (new_n92_ & new_n93_)));
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign new_n93_ = (x13 | ~x17) & (x37 | (x28 & x35));
  assign new_n94_ = ~x17 & ~x04 & ~x13;
  assign new_n95_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = (~new_n92_ & (new_n97_ | ~new_n98_)) | new_n70_ | (~new_n99_ & (~new_n98_ | new_n100_));
  ...
  assign z19 = new_n70_ | (new_n89_ & (~new_n88_ | (x27 & (~new_n73_ | ~x29))));
  assign z20 = ~new_n88_ & (~x27 | ~x35) & ~new_n70_ & ~x09 & ~x30;
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z18 = new_n70_ | ~new_n89_ | (new_n88_ & (~x27 | (new_n73_ & x29)));
endmodule
