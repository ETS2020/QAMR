...
module FAU ( 
  ...
  assign z01 = (~new_n70_ & ~x30 & ~x32) | ~x04 | (~x19 & x32);
  ...
  assign new_n82_ = new_n83_ & (~new_n73_ | (x05 & ~x32)) & (new_n73_ | x07);
  assign new_n83_ = (x36 | (~x28 & x35)) & ~x04 & (x19 | ~x32);
  assign new_n84_ = new_n67_ & x05 & (x30 | x32) & (x19 | ~x32);
  ...
  assign z13 = (~new_n91_ & x27) | (new_n93_ & (x30 | x32) & (x19 | ~x32));
  assign new_n91_ = (x32 | (~new_n94_ & (~new_n93_ | (~new_n92_ & x28)))) & (x28 | ~new_n93_ | ~x19);
  assign new_n92_ = x35 & x36;
  assign new_n93_ = ~x04 & ~x13 & x39 & x40;
  assign new_n94_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = ~new_n97_ | (new_n96_ & (new_n66_ | ~x27));
  assign new_n96_ = ~x32 & (~new_n93_ | (~x30 & (~x27 | x28)));
  assign new_n97_ = (~x32 | (new_n93_ & x19)) & ((new_n93_ & ~new_n98_) | (x20 & ~x18 & ~x19));
