...
module FAU ( 
  ...
  assign z01 = ~z17 & (~x04 | (~new_n71_ & new_n72_));
  assign z17 = x22 & x23;
  assign new_n71_ = x27 & (x36 | (~x28 & x35));
  assign new_n72_ = ~x30 & ~x32;
  assign z02 = ~z17 & (new_n75_ | ~new_n74_ | (~x02 & (~x08 | ~x29)));
  ...
  assign z14 = (~new_n97_ & (~new_n93_ | new_n98_)) | z17 | (~new_n99_ & (~new_n93_ | new_n100_));
  ...
  assign z20 = ~new_n89_ & (~x27 | ~x35) & ~z17 & ~x09 & ~x30;
