...
module FAU ( 
  ...
  assign new_n68_ = ~x03 & ~x32;
  assign z01 = (~x04 & (x03 | x32)) | (~new_n70_ & x03 & ~x30 & ~x32);
  ...
  assign z10 = new_n83_ | new_n68_ | (x37 & x06 & x27);
  assign new_n83_ = (new_n70_ | new_n84_) & (new_n72_ | x07) & ~x04 & (~new_n72_ | x05);
  assign new_n84_ = (x30 | x32) & x39 & x40;
  ...
  assign z13 = (~new_n91_ & x27) | new_n68_ | (new_n84_ & ~x04 & ~x13);
  assign new_n91_ = (~new_n92_ | (x28 & (~x35 | ~x36))) & (~new_n93_ | (~x37 & (~x28 | ~x35)));
  assign new_n92_ = ~x04 & ~x13 & x39 & x40;
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n93_ & (new_n95_ | new_n96_)) | ((new_n66_ | ~x27) & (new_n95_ | new_n97_));
  assign new_n95_ = ~new_n68_ & ~new_n92_;
  assign new_n96_ = x03 & ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n97_ = x03 & ~x30 & ~x32 & (~x27 | x28);
