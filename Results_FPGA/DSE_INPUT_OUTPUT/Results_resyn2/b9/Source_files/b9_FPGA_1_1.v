...
module FAU ( 
  ...
  assign z10 = (~new_n81_ & x27) | (new_n67_ & x05 & x30);
  assign new_n81_ = ~new_n83_ & (new_n82_ | x04 | (~new_n70_ & ~x36));
  assign new_n82_ = (~x07 | (x39 & x40) | (~x30 & x32)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n83_ = (x30 | ~x32) & x06 & x37;
  assign z11 = new_n86_ & (~new_n85_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n85_ = x08 & (new_n70_ | (x29 & x39 & x40));
  assign new_n86_ = (~new_n70_ | x04 | ~x27) & ~x32 & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (x27 & (new_n89_ | (new_n90_ & ~new_n91_))) | (~x30 & x32) | (new_n90_ & x30);
  assign new_n89_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n90_ = x39 & x40 & ~x04 & ~x13;
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign z14 = new_n93_ | new_n94_ | (~new_n90_ & (new_n66_ | ~x27));
  assign new_n93_ = (~x20 | x18 | x19) & (~new_n90_ | (new_n91_ & ~x30));
