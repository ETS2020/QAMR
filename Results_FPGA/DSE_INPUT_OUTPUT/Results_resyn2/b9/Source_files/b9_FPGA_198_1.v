...
module FAU ( 
  ...
  assign z02 = ~new_n68_ & (new_n73_ | new_n74_ | ~x39 | ~x40);
  ...
  assign new_n84_ = x32 & (~x26 | (new_n67_ & x05));
  ...
  assign new_n91_ = (~new_n92_ | new_n66_ | (~x26 & x32)) & (new_n93_ | ~new_n94_ | x32);
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = (~new_n92_ & ((new_n71_ & new_n93_) | (~new_n68_ & ~new_n94_))) | (~new_n96_ & ~new_n68_ & (new_n71_ | ~new_n94_));
