...
module FAU ( 
  ...
  assign new_n68_ = ~x13 & x32;
  assign z01 = (~x32 & ~new_n70_ & ~x30) | ~x04 | (~x13 & x32);
  ...
  assign new_n84_ = x32 & (~x13 | (new_n67_ & x05));
  ...
  assign z13 = new_n91_ | (~x13 & (x32 | (new_n67_ & ~new_n92_)));
  assign new_n91_ = ~new_n66_ & x27 & x20 & ~x18 & ~x19;
  assign new_n92_ = ~x30 & (~x27 | (x28 & (~x35 | ~x36)));
  assign z14 = new_n94_ | new_n68_ | (~new_n96_ & (~x20 | x18 | x19));
  assign new_n94_ = (new_n66_ | ~x27) & (~new_n95_ | (~x30 & (~x27 | x28)));
  assign new_n95_ = ~x13 & ~x04 & x39 & x40;
  assign new_n96_ = new_n95_ & (x30 | ~x28 | (x35 & x36));
