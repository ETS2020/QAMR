...
module FAU ( 
  ...
  assign new_n71_ = ~x30 & ~x32 & (~x27 | ~x36);
  ...
  assign z11 = new_n70_ | (~new_n91_ & ~x09 & ~x30 & (~new_n89_ | new_n90_));
  assign new_n89_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n90_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n91_ = ~x04 & x27 & ~x28 & x35;
  assign z12 = new_n93_ | new_n70_ | ((~new_n73_ | x04) & (new_n65_ | ~x27));
  assign new_n93_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = (x27 & (new_n95_ | new_n96_)) | new_n70_ | new_n97_;
  assign new_n95_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n96_ = ~x28 & x39 & x40 & ~x04 & ~x13;
  assign new_n97_ = (x30 | x32) & x39 & x40 & ~x04 & ~x13;
  assign z14 = (new_n99_ | ~x35) & ~new_n97_ & (~x27 | (~new_n96_ & ~new_n100_));
  assign new_n99_ = x32 & (~x27 | ~x28 | ~x20 | x18 | x19);
  assign new_n100_ = x37 & x20 & ~x18 & ~x19;
  assign z15 = new_n70_ | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~new_n70_ & ~x23;
  assign z17 = x01 & x22 & ~new_n70_ & x23 & ~x24;
  assign z18 = new_n105_ | (new_n89_ & ~new_n90_) | x09 | x30;
  assign new_n105_ = x35 & (~x32 | (~x28 & ~x04 & x27));
  assign z20 = (~x32 & x35) | (~new_n89_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z19 = new_n70_ | (~new_n91_ & ~x09 & ~x30 & (~new_n89_ | new_n90_));
endmodule
