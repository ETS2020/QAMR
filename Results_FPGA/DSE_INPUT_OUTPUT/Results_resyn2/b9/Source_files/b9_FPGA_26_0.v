...
module FAU ( 
  ...
  assign z02 = ~new_n70_ & (new_n73_ | ~new_n72_ | (~x02 & (~x08 | ~x29)));
  ...
  assign z07 = new_n70_ | (new_n78_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  assign new_n78_ = x03 & (~x14 | ((x15 | ~x17) & ~x31 & ~x33));
  assign z08 = new_n72_ & ~new_n70_;
  assign z09 = x11 & ~new_n70_ & x34 & x26 & x27;
  assign z10 = ~new_n70_ & (new_n85_ | (~x04 & (new_n82_ | (~new_n83_ & new_n84_))));
  assign new_n82_ = x05 & x39 & x40;
  assign new_n83_ = ~x36 & (x28 | ~x35);
  assign new_n84_ = x07 & x27 & (~x39 | ~x40);
  assign new_n85_ = x37 & x06 & x27;
  assign z11 = (~new_n87_ | new_n88_) & ~new_n89_ & x32 & ~x09 & ~x30;
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n88_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n89_ = x27 & x35 & ~x04 & ~x28;
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = ~new_n70_ & ((~x13 & new_n72_ & ~x04) | (~new_n65_ & new_n92_));
  ...
  assign z19 = ~x30 & (~x32 | ((~new_n87_ | new_n88_) & ~new_n89_ & ~x09));
  assign z20 = ~new_n87_ & (~x27 | ~x35) & x32 & ~x09 & ~x30;
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z14 = new_n70_ | ((x13 | ~new_n72_ | x04) & (new_n65_ | ~new_n92_));
  assign z18 = x30 | (x32 & ((new_n87_ & ~new_n88_) | new_n89_ | x09));
endmodule
