...
module FAU ( 
  ...
  assign new_n68_ = x16 & (x38 | x40);
  assign z01 = new_n71_ | new_n70_ | ~x04;
  assign new_n70_ = ~x38 & ~x40;
  ...
  assign z07 = (~x38 & ~x40) | (new_n79_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  ...
  assign new_n84_ = (x38 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n70_ | (new_n88_ & (~new_n87_ | (~new_n86_ & x27)));
  assign new_n86_ = x40 & x29 & x39;
  assign new_n87_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign new_n88_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = (~new_n91_ & new_n93_) | (x27 & ((new_n94_ & new_n95_) | (~new_n92_ & new_n93_)));
  assign new_n91_ = ~x30 & ~x32;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x13 & ~x04 & x39 & x40;
  assign new_n94_ = x20 & ~x18 & ~x19;
  assign new_n95_ = (x37 | (x28 & x35)) & (x38 | x40);
  assign z14 = (~new_n97_ & (~new_n93_ | new_n98_)) | new_n70_ | (~new_n94_ & (~new_n93_ | new_n99_));
  ...
  assign z19 = ~new_n70_ & new_n88_ & (~new_n87_ | (~new_n86_ & x27));
  assign z20 = ~new_n87_ & (~x27 | ~x35) & ~new_n70_ & ~x09 & ~x30;
  assign z18 = new_n70_ | ~new_n88_ | (new_n87_ & (new_n86_ | ~x27));
endmodule
