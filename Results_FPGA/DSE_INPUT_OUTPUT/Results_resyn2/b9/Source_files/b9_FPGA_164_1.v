...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    ...
    new_n89_, new_n92_, new_n93_, new_n94_, new_n95_;
  ...
  assign new_n73_ = x00 & (new_n74_ | ~x39 | (~x02 & (~x08 | ~x29)));
  ...
  assign z07 = (~x00 & x40) | (new_n79_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  ...
  assign new_n83_ = (~x40 | (x00 & (x05 | ~x39))) & new_n84_ & (x07 | (x39 & x40));
  assign new_n84_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n85_ = x40 & x05 & x39 & ~new_n71_ & x00 & ~x04;
  ...
  assign z14 = (new_n95_ | ~x40) & (new_n92_ | ~x27);
  assign new_n92_ = ~new_n93_ & (~new_n94_ | (x28 & (~x35 | ~x36)));
  assign new_n93_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n94_ = ~x04 & ~x13 & x39 & x40;
  assign new_n95_ = x00 & (x04 | x13 | new_n71_ | ~x39);
  ...
  assign z06 = ~z05;
  assign z13 = (~new_n95_ & x40) | (~new_n92_ & x27);
