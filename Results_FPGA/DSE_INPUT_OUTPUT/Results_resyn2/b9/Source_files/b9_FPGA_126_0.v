...
module FAU ( 
  ...
  assign z02 = x40 ? (new_n74_ | ~new_n75_) : x21;
  ...
  assign z10 = ~new_n86_ | (new_n85_ & ((~new_n72_ & z08) | (new_n71_ & (z08 | x07))));
  assign new_n85_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n86_ = (x21 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = ~new_n90_ & new_n91_ & (~new_n88_ | new_n89_);
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n89_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n90_ = ~x04 & x27 & ~x28 & x35;
  assign new_n91_ = (x21 | x40) & ~x09 & ~x30;
  assign z12 = (x40 & (new_n93_ | (~new_n94_ & (x04 | ~x39)))) | (~new_n94_ & x21 & ~x40);
  assign new_n93_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign new_n94_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n96_ | (~new_n97_ & new_n98_))) | new_n70_ | new_n99_;
  ...
  assign z14 = (new_n105_ & (new_n103_ | ~new_n104_)) | (new_n102_ & (~new_n98_ | new_n101_));
  assign new_n101_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n102_ = (~x20 | x18 | x19) & (x21 | x40);
  assign new_n103_ = ~x30 & ~x32 & (~x27 | x28);
  assign new_n104_ = ~x04 & ~x13 & x39 & x40;
  assign new_n105_ = (x21 | x40) & (~x27 | (~x37 & (~x28 | ~x35)));
  assign z15 = x12 & ~new_n70_ & x34 & x26 & x27;
  assign z16 = new_n70_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n70_ & x23 & ~x24;
  assign z18 = new_n111_ | (~new_n70_ & (new_n110_ | x09 | x30));
  assign new_n110_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign new_n111_ = x08 & x29 & x39 & x40;
  assign z20 = new_n70_ | (~new_n88_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z06 = new_n70_ | (~x37 & (~x27 | ~x28));
  assign z19 = ~new_n90_ & new_n91_ & (~new_n88_ | new_n89_);
endmodule
