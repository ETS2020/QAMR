...
module FAU ( 
  ...
  assign new_n65_ = x39 & x40 & ~x04 & x10;
  ...
  assign z13 = (~new_n87_ & new_n96_) | (x27 & ((new_n96_ & new_n97_) | (new_n94_ & new_n95_)));
  assign new_n94_ = x20 & ~x18 & ~x19;
  assign new_n95_ = x32 & (x37 | (x28 & x35));
  assign new_n96_ = ~x13 & x40 & ~x04 & x39;
  assign new_n97_ = x19 & (~x28 | (x35 & x36));
  assign z14 = (~new_n99_ & ~x32) | (~new_n96_ & (~new_n94_ | new_n66_ | ~x27));
  assign new_n99_ = x19 & (x30 | (x27 & (~x28 | (x35 & x36))));
