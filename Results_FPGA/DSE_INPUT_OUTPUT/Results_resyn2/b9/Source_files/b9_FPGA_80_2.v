...
module FAU ( 
  ...
  assign z13 = new_n88_ | (new_n91_ & (x30 | x32));
  assign new_n88_ = x27 & ((~new_n90_ & new_n91_) | (new_n92_ & ~new_n67_ & ~new_n89_));
  ...
  assign new_n94_ = (~new_n66_ | ~new_n92_) & (~x39 | ((x04 | x13) & x40));
