...
module FAU ( 
  ...
  assign z01 = (x13 | ~x32) & (~x04 | (~x32 & ~new_n70_ & ~x30));
  ...
  assign new_n83_ = x32 & (~x13 | (new_n67_ & x05));
  ...
  assign z13 = (~new_n90_ & x27) | (new_n67_ & ~x13 & x30 & ~x32);
  assign new_n90_ = (~new_n91_ | new_n66_ | (~x13 & x32)) & (~new_n67_ | x13 | new_n92_ | x32);
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign z14 = (~new_n91_ & (new_n94_ | x13)) | ((new_n95_ | x13) & (new_n66_ | ~x27));
  assign new_n94_ = ~x32 & (~new_n67_ | (new_n92_ & ~x30));
  assign new_n95_ = ~x32 & (~new_n67_ | (~x30 & (~x27 | x28)));
