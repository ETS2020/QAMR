...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n71_, new_n73_, new_n74_,
    new_n80_, new_n81_, new_n84_, new_n85_, new_n86_, new_n87_, new_n89_,
    new_n90_, new_n91_, new_n93_, new_n95_, new_n96_, new_n97_, new_n98_,
    new_n100_, new_n101_, new_n106_;
  assign z00 = ~new_n65_ & (~x16 | (new_n68_ & (new_n66_ | (z08 & ~x04))));
  ...
  assign z02 = x40 ? (new_n73_ | ~new_n74_) : ~x26;
  ...
  assign new_n81_ = x03 & (~x26 | x40);
  assign z09 = x11 & x26 & x40 & x27 & x34;
  assign z10 = new_n87_ | (x27 & (new_n86_ | (~new_n84_ & new_n85_)));
  assign new_n84_ = (x39 & x40) ? ~x05 : (~x07 | (x26 & ~x40));
  assign new_n85_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n86_ = (~x26 | x40) & x06 & x37;
  assign new_n87_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = new_n65_ | (new_n91_ & (~new_n90_ | (~new_n89_ & x27)));
  assign new_n89_ = x29 & x39 & x40;
  assign new_n90_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n91_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = (x40 & (new_n93_ | (~new_n66_ & (x04 | ~x39)))) | (~new_n66_ & ~x26 & ~x40);
  assign new_n93_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = (~new_n71_ & new_n96_) | (x27 & ((new_n97_ & new_n98_) | (~new_n95_ & new_n96_)));
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = ~x13 & ~x04 & x39 & x40;
  assign new_n97_ = x20 & ~x18 & ~x19;
  assign new_n98_ = (x37 | (x28 & x35)) & (~x26 | x40);
  assign z14 = ~new_n65_ & ((~new_n97_ & (~new_n96_ | new_n100_)) | (~new_n66_ & (~new_n96_ | new_n101_)));
  ...
  assign z19 = (new_n65_ | (~new_n106_ & ~x09 & ~x30)) & (~new_n89_ | ~x08);
  assign new_n106_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign z20 = ~new_n90_ & (~x27 | ~x35) & ~new_n65_ & ~x09 & ~x30;
  assign z18 = (~new_n65_ & (new_n106_ | x09 | x30)) | (new_n89_ & x08);
endmodule
