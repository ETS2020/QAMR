...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n78_,
    ...
    new_n92_, new_n93_;
  assign z00 = (~new_n65_ & (x19 | x40)) | (~x15 & ~new_n66_ & new_n67_ & x40);
  ...
  assign new_n82_ = (x39 & x40) ? ~x05 : (~x07 | (~x19 & ~x40));
  assign new_n83_ = (x19 | x40) & x06 & x37;
  assign new_n84_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = ~new_n69_ & new_n87_ & (~new_n86_ | (x27 & (~z08 | ~x29)));
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n87_ = (x28 | ~x35 | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = (new_n66_ | ~new_n67_ | ~x40) & ~new_n89_ & (x19 | x40);
  assign new_n89_ = x27 & (x37 | (x28 & x35));
  assign z13 = x40 & (new_n93_ | (x27 & (new_n91_ | new_n92_)));
  assign new_n91_ = (~x28 | (x35 & x36)) & ~x13 & ~x04 & x39;
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n93_ = (x30 | x32) & ~x13 & ~x04 & x39;
  assign z15 = new_n69_ | (x12 & x34 & x26 & x27);
  assign z16 = new_n69_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n69_ & x23 & ~x24;
  assign z19 = new_n69_ | (new_n87_ & (~new_n86_ | (x27 & (~z08 | ~x29))));
  assign z20 = new_n69_ | (~new_n86_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z14 = ~x40 | (~new_n93_ & (~x27 | (~new_n91_ & ~new_n92_)));
  assign z18 = new_n69_ | ~new_n87_ | (new_n86_ & (~x27 | (z08 & x29)));
endmodule
