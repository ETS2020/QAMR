...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n73_, new_n74_,
    new_n80_, new_n83_, new_n84_, new_n87_, new_n88_, new_n91_, new_n92_,
    new_n93_, new_n94_;
  ...
  assign z10 = new_n83_ | new_n84_ | (x37 & x06 & x27);
  assign new_n83_ = ~x04 & (((new_n70_ | x32) & new_n73_ & x05) | (new_n70_ & ~new_n73_ & x07));
  assign new_n84_ = x30 & (x32 | (new_n67_ & x05));
  assign z11 = ~z18 | new_n68_;
  assign z18 = ~new_n88_ | (new_n87_ & (~x27 | (new_n73_ & x29)));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n88_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = new_n91_ | (new_n73_ & (~x30 | ~x32) & (x30 | x32) & ~x04 & ~x13);
  assign new_n91_ = x27 & (~x30 | ~x32) & (new_n92_ | (new_n93_ & ~new_n94_ & ~x30));
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n93_ = x39 & x40 & ~x04 & ~x13;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign z14 = (~new_n92_ | ~x27) & ((~x30 & ~x32 & (new_n94_ | ~x27)) | (~new_n93_ & (~x30 | ~x32)));
