...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n74_, new_n80_, new_n84_, new_n86_, new_n89_, new_n90_, new_n91_,
    new_n96_, new_n98_;
  ...
  assign new_n86_ = ((new_n73_ & x29) | (new_n74_ & (~x04 | ~x27))) & (x08 | (new_n74_ & ~x04 & x27));
  assign z12 = new_n65_ & ~new_n68_;
  assign z14 = ~new_n89_ & ~new_n68_ & (~new_n90_ | (~x30 & ~x32));
  ...
  assign z16 = x01 & x22 & x08 & ~x23;
  assign z17 = x01 & x22 & x23 & ~x24;
  assign z18 = ~new_n96_ | ((x08 | x27) & new_n74_ & (~x04 | ~x27));
  assign new_n96_ = (~new_n73_ | ~x08 | ~x29) & (x08 | x23) & ~x09 & ~x30;
  assign z20 = (~x08 & ~x23) | (new_n98_ & (~x08 | (~new_n74_ & (~new_n73_ | ~x29))));
  assign new_n98_ = ~x09 & ~x30 & (~x27 | ~x35);
  assign z13 = new_n89_ | new_n68_ | (new_n90_ & (x30 | x32));
  assign z19 = new_n68_ | (~new_n86_ & ~x09 & ~x30);
endmodule
