...
module FAU ( 
  ...
  assign z01 = (~new_n70_ & ~x30 & ~x32) | ~x04 | (~x26 & x32);
  ...
  assign new_n83_ = x32 & (~x26 | (new_n67_ & x05));
  assign z11 = new_n85_ & ~new_n68_;
  assign new_n85_ = new_n87_ & (~new_n86_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n87_ = (x04 | x28 | ~x27 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = new_n91_ | (x27 & (new_n90_ | (~new_n93_ & new_n92_ & ~x32)));
  assign new_n90_ = x20 & ~x18 & ~x19 & ~new_n66_ & ~new_n68_;
  assign new_n91_ = new_n92_ & (x26 | ~x32) & (x30 | x32);
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign z14 = (~new_n91_ & ~new_n96_) | (~new_n95_ & (~x20 | x18 | x19));
  assign new_n95_ = new_n92_ & (~new_n93_ | x30 | x32);
  assign new_n96_ = ~new_n68_ & x27 & (~new_n66_ | (new_n92_ & ~x28));
