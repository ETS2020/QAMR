...
module FAU ( 
  ...
  assign new_n80_ = x03 & (x25 | (~x32 & (x00 | ~x38)));
  assign z08 = new_n68_ | (x39 & x40);
  assign z09 = new_n68_ | (x11 & x26 & x27 & x34);
  assign z10 = (~new_n84_ & ~x04) | new_n85_ | (x37 & x06 & x27);
  assign new_n84_ = ((~new_n70_ & ~x30) | ~x05 | ~x39 | ~x40) & (~new_n70_ | ~x07 | (x39 & x40));
  assign new_n85_ = x32 & (~x25 | (new_n67_ & x05));
  ...
  assign z13 = (~new_n92_ & x27) | ((new_n68_ | ~new_n71_) & (new_n68_ | new_n94_));
  assign new_n92_ = (new_n93_ | ~new_n94_) & (new_n66_ | ~new_n95_);
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = ~x04 & ~x13 & x39 & x40;
  assign new_n95_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n95_ & ((new_n71_ & new_n93_) | (~new_n68_ & ~new_n94_))) | (~new_n97_ & ((~new_n68_ & new_n71_) | (~new_n68_ & ~new_n94_)));
  assign new_n97_ = x27 & (~new_n66_ | (new_n94_ & ~x28));
