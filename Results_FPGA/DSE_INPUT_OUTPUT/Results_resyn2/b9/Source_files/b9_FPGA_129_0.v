...
module FAU ( 
  ...
  assign new_n68_ = ~x14 & ~x32;
  assign z01 = ~x04 | (~x32 & (~x14 | (~x30 & (new_n70_ | ~x27))));
  ...
  assign new_n78_ = ((x00 & ~x25) | ~x38 | (~x14 & x25)) & x03 & (x14 | x32);
  assign z08 = ~new_n68_ & new_n72_;
  assign z09 = x11 & ~new_n68_ & x27 & x26 & x34;
  assign z10 = new_n83_ | (~new_n68_ & x27 & (new_n82_ | (x06 & x37)));
  assign new_n82_ = ~new_n70_ & ~x04 & (~new_n72_ | (x05 & x14)) & (new_n72_ | x07);
  assign new_n83_ = new_n67_ & x05 & (x32 | (x14 & x30));
  ...
  assign z13 = new_n91_ | new_n68_ | (new_n90_ & ~new_n92_);
  assign new_n90_ = new_n72_ & ~x04 & ~x13;
  assign new_n91_ = x20 & ~x18 & ~x19 & ~new_n66_ & x27;
  assign new_n92_ = ~x30 & ~x32 & (~x27 | (x28 & (~x35 | ~x36)));
  assign z14 = (~new_n96_ & ~x32) | (~new_n91_ & (~new_n90_ | new_n94_));
  assign new_n94_ = new_n95_ & x28 & (~x35 | ~x36);
  assign new_n95_ = ~x30 & ~x32 & (~x20 | x18 | x19);
  assign new_n96_ = x14 & (x30 | (x27 & (x37 | ~x28 | x35)));
