...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n79_, new_n83_, new_n84_, new_n87_, new_n88_, new_n91_, new_n92_,
    new_n93_;
  ...
  assign z19 = new_n88_ & (~new_n87_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n88_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = (~x30 | ~x32) & ((new_n92_ & (new_n91_ | x30 | x32)) | (~new_n66_ & new_n93_));
  assign new_n91_ = x27 & (~x28 | (x35 & x36));
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = x20 & x27 & ~x18 & ~x19;
  assign z14 = (~x30 | ~x32) & (~new_n92_ | (~new_n91_ & ~x30 & ~x32)) & (new_n66_ | ~new_n93_);
