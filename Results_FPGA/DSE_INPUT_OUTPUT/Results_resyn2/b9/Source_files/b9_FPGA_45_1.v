...
module FAU ( 
  ...
  assign z04 = (x27 & (~x28 | ~x35)) | x21 | x32 | (~x27 & ~x37);
  ...
  assign z10 = (~new_n83_ & x27) | (new_n85_ & x05 & ~new_n68_ & ~x04);
  assign new_n83_ = (new_n84_ | new_n70_ | x04) & (new_n68_ | ~x06 | ~x37);
  assign new_n84_ = (~x07 | (~x21 & x32) | (x39 & x40)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n85_ = ~new_n71_ & x39 & x40;
  ...
  assign z13 = (~new_n92_ & x27) | (new_n85_ & ~new_n68_ & ~x04 & ~x13);
  assign new_n92_ = (~new_n93_ | new_n66_ | (~x21 & x32)) & (new_n94_ | ~new_n95_ | x32);
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = new_n97_ | (~new_n93_ & ((new_n71_ & new_n94_) | (~new_n68_ & ~new_n95_)));
  assign new_n97_ = (~new_n95_ | (new_n71_ & (~x27 | x28))) & ~new_n68_ & (new_n66_ | ~x27);
