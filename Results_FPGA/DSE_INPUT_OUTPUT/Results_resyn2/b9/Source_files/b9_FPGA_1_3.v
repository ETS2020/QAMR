...
module FAU ( 
  ...
  assign new_n86_ = x08 & (new_n70_ | (new_n73_ & x29));
  assign new_n87_ = (~new_n70_ | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (x30 & x32) | new_n90_ | (~x13 & new_n67_ & (x30 | x32));
  assign new_n90_ = x27 & (new_n92_ | (new_n91_ & (~x28 | (x35 & x36))));
  assign new_n91_ = ~x04 & ~x13 & x39 & x40;
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (x30 & x32) | (~new_n90_ & (x13 | ~new_n67_ | (~x30 & ~x32)));
  ...
  assign z05 = ~z06;
  assign z18 = ~new_n87_ | (new_n86_ & (~x27 | (new_n73_ & x29)));
