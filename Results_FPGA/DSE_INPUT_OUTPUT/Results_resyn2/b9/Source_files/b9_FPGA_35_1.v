...
module FAU ( 
  ...
  assign z11 = (~x39 & x40) | (new_n88_ & (~new_n87_ | (x27 & (~x29 | ~x40))));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x40));
  ...
  assign new_n96_ = (~x28 | (x35 & x36)) & x40 & ~x04 & ~x13;
  assign new_n97_ = x40 & (~x39 | ((x30 | x32) & ~x04 & ~x13));
  assign z15 = new_n68_ | (x12 & x34 & x26 & x27);
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z18 = (~x39 & x40) | ~new_n88_ | (new_n87_ & (~x27 | (x29 & x40)));
  assign z20 = new_n68_ | (~new_n87_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z19 = (~x39 & x40) | (new_n88_ & (~new_n87_ | (x27 & (~x29 | ~x40))));
endmodule
