...
module FAU ( 
  ...
  assign new_n68_ = ~x18 & ~x32;
  assign z01 = ~x04 | (~x32 & (~x18 | (~new_n70_ & ~x30)));
  ...
  assign z10 = new_n82_ | new_n68_ | (x37 & x06 & x27);
  assign new_n82_ = (new_n70_ | new_n83_) & (new_n72_ | x07) & ~x04 & (~new_n72_ | x05);
  ...
  assign z13 = new_n90_ | new_n68_ | (new_n83_ & ~x04 & ~x13);
  assign new_n90_ = x27 & (new_n92_ | (new_n91_ & (~x28 | (x35 & x36))));
  assign new_n91_ = ~x04 & ~x13 & x39 & x40;
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~new_n94_ & ~x32) | (~new_n91_ & (~new_n92_ | ~x27));
  assign new_n94_ = x18 & (x30 | (x27 & (~x28 | (x35 & x36))));
