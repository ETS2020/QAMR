...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x30 & (new_n70_ | ~x27 | x32));
  ...
  assign new_n84_ = (~x07 | (x39 & x40) | (~x30 & x32)) & (~x39 | ~x40 | ~x05 | x32);
  ...
  assign z13 = (x27 & ((new_n92_ & x30) | (~new_n90_ & ~x32))) | (new_n91_ & x30);
  assign new_n90_ = ~new_n92_ & (~new_n91_ | (x28 & (~x35 | ~x36)));
  assign new_n91_ = ~x04 & ~x13 & x39 & x40;
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (new_n90_ | ~x27) & (x30 | ~x32) & (~new_n91_ | ~x30);
  ...
  assign z20 = new_n99_ & (~x08 | ((x28 | ~x35) & (~new_n72_ | ~x29)));
  assign new_n99_ = (~x27 | ~x35) & ~x32 & ~x09 & ~x30;
