...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n73_, new_n74_,
    new_n80_, new_n83_, new_n85_, new_n86_, new_n87_, new_n90_, new_n91_,
  ...
  assign new_n83_ = ((~x32 & ~new_n70_ & ~x30) | ~new_n73_ | ~x05) & (~new_n70_ | new_n73_ | ~x07);
  ...
  assign z13 = (~new_n90_ & x27) | (new_n92_ & (x32 | (x24 & x30)));
  assign new_n90_ = (~new_n91_ | new_n66_ | (~x24 & ~x32)) & (~new_n92_ | new_n93_ | ~x24);
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = ~x13 & ~x04 & x39 & x40;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign z14 = new_n95_ | (~new_n97_ & ~x32);
  assign new_n95_ = (~new_n92_ | (new_n93_ & ~new_n91_ & ~x30 & ~x32)) & (~new_n91_ | ~new_n96_);
  assign new_n96_ = x27 & (x37 | (x28 & x35));
  assign new_n97_ = x24 & (x30 | (x27 & (x37 | ~x28 | x35)));
  assign z15 = new_n68_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = ~x24 & (~x32 | (x23 & x01 & x22));
