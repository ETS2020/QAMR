...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n71_, new_n72_, new_n78_,
    new_n82_, new_n83_, new_n85_, new_n86_, new_n89_, new_n95_;
  ...
  assign z02 = ~new_n68_ & (new_n72_ | ~new_n71_ | (~x02 & (~x08 | ~x29)));
  ...
  assign new_n85_ = x08 & ((~x28 & x35) | (new_n71_ & x29)) & (~x27 | (new_n71_ & x29));
  ...
  assign z20 = new_n95_ & (~x08 | ((x28 | ~x35) & (~new_n71_ | ~x29)));
  assign new_n95_ = (~x27 | ~x35) & x32 & ~x09 & ~x30;
