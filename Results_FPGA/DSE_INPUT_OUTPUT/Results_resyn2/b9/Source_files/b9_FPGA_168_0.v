...
module FAU ( 
  ...
  assign new_n83_ = (x39 & x40) ? ~x05 : (~x07 | (~x39 & ~x40));
  assign new_n84_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n85_ = x06 & x37 & (x39 | x40);
  assign new_n86_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = (new_n88_ | ~x08) & ~new_n89_ & ~new_n70_ & ~x09 & ~x30;
  assign new_n88_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
  ...
  assign new_n96_ = (x37 | (x28 & x35)) & (x39 | x40);
  ...
  assign z18 = ((x39 | x40) & (new_n106_ | x09 | x30)) | (new_n105_ & x39 & x40);
  assign new_n105_ = x08 & x29;
  assign new_n106_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z20 = new_n70_ | (~new_n108_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign new_n108_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z19 = (new_n88_ | ~x08) & ~new_n89_ & ~new_n70_ & ~x09 & ~x30;
endmodule
