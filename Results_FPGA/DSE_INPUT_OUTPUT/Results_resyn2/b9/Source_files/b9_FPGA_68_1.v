...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    ...
    new_n91_, new_n92_, new_n93_, new_n95_, new_n101_;
  ...
  assign z02 = ~new_n68_ & (~new_n74_ | (x04 & (~new_n73_ | (~x08 & ~x27))));
  ...
  assign new_n84_ = x30 & (~x29 | (new_n67_ & x05));
  assign z11 = x30 ? ~x29 : new_n86_;
  ...
  assign z13 = (~new_n90_ & x27) | (new_n93_ & ~new_n68_ & ~new_n71_);
  assign new_n90_ = (~new_n91_ | new_n66_ | (~x29 & x30)) & (new_n92_ | ~new_n93_ | x30);
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = new_n95_ | (~new_n91_ & ((~new_n68_ & ~new_n93_) | (new_n71_ & new_n92_)));
  assign new_n95_ = (~new_n93_ | (new_n71_ & (~x27 | x28))) & ~new_n68_ & (new_n66_ | ~x27);
  ...
  assign z20 = new_n68_ | (new_n101_ & (~x08 | (~new_n73_ & ~new_n87_)));
  assign new_n101_ = ~x09 & ~x30 & (~x27 | ~x35);
  assign z06 = ~z05;
  assign z18 = ~new_n86_ | x30;
endmodule
