...
module FAU ( 
  ...
  assign new_n84_ = (~x07 | (x39 & x40) | (x21 & ~x32)) & (~x39 | ~x40 | ~x05 | x21);
  assign new_n85_ = new_n67_ & (x32 | (~x21 & x30));
  ...
  assign z13 = (~new_n92_ & x27) | (new_n85_ & ~x13);
  assign new_n92_ = (~new_n94_ | ~new_n95_) & (~new_n93_ | ~x20 | x18 | x19);
  assign new_n93_ = (~x21 | x32) & (x37 | (x28 & x35));
  assign new_n94_ = ~x13 & ~x04 & x39 & x40;
  assign new_n95_ = ~x21 & (~x28 | (x35 & x36));
