...
module FAU ( 
  ...
  assign z10 = new_n85_ | (x27 & (new_n84_ | (~new_n82_ & new_n83_)));
  assign new_n82_ = (~x07 | x39) & (~x05 | ~x39 | ~x40);
  assign new_n83_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n84_ = x06 & x37 & (~x39 | x40);
  assign new_n85_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = (x39 & ~x40) | (new_n88_ & (~new_n87_ | (x27 & (~x29 | ~x39))));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39));
  assign new_n88_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = ~new_n65_ & (~x39 | (~new_n66_ & x40));
  assign z13 = (~new_n91_ & new_n94_) | (x27 & ((~new_n68_ & new_n92_) | (~new_n93_ & new_n94_)));
  assign new_n91_ = ~x30 & ~x32;
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = x39 & x40 & ~x04 & ~x13;
  assign z14 = ~new_n97_ & (~x27 | (~new_n92_ & ~new_n96_));
  assign new_n96_ = (~x28 | (x35 & x36)) & x39 & ~x04 & ~x13;
  assign new_n97_ = x39 & (~x40 | ((x30 | x32) & ~x04 & ~x13));
  assign z15 = new_n68_ | (x12 & x34 & x26 & x27);
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z18 = (x39 & ~x40) | ~new_n88_ | (new_n87_ & (~x27 | (x29 & x39)));
  assign z20 = new_n68_ | (~new_n87_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z19 = (x39 & ~x40) | (new_n88_ & (~new_n87_ | (x27 & (~x29 | ~x39))));
endmodule
