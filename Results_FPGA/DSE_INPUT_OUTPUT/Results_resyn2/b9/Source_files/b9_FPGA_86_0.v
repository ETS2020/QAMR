...
module FAU ( 
  ...
  assign z02 = (~x39 ^ ~x40) | (x40 & (new_n72_ | (~new_n73_ & ~x02)));
  ...
  assign z13 = ~new_n98_ | (x27 & ((new_n95_ & ~new_n96_) | (~new_n92_ & new_n97_)));
  ...
  assign z14 = ~new_n65_ & (new_n100_ | (~new_n66_ & ~new_n95_) | (~new_n97_ & (~new_n95_ | new_n101_)));
  ...
  assign z19 = ((~x39 & ~x40) | (~new_n106_ & ~x09 & ~x30)) & (~new_n73_ | ~x39 | ~x40);
