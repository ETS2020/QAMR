...
module FAU ( 
  ...
  assign z07 = ((x00 & ~x25) | ~x38 | (~x14 & x25)) & ~new_n80_ & x03;
  assign new_n80_ = (x14 | (x31 & x40)) & ((~x15 & x17) | x31 | x33);
  assign z08 = x40 & (x31 | x39);
  assign z09 = new_n69_ | (x27 & x34 & x11 & x26);
  assign z10 = (x27 & (new_n87_ | (new_n86_ & (new_n84_ | new_n85_)))) | (new_n85_ & new_n88_);
  assign new_n84_ = x07 & (~x40 | (~x31 & ~x39));
  assign new_n85_ = x05 & x40 & ~x31 & x39;
  assign new_n86_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n87_ = (~x31 | ~x40) & x06 & x37;
  assign new_n88_ = ~x04 & (x30 | x32);
  assign z11 = (~x08 | (~new_n70_ & ~new_n90_) | (~new_n90_ & x27)) & new_n91_ & (~new_n70_ | x04 | ~x27);
  assign new_n90_ = x40 & x29 & x39;
  assign new_n91_ = ~x09 & ~x30 & (~x31 | ~x40);
  assign z12 = (~x31 & (new_n94_ | (~new_n93_ & (x04 | ~x39)))) | (~new_n93_ & ~x40);
  assign new_n93_ = x27 & (x37 | (x28 & x35));
  assign new_n94_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = (~new_n99_ & x40) | (x27 & (new_n98_ | (~new_n96_ & new_n97_)));
  assign new_n96_ = x28 & (~x35 | ~x36);
  assign new_n97_ = x40 & ~x13 & ~x04 & x39;
  assign new_n98_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n99_ = ~x31 & ((~x30 & ~x32) | x13 | x04 | ~x39);
  assign z14 = new_n69_ | ((~x27 | (~new_n98_ & (new_n96_ | ~new_n97_))) & (new_n71_ | ~new_n97_));
