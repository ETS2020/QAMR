...
module FAU ( 
  ...
  assign z11 = new_n90_ & (~new_n88_ | new_n89_) & ~x30 & ~x32;
  ...
  assign z13 = (new_n93_ | x27) & ((~new_n94_ & new_n95_) | new_n93_ | (new_n96_ & new_n97_));
  assign new_n93_ = x30 & x39 & x40 & ~x04 & ~x13;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = ~x32 & x39 & x40 & ~x04 & ~x13;
  assign new_n96_ = x20 & ~x18 & ~x19;
  assign new_n97_ = (x30 | ~x32) & (x37 | (x28 & x35));
  assign z14 = (~new_n96_ & (~new_n99_ | new_n101_)) | new_n102_ | new_n100_ | (new_n65_ & ~new_n99_);
  assign new_n99_ = x39 & x40 & ~x04 & ~x13;
  assign new_n100_ = ~x27 & (~x30 | ~x39 | ~x40 | x04 | x13);
  assign new_n101_ = ~x30 & x28 & (~x35 | ~x36);
  assign new_n102_ = ~x30 & (x32 | (~x37 & x28 & ~x35));
