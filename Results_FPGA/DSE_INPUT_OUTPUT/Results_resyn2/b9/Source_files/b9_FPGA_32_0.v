...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n72_,
    new_n74_, new_n80_, new_n83_, new_n84_, new_n86_, new_n87_, new_n88_,
  ...
  assign z10 = ~new_n84_ | (new_n83_ & ((~new_n72_ & z08) | (new_n71_ & (z08 | x07))));
  assign new_n83_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n84_ = (x39 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n70_ | (new_n89_ & (new_n86_ | new_n87_ | new_n88_));
  assign new_n86_ = ~x08 & (~x27 | x04 | x28 | ~x35);
  ...
  assign z13 = new_n96_ | (x27 & ((new_n94_ & new_n95_) | (~new_n92_ & new_n93_)));
  ...
  assign z14 = (~new_n94_ & (~new_n93_ | new_n98_)) | new_n70_ | (~new_n99_ & (~new_n93_ | new_n100_));
  ...
  assign z18 = ((~new_n89_ | new_n105_) & (x39 | x40)) | (x39 & x40 & x08 & x29);
  assign new_n105_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z19 = ~new_n70_ & new_n89_ & (new_n107_ | new_n87_ | new_n88_);
  assign new_n107_ = ~x08 & (~x27 | (x39 & (x04 | x28 | ~x35)));
  assign z20 = new_n70_ | ((new_n87_ | ~x08) & new_n89_ & (~x27 | ~x35));
