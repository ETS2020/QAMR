...
module FAU ( 
  ...
  assign new_n68_ = x16 & (x34 | x40);
  assign z01 = ~new_n70_ & (new_n71_ | ~x04);
  assign new_n70_ = ~x34 & ~x40;
  ...
  assign new_n80_ = x03 & (x34 | x40);
  assign z08 = x40 ? x39 : ~x34;
  assign z09 = x11 & x26 & x27 & x34;
  assign z10 = new_n87_ | (x27 & (new_n86_ | (~new_n84_ & new_n85_)));
  assign new_n84_ = (~x05 | ~x39 | ~x40) & (~x07 | (x39 & x40) | (~x34 & ~x40));
  assign new_n85_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n86_ = (x34 | x40) & x06 & x37;
  ...
  assign new_n92_ = ~x09 & ~x30 & (x34 | x40);
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = new_n70_ | (~new_n95_ & new_n96_) | (x27 & (new_n98_ | (new_n96_ & ~new_n97_)));
  assign new_n95_ = ~x30 & ~x32;
  assign new_n96_ = ~x13 & ~x04 & x39 & x40;
  assign new_n97_ = x28 & (~x35 | ~x36);
  assign new_n98_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (new_n101_ & (~new_n96_ | (new_n95_ & ~new_n100_))) | (new_n102_ & (~new_n96_ | (new_n95_ & new_n97_)));
  assign new_n100_ = x27 & ~x28;
  assign new_n101_ = (x34 | x40) & (~x27 | (~x37 & (~x28 | ~x35)));
  assign new_n102_ = (~x20 | x18 | x19) & (x34 | x40);
  assign z15 = (x12 & x26 & x27 & x34) | (~x34 & ~x40);
