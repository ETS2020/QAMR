...
module FAU ( 
  ...
  assign z01 = (~new_n70_ & ~x30 & ~x32) | ~x04 | (~x12 & x32);
  ...
  assign new_n83_ = x32 & (~x12 | (new_n67_ & x05));
  ...
  assign z13 = (x27 & ((new_n90_ & (x12 | ~x32)) | (new_n91_ & ~x32))) | (new_n93_ & (x12 | ~x32));
  ...
  assign z14 = ~new_n93_ & ~new_n68_ & (~x27 | (~new_n90_ & ~new_n91_));
