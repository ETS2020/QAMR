...
module FAU ( 
  ...
  assign new_n76_ = x03 & (~x14 | (~x31 & ~x33 & (x15 | ~x17)));
  assign z08 = x39 & x40;
  ...
  assign z12 = new_n68_ | (~new_n89_ & (~x27 | (new_n87_ & ~new_n88_)));
  assign new_n87_ = ~x37 & (~x28 | ~x35);
  assign new_n88_ = (x35 | x36) & ~x04 & x39 & x40;
  assign new_n89_ = x10 & ~x04 & x39 & x40;
  assign z13 = ~new_n94_ | (x27 & ((~new_n91_ & new_n92_) | (~new_n87_ & new_n93_)));
  ...
  assign z14 = ~new_n68_ & ((~new_n93_ & (~new_n92_ | new_n97_)) | (~new_n96_ & (~new_n92_ | new_n98_)));
