...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x30 & ((~new_n70_ & ~x36) | ~x27 | x32));
  ...
  assign new_n86_ = (x30 | ~x32) & x06 & x37;
  assign new_n87_ = ~x04 & x39 & x40 & x05 & x30;
  assign z11 = ~x30 & (x32 | (new_n91_ & (~new_n90_ | (~new_n89_ & x27))));
  ...
  assign z13 = new_n98_ | (x27 & ((new_n94_ & new_n95_) | (~new_n96_ & new_n97_)));
  ...
  assign new_n98_ = x30 & x39 & x40 & ~x04 & ~x13;
  assign z14 = (~new_n94_ & (~new_n100_ | (new_n96_ & ~x30))) | (~new_n101_ & ~x30) | (~new_n100_ & ~new_n102_);
  assign new_n100_ = x39 & x40 & ~x04 & ~x13;
  assign new_n101_ = x27 & ~x32 & (x37 | ~x28 | x35);
  ...
  assign z19 = (~x08 | (~new_n70_ & ~new_n89_) | (~new_n89_ & x27)) & new_n107_ & (~new_n70_ | x04 | ~x27);
  assign new_n107_ = ~x32 & ~x09 & ~x30;
  assign z20 = ~new_n90_ & new_n107_ & (~x27 | ~x35);
  assign z18 = x30 | (~x32 & (~new_n91_ | (new_n90_ & (new_n89_ | ~x27))));
endmodule
