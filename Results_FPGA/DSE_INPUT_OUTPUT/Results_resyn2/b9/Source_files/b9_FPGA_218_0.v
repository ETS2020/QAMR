...
module FAU ( 
  ...
  assign z10 = ~new_n88_ | (~x04 & ((new_n86_ & (new_n70_ | ~new_n85_)) | (new_n70_ & new_n87_)));
  ...
  assign new_n91_ = (x04 | x28 | ~x27 | ~x35) & ~x09 & ~x30;
  assign z12 = ~new_n73_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = new_n94_ | (~new_n65_ & new_n95_);
  assign new_n94_ = ~x13 & (~x32 | (~x04 & x39 & x40));
  assign new_n95_ = x20 & x27 & ~x18 & ~x19;
  assign z14 = (~x13 & ~x32) | ((new_n65_ | ~new_n95_) & (x13 | ~new_n72_ | x04));
