...
module FAU ( 
  ...
  assign z10 = (new_n67_ & x05 & x30) | (~new_n81_ & x27 & (x30 | ~x32));
  assign new_n81_ = (~x06 | ~x37) & (~new_n82_ | x04 | (~new_n70_ & ~x36));
  assign new_n82_ = (x39 & x40) ? (x05 & ~x32) : x07;
  assign z11 = new_n85_ & (~new_n84_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n84_ = x08 & (new_n70_ | (x29 & x39 & x40));
  assign new_n85_ = (~new_n70_ | x04 | ~x27) & ~x32 & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = (x27 & (new_n88_ | (new_n89_ & ~new_n90_))) | (~x30 & x32) | (new_n89_ & x30);
  ...
  assign new_n92_ = (~x20 | x18 | x19) & (~new_n89_ | (new_n90_ & ~x30));
  assign new_n93_ = ~x30 & (~x27 | x32 | (~x37 & x28 & ~x35));
