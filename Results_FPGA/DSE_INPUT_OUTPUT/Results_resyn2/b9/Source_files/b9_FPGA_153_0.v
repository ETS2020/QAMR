...
module FAU ( 
  ...
  assign z10 = ~new_n84_ | (~x04 & (new_n81_ | (~new_n82_ & new_n83_)));
  assign new_n81_ = x05 & x39 & x40;
  assign new_n82_ = ~x36 & (x28 | ~x35);
  assign new_n83_ = x07 & x27 & (~x39 | ~x40);
  ...
  assign z14 = new_n91_ & (new_n65_ | x18 | x19 | ~x20 | ~x27);
  assign new_n91_ = (x30 | x32) & (x13 | x04 | ~x39 | ~x40);
  assign z15 = new_n70_ | (x27 & x34 & x12 & x26);
  assign z16 = new_n70_ | (~x23 & x01 & x22);
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z19 = ~x30 & (~x32 | (new_n97_ & (~new_n96_ | (~new_n87_ & x27))));
  assign new_n96_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n97_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~new_n96_ & (~x27 | ~x35) & x32 & ~x09 & ~x30;
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z13 = ~new_n91_ | (~new_n65_ & ~x18 & ~x19 & x20 & x27);
  assign z18 = x30 | (x32 & (~new_n97_ | (new_n96_ & (new_n87_ | ~x27))));
endmodule
