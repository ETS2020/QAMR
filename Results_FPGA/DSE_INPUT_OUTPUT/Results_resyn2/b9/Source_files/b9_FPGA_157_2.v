...
module FAU ( 
  ...
  assign z13 = (new_n92_ & x32) | (x27 & ((~x30 & new_n92_ & ~new_n93_) | (new_n94_ & (~x30 | x32))));
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = new_n96_ & (~x27 | (~new_n94_ & (~new_n92_ | new_n93_)));
  ...
  assign z18 = ~new_n89_ | (new_n88_ & (~x27 | (new_n72_ & x29)));
