...
module FAU ( 
  ...
  assign z14 = (~x27 | (~new_n92_ & (~new_n91_ | new_n93_))) & (x30 | ~x32) & (~new_n91_ | ~x30);
  ...
  assign z13 = (x27 & (new_n92_ | (new_n91_ & ~new_n93_))) | (~x30 & x32) | (new_n91_ & x30);
  assign z19 = new_n87_ & ~x30 & ~x32;
endmodule
