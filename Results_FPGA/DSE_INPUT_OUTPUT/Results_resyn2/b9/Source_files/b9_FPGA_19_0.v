...
module FAU ( 
  ...
  assign new_n85_ = (~x05 | ~x39 | ~x40) & (~x07 | (x39 & x40) | (~x21 & ~x40));
  assign new_n86_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n87_ = (x21 | x40) & x06 & x37;
  assign new_n88_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = (~x08 | (~new_n71_ & ~new_n90_) | (~new_n90_ & x27)) & new_n91_ & (~new_n71_ | x04 | ~x27);
  assign new_n90_ = x29 & x39 & x40;
  assign new_n91_ = ~x09 & ~x30 & (x21 | x40);
  assign z12 = ~new_n70_ & ~new_n67_ & (~x27 | (~new_n65_ & new_n66_));
  assign z13 = (x27 & (new_n96_ | (new_n94_ & ~new_n95_))) | new_n70_ | (~new_n72_ & new_n94_);
  assign new_n94_ = ~x04 & ~x13 & x39 & x40;
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~new_n98_ & (~new_n94_ | new_n99_)) | new_n70_ | (~new_n100_ & (~new_n94_ | new_n101_));
  ...
  assign z19 = (new_n70_ | (~new_n106_ & ~x09 & ~x30)) & (~new_n90_ | ~x08);
  assign new_n106_ = (~x04 | ~x27) & (x08 | x27) & ~x28 & x35;
  assign z20 = ~new_n108_ & new_n91_ & (~x27 | ~x35);
  assign new_n108_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z18 = (x08 & (new_n71_ | new_n90_) & (new_n90_ | ~x27)) | ~new_n91_ | (new_n71_ & ~x04 & x27);
endmodule
