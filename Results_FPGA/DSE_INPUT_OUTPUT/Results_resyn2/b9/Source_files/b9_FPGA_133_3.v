...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x30 | ~x32)) | ((~x27 | (~new_n70_ & ~x36)) & ~x30 & ~x32);
  assign new_n70_ = ~x28 & x35;
  assign z02 = ~new_n68_ & (~new_n72_ | (x04 & (~new_n70_ | (~x08 & ~x27))));
  ...
  assign z10 = (~new_n82_ & x27) | (new_n67_ & (x30 | x32) & x05 & (~x30 | ~x32));
  assign new_n82_ = ~new_n84_ & (new_n83_ | x04 | (~new_n70_ & ~x36));
  assign new_n83_ = (~x07 | (x30 & x32) | (x39 & x40)) & (~x39 | ~x40 | ~x05 | x30);
  assign new_n84_ = (~x30 | ~x32) & x06 & x37;
  assign z11 = new_n86_ & ~x30;
  assign new_n86_ = (~x08 | (~new_n70_ & ~new_n87_) | (~new_n87_ & x27)) & ~x09 & (~new_n70_ | x04 | ~x27);
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = (x27 & (new_n90_ | (~new_n91_ & new_n92_))) | ((x30 | x32) & (new_n92_ | (x30 & x32)));
  assign new_n90_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign z14 = ((~x30 & ~x32) | (~new_n92_ & (~x30 | ~x32))) & (~x27 | (~new_n90_ & (new_n91_ | (~new_n92_ & (~x30 | ~x32)))));
  ...
  assign z20 = x30 ? x32 : (new_n99_ & (~x08 | (~new_n70_ & ~new_n87_)));
  assign new_n99_ = ~x09 & (~x27 | ~x35);
