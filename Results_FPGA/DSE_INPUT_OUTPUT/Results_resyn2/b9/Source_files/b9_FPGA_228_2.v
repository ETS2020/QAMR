...
module FAU ( 
  ...
  assign z06 = (new_n73_ | ~x37) & (new_n73_ | ~x27 | ~x28);
  assign z07 = (new_n79_ | ~x14) & new_n80_ & ((x00 & ~x25) | ~x38 | (~x14 & x25));
  assign new_n79_ = (x15 | ~x17) & ~x31 & ~x33;
  assign new_n80_ = x03 & (~x07 | x32);
  assign z08 = new_n72_ & ~new_n73_;
  assign z09 = new_n73_ | (x27 & x34 & x11 & x26);
  assign z10 = (~new_n87_ & new_n88_) | (x27 & (new_n84_ | (new_n85_ & new_n86_)));
  assign new_n84_ = x06 & x37 & (~x07 | x32);
  assign new_n85_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n86_ = (x39 & x40) ? (x05 & ~x07) : (x07 & x32);
  assign new_n87_ = ~x32 & (x07 | ~x30);
  ...
  assign new_n91_ = ~x09 & ~x30 & (~x27 | ~x35 | x04 | x28);
  ...
  assign z20 = ~new_n90_ & (~x27 | ~x35) & ~new_n73_ & ~x09 & ~x30;
  assign z05 = (~new_n73_ & x37) | (~new_n73_ & x27 & x28);
