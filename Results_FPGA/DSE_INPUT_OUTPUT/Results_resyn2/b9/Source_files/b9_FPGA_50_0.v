// Benchmark "FAU" written by ABC on Tue Aug 11 21:45:48 2020
...
module FAU ( 
  ...
  assign new_n68_ = x16 & (x13 | x23);
  assign z01 = ~new_n70_ & (~x04 | (~new_n71_ & ~x30 & ~x32));
  assign new_n70_ = ~x13 & ~x23;
  assign new_n71_ = x27 & (x36 | (~x28 & x35));
  assign z02 = new_n74_ | ~new_n73_ | new_n70_ | (~x02 & (~x08 | ~x29));
  ...
  assign z09 = x34 & x26 & x27 & ~new_n70_ & x11;
  assign z10 = ~new_n70_ & (new_n85_ | (~x04 & (new_n84_ | (new_n71_ & ~new_n83_))));
  assign new_n83_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n84_ = (x30 | x32) & x05 & x39 & x40;
  assign new_n85_ = x37 & x06 & x27;
  assign z11 = new_n70_ | (new_n88_ & (~new_n87_ | (x27 & (~new_n73_ | ~x29))));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n88_ = (~x27 | x28 | x04 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = (~new_n94_ & ~x13) | (x27 & (new_n93_ | (~new_n91_ & new_n92_)));
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = ~x13 & ~x04 & x39 & x40;
  assign new_n93_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n94_ = x23 & (x04 | ~x39 | ~x40 | (~x30 & ~x32));
  ...
  assign z16 = ~x23 & (~x13 | (x01 & x22));
  assign z17 = (~x13 & ~x23) | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n70_ | ~new_n88_ | (new_n87_ & (~x27 | (new_n73_ & x29)));
  assign z20 = ~new_n87_ & (~x27 | ~x35) & ~new_n70_ & ~x09 & ~x30;
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z19 = new_n70_ | (new_n88_ & (~new_n87_ | (x27 & (~new_n73_ | ~x29))));
endmodule
