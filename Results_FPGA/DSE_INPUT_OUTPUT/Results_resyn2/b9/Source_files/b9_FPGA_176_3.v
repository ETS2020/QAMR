...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n79_, new_n83_, new_n84_, new_n85_, new_n88_, new_n89_, new_n92_,
    new_n93_, new_n94_;
  ...
  assign z10 = new_n85_ | (~new_n68_ & x27 & (new_n83_ | (x06 & x37)));
  assign new_n83_ = new_n84_ & ~x04 & (new_n70_ | x36);
  assign new_n84_ = (x39 & x40) ? (x05 & ~x30) : x07;
  assign new_n85_ = (x30 | x32) & new_n73_ & (~x30 | ~x32) & ~x04 & x05;
  ...
  assign z13 = (new_n94_ | ((new_n92_ | new_n93_) & x27 & (~x30 | ~x32))) & (new_n94_ | new_n92_ | ~x30);
  assign new_n92_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n93_ = (~x28 | (x35 & x36)) & new_n73_ & ~x04 & ~x13;
  assign new_n94_ = (x30 | x32) & new_n73_ & (~x30 | ~x32) & ~x04 & ~x13;
  assign z14 = ~new_n94_ & (new_n68_ | ~x27 | (~new_n92_ & ~new_n93_));
