...
module FAU ( 
  ...
  assign new_n83_ = (~new_n73_ | (x05 & (new_n70_ | x30))) & ~x04 & (new_n73_ | (new_n70_ & x07));
  assign z11 = ~new_n85_ & ~new_n86_ & ~x32 & ~x09 & ~x30;
  assign new_n85_ = x08 & ((~x28 & x35) | (new_n73_ & x29)) & (~x27 | (new_n73_ & x29));
  assign new_n86_ = ~x04 & x27 & ~x28 & x35;
  assign z12 = new_n65_ & ~new_n68_;
  assign z14 = (~x27 | (~new_n90_ & (~new_n89_ | new_n91_))) & (~new_n89_ | ~x30) & (x30 | ~x32);
  assign new_n89_ = new_n73_ & ~x04 & ~x13;
  ...
  assign z18 = x30 | (~x32 & (new_n85_ | new_n86_ | x09));
  assign z20 = new_n97_ & (~x08 | ((x28 | ~x35) & (~new_n73_ | ~x29)));
  assign new_n97_ = (~x27 | ~x35) & ~x32 & ~x09 & ~x30;
  assign z13 = (x27 & (new_n90_ | (new_n89_ & ~new_n91_))) | (new_n89_ & x30) | (~x30 & x32);
  assign z19 = ~new_n85_ & ~new_n86_ & ~x32 & ~x09 & ~x30;
endmodule
