...
module FAU ( 
  ...
  assign new_n84_ = (~x05 | ~x39 | ~x40) & (~x07 | (x39 & x40) | (~x39 & ~x40));
  ...
  assign new_n89_ = (~x27 | ~x35 | x04 | x28) & ~x09 & ~x30;
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = new_n95_ | (x27 & ((~new_n70_ & new_n94_) | (~new_n92_ & new_n93_)));
  ...
  assign z19 = (~x39 & ~x40) | (new_n89_ & (~new_n88_ | (x27 & (~x29 | ~x39 | ~x40))));
  assign z20 = new_n70_ | (~new_n88_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z18 = (~x39 & ~x40) | ~new_n89_ | (new_n88_ & (~x27 | (x29 & x39 & x40)));
endmodule
