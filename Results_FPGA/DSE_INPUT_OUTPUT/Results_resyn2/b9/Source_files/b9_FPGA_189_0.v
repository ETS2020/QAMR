...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x32 & (~x17 | (~new_n70_ & ~x30)));
  ...
  assign new_n84_ = ((new_n73_ & ~new_n85_) | (new_n70_ & (new_n73_ | x07))) & ~x04 & (~new_n73_ | x05);
  ...
  assign z14 = (new_n91_ | ~x27) & ~new_n68_ & (new_n85_ | ~new_n92_);
  ...
  assign z13 = (~new_n91_ & x27) | new_n68_ | (~new_n85_ & new_n92_);
