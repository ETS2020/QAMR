...
module FAU ( 
  ...
  assign new_n68_ = x19 & ~x32;
  assign z01 = (~x19 | x32) & (~x04 | (~x19 & ~new_n70_ & ~x30 & ~x32));
  ...
  assign z13 = (~x19 | (new_n91_ & x32)) & ((~new_n90_ & x27) | (new_n91_ & x32) | (new_n91_ & x30));
  assign new_n90_ = (~new_n91_ | new_n92_) & (new_n66_ | x18 | ~x20);
  assign new_n91_ = ~x13 & ~x04 & x39 & x40;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign z14 = ~new_n95_ | (~new_n94_ & (x18 | ~x20));
  assign new_n94_ = new_n91_ & (~new_n92_ | x30 | x32);
  assign new_n95_ = (~x19 | (new_n91_ & x32)) & ~new_n96_ & (new_n91_ | (~new_n66_ & x27));
  assign new_n96_ = ~x30 & ~x32 & (~x27 | (~x37 & x28 & ~x35));
