...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x32 & (~x25 | (~new_n70_ & ~x30)));
  ...
  assign z07 = (~x25 & ~x32) | (new_n79_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  ...
  assign z13 = new_n92_ | (x27 & ((new_n93_ & (x25 | x32)) | (new_n90_ & x25)));
  assign new_n90_ = new_n91_ & (~x28 | (x35 & x36));
  assign new_n91_ = ~x13 & ~x04 & x39 & x40;
  assign new_n92_ = new_n91_ & (x32 | (x25 & x30));
  assign new_n93_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = ~new_n95_ & (x25 | x32) & (~new_n91_ | (~x30 & ~x32));
  assign new_n95_ = x27 & (new_n93_ | (new_n91_ & (~x28 | (x35 & x36))));
