...
module FAU ( 
  ...
  assign new_n84_ = ~x04 & (((new_n70_ | x30) & new_n74_ & x05) | (new_n70_ & ~new_n74_ & x07));
  assign z11 = ~x30 & (new_n86_ | x32);
  assign new_n86_ = new_n87_ & (~x08 | (~new_n73_ & (~new_n74_ | ~x29)) | (x27 & (~new_n74_ | ~x29)));
  assign new_n87_ = ~x09 & (~x27 | ~x35 | x04 | x28);
  ...
  assign z20 = ~x30 & (x32 | (~new_n100_ & ~x09 & (~x27 | ~x35)));
  assign new_n100_ = x08 & (new_n73_ | (new_n74_ & x29));
  assign z18 = x30 | (~new_n86_ & ~x32);
  assign z19 = ~x30 & (new_n86_ | x32);
endmodule
