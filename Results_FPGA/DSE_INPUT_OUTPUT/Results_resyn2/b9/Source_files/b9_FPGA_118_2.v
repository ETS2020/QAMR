...
module FAU ( 
  ...
  assign new_n78_ = ((x00 & ~x25) | ~x38 | (~x14 & x25)) & x03 & x40;
  assign z08 = x39 & x40;
  assign z09 = new_n65_ | (x11 & x26 & x27 & x34);
  assign z10 = ~new_n83_ | (new_n82_ & ((~new_n71_ & z08) | (new_n70_ & (z08 | x07))));
  assign new_n82_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n83_ = (~x03 | x40) & (~x37 | ~x06 | ~x27);
  ...
  assign z13 = new_n65_ | (~new_n71_ & new_n91_) | (x27 & (new_n92_ | (~new_n90_ & new_n91_)));
  assign new_n90_ = x28 & (~x35 | ~x36);
  assign new_n91_ = ~x04 & ~x13 & x39 & x40;
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = new_n65_ | ((new_n71_ | ~new_n91_) & (~x27 | (~new_n92_ & (new_n90_ | ~new_n91_))));
  ...
  assign z19 = (new_n65_ | (~new_n99_ & ~x09 & ~x30)) & (~new_n85_ | ~x08);
