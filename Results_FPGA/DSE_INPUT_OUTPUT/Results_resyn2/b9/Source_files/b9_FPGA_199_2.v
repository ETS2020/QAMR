...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n72_,
    new_n74_, new_n80_, new_n81_, new_n83_, new_n86_, new_n87_, new_n89_,
  ...
  assign new_n68_ = x16 & (~x31 | x40);
  assign z01 = ~new_n70_ & (~x04 | (~new_n71_ & new_n72_));
  assign new_n70_ = x31 & ~x40;
  ...
  assign z08 = new_n70_ | new_n83_;
  assign new_n83_ = x39 & x40;
  assign z09 = new_n70_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n87_ | (new_n86_ & ((~new_n72_ & new_n83_) | (new_n71_ & (new_n83_ | x07))));
  assign new_n86_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n87_ = (~x31 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n70_ | (new_n90_ & (~new_n89_ | (x27 & (~new_n83_ | ~x29))));
  ...
  assign z13 = (x27 & (new_n95_ | (~new_n93_ & new_n94_))) | new_n70_ | new_n96_;
  ...
  assign z19 = ~new_n70_ & new_n90_ & (~new_n89_ | (x27 & (~new_n83_ | ~x29)));
  assign z20 = new_n70_ | (~new_n89_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z18 = new_n70_ | ~new_n90_ | (new_n89_ & (~x27 | (new_n83_ & x29)));
endmodule
