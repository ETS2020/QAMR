...
module FAU ( 
  ...
  assign z02 = ~new_n72_ | (x04 & (~new_n70_ | (~x08 & ~x27)));
  assign new_n72_ = ~new_n68_ & x39 & x40 & (x02 | (x08 & x29));
  ...
  assign z10 = (~new_n82_ & x27 & (~x30 | x32)) | (new_n67_ & x05 & x32);
  assign new_n82_ = (~x06 | ~x37) & (~new_n83_ | x04 | (~new_n70_ & ~x36));
  assign new_n83_ = (x39 & x40) ? (x05 & ~x30) : x07;
  assign z11 = new_n86_ & (~new_n85_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n85_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n86_ = (x28 | ~x35 | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (x27 | (new_n90_ & x32)) & ((~new_n91_ & new_n90_ & ~x30) | new_n89_ | (new_n90_ & x32));
  assign new_n89_ = x20 & ~x18 & ~x19 & ~new_n68_ & ~new_n66_;
  assign new_n90_ = x39 & x40 & ~x04 & ~x13;
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign z14 = ~new_n94_ | (~new_n93_ & (~x20 | x18 | x19));
  assign new_n93_ = new_n90_ & (~new_n91_ | x32);
  assign new_n94_ = (~new_n66_ | (new_n90_ & (~x28 | x32))) & (~x30 | x32) & (x27 | (new_n90_ & x32));
  ...
  assign z20 = (x30 & ~x32) | (~new_n85_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z18 = ~z11;
endmodule
