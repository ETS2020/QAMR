...
module FAU ( 
  ...
  assign new_n84_ = ~x04 & x27 & ~x28 & ~x23 & x35;
  assign z11 = new_n68_ | (~new_n86_ & ~x09 & ~x30);
  assign new_n86_ = (x08 | (x35 & ~x04 & x27 & ~x28)) & (new_n87_ | ((~x04 | ~x27) & ~x28 & x35));
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (new_n90_ & ~new_n68_ & new_n92_) | (~new_n93_ & new_n91_ & ~new_n68_);
  assign new_n90_ = ~new_n66_ & x27;
  assign new_n91_ = new_n67_ & ~x13;
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign new_n93_ = (~x27 | ~x35 | ~x36) & ~x30 & ~x32 & (~x27 | x28);
  assign z14 = (~new_n92_ & (~new_n91_ | new_n95_)) | new_n96_ | new_n68_ | (~new_n90_ & ~new_n91_);
  ...
  assign z17 = x01 & x22 & ~x35 & x23 & ~x24;
  assign z18 = (~new_n101_ & (~x23 | ~x35)) | (new_n102_ & (x08 | x27) & ~x23 & x35);
  assign new_n101_ = ~x09 & ~x30 & (~x39 | ~x40 | ~x08 | ~x29);
  assign new_n102_ = ~x28 & (~x04 | ~x27);
  assign z19 = ~new_n104_ & ~x09 & ~x30;
  assign new_n104_ = (new_n87_ | (x35 & (new_n102_ | x23))) & (x08 | (x35 & (new_n105_ | x23)));
  assign new_n105_ = ~x04 & x27 & ~x28;
  assign z20 = new_n107_ & (~x08 | (~new_n87_ & (x28 | ~x35)));
