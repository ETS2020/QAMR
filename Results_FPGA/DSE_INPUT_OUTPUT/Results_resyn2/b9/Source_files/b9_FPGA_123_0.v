...
module FAU ( 
  ...
  assign new_n81_ = x03 & (x29 | x40);
  assign z08 = new_n65_ | new_n68_;
  assign z09 = new_n65_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n86_ | (new_n85_ & ((new_n68_ & ~new_n71_) | (new_n70_ & (new_n68_ | x07))));
  assign new_n85_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n86_ = (x29 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = (~x08 | (~new_n73_ & ~new_n88_) | (~new_n88_ & x27)) & new_n89_ & (~new_n73_ | x04 | ~x27);
  assign new_n88_ = x29 & x39 & x40;
  assign new_n89_ = (x29 | x40) & ~x09 & ~x30;
  assign z12 = (x40 & (new_n92_ | (~new_n91_ & (x04 | ~x39)))) | (~new_n91_ & x29 & ~x40);
  assign new_n91_ = x27 & (x37 | (x28 & x35));
  assign new_n92_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = (x27 & (new_n94_ | (~new_n95_ & new_n96_))) | new_n65_ | (~new_n71_ & new_n96_);
  assign new_n94_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = ~new_n65_ & ((~new_n98_ & (~new_n96_ | new_n99_)) | (~new_n91_ & (~new_n96_ | new_n100_)));
  ...
  assign z19 = ((new_n105_ & ~new_n106_) | (~x29 & ~x40)) & (~x08 | ~x29 | ~x39 | ~x40);
  assign new_n105_ = ~x09 & ~x30;
  assign new_n106_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign z20 = ~new_n108_ & new_n89_ & (~x27 | ~x35);
  assign new_n108_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z18 = (x08 & (new_n73_ | new_n88_) & (new_n88_ | ~x27)) | ~new_n89_ | (new_n73_ & ~x04 & x27);
endmodule
