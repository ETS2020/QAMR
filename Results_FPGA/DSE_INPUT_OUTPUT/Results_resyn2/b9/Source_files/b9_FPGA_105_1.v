...
module FAU ( 
  ...
  assign z11 = (x39 | ~x40) & new_n86_ & (~new_n85_ | (x27 & (~x29 | ~x40)));
  ...
  assign z14 = (~x27 | (~new_n92_ & (~new_n91_ | ~x40))) & (~x40 | (~new_n93_ & x39));
  assign z15 = x12 & ~new_n68_ & x34 & x26 & x27;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z19 = (~x39 & x40) | (new_n86_ & (~new_n85_ | (x27 & (~x29 | ~x40))));
  assign z20 = new_n68_ | (~new_n85_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z18 = (~x39 & x40) | ~new_n86_ | (new_n85_ & (~x27 | (x29 & x40)));
  assign z08 = x40;
endmodule
