...
module FAU ( 
  ...
  assign new_n74_ = x39 & x40 & (x29 | ~x32) & (x02 | (x08 & x29));
  ...
  assign new_n88_ = x08 & (new_n73_ | (x29 & x39 & x40));
  assign new_n89_ = (~new_n73_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = (~new_n92_ & x27) | (new_n86_ & ~x04 & ~x13);
  assign new_n92_ = (~new_n93_ | new_n66_ | (~x29 & x32)) & (new_n94_ | ~new_n95_ | x32);
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = new_n97_ | (~new_n93_ & ((~new_n68_ & ~new_n95_) | (new_n71_ & new_n94_)));
