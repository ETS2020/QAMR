...
module FAU ( 
  ...
  assign new_n66_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign new_n67_ = (~x27 | (~x37 & (~x28 | ~x35))) & (x04 | ~x39);
  ...
  assign z11 = ~new_n84_ & new_n85_ & (x04 | ~x27 | x28 | ~x35);
  assign new_n84_ = x08 & ((~x28 & x35) | (x29 & x39)) & (~x27 | (x29 & x39));
  assign new_n85_ = (~x39 | x40) & ~x09 & ~x30;
  assign z12 = new_n66_ | new_n65_ | new_n67_;
  assign z13 = new_n90_ | (x27 & ((new_n88_ & (~x39 | x40)) | (new_n89_ & x40)));
  assign new_n88_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n89_ = (~x28 | (x35 & x36)) & ~x13 & ~x04 & x39;
  assign new_n90_ = ~x13 & ~x04 & x39 & (x30 | x32) & x40;
  assign z14 = ~new_n92_ & (~x27 | (~new_n88_ & ~new_n89_));
  assign new_n92_ = x39 & (~x40 | ((x30 | x32) & ~x04 & ~x13));
  assign z15 = x27 & x34 & ~new_n65_ & x12 & x26;
  assign z16 = x01 & x22 & ~new_n65_ & ~x23;
  assign z17 = x01 & x22 & ~new_n65_ & x23 & ~x24;
  assign z20 = new_n65_ | (~new_n97_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign new_n97_ = x08 & ((~x28 & x35) | (x29 & x39));
  assign z18 = new_n84_ | ~new_n85_ | (~x04 & x27 & ~x28 & x35);
  assign z08 = x39;
  assign z19 = ~new_n84_ & new_n85_ & (x04 | ~x27 | x28 | ~x35);
endmodule
