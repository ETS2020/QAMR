...
module FAU ( 
  ...
  assign new_n68_ = x16 & (~x29 | x32);
  assign z01 = ~x04 | (~x32 & (x29 | (~new_n70_ & ~x30)));
  assign new_n70_ = x27 & (x36 | (~x28 & x35));
  assign z02 = (~new_n72_ & x04) | ~z08 | (~x02 & (~x08 | ~x29));
  assign new_n72_ = ~x28 & x35 & (x08 | x27);
  assign z08 = (~x29 | x32) & x39 & x40;
  ...
  assign new_n81_ = x03 & (~x29 | x32);
  assign z09 = new_n75_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n86_ | (new_n85_ & (new_n70_ | new_n84_));
  assign new_n84_ = x39 & x40 & (x30 | x32);
  assign new_n85_ = (x07 | (x39 & x40)) & ~x04 & (x05 | ~x39 | ~x40);
  assign new_n86_ = (~x29 | x32) & (~x37 | ~x06 | ~x27);
  assign z11 = ~new_n88_ & ~new_n89_ & ~x09 & ~x30;
  assign new_n88_ = x29 & (~x32 | (x08 & x39 & x40));
  assign new_n89_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z12 = ~new_n75_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = (x27 & (new_n94_ | (~new_n92_ & new_n93_))) | new_n75_ | new_n95_;
  ...
  assign z14 = (~new_n98_ & ~x32) | ((~new_n93_ | (~new_n97_ & new_n99_)) & (~new_n97_ | ~new_n100_));
  assign new_n97_ = x20 & ~x18 & ~x19;
  assign new_n98_ = ~x29 & (x30 | (x27 & (x37 | ~x28 | x35)));
  ...
  assign z18 = new_n105_ | (~new_n75_ & (new_n89_ | x09 | x30));
  assign new_n105_ = x08 & x29 & x32 & x39 & x40;
  assign z20 = ~new_n107_ & (~x27 | ~x35) & ~new_n75_ & ~x09 & ~x30;
  assign new_n107_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z19 = ~new_n88_ & ~new_n89_ & ~x09 & ~x30;
endmodule
