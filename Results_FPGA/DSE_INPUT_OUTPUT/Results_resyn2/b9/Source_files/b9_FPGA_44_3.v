...
module FAU ( 
  ...
  assign z10 = (~new_n82_ & x27) | (new_n85_ & ~x04 & x05);
  assign new_n82_ = ~new_n84_ & (new_n83_ | x04 | (~new_n70_ & ~x36));
  assign new_n83_ = (~x07 | (x39 & x40) | (x30 & x32)) & (~x39 | ~x40 | ~x05 | x30);
  assign new_n84_ = (~x30 | ~x32) & x06 & x37;
  assign new_n85_ = (x30 | x32) & (~x30 | ~x32) & x39 & x40;
  ...
  assign z13 = (~new_n91_ & ~new_n68_ & x27) | (new_n85_ & ~x04 & ~x13);
  assign new_n91_ = ~new_n92_ & (~new_n93_ | new_n94_ | x30);
