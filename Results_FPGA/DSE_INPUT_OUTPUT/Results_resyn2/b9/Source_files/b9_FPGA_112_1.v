...
module FAU ( 
  ...
  assign new_n98_ = ~x19 & ~x18 & x20 & (x37 | (x28 & x35));
  assign new_n99_ = x19 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n101_ & ~new_n102_) | (x19 & (~new_n97_ | (new_n72_ & new_n96_)));
  assign new_n101_ = x40 & (~x19 | x27 | x30 | x32);
  assign new_n102_ = x27 & ~x18 & x20 & (x37 | (x28 & x35));
  assign z15 = new_n70_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n70_ & ~x23;
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n107_ | (~new_n70_ & (~new_n89_ | (new_n74_ & (~x04 | ~x27))));
  assign new_n107_ = x08 & x29 & x19 & x39 & x40;
  assign z19 = new_n70_ | (new_n89_ & (new_n109_ | new_n92_ | new_n93_));
  assign new_n109_ = ~x08 & (x04 | ~x27 | x28 | ~x35);
