...
module FAU ( 
  ...
  assign z12 = ~new_n87_ & (new_n88_ | ~x40);
  assign new_n87_ = x27 & (x37 | (x28 & x35));
  assign new_n88_ = x39 & (x04 | (~x10 & (~x27 | (~x35 & ~x36))));
  assign z13 = new_n94_ | (~new_n90_ & x27);
  assign new_n90_ = (~new_n91_ | ~new_n92_) & (~new_n93_ | ~x40 | x04 | x13);
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = (x39 | ~x40) & (x37 | (x28 & x35));
  assign new_n93_ = x39 & (~x28 | (x35 & x36));
  assign new_n94_ = x40 & (x30 | x32) & x39 & ~x04 & ~x13;
  assign z14 = ~new_n97_ | (~new_n96_ & ~x30 & ~x32);
  assign new_n96_ = x27 & (~x28 | (x35 & x36) | (new_n91_ & (x35 | x37)));
  assign new_n97_ = (x39 | ~x40) & ((new_n87_ & new_n91_) | (x40 & ~x04 & ~x13));
  assign z15 = x12 & ~new_n67_ & x34 & x26 & x27;
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = x01 & x22 & ~new_n67_ & x23 & ~x24;
  assign z18 = ~new_n67_ & (~new_n102_ | (new_n70_ & (x08 | x27) & (~x04 | ~x27)));
  assign new_n102_ = ~x09 & ~x30 & (~x40 | ~x08 | ~x29);
  assign z19 = new_n84_ & ~new_n67_;
  assign z20 = (~x39 & x40) | (new_n105_ & (~x08 | (~new_n70_ & (~x29 | ~x40))));
  assign new_n105_ = ~x09 & ~x30 & (~x27 | ~x35);
  assign z08 = x40;
endmodule
