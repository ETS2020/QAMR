...
module FAU ( 
  ...
  assign z10 = new_n85_ | ((new_n84_ | (x06 & x37)) & ~new_n86_ & x27);
  assign new_n84_ = (x07 | (x39 & x40)) & ~x04 & (new_n70_ | x36);
  assign new_n85_ = ~new_n71_ & x39 & x40 & x05 & ~x04 & x11;
  assign new_n86_ = x40 & (~x11 | ((~x06 | ~x37) & ~x05 & x39));
  ...
  assign z13 = new_n94_ | (x27 & (new_n93_ | (new_n95_ & ~new_n96_ & x11)));
  assign new_n93_ = ~new_n66_ & ~new_n68_ & x20 & ~x18 & ~x19;
  ...
  assign new_n99_ = new_n95_ & (~new_n71_ | ~new_n96_);
