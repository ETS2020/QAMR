...
module FAU ( 
  ...
  assign z10 = (~new_n83_ & x27) | (new_n85_ & ~new_n68_ & x05);
  assign new_n83_ = (new_n84_ | new_n70_ | x04) & (new_n68_ | ~x06 | ~x37);
  assign new_n84_ = (~x07 | (x12 & x32) | (x39 & x40)) & (~x39 | ~x40 | ~x05 | x32);
