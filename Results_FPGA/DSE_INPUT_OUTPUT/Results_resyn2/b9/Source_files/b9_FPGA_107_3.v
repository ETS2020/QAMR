...
module FAU ( 
  ...
  assign z01 = (~x30 & ~x32 & (new_n69_ | ~x27)) | ~x04 | (x32 & x40);
  ...
  assign new_n82_ = (~x07 | (x40 & (x32 | x39))) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n83_ = (~x32 | ~x40) & x06 & x37;
  assign new_n84_ = ~x04 & x30 & x39 & x40 & x05 & ~x32;
  ...
  assign z13 = new_n95_ | (x27 & (new_n92_ | (~new_n93_ & new_n94_)));
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = ~x13 & ~x04 & x39 & x40;
  assign new_n95_ = x40 & (x32 | (~x04 & x30 & ~x13 & x39));
  assign z14 = new_n74_ | (~new_n97_ & (~x27 | (~new_n92_ & (new_n93_ | ~new_n94_))));
  assign new_n97_ = x40 & ~x04 & x30 & ~x13 & x39;
  assign z15 = x12 & ~new_n74_ & x34 & x26 & x27;
  assign z16 = new_n74_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n74_ & x23 & ~x24;
  assign z18 = new_n104_ | ~new_n105_ | (new_n102_ & ~new_n103_);
  assign new_n102_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign new_n103_ = x27 & (~x40 | ~x29 | ~x39);
  assign new_n104_ = x27 & x35 & ~x04 & ~x28;
  assign new_n105_ = ~x09 & ~x30 & (~x32 | ~x40);
  assign z19 = ~new_n107_ & (new_n74_ | (~new_n87_ & ~x09 & ~x30));
  assign new_n107_ = x08 & ~x32 & x40 & x29 & x39;
  assign z20 = ~new_n102_ & new_n105_ & (~x27 | ~x35);
