...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n72_,
    ...
    new_n91_, new_n92_, new_n93_, new_n95_, new_n100_, new_n101_;
  ...
  assign z10 = ~new_n85_ | (new_n84_ & ((new_n83_ & ~new_n72_) | (new_n71_ & (new_n83_ | x07))));
  ...
  assign z13 = (~new_n72_ & new_n92_) | (x27 & ((~new_n91_ & new_n92_) | (~new_n70_ & new_n93_)));
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = ~x13 & ~x04 & x39 & x40;
  assign new_n93_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = new_n95_ & (~x27 | (~new_n93_ & (new_n91_ | ~new_n92_)));
  ...
  assign z19 = ((~x39 & ~x40) | (~new_n101_ & ~x09 & ~x30)) & (~new_n100_ | ~x39 | ~x40);
