...
module FAU ( 
  ...
  assign z01 = (~new_n70_ & ~x30 & ~x32) | ~x04 | (x19 & x30);
  ...
  assign new_n84_ = x30 & (x19 | (new_n66_ & x05));
  assign z11 = new_n87_ & (~new_n86_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n86_ = x08 & (new_n72_ | (x29 & x39 & x40));
  assign new_n87_ = (~new_n72_ | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (~new_n90_ & x27) | (new_n92_ & (x30 | x32) & (~x19 | ~x30));
  assign new_n90_ = ~new_n91_ & (~new_n92_ | x30 | (x28 & (~x35 | ~x36)));
  assign new_n91_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n92_ = ~x13 & ~x04 & x39 & x40;
  assign z14 = (~x30 & ((~new_n92_ & x19) | (~new_n94_ & ~x32))) | (~new_n96_ & ~new_n92_ & ~x19);
  assign new_n94_ = x27 & (~x28 | (x35 & x36) | (new_n95_ & (x35 | x37)));
  assign new_n95_ = x20 & ~x18 & ~x19;
  assign new_n96_ = ~new_n67_ & x27 & ~x18 & x20;
  assign z15 = x12 & ~new_n68_ & x34 & x26 & x27;
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z20 = (x19 & x30) | (~new_n86_ & ~x09 & ~x30 & (~x27 | ~x35));
