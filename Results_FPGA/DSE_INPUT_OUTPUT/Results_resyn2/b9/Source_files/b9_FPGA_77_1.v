...
module FAU ( 
  ...
  assign z01 = (~x04 & (x08 | ~x32)) | (~new_n70_ & ~x30 & ~x32);
  assign new_n70_ = x27 & (x36 | (~x28 & x35));
  assign z02 = ~new_n72_ | (~x08 & (x32 | (x04 & ~x27)));
  ...
  assign new_n83_ = ((~new_n70_ & ~x30) | ~new_n73_ | ~x05) & (~new_n70_ | new_n73_ | ~x07);
  assign new_n84_ = x32 & (~x08 | (new_n67_ & x05));
  assign z11 = new_n87_ & (~new_n86_ | (x27 & (~new_n73_ | ~x29)));
  assign new_n86_ = x08 & (new_n74_ | (new_n73_ & x29));
  assign new_n87_ = ~new_n68_ & ~x09 & ~x30 & (~new_n74_ | x04 | ~x27);
  assign z12 = new_n65_ & ~new_n68_;
  assign z14 = (new_n90_ | ~x27) & (~new_n91_ | (~x30 & ~x32)) & (x08 | ~x32);
  ...
  assign z18 = ~new_n97_ | (new_n74_ & (x27 ? ~x04 : x08));
  assign new_n97_ = (x08 | ~x32) & ~x09 & ~x30 & (~new_n73_ | ~x08 | ~x29);
  assign z20 = new_n68_ | (~new_n86_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z06 = ~z05;
  assign z13 = (~new_n90_ & x27) | (new_n91_ & (x30 | x32)) | (~x08 & x32);
  assign z19 = new_n87_ & (~new_n86_ | (x27 & (~new_n73_ | ~x29)));
endmodule
