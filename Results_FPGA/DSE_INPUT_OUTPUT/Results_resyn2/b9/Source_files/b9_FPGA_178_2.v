...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n89_, new_n90_, new_n93_, new_n94_, new_n95_, new_n100_;
  ...
  assign z01 = ~x04 | (~x32 & (x23 | (~new_n70_ & ~x30)));
  ...
  assign z03 = (x27 & (~x28 | ~x35)) | (~x27 & ~x37) | new_n73_ | ~x21;
  ...
  assign new_n80_ = x03 & (~x23 | x32);
  assign z08 = new_n72_ & ~new_n73_;
  assign z09 = new_n73_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n86_ | (new_n85_ & ((new_n72_ & ~new_n84_) | (new_n70_ & (new_n72_ | x07))));
  assign new_n84_ = ~x30 & ~x32;
  assign new_n85_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n86_ = (~x23 | x32) & (~x37 | ~x06 | ~x27);
  assign z11 = (~x08 | (~new_n88_ & ~new_n89_) | (~new_n89_ & x27)) & new_n90_ & (~new_n88_ | x04 | ~x27);
  assign new_n88_ = ~x28 & x35;
  assign new_n89_ = x29 & x39 & x40;
  assign new_n90_ = (~x23 | x32) & ~x09 & ~x30;
  assign z12 = new_n73_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z14 = (~x27 | (~new_n95_ & (~new_n93_ | new_n94_))) & ~new_n73_ & (new_n84_ | ~new_n93_);
  ...
  assign z20 = ~new_n100_ & new_n90_ & (~x27 | ~x35);
  assign new_n100_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z06 = new_n73_ | (~x37 & (~x27 | ~x28));
  assign z13 = (x27 & (new_n95_ | (new_n93_ & ~new_n94_))) | new_n73_ | (~new_n84_ & new_n93_);
  assign z18 = (x08 & (new_n88_ | new_n89_) & (new_n89_ | ~x27)) | ~new_n90_ | (new_n88_ & ~x04 & x27);
  assign z19 = (~x08 | (~new_n88_ & ~new_n89_) | (~new_n89_ & x27)) & new_n90_ & (~new_n88_ | x04 | ~x27);
endmodule
