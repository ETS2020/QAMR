...
module FAU ( 
  ...
  assign new_n86_ = ~x09 & ~x30 & (~x39 | ~x08 | ~x29);
  ...
  assign new_n94_ = x39 & (~x40 | (~x04 & ~x13 & (x30 | x32)));
  ...
  assign new_n99_ = x08 & ((x29 & x39) | (~x28 & x35)) & (~x27 | (x29 & x39));
  assign new_n100_ = ~x09 & ~x30 & (~x39 | x40);
  assign z20 = new_n102_ & (~x08 | (~new_n69_ & (~x29 | ~x39)));
