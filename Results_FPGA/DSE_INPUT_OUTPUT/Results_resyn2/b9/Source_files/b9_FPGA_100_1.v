...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    ...
    new_n90_, new_n93_, new_n94_, new_n95_, new_n96_, new_n98_;
  ...
  assign z10 = (~new_n84_ & x27) | (new_n86_ & ~x04 & x05);
  assign new_n84_ = (~new_n85_ | new_n70_ | new_n68_ | x04) & (new_n68_ | ~x06 | ~x37);
  assign new_n85_ = (x39 & x40) ? (x05 & ~x32) : x07;
  assign new_n86_ = ~new_n71_ & ~new_n68_ & x39 & x40;
  assign z18 = ~new_n88_ & ~new_n68_;
  assign new_n88_ = new_n90_ & (~new_n89_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n89_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n90_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (~new_n93_ & x27) | (new_n86_ & ~x04 & ~x13);
  assign new_n93_ = (~new_n94_ | new_n66_ | (~x23 & x32)) & (new_n95_ | ~new_n96_ | x32);
  assign new_n94_ = x20 & ~x18 & ~x19;
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = new_n98_ | (~new_n94_ & ((~new_n68_ & ~new_n96_) | (new_n71_ & new_n95_)));
  assign new_n98_ = (~new_n96_ | (new_n71_ & (~x27 | x28))) & ~new_n68_ & (new_n66_ | ~x27);
  ...
  assign z20 = ~new_n89_ & (~x27 | ~x35) & ~new_n68_ & ~x09 & ~x30;
