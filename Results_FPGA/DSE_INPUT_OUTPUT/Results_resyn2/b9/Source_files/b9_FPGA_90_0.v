...
module FAU ( 
  ...
  assign z02 = (x39 ^ x40) | (x40 & (new_n73_ | (~new_n74_ & ~x02)));
  ...
  assign z10 = new_n87_ | (x27 & (new_n86_ | (~new_n85_ & ~new_n71_ & ~x04)));
  assign new_n85_ = (~x05 | ~x39 | ~x40) & (~x07 | (~x39 & ~x40) | (x39 & x40));
  assign new_n86_ = x06 & x37 & (x39 | x40);
  assign new_n87_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = (new_n89_ | ~x08) & ~new_n90_ & ~new_n70_ & ~x09 & ~x30;
  assign new_n89_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n90_ = ~x04 & x27 & ~x28 & x35;
  assign z12 = ~new_n70_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = ~new_n96_ | (x27 & (new_n94_ | (~new_n95_ & new_n93_ & ~x13)));
  assign new_n93_ = x40 & ~x04 & x39;
  assign new_n94_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = (x39 | x40) & (x04 | x13 | (~x30 & ~x32) | ~x39 | ~x40);
  assign z14 = new_n96_ & (~x27 | ((new_n65_ | ~new_n98_) & ~new_n94_ & ~new_n99_));
  assign new_n98_ = ~x04 & ~x13 & x35 & x36 & x39 & x40;
  assign new_n99_ = ~x04 & ~x13 & ~x28 & x39 & x40;
  assign z15 = x12 & ~new_n70_ & x34 & x26 & x27;
  assign z16 = x01 & x22 & ~new_n70_ & ~x23;
  assign z17 = x01 & x22 & ~new_n70_ & x23 & ~x24;
  assign z18 = ((x39 | x40) & (new_n104_ | x09 | x30)) | (new_n74_ & x39 & x40);
  assign new_n104_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z20 = new_n70_ | (~new_n106_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign new_n106_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z19 = (new_n89_ | ~x08) & ~new_n90_ & ~new_n70_ & ~x09 & ~x30;
endmodule
