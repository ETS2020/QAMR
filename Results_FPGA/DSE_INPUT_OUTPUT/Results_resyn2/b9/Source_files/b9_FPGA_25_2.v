...
module FAU ( 
  ...
  assign z14 = (~new_n96_ & ~x30) | new_n68_ | (~new_n92_ & (~new_n95_ | ~x27));
  assign new_n95_ = ~new_n66_ & new_n93_;
  assign new_n96_ = new_n97_ & (new_n93_ | ~x28 | (x35 & (x32 | x36)));
  assign new_n97_ = (x27 | x32) & (x37 | ~x28 | x35);
  ...
  assign z20 = ~new_n87_ & (~x27 | ~x35) & (~x32 | x35) & ~x09 & ~x30;
