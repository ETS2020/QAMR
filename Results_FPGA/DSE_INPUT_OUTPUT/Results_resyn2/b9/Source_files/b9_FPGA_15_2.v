...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x32 | x36)) | (~new_n70_ & ~x30 & ~x32);
  ...
  assign new_n83_ = x32 & (~x36 | (new_n67_ & x05));
  ...
  assign z14 = (new_n90_ | ~x27) & (~x32 | x36) & (~new_n91_ | (~x30 & ~x32));
  ...
  assign z06 = ~z05;
  assign z13 = (~new_n90_ & x27) | (x32 & ~x36) | (new_n91_ & (x30 | x32));
