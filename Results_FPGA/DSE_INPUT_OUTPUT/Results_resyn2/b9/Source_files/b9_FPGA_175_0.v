...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x32 & (~x40 | (~x30 & (new_n70_ | ~x27))));
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = x40 ? ~new_n72_ : x32;
  assign new_n72_ = ~new_n73_ & x39 & (x02 | (x08 & x29));
  ...
  assign new_n82_ = (z08 ? x05 : (~new_n68_ & x07)) & ~new_n70_ & ~x04;
  assign new_n83_ = z08 & x05 & ~x04 & (x30 | x32);
  assign z11 = new_n85_ | new_n68_;
  assign new_n85_ = new_n87_ & (~new_n86_ | (x27 & (~z08 | ~x29)));
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n87_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = (x40 & (new_n90_ | (~new_n89_ & (x04 | ~x39)))) | (~new_n89_ & x32 & ~x40);
  assign new_n89_ = ~new_n67_ & x27;
  assign new_n90_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = (~new_n92_ & x27) | (~x32 & ~x40) | (new_n94_ & (x30 | x32));
  assign new_n92_ = (~new_n93_ | (~x37 & (~x28 | ~x35))) & (~new_n94_ | (x28 & (~x35 | ~x36)));
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign new_n94_ = ~x13 & x40 & ~x04 & x39;
  assign z14 = (~new_n96_ & ~new_n93_ & (x32 | x40)) | (~new_n97_ & ~new_n89_ & x40) | (~new_n89_ & x32 & ~x40);
  assign new_n96_ = new_n94_ & (x30 | x32 | ~x28 | (x35 & x36));
  assign new_n97_ = ~new_n98_ & ~x13 & ~x04 & x39;
