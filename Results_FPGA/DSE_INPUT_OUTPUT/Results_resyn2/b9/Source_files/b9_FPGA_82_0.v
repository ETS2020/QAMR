...
module FAU ( 
  ...
  assign z02 = (x39 ^ x40) | (x39 & (new_n74_ | (~new_n73_ & ~x02)));
  ...
  assign z10 = ~new_n87_ | ((new_n85_ | new_n86_) & ~new_n71_ & ~x04 & (~new_n85_ | x05));
  assign new_n85_ = x39 & x40;
  assign new_n86_ = x07 & x27 & (x36 | (~x28 & x35));
  ...
  assign new_n91_ = ~x09 & ~x30 & (x39 | x40);
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = (x27 & ((new_n97_ & new_n98_) | (~new_n95_ & new_n96_))) | (~new_n94_ & new_n96_);
  ...
  assign z14 = (~new_n100_ & (~new_n96_ | new_n101_)) | new_n70_ | (~new_n97_ & (~new_n96_ | new_n102_));
  ...
  assign z19 = ((~x39 & ~x40) | (~new_n107_ & ~x09 & ~x30)) & (~new_n73_ | ~x39 | ~x40);
  assign new_n107_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z20 = ~new_n109_ & new_n91_ & (~x27 | ~x35);
