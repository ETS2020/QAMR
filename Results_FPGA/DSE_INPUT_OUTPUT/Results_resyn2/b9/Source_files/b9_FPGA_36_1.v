...
module FAU ( 
  ...
  assign new_n96_ = x30 ? (x04 | x13 | ~x39 | ~x40) : ~x32;
  assign z14 = (~new_n95_ & (~new_n93_ | new_n98_)) | new_n99_ | new_n100_ | (new_n65_ & ~new_n93_);
  assign new_n98_ = ~x30 & x28 & (~x35 | ~x36);
  assign new_n99_ = ~x30 & (x32 | (~x37 & x28 & ~x35));
  assign new_n100_ = ~x27 & (~x30 | x04 | x13 | ~x39 | ~x40);
  assign z15 = x12 & ~new_n72_ & x34 & x26 & x27;
  assign z16 = new_n72_ | (~x23 & x01 & x22);
  assign z17 = new_n72_ | (x01 & x22 & x23 & ~x24);
  assign z20 = ~new_n105_ & new_n90_ & (~x27 | ~x35);
