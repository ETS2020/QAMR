...
module FAU ( 
  ...
  assign new_n84_ = (~x05 | ~x39) & x40 & (~x07 | x39);
  assign new_n85_ = (x07 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n70_ | (new_n87_ & (new_n90_ | (~new_n88_ & ~new_n89_)));
  ...
  assign z18 = new_n106_ | (~new_n70_ & (~new_n87_ | (new_n73_ & (~x04 | ~x27))));
  assign new_n106_ = x08 & x29 & x39 & x40;
  assign z19 = (~new_n88_ | new_n108_) & ~new_n89_ & ~new_n70_ & new_n87_;
  assign new_n108_ = x27 & (~x29 | ~x39 | ~x40);
  assign z20 = new_n70_ | (~new_n88_ & new_n87_ & (~x27 | ~x35));
endmodule
