...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x32 & (~x05 | (~x30 & (new_n70_ | ~x27))));
  ...
  assign new_n84_ = (x05 | (~new_n74_ & x32)) & (new_n74_ | x07) & ~new_n70_ & ~x04;
  ...
  assign z14 = new_n96_ | (~new_n98_ & ~x32);
  assign new_n96_ = (~new_n92_ | ~new_n97_) & (~new_n94_ | (new_n93_ & ~new_n92_ & ~x30 & ~x32));
  assign new_n97_ = x27 & (x37 | (x28 & x35));
  assign new_n98_ = x05 & (x30 | (x27 & (x37 | ~x28 | x35)));
