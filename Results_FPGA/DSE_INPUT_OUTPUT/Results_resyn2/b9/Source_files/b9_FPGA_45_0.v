...
module FAU ( 
  ...
  assign z01 = (~x04 & (x21 | x32)) | ((new_n70_ | ~x27) & ~x32 & x21 & ~x30);
  ...
  assign new_n83_ = (~x07 | (x39 & x40) | (~x21 & ~x32)) & (~x39 | ~x40 | ~x05 | ~x21);
  assign new_n84_ = new_n67_ & (x32 | (x21 & x30));
  ...
  assign z13 = (x27 & (new_n92_ | (new_n91_ & ~new_n68_))) | (new_n84_ & ~x13);
  assign new_n91_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n92_ = new_n93_ & ~new_n94_ & x21;
  assign new_n93_ = ~x13 & ~x04 & x39 & x40;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign z14 = ~new_n96_ & (~new_n91_ | ~x27);
  assign new_n96_ = (new_n93_ | (~x21 & ~x32)) & ((~new_n94_ & x27) | x32 | ~x21 | x30);
