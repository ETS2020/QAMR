...
module FAU ( 
  ...
  assign new_n68_ = ~x07 & x32;
  assign z01 = (~x04 & (x07 | ~x32)) | (~x30 & ~x32 & (new_n70_ | ~x27));
  ...
  assign new_n82_ = ~new_n70_ & ~x04 & (~new_n72_ | (x05 & ~x32)) & (new_n72_ | x07);
  assign new_n83_ = new_n67_ & (x30 | x32) & x05 & (x07 | ~x32);
  ...
  assign z13 = ~new_n89_ | (x27 & ((~new_n90_ & new_n91_) | (~new_n66_ & new_n92_)));
  assign new_n89_ = (x07 | ~x32) & (x13 | ~new_n67_ | (~x30 & ~x32));
  assign new_n90_ = x28 & (~x35 | ~x36);
  assign new_n91_ = x39 & x40 & ~x04 & ~x13;
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign z14 = new_n94_ | (new_n89_ & (~x27 | (new_n66_ & (~new_n91_ | x28))));
  assign new_n94_ = ~new_n92_ & ((~new_n91_ & (x07 | ~x32)) | (new_n90_ & ~x30 & ~x32));
