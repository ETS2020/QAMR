...
module FAU ( 
  ...
  assign new_n70_ = ~x32 & ((~x36 & (x28 | ~x35)) | ~x27 | x30);
  ...
  assign z06 = (~x27 | ~x28) & ~new_n73_ & ~x37;
  ...
  assign new_n83_ = (x36 | (~x28 & x35)) & ~x04 & (~x30 | x32);
  assign new_n84_ = (x39 & x40) ? (x05 & ~x30) : x07;
  assign new_n85_ = (~x30 | x32) & x06 & x37;
  assign new_n86_ = ~x04 & x39 & x40 & x05 & x32;
  assign z11 = ~x30 & new_n90_ & (~new_n88_ | new_n89_);
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n89_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n90_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n73_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = new_n97_ | (x27 & ((new_n93_ & new_n94_) | (~new_n95_ & new_n96_)));
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign new_n94_ = (~x30 | x32) & (x37 | (x28 & x35));
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = ~x30 & x39 & x40 & ~x04 & ~x13;
  assign new_n97_ = x32 & x39 & x40 & ~x04 & ~x13;
  assign z14 = (~new_n93_ & (~new_n99_ | (new_n95_ & ~x32))) | (~new_n100_ & ~x32) | (~new_n99_ & ~new_n101_);
  assign new_n99_ = x39 & x40 & ~x04 & ~x13;
  assign new_n100_ = x27 & ~x30 & (x37 | ~x28 | x35);
  assign new_n101_ = x27 & (x37 | (x28 & x35));
  assign z15 = x12 & ~new_n73_ & x34 & x26 & x27;
  assign z16 = new_n73_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n73_ & x23 & ~x24;
  assign z19 = x30 ? ~x32 : (new_n90_ & (~new_n88_ | new_n89_));
  assign z20 = ~new_n88_ & (~x27 | ~x35) & ~x09 & ~x30;
  assign z05 = (x27 & x28) | new_n73_ | x37;
  assign z18 = x30 ? x32 : (~new_n90_ | (new_n88_ & ~new_n89_));
endmodule
