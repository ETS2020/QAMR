...
module FAU ( 
  ...
  assign z01 = (~x04 & (x32 | ~x38)) | ((new_n70_ | ~x27) & ~x38 & ~x30 & ~x32);
  ...
  assign z07 = (~x32 & x38) | (new_n77_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  assign new_n77_ = x03 & (~x14 | (~x31 & ~x33 & (x15 | ~x17)));
  assign z08 = ~new_n68_ & x39 & x40;
  assign z09 = new_n68_ | (x11 & x26 & x27 & x34);
  assign z10 = (new_n83_ & x05) | (~new_n81_ & x27);
  assign new_n81_ = (new_n68_ | ~x06 | ~x37) & (~new_n82_ | new_n70_ | new_n68_ | x04);
  assign new_n82_ = (x39 & x40) ? (x05 & ~x38) : x07;
  assign new_n83_ = new_n67_ & (x32 | (x30 & ~x38));
  ...
  assign z13 = (~new_n90_ & x27) | (new_n83_ & ~x13);
  assign new_n90_ = (~new_n91_ | new_n66_ | (~x32 & x38)) & (~new_n92_ | new_n93_ | x38);
