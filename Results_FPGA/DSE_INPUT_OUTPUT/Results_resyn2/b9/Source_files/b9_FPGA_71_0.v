...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n71_, new_n77_, new_n81_,
    new_n82_, new_n84_, new_n85_, new_n86_, new_n89_;
  ...
  assign new_n71_ = ~new_n68_ & x39 & x40 & (x02 | (x08 & x29));
  ...
  assign new_n81_ = (~x05 | ~x39 | ~x40) & (new_n82_ | (x39 & x40) | ~x07 | ~x27);
  ...
  assign z14 = ~new_n89_ & ~new_n68_ & (~new_n67_ | x13);
  ...
  assign z18 = x30 | (x32 & (new_n84_ | new_n86_ | x09));
  assign z20 = ~new_n85_ & x32 & ~x09 & ~x30 & (~x27 | ~x35);
  assign z13 = new_n89_ | new_n68_ | (new_n67_ & ~x13);
  assign z19 = ~new_n84_ & ~new_n86_ & x32 & ~x09 & ~x30;
endmodule
