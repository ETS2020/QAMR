...
module FAU ( 
  ...
  assign new_n89_ = ~x09 & (~x27 | ~x35 | x04 | x28);
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z14 = new_n92_ & (new_n65_ | ~x20 | ~x27 | x18 | x19);
  assign new_n92_ = (x30 | x32) & (x13 | x04 | ~x39 | ~x40);
  ...
  assign z13 = ~new_n92_ | (~new_n65_ & x20 & x27 & ~x18 & ~x19);
