...
module FAU ( 
  ...
  assign new_n82_ = (x05 | (~new_n72_ & x32)) & ~new_n70_ & ~x04 & (new_n72_ | x07);
  assign new_n83_ = x05 & new_n67_ & (x30 | x32);
  ...
  assign z13 = new_n90_ | (~x05 & ~x32) | (~x13 & new_n67_ & (x30 | x32));
  assign new_n90_ = x27 & (new_n92_ | (new_n91_ & (~x28 | (x35 & x36))));
  assign new_n91_ = ~x13 & ~x04 & x39 & x40;
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~new_n96_ & ~x32) | ((~new_n91_ | (~new_n95_ & new_n97_)) & (~new_n94_ | ~new_n95_));
  assign new_n94_ = ~new_n66_ & x27;
