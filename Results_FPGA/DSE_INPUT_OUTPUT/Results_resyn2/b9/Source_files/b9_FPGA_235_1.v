...
module FAU ( 
  ...
  assign z13 = (x27 | (new_n89_ & x30)) & ((~new_n90_ & new_n89_ & ~x32) | new_n88_ | (new_n89_ & x30));
  assign new_n88_ = ~new_n66_ & ~new_n68_ & x20 & ~x18 & ~x19;
  assign new_n89_ = x39 & x40 & ~x04 & ~x13;
  assign new_n90_ = x28 & (~x35 | ~x36);
  assign z14 = ~new_n93_ | (~new_n92_ & (~x20 | x18 | x19));
  assign new_n92_ = new_n89_ & (~new_n90_ | x30);
  assign new_n93_ = (~new_n66_ | (new_n89_ & (~x28 | x30))) & (x30 | ~x32) & (x27 | (new_n89_ & x30));
