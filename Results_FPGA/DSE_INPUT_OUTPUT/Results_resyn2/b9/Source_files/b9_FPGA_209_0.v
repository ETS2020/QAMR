...
module FAU ( 
  ...
  assign z11 = new_n87_ & (~new_n86_ | (x27 & (~new_n74_ | ~x29)));
  assign new_n86_ = x08 & (new_n75_ | (new_n74_ & x29));
  assign new_n87_ = (~new_n75_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  assign z12 = (x40 & (new_n90_ | (~new_n89_ & (new_n67_ | ~x27)))) | ((new_n67_ | ~x27) & x24 & ~x40);
  assign new_n89_ = ~x04 & x39;
  assign new_n90_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = new_n92_ | (~new_n71_ & new_n74_ & ~x04 & ~x13);
  ...
  assign z14 = ~new_n68_ & (new_n97_ | (~new_n95_ & (~new_n94_ | (new_n71_ & new_n93_))));
  assign new_n97_ = (new_n67_ | ~x27) & (~new_n98_ | (new_n71_ & (~x27 | x28)));
  assign new_n98_ = ~x04 & ~x13 & x39 & x40;
  assign z15 = x12 & ~new_n68_ & x34 & x26 & x27;
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & x40 & x23 & ~x24;
  assign z20 = new_n68_ | (~new_n86_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z05 = ~z06;
  assign z18 = ~new_n87_ | (new_n86_ & (~x27 | (new_n74_ & x29)));
  assign z19 = new_n87_ & (~new_n86_ | (x27 & (~new_n74_ | ~x29)));
endmodule
