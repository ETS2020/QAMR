...
module FAU ( 
  ...
  assign z10 = ~new_n86_ | (~x04 & (new_n83_ | (~new_n84_ & new_n85_)));
  assign new_n83_ = x05 & x39 & x40;
  assign new_n84_ = ~x36 & (x28 | ~x35);
  assign new_n85_ = x07 & x27 & (~x39 | ~x40);
  ...
  assign new_n90_ = ~x09 & (~x27 | ~x35 | x04 | x28);
  assign z12 = ~new_n70_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = ~new_n70_ & ((~x13 & new_n72_ & ~x04) | (~new_n65_ & new_n93_));
  ...
  assign z20 = ~x30 & (~x32 | (~new_n88_ & ~x09 & (~x27 | ~x35)));
  assign z14 = new_n70_ | ((x13 | ~new_n72_ | x04) & (new_n65_ | ~new_n93_));
