...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n71_, new_n73_,
    ...
    new_n90_, new_n92_, new_n93_, new_n94_, new_n100_, new_n101_,
    new_n103_;
  assign z00 = ~new_n67_ | (~x15 & x27 & (~new_n65_ | new_n66_));
  assign new_n65_ = ~x37 & (~x28 | ~x35);
  assign new_n66_ = (x35 | x36) & x40 & ~x04 & x39;
  assign new_n67_ = x16 & (~x10 | (x40 & (x15 | x04 | ~x39)));
  assign z01 = ~new_n69_ & (~x04 | (new_n71_ & (new_n70_ | ~x27)));
  assign new_n69_ = x10 & ~x40;
  ...
  assign new_n84_ = (~x10 | x40) & x06 & x37;
  assign new_n85_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = (~x08 | (~new_n73_ & ~new_n87_) | (~new_n87_ & x27)) & new_n88_ & (~new_n73_ | x04 | ~x27);
  assign new_n87_ = x40 & x29 & x39;
  assign new_n88_ = (~x10 | x40) & ~x09 & ~x30;
  assign z12 = ~new_n90_ & (~x27 | (new_n65_ & ~new_n66_));
  assign new_n90_ = x10 & (~x40 | (~x04 & x39));
  assign z13 = (~new_n71_ & new_n93_) | (x27 & ((~new_n69_ & new_n94_) | (~new_n92_ & new_n93_)));
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x04 & x39 & ~x13 & x40;
  assign new_n94_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~x27 | (~new_n94_ & (new_n92_ | ~new_n93_))) & ~new_n69_ & (new_n71_ | ~new_n93_);
  assign z15 = x12 & ~new_n69_ & x34 & x26 & x27;
  assign z16 = x01 & x22 & ~new_n69_ & ~x23;
  assign z17 = new_n69_ | (x01 & x22 & x23 & ~x24);
  assign z19 = ~new_n101_ & (new_n69_ | (~new_n100_ & ~x09 & ~x30));
  assign new_n100_ = (~x04 | ~x27) & (x08 | x27) & ~x28 & x35;
  assign new_n101_ = x08 & x29 & x39 & x40;
  assign z20 = ~new_n103_ & new_n88_ & (~x27 | ~x35);
  assign new_n103_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign z06 = new_n69_ | (~x37 & (~x27 | ~x28));
  assign z18 = new_n101_ | (~new_n69_ & (new_n100_ | x09 | x30));
endmodule
