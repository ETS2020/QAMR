...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n73_,
    new_n79_, new_n82_, new_n84_, new_n87_, new_n88_, new_n89_, new_n90_,
  ...
  assign new_n84_ = (~new_n73_ | x04 | ~x27) & ~new_n67_ & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n67_;
  assign z13 = new_n87_ | (~new_n70_ & x40 & new_n89_ & x39);
  assign new_n87_ = x27 & ((new_n88_ & (x39 | ~x40)) | (~new_n90_ & x39 & new_n89_ & x40));
  assign new_n88_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n89_ = ~x04 & ~x13;
  assign new_n90_ = x28 & (~x35 | ~x36);
  assign z14 = ~new_n93_ | (new_n70_ & (new_n92_ | ~x27));
  assign new_n92_ = new_n90_ & ((~x35 & ~x37) | ~x20 | x18 | x19);
  assign new_n93_ = (x39 | ~x40) & ((new_n89_ & x40) | (new_n88_ & x27));
  assign z15 = new_n67_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n67_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n67_ & x23 & ~x24;
  assign z19 = new_n67_ | (new_n98_ & (~new_n73_ | (~x08 & ~x27) | (x04 & x27)));
  assign new_n98_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x40);
  assign z20 = new_n100_ & (~x08 | (~new_n73_ & (~x29 | ~x40)));
  assign new_n100_ = (~x27 | ~x35) & ~new_n67_ & ~x09 & ~x30;
  assign z18 = ~new_n84_ | (x08 & (new_n73_ | (x29 & x40)) & (~x27 | (x29 & x40)));
  assign z08 = x40;
endmodule
