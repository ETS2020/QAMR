...
module FAU ( 
  ...
  assign new_n83_ = ~x04 & (((new_n70_ | x32) & new_n72_ & x05) | (new_n70_ & ~new_n72_ & x07));
  assign new_n84_ = x30 & (x32 | (new_n67_ & x05));
  assign z11 = ~z18 | new_n68_;
  assign z18 = ~new_n88_ | (new_n87_ & (~x27 | (new_n72_ & x29)));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n88_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = (~x30 | ~x32) & ((new_n91_ & (x30 | x32)) | (x27 & (new_n92_ | (new_n91_ & ~new_n93_)))) & (new_n92_ | new_n91_ | ~x30);
  assign new_n91_ = new_n72_ & ~x04 & ~x13;
  assign new_n92_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign z14 = (x30 & x32) | ((~new_n91_ | (~x30 & ~x32)) & (~x27 | (~new_n92_ & (~new_n91_ | new_n93_))));
