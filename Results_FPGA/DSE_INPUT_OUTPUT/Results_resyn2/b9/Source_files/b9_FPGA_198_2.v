...
module FAU ( 
  ...
  assign z01 = (~x26 | x32) & (~x04 | (~x26 & ~new_n70_ & ~x30 & ~x32));
  ...
  assign z09 = x26 & (~x32 | (x34 & x11 & x27));
  assign z10 = (~new_n82_ & ~x04) | new_n68_ | (x37 & x06 & x27);
  assign new_n82_ = ((~new_n70_ & new_n83_) | ~new_n72_ | ~x05) & (~new_n70_ | new_n72_ | ~x07);
  ...
  assign z13 = (~new_n90_ & x27) | (new_n92_ & (x32 | (~x26 & x30)));
  assign new_n90_ = (~new_n91_ | new_n66_ | (x26 & ~x32)) & (~new_n92_ | new_n93_ | x26);
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = ~x13 & ~x04 & x39 & x40;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign z14 = (~new_n95_ & ~new_n68_ & (new_n83_ | ~new_n92_)) | ((~new_n92_ | (new_n83_ & new_n93_)) & ~new_n68_ & ~new_n91_);
