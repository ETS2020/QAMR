...
module FAU ( 
  ...
  assign new_n78_ = x03 & (x31 | ~x40);
  assign z08 = x40 & (~x31 | x39);
  assign z09 = x11 & ~new_n69_ & x34 & x26 & x27;
  assign z10 = ~new_n84_ | (~x04 & (new_n83_ | (new_n70_ & ~new_n82_)));
  assign new_n82_ = (~x07 | (x39 & x40)) & (~x40 | ~x05 | ~x39);
  assign new_n83_ = (x30 | x32) & x40 & x05 & x39;
  assign new_n84_ = (x31 | ~x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n86_ | (~x09 & ~x30 & (new_n87_ | new_n88_ | new_n89_));
  assign new_n86_ = x40 & (~x31 | (~x09 & ~x30 & x04 & ~x08));
  assign new_n87_ = x04 & x27 & (~x29 | ~x39 | ~x40);
  assign new_n88_ = (x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n89_ = ~x08 & (~x27 | x28 | ~x35);
  assign z12 = (x31 & (new_n92_ | (~new_n91_ & (x04 | ~x39)))) | (~new_n91_ & ~x40);
  assign new_n91_ = x27 & (x37 | (x28 & x35));
  assign new_n92_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = (~new_n97_ & x40) | (x27 & (new_n96_ | (~new_n94_ & new_n95_)));
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = x40 & ~x13 & ~x04 & x39;
  assign new_n96_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n97_ = x31 & ((~x30 & ~x32) | x13 | x04 | ~x39);
  assign z14 = (~new_n91_ & (~new_n95_ | new_n100_)) | new_n69_ | (~new_n99_ & (~new_n95_ | new_n101_));
  ...
  assign z18 = new_n69_ | ~new_n108_ | (new_n107_ & (new_n106_ | ~x27));
  assign new_n106_ = x29 & x39 & x40;
  assign new_n107_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n108_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = new_n69_ | (new_n108_ & (~new_n107_ | (~new_n106_ & x27)));
  assign z20 = new_n69_ | (~new_n107_ & ~x09 & ~x30 & (~x27 | ~x35));
