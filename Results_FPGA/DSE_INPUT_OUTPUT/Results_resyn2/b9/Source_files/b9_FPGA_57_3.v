...
module FAU ( 
  ...
  assign new_n66_ = x40 & ~x19 & x39 & ~x04 & ~x15;
  ...
  assign z07 = new_n67_ | (new_n80_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  assign new_n80_ = x03 & (~x14 | ((x15 | ~x17) & ~x31 & ~x33));
  assign z09 = ~new_n67_ & x11 & x34 & x26 & x27;
  assign z10 = new_n84_ | ((new_n83_ | (x06 & x37)) & ~new_n85_ & x27);
  assign new_n83_ = (x07 | (x39 & x40)) & ~x04 & (new_n70_ | x36);
  assign new_n84_ = x05 & ~x19 & x40 & ~new_n71_ & ~x04 & x39;
  assign new_n85_ = x40 & (x19 | ((~x06 | ~x37) & ~x05 & x39));
  ...
  assign z12 = (~x19 & (new_n91_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = ~x19 & ((~new_n71_ & new_n94_) | (x27 & (new_n95_ | (~new_n93_ & new_n94_))));
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = ~x04 & ~x13 & x39 & x40;
  assign new_n95_ = ~x18 & x20 & (x37 | (x28 & x35));
  ...
  assign z20 = new_n67_ | (~new_n88_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z14 = ~z13;
