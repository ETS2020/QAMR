...
module FAU ( 
  ...
  assign z01 = (~x04 & (x09 | x32)) | (new_n70_ & x09);
  ...
  assign new_n81_ = x03 & (x09 | x32);
  assign z08 = new_n72_ | new_n73_;
  assign z09 = x11 & ~new_n73_ & x34 & x26 & x27;
  assign z10 = ~new_n86_ | ((new_n72_ | new_n85_) & ~new_n70_ & ~x04 & (~new_n72_ | x05));
  assign new_n85_ = x07 & x27 & (x36 | (~x28 & x35));
  assign new_n86_ = (x09 | x32) & (~x37 | ~x06 | ~x27);
  assign z11 = ~x09 & (~x32 | (~x30 & (new_n88_ | (~new_n89_ & ~new_n90_))));
  assign new_n88_ = ~x08 & ((x04 & x39) | ~x27 | x28 | ~x35);
  assign new_n89_ = x29 & x39 & x40;
  assign new_n90_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = new_n73_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = (x27 & (new_n96_ | (new_n94_ & ~new_n95_))) | new_n73_ | (~new_n93_ & new_n94_);
  ...
  assign new_n99_ = x09 & (x30 | (x27 & (x37 | ~x28 | x35)));
  ...
  assign z18 = x09 | (x32 & (~new_n107_ | (new_n106_ & (new_n89_ | ~x27))));
  assign new_n106_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n107_ = ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = (~x08 | (~new_n109_ & ~new_n89_) | (~new_n89_ & x27)) & new_n110_ & (x04 | ~new_n109_ | ~x27);
  assign new_n109_ = ~x28 & x35;
  assign new_n110_ = x32 & ~x09 & ~x30;
  assign z20 = ~new_n106_ & new_n110_ & (~x27 | ~x35);
endmodule
