...
module FAU ( 
  ...
  assign z13 = (new_n93_ & new_n94_) | (x27 & (new_n91_ | (~new_n92_ & new_n93_ & ~x32)));
  assign new_n91_ = ~new_n66_ & ~new_n68_ & x20 & ~x18 & ~x19;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x04 & ~x13 & x39 & x40;
  assign new_n94_ = x32 ? x05 : x30;
  assign z14 = new_n97_ | new_n68_ | (~new_n96_ & (~x20 | x18 | x19));
  assign new_n96_ = new_n93_ & (~new_n92_ | x30 | x32);
  assign new_n97_ = (new_n66_ | ~x27) & (~new_n93_ | (~x30 & ~x32 & (~x27 | x28)));
