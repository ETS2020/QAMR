...
module FAU ( 
  ...
  assign new_n82_ = new_n67_ & (x30 | x32) & x05 & (~x20 | ~x32);
  assign new_n83_ = ~new_n70_ & ~x04 & (~new_n73_ | (x05 & ~x32)) & (new_n73_ | x07);
  ...
  assign z13 = (new_n91_ & (~new_n92_ ^ (x20 & x32))) | (new_n90_ & ~x32 & new_n93_ & x20);
  ...
  assign z14 = ((~new_n93_ | ~x20) & (~new_n91_ | new_n96_)) | ((new_n95_ | x32) & (~new_n91_ | x20 | ~x32));
  assign new_n95_ = (new_n66_ | ~x27) & (~new_n91_ | (~x30 & (~x27 | x28)));
