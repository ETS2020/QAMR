...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x21 | ~x32)) | (~new_n70_ & ~x30 & ~x32);
  ...
  assign new_n81_ = ((~new_n70_ & ~x30) | ~x05 | ~x39 | ~x40) & (~new_n70_ | ~x07 | (x39 & x40));
  assign new_n82_ = x32 & (x21 | (new_n67_ & x05));
  ...
  assign new_n89_ = (~new_n90_ | (~x30 & ~x32)) & (~x27 | (~new_n92_ & (~new_n90_ | new_n91_)));
