...
module FAU ( 
  ...
  assign z02 = (x39 ^ x40) | (x40 & (new_n71_ | (~new_n72_ & ~x02)));
  ...
  assign new_n83_ = (~x05 | ~x39 | ~x40) & (~x07 | (~x39 & ~x40) | (x39 & x40));
  assign new_n84_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n85_ = (x39 | x40) & x06 & x37;
  assign new_n86_ = x05 & (x30 | x32) & ~x04 & x39 & x40;
  assign z11 = (~x39 & ~x40) | (new_n89_ & (~new_n88_ | (x27 & (~x29 | ~x39 | ~x40))));
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n89_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n68_ | (~new_n93_ & (~x27 | (new_n91_ & ~new_n92_)));
  assign new_n91_ = ~x37 & (~x28 | ~x35);
  assign new_n92_ = (x35 | x36) & ~x04 & x39 & x40;
  assign new_n93_ = x10 & ~x04 & x39 & x40;
  assign z13 = ~new_n98_ | (x27 & ((~new_n91_ & new_n97_) | (new_n95_ & ~new_n96_)));
  assign new_n95_ = ~x13 & ~x04 & x39 & x40;
  assign new_n96_ = x28 & (~x35 | ~x36);
  assign new_n97_ = x20 & ~x18 & ~x19;
  assign new_n98_ = (x39 | x40) & ((~x30 & ~x32) | x13 | x04 | ~x39 | ~x40);
  assign z14 = ~new_n68_ & ((~new_n97_ & (~new_n95_ | new_n101_)) | (~new_n100_ & (~new_n95_ | new_n102_)));
  ...
  assign z19 = ((~x39 & ~x40) | (~new_n107_ & ~x09 & ~x30)) & (~new_n72_ | ~x39 | ~x40);
  assign new_n107_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z20 = ~new_n88_ & (~x27 | ~x35) & ~new_n68_ & ~x09 & ~x30;
  assign z18 = ((x39 | x40) & (new_n107_ | x09 | x30)) | (new_n72_ & x39 & x40);
endmodule
