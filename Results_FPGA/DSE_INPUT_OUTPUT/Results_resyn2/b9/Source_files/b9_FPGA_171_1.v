...
module FAU ( 
  ...
  assign z11 = (~x39 & x40) | (new_n83_ & (~new_n85_ | (x27 & (~x29 | ~x40))));
  assign new_n83_ = new_n84_ & (x04 | ~x27 | x28 | ~x35);
  assign new_n84_ = ~x09 & ~x30;
  assign new_n85_ = x08 & ((~x28 & x35) | (x29 & x40));
  assign z12 = new_n65_ | new_n67_;
  assign z13 = new_n88_ | (~new_n70_ & z08 & new_n93_);
  ...
  assign z14 = new_n96_ | (~new_n95_ & new_n70_ & x39);
  assign new_n95_ = x27 & (~new_n90_ | (new_n92_ & (x35 | x37)));
  assign new_n96_ = ((~new_n93_ & x39) | ~x40) & (~new_n92_ | new_n89_ | ~x27);
  assign z15 = new_n67_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (x39 | ~x40) & (new_n101_ | ~new_n84_ | (x08 & x29 & x40));
  assign new_n101_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign z20 = new_n67_ | (~new_n85_ & new_n84_ & (~x27 | ~x35));
  assign z05 = ~z06;
  assign z19 = (~x39 & x40) | (new_n83_ & (~new_n85_ | (x27 & (~x29 | ~x40))));
endmodule
