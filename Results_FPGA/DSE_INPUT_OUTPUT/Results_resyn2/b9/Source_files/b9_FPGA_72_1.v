...
module FAU ( 
  ...
  assign z11 = new_n85_ & (~new_n84_ | (x27 & (~x29 | ~x40)));
  assign new_n84_ = x08 & (new_n71_ | (x29 & x40));
  ...
  assign new_n97_ = (x39 | ~x40) & ((new_n87_ & new_n93_) | (x40 & ~x04 & ~x13));
  ...
  assign z18 = ~new_n85_ | (new_n84_ & (~x27 | (x29 & x40)));
  assign z08 = x40;
  assign z19 = new_n85_ & (~new_n84_ | (x27 & (~x29 | ~x40)));
endmodule
