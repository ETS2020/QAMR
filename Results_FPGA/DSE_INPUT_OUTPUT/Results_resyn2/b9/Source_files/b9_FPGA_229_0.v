...
module FAU ( 
  ...
  assign new_n85_ = (x39 & x40) ? (x05 & x13) : x07;
  assign new_n86_ = (x13 | x32) & x06 & x37;
  assign new_n87_ = ~x32 & (~x13 | ~x30);
  ...
  assign new_n93_ = ~x09 & ~x30 & (x13 | x32);
  assign z12 = ~new_n73_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = (x13 | x32) & ((~x13 & new_n72_ & ~x04) | (~new_n65_ & new_n96_));
  ...
  assign z14 = (~x13 & ~x32) | ((x13 | ~new_n72_ | x04) & (new_n65_ | ~new_n96_));
