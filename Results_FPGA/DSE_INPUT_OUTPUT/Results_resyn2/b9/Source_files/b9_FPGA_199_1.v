...
module FAU ( 
  ...
  assign new_n74_ = (x02 | (x08 & x29)) & x31 & x39 & x40;
  ...
  assign z19 = (~new_n109_ | new_n110_) & ~new_n111_ & new_n112_;
  assign new_n109_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n110_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n111_ = ~x04 & x27 & ~x28 & x35;
  assign new_n112_ = ~x09 & ~x30 & (x31 | ~x40);
  assign z20 = new_n70_ | (~new_n109_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z18 = (new_n109_ & ~new_n110_) | new_n111_ | ~new_n112_;
endmodule
