...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n90_, new_n93_, new_n98_, new_n99_;
  ...
  assign z19 = (~x08 | (~new_n98_ & ~new_n88_) | (~new_n88_ & x27)) & new_n99_ & (~new_n98_ | x04 | ~x27);
  assign new_n98_ = ~x28 & x35;
  assign new_n99_ = x32 & ~x09 & ~x30;
  assign z20 = ~new_n89_ & new_n99_ & (~x27 | ~x35);
  assign z14 = new_n70_ | ((new_n65_ | ~new_n93_) & (x13 | ~new_n72_ | x04));
  assign z18 = x30 | (x32 & (~new_n90_ | (new_n89_ & (new_n88_ | ~x27))));
endmodule
