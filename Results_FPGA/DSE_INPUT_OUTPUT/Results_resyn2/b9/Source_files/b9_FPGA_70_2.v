...
module FAU ( 
  ...
  assign z10 = (~new_n84_ & x27 & (~x05 | x32)) | (new_n67_ & x05 & x32);
  assign new_n84_ = (~x06 | ~x37) & (new_n70_ | new_n74_ | x04 | ~x07);
  assign z11 = new_n87_ & (~new_n86_ | (x27 & (~new_n74_ | ~x29)));
  assign new_n86_ = x08 & (new_n73_ | (new_n74_ & x29));
  assign new_n87_ = (~new_n73_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = (~new_n90_ & x27) | (new_n93_ & (x32 | (~x05 & x30)));
  assign new_n90_ = (~new_n91_ | new_n66_ | (x05 & ~x32)) & (new_n92_ | ~new_n93_ | x05);
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = new_n95_ | (~new_n97_ & ~x32);
  assign new_n95_ = (~new_n91_ | ~new_n96_) & (~new_n93_ | (new_n92_ & ~new_n91_ & ~x30 & ~x32));
  assign new_n96_ = x27 & (x37 | (x28 & x35));
  assign new_n97_ = ~x05 & (x30 | (x27 & (x37 | ~x28 | x35)));
