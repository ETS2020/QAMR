...
module FAU ( 
  ...
  assign new_n88_ = ~x04 & x39 & x40 & (x30 | x32) & x05 & (~x30 | ~x32);
  ...
  assign z13 = (x27 & (new_n96_ | (~new_n94_ & new_n95_))) | ((x30 | x32) & (new_n95_ | (x30 & x32)));
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = x39 & x40 & ~x04 & ~x13;
  assign new_n96_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = ((~x30 & ~x32) | (~new_n95_ & (~x30 | ~x32))) & (~x27 | (~new_n96_ & (new_n94_ | (~new_n95_ & (~x30 | ~x32)))));
