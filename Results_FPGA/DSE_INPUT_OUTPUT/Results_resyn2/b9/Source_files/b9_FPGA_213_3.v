...
module FAU ( 
  ...
  assign z01 = (~new_n70_ & ~x30 & ~x32) | ~x04 | (x29 & x32);
  assign new_n70_ = x27 & (x36 | (~x28 & x35));
  assign z02 = ~new_n72_ | (x04 & (x28 | ~x35 | (~x08 & ~x27)));
  assign new_n72_ = (x02 | (x08 & x29)) & x39 & x40 & (~x29 | ~x32);
  ...
  assign z18 = (~new_n85_ & (~x29 | ~x32)) | (x08 & x29 & ~x32 & x39 & x40);
  assign z20 = ~new_n100_ & (~x27 | ~x35) & ~new_n68_ & ~x09 & ~x30;
  assign new_n100_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z19 = new_n85_ & (~x29 | (~x32 & (~x08 | ~x39 | ~x40)));
endmodule
