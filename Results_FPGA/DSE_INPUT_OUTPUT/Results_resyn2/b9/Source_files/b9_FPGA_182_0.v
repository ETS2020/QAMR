...
module FAU ( 
  ...
  assign new_n68_ = ~x24 & ~x32;
  assign z01 = ~x04 | (~x32 & (~x24 | (~new_n70_ & ~x30)));
  ...
  assign new_n82_ = ((new_n72_ & ~new_n83_) | (new_n70_ & (new_n72_ | x07))) & ~x04 & (~new_n72_ | x05);
  ...
  assign z14 = (new_n90_ | ~x27) & ~new_n68_ & (new_n83_ | ~new_n91_);
  ...
  assign z05 = ~z06;
  assign z13 = (~new_n90_ & x27) | new_n68_ | (~new_n83_ & new_n91_);
