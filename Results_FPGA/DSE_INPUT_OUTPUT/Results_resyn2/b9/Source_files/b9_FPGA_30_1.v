...
module FAU ( 
  ...
  assign z10 = new_n82_ | new_n67_ | (x37 & x06 & x27);
  assign new_n82_ = ((~new_n70_ & x40) | (new_n69_ & (x07 | x40))) & ~x04 & (x05 | ~x40);
  assign z11 = new_n84_ | new_n67_;
  assign new_n84_ = new_n86_ & (~new_n85_ | (x27 & (~x29 | ~x40)));
  assign new_n85_ = x08 & ((~x28 & x35) | (x29 & x40));
  assign new_n86_ = (x28 | ~x35 | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n67_;
  assign z13 = new_n89_ | (~new_n70_ & x40 & new_n91_ & x39);
  assign new_n89_ = x27 & ((new_n90_ & (x39 | ~x40)) | (new_n91_ & x40 & ~new_n92_ & x39));
  assign new_n90_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n91_ = ~x04 & ~x13;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign z14 = ~new_n95_ | (new_n70_ & (new_n94_ | ~x27));
  assign new_n94_ = new_n92_ & ((~x35 & ~x37) | ~x20 | x18 | x19);
  assign new_n95_ = (x39 | ~x40) & ((new_n91_ & x40) | (new_n90_ & x27));
  assign z15 = x12 & ~new_n67_ & x34 & x26 & x27;
  assign z16 = new_n67_ | (~x23 & x01 & x22);
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z19 = new_n84_ & ~new_n67_;
  assign z20 = ~new_n85_ & (~x27 | ~x35) & ~new_n67_ & ~x09 & ~x30;
  assign z18 = ~new_n84_ | new_n67_;
endmodule
