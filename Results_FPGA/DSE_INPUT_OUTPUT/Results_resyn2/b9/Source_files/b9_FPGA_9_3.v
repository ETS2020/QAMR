...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n92_, new_n93_, new_n94_, new_n101_;
  ...
  assign z13 = new_n91_ | (~x04 & ~x13 & (x30 | x32) & new_n73_ & (~x30 | ~x32));
  ...
  assign z14 = ((~x30 & ~x32 & (new_n94_ | ~x27)) | (~new_n93_ & (~x30 | ~x32))) & (~new_n92_ | ~x27);
  ...
  assign z20 = x30 ? x32 : (new_n101_ & (~x08 | (~new_n70_ & ~new_n88_)));
