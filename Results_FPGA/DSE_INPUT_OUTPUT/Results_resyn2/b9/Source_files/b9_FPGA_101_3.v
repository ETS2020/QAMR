...
module FAU ( 
  ...
  assign new_n85_ = ~x04 & (~x30 | ~x32) & (x36 | (~x28 & x35));
  assign new_n86_ = (x39 & x40) ? (x05 & ~x30) : x07;
  assign new_n87_ = (~x30 | ~x32) & x06 & x37;
  assign new_n88_ = ~x04 & x05 & (x30 | x32) & (~x30 | ~x32) & x39 & x40;
  assign z11 = x30 ? x32 : (new_n92_ & (~new_n90_ | new_n91_));
  assign new_n90_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n91_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n92_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n72_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = new_n95_ | (new_n96_ & (new_n97_ | (~new_n98_ & new_n99_ & ~x30)));
  assign new_n95_ = (x30 | x32) & (~x30 | ~x32) & x39 & x40 & ~x04 & ~x13;
  assign new_n96_ = x27 & (~x30 | ~x32);
  assign new_n97_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n98_ = x28 & (~x35 | ~x36);
  assign new_n99_ = x39 & x40 & ~x04 & ~x13;
  assign z14 = (~new_n101_ & (~new_n99_ | new_n102_)) | new_n72_ | (~new_n103_ & (~new_n99_ | new_n104_));
  ...
  assign z15 = new_n96_ & x34 & x12 & x26;
  assign z16 = x01 & x22 & ~new_n72_ & ~x23;
  assign z17 = new_n72_ | (x01 & x22 & x23 & ~x24);
  assign z20 = ~new_n90_ & (~x27 | ~x35) & ~x09 & ~x30;
  assign z18 = x30 ? ~x32 : (~new_n92_ | (new_n90_ & ~new_n91_));
  assign z19 = x30 ? x32 : (new_n92_ & (~new_n90_ | new_n91_));
endmodule
