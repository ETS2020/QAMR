...
module FAU ( 
  ...
  assign z13 = (x27 | (new_n91_ & x32)) & ((~new_n92_ & new_n91_ & ~x30) | new_n90_ | (new_n91_ & x32));
  ...
  assign new_n94_ = new_n91_ & (~new_n92_ | x32);
  assign new_n95_ = (~new_n66_ | (new_n91_ & (~x28 | x32))) & (~x30 | x32) & (x27 | (new_n91_ & x32));
  assign z15 = new_n68_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z20 = new_n100_ & (~x08 | (~new_n70_ & ~new_n87_));
  assign new_n100_ = ~x09 & ~x30 & (~x27 | ~x35);
