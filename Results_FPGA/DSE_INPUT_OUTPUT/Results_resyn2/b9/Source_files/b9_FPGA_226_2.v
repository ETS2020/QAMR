...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n69_, new_n71_, new_n72_, new_n78_,
    ...
    new_n100_, new_n101_;
  assign z00 = (~new_n65_ & (~x32 | x37)) | ((x37 | (~new_n66_ & ~x32)) & ~x15 & x27);
  assign new_n65_ = x16 & (x04 | ~x39 | ~x40 | ~x10 | x15);
  assign new_n66_ = (~x28 | ~x35) & (x04 | ~x39 | ~x40 | (~x35 & ~x36));
  assign z01 = new_n69_ | new_n68_ | ~x04;
  assign new_n68_ = x32 & ~x37;
