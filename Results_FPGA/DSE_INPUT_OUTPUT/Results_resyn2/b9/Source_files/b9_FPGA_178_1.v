...
module FAU ( 
  ...
  assign z11 = new_n87_ & (~new_n86_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n86_ = x08 & (new_n74_ | (x29 & x39 & x40));
  assign new_n87_ = (~new_n74_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = (~new_n90_ & x27) | ((new_n68_ | ~new_n71_) & (new_n68_ | new_n92_));
  assign new_n90_ = (new_n91_ | ~new_n92_) & (new_n66_ | ~new_n93_);
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = ~x04 & ~x13 & x39 & x40;
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n93_ & ((new_n71_ & new_n91_) | (~new_n68_ & ~new_n92_))) | (~new_n95_ & ((~new_n68_ & new_n71_) | (~new_n68_ & ~new_n92_)));
  assign new_n95_ = x27 & (~new_n66_ | (new_n92_ & ~x28));
  assign z15 = ~new_n68_ & x12 & x26 & x27 & x34;
  assign z16 = x01 & x22 & ~x23 & ~x32;
  assign z17 = x01 & x22 & x23 & ~x24;
  assign z20 = ~new_n86_ & ~new_n68_ & ~x09 & ~x30 & (~x27 | ~x35);
  assign z06 = ~z05;
  assign z18 = ~new_n87_ | (new_n86_ & (~x27 | (x29 & x39 & x40)));
  assign z19 = new_n87_ & (~new_n86_ | (x27 & (~x29 | ~x39 | ~x40)));
endmodule
