...
module FAU ( 
  ...
  assign z02 = ~new_n73_ | ((~new_n72_ | (~x08 & ~x27)) & ~new_n68_ & x04);
  assign new_n72_ = ~x28 & x35;
  assign new_n73_ = ((x29 & x32) | (x39 & x40)) & (x02 | (x29 & (x08 | x32)));
  ...
  assign new_n83_ = x32 & (x29 | (new_n67_ & x05));
  assign z11 = new_n86_ & (~new_n85_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n85_ = x08 & (new_n72_ | (x29 & x39 & x40));
  assign new_n86_ = (~new_n72_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = ~new_n89_ & ~new_n68_;
  assign new_n89_ = (~x27 | (~new_n92_ & (~new_n90_ | new_n91_))) & (~new_n90_ | (~x30 & ~x32));
  ...
  assign z20 = ~new_n85_ & ~new_n68_ & ~x09 & ~x30 & (~x27 | ~x35);
  assign z06 = ~z05;
  assign z14 = new_n89_ | new_n68_;
  assign z18 = ~new_n86_ | (new_n85_ & (~x27 | (x29 & x39 & x40)));
  assign z19 = new_n86_ & (~new_n85_ | (x27 & (~x29 | ~x39 | ~x40)));
endmodule
