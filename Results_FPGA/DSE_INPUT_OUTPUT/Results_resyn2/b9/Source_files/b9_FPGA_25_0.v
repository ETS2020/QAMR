// Benchmark "FAU" written by ABC on Tue Aug 11 21:45:39 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n77_, new_n80_, new_n81_, new_n83_, new_n86_, new_n87_, new_n88_,
  ...
  assign z01 = (x32 | x35) & (~x04 | (~new_n70_ & ~x30 & ~x32));
  ...
  assign z03 = ((x27 | ~x37) & (~x28 | ~x27 | ~x35)) | ~x21 | (~x32 & ~x35);
  assign z04 = (x32 | x35) & (x21 | ((x27 | ~x37) & (~x28 | ~x27 | ~x35)));
  ...
  assign new_n81_ = x03 & (x32 | x35);
  assign z08 = new_n83_ | new_n77_;
  assign new_n83_ = x39 & x40;
  assign z09 = new_n77_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n89_ | (~x04 & ((~new_n86_ & new_n87_) | (new_n70_ & new_n88_)));
  assign new_n86_ = x35 & ~x30 & ~x32 & (~x27 | (x28 & ~x36));
  assign new_n87_ = x05 & x39 & x40;
  assign new_n88_ = (~x39 | ~x40) & x07 & (x35 | x36);
  assign new_n89_ = (x32 | x35) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n77_ | (new_n92_ & (~new_n91_ | (x27 & (~new_n83_ | ~x29))));
  assign new_n91_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n92_ = (x28 | ~x35 | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = ~new_n77_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = new_n77_ | new_n97_ | (x27 & (new_n96_ | (~new_n65_ & new_n95_)));
  ...
  assign z15 = new_n77_ | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~new_n77_ & ~x23;
  assign z17 = new_n77_ | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n77_ | ~new_n92_ | (new_n91_ & (~x27 | (new_n83_ & x29)));
  assign z20 = ~new_n91_ & ~x09 & ~x30 & (x32 | x35) & (~x27 | ~x35);
  assign z19 = new_n77_ | (new_n92_ & (~new_n91_ | (x27 & (~new_n83_ | ~x29))));
endmodule
