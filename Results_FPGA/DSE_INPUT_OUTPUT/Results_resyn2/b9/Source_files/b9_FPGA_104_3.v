...
module FAU ( 
  ...
  assign z13 = ~new_n68_ & ((~new_n90_ & new_n91_) | (new_n92_ & ~new_n66_ & x27));
  assign new_n90_ = new_n71_ & (~x27 | (x28 & (~x35 | ~x36)));
  assign new_n91_ = ~x04 & ~x13 & x39 & x40;
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign z14 = new_n95_ | (~new_n94_ & ~new_n92_);
  assign new_n94_ = (new_n68_ | new_n91_) & (~new_n71_ | ~x28 | (x35 & x36));
  assign new_n95_ = (~new_n91_ | (new_n71_ & (~x27 | x28))) & ~new_n68_ & (new_n66_ | ~x27);
