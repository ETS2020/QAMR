...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n71_, new_n72_, new_n73_,
    new_n78_, new_n82_, new_n84_, new_n85_, new_n88_, new_n89_, new_n95_;
  ...
  assign z11 = ~x30 & (new_n84_ | ~x32);
  assign new_n84_ = (~x08 | (~new_n72_ & ~new_n85_) | (~new_n85_ & x27)) & ~x09 & (~new_n72_ | x04 | ~x27);
  assign new_n85_ = x29 & x39 & x40;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = ~new_n88_ & ~new_n68_;
  assign new_n88_ = (new_n66_ | ~new_n89_) & (~new_n67_ | x13);
  assign new_n89_ = ~x18 & ~x19 & x20 & x27;
  assign z14 = new_n88_ & ~new_n68_;
  assign z15 = ~new_n68_ & x12 & x26 & x27 & x34;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z20 = ~x30 & (~x32 | (new_n95_ & (~x08 | (~new_n72_ & ~new_n85_))));
  assign new_n95_ = ~x09 & (~x27 | ~x35);
  assign z05 = ~z06;
  assign z18 = x30 | (~new_n84_ & x32);
  assign z19 = ~x30 & (new_n84_ | ~x32);
endmodule
