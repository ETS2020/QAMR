...
module FAU ( 
  ...
  assign z01 = (~x04 & (x05 | ~x32)) | (~x30 & ~x32 & (new_n70_ | ~x27));
  ...
  assign z10 = new_n85_ | (x27 & (new_n84_ | (~new_n68_ & x06 & x37)));
  assign new_n84_ = (x05 | (~new_n73_ & ~x32)) & (new_n73_ | x07) & ~new_n70_ & ~x04;
  assign new_n85_ = new_n67_ & x05 & (x30 | x32);
  ...
  assign z13 = (x27 & ((new_n91_ & (x05 | ~x32)) | (new_n92_ & ~x32))) | (new_n93_ & (x05 | ~x32));
  assign new_n91_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n92_ = new_n73_ & ~x04 & ~x13 & (~x28 | (x35 & x36));
  assign new_n93_ = (x30 | x32) & new_n73_ & ~x04 & ~x13;
