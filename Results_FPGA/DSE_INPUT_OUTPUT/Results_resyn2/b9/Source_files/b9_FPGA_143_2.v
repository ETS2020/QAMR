...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n68_, new_n69_, new_n71_, new_n73_, new_n79_,
    new_n82_, new_n84_, new_n85_, new_n88_, new_n89_, new_n90_, new_n91_,
    new_n92_, new_n94_, new_n95_, new_n100_, new_n103_;
  ...
  assign z01 = ~new_n68_ & (~x04 | (~new_n69_ & ~x30 & ~x32));
  ...
  assign new_n82_ = ((~new_n69_ & ~x30 & ~x32) | ~x05 | ~x39) & (~new_n69_ | ~x07 | x39);
  assign z11 = new_n84_ & ~new_n68_;
  assign new_n84_ = new_n85_ & (~x08 | (~new_n73_ & (~x29 | ~x39)) | (x27 & (~x29 | ~x39)));
  assign new_n85_ = (x28 | ~x35 | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = ~new_n65_ & (~x39 | (~new_n66_ & x40));
  assign z13 = new_n88_ | (new_n92_ & (x30 | x32));
  assign new_n88_ = x27 & ((~new_n91_ & new_n92_) | (new_n90_ & ~new_n68_ & ~new_n89_));
  assign new_n89_ = ~x37 & (~x28 | ~x35);
  assign new_n90_ = x20 & ~x18 & ~x19;
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign z14 = ~new_n95_ | (~new_n94_ & ~x30 & ~x32);
  assign new_n94_ = x27 & (~new_n91_ | (new_n90_ & (x35 | x37)));
  assign new_n95_ = (~x39 | x40) & ((new_n65_ & new_n90_) | (x39 & ~x04 & ~x13));
  assign z15 = new_n68_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z18 = ~new_n68_ & (~new_n100_ | (new_n73_ & (x08 | x27) & (~x04 | ~x27)));
  assign new_n100_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x39);
  assign z19 = new_n84_ | new_n68_;
  assign z20 = (x39 & ~x40) | (new_n103_ & (~x08 | (~new_n73_ & (~x29 | ~x39))));
