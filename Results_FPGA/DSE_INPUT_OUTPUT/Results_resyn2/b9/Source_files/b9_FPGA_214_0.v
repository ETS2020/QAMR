...
module FAU ( 
  ...
  assign z10 = ~new_n86_ | ((z08 | new_n85_) & ~new_n71_ & ~x04 & (~z08 | x05));
  assign new_n85_ = x07 & x27 & (x36 | (~x28 & x35));
  assign new_n86_ = (x39 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = (~x08 | (~new_n88_ & (~new_n73_ | x27))) & new_n89_ & (~new_n73_ | x04 | ~x27);
  assign new_n88_ = x40 & x29 & x39;
  assign new_n89_ = ~x09 & ~x30 & (x39 | x40);
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = (x27 & ((new_n95_ & new_n96_) | (~new_n93_ & new_n94_))) | (~new_n92_ & new_n94_);
  ...
  assign z14 = (~new_n98_ & (~new_n94_ | new_n99_)) | new_n70_ | (~new_n95_ & (~new_n94_ | new_n100_));
  ...
  assign z19 = ((~x39 & ~x40) | (~new_n106_ & ~x09 & ~x30)) & (~new_n105_ | ~x39 | ~x40);
  assign new_n105_ = x08 & x29;
  assign new_n106_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z20 = (~x08 | (~new_n88_ & (x28 | ~x35))) & new_n89_ & (~x27 | ~x35);
