...
module FAU ( 
  ...
  assign z01 = (~x04 & (x31 | x32)) | (x31 & ~new_n70_ & ~x30 & ~x32);
  ...
  assign z13 = (~new_n90_ & x27) | (new_n92_ & (x32 | (x30 & x31)));
  assign new_n90_ = (~new_n91_ | new_n66_ | (~x31 & ~x32)) & (~new_n92_ | new_n93_ | ~x31);
  ...
  assign new_n96_ = x31 & (x30 | (x27 & (x37 | ~x28 | x35)));
