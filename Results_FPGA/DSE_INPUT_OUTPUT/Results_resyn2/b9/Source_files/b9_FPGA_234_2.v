...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n75_, new_n79_, new_n83_, new_n84_, new_n85_, new_n87_, new_n88_,
  ...
  assign z13 = ~new_n95_ | (x27 & (new_n94_ | (new_n92_ & ~new_n93_)));
  assign z18 = x30 ? x32 : (~new_n89_ | (new_n87_ & ~new_n88_));
  assign z19 = x30 ? ~x32 : (new_n89_ & (~new_n87_ | new_n88_));
endmodule
