...
module FAU ( 
  ...
  assign new_n84_ = (~x07 | (x39 & x40) | (~x11 & x32)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n85_ = ~new_n71_ & ~new_n68_ & x39 & x40;
  assign z11 = new_n88_ & (~new_n87_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n87_ = x08 & (new_n74_ | (x29 & x39 & x40));
  assign new_n88_ = (~new_n74_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = new_n92_ | (x27 & (new_n91_ | (~new_n93_ & new_n94_ & ~x32)));
  assign new_n91_ = ~new_n66_ & ~new_n68_ & x20 & ~x18 & ~x19;
  assign new_n92_ = ~x04 & ~x13 & ~new_n71_ & ~new_n68_ & x39 & x40;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = (~new_n96_ & (~x20 | x18 | x19)) | new_n97_ | new_n68_;
  assign new_n96_ = new_n94_ & (~new_n71_ | ~new_n93_);
  assign new_n97_ = (new_n66_ | ~x27) & (~new_n94_ | (new_n71_ & (~x27 | x28)));
  ...
  assign z06 = ~z05;
  assign z18 = ~new_n88_ | (new_n87_ & (~x27 | (x29 & x39 & x40)));
