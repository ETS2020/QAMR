...
module FAU ( 
  ...
  assign z02 = ~x40 | (x13 & (new_n73_ | ~new_n74_));
  ...
  assign z10 = (x27 & (new_n87_ | (~new_n85_ & new_n86_))) | (new_n84_ & new_n88_);
  assign new_n84_ = x40 & ~x04 & x39;
  assign new_n85_ = (~x07 | (x40 & (~x13 | x39))) & (~x05 | ~x40 | ~x13 | ~x39);
  assign new_n86_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n87_ = (x13 | ~x40) & x06 & x37;
  assign new_n88_ = x05 & x13 & (x30 | x32);
  assign z11 = ~new_n70_ & new_n92_ & (~new_n91_ | (~new_n90_ & x27));
  assign new_n90_ = x40 & x29 & x39;
  assign new_n91_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign new_n92_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = (x13 & (new_n94_ | (~new_n95_ & (x04 | ~x39)))) | (~new_n95_ & ~x40);
  assign new_n94_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign new_n95_ = x27 & (x37 | (x28 & x35));
  assign z14 = ~new_n70_ & (~new_n95_ | ~x20 | x18 | x19);
  ...
  assign z20 = new_n70_ | (~new_n91_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z13 = new_n70_ | (new_n95_ & x20 & ~x18 & ~x19);
