...
module FAU ( 
  ...
  assign new_n84_ = (~x07 | (x09 & x32) | (x39 & x40)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n85_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n86_ = (~x09 | ~x32) & x06 & x37;
  assign new_n87_ = (x30 | x32) & x39 & x40 & (~x09 | ~x32);
  ...
  assign z13 = (new_n87_ & new_n94_) | (new_n98_ & (new_n95_ | (~new_n96_ & new_n97_)));
  ...
  assign new_n98_ = x27 & (~x09 | ~x32);
  assign z14 = (~new_n100_ & (~new_n101_ | new_n102_)) | new_n73_ | (~new_n103_ & (~new_n101_ | new_n104_));
