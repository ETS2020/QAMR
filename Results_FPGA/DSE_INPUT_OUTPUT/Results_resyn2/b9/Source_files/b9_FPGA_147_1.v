...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n74_, new_n79_, new_n83_, new_n85_, new_n88_, new_n89_, new_n90_,
  ...
  assign new_n83_ = (~new_n74_ | (x05 & (new_n70_ | x30))) & ~x04 & (new_n74_ | (new_n70_ & x07));
  assign z11 = ~x30 & (x32 | (new_n85_ & ~x09));
  assign new_n85_ = (~x08 | (~new_n73_ & (~new_n74_ | ~x29)) | (x27 & (~new_n74_ | ~x29))) & (~new_n73_ | x04 | ~x27);
  assign z12 = new_n65_ | new_n68_;
  assign z13 = (x27 | (new_n89_ & x30)) & (new_n88_ | (new_n89_ & x30) | (~new_n90_ & new_n89_ & ~x32));
  assign new_n88_ = ~new_n68_ & ~new_n66_ & x20 & ~x18 & ~x19;
  ...
  assign z19 = new_n85_ & ~x32 & ~x09 & ~x30;
  assign z20 = new_n99_ & (~x08 | (~new_n73_ & (~new_n74_ | ~x29)));
  assign new_n99_ = (~x27 | ~x35) & ~x32 & ~x09 & ~x30;
  assign z06 = ~z05;
  assign z18 = x30 | (~x32 & (~new_n85_ | x09));
endmodule
