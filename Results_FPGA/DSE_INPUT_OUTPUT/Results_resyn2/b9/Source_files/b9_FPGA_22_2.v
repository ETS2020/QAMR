...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x09 | x32)) | (~new_n70_ & ~x09 & ~x30 & ~x32);
  ...
  assign z11 = x09 ? ~x32 : (new_n90_ & (~new_n88_ | new_n89_));
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n89_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n90_ = ~x30 & (x04 | ~x27 | x28 | ~x35);
  ...
  assign z19 = ~x09 & new_n90_ & (~new_n88_ | new_n89_);
  assign z20 = ~new_n88_ & (~x27 | ~x35) & ~x09 & ~x30;
  assign z18 = x09 ? x32 : (~new_n90_ | (new_n88_ & ~new_n89_));
endmodule
