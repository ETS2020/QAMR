...
module FAU ( 
  ...
  assign z01 = (~x04 & (x05 | x32)) | (x05 & ~new_n70_ & ~x30 & ~x32);
  ...
  assign new_n83_ = ((~new_n70_ & ~x30 & ~x32) | ~new_n72_ | (~x05 & x32)) & (~new_n70_ | new_n72_ | ~x07);
  ...
  assign z14 = (~new_n95_ & ~x32) | ((~new_n91_ | (~new_n92_ & new_n96_)) & (~new_n94_ | ~new_n92_));
  assign new_n94_ = ~new_n66_ & x27;
  assign new_n95_ = x05 & (x30 | (x27 & (x37 | ~x28 | x35)));
