...
module FAU ( 
  ...
  assign z03 = (x27 & (~x28 | ~x35)) | (~x27 & ~x37) | z08 | ~x21;
  ...
  assign z11 = ~new_n80_ & ~z08 & ~x09 & ~x30;
  assign new_n80_ = (~x04 | ~x27) & ~x28 & x35 & (x08 | x27);
  ...
  assign z02 = ~z08;
  assign z18 = new_n80_ | z08 | x09 | x30;
  assign z19 = ~new_n80_ & ~z08 & ~x09 & ~x30;
endmodule
