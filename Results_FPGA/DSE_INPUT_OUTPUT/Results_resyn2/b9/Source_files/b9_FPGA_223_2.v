...
module FAU ( 
  ...
  assign z01 = (~x36 | (x40 & (~x04 | ~x27))) & (new_n70_ | ~x04);
  assign new_n70_ = ~x30 & ~x32 & (~x35 | ~x27 | x28);
  assign z02 = (~new_n72_ & x04) | ~new_n68_ | (~x02 & (~x08 | ~x29));
  ...
  assign new_n83_ = (x36 | (x40 & ~x28 & x35)) & x05 & x39;
  assign new_n84_ = ((x36 & ~x39) | (~x28 & x35)) & x07 & (~x39 | ~x40);
  assign new_n85_ = (x30 | x32) & x05 & x39 & x40;
  assign new_n86_ = (~x36 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n65_ | (new_n89_ & (~new_n88_ | (x27 & (~new_n68_ | ~x29))));
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n89_ = ~x09 & ~x30 & (x04 | ~x35 | ~x27 | x28);
