...
module FAU ( 
  ...
  assign new_n80_ = (x15 | ~x17) & ~x31 & ~x33 & (~x25 | ~x38);
  ...
  assign z13 = (x27 & (new_n95_ | (~new_n93_ & new_n94_))) | new_n73_ | new_n96_;
  ...
  assign z14 = (~new_n99_ & ~x32) | ((~new_n94_ | (~new_n98_ & new_n100_)) & (~new_n98_ | ~new_n101_));
  assign new_n98_ = x20 & ~x18 & ~x19;
  assign new_n99_ = x25 & (x30 | (x27 & (x37 | ~x28 | x35)));
