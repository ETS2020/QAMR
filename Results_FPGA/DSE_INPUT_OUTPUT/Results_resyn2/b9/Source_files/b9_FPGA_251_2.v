...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x32 & (~new_n70_ | x30));
  ...
  assign z04 = ((x27 | ~x37) & (~x35 | ~x27 | ~x28)) | new_n73_ | x21;
  ...
  assign z10 = ~new_n87_ | (~x04 & ((new_n85_ & (new_n70_ | x32)) | (new_n70_ & new_n86_)));
  assign new_n85_ = x05 & x39 & x40;
  assign new_n86_ = x07 & (~x39 | ~x40);
  assign new_n87_ = (~x30 | x32) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n73_ | (new_n90_ & (~new_n89_ | (x27 & (~new_n72_ | ~x29))));
  ...
  assign z13 = (new_n93_ & x32) | (x27 & ((~x30 & new_n93_ & ~new_n94_) | (new_n95_ & (~x30 | x32))));
  ...
  assign new_n97_ = x32 ? (~x39 | ~x40 | x04 | x13) : ~x30;
  assign z15 = new_n73_ | (x27 & x34 & x12 & x26);
  assign z16 = new_n73_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n73_ & x23 & ~x24;
  assign z19 = new_n90_ & (~new_n89_ | (x27 & (~new_n72_ | ~x29)));
  assign z20 = ~new_n89_ & ~x09 & ~x30 & (~x27 | ~x35);
  assign z18 = ~new_n90_ | (new_n89_ & (~x27 | (new_n72_ & x29)));
endmodule
