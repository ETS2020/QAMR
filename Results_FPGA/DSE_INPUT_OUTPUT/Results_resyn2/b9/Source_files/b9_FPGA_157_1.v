// Benchmark "FAU" written by ABC on Tue Aug 11 21:46:27 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n90_, new_n93_, new_n94_, new_n95_, new_n97_;
  ...
  assign z01 = ~x04 | (~x30 & (~new_n70_ | x32));
  ...
  assign z07 = new_n73_ | (new_n80_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  assign new_n80_ = x03 & (~x14 | ((x15 | ~x17) & ~x31 & ~x33));
  assign z08 = new_n72_ & ~new_n73_;
  assign z09 = new_n73_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n86_ | (~x04 & ((new_n84_ & (new_n70_ | x30)) | (new_n70_ & new_n85_)));
  assign new_n84_ = x05 & x39 & x40;
  assign new_n85_ = x07 & (~x39 | ~x40);
  assign new_n86_ = (x30 | ~x32) & (~x37 | ~x06 | ~x27);
  assign z11 = ~x30 & (x32 | ((~new_n88_ | new_n89_) & ~new_n90_ & ~x09));
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n89_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n90_ = x27 & x35 & ~x04 & ~x28;
  assign z12 = new_n73_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = (x27 & ((~x32 & new_n93_ & ~new_n94_) | (new_n95_ & (x30 | ~x32)))) | (new_n93_ & x30);
  assign new_n93_ = x39 & x40 & ~x04 & ~x13;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = new_n97_ & (~x27 | (~new_n95_ & (~new_n93_ | new_n94_)));
  assign new_n97_ = x30 ? (~x39 | ~x40 | x04 | x13) : ~x32;
  assign z15 = x27 & x34 & ~new_n73_ & x12 & x26;
  assign z16 = new_n73_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n73_ & x23 & ~x24;
  assign z18 = (new_n88_ & ~new_n89_) | new_n90_ | x32 | x09 | x30;
  assign z20 = ~new_n88_ & (~x27 | ~x35) & ~x32 & ~x09 & ~x30;
  assign z19 = ~x30 & (x32 | ((~new_n88_ | new_n89_) & ~new_n90_ & ~x09));
endmodule
