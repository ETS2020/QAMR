...
module FAU ( 
  ...
  assign z02 = (~new_n74_ & x04) | ~z08 | (~x02 & (~x08 | ~x29));
  assign z08 = x39 & x40;
  ...
  assign z11 = new_n70_ | (new_n88_ & (new_n85_ | new_n86_ | new_n87_));
  assign new_n85_ = ~x08 & (~x27 | x04 | x28 | ~x35);
  assign new_n86_ = (x28 | ~x35) & (~x40 | ~x29 | ~x39);
  assign new_n87_ = x04 & x27 & (~x40 | ~x29 | ~x39);
  assign new_n88_ = ~x09 & ~x30;
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = ~new_n94_ | (x27 & ((new_n91_ & ~new_n92_) | (~new_n65_ & new_n93_)));
  assign new_n91_ = ~x13 & ~x04 & x39 & x40;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign new_n94_ = (x39 | x40) & ((~x30 & ~x32) | x13 | x04 | ~x39 | ~x40);
  assign z14 = (~new_n96_ & (~new_n91_ | new_n97_)) | new_n70_ | (~new_n93_ & (~new_n91_ | new_n98_));
  ...
  assign z18 = ((~new_n88_ | new_n103_) & (x39 | x40)) | (x08 & x29 & x39 & x40);
  assign new_n103_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z19 = ~new_n70_ & new_n88_ & (new_n105_ | new_n86_ | new_n87_);
  assign new_n105_ = ~x08 & (~x27 | (x39 & (x04 | x28 | ~x35)));
  assign z20 = (new_n86_ | ~x08) & (~x27 | ~x35) & ~new_n70_ & new_n88_;
