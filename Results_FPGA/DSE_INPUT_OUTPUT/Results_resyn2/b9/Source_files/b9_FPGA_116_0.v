...
module FAU ( 
  ...
  assign z07 = new_n82_ & (new_n81_ | ~x14);
  assign new_n81_ = (x15 | ~x17) & (~x25 | ~x38) & ~x31 & ~x33;
  assign new_n82_ = x03 & (x00 | (x26 & (x25 | ~x38)));
  assign z08 = new_n74_ & ~new_n70_;
  assign z09 = (~x00 & ~x26) | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n70_ & (new_n88_ | (~x04 & (new_n87_ | (new_n71_ & ~new_n86_))));
  assign new_n86_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n87_ = (x30 | x32) & x05 & x39 & x40;
  assign new_n88_ = x37 & x06 & x27;
