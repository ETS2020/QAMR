...
module FAU ( 
  ...
  assign z13 = (x27 & ((~x30 & new_n95_ & ~new_n96_) | (new_n97_ & (~x30 | x32)))) | (new_n95_ & x32);
  assign new_n95_ = x39 & x40 & ~x04 & ~x13;
  assign new_n96_ = x28 & (~x35 | ~x36);
  assign new_n97_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = new_n99_ & (~x27 | (~new_n97_ & (~new_n95_ | new_n96_)));
  assign new_n99_ = x32 ? (~x39 | ~x40 | x04 | x13) : ~x30;
