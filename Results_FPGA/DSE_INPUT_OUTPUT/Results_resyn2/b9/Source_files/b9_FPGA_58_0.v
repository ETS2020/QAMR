...
module FAU ( 
  ...
  assign z10 = new_n84_ | (x27 & (new_n82_ | (~new_n65_ & x06 & x37)));
  assign new_n82_ = new_n83_ & (x40 | (x07 & x36)) & (x05 | ~x39 | ~x40);
  assign new_n83_ = (x36 | (~x28 & x35)) & ~x04 & (x07 | x39);
  assign new_n84_ = x05 & new_n68_ & (x30 | x32);
  assign z11 = new_n86_ | new_n65_;
  ...
  assign z12 = new_n90_ | new_n65_ | (~new_n66_ & ~new_n68_);
  assign new_n90_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = new_n92_ | new_n65_ | (~x13 & new_n68_ & (x30 | x32));
  assign new_n92_ = x27 & (new_n94_ | (new_n93_ & (~x28 | (x35 & x36))));
  assign new_n93_ = ~x13 & ~x04 & x39 & x40;
  assign new_n94_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = new_n98_ | new_n65_ | (~new_n96_ & ~x30 & ~x32);
  assign new_n96_ = x27 & (~x28 | (x35 & x36) | (new_n97_ & (x35 | x37)));
  assign new_n97_ = x20 & ~x18 & ~x19;
  assign new_n98_ = ~new_n93_ & (~new_n66_ | ~new_n97_);
  assign z15 = ~new_n65_ & x12 & x26 & x27 & x34;
  assign z16 = x01 & x22 & ~new_n65_ & ~x23;
  assign z17 = new_n65_ | (x23 & ~x24 & x01 & x22);
  assign z18 = ~new_n86_ | new_n65_;
  assign z20 = new_n65_ | (~new_n87_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z19 = new_n86_ | new_n65_;
endmodule
