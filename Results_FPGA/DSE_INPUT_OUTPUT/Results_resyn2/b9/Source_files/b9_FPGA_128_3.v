...
module FAU ( 
  ...
  assign z10 = new_n88_ | (x27 & (new_n85_ | (new_n86_ & new_n87_)));
  assign new_n85_ = x06 & x37 & (~x30 | ~x32);
  assign new_n86_ = ~x04 & (~x30 | ~x32) & (x36 | (~x28 & x35));
  assign new_n87_ = (x39 & x40) ? (x05 & ~x30) : x07;
  assign new_n88_ = ~x04 & x05 & (x30 | x32) & (~x30 | ~x32) & x39 & x40;
  assign z11 = ~x30 & new_n92_ & (~new_n90_ | new_n91_);
  ...
  assign z13 = new_n99_ | (new_n95_ & (new_n96_ | (new_n97_ & ~new_n98_ & ~x30)));
  ...
  assign new_n99_ = (x30 | x32) & (~x30 | ~x32) & x39 & x40 & ~x04 & ~x13;
  assign z14 = ((~new_n97_ & (~x30 | ~x32)) | (~x30 & ~x32 & (new_n98_ | ~x27))) & (~new_n96_ | ~x27);
  assign z15 = new_n95_ & x34 & x12 & x26;
  ...
  assign z19 = ~x30 & new_n92_ & (~new_n90_ | new_n91_);
endmodule
