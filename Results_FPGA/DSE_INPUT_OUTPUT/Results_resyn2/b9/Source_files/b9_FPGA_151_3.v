...
module FAU ( 
  ...
  assign new_n87_ = ~x04 & x05 & (x30 | x32) & (~x30 | ~x32) & x39 & x40;
  ...
  assign z13 = new_n94_ | (new_n98_ & (new_n95_ | (new_n96_ & ~new_n97_ & ~x30)));
  assign new_n94_ = (x30 | x32) & (~x30 | ~x32) & x39 & x40 & ~x04 & ~x13;
  ...
  assign z14 = (~new_n95_ | ~x27) & ((~new_n96_ & (~x30 | ~x32)) | (~x30 & ~x32 & (new_n97_ | ~x27)));
