...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n78_, new_n82_, new_n83_, new_n85_, new_n86_, new_n89_, new_n90_,
  ...
  assign new_n82_ = ((~new_n70_ & ~x30) | ~new_n72_ | ~x05) & (~new_n70_ | new_n72_ | ~x07);
  assign new_n83_ = x32 & (x35 | (new_n67_ & x05));
  assign z11 = (x32 & x35) | (new_n85_ & (x04 | ~x27 | x28 | ~x35));
  assign new_n85_ = ~x09 & ~x30 & (~new_n86_ | (x27 & (~new_n72_ | ~x29)));
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = new_n89_ | (~new_n92_ & z08 & ~x04 & ~x13);
  assign new_n89_ = new_n90_ & ~new_n68_ & new_n91_;
  assign new_n90_ = x27 & (x37 | (x28 & x35));
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = ~x30 & ~x32 & (~x27 | (x28 & (~x35 | ~x36)));
  assign z14 = (~new_n91_ & (~new_n94_ | new_n95_)) | new_n96_ | new_n68_ | (~new_n94_ & ~new_n90_);
  assign new_n94_ = new_n72_ & ~x04 & ~x13;
  assign new_n95_ = x28 & (~x35 | ~x36) & ~x30 & (~x32 | x35);
  ...
  assign z20 = (x32 & x35) | (~new_n86_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z06 = ~z05;
  assign z19 = (x32 & x35) | (new_n85_ & (x04 | ~x27 | x28 | ~x35));
endmodule
