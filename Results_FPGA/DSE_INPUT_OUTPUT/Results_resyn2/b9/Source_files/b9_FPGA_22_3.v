...
module FAU ( 
  ...
  assign new_n84_ = x32 & (x09 | (new_n67_ & x05));
  assign z11 = x09 ? x32 : new_n86_;
  assign new_n86_ = (~x08 | (~new_n72_ & ~new_n87_) | (~new_n87_ & x27)) & ~x30 & (~new_n72_ | x04 | ~x27);
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = (~new_n90_ & x27) | (new_n91_ & (x30 | x32)) | (x09 & x32);
  ...
  assign z19 = new_n86_ & ~x09;
  assign z20 = new_n101_ & (~x08 | (~new_n72_ & ~new_n87_));
  assign new_n101_ = ~x09 & ~x30 & (~x27 | ~x35);
  assign z18 = x09 ? ~x32 : ~new_n86_;
endmodule
