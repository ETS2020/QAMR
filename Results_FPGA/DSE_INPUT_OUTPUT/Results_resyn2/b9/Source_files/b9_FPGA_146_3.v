...
module FAU ( 
  ...
  assign z17 = x01 & x22 & ~x24 & ~x08 & x23;
  assign z18 = new_n96_ | new_n97_ | x09 | x30;
  assign new_n96_ = x08 & (x23 | (new_n73_ & x29));
  ...
  assign z19 = new_n68_ | (new_n86_ & (~new_n85_ | (x27 & (~new_n73_ | ~x29))));
endmodule
