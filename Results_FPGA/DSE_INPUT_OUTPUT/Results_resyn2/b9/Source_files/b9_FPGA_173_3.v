...
module FAU ( 
  ...
  assign z10 = new_n84_ | (~new_n68_ & x27 & (new_n82_ | (x06 & x37)));
  assign new_n82_ = new_n83_ & ~x04 & (new_n70_ | x36);
  assign new_n83_ = (x39 & x40) ? (x05 & ~x30) : x07;
  assign new_n84_ = ~x04 & x05 & (x30 | x32) & x39 & x40 & (~x30 | ~x32);
  ...
  assign z13 = (new_n93_ | ((new_n90_ | new_n91_) & x27 & (~x30 | ~x32))) & (new_n93_ | new_n90_ | ~x30);
  assign new_n90_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n91_ = new_n92_ & (~x28 | (x35 & x36));
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = (x30 | x32) & x39 & x40 & (~x30 | ~x32) & ~x04 & ~x13;
  assign z14 = ~new_n93_ & ((~new_n90_ & ~new_n91_) | new_n68_ | ~x27);
  ...
  assign z20 = (x30 & x32) | (~new_n86_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z18 = ~z11;
endmodule
