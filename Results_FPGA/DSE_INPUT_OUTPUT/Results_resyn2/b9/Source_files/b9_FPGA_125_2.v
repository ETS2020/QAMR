...
module FAU ( 
  ...
  assign new_n72_ = x39 & x40 & (x35 | (~x04 & ~x32));
  ...
  assign new_n82_ = ((~new_n69_ & ~x30) | ~x05 | ~x39 | ~x40) & (~new_n69_ | ~x07 | (x39 & x40));
  assign new_n83_ = x32 & (~x35 | (new_n66_ & x05));
  ...
  assign z12 = ~new_n89_ | (~x10 & (~x27 | (~x37 & ~x35 & ~x36)));
  assign new_n89_ = (~x32 | x35) & (new_n66_ | (x27 & (x37 | (x28 & x35))));
  assign z13 = (~new_n91_ & x27) | (x32 & ~x35) | (new_n92_ & (x30 | x32));
  assign new_n91_ = (~new_n92_ | (x28 & (~x35 | ~x36))) & (~new_n93_ | (~x37 & (~x28 | ~x35)));
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n93_ & (new_n96_ | (~new_n92_ & (~x32 | x35)))) | (new_n95_ & (~x32 | (~new_n92_ & x35)));
  assign new_n95_ = (~x27 | (~x37 & (~x28 | ~x35))) & (~new_n92_ | (~x30 & (~x27 | x28)));
