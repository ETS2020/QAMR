...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n72_,
    ...
    new_n99_, new_n100_, new_n102_, new_n103_, new_n104_, new_n109_,
  ...
  assign z02 = ~new_n75_ | (~new_n74_ & x04);
  assign new_n74_ = (x08 | x27) & ~x28 & x35;
  assign new_n75_ = (x02 | (x08 & x29)) & x07 & x39 & x40;
  ...
  assign z10 = ~new_n87_ | (new_n86_ & (new_n85_ | (~new_n72_ & x39 & x40)));
  assign new_n85_ = x07 & x27 & (x36 | (~x28 & x35));
  assign new_n86_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n87_ = (x07 | ~x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n90_ | (new_n89_ & (new_n92_ | (~new_n74_ & ~new_n91_)));
  assign new_n89_ = ~x09 & ~x30;
  assign new_n90_ = x40 & (~x07 | (~x09 & ~x30 & x04 & ~x08));
  assign new_n91_ = x08 & x29 & x39 & x40;
  assign new_n92_ = x04 & x27 & (~x29 | ~x39 | ~x40);
  assign z12 = ~new_n94_ & (~x40 | (~new_n95_ & x07));
  assign new_n94_ = x27 & (x37 | (x28 & x35));
  assign new_n95_ = ~x04 & x39 & (x10 | (x27 & (x35 | x36)));
  assign z13 = (x27 & (new_n99_ | (~new_n97_ & new_n98_))) | (~new_n100_ & x40);
  assign new_n97_ = x28 & (~x35 | ~x36);
  assign new_n98_ = ~x13 & x40 & ~x04 & x39;
  assign new_n99_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n100_ = x07 & ((~x30 & ~x32) | x13 | x04 | ~x39);
  assign z14 = (~new_n94_ & (~new_n98_ | new_n103_)) | new_n70_ | (~new_n102_ & (~new_n98_ | new_n104_));
  ...
  assign z18 = new_n109_ | (~new_n70_ & (~new_n89_ | (new_n74_ & (~x04 | ~x27))));
  assign new_n109_ = x08 & x29 & x40 & x07 & x39;
  assign z19 = (~new_n111_ | new_n112_) & ~new_n113_ & ~new_n70_ & new_n89_;
  assign new_n111_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n112_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n113_ = ~x04 & x27 & ~x28 & x35;
  assign z20 = new_n70_ | (~new_n111_ & new_n89_ & (~x27 | ~x35));
endmodule
