...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n74_, new_n80_, new_n84_, new_n85_, new_n86_, new_n87_, new_n88_,
  ...
  assign z09 = x34 & x26 & x27 & ~new_n73_ & x11;
  assign z10 = (new_n87_ & new_n88_) | (x27 & (new_n86_ | (~new_n84_ & new_n85_)));
  assign new_n84_ = (~x07 | (x16 & x32) | (x39 & x40)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n85_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n86_ = x06 & x37 & (~x16 | ~x32);
  assign new_n87_ = (x30 | x32) & x39 & x40 & (~x16 | ~x32);
  ...
  assign z13 = (new_n94_ & (new_n95_ | (~new_n96_ & new_n98_))) | (new_n87_ & new_n97_);
  assign new_n94_ = x27 & (~x16 | ~x32);
  assign new_n95_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n96_ = x28 & (~x35 | ~x36);
  assign new_n97_ = ~x04 & ~x13;
  assign new_n98_ = ~x32 & x39 & x40 & ~x04 & ~x13;
  assign z14 = (~new_n100_ & (new_n102_ | (~new_n73_ & ~new_n101_))) | ((~new_n101_ | new_n103_) & ~new_n73_ & ~new_n104_);
