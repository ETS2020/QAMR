...
module FAU ( 
  ...
  assign z10 = (~new_n82_ & x27) | (~x04 & x30 & new_n73_ & x05);
  assign new_n82_ = (new_n83_ | new_n70_ | x04) & (new_n68_ | ~x06 | ~x37);
  assign new_n83_ = (~x07 | (x40 & (x32 | x39))) & (~x05 | x32 | ~x39 | ~x40);
  ...
  assign z12 = (~x32 & (new_n89_ | (~new_n90_ & (x04 | ~x39)))) | (~new_n90_ & ~x40);
  assign new_n89_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign new_n90_ = x27 & (x37 | (x28 & x35));
  assign z13 = new_n93_ | ((new_n92_ | x30) & new_n73_ & ~x04 & ~x13);
  assign new_n92_ = ~new_n68_ & x27 & (~x28 | (x35 & x36));
  assign new_n93_ = new_n90_ & ~new_n68_ & new_n94_;
  assign new_n94_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n94_ & (~x40 | (~new_n96_ & ~x32))) | (~new_n90_ & ~x40) | (~new_n98_ & ~new_n90_ & ~x32);
  assign new_n96_ = ~new_n97_ & x39 & ~x04 & ~x13;
  assign new_n97_ = ~x30 & x28 & (~x35 | ~x36);
  assign new_n98_ = x39 & ~x04 & ~x13 & (x30 | (x27 & ~x28));
