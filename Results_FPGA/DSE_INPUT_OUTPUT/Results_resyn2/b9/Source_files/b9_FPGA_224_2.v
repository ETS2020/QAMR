...
module FAU ( 
  ...
  assign z02 = new_n65_ ^ (new_n74_ | ~z08 | (~x02 & (~x08 | ~x29)));
  assign z08 = x39 & x40;
  ...
  assign new_n80_ = x03 & (~x06 | x40);
  assign z09 = new_n65_ | (x27 & x34 & x11 & x26);
  assign z10 = new_n85_ | (~x04 & ((new_n83_ & (new_n70_ | ~new_n71_)) | (new_n70_ & new_n84_)));
  assign new_n83_ = x05 & x39 & x40;
  assign new_n84_ = (~x39 | ~x40) & x07 & (~x06 | x40);
  assign new_n85_ = x06 & x27 & x37 & x40;
  assign z11 = new_n65_ | (new_n88_ & (~new_n87_ | (x27 & (~z08 | ~x29))));
