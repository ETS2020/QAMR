...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n90_, new_n91_, new_n94_, new_n99_, new_n100_, new_n102_;
  ...
  assign z11 = ~x30 & (~x32 | (~x09 & (new_n89_ | (~new_n90_ & ~new_n91_))));
  assign new_n89_ = ~x08 & ((x04 & x39) | ~x27 | x28 | ~x35);
  assign new_n90_ = x29 & x39 & x40;
  assign new_n91_ = (~x04 | ~x27) & ~x28 & x35;
  assign z12 = ~new_n70_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z14 = new_n94_ & (new_n65_ | x18 | x19 | ~x20 | ~x27);
  assign new_n94_ = (x30 | x32) & (x13 | x04 | ~x39 | ~x40);
  assign z15 = x12 & ~new_n70_ & x34 & x26 & x27;
  assign z16 = new_n70_ | (~x23 & x01 & x22);
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z18 = x30 | (x32 & (~new_n100_ | (new_n99_ & (new_n90_ | ~x27))));
  assign new_n99_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n100_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = (~x08 | (~new_n84_ & ~new_n90_) | (~new_n90_ & x27)) & new_n102_ & (x04 | ~new_n84_ | ~x27);
  assign new_n102_ = x32 & ~x09 & ~x30;
  assign z20 = ~new_n99_ & new_n102_ & (~x27 | ~x35);
  assign z13 = ~new_n94_ | (~new_n65_ & ~x18 & ~x19 & x20 & x27);
endmodule
