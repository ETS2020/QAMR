...
module FAU ( 
  ...
  assign z03 = (~x21 & (x37 | (x27 & x32))) | ((~x27 | ~x28 | ~x35) & (x32 | x37) & (x27 | ~x37));
  assign z04 = ((~x27 | ~x28 | ~x35) & (x32 | x37) & (x27 | ~x37)) | (x21 & (x37 | (x27 & x32)));
  ...
  assign new_n90_ = (~x10 | x04 | ~x39 | ~x40) & (x32 | x37);
  ...
  assign z14 = (~new_n98_ & (~new_n92_ | (new_n93_ & new_n95_))) | (~new_n99_ & (new_n97_ | ~new_n92_));
  assign new_n97_ = ~x32 & (~x30 | ~x37);
  assign new_n98_ = x20 & ~x18 & ~x19;
  assign new_n99_ = x27 & (x37 | (x32 & x28 & x35));
