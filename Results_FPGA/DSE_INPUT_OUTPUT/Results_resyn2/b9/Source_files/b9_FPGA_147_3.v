...
module FAU ( 
  ...
  assign z13 = (~x30 | ~x32) & ((new_n90_ & (x30 | x32)) | (x27 & (new_n91_ | (new_n90_ & ~new_n92_)))) & (new_n91_ | new_n90_ | ~x30);
  assign new_n90_ = new_n74_ & ~x04 & ~x13;
  assign new_n91_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign z14 = (x30 & x32) | ((~new_n90_ | (~x30 & ~x32)) & (~x27 | (~new_n91_ & (~new_n90_ | new_n92_))));
