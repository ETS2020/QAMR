...
module FAU ( 
  ...
  assign z01 = (~x04 & (x20 | x32)) | (x20 & ~new_n70_ & ~x30 & ~x32);
  ...
  assign new_n92_ = ~new_n66_ & ~x18 & ~x19 & x20 & x27;
  assign new_n93_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = (~new_n92_ & ~new_n95_) | (~new_n96_ & ~x32);
  assign new_n95_ = new_n93_ & (~new_n91_ | x30 | x32 | (~x18 & ~x19));
  assign new_n96_ = x20 & (x30 | (x27 & (x37 | ~x28 | x35)));
