...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    ...
    new_n98_, new_n99_, new_n105_, new_n107_, new_n109_;
  assign z00 = (~new_n65_ & ~new_n66_) | (~new_n67_ & new_n68_);
  assign new_n65_ = x03 & x40;
  assign new_n66_ = x16 & (x15 | ~x27 | (~x37 & (~x28 | ~x35)));
  assign new_n67_ = ~x10 & (~x27 | (~x35 & ~x36));
  assign new_n68_ = x39 & x40 & ~x15 & ~x03 & ~x04;
  ...
  assign new_n73_ = (x08 | x27) & ~x28 & x35;
  ...
  assign new_n79_ = ((x00 & ~x25) | (~x14 & x25) | ~x38) & x03 & ~x40;
  ...
  assign new_n84_ = (~x03 | ~x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n88_ | (new_n87_ & ((~new_n89_ & new_n90_) | new_n91_ | (~new_n86_ & ~new_n89_)));
  assign new_n86_ = ~x28 & x35;
  assign new_n87_ = ~x09 & ~x30;
  assign new_n88_ = x40 & (x03 | (~x09 & ~x30 & x04 & ~x08));
  assign new_n89_ = x29 & x39 & x40;
  assign new_n90_ = x04 & x27;
  assign new_n91_ = ~x08 & (~x27 | x28 | ~x35);
  assign z12 = (~x03 & (new_n94_ | (~new_n93_ & (x04 | ~x39)))) | (~new_n93_ & ~x40);
  assign new_n93_ = x27 & (x37 | (x28 & x35));
  assign new_n94_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = (x27 & (new_n98_ | (~new_n96_ & new_n97_))) | (~new_n99_ & x40);
  assign new_n96_ = x28 & (~x35 | ~x36);
  assign new_n97_ = x40 & ~x13 & ~x04 & x39;
  assign new_n98_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n99_ = ~x03 & ((~x30 & ~x32) | x13 | x04 | ~x39);
  assign z14 = new_n65_ | ((~x27 | ((new_n96_ | ~new_n97_) & ~new_n98_)) & (new_n71_ | ~new_n97_));
  assign z15 = new_n65_ | (x27 & x34 & x12 & x26);
  assign z16 = new_n65_ | (~x23 & x01 & x22);
  assign z17 = new_n65_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ((new_n89_ | ~x27) & (new_n86_ | new_n89_) & x08) | ~new_n105_ | (~x04 & new_n86_ & x27);
  assign new_n105_ = (~x03 | ~x40) & ~x09 & ~x30;
  assign z19 = ~new_n107_ & (new_n65_ | (new_n87_ & (~new_n73_ | new_n90_)));
  assign new_n107_ = x08 & x29 & x40 & ~x03 & x39;
  assign z20 = ~new_n109_ & new_n105_ & (~x27 | ~x35);
