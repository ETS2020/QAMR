...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n79_, new_n83_, new_n84_, new_n86_, new_n89_, new_n90_, new_n91_,
    new_n97_;
  ...
  assign z11 = ~new_n86_ & (~new_n73_ | x04 | ~x27) & ~x09 & ~x30;
  assign new_n86_ = x08 & (new_n73_ | (x29 & x39 & x40)) & (~x27 | (x29 & x39 & x40));
  ...
  assign z20 = (x30 & x32) | (~new_n97_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign new_n97_ = x08 & (new_n73_ | (x29 & x39 & x40));
  assign z18 = new_n86_ | (new_n73_ & ~x04 & x27) | x09 | x30;
  assign z19 = ~new_n86_ & (~new_n73_ | x04 | ~x27) & ~x09 & ~x30;
endmodule
