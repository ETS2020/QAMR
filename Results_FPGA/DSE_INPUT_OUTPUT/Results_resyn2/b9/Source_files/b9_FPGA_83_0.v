...
module FAU ( 
  ...
  assign z11 = ~new_n84_ & ~new_n85_ & x33 & ~x09 & ~x30;
  assign new_n84_ = x08 & ((~x28 & x35) | (new_n73_ & x29)) & (~x27 | (new_n73_ & x29));
  assign new_n85_ = ~x04 & ~x28 & x27 & x35;
  ...
  assign z19 = ~x09 & (~x33 | (~new_n84_ & ~new_n85_ & ~x30));
  assign z20 = new_n97_ & (~x08 | ((x28 | ~x35) & (~new_n73_ | ~x29)));
  assign new_n97_ = (~x27 | ~x35) & x33 & ~x09 & ~x30;
  assign z06 = ~z05;
  assign z18 = new_n84_ | new_n85_ | ~x33 | x09 | x30;
endmodule
