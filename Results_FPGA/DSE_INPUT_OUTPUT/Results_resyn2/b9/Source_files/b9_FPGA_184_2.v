// Benchmark "FAU" written by ABC on Tue Aug 11 21:46:37 2020
...
module FAU ( 
  ...
  assign z10 = new_n81_ | (x27 & (new_n80_ | (~new_n67_ & x06 & x37)));
  assign new_n80_ = ((x07 & ~x39) | (x05 & x39 & x40)) & ~new_n69_ & ~x04;
  assign new_n81_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = new_n83_ | new_n67_;
  assign new_n83_ = new_n85_ & (~new_n84_ | (x27 & (~x29 | ~x39)));
  ...
  assign z13 = new_n94_ | (x27 & (new_n90_ | (new_n93_ & ~new_n92_ & ~new_n67_)));
  assign new_n90_ = new_n91_ & (~x28 | (x35 & x36));
  assign new_n91_ = x39 & x40 & ~x04 & ~x13;
  assign new_n92_ = ~x37 & (~x28 | ~x35);
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign new_n94_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
  assign z14 = new_n97_ | (~new_n96_ & x40 & ~x30 & ~x32);
  assign new_n96_ = x27 & (~x28 | (x35 & x36) | (new_n93_ & (x35 | x37)));
  assign new_n97_ = (~new_n87_ | ~new_n93_) & (~x39 | (x40 & (x04 | x13)));
  assign z15 = x12 & ~new_n67_ & x34 & x26 & x27;
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n83_ | new_n67_;
  assign z20 = new_n67_ | (~new_n84_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z08 = x39;
  assign z19 = new_n83_ | new_n67_;
endmodule
