...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    ...
    new_n91_, new_n93_, new_n94_, new_n95_, new_n96_, new_n98_;
  assign z00 = new_n68_ | (~x15 & (new_n67_ | (x27 & (new_n65_ | new_n66_))));
  assign new_n65_ = (x39 | x40) & (x37 | (x28 & x35));
  ...
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n91_ & ~new_n66_)));
  ...
  assign z14 = new_n98_ & (~x27 | ((new_n91_ | ~new_n95_) & (new_n93_ | ~new_n94_)));
  assign new_n98_ = (x39 | x40) & (x13 | (~x30 & ~x32) | x04 | ~x39 | ~x40);
