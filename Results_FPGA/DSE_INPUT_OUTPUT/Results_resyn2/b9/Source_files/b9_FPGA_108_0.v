...
module FAU ( 
  ...
  assign new_n81_ = x03 & (x24 | x40);
  assign z08 = x40 ? x39 : ~x24;
  assign z09 = new_n65_ | (x11 & x26 & x27 & x34);
  assign z10 = new_n88_ | (x27 & (new_n87_ | (~new_n85_ & new_n86_)));
  assign new_n85_ = (~x05 | ~x39 | ~x40) & (~x07 | (x39 & x40) | (~x24 & ~x40));
  assign new_n86_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n87_ = (x24 | x40) & x06 & x37;
  assign new_n88_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = (~x08 | (~new_n70_ & ~new_n90_) | (~new_n90_ & x27)) & new_n91_ & (~new_n70_ | x04 | ~x27);
  assign new_n90_ = x40 & x29 & x39;
  assign new_n91_ = ~x09 & ~x30 & (x24 | x40);
  assign z12 = (x40 & (new_n68_ | (~new_n66_ & (x04 | ~x39)))) | (~new_n66_ & x24 & ~x40);
  assign z13 = (x27 & ((new_n96_ & new_n97_) | (~new_n94_ & new_n95_))) | (~new_n71_ & new_n95_);
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = ~x13 & ~x04 & x39 & x40;
  assign new_n96_ = x20 & ~x18 & ~x19;
  assign new_n97_ = (x37 | (x28 & x35)) & (x24 | x40);
  assign z14 = (~new_n96_ & (~new_n95_ | new_n99_)) | new_n65_ | (~new_n66_ & (~new_n95_ | new_n100_));
  ...
  assign z20 = ~new_n105_ & new_n91_ & (~x27 | ~x35);
  assign new_n105_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign z18 = (x08 & (new_n70_ | new_n90_) & (new_n90_ | ~x27)) | ~new_n91_ | (new_n70_ & ~x04 & x27);
  assign z19 = (~x08 | (~new_n70_ & ~new_n90_) | (~new_n90_ & x27)) & new_n91_ & (~new_n70_ | x04 | ~x27);
endmodule
