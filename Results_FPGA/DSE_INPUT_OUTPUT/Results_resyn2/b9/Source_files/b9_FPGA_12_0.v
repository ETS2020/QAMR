...
module FAU ( 
  ...
  assign z01 = (~x04 & (x17 | x32)) | ((new_n70_ | ~x27) & x17 & ~x30 & ~x32);
  ...
  assign z03 = new_n68_ | (~x27 & ~x37) | ~x21 | (x27 & (~x28 | ~x35));
  assign z04 = new_n68_ | (~x27 & ~x37) | x21 | (x27 & (~x28 | ~x35));
  ...
  assign z10 = new_n84_ | ((new_n83_ | (x06 & x37)) & ~new_n68_ & x27);
  assign new_n83_ = ~new_n70_ & ~x04 & (~new_n72_ | (x05 & x17)) & (new_n72_ | x07);
  assign new_n84_ = new_n67_ & x05 & (x32 | (x17 & x30));
  ...
  assign z14 = (new_n91_ | ~x27) & (~new_n92_ | (~x30 & ~x32)) & (x17 | x32);
  ...
  assign z20 = new_n68_ | (~new_n87_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z13 = (~new_n91_ & x27) | (new_n92_ & (x30 | x32)) | (~x17 & ~x32);
