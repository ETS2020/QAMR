...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n73_, new_n74_,
    new_n80_, new_n83_, new_n85_, new_n86_, new_n89_, new_n90_, new_n91_,
    new_n92_, new_n94_;
  ...
  assign z01 = ~x04 | (~x32 & ((~new_n70_ & ~x30) | x38));
  ...
  assign z07 = (~x32 & x38) | (new_n80_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  assign new_n80_ = x03 & (~x14 | (~x31 & ~x33 & (x15 | ~x17)));
  assign z09 = x11 & ~new_n68_ & x34 & x26 & x27;
  assign z10 = (~new_n83_ & ~x04) | new_n68_ | (x37 & x06 & x27);
  assign new_n83_ = ((~new_n70_ & ~x30 & ~x32) | ~new_n73_ | ~x05) & (~new_n70_ | new_n73_ | ~x07);
  assign z18 = ~new_n68_ & (~new_n86_ | (new_n85_ & (~x27 | (new_n73_ & x29))));
  assign new_n85_ = x08 & ((~x28 & x35) | (new_n73_ & x29));
  assign new_n86_ = ~x09 & ~x30 & (~x27 | ~x35 | x04 | x28);
  assign z12 = new_n65_ | new_n68_;
  assign z13 = new_n91_ | (x27 & ((new_n92_ & (x32 | ~x38)) | (new_n89_ & ~x38)));
  assign new_n89_ = new_n90_ & (~x28 | (x35 & x36));
  assign new_n90_ = ~x13 & ~x04 & x39 & x40;
  assign new_n91_ = new_n90_ & (x32 | (x30 & ~x38));
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = ~new_n94_ & (x32 | ~x38) & (~new_n90_ | (~x30 & ~x32));
  assign new_n94_ = x27 & (new_n92_ | (new_n90_ & (~x28 | (x35 & x36))));
  ...
  assign z11 = new_n68_ | (new_n86_ & (~new_n85_ | (x27 & (~new_n73_ | ~x29))));
  assign z19 = z11;
endmodule
