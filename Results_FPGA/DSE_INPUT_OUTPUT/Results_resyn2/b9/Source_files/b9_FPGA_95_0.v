...
module FAU ( 
  ...
  assign z01 = (~x04 & (x12 | x32)) | ((new_n70_ | ~x27) & ~x32 & x12 & ~x30);
  ...
  assign new_n83_ = (~x07 | (~x12 & ~x32) | (x39 & x40)) & (~x39 | ~x40 | ~x05 | ~x12);
  assign new_n84_ = new_n67_ & (x32 | (x12 & x30));
  ...
  assign new_n91_ = (~new_n92_ | new_n66_ | (~x12 & ~x32)) & (~new_n93_ | new_n94_ | ~x12);
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign new_n93_ = ~x13 & ~x04 & x39 & x40;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign z14 = ~new_n96_ & (~new_n92_ | new_n66_ | ~x27);
  assign new_n96_ = (new_n93_ | (~x12 & ~x32)) & (x32 | ~x12 | x30 | (~new_n94_ & x27));
  assign z15 = x12 & x34 & x26 & x27;
