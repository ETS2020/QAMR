...
module FAU ( 
  ...
  assign z10 = (new_n67_ & x05 & x32) | (~new_n82_ & x27 & (~x30 | x32));
  ...
  assign z14 = (~x27 | (~new_n89_ & (~new_n90_ | new_n91_))) & (~x30 | x32) & (~new_n90_ | ~x32);
  ...
  assign z13 = (x27 & (new_n89_ | (new_n90_ & ~new_n91_))) | (x30 & ~x32) | (new_n90_ & x32);
