...
module FAU ( 
  ...
  assign new_n87_ = ~x04 & x39 & x40 & x05 & x32;
  ...
  assign z13 = (x27 & ((~x30 & new_n94_ & ~new_n95_) | (new_n96_ & (~x30 | x32)))) | (new_n94_ & x32);
  assign new_n94_ = x39 & x40 & ~x04 & ~x13;
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = new_n98_ & (~x27 | (~new_n96_ & (~new_n94_ | new_n95_)));
