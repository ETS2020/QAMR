...
module FAU ( 
  ...
  assign z01 = (~x04 & (x18 | ~x32)) | (~new_n70_ & ~x30 & ~x32);
  ...
  assign z13 = (~new_n91_ & x27) | (new_n92_ & (x30 | x32)) | (~x18 & x32);
  assign new_n91_ = (~new_n92_ | (x28 & (~x35 | ~x36))) & (~new_n93_ | (~x37 & (~x28 | ~x35)));
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n93_ & (~new_n92_ | new_n96_)) | ((~new_n92_ | ~x18 | ~x32) & (new_n95_ | x32));
  assign new_n95_ = (new_n66_ | ~x27) & (~new_n92_ | (~x30 & (~x27 | x28)));
