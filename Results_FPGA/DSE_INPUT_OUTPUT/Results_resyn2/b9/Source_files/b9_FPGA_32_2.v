...
module FAU ( 
  ...
  assign new_n71_ = (x02 | (x08 & x29)) & x39 & x40;
  ...
  assign z10 = ~new_n81_ | (~x04 & (new_n80_ | (~new_n69_ & x05 & x39)));
  assign new_n80_ = x27 & (x36 | (~x28 & x35)) & x07 & ~x39;
  assign new_n81_ = (~x39 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = (x39 & ~x40) | (new_n84_ & (~new_n83_ | (x27 & (~x29 | ~x39))));
  assign new_n83_ = x08 & ((~x28 & x35) | (x29 & x39));
  assign new_n84_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = (new_n86_ | ~x39) & (~x27 | (~x37 & (~x28 | ~x35)));
  ...
  assign z18 = ~new_n67_ & (new_n96_ | ~new_n97_);
  assign new_n96_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign new_n97_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x39);
  assign z19 = (~x39 | x40) & new_n84_ & (~new_n83_ | (x27 & (~x29 | ~x39)));
  assign z20 = new_n67_ | (~new_n83_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z05 = (x27 & x28) | new_n67_ | x37;
endmodule
