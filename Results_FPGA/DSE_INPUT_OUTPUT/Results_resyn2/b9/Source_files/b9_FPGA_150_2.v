...
module FAU ( 
  ...
  assign new_n68_ = x16 & (~x19 | x32);
  assign z01 = ~x04 | (~new_n70_ & ~x32);
  assign new_n70_ = ~x19 & (x30 | (x27 & (x36 | (~x28 & x35))));
  ...
  assign new_n84_ = (x36 | (~x28 & x35)) & ~x04 & (~x19 | x32);
  assign new_n85_ = (x39 & x40) ? (x05 & ~x19) : x07;
  assign new_n86_ = (~x19 | x32) & x06 & x37;
  assign new_n87_ = ~x32 & (x19 | ~x30);
  ...
  assign z13 = ~new_n95_ & (~new_n98_ | (x27 & (new_n97_ | (new_n94_ & ~new_n96_))));
  assign new_n94_ = x39 & x40 & ~x04 & ~x13;
  assign new_n95_ = x19 & (~x32 | ~x39 | ~x40 | x04 | x13);
  assign new_n96_ = x28 & (~x35 | ~x36);
  assign new_n97_ = ~x18 & x20 & (x37 | (x28 & x35));
  assign new_n98_ = (~x32 | ~x39 | ~x40 | x04 | x13) & (~x30 | ~x39 | ~x40 | x04 | x13);
  assign z14 = (~new_n100_ & (~new_n94_ | new_n101_)) | new_n102_ | new_n95_ | (~new_n94_ & ~new_n103_);
