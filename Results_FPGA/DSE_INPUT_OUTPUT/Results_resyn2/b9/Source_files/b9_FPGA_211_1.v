...
module FAU ( 
  ...
  assign z01 = (~x30 & ~new_n70_ & ~x32) | ~x04 | (~x19 & x30);
  ...
  assign new_n83_ = ((~new_n70_ & ~x32) | ~new_n72_ | ~x05) & (~new_n70_ | new_n72_ | ~x07);
  assign new_n84_ = x30 & (~x19 | (new_n67_ & x05));
  assign z11 = new_n87_ & (~new_n86_ | (x27 & (~new_n72_ | ~x29)));
  assign new_n86_ = x08 & ((~x28 & x35) | (new_n72_ & x29));
  assign new_n87_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (~new_n90_ & ~x30 & (x27 | (new_n93_ & x32))) | (new_n93_ & x19 & x30);
  assign new_n90_ = (~new_n91_ | x19) & (new_n92_ | ~new_n93_) & (~new_n93_ | ~x32);
  assign new_n91_ = ~x18 & x20 & (x37 | (x28 & x35));
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x04 & ~x13 & x39 & x40;
  assign z14 = (~new_n93_ & x19) | (~new_n95_ & ~x30);
  assign new_n95_ = (new_n96_ | ~new_n92_ | x32) & (new_n91_ | new_n93_) & (x27 | (new_n93_ & x32));
  assign new_n96_ = (x35 | x37) & ~x19 & ~x18 & x20;
  ...
  assign z18 = ~new_n87_ | (new_n86_ & (~x27 | (new_n72_ & x29)));
  assign z19 = new_n87_ & (~new_n86_ | (x27 & (~new_n72_ | ~x29)));
endmodule
