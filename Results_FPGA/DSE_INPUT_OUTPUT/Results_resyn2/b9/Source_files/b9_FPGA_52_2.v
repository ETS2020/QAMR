...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x26 | x32)) | ((new_n70_ | ~x27) & ~x32 & ~x26 & ~x30);
  ...
  assign z10 = (~new_n82_ & x27) | (x05 & new_n67_ & ~new_n84_);
  assign new_n82_ = (new_n83_ | new_n70_ | x04) & (new_n68_ | ~x06 | ~x37);
  assign new_n83_ = (~x07 | (x39 & x40) | (x26 & ~x32)) & (~x39 | ~x40 | ~x05 | x26);
  ...
  assign z13 = new_n93_ | (x27 & ((new_n91_ & (~x26 | x32)) | (new_n92_ & ~x26)));
  assign new_n91_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n92_ = new_n67_ & ~x13 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x13 & new_n67_ & ~new_n84_;
  assign z14 = (new_n84_ | (~new_n95_ & (~new_n91_ | ~x27))) & ((~new_n91_ & ~new_n92_) | x26 | ~x27);
