...
module FAU ( 
  ...
  assign z01 = (~x04 & (x05 | x32)) | ((new_n70_ | ~x27) & ~x32 & x05 & ~x30);
  ...
  assign new_n83_ = (x05 | (x32 & (~x39 | ~x40))) & new_n84_ & (x07 | (x39 & x40));
  assign new_n84_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n85_ = new_n67_ & x05 & (x30 | x32);
  assign z11 = new_n88_ & (~new_n87_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n87_ = x08 & (new_n71_ | (x29 & x39 & x40));
  assign new_n88_ = (~new_n71_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  ...
  assign z14 = new_n96_ | (~new_n97_ & ~new_n68_ & (new_n66_ | ~x27));
  assign new_n96_ = ~new_n92_ & ((~new_n94_ & (x05 | x32)) | (new_n93_ & ~x32 & x05 & ~x30));
  assign new_n97_ = new_n94_ & (x30 | x32 | (x27 & ~x28));
