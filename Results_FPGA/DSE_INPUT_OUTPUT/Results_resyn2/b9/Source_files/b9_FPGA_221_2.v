...
module FAU ( 
  ...
  assign new_n81_ = x03 & (~x15 | x32);
  assign z08 = ~new_n72_ & new_n73_;
  assign z09 = new_n72_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n87_ | (new_n86_ & (new_n70_ | (new_n73_ & ~new_n85_)));
  assign new_n85_ = ~x30 & ~x32;
  assign new_n86_ = (x07 | (x39 & x40)) & ~x04 & (x05 | ~x39 | ~x40);
  assign new_n87_ = (~x15 | x32) & (~x37 | ~x06 | ~x27);
  assign z11 = ~new_n72_ & new_n90_ & (~new_n89_ | (x27 & (~new_n73_ | ~x29)));
  assign new_n89_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n90_ = (x28 | ~x35 | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = ~new_n72_ & ~new_n68_ & (~x27 | (new_n66_ & ~new_n67_));
  assign z14 = (~x27 | (~new_n95_ & (new_n93_ | ~new_n94_))) & ~new_n72_ & (new_n85_ | ~new_n94_);
  ...
  assign z18 = ~new_n72_ & (~new_n90_ | (new_n89_ & (~x27 | (new_n73_ & x29))));
  assign z20 = new_n72_ | (~new_n89_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z13 = (x27 & (new_n95_ | (~new_n93_ & new_n94_))) | new_n72_ | (~new_n85_ & new_n94_);
  assign z19 = new_n72_ | (new_n90_ & (~new_n89_ | (x27 & (~new_n73_ | ~x29))));
endmodule
