...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n91_, new_n93_, new_n94_, new_n95_, new_n96_, new_n101_;
  ...
  assign z13 = (x27 & (~x30 | ~x32) & (new_n89_ | (~new_n90_ & new_n91_ & ~x30))) | (new_n91_ & (x30 | x32) & (~x30 | ~x32));
  assign new_n89_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n90_ = x28 & (~x35 | ~x36);
  assign new_n91_ = x39 & x40 & ~x04 & ~x13;
  assign z14 = ~new_n96_ | (~new_n93_ & (~x20 | x18 | x19));
  assign new_n93_ = ~new_n95_ & (~new_n90_ | ~new_n94_);
  assign new_n94_ = ~x30 & ~x32;
  assign new_n95_ = (~x30 | ~x32) & (~x39 | ~x40 | x04 | x13);
  assign new_n96_ = (~new_n95_ | (x27 & (x37 | (x28 & x35)))) & (~new_n94_ | (x27 & (x37 | ~x28 | x35)));
  assign z15 = ~new_n68_ & x27 & x34 & x12 & x26;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z20 = x30 ? x32 : (new_n101_ & (~x08 | (~new_n72_ & ~new_n86_)));
  assign new_n101_ = ~x09 & (~x27 | ~x35);
  assign z05 = ~z06;
  assign z18 = x30 ? ~x32 : ~new_n85_;
  assign z19 = x30 ? x32 : new_n85_;
endmodule
