...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x32 & (x13 | (~new_n70_ & ~x30)));
  ...
  assign z10 = ~new_n86_ | (new_n85_ & (new_n70_ | (new_n72_ & (x30 | x32))));
  assign new_n85_ = (x05 | ~x39 | ~x40) & ~x04 & (x07 | (x39 & x40));
  assign new_n86_ = (~x13 | x32) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n73_ | (new_n89_ & (~new_n88_ | (x27 & (~new_n72_ | ~x29))));
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n89_ = (x04 | x28 | ~x27 | ~x35) & ~x09 & ~x30;
  ...
  assign new_n95_ = (~x13 | x32) & ((~x30 & ~x32) | x13 | x04 | ~x39 | ~x40);
  assign z14 = (~new_n97_ & ~x32) | ((~new_n92_ | (~new_n94_ & new_n98_)) & (~new_n94_ | ~new_n99_));
  assign new_n97_ = ~x13 & (x30 | (x27 & (x37 | ~x28 | x35)));
  ...
  assign z18 = new_n73_ | ~new_n89_ | (new_n88_ & (~x27 | (new_n72_ & x29)));
  assign z20 = ~new_n88_ & ~x09 & ~x30 & ~new_n73_ & (~x27 | ~x35);
  assign z19 = new_n73_ | (new_n89_ & (~new_n88_ | (x27 & (~new_n72_ | ~x29))));
endmodule
