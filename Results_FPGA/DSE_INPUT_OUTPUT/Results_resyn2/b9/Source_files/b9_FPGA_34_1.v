...
module FAU ( 
  ...
  assign z10 = (new_n84_ & ~x04 & x05) | (~new_n82_ & ~new_n68_ & x27);
  assign new_n82_ = (~x06 | ~x37) & (~new_n83_ | x04 | (~new_n71_ & ~x36));
  assign new_n83_ = (x39 & x40) ? (x05 & ~x32) : x07;
  assign new_n84_ = (x30 | x32) & x39 & x40 & (x20 | ~x32);
  ...
  assign z13 = ((new_n91_ | new_n93_) & x27) | (new_n84_ & ~x04 & ~x13);
  assign new_n91_ = new_n92_ & (~x28 | (x35 & x36));
  assign new_n92_ = ~x13 & ~x32 & x40 & ~x04 & x39;
  assign new_n93_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = ~new_n95_ | (~x30 & (new_n99_ | (~x27 & ~x32)));
  assign new_n95_ = (new_n96_ | new_n97_) & ~new_n68_ & ((~x18 & ~x19) | (new_n96_ & ~new_n98_));
  assign new_n96_ = x39 & x40 & ~x04 & ~x13;
  assign new_n97_ = x27 & x20 & (x37 | (x28 & x35));
  assign new_n98_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n99_ = x28 & ((~x20 & (~x35 | ~x36)) | (~x37 & ~x32 & ~x35));
