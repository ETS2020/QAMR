...
module FAU ( 
  ...
  assign z12 = (new_n87_ | ~x39) & (~x27 | (~x37 & (~x28 | ~x35)));
  assign new_n87_ = x40 & (x04 | (~x10 & (~x27 | (~x35 & ~x36))));
  assign z13 = (x27 & ((new_n89_ & (~x39 | x40)) | (new_n90_ & x40))) | (new_n91_ & x40);
  assign new_n89_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n90_ = (~x28 | (x35 & x36)) & ~x13 & ~x04 & x39;
  assign new_n91_ = (x30 | x32) & ~x13 & ~x04 & x39;
  assign z14 = new_n67_ | (~new_n91_ & (~x27 | (~new_n89_ & ~new_n90_)));
  assign z15 = x12 & ~new_n67_ & x34 & x26 & x27;
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = x01 & x22 & ~new_n67_ & x23 & ~x24;
  assign z18 = ~new_n67_ & (new_n97_ | ~new_n98_);
  assign new_n97_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign new_n98_ = ~x09 & ~x30 & (~x39 | ~x08 | ~x29);
  assign z19 = (~x39 | x40) & new_n85_ & (~new_n84_ | (x27 & (~x29 | ~x39)));
  assign z20 = new_n67_ | (~new_n84_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z08 = x39;
endmodule
