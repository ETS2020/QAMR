...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x12 | ~x32)) | (~new_n70_ & ~x30 & ~x32);
  ...
  assign new_n85_ = new_n72_ & (~x12 | ~x32) & (x30 | x32) & ~x04 & x05;
