...
module FAU ( 
  ...
  assign z01 = ((new_n70_ | ~x27) & ~x30 & ~x32) | ~x04 | (x32 & ~x34);
  ...
  assign z10 = (~new_n83_ & x27) | (new_n85_ & new_n67_ & x05);
  assign new_n83_ = (new_n84_ | new_n70_ | x04) & (new_n68_ | ~x06 | ~x37);
  assign new_n84_ = (~x07 | (x39 & x40) | (x32 & ~x34)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n85_ = x32 ? x34 : x30;
  ...
  assign z13 = new_n93_ | (x27 & ((new_n92_ & ~x32) | (new_n91_ & (~x32 | x34))));
  assign new_n91_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n92_ = new_n72_ & ~x04 & ~x13 & (~x28 | (x35 & x36));
  assign new_n93_ = new_n85_ & new_n72_ & ~x04 & ~x13;
  assign z14 = ~new_n93_ & (new_n68_ | ~x27 | (~new_n91_ & ~new_n92_));
