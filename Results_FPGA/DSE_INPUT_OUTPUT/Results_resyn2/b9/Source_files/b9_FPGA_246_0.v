...
module FAU ( 
  ...
  assign new_n67_ = x39 & x40 & ~x04 & x10;
  ...
  assign z02 = (x39 & (new_n74_ | (~x02 & (~x08 | ~x29)))) | (x39 ^ x40);
  ...
  assign z10 = ~new_n85_ | (new_n84_ & ((z08 & ~new_n72_) | (new_n71_ & (z08 | x07))));
  assign new_n84_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n85_ = (x39 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n70_ | (new_n90_ & (new_n87_ | new_n88_ | new_n89_));
  assign new_n87_ = ~x08 & (~x27 | x04 | x28 | ~x35);
  assign new_n88_ = (x28 | ~x35) & (~x40 | ~x29 | ~x39);
  assign new_n89_ = x04 & x27 & (~x40 | ~x29 | ~x39);
  assign new_n90_ = ~x09 & ~x30;
  assign z12 = ~new_n70_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = ~new_n96_ | (x27 & ((~new_n93_ & new_n94_) | (~new_n65_ & new_n95_)));
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = x39 & x40 & ~x04 & ~x13;
  assign new_n95_ = x20 & ~x18 & ~x19;
  assign new_n96_ = (x39 | x40) & (x04 | x13 | ~x39 | ~x40 | (~x30 & ~x32));
  assign z14 = (~new_n95_ & (~new_n94_ | new_n98_)) | new_n70_ | (~new_n99_ & (~new_n94_ | new_n100_));
  ...
  assign z18 = ((~new_n90_ | new_n105_) & (x39 | x40)) | (x08 & x29 & x39 & x40);
  assign new_n105_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z19 = ~new_n70_ & new_n90_ & (new_n107_ | new_n88_ | new_n89_);
  assign new_n107_ = ~x08 & (~x27 | (x39 & (x04 | x28 | ~x35)));
  assign z20 = (new_n88_ | ~x08) & (~x27 | ~x35) & ~new_n70_ & new_n90_;
