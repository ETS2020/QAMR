...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x32 & (x34 | (~x30 & (new_n70_ | ~x27))));
  ...
  assign new_n79_ = ~new_n68_ & x03 & ((x00 & ~x25) | ~x38 | (~x14 & x25));
  assign z08 = new_n68_ | new_n72_;
  assign z09 = x11 & x26 & x34 & x27 & x32;
  assign z10 = (~new_n83_ & x27) | (x05 & new_n67_ & ~new_n85_);
  assign new_n83_ = (new_n84_ | new_n70_ | x04) & (new_n68_ | ~x06 | ~x37);
  assign new_n84_ = (~x07 | (x39 & x40) | (~x32 & x34)) & (~x39 | ~x40 | ~x05 | x34);
  assign new_n85_ = ~x32 & (~x30 | x34);
  assign z18 = ~new_n68_ & (~new_n88_ | (new_n87_ & (~x27 | (new_n72_ & x29))));
  assign new_n87_ = x08 & ((~x28 & x35) | (new_n72_ & x29));
  assign new_n88_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = new_n65_ | new_n68_;
  assign z13 = new_n93_ | (x27 & ((new_n91_ & (x32 | ~x34)) | (new_n92_ & ~x34)));
  assign new_n91_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n92_ = (~x28 | (x35 & x36)) & new_n67_ & ~x13;
  assign new_n93_ = ~x13 & new_n67_ & ~new_n85_;
  assign z14 = (new_n85_ | (~new_n95_ & (~new_n91_ | ~x27))) & ((~new_n91_ & ~new_n92_) | ~x27 | x34);
  assign new_n95_ = new_n67_ & ~x13;
  assign z15 = x12 & x26 & x34 & x27 & x32;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z20 = new_n68_ | (~new_n87_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z11 = new_n68_ | (new_n88_ & (~new_n87_ | (x27 & (~new_n72_ | ~x29))));
  assign z19 = z11;
endmodule
