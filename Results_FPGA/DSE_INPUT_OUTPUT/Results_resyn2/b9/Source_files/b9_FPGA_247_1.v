...
module FAU ( 
  ...
  assign z01 = (~x04 & (x28 | ~x32)) | (~new_n70_ & ~x30 & ~x32);
  assign new_n70_ = x27 & (x36 | (~x28 & x35));
  assign z02 = ~new_n72_ | (x04 & (x28 | ~x35 | (~x08 & ~x27)));
  assign new_n72_ = (x02 | (x08 & x29)) & ~new_n68_ & x39 & x40;
  assign z03 = (~x21 & (x28 | (~x27 & ~x32))) | ((~x35 | ~x27 | ~x28) & (x28 | ~x32) & (x27 | ~x37));
  assign z04 = ((~x35 | ~x27 | ~x28) & (x28 | ~x32) & (x27 | ~x37)) | (x21 & (x28 | (~x27 & ~x32)));
  assign z05 = (~x28 & x32) | x37 | (x27 & x28);
  ...
  assign new_n83_ = x32 & (~x28 | (new_n67_ & x05));
  assign z11 = (new_n85_ | ~x08) & ~new_n86_ & ~x09 & ~x30;
  assign new_n85_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign new_n86_ = ~x28 & (x32 | (x35 & ~x04 & x27));
  assign z12 = new_n65_ & ~new_n68_;
  assign z14 = (new_n89_ | ~x27) & (~new_n90_ | (~x30 & ~x32)) & (x28 | ~x32);
  assign new_n89_ = (~new_n90_ | (x28 & (~x35 | ~x36))) & (~new_n91_ | (~x37 & (~x28 | ~x35)));
  ...
  assign z19 = ~new_n97_ & (new_n68_ | new_n96_);
  assign new_n96_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x39 | ~x40);
  assign new_n97_ = ~x28 & x35 & (x08 | x27) & ~x32 & (~x04 | ~x27);
  assign z20 = ~new_n99_ & (~x27 | ~x35) & ~new_n68_ & ~x09 & ~x30;
  assign new_n99_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z13 = (~new_n89_ & x27) | (new_n90_ & (x30 | x32)) | (~x28 & x32);
  assign z18 = ~z19;
endmodule
