...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n77_, new_n80_,
    ...
    new_n91_, new_n92_, new_n94_, new_n95_, new_n100_;
  ...
  assign z10 = (~new_n80_ & ~x04) | new_n67_ | (x37 & x06 & x27);
  ...
  assign z13 = new_n87_ | (z08 & new_n92_ & (x30 | x32));
  assign new_n87_ = x27 & ((~new_n89_ & new_n90_) | (new_n91_ & ~new_n88_ & ~new_n67_));
  ...
  assign z14 = new_n94_ | (~new_n95_ & x40 & ~x30 & ~x32);
  assign new_n94_ = (~x39 | (~new_n92_ & x40)) & (~new_n91_ | new_n88_ | ~x27);
  assign new_n95_ = x27 & (~new_n89_ | (new_n91_ & (x35 | x37)));
  assign z15 = new_n67_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~x39 | x40) & (new_n100_ | ~new_n83_ | (x08 & x29 & x39));
  assign new_n100_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign z20 = new_n67_ | (~new_n84_ & new_n83_ & (~x27 | ~x35));
  assign z05 = ~z06;
