// Benchmark "FAU" written by ABC on Tue Aug 11 21:46:17 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n70_, new_n71_, new_n73_, new_n78_,
    ...
    new_n89_, new_n91_, new_n92_, new_n94_, new_n95_, new_n96_, new_n102_,
    new_n103_;
  ...
  assign new_n83_ = (~x39 | ~x40) & x07 & (x06 | x40);
  assign new_n84_ = x37 & x06 & x27;
  assign z11 = ~new_n88_ & new_n89_ & (~new_n86_ | new_n87_);
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n87_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n88_ = ~x04 & x27 & ~x28 & x35;
  assign new_n89_ = ~x09 & ~x30 & (x06 | x40);
  assign z12 = new_n92_ | new_n65_ | (~new_n91_ & (~z08 | x04));
  assign new_n91_ = x27 & (x37 | (x28 & x35));
  assign new_n92_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = (~new_n71_ & new_n94_) | (x27 & (new_n96_ | (new_n94_ & ~new_n95_)) & (~new_n65_ | (new_n94_ & ~new_n95_)));
  assign new_n94_ = ~x13 & ~x04 & x39 & x40;
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~x27 | (~new_n96_ & (~new_n94_ | new_n95_))) & ~new_n65_ & (new_n71_ | ~new_n94_);
  assign z15 = new_n65_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n65_ & ~x23;
  assign z17 = new_n65_ | (x23 & ~x24 & x01 & x22);
  assign z18 = new_n103_ | (~new_n65_ & (new_n102_ | x09 | x30));
  assign new_n102_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign new_n103_ = x08 & x29 & x39 & x40;
  assign z20 = new_n65_ | (~new_n86_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z05 = (x27 & x28) | new_n65_ | x37;
  assign z19 = ~new_n88_ & new_n89_ & (~new_n86_ | new_n87_);
endmodule
