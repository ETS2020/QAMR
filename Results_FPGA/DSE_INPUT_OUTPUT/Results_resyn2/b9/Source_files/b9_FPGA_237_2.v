...
module FAU ( 
  ...
  assign z01 = ~new_n67_ & (new_n69_ | ~x04);
  ...
  assign z11 = (~x39 | x40) & new_n87_ & (~new_n86_ | (x27 & (~x29 | ~x39)));
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x39));
  assign new_n87_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n67_ | (~new_n66_ & (new_n65_ | ~x27));
  assign z13 = new_n93_ | (x27 & ((~new_n67_ & new_n90_) | (~new_n91_ & new_n92_)));
  assign new_n90_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
  assign z14 = (~new_n95_ & (~new_n90_ | ~x27)) | (new_n97_ & (~x27 | (new_n91_ & ~new_n96_)));
  assign new_n95_ = x39 & (~x40 | (~x04 & ~x13));
  assign new_n96_ = x20 & ~x18 & ~x19 & (x35 | x37);
  assign new_n97_ = x40 & ~x30 & ~x32;
  assign z15 = x27 & x34 & ~new_n67_ & x12 & x26;
  assign z16 = x01 & x22 & ~new_n67_ & ~x23;
  assign z17 = new_n67_ | (x01 & x22 & x23 & ~x24);
  assign z19 = (x39 & ~x40) | (new_n87_ & (~new_n86_ | (x27 & (~x29 | ~x39))));
  assign z20 = new_n67_ | (~new_n86_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z18 = (x39 & ~x40) | ~new_n87_ | (new_n86_ & (~x27 | (x29 & x39)));
  assign z08 = x39;
endmodule
