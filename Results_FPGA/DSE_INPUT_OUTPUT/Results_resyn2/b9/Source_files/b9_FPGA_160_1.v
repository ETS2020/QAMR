...
module FAU ( 
  ...
  assign new_n83_ = x32 & (~x20 | (new_n67_ & x05));
  ...
  assign z13 = new_n90_ | (~x20 & x32) | (new_n91_ & (x30 | x32));
  assign new_n90_ = x27 & ((new_n91_ & ~new_n92_) | (new_n93_ & ~x18 & ~x19));
  ...
  assign new_n95_ = ((~x18 & ~x19) | (new_n91_ & ~new_n96_)) & (new_n97_ | (~new_n68_ & new_n91_));
  assign new_n96_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n97_ = x27 & x20 & (x37 | (x28 & x35));
  assign new_n98_ = x28 & ((~x20 & (~x35 | ~x36)) | (~x37 & ~x32 & ~x35));
