...
module FAU ( 
  ...
  assign z01 = (~x04 & (x19 | x32)) | (x19 & ~new_n70_ & ~x30 & ~x32);
  ...
  assign new_n83_ = (~new_n72_ | ~x05 | (~new_n70_ & ~x30 & ~x32)) & (~new_n70_ | new_n72_ | ~x07);
  ...
  assign z14 = (~x32 | (~new_n90_ & (~new_n66_ | x13))) & (new_n91_ | ~x19 | ~new_n66_ | x13);
  assign new_n90_ = ~new_n67_ & ~x18 & ~x19 & x20 & x27;
  assign new_n91_ = ~x30 & (~x27 | (x28 & (~x35 | ~x36)));
  ...
  assign z13 = (x32 & (new_n90_ | (new_n66_ & ~x13))) | (~new_n91_ & x19 & new_n66_ & ~x13);
