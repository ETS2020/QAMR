...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n72_,
    ...
    new_n88_, new_n90_, new_n91_, new_n94_, new_n95_, new_n96_;
  ...
  assign new_n81_ = x03 & (~x07 | ~x32);
  assign z08 = new_n74_ & ~new_n70_;
  assign z09 = new_n70_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n70_ & (new_n88_ | (x27 & (new_n85_ | (~new_n86_ & new_n87_))));
  assign new_n85_ = x06 & x37;
  assign new_n86_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n87_ = (x36 | (~x28 & x35)) & ~x04 & ~x32;
  ...
  assign new_n91_ = ~x09 & ~x30 & (x04 | x28 | ~x27 | ~x35);
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z14 = (~x27 | (~new_n96_ & (~new_n94_ | new_n95_))) & ~new_n70_ & (new_n72_ | ~new_n94_);
