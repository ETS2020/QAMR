// Benchmark "FAU" written by ABC on Tue Aug 11 21:46:01 2020
...
module FAU ( 
  ...
  assign new_n83_ = (new_n69_ | ~x06 | ~x37) & (new_n84_ | new_n70_ | x04);
  assign new_n84_ = (~x07 | (x39 & x40) | (x16 & ~x32)) & (~x39 | ~x40 | ~x05 | x16);
  assign new_n85_ = new_n67_ & (x32 | (~x16 & x30));
  ...
  assign new_n93_ = (~x16 | x32) & (x37 | (x28 & x35));
  assign new_n94_ = ~x13 & ~x04 & x39 & x40;
  assign new_n95_ = ~x16 & (~x28 | (x35 & x36));
  assign z14 = new_n98_ | (~new_n97_ & (~x20 | x18 | x19));
  assign new_n97_ = (new_n69_ | new_n94_) & (~new_n71_ | ~x28 | (x35 & x36));
  assign new_n98_ = (~new_n94_ | (new_n71_ & (~x27 | x28))) & ~new_n69_ & (new_n66_ | ~x27);
