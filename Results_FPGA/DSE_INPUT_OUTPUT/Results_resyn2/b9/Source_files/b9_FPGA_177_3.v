...
module FAU ( 
  ...
  assign new_n84_ = x39 & x40 & (~x30 | ~x32) & ~x04 & x05 & (x30 | x32);
  ...
  assign z13 = (~x30 | ~x32) & ((new_n91_ & (x30 | x32)) | (x27 & (new_n90_ | (new_n91_ & ~new_n92_)))) & (new_n90_ | ~x30 | (new_n91_ & (x30 | x32)));
  assign new_n90_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n91_ = x39 & x40 & ~x04 & ~x13;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign z14 = (x30 & x32) | ((~new_n91_ | (~x30 & ~x32)) & (~x27 | (~new_n90_ & (~new_n91_ | new_n92_))));
  assign z15 = new_n68_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z20 = new_n98_ & (~x08 | (~new_n70_ & ~new_n87_));
