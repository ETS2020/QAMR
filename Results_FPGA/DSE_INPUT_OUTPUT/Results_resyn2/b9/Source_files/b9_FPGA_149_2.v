...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n74_, new_n83_, new_n85_, new_n86_, new_n89_, new_n90_, new_n91_,
    new_n92_;
  ...
  assign z07 = x03 & (~x33 | (~x14 & (~x38 | x00 | x25)));
  assign z08 = new_n68_ | new_n74_;
  assign z09 = x11 & ~new_n68_ & x34 & x26 & x27;
  assign z10 = (~new_n83_ & ~x04) | new_n68_ | (x37 & x06 & x27);
  assign new_n83_ = ((~new_n70_ & ~x30 & ~x32) | ~new_n74_ | ~x05) & (~new_n70_ | new_n74_ | ~x07);
  assign z11 = new_n86_ & (~new_n85_ | (x27 & (~new_n74_ | ~x29)));
  assign new_n85_ = x08 & (new_n73_ | (new_n74_ & x29));
  assign new_n86_ = (~new_n73_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = ~new_n89_ & ~new_n68_;
  assign new_n89_ = (~new_n91_ | (~x30 & ~x32)) & (~x27 | (~new_n92_ & (new_n90_ | ~new_n91_)));
  ...
  assign z18 = ~new_n86_ | (new_n85_ & (~x27 | (new_n74_ & x29)));
  assign z19 = new_n86_ & (~new_n85_ | (x27 & (~new_n74_ | ~x29)));
endmodule
