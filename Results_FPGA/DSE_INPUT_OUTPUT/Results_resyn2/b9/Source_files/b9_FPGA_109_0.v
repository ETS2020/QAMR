...
module FAU ( 
  ...
  assign new_n68_ = x16 & (x02 | x40);
  assign z01 = (new_n72_ & (~x27 | (~new_n71_ & ~x36))) | new_n70_ | ~x04;
  assign new_n70_ = ~x02 & ~x40;
  ...
  assign new_n84_ = (~x05 | ~x39 | ~x40) & ((~x02 & ~x40) | ~x07 | (x39 & x40));
  assign new_n85_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n86_ = x06 & x37 & (x02 | x40);
  assign new_n87_ = ~x04 & x39 & x40 & x05 & (x30 | x32);
  assign z11 = (~x08 | (~new_n71_ & ~new_n89_) | (~new_n89_ & x27)) & new_n90_ & (~new_n71_ | x04 | ~x27);
  assign new_n89_ = x40 & x29 & x39;
  assign new_n90_ = ~x09 & ~x30 & (x02 | x40);
  ...
  assign z14 = ~new_n70_ & (new_n98_ | (~new_n93_ & ~new_n100_) | (~new_n97_ & (~new_n93_ | new_n99_)));
  assign new_n97_ = x20 & ~x18 & ~x19;
  assign new_n98_ = ~x30 & ~x32 & (~x27 | (x28 & ~x37 & (~x28 | ~x35)));
  ...
  assign z19 = ~new_n106_ & (new_n70_ | (~new_n105_ & ~x09 & ~x30));
  assign new_n105_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign new_n106_ = x08 & x29 & x39 & x40;
  assign z20 = ~new_n108_ & new_n90_ & (~x27 | ~x35);
  assign new_n108_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign z18 = new_n106_ | (~new_n70_ & (new_n105_ | x09 | x30));
endmodule
