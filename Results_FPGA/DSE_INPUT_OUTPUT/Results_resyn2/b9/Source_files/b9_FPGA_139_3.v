...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (~x32 | ~x37)) | (new_n68_ & ((~new_n66_ & ~new_n67_ & ~x37) | (~x32 & x37)));
  ...
  assign z12 = (~x37 & (new_n66_ | new_n93_)) | (~new_n92_ & ~x27 & (~x32 | ~x37));
  assign new_n92_ = x10 & ~x04 & x39 & x40;
  assign new_n93_ = ~x10 & ~x35 & ~x36;
  assign z13 = (x27 & (new_n98_ | (new_n96_ & ~new_n97_))) | new_n70_ | (~new_n95_ & new_n96_);
  assign new_n95_ = ~x30 & ~x32;
  assign new_n96_ = ~x04 & ~x13 & x39 & x40;
  assign new_n97_ = x28 & (~x35 | ~x36);
  assign new_n98_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~new_n100_ & (~new_n96_ | new_n101_)) | new_n102_ | new_n70_ | (~new_n96_ & ~new_n103_);
  assign new_n100_ = x20 & ~x18 & ~x19;
  assign new_n101_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n102_ = ~x30 & ~x32 & (~x27 | (~x37 & x28 & ~x35));
  assign new_n103_ = x27 & ((x28 & x35) | (~x32 & x37));
  ...
  assign z20 = new_n70_ | (~new_n89_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z05 = ~z06;
