...
module FAU ( 
  ...
  assign z07 = (x14 & ~x31) | ((~x38 | x00 | x25) & x03 & ~x14);
  assign z08 = new_n68_ | new_n72_;
  assign z09 = ~new_n68_ & x11 & x34 & x26 & x27;
  assign z10 = ~new_n68_ & (new_n81_ | (x37 & x06 & x27));
  assign new_n81_ = (new_n82_ | (new_n70_ & (new_n72_ | x07))) & ~x04 & (~new_n72_ | x05);
  ...
  assign z14 = (new_n89_ | ~x27) & ~new_n68_ & (~new_n82_ | x04 | x13);
  assign new_n89_ = ~new_n90_ & (~new_n91_ | (x28 & (~x35 | ~x36)));
  ...
  assign z13 = (~new_n89_ & x27) | new_n68_ | (new_n82_ & ~x04 & ~x13);
endmodule
