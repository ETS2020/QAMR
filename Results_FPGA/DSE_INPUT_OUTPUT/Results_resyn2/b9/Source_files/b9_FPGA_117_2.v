...
module FAU ( 
  ...
  assign z10 = ~new_n85_ | (new_n84_ & ((~new_n72_ & z08) | (new_n71_ & (z08 | x07))));
  ...
  assign z12 = (x40 & (new_n90_ | (~new_n91_ & (x04 | ~x39)))) | (~new_n91_ & ~x29 & ~x40);
  assign new_n90_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign new_n91_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n93_ | (~new_n94_ & new_n95_))) | new_n70_ | new_n96_;
  assign new_n93_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = ~x13 & x40 & ~x04 & x39;
  assign new_n96_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
  assign z14 = (new_n102_ & (new_n100_ | ~new_n101_)) | (new_n99_ & (~new_n95_ | new_n98_));
  assign new_n98_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n99_ = (~x20 | x18 | x19) & (~x29 | x40);
  assign new_n100_ = (~x27 | x28) & ~x30 & ~x32;
  assign new_n101_ = ~x04 & ~x13 & x39 & x40;
  assign new_n102_ = (~x29 | x40) & (~x27 | (~x37 & (~x28 | ~x35)));
  assign z15 = x12 & ~new_n70_ & x34 & x26 & x27;
  assign z16 = x01 & x22 & ~new_n70_ & ~x23;
  assign z17 = x01 & x22 & ~new_n70_ & x23 & ~x24;
  assign z19 = ((new_n107_ & ~new_n108_) | (x29 & ~x40)) & (~x08 | ~x29 | ~x39 | ~x40);
  assign new_n107_ = ~x09 & ~x30;
  assign new_n108_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z20 = new_n110_ & (~x08 | ((x28 | ~x35) & (~x29 | ~x39)));
  assign new_n110_ = (~x29 | x40) & ~x09 & ~x30 & (~x27 | ~x35);
