...
module FAU ( 
  ...
  assign z07 = new_n81_ & (new_n80_ | ~x14);
  assign new_n80_ = (x15 | ~x17) & (~x25 | ~x38) & ~x31 & ~x33;
  assign new_n81_ = x03 & (x25 | (x32 & (x00 | ~x38)));
  assign z08 = new_n72_ | new_n73_;
  assign z09 = new_n73_ | (x27 & x34 & x11 & x26);
  assign z10 = ~new_n87_ | (new_n86_ & ((new_n72_ & ~new_n85_) | (new_n70_ & (new_n72_ | x07))));
  assign new_n85_ = ~x30 & ~x32;
  assign new_n86_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n87_ = (x25 | x32) & (~x37 | ~x06 | ~x27);
  ...
  assign z14 = (~x27 | (~new_n95_ & (~new_n93_ | new_n94_))) & ~new_n73_ & (new_n85_ | ~new_n93_);
  ...
  assign z20 = new_n73_ | (~new_n89_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z13 = (x27 & (new_n95_ | (new_n93_ & ~new_n94_))) | new_n73_ | (~new_n85_ & new_n93_);
