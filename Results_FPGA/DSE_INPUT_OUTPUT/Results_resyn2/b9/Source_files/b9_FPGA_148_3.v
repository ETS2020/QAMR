...
module FAU ( 
  ...
  assign z07 = ((x00 & ~x25) | ~x38 | (~x14 & x25)) & ~new_n79_ & x03;
  assign new_n79_ = (x14 | (x11 & x33)) & (x31 | x33 | (~x15 & x17));
  assign z08 = new_n68_ | new_n72_;
  assign z09 = x34 & x26 & x27 & x11 & ~x33;
  ...
  assign z13 = ~new_n90_ & ~new_n68_;
  assign new_n90_ = (~new_n92_ | (~x30 & ~x32)) & (~x27 | (~new_n93_ & (new_n91_ | ~new_n92_)));
