...
module FAU ( 
  ...
  assign z12 = (x40 & (new_n92_ | (~new_n91_ & (new_n67_ | ~x27)))) | ((new_n67_ | ~x27) & x25 & ~x40);
  assign new_n91_ = ~x04 & x39;
  assign new_n92_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = new_n94_ | (~x04 & ~x13 & ~new_n71_ & x39 & x40);
  assign new_n94_ = x27 & ((~new_n95_ & new_n96_) | (new_n97_ & ~new_n67_ & ~new_n68_));
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = ~x13 & x40 & ~x04 & x39;
  assign new_n97_ = x20 & ~x18 & ~x19;
  assign z14 = ~new_n68_ & (new_n99_ | (~new_n97_ & (~new_n96_ | (new_n71_ & new_n95_))));
  assign new_n99_ = (new_n67_ | ~x27) & (~new_n100_ | (new_n71_ & (~x27 | x28)));
