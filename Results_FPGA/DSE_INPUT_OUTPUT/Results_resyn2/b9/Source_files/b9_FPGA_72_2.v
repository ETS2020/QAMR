...
module FAU ( 
  ...
  assign new_n81_ = ((x07 & ~x39) | (x05 & x39 & x40)) & ~new_n69_ & ~x04;
  assign new_n82_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = new_n85_ & (~new_n84_ | (x27 & (~x29 | ~x39)));
  assign new_n84_ = x08 & (new_n71_ | (x29 & x39));
  assign new_n85_ = (~new_n71_ | x04 | ~x27) & ~new_n67_ & ~x09 & ~x30;
  ...
  assign new_n97_ = (~x39 | x40) & ((new_n87_ & new_n93_) | (x39 & ~x04 & ~x13));
