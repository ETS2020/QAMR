...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x32 & (~x09 | (~x30 & (new_n70_ | ~x27))));
  ...
  assign z10 = (new_n84_ & x05) | (~new_n82_ & x27);
  assign new_n82_ = (new_n68_ | ~x06 | ~x37) & (new_n83_ | new_n70_ | x04);
  assign new_n83_ = (~x07 | (~x09 & ~x32) | (x39 & x40)) & (~x39 | ~x40 | ~x05 | ~x09);
  assign new_n84_ = new_n67_ & (x32 | (x09 & x30));
  assign z11 = ~x09 & (~x32 | (~new_n86_ & ~new_n88_ & ~x30));
  assign new_n86_ = new_n87_ & (~x27 | (x29 & x39 & x40));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n88_ = ~x04 & x27 & ~x28 & x35;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (~new_n91_ & x27) | (new_n84_ & ~x13);
  assign new_n91_ = (~new_n92_ | new_n66_ | (~x09 & ~x32)) & (~new_n93_ | new_n94_ | ~x09);
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign new_n93_ = ~x13 & ~x04 & x39 & x40;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign z14 = (~new_n97_ & ~x32) | (~new_n96_ & (~new_n92_ | new_n66_ | ~x27));
  assign new_n96_ = new_n93_ & (~new_n94_ | new_n92_ | x30 | x32);
  assign new_n97_ = x09 & (x30 | (x27 & (x37 | ~x28 | x35)));
  assign z15 = new_n68_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z19 = ~new_n86_ & ~new_n88_ & x32 & ~x09 & ~x30;
  assign z20 = ~new_n87_ & x32 & ~x09 & ~x30 & (~x27 | ~x35);
  assign z18 = new_n86_ | new_n88_ | ~x32 | x09 | x30;
endmodule
