...
module FAU ( 
  ...
  assign z10 = new_n85_ | ((new_n84_ | (x06 & x37)) & ~new_n68_ & x27);
  assign new_n84_ = ~new_n70_ & ~x04 & (~new_n72_ | (x05 & ~x17)) & (new_n72_ | x07);
  assign new_n85_ = new_n67_ & x05 & (x32 | (~x17 & x30));
  ...
  assign z14 = (new_n92_ | ~x27) & (~new_n93_ | (~x30 & ~x32)) & (~x17 | x32);
  ...
  assign z13 = (~new_n92_ & x27) | (new_n93_ & (x30 | x32)) | (x17 & ~x32);
