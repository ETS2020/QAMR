...
module FAU ( 
  ...
  assign new_n83_ = (~new_n72_ | (x05 & (new_n70_ | x30))) & ~x04 & (new_n72_ | (new_n70_ & x07));
  assign z11 = ~x30 & (x32 | (~new_n85_ & ~new_n86_ & ~x09));
  assign new_n85_ = x08 & ((~x28 & x35) | (new_n72_ & x29)) & (~x27 | (new_n72_ & x29));
  assign new_n86_ = ~x04 & ~x28 & x27 & x35;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = (x27 | (new_n90_ & x30)) & (new_n89_ | (new_n90_ & x30) | (~new_n91_ & new_n90_ & ~x32));
  ...
  assign z18 = new_n85_ | new_n86_ | x32 | x09 | x30;
  assign z20 = new_n100_ & (~x08 | ((x28 | ~x35) & (~new_n72_ | ~x29)));
  assign new_n100_ = (~x27 | ~x35) & ~x32 & ~x09 & ~x30;
  assign z19 = ~x30 & (x32 | (~new_n85_ & ~new_n86_ & ~x09));
endmodule
