...
module FAU ( 
  ...
  assign z00 = ~new_n65_ & (~x16 | (new_n68_ & (new_n66_ | (new_n67_ & ~x04))));
  assign new_n65_ = x10 & x33;
  ...
  assign z02 = ~new_n65_ & (new_n73_ | ~new_n67_ | (~x02 & (~x08 | ~x29)));
  ...
  assign z10 = ~new_n65_ & (new_n85_ | (~x04 & (new_n84_ | (new_n70_ & ~new_n83_))));
  assign new_n83_ = (x39 & x40) ? ~x05 : ~x07;
  assign new_n84_ = (x30 | x32) & x05 & x39 & x40;
  assign new_n85_ = x37 & x06 & x27;
  assign z11 = ~new_n65_ & new_n88_ & (~new_n87_ | (x27 & (~new_n67_ | ~x29)));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n88_ = (~x27 | ~x35 | x04 | x28) & ~x09 & ~x30;
  assign z12 = ~new_n90_ | (~new_n66_ & (~new_n67_ | x04));
  assign new_n90_ = x10 ? ~x33 : (x27 & (x37 | x35 | x36));
  assign z13 = ~new_n65_ & ((~new_n71_ & new_n93_) | (x27 & (new_n94_ | (~new_n92_ & new_n93_))));
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x04 & ~x13 & x39 & x40;
  assign new_n94_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = ~new_n65_ & (new_n71_ | ~new_n93_) & (~x27 | (~new_n94_ & (new_n92_ | ~new_n93_)));
  assign z15 = new_n65_ | (x12 & x26 & x27 & x34);
  assign z16 = x01 & x22 & ~new_n65_ & ~x23;
  assign z17 = new_n65_ | (x01 & x22 & x23 & ~x24);
  assign z19 = new_n65_ | (new_n88_ & (~new_n87_ | (x27 & (~new_n67_ | ~x29))));
  assign z20 = ~new_n87_ & ~x09 & ~x30 & ~new_n65_ & (~x27 | ~x35);
  assign z18 = new_n65_ | ~new_n88_ | (new_n87_ & (~x27 | (new_n67_ & x29)));
endmodule
