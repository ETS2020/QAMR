...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    ...
    new_n89_, new_n91_, new_n92_, new_n94_, new_n95_, new_n96_;
  assign z00 = (~new_n65_ & ~new_n66_) | (~new_n67_ & new_n68_ & ~x15);
  assign new_n65_ = x12 & ~x40;
  assign new_n66_ = x16 & ((~x37 & (~x28 | ~x35)) | x15 | ~x27);
  ...
  assign new_n80_ = x03 & (~x12 | x40);
  assign z08 = new_n65_ | new_n73_;
  assign z09 = ~new_n65_ & x11 & x34 & x26 & x27;
  assign z10 = new_n86_ | (x27 & (new_n85_ | (~new_n84_ & ~new_n70_ & ~x04)));
  assign new_n84_ = (~x05 | ~x39 | ~x40) & (~x07 | (x39 & x40) | (x12 & ~x40));
  assign new_n85_ = (~x12 | x40) & x06 & x37;
  assign new_n86_ = x05 & (x30 | x32) & ~x04 & x39 & x40;
  assign z11 = new_n65_ | (new_n89_ & (~new_n88_ | (x27 & (~new_n73_ | ~x29))));
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n89_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n65_ | ((~new_n68_ | ~x10) & (~x27 | (new_n91_ & (new_n92_ | ~new_n68_))));
  assign new_n91_ = ~x37 & (~x28 | ~x35);
  assign new_n92_ = ~x35 & ~x36;
  assign z13 = new_n65_ | (~new_n71_ & new_n95_) | (x27 & (new_n96_ | (~new_n94_ & new_n95_)));
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = ~x13 & ~x04 & x39 & x40;
  assign new_n96_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = new_n65_ | ((new_n71_ | ~new_n95_) & (~x27 | (~new_n96_ & (new_n94_ | ~new_n95_))));
  assign z15 = x12 & (~x40 | (x34 & x26 & x27));
  assign z16 = new_n65_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n65_ & x23 & ~x24;
  assign z19 = ~new_n65_ & new_n89_ & (~new_n88_ | (x27 & (~new_n73_ | ~x29)));
  assign z20 = new_n65_ | (~new_n88_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z05 = (x27 & x28) | new_n65_ | x37;
  assign z18 = new_n65_ | ~new_n89_ | (new_n88_ & (~x27 | (new_n73_ & x29)));
endmodule
