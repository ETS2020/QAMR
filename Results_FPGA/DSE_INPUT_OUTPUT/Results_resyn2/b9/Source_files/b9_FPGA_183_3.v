...
module FAU ( 
  ...
  assign z07 = ((x00 & ~x25) | ~x38 | (~x14 & x25)) & ~new_n79_ & new_n80_;
  ...
  assign z10 = ~new_n85_ | ((new_n73_ | new_n84_) & ~new_n71_ & ~x04 & (~new_n73_ | x05));
  assign new_n84_ = x07 & x27 & (x36 | (~x28 & x35));
  assign new_n85_ = (~x13 | ~x17) & (~x37 | ~x06 | ~x27);
  ...
  assign z13 = (new_n94_ & new_n95_) | (new_n92_ & (~new_n91_ | new_n93_));
  assign new_n91_ = ~x30 & ~x32;
  assign new_n92_ = ~x13 & ~x04 & x39 & x40;
  assign new_n93_ = (~x28 | (x35 & x36)) & x27 & (~x13 | ~x17);
  assign new_n94_ = ~x18 & ~x19 & (x37 | (x28 & x35));
  assign new_n95_ = (~x13 | ~x17) & x20 & x27;
  assign z14 = new_n70_ | ((new_n91_ | ~new_n92_) & (~x27 | (~new_n98_ & (~new_n92_ | new_n97_))));
