...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n79_, new_n83_, new_n85_, new_n86_, new_n87_, new_n90_, new_n91_,
  ...
  assign z01 = (~x04 & (~x05 | x32)) | ((new_n70_ | ~x27) & ~x05 & ~x30 & ~x32);
  ...
  assign z10 = (~new_n83_ & x27) | (x05 & (new_n67_ | ~x32));
  assign new_n83_ = (~x06 | ~x37) & (new_n70_ | new_n72_ | x04 | ~x07);
  ...
  assign z13 = (~new_n90_ & x27) | (new_n91_ & (x30 | x32)) | (x05 & ~x32);
  assign new_n90_ = (~new_n91_ | (x28 & (~x35 | ~x36))) & (~new_n92_ | (~x37 & (~x28 | ~x35)));
  assign new_n91_ = x39 & x40 & ~x04 & ~x13;
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign z14 = new_n94_ | (~new_n96_ & ~x32);
  assign new_n94_ = (~new_n91_ | (~new_n92_ & new_n95_)) & (~new_n92_ | new_n66_ | ~x27);
  assign new_n95_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n96_ = ~x05 & (x30 | (x27 & (x37 | ~x28 | x35)));
