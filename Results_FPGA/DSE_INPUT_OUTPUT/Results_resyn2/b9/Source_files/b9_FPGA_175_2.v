...
module FAU ( 
  ...
  assign z01 = ((new_n70_ | ~x27) & ~x30 & ~x32) | ~x04 | (x32 & ~x40);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = new_n72_ ^ (new_n73_ | ~z08 | (~x02 & (~x08 | ~x29)));
  ...
  assign z07 = new_n72_ | (new_n79_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  ...
  assign new_n82_ = (x39 & x40) ? ~x05 : (~x07 | (x32 & ~x40));
  assign new_n83_ = (~x32 | x40) & x06 & x37;
  assign new_n84_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = new_n72_ | (new_n87_ & (~new_n86_ | (x27 & (~z08 | ~x29))));
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n87_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = (new_n89_ | ~x40 | x04 | ~x39) & ~new_n90_ & (~x32 | x40);
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36));
  assign new_n90_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n92_ | (~new_n93_ & new_n94_ & x40))) | (~new_n95_ & (new_n94_ | ~x40));
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = ~x13 & ~x04 & x39;
  assign new_n95_ = ~x32 & (~x30 | ~x40);
  assign z14 = (~new_n97_ & (new_n98_ | new_n99_)) | (~new_n90_ & new_n98_) | (new_n95_ & ~new_n100_);
  assign new_n97_ = x20 & ~x18 & ~x19;
  assign new_n98_ = x40 & (x13 | x04 | ~x39);
  assign new_n99_ = ~x32 & (~x40 | (~x30 & x28 & (~x35 | ~x36)));
  assign new_n100_ = x27 & (x37 | (x28 & x35) | (~x28 & x40));
  assign z15 = new_n72_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n72_ | (~x23 & x01 & x22);
  assign z17 = new_n72_ | (x01 & x22 & x23 & ~x24);
  assign z19 = ~new_n72_ & new_n87_ & (~new_n86_ | (x27 & (~z08 | ~x29)));
  assign z20 = new_n72_ | (~new_n86_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z06 = new_n72_ | (~x37 & (~x27 | ~x28));
  assign z18 = new_n72_ | ~new_n87_ | (new_n86_ & (~x27 | (z08 & x29)));
endmodule
