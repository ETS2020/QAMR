...
module FAU ( 
  ...
  assign z18 = (~x39 & ~x40) | ~new_n85_ | (new_n84_ & (~x27 | (x29 & x39 & x40)));
  assign z20 = new_n68_ | (~new_n84_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z05 = (x27 & x28) | new_n68_ | x37;
  assign z19 = (~x39 & ~x40) | (new_n85_ & (~new_n84_ | (x27 & (~x29 | ~x39 | ~x40))));
endmodule
