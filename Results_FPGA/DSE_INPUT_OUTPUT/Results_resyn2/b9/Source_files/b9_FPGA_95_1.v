...
module FAU ( 
  ...
  assign z01 = (~x04 & (x12 | ~x32)) | (~x30 & ~x32 & (new_n70_ | ~x27));
  ...
  assign new_n84_ = (~x07 | (x39 & x40) | (~x12 & x32)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n85_ = new_n72_ & (x12 | ~x32) & ~x04 & (x30 | x32);
  ...
  assign z13 = new_n94_ | (x27 & ((new_n92_ & (x12 | ~x32)) | (new_n93_ & ~x32)));
  assign new_n92_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n93_ = new_n72_ & ~x04 & ~x13 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x13 & new_n72_ & (x12 | ~x32) & ~x04 & (x30 | x32);
  assign z14 = (~x27 | (~new_n92_ & ~new_n93_)) & ~new_n96_ & ~new_n68_;
  assign new_n96_ = (x30 | x32) & new_n72_ & ~x04 & ~x13;
