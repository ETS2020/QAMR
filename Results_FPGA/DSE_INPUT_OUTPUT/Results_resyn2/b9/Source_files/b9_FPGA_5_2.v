...
module FAU ( 
  ...
  assign new_n68_ = x29 & ~x32;
  assign z01 = (~x04 & (~x29 | x32)) | ((new_n70_ | ~x27) & ~x29 & ~x30 & ~x32);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n72_ | (x04 & (~new_n74_ | (~x08 & ~x27)));
  assign new_n72_ = new_n73_ & (~x29 | x32) & (x02 | (x08 & x29));
  ...
  assign z10 = (~new_n84_ & x27) | (~new_n86_ & new_n67_ & x05);
  assign new_n84_ = (~new_n85_ | new_n70_ | new_n68_ | x04) & (new_n68_ | ~x06 | ~x37);
  assign new_n85_ = (x39 & x40) ? (x05 & ~x29) : x07;
  assign new_n86_ = ~x32 & (x29 | ~x30);
  assign z11 = new_n89_ & (~new_n88_ | (x27 & (~new_n73_ | ~x29)));
  assign new_n88_ = x08 & (new_n74_ | (new_n73_ & x29));
  assign new_n89_ = (~new_n74_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = new_n94_ | (x27 & ((new_n95_ & (~x29 | x32)) | (new_n92_ & ~x29)));
  ...
  assign z14 = ~new_n97_ & (~new_n93_ | (~x30 & ~x32)) & (~x29 | x32);
  assign new_n97_ = x27 & (new_n95_ | (new_n93_ & (~x28 | (x35 & x36))));
  ...
  assign z18 = ~new_n89_ | (new_n88_ & (~x27 | (new_n73_ & x29)));
  assign z19 = new_n89_ & (~new_n88_ | (x27 & (~new_n73_ | ~x29)));
endmodule
