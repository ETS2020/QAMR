...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n89_, new_n90_, new_n93_, new_n99_, new_n100_;
  ...
  assign z18 = x30 | (x32 & (~new_n100_ | (new_n99_ & (new_n89_ | ~x27))));
  assign new_n99_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n100_ = ~x09 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = ~new_n99_ & new_n90_ & (~x27 | ~x35);
