...
module FAU ( 
  ...
  assign z01 = (~x04 & (x23 | x32)) | ((new_n70_ | ~x27) & ~x32 & x23 & ~x30);
  ...
  assign new_n83_ = (~new_n84_ | new_n70_ | new_n68_ | x04) & (new_n68_ | ~x06 | ~x37);
  assign new_n84_ = (x39 & x40) ? (x05 & x23) : x07;
  assign new_n85_ = new_n67_ & (x32 | (x23 & x30));
  ...
  assign z13 = (x27 & (new_n93_ | (new_n92_ & ~new_n68_))) | (new_n85_ & ~x13);
  assign new_n92_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n93_ = new_n94_ & ~new_n95_ & x23;
  assign new_n94_ = ~x13 & ~x04 & x39 & x40;
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign z14 = ~new_n97_ & (~new_n92_ | ~x27);
  assign new_n97_ = (new_n94_ | (~x23 & ~x32)) & ((~new_n95_ & x27) | x32 | ~x23 | x30);
  assign z15 = x12 & ~new_n68_ & x34 & x26 & x27;
  assign z16 = x01 & x22 & ~x23 & x32;
  assign z17 = (~x23 & ~x32) | (x01 & x22 & x23 & ~x24);
