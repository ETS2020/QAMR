...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n71_, new_n72_, new_n73_,
    new_n78_, new_n82_, new_n84_, new_n85_, new_n88_, new_n89_;
  ...
  assign new_n84_ = x08 & (new_n72_ | (new_n73_ & x29));
  ...
  assign z05 = ~z06;
  assign z18 = ~new_n85_ | (new_n84_ & (~x27 | (new_n73_ & x29)));
  assign z19 = new_n85_ & (~new_n84_ | (x27 & (~new_n73_ | ~x29)));
endmodule
