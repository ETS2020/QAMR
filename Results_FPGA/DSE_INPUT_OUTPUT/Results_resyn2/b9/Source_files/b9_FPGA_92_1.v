...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n73_,
    new_n78_, new_n81_, new_n83_, new_n86_, new_n87_, new_n88_, new_n89_,
    new_n90_, new_n92_, new_n93_, new_n94_, new_n99_;
  ...
  assign z02 = new_n72_ | (~new_n73_ & ~x02) | ~x39 | ~x40;
  ...
  assign z18 = (x39 | ~x40) & (new_n83_ | x09 | x30 | (new_n73_ & x40));
  assign new_n83_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z12 = new_n65_ | new_n67_;
  assign z13 = new_n86_ | (~new_n70_ & new_n89_);
  assign new_n86_ = x27 & ((~new_n88_ & new_n89_) | (new_n90_ & ~new_n87_ & ~new_n67_));
  assign new_n87_ = ~x37 & (~x28 | ~x35);
  assign new_n88_ = x28 & (~x35 | ~x36);
  assign new_n89_ = ~x04 & ~x13 & x39 & x40;
  assign new_n90_ = x20 & ~x18 & ~x19;
  assign z14 = new_n93_ | (~new_n92_ & new_n70_ & x39);
  assign new_n92_ = x27 & (~new_n88_ | (new_n90_ & (x35 | x37)));
  assign new_n93_ = ((~new_n94_ & x39) | ~x40) & (~new_n90_ | new_n87_ | ~x27);
  ...
  assign z20 = ~new_n99_ & (~x27 | ~x35) & ~new_n67_ & ~x09 & ~x30;
  assign new_n99_ = x08 & ((~x28 & x35) | (x29 & x40));
  assign z06 = ~z05;
  assign z11 = ~z18;
  assign z08 = x40;
  assign z19 = z11;
