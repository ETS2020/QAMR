...
module FAU ( 
  ...
  assign new_n99_ = ~x07 & ((~x30 & ~x32) | x13 | x04 | ~x39);
  assign z14 = (~new_n93_ & (~new_n97_ | new_n102_)) | new_n70_ | (~new_n101_ & (~new_n97_ | new_n103_));
  ...
  assign z18 = new_n108_ | (~new_n70_ & (~new_n87_ | (new_n73_ & (~x04 | ~x27))));
  assign new_n108_ = ~x07 & x08 & x40 & x29 & x39;
  assign z19 = (~new_n89_ | new_n110_) & ~new_n70_ & new_n87_ & (~new_n90_ | x04);
  assign new_n110_ = x27 & (~x40 | ~x29 | ~x39);
  assign z20 = new_n70_ | (~new_n89_ & new_n87_ & (~x27 | ~x35));
endmodule
