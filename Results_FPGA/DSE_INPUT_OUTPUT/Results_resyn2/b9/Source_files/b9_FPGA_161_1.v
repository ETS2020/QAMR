...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n90_, new_n91_, new_n94_, new_n95_, new_n96_, new_n97_, new_n102_,
  ...
  assign z10 = ~new_n87_ | (~x04 & ((new_n85_ & (new_n70_ | x30)) | (new_n70_ & new_n86_)));
  ...
  assign new_n97_ = x30 ? (x13 | x04 | ~x39 | ~x40) : ~x32;
  assign z15 = x12 & ~new_n75_ & x34 & x26 & x27;
  assign z16 = new_n75_ | (~x23 & x01 & x22);
  assign z17 = new_n75_ | (x01 & x22 & x23 & ~x24);
  assign z18 = x30 | (~x32 & (~new_n103_ | (new_n102_ & (new_n90_ | ~x27))));
  assign new_n102_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n103_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z19 = (~x08 | (~new_n105_ & ~new_n90_) | (~new_n90_ & x27)) & new_n106_ & (x04 | ~new_n105_ | ~x27);
  assign new_n105_ = ~x28 & x35;
  assign new_n106_ = ~x32 & ~x09 & ~x30;
  assign z20 = ~new_n102_ & new_n106_ & (~x27 | ~x35);
