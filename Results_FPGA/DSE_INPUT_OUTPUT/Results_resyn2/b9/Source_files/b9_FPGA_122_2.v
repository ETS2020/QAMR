...
module FAU ( 
  ...
  assign new_n83_ = ((~new_n70_ & ~x30) | ~new_n72_ | ~x05) & (~new_n70_ | new_n72_ | ~x07);
  assign new_n84_ = x32 & (~x40 | (x05 & ~x04 & x39));
  ...
  assign z13 = new_n90_ | ((x30 | x32) & new_n67_ & ~x13);
  assign new_n90_ = x27 & ((~new_n92_ & new_n93_) | (new_n91_ & ~new_n66_ & ~new_n68_));
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x13 & ~x04 & x39 & x40;
  assign z14 = new_n97_ | (~new_n95_ & (~x32 | (~new_n96_ & x40)) & (~new_n96_ | ~x30 | ~x40));
  assign new_n95_ = x27 & (~new_n66_ | (new_n96_ & ~x28 & x40));
  assign new_n96_ = ~x13 & ~x04 & x39;
  assign new_n97_ = ((new_n92_ & ~x30) | ~x40 | (~new_n96_ & x40)) & ~new_n91_ & (~x32 | (~new_n96_ & x40));
  assign z15 = x12 & ~new_n68_ & x34 & x26 & x27;
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n102_ & ~new_n68_) | (new_n72_ & x08 & x29);
  assign new_n102_ = ~new_n103_ & ~x09 & ~x30;
  assign new_n103_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign z20 = new_n68_ | (~new_n86_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign z19 = new_n68_ | (new_n87_ & (~new_n86_ | (x27 & (~new_n72_ | ~x29))));
endmodule
