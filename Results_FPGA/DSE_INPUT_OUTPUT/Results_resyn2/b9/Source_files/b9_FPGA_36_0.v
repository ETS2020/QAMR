...
module FAU ( 
  ...
  assign new_n79_ = x03 & (x30 | x32);
  assign z08 = new_n72_ | new_n70_;
  assign z09 = x11 & ~new_n70_ & x34 & x26 & x27;
  assign z10 = ~new_n86_ | (~x04 & (new_n84_ | (new_n85_ & (new_n83_ | x36))));
  assign new_n83_ = ~x28 & x35;
  assign new_n84_ = x05 & x39 & x40;
  assign new_n85_ = x07 & x27 & (~x39 | ~x40);
  assign new_n86_ = (x30 | x32) & (~x37 | ~x06 | ~x27);
  assign z11 = (~x08 | (~new_n83_ & ~new_n88_) | (~new_n88_ & x27)) & new_n89_ & (~new_n83_ | x04 | ~x27);
  assign new_n88_ = x29 & x39 & x40;
  assign new_n89_ = x32 & ~x09 & ~x30;
  assign z12 = ~new_n70_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = new_n70_ | (~new_n65_ & new_n92_) | (~x13 & new_n72_ & ~x04);
  assign new_n92_ = x20 & x27 & ~x18 & ~x19;
  assign z14 = new_n70_ | ((new_n65_ | ~new_n92_) & (x13 | ~new_n72_ | x04));
  assign z15 = x12 & ~new_n70_ & x34 & x26 & x27;
  assign z16 = new_n70_ | (~x23 & x01 & x22);
  assign z17 = new_n70_ | (x01 & x22 & x23 & ~x24);
  assign z20 = ~new_n98_ & new_n89_ & (~x27 | ~x35);
  assign new_n98_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z18 = (x08 & (new_n83_ | new_n88_) & (new_n88_ | ~x27)) | ~new_n89_ | (new_n83_ & ~x04 & x27);
  assign z19 = (~x08 | (~new_n83_ & ~new_n88_) | (~new_n88_ & x27)) & new_n89_ & (~new_n83_ | x04 | ~x27);
endmodule
