...
module FAU ( 
  ...
  assign z10 = ~new_n86_ | (new_n85_ & ((~new_n72_ & new_n84_) | (new_n71_ & (new_n84_ | x07))));
  ...
  assign new_n95_ = (x39 | x40) & (x04 | x13 | (~x30 & ~x32) | ~x39 | ~x40);
  assign z14 = (~new_n94_ & (~new_n93_ | new_n97_)) | new_n70_ | (~new_n98_ & (~new_n93_ | new_n99_));
