...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n70_, new_n72_, new_n77_, new_n78_,
    ...
    new_n90_, new_n92_, new_n93_, new_n94_, new_n100_;
  ...
  assign z08 = x39 & x40;
  assign z01 = ((new_n70_ | ~x27) & ~x30 & ~x32) | new_n65_ | ~x04;
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = ~new_n65_ & (new_n72_ | ~z08 | (~x02 & (~x08 | ~x29)));
  ...
  assign new_n78_ = x03 & (~x20 | x40);
  assign z09 = new_n65_ | (x27 & x34 & x11 & x26);
  assign z10 = new_n83_ | (x27 & (new_n82_ | (~new_n81_ & ~new_n70_ & ~x04)));
  assign new_n81_ = (x39 & x40) ? ~x05 : (~x07 | (x20 & ~x40));
  assign new_n82_ = (~x20 | x40) & x06 & x37;
  assign new_n83_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = new_n65_ | (new_n87_ & (~new_n86_ | (~new_n85_ & x27)));
  assign new_n85_ = x29 & x39 & x40;
  assign new_n86_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n87_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n90_ | new_n65_ | (~new_n89_ & (~z08 | x04));
  assign new_n89_ = x27 & (x37 | (x28 & x35));
  assign new_n90_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = x40 & (new_n94_ | (x27 & (new_n92_ | new_n93_)));
  assign new_n92_ = (~x28 | (x35 & x36)) & x39 & ~x04 & ~x13;
  assign new_n93_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n94_ = (x30 | x32) & x39 & ~x04 & ~x13;
  assign z15 = x27 & x34 & ~new_n65_ & x12 & x26;
  assign z16 = x01 & x22 & ~new_n65_ & ~x23;
  assign z17 = x01 & x22 & ~new_n65_ & x23 & ~x24;
  assign z18 = new_n65_ | ~new_n87_ | (new_n86_ & (new_n85_ | ~x27));
  assign z19 = (new_n65_ | (~new_n100_ & ~x09 & ~x30)) & (~new_n85_ | ~x08);
  assign new_n100_ = ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign z20 = ~new_n86_ & (~x27 | ~x35) & ~new_n65_ & ~x09 & ~x30;
  assign z05 = (x27 & x28) | new_n65_ | x37;
  assign z14 = ~x40 | (~new_n94_ & (~x27 | (~new_n92_ & ~new_n93_)));
endmodule
