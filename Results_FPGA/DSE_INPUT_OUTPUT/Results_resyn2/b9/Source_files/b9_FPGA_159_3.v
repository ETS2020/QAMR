...
module FAU ( 
  ...
  assign z04 = ~new_n66_ & (x21 | ((x27 | ~x37) & (~x35 | ~x27 | ~x28)));
  assign z05 = ~new_n66_ & (x37 | (x27 & x28));
  assign z06 = ~new_n66_ & ~x37 & (~x27 | ~x28);
  assign z07 = new_n66_ | (x03 & ((~new_n74_ & new_n75_) | new_n76_));
  assign new_n74_ = x38 & (~x00 | x25);
  assign new_n75_ = (x15 | ~x17) & ~x31 & ~x33;
  assign new_n76_ = ~x14 & (~x38 | x00 | x25);
  assign z09 = x11 & ~new_n66_ & x27 & x26 & x34;
  assign z10 = new_n66_ | (x27 & (new_n79_ | (x06 & x37)));
  ...
  assign z15 = x12 & ~new_n66_ & x27 & x26 & x34;
  assign z16 = new_n66_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n66_ & x23 & ~x24;
  assign z18 = ~new_n66_ & (new_n82_ | x09 | x30);
