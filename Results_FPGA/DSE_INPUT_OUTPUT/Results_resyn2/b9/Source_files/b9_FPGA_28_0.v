...
module FAU ( 
  ...
  assign new_n83_ = (~x07 | (x39 & x40) | (~x17 & ~x32)) & (~x39 | ~x40 | ~x05 | ~x17);
  assign new_n84_ = ~x32 & (~x17 | ~x30);
  ...
  assign z13 = new_n93_ | (x27 & ((new_n91_ & (x17 | x32)) | (new_n92_ & x17)));
  assign new_n91_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n92_ = new_n67_ & ~x13 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x13 & new_n67_ & ~new_n84_;
  assign z14 = (new_n84_ | (~new_n95_ & (~new_n91_ | ~x27))) & ((~new_n91_ & ~new_n92_) | ~x17 | ~x27);
