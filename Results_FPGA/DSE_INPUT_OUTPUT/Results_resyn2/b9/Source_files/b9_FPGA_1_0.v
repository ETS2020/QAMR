// Benchmark "FAU" written by ABC on Tue Aug 11 21:45:30 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n71_, new_n72_, new_n77_,
    new_n81_, new_n82_, new_n84_, new_n85_, new_n88_, new_n89_;
  ...
  assign z11 = new_n85_ & (~new_n84_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n84_ = x08 & (new_n72_ | (x29 & x39 & x40));
  assign new_n85_ = (~new_n72_ | x04 | ~x27) & x32 & ~x09 & ~x30;
  ...
  assign z20 = ~new_n84_ & x32 & ~x09 & ~x30 & (~x27 | ~x35);
  assign z05 = ~z06;
  assign z18 = ~new_n85_ | (new_n84_ & (~x27 | (x29 & x39 & x40)));
  assign z19 = new_n85_ & (~new_n84_ | (x27 & (~x29 | ~x39 | ~x40)));
endmodule
