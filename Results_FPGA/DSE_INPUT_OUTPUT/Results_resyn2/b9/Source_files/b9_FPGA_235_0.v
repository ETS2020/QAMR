...
module FAU ( 
  ...
  assign z10 = ~new_n85_ | (~x04 & (new_n83_ | (new_n84_ & (new_n82_ | x36))));
  assign new_n82_ = ~x28 & x35;
  assign new_n83_ = x05 & x39 & x40;
  assign new_n84_ = x07 & x27 & (~x39 | ~x40);
  assign new_n85_ = (x30 | x32) & (~x37 | ~x06 | ~x27);
  assign z11 = (~x08 | (~new_n82_ & ~new_n87_) | (~new_n87_ & x27)) & new_n88_ & (~new_n82_ | x04 | ~x27);
  assign new_n87_ = x29 & x39 & x40;
  assign new_n88_ = x32 & ~x09 & ~x30;
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z13 = ~new_n70_ & ((~x13 & new_n72_ & ~x04) | (~new_n65_ & new_n91_));
  ...
  assign z20 = ~new_n96_ & new_n88_ & (~x27 | ~x35);
  assign new_n96_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z14 = new_n70_ | ((x13 | ~new_n72_ | x04) & (new_n65_ | ~new_n91_));
  assign z18 = (x08 & (new_n82_ | new_n87_) & (new_n87_ | ~x27)) | ~new_n88_ | (new_n82_ & ~x04 & x27);
  assign z19 = (~x08 | (~new_n82_ & ~new_n87_) | (~new_n87_ & x27)) & new_n88_ & (~new_n82_ | x04 | ~x27);
endmodule
