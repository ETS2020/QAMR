...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n90_, new_n91_, new_n94_, new_n95_, new_n96_;
  ...
  assign z01 = ((~x27 | (~new_n70_ & ~x36)) & ~x30 & ~x32) | ~x04 | (x30 & x32);
  ...
  assign z03 = ((new_n73_ | ~x27) & (new_n73_ | ~x37)) | ~x21 | (x27 & (~x28 | ~x35));
  assign z04 = ((new_n73_ | ~x27) & (new_n73_ | ~x37)) | x21 | (x27 & (~x28 | ~x35));
  ...
  assign new_n85_ = (~x07 | (x30 & x32) | (x39 & x40)) & (~x39 | ~x40 | ~x05 | x30);
  assign new_n86_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n87_ = x06 & x37 & (~x30 | ~x32);
  assign new_n88_ = (~x30 | ~x32) & (x30 | x32) & x05 & ~x04 & x39 & x40;
  assign z11 = new_n73_ | (new_n91_ & (~new_n90_ | (x27 & (~new_n72_ | ~x29))));
  assign new_n90_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n91_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = ~new_n73_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = (x27 & (~x30 | ~x32) & (new_n94_ | (~new_n95_ & new_n96_ & ~x30))) | (new_n96_ & (~x30 | ~x32) & (x30 | x32));
  assign new_n94_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = x39 & x40 & ~x04 & ~x13;
  assign z14 = ((~new_n96_ & (~x30 | ~x32)) | ((new_n95_ | ~x27) & ~x30 & ~x32)) & (~new_n94_ | ~x27);
  assign z15 = new_n73_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n73_ & ~x23;
  assign z17 = new_n73_ | (x01 & x22 & x23 & ~x24);
  assign z19 = new_n91_ & (~new_n90_ | (x27 & (~new_n72_ | ~x29)));
  assign z20 = ~new_n90_ & ~x09 & ~x30 & (~x27 | ~x35);
  assign z18 = ~new_n91_ | (new_n90_ & (~x27 | (new_n72_ & x29)));
endmodule
