...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    new_n79_, new_n80_, new_n84_, new_n86_, new_n87_, new_n88_, new_n91_,
  ...
  assign z01 = (~x31 | x32) & (~x04 | (~x31 & ~new_n70_ & ~x30 & ~x32));
  ...
  assign new_n79_ = (new_n80_ | ~x14) & x03 & (~x31 | (~x14 & x32));
  assign new_n80_ = ~x33 & (x15 | ~x17);
  assign z08 = new_n68_ | new_n72_;
  assign z09 = x34 & x26 & x27 & ~new_n68_ & x11;
  assign z10 = (~new_n84_ & ~x04) | new_n68_ | (x37 & x06 & x27);
  assign new_n84_ = ((~new_n70_ & ~x30 & ~x32) | ~new_n72_ | ~x05) & (~new_n70_ | new_n72_ | ~x07);
  ...
  assign z13 = (~new_n91_ & x27) | (new_n93_ & (x32 | (x30 & ~x31)));
  assign new_n91_ = (~new_n92_ | new_n66_ | (x31 & ~x32)) & (~new_n93_ | new_n94_ | x31);
  ...
  assign new_n97_ = ~x31 & (x30 | (x27 & (x37 | ~x28 | x35)));
