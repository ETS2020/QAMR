...
module FAU ( 
  ...
  assign new_n68_ = x16 & (x14 | x40);
  assign z01 = ((new_n71_ | ~x27) & ~x30 & ~x32) | new_n70_ | ~x04;
  assign new_n70_ = ~x14 & ~x40;
  ...
  assign z07 = (~x14 & ~x40) | (new_n79_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  assign new_n79_ = x03 & (~x14 | (~x31 & ~x33 & (x15 | ~x17)));
  assign z08 = x39 & x40;
  assign z09 = new_n70_ | (x27 & x34 & x11 & x26);
  assign z10 = new_n85_ | (x27 & (new_n84_ | (~new_n83_ & ~new_n71_ & ~x04)));
  assign new_n83_ = (~x05 | ~x39 | ~x40) & ((~x14 & ~x40) | ~x07 | (x39 & x40));
  assign new_n84_ = (x14 | x40) & x06 & x37;
  assign new_n85_ = x05 & (x30 | x32) & ~x04 & x39 & x40;
  assign z11 = new_n70_ | (new_n89_ & (~new_n88_ | (~new_n87_ & x27)));
  ...
  assign z13 = new_n95_ | (x27 & ((~new_n92_ & new_n93_) | (~new_n70_ & new_n94_)));
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x13 & ~x04 & x39 & x40;
  assign new_n94_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n95_ = ~x13 & (x30 | x32) & ~x04 & x39 & x40;
  assign z14 = ~new_n70_ & ~new_n95_ & (~x27 | (~new_n94_ & (new_n92_ | ~new_n93_)));
  assign z15 = x27 & x34 & ~new_n70_ & x12 & x26;
  assign z16 = x01 & x22 & ~new_n70_ & ~x23;
  assign z17 = x01 & x22 & ~new_n70_ & x23 & ~x24;
  assign z19 = ~new_n70_ & new_n89_ & (~new_n88_ | (~new_n87_ & x27));
  assign z20 = ~new_n88_ & (~x27 | ~x35) & ~new_n70_ & ~x09 & ~x30;
  assign z18 = new_n70_ | ~new_n89_ | (new_n88_ & (new_n87_ | ~x27));
endmodule
