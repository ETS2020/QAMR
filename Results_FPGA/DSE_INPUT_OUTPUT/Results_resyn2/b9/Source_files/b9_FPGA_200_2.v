...
module FAU ( 
  ...
  assign new_n68_ = ~x15 & ~x04 & x39 & x40;
  ...
  assign z18 = (x29 & ~x40) | ~new_n89_ | (new_n88_ & (~x27 | (x29 & x39)));
  assign z20 = new_n65_ | (~new_n88_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z19 = (x29 & ~x40) | (new_n89_ & (~new_n88_ | (x27 & (~x29 | ~x39))));
endmodule
