...
module FAU ( 
  ...
  assign z01 = (~new_n69_ & ~x30 & ~x32) | new_n68_ | ~x04;
  ...
  assign z11 = (~x08 | (~new_n71_ & ~new_n85_) | (~new_n85_ & x27)) & new_n86_ & (~new_n71_ | x04 | ~x27);
  assign new_n85_ = x40 & x29 & x39;
  assign new_n86_ = (x39 | x40) & ~x09 & ~x30;
  assign z12 = new_n68_ | (~new_n90_ & (~x27 | (new_n88_ & ~new_n89_)));
  assign new_n88_ = ~x37 & (~x28 | ~x35);
  assign new_n89_ = (x35 | x36) & ~x04 & x39 & x40;
  assign new_n90_ = x10 & ~x04 & x39 & x40;
  assign z13 = ~new_n95_ | (x27 & ((~new_n92_ & new_n93_) | (~new_n88_ & new_n94_)));
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x13 & ~x04 & x39 & x40;
  assign new_n94_ = x20 & ~x18 & ~x19;
  assign new_n95_ = (x39 | x40) & ((~x30 & ~x32) | x13 | x04 | ~x39 | ~x40);
  assign z14 = ~new_n68_ & ((~new_n94_ & (~new_n93_ | new_n98_)) | (~new_n97_ & (~new_n93_ | new_n99_)));
  ...
  assign z18 = (x08 & (new_n71_ | new_n85_) & (new_n85_ | ~x27)) | ~new_n86_ | (new_n71_ & ~x04 & x27);
  assign z19 = (~x08 | (~new_n71_ & ~new_n85_) | (~new_n85_ & x27)) & new_n86_ & (~new_n71_ | x04 | ~x27);
endmodule
