...
module FAU ( 
  ...
  assign z10 = ~new_n85_ | (new_n84_ & ((new_n83_ & ~new_n70_) | (new_n69_ & (new_n83_ | x07))));
  assign new_n83_ = x39 & x40;
  assign new_n84_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n85_ = (x39 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = (~new_n87_ | new_n88_) & ~new_n89_ & new_n90_;
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n88_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n89_ = x27 & x35 & ~x04 & ~x28;
  assign new_n90_ = (x39 | x40) & ~x09 & ~x30;
  assign z12 = new_n93_ | (~x39 & ~x40) | (~new_n92_ & (x04 | ~x39 | ~x40));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign new_n93_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = (x27 & ((new_n97_ & new_n98_) | (~new_n95_ & new_n96_))) | (~new_n70_ & new_n96_);
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = ~x13 & ~x04 & x39 & x40;
  assign new_n97_ = ~x18 & ~x19 & (x37 | (x28 & x35));
  assign new_n98_ = x20 & (x39 | x40);
  assign z14 = new_n100_ & (~x27 | ((new_n95_ | ~new_n96_) & (~new_n97_ | ~x20)));
  assign new_n100_ = (x39 | x40) & ((~x30 & ~x32) | x13 | x04 | ~x39 | ~x40);
  ...
  assign z18 = (new_n87_ & ~new_n88_) | new_n89_ | ~new_n90_;
  assign z19 = (~new_n87_ | new_n88_) & ~new_n89_ & new_n90_;
endmodule
