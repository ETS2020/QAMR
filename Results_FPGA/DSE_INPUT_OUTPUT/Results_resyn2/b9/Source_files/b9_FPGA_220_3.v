...
module FAU ( 
  ...
  assign new_n84_ = x32 & (x19 | (new_n66_ & x05));
  ...
  assign z13 = (~new_n91_ & x27) | (new_n94_ & (x30 | x32));
  assign new_n91_ = ~new_n93_ & (~new_n92_ | x32 | (x28 & (~x35 | ~x36)));
  assign new_n92_ = ~x13 & ~x04 & x39 & x40;
  assign new_n93_ = ~x18 & x20 & ~x19 & (x37 | (x28 & x35));
  assign new_n94_ = (~x19 | ~x32) & ~x13 & ~x04 & x39 & x40;
  assign z14 = new_n96_ | new_n98_ | (~x30 & (new_n99_ | (~x27 & ~x32)));
  assign new_n96_ = (x18 | ~x20) & (~new_n92_ | new_n97_);
  assign new_n97_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n98_ = ~new_n94_ & (~x27 | new_n67_ | x19);
