...
module FAU ( 
  ...
  assign new_n68_ = x06 & ~x32;
  assign z01 = ~x04 | (~x32 & (x06 | (~new_n70_ & ~x30)));
  ...
  assign new_n82_ = (~x07 | (x39 & x40) | (x06 & ~x32)) & (x06 | ~x40 | ~x05 | ~x39);
  assign new_n83_ = (x32 | (~x06 & x30)) & x40 & x05 & x39;
  assign new_n84_ = x06 & x27 & x32 & x37;
  assign z11 = new_n86_ & ~new_n68_;
  assign new_n86_ = new_n88_ & (~new_n87_ | (x27 & (~new_n72_ | ~x29)));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n88_ = (x04 | x28 | ~x27 | ~x35) & ~x09 & ~x30;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = new_n91_ | new_n68_ | (~new_n92_ & new_n67_ & ~x13);
  assign new_n91_ = x20 & ~x18 & ~x19 & ~new_n66_ & x27;
  assign new_n92_ = ~x30 & ~x32 & (~x27 | (x28 & (~x35 | ~x36)));
  assign z14 = (~new_n91_ & ~new_n94_) | (~new_n96_ & ~x32);
  assign new_n94_ = new_n67_ & ~x13 & (~new_n95_ | ~x28 | (x35 & x36));
  assign new_n95_ = (~x20 | x18 | x19) & ~x30 & ~x32;
  assign new_n96_ = ~x06 & (x30 | (x27 & (x37 | ~x28 | x35)));
  ...
  assign z20 = ~new_n87_ & ~x09 & ~x30 & ~new_n68_ & (~x27 | ~x35);
  assign z06 = ~z05;
