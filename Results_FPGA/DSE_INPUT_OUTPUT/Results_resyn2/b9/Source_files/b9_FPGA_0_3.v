...
module FAU ( 
  ...
  assign new_n66_ = ~x04 & x39 & x40 & ~x12 & ~x15;
  assign new_n67_ = x12 & x40;
  assign new_n68_ = x27 & (x37 | (x28 & x35));
  assign z01 = (~new_n70_ & ~x30 & ~x32) | new_n67_ | ~x04;
  assign new_n70_ = x27 & (x36 | (~x28 & x35));
  assign z02 = new_n72_ | ~x40;
  assign new_n72_ = ~x12 & (new_n73_ | ~x39 | (~x02 & (~x08 | ~x29)));
  ...
  assign new_n83_ = ((~new_n70_ & ~x30 & ~x32) | ~new_n84_ | ~x05) & (~new_n70_ | new_n84_ | ~x07);
  assign new_n84_ = x39 & x40;
  assign z11 = new_n86_ & ~new_n67_;
  assign new_n86_ = new_n88_ & (~new_n87_ | (x27 & (~new_n84_ | ~x29)));
  ...
  assign z13 = new_n92_ | (x40 & (x12 | (new_n95_ & (x30 | x32))));
  ...
  assign z14 = (~new_n99_ & (~x40 | (~new_n97_ & ~x12))) | (~new_n68_ & (~x40 | (~new_n98_ & ~x12)));
  assign new_n97_ = new_n95_ & (x30 | x32 | ~x28 | (x35 & x36));
  assign new_n98_ = new_n95_ & (x30 | x32 | (x27 & ~x28));
