...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x26 | ~x32)) | (~new_n70_ & ~x30 & ~x32);
  ...
  assign z13 = ~new_n68_ & (new_n90_ | (new_n92_ & ~new_n93_));
  assign new_n90_ = new_n91_ & x20 & ~x18 & ~x19;
  assign new_n91_ = x27 & (x37 | (x28 & x35));
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = ~x30 & ~x32 & (~x27 | (x28 & (~x35 | ~x36)));
  assign z14 = ~new_n95_ & ((~new_n92_ & (~x26 | ~x32)) | (~new_n96_ & ~x30 & ~x32));
  assign new_n95_ = (new_n68_ | new_n91_) & x20 & ~x18 & ~x19;
  assign new_n96_ = (new_n68_ | x27) & (~x28 | (x35 & x36));
