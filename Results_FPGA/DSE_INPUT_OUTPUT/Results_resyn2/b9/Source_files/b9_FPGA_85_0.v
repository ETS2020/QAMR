...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n90_, new_n91_, new_n94_, new_n100_, new_n101_;
  ...
  assign z19 = (~x08 | (~new_n100_ & ~new_n89_) | (~new_n89_ & x27)) & new_n101_ & (~new_n100_ | x04 | ~x27);
  assign new_n100_ = ~x28 & x35;
  assign new_n101_ = x32 & ~x09 & ~x30;
  assign z20 = ~new_n90_ & new_n101_ & (~x27 | ~x35);
  assign z18 = (x08 & (new_n100_ | new_n89_) & (new_n89_ | ~x27)) | ~new_n101_ | (new_n100_ & ~x04 & x27);
endmodule
