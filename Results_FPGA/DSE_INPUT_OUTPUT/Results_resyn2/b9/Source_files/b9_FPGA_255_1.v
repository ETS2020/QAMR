...
module FAU ( 
  ...
  assign new_n76_ = ((x00 & ~x25) | ~x38 | (~x14 & x25)) & ~new_n67_ & x03;
  assign z09 = ~new_n67_ & x11 & x34 & x26 & x27;
  assign z10 = (~new_n79_ & ~x04) | new_n67_ | (x37 & x06 & x27);
  assign new_n79_ = ((~new_n69_ & ~x30 & ~x32) | ~x05 | ~x40) & (~new_n69_ | ~x07 | x40);
  assign z11 = new_n81_ | new_n67_;
  assign new_n81_ = new_n83_ & (~new_n82_ | (x27 & (~x29 | ~x40)));
  assign new_n82_ = x08 & ((~x28 & x35) | (x29 & x40));
  assign new_n83_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  ...
  assign z19 = new_n81_ & ~new_n67_;
  assign z20 = new_n67_ | (~new_n82_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z06 = ~z05;
  assign z18 = ~new_n81_ | new_n67_;
  assign z08 = x40;
endmodule
