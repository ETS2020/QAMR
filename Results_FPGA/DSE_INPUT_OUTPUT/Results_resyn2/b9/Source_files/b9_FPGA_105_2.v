...
module FAU ( 
  ...
  assign z01 = ~new_n68_ & (~x04 | ((new_n69_ | ~x27) & ~x30 & ~x32));
  ...
  assign z11 = (~x39 | x40) & new_n86_ & (~new_n85_ | (x27 & (~x29 | ~x39)));
  assign new_n85_ = x08 & ((~x28 & x35) | (x29 & x39));
  assign new_n86_ = (x28 | ~x35 | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = new_n89_ | (x39 & ~x40) | (~new_n88_ & (x04 | ~x39));
  assign new_n88_ = x27 & (x37 | (x28 & x35));
  assign new_n89_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = (x27 & ((new_n91_ & x39 & x40) | (new_n92_ & (~x39 | x40)))) | (new_n93_ & x39 & x40);
  assign new_n91_ = (~x28 | (x35 & x36)) & ~x04 & ~x13;
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n93_ = ~x13 & ~x04 & (x30 | x32);
  assign z14 = (~x27 | (~new_n92_ & (~new_n91_ | ~x39))) & (~x39 | (~new_n93_ & x40));
  assign z15 = x12 & ~new_n68_ & x34 & x26 & x27;
  assign z16 = x01 & x22 & ~new_n68_ & ~x23;
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z19 = (x39 & ~x40) | (new_n86_ & (~new_n85_ | (x27 & (~x29 | ~x39))));
  assign z20 = new_n68_ | (~new_n85_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z18 = (x39 & ~x40) | ~new_n86_ | (new_n85_ & (~x27 | (x29 & x39)));
  assign z08 = x39;
endmodule
