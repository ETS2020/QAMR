...
module FAU ( 
  ...
  assign new_n85_ = (~x07 | (x39 & x40) | (~x30 & x32)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n86_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n87_ = (x30 | ~x32) & x06 & x37;
  assign new_n88_ = ~x04 & x39 & x40 & x05 & x30;
  assign z11 = ~x30 & (x32 | (new_n92_ & (~new_n91_ | (~new_n90_ & x27))));
  ...
  assign z13 = (x27 & ((~x32 & new_n95_ & ~new_n96_) | (new_n97_ & (x30 | ~x32)))) | (new_n95_ & x30);
  ...
  assign new_n99_ = x30 ? (~x39 | ~x40 | x04 | x13) : ~x32;
  assign z15 = new_n72_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n72_ & ~x23;
  assign z17 = new_n72_ | (x01 & x22 & x23 & ~x24);
  assign z19 = (~x08 | (~new_n70_ & ~new_n90_) | (~new_n90_ & x27)) & new_n104_ & (~new_n70_ | x04 | ~x27);
  assign new_n104_ = ~x32 & ~x09 & ~x30;
  assign z20 = ~new_n91_ & new_n104_ & (~x27 | ~x35);
  assign z18 = (x08 & (new_n70_ | new_n90_) & (new_n90_ | ~x27)) | ~new_n104_ | (new_n70_ & ~x04 & x27);
endmodule
