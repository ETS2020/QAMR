// Benchmark "FAU" written by ABC on Tue Aug 11 21:46:44 2020
...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n74_, new_n75_, new_n78_, new_n80_,
    new_n81_;
  assign z00 = new_n65_ | new_n66_ | ~x16;
  ...
  assign new_n74_ = (~x00 | x25) & (x14 | ~x25) & x38;
  assign new_n75_ = x14 & ((~x15 & x17) | x31 | x33);
  assign z09 = ~new_n66_ & x11 & x34 & x26 & x27;
  assign z10 = new_n66_ | (x27 & (new_n78_ | (x06 & x37)));
  assign new_n78_ = ~x04 & x07 & (x36 | (~x28 & x35));
  assign z11 = new_n80_ & ~new_n81_;
  assign new_n80_ = (~x39 | ~x40) & ~x09 & ~x30;
  assign new_n81_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z12 = (~x37 & (~x28 | ~x35)) | ~x27 | (x39 & x40);
  assign z13 = ~z12 & x20 & ~x18 & ~x19;
  assign z15 = new_n66_ | (x12 & x34 & x26 & x27);
  assign z16 = x01 & x22 & ~new_n66_ & ~x23;
  assign z17 = new_n66_ | (x01 & x22 & x23 & ~x24);
  assign z18 = ~new_n66_ & (new_n81_ | x09 | x30);
  assign z20 = new_n80_ & (~x35 | (~x27 & (~x08 | x28)));
  assign z02 = 1'b1;
  assign z08 = 1'b0;
  assign z14 = z12 | ~x20 | x18 | x19;
  assign z19 = new_n66_ | (~new_n81_ & ~x09 & ~x30);
endmodule
