...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    new_n74_, new_n79_, new_n83_, new_n84_, new_n85_, new_n86_, new_n87_,
    new_n89_, new_n90_, new_n92_, new_n93_, new_n95_, new_n96_, new_n97_,
    new_n98_, new_n100_, new_n101_, new_n102_, new_n107_;
  ...
  assign new_n83_ = x40 & ~x04 & x39;
  assign new_n84_ = (~x07 | (x40 & (~x21 | x39))) & (~x39 | ~x40 | ~x05 | ~x21);
  assign new_n85_ = ~x04 & (x36 | (~x28 & x35));
  assign new_n86_ = x06 & x37 & (x21 | ~x40);
  assign new_n87_ = x05 & x21 & (x30 | x32);
  assign z11 = (~x08 | (~new_n73_ & ~new_n89_) | (~new_n89_ & x27)) & new_n90_ & (~new_n73_ | x04 | ~x27);
  assign new_n89_ = x40 & x29 & x39;
  assign new_n90_ = (x21 | ~x40) & ~x09 & ~x30;
  assign z12 = ~new_n92_ & (~x40 | (~new_n93_ & x21));
  assign new_n92_ = x27 & (x37 | (x28 & x35));
  assign new_n93_ = ~x04 & x39 & (x10 | (x27 & (x35 | x36)));
  assign z13 = (~new_n98_ & x40) | (x27 & (new_n97_ | (~new_n95_ & new_n96_)));
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = ~x13 & x40 & ~x04 & x39;
  assign new_n97_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n98_ = x21 & ((~x30 & ~x32) | x13 | x04 | ~x39);
  assign z14 = (~new_n92_ & (~new_n96_ | new_n101_)) | new_n70_ | (~new_n100_ & (~new_n96_ | new_n102_));
  assign new_n100_ = x20 & ~x18 & ~x19;
  assign new_n101_ = ~x30 & ~x32 & (~x27 | x28);
  ...
  assign z20 = ~new_n107_ & new_n90_ & (~x27 | ~x35);
  assign new_n107_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z18 = (x08 & (new_n73_ | new_n89_) & (new_n89_ | ~x27)) | ~new_n90_ | (new_n73_ & ~x04 & x27);
  assign z19 = (~x08 | (~new_n73_ & ~new_n89_) | (~new_n89_ & x27)) & new_n90_ & (~new_n73_ | x04 | ~x27);
endmodule
