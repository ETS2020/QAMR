...
module FAU ( 
  ...
  assign new_n85_ = (~x08 | (~new_n73_ & ~new_n86_) | (~new_n86_ & x27)) & ~x09 & (~new_n73_ | x04 | ~x27);
  assign new_n86_ = x29 & x39 & x40;
  assign z12 = new_n65_ & ~new_n68_;
  assign z13 = (x27 & (new_n89_ | (~new_n90_ & new_n91_))) | ((x30 | x32) & (new_n91_ | (x30 & x32)));
  assign new_n89_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n90_ = x28 & (~x35 | ~x36);
  assign new_n91_ = x39 & x40 & ~x04 & ~x13;
  assign z14 = ((~x30 & ~x32) | (~new_n91_ & (~x30 | ~x32))) & (~x27 | (~new_n89_ & (new_n90_ | (~new_n91_ & (~x30 | ~x32)))));
  assign z15 = new_n68_ | (x12 & x26 & x27 & x34);
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = new_n68_ | (x01 & x22 & x23 & ~x24);
  assign z20 = new_n97_ & (~x08 | (~new_n73_ & ~new_n86_));
  assign new_n97_ = ~x09 & ~x30 & (~x27 | ~x35);
  assign z05 = ~z06;
