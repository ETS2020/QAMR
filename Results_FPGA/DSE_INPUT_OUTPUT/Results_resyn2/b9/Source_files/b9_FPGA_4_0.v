...
module FAU ( 
  ...
  assign z13 = ~new_n96_ | (x27 & ((~new_n65_ & new_n95_) | (new_n93_ & ~new_n94_)));
  assign new_n93_ = ~x13 & ~x04 & x39 & x40;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = x20 & ~x18 & ~x19;
  assign new_n96_ = (x39 | x40) & ((~x30 & ~x32) | x13 | x04 | ~x39 | ~x40);
  assign z14 = (~new_n98_ & (~new_n93_ | new_n99_)) | new_n70_ | (~new_n95_ & (~new_n93_ | new_n100_));
