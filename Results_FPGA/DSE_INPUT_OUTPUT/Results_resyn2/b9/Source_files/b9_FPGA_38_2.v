...
module FAU ( 
  ...
  assign new_n65_ = x10 & x40 & ~x04 & x39;
  assign new_n66_ = ~x37 & (~x28 | ~x35);
  assign new_n67_ = x40 & ~x04 & x39 & (x35 | x36);
  assign new_n68_ = x16 & (~x13 | x32);
  assign z01 = (~x04 & (~x13 | x32)) | (~new_n70_ & ~x13 & ~x30 & ~x32);
  assign new_n70_ = x27 & (x36 | (~x28 & x35));
  assign z02 = new_n73_ | new_n72_ | ~new_n74_ | (~x02 & (~x08 | ~x29));
  assign new_n72_ = x13 & ~x32;
  assign new_n73_ = x04 & ((~x08 & ~x27) | x28 | ~x35);
  assign new_n74_ = x39 & x40;
  assign z03 = (x27 & (~x28 | ~x35)) | ~x21 | new_n72_ | (~x27 & ~x37);
  assign z04 = (x27 & (~x28 | ~x35)) | x21 | new_n72_ | (~x27 & ~x37);
  ...
  assign z10 = ~new_n87_ | (new_n86_ & ((~new_n85_ & new_n74_) | (new_n70_ & (new_n74_ | x07))));
  assign new_n85_ = ~x30 & ~x32;
  assign new_n86_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n87_ = (~x13 | x32) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n72_ | (new_n90_ & (~new_n89_ | (x27 & (~new_n74_ | ~x29))));
  assign new_n89_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n90_ = (x04 | ~x27 | x28 | ~x35) & ~x09 & ~x30;
  assign z12 = ~new_n72_ & ~new_n65_ & (~x27 | (new_n66_ & ~new_n67_));
  assign z13 = new_n97_ | (x27 & ((new_n93_ & new_n94_) | (~new_n95_ & new_n96_)));
  assign new_n93_ = x20 & ~x18 & ~x19;
  assign new_n94_ = (~x13 | x32) & (x37 | (x28 & x35));
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = ~x04 & ~x13 & x39 & x40;
  assign new_n97_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (new_n100_ & (~new_n96_ | (new_n85_ & ~new_n99_))) | (new_n101_ & (~new_n96_ | (new_n85_ & new_n95_)));
  assign new_n99_ = x27 & ~x28;
  assign new_n100_ = (~x13 | x32) & (~x27 | (~x37 & (~x28 | ~x35)));
  assign new_n101_ = (~x13 | x32) & (~x20 | x18 | x19);
  assign z15 = new_n72_ | (x27 & x34 & x12 & x26);
  assign z16 = x01 & x22 & ~new_n72_ & ~x23;
  assign z17 = new_n72_ | (x01 & x22 & x23 & ~x24);
  assign z19 = ~new_n72_ & new_n90_ & (~new_n89_ | (x27 & (~new_n74_ | ~x29)));
  assign z20 = new_n72_ | (~new_n89_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z18 = new_n72_ | ~new_n90_ | (new_n89_ & (~x27 | (new_n74_ & x29)));
endmodule
