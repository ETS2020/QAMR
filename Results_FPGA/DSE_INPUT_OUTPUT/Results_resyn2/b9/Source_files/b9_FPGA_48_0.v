...
module FAU ( 
  ...
  assign z01 = (~x04 & (x29 | x32)) | (x29 & ~new_n70_ & ~x30 & ~x32);
  assign new_n70_ = x27 & (x36 | (~x28 & x35));
  assign z02 = (x29 | x32) & (new_n73_ | ~new_n72_ | (~x02 & (~x08 | ~x29)));
  ...
  assign z13 = (~new_n90_ & x27) | (new_n92_ & (x32 | (x29 & x30)));
  assign new_n90_ = (~new_n91_ | new_n66_ | (~x29 & ~x32)) & (~new_n92_ | new_n93_ | ~x29);
