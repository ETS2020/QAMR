...
module FAU ( 
  ...
  assign new_n68_ = x16 & (x01 | x23);
  assign z01 = (~new_n71_ & new_n72_) | new_n70_ | ~x04;
  assign new_n70_ = ~x01 & ~x23;
  ...
  assign z10 = ~new_n85_ | (new_n84_ & ((new_n74_ & ~new_n72_) | (new_n71_ & (new_n74_ | x07))));
  assign new_n84_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n85_ = (x01 | x23) & (~x37 | ~x06 | ~x27);
  ...
  assign z14 = (~x27 | (~new_n91_ & (new_n92_ | ~new_n93_))) & ~new_n70_ & ~new_n94_;
  ...
  assign z20 = new_n70_ | (~new_n87_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z13 = (x27 & (new_n91_ | (~new_n92_ & new_n93_))) | new_n70_ | new_n94_;
