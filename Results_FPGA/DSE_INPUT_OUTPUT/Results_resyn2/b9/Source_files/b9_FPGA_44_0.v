...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n71_, new_n77_, new_n81_,
    new_n82_, new_n84_, new_n85_, new_n86_, new_n89_, new_n90_;
  ...
  assign new_n71_ = (x02 | (x08 & x29)) & ~new_n68_ & x39 & x40;
  ...
  assign z10 = ~new_n68_ & ((~new_n81_ & ~x04) | (x37 & x06 & x27));
  assign new_n81_ = (~x05 | ~x39 | ~x40) & (new_n82_ | ~x07 | ~x27 | (x39 & x40));
  assign new_n82_ = ~x36 & (x28 | ~x35);
  assign z11 = ~new_n84_ & ~new_n86_ & x32 & ~x09 & ~x30;
  assign new_n84_ = new_n85_ & (~x27 | (x29 & x39 & x40));
  assign new_n85_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n86_ = ~x04 & ~x28 & x27 & x35;
  assign z12 = new_n65_ | new_n68_;
  assign z13 = ~new_n89_ & ~new_n68_;
  assign new_n89_ = (~new_n67_ | x13) & (new_n66_ | ~new_n90_);
  assign new_n90_ = ~x18 & ~x19 & x20 & x27;
  assign z14 = new_n89_ & ~new_n68_;
  assign z15 = x12 & ~new_n68_ & x34 & x26 & x27;
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z19 = ~x30 & (~x32 | (~new_n84_ & ~new_n86_ & ~x09));
  assign z20 = ~new_n85_ & (~x27 | ~x35) & x32 & ~x09 & ~x30;
  assign z18 = new_n84_ | new_n86_ | ~x32 | x09 | x30;
endmodule
