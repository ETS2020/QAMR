...
module FAU ( 
  ...
  assign z00 = ~new_n67_ | (~x15 & ((~new_n65_ & x27) | (new_n66_ & (x10 | x27))));
  assign new_n65_ = ~x37 & (~x28 | ~x35);
  assign new_n66_ = ~x04 & x39 & x40;
  assign new_n67_ = x16 & (x35 | ~x40);
  assign z01 = (x35 | ~x40) & (new_n69_ | ~x04);
  assign new_n69_ = ~x30 & ~x32 & (~x27 | (~x36 & (x28 | ~x35)));
  assign z02 = ~new_n71_ | (x04 & (x28 | (~x08 & ~x27)));
  assign new_n71_ = (x02 | (x08 & x29)) & x40 & x35 & x39;
  ...
  assign new_n81_ = (~x28 | x36) & x05 & x39 & x40;
  assign new_n82_ = (~x40 | ~x35 | ~x39) & x07 & (x36 | (~x28 & x35));
  assign new_n83_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n84_ = (x35 | ~x40) & (~x37 | ~x06 | ~x27);
  assign z11 = (~x35 & x40) | (new_n86_ & (~x35 | (~new_n87_ & ~new_n88_)));
  assign new_n86_ = ~x09 & ~x30;
  assign new_n87_ = x08 & ((~x27 & ~x28) | (x29 & x39 & x40));
  assign new_n88_ = ~x28 & ~x04 & x27;
  assign z12 = new_n90_ | (~x10 & ~x27) | (~x35 & (~x37 | x40));
  assign new_n90_ = (x04 | ~x39 | ~x40) & (~x27 | (~x28 & ~x37));
  assign z13 = (~new_n94_ & x40) | (x27 & (new_n93_ | (~new_n65_ & new_n92_)));
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign new_n93_ = (~x28 | x36) & ~x04 & ~x13 & x39 & x40;
  assign new_n94_ = x35 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n92_ & (~new_n97_ | new_n98_)) | ~new_n99_ | (~new_n96_ & ~new_n97_);
  assign new_n96_ = x27 & (x28 | x37);
  assign new_n97_ = x39 & x40 & ~x04 & ~x13;
  assign new_n98_ = ~x30 & ~x32 & x28 & ~x36;
  assign new_n99_ = (x35 | (x37 & ~x40)) & (x27 | x30 | x32);
  assign z15 = x27 & x34 & x12 & x26 & (x35 | ~x40);
  assign z16 = x01 & x22 & ~x23 & (x35 | ~x40);
  assign z17 = (~x35 & x40) | (x01 & x22 & x23 & ~x24);
  assign z18 = (~new_n104_ & x08) | (new_n88_ & x35) | ~new_n86_ | (~x35 & x40);
  assign new_n104_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign z20 = new_n106_ & (~x40 | (x35 & (~x39 | ~x08 | ~x29)));
  assign new_n106_ = ~x09 & ~x30 & (~x35 | (~x27 & (~x08 | x28)));
  assign z06 = ~z05;
  assign z19 = (~x35 & x40) | (new_n86_ & (~x35 | (~new_n87_ & ~new_n88_)));
endmodule
