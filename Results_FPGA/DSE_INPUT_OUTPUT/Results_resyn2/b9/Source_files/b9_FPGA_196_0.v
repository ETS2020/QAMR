...
module FAU ( 
  ...
  assign z01 = ~x04 | (~x32 & (~x12 | (~new_n70_ & ~x30)));
  ...
  assign new_n83_ = ((~x32 & ~new_n70_ & ~x30) | ~new_n72_ | ~x05) & (~new_n70_ | new_n72_ | ~x07);
  ...
  assign z13 = new_n92_ | (x27 & ((new_n91_ & x12) | (new_n90_ & (x12 | x32))));
  assign new_n90_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n91_ = (~x28 | (x35 & x36)) & new_n67_ & ~x13;
  assign new_n92_ = new_n67_ & ~x13 & (x32 | (x12 & x30));
  assign z14 = ~new_n94_ & ~new_n68_ & (~x27 | (~new_n90_ & ~new_n91_));
  assign new_n94_ = new_n67_ & ~x13 & (x30 | x32);
  assign z15 = x12 ? (x34 & x26 & x27) : ~x32;
