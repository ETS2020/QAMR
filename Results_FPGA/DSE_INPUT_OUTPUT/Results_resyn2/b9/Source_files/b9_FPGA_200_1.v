...
module FAU ( 
  ...
  assign new_n72_ = (~x04 | (~x28 & x35)) & x29 & x39 & x40;
  ...
  assign z11 = new_n69_ | (new_n89_ & (~new_n88_ | (~new_n87_ & x27)));
  assign new_n87_ = x39 & x40;
  assign new_n88_ = x08 & ((x39 & x40) | (~x28 & x35));
  assign new_n89_ = (x28 | ~x35 | x04 | ~x27) & ~x09 & ~x30;
  assign z12 = new_n69_ | ((~new_n67_ | ~x10) & (~x27 | (new_n91_ & (new_n92_ | ~new_n67_))));
  ...
  assign new_n97_ = x29 & (x04 | x13 | ~x39 | (~x30 & ~x32));
  assign z14 = (~new_n100_ & (~new_n95_ | new_n101_)) | new_n69_ | (~new_n99_ & (~new_n95_ | new_n102_));
  ...
  assign z18 = new_n69_ | ~new_n89_ | (new_n88_ & (new_n87_ | ~x27));
  assign z20 = new_n69_ | (~new_n88_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z19 = new_n69_ | (new_n89_ & (~new_n88_ | (~new_n87_ & x27)));
endmodule
