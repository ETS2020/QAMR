...
module FAU ( 
  ...
  assign new_n80_ = (~x25 | (x32 & (~x14 | ~x38))) & x03 & (~x38 | x00 | x25);
  ...
  assign new_n86_ = (~x25 | x32) & (~x37 | ~x06 | ~x27);
  ...
  assign z13 = (x27 & (new_n94_ | (~new_n92_ & new_n93_))) | new_n73_ | new_n95_;
  ...
  assign new_n98_ = ~x25 & (x30 | (x27 & (x37 | ~x28 | x35)));
  ...
  assign z20 = ~new_n88_ & (~x27 | ~x35) & ~new_n73_ & ~x09 & ~x30;
