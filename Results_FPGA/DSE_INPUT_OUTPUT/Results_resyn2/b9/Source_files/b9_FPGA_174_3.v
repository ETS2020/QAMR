...
module FAU ( 
  ...
  assign new_n68_ = x16 & (~x22 | ~x33);
  assign z01 = ~new_n70_ & (~x04 | (~new_n71_ & new_n72_));
  assign new_n70_ = x22 & x33;
  ...
  assign z07 = ((x00 & ~x25) | ~x38 | (~x14 & x25)) & ~new_n81_ & x03;
  assign new_n81_ = (x14 | (x22 & x33)) & ((~x15 & x17) | x31 | x33);
  ...
  assign z16 = x01 & x22 & ~x23 & ~x33;
  assign z17 = x01 & x22 & ~x33 & x23 & ~x24;
