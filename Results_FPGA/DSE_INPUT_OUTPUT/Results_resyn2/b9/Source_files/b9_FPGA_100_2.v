...
module FAU ( 
  ...
  assign new_n85_ = (x39 & x40) ? (x05 & ~x23) : x07;
  assign new_n86_ = new_n67_ & (x32 | (~x23 & x30));
  ...
  assign z13 = (~new_n93_ & x27) | (new_n86_ & ~x13);
  assign new_n93_ = (~new_n95_ | ~new_n96_) & (~new_n94_ | ~x20 | x18 | x19);
  assign new_n94_ = (~x23 | x32) & (x37 | (x28 & x35));
  assign new_n95_ = ~x13 & ~x04 & x39 & x40;
  assign new_n96_ = ~x23 & (~x28 | (x35 & x36));
  assign z14 = new_n99_ | (~new_n98_ & (~x20 | x18 | x19));
  assign new_n98_ = (new_n68_ | new_n95_) & (~new_n71_ | ~x28 | (x35 & x36));
  assign new_n99_ = (~new_n95_ | (new_n71_ & (~x27 | x28))) & ~new_n68_ & (new_n66_ | ~x27);
