...
module FAU ( 
  ...
  assign z10 = (~new_n82_ & x27 & (x30 | ~x32)) | (new_n67_ & x05 & x30);
  ...
  assign z13 = (x27 | (new_n90_ & x30)) & ((~new_n91_ & new_n90_ & ~x32) | new_n89_ | (new_n90_ & x30));
  assign new_n89_ = ~new_n68_ & ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n90_ = x39 & x40 & ~x04 & ~x13;
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign z14 = ~new_n94_ | (~new_n93_ & (~x20 | x18 | x19));
  assign new_n93_ = new_n90_ & (~new_n91_ | x30);
  assign new_n94_ = (~new_n66_ | (new_n90_ & (~x28 | x30))) & (x30 | ~x32) & (x27 | (new_n90_ & x30));
  ...
  assign z20 = ~x30 & (x32 | (new_n100_ & (~x08 | (~new_n70_ & ~new_n86_))));
  assign new_n100_ = ~x09 & (~x27 | ~x35);
  assign z18 = ~new_n85_ | x30 | x32;
endmodule
