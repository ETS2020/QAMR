...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n73_,
    ...
    new_n90_, new_n93_, new_n94_, new_n95_, new_n96_, new_n98_, new_n103_;
  ...
  assign new_n86_ = (x18 | x32) & (~x37 | ~x06 | ~x27);
  ...
  assign new_n90_ = (x18 | x32) & ~x09 & ~x30;
  ...
  assign z14 = (~new_n98_ & ~x32) | (~new_n94_ & (~new_n95_ | ~x27));
  assign new_n98_ = x18 & (x30 | (x27 & (~x28 | (x35 & x36))));
  assign z15 = x12 & ~new_n73_ & x34 & x26 & x27;
  assign z16 = new_n73_ | (~x23 & x01 & x22);
  assign z17 = new_n73_ | (x01 & x22 & x23 & ~x24);
  assign z20 = ~new_n103_ & new_n90_ & (~x27 | ~x35);
