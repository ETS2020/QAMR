...
module FAU ( 
  ...
  assign new_n81_ = ((~new_n69_ & ~x30 & ~x32) | ~x05 | ~x40) & (~new_n69_ | ~x07 | x40);
  assign z18 = ~new_n67_ & (~new_n83_ | (new_n72_ & (x08 | x27) & (~x04 | ~x27)));
  assign new_n83_ = ~x09 & ~x30 & (~x40 | ~x08 | ~x29);
  assign z12 = (new_n86_ | ~x40) & (new_n85_ | ~x27);
