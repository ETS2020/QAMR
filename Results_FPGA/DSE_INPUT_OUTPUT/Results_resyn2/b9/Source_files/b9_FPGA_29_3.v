...
module FAU ( 
  ...
  assign z01 = ((new_n70_ | ~x27) & ~x30 & ~x32) | ~x04 | (x30 & x32);
  ...
  assign new_n84_ = (~x07 | (x30 & x32) | (x39 & x40)) & (~x39 | ~x40 | ~x05 | x30);
  assign new_n85_ = (~x30 | ~x32) & x06 & x37;
  assign new_n86_ = ~x04 & x39 & x40 & (x30 | x32) & x05 & (~x30 | ~x32);
  assign z11 = x30 ? x32 : (new_n90_ & (~new_n88_ | new_n89_));
  assign new_n88_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n89_ = x27 & (~x29 | ~x39 | ~x40);
  assign new_n90_ = ~x09 & (x04 | ~x27 | x28 | ~x35);
  assign z12 = ~new_n73_ & ~new_n67_ & (~x27 | (new_n65_ & ~new_n66_));
  assign z13 = (~x30 | ~x32) & ((new_n95_ & x27) | (new_n93_ & (x30 | x32 | (~new_n94_ & x27))));
  assign new_n93_ = x39 & x40 & ~x04 & ~x13;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = new_n73_ | (~new_n97_ & (~x27 | (~new_n95_ & (~new_n93_ | new_n94_))));
  assign new_n97_ = ~x13 & ~x04 & x39 & x40 & (x30 | x32);
  assign z15 = x27 & x34 & ~new_n73_ & x12 & x26;
  assign z16 = new_n73_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n73_ & x23 & ~x24;
  assign z19 = ~x30 & new_n90_ & (~new_n88_ | new_n89_);
