...
module FAU ( 
  ...
  assign new_n68_ = ~x04 & x23;
  assign z01 = ~x04 | ((new_n70_ | ~x27) & ~x30 & ~x32);
  assign new_n70_ = ~x36 & (x28 | ~x35);
  assign z02 = new_n72_ | new_n68_ | ~new_n73_ | (~x02 & (~x08 | ~x29));
  ...
  assign z10 = new_n84_ | (x27 & (new_n83_ | (~new_n68_ & x06 & x37)));
  assign new_n83_ = ~new_n70_ & ~x04 & ~x23 & (~new_n73_ | x05) & (new_n73_ | x07);
  assign new_n84_ = new_n73_ & (x30 | x32) & x05 & ~x04 & ~x23;
  assign z11 = (~x04 & x23) | (new_n86_ & (x04 | ~x27 | x28 | ~x35));
  assign new_n86_ = ~x09 & ~x30 & (~new_n87_ | (x27 & (~new_n73_ | ~x29)));
  assign new_n87_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z12 = ~new_n89_ & (new_n90_ | x04);
  assign new_n89_ = ~new_n67_ & x27;
  assign new_n90_ = ~x23 & (~new_n73_ | (~x10 & (~x27 | (~x35 & ~x36))));
  assign z13 = (~new_n92_ & ~x04) | (x27 & (new_n93_ | (~new_n95_ & new_n96_ & ~x04)));
  assign new_n92_ = ~x23 & (x13 | ~new_n73_ | (~x30 & ~x32));
  assign new_n93_ = ~new_n67_ & new_n94_;
  assign new_n94_ = x20 & ~x18 & ~x19;
  assign new_n95_ = x28 & (~x35 | ~x36);
  assign new_n96_ = ~x13 & x39 & x40;
  assign z14 = (~new_n94_ & (x04 | (~new_n98_ & ~x23))) | (~new_n89_ & (x04 | (~new_n99_ & ~x23)));
  assign new_n98_ = new_n96_ & (~new_n95_ | x30 | x32);
  assign new_n99_ = new_n96_ & (x30 | x32 | (x27 & ~x28));
  assign z15 = x12 & ~new_n68_ & x34 & x26 & x27;
  assign z16 = x23 ? ~x04 : (x01 & x22);
  assign z17 = x23 & (~x04 | (~x24 & x01 & x22));
  assign z19 = new_n86_ & (x04 | (~x23 & (~x27 | x28 | ~x35)));
