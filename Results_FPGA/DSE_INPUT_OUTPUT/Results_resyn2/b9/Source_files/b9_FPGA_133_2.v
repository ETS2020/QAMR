...
module FAU ( 
  ...
  assign new_n84_ = (~x07 | (x39 & x40) | (x30 & ~x32)) & (~x39 | ~x40 | ~x05 | x30);
  ...
  assign z14 = (~x27 | (~new_n92_ & (~new_n91_ | new_n93_))) & (~x30 | x32) & (~new_n91_ | ~x32);
  assign new_n91_ = new_n73_ & ~x04 & ~x13;
  ...
  assign z20 = x30 ? ~x32 : (new_n99_ & (~x08 | (~new_n70_ & ~new_n88_)));
  assign new_n99_ = ~x09 & (~x27 | ~x35);
  assign z13 = (x27 & (new_n92_ | (new_n91_ & ~new_n93_))) | (x30 & ~x32) | (new_n91_ & x32);
