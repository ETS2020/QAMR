...
module FAU ( 
  ...
  assign z03 = (x27 & (~x28 | ~x35)) | (~x27 & ~x37) | new_n75_ | ~x21;
  ...
  assign z11 = new_n90_ & (~new_n89_ | (x27 & (~x29 | ~x39 | ~x40)));
  ...
  assign z14 = new_n96_ & (~x27 | (~new_n95_ & (~new_n93_ | new_n94_)));
  ...
  assign z20 = (x30 & ~x32) | (~new_n89_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z13 = ~new_n96_ | (x27 & (new_n95_ | (new_n93_ & ~new_n94_)));
  assign z18 = ~new_n90_ | (new_n89_ & (~x27 | (x29 & x39 & x40)));
  assign z19 = new_n90_ & (~new_n89_ | (x27 & (~x29 | ~x39 | ~x40)));
endmodule
