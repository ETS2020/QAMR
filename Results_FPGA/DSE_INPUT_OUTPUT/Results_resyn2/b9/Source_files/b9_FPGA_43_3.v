...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n78_,
    ...
    new_n92_, new_n94_, new_n95_, new_n96_, new_n101_;
  ...
  assign z11 = new_n68_ | (new_n87_ & (~new_n85_ | (~new_n86_ & x27)));
  assign new_n85_ = x08 & (new_n86_ | (~x28 & x35));
  ...
  assign new_n94_ = new_n91_ & (~x28 | (x35 & x36) | x30 | (x32 & ~x35));
  assign new_n95_ = ~new_n68_ & (new_n91_ | (~new_n66_ & x27));
  assign new_n96_ = ~x30 & (~x32 | x35) & (~x27 | (~x37 & x28 & ~x35));
  assign z15 = new_n68_ | (x12 & x34 & x26 & x27);
  assign z16 = new_n68_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n68_ & x23 & ~x24;
  assign z19 = ~new_n101_ & (new_n68_ | (~x09 & ~x30 & (~new_n86_ | ~x08)));
  assign new_n101_ = ~x32 & ~x28 & x35 & (x08 | x27) & (~x04 | ~x27);
  assign z20 = ~new_n85_ & ~x09 & ~x30 & (~x35 | (~x27 & ~x32));
  assign z18 = ~z19;
endmodule
