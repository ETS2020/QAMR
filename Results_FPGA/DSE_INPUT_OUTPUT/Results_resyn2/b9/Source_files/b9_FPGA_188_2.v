...
module FAU ( 
  ...
  assign z01 = (~x18 | x32) & (~x04 | (~x18 & ~new_n70_ & ~x30 & ~x32));
  ...
  assign z13 = new_n92_ | new_n68_ | (~new_n90_ & new_n93_);
  assign new_n90_ = ~x30 & ~x32 & (new_n91_ | ~x27);
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = ~new_n66_ & ~x19 & x20 & ~x18 & x27;
  assign new_n93_ = x39 & x40 & ~x04 & ~x13;
  assign z14 = (~new_n96_ & ~x32) | (~new_n92_ & ~new_n95_);
  assign new_n95_ = new_n93_ & (~new_n91_ | x30 | x32 | (~x19 & x20));
