...
module FAU ( 
  ...
  assign z10 = ~new_n85_ | ((z08 | new_n84_) & ~new_n71_ & ~x04 & (~z08 | x05));
  assign new_n84_ = x07 & x27 & (x36 | (~x28 & x35));
  assign new_n85_ = (x39 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = (~x08 | (~new_n87_ & (~new_n73_ | x27))) & new_n88_ & (~new_n73_ | x04 | ~x27);
  ...
  assign new_n95_ = (x37 | (x28 & x35)) & (x39 | x40);
  ...
  assign z18 = ((x39 | x40) & (new_n105_ | x09 | x30)) | (new_n104_ & x39 & x40);
  assign new_n104_ = x08 & x29;
  assign new_n105_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z20 = (~x08 | (~new_n87_ & (x28 | ~x35))) & new_n88_ & (~x27 | ~x35);
  assign z19 = (~x08 | (~new_n87_ & (~new_n73_ | x27))) & new_n88_ & (~new_n73_ | x04 | ~x27);
endmodule
