...
module FAU ( 
  ...
  assign z01 = (~x30 & ~x32 & (new_n70_ | ~x27)) | ~x04 | (x05 & x32);
  ...
  assign new_n82_ = ~new_n70_ & ~x04 & ((x07 & ~new_n72_ & (~x05 | ~x32)) | (new_n72_ & x05 & ~x32));
  assign new_n83_ = new_n67_ & x30 & x05 & ~x32;
