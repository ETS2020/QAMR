...
module FAU ( 
  ...
  assign z02 = (x39 & (new_n74_ | (~new_n75_ & ~x02))) | (x39 ^ x40);
  assign new_n74_ = x04 & ((~x08 & ~x27) | x28 | ~x35);
  assign new_n75_ = x08 & x29;
  ...
  assign z10 = ~new_n86_ | (new_n85_ & ((z08 & ~new_n72_) | (new_n71_ & (z08 | x07))));
  ...
  assign z18 = ((x39 | x40) & (new_n104_ | x09 | x30)) | (new_n75_ & x39 & x40);
  assign new_n104_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign z20 = (~x08 | (~new_n89_ & (x28 | ~x35))) & new_n90_ & (~x27 | ~x35);
  assign z19 = (~x08 | (~new_n89_ & (~new_n88_ | x27))) & new_n90_ & (~new_n88_ | x04 | ~x27);
endmodule
