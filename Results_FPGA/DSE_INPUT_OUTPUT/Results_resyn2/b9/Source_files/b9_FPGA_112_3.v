...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n72_,
    ...
    new_n98_, new_n99_, new_n104_, new_n106_;
  ...
  assign new_n87_ = (~x19 | ~x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n90_ | (new_n89_ & (new_n91_ | new_n92_ | new_n93_));
  assign new_n89_ = ~x09 & ~x30;
  assign new_n90_ = x40 & (x19 | (x04 & ~x08 & ~x09 & ~x30));
  assign new_n91_ = ~x08 & (~x27 | x28 | ~x35);
  assign new_n92_ = (x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n93_ = x04 & x27 & (~x29 | ~x39 | ~x40);
  assign z12 = new_n70_ | (~new_n67_ & (~x27 | (new_n65_ & ~new_n66_)));
  assign z14 = (new_n96_ | ~x40) & (~x27 | (~new_n97_ & (new_n98_ | ~new_n99_)));
  ...
  assign z18 = new_n104_ | (~new_n70_ & (~new_n89_ | (new_n74_ & (~x04 | ~x27))));
  assign new_n104_ = x08 & x29 & ~x19 & x39 & x40;
  assign z19 = new_n70_ | (new_n89_ & (new_n106_ | new_n92_ | new_n93_));
  assign new_n106_ = ~x08 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = new_n70_ | ((new_n92_ | ~x08) & new_n89_ & (~x27 | ~x35));
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z13 = (~new_n96_ & x40) | (x27 & (new_n97_ | (~new_n98_ & new_n99_)));
endmodule
