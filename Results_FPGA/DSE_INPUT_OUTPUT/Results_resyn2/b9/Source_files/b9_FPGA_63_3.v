...
module FAU ( 
  ...
  assign z13 = new_n90_ | (x18 & x32) | (new_n91_ & (x30 | x32));
  assign new_n90_ = x27 & ((new_n91_ & ~new_n92_) | (new_n93_ & ~x19 & x20));
  assign new_n91_ = x39 & x40 & ~x04 & ~x13;
  assign new_n92_ = x28 & (~x35 | ~x36);
  assign new_n93_ = ~x18 & (x37 | (x28 & x35));
  assign z14 = ~new_n95_ | (~x30 & (new_n98_ | (~x27 & ~x32)));
  assign new_n95_ = ((~x19 & x20) | (new_n91_ & ~new_n96_)) & (new_n97_ | (~new_n68_ & new_n91_));
  assign new_n96_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n97_ = x27 & ~x18 & (x37 | (x28 & x35));
  assign new_n98_ = x28 & ((x18 & (~x35 | ~x36)) | (~x37 & ~x32 & ~x35));
