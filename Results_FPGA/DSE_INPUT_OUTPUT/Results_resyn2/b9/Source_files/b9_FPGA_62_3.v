...
module FAU ( 
  ...
  assign z01 = (~x04 & (~x25 | ~x32)) | (~new_n70_ & ~x30 & ~x32);
  ...
  assign new_n79_ = (~x25 | (~x32 & (~x14 | ~x38))) & x03 & (~x38 | x00 | x25);
  ...
  assign new_n84_ = x32 & (x25 | (new_n67_ & x05));
  ...
  assign z13 = (~new_n91_ & x27) | (new_n92_ & (x30 | x32)) | (x25 & x32);
  ...
  assign new_n95_ = (~new_n92_ | (~x30 & ~x32)) & (~x27 | (new_n66_ & (~new_n92_ | x28)));
