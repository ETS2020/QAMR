...
module FAU ( 
  ...
  assign z13 = ~new_n70_ & ((~new_n72_ & new_n94_) | (x27 & (new_n95_ | (~new_n93_ & new_n94_))));
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = x39 & x40 & ~x04 & ~x13;
  assign new_n95_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~new_n97_ & (~new_n94_ | new_n98_)) | new_n70_ | (~new_n99_ & (~new_n94_ | new_n100_));
  ...
  assign z17 = (~x22 & ~x23) | (x01 & x22 & x23 & ~x24);
