...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n77_, new_n81_,
    new_n82_, new_n84_, new_n85_, new_n88_, new_n89_, new_n90_, new_n96_,
    new_n97_, new_n99_;
  ...
  assign z20 = new_n99_ & (~x08 | ((x28 | ~x35) & (~x29 | ~x39)));
  assign new_n99_ = (~x39 | x40) & ~x09 & ~x30 & (~x27 | ~x35);
  assign z19 = ~new_n84_ & new_n85_ & (x28 | ~x35 | x04 | ~x27);
endmodule
