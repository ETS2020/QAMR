...
module FAU ( 
  ...
  assign z08 = x39 & x40;
  assign z01 = (~new_n70_ & new_n71_) | new_n65_ | ~x04;
  ...
  assign z10 = ~new_n83_ | (new_n82_ & ((z08 & ~new_n71_) | (new_n70_ & (z08 | x07))));
  assign new_n82_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n83_ = (~x12 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = ~new_n65_ & new_n86_ & (~new_n85_ | (x27 & (~z08 | ~x29)));
  assign new_n85_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign new_n86_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n65_ | (~new_n90_ & (~x27 | (new_n88_ & ~new_n89_)));
  assign new_n88_ = ~x37 & (~x28 | ~x35);
  assign new_n89_ = (x35 | x36) & ~x04 & x39 & x40;
  assign new_n90_ = x10 & ~x04 & x39 & x40;
  assign z13 = (x27 & (new_n94_ | (new_n92_ & ~new_n93_))) | new_n65_ | (~new_n71_ & new_n92_);
  assign new_n92_ = ~x13 & ~x04 & x39 & x40;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = ~new_n65_ & ((~new_n97_ & (~new_n92_ | new_n98_)) | (~new_n96_ & (~new_n92_ | new_n99_)));
  ...
  assign z15 = x34 & x26 & x27 & x12 & x40;
  assign z16 = new_n65_ | (~x23 & x01 & x22);
  assign z17 = x01 & x22 & ~new_n65_ & x23 & ~x24;
  assign z19 = new_n65_ | (new_n86_ & (~new_n85_ | (x27 & (~z08 | ~x29))));
  assign z20 = new_n65_ | (~new_n85_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z18 = new_n65_ | ~new_n86_ | (new_n85_ & (~x27 | (z08 & x29)));
endmodule
