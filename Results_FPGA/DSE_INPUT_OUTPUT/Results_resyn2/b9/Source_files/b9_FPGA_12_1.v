...
module FAU ( 
  ...
  assign z10 = (~new_n84_ & ~new_n68_ & x27) | (new_n86_ & ~new_n68_ & x05);
  ...
  assign z14 = (~x27 | (~new_n93_ & ~new_n94_)) & ~new_n68_ & (~new_n86_ | x13);
  assign new_n93_ = (~x28 | (x35 & x36)) & new_n74_ & ~x04 & ~x13;
  assign new_n94_ = ~new_n66_ & x20 & ~x18 & ~x19;
  ...
  assign z13 = (x27 & (new_n93_ | new_n94_)) | new_n68_ | (new_n86_ & ~x13);
