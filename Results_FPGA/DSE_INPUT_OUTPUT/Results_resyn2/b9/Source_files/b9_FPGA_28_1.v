...
module FAU ( 
  ...
  assign z01 = (~x30 & ~x32 & (new_n70_ | ~x27)) | ~x04 | (~x17 & x32);
  ...
  assign new_n82_ = (~x06 | new_n68_ | ~x37) & (new_n83_ | new_n70_ | x04);
  assign new_n83_ = (~x07 | (x39 & x40) | (~x17 & x32)) & (~x39 | ~x40 | ~x05 | x32);
  assign new_n84_ = (x30 | x32) & new_n72_ & (x17 | ~x32);
  ...
  assign z13 = new_n93_ | (x27 & ((new_n91_ & (x17 | ~x32)) | (new_n92_ & ~x32)));
  assign new_n91_ = ~new_n66_ & x20 & ~x18 & ~x19;
  assign new_n92_ = (~x28 | (x35 & x36)) & new_n72_ & ~x04 & ~x13;
  assign new_n93_ = ~x04 & ~x13 & (x30 | x32) & new_n72_ & (x17 | ~x32);
