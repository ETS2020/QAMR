...
module FAU ( 
  ...
  assign z03 = (x27 & (~x28 | ~x35)) | (~x27 & ~x37) | new_n74_ | ~x21;
  ...
  assign z07 = new_n74_ | (new_n79_ & ((x00 & ~x25) | ~x38 | (~x14 & x25)));
  assign new_n79_ = x03 & (~x14 | ((x15 | ~x17) & ~x31 & ~x33));
  assign z08 = new_n81_ | new_n74_;
  assign new_n81_ = x39 & x40;
  assign z09 = x11 & ~new_n74_ & x34 & x26 & x27;
  assign z10 = ~new_n86_ | (new_n85_ & ((new_n81_ & ~new_n84_) | (new_n70_ & (new_n81_ | x07))));
  assign new_n84_ = ~x30 & ~x32;
  assign new_n85_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n86_ = (x32 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n74_ | (new_n89_ & (~new_n88_ | (x27 & (~new_n81_ | ~x29))));
  ...
  assign z13 = (~new_n84_ & new_n93_) | (x27 & ((~new_n92_ & new_n93_) | (~new_n74_ & new_n94_)));
  ...
  assign new_n96_ = (x32 | x40) & ((~x30 & ~x32) | x13 | x04 | ~x39 | ~x40);
  assign z15 = x12 & ~new_n74_ & x34 & x26 & x27;
  assign z16 = new_n74_ | (~x23 & x01 & x22);
  assign z17 = new_n74_ | (x01 & x22 & x23 & ~x24);
  assign z18 = new_n102_ | (~new_n74_ & (new_n101_ | x09 | x30));
  assign new_n101_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign new_n102_ = x08 & x29 & x39 & x40;
  assign z20 = new_n74_ | (~new_n88_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z19 = new_n74_ | (new_n89_ & (~new_n88_ | (x27 & (~new_n81_ | ~x29))));
endmodule
