...
module FAU ( 
  ...
  assign z11 = (new_n87_ | ~x08) & ~new_n88_ & ~new_n65_ & ~x09 & ~x30;
  assign new_n87_ = (x27 | x28 | ~x35) & (~x29 | ~x39 | ~x40);
  assign new_n88_ = ~x04 & x27 & ~x28 & x35;
  assign z12 = new_n91_ & (~x27 | (new_n90_ & (~new_n68_ | (~x35 & ~x36))));
  assign new_n90_ = ~x37 & (~x28 | ~x35);
  assign new_n91_ = (x39 | x40) & (~x10 | ~x40 | x04 | ~x39);
  assign z13 = ~new_n96_ | (x27 & ((~new_n90_ & new_n95_) | (new_n93_ & ~new_n94_)));
  assign new_n93_ = ~x04 & ~x13 & x39 & x40;
  assign new_n94_ = x28 & (~x35 | ~x36);
  assign new_n95_ = x20 & ~x18 & ~x19;
  assign new_n96_ = (x39 | x40) & ((~x30 & ~x32) | x04 | x13 | ~x39 | ~x40);
  assign z14 = (~new_n95_ & (~new_n93_ | new_n98_)) | new_n65_ | (~new_n66_ & (~new_n93_ | new_n99_));
  ...
  assign z19 = (new_n87_ | ~x08) & ~new_n88_ & ~new_n65_ & ~x09 & ~x30;
endmodule
