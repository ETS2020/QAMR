...
module FAU ( 
  ...
  assign z02 = ~x40 | (x21 & (new_n74_ | ~new_n75_));
  ...
  assign z18 = new_n105_ | (~new_n70_ & (new_n89_ | x09 | x30));
  assign new_n105_ = x08 & x29 & x21 & x39 & x40;
  assign z20 = ~new_n107_ & (~x27 | ~x35) & ~new_n70_ & ~x09 & ~x30;
