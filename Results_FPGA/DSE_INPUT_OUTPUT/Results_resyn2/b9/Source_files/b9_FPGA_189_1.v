...
module FAU ( 
  ...
  assign new_n68_ = ~x17 & x32;
  assign z01 = (~new_n70_ & ~x30 & ~x32) | ~x04 | (~x17 & x32);
  ...
  assign new_n84_ = x32 & (~x17 | (new_n67_ & x05));
  assign z11 = new_n87_ & (~new_n86_ | (x27 & (~x29 | ~x39 | ~x40)));
  assign new_n86_ = x08 & (new_n73_ | (x29 & x39 & x40));
  assign new_n87_ = (~new_n73_ | x04 | ~x27) & ~new_n68_ & ~x09 & ~x30;
  assign z12 = new_n65_ & ~new_n68_;
  assign z14 = (new_n90_ | ~x27) & (~new_n91_ | (~x30 & ~x32)) & (x17 | ~x32);
  assign new_n90_ = (~new_n91_ | (x28 & (~x35 | ~x36))) & (~new_n92_ | (~x37 & (~x28 | ~x35)));
  ...
  assign z20 = new_n68_ | (~new_n86_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z13 = (~new_n90_ & x27) | (new_n91_ & (x30 | x32)) | (~x17 & x32);
