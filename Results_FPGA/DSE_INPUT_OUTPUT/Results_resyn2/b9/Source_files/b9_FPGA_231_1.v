...
module FAU ( 
  ...
  assign z01 = (~new_n70_ & ~x30 & ~x32) | ~x04 | (~x18 & x32);
  ...
  assign new_n84_ = x32 & (~x18 | (new_n67_ & x05));
  ...
  assign z13 = (~new_n90_ & x27) | (new_n91_ & (x30 | x32)) | (~x18 & x32);
  assign new_n90_ = (~new_n91_ | (x28 & (~x35 | ~x36))) & (~new_n92_ | (~x37 & (~x28 | ~x35)));
  assign new_n91_ = x39 & x40 & ~x04 & ~x13;
  assign new_n92_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n92_ & (~new_n91_ | new_n95_)) | ((~new_n91_ | ~x18 | ~x32) & (new_n94_ | x32));
  assign new_n94_ = (new_n66_ | ~x27) & (~new_n91_ | (~x30 & (~x27 | x28)));
