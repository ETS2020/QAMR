...
module FAU ( 
  ...
  assign new_n84_ = (x07 | x32) & x06 & x37;
  assign new_n85_ = ~x05 & x39 & x40;
  assign new_n86_ = ~x04 & x07 & (x36 | (~x28 & x35));
  ...
  assign z14 = ~new_n73_ & (new_n94_ | ~new_n95_) & (~x27 | (~new_n97_ & (~new_n95_ | new_n96_)));
  ...
  assign z13 = new_n73_ | (~new_n94_ & new_n95_) | (x27 & (new_n97_ | (new_n95_ & ~new_n96_)));
  assign z19 = z11;
endmodule
