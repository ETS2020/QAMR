...
module FAU ( 
  ...
  assign z13 = new_n91_ | (x18 & x32) | (new_n92_ & (x30 | x32));
  assign new_n91_ = x27 & ((new_n92_ & ~new_n93_) | (new_n94_ & ~x19 & x20));
  assign new_n92_ = x39 & x40 & ~x04 & ~x13;
  assign new_n93_ = x28 & (~x35 | ~x36);
  assign new_n94_ = ~x18 & (x37 | (x28 & x35));
  assign z14 = ~new_n96_ | (~x30 & (new_n99_ | (~x27 & ~x32)));
  assign new_n96_ = ((~x19 & x20) | (new_n92_ & ~new_n97_)) & (new_n98_ | (~new_n68_ & new_n92_));
  assign new_n97_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n98_ = x27 & ~x18 & (x37 | (x28 & x35));
  assign new_n99_ = x28 & ((x18 & (~x35 | ~x36)) | (~x37 & ~x32 & ~x35));
