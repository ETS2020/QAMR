...
module FAU ( 
  ...
  assign z10 = ~new_n83_ | ((z08 | new_n82_) & ~new_n71_ & ~x04 & (~z08 | x05));
  assign new_n82_ = x07 & x27 & (x36 | (~x28 & x35));
  assign new_n83_ = (~x12 | x40) & (~x37 | ~x06 | ~x27);
  assign z11 = new_n70_ | (new_n86_ & (~new_n85_ | (x27 & (~z08 | ~x29))));
  ...
  assign z13 = (x27 & (new_n92_ | (new_n90_ & ~new_n91_))) | new_n70_ | (~new_n89_ & new_n90_);
  assign new_n89_ = ~x30 & ~x32;
  assign new_n90_ = ~x13 & ~x04 & x39 & x40;
  assign new_n91_ = x28 & (~x35 | ~x36);
  assign new_n92_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~new_n95_ & (~new_n90_ | new_n96_)) | new_n70_ | (~new_n94_ & (~new_n90_ | new_n97_));
  ...
  assign z18 = new_n103_ | (~new_n70_ & (new_n102_ | x09 | x30));
  assign new_n102_ = (x08 | x27) & ~x28 & x35 & (~x04 | ~x27);
  assign new_n103_ = x08 & x29 & x39 & x40;
  assign z20 = new_n70_ | (~new_n85_ & ~x09 & ~x30 & (~x27 | ~x35));
  assign z05 = (x27 & x28) | new_n70_ | x37;
  assign z19 = new_n70_ | (new_n86_ & (~new_n85_ | (x27 & (~z08 | ~x29))));
endmodule
