...
module FAU ( 
  ...
  assign new_n70_ = x36 & ~x27 & ~x30 & ~x32;
  ...
  assign new_n82_ = (new_n70_ | ~new_n72_ | ~x05) & (new_n83_ | new_n72_ | ~x07 | ~x27);
  ...
  assign z13 = (~new_n90_ & x27) | new_n68_ | (~new_n93_ & new_n91_);
  assign new_n90_ = (~new_n91_ | (x28 & ~x35)) & (~new_n92_ | ~x20 | (~x37 & (~x28 | ~x35)));
  assign new_n91_ = ~x04 & ~x13 & x39 & x40;
  assign new_n92_ = ~x18 & ~x19;
  assign new_n93_ = ~x30 & ~x32;
  assign z14 = new_n98_ | (x36 & (~new_n96_ | (~new_n95_ & ~x35)));
  assign new_n95_ = (new_n91_ | x37) & (~new_n93_ | ~x28 | (new_n92_ & x20 & x37));
  assign new_n96_ = (~new_n93_ | x27) & (new_n91_ | (new_n97_ & (x28 | x37)));
  assign new_n97_ = ~x18 & ~x19 & x20 & x27;
  assign new_n98_ = ~new_n91_ & x32 & (new_n66_ | ~new_n97_);
