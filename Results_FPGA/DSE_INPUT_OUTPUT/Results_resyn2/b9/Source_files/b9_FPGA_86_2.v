...
module FAU ( 
  ...
  assign new_n82_ = x06 & x37 & (~x39 | x40);
  assign new_n83_ = x05 & x39 & x40 & ~x04 & (x30 | x32);
  assign z11 = ~new_n85_ & new_n86_ & (x04 | ~x27 | x28 | ~x35);
  ...
  assign new_n93_ = x39 & (~x40 | ((x30 | x32) & ~x04 & ~x13));
  ...
  assign new_n99_ = ~x09 & ~x30 & (~x08 | ~x29 | ~x39);
  assign z20 = new_n101_ & (~x08 | ((x28 | ~x35) & (~x29 | ~x39)));
  assign new_n101_ = (~x39 | x40) & ~x09 & ~x30 & (~x27 | ~x35);
  assign z13 = new_n93_ | (x27 & (new_n91_ | new_n92_));
  assign z18 = new_n85_ | ~new_n86_ | (~x04 & x27 & ~x28 & x35);
endmodule
