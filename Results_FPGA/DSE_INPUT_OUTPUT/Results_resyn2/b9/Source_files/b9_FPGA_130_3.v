...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n73_,
    ...
    new_n99_, new_n100_, new_n101_, new_n106_, new_n108_, new_n110_;
  ...
  assign new_n85_ = (x30 | x32) & x39 & x40 & x05 & ~x06;
  ...
  assign z12 = new_n92_ | (x06 & x40) | (~new_n68_ & (x04 | ~x39 | ~x40));
  assign new_n92_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = new_n94_ | (~new_n95_ & ~new_n67_ & x27);
  assign new_n94_ = ~x13 & x39 & x40 & ~new_n71_ & ~x04 & ~x06;
  assign new_n95_ = (~new_n96_ | ((~x28 | ~x35) & ~x37)) & (~new_n97_ | (x28 & (~x35 | ~x36)));
  assign new_n96_ = x20 & ~x18 & ~x19;
  assign new_n97_ = ~x04 & ~x13 & x40 & ~x06 & x39;
  assign z14 = (~new_n96_ & (~x40 | (~new_n99_ & ~x06))) | (~new_n68_ & (~x40 | (~new_n101_ & ~x06)));
  assign new_n99_ = ~new_n100_ & x39 & ~x04 & ~x13;
  assign new_n100_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39 & (~new_n71_ | (x27 & ~x28));
  ...
  assign new_n106_ = ~x09 & ~x30 & (~new_n88_ | (~x08 & ~x27) | (x04 & x27));
  assign z19 = ~x09 & ~x30 & (new_n89_ | (~new_n108_ & ~x08));
  assign new_n108_ = (x27 | (x06 & x40)) & (x06 | (new_n88_ & (~x04 | ~x40)));
  assign z20 = new_n67_ | (~new_n110_ & (~x27 | ~x35) & ~x09 & ~x30);
  assign new_n110_ = x08 & (new_n88_ | (x29 & x39 & x40));
  assign z05 = ~z06;
endmodule
