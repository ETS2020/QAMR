...
module FAU ( 
  ...
  assign z14 = (x12 | (~x10 & x15)) & ((x02 & x10 & x08 & ~x15) | (~x10 & x15) | (~x08 & x15));
  assign z15 = (~x10 & (x15 | (new_n58_ & x12))) | (x12 & ((new_n58_ & (~x08 | x15)) | (x03 & x10 & x08 & ~x15)));
  assign new_n58_ = ~x14 & x16;
  assign z16 = (~x10 & (x15 | (x12 & x17))) | (x12 & ((x04 & x10 & x08 & ~x15) | (x17 & (~x08 | x15))));
  assign z17 = x12 & ((~x15 & ((~x10 & x18) | (x05 & x08 & x10))) | ((~x08 | x15) & x10 & x18));
  assign z18 = (~x10 & (x15 | (x12 & x19))) | (x12 & ((x06 & x10 & x08 & ~x15) | (x19 & (~x08 | x15))));
