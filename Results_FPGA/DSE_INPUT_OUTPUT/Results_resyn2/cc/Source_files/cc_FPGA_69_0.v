...
module FAU ( 
  ...
  assign z01 = (~x10 & ~x12) | (~x14 & x15 & x08 & x10);
  ...
  assign z12 = (~x10 | (x12 & (x15 | x00 | ~x08))) & ((x08 & x10 & ~x15) | ~x12 | x13);
  assign z13 = ((x15 & x08 & x10) | ((~x12 | x14) & (~x01 | ~x08 | ~x10))) & (~x10 | x12);
  assign z14 = (~x10 & (~x12 | x15)) | ((x15 | (x02 & x08)) & x12 & (~x08 | (x10 & ~x15)));
  assign z15 = (new_n46_ | (~x14 & x16)) & x12 & (~new_n46_ | x03);
  assign z16 = (~new_n46_ | x04) & x12 & (new_n46_ | x17);
  assign z17 = (~x10 | (x12 & (x15 | x05 | ~x08))) & ((x08 & x10 & ~x15) | ~x12 | x18);
  assign z18 = (~x10 | (x12 & (x15 | x06 | ~x08))) & ((x08 & x10 & ~x15) | ~x12 | x19);
