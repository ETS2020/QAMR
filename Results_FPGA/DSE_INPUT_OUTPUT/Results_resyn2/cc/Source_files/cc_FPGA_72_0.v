...
module FAU ( 
  ...
  assign z13 = (~x00 & ~x15) | (x12 & ((new_n45_ & x15) | (x14 & (~new_n45_ | ~x01))));
  assign z14 = (x15 | (new_n45_ & x00 & x02)) & x12 & (~new_n45_ | ~x15);
  assign z15 = (~new_n59_ & ~x15) | (~x14 & (~new_n45_ | x15) & x12 & x16);
  assign new_n59_ = x00 & (~x03 | ~x12 | ~x08 | ~x10);
  assign z16 = x12 & ((x15 & x17) | ((~new_n45_ | (x04 & ~x15)) & x00 & (new_n45_ | x17)));
  assign z17 = x12 & ((x15 & x18) | ((~new_n45_ | (x05 & ~x15)) & x00 & (new_n45_ | x18)));
  assign z18 = (~x15 & (~x00 | (x06 & new_n45_ & x12))) | ((~new_n45_ | x15) & x12 & x19);
