...
module FAU ( 
  ...
  assign z03 = x15 & (~x19 | (x12 & new_n45_ & ~x14));
  ...
  assign z14 = x12 & ((~new_n45_ & x15 & x19) | (x02 & new_n45_ & ~x15));
  assign z15 = (x15 & (~x19 | (x12 & ~x14 & x16))) | (~new_n59_ & x12);
  assign new_n59_ = ((x08 & x10) | x14 | ~x16) & (~x03 | x15 | ~x08 | ~x10);
  assign z16 = x12 & ((x17 & x15 & x19) | ((~new_n45_ | x04) & ~x15 & (new_n45_ | x17)));
