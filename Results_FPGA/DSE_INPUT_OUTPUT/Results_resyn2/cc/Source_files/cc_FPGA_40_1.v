...
module FAU ( 
  ...
  assign z02 = (~x12 & x19) | (~x11 & x12 & (new_n47_ | x14));
  ...
  assign z12 = (~new_n47_ | x00) & x12 & (new_n47_ | x13);
  assign z13 = x12 ? ~new_n58_ : x19;
  assign new_n58_ = (~x08 | ~x10 | ~x15) & (~x14 | (x01 & x08 & x10));
  assign z14 = (x15 | (x02 & x08 & x10)) & x12 & (~x08 | ~x10 | ~x15);
  assign z15 = (~x12 & x19) | ((~new_n47_ | x03) & x12 & (new_n47_ | (~x14 & x16)));
  assign z16 = (~x12 & x19) | ((~new_n47_ | x04) & x12 & (new_n47_ | x17));
  assign z17 = (~new_n47_ | x05) & x12 & (new_n47_ | x18);
  assign z18 = (new_n47_ & x12) ? x06 : x19;
  assign z19 = (~x12 & x19) | ((~new_n47_ | x07) & x12 & (new_n47_ | x20));
endmodule
