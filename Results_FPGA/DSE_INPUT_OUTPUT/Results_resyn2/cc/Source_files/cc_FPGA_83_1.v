// Benchmark "FAU" written by ABC on Wed Aug 12 15:00:38 2020
...
module FAU ( 
  ...
  assign z03 = x15 & (~x07 | (~x14 & new_n45_ & x12));
  ...
  assign z14 = (~x07 & x15) | ((new_n45_ | x15) & x12 & (~new_n45_ | (x02 & ~x15)));
  ...
  assign z19 = (x20 | (new_n45_ & ~x15)) & x12 & (x07 | (~new_n45_ & ~x15));
  assign z06 = x15;
endmodule
