...
module FAU ( 
  ...
  assign z03 = new_n44_ | (x08 & x10 & x15 & x12 & ~x14);
  ...
  assign z15 = new_n44_ | (x12 & ((new_n47_ & x03) | (~new_n47_ & ~x14 & x16)));
  assign z16 = (~x17 & x19) | ((~new_n47_ | x04) & x12 & (new_n47_ | x17));
  assign z17 = new_n44_ | ((~new_n47_ | x05) & x12 & (new_n47_ | x18));
  assign z18 = (~x17 & x19) | ((~new_n47_ | x06) & x12 & (new_n47_ | x19));
