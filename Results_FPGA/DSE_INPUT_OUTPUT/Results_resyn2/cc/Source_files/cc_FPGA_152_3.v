...
module FAU ( 
  ...
  assign z02 = (~x11 & x12 & x14) | (x08 & (x15 | (x12 & x10 & ~x11)));
  ...
  assign z12 = x12 & ((x13 & (~x08 | (~x10 & ~x15))) | (x00 & ~x15 & x08 & x10));
  assign z13 = x12 & x14 & (~x08 | ((~x01 | ~x10) & ~x15));
  assign z14 = (x08 & x15) | (x12 & (x15 | (x02 & x08 & x10)));
  assign z15 = ~new_n55_ & x12;
  assign new_n55_ = (~x03 | x15 | ~x08 | ~x10) & ((x08 & (x10 | x15)) | x14 | ~x16);
