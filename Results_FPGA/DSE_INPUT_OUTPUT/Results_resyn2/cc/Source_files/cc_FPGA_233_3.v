...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n44_, new_n47_, new_n59_;
  ...
  assign z12 = new_n44_ | ((~new_n47_ | x00) & x12 & (new_n47_ | x13));
  assign z13 = ~new_n59_ & ~new_n44_ & x12;
  assign new_n59_ = (~x08 | ~x10 | ~x15) & (~x14 | (x01 & x08 & x10));
  assign z14 = (x15 | (x02 & x08 & x10)) & (~x15 | ~x08 | ~x10) & ~new_n44_ & x12;
  assign z15 = new_n44_ | ((~new_n47_ | x03) & x12 & (new_n47_ | (~x14 & x16)));
  assign z16 = (~new_n47_ | x04) & x12 & (~x17 | ~x19) & (new_n47_ | x17);
  assign z17 = new_n44_ | ((~new_n47_ | x05) & x12 & (new_n47_ | x18));
  assign z18 = (~new_n47_ | x06) & x12 & (~x17 | ~x19) & (new_n47_ | x19);
