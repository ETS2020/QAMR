...
module FAU ( 
  ...
  assign z13 = (x15 & ((new_n45_ & x12) | ~x17)) | ((~new_n45_ | ~x01) & x12 & x14);
  assign z14 = (x12 | (x15 & ~x17)) & ((x02 & new_n45_ & ~x15) | (~new_n45_ & x15) | (x15 & ~x17));
  assign z15 = x12 & (new_n59_ | (x03 & new_n45_ & ~x15));
  assign new_n59_ = x16 & (~x15 | x17) & ~x14 & (x15 | ~x08 | ~x10);
