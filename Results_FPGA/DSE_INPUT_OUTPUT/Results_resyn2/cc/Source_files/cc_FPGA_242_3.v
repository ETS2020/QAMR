...
module FAU ( 
  ...
  assign z14 = (x07 & x15) | (x12 & ((~new_n46_ & x15) | (x02 & new_n46_ & ~x15)));
  assign z15 = (x15 & (x07 | (x12 & ~x14 & x16))) | (~new_n59_ & x12);
  assign new_n59_ = ((x08 & x10) | x14 | ~x16) & (~x03 | x15 | ~x08 | ~x10);
  assign z16 = (x15 & (x07 | (x12 & x17))) | (x12 & ((x04 & new_n46_ & ~x15) | (~new_n46_ & x17)));
  assign z17 = (x15 & (x07 | (x12 & x18))) | (x12 & ((x05 & new_n46_ & ~x15) | (~new_n46_ & x18)));
  assign z18 = x12 & ((x19 & ~x07 & x15) | ((~new_n46_ | x06) & ~x15 & (new_n46_ | x19)));
  assign z19 = (x07 | ~new_n46_ | x15) & (x20 | (new_n46_ & ~x15)) & x12 & (~x07 | ~x15);
  assign z09 = ~z10;
endmodule
