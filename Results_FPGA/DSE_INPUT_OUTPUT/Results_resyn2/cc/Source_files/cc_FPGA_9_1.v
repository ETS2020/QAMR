...
module FAU ( 
  ...
  assign z03 = x10 & x12 & x15 & x08 & ~x14;
  ...
  assign z15 = (~x10 & (x15 | (new_n59_ & x12))) | (x12 & ((new_n59_ & (~x08 | x15)) | (x03 & x10 & x08 & ~x15)));
  assign new_n59_ = ~x14 & x16;
  assign z16 = (~x10 & (x15 | (x12 & x17))) | (x12 & ((x17 & (~x08 | x15)) | (x04 & x10 & x08 & ~x15)));
  assign z17 = x12 & ((~x15 & (x10 ? (x05 & x08) : x18)) | ((~x08 | x15) & x10 & x18));
