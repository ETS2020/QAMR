...
module FAU ( 
  ...
  assign z03 = x12 & ~new_n44_ & ~x14 & x08 & x10 & x15;
  ...
  assign z13 = ~new_n56_ & ~new_n44_ & x12;
  assign new_n56_ = (~x08 | ~x10 | ~x15) & (~x14 | (x01 & x08 & x10));
  ...
  assign z17 = (x18 & ~x19) | ((~new_n47_ | x05) & x12 & (new_n47_ | x18));
  assign z18 = (x19 | (new_n47_ & ~x18)) & x12 & (~new_n47_ | x06);
