...
module FAU ( 
  ...
  assign z01 = (~x10 & ~x15) | (~x14 & x15 & x08 & x10);
  assign z02 = (x14 | (x08 & ~x15)) & (x10 | x15) & ~x11 & x12;
  assign z03 = (~x10 & ~x15) | (x12 & ~x14 & x08 & x10 & x15);
  ...
  assign z13 = x12 & ((x15 & x08 & x10) | (x14 & (x15 | (x10 & (~x01 | ~x08)))));
  assign z14 = (x15 | (x02 & x08 & x10)) & x12 & (~x15 | ~x08 | ~x10);
  assign z15 = new_n59_ | (~x10 & ~x15);
  assign new_n59_ = x12 & ((x03 & x08 & ~x15) | (x16 & ~x14 & (~x08 | x15)));
