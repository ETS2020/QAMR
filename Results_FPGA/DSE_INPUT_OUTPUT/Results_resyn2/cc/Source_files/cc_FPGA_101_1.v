...
module FAU ( 
  ...
  assign z13 = new_n44_ | new_n59_;
  assign new_n59_ = x12 & ((x08 & x10 & x15) | (x14 & (~x01 | ~x08 | ~x10)));
  assign z14 = (~x02 & x04) | ((x15 | (x02 & x08 & x10)) & x12 & (~x15 | ~x08 | ~x10));
  assign z15 = new_n44_ | ((~new_n47_ | x03) & x12 & (new_n47_ | (~x14 & x16)));
  assign z16 = (x04 & (~x02 | (new_n47_ & x12))) | (~new_n47_ & x12 & x17);
  assign z17 = (~new_n47_ | x05) & (new_n47_ | x18) & ~new_n44_ & x12;
  assign z18 = new_n44_ | ((~new_n47_ | x06) & x12 & (new_n47_ | x19));
