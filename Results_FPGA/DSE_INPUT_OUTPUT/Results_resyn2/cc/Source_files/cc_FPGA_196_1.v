...
module FAU ( 
  ...
  assign z13 = (~x01 | ~x10 | ~x08 | x15) & (x14 | (x08 & x15)) & x12 & (x10 | ~x15);
  assign z14 = (x15 | (x02 & x08)) & x10 & x12 & (~x08 | ~x15);
  assign z15 = (~x10 & (x15 | (new_n58_ & x12))) | (x12 & ((x03 & x10 & x08 & ~x15) | (new_n58_ & (~x08 | x15))));
  assign new_n58_ = ~x14 & x16;
  assign z16 = x12 & ((~x15 & ((x04 & x08 & x10) | (~x10 & x17))) | ((~x08 | x15) & x10 & x17));
