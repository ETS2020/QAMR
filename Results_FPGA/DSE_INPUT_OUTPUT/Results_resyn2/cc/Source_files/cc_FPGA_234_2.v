...
module FAU ( 
  ...
  assign z02 = (x15 & ~x17) | ((x14 | (new_n45_ & ~x15)) & ~x11 & x12);
  ...
  assign z14 = x12 & ((x02 & new_n45_ & ~x15) | (x15 & ~new_n45_ & x17));
  assign z15 = x12 & (new_n58_ | (x03 & new_n45_ & ~x15));
  assign new_n58_ = ~x14 & (x15 | ~x08 | ~x10) & x16 & (~x15 | x17);
  assign z16 = (x15 & ~x17) | (x12 & ((new_n45_ & x04) | x15 | (~new_n45_ & x17)));
