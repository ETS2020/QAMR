...
module FAU ( 
  ...
  assign z01 = x08 & x10 & x15 & ~x07 & ~x14;
  ...
  assign z13 = (~new_n59_ & x10) | ((~x01 | ~x08 | ~x10) & x12 & x14);
  assign new_n59_ = ~x07 & (~x15 | ~x08 | ~x12);
  assign z14 = x12 & ((~x10 & x15) | (((x02 & x08) | x15) & ~x07 & (~x08 | (x10 & ~x15))));
  assign z15 = x12 & ((~x10 & ~x14 & x16) | (~new_n62_ & ~x07));
  assign new_n62_ = (x14 | ~x16 | (x08 & ~x15)) & (~x08 | ~x10 | ~x03 | x15);
  assign z16 = (~new_n64_ & x10) | ((~x08 | ~x10 | x15) & x12 & x17);
  assign new_n64_ = ~x07 & (~x04 | ~x08 | ~x12 | x15);
  assign z17 = ~new_n66_ & x12;
  assign new_n66_ = (x10 | ~x18) & (x07 | (((x08 & ~x15) | ~x18) & (~x08 | ~x10 | ~x05 | x15)));
  assign z18 = (~new_n68_ & x10) | ((~x08 | ~x10 | x15) & x12 & x19);
  assign new_n68_ = ~x07 & (~x06 | ~x08 | ~x12 | x15);
  assign z19 = x12 & x20 & (~x10 | (~x07 & (~x08 | x15)));
endmodule
