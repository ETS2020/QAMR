...
module FAU ( 
  ...
  assign z02 = ((x14 & (x03 | ~x15)) | (new_n45_ & ~x15)) & ~x11 & x12;
  assign z03 = x15 & (~x03 | (~x14 & new_n45_ & x12));
  ...
  assign z13 = (x15 & (~x03 | (new_n45_ & x12))) | ((~new_n45_ | ~x01) & x12 & x14);
  assign z14 = x12 & ((~new_n45_ & x03 & x15) | (x02 & new_n45_ & ~x15));
  assign z15 = (x03 | (~new_n45_ & ~x15)) & x12 & ((new_n45_ & ~x15) | (~x14 & x16));
  assign z16 = x12 & ((x17 & x03 & x15) | ((~new_n45_ | x04) & ~x15 & (new_n45_ | x17)));
  assign z17 = (x15 & (~x03 | (x12 & x18))) | (x12 & ((~new_n45_ & x18) | (x05 & new_n45_ & ~x15)));
  assign z18 = (x15 & (~x03 | (x12 & x19))) | (x12 & ((~new_n45_ & x19) | (x06 & new_n45_ & ~x15)));
  assign z19 = (x15 & (~x03 | (x12 & x20))) | (x12 & ((~new_n45_ & x20) | (x07 & new_n45_ & ~x15)));
endmodule
