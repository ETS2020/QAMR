...
module FAU ( 
  ...
  assign z02 = ((x14 & (x15 | x17)) | (x17 & new_n45_ & ~x15)) & ~x11 & x12;
  ...
  assign z15 = x12 & ((new_n58_ & (x15 | (~new_n45_ & x17))) | (x03 & x17 & new_n45_ & ~x15));
  assign new_n58_ = ~x14 & x16;
  assign z16 = (~x15 & ~x17) | ((x04 | ~new_n45_ | x15) & x12 & x17);
  assign z17 = x12 & ((x15 & x18) | ((~new_n45_ | (x05 & ~x15)) & x17 & (new_n45_ | x18)));
  assign z18 = x12 & ((x15 & x19) | ((~new_n45_ | (x06 & ~x15)) & x17 & (new_n45_ | x19)));
