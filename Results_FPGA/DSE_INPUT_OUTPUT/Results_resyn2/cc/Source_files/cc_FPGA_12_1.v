...
module FAU ( 
  ...
  assign z02 = (~x12 & x15) | (~x11 & x12 & (new_n46_ | x14));
  assign new_n46_ = ~x15 & x08 & x10;
  assign z03 = ~x14 & x08 & x10 & x12 & x15;
  ...
  assign z12 = (x15 | (x12 & (x00 | ~x08 | ~x10))) & ((~x15 & x08 & x10) | ~x12 | x13);
  ...
  assign z17 = (x15 | (x12 & (x05 | ~x08 | ~x10))) & ((~x15 & x08 & x10) | ~x12 | x18);
