...
module FAU ( 
  ...
  assign z13 = (~x01 | ~x10 | ~x08 | x15) & x12 & ((x08 & x10 & x15) | (x14 & (x10 | ~x15)));
  ...
  assign z18 = x12 & ((~x15 & ((~x10 & x19) | (x06 & x08 & x10))) | (x10 & x19 & (~x08 | x15)));
  assign z19 = x12 & ((~x15 & ((~x10 & x20) | (x07 & x08 & x10))) | (x10 & x20 & (~x08 | x15)));
endmodule
