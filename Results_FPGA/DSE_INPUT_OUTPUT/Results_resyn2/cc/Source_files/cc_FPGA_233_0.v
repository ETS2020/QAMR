...
module FAU ( 
  ...
  assign z01 = (new_n44_ | ~x14) & (new_n44_ | (x08 & x10 & x15));
  assign z02 = (new_n47_ | x14) & ~x11 & ~new_n44_ & x12;
  assign new_n47_ = ~x15 & x08 & x10;
  assign z03 = ~new_n44_ & x15 & x08 & x10 & x12 & ~x14;
  ...
  assign z14 = (x15 | (x02 & x08 & x10)) & x12 & ~new_n44_ & (~x15 | ~x08 | ~x10);
  ...
  assign z18 = x12 & (~new_n47_ | x06) & (x19 | (new_n47_ & x17));
