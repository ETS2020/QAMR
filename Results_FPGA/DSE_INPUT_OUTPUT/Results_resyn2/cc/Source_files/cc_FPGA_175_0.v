...
module FAU ( 
  ...
  assign z13 = (~x05 & ~x15) | (x12 & ((new_n45_ & x15) | ((~new_n45_ | ~x01) & x14)));
  assign z14 = (~x05 & ~x15) | (((new_n45_ & x02) | x15) & x12 & (~new_n45_ | ~x15));
  assign z15 = x12 & ((new_n59_ & x15) | ((~new_n45_ | (x03 & ~x15)) & x05 & (new_n45_ | new_n59_)));
  assign new_n59_ = ~x14 & x16;
  assign z16 = (~x15 & (~x05 | (new_n45_ & x04 & x12))) | (x17 & x12 & (~new_n45_ | x15));
  assign z17 = (~x05 & ~x15) | (x12 & (x18 | (new_n45_ & ~x15)));
  assign z18 = (x19 & x12 & (~new_n45_ | x15)) | (~x15 & (~x05 | (new_n45_ & x06 & x12)));
  assign z19 = x12 & ((x15 & x20) | ((~new_n45_ | (x07 & ~x15)) & x05 & (new_n45_ | x20)));
  assign z10 = ~z09;
endmodule
