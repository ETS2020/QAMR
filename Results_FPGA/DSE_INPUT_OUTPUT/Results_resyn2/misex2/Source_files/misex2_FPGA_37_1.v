...
module FAU ( 
  ...
  assign z05 = x02 & x10 & new_n54_ & x09;
  ...
  assign z08 = new_n61_ & new_n62_ & ~x24 & ~x00 & ~x01;
  ...
  assign z13 = x17 & ~x02 & ~x19 & ~x24 & ~x00 & ~x01;
  assign z14 = ~x01 & (x24 | (new_n49_ & ~x09 & ~x00 & ~x02));
  assign z15 = (x00 & x01 & (~x02 | ~x10)) | ((x00 | (~x01 & x19)) & ~x02 & ~x24);
