...
module FAU ( 
  ...
  assign z03 = new_n52_ | (new_n51_ & x12 & ~x15 & x00 & x01);
  ...
  assign z06 = x01 & (x15 | (new_n51_ & x00));
  assign z07 = new_n55_ & (~x01 | (new_n54_ & ~x15 & x11 & ~x12));
  assign z08 = new_n60_ | (new_n61_ & z17 & x19 & x17 & ~x18);
  assign new_n60_ = x01 & x15;
  assign new_n61_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = new_n60_ | (new_n67_ & ~x21 & (new_n66_ | (new_n64_ & new_n65_)));
  assign new_n64_ = ~x01 & x02 & ~x13 & ~x14 & ~x11 & x12;
  assign new_n65_ = x20 & ~x15 & ~x16;
  assign new_n66_ = x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = ~x00 & ~x22;
  assign z10 = (new_n60_ | ~x00) & ((new_n69_ & new_n70_) | new_n60_ | new_n71_);
  assign new_n69_ = ~x13 & ~x14 & ~x11 & x12;
  assign new_n70_ = x20 & ~x21 & x02 & x15 & x16 & ~x22;
  assign new_n71_ = x18 & ~x19 & x01 & ~x20 & x21 & x22;
  assign z11 = new_n67_ & ((new_n64_ & new_n73_) | (new_n66_ & ~x15 & x21));
