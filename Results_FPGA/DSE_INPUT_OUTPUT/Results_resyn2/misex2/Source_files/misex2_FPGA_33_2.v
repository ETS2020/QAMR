...
module FAU ( 
  ...
  assign z03 = new_n51_ | (new_n48_ & ~x17 & x18 & ~x19);
  assign new_n51_ = new_n52_ & ~x09 & x11 & new_n53_ & x12;
  ...
  assign z07 = x00 & (~x01 | (~x12 & new_n52_ & ~x09 & x11));
  ...
  assign z10 = ~x00 & ((new_n68_ & x22) | (new_n67_ & new_n69_));
  ...
  assign z12 = (x00 & ~x01) | (((~new_n52_ & x00) | (~new_n73_ & ~x01)) & x09 & ~x24);
  assign new_n73_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = ~x01 & (new_n76_ | x00);
  assign new_n76_ = ~x02 & ~x09 & ~x10 & ~x19 & ~x17 & ~x18;
  assign z15 = (new_n48_ & x19) | (~new_n52_ & new_n53_);
  assign z16 = ~x00 ^ ~x01;
