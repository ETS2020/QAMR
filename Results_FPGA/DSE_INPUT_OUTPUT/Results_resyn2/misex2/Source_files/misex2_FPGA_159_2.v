...
module FAU ( 
  ...
  assign z05 = x00 & x01 & x10 & x16 & x02 & x09;
  ...
  assign z09 = (new_n62_ | new_n64_) & ~x21 & ~x00 & ~x22;
  assign new_n62_ = new_n63_ & ~x13 & ~x14 & x20 & ~x15 & ~x16;
  assign new_n63_ = ~x10 & ~x11 & x12 & ~x01 & x02;
  assign new_n64_ = (~x10 | x16) & ~x19 & ~x20 & x01 & x18;
  assign z10 = ~x00 & (new_n66_ | (x22 & new_n64_ & x21));
  assign new_n66_ = new_n68_ & new_n67_ & ~x22 & x15 & x16;
  assign new_n67_ = ~x01 & x02 & ~x11 & x12;
  assign new_n68_ = ~x13 & ~x14 & x20 & ~x21;
  assign z11 = ~x00 & ~x22 & ((new_n70_ & new_n63_) | (new_n64_ & x21));
  assign new_n70_ = new_n68_ & x15 & ~x16;
  assign z12 = (x10 & ~x16) | (~new_n72_ & x09 & ~x24);
  assign new_n72_ = ((x02 & x10) | ~x00 | ~x01) & (new_n73_ | x00 | x01);
