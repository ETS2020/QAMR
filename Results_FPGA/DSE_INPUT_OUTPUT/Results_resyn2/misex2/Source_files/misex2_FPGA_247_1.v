...
module FAU ( 
  ...
  assign z00 = new_n46_ & ~x02 & ~x00 & ~x01 & x10 & ~x17;
  assign new_n46_ = ~x09 & ~x18 & ~x19 & ~x21;
  assign z01 = new_n48_ & ~x19 & ~x17 & ~x18;
  assign new_n48_ = ~x02 & ~x00 & ~x01 & ~x21 & x09 & x10;
  assign z02 = ~x01 & (x21 | (new_n50_ & ~x19 & ~x17 & ~x18));
  assign new_n50_ = ~x00 & ~x02 & x09 & ~x10;
  assign z03 = (~new_n52_ & ~x01) | (x12 & new_n53_ & x02 & x00 & x01);
  assign new_n52_ = ~x21 & (x17 | x00 | x02 | ~x18 | x19);
  ...
  assign z06 = (~x01 & x21) | (new_n53_ & x02 & x00 & x01);
  assign z07 = (~x01 | (new_n53_ & ~x12)) & (x01 | ~x21) & x00 & x02;
  assign z08 = ~x01 & (x21 | (new_n60_ & new_n61_ & new_n62_));
  ...
  assign z10 = (~x01 & x21) | (~x00 & (new_n68_ | (new_n65_ & new_n69_)));
  assign new_n68_ = x18 & ~x19 & x22 & ~x20 & x21;
  assign new_n69_ = ~x14 & x15 & ~x22 & x16 & x20;
