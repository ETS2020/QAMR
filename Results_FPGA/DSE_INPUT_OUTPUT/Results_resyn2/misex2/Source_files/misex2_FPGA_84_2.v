...
module FAU ( 
  ...
  assign z03 = new_n52_ | (x12 & new_n51_ & x22 & ~x09 & x11);
  assign new_n51_ = x00 & x01 & x02 & x10;
  assign new_n52_ = ~x02 & ~x00 & ~x01 & ~x19 & ~x17 & x18;
  assign z04 = x01 & (new_n54_ | ~x22);
  assign new_n54_ = ~x09 & ~x12 & x00 & x10 & x02 & ~x11;
  assign z05 = x01 & (~x22 | (x00 & x09 & x02 & x10));
  assign z06 = new_n51_ & x22 & ~x09 & x11;
  assign z07 = (x01 & ~x22) | ((new_n58_ | ~x01) & x00 & x02);
  assign new_n58_ = ~x09 & ~x12 & x10 & x11;
  assign z08 = (x01 & ~x22) | (new_n60_ & new_n61_ & x02 & ~x00 & ~x01);
  assign new_n60_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign new_n61_ = x19 & x17 & ~x18;
  assign z09 = ~x22 & (x01 | (new_n63_ & new_n64_ & ~x15));
  assign new_n63_ = ~x00 & x02 & ~x11 & x12 & ~x13;
  ...
  assign z17 = (x01 & ~x22) | (x02 & ~x00 & ~x01);
endmodule
