...
module FAU ( 
  ...
  assign z09 = (new_n64_ | (new_n62_ & new_n63_ & ~x15)) & new_n65_ & ~x21;
  assign new_n62_ = ~x11 & x12 & ~x13 & ~x14 & ~x01 & x02;
  assign new_n63_ = ~x16 & x20;
  assign new_n64_ = ~x19 & ~x20 & x01 & x18;
  assign new_n65_ = ~x00 & ~x22;
  assign z10 = (~x01 & (x00 | (new_n67_ & new_n68_))) | (new_n69_ & ~x00 & x22);
  assign new_n67_ = ~x13 & ~x14 & ~x11 & x12;
  assign new_n68_ = x02 & x15 & ~x21 & ~x22 & x16 & x20;
  assign new_n69_ = x21 & ~x19 & ~x20 & x01 & x18;
  assign z11 = new_n65_ & ((new_n64_ & x21) | (new_n62_ & new_n63_ & x15 & ~x21));
  assign z12 = (x00 & ~x01) | (x09 & ~x24 & ((~new_n55_ & x00) | (~new_n72_ & ~x01)));
