...
module FAU ( 
  ...
  assign z00 = (x01 & x03) | (new_n46_ & ~x09 & ~x02 & ~x00 & ~x01);
  assign new_n46_ = ~x18 & ~x19 & x10 & ~x17;
  assign z01 = new_n46_ & x09 & ~x02 & ~x00 & ~x01;
  assign z02 = (x01 & x03) | (new_n49_ & x09 & ~x02 & ~x00 & ~x01);
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = new_n52_ | (x01 & (new_n51_ | x03));
  ...
  assign z06 = new_n57_ & x00 & x02 & x01 & ~x03;
  assign new_n57_ = x11 & ~x09 & x10;
  assign z07 = (x01 & x03) | (x00 & x02 & (~x01 | (new_n57_ & ~x12)));
  ...
  assign z13 = (x01 & x03) | (x17 & ~x19 & ~x02 & ~x00 & ~x01);
  assign z14 = (x01 & x03) | (new_n49_ & ~x09 & ~x02 & ~x00 & ~x01);
  assign z15 = (~x10 & ~x03 & x00 & x01) | ((x00 | (~x01 & x19)) & ~x02 & (~x01 | ~x03));
