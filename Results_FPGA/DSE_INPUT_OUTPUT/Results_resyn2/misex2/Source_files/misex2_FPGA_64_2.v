...
module FAU ( 
  ...
  assign z01 = (x01 & ~x13) | (new_n47_ & new_n46_ & x09);
  assign z02 = (x01 & ~x13) | (new_n50_ & new_n46_ & x09);
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = new_n53_ | (new_n52_ & x02 & x10 & x11 & x12);
  assign new_n52_ = ~x09 & x13 & x00 & x01;
  assign new_n53_ = ~x02 & ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign z04 = new_n55_ & x02 & x00 & x01;
  assign new_n55_ = ~x09 & x13 & ~x12 & x10 & ~x11;
  assign z05 = x02 & x00 & x01 & x13 & x09 & x10;
  assign z06 = x01 & (~x13 | (new_n58_ & x00 & x02));
  assign new_n58_ = x11 & ~x09 & x10;
  assign z07 = (x01 & ~x13) | (x00 & x02 & (~x01 | (new_n58_ & ~x12)));
  assign z08 = (x01 & ~x13) | (new_n61_ & z17 & new_n63_);
  assign new_n61_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign new_n63_ = x19 & x17 & ~x18;
  assign z09 = (new_n65_ | (new_n66_ & new_n67_)) & ~x21 & ~x00 & ~x22;
  assign new_n65_ = x18 & ~x19 & ~x20 & x01 & x13;
  assign new_n66_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n67_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((new_n69_ & x22) | (new_n66_ & new_n70_ & x16 & ~x22));
  assign new_n69_ = x21 & x18 & ~x19 & ~x20 & x01 & x13;
  assign new_n70_ = ~x14 & x15 & x20 & ~x21;
  assign z11 = ~x00 & ~x22 & (new_n69_ | (new_n66_ & new_n70_ & ~x16));
  assign z12 = (x01 & ~x13) | ((new_n73_ | new_n74_) & x09 & ~x24);
  ...
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & ~x13) | (x19 & ~x01 & ~x02);
