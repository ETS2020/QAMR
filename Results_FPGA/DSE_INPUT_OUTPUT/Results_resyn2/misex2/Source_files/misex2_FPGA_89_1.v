...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n59_, new_n60_,
    new_n62_, new_n63_, new_n65_, new_n69_, new_n70_;
  ...
  assign z03 = (~x00 & (new_n51_ | x01)) | (new_n52_ & x01 & x12);
  assign new_n51_ = x18 & ~x17 & ~x02 & ~x19;
  assign new_n52_ = x02 & x10 & ~x09 & x11;
  assign z04 = ~x11 & x02 & ~x09 & new_n54_ & x00 & x01;
  ...
  assign new_n62_ = x02 & ~x13 & ~x14 & ~x11 & x12;
  assign new_n63_ = ~x22 & x20 & ~x21;
  assign z10 = new_n65_ & new_n63_ & z17;
  assign new_n65_ = ~x11 & x12 & ~x13 & ~x14 & x15 & x16;
  assign z17 = x02 & ~x00 & ~x01;
  assign z11 = ~x00 & (x01 | (new_n62_ & new_n63_ & x15 & ~x16));
  assign z12 = x09 & ~x24 & (new_n69_ | new_n70_);
