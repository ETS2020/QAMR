...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
    new_n61_, new_n63_, new_n65_, new_n67_, new_n70_;
  ...
  assign new_n63_ = ~x13 & ~x14 & ~x15 & ~x16 & ~x11 & x12;
  assign z17 = x02 & ~x00 & ~x01;
  assign new_n65_ = ~x22 & x20 & ~x21;
  assign z10 = ~x00 & (x01 | (x16 & new_n65_ & new_n67_));
  assign new_n67_ = ~x13 & ~x14 & ~x11 & x12 & x02 & x15;
  assign z11 = ~x00 & (x01 | (~x16 & new_n65_ & new_n67_));
  assign z12 = (~x00 & x01) | ((new_n70_ | (~new_n54_ & x01)) & x09 & ~x24);
