...
module FAU ( 
  ...
  assign z09 = new_n60_ | (new_n67_ & (new_n64_ | (new_n65_ & new_n66_)));
  assign new_n64_ = x18 & ~x19 & x01 & ~x20;
  assign new_n65_ = x12 & x02 & ~x11;
  assign new_n66_ = ~x13 & ~x14 & ~x01 & ~x15 & ~x16 & x20;
  assign new_n67_ = ~x22 & ~x00 & ~x21;
  assign z10 = new_n60_ | (~x00 & ((new_n70_ & new_n71_) | (new_n69_ & x22)));
  assign new_n69_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n70_ = x12 & x02 & ~x11 & ~x21 & ~x13 & ~x14;
  assign new_n71_ = x15 & x20 & x16 & ~x22;
  assign z11 = new_n73_ & (new_n69_ | (new_n70_ & ~x01 & x15 & x20));
