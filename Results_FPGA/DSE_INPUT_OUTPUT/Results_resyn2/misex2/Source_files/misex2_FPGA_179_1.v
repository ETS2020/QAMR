...
module FAU ( 
  ...
  assign new_n61_ = ~x03 & x04 & (x12 | ~x20);
  assign new_n62_ = ~x00 & ~x01 & x02 & x19 & x17 & ~x18;
  assign z09 = new_n48_ | ((new_n66_ | (new_n64_ & new_n65_)) & new_n67_ & ~x21);
  assign new_n64_ = ~x01 & x02 & ~x11 & ~x13;
  ...
  assign new_n75_ = (x12 | ~x20) & x09 & ~x24;
