...
module FAU ( 
  ...
  assign z03 = new_n51_ | (new_n53_ & new_n52_ & x10 & x12);
  assign new_n51_ = ~x17 & ~x02 & ~x19 & x18 & ~x00 & ~x01;
  assign new_n52_ = x00 & x01;
  assign new_n53_ = x02 & ~x09 & x11 & ~x20;
  assign z04 = x01 & (new_n55_ | x20);
  assign new_n55_ = x02 & ~x09 & x00 & x10 & ~x11 & ~x12;
  assign z05 = new_n52_ & x02 & ~x20 & x09 & x10;
  assign z06 = new_n52_ & x02 & x11 & ~x20 & ~x09 & x10;
  ...
  assign z12 = (x01 & x20) | ((new_n75_ | new_n76_) & x09 & ~x24);
