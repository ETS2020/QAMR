...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n50_, new_n52_, new_n53_, new_n55_, new_n60_,
    new_n62_, new_n63_, new_n65_, new_n68_, new_n69_;
  assign z00 = new_n46_ & ~x09 & new_n47_ & ~x02;
  assign new_n46_ = x10 & ~x19 & ~x17 & ~x18;
  assign new_n47_ = ~x00 & ~x01;
  assign z01 = ~x00 & (x01 | (new_n46_ & ~x02 & x09));
  assign z02 = new_n50_ & x09 & new_n47_ & ~x02;
  ...
  assign z05 = x01 & (~x00 | (x09 & x02 & x10));
  assign z06 = x01 & (new_n53_ | ~x00);
  assign z07 = (~x00 & x01) | ((~x01 | (new_n55_ & ~x09 & x11)) & x00 & x02);
  assign z08 = new_n60_ & new_n47_ & x02 & x19 & x17 & ~x18;
  assign new_n60_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z09 = new_n62_ & new_n63_ & new_n47_ & x02;
  assign new_n62_ = ~x13 & ~x14 & ~x11 & x12 & ~x15 & ~x16;
  assign new_n63_ = ~x22 & x20 & ~x21;
  assign z10 = ~x00 & (x01 | (new_n65_ & new_n63_ & x15 & x16));
  assign new_n65_ = ~x13 & ~x14 & x12 & x02 & ~x11;
  assign z11 = ~x00 & (x01 | (new_n65_ & new_n63_ & x15 & ~x16));
