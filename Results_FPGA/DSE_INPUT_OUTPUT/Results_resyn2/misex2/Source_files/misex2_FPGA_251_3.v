...
module FAU ( 
  ...
  assign z01 = z04 | (new_n49_ & ~x02 & x09 & x10 & ~x17);
  assign z04 = x00 & x01;
  ...
  assign new_n58_ = ~x00 & ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n59_ = ~x16 & x20 & ~x21 & ~x22;
