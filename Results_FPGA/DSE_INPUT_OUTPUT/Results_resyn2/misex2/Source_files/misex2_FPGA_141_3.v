...
module FAU ( 
  ...
  assign z01 = (x00 & x01) | (new_n46_ & ~x01 & ~x02 & ~x00 & x09);
  assign z02 = (x00 & x01) | (new_n49_ & ~x01 & ~x02 & ~x00 & x09);
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (x00 & x01) | (x18 & ~x19 & ~x01 & ~x02 & ~x00 & ~x17);
  assign z05 = x00 & x01;
  assign z07 = x02 & x00 & ~x01;
  assign z08 = z05 | (new_n54_ & z17 & x19 & x17 & ~x18);
  assign new_n54_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = (new_n59_ | (new_n57_ & new_n58_)) & ~x00 & ~x21 & ~x22;
