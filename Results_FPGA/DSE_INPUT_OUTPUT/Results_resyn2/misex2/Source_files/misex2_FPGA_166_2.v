...
module FAU ( 
  ...
  assign new_n52_ = x02 & x00 & x01 & ~x09 & x10;
  ...
  assign z07 = (x01 & ~x24) | ((new_n58_ | ~x01) & x00 & x02);
  ...
  assign z10 = ~x00 & ((new_n67_ & x22 & x24) | (new_n63_ & new_n68_));
  assign new_n67_ = ~x20 & x18 & ~x19 & x01 & x21;
  assign new_n68_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign z11 = new_n49_ | (~x00 & ~x22 & (new_n67_ | (new_n63_ & new_n70_)));
  assign new_n70_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = ~x24 & (new_n72_ | x01);
  assign new_n72_ = ~x00 & x09 & ((~x02 & ~x19) ? x17 : x23);
