...
module FAU ( 
  ...
  assign new_n51_ = x11 & x10 & x02 & ~x09;
  assign new_n52_ = x18 & ~x19 & ~x17 & ~x01 & ~x02;
  assign z04 = x10 & x02 & ~x09 & new_n54_ & ~x11 & ~x12;
  assign new_n54_ = x00 & x01;
  assign z05 = x00 & (~x01 | (new_n56_ & x09));
  assign new_n56_ = x02 & x10;
  assign z06 = new_n51_ & new_n54_;
  assign z07 = z06 & ~x12;
  assign z08 = new_n60_ & ~x18 & x19 & ~x08 & x17;
  assign new_n60_ = new_n61_ & ~x06 & ~x07 & x04 & ~x05;
  assign new_n61_ = ~x00 & ~x01 & x02 & ~x03;
  assign z09 = (~new_n63_ & ~x01) | (new_n66_ & x18 & ~x19 & x01 & ~x20);
  assign new_n63_ = ~x00 & (~new_n64_ | ~new_n65_ | x14 | x15 | x16);
  assign new_n64_ = x20 & ~x21 & ~x22;
  assign new_n65_ = x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x00 & ~x21 & ~x22;
  assign z10 = ~x00 & ((new_n69_ & x22) | (new_n68_ & new_n70_));
  assign new_n68_ = new_n64_ & x16 & ~x14 & x15;
  assign new_n69_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n70_ = ~x01 & x12 & ~x13 & x02 & ~x11;
  assign z11 = (new_n72_ | new_n69_) & ~x00 & ~x22;
  assign new_n72_ = new_n70_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = (x00 & ~x01) | (((~new_n56_ & x00) | (~new_n74_ & ~x01)) & x09 & ~x24);
