...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n49_, new_n52_, new_n53_, new_n54_, new_n61_,
    new_n63_, new_n64_, new_n65_, new_n67_, new_n68_, new_n71_, new_n72_;
  assign z00 = new_n46_ & ~x09 & x10 & ~x02 & ~x00 & ~x01;
  assign new_n46_ = ~x18 & ~x19 & ~x17 & (x21 | ~x22);
  assign z01 = new_n48_ | (new_n49_ & ~x02 & ~x17 & x09 & x10);
  assign new_n48_ = ~x21 & x22;
  assign new_n49_ = ~x18 & ~x19 & ~x00 & ~x01;
  assign z02 = new_n46_ & ~x00 & ~x01 & ~x10 & ~x02 & x09;
  assign z03 = ~new_n48_ & (new_n54_ | (x12 & new_n52_ & new_n53_));
  assign new_n52_ = x02 & x00 & x01;
  assign new_n53_ = x11 & ~x09 & x10;
  assign new_n54_ = ~x02 & ~x17 & ~x00 & ~x01 & x18 & ~x19;
  assign z04 = new_n52_ & ~x09 & x10 & ~new_n48_ & ~x11 & ~x12;
  assign z05 = new_n48_ | (new_n52_ & x09 & x10);
  assign z06 = new_n48_ | (new_n52_ & new_n53_);
  assign z07 = (~x01 | (new_n53_ & ~x12)) & ~new_n48_ & x00 & x02;
  assign z08 = z17 & new_n61_ & x19 & x17 & ~x18;
  assign z17 = x02 & (x21 | ~x22) & ~x00 & ~x01;
  ...
  assign new_n72_ = x09 & ~x24 & (x21 | ~x22);
  assign z13 = ~new_n48_ & ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = new_n48_ | (new_n49_ & ~x02 & ~x17 & ~x09 & ~x10);
