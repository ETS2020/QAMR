...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n52_, new_n54_, new_n56_, new_n58_, new_n60_,
    new_n61_, new_n64_, new_n65_, new_n67_, new_n70_;
  ...
  assign z07 = (~x00 & x01) | (x00 & x02 & (new_n58_ | ~x01));
  ...
  assign z09 = z17 & new_n64_ & new_n65_ & ~x15;
  assign z17 = x02 & ~x00 & ~x01;
  assign new_n64_ = ~x11 & x12 & ~x13 & ~x14;
  assign new_n65_ = ~x16 & ~x22 & x20 & ~x21;
  assign z10 = new_n67_ & x15 & z17 & new_n64_;
  assign new_n67_ = x16 & ~x22 & x20 & ~x21;
  assign z11 = new_n65_ & x15 & z17 & new_n64_;
  assign z12 = ((~new_n70_ & ~x00 & ~x01) | (~new_n56_ & x00 & x01)) & x09 & ~x24;
