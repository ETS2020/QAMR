...
module FAU ( 
  ...
  assign z00 = new_n46_ & ~x19 & ~x22 & ~x18 & ~x09 & x10;
  assign new_n46_ = ~x17 & ~x02 & ~x00 & ~x01;
  assign z01 = ~x01 & (x22 | (new_n48_ & ~x17 & ~x02 & ~x19));
  assign new_n48_ = x09 & x10 & ~x00 & ~x18;
  assign z02 = ~x18 & ~x02 & ~x00 & ~x01 & new_n50_ & x09;
  assign new_n50_ = ~x10 & ~x17 & ~x19 & ~x22;
  assign z03 = (z06 & x12) | (new_n46_ & ~x22 & x18 & ~x19);
  ...
  assign z09 = new_n63_ | (~x00 & ~x21 & (new_n64_ | (new_n65_ & new_n66_)));
  assign new_n63_ = ~x01 & x22;
  assign new_n64_ = ~x22 & x18 & ~x19 & x01 & ~x20;
  assign new_n65_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = new_n63_ | (~x00 & (new_n69_ | (new_n65_ & new_n68_)));
  assign new_n68_ = x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n69_ = x18 & ~x19 & x22 & ~x20 & x21;
  assign z11 = new_n63_ | (~x00 & ((new_n65_ & new_n71_) | (new_n64_ & x21)));
  ...
  assign z13 = ~x02 & ~x00 & ~x01 & x17 & ~x19 & ~x22;
  assign z14 = ~x18 & ~x02 & ~x00 & ~x01 & new_n50_ & ~x09;
