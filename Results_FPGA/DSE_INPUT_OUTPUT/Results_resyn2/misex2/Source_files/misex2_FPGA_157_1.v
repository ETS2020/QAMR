...
module FAU ( 
  ...
  assign z10 = new_n46_ | (~x00 & (new_n70_ | (new_n69_ & new_n66_ & new_n71_)));
  assign new_n69_ = x20 & ~x13 & ~x14;
  assign new_n70_ = x18 & ~x19 & x01 & ~x20 & x21 & x22;
  assign new_n71_ = ~x21 & ~x22 & x15 & x16;
  assign z11 = (new_n73_ | (new_n65_ & new_n66_ & ~x21)) & new_n64_ & x15;
  assign new_n73_ = ~x19 & ~x20 & x21 & x01 & x18;
  assign z12 = new_n46_ | (x09 & ~x24 & (new_n75_ | new_n76_));
