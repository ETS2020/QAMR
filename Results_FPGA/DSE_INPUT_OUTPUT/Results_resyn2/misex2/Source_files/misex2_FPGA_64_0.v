...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n50_, new_n52_, new_n54_, new_n58_, new_n60_,
    new_n61_, new_n62_, new_n64_, new_n66_, new_n69_, new_n70_;
  assign z00 = new_n46_ & new_n47_ & ~x09;
  assign new_n46_ = ~x18 & ~x19 & x10 & ~x17;
  assign new_n47_ = ~x00 & ~x01 & ~x02 & x13;
  assign z01 = ~x01 & (~x13 | (new_n46_ & x09 & ~x00 & ~x02));
  assign z02 = ~x01 & (~x13 | (new_n50_ & x09 & ~x00 & ~x02));
  assign new_n50_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (new_n52_ & x12) | (new_n47_ & ~x17 & x18 & ~x19);
  ...
  assign z06 = new_n52_ | (~x01 & ~x13);
  assign z07 = (~x01 & ~x13) | ((new_n58_ | ~x01) & x00 & x02);
  assign new_n58_ = ~x12 & x11 & ~x09 & x10;
  assign z08 = ~x01 & (~x13 | (new_n60_ & new_n61_ & new_n62_));
  ...
  assign z13 = new_n47_ & x17 & ~x19;
  assign z14 = new_n50_ & new_n47_ & ~x09;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x01 & (~x13 | (~x02 & x19)));
  assign z16 = ~x00 & x01;
  assign z17 = ~x00 & ~x01 & x02 & x13;
endmodule
