...
module FAU ( 
  ...
  assign z10 = ~x00 & ((new_n69_ & ~new_n49_ & x22) | (new_n65_ & new_n70_));
  assign new_n69_ = x21 & ~x19 & ~x20 & x01 & x18;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n49_ | (new_n67_ & (new_n69_ | (new_n65_ & new_n72_)));
  assign new_n72_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = new_n49_ | ((new_n74_ | new_n75_) & x09 & ~x24);
