...
module FAU ( 
  ...
  assign z05 = new_n57_ | (x02 & x10 & new_n55_ & x09);
  ...
  assign z08 = new_n62_ & new_n63_ & ~x00 & ~x01 & x02;
  assign new_n62_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign new_n63_ = ~x18 & x19 & ~x16 & x17;
  ...
  assign z11 = new_n57_ | (~x00 & ~x22 & (new_n69_ | (new_n66_ & new_n71_)));
  assign new_n71_ = ~x13 & ~x14 & ~x21 & x15 & x20;
