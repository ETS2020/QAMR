...
module FAU ( 
  ...
  assign new_n46_ = ~x08 & ~x23;
  assign new_n47_ = ~x00 & ~x01 & ~x02 & ~x09;
  assign z01 = new_n46_ | (new_n49_ & ~x18 & ~x19 & x10 & ~x17);
  assign new_n49_ = ~x00 & ~x01 & ~x02 & x09;
  assign z02 = new_n46_ | (new_n49_ & ~x18 & ~x19 & ~x10 & ~x17);
  assign z03 = ~new_n46_ & (new_n52_ | (new_n53_ & x12 & x10 & x11));
  assign new_n52_ = ~x00 & ~x01 & ~x02 & ~x17 & x18 & ~x19;
  assign new_n53_ = x02 & ~x09 & x00 & x01;
  assign z04 = new_n55_ & ~x12 & x10 & ~x11;
  assign new_n55_ = x00 & x01 & (x08 | x23) & x02 & ~x09;
  ...
  assign z08 = new_n61_ & new_n62_ & x23 & ~x18 & x19;
  assign new_n61_ = ~x00 & ~x01 & x02 & ~x03 & x04 & ~x05;
  assign new_n62_ = ~x06 & ~x07 & ~x08 & x17;
  assign z09 = new_n46_ | (new_n67_ & ~x21 & (new_n66_ | (new_n64_ & new_n65_)));
  assign new_n64_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n65_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = ~x00 & ~x22;
  assign z10 = ~new_n46_ & ~x00 & ((new_n69_ & x22) | (new_n64_ & new_n70_));
  assign new_n69_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n70_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign z11 = new_n46_ | (new_n67_ & (new_n69_ | (new_n64_ & new_n72_)));
  ...
  assign z14 = ~x18 & ~x19 & ~x10 & ~x17 & ~new_n46_ & new_n47_;
