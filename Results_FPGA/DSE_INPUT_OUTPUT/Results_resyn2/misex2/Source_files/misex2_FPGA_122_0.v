...
module FAU ( 
  ...
  assign z00 = ~x09 & new_n46_ & new_n47_ & x10 & ~x17;
  assign new_n46_ = x20 & ~x18 & ~x19;
  assign new_n47_ = ~x02 & ~x00 & ~x01;
  assign z01 = x09 & new_n46_ & new_n47_ & x10 & ~x17;
  assign z02 = new_n46_ & new_n47_ & x09 & ~x10 & ~x17;
  assign z03 = (z06 & x12) | (new_n52_ & ~x17 & x18 & ~x19);
  assign z06 = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign new_n52_ = x20 & ~x02 & ~x00 & ~x01;
  assign z04 = (~x01 & ~x20) | (new_n54_ & x02 & x00 & x01);
  assign new_n54_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = (~x01 & ~x20) | (x02 & x10 & x09 & x00 & x01);
  assign z07 = (new_n57_ | ~x01) & (x01 | x20) & x00 & x02;
  ...
  assign z09 = new_n62_ | (new_n65_ & (new_n63_ | (new_n64_ & ~x15 & ~x16)));
  assign new_n62_ = ~x01 & ~x20;
  assign new_n63_ = ~x20 & x18 & ~x19;
  assign new_n64_ = ~x01 & x02 & ~x13 & ~x14 & ~x11 & x12;
  assign new_n65_ = ~x21 & ~x00 & ~x22;
  assign z10 = new_n62_ | (~x00 & ((new_n64_ & new_n68_) | (new_n67_ & x22)));
  assign new_n67_ = x21 & ~x20 & x18 & ~x19;
  assign new_n68_ = x15 & x16 & ~x21 & ~x22;
  assign z11 = new_n62_ | (~x00 & ~x22 & (new_n67_ | (new_n64_ & new_n70_)));
  assign new_n70_ = ~x21 & x15 & ~x16;
  assign z12 = new_n62_ | (x09 & ~x24 & (new_n72_ | new_n73_));
  assign new_n72_ = x00 & x01 & (~x02 | ~x10);
  assign new_n73_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign z13 = new_n52_ & x17 & ~x19;
  assign z14 = ~x01 & (~x20 | (new_n76_ & ~x18 & ~x00 & ~x09));
  assign new_n76_ = ~x10 & ~x17 & ~x02 & ~x19;
