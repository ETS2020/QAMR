...
module FAU ( 
  ...
  assign z01 = ~x00 & ~x01;
  assign z03 = z06 & x12;
  assign z06 = x10 & x11 & x00 & ~x09 & x01 & x02;
  assign z04 = (~x00 & ~x01) | (~x12 & x00 & ~x09 & new_n49_ & x01 & ~x11);
  assign new_n49_ = x02 & x10;
  assign z05 = (~x00 & ~x01) | (new_n49_ & x09 & x00 & x01);
  ...
  assign z12 = (~x00 & ~x01) | (x09 & x00 & x01 & ~new_n49_ & ~x24);
