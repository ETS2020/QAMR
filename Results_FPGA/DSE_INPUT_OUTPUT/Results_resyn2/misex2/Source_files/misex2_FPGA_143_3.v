...
module FAU ( 
  ...
  assign new_n53_ = ~x03 & x04 & ~x07 & ~x08 & ~x05 & ~x06;
  assign new_n54_ = x19 & x17 & ~x18;
  assign z09 = (new_n58_ | (new_n56_ & new_n57_)) & ~x22 & ~x00 & ~x21;
  assign new_n56_ = ~x13 & ~x11 & x12;
  assign new_n57_ = ~x01 & x02 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n58_ = x18 & ~x19 & x01 & ~x20;
  assign z10 = (~new_n60_ & x01) | (new_n61_ & new_n62_ & x16);
  assign new_n60_ = ~x00 & (~x22 | x20 | ~x21 | ~x18 | x19);
  assign new_n61_ = ~x14 & x15 & ~x22 & x20 & ~x21;
  assign new_n62_ = ~x00 & ~x01 & x02 & ~x13 & ~x11 & x12;
  assign z11 = (~new_n64_ & x01) | (new_n61_ & new_n62_ & ~x16);
