...
module FAU ( 
  ...
  assign z08 = ~x06 & (x23 | (new_n61_ & new_n62_ & new_n63_));
  assign new_n61_ = ~x00 & ~x01 & x02;
  assign new_n62_ = ~x18 & x19 & ~x08 & x17;
  assign new_n63_ = ~x05 & ~x07 & ~x03 & x04;
  assign z09 = new_n48_ | (new_n68_ & ~x21 & (new_n65_ | (new_n66_ & new_n67_)));
  assign new_n65_ = x18 & ~x19 & x01 & ~x20;
  assign new_n66_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n67_ = ~x16 & x20 & ~x14 & ~x15;
  assign new_n68_ = ~x00 & ~x22;
  assign z10 = new_n48_ | (~x00 & ((new_n70_ & x22) | (new_n66_ & new_n71_)));
  assign new_n70_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n71_ = ~x14 & x15 & x20 & ~x21 & x16 & ~x22;
  assign z11 = (new_n70_ | (new_n66_ & new_n73_)) & ~new_n48_ & new_n68_;
