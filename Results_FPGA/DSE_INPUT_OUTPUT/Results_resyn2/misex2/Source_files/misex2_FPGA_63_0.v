...
module FAU ( 
  ...
  assign new_n48_ = x09 & ~x00 & ~x01 & ~x02 & x13;
  ...
  assign new_n54_ = ~x19 & ~x00 & ~x01 & ~x02 & x13;
  ...
  assign new_n64_ = x01 & x18 & (x02 | x13) & ~x19 & ~x20;
  assign new_n65_ = ~x01 & x02 & x12 & ~x13;
  assign new_n66_ = ~x15 & ~x11 & ~x14 & ~x16 & x20;
  assign z10 = ~x00 & ((new_n65_ & new_n68_ & new_n69_) | (new_n70_ & new_n71_));
  assign new_n68_ = ~x22 & x20 & ~x21;
  assign new_n69_ = ~x11 & ~x14 & x15 & x16;
  assign new_n70_ = x01 & x18 & x21 & ~x19 & ~x20;
  assign new_n71_ = x22 & (x02 | x13);
  assign z11 = new_n56_ | (~x00 & ~x22 & (new_n70_ | (new_n73_ & new_n74_)));
  assign new_n73_ = ~x11 & ~x14 & ~x16 & x20;
  assign new_n74_ = x12 & ~x13 & ~x21 & ~x01 & x15;
  assign z12 = new_n56_ | ((new_n76_ | new_n77_) & x09 & ~x24);
  ...
  assign z15 = (~x10 & x00 & x01) | (~x02 & ((~x01 & x19) | x00 | ~x13));
