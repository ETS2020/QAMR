...
module FAU ( 
  ...
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n55_, new_n59_, new_n60_,
    new_n62_, new_n63_, new_n66_, new_n68_, new_n71_;
  ...
  assign z04 = new_n53_ & x00 & x01 & x02 & ~x11;
  assign new_n53_ = ~x12 & ~x09 & x10;
  assign z05 = new_n55_ & x09 & x00 & x01;
  assign new_n55_ = x02 & x10;
  assign z06 = x01 & (new_n51_ | ~x00);
  assign z07 = (~x01 | (new_n53_ & x11)) & x00 & x02;
  ...
  assign new_n62_ = ~x13 & ~x14 & x12 & x02 & ~x11;
  assign new_n63_ = ~x22 & x20 & ~x21;
  assign z10 = ~x00 & (x01 | (new_n62_ & new_n63_ & x15 & x16));
  assign z11 = new_n66_ & new_n63_ & x02 & ~x00 & ~x01;
  assign new_n66_ = ~x13 & ~x14 & ~x11 & x12 & x15 & ~x16;
  assign z12 = (~x00 & x01) | (x09 & ~x24 & ((~new_n55_ & x01) | (~new_n68_ & ~x00)));
  assign new_n68_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = ~x00 & (new_n71_ | x01);
  assign new_n71_ = ~x02 & ~x19 & ~x10 & ~x17 & ~x09 & ~x18;
