...
module FAU ( 
  ...
  assign new_n48_ = ~x01 & ~x02 & ~x00 & ~x07;
  ...
  assign z08 = ~x01 & (x07 | (new_n59_ & new_n60_));
  assign new_n59_ = ~x08 & x17 & ~x18 & x19;
  assign new_n60_ = ~x00 & x02 & ~x03 & x04 & ~x05 & ~x06;
  assign z09 = (new_n62_ | (new_n63_ & new_n64_)) & ~x21 & ~x00 & ~x22;
  assign new_n62_ = x18 & ~x19 & x01 & ~x20;
  assign new_n63_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n64_ = ~x07 & ~x14 & x20 & ~x15 & ~x16;
  assign z10 = new_n66_ | (~x00 & ((new_n67_ & x22) | (new_n63_ & new_n68_)));
  assign new_n66_ = ~x01 & x07;
  assign new_n67_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n68_ = ~x14 & x15 & x20 & ~x21 & x16 & ~x22;
  assign z11 = new_n66_ | (~x00 & ~x22 & (new_n67_ | (new_n63_ & new_n70_)));
  assign new_n70_ = ~x16 & ~x14 & x15 & x20 & ~x21;
  assign z12 = new_n66_ | ((new_n72_ | new_n73_) & x09 & ~x24);
