...
module FAU ( 
  ...
  assign z09 = (x21 & x22) | ((new_n65_ | (new_n63_ & new_n64_)) & ~x22 & ~x00 & ~x21);
  assign new_n63_ = x12 & ~x01 & ~x11 & x02 & ~x13 & ~x14;
  assign new_n64_ = x20 & ~x15 & ~x16;
  assign new_n65_ = ~x19 & ~x20 & x01 & x18;
  assign z10 = new_n67_ & new_n68_;
  assign new_n67_ = ~x13 & ~x14 & ~x00 & x02 & x15 & x16;
  assign new_n68_ = x12 & ~x01 & ~x11 & ~x22 & x20 & ~x21;
  assign z11 = (x21 & x22) | (~x00 & ((new_n65_ & x21) | (new_n63_ & new_n70_)));
