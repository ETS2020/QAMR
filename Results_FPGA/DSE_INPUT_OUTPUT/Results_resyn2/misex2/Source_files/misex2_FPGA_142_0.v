...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n53_, new_n56_, new_n58_, new_n61_, new_n62_,
    new_n63_, new_n65_, new_n66_, new_n68_, new_n70_, new_n71_;
  assign z00 = ~x09 & x10 & new_n46_ & ~x19 & ~x17 & ~x18;
  assign new_n46_ = ~x00 & ~x01 & ~x02 & x20;
  assign z01 = new_n46_ & ~x19 & ~x17 & ~x18 & x09 & x10;
  assign z02 = ~x01 & (~x20 | (new_n49_ & x09 & ~x00 & ~x02));
  ...
  assign z07 = (~x01 & ~x20) | ((new_n56_ | ~x01) & x00 & x02);
  ...
  assign z10 = (~x01 & ~x20) | (~x00 & (new_n65_ | (new_n62_ & new_n66_)));
  assign new_n65_ = x18 & ~x19 & x22 & ~x20 & x21;
  assign new_n66_ = ~x14 & x15 & ~x22 & x16 & ~x21;
  assign z11 = ~x00 & ~x22 & ((new_n62_ & new_n68_) | (new_n61_ & x21));
  ...
  assign z14 = ~x01 & (~x20 | (new_n49_ & ~x09 & ~x00 & ~x02));
