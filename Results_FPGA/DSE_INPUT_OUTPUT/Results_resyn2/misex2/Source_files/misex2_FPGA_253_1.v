...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n49_, new_n56_, new_n58_, new_n59_, new_n61_,
  ...
  assign z08 = ~x01 & (x05 | (new_n58_ & new_n59_));
  assign new_n58_ = ~x08 & x17 & ~x18 & x19;
  assign new_n59_ = ~x00 & x02 & ~x06 & ~x07 & ~x03 & x04;
  assign z09 = (~x01 & x05) | (new_n64_ & (new_n63_ | (new_n61_ & new_n62_)));
  ...
  assign z10 = ~x00 & ((new_n66_ & x22) | (new_n68_ & new_n61_ & new_n67_));
  assign new_n66_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = ~x13 & ~x14 & ~x05 & x15;
  assign new_n68_ = x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n66_ | (new_n70_ & new_n61_ & new_n67_));
  assign new_n70_ = ~x21 & ~x16 & x20;
  assign z12 = x09 & ~x24 & (new_n74_ | (new_n72_ & ~new_n73_));
