...
module FAU ( 
  ...
  assign new_n52_ = ~x15 & (x17 | ~x18 | x19 | x00 | x02);
  ...
  assign new_n62_ = ~x06 & ~x07 & ~x08 & ~x15;
  ...
  assign z10 = (~x01 & x15) | (new_n68_ & x22 & ~x19 & ~x20);
  assign new_n68_ = x01 & x18 & ~x00 & x21;
  assign z11 = (~x01 & x15) | (new_n68_ & ~x22 & ~x19 & ~x20);
