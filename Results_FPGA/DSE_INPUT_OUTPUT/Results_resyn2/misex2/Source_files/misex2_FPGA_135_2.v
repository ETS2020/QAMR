...
module FAU ( 
  ...
  assign z01 = new_n46_ & x09 & x10 & ~x00 & ~x01;
  assign z02 = ~x01 & (x00 | (x09 & new_n46_ & ~x10));
  ...
  assign new_n53_ = x01 & (x09 | ~x10 | x12 | ~x02 | x11);
  ...
  assign z09 = (~x01 & (x00 | (new_n60_ & new_n61_))) | (new_n62_ & ~x00 & x01 & x18);
  assign new_n60_ = x02 & ~x11 & ~x14 & x12 & ~x13;
  assign new_n61_ = ~x15 & ~x16 & x20 & ~x21 & ~x22;
  assign new_n62_ = ~x19 & ~x20 & ~x21 & ~x22;
  assign z10 = (~x01 & (x00 | (new_n60_ & new_n64_))) | (new_n65_ & new_n66_);
  assign new_n64_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n65_ = x21 & ~x19 & ~x20;
  assign new_n66_ = x22 & x18 & ~x00 & x01;
  assign z11 = (~x01 & (x00 | (new_n60_ & new_n68_))) | (new_n65_ & new_n69_);
  ...
  assign z14 = new_n46_ & ~x10 & ~x09 & ~x00 & ~x01;
