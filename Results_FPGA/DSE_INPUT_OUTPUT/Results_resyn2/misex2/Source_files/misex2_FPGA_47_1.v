...
module FAU ( 
  ...
  assign z03 = (new_n51_ & x12) | (new_n52_ & ~x17 & ~x02 & ~x19);
  assign new_n51_ = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign new_n52_ = ~x01 & ~x16 & ~x00 & x18;
  ...
  assign z09 = new_n66_ & (new_n65_ | (new_n64_ & x20 & ~x15 & ~x16));
  assign new_n64_ = ~x01 & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n65_ = ~x19 & ~x20 & x01 & x18;
  assign new_n66_ = ~x21 & ~x00 & ~x22;
  assign z10 = (~x01 & x16) | (new_n68_ & ~x00 & x22);
  ...
  assign new_n73_ = ~x23 & (x02 | x19);
  assign new_n74_ = (x17 | x02 | x19) & ~x00 & ~x01 & ~x16;
  assign z13 = ~x01 & (x16 | (~x00 & ~x02 & x17 & ~x19));
  assign z14 = new_n49_ & ~x10 & ~x09 & ~x00 & ~x02;
