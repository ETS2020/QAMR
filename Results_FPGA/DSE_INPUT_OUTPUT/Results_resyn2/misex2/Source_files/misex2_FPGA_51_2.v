...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n49_, new_n52_, new_n53_, new_n56_, new_n59_,
  ...
  assign new_n52_ = x03 & x00 & x01 & x02 & ~x09 & x10;
  assign new_n53_ = ~x02 & ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign z04 = new_n52_ & ~x11 & ~x12;
  assign z05 = new_n56_ & x09 & x02 & x10;
  assign new_n56_ = x03 & x00 & x01;
  assign z06 = new_n52_ & x11;
  assign z07 = (x01 & ~x03) | (x00 & x02 & (new_n59_ | ~x01));
  ...
  assign z17 = (~x00 & ~x01 & x02) | (x01 & ~x03);
endmodule
