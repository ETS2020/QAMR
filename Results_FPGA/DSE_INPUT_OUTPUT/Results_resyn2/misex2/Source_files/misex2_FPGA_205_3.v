...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n52_, new_n56_, new_n58_, new_n61_, new_n62_,
  ...
  assign z03 = (x01 & x12) | (new_n46_ & ~x17 & x18 & ~x19);
  assign z04 = new_n52_ & ~x11 & ~x09 & x10;
  assign new_n52_ = x00 & x01 & x02 & ~x12;
  assign z05 = new_n52_ & x09 & x10;
  assign z06 = new_n52_ & x11 & ~x09 & x10;
  ...
  assign new_n61_ = x01 & ~x12 & ~x20 & x18 & ~x19;
  assign new_n62_ = ~x01 & x02 & ~x11 & ~x14 & x12 & ~x13;
  assign new_n63_ = ~x22 & ~x00 & ~x21;
  assign z10 = (x01 & x12) | (~x00 & (new_n66_ | (new_n65_ & new_n67_)));
  ...
  assign new_n70_ = x01 & ~x12 & x21 & ~x20 & x18 & ~x19;
  ...
  assign z15 = ((~x01 | (x00 & ~x12)) & ~x02 & (x00 | x19)) | (x01 & ~x12 & x00 & ~x10);
