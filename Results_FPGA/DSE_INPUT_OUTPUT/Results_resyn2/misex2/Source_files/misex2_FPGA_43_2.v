...
module FAU ( 
  ...
  assign z02 = ~x10 & (x01 | (new_n49_ & x09));
  assign new_n49_ = ~x00 & ~x02 & ~x19 & ~x17 & ~x18;
  assign z03 = (new_n51_ & ~x02 & ~x00 & ~x01) | (new_n52_ & x00 & x02 & x01 & ~x09);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign new_n52_ = x12 & x10 & x11;
  assign z04 = x01 & (~x10 | (new_n54_ & ~x12 & ~x09 & ~x11));
  assign new_n54_ = x00 & x02;
  assign z05 = x01 & (~x10 | (new_n54_ & x09));
  assign z06 = x01 & (~x10 | (new_n54_ & ~x09 & x11));
  assign z07 = (new_n54_ & (~x01 | (~x12 & ~x09 & x11))) | (x01 & ~x10);
  assign z08 = (x01 & ~x10) | (new_n59_ & new_n60_ & ~x00 & ~x01 & x02);
  ...
  assign new_n64_ = x01 & ~x20 & x10 & x18 & ~x19;
  assign z10 = (new_n66_ | ~x00) & ((new_n62_ & new_n67_) | new_n66_ | (new_n68_ & x22));
  assign new_n66_ = x01 & ~x10;
  assign new_n67_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign new_n68_ = x01 & ~x20 & x21 & x18 & ~x19;
  assign z11 = new_n66_ | (~x00 & ~x22 & (new_n68_ | (new_n62_ & new_n70_)));
  assign new_n70_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = (~new_n72_ & x01) | (~new_n73_ & ~x00 & ~x01 & x09 & ~x24);
  assign new_n72_ = x10 & (~x00 | x02 | ~x09 | x24);
  assign new_n73_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = (x01 & ~x10) | (~x00 & ~x01 & x17 & ~x02 & ~x19);
  assign z14 = ~x10 & (x01 | (new_n49_ & ~x09));
