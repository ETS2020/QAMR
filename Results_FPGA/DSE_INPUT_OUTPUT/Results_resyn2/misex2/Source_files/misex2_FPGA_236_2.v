...
module FAU ( 
  ...
  assign z00 = new_n46_ & ~x00 & ~x01 & x10 & ~x02 & ~x09;
  assign new_n46_ = ~x18 & ~x19 & ~x17 & (~x06 | x23);
  assign z01 = new_n48_ | (new_n49_ & ~x02 & x09 & x10 & ~x17);
  assign new_n48_ = x06 & ~x23;
  assign new_n49_ = ~x18 & ~x19 & ~x00 & ~x01;
  assign z02 = new_n46_ & ~x02 & x09 & ~x10 & ~x00 & ~x01;
  assign z03 = new_n52_ | new_n48_ | (new_n53_ & x12 & x10 & x11);
  assign new_n52_ = x18 & ~x19 & ~x02 & ~x17 & ~x00 & ~x01;
  assign new_n53_ = x02 & ~x09 & x00 & x01;
  assign z04 = new_n55_ & ~x12 & x10 & ~x11;
  assign new_n55_ = x02 & ~x09 & x00 & x01 & (~x06 | x23);
  assign z05 = ~new_n48_ & x00 & x01 & x09 & x02 & x10;
  assign z06 = new_n55_ & x10 & x11;
  assign z07 = ~new_n59_ & ~new_n48_ & x00 & x02;
  ...
  assign z09 = new_n48_ | (new_n67_ & ~x21 & (new_n64_ | (new_n65_ & new_n66_)));
  assign new_n64_ = x18 & ~x19 & x01 & ~x20;
  assign new_n65_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n66_ = ~x16 & x20 & ~x14 & ~x15;
  assign new_n67_ = ~x00 & ~x22;
  assign z10 = new_n48_ | (~x00 & ((new_n69_ & x22) | (new_n65_ & new_n70_)));
  assign new_n69_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n70_ = ~x14 & x15 & x20 & ~x21 & x16 & ~x22;
  assign z11 = (new_n69_ | (new_n65_ & new_n72_)) & ~new_n48_ & new_n67_;
  assign new_n72_ = ~x16 & ~x14 & x15 & x20 & ~x21;
  assign z12 = new_n48_ | ((new_n74_ | new_n75_) & x09 & ~x24);
