...
module FAU ( 
  ...
  assign z03 = new_n53_ | (x01 & (x15 | (new_n51_ & new_n52_ & x12)));
  assign new_n51_ = x11 & ~x09 & x10;
  assign new_n52_ = x00 & x02;
  assign new_n53_ = ~x02 & ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign z04 = new_n55_ & ~x15 & ~x11 & ~x12;
  assign new_n55_ = x00 & x02 & x01 & ~x09 & x10;
  assign z05 = x01 & (x15 | (new_n52_ & x09 & x10));
  assign z06 = new_n55_ & x11 & ~x15;
  assign z07 = (x01 & x15) | (new_n52_ & (~x01 | (new_n51_ & ~x12)));
  assign z08 = new_n60_ & new_n61_ & ~x00 & ~x01 & x02;
  assign new_n60_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign new_n61_ = x19 & x17 & ~x18;
  assign z09 = new_n66_ & (new_n65_ | (new_n63_ & new_n64_));
  assign new_n63_ = ~x13 & ~x14 & ~x11 & x12;
  assign new_n64_ = ~x01 & x02 & ~x16 & x20;
  assign new_n65_ = x18 & ~x19 & x01 & ~x20;
  assign new_n66_ = ~x21 & ~x22 & ~x00 & ~x15;
  assign z10 = (x01 & x15) | (~x00 & (new_n68_ | (new_n63_ & new_n69_)));
  assign new_n68_ = x18 & ~x19 & x01 & ~x20 & x21 & x22;
  assign new_n69_ = ~x21 & ~x22 & x02 & x15 & x16 & x20;
  assign z11 = new_n71_ & ((new_n63_ & new_n64_ & x15 & ~x21) | (new_n65_ & ~x15 & x21));
  assign new_n71_ = ~x00 & ~x22;
  assign z12 = (new_n73_ | new_n74_) & x09 & ~x24;
  assign new_n73_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign new_n74_ = (~x02 | ~x10) & x01 & x00 & ~x15;
