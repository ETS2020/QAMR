...
module FAU ( 
  ...
  assign z10 = ~x00 & ((new_n66_ & x22) | (new_n63_ & new_n67_ & new_n68_));
  assign new_n66_ = x21 & ~x19 & ~x20 & x01 & x18;
  assign new_n67_ = ~x24 & ~x21 & ~x22;
  assign new_n68_ = x16 & x20 & ~x14 & x15;
  assign z11 = new_n70_ | (~x00 & ~x22 & (new_n66_ | (new_n63_ & new_n71_)));
  assign new_n70_ = ~x01 & x24;
  assign new_n71_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = (~x01 & x24) | (x09 & (new_n73_ | (~new_n74_ & ~x24 & x00 & x01)));
