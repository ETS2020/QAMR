...
module FAU ( 
  ...
  assign z01 = (x01 & x06) | (new_n46_ & ~x02 & ~x00 & ~x01 & x09);
  assign z02 = (x01 & x06) | (new_n49_ & ~x02 & ~x00 & ~x01 & x09);
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = new_n53_ | (x12 & new_n51_ & new_n52_ & x01 & ~x06);
  assign new_n51_ = x11 & ~x09 & x10;
  assign new_n52_ = x00 & x02;
  assign new_n53_ = ~x19 & ~x02 & ~x00 & ~x01 & ~x17 & x18;
  assign z04 = x01 & (new_n55_ | x06);
  assign new_n55_ = ~x09 & x10 & x00 & x02 & ~x11 & ~x12;
  assign z05 = x01 & (x06 | (new_n52_ & x09 & x10));
  assign z06 = new_n51_ & new_n52_ & x01 & ~x06;
  assign z07 = (x01 & x06) | (new_n52_ & (~x01 | (new_n51_ & ~x12)));
  ...
  assign new_n72_ = (~x02 | ~x10) & x00 & x01 & ~x06;
  assign z13 = x17 & ~x19 & ~x02 & ~x00 & ~x01;
  assign z14 = (x01 & x06) | (new_n49_ & ~x02 & ~x00 & ~x01 & ~x09);
