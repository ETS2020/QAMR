...
module FAU ( 
  ...
  assign z03 = (new_n52_ & x12 & ~x09 & x11) | new_n50_ | new_n53_;
  assign new_n52_ = x00 & x01 & x02 & x10;
  assign new_n53_ = ~x00 & x18 & ~x19 & ~x17 & ~x01 & ~x02;
  assign z04 = new_n55_ & ~x11 & x10 & ~x12;
  assign new_n55_ = x00 & x01 & (~x15 | x21) & x02 & ~x09;
  ...
  assign z09 = ~x21 & (x15 | (new_n67_ & (new_n66_ | (new_n64_ & new_n65_))));
