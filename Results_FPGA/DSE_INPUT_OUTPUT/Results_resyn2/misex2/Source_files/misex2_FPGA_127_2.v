...
module FAU ( 
  ...
  assign new_n51_ = x00 & (~x01 | (new_n52_ & x12 & x10 & x11));
  assign new_n52_ = x02 & ~x09;
  assign z04 = x10 & x00 & x01 & ~x11 & new_n52_ & ~x12;
  assign z05 = x02 & x10 & x09 & x00 & x01;
  assign z06 = x10 & x00 & x01 & new_n52_ & x11;
  assign z07 = x00 & (~x01 | (x10 & x11 & new_n52_ & ~x12));
  ...
  assign new_n61_ = ~x00 & (~new_n62_ | ~new_n63_ | x16 | x14 | x15);
  assign new_n62_ = x20 & ~x21 & ~x22;
  assign new_n63_ = x02 & ~x11 & x12 & ~x13;
  ...
  assign new_n68_ = ~x01 & x12 & ~x13 & x02 & ~x11;
  assign z11 = ~x00 & ~x22 & (new_n70_ | new_n67_);
  assign new_n70_ = new_n68_ & ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = ~new_n72_ & x09 & ~x24;
  assign new_n72_ = (new_n73_ | x00 | x01) & ((x02 & x10) | ~x00 | ~x01);
