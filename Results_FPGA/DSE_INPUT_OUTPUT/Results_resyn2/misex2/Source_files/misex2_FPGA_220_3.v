...
module FAU ( 
  ...
  assign z03 = (new_n53_ & ~x17 & x18) | (new_n54_ & new_n55_);
  assign new_n53_ = ~x19 & (~x12 | ~x22) & ~x02 & ~x00 & ~x01;
  assign new_n54_ = x00 & x01 & ~x09 & x10;
  assign new_n55_ = x02 & x11 & x12 & ~x22;
  assign z04 = (x12 & x22) | (new_n54_ & ~x12 & x02 & ~x11);
  assign z05 = new_n48_ | (x02 & x10 & x09 & x00 & x01);
  assign z06 = new_n54_ & ~new_n48_ & x02 & x11;
  ...
  assign new_n63_ = x02 & ~x00 & ~x01 & x19 & x17 & ~x18;
  assign z09 = new_n48_ | (~x00 & ~x21 & (new_n65_ | (new_n66_ & new_n67_)));
  assign new_n65_ = ~x20 & ~x22 & ~x19 & x01 & x18;
  assign new_n66_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n67_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = new_n48_ | (~x00 & (new_n70_ | (new_n66_ & new_n69_)));
  assign new_n69_ = x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n70_ = ~x19 & x01 & x18 & x22 & ~x20 & x21;
  assign z11 = new_n48_ | (~x00 & ((new_n65_ & x21) | (new_n66_ & new_n72_)));
  ...
  assign new_n75_ = (~x12 | ~x22) & x09 & ~x24;
