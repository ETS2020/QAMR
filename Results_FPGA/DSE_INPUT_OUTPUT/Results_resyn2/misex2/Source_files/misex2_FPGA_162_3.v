...
module FAU ( 
  ...
  assign z09 = (x07 & x21) | ((new_n66_ | (new_n64_ & new_n65_)) & new_n67_ & ~x21);
  assign new_n64_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n65_ = ~x16 & x20 & ~x14 & ~x15;
  assign new_n66_ = x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n69_ & x22) | (new_n64_ & new_n70_));
  assign new_n69_ = x18 & ~x19 & x01 & ~x20 & ~x07 & x21;
  assign new_n70_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign z11 = new_n67_ & (new_n69_ | (new_n64_ & new_n72_));
  ...
  assign new_n75_ = (~x07 | ~x21) & x09 & ~x24;
