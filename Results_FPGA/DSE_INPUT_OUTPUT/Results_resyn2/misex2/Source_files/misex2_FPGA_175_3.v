...
module FAU ( 
  ...
  assign z03 = new_n53_ | (x01 & (x05 | (new_n51_ & new_n52_ & x12)));
  ...
  assign new_n58_ = x01 & (~x10 | ~x11 | x12 | x05 | x09);
  ...
  assign new_n63_ = x01 & ~x05 & ~x20 & x18 & ~x19;
  assign new_n64_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n65_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n64_ & new_n68_) | (new_n63_ & x21 & x22));
  assign new_n68_ = x20 & ~x21 & ~x14 & x15 & x16 & ~x22;
  assign z11 = (x01 & x05) | (new_n66_ & (new_n71_ | (new_n64_ & new_n70_)));
  assign new_n70_ = ~x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n71_ = x01 & x21 & ~x20 & x18 & ~x19;
  assign z12 = (x01 & x05) | ((new_n73_ | new_n74_) & x09 & ~x24);
  ...
  assign z15 = ((~x01 | (x00 & ~x05)) & ~x02 & (x00 | x19)) | (x00 & ~x05 & x01 & ~x10);
