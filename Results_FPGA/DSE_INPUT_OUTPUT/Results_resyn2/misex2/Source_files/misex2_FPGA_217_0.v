...
module FAU ( 
  ...
  assign z10 = ~x00 & ((new_n68_ & ~new_n48_ & x22) | (new_n65_ & new_n69_));
  assign new_n68_ = x01 & x18 & x21 & ~x19 & ~x20;
  assign new_n69_ = ~x14 & x15 & x20 & ~x21 & x16 & ~x22;
  assign z11 = new_n48_ | (~x00 & ~x22 & (new_n68_ | (new_n65_ & new_n71_)));
  assign new_n71_ = ~x16 & ~x14 & x15 & x20 & ~x21;
  assign z12 = (new_n73_ | new_n74_) & ~x24 & x09 & x12;
