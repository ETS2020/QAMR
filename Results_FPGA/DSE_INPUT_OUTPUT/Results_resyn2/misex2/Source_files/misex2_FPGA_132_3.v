...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n48_, new_n52_, new_n53_, new_n55_, new_n60_,
  ...
  assign z03 = (new_n52_ & new_n53_) | (new_n48_ & ~x17 & x18 & ~x19);
  assign new_n52_ = x11 & ~x09 & x10;
  assign new_n53_ = x00 & x01 & x02 & ~x06 & x12;
  assign z04 = x01 & (new_n55_ | x06);
  assign new_n55_ = x00 & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x01 & (x06 | (x00 & x02 & x09 & x10));
  assign z06 = x01 & (x06 | (new_n52_ & x00 & x02));
  assign z07 = (x01 & x06) | (x00 & x02 & (~x01 | (new_n52_ & ~x12)));
