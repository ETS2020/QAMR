...
module FAU ( 
  ...
  assign z00 = ~x01 & (~x20 | (new_n46_ & ~x09 & ~x00 & ~x02));
  assign new_n46_ = ~x18 & ~x19 & x10 & ~x17;
  assign z01 = new_n48_ & x09 & ~x01 & ~x00 & ~x02;
  assign new_n48_ = x10 & ~x17 & x20 & ~x18 & ~x19;
  assign z02 = x09 & ~x01 & ~x00 & ~x02 & new_n50_ & x20;
  assign new_n50_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (~new_n52_ & ~x01) | (x12 & new_n53_ & x02 & x00 & x01);
  ...
  assign z06 = (~x01 & ~x20) | (new_n53_ & x02 & x00 & x01);
  assign z07 = (~x01 | (new_n53_ & ~x12)) & (x01 | x20) & x00 & x02;
  ...
  assign z11 = new_n70_ | (~x00 & ~x22 & (new_n72_ | (new_n65_ & new_n71_)));
  assign new_n70_ = ~x01 & ~x20;
  assign new_n71_ = ~x21 & x15 & ~x16;
