...
module FAU ( 
  ...
  assign z03 = (x00 & (new_n52_ | ~x01)) | (new_n53_ & x18 & ~x01 & ~x17);
  assign new_n52_ = x12 & x11 & x10 & x02 & ~x09;
  assign new_n53_ = ~x02 & ~x19;
  assign z04 = x10 & x02 & ~x09 & new_n55_ & ~x11 & ~x12;
  assign new_n55_ = x00 & x01;
  assign z05 = x00 & (~x01 | (x09 & x02 & x10));
  assign z06 = new_n55_ & x11 & x10 & x02 & ~x09;
  assign z07 = ~x12 & new_n55_ & x11 & x10 & x02 & ~x09;
  ...
  assign z13 = ~x01 & (x00 | (new_n53_ & x17));
