...
module FAU ( 
  ...
  assign new_n55_ = (x15 | x22) & x00 & x02;
  ...
  assign z09 = new_n63_ & x18 & ~x19 & x15 & ~x20;
  assign new_n63_ = ~x21 & ~x22 & ~x00 & x01;
  assign z10 = (~x15 & ~x22) | (~x00 & ((new_n65_ & x22) | (new_n66_ & new_n67_)));
  assign new_n65_ = x18 & ~x19 & x21 & x01 & ~x20;
  assign new_n66_ = ~x13 & ~x14 & ~x11 & x12 & ~x01 & x02;
  assign new_n67_ = ~x21 & ~x22 & x16 & x20;
  assign z11 = new_n69_ & (new_n65_ | (new_n66_ & ~x21 & ~x16 & x20));
  assign new_n69_ = ~x22 & ~x00 & x15;
  assign z12 = new_n48_ | ((new_n71_ | new_n72_) & x09 & ~x24);
