...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n50_, new_n52_, new_n56_, new_n58_, new_n60_,
  ...
  assign new_n47_ = ~x00 & ~x02 & ~x01 & x04;
  assign z01 = new_n47_ & ~x19 & ~x17 & ~x18 & x09 & x10;
  assign z02 = ~x01 & (~x04 | (new_n50_ & x09));
  assign new_n50_ = ~x19 & ~x17 & ~x18 & ~x10 & ~x00 & ~x02;
  ...
  assign new_n58_ = (x01 | ~x04) & (x09 | ~x10 | x12 | ~x01 | ~x11);
  assign z08 = ~x01 & (~x04 | (new_n60_ & new_n61_));
  assign new_n60_ = ~x08 & x17 & ~x18 & x19;
  assign new_n61_ = ~x00 & x02 & ~x03 & ~x05 & ~x06 & ~x07;
  assign z09 = new_n56_ | (new_n66_ & ~x21 & (new_n65_ | (new_n63_ & new_n64_)));
  assign new_n63_ = ~x16 & x20 & ~x13 & ~x11 & x12;
  assign new_n64_ = ~x14 & ~x15 & ~x01 & x02;
  ...
  assign z11 = new_n56_ | (new_n66_ & ((new_n65_ & x21) | (new_n63_ & new_n71_ & ~x21)));
  assign z12 = new_n56_ | ((new_n74_ | new_n75_) & x09 & ~x24);
  assign new_n74_ = x00 & x01 & (~x02 | ~x10);
  assign new_n75_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign z13 = new_n47_ & x17 & ~x19;
  assign z14 = ~x01 & (~x04 | (new_n50_ & ~x09));
