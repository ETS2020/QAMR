...
module FAU ( 
  ...
  assign z09 = (~x01 & ~x13) | (new_n64_ & ~x22 & x18 & ~x00 & x01);
  assign new_n64_ = ~x21 & ~x19 & ~x20;
  assign z10 = (~x01 & ~x13) | (new_n66_ & x22 & x18 & ~x00 & x01);
  assign new_n66_ = x21 & ~x19 & ~x20;
  assign z11 = (~x01 & ~x13) | (new_n66_ & ~x22 & x18 & ~x00 & x01);
  assign z12 = (new_n69_ | (~new_n70_ & new_n71_)) & x09 & ~x24;
  assign new_n69_ = x00 & x01 & (~x02 | ~x10);
  assign new_n70_ = ~x17 & ~x02 & ~x19;
  assign new_n71_ = (x23 | (~x02 & ~x19)) & x13 & ~x00 & ~x01;
  assign z13 = ~x01 & (~x13 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = new_n70_ & new_n74_;
  assign new_n74_ = ~x00 & ~x01 & ~x09 & ~x10 & x13 & ~x18;
