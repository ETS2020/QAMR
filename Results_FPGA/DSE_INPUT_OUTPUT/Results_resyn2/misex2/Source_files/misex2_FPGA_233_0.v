...
module FAU ( 
  ...
  assign new_n63_ = ~x01 & x04 & x12 & x02 & ~x11;
  assign new_n64_ = ~x16 & x20 & ~x15 & ~x13 & ~x14;
  assign z10 = ~x00 & (new_n66_ | (new_n68_ & new_n63_ & new_n67_));
  assign new_n66_ = x22 & x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = x15 & ~x13 & ~x14;
  assign new_n68_ = x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n71_ & ((new_n62_ & x21) | (new_n63_ & new_n67_ & new_n70_ & ~x21));
  assign new_n70_ = ~x16 & x20;
  assign new_n71_ = ~x00 & ~x22;
  assign z12 = (~x01 & ~x04) | (x09 & ~x24 & (new_n73_ | new_n74_));
