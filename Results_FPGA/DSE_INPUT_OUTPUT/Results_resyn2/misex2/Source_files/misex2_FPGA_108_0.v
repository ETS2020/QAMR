...
module FAU ( 
  ...
  assign new_n61_ = x12 & ~x01 & x02 & x06 & ~x11;
  assign new_n62_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n63_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n66_ & x22) | (new_n67_ & new_n65_ & new_n68_));
  assign new_n65_ = ~x01 & x02 & x06 & ~x11;
  assign new_n66_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = ~x13 & ~x14 & x20 & ~x21;
  assign new_n68_ = x12 & x15 & x16 & ~x22;
  assign z11 = new_n63_ & (new_n66_ | (new_n61_ & new_n67_ & x15 & ~x16));
  assign z12 = new_n72_ & ((~new_n56_ & x00 & x01) | (~new_n71_ & x06 & ~x00 & ~x01));
