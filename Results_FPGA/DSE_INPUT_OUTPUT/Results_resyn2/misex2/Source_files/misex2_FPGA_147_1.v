...
module FAU ( 
  ...
  assign new_n60_ = (x01 | x04) & (~x01 | x09 | x12 | ~x10 | ~x11);
  assign z09 = (new_n62_ | (new_n63_ & new_n64_)) & ~x21 & ~x00 & ~x22;
  assign new_n62_ = x01 & ~x20 & x18 & ~x19;
  assign new_n63_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n64_ = ~x04 & ~x14 & x20 & ~x15 & ~x16;
  assign z10 = new_n56_ | (~x00 & ((new_n63_ & new_n67_) | (new_n66_ & x22)));
  assign new_n66_ = x21 & x01 & ~x20 & x18 & ~x19;
  assign new_n67_ = ~x14 & x15 & x20 & ~x21 & x16 & ~x22;
  assign z11 = new_n56_ | (~x00 & ~x22 & (new_n66_ | (new_n63_ & new_n69_)));
  assign new_n69_ = ~x16 & ~x14 & x15 & x20 & ~x21;
  assign z12 = x09 & ~x24 & (new_n71_ | (new_n49_ & ~new_n72_));
