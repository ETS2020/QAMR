...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n52_, new_n56_, new_n58_, new_n59_, new_n61_,
  ...
  assign z01 = new_n48_ | (new_n46_ & x09 & x10);
  ...
  assign z06 = new_n52_ & x11 & ~x12;
  assign z07 = (x01 & x12) | (x00 & x02 & (new_n56_ | ~x01));
  ...
  assign z09 = new_n48_ | ((new_n61_ | (new_n62_ & new_n63_)) & new_n64_ & ~x00);
  assign new_n61_ = x01 & x18 & ~x19 & ~x20;
  assign new_n62_ = x02 & ~x11 & x12 & ~x13;
  assign new_n63_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n64_ = ~x21 & ~x22;
  assign z10 = new_n48_ | (~x00 & ((new_n67_ & new_n68_) | (new_n66_ & x22)));
  assign new_n66_ = x21 & x01 & x18 & ~x19 & ~x20;
  assign new_n67_ = x02 & ~x11 & x12 & ~x13 & ~x14 & x15;
  assign new_n68_ = x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n48_ | (~x00 & ~x22 & (new_n66_ | (new_n67_ & new_n70_)));
  assign new_n70_ = ~x21 & ~x16 & x20;
  assign z12 = new_n48_ | ((new_n72_ | new_n73_) & x09 & ~x24);
  assign new_n72_ = (~x02 | ~x10) & x00 & x01;
  assign new_n73_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign z13 = (x01 & x12) | (x17 & ~x00 & ~x01 & ~x02 & ~x19);
  assign z14 = new_n48_ | (new_n46_ & ~x09 & ~x10);
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & x12) | (x19 & ~x01 & ~x02);
