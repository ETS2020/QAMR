...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
    new_n61_, new_n63_, new_n65_, new_n68_, new_n70_;
  ...
  assign z09 = new_n63_ & z17 & ~x14 & new_n65_ & ~x15 & ~x16;
  assign new_n63_ = ~x13 & ~x11 & x12;
  assign z17 = x02 & ~x00 & ~x01;
  assign new_n65_ = ~x22 & x20 & ~x21;
  assign z10 = new_n63_ & z17 & ~x14 & new_n65_ & x15 & x16;
  assign z11 = ~x00 & (x01 | (new_n63_ & new_n65_ & new_n68_));
  assign new_n68_ = x15 & ~x16 & x02 & ~x14;
