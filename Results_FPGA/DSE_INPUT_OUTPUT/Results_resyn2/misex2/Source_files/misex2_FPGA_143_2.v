...
module FAU ( 
  ...
  assign z02 = ~x17 & ~x18 & ~x19 & new_n46_ & x09 & ~x10;
  assign z03 = (z06 & x12) | (new_n46_ & ~x19 & ~x17 & x18);
  assign z06 = x11 & x00 & x01 & x10 & x02 & ~x09;
  assign z04 = new_n52_ & x00 & x01 & ~x11 & ~x12;
  assign new_n52_ = x10 & x02 & ~x09;
  ...
  assign z12 = (x00 & ~x01) | (((~new_n54_ & x00) | (~new_n71_ & ~x01)) & x09 & ~x24);
  assign new_n71_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = x17 & new_n46_ & ~x19;
  assign z14 = ~x01 & (new_n74_ | x00);
  assign new_n74_ = ~x10 & ~x02 & ~x09 & ~x17 & ~x18 & ~x19;
