...
module FAU ( 
  ...
  assign new_n46_ = ~x02 & ~x09 & (x06 | ~x22) & ~x00 & ~x01;
  assign z01 = new_n48_ | (new_n49_ & ~x18 & ~x19 & x10 & ~x17);
  assign new_n48_ = ~x06 & x22;
  ...
  assign z07 = new_n48_ | ((~x01 | (new_n54_ & ~x12)) & x00 & x02);
  assign z08 = ~x06 & (x22 | (new_n61_ & new_n62_ & new_n63_));
  assign new_n61_ = x19 & x17 & ~x18;
  assign new_n62_ = ~x07 & ~x08 & x04 & ~x05;
  assign new_n63_ = ~x01 & x02 & ~x00 & ~x03;
  ...
  assign z10 = ~x00 & ((new_n69_ & x06 & x22) | (new_n66_ & new_n70_));
  ...
  assign new_n75_ = ~x24 & x09 & (x06 | ~x22);
