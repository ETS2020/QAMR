...
module FAU ( 
  ...
  assign new_n63_ = x02 & ~x13 & ~x14 & ~x11 & x12;
  assign new_n64_ = ~x22 & x20 & ~x21;
  assign z10 = ~x00 & (x01 | (new_n63_ & new_n64_ & x15 & x16));
  assign z11 = new_n67_ & new_n64_ & z17;
  assign new_n67_ = ~x11 & x12 & ~x13 & ~x14 & x15 & ~x16;
  assign z17 = x02 & ~x00 & ~x01;
  assign z12 = x09 & ~x24 & ((~new_n56_ & x00 & x01) | (~new_n70_ & ~x00 & ~x01));
  assign new_n70_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = new_n49_ & ~x02 & ~x09 & ~x00 & ~x01;
