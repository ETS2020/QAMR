...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n49_, new_n52_, new_n57_, new_n59_, new_n60_,
    new_n62_, new_n63_, new_n64_, new_n65_, new_n66_, new_n68_, new_n69_,
    new_n71_, new_n73_, new_n74_;
  assign z00 = ~x01 & (~x04 | (new_n46_ & new_n47_));
  assign new_n46_ = ~x09 & x10;
  assign new_n47_ = ~x02 & ~x19 & ~x18 & ~x00 & ~x17;
  assign z01 = x09 & x10 & new_n49_ & ~x17 & ~x18;
  assign new_n49_ = ~x02 & x04 & ~x19 & ~x00 & ~x01;
  assign z02 = ~x01 & (~x04 | (new_n47_ & x09 & ~x10));
  assign z03 = (~new_n52_ & ~x01) | (z06 & x12);
  assign new_n52_ = x04 & (~x18 | x19 | x02 | x00 | x17);
  assign z06 = x11 & ~x09 & x10 & x01 & x00 & x02;
  assign z04 = new_n46_ & x01 & x00 & x02 & ~x11 & ~x12;
  assign z05 = (~x01 & ~x04) | (x01 & x00 & x02 & x09 & x10);
  ...
  assign z09 = new_n62_ | (new_n66_ & (new_n65_ | (new_n63_ & new_n64_ & ~x15)));
