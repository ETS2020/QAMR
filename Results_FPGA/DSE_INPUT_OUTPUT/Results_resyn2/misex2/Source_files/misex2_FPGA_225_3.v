...
module FAU ( 
  ...
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n58_, new_n61_, new_n62_,
    ...
    new_n73_;
  assign z00 = ~x17 & ~x09 & x10 & new_n46_ & ~x18;
  assign new_n46_ = ~x00 & ~x01 & ~x02 & ~x19;
  assign z01 = new_n46_ & x09 & ~x18 & x10 & ~x17;
  assign z02 = ~x10 & ~x17 & new_n46_ & x09 & ~x18;
  assign z03 = ~x17 & (new_n50_ | (new_n51_ & x12 & ~x09 & x10));
  assign new_n50_ = x18 & ~x00 & ~x01 & ~x02 & ~x19;
  assign new_n51_ = x01 & x02 & x00 & x11;
  assign z04 = x00 & (x17 | (new_n53_ & ~x11 & x01 & x02));
  assign new_n53_ = ~x12 & ~x09 & x10;
  assign z05 = x00 & (x17 | (x01 & x02 & x09 & x10));
  assign z06 = new_n51_ & ~x17 & ~x09 & x10;
  assign z07 = x00 & (x17 | (x02 & (~x01 | (new_n53_ & x11))));
