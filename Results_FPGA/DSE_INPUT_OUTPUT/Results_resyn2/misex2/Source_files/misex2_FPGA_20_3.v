...
module FAU ( 
  ...
  assign z02 = new_n51_ & ~new_n46_ & new_n49_;
  assign new_n51_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (new_n53_ & x12) | new_n46_ | new_n54_;
  assign new_n53_ = x11 & ~x09 & x10 & x02 & x00 & x01;
  assign new_n54_ = ~x02 & ~x17 & ~x00 & ~x01 & x18 & ~x19;
  assign z04 = new_n56_ & x01 & ~x11 & ~x12 & ~x09 & x10;
  assign new_n56_ = x00 & x02 & (~x05 | ~x06);
  assign z05 = new_n56_ & x01 & x09 & x10;
  assign z06 = new_n46_ | new_n53_;
  assign z07 = new_n56_ & (~x01 | (~x12 & x11 & ~x09 & x10));
  ...
  assign new_n67_ = ~x00 & (~x05 | ~x06) & ~x21 & ~x22;
  assign z10 = ~new_n46_ & ~x00 & ((new_n65_ & new_n70_) | (new_n69_ & x22));
  assign new_n69_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n70_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign z11 = (new_n69_ | (new_n65_ & new_n72_)) & ~x22 & ~new_n46_ & ~x00;
  assign new_n72_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = new_n46_ | (x09 & ~x24 & (new_n74_ | new_n75_));
  assign new_n74_ = x00 & x01 & (~x02 | ~x10);
  assign new_n75_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign z13 = new_n46_ | (~x00 & ~x01 & x17 & ~x02 & ~x19);
  assign z14 = new_n46_ | (new_n51_ & ~x00 & ~x01 & ~x02 & ~x09);
