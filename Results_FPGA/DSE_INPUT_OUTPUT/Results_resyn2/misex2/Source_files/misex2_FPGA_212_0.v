...
module FAU ( 
  ...
  assign new_n46_ = ~x07 & ~x22;
  assign new_n47_ = ~x18 & ~x19 & ~x01 & ~x02 & ~x00 & ~x17;
  assign z01 = new_n49_ & x09 & x10 & ~x02 & ~x00 & ~x01;
  assign new_n49_ = ~x18 & ~x19 & ~x17 & (x07 | x22);
  assign z02 = new_n46_ | (new_n47_ & x09 & ~x10);
  assign z03 = ~new_n46_ & (new_n53_ | (new_n52_ & x12));
  assign new_n52_ = x11 & ~x09 & x10 & x02 & x00 & x01;
  assign new_n53_ = ~x01 & ~x02 & ~x00 & ~x17 & x18 & ~x19;
  assign z04 = new_n46_ | (new_n55_ & ~x11 & ~x12);
  assign new_n55_ = ~x09 & x10 & x02 & x00 & x01;
  assign z05 = x02 & x00 & x01 & ~new_n46_ & x09 & x10;
  ...
  assign new_n62_ = x19 & x22 & x17 & ~x18;
  assign z09 = ~x22 & (~x07 | (new_n67_ & (new_n66_ | (new_n64_ & new_n65_))));
  assign new_n64_ = ~x16 & x20 & ~x13 & ~x11 & x12;
  assign new_n65_ = ~x14 & ~x15 & ~x01 & x02;
  assign new_n66_ = x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = ~x00 & ~x21;
  assign z10 = ~x00 & ((new_n70_ & x22) | (new_n71_ & new_n69_ & new_n72_));
  assign new_n69_ = ~x13 & ~x11 & x12;
  assign new_n70_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n71_ = x07 & x16 & ~x22 & x20 & ~x21;
  assign new_n72_ = ~x14 & x15 & ~x01 & x02;
  assign z11 = ~x22 & (~x07 | (~x00 & (new_n70_ | (new_n64_ & new_n74_))));
  assign new_n74_ = ~x21 & ~x14 & x15 & ~x01 & x02;
  assign z12 = new_n46_ | ((new_n76_ | new_n77_) & x09 & ~x24);
