...
module FAU ( 
  ...
  assign new_n48_ = x10 & ~x19 & ~x17 & ~x18 & ~x02 & x09;
  ...
  assign new_n67_ = x01 & x18 & ~x00 & x21;
  ...
  assign z13 = new_n59_ & x17 & ~x02 & ~x19;
  assign z14 = ~x01 & (new_n77_ | x00);
  assign new_n77_ = ~x02 & ~x09 & ~x10 & ~x19 & ~x17 & ~x18;
  assign z15 = new_n73_ | (new_n46_ & x19);
  assign z16 = ~x00 ^ ~x01;
  assign z17 = new_n59_ & x02;
endmodule
