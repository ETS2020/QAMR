...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n54_, new_n58_, new_n60_,
    new_n61_, new_n63_, new_n64_, new_n65_, new_n66_, new_n68_, new_n69_,
    new_n71_, new_n73_, new_n74_;
  assign z00 = new_n46_ | (new_n47_ & new_n48_ & ~x02 & ~x17);
  assign new_n46_ = ~x05 & x09;
  assign new_n47_ = ~x00 & ~x01 & ~x18 & ~x19;
  assign new_n48_ = ~x09 & x10;
  assign z01 = new_n50_ & x10 & x05 & x09;
  assign new_n50_ = ~x17 & ~x18 & ~x19 & ~x02 & ~x00 & ~x01;
  assign z02 = x09 & (~x05 | (new_n47_ & ~x10 & ~x02 & ~x17));
  assign z03 = (z06 & x12) | (new_n54_ & ~x02 & ~x00 & ~x01);
  assign z06 = ~x09 & x10 & x00 & x01 & x02 & x11;
  assign new_n54_ = x18 & ~x19 & ~x17 & (x05 | ~x09);
  assign z04 = new_n48_ & x00 & x01 & ~x12 & x02 & ~x11;
  assign z05 = x10 & x05 & x09 & x01 & x00 & x02;
  assign z07 = ~new_n58_ & x00 & x02;
  assign new_n58_ = (x01 | (~x05 & x09)) & (x09 | ~x10 | ~x11 | x12);
  assign z08 = new_n60_ & new_n61_ & x02 & ~x00 & ~x01;
  assign new_n60_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign new_n61_ = ~x09 & x17 & ~x18 & x19;
  assign z09 = new_n66_ & (new_n63_ | (new_n64_ & new_n65_));
  assign new_n63_ = x18 & ~x19 & x01 & ~x20;
  assign new_n64_ = x02 & ~x11 & ~x13 & ~x01 & x12;
  assign new_n65_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = ~x21 & ~x22 & ~x00 & (x05 | ~x09);
  ...
  assign new_n74_ = ~x24 & x05 & x09;
  assign z13 = new_n46_ | (x17 & ~x19 & ~x02 & ~x00 & ~x01);
  assign z14 = new_n50_ & ~x09 & ~x10;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | new_n46_ | (~x01 & ~x02 & x19);
  assign z16 = x01 & ~new_n46_ & ~x00;
