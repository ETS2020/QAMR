...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n50_, new_n52_, new_n54_, new_n59_, new_n61_,
  ...
  assign new_n49_ = ~x02 & ~x19;
  assign new_n50_ = ~x00 & ~x01;
  assign z03 = (x00 & (new_n52_ | ~x01)) | (new_n49_ & ~x01 & ~x17 & x18);
  assign new_n52_ = x12 & ~x09 & x11 & x02 & x10;
  assign z04 = ~x09 & ~x11 & ~x12 & new_n54_ & x00 & x01;
  assign new_n54_ = x02 & x10;
  assign z05 = x00 & (~x01 | (new_n54_ & x09));
  assign z06 = x00 & (~x01 | (new_n54_ & ~x09 & x11));
  assign z07 = x00 & (~x01 | (new_n54_ & ~x09 & x11 & ~x12));
  assign z08 = new_n59_ & new_n50_ & x02 & x19 & x17 & ~x18;
  assign new_n59_ = ~x03 & x04 & ~x07 & ~x08 & ~x05 & ~x06;
  assign z09 = (~x01 & (x00 | (new_n61_ & new_n63_))) | (new_n64_ & new_n62_ & ~x00);
  assign new_n61_ = x02 & ~x11 & ~x14 & x12 & ~x13;
  assign new_n62_ = ~x21 & ~x22;
  assign new_n63_ = ~x16 & x20 & ~x15 & ~x21 & ~x22;
  assign new_n64_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = (~x01 & (x00 | (new_n61_ & new_n66_))) | (new_n67_ & ~x00 & x22);
  assign new_n66_ = ~x21 & ~x22 & x20 & x15 & x16;
  assign new_n67_ = ~x19 & ~x20 & x21 & x01 & x18;
  assign z11 = ~x00 & ~x22 & (new_n67_ | (new_n61_ & new_n69_));
  assign new_n69_ = ~x16 & x20 & ~x21 & ~x01 & x15;
  assign z12 = (new_n71_ | (~new_n54_ & x00 & x01)) & x09 & ~x24;
  assign new_n71_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign z13 = new_n50_ & new_n49_ & x17;
