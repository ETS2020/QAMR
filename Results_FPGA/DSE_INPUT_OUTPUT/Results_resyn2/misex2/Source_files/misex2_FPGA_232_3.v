...
module FAU ( 
  ...
  assign z03 = new_n50_ | (x01 & x00 & ~x21 & new_n51_ & x12);
  assign new_n50_ = ~x00 & ~x01 & ~x02 & ~x17 & x18 & ~x19;
  assign new_n51_ = ~x09 & x10 & x02 & x11;
  assign z04 = x01 & (x21 | (new_n53_ & ~x11 & x00 & x02));
  assign new_n53_ = ~x12 & ~x09 & x10;
  assign z05 = x01 & x00 & ~x21 & x09 & x02 & x10;
  assign z06 = x01 & (x21 | (new_n51_ & x00));
  assign z07 = x00 & x02 & (~x01 | (new_n53_ & x11 & ~x21));
  assign z08 = new_n58_ & z17 & x19 & x17 & ~x18;
  assign new_n58_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = new_n63_ & (new_n62_ | (new_n61_ & ~x15 & ~x16 & x20));
  assign new_n61_ = x12 & ~x13 & ~x01 & x02 & ~x11 & ~x14;
  assign new_n62_ = x18 & ~x19 & x01 & ~x20;
  assign new_n63_ = ~x22 & ~x00 & ~x21;
  assign z10 = new_n65_ | (new_n66_ & new_n67_ & x16 & ~x14 & x15);
  assign new_n65_ = x01 & x21;
  assign new_n66_ = x02 & ~x00 & ~x01 & ~x11 & x12 & ~x13;
  assign new_n67_ = ~x22 & x20 & ~x21;
  assign z11 = new_n65_ | (new_n66_ & new_n67_ & ~x16 & ~x14 & x15);
  assign z12 = new_n65_ | (x09 & ~x24 & (new_n70_ | new_n71_));
  assign new_n70_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign new_n71_ = x00 & x01 & (~x02 | ~x10);
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = new_n65_ | (new_n46_ & ~x09 & ~x10 & ~x18 & ~x19);
  assign z15 = (~x10 & x01 & x00 & ~x21) | ((~x01 | (x00 & ~x21)) & ~x02 & (x00 | x19));
