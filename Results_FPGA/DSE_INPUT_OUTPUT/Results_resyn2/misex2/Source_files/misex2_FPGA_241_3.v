...
module FAU ( 
  ...
  assign z00 = (x01 & x24) | (new_n47_ & new_n46_ & ~x09);
  ...
  assign z03 = (new_n46_ & new_n53_) | (x01 & (new_n52_ | x24));
  assign new_n52_ = ~x09 & x00 & x02 & x12 & x10 & x11;
  assign new_n53_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (x24 | (new_n55_ & ~x12 & x10 & ~x11));
  assign new_n55_ = ~x09 & x00 & x02;
  assign z05 = x01 & (x24 | (x00 & x02 & x09 & x10));
  assign z06 = new_n55_ & x10 & x11 & x01 & ~x24;
  assign z07 = ~new_n59_ & x00 & x02;
  assign new_n59_ = x01 & (x09 | ~x10 | x24 | ~x11 | x12);
  ...
  assign new_n64_ = x01 & ~x24 & ~x20 & x18 & ~x19;
  assign new_n65_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = (x01 & x24) | (~x00 & (new_n69_ | (new_n65_ & new_n68_)));
  assign new_n68_ = x20 & ~x21 & ~x14 & x15 & x16 & ~x22;
  assign new_n69_ = x01 & x18 & ~x19 & x22 & ~x20 & x21;
  assign z11 = (new_n72_ | (new_n65_ & new_n71_)) & ~x00 & ~x22;
  assign new_n71_ = ~x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n72_ = x01 & x18 & ~x19 & ~x24 & ~x20 & x21;
  assign z12 = new_n75_ & ((~new_n74_ & ~x00 & ~x01) | (x00 & x01 & (~x02 | ~x10)));
  assign new_n74_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign new_n75_ = x09 & ~x24;
  assign z13 = (x01 & x24) | (~x00 & ~x01 & x17 & ~x02 & ~x19);
  assign z14 = (x01 & x24) | (new_n50_ & new_n46_ & ~x09);
  assign z15 = ((~x01 | (x00 & ~x24)) & ~x02 & (x00 | x19)) | (x00 & ~x10 & x01 & ~x24);
