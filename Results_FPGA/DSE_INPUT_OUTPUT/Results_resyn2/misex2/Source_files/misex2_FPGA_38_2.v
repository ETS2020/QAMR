...
module FAU ( 
  ...
  assign z03 = new_n53_ | (~new_n52_ & x00);
  assign new_n52_ = x01 & (~x12 | ~x02 | ~x10 | x09 | ~x11);
  ...
  assign z06 = new_n55_ & ~x09 & x11 & x00 & x01;
  assign z07 = x00 & (~x01 | (~x12 & new_n55_ & ~x09 & x11));
  ...
  assign z10 = (~x01 & (x00 | (new_n63_ & new_n67_))) | (new_n68_ & new_n69_);
  assign new_n67_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n68_ = x21 & ~x19 & ~x20;
  assign new_n69_ = x22 & x18 & ~x00 & x01;
  assign z11 = (new_n68_ & new_n72_) | (~x01 & (x00 | (new_n63_ & new_n71_)));
  assign new_n71_ = x15 & ~x16 & x20 & ~x21 & ~x22;
  assign new_n72_ = ~x22 & x18 & ~x00 & x01;
  assign z12 = (x00 & ~x01) | (((~new_n55_ & x00) | (~new_n74_ & ~x01)) & x09 & ~x24);
