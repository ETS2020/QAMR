// Benchmark "FAU" written by ABC on Wed Aug 12 18:02:19 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n49_, new_n52_, new_n53_, new_n54_, new_n60_,
  ...
  assign new_n46_ = x22 & x23;
  assign new_n47_ = ~x17 & ~x18 & ~x02 & ~x19 & ~x00 & ~x01;
  assign z01 = new_n49_ & ~new_n46_ & ~x19 & ~x02 & x09 & x10;
  assign new_n49_ = ~x00 & ~x01 & ~x17 & ~x18;
  assign z02 = new_n46_ | (new_n47_ & x09 & ~x10);
  assign z03 = ~new_n46_ & (new_n54_ | (new_n52_ & new_n53_ & x12));
  assign new_n52_ = x02 & x00 & x01;
  assign new_n53_ = x11 & ~x09 & x10;
  assign new_n54_ = x18 & ~x19 & ~x01 & ~x02 & ~x00 & ~x17;
  assign z04 = new_n46_ | (new_n52_ & ~x09 & x10 & ~x11 & ~x12);
  ...
  assign new_n60_ = ~x03 & x04 & (~x22 | ~x23);
  ...
  assign new_n64_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n65_ = ~x16 & x20 & ~x14 & ~x15;
  assign new_n66_ = ~x00 & ~x22;
  assign z10 = (x22 & x23) | (~x00 & ((new_n68_ & x22) | (new_n64_ & new_n69_)));
  ...
  assign z12 = new_n77_ & (new_n74_ | (~new_n75_ & ~new_n76_ & ~new_n46_ & new_n73_));
  assign new_n73_ = ~x00 & ~x01;
  assign new_n74_ = (~x02 | ~x10) & x00 & x01 & (~x22 | ~x23);
  assign new_n75_ = ~x23 & (x02 | x19);
  assign new_n76_ = ~x17 & ~x02 & ~x19;
  assign new_n77_ = x09 & ~x24;
  assign z13 = new_n73_ & ~x02 & x17 & ~new_n46_ & ~x19;
  assign z14 = new_n49_ & ~new_n46_ & ~x19 & ~x10 & ~x02 & ~x09;
