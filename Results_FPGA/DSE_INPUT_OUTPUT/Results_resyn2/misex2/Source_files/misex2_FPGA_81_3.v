...
module FAU ( 
  ...
  assign z09 = (new_n58_ | (new_n56_ & new_n57_)) & ~x21 & ~x00 & ~x22;
  assign new_n56_ = ~x13 & ~x11 & x12 & ~x16 & x20;
  assign new_n57_ = ~x14 & ~x15 & ~x01 & x02;
  assign new_n58_ = x18 & ~x19 & x01 & ~x20;
  assign z10 = (x01 & (new_n61_ | x00)) | (new_n62_ & new_n60_ & ~x00 & ~x01 & x02);
  assign new_n60_ = ~x13 & ~x11 & x12;
  assign new_n61_ = x22 & x18 & ~x19 & ~x20 & x21;
  assign new_n62_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign z11 = (new_n65_ | (new_n56_ & new_n64_)) & ~x00 & ~x22;
  assign new_n64_ = ~x14 & x15 & ~x21 & ~x01 & x02;
  assign new_n65_ = x01 & ~x20 & x21 & x18 & ~x19;
  assign z12 = new_n67_ & ((~x02 & ~x19) ? x17 : x23);
  assign new_n67_ = x09 & ~x24 & ~x00 & ~x01;
