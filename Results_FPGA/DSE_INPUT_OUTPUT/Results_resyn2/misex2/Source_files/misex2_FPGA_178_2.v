...
module FAU ( 
  ...
  assign z03 = new_n52_ | (new_n51_ & x12 & x16 & x00 & x01);
  assign new_n51_ = x02 & ~x09 & x10 & x11;
  assign new_n52_ = ~x02 & ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign z04 = x01 & (new_n54_ | ~x16);
  assign new_n54_ = x02 & ~x09 & x00 & x10 & ~x11 & ~x12;
  assign z05 = x01 & (~x16 | (x00 & x09 & x02 & x10));
  assign z06 = x01 & (~x16 | (new_n51_ & x00));
  assign z07 = (x01 & ~x16) | ((new_n58_ | ~x01) & x00 & x02);
  assign new_n58_ = x10 & x11 & ~x09 & ~x12;
  assign z08 = new_n60_ | (new_n61_ & z17 & x19 & x17 & ~x18);
  assign new_n60_ = x01 & ~x16;
  assign new_n61_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = new_n60_ | (new_n67_ & ~x21 & (new_n64_ | (new_n65_ & new_n66_)));
  assign new_n64_ = x18 & ~x19 & x01 & ~x20;
  assign new_n65_ = x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n67_ = ~x00 & ~x22;
  assign z10 = new_n60_ | (~x00 & (new_n69_ | (new_n70_ & new_n71_)));
  assign new_n69_ = x18 & ~x19 & x01 & ~x20 & x21 & x22;
  assign new_n70_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n71_ = x16 & ~x22 & x20 & ~x21 & ~x14 & x15;
  assign z11 = new_n67_ & ((new_n70_ & new_n73_ & ~x16) | (new_n64_ & x16 & x21));
  assign new_n73_ = ~x14 & x15 & x20 & ~x21;
  assign z12 = (new_n75_ | new_n76_) & x09 & ~x24;
  assign new_n75_ = (~x02 | ~x10) & x16 & x00 & x01;
