...
module FAU ( 
  ...
  assign z08 = ~x01 & (x08 | (new_n61_ & new_n62_));
  assign new_n61_ = ~x07 & x17 & ~x18 & x19;
  assign new_n62_ = ~x00 & x02 & ~x03 & x04 & ~x05 & ~x06;
  assign z09 = (new_n64_ | (new_n65_ & new_n66_)) & ~x21 & ~x00 & ~x22;
  assign new_n64_ = x18 & ~x19 & x01 & ~x20;
  assign new_n65_ = ~x08 & ~x01 & x02 & ~x11 & x12;
  assign new_n66_ = ~x13 & ~x14 & x20 & ~x15 & ~x16;
  assign z10 = new_n57_ | (~x00 & (new_n69_ | (new_n70_ & new_n68_ & new_n71_)));
  ...
  assign z12 = new_n57_ | ((new_n75_ | new_n76_) & x09 & ~x24);
