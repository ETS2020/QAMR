...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n50_, new_n53_, new_n55_, new_n57_, new_n60_,
  ...
  assign z02 = ~x01 & (x00 | (new_n50_ & x09));
  ...
  assign new_n55_ = x00 & x01 & x02 & ~x09 & x10;
  assign z05 = x00 & (~x01 | (new_n57_ & x09));
  assign new_n57_ = x02 & x10;
  assign z07 = x00 & (~x01 | (new_n57_ & ~x12 & ~x09 & x11));
  ...
  assign z12 = x09 & ~x24 & (new_n71_ | (~new_n57_ & x00 & x01));
  assign new_n71_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = ~x01 & (x00 | (new_n50_ & ~x09));
