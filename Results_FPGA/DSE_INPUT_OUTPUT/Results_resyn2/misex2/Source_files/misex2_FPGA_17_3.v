...
module FAU ( 
  ...
  assign z01 = x10 & new_n47_ & x09;
  assign z02 = new_n46_ | (~x10 & new_n47_ & x09);
  assign z03 = (x01 & (x24 | (new_n51_ & x00 & x02))) | (new_n52_ & ~x02 & ~x00 & ~x01);
  assign new_n51_ = ~x09 & x10 & x11 & x12;
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign z04 = new_n54_ & ~x11 & ~x12;
  assign new_n54_ = x01 & x00 & x02 & ~x24 & ~x09 & x10;
  assign z05 = x01 & x00 & x02 & new_n56_ & x10;
  assign new_n56_ = x09 & ~x24;
  assign z06 = new_n54_ & x11;
  assign z07 = (x01 & x24) | (x00 & x02 & (new_n59_ | ~x01));
  assign new_n59_ = ~x09 & x10 & x11 & ~x12;
  assign z08 = (x01 & x24) | (new_n61_ & new_n62_ & ~x00 & ~x01 & x02);
  ...
  assign z12 = new_n56_ & ((~new_n74_ & ~x00 & ~x01) | (x00 & x01 & (~x02 | ~x10)));
