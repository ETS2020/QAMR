...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n49_, new_n52_, new_n55_, new_n58_, new_n60_,
    new_n61_, new_n62_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_,
    new_n73_, new_n74_;
  assign z00 = ~x01 & (~x15 | (new_n46_ & ~x17 & ~x09 & x10));
  assign new_n46_ = ~x18 & ~x19 & ~x00 & ~x02;
  assign z01 = x09 & x10 & new_n49_ & new_n48_ & x15 & ~x17;
  ...
  assign z04 = (~x01 & ~x15) | (new_n55_ & ~x11 & ~x12);
  assign new_n55_ = ~x09 & x10 & x02 & x00 & x01;
  assign z05 = (~x01 & ~x15) | (x02 & x00 & x01 & x09 & x10);
  assign z07 = (~x01 & ~x15) | (x00 & x02 & (new_n58_ | ~x01));
  assign new_n58_ = x11 & ~x12 & ~x09 & x10;
  assign z08 = ~x01 & (~x15 | (new_n60_ & new_n61_ & new_n62_));
  ...
  assign z16 = ~x00 & x01;
  assign z10 = ~x00 & ((new_n66_ & new_n67_) | (new_n68_ & x22));
  assign new_n66_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n67_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n68_ = ~x20 & x18 & ~x19 & x01 & x21;
  assign z11 = (new_n68_ | (new_n66_ & new_n70_)) & ~x00 & ~x22;
  assign new_n70_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = new_n74_ & ((~new_n72_ & x00 & x01) | (new_n73_ & x15 & ~x00 & ~x01));
  assign new_n72_ = x02 & x10;
  assign new_n73_ = (~x02 & ~x19) ? x17 : x23;
  assign new_n74_ = x09 & ~x24;
  assign z13 = new_n49_ & ~x19 & x15 & x17;
  assign z14 = ~x09 & ~x10 & new_n49_ & new_n48_ & x15 & ~x17;
