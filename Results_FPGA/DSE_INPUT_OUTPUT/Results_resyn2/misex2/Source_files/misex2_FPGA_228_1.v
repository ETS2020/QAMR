...
module FAU ( 
  ...
  assign new_n46_ = ~x19 & ~x17 & ~x18 & x10 & ~x13;
  assign z01 = ~x01 & (x13 | (new_n48_ & ~x19 & ~x17 & ~x18));
  assign new_n48_ = ~x00 & ~x02 & x09 & x10;
  assign z02 = new_n50_ & x09 & ~x02 & ~x00 & ~x01;
  assign new_n50_ = ~x19 & ~x17 & ~x18 & ~x10 & ~x13;
  assign z03 = (~new_n52_ & ~x01) | (new_n53_ & x12);
  assign new_n52_ = ~x13 & (~x18 | x19 | x17 | x00 | x02);
  assign new_n53_ = x00 & x02 & x10 & x11 & x01 & ~x09;
  assign z04 = ~x12 & x01 & ~x09 & new_n55_ & x10 & ~x11;
  assign new_n55_ = x00 & x02;
  assign z05 = (~x01 & x13) | (new_n55_ & x01 & x09 & x10);
  assign z06 = new_n53_ | (~x01 & x13);
  assign z07 = new_n55_ & ~new_n59_;
  assign new_n59_ = (x01 | x13) & (~x10 | ~x11 | x12 | ~x01 | x09);
  assign z08 = new_n61_ & new_n62_ & x19 & x17 & ~x18;
  assign new_n61_ = ~x00 & ~x01 & x04 & ~x05 & x02 & ~x03;
  assign new_n62_ = ~x08 & ~x13 & ~x06 & ~x07;
  assign z09 = (new_n64_ | (new_n65_ & new_n66_)) & ~x21 & ~x00 & ~x22;
  assign new_n64_ = x18 & ~x19 & x01 & ~x20;
  assign new_n65_ = ~x01 & ~x13 & x12 & x02 & ~x11;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((new_n68_ & x22) | (x16 & ~x22 & new_n65_ & new_n69_));
  assign new_n68_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n69_ = x20 & ~x21 & ~x14 & x15;
  assign z11 = ~x00 & ~x22 & (new_n68_ | (~x16 & new_n65_ & new_n69_));
  assign z12 = (~x01 & x13) | ((new_n72_ | new_n73_) & x09 & ~x24);
  assign new_n72_ = (~x02 | ~x10) & x00 & x01;
  assign new_n73_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign z13 = ~x02 & ~x00 & ~x01 & ~x19 & ~x13 & x17;
