...
module FAU ( 
  ...
  assign z05 = new_n48_ | (x09 & x00 & x01 & x02 & x10);
  assign z06 = new_n48_ | (new_n52_ & new_n53_);
  assign z07 = new_n48_ | ((~x01 | (new_n53_ & ~x12)) & x00 & x02);
  ...
  assign new_n64_ = x01 & ~x20 & x18 & ~x19 & (x13 | x24);
  assign new_n65_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n66_ = ~x14 & ~x15 & x24 & ~x16 & x20;
  assign z10 = new_n48_ | (~x00 & (new_n69_ | (new_n65_ & new_n68_)));
  assign new_n68_ = ~x21 & ~x14 & x15 & ~x22 & x16 & x20;
  assign new_n69_ = x01 & ~x20 & x18 & ~x19 & x21 & x22;
  assign z11 = ~x00 & ~x22 & ((new_n65_ & new_n71_) | (new_n64_ & x21));
  assign new_n71_ = ~x21 & ~x14 & x15 & x24 & ~x16 & x20;
  assign z12 = new_n74_ & ((x00 & x01 & (~x02 | ~x10)) | (~new_n73_ & ~x00 & ~x01));
  assign new_n73_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign new_n74_ = ~x24 & x09 & x13;
