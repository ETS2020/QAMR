...
module FAU ( 
  ...
  assign new_n46_ = ~x19 & ~x17 & ~x18 & x10 & ~x02 & ~x09;
  assign z01 = ~x00 & (x01 | (new_n48_ & x10));
  assign new_n48_ = ~x19 & ~x17 & ~x18 & ~x02 & x09;
  assign z02 = ~x00 & (x01 | (new_n48_ & ~x10));
  assign z03 = (z06 & x12) | (new_n52_ & ~x17 & x18);
  assign z06 = ~x09 & x11 & x02 & x10 & x00 & x01;
  assign new_n52_ = ~x00 & ~x01 & ~x02 & ~x19;
  assign z04 = x01 & (~x00 | (x02 & ~x11 & new_n54_ & ~x09));
  assign new_n54_ = x10 & ~x12;
  assign z05 = x09 & new_n56_ & x00 & x01;
  assign new_n56_ = x02 & x10;
  assign z07 = (~x00 & x01) | ((~x01 | (new_n54_ & ~x09 & x11)) & x00 & x02);
  ...
  assign new_n63_ = ~x14 & x02 & ~x11 & ~x15 & x12 & ~x13;
  assign z10 = new_n66_ & new_n65_ & ~x14 & x02 & ~x11;
  assign new_n65_ = x12 & ~x13 & x15 & ~x00 & ~x01;
  assign new_n66_ = x16 & ~x22 & x20 & ~x21;
  assign z11 = new_n62_ & new_n65_ & ~x14 & x02 & ~x11;
  assign z12 = (~x00 & x01) | (((~new_n56_ & x01) | (~new_n69_ & ~x00)) & x09 & ~x24);
  assign new_n69_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = ~x00 & (x01 | (x17 & ~x02 & ~x19));
  assign z14 = new_n52_ & ~x17 & ~x18 & ~x09 & ~x10;
