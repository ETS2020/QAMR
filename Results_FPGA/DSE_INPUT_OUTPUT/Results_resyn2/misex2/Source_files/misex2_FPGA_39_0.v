...
module FAU ( 
  ...
  assign new_n48_ = x09 & ~x00 & ~x02 & ~x01 & x08;
  ...
  assign z09 = new_n60_ | (new_n64_ & ~x21 & (new_n63_ | (new_n61_ & new_n62_)));
  ...
  assign new_n68_ = x08 & x16 & ~x22 & x20 & ~x21;
  assign new_n69_ = ~x01 & x02 & ~x14 & x15;
  assign z11 = new_n60_ | (new_n64_ & ((new_n63_ & x21) | (new_n61_ & new_n69_ & ~x21)));
  assign z12 = new_n60_ | ((new_n72_ | new_n73_) & x09 & ~x24);
  assign new_n72_ = x00 & x01 & (~x02 | ~x10);
  assign new_n73_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign z13 = ~x00 & ~x02 & ~x01 & x08 & x17 & ~x19;
