...
module FAU ( 
  ...
  assign z01 = z04 | (new_n49_ & ~x02 & ~x17 & x09 & x10);
  assign z04 = x00 & x01;
  assign new_n49_ = ~x00 & ~x01 & ~x18 & ~x19;
  assign z02 = ~x19 & ~x17 & ~x18 & new_n46_ & x09 & ~x10;
  assign z03 = z04 | (new_n46_ & ~x17 & x18 & ~x19);
  ...
  assign z12 = (x00 & x01) | (~new_n68_ & x09 & ~x24 & ~x00 & ~x01);
  assign new_n68_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = z04 | (new_n49_ & ~x09 & ~x10 & ~x02 & ~x17);
