...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n50_, new_n52_, new_n53_, new_n55_, new_n59_,
    ...
    new_n70_, new_n72_, new_n74_, new_n75_, new_n78_;
  ...
  assign z09 = (~x15 & x21) | (new_n64_ & (new_n67_ | (new_n65_ & new_n66_ & ~x15)));
  assign new_n64_ = ~x00 & ~x22;
  assign new_n65_ = ~x01 & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n66_ = ~x16 & x20;
  assign new_n67_ = ~x19 & ~x20 & ~x21 & x01 & x18;
  assign z10 = (new_n70_ | (new_n65_ & new_n69_)) & ~x00 & x15;
  assign new_n69_ = ~x21 & ~x22 & x16 & x20;
  assign new_n70_ = ~x19 & ~x20 & x01 & x18 & x21 & x22;
  assign z11 = ((new_n72_ & x21) | (new_n65_ & new_n66_ & ~x21)) & new_n64_ & x15;
  assign new_n72_ = ~x19 & ~x20 & x01 & x18;
  assign z12 = new_n75_ & ((x00 & x01 & (~x02 | ~x10)) | (~new_n74_ & ~x00 & ~x01));
  assign new_n74_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign new_n75_ = (x15 | ~x21) & x09 & ~x24;
  assign z13 = new_n50_ | (~x00 & ~x01 & x17 & ~x02 & ~x19);
  assign z14 = new_n78_ & ~x00 & ~x01 & ~x02 & ~x09 & ~x10;
  assign new_n78_ = (x15 | ~x21) & ~x19 & ~x17 & ~x18;
