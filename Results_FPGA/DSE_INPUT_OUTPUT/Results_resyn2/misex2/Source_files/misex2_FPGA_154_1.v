...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n50_, new_n52_, new_n53_, new_n55_, new_n59_,
    new_n61_, new_n62_, new_n64_, new_n65_, new_n68_, new_n70_;
  ...
  assign z07 = (new_n59_ | ~x00 | ~x01) & (x00 | x01) & (~x00 | x02);
  assign new_n59_ = x11 & ~x12 & ~x09 & x10;
  assign z08 = new_n62_ & new_n61_ & x02 & x19 & x17 & ~x18;
  assign new_n61_ = ~x00 & ~x01;
  assign new_n62_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z09 = ~x00 & (x01 | (new_n64_ & new_n65_ & ~x15 & ~x16));
  assign new_n64_ = ~x13 & ~x14 & x12 & x02 & ~x11;
  assign new_n65_ = ~x22 & x20 & ~x21;
  assign z10 = ~x00 & (x01 | (new_n64_ & new_n65_ & x15 & x16));
  assign z11 = new_n68_ & new_n65_ & new_n61_ & x02;
  assign new_n68_ = ~x13 & ~x14 & ~x11 & x12 & x15 & ~x16;
  assign z12 = (new_n70_ | (new_n55_ & (~x02 | ~x10))) & x09 & ~x24;
