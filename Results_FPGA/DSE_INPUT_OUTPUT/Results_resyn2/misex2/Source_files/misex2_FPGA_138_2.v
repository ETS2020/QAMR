...
module FAU ( 
  ...
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n58_, new_n59_, new_n61_,
    ...
    new_n72_, new_n73_;
  assign z00 = ~x09 & ~x02 & ~x00 & ~x01 & new_n46_ & x10;
  assign new_n46_ = ~x19 & ~x17 & ~x18;
  assign z01 = ~x01 & (x00 | (new_n46_ & ~x02 & x09 & x10));
  assign z02 = new_n46_ & ~x10 & x09 & ~x02 & ~x00 & ~x01;
  assign z03 = new_n51_ | (x00 & (~x01 | (new_n50_ & x12)));
  assign new_n50_ = x02 & x10 & ~x09 & x11;
  assign new_n51_ = ~x02 & ~x19 & x18 & ~x01 & ~x17;
  assign z04 = new_n53_ & x02 & x00 & x01;
  assign new_n53_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x09 & x10 & x02 & x00 & x01;
  assign z06 = x00 & (new_n50_ | ~x01);
  assign z07 = x00 & (~x01 | (new_n50_ & ~x12));
  ...
  assign z12 = (x00 & ~x01) | (new_n73_ & ((x00 & (~x02 | ~x10)) | (~new_n72_ & ~x01)));
  assign new_n72_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign new_n73_ = x09 & ~x24;
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = ~x09 & ~x02 & ~x00 & ~x01 & new_n46_ & ~x10;
