...
module FAU ( 
  ...
  assign z03 = new_n52_ | (x01 & x00 & ~x23 & new_n51_ & x12);
  ...
  assign z06 = x01 & (x23 | (new_n51_ & x00));
  ...
  assign new_n65_ = x01 & x18 & ~x23 & ~x19 & ~x20;
  assign z10 = ~x00 & ((new_n67_ & x22) | (new_n63_ & new_n68_ & x16 & ~x22));
  assign new_n67_ = x18 & ~x19 & x21 & ~x23 & x01 & ~x20;
  ...
  assign new_n71_ = (x02 | x19 | (~x01 & x17)) & ~x00 & (x23 | (~x02 & ~x19));
