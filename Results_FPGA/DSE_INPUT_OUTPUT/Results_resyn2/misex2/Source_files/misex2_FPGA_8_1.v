...
module FAU ( 
  ...
  assign z05 = x01 & (~x00 | (new_n54_ & x09));
  assign z06 = x11 & new_n54_ & ~x09 & x00 & x01;
  ...
  assign z09 = new_n63_ & ~x00 & ~x01 & new_n64_ & ~x15;
  assign new_n63_ = x02 & ~x11 & ~x14 & x12 & ~x13;
  assign new_n64_ = ~x16 & ~x22 & x20 & ~x21;
  assign z10 = new_n66_ & new_n63_ & ~x00 & ~x01;
  assign new_n66_ = x15 & x16 & ~x22 & x20 & ~x21;
  assign z11 = ~x00 & (x01 | (new_n63_ & new_n64_ & x15));
  assign z12 = (~x00 & x01) | ((new_n69_ | (~new_n54_ & x01)) & x09 & ~x24);
