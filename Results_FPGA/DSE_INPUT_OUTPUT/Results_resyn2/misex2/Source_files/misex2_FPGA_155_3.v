...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n53_, new_n58_, new_n60_,
  ...
  assign new_n51_ = ~x09 & x02 & x10;
  assign new_n52_ = x00 & x01 & x11 & ~x22;
  assign new_n53_ = ~x19 & ~x02 & ~x00 & ~x01 & ~x17 & x18;
  assign z04 = ~x22 & x00 & x01 & new_n51_ & ~x11 & ~x12;
  assign z05 = x01 & (x22 | (x00 & x02 & x09 & x10));
  assign z06 = new_n51_ & new_n52_;
  assign z07 = ~new_n58_ & x00 & x02;
  assign new_n58_ = x01 & (~x11 | x22 | x12 | x09 | ~x10);
  assign z08 = (x01 & x22) | (new_n60_ & new_n61_ & ~x00 & ~x01 & x02);
  assign new_n60_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign new_n61_ = x19 & x17 & ~x18;
  assign z09 = (x01 & x22) | (new_n66_ & (new_n63_ | (new_n64_ & new_n65_)));
  assign new_n63_ = x01 & x18 & ~x19 & ~x20;
  assign new_n64_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n65_ = ~x16 & x20 & ~x22 & ~x14 & ~x15;
  assign new_n66_ = ~x00 & ~x21;
  assign z10 = new_n64_ & new_n68_ & ~x22 & x16 & x20;
  assign new_n68_ = ~x14 & x15 & ~x00 & ~x21;
  assign z11 = ((new_n64_ & new_n70_) | (new_n63_ & x21)) & ~x00 & ~x22;
  assign new_n70_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = (new_n72_ | new_n73_) & x09 & ~x24;
  assign new_n72_ = (~x02 | ~x10) & ~x22 & x00 & x01;
