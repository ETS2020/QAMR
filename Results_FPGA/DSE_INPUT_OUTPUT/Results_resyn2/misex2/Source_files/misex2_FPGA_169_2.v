...
module FAU ( 
  ...
  assign z03 = new_n51_ | (new_n52_ & x12 & x01 & x04);
  assign new_n51_ = ~x17 & ~x02 & ~x19 & x18 & ~x00 & ~x01;
  assign new_n52_ = x00 & x02 & x11 & ~x09 & x10;
  assign z04 = new_n54_ & ~x09 & x10 & ~x11 & ~x12;
  assign new_n54_ = x01 & x04 & x00 & x02;
  assign z05 = new_n54_ & x09 & x10;
  assign z06 = x01 & (new_n52_ | ~x04);
  assign z07 = ~new_n58_ & x00 & x02;
  assign new_n58_ = x01 & (~x04 | x09 | x12 | ~x10 | ~x11);
  assign z08 = (x01 & ~x04) | (new_n60_ & new_n61_ & ~x00 & ~x01 & x02);
  ...
  assign z10 = ~x00 & ((new_n65_ & new_n70_) | (new_n69_ & x04 & x22));
  ...
  assign z17 = (x01 & ~x04) | (~x00 & ~x01 & x02);
endmodule
