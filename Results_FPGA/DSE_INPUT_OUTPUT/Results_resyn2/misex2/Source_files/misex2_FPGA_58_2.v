...
module FAU ( 
  ...
  assign z12 = (x00 & ~x01) | (x09 & ~x24 & ((~new_n54_ & x00) | (~new_n70_ & ~x01)));
  assign new_n70_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = ~x01 & (x00 | (x17 & ~x02 & ~x19));
  assign z14 = ~x01 & (new_n73_ | x00);
  assign new_n73_ = ~x02 & ~x09 & ~x10 & ~x19 & ~x17 & ~x18;
  assign z15 = (x19 & ~x01 & ~x00 & ~x02) | (x00 & x01 & (~x02 | ~x10));
  assign z16 = ~x00 & x01;
