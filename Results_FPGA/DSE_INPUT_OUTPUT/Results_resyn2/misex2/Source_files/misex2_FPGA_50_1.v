...
module FAU ( 
  ...
  assign z01 = new_n49_ & x10 & ~x17 & new_n47_ & ~x22;
  assign new_n49_ = ~x00 & ~x01 & ~x02 & x09;
  assign z02 = new_n49_ & new_n47_ & ~x22 & ~x10 & ~x17;
  assign z03 = (new_n52_ & x12) | (new_n53_ & ~x17 & x18 & ~x19);
  assign new_n52_ = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign new_n53_ = ~x00 & ~x22 & ~x01 & ~x02;
  ...
  assign z08 = new_n61_ & new_n62_ & ~x18 & ~x08 & x17;
  assign new_n61_ = x19 & ~x22 & ~x00 & ~x03 & ~x01 & x02;
  ...
  assign new_n68_ = ~x21 & ~x14 & x15 & x16 & x20;
  ...
  assign new_n74_ = ~x23 & (x02 | x19);
  assign new_n75_ = (x17 | x02 | x19) & ~x22 & ~x00 & ~x01;
  assign z13 = new_n53_ & x17 & ~x19;
  assign z14 = ~x01 & (x22 | (new_n46_ & new_n47_ & ~x10 & ~x17));
  assign z15 = (x19 & ~x22 & ~x01 & ~x02) | ((~x02 | (x01 & ~x10)) & x00 & (x01 | ~x22));
  assign z16 = ~x00 & x01;
  assign z17 = ~x00 & ~x22 & ~x01 & x02;
endmodule
