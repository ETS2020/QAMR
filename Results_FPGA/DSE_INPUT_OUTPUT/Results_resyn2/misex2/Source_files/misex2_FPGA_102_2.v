...
module FAU ( 
  ...
  assign z00 = ~x01 & (x00 | (~x09 & x10 & new_n46_ & new_n47_));
  assign new_n46_ = ~x17 & ~x18;
  assign new_n47_ = ~x02 & ~x19;
  assign z01 = new_n49_ & x09 & x10;
  assign new_n49_ = ~x00 & ~x01 & ~x17 & ~x18 & ~x02 & ~x19;
  assign z02 = ~x01 & (x00 | (new_n46_ & new_n47_ & x09 & ~x10));
  assign z03 = new_n53_ | (x00 & (~x01 | (new_n52_ & x12)));
  assign new_n52_ = ~x09 & x10 & x02 & x11;
  assign new_n53_ = x18 & ~x19 & ~x17 & ~x01 & ~x02;
  assign z04 = x00 & (~x01 | (new_n55_ & ~x12 & ~x09 & ~x11));
  ...
  assign z13 = ~x01 & (x00 | (new_n47_ & x17));
