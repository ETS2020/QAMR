...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n48_, new_n52_, new_n53_, new_n54_, new_n57_,
  ...
  assign z03 = new_n54_ | (x01 & (x04 | (new_n52_ & new_n53_ & x12)));
  assign new_n52_ = ~x09 & x00 & x02;
  assign new_n53_ = x10 & x11;
  assign new_n54_ = ~x02 & ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign z04 = x01 & (x04 | (new_n52_ & ~x12 & x10 & ~x11));
  assign z05 = x01 & (x04 | (new_n57_ & x09 & x10));
  assign new_n57_ = x00 & x02;
  assign z06 = x01 & (x04 | (new_n52_ & new_n53_));
  assign z07 = new_n57_ & (~x01 | (new_n53_ & ~x12 & ~x04 & ~x09));
  ...
  assign new_n74_ = (~x02 | ~x10) & x01 & x00 & ~x04;
  ...
  assign z17 = (~x00 & ~x01 & x02) | (x01 & x04);
endmodule
