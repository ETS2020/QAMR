...
module FAU ( 
  ...
  assign z10 = (~x01 & x15) | (new_n63_ & x22 & ~x00 & x21);
  assign z11 = new_n63_ & x21 & ~x00 & ~x22;
  assign z12 = x09 & ~x24 & (new_n69_ | (~new_n70_ & new_n71_));
  assign new_n69_ = x00 & x01 & (~x02 | ~x10);
  assign new_n70_ = ~x17 & ~x02 & ~x19;
  assign new_n71_ = ((~x02 & ~x19) | x23) & ~x00 & ~x01 & ~x15;
  assign z13 = new_n46_ & ~x01 & ~x15 & x17 & ~x19;
