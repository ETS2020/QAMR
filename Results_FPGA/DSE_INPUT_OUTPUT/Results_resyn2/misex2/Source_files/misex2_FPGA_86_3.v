...
module FAU ( 
  ...
  assign z03 = new_n51_ | (new_n52_ & x12 & ~x13 & x00 & x01);
  assign new_n51_ = ~x02 & ~x17 & ~x00 & ~x01 & x18 & ~x19;
  assign new_n52_ = x02 & ~x09 & x10 & x11;
  assign z04 = x01 & (new_n54_ | x13);
  assign new_n54_ = x02 & ~x09 & x00 & x10 & ~x11 & ~x12;
  assign z05 = x01 & (x13 | (x00 & x02 & x09 & x10));
  assign z06 = x01 & (x13 | (new_n52_ & x00));
  assign z07 = ~new_n58_ & x00 & x02;
  assign new_n58_ = x01 & (x09 | ~x10 | x13 | ~x11 | x12);
  ...
  assign new_n64_ = x12 & ~x13 & ~x01 & x02 & ~x11 & ~x14;
  assign new_n65_ = x20 & ~x15 & ~x16;
  assign new_n66_ = x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = ~x00 & ~x22;
  assign z10 = ~x00 & ~x13 & ((new_n69_ & new_n71_) | (new_n70_ & x22));
  assign new_n69_ = ~x11 & ~x14 & ~x01 & x02;
  assign new_n70_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n71_ = x20 & ~x21 & x12 & x15 & x16 & ~x22;
  assign z11 = new_n63_ | (new_n67_ & (new_n70_ | (new_n64_ & new_n73_)));
  assign new_n73_ = x15 & ~x16 & x20 & ~x21;
  assign z12 = (new_n75_ | new_n76_) & x09 & ~x24;
  assign new_n75_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign new_n76_ = (~x02 | ~x10) & ~x13 & x00 & x01;
  assign z13 = (x01 & x13) | (~x00 & ~x01 & x17 & ~x02 & ~x19);
  assign z14 = (x01 & x13) | (new_n49_ & ~x00 & ~x01 & ~x02 & ~x09);
