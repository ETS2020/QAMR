...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n52_, new_n54_, new_n57_, new_n59_, new_n60_,
    new_n62_, new_n63_, new_n64_, new_n65_, new_n67_, new_n68_, new_n70_,
    new_n72_, new_n73_, new_n76_;
  assign z00 = new_n46_ & ~x09 & x10;
  assign new_n46_ = ~x02 & ~x00 & ~x01 & ~x19 & ~x17 & ~x18;
  assign z01 = x10 ? (new_n46_ & x09) : x08;
  assign z02 = ~x10 & (x08 | (new_n46_ & x09));
  assign z03 = (z06 & x12) | new_n50_ | new_n52_;
  assign new_n50_ = x08 & ~x10;
  assign z06 = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign new_n52_ = ~x02 & ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign z04 = new_n50_ | (new_n54_ & x02 & x00 & x01);
  assign new_n54_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x02 & x10 & x09 & x00 & x01;
  assign z07 = new_n50_ | (~new_n57_ & x00 & x02);
  assign new_n57_ = x01 & (x12 | x09 | ~x10 | ~x11);
  assign z08 = new_n50_ | (new_n59_ & new_n60_);
  ...
  assign new_n65_ = ~x21 & ~x22 & ~x00 & (~x08 | x10);
  assign z10 = ~new_n50_ & ~x00 & ((new_n63_ & new_n68_) | (new_n67_ & x22));
  assign new_n67_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n68_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = (new_n67_ | (new_n63_ & new_n70_)) & ~x22 & ~new_n50_ & ~x00;
  assign new_n70_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = new_n50_ | (x09 & ~x24 & (new_n72_ | new_n73_));
  assign new_n72_ = x00 & x01 & (~x02 | ~x10);
  assign new_n73_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign z13 = new_n50_ | (~x00 & ~x01 & x17 & ~x02 & ~x19);
  assign z14 = new_n76_ & ~x19 & ~x17 & ~x18;
  assign new_n76_ = ~x02 & ~x00 & ~x01 & ~x10 & ~x08 & ~x09;
  assign z15 = (x00 | (~x01 & x19)) & (~x08 | x10) & (~x02 | (x01 & ~x10));
  assign z16 = x01 & ~new_n50_ & ~x00;
