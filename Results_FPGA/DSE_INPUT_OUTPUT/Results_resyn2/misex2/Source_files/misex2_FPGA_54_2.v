...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n50_, new_n54_, new_n58_, new_n59_, new_n61_,
  ...
  assign new_n50_ = ~x02 & x09 & ~x10 & ~x19 & ~x17 & ~x18;
  assign z03 = (z06 & x12) | (new_n46_ & ~x17 & x18 & ~x19);
  assign z06 = x02 & x10 & ~x09 & x11 & x00 & x01;
  assign z04 = x00 & (~x01 | (~x09 & ~x11 & new_n54_ & ~x12));
  assign new_n54_ = x02 & x10;
  assign z05 = x00 & (~x01 | (new_n54_ & x09));
  assign z07 = x00 & (~x01 | (new_n54_ & ~x12 & ~x09 & x11));
  ...
  assign new_n66_ = ~x14 & x15 & x20 & ~x21;
  assign z11 = ~x00 & ~x22 & (new_n65_ | (new_n62_ & new_n66_ & ~x16));
  assign z12 = (x00 & ~x01) | (x09 & ~x24 & ((~new_n54_ & x00) | (~new_n69_ & ~x01)));
