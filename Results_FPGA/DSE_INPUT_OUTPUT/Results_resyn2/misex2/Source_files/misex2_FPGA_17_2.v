...
module FAU ( 
  ...
  assign new_n46_ = x01 & ~x24;
  assign new_n47_ = ~x02 & ~x00 & ~x01 & ~x19 & ~x17 & ~x18;
  assign z01 = new_n47_ & x09 & x10;
  assign z02 = new_n46_ | (new_n47_ & x09 & ~x10);
  assign z03 = new_n52_ | (x01 & (new_n51_ | ~x24));
  assign new_n51_ = ~x09 & x10 & x11 & x12 & x00 & x02;
  assign new_n52_ = ~x02 & ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign z04 = new_n54_ & ~x11 & ~x12 & ~x09 & x10;
  assign new_n54_ = x01 & x02 & x00 & x24;
  assign z05 = new_n54_ & x09 & x10;
  assign z06 = new_n54_ & x11 & ~x09 & x10;
  assign z07 = (x01 & ~x24) | (x00 & x02 & (new_n58_ | ~x01));
  ...
  assign z10 = new_n46_ | (~x00 & ((new_n64_ & new_n69_) | (new_n68_ & x22)));
  ...
  assign z12 = new_n73_ & ((~x02 & ~x19) ? x17 : x23);
  assign new_n73_ = ~x00 & ~x01 & x09 & ~x24;
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = new_n47_ & ~x09 & ~x10;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & ~x24) | (x19 & ~x01 & ~x02);
