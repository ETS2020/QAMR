...
module FAU ( 
  ...
  assign new_n46_ = ~x04 & x20;
  assign new_n47_ = x10 & ~x02 & ~x09 & ~x00 & ~x01;
  assign z01 = new_n49_ & x10 & ~x00 & ~x01 & ~x02 & x09;
  assign new_n49_ = (x04 | ~x20) & ~x19 & ~x17 & ~x18;
  assign z02 = new_n51_ & ~x00 & ~x01 & ~x02 & x09;
  assign new_n51_ = ~x10 & ~x19 & ~x17 & ~x18 & (x04 | ~x20);
  assign z03 = (x12 & new_n53_ & new_n54_) | new_n46_ | new_n55_;
  assign new_n53_ = x02 & x00 & x01;
  assign new_n54_ = x11 & ~x09 & x10;
  assign new_n55_ = ~x02 & ~x17 & ~x00 & ~x01 & x18 & ~x19;
  assign z04 = new_n53_ & ~x09 & x10 & ~new_n46_ & ~x11 & ~x12;
  assign z05 = ~new_n46_ & x09 & new_n53_ & x10;
  assign z06 = new_n46_ | (new_n53_ & new_n54_);
  assign z07 = (~x01 | (new_n54_ & ~x12)) & x00 & ~new_n46_ & x02;
  ...
  assign new_n65_ = x04 & ~x01 & x02 & ~x11 & x12;
  assign new_n66_ = ~x13 & ~x14 & x20 & ~x15 & ~x16;
  assign z10 = new_n46_ | (~x00 & (new_n69_ | (new_n70_ & new_n68_ & new_n71_)));
  assign new_n68_ = ~x01 & x02 & ~x11 & x12;
  assign new_n69_ = x22 & x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n70_ = ~x13 & ~x14 & x20 & ~x21;
  assign new_n71_ = ~x22 & x15 & x16;
  assign z11 = ~x00 & ~x22 & ((new_n65_ & new_n73_) | (new_n64_ & x21));
  assign new_n73_ = x15 & ~x16 & ~x13 & ~x14 & x20 & ~x21;
  assign z12 = new_n76_ & ((x00 & x01 & (~x02 | ~x10)) | (~new_n75_ & ~x00 & ~x01));
