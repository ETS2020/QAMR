...
module FAU ( 
  ...
  assign z03 = (new_n52_ & ~x00 & ~x19) | (new_n53_ & x12 & x00 & x01);
  assign new_n52_ = ~x01 & ~x02 & ~x17 & x18;
  assign new_n53_ = x10 & x11 & x02 & ~x09;
  ...
  assign new_n59_ = ~x09 & x11 & x10 & ~x12;
  assign z08 = ~x00 & (x01 | (new_n61_ & new_n62_));
  assign new_n61_ = ~x18 & x19 & ~x08 & x17;
  assign new_n62_ = x02 & ~x03 & x04 & ~x05 & ~x06 & ~x07;
  assign z09 = new_n64_ & ~x14 & x12 & ~x13 & new_n65_ & ~x15;
  assign new_n64_ = ~x00 & ~x01 & x02 & ~x11;
  assign new_n65_ = ~x16 & ~x22 & x20 & ~x21;
  assign z10 = new_n67_ & x15 & new_n64_ & ~x14 & x12 & ~x13;
  assign new_n67_ = x16 & ~x22 & x20 & ~x21;
  assign z11 = new_n65_ & x15 & new_n64_ & ~x14 & x12 & ~x13;
  assign z12 = x09 & ~x24 & (new_n70_ | (new_n55_ & (~x02 | ~x10)));
