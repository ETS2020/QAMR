...
module FAU ( 
  ...
  assign z09 = new_n65_ & ~x21 & (new_n64_ | (new_n62_ & new_n63_));
  ...
  assign z10 = ~x00 & ((new_n62_ & new_n67_) | (new_n68_ & new_n69_));
  assign new_n67_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign new_n68_ = x21 & ~x20 & x18 & ~x19;
  assign new_n69_ = x22 & x01 & ~x24;
  assign z11 = (x01 & x24) | (new_n65_ & ((new_n68_ & x01) | (new_n62_ & new_n71_)));
  assign new_n71_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = (x01 & x24) | (x09 & ((~new_n73_ & x00 & x01) | (~new_n74_ & ~x24 & ~x00 & ~x01)));
