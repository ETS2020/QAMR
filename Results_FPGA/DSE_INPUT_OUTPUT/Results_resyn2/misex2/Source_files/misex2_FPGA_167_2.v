...
module FAU ( 
  ...
  assign z05 = x01 & x00 & x02 & x09 & x10 & x15;
  assign z06 = new_n58_ & x01 & x00 & x02;
  assign new_n58_ = ~x09 & x11 & x10 & x15;
  ...
  assign new_n64_ = x15 & x18 & ~x19 & x01 & ~x20;
  assign new_n65_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = new_n46_ | (~x00 & ((new_n65_ & new_n69_) | (new_n68_ & x22)));
  assign new_n68_ = x01 & ~x20 & x21 & x18 & ~x19;
  assign new_n69_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign z11 = new_n46_ | (~x00 & ~x22 & (new_n68_ | (new_n65_ & new_n71_)));
