...
module FAU ( 
  ...
  assign z01 = ~x01 & (x21 | (new_n46_ & new_n48_ & x09));
  assign new_n48_ = ~x00 & ~x02;
  assign z02 = ~x01 & (x21 | (new_n50_ & ~x17 & new_n48_ & x09));
  assign new_n50_ = ~x10 & ~x18 & ~x19;
  assign z03 = (new_n53_ & x12) | (~new_n52_ & ~x01);
  assign new_n52_ = ~x21 & (~x18 | x19 | x17 | x00 | x02);
  assign new_n53_ = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign z04 = (~x01 & x21) | (new_n55_ & x02 & x00 & x01);
  assign new_n55_ = ~x11 & ~x12 & ~x09 & x10;
  assign z05 = x02 & x10 & x09 & x00 & x01;
  assign z06 = new_n53_ | new_n58_;
  assign new_n58_ = ~x01 & x21;
  assign z07 = (~x01 & x21) | (x00 & x02 & (new_n60_ | ~x01));
  assign new_n60_ = ~x12 & x11 & ~x09 & x10;
  assign z08 = ~x01 & (x21 | (new_n62_ & new_n63_ & new_n64_));
  assign new_n62_ = x19 & x17 & ~x18;
  assign new_n63_ = ~x07 & ~x08 & ~x05 & ~x06;
  assign new_n64_ = ~x00 & x02 & ~x03 & x04;
  assign z09 = new_n58_ | (~x00 & ~x22 & (new_n68_ | (new_n66_ & new_n67_)));
  assign new_n66_ = ~x01 & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n67_ = ~x15 & ~x16 & x20;
  assign new_n68_ = ~x20 & x18 & ~x19 & x01 & ~x21;
  assign z10 = new_n58_ | (~x00 & ((new_n66_ & new_n71_) | (new_n70_ & x22)));
  assign new_n70_ = x21 & ~x20 & x18 & ~x19;
  assign new_n71_ = x15 & x16 & x20 & ~x22;
  assign z11 = new_n58_ | (~x00 & ~x22 & (new_n70_ | (new_n66_ & new_n73_)));
  assign new_n73_ = x15 & ~x16 & x20;
  assign z12 = x09 & ~x24 & (new_n75_ | (~new_n76_ & new_n77_));
  assign new_n75_ = x00 & x01 & (~x02 | ~x10);
  assign new_n76_ = ~x23 & (x02 | x19);
  assign new_n77_ = ~x21 & ~x00 & ~x01 & (x17 | x02 | x19);
  assign z13 = ~x01 & (x21 | (new_n48_ & x17 & ~x19));
  assign z14 = ~x01 & (x21 | (new_n48_ & ~x17 & new_n50_ & ~x09));
  assign z15 = (x00 & x01 & (~x02 | ~x10)) | ((x00 | (~x01 & x19)) & ~x02 & ~x21);
