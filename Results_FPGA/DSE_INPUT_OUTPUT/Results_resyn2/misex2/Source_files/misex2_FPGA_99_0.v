...
module FAU ( 
  ...
  assign z09 = ~x22 & (~x18 | (new_n64_ & (new_n61_ | (new_n62_ & new_n63_))));
  assign new_n61_ = ~x20 & x01 & ~x19;
  assign new_n62_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n63_ = ~x15 & x20 & ~x14 & ~x16;
  assign new_n64_ = ~x00 & ~x21;
  assign z10 = ~x00 & x18 & ((new_n62_ & new_n67_) | (new_n66_ & x22));
  assign new_n66_ = x21 & ~x20 & x01 & ~x19;
  assign new_n67_ = x15 & ~x21 & ~x14 & x16 & x20 & ~x22;
  assign z11 = ~x22 & (~x18 | (~x00 & (new_n66_ | (new_n62_ & new_n69_))));
