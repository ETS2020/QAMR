...
module FAU ( 
  ...
  assign new_n66_ = ~x00 & ~x22 & ~x03 & ~x21;
  assign z10 = new_n46_ | (~x00 & ((new_n68_ & x22) | (new_n65_ & new_n69_)));
  assign new_n68_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n69_ = x15 & x16 & ~x22 & x20 & ~x21;
  assign z11 = ~x00 & ~x22 & (new_n68_ | (new_n65_ & new_n71_));
  assign new_n71_ = ~x16 & x20 & x15 & ~x03 & ~x21;
  assign z12 = new_n74_ & ((x00 & x01 & (~x02 | ~x10)) | (~new_n73_ & ~x00 & ~x01));
  assign new_n73_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign new_n74_ = (~x03 | x21) & x09 & ~x24;
