...
module FAU ( 
  ...
  assign new_n58_ = ~x19 & ~x20 & x09 & x01 & x18;
  assign new_n59_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n60_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((new_n63_ & new_n62_ & x22) | (new_n59_ & new_n64_));
  assign new_n62_ = x09 & x01 & x18;
  assign new_n63_ = x21 & ~x19 & ~x20;
  assign new_n64_ = ~x14 & x15 & x20 & ~x21 & x16 & ~x22;
  assign z11 = z06 | (~x00 & ~x22 & (new_n67_ | (new_n59_ & new_n66_)));
  assign new_n66_ = ~x16 & ~x14 & x15 & x20 & ~x21;
  assign new_n67_ = x01 & x18 & x21 & ~x19 & ~x20;
  assign z12 = z06 | (~x24 & (new_n69_ | (~new_n70_ & new_n71_)));
  assign new_n69_ = x00 & x01 & (~x02 | ~x10);
  assign new_n70_ = ~x17 & ~x02 & ~x19;
  assign new_n71_ = (x23 | (~x02 & ~x19)) & x09 & ~x00 & ~x01;
