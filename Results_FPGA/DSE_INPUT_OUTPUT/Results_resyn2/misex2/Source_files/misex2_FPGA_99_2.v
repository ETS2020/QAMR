...
module FAU ( 
  ...
  assign z09 = ~x22 & (x18 | (new_n62_ & new_n63_ & new_n64_ & ~x15));
  assign new_n62_ = ~x00 & ~x01 & x12 & x02 & ~x11;
  assign new_n63_ = ~x21 & ~x16 & x20;
  assign new_n64_ = ~x13 & ~x14;
  assign z10 = ~x00 & (new_n68_ | (new_n66_ & new_n67_));
  assign new_n66_ = ~x13 & ~x14 & ~x01 & x15 & x16 & ~x18;
  assign new_n67_ = x12 & x02 & ~x11 & ~x22 & x20 & ~x21;
  assign new_n68_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x22 & (x18 | (new_n62_ & new_n63_ & new_n64_ & x15));
