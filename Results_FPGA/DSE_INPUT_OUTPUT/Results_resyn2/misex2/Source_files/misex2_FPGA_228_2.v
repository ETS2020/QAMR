...
module FAU ( 
  ...
  assign z03 = new_n53_ | (x01 & (~x13 | (x12 & new_n51_ & new_n52_)));
  assign new_n51_ = x00 & x02;
  assign new_n52_ = x11 & ~x09 & x10;
  assign new_n53_ = ~x02 & ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign z04 = new_n55_ & new_n51_ & x01 & ~x11;
  assign new_n55_ = ~x09 & x10 & ~x12 & x13;
  assign z05 = x01 & (~x13 | (new_n51_ & x09 & x10));
  assign z06 = x01 & (~x13 | (new_n51_ & new_n52_));
  assign z07 = new_n51_ & (~x01 | (new_n52_ & ~x12 & x13));
