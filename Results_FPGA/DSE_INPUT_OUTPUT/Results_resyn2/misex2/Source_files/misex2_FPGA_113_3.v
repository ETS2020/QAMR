...
module FAU ( 
  ...
  assign z08 = (x01 & x22) | (new_n61_ & new_n62_ & ~x00 & ~x01 & x02);
  ...
  assign new_n65_ = ~x01 & x02 & ~x16 & x20;
  assign new_n66_ = ~x15 & ~x11 & x12 & ~x13 & ~x14;
  assign z10 = new_n68_ & new_n69_;
  assign new_n68_ = ~x11 & x12 & ~x13 & ~x14 & x15 & ~x21;
  assign new_n69_ = ~x00 & ~x01 & x02 & ~x22 & x16 & x20;
  assign z11 = ~x00 & ~x22 & ((new_n65_ & new_n68_) | (new_n64_ & x21));
  ...
  assign z17 = (~x00 & ~x01 & x02) | (x01 & x22);
endmodule
