...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n57_, new_n59_,
    ...
    new_n71_;
  assign z00 = ~x01 & (~x24 | (new_n46_ & ~x09 & ~x00 & ~x02));
  assign new_n46_ = ~x18 & ~x19 & x10 & ~x17;
  assign z01 = ~x01 & (~x24 | (new_n46_ & x09 & ~x00 & ~x02));
  assign z02 = ~x01 & (~x24 | (new_n49_ & x09 & ~x00 & ~x02));
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (~new_n51_ & ~x01) | (new_n52_ & x12);
  assign new_n51_ = x24 & (~x18 | x19 | x17 | x00 | x02);
  ...
  assign new_n57_ = ~x01 & ~x24;
  assign z07 = (~x01 & ~x24) | (x00 & x02 & (new_n59_ | ~x01));
  assign new_n59_ = ~x12 & x11 & ~x09 & x10;
  assign z08 = new_n61_ & new_n62_ & x24 & ~x18 & x19;
  ...
  assign z10 = new_n57_ | (~x00 & ((new_n65_ & new_n68_) | (new_n69_ & x22)));
  assign new_n68_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign new_n69_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign z11 = new_n57_ | (~x00 & ~x22 & (new_n69_ | (new_n65_ & new_n71_)));
  assign new_n71_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = x09 & x00 & x01 & ~x24 & (~x02 | ~x10);
  assign z13 = ~x02 & x24 & ~x00 & ~x01 & x17 & ~x19;
  assign z14 = ~x01 & (~x24 | (new_n49_ & ~x09 & ~x00 & ~x02));
  assign z15 = (x01 | (~x02 & x24)) & ((x00 & (~x02 | ~x10)) | (~x01 & x19));
