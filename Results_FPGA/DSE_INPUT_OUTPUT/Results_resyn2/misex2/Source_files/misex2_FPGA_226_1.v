...
module FAU ( 
  ...
  assign z03 = (x12 & new_n51_ & x02 & x00 & x01) | (new_n52_ & ~x01 & ~x00 & ~x02);
  assign new_n51_ = x11 & ~x09 & x10;
  assign new_n52_ = ~x19 & ~x23 & ~x17 & x18;
  ...
  assign z07 = (~x01 | (new_n51_ & ~x12)) & (x01 | ~x23) & x00 & x02;
  ...
  assign new_n72_ = ~x14 & x15 & x20 & ~x21 & ~x16 & ~x23;
  assign z12 = new_n63_ | (~new_n74_ & x09 & ~x24);
  assign new_n74_ = ((x02 & x10) | ~x00 | ~x01) & (~x17 | x19 | x01 | x00 | x02);
  assign z13 = ~x01 & (x23 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x01 & (x23 | (new_n49_ & ~x09 & ~x00 & ~x02));
  assign z15 = ((~x02 | ~x10) & x00 & x01) | (~x02 & ~x23 & (x00 | (~x01 & x19)));
