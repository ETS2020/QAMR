...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n57_, new_n58_, new_n60_,
    new_n61_, new_n63_, new_n64_, new_n65_, new_n66_, new_n68_, new_n69_,
    new_n71_, new_n73_, new_n74_;
  assign z00 = new_n46_ & x10 & ~x08 & ~x09;
  assign new_n46_ = ~x00 & ~x01 & ~x02 & ~x19 & ~x17 & ~x18;
  assign z01 = x10 & (x08 | (new_n46_ & x09));
  assign z02 = x10 ? x08 : (new_n46_ & x09);
  assign z03 = new_n51_ | (x10 & (new_n50_ | x08));
  assign new_n50_ = x02 & x00 & x01 & x12 & ~x09 & x11;
  assign new_n51_ = ~x00 & ~x01 & ~x02 & ~x19 & ~x17 & x18;
  assign z04 = x10 & (x08 | (new_n53_ & ~x12 & ~x09 & ~x11));
  assign new_n53_ = x02 & x00 & x01;
  assign z05 = new_n53_ & ~x08 & x09 & x10;
  assign z06 = new_n53_ & ~x08 & x10 & ~x09 & x11;
  assign z07 = new_n57_ | (~new_n58_ & x00 & x02);
  assign new_n57_ = x08 & x10;
  assign new_n58_ = x01 & (x12 | ~x10 | x09 | ~x11);
  assign z08 = new_n57_ | (new_n60_ & new_n61_);
  ...
  assign z10 = ~new_n57_ & ~x00 & ((new_n64_ & new_n69_) | (new_n68_ & x22));
  assign new_n68_ = x21 & x01 & x18 & ~x19 & ~x20;
  assign new_n69_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = (new_n68_ | (new_n64_ & new_n71_)) & ~x22 & ~new_n57_ & ~x00;
  ...
  assign z13 = new_n57_ | (x17 & ~x00 & ~x01 & ~x02 & ~x19);
  assign z14 = new_n46_ & ~x09 & ~x10;
  assign z15 = (~x02 | (x01 & ~x10)) & (~x08 | ~x10) & (x00 | (~x01 & x19));
  assign z16 = x01 & ~new_n57_ & ~x00;
  assign z17 = new_n57_ | (~x00 & ~x01 & x02);
endmodule
