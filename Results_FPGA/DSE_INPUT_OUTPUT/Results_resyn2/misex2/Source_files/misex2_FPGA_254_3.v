...
module FAU ( 
  ...
  assign z01 = z06 | (new_n47_ & new_n48_ & x09);
  assign z02 = new_n48_ & x09 & ~x10 & ~x19 & ~x17 & ~x18;
  assign z03 = z06 | (new_n48_ & ~x17 & x18 & ~x19);
  ...
  assign z09 = new_n60_ & (new_n59_ | (new_n57_ & new_n58_ & ~x15));
  assign new_n57_ = ~x16 & ~x13 & ~x11 & x12;
  assign new_n58_ = ~x01 & x02 & ~x14 & x20;
  assign new_n59_ = x18 & ~x19 & x01 & ~x20;
  assign new_n60_ = ~x22 & ~x00 & ~x21;
  assign z10 = (~new_n62_ & x01) | (new_n63_ & new_n58_ & new_n60_);
  assign new_n62_ = ~x00 & (~x22 | ~x18 | x19 | x20 | ~x21);
  assign new_n63_ = ~x13 & ~x11 & x12 & x15 & x16;
  assign z11 = new_n66_ & (new_n65_ | (new_n57_ & new_n58_ & x15 & ~x21));
  assign new_n65_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign new_n66_ = ~x00 & ~x22;
  assign z12 = new_n68_ & ((~x02 & ~x19) ? x17 : x23);
  assign new_n68_ = x09 & ~x24 & ~x00 & ~x01;
