...
module FAU ( 
  ...
  assign z09 = new_n56_ | (new_n66_ & (new_n65_ | (new_n63_ & new_n64_ & ~x15)));
  assign new_n63_ = ~x01 & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n64_ = ~x16 & x20;
  assign new_n65_ = x18 & ~x19 & x01 & ~x20;
  assign new_n66_ = ~x21 & ~x00 & ~x22;
  assign z10 = new_n56_ | (~x00 & ((new_n68_ & x22) | (new_n63_ & new_n69_)));
  assign new_n68_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n69_ = x15 & x16 & ~x22 & x20 & ~x21;
  assign z11 = ~x00 & ~x22 & (new_n68_ | (new_n63_ & new_n71_));
  assign new_n71_ = ~x16 & x20 & ~x21 & ~x06 & x15;
