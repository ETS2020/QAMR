...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n59_, new_n60_,
    new_n62_, new_n64_, new_n66_, new_n69_, new_n70_;
  ...
  assign z10 = ~x00 & (x01 | (new_n66_ & new_n64_ & x15 & x16));
  assign new_n66_ = ~x13 & ~x14 & x12 & x02 & ~x11;
  assign z11 = ~x00 & (x01 | (new_n66_ & new_n64_ & x15 & ~x16));
