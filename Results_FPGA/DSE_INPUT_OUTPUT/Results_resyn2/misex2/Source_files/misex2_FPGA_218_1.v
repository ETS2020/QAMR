...
module FAU ( 
  ...
  assign z09 = new_n59_ | (new_n63_ & ~x21 & (new_n60_ | (new_n61_ & new_n62_)));
  ...
  assign z10 = new_n59_ | (~x00 & ((new_n61_ & new_n66_) | (new_n65_ & x22)));
  assign new_n65_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n66_ = ~x14 & x15 & x20 & ~x21 & x16 & ~x22;
  assign z11 = new_n59_ | (new_n63_ & (new_n65_ | (new_n61_ & new_n68_)));
  ...
  assign z13 = ~x04 & ~x00 & ~x01 & x17 & ~x02 & ~x19;
