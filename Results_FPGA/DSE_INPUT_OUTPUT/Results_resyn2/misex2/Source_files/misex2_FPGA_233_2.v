...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n51_, new_n53_, new_n56_, new_n59_, new_n62_,
    new_n63_, new_n64_, new_n66_, new_n67_, new_n70_, new_n71_;
  ...
  assign z03 = (x01 & (new_n51_ | ~x04)) | (new_n48_ & x18 & ~x19);
  assign new_n51_ = ~x09 & x00 & x02 & x12 & x10 & x11;
  assign z04 = x01 & (new_n53_ | ~x04);
  assign new_n53_ = ~x09 & x00 & x02 & ~x12 & x10 & ~x11;
  assign z05 = x01 & (~x04 | (x00 & x02 & x09 & x10));
  assign z06 = new_n56_ & x00 & x02 & x01 & x04;
  assign new_n56_ = x11 & ~x09 & x10;
  assign z07 = (x00 & x02 & (~x01 | (new_n56_ & ~x12))) | (x01 & ~x04);
