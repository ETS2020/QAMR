...
module FAU ( 
  ...
  assign z08 = (x01 & x20) | (new_n60_ & z17 & new_n62_);
  assign new_n60_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign new_n62_ = x19 & x17 & ~x18;
  assign z09 = (x01 & x20) | (new_n67_ & ((new_n65_ & new_n66_) | (new_n64_ & x01)));
  assign new_n64_ = x18 & ~x19;
  assign new_n65_ = x02 & ~x11 & x12 & ~x13;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n67_ = ~x00 & ~x21 & ~x22;
  assign z10 = (x01 & x20) | (~x00 & (new_n71_ | (new_n69_ & new_n70_)));
  assign new_n69_ = x02 & ~x11 & x12 & ~x13 & ~x14 & x15;
  assign new_n70_ = ~x21 & ~x22 & x16 & x20;
  assign new_n71_ = ~x19 & x21 & x22 & x01 & x18;
  assign z11 = (new_n73_ | (new_n69_ & new_n74_)) & ~x00 & ~x22;
  assign new_n73_ = ~x20 & x01 & x18 & ~x19 & x21;
  assign new_n74_ = ~x16 & x20 & ~x01 & ~x21;
  assign z12 = (new_n76_ | (new_n54_ & (~x02 | ~x10))) & x09 & ~x24;
