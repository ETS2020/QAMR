...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n50_, new_n52_, new_n54_, new_n58_, new_n60_,
    ...
    new_n70_, new_n71_, new_n74_;
  assign z00 = new_n46_ & ~x09 & x10 & x23 & ~x18 & ~x19;
  assign new_n46_ = ~x00 & ~x01 & ~x02 & ~x17;
  assign z01 = ~x01 & (~x23 | (new_n48_ & x09 & ~x00 & ~x02));
  assign new_n48_ = ~x18 & ~x19 & x10 & ~x17;
  assign z02 = ~x01 & (~x23 | (new_n50_ & x09 & ~x00 & ~x02));
  assign new_n50_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = (new_n52_ & x12) | (new_n46_ & x23 & x18 & ~x19);
  ...
  assign z06 = new_n52_ | (~x01 & ~x23);
  assign z07 = (~x01 & ~x23) | ((new_n58_ | ~x01) & x00 & x02);
  assign new_n58_ = ~x12 & x11 & ~x09 & x10;
  assign z08 = new_n60_ & new_n61_ & x23 & ~x18 & x19;
  ...
  assign new_n64_ = ~x13 & ~x01 & x02 & ~x11 & x12;
  assign new_n65_ = ~x16 & x20 & x23 & ~x14 & ~x15;
  ...
  assign new_n70_ = ~x14 & x15 & ~x21 & x23;
  assign new_n71_ = ~x13 & x16 & x20 & ~x22;
  assign z11 = new_n66_ & (new_n69_ | (new_n64_ & new_n70_ & ~x16 & x20));
  assign z12 = (~x01 & ~x23) | (~new_n74_ & x09 & ~x24);
  assign new_n74_ = (x00 | x01 | (~x19 & ~x02 & ~x17)) & (~x00 | ~x01 | (x02 & x10));
  assign z13 = ~x01 & (~x23 | (x17 & ~x19 & ~x00 & ~x02));
  assign z14 = ~x01 & (~x23 | (new_n50_ & ~x09 & ~x00 & ~x02));
  assign z15 = (x00 & x01 & (~x02 | ~x10)) | ((x00 | (~x01 & x19)) & ~x02 & x23);
