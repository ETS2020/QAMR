...
module FAU ( 
  ...
  assign z09 = (new_n65_ | (~x15 & new_n63_ & new_n64_)) & new_n66_ & ~x21;
  assign new_n63_ = ~x11 & x12 & ~x01 & x02;
  assign new_n64_ = ~x13 & ~x14 & ~x16 & x20;
  assign new_n65_ = x01 & ~x20 & x15 & x18 & ~x19;
  assign new_n66_ = ~x00 & ~x22;
  assign z10 = new_n68_ | (~x00 & (new_n71_ | (new_n63_ & new_n69_ & new_n70_)));
  assign new_n68_ = x01 & ~x15;
  assign new_n69_ = ~x22 & x20 & ~x21;
  assign new_n70_ = ~x13 & ~x14 & x15 & x16;
  assign new_n71_ = x22 & x01 & ~x20 & x21 & x18 & ~x19;
  assign z11 = (new_n73_ | (~x21 & new_n63_ & new_n64_)) & new_n66_ & x15;
  assign new_n73_ = x01 & ~x20 & x21 & x18 & ~x19;
  assign z12 = (new_n75_ | new_n76_) & x09 & ~x24;
  assign new_n75_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign new_n76_ = (~x02 | ~x10) & x01 & x00 & x15;
