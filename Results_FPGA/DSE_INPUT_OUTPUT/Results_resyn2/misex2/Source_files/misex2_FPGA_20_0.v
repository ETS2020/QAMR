...
module FAU ( 
  ...
  assign new_n56_ = (x05 | x06) & x00 & x02;
  ...
  assign new_n64_ = ~x21 & ~x22 & ~x00 & (x05 | x06);
  assign z10 = ~new_n46_ & ~x00 & ((new_n62_ & new_n67_) | (new_n66_ & x22));
  assign new_n66_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign z11 = (new_n66_ | (new_n62_ & new_n69_)) & ~x22 & ~new_n46_ & ~x00;
