...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n56_, new_n60_,
    new_n61_, new_n63_, new_n64_, new_n66_, new_n67_, new_n70_;
  assign z00 = ~x00 & (x01 | (new_n46_ & ~x02 & ~x09));
  assign new_n46_ = x10 & ~x19 & ~x17 & ~x18;
  assign z01 = new_n46_ & x09 & ~x00 & ~x01 & ~x02;
  assign z02 = ~x00 & (x01 | (new_n49_ & ~x02 & x09));
  assign new_n49_ = ~x10 & ~x19 & ~x17 & ~x18;
  assign z03 = (new_n51_ & x12 & x00 & x01) | (new_n52_ & ~x00 & ~x01 & ~x02);
  ...
  assign new_n64_ = ~x22 & x20 & ~x21 & ~x15 & x02 & ~x16;
  assign z10 = new_n67_ & new_n66_ & x16 & x02 & ~x00 & ~x01;
  assign new_n66_ = ~x22 & x20 & ~x21;
  assign new_n67_ = x15 & ~x13 & ~x14 & ~x11 & x12;
  assign z11 = ~x00 & (x01 | (new_n67_ & new_n66_ & x02 & ~x16));
  assign z12 = (~x00 & x01) | (x09 & ~x24 & ((~new_n70_ & ~x00) | (~new_n56_ & x01)));
