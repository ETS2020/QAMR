...
module FAU ( 
  ...
  assign new_n46_ = (~x07 | ~x12) & ~x17 & ~x18 & ~x19;
  ...
  assign z03 = new_n53_ | (x12 & (new_n52_ | x07));
  assign new_n52_ = x02 & x00 & x01 & ~x09 & x10 & x11;
  assign new_n53_ = ~x02 & ~x19 & ~x00 & ~x01 & ~x17 & x18;
  assign z04 = new_n55_ & ~x09 & ~x12 & x10 & ~x11;
  assign new_n55_ = x02 & x00 & x01;
  assign z05 = new_n55_ & ~new_n48_ & x09 & x10;
  assign z06 = ~new_n48_ & new_n52_;
  assign z07 = new_n48_ | (~new_n59_ & x00 & x02);
  assign new_n59_ = x01 & (x09 | x12 | ~x10 | ~x11);
  assign z08 = new_n61_ & new_n62_ & ~x08 & x17 & ~x18 & x19;
  assign new_n61_ = ~x06 & ~x07 & x04 & ~x05;
  assign new_n62_ = x02 & ~x03 & ~x00 & ~x01;
  assign z09 = new_n48_ | ((new_n64_ | (new_n65_ & new_n66_)) & new_n67_ & ~x21);
  ...
  assign new_n70_ = ~x07 & x16 & ~x22 & x20 & ~x21;
  assign new_n71_ = ~x14 & x15 & ~x01 & x02;
  assign new_n72_ = x21 & ~x19 & ~x20 & x01 & x18;
  assign new_n73_ = x22 & (~x07 | ~x12);
  assign z11 = new_n48_ | (new_n67_ & ((new_n64_ & x21) | (new_n65_ & new_n71_ & ~x21)));
  assign z12 = new_n48_ | ((new_n76_ | new_n77_) & x09 & ~x24);
  ...
  assign z17 = x02 & ~new_n48_ & ~x00 & ~x01;
endmodule
