...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n49_, new_n52_, new_n53_, new_n54_, new_n57_,
  ...
  assign new_n46_ = (x13 | ~x24) & ~x17 & ~x18 & ~x19;
  ...
  assign new_n65_ = x01 & ~x20 & x18 & ~x19 & (x13 | ~x24);
  assign new_n66_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n67_ = ~x14 & ~x15 & ~x24 & ~x16 & x20;
  assign z10 = new_n48_ | (~x00 & (new_n70_ | (new_n66_ & new_n69_)));
  assign new_n69_ = ~x21 & ~x14 & x15 & ~x22 & x16 & x20;
  assign new_n70_ = x01 & ~x20 & x18 & ~x19 & x21 & x22;
  assign z11 = ~x00 & ~x22 & ((new_n66_ & new_n72_) | (new_n65_ & x21));
  assign new_n72_ = ~x21 & ~x14 & x15 & ~x24 & ~x16 & x20;
  assign z12 = (new_n74_ | (new_n57_ & (~x02 | ~x10))) & x09 & ~x24;
