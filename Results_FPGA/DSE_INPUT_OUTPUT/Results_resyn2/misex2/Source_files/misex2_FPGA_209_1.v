...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n49_, new_n54_, new_n57_, new_n59_, new_n60_,
  ...
  assign new_n49_ = ~x17 & ~x22;
  assign z02 = ~x01 & (x22 | (new_n46_ & x09 & ~x10));
  assign z03 = (z06 & x12) | (new_n48_ & new_n49_ & x18 & ~x19);
  assign z06 = x11 & ~x09 & x10 & x02 & x00 & x01;
  assign z04 = ~x11 & ~x12 & ~x09 & x10 & new_n54_ & x02;
  ...
  assign new_n59_ = x19 & x02 & x17;
  assign new_n60_ = ~x05 & ~x06 & ~x07 & ~x08;
  assign new_n61_ = ~x00 & ~x18 & ~x03 & x04;
  ...
  assign z10 = (~x01 & x22) | (~x00 & (new_n68_ | (new_n64_ & new_n67_)));
