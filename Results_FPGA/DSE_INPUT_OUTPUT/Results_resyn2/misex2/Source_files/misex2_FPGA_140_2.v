...
module FAU ( 
  ...
  assign z04 = new_n55_ & ~x11 & x06 & ~x12;
  assign new_n55_ = x01 & ~x09 & x00 & x02 & x10;
  assign z05 = x01 & (~x06 | (x09 & x00 & x02 & x10));
  assign z06 = new_n55_ & x06 & x11;
  assign z07 = ~new_n59_ & x00 & x02;
  assign new_n59_ = x01 & (~x06 | x12 | ~x11 | x09 | ~x10);
  ...
  assign z10 = ~x00 & ((new_n69_ & x06 & x22) | (new_n65_ & new_n70_));
