...
module FAU ( 
  ...
  assign z00 = (x02 & x13) | (new_n46_ & ~x09 & ~x02 & ~x00 & ~x01);
  ...
  assign z03 = new_n51_ | (new_n52_ & new_n53_ & x02 & x12 & ~x13);
  assign new_n51_ = ~x17 & ~x02 & ~x19 & x18 & ~x00 & ~x01;
  assign new_n52_ = x00 & x01;
  assign new_n53_ = x11 & ~x09 & x10;
  assign z04 = x02 & (new_n55_ | x13);
  assign new_n55_ = ~x09 & x10 & x00 & x01 & ~x11 & ~x12;
  ...
  assign new_n61_ = ~x08 & ~x13 & ~x06 & ~x07;
  assign z09 = (new_n63_ | (new_n64_ & new_n65_)) & ~x21 & ~x00 & ~x22;
  assign new_n63_ = x01 & x18 & (~x02 | ~x13) & ~x19 & ~x20;
  assign new_n64_ = ~x01 & x02 & ~x11 & x12;
  assign new_n65_ = ~x16 & x20 & ~x15 & ~x13 & ~x14;
  assign z10 = ~x00 & ((new_n67_ & new_n68_ & new_n69_) | (new_n70_ & new_n71_));
  assign new_n67_ = ~x22 & x20 & ~x21;
  assign new_n68_ = x12 & ~x13 & ~x11 & x16;
  assign new_n69_ = ~x01 & x02 & ~x14 & x15;
  assign new_n70_ = x01 & x18 & x21 & ~x19 & ~x20;
  assign new_n71_ = x22 & (~x02 | ~x13);
  assign z11 = new_n73_ | (~x00 & ~x22 & (new_n70_ | (new_n64_ & new_n74_)));
  assign new_n73_ = x02 & x13;
  assign new_n74_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = new_n73_ | ((new_n76_ | new_n77_) & x09 & ~x24);
  assign new_n76_ = x00 & x01 & (~x02 | ~x10);
  assign new_n77_ = (x23 | (~x02 & ~x19)) & ~x00 & ~x01 & (x17 | x02 | x19);
  assign z13 = ~x02 & ~x19 & x17 & ~x00 & ~x01;
  assign z14 = (x02 & x13) | (new_n49_ & ~x09 & ~x02 & ~x00 & ~x01);
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x02 & x13) | (x19 & ~x01 & ~x02);
  assign z16 = new_n73_ | (~x00 & x01);
