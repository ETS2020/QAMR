...
module FAU ( 
  ...
  assign z09 = new_n64_ & new_n63_ & ~x00 & ~x01 & x02 & ~x11;
  assign new_n63_ = ~x14 & x12 & ~x13;
  assign new_n64_ = ~x15 & ~x16 & ~x22 & x20 & ~x21;
  assign z10 = new_n66_ & new_n63_ & ~x00 & ~x01 & x02 & ~x11;
  assign new_n66_ = x15 & x16 & ~x22 & x20 & ~x21;
  assign z11 = ~x00 & (x01 | (new_n68_ & new_n69_));
  assign new_n68_ = ~x16 & ~x22 & x20 & ~x21;
  assign new_n69_ = ~x14 & x12 & ~x13 & x15 & x02 & ~x11;
  assign z12 = (~x00 & x01) | (x09 & ~x24 & ((~new_n71_ & ~x00) | (~new_n56_ & x01)));
