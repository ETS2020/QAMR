...
module FAU ( 
  ...
  assign new_n51_ = ~x10 & ~x19 & ~x17 & ~x18 & (x13 | ~x16);
  assign z03 = new_n48_ | new_n55_ | (new_n53_ & new_n54_ & x12);
  assign new_n53_ = x11 & ~x09 & x10;
  assign new_n54_ = x02 & x00 & x01;
  assign new_n55_ = x18 & ~x19 & ~x01 & ~x02 & ~x00 & ~x17;
  ...
  assign z09 = new_n48_ | (new_n67_ & (new_n64_ | (new_n65_ & new_n66_ & ~x15)));
  assign new_n64_ = x18 & ~x19 & x01 & ~x20;
  assign new_n65_ = ~x01 & x02 & ~x11 & x12;
  assign new_n66_ = x20 & ~x13 & ~x14;
  assign new_n67_ = ~x21 & ~x00 & ~x22;
  assign z10 = new_n69_ & x22 & ~x20 & x21;
  assign new_n69_ = ~x00 & x01 & (x13 | ~x16) & x18 & ~x19;
  assign z11 = new_n48_ | (~x00 & ~x22 & (new_n71_ | (new_n65_ & new_n72_)));
  assign new_n71_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n72_ = x20 & ~x13 & ~x14 & x15 & ~x21;
  assign z12 = new_n75_ & ((x00 & x01 & (~x02 | ~x10)) | (~new_n74_ & ~x00 & ~x01));
  assign new_n74_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign new_n75_ = (x13 | ~x16) & x09 & ~x24;
