...
module FAU ( 
  ...
  assign new_n50_ = x01 & (~x12 | ~x02 | ~x10 | x09 | ~x11);
  ...
  assign z06 = x00 & (~x01 | (new_n53_ & ~x09 & x11));
  assign z07 = x00 & (~x01 | (~x12 & new_n53_ & ~x09 & x11));
  ...
  assign z12 = ((~new_n71_ & ~x00 & ~x01) | (x01 & ~new_n53_ & x00)) & x09 & ~x24;
