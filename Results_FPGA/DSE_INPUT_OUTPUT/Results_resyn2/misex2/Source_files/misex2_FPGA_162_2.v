...
module FAU ( 
  ...
  assign z08 = new_n46_ | (new_n61_ & new_n62_);
  assign new_n61_ = ~x07 & ~x08 & ~x05 & ~x06 & ~x03 & x04;
  assign new_n62_ = x02 & ~x00 & ~x01 & x19 & x17 & ~x18;
  assign z09 = ~x21 & (x07 | (new_n64_ & (new_n65_ | (new_n66_ & new_n67_))));
  assign new_n64_ = ~x00 & ~x22;
  assign new_n65_ = x18 & ~x19 & x01 & ~x20;
  assign new_n66_ = ~x11 & x12 & ~x01 & x02;
  assign new_n67_ = ~x16 & x20 & ~x15 & ~x13 & ~x14;
  assign z10 = ~x00 & (new_n69_ | (new_n71_ & new_n66_ & new_n70_));
  assign new_n69_ = x22 & x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n70_ = ~x13 & ~x14 & ~x07 & x15;
  assign new_n71_ = ~x21 & ~x22 & x16 & x20;
  assign z11 = new_n64_ & ((new_n65_ & x21) | (new_n66_ & new_n70_ & new_n73_ & ~x21));
  assign new_n73_ = ~x16 & x20;
  assign z12 = new_n76_ & (new_n75_ | (x00 & x01 & (~x02 | ~x10)));
  assign new_n75_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign new_n76_ = (~x07 | x21) & x09 & ~x24;
