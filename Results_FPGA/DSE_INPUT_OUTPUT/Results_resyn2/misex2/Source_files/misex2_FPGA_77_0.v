...
module FAU ( 
  ...
  assign new_n61_ = x06 & ~x01 & x02 & ~x11 & x12;
  assign new_n62_ = ~x16 & x20 & ~x15 & ~x13 & ~x14;
  assign new_n63_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n65_ & x22) | (new_n67_ & new_n61_ & new_n66_));
  assign new_n65_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n66_ = x15 & ~x13 & ~x14;
  assign new_n67_ = x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n63_ & ((new_n60_ & x21) | (new_n61_ & new_n66_ & new_n69_ & ~x21));
