...
module FAU ( 
  ...
  assign new_n66_ = x01 & (x20 | ~x18 | x19 | x00 | ~x21);
  assign z12 = (~x01 & ~x22) | ((new_n68_ | new_n69_) & x09 & ~x24);
  assign new_n68_ = (~x02 | ~x10) & x00 & x01;
  assign new_n69_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign z13 = ~x00 & ~x02 & ~x01 & x22 & x17 & ~x19;
  assign z14 = ~x01 & (~x22 | (new_n72_ & ~x19 & ~x17 & ~x18));
  assign new_n72_ = ~x09 & ~x10 & ~x00 & ~x02;
