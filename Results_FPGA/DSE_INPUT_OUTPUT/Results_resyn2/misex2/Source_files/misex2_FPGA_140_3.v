...
module FAU ( 
  ...
  assign z03 = new_n53_ | (x01 & (new_n52_ | x06));
  assign new_n52_ = ~x09 & x00 & x02 & x10 & x11 & x12;
  assign new_n53_ = ~x02 & ~x00 & ~x01 & ~x19 & ~x17 & x18;
  assign z04 = new_n55_ & ~x11 & ~x12;
  assign new_n55_ = ~x09 & x00 & x02 & x10 & x01 & ~x06;
  assign z05 = x01 & (x06 | (x09 & x00 & x02 & x10));
  assign z06 = new_n55_ & x11;
  assign z07 = ~new_n59_ & x00 & x02;
  assign new_n59_ = x01 & (x06 | x09 | x12 | ~x10 | ~x11);
  assign z08 = new_n61_ & z17 & x19 & x17 & ~x18;
  assign new_n61_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = new_n49_ | ((new_n64_ | (new_n65_ & new_n66_)) & new_n67_ & ~x21);
  assign new_n64_ = x01 & x18 & ~x19 & ~x20;
  assign new_n65_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n67_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n65_ & new_n69_) | (new_n70_ & new_n71_));
  assign new_n69_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign new_n70_ = x22 & x18 & x21;
  assign new_n71_ = ~x19 & ~x20 & x01 & ~x06;
  assign z11 = new_n49_ | (new_n67_ & ((new_n65_ & new_n73_) | (new_n64_ & x21)));
  assign new_n73_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = new_n49_ | ((new_n75_ | new_n76_) & x09 & ~x24);
  ...
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & x06) | (~x01 & ~x02 & x19);
