...
module FAU ( 
  ...
  assign new_n49_ = ~x17 & ~x18 & ~x19 & ~x00 & ~x01 & ~x02;
  ...
  assign new_n64_ = ~x13 & ~x14 & x02 & ~x11 & x12 & ~x15;
  assign z10 = new_n61_ & new_n66_ & x16 & ~x22 & x20 & ~x21;
  assign new_n66_ = ~x13 & ~x14 & x15 & ~x11 & x12;
  assign z11 = new_n63_ & new_n61_ & new_n66_;
  assign z12 = (~x00 & x01) | (((~new_n69_ & ~x00) | (~new_n56_ & x01)) & x09 & ~x24);
