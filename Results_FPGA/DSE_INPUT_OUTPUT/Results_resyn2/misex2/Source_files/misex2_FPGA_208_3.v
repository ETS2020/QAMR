...
module FAU ( 
  ...
  assign z03 = new_n51_ | (new_n52_ & new_n53_ & x12);
  assign new_n51_ = ~x17 & ~x02 & ~x19 & x18 & ~x00 & ~x01;
  assign new_n52_ = x02 & ~x07 & x00 & x01;
  assign new_n53_ = x11 & ~x09 & x10;
  assign z04 = new_n52_ & ~x11 & ~x12 & ~x09 & x10;
  assign z05 = new_n56_ & x09 & x02 & x10;
  assign new_n56_ = ~x07 & x00 & x01;
  assign z06 = x01 & (x07 | (new_n53_ & x00 & x02));
  assign z07 = (x01 & x07) | (x00 & x02 & (~x01 | (new_n53_ & ~x12)));
