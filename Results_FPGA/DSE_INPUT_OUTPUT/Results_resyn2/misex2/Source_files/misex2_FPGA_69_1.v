...
module FAU ( 
  ...
  assign z00 = ~x01 & (x20 | (new_n46_ & ~x19 & ~x09 & ~x18));
  assign new_n46_ = x10 & ~x17 & ~x00 & ~x02;
  assign z01 = x10 & ~x17 & new_n48_ & x09 & ~x18;
  assign new_n48_ = ~x19 & ~x20 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x10 & ~x17 & new_n48_ & x09 & ~x18;
  assign z03 = (~new_n51_ & ~x01) | (z06 & x12);
  assign new_n51_ = ~x20 & (x17 | x00 | x02 | ~x18 | x19);
  ...
  assign new_n60_ = x19 & ~x20 & x17 & ~x18;
  assign z09 = new_n62_ & ~x22 & ~x20 & ~x21;
  assign new_n62_ = x18 & ~x19 & ~x00 & x01;
  assign z10 = (~x01 & x20) | (x18 & ~x00 & x01 & new_n64_ & x22);
  assign new_n64_ = x21 & ~x19 & ~x20;
  assign z11 = (~x01 & x20) | (x18 & ~x00 & x01 & new_n64_ & ~x22);
  assign z12 = (~x01 & x20) | ((new_n67_ | new_n68_) & x09 & ~x24);
  assign new_n67_ = x00 & x01 & (~x02 | ~x10);
  assign new_n68_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign z13 = ~x01 & (x20 | (~x00 & ~x02 & x17 & ~x19));
  assign z14 = new_n48_ & ~x10 & ~x17 & ~x09 & ~x18;
