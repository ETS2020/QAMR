...
module FAU ( 
  ...
  assign z09 = new_n64_ & ~x21 & (new_n60_ | (new_n61_ & new_n62_ & new_n63_));
  assign new_n60_ = x18 & ~x19 & x01 & ~x20;
  assign new_n61_ = x05 & ~x01 & x02;
  assign new_n62_ = ~x13 & ~x11 & x12;
  assign new_n63_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n64_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n66_ & x22) | (new_n68_ & new_n62_ & new_n67_));
  assign new_n66_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = ~x01 & x02 & ~x14 & x15;
  assign new_n68_ = ~x22 & x20 & ~x21 & x05 & x16;
  assign z11 = new_n55_ | (new_n64_ & (new_n66_ | (new_n70_ & new_n62_ & new_n67_)));
  assign new_n70_ = ~x21 & ~x16 & x20;
  assign z12 = new_n55_ | ((new_n72_ | new_n73_) & x09 & ~x24);
