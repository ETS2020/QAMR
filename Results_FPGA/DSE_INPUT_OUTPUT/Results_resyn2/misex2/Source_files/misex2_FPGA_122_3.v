...
module FAU ( 
  ...
  assign z03 = new_n50_ | (x12 & new_n51_ & ~x20 & x10 & x11);
  assign new_n50_ = ~x00 & ~x01 & ~x02 & ~x17 & x18 & ~x19;
  assign new_n51_ = x00 & x01 & x02 & ~x09;
  assign z04 = x01 & (new_n53_ | x20);
  assign new_n53_ = ~x09 & x10 & x02 & ~x11 & x00 & ~x12;
  assign z05 = x01 & (x20 | (x00 & x02 & x09 & x10));
  assign z06 = new_n51_ & ~x20 & x10 & x11;
  assign z07 = ~new_n57_ & x00 & x02;
  assign new_n57_ = x01 & (x09 | ~x10 | x20 | ~x11 | x12);
  assign z08 = new_n59_ & z17 & x19 & x17 & ~x18;
  assign new_n59_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = new_n62_ | (new_n66_ & ~x00 & (new_n63_ | (new_n64_ & new_n65_)));
  assign new_n62_ = x01 & x20;
  assign new_n63_ = x01 & x18 & ~x19;
  assign new_n64_ = x02 & ~x11 & x12 & ~x13;
  assign new_n65_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = ~x21 & ~x22;
  assign z10 = (new_n62_ | ~x00) & ((new_n68_ & new_n69_) | new_n62_ | (new_n70_ & x22));
  assign new_n68_ = x02 & ~x11 & x12 & ~x13 & ~x14 & x15;
  assign new_n69_ = ~x21 & ~x22 & x16 & x20;
  assign new_n70_ = x21 & x01 & x18 & ~x19;
  assign z11 = new_n62_ | (~x00 & ~x22 & (new_n70_ | (new_n68_ & new_n72_)));
  assign new_n72_ = ~x21 & ~x16 & x20;
  assign z12 = new_n62_ | (x09 & ~x24 & (new_n74_ | new_n75_));
