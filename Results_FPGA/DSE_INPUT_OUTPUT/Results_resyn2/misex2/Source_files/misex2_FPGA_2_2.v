...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
    new_n61_, new_n64_, new_n65_, new_n69_;
  assign z00 = new_n46_ & ~x09 & ~x02 & ~x00 & ~x01;
  assign new_n46_ = ~x18 & ~x19 & x10 & ~x17;
  assign z01 = (x01 & ~x20) | (new_n46_ & x09 & ~x02 & ~x00 & ~x01);
  assign z02 = (x01 & ~x20) | (new_n49_ & x09 & ~x02 & ~x00 & ~x01);
  ...
  assign z05 = x01 & (~x20 | (x02 & x10 & x00 & x09));
  ...
  assign new_n60_ = x01 & ~x20;
  assign new_n61_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = new_n60_ | (new_n64_ & new_n65_ & ~x16 & ~x14 & ~x15);
  assign new_n64_ = x02 & ~x00 & ~x01 & ~x13 & ~x11 & x12;
  assign new_n65_ = ~x22 & x20 & ~x21;
  assign z10 = new_n60_ | (new_n64_ & new_n65_ & x16 & ~x14 & x15);
  assign z11 = new_n64_ & new_n65_ & ~x16 & ~x14 & x15;
  assign z12 = (new_n69_ | (new_n54_ & (~x02 | ~x10))) & x09 & ~x24;
  assign new_n69_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign z13 = x17 & ~x19 & ~x02 & ~x00 & ~x01;
  assign z14 = (new_n49_ & ~x09 & ~x02 & ~x00 & ~x01) | (x01 & ~x20);
  assign z15 = (~x10 & x20 & x00 & x01) | ((~x01 | (x00 & x20)) & ~x02 & (x00 | x19));
