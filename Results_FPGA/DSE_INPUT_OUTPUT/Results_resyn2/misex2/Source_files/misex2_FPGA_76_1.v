...
module FAU ( 
  ...
  assign new_n49_ = ~x02 & ~x21 & ~x00 & ~x01;
  ...
  assign z10 = (~x01 & x21) | (~x00 & (new_n67_ | (new_n64_ & new_n68_)));
  assign new_n67_ = x18 & ~x19 & x22 & ~x20 & x21;
  assign new_n68_ = ~x14 & x15 & ~x22 & x16 & x20;
  assign z11 = ~x00 & ~x22 & ((new_n64_ & new_n70_) | (new_n63_ & x21));
  assign new_n70_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = (~x01 & x21) | ((new_n72_ | new_n73_) & x09 & ~x24);
