...
module FAU ( 
  ...
  assign z03 = (x00 & (new_n51_ | ~x01)) | (new_n52_ & x18 & ~x01 & ~x17);
  assign new_n51_ = x02 & ~x09 & x12 & x10 & x11;
  assign new_n52_ = ~x02 & ~x19;
  assign z04 = x10 & x00 & x01 & ~x11 & new_n54_ & ~x12;
  assign new_n54_ = x02 & ~x09;
  assign z05 = new_n56_ & x09 & x00 & x01;
  assign new_n56_ = x02 & x10;
  assign z06 = x10 & x00 & x01 & new_n54_ & x11;
  assign z07 = x00 & (~x01 | (new_n54_ & ~x12 & x10 & x11));
  assign z08 = new_n60_ & new_n61_ & ~x08 & x17 & ~x18 & x19;
  assign new_n60_ = x04 & ~x05 & ~x06 & ~x07;
  assign new_n61_ = ~x00 & ~x01 & x02 & ~x03;
  assign z09 = (new_n63_ | (new_n64_ & new_n65_)) & ~x22 & ~x00 & ~x21;
  assign new_n63_ = x01 & x18 & ~x19 & ~x20;
  assign new_n64_ = x02 & ~x11 & ~x14 & x12 & ~x13;
  assign new_n65_ = ~x01 & ~x15 & ~x16 & x20;
  assign z10 = (new_n68_ & new_n69_) | (~x01 & (x00 | (new_n64_ & new_n67_)));
  assign new_n67_ = x15 & x16 & ~x22 & x20 & ~x21;
  assign new_n68_ = ~x00 & x21 & x01 & x18;
  assign new_n69_ = x22 & ~x19 & ~x20;
  assign z11 = (~x01 & (x00 | (new_n64_ & new_n71_))) | (new_n68_ & new_n72_);
  assign new_n71_ = x15 & ~x16 & ~x22 & x20 & ~x21;
  assign new_n72_ = ~x22 & ~x19 & ~x20;
  assign z12 = (x00 & ~x01) | (((~new_n56_ & x00) | (~new_n74_ & ~x01)) & x09 & ~x24);
  assign new_n74_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = ~x00 & ~x01 & new_n52_ & x17;
