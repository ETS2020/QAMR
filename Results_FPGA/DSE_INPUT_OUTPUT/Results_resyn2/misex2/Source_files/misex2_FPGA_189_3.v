...
module FAU ( 
  ...
  assign z00 = (x01 & x02) | (new_n46_ & ~x09 & ~x02 & ~x00 & ~x01);
  assign new_n46_ = x10 & ~x19 & ~x17 & ~x18;
  assign z01 = (x01 & x02) | (new_n46_ & x09 & ~x02 & ~x00 & ~x01);
  ...
  assign new_n57_ = x01 & ~x02 & ~x20 & x18 & ~x19;
  assign new_n58_ = ~x01 & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n59_ = ~x21 & ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n58_ & new_n61_) | (new_n57_ & x21 & x22));
  assign new_n61_ = x15 & x16 & ~x22 & x20 & ~x21;
  assign z11 = z04 | (~x00 & ~x22 & (new_n65_ | (new_n63_ & new_n64_)));
  assign new_n63_ = ~x11 & x12 & ~x13 & ~x14;
  assign new_n64_ = ~x16 & x20 & ~x21 & x02 & x15;
  assign new_n65_ = ~x20 & x18 & ~x19 & x01 & x21;
  assign z12 = ~new_n67_ & x09 & ~x24;
  assign new_n67_ = ((~x00 & (~x17 | x19)) | (~x00 & x01) | x02 | (x00 & ~x01)) & ((~x02 & ~x19) | ~x23 | x00 | x01);
  assign z13 = x17 & ~x19 & ~x02 & ~x00 & ~x01;
  assign z14 = (x01 & x02) | (new_n49_ & ~x09 & ~x02 & ~x00 & ~x01);
  assign z15 = (x01 | ~x02) & (x00 | ((x02 | x19) & (~x01 | x02)));
