...
module FAU ( 
  ...
  assign z04 = x01 & (~x22 | (new_n54_ & ~x12 & x10 & ~x11));
  assign new_n54_ = ~x09 & x00 & x02;
  assign z05 = x01 & (~x22 | (x09 & x10 & x00 & x02));
  assign z06 = new_n54_ & x10 & x11 & x01 & x22;
  ...
  assign z09 = ~x15 & new_n64_ & x02 & ~x11 & new_n63_ & ~x16;
  assign new_n63_ = ~x00 & ~x01;
  assign new_n64_ = ~x22 & x20 & ~x21 & ~x14 & x12 & ~x13;
  assign z10 = ~new_n68_ & (new_n69_ | (new_n67_ & new_n66_ & new_n70_));
  assign new_n66_ = ~x22 & x20 & ~x21;
  assign new_n67_ = ~x14 & x12 & ~x13;
  assign new_n68_ = x00 & (~x01 | x22);
  assign new_n69_ = x01 & (~x22 | (~x20 & x21 & x18 & ~x19));
  assign new_n70_ = x15 & x16 & x02 & ~x11;
  assign z11 = x15 & new_n64_ & x02 & ~x11 & new_n63_ & ~x16;
  assign z12 = (new_n73_ | new_n74_) & x09 & ~x24;
  assign new_n73_ = (~x02 | ~x10) & x22 & x00 & x01;
