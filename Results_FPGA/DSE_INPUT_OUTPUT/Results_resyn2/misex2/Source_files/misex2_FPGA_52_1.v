...
module FAU ( 
  ...
  assign z03 = (z06 & x12) | (new_n52_ & new_n53_);
  assign z06 = x11 & x00 & x02 & x01 & ~x09 & x10;
  assign new_n52_ = ~x01 & ~x00 & ~x04;
  assign new_n53_ = x18 & ~x19 & ~x02 & ~x17;
  ...
  assign z09 = new_n60_ | ((new_n63_ | (new_n61_ & new_n62_)) & new_n64_ & ~x21);
  assign new_n60_ = ~x01 & x04;
  assign new_n61_ = ~x16 & x20 & ~x13 & ~x11 & x12;
