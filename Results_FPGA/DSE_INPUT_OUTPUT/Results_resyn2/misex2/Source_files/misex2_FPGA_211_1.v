...
module FAU ( 
  ...
  assign z03 = (x01 & x00 & x02 & new_n52_ & x12) | (new_n53_ & ~x02 & ~x00 & ~x01);
  ...
  assign z10 = ~x00 & (x01 | (new_n64_ & new_n67_));
  assign new_n67_ = x15 & x16 & ~x22 & x20 & ~x21;
  assign z11 = new_n64_ & new_n65_ & x15 & ~x00 & ~x01;
  assign z12 = (~x00 & x01) | (((~new_n57_ & x01) | (~new_n70_ & ~x00)) & x09 & ~x24);
