...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n49_, new_n52_, new_n54_, new_n55_, new_n57_, new_n58_, new_n59_,
    new_n60_, new_n62_, new_n63_, new_n65_, new_n67_;
  assign z01 = ~x01 & ~x17;
  assign z03 = z01 | (z06 & x12);
  ...
  assign new_n52_ = (x01 | ~x17) & (~x01 | x09 | x12 | ~x10 | ~x11);
  assign z08 = ~x01 & (~x17 | (new_n54_ & new_n55_));
  assign new_n54_ = ~x07 & ~x08 & ~x18 & x19;
  assign new_n55_ = ~x00 & x02 & ~x03 & x04 & ~x05 & ~x06;
  ...
  assign new_n63_ = ~x14 & x15 & x20 & ~x21 & x16 & ~x22;
  assign z11 = z01 | (new_n60_ & (new_n62_ | (new_n58_ & new_n65_)));
  assign new_n65_ = ~x16 & ~x14 & x15 & x20 & ~x21;
  assign z12 = z01 | (~new_n67_ & x09 & ~x24);
  assign new_n67_ = (~x00 | ~x01 | (x02 & x10)) & (x00 | x01 | (~x23 & (x02 | x19)));
  assign z13 = ~x02 & ~x19 & ~x00 & ~x01 & x17;
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (~x01 & (~x17 | (~x02 & x19)));
  assign z16 = x01 ? ~x00 : ~x17;
  assign z17 = x02 & ~x00 & ~x01 & x17;
  assign z00 = 1'b0;
  assign z02 = z01;
  assign z14 = z01;
endmodule
