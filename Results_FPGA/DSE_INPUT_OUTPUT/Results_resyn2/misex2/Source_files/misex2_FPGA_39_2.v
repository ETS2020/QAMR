...
module FAU ( 
  ...
  assign z03 = new_n54_ | (x01 & (new_n53_ | ~x08));
  assign new_n53_ = x11 & ~x09 & x10 & x12 & x00 & x02;
  assign new_n54_ = ~x02 & ~x00 & ~x01 & ~x19 & ~x17 & x18;
  assign z04 = new_n56_ & ~x12 & ~x09 & ~x11;
  assign new_n56_ = x10 & x00 & x08 & x01 & x02;
  assign z05 = new_n56_ & x09;
  assign z06 = new_n59_ & x00 & x08 & x01 & x02;
  assign new_n59_ = x11 & ~x09 & x10;
  assign z07 = x00 & x02 & (~x01 | (new_n59_ & x08 & ~x12));
  assign z08 = new_n62_ & z17 & x19 & x17 & ~x18;
  assign new_n62_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = new_n46_ | (new_n68_ & ~x21 & (new_n65_ | (new_n66_ & new_n67_)));
  assign new_n65_ = ~x19 & ~x20 & x01 & x18;
  assign new_n66_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n67_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n68_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n66_ & new_n71_) | (new_n70_ & x08 & x22));
  assign new_n70_ = x21 & ~x19 & ~x20 & x01 & x18;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n46_ | (new_n68_ & (new_n70_ | (new_n66_ & new_n73_)));
  ...
  assign z13 = x17 & new_n47_ & ~x19;
  assign z14 = new_n46_ | (new_n51_ & new_n47_ & ~x09);
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & ~x08) | (x19 & ~x01 & ~x02);
