...
module FAU ( 
  ...
  assign new_n58_ = (x01 | x15) & (~x11 | x09 | ~x10 | ~x01 | x12);
  assign z08 = new_n60_ & new_n61_ & x19 & x17 & ~x18;
  assign new_n60_ = ~x00 & ~x01 & x02 & ~x03 & x04 & ~x05;
  assign new_n61_ = ~x06 & ~x07 & ~x08 & ~x15;
  assign z09 = new_n65_ & (new_n63_ | (new_n64_ & x20 & ~x14 & ~x16));
  assign new_n63_ = ~x19 & ~x20 & x01 & x18;
  assign new_n64_ = ~x01 & ~x15 & x02 & ~x11 & x12 & ~x13;
  assign new_n65_ = ~x22 & ~x00 & ~x21;
  assign z10 = (~x01 & x15) | (new_n67_ & x22 & ~x19 & ~x20);
  assign new_n67_ = ~x00 & x01 & x18 & x21;
  assign z11 = (new_n67_ & ~x22 & ~x19 & ~x20) | (~x01 & x15);
  assign z12 = (~x01 & x15) | ((new_n70_ | new_n71_) & x09 & ~x24);
