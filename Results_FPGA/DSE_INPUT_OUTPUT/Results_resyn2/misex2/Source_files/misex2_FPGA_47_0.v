...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
    ...
    new_n72_, new_n73_;
  assign z00 = ~x01 & (~x16 | (new_n46_ & ~x09 & ~x00 & ~x02));
  assign new_n46_ = ~x18 & ~x19 & x10 & ~x17;
  assign z01 = ~x01 & (~x16 | (new_n46_ & x09 & ~x00 & ~x02));
  assign z02 = new_n49_ & ~x10 & x09 & ~x00 & ~x02;
  assign new_n49_ = ~x01 & x16 & ~x17 & ~x18 & ~x19;
  assign z03 = (new_n51_ & x12) | (new_n52_ & ~x17 & ~x01 & x16);
  assign new_n51_ = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign new_n52_ = ~x00 & ~x02 & x18 & ~x19;
  assign z04 = new_n54_ & x02 & x00 & x01;
  assign new_n54_ = ~x11 & ~x12 & ~x09 & x10;
  assign z05 = x02 & x10 & x09 & x00 & x01;
  assign z06 = new_n51_ | (~x01 & ~x16);
  ...
  assign new_n64_ = ~x00 & x18 & ~x19 & x01 & ~x20;
  ...
  assign z11 = new_n64_ & x21 & ~x22;
  assign z12 = (new_n71_ | (~new_n72_ & new_n73_)) & x09 & ~x24;
  assign new_n71_ = x00 & x01 & (~x02 | ~x10);
  assign new_n72_ = ~x23 & (x02 | x19);
  assign new_n73_ = (x17 | x02 | x19) & ~x00 & ~x01 & x16;
  assign z13 = ~x01 & (~x16 | (~x00 & ~x02 & x17 & ~x19));
  assign z14 = new_n49_ & ~x00 & ~x02 & ~x09 & ~x10;
