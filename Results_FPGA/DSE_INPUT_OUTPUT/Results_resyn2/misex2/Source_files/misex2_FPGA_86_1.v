...
module FAU ( 
  ...
  assign new_n48_ = ~x13 & ~x00 & ~x01 & ~x02 & x09;
  assign z02 = new_n48_ & new_n50_;
  assign new_n50_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (new_n52_ & x12) | (new_n53_ & ~x17 & ~x02 & ~x13);
  assign new_n52_ = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign new_n53_ = ~x00 & ~x01 & x18 & ~x19;
  assign z04 = (~x01 & x13) | (new_n55_ & x02 & x00 & x01);
  assign new_n55_ = ~x11 & ~x12 & ~x09 & x10;
  assign z05 = (~x01 & x13) | (x02 & x10 & x09 & x00 & x01);
  assign z06 = new_n52_ | new_n58_;
  assign new_n58_ = ~x01 & x13;
  assign z07 = (new_n60_ | ~x01) & (x01 | ~x13) & x00 & x02;
  assign new_n60_ = ~x12 & x11 & ~x09 & x10;
  assign z08 = new_n62_ & x02 & new_n63_ & x19 & x17 & ~x18;
  assign new_n62_ = ~x13 & ~x00 & ~x01;
  assign new_n63_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z09 = new_n58_ | ((new_n65_ | (new_n66_ & new_n67_)) & new_n68_ & ~x21);
  assign new_n65_ = x18 & ~x19 & x01 & ~x20;
  assign new_n66_ = ~x11 & x12 & ~x01 & x02;
  assign new_n67_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n68_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n70_ & x22) | (new_n66_ & new_n72_ & new_n71_ & ~x22));
  assign new_n70_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n71_ = x20 & ~x21;
  assign new_n72_ = ~x14 & x15 & ~x13 & x16;
  assign z11 = new_n58_ | (new_n68_ & (new_n70_ | (new_n66_ & new_n74_)));
  assign new_n74_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = x09 & ~x24 & (new_n76_ | (~new_n77_ & new_n78_));
  assign new_n76_ = x00 & x01 & (~x02 | ~x10);
  assign new_n77_ = ~x17 & ~x02 & ~x19;
  assign new_n78_ = ~x13 & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign z13 = ~x01 & (x13 | (x17 & ~x19 & ~x00 & ~x02));
