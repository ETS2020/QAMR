...
module FAU ( 
  ...
  assign z07 = ~new_n59_ & ~new_n46_ & x00 & x02;
  assign new_n59_ = x01 & (x12 | ~x11 | x09 | ~x10);
  assign z08 = new_n62_ & new_n61_ & ~x07 & ~x08 & ~x05 & ~x06;
  assign new_n61_ = (x15 | x21) & ~x03 & x04;
  assign new_n62_ = ~x00 & ~x01 & x02 & x19 & x17 & ~x18;
  assign z09 = ~x21 & (new_n64_ | ~x15);
  assign new_n64_ = ~x00 & ~x22 & x18 & ~x19 & x01 & ~x20;
  assign z10 = new_n46_ | (~x00 & ((new_n67_ & new_n68_) | (new_n66_ & x22)));
  assign new_n66_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n68_ = x20 & ~x21 & ~x22 & ~x14 & x16;
  assign z11 = ~x00 & ~x22 & (new_n66_ | (new_n67_ & new_n70_));
  assign new_n70_ = x20 & ~x21 & ~x16 & ~x14 & x15;
  assign z12 = new_n46_ | (x09 & ~x24 & (new_n72_ | new_n73_));
  assign new_n72_ = (~x02 | ~x10) & x00 & x01;
  assign new_n73_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign z13 = ~new_n46_ & x17 & ~x00 & ~x01 & ~x02 & ~x19;
