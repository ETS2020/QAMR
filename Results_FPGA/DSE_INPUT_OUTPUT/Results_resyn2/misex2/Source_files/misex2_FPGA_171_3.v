...
module FAU ( 
  ...
  assign new_n57_ = x18 & ~x19 & ~x20 & x01 & ~x02;
  assign new_n58_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n59_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((new_n61_ & x22) | (new_n58_ & new_n62_ & x16 & ~x22));
  assign new_n61_ = x21 & x18 & ~x19 & ~x20 & x01 & ~x02;
  assign new_n62_ = x20 & ~x21 & ~x14 & x15;
  assign z11 = ~x00 & ~x22 & (new_n61_ | (new_n58_ & new_n62_ & ~x16));
  assign z12 = (x01 & (x02 | (~x24 & x00 & x09))) | (~new_n65_ & ~x24 & ~x00 & x09);
  assign new_n65_ = (~x02 | ~x23) & (x01 | (x19 ? ~x23 : (x02 | ~x17)));
  assign z13 = (x01 & x02) | (~x00 & ~x01 & ~x19 & ~x02 & x17);
  assign z14 = ~x10 & ~x19 & ~x17 & ~x18 & new_n48_ & ~x09;
  assign z15 = (x19 & ~x01 & ~x02) | (x01 & x02) | (x00 & ~x02);
