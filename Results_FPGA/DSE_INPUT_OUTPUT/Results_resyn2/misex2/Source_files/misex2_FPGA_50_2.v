...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
    new_n63_, new_n64_, new_n66_, new_n67_, new_n68_, new_n69_, new_n72_,
    new_n73_;
  ...
  assign z03 = new_n51_ | (x22 & x00 & x01 & new_n52_ & x12);
  assign new_n51_ = ~x17 & ~x02 & ~x19 & x18 & ~x00 & ~x01;
  assign new_n52_ = x02 & ~x09 & x10 & x11;
  assign z04 = x01 & (new_n54_ | ~x22);
  assign new_n54_ = x02 & ~x09 & x00 & x10 & ~x11 & ~x12;
  assign z05 = x22 & x00 & x01 & x09 & x02 & x10;
  assign z06 = x01 & (~x22 | (new_n52_ & x00));
  assign z07 = (x01 & ~x22) | ((new_n58_ | ~x01) & x00 & x02);
  assign new_n58_ = x10 & x11 & ~x09 & ~x12;
  assign z08 = new_n60_ & z17 & x19 & x17 & ~x18;
  assign new_n60_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = ~x15 & new_n63_ & z17 & new_n64_;
  assign new_n63_ = x12 & ~x13 & ~x16 & ~x11 & ~x14;
  assign new_n64_ = ~x22 & x20 & ~x21;
  assign z10 = ~new_n66_ & (new_n67_ | (new_n64_ & new_n68_ & new_n69_));
  assign new_n66_ = x00 & (~x01 | x22);
  assign new_n67_ = x01 & (~x22 | (x18 & ~x19 & ~x20 & x21));
  assign new_n68_ = x16 & ~x14 & x15;
  assign new_n69_ = x02 & ~x11 & x12 & ~x13;
  assign z11 = x15 & new_n63_ & z17 & new_n64_;
  ...
  assign z15 = (~x02 & ((x00 & (~x01 | x22)) | (~x01 & x19))) | (~x10 & x22 & x00 & x01);
