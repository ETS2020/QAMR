...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n50_, new_n52_, new_n53_, new_n55_, new_n59_,
    ...
    new_n72_;
  assign z00 = (x01 & ~x20) | (new_n47_ & new_n46_ & ~x09);
  ...
  assign z03 = new_n53_ | (x01 & (~x20 | (new_n52_ & x12)));
  ...
  assign z05 = x10 & x20 & x00 & x02 & x01 & x09;
  assign z06 = x01 & (new_n52_ | ~x20);
  assign z07 = ~new_n59_ & x00 & x02;
  assign new_n59_ = x01 & (~x10 | ~x20 | x12 | x09 | ~x11);
  ...
  assign z09 = new_n62_ & new_n65_ & new_n66_ & ~x15;
  assign new_n65_ = ~x13 & ~x14 & ~x11 & x12;
  assign new_n66_ = ~x16 & ~x22 & x20 & ~x21;
  assign z10 = new_n68_ & x15 & new_n62_ & new_n65_;
  assign new_n68_ = x16 & ~x22 & x20 & ~x21;
  assign z11 = (x01 & ~x20) | (new_n66_ & x15 & new_n62_ & new_n65_);
  assign z12 = (x01 & ~x20) | ((new_n71_ | new_n72_) & x09 & ~x24);
  assign new_n71_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign new_n72_ = x00 & x01 & (~x02 | ~x10);
  assign z13 = x17 & new_n46_ & ~x19;
  assign z14 = (x01 & ~x20) | (new_n50_ & new_n46_ & ~x09);
  assign z15 = (x00 & (~x02 | (x01 & ~x10))) | (x01 & ~x20) | (x19 & ~x01 & ~x02);
  assign z16 = x01 & (~x00 | ~x20);
  assign z17 = new_n62_ | (x01 & ~x20);
endmodule
