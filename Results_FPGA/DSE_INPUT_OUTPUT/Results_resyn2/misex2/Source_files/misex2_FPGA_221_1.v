...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n47_, new_n50_, new_n52_, new_n55_, new_n58_, new_n60_,
  ...
  assign new_n47_ = ~x02 & ~x00 & ~x01 & ~x09 & ~x16;
  ...
  assign z04 = (~x01 & x16) | (new_n55_ & x02 & x00 & x01);
  assign new_n55_ = ~x11 & ~x12 & ~x09 & x10;
  assign z05 = x02 & x10 & x00 & x01 & x09;
  assign z07 = (new_n58_ | ~x01) & x00 & x02 & (x01 | ~x16);
  assign new_n58_ = ~x12 & x11 & ~x09 & x10;
  assign z08 = new_n60_ & new_n61_ & ~x00 & ~x01 & x02;
  assign new_n60_ = ~x05 & ~x06 & ~x03 & x04 & ~x16 & x17;
  assign new_n61_ = ~x07 & ~x08 & ~x18 & x19;
  assign z09 = new_n63_ | (new_n67_ & (new_n64_ | (new_n65_ & new_n66_ & ~x15)));
  assign new_n63_ = ~x01 & x16;
  assign new_n64_ = x18 & ~x19 & x01 & ~x20;
  assign new_n65_ = ~x01 & x02 & ~x11 & x12;
  assign new_n66_ = x20 & ~x13 & ~x14;
  assign new_n67_ = ~x21 & ~x00 & ~x22;
  assign z10 = new_n69_ & ~x00 & x22;
  assign new_n69_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign z11 = new_n63_ | (~x00 & ~x22 & (new_n69_ | (new_n65_ & new_n71_)));
  assign new_n71_ = x20 & ~x13 & ~x14 & x15 & ~x21;
  assign z12 = new_n63_ | ((new_n73_ | new_n74_) & x09 & ~x24);
  assign new_n73_ = x00 & x01 & (~x02 | ~x10);
  assign new_n74_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign z13 = ~x02 & ~x00 & ~x01 & ~x19 & ~x16 & x17;
