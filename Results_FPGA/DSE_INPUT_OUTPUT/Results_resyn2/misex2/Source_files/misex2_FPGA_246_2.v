...
module FAU ( 
  ...
  assign z10 = ~x00 & ((new_n68_ & x22) | (new_n65_ & new_n69_ & x16 & ~x22));
  assign new_n68_ = x21 & x01 & ~x20 & x18 & ~x19;
  assign new_n69_ = ~x14 & x15 & x20 & ~x21;
  assign z11 = (x00 & ~x24) | (~x00 & ~x22 & (new_n68_ | (new_n65_ & new_n71_)));
  assign new_n71_ = ~x16 & x20 & ~x21 & ~x14 & x15;
  assign z12 = ~x24 & (new_n73_ | x00);
  assign new_n73_ = ((~x02 & ~x19) ? x17 : x23) & ~x01 & x09;
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = (x00 & ~x24) | (new_n50_ & new_n46_ & ~x09);
  assign z15 = (x00 & x24 & (~x02 | (x01 & ~x10))) | (x19 & ~x02 & ~x00 & ~x01);
  assign z16 = x00 ? ~x24 : x01;
