...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n54_, new_n57_, new_n59_, new_n60_,
    ...
    new_n72_, new_n73_;
  assign z00 = ~x09 & ~x02 & ~x00 & ~x01 & new_n46_ & x12;
  assign new_n46_ = x10 & ~x19 & ~x17 & ~x18;
  assign z01 = ~x01 & (~x12 | (new_n46_ & x09 & ~x00 & ~x02));
  assign z02 = new_n49_ & ~x01 & x09 & ~x00 & ~x02;
  assign new_n49_ = ~x19 & ~x17 & ~x18 & ~x10 & x12;
  assign z03 = (~x01 & (new_n51_ | ~x12)) | (z06 & x12);
  assign new_n51_ = x18 & ~x19 & ~x17 & ~x00 & ~x02;
  ...
  assign new_n57_ = (x01 | ~x12) & (~x10 | x12 | ~x11 | ~x01 | x09);
  assign z08 = new_n59_ & new_n60_ & x02 & ~x00 & ~x01;
  assign new_n59_ = x12 & x17 & ~x05 & ~x06 & ~x03 & x04;
  assign new_n60_ = ~x07 & ~x08 & ~x18 & x19;
  assign z09 = (new_n62_ | (new_n63_ & new_n64_ & ~x15)) & new_n65_ & ~x21;
  assign new_n62_ = x18 & ~x19 & x01 & ~x20;
  assign new_n63_ = ~x13 & ~x14 & ~x01 & x02 & ~x11 & x12;
  assign new_n64_ = ~x16 & x20;
  assign new_n65_ = ~x00 & ~x22;
  assign z10 = (~x01 & ~x12) | (~x00 & (new_n67_ | (new_n68_ & new_n69_)));
  assign new_n67_ = x22 & x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n68_ = ~x21 & ~x22 & x16 & x20;
  assign new_n69_ = ~x13 & ~x14 & ~x01 & x02 & ~x11 & x15;
  assign z11 = new_n65_ & ((new_n62_ & x21) | (new_n63_ & new_n64_ & x15 & ~x21));
  assign z12 = (~x01 & ~x12) | ((new_n72_ | new_n73_) & x09 & ~x24);
  ...
  assign z15 = (x00 & x01 & (~x02 | ~x10)) | ((x00 | (~x01 & x19)) & ~x02 & x12);
