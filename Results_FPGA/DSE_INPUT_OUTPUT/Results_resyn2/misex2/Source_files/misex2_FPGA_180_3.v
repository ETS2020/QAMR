...
module FAU ( 
  ...
  assign z03 = new_n52_ | (x11 & (x17 | (new_n51_ & x12)));
  assign new_n51_ = ~x09 & x02 & x10 & x00 & x01;
  assign new_n52_ = ~x17 & ~x02 & ~x19 & x18 & ~x00 & ~x01;
  assign z04 = new_n51_ & ~x11 & ~x12;
  assign z05 = x02 & x10 & x00 & x01 & ~new_n55_ & x09;
  assign new_n55_ = x11 & x17;
  assign z06 = x11 & (new_n51_ | x17);
  ...
  assign new_n61_ = ~x11 & x17 & ~x18 & x19;
  assign z09 = (new_n63_ | (new_n64_ & new_n65_)) & ~x21 & ~x00 & ~x22;
  assign new_n63_ = x01 & (~x11 | ~x17) & ~x20 & x18 & ~x19;
  ...
  assign z11 = ~x00 & ~x22 & ((new_n64_ & new_n69_) | (new_n63_ & x21));
  assign new_n69_ = ~x16 & x20 & ~x21 & ~x14 & x15;
  assign z12 = (new_n71_ | x00) & new_n72_ & (~x00 | (x01 & (~x02 | ~x10)));
  assign new_n71_ = (x23 | (~x02 & ~x19)) & ~x01 & (x17 | x02 | x19);
  assign new_n72_ = ~x24 & x09 & (~x11 | ~x17);
  assign z13 = x17 & (x11 | (~x19 & ~x02 & ~x00 & ~x01));
