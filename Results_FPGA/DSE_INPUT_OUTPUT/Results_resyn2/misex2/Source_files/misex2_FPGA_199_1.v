...
module FAU ( 
  ...
  assign new_n49_ = (x03 | ~x21) & ~x19 & ~x17 & ~x18;
  assign z02 = new_n51_ & ~x00 & ~x01 & ~x02 & x09;
  assign new_n51_ = ~x10 & ~x19 & ~x17 & ~x18 & (x03 | ~x21);
  ...
  assign new_n56_ = (x03 | ~x21) & x02 & x00 & x01;
  assign z05 = new_n56_ & x09 & x10;
  ...
  assign z09 = (~x03 & x21) | ((new_n65_ | (new_n66_ & new_n67_)) & new_n68_ & ~x21);
  assign new_n65_ = ~x19 & ~x20 & x01 & x18;
  assign new_n66_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n67_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n68_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n66_ & new_n71_) | (new_n70_ & x22));
  assign new_n70_ = ~x19 & ~x20 & x01 & x18 & x03 & x21;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n68_ & (new_n70_ | (new_n66_ & new_n73_));
  assign new_n73_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = new_n46_ | ((new_n75_ | new_n76_) & x09 & ~x24);
