...
module FAU ( 
  ...
  assign z09 = (x01 & (new_n57_ | x00)) | (new_n58_ & new_n59_ & ~x00 & ~x01 & x02);
  assign new_n57_ = ~x21 & ~x22 & ~x20 & x18 & ~x19;
  assign new_n58_ = ~x13 & ~x11 & x12 & x20 & ~x21 & ~x22;
  assign new_n59_ = ~x16 & ~x14 & ~x15;
  assign z10 = ~x00 & ((new_n61_ & x22) | (new_n58_ & new_n62_ & x16));
  assign new_n61_ = ~x20 & x18 & ~x19 & x01 & x21;
  assign new_n62_ = ~x01 & x02 & ~x14 & x15;
  assign z11 = ~x00 & ~x22 & (new_n61_ | (new_n62_ & new_n64_));
  assign new_n64_ = ~x13 & ~x11 & x12 & ~x21 & ~x16 & x20;
