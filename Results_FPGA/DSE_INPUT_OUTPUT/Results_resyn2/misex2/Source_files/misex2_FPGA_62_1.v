...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n50_, new_n52_, new_n53_, new_n54_, new_n60_,
    new_n63_, new_n64_, new_n66_, new_n68_, new_n70_;
  ...
  assign new_n52_ = ~x17 & ~x02 & ~x19 & ~x00 & ~x01 & x18;
  assign new_n53_ = x00 & x01;
  assign new_n54_ = ~x09 & x10;
  assign z04 = new_n53_ & ~x09 & x02 & x10 & ~x11 & ~x12;
  assign z05 = x02 & x10 & new_n53_ & x09;
  assign z06 = x11 & new_n53_ & ~x09 & x02 & x10;
  assign z07 = x00 & x02 & (~x01 | (new_n54_ & x11 & ~x12));
  assign z08 = new_n60_ & z17 & x19 & x17 & ~x18;
  assign new_n60_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = new_n63_ & z17 & ~x14 & new_n64_ & ~x15;
  assign new_n63_ = ~x13 & ~x11 & x12;
  assign new_n64_ = ~x16 & ~x22 & x20 & ~x21;
  assign z10 = new_n66_ & new_n63_ & z17 & ~x14;
  assign new_n66_ = x15 & x16 & ~x22 & x20 & ~x21;
  assign z11 = ~x00 & (x01 | (new_n64_ & new_n68_));
  assign new_n68_ = ~x13 & ~x11 & x12 & x15 & x02 & ~x14;
  assign z12 = (new_n70_ | (new_n53_ & (~x02 | ~x10))) & x09 & ~x24;
