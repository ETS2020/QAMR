...
module FAU ( 
  ...
  assign z00 = (~x10 & x23) | (new_n46_ & ~x17 & ~x18 & x10 & ~x19);
  assign new_n46_ = ~x09 & ~x02 & ~x00 & ~x01;
  assign z01 = (~x10 & x23) | (new_n48_ & ~x17 & ~x18 & x10 & ~x19);
  assign new_n48_ = x09 & ~x02 & ~x00 & ~x01;
  assign z02 = new_n48_ & new_n50_;
  assign new_n50_ = ~x17 & ~x18 & ~x23 & ~x10 & ~x19;
  assign z03 = (z06 & x12) | (new_n54_ & ~new_n52_ & ~x17 & x18);
  assign new_n52_ = ~x10 & x23;
  assign z06 = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign new_n54_ = ~x02 & ~x19 & ~x00 & ~x01;
  assign z04 = new_n52_ | (new_n56_ & x02 & x00 & x01);
  assign new_n56_ = ~x11 & ~x12 & ~x09 & x10;
  assign z05 = x02 & x10 & x09 & x00 & x01;
  assign z07 = new_n52_ | (~new_n59_ & x00 & x02);
  assign new_n59_ = x01 & (x12 | ~x11 | x09 | ~x10);
  assign z08 = new_n52_ | (new_n61_ & new_n62_ & new_n63_);
  ...
  assign new_n68_ = ~x21 & ~x22 & ~x00 & (x10 | ~x23);
  assign z10 = ~new_n52_ & ~x00 & ((new_n66_ & new_n71_) | (new_n70_ & x22));
  assign new_n70_ = x21 & ~x19 & ~x20 & x01 & x18;
  assign new_n71_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = (new_n70_ | (new_n66_ & new_n73_)) & ~x22 & ~new_n52_ & ~x00;
  ...
  assign z13 = new_n52_ | (new_n54_ & x17);
