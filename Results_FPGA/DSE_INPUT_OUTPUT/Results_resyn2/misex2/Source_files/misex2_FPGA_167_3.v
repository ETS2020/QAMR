...
module FAU ( 
  ...
  assign z03 = (x01 & (new_n52_ | x15)) | (new_n48_ & new_n53_);
  assign new_n52_ = ~x09 & x00 & x02 & x12 & x10 & x11;
  assign new_n53_ = ~x17 & x18 & ~x19;
  assign z04 = x01 & (new_n55_ | x15);
  assign new_n55_ = ~x09 & x00 & x02 & ~x12 & x10 & ~x11;
  assign z05 = x01 & x00 & x02 & ~x15 & x09 & x10;
  assign z06 = new_n58_ & x01 & x00 & x02;
  assign new_n58_ = x10 & x11 & ~x09 & ~x15;
  ...
  assign z10 = new_n46_ | (~x00 & ((new_n69_ & x22) | (new_n70_ & new_n71_)));
  assign new_n69_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n70_ = ~x13 & ~x14 & ~x11 & x12 & x02 & x15;
  assign new_n71_ = x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n46_ | (~x00 & ~x22 & (new_n69_ | (new_n70_ & new_n73_)));
