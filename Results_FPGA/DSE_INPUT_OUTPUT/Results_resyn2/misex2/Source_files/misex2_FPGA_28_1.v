...
module FAU ( 
  ...
  assign new_n52_ = ~x01 & ~x06 & ~x00 & ~x02;
  ...
  assign z15 = ((~x02 | ~x10) & x00 & x01) | (~x02 & ~x06 & (x00 | (~x01 & x19)));
  assign z16 = ~x00 & x01;
