...
module FAU ( 
  ...
  assign z09 = new_n52_ | (new_n68_ & ~x21 & (new_n65_ | (new_n66_ & new_n67_)));
  assign new_n65_ = x18 & ~x19 & x01 & ~x20;
  assign new_n66_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n67_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n68_ = ~x00 & ~x22;
  assign z10 = new_n52_ | (~x00 & ((new_n70_ & x22) | (new_n66_ & new_n71_)));
  assign new_n70_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n71_ = x16 & ~x22 & ~x14 & x15 & x20 & ~x21;
  assign z11 = (new_n70_ | (new_n66_ & new_n73_)) & ~new_n52_ & new_n68_;
  assign new_n73_ = ~x16 & ~x14 & x15 & x20 & ~x21;
  assign z12 = new_n52_ | ((new_n75_ | new_n76_) & x09 & ~x24);
