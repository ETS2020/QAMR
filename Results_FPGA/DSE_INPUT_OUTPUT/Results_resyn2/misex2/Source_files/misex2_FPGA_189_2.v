...
module FAU ( 
  ...
  assign z00 = ~x02 & (x01 | (new_n46_ & ~x09 & x10));
  assign new_n46_ = ~x00 & ~x19 & ~x17 & ~x18;
  assign z01 = ~x02 & (x01 | (new_n46_ & x09 & x10));
  assign z02 = new_n49_ & ~x02 & ~x00 & ~x01;
  assign new_n49_ = ~x19 & ~x17 & ~x18 & x09 & ~x10;
  assign z03 = new_n51_ | (new_n52_ & x12 & x02 & x11);
  assign new_n51_ = ~x02 & ~x00 & ~x01 & ~x17 & x18 & ~x19;
  assign new_n52_ = ~x09 & x10 & x00 & x01;
  assign z04 = ~new_n54_ & x01;
  assign new_n54_ = x02 & (~x10 | x12 | x11 | ~x00 | x09);
  assign z05 = x01 & (~x02 | (x00 & x09 & x10));
  assign z06 = x01 & (~x02 | (~x09 & x11 & x00 & x10));
  assign z07 = ~new_n58_ & x00 & x02;
  assign new_n58_ = x01 & (~x10 | x12 | x09 | ~x11);
  assign z08 = (x01 & ~x02) | (new_n60_ & new_n61_ & ~x00 & ~x01 & x02);
  ...
  assign new_n64_ = ~x01 & ~x11 & x12 & ~x13;
  assign new_n65_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = ~x21 & ~x22 & ~x00 & x02;
  assign z10 = ~x00 & x02 & ((new_n68_ & x22) | (new_n64_ & new_n69_));
  assign new_n68_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n69_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n71_ | (~x00 & ~x22 & (new_n68_ | (new_n72_ & new_n73_)));
  assign new_n71_ = x01 & ~x02;
  assign new_n72_ = ~x11 & ~x21 & ~x01 & x02;
  assign new_n73_ = ~x14 & x15 & x12 & ~x13 & ~x16 & x20;
  assign z12 = (new_n75_ | new_n76_) & x09 & ~x24;
  assign new_n75_ = x02 & ((~x10 & x00 & x01) | (x23 & ~x00 & ~x01));
  assign new_n76_ = (x19 | (~x02 & x17)) & ~x00 & ~x01 & (~x19 | x23);
  assign z13 = ~x02 & x17 & ~x19 & ~x00 & ~x01;
  assign z14 = ~x02 & (x01 | (new_n46_ & ~x09 & ~x10));
  assign z15 = (~x10 & x00 & x01) | (~x02 & (x19 | x00 | x01));
  assign z16 = x01 & ~x00 & x02;
  assign z17 = (x01 & ~x02) | (~x00 & ~x01 & x02);
endmodule
