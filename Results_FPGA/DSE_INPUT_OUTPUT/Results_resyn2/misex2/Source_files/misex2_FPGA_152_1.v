...
module FAU ( 
  ...
  assign z00 = ~x09 & x10 & new_n46_ & new_n47_;
  ...
  assign z09 = ~x15 & new_n63_ & x02 & ~x14 & new_n46_ & ~x16;
  assign new_n63_ = ~x22 & x20 & ~x21 & ~x13 & ~x11 & x12;
  assign z10 = ~x00 & (x01 | (new_n66_ & new_n65_ & new_n67_));
  assign new_n65_ = ~x22 & x20 & ~x21;
  assign new_n66_ = ~x13 & ~x11 & x12;
  assign new_n67_ = x02 & ~x14 & x15 & x16;
  assign z11 = x15 & new_n63_ & x02 & ~x14 & new_n46_ & ~x16;
  assign z12 = z16 | ((new_n70_ | new_n71_) & x09 & ~x24);
