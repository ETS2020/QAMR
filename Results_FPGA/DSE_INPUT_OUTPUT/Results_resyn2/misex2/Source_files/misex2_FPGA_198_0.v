...
module FAU ( 
  ...
  assign z08 = ~x01 & (~x04 | (new_n59_ & new_n60_));
  assign new_n59_ = ~x18 & x19 & ~x08 & x17;
  assign new_n60_ = ~x00 & x02 & ~x03 & ~x05 & ~x06 & ~x07;
  assign z09 = (new_n62_ | (new_n63_ & new_n64_)) & ~x21 & ~x00 & ~x22;
  assign new_n62_ = x18 & ~x19 & x01 & ~x20;
  assign new_n63_ = x04 & ~x11 & x12 & ~x01 & x02;
  assign new_n64_ = ~x13 & ~x14 & x20 & ~x15 & ~x16;
  assign z10 = new_n66_ | (~x00 & (new_n68_ | (new_n69_ & new_n67_ & new_n70_)));
  ...
  assign z11 = ~x00 & ~x22 & ((new_n63_ & new_n72_) | (new_n62_ & x21));
  assign new_n72_ = x15 & ~x16 & ~x13 & ~x14 & x20 & ~x21;
  assign z12 = new_n66_ | ((new_n74_ | new_n75_) & x09 & ~x24);
