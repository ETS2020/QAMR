...
module FAU ( 
  ...
  assign new_n57_ = x01 & (~x10 | ~x11 | x12 | ~x02 | x09);
  assign z08 = new_n59_ & new_n60_ & ~x08 & x17 & ~x18 & x19;
  assign new_n59_ = ~x06 & ~x07 & x04 & ~x05;
  assign new_n60_ = ~x00 & ~x01 & x02 & ~x03;
  assign z09 = (new_n62_ | (new_n63_ & new_n64_)) & ~x22 & ~x00 & ~x21;
  assign new_n62_ = ~x19 & ~x20 & x01 & x18;
  assign new_n63_ = x02 & ~x11 & ~x14 & x12 & ~x13;
  assign new_n64_ = ~x01 & ~x15 & ~x16 & x20;
  assign z10 = (new_n67_ & new_n68_) | (~x01 & (x00 | (new_n63_ & new_n66_)));
  assign new_n66_ = x15 & x16 & ~x22 & x20 & ~x21;
  assign new_n67_ = x18 & x21 & ~x00 & x01;
  assign new_n68_ = x22 & ~x19 & ~x20;
  assign z11 = (~x01 & (x00 | (new_n63_ & new_n70_))) | (new_n67_ & new_n71_);
  assign new_n70_ = x15 & ~x16 & ~x22 & x20 & ~x21;
  assign new_n71_ = ~x22 & ~x19 & ~x20;
  assign z12 = new_n74_ & ((x00 & x01 & (~x02 | ~x10)) | (~new_n73_ & ~x00 & ~x01));
  assign new_n73_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign new_n74_ = x09 & ~x24;
  assign z13 = ~x00 & ~x01 & new_n51_ & x17;
  assign z14 = new_n46_ & ~x00 & ~x01 & ~x09 & ~x10;
  assign z15 = ((~x02 | ~x10) & x00 & x01) | (~x00 & ~x01 & ~x02 & x19);
  assign z16 = ~x00 & x01;
