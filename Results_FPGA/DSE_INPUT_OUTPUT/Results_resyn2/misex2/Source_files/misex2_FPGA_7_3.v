...
module FAU ( 
  ...
  assign z03 = new_n53_ | (x01 & (x22 | (x12 & new_n52_ & x11)));
  assign new_n52_ = x00 & x02 & ~x09 & x10;
  assign new_n53_ = ~x19 & ~x02 & ~x00 & ~x01 & ~x17 & x18;
  assign z04 = x01 & (x22 | (new_n52_ & ~x11 & ~x12));
  assign z05 = x01 & (x22 | (new_n56_ & x09 & x10));
  assign new_n56_ = x00 & x02;
  assign z06 = x01 & (x22 | (new_n52_ & x11));
  assign z07 = new_n56_ & ~new_n59_;
  ...
  assign z09 = new_n49_ | (~x00 & ~x21 & (new_n64_ | (new_n65_ & new_n66_)));
  assign new_n64_ = x01 & x18 & ~x19 & ~x20;
  assign new_n65_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n66_ = ~x16 & x20 & ~x22 & ~x14 & ~x15;
  assign z10 = (x01 & x22) | (new_n65_ & new_n68_ & ~x22 & x16 & x20);
  assign new_n68_ = ~x14 & x15 & ~x00 & ~x21;
  assign z11 = ((new_n64_ & x21) | (new_n65_ & new_n70_)) & ~x00 & ~x22;
  ...
  assign z15 = (~x10 & ~x22 & x00 & x01) | ((~x01 | (x00 & ~x22)) & ~x02 & (x00 | x19));
