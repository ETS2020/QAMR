...
module FAU ( 
  ...
  assign new_n47_ = ~x19 & ~x02 & ~x17 & ~x18 & ~x00 & ~x01;
  assign z01 = new_n49_ & ~x00 & ~x01 & x10 & ~x02 & x09;
  assign new_n49_ = ~x17 & ~x18 & ~x19 & (~x22 | x23);
  ...
  assign new_n54_ = ~x19 & ~x02 & ~x17 & x18 & ~x00 & ~x01;
  ...
  assign new_n60_ = (~x22 | x23) & ~x03 & x04;
  assign new_n61_ = ~x00 & ~x01 & x02 & x19 & x17 & ~x18;
  assign z09 = new_n46_ | ((new_n63_ | (new_n64_ & new_n65_)) & new_n66_ & ~x21);
  ...
  assign new_n73_ = (~x02 | ~x10) & x00 & x01 & (~x22 | x23);
  assign new_n74_ = ~x23 & (x22 | x02 | x19);
  assign new_n75_ = ~x00 & ~x01 & (x19 | x02 | x17);
  assign z13 = ~new_n46_ & ~x19 & ~x00 & ~x01 & ~x02 & x17;
