...
module FAU ( 
  ...
  assign z03 = (new_n52_ & ~x00 & ~x01 & (~x12 | x20)) | (new_n53_ & x00 & x01 & x12 & x20);
  assign new_n52_ = ~x02 & ~x19 & ~x17 & x18;
  assign new_n53_ = x02 & x10 & ~x09 & x11;
  assign z04 = (x12 & ~x20) | (new_n55_ & ~x12 & ~x09 & x10);
  assign new_n55_ = x00 & x01 & x02 & ~x11;
  assign z05 = new_n46_ | (x02 & x10 & x09 & x00 & x01);
  assign z06 = new_n53_ & ~new_n46_ & x00 & x01;
  assign z07 = ~new_n59_ & x00 & x02;
  assign new_n59_ = (x01 | (x12 & ~x20)) & (x09 | ~x11 | ~x10 | x12);
  assign z08 = z17 & new_n62_ & x19 & x17 & ~x18;
  assign z17 = x02 & ~x00 & ~x01 & (~x12 | x20);
  assign new_n62_ = ~x05 & ~x06 & ~x07 & ~x08 & ~x03 & x04;
  assign z09 = new_n46_ | (new_n67_ & (new_n64_ | (new_n65_ & new_n66_ & ~x15)));
  assign new_n64_ = ~x19 & ~x20 & x01 & x18;
  assign new_n65_ = x02 & ~x11 & ~x01 & x12;
  assign new_n66_ = ~x16 & ~x13 & ~x14;
  assign new_n67_ = ~x21 & ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n65_ & new_n69_ & new_n70_) | (new_n71_ & new_n72_));
  assign new_n69_ = ~x22 & x20 & ~x21;
  assign new_n70_ = ~x13 & ~x14 & x15 & x16;
  assign new_n71_ = x21 & ~x19 & ~x20 & x01 & x18;
  assign new_n72_ = ~x12 & x22;
  assign z11 = new_n46_ | (~x00 & ~x22 & (new_n71_ | (new_n65_ & new_n74_)));
  assign new_n74_ = x15 & ~x21 & ~x16 & ~x13 & ~x14;
  assign z12 = new_n77_ & ((x00 & x01 & (~x02 | ~x10)) | (~new_n76_ & ~x00 & ~x01));
  assign new_n76_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign new_n77_ = (~x12 | x20) & x09 & ~x24;
