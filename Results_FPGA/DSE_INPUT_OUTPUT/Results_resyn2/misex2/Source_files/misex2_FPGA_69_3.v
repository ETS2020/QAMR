...
module FAU ( 
  ...
  assign z03 = new_n53_ | (x01 & (new_n52_ | x20));
  assign new_n52_ = x11 & ~x09 & x10 & x00 & x02 & x12;
  assign new_n53_ = ~x02 & ~x00 & ~x01 & ~x19 & ~x17 & x18;
  assign z04 = new_n55_ & ~x11 & ~x12 & ~x09 & x10;
  assign new_n55_ = x02 & ~x20 & x00 & x01;
  assign z05 = new_n55_ & x09 & x10;
  assign z06 = new_n55_ & x11 & ~x09 & x10;
  ...
  assign z09 = new_n66_ & (new_n64_ | (new_n65_ & ~x15 & ~x01 & x12));
  assign new_n64_ = ~x20 & ~x19 & x01 & x18;
  assign new_n65_ = x02 & ~x11 & ~x13 & ~x14 & ~x16 & x20;
  assign new_n66_ = ~x21 & ~x00 & ~x22;
  assign z10 = new_n46_ | (~x00 & ((new_n68_ & x22) | (new_n69_ & new_n70_)));
  assign new_n68_ = x21 & ~x19 & x01 & x18;
  assign new_n69_ = x02 & ~x11 & ~x13 & ~x14 & x12 & x15;
  assign new_n70_ = x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n46_ | (~x00 & ~x22 & (new_n68_ | (new_n69_ & new_n72_)));
