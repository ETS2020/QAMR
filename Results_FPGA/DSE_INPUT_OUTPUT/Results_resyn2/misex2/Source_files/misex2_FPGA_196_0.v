...
module FAU ( 
  ...
  assign z10 = ~new_n50_ & ~x00 & ((new_n64_ & new_n69_) | (new_n68_ & x22));
  assign new_n68_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n69_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = (new_n68_ | (new_n64_ & new_n71_)) & ~x22 & ~new_n50_ & ~x00;
  assign new_n71_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = new_n50_ | ((new_n73_ | new_n74_) & x09 & ~x24);
  assign new_n73_ = x00 & x01 & (~x02 | ~x10);
  assign new_n74_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign z13 = new_n50_ | (~x00 & ~x01 & x17 & ~x02 & ~x19);
  assign z14 = new_n77_ & ~x19 & ~x17 & ~x18;
  assign new_n77_ = ~x02 & ~x00 & ~x01 & ~x10 & x08 & ~x09;
