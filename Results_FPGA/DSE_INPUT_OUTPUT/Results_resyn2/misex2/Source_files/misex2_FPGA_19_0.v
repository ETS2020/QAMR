...
module FAU ( 
  ...
  assign z00 = new_n46_ & ~x18 & ~x19 & x10 & ~x17;
  assign new_n46_ = ~x02 & ~x09 & (x08 | x15) & ~x00 & ~x01;
  assign z01 = new_n48_ | (new_n49_ & ~x18 & ~x19 & x10 & ~x17);
  assign new_n48_ = ~x08 & ~x15;
  assign new_n49_ = ~x00 & ~x01 & ~x02 & x09;
  assign z02 = new_n48_ | (new_n49_ & new_n51_);
  assign new_n51_ = ~x10 & ~x17 & ~x18 & ~x19;
  assign z03 = ~new_n48_ & (new_n55_ | (x12 & new_n53_ & new_n54_));
  assign new_n53_ = x02 & x00 & x01;
  assign new_n54_ = x11 & ~x09 & x10;
  assign new_n55_ = ~x02 & ~x19 & ~x00 & ~x01 & ~x17 & x18;
  assign z04 = new_n53_ & ~x09 & x10 & ~new_n48_ & ~x11 & ~x12;
  assign z05 = ~new_n48_ & x09 & new_n53_ & x10;
  assign z06 = new_n48_ | (new_n53_ & new_n54_);
  assign z07 = (~x01 | (new_n54_ & ~x12)) & ~new_n48_ & x00 & x02;
  assign z08 = new_n61_ & new_n62_ & x02 & ~x00 & ~x01;
  assign new_n61_ = ~x03 & x04 & ~x07 & ~x08 & ~x05 & ~x06;
  assign new_n62_ = ~x18 & x19 & x15 & x17;
  assign z09 = (new_n64_ | (new_n65_ & new_n66_)) & ~x21 & ~x00 & ~x22;
  assign new_n64_ = ~x19 & ~x20 & (x08 | x15) & x01 & x18;
  assign new_n65_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n66_ = x20 & ~x15 & ~x16 & x08 & ~x14;
  assign z10 = ~x00 & ((new_n65_ & new_n70_) | (x22 & new_n68_ & new_n69_));
  assign new_n68_ = (x08 | x15) & x01 & x18;
  assign new_n69_ = x21 & ~x19 & ~x20;
  assign new_n70_ = ~x14 & x15 & x20 & ~x21 & x16 & ~x22;
  assign z11 = ~x00 & ~x22 & ((new_n65_ & new_n72_) | (new_n68_ & new_n69_));
  assign new_n72_ = ~x16 & ~x14 & x15 & x20 & ~x21;
  assign z12 = new_n75_ & (new_n74_ | (x00 & x01 & (~x02 | ~x10)));
  assign new_n74_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign new_n75_ = ~x24 & x09 & (x08 | x15);
