...
module FAU ( 
  ...
  assign z04 = new_n51_ | (~x12 & ~x09 & x10 & new_n53_ & ~x11);
  assign new_n53_ = x02 & x00 & x01;
  assign z05 = ~new_n51_ & x09 & new_n53_ & x10;
  assign z06 = new_n50_ | new_n51_;
  assign z07 = ~new_n57_ & ~new_n51_ & x00 & x02;
  assign new_n57_ = x01 & (~x11 | x12 | x09 | ~x10);
  assign z08 = new_n59_ & new_n60_ & x02 & ~x00 & ~x01;
  assign new_n59_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign new_n60_ = x16 & x17 & ~x18 & x19;
  assign z09 = new_n51_ | (new_n65_ & ~x21 & (new_n64_ | (new_n62_ & new_n63_)));
  assign new_n62_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n63_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n64_ = x18 & ~x19 & x01 & ~x20;
  assign new_n65_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n67_ & ~new_n51_ & x22) | (new_n62_ & new_n68_));
  assign new_n67_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n68_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = new_n51_ | (new_n65_ & (new_n67_ | (new_n62_ & new_n70_)));
  assign new_n70_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = (new_n72_ | x00) & new_n73_ & (~x00 | (x01 & (~x02 | ~x10)));
  assign new_n72_ = (x17 | x02 | x19) & ~x01 & (x23 | (~x02 & ~x19));
  assign new_n73_ = ~x24 & x09 & (x16 | ~x17);
