...
module FAU ( 
  ...
  assign new_n46_ = x10 & ~x19 & (x04 | x20) & ~x17 & ~x18;
  assign z01 = new_n46_ & ~x00 & ~x01 & ~x02 & x09;
  assign z02 = new_n49_ & ~x00 & ~x01 & ~x02 & x09;
  assign new_n49_ = ~x10 & ~x19 & (x04 | x20) & ~x17 & ~x18;
  assign z03 = (new_n52_ & x12) | new_n51_ | new_n53_;
  assign new_n51_ = ~x04 & ~x20;
  assign new_n52_ = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign new_n53_ = ~x17 & ~x02 & ~x19 & x18 & ~x00 & ~x01;
  assign z04 = new_n55_ & ~x09 & x10 & ~new_n51_ & ~x11 & ~x12;
  assign new_n55_ = x02 & x00 & x01;
  assign z05 = new_n55_ & x10 & ~new_n51_ & x09;
  assign z06 = new_n51_ | new_n52_;
  assign z07 = new_n51_ | (~new_n59_ & x00 & x02);
  ...
  assign new_n64_ = ~x19 & ~x20 & x04 & x01 & x18;
  assign new_n65_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((new_n65_ & new_n70_) | (new_n69_ & new_n68_ & x22));
  assign new_n68_ = x04 & x01 & x18;
  assign new_n69_ = x21 & ~x19 & ~x20;
  assign new_n70_ = ~x14 & x15 & x20 & ~x21 & x16 & ~x22;
  assign z11 = new_n51_ | (~x00 & ~x22 & (new_n73_ | (new_n65_ & new_n72_)));
  assign new_n72_ = ~x16 & ~x14 & x15 & x20 & ~x21;
  assign new_n73_ = x01 & x18 & x21 & ~x19 & ~x20;
  assign z12 = new_n76_ & (new_n75_ | (x00 & x01 & (~x02 | ~x10)));
  assign new_n75_ = (x23 | (~x02 & ~x19)) & ~x00 & ~x01 & (x17 | x02 | x19);
  assign new_n76_ = ~x24 & x09 & (x04 | x20);
  assign z13 = ~new_n51_ & ~x19 & ~x01 & ~x02 & ~x00 & x17;
