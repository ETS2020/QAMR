...
module FAU ( 
  ...
  assign z06 = x11 & x00 & x01 & new_n55_ & ~x09;
  ...
  assign new_n64_ = ~x11 & x12 & x02 & ~x13 & ~x14;
  assign new_n65_ = ~x22 & x20 & ~x21;
  assign z10 = ~x00 & (x01 | (new_n64_ & new_n65_ & x15 & x16));
  assign z11 = new_n68_ & new_n65_ & x02 & ~x00 & ~x01;
  assign new_n68_ = ~x11 & x12 & ~x13 & ~x14 & x15 & ~x16;
  assign z12 = x09 & ~x24 & (new_n70_ | (~new_n55_ & x00 & x01));
