...
module FAU ( 
  ...
  assign z03 = new_n50_ | (new_n51_ & x12 & x10 & x11);
  assign new_n50_ = ~x17 & ~x02 & ~x19 & x18 & ~x00 & ~x01;
  assign new_n51_ = x00 & x01 & x02 & ~x09;
  ...
  assign new_n56_ = x01 & (~x10 | x12 | x09 | ~x11);
