...
module FAU ( 
  ...
  assign z03 = (~new_n51_ & x02) | (new_n52_ & ~x02 & ~x00 & ~x01);
  assign new_n51_ = x12 & (~x00 | ~x01 | ~x11 | x09 | ~x10);
  assign new_n52_ = ~x17 & x18 & ~x19;
  assign z04 = x02 & ~x12;
  assign z05 = x02 & (~x12 | (x00 & x01 & x09 & x10));
  assign z06 = ~new_n51_ & x02;
  assign z07 = x02 & (~x12 | (x00 & ~x01));
  assign z08 = new_n58_ & new_n59_ & x19 & x17 & ~x18;
  assign new_n58_ = ~x00 & ~x01 & x02 & ~x03 & x04 & ~x05;
  assign new_n59_ = ~x08 & x12 & ~x06 & ~x07;
  assign z09 = new_n64_ & ~x21 & (new_n61_ | (new_n62_ & new_n63_ & ~x15));
  assign new_n61_ = (~x02 | x12) & x18 & ~x19 & x01 & ~x20;
  ...
  assign new_n67_ = ~x11 & x16 & x20 & ~x22;
  assign new_n68_ = x15 & ~x21 & ~x13 & ~x14 & ~x01 & x02;
  assign z11 = new_n64_ & ((new_n61_ & x21) | (new_n62_ & new_n63_ & x15 & ~x21));
  assign z12 = z04 | ((new_n71_ | new_n72_) & x09 & ~x24);
