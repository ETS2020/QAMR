...
module FAU ( 
  ...
  assign z00 = new_n46_ & ~x09 & x10 & ~x02 & ~x00 & ~x01;
  assign new_n46_ = ~x19 & ~x17 & ~x18;
  assign z01 = new_n46_ & ~x02 & x09 & x10 & ~x00 & ~x01;
  assign z02 = ~x00 & (x01 | (~x02 & x09 & new_n46_ & ~x10));
  assign z03 = new_n50_ | new_n51_;
  assign new_n50_ = ~x00 & (x01 | (x18 & ~x17 & ~x02 & ~x19));
  assign new_n51_ = ~x09 & x10 & x01 & x02 & x11 & x12;
  assign z04 = new_n53_ & ~x09 & x00 & x01 & ~x11 & ~x12;
  assign new_n53_ = x02 & x10;
  assign z05 = x01 & (~x00 | (new_n53_ & x09));
  assign z06 = x11 & new_n53_ & ~x09 & x00 & x01;
  ...
  assign z09 = ~x00 & (x01 | (new_n62_ & new_n63_));
  assign new_n62_ = ~x11 & x12 & ~x13 & ~x14;
  assign new_n63_ = ~x22 & x20 & ~x21 & ~x15 & x02 & ~x16;
  assign z10 = new_n66_ & new_n65_ & x16 & x02 & ~x00 & ~x01;
  assign new_n65_ = ~x22 & x20 & ~x21;
  assign new_n66_ = x15 & ~x11 & x12 & ~x13 & ~x14;
  assign z11 = ~x00 & (x01 | (new_n66_ & new_n65_ & x02 & ~x16));
  assign z12 = (~x00 & x01) | (x09 & ~x24 & (new_n69_ | (~new_n53_ & x01)));
