...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n52_, new_n54_, new_n56_, new_n59_, new_n60_,
  ...
  assign new_n52_ = ~x00 & ~x19 & ~x01 & ~x02 & ~x17 & x18;
  ...
  assign z09 = ~x15 & new_n62_ & new_n63_ & x02 & ~x00 & ~x01;
  assign new_n62_ = x12 & ~x13 & ~x16 & ~x11 & ~x14;
  assign new_n63_ = ~x22 & x20 & ~x21;
  assign z10 = ~x00 & (x01 | (new_n63_ & new_n65_ & new_n66_));
  assign new_n65_ = x16 & ~x14 & x15;
  assign new_n66_ = x02 & ~x11 & x12 & ~x13;
  assign z11 = x15 & new_n62_ & new_n63_ & x02 & ~x00 & ~x01;
  assign z12 = ((~new_n56_ & x00 & x01) | (~new_n69_ & ~x00 & ~x01)) & x09 & ~x24;
