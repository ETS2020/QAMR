...
module FAU ( 
  ...
  assign z01 = (x01 & ~x23) | (new_n46_ & x09 & ~x02 & ~x00 & ~x01);
  assign z02 = (x01 & ~x23) | (new_n49_ & x09 & ~x02 & ~x00 & ~x01);
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = new_n51_ | (x01 & x00 & x23 & new_n52_ & x12);
  ...
  assign z05 = x01 & (~x23 | (x00 & x09 & x02 & x10));
  assign z06 = x01 & (~x23 | (new_n52_ & x00));
