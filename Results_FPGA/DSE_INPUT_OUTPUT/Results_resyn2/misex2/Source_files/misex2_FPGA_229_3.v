...
module FAU ( 
  ...
  assign new_n46_ = (~x21 | ~x22) & ~x19 & ~x17 & ~x18;
  ...
  assign z10 = new_n67_ & new_n68_ & x15 & x16 & ~x00 & ~x22;
  assign new_n67_ = ~x13 & ~x14 & ~x11 & x12;
  assign new_n68_ = ~x01 & x02 & x20 & ~x21;
  assign z11 = ~x00 & ~x22 & ((new_n64_ & x21) | (new_n63_ & new_n70_));
  assign new_n70_ = x20 & ~x21 & x15 & ~x16;
  assign z12 = new_n73_ & (new_n72_ | (x00 & x01 & (~x02 | ~x10)));
  assign new_n72_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign new_n73_ = (~x21 | ~x22) & x09 & ~x24;
