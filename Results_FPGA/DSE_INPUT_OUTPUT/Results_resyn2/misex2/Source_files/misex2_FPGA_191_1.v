...
module FAU ( 
  ...
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n55_, new_n59_, new_n60_,
    new_n62_, new_n64_, new_n66_, new_n69_;
  ...
  assign z09 = new_n62_ & z17 & new_n64_;
  assign new_n62_ = ~x13 & ~x14 & ~x11 & x12 & ~x15 & ~x16;
  assign z17 = x02 & ~x00 & ~x01;
  assign new_n64_ = ~x22 & x20 & ~x21;
  assign z10 = ~x00 & (x01 | (x16 & new_n64_ & new_n66_));
  assign new_n66_ = ~x13 & ~x14 & x02 & ~x11 & x12 & x15;
  assign z11 = ~x00 & (x01 | (~x16 & new_n64_ & new_n66_));
  assign z12 = (~x00 & x01) | ((new_n69_ | (~new_n55_ & x01)) & x09 & ~x24);
