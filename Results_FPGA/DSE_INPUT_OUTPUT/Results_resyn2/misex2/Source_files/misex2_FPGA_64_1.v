...
module FAU ( 
  ...
  assign new_n46_ = ~x02 & ~x00 & ~x01 & ~x09 & ~x13 & ~x17;
  assign z01 = ~x01 & (x13 | (new_n48_ & x10 & ~x18 & ~x19));
  assign new_n48_ = ~x00 & ~x02 & x09 & ~x17;
  assign z02 = ~x01 & (x13 | (new_n48_ & ~x10 & ~x18 & ~x19));
  assign z03 = (new_n51_ & x12) | (new_n52_ & ~x00 & ~x01 & ~x02);
