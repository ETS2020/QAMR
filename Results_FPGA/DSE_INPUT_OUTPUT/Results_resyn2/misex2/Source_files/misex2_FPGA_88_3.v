...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n48_, new_n49_, new_n54_, new_n55_, new_n57_, new_n58_,
    new_n59_, new_n61_, new_n62_, new_n64_, new_n66_;
  assign z00 = new_n46_ & ~x02 & ~x09 & x10 & ~x00 & ~x01;
  assign new_n46_ = ~x19 & ~x17 & ~x18;
  assign z01 = new_n48_ | (new_n49_ & ~x02 & x09 & x10 & ~x17);
  ...
  assign z10 = (x01 & (x00 | (new_n61_ & x22))) | (new_n62_ & new_n57_ & ~x00);
  assign new_n61_ = ~x20 & x21 & x18 & ~x19;
  assign new_n62_ = ~x22 & x20 & ~x21 & x16 & ~x14 & x15;
  assign z11 = (new_n64_ & new_n57_ & ~x00) | (x01 & (x00 | (new_n61_ & ~x22)));
  assign new_n64_ = ~x22 & x20 & ~x21 & ~x16 & ~x14 & x15;
  assign z12 = (x00 & x01) | (~new_n66_ & ~x00 & ~x01 & x09 & ~x24);
  assign new_n66_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = new_n48_ | (new_n49_ & ~x02 & ~x09 & ~x10 & ~x17);
