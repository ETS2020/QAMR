...
module FAU ( 
  ...
  assign new_n63_ = ~x03 & x04 & ~x05 & ~x06;
  assign z09 = (~x07 & x21) | ((new_n67_ | (new_n65_ & new_n66_)) & new_n68_ & ~x21);
  assign new_n65_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n66_ = ~x16 & x20 & ~x14 & ~x15;
  assign new_n67_ = x18 & ~x19 & x01 & ~x20;
  assign new_n68_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n70_ & x22) | (new_n65_ & new_n71_));
  assign new_n70_ = x18 & ~x19 & x01 & ~x20 & x07 & x21;
  assign new_n71_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign z11 = new_n68_ & (new_n70_ | (new_n65_ & new_n73_));
