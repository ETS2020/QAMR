...
module FAU ( 
  ...
  assign z00 = ~x00 & ~x01;
  assign z03 = x12 & x11 & x00 & ~x09 & new_n47_ & x01;
  assign new_n47_ = x02 & x10;
  assign z04 = x00 & ~x09 & new_n47_ & x01 & ~x11 & ~x12;
  assign z05 = (~x00 & ~x01) | (new_n47_ & x09 & x00 & x01);
  assign z06 = (x11 & x00 & ~x09 & new_n47_ & x01) | (~x00 & ~x01);
  assign z07 = (~x00 | x02) & (~x01 | (new_n52_ & x00 & ~x09));
  ...
  assign z12 = (~x00 & ~x01) | (x09 & x00 & x01 & ~new_n47_ & ~x24);
