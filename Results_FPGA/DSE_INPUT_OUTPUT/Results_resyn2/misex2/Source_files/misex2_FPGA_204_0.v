...
module FAU ( 
  ...
  assign z00 = new_n46_ & ~x00 & ~x01 & ~x02 & ~x19;
  assign new_n46_ = x15 & ~x17 & ~x18 & ~x09 & x10;
  assign z01 = ~x01 & (~x15 | (new_n48_ & x09 & ~x00 & ~x02));
  assign new_n48_ = ~x18 & ~x19 & x10 & ~x17;
  assign z02 = ~x01 & (~x15 | (new_n50_ & x09 & ~x00 & ~x02));
  assign new_n50_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = (new_n52_ & x12) | (new_n53_ & ~x02 & x15 & ~x17);
  assign new_n52_ = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign new_n53_ = x18 & ~x19 & ~x00 & ~x01;
  assign z04 = (~x01 & ~x15) | (new_n55_ & x02 & x00 & x01);
  assign new_n55_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = (~x01 & ~x15) | (x02 & x10 & x09 & x00 & x01);
  assign z06 = new_n52_ | (~x01 & ~x15);
  assign z07 = (new_n59_ | ~x01) & (x01 | x15) & x00 & x02;
  ...
  assign z09 = (~x01 & ~x15) | (new_n65_ & x01 & x18 & ~x21 & ~x22);
  assign new_n65_ = ~x00 & ~x19 & ~x20;
  assign z10 = (~x01 & ~x15) | (~x00 & (new_n69_ | (new_n67_ & new_n68_)));
  assign new_n67_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n68_ = ~x21 & ~x22 & x20 & ~x14 & x16;
  assign new_n69_ = x18 & ~x19 & x01 & ~x20 & x21 & x22;
  assign z11 = ~x00 & ~x22 & (new_n72_ | (new_n67_ & new_n71_));
  assign new_n71_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign new_n72_ = x01 & x18 & x21 & ~x19 & ~x20;
  assign z12 = (~x01 & ~x15) | ((new_n74_ | new_n75_) & x09 & ~x24);
  assign new_n74_ = x00 & x01 & (~x02 | ~x10);
  assign new_n75_ = (x23 | (~x02 & ~x19)) & ~x00 & ~x01 & (x17 | x02 | x19);
  assign z13 = ~x00 & ~x01 & ~x02 & ~x19 & x15 & x17;
  assign z14 = ~x01 & (~x15 | (new_n50_ & ~x09 & ~x00 & ~x02));
  assign z15 = (x00 & x01 & (~x02 | ~x10)) | ((x00 | (~x01 & x19)) & ~x02 & x15);
  assign z16 = ~x00 & x01;
