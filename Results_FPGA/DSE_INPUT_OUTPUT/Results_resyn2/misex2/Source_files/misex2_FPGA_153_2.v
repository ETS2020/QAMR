...
module FAU ( 
  ...
  assign new_n48_ = ~x00 & ~x02 & ~x18 & ~x01 & x09;
  assign z02 = new_n48_ & ~x10 & ~x17 & ~x19;
  assign z03 = x18 & ((new_n51_ & ~x00 & ~x01) | (new_n52_ & x02 & x00 & x01));
  assign new_n51_ = ~x17 & ~x02 & ~x19;
  assign new_n52_ = x12 & x11 & ~x09 & x10;
  assign z04 = new_n54_ & x02 & x00 & x01;
  assign new_n54_ = ~x12 & x18 & ~x11 & ~x09 & x10;
  assign z05 = x02 & x00 & x01 & x18 & x09 & x10;
  assign z06 = x01 & (~x18 | (new_n57_ & x00 & x02));
  assign new_n57_ = x11 & ~x09 & x10;
  assign z07 = x00 & x02 & (~x01 | (new_n57_ & ~x12 & x18));
  ...
  assign new_n64_ = ~x20 & x01 & ~x19;
  assign new_n65_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n66_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n67_ = ~x00 & ~x22;
  assign z10 = (new_n63_ | ~x00) & ((new_n65_ & new_n69_) | new_n63_ | new_n70_);
  assign new_n69_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign new_n70_ = x21 & x22 & ~x20 & x01 & ~x19;
  assign z11 = new_n67_ & ((new_n65_ & new_n72_) | (new_n64_ & x18 & x21));
  assign new_n72_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = new_n63_ | ((new_n74_ | new_n75_) & x09 & ~x24);
  assign new_n74_ = (~x02 | ~x10) & x00 & x01;
  assign new_n75_ = (x23 | (~x02 & ~x19)) & ~x00 & ~x01 & (x17 | x02 | x19);
  assign z13 = (x01 & ~x18) | (~x02 & ~x19 & ~x00 & ~x01 & x17);
  assign z14 = ~x18 & (new_n78_ | x01);
  assign new_n78_ = ~x09 & ~x00 & ~x02 & ~x10 & ~x17 & ~x19;
  assign z15 = (~x02 & ((x00 & (~x01 | x18)) | (~x01 & x19))) | (~x10 & x18 & x00 & x01);
