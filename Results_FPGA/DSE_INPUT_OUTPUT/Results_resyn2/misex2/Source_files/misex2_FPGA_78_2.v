...
module FAU ( 
  ...
  assign z03 = new_n51_ | (new_n52_ & x12 & x20 & x10 & x11);
  ...
  assign z05 = x00 & x01 & x02 & x09 & x10 & x20;
  assign z06 = new_n52_ & x20 & x10 & x11;
  ...
  assign z09 = new_n63_ & ~x13 & ~x14 & new_n64_ & ~x15;
  assign new_n63_ = x02 & ~x00 & ~x01 & ~x11 & x12;
  assign new_n64_ = ~x16 & ~x22 & x20 & ~x21;
  assign z10 = (x01 & ~x20) | (new_n63_ & new_n66_ & ~x22 & x20 & ~x21);
  assign new_n66_ = x15 & x16 & ~x13 & ~x14;
  assign z11 = new_n63_ & ~x13 & ~x14 & new_n64_ & x15;
  assign z12 = (new_n69_ | new_n70_) & x09 & ~x24;
  assign new_n69_ = (~x02 | ~x10) & x01 & x00 & x20;
