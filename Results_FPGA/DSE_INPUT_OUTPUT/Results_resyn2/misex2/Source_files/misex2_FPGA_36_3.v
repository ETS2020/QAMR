...
module FAU ( 
  ...
  assign z02 = new_n50_ & x09 & new_n49_ & ~x02;
  assign new_n49_ = ~x00 & ~x01;
  assign new_n50_ = ~x10 & ~x19 & ~x17 & ~x18;
  assign z03 = new_n49_ & ~x02 & ~x17 & x18 & ~x19;
  assign z06 = x00 & x01;
  assign z07 = x00 & (x01 | x02);
  assign z08 = new_n55_ & new_n49_ & x02 & x17 & ~x18 & x19;
  ...
  assign z14 = (x00 & x01) | (new_n50_ & ~x09 & ~x02 & ~x00 & ~x01);
