...
module FAU ( 
  ...
  assign new_n46_ = ~x19 & (~x11 | ~x13) & ~x17 & ~x18;
  ...
  assign new_n51_ = ~x10 & ~x17 & ~x18 & ~x19 & (~x11 | ~x13);
  assign z03 = (new_n54_ & new_n55_) | (new_n53_ & x18 & ~x02 & ~x17);
  assign new_n53_ = ~x00 & ~x01 & ~x19 & (~x11 | ~x13);
  assign new_n54_ = x00 & x01 & ~x09 & x02 & x10;
  assign new_n55_ = x11 & x12 & ~x13;
  assign z04 = (x11 & x13) | (new_n54_ & ~x11 & ~x12);
  assign z05 = new_n48_ | (x00 & x01 & x09 & x02 & x10);
  assign z06 = x11 & (new_n54_ | x13);
  assign z07 = ~new_n60_ & ~new_n48_ & x00 & x02;
  ...
  assign z09 = new_n48_ | ((new_n65_ | (new_n66_ & new_n67_)) & new_n68_ & ~x21);
  assign new_n65_ = ~x19 & ~x20 & x01 & x18;
  assign new_n66_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n67_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n68_ = ~x00 & ~x22;
  assign z10 = new_n48_ | (~x00 & (new_n70_ | (new_n66_ & new_n71_)));
  assign new_n70_ = ~x19 & ~x20 & x01 & x18 & x21 & x22;
  assign new_n71_ = x16 & ~x22 & x20 & ~x21 & ~x14 & x15;
  assign z11 = new_n68_ & ((new_n66_ & new_n75_) | (new_n74_ & new_n73_ & x21));
  assign new_n73_ = ~x19 & (~x11 | ~x13);
  assign new_n74_ = ~x20 & x01 & x18;
  assign new_n75_ = ~x16 & x20 & ~x21 & ~x14 & x15;
  assign z12 = new_n48_ | ((new_n77_ | new_n78_) & x09 & ~x24);
  assign new_n77_ = x00 & x01 & (~x02 | ~x10);
  assign new_n78_ = (x23 | (~x02 & ~x19)) & ~x00 & ~x01 & (x17 | x02 | x19);
  assign z13 = new_n53_ & ~x02 & x17;
