...
module FAU ( 
  ...
  assign z00 = new_n46_ & ~x09 & x10;
  assign new_n46_ = ~x17 & ~x02 & ~x19 & ~x18 & ~x00 & ~x01;
  assign z01 = x10 & new_n46_ & x09;
  assign z02 = ~x10 & (x06 | (new_n46_ & x09));
  assign z03 = (new_n50_ & x12) | (new_n51_ & ~x17 & ~x02 & ~x19);
  assign new_n50_ = x11 & x00 & x01 & x02 & ~x09 & x10;
  assign new_n51_ = (~x06 | x10) & x18 & ~x00 & ~x01;
  assign z04 = new_n53_ & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign new_n53_ = x00 & x01;
  assign z05 = (x06 & ~x10) | (new_n53_ & x09 & x02 & x10);
  assign z06 = new_n50_ | new_n56_;
  assign new_n56_ = x06 & ~x10;
  assign z07 = new_n56_ | (~new_n58_ & x00 & x02);
  ...
  assign z12 = new_n56_ | (x09 & ~x24 & (new_n73_ | new_n74_));
  assign new_n73_ = x00 & x01 & (~x02 | ~x10);
  assign new_n74_ = (x23 | (~x02 & ~x19)) & ~x00 & ~x01 & (x17 | x02 | x19);
  assign z13 = ~new_n56_ & ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = new_n46_ & ~x10 & ~x06 & ~x09;
  assign z15 = (x00 | (~x01 & x19)) & (~x06 | x10) & (~x02 | (x01 & ~x10));
  assign z16 = new_n56_ | (~x00 & x01);
  assign z17 = x02 & ~new_n56_ & ~x00 & ~x01;
endmodule
