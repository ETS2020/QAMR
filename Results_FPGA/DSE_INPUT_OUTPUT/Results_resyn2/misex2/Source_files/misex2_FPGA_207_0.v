...
module FAU ( 
  ...
  assign new_n46_ = x20 & ~x18 & ~x19 & x10 & ~x17;
  assign z01 = new_n46_ & x09 & ~x02 & ~x00 & ~x01;
  assign z02 = new_n49_ & x09 & ~x02 & ~x00 & ~x01;
  assign new_n49_ = x20 & ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = new_n51_ | new_n52_ | (new_n53_ & x12 & x10 & x11);
  assign new_n51_ = ~x19 & ~x02 & ~x00 & ~x01 & ~x17 & x18;
  assign new_n52_ = ~x18 & ~x20;
  assign new_n53_ = x00 & x01 & x02 & ~x09;
  assign z04 = ~new_n52_ & new_n53_ & ~x12 & x10 & ~x11;
  assign z05 = new_n52_ | (x02 & x10 & x09 & x00 & x01);
  assign z06 = ~new_n52_ & new_n53_ & x10 & x11;
  assign z07 = new_n52_ | (~new_n58_ & x00 & x02);
  assign new_n58_ = x01 & (~x10 | ~x11 | x09 | x12);
  ...
  assign new_n72_ = (x18 | x20) & x09 & ~x24;
  assign z13 = x17 & ~x02 & ~x19 & ~new_n52_ & ~x00 & ~x01;
  assign z14 = ~x18 & (~x20 | (new_n75_ & ~x09 & ~x10 & ~x17));
  assign new_n75_ = ~x19 & ~x02 & ~x00 & ~x01;
