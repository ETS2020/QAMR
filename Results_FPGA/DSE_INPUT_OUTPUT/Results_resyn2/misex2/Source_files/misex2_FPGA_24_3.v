...
module FAU ( 
  ...
  assign z00 = z04 | (new_n48_ & new_n47_ & ~x09);
  assign z04 = x00 & x01;
  ...
  assign z03 = z04 | (new_n47_ & ~x17 & x18 & ~x19);
  assign z07 = x02 & x00 & ~x01;
  assign z08 = (x00 & x01) | (new_n55_ & new_n56_ & ~x01 & x02 & ~x00 & ~x03);
  assign new_n55_ = ~x08 & x17 & ~x18 & x19;
  assign new_n56_ = ~x06 & ~x07 & x04 & ~x05;
  assign z09 = (new_n60_ | (new_n58_ & new_n59_)) & ~x22 & ~x00 & ~x21;
  assign new_n58_ = ~x13 & ~x11 & x12;
  assign new_n59_ = ~x01 & x02 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n60_ = x18 & ~x19 & x01 & ~x20;
  assign z10 = (~new_n62_ & x01) | (new_n63_ & new_n64_ & x16);
  assign new_n62_ = ~x00 & (~x22 | x20 | ~x21 | ~x18 | x19);
  assign new_n63_ = ~x14 & x15 & ~x22 & x20 & ~x21;
  assign new_n64_ = ~x13 & ~x11 & x12 & x02 & ~x00 & ~x01;
  assign z11 = (~new_n66_ & x01) | (new_n63_ & new_n64_ & ~x16);
  assign new_n66_ = ~x00 & (x22 | x20 | ~x21 | ~x18 | x19);
  assign z12 = new_n68_ & ((~x02 & ~x19) ? x17 : x23);
  assign new_n68_ = ~x00 & ~x01 & x09 & ~x24;
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = z04 | (new_n51_ & new_n47_ & ~x09);
