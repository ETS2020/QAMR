...
module FAU ( 
  ...
  assign z02 = (x01 & x02) | (new_n49_ & x09 & ~x02 & ~x00 & ~x01);
  ...
  assign z09 = z05 | ((new_n57_ | (new_n58_ & new_n59_)) & new_n60_ & ~x00);
  assign new_n57_ = x01 & x18 & ~x19 & ~x20;
  assign new_n58_ = x12 & ~x13 & x02 & ~x11;
  assign new_n59_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n60_ = ~x21 & ~x22;
  assign z10 = z05 | (~x00 & ((new_n63_ & new_n64_) | (new_n62_ & x22)));
  assign new_n62_ = x21 & x01 & x18 & ~x19 & ~x20;
  assign new_n63_ = x12 & ~x13 & x02 & ~x11 & ~x14 & x15;
  assign new_n64_ = x16 & x20 & ~x21 & ~x22;
  assign z11 = z05 | (~x00 & ~x22 & (new_n62_ | (new_n63_ & new_n66_)));
  assign new_n66_ = ~x21 & ~x16 & x20;
  assign z12 = ~new_n68_ & x09 & ~x24;
  assign new_n68_ = ((~x02 & ~x19) | ~x23 | x00 | x01) & ((~x01 & (x00 | ~x17 | x19)) | x02 | (~x00 & x01));
