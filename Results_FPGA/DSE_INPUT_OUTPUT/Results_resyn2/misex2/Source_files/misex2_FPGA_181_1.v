...
module FAU ( 
  ...
  assign z09 = new_n61_ & new_n62_ & ~x00 & ~x01 & new_n63_ & ~x15;
  assign new_n61_ = ~x14 & x12 & ~x13;
  assign new_n62_ = x02 & ~x11;
  assign new_n63_ = ~x16 & ~x22 & x20 & ~x21;
  assign z10 = new_n65_ & new_n61_ & new_n62_ & ~x00 & ~x01;
  assign new_n65_ = x15 & x16 & ~x22 & x20 & ~x21;
  assign z11 = ~x00 & (x01 | (new_n63_ & new_n61_ & new_n62_ & x15));
  assign z12 = (~x00 & x01) | (new_n69_ & ((~new_n68_ & ~x00) | (x01 & (~x02 | ~x10))));
