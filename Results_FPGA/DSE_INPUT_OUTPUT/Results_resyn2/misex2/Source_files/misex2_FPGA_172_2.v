...
module FAU ( 
  ...
  assign z09 = ~x22 & (x21 | (~x00 & (new_n65_ | (new_n63_ & new_n64_))));
  assign new_n63_ = ~x16 & x20 & ~x13 & ~x14 & ~x11 & x12;
  assign new_n64_ = ~x15 & ~x01 & x02;
  assign new_n65_ = x18 & ~x19 & x01 & ~x20;
  assign z10 = ~x00 & (new_n70_ | (new_n67_ & new_n68_ & new_n69_));
  assign new_n67_ = ~x13 & ~x14 & ~x11 & x12;
  assign new_n68_ = ~x22 & x20 & ~x21;
  assign new_n69_ = ~x01 & x02 & x15 & x16;
  assign new_n70_ = x18 & ~x19 & x01 & ~x20 & x21 & x22;
  assign z11 = ~x22 & (x21 | (new_n63_ & new_n72_));
  assign new_n72_ = ~x00 & ~x01 & x02 & x15;
