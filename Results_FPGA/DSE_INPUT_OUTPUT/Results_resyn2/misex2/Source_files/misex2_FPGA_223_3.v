...
module FAU ( 
  ...
  assign z03 = new_n52_ | (x01 & (x04 | (new_n51_ & x12)));
  assign new_n51_ = ~x09 & x10 & x11 & x00 & x02;
  assign new_n52_ = x18 & ~x19 & ~x01 & ~x02 & ~x00 & ~x17;
  assign z04 = new_n54_ & ~x09 & x10 & ~x12 & x02 & ~x11;
  assign new_n54_ = ~x04 & x00 & x01;
  assign z05 = new_n54_ & x09 & x02 & x10;
  assign z06 = x01 & (new_n51_ | x04);
  assign z07 = ~new_n58_ & x00 & x02;
  assign new_n58_ = x01 & (x04 | x09 | x12 | ~x10 | ~x11);
  assign z08 = x04 & (x01 | (new_n60_ & new_n61_));
  ...
  assign z10 = new_n63_ | (~x00 & (new_n70_ | (new_n65_ & new_n69_)));
  ...
  assign new_n72_ = x18 & ~x19 & x01 & ~x20 & ~x04 & x21;
  assign new_n73_ = ~x16 & ~x14 & x15 & x20 & ~x21;
  assign z12 = (new_n75_ | (new_n54_ & (~x02 | ~x10))) & x09 & ~x24;
  assign new_n75_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign z13 = (x01 & x04) | (~x00 & ~x01 & x17 & ~x02 & ~x19);
