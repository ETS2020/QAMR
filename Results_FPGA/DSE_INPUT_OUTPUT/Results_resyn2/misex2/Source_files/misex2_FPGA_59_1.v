...
module FAU ( 
  ...
  assign z00 = new_n46_ & ~x01 & ~x16 & ~x09 & ~x00 & ~x02;
  ...
  assign new_n51_ = ~x16 & (x19 | x00 | x02 | x17 | ~x18);
  ...
  assign z09 = new_n57_ | (new_n67_ & (new_n66_ | (new_n65_ & ~x15 & x20)));
  assign new_n65_ = ~x01 & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n66_ = ~x19 & ~x20 & x01 & x18;
  assign new_n67_ = ~x21 & ~x00 & ~x22;
  assign z10 = new_n57_ | (new_n69_ & ~x00 & x22);
  assign new_n69_ = x21 & ~x19 & ~x20 & x01 & x18;
  assign z11 = ~x00 & ~x22 & (new_n69_ | (new_n65_ & new_n71_));
  assign new_n71_ = x15 & ~x16 & x20 & ~x21;
  ...
  assign z13 = x17 & ~x01 & ~x16 & ~x19 & ~x00 & ~x02;
