...
module FAU ( 
  ...
  assign z00 = new_n46_ & ~x22 & new_n47_ & x10 & ~x17;
  assign new_n46_ = ~x18 & ~x19;
  assign new_n47_ = ~x00 & ~x01 & ~x02 & ~x09;
  assign z01 = ~x01 & (x22 | (new_n49_ & new_n46_ & x10 & ~x17));
  assign new_n49_ = x09 & ~x00 & ~x02;
  assign z02 = ~x01 & (x22 | (new_n49_ & new_n46_ & ~x10 & ~x17));
  ...
  assign z05 = (~x01 & x22) | (x00 & x01 & x09 & x02 & x10);
