...
module FAU ( 
  ...
  wire new_n46_, new_n49_, new_n51_, new_n52_, new_n54_, new_n57_, new_n60_,
    ...
    new_n70_, new_n71_, new_n74_, new_n75_, new_n76_;
  ...
  assign z04 = x02 & x00 & x01 & new_n54_ & ~x11 & ~x12;
  assign new_n54_ = ~x09 & x10;
  assign z05 = x02 & x10 & x09 & x00 & x01;
  assign z06 = new_n51_ | new_n57_;
  assign new_n57_ = ~x01 & ~x12;
  assign z07 = (~x01 & ~x12) | ((~x01 | (new_n54_ & x11 & ~x12)) & x00 & x02);
  ...
  assign z09 = new_n57_ | (new_n67_ & ~x21 & (new_n66_ | (new_n64_ & new_n65_)));
  assign new_n64_ = ~x11 & ~x13 & ~x01 & x02;
  assign new_n65_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = x18 & ~x19 & x01 & ~x20;
  assign new_n67_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n69_ & x22) | (new_n70_ & new_n71_ & x16 & ~x22));
  assign new_n69_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n70_ = x12 & ~x01 & x02 & ~x11 & ~x13;
  assign new_n71_ = ~x14 & x15 & x20 & ~x21;
  assign z11 = new_n67_ & (new_n69_ | (new_n70_ & new_n71_ & ~x16));
  assign z12 = x09 & ~x24 & (new_n74_ | (~new_n75_ & new_n76_));
  assign new_n74_ = x00 & x01 & (~x02 | ~x10);
  assign new_n75_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign new_n76_ = x12 & ~x00 & ~x01;
