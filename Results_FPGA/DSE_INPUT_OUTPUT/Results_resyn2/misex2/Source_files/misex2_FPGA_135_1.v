...
module FAU ( 
  ...
  assign z02 = ~x00 & (x01 | (x09 & new_n46_ & ~x10));
  assign z03 = new_n51_ | (z06 & x12);
  assign z06 = ~x09 & x11 & x02 & x10 & x00 & x01;
  assign new_n51_ = ~x02 & ~x19 & ~x17 & x18 & ~x00 & ~x01;
  assign z04 = x01 & (~x00 | (new_n53_ & ~x09 & x02 & ~x11));
  assign new_n53_ = x10 & ~x12;
  assign z05 = x00 & x02 & x01 & x09 & x10;
  assign z07 = x00 & x02 & (~x01 | (new_n53_ & ~x09 & x11));
  assign z08 = ~x00 & (x01 | (new_n57_ & new_n58_));
  assign new_n57_ = ~x08 & x17 & ~x18 & x19;
  assign new_n58_ = x02 & ~x03 & x04 & ~x05 & ~x06 & ~x07;
  assign z09 = ~x00 & (x01 | (new_n60_ & new_n61_ & ~x15));
  ...
  assign z11 = ~x00 & (x01 | (new_n61_ & new_n63_));
  assign z12 = (~x00 & x01) | (((~new_n68_ & ~x00) | (~new_n67_ & x01)) & x09 & ~x24);
