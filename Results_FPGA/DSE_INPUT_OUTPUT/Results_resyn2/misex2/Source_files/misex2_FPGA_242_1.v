...
module FAU ( 
  ...
  assign z00 = new_n46_ & ~x09 & ~x00 & ~x01 & ~x02;
  ...
  assign z09 = ~x15 & new_n63_ & new_n64_ & ~x00 & ~x01 & ~x16;
  assign new_n63_ = x02 & ~x11 & ~x14 & x12 & ~x13;
  assign new_n64_ = ~x22 & x20 & ~x21;
  assign z10 = ~x00 & (x01 | (new_n63_ & new_n64_ & x15 & x16));
  assign z11 = x15 & new_n63_ & new_n64_ & ~x00 & ~x01 & ~x16;
  assign z12 = (~x00 & x01) | (((~new_n68_ & ~x00) | (~new_n56_ & x01)) & x09 & ~x24);
  assign new_n68_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = new_n49_ & ~x09 & ~x00 & ~x01 & ~x02;
