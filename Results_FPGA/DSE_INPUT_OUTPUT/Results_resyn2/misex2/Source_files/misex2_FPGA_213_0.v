...
module FAU ( 
  ...
  assign z03 = new_n52_ | (~x07 & ~x12) | (new_n53_ & x12 & x02 & x11);
  assign new_n52_ = ~x02 & ~x19 & ~x00 & ~x01 & ~x17 & x18;
  assign new_n53_ = ~x09 & x10 & x00 & x01;
  assign z04 = new_n55_ & ~x11 & ~x12 & x07 & ~x09;
  assign new_n55_ = x00 & x01 & x02 & x10;
  assign z05 = new_n55_ & ~new_n48_ & x09;
  assign z06 = new_n53_ & ~new_n48_ & x02 & x11;
  ...
  assign new_n62_ = ~x06 & ~x07 & ~x08 & x12;
