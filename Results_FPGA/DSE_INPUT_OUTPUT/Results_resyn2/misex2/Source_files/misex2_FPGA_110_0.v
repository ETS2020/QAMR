...
module FAU ( 
  ...
  assign z03 = (~x00 & ~x01) | (x12 & new_n46_ & x02 & x00 & x01);
  assign new_n46_ = x11 & ~x09 & x10;
  assign z04 = new_n48_ & x02 & x00 & x01;
  assign new_n48_ = ~x09 & x10 & ~x11 & ~x12;
  assign z05 = x02 & x10 & x09 & x00 & x01;
  assign z06 = (~x00 & ~x01) | (new_n46_ & x02 & x00 & x01);
  assign z07 = (~x01 | (new_n46_ & ~x12)) & x00 & x02;
  assign z08 = ~x00 & ~x01;
