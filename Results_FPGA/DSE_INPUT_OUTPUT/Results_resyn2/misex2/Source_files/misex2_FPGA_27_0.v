...
module FAU ( 
  ...
  assign z00 = (~x07 & ~x10) | (new_n46_ & x10 & ~x19 & ~x17 & ~x18);
  assign new_n46_ = ~x09 & ~x02 & ~x00 & ~x01;
  assign z01 = (~x07 & ~x10) | (new_n48_ & x10 & ~x19 & ~x17 & ~x18);
  assign new_n48_ = x09 & ~x02 & ~x00 & ~x01;
  assign z02 = ~x10 & (~x07 | (new_n48_ & ~x19 & ~x17 & ~x18));
  assign z03 = (new_n51_ & x12 & ~x09 & x10) | new_n52_ | (~x07 & ~x10);
  assign new_n51_ = x11 & x02 & x00 & x01;
  ...
  assign z06 = new_n51_ & ~x09 & x10;
  assign z07 = ~new_n58_ & x00 & x02;
  assign new_n58_ = (x01 | (~x07 & ~x10)) & (~x11 | x12 | x09 | ~x10);
  assign z08 = ~x07 & (~x10 | (new_n60_ & new_n61_ & new_n62_));
  assign new_n60_ = x19 & x17 & ~x18;
  assign new_n61_ = ~x06 & ~x08 & x04 & ~x05;
  ...
  assign new_n67_ = ~x21 & ~x22 & ~x00 & (x07 | x10);
  assign z10 = new_n69_ | (~x00 & ((new_n70_ & x22) | (new_n65_ & new_n71_)));
  assign new_n69_ = ~x07 & ~x10;
  assign new_n70_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n71_ = ~x14 & x15 & ~x21 & ~x22 & x16 & x20;
  assign z11 = (new_n70_ | (new_n65_ & new_n73_)) & ~x22 & ~new_n69_ & ~x00;
  assign new_n73_ = ~x14 & x15 & ~x21 & ~x16 & x20;
  assign z12 = new_n69_ | ((new_n75_ | new_n76_) & x09 & ~x24);
  assign new_n75_ = x00 & x01 & (~x02 | ~x10);
  assign new_n76_ = ~x00 & ~x01 & ((~x02 & ~x19) ? x17 : x23);
  assign z13 = new_n69_ | (~x00 & ~x01 & x17 & ~x02 & ~x19);
  assign z14 = ~x10 & (~x07 | (new_n46_ & ~x19 & ~x17 & ~x18));
  assign z15 = (x00 | (~x01 & x19)) & (x07 | x10) & (~x02 | (x01 & ~x10));
  assign z16 = x01 & ~new_n69_ & ~x00;
  assign z17 = ~new_n69_ & ~x00 & ~x01 & x02;
endmodule
