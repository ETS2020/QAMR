...
module FAU ( 
  ...
  assign new_n65_ = x01 & ~x20 & x08 & x18 & ~x19;
  assign z10 = new_n50_ | (~x00 & ((new_n67_ & x22) | (new_n63_ & new_n68_)));
  assign new_n67_ = x01 & ~x20 & x21 & x18 & ~x19;
  assign new_n68_ = ~x14 & x15 & x20 & ~x21 & x16 & ~x22;
  assign z11 = new_n50_ | (~x00 & ~x22 & (new_n67_ | (new_n63_ & new_n70_)));
