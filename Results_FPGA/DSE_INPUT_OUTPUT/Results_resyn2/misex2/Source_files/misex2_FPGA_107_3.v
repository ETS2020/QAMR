...
module FAU ( 
  ...
  assign z09 = (new_n57_ | (new_n58_ & new_n59_)) & ~x22 & ~x00 & ~x21;
  assign new_n57_ = x18 & ~x19 & x01 & ~x20;
  assign new_n58_ = ~x16 & ~x14 & ~x01 & x02;
  assign new_n59_ = ~x13 & ~x11 & x12 & ~x15 & x20;
  assign z10 = ~x00 & ((new_n61_ & new_n62_) | (new_n57_ & x21 & x22));
  assign new_n61_ = ~x13 & ~x11 & x12 & ~x22 & x20 & ~x21;
  assign new_n62_ = ~x14 & ~x01 & x02 & x15 & x16;
  assign z11 = (x01 & (new_n64_ | x00)) | (new_n61_ & new_n58_ & ~x00 & x15);
