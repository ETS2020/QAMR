...
module FAU ( 
  ...
  assign z06 = (~x00 & ~x01) | (new_n47_ & x02 & x00 & x01);
  assign z07 = (~x01 | (new_n47_ & ~x12)) & x00 & x02;
  assign z09 = new_n54_ & ~x22 & z16 & ~x20 & ~x21;
  assign new_n54_ = x18 & ~x19;
  assign z16 = ~x00 & x01;
  assign z10 = ~x00 & (~x01 | (~x20 & x21 & new_n54_ & x22));
  assign z11 = ~x00 & (~x01 | (~x20 & x21 & new_n54_ & ~x22));
