...
module FAU ( 
  ...
  assign z03 = x12 & new_n46_ & ~x09 & x11 & x02 & x10;
  assign new_n46_ = x00 & x01;
  assign z04 = ~x12 & x02 & x10 & ~x11 & new_n46_ & ~x09;
  assign z05 = new_n46_ & x09 & x02 & x10;
  assign z06 = (~x09 & x00 & x01 & x11 & x02 & x10) | (~x01 & ~x02);
  assign z07 = (~x01 & ~x02) | (x00 & (~x01 | (new_n51_ & ~x12 & x02 & x10)));
  assign new_n51_ = ~x09 & x11;
  assign z08 = ~x01 & (~x02 | (new_n53_ & new_n54_));
  assign new_n53_ = ~x08 & x17 & ~x18 & x19;
  assign new_n54_ = ~x00 & ~x03 & x04 & ~x05 & ~x06 & ~x07;
  ...
  assign new_n64_ = (~x00 | ~x01 | (x02 & x10)) & (x01 | ~x02 | x00 | ~x23);
  assign z13 = ~x01 & ~x02;
  assign z15 = new_n46_ & (~x02 | ~x10);
