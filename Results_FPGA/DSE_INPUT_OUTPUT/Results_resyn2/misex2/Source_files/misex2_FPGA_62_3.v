...
module FAU ( 
  ...
  assign z09 = (new_n55_ | (new_n56_ & new_n57_)) & ~x22 & ~x00 & ~x21;
  assign new_n55_ = x18 & ~x19 & x01 & ~x20;
  assign new_n56_ = ~x16 & ~x14 & ~x01 & x02;
  assign new_n57_ = ~x13 & ~x11 & x12 & ~x15 & x20;
  assign z10 = ~x00 & ((new_n59_ & new_n60_) | (new_n55_ & x21 & x22));
  assign new_n59_ = ~x13 & ~x11 & x12 & ~x22 & x20 & ~x21;
  assign new_n60_ = ~x14 & ~x01 & x02 & x15 & x16;
  assign z11 = (x01 & (new_n62_ | x00)) | (new_n59_ & new_n56_ & ~x00 & x15);
  assign new_n62_ = x18 & ~x19 & ~x22 & ~x20 & x21;
  assign z12 = new_n64_ & ((~x02 & ~x19) ? x17 : x23);
  assign new_n64_ = x09 & ~x24 & ~x00 & ~x01;
