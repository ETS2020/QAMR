...
module FAU ( 
  ...
  assign z03 = (new_n53_ & x12) | (new_n54_ & ~new_n48_ & ~x19);
  assign new_n53_ = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign new_n54_ = ~x01 & ~x02 & x18 & ~x00 & ~x17;
  assign z04 = ~x11 & (new_n56_ | ~x13);
  assign new_n56_ = x02 & x00 & x01 & ~x12 & ~x09 & x10;
  assign z05 = new_n48_ | (x02 & x10 & x09 & x00 & x01);
  assign z06 = new_n48_ | new_n53_;
  assign z07 = ~new_n60_ & x00 & x02;
  assign new_n60_ = (x01 | (~x11 & ~x13)) & (x12 | ~x11 | x09 | ~x10);
  assign z08 = new_n48_ | (new_n62_ & new_n63_);
  assign new_n62_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign new_n63_ = x02 & ~x00 & ~x01 & x19 & x17 & ~x18;
  assign z09 = new_n48_ | (new_n65_ & ~x22 & ~x20 & ~x21);
  assign new_n65_ = ~x19 & x18 & ~x00 & x01;
  assign z10 = new_n48_ | (new_n65_ & x22 & ~x20 & x21);
  assign z11 = new_n68_ & x18 & ~x00 & x01;
  assign new_n68_ = ~x22 & ~x20 & x21 & ~x19 & (x11 | x13);
  assign z12 = new_n48_ | ((new_n70_ | new_n71_) & x09 & ~x24);
  assign new_n70_ = x00 & x01 & (~x02 | ~x10);
  assign new_n71_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
  assign z13 = ~new_n48_ & ~x19 & ~x00 & ~x01 & ~x02 & x17;
