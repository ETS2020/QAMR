...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n59_, new_n61_, new_n64_,
    new_n65_;
  ...
  assign new_n50_ = x00 & ~x09 & x10 & x11;
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign z04 = new_n53_ & ~x12 & x10 & ~x11;
  assign new_n53_ = x00 & ~x09 & x01 & x02;
  assign z05 = x02 & x10 & x09 & x00 & x01;
  assign z06 = x02 & (new_n50_ | ~x01);
  assign z07 = x02 & (~x01 | (new_n50_ & ~x12));
  assign z08 = ~x01 & x02;
  assign z09 = new_n59_ & ~x21 & ~x22;
  assign new_n59_ = x18 & ~x19 & ~x20 & ~x00 & x01;
  assign z10 = new_n61_ & x22;
  assign new_n61_ = x21 & x18 & ~x19 & ~x20 & ~x00 & x01;
  assign z11 = new_n61_ & ~x22;
  assign z12 = new_n65_ & ((x00 & x01 & (~x02 | ~x10)) | (~new_n64_ & ~x02 & ~x00 & ~x01));
