...
module FAU ( 
  ...
  assign new_n22_ = (((~x2 | ((~x5 | x6) & (~x4 | x5 | ~x6))) & ~x8 & (~x4 | x2 | x6)) | x7 | (x8 & (x2 | ~x6))) & (~x5 | (~x8 & (~x2 | x4)) | (x8 & x2 & ~x4)) & ((x8 & (~x2 | ~x4)) | (x6 & ~x7) | (~x8 & (x2 | x5)));
  ...
  assign new_n38_ = (~x5 | (~x8 & (~x2 | x4))) & (~x8 | (x2 & x4)) & ((x2 & x4) | x5 | x6);
  ...
  assign new_n59_ = (x6 | x7 | ~x9 | ~x4 | ~x5) & (x9 | ((x3 | x5 | ~x6) & (x4 | ~x3 | ~x7)));
  assign z2 = z3 | (~x1 & ~x3);
  assign z3 = (x1 & x3) | (x0 & ~x9);
  assign z4 = new_n69_ | (x9 & (~new_n63_ | (x6 & (new_n77_ | ~new_n80_))));
  assign new_n63_ = (new_n64_ | ~x4) & (x6 | (~new_n66_ & (new_n68_ | ~x1)));
  assign new_n64_ = ~new_n65_ & ((~x1 & ~x3) | ~x2 | x5 | x8);
  assign new_n65_ = (~x1 | (x3 & ~x7)) & x5 & (~x0 | (x2 & ~x7));
  assign new_n66_ = x5 & (new_n67_ | (x4 & (~x7 | (~x0 & ~x3))));
  assign new_n67_ = (x4 | (~x3 & ~x8)) & ~x2 & (~x1 | ~x3);
  assign new_n68_ = ((x4 & x5) | ~x3 | ~x7) & (x2 | ~x5 | x4 | x8);
  assign new_n69_ = x0 & (~new_n72_ | (x6 & (new_n70_ | (~new_n76_ & ~x5))));
  assign new_n70_ = new_n71_ & (~x8 | ((~x2 | ~x7) & (x5 | (x1 & x7))));
  assign new_n71_ = ~x4 & (~x5 | ((~x2 | ~x1 | x3) & (x1 | ~x3) & (x2 | x7)));
  assign new_n72_ = x9 & (new_n75_ | ~x1) & (new_n73_ | new_n74_);
  assign new_n73_ = x8 & (~x2 | ~x7);
  assign new_n74_ = (x5 | (~x1 & (~x3 | ~x4))) & (~x5 | x6 | x3 | x4);
  assign new_n75_ = (x4 | x6 | x8) & (~x3 | x5 | ~x7);
  assign new_n76_ = (x7 | (x2 & x8)) & (x1 | ~x3 | ~x4) & (~x1 | (x2 & x3));
  assign new_n77_ = ~x0 & (new_n79_ | (new_n78_ & ((~x1 & ~x3) | (~x4 & x1 & x3))));
  assign new_n78_ = ~x2 & x5 & (~x7 | ~x8);
  assign new_n79_ = x4 & ~x5 & (x7 ? x1 : x2);
  assign new_n80_ = (x5 | ((~x1 | x3 | (~x4 & x7)) & (x7 | (x8 & (x1 | ~x3 | ~x4))))) & (~x1 | x3 | ~x5 | x4 | ~x7);
