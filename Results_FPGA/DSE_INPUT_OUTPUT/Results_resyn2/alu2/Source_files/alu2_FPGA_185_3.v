...
module FAU ( 
  ...
  assign z0 = (~x0 & ((~new_n21_ & x9) | new_n19_ | new_n22_)) | (~new_n23_ & ~x9);
  assign new_n19_ = ~x4 & (new_n20_ | ~x8) & x2 & (~new_n20_ | (~x5 & x8));
  assign new_n20_ = x6 & ~x7;
  assign new_n21_ = (~x2 | ((~x4 | ((~x5 | (x4 & (x6 | x7))) & (~x8 | (x6 & ~x7)) & (x7 | x8 | x5 | ~x6))) & (x8 | ~x5 | (x4 & (x6 | x7))))) & (~x4 | ((~x5 | ~x8) & (x7 | x8 | x2 | x6))) & (x2 | (x8 ^ (x5 | (x6 & ~x7))));
  ...
  assign new_n26_ = (new_n27_ | ~x3) & (new_n28_ | ((x3 | x6) & (x7 | ~x3 | ~x5)));
  assign new_n27_ = (~x4 | ((~x5 | x6 | x7) & (x8 | ~x2 | ~x7))) & (x7 | (~x8 & (x5 | x6)) | (x4 & (x6 | ~x8)));
  assign new_n28_ = ~x8 & (~x2 | x4);
  assign new_n29_ = ~new_n33_ & (x1 | ((new_n30_ | x3) & ~new_n32_ & (new_n31_ | ~x3)));
  assign new_n30_ = (~x5 | ~x8) & (~x2 | (~x4 & ~x5) | (x4 & (x8 | x5 | (x6 & ~x7))));
  ...
  assign new_n39_ = (~x2 | ((x8 | x3 | ~x4) & (~x3 | x4 | ~x7))) & ((~x5 & x7) | x8 | x3 | ~x4) & (~x8 | ~x3 | x4 | ~x7);
  ...
  assign z4 = x9 & ((~new_n53_ & x1) | new_n45_ | ~new_n50_);
  assign new_n45_ = ~new_n46_ & x5 & (~new_n49_ | (~new_n48_ & ~x2));
  assign new_n46_ = (~new_n47_ | x4 | (x8 & (~x6 | x7))) & x3 & (~x4 | x7);
  assign new_n47_ = x1 & ~x0 & ~x2;
  assign new_n48_ = (x6 | x8) & (x4 | (x8 & (~x6 | x7)) | x0 | x1);
  assign new_n49_ = ~x3 & (~x4 | x6) & (~x6 | ~x1 | x4 | ~x7);
  assign new_n50_ = new_n52_ & (new_n51_ | ~x4);
  assign new_n51_ = ((~new_n20_ & ~x3) | (~new_n20_ & x8) | ~x2 | x5) & (x1 | ~x5) & (~new_n20_ | x1 | ~x3);
  assign new_n52_ = ~x0 & (x7 | x8 | x5 | ~x6);
  assign new_n53_ = (x5 | ((~x4 | (~new_n54_ & (~x6 | ~x7))) & (x3 ? (x6 | ~x7) : (~x6 | x7)))) & (x6 | ~x3 | x4 | ~x7);
  assign new_n54_ = x2 & (x6 | ~x8);
