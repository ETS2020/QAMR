...
module FAU ( 
  ...
  assign new_n28_ = (new_n29_ | x3) & new_n35_ & (new_n33_ | ~x3);
  assign new_n29_ = ~new_n30_ & (~x6 | ((new_n31_ | x5) & (new_n32_ | ~x5 | ~x9)));
  assign new_n30_ = (~x5 | (~x4 & x6)) & ~x7 & ~x9;
  assign new_n31_ = ((~x4 & ~x8) | ((~x0 | ~x7) & ((~x0 & x8) | ~x2 | (~x7 & ~x8)))) & (x7 | ~x8 | x0 | x2);
  assign new_n32_ = ((x4 & x7) | ~x2 | ~x8) & (x0 | (~x8 & (~x2 | x4)));
  assign new_n33_ = ((x4 & (x5 | ~x7)) | x6 | x9) & (new_n34_ | ~x6 | ~x9);
  assign new_n34_ = (~x4 | ((x5 | ((x7 | x8) & ((~x0 & x8) | x2 | (x0 & x7)))) & (x0 | ~x8 | (~x2 & ~x7)))) & ((~x0 & (x2 | x8)) | x4 | ~x5 | (x2 & x8));
  ...
  assign z4 = x9 & (~new_n57_ | (~new_n53_ & (~new_n51_ | (~new_n58_ & x4))));
  assign new_n51_ = new_n52_ & (~x1 | ((~x0 | ~x7) & (x7 ? ~x4 : x3)));
  assign new_n52_ = (~x0 | ((x2 | x7) & (x4 | x8))) & ~x5 & (x7 | x8);
  assign new_n53_ = (x4 | (~new_n55_ & (new_n54_ | x3))) & ~new_n56_ & x5;
  assign new_n54_ = (~x7 | (~x1 & (~x0 | x2))) & ((~x0 ^ ~x2) | x1 | ~x6 | (x7 & x8));
  assign new_n55_ = x1 & x3 & ((~x7 & (x0 ^ ~x2)) | (~x0 & ~x2 & ~x8));
  assign new_n56_ = x4 & (~x0 | (x2 & ~x7)) & (~x1 | (x3 & ~x7));
  assign new_n57_ = x6 & (~x0 | ~x7 | new_n45_ | ~x1 | x4);
