...
module FAU ( 
  ...
  assign new_n26_ = (new_n27_ | ~x3) & (new_n28_ | (x3 ? (~x5 | x7) : x6));
  assign new_n27_ = (~x4 | ((~x5 | x6 | x7) & (x8 | ~x2 | ~x7))) & ((x4 & (x6 | ~x8)) | x7 | (~x8 & (x5 | x6)));
  ...
  assign new_n35_ = ((x6 & x8) | x7 | (~x4 & ~x6)) & (x8 | x4 | ~x6) & ~x3 & (x5 | x6);
  ...
  assign new_n39_ = (~x2 | ((~x3 | x4 | ~x7) & (~x4 | x3 | x8))) & (x3 | x8 | ~x4 | (~x5 & x7)) & (~x8 | ~x3 | x4 | ~x7);
  ...
  assign new_n45_ = new_n46_ & new_n48_ & (x3 | ((~x5 | x6) & (~x1 | x5 | ~x6)));
  assign new_n46_ = (x1 | (~x5 & (~x3 | ~x6 | x7))) & ~new_n47_ & (~x3 | ~x5 | x7);
  assign new_n47_ = ~x5 & ~x8 & x2 & x3;
  assign new_n48_ = (x7 | ((~x5 | x6) & (~x2 | x5 | ~x6))) & (((~x2 | (~x6 & x8)) & (~x6 | ~x7)) | ~x1 | x5);
  assign new_n49_ = (new_n50_ | ~x1) & ~new_n54_ & (new_n56_ | ~x6 | x7);
  assign new_n50_ = (new_n52_ | ~x6) & ~new_n53_ & (new_n51_ | ~x7 | ~x3 | x6);
  assign new_n51_ = x4 & x5;
  assign new_n52_ = (x2 | ~x3 | ~x5 | x7) & (x3 | (~x5 & x7) | (x5 & ~x7) | (x4 & x5));
  assign new_n53_ = ~x2 & x5 & (~x6 | x7) & ~x4 & ~x8;
