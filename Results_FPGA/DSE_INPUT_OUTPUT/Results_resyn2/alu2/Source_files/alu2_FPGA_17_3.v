...
module FAU ( 
  ...
  assign new_n31_ = (new_n32_ | ~x3) & ((x3 ? x7 : x6) | new_n33_ | (~x5 & (x3 | x6)));
  assign new_n32_ = (~x4 | ((~x5 | x6 | x7) & (~x7 | ~x2 | x8))) & (x7 | (~x8 & (x5 | x6)) | (x4 & (x6 | ~x8)));
  ...
  assign new_n44_ = (~x2 | ((~x3 | x4 | ~x7) & (~x4 | x3 | x8))) & ((x3 & ~x8) | ((~x3 | x4 | ~x7) & (x8 | ~x4 | (~x5 & x7))));
  ...
  assign z4 = ~x0 & x9 & (~new_n50_ | (~new_n57_ & x4));
  assign new_n50_ = ~new_n53_ & ~new_n54_ & (~x1 | (~new_n51_ & ~new_n56_));
  assign new_n51_ = (~x4 | ~x5) & (new_n52_ | (x7 & x3 & ~x6));
  assign new_n52_ = x5 & ~x8 & (~x6 | x7) & ~x2 & ~x4;
  assign new_n53_ = new_n21_ & ((~x5 & ~x8) | (~x2 & x5 & ~x1 & ~x3));
  assign new_n54_ = new_n55_ & (~x6 | (~x4 & x7));
  assign new_n55_ = ~x2 & x5 & ~x3 & ~x8;
  assign new_n56_ = x6 & ((~x2 & x5 & x3 & ~x7) | ((~x5 | (~x4 & x7)) & ~x3 & (x5 | ~x7)));
  assign new_n57_ = (new_n58_ | x5) & ((~x5 & (~x3 | ~x6 | x7)) | (x1 & (~x5 | (x3 ? x7 : x6))));
  assign new_n58_ = (~x2 | ((~x3 | x8) & (~x6 | x7))) & (~x1 | ((~x2 | x8) & (~x6 | ~x7)));
