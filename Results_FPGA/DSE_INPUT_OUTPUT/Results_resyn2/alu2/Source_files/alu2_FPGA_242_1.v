...
module FAU ( 
  ...
  assign z1 = (x0 & ((~new_n26_ & x9) | new_n33_ | new_n37_)) | (~new_n39_ & ~x9);
  ...
  assign new_n30_ = (~x4 | ((x2 | ~x8 | (x6 & (x5 | x7))) & (x5 | x8 | ~x6 | x7))) & ((x8 & (x2 | ~x6)) | x4 | ~x5);
  assign new_n31_ = (x3 | ~x6 | (x8 & (x2 | (~x5 & x7)))) & (x6 | ~x8 | (x7 & (x2 | x3))) & ((x6 & x7 & (x5 | x8)) | (~x7 & ~x8) | ~x3 | (~x2 & x8));
  assign new_n32_ = (x5 | (x3 & x8)) & ~x7 & x4 & ~x6;
  assign new_n33_ = ~new_n34_ & x7 & (new_n36_ | ~x1 | (x4 & x6));
  assign new_n34_ = new_n35_ & ((~x4 & ~x8) | x5 | ~x6 | (x3 & x4));
  assign new_n35_ = ~x1 & (x4 | x6 | ~x2 | ~x3);
  assign new_n36_ = x3 & x5 & x2 & x8;
  assign new_n37_ = ~new_n38_ & ~x1 & (~x3 | ~x4);
  assign new_n38_ = (~x2 | ~x8 | x5 | ~x6) & (~x3 | x6 | x8);
  assign new_n39_ = (x3 | ((x1 | x7 | (x5 & (x4 | ~x6))) & (x5 | ~x6))) & (x1 | ((x4 | x5) & (~x3 | x6 | (x4 & (x5 | ~x7))))) & (~x1 | ((x3 | ((x5 | ~x7) & (~x4 | ~x6))) & ((~x7 & (x4 | ~x6)) | ((~x6 | ~x7) & (~x3 | ~x5))))) & (~x3 | x4 | ~x7);
  assign z2 = z3 | (~x1 & ~x3);
  ...
  assign new_n47_ = x4 & ((~x7 & (~x6 | (x2 & x3))) | ((x2 | ~x6) & ~x1 & (~x2 | ~x7)));
