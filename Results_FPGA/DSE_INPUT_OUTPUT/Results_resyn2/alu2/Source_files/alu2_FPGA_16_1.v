...
module FAU ( 
  ...
  assign z4 = x9 & (new_n52_ | ~x7 | (~new_n57_ & x0));
  assign new_n52_ = (new_n53_ | (~new_n55_ & (x5 | (~new_n54_ & x4)))) & (new_n56_ | ~x4 | ~x5);
  assign new_n53_ = ~x6 & x1 & x3;
  assign new_n54_ = (~x1 | (~x6 & (~x2 | x8))) & (~x3 | ((~x2 | x8) & (~x0 | (x8 & ~x2 & ~x6))));
  assign new_n55_ = ((x3 & (x2 | x8)) | ~x1 | ~x6) & ~x4 & (x3 | x2 | x8);
  assign new_n56_ = (~x1 | (~x3 & ~x6)) & (~x0 | (~x2 & ~x6));
  assign new_n57_ = (~new_n58_ | ((~x1 | x5) & x8 & (x2 | ~x5))) & ~new_n59_ & (~x1 | x5 | (~x2 & x8));
  assign new_n58_ = (~x4 | (x1 & ~x5)) & x6 & (~x5 | x1 | ~x3);
  assign new_n59_ = ~x3 & ~x6 & x2 & ~x4 & x5;
