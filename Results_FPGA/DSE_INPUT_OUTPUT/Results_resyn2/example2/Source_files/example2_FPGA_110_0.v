...
module FAU ( 
  ...
  assign z22 = (~x55 & ~x79) | (~x01 & (new_n178_ | (new_n183_ & ~new_n182_ & x79)));
  ...
  assign z24 = new_n186_ & (x79 ? (x77 & x78) : x55);
  ...
  assign z37 = (~x55 & ~x79) | (new_n201_ & new_n190_ & x55);
  ...
  assign z47 = new_n155_ | (~x01 & (new_n216_ | (new_n215_ & (x67 | x75))));
  assign new_n215_ = x77 & ~x78 & ~new_n182_ & x79;
  assign new_n216_ = new_n217_ & x04 & ~x79 & (x15 | ~x52) & (x07 | x52);
  assign new_n217_ = ~x77 & x78;
  assign z48 = ~x01 & (new_n219_ | (new_n220_ & (x16 | ~x52) & (x08 | x52)));
  assign new_n219_ = x68 & x77 & ~x78 & ~new_n182_ & x79;
  assign new_n220_ = x55 & ~x79 & new_n217_ & x04;
  assign z49 = ~x01 & (new_n222_ | (new_n220_ & (x17 | ~x52) & (x09 | x52)));
  assign new_n222_ = x69 & x77 & ~x78 & ~new_n182_ & x79;
  assign z50 = ~x01 & (new_n224_ | (new_n220_ & (x18 | ~x52) & (x10 | x52)));
  assign new_n224_ = x70 & x77 & ~x78 & ~new_n182_ & x79;
  assign z51 = new_n155_ | (~x01 & (new_n226_ | (new_n215_ & x71)));
  assign new_n226_ = new_n217_ & x04 & ~x79 & (x19 | ~x52) & (x11 | x52);
  assign z52 = new_n155_ | (~x01 & (new_n228_ | (new_n215_ & x72)));
  assign new_n228_ = new_n217_ & x04 & ~x79 & (x20 | ~x52) & (x12 | x52);
  assign z53 = ~x01 & (new_n230_ | (new_n220_ & (x21 | ~x52) & (x13 | x52)));
  assign new_n230_ = x73 & x77 & ~x78 & ~new_n182_ & x79;
  ...
  assign z58 = (~x55 & ~x79) | (~x01 & (new_n238_ | (~x79 & (new_n217_ | ~x04))));
  ...
  assign z59 = (~x55 & ~x79) | (~x01 & ((~x04 & ~x79) | (~new_n242_ & x77)));
  ...
  assign new_n246_ = x77 & x78 & new_n244_ & (~new_n180_ | ~new_n181_);
  assign new_n247_ = (~new_n182_ | ((x77 | ~x78) & (~x79 | ~x77 | x78))) & (x79 | (x04 & ~x78));
  assign z61 = new_n249_ & x80 & ~x01 & x79;
  assign new_n249_ = (x77 ^ ~x78) ? (~x04 & x78) : (~x81 ^ x84);
  assign z62 = (~x79 & (~x55 | (new_n179_ & ~x01))) | (~x01 & (new_n246_ | new_n251_));
  ...
  assign new_n254_ = (~new_n217_ | ~x04 | x79) & (~new_n249_ | ~x79 | ~x83);
