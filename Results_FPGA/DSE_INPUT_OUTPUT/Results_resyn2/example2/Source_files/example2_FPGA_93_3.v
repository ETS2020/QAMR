...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n158_, new_n159_, new_n163_, new_n181_,
    ...
    new_n206_, new_n208_, new_n210_, new_n222_, new_n223_, new_n224_,
    new_n226_, new_n228_, new_n230_, new_n232_, new_n234_, new_n238_,
    new_n240_, new_n243_, new_n244_, new_n245_, new_n246_, new_n248_,
    new_n249_, new_n251_, new_n252_, new_n253_, new_n256_, new_n259_;
  ...
  assign z23 = (new_n188_ & x05) | (~new_n163_ & (~x00 | x01));
  ...
  assign z26 = x79 & (x73 | (~x42 & x44 & ~new_n193_ & new_n195_));
  ...
  assign z32 = x79 & (x73 | (~x42 & x50 & ~new_n193_ & new_n195_));
  assign z33 = ~new_n203_ & new_n195_ & ~x73 & x79;
  assign new_n203_ = ((new_n204_ & (~x81 | x83) & (x81 | ~x83)) | ~x05 | ~x42 | (~new_n204_ & (~x81 ^ ~x83))) & (x42 | ~x51 | (~new_n204_ ^ ~x81));
  assign new_n204_ = ~x82 ^ x84;
  assign z34 = x79 & (x73 | (new_n206_ & (~new_n193_ ^ (x42 & x83))));
  assign new_n206_ = ~x01 & x52 & new_n155_ & ~x04;
  assign z35 = new_n208_ & new_n190_ & x53;
  assign new_n208_ = (~new_n193_ ^ (x42 & x83)) & new_n155_ & ~x73 & x79;
  assign z36 = x79 & (x73 | (new_n210_ & x54));
  assign new_n210_ = new_n195_ & (~new_n193_ ^ (x42 & x83));
  assign z37 = x79 & (x73 | (new_n210_ & x55));
  assign z38 = new_n208_ & new_n190_ & x56;
  assign z39 = new_n208_ & new_n190_ & x57;
  assign z40 = new_n208_ & new_n190_ & x58;
  assign z41 = new_n208_ & new_n190_ & x59;
  assign z42 = new_n208_ & new_n190_ & x60;
  assign z43 = new_n208_ & new_n190_ & x61;
  assign z44 = x79 & (x73 | (new_n210_ & x62));
  assign z45 = x79 & (x73 | (new_n210_ & x63));
  assign z46 = x79 & (x73 | (new_n210_ & x64));
  assign z47 = new_n163_ | (~x01 & (new_n222_ | (new_n224_ & (x67 | x75))));
  ...
  assign z49 = new_n163_ | (~new_n228_ & ~x01);
  assign new_n228_ = (~new_n224_ | ~x69) & (~new_n223_ | (~x17 & x52) | (~x09 & ~x52));
  assign z50 = ~x01 & (new_n230_ | (x70 & new_n224_ & ~x73));
  assign new_n230_ = new_n223_ & (x18 | ~x52) & (x10 | x52);
  assign z51 = ~x01 & (new_n232_ | (x71 & new_n224_ & ~x73));
  assign new_n232_ = new_n223_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = new_n163_ | (~new_n234_ & ~x01);
  assign new_n234_ = (~new_n224_ | ~x72) & (~new_n223_ | (~x20 & x52) | (~x12 & ~x52));
  assign z53 = new_n163_ | (new_n223_ & ~x01 & (x21 | ~x52) & (x13 | x52));
  assign z54 = new_n163_ | (new_n223_ & ~x01 & (x22 | ~x52) & (x14 | x52));
  assign z55 = x79 & (new_n238_ | x73);
  assign new_n238_ = new_n195_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = ~x00 | x01 | ((x73 | ~x77 | ~x78) & (new_n240_ | (~x77 & ~x78)));
  assign new_n240_ = x79 & (~new_n186_ | x73 | x76);
  assign z57 = x00 & ~x01 & ~new_n163_ & ~x02 & x03;
  assign z58 = ~x01 & (new_n246_ | (x77 & (new_n243_ | new_n245_)));
  assign new_n243_ = new_n244_ & (x42 | (new_n183_ & new_n184_));
  assign new_n244_ = (~x40 | ~x42) & x04 & x78 & ~x73 & x79;
  assign new_n245_ = x40 & ~x42 & ~x78 & ~x79;
  assign new_n246_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = ~x01 & (new_n188_ | (x77 & (new_n248_ | (~new_n249_ & x78))));
  assign new_n248_ = x40 & (~x79 | (new_n182_ & ~x73));
  assign new_n249_ = x79 & ((new_n183_ & new_n184_) | x73 | ~x04 | x42);
  assign z60 = ~x01 & ((~new_n251_ & ~x73) | (~x79 & (~x04 | x78)));
  assign new_n251_ = ~new_n252_ & (~new_n253_ | (new_n183_ & new_n184_));
  assign new_n252_ = (~x81 ^ ~x84) & ((~x77 & x78) | (x79 & x77 & ~x78));
  assign new_n253_ = x77 & x78 & x04 & ~x42;
  assign z61 = x80 & new_n159_ & ((~x04 & x77 & x78) | (new_n186_ & (~x77 ^ ~x78)));
  assign z62 = new_n163_ | (~x01 & (new_n181_ | new_n256_));
  assign new_n256_ = ((~x04 & x77) | (x77 & ~x78) | (~x77 & x78)) & x79 & x81 & (x84 | (x77 & x78));
  assign z63 = x82 & new_n159_ & ((~x04 & x77 & x78) | (new_n186_ & (~x77 ^ ~x78)));
  assign z64 = new_n163_ | (~new_n259_ & ~x01);
  assign new_n259_ = (~x78 | ((x79 | ~x04 | x77) & (x04 | ~x77 | ~x79 | ~x83))) & (~x79 | ~x83 | ~new_n186_ | (x77 ^ ~x78));
