...
module FAU ( 
  ...
  wire new_n155_, new_n176_, new_n177_, new_n178_, new_n179_, new_n180_,
    ...
    new_n198_, new_n200_, new_n201_, new_n204_, new_n223_, new_n230_,
    new_n232_;
  ...
  assign z22 = new_n155_ & (new_n178_ | (new_n176_ & new_n180_));
  assign new_n176_ = ~x42 & (~new_n177_ | ~x81);
  assign new_n177_ = x43 & ~x74 & x80 & x82 & ~x83 & x84;
  assign new_n178_ = ~new_n179_ & ~x41 & ((x66 & x77 & ~x78) | (x78 & x75 & ~x77));
  ...
  assign z25 = ~x01 & (~x79 | (new_n185_ & x05 & ~x04 & ~x42));
  assign new_n185_ = x77 & x78 & (~new_n186_ ^ x81);
  assign new_n186_ = ~x82 ^ x84;
  assign z26 = new_n185_ & new_n155_ & x44 & ~x04 & ~x42;
  assign z27 = ~x01 & (~x79 | (new_n185_ & x45 & ~x04 & ~x42));
  assign z28 = new_n185_ & new_n155_ & x46 & ~x04 & ~x42;
  assign z29 = ~x01 & (~x79 | (new_n185_ & x47 & ~x04 & ~x42));
  assign z30 = new_n185_ & new_n155_ & x48 & ~x04 & ~x42;
  ...
  assign z34 = ~x01 & (~x79 | (new_n200_ & x52));
  assign new_n200_ = new_n198_ & ~new_n201_;
  assign new_n201_ = (x42 & x83) ^ (~x81 ^ (x82 ^ x84));
  assign z35 = ~x01 & (~x79 | (new_n200_ & x53));
  assign z36 = new_n204_ & x54 & ~x01 & ~x04;
  assign new_n204_ = ~new_n201_ & x79 & x77 & x78;
  assign z37 = ~x01 & (~x79 | (new_n200_ & x55));
  assign z38 = new_n204_ & x56 & ~x01 & ~x04;
  assign z39 = ~x01 & (~x79 | (new_n200_ & x57));
  assign z40 = new_n204_ & x58 & ~x01 & ~x04;
  assign z41 = ~x01 & (~x79 | (new_n200_ & x59));
  assign z42 = ~x01 & (~x79 | (new_n200_ & x60));
  assign z43 = ~x01 & (~x79 | (new_n200_ & x61));
  assign z44 = new_n204_ & x62 & ~x01 & ~x04;
  assign z45 = new_n204_ & x63 & ~x01 & ~x04;
  assign z46 = new_n204_ & x64 & ~x01 & ~x04;
  assign z47 = (x67 | x75) & new_n155_ & ~new_n179_ & x77 & ~x78;
  assign z48 = x68 & new_n155_ & ~new_n179_ & x77 & ~x78;
  assign z49 = ~x01 & (~x79 | (x69 & ~new_n179_ & x77 & ~x78));
  assign z50 = ~x01 & (~x79 | (x70 & ~new_n179_ & x77 & ~x78));
  assign z51 = x71 & new_n155_ & ~new_n179_ & x77 & ~x78;
  assign z52 = ~x01 & (~x79 | (x72 & ~new_n179_ & x77 & ~x78));
  assign z53 = x73 & new_n155_ & ~new_n179_ & x77 & ~x78;
  assign z55 = ~x01 & (~x79 | (new_n198_ & new_n223_));
  assign new_n223_ = ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = ((~x77 | ~x78) & (new_n179_ | x76)) | z23 | (~x77 & ~x78);
  assign z57 = ~x01 & (~x79 | (x03 & x00 & ~x02));
  assign z58 = ~new_n176_ & new_n180_ & new_n155_ & (~x40 | ~x42);
  assign z59 = ~x01 & (~x79 | (new_n180_ & (new_n176_ | x40)));
  assign z60 = new_n155_ & ((new_n176_ & x78 & x04 & x77) | (new_n179_ & (~x77 | ~x78) & (x77 | x78)));
  ...
  assign z64 = ~new_n230_ & new_n155_ & x83;
  assign z65 = ((~x04 & x77 & x78) | (x81 & (~x77 | ~x78) & (x77 | x78))) & new_n155_ & x84;
  assign z04 = ~x01;
  assign z54 = z03;
endmodule
