...
module FAU ( 
  ...
  assign z37 = new_n199_ & new_n195_ & x55;
  ...
  assign z51 = ~x01 & (new_n224_ | (new_n217_ & x71));
  assign new_n224_ = new_n220_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = (~x79 & (new_n226_ | x01)) | (new_n217_ & ~x01 & x72);
  ...
  assign new_n230_ = (x22 | ~x52) & ~x01 & x04 & (x14 | x52);
  ...
  assign z59 = ~new_n243_ & (~x79 | (new_n242_ & (new_n237_ | x40)));
  assign new_n242_ = ~x01 & x04 & x78;
  assign new_n243_ = ~x01 & x04 & (~x77 | (~x40 & ~x78));
  assign z60 = ~x01 & (~new_n245_ | (new_n178_ & x79));
  assign new_n245_ = (x79 | (x04 & ~x78)) & ((~x81 & ~x84) | (x81 & x84) | ((x77 | ~x78) & (~x79 | ~x77 | x78)));
  assign z61 = (x01 & ~x79) | (x80 & ~new_n247_ & ~x01 & x79);
  ...
  assign z63 = (x01 & ~x79) | (x82 & ~new_n247_ & ~x01 & x79);
  assign z64 = ~x01 & (new_n220_ | (~new_n247_ & x79 & x83));
