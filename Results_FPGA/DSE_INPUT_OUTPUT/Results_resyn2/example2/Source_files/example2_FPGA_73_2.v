...
module FAU ( 
  ...
  assign z27 = (new_n186_ & x45) | (x01 & ~x79);
  ...
  assign z44 = new_n201_ & new_n197_ & x62;
  ...
  assign new_n223_ = new_n179_ & ~x77 & (x18 | ~x52) & (x10 | x52);
  assign z51 = (new_n217_ & ~x01 & x71) | (~x79 & (new_n225_ | x01));
  assign new_n225_ = new_n179_ & ~x77 & (x19 | ~x52) & (x11 | x52);
  ...
  assign z58 = new_n240_ | (x77 & (new_n239_ | (~new_n237_ & new_n238_)));
  assign new_n237_ = ~x42 & (~new_n180_ | ~new_n181_);
  assign new_n238_ = (~x40 | ~x42) & new_n179_ & ~x01 & x79;
  assign new_n239_ = x40 & ~x42 & ~x78 & ~x79;
  assign new_n240_ = ~x79 & ((~x77 & x78) | x01 | ~x04);
  assign z59 = (x77 & (new_n242_ | new_n244_)) | (~x79 & (x01 | ~x04));
  assign new_n242_ = x40 & (~x79 | (new_n243_ & x04));
  assign new_n243_ = ~x01 & x78;
  assign new_n244_ = new_n243_ & (~x79 | (x04 & ~x42 & (~new_n180_ | ~new_n181_)));
  assign z60 = ~x01 & (~new_n246_ | (new_n178_ & x79));
  assign new_n246_ = ((~x81 & ~x84) | (x81 & x84) | ((x77 | ~x78) & (~x79 | ~x77 | x78))) & (x79 | (x04 & ~x78));
  assign z61 = (x01 & ~x79) | (x80 & ~new_n248_ & ~x01 & x79);
  assign new_n248_ = (x04 | ~x77 | ~x78) & ((x77 & x78) | (~x77 & ~x78) | (x81 ^ x84));
  assign z62 = ~x01 & (new_n250_ | (new_n179_ & (~x79 | (new_n237_ & x77))));
  assign new_n250_ = (x77 | x78) & (~x77 | ~x04 | ~x78) & x79 & x81 & (x84 | (x77 & x78));
  assign z63 = (x01 & ~x79) | (x82 & ~new_n248_ & ~x01 & x79);
