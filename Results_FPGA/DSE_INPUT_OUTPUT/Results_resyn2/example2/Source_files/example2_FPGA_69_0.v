...
module FAU ( 
  ...
  wire new_n156_, new_n176_, new_n177_, new_n178_, new_n179_, new_n180_,
    ...
    new_n198_, new_n199_, new_n201_, new_n204_, new_n223_, new_n225_,
    new_n228_, new_n232_, new_n234_;
  assign z00 = (~x01 & (x40 | ~x79)) | (x06 & ~x40) | (x40 & x52);
  assign z01 = ~x01 & ((x77 & x78) | ~x79 | (~x77 & ~x78));
  assign z02 = new_n156_ & ((x66 & x77 & ~x78) | (x78 & x75 & ~x77));
  ...
  assign new_n188_ = new_n156_ & (~new_n186_ | x81) & new_n183_ & (new_n186_ | ~x81);
  ...
  assign new_n204_ = ~new_n201_ & new_n183_ & x79;
  ...
  assign z56 = ((~x77 | ~x78) & (~new_n180_ | x76)) | ~new_n225_ | ~x79 | (~x77 & ~x78);
  assign new_n225_ = x00 & ~x01;
  assign z57 = new_n225_ & x79 & ~x02 & x03;
  assign z58 = ~new_n228_ & new_n156_ & new_n177_ & (~x40 | ~x42);
  assign new_n228_ = ~x42 & (~new_n178_ | ~x84 | ~x80 | ~x82);
  assign z59 = new_n156_ & new_n177_ & (new_n228_ | x40);
  assign z60 = ~x01 & (new_n176_ | ~x79 | (~new_n180_ & (~x77 | ~x78) & (x77 | x78)));
  assign z61 = ~x01 & (~x79 | (new_n232_ & x80));
  assign new_n232_ = (x77 ^ x78) ? new_n180_ : (~x04 & x78);
  assign z62 = new_n156_ & (new_n176_ | new_n234_);
  assign new_n234_ = (x84 | (x77 & x78) | (~x77 & ~x78)) & x81 & ((~x04 & x78) | (x77 ^ x78));
  assign z63 = ~x01 & (~x79 | (new_n232_ & x82));
  assign z64 = new_n232_ & new_n156_ & x83;
  assign z65 = (x81 | (x77 & x78) | (~x77 & ~x78)) & new_n156_ & x84 & ((~x04 & x78) | (x77 ^ x78));
  assign z04 = ~x01;
  assign z54 = z03;
endmodule
