...
module FAU ( 
  ...
  wire new_n155_, new_n176_, new_n177_, new_n178_, new_n179_, new_n180_,
    new_n183_, new_n185_, new_n186_, new_n194_, new_n196_, new_n197_,
  ...
  assign new_n185_ = new_n155_ & new_n183_ & (~new_n186_ | x81) & (new_n186_ | ~x81);
  ...
  assign z32 = ~x01 & (~x79 | (new_n194_ & (new_n186_ | ~x81) & (~new_n186_ | x81)));
  assign new_n194_ = new_n183_ & ~x42 & x50;
  ...
  assign z36 = ~x01 & (~x79 | (new_n201_ & new_n183_ & x54));
  assign z37 = ~x01 & (~x79 | (new_n201_ & new_n183_ & x55));
  assign z38 = ~x01 & (~x79 | (new_n201_ & new_n183_ & x56));
  assign z39 = ~x01 & (~x79 | (new_n201_ & new_n183_ & x57));
  ...
  assign z49 = new_n215_ & new_n155_ & x69;
  ...
  assign new_n225_ = ((x77 & x78) | (~new_n180_ & ~x76)) & x00 & (x77 | x78);
  assign z57 = ~z23 & ~x02 & x03;
  assign z58 = ~x01 & (~x79 | (~new_n228_ & new_n177_ & (~x40 | ~x42)));
  assign new_n228_ = ~x42 & (~new_n178_ | ~x84 | ~x80 | ~x82);
  assign z59 = ~x01 & (~x79 | (new_n177_ & (new_n228_ | x40)));
  assign z60 = new_n155_ & (new_n176_ | (new_n180_ & (~x77 | ~x78) & (x77 | x78)));
  assign z61 = ~x01 & (~x79 | (new_n232_ & x80));
  assign new_n232_ = ((~x77 ^ ~x78) | (~x04 & x78)) & ((x79 & x81 & x84) | (~x77 & ~x78) | (x77 & x78) | (~x81 & ~x84));
  assign z62 = new_n155_ & (new_n176_ | new_n234_);
  assign new_n234_ = (x84 | (~x77 & ~x78) | (x77 & x78)) & x81 & ((~x77 ^ ~x78) | (~x04 & x78));
  assign z63 = ((~x04 & x78) | (x77 ^ x78)) & (~new_n180_ | (x77 & x78) | (~x77 & ~x78)) & new_n155_ & x82;
