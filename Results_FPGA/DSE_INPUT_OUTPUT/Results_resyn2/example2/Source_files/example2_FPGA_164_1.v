...
module FAU ( 
  ...
  assign z47 = z01 & new_n180_ & (x07 | x52) & (x15 | ~x52);
  assign new_n180_ = ~x77 & x04 & x78;
  assign z48 = ~x01 & (x79 | (new_n180_ & (x08 | x52) & (x16 | ~x52)));
  assign z49 = z01 & new_n180_ & (x09 | x52) & (x17 | ~x52);
  assign z50 = ~x01 & (x79 | (new_n180_ & (x10 | x52) & (x18 | ~x52)));
  assign z51 = ~x01 & (x79 | (new_n180_ & (x11 | x52) & (x19 | ~x52)));
  assign z52 = z01 & new_n180_ & (x12 | x52) & (x20 | ~x52);
  assign z53 = ~x01 & (x79 | (new_n180_ & (x13 | x52) & (x21 | ~x52)));
  assign z54 = ~x01 & (x79 | (new_n180_ & (x14 | x52) & (x22 | ~x52)));
