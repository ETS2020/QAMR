...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n159_, new_n179_, new_n180_, new_n181_,
    ...
    new_n192_, new_n193_, new_n201_, new_n202_, new_n203_, new_n204_,
  ...
  assign z04 = (~new_n155_ | x79) & ~x01 & (~x08 | ~x79);
  assign new_n155_ = x77 & x78;
  assign new_n156_ = x08 & x79;
  assign z01 = (x08 & x79) | (~x01 & ((~x77 & ~x78) | ~x79 | (x77 & x78)));
  assign z02 = ~new_n159_ & x79;
  assign new_n159_ = ~x08 & (x01 | ((~x75 | x77 | ~x78) & (~x66 | ~x77 | x78)));
  assign z03 = (x08 & x79) | (x78 & ~x79 & ~x01 & x52);
  ...
  assign z25 = new_n189_ & x05 & ~x42 & ~x08 & ~x01 & ~x04;
  assign new_n189_ = ~new_n190_ & new_n155_ & x79;
  assign new_n190_ = x81 ^ (x82 ^ ~x84);
  assign z26 = x79 & (x08 | (new_n192_ & x44));
  assign new_n192_ = ~new_n190_ & new_n193_ & ~x42;
  assign new_n193_ = x77 & x78 & ~x01 & ~x04;
  assign z27 = new_n189_ & x45 & ~x42 & ~x08 & ~x01 & ~x04;
  assign z28 = x79 & (x08 | (new_n192_ & x46));
  assign z29 = x79 & (x08 | (new_n192_ & x47));
  assign z30 = x79 & (x08 | (new_n192_ & x48));
  assign z31 = new_n189_ & x49 & ~x42 & ~x08 & ~x01 & ~x04;
  assign z32 = new_n189_ & x50 & ~x42 & ~x08 & ~x01 & ~x04;
  assign z33 = ((new_n203_ & (x81 | ~x83) & (~x81 | x83)) | new_n202_ | (new_n204_ & ~x81)) & new_n201_ & ((new_n203_ & (x81 ^ x83)) | ~new_n202_ | (new_n204_ & x81));
  assign new_n201_ = new_n193_ & ~x08 & x79;
  assign new_n202_ = ~x82 ^ x84;
  assign new_n203_ = x05 & x42;
  assign new_n204_ = ~x42 & x51;
  assign z34 = x79 & (x08 | (new_n206_ & x52));
  assign new_n206_ = new_n193_ & (~new_n190_ | (x42 & x83)) & (new_n190_ | ~x42 | ~x83);
  assign z35 = new_n208_ & x53 & ~x08 & ~x01 & ~x04;
  assign new_n208_ = new_n155_ & x79 & (~new_n190_ | (x42 & x83)) & (new_n190_ | ~x42 | ~x83);
  assign z36 = x79 & (x08 | (new_n206_ & x54));
  assign z37 = new_n208_ & x55 & ~x08 & ~x01 & ~x04;
  assign z38 = x79 & (x08 | (new_n206_ & x56));
  assign z39 = x79 & (x08 | (new_n206_ & x57));
  assign z40 = x79 & (x08 | (new_n206_ & x58));
  assign z41 = x79 & (x08 | (new_n206_ & x59));
  assign z42 = x79 & (x08 | (new_n206_ & x60));
  assign z43 = x79 & (x08 | (new_n206_ & x61));
  assign z44 = new_n208_ & x62 & ~x08 & ~x01 & ~x04;
  assign z45 = new_n208_ & x63 & ~x08 & ~x01 & ~x04;
  assign z46 = new_n208_ & x64 & ~x08 & ~x01 & ~x04;
  ...
  assign z48 = ~new_n225_ & ~x01;
  assign new_n225_ = (~new_n222_ | (~x16 & x52) | (~x08 & ~x52)) & (~new_n223_ | x08 | ~x68);
  assign z49 = ~x01 & (new_n227_ | (new_n223_ & ~x08 & x69));
  assign new_n227_ = new_n222_ & (x09 | x52) & (x17 | ~x52);
  assign z50 = ~x01 & (new_n229_ | (new_n223_ & ~x08 & x70));
  assign new_n229_ = new_n222_ & (x10 | x52) & (x18 | ~x52);
  assign z51 = ~x01 & (new_n231_ | (new_n223_ & ~x08 & x71));
  assign new_n231_ = new_n222_ & (x11 | x52) & (x19 | ~x52);
  assign z52 = ~x01 & (new_n233_ | (new_n223_ & ~x08 & x72));
  assign new_n233_ = new_n222_ & (x12 | x52) & (x20 | ~x52);
  assign z53 = ~x01 & (new_n235_ | (new_n223_ & ~x08 & x73));
  assign new_n235_ = new_n222_ & (x13 | x52) & (x21 | ~x52);
  assign z54 = new_n156_ | (new_n222_ & (x22 | ~x52) & ~x01 & (x14 | x52));
  assign z55 = new_n201_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = (~new_n239_ & x79) | ~x00 | x01 | (~x77 & ~x78);
  assign new_n239_ = (new_n155_ | (x81 ^ ~x84)) & ~x08 & (new_n155_ | ~x76);
  ...
  assign z63 = x79 & (x08 | (new_n253_ & x82));
