...
module FAU ( 
  ...
  wire new_n157_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    new_n185_, new_n186_, new_n191_, new_n196_, new_n198_, new_n199_,
  ...
  assign new_n180_ = x79 & (new_n157_ | x41 | (~x81 ^ ~x84));
  ...
  assign z29 = ~x01 & (~x79 | (new_n191_ & x47 & ~x04 & ~x42));
  assign new_n191_ = x77 & x78 & (new_n186_ ^ ~x81);
  assign z30 = new_n185_ & x48 & ~x04 & ~x42;
  assign z31 = ~x01 & (~x79 | (new_n191_ & x49 & ~x04 & ~x42));
  assign z32 = ~x01 & (~x79 | (new_n191_ & x50 & ~x04 & ~x42));
  assign z33 = ~x01 & (~x79 | (~new_n196_ & new_n183_));
  ...
  assign new_n198_ = new_n183_ & ~new_n199_;
  assign new_n199_ = (x42 & x83) ^ (~x81 ^ (x82 ^ x84));
  ...
  assign z41 = ~x01 & (~x79 | (new_n198_ & x59));
  assign z42 = ~x01 & (~x79 | (new_n198_ & x60));
  assign z43 = new_n203_ & x61 & ~x01 & ~x04;
  assign z44 = ~x01 & (~x79 | (new_n198_ & x62));
  ...
  assign z60 = z04 & (new_n177_ | ((~x77 | ~x78) & (x77 | x78) & (x81 | x84) & (~x81 | ~x84)));
  assign z61 = ~x01 & (~x79 | (~new_n230_ & x80));
  assign new_n230_ = (x04 | ~x77 | ~x78) & ((x77 & x78) | (~x77 & ~x78) | (~x81 ^ ~x84));
