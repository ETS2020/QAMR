// Benchmark "FAU" written by ABC on Wed Aug 12 20:27:08 2020
...
module FAU ( 
  ...
  assign z22 = x04 & z01 & x78;
  assign z23 = x01 | (~x79 & (~x00 | (~x04 & x05)));
  assign z24 = ~x01 & (x79 | (~x43 & ~x04 & x05));
  assign z47 = new_n180_ & (x15 | ~x52) & (x07 | x52);
  assign new_n180_ = x04 & ~x77 & x78 & ~x01 & ~x79;
  assign z48 = new_n180_ & (x16 | ~x52) & (x08 | x52);
  assign z49 = ~x01 & (x79 | (new_n183_ & (x09 | x52) & (x17 | ~x52)));
  assign new_n183_ = x78 & x04 & ~x77;
  assign z50 = new_n180_ & (x18 | ~x52) & (x10 | x52);
  assign z51 = ~x01 & (x79 | (new_n183_ & (x11 | x52) & (x19 | ~x52)));
  assign z52 = ~x01 & (x79 | (new_n183_ & (x12 | x52) & (x20 | ~x52)));
  assign z53 = new_n180_ & (x21 | ~x52) & (x13 | x52);
  assign z54 = new_n180_ & (x22 | ~x52) & (x14 | x52);
  assign z56 = x01 | (~x79 & (~x00 | (~x77 & ~x78)));
  assign z57 = z01 & x03 & x00 & ~x02;
  assign z58 = ~new_n192_ & ~x01;
  assign new_n192_ = ((~x78 & (~x40 | ~x77)) | (x77 & (x42 | x78))) & x04 & ~x79;
  assign z59 = z01 & (~x04 | (x77 & (x40 | x78)));
  assign z60 = z01 & (~x04 | x78);
  assign z64 = ~x01 & (new_n183_ | x79);
  assign z02 = 1'b0;
  assign z25 = 1'b0;
  assign z27 = 1'b0;
  assign z29 = 1'b0;
