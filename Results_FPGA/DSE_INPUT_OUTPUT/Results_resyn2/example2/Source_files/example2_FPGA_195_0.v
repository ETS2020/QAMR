...
module FAU ( 
  ...
  wire new_n157_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    ...
    new_n213_, new_n222_, new_n225_, new_n229_, new_n231_;
  ...
  assign z30 = new_n185_ & z04 & x48 & ~x04 & ~x42;
  ...
  assign new_n199_ = (new_n186_ | (x81 ^ (~x42 | ~x83))) & new_n183_ & (~new_n186_ | (x81 & (~x42 | ~x83)) | (~x81 & x42 & x83));
  assign z35 = ~x01 & (~x79 | (new_n199_ & ~x04 & x53));
  assign z36 = new_n199_ & x79 & x54 & ~x01 & ~x04;
  assign z37 = ~x01 & (~x79 | (new_n199_ & ~x04 & x55));
  assign z38 = new_n199_ & x79 & x56 & ~x01 & ~x04;
  assign z39 = new_n199_ & x79 & x57 & ~x01 & ~x04;
  ...
  assign z44 = ~x01 & (~x79 | (new_n199_ & ~x04 & x62));
  ...
  assign new_n222_ = x00 & ((x77 & x78) | ((~x81 | x84) & (x81 | ~x84) & ~x76 & (x77 | x78)));
  assign z57 = ~x01 & (~x79 | (x03 & x00 & ~x02));
  assign z58 = ~new_n225_ & new_n178_ & z04 & (~x40 | ~x42);
  ...
  assign z62 = z04 & (new_n177_ | new_n231_);
