...
module FAU ( 
  ...
  assign z37 = (x01 & ~x79) | (new_n201_ & new_n197_ & x55);
  ...
  assign z42 = new_n201_ & new_n197_ & x60;
  ...
  assign z48 = (new_n220_ & ~x01 & x68) | (~x79 & (new_n219_ | x01));
  assign new_n219_ = new_n216_ & (x16 | ~x52) & (x08 | x52);
  assign new_n220_ = (~x81 ^ x84) & x79 & x77 & ~x78;
  assign z49 = ~x01 & (new_n222_ | (new_n220_ & x69));
  assign new_n222_ = new_n216_ & ~x79 & (x17 | ~x52) & (x09 | x52);
  assign z50 = ~x01 & (new_n224_ | (new_n220_ & x70));
  assign new_n224_ = new_n216_ & ~x79 & (x18 | ~x52) & (x10 | x52);
  assign z51 = (new_n220_ & ~x01 & x71) | (~x79 & (new_n226_ | x01));
  assign new_n226_ = new_n216_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = (new_n220_ & ~x01 & x72) | (~x79 & (new_n228_ | x01));
  assign new_n228_ = new_n216_ & (x20 | ~x52) & (x12 | x52);
  assign z53 = (new_n220_ & ~x01 & x73) | (~x79 & (new_n230_ | x01));
  ...
  assign z60 = (~x79 & (x01 | x78)) | (~x01 & (new_n178_ | ~new_n245_));
  assign new_n245_ = (x04 | x79) & ((~x81 & ~x84) | (x81 & x84) | ((x77 | ~x78) & (~x79 | ~x77 | x78)));
  assign z61 = new_n247_ & x80 & ~x01 & x79;
  assign new_n247_ = (~x77 ^ x78) ? (~x04 & x78) : (~x81 ^ x84);
  assign z62 = (~x01 & (new_n178_ | new_n249_)) | (~x79 & (x01 | (x04 & x78)));
  assign new_n249_ = (x84 | (~x77 ^ x78)) & x79 & x81 & ((~x77 & x78) | (x77 & ~x78) | (~x04 & x78));
  assign z63 = new_n247_ & x82 & ~x01 & x79;
  assign z64 = (~x79 & (new_n216_ | x01)) | (new_n247_ & x83 & ~x01 & x79);
