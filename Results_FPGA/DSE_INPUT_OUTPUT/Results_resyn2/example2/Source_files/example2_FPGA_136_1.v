...
module FAU ( 
  ...
  assign z48 = ~x01 & (new_n222_ | (new_n219_ & (x16 | ~x52) & (x08 | x52)));
  assign new_n222_ = x68 & x77 & ~x78 & x79 & (x81 ^ ~x84);
  assign z49 = ~new_n224_ & ~x01;
  assign new_n224_ = (~new_n222_ | ~x69) & (~new_n219_ | (~x09 & ~x52) | (~x17 & x52));
  ...
  assign new_n230_ = (~new_n222_ | ~x72) & (~new_n219_ | (~x12 & ~x52) | (~x20 & x52));
  assign z53 = ~new_n232_ & ~x01;
  assign new_n232_ = (~new_n222_ | ~x73) & (~new_n219_ | (~x13 & ~x52) | (~x21 & x52));
  assign z54 = new_n219_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z55 = new_n196_ & new_n235_ & x83 & ~x80 & ~x81;
  assign new_n235_ = ~x82 & x84 & x68 & x79;
  assign z56 = ~x00 | x01 | ((~x68 | ~x77 | ~x78) & (new_n237_ | (~x77 & ~x78)));
  assign new_n237_ = x79 & (~x68 | x76 | (~x81 ^ ~x84));
  assign z57 = new_n156_ | (x00 & ~x01 & ~x02 & x03);
  assign z58 = new_n156_ | (~x01 & (new_n242_ | (x77 & (new_n240_ | new_n243_))));
  ...
  assign z59 = (~x68 & x79) | (~x01 & ((~x04 & ~x79) | (~new_n245_ & x77)));
  ...
  assign z61 = x79 & (~x68 | (new_n252_ & x80));
  assign new_n252_ = new_n253_ & ~x01;
  assign new_n253_ = (x77 ^ ~x78) ? (~x04 & x78) : (x81 ^ ~x84);
  assign z62 = new_n156_ | (~x01 & (new_n179_ | new_n255_));
  assign new_n255_ = (x84 | (x77 ^ ~x78)) & x79 & x81 & ((x77 & ~x78) | (~x77 & x78) | (~x04 & x78));
  assign z63 = x79 & (~x68 | (new_n252_ & x82));
  assign z64 = (~x68 & x79) | (~x01 & (new_n219_ | (new_n253_ & x79 & x83)));
  assign z65 = x79 & (new_n259_ | ~x68);
