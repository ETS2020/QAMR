...
module FAU ( 
  ...
  assign z01 = x01 ? x79 : (~x79 | (~x77 ^ x78));
  ...
  assign z26 = x79 & (x01 | (new_n186_ & x44 & ~x04 & ~x42));
  assign z27 = x45 & ~x04 & ~x42 & new_n186_ & ~x01 & x79;
  assign z28 = x79 & (x01 | (new_n186_ & x46 & ~x04 & ~x42));
  assign z29 = x79 & (x01 | (new_n186_ & x47 & ~x04 & ~x42));
  assign z30 = x48 & ~x04 & ~x42 & new_n186_ & ~x01 & x79;
  assign z31 = x79 & (x01 | (new_n186_ & x49 & ~x04 & ~x42));
  assign z32 = x79 & (x01 | (new_n186_ & x50 & ~x04 & ~x42));
  assign z33 = ~new_n196_ & ~new_n198_ & new_n154_ & x79 & ~x01 & ~x04;
  ...
  assign z37 = x79 & (x01 | (new_n200_ & x55));
  assign z38 = x79 & (x01 | (new_n200_ & x56));
  assign z39 = x79 & (x01 | (new_n200_ & x57));
  assign z40 = new_n203_ & x58 & ~x01 & ~x04;
  assign z41 = new_n203_ & x59 & ~x01 & ~x04;
  assign z42 = new_n203_ & x60 & ~x01 & ~x04;
  assign z43 = x79 & (x01 | (new_n200_ & x61));
  ...
  assign new_n216_ = ~x01 & ~x77 & x78 & x04 & ~x79;
  ...
  assign z49 = ~x01 & (new_n222_ | (new_n221_ & (x17 | ~x52) & (x09 | x52)));
  assign new_n221_ = ~x77 & x78 & x04 & ~x79;
  assign new_n222_ = x69 & x79 & x77 & ~x78 & (x81 ^ ~x84);
  assign z50 = (~new_n224_ & x79) | (new_n216_ & (x10 | x52) & (x18 | ~x52));
  assign new_n224_ = ~x01 & (~x70 | ~x77 | x78 | (~x81 ^ ~x84));
  assign z51 = (~new_n226_ & x79) | (new_n216_ & (x11 | x52) & (x19 | ~x52));
  assign new_n226_ = ~x01 & (~x71 | ~x77 | x78 | (~x81 ^ ~x84));
  assign z52 = ~x01 & (new_n228_ | (new_n221_ & (x20 | ~x52) & (x12 | x52)));
  assign new_n228_ = x72 & x79 & x77 & ~x78 & (x81 ^ ~x84);
  assign z53 = ~x01 & (new_n230_ | (new_n221_ & (x21 | ~x52) & (x13 | x52)));
  ...
  assign z56 = (~x01 | ~x79) & (~x00 | x01 | (~x01 & ((~x77 & ~x78) | (~new_n235_ & x79 & (~x77 | ~x78)))));
  ...
  assign new_n247_ = (~x79 | ((~x77 | ~x78) & (x81 | x84) & (~x81 | ~x84))) & ((x77 & x79) | x78 | (~x04 & ~x79));
  ...
  assign z64 = ~x01 & (new_n221_ | (new_n249_ & x79 & x83));
