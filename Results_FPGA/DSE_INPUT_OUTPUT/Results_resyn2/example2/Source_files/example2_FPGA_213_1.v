...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62, z63, z64, z65;
  wire new_n178_, new_n180_, new_n190_;
  assign z00 = (z04 & x40) | ((~x40 | x52) & ~z02 & (x06 | x40));
  ...
  assign new_n180_ = ~x77 & x04 & x78 & ~x01 & ~x79;
  assign z49 = ~x01 & (x79 | (new_n178_ & (x17 | ~x52) & (x09 | x52)));
  assign z50 = ~x01 & (x79 | (new_n178_ & (x18 | ~x52) & (x10 | x52)));
  assign z51 = new_n180_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = ~x01 & (x79 | (new_n178_ & (x20 | ~x52) & (x12 | x52)));
  ...
  assign new_n190_ = x04 & ~x79 & ((x77 & (~x40 | x42)) | (x77 & x78) | (~x77 & ~x78));
  assign z59 = ~x01 & (~x04 | x79 | (x77 & (x40 | x78)));
  assign z60 = ~x01 & (x78 | ~x04 | x79);
  assign z62 = x04 & x78 & ~x01 & ~x79;
  assign z64 = ~x01 & (new_n178_ | x79);
  assign z26 = 1'b0;
  assign z28 = 1'b0;
  assign z29 = 1'b0;
  assign z36 = 1'b0;
