...
module FAU ( 
  ...
  wire new_n154_, new_n157_, new_n178_, new_n179_, new_n180_, new_n181_,
    new_n182_, new_n186_, new_n187_, new_n189_, new_n197_, new_n199_,
  ...
  assign z22 = (x79 & (new_n178_ | x01)) | (~x01 & new_n182_ & (new_n179_ | ~x79));
  ...
  assign new_n186_ = ~x42 & new_n154_ & (new_n187_ ^ ~x81);
  assign new_n187_ = x82 ^ ~x84;
  assign z26 = new_n189_ & x44 & ~x04 & ~x42;
  assign new_n189_ = ~x01 & x79 & new_n154_ & (new_n187_ ^ ~x81);
  ...
  assign z31 = x79 & (x01 | (new_n186_ & ~x04 & x49));
  assign z32 = x79 & (x01 | (new_n186_ & ~x04 & x50));
  ...
  assign z34 = x79 & (x01 | (new_n199_ & x52));
  assign new_n199_ = ~new_n200_ & new_n154_ & ~x04;
  assign new_n200_ = (x82 ^ x84) ^ (x81 ^ (~x42 | ~x83));
  assign z35 = x79 & (x01 | (new_n199_ & x53));
  assign z36 = new_n203_ & x54 & ~x01 & ~x04;
  assign new_n203_ = ~new_n200_ & new_n154_ & x79;
  assign z37 = new_n203_ & x55 & ~x01 & ~x04;
  assign z38 = x79 & (x01 | (new_n199_ & x56));
  assign z39 = new_n203_ & x57 & ~x01 & ~x04;
  assign z40 = new_n203_ & x58 & ~x01 & ~x04;
  assign z41 = x79 & (x01 | (new_n199_ & x59));
  ...
  assign z46 = x79 & (x01 | (new_n199_ & x64));
  ...
  assign z53 = ~x01 & (new_n230_ | (new_n217_ & x73));
  ...
  assign z58 = new_n242_ | (x77 & (new_n241_ | (~new_n238_ & new_n239_)));
  assign new_n238_ = ~x42 & (~new_n180_ | ~new_n181_);
  assign new_n239_ = new_n240_ & (~x40 | ~x42);
  assign new_n240_ = x79 & x04 & x78;
  assign new_n241_ = ~x01 & ~x79 & ~x78 & x40 & ~x42;
  assign new_n242_ = (~x01 ^ x79) & ((~x77 & x78) | ~x04 | x79);
  assign z59 = (~new_n244_ & x77) | (x79 ? x01 : (~x01 & ~x04));
  assign new_n244_ = ~new_n245_ & (~new_n240_ | (~x40 & (x42 | (new_n180_ & new_n181_))));
  assign new_n245_ = (x40 | x78) & ~x01 & ~x79;
  assign z60 = (~x01 & ~x79 & (~x04 | x78)) | (x79 & (new_n247_ | x01 | (new_n179_ & x04 & x78)));
  ...
  assign z62 = ~x01 & (new_n251_ | (new_n182_ & (new_n179_ | ~x79)));
