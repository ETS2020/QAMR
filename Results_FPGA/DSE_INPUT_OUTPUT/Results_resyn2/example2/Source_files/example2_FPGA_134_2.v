...
module FAU ( 
  ...
  wire new_n154_, new_n157_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n243_, new_n244_, new_n246_, new_n248_, new_n250_;
  ...
  assign new_n201_ = (~new_n186_ ^ x81) ^ (x42 & x83);
  ...
  assign new_n221_ = new_n216_ & ~x79 & (x17 | ~x52) & (x09 | x52);
  ...
  assign new_n227_ = new_n216_ & ~x79 & (x20 | ~x52) & (x12 | x52);
  ...
  assign z55 = (new_n199_ & new_n232_) | (x01 & ~x79);
  ...
  assign new_n237_ = ~x42 & (~new_n180_ | ~x84 | ~x80 | ~x82);
  assign new_n238_ = (~x40 | ~x42) & new_n239_ & x04 & x78;
  assign new_n239_ = ~x01 & x79;
  assign new_n240_ = ~x78 & ~x79 & x40 & ~x42;
  assign new_n241_ = ~x79 & ((~x77 & x78) | x01 | ~x04);
  assign z59 = ~new_n244_ & (~x79 | (new_n243_ & (new_n237_ | x40)));
  assign new_n243_ = ~x01 & x04 & x78;
  ...
  assign new_n248_ = new_n239_ & ((~x04 & x77 & x78) | ((x77 | x78) & (~x77 | ~x78) & (x81 ^ ~x84)));
  ...
  assign z64 = (~x79 & (new_n216_ | x01)) | (new_n248_ & x83);
  assign z65 = (x77 | x78) & (~x77 | ~x04 | ~x78) & (x81 | (x77 & x78)) & new_n239_ & x84;
endmodule
