...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n158_, new_n178_, new_n179_, new_n180_,
    new_n181_, new_n184_, new_n186_, new_n187_, new_n196_, new_n197_,
  ...
  assign z22 = ~x01 & (new_n181_ | new_n178_ | ~x79);
  ...
  assign z24 = new_n184_ & new_n155_ & x05 & ~x43;
  ...
  assign z26 = new_n186_ & new_n155_ & x44 & ~x04 & ~x42;
  ...
  assign new_n196_ = ((new_n197_ & (~x81 ^ ~x83)) | ~new_n187_ | (new_n198_ & x81)) & new_n184_ & ((new_n197_ & (~x81 | x83) & (x81 | ~x83)) | new_n187_ | (new_n198_ & ~x81));
  ...
  assign z35 = ~x01 & (~x79 | (new_n201_ & new_n184_ & x53));
  assign z36 = new_n200_ & x54 & ~x01 & ~x04;
  assign z37 = new_n200_ & x55 & ~x01 & ~x04;
  assign z38 = new_n200_ & x56 & ~x01 & ~x04;
  assign z39 = ~x01 & (~x79 | (new_n201_ & new_n184_ & x57));
  assign z40 = new_n200_ & x58 & ~x01 & ~x04;
  assign z41 = ~x01 & (~x79 | (new_n201_ & new_n184_ & x59));
  assign z42 = new_n200_ & x60 & ~x01 & ~x04;
  assign z43 = new_n200_ & x61 & ~x01 & ~x04;
  assign z44 = ~x01 & (~x79 | (new_n201_ & new_n184_ & x62));
  assign z45 = ~x01 & (~x79 | (new_n201_ & new_n184_ & x63));
  assign z46 = ~x01 & (~x79 | (new_n201_ & new_n184_ & x64));
  assign z47 = new_n155_ & new_n215_ & (x67 | x75);
  assign new_n215_ = x77 & ~x78 & (~x81 ^ x84);
  assign z48 = x68 & new_n155_ & new_n215_;
  ...
  assign z62 = new_n155_ & (new_n178_ | new_n234_);
