...
module FAU ( 
  ...
  assign z64 = ~x77 & x04 & x78 & ~x01 & ~x79;
  ...
  assign z52 = ~x01 & (x79 | (new_n180_ & (x20 | ~x52) & (x12 | x52)));
  ...
  assign z58 = ~new_n190_ & ~x01 & ~x79;
  assign new_n190_ = x04 & ((x77 & (~x40 | x42)) | (x77 & x78) | (~x77 & ~x78));
