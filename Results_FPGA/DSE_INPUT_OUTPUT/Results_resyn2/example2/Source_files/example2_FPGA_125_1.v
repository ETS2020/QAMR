...
module FAU ( 
  ...
  wire new_n154_, new_n157_, new_n178_, new_n179_, new_n180_, new_n181_,
    new_n182_, new_n183_, new_n186_, new_n188_, new_n189_, new_n196_,
  ...
  assign z22 = ~x01 & ((~new_n178_ & x00) | (x04 & x78 & ~x79));
  assign new_n178_ = (~new_n179_ | ~new_n182_ | (new_n180_ & new_n181_)) & (new_n157_ | ~new_n183_);
  ...
  assign z23 = (x00 & x01) | (~x79 & (~x00 | (~x04 & x05)));
  assign z24 = (~x00 & x79) | (new_n186_ & (new_n179_ | ~x79));
  assign new_n186_ = ~x04 & x05 & ~x01 & ~x43;
  assign z25 = new_n188_ & ~x42 & ~x04 & x05;
  assign new_n188_ = ~new_n189_ & x00 & ~x01 & new_n179_ & x79;
  ...
  assign z31 = x79 & (~x00 | (~new_n189_ & new_n196_ & ~x42 & x49));
  assign new_n196_ = x77 & x78 & ~x01 & ~x04;
  assign z32 = new_n188_ & x50 & ~x04 & ~x42;
  assign z33 = x79 & (new_n199_ | ~x00);
  assign new_n199_ = ((new_n201_ & (~x81 ^ ~x83)) | ~new_n200_ | (new_n202_ & x81)) & new_n196_ & ((new_n201_ & (~x81 | x83) & (x81 | ~x83)) | new_n200_ | (new_n202_ & ~x81));
  assign new_n200_ = ~x82 ^ x84;
  assign new_n201_ = x05 & x42;
  assign new_n202_ = ~x42 & x51;
  assign z34 = x79 & (~x00 | (new_n204_ & x52));
  assign new_n204_ = new_n196_ & (~new_n189_ | (x42 & x83)) & (new_n189_ | ~x42 | ~x83);
  assign z35 = new_n206_ & x53 & ~x01 & ~x04;
  assign new_n206_ = (~new_n189_ | (x42 & x83)) & (new_n189_ | ~x42 | ~x83) & new_n179_ & x00 & x79;
  assign z36 = new_n206_ & x54 & ~x01 & ~x04;
  assign z37 = x79 & (~x00 | (new_n204_ & x55));
  assign z38 = x79 & (~x00 | (new_n204_ & x56));
  assign z39 = x79 & (~x00 | (new_n204_ & x57));
  assign z40 = x79 & (~x00 | (new_n204_ & x58));
  assign z41 = new_n206_ & x59 & ~x01 & ~x04;
  assign z42 = x79 & (~x00 | (new_n204_ & x60));
  assign z43 = new_n206_ & x61 & ~x01 & ~x04;
  assign z44 = x79 & (~x00 | (new_n204_ & x62));
  assign z45 = x79 & (~x00 | (new_n204_ & x63));
  assign z46 = x79 & (~x00 | (new_n204_ & x64));
  assign z47 = (~x00 & x79) | (~x01 & (new_n219_ | new_n221_));
  ...
  assign z48 = ~x01 & (new_n224_ | (new_n220_ & x00 & x68));
  assign new_n224_ = new_n222_ & (x16 | ~x52) & (x08 | x52);
  assign z49 = (~new_n226_ & ~x01) | (~x00 & x79);
  assign new_n226_ = (~new_n220_ | ~x69) & (~new_n222_ | (~x17 & x52) | (~x09 & ~x52));
  assign z50 = (~new_n228_ & ~x01) | (~x00 & x79);
  assign new_n228_ = (~new_n220_ | ~x70) & (~new_n222_ | (~x18 & x52) | (~x10 & ~x52));
  assign z51 = (~new_n230_ & ~x01) | (~x00 & x79);
  assign new_n230_ = (~new_n220_ | ~x71) & (~new_n222_ | (~x19 & x52) | (~x11 & ~x52));
  assign z52 = (~new_n232_ & ~x01) | (~x00 & x79);
  assign new_n232_ = (~new_n220_ | ~x72) & (~new_n222_ | (~x20 & x52) | (~x12 & ~x52));
  assign z53 = ~x01 & (new_n234_ | (new_n220_ & x00 & x73));
  assign new_n234_ = new_n222_ & (x21 | ~x52) & (x13 | x52);
  assign z54 = new_n222_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z55 = x79 & (new_n237_ | ~x00);
  assign new_n237_ = new_n196_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = (x00 | ~x79) & ((~new_n239_ & x79 & (~x77 | ~x78)) | ~x00 | x01 | (~x77 & ~x78));
  assign new_n239_ = ~x76 & (x81 ^ ~x84);
  ...
  assign new_n243_ = (~x40 | ~x42) & x00 & x79 & x04 & x78;
  assign new_n244_ = ~x79 & (~x04 | (~x77 & x78));
  assign new_n245_ = ~x78 & ~x79 & x40 & ~x42;
  assign z59 = (~x00 & x79) | (~x01 & ((~new_n247_ & x77) | (~x04 & ~x79)));
  assign new_n247_ = ~new_n248_ & (~x78 | (x79 & (~new_n182_ | (new_n180_ & new_n181_))));
  assign new_n248_ = x40 & (~x79 | (x04 & x78));
  assign z60 = ~x01 & (new_n250_ | (~x79 & (~x04 | x78)));
  assign new_n250_ = x00 & (new_n251_ | (new_n179_ & new_n182_ & (~new_n180_ | ~new_n181_)));
  ...
  assign z62 = (~x00 & x79) | (~x01 & (new_n258_ | (new_n257_ & (new_n256_ | ~x79))));
  assign new_n256_ = x77 & ~x42 & (~new_n180_ | ~new_n181_);
  assign new_n257_ = x04 & x78;
  assign new_n258_ = (x84 | (~x77 ^ x78)) & x79 & x81 & ((~x77 & x78) | (x77 & ~x78) | (~x04 & x78));
  assign z63 = x79 & (~x00 | (new_n253_ & x82));
  assign z64 = ~x01 & (new_n222_ | (new_n254_ & x83 & x00 & x79));
  assign z65 = x79 & (new_n262_ | ~x00);
