// Benchmark "FAU" written by ABC on Wed Aug 12 20:26:30 2020
...
module FAU ( 
  ...
  assign z05 = (~x40 | x65) & ~z27 & (x23 | x40);
  assign z27 = ~x01 & x79;
  assign z06 = (~x40 | x64) & ~z27 & (x24 | x40);
  assign z07 = (~x40 | x63) & ~z27 & (x25 | x40);
  assign z08 = (x40 & x62) | z27 | (x26 & ~x40);
  assign z09 = (~x40 | x61) & ~z27 & (x27 | x40);
  assign z10 = (x40 & x60) | z27 | (x28 & ~x40);
  assign z11 = (x40 & x59) | z27 | (x29 & ~x40);
  assign z12 = (x40 & x58) | z27 | (x30 & ~x40);
  assign z13 = (x40 & x57) | z27 | (x31 & ~x40);
  assign z14 = (x40 & x51) | z27 | (x32 & ~x40);
  assign z15 = (~x40 | x50) & ~z27 & (x33 | x40);
  assign z16 = (~x40 | x49) & ~z27 & (x34 | x40);
  assign z17 = (x40 & x48) | z27 | (x35 & ~x40);
  assign z18 = (~x40 | x47) & ~z27 & (x36 | x40);
  assign z19 = (~x40 | x46) & ~z27 & (x37 | x40);
  assign z20 = (~x40 | x45) & ~z27 & (x38 | x40);
  assign z21 = (x40 & x44) | z27 | (x39 & ~x40);
  ...
  assign z50 = (x10 | x52) & (x18 | ~x52) & new_n179_ & ~x01 & ~x79;
  assign z51 = (x11 | x52) & (x19 | ~x52) & new_n179_ & ~x01 & ~x79;
