...
module FAU ( 
  ...
  assign new_n229_ = (~new_n223_ | (~x10 & ~x52) | (~x18 & x52)) & (~new_n221_ | x18 | ~x70);
  ...
  assign z65 = new_n261_ & ~x01 & x84 & (x81 | (~x77 ^ x78));
endmodule
