...
module FAU ( 
  ...
  wire new_n156_, new_n176_, new_n177_, new_n178_, new_n179_, new_n180_,
    ...
    new_n198_, new_n199_, new_n201_, new_n203_, new_n216_, new_n224_,
    new_n226_, new_n229_, new_n233_;
  ...
  assign z58 = ~x01 & (~x79 | (~new_n229_ & new_n177_ & (~x40 | ~x42)));
  assign new_n229_ = ~x42 & (~new_n178_ | ~x84 | ~x80 | ~x82);
  assign z59 = z04 & new_n177_ & (new_n229_ | x40);
  assign z60 = z04 & (new_n176_ | (new_n156_ & new_n180_));
  assign z61 = ~new_n233_ & (~new_n156_ | ~new_n180_) & z04 & x80;
  assign new_n233_ = (x04 | ~x78) & (x77 ^ ~x78);
  assign z62 = z04 & (new_n176_ | ((~new_n156_ | x84) & ~new_n233_ & x81));
  assign z63 = ~x01 & (~x79 | (x82 & ~new_n233_ & (~new_n156_ | ~new_n180_)));
  assign z64 = ~new_n233_ & (~new_n156_ | ~new_n180_) & z04 & x83;
