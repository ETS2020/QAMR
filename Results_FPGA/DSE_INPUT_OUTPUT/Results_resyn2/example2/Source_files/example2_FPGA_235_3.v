...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n158_, new_n179_, new_n180_, new_n181_,
    ...
    new_n206_, new_n207_, new_n220_, new_n221_, new_n223_, new_n224_,
  ...
  assign new_n194_ = (~new_n190_ ^ x81) & new_n195_ & new_n155_ & ~x42;
  ...
  assign new_n206_ = new_n207_ & new_n195_ & new_n155_ & ~x04;
  assign new_n207_ = (x81 ^ (x82 ^ x84)) ^ (x42 & x83);
  assign z35 = new_n206_ & ~x01 & x53;
  ...
  assign new_n220_ = new_n184_ & (x67 | x75) & new_n195_ & x77 & ~x78;
  ...
  assign new_n228_ = (~new_n224_ | ~x70) & (~new_n221_ | (~x18 & x52) | (~x10 & ~x52));
  ...
  assign z53 = ~x01 & (new_n234_ | (new_n224_ & ~x61 & x73));
  ...
  assign new_n239_ = ((x00 & ~x01) | (x61 & x79)) & ((x61 & x79) | x77 | x78);
  ...
  assign new_n260_ = (~x78 | ((x79 | ~x04 | x77) & (~x79 | ~x83 | x04 | ~x77))) & (~x79 | ~x83 | ~new_n184_ | (x77 ^ ~x78));
