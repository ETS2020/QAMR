...
module FAU ( 
  ...
  assign new_n223_ = new_n224_ & x11 & (x67 | x75);
  assign new_n224_ = (~x81 | x84) & (x81 | ~x84) & x79 & x77 & ~x78;
  assign new_n225_ = ~x77 & x78 & x04 & ~x79;
  assign z48 = ~x01 & (new_n227_ | (new_n224_ & x11 & x68));
  assign new_n227_ = new_n225_ & (x08 | x52) & (x16 | ~x52);
  assign z49 = ~x01 & (new_n229_ | (new_n224_ & x11 & x69));
  assign new_n229_ = new_n225_ & (x09 | x52) & (x17 | ~x52);
  assign z50 = (~x11 & x79) | (~new_n231_ & ~x01);
  assign new_n231_ = (~new_n224_ | ~x70) & (~new_n225_ | (~x10 & ~x52) | (~x18 & x52));
  assign z51 = (~x11 & x79) | (~new_n233_ & ~x01);
  assign new_n233_ = (~new_n224_ | ~x71) & (~new_n225_ | (~x11 & ~x52) | (~x19 & x52));
  assign z52 = ~x01 & (new_n235_ | (new_n224_ & x11 & x72));
  assign new_n235_ = new_n225_ & (x12 | x52) & (x20 | ~x52);
  assign z53 = (~x11 & x79) | (~new_n237_ & ~x01);
  assign new_n237_ = (~new_n224_ | ~x73) & (~new_n225_ | (~x13 & ~x52) | (~x21 & x52));
  assign z54 = new_n225_ & (x14 | x52) & ~x01 & (x22 | ~x52);
  assign z55 = new_n201_ & ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = ~new_n241_ | ((~new_n184_ | x76) & ~new_n155_ & x11 & x79);
  assign new_n241_ = ((~x11 & x79) | (x00 & ~x01)) & ((~x11 & x79) | x77 | x78);
  ...
  assign new_n245_ = (~x40 | ~x42) & x11 & x79 & x04 & x78;
  assign new_n246_ = x40 & ~x42 & ~x78 & ~x79;
  assign new_n247_ = ~x79 & (~x04 | (~x77 & x78));
  assign z59 = (~x11 & x79) | (~x01 & ((~new_n249_ & x77) | (~x04 & ~x79)));
  ...
  assign new_n253_ = x11 & (new_n254_ | (new_n155_ & new_n251_ & (~new_n181_ | ~new_n182_)));
  assign new_n254_ = (~x81 ^ ~x84) & ((~x77 & x78) | (x79 & x77 & ~x78));
  assign z61 = x79 & (~x11 | (new_n256_ & x80));
  assign new_n256_ = ~x01 & ((~x04 & x77 & x78) | (new_n184_ & (~x77 ^ ~x78)));
  assign z62 = ~x01 & (new_n259_ | (x11 & (new_n260_ | (new_n258_ & new_n155_))));
  assign new_n258_ = new_n251_ & (~new_n181_ | ~new_n182_);
  assign new_n259_ = x78 & x04 & ~x79;
  assign new_n260_ = ((~x04 & x77) | (~x77 & x78) | (x77 & ~x78)) & x79 & x81 & (x84 | (x77 & x78));
  assign z63 = new_n256_ & x82 & x11 & x79;
  assign z64 = (~x11 & x79) | (~new_n263_ & ~x01);
  assign new_n263_ = (~new_n184_ | (~x77 ^ x78) | ~x79 | ~x83) & ((x77 & (~x79 | ~x83)) | ~x78 | (x04 ? x79 : ~x77));
  assign z65 = ((~x77 & x78) | (x77 & ~x78) | (~x04 & x77)) & new_n265_ & (x81 | (x77 & x78));
  assign new_n265_ = x84 & new_n159_ & x79;
endmodule
