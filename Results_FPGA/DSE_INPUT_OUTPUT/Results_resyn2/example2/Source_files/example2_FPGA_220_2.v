...
module FAU ( 
  ...
  wire new_n154_, new_n157_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n222_, new_n224_, new_n225_, new_n227_, new_n229_, new_n232_,
  ...
  assign z36 = new_n200_ & new_n196_ & x54;
  assign z37 = new_n200_ & new_n196_ & x55;
  assign z38 = (x01 & ~x79) | (new_n200_ & new_n196_ & x56);
  assign z39 = new_n200_ & new_n196_ & x57;
  assign z40 = new_n200_ & new_n196_ & x58;
  assign z41 = new_n200_ & new_n196_ & x59;
  assign z42 = (x01 & ~x79) | (new_n200_ & new_n196_ & x60);
  assign z43 = new_n200_ & new_n196_ & x61;
  assign z44 = (x01 & ~x79) | (new_n200_ & new_n196_ & x62);
  assign z45 = new_n200_ & new_n196_ & x63;
  ...
  assign z49 = (new_n216_ & ~x01 & x69) | (~x79 & (new_n220_ | x01));
  ...
  assign z51 = ~x01 & ((new_n216_ & x71) | (new_n224_ & new_n225_));
  assign new_n224_ = new_n215_ & ~x79;
  assign new_n225_ = x52 ? x19 : x11;
  assign z52 = ~x01 & ((new_n216_ & x72) | (new_n224_ & new_n227_));
  assign new_n227_ = x52 ? x20 : x12;
  assign z53 = ~x01 & ((new_n216_ & x73) | (new_n224_ & new_n229_));
  assign new_n229_ = x52 ? x21 : x13;
  assign z54 = ~x79 & (x01 | (new_n215_ & (x14 | x52) & (x22 | ~x52)));
  assign z55 = (x01 & ~x79) | (new_n196_ & new_n232_);
  assign new_n232_ = ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = (~x01 | x79) & (~x00 | ((x01 | ~x77 | ~x78) & ((~x77 & ~x78) | (~new_n234_ & x79))));
  assign new_n234_ = ~x01 & ~x76 & (~x81 ^ x84);
  ...
  assign new_n241_ = ~new_n242_ & (~x78 | (x79 & (~new_n181_ | (new_n179_ & new_n180_))));
