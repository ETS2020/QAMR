...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62, z63, z64, z65;
  wire new_n154_, new_n182_, new_n192_;
  ...
  assign z47 = z64 & (x15 | ~x52) & (x07 | x52);
  assign z64 = ~x01 & ~x79 & ~x77 & x04 & x78;
  assign z48 = ~x01 & (x79 | (new_n182_ & (x16 | ~x52) & (x08 | x52)));
  assign new_n182_ = ~x77 & x04 & x78;
  assign z49 = z64 & (x17 | ~x52) & (x09 | x52);
  assign z50 = z64 & (x18 | ~x52) & (x10 | x52);
  assign z51 = ~x01 & (x79 | (new_n182_ & (x19 | ~x52) & (x11 | x52)));
  assign z52 = z64 & (x20 | ~x52) & (x12 | x52);
  assign z53 = z64 & (x21 | ~x52) & (x13 | x52);
  assign z54 = ~x01 & (x79 | (new_n182_ & (x22 | ~x52) & (x14 | x52)));
  assign z56 = x01 | (~x79 & (~x00 | (~x77 & ~x78)));
  assign z57 = z01 & x03 & x00 & ~x02;
  assign z58 = ~new_n192_ & ~x01;
  assign new_n192_ = ((x77 & (~x40 | x42)) | (x77 & x78) | (~x77 & ~x78)) & x04 & ~x79;
