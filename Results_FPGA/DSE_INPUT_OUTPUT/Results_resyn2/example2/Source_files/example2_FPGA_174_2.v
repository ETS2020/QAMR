// Benchmark "FAU" written by ABC on Wed Aug 12 20:27:45 2020
...
module FAU ( 
  ...
  assign z22 = (~x01 & (new_n177_ | new_n181_)) | (~x79 & (new_n178_ | x01));
  assign new_n177_ = new_n178_ & x77 & ~x42 & (~new_n179_ | ~new_n180_);
  ...
  assign new_n184_ = ~x43 & x05 & ~x01 & ~x04;
  assign z25 = (x01 & ~x79) | (new_n186_ & x05 & ~x01 & ~x04);
  assign new_n186_ = (new_n187_ ^ ~x81) & ~x42 & x79 & x77 & x78;
  assign new_n187_ = x82 ^ ~x84;
  assign z26 = (x01 & ~x79) | (new_n186_ & x44 & ~x01 & ~x04);
  assign z27 = (x01 & ~x79) | (new_n186_ & x45 & ~x01 & ~x04);
  assign z28 = (x01 & ~x79) | (new_n186_ & x46 & ~x01 & ~x04);
  ...
  assign z34 = (x01 & ~x79) | (new_n201_ & new_n199_ & x52);
  assign new_n201_ = (x42 & x83) ^ (new_n187_ ^ ~x81);
  assign z35 = (x01 & ~x79) | (new_n201_ & new_n199_ & x53);
  assign z36 = new_n201_ & new_n199_ & x54;
  ...
  assign z41 = new_n201_ & new_n199_ & x59;
  assign z42 = (x01 & ~x79) | (new_n201_ & new_n199_ & x60);
  assign z43 = (x01 & ~x79) | (new_n201_ & new_n199_ & x61);
  assign z44 = new_n201_ & new_n199_ & x62;
  assign z45 = (x01 & ~x79) | (new_n201_ & new_n199_ & x63);
  assign z46 = (x01 & ~x79) | (new_n201_ & new_n199_ & x64);
  ...
  assign z49 = (new_n217_ & ~x01 & x69) | (~x79 & (new_n221_ | x01));
  assign new_n221_ = new_n178_ & ~x77 & (x17 | ~x52) & (x09 | x52);
  assign z50 = ~x01 & (new_n223_ | (new_n217_ & x70));
  assign new_n223_ = new_n216_ & (x18 | ~x52) & (x10 | x52);
  assign z51 = ~x01 & (new_n225_ | (new_n217_ & x71));
  assign new_n225_ = new_n216_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = ~x01 & (new_n227_ | (new_n217_ & x72));
  assign new_n227_ = new_n216_ & (x20 | ~x52) & (x12 | x52);
  assign z53 = (new_n217_ & ~x01 & x73) | (~x79 & (new_n229_ | x01));
  assign new_n229_ = new_n178_ & ~x77 & (x21 | ~x52) & (x13 | x52);
  assign z54 = ~x79 & (x01 | (new_n231_ & (x14 | x52) & (x22 | ~x52)));
  assign new_n231_ = new_n178_ & ~x77;
  ...
  assign z59 = (x77 & ((~x79 & (x40 | x78)) | ((new_n241_ | x40) & new_n242_ & x78))) | (~new_n242_ & ~x79);
  assign new_n241_ = ~x42 & (~new_n179_ | ~new_n180_);
  assign new_n242_ = ~x01 & x04;
  assign z60 = (~x01 & (new_n244_ | (new_n177_ & x79))) | (~x79 & (x78 | x01 | ~x04));
  assign new_n244_ = (x81 | x84) & (~x81 | ~x84) & ((~x77 & x78) | (x79 & x77 & ~x78));
  assign z61 = (x01 & ~x79) | (new_n246_ & x80 & ~x01 & x79);
  assign new_n246_ = (~x77 ^ x78) ? (~x04 & x78) : (x81 ^ ~x84);
  assign z62 = ~x01 & (new_n248_ | (new_n178_ & (~x79 | (new_n241_ & x77))));
  assign new_n248_ = (x84 | (~x77 ^ x78)) & x79 & x81 & ((~x77 & x78) | (x77 & ~x78) | (~x04 & x78));
  assign z63 = new_n246_ & x82 & ~x01 & x79;
  assign z64 = (~x79 & (new_n231_ | x01)) | (new_n246_ & x83 & ~x01 & x79);
  assign z65 = (x01 & ~x79) | (new_n252_ & (x81 | (~x77 ^ x78)));
  assign new_n252_ = ((~x77 & x78) | (x77 & ~x78) | (~x04 & x78)) & x84 & ~x01 & x79;
endmodule
