...
module FAU ( 
  ...
  assign z22 = ~x01 & (new_n180_ | (new_n181_ & (~x79 | (new_n177_ & x77))));
  ...
  assign z24 = (x01 & ~x79) | (new_n184_ & (~x79 | (~x01 & x77 & x78)));
  assign new_n184_ = ~x43 & ~x04 & x05;
  assign z25 = (x01 & ~x79) | (new_n186_ & ~x04 & x05);
  assign new_n186_ = new_n187_ & ~x01 & ~x42;
  assign new_n187_ = x79 & x77 & x78 & (x81 ^ (x82 ^ x84));
  assign z26 = (x01 & ~x79) | (new_n187_ & ~x01 & ~x04 & ~x42 & x44);
  assign z27 = new_n186_ & ~x04 & x45;
  assign z28 = (x01 & ~x79) | (new_n186_ & ~x04 & x46);
  assign z29 = (x01 & ~x79) | (new_n186_ & ~x04 & x47);
  assign z30 = new_n186_ & ~x04 & x48;
  assign z31 = (x01 & ~x79) | (new_n186_ & ~x04 & x49);
  assign z32 = new_n186_ & ~x04 & x50;
  assign z33 = ~new_n196_ & ~new_n198_ & new_n199_;
  ...
  assign new_n199_ = x79 & x77 & x78 & ~x01 & ~x04;
  assign z34 = new_n201_ & new_n199_ & x52;
  assign new_n201_ = (new_n197_ ^ ~x81) ^ (x42 & x83);
  assign z35 = new_n201_ & new_n199_ & x53;
  ...
  assign z44 = (x01 & ~x79) | (new_n201_ & new_n199_ & x62);
  ...
  assign new_n219_ = new_n181_ & ~x77 & (x16 | ~x52) & (x08 | x52);
  ...
  assign new_n229_ = new_n181_ & ~x77 & (x21 | ~x52) & (x13 | x52);
  assign z54 = new_n231_ & ~x79 & ~x77 & x78;
  assign new_n231_ = (x22 | ~x52) & new_n232_ & (x14 | x52);
  assign new_n232_ = ~x01 & x04;
  assign z55 = (x01 & ~x79) | (new_n199_ & new_n234_);
  assign new_n234_ = ~x81 & x83 & ~x80 & ~x82 & x84;
  assign z56 = (~x01 | x79) & (~x00 | ((x01 | ~x77 | ~x78) & ((~x77 & ~x78) | (~new_n236_ & x79))));
  assign new_n236_ = (~x81 ^ x84) & ~x01 & ~x76;
  assign z57 = (x01 & ~x79) | (x00 & ~x01 & ~x02 & x03);
  assign z58 = ~x01 & (new_n239_ | (~x79 & (~x04 | (~x77 & x78))));
  assign new_n239_ = x77 & (new_n241_ | (new_n240_ & (x42 | (new_n178_ & new_n179_))));
  assign new_n240_ = (~x40 | ~x42) & x79 & x04 & x78;
  assign new_n241_ = x40 & ~x42 & ~x78 & ~x79;
  assign z59 = (~new_n232_ | (x77 & (x40 | x78))) & (~x79 | ((new_n177_ | x40) & new_n232_ & x78));
  assign z60 = ~x01 & (~new_n244_ | (x79 & new_n181_ & new_n177_ & x77));
  assign new_n244_ = (x79 | (x04 & ~x78)) & ((~x81 & ~x84) | (x81 & x84) | ((x77 | ~x78) & (~x79 | ~x77 | x78)));
  assign z61 = new_n246_ & x80 & ~x01 & x79;
  assign new_n246_ = (~x77 ^ x78) ? (~x04 & x78) : (x81 ^ ~x84);
  assign z62 = (~x79 & (new_n181_ | x01)) | (~x01 & (new_n248_ | (new_n181_ & new_n177_ & x77)));
  assign new_n248_ = (x84 | (~x77 ^ x78)) & x79 & x81 & ((~x77 & x78) | (x77 & ~x78) | (~x04 & x78));
  assign z63 = (x01 & ~x79) | (new_n246_ & x82 & ~x01 & x79);
  assign z64 = ~x01 & (new_n216_ | (new_n246_ & x79 & x83));
