...
module FAU ( 
  ...
  assign z48 = z64 & (x16 | ~x52) & (x08 | x52);
  assign z49 = ~x01 & (x79 | (new_n183_ & (x17 | ~x52) & (x09 | x52)));
  assign new_n183_ = ~x77 & x04 & x78;
  assign z50 = ~x01 & (x79 | (new_n183_ & (x18 | ~x52) & (x10 | x52)));
  assign z51 = z64 & (x19 | ~x52) & (x11 | x52);
  assign z52 = ~x01 & (x79 | (new_n183_ & (x20 | ~x52) & (x12 | x52)));
  assign z53 = z64 & (x21 | ~x52) & (x13 | x52);
  assign z54 = ~x01 & (x79 | (new_n183_ & (x22 | ~x52) & (x14 | x52)));
