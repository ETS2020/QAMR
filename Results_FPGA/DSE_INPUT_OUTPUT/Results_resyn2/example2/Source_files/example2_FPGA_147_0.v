...
module FAU ( 
  ...
  wire new_n156_, new_n158_, new_n178_, new_n179_, new_n180_, new_n183_,
    ...
    new_n202_, new_n214_, new_n223_, new_n226_, new_n230_;
  ...
  assign new_n195_ = ((x81 ^ ~x83) | ~x05 | ~x42) & new_n186_ & (~x81 | x42 | ~x51);
  assign new_n196_ = ((x81 & ~x83) | (~x81 & x83) | ~x05 | ~x42) & ~new_n186_ & (x81 | x42 | ~x51);
  ...
  assign z36 = ~x01 & (~x79 | (new_n202_ & ~x04 & x54));
  assign new_n202_ = new_n199_ & x77 & x78;
  assign z37 = ~x01 & (~x79 | (new_n202_ & ~x04 & x55));
  assign z38 = ~x01 & (~x79 | (new_n202_ & ~x04 & x56));
  assign z39 = ~x01 & (~x79 | (new_n202_ & ~x04 & x57));
  assign z40 = new_n199_ & new_n183_ & x58;
  assign z41 = ~x01 & (~x79 | (new_n202_ & ~x04 & x59));
  assign z42 = ~x01 & (~x79 | (new_n202_ & ~x04 & x60));
  assign z43 = ~x01 & (~x79 | (new_n202_ & ~x04 & x61));
  ...
  assign z56 = new_n223_ | ~z04 | ~x00;
  assign new_n223_ = (~x77 | ~x78) & (x76 | (~x77 & ~x78) | (x81 & ~x84) | (~x81 & x84));
  ...
  assign z60 = z04 & (new_n178_ | (new_n156_ & (~x81 ^ ~x84)));
  assign z61 = ~x01 & (~x79 | (new_n230_ & x80));
  assign new_n230_ = new_n156_ ? (x81 ^ ~x84) : new_n197_;
  assign z62 = z04 & (new_n178_ | ((~new_n156_ | x84) & x81 & (new_n156_ | new_n197_)));
  assign z63 = new_n230_ & z04 & x82;
  assign z64 = ~x01 & (~x79 | (new_n230_ & x83));
  assign z65 = ~x01 & (~x79 | ((~new_n156_ | x81) & (new_n156_ | new_n197_) & x84));
  assign z54 = 1'b0;
endmodule
