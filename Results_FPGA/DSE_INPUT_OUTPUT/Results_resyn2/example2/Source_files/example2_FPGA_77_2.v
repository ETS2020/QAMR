...
module FAU ( 
  ...
  assign z22 = ~x01 & (new_n177_ | (new_n157_ & ~x41 & (x81 ^ ~x84)));
  ...
  assign z58 = (~new_n235_ & x77) | (~x79 & (~new_n238_ | (~x77 & x78)));
  assign new_n235_ = ~new_n237_ & (~new_n236_ | ~x79 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n236_ = (~x40 | ~x42) & x78 & ~x01 & x04;
  assign new_n237_ = ~x78 & ~x79 & x40 & ~x42;
  assign new_n238_ = ~x01 & x04;
  assign z59 = (x40 | ((new_n240_ | ~x79) & (~new_n238_ | x78))) & (~new_n238_ | x77) & (~x79 | (new_n238_ & x78));
  assign new_n240_ = ~x42 & (~new_n178_ | ~new_n179_);
  assign z60 = new_n242_ | (~x79 & (~new_n238_ | x78));
  assign new_n242_ = ~x01 & (new_n243_ | (new_n244_ & ~x42 & (~new_n178_ | ~new_n179_)));
