...
module FAU ( 
  ...
  assign z16 = (x34 | x40) & (~x34 | ~x79) & (~x40 | x49);
  ...
  assign new_n200_ = new_n155_ & x79 & ~x34 & ~x01 & ~x04;
  ...
  assign new_n224_ = (~new_n220_ | ~x68) & (~new_n222_ | (~x08 & ~x52) | (~x16 & x52));
  ...
  assign new_n230_ = (~new_n220_ | ~x71) & (~new_n222_ | (~x11 & ~x52) | (~x19 & x52));
  assign z52 = (x34 & x79) | (~new_n232_ & ~x01);
  assign new_n232_ = (~new_n220_ | ~x72) & (~new_n222_ | (~x12 & ~x52) | (~x20 & x52));
  ...
  assign z59 = (x34 & x79) | (~x01 & ((~x04 & ~x79) | (~new_n246_ & x77)));
