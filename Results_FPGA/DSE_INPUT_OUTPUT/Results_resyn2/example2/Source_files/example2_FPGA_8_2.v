...
module FAU ( 
  ...
  assign z22 = (~x01 & (new_n181_ | (new_n178_ & new_n182_ & x77))) | (~x79 & (new_n182_ | x01));
  ...
  assign z25 = (x01 & ~x79) | (new_n186_ & ~x01 & ~x04 & x05);
  ...
  assign new_n229_ = new_n182_ & ~x77 & (x21 | ~x52) & (x13 | x52);
  assign z54 = ~x79 & (x01 | (new_n231_ & (x14 | x52) & (x22 | ~x52)));
  assign new_n231_ = new_n182_ & ~x77;
  assign z55 = (new_n199_ & new_n233_) | (x01 & ~x79);
  ...
  assign z60 = new_n244_ | (~x79 & (~new_n242_ | x78));
  assign new_n244_ = ~x01 & (new_n246_ | (new_n245_ & ~x42 & (~new_n179_ | ~new_n180_)));
  ...
  assign z62 = ~x01 & (new_n250_ | (new_n182_ & (~x79 | (new_n178_ & x77))));
  assign new_n250_ = (x77 | x78) & (~x77 | ~x04 | ~x78) & x79 & x81 & (x84 | (x77 & x78));
  assign z63 = (x01 & ~x79) | (~new_n248_ & x82 & ~x01 & x79);
  assign z64 = ~x01 & ((new_n231_ & ~x79) | (~new_n248_ & x79 & x83));
