...
module FAU ( 
  ...
  assign new_n200_ = new_n155_ & x79 & ~x08 & ~x01 & ~x04;
  ...
  assign new_n222_ = ~x79 & x78 & x04 & ~x77;
  assign z48 = (x08 & x79) | (~x01 & (new_n224_ | (new_n220_ & x68)));
  assign new_n224_ = (~x52 | (x16 & ~x79)) & new_n225_ & (x08 | x52);
  assign new_n225_ = x78 & x04 & ~x77;
  assign z49 = (~new_n227_ & ~x01) | (x08 & x79);
  assign new_n227_ = (~new_n220_ | ~x69) & (~new_n222_ | (~x17 & x52) | (~x09 & ~x52));
  assign z50 = (~new_n229_ & ~x01) | (x08 & x79);
  assign new_n229_ = (~new_n220_ | ~x70) & (~new_n222_ | (~x18 & x52) | (~x10 & ~x52));
  assign z51 = (~new_n231_ & ~x01) | (x08 & x79);
  assign new_n231_ = (~new_n220_ | ~x71) & (~new_n222_ | (~x19 & x52) | (~x11 & ~x52));
  assign z52 = ~x01 & (new_n233_ | (new_n220_ & ~x08 & x72));
  assign new_n233_ = new_n222_ & (x12 | x52) & (x20 | ~x52);
  assign z53 = ~x01 & (new_n235_ | (new_n220_ & ~x08 & x73));
  ...
  assign new_n240_ = (new_n155_ | (~x81 ^ x84)) & ~x08 & (new_n155_ | ~x76);
  assign z57 = (~x08 | ~x79) & x00 & ~x01 & ~x02 & x03;
  assign z58 = (x08 & x79) | (~x01 & (new_n243_ | (~new_n246_ & ~x79)));
  ...
  assign z59 = (x08 & x79) | (~x01 & ((~new_n248_ & x77) | (~x04 & ~x79)));
  assign new_n248_ = ~new_n249_ & (~x78 | (x79 & (~new_n182_ | (new_n180_ & new_n181_))));
  assign new_n249_ = x40 & (~x79 | (x04 & x78));
  assign z60 = new_n251_ | (x08 & x79);
  assign new_n251_ = new_n253_ & (~new_n252_ | (new_n155_ & new_n182_ & (~new_n180_ | ~new_n181_)));
  assign new_n252_ = x79 & ((~x77 & ~x78) | (x77 & x78) | (~x81 ^ x84));
  assign new_n253_ = ~x01 & (x79 | ~x04 | x78);
  assign z61 = x79 & (x08 | (new_n255_ & x80));
  assign new_n255_ = new_n256_ & ~x01;
  assign new_n256_ = ((x77 & x78) | (~x81 ^ x84)) & (x77 | x78) & (~x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n258_ | (x04 & x78 & ~x79));
  assign new_n258_ = ~x08 & (new_n259_ | (new_n155_ & new_n182_ & (~new_n180_ | ~new_n181_)));
  assign new_n259_ = (x77 | x78) & (~x04 | ~x77 | ~x78) & x79 & x81 & (x84 | (x77 & x78));
  assign z63 = new_n255_ & x82 & ~x08 & x79;
  assign z64 = ~x01 & ((new_n225_ & ~x79) | (new_n256_ & x83 & ~x08 & x79));
  assign z65 = x79 & (new_n263_ | x08);
