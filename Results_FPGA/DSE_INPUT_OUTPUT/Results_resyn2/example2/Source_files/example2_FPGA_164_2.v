...
module FAU ( 
  ...
  assign z49 = ~x01 & ((new_n217_ & x69) | (new_n221_ & new_n222_));
  assign new_n221_ = new_n216_ & ~x79;
  ...
  assign z52 = ~x01 & ((new_n217_ & x72) | (new_n221_ & new_n228_));
  assign new_n228_ = x52 ? x20 : x12;
  assign z53 = (new_n217_ & ~x01 & x73) | (~x79 & (new_n230_ | x01));
  ...
  assign new_n244_ = ~new_n245_ & (~new_n182_ | ~x77 | x42 | (new_n179_ & new_n180_));
  ...
  assign z62 = (~x79 & (new_n182_ | x01)) | (~x01 & (new_n249_ | (new_n182_ & new_n178_ & x77)));
  assign new_n249_ = (x84 | (x77 ^ ~x78)) & x79 & x81 & ((x77 & ~x78) | (~x77 & x78) | (~x04 & x78));
  assign z63 = new_n247_ & x82 & ~x01 & x79;
  assign z64 = ~x01 & ((new_n216_ & ~x79) | (new_n247_ & x79 & x83));
  assign z65 = (x01 & ~x79) | (new_n253_ & (x81 | (x77 ^ ~x78)));
  assign new_n253_ = ((~x04 & x78) | (x77 & ~x78) | (~x77 & x78)) & x84 & ~x01 & x79;
endmodule
