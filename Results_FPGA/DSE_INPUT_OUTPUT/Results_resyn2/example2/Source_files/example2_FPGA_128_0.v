...
module FAU ( 
  ...
  assign z23 = ((x13 | x79) & (~x00 | x01)) | (~x04 & x05 & x13 & ~x79);
  ...
  assign z32 = new_n156_ | (new_n188_ & x50);
  assign z33 = new_n156_ | (~new_n199_ & new_n190_);
  ...
  assign z35 = new_n156_ | (new_n201_ & new_n190_ & x53);
  ...
  assign z46 = new_n156_ | (new_n201_ & new_n190_ & x64);
  assign z47 = ~x01 & (new_n215_ | (new_n217_ & (x67 | x75)));
  assign new_n215_ = new_n216_ & (x15 | ~x52) & (x07 | x52);
  assign new_n216_ = x13 & ~x79 & x04 & ~x77 & x78;
  assign new_n217_ = x77 & ~x78 & x79 & (x81 ^ ~x84);
  assign z48 = new_n156_ | (~new_n219_ & ~x01);
  assign new_n219_ = (~new_n217_ | ~x68) & (~new_n220_ | (~x16 & x52) | (~x08 & ~x52));
  assign new_n220_ = ~x79 & x04 & ~x77 & x78;
  assign z49 = new_n156_ | (~new_n222_ & ~x01);
  assign new_n222_ = (~new_n217_ | ~x69) & (~new_n220_ | (~x17 & x52) | (~x09 & ~x52));
  assign z50 = new_n156_ | (~new_n224_ & ~x01);
  assign new_n224_ = (~new_n217_ | ~x70) & (~new_n220_ | (~x18 & x52) | (~x10 & ~x52));
  assign z51 = new_n156_ | (~new_n226_ & ~x01);
  assign new_n226_ = (~new_n217_ | ~x71) & (~new_n220_ | (~x19 & x52) | (~x11 & ~x52));
  assign z52 = new_n156_ | (~new_n228_ & ~x01);
  assign new_n228_ = (~new_n217_ | ~x72) & (~new_n220_ | (~x20 & x52) | (~x12 & ~x52));
  assign z53 = ~x01 & ((new_n217_ & x73) | (new_n216_ & (x21 | ~x52)));
  ...
  assign new_n233_ = (new_n156_ | (x00 & ~x01)) & (new_n156_ | x77 | x78);
  ...
  assign new_n238_ = x13 & ~x79 & ~x78 & x40 & ~x42;
  assign new_n239_ = x13 & ~x79 & (~x04 | (~x77 & x78));
  assign z59 = (~x13 & ~x79) | (~x01 & ((~x04 & ~x79) | (~new_n241_ & x77)));
  assign new_n241_ = ~new_n242_ & (~x78 | (x79 & (~new_n243_ | (new_n180_ & new_n181_))));
  assign new_n242_ = x40 & (~x79 | (x04 & x78));
  assign new_n243_ = x04 & ~x42;
  assign z60 = ~x01 & ((~new_n245_ & x79) | (x13 & ~x79 & (~x04 | x78)));
  ...
  assign z62 = ~x01 & ((new_n179_ & x13 & ~x79) | (~new_n250_ & x79));
  ...
  assign z63 = (~x13 & ~x79) | (new_n248_ & x82 & ~x01 & x79);
