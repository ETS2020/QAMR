...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62, z63, z64, z65;
  wire new_n179_, new_n181_, new_n184_, new_n192_;
  ...
  assign new_n179_ = ~x01 & ~x79 & x04 & ~x77 & x78;
  assign z48 = ~x01 & (new_n181_ | x79);
  assign new_n181_ = x04 & ~x77 & x78 & (x52 ? x16 : x08);
  assign z49 = new_n179_ & (x17 | ~x52) & (x09 | x52);
  assign z50 = ~x01 & (x79 | (new_n184_ & (x18 | ~x52) & (x10 | x52)));
  assign new_n184_ = ~x77 & x04 & x78;
  assign z51 = ~x01 & (x79 | (new_n184_ & (x19 | ~x52) & (x11 | x52)));
  assign z52 = new_n179_ & (x20 | ~x52) & (x12 | x52);
  assign z53 = ~x01 & (x79 | (new_n184_ & (x21 | ~x52) & (x13 | x52)));
  assign z54 = ~x01 & (x79 | (new_n184_ & (x22 | ~x52) & (x14 | x52)));
  assign z56 = x01 | (~x79 & (~x00 | (~x77 & ~x78)));
  assign z57 = ~x02 & x03 & z01 & x00;
