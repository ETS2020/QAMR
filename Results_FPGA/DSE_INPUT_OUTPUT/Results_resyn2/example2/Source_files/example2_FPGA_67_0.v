...
module FAU ( 
  ...
  assign z05 = (~x40 | x65) & (x23 | x40) & (x11 | x79);
  assign z06 = (x40 & x64) | (~x11 & ~x79) | (x24 & ~x40);
  assign z07 = (x40 & x63) | (~x11 & ~x79) | (x25 & ~x40);
  assign z08 = (~x40 | x62) & (x26 | x40) & (x11 | x79);
  assign z09 = (x40 & x61) | (~x11 & ~x79) | (x27 & ~x40);
  assign z10 = (~x40 | x60) & (x28 | x40) & (x11 | x79);
  assign z11 = (x40 & x59) | (~x11 & ~x79) | (x29 & ~x40);
  assign z12 = (~x40 | x58) & (x30 | x40) & (x11 | x79);
  assign z13 = (x40 & x57) | (~x11 & ~x79) | (x31 & ~x40);
  assign z14 = (~x40 | x51) & (x32 | x40) & (x11 | x79);
  assign z15 = (~x40 | x50) & (x33 | x40) & (x11 | x79);
  assign z16 = (~x40 | x49) & (x34 | x40) & (x11 | x79);
  assign z17 = (~x40 | x48) & (x35 | x40) & (x11 | x79);
  assign z18 = (~x40 | x47) & (x36 | x40) & (x11 | x79);
  assign z19 = (~x40 | x46) & (x37 | x40) & (x11 | x79);
  assign z20 = (x40 & x45) | (~x11 & ~x79) | (x38 & ~x40);
  assign z21 = (~x40 | x44) & (x39 | x40) & (x11 | x79);
  ...
  assign new_n225_ = new_n179_ & ~x77 & ~x79 & (x19 | ~x52);
  ...
  assign z62 = ~x01 & ((new_n179_ & x11 & ~x79) | (~new_n250_ & x79));
  ...
  assign z64 = (~new_n254_ & ~x01) | (~x11 & ~x79);
