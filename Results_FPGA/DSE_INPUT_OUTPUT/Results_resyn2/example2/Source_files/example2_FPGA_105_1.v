...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62, z63, z64, z65;
  wire new_n178_, new_n189_;
  assign z00 = (z04 & x40) | ((~x40 | x52) & ~z26 & (x06 | x40));
  ...
  assign z47 = ~x01 & (x79 | (new_n178_ & (x15 | ~x52) & (x07 | x52)));
  assign new_n178_ = ~x77 & x04 & x78;
  assign z48 = ~x01 & (x79 | (new_n178_ & (x16 | ~x52) & (x08 | x52)));
  assign z49 = ~x01 & (x79 | (new_n178_ & (x17 | ~x52) & (x09 | x52)));
  assign z50 = ~x01 & (x79 | (new_n178_ & (x18 | ~x52) & (x10 | x52)));
  assign z51 = ~x01 & (x79 | (new_n178_ & (x19 | ~x52) & (x11 | x52)));
  assign z52 = (x20 | ~x52) & (x12 | x52) & new_n178_ & ~x01 & ~x79;
  assign z53 = ~x01 & (x79 | (new_n178_ & (x21 | ~x52) & (x13 | x52)));
  assign z54 = ~x01 & (x79 | (new_n178_ & (x22 | ~x52) & (x14 | x52)));
  assign z56 = (~x77 & ~x78) | x79 | ~x00 | x01;
  assign z57 = ~x02 & x03 & ~x79 & x00 & ~x01;
  assign z58 = ~new_n189_ & ~x01 & ~x79;
  assign new_n189_ = x04 & ((x77 & (~x40 | x42)) | (x77 & x78) | (~x77 & ~x78));
  assign z59 = ~x01 & ~x79 & (~x04 | (x77 & (x40 | x78)));
  assign z60 = ~x01 & (x79 | ~x04 | x78);
  assign z64 = new_n178_ & ~x01 & ~x79;
  assign z02 = 1'b0;
  assign z25 = 1'b0;
  assign z27 = 1'b0;
  assign z30 = 1'b0;
