...
module FAU ( 
  ...
  wire new_n157_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    ...
    new_n199_, new_n201_, new_n203_, new_n216_, new_n224_, new_n228_,
    new_n233_, new_n235_;
  ...
  assign z22 = z04 & (new_n177_ | (~new_n157_ & ~new_n180_ & ~x41));
  ...
  assign new_n189_ = z04 & (~new_n186_ | x81) & x77 & x78 & (new_n186_ | ~x81);
  ...
  assign new_n196_ = ((new_n197_ & (~x81 | x83) & (x81 | ~x83)) | new_n186_ | (new_n198_ & ~x81)) & new_n199_ & ((new_n197_ & (~x81 ^ ~x83)) | ~new_n186_ | (new_n198_ & x81));
  ...
  assign new_n203_ = ~new_n201_ & x79 & x77 & x78;
  ...
  assign z60 = z04 & (new_n177_ | (new_n180_ & (x77 | x78) & (~x77 | ~x78)));
  assign z61 = (~new_n180_ | (~x77 & ~x78) | (x77 & x78)) & ((~x04 & x78) | (~x77 ^ ~x78)) & z04 & x80;
  assign z62 = z04 & (new_n177_ | new_n233_);
  assign new_n233_ = (x84 | (~x77 & ~x78) | (x77 & x78)) & x81 & ((~x77 ^ ~x78) | (~x04 & x78));
  assign z63 = ~x01 & (new_n235_ | ~x79);
  assign new_n235_ = x82 & (~new_n180_ | (x77 & x78) | (~x77 & ~x78)) & ((~x04 & x78) | (x77 ^ x78));
  assign z64 = (~new_n180_ | (~x77 & ~x78) | (x77 & x78)) & ((~x04 & x78) | (~x77 ^ ~x78)) & z04 & x83;
