...
module FAU ( 
  ...
  assign z22 = (x79 & (new_n177_ | x01)) | (~x01 & new_n182_ & (~x79 | (new_n179_ & x77)));
  ...
  assign z26 = x79 & (x01 | (x44 & new_n186_ & ~x04 & ~x42));
  assign z27 = x79 & (x01 | (x45 & new_n186_ & ~x04 & ~x42));
  assign z28 = new_n191_ & x46 & ~x04 & ~x42;
  assign new_n191_ = ~x01 & x79 & (~new_n187_ | x81) & new_n154_ & (new_n187_ | ~x81);
  assign z29 = new_n191_ & x47 & ~x04 & ~x42;
  assign z30 = new_n191_ & x48 & ~x04 & ~x42;
  assign z31 = new_n191_ & x49 & ~x04 & ~x42;
  assign z32 = x79 & (x01 | (x50 & new_n186_ & ~x04 & ~x42));
  ...
  assign new_n201_ = x79 & (~new_n187_ | (x81 & (~x42 | ~x83)) | (~x81 & x42 & x83)) & new_n154_ & (new_n187_ | (x81 ^ (~x42 | ~x83)));
  assign z35 = x79 & (x01 | (new_n203_ & x53));
  assign new_n203_ = ~x04 & (~new_n187_ | (x81 & (~x42 | ~x83)) | (~x81 & x42 & x83)) & new_n154_ & (new_n187_ | (x81 ^ (~x42 | ~x83)));
  ...
  assign z51 = (~new_n226_ & x79) | (new_n220_ & (x19 | ~x52) & (x11 | x52));
  ...
  assign new_n234_ = new_n178_ & ~x76;
  ...
  assign z59 = (x77 & (new_n241_ | new_n242_)) | (x79 ? x01 : (~x01 & ~x04));
  assign new_n241_ = x40 & (x79 ? new_n182_ : ~x01);
  assign new_n242_ = new_n243_ & (~x79 | (x04 & x79 & ~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n243_ = ~x01 & x78;
  assign z60 = ~x01 & (new_n245_ | (new_n154_ & new_n179_ & x04 & x79));
  assign new_n245_ = (x78 | (x79 ? x77 : ~x04)) & (~x79 | (~new_n178_ & (~x77 | ~x78)));
  ...
  assign z64 = (new_n217_ & ~x01) | (x79 & (x01 | (new_n247_ & x83)));
