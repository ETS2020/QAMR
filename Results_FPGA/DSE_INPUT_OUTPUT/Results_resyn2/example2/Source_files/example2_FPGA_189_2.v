...
module FAU ( 
  ...
  assign z54 = new_n231_ & ~x79 & ~x01 & x04;
  assign new_n231_ = (x22 | ~x52) & (x14 | x52) & ~x77 & x78;
  ...
  assign new_n237_ = x77 & (new_n239_ | (new_n238_ & (x42 | (new_n178_ & new_n179_))));
  assign new_n238_ = (~x40 | ~x42) & x79 & x04 & x78;
  assign new_n239_ = ~x78 & ~x79 & x40 & ~x42;
  assign z59 = new_n241_ & (~x79 | (new_n181_ & (new_n177_ | x40)));
  assign new_n241_ = ~x01 & (~x04 | (x77 & (x40 | x78)));
  assign z60 = ~x01 & (~new_n243_ | (x79 & new_n181_ & new_n177_ & x77));
  ...
  assign z62 = (~x79 & (new_n181_ | x01)) | (~x01 & (new_n247_ | (new_n181_ & new_n177_ & x77)));
