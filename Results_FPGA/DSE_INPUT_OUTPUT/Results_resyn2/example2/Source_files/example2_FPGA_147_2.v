...
module FAU ( 
  ...
  wire new_n154_, new_n157_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n242_, new_n245_, new_n247_, new_n249_, new_n253_;
  ...
  assign z24 = x05 & ~x01 & ~x04 & ~x43 & (new_n154_ | ~x79);
  ...
  assign z47 = (~new_n182_ & new_n217_) | (~x79 & (new_n215_ | x01));
  ...
  assign z50 = (~x79 & (new_n224_ | x01)) | (new_n220_ & ~x01 & x70);
  ...
  assign z52 = ~x01 & (new_n228_ | (new_n220_ & x72));
  assign new_n228_ = new_n216_ & ~x79 & (x20 | ~x52) & (x12 | x52);
  assign z53 = (~x79 & (new_n230_ | x01)) | (new_n220_ & ~x01 & x73);
  ...
  assign z58 = new_n241_ | (x77 & (new_n242_ | (~new_n239_ & new_n240_)));
  ...
  assign z59 = (~x79 | (new_n233_ & (new_n239_ | x40))) & (~new_n233_ | x77) & (x78 | (~x79 & (~new_n233_ | x40)));
  assign z60 = ~x01 & (~new_n245_ | (new_n239_ & x04 & new_n154_ & x79));
  assign new_n245_ = (x79 | (x04 & ~x78)) & (~new_n182_ | ((x77 | ~x78) & (~x79 | ~x77 | x78)));
