...
module FAU ( 
  ...
  wire new_n154_, new_n157_, new_n158_, new_n179_, new_n180_, new_n181_,
    ...
    new_n242_, new_n245_, new_n247_, new_n249_;
  ...
  assign z22 = ~x01 & (new_n181_ | (new_n182_ & (~x79 | (new_n179_ & x77))));
  assign new_n179_ = ~x42 & (~new_n180_ | ~x84 | ~x80 | ~x82);
  ...
  assign new_n215_ = new_n216_ & ~x79 & (x15 | ~x52) & (x07 | x52);
  ...
  assign z50 = ~x01 & ((new_n217_ & x70) | (new_n223_ & new_n224_));
  assign new_n223_ = new_n216_ & ~x79;
  assign new_n224_ = x52 ? x18 : x10;
  assign z51 = (new_n217_ & ~x01 & x71) | (~x79 & (new_n226_ | x01));
  assign new_n226_ = new_n216_ & (x19 | ~x52) & (x11 | x52);
  assign z52 = ~x01 & ((new_n217_ & x72) | (new_n223_ & new_n228_));
  assign new_n228_ = x52 ? x20 : x12;
  assign z53 = ~x01 & ((new_n217_ & x73) | (new_n223_ & new_n230_));
  assign new_n230_ = x52 ? x21 : x13;
  assign z54 = new_n232_ & ~x79 & ~x77 & x78;
  assign new_n232_ = (x22 | ~x52) & new_n233_ & (x14 | x52);
  assign new_n233_ = ~x01 & x04;
  assign z55 = (x01 & ~x79) | (new_n199_ & new_n235_);
  ...
  assign z58 = new_n241_ | (x77 & (new_n242_ | (~new_n179_ & new_n240_)));
  assign new_n240_ = (~x40 | ~x42) & new_n233_ & x78 & x79;
  assign new_n241_ = ~x79 & (~new_n233_ | (~x77 & x78));
  assign new_n242_ = x40 & ~x42 & ~x78 & ~x79;
  assign z59 = (~x79 | (new_n233_ & (new_n179_ | x40))) & (~new_n233_ | x77) & (x78 | (~x79 & (~new_n233_ | x40)));
  assign z60 = ~x01 & (~new_n245_ | (new_n179_ & x04 & new_n154_ & x79));
  assign new_n245_ = (x79 | (x04 & ~x78)) & ((~x81 & ~x84) | (x81 & x84) | ((x77 | ~x78) & (~x79 | ~x77 | x78)));
  assign z61 = new_n247_ & x80;
  assign new_n247_ = new_n158_ & ((~x04 & x77 & x78) | ((x81 ^ ~x84) & (~x77 ^ ~x78)));
  assign z62 = ~x01 & (new_n249_ | (new_n182_ & (~x79 | (new_n179_ & x77))));
  assign new_n249_ = (x77 | x78) & (~x77 | ~x04 | ~x78) & x79 & x81 & (x84 | (x77 & x78));
  assign z63 = (x01 & ~x79) | (new_n247_ & x82);
  assign z64 = (new_n247_ & x83) | (~x79 & (new_n216_ | x01));
