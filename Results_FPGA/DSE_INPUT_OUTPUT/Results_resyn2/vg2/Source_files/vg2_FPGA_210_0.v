...
module FAU ( 
  ...
  assign new_n53_ = new_n54_ & ((new_n50_ & new_n55_) | (x19 & new_n38_ & new_n49_));
  ...
  assign z4 = (~new_n36_ & ~new_n61_) | (~new_n40_ & ~new_n63_ & (new_n64_ | ~x08));
  assign new_n61_ = (new_n62_ | (~x04 & ~x20)) & (~x04 | x16 | x22 | x23);
  assign new_n62_ = ~x08 & (x16 | (~x09 & (~x17 | x22)));
  assign new_n63_ = ~x04 & ~x20;
