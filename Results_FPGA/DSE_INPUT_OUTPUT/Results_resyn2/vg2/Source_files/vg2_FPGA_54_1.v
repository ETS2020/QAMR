...
module FAU ( 
  ...
  assign new_n64_ = new_n65_ & x06 & x01 & x03;
  assign new_n65_ = x20 & x11 & x14;
  assign z3 = (~new_n67_ & ~x24) | (~new_n68_ & x24 & (x05 | x13)) | (~new_n70_ & ~x05 & ~x13);
  assign new_n67_ = (~new_n49_ | ~new_n38_ | x08) & (~new_n64_ | new_n44_ | ~x08);
  assign new_n68_ = (~new_n52_ | x08 | x01 | x03) & (~new_n69_ | ~x08 | ~x06 | ~x01 | ~x03);
  assign new_n69_ = new_n65_ & x18;
  assign new_n70_ = ~new_n71_ & (~new_n60_ | ~new_n38_ | x11 | x14);
  assign new_n71_ = x08 & x06 & x01 & x03 & new_n65_ & x15;
  assign z4 = (~new_n63_ & (new_n73_ | ~x08)) | new_n61_ | (~new_n36_ & (new_n74_ | x08));
  assign new_n73_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n74_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n61_;
  assign z6 = ~new_n77_ | (~new_n63_ & x11 & (~x06 | (x14 & ~x20)));
  assign new_n77_ = (new_n78_ | x03) & (x06 | ~x20) & (new_n36_ | (~x03 & (~x06 | x11)));
  assign new_n78_ = (~new_n45_ | x24) & (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (x05 | (x13 ? (~x18 | ~x24) : ~x15));
