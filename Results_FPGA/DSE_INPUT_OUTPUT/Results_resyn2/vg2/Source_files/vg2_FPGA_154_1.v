...
module FAU ( 
  ...
  assign new_n47_ = new_n48_ & new_n38_ & ~x16;
  assign new_n48_ = ~x22 & ~x23 & ~x11 & ~x12;
  assign new_n49_ = new_n50_ & ~x17 & ~x08 & ~x09;
  ...
  assign new_n57_ = new_n48_ & new_n50_ & new_n58_ & x19 & ~x16 & ~x17;
  assign new_n58_ = ~x08 & ~x09 & ~x06 & ~x14;
  ...
  assign new_n64_ = ~x24 & ((~new_n44_ & new_n65_) | (~new_n46_ & new_n66_));
  assign new_n65_ = new_n62_ & x06 & x08;
  assign new_n66_ = new_n38_ & ~x01 & ~x03 & ~x20 & ~x08 & ~x11;
  assign new_n67_ = new_n52_ & ((new_n66_ & x07) | (new_n65_ & x18));
  assign new_n68_ = ~x05 & ~x13 & ((new_n65_ & x15) | (new_n66_ & x19));
  ...
  assign z6 = ~new_n74_ | (~new_n36_ & (x03 | (x06 & ~x11)));
  assign new_n74_ = (x11 | ~x20) & (new_n61_ | (x03 & (~x11 | (x06 & (~x14 | x20)))));
