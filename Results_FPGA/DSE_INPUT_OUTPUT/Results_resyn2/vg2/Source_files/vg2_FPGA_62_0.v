...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n63_, new_n64_;
  assign z0 = ~x20 & (~x04 | (~new_n36_ & new_n38_ & ~x06));
  ...
  assign z2 = (~x04 & ~x20) | (~new_n40_ & new_n46_ & x14 & x20);
  assign new_n46_ = x06 & x11 & x01 & x03;
  assign z3 = (~new_n48_ & x24 & (x05 | x13)) | (~new_n51_ & ~x05 & ~x13) | (~new_n52_ & ~x24);
  assign new_n48_ = (~x07 | ~new_n38_ | ~new_n49_) & (~new_n50_ | ~new_n44_ | ~x18);
  assign new_n49_ = ~x08 & ~x20 & x04 & ~x06;
  assign new_n50_ = x20 & x11 & x14;
  assign new_n51_ = (~x19 | ~new_n38_ | ~new_n49_) & (~new_n50_ | ~new_n44_ | ~x15);
  assign new_n52_ = (new_n53_ | ~new_n46_ | ~new_n54_) & (new_n55_ | ~new_n38_ | ~new_n49_);
  assign new_n53_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n54_ = x14 & x08 & x20;
  assign new_n55_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign z4 = (~new_n40_ & (new_n60_ | ~x08)) | new_n59_ | (~new_n36_ & ~new_n57_);
  assign new_n57_ = new_n58_ & (~x04 | (~x08 & (x23 | x16 | x22)));
  assign new_n58_ = (~x08 | ~x20) & (x08 | x16 | (~x09 & (~x17 | x22)));
  assign new_n59_ = ~x04 & ~x20;
  assign new_n60_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ & ~new_n59_;
  assign z6 = (~new_n40_ & (new_n63_ | ~x03)) | new_n59_ | (~new_n36_ & (new_n64_ | x03));
  assign new_n63_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n64_ = ~x11 & (x06 | (~x14 & x20));
  assign z7 = ~new_n40_ | new_n59_;
endmodule
