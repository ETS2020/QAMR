...
module FAU ( 
  ...
  assign z1 = new_n44_ | (new_n42_ & ~new_n36_ & new_n40_);
  assign new_n42_ = new_n43_ & ~x16 & ~x17 & ~x22 & ~x23;
  assign new_n43_ = ~x04 & ~x08 & ~x09 & ~x12;
  assign new_n44_ = x01 & x20;
  assign z3 = ~new_n36_ & new_n40_ & ~x08;
  assign z4 = ~new_n44_ & ((~new_n36_ & (new_n51_ | x08)) | (~new_n47_ & (new_n52_ | ~x08)));
  ...
  assign z6 = (~new_n44_ & (new_n55_ | new_n56_)) | new_n57_ | ~new_n62_;
  assign new_n55_ = (new_n37_ | new_n38_ | ~new_n39_) & (x03 | (x06 & ~x11));
  assign new_n56_ = (new_n48_ | new_n49_ | ~new_n50_) & (~x03 | (~x06 & x11));
  assign new_n57_ = ~x24 & ((~new_n58_ & new_n59_) | (new_n60_ & ~new_n61_));
  assign new_n58_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n59_ = ~x11 & ~x14 & ~x01 & x20;
  assign new_n60_ = ~x20 & x11 & x14;
  assign new_n61_ = (x02 | x10 | ~x21) & (~x15 | ~x05 | ~x13);
  assign new_n62_ = (new_n63_ | x05 | x13) & (new_n64_ | ~x24 | (~x05 & ~x13));
  assign new_n63_ = (~x19 | x11 | x14 | x01 | ~x20) & (~x15 | x20 | ~x11 | ~x14);
  assign new_n64_ = (~x07 | x11 | x14 | x01 | ~x20) & (~x18 | x20 | ~x11 | ~x14);
  assign z7 = ~new_n47_ | new_n44_;
  assign z2 = 1'b0;
endmodule
