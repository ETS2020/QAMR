...
module FAU ( 
  ...
  wire new_n37_, new_n38_, new_n39_, new_n40_, new_n41_, new_n45_, new_n46_,
    ...
    new_n56_;
  assign z0 = ~x11 & ~x20;
  assign z1 = ~new_n37_ & new_n39_ & new_n41_ & x08;
  ...
  assign z2 = (~x11 & ~x20) | (new_n41_ & ~new_n37_ & x11 & x14 & x20);
  assign z3 = (~x11 & ~x20) | (new_n41_ & x08 & ~new_n37_ & x20 & x11 & x14);
  ...
  assign new_n52_ = (x00 | ~x03) & (x03 | x21) & ~x02 & ~x10;
  assign new_n53_ = x03 ? x19 : x15;
  assign new_n54_ = x03 ? x07 : x18;
  assign new_n55_ = (x06 | ~x14) & ~x11 & x20;
