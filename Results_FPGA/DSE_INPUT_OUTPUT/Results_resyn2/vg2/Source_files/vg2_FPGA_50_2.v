...
module FAU ( 
  ...
  assign new_n66_ = (~new_n40_ | ~new_n39_ | ~new_n58_) & (~new_n65_ | ~x15);
  assign new_n67_ = (~new_n65_ | new_n48_) & (new_n46_ | ~new_n38_ | ~new_n40_ | x08);
  assign z4 = ~new_n69_ & (~x14 | x20);
  ...
  assign z6 = (~new_n74_ & (~x14 | x20)) | (~new_n36_ & x20 & ~x11 & ~x14);
  assign new_n74_ = (new_n36_ | (~x03 & (~x06 | x11))) & (new_n60_ | (x03 & (x06 | ~x11)));
  assign z7 = ~new_n60_ & (~x14 | x20);
endmodule
