...
module FAU ( 
  ...
  assign z2 = ~new_n46_ & new_n50_ & x06 & x01 & x03;
  ...
  assign new_n50_ = x11 & x14 & ~x12 & x20;
  assign z3 = (~new_n52_ & ~x24) | (~new_n56_ & ~x05 & ~x13) | (~new_n57_ & x24 & (x05 | x13));
  assign new_n52_ = (new_n53_ | ~new_n50_ | ~new_n54_) & (new_n55_ | ~new_n40_ | x08);
  assign new_n53_ = (x02 | x10 | ~x21) & (~x15 | ~x05 | ~x13);
  assign new_n54_ = x08 & x06 & x01 & x03;
  assign new_n55_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n56_ = (~new_n54_ | ~new_n50_ | ~x15) & (~new_n40_ | x08 | ~x19);
  assign new_n57_ = (~new_n40_ | ~x07 | x08) & (~new_n54_ | ~new_n50_ | ~x18);
  assign z4 = (~new_n36_ & (new_n59_ | x08)) | new_n60_ | (~new_n46_ & (new_n61_ | ~x08));
  ...
  assign z6 = (~new_n60_ & (new_n64_ | new_n65_)) | new_n66_ | ~new_n70_;
  assign new_n64_ = (new_n37_ | new_n38_ | ~new_n39_) & (x03 | (x06 & ~x11));
  assign new_n65_ = (new_n47_ | new_n48_ | ~new_n49_) & (~x03 | (~x06 & x11));
