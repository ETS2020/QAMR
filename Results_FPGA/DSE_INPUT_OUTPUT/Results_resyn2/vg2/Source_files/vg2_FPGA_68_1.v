...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n67_, new_n69_, new_n70_, new_n73_;
  ...
  assign z4 = (~new_n62_ & (new_n69_ | ~x08)) | new_n59_ | (~new_n36_ & (new_n70_ | x08));
  assign new_n69_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n70_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n59_;
  assign z6 = ~new_n73_ | (~new_n36_ & (x03 | (x06 & ~x11)));
  assign new_n73_ = (x06 | ~x20) & (new_n62_ | (x03 & (~x11 | (x06 & (~x14 | x20)))));
