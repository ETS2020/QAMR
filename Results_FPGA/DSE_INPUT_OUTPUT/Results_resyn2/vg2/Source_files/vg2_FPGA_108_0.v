...
module FAU ( 
  ...
  assign z2 = new_n43_ & ~new_n36_ & x20 & x11 & x14;
  assign new_n43_ = x06 & x01 & x03;
  assign z3 = (~x06 & ~x20) | (new_n39_ & ~new_n36_ & x20 & x11 & x14);
  assign z4 = (~new_n36_ & (new_n48_ | ~x08)) | new_n41_ | (~new_n46_ & (new_n49_ | x08));
  ...
  assign z6 = (~new_n52_ & ~new_n41_) | (~new_n36_ & new_n57_) | (~new_n46_ & new_n56_);
