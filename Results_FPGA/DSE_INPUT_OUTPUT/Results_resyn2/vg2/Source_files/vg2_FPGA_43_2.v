...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & ~x24) | (~new_n52_ & ~new_n58_ & x24) | new_n59_ | (~new_n54_ & new_n58_);
  assign new_n40_ = (~new_n41_ | ~new_n44_) & (new_n46_ | ~new_n48_ | ~new_n50_ | ~new_n51_);
  ...
  assign new_n48_ = new_n49_ & x11 & x04 & x09;
  assign new_n49_ = x01 & x03 & x06 & x08;
  assign new_n50_ = x16 & x17;
  assign new_n51_ = x12 & x14 & x22 & x23;
  assign new_n52_ = (~new_n41_ | ~new_n53_) & (~new_n48_ | ~new_n51_ | ~new_n50_ | ~x18);
  assign new_n53_ = x07 & ~x11 & ~x14 & ~x06 & ~x20;
  assign new_n54_ = (~new_n48_ | ~new_n51_ | ~new_n50_ | ~x15) & (~new_n55_ | ~new_n56_);
  ...
  assign new_n64_ = (~new_n65_ | ~x18) & (~new_n53_ | ~new_n38_ | x08);
  ...
  assign z6 = new_n73_ | (x06 & ~x20) | (~new_n61_ & (~x03 | (~x06 & x11)));
