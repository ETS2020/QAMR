...
module FAU ( 
  ...
  assign new_n47_ = x11 & x12 & x04 & x09 & x14 & x16;
  assign new_n48_ = x08 & x06 & x01 & x03;
  assign z2 = new_n51_ | (~new_n42_ & new_n50_);
  assign new_n50_ = x06 & x01 & x03 & x11 & x14 & x20;
  assign new_n51_ = ~x12 & ~x20;
  assign z3 = (~new_n53_ & ~x24) | ~new_n59_ | (~new_n58_ & ~new_n60_ & x24);
  assign new_n53_ = (new_n55_ | ~new_n40_ | ~new_n56_) & (~new_n48_ | ~new_n54_ | new_n57_);
  ...
  assign new_n58_ = (~x07 | ~new_n40_ | ~new_n56_) & (~new_n50_ | ~x08 | ~x18);
  assign new_n59_ = ~new_n51_ & (~new_n60_ | ((~new_n62_ | ~new_n63_) & (~new_n48_ | ~new_n61_)));
  assign new_n60_ = ~x05 & ~x13;
  assign new_n61_ = x15 & x20 & x11 & x14;
  assign new_n62_ = ~x01 & ~x03 & ~x06 & x19;
  assign new_n63_ = ~x11 & ~x14 & ~x08 & ~x20;
  assign z4 = ~new_n51_ & ((~new_n36_ & (new_n65_ | x08)) | (~new_n42_ & (new_n66_ | ~x08)));
  assign new_n65_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n66_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ & ~new_n51_;
  assign z6 = new_n71_ | ~new_n75_ | (~new_n51_ & (new_n69_ | new_n70_));
  ...
  assign new_n73_ = (~x00 | ~x20 | x11 | x14) & (~x14 | x20 | ~x11 | ~x12 | ~x21);
  assign new_n74_ = (x11 | x14 | ~x19 | ~x20) & (~x15 | ~x11 | ~x12 | ~x14 | x20);
  assign new_n75_ = (new_n76_ | new_n60_ | ~x24) & (~new_n60_ | new_n74_);
  assign new_n76_ = (x11 | x14 | ~x07 | ~x20) & (~x14 | x20 | ~x18 | ~x11 | ~x12);
  assign z7 = ~new_n42_ & ~new_n51_;
endmodule
