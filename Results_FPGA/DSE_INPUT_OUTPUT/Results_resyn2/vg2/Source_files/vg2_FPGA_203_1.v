...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n51_ | new_n54_ | (~x08 & x20);
  ...
  assign z3 = (~new_n66_ & ~x24) | (~new_n67_ & x24 & (x05 | x13)) | (~new_n68_ & ~x05 & ~x13);
  assign new_n66_ = (new_n44_ | ~new_n63_) & (~new_n49_ | ~new_n38_ | x08);
  assign new_n67_ = (~new_n63_ | ~x18) & (~new_n52_ | ~new_n38_ | x08);
  assign new_n68_ = (~new_n63_ | ~x15) & (~new_n60_ | ~new_n38_ | x11 | x14);
  assign z4 = (~new_n36_ & (new_n70_ | x08)) | ((new_n71_ | ~x08) & (~new_n62_ | (~x08 & x20)));
  assign new_n70_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n71_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | (~x08 & x20);
  assign z6 = new_n74_ | new_n75_ | (~x08 & x20);
  assign new_n74_ = ~new_n36_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n75_ = ~new_n62_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n62_ & (x08 | ~x20);
endmodule
