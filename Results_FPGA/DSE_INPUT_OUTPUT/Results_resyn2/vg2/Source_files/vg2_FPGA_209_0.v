...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_, new_n43_,
    ...
    new_n77_;
  assign z0 = ~x20 & (~x17 | (~new_n36_ & new_n40_));
  ...
  assign new_n40_ = ~x01 & ~x03 & ~x06 & ~x11 & ~x14;
  ...
  assign z3 = new_n57_ | new_n60_ | (~x24 & (new_n52_ | new_n55_));
  assign new_n52_ = ~new_n54_ & new_n40_ & new_n53_;
  assign new_n53_ = ~x08 & x17 & ~x20;
  assign new_n54_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n55_ = ~new_n56_ & new_n48_ & new_n50_;
  assign new_n56_ = (x02 | x10 | ~x21) & (~x15 | ~x05 | ~x13);
  assign new_n57_ = new_n58_ & ((new_n48_ & new_n59_) | (x07 & new_n40_ & new_n53_));
  assign new_n58_ = x24 & (x05 | x13);
  assign new_n59_ = x20 & x18 & x11 & x14;
  assign new_n60_ = ~x05 & ~x13 & ((new_n61_ & new_n62_) | (new_n48_ & new_n63_));
  assign new_n61_ = x19 & ~x06 & ~x08;
  assign new_n62_ = x17 & ~x20 & ~x01 & ~x03 & ~x11 & ~x14;
  assign new_n63_ = x20 & x15 & x11 & x14;
  assign z4 = (~new_n36_ & (new_n65_ | x08)) | new_n67_ | (~new_n42_ & (new_n66_ | ~x08));
  ...
  assign z6 = (~new_n67_ & (new_n70_ | new_n71_)) | new_n72_ | ~new_n76_;
  ...
  assign new_n74_ = (x11 | x14 | ~x00 | ~x20) & (~x17 | x20 | ~x11 | ~x14 | ~x21);
  assign new_n75_ = (~x15 | ~x11 | ~x14 | ~x17 | x20) & (x11 | x14 | ~x19 | ~x20);
  assign new_n76_ = (new_n77_ | ~x24 | (~x05 & ~x13)) & (new_n75_ | x05 | x13);
  assign new_n77_ = (~x17 | x20 | ~x18 | ~x11 | ~x14) & (x11 | x14 | ~x07 | ~x20);
  assign z7 = ~new_n42_ | new_n67_;
endmodule
