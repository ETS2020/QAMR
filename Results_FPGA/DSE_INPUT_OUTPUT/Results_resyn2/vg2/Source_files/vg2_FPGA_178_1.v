...
module FAU ( 
  ...
  assign new_n63_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n45_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  ...
  assign z6 = ~new_n77_ | (~new_n36_ & (x03 | (x06 & ~x11)));
  assign new_n77_ = (x06 | ~x20) & (new_n63_ | (x03 & (~x11 | (x06 & (~x14 | x20)))));
