...
module FAU ( 
  ...
  assign z2 = ~new_n36_ & new_n43_ & x20 & x11 & x14;
  ...
  assign z6 = new_n52_ | new_n55_ | (~new_n46_ & new_n60_) | (~new_n57_ & x24);
  assign new_n52_ = ~new_n41_ & (new_n54_ | (x03 & (new_n47_ | new_n53_)));
  assign new_n53_ = x19 & ((~x05 & ~x13) | (~x24 & x05 & x13));
  assign new_n54_ = x24 & (x05 | x13) & (~x03 | x07) & (x03 | x18);
  assign new_n55_ = new_n56_ & (new_n37_ | (x15 & ((~x05 & ~x13) | (~x24 & x05 & x13))));
  assign new_n56_ = (x06 | x20) & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n57_ = ~new_n59_ & (~new_n58_ | ~x11 | (x06 & (~x14 | x20)));
  assign new_n58_ = (x05 | x13) & x18 & (x06 | x20);
  assign new_n59_ = x15 & ~x05 & ~x13 & ~x03 & x20;
