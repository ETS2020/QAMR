...
module FAU ( 
  ...
  assign z0 = ~new_n36_ & new_n38_ & new_n40_;
  ...
  assign new_n46_ = ~new_n37_ & (~x05 | ~x13 | ~x19);
  ...
  assign z2 = ~new_n60_ & x14;
  assign new_n60_ = x20 & (new_n61_ | ~x01 | ~x03 | ~x06 | ~x11);
  assign new_n61_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n62_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n62_ = x21 & ~x02 & ~x10;
  assign z3 = (~new_n64_ & ~x24) | (~new_n67_ & x24 & (x05 | x13)) | (~new_n68_ & ~x05 & ~x13);
  assign new_n64_ = (~new_n65_ | new_n48_) & (new_n46_ | ~new_n38_ | ~new_n40_ | x08);
  assign new_n65_ = new_n66_ & x11 & x14 & x20;
  assign new_n66_ = x06 & x08 & x01 & x03;
  assign new_n67_ = (~new_n65_ | ~x18) & (~new_n38_ | ~x07 | ~new_n40_ | x08);
  assign new_n68_ = (~new_n40_ | ~new_n39_ | ~new_n58_) & (~new_n65_ | ~x15);
  assign z4 = (~new_n36_ & (new_n70_ | x08)) | new_n72_ | (~new_n61_ & (new_n71_ | ~x08));
  assign new_n70_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n71_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n72_ = x14 & ~x20;
  assign z5 = ~new_n36_ | new_n72_;
  assign z6 = (~new_n75_ & (~x14 | x20)) | (~new_n36_ & x20 & ~x11 & ~x14);
  assign new_n75_ = (new_n36_ | (~x03 & (~x06 | x11))) & (new_n61_ | (x03 & (x06 | ~x11)));
