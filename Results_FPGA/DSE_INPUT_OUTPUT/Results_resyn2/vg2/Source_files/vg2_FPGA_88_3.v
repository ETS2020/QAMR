...
module FAU ( 
  ...
  assign z1 = ~new_n36_ & new_n42_ & new_n40_ & new_n38_;
  assign new_n40_ = new_n41_ & ~x23 & ~x17 & ~x22;
  assign new_n41_ = ~x12 & ~x16 & ~x04 & ~x09;
  assign new_n42_ = ~x08 & ~x06 & ~x01 & ~x03;
  assign z3 = new_n44_ | (new_n42_ & ~new_n36_ & new_n38_);
  assign new_n44_ = x06 & x20;
  assign z4 = (~new_n46_ & (new_n48_ | ~x08)) | new_n44_ | (~new_n36_ & (new_n49_ | x08));
  ...
  assign z6 = (~new_n46_ & (new_n52_ | ~x03)) | new_n44_ | (~new_n36_ & (new_n53_ | x03));
  assign new_n52_ = x11 & (~x06 | x14);
  assign new_n53_ = ~x11 & (x06 | (~x14 & x20));
  assign z7 = ~new_n46_ & ~new_n44_;
  assign z2 = 1'b0;
endmodule
