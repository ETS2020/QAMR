...
module FAU ( 
  ...
  assign z2 = new_n47_ | (~new_n40_ & new_n43_ & x06 & x01 & x03);
  assign new_n47_ = ~x16 & ~x20;
  assign z3 = (~new_n49_ & ~x24) | new_n53_ | new_n47_ | (~new_n56_ & new_n57_);
  assign new_n49_ = (new_n50_ | ~new_n38_ | ~new_n51_) & (new_n52_ | ~new_n45_ | ~new_n43_);
  assign new_n50_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n51_ = ~x20 & ~x08 & ~x14;
  assign new_n52_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n53_ = new_n55_ & ((new_n45_ & new_n54_) | (x07 & new_n38_ & new_n51_));
  assign new_n54_ = x18 & x20 & x11 & x14;
  assign new_n55_ = x24 & (x05 | x13);
  assign new_n56_ = (~x19 | ~new_n38_ | ~new_n51_) & (~new_n45_ | ~new_n43_ | ~x15);
  assign new_n57_ = ~x05 & ~x13;
  assign z4 = (~new_n36_ & (new_n59_ | x08)) | new_n47_ | (~new_n40_ & (new_n60_ | ~x08));
  assign new_n59_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n60_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | new_n47_;
  assign z6 = (~new_n36_ & (new_n63_ | x03)) | new_n47_ | (~new_n40_ & (new_n64_ | ~x03));
  assign new_n63_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n64_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n40_ | new_n47_;
endmodule
