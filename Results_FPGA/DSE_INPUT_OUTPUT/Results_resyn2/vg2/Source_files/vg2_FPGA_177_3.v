...
module FAU ( 
  ...
  assign z4 = (~new_n36_ & (new_n46_ | x08)) | new_n47_ | (~new_n44_ & (new_n48_ | ~x08));
  assign new_n44_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n45_ & (~x15 | x05 | x13);
  ...
  assign z6 = (~new_n44_ & (new_n51_ | ~x03)) | new_n47_ | (~new_n36_ & (new_n52_ | x03));
  assign new_n51_ = x11 & (~x06 | x14);
  assign new_n52_ = ~x11 & (x06 | (~x14 & x20));
  assign z7 = ~new_n44_ & ~new_n47_;
  assign z2 = 1'b0;
endmodule
