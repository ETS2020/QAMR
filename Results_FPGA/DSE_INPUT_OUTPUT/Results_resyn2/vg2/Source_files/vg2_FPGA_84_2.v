...
module FAU ( 
  ...
  assign new_n48_ = x04 & x09 & x06 & x08 & x01 & x03;
  ...
  assign z6 = ~new_n72_ | (~new_n77_ & x13);
  assign new_n72_ = (new_n74_ | new_n76_) & (new_n73_ | new_n75_) & (~x06 | x20);
  assign new_n73_ = (~new_n37_ | x24) & (~x05 | ~x07 | ~x24) & (~x19 | x05 | x13);
  assign new_n74_ = (~x05 | (x24 ? ~x18 : (~x13 | ~x15))) & (~new_n60_ | x24) & (~x15 | x05 | x13);
