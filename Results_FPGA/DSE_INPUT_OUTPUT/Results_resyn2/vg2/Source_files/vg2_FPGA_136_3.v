...
module FAU ( 
  ...
  assign new_n40_ = ~x14 & ~x20 & ~x11 & ~x06 & ~x01 & ~x03;
  assign new_n41_ = x09 & x20;
  assign z1 = new_n41_ | (~new_n36_ & new_n43_);
  assign new_n43_ = new_n45_ & new_n44_ & ~x14 & ~x20 & ~x09 & ~x11;
  assign new_n44_ = ~x04 & ~x08 & ~x12 & ~x16;
  assign new_n45_ = ~x06 & ~x01 & ~x03 & ~x23 & ~x17 & ~x22;
  assign z2 = ~new_n47_ & new_n51_ & x01 & x03 & x06 & ~x09;
  ...
  assign z3 = (~new_n53_ & ~x24) | new_n57_ | new_n60_ | new_n41_;
  assign new_n53_ = (new_n55_ | ~new_n51_ | ~new_n54_) & (~new_n40_ | new_n56_ | x08);
  assign new_n54_ = x01 & x03 & x06 & x08;
  assign new_n55_ = (x02 | x10 | ~x21) & (~x15 | ~x05 | ~x13);
  assign new_n56_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n57_ = new_n58_ & ((x18 & new_n51_ & new_n54_) | (new_n40_ & new_n59_));
  assign new_n58_ = x24 & (x05 | x13);
  assign new_n59_ = x07 & ~x08;
  assign new_n60_ = new_n61_ & ((new_n62_ & new_n63_) | (x15 & new_n51_ & new_n54_));
  assign new_n61_ = ~x05 & ~x13;
  assign new_n62_ = ~x11 & ~x06 & ~x01 & ~x03;
  assign new_n63_ = ~x14 & ~x20 & ~x08 & x19;
  assign z4 = (~new_n47_ & (new_n65_ | ~x08)) | new_n41_ | (~new_n36_ & (new_n66_ | x08));
  assign new_n65_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n66_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n41_;
  assign z6 = (~new_n41_ & (new_n69_ | new_n70_)) | new_n71_ | ~new_n75_;
  assign new_n69_ = (new_n37_ | new_n38_ | ~new_n39_) & (x03 | (x06 & ~x11));
  assign new_n70_ = (new_n48_ | new_n49_ | ~new_n50_) & (~x03 | (~x06 & x11));
  assign new_n71_ = ~x24 & ((~new_n73_ & ~x02 & ~x10) | (new_n72_ & ~new_n74_));
  assign new_n72_ = x05 & x13;
  assign new_n73_ = (~x00 | x09 | ~x20 | x11 | x14) & (~x11 | ~x14 | x20 | ~x21);
  assign new_n74_ = (x09 | x11 | ~x20 | x14 | ~x19) & (~x11 | ~x14 | ~x15 | x20);
  assign new_n75_ = (~new_n61_ | new_n74_) & (new_n76_ | new_n61_ | ~x24);
  assign new_n76_ = (~x11 | ~x14 | ~x18 | x20) & (~x07 | x09 | ~x20 | x11 | x14);
