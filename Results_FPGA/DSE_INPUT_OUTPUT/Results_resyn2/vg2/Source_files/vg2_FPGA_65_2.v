// Benchmark "FAU" written by ABC on Thu Aug 13 18:48:42 2020
...
module FAU ( 
  ...
  assign z2 = x06 & (~x20 | (~new_n59_ & new_n50_ & x01 & x03));
  assign new_n59_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n60_ | x24) & (~x15 | x05 | x13) & (~x13 | ~x18 | ~x24);
  assign new_n60_ = x21 & ~x02 & ~x10;
  assign z3 = (~new_n62_ & ~x24) | (~new_n64_ & x24 & (x05 | x13)) | (~new_n65_ & ~x05 & ~x13);
  assign new_n62_ = (~new_n63_ | new_n47_) & (new_n45_ | ~new_n38_ | ~new_n39_ | x08);
  assign new_n63_ = x01 & x03 & x06 & x08 & new_n50_ & x20;
  assign new_n64_ = (~new_n63_ | ~x18) & (~new_n38_ | ~x07 | ~new_n39_ | x08);
  assign new_n65_ = (~new_n63_ | ~x15) & (~new_n57_ | ~new_n39_ | x11 | x14);
  assign z4 = ~new_n67_ & (~x06 | x20);
  ...
  assign z6 = new_n72_ | (x06 & ~x20) | (~new_n59_ & (~x03 | (~x06 & x11)));
