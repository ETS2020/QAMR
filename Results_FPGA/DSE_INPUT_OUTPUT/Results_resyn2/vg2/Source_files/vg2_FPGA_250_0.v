...
module FAU ( 
  ...
  assign new_n36_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (x05 | x13 | ~x15) & ~new_n37_ & (~x13 | ~x18 | ~x24);
  ...
  assign z6 = new_n52_ | (~new_n46_ & ~new_n55_) | new_n41_ | (~new_n36_ & new_n56_);
  assign new_n52_ = ~x03 & ((~new_n54_ & ~x05) | new_n37_ | (~new_n53_ & x05));
  assign new_n53_ = (~x18 | ~x24) & (~x15 | ~x13 | x24);
  assign new_n54_ = x13 ? (~x18 | ~x24) : ~x15;
