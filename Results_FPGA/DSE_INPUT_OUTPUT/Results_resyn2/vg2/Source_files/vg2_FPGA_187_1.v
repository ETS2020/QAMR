...
module FAU ( 
  ...
  assign new_n57_ = (~new_n58_ | x24) & (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n58_ = x21 & ~x02 & ~x10;
  assign new_n59_ = x11 & x14 & x20 & x01 & x03;
  assign z3 = ~new_n61_ | (~new_n65_ & ~x05 & ~x13) | (~new_n66_ & x24 & (x05 | x13));
  assign new_n61_ = ~new_n64_ & (x24 | ((~new_n62_ | new_n45_) & (new_n41_ | ~new_n63_)));
  assign new_n62_ = new_n59_ & x06 & x08;
  assign new_n63_ = new_n38_ & ~x06 & ~x08;
  assign new_n64_ = ~x06 & x20;
  assign new_n65_ = (~new_n62_ | ~x15) & (~new_n49_ | ~x19 | x11 | x14);
  assign new_n66_ = (~new_n62_ | ~x18) & (~new_n49_ | ~x07 | x11 | x14);
  assign z4 = (~new_n57_ & (new_n68_ | ~x08)) | new_n64_ | (~new_n36_ & (new_n69_ | x08));
  assign new_n68_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n69_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n64_;
  assign z6 = ~new_n72_ | (~new_n57_ & x11 & (~x06 | (x14 & ~x20)));
  assign new_n72_ = (new_n73_ | x03) & (x06 | ~x20) & (new_n36_ | (~x03 & (~x06 | x11)));
  assign new_n73_ = (~new_n58_ | x24) & (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (x05 | (x13 ? (~x18 | ~x24) : ~x15));
