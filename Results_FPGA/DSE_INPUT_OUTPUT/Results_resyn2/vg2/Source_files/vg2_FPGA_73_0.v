...
module FAU ( 
  ...
  assign new_n37_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & ~new_n38_ & (~x15 | x05 | x13) & (~x13 | ~x18 | ~x24);
  ...
  assign new_n52_ = ~z0 & (new_n54_ | (x03 & (new_n47_ | new_n53_)));
  assign new_n53_ = x19 & ((~x05 & ~x13) | (~x24 & x05 & x13));
  assign new_n54_ = x24 & (x05 | x13) & (~x03 | x07) & (x03 | x18);
  assign new_n55_ = new_n56_ & (new_n38_ | (x15 & ((~x05 & ~x13) | (~x24 & x05 & x13))));
