...
module FAU ( 
  ...
  assign z2 = ~new_n59_ & new_n62_ & x06;
  assign new_n59_ = new_n60_ & (~x13 | ~x18 | ~x24);
  assign new_n60_ = (~x05 | (x24 ? ~x18 : (~x13 | ~x15))) & (~new_n61_ | x24) & (~x15 | x05 | x13);
  ...
  assign new_n67_ = (~new_n65_ | new_n47_) & (new_n45_ | ~new_n39_ | ~new_n38_ | x08);
  assign z4 = (~new_n36_ & (new_n69_ | x08)) | new_n71_ | (~new_n59_ & (new_n70_ | ~x08));
  assign new_n69_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n70_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n71_ = x06 & ~x20;
  assign z5 = ~new_n36_ | new_n71_;
  assign z6 = ~new_n74_ | (~new_n78_ & x13);
  assign new_n74_ = (new_n60_ | new_n77_) & ~new_n71_ & (new_n75_ | new_n76_);
