...
module FAU ( 
  ...
  assign z0 = ~x20 & (~x22 | (~new_n36_ & new_n38_ & ~x14));
  ...
  assign z1 = new_n45_ | (~new_n40_ & new_n42_);
  assign new_n40_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n41_ | x24) & (~x15 | x05 | x13) & (~x13 | ~x18 | ~x24);
  ...
  assign z2 = ~new_n40_ & new_n47_ & x06 & x01 & x03;
  assign new_n47_ = x20 & x11 & x14;
  assign z3 = (~new_n49_ & ~x24) | (~new_n53_ & ~new_n55_ & x24) | new_n45_ | (~new_n54_ & new_n55_);
  assign new_n49_ = (new_n50_ | ~new_n38_ | ~new_n51_) & (new_n52_ | ~new_n43_ | ~new_n47_);
  assign new_n50_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n51_ = ~x20 & ~x08 & ~x14;
  assign new_n52_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n53_ = (~x07 | ~new_n38_ | ~new_n51_) & (~new_n43_ | ~new_n47_ | ~x18);
  assign new_n54_ = (~x19 | ~new_n38_ | ~new_n51_) & (~new_n43_ | ~new_n47_ | ~x15);
  assign new_n55_ = ~x05 & ~x13;
  assign z4 = (~new_n36_ & (new_n57_ | x08)) | new_n45_ | (~new_n40_ & (new_n58_ | ~x08));
  assign new_n57_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n58_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | new_n45_;
  assign z6 = (~new_n36_ & (new_n61_ | x03)) | new_n45_ | (~new_n40_ & (new_n62_ | ~x03));
