...
module FAU ( 
  ...
  assign z6 = ~new_n72_ | (~new_n77_ & (x06 | ~x20));
  assign new_n72_ = new_n73_ & (new_n76_ | x24 | x02 | x10);
  assign new_n73_ = (new_n74_ | ((x05 | x13) & (x24 | ~x05 | ~x13))) & (new_n75_ | ~x24 | (~x05 & ~x13));
  assign new_n74_ = (~x19 | ~x06 | x11) & (~x11 | ~x15 | x20 | (x06 & ~x14));
  assign new_n75_ = (~x07 | ~x06 | x11) & (x20 | (x06 & ~x14) | ~x11 | ~x18);
  assign new_n76_ = (~x00 | ~x06 | x11) & (~x11 | ~x21 | x20 | (x06 & ~x14));
  assign new_n77_ = (x24 | (~new_n79_ & (~new_n78_ | ~x05 | ~x13))) & (~new_n78_ | x05 | x13) & (~new_n80_ | ~x24 | (~x05 & ~x13));
  assign new_n78_ = x03 ? x19 : x15;
  assign new_n79_ = (x00 | ~x03) & ~x02 & ~x10 & (x03 | x21);
