...
module FAU ( 
  ...
  assign z0 = ~x20 & (~x23 | (~new_n36_ & new_n38_ & ~x14));
  ...
  assign new_n42_ = new_n43_ & new_n44_ & x17 & x20 & x14 & x16;
  assign new_n43_ = x22 & x23 & x11 & x12 & x04 & x09;
  ...
  assign new_n49_ = ~x08 & ~x14 & ~x20 & x23;
  ...
  assign z4 = (~new_n40_ & ~new_n61_) | (~new_n36_ & ~new_n63_ & (new_n64_ | x08));
  assign new_n61_ = (new_n62_ | (~x20 & ~x23)) & (~x22 | ~x23 | x04 | ~x16);
  assign new_n62_ = x08 & (~x16 | (x09 & (x17 | ~x22)));
  assign new_n63_ = ~x20 & ~x23;
  assign new_n64_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n63_;
  assign z6 = (~new_n36_ & (new_n67_ | x03)) | new_n63_ | (~new_n40_ & (new_n68_ | ~x03));
  assign new_n67_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n68_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n40_ | new_n63_;
endmodule
