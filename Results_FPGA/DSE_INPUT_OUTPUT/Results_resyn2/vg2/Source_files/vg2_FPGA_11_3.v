...
module FAU ( 
  ...
  assign new_n42_ = ~x11 & ~x12 & ~x08 & ~x09;
  assign z2 = ~new_n44_ & new_n46_ & x14 & ~x17 & x20;
  ...
  assign z3 = (~new_n48_ & x24 & (x05 | x13)) | (~new_n52_ & ~x05 & ~x13) | (~new_n54_ & ~x24);
  assign new_n48_ = (~new_n50_ | ~new_n51_) & (~x07 | ~new_n38_ | ~new_n49_);
  assign new_n49_ = ~x08 & ~x14 & ~x20;
  assign new_n50_ = x11 & x14 & ~x17 & x20;
  assign new_n51_ = x18 & x01 & x03 & x06 & x08;
  assign new_n52_ = (~new_n50_ | ~new_n53_) & (~x19 | ~new_n38_ | ~new_n49_);
  assign new_n53_ = x15 & x01 & x03 & x06 & x08;
  assign new_n54_ = (new_n55_ | ~new_n46_ | ~new_n56_) & (new_n57_ | ~new_n38_ | ~new_n49_);
  assign new_n55_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n56_ = x08 & x14 & ~x17 & x20;
  assign new_n57_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign z4 = (~new_n36_ & ~new_n59_ & (new_n60_ | x08)) | (~new_n44_ & ~new_n59_ & (new_n61_ | ~x08));
  ...
  assign z6 = (~new_n44_ & (new_n64_ | ~x03)) | new_n59_ | (~new_n36_ & (new_n65_ | x03));
