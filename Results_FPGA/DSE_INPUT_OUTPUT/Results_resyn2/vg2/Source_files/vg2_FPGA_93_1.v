...
module FAU ( 
  ...
  assign new_n42_ = x11 & x14 & x12 & x16;
  ...
  assign z3 = (~x24 & (new_n57_ | (new_n56_ & ~new_n49_))) | new_n58_ | (new_n56_ & ~new_n44_);
  assign new_n56_ = x08 & new_n54_ & x20 & x14 & x15;
  assign new_n57_ = ~new_n50_ & new_n38_ & ~x01 & ~x03 & ~x08;
  assign new_n58_ = ~new_n51_ & new_n38_ & ~x01 & ~x03 & ~x08;
  assign z4 = (~new_n36_ & (new_n64_ | x08)) | ~new_n62_ | (~new_n60_ & (new_n65_ | ~x08));
  assign new_n60_ = (~x15 | ((x05 | x13) & (x24 | ~x05 | ~x13))) & ~new_n61_ & ((~x05 & ~x13) | ~x18 | ~x24);
  assign new_n61_ = ~x24 & x21 & ~x02 & ~x10;
  assign new_n62_ = ~new_n63_ & (~x19 | x24 | ~x15 | ((x05 | x13) & (x24 | ~x05 | ~x13)));
  assign new_n63_ = x20 & (~x15 | (~x05 & ~x13 & ~x08 & x24));
  assign new_n64_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n65_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | (~x15 & x20);
  assign z6 = new_n68_ | new_n69_ | new_n71_ | (~new_n60_ & ~new_n73_);
  assign new_n68_ = ~x15 & (x20 | (new_n61_ & x11 & x14));
  assign new_n69_ = ~new_n70_ & ((new_n37_ & ~x24) | ((x05 | x13) & x07 & x24));
  assign new_n70_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n71_ = new_n72_ & ((~x05 & ~x13) | (~x24 & x05 & x13));
  assign new_n72_ = x19 & (x03 | (x06 & ~x11));
  assign new_n73_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign z7 = new_n75_ | new_n61_ | ~new_n76_;
  assign new_n75_ = x05 & (x24 ? x18 : (x13 & x15));
  assign new_n76_ = (~x15 | x05 | x13) & (x15 | ~x20) & (~x13 | ~x18 | ~x24);
endmodule
