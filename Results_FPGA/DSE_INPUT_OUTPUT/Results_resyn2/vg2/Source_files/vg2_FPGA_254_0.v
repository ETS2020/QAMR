...
module FAU ( 
  ...
  assign new_n41_ = ~x03 & ~x20;
  assign z2 = new_n43_ & ~new_n36_ & x20 & x11 & x14;
  assign new_n43_ = x06 & x01 & x03;
  assign z3 = (~x03 & ~x20) | (new_n39_ & ~new_n36_ & x20 & x11 & x14);
  ...
  assign z6 = (~new_n36_ & (x03 | x20) & (new_n52_ | ~x03)) | (~new_n46_ & (new_n53_ | x03));
  assign new_n52_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n53_ = (x06 | ~x14) & ~x11 & x20;
