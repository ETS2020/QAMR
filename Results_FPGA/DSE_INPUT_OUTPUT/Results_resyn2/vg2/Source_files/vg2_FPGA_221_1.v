...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & ~x24) | (~new_n50_ & ~new_n56_ & x24) | (~new_n53_ & new_n56_);
  ...
  assign z2 = x20 & (~x06 | (~new_n58_ & new_n48_ & x01 & x03));
  assign new_n58_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n59_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n59_ = x21 & ~x02 & ~x10;
  assign z3 = new_n65_ | (~new_n61_ & ~x24) | (~new_n63_ & new_n56_) | (~new_n64_ & ~new_n56_ & x24);
  assign new_n61_ = (~new_n62_ | new_n45_) & (new_n41_ | ~new_n38_ | x06 | x08);
  assign new_n62_ = x08 & x01 & x03 & new_n48_ & x20;
  assign new_n63_ = (~new_n62_ | ~x15) & (~new_n49_ | ~x19 | x11 | x14);
  assign new_n64_ = (~new_n62_ | ~x18) & (~new_n49_ | ~x07 | x11 | x14);
  assign new_n65_ = ~x06 & x20;
  assign z4 = (~new_n36_ & (new_n67_ | x08)) | new_n65_ | (~new_n58_ & (new_n68_ | ~x08));
  assign new_n67_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n68_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | new_n65_;
  assign z6 = ~new_n71_ | (~x06 & (x20 | (~new_n77_ & x11 & ~x24)));
  assign new_n71_ = ~new_n72_ & ~new_n74_ & (new_n36_ | (~x03 & (~x06 | x11)));
  assign new_n72_ = new_n73_ & ((new_n59_ & ~x24) | (x15 & ((~x05 & ~x13) | (~x24 & x05 & x13))));
  assign new_n73_ = (x06 | ~x20) & (~x03 | (~x20 & x11 & x14));
  assign new_n74_ = x24 & ((~new_n75_ & ~new_n56_ & x18) | (~new_n76_ & (new_n56_ ? x15 : x18)));
  assign new_n75_ = (x03 | ~x06) & (x20 | ~x11 | ~x14);
  assign new_n76_ = (x03 | x20) & (~x11 | ~x03 | x06);
  assign new_n77_ = ~new_n59_ & (~x15 | (~x05 ^ ~x13));
  assign z7 = ~new_n58_ & ~new_n65_;
endmodule
