...
module FAU ( 
  ...
  assign z2 = (x04 | (~new_n45_ & new_n47_)) & x20;
  assign new_n45_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n46_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n46_ = x21 & ~x02 & ~x10;
  assign new_n47_ = x01 & x03 & x14 & x06 & x11;
  assign z3 = new_n49_ | new_n56_ | (~x24 & (new_n53_ | new_n55_));
  assign new_n49_ = new_n52_ & ((x18 & new_n47_ & new_n50_) | (new_n38_ & new_n51_));
  assign new_n50_ = x20 & ~x04 & x08;
  assign new_n51_ = x07 & ~x08;
  assign new_n52_ = x24 & (x05 | x13);
  assign new_n53_ = ~new_n54_ & new_n47_ & new_n50_;
  assign new_n54_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n55_ = (new_n37_ | (x19 & x05 & x13)) & new_n38_ & ~x08;
  assign new_n56_ = new_n57_ & ((x15 & new_n47_ & new_n50_) | (new_n38_ & new_n58_));
