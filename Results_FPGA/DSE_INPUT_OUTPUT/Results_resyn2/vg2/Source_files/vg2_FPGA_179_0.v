...
module FAU ( 
  ...
  assign z0 = ~new_n36_ & new_n40_ & ~x01 & ~x03 & ~x06 & x09;
  ...
  assign z1 = ~new_n42_ & new_n46_ & new_n48_ & new_n49_;
  ...
  assign new_n47_ = x12 & x16 & x04 & x09;
  assign new_n48_ = x20 & x11 & x14;
  assign new_n49_ = x08 & x06 & x01 & x03;
  assign z2 = ~new_n42_ & new_n51_;
  assign new_n51_ = x06 & x01 & x03 & x20 & x11 & x14;
  assign z3 = (~new_n53_ & new_n59_) | (~new_n55_ & ~x24) | new_n60_ | (~new_n58_ & ~new_n59_ & x24);
  assign new_n53_ = (~x19 | ~new_n40_ | ~new_n54_) & (~x15 | ~new_n48_ | ~new_n49_);
  assign new_n54_ = ~x06 & ~x08 & ~x01 & ~x03;
  assign new_n55_ = (new_n56_ | ~new_n40_ | ~new_n54_) & (new_n57_ | ~new_n48_ | ~new_n49_);
  assign new_n56_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n57_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n58_ = (~x07 | ~new_n40_ | ~new_n54_) & (~new_n51_ | ~x08 | ~x18);
  assign new_n59_ = ~x05 & ~x13;
  assign new_n60_ = ~x09 & ~x20;
  assign z4 = (~new_n36_ & (new_n62_ | x08)) | new_n60_ | (~new_n42_ & (new_n63_ | ~x08));
  assign new_n62_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n63_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | new_n60_;
  assign z6 = (~new_n60_ & (new_n66_ | new_n67_)) | new_n68_ | ~new_n72_;
  ...
  assign new_n70_ = (x11 | x14 | ~x00 | ~x20) & (~x14 | x20 | ~x21 | ~x09 | ~x11);
  assign new_n71_ = (x11 | x14 | ~x19 | ~x20) & (~x14 | x20 | ~x15 | ~x09 | ~x11);
  assign new_n72_ = (~new_n59_ | new_n71_) & (new_n73_ | new_n59_ | ~x24);
  assign new_n73_ = (x11 | x14 | ~x07 | ~x20) & (~x18 | ~x09 | ~x11 | ~x14 | x20);
