...
module FAU ( 
  ...
  assign z3 = (~new_n50_ & ~new_n59_ & x24) | (~new_n52_ & ~x24) | new_n38_ | (~new_n55_ & new_n59_);
  assign new_n50_ = (~new_n39_ | ~x07 | x08) & (~new_n51_ | ~x11 | ~x18);
  assign new_n51_ = x14 & x20 & x08 & x06 & x01 & x03;
  assign new_n52_ = (~new_n39_ | new_n53_ | x08) & (~new_n51_ | new_n54_ | ~x11);
  assign new_n53_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n54_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n55_ = (~new_n57_ | ~new_n48_ | ~x11 | ~x15) & (~new_n58_ | ~new_n56_ | x11);
  assign new_n56_ = ~x06 & ~x01 & ~x03;
  assign new_n57_ = x08 & x06 & x01 & x03;
  assign new_n58_ = ~x14 & ~x20 & ~x08 & x19;
  assign new_n59_ = ~x05 & ~x13;
  assign z4 = (~new_n45_ & (new_n61_ | ~x08)) | new_n38_ | (~new_n36_ & (new_n62_ | x08));
