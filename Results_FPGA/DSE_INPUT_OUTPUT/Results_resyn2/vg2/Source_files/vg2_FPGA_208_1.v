...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    ...
    new_n68_, new_n69_, new_n70_, new_n73_;
  ...
  assign new_n46_ = ~new_n47_ & new_n48_ & new_n49_ & new_n50_ & x12 & x16;
  assign new_n47_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n48_ = x04 & x09 & x01 & x03 & x06 & x08;
  ...
  assign z2 = ~new_n59_ & x20;
  assign new_n59_ = x14 & (new_n60_ | ~x01 | ~x03 | ~x06 | ~x11);
  assign new_n60_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n61_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n61_ = x21 & ~x02 & ~x10;
  assign z3 = (~new_n63_ & ~x24) | (~new_n65_ & x24 & (x05 | x13)) | (~new_n66_ & ~x05 & ~x13);
  assign new_n63_ = (~new_n64_ | new_n47_) & (new_n45_ | ~new_n39_ | ~new_n38_ | x08);
  assign new_n64_ = x01 & x03 & x06 & x08 & new_n50_ & x20;
  assign new_n65_ = (~new_n64_ | ~x18) & (~new_n39_ | ~x07 | ~new_n38_ | x08);
  assign new_n66_ = (~new_n64_ | ~x15) & (~new_n57_ | ~new_n38_ | x11 | x14);
  assign z4 = (~new_n36_ & (new_n68_ | x08)) | new_n70_ | (~new_n60_ & (new_n69_ | ~x08));
  ...
  assign z6 = (~new_n73_ & (x14 | ~x20)) | (~new_n60_ & ~x20 & x11 & x14);
  assign new_n73_ = (new_n36_ | (~x03 & (~x06 | x11))) & (new_n60_ | (x03 & (x06 | ~x11)));
  assign z7 = ~new_n60_ | new_n70_;
endmodule
