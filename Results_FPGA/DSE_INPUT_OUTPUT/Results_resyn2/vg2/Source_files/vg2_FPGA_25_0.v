...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n53_, new_n55_, new_n56_, new_n57_, new_n60_, new_n61_;
  assign z0 = ~x20 & (~x23 | (~new_n36_ & new_n38_));
  ...
  assign z1 = new_n42_ & ~new_n40_ & new_n45_;
  ...
  assign z2 = ~new_n40_ & new_n45_ & x06 & x01 & x03;
  assign z3 = (~new_n48_ & x24 & (x05 | x13)) | (~new_n50_ & ~x24) | (~new_n53_ & ~x05 & ~x13);
  assign new_n48_ = (~x07 | ~new_n38_ | ~new_n49_) & (~new_n43_ | ~new_n45_ | ~x18);
  assign new_n49_ = x23 & ~x08 & ~x20;
  assign new_n50_ = (new_n51_ | ~new_n38_ | ~new_n49_) & (new_n52_ | ~new_n45_ | ~new_n43_);
  assign new_n51_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n52_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n53_ = (~x19 | ~new_n38_ | ~new_n49_) & (~new_n43_ | ~new_n45_ | ~x15);
  assign z4 = (~new_n36_ & (new_n55_ | x08)) | new_n56_ | (~new_n40_ & (new_n57_ | ~x08));
  ...
  assign z6 = (~new_n40_ & (new_n60_ | ~x03)) | new_n56_ | (~new_n36_ & (new_n61_ | x03));
  assign new_n60_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n61_ = ~x11 & (x06 | (~x14 & x20));
  assign z7 = ~new_n40_ & ~new_n56_;
endmodule
