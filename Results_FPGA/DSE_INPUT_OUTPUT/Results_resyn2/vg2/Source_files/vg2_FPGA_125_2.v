...
module FAU ( 
  ...
  assign z6 = ~new_n72_ | (~new_n73_ & (~x06 | x20));
  assign new_n72_ = (new_n36_ | x11 | ~x20 | (~x06 & x14)) & (new_n59_ | x06 | ~x11);
  assign new_n73_ = (x24 | (~new_n75_ & (~new_n74_ | ~x05 | ~x13))) & (~new_n74_ | x05 | x13) & (~new_n76_ | ~x24 | (~x05 & ~x13));
  assign new_n74_ = x03 ? x19 : x15;
  assign new_n75_ = (x00 | ~x03) & ~x02 & ~x10 & (x03 | x21);
  assign new_n76_ = x03 ? x07 : x18;
