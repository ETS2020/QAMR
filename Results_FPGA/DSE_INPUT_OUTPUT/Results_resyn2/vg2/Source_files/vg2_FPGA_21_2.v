...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & ~x24) | new_n51_ | new_n54_ | new_n59_;
  ...
  assign new_n53_ = x07 & ~x06 & ~x20 & ~x11 & ~x14;
  ...
  assign z2 = ~new_n61_ & x06;
  assign new_n61_ = x20 & (new_n62_ | ~x11 | ~x14 | ~x01 | ~x03);
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n63_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n63_ = x21 & ~x02 & ~x10;
  assign z3 = (~new_n65_ & ~x24) | (~new_n67_ & ~x05 & ~x13) | (~new_n68_ & x24 & (x05 | x13));
  assign new_n65_ = (~new_n66_ | new_n47_) & (~new_n44_ | ~new_n38_ | x08);
  assign new_n66_ = new_n49_ & x20 & x11 & x14;
  assign new_n67_ = (~new_n66_ | ~x15) & (~new_n57_ | ~new_n38_ | x11 | x14);
  assign new_n68_ = (~new_n66_ | ~x18) & (~new_n53_ | ~new_n38_ | x08);
  assign z4 = (~new_n36_ & (new_n70_ | x08)) | new_n59_ | (~new_n62_ & (new_n71_ | ~x08));
  assign new_n70_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n71_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | new_n59_;
  assign z6 = new_n74_ | (x06 & ~x20) | (~new_n62_ & (~x03 | (~x06 & x11)));
