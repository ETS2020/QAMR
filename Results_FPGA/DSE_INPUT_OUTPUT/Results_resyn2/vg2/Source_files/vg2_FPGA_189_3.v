...
module FAU ( 
  ...
  assign z0 = (~x06 & ~x01 & ~x03 & ~new_n36_ & new_n38_ & ~x20) | (x03 & x20);
  ...
  assign z2 = x03 & x20;
  assign z3 = (x03 & x20) | (new_n42_ & ~new_n36_ & new_n38_ & ~x20);
  ...
  assign z6 = (~new_n46_ & (new_n52_ | ~x03)) | (x03 & x20) | (~new_n36_ & (new_n53_ | x03));
