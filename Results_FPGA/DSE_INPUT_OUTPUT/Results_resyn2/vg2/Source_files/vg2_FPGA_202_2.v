...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n51_ | new_n54_ | (x06 & ~x20);
  ...
  assign new_n69_ = (new_n36_ | (~x08 & (new_n70_ | x16))) & (new_n60_ | (x08 & (new_n71_ | ~x16)));
  assign new_n70_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n71_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = ~new_n36_ | (x06 & ~x20);
  assign z6 = ~new_n74_ | ((~x06 | x20) & (~new_n78_ | (~new_n75_ & ~x24)));
