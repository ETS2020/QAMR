...
module FAU ( 
  ...
  assign new_n37_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (x05 | x13 | ~x15) & ~new_n38_ & (~x13 | ~x18 | ~x24);
  ...
  assign z3 = (~x06 & ~x20) | (new_n40_ & ~new_n37_ & new_n43_ & x20);
  ...
  assign z6 = new_n52_ | (~new_n46_ & ~new_n55_) | z0 | (~new_n37_ & new_n56_);
  assign new_n52_ = ~x03 & ((~new_n54_ & ~x05) | new_n38_ | (~new_n53_ & x05));
