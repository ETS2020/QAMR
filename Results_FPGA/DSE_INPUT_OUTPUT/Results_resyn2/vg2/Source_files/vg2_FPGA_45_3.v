...
module FAU ( 
  ...
  assign new_n39_ = x16 & x20;
  assign z1 = ~new_n36_ & new_n43_ & new_n42_ & new_n41_ & ~x04 & ~x08;
  assign new_n41_ = ~x14 & ~x20;
  ...
  assign z3 = (~new_n49_ & ~new_n59_ & x24) | (~new_n52_ & ~x24) | new_n39_ | (~new_n56_ & new_n59_);
  assign new_n49_ = (~new_n38_ | ~x07 | x08) & (~new_n51_ | ~new_n50_ | ~x08);
  assign new_n50_ = x06 & x01 & x03;
  assign new_n51_ = x18 & x20 & x11 & x14;
  assign new_n52_ = (~new_n38_ | new_n53_ | x08) & (new_n54_ | ~new_n47_ | ~new_n55_);
  assign new_n53_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n54_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n55_ = x20 & x08 & x14;
  assign new_n56_ = (~new_n58_ | ~new_n50_ | ~x08) & (~new_n57_ | ~new_n41_ | x08 | ~x19);
  assign new_n57_ = ~x11 & ~x06 & ~x01 & ~x03;
  assign new_n58_ = x15 & x20 & x11 & x14;
  assign new_n59_ = ~x05 & ~x13;
  assign z4 = (~new_n45_ & (new_n61_ | ~x08)) | new_n39_ | (~new_n36_ & (new_n62_ | x08));
  assign new_n61_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n62_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n39_;
  assign z6 = (~new_n45_ & (new_n65_ | ~x03)) | new_n39_ | (~new_n36_ & (new_n66_ | x03));
