...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n43_, new_n46_,
    new_n47_, new_n48_, new_n49_, new_n50_, new_n53_, new_n54_, new_n55_,
    new_n56_, new_n57_, new_n58_;
  assign z0 = new_n36_ | z2;
  ...
  assign z4 = (~new_n47_ & (new_n49_ | ~x08)) | z2 | (~new_n46_ & (new_n50_ | x08));
  ...
  assign z6 = (~new_n53_ & ~z2) | (new_n57_ & ~new_n46_ & ~z2) | (~new_n47_ & new_n58_);
