...
module FAU ( 
  ...
  assign new_n41_ = new_n43_ & new_n42_ & ~x22 & ~x23 & ~x16 & ~x17;
  assign new_n42_ = ~x01 & ~x03 & ~x14 & ~x20;
  assign new_n43_ = ~x04 & ~x06 & ~x11 & ~x12 & ~x08 & ~x09;
  assign z2 = x20 & (x23 | (~new_n45_ & new_n47_ & x11 & x14));
  assign new_n45_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n46_ | x24) & (~x15 | x05 | x13) & (~x13 | ~x18 | ~x24);
  assign new_n46_ = x21 & ~x02 & ~x10;
  assign new_n47_ = x06 & x01 & x03;
  assign z3 = (~new_n49_ & ~new_n56_ & x24) | (~new_n51_ & ~x24) | new_n39_ | (~new_n54_ & new_n56_);
  assign new_n49_ = (~new_n50_ | ~x18 | ~x20) & (~x07 | ~new_n38_ | x08);
  assign new_n50_ = x11 & x14 & x08 & x06 & x01 & x03;
  assign new_n51_ = (~new_n50_ | new_n52_ | ~x20) & (new_n53_ | ~new_n38_ | x08);
  assign new_n52_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n53_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n54_ = (~new_n55_ | ~new_n47_ | ~x08) & (~new_n38_ | x08 | ~x19);
