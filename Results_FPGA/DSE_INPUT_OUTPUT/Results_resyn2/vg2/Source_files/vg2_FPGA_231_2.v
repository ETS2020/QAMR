...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n67_, new_n68_, new_n70_, new_n71_, new_n74_;
  ...
  assign z1 = new_n40_ | new_n51_ | new_n54_ | new_n59_;
  ...
  assign new_n51_ = ~new_n53_ & x24 & ((new_n47_ & new_n52_) | (new_n41_ & x07));
  assign new_n52_ = new_n50_ & x18 & x16 & x17;
  assign new_n53_ = ~x05 & ~x13;
  assign new_n54_ = new_n53_ & ((new_n47_ & new_n50_ & new_n58_) | (new_n55_ & new_n56_));
  assign new_n55_ = new_n42_ & ~x23 & ~x14 & ~x22;
  ...
  assign new_n64_ = ~x24 & ((~new_n45_ & new_n65_) | (~new_n44_ & new_n66_));
  assign new_n65_ = new_n62_ & x06 & x08;
  assign new_n66_ = new_n38_ & ~x20 & ~x06 & ~x08;
  assign new_n67_ = ~new_n53_ & x24 & ((new_n65_ & x18) | (new_n66_ & x07));
  assign new_n68_ = new_n53_ & ((new_n65_ & x15) | (new_n66_ & x19));
  assign z4 = (~new_n61_ & (new_n70_ | ~x08)) | new_n59_ | (~new_n36_ & (new_n71_ | x08));
  assign new_n70_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n71_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n59_;
  assign z6 = ~new_n74_ | (~new_n61_ & (~x03 | (~x06 & x11)));
  assign new_n74_ = (~x06 | x20) & (new_n36_ | (~x03 & (x11 | (~x06 & (x14 | ~x20)))));
