...
module FAU ( 
  ...
  assign z4 = (~new_n36_ & (new_n46_ | x08)) | new_n48_ | (~new_n44_ & (new_n47_ | ~x08));
  assign new_n44_ = ~new_n45_ & (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  ...
  assign z6 = (~new_n44_ & new_n54_) | new_n51_ | new_n48_ | (~new_n36_ & ~new_n55_);
  assign new_n51_ = ~x03 & (new_n53_ | new_n52_ | new_n45_);
