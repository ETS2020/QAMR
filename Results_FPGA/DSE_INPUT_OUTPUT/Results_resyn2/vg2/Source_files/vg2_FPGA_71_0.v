...
module FAU ( 
  ...
  assign z1 = new_n46_ | (~new_n40_ & new_n42_);
  assign new_n40_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n41_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n41_ = x21 & ~x02 & ~x10;
  assign new_n42_ = new_n43_ & new_n44_ & new_n45_ & x23 & x17 & x22;
  assign new_n43_ = x01 & x03 & x06 & x08;
  assign new_n44_ = x20 & x11 & x14;
  assign new_n45_ = x04 & x09 & x12 & x16;
  assign new_n46_ = ~x16 & ~x20;
  assign z2 = ~new_n40_ & new_n44_ & x06 & x01 & x03;
  assign z3 = (~new_n49_ & ~x24) | (~new_n53_ & new_n57_) | new_n46_ | (~new_n54_ & ~new_n57_ & x24);
  assign new_n49_ = (new_n51_ | ~new_n38_ | ~new_n50_) & (new_n52_ | ~new_n43_ | ~new_n44_);
  assign new_n50_ = ~x20 & ~x08 & ~x14;
  assign new_n51_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n52_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n53_ = (~x19 | ~new_n38_ | ~new_n50_) & (~x15 | ~new_n43_ | ~new_n44_);
  assign new_n54_ = (~new_n38_ | ~new_n56_) & (~new_n43_ | ~new_n55_);
  assign new_n55_ = x11 & x14 & x18 & x20;
  assign new_n56_ = ~x08 & ~x14 & x07 & ~x20;
  assign new_n57_ = ~x05 & ~x13;
  assign z4 = (~new_n59_ & ~new_n46_) | (~new_n36_ & new_n63_) | (~new_n40_ & new_n65_);
  assign new_n59_ = (x24 | (~new_n61_ & (~new_n60_ | ~x05 | ~x13))) & (~new_n60_ | x05 | x13) & (~new_n62_ | ~x24 | (~x05 & ~x13));
  assign new_n60_ = x08 ? x19 : x15;
  assign new_n61_ = (x00 | ~x08) & ~x02 & ~x10 & (x08 | x21);
  assign new_n62_ = x08 ? x07 : x18;
  assign new_n63_ = ~new_n64_ & ~x16 & x20;
