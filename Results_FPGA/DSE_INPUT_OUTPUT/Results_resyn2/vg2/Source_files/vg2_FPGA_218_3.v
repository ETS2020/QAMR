...
module FAU ( 
  ...
  assign z1 = ~new_n36_ & new_n41_ & new_n43_ & ~x23 & ~x17 & ~x22;
  assign new_n41_ = new_n42_ & ~x09 & ~x11 & ~x12 & ~x16;
  ...
  assign new_n47_ = new_n48_ & x11 & ~x22;
  assign new_n48_ = x14 & x20;
  assign z3 = (~new_n50_ & ~new_n58_ & x24) | (~new_n52_ & ~x24) | new_n39_ | (~new_n55_ & new_n58_);
  assign new_n50_ = (~new_n38_ | ~x07 | x08) & (~new_n51_ | ~x11 | ~x18);
  assign new_n51_ = x14 & x20 & x08 & x06 & x01 & x03;
  assign new_n52_ = (~new_n38_ | new_n53_ | x08) & (~new_n51_ | new_n54_ | ~x11);
  assign new_n53_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n54_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n55_ = (~new_n56_ | ~new_n48_ | ~x11 | ~x15) & (~new_n57_ | ~new_n43_ | x11);
  assign new_n56_ = x08 & x06 & x01 & x03;
  assign new_n57_ = ~x14 & ~x20 & ~x08 & x19;
  assign new_n58_ = ~x05 & ~x13;
  assign z4 = (~new_n45_ & (new_n60_ | ~x08)) | new_n39_ | (~new_n36_ & (new_n61_ | x08));
  assign new_n60_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n39_;
  assign z6 = (~new_n45_ & (new_n64_ | ~x03)) | new_n39_ | (~new_n36_ & (new_n65_ | x03));
