...
module FAU ( 
  ...
  assign new_n61_ = new_n62_ & x11 & x14 & x20;
  assign new_n62_ = x06 & x08 & x01 & x03;
  assign z3 = (~new_n64_ & ~x24) | (~new_n65_ & x24 & (x05 | x13)) | (~new_n66_ & ~x05 & ~x13);
  assign new_n64_ = (~new_n61_ | new_n47_) & (new_n45_ | ~new_n38_ | ~new_n39_ | x08);
  assign new_n65_ = (~new_n61_ | ~x18) & (~new_n38_ | ~x07 | ~new_n39_ | x08);
  assign new_n66_ = (~new_n61_ | ~x15) & (~new_n57_ | ~new_n39_ | x11 | x14);
  assign z4 = (~new_n36_ & (new_n68_ | x08)) | ((new_n69_ | ~x08) & (~new_n59_ | (~x08 & x20)));
  assign new_n68_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n69_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | (~x08 & x20);
  assign z6 = new_n72_ | new_n73_ | (~x08 & x20);
  assign new_n72_ = ~new_n36_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n73_ = ~new_n59_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign z7 = ~new_n59_ & (x08 | ~x20);
endmodule
