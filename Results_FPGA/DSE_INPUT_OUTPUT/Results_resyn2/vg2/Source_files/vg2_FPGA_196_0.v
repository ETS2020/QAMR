...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n63_, new_n64_;
  assign z0 = ~new_n36_ & new_n38_ & ~x20 & ~x14 & x17;
  ...
  assign z4 = (~new_n36_ & ~new_n46_ & (new_n59_ | x08)) | (~new_n40_ & ~new_n46_ & (new_n60_ | ~x08));
  assign new_n59_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n60_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | new_n46_;
  assign z6 = (~new_n36_ & (new_n63_ | x03)) | new_n46_ | (~new_n40_ & (new_n64_ | ~x03));
