...
module FAU ( 
  ...
  assign z2 = x20 & (~x06 | (~new_n63_ & new_n64_));
  assign new_n63_ = (~new_n45_ | x24) & (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n64_ = x11 & x14 & x01 & x03;
  assign z3 = (~new_n66_ & ~x24) | new_n68_ | (~new_n69_ & ~x05 & ~x13);
  assign new_n66_ = (new_n44_ | ~new_n67_) & (~new_n49_ | ~new_n38_ | x08);
  assign new_n67_ = new_n64_ & x20 & x06 & x08;
  assign new_n68_ = new_n53_ & ((new_n67_ & x18) | (new_n52_ & new_n38_ & ~x08));
  assign new_n69_ = (~new_n67_ | ~x15) & (~new_n60_ | ~new_n38_ | x11 | x14);
  assign z4 = (~new_n36_ & (new_n71_ | x08)) | new_n61_ | (~new_n63_ & (new_n72_ | ~x08));
