...
module FAU ( 
  ...
  assign z6 = (~new_n73_ & ~x03) | ~new_n72_ | (~new_n36_ & (x03 | (x06 & ~x11)));
  assign new_n72_ = (x06 | ~x20) & (new_n59_ | ~x11 | (x06 & (~x14 | x20)));
  assign new_n73_ = (x05 | (x13 ? (~x18 | ~x24) : ~x15)) & (~new_n60_ | x24) & (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24)));
