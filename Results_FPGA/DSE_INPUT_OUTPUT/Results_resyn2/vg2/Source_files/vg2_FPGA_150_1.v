...
module FAU ( 
  ...
  assign new_n56_ = new_n57_ & new_n47_ & new_n58_;
  ...
  assign z3 = new_n65_ | new_n67_ | new_n68_;
  assign new_n65_ = ~x24 & ((~new_n44_ & new_n62_) | (~new_n48_ & new_n66_));
  assign new_n66_ = new_n58_ & ~x20 & ~x01 & ~x03;
  assign new_n67_ = ~new_n52_ & x24 & ((new_n62_ & x18) | (new_n66_ & x07));
  assign new_n68_ = new_n52_ & ((new_n62_ & x15) | (new_n66_ & x19));
  assign z4 = (~new_n36_ & (new_n70_ | x08)) | ((new_n71_ | ~x08) & (~new_n61_ | (~x08 & x20)));
  ...
  assign new_n74_ = ~new_n59_ & ((~new_n36_ & (x03 | (x06 & ~x11))) | (~new_n61_ & (~x03 | (~x06 & x11))));
  assign new_n75_ = (x24 | (~new_n76_ & (new_n78_ | ~x05 | ~x13))) & (new_n79_ | ~x24 | (~x05 & ~x13)) & (new_n78_ | x05 | x13);
  assign new_n76_ = ~new_n77_ & ~x02 & ~x10;
  assign new_n77_ = (x11 | x14 | ~x00 | ~x08 | ~x20) & (x20 | ~x21 | ~x11 | ~x14);
  assign new_n78_ = (~x15 | x20 | ~x11 | ~x14) & (x11 | x14 | ~x19 | ~x08 | ~x20);
  assign new_n79_ = (x11 | x14 | ~x07 | ~x08 | ~x20) & (~x11 | ~x14 | ~x18 | x20);
