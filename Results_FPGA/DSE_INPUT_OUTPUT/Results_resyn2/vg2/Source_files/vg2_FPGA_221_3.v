...
module FAU ( 
  ...
  assign z4 = (~new_n36_ & (new_n48_ | x08)) | z2 | (~new_n46_ & (new_n49_ | ~x08));
  assign new_n46_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n47_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  ...
  assign z6 = (~new_n52_ & ~x24) | (~new_n57_ & x24) | ~new_n60_ | (~new_n36_ & ~new_n61_);
  assign new_n52_ = (~x11 | ((~new_n53_ | ~new_n54_) & (new_n55_ | (~new_n54_ & x06)))) & (new_n55_ | ~new_n56_);
  assign new_n53_ = x15 & ~x05 & ~x13;
  assign new_n54_ = x14 & ~x20;
  assign new_n55_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n56_ = ~x03 & (~x06 | ~x20);
  assign new_n57_ = (new_n58_ | ~x18 | (~x05 & ~x13)) & (~new_n59_ | ~x15 | x05 | x13);
  assign new_n58_ = (x03 | (x06 & x20)) & (~x11 | (x06 & (~x03 | ~x14)));
  assign new_n59_ = x11 & x03 & x14;
  assign new_n60_ = (~x06 | ~x20) & (~new_n53_ | (x03 & (x06 | ~x11)));
  assign new_n61_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
