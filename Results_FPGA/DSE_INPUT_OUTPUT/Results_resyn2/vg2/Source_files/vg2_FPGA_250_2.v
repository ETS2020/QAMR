...
module FAU ( 
  ...
  assign z1 = (~new_n41_ & ~x24) | ~new_n52_ | (~new_n50_ & x24 & (x05 | x13));
  assign new_n41_ = ~new_n44_ & (new_n42_ | ~new_n43_ | ~new_n38_ | ~new_n49_);
  assign new_n42_ = ~new_n37_ & (~x13 | ~x05 | ~x19);
  ...
  assign new_n48_ = (~x05 | ~x13 | ~x15) & (~x21 | x02 | x10);
  assign new_n49_ = ~x06 & ~x08 & ~x09 & ~x12;
  assign new_n50_ = (~new_n43_ | ~new_n51_) & (~new_n47_ | ~new_n46_ | ~new_n45_ | ~x18);
  assign new_n51_ = new_n38_ & ~x06 & x07 & ~x08 & ~x09 & ~x12;
  assign new_n52_ = ~new_n56_ & (x05 | x13 | (~new_n54_ & (~new_n43_ | ~new_n53_)));
  assign new_n53_ = new_n49_ & ~x11 & ~x14 & x19 & ~x20;
  assign new_n54_ = new_n55_ & new_n45_ & new_n46_;
  assign new_n55_ = x11 & x04 & x09 & x15 & x16 & x17;
  assign new_n56_ = x06 & ~x20;
  assign z2 = ~new_n58_ & new_n61_ & x06;
  assign new_n58_ = new_n59_ & (~x13 | ~x18 | ~x24);
  assign new_n59_ = (~x05 | (x24 ? ~x18 : (~x13 | ~x15))) & (~new_n60_ | x24) & (~x15 | x05 | x13);
  assign new_n60_ = x21 & ~x02 & ~x10;
  assign new_n61_ = x01 & x03 & x20 & x11 & x14;
  assign z3 = ~new_n63_ | (~new_n66_ & ~x05 & ~x13) | (~new_n68_ & x24 & (x05 | x13));
  assign new_n63_ = ~new_n56_ & (x24 | ((~new_n64_ | new_n48_) & (new_n42_ | ~new_n65_)));
  ...
  assign z4 = (~new_n36_ & (new_n70_ | x08)) | new_n56_ | (~new_n58_ & (new_n71_ | ~x08));
  assign new_n70_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n71_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | new_n56_;
  assign z6 = ~new_n74_ | (~new_n78_ & x13);
  assign new_n74_ = (new_n59_ | new_n77_) & ~new_n56_ & (new_n75_ | new_n76_);
  assign new_n75_ = (~new_n37_ | x24) & (~x05 | ~x07 | ~x24) & (~x19 | x05 | x13);
