// Benchmark "FAU" written by ABC on Thu Aug 13 18:48:28 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n77_;
  assign z0 = ~new_n36_ & ~x06;
  assign new_n36_ = ~x20 & (new_n37_ | x01 | x03 | x11 | x14);
  ...
  assign new_n55_ = new_n43_ & new_n44_ & new_n56_ & x19 & ~x14 & ~x17;
  ...
  assign z3 = (~new_n65_ & ~x24) | (~new_n71_ & ~new_n50_ & x24) | new_n57_ | (~new_n67_ & new_n50_);
  assign new_n65_ = (new_n41_ | ~new_n66_) & (~new_n62_ | new_n58_ | ~x08);
  assign new_n66_ = ~x06 & ~x08 & ~x01 & ~x03 & ~x11 & ~x14;
  assign new_n67_ = ~new_n68_ & (~new_n70_ | ~new_n63_ | ~x15);
  assign new_n68_ = new_n69_ & x19 & ~x01 & ~x03;
  assign new_n69_ = ~x06 & ~x08 & ~x11 & ~x14;
  assign new_n70_ = x06 & x08 & x01 & x03;
  assign new_n71_ = (~new_n66_ | ~x07) & (~new_n70_ | ~new_n63_ | ~x18);
  assign z4 = ~new_n57_ & ((~new_n37_ & (new_n73_ | x08)) | (~new_n61_ & (new_n74_ | ~x08)));
  assign new_n73_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n74_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & ~new_n57_;
  assign z6 = ~new_n77_ | (~new_n37_ & (x03 | (x06 & ~x11)));
  assign new_n77_ = (x06 | ~x20) & (new_n61_ | (x03 & (~x11 | (x06 & (~x14 | x20)))));
