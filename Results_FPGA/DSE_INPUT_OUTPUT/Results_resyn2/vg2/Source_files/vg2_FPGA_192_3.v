...
module FAU ( 
  ...
  assign new_n40_ = new_n42_ & new_n41_ & ~x16 & ~x17 & ~x11 & ~x12;
  assign new_n41_ = ~x01 & ~x03 & ~x14 & ~x20;
  assign new_n42_ = ~x22 & ~x23 & ~x04 & ~x06 & ~x08 & ~x09;
  ...
  assign z4 = (~new_n45_ & (new_n56_ | ~x08)) | new_n43_ | (~new_n36_ & (new_n57_ | x08));
  assign new_n56_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n57_ = ~x16 & ((x04 & ~x22 & ~x23) | x09 | (x17 & ~x22));
  assign z5 = ~new_n36_ & ~new_n43_;
  assign z6 = (~new_n36_ & (new_n60_ | x03)) | new_n43_ | (~new_n45_ & (new_n61_ | ~x03));
