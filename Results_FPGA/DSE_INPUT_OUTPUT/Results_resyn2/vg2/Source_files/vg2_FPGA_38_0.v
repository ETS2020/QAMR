...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_, new_n43_,
    ...
    new_n70_, new_n71_;
  assign z0 = ~x20 & (~x12 | (~new_n36_ & new_n40_));
  ...
  assign z2 = new_n49_ | (~new_n42_ & new_n51_ & x01 & x03 & x06);
  assign new_n51_ = x20 & x11 & x14;
  assign z3 = (~new_n53_ & ~x05 & ~x13) | (~new_n55_ & x24 & (x05 | x13)) | (~new_n56_ & ~x24);
  assign new_n53_ = (~x19 | ~new_n40_ | ~new_n54_) & (~new_n47_ | ~new_n51_ | ~x15);
  assign new_n54_ = ~x20 & ~x08 & x12;
  assign new_n55_ = (~x07 | ~new_n40_ | ~new_n54_) & (~new_n47_ | ~new_n51_ | ~x18);
  assign new_n56_ = (new_n57_ | ~new_n40_ | ~new_n54_) & (new_n58_ | ~new_n47_ | ~new_n51_);
  assign new_n57_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n58_ = (x02 | x10 | ~x21) & (~x15 | ~x05 | ~x13);
  assign z4 = (~new_n42_ & (new_n60_ | ~x08)) | new_n49_ | (~new_n36_ & (new_n61_ | x08));
  assign new_n60_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n61_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n49_;
  assign z6 = (~new_n49_ & (new_n64_ | new_n65_)) | new_n66_ | ~new_n70_;
  assign new_n64_ = (new_n37_ | new_n38_ | ~new_n39_) & (x03 | (x06 & ~x11));
  assign new_n65_ = (new_n43_ | new_n44_ | ~new_n45_) & (~x03 | (~x06 & x11));
  assign new_n66_ = ~x24 & ((~new_n68_ & ~x02 & ~x10) | (new_n67_ & ~new_n69_));
  assign new_n67_ = x05 & x13;
  assign new_n68_ = (x14 | ~x20 | ~x00 | x11) & (~x14 | x20 | ~x21 | ~x11 | ~x12);
  assign new_n69_ = (x14 | ~x20 | x11 | ~x19) & (~x14 | x20 | ~x15 | ~x11 | ~x12);
  assign new_n70_ = (new_n71_ | ~x24 | (~x05 & ~x13)) & (new_n69_ | x05 | x13);
  assign new_n71_ = (x14 | ~x20 | ~x07 | x11) & (~x14 | x20 | ~x18 | ~x11 | ~x12);
