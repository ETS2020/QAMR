...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n44_, new_n45_,
    ...
    new_n55_, new_n56_;
  assign z0 = new_n38_ & ~new_n36_ & ~x20;
  ...
  assign z3 = ~x08 & new_n38_ & ~new_n36_ & ~x20;
  assign z4 = ~new_n46_ & ((~new_n36_ & (new_n47_ | x08)) | (~new_n44_ & (new_n48_ | ~x08)));
  assign new_n44_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & ~new_n45_ & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  ...
  assign z6 = (~new_n51_ & ~new_n46_) | (new_n55_ & ~new_n36_ & ~new_n46_) | (~new_n44_ & new_n56_);
  assign new_n51_ = (x24 | (~new_n53_ & (~new_n52_ | ~x05 | ~x13))) & (~new_n52_ | x05 | x13) & (~new_n54_ | ~x24 | (~x05 & ~x13));
  assign new_n52_ = x03 ? x19 : x15;
