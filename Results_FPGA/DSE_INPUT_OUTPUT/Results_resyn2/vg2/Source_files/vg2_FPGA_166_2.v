...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n50_ | ~new_n53_;
  assign new_n40_ = ~x24 & (new_n44_ | (new_n41_ & (new_n37_ | (new_n49_ & x19))));
  assign new_n41_ = new_n43_ & new_n42_ & ~x23 & ~x14 & ~x22;
  assign new_n42_ = ~x01 & ~x03 & ~x04 & ~x12;
  assign new_n43_ = ~x11 & ~x08 & ~x09 & ~x20 & ~x16 & ~x17;
  assign new_n44_ = ~new_n45_ & new_n47_ & new_n48_ & new_n46_ & x16 & x17;
  assign new_n45_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n46_ = x11 & x04 & x09;
  assign new_n47_ = x06 & x08 & x01 & x03;
  assign new_n48_ = x22 & x23 & x12 & x14;
  assign new_n49_ = x05 & x13;
  assign new_n50_ = ~new_n52_ & x24 & (new_n51_ | (new_n41_ & x07));
  assign new_n51_ = new_n46_ & new_n47_ & new_n48_ & x18 & x16 & x17;
  assign new_n52_ = ~x05 & ~x13;
  assign new_n53_ = ~new_n58_ & (~new_n52_ | (~new_n55_ & (~new_n54_ | ~new_n56_)));
  assign new_n54_ = new_n42_ & ~x23 & ~x14 & ~x22;
  assign new_n55_ = new_n46_ & new_n47_ & new_n48_ & x15 & x16 & x17;
  assign new_n56_ = new_n57_ & ~x11 & ~x08 & ~x09;
  assign new_n57_ = ~x16 & ~x17 & x19 & ~x20;
  assign new_n58_ = x06 & ~x20;
  assign z2 = ~new_n60_ & x06;
  assign new_n60_ = x20 & (new_n61_ | ~x11 | ~x14 | ~x01 | ~x03);
  assign new_n61_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n62_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n62_ = x21 & ~x02 & ~x10;
  assign z3 = new_n67_ | new_n68_ | (~new_n64_ & ~x24);
  assign new_n64_ = (~new_n65_ | new_n45_) & (~new_n66_ | (~new_n37_ & (~new_n49_ | ~x19)));
  assign new_n65_ = new_n47_ & x20 & x11 & x14;
  assign new_n66_ = new_n38_ & ~x20 & ~x06 & ~x08;
  assign new_n67_ = ~new_n52_ & x24 & ((new_n66_ & x07) | (new_n65_ & x18));
  assign new_n68_ = new_n52_ & ((new_n65_ & x15) | (new_n66_ & x19));
  assign z4 = (~new_n61_ & (new_n70_ | ~x08)) | new_n58_ | (~new_n36_ & (new_n71_ | x08));
  ...
  assign new_n74_ = (new_n61_ | x06 | ~x11) & (new_n36_ | (~x06 & x14) | x11 | ~x20);
  assign new_n75_ = ~new_n77_ & (~new_n49_ | ~new_n76_);
  assign new_n76_ = x03 ? x19 : x15;
  assign new_n77_ = (x00 | ~x03) & ~x02 & ~x10 & (x03 | x21);
  assign new_n78_ = (~new_n52_ | ~new_n76_) & (new_n52_ | ~x24 | (x03 & ~x07) | (~x03 & ~x18));
