...
module FAU ( 
  ...
  wire new_n37_, new_n38_, new_n39_, new_n40_, new_n41_, new_n45_, new_n46_,
    ...
    new_n56_;
  assign z0 = ~x06 & ~x20;
  assign z1 = ~new_n37_ & new_n39_ & new_n41_ & x23 & x20 & x22;
  assign new_n37_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & ~new_n38_ & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n38_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n39_ = new_n40_ & x16 & x17 & x09 & x12;
  assign new_n40_ = x11 & x14 & x04 & x08;
  assign new_n41_ = x06 & x01 & x03;
  assign z2 = ~new_n37_ & new_n41_ & x20 & x11 & x14;
  assign z3 = x08 & ~new_n37_ & new_n41_ & x20 & x11 & x14;
  ...
  assign z6 = (new_n55_ & ~new_n37_ & ~z0) | (~new_n51_ & ~z0) | (~new_n45_ & new_n56_);
