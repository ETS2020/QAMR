...
module FAU ( 
  ...
  assign z3 = (~x24 & (new_n49_ | new_n52_)) | new_n53_ | new_n56_ | new_n47_;
  assign new_n49_ = ~new_n51_ & new_n38_ & new_n50_;
  assign new_n50_ = ~x06 & ~x08 & ~x01 & ~x03;
  assign new_n51_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n52_ = new_n45_ & new_n43_ & (new_n41_ | (x15 & x05 & x13));
  assign new_n53_ = new_n55_ & ((x07 & new_n38_ & new_n50_) | (new_n45_ & new_n54_));
  assign new_n54_ = x18 & x20 & x11 & x14;
  assign new_n55_ = x24 & (x05 | x13);
  assign new_n56_ = new_n57_ & ((new_n45_ & new_n58_) | (x19 & new_n38_ & new_n50_));
  assign new_n57_ = ~x05 & ~x13;
  assign new_n58_ = x15 & x20 & x11 & x14;
  assign z4 = (~new_n36_ & (new_n60_ | x08)) | new_n47_ | (~new_n40_ & (new_n61_ | ~x08));
  assign new_n60_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n61_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | new_n47_;
  assign z6 = (~new_n36_ & (new_n64_ | x03)) | new_n47_ | (~new_n40_ & (new_n65_ | ~x03));
