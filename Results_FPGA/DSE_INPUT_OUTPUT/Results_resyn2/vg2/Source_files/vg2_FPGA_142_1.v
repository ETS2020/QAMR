...
module FAU ( 
  ...
  assign new_n47_ = ~new_n48_ & new_n49_ & new_n50_ & new_n51_ & x12 & x16;
  ...
  assign z2 = x20 & (new_n61_ | ~x16);
  assign new_n61_ = ~new_n62_ & new_n51_ & x01 & x03 & x06;
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n63_ | x24) & (~x15 | x05 | x13) & (~x13 | ~x18 | ~x24);
  assign new_n63_ = x21 & ~x02 & ~x10;
  assign z3 = (~new_n65_ & ~x24) | (~new_n67_ & new_n59_) | new_n38_ | (~new_n68_ & ~new_n59_ & x24);
  assign new_n65_ = (~new_n66_ | new_n48_) & (new_n46_ | ~new_n40_ | ~new_n39_ | x08);
  assign new_n66_ = x01 & x03 & x06 & x08 & new_n51_ & x20;
  assign new_n67_ = (~new_n66_ | ~x15) & (~new_n57_ | ~new_n39_ | x11 | x14);
  assign new_n68_ = (~new_n66_ | ~x18) & (~new_n40_ | ~x07 | ~new_n39_ | x08);
  assign z4 = (~new_n36_ & (new_n70_ | x08)) | new_n38_ | (~new_n62_ & (new_n71_ | ~x08));
  assign new_n70_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n71_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n36_ | new_n38_;
  assign z6 = (~new_n36_ & (new_n74_ | x03)) | new_n38_ | (~new_n62_ & (new_n75_ | ~x03));
