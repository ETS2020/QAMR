...
module FAU ( 
  ...
  assign z4 = ~z2 & ((~new_n36_ & (new_n50_ | x08)) | (~new_n46_ & (new_n51_ | ~x08)));
  assign new_n46_ = ~new_n47_ & new_n49_ & (~new_n48_ | x24);
  ...
  assign z6 = new_n59_ | new_n63_ | (~z2 & (new_n54_ | ~new_n57_));
  assign new_n54_ = ~x24 & ((~new_n56_ & ~x03) | (~new_n55_ & (x03 | (x06 & ~x11))));
  assign new_n55_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n56_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n57_ = ~new_n58_ & ((x03 & ~x19) | x05 | x13 | (~x03 & ~x15));
  assign new_n58_ = x24 & (x05 | x13) & (~x03 | x07) & (x03 | x18);
  assign new_n59_ = ~x11 & ((~new_n60_ & new_n61_) | (~new_n55_ & new_n62_));
  assign new_n60_ = (~x05 & ~x13) ? ~x19 : (~x07 | ~x24);
  assign new_n61_ = x20 ? ~x14 : x06;
  assign new_n62_ = ~x24 & ~x14 & x20;
  assign new_n63_ = new_n64_ & ~z2 & (new_n47_ | ~new_n49_ | (new_n48_ & ~x24));
  assign new_n64_ = x11 & (~x06 | x14);
