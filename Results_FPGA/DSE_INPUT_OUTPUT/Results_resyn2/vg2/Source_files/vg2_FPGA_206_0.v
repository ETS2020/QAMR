...
module FAU ( 
  ...
  assign z4 = (~new_n40_ & ~new_n61_) | ((new_n64_ | x08) & ~new_n36_ & ~new_n63_);
  assign new_n61_ = ((~x20 & ~x22) | (x08 & (x09 | ~x16))) & (new_n62_ | ~x16 | ~x22);
  assign new_n62_ = x17 & (x04 | ~x23);
  assign new_n63_ = ~x20 & ~x22;
  assign new_n64_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n63_;
  assign z6 = (~new_n40_ & (new_n67_ | ~x03)) | new_n63_ | (~new_n36_ & (new_n68_ | x03));
