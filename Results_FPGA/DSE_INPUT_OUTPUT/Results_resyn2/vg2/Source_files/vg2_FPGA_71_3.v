...
module FAU ( 
  ...
  assign z2 = ~new_n45_ & new_n47_ & x20 & x14 & ~x16;
  ...
  assign z3 = (~new_n49_ & ~x24) | (~new_n53_ & ~new_n60_ & x24) | new_n38_ | (~new_n56_ & new_n60_);
  assign new_n49_ = (new_n50_ | ~new_n47_ | ~new_n51_) & (new_n52_ | ~new_n39_ | x08);
  assign new_n50_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n51_ = x20 & x08 & x14;
  assign new_n52_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n53_ = (~new_n39_ | ~x07 | x08) & (~new_n54_ | ~new_n55_);
  assign new_n54_ = x01 & x03 & x06 & x08;
  assign new_n55_ = x11 & x14 & x18 & x20;
  assign new_n56_ = (~new_n54_ | ~new_n58_) & (~new_n57_ | ~new_n59_);
  assign new_n57_ = ~x01 & ~x03 & ~x06 & ~x11;
  assign new_n58_ = x11 & x14 & x15 & x20;
  assign new_n59_ = ~x14 & ~x20 & ~x08 & x19;
  assign new_n60_ = ~x05 & ~x13;
  assign z4 = (~new_n62_ & ~new_n38_) | (~new_n36_ & new_n68_) | (~new_n45_ & new_n66_);
  assign new_n62_ = (x24 | (~new_n64_ & (~new_n63_ | ~x05 | ~x13))) & (~new_n63_ | x05 | x13) & (~new_n65_ | ~x24 | (~x05 & ~x13));
  assign new_n63_ = x08 ? x19 : x15;
  assign new_n64_ = (x00 | ~x08) & ~x02 & ~x10 & (x08 | x21);
  assign new_n65_ = x08 ? x07 : x18;
  assign new_n66_ = ~new_n67_ & x16 & ~x20;
  assign new_n67_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n68_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ | new_n38_;
  assign z6 = (~new_n36_ & (new_n71_ | x03)) | new_n38_ | (~new_n45_ & (new_n72_ | ~x03));
