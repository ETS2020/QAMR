...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n67_, new_n69_, new_n70_, new_n71_, new_n74_;
  ...
  assign z1 = (~new_n40_ & ~x24) | new_n51_ | new_n54_ | (x06 & ~x20);
  assign new_n40_ = ~new_n46_ & (~new_n41_ | ~new_n44_);
  assign new_n41_ = new_n43_ & new_n42_ & ~x23 & ~x17 & ~x22;
  assign new_n42_ = ~x01 & ~x03 & ~x04 & ~x16;
  assign new_n43_ = ~x08 & ~x09 & ~x12;
  assign new_n44_ = ~new_n45_ & ~x11 & ~x14 & ~x06 & ~x20;
  assign new_n45_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n46_ = ~new_n47_ & new_n49_ & new_n50_ & new_n48_ & x16 & x17;
  ...
  assign new_n51_ = x24 & (x05 | x13) & (new_n52_ | (new_n41_ & new_n53_));
  assign new_n52_ = new_n48_ & new_n49_ & new_n50_ & x18 & x16 & x17;
  assign new_n53_ = x07 & ~x11 & ~x14 & ~x06 & ~x20;
  assign new_n54_ = ~x05 & ~x13 & (new_n56_ | (new_n55_ & new_n57_ & new_n58_));
  assign new_n55_ = new_n42_ & ~x23 & ~x17 & ~x22;
  assign new_n56_ = new_n48_ & new_n49_ & new_n50_ & x15 & x16 & x17;
  assign new_n57_ = ~x06 & ~x20 & ~x08 & x19;
  assign new_n58_ = ~x11 & ~x14 & ~x09 & ~x12;
  ...
  assign z3 = (~new_n64_ & ~x24) | (~new_n66_ & ~x05 & ~x13) | (~new_n67_ & x24 & (x05 | x13));
  assign new_n64_ = (~new_n65_ | new_n47_) & (~new_n44_ | ~new_n38_ | x08);
  assign new_n65_ = new_n49_ & x20 & x11 & x14;
  assign new_n66_ = (~new_n65_ | ~x15) & (~new_n57_ | ~new_n38_ | x11 | x14);
  assign new_n67_ = (~new_n65_ | ~x18) & (~new_n53_ | ~new_n38_ | x08);
  ...
  assign z6 = new_n74_ | (x06 & ~x20) | (~new_n61_ & (~x03 | (~x06 & x11)));
