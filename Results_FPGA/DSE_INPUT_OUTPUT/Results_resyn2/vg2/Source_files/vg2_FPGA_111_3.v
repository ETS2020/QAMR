...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n44_,
    ...
    new_n53_, new_n54_, new_n56_, new_n57_, new_n58_, new_n59_, new_n62_,
    new_n63_;
  ...
  assign z2 = ~new_n44_ & new_n46_ & x11 & x14 & x20;
  ...
  assign z3 = (~new_n48_ & x24 & (x05 | x13)) | (~new_n51_ & ~x05 & ~x13) | (~new_n52_ & ~x24);
  assign new_n48_ = (~x18 | ~new_n46_ | ~new_n49_) & (~x07 | ~new_n38_ | ~new_n50_);
  assign new_n49_ = x08 & x11 & x14 & x20;
  assign new_n50_ = ~x08 & ~x14 & ~x20;
  assign new_n51_ = (~x15 | ~new_n46_ | ~new_n49_) & (~x19 | ~new_n38_ | ~new_n50_);
  assign new_n52_ = (new_n53_ | ~new_n46_ | ~new_n49_) & (new_n54_ | ~new_n38_ | ~new_n50_);
  assign new_n53_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n54_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign z4 = (~new_n44_ & ~new_n56_) | ((new_n59_ | x08) & ~new_n36_ & ~new_n58_);
  assign new_n56_ = (new_n57_ | (x04 & x20)) & (~x22 | ~x23 | x04 | ~x16);
  assign new_n57_ = x08 & (~x16 | (x09 & (x17 | ~x22)));
  assign new_n58_ = x04 & x20;
  assign new_n59_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n58_;
  assign z6 = (~new_n36_ & (new_n62_ | x03)) | new_n58_ | (~new_n44_ & (new_n63_ | ~x03));
  assign new_n62_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n63_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n44_ & ~new_n58_;
endmodule
