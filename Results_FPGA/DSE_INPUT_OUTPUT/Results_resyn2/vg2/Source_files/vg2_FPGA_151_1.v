...
module FAU ( 
  ...
  assign z2 = x20 & (~x06 | (~new_n62_ & new_n63_));
  assign new_n62_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n45_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n63_ = x11 & x14 & x01 & x03;
  assign z3 = (~new_n65_ & ~x24) | new_n67_ | (~new_n68_ & ~x05 & ~x13);
  assign new_n65_ = (new_n44_ | ~new_n66_) & (~new_n49_ | ~new_n38_ | x08);
  assign new_n66_ = new_n63_ & x20 & x06 & x08;
  assign new_n67_ = new_n53_ & ((new_n66_ & x18) | (new_n52_ & new_n38_ & ~x08));
  assign new_n68_ = (~new_n66_ | ~x15) & (~new_n60_ | ~new_n38_ | x11 | x14);
