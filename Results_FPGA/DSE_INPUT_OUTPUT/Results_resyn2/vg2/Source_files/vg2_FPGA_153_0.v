...
module FAU ( 
  ...
  assign z0 = ~x20 & (~x16 | (~new_n36_ & new_n38_ & ~x14));
  ...
  assign new_n43_ = x08 & x09 & x04 & x06 & x01 & x03;
  assign new_n44_ = x14 & x16 & x11 & x12;
  assign z2 = (~x16 & ~x20) | (~new_n40_ & new_n46_ & x14 & x20);
  assign new_n46_ = x06 & x11 & x01 & x03;
  assign z3 = (~new_n48_ & ~x24) | (~new_n53_ & x24 & (x05 | x13)) | (~new_n54_ & ~x05 & ~x13);
  assign new_n48_ = (new_n50_ | ~new_n38_ | ~new_n49_) & (new_n51_ | ~new_n46_ | ~new_n52_);
  assign new_n49_ = ~x08 & ~x14 & x16 & ~x20;
  assign new_n50_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n51_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n52_ = x08 & x14 & x20;
  assign new_n53_ = (~x07 | ~new_n38_ | ~new_n49_) & (~new_n52_ | ~new_n46_ | ~x18);
  assign new_n54_ = (~x19 | ~new_n38_ | ~new_n49_) & (~new_n52_ | ~new_n46_ | ~x15);
  assign z4 = (~new_n56_ & ~new_n62_) | (~new_n36_ & new_n60_) | (~new_n40_ & new_n63_);
  assign new_n56_ = (x24 | (~new_n58_ & (~new_n57_ | ~x05 | ~x13))) & (~new_n57_ | x05 | x13) & (~new_n59_ | ~x24 | (~x05 & ~x13));
  assign new_n57_ = x08 ? x19 : x15;
  assign new_n58_ = (x00 | ~x08) & ~x02 & ~x10 & (x08 | x21);
  assign new_n59_ = x08 ? x07 : x18;
  assign new_n60_ = ~new_n61_ & ~x16 & x20;
