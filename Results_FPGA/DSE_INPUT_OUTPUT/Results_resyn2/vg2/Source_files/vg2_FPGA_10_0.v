...
module FAU ( 
  ...
  wire new_n37_, new_n38_, new_n39_, new_n40_, new_n41_, new_n45_, new_n46_,
    ...
    new_n56_;
  assign z0 = ~x06 & ~x20;
  assign z1 = new_n39_ & x08 & ~new_n37_ & new_n41_;
  assign new_n37_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & ~new_n38_ & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n38_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n39_ = new_n40_ & x23 & x17 & x22;
  assign new_n40_ = x04 & x09 & x12 & x16;
  assign new_n41_ = x01 & x03 & x14 & x20 & x06 & x11;
  assign z2 = z0 | (~new_n37_ & new_n41_);
  assign z3 = x08 & ~new_n37_ & new_n41_;
