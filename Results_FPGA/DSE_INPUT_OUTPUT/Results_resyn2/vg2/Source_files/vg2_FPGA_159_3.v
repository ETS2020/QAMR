...
module FAU ( 
  ...
  assign new_n38_ = x01 & x20;
  assign new_n39_ = ~x01 & ~x03 & ~x06 & ~x20 & ~x11 & ~x14;
  assign z1 = new_n38_ | (~new_n36_ & new_n41_);
  assign new_n41_ = new_n39_ & new_n42_ & ~x16 & ~x17 & ~x22 & ~x23;
  assign new_n42_ = ~x04 & ~x08 & ~x09 & ~x12;
  assign z3 = ~x08 & ~new_n36_ & new_n39_;
  assign z4 = ~new_n38_ & ((~new_n36_ & (new_n47_ | x08)) | (~new_n45_ & (new_n48_ | ~x08)));
  assign new_n45_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & ~new_n46_ & (~x15 | x05 | x13) & (~x13 | ~x18 | ~x24);
  ...
  assign z6 = (~new_n36_ & (new_n51_ | x03)) | new_n38_ | (~new_n45_ & (new_n52_ | ~x03));
