// Benchmark "FAU" written by ABC on Thu Aug 13 18:48:37 2020
...
module FAU ( 
  ...
  assign z4 = ~z2 & ((~new_n36_ & (new_n49_ | x08)) | (~new_n47_ & (new_n50_ | ~x08)));
  assign new_n47_ = ~new_n48_ & (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  ...
  assign z6 = (~new_n47_ & new_n56_) | new_n53_ | z2 | (~new_n36_ & ~new_n57_);
  assign new_n53_ = ~x03 & (new_n55_ | new_n54_ | new_n48_);
