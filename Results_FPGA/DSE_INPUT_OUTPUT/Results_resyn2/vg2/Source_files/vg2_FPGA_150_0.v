...
module FAU ( 
  ...
  assign z4 = (~new_n36_ & (new_n52_ | x08)) | ((new_n53_ | ~x08) & (~new_n42_ | (~x08 & ~x20)));
  ...
  assign new_n57_ = (new_n43_ | new_n44_ | ~new_n45_) & (~x03 | (~x06 & x11));
  assign new_n58_ = ~x24 & ((new_n59_ & ~new_n60_) | (~new_n61_ & x05 & x13));
  assign new_n59_ = ~x02 & ~x10;
  assign new_n60_ = (x11 | x14 | ~x00 | ~x20) & (~x14 | x20 | ~x21 | ~x08 | ~x11);
  assign new_n61_ = (x11 | x14 | ~x19 | ~x20) & (~x14 | x20 | ~x15 | ~x08 | ~x11);
  assign new_n62_ = (new_n61_ | x05 | x13) & (new_n63_ | ~x24 | (~x05 & ~x13));
  assign new_n63_ = (x11 | x14 | ~x07 | ~x20) & (~x14 | x20 | ~x18 | ~x08 | ~x11);
