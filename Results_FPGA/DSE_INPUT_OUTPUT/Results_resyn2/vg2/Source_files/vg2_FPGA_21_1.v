...
module FAU ( 
  ...
  assign new_n38_ = ~x11 & ~x14 & ~x06 & ~x20 & ~x01 & ~x03;
  assign z1 = new_n40_ | new_n51_ | new_n58_ | (new_n53_ & (new_n54_ | new_n57_));
  ...
  assign new_n47_ = new_n48_ & ~x12 & ~x08 & ~x09;
  assign new_n48_ = ~x11 & ~x14 & ~x06 & ~x20;
  ...
  assign new_n57_ = new_n49_ & new_n48_ & ~x08 & ~x09 & ~x12 & x19;
  assign new_n58_ = ~x06 & x20;
  assign z2 = x20 & ((~new_n60_ & new_n61_) | ~x06);
  assign new_n60_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (~new_n45_ | x24) & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n61_ = x11 & x14 & x01 & x03;
  assign z3 = new_n63_ | new_n66_ | new_n67_;
  assign new_n63_ = new_n52_ & ((new_n65_ & x07) | (new_n64_ & x18));
  assign new_n64_ = new_n61_ & x20 & x06 & x08;
  assign new_n65_ = new_n38_ & ~x08;
  assign new_n66_ = ~x24 & ((~new_n44_ & new_n64_) | (~new_n46_ & new_n65_));
  assign new_n67_ = new_n53_ & ((new_n65_ & x19) | (new_n64_ & x15));
  assign z4 = (~new_n36_ & (new_n69_ | x08)) | new_n58_ | (~new_n60_ & (new_n70_ | ~x08));
