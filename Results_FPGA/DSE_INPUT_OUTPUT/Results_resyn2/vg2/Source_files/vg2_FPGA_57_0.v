...
module FAU ( 
  ...
  assign new_n49_ = ~x08 & ~x14 & ~x20 & x22;
  ...
  assign z4 = ((new_n61_ | x08) & ~new_n36_ & ~new_n62_) | (~new_n40_ & ~new_n62_ & (new_n63_ | ~x08));
  ...
  assign z6 = (~new_n36_ & (new_n66_ | x03)) | new_n62_ | (~new_n40_ & (new_n67_ | ~x03));
  assign new_n66_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n67_ = x11 & (~x06 | (x14 & ~x20));
  assign z7 = ~new_n40_ & ~new_n62_;
endmodule
