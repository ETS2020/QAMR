...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n46_,
  ...
  assign z1 = z2 | (z0 & new_n41_);
  assign new_n41_ = new_n42_ & ~x16 & ~x17 & ~x22 & ~x23;
  assign new_n42_ = ~x04 & ~x08 & ~x09 & ~x12;
  assign z2 = x06 & x20;
  assign z3 = z0 & ~x08;
  assign z4 = ~z2 & ((~new_n46_ & (new_n49_ | x08)) | (~new_n47_ & (new_n50_ | ~x08)));
  ...
  assign z5 = ~new_n46_ | z2;
  assign z6 = (~new_n53_ & ~z2) | (~new_n46_ & new_n58_) | (~new_n47_ & new_n57_);
  assign new_n53_ = (x24 | (~new_n54_ & (~new_n55_ | ~x05 | ~x13))) & (~new_n55_ | x05 | x13) & (~new_n56_ | ~x24 | (~x05 & ~x13));
  assign new_n54_ = (x00 | ~x03) & ~x02 & ~x10 & (x03 | x21);
  assign new_n55_ = x03 ? x19 : x15;
  assign new_n56_ = x03 ? x07 : x18;
  assign new_n57_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n58_ = (x06 | (~x14 & x20)) & ~x11 & (~x06 | ~x20);
