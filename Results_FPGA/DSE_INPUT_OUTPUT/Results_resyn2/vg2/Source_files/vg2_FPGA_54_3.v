...
module FAU ( 
  ...
  assign z1 = (~new_n36_ & new_n40_) | new_n42_;
  ...
  assign z6 = (~new_n45_ & new_n54_) | new_n51_ | new_n42_ | (~new_n36_ & ~new_n55_);
  assign new_n51_ = ~x03 & (new_n53_ | new_n52_ | new_n46_);
  assign new_n52_ = x05 & ((x18 & x24) | (x15 & x13 & ~x24));
  assign new_n53_ = ~x05 & (x13 ? (x18 & x24) : x15);
  assign new_n54_ = x11 & (~x06 | x14);
