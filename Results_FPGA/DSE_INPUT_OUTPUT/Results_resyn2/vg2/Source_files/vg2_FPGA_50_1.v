...
module FAU ( 
  ...
  assign z2 = ~new_n59_ & x06 & new_n50_ & x20 & x01 & x03;
  ...
  assign new_n62_ = (~new_n63_ | ~x18) & (~new_n39_ | ~x07 | ~new_n38_ | x08);
  assign new_n63_ = x06 & x08 & new_n50_ & x01 & x03 & x20;
  assign new_n64_ = (~new_n63_ | ~x15) & (~new_n57_ | ~new_n38_ | x11 | x14);
  assign new_n65_ = (~new_n63_ | new_n47_) & (new_n45_ | ~new_n39_ | ~new_n38_ | x08);
  ...
  assign z6 = (~new_n72_ & (x14 | ~x20)) | (~new_n59_ & ~x20 & x11 & x14);
