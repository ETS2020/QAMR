...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n45_,
    ...
    new_n55_, new_n56_;
  assign z0 = (x14 & x20) | (~new_n36_ & new_n38_ & ~x06 & ~x20 & ~x11 & ~x14);
  ...
  assign z6 = new_n54_ | (~new_n55_ & ~x03) | new_n49_ | (~new_n36_ & (new_n56_ | x03));
  assign new_n54_ = (~new_n48_ | new_n46_ | new_n47_) & x11 & (~x06 | x14);
  assign new_n55_ = ~new_n47_ & (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & (x05 | (x13 ? (~x18 | ~x24) : ~x15));
  assign new_n56_ = ~x11 & (x06 | x20);
  assign z7 = ~new_n45_ | new_n49_;
  assign z2 = 1'b0;
endmodule
