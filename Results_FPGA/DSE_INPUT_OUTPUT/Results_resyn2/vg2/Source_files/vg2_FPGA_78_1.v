...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n42_, new_n43_,
    ...
    new_n52_, new_n53_, new_n57_, new_n58_, new_n59_, new_n60_, new_n63_,
    new_n64_;
  ...
  assign new_n41_ = new_n43_ & (x24 | (~new_n42_ & (~x05 | ~x13 | ~x19)));
  assign new_n42_ = (x05 | ~x21) & ~x10 & x00 & ~x02;
  assign new_n43_ = (x21 | ((~x13 | ~x07 | ~x24) & (~x19 | x05 | x13))) & (~x05 | ~x07 | ~x24);
  assign new_n44_ = new_n46_ & new_n45_ & ~x09 & ~x11 & ~x12 & ~x16;
  assign new_n45_ = ~x01 & ~x03 & ~x04 & ~x08;
  assign new_n46_ = ~x23 & ~x17 & ~x22 & ~x20 & ~x06 & ~x14;
  assign z7 = (~new_n48_ & x13) | (~x21 & x15 & ~x05 & ~x13) | (~new_n49_ & x05);
  assign new_n48_ = (x24 | ~x05 | ~x15) & (x21 | ~x18 | ~x24);
  assign new_n49_ = (~x18 | ~x24) & (x02 | x10 | ~x21 | x24);
  ...
  assign z3 = (~new_n41_ & new_n39_ & ~x08) | (new_n51_ & z7 & new_n52_);
  assign z4 = (~new_n36_ & (new_n59_ | x08)) | new_n38_ | (~new_n57_ & (new_n60_ | ~x08));
  assign new_n57_ = ((~x05 & ~x13) | ((~x18 | ~x24) & (~x13 | x24 | ~x05 | ~x15))) & ~new_n58_ & (~x15 | x05 | x13);
