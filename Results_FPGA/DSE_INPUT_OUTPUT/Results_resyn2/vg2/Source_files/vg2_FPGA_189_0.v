...
module FAU ( 
  ...
  assign z2 = (~x03 & ~x20) | (x06 & x01 & x03 & ~new_n37_ & new_n43_ & x20);
  assign new_n43_ = x11 & x14;
  assign z3 = (~x03 & ~x20) | (new_n41_ & ~new_n37_ & new_n43_ & x20);
  ...
  assign z6 = (~new_n46_ & (new_n52_ | x03)) | ((new_n53_ | ~x03) & (~new_n37_ | (~x03 & ~x20)));
