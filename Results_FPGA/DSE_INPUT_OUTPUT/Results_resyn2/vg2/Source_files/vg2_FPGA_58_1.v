...
module FAU ( 
  ...
  assign z4 = (~new_n57_ & (new_n67_ | ~x08)) | new_n63_ | (~new_n36_ & (new_n68_ | x08));
  assign new_n67_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n68_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n36_ & ~new_n63_;
  assign z6 = new_n71_ | ~new_n72_ | (~new_n73_ & ~x03);
  assign new_n71_ = ~new_n57_ & x11 & (~x06 | (x14 & ~x20));
  assign new_n72_ = (x06 | ~x20) & (new_n36_ | (~x03 & (~x06 | x11)));
  assign new_n73_ = (x05 | (x13 ? (~x18 | ~x24) : ~x15)) & (~new_n58_ | x24) & (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24)));
