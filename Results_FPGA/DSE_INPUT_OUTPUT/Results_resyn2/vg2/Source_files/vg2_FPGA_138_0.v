...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n42_, new_n43_,
    ...
    new_n70_, new_n71_;
  assign z0 = ~new_n36_ & new_n40_ & ~x06 & ~x11 & ~x14;
  ...
  assign new_n40_ = x17 & ~x20 & ~x01 & ~x03;
  ...
  assign z3 = (~new_n52_ & ~x05 & ~x13) | (~new_n54_ & ~x24) | (~new_n57_ & (x05 | x13) & x24);
  assign new_n52_ = (~x15 | ~new_n46_ | ~new_n50_) & (~x19 | ~new_n40_ | ~new_n53_);
  assign new_n53_ = ~x06 & ~x08 & ~x11 & ~x14;
  assign new_n54_ = (new_n55_ | ~new_n46_ | ~new_n50_) & (new_n56_ | ~new_n40_ | ~new_n53_);
  assign new_n55_ = (x02 | x10 | ~x21) & (~x15 | ~x05 | ~x13);
  assign new_n56_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n57_ = (~x07 | ~new_n40_ | ~new_n53_) & (~x18 | ~new_n46_ | ~new_n50_);
  assign z4 = (~new_n42_ & ~new_n59_ & (new_n60_ | ~x08)) | (~new_n36_ & ~new_n59_ & (new_n61_ | x08));
  ...
  assign z6 = (~new_n59_ & (new_n64_ | new_n65_)) | new_n66_ | ~new_n70_;
  ...
  assign new_n68_ = (x11 | x14 | ~x00 | ~x20) & (~x11 | ~x14 | ~x21 | ~x17 | x20);
  assign new_n69_ = (x11 | x14 | ~x19 | ~x20) & (~x11 | ~x14 | ~x15 | ~x17 | x20);
  assign new_n70_ = (new_n71_ | ~x24 | (~x05 & ~x13)) & (new_n69_ | x05 | x13);
  assign new_n71_ = (x11 | x14 | ~x07 | ~x20) & (~x11 | ~x14 | ~x18 | ~x17 | x20);
  assign z7 = ~new_n42_ & ~new_n59_;
endmodule
