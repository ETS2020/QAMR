...
module FAU ( 
  ...
  assign new_n63_ = (~new_n64_ | ~x18) & (~new_n38_ | ~x07 | ~new_n39_ | x08);
  assign new_n64_ = new_n61_ & x06 & x08;
  assign new_n65_ = (~new_n64_ | ~x15) & (~new_n57_ | ~new_n39_ | x11 | x14);
  assign new_n66_ = (~new_n64_ | new_n47_) & (new_n45_ | ~new_n38_ | ~new_n39_ | x08);
  assign z4 = (~new_n36_ & (new_n68_ | x08)) | new_n69_ | (~new_n59_ & (new_n70_ | ~x08));
  ...
  assign z6 = ~new_n73_ | (~new_n78_ & ~new_n69_);
  assign new_n73_ = new_n74_ & (new_n77_ | x24 | x02 | x10);
  assign new_n74_ = (new_n75_ | ((x05 | x13) & (x24 | ~x05 | ~x13))) & (new_n76_ | ~x24 | (~x05 & ~x13));
  assign new_n75_ = (~x19 | ~x06 | x11) & (~x11 | ~x15 | x20 | (x06 & ~x14));
  assign new_n76_ = (~x07 | ~x06 | x11) & (x20 | (x06 & ~x14) | ~x11 | ~x18);
  assign new_n77_ = (~x00 | ~x06 | x11) & (~x11 | ~x21 | x20 | (x06 & ~x14));
  assign new_n78_ = (x24 | (~new_n80_ & (~new_n79_ | ~x05 | ~x13))) & (~new_n79_ | x05 | x13) & (~new_n81_ | ~x24 | (~x05 & ~x13));
  assign new_n79_ = x03 ? x19 : x15;
  assign new_n80_ = (x00 | ~x03) & ~x02 & ~x10 & (x03 | x21);
  assign new_n81_ = x03 ? x07 : x18;
  assign z7 = ~new_n59_ | new_n69_;
endmodule
