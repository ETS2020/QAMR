...
module FAU ( 
  ...
  assign new_n47_ = new_n48_ & x24 & x25 & x21 & x26;
  ...
  assign new_n66_ = x24 & x25 & ~x10 & ~x08 & x09 & x26;
  assign z12 = ~new_n68_ | ((~new_n69_ | ~x22) & (new_n69_ | x22) & ~new_n49_ & new_n51_);
  assign new_n68_ = (new_n49_ | ~x03 | ~x08) & (~new_n66_ | ~new_n48_ | ~x14);
  assign new_n69_ = x21 & x19 & x20;
  assign z13 = (~new_n71_ & ~new_n49_) | (new_n66_ & x15 & new_n69_ & x22);
  assign new_n71_ = (~x04 | ~x08) & (((~new_n69_ | ~x22) & ~x23) | ~new_n51_ | (new_n69_ & x22 & x23));
  assign z14 = ((new_n74_ | x24) & new_n51_ & (~new_n74_ | ~x24)) | new_n73_ | (x05 & x08);
  assign new_n73_ = x16 & (~x24 | (new_n51_ & x25 & x26));
  assign new_n74_ = x22 & x23 & x21 & x19 & x20;
  assign z15 = new_n76_ | new_n77_ | (x06 & x08);
  assign new_n76_ = (x25 | (new_n74_ & x24)) & new_n51_ & (~new_n74_ | ~x25 | (x17 & x26));
  assign new_n77_ = ~x24 & (x16 | (new_n51_ & x25));
  assign z16 = (~new_n79_ & new_n51_) | new_n60_ | (~x24 & (x16 | (new_n51_ & x26)));
  assign new_n79_ = (~x26 | (new_n74_ & ~x18 & x25)) & (~new_n74_ | x26 | ~x24 | ~x25);
endmodule
