...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n60_, new_n62_, new_n63_,
    new_n65_, new_n67_, new_n68_, new_n69_, new_n72_, new_n74_, new_n75_,
    new_n77_, new_n78_;
  assign z00 = (x10 & ~x20) | (new_n48_ & new_n49_ & new_n47_ & x23);
  ...
  assign z10 = z02 | (((new_n62_ & new_n63_) | ~x19 | ~x20) & new_n49_ & (x19 | x20));
  ...
  assign z12 = new_n67_ | ~new_n69_;
  assign new_n67_ = (new_n68_ | ~x19 | ~x21 | ~x22) & new_n49_ & (x22 | (x21 & x19 & x20));
  ...
  assign z15 = new_n75_ | (new_n49_ & ((new_n74_ & ~x25) | (x17 & x25 & x26) | (~new_n74_ & x25)));
  assign new_n74_ = new_n47_ & x23 & x24;
  assign new_n75_ = x06 & x08 & (~x10 | x20);
  assign z16 = ~new_n78_ | (new_n77_ & (x26 | (new_n74_ & x25)));
  assign new_n77_ = new_n49_ & (~new_n62_ | ~x25 | ~x26 | x18 | ~x19);
  assign new_n78_ = (~x07 | ~x08) & (x20 | (~x10 & (~x26 | x08 | ~x09)));
endmodule
