...
module FAU ( 
  ...
  assign z11 = (x02 & x08) | (~x10 & (new_n63_ | ~x09));
  assign new_n63_ = (~new_n64_ | ~x21 | (new_n59_ & x13 & x22)) & ~x08 & (new_n64_ | x21);
  ...
  assign new_n68_ = x09 & (x08 | (~new_n47_ & ~x23) | (~new_n69_ & new_n47_ & x23));
  ...
  assign new_n73_ = x09 & ((new_n74_ & x25 & (~x17 | ~x26)) | x08 | (~new_n74_ & ~x25));
