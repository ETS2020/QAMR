...
module FAU ( 
  ...
  assign z10 = (x01 & x08) | (~x10 & (new_n62_ | ~x03));
  ...
  assign z12 = (x03 & x08) | (~x10 & (new_n68_ | ~x03));
  assign new_n68_ = ((new_n60_ & x14) | ~x22 | ~new_n66_ | ~x21) & x09 & (x22 | (new_n66_ & x21));
  assign z13 = z05 | ((~new_n70_ | ~x23 | (new_n48_ & x15)) & new_n71_ & (new_n70_ | x23));
  assign new_n70_ = new_n66_ & x21 & x22;
  assign new_n71_ = new_n49_ & x03 & ~x10;
  assign z14 = (x05 & x08) | (~x10 & (~x03 | (~new_n73_ & ~x08 & x09)));
  assign new_n73_ = (~x16 | ~x24 | ~x25 | ~x26) & (~new_n47_ ^ x24);
  assign z15 = z07 | (new_n71_ & ((x17 & x25 & x26) | (new_n75_ ^ x25)));
  assign new_n75_ = x23 & x19 & x20 & x21 & x22 & x24;
  assign z16 = (x07 & x08) | (~x10 & (new_n77_ | ~x03));
  assign new_n77_ = (x26 | (new_n75_ & x25)) & new_n49_ & (~new_n60_ | ~new_n78_);
