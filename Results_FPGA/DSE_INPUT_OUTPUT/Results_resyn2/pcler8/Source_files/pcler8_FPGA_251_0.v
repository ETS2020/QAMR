...
module FAU ( 
  ...
  assign new_n61_ = ((new_n48_ & new_n62_) | ~x19 | ~x20) & ~x08 & x09 & (x19 | x20);
  ...
  assign z13 = x04 & (x08 | (~new_n70_ & x09 & ~x10));
  ...
  assign z16 = (x07 & x08) | (~x10 & (~x04 | (~new_n76_ & new_n77_)));
  assign new_n76_ = ~x26 & (~x25 | ~x24 | ~new_n49_ | ~x23);
  assign new_n77_ = ~x08 & x09 & (~new_n48_ | ~new_n49_ | x18);
endmodule
