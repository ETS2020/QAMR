...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n61_, new_n62_, new_n64_,
    ...
    new_n77_;
  assign z00 = new_n47_ & new_n49_ & new_n48_ & ~x10;
  ...
  assign z09 = z01 | (~new_n59_ & new_n48_ & ~x10);
  ...
  assign z14 = ~x10 & ((x05 & x08) | (~x08 & x09 & (new_n71_ | new_n72_)));
  assign new_n71_ = x24 ^ (new_n49_ & x23);
  ...
  assign z16 = z08 | (new_n77_ & (new_n76_ | x26));
  assign new_n76_ = x25 & x24 & new_n49_ & x23;
  assign new_n77_ = new_n48_ & ~x10 & (~new_n47_ | ~new_n49_ | x18);
endmodule
