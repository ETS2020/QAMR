...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n61_, new_n62_,
    new_n64_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n75_,
    new_n77_;
  ...
  assign new_n61_ = x19 & (~new_n62_ | ~x11 | ~x20);
  assign new_n62_ = x21 & x22 & x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08) | (~new_n64_ & ~x10);
  assign new_n64_ = ~x16 & (((~new_n62_ | ~x12) & x19 & x20) | ~new_n48_ | (~x19 & ~x20));
  assign z11 = (x02 & x08) | (~x10 & (new_n66_ | x16));
  assign new_n66_ = (~new_n67_ | ~x21 | (new_n68_ & x13 & x22)) & new_n48_ & (new_n67_ | x21);
  assign new_n67_ = x19 & x20;
  assign new_n68_ = x23 & x24 & x25 & x26;
  assign z12 = (x03 & x08) | (~x10 & (new_n70_ | x16));
  assign new_n70_ = ((new_n68_ & x14) | ~new_n67_ | ~x21 | ~x22) & new_n48_ & (x22 | (new_n67_ & x21));
  assign z13 = ((new_n72_ | ~new_n50_ | ~x23) & new_n47_ & (new_n50_ | x23)) | (new_n52_ & x04);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (new_n52_ & x05) | ((x24 | (new_n50_ & x23)) & new_n47_ & (~new_n50_ | ~x23 | ~x24));
  assign z15 = (new_n52_ & x06) | (new_n47_ & ~new_n75_);
