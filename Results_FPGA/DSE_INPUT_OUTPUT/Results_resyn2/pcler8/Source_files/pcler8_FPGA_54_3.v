...
module FAU ( 
  ...
  assign z10 = new_n60_ | (x08 & (x01 | x10));
  assign new_n60_ = ((new_n47_ & new_n62_) | ~x19 | ~x20) & new_n61_ & (x19 | x20);
  assign new_n61_ = ~x10 & ~x08 & x09;
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = new_n64_ | z03;
  assign new_n64_ = (~new_n65_ | ~x21 | (new_n47_ & x13 & x22)) & new_n61_ & (new_n65_ | x21);
  assign new_n65_ = x19 & x20;
  assign z12 = new_n67_ | (x08 & (x03 | x10));
  assign new_n67_ = ((new_n47_ & x14) | ~new_n65_ | ~x21 | ~x22) & new_n61_ & ((new_n65_ & x21) | x22);
  assign z13 = new_n69_ | (new_n61_ & ((new_n47_ & x15) | (new_n48_ ^ x23)));
  assign new_n69_ = x08 & (x04 | x10);
  assign z14 = z06 | (~new_n71_ & new_n61_);
  assign new_n71_ = (~x16 | ~x26 | ~x24 | ~x25) & (new_n72_ ^ ~x24);
  assign new_n72_ = x23 & x19 & x20 & x21 & x22;
  assign z15 = ~x10 & (new_n74_ | (x06 & x08));
  assign new_n74_ = (x25 | (new_n72_ & x24)) & new_n75_ & ((x17 & x26) | ~new_n72_ | ~x24 | ~x25);
  assign new_n75_ = ~x08 & x09;
  assign z16 = ~x10 & ((x07 & x08) | (~new_n77_ & new_n78_));
  assign new_n77_ = ~x18 & new_n47_ & new_n48_;
  assign new_n78_ = new_n75_ & (x26 | (new_n72_ & x24 & x25));
endmodule
