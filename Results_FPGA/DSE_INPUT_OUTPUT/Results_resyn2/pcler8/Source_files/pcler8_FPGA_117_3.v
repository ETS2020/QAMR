...
module FAU ( 
  ...
  assign new_n62_ = new_n47_ & x12 & x21 & x22;
  ...
  assign z14 = (~new_n72_ & ~x10 & ~x08 & x09) | (x05 & x08) | (x04 & x10);
  assign new_n72_ = (~x16 | ~x26 | ~x24 | ~x25) & (~x24 ^ (new_n49_ & x23));
  assign z15 = new_n74_ | (x06 & x08) | (x04 & x10);
  assign new_n74_ = (new_n75_ | ~x25 | ~new_n49_ | ~x23 | ~x24) & new_n48_ & (x25 | (new_n49_ & x23 & x24));
  assign new_n75_ = x17 & x26;
  assign z16 = ~new_n78_ | (~new_n77_ & new_n48_ & (~new_n47_ | ~new_n49_ | x18));
  assign new_n77_ = ~x26 & (~x25 | ~x24 | ~new_n49_ | ~x23);
  assign new_n78_ = (~x07 | ~x08) & (~x04 | ~x10);
endmodule
