...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n60_, new_n62_, new_n64_,
    new_n65_, new_n67_, new_n70_, new_n72_, new_n73_, new_n75_, new_n76_;
  ...
  assign z09 = (~new_n59_ & ~x08 & x09 & ~x10) | (x00 & x08) | (~x09 & x10);
  ...
  assign new_n72_ = new_n49_ & ((x17 & x25 & x26) | (new_n73_ ^ x25));
  assign new_n73_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = (~new_n75_ & ~new_n76_ & ~x08 & x09 & ~x10) | (x07 & x08) | (~x09 & x10);
  assign new_n75_ = ~x26 & (~new_n73_ | ~x25);
