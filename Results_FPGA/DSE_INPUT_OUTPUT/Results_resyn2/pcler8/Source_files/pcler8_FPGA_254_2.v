...
module FAU ( 
  ...
  assign z10 = new_n62_ | (x01 & x08) | (x10 & ~x18);
  ...
  assign z15 = new_n74_ | (new_n49_ & ((x17 & x25 & x26) | (new_n73_ ^ x25)));
  assign new_n73_ = new_n47_ & x23 & x24;
  assign new_n74_ = x06 & x08 & (~x10 | x18);
  assign z16 = z08 | ((x26 | (new_n73_ & x25)) & ~new_n76_ & new_n49_);
