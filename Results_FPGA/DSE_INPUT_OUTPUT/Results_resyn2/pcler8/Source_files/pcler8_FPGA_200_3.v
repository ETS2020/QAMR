...
module FAU ( 
  ...
  assign z09 = z01 | (new_n62_ & (new_n60_ | (~x10 & ~x19)));
  ...
  assign new_n64_ = new_n61_ & x12 & x21 & x22;
  assign z11 = z03 | (new_n62_ & ((~new_n66_ & x19) | (x21 & ~x10 & ~x19)));
  assign new_n66_ = (~new_n61_ | ~x22 | ~x13 | ~x20) & ((~x20 & ~x21) | x10 | (x20 & x21));
  assign z12 = z04 | new_n68_;
  assign new_n68_ = (new_n69_ | ~x21 | ~x22 | ~x19 | ~x20) & new_n47_ & (x22 | (x21 & x19 & x20));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | ((new_n71_ | ~new_n72_ | ~x23) & new_n47_ & (new_n72_ | x23));
  assign new_n71_ = new_n49_ & x15 & x24;
  assign new_n72_ = x21 & x22 & x19 & x20;
  assign z14 = z06 | new_n74_;
  assign new_n74_ = (x24 | (new_n72_ & x23)) & new_n47_ & ((new_n49_ & x16) | ~new_n72_ | ~x23 | ~x24);
  assign z15 = z07 | (new_n47_ & ((x17 & x25 & x26) | (new_n48_ ^ x25)));
  assign z16 = new_n77_ | (new_n52_ & x07);
  assign new_n77_ = (x26 | (new_n48_ & x25)) & new_n47_ & (x18 | ~new_n48_ | ~x25 | ~x26);
endmodule
