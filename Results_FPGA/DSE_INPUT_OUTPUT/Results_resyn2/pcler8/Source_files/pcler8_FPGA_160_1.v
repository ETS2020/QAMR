...
module FAU ( 
  ...
  assign new_n66_ = ((new_n47_ & x14) | ~new_n64_ | ~x21 | ~x22) & new_n60_ & (x22 | (new_n64_ & x21));
  assign z13 = (~new_n68_ & ~x10 & ~x08 & x09) | (x04 & x08 & (x09 | ~x10));
  ...
  assign new_n73_ = ((x17 & x26) | ~new_n71_ | ~x24 | ~x25) & new_n60_ & (x25 | (new_n71_ & x24));
  assign z16 = new_n75_ | (~x09 & x10) | (x07 & x08);
  assign new_n75_ = (x26 | (new_n76_ & new_n48_ & x23)) & new_n60_ & (x18 | ~new_n48_ | ~x23 | ~new_n76_ | ~x26);
