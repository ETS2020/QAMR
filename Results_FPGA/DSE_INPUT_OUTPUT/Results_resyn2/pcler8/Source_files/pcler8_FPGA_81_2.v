...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n60_, new_n62_, new_n64_,
    new_n65_, new_n67_, new_n68_, new_n71_, new_n73_, new_n75_;
  ...
  assign new_n67_ = (new_n68_ | ~x19 | ~x20 | ~x21 | ~x22) & new_n47_ & (x22 | (x19 & x20 & x21));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (new_n47_ & ((new_n48_ & x15) | (new_n49_ ^ x23)));
  assign z14 = (x05 & x08) | (~x10 & (x03 | (~new_n71_ & ~x08 & x09)));
  ...
  assign z16 = (new_n51_ & x07) | (new_n75_ & (x26 | (new_n73_ & x25)));
  assign new_n75_ = new_n47_ & (~new_n48_ | ~new_n49_ | x18);
endmodule
