...
module FAU ( 
  ...
  assign z09 = (x08 & (x00 | x10)) | (~new_n58_ & ~x10 & ~x08 & x09);
  assign new_n58_ = x19 & (~new_n47_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign z10 = ~x10 & (new_n60_ | (x01 & x08));
  assign new_n60_ = (~x19 | ~x20 | (new_n47_ & new_n62_)) & new_n61_ & (x19 | x20);
  ...
  assign new_n68_ = (~new_n66_ | ~x21 | ~x22 | (new_n47_ & x14)) & new_n65_ & ((new_n66_ & x21) | x22);
  assign z13 = ~x10 & (new_n70_ | (x04 & x08));
  assign new_n70_ = (new_n71_ | ~new_n48_ | ~x23) & ~x08 & x09 & (new_n48_ | x23);
  assign new_n71_ = x24 & x25 & x15 & x26;
  assign z14 = z06 | (~new_n73_ & new_n65_);
  assign new_n73_ = (~x16 | ~x26 | ~x24 | ~x25) & (new_n74_ ^ ~x24);
  assign new_n74_ = x23 & x19 & x20 & x21 & x22;
  assign z15 = new_n76_ | z07;
  assign new_n76_ = (~new_n74_ | ~x24 | ~x25 | (x17 & x26)) & new_n65_ & (x25 | (new_n74_ & x24));
  assign z16 = ~x10 & (new_n78_ | (x07 & x08));
  assign new_n78_ = (x26 | (new_n74_ & x24 & x25)) & new_n61_ & (~new_n74_ | x18 | ~x26 | ~x24 | ~x25);
endmodule
