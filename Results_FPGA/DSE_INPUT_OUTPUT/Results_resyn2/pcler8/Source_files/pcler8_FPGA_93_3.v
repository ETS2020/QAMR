...
module FAU ( 
  ...
  assign z11 = (x02 & x08) | (x09 & (new_n65_ | x10));
  assign new_n65_ = (~new_n66_ | ~x21 | (new_n60_ & x13 & x22)) & ~x08 & (new_n66_ | x21);
  ...
  assign z15 = (x06 & x08) | (x09 & (x10 | (~new_n73_ & ~x08)));
  assign new_n73_ = (~x17 | ~x25 | ~x26) & (new_n74_ ^ ~x25);
  assign new_n74_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | (~new_n76_ & new_n49_ & (x26 | (new_n74_ & x25)));
