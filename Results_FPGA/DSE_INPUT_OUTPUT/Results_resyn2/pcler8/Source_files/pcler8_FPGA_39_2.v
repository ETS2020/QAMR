...
module FAU ( 
  ...
  assign new_n49_ = ~x02 & ~x10 & ~x08 & x09;
  assign z01 = new_n51_ & x00;
  assign new_n51_ = x08 & (~x02 | x10);
  ...
  assign z10 = (new_n51_ & x01) | (~new_n63_ & new_n49_ & (x19 | x20));
  assign new_n63_ = new_n64_ & (~new_n61_ | ~x12 | ~x21 | ~x22);
  assign new_n64_ = x19 & x20;
  assign z11 = z03 | ((new_n67_ | ~new_n64_ | ~x21) & new_n66_ & ~x10 & (new_n64_ | x21));
  assign new_n66_ = ~x08 & x09;
  assign new_n67_ = x24 & x25 & x26 & x23 & x13 & x22;
  assign z12 = (x03 & x08) | (~x10 & (new_n69_ | x02));
  assign new_n69_ = ((new_n61_ & x14) | ~new_n64_ | ~x21 | ~x22) & new_n66_ & (x22 | (new_n64_ & x21));
  assign z13 = (x04 & x08) | (~x10 & (new_n71_ | x02));
  assign new_n71_ = (new_n72_ | ~new_n48_ | ~x23) & new_n66_ & (new_n48_ | x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (new_n51_ & x05) | (~new_n74_ & new_n49_);
  assign new_n74_ = (~x16 | ~x24 | ~x25 | ~x26) & ((new_n48_ & x23 & x24) | (~x24 & (~new_n48_ | ~x23)));
  assign z15 = z07 | (new_n49_ & ((x17 & x25 & x26) | (new_n47_ ^ x25)));
  assign z16 = (new_n51_ & x07) | (new_n77_ & (x26 | (new_n47_ & x25)));
  assign new_n77_ = new_n49_ & (~new_n61_ | ~new_n48_ | x18);
endmodule
