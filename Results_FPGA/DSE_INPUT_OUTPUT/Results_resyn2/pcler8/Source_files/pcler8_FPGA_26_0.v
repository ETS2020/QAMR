...
module FAU ( 
  ...
  assign new_n71_ = x18 & (((~new_n72_ | ~x15) & new_n49_ & x23) | ~new_n62_ | (~new_n49_ & ~x23));
  assign new_n72_ = x24 & x25 & x26;
  assign z14 = (x05 & x08) | (~new_n74_ & ~x10);
  assign new_n74_ = x18 & (~new_n62_ | ((~new_n72_ | ~x16) & (~new_n75_ ^ x24)));
  assign new_n75_ = x21 & x22 & x19 & x20 & x23;
  assign z15 = z07 | (new_n48_ & ((x17 & x25 & x26) | (new_n77_ ^ x25)));
  assign new_n77_ = new_n75_ & x24;
  assign z16 = z08 | (new_n48_ & (x26 | (new_n77_ & x25)));
endmodule
