...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n61_, new_n62_, new_n64_,
    new_n65_, new_n67_, new_n70_, new_n71_, new_n73_, new_n74_, new_n76_;
  ...
  assign z10 = new_n61_ | (x01 & x08 & x10);
  ...
  assign z15 = new_n73_ | (x08 & (x06 | ~x10));
  assign new_n73_ = ((x17 & x26) | ~new_n71_ | ~x24 | ~x25) & new_n74_ & (x25 | (new_n71_ & x24));
  assign new_n74_ = x09 & ~x10;
  assign z16 = z08 | (new_n76_ & (x26 | (new_n71_ & x24 & x25)));
  assign new_n76_ = new_n74_ & (~new_n47_ | ~new_n49_ | x18);
endmodule
