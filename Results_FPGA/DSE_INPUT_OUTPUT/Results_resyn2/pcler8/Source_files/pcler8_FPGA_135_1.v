...
module FAU ( 
  ...
  assign z09 = (~new_n58_ & ~x10 & ~x08 & x09) | (~x09 & x10) | (x00 & x08);
  assign new_n58_ = x19 & (~new_n59_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | (((new_n59_ & new_n62_) | ~x19 | ~x20) & new_n61_ & (x19 | x20));
  assign new_n61_ = ~x10 & ~x08 & x09;
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = z03 | ((new_n64_ | ~x21 | ~x19 | ~x20) & new_n61_ & (x21 | (x19 & x20)));
  assign new_n64_ = new_n59_ & x13 & x22;
  assign z12 = z04 | (((new_n59_ & x14) | ~new_n66_ | ~x22) & new_n61_ & (new_n66_ | x22));
  assign new_n66_ = x21 & x19 & x20;
  assign z13 = z05 | ((~new_n47_ | ~x23 | (new_n48_ & x15)) & new_n61_ & (new_n47_ | x23));
  assign z14 = (~new_n69_ & ~x10 & ~x08 & x09) | (x05 & x08 & (x09 | ~x10));
  assign new_n69_ = (~new_n48_ | ~x16) & ((~x24 & (~new_n47_ | ~x23)) | (new_n47_ & x23 & x24));
  assign z15 = z07 | (~new_n71_ & new_n61_);
  assign new_n71_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n47_ & new_n72_));
  assign new_n72_ = x23 & x24;
  assign z16 = new_n74_ | z08;
  assign new_n74_ = (x26 | (x25 & new_n47_ & new_n72_)) & new_n61_ & (~new_n72_ | ~x25 | ~x26 | ~new_n47_ | x18);
endmodule
