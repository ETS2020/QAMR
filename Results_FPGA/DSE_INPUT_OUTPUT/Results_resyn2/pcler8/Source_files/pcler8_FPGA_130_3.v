...
module FAU ( 
  ...
  assign z09 = (~new_n59_ & ~x10 & ~x08 & x09) | (x00 & x08 & (~x09 | ~x10));
  ...
  assign z15 = z07 | (new_n49_ & (new_n75_ | x25) & (~new_n75_ | ~x25 | (x17 & x26)));
  assign new_n75_ = new_n47_ & x24;
  assign z16 = z08 | ((x26 | (new_n75_ & x25)) & ~new_n77_ & new_n49_);
