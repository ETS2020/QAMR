...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (~x10 & (~x11 | (~new_n58_ & ~x08 & x09)));
  assign new_n58_ = x19 & (~new_n59_ | ~x20 | ~x21 | ~x22);
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = new_n61_ | (x01 & x08 & (x10 | x11));
  assign new_n61_ = ((new_n59_ & new_n62_) | ~x19 | ~x20) & new_n48_ & (x19 | x20);
  ...
  assign new_n68_ = (new_n69_ | ~x19 | ~x20 | ~x21 | ~x22) & new_n65_ & (x22 | (x19 & x20 & x21));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n71_ | (x04 & x08 & (x10 | x11));
  assign new_n71_ = ((new_n73_ & x15) | ~new_n72_ | ~x23) & new_n48_ & (new_n72_ | x23);
  assign new_n72_ = x21 & x22 & x19 & x20;
  assign new_n73_ = x24 & x25 & x26;
  assign z14 = (x05 & x08) | (~new_n75_ & ~x10);
  assign new_n75_ = x11 & (~new_n65_ | ((~new_n73_ | ~x16) & (~new_n76_ ^ x24)));
  assign new_n76_ = x23 & x21 & x22 & x19 & x20;
  assign z15 = (x06 & x08) | (~x10 & (new_n78_ | ~x11));
  assign new_n78_ = ((x17 & x26) | ~new_n47_ | ~x25) & new_n65_ & (new_n47_ | x25);
  assign z16 = (x07 & x08) | (~x10 & (new_n80_ | ~x11));
  assign new_n80_ = (x26 | (new_n47_ & x25)) & new_n65_ & (~new_n59_ | ~new_n81_);
  assign new_n81_ = ~x18 & x19 & x20 & x21 & x22;
endmodule
