...
module FAU ( 
  ...
  assign new_n68_ = ((new_n47_ & x14) | ~new_n66_ | ~x21 | ~x22) & new_n59_ & ((new_n66_ & x21) | x22);
  assign z13 = ~x10 & ((x04 & x08) | (~new_n70_ & ~x08 & x09));
  assign new_n70_ = (~new_n47_ | ~x15) & (~new_n48_ ^ x23);
  assign z14 = (x08 & (x05 | x10)) | (~new_n72_ & ~x10 & ~x08 & x09);
  assign new_n72_ = (~x16 | ~x26 | ~x24 | ~x25) & (new_n73_ ^ ~x24);
  assign new_n73_ = x23 & x19 & x20 & x21 & x22;
  assign z15 = ~x10 & (new_n75_ | (x06 & x08));
  assign new_n75_ = (x25 | (new_n73_ & x24)) & new_n62_ & ((x17 & x26) | ~new_n73_ | ~x24 | ~x25);
  assign z16 = ~x10 & ((x07 & x08) | (~new_n77_ & new_n78_));
  assign new_n77_ = ~x26 & (~new_n73_ | ~x24 | ~x25);
  assign new_n78_ = new_n62_ & (x18 | ~new_n47_ | ~new_n48_);
endmodule
