...
module FAU ( 
  ...
  assign new_n62_ = ((new_n49_ & new_n63_) | ~x19 | ~x20) & new_n60_ & (x19 | x20);
  ...
  assign new_n68_ = ((new_n49_ & x14) | ~new_n48_ | ~x21 | ~x22) & new_n60_ & ((new_n48_ & x21) | x22);
  ...
  assign new_n74_ = ((x17 & x26) | ~new_n72_ | ~x24 | ~x25) & new_n66_ & (x25 | (new_n72_ & x24));
  assign z16 = ~x10 & ((~new_n76_ & new_n77_) | (x07 & x08));
  assign new_n76_ = ~x18 & new_n49_ & new_n48_ & x21 & x22;
  assign new_n77_ = new_n66_ & (x26 | (new_n72_ & x24 & x25));
endmodule
