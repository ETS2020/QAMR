// Benchmark "FAU" written by ABC on Wed Aug 12 20:06:21 2020
...
module FAU ( 
  ...
  assign new_n64_ = ((new_n62_ & x13) | ~x21 | ~x19 | ~x20) & ~x08 & (x21 | (x19 & x20));
  assign z12 = (x03 & x08) | (~x10 & (new_n66_ | ~x09));
  assign new_n66_ = (new_n67_ | ~x19 | ~x22 | ~x20 | ~x21) & ~x08 & (x22 | (x21 & x19 & x20));
  ...
  assign new_n70_ = x04 & x08 & (x09 | x10);
