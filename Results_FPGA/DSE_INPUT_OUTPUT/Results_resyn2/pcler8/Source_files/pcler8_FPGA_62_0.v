...
module FAU ( 
  ...
  assign z09 = ~new_n59_ | (new_n47_ & x11 & x20);
  assign new_n59_ = (new_n50_ | ~x00 | ~x08) & (~new_n60_ | new_n50_ | x19);
  assign new_n60_ = ~x10 & ~x08 & x09;
  assign z10 = (~new_n62_ & ~new_n50_) | (new_n47_ & x12 & x19);
  assign new_n62_ = (~x01 | ~x08) & (~new_n60_ | (x19 & x20) | (~x19 & ~x20));
  assign z11 = new_n64_ | new_n50_ | (x02 & x08);
  assign new_n64_ = (new_n65_ | ~x19 | ~x20 | ~x21) & new_n60_ & ((x19 & x20) | x21);
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = new_n67_ | new_n50_ | (x03 & x08);
  assign new_n67_ = (new_n68_ | ~x19 | ~x20 | ~x21 | ~x22) & new_n60_ & (x22 | (x19 & x20 & x21));
  assign new_n68_ = x24 & x25 & x26 & x14 & x23;
  assign z13 = ~new_n70_ | ((new_n71_ | x23) & ~new_n72_ & new_n60_ & ~new_n50_);
  assign new_n70_ = (new_n50_ | ~x04 | ~x08) & (~new_n48_ | ~x15 | ~x23);
  assign new_n71_ = x21 & x22 & x19 & x20;
  assign new_n72_ = x22 & x23 & x21 & x19 & x20;
  assign z14 = z06 | new_n74_;
  assign new_n74_ = (~new_n72_ | ~x24 | (x16 & x25 & x26)) & new_n60_ & (new_n72_ | x24);
  assign z15 = z07 | (~new_n76_ & new_n60_);
  assign new_n76_ = (~x25 | (new_n71_ & new_n77_)) & (~new_n72_ | x25 | ~x18 | ~x24);
  assign new_n77_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (~new_n79_ & new_n60_) | new_n50_ | (x07 & x08);
  assign new_n79_ = (~x26 | (new_n71_ & ~x18 & x23 & x24)) & (~new_n71_ | ~x23 | ~x24 | ~x25 | x26);
endmodule
