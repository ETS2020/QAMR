...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n61_, new_n62_, new_n64_,
    ...
    new_n77_, new_n78_;
  assign z00 = ~x10 & (~x15 | (new_n47_ & new_n48_ & new_n49_));
  ...
  assign z11 = new_n64_ | (x02 & x08 & (x10 | x15));
  assign new_n64_ = (~new_n65_ | ~x21 | (new_n48_ & x13 & x22)) & new_n66_ & (new_n65_ | x21);
  assign new_n65_ = x19 & x20;
  assign new_n66_ = ~x08 & x09 & ~x10 & x15;
  assign z12 = new_n68_ | z04;
  assign new_n68_ = (~new_n65_ | ~x21 | ~x22 | (new_n48_ & x14)) & new_n66_ & (x22 | (new_n65_ & x21));
  assign z13 = new_n70_ | z05;
  assign new_n70_ = ((x26 & x24 & x25) | ~new_n49_ | ~x23) & new_n66_ & (new_n49_ | x23);
  ...
  assign new_n75_ = (x25 | (new_n73_ & x24)) & new_n47_ & ((x17 & x26) | ~new_n73_ | ~x24 | ~x25);
  assign z16 = (x07 & x08) | (~x10 & (new_n77_ | ~x15));
  assign new_n77_ = (x18 | ~new_n49_ | ~x23 | ~new_n78_ | ~x26) & new_n47_ & (x26 | (new_n78_ & new_n49_ & x23));
