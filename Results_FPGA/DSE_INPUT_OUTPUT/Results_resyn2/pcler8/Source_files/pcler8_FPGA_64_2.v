...
module FAU ( 
  ...
  assign z09 = (~new_n58_ & ~x10 & ~x08 & x09) | (x00 & x08 & (~x10 | x13));
  ...
  assign z11 = new_n63_ | (x02 & x08 & (~x10 | x13));
  assign new_n63_ = (new_n64_ | ~x21 | ~x19 | ~x20) & new_n48_ & (x21 | (x19 & x20));
  assign new_n64_ = x13 & x22 & x25 & x26 & x23 & x24;
  assign z12 = z04 | (((new_n59_ & x14) | ~new_n66_ | ~x22) & new_n48_ & (new_n66_ | x22));
  assign new_n66_ = x21 & x19 & x20;
  assign z13 = ~new_n69_ | ((new_n68_ | ~new_n47_ | ~x23) & new_n48_ & (new_n47_ | x23));
  assign new_n68_ = x15 & x24 & x25 & x26;
  assign new_n69_ = (~x04 | ~x08) & (~x10 | x13);
  assign z14 = z06 | (~new_n71_ & new_n48_);
  assign new_n71_ = (~x16 | ~x24 | ~x25 | ~x26) & ((~x24 & (~new_n47_ | ~x23)) | (new_n47_ & x23 & x24));
  assign z15 = z07 | (new_n48_ & ((x17 & x25 & x26) | (new_n73_ ^ x25)));
  assign new_n73_ = new_n47_ & x23 & x24;
  assign z16 = z08 | (~new_n75_ & new_n48_ & (x26 | (new_n73_ & x25)));
  assign new_n75_ = new_n59_ & x22 & x20 & x21 & ~x18 & x19;
endmodule
