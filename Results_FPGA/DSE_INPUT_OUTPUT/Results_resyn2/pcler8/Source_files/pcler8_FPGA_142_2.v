...
module FAU ( 
  ...
  assign new_n48_ = ~x03 & ~x10 & ~x08 & x09;
  ...
  assign z09 = (x00 & x08) | (~x10 & (x03 | (~new_n59_ & ~x08 & x09)));
  ...
  assign new_n65_ = x23 & x13 & x22 & x24 & x25 & x26;
  ...
  assign z13 = new_n70_ | (x04 & x08) | (x03 & ~x10);
  assign new_n70_ = (new_n72_ | ~new_n71_ | ~x23) & ~x10 & ~x08 & x09 & (new_n71_ | x23);
  assign new_n71_ = x21 & x22 & x19 & x20;
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (new_n51_ & x05) | (~new_n74_ & new_n48_);
  assign new_n74_ = (~x16 | ~x24 | ~x25 | ~x26) & (~x24 ^ (new_n71_ & x23));
  assign z15 = new_n76_ | (new_n51_ & x06);
  assign new_n76_ = ((x17 & x26) | ~new_n47_ | ~x25) & new_n48_ & (new_n47_ | x25);
  assign z16 = (new_n51_ & x07) | (new_n78_ & (x26 | (new_n47_ & x25)));
  assign new_n78_ = new_n48_ & (~new_n60_ | ~new_n71_ | x18);
endmodule
