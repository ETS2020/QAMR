...
module FAU ( 
  ...
  assign z10 = (x01 & x08) | (~new_n62_ & x09);
  assign new_n62_ = ~x10 & ((x19 & x20 & (~new_n60_ | ~x12)) | x08 | (~x19 & ~x20));
  ...
  assign z12 = z04 | ((~new_n68_ | ~x22 | (new_n67_ & x14)) & new_n59_ & (new_n68_ | x22));
  ...
  assign z16 = new_n77_ | (x07 & x08 & (~x09 | ~x10));
  assign new_n77_ = (x26 | (new_n75_ & x25)) & new_n59_ & (~new_n75_ | x18 | ~x25 | ~x26);
endmodule
