...
module FAU ( 
  ...
  assign new_n67_ = (~new_n65_ | ~x21 | ~x22 | (new_n47_ & x14)) & new_n68_ & (x22 | (new_n65_ & x21));
  ...
  assign new_n75_ = ((x17 & x26) | ~new_n73_ | ~x24 | ~x25) & new_n68_ & (x25 | (new_n73_ & x24));
  assign z16 = new_n77_ | (x08 & (x07 | x10));
  assign new_n77_ = (x26 | (new_n78_ & new_n49_ & x23)) & new_n48_ & (~x23 | ~new_n78_ | ~x26 | ~new_n49_ | x18);
