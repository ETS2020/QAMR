...
module FAU ( 
  ...
  assign z00 = ~x10 & (~x09 | (new_n47_ & x23 & new_n48_ & ~x08));
  ...
  assign z10 = z02 | ((new_n61_ | ~x19 | ~x20) & new_n62_ & (x19 | x20));
  ...
  assign new_n69_ = x09 & ((new_n47_ & x23 & (~new_n48_ | ~x15)) | x08 | (~new_n47_ & ~x23));
  assign z14 = z06 | (~new_n71_ & new_n62_);
  assign new_n71_ = (~new_n48_ | ~x16) & ((~x24 & (~new_n47_ | ~x23)) | (new_n47_ & x23 & x24));
  assign z15 = (x06 & x08) | (~x10 & (~x09 | (~new_n73_ & ~x08)));
  assign new_n73_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n47_ & new_n74_));
  assign new_n74_ = x23 & x24;
  assign z16 = (x07 & x08) | (~x10 & (new_n76_ | ~x09));
  assign new_n76_ = (x26 | (x25 & new_n47_ & new_n74_)) & ~x08 & (~new_n74_ | ~x25 | ~x26 | ~new_n47_ | x18);
endmodule
