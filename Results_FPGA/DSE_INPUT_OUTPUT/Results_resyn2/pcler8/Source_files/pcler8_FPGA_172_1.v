...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (~x10 & (x15 | (~new_n60_ & ~x08 & x09)));
  ...
  assign new_n65_ = (~new_n66_ | ~x21 | (new_n61_ & x13 & x22)) & new_n48_ & (new_n66_ | x21);
  assign new_n66_ = x19 & x20;
  assign z12 = (x03 & x08) | (~x10 & (new_n68_ | x15));
  assign new_n68_ = ((new_n61_ & x14) | ~new_n66_ | ~x21 | ~x22) & new_n48_ & (x22 | (new_n66_ & x21));
  assign z13 = z05 | new_n70_;
  assign new_n70_ = (new_n71_ | x23) & ~x08 & x09 & ~x10 & ~x15 & (~new_n71_ | ~x23);
  assign new_n71_ = x21 & x22 & x19 & x20;
  assign z14 = (x05 & x08) | (~x10 & (new_n73_ | x15));
  assign new_n73_ = (~new_n74_ | ~x24 | (x16 & x25 & x26)) & new_n48_ & (new_n74_ | x24);
  assign new_n74_ = x23 & x21 & x22 & x19 & x20;
  assign z15 = (x06 & x08) | (~x10 & (new_n76_ | x15));
  assign new_n76_ = new_n48_ & (new_n49_ | x25) & (~new_n49_ | ~x25 | (x17 & x26));
  assign z16 = (x07 & x08) | (~x10 & (new_n78_ | x15));
  assign new_n78_ = (x26 | (new_n49_ & x25)) & new_n48_ & (~new_n61_ | ~new_n79_);
