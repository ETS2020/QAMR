...
module FAU ( 
  ...
  assign z01 = (x00 & x08) | (x03 & x10);
  assign z02 = x01 & x08 & (~x03 | ~x10);
  ...
  assign new_n61_ = (~x19 | ~x20 | (new_n62_ & x12 & x21)) & new_n48_ & (x19 | x20);
  assign new_n62_ = x22 & x23 & x24 & x25 & x26;
  assign z11 = z03 | (((new_n62_ & x13) | ~new_n64_ | ~x21) & new_n48_ & (new_n64_ | x21));
  assign new_n64_ = x19 & x20;
  assign z12 = ~x10 & ((x03 & x08) | (~new_n66_ & ~new_n67_ & ~x08 & x09));
  assign new_n66_ = new_n47_ & (~new_n59_ | ~x14);
  assign new_n67_ = ~x22 & (~new_n64_ | ~x21);
  assign z13 = ~new_n70_ | ((new_n69_ | ~new_n47_ | ~x23) & new_n48_ & (new_n47_ | x23));
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign new_n70_ = (~x04 | ~x08) & (~x03 | ~x10);
  assign z14 = (~new_n72_ & ~x10 & ~x08 & x09) | (x05 & x08 & (~x03 | ~x10));
  assign new_n72_ = (~x16 | ~x24 | ~x25 | ~x26) & ((~x24 & (~new_n47_ | ~x23)) | (new_n47_ & x23 & x24));
  assign z15 = (~new_n74_ & ~x10 & ~x08 & x09) | (x06 & x08 & (~x03 | ~x10));
  assign new_n74_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n47_ & new_n75_));
  assign new_n75_ = x23 & x24;
  assign z16 = new_n77_ | (x07 & x08 & (~x03 | ~x10));
  assign new_n77_ = (x26 | (x25 & new_n47_ & new_n75_)) & new_n48_ & (~new_n47_ | x18 | ~new_n75_ | ~x25 | ~x26);
endmodule
