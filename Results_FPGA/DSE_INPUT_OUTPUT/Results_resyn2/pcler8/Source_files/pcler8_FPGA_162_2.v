...
module FAU ( 
  ...
  assign z13 = z05 | (x09 & ~x10 & (new_n71_ | (new_n49_ & ~new_n70_)));
  assign new_n70_ = x23 & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n71_ = x23 & (~x22 | (~x08 & (~x19 | ~x20 | ~x21)));
  ...
  assign z16 = z08 | (~new_n78_ & new_n48_ & (~new_n47_ | ~new_n49_ | x18));
  assign new_n78_ = (~new_n74_ | ~x24 | ~x25) & ~x26;
endmodule
