...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n61_, new_n62_, new_n64_,
    ...
    new_n77_;
  assign z00 = (x10 & ~x14) | (new_n47_ & new_n48_ & new_n49_);
  ...
  assign z10 = new_n62_ | (((new_n48_ & new_n61_) | ~x19 | ~x20) & new_n47_ & (x19 | x20));
  assign new_n61_ = x12 & x21 & x22;
  assign new_n62_ = x01 & x08 & (~x10 | x14);
  assign z11 = new_n64_ | (x02 & x08 & (~x10 | x14));
  ...
  assign z13 = new_n69_ | (new_n47_ & ((new_n48_ & x15) | (new_n49_ ^ x23)));
  assign new_n69_ = x04 & x08 & (~x10 | x14);
  ...
  assign new_n74_ = (x25 | (new_n72_ & x24)) & new_n47_ & ((x17 & x26) | ~new_n72_ | ~x24 | ~x25);
  assign z16 = new_n76_ | (x10 & ~x14) | (x07 & x08);
  assign new_n76_ = (x26 | (new_n77_ & new_n49_ & x23)) & new_n47_ & (x18 | ~new_n49_ | ~x23 | ~new_n77_ | ~x26);
