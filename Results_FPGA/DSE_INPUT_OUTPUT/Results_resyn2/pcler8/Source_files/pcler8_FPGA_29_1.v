...
module FAU ( 
  ...
  assign z00 = (~x06 & x10) | (new_n48_ & new_n49_ & new_n47_ & x23);
  ...
  assign z12 = z04 | (((new_n60_ & x14) | ~new_n66_ | ~x22) & new_n49_ & (new_n66_ | x22));
  ...
  assign z15 = z07 | (~new_n71_ & new_n49_);
  assign new_n71_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n47_ & new_n72_));
  assign new_n72_ = x23 & x24;
  assign z16 = new_n74_ | (x07 & x08 & (x06 | ~x10));
  assign new_n74_ = (x26 | (x25 & new_n47_ & new_n72_)) & new_n49_ & (~new_n72_ | ~x25 | ~x26 | ~new_n47_ | x18);
endmodule
