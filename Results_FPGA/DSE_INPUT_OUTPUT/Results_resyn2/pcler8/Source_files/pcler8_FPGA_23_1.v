...
module FAU ( 
  ...
  assign new_n69_ = ((new_n48_ & x15) | ~new_n47_ | ~x23) & new_n60_ & (new_n47_ | x23);
  assign z14 = z06 | (~new_n71_ & new_n60_);
  assign new_n71_ = (~new_n48_ | ~x16) & ((~x24 & (~new_n47_ | ~x23)) | (new_n47_ & x23 & x24));
  assign z15 = z07 | (~new_n73_ & new_n60_);
  assign new_n73_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n47_ & new_n74_));
  assign new_n74_ = x23 & x24;
  assign z16 = new_n76_ | (~x09 & x10) | (x07 & x08);
  assign new_n76_ = (x26 | (x25 & new_n47_ & new_n74_)) & new_n60_ & (~new_n74_ | ~x25 | ~x26 | ~new_n47_ | x18);
endmodule
