...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (~x10 & (~x09 | (~new_n59_ & ~x08)));
  assign new_n59_ = x19 & (~new_n60_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign new_n60_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | ((~x19 | ~x20 | (new_n62_ & x12)) & new_n63_ & (x19 | x20));
  assign new_n62_ = new_n60_ & x21 & x22;
  assign new_n63_ = ~x10 & ~x08 & x09;
  assign z11 = new_n65_ | (x02 & x08 & (x09 | x10));
  assign new_n65_ = (~new_n66_ | ~x21 | (new_n60_ & x13 & x22)) & new_n63_ & (new_n66_ | x21);
  assign new_n66_ = x19 & x20;
  assign z12 = new_n68_ | (x03 & x08 & (x09 | x10));
  assign new_n68_ = ((new_n60_ & x14) | ~x22 | ~new_n66_ | ~x21) & new_n63_ & (x22 | (new_n66_ & x21));
  ...
  assign z16 = z08 | ((x26 | (new_n75_ & x25)) & new_n63_ & (~new_n75_ | x18 | ~x25 | ~x26));
endmodule
