...
module FAU ( 
  ...
  assign new_n61_ = (~x19 | ~x20 | (new_n47_ & new_n63_)) & new_n62_ & (x19 | x20);
  assign new_n62_ = ~x08 & x09;
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (x02 & x08) | (~x10 & (new_n65_ | x18));
  assign new_n65_ = (new_n66_ | ~x19 | ~x20 | ~x21) & new_n62_ & ((x19 & x20) | x21);
  assign new_n66_ = x24 & x25 & x26 & x23 & x13 & x22;
  assign z12 = new_n68_ | (x03 & x08 & (x10 | ~x18));
  assign new_n68_ = (new_n69_ | ~x19 | ~x20 | ~x21 | ~x22) & new_n48_ & (x22 | (x19 & x20 & x21));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08) | (~x10 & (new_n71_ | x18));
  assign new_n71_ = (new_n72_ | ~new_n49_ | ~x23) & new_n62_ & (new_n49_ | x23);
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~new_n74_ & new_n48_);
  assign new_n74_ = (~x16 | ~x24 | ~x25 | ~x26) & (x24 ^ (~new_n49_ | ~x23));
  assign z15 = (~new_n76_ & ~x08 & x09 & ~x10 & ~x18) | (x06 & x08 & (x10 | ~x18));
  assign new_n76_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (x24 & new_n49_ & x23));
  assign z16 = (x07 & x08) | (~x10 & (new_n78_ | x18));
  assign new_n78_ = (~x26 | ~x25 | ~new_n49_ | ~x23 | ~x24) & new_n62_ & (x26 | (x25 & new_n49_ & x23 & x24));
endmodule
