...
module FAU ( 
  ...
  assign new_n63_ = ~x08 & x09 & ~x02 & ~x10;
  ...
  assign new_n68_ = (~new_n66_ | ~x21 | ~x22 | (new_n48_ & x14)) & new_n63_ & (x22 | (new_n66_ & x21));
  assign z13 = z05 | (new_n63_ & ((new_n48_ & x15) | (new_n49_ ^ x23)));
  assign z14 = (x05 & x08) | (~x10 & (x02 | (~new_n71_ & ~x08 & x09)));
  assign new_n71_ = (~x16 | ~x26 | ~x24 | ~x25) & (~new_n72_ ^ x24);
  assign new_n72_ = x23 & x19 & x20 & x21 & x22;
  assign z15 = (x06 & x08) | (~x10 & (new_n74_ | x02));
  assign new_n74_ = (x25 | (new_n72_ & x24)) & new_n47_ & ((x17 & x26) | ~new_n72_ | ~x24 | ~x25);
  assign z16 = (x07 & x08) | (~x10 & (new_n76_ | x02));
  assign new_n76_ = (x18 | ~new_n49_ | ~x23 | ~new_n77_ | ~x26) & new_n47_ & (x26 | (new_n77_ & new_n49_ & x23));
