...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n60_, new_n62_, new_n64_,
    new_n66_, new_n69_, new_n71_, new_n73_;
  ...
  assign new_n69_ = (~new_n48_ | ~x16) & (((~new_n47_ | ~x23) & ~x24) | (new_n47_ & x23 & x24));
  assign z15 = z07 | (new_n49_ & ((x17 & x25 & x26) | (new_n71_ ^ x25)));
  assign new_n71_ = new_n47_ & x23 & x24;
  assign z16 = z08 | (~new_n73_ & new_n49_ & (x26 | (new_n71_ & x25)));
  assign new_n73_ = new_n60_ & x22 & x20 & x21 & ~x18 & x19;
endmodule
