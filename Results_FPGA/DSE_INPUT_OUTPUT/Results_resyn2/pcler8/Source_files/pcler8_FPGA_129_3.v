...
module FAU ( 
  ...
  assign z14 = (x05 & x08 & (~x09 | ~x10)) | (~new_n70_ & ~x10 & ~x08 & x09);
  assign new_n70_ = (~x16 | ~x24 | ~x25 | ~x26) & (new_n71_ ^ ~x24);
  assign new_n71_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = (x06 & x08) | (x09 & (new_n73_ | x10));
  assign new_n73_ = (x25 | (new_n71_ & x24)) & ~x08 & ((x17 & x26) | ~new_n71_ | ~x24 | ~x25);
  assign z16 = (x07 & x08) | (x09 & (new_n75_ | x10));
  assign new_n75_ = (x26 | (new_n76_ & new_n49_ & x23)) & ~x08 & (~x23 | ~new_n76_ | ~x26 | ~new_n49_ | x18);
