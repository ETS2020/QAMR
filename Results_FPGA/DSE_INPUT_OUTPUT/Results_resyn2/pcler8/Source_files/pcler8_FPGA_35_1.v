...
module FAU ( 
  ...
  assign z14 = z06 | (~new_n69_ & new_n60_);
  assign new_n69_ = (~x16 | ~x26 | ~x24 | ~x25) & (~new_n70_ ^ x24);
  assign new_n70_ = x23 & x19 & x20 & x21 & x22;
  assign z15 = new_n72_ | (~x09 & x10) | (x06 & x08);
  assign new_n72_ = ((x17 & x26) | ~new_n70_ | ~x24 | ~x25) & new_n60_ & (x25 | (new_n70_ & x24));
  assign z16 = new_n74_ | (~x09 & x10) | (x07 & x08);
  assign new_n74_ = (x26 | (new_n75_ & new_n48_ & x23)) & new_n60_ & (x18 | ~new_n48_ | ~x23 | ~new_n75_ | ~x26);
