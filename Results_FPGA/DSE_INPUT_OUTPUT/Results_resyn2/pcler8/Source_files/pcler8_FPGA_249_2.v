...
module FAU ( 
  ...
  assign z09 = z01 | (~new_n58_ & x09 & ~x10);
  ...
  assign z12 = z04 | (new_n68_ & (~new_n67_ | (new_n59_ & x14)));
  assign new_n67_ = new_n65_ & x21 & x22;
  assign new_n68_ = x09 & ~x10 & (x22 | (new_n65_ & x21));
  assign z13 = new_n70_ | (new_n62_ & ((new_n59_ & x15) | (new_n67_ ^ x23)));
  ...
  assign new_n76_ = (x26 | (x25 & new_n48_ & x24)) & new_n62_ & (x18 | ~new_n48_ | ~x26 | ~x24 | ~x25);
endmodule
