...
module FAU ( 
  ...
  assign z00 = (x10 & ~x17) | (new_n49_ & new_n47_ & new_n50_);
  ...
  assign z09 = (~new_n60_ & ~x10 & ~x08 & x09) | (x00 & x08 & (~x10 | x17));
  assign new_n60_ = x19 & (~new_n50_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign z10 = new_n62_ | (x10 & ~x17) | (x01 & x08);
  ...
  assign z12 = new_n67_ | (x10 & ~x17) | (x03 & x08);
