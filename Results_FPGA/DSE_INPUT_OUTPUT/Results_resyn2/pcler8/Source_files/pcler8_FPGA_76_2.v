...
module FAU ( 
  ...
  assign z00 = (x10 & ~x24) | (new_n49_ & new_n47_ & new_n50_);
  ...
  assign z09 = (~new_n60_ & ~x10 & ~x08 & x09) | (x00 & x08) | (x10 & ~x24);
  assign new_n60_ = x19 & (~new_n50_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign z10 = new_n62_ | (x10 & ~x24) | (x01 & x08);
  assign new_n62_ = ((new_n50_ & new_n63_) | ~x19 | ~x20) & new_n49_ & (x19 | x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = new_n65_ | (x10 & ~x24) | (x02 & x08);
  ...
  assign z13 = z05 | (new_n49_ & ((new_n50_ & x15) | (new_n47_ ^ x23)));
  assign z14 = z06 | (~new_n70_ & new_n49_);
  assign new_n70_ = (~x16 | ~x26 | ~x24 | ~x25) & (~new_n71_ ^ x24);
  assign new_n71_ = x23 & x19 & x20 & x21 & x22;
  assign z15 = new_n73_ | z07;
  assign new_n73_ = (x25 | (new_n71_ & x24)) & new_n49_ & ((x17 & x26) | ~new_n71_ | ~x24 | ~x25);
  assign z16 = z08 | (new_n75_ & (x18 | ~new_n47_ | ~new_n50_));
  assign new_n75_ = new_n49_ & (x26 | (new_n71_ & x24 & x25));
endmodule
