...
module FAU ( 
  ...
  assign z10 = z02 | ((~x19 | ~x20 | (new_n47_ & new_n62_)) & new_n48_ & (x19 | x20));
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = new_n64_ | (x02 & x08 & x10);
  ...
  assign z14 = (~new_n71_ & ~x10 & ~x08 & x09) | (x05 & x08 & x10);
  assign new_n71_ = (~x16 | ~x24 | ~x25 | ~x26) & (~new_n72_ ^ x24);
  assign new_n72_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = new_n74_ | (x08 & (x06 | ~x10));
  assign new_n74_ = ((x17 & x26) | ~new_n72_ | ~x24 | ~x25) & new_n60_ & (x25 | (new_n72_ & x24));
  assign z16 = z08 | (new_n76_ & (x26 | (new_n72_ & x24 & x25)));
  assign new_n76_ = new_n60_ & (~new_n47_ | ~new_n49_ | x18);
endmodule
