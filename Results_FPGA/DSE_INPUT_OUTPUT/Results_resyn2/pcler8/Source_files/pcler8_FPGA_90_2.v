...
module FAU ( 
  ...
  assign new_n61_ = ((new_n47_ & new_n62_) | ~x19 | ~x20) & new_n63_ & (x19 | x20);
  assign new_n62_ = x12 & x21 & x22;
  assign new_n63_ = x09 & ~x10;
  assign z11 = new_n65_ | (x08 & (x02 | ~x10));
  assign new_n65_ = (~new_n66_ | ~x21 | (new_n47_ & x13 & x22)) & new_n63_ & (new_n66_ | x21);
  assign new_n66_ = x19 & x20;
  assign z12 = new_n68_ | z04;
  assign new_n68_ = (~new_n66_ | ~x21 | ~x22 | (new_n47_ & x14)) & new_n63_ & (x22 | (new_n66_ & x21));
  assign z13 = z05 | (new_n63_ & ((new_n47_ & x15) | (new_n49_ ^ x23)));
  ...
  assign z16 = new_n76_ | (x08 & (x07 | ~x10));
  assign new_n76_ = (x26 | (new_n77_ & new_n49_ & x23)) & new_n63_ & (~x23 | ~new_n77_ | ~x26 | ~new_n49_ | x18);
