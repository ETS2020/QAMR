...
module FAU ( 
  ...
  assign z09 = z01 | (~new_n57_ & new_n59_);
  assign new_n57_ = x19 & (~new_n58_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign new_n58_ = x23 & x24 & x25 & x26;
  assign new_n59_ = ~x10 & ~x08 & x09;
  assign z10 = new_n61_ | (x01 & x08 & (~x09 | ~x10));
  assign new_n61_ = (~x19 | ~x20 | (new_n58_ & new_n62_)) & new_n59_ & (x19 | x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = new_n64_ | z03;
  assign new_n64_ = (~new_n65_ | ~x21 | (new_n58_ & x13 & x22)) & new_n59_ & (new_n65_ | x21);
  assign new_n65_ = x19 & x20;
  assign z12 = new_n67_ | z04;
  assign new_n67_ = ((new_n58_ & x14) | ~new_n65_ | ~x21 | ~x22) & new_n59_ & (x22 | (new_n65_ & x21));
  assign z13 = (x04 & x08 & (~x09 | ~x10)) | (~new_n69_ & ~x10 & ~x08 & x09);
  ...
  assign z15 = (x06 & x08 & (~x09 | ~x10)) | (~new_n74_ & ~x10 & ~x08 & x09);
