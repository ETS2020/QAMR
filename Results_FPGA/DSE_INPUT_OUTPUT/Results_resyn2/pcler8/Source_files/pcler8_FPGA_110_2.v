...
module FAU ( 
  ...
  assign z14 = (~new_n71_ & ~x10 & ~x08 & x09) | (x05 & x08 & (~x10 | x25));
  assign new_n71_ = (~x16 | ~x24 | ~x25 | ~x26) & ((~x24 & (~new_n47_ | ~x23)) | (new_n47_ & x23 & x24));
  assign z15 = new_n73_ | (x06 & x08 & (~x10 | x25));
  assign new_n73_ = new_n49_ & ((x17 & x25 & x26) | (new_n74_ ^ x25));
  assign new_n74_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = new_n77_ | (~new_n76_ & new_n49_ & (x26 | (new_n74_ & x25)));
  assign new_n76_ = new_n60_ & x22 & x20 & x21 & ~x18 & x19;
  assign new_n77_ = x07 & x08 & (~x10 | x25);
endmodule
