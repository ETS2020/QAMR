...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (~new_n59_ & ~x10 & ~x08 & x09);
  ...
  assign z12 = (x03 & x08) | (new_n65_ & (~new_n49_ | (new_n47_ & x14)));
  assign new_n65_ = new_n48_ & ~x10 & (x22 | (x19 & x20 & x21));
  assign z13 = z05 | (new_n48_ & ((new_n47_ & x15) | (new_n49_ ^ x23)));
  assign z14 = (~new_n68_ & ~x08 & x09) | (x05 & x08) | (~x08 & x10);
  assign new_n68_ = (~x16 | ~x24 | ~x25 | ~x26) & (~new_n69_ ^ x24);
  assign new_n69_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = new_n71_ | z07;
  assign new_n71_ = (x25 | (new_n69_ & x24)) & new_n48_ & ((x17 & x26) | ~new_n69_ | ~x24 | ~x25);
  assign z16 = (x07 & x08) | (new_n74_ & (new_n73_ | x26));
  assign new_n73_ = new_n69_ & x24 & x25;
  assign new_n74_ = new_n48_ & ~x10 & (~new_n47_ | ~new_n49_ | x18);
endmodule
