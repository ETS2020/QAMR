...
module FAU ( 
  ...
  assign z00 = (x10 & x12) | (new_n48_ & new_n49_ & new_n47_ & x23);
  ...
  assign new_n61_ = (~new_n59_ | ~x12 | ~x19) & ((~x19 & ~x20) | x10 | (x19 & x20));
  assign z11 = new_n63_ | (x02 & x08 & (~x10 | ~x12));
  assign new_n63_ = ((new_n65_ & x13 & x22) | ~new_n64_ | ~x21) & new_n49_ & (new_n64_ | x21);
  assign new_n64_ = x19 & x20;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z12 = new_n67_ | (x10 & x12) | (x03 & x08);
  assign new_n67_ = ((new_n65_ & x14) | ~x22 | ~new_n64_ | ~x21) & new_n49_ & (x22 | (new_n64_ & x21));
  assign z13 = new_n69_ | (x10 & x12) | (x04 & x08);
  assign new_n69_ = (~new_n47_ | ~x23 | (new_n48_ & x15)) & new_n49_ & (new_n47_ | x23);
