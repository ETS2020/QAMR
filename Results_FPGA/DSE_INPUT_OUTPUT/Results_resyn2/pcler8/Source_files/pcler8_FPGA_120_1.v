...
module FAU ( 
  ...
  assign z10 = new_n61_ | (~x09 & x10) | (x01 & x08);
  assign new_n61_ = ((new_n47_ & new_n62_) | ~x19 | ~x20) & new_n59_ & (x19 | x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = new_n64_ | (~x09 & x10) | (x02 & x08);
  assign new_n64_ = (~new_n65_ | ~x21 | (new_n47_ & x13 & x22)) & new_n59_ & (new_n65_ | x21);
  assign new_n65_ = x19 & x20;
  assign z12 = new_n67_ | z04;
  assign new_n67_ = ((new_n47_ & x14) | ~new_n65_ | ~x21 | ~x22) & new_n59_ & (x22 | (new_n65_ & x21));
  assign z13 = (~new_n69_ & ~x10 & ~x08 & x09) | (x04 & x08 & (x09 | ~x10));
  assign new_n69_ = (~new_n47_ | ~x15) & (~new_n48_ ^ x23);
  assign z14 = (~new_n71_ & ~x10 & ~x08 & x09) | (x05 & x08 & (x09 | ~x10));
  assign new_n71_ = (~x16 | ~x26 | ~x24 | ~x25) & (~new_n72_ ^ x24);
  assign new_n72_ = x23 & x19 & x20 & x21 & x22;
  assign z15 = new_n74_ | z07;
  assign new_n74_ = (x25 | (new_n72_ & x24)) & new_n59_ & ((x17 & x26) | ~new_n72_ | ~x24 | ~x25);
  assign z16 = z08 | (new_n76_ & (x18 | ~new_n47_ | ~new_n48_));
  assign new_n76_ = new_n59_ & (x26 | (new_n72_ & x24 & x25));
endmodule
