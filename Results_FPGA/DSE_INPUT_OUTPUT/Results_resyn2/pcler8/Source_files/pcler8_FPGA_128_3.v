...
module FAU ( 
  ...
  assign new_n64_ = (new_n66_ | ~new_n65_ | ~x21) & new_n61_ & ~x10 & (new_n65_ | x21);
  assign new_n65_ = x19 & x20;
  assign new_n66_ = x13 & x22 & x23 & x26 & x24 & x25;
  assign z12 = ~x10 & (new_n68_ | (x03 & x08));
  assign new_n68_ = (~new_n65_ | ~x21 | ~x22 | (new_n47_ & x14)) & new_n61_ & ((new_n65_ & x21) | x22);
  ...
  assign new_n75_ = (x25 | (new_n73_ & x24)) & new_n61_ & ((x17 & x26) | ~new_n73_ | ~x24 | ~x25);
  assign z16 = ~x10 & (new_n77_ | (x07 & x08));
  assign new_n77_ = (x26 | (new_n78_ & new_n48_ & x23)) & new_n61_ & (~x23 | ~new_n78_ | ~x26 | ~new_n48_ | x18);
