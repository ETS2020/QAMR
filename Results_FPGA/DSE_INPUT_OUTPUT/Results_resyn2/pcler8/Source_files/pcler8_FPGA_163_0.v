...
module FAU ( 
  ...
  assign z10 = (x01 & x08) | (~x10 & (new_n62_ | ~x02));
  assign new_n62_ = ((new_n60_ & new_n63_) | ~x19 | ~x20) & new_n49_ & (x19 | x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = x02 & (new_n65_ | x08);
  assign new_n65_ = (new_n66_ | ~x21 | ~x19 | ~x20) & (x21 | (x19 & x20)) & x09 & ~x10;
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (x03 & x08) | (~x10 & (new_n68_ | ~x02));
  assign new_n68_ = (new_n69_ | ~x19 | ~x20 | ~x21 | ~x22) & new_n49_ & (x22 | (x21 & x19 & x20));
  ...
  assign z14 = z06 | (new_n74_ & ((new_n48_ & x16) | (new_n47_ ^ x24)));
  assign new_n74_ = ~x08 & x09 & x02 & ~x10;
  assign z15 = new_n76_ | (x06 & x08 & (x02 | x10));
  assign new_n76_ = (x25 | (new_n47_ & x24)) & new_n74_ & (~new_n47_ | ~x24 | ~x25 | (x17 & x26));
  assign z16 = (x07 & x08) | (~x10 & (new_n78_ | ~x02));
  assign new_n78_ = (~new_n72_ | x18 | ~new_n79_ | ~x25 | ~x26) & new_n49_ & (x26 | (new_n72_ & new_n79_ & x25));
