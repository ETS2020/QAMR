...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n61_, new_n62_, new_n64_,
    new_n65_, new_n67_, new_n70_, new_n72_, new_n74_, new_n75_;
  ...
  assign z14 = (x05 & x08) | (x09 & (x10 | (~new_n70_ & ~x08)));
  assign new_n70_ = (~x16 | ~x24 | ~x25 | ~x26) & (~x24 ^ (new_n49_ & x23));
  assign z15 = z07 | (new_n48_ & ((x17 & x25 & x26) | (new_n72_ ^ x25)));
  assign new_n72_ = x24 & x21 & x22 & x19 & x20 & x23;
  assign z16 = (x07 & x08) | (x09 & (new_n74_ | x10));
  assign new_n74_ = ~x08 & (~new_n47_ | ~new_n75_) & (x26 | (new_n72_ & x25));
