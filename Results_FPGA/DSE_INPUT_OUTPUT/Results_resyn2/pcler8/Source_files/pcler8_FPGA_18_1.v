...
module FAU ( 
  ...
  assign z14 = (~new_n69_ & ~x08 & x09 & ~x10) | (x05 & x08) | (~x09 & x10);
  assign new_n69_ = (~x16 | ~x24 | ~x25 | ~x26) & ((~x24 & (~new_n47_ | ~x23)) | (new_n47_ & x23 & x24));
  assign z15 = (~new_n71_ & ~x08 & x09 & ~x10) | (x06 & x08 & (x09 | ~x10));
  assign new_n71_ = (~x17 | ~x25 | ~x26) & (~new_n72_ ^ x25);
  assign new_n72_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | (~new_n74_ & new_n49_ & (x26 | (new_n72_ & x25)));
