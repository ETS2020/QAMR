...
module FAU ( 
  ...
  assign new_n65_ = (~new_n66_ | ~x21 | (new_n59_ & x13 & x22)) & new_n67_ & (new_n66_ | x21);
  assign new_n66_ = x19 & x20;
  assign new_n67_ = ~x10 & ~x08 & x09;
  assign z12 = new_n69_ | z04;
  assign new_n69_ = ((new_n59_ & x14) | ~new_n66_ | ~x21 | ~x22) & new_n60_ & (x22 | (new_n66_ & x21));
  assign z13 = z05 | (new_n60_ & ((x15 & new_n47_ & x23) | (new_n71_ ^ x23)));
  assign new_n71_ = x19 & x20 & x21 & x22;
  assign z14 = (~new_n73_ & ~x10 & ~x08 & x09) | (x05 & x08 & x10);
  assign new_n73_ = (~new_n47_ | ~x16) & (~new_n48_ ^ x24);
  assign z15 = new_n75_ | (x06 & x08 & x10);
  assign new_n75_ = ((x17 & x26) | ~x25 | ~new_n48_ | ~x24) & new_n67_ & (x25 | (new_n48_ & x24));
  assign z16 = new_n77_ | z08;
  assign new_n77_ = (x26 | (x25 & new_n48_ & x24)) & new_n67_ & (x18 | ~new_n48_ | ~x26 | ~x24 | ~x25);
endmodule
