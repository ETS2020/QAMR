...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n61_, new_n62_, new_n64_,
    new_n65_, new_n67_, new_n70_, new_n71_, new_n73_, new_n75_, new_n76_;
  ...
  assign z09 = (~new_n59_ & ~x10 & ~x08 & x09) | (x00 & x08 & (~x05 | ~x10));
  assign new_n59_ = x19 & (~new_n47_ | ~x11 | ~x20 | ~x21 | ~x22);
  assign z10 = new_n62_ | (((new_n47_ & new_n61_) | ~x19 | ~x20) & new_n48_ & (x19 | x20));
  assign new_n61_ = x12 & x21 & x22;
  assign new_n62_ = x01 & x08 & (~x05 | ~x10);
  ...
  assign z12 = new_n67_ | (x03 & x08 & (~x05 | ~x10));
  assign new_n67_ = ((new_n47_ & x14) | ~new_n65_ | ~x21 | ~x22) & new_n48_ & (x22 | (new_n65_ & x21));
  ...
  assign new_n73_ = ((new_n71_ & x24) | x25) & new_n48_ & ((x17 & x26) | ~new_n71_ | ~x24 | ~x25);
