...
module FAU ( 
  ...
  assign z12 = z04 | (((new_n49_ & x14) | ~new_n68_ | ~x22) & new_n47_ & (new_n68_ | x22));
  assign new_n68_ = x21 & x19 & x20;
  assign z13 = z05 | ((new_n70_ | ~new_n48_ | ~x23) & new_n62_ & ~x10 & (new_n48_ | x23));
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~new_n72_ & new_n47_);
  assign new_n72_ = (~x16 | ~x24 | ~x25 | ~x26) & (x24 ^ (~new_n48_ | ~x23));
  assign z15 = new_n74_ | (x06 & x08 & (~x04 | x10));
  assign new_n74_ = (new_n75_ | x25) & new_n47_ & (~new_n75_ | ~x25 | (x17 & x26));
  assign new_n75_ = x24 & x19 & x20 & x21 & x22 & x23;
  assign z16 = (x07 & x08) | (~x10 & (new_n77_ | x04));
  assign new_n77_ = (~new_n48_ | x18 | ~new_n78_ | ~x25 | ~x26) & new_n62_ & (x26 | (new_n48_ & new_n78_ & x25));
