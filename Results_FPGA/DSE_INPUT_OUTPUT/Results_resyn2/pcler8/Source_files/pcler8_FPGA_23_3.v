...
module FAU ( 
  ...
  assign z10 = new_n63_ | (((new_n59_ & new_n61_) | ~x19 | ~x20) & new_n62_ & (x19 | x20));
  assign new_n61_ = x12 & x21 & x22;
  assign new_n62_ = ~x10 & ~x08 & x09;
  assign new_n63_ = x01 & x08 & (~x09 | ~x10);
  assign z11 = (x02 & x08) | (x09 & (new_n65_ | x10));
  assign new_n65_ = (~new_n66_ | ~x21 | (new_n59_ & x13 & x22)) & ~x08 & (new_n66_ | x21);
  assign new_n66_ = x19 & x20;
  assign z12 = (x03 & x08) | (x09 & (new_n68_ | x10));
  assign new_n68_ = ((new_n59_ & x14) | ~new_n66_ | ~x21 | ~x22) & ~x08 & (x22 | (new_n66_ & x21));
  assign z13 = new_n70_ | (x04 & x08 & (~x09 | ~x10));
  assign new_n70_ = ((new_n48_ & x15) | ~new_n47_ | ~x23) & new_n62_ & (new_n47_ | x23);
  assign z14 = z06 | (~new_n72_ & new_n62_);
  assign new_n72_ = (~new_n48_ | ~x16) & (x24 ^ (~new_n47_ | ~x23));
  assign z15 = z07 | (new_n62_ & (new_n74_ | x25) & (~new_n74_ | ~x25 | (x17 & x26)));
  assign new_n74_ = x24 & new_n47_ & x23;
