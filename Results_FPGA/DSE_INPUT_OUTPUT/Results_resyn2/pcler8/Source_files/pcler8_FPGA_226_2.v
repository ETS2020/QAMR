...
module FAU ( 
  ...
  assign z09 = (~new_n59_ & ~x10 & ~x08 & x09) | (x00 & x08 & x10);
  assign new_n59_ = x19 & (~new_n47_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign z10 = z02 | ((~x19 | ~x20 | (new_n47_ & new_n61_)) & new_n62_ & (x19 | x20));
  assign new_n61_ = x12 & x21 & x22;
  assign new_n62_ = x09 & ~x10;
  assign z11 = new_n64_ | z03;
  assign new_n64_ = (~new_n65_ | ~x21 | (new_n47_ & x13 & x22)) & new_n62_ & (new_n65_ | x21);
  ...
  assign z13 = z05 | (new_n62_ & (new_n69_ | (new_n49_ & ~new_n70_)));
  assign new_n69_ = x23 & (~x22 | (~x08 & (~new_n65_ | ~x21)));
  assign new_n70_ = x23 & (~x15 | ~x24 | ~x25 | ~x26);
  assign z14 = (x08 & (x05 | ~x10)) | (~new_n72_ & x09 & ~x10);
  ...
  assign z16 = (~new_n77_ & new_n78_) | (x07 & x08 & x10);
  assign new_n77_ = (~new_n73_ | ~x24 | ~x25) & ~x26;
  assign new_n78_ = new_n48_ & (~new_n47_ | ~new_n49_ | x18);
endmodule
