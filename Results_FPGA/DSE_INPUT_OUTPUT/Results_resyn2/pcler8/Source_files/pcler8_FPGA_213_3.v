...
module FAU ( 
  ...
  assign new_n64_ = (~new_n65_ | ~x21 | (new_n60_ & x13 & x22)) & ~x08 & (new_n65_ | x21);
  assign new_n65_ = x19 & x20;
  assign z12 = (x03 & x08) | (x09 & (new_n67_ | x10));
  assign new_n67_ = ((new_n60_ & x14) | ~x22 | ~new_n65_ | ~x21) & ~x08 & (x22 | (new_n65_ & x21));
  assign z13 = (new_n51_ & x04) | (~new_n69_ & ~new_n70_ & new_n48_);
  assign new_n69_ = new_n47_ & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n70_ = ~x23 & (~new_n65_ | ~x21 | ~x22);
  assign z14 = (x05 & x08) | (x09 & (x10 | (~new_n72_ & ~x08)));
  assign new_n72_ = (~x16 | ~x24 | ~x25 | ~x26) & (new_n47_ ^ ~x24);
  assign z15 = (new_n51_ & x06) | (~new_n74_ & new_n48_);
  assign new_n74_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n47_ & x24));
  assign z16 = (new_n51_ & x07) | (~new_n76_ & ~new_n77_ & new_n48_);
  assign new_n76_ = ~x26 & (~x25 | ~new_n47_ | ~x24);
  assign new_n77_ = new_n60_ & x20 & x21 & x22 & ~x18 & x19;
endmodule
