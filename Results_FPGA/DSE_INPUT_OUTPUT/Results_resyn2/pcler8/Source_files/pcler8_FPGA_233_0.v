...
module FAU ( 
  ...
  assign z09 = ~new_n50_ & ((~new_n60_ & new_n49_) | (x00 & x08));
  assign new_n60_ = x19 & (~new_n47_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign z10 = z02 | ((~x19 | ~x20 | (new_n47_ & new_n62_)) & new_n49_ & (x19 | x20));
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = z03 | ((new_n64_ | ~new_n65_ | ~x21) & new_n66_ & (new_n65_ | x21));
  assign new_n64_ = new_n47_ & x13 & x22;
  assign new_n65_ = x19 & x20;
  assign new_n66_ = x09 & ~x10 & (x02 | (~x08 & x12));
  ...
  assign z14 = z06 | (~new_n71_ & new_n49_ & ~new_n50_);
  assign new_n71_ = (~x16 | ~x24 | ~x25 | ~x26) & (~x24 ^ (new_n48_ & x23));
  assign z15 = (~new_n73_ & new_n49_) | new_n50_ | (x06 & x08);
  assign new_n73_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (x24 & new_n48_ & x23));
  assign z16 = ~new_n50_ & ((x07 & x08) | (new_n76_ & (new_n75_ | x26)));
  assign new_n75_ = x25 & x24 & new_n48_ & x23;
  assign new_n76_ = new_n49_ & (~new_n47_ | ~new_n48_ | x18);
endmodule
