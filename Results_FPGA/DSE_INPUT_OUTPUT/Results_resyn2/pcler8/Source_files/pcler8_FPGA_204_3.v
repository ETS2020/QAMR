...
module FAU ( 
  ...
  assign z13 = ~new_n71_ | (x15 & (x10 | (new_n69_ & new_n49_)));
  assign new_n69_ = new_n70_ & x26 & ~x08 & x09;
  assign new_n70_ = x24 & x25;
  assign new_n71_ = (~x04 | ~x08) & ((new_n49_ & x23) | x10 | x08 | ~x09 | (~new_n49_ & ~x23));
  assign z14 = (~new_n73_ & ~x10 & ~x08 & x09) | (x05 & x08) | (x10 & x15);
  assign new_n73_ = (~x16 | ~x24 | ~x25 | ~x26) & (~new_n74_ ^ x24);
  assign new_n74_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = new_n76_ | (x06 & x08) | (x10 & x15);
  assign new_n76_ = ((x17 & x26) | ~new_n74_ | ~x24 | ~x25) & new_n48_ & (x25 | (new_n74_ & x24));
  assign z16 = new_n78_ | (x07 & x08 & (~x10 | ~x15));
  assign new_n78_ = (x26 | (new_n70_ & new_n49_ & x23)) & new_n48_ & (~x23 | ~new_n70_ | ~x26 | ~new_n49_ | x18);
endmodule
