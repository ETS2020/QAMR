...
module FAU ( 
  ...
  assign new_n65_ = ((new_n63_ & x13) | ~x21 | ~x19 | ~x20) & new_n48_ & (x21 | (x19 & x20));
  assign z12 = z04 | (new_n67_ & (~new_n47_ | (new_n59_ & x14)));
  assign new_n67_ = new_n62_ & (x22 | (x21 & x19 & x20));
  assign z13 = new_n69_ | (x04 & x08) | (~x08 & x10);
  assign new_n69_ = (new_n70_ | ~new_n47_ | ~x23) & new_n62_ & (new_n47_ | x23);
  ...
  assign new_n76_ = new_n48_ & (~new_n47_ | ~new_n59_ | x18);
endmodule
