...
module FAU ( 
  ...
  assign z10 = z00 | (x01 & x08) | (new_n56_ & (~x19 | ~x20) & (x19 | x20));
  assign z11 = z03 | (~z00 & new_n56_ & (~x21 | ~x19 | ~x20) & (x21 | (x19 & x20)));
  assign z12 = (x03 & x08 & (~x22 | ~x23)) | ((~new_n60_ | ~x22) & new_n56_ & (new_n60_ | (x22 & ~x23)));
  assign new_n60_ = x19 & x20 & x21;
  assign z13 = (new_n56_ & (x23 | (new_n60_ & x22))) | (x04 & x08) | (x22 & x23);
  assign z14 = z00 | (x05 & x08) | (new_n56_ & x24);
  assign z15 = (~z00 & x06 & x08) | (new_n56_ & ~z00 & x25);
