...
module FAU ( 
  ...
  assign z12 = (x03 & x08) | (~x10 & (new_n67_ | ~x17));
  assign new_n67_ = ((new_n48_ & x14) | ~new_n65_ | ~x21 | ~x22) & new_n47_ & (x22 | (new_n65_ & x21));
  assign z13 = (x04 & x08) | (~x10 & (~x17 | (~new_n69_ & ~x08 & x09)));
  assign new_n69_ = (~new_n48_ | ~x15) & (~new_n49_ ^ x23);
  assign z14 = (x05 & x08) | (~x10 & (~x17 | (~new_n71_ & ~x08 & x09)));
  assign new_n71_ = (~x16 | ~x26 | ~x24 | ~x25) & (~new_n72_ ^ x24);
  assign new_n72_ = x23 & x19 & x20 & x21 & x22;
  assign z15 = (x06 & x08) | (~x10 & (new_n74_ | ~x17));
  assign new_n74_ = (x25 | (new_n72_ & x24)) & new_n47_ & (x26 | ~new_n72_ | ~x24 | ~x25);
  assign z16 = (x07 & x08) | (~x10 & (new_n76_ | ~x17));
