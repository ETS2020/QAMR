...
module FAU ( 
  ...
  assign z13 = z05 | ((~new_n47_ | ~x23 | (new_n48_ & x15)) & new_n69_ & (new_n47_ | x23));
  assign new_n69_ = ~x10 & ~x08 & x09;
  assign z14 = (~new_n71_ & ~x10 & ~x08 & x09) | (x05 & x08 & (~x09 | ~x10));
  assign new_n71_ = (~x16 | ~x24 | ~x25 | ~x26) & (x24 ^ (~new_n47_ | ~x23));
  assign z15 = new_n73_ | (x06 & x08 & (~x09 | ~x10));
  assign new_n73_ = (new_n74_ | x25) & new_n69_ & (~new_n74_ | ~x25 | (x17 & x26));
  assign new_n74_ = x24 & x23 & x19 & x20 & x21 & x22;
  assign z16 = (x07 & x08) | (x09 & (new_n76_ | x10));
  assign new_n76_ = (~new_n77_ | ~x25 | ~x26 | ~new_n47_ | x18) & ~x08 & (x26 | (new_n47_ & new_n77_ & x25));
