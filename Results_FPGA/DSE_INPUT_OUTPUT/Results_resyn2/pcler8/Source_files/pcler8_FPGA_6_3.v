...
module FAU ( 
  ...
  assign new_n68_ = ((new_n49_ & x14) | ~new_n66_ | ~x21 | ~x22) & new_n65_ & (x22 | (new_n66_ & x21));
  assign z13 = ~x10 & ((x04 & x08) | (~new_n70_ & ~x08 & x09));
  assign new_n70_ = (~new_n49_ | ~x15) & (~new_n48_ ^ x23);
  ...
  assign z16 = z08 | (~new_n76_ & new_n47_ & (~new_n48_ | ~new_n49_ | x18));
  assign new_n76_ = ~x26 & (~x25 | ~x24 | ~new_n48_ | ~x23);
endmodule
