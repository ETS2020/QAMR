...
module FAU ( 
  ...
  assign z09 = new_n59_ | (x00 & x08) | (x10 & x12);
  assign new_n59_ = new_n48_ & (~x19 | (new_n60_ & x11 & x20));
  assign new_n60_ = x21 & x22 & x23 & x24 & x25 & x26;
  assign z10 = z02 | (~new_n62_ & ~x08 & x09);
  assign new_n62_ = (~new_n60_ | ~x12 | ~x19) & ((~x19 & ~x20) | x10 | (x19 & x20));
  ...
  assign new_n67_ = (~new_n65_ | ~x21 | ~x22 | (new_n47_ & x14)) & new_n48_ & ((new_n65_ & x21) | x22);
  assign z13 = new_n69_ | (x04 & x08 & (~x10 | ~x12));
  assign new_n69_ = new_n48_ & ((new_n47_ & x15) | (new_n49_ ^ x23));
  assign z14 = z06 | (~new_n71_ & new_n48_);
  assign new_n71_ = (~x16 | ~x24 | ~x25 | ~x26) & (~new_n72_ ^ x24);
  assign new_n72_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = new_n74_ | (x06 & x08) | (x10 & x12);
  assign new_n74_ = ((x17 & x26) | ~new_n72_ | ~x24 | ~x25) & new_n48_ & (x25 | (new_n72_ & x24));
  assign z16 = z08 | (new_n76_ & (~new_n60_ | ~new_n65_ | x18));
  assign new_n76_ = new_n48_ & (x26 | (new_n72_ & x24 & x25));
endmodule
