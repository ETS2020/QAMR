...
module FAU ( 
  ...
  assign z00 = (x10 & x12) | (new_n49_ & new_n47_ & new_n50_);
  ...
  assign z09 = (~new_n60_ & ~x10 & ~x08 & x09) | (x00 & x08 & (~x10 | ~x12));
  ...
  assign new_n63_ = x01 & x08 & (~x10 | ~x12);
  assign z11 = new_n65_ | (x02 & x08 & (~x10 | ~x12));
  ...
  assign new_n69_ = x04 & x08 & (~x10 | ~x12);
