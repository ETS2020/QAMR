...
module FAU ( 
  ...
  assign z10 = (x01 & x08) | (~x10 & (new_n62_ | ~x09));
  assign new_n62_ = ((new_n60_ & new_n63_) | ~x19 | ~x20) & ~x08 & (x19 | x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (x02 & x08) | (~x10 & (new_n65_ | ~x09));
  assign new_n65_ = (new_n66_ | ~x21 | ~x19 | ~x20) & ~x08 & (x21 | (x19 & x20));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (((new_n60_ & x14) | ~new_n68_ | ~x22) & new_n49_ & (new_n68_ | x22));
  assign new_n68_ = x21 & x19 & x20;
  assign z13 = new_n70_ | (x04 & x08);
  assign new_n70_ = ~x10 & (~x09 | (new_n71_ & (~new_n47_ | (new_n48_ & x15))));
  assign new_n71_ = ~x08 & (x23 | (x19 & x20 & x21 & x22));
  assign z14 = (x05 & x08) | (~x10 & (~x09 | (~new_n73_ & ~x08)));
  assign new_n73_ = (~x16 | ~x24 | ~x25 | ~x26) & (new_n47_ ^ ~x24);
  assign z15 = new_n75_ | (x06 & x08 & (x09 | x10));
  assign new_n75_ = (new_n76_ | x25) & new_n49_ & (~new_n76_ | ~x25 | (x17 & x26));
  assign new_n76_ = x23 & x19 & x20 & x21 & x22 & x24;
  assign z16 = (x07 & x08) | (~x10 & (~x09 | (~new_n78_ & ~new_n79_ & ~x08)));
  assign new_n78_ = ~x26 & (~new_n76_ | ~x25);
  assign new_n79_ = new_n60_ & x22 & x20 & x21 & ~x18 & x19;
endmodule
