...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n60_, new_n62_, new_n63_,
    new_n65_, new_n66_, new_n68_, new_n71_, new_n73_, new_n75_;
  ...
  assign z14 = (~new_n71_ & ~x10 & ~x08 & x09) | (x05 & x08) | (x04 & x10);
  assign new_n71_ = (~new_n48_ | ~x16) & (((~new_n47_ | ~x23) & ~x24) | (new_n47_ & x23 & x24));
  assign z15 = z07 | (new_n49_ & ((x17 & x25 & x26) | (new_n73_ ^ x25)));
  assign new_n73_ = new_n47_ & x23 & x24;
  assign z16 = z08 | ((x26 | (new_n73_ & x25)) & ~new_n75_ & new_n49_);
  assign new_n75_ = new_n60_ & x22 & x20 & x21 & ~x18 & x19;
endmodule
