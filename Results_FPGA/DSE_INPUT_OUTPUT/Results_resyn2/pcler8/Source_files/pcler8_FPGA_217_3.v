...
module FAU ( 
  ...
  assign z10 = z02 | (~new_n63_ & new_n61_ & (x19 | x20));
  assign new_n63_ = new_n50_ & (~new_n48_ | ~x23 | ~x12 | ~x21 | ~x22);
  assign z11 = (~new_n65_ & ~new_n49_) | (new_n66_ & new_n51_ & x26);
  assign new_n65_ = (~x02 | ~x08) & ((~new_n50_ & ~x21) | ~new_n51_ | (new_n50_ & x21));
  assign new_n66_ = new_n50_ & x13 & ~x18 & new_n67_ & x22 & x23;
  assign new_n67_ = x24 & x25;
  assign z12 = z04 | ((new_n69_ | ~new_n50_ | ~x21 | ~x22) & new_n51_ & (x22 | (new_n50_ & x21)));
  assign new_n69_ = x14 & new_n48_ & x23;
  assign z13 = z05 | new_n71_;
  assign new_n71_ = (~new_n72_ | ~x23 | (new_n48_ & x15)) & ~new_n49_ & new_n51_ & (new_n72_ | x23);
  assign new_n72_ = x21 & x22 & x19 & x20;
  assign z14 = ~new_n49_ & ((x05 & x08) | (~new_n74_ & new_n51_));
  assign new_n74_ = (~new_n48_ | ~x16) & (~new_n75_ ^ x24);
  assign new_n75_ = x23 & x21 & x22 & x19 & x20;
  assign z15 = z07 | new_n77_;
  assign new_n77_ = (~new_n75_ | ~x24 | ~x25 | (x17 & x26)) & new_n61_ & (x25 | (new_n75_ & x24));
  assign z16 = ~new_n49_ & (new_n79_ | new_n80_ | (x07 & x08));
  assign new_n79_ = new_n51_ & x26 & (~new_n75_ | ~new_n67_ | x18);
  assign new_n80_ = new_n81_ & new_n50_ & new_n51_;
  assign new_n81_ = x21 & x22 & x23 & ~x26 & x24 & x25;
endmodule
