...
module FAU ( 
  ...
  assign new_n69_ = x04 & x08 & (~x10 | ~x17);
  assign z14 = (~new_n71_ & ~x10 & ~x08 & x09) | (x05 & x08) | (x10 & x17);
  assign new_n71_ = (~x16 | ~x24 | ~x25 | ~x26) & (~new_n72_ ^ x24);
  assign new_n72_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = new_n74_ | (x06 & x08 & (~x10 | ~x17));
  assign new_n74_ = ((x17 & x26) | ~new_n72_ | ~x24 | ~x25) & new_n48_ & (x25 | (new_n72_ & x24));
  assign z16 = new_n76_ | (x07 & x08 & (~x10 | ~x17));
