...
module FAU ( 
  ...
  assign new_n61_ = (~x19 | ~x20 | (new_n62_ & x12 & x21)) & ~x08 & (x19 | x20);
  ...
  assign z12 = (x03 & x08) | (x09 & (new_n66_ | x10));
  ...
  assign new_n74_ = (~new_n47_ | ~new_n75_ | ~x25 | (x17 & x26)) & new_n48_ & (x25 | (new_n47_ & new_n75_));
  assign new_n75_ = x23 & x24;
  assign z16 = (x07 & x08) | (x09 & (new_n77_ | x10));
  assign new_n77_ = (x26 | (new_n47_ & new_n75_ & x25)) & ~x08 & (~new_n47_ | x18 | ~new_n75_ | ~x25 | ~x26);
endmodule
