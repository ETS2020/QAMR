...
module FAU ( 
  ...
  assign new_n47_ = x20 & x23 & x24 & new_n48_ & x25 & x26;
  ...
  assign new_n59_ = new_n60_ & new_n48_ & x11 & x20;
  assign new_n60_ = x23 & x24 & x25 & x26;
  assign z10 = new_n62_ | (x01 & x08 & (~x10 | x19));
  assign new_n62_ = (~x19 | ~x20 | (new_n60_ & new_n48_ & x12)) & new_n49_ & (x19 | x20);
  assign z11 = ~new_n65_ | ((new_n64_ | ~x20 | ~x21) & (x20 | x21) & new_n49_ & x19);
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n65_ = (~x02 | ~x08) & (x19 | (~x10 & (~x21 | x08 | ~x09)));
  assign z12 = new_n67_ | (x03 & x08 & (~x10 | x19));
  assign new_n67_ = (new_n68_ | ~x21 | ~x22 | ~x19 | ~x20) & new_n49_ & (x22 | (x19 & x20 & x21));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (new_n49_ & ((new_n60_ & x15) | (~new_n70_ & x23) | (new_n70_ & ~x23)));
  assign new_n70_ = new_n48_ & x19 & x20;
  assign z14 = new_n72_ | (x05 & x08 & (~x10 | x19));
  assign new_n72_ = (new_n73_ | x24) & new_n49_ & (~new_n73_ | ~x24 | (x16 & x25 & x26));
  assign new_n73_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = ~new_n76_ | (new_n49_ & ((~new_n75_ & x25) | (new_n73_ & x24 & ~x25)));
  assign new_n75_ = x24 & x20 & x23 & new_n48_ & (~x17 | ~x26);
  assign new_n76_ = (~x06 | ~x08) & (x19 | (~x10 & (~x25 | x08 | ~x09)));
  assign z16 = ~new_n79_ | (~new_n78_ & new_n49_ & (~new_n47_ | x18));
  assign new_n78_ = (~new_n73_ | ~x24 | ~x25) & ~x26;
