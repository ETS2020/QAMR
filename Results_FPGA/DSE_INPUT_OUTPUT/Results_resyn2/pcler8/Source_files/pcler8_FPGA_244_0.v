...
module FAU ( 
  ...
  assign z10 = new_n61_ | (x01 & x08) | (~x09 & ~x26);
  ...
  assign new_n70_ = (~x04 | ~x08) & (x09 | x26);
  assign z14 = z06 | (~new_n72_ & new_n48_);
  assign new_n72_ = (~x16 | ~x24 | ~x25 | ~x26) & ((~x24 & (~new_n47_ | ~x23)) | (new_n47_ & x23 & x24));
  assign z15 = new_n74_ | (x06 & x08 & (x09 | x26));
  assign new_n74_ = new_n48_ & ((x17 & x25 & x26) | (new_n75_ ^ x25));
  assign new_n75_ = x23 & x24 & x19 & x20 & x21 & x22;
  assign z16 = new_n78_ | (~new_n77_ & new_n48_ & (x26 | (new_n75_ & x25)));
  assign new_n77_ = new_n59_ & x22 & x20 & x21 & ~x18 & x19;
  assign new_n78_ = x07 & x08 & (x09 | x26);
endmodule
