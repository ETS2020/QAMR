...
module FAU ( 
  ...
  assign z09 = (~new_n59_ & ~x10 & ~x08 & x09) | (x00 & x08 & (~x10 | ~x18));
  ...
  assign new_n62_ = x01 & x08 & (~x10 | ~x18);
  assign z11 = new_n64_ | (x02 & x08 & (~x10 | ~x18));
  ...
  assign new_n69_ = (~x04 | ~x08) & (~x10 | ~x18);
  assign z14 = (~new_n71_ & ~x10 & ~x08 & x09) | (x05 & x08) | (x10 & x18);
  ...
  assign z16 = new_n76_ | (x07 & x08 & (~x10 | ~x18));
