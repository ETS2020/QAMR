...
module FAU ( 
  ...
  assign z09 = (x00 & x08) | (~x10 & (x17 | (~new_n58_ & ~x08 & x09)));
  ...
  assign z11 = new_n65_ | (x02 & x08 & (x10 | ~x17));
  assign new_n65_ = (new_n66_ | ~x19 | ~x20 | ~x21) & new_n48_ & ((x19 & x20) | x21);
  assign new_n66_ = x24 & x25 & x26 & x23 & x13 & x22;
  assign z12 = (x03 & x08) | (~x10 & (new_n68_ | x17));
  assign new_n68_ = (new_n69_ | ~x19 | ~x20 | ~x21 | ~x22) & new_n62_ & (x22 | (x19 & x20 & x21));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (((new_n72_ & x15) | ~new_n71_ | ~x23) & new_n48_ & (new_n71_ | x23));
  assign new_n71_ = x21 & x22 & x19 & x20;
  assign new_n72_ = x24 & x25 & x26;
  assign z14 = (x05 & x08) | (~new_n74_ & ~x10);
  assign new_n74_ = ~x17 & (~new_n62_ | ((~new_n72_ | ~x16) & (~new_n75_ ^ x24)));
  assign new_n75_ = x23 & x21 & x22 & x19 & x20;
  assign z15 = new_n77_ | (x06 & x08);
  assign new_n77_ = ~x10 & (x17 | ((new_n47_ | x25) & new_n62_ & (~new_n47_ | ~x25)));
  assign z16 = (x07 & x08) | (~x10 & (new_n79_ | x17));
  assign new_n79_ = (x26 | (new_n47_ & x25)) & new_n62_ & (~new_n59_ | ~new_n80_);
