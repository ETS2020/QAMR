...
module FAU ( 
  ...
  assign z09 = (~new_n60_ & ~x10 & ~x08 & x09) | (x00 & x08) | (x02 & x10);
  assign new_n60_ = x19 & (~new_n61_ | ~x11 | ~x22 | ~x20 | ~x21);
  ...
  assign new_n65_ = (~new_n66_ | ~x21 | (new_n61_ & x13 & x22)) & new_n49_ & (new_n66_ | x21);
  assign new_n66_ = x19 & x20;
  assign z12 = new_n68_ | (x03 & x08) | (x02 & x10);
  assign new_n68_ = ((new_n61_ & x14) | ~x22 | ~new_n66_ | ~x21) & new_n49_ & (x22 | (new_n66_ & x21));
  assign z13 = z05 | (((new_n48_ & x15) | ~new_n47_ | ~x23) & new_n49_ & (new_n47_ | x23));
  assign z14 = (new_n51_ & x05) | (~new_n71_ & new_n49_);
  assign new_n71_ = (~new_n48_ | ~x16) & (((~new_n47_ | ~x23) & ~x24) | (new_n47_ & x23 & x24));
  assign z15 = z07 | (~new_n73_ & new_n49_);
  assign new_n73_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n47_ & x23 & x24));
  assign z16 = (new_n51_ & x07) | ((new_n75_ | x26) & ~new_n76_ & new_n49_);
  assign new_n75_ = x25 & new_n47_ & x23 & x24;
  assign new_n76_ = new_n61_ & x22 & x20 & x21 & ~x18 & x19;
endmodule
