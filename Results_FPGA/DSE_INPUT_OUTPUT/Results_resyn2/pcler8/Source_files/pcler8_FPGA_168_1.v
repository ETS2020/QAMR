...
module FAU ( 
  ...
  assign z08 = x07 & x08;
  assign z09 = z01 | (~new_n59_ & ~x08 & x09);
  ...
  assign z12 = (x03 & x08) | (new_n67_ & (~new_n49_ | (new_n47_ & x14)));
  assign new_n67_ = new_n48_ & (x22 | (x19 & x20 & x21));
  assign z13 = (x04 & x08) | (~new_n69_ & new_n48_);
  ...
  assign z15 = (x06 & x08) | (~new_n73_ & new_n48_);
  assign new_n73_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (x24 & new_n49_ & x23));
  assign z16 = (new_n76_ & (new_n75_ | x26)) | (x07 & x08) | (~x08 & x10);
  assign new_n75_ = x25 & x24 & new_n49_ & x23;
  assign new_n76_ = ~x08 & x09 & (~new_n47_ | ~new_n49_ | x18);
endmodule
