...
module FAU ( 
  ...
  assign z11 = new_n65_ | (new_n51_ & x02);
  ...
  assign z13 = (x04 & x08) | (x09 & (x10 | (~new_n70_ & ~x08)));
  assign new_n70_ = (~new_n60_ | ~x15) & (~new_n71_ ^ x23);
  ...
  assign z16 = (new_n51_ & x07) | (new_n78_ & (x26 | (new_n77_ & x25)));
  assign new_n77_ = new_n48_ & x24;
  assign new_n78_ = new_n63_ & (~new_n60_ | ~new_n71_ | x18);
endmodule
