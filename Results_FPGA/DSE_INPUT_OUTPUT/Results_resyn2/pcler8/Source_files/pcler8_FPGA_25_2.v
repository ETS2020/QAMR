...
module FAU ( 
  ...
  assign z09 = (x08 & (x00 | ~x10)) | (~new_n59_ & x09 & ~x10);
  ...
  assign z11 = z03 | (~new_n63_ & x09 & ~x10);
  assign new_n63_ = (~x21 | (x19 & (x08 | x20))) & (~x19 | ~x20 | (~new_n64_ & x21));
  assign new_n64_ = x23 & x13 & x22 & x26 & x24 & x25;
  assign z12 = (x08 & (x03 | ~x10)) | (~new_n66_ & ~new_n67_ & x09 & ~x10);
  assign new_n66_ = new_n49_ & (~new_n47_ | ~x14);
  assign new_n67_ = ~x22 & (~x21 | ~x19 | ~x20);
  assign z13 = z05 | (~new_n69_ & x09 & ~x10);
  assign new_n69_ = (~new_n47_ | ~x15) & (~new_n49_ ^ x23);
  ...
  assign z16 = (~new_n76_ & new_n77_) | (x08 & (x07 | ~x10));
  assign new_n76_ = (~new_n72_ | ~x24 | ~x25) & ~x26;
  assign new_n77_ = x09 & ~x10 & (~new_n47_ | ~new_n49_ | x18);
endmodule
