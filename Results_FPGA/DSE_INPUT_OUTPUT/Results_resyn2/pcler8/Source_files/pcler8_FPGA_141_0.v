...
module FAU ( 
  ...
  assign new_n47_ = ~x08 & x09 & ~x10 & x15;
  ...
  assign z09 = (~new_n59_ & ~x08 & x09 & ~x10 & x15) | (x00 & x08 & (x10 | x15));
  assign new_n59_ = x19 & (~new_n48_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign z10 = new_n61_ | (x01 & x08 & (x10 | x15));
  ...
  assign new_n67_ = ((new_n48_ & x14) | ~new_n65_ | ~x21 | ~x22) & new_n68_ & (x22 | (new_n65_ & x21));
  assign new_n68_ = ~x08 & x09;
  assign z13 = (x04 & x08) | (~x10 & (new_n70_ | ~x15));
  assign new_n70_ = (~new_n49_ | ~x23 | (x26 & x24 & x25)) & new_n68_ & (new_n49_ | x23);
  assign z14 = (x05 & x08) | (~x10 & (~x15 | (~new_n72_ & ~x08 & x09)));
  assign new_n72_ = (~x16 | ~x24 | ~x25 | ~x26) & (~new_n73_ ^ x24);
  assign new_n73_ = x19 & x20 & x21 & x22 & x23;
  assign z15 = (x06 & x08) | (~x10 & (new_n75_ | ~x15));
  assign new_n75_ = (x25 | (new_n73_ & x24)) & new_n68_ & ((x17 & x26) | ~new_n73_ | ~x24 | ~x25);
  assign z16 = (x07 & x08) | (~x10 & (new_n77_ | ~x15));
  assign new_n77_ = (x18 | ~new_n49_ | ~x23 | ~new_n78_ | ~x26) & new_n68_ & (x26 | (new_n78_ & new_n49_ & x23));
