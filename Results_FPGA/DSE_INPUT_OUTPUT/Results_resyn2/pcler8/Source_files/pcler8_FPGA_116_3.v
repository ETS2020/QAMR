...
module FAU ( 
  ...
  assign new_n69_ = ~x10 & ((new_n47_ & x23 & (~new_n48_ | ~x15)) | x08 | (~new_n47_ & ~x23));
  assign z14 = z06 | (~new_n71_ & new_n62_);
  assign new_n71_ = (~new_n48_ | ~x16) & (x24 ^ (~new_n47_ | ~x23));
  assign z15 = z07 | (new_n62_ & (new_n73_ | x25) & (~new_n73_ | ~x25 | (x17 & x26)));
  assign new_n73_ = x24 & new_n47_ & x23;
  assign z16 = (x07 & x08) | (x09 & (new_n75_ | x10));
  assign new_n75_ = (~new_n76_ | ~x25 | ~x26 | ~new_n47_ | x18) & ~x08 & (x26 | (new_n47_ & new_n76_ & x25));
