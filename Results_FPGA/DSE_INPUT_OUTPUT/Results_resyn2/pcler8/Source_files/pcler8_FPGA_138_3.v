...
module FAU ( 
  ...
  assign z00 = (x08 & x10) | (new_n47_ & new_n49_ & ~x10 & ~x08 & x09);
  ...
  assign new_n61_ = ((new_n49_ & new_n63_) | ~x19 | ~x20) & new_n62_ & (x19 | x20);
  assign new_n62_ = ~x08 & x09;
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = new_n65_ | z03;
  assign new_n65_ = (~new_n48_ | ~x21 | (new_n49_ & x13 & x22)) & new_n66_ & (new_n48_ | x21);
  assign new_n66_ = ~x10 & ~x08 & x09;
  assign z12 = ~x10 & (new_n68_ | (x03 & x08));
  assign new_n68_ = ((new_n49_ & x14) | ~new_n48_ | ~x21 | ~x22) & new_n62_ & ((new_n48_ & x21) | x22);
  assign z13 = z05 | (new_n66_ & ((new_n49_ & x15) | (new_n47_ ^ x23)));
  ...
  assign new_n74_ = ((x17 & x26) | ~new_n72_ | ~x24 | ~x25) & new_n62_ & (x25 | (new_n72_ & x24));
  assign z16 = z08 | (new_n76_ & (x18 | ~new_n47_ | ~new_n49_));
  assign new_n76_ = new_n66_ & (x26 | (new_n72_ & x24 & x25));
endmodule
