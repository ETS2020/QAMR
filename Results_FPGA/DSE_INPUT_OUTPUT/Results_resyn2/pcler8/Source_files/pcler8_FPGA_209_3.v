...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n61_, new_n62_, new_n64_,
    new_n65_, new_n67_, new_n68_, new_n71_, new_n72_, new_n74_, new_n76_,
    new_n77_;
  ...
  assign z09 = (~new_n59_ & ~x10 & ~x08 & x09) | (x00 & x08) | (x10 & x13);
  ...
  assign z11 = ~new_n64_ | (x13 & ((new_n47_ & new_n65_) | x10));
  assign new_n64_ = (~x02 | ~x08) & ((x21 & x19 & x20) | ~new_n48_ | (~x21 & (~x19 | ~x20)));
  assign new_n65_ = x19 & x20 & ~x08 & x09 & x22;
