...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n60_, new_n62_, new_n63_,
    ...
    new_n76_;
  assign z00 = new_n48_ & new_n49_ & x22 & x23 & new_n47_ & x21;
  ...
  assign new_n62_ = (~x19 | ~x20 | (new_n60_ & new_n63_)) & ~x08 & x09 & (x19 | x20);
  assign new_n63_ = x12 & x21 & x22;
  assign z11 = (x02 & x08) | (~x10 & (new_n65_ | x18));
  assign new_n65_ = (new_n66_ | ~new_n47_ | ~x21) & ~x08 & x09 & (new_n47_ | x21);
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = new_n68_ | (x03 & x08 & (x10 | ~x18));
  assign new_n68_ = ((new_n60_ & x14) | ~new_n47_ | ~x21 | ~x22) & new_n48_ & (x22 | (new_n47_ & x21));
  assign z13 = (x04 & x08) | (~x10 & (new_n70_ | x18));
  assign new_n70_ = ((new_n49_ & x15) | ~new_n71_ | ~x23) & ~x08 & x09 & (new_n71_ | x23);
  assign new_n71_ = x19 & x20 & x21 & x22;
  assign z14 = (x05 & x08) | (~x10 & (x18 | (~new_n73_ & ~x08 & x09)));
  assign new_n73_ = ~new_n74_ & (~new_n49_ | ~x16);
  assign new_n74_ = (x24 | (x22 & x23 & x21 & x19 & x20)) & (~x23 | ~x24 | ~x19 | ~x20 | ~x21 | ~x22);
  assign z15 = z07 | (new_n48_ & ((x17 & x25 & x26) | (~new_n76_ ^ ~x25)));
  assign new_n76_ = new_n71_ & x23 & x24;
  assign z16 = z08 | ((~x26 | ~new_n76_ | ~x25) & new_n48_ & (x26 | (new_n76_ & x25)));
endmodule
