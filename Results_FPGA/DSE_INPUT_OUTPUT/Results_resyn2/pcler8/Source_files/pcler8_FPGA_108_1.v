...
module FAU ( 
  ...
  assign z00 = ~x10 & (new_n47_ | x16);
  assign new_n47_ = new_n48_ & x23 & new_n49_ & x24 & x25 & x26;
  ...
  assign z09 = (~new_n59_ & ~x08 & x09 & ~x10 & ~x16) | (x00 & x08 & (x10 | ~x16));
  ...
  assign z11 = (x02 & x08) | (~x10 & (new_n65_ | x16));
  assign new_n65_ = (new_n66_ | ~x21 | ~x19 | ~x20) & new_n49_ & (x21 | (x19 & x20));
  assign new_n66_ = x13 & x22 & x25 & x26 & x23 & x24;
  assign z12 = (x03 & x08) | (~x10 & (new_n68_ | x16));
  assign new_n68_ = (new_n69_ | ~x22 | ~x21 | ~x19 | ~x20) & new_n49_ & (x22 | (x21 & x19 & x20));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | ((new_n72_ | ~new_n48_ | ~x23) & new_n71_ & (new_n48_ | x23));
  assign new_n71_ = ~x08 & x09 & ~x10 & ~x16;
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & x08) | (~new_n74_ & ~x10);
  assign new_n74_ = ~x16 & ((~x24 & (~new_n48_ | ~x23)) | ~new_n49_ | (new_n48_ & x23 & x24));
  assign z15 = (x06 & x08) | (~x10 & (x16 | (~new_n76_ & ~x08 & x09)));
  assign new_n76_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n48_ & new_n77_));
  assign new_n77_ = x23 & x24;
  assign z16 = new_n79_ | (x07 & x08 & (x10 | ~x16));
  assign new_n79_ = (x26 | (x25 & new_n48_ & new_n77_)) & new_n71_ & (~new_n77_ | ~x25 | ~x26 | ~new_n48_ | x18);
endmodule
