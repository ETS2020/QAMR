...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n60_, new_n62_, new_n63_,
    ...
    new_n77_;
  assign z00 = (~x00 & x10) | (new_n48_ & new_n49_ & new_n47_ & x23);
  assign new_n47_ = x19 & x20 & x21 & x22;
  assign new_n48_ = x24 & x25 & x26;
  assign new_n49_ = ~x10 & ~x08 & x09;
  assign z01 = x00 ? x08 : x10;
  assign z02 = (x01 & x08) | (~x00 & x10);
  assign z03 = x02 & x08 & (x00 | ~x10);
  assign z04 = x03 & x08 & (x00 | ~x10);
  assign z05 = (x04 & x08) | (~x00 & x10);
  assign z06 = x05 & x08 & (x00 | ~x10);
  assign z07 = (x06 & x08) | (~x00 & x10);
  assign z08 = (x07 & x08) | (~x00 & x10);
  assign z09 = (x00 & x08) | (~new_n59_ & new_n49_);
  ...
  assign new_n63_ = x01 & x08 & (x00 | ~x10);
  assign z11 = new_n65_ | (x02 & x08) | (~x00 & x10);
  assign new_n65_ = (~new_n66_ | ~x21 | (new_n60_ & x13 & x22)) & new_n49_ & (new_n66_ | x21);
  assign new_n66_ = x19 & x20;
  assign z12 = new_n68_ | (x03 & x08) | (~x00 & x10);
  assign new_n68_ = ((new_n60_ & x14) | ~x22 | ~new_n66_ | ~x21) & new_n49_ & (x22 | (new_n66_ & x21));
  assign z13 = new_n70_ | (x04 & x08 & (x00 | ~x10));
  assign new_n70_ = ((new_n48_ & x15) | ~new_n47_ | ~x23) & new_n49_ & (new_n47_ | x23);
  assign z14 = z06 | (~new_n72_ & new_n49_);
  assign new_n72_ = (~new_n48_ | ~x16) & ((~x24 & (~new_n47_ | ~x23)) | (new_n47_ & x23 & x24));
  assign z15 = (~new_n74_ & ~x10 & ~x08 & x09) | (x06 & x08 & (x00 | ~x10));
  assign new_n74_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n47_ & new_n75_));
  assign new_n75_ = x23 & x24;
  assign z16 = new_n77_ | (x07 & x08 & (x00 | ~x10));
  assign new_n77_ = (x26 | (x25 & new_n47_ & new_n75_)) & new_n49_ & (~new_n75_ | ~x25 | ~x26 | ~new_n47_ | x18);
endmodule
