...
module FAU ( 
  ...
  assign z10 = (x01 & x08) | (~x10 & (new_n63_ | ~x16));
  assign new_n63_ = ((new_n61_ & new_n64_) | ~x19 | ~x20) & new_n48_ & (x19 | x20);
  assign new_n64_ = x12 & x21 & x22;
  assign z11 = (x02 & x08) | (~x10 & (new_n66_ | ~x16));
  assign new_n66_ = (new_n67_ | ~x21 | ~x19 | ~x20) & new_n48_ & (x21 | (x19 & x20));
  assign new_n67_ = x24 & x25 & x26 & x23 & x13 & x22;
  ...
  assign z13 = new_n73_ | ((new_n72_ | ~new_n50_ | ~x23) & new_n47_ & (new_n50_ | x23));
  assign new_n72_ = x15 & x24 & x25 & x26;
  assign new_n73_ = x04 & x08 & (x10 | x16);
  assign z14 = (~new_n75_ & ~x08 & x09 & ~x10 & x16) | (x05 & x08 & (x10 | x16));
  assign new_n75_ = (~x24 | ~x25 | ~x26) & ((new_n50_ & x23 & x24) | (~x24 & (~new_n50_ | ~x23)));
  assign z15 = (~new_n77_ & ~x08 & x09 & ~x10 & x16) | (x06 & x08 & (x10 | x16));
  assign new_n77_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n49_ & new_n50_));
  assign z16 = (x07 & x08) | (~x10 & (new_n79_ | ~x16));
  assign new_n79_ = (x26 | (x25 & new_n49_ & new_n50_)) & new_n48_ & (~new_n49_ | ~x25 | ~x26 | ~new_n50_ | x18);
endmodule
