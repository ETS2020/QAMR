...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n60_, new_n62_, new_n64_,
    ...
    new_n77_;
  assign z00 = (~x09 & ~x19) | (new_n47_ & new_n48_ & new_n49_);
  ...
  assign z10 = z02 | (((new_n60_ & new_n62_) | ~x19 | ~x20) & new_n49_ & (x19 | x20));
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = new_n64_ | z03;
  assign new_n64_ = (~new_n65_ | ~x21 | (new_n60_ & x13 & x22)) & new_n49_ & (new_n65_ | x21);
  assign new_n65_ = x19 & x20;
  assign z12 = new_n67_ | (x03 & x08 & (x09 | x19));
  assign new_n67_ = ((new_n60_ & x14) | ~new_n65_ | ~x21 | ~x22) & new_n49_ & (x22 | (new_n65_ & x21));
  assign z13 = ~new_n70_ | (new_n49_ & ((x15 & new_n48_ & x23) | (new_n69_ ^ x23)));
  assign new_n69_ = new_n65_ & x21 & x22;
  assign new_n70_ = (~x04 | ~x08) & (x09 | x19);
  assign z14 = z06 | (~new_n72_ & new_n49_);
  assign new_n72_ = (~x16 | ~x26 | ~x24 | ~x25) & (~new_n47_ ^ x24);
  assign z15 = z07 | (((x17 & x26) | ~new_n74_ | ~x25) & new_n49_ & (new_n74_ | x25));
  assign new_n74_ = x23 & x19 & x20 & x21 & x22 & x24;
  assign z16 = new_n76_ | (x07 & x08 & (x09 | x19));
  assign new_n76_ = (x26 | (new_n74_ & x25)) & new_n49_ & (~new_n60_ | ~new_n77_);
  assign new_n77_ = ~x18 & x19 & x20 & x21 & x22;
endmodule
