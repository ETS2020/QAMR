...
module FAU ( 
  ...
  assign z00 = (~x09 & ~x26) | (new_n49_ & new_n47_ & new_n50_);
  ...
  assign new_n63_ = x01 & x08 & (x09 | x26);
  assign z11 = new_n65_ | (~x09 & ~x26) | (x02 & x08);
  ...
  assign new_n69_ = (~x04 | ~x08) & (x09 | x26);
  assign z14 = (~new_n71_ & ~x10 & ~x08 & x09) | (x05 & x08 & (x09 | x26));
  assign new_n71_ = (~x16 | ~x26 | ~x24 | ~x25) & (~new_n72_ ^ x24);
  assign new_n72_ = x23 & x19 & x20 & x21 & x22;
  assign z15 = new_n74_ | (~x09 & ~x26) | (x06 & x08);
  assign new_n74_ = ((x17 & x26) | ~new_n72_ | ~x24 | ~x25) & new_n49_ & (x25 | (new_n72_ & x24));
