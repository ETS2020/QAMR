...
module FAU ( 
  ...
  assign z13 = new_n69_ | (x04 & x08);
  assign new_n69_ = x09 & (x10 | (new_n70_ & (~new_n47_ | (new_n48_ & x15))));
  assign new_n70_ = ~x08 & (x23 | (x19 & x20 & x21 & x22));
  assign z14 = (x05 & x08) | (x09 & (x10 | (~new_n72_ & ~x08)));
  assign new_n72_ = (~x16 | ~x24 | ~x25 | ~x26) & (new_n47_ ^ ~x24);
  assign z15 = new_n74_ | (x06 & x08 & (~x09 | ~x10));
  assign new_n74_ = (new_n75_ | x25) & new_n49_ & (~new_n75_ | ~x25 | (x17 & x26));
  assign new_n75_ = x23 & x19 & x20 & x21 & x22 & x24;
  assign z16 = z08 | (~new_n77_ & new_n49_ & (x26 | (new_n75_ & x25)));
  assign new_n77_ = new_n60_ & x22 & x20 & x21 & ~x18 & x19;
endmodule
