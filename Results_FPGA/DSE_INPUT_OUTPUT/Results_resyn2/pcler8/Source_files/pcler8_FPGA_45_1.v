...
module FAU ( 
  ...
  assign new_n74_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n47_ & x23 & x24));
  assign z16 = (new_n50_ & x07) | (~new_n77_ & new_n48_ & (new_n76_ | x26));
  assign new_n76_ = x25 & new_n47_ & x23 & x24;
  assign new_n77_ = new_n60_ & ~x18 & x19 & x22 & x20 & x21;
endmodule
