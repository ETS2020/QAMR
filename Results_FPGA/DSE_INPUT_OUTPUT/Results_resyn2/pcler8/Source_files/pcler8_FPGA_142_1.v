...
module FAU ( 
  ...
  assign z06 = (~x03 & x10) | (x05 & x08);
  assign z07 = (~x03 & x10) | (x06 & x08);
  assign z08 = (~x03 & x10) | (x07 & x08);
  ...
  assign z13 = ~new_n70_ | (new_n48_ & (new_n47_ | x23) & (new_n69_ | ~new_n47_ | ~x23));
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign new_n70_ = (x03 | ~x10) & (~x04 | ~x08);
  assign z14 = (new_n51_ & x05) | (~new_n72_ & new_n48_);
  ...
  assign z16 = (new_n51_ & x07) | (~new_n77_ & ~new_n78_ & new_n48_);
  assign new_n77_ = ~x26 & (~new_n75_ | ~x25);
  assign new_n78_ = new_n60_ & x22 & x20 & x21 & ~x18 & x19;
endmodule
