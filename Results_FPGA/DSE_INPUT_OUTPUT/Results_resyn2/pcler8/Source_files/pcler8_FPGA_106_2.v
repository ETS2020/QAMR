...
module FAU ( 
  ...
  assign z00 = x25 & x24 & new_n47_ & x23 & new_n48_ & x26;
  assign new_n47_ = x19 & x20 & x21 & x22;
  assign new_n48_ = (~x01 | x11) & ~x10 & ~x08 & x09;
  ...
  assign z09 = z01 | (~new_n59_ & ~x10 & ~x08 & x09);
  assign new_n59_ = x19 & (~new_n60_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign new_n60_ = x23 & x24 & x25 & x26;
  assign z10 = new_n62_ | (x11 & x01 & x08);
  assign new_n62_ = ((new_n60_ & new_n63_) | ~x19 | ~x20) & new_n48_ & (x19 | x20);
  ...
  assign new_n68_ = ((new_n60_ & x14) | ~new_n66_ | ~x21 | ~x22) & new_n48_ & (x22 | (new_n66_ & x21));
  assign z13 = ~new_n50_ & ((x04 & x08) | (~new_n70_ & ~x10 & ~x08 & x09));
  assign new_n70_ = (~new_n60_ | ~x15) & (~new_n47_ ^ x23);
  assign z14 = (~new_n72_ & ~x10 & ~x08 & x09) | new_n50_ | (x05 & x08);
  assign new_n72_ = (~x16 | ~x24 | ~x25 | ~x26) & (~x24 ^ (new_n47_ & x23));
  assign z15 = (~new_n74_ & ~x10 & ~x08 & x09) | new_n50_ | (x06 & x08);
  assign new_n74_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (x24 & new_n47_ & x23));
  assign z16 = z08 | (~new_n76_ & new_n48_ & (~new_n60_ | ~new_n47_ | x18));
  assign new_n76_ = ~x26 & (~x25 | ~x24 | ~new_n47_ | ~x23);
endmodule
