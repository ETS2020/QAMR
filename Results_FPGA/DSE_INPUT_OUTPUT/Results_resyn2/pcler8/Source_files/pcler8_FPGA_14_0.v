...
module FAU ( 
  ...
  assign new_n74_ = x09 & ((new_n75_ & x25 & (~x17 | ~x26)) | x08 | (~new_n75_ & ~x25));
  assign new_n75_ = x23 & x24 & x19 & x20 & x21 & x22;
  assign z16 = (new_n77_ & (x26 | (new_n75_ & x25))) | (new_n50_ & x07);
  assign new_n77_ = new_n48_ & (~new_n60_ | ~new_n78_);
