...
module FAU ( 
  ...
  assign z09 = (x00 & x08 & (x06 | x10)) | (~new_n59_ & ~x08 & x09 & x06 & ~x10);
  ...
  assign z12 = (x03 & x08) | (~x10 & (new_n68_ | ~x06));
  ...
  assign z15 = x06 & (x08 | (~new_n75_ & x09 & ~x10));
  assign new_n75_ = (~x17 | ~x25 | ~x26) & (~x25 ^ (new_n47_ & new_n76_));
  assign new_n76_ = x23 & x24;
  assign z16 = (x07 & x08) | (~x10 & (new_n78_ | ~x06));
  assign new_n78_ = (x26 | (x25 & new_n47_ & new_n76_)) & new_n49_ & (~new_n76_ | ~x25 | ~x26 | ~new_n47_ | x18);
endmodule
