...
module FAU ( 
  ...
  assign z09 = z01 | (~new_n58_ & new_n59_ & ~x10);
  assign new_n58_ = x19 & (~new_n47_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign new_n59_ = ~x08 & x09;
  assign z10 = ~x10 & (new_n61_ | (x01 & x08));
  ...
  assign z12 = ~x10 & (new_n67_ | (x03 & x08));
  assign new_n67_ = ((new_n47_ & x14) | ~new_n65_ | ~x21 | ~x22) & new_n59_ & ((new_n65_ & x21) | x22);
  ...
  assign new_n74_ = ((x17 & x26) | ~new_n72_ | ~x24 | ~x25) & new_n59_ & (x25 | (new_n72_ & x24));
  assign z16 = z08 | (new_n76_ & (x18 | ~new_n47_ | ~new_n48_));
  assign new_n76_ = new_n59_ & ~x10 & (x26 | (new_n72_ & x24 & x25));
endmodule
