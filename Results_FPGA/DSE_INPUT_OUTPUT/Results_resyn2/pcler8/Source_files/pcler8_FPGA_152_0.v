...
module FAU ( 
  ...
  assign new_n77_ = ~x08 & (~new_n59_ | ~new_n78_) & (x26 | (new_n75_ & x25));
  assign new_n78_ = ~x18 & x19 & x22 & x20 & x21;
endmodule
