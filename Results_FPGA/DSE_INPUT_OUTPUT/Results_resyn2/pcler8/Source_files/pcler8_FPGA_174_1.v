...
module FAU ( 
  ...
  assign new_n48_ = x15 & ~x10 & x25 & x24 & x26;
  ...
  assign z09 = ~new_n59_ | (new_n61_ & new_n60_ & x11 & x15 & x20);
  assign new_n59_ = (new_n50_ | ~x00 | ~x08) & (~new_n60_ | new_n50_ | x19);
  assign new_n60_ = ~x10 & ~x08 & x09;
  assign new_n61_ = x25 & x24 & x26 & x21 & x22 & x23;
  ...
  assign z12 = new_n67_ | (new_n69_ & ~x10 & x25 & x24 & x26);
  ...
  assign z13 = ~new_n72_ | (x25 & (new_n71_ | ~x15));
  assign new_n71_ = x23 & x24 & new_n60_ & x26;
  assign new_n72_ = (~x04 | ~x08) & ((~x23 & (~new_n68_ | ~x22)) | ~new_n60_ | (new_n68_ & x22 & x23));
  assign z14 = ~new_n74_ | (~new_n76_ & new_n60_ & (new_n47_ | x24));
  assign new_n74_ = (~x05 | ~x08) & (~x25 | (~new_n75_ & x15));
  assign new_n75_ = ~x10 & ~x08 & x09 & x16 & x24 & x26;
  assign new_n76_ = x23 & x24 & x22 & x21 & x19 & x20;
  assign z15 = new_n78_ | new_n50_ | (x06 & x08);
  assign new_n78_ = (~new_n76_ | ~x25 | (x17 & x26)) & new_n60_ & (new_n76_ | x25);
  assign z16 = new_n81_ | (x07 & x08) | (x25 & (new_n80_ | ~x15));
  assign new_n80_ = new_n47_ & ~x08 & x09 & ~x26 & ~x10 & x24;
  assign new_n81_ = (~new_n82_ | ~x21 | ~x22 | ~x23) & new_n60_ & x26;
  assign new_n82_ = ~x18 & x19 & x25 & x20 & x24;
endmodule
