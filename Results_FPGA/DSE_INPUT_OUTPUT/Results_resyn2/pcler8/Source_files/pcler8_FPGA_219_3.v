...
module FAU ( 
  ...
  assign z10 = (x01 & x08) | (x09 & (new_n62_ | x10));
  ...
  assign new_n68_ = ((new_n60_ & x14) | ~x22 | ~new_n66_ | ~x21) & ~x08 & (x22 | (new_n66_ & x21));
  assign z13 = new_n70_ | (x04 & x08);
  assign new_n70_ = x09 & (x10 | (new_n71_ & (~new_n47_ | (new_n48_ & x15))));
  assign new_n71_ = ~x08 & (x23 | (x19 & x20 & x21 & x22));
  assign z14 = (x05 & x08) | (x09 & (x10 | (~new_n73_ & ~x08)));
  assign new_n73_ = (~x16 | ~x24 | ~x25 | ~x26) & (new_n47_ ^ ~x24);
  assign z15 = (x06 & x08 & (~x09 | ~x10)) | (~new_n75_ & ~x10 & ~x08 & x09);
  assign new_n75_ = (new_n76_ ^ ~x25) & (~x17 | ~x25 | ~x26);
  assign new_n76_ = x23 & x19 & x20 & x21 & x22 & x24;
  assign z16 = (x07 & x08) | (x09 & (new_n78_ | x10));
  assign new_n78_ = (x26 | (new_n76_ & x25)) & ~x08 & (~new_n60_ | ~new_n79_);
  assign new_n79_ = ~x18 & x19 & x22 & x20 & x21;
endmodule
