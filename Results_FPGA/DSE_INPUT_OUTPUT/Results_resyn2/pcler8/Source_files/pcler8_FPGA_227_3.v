...
module FAU ( 
  ...
  assign new_n61_ = ((new_n47_ & new_n62_) | ~x19 | ~x20) & ~x08 & (x19 | x20);
  assign new_n62_ = x12 & x21 & x22;
  assign z11 = (x02 & x08) | (x09 & (new_n64_ | x10));
  assign new_n64_ = (~new_n65_ | ~x21 | (new_n47_ & x13 & x22)) & ~x08 & (new_n65_ | x21);
  assign new_n65_ = x19 & x20;
  assign z12 = (x03 & x08) | (x09 & (new_n67_ | x10));
  assign new_n67_ = (~new_n65_ | ~x21 | ~x22 | (new_n47_ & x14)) & ~x08 & (x22 | (new_n65_ & x21));
  assign z13 = (x04 & x08) | (x09 & (x10 | (~new_n69_ & ~x08)));
  ...
  assign z15 = (x06 & x08) | (x09 & (new_n74_ | x10));
  assign new_n74_ = (x25 | (new_n72_ & x24)) & ~x08 & ((x17 & x26) | ~new_n72_ | ~x24 | ~x25);
