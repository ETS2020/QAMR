...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n59_, new_n60_, new_n61_, new_n63_,
    new_n64_, new_n66_, new_n67_, new_n69_, new_n71_, new_n72_, new_n75_,
    new_n77_, new_n78_;
  ...
  assign new_n61_ = ~x08 & x09 & ~x10 & x16;
  ...
  assign new_n66_ = (~new_n67_ | ~x21 | (new_n60_ & x13 & x22)) & new_n49_ & (new_n67_ | x21);
  assign new_n67_ = x19 & x20;
  assign z12 = new_n69_ | (x03 & x08 & (x10 | x16));
  ...
  assign z14 = z06 | (((x25 & x26) | ~new_n47_ | ~x24) & new_n61_ & (new_n47_ | x24));
  assign z15 = new_n75_ | (x06 & x08 & (x10 | x16));
  assign new_n75_ = (x25 | (new_n47_ & x24)) & new_n61_ & (~new_n47_ | ~x24 | ~x25 | (x17 & x26));
  assign z16 = (x07 & x08) | (~x10 & (new_n77_ | ~x16));
  assign new_n77_ = (~new_n72_ | ~new_n78_ | x18 | ~x26) & new_n49_ & (x26 | (new_n72_ & new_n78_));
  assign new_n78_ = x25 & x23 & x24;
endmodule
