...
module FAU ( 
  ...
  assign z09 = (~new_n58_ & ~x10 & ~x08 & x09) | (x00 & x08 & (~x09 | ~x10));
  ...
  assign new_n69_ = ~x10 & (x08 | (~new_n47_ & ~x23) | (~new_n70_ & new_n47_ & x23));
  ...
  assign z15 = (x06 & x08) | (~new_n74_ & x09);
  assign new_n74_ = ~x10 & ((new_n75_ & x25 & (~x17 | ~x26)) | x08 | (~new_n75_ & ~x25));
  assign new_n75_ = x23 & x24 & x19 & x20 & x21 & x22;
  assign z16 = (x07 & x08) | (x09 & (x10 | (~new_n77_ & ~new_n78_ & ~x08)));
  assign new_n77_ = ~x26 & (~new_n75_ | ~x25);
  assign new_n78_ = new_n59_ & x22 & x20 & x21 & ~x18 & x19;
endmodule
