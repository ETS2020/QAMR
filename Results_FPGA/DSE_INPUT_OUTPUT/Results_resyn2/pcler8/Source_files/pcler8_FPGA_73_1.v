...
module FAU ( 
  ...
  assign new_n62_ = (~x19 | ~x20 | (new_n60_ & x12)) & new_n63_ & (x19 | x20);
  ...
  assign new_n73_ = (~x16 | ~x24 | ~x25 | ~x26) & (new_n74_ | (~new_n48_ & ~x24));
  assign new_n74_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z15 = (x06 & x08) | (~x10 & (x15 | (~new_n76_ & ~x08 & x09)));
  assign new_n76_ = (~x17 | ~x25 | ~x26) & (new_n74_ ^ ~x25);
  assign z16 = (x07 & x08) | (~x10 & (new_n78_ | x15));
  assign new_n78_ = (x26 | (new_n74_ & x25)) & new_n49_ & (~new_n74_ | x18 | ~x25 | ~x26);
endmodule
