...
module FAU ( 
  ...
  assign z00 = ~x10 & (~x14 | (new_n48_ & new_n49_ & new_n47_ & x23));
  ...
  assign new_n61_ = ~x08 & x09 & ~x10 & x14;
  assign new_n62_ = x00 & x08 & (x10 | x14);
  ...
  assign new_n68_ = (~x21 | ~x19 | ~x20 | new_n60_ | ~x22) & new_n61_ & (x22 | (x21 & x19 & x20));
  assign z13 = (x04 & x08) | (~x10 & (new_n70_ | ~x14));
  assign new_n70_ = (~new_n47_ | ~x23 | (new_n48_ & x15)) & new_n49_ & (new_n47_ | x23);
  assign z14 = (x05 & x08) | (~x10 & (~x14 | (~new_n72_ & ~x08 & x09)));
  assign new_n72_ = (~x16 | ~x24 | ~x25 | ~x26) & ((~x24 & (~new_n47_ | ~x23)) | (new_n47_ & x23 & x24));
  assign z15 = (x06 & x08) | (~x10 & (~x14 | (~new_n74_ & ~x08 & x09)));
  assign new_n74_ = (~x17 | ~x25 | ~x26) & (~new_n75_ ^ x25);
  assign new_n75_ = x19 & x20 & x21 & x22 & x23 & x24;
  assign z16 = z08 | ((x26 | (new_n75_ & x25)) & new_n61_ & (~new_n75_ | x18 | ~x25 | ~x26));
endmodule
