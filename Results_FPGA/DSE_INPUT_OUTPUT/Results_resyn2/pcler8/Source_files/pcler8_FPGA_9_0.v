...
module FAU ( 
  ...
  assign new_n66_ = new_n48_ & (x22 | (x21 & x19 & x20));
  assign z13 = (x04 & x08) | (~new_n68_ & ~x10);
  assign new_n68_ = x09 & ((~new_n69_ & new_n47_ & x23) | x08 | (~new_n47_ & ~x23));
  ...
  assign z15 = z07 | new_n73_;
  assign new_n73_ = (~new_n47_ | ~new_n74_ | ~x25 | (x17 & x26)) & new_n48_ & (x25 | (new_n47_ & new_n74_));
  assign new_n74_ = x23 & x24;
  assign z16 = new_n76_ | (new_n50_ & x07);
  assign new_n76_ = (x26 | (x25 & new_n47_ & new_n74_)) & new_n48_ & (~new_n47_ | x18 | ~new_n74_ | ~x25 | ~x26);
endmodule
