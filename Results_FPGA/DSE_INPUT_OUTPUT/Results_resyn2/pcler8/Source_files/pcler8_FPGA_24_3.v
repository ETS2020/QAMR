...
module FAU ( 
  ...
  assign z09 = (~x01 | ~x11) & (~new_n60_ | (new_n47_ & x11));
  assign new_n60_ = (~x00 | ~x08) & (~new_n48_ | x19);
  assign z10 = new_n62_ | (x01 & (x08 | x11));
  assign new_n62_ = ((new_n49_ & new_n63_) | ~x19 | ~x20) & new_n48_ & (x19 | x20);
  assign new_n63_ = x12 & x21 & x22 & x23;
  assign z11 = z03 | ((new_n65_ | ~x21 | ~x19 | ~x20) & new_n48_ & (x21 | (x19 & x20)));
  assign new_n65_ = x13 & new_n49_ & x22 & x23;
  assign z12 = z04 | new_n67_;
  assign new_n67_ = (~new_n68_ | ~x22 | (new_n49_ & x14 & x23)) & new_n69_ & (new_n68_ | x22);
  assign new_n68_ = x21 & x19 & x20;
  assign new_n69_ = (~x01 | ~x11) & ~x08 & x09 & ~x10;
  assign z13 = z05 | new_n71_;
  assign new_n71_ = ((new_n49_ & x15) | ~x23 | ~new_n68_ | ~x22) & new_n69_ & (x23 | (new_n68_ & x22));
  assign z14 = z06 | (new_n69_ & (new_n73_ | (new_n49_ & x16)));
  assign new_n73_ = ~new_n74_ & (x24 | (new_n68_ & x22 & x23));
  assign new_n74_ = x19 & x20 & x22 & x23 & x21 & x24;
  assign z15 = (~new_n76_ & new_n48_) | new_n50_ | (x06 & x08);
  assign new_n76_ = (~x17 | ~x25 | ~x26) & (~new_n74_ ^ x25);
  assign z16 = ~new_n79_ | (new_n78_ & (x26 | (new_n74_ & x25)));
  assign new_n78_ = new_n48_ & (~new_n49_ | ~x22 | ~x23 | ~new_n68_ | x18);
