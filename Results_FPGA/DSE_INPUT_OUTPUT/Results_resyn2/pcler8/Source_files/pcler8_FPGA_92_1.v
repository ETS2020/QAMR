...
module FAU ( 
  ...
  assign new_n54_ = x08 & (x10 | ~x18);
  assign z05 = new_n54_ & x04;
  assign z06 = new_n54_ & x05;
  assign z07 = new_n54_ & x06;
  assign z08 = (x07 & x08) | (~x10 & x18);
  assign z09 = (new_n54_ & x00) | (~new_n60_ & new_n48_);
  assign new_n60_ = x19 & (~new_n47_ | ~x21 | ~x22 | ~x11 | ~x20);
  assign z10 = (new_n54_ & x01) | (~new_n62_ & new_n48_ & (x19 | x20));
  assign new_n62_ = new_n63_ & (~new_n47_ | ~x12 | ~x21 | ~x22);
  assign new_n63_ = x19 & x20;
  assign z11 = ((new_n65_ | ~new_n63_ | ~x21) & new_n48_ & (new_n63_ | x21)) | (new_n54_ & x02);
  assign new_n65_ = x24 & x25 & x26 & x23 & x13 & x22;
  assign z12 = (x03 & x08) | (~x10 & (new_n67_ | x18));
  assign new_n67_ = new_n68_ & (~new_n49_ | (new_n47_ & x14));
  ...
  assign z16 = (new_n54_ & x07) | ((~x26 | ~new_n75_ | ~x25) & new_n48_ & (x26 | (new_n75_ & x25)));
endmodule
