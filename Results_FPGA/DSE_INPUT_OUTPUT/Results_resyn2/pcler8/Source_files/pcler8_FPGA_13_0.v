...
module FAU ( 
  ...
  assign z11 = (x02 & x08) | (~x10 & (new_n65_ | ~x20));
  assign new_n65_ = ((new_n60_ & x13 & x22) | ~x19 | ~x21) & new_n48_ & (x19 | x21);
  assign z12 = new_n67_ | z04;
  assign new_n67_ = (~x22 | ~x19 | ~x21 | (new_n60_ & x14)) & new_n61_ & (x22 | (x19 & x21));
  assign z13 = (x04 & x08) | (~x10 & (new_n69_ | ~x20));
  assign new_n69_ = (new_n70_ | ~x23 | ~x22 | ~x19 | ~x21) & new_n48_ & (x23 | (x22 & x19 & x21));
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign z14 = new_n72_ | (x05 & x08 & (x10 | x20));
  assign new_n72_ = (new_n47_ | x24) & new_n61_ & (~new_n47_ | ~x24 | (new_n49_ & x16));
  assign z15 = z07 | (new_n61_ & ((x17 & x25 & x26) | (new_n74_ ^ x25)));
  assign new_n74_ = x22 & x19 & x21 & x23 & x24;
  assign z16 = (x07 & x08) | (~x10 & (new_n76_ | ~x20));
  assign new_n76_ = (x26 | (new_n74_ & x25)) & new_n48_ & (~new_n74_ | x18 | ~x25 | ~x26);
endmodule
