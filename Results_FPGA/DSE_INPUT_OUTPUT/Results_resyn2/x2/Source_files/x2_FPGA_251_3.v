...
module FAU ( 
  ...
  wire new_n21_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_;
  ...
  assign z4 = ~x7 | (x8 & x9) | x5 | ~x6;
  assign z5 = ~x6 | (~x5 & (new_n27_ | new_n28_));
  assign new_n27_ = ~x9 & (~x8 | (x7 & x3 & ~x4));
  assign new_n28_ = (~x7 | (x8 & x9)) & (x7 | ~x8) & x2 & ~x0 & ~x1;
  assign z6 = ~x6 | (~x5 & (new_n21_ | (x7 & (new_n30_ | new_n31_))));
