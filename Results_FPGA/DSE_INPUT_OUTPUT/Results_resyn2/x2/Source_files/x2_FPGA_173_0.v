...
module FAU ( 
  ...
  assign z3 = x7 | (x5 & (~new_n23_ | ~x8 | x9));
  ...
  assign z6 = ~new_n30_ & (~new_n31_ | (x9 & (new_n23_ | ~x8)));
  assign new_n30_ = ~x7 & (~x5 | (x6 & ((~x8 & x9) | x7 | (x8 & ~x9))));
  assign new_n31_ = x6 & ((~x8 & x9) | x7 | (x8 & ~x9)) & (~x3 | ~x4 | ~x8 | x9);
endmodule
