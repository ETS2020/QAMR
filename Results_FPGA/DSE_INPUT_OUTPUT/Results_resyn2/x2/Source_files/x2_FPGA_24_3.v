...
module FAU ( 
  ...
  assign z2 = ~x9 & ~x7 & ~x8;
  assign z3 = (~x5 & (x7 | (x8 & x9))) | (~x7 & (~new_n23_ | ~x8 | x9));
  assign new_n23_ = ~x2 & ~x0 & ~x1;
  assign z4 = ~x7 | (~x5 & (~x6 | (x8 & x9)));
  assign z5 = new_n27_ | new_n28_ | (~new_n26_ & x2 & ~x0 & ~x1);
  assign new_n26_ = (x7 | x8) & (x5 | ~x7 | ~x8 | ~x9);
  assign new_n27_ = (~x5 | ~x7) & ((x5 & x8 & x9) | ~x6 | (~x8 & ~x9));
  assign new_n28_ = ~x5 & x7 & ~x9 & x3 & ~x4;
  assign z6 = new_n32_ | ((new_n30_ | new_n31_) & ~x5 & x7);
  assign new_n30_ = x9 & (~x8 | (~x2 & ~x0 & ~x1));
  assign new_n31_ = x8 & ~x9 & x3 & x4;
  assign new_n32_ = ((x5 & x8 & x9) | ~x6 | (~x8 & ~x9)) & (~x7 | (~x5 & ~x6));
endmodule
