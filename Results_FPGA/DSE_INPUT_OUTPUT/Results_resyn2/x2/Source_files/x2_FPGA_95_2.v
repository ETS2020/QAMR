...
module FAU ( 
  ...
  assign z1 = x8 | (x9 ? ~x7 : (x4 | x7));
  assign z2 = ~x9 & (x4 | (~x7 & ~x8));
  assign z3 = ~new_n23_ | ~x8 | x4 | x7 | x9;
  assign new_n23_ = ~x2 & ~x0 & ~x1;
  assign z4 = (x8 & x9) | ~x6 | ~x7 | (x4 & ~x9);
  assign z5 = new_n26_ | new_n27_ | ~new_n28_;
  assign new_n26_ = (x7 ? (x8 & x9) : ~x8) & x2 & ~x0 & ~x1;
  assign new_n27_ = ~x9 & ((x3 & x7) | x4 | ~x8);
  assign new_n28_ = x6 & (~x8 | ~x9 | ~x5 | x7);
  assign z6 = new_n30_ | (x9 & (~new_n31_ | (x7 & (new_n23_ | ~x8))));
  assign new_n30_ = ~x4 & (~x6 | (~x9 & ~x7 & ~x8));
  assign new_n31_ = x6 & (~x8 | ~x5 | x7);
endmodule
