...
module FAU ( 
  ...
  assign z3 = ~new_n23_ | (x3 & ~x4) | x0 | x9;
  assign new_n23_ = ~x7 & x8 & ~x1 & ~x2;
  assign z4 = (x8 & x9) | (x3 & ~x4) | ~x6 | ~x7;
  assign z5 = new_n26_ | ~new_n28_ | ~new_n27_ | (x3 & ~x4);
  assign new_n26_ = (~x7 | (x8 & x9)) & (x7 | ~x8) & x2 & ~x0 & ~x1;
  assign new_n27_ = x6 & (x7 | x8 | x9);
  assign new_n28_ = (~x9 | ~x5 | x7 | ~x8) & ((~x7 & ~x8) | (x6 & (x8 | x9)));
  assign z6 = (~x3 | x4) & (~new_n31_ | (~new_n30_ & x9));
  assign new_n30_ = (~x5 | x7 | ~x8) & (~x7 | (x8 & (x0 | x1 | x2)));
  assign new_n31_ = x6 & (x7 | x8 | x9) & (~x3 | x9 | ~x7 | ~x8);
endmodule
