...
module FAU ( 
  ...
  assign new_n27_ = (x9 | (x8 & (x4 | ~x7))) & x6 & (~x8 | ~x9 | ~x5 | x7);
  assign z6 = new_n31_ | ((x3 | x4) & (~new_n30_ | (~new_n29_ & x9)));
  assign new_n29_ = (~x7 | (x8 & (x2 | x0 | x1))) & (~x5 | x7 | ~x8);
  assign new_n30_ = x6 & (x9 | x7 | x8);
  assign new_n31_ = x7 & x8 & ~x9 & x3 & x4;
endmodule
