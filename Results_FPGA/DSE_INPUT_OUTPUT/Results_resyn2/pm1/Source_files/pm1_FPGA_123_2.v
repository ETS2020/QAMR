// Benchmark "FAU" written by ABC on Thu Aug 13 16:58:47 2020
...
module FAU ( 
  ...
  assign z00 = (~x12 | x14) & (x11 | x01 | x12);
  assign z01 = ~x12 | (x11 & x14);
  assign z02 = ~new_n34_ | ~x11 | ~x09 | ~x12 | ~x14;
  assign new_n34_ = x05 & x06 & x07 & x08;
  assign z03 = ~x12 | (x14 & (new_n34_ | ~x09 | ~x11));
  assign z05 = ~x13 | (x12 & ~x14);
  assign z06 = (~new_n38_ | (~x11 & x12)) & x01 & x09 & (~x12 | x14);
  assign new_n38_ = x04 & x02 & x03;
  assign z07 = ~x15 & (~x12 | x14);
  assign z08 = (new_n38_ & x09 & x12 & x14) | (~new_n41_ & (~x12 | x14));
  assign new_n41_ = x11 & x00 & ~x10;
  assign z09 = (x12 | (~x11 & x00 & ~x10)) & (~x12 | ~x14 | (x11 & x00 & ~x10));
