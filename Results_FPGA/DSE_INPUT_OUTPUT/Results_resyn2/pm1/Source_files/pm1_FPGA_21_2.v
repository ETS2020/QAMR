// Benchmark "FAU" written by ABC on Thu Aug 13 16:58:02 2020
...
module FAU ( 
  ...
  assign z10 = x12 & ((~new_n39_ & new_n45_) | ~x14);
  assign new_n45_ = x00 & ~x10 & x09 & x11;
  assign z11 = new_n42_ & ((~new_n39_ & x01 & x09 & x12 & x14) | (~x01 & ~x12));
