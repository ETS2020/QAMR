...
module FAU ( 
  ...
  assign z06 = ((~new_n39_ & (~x10 | ~x12)) | (x12 & ~x10 & ~x11)) & x01 & x09;
  assign new_n39_ = x04 & x02 & x03;
  assign z07 = ~x15 & (~x10 | ~x12);
  assign z08 = (new_n39_ & x09 & x12) | ~x00 | x10 | ~x11;
  assign z09 = (x12 | (~x10 & ~x11)) & (x00 | x10) & (~x12 | x10 | x11);
  assign z10 = x12 & (x10 | (~new_n39_ & x00 & x09 & x11));
  assign z11 = (x10 & x12) | (new_n45_ & ((~new_n39_ & x01 & x09 & x12) | (~x12 & ~x01 & ~x10)));
  assign new_n45_ = x00 & x11;
  assign z12 = x12 & (x10 | (new_n45_ & ~x09));
endmodule
