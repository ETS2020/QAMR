...
module FAU ( 
  ...
  assign new_n34_ = x12 & ~x13 & x09 & x11;
  assign z03 = ~x12 | (~new_n36_ & ~x13);
  assign new_n36_ = (~x07 | ~x08 | ~x05 | ~x06) & x09 & x11;
  assign z04 = ~x14 | (x12 & x13);
  assign z05 = x12 | ~x13;
  assign z06 = (x12 & (x13 | (~x11 & x01 & x09))) | (~new_n40_ & x01 & x09);
  assign new_n40_ = x04 & x02 & x03;
  assign z07 = ~x15 | (x12 & x13);
  assign z08 = ~new_n43_ | (x12 & (x13 | (new_n40_ & x09)));
  assign new_n43_ = x11 & x00 & ~x10;
  assign z09 = (x12 | (~x11 & x00 & ~x10)) & ((x11 & x00 & ~x10) | ~x12 | x13);
  assign z10 = ~new_n40_ & new_n34_ & x00 & ~x10;
  assign z11 = (x12 & x13) | (new_n43_ & ((~x01 & ~x12) | (~new_n40_ & x01 & x09 & x12)));
  assign z12 = x12 & (x13 | (new_n43_ & ~x09));
endmodule
