...
module FAU ( 
  ...
  assign new_n39_ = (~x04 | ~x02 | ~x03) & x01 & x09;
  assign z07 = z01 & ~x15;
  assign z08 = x11 ? (~x00 | x10 | (new_n42_ & x09 & x12)) : ~x12;
  assign new_n42_ = x04 & x02 & x03;
  assign z09 = x00 & ~x10 & (~x11 ^ x12);
  assign z10 = x11 & x00 & ~x10 & ~new_n42_ & x09 & x12;
  assign z11 = (new_n39_ | ~x12) & x11 & x00 & ~x10 & (~x01 | x12);
  assign z12 = x12 & (~x11 | (~x09 & x00 & ~x10));
endmodule
