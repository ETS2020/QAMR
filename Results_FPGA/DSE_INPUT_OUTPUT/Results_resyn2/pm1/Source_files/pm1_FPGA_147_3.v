...
module FAU ( 
  ...
  assign z05 = x09 | ~x13;
  assign z06 = x09 & (x13 | (x01 & (~new_n39_ | (~x11 & x12))));
  assign new_n39_ = x04 & x02 & x03;
  assign z07 = ~x15 & (~x09 | ~x13);
  assign z08 = (~new_n42_ & (~x09 | ~x13)) | (new_n39_ & ~x13 & x09 & x12);
  assign new_n42_ = x11 & x00 & ~x10;
  assign z09 = (~x11 ^ x12) & (~x09 | ~x13) & x00 & ~x10;
  assign z10 = x09 & (x13 | (new_n42_ & ~new_n39_ & x12));
  assign z11 = (x09 & x13) | ((~x01 | (~new_n39_ & x09 & x12)) & new_n42_ & (x01 | ~x12));
