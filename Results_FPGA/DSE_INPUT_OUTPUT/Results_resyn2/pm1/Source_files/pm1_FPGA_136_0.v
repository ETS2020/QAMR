...
module FAU ( 
  ...
  assign z06 = ((~x02 & ~x12) | (x01 & x09)) & ((~x11 & x12) | ~new_n40_ | ~x02);
  assign new_n40_ = x03 & x04;
  assign z07 = ~x15 | (~x02 & ~x12);
  assign z08 = (~new_n43_ & (x02 | x12)) | (x02 & x03 & x12 & x04 & x09);
  assign new_n43_ = x11 & x00 & ~x10;
  assign z09 = (~x02 & ~x12) | ((~x11 | x12) & (x11 | ~x12) & x00 & ~x10);
  assign z10 = (~new_n40_ | ~x02) & new_n35_ & x00 & ~x10;
  assign z11 = (~x02 & (~x12 | (new_n43_ & x01 & x09))) | ((~x12 | (~new_n40_ & x01 & x09)) & new_n43_ & (~x01 | x12));
  assign z12 = (~x02 & ~x12) | (new_n43_ & ~x09 & x12);
endmodule
