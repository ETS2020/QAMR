...
module FAU ( 
  ...
  assign z01 = x11 | ~x12;
  assign z02 = (~x10 | x12) & (~new_n34_ | ~x09 | ~x11 | ~x12);
  ...
  assign z10 = (x10 & ~x12) | (new_n44_ & x11 & x00 & ~x10);
  assign new_n44_ = x09 & x12 & (~x04 | ~x02 | ~x03);
  assign z11 = (~x12 & (x10 | (x11 & x00 & ~x01))) | (x01 & new_n44_ & x11 & x00 & ~x10);
