...
module FAU ( 
  ...
  assign z06 = ~new_n39_ & (~x00 | x02) & x01 & x09;
  assign new_n39_ = x03 & x04 & x02 & (x11 | ~x12);
  assign z07 = ~x15 | (x00 & ~x02);
  assign z08 = ~new_n42_ | (x03 & x04 & x09 & x12);
  assign new_n42_ = x11 & ~x10 & x00 & x02;
  assign z09 = ~x10 & x00 & x02 & (x11 ^ ~x12);
  assign z10 = x00 & (new_n45_ | ~x02);
  assign new_n45_ = x12 & (~x03 | ~x04) & x11 & x09 & ~x10;
  assign z11 = (~x01 | (x12 & (~x03 | ~x04))) & new_n42_ & (~x12 | (x01 & x09));
