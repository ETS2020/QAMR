...
module FAU ( 
  ...
  assign z08 = (~new_n42_ & (x03 | ~x12)) | (x03 & x09 & new_n39_ & x12);
  assign new_n42_ = x11 & x00 & ~x10;
  assign z09 = (~x03 & x12) | ((~x11 | x12) & (x11 | ~x12) & x00 & ~x10);
  assign z10 = ~new_n39_ & x12 & new_n42_ & x03 & x09;
  assign z11 = (~x01 | (~new_n39_ & x12)) & new_n42_ & (~x12 | (x03 & x01 & x09));
  assign z12 = x00 & ~x10 & ~x09 & x12 & x03 & x11;
endmodule
