...
module FAU ( 
  ...
  assign z06 = (x07 & ~x12) | (x01 & x09 & (~new_n40_ | (~x11 & x12)));
  assign new_n40_ = x04 & x02 & x03;
  assign z07 = ~x15 & (~x07 | x12);
  assign z08 = (~new_n43_ & (~x07 | x12)) | (new_n40_ & x09 & x12);
  assign new_n43_ = x11 & x00 & ~x10;
  assign z09 = (x07 & ~x12) | (x00 & ~x10 & (~x11 ^ x12));
  assign z10 = ~new_n40_ & x12 & new_n43_ & x09;
  assign z11 = new_n43_ & ((~x01 & ~x07 & ~x12) | (x01 & x09 & ~new_n40_ & x12));
