...
module FAU ( 
  ...
  assign z04 = z02 & ~x14;
  assign z05 = ~z02 | ~x13;
  assign z06 = (~new_n38_ | (~x11 & x12)) & z02 & x01 & x09;
  assign new_n38_ = x04 & x02 & x03;
  assign z07 = z02 & ~x15;
  assign z08 = (new_n38_ & x09 & x12) | ~z02 | ~new_n41_;
  assign new_n41_ = x11 & x00 & ~x10;
  assign z09 = ~z02 | (x00 & ~x10 & (~x11 ^ x12));
  assign z10 = ~z02 | (new_n41_ & x09 & ~new_n38_ & x12);
  assign z11 = ~z02 | ((~x01 | (~new_n38_ & x12)) & new_n41_ & (~x12 | (x01 & x09)));
  assign z12 = ~z02 | (x00 & ~x10 & ~x09 & x11 & x12);
endmodule
