// Benchmark "FAU" written by ABC on Thu Aug 13 16:58:38 2020
...
module FAU ( 
  ...
  assign z08 = (x09 | (x12 & (~x00 | x10 | ~x11))) & ((new_n39_ & x12) | ~x00 | x10 | ~x11);
  ...
  assign new_n46_ = ~x12 & (~x09 | (~x10 & x11 & x00 & ~x01));
