...
module FAU ( 
  ...
  wire new_n34_, new_n39_, new_n41_, new_n42_, new_n45_;
  ...
  assign z08 = new_n41_ | ~new_n42_;
  assign new_n41_ = x12 & ((x02 & x03 & x04 & x09) | x15);
  assign new_n42_ = x11 & x00 & ~x10;
  assign z09 = (~x11 | (x12 & ~x15)) & x00 & ~x10 & (x11 | ~x12);
  assign z10 = x12 & ((~new_n39_ & new_n45_) | x15);
  assign new_n45_ = x09 & x11 & x00 & ~x10;
  assign z11 = new_n42_ & ((~new_n39_ & x01 & x09 & x12 & ~x15) | (~x01 & ~x12));
  assign z12 = x12 & (x15 | (new_n42_ & ~x09));
  assign z07 = ~x15;
endmodule
