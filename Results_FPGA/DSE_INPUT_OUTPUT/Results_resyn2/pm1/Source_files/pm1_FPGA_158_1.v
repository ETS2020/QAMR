...
module FAU ( 
  ...
  assign z06 = (x12 & (~x01 | (x09 & ~x11))) | (~new_n39_ & x01 & x09);
  assign new_n39_ = x04 & x02 & x03;
  assign z07 = ~x15 | (~x01 & x12);
  assign z08 = new_n42_ | ~x00 | x10 | ~x11;
  assign new_n42_ = x12 & (~x01 | (x09 & x04 & x02 & x03));
  assign z09 = (~x01 & x12) | ((x11 | ~x12) & (~x11 | x12) & x00 & ~x10);
  assign z10 = new_n45_ & x00 & ~x10 & x11;
  assign new_n45_ = (~x04 | ~x02 | ~x03) & x12 & x01 & x09;
  assign z11 = x11 & x00 & ~x10 & (new_n45_ | (~x01 & ~x12));
  assign z12 = x12 & (~x01 | (~x09 & x11 & x00 & ~x10));
endmodule
