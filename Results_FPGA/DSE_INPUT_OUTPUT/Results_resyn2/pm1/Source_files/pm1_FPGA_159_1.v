...
module FAU ( 
  ...
  assign z07 = ~z12 & ~x15;
  assign z08 = ((new_n40_ | ~x09) & x12) | ~x11 | ~x00 | x10;
  assign z09 = (~x12 | (x09 & x11)) & x00 & ~x10 & (~x11 | x12);
  assign z10 = ~new_n40_ & x12 & x00 & ~x10 & x09 & x11;
  assign z11 = z12 | (~new_n46_ & x11 & x00 & ~x10);
  assign new_n46_ = x01 ? (~x12 | (x04 & x02 & x03)) : x12;
endmodule
