...
module FAU ( 
  ...
  assign z08 = new_n42_ | ((x07 | ~x12) & (~x11 | ~x00 | x10));
  assign new_n42_ = x04 & x02 & x03 & x09 & x07 & x12;
  assign z09 = (~x12 | (x07 & x11)) & x00 & ~x10 & (~x11 | x12);
  assign z10 = new_n45_ & x11 & x00 & ~x10;
  assign new_n45_ = (~x04 | ~x02 | ~x03) & x09 & x07 & x12;
  assign z11 = x11 & x00 & ~x10 & (x01 ? new_n45_ : ~x12);
