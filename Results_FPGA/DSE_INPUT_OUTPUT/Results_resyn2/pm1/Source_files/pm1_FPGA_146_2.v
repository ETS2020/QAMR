...
module FAU ( 
  ...
  assign z09 = (x12 | (~x11 & x00 & ~x10)) & (~x12 | ~x13 | (x11 & x00 & ~x10));
  assign z10 = new_n41_ & ~new_n38_ & x09 & x12 & x13;
  assign z11 = (new_n41_ | (x12 & ~x13)) & ((~new_n38_ & x12 & x01 & x09) | (x12 & ~x13) | (~x01 & ~x12));
