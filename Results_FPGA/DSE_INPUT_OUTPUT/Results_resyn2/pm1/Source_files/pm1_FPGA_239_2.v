...
module FAU ( 
  ...
  assign z02 = new_n34_ | ~x05;
  assign new_n34_ = x12 & (~x08 | ~x06 | ~x07 | ~x09 | ~x11);
  assign z03 = new_n36_ | ~x09 | ~x11 | ~x12;
  assign new_n36_ = x05 & x08 & x06 & x07;
  assign z04 = ~x14 & (~x05 | x12);
  assign z05 = ~x13 | (x05 & ~x12);
  assign z06 = (~new_n40_ | (~x11 & x12)) & (~x05 | x12) & x01 & x09;
  assign new_n40_ = x04 & x02 & x03;
  assign z07 = ~x15 & (~x05 | x12);
  assign z08 = (~new_n43_ & (~x05 | x12)) | (new_n40_ & x09 & x12);
  assign new_n43_ = x11 & x00 & ~x10;
  assign z09 = (x05 & ~x12) | ((~x11 | x12) & (x11 | ~x12) & x00 & ~x10);
  assign z10 = new_n43_ & ~new_n40_ & x09 & x12;
  assign z11 = (~x12 & (x05 | (new_n43_ & ~x01))) | (x01 & new_n43_ & ~new_n40_ & x09 & x12);
