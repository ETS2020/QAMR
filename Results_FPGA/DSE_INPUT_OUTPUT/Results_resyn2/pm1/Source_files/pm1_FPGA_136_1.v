...
module FAU ( 
  ...
  assign z03 = ~x12 | ~x02 | ~x09 | new_n34_ | ~x11;
  ...
  assign z08 = (new_n39_ & x12 & x02 & x09) | (~new_n42_ & (x02 | ~x12));
  assign new_n42_ = x11 & x00 & ~x10;
  assign z09 = (~x02 & x12) | ((~x11 | x12) & (x11 | ~x12) & x00 & ~x10);
  assign z10 = ~new_n39_ & x12 & new_n42_ & x02 & x09;
  assign z11 = (~x02 & x12) | ((~x01 | (~new_n39_ & x12)) & new_n42_ & (~x12 | (x01 & x09)));
