...
module FAU ( 
  ...
  assign z09 = (x12 | (~x11 & x00 & ~x10)) & ((x11 & x00 & ~x10) | x03 | ~x12);
  assign z10 = x12 & ~x03 & x11 & x09 & x00 & ~x10;
  assign z11 = (~x01 | (~x03 & x12)) & new_n41_ & (~x12 | (x01 & x09));
  assign z12 = x12 & ~x03 & x11 & ~x09 & x00 & ~x10;
endmodule
