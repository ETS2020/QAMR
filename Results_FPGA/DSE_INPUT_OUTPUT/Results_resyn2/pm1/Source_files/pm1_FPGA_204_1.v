...
module FAU ( 
  ...
  assign z02 = ~x08 | (x05 & (~new_n35_ | ~x06 | ~x07));
  assign new_n35_ = x09 & x11 & x12;
  assign z03 = ~new_n35_ | (x08 & (~x05 | (x06 & x07)));
  assign z04 = ~new_n32_ & ~x14;
  assign z05 = ~new_n32_ & ~x13;
  assign z06 = new_n32_ | (x01 & x09 & (~new_n40_ | (~x11 & x12)));
  assign new_n40_ = x04 & x02 & x03;
  assign z07 = new_n32_ | ~x15;
  assign z08 = ~new_n43_ | (new_n40_ & x09 & x12);
  assign new_n43_ = (x05 | ~x08) & x11 & x00 & ~x10;
  assign z09 = new_n32_ | (x00 & ~x10 & (x11 ^ ~x12));
  assign z10 = new_n32_ | (new_n46_ & x09 & ~new_n40_ & x12);
  assign new_n46_ = x11 & x00 & ~x10;
  assign z11 = new_n32_ | ((~x01 | (~new_n40_ & x12)) & new_n46_ & (~x12 | (x01 & x09)));
