...
module FAU ( 
  ...
  assign z02 = ~x12 | (x07 & (~new_n34_ | ~x08 | ~x05 | ~x06));
  assign new_n34_ = x09 & x11;
  assign z03 = ~x12 | (x07 & (~new_n34_ | (x08 & x05 & x06)));
  ...
  assign z09 = (~x07 & x12) | ((x11 | ~x12) & x00 & ~x10 & (~x11 | x12));
  assign z10 = new_n45_ & ~new_n39_ & x12;
  assign new_n45_ = x00 & ~x10 & x07 & x09 & x11;
  assign z11 = (~x07 & x12) | (new_n42_ & ((~x01 & ~x12) | (x01 & x09 & ~new_n39_ & x12)));
