...
module FAU ( 
  ...
  assign z09 = (~x01 & x12) | (x00 & ~x10 & (x11 | ~x12) & (~x11 | x12));
  assign z10 = x12 & (~x01 | (~new_n39_ & new_n45_));
  assign new_n45_ = x00 & ~x10 & x09 & x11;
  assign z11 = ~new_n47_ & x00 & ~x10 & x11;
  assign new_n47_ = (~x12 | ~x01 | ~x09 | (x04 & x02 & x03)) & (x01 | x12);
