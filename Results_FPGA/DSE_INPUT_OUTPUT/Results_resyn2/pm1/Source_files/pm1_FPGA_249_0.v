...
module FAU ( 
  ...
  assign z08 = (new_n38_ & x09 & x12) | ~new_n41_ | (~x12 & ~x13);
  assign new_n41_ = x11 & x00 & ~x10;
  assign z09 = (~x12 & ~x13) | ((~x11 | x12) & (x11 | ~x12) & x00 & ~x10);
  assign z10 = (~x12 & ~x13) | (new_n41_ & x09 & ~new_n38_ & x12);
  assign z11 = new_n41_ & ((~x01 & ~x12 & x13) | (x01 & x09 & ~new_n38_ & x12));
