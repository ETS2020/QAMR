...
module FAU ( 
  ...
  assign z07 = ~x12 | ~x15;
  assign z08 = (new_n39_ & x09 & x12) | ~new_n42_ | ~x00 | (~x12 & x15);
  assign new_n42_ = ~x10 & x11;
  assign z09 = (~x12 & x15) | ((x11 ^ ~x12) & x00 & ~x10);
  assign z10 = (~x12 & x15) | (x00 & ~new_n39_ & new_n45_);
  assign new_n45_ = ~x10 & x11 & x09 & x12;
  assign z11 = new_n47_ | (~new_n39_ & new_n45_ & x00 & x01);
  assign new_n47_ = ~x12 & (x15 | (x00 & ~x01 & ~x10 & x11));
