...
module FAU ( 
  ...
  assign z00 = x12 ? ~x01 : (x01 | x11);
  assign z01 = ~x12 | (~x01 & x11);
  assign z02 = ~x12 | (~x01 & (~new_n34_ | ~x09 | ~x11));
  assign new_n34_ = x07 & x08 & x05 & x06;
  assign z03 = ~x12 | (~x01 & (new_n34_ | ~x09 | ~x11));
  assign z04 = ~x14 | (x01 & x12);
  assign z05 = ~x13 | (x01 & x12);
  assign z06 = (~x04 | ~x02 | ~x03) & ~x12 & x01 & x09;
  assign z07 = ~x15 & (~x01 | ~x12);
  assign z08 = new_n41_ | ((~x01 | ~x12) & (~x11 | ~x00 | x10));
  assign new_n41_ = x04 & x02 & x03 & ~x01 & x09 & x12;
  assign z09 = (~x12 | (~x01 & x11)) & x00 & ~x10 & (~x11 | x12);
  assign z10 = new_n44_ & ~x01 & x11 & x00 & ~x10;
  assign new_n44_ = (~x04 | ~x02 | ~x03) & x09 & x12;
  assign z11 = ~x12 & ~x01 & x11 & x00 & ~x10;
  assign z12 = ~x01 & x11 & x00 & ~x10 & ~x09 & x12;
endmodule
