...
module FAU ( 
  ...
  assign z06 = (~x12 & ~x14) | ((~new_n38_ | (~x11 & x12)) & x01 & x09);
  assign new_n38_ = x04 & x02 & x03;
  assign z07 = ~x15 | (~x12 & ~x14);
  assign z08 = (~new_n41_ & (x12 | x14)) | (new_n38_ & x09 & x12);
  assign new_n41_ = x11 & x00 & ~x10;
  assign z09 = (~x12 & ~x14) | ((~x11 | x12) & x00 & ~x10 & (x11 | ~x12));
  assign z10 = (~x12 & ~x14) | (new_n41_ & x09 & ~new_n38_ & x12);
  assign z11 = new_n41_ & ((x01 & x09 & ~new_n38_ & x12) | (x14 & ~x01 & ~x12));
