...
module FAU ( 
  ...
  assign z02 = ~x12 | (x04 & (~new_n34_ | ~x09 | ~x11));
  assign new_n34_ = x07 & x08 & x05 & x06;
  assign z03 = ~x12 | ~x04 | ~x09 | new_n34_ | ~x11;
  assign z04 = ~x14 | (~x04 & x12);
  assign z05 = ~x13 | (~x04 & x12);
  assign z06 = x01 & x09 & ((x12 & x04 & ~x11) | (x04 ? ~new_n39_ : ~x12));
  assign new_n39_ = x02 & x03;
  assign z07 = ~x15 & (x04 | ~x12);
  assign z08 = (new_n39_ & x12 & x04 & x09) | (~new_n42_ & (x04 | ~x12));
  assign new_n42_ = x11 & x00 & ~x10;
  assign z09 = (x11 ^ ~x12) & (x04 | ~x12) & x00 & ~x10;
  assign z10 = ~new_n39_ & x12 & new_n42_ & x04 & x09;
  assign z11 = (~x04 & x12) | ((~x01 | (~new_n39_ & x12)) & new_n42_ & (~x12 | (x01 & x09)));
