...
module FAU ( 
  ...
  assign z00 = (~x02 & x12) | (x11 & ~x12) | (x01 & ~x12);
  ...
  assign z09 = ((~x02 & x11) | ~x12) & (~x11 | x12) & x00 & ~x10;
  assign z10 = x00 & ~x10 & ~x02 & x12 & x09 & x11;
  assign z11 = (~x12 | (x01 & x09)) & new_n41_ & (~x02 | ~x12) & (~x01 | x12);
