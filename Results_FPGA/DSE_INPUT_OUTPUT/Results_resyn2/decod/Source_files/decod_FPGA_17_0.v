// Benchmark "FAU" written by ABC on Wed Aug 12 17:24:05 2020
...
module FAU ( 
  ...
  assign z02 = (~x4 | (~x2 & x0 & x1)) & (x3 | ~x4) & (~x3 | x4);
  ...
  assign z10 = (x3 | ~x4) & (~x3 | x4) & (~x4 | (~x2 & ~x0 & x1));
  assign z11 = ~x3 & (~x4 | (~x2 & ~x0 & x1));
  assign z12 = (x3 | ~x4) & (~x3 | x4) & (~x4 | (x2 & ~x0 & ~x1));
