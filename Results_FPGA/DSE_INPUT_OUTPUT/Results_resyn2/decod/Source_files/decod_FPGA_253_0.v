// Benchmark "FAU" written by ABC on Wed Aug 12 17:25:50 2020
...
module FAU ( 
  ...
  assign z01 = (~x0 & ~x4) | (x0 & x1 & x4 & x2 & ~x3);
  assign z02 = x4 & x0 & x1 & ~x2 & x3;
  assign z03 = x4 & x0 & x1 & ~x2 & ~x3;
  assign z04 = (~x4 | (~x1 & x2 & x3)) & (x0 ^ ~x4);
  assign z05 = (~x0 & ~x4) | (x4 & x2 & ~x3 & x0 & ~x1);
