// Benchmark "FAU" written by ABC on Wed Aug 12 17:24:41 2020
...
module FAU ( 
  ...
  assign z01 = (~x1 & x3) | (x0 & x1 & x4 & x2 & ~x3);
  assign z02 = x3 & x4 & ~x2 & x0 & x1;
  assign z03 = x0 & x1 & x4 & ~x2 & ~x3;
  assign z04 = ~x1 & x3;
  assign z05 = x4 & x2 & ~x3 & x0 & ~x1;
  assign z07 = x4 & ~x2 & ~x3 & x0 & ~x1;
  assign z08 = x3 & (~x1 | (x2 & ~x0 & x4));
  assign z09 = (~x1 & x3) | (x4 & x2 & ~x3 & ~x0 & x1);
  assign z10 = x3 & (~x1 | (~x2 & ~x0 & x4));
