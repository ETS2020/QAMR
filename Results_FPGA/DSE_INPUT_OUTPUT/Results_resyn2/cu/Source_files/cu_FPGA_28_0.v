...
module FAU ( 
  ...
  assign z00 = x03 | ((x02 | ~x05 | x04 | ~x13) & (~x04 | ~x02 | x05));
  assign z01 = (~x02 & (~x13 | (x05 & ~x03 & ~x04))) | (x02 & ~x05 & ~x03 & x04);
  assign z05 = ~x02 & ~x13;
  assign z06 = new_n34_ | (~x02 & (~x13 | (~new_n31_ & ~new_n32_ & new_n33_)));
  assign new_n31_ = (~x01 | x10) & ~x00 & (x01 | x08);
  assign new_n32_ = (~x01 | x11) & x00 & (x01 | x09);
  assign new_n33_ = ~x03 & x04 & ~x12 & x05 & ~x07;
  assign new_n34_ = ~x03 & x04 & ~x05 & ~x13;
  assign z08 = ((~x05 & ~x13) | (~x12 & ~x02 & x05)) & ~x03 & x04 & (x02 | x13);
