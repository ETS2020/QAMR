...
module FAU ( 
  ...
  assign z00 = (~x12 & ~x13) | (x04 ? ~x02 : ~x05) | x03 | (x02 & x05);
  assign z01 = (~x12 & ~x13) | ((x04 ? x02 : x05) & ~x03 & (~x02 | ~x05));
  assign z02 = ~x00 & ~x01 & new_n30_ & x12 & ~x13;
  assign new_n30_ = ~x03 & ~x04 & ~x02 & x05;
  assign z03 = ~x13 & (~x12 | (new_n30_ & x00 & ~x01));
  assign z04 = ~x13 & (~x12 | (new_n30_ & ~x00 & x01));
  assign z05 = ~x13 & (~x12 | (new_n30_ & x00 & x01));
  ...
  assign z07 = new_n30_ & x12 & ~x13;
  assign z08 = ~x03 & x04 & ((~x02 & x05 & ~x12 & x13) | (x12 & ~x13 & x02 & ~x05));
  assign z09 = x13 ? x06 : ~x12;
  assign z10 = ~x03 & (~x02 | ~x05) & x06 & (x12 | x13);
endmodule
