...
module FAU ( 
  ...
  assign z02 = ~x13 & (x09 | (new_n30_ & ~x00 & ~x01));
  assign new_n30_ = ~x03 & ~x04 & ~x02 & x05;
  assign z03 = ~x01 & x00 & new_n30_ & ~x09 & ~x13;
  assign z04 = new_n30_ & ~x09 & ~x13 & ~x00 & x01;
  assign z05 = x01 & x00 & new_n30_ & ~x09 & ~x13;
