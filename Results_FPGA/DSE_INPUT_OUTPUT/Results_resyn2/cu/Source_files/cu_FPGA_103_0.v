...
module FAU ( 
  ...
  assign z02 = ~x13 & (~x11 | (~x01 & new_n30_ & ~x00));
  assign new_n30_ = ~x02 & ~x03 & ~x04 & x05;
  assign z03 = new_n30_ & x11 & ~x13 & x00 & ~x01;
  assign z04 = new_n30_ & ~x00 & x01 & x11 & ~x13;
  assign z05 = ~x13 & (~x11 | (new_n30_ & x00 & x01));
  assign z06 = new_n28_ | (new_n39_ & (new_n35_ | (new_n38_ & (new_n36_ | new_n37_))));
  assign new_n35_ = ~x13 & x02 & ~x05;
  assign new_n36_ = x00 & ((x01 & ~x11) | (x13 & ~x01 & ~x09));
  assign new_n37_ = (x01 | ~x08) & (~x01 | ~x10) & ~x00 & x13;
  assign new_n38_ = ~x07 & ~x12 & ~x02 & x05;
  assign new_n39_ = ~x03 & x04;
  assign z07 = new_n30_ & x11 & ~x13;
  assign z08 = new_n39_ & ((x13 & ~x12 & ~x02 & x05) | (x02 & ~x05 & x11 & ~x13));
  assign z09 = x06 & x13;
