...
module FAU ( 
  ...
  assign z03 = (~x09 & x13) | (new_n29_ & x00 & ~x01);
  assign z04 = x01 & new_n29_ & ~x00;
  assign z05 = new_n29_ & x00 & x01;
  assign z06 = new_n36_ & ((~new_n34_ & new_n35_) | (~x13 & x02 & ~x05));
  assign new_n34_ = (x11 | ~x00 | ~x01) & ((x01 & x10) | x00 | (~x01 & x08));
  assign new_n35_ = ~x07 & x09 & ~x12 & x13 & ~x02 & x05;
  assign new_n36_ = ~x03 & x04;
  assign z07 = new_n29_ | (~x09 & x13);
  assign z08 = (~x09 & x13) | (new_n36_ & ((~x13 & x02 & ~x05) | (~x12 & x13 & ~x02 & x05)));
