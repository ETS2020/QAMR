...
module FAU ( 
  ...
  assign z02 = ~x13 & (x11 | (new_n31_ & ~x00 & ~x01));
  assign new_n31_ = ~x03 & ~x04 & ~x02 & x05;
  assign z03 = new_n31_ & ~x11 & ~x13 & x00 & ~x01;
  assign z04 = ~x13 & (x11 | (new_n31_ & ~x00 & x01));
  assign z05 = ~x13 & (x11 | (new_n31_ & x00 & x01));
  ...
  assign z07 = ~x13 & (new_n31_ | x11);
  assign z08 = new_n40_ & ((~x02 & x05 & ~x12 & x13) | (x02 & ~x05 & ~x11 & ~x13));
  assign z09 = x06 & x13;
