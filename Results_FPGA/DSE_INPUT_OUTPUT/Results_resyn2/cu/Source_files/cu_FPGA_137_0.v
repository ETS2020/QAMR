...
module FAU ( 
  ...
  assign z02 = new_n31_ & ~x01 & ~x00 & ~x02 & ~x03;
  assign new_n31_ = ~x04 & x05 & x09 & ~x13;
  assign z03 = ~x13 & (new_n33_ | ~x09);
  assign new_n33_ = x00 & ~x02 & ~x03 & ~x01 & ~x04 & x05;
  assign z04 = new_n35_ & ~x00 & ~x02 & ~x03;
  assign new_n35_ = x01 & ~x04 & x05 & x09 & ~x13;
  assign z05 = new_n35_ & x00 & ~x02 & ~x03;
  assign z06 = new_n28_ | (new_n42_ & (new_n38_ | (new_n41_ & (new_n39_ | new_n40_))));
  assign new_n38_ = ~x13 & x02 & ~x05;
  assign new_n39_ = (~x01 | (~x11 & x13)) & x00 & (x01 | ~x09);
  assign new_n40_ = (~x01 | ~x10) & (x01 | ~x08) & ~x00 & x13;
  assign new_n41_ = ~x07 & ~x12 & ~x02 & x05;
  assign new_n42_ = ~x03 & x04;
  assign z07 = ~x13 & (~x09 | (~x02 & ~x03 & ~x04 & x05));
  assign z08 = new_n42_ & ((x13 & ~x12 & ~x02 & x05) | (x09 & ~x13 & x02 & ~x05));
