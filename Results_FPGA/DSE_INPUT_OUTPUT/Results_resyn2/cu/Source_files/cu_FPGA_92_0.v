...
module FAU ( 
  ...
  assign z04 = (~x01 & ~x08) | (new_n31_ & ~x03 & ~x02 & ~x00 & x01);
  assign z05 = (~x01 & ~x08) | (new_n31_ & ~x03 & ~x02 & x00 & x01);
  assign z06 = new_n28_ | ((new_n38_ | (~new_n36_ & new_n37_)) & ~x03 & x04);
  assign new_n36_ = (x10 | x00 | ~x01) & ((x01 & x11) | ~x00 | (~x01 & x09));
  ...
  assign new_n41_ = ~x03 & x04 & ((~x12 & x13 & ~x02 & x05) | (~x13 & x02 & ~x05));
