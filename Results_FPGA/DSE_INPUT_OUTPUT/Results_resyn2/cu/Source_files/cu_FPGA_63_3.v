...
module FAU ( 
  ...
  assign z00 = ~z09 & ((x02 ? x05 : x04) | x03 | (~x04 & ~x05));
  assign z09 = x06 & x13;
  assign z01 = ~z09 & (x02 ? ~x05 : ~x04) & ~x03 & (x04 | x05);
  assign z02 = z09 | (z07 & ~x00 & ~x01);
  assign z07 = ~x03 & ~x13 & ~x04 & ~x02 & x05;
  assign z03 = ~x01 & z07 & x00;
  assign z04 = z09 | (z07 & ~x00 & x01);
  ...
  assign new_n39_ = ~x06 & ~x07 & ~x02 & x05 & ~x12 & x13;
  assign new_n40_ = ~x03 & x04;
  assign z08 = (x06 & x13) | (new_n40_ & ((~x13 & x02 & ~x05) | (~x12 & x13 & ~x02 & x05)));
