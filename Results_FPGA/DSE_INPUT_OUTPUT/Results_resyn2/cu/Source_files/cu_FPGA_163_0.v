...
module FAU ( 
  ...
  assign z02 = ~x13 & (~x06 | (~x01 & ~x02 & new_n31_ & ~x00));
  assign new_n31_ = ~x03 & ~x04 & x05;
  assign z03 = ~x13 & (~x06 | (~x01 & ~x02 & new_n31_ & x00));
  assign z04 = ~x13 & (~x06 | (new_n31_ & ~x00 & x01 & ~x02));
  assign z05 = new_n31_ & x00 & x01 & ~x02 & x06 & ~x13;
  ...
  assign z07 = new_n31_ & ~x13 & ~x02 & x06;
  assign z08 = (~x06 & ~x13) | (new_n40_ & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)));
  assign z09 = x06 ^ ~x13;
