...
module FAU ( 
  ...
  assign z00 = (~x02 & (x04 | ~x05)) | (x05 & (x02 | x03));
  assign z01 = ~x04 & x05 & ~x02 & ~x03;
  assign z02 = (x02 & ~x05) | (~x01 & ~x02 & new_n30_ & ~x00);
  assign new_n30_ = ~x04 & x05 & ~x03 & ~x13;
  assign z03 = (x02 & ~x05) | (~x01 & ~x02 & new_n30_ & x00);
  assign z04 = (x02 & ~x05) | (new_n30_ & ~x00 & x01 & ~x02);
  assign z05 = (x02 & ~x05) | (new_n30_ & x00 & x01 & ~x02);
  assign z06 = new_n36_ & z08 & ~x07;
  assign z08 = ~x02 & ~x03 & x04 & x05 & ~x12 & x13;
  assign new_n36_ = ((x01 & ~x11) | ~x00 | (~x01 & ~x09)) & ((x01 & ~x10) | x00 | (~x01 & ~x08));
  assign z07 = x02 ? ~x05 : new_n30_;
