...
module FAU ( 
  ...
  assign z02 = ~x04 & (x08 | (new_n29_ & ~x00 & ~x01));
  assign new_n29_ = ~x02 & x05 & ~x03 & ~x13;
  assign z03 = ~x04 & (x08 | (new_n29_ & x00 & ~x01));
  assign z04 = new_n29_ & ~x04 & ~x08 & ~x00 & x01;
  assign z05 = ~x04 & (x08 | (new_n29_ & x00 & x01));
