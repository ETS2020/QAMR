...
module FAU ( 
  ...
  assign z02 = ~x13 & (~x05 | (new_n30_ & ~x04 & ~x00 & ~x01));
  assign new_n30_ = ~x02 & ~x03;
  assign z03 = ~x13 & (~x05 | (new_n30_ & ~x04 & x00 & ~x01));
  assign z04 = ~x00 & x01 & new_n30_ & new_n33_ & ~x13;
  assign new_n33_ = ~x04 & x05;
  assign z05 = x00 & x01 & new_n30_ & new_n33_ & ~x13;
  assign z06 = (~x05 & ~x13) | (new_n37_ & z08 & ~x07);
  assign z08 = ~x02 & ~x03 & x04 & x05 & ~x12 & x13;
  assign new_n37_ = ((x01 & ~x11) | ~x00 | (~x01 & ~x09)) & ((x01 & ~x10) | x00 | (~x01 & ~x08));
  assign z07 = new_n30_ & new_n33_ & ~x13;
