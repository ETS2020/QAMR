...
module FAU ( 
  ...
  assign z02 = new_n30_ & ~x01 & ~x03 & ~x13 & ~x00 & x05;
  assign new_n30_ = ~x02 & ~x04;
  assign z03 = x05 & (x13 | (new_n30_ & ~x01 & x00 & ~x03));
  assign z04 = new_n30_ & x01 & ~x03 & ~x13 & ~x00 & x05;
  assign z05 = x05 & (x13 | (new_n30_ & x01 & x00 & ~x03));
