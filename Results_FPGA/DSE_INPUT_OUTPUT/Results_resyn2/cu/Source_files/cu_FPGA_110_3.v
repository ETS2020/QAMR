...
module FAU ( 
  ...
  assign z02 = (x13 ? x01 : new_n29_) & (x01 ? x13 : ~x00);
  assign new_n29_ = ~x04 & x05 & ~x02 & ~x03;
  assign z03 = new_n29_ & ~x13 & x00 & ~x01;
  assign z04 = x01 & (x13 | (new_n29_ & ~x00));
  assign z05 = x01 & (x13 | (new_n29_ & x00));
  assign z06 = new_n34_ & ((~x13 & x02 & ~x05) | (new_n35_ & ~x02 & x05 & ~x12 & x13));
  assign new_n34_ = ~x03 & x04;
  assign new_n35_ = (x00 | ~x08) & ~x01 & ~x07 & (~x00 | ~x09);
  assign z07 = x13 ? x01 : new_n29_;
