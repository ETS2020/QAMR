...
module FAU ( 
  ...
  assign z00 = ~z03 & (x03 | (x02 & x05) | (~x02 & x04) | (~x04 & ~x05));
  assign z03 = x00 & ~x13;
  assign z02 = ~x13 & (x00 | (new_n30_ & ~x01));
  assign new_n30_ = ~x02 & x05 & ~x03 & ~x04;
  assign z04 = ~x13 & (x00 | (new_n30_ & x01));
  ...
  assign z10 = z03 | (x06 & ~x03 & (~x02 | ~x05));
  assign z01 = z03 | (~x03 & (~x02 | ~x05) & (x02 | ~x04) & (x04 | x05));
  assign z05 = z03;
endmodule
