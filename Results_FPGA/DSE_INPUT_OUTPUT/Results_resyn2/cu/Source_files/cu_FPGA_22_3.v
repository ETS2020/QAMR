...
module FAU ( 
  ...
  assign z01 = (x02 | (~x04 & x05)) & ((~x02 & ~x03) | (x04 & ~x05) | (x02 & x03));
  assign z02 = (x02 & x03) | (~x01 & ~x02 & new_n30_ & ~x00);
  assign new_n30_ = ~x04 & x05 & ~x03 & ~x13;
  assign z03 = (x02 & x03) | (new_n30_ & x00 & ~x01 & ~x02);
  assign z04 = (x02 & x03) | (x01 & ~x02 & new_n30_ & ~x00);
  assign z05 = (x02 & x03) | (x01 & ~x02 & new_n30_ & x00);
