...
module FAU ( 
  ...
  assign z00 = (x04 ? ~x02 : ~x05) | x03 | (x02 & x05) | (x13 & (~x04 | ~x02 | x05));
  assign z01 = ((x04 ? x02 : x05) & ~x03 & (~x02 | ~x05)) | (~x04 & x13);
  assign z02 = ~x13 & ~x04 & x05 & ~x01 & new_n30_ & ~x00;
  assign new_n30_ = ~x02 & ~x03;
  assign z03 = ~x04 & (x13 | (new_n30_ & x05 & x00 & ~x01));
  assign z04 = ~x04 & (x13 | (new_n30_ & ~x00 & x01 & x05));
  ...
  assign z07 = ~x04 & (x13 | (new_n30_ & x05));
