...
module FAU ( 
  ...
  assign z03 = ~x01 & x00 & ~x02 & ~x03 & new_n29_ & ~x13;
  assign z04 = ~x02 & ~x03 & new_n29_ & ~x13 & ~x00 & x01;
  assign z05 = x01 & x00 & ~x02 & ~x03 & new_n29_ & ~x13;
  assign z06 = (new_n35_ & z08 & ~x07) | (x02 & ~x13);
  assign z08 = ~x02 & ~x03 & x04 & x05 & ~x12 & x13;
  assign new_n35_ = ((x01 & ~x11) | ~x00 | (~x01 & ~x09)) & ((x01 & ~x10) | x00 | (~x01 & ~x08));
  assign z07 = ~x13 & (x02 | (new_n29_ & ~x03));
  assign z09 = x06 & x13;
