...
module FAU ( 
  ...
  assign z00 = (~x05 & (~x02 | x03)) | ((x05 | ~x02 | ~x04) & ~x03 & (x02 | x04));
  ...
  assign z05 = new_n30_ & ~x03 & x05 & x00 & x01;
  assign z06 = new_n39_ | (x04 & (new_n38_ | (~new_n35_ & ~new_n36_ & new_n37_)));
  assign new_n35_ = (~x01 | x10) & ~x00 & (x01 | x08);
  assign new_n36_ = (~x01 | x11) & x00 & (x01 | x09);
  assign new_n37_ = ~x07 & ~x12 & x13 & ~x02 & x05;
  assign new_n38_ = x02 & ~x03 & ~x05 & ~x13;
  assign new_n39_ = x03 & x05;
  assign z07 = new_n30_ & ~x03 & x05;
  assign z08 = ~x03 & x04 & ((~x02 & x05 & ~x12 & x13) | (x02 & ~x05 & ~x13));
  assign z09 = ~new_n39_ & x06 & x13;
