...
module FAU ( 
  ...
  assign z07 = x06 & ~x13 & ~x03 & ~x04 & ~x02 & x05;
  assign z03 = z07 & x00 & ~x01;
  assign z04 = ~x13 & (~x06 | (new_n33_ & ~x00 & x01));
  assign new_n33_ = ~x03 & ~x04 & ~x02 & x05;
  assign z05 = ~x13 & (~x06 | (new_n33_ & x00 & x01));
  ...
  assign z08 = new_n40_ & ((~x02 & x05 & ~x12 & x13) | (x02 & ~x05 & x06 & ~x13));
  assign z09 = x06 & x13;
