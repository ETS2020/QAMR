...
module FAU ( 
  ...
  assign z02 = (~x05 & x13) | (new_n30_ & ~x00 & ~x04 & x05 & ~x03 & ~x13);
  assign new_n30_ = ~x01 & ~x02;
  assign z03 = (~x05 & x13) | (new_n30_ & x00 & ~x04 & x05 & ~x03 & ~x13);
  assign z04 = (~x05 & x13) | (new_n33_ & ~x00 & ~x04 & x05 & ~x03 & ~x13);
  assign new_n33_ = x01 & ~x02;
  assign z05 = (~x05 & x13) | (new_n33_ & x00 & ~x04 & x05 & ~x03 & ~x13);
  ...
  assign z07 = (~x05 & x13) | (x05 & ~x02 & ~x04 & ~x03 & ~x13);
