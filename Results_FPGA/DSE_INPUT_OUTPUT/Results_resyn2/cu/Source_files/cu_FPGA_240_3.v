...
module FAU ( 
  ...
  assign z06 = ~x03 & x04 & (new_n38_ | (new_n36_ & ~new_n40_));
  assign new_n36_ = (x00 | (~x01 & ~x08)) & new_n37_ & ~x07 & (~x01 | ~x11);
  assign new_n37_ = ~x02 & x05 & ~x12 & x13;
  assign new_n38_ = (new_n39_ | (x02 & ~x05 & ~x13)) & ~new_n28_ & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13));
  assign new_n39_ = ~x00 & x01 & ~x07 & ~x10;
  assign new_n40_ = x09 & (x06 | (x00 & ~x01));
  assign z07 = new_n28_ | new_n31_;
  assign z08 = new_n28_ | new_n43_;
  assign new_n43_ = ~x03 & x04 & ((~x12 & x13 & ~x02 & x05) | (~x13 & x02 & ~x05));
