...
module FAU ( 
  ...
  assign z01 = (x04 | (x05 & ~x07)) & ~x03 & (x02 ? ~x05 : ~x04);
  assign z02 = new_n29_ & ~x01 & ~x02 & ~x04;
  assign new_n29_ = ~x00 & x05 & ~x07 & ~x03 & ~x13;
  assign z03 = new_n31_ & ~x01 & ~x02 & ~x04;
  assign new_n31_ = x00 & x05 & ~x07 & ~x03 & ~x13;
  assign z04 = new_n29_ & x01 & ~x02 & ~x04;
  assign z05 = new_n31_ & x01 & ~x02 & ~x04;
  ...
  assign z07 = x05 & (x07 | (~x02 & ~x04 & ~x03 & ~x13));
  assign z08 = (new_n39_ & ((~x13 & x02 & ~x05) | (~x02 & x05 & ~x12 & x13))) | (x05 & x07);
