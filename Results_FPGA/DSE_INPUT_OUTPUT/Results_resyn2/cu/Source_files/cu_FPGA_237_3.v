...
module FAU ( 
  ...
  wire new_n33_, new_n35_, new_n36_, new_n37_, new_n38_, new_n39_;
  ...
  assign z05 = new_n33_ | (x01 & z07 & x00);
  assign new_n33_ = x03 & x09;
  assign z06 = new_n33_ | (new_n39_ & (new_n38_ | (~new_n35_ & ~new_n36_ & new_n37_)));
  ...
  assign z08 = new_n39_ & ((~x12 & x13 & ~x02 & x05) | (~x13 & x02 & ~x05));
