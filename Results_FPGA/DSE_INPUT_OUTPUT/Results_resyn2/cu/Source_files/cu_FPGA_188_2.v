...
module FAU ( 
  ...
  assign z02 = ~x13 & (x03 | (new_n30_ & ~x02 & ~x00 & ~x01));
  assign new_n30_ = ~x04 & x05;
  assign z03 = ~x13 & (x03 | (x00 & ~x01 & new_n30_ & ~x02));
  assign z04 = ~x00 & x01 & ~x02 & ~x03 & new_n30_ & ~x13;
  assign z05 = x00 & x01 & ~x02 & ~x03 & new_n30_ & ~x13;
  assign z06 = (x03 & ~x13) | (x04 & ((new_n35_ & new_n36_) | (new_n37_ & ~x13)));
