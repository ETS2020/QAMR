...
module FAU ( 
  ...
  wire new_n29_, new_n35_, new_n36_;
  assign z01 = ~x03 & (~x02 | ~x05) & ((~x04 & x05) | (x13 & x02 & x04));
  assign z02 = ~x13 & (x02 | (new_n29_ & ~x03 & ~x00 & ~x01));
  assign new_n29_ = ~x04 & x05;
  assign z03 = z07 & x00 & ~x01;
  assign z07 = ~x02 & ~x03 & ~x13 & ~x04 & x05;
  assign z04 = z07 & ~x00 & x01;
  assign z05 = ~x13 & (x02 | (new_n29_ & ~x03 & x00 & x01));
  ...
  assign z09 = x06 & x13;
  assign z10 = (x02 & ~x13) | (x06 & ~x03 & (~x02 | ~x05));
  assign z00 = ~z01;
endmodule
