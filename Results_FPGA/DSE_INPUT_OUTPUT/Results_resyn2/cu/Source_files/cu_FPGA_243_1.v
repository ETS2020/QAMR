...
module FAU ( 
  ...
  assign z02 = ~x03 & ~x04 & ~x13 & ~x00 & new_n30_ & ~x01;
  assign new_n30_ = ~x02 & x05;
  assign z03 = ~x03 & ~x04 & ~x13 & x00 & new_n30_ & ~x01;
  assign z04 = ~x04 & (x13 | (new_n30_ & ~x03 & ~x00 & x01));
  assign z05 = ~x04 & (x13 | (new_n30_ & ~x03 & x00 & x01));
