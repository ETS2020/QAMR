...
module FAU ( 
  ...
  assign z02 = ~x00 & ~x13;
  assign z03 = z07 & ~x01;
  assign z07 = ~x04 & x05 & x00 & ~x02 & ~x03 & ~x13;
  assign z05 = z07 & x01;
  assign z06 = z02 | (new_n37_ & (new_n33_ | (new_n36_ & (new_n34_ | new_n35_))));
  assign new_n33_ = ~x13 & x02 & ~x05;
  assign new_n34_ = (~x01 | ~x11) & (x01 | ~x09) & x00 & x13;
  assign new_n35_ = (~x01 | ~x10) & ~x00 & (x01 | ~x08);
  assign new_n36_ = ~x07 & ~x12 & ~x02 & x05;
  assign new_n37_ = ~x03 & x04;
  assign z08 = new_n37_ & ((x13 & ~x12 & ~x02 & x05) | (x00 & ~x13 & x02 & ~x05));
