...
module FAU ( 
  ...
  assign z04 = new_n32_ | (x01 & new_n29_ & ~x00);
  assign new_n32_ = ~x05 & x13;
  assign z05 = x01 & new_n29_ & x00;
  assign z06 = new_n32_ | (new_n39_ & (new_n35_ | (~new_n36_ & ~new_n37_ & new_n38_)));
  ...
  assign z07 = new_n32_ | new_n29_;
  assign z08 = (x05 | ~x13) & (~x02 | ~x05) & new_n39_ & (x02 | (~x12 & x13));
