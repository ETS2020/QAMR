...
module FAU ( 
  ...
  assign z01 = (x04 ? x02 : x05) & ~z05 & ~x03 & (~x02 | ~x05);
  assign z05 = x01 & ~x13;
  assign z02 = ~x13 & (x01 | (new_n30_ & ~x00 & ~x02));
  assign new_n30_ = ~x03 & ~x04 & x05;
  assign z03 = ~x13 & (x01 | (new_n30_ & x00 & ~x02));
  ...
  assign z07 = new_n30_ & ~x13 & ~x01 & ~x02;
  assign z08 = (x01 & ~x13) | (new_n37_ & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)));
  assign z09 = x06 & x13;
  assign z10 = x06 & ~z05 & ~x03 & (~x02 | ~x05);
  assign z04 = 1'b0;
  assign z00 = (x04 ? ~x02 : ~x05) | z05 | x03 | (x02 & x05);
endmodule
