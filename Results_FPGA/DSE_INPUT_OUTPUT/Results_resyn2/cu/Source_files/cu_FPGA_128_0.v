// Benchmark "FAU" written by ABC on Wed Aug 12 17:38:05 2020
...
module FAU ( 
  ...
  assign z01 = ~x03 & (x02 | (~x04 & x05)) & ((x04 & ~x05) | (~x02 & x13));
  assign z02 = ~x02 & ~x13;
  ...
  assign new_n34_ = ~x03 & x04 & x05 & ~x12 & ~x02 & ~x07;
  assign z08 = (~x13 | (x05 & ~x12)) & ~x03 & x04 & (x02 | x13) & (~x02 | ~x05);
  assign z09 = x06 & x13;
