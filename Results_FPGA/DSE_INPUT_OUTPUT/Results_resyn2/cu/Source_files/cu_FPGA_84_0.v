...
module FAU ( 
  ...
  assign z02 = new_n29_ & ~x00 & ~x04 & x05 & ~x01 & ~x13;
  assign new_n29_ = ~x02 & ~x03;
  assign z03 = ~x04 & x05 & ~x01 & ~x13 & new_n29_ & x00;
  assign z04 = ~x13 & (~x05 | (new_n29_ & ~x00 & x01 & ~x04));
  assign z05 = ~x13 & (~x05 | (new_n29_ & x00 & x01 & ~x04));
  assign z06 = new_n35_ & new_n34_ & ~x07;
  assign new_n34_ = ~x02 & x05 & ~x03 & x04 & ~x12 & x13;
