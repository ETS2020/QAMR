...
module FAU ( 
  ...
  assign z01 = (~x03 & (x05 ? (~x02 & ~x04) : (x02 & x04))) | (~x04 & x13);
  assign z02 = new_n30_ & ~x01 & ~x00 & ~x13 & ~x03 & x05;
  assign new_n30_ = ~x02 & ~x04;
  assign z03 = new_n30_ & ~x01 & x00 & ~x13 & ~x03 & x05;
  assign z04 = new_n30_ & x01 & ~x00 & ~x13 & ~x03 & x05;
  assign z05 = new_n30_ & x01 & x00 & ~x13 & ~x03 & x05;
  assign z06 = new_n35_ | (~x03 & (new_n39_ | (~new_n36_ & ~new_n37_ & new_n38_)));
  ...
  assign new_n39_ = ~x13 & ~x05 & x02 & x04;
  assign z07 = ~x04 & (x13 | (~x02 & ~x03 & x05));
  assign z08 = ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)) & ~x03 & x04;
  assign z09 = x13 & (~x04 | x06);
  assign z10 = new_n35_ | (~x03 & x06 & (~x02 | ~x05));
endmodule
