...
module FAU ( 
  ...
  wire new_n29_;
  assign z01 = ~x03 & ~x13 & (~x02 | ~x05) & (x04 ? x02 : x05);
  assign z02 = new_n29_ & ~x13 & ~x01 & ~x00 & ~x02 & ~x03;
  assign new_n29_ = ~x04 & x05;
  assign z03 = ~x03 & (x13 | (new_n29_ & ~x02 & x00 & ~x01));
  assign z04 = ~x00 & ~x02 & ~x03 & x01 & new_n29_ & ~x13;
  assign z05 = x01 & new_n29_ & ~x13 & x00 & ~x02 & ~x03;
  assign z06 = ~x03 & ~x13 & ~x05 & x02 & x04;
  assign z07 = ~x03 & (x13 | (new_n29_ & ~x02));
