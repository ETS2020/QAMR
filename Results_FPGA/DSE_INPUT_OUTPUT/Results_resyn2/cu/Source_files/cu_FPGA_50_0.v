...
module FAU ( 
  ...
  assign z00 = ~z02 & ((x04 ? ~x02 : ~x05) | x03 | (x02 & x05));
  assign z02 = ~x01 & ~x13;
  assign z04 = ~x13 & (~x01 | (new_n30_ & ~x00));
  ...
  assign z07 = new_n30_ & x01 & ~x13;
  assign z08 = ~new_n39_ & ~x03 & x04;
  assign new_n39_ = (x12 | ~x13 | x02 | ~x05) & (~x02 | x05 | ~x01 | x13);
  assign z09 = x06 & x13;
  assign z10 = ~x03 & (~x02 | ~x05) & ~z02 & x06;
  assign z03 = 1'b0;
  assign z01 = z02 | ((x04 ? x02 : x05) & ~x03 & (~x02 | ~x05));
endmodule
