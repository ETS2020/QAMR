...
module FAU ( 
  ...
  assign z00 = ~z05 & (x03 | (x05 ? (x02 | x04) : (~x02 | ~x04)));
  assign z05 = x01 & ~x13;
  assign z01 = ~z05 & ~x03 & (x05 ? (~x02 & ~x04) : (x02 & x04));
  assign z02 = new_n31_ & ~x13 & ~x00 & ~x01;
  assign new_n31_ = ~x03 & x05 & ~x02 & ~x04;
  assign z03 = ~x13 & (x01 | (new_n31_ & x00));
  ...
  assign new_n40_ = (x02 | ~x05 | x12 | ~x13) & (x01 | ~x02 | x05 | x13);
  assign z09 = x13 ? x06 : x01;
  assign z10 = (~x02 | ~x05) & ~z05 & ~x03 & x06;
  assign z04 = 1'b0;
endmodule
