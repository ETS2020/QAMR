...
module FAU ( 
  ...
  assign new_n39_ = x02 & ~x05 & x11 & ~x13;
  assign z07 = new_n30_ & ~x02 & x11 & ~x13;
  assign z08 = (~x11 & ~x13) | (new_n35_ & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)));
  assign z09 = x06 & x13;
