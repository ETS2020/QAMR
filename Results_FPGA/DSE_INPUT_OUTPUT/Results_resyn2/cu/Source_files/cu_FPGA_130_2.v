...
module FAU ( 
  ...
  assign z00 = (~x03 | x13) & ((x04 & (~x02 | x05)) | x03 | (~x04 & (x02 | ~x05)));
  assign z02 = z07 & ~x00 & ~x01;
  assign z07 = ~x04 & ~x02 & x05 & ~x03 & ~x13;
  assign z03 = z07 & x00 & ~x01;
  assign z04 = ~x13 & (x03 | (new_n32_ & ~x00 & x01));
  assign new_n32_ = ~x04 & ~x02 & x05;
  assign z05 = ~x13 & (x03 | (new_n32_ & x00 & x01));
  assign z06 = new_n35_ | (x04 & (new_n36_ | (~new_n37_ & ~new_n38_ & new_n39_)));
  assign new_n35_ = x03 & ~x13;
  assign new_n36_ = ~x13 & x02 & ~x05;
  assign new_n37_ = (~x01 | x10) & ~x00 & (x01 | x08);
  assign new_n38_ = (~x01 | x11) & x00 & (x01 | x09);
  assign new_n39_ = ~x02 & x05 & ~x12 & x13 & ~x03 & ~x07;
  assign z08 = ~x03 & x04 & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13));
  assign z09 = x13 ? x06 : x03;
  assign z10 = (x03 & ~x13) | ((~x02 | ~x05) & ~x03 & x06);
  assign z01 = ~z00;
endmodule
