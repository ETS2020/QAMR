...
module FAU ( 
  ...
  assign z02 = ~x13 & (~x10 | (new_n31_ & ~x00 & ~x01));
  assign new_n31_ = ~x02 & ~x03 & ~x04 & x05;
  assign z03 = ~x13 & (~x10 | (new_n31_ & x00 & ~x01));
  assign z04 = ~x13 & (~x10 | (new_n31_ & ~x00 & x01));
  assign z05 = new_n31_ & x10 & ~x13 & x00 & x01;
  assign z06 = new_n28_ | (new_n40_ & (new_n36_ | (new_n39_ & (new_n37_ | new_n38_))));
  assign new_n36_ = ~x13 & x02 & ~x05;
  assign new_n37_ = x13 & ((~x08 & ~x00 & ~x01) | ((~x01 | ~x11) & x00 & (x01 | ~x09)));
  assign new_n38_ = ~x10 & ~x00 & x01;
  assign new_n39_ = ~x07 & ~x12 & ~x02 & x05;
  assign new_n40_ = ~x03 & x04;
  assign z07 = ~x13 & (new_n31_ | ~x10);
  assign z08 = new_n40_ & ((x13 & ~x12 & ~x02 & x05) | (x02 & ~x05 & x10 & ~x13));
