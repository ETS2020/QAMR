...
module FAU ( 
  ...
  assign z02 = ~x13 & (x10 | (new_n29_ & ~x00 & ~x01));
  assign new_n29_ = ~x03 & ~x04 & ~x02 & x05;
  assign z03 = ~x01 & new_n29_ & x00 & ~x10 & ~x13;
  assign z04 = ~x13 & (x10 | (new_n29_ & ~x00 & x01));
  assign z05 = x01 & new_n29_ & x00 & ~x10 & ~x13;
  ...
  assign z07 = ~x13 & (new_n29_ | x10);
  assign z08 = (x10 & ~x13) | (new_n34_ & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)));
