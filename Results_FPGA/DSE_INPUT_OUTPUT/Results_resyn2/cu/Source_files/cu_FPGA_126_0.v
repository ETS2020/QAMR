...
module FAU ( 
  ...
  assign z02 = ~x13 & (~x10 | (new_n30_ & ~x00 & ~x01));
  assign new_n30_ = ~x03 & ~x04 & ~x02 & x05;
  assign z03 = new_n30_ & x10 & ~x13 & x00 & ~x01;
  assign z04 = new_n30_ & x10 & ~x13 & ~x00 & x01;
  assign z05 = ~x13 & (~x10 | (new_n30_ & x00 & x01));
  assign z06 = new_n35_ & (new_n39_ | (~new_n36_ & ~new_n37_ & new_n38_));
  ...
  assign z07 = ~x13 & (new_n30_ | ~x10);
  assign z08 = (~x10 & ~x13) | (new_n35_ & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)));
