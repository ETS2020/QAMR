...
module FAU ( 
  ...
  assign z00 = (x10 & (x02 | x04 | ~x05)) | (x04 ? ~x02 : ~x05) | x03 | (x02 & x05);
  assign z01 = ((x04 ? x02 : x05) & ~x03 & (~x02 | ~x05)) | (~x05 & x10);
  assign z02 = new_n30_ | (new_n31_ & ~x00 & ~x01 & ~x02);
  assign new_n30_ = ~x05 & x10;
  assign new_n31_ = ~x04 & x05 & ~x03 & ~x13;
  assign z03 = new_n30_ | (new_n31_ & x00 & ~x01 & ~x02);
  assign z04 = ~x00 & x01 & new_n31_ & ~x02;
  assign z05 = new_n30_ | (x00 & x01 & new_n31_ & ~x02);
