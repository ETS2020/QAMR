...
module FAU ( 
  ...
  wire new_n29_, new_n34_, new_n35_, new_n36_, new_n37_, new_n38_, new_n39_;
  assign z00 = (x05 | x06) & ((x02 ? x05 : x04) | x03 | (~x04 & ~x05));
  ...
  assign z06 = new_n34_ | (new_n39_ & (new_n38_ | (~new_n35_ & ~new_n36_ & new_n37_)));
  ...
  assign z07 = new_n34_ | new_n29_;
  assign z08 = new_n39_ & ((~x02 & x05 & ~x12 & x13) | (x06 & ~x13 & x02 & ~x05));
