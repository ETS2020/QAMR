...
module FAU ( 
  ...
  assign z02 = ~x00 & ~x01 & new_n29_ & x12 & ~x13;
  assign new_n29_ = ~x03 & ~x04 & ~x02 & x05;
  assign z03 = ~x13 & (~x12 | (new_n29_ & x00 & ~x01));
  assign z04 = ~x13 & (~x12 | (new_n29_ & ~x00 & x01));
  assign z05 = ~x13 & (~x12 | (new_n29_ & x00 & x01));
