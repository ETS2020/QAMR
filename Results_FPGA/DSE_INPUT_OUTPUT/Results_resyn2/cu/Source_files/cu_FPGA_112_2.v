...
module FAU ( 
  ...
  wire new_n29_, new_n35_, new_n36_, new_n37_;
  assign z01 = (x04 ? x02 : x05) & ~x03 & (~x02 | ~x05);
  assign z02 = ~x13 & (x03 | (new_n29_ & ~x00 & ~x01));
  assign new_n29_ = ~x02 & ~x04 & x05;
  assign z03 = ~x13 & (x03 | (new_n29_ & x00 & ~x01));
  assign z04 = ~x13 & (x03 | (new_n29_ & ~x00 & x01));
  assign z05 = z07 & x00 & x01;
  assign z07 = ~x02 & ~x03 & ~x04 & x05 & ~x13;
  assign z06 = (x04 & ((new_n35_ & new_n36_) | (new_n37_ & ~x13))) | (x03 & ~x13);
  assign new_n35_ = ~x07 & ~x02 & ~x03 & x13 & x05 & ~x12;
