...
module FAU ( 
  ...
  assign z00 = (x06 & ~x05 & (~x02 | ~x04)) | (x05 & (x02 | x04)) | (x03 & (x05 | x06));
  assign z01 = (x05 | (x02 & x04)) & (~x05 | (~x02 & ~x04)) & ~x03 & (x05 | x06);
  assign z02 = new_n30_ | (z07 & ~x00 & ~x01);
  assign new_n30_ = ~x05 & ~x06;
  assign z07 = ~x02 & ~x04 & ~x13 & ~x03 & x05;
  assign z03 = ~x01 & z07 & x00;
  assign z04 = new_n30_ | (z07 & ~x00 & x01);
  assign z05 = new_n30_ | (x01 & z07 & x00);
  ...
  assign z10 = (~x03 | (~x05 & ~x06)) & (~x05 | (~x02 & x06));
endmodule
