...
module FAU ( 
  ...
  wire new_n28_, new_n35_, new_n36_, new_n37_, new_n38_, new_n39_;
  ...
  assign z04 = new_n28_ | (x01 & z07 & ~x00);
  assign z05 = new_n28_ | (x01 & z07 & x00);
  ...
  assign new_n38_ = ~x12 & ~x02 & x05 & ~x07 & x13;
  assign new_n39_ = ~x03 & x04;
  assign z08 = new_n39_ & ((x02 & ~x05 & ~x13) | (~x12 & ~x02 & x05 & x06 & x13));
  assign z09 = x06 & x13;
  assign z10 = (~x06 & x13) | ((~x02 | ~x05) & ~x03 & x06);
