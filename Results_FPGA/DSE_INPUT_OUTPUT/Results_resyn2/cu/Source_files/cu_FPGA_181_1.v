...
module FAU ( 
  ...
  assign z01 = (x02 ? ~x05 : ~x04) & ~x03 & (x04 | x05) & (~x06 | (~x04 & ~x02 & x05));
  assign z02 = new_n30_ | (new_n31_ & ~x00 & ~x01 & ~x02 & ~x04);
  assign new_n30_ = ~x05 & x06;
  assign new_n31_ = ~x03 & x05 & ~x13;
  assign z03 = ~x01 & ~x02 & ~x04 & new_n31_ & x00;
  assign z04 = new_n30_ | (new_n31_ & ~x04 & ~x00 & x01 & ~x02);
  assign z05 = new_n30_ | (new_n31_ & ~x04 & x00 & x01 & ~x02);
