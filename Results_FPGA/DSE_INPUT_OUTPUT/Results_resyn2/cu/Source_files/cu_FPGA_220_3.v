...
module FAU ( 
  ...
  wire new_n31_, new_n35_, new_n36_, new_n37_, new_n38_;
  assign z01 = (x04 ? x02 : x05) & ~x03 & (~x02 | ~x05);
  assign z02 = z07 & ~x00 & ~x01;
  assign z07 = ~x04 & x05 & ~x13 & ~x02 & ~x03;
  assign z03 = x05 & (x02 | (new_n31_ & x00 & ~x01));
  assign new_n31_ = ~x13 & ~x03 & ~x04;
  assign z04 = x05 & (x02 | (new_n31_ & ~x00 & x01));
  assign z05 = x05 & (x02 | (new_n31_ & x00 & x01));
  assign z06 = ~x03 & x04 & (new_n38_ | (~new_n35_ & ~new_n36_ & new_n37_));
  ...
  assign z08 = (x02 & (x05 | (~x03 & x04 & ~x13))) | (x05 & ~x12 & ~x03 & x04 & x13);
