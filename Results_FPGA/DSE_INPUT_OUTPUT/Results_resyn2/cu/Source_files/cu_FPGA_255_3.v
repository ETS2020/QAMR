...
module FAU ( 
  ...
  assign z02 = (x01 & x13) | (~x01 & ~x02 & ~x00 & new_n29_ & ~x13);
  assign new_n29_ = ~x03 & ~x04 & x05;
  assign z03 = (x01 & x13) | (new_n29_ & ~x13 & x00 & ~x01 & ~x02);
  assign z04 = ~x00 & new_n29_ & ~x13 & x01 & ~x02;
  assign z05 = x01 & (x13 | (new_n29_ & x00 & ~x02));
  assign z06 = new_n34_ & ((~x13 & x02 & ~x05) | (new_n35_ & ~x02 & x05 & ~x12 & x13));
  assign new_n34_ = ~x03 & x04;
  assign new_n35_ = (x00 | ~x08) & (~x00 | ~x09) & ~x01 & ~x07;
