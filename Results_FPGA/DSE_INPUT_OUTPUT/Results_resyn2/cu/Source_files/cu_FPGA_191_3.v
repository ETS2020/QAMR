...
module FAU ( 
  ...
  assign new_n37_ = (x01 | ~x08) & ~x12 & x13 & (~x01 | ~x10);
  assign z08 = ~new_n39_ & ~x03 & x04;
  assign new_n39_ = (x13 | ~x02 | x05) & (x12 | ~x13 | ~x05 | x00 | x02);
