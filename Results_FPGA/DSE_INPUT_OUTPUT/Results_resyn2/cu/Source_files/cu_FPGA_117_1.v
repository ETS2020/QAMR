...
module FAU ( 
  ...
  assign z00 = (x04 | ~x13) & (x03 | ((x05 | ~x02 | ~x04) & (x04 | x02 | ~x05)));
  assign z01 = ~x03 & ((~x05 & x02 & x04) | (~x02 & x05 & ~x04 & ~x13));
  assign z02 = ~x04 & (x13 | (new_n30_ & ~x03 & ~x00 & ~x01));
  assign new_n30_ = ~x02 & x05;
  assign z03 = ~x01 & x00 & ~x03 & new_n30_ & ~x04 & ~x13;
  assign z04 = ~x03 & new_n30_ & ~x04 & ~x13 & ~x00 & x01;
  assign z05 = x01 & x00 & ~x03 & new_n30_ & ~x04 & ~x13;
  ...
  assign z07 = ~x04 & (x13 | (new_n30_ & ~x03));
