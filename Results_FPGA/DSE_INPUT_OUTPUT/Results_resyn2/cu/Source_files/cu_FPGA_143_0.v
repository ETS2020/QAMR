...
module FAU ( 
  ...
  assign z01 = ~new_n28_ & ~x03 & (~x02 | ~x05) & (x04 | x05) & (x02 | ~x04);
  assign new_n28_ = ~x07 & ~x13;
  assign z02 = ~x13 & (new_n30_ | ~x07);
  assign new_n30_ = ~x00 & ~x01 & ~x03 & ~x04 & ~x02 & x05;
  assign z03 = z07 & x00 & ~x01;
  assign z07 = ~x02 & x05 & ~x03 & ~x04 & x07 & ~x13;
  ...
  assign z08 = new_n40_ & ((x13 & ~x12 & ~x02 & x05) | (x02 & ~x05 & x07 & ~x13));
  assign z09 = x06 & x13;
