...
module FAU ( 
  ...
  assign z02 = ~x01 & ~x00 & new_n29_ & ~x04 & ~x13;
  assign new_n29_ = ~x03 & ~x02 & x05;
  assign z03 = ~x04 & (x13 | (new_n29_ & x00 & ~x01));
  assign z04 = x01 & ~x00 & new_n29_ & ~x04 & ~x13;
  assign z05 = ~x04 & (x13 | (new_n29_ & x00 & x01));
  assign z06 = new_n34_ | (~x03 & (new_n38_ | (~new_n35_ & ~new_n36_ & new_n37_)));
