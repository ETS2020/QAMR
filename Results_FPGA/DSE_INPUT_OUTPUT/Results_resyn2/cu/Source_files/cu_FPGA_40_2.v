...
module FAU ( 
  ...
  assign new_n31_ = ~x08 & ~x13 & ~x00 & ~x04 & x05;
  assign z03 = ~x13 & (x08 | (new_n33_ & ~x01 & ~x02 & ~x03));
  assign new_n33_ = x00 & ~x04 & x05;
  assign z04 = new_n31_ & x01 & ~x02 & ~x03;
  assign z05 = x01 & ~x02 & ~x03 & new_n33_ & ~x08 & ~x13;
  ...
  assign z08 = (x08 & ~x13) | (new_n41_ & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)));
