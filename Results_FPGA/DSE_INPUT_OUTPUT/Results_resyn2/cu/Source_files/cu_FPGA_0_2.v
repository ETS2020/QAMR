...
module FAU ( 
  ...
  assign z00 = (x13 | (~x02 & (x03 | x04 | ~x05))) & ((~x02 & (x03 | x04 | ~x05)) | x03 | (x02 & (~x04 | x05)));
  assign z01 = (x02 | (~x03 & ~x04 & x05)) & ((~x03 & x04 & ~x05) | ~x02 | ~x13);
  assign z02 = ~x13 & ~x04 & x05 & new_n30_ & ~x00 & ~x01;
  assign new_n30_ = ~x02 & ~x03;
  assign z03 = ~x13 & (x02 | (new_n32_ & x00 & ~x01));
  assign new_n32_ = ~x03 & ~x04 & x05;
  assign z04 = ~x13 & (x02 | (new_n32_ & ~x00 & x01));
  assign z05 = ~x13 & ~x04 & x05 & new_n30_ & x00 & x01;
