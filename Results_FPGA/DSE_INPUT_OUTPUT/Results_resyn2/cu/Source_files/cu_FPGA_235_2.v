...
module FAU ( 
  ...
  wire new_n28_, new_n32_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_;
  assign z00 = ~new_n28_ & ((x04 ? ~x02 : ~x05) | x03 | (x02 & x05));
  assign new_n28_ = x12 & ~x13;
  assign z02 = ~x01 & z07 & ~x00;
  assign z07 = ~x12 & ~x13 & ~x04 & x05 & ~x02 & ~x03;
  assign z03 = ~x13 & (new_n32_ | x12);
  assign new_n32_ = x00 & ~x01 & ~x04 & x05 & ~x02 & ~x03;
  ...
  assign z08 = (x13 ? (~x02 & x05) : (x02 & ~x05)) & new_n40_ & ~x12;
