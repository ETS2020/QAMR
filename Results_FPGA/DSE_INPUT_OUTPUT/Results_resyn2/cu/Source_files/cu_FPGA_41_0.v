...
module FAU ( 
  ...
  assign z02 = ~x01 & (~x10 | (new_n31_ & ~x00));
  assign new_n31_ = ~x04 & x05 & ~x13 & ~x02 & ~x03;
  assign z03 = new_n31_ & x10 & x00 & ~x01;
  assign z04 = x01 ? (new_n31_ & ~x00) : ~x10;
  assign z05 = (~x01 & ~x10) | (new_n31_ & x00 & x01);
  assign z06 = new_n28_ | ((new_n38_ | (~new_n36_ & new_n37_)) & ~x03 & x04);
  assign new_n36_ = (x00 | (x10 & (x01 | x08))) & ((x01 & x11) | ~x00 | (~x01 & x09));
