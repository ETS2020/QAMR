...
module FAU ( 
  ...
  assign new_n34_ = x01 & ~x07 & ~x13 & ~x04 & x05;
  assign z05 = new_n34_ & x00 & ~x02 & ~x03;
  assign z06 = new_n28_ | (new_n41_ & (new_n37_ | (~new_n38_ & ~new_n39_ & new_n40_)));
  ...
  assign z08 = new_n41_ & ((~x12 & x13 & ~x02 & x05) | (~x07 & ~x13 & x02 & ~x05));
