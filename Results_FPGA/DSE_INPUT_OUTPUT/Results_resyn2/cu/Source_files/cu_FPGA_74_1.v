...
module FAU ( 
  ...
  assign z03 = (~x10 & x13) | (new_n29_ & x00 & ~x01);
  assign z04 = ~x00 & new_n29_ & x01;
  assign z05 = x00 & new_n29_ & x01;
  assign z06 = new_n36_ & ((~new_n34_ & new_n35_) | (~x13 & x02 & ~x05));
  assign new_n34_ = (x08 | x00 | x01) & ((x01 & x11) | ~x00 | (~x01 & x09));
  assign new_n35_ = ~x07 & ~x02 & x05 & x13 & x10 & ~x12;
  assign new_n36_ = ~x03 & x04;
  assign z07 = new_n29_ | (~x10 & x13);
  assign z08 = new_n36_ & ((x13 & x10 & ~x12 & ~x02 & x05) | (~x13 & x02 & ~x05));
