...
module FAU ( 
  ...
  assign z00 = z03 | (x02 ? x05 : x04) | x03 | (~x04 & ~x05);
  assign z03 = x00 & ~x13;
  assign z01 = z03 | ((x02 ? ~x05 : ~x04) & ~x03 & (x04 | x05));
  assign z02 = ~x13 & (x00 | (new_n31_ & ~x01));
  assign new_n31_ = ~x02 & x05 & ~x03 & ~x04;
  assign z04 = new_n31_ & ~x13 & ~x00 & x01;
  assign z06 = z03 | (new_n38_ & (new_n34_ | (new_n37_ & (new_n35_ | new_n36_))));
  assign new_n34_ = ~x13 & x02 & ~x05;
  assign new_n35_ = (~x01 | ~x10) & (x01 | ~x08) & ~x00 & x13;
