...
module FAU ( 
  ...
  assign z06 = new_n30_ | (new_n40_ & (new_n36_ | (new_n39_ & (new_n37_ | new_n38_))));
  assign new_n36_ = ~x13 & x02 & ~x05;
  assign new_n37_ = x00 & ((x01 & ~x11) | (~x09 & ~x01 & x05));
  assign new_n38_ = (x01 | ~x08) & (~x01 | ~x10) & ~x00 & x05;
  assign new_n39_ = ~x02 & ~x07 & ~x12 & x13;
  assign new_n40_ = ~x03 & x04;
  assign z07 = new_n30_ | new_n31_;
  assign z08 = (~x05 & ~x11) | (new_n40_ & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13)));
