...
module FAU ( 
  ...
  assign new_n38_ = ~x05 & ~x10 & x02 & ~x13;
  assign z08 = ~new_n40_ & ~x03 & x04;
  assign new_n40_ = (x12 | ~x13 | x02 | ~x05) & (x05 | x10 | ~x02 | x13);
  assign z09 = x13 & x06 & (x05 | ~x10);
  assign z10 = x06 & (x05 | ~x10) & ~x03 & (~x02 | ~x05);
endmodule
