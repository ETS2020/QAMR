...
module FAU ( 
  ...
  assign z02 = ~x01 & ~x00 & new_n30_ & ~x06 & ~x13;
  assign new_n30_ = ~x02 & x05 & ~x03 & ~x04;
  assign z03 = ~x13 & (x06 | (new_n30_ & x00 & ~x01));
  assign z04 = x01 & ~x00 & new_n30_ & ~x06 & ~x13;
  assign z05 = ~x13 & (x06 | (new_n30_ & x00 & x01));
  ...
  assign z07 = new_n30_ & ~x06 & ~x13;
  assign z08 = new_n39_ & ((~x02 & x05 & ~x12 & x13) | (x02 & ~x05 & ~x06 & ~x13));
  assign z09 = x06 & x13;
