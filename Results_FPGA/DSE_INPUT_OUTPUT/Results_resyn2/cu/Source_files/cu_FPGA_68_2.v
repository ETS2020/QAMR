...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n32_, new_n36_, new_n37_, new_n38_;
  assign z01 = ~x02 & ~x03 & ~x04 & x05;
  assign z02 = (x04 & ~x05) | (new_n29_ & new_n30_);
  assign new_n29_ = ~x01 & ~x02;
  assign new_n30_ = ~x00 & ~x04 & x05 & ~x03 & ~x13;
  assign z03 = (x04 & ~x05) | (new_n29_ & new_n32_);
  assign new_n32_ = x00 & ~x04 & x05 & ~x03 & ~x13;
  assign z04 = new_n30_ & x01 & ~x02;
  assign z05 = new_n32_ & x01 & ~x02;
