...
module FAU ( 
  ...
  assign z04 = ~x13 & (~x01 | (new_n31_ & ~x00));
  assign new_n31_ = ~x02 & x05 & ~x03 & ~x04;
  assign z05 = ~x13 & (~x01 | (new_n31_ & x00));
  assign z06 = z02 | (new_n38_ & (new_n34_ | (new_n37_ & (new_n35_ | new_n36_))));
  assign new_n34_ = ~x13 & x02 & ~x05;
  assign new_n35_ = (~x01 | (~x11 & x13)) & x00 & (x01 | ~x09);
  assign new_n36_ = (~x01 | (~x10 & x13)) & ~x00 & (x01 | ~x08);
  assign new_n37_ = ~x07 & ~x12 & ~x02 & x05;
  assign new_n38_ = ~x03 & x04;
  assign z07 = ~x13 & (new_n31_ | ~x01);
  assign z08 = new_n38_ & ((x01 & ~x13 & x02 & ~x05) | (x13 & ~x12 & ~x02 & x05));
  assign z09 = x13 ? x06 : ~x01;
  assign z10 = z02 | ((~x02 | ~x05) & ~x03 & x06);
  assign z03 = 1'b0;
endmodule
