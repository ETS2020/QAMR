...
module FAU ( 
  ...
  assign z01 = (~x03 & ~x04) ? (~x02 & x05) : (~x05 & (x02 | x03));
  assign z02 = (x03 & ~x05) | (~x01 & ~x02 & new_n29_ & ~x00);
  assign new_n29_ = ~x03 & ~x04 & x05 & ~x13;
  assign z03 = (x03 & ~x05) | (~x01 & ~x02 & new_n29_ & x00);
  assign z04 = (x03 & ~x05) | (new_n29_ & ~x00 & x01 & ~x02);
  assign z05 = x01 & ~x02 & new_n29_ & x00;
  ...
  assign z08 = (x03 & ~x05) | (x04 & ((~x13 & x02 & ~x05) | (~x02 & ~x03 & x13 & x05 & ~x12)));
