...
module FAU ( 
  ...
  assign z02 = ~x13 & (x10 | (~x01 & new_n30_ & ~x00));
  assign new_n30_ = ~x02 & x05 & ~x03 & ~x04;
  assign z03 = ~x13 & (x10 | (new_n30_ & x00 & ~x01));
  assign z04 = new_n30_ & ~x00 & ~x13 & x01 & ~x10;
