...
module FAU ( 
  ...
  wire new_n30_, new_n34_, new_n35_, new_n36_;
  assign z01 = ~x02 & ~x04 & ~x03 & x05;
  assign z02 = ~x01 & ~x00 & z01 & ~x13;
  assign z03 = ~x03 & (~x05 | (new_n30_ & x00 & ~x01));
  assign new_n30_ = ~x13 & ~x02 & ~x04;
  assign z04 = x01 & ~x00 & z01 & ~x13;
  assign z05 = ~x03 & (~x05 | (new_n30_ & x00 & x01));
  assign z06 = ~x03 & (~x05 | (~new_n34_ & ~new_n35_ & new_n36_));
  assign new_n34_ = (~x01 | x10) & ~x00 & (x01 | x08);
  assign new_n35_ = (~x01 | x11) & x00 & (x01 | x09);
  assign new_n36_ = ~x07 & ~x02 & x04 & ~x12 & x13;
  assign z07 = z01 & ~x13;
