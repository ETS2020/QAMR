...
module FAU ( 
  ...
  assign z01 = (~x02 & ~x03 & ~x04 & x05) | (x02 & ~x13) | (~x03 & x04 & x02 & ~x05);
  assign z02 = ~x13 & new_n30_ & ~x02 & ~x00 & ~x01;
  ...
  assign z06 = (x02 & ~x13) | (new_n36_ & new_n35_ & ~x07);
  assign new_n35_ = ~x03 & x04 & ~x02 & x05 & ~x12 & x13;
