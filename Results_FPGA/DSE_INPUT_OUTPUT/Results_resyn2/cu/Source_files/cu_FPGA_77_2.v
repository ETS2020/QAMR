...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n32_, new_n35_, new_n37_, new_n38_, new_n39_,
    new_n40_, new_n41_;
  assign z01 = (x04 ? x02 : x05) & ~new_n28_ & ~x03 & (~x02 | ~x05);
  assign new_n28_ = x10 & ~x13;
  assign z02 = new_n30_ & ~x01 & ~x02 & ~x03;
  assign new_n30_ = ~x04 & x05 & ~x13 & ~x00 & ~x10;
  assign z03 = ~x13 & (new_n32_ | x10);
  assign new_n32_ = ~x01 & ~x02 & ~x03 & x00 & ~x04 & x05;
  assign z04 = new_n30_ & x01 & ~x02 & ~x03;
  assign z05 = ~x13 & (new_n35_ | x10);
  assign new_n35_ = x00 & ~x04 & x05 & x01 & ~x02 & ~x03;
  ...
  assign z07 = ~x13 & (x10 | (~x02 & ~x03 & ~x04 & x05));
  assign z08 = (x10 & ~x13) | (new_n41_ & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)));
