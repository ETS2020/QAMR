...
module FAU ( 
  ...
  wire new_n28_, new_n34_, new_n37_, new_n38_, new_n39_, new_n40_, new_n41_;
  ...
  assign new_n34_ = ~x02 & ~x03 & ~x04 & x05 & ~x00 & x01;
  ...
  assign z08 = (x06 & ~x13) | (new_n41_ & ((~x12 & x13 & ~x02 & x05) | (~x13 & x02 & ~x05)));
  assign z10 = ~x03 & (~x02 | ~x05) & x06 & x13;
  assign z09 = x06;
endmodule
