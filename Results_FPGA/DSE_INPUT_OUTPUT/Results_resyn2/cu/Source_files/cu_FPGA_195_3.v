...
module FAU ( 
  ...
  assign z00 = x03 | ((x05 | ~x02 | ~x04) & (x08 | ~x05 | x02 | x04));
  assign z01 = (~x03 & (x05 ? (~x02 & ~x04) : (x02 & x04))) | (x05 & x08);
  assign z02 = ~x01 & z07 & ~x00;
  assign z07 = ~x08 & x05 & ~x02 & ~x04 & ~x03 & ~x13;
  ...
  assign new_n36_ = ~x02 & x05 & x13 & ~x08 & ~x12;
  assign new_n37_ = ~x07 & (~x10 | x00 | ~x01);
  assign new_n38_ = ~x13 & x02 & ~x05;
  assign z08 = ~x03 & x04 & (new_n36_ | new_n38_);
