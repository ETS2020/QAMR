...
module FAU ( 
  ...
  assign z02 = ~x01 & ~x00 & new_n31_ & new_n30_ & ~x03 & x05;
  assign new_n30_ = ~x02 & ~x04;
  assign new_n31_ = ~x13 & (x11 | x12);
  assign z03 = new_n31_ & new_n30_ & ~x03 & x05 & x00 & ~x01;
  assign z04 = x01 & ~x00 & new_n31_ & new_n30_ & ~x03 & x05;
  assign z05 = new_n31_ & new_n30_ & ~x03 & x05 & x00 & x01;
