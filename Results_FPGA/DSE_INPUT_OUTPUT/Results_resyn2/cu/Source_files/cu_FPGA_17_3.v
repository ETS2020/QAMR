...
module FAU ( 
  ...
  assign z04 = (x07 & x13) | (x01 & new_n29_ & ~x00);
  assign z05 = x01 & new_n29_ & x00;
  assign z06 = (new_n35_ | (x07 & x13)) & (new_n36_ | new_n37_ | (x07 & x13) | (new_n34_ & ~x13));
  assign new_n34_ = x02 & ~x05;
  assign new_n35_ = ((~x13 & x02 & ~x05) | (~x02 & x05 & ~x12 & x13)) & ~x03 & x04;
  assign new_n36_ = (~x01 | ~x11) & x00 & (x01 | ~x09);
  assign new_n37_ = (~x01 | ~x10) & ~x00 & (x01 | ~x08);
  assign z07 = new_n29_ | (x07 & x13);
  assign z08 = new_n35_ | (x07 & x13);
