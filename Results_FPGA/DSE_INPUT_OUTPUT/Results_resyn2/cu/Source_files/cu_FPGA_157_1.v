...
module FAU ( 
  ...
  assign z01 = ~x03 & ((x05 & ~x02 & ~x04) | (x02 & ~x05 & x04 & ~x07));
  ...
  assign z06 = (new_n34_ | new_n35_ | new_n36_) & new_n37_ & ~x07;
  ...
  assign z07 = new_n29_ | (~x05 & x07);
  assign z08 = new_n37_ | (~x05 & x07);
  assign z09 = x06 & x13 & (x05 | ~x07);
  assign z10 = (~x05 & x07) | ((~x02 | ~x05) & ~x03 & x06);
  assign z00 = ~z01;
endmodule
