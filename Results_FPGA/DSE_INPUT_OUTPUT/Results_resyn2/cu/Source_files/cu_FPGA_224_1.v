...
module FAU ( 
  ...
  assign z00 = (x02 | (~x03 & (x04 | ~x05))) & (x03 | x05 | ~x02 | ~x04);
  assign z02 = ~x01 & ~x00 & new_n29_ & ~x02 & ~x03;
  assign new_n29_ = ~x13 & ~x04 & x05;
  assign z03 = ~x02 & (x03 | (new_n29_ & x00 & ~x01));
  assign z04 = x01 & ~x00 & new_n29_ & ~x02 & ~x03;
  assign z05 = ~x02 & (x03 | (new_n29_ & x00 & x01));
  assign z06 = new_n37_ | (~x02 & (x03 | (~new_n34_ & ~new_n35_ & new_n36_)));
  assign new_n34_ = (~x01 | x10) & ~x00 & (x01 | x08);
  assign new_n35_ = (~x01 | x11) & x00 & (x01 | x09);
  assign new_n36_ = ~x07 & x04 & x05 & ~x12 & x13;
  assign new_n37_ = ~x03 & ~x05 & x02 & x04 & ~x13;
  assign z07 = new_n29_ & ~x02 & ~x03;
  assign z08 = (~x03 & ~x05 & x02 & x04 & ~x13) | (~x02 & (x03 | (x04 & x05 & ~x12 & x13)));
  assign z09 = (x02 | ~x03) & x06 & x13;
  assign z10 = (x03 | x06) & (~x02 | (~x03 & ~x05));
  assign z01 = ~z00;
endmodule
