...
module FAU ( 
  ...
  assign z02 = new_n30_ | (~x01 & ~x02 & new_n31_ & ~x00);
  assign new_n30_ = ~x05 & x13;
  assign new_n31_ = ~x04 & x05 & ~x03 & ~x13;
  assign z03 = new_n30_ | (~x01 & ~x02 & new_n31_ & x00);
  assign z04 = new_n31_ & ~x00 & x01 & ~x02;
  assign z05 = x01 & ~x02 & new_n31_ & x00;
  assign z06 = new_n30_ | (new_n40_ & (new_n36_ | (~new_n37_ & ~new_n38_ & new_n39_)));
