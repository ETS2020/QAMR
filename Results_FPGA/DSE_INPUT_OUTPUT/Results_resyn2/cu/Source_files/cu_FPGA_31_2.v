...
module FAU ( 
  ...
  assign z01 = (x02 | (~x03 & ~x04 & x05)) & ((~x05 & ~x03 & x04) | ~x02 | ~x13);
  assign z02 = ~x00 & new_n30_ & ~x01 & ~x02 & ~x03 & ~x13;
  assign new_n30_ = ~x04 & x05;
  assign z03 = x00 & new_n30_ & ~x01 & ~x02 & ~x03 & ~x13;
