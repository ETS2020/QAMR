...
module FAU ( 
  ...
  wire new_n33_, new_n36_, new_n37_, new_n38_, new_n39_;
  assign z00 = (x04 | ~x13) & (x03 | (x04 ? (~x02 | x05) : (x02 | ~x05)));
  assign z01 = ~x03 & ((x04 & x02 & ~x05) | (~x13 & ~x04 & ~x02 & x05));
  assign z02 = z07 & ~x00 & ~x01;
  assign z07 = ~x03 & ~x13 & ~x04 & ~x02 & x05;
  assign z03 = ~x01 & z07 & x00;
  assign z04 = ~new_n33_ & ~x04;
  assign new_n33_ = ~x13 & (x02 | ~x05 | x03 | x00 | ~x01);
