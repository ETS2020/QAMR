...
module FAU ( 
  ...
  assign z00 = (~x05 | x11) & ((x05 & (x02 | x04)) | x03 | (~x05 & (~x02 | ~x04)));
  assign z01 = (~x05 | x11) & (~x05 | (~x02 & ~x04)) & ~x03 & (x05 | (x02 & x04));
  assign z02 = x05 & (~x11 | (new_n30_ & ~x00 & ~x01));
  assign new_n30_ = ~x02 & ~x04 & ~x03 & ~x13;
  assign z03 = x00 & ~x01 & new_n30_ & x05 & x11;
  assign z04 = ~x00 & x01 & new_n30_ & x05 & x11;
  assign z05 = x00 & x01 & new_n30_ & x05 & x11;
  ...
  assign z08 = (x05 & ~x11) | (new_n38_ & ((~x02 & x05 & ~x12 & x13) | (x02 & ~x05 & ~x13)));
