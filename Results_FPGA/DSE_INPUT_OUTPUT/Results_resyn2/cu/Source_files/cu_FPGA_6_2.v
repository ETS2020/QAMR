...
module FAU ( 
  ...
  wire new_n28_, new_n31_, new_n34_, new_n37_, new_n38_, new_n39_, new_n40_,
    new_n41_;
  assign z00 = ~new_n28_ & ((x04 ? ~x02 : ~x05) | x03 | (x02 & x05));
  assign new_n28_ = x09 & ~x13;
  assign z01 = ~new_n28_ & (x04 ? x02 : x05) & ~x03 & (~x02 | ~x05);
  assign z02 = ~x00 & new_n31_ & ~x01 & ~x02 & ~x03;
  assign new_n31_ = ~x04 & x05 & ~x09 & ~x13;
  assign z03 = x00 & new_n31_ & ~x01 & ~x02 & ~x03;
  assign z04 = ~x13 & (new_n34_ | x09);
  assign new_n34_ = x01 & ~x02 & ~x03 & ~x00 & ~x04 & x05;
  assign z05 = x01 & ~x02 & ~x03 & new_n31_ & x00;
  ...
  assign z08 = (x09 & ~x13) | (new_n41_ & ((~x12 & x13 & ~x02 & x05) | (~x13 & x02 & ~x05)));
  assign z09 = x06 & x13;
