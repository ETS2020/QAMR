...
module FAU ( 
  ...
  assign z02 = ~x13 & (~x10 | (~x00 & ~x01 & new_n30_ & ~x02));
  assign new_n30_ = ~x03 & ~x04 & x05;
  assign z03 = ~x13 & (~x10 | (new_n30_ & ~x01 & x00 & ~x02));
  assign z04 = ~x00 & x01 & new_n30_ & ~x02 & x10 & ~x13;
  assign z05 = ~x13 & (~x10 | (new_n30_ & x01 & x00 & ~x02));
  ...
  assign z07 = new_n30_ & ~x02 & x10 & ~x13;
  assign z08 = new_n39_ & ((x13 & ~x12 & ~x02 & x05) | (x10 & ~x13 & x02 & ~x05));
