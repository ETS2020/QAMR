...
module FAU ( 
  ...
  assign z02 = ~x13 & (~x12 | (new_n30_ & ~x00 & ~x01));
  assign new_n30_ = ~x02 & ~x03 & ~x04 & x05;
  assign z03 = ~x01 & x00 & new_n30_ & x12 & ~x13;
  assign z04 = ~x13 & (~x12 | (new_n30_ & ~x00 & x01));
  assign z05 = x01 & x00 & new_n30_ & x12 & ~x13;
  ...
  assign z08 = ((~x12 & ~x02 & x05) | (~x13 & x02 & ~x05)) & x04 & ~x03 & (x12 | x13);
  assign z09 = x13 ? x06 : ~x12;
  assign z10 = x06 & (~x02 | ~x05) & ~new_n28_ & ~x03;
