...
module FAU ( 
  ...
  assign z03 = ~x01 & x00 & ~new_n28_ & new_n31_;
  assign z04 = ~new_n28_ & new_n31_ & ~x00 & x01;
  assign z05 = x01 & x00 & ~new_n28_ & new_n31_;
  assign z06 = ~x03 & x04 & (new_n38_ | (~new_n36_ & new_n37_));
  assign new_n36_ = (~x09 | (((~x01 & x08) | x00 | x10) & (x11 | ~x00 | ~x01))) & (~x10 | (((x01 & x11) | ~x00 | x09) & (x08 | x00 | x01)));
