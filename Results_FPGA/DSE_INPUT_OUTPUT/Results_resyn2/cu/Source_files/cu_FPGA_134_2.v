...
module FAU ( 
  ...
  assign z00 = (x05 & (x02 | ~x13)) | x03 | (x04 ? ~x02 : ~x05);
  assign z01 = (x05 & ~x13) | (~x03 & (x04 ? x02 : x05) & (~x02 | ~x05));
  assign z03 = x05 & ~x13;
  assign z06 = (new_n34_ | (~new_n31_ & ~new_n32_ & new_n33_)) & ~x03 & x04;
  assign new_n31_ = (~x01 | x10) & ~x00 & (x01 | x08);
  assign new_n32_ = (~x01 | x11) & x00 & (x01 | x09);
  assign new_n33_ = ~x07 & ~x02 & x13 & x05 & ~x12;
  assign new_n34_ = ~x13 & x02 & ~x05;
  assign z08 = ~x03 & x04 & ((x05 & ~x12 & ~x02 & x13) | (~x13 & x02 & ~x05));
  assign z09 = x06 & x13;
