...
module FAU ( 
  ...
  assign new_n30_ = ~x04 & x05 & ~x09 & ~x13;
  assign z03 = ~x13 & (x09 | (new_n32_ & x00 & ~x01));
  assign new_n32_ = ~x04 & x05 & ~x02 & ~x03;
  assign z04 = new_n30_ & x01 & ~x00 & ~x02 & ~x03;
  assign z05 = ~x13 & (x09 | (new_n32_ & x00 & x01));
  assign z06 = new_n36_ & (new_n40_ | (~new_n37_ & ~new_n38_ & new_n39_));
  ...
  assign new_n40_ = ~x09 & ~x13 & x02 & ~x05;
  assign z07 = ~x13 & (new_n32_ | x09);
  assign z08 = (x09 & ~x13) | (new_n36_ & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)));
