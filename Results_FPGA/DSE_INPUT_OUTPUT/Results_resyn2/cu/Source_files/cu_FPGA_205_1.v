...
module FAU ( 
  ...
  assign z08 = (~x05 & x06) | (new_n39_ & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)));
  assign z09 = x13 & x05 & x06;
  assign z10 = x05 & x06 & ~x02 & ~x03;
endmodule
