...
module FAU ( 
  ...
  assign z01 = (x04 | (~x02 & x05)) & (~x04 | (x02 & ~x05)) & ~x03 & (~x07 | ~x13);
  assign z02 = (x07 & x13) | (~x01 & ~x02 & new_n29_ & ~x00);
  assign new_n29_ = ~x03 & ~x04 & x05 & ~x13;
  assign z03 = (x07 & x13) | (~x01 & ~x02 & new_n29_ & x00);
  assign z04 = new_n29_ & ~x00 & x01 & ~x02;
  assign z05 = (x07 & x13) | (x01 & ~x02 & new_n29_ & x00);
  assign z06 = new_n38_ & (new_n34_ | (~new_n35_ & ~new_n36_ & new_n37_));
  ...
  assign z07 = (new_n29_ & ~x02) | (x07 & x13);
  assign z08 = (x07 & x13) | (new_n38_ & ((~x13 & x02 & ~x05) | (~x02 & x05 & ~x12 & x13)));
