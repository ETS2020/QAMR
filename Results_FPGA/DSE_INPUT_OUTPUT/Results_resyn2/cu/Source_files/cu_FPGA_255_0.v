...
module FAU ( 
  ...
  assign z01 = (x04 ? x02 : x05) & ~z02 & ~x03 & (~x02 | ~x05);
  assign z02 = ~x01 & ~x13;
  assign z04 = ~x00 & ~x02 & ~x03 & new_n30_ & x01 & ~x13;
  assign new_n30_ = ~x04 & x05;
  assign z05 = ~x13 & (~x01 | (~x02 & ~x03 & new_n30_ & x00));
  ...
  assign z07 = ~x02 & ~x03 & new_n30_ & x01 & ~x13;
  assign z08 = (~x01 & ~x13) | (new_n37_ & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)));
  assign z09 = x06 & x13;
  assign z10 = x06 & ~z02 & ~x03 & (~x02 | ~x05);
  assign z00 = (x04 ? ~x02 : ~x05) | z02 | x03 | (x02 & x05);
  assign z03 = z02;
endmodule
