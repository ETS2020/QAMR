...
module FAU ( 
  ...
  assign z03 = ~x01 & x00 & new_n29_ & ~x04 & x05;
  assign z04 = ~x04 & (~x05 | (new_n29_ & ~x00 & x01));
  assign z05 = x01 & x00 & new_n29_ & ~x04 & x05;
  assign z06 = (~x04 & ~x05) | (~x03 & (new_n36_ | (new_n34_ & new_n35_)));
  assign new_n34_ = ~x07 & ~x02 & x04 & x13 & x05 & ~x12;
  assign new_n35_ = ((x01 & ~x11) | ~x00 | (~x01 & ~x09)) & ((x01 & ~x10) | x00 | (~x01 & ~x08));
  assign new_n36_ = ~x13 & x02 & ~x05;
  assign z07 = new_n29_ & ~x04 & x05;
