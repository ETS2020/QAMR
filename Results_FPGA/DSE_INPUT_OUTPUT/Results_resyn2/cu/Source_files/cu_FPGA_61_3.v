...
module FAU ( 
  ...
  assign new_n29_ = ~x00 & ~x04 & x05 & ~x13 & ~x02 & ~x03;
  assign z03 = x05 & (x03 | (new_n31_ & x00 & ~x01));
  assign new_n31_ = ~x13 & ~x02 & ~x04;
  assign z04 = new_n29_ & x01;
  assign z05 = x05 & (x03 | (new_n31_ & x00 & x01));
  ...
  assign z08 = (x04 & ((~x12 & x13 & ~x02 & x05) | (~x03 & ~x13 & x02 & ~x05))) | (x03 & x05);
  assign z09 = (x03 & x05) | (x06 & x13);
  assign z10 = (x03 & x05) | (x06 & ~x03 & (~x02 | ~x05));
  assign z00 = ~z01;
endmodule
