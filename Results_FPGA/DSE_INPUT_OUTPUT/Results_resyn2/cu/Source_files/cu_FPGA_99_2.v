// Benchmark "FAU" written by ABC on Wed Aug 12 17:37:52 2020
...
module FAU ( 
  ...
  assign z02 = x05 & ~x13;
  assign z06 = (new_n33_ | (~new_n30_ & ~new_n31_ & new_n32_)) & ~x03 & x04;
  assign new_n30_ = (~x01 | x10) & ~x00 & (x01 | x08);
  assign new_n31_ = (~x01 | x11) & x00 & (x01 | x09);
  assign new_n32_ = ~x07 & x05 & x13 & ~x02 & ~x12;
  assign new_n33_ = ~x13 & x02 & ~x05;
  assign z08 = ~x03 & x04 & ((x05 & x13 & ~x02 & ~x12) | (x02 & ~x05 & ~x13));
