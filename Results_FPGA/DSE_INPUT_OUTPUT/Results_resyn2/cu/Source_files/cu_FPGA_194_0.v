...
module FAU ( 
  ...
  assign z02 = ~x13 & (~x10 | (new_n30_ & ~x01));
  assign new_n30_ = ~x00 & ~x04 & x05 & ~x02 & ~x03;
  assign z03 = ~x01 & z07 & x00;
  assign z07 = ~x04 & x05 & ~x02 & ~x03 & x10 & ~x13;
  assign z04 = ~x13 & (~x10 | (new_n30_ & x01));
  ...
  assign new_n40_ = x02 & ~x05 & x10 & ~x13;
  assign z08 = (~x10 & ~x13) | (new_n36_ & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05)));
  assign z09 = x06 & x13;
