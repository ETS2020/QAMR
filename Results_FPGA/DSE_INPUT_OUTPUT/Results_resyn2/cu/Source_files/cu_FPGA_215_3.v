...
module FAU ( 
  ...
  assign z01 = ((~x02 & ~x04) | x03 | ~x05) & (x05 | (x04 & x02 & ~x03));
  assign z02 = x05 & (x03 | (new_n29_ & ~x00 & ~x01));
  assign new_n29_ = ~x13 & ~x02 & ~x04;
  assign z03 = x05 & (x03 | (new_n29_ & x00 & ~x01));
  assign z04 = x05 & (x03 | (new_n29_ & ~x00 & x01));
  assign z05 = new_n29_ & ~x03 & x05 & x00 & x01;
  ...
  assign z07 = new_n29_ & ~x03 & x05;
  assign z08 = (x04 & ((~x12 & x13 & ~x02 & x05) | (x02 & ~x03 & ~x05 & ~x13))) | (x03 & x05);
