...
module FAU ( 
  ...
  assign z00 = x03 | ((~x05 | x02 | x04) & (~x04 | x05 | ~x02 | ~x06));
  assign z01 = (~x03 & ((x05 & ~x02 & ~x04) | (x02 & x04 & ~x05))) | (~x05 & ~x06);
  ...
  assign z05 = (~x05 & ~x06) | (x00 & new_n30_ & x01);
  ...
  assign new_n38_ = x02 & x06 & ~x05 & ~x13;
  assign z07 = new_n30_ | (~x05 & ~x06);
  assign z08 = ~new_n41_ & ~x03 & x04;
  assign new_n41_ = (x02 | ~x05 | x12 | ~x13) & (x05 | x13 | ~x02 | ~x06);
  assign z09 = x06 ? x13 : ~x05;
  assign z10 = (~x05 | (~x02 & x06)) & (~x03 | ~x06);
endmodule
