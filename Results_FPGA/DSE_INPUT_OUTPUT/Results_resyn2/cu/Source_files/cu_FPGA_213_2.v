...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n35_, new_n36_, new_n37_, new_n38_, new_n41_;
  ...
  assign new_n35_ = (~x00 | x11) & x01 & (x00 | x10);
  assign new_n36_ = (~x01 | ~x09) & (x08 | (x00 & x09));
  assign new_n37_ = ~x07 & ~x02 & x05 & ~x12 & x13;
  assign new_n38_ = (~x08 | x09) & ~x13 & x02 & ~x05;
  assign z07 = new_n28_ | new_n30_;
  assign z08 = new_n28_ | new_n41_;
  assign new_n41_ = ~x03 & x04 & ((~x02 & x05 & ~x12 & x13) | (~x13 & x02 & ~x05));
