...
module FAU ( 
  ...
  assign z00 = ~z04 & (x03 | (x02 & x05) | (~x02 & x04) | (~x04 & ~x05));
  assign z04 = x01 & ~x13;
  assign z02 = ~x13 & (x01 | (new_n30_ & ~x00));
  assign new_n30_ = ~x02 & x05 & ~x03 & ~x04;
  assign z03 = new_n30_ & ~x13 & x00 & ~x01;
  ...
  assign z10 = z04 | (x06 & ~x03 & (~x02 | ~x05));
  assign z01 = z04 | (~x03 & (~x02 | ~x05) & (x02 | ~x04) & (x04 | x05));
  assign z05 = z04;
endmodule
