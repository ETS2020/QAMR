...
module FAU ( 
  ...
  assign z02 = (~x09 & x13) | (new_n29_ & ~x00 & ~x01);
  assign new_n29_ = ~x02 & x05 & ~x13 & ~x03 & ~x04;
  assign z03 = ~x01 & new_n29_ & x00;
  assign z04 = (~x09 & x13) | (new_n29_ & ~x00 & x01);
  assign z05 = x01 & new_n29_ & x00;
  assign z06 = new_n36_ & ((~new_n34_ & new_n35_) | (~x13 & x02 & ~x05));
  assign new_n34_ = ((x01 & x10) | x00 | (~x01 & x08)) & (x11 | ~x00 | ~x01);
  assign new_n35_ = ~x07 & ~x02 & x05 & x13 & x09 & ~x12;
  assign new_n36_ = ~x03 & x04;
  assign z07 = new_n29_ | (~x09 & x13);
  assign z08 = new_n36_ & ((~x02 & x05 & x13 & x09 & ~x12) | (~x13 & x02 & ~x05));
