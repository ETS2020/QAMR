...
module FAU ( 
  ...
  assign z02 = ~x13 & (x10 | (new_n31_ & ~x00 & ~x01 & ~x02));
  assign new_n31_ = ~x03 & ~x04 & x05;
  assign z03 = ~x13 & (x10 | (new_n31_ & x00 & ~x01 & ~x02));
  assign z04 = ~x13 & (x10 | (new_n31_ & ~x00 & x01 & ~x02));
  assign z05 = new_n31_ & ~x02 & ~x10 & ~x13 & x00 & x01;
  ...
  assign z07 = ~x13 & (x10 | (new_n31_ & ~x02));
  assign z08 = new_n40_ & ((~x02 & x05 & ~x12 & x13) | (~x10 & ~x13 & x02 & ~x05));
