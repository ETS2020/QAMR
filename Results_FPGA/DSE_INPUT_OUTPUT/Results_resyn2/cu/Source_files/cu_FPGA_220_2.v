...
module FAU ( 
  ...
  wire new_n31_, new_n35_, new_n36_;
  assign z01 = ~x02 & ~x03 & ~x04 & x05;
  assign z02 = z07 & ~x00 & ~x01;
  assign z07 = ~x02 & ~x03 & ~x04 & x05 & ~x13;
  assign z03 = (x02 & ~x05) | (new_n31_ & ~x01 & x00 & ~x02);
  assign new_n31_ = ~x04 & x05 & ~x03 & ~x13;
  assign z04 = (x02 & ~x05) | (z07 & ~x00 & x01);
  assign z05 = (x02 & ~x05) | (new_n31_ & x01 & x00 & ~x02);
