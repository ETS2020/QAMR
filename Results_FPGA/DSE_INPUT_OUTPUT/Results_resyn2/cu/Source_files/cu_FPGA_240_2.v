...
module FAU ( 
  ...
  assign z02 = ~x01 & ~x00 & ~new_n28_ & new_n31_;
  assign new_n31_ = ~x04 & x05 & ~x13 & ~x02 & ~x03;
  assign z03 = new_n28_ | (new_n31_ & x00 & ~x01);
  assign z04 = x01 & ~x00 & ~new_n28_ & new_n31_;
  assign z05 = ~new_n28_ & new_n31_ & x00 & x01;
  assign z06 = (new_n36_ | (new_n39_ & (new_n37_ | new_n38_))) & ~new_n28_ & new_n40_;
  assign new_n36_ = ~x13 & x02 & ~x05;
  assign new_n37_ = (~x01 | ~x10) & (x01 | ~x08) & ~x00 & ~x02;
  assign new_n38_ = (x01 | ~x09) & (~x01 | ~x11) & x00 & ~x02;
  assign new_n39_ = x05 & ~x07 & ~x12 & x13;
  assign new_n40_ = ~x03 & x04;
  assign z07 = new_n28_ | new_n31_;
  assign z08 = new_n28_ | (new_n40_ & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13)));
  assign z09 = x06 & (~x09 | x13);
  assign z10 = ~x03 & (~x02 | ~x05) & x06 & x09;
endmodule
