...
module FAU ( 
  ...
  assign z4 = (x03 & x08) | (~new_n39_ & x09);
  assign new_n39_ = ~x10 & ((~x14 & (~x13 | ~x11 | ~x12)) | x08 | (x11 & x12 & x13 & x14));
  ...
  assign z7 = (x06 & x08) | (x09 & (x10 | ((~new_n45_ | ~x17) & ~x08 & (new_n45_ | x17))));
  assign new_n45_ = new_n32_ & new_n41_;
  assign z8 = (x07 & x08) | (x09 & (x10 | (~new_n47_ & ~x08)));
