...
module FAU ( 
  ...
  wire new_n32_, new_n33_, new_n37_, new_n39_;
  assign z0 = ~x10 & x15;
  ...
  assign z4 = new_n37_ | ((~x14 | ~x13 | ~x11 | ~x12) & new_n33_ & (x14 | (x13 & x11 & x12)));
  assign new_n37_ = x03 & x08 & (x10 | ~x15);
  assign z5 = (new_n32_ & x04) | (new_n33_ & new_n39_);
  assign new_n39_ = x14 & x13 & x11 & x12;
  assign z6 = (new_n32_ & x05) | (new_n33_ & x16);
  assign z7 = (x06 & x08) | (~x10 & (x15 | (~x08 & x09 & x17)));
