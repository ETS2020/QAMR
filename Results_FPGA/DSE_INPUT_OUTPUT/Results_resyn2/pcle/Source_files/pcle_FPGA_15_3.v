...
module FAU ( 
  ...
  assign z2 = (x01 & ~new_n31_ & x08) | (new_n34_ & (~x11 | ~x12) & (x11 | x12));
  assign z3 = new_n38_ | (x02 & ~new_n31_ & x08);
  assign new_n38_ = (~x11 | ~x12 | ~x13) & ~x10 & ~x08 & x09 & ((x11 & x12) | x13);
  assign z4 = new_n40_ | ((x14 | (x13 & x11 & x12)) & new_n34_ & (~x11 | ~x12 | ~x13 | ~x14));
  assign new_n40_ = x03 & (x08 | x10);
  assign z5 = ((new_n32_ | x15) & new_n34_ & (~new_n32_ | ~x15)) | new_n31_ | (x04 & x08);
