...
module FAU ( 
  ...
  wire new_n33_;
  assign z1 = (x00 & x08 & (~x11 | ~x12)) | (~x11 & ~x10 & ~x08 & x09);
  assign z2 = (x01 & x08 & (~x11 | ~x12)) | (~x10 & ~x08 & x09 & (~x11 | ~x12) & (x11 | x12));
  assign z3 = (x02 & ~new_n33_ & x08) | (~x10 & ~x08 & x09 & ~new_n33_ & x13);
  assign new_n33_ = x11 & x12;
  assign z4 = ~new_n33_ & ((x03 & x08) | (~x08 & x09 & ~x10 & x14));
  assign z5 = ~new_n33_ & ((x04 & x08) | (~x08 & x09 & ~x10 & x15));
  assign z6 = (x16 & ~x10 & ~x08 & x09) | new_n33_ | (x05 & x08);
