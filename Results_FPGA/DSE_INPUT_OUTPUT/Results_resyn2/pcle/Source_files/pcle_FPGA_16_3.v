...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n35_, new_n36_, new_n41_, new_n43_,
    new_n46_;
  ...
  assign z5 = new_n41_ | new_n36_ | (x04 & x08);
  assign new_n41_ = (x15 | (new_n31_ & x14)) & new_n33_ & (~new_n31_ | ~x14 | ~x15);
  assign z6 = ((~new_n43_ | ~x16) & new_n33_ & (new_n43_ | x16)) | new_n36_ | (x05 & x08);
  assign new_n43_ = new_n31_ & x14 & x15;
  assign z7 = (new_n35_ & x06) | ((~x17 | ~new_n43_ | ~x16) & new_n33_ & (x17 | (new_n43_ & x16)));
  assign z8 = ~x10 & ((x07 & x08) | (~new_n46_ & ~x08 & x09));
  assign new_n46_ = (~x18 | (new_n31_ & x16 & x17 & x14 & x15)) & (~new_n31_ | ~x14 | ~x16 | ~x17 | ~x15 | x18);
endmodule
