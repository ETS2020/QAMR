...
module FAU ( 
  ...
  assign z3 = (new_n36_ & x02) | ((x13 | (x11 & x12)) & new_n32_ & (~x13 | ~x11 | ~x12));
  assign z4 = ~new_n39_ | ((x14 | (x13 & x11 & x12)) & new_n32_ & (~x14 | ~x11 | ~x13));
  assign new_n39_ = (~x03 | ~x08) & (x12 | (~x10 & (~x14 | x08 | ~x09)));
  assign z5 = (new_n36_ & x04) | ((new_n41_ | x15) & new_n32_ & (~new_n41_ | ~x15));
  assign new_n41_ = x11 & x12 & x13 & x14;
  assign z6 = (new_n36_ & x05) | ((~new_n31_ | ~x16) & new_n32_ & (new_n31_ | x16));
  assign z7 = ~new_n46_ | (new_n32_ & (((~new_n44_ | ~new_n45_) & x17) | (new_n41_ & new_n45_ & ~x17)));
  assign new_n44_ = x14 & x11 & x13;
  assign new_n45_ = x15 & x16;
  assign new_n46_ = (~x06 | ~x08) & (x12 | (~x10 & (~x17 | x08 | ~x09)));
  assign z8 = ~new_n49_ | (new_n32_ & (((~new_n44_ | ~new_n48_) & x18) | (new_n48_ & new_n41_ & ~x18)));
  assign new_n48_ = x15 & x16 & x17;
  assign new_n49_ = (~x07 | ~x08) & (x12 | (~x10 & (~x18 | x08 | ~x09)));
endmodule
