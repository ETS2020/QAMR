...
module FAU ( 
  ...
  assign z4 = new_n37_ | (x03 & ~z0 & x08);
  assign new_n37_ = (~x14 | (~x17 & (~x11 | ~x12 | ~x13))) & new_n32_ & (x14 | (x13 & x11 & x12));
  assign z5 = (new_n32_ & ~new_n39_) | z0 | (x04 & x08);
  assign new_n39_ = (~x15 | (x14 & (x17 | (x11 & x12 & x13)))) & (~x11 | ~x12 | ~x13 | ~x14 | x15);
  assign z6 = ~new_n41_ | (x14 & (x17 | (new_n43_ & new_n44_)));
  assign new_n41_ = (~x05 | ~x08) & (new_n42_ | ~new_n32_ | ~x16);
  assign new_n42_ = x14 & x15 & x11 & x12 & x13;
  assign new_n43_ = ~x10 & x11 & x15 & ~x16;
  assign new_n44_ = x12 & x13 & ~x08 & x09;
  assign z7 = (x06 & x08 & (~x14 | ~x17)) | ((new_n46_ | x17) & new_n32_ & (~x14 | ~x17));
  assign new_n46_ = new_n42_ & x16;
