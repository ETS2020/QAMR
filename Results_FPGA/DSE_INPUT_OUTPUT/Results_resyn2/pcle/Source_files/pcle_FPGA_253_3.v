...
module FAU ( 
  ...
  assign z7 = new_n35_ | (x06 & x08) | ((~new_n45_ | ~x17) & new_n33_ & (new_n45_ | x17));
  assign new_n45_ = x16 & new_n31_ & x14 & x15;
  assign z8 = ~x10 & ((x07 & x08) | (~new_n47_ & ~x08 & x09));
  assign new_n47_ = (~x18 | (new_n31_ & x14 & x15 & x16 & x17)) & (~new_n31_ | ~x14 | ~x16 | ~x17 | ~x15 | x18);
endmodule
