...
module FAU ( 
  ...
  assign new_n36_ = ~x10 & (~x12 | ((x11 | x13) & ~x08 & x09 & (~x11 | ~x13)));
  assign z4 = (new_n38_ & x03) | ((x14 | (x11 & x13)) & new_n32_ & (~x14 | ~x11 | ~x13));
  assign new_n38_ = x08 & (x10 | x12);
  assign z5 = new_n40_ | (new_n38_ & x04);
  ...
  assign z7 = (new_n38_ & x06) | ((~x17 | ~new_n31_ | ~x16) & new_n32_ & (x17 | (new_n31_ & x16)));
