...
module FAU ( 
  ...
  assign z5 = ~new_n41_ | ((x15 | (new_n31_ & x14)) & new_n33_ & (~new_n31_ | ~x14 | ~x15));
  assign new_n41_ = (~x04 | ~x08) & (~x10 | ~x18);
  assign z6 = ((~new_n43_ | ~x16) & new_n33_ & (new_n43_ | x16)) | new_n35_ | (x05 & x08);
  assign new_n43_ = x13 & x11 & x12 & x14 & x15;
  assign z7 = ~new_n46_ | ((x17 | (new_n31_ & new_n45_ & x16)) & new_n33_ & (~new_n31_ | ~new_n45_ | ~x16 | ~x17));
  assign new_n45_ = x14 & x15;
  assign new_n46_ = (~x06 | ~x08) & (~x10 | ~x18);
  assign z8 = (x18 & (x10 | (new_n48_ & (~new_n31_ | ~new_n32_)))) | new_n49_ | (new_n31_ & new_n32_ & ~x18 & new_n48_ & ~x10);
