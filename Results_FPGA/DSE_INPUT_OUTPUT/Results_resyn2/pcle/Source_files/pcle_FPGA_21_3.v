...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n35_, new_n37_, new_n39_;
  ...
  assign z4 = (x03 & ~new_n32_ & x08) | (new_n37_ & new_n31_ & ~new_n32_);
  assign new_n37_ = x14 ^ (x13 & x11 & x12);
  assign z5 = (x04 & x08 & (~x15 | ~x16)) | ((new_n39_ | x15) & new_n31_ & (~x15 | ~x16) & (~new_n39_ | ~x15));
  assign new_n39_ = x14 & x13 & x11 & x12;
  assign z6 = (x05 & x08 & (~x15 | ~x16)) | (new_n31_ & (~x15 | ~x16) & (x16 | (new_n39_ & x15)));
  assign z7 = new_n32_ | (x06 & x08) | (new_n31_ & x17);
