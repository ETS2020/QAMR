...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n35_, new_n38_, new_n41_, new_n43_,
    new_n45_, new_n47_;
  assign z0 = new_n31_ & x16 & x17 & new_n33_ & x15 & x18;
  ...
  assign new_n41_ = (x15 | (x16 & new_n32_ & x14)) & new_n33_ & (~new_n32_ | ~x14 | ~x15);
  assign z6 = (x05 & x08 & (x15 | x16)) | ((~new_n43_ | ~x16) & new_n33_ & (new_n43_ | x16));
  assign new_n43_ = new_n32_ & x14 & x15;
  assign z7 = ((~new_n31_ | ~x16 | (x15 & ~x17)) & new_n33_ & (x17 | (new_n31_ & x16))) | new_n45_ | (~x15 & (~x16 | (new_n33_ & x17)));
  assign new_n45_ = x06 & x08;
  assign z8 = (~new_n47_ & new_n33_) | (x07 & ~new_n35_ & x08);
  assign new_n47_ = (~x16 | ((x15 | ~x18) & (~new_n32_ | ~x14 | ~x15 | ~x17 | x18))) & (~x15 | ~x18 | (x16 & x17 & new_n32_ & x14));
endmodule
