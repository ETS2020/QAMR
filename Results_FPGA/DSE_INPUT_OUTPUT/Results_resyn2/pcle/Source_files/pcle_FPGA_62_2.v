...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n36_, new_n38_, new_n39_, new_n41_, new_n43_,
    new_n45_, new_n47_;
  assign z0 = new_n31_ & new_n32_ & x18 & x17 & x15 & x16;
  assign new_n31_ = x14 & x13 & x11 & x12;
  assign new_n32_ = ~x01 & ~x10 & ~x08 & x09;
  assign z1 = (~x10 & (x01 | (~x11 & ~x08 & x09))) | (x00 & x08);
  assign z2 = (x10 & x01 & x08) | (~x01 & ~x10 & ~x08 & x09 & (~x11 | ~x12) & (x11 | x12));
  assign z3 = new_n36_ | (x02 & x08) | (x01 & ~x10);
