...
module FAU ( 
  ...
  assign z4 = ~new_n34_ & ((x03 & x08) | ((new_n39_ | x14) & new_n32_ & (~new_n39_ | ~x14)));
  assign new_n39_ = x13 & x11 & x12;
  assign z5 = ((x15 | (new_n41_ & x16)) & new_n32_ & (~new_n41_ | ~x15)) | (x04 & x08 & (x15 | x16));
  assign new_n41_ = x14 & x13 & x11 & x12;
  assign z6 = ((new_n41_ | x16) & new_n32_ & (~new_n41_ | ~x16)) | (x05 & x08) | (~x15 & (new_n32_ | ~x16));
  assign z7 = ((~new_n41_ | ~x16 | (x15 & ~x17)) & new_n32_ & (x17 | (new_n41_ & x16))) | new_n44_ | (~x15 & (~x16 | (new_n32_ & x17)));
  assign new_n44_ = x06 & x08;
  assign z8 = new_n46_ | (~x15 & (~x16 | (new_n32_ & x18))) | ((~new_n31_ | (x15 & ~x18)) & new_n32_ & (new_n31_ | x18));
