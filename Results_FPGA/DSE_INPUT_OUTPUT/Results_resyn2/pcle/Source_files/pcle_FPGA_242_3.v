...
module FAU ( 
  ...
  assign z4 = ~new_n32_ & ((x03 & x08) | ((~new_n37_ | ~x14) & new_n31_ & (new_n37_ | x14)));
  assign new_n37_ = x13 & x11 & x12;
  assign z5 = ((~new_n39_ | ~x15) & new_n31_ & (new_n39_ | x15)) | (x04 & x08) | (x15 & x16);
  assign new_n39_ = x14 & x13 & x11 & x12;
  assign z6 = (~x15 | ~x16) & (new_n41_ | (new_n31_ & (x16 | (new_n37_ & x14 & x15))));
