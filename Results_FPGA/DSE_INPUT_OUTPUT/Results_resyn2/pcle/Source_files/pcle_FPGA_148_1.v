...
module FAU ( 
  ...
  wire new_n33_, new_n34_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_,
    new_n44_, new_n46_;
  assign z0 = ~x10 & x18;
  ...
  assign z4 = (new_n33_ & x03) | ((~new_n37_ | ~x14) & new_n34_ & (new_n37_ | x14));
  assign new_n37_ = x13 & x11 & x12;
  assign z5 = new_n42_ | (~x10 & (x18 | (~new_n40_ & new_n39_ & ~new_n41_)));
  assign new_n39_ = ~x08 & x09;
  assign new_n40_ = ~x15 & (~x14 | ~x13 | ~x11 | ~x12);
  assign new_n41_ = x14 & x15 & x13 & x11 & x12;
  assign new_n42_ = x04 & x08;
  assign z6 = (new_n33_ & x05) | ((new_n41_ | x16) & new_n34_ & ~new_n44_);
  assign new_n44_ = x16 & x14 & x15 & x13 & x11 & x12;
  assign z7 = new_n46_ | (~x10 & (x18 | ((~new_n44_ | ~x17) & new_n39_ & (new_n44_ | x17))));
  assign new_n46_ = x06 & x08;
  assign z8 = (new_n33_ & x07) | (new_n34_ & new_n44_ & x17);
endmodule
