...
module FAU ( 
  ...
  assign z4 = ((new_n32_ | x14) & new_n33_ & (~new_n32_ | ~x14)) | (x03 & x08) | (x14 & ~x18);
  assign z5 = new_n41_ | (x04 & ~new_n35_ & x08);
  assign new_n41_ = (~x14 | (x18 & (~new_n32_ | ~x15))) & new_n33_ & ((new_n32_ & x14) | x15);
  assign z6 = new_n43_ | (x05 & ~new_n35_ & x08);
  assign new_n43_ = new_n33_ & ((x16 & (~x14 | (x18 & (~new_n32_ | ~x15)))) | (new_n32_ & x14 & x18 & x15 & ~x16));
  assign z7 = (~new_n45_ & new_n33_) | (x06 & ~new_n35_ & x08);
  assign new_n45_ = (~x17 | (x14 & (~x18 | (new_n32_ & x15 & x16)))) & (~new_n32_ | ~x14 | ~x15 | ~x16 | x17 | ~x18);
  assign z8 = (x07 & x08 & (~x14 | x18)) | (~new_n31_ & new_n33_ & x18);
endmodule
