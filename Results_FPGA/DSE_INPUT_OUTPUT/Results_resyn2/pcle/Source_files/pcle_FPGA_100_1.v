...
module FAU ( 
  ...
  assign new_n31_ = new_n32_ & x11 & x12 & x13;
  ...
  assign z4 = new_n39_ | new_n35_ | (x03 & x08);
  assign new_n39_ = ((x11 & x12 & x13) | x14) & new_n33_ & (~x11 | ~x12 | ~x13 | ~x14);
  assign z5 = (x04 & ~new_n35_ & x08) | ((~new_n41_ | ~x15) & new_n33_ & (new_n41_ | x15));
  assign new_n41_ = x13 & x14 & x11 & x12;
  assign z6 = new_n43_ | (x05 & ~new_n35_ & x08);
  assign new_n43_ = (x16 | (new_n41_ & x15)) & new_n33_ & ~new_n44_;
  ...
  assign new_n47_ = ~new_n35_ & (~x07 | ~x08);
endmodule
