// Benchmark "FAU" written by ABC on Wed Aug 12 18:03:55 2020
...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n36_, new_n38_, new_n40_, new_n42_;
  ...
  assign z3 = (new_n36_ & x02) | ((x13 | (x11 & x12)) & new_n31_ & (~x13 | ~x11 | ~x12));
  ...
  assign z7 = (new_n36_ & x06) | ((new_n32_ | x17) & new_n31_ & (~new_n32_ | ~x17));
