...
module FAU ( 
  ...
  assign z5 = ((~new_n41_ | ~x15) & new_n32_ & (new_n41_ | x15)) | new_n34_ | (x04 & x08);
  assign new_n41_ = x14 & x13 & x11 & x12;
  assign z6 = (x05 & x08 & (~x10 | x16)) | ((~new_n31_ | ~x16) & (new_n31_ | x16) & ~x10 & ~x08 & x09);
  assign z7 = ~new_n45_ | ((x17 | (new_n31_ & x16)) & new_n32_ & ~new_n44_);
  assign new_n44_ = x13 & x11 & x12 & x14 & x15 & x17;
  assign new_n45_ = (~x06 | ~x08) & (x16 | (~x10 & (~x17 | x08 | ~x09)));
  assign z8 = ~new_n48_ | (new_n32_ & ((~new_n44_ & x18) | (new_n41_ & new_n47_)));
  assign new_n47_ = x16 & x17 & x15 & ~x18;
  assign new_n48_ = (~x07 | ~x08) & (x16 | (~x10 & (~x18 | x08 | ~x09)));
endmodule
