...
module FAU ( 
  ...
  assign z3 = (new_n34_ & x02) | (((x11 & x12) | x13) & new_n35_ & (~x11 | ~x12 | ~x13));
  assign z4 = (new_n34_ & x03) | (new_n35_ & (~new_n39_ | ~x14) & (new_n39_ | x14));
  assign new_n39_ = x13 & x11 & x12;
  assign z5 = (new_n34_ & x04) | (~new_n31_ & new_n35_);
  assign z6 = (new_n34_ & x05) | ((~new_n31_ | ~x16) & new_n35_ & (new_n31_ | x16));
  assign z7 = new_n46_ | (~x10 & (~x15 | (~new_n44_ & new_n43_ & ~new_n45_)));
  assign new_n43_ = ~x08 & x09;
  assign new_n44_ = ~x17 & (~x13 | ~x11 | ~x12 | ~x14 | ~x16);
  assign new_n45_ = x13 & x11 & x12 & x14 & x16 & x17;
