...
module FAU ( 
  ...
  assign z3 = new_n38_ | ((~x11 | ~x12 | ~x13) & new_n31_ & ((x11 & x12) | x13));
  assign new_n38_ = x02 & (x08 | x10);
  assign z4 = ~new_n40_ | ((x14 | (x11 & x12 & x13)) & new_n31_ & (~x11 | ~x12 | ~x13 | ~x14));
  assign new_n40_ = (~x03 | ~x08) & (~x02 | ~x10);
  assign z5 = ((~new_n32_ | ~x15) & new_n31_ & (new_n32_ | x15)) | new_n35_ | (x04 & x08);
