// Benchmark "FAU" written by ABC on Wed Aug 12 18:05:07 2020
...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n35_, new_n38_, new_n40_, new_n42_;
  ...
  assign z7 = (new_n35_ & x06) | ((new_n32_ | x17) & new_n31_ & (~new_n32_ | ~x17));
  assign z8 = (new_n35_ & x07) | ((x18 | (new_n32_ & x17)) & new_n31_ & (~x18 | ~new_n32_ | ~x17));
endmodule
