...
module FAU ( 
  ...
  assign new_n32_ = ~x08 & x09 & ~x03 & ~x10;
  assign z1 = (~x10 & (x03 | (~x11 & ~x08 & x09))) | (x00 & x08);
  assign z2 = new_n35_ | (x01 & x08);
  assign new_n35_ = ~x10 & (x03 | ((x11 | x12) & ~x08 & x09 & (~x11 | ~x12)));
  assign z3 = (~new_n37_ & ~x10) | (x02 & x08);
  assign new_n37_ = ~x03 & ((~x13 & (~x11 | ~x12)) | x08 | ~x09 | (x13 & x11 & x12));
  assign z4 = (x10 & x03 & x08) | ((new_n39_ | x14) & ~x08 & x09 & ~x03 & ~x10 & (~new_n39_ | ~x14));
  assign new_n39_ = x13 & x11 & x12;
  assign z5 = (new_n41_ & x04) | ((~new_n31_ | ~x15) & new_n32_ & (new_n31_ | x15));
  assign new_n41_ = x08 & (~x03 | x10);
  assign z6 = (~new_n43_ & ~x10) | (x05 & x08);
  assign new_n43_ = ~x03 & ((~x16 & (~new_n31_ | ~x15)) | x08 | ~x09 | (new_n31_ & x15 & x16));
  assign z7 = new_n45_ | (new_n41_ & x06);
  assign new_n45_ = (~x17 | ~new_n31_ | ~x15 | ~x16) & new_n32_ & (x17 | (new_n31_ & x15 & x16));
  assign z8 = (x07 & x08) | (~x10 & (x03 | (~new_n47_ & ~x08 & x09)));
