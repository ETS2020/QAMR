...
module FAU ( 
  ...
  assign z4 = new_n38_ | ((~x14 | ~x13 | ~x11 | ~x12) & new_n36_ & (x14 | (x13 & x11 & x12)));
  assign new_n38_ = x03 & x08 & (x10 | ~x15);
  assign z5 = (x04 & x08) | (~x10 & (new_n40_ | x15));
  assign new_n40_ = x13 & x11 & x12 & ~x08 & x09 & x14;
  assign z6 = (new_n35_ & x05) | (new_n36_ & x16);
  assign z7 = (new_n35_ & x06) | (new_n36_ & x17);
  assign z8 = (new_n35_ & x07) | (new_n36_ & x18);
endmodule
