...
module FAU ( 
  ...
  wire new_n31_, new_n33_, new_n34_, new_n38_, new_n40_;
  ...
  assign z6 = (new_n33_ & x05) | ((~x16 | ~new_n40_ | ~x15) & new_n34_ & (x16 | (new_n40_ & x15)));
  assign z7 = (x06 & x08) | (x09 & (x10 | ((new_n31_ | x17) & ~x08 & (~new_n31_ | ~x17))));
  assign z8 = (new_n33_ & x07) | ((x18 | (new_n31_ & x17)) & new_n34_ & (~x18 | ~new_n31_ | ~x17));
endmodule
