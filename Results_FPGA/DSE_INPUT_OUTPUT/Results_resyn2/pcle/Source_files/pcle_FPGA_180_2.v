...
module FAU ( 
  ...
  assign z1 = (~x11 & ~x10 & ~x08 & x09) | (x10 & ~x17) | (x00 & x08);
  assign z2 = (new_n36_ & x01) | (new_n33_ & (~x11 | ~x12) & (x11 | x12));
  assign new_n36_ = x08 & (~x10 | x17);
  assign z3 = (new_n36_ & x02) | ((x13 | (x11 & x12)) & new_n33_ & (~x13 | ~x11 | ~x12));
  assign z4 = new_n39_ | (x03 & x08) | (x10 & ~x17);
