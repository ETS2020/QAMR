...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n34_, new_n36_, new_n38_, new_n40_, new_n42_,
    new_n44_, new_n45_, new_n46_, new_n49_;
  ...
  assign z4 = new_n40_ | ((x14 | (x13 & x11 & x12)) & new_n31_ & (~x14 | ~x13 | ~x11 | ~x12));
  assign new_n40_ = x03 & x08 & (~x07 | x10);
  assign z5 = (new_n34_ & x04) | ((~new_n42_ | ~x15) & new_n31_ & (new_n42_ | x15));
  assign new_n42_ = x14 & x13 & x11 & x12;
  assign z6 = new_n46_ | (~x10 & (x07 | (~new_n45_ & new_n44_ & ~new_n32_)));
  ...
  assign z8 = new_n49_ | ((x18 | (new_n32_ & x17)) & new_n44_ & ~x10 & (~x18 | ~new_n32_ | ~x17));
