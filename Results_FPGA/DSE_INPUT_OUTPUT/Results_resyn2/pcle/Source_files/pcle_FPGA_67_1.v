...
module FAU ( 
  ...
  assign z4 = ((new_n39_ | x14) & new_n31_ & (~new_n39_ | ~x14)) | new_n34_ | (x03 & x08);
  assign new_n39_ = x13 & x11 & x12;
  assign z5 = ~new_n41_ | (new_n31_ & (~new_n39_ | ~x14 | ~x15) & (x15 | (new_n39_ & x14)));
  assign new_n41_ = (~x04 | ~x08) & (x16 | ~x18);
  assign z6 = (~x16 & ((new_n31_ & new_n32_) | x18)) | (x05 & x08) | (x16 & new_n31_ & ~new_n32_);
  assign z7 = ((~new_n32_ | (x16 & ~x17)) & new_n31_ & (new_n32_ | x17)) | new_n44_ | (~x16 & (x18 | (new_n31_ & x17)));
  assign new_n44_ = x06 & x08;
  assign z8 = ~new_n48_ | (new_n31_ & ((~new_n46_ & x18) | (new_n32_ & new_n47_ & ~x18)));
  assign new_n46_ = x13 & x11 & x12 & x14 & x15 & x17;
  assign new_n47_ = x16 & x17;
  assign new_n48_ = (~x07 | ~x08) & (x16 | ~x18);
endmodule
