...
module FAU ( 
  ...
  assign z6 = new_n44_ | (~x05 & x06) | (x05 & x08);
  assign new_n44_ = (~x16 | ~new_n42_ | ~x15) & new_n35_ & (x16 | (new_n42_ & x15));
  assign z7 = new_n46_ | (x06 & x05 & x08);
  assign new_n46_ = (~x17 | ~new_n42_ | ~x15 | ~x16) & ~new_n34_ & new_n35_ & (x17 | (new_n42_ & x15 & x16));
  assign z8 = (~new_n48_ & new_n35_) | new_n34_ | (x07 & x08);
  assign new_n48_ = (~x18 | (new_n39_ & x13 & new_n33_ & x14 & x17)) & (~new_n33_ | ~new_n39_ | ~x13 | ~x14 | ~x17 | x18);
endmodule
