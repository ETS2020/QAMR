...
module FAU ( 
  ...
  assign z3 = ((~new_n36_ | ~x13) & ~x10 & ~x08 & x09 & (new_n36_ | x13)) | (~x09 & x10) | (x02 & x08);
  assign new_n36_ = x11 & x12;
  assign z4 = new_n39_ | ((x14 | (x13 & x11 & x12)) & new_n38_ & (~x11 | ~x12 | ~x13 | ~x14));
  assign new_n38_ = ~x10 & ~x08 & x09;
  assign new_n39_ = x03 & x08 & (x09 | ~x10);
  assign z5 = (x04 & x08 & (x09 | ~x10)) | ((new_n31_ | x15) & ~x10 & ~x08 & x09 & (~new_n31_ | ~x15));
  assign z6 = ((~new_n42_ | ~x16) & ~x10 & ~x08 & x09 & (new_n42_ | x16)) | (x05 & x08 & (x09 | ~x10));
  assign new_n42_ = x15 & x11 & x12 & x13 & x14;
  assign z7 = new_n44_ | ((x17 | (x16 & new_n31_ & x15)) & new_n38_ & (~new_n31_ | ~x17 | ~x15 | ~x16));
  assign new_n44_ = x06 & x08 & (x09 | ~x10);
  assign z8 = ~new_n46_ | ((~x18 | ~new_n31_ | ~new_n32_) & new_n38_ & (x18 | (new_n31_ & new_n32_)));
