...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n36_, new_n39_, new_n41_, new_n43_, new_n44_,
    new_n45_, new_n47_;
  ...
  assign z4 = (x03 & x08 & (~x09 | ~x10)) | ((~new_n31_ | ~x14) & (new_n31_ | x14) & ~x10 & ~x08 & x09);
  ...
  assign z7 = new_n45_ | ((x17 | (x16 & new_n31_ & new_n43_)) & new_n44_ & (~new_n31_ | ~new_n43_ | ~x16 | ~x17));
  assign new_n43_ = x14 & x15;
  assign new_n44_ = ~x10 & ~x08 & x09;
  assign new_n45_ = x06 & x08 & (~x09 | ~x10);
  assign z8 = new_n47_ | ((~x18 | ~new_n31_ | ~new_n32_) & new_n44_ & (x18 | (new_n31_ & new_n32_)));
