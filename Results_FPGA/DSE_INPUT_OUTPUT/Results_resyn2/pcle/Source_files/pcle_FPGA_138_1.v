...
module FAU ( 
  ...
  assign z6 = (~new_n44_ & x05) | (new_n34_ & ~x15 & x16);
  assign new_n44_ = ~x08 & ((~x16 & (~new_n42_ | ~x15)) | (new_n42_ & x16) | ~x09 | x10);
  assign z7 = new_n46_ | (~new_n35_ & x06 & x08);
  assign new_n46_ = new_n34_ & ((x17 & (~x15 | (x05 & (~new_n42_ | ~x16 | ~x17)))) | (x05 & (~new_n42_ | ~x16 | ~x17) & x16 & new_n42_ & x15));
  assign z8 = (x15 & (new_n48_ | ~x05)) | new_n49_ | (x07 & x08);
  assign new_n48_ = new_n32_ & x16 & x17 & ~x18 & x13 & x14;
  assign new_n49_ = (~x16 | ~x17 | ~new_n42_ | ~x15) & new_n34_ & x18;
endmodule
