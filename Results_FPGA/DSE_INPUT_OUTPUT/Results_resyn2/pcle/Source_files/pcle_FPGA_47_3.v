...
module FAU ( 
  ...
  assign z2 = (new_n31_ & (~x11 | ~x12) & (x11 | x12)) | (x12 & x15) | (x01 & x08);
  assign z3 = new_n34_ | (x02 & x08) | (x12 & x15);
  assign new_n34_ = (~x13 | ~x11 | ~x12) & ~x10 & ~x08 & x09 & (x13 | (x11 & x12));
  assign z4 = (x12 & (new_n37_ | x15)) | new_n39_ | (new_n38_ & (~new_n36_ | x15));
  assign new_n36_ = x13 & x11 & x12;
  assign new_n37_ = ~x10 & ~x08 & x09 & ~x14 & x11 & x13;
  assign new_n38_ = x14 & ~x10 & ~x08 & x09;
  assign new_n39_ = x03 & x08;
  assign z5 = (new_n31_ & (new_n41_ | x15)) | (x12 & x15) | (x04 & x08);
  assign new_n41_ = x14 & x13 & x11 & x12;
  assign z6 = (x05 & x08) | (x12 & x15) | (new_n31_ & x16);
