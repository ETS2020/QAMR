// Benchmark "FAU" written by ABC on Wed Aug 12 18:03:54 2020
...
module FAU ( 
  ...
  assign z3 = (x02 & x08 & (x09 | x10)) | ((new_n32_ | x13) & ~x10 & ~x08 & x09 & (~new_n32_ | ~x13));
  assign z4 = (~new_n38_ & ~x10) | (x03 & x08);
  assign new_n38_ = x09 & ((~x14 & (~x13 | ~x11 | ~x12)) | x08 | (x13 & x14 & x11 & x12));
  assign z5 = (x04 & x08) | (~x10 & (~x09 | ((new_n40_ | x15) & ~x08 & (~new_n40_ | ~x15))));
  assign new_n40_ = x11 & x12 & x13 & x14;
  assign z6 = new_n42_ | (x05 & x08 & (x09 | x10));
  assign new_n42_ = (x16 | (new_n40_ & x15)) & ~x10 & ~x08 & x09 & (~new_n40_ | ~x15 | ~x16);
