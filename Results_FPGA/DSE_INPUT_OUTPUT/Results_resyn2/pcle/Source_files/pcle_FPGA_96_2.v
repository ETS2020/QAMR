...
module FAU ( 
  ...
  assign z3 = new_n38_ | (x10 & ~x12) | (x02 & x08);
  assign new_n38_ = (x13 | (x11 & x12)) & ~x08 & x09 & (~x10 | ~x12) & (~x13 | ~x11 | ~x12);
  assign z4 = ~new_n40_ | ((x14 | (x13 & x11 & x12)) & new_n32_ & (~x11 | ~x13 | ~x14));
  assign new_n40_ = (~x03 | ~x08) & (x12 | (~x10 & (~x14 | x08 | ~x09)));
  assign z5 = (new_n35_ & x04) | ((new_n42_ | x15) & new_n32_ & (~new_n42_ | ~x15));
  assign new_n42_ = x11 & x12 & x13 & x14;
  assign z6 = (new_n35_ & x05) | ((~new_n31_ | ~x16) & new_n32_ & (new_n31_ | x16));
  assign z7 = (new_n35_ & x06) | ((~new_n45_ | ~x17) & new_n32_ & (new_n45_ | x17));
  assign new_n45_ = x11 & x12 & x13 & x14 & x15 & x16;
  assign z8 = ~new_n49_ | (new_n32_ & (((~new_n47_ | ~new_n48_) & x18) | (new_n48_ & new_n42_ & ~x18)));
