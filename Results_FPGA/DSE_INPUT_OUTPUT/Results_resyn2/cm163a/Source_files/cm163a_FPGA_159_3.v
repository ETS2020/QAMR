...
module FAU ( 
  ...
  assign z1 = ((~x07 | ~x11) & (~x05 | (~x01 & ~x04))) | ((new_n26_ | (~x07 & x11)) & x04 & (~new_n26_ | ~x11));
  assign new_n26_ = ~x09 & x02 & x03;
  assign z2 = ((~new_n26_ | (~x11 & ~x12)) & x04 & (new_n26_ | x12)) | ~new_n28_ | (x11 & (x07 | (x04 & x12)));
  assign new_n28_ = x05 & (x04 | x06);
  assign z3 = (~new_n30_ & x04) | (x11 & (x07 | x13)) | ~x05 | (~x04 & ~x07);
