...
module FAU ( 
  ...
  assign new_n24_ = x05 & (~x01 | ~x07);
  assign z1 = ((~x01 | (x04 & ~x07)) & (new_n26_ ^ x11)) | (~x01 & ~x04) | (~x05 & (~x01 | ~x07));
  assign new_n26_ = ~x09 & x02 & x03;
  assign z2 = (x04 & ((x12 & (~new_n26_ | x11)) | (new_n26_ & ~x11 & ~x12))) | ~new_n24_ | (~x04 & ~x06);
  assign z3 = ((~new_n29_ | ~x13) & (~x07 | (~x01 & x04)) & (new_n29_ | x13)) | (~x05 & (~x01 | ~x07)) | (~x04 & ~x07);
  assign new_n29_ = ~x09 & x02 & x03 & ~x11 & ~x12;
  assign z4 = new_n31_ | (x01 & x07);
