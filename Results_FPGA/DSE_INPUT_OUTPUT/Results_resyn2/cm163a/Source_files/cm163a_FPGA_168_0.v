...
module FAU ( 
  ...
  assign new_n25_ = ~x09 & ~x11 & x02 & x04;
  assign new_n26_ = (x01 | x04) & ((~x09 & x02 & x03) | ~x04 | ~x11);
  assign z2 = (x03 & (new_n28_ | ~x05)) | ((new_n29_ | ~x04) & x05 & (x04 | ~x06));
  assign new_n28_ = ~x12 & ~x09 & ~x11 & x02 & x04;
  assign new_n29_ = x12 & (x09 | x11 | ~x02 | ~x03);
  assign z3 = (x03 & (new_n31_ | ~x05)) | (x05 & (new_n34_ | (~new_n32_ & new_n33_)));
  assign new_n31_ = ~x13 & ~x12 & ~x09 & ~x11 & x02 & x04;
  assign new_n32_ = ~x12 & ~x09 & ~x11 & x02 & x03;
