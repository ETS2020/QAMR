// Benchmark "FAU" written by ABC on Wed Aug 12 14:46:13 2020
...
module FAU ( 
  ...
  assign z1 = (x04 & new_n24_ & ~x09) | (~x01 & ~x04) | ~x05 | x11;
  assign z2 = (~new_n27_ & x04) | ~x05 | x11 | (~x04 & ~x06);
  assign new_n27_ = (~x12 | (~x09 & x02 & x03)) & (~x02 | ~x03 | x09 | x12);
