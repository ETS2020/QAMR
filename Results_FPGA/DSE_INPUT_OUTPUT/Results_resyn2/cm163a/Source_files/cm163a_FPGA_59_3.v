...
module FAU ( 
  ...
  assign new_n26_ = ~x09 & ~x13 & x02 & x03;
  assign new_n27_ = x03 & (x13 | (x02 & x04 & ~x09 & ~x11));
  assign z2 = ((~x03 | ~x13) & (~x05 | (~x04 & ~x06))) | (~new_n29_ & x04);
  assign new_n29_ = (~x12 | (x03 & (x13 | (x02 & ~x09 & ~x11)))) & (x13 | ~x02 | ~x03 | x12 | x09 | x11);
  assign z3 = (x03 & (new_n31_ | x13)) | (~x04 & ~x07) | ~x05 | (x04 & x13);
  assign new_n31_ = x02 & x04 & ~x12 & ~x09 & ~x11;
