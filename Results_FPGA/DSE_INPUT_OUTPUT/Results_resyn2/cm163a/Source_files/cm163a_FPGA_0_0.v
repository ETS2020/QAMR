// Benchmark "FAU" written by ABC on Wed Aug 12 14:45:56 2020
...
module FAU ( 
  ...
  assign z0 = (x05 | x11) & ((~new_n24_ & x04) | ~x05 | (~x00 & ~x04));
  assign new_n24_ = x09 ^ (~x02 | ~x03);
  assign z1 = (x11 & (~x05 | (~new_n26_ & x04))) | ((~x04 | (new_n26_ & ~x11)) & x05 & (~x01 | x04));
