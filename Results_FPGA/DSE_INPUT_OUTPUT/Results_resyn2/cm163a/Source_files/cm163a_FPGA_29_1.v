...
module FAU ( 
  ...
  assign new_n27_ = ~x09 & (x13 | (x02 & x03 & x04 & ~x11));
  assign z2 = (~new_n29_ & ~x09) | ~new_n31_ | (~new_n30_ & x04 & x12);
  assign new_n29_ = ~x13 & (x12 | ~x02 | ~x03 | ~x04 | x11);
  assign new_n30_ = ~x09 & x02 & x03 & ~x11 & ~x13;
  assign new_n31_ = x05 & (x04 | x06);
  assign z3 = (~new_n33_ & x04) | ((x09 | ~x13) & (~x05 | (~x07 & (~x04 | x13))));
  assign new_n33_ = (~x09 | ~x13) & (x09 | ~x02 | ~x03 | x12 | x11 | x13);
