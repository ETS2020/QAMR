...
module FAU ( 
  ...
  assign new_n26_ = x11 ? (~x09 & (x15 | (x02 & x03))) : (~x02 | ~x03 | x09 | x15);
  assign z2 = (~new_n29_ & ~x09) | ~new_n30_ | (~new_n28_ & x04 & x12);
  assign new_n28_ = ~x11 & x02 & x03 & ~x09 & ~x15;
  assign new_n29_ = ~x15 & (~x02 | ~x03 | x12 | ~x04 | x11);
  assign new_n30_ = x05 & (x04 | x06);
  assign z3 = (~x09 & (new_n32_ | x15)) | ~new_n35_ | (~new_n33_ & new_n34_);
  assign new_n32_ = ~x13 & x02 & x03 & ~x12 & x04 & ~x11;
  assign new_n33_ = ~x12 & ~x11 & x02 & x03 & ~x09 & ~x15;
