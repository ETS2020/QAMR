...
module FAU ( 
  ...
  assign z2 = new_n28_ | (~new_n29_ & x04 & (~x09 | x13));
  assign new_n28_ = (~x04 | (~x05 & (~x09 | ~x12))) & (~x09 | x13) & (~x05 | ~x06);
  assign new_n29_ = ~x12 ^ (x02 & x03 & ~x09 & ~x11);
  assign z3 = ((~x09 | x13) & (~x05 | (~x04 & ~x07))) | ((~new_n31_ | ~x13) & x04 & (new_n31_ | x13));
  assign new_n31_ = ~x12 & x02 & x03 & ~x09 & ~x11;
  assign z4 = new_n33_ & x15 & x10 & x14;
  assign new_n33_ = x03 & x08 & (~x09 | x13);
endmodule
