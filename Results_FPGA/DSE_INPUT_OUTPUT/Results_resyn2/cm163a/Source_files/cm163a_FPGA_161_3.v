...
module FAU ( 
  ...
  assign z2 = (~new_n28_ & x04 & x12) | new_n29_ | ~x05 | (~x04 & ~x06);
  assign new_n28_ = x02 & ~x09 & ~x11 & x03 & ~x06;
  assign new_n29_ = x03 & (x06 | (x02 & ~x09 & ~x11 & ~x12));
  assign z3 = (x03 & (new_n32_ | x06)) | ~new_n34_ | (new_n33_ & (~new_n31_ | ~x03 | x06));
  assign new_n31_ = x02 & ~x09 & ~x11 & ~x12;
  assign new_n32_ = ~x09 & x02 & x04 & ~x13 & ~x11 & ~x12;
