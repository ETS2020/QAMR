...
module FAU ( 
  ...
  assign z2 = new_n29_ | (~new_n30_ & x04 & x12) | ~x05 | (~x04 & ~x06);
  assign new_n29_ = x02 & (x06 | (x03 & ~x12 & ~x09 & ~x11));
  assign new_n30_ = ~x06 & x02 & x03 & ~x09 & ~x11;
  assign z3 = (x02 & (new_n32_ | x06)) | ~new_n35_ | (~new_n33_ & new_n34_);
  assign new_n32_ = ~x12 & ~x13 & ~x09 & ~x11 & x03 & x04;
  assign new_n33_ = ~x06 & x02 & x03 & ~x12 & ~x09 & ~x11;
  assign new_n34_ = x04 & x13;
  assign new_n35_ = x05 & (x04 | x07);
  assign z4 = new_n37_ & x15 & x10 & x14;
  assign new_n37_ = (~x02 | ~x06) & x03 & x08;
endmodule
