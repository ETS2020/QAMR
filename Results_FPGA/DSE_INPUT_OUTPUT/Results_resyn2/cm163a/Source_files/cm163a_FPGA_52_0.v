...
module FAU ( 
  ...
  assign z0 = (~x05 & x12) | (((new_n24_ & ~x09) | ~x04 | (~new_n24_ & x09)) & x05 & (~x00 | x04));
  assign new_n24_ = x02 & x03;
  assign z1 = (~x05 & x12) | (((new_n26_ & ~x11) | ~x04 | (~new_n26_ & x11)) & x05 & (~x01 | x04));
  assign new_n26_ = ~x09 & x02 & x03;
  assign z2 = (x04 & (~x12 ^ (~new_n26_ | x11))) | ~x05 | (~x04 & ~x06);
