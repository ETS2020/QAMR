...
module FAU ( 
  ...
  assign z1 = (~new_n27_ & ~x11) | (~new_n26_ & x04 & x11) | ~x05 | (~x01 & ~x04);
  assign new_n26_ = ~x09 & x02 & x03;
  assign new_n27_ = ~x15 & (~x02 | ~x03 | ~x04 | x09);
  assign z2 = (~new_n29_ & ~x11) | ~new_n31_ | (~new_n30_ & x04 & x12);
  assign new_n29_ = ~x15 & (x12 | ~x02 | ~x03 | ~x04 | x09);
  assign new_n30_ = ~x09 & x02 & x03 & ~x11 & ~x15;
  assign new_n31_ = x05 & (x04 | x06);
  assign z3 = (~x11 & (new_n33_ | x15)) | (~new_n34_ & new_n35_) | ~new_n36_;
  assign new_n33_ = x02 & x03 & x04 & ~x09 & ~x12 & ~x13;
  assign new_n34_ = ~x09 & x02 & x03 & ~x12 & ~x11 & ~x15;
