...
module FAU ( 
  ...
  assign z2 = new_n29_ | ((~new_n28_ | ~x12) & (new_n28_ | x12) & x04 & (~x09 | ~x13));
  assign new_n28_ = ~x11 & ~x09 & x02 & x03;
  assign new_n29_ = (~x04 | (~x05 & (~x09 | ~x12))) & (~x09 | ~x13) & (~x05 | ~x06);
  assign z3 = ((~x09 | ~x13) & (~x05 | (~x04 & ~x07))) | ((~new_n31_ | ~x13) & (new_n31_ | x13) & x04 & ~x09);
