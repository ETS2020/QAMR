...
module FAU ( 
  ...
  wire new_n24_, new_n27_, new_n28_, new_n30_, new_n31_, new_n32_, new_n33_,
    new_n35_;
  assign z0 = x05 ? ((~x00 | x04) & ((~new_n24_ & x09) | ~x04 | (new_n24_ & ~x09))) : ~x11;
  assign new_n24_ = x02 & x03;
  assign z1 = (~x11 & (~x05 | (new_n24_ & x04 & ~x09))) | (x05 & ((~x01 & ~x04) | (x11 & x04 & (~new_n24_ | x09))));
  assign z2 = (~x11 & (new_n27_ | ~x05)) | ((new_n28_ | ~x04) & x05 & (x04 | ~x06));
  assign new_n27_ = ~x12 & x02 & x03 & x04 & ~x09;
  assign new_n28_ = x12 & (~x02 | ~x03 | x09 | x11);
  assign z3 = (~x11 & (new_n30_ | ~x05)) | (x05 & (new_n33_ | (~new_n31_ & new_n32_)));
  assign new_n30_ = ~x13 & ~x12 & x02 & x03 & x04 & ~x09;
