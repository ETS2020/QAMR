...
module FAU ( 
  ...
  assign new_n26_ = x03 & (x06 | (~x11 & ~x09 & x02 & x04));
  assign new_n27_ = ~x09 & x02 & x03 & ~x06;
  assign z2 = (~new_n29_ & x04 & x12) | new_n30_ | ~x05 | (~x04 & ~x06);
  assign new_n29_ = ~x11 & ~x09 & x02 & x03 & ~x06;
  assign new_n30_ = x03 & (x06 | (~x11 & ~x12 & x02 & ~x09));
  assign z3 = (x03 & (new_n33_ | x06)) | ~new_n35_ | (new_n34_ & (~new_n32_ | ~x03 | x06));
  assign new_n32_ = ~x11 & ~x12 & x02 & ~x09;
  assign new_n33_ = ~x09 & x02 & x04 & ~x13 & ~x11 & ~x12;
