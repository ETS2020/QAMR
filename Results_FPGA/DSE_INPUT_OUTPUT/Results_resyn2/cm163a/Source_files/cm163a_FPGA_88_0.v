...
module FAU ( 
  ...
  wire new_n25_, new_n28_, new_n29_, new_n31_;
  assign z0 = (x04 & (~x09 ^ (~x02 | ~x03))) | ~x05 | (~x00 & ~x04);
  assign z1 = (x11 & (~x05 | (~new_n25_ & x04))) | ((~x04 | (new_n25_ & ~x11)) & x05 & (~x01 | x04));
  assign new_n25_ = ~x09 & x02 & x03;
  assign z2 = (x04 & ((x12 & (~new_n25_ | x11)) | (new_n25_ & ~x11 & ~x12))) | ~x05 | (~x04 & ~x06);
  assign z3 = (x11 | (~new_n28_ & x05)) & ((~new_n29_ & x04) | ~x05 | (~x04 & ~x07));
  assign new_n28_ = ~x09 & x02 & x03 & x13 & x04 & ~x12;
  assign new_n29_ = ~x13 & (x09 | ~x02 | ~x03 | x11 | x12);
