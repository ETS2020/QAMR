...
module FAU ( 
  ...
  assign z0 = (x04 & (new_n24_ ^ x09)) | (~x00 & ~x04) | ~x01 | ~x05;
  assign new_n24_ = x02 & x03;
  assign z1 = ~x01 | ~x05 | (x04 & ((x11 & (~new_n24_ | x09)) | (new_n24_ & ~x09 & ~x11)));
  assign z2 = ~x05 | (((~new_n27_ & x12) | ~x04 | (new_n27_ & ~x12)) & x01 & (x04 | ~x06));
  assign new_n27_ = x02 & x03 & ~x09 & ~x11;
  assign z3 = ((~new_n29_ | ~x13) & x04 & (new_n29_ | x13)) | ~x01 | ~x05 | (~x04 & ~x07);
  assign new_n29_ = ~x12 & x02 & x03 & ~x09 & ~x11;
  assign z4 = new_n31_ & x15 & x10 & x14;
  assign new_n31_ = x03 & x08 & (x01 | ~x05);
endmodule
