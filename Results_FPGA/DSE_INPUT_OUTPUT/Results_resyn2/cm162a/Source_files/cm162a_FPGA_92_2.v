...
module FAU ( 
  ...
  assign z2 = new_n29_ | (x03 & ((~new_n26_ & x11) | (~new_n27_ & new_n28_)));
  assign new_n26_ = (~x09 | ~x13) & x02 & x04 & ~x08 & ~x10;
  assign new_n27_ = (~x09 | ~x13) & (x11 | x08 | x10);
  assign new_n28_ = ~x07 & x02 & x04;
  assign new_n29_ = (~x07 | x11) & (~x05 | (~x03 & ~x06));
  assign z3 = (new_n33_ & (new_n31_ | new_n32_)) | ~new_n36_ | (~new_n34_ & new_n35_);
  assign new_n31_ = x03 & x09 & x13;
  assign new_n32_ = ~x12 & ~x11 & ~x08 & ~x10;
  assign new_n33_ = x04 & (x02 | x12);
  assign new_n34_ = ~x11 & x02 & x04 & ~x08 & ~x10;
  assign new_n35_ = x03 & x12;
  assign new_n36_ = (x03 | x07) & x05 & (~x07 | x11);
