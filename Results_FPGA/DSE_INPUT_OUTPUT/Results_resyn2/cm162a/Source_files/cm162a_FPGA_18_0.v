...
module FAU ( 
  ...
  assign z1 = (~new_n26_ & x03) | (x04 & ~x05) | (~x01 & ~x03 & x05);
  assign new_n26_ = (~new_n24_ | (~new_n23_ & (x08 | x10))) & ((new_n24_ & ~x08) | ~x05 | ~x10);
  ...
  assign new_n30_ = (~x04 | ((~new_n23_ | (~x02 & ~x12)) & (~new_n31_ | ~x02 | x12))) & ((new_n31_ & x02 & x04) | ~x05 | ~x12);
