...
module FAU ( 
  ...
  assign new_n22_ = (x00 | x03) & (new_n23_ | ~x03 | ~x08);
  ...
  assign new_n27_ = (x11 | ((new_n28_ | new_n29_) & x02 & x04)) & x03 & (new_n28_ | ~x02 | ~x04 | ~new_n29_ | ~x11);
  assign new_n28_ = x09 & x13;
  assign new_n29_ = ~x08 & ~x10;
  assign z3 = (x03 & (new_n31_ | new_n32_)) | (x05 ? (~x03 & ~x07) : x04);
  assign new_n31_ = x02 & x04 & (new_n28_ | (new_n29_ & ~x11 & ~x12));
  assign new_n32_ = x05 & x12 & (~new_n23_ | ~new_n29_ | x11);
  assign z4 = x04 ? new_n28_ : ~x05;
endmodule
