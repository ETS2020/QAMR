...
module FAU ( 
  ...
  assign z1 = (x01 & ~x05) | ((new_n25_ | new_n26_ | new_n24_ | ~x03) & x05 & (~x01 | x03));
  assign new_n24_ = x02 & x04 & x09 & x13;
  assign new_n25_ = x10 & (x08 | ~x02 | ~x04);
  assign new_n26_ = x02 & x04 & ~x08 & ~x10;
  assign z2 = ~new_n29_ | (x03 & (new_n28_ | new_n24_ | (~new_n26_ & x11)));
  assign new_n28_ = ~x08 & ~x10 & ~x11 & x02 & x04;
  assign new_n29_ = x05 & (x03 | x06);
  assign z3 = (x03 & ((new_n28_ & ~x12) | new_n31_ | (~new_n28_ & x12))) | ~x05 | (~x03 & ~x07);
