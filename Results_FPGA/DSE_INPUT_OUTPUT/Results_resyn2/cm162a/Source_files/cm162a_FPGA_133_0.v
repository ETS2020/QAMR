...
module FAU ( 
  ...
  assign z0 = (~x08 & (~x06 | (new_n22_ & x03))) | ~new_n24_ | ((~new_n22_ | new_n23_) & x03 & x08);
  ...
  assign z2 = (~new_n30_ & x03 & (x08 | (~new_n28_ & x06))) | ((x06 | x08) & (~x05 | (~x03 & ~x06)));
  assign new_n28_ = new_n29_ & ~x10 & x11;
  assign new_n29_ = x02 & x04 & (~x09 | ~x13);
  assign new_n30_ = ~x11 & (~new_n22_ | (~new_n23_ & (x08 | x10)));
  assign z3 = (~new_n32_ & ~new_n33_ & x03) | ~new_n34_ | (~x03 & ~x07);
  assign new_n32_ = ~x12 & (~new_n22_ | (~new_n23_ & (x08 | x10 | x11)));
  assign new_n33_ = new_n29_ & ~x10 & ~x11 & x12 & x06 & ~x08;
  assign new_n34_ = x05 & (x06 | x08);
