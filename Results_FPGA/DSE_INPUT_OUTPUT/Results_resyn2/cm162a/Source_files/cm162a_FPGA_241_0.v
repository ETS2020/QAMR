...
module FAU ( 
  ...
  assign z2 = new_n29_ | ((new_n23_ | new_n28_) & x03 & (new_n27_ | x11));
  assign new_n27_ = x02 & x04 & ((x09 & x13) | (~x08 & ~x10));
  assign new_n28_ = x05 & (x08 | ~x02 | ~x04 | x10 | ~x11);
  assign new_n29_ = x05 ? (~x03 & ~x06) : x13;
  assign z3 = ~new_n32_ | ((x12 | (new_n22_ & (new_n23_ | new_n31_))) & x03 & (~new_n31_ | new_n23_ | ~new_n22_ | ~x12));
