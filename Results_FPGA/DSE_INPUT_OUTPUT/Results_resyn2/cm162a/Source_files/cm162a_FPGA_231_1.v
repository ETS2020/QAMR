...
module FAU ( 
  ...
  assign z0 = (x08 & x13 & x03 & x09) | (~new_n22_ & (x09 | ~x12));
  assign new_n22_ = (~x03 | (x08 ^ (~x02 | ~x04))) & x05 & (x00 | x03);
  assign z1 = new_n25_ | (~new_n24_ & ((~new_n26_ & x03) | ~x05 | (~x01 & ~x03)));
  assign new_n24_ = ~x09 & x12;
  assign new_n25_ = x13 & x03 & x09 & (x10 | (x02 & x04));
  assign new_n26_ = x10 ^ (x08 | ~x02 | ~x04);
  assign z2 = new_n29_ | (~new_n24_ & ((~new_n28_ & x03) | ~x05 | (~x03 & ~x06)));
  assign new_n28_ = (~x11 | (~x10 & ~x08 & x02 & x04)) & (x10 | x11 | x08 | ~x02 | ~x04);
  assign new_n29_ = x13 & x03 & x09 & (x11 | (x02 & x04));
  assign z3 = ~new_n34_ | (x03 & (new_n31_ | (~new_n32_ & new_n33_)));
  assign new_n31_ = x12 & (x10 | x11 | x08 | ~x02 | ~x04);
  assign new_n32_ = (~x09 | ~x13) & (x10 | x11 | x08 | x12);
  assign new_n33_ = x04 & (x02 | x12);
  assign new_n34_ = (x03 | x07) & x05 & (x09 | ~x12);
