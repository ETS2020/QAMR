...
module FAU ( 
  ...
  assign z2 = ~new_n29_ | (x03 & ((x11 & (~new_n27_ | ~new_n28_)) | (new_n26_ & new_n27_) | (~x11 & new_n27_ & new_n28_)));
  assign new_n26_ = x09 & x13;
  assign new_n27_ = x02 & x04;
  assign new_n28_ = ~x08 & ~x10;
  assign new_n29_ = x05 & (~x07 | ~x11) & (x03 | x06);
  assign z3 = new_n31_ | (new_n27_ & (new_n32_ | new_n33_)) | (~new_n34_ & new_n35_);
  assign new_n31_ = (~x07 | ~x11) & (~x05 | (~x07 & (~x03 | (x11 & x12))));
  assign new_n32_ = x09 & x13 & ((x03 & ~x11) | (~x07 & ~x12));
  assign new_n33_ = x03 & ~x11 & ~x12 & ~x08 & ~x10;
  assign new_n34_ = ~x08 & ~x10 & x02 & x04 & (~x09 | ~x13);
  assign new_n35_ = x12 & x03 & ~x11;
