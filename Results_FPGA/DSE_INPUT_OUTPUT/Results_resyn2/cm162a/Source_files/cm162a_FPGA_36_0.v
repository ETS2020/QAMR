...
module FAU ( 
  ...
  assign z0 = (~new_n22_ & x05) | (x02 & (~x05 | (~x08 & x03 & x04)));
  ...
  assign z2 = (~new_n28_ & x03) | (~x06 & ~x03 & x05) | (x02 & ~x05);
  assign new_n28_ = (~new_n24_ | (~new_n23_ & (x11 | x08 | x10))) & ((new_n24_ & ~x08 & ~x10) | ~x05 | ~x11);
  assign z3 = (~new_n30_ & x03) | (~x07 & ~x03 & x05) | (x02 & ~x05);
  assign new_n30_ = (~new_n24_ | ((~new_n23_ | ~x05) & (~new_n31_ | x12))) & (~x05 | ~x12 | (new_n24_ & new_n31_));
