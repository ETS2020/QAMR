...
module FAU ( 
  ...
  assign z0 = (~x04 | (~new_n22_ & x05)) & ((~new_n23_ & x03) | ~x05 | (~x00 & ~x03));
  assign new_n22_ = (~x09 | ~x13) & x08 & x02 & x03;
  ...
  assign new_n29_ = ~x10 & x02 & x04 & ~x08 & (~x09 | ~x13);
  assign new_n30_ = x05 & (x03 | x06);
  assign z3 = ~new_n34_ | ((x12 | (new_n27_ & (new_n32_ | new_n33_))) & x03 & (new_n33_ | ~new_n32_ | ~new_n27_ | ~x12));
