...
module FAU ( 
  ...
  assign z2 = ~new_n29_ | (x03 & ((new_n27_ & (new_n26_ | (new_n28_ & ~x11))) | (x11 & (new_n26_ | ~new_n27_ | ~new_n28_))));
  assign new_n26_ = x09 & x13;
  assign new_n27_ = x02 & x04;
  assign new_n28_ = ~x08 & ~x10;
  assign new_n29_ = x05 & (x07 | x11) & (x03 | x06);
  assign z3 = ~new_n32_ | (x03 & (((new_n26_ | new_n31_) & new_n27_ & ~x12) | (x12 & (~new_n31_ | new_n26_ | ~new_n27_))));
  assign new_n31_ = ~x11 & ~x08 & ~x10;
  assign new_n32_ = x05 & (x07 | (~x12 & x03 & x11));
  assign z4 = (new_n26_ & x04) | (~x07 & ~x11);
endmodule
