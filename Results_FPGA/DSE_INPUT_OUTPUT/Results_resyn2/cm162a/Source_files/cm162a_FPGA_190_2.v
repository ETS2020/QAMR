...
module FAU ( 
  ...
  assign new_n28_ = (~x11 | (~x10 & new_n22_ & ~new_n23_)) & (x10 | x11 | ~new_n22_ | x08);
  assign new_n29_ = (~new_n23_ | ~new_n22_ | ~x03) & x05 & (x03 | x06);
  assign z3 = (~x07 & (new_n31_ | ~x03)) | ~new_n34_ | (~new_n32_ & x04);
  assign new_n31_ = x12 & (~new_n22_ | x08 | x10 | x11);
  assign new_n32_ = ~new_n33_ & (x10 | x11 | x12 | ~x02 | x08);
  assign new_n33_ = (x02 | (x03 & x12)) & x09 & x13 & (~x07 | (x03 & ~x12));
  assign new_n34_ = x05 & (~x07 | (x08 & (~x03 | ~x12)));
