...
module FAU ( 
  ...
  assign z2 = new_n27_ | (new_n30_ & (new_n28_ | new_n29_ | (new_n22_ & new_n23_)));
  assign new_n27_ = ~x03 & (~x05 | ~x06);
  assign new_n28_ = ~x08 & ~x10 & ~x11 & x02 & x04;
  assign new_n29_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign new_n30_ = x03 & x05;
  assign z3 = (x03 & ((new_n28_ & ~x12) | new_n32_ | (~new_n28_ & x12))) | ~x05 | (~x03 & ~x07);
