...
module FAU ( 
  ...
  assign z0 = (new_n22_ & x08) | (~new_n23_ & (x06 | ~x09));
  assign new_n22_ = x03 & x13 & x06 & x09;
  assign new_n23_ = (~x03 | (x08 ^ (~x02 | ~x04))) & x05 & (x00 | x03);
  assign z1 = (new_n22_ & ~new_n25_) | ((x06 | ~x09) & (new_n26_ | ~new_n27_));
