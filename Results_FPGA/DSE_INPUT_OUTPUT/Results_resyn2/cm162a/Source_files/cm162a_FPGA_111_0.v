...
module FAU ( 
  ...
  assign z1 = (~x05 & x11) | (~new_n26_ & x05 & (~x01 | x03));
  assign new_n26_ = (~x10 | (~x08 & ~new_n23_ & x02 & x04)) & x03 & (~x02 | ~x04 | (~new_n23_ & (x08 | x10)));
  assign z2 = new_n28_ | ~x05 | (~x03 & ~x06);
  assign new_n28_ = (x11 | (new_n24_ & (new_n23_ | (~x08 & ~x10)))) & x03 & (new_n23_ | ~new_n24_ | ~x11 | x08 | x10);
  assign z3 = (x11 | (~new_n30_ & x05)) & ((~new_n31_ & x03) | ~x05 | (~x03 & ~x07));
  assign new_n30_ = ~new_n23_ & x03 & x12 & new_n24_ & ~x08 & ~x10;
  assign new_n31_ = ~x12 & (~new_n32_ | (~new_n23_ & x11));
