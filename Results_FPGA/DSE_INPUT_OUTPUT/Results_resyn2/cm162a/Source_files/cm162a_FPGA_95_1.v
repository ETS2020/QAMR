...
module FAU ( 
  ...
  assign new_n25_ = (~x10 | (new_n23_ & ~x08)) & x03 & (~new_n23_ | (~new_n22_ & (x08 | x10)));
  assign z2 = (~x05 & ~x13) | (~new_n27_ & x05 & (x03 | ~x06));
  assign new_n27_ = (~new_n23_ | (~new_n22_ & (x11 | x08 | x10))) & x03 & (~x11 | (new_n23_ & ~x08 & ~x10));
