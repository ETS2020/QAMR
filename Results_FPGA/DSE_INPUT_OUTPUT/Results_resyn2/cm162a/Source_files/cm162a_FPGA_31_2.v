...
module FAU ( 
  ...
  assign new_n26_ = (x08 | (~x06 & (new_n23_ | ~new_n22_ | ~x10))) & x03 & (x10 | (new_n22_ & (new_n23_ | ~x08)));
  assign z2 = (~x06 | (x08 & (x03 | ~x05))) & (new_n28_ | ~x03 | ~x05);
  assign new_n28_ = (x11 | (new_n22_ & (new_n23_ | new_n29_))) & (~new_n29_ | ~x11 | ~new_n22_ | new_n23_);
  assign new_n29_ = ~x08 & ~x10;
  assign z3 = new_n31_ | (~x03 & ~x07) | ~x05 | (x06 & ~x08);
  assign new_n31_ = (x12 | ((new_n23_ | ~x11) & new_n22_ & (new_n23_ | new_n29_))) & x03 & (new_n23_ | ~new_n29_ | ~new_n22_ | x11 | ~x12);
