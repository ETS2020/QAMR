...
module FAU ( 
  ...
  assign new_n25_ = ((x08 & ~x09) | ~new_n23_ | x10) & (~x10 | (new_n23_ & ~x08 & (~x09 | ~x13)));
  assign z2 = (~new_n27_ & x03) | (~x03 & ~x06) | ~x05 | (~x10 & ~x13);
  assign new_n27_ = (~new_n23_ | ((~x09 | ~x13) & (x11 | x08 | x10))) & (~x11 | (new_n23_ & ~x08 & ~x10 & x13));
  assign z3 = (x13 & (~new_n30_ | (~new_n29_ & x03))) | (x10 & (~new_n30_ | (x03 & x12)));
  assign new_n29_ = (~new_n23_ | (~x09 & (x11 | x12 | x08 | x10))) & (~x12 | (~x11 & new_n23_ & ~x08));
