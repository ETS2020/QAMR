...
module FAU ( 
  ...
  assign z2 = (~new_n28_ & x03) | (~x03 & ~x06) | ~x05 | (~x07 & ~x08);
  assign new_n28_ = (~new_n22_ | (~new_n23_ & x08) | (~new_n23_ & (x10 | x11))) & (~x11 | (new_n22_ & ~new_n23_ & ~x10 & x07 & ~x08));
  assign z3 = (~new_n30_ & x03) | ((x07 | x08) & (~x05 | (~x03 & ~x07)));
  assign new_n30_ = (~x08 | (~x12 & (~new_n22_ | ~new_n23_))) & (~x07 | ((~x12 | (new_n22_ & new_n31_)) & ((~new_n23_ & x12) | (~new_n23_ & ~new_n31_) | ~new_n22_ | (~new_n23_ & x08))));
