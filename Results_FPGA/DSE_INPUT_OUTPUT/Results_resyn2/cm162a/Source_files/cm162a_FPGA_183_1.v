...
module FAU ( 
  ...
  assign new_n28_ = x03 & x07 & x09 & x13;
  ...
  assign z3 = ~new_n35_ | (x03 & (new_n34_ | (new_n22_ & ~new_n33_)));
  assign new_n33_ = (~x09 | ~x13) & (x11 | x12 | x08 | x10);
  assign new_n34_ = x12 & (x11 | x08 | x10 | ~x02 | ~x04);
  assign new_n35_ = x05 & (x07 | (x03 & ~x13));
