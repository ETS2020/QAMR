...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_, new_n33_;
  assign z0 = (x00 & ~x05) | ((~new_n23_ | (~new_n22_ & x08) | (new_n22_ & ~x08)) & x05 & (~x00 | x03));
  ...
  assign z2 = (x00 & ~x05) | (((new_n27_ & ~x11) | ~new_n23_ | (~new_n27_ & x11)) & ~new_n28_ & x05);
  assign new_n27_ = x02 & x04 & ~x08 & ~x10;
  assign new_n28_ = ~x03 & x06;
  assign z3 = ~new_n33_ | (x03 & (new_n30_ | (new_n22_ & (new_n31_ | new_n32_))));
