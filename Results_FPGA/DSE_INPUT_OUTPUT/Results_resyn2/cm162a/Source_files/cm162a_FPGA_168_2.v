...
module FAU ( 
  ...
  assign new_n26_ = (~x02 | ~x04 | x11 | x08 | x10) & (~x02 | ~x04 | ~x13) & (~x11 | (x02 & x04 & ~x08 & ~x10));
  assign z3 = ~new_n31_ | ((x12 | (new_n28_ & (new_n29_ | new_n30_))) & x03 & (~new_n28_ | ~new_n29_ | new_n30_ | ~x12));
  assign new_n28_ = x02 & x04;
  assign new_n29_ = ~x11 & ~x08 & ~x10;
  assign new_n30_ = x09 & x13;
  assign new_n31_ = x05 & x09 & (x03 | x07);
  assign z4 = new_n30_ & x04;
endmodule
