...
module FAU ( 
  ...
  assign z1 = (~x05 & ~x07) | ((new_n24_ | ~new_n25_ | new_n26_) & ~new_n27_ & x05);
  assign new_n24_ = x10 & (x08 | ~x02 | ~x04);
  assign new_n25_ = x03 & (~x09 | ~x13 | ~x02 | ~x04);
  assign new_n26_ = x02 & x04 & ~x08 & ~x10;
  assign new_n27_ = x01 & ~x03;
  assign z2 = (~x05 & ~x07) | (((~new_n26_ & x11) | ~new_n25_ | (new_n26_ & ~x11)) & ~new_n29_ & x05);
  assign new_n29_ = ~x03 & x06;
  assign z3 = ~new_n35_ | (x03 & (new_n32_ | (new_n31_ & (new_n33_ | new_n34_))));
