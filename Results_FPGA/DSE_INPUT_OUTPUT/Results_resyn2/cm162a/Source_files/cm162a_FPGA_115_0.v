...
module FAU ( 
  ...
  assign z0 = x05 ? (~new_n22_ & (~x00 | x03)) : x10;
  assign new_n22_ = (new_n23_ | ~x08) & x03 & (x08 | ~x02 | ~x04);
  ...
  assign z2 = ~new_n27_ & ((x03 & (new_n28_ | x11)) | ~x05 | (~x03 & ~x06));
  assign new_n27_ = ~x10 & (~x05 | (new_n23_ & x11 & x03 & ~x08));
  assign new_n28_ = x02 & x04 & ((x09 & x13) | (~x08 & ~x10));
  assign z3 = ~x05 | (~x03 & ~x07) | (x03 & ((~new_n30_ & x12) | new_n31_ | (new_n30_ & ~x12)));
