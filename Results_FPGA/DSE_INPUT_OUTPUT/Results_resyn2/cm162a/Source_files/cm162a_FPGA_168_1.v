...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n32_;
  assign z0 = (x03 & ((~new_n22_ & x08) | new_n23_ | (new_n22_ & ~x08))) | ~x05 | (~x00 & ~x03);
  ...
  assign z2 = ~new_n29_ | (x03 & ((new_n22_ & new_n27_) | new_n23_ | new_n28_));
  assign new_n27_ = ~x11 & ~x08 & ~x10;
  assign new_n28_ = x11 & (x08 | x10 | ~x02 | ~x04);
  assign new_n29_ = x05 & (x03 | x06);
  assign z3 = ~new_n32_ | ((x12 | (new_n22_ & (new_n27_ | new_n31_))) & x03 & (~new_n22_ | ~new_n27_ | new_n31_ | ~x12));
  assign new_n31_ = x05 & x09 & x13;
  assign new_n32_ = x05 & (x03 | x07);
  assign z4 = new_n31_ & x04;
endmodule
