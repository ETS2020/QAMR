...
module FAU ( 
  ...
  assign z1 = (x10 & (new_n22_ | ~new_n23_ | x08)) | ~new_n25_ | (new_n23_ & (new_n22_ | (~x08 & ~x10)));
  assign new_n25_ = x03 & x05;
  assign z2 = ~x05 | ((x11 | (new_n23_ & (new_n22_ | new_n27_))) & x03 & (new_n22_ | ~new_n23_ | ~new_n27_ | ~x11));
  assign new_n27_ = ~x08 & ~x10;
  assign z3 = (x04 & ((new_n22_ & (x02 | x12)) | (new_n29_ & x02 & ~x12))) | ~new_n25_ | (x12 & (~new_n29_ | ~x02 | ~x04));
