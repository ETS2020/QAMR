...
module FAU ( 
  ...
  assign z0 = x05 ? (~new_n22_ & (~x00 | x03)) : x01;
  assign new_n22_ = (~x08 | ((~x09 | ~x13) & x02 & x04)) & x03 & (x08 | ~x02 | ~x04);
  assign z1 = (~new_n24_ & x03) | ~x05 | (~x01 & ~x03);
  assign new_n24_ = (~x10 | (~x08 & x02 & x04)) & (~x02 | ~x04 | ~x09 | ~x13) & (x08 | x10 | ~x02 | ~x04);
  assign z2 = (x03 & (new_n27_ | new_n26_ | new_n28_)) | ~x05 | (~x03 & ~x06);
  ...
  assign new_n30_ = x02 & x04 & x05 & x09 & x13;
  assign z4 = x09 & x13 & x04 & (x01 | x05);
endmodule
