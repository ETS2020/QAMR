...
module FAU ( 
  ...
  assign new_n25_ = (~x02 | ~x04 | (~new_n22_ & (x08 | x10))) & (~x10 | (~x08 & ~new_n22_ & x02 & x04));
  assign z2 = (~new_n27_ & x03) | ~x05 | (x07 & ~x12) | (~x03 & ~x06);
  assign new_n27_ = (~x02 | ~x04 | (~new_n22_ & (x11 | x08 | x10))) & (~x11 | (~x08 & ~x10 & ~new_n22_ & x02 & x04));
  assign z3 = (~x12 & (new_n29_ | ~x03 | x07)) | (~new_n30_ & x03 & x12) | ~x05 | (~x03 & ~x07);
  assign new_n29_ = x02 & x04 & (new_n22_ | (~x11 & ~x08 & ~x10));
  assign new_n30_ = ~new_n22_ & x02 & x04 & ~x11 & ~x08 & ~x10;
