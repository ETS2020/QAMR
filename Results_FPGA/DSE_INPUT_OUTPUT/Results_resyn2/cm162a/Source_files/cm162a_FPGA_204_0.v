...
module FAU ( 
  ...
  assign new_n28_ = (~new_n24_ | (~new_n23_ & (x08 | x10 | x11))) & x03 & (~x11 | (~new_n23_ & new_n24_ & ~x08 & ~x10));
  assign z3 = ((x12 | (new_n30_ & x05)) & ~new_n31_ & x03) | (~x05 & x12) | (~x07 & ~x03 & x05);
  assign new_n30_ = new_n24_ & (new_n23_ | (~x11 & ~x08 & ~x10));
  assign new_n31_ = ~x11 & ~x08 & ~x10 & ~new_n23_ & new_n24_ & x12;
