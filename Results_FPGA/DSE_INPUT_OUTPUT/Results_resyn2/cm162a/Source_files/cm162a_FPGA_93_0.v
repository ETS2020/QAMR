...
module FAU ( 
  ...
  assign z2 = (x01 & ~x05) | (~new_n27_ & x05 & (x03 | ~x06));
  assign new_n27_ = (~x11 | (new_n28_ & new_n23_ & (~x09 | ~x13))) & x03 & (~new_n23_ | ((~x09 | ~x13) & (~new_n28_ | x11)));
  assign new_n28_ = ~x08 & ~x10;
  assign z3 = x05 ? (new_n30_ | (~x03 & ~x07)) : x01;
  assign new_n30_ = (x12 | (new_n23_ & (new_n31_ | (x09 & x13)))) & x03 & (~new_n31_ | ~x12 | ~new_n23_ | (x09 & x13));
