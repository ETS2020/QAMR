...
module FAU ( 
  ...
  assign z2 = x05 ? (~new_n26_ & (new_n27_ | new_n28_ | ~new_n29_)) : ~x13;
  assign new_n26_ = ~x03 & x06;
  assign new_n27_ = x02 & x04 & ~x11 & ~x08 & ~x10;
  assign new_n28_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign new_n29_ = x03 & (~x09 | ~x13 | ~x02 | ~x04);
  assign z3 = ~new_n34_ | ((x12 | (new_n31_ & (new_n32_ | new_n33_))) & x03 & (~new_n31_ | ~new_n32_ | new_n33_ | ~x12));
