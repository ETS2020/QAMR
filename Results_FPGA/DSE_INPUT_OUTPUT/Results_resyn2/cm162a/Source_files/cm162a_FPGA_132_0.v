...
module FAU ( 
  ...
  assign new_n27_ = (x11 | ~new_n23_ | x08 | x10) & (~new_n22_ | ~new_n23_) & (~x11 | (new_n23_ & ~x08 & ~x10));
  assign z3 = new_n29_ | ~x05 | (~x03 & ~x07);
  assign new_n29_ = (x12 | (new_n23_ & (new_n30_ | (new_n22_ & x05)))) & x03 & (~new_n30_ | ~x12 | new_n22_ | ~new_n23_);
  assign new_n30_ = ~x11 & ~x08 & ~x10;
  assign z4 = (x05 | x12) & new_n22_ & x04;
endmodule
