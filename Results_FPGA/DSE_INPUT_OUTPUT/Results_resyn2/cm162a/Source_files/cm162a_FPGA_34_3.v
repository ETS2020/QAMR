...
module FAU ( 
  ...
  assign z1 = (~new_n24_ & x03) | (~x01 & ~x03) | ~x05 | x07;
  assign new_n24_ = (~x10 | (~x08 & x02 & x04)) & (~x02 | ~x04 | ~x09 | ~x13) & (~x02 | ~x04 | x08 | x10);
  assign z2 = ~x05 | (new_n28_ & ((new_n26_ & ~x11) | ~new_n27_ | (~new_n26_ & x11)));
  assign new_n26_ = x02 & x04 & ~x08 & ~x10;
  assign new_n27_ = x03 & (~x09 | ~x13 | ~x02 | ~x04);
  assign new_n28_ = ~x07 & (x03 | ~x06);
  assign z3 = new_n31_ | ~new_n34_ | (new_n33_ & (new_n32_ | (new_n30_ & ~x07)));
  assign new_n30_ = x09 & x13;
  assign new_n31_ = x12 & (x11 | ~x02 | ~x04 | x08 | x10);
  assign new_n32_ = ~x11 & ~x12 & ~x08 & ~x10;
  assign new_n33_ = x04 & (x02 | x12);
  assign new_n34_ = x03 & x05 & ~x07;
  assign z4 = new_n30_ & x04 & (~x05 | ~x07);
endmodule
