...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n33_;
  assign z0 = (~new_n22_ & (~x06 | x08)) | (x03 & ((x08 & (new_n23_ | ~new_n24_)) | (new_n24_ & ~x06 & ~x08)));
  assign new_n22_ = x05 & (x00 | x03);
  assign new_n23_ = x09 & x13;
  assign new_n24_ = x02 & x04;
  assign z1 = (~new_n26_ & x03) | (~x01 & ~x03) | ~x05 | (x06 & ~x08);
  assign new_n26_ = (~new_n24_ | (~new_n23_ & (x08 | x10))) & (~x10 | (~new_n23_ & new_n24_ & ~x06 & ~x08));
  assign z2 = ~new_n29_ | (~new_n28_ & new_n24_);
  ...
  assign new_n32_ = (~x12 | (~x10 & ~x11 & ~new_n23_ & new_n24_)) & (x11 | x08 | x10 | ~new_n24_ | x12);
  assign new_n33_ = (~new_n24_ | ~new_n23_ | ~x03) & x05 & (x03 | x07);
