...
module FAU ( 
  ...
  assign z2 = (x03 & ((~new_n28_ & x11) | (new_n26_ & x05))) | (x05 ? (~x03 & ~x06) : x11);
  assign new_n26_ = ~new_n27_ & x02 & x04;
  assign new_n27_ = (~x09 | ~x13) & (x11 | x08 | x10);
  assign new_n28_ = (~x09 | ~x13) & x02 & x04 & ~x08 & ~x10;
  assign z3 = ~new_n30_ & (~x05 | (~x03 & ~x07) | (x03 & (new_n26_ | x12)));
  assign new_n30_ = ~x11 & (~x05 | (new_n28_ & x03 & x12));
