...
module FAU ( 
  ...
  assign new_n27_ = x00 & (~x01 | x03);
  assign z2 = ~new_n30_ | (x03 & (new_n29_ | new_n24_ | (~new_n26_ & x11)));
  assign new_n29_ = ~x08 & ~x10 & ~x11 & x02 & x04;
  assign new_n30_ = (x03 | x06) & x00 & x05;
  assign z3 = (x03 & ((new_n29_ & ~x12) | new_n33_ | (~new_n29_ & x12))) | ~new_n32_ | (~x03 & ~x07);
  assign new_n32_ = x00 & x05;
  assign new_n33_ = x09 & x13 & x00 & x02 & x04;
