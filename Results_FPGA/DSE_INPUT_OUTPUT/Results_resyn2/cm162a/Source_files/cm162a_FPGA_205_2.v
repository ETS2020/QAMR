...
module FAU ( 
  ...
  assign z2 = new_n28_ | (new_n27_ & (new_n29_ | new_n30_ | (new_n22_ & new_n23_)));
  assign new_n27_ = x03 & x05;
  assign new_n28_ = ~x03 & (~x05 | ~x06);
  assign new_n29_ = ~x08 & ~x10 & ~x11 & x02 & x04;
  assign new_n30_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign z3 = (x03 & ((new_n29_ & ~x12) | new_n32_ | (~new_n29_ & x12))) | ~x05 | (~x03 & ~x07);
  assign new_n32_ = x09 & x13 & x05 & x02 & x04;
