...
module FAU ( 
  ...
  assign z2 = (~new_n28_ & x03) | ~x05 | (~x06 & (x11 | ~x03 | ~x08));
  assign new_n28_ = (~new_n22_ | (~new_n23_ & (x11 | x08 | x10))) & (~x11 | (new_n22_ & ~new_n23_ & ~x08 & ~x10));
  assign z3 = (x03 & ((~new_n30_ & x06) | (x08 & x12))) | (~new_n31_ & (x06 | x08));
  assign new_n30_ = (~x12 | (new_n22_ & ~new_n23_ & ~x10 & ~x11)) & (x11 | x08 | x10 | ~new_n22_ | x12);
  assign new_n31_ = (~new_n23_ | ~new_n22_ | ~x03) & x05 & (x03 | x07);
