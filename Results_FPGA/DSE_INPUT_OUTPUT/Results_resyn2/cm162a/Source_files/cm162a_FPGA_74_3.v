...
module FAU ( 
  ...
  assign new_n22_ = ((~x08 & x02 & x04) | ~x03 | (x08 & (~x02 | ~x04))) & ~x13 & (~x00 | x03);
  assign z1 = ~x05 | (~new_n24_ & ~x13 & (~x01 | x03));
