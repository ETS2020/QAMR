...
module FAU ( 
  ...
  assign new_n23_ = x08 ? (x02 & x04 & (~x09 | ~x13)) : (~x02 | ~x04);
  assign z1 = new_n26_ | (~new_n22_ & ((~new_n25_ & x03) | ~x05 | (~x01 & ~x03)));
  assign new_n25_ = x10 ^ (x08 | ~x02 | ~x04);
  assign new_n26_ = (x10 | (x02 & x04)) & x13 & x03 & x09;
  assign z2 = (~new_n28_ & (~x06 | (x03 & x09))) | new_n29_ | (~x03 & ~x06) | (~x05 & (~x06 | x09));
  assign new_n28_ = (~x11 | (~x10 & ~x08 & x02 & x04)) & (x08 | ~x02 | ~x04 | x10 | x11);
  assign new_n29_ = (x11 | (x02 & x04)) & x03 & x09 & x13;
  assign z3 = ~new_n34_ | (x03 & (new_n31_ | (x04 & (new_n32_ | new_n33_))));
  assign new_n31_ = x12 & (x08 | ~x02 | ~x04 | x10 | x11);
  assign new_n32_ = x09 & x13 & (x02 | x12);
