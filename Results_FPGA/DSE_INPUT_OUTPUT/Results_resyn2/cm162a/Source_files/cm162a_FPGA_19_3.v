...
module FAU ( 
  ...
  assign z0 = ~new_n22_ | (x13 & (x12 | (x09 & x03 & x08)));
  assign new_n22_ = (~x03 | (x08 ^ (~x02 | ~x04))) & x05 & (x00 | x03);
  assign z1 = (~new_n25_ & (new_n26_ | ~new_n27_)) | (new_n28_ & (new_n24_ | x10));
  ...
  assign new_n28_ = x09 & x13 & x03 & ~x12;
  assign z2 = (~new_n25_ & (new_n30_ | ~new_n31_)) | (new_n28_ & (new_n24_ | x11));
  assign new_n30_ = x03 & ((x11 & (~x02 | ~x04 | x08 | x10)) | (x02 & x04 & ~x11 & ~x08 & ~x10));
  assign new_n31_ = x05 & (x03 | x06);
  assign z3 = ~new_n35_ | (x03 & ((x12 & (~new_n24_ | ~new_n34_)) | ((new_n33_ | new_n34_) & new_n24_ & ~x12)));
  assign new_n33_ = x09 & x13;
  assign new_n34_ = ~x11 & ~x08 & ~x10;
  assign new_n35_ = (x03 | x07) & x05 & (~x12 | ~x13);
