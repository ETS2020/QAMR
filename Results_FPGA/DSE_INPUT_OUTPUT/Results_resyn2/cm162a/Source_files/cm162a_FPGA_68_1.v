...
module FAU ( 
  ...
  assign z2 = (~x11 | (~new_n28_ & x05)) & (~x05 | ((new_n27_ | ~x03 | x11) & (x03 | ~x06)));
  assign new_n27_ = x02 & x04 & (new_n23_ | (~x08 & ~x10));
  assign new_n28_ = ~new_n23_ & x02 & x04 & x03 & ~x08 & ~x10;
  assign z3 = new_n30_ | ~x05 | (~x03 & ~x07);
  assign new_n30_ = (x12 | ((new_n23_ | new_n31_) & x02 & x04)) & x03 & (~new_n31_ | ~x12 | new_n23_ | ~x02 | ~x04);
