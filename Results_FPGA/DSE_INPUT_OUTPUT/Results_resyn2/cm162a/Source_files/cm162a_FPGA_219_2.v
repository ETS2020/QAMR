...
module FAU ( 
  ...
  assign z1 = (~new_n24_ & x03) | (~x01 & ~x03) | ~x05 | (x06 & ~x09);
  assign new_n24_ = (x10 | x08 | ~x02 | ~x04) & (~x02 | ~x04 | ~x09 | ~x13) & (~x10 | (~x08 & x02 & x04));
  assign z2 = (~new_n26_ & (~x06 | (x03 & x09))) | new_n27_ | (~x03 & ~x06) | (~x05 & (~x06 | x09));
  assign new_n26_ = (~x11 | (~x10 & ~x08 & x02 & x04)) & (x08 | ~x02 | ~x04 | x10 | x11);
  assign new_n27_ = (x11 | (x02 & x04)) & x03 & x09 & x13;
  assign z3 = ~new_n32_ | (x03 & (new_n29_ | (x04 & (new_n30_ | new_n31_))));
  assign new_n29_ = x12 & (x08 | ~x02 | ~x04 | x10 | x11);
  assign new_n30_ = x09 & x13 & (x02 | x12);
  assign new_n31_ = ~x10 & ~x11 & ~x12 & x02 & ~x08;
  assign new_n32_ = x05 & (~x06 | x09) & (x03 | x07);
