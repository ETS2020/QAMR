...
module FAU ( 
  ...
  assign z0 = (~new_n22_ & x03) | new_n23_ | ~x05 | (~x00 & ~x03);
  assign new_n22_ = x08 ^ (~x02 | ~x04);
  assign new_n23_ = x09 & (~x06 | (x13 & x03 & x08));
  assign z1 = ((x06 | ~x09) & (new_n25_ | ~new_n26_)) | (new_n27_ & x13 & x06 & x09);
  assign new_n25_ = x03 & (~x10 ^ (x08 | ~x02 | ~x04));
  assign new_n26_ = x05 & (x01 | x03);
  assign new_n27_ = x03 & (x10 | (x02 & x04));
  ...
  assign z3 = ~new_n35_ | (x03 & (new_n32_ | (x04 & (new_n33_ | new_n34_))));
  assign new_n32_ = x12 & (x08 | ~x02 | ~x04 | x10 | x11);
  assign new_n33_ = (x02 | x12) & x09 & x13;
  assign new_n34_ = ~x10 & ~x11 & ~x12 & x02 & ~x08;
