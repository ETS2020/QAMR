...
module FAU ( 
  ...
  assign z1 = ~new_n23_ & (~x05 | ((~x01 | x03) & (new_n25_ | new_n26_ | ~x03)));
  assign new_n25_ = x10 & (x08 | ~x02 | ~x04);
  assign new_n26_ = (~x08 | (x09 & x13)) & ~x10 & x02 & x04;
  ...
  assign new_n31_ = x11 & (x08 | x10 | ~x02 | ~x04 | x13);
  assign new_n32_ = x05 & (x08 | ~x13) & (x03 | x06);
  assign z3 = ~new_n34_ | ((x12 | (new_n28_ & (new_n29_ | new_n30_))) & x03 & (~new_n30_ | new_n29_ | ~new_n28_ | ~x12));
