...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n28_, new_n29_;
  ...
  assign z3 = (x04 & ((new_n28_ & x02 & ~x12) | (new_n29_ & (x02 | x12)))) | ~new_n25_ | (x12 & (~new_n28_ | ~x02 | ~x04));
  assign new_n28_ = ~x11 & ~x08 & ~x10;
  assign new_n29_ = x03 & x09 & x13;
