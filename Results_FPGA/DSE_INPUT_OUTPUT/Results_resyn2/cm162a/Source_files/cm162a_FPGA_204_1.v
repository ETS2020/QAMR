...
module FAU ( 
  ...
  assign new_n28_ = (~new_n24_ | (~new_n23_ & (x08 | x10 | x11))) & x03 & (~x11 | (~x08 & ~x10 & ~new_n23_ & new_n24_));
  assign z3 = ((~new_n31_ & x05) | ~x12) & ((x03 & (new_n30_ | x12)) | ~x05 | (~x03 & ~x07));
  assign new_n30_ = new_n24_ & (new_n23_ | (~x11 & ~x08 & ~x10));
  assign new_n31_ = ~x08 & ~x10 & ~x11 & x03 & ~new_n23_ & new_n24_;
