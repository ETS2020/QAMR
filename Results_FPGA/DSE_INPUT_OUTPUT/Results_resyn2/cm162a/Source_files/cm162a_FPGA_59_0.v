...
module FAU ( 
  ...
  assign z1 = new_n27_ | (x03 & (new_n25_ | (~new_n26_ & new_n24_ & x05)));
  ...
  assign z2 = ~new_n31_ | (x03 & ((new_n24_ & ~new_n29_) | (~new_n30_ & x11)));
  assign new_n29_ = (~x09 | ~x13) & (x11 | x08 | x10);
  assign new_n30_ = ~x10 & ~x08 & x02 & x04 & (~x09 | ~x13);
  assign new_n31_ = x05 & (x03 | x06);
  assign z3 = (x03 & ((~new_n33_ & x12) | new_n34_ | (new_n33_ & ~x12))) | ~x05 | (~x03 & ~x07);
  assign new_n33_ = x02 & x04 & ~x11 & ~x08 & ~x10;
