...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n26_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_;
  assign z0 = (~new_n22_ & x03) | (~x00 & ~x03) | ~x05 | (x07 & x12);
  assign new_n22_ = (~x02 | ~x04 | ~x09 | ~x13) & (x08 | ~x02 | ~x04) & (~x08 | (x02 & x04));
  assign z1 = (~x07 | ~x12) & ((~new_n24_ & x03) | ~x05 | (~x01 & ~x03));
  ...
  assign new_n29_ = (x03 | x06) & x05 & (~x07 | ~x12);
  assign z3 = (~new_n31_ & ~new_n27_ & x04) | ~new_n33_ | (~new_n32_ & x12);
  assign new_n31_ = x12 ? (~x09 | ~x13) : (~x02 | ~x03);
  assign new_n32_ = ~x07 & x02 & x04 & ~x11 & ~x08 & ~x10;
  assign new_n33_ = x05 & (x03 | x07);
  assign z4 = (x07 & x12) | (x04 & x09 & x13);
endmodule
