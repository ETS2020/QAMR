...
module FAU ( 
  ...
  assign new_n27_ = (~x11 | (~new_n23_ & x02 & x04 & ~x08 & ~x10)) & (~x02 | ~x04 | (~new_n23_ & (x08 | x10)) | (~new_n23_ & x11));
  assign z3 = new_n32_ | ((new_n29_ | x12) & ~new_n30_ & x03);
  assign new_n29_ = x02 & x04 & (new_n23_ | (~x08 & ~x10)) & (new_n23_ | ~x11);
  assign new_n30_ = ~x11 & (~x07 | (new_n31_ & x12 & ~x08 & ~x10));
  assign new_n31_ = x02 & x04 & (~x09 | ~x13);
  assign new_n32_ = (x07 | x11) & (~x05 | (~x03 & ~x07));
