...
module FAU ( 
  ...
  assign new_n25_ = ((~x08 & x02 & x04) | ~x10) & (~new_n23_ | ~x02 | ~x04) & (~x02 | ~x04 | x08 | x10);
  assign z2 = (~new_n27_ & x03) | ~x05 | (~x03 & ~x06);
  assign new_n27_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10 | x11))) & (~x11 | (~new_n23_ & x02 & x04 & ~x08 & ~x10));
  assign z3 = x05 ? (new_n29_ | (~x03 & ~x07)) : ~x09;
