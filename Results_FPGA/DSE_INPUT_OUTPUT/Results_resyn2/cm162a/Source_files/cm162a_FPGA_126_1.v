...
module FAU ( 
  ...
  assign z2 = ~x05 | (x03 & ((new_n22_ & (new_n23_ | (new_n27_ & ~x11))) | (x11 & (~new_n27_ | ~new_n22_ | new_n23_))));
  assign new_n27_ = ~x08 & ~x10;
  assign z3 = ~x05 | ((x12 | (new_n22_ & (new_n23_ | new_n29_))) & x03 & (~new_n29_ | ~new_n22_ | new_n23_ | ~x12));
