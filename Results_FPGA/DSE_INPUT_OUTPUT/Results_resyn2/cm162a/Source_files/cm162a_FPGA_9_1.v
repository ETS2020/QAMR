...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_;
  assign z0 = (x11 | ~x13) & ((~new_n22_ & x03) | ~x05 | (~x00 & ~x03));
  ...
  assign z2 = ~new_n28_ | (x03 & (new_n26_ | (~new_n27_ & x11)));
  assign new_n26_ = ~x11 & (x13 | (x02 & x04 & ~x08 & ~x10));
  assign new_n27_ = ~x08 & ~x10 & x02 & x04 & (~x09 | ~x13);
  assign new_n28_ = x05 & (x03 | (x06 & (x11 | ~x13)));
  assign z3 = new_n32_ | (x03 & ((~new_n26_ & x12) | (new_n30_ & ~new_n31_)));
  assign new_n30_ = x02 & x04;
  assign new_n31_ = (~x11 | ~x09 | ~x13) & (x08 | x10 | x13 | x11 | x12);
  assign new_n32_ = (x11 | ~x13) & (~x05 | (~x03 & ~x07));
