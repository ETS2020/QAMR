...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n26_, new_n29_;
  ...
  assign z1 = ~x05 | (~new_n26_ & x03);
  assign new_n26_ = (~x02 | ~x04 | ~x09 | ~x13) & (~x02 | ~x04 | x08 | x10) & (~x10 | (~x08 & x02 & x04));
  assign z2 = (x11 & (new_n23_ | ~new_n22_ | x08 | x10)) | ~new_n24_ | (new_n22_ & (new_n23_ | (~x11 & ~x08 & ~x10)));
  assign z3 = ~new_n24_ | ((x12 | (new_n22_ & (new_n23_ | new_n29_))) & (~new_n29_ | ~new_n22_ | new_n23_ | ~x12));
