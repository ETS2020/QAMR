...
module FAU ( 
  ...
  assign z2 = ((x08 | (~new_n28_ & x06)) & ~new_n29_ & x03) | ((x06 | x08) & (~x05 | (~x03 & ~x06)));
  assign new_n28_ = new_n22_ & ~new_n23_ & ~x10 & x11;
  assign new_n29_ = ~x11 & (~new_n22_ | (~new_n23_ & (x08 | x10)));
  assign z3 = ~new_n32_ | ((x12 | (new_n22_ & (new_n23_ | new_n31_))) & x03 & (~new_n31_ | ~x12 | ~new_n22_ | new_n23_));
  assign new_n31_ = ~x11 & ~x08 & ~x10;
  assign new_n32_ = (x03 | x07) & x05 & (x06 | x08);
