...
module FAU ( 
  ...
  assign z2 = (~new_n28_ & x03) | (~x05 & ~x11) | (~x06 & ~x03 & x05);
  assign new_n28_ = (~new_n24_ | ((~new_n29_ | x11) & (~new_n23_ | ~x05))) & ((new_n24_ & new_n29_) | ~x05 | ~x11);
  assign new_n29_ = ~x08 & ~x10;
  assign z3 = (~new_n31_ & x03) | (~x05 & ~x11) | (~x07 & ~x03 & x05);
  assign new_n31_ = (~new_n24_ | ((~new_n29_ | x11) & (~new_n23_ | ~x05)) | ((~new_n23_ | ~x05) & x12)) & ((~x11 & new_n24_ & new_n29_) | ~x05 | ~x12);
