...
module FAU ( 
  ...
  assign z0 = (x00 | ~x03) & ((~new_n22_ & x03) | ~x00 | ~x05);
  assign new_n22_ = x08 ? (~new_n23_ & x02 & x04) : (~x02 | ~x04);
  assign new_n23_ = x09 & x13;
  assign z1 = (~new_n25_ & x03) | ~x05 | (~x01 & ~x03);
  assign new_n25_ = (~x10 | (~new_n23_ & ~x08 & x02 & x04)) & x00 & (~x02 | ~x04 | (~new_n23_ & (x08 | x10)));
  assign z2 = (x00 | ~x03) & (new_n27_ | ~x05 | (~x03 & ~x06));
  ...
  assign new_n30_ = (~x02 | ~x04 | (~new_n23_ & (~new_n28_ | x11 | x12))) & (~x12 | (~new_n23_ & x02 & x04 & new_n28_ & ~x11));
  assign z4 = (~x00 & x03) | (new_n23_ & x04);
endmodule
