...
module FAU ( 
  ...
  assign z0 = x05 ? (~new_n22_ & (~x00 | x03)) : x12;
  ...
  assign new_n27_ = (~x02 | ~x04 | (~new_n23_ & (x08 | x10 | x11))) & (~x11 | (~x08 & ~x10 & ~new_n23_ & x02 & x04));
  assign z3 = ((new_n29_ | x12) & ~new_n30_ & x03) | ~x05 | (~x03 & ~x07);
  assign new_n29_ = x02 & x04 & (new_n23_ | (~x08 & ~x10 & ~x11));
