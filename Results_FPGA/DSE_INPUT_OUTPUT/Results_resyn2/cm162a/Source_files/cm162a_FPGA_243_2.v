...
module FAU ( 
  ...
  assign z1 = (~new_n25_ & x03 & x05) | (~x03 & (~x01 | ~x05));
  assign new_n25_ = (~x10 | (~x08 & x02 & x04)) & (~x02 | ~x04 | ~x09 | ~x13) & (~x02 | ~x04 | x08 | x10);
  assign z2 = new_n29_ | (new_n27_ & ((new_n23_ & (new_n22_ | (new_n28_ & ~x11))) | (x11 & (~new_n28_ | new_n22_ | ~new_n23_))));
  assign new_n27_ = x03 & x05;
  assign new_n28_ = ~x08 & ~x10;
  assign new_n29_ = ~x03 & (~x05 | ~x06);
