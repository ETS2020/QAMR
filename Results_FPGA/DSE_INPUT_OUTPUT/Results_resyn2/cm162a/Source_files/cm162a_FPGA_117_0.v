...
module FAU ( 
  ...
  assign new_n27_ = (~x11 | (~x10 & ~x08 & x02 & x04)) & (x08 | ~x02 | ~x04 | x10 | x11);
  assign new_n28_ = x03 & x09 & x13 & (x11 | (x02 & x04));
  assign z3 = ~new_n23_ & (~x05 | (~new_n32_ & ((new_n30_ & ~x12) | new_n31_ | (~new_n30_ & x12))));
  assign new_n30_ = ~x08 & x02 & x04 & ~x10 & ~x11;
  assign new_n31_ = x09 & (~x03 | x13);
  assign new_n32_ = x03 ? (~x12 & (~x02 | ~x04)) : x07;
