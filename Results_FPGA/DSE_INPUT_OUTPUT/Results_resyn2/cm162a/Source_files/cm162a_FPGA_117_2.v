...
module FAU ( 
  ...
  assign z2 = new_n28_ | (~new_n23_ & ((~new_n27_ & x03) | ~x05 | (~x03 & ~x06)));
  assign new_n27_ = x11 ^ (x08 | x10 | ~x02 | ~x04);
  assign new_n28_ = x03 & x09 & x13 & (x11 | (x02 & x04));
  assign z3 = (~new_n30_ & (~x07 | (x03 & x09))) | new_n31_ | (~x03 & ~x07) | (~x05 & (~x07 | x09));
  assign new_n30_ = ~x12 ^ (~x11 & ~x08 & ~x10 & x02 & x04);
  assign new_n31_ = x03 & x09 & x13 & (x12 | (x02 & x04));
