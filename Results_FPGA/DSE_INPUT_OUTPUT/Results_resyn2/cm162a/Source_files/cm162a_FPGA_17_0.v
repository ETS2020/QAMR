...
module FAU ( 
  ...
  assign z1 = (~new_n26_ & x03) | (~x01 & ~x03) | ~x05 | (~x07 & ~x12);
  assign new_n26_ = (~new_n24_ | (~new_n23_ & (x08 | x10))) & (~x10 | (~new_n23_ & new_n24_ & ~x08));
  assign z2 = new_n28_ | ~x05 | (~x07 & ~x12) | (~x03 & ~x06);
  assign new_n28_ = (x11 | (new_n24_ & (new_n23_ | (~x08 & ~x10)))) & x03 & (new_n23_ | ~new_n24_ | ~x11 | x08 | x10);
  assign z3 = new_n30_ | ((x07 | x12) & (~x05 | (~x03 & ~x07)));
  assign new_n30_ = (x12 | ((new_n23_ | new_n31_) & new_n24_ & x07)) & x03 & (~new_n31_ | ~x12 | new_n23_ | ~new_n24_);
