...
module FAU ( 
  ...
  assign z2 = ~new_n29_ | (x03 & (new_n30_ | new_n24_ | (~new_n26_ & x11)));
  assign new_n29_ = x05 & x06;
  assign new_n30_ = ~x08 & ~x10 & ~x11 & x02 & x04;
  assign z3 = (x03 & ((new_n30_ & ~x12) | new_n32_ | (~new_n30_ & x12))) | ~new_n29_ | (~x03 & ~x07);
  assign new_n32_ = x09 & x13 & x06 & x02 & x04;
