...
module FAU ( 
  ...
  assign z2 = (new_n31_ | x02) & ((~x07 & ~x08) | ~x00 | (x07 & x11));
  assign new_n31_ = ((~x01 & (~x03 | ~x07)) | (x07 & x11)) & ((x09 & ~x10) | x07 | (~x03 & x10));
  ...
  assign z7 = (~x07 | ~x11) & ((new_n39_ & x09) | (~new_n39_ & ~x08) | x07 | x10);
  assign new_n39_ = ~x01 & ~x02 & x03;
  assign z8 = x07 ? ~x11 : ((~new_n41_ & x09) | x10 | (~x00 & ~x09));
