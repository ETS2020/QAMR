...
module FAU ( 
  ...
  assign z6 = (x09 | (~x07 & (x03 | x01 | x02))) & (x07 | (new_n36_ & (~x09 | x01 | x02 | ~x03)));
  assign new_n36_ = (x00 | ~x01 | ~x02 | ~x14) & ~x10 & (~x00 | ~x08);
  assign z7 = (~new_n38_ & ~x08) | (new_n38_ & x09) | x07 | x10;
  assign new_n38_ = ~x01 & ~x02 & x03;
  assign z8 = (~x07 | ~x09) & (x10 | ((x12 | ~new_n38_ | ~x09) & (x09 | ~x00 | x07)));
endmodule
