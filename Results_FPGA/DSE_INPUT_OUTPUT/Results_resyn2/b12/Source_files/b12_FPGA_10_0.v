...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n31_, new_n32_, new_n37_, new_n40_;
  ...
  assign new_n37_ = (x01 | x02 | ~x03) & ~x10 & ~x07 & x09;
  assign z7 = ~new_n37_ | ~x08;
  assign z8 = new_n40_ | x07;
  assign new_n40_ = x09 & (x10 | x12 | x01 | x02 | ~x03);
endmodule
