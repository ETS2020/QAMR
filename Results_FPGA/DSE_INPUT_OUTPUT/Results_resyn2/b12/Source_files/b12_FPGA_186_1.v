...
module FAU ( 
  ...
  assign z2 = (~x00 & (x02 | (x07 & ~x01 & ~x03))) | (~new_n31_ & ~x07);
  assign new_n31_ = ((x03 & x10) | x01 | (~x09 & ~x10)) & ~x02 & ~x08;
  assign z3 = (~x07 | ~x11) & ((~x07 & x08) | x00 | ~x12);
  assign z4 = ~x07 | ~x11;
  assign z5 = x10 | x07 | x08 | ~x13 | x00 | x12;
  assign z6 = ~new_n36_ & ~new_n37_ & ~x10 & ~x07 & ~x08;
  assign new_n36_ = (x03 | ~x09) & ~x01 & ~x02 & (~x03 | x09);
  assign new_n37_ = ~x00 & x01 & x02 & x14;
  assign z7 = ~new_n39_ | x10 | x07 | x08;
