...
module FAU ( 
  ...
  assign z2 = ~new_n31_ & (~x00 | (x07 ? ~x03 : ~x08));
  assign new_n31_ = ~x02 & ((~x07 & (x01 | (~x09 & ~x10))) | (x03 & (x07 | x10)));
  assign z3 = (~x07 | (x03 & ~x11)) & (x00 | ~x12);
  assign z4 = (~x07 | (x03 & ~x11)) & (~x00 | ~x08 | x07 | ~x09);
  ...
  assign z7 = (x03 & (x07 | (new_n39_ & x09))) | (~x07 & (x10 | (~x08 & (~new_n39_ | ~x03))));
  assign new_n39_ = ~x01 & ~x02;
  assign z8 = x07 ? x03 : (new_n41_ | x10);
  assign new_n41_ = (~x00 | x09) & (~x09 | x01 | x02 | ~x03 | x12);
endmodule
