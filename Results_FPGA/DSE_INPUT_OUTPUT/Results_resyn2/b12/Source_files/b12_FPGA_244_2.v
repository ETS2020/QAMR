...
module FAU ( 
  ...
  assign z1 = new_n30_ & (~x05 | (x11 & (~x06 | ~x01 | ~x02)));
  ...
  assign z3 = (~x07 | ~x11) & ((x05 & ~x11) | x00 | ~x12);
  ...
  assign z7 = ~new_n28_ & ((new_n41_ & x09) | (~new_n41_ & ~x08) | x07 | x10);
  assign new_n41_ = ~x01 & ~x02 & x03;
  assign z8 = new_n43_ | new_n28_ | x07 | x10;
