...
module FAU ( 
  ...
  assign new_n31_ = ~x02 & (((~x07 | x09) & (x01 | (x03 & x07))) | ((~x09 | x10) & ~x07 & (x03 | ~x10)));
  assign z3 = (x07 & ~x09) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (~x07 | x09) & (~x07 | ~x11);
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = (new_n36_ | x01 | x02) & new_n37_ & (x00 | ~x14 | ~x01 | ~x02);
  assign new_n36_ = x03 ^ x09;
  assign new_n37_ = (~x00 | ~x08) & ~x07 & ~x10;
  assign z7 = (x09 & (new_n39_ | x07)) | (~x07 & (x10 | (~new_n39_ & ~x08)));
  assign new_n39_ = ~x01 & ~x02 & x03;
  assign z8 = (~x07 & (x10 | (~x00 & ~x09))) | (~new_n41_ & x09);
  assign new_n41_ = ~x01 & ~x02 & x03 & ~x07 & ~x12;
endmodule
