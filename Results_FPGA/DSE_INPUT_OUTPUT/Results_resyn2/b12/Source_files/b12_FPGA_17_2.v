...
module FAU ( 
  ...
  assign z3 = (~x07 | ~x11) & ((x10 & ~x11) | x00 | ~x12);
  assign z4 = (~x11 & (x07 | x10)) | (~x07 & (~x09 | ~x00 | ~x08));
  assign z5 = (~x10 | x11) & (x07 | x10 | ~x13 | x00 | x12);
  assign z6 = new_n28_ | (~new_n40_ & ~new_n41_ & new_n42_);
  assign new_n40_ = (x03 | ~x09) & ~x01 & ~x02 & (~x03 | x09);
  assign new_n41_ = x01 & x02 & ~x00 & x14;
  assign new_n42_ = (~x00 | ~x08) & ~x07 & ~x10;
  assign z7 = new_n44_ | x07 | x10;
  assign new_n44_ = (~x08 | (x03 & ~x01 & ~x02)) & (x01 | x02 | ~x03 | x09);
  assign z8 = x10 ? x11 : ((~new_n46_ & x09) | x07 | (~x00 & ~x09));
  assign new_n46_ = ~x12 & x03 & ~x01 & ~x02;
endmodule
