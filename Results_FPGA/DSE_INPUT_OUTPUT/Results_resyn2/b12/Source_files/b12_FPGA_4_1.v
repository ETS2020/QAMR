...
module FAU ( 
  ...
  assign new_n27_ = ((x02 & (x04 | x01 | x09)) | (~x01 & ~x02) | ~x03) & ((x04 & ~x05) | ~x01 | ~x02);
  assign z1 = (~x01 & x09) | (new_n29_ & (~x01 | ~x02 | ~x05 | ~x06));
  assign new_n29_ = (x02 | (x01 & x03)) & ~x00 & (x03 | x04);
  assign z2 = (~new_n32_ & ~x01) | (~new_n31_ & (x02 | (x10 & ~x01 & ~x03)));
  assign new_n31_ = x00 & (x07 | x08);
  assign new_n32_ = ~x09 & (x00 | x03 | ~x07);
  ...
  assign z6 = ~new_n38_ & new_n39_ & (~x00 | ~x08);
  assign new_n38_ = ((~x02 & ~x03) | x01 | x09) & (~x01 | (x14 & ~x00 & x02));
  assign new_n39_ = ~x07 & ~x10;
  assign z7 = (~x08 & (~x03 | x01 | x02)) | ~new_n39_ | (~x01 & x09);
