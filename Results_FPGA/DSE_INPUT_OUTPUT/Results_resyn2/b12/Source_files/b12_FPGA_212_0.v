...
module FAU ( 
  ...
  assign new_n27_ = ((~x01 & ~x02) | ~x03 | (x02 & x04)) & x07 & ((x04 & ~x05) | ~x01 | ~x02);
  assign z1 = (~x01 | ~x02 | ~x05 | ~x06) & new_n29_ & (x02 | (x01 & x03));
  assign new_n29_ = (x03 | x04) & ~x00 & x07;
  ...
  assign z5 = x00 | x07;
  assign z6 = ~x07 & (new_n37_ | ~x00);
  assign new_n37_ = (x01 | x02 | (x03 ^ x09)) & ~x08 & ~x10;
  assign z7 = x07 | (~new_n39_ & x00);
  assign new_n39_ = (x08 | (~x01 & ~x02 & x03)) & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = x07 | (~new_n41_ & x00);
  assign new_n41_ = ~x10 & (~x09 | (~x01 & ~x02 & x03 & ~x12));
endmodule
