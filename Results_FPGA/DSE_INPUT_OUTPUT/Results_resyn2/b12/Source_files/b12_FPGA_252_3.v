...
module FAU ( 
  ...
  assign z1 = new_n29_ & (~x04 | ~x07) & ~x00 & (x01 | x02);
  assign new_n29_ = (~x05 | ~x06 | ~x01 | ~x02) & (x03 | (x02 & x04));
  assign z2 = ~new_n31_ & (~x04 | ~x07) & (~x00 | (~x07 & ~x08));
  assign new_n31_ = ~x02 & ((~x09 & ~x07 & ~x10) | x01 | (x03 & (x07 | x10)));
  assign z3 = (x04 & x07) | ((~x07 | ~x11) & (x00 | ~x12));
  ...
  assign z7 = (x09 & x03 & ~x01 & ~x02) | ~new_n35_ | (~x08 & (~x03 | x01 | x02));
  assign z8 = ~new_n35_ | new_n41_;
  assign new_n41_ = (~x00 | x09) & (x12 | ~x09 | ~x03 | x01 | x02);
endmodule
