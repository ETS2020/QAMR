...
module FAU ( 
  ...
  assign z1 = (x07 & ~x09) | (new_n30_ & (~new_n29_ | ~x05 | ~x06));
  assign new_n29_ = x01 & x02;
  assign new_n30_ = (x03 | (x02 & x04)) & ~x00 & (x01 | x02);
  assign z2 = ~new_n32_ & ((~x07 & ~x08) | ~x00 | (x07 & ~x09));
  assign new_n32_ = ~x02 & (((~x07 | x09) & (x01 | (x03 & x07))) | ((~x09 | x10) & ~x07 & (x03 | ~x10)));
  assign z3 = (x07 & ~x09) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (~x07 | x09) & (~x07 | ~x11);
  assign z5 = (~x07 | x09) & (x10 | x12 | ~x13 | x00 | x07);
  assign z6 = new_n38_ & (~new_n37_ | ~x01 | ~x02) & (x01 | x02 | (~x03 ^ ~x09));
  ...
  assign z8 = (x09 | (~x07 & (~x00 | x10))) & (~new_n40_ | x10 | x12 | x07 | ~x09);
endmodule
