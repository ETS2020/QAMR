...
module FAU ( 
  ...
  assign z1 = new_n30_ & (x03 | x04) & ~new_n28_ & ~x00;
  assign new_n30_ = (x02 | (x01 & x03)) & (~x01 | ~x02 | ~x05 | ~x06);
  assign z2 = (~new_n32_ & ~new_n33_ & ~x01) | new_n28_ | (~new_n34_ & ~new_n35_);
  ...
  assign z4 = (x09 | ~x14) & (~x07 | ~x11) & (~new_n33_ | x07 | ~x09);
  assign z5 = ~new_n28_ & (x00 | x07 | ~x13 | x10 | x12);
  assign z6 = ~new_n40_ & new_n41_ & (x01 | x02 | (~x03 ^ ~x09));
  assign new_n40_ = x14 & (~x09 | (~x00 & x01 & x02));
  assign new_n41_ = (~x00 | ~x08) & ~x07 & ~x10;
  assign z7 = (~new_n43_ & ~x08) | (new_n43_ & x09) | (~x09 & x14) | x07 | x10;
  assign new_n43_ = ~x01 & ~x02 & x03;
  assign z8 = ~new_n28_ & (new_n45_ | x07 | x10);
  assign new_n45_ = (~x09 | x12 | ~x03 | x01 | x02) & (~x00 | x09);
endmodule
