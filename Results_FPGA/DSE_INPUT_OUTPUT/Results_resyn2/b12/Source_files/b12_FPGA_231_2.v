...
module FAU ( 
  ...
  assign z2 = (new_n32_ | x02) & ((~x07 & ~x08) | ~x00 | (x07 & ~x12));
  assign new_n32_ = ((x07 & ~x12) | (~x01 & (~x03 | ~x07))) & ((x09 & ~x10) | x07 | (~x03 & x10));
  assign z3 = (~x07 | (~x11 & x12)) & (x00 | ~x12);
  assign z4 = (x07 & (~x11 | ~x12)) | (~x07 & (~x00 | ~x08)) | (~x07 & ~x09);
  ...
  assign new_n39_ = ~x10 & ~x07 & (~x00 | ~x08);
  assign z7 = (new_n41_ & x09) | (~new_n41_ & ~x08) | x07 | x10;
  assign new_n41_ = x03 & ~x01 & ~x02;
  assign z8 = (x12 & (x07 | x09)) | (~x07 & (x10 | (x09 ? ~new_n41_ : ~x00)));
endmodule
