...
module FAU ( 
  ...
  assign z6 = (~x01 | (x14 & (x00 | ~x02))) & new_n38_ & (new_n37_ | x01 | x02);
  assign new_n37_ = ~x03 ^ ~x09;
  assign new_n38_ = ~x07 & ~x10 & (~x00 | ~x08);
  assign z7 = (~x01 | x14) & ((~new_n40_ & ~x01) | x07 | x10 | (x01 & ~x08));
  assign new_n40_ = (~x02 & x03) ? ~x09 : x08;
  assign z8 = ~new_n28_ & (new_n42_ | x07 | x10);
  assign new_n42_ = (~x00 | x09) & (~x09 | x02 | ~x03 | x01 | x12);
endmodule
