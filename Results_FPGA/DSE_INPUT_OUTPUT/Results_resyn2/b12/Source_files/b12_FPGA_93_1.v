...
module FAU ( 
  ...
  assign z4 = (~x11 & (x07 | x12)) | (~x07 & (~x09 | ~x00 | ~x08));
  assign z5 = ~new_n36_ | ~x13 | x00 | x12;
  assign new_n36_ = ~x07 & ~x10;
  assign z6 = new_n28_ | (~new_n38_ & ~new_n39_ & new_n40_);
  assign new_n38_ = (x03 | ~x09) & ~x01 & ~x02 & (~x03 | x09);
  assign new_n39_ = x01 & x02 & ~x00 & x14;
  assign new_n40_ = (~x00 | ~x08) & ~x07 & ~x10;
  assign z7 = (new_n42_ & x09) | new_n28_ | ~new_n36_ | (~new_n42_ & ~x08);
  assign new_n42_ = ~x01 & ~x02 & x03;
  assign z8 = ~new_n36_ | ((x12 | ~new_n42_ | ~x09) & (~x00 | x09 | (~x11 & x12)));
endmodule
