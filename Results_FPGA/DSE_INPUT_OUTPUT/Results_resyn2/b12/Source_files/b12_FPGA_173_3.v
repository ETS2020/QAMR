// Benchmark "FAU" written by ABC on Tue Aug 11 21:50:00 2020
...
module FAU ( 
  ...
  assign z7 = ~new_n35_ | ((~x08 | (x03 & ~x01 & ~x02)) & (x01 | x02 | ~x03 | x09));
  assign z8 = (~new_n41_ & x09) | ~new_n35_ | (~x00 & ~x09);
