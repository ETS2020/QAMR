...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n31_, new_n35_, new_n36_, new_n38_, new_n39_,
    new_n41_;
  ...
  assign z3 = (x05 & x07) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (x05 | ~x07 | ~x11);
  assign z5 = ~new_n35_ & (~new_n36_ | ~x13 | x00 | x12);
  assign new_n35_ = x05 & x07;
  assign new_n36_ = ~x07 & ~x10;
  assign z6 = new_n35_ | ((new_n38_ | ~new_n39_) & (~new_n38_ | new_n39_) & new_n36_ & (~x00 | ~x08));
  assign new_n38_ = ~x01 & ~x02 & (~x03 ^ x09);
  assign new_n39_ = x01 & x02 & ~x00 & x14;
  assign z7 = ~new_n35_ & ((new_n41_ & x09) | ~new_n36_ | (~new_n41_ & ~x08));
  assign new_n41_ = x03 & ~x01 & ~x02;
  assign z8 = ~new_n36_ | ((~x00 | x09) & (x12 | ~new_n41_ | ~x09));
endmodule
