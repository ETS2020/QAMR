...
module FAU ( 
  ...
  assign z4 = (x08 | ~x13) & (~x07 | ~x11) & (x07 | ~x09 | ~x00 | ~x08);
  assign z5 = x00 | x07 | ~x08 | x10 | x12 | ~x13;
  assign z6 = ((x03 & ~x09) | x01 | x02 | (~x03 & x09)) & new_n37_ & (~new_n36_ | ~x01 | ~x02);
  assign new_n36_ = ~x00 & x14;
  assign new_n37_ = (~x00 | ~x08) & (x08 | ~x13) & ~x07 & ~x10;
  assign z7 = (x08 | ~x13) & (new_n39_ | x07 | x10);
  assign new_n39_ = (~x08 | (~x01 & ~x02 & x03)) & (x01 | x02 | ~x03 | x09);
  assign z8 = ~new_n41_ | (x09 & (x12 | x01 | x02 | ~x03));
  assign new_n41_ = (x08 | ~x13) & ~x07 & ~x10 & (x00 | x09);
endmodule
