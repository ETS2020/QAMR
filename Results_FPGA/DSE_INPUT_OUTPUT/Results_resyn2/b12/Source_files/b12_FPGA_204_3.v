...
module FAU ( 
  ...
  assign z1 = (x06 & x07) | (new_n30_ & (~x01 | ~x02 | x07 | ~x05 | ~x06));
  assign new_n30_ = ~x00 & ((x02 & x04) | (x03 & (x01 | x02)));
  assign z2 = (new_n32_ | x02) & ((~x07 & ~x08) | ~x00 | (x06 & x07));
  assign new_n32_ = ((x06 & x07) | (~x01 & (~x03 | ~x07))) & ((x09 & ~x10) | x07 | (~x03 & x10));
  assign z3 = (x06 & x07) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (~x06 | ~x07) & (~x07 | ~x11);
  assign z5 = ~new_n28_ & (~new_n36_ | ~x13 | x00 | x12);
  ...
  assign z7 = (x09 & x03 & ~x01 & ~x02) | ~new_n36_ | (~x08 & (~x03 | x01 | x02));
