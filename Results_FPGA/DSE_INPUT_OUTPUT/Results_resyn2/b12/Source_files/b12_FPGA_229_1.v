...
module FAU ( 
  ...
  assign z2 = ((x02 | (~new_n31_ & ~x01)) & ~x07 & (~x00 | ~x08)) | (~x00 & x01 & x02);
  ...
  assign z6 = (new_n36_ | x01 | x02) & new_n37_ & (~x14 | x00 | ~x01 | ~x02);
  assign new_n36_ = ~x03 ^ ~x09;
  assign new_n37_ = ~x10 & ~x07 & (~x00 | ~x08);
  assign z7 = (~new_n39_ & ~x07) | (x01 & (x07 | ~x08));
  assign new_n39_ = (x01 | x02 | ~x03 | ~x09) & ~x10 & (x08 | (~x02 & x03));
  assign z8 = (x01 | (~new_n41_ & ~x07)) & (x07 | x10 | ~x00 | x09);
