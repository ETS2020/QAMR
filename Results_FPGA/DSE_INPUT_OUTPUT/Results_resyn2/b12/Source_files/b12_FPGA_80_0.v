...
module FAU ( 
  ...
  assign new_n33_ = ~x02 & (x01 | ((x03 | (~x07 & ~x10)) & (x10 | x07 | ~x09)));
  assign z3 = (~x08 & ~x11) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (x08 | x11) & (~x07 | ~x11);
  assign z5 = new_n28_ | x00 | x07 | x10 | x12 | ~x13;
  assign z6 = ~new_n38_ & (~new_n30_ | x00 | ~x14) & new_n39_ & (~x00 | ~x08);
  assign new_n38_ = (~x03 | x09) & ~x01 & ~x02 & (x03 | ~x09);
  assign new_n39_ = (x08 | x11) & ~x07 & ~x10;
  assign z7 = ~new_n28_ & (new_n41_ | x07 | x10);
  assign new_n41_ = (~x08 | (~x01 & ~x02 & x03)) & (x01 | x02 | ~x03 | x09);
  assign z8 = ~new_n43_ | (x09 & (x12 | ~x03 | x01 | x02));
