...
module FAU ( 
  ...
  assign z2 = (new_n31_ & (x10 | (~x07 & x09))) | new_n32_ | (x07 & (new_n33_ | x10));
  assign new_n31_ = (~x00 | ~x08) & ~x01 & (~x03 | ~x10);
  assign new_n32_ = x02 & (~x00 | (~x07 & ~x08));
  assign new_n33_ = ~x03 & ~x00 & ~x01;
  ...
  assign z8 = x07 | x10 | ((~x00 | x09) & (~new_n41_ | ~x09 | x12));
endmodule
