...
module FAU ( 
  ...
  assign z2 = ~new_n32_ & (~x00 | ~x08) & (~x07 | (~x00 & x13));
  assign new_n32_ = ~x02 & (x01 | ((x03 | (~x07 & ~x10)) & (x10 | x07 | ~x09)));
  assign z3 = (x07 & ~x13) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (x07 | ~x09 | ~x00 | ~x08) & (~x11 | ~x07 | ~x13);
  assign z5 = x07 | x10 | x12 | x00 | ~x13;
  ...
  assign z7 = (new_n41_ | x07 | x10) & (~x07 | x13);
  assign new_n41_ = (~x08 | (x03 & ~x01 & ~x02)) & (x01 | x02 | ~x03 | x09);
  assign z8 = x07 ? x13 : ((~new_n43_ & x09) | x10 | (~x00 & ~x09));
