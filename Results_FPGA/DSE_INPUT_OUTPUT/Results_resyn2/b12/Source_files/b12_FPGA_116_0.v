...
module FAU ( 
  ...
  assign new_n31_ = x02 & (x06 | x07);
  assign new_n32_ = ~x01 & ((~x03 & (x07 | (x06 & x10))) | (x06 & ~x07 & x09 & ~x10));
  ...
  assign z6 = (x01 | x02 | (~x03 ^ ~x09) | (new_n39_ & x01 & x02)) & new_n40_ & ((~x01 & ~x02 & (x03 ^ ~x09)) | ~new_n39_ | ~x01 | ~x02);
  assign new_n39_ = ~x00 & x14;
  assign new_n40_ = (~x00 | ~x08) & ~x10 & x06 & ~x07;
  assign z7 = x07 | (~new_n42_ & x06);
