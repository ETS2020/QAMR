...
module FAU ( 
  ...
  assign z0 = (~x00 | (x07 & ~x14)) & (new_n27_ | new_n28_ | (x07 & ~x14));
  assign new_n27_ = (~x02 | ~x04) & x03 & (x01 | x02);
  assign new_n28_ = (~x04 | x05) & x01 & x02;
  assign z1 = ~new_n30_ & ~x00 & (~x07 | x14);
  assign new_n30_ = (~x01 | x02 | ~x03) & ((x06 & x01 & x05) | ~x02 | (~x03 & ~x04));
  assign z2 = (new_n32_ | x02) & (~x00 | (x07 & ~x14) | (~x07 & ~x08));
  assign new_n32_ = ((x07 & ~x14) | (~x01 & (~x03 | ~x07))) & ((x09 & ~x10) | x07 | (~x03 & x10));
  assign z3 = (~x07 | (~x11 & x14)) & (x00 | ~x12);
  assign z4 = (~x07 | (~x11 & x14)) & (~x00 | ~x08 | x07 | ~x09);
  ...
  assign z7 = (new_n40_ & x09) | (~new_n40_ & ~x08) | x07 | x10;
