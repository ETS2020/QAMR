...
module FAU ( 
  ...
  assign new_n33_ = ~x07 & (~x09 | ((~x00 | ~x08) & ~x01 & ~x10));
  assign z3 = (~x07 | ~x11) & (~new_n29_ | ~x12);
  assign z4 = (~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09);
  assign z5 = x07 | (x09 & (x00 | x10 | x12 | ~x13));
  assign z6 = new_n38_ & (~x00 | ~x08) & (~x01 | ~x02 | x00 | ~x14);
  assign new_n38_ = (~x03 | x01 | x02) & ~x10 & ~x07 & x09;
  assign z7 = x07 | (x09 & (new_n40_ | ~x08 | x10));
  assign new_n40_ = x03 & ~x01 & ~x02;
  assign z8 = x10 | x07 | ~x09 | ~new_n40_ | x12;
endmodule
