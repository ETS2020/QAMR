...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n34_, new_n36_;
  ...
  assign z2 = (~new_n30_ & ~x00) | (~x07 & (x00 | (~x10 & ~x01 & x09)));
  assign new_n30_ = ~x02 & ((~x07 & ~x10) | x01 | x03);
  assign z3 = z4 & (x00 | ~x12);
  assign z4 = x07 ? ~x11 : ~x00;
  assign z5 = ~x13 | ~new_n34_ | x12;
  assign new_n34_ = ~x10 & ~x00 & ~x07;
  assign z6 = ~x07 & (new_n36_ | x00);
  assign new_n36_ = ((~x03 & x09) | x01 | x02 | (x03 & ~x09)) & ~x10 & (~x14 | ~x01 | ~x02);
  assign z7 = (~x08 & (~x03 | x01 | x02)) | ~new_n34_ | (x09 & x03 & ~x01 & ~x02);
  assign z8 = ~new_n34_ | x12 | ~x09 | ~x03 | x01 | x02;
endmodule
