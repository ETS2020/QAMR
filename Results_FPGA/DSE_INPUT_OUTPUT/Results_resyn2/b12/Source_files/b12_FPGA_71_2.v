...
module FAU ( 
  ...
  assign new_n34_ = ~x08 & ~x05 & ~x07;
  assign z3 = (x07 ? ~x11 : ~x05) & (x00 | ~x12);
  assign z4 = x07 ? ~x11 : (~x00 | ~x08 | x05 | ~x09);
  assign z5 = ~new_n38_ | ~x13 | x00 | x12;
  assign new_n38_ = ~x10 & ~x05 & ~x07;
  assign z6 = ~x07 & (x05 | (new_n41_ & (~new_n40_ | (~x03 ^ ~x09))));
  assign new_n40_ = ~x01 & ~x02;
  assign new_n41_ = (~x01 | ~x02 | x00 | ~x14) & ~x10 & (~x00 | ~x08);
  assign z7 = (x09 & new_n40_ & x03) | ~new_n38_ | (~x08 & (~new_n40_ | ~x03));
  assign z8 = ~new_n38_ | ((~x00 | x09) & (x12 | ~x09 | ~new_n40_ | ~x03));
endmodule
