...
module FAU ( 
  ...
  assign z1 = new_n30_ & ~x00 & (~x01 | ~x05 | ~x02 | ~x06);
  assign new_n30_ = (x02 | (x01 & x03)) & (x03 | (x04 & ~x12));
  ...
  assign z4 = (~x00 | x07 | ~x08 | ~x09) & ~new_n28_ & (~x07 | ~x11);
  assign z5 = (x03 | ~x12) & (x00 | x07 | ~x13 | x10 | x12);
  ...
  assign new_n42_ = (x03 | x12 | ~x00 | (~x02 & ~x09)) & ((~x02 & x09) | x01 | ~x03);
  assign new_n43_ = (~x09 | (~x03 & ~x12)) & ~x00 & ~x01 & (x03 | x09);
  assign z7 = (x03 & (new_n45_ ? x09 : ~x08)) | (~new_n40_ & (x03 | ~x12)) | (~x08 & ~x03 & ~x12);
  assign new_n45_ = ~x01 & ~x02;
  assign z8 = (~new_n40_ & (x03 | ~x12)) | ((~new_n45_ | ~x09 | ~x03 | x12) & (x03 | ~x12) & (~x00 | x09));
endmodule
