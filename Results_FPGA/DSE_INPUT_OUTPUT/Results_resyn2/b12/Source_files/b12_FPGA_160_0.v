...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n31_, new_n36_, new_n37_, new_n39_, new_n40_,
    new_n42_;
  ...
  assign z5 = x12 | (x11 & (x07 | x10 | x00 | ~x13));
  assign z6 = (new_n36_ | x01 | x02) & new_n37_ & (~x01 | ~x02 | x00 | ~x14);
  assign new_n36_ = ~x03 ^ ~x09;
  assign new_n37_ = (~x00 | ~x08) & (x11 | x12) & ~x07 & ~x10;
  assign z7 = (x11 | x12) & (new_n39_ | ~new_n40_);
  assign new_n39_ = ~x08 & (x01 | x02 | ~x03);
  assign new_n40_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = new_n42_ | x07 | x10 | (~x11 & ~x12);
