...
module FAU ( 
  ...
  assign z1 = new_n29_ & (~x06 | (~x07 & (~x05 | ~x01 | ~x02)));
  ...
  assign z4 = (~x07 | (~x06 & ~x11)) & (~x00 | ~x08 | x07 | ~x09);
  assign z5 = (~x06 | ~x07) & (x00 | x07 | ~x13 | x10 | x12);
  assign z6 = x07 ? x06 : (~new_n36_ & new_n37_);
  ...
  assign z8 = x07 ? ~x06 : ((~new_n41_ & x09) | x10 | (~x00 & ~x09));
