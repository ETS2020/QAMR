...
module FAU ( 
  ...
  assign z1 = new_n29_ & ~x00 & (~x07 | ~x13) & (x03 | x04);
  assign new_n29_ = (x02 | (x01 & x03)) & (~x01 | ~x02 | ~x05 | ~x06);
  assign z2 = (new_n31_ | x02) & ((~x07 & ~x08) | ~x00 | (x07 & x13));
  assign new_n31_ = ((x07 & x13) | (~x01 & (~x03 | ~x07))) & ((x09 & ~x10) | x07 | (~x03 & x10));
  assign z3 = (x07 & x13) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (~x07 | ~x11) & (~x07 | ~x13);
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = x07 ? x13 : (~new_n36_ & new_n37_);
  assign new_n36_ = ~x01 & ~x02 & (~x03 ^ x09);
  assign new_n37_ = (~x01 | ~x02 | x00 | ~x14) & ~x10 & (~x00 | ~x08);
  assign z7 = (~x07 | ~x13) & ((new_n39_ & x09) | (~new_n39_ & ~x08) | x07 | x10);
  assign new_n39_ = x03 & ~x01 & ~x02;
  assign z8 = x07 ? ~x13 : ((~new_n41_ & x09) | x10 | (~x00 & ~x09));
