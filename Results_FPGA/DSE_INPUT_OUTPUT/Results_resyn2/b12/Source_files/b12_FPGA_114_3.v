...
module FAU ( 
  ...
  assign z2 = ((~x00 | ~x08) & (new_n31_ | x02)) | (x07 & (new_n32_ | x00 | x02));
  assign new_n31_ = (x10 | (~x07 & x09)) & ~x01 & (~x03 | ~x10);
  assign new_n32_ = ~x01 & ~x03;
  assign z3 = x00 | ((~x07 | ~x11) & ~x12);
  assign z4 = (x00 & x07) | ((~x07 | ~x11) & (~x09 | ~x00 | ~x08));
  ...
  assign z7 = (~x00 | ~x07) & ((new_n40_ & x09) | (~new_n40_ & ~x08) | x07 | x10);
  assign new_n40_ = ~x01 & ~x02 & x03;
  assign z8 = (~x00 | ~x07) & (x10 | ((~x00 | x09) & (~new_n40_ | x12 | x07 | ~x09)));
endmodule
