...
module FAU ( 
  ...
  assign z2 = (~x00 & (new_n32_ | (~new_n28_ & x02))) | (new_n34_ & (new_n33_ | x02));
  assign new_n32_ = ~x01 & ((~x03 & (x07 | (x10 & ~x12))) | (x09 & ~x12 & ~x07 & ~x10));
  assign new_n33_ = (~x03 | ~x10) & ~x01 & (x09 | x10);
  assign new_n34_ = ~x07 & ~x08 & ~x12;
  assign z3 = (~x07 | ~x11) & (~x12 | (x00 & x07));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (x07 | ~x12) & (~x07 | ~x11);
  assign z5 = x12 | x07 | x10 | x00 | ~x13;
  assign z6 = ~x07 & (x12 | (~new_n39_ & new_n40_));
  assign new_n39_ = (x03 | ~x09) & ~x01 & ~x02 & (~x03 | x09);
  assign new_n40_ = (~x01 | ~x02 | x00 | ~x14) & ~x10 & (~x00 | ~x08);
  assign z7 = x07 | (~x12 & ((new_n42_ & x09) | x10 | (~new_n42_ & ~x08)));
  assign new_n42_ = ~x01 & ~x02 & x03;
  assign z8 = x07 | (~x12 & (x10 | (x09 ? ~new_n42_ : ~x00)));
endmodule
