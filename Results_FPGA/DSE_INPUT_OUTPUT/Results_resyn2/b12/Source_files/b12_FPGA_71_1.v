...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n31_, new_n35_, new_n37_, new_n38_, new_n39_,
    new_n42_;
  assign z0 = new_n27_ | (~x05 & x07);
  assign new_n27_ = ~x00 & (((~x04 | x05) & x01 & x02) | ((~x02 | ~x04) & x03 & (x01 | x02)));
  assign z1 = new_n29_ & (x03 | x04) & ~x00 & (x05 | ~x07);
  ...
  assign z6 = (~x05 & x07) | (~new_n37_ & ~new_n38_ & new_n39_);
