...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n31_, new_n36_, new_n39_;
  ...
  assign z7 = (~x08 & (x02 | ~x03)) | ~new_n36_ | (x09 & ~x02 & x03);
  assign z8 = (~new_n39_ & ~x01) | x07;
  assign new_n39_ = ~x10 & ((x00 & ~x09) | (~x12 & x09 & ~x02 & x03));
endmodule
