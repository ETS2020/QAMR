...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | (x01 & x02) | (~x01 & ~x02) | (x02 & x04)) & (~x01 | ~x10) & (~x01 | ~x02 | (x04 & ~x05));
  assign z1 = (new_n29_ | ~x01) & (x03 | (x02 & x04)) & ~x00 & (x01 | x02);
  assign new_n29_ = ~x10 & (~x06 | ~x02 | ~x05);
  assign z2 = ~new_n31_ & ((~x07 & ~x08) | ~x00 | (x01 & x10));
  assign new_n31_ = ~x02 & ((~x10 & (x01 | (~x07 & ~x09))) | (~x01 & x03 & (x07 | x10)));
  ...
  assign z6 = (new_n37_ | ~new_n38_) & (~new_n37_ | new_n38_) & ~x07 & ~x10 & (~x00 | ~x08);
  ...
  assign z8 = x10 ? ~x01 : ((~new_n42_ & x09) | x07 | (~x00 & ~x09));
