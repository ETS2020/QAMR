...
module FAU ( 
  ...
  assign z0 = new_n27_ | (~x09 & x10);
  assign new_n27_ = ~x00 & (((~x04 | x05) & x01 & x02) | ((~x02 | ~x04) & x03 & (x01 | x02)));
  assign z1 = (~x09 & x10) | (~new_n29_ & ~x00);
  assign new_n29_ = (~x01 | x02 | ~x03) & ((x06 & x01 & x05) | ~x02 | (~x03 & ~x04));
  assign z2 = (~new_n31_ & new_n32_) | (~new_n33_ & ~new_n34_) | (~x09 & x10);
  ...
  assign z4 = (~x00 | x07 | ~x08 | ~x09) & (x09 | ~x10) & (~x07 | ~x11);
  assign z5 = (x09 | ~x10) & (x00 | x07 | ~x13 | x10 | x12);
  assign z6 = (new_n39_ | x01 | x02) & new_n40_ & (~x01 | ~x02 | x00 | ~x14);
  assign new_n39_ = ~x03 ^ ~x09;
  assign new_n40_ = (~x00 | ~x08) & ~x07 & ~x10;
  assign z7 = (x09 & (new_n42_ | x10)) | (~x10 & (x07 | (~new_n42_ & ~x08)));
  assign new_n42_ = ~x01 & ~x02 & x03;
  assign z8 = (x09 | (~x10 & (~x00 | x07))) & (~new_n44_ | ~x09 | x07 | x10);
