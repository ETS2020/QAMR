...
module FAU ( 
  ...
  assign z1 = ~new_n29_ & ~x00 & (x07 | x13);
  ...
  assign z3 = (~x07 | ~x11) & (~x12 | x00 | (~x07 & ~x13));
  ...
  assign new_n40_ = (~x00 | ~x08) & ~x10 & ~x07 & x13;
  assign z7 = x07 | (x13 & ((new_n42_ & x09) | x10 | (~new_n42_ & ~x08)));
  assign new_n42_ = ~x01 & ~x02 & x03;
  assign z8 = new_n44_ | x10 | x07 | ~x13;
