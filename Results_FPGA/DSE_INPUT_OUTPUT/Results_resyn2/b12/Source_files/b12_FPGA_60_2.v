...
module FAU ( 
  ...
  assign new_n31_ = ~x07 & (x05 | (~x10 & ~x02 & ~x09));
  assign new_n32_ = (~x07 | (~x00 & (x02 | ~x03))) & (~x00 | ~x08);
  assign z3 = (x00 | ~x12) & (~x05 | x07) & (~x07 | ~x11);
  assign z4 = (~x05 | x07) & (~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09);
  assign z5 = x07 | x10 | x00 | x05 | x12 | ~x13;
  assign z6 = ((~new_n37_ & ~x01 & ~x02) | ~x01 | ~x02 | x00 | ~x14) & new_n38_ & (new_n37_ | x01 | x02 | (x01 & x02 & ~x00 & x14));
  assign new_n37_ = ~x03 ^ ~x09;
  assign new_n38_ = ~x07 & ~x10 & ~x05 & (~x00 | ~x08);
  assign z7 = x07 | (~new_n40_ & ~x05);
