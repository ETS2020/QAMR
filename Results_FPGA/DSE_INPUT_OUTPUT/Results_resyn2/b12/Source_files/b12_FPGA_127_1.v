...
module FAU ( 
  ...
  assign z2 = (~new_n34_ & new_n35_) | (~x00 & (new_n32_ | new_n33_));
  ...
  assign z4 = (~x07 | ~x11) & (~x00 | ~x08 | ~x09 | x07 | x12);
  assign z5 = x10 | x07 | x12 | x00 | ~x13;
  assign z6 = ~x07 & (x12 | (~new_n40_ & new_n41_));
  assign new_n40_ = (x03 | ~x09) & ~x01 & ~x02 & (~x03 | x09);
  assign new_n41_ = (~x01 | ~x02 | x00 | ~x14) & ~x10 & (~x00 | ~x08);
  assign z7 = x07 | (~x12 & ((new_n43_ & x09) | x10 | (~new_n43_ & ~x08)));
  assign new_n43_ = x03 & ~x01 & ~x02;
  assign z8 = x10 | x07 | x12 | (x09 ? ~new_n43_ : ~x00);
endmodule
