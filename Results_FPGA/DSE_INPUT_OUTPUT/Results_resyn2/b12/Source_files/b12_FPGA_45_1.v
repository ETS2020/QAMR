...
module FAU ( 
  ...
  assign z4 = (x07 & (~x01 | ~x11)) | (~new_n34_ & ~x07) | (~x07 & ~x09);
  assign new_n34_ = x00 & x08;
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = (~x01 & x07) | (((~new_n37_ & ~x01) | (~new_n38_ & x01 & ~x07)) & ~new_n34_ & ~x10);
  assign new_n37_ = ~x02 & (~x03 ^ x09);
  assign new_n38_ = x14 & ~x00 & x02;
  assign z7 = (~new_n40_ & ~x07) | (x01 & (x07 | ~x08));
  assign new_n40_ = (~x03 | ~x09 | x01 | x02) & ~x10 & ((~x02 & x03) | x08);
  assign z8 = (x01 | (~new_n42_ & ~x07)) & (x07 | x10 | ~x00 | x09);
  assign new_n42_ = ~x02 & x03 & ~x12 & x09 & ~x10;
endmodule
