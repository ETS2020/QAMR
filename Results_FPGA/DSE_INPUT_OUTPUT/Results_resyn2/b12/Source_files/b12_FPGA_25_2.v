...
module FAU ( 
  ...
  assign new_n27_ = (((~x02 | x04) & (~x01 | ~x07)) | ~x03 | (x01 & x02)) & ((x04 & ~x05) | ~x01 | ~x02 | ~x07);
  ...
  assign z3 = (x00 | ~x12) & (~x07 | ~x11) & (~x01 | x07);
  ...
  assign z7 = new_n38_ | x01 | x07 | x10;
  assign new_n38_ = (~x08 | (~x02 & x03)) & (x02 | ~x03 | x09);
  assign z8 = (~new_n40_ & ~x01) | x07;
