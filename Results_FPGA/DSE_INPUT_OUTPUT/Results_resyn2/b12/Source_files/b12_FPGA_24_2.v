...
module FAU ( 
  ...
  assign z6 = ~x07 & (x05 | (new_n38_ & ((~x03 & x09) | ~new_n37_ | (x03 & ~x09))));
  assign new_n37_ = ~x01 & ~x02;
  assign new_n38_ = (~x01 | ~x02 | x00 | ~x14) & ~x10 & (~x00 | ~x08);
  assign z7 = (~x08 & (~new_n37_ | ~x03)) | ~new_n40_ | (x09 & new_n37_ & x03);
  assign new_n40_ = ~x10 & ~x05 & ~x07;
  assign z8 = (x09 & (x12 | ~new_n37_ | ~x03)) | ~new_n40_ | (~x00 & ~x09);
endmodule
