...
module FAU ( 
  ...
  assign z4 = (x07 | ~x08 | ~x09) & (x00 | x07) & (~x07 | ~x11);
  assign z5 = x00 | x07;
  assign z6 = ~x07 & (new_n37_ | ~x00);
  assign new_n37_ = ((~x03 & x09) | x01 | x02 | (x03 & ~x09)) & ~x08 & ~x10;
  assign z7 = (new_n39_ & x09) | (~new_n39_ & ~x08) | x10 | ~x00 | x07;
  assign new_n39_ = ~x01 & ~x02 & x03;
  assign z8 = x10 | ~x00 | x07 | (x09 & (~new_n39_ | x12));
endmodule
