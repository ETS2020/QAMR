...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n31_, new_n36_, new_n37_, new_n38_, new_n41_;
  ...
  assign z6 = (new_n36_ | ~new_n37_) & (~new_n36_ | new_n37_) & new_n38_ & (~x00 | ~x08);
  assign new_n36_ = ~x01 & ~x02 & (x03 ^ ~x09);
  assign new_n37_ = x01 & x02 & ~x00 & x14;
  assign new_n38_ = ~x07 & ~x10;
  assign z7 = (~x08 & (x01 | x02 | ~x03)) | ~new_n38_ | (~x01 & ~x02 & x03 & x09);
