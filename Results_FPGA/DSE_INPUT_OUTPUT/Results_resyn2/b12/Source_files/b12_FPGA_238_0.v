...
module FAU ( 
  ...
  assign z1 = (~x07 & ~x14) | (~new_n29_ & new_n30_);
  assign new_n29_ = x01 & x02 & x05 & x06;
  assign new_n30_ = (x02 | (x01 & x03)) & ~x00 & (x03 | x04);
  assign z2 = (~x00 | (~x07 & (~x08 | ~x14))) & (~new_n33_ | (~x07 & (new_n32_ | ~x14)));
  assign new_n32_ = ~x10 & ~x01 & x09;
  assign new_n33_ = ~x02 & ((~x07 & ~x10) | x01 | x03);
  assign z3 = (x07 ? ~x11 : x14) & (x00 | ~x12);
  assign z4 = (~x07 & (~x00 | ~x09)) | (~x07 & (~x08 | ~x14)) | (x07 & ~x11);
  assign z5 = x07 | (x14 & (x00 | x10 | x12 | ~x13));
  assign z6 = ~x07 & (~x14 | (~new_n38_ & new_n39_));
  assign new_n38_ = (x03 | ~x09) & ~x01 & ~x02 & (~x03 | x09);
  assign new_n39_ = (x00 | ~x01 | ~x02) & ~x10 & (~x00 | ~x08);
  assign z7 = (~new_n41_ & ~x08) | (new_n41_ & x09) | x10 | x07 | ~x14;
  assign new_n41_ = x03 & ~x01 & ~x02;
  assign z8 = (~new_n43_ & x09) | x10 | x07 | ~x14 | (~x00 & ~x09);
