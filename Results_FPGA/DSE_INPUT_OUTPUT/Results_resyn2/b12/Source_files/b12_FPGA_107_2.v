...
module FAU ( 
  ...
  assign z6 = ~new_n40_ & (x10 | (~new_n41_ & ~x07 & (~x00 | ~x08)));
  assign new_n40_ = x14 & (x10 | (~x00 & x01 & x02));
  assign new_n41_ = ~x01 & ~x02 & (~x03 ^ x09);
  assign z7 = x10 ? x14 : ~new_n43_;
  assign new_n43_ = (~x09 | ~x03 | x01 | x02) & ~x07 & (x08 | (x03 & ~x01 & ~x02));
  assign z8 = x10 ? x14 : (new_n45_ | x07);
  assign new_n45_ = (x01 | x02 | ~x03 | ~x09 | x12) & (~x00 | x09);
endmodule
