...
module FAU ( 
  ...
  assign z3 = (x12 & ~x13) | ((~x07 | ~x11) & (x00 | ~x12));
  ...
  assign z7 = (~x08 & (x01 | x02 | ~x03)) | ~new_n41_ | (~x01 & ~x02 & x03 & x09);
  assign new_n41_ = ~x07 & ~x10 & (~x12 | x13);
  assign z8 = ~new_n28_ & (new_n43_ | x07 | x10);
  assign new_n43_ = (~x00 | x09) & (x12 | x01 | x02 | ~x03 | ~x09);
endmodule
