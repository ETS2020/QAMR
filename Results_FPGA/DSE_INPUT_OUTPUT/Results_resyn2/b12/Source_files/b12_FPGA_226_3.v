...
module FAU ( 
  ...
  assign z4 = (~x07 | (~x09 & ~x11)) & (~x09 | ~x00 | ~x08);
  assign z5 = (~x07 | ~x09) & (x07 | x10 | ~x13 | x00 | x12);
  assign z6 = (x01 | x02 | (x03 ^ x09)) & new_n37_ & (~new_n36_ | ~x01 | ~x02);
  assign new_n36_ = ~x00 & x14;
  assign new_n37_ = (~x00 | ~x08) & ~x07 & ~x10;
  assign z7 = x07 ? ~x09 : ~new_n39_;
  assign new_n39_ = (x08 | (~x01 & ~x02 & x03)) & ~x10 & (~x03 | ~x09 | x01 | x02);
  assign z8 = (~x09 & (~x00 | x07)) | (~x07 & (x10 | (~new_n41_ & x09)));
