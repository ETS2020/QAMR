...
module FAU ( 
  ...
  assign z2 = ((~x00 | ~x08) & (new_n30_ | x02)) | (x07 & (new_n31_ | x00 | x02));
  assign new_n30_ = (x10 | (~x07 & x09)) & ~x01 & (~x03 | ~x10);
  assign new_n31_ = ~x01 & ~x03;
  assign z3 = (x00 | ~x12) & (~x07 | (~x00 & ~x11));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (~x11 | x00 | ~x07);
  ...
  assign z7 = (~x00 | ~x07) & ((~new_n39_ & ~x08) | (new_n39_ & x09) | x07 | x10);
  assign new_n39_ = ~x01 & ~x02 & x03;
  assign z8 = (~x00 | ~x07) & (x10 | ((~x00 | x09) & (~new_n39_ | x12 | x07 | ~x09)));
endmodule
