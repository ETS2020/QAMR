...
module FAU ( 
  ...
  assign new_n27_ = ~x00 & ((x01 & x02 & (~x04 | x05)) | ((~x01 | ~x02) & x03 & (x01 | ~x04) & (x01 | x02)));
  ...
  assign z6 = (x01 | (~x07 & (x02 | (~x03 ^ ~x09)))) & (new_n36_ | x07);
  assign new_n36_ = (~x01 | ~x02 | x00 | ~x14) & ~x10 & (~x00 | ~x08);
  assign z7 = (~new_n38_ & ~x07) | (~x01 & (x07 | (~x02 & x03 & x09)));
  assign new_n38_ = ~x10 & (x08 | (x03 & ~x01 & ~x02));
