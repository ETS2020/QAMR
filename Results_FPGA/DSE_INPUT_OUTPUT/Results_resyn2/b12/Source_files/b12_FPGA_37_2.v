...
module FAU ( 
  ...
  assign z1 = (x03 & ~x07) | (new_n30_ & (~new_n29_ | ~x05 | ~x06));
  assign new_n29_ = x01 & x02;
  assign new_n30_ = (x03 | (x02 & x04)) & ~x00 & (x01 | x02);
  assign z2 = new_n32_ & (x07 | (~x03 & (x02 | x09 | x10)));
  ...
  assign z6 = ~x07 & (x03 | (new_n37_ & (~new_n29_ | x00 | ~x14)));
  assign new_n37_ = (x09 | x01 | x02) & ~x10 & (~x00 | ~x08);
