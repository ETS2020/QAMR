...
module FAU ( 
  ...
  assign z1 = new_n29_ & ~new_n30_ & (x04 | (x03 & ~x07));
  assign new_n29_ = ~x00 & (x02 | (x01 & x03));
  assign new_n30_ = x01 & x02 & x05 & x06;
  assign z2 = (new_n32_ | x02) & ((~x07 & ~x08) | ~x00 | (~x04 & x07));
  assign new_n32_ = ((~x04 & x07) | (~x01 & (~x03 | ~x07))) & ((x09 & ~x10) | x07 | (~x03 & x10));
  assign z3 = (~x04 & x07) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (~x11 | ~x04 | ~x07);
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = x07 ? ~x04 : (~new_n37_ & new_n38_);
  assign new_n37_ = ~x01 & ~x02 & (~x03 ^ x09);
  assign new_n38_ = (~x01 | ~x02 | x00 | ~x14) & ~x10 & (~x00 | ~x08);
  assign z7 = (x04 | ~x07) & ((new_n40_ & x09) | (~new_n40_ & ~x08) | x07 | x10);
