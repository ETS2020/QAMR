...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | (x01 & x07) | (~x01 & ~x02) | (x02 & x04) | (x01 & x02)) & ((x04 & ~x05) | x07 | ~x01 | ~x02);
  assign z1 = (x01 & x07) | (new_n29_ & (~x01 | ~x02 | ~x05 | ~x06));
  assign new_n29_ = (x02 | (x01 & x03)) & ~x00 & (x03 | x04);
  assign z2 = ~new_n31_ & ((~x07 & ~x08) | ~x00 | (x01 & x07));
  assign new_n31_ = ~x02 & ((~x07 & (x01 | (~x09 & ~x10))) | (x03 & (~x01 | ~x07) & (x07 | x10)));
  assign z3 = (x01 & x07) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (~x11 | x01 | ~x07);
  assign z5 = (~x01 | ~x07) & (x07 | x10 | ~x13 | x00 | x12);
  assign z6 = ((~x01 & ~x02 & (x03 ^ ~x09)) | ~new_n36_ | ~x01 | ~x02) & new_n37_ & (x01 | x02 | (~x03 ^ ~x09) | (new_n36_ & x01 & x02));
  assign new_n36_ = ~x00 & x14;
  assign new_n37_ = ~x07 & ~x10 & (~x00 | ~x08);
  assign z7 = (new_n39_ & x09) | x07 | x10 | (~new_n39_ & ~x08);
  assign new_n39_ = ~x01 & ~x02 & x03;
  assign z8 = x07 ? ~x01 : ((~new_n41_ & x09) | x10 | (~x00 & ~x09));
