...
module FAU ( 
  ...
  assign z2 = new_n27_ | (~new_n32_ & (~x00 | (~x07 & ~x08)));
  assign new_n32_ = ~x02 & ((~x09 & ~x07 & ~x10) | x01 | (x03 & (x07 | x10)));
  assign z3 = new_n27_ | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = new_n27_ | ((~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09));
  ...
  assign z7 = ~new_n27_ & ((new_n41_ & x09) | (~new_n41_ & ~x08) | x07 | x10);
  assign new_n41_ = x03 & ~x01 & ~x02;
  assign z8 = ~new_n27_ & (new_n43_ | x07 | x10);
  assign new_n43_ = (~x00 | x09) & (x12 | ~x09 | ~x03 | x01 | x02);
endmodule
