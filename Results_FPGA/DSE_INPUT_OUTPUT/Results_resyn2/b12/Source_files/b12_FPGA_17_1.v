...
module FAU ( 
  ...
  assign z3 = (~x10 & x11) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x10 & x11) | ((~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09));
  assign z5 = x10 | (~x11 & (x00 | x07 | x12 | ~x13));
  assign z6 = ~x10 & (x11 | (~new_n40_ & new_n41_));
  assign new_n40_ = (x03 | ~x09) & ~x01 & ~x02 & (~x03 | x09);
  assign new_n41_ = (~x01 | ~x02 | x00 | ~x14) & ~x07 & (~x00 | ~x08);
  assign z7 = (new_n43_ & x09) | (~new_n43_ & ~x08) | x11 | x07 | x10;
  assign new_n43_ = x03 & ~x01 & ~x02;
  assign z8 = x10 | (~x11 & ((~new_n45_ & x09) | x07 | (~x00 & ~x09)));
