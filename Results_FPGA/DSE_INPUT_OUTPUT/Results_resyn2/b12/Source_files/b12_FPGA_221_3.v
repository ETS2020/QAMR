...
module FAU ( 
  ...
  assign new_n38_ = (~x14 | x00 | ~x02) & (~x00 | ~x08) & x01 & ~x07;
  assign z7 = (~x07 | ~x09) & (new_n40_ | x07 | x10);
  assign new_n40_ = (~x08 | (~x01 & ~x02 & x03)) & (~x03 | x09 | x01 | x02);
  assign z8 = (~x07 | ~x09) & (x10 | ((x09 | ~x00 | x07) & (~new_n42_ | ~x09 | x12)));
