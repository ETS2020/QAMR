...
module FAU ( 
  ...
  assign z2 = (~x07 & ~x08) | (~new_n31_ & ~x00);
  assign new_n31_ = ~x02 & ((~x09 & ~x07 & ~x10) | x01 | (x03 & (x07 | x10)));
  assign z3 = (~x07 | ~x11) & (~x12 | x00 | (~x07 & ~x08));
  assign z4 = (~x07 | ~x11) & (x07 | ~x08 | ~x00 | ~x09);
  assign z5 = x07 | ~x08 | x00 | x10 | x12 | ~x13;
  assign z6 = ~new_n36_ & ~x07 & x08 & ~x00 & ~x10;
  assign new_n36_ = (~x01 | x02) & ((x01 & x14) | (~x02 & (x03 ^ ~x09)));
