...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n31_, new_n32_, new_n36_, new_n38_;
  ...
  assign z2 = ((new_n31_ | x02) & ~x07 & ~x08) | (~x00 & (new_n32_ | x02 | ~x07));
  assign new_n31_ = (~x03 | ~x10) & ~x01 & (x09 | x10);
  assign new_n32_ = ~x01 & ~x03;
  assign z3 = ~x07 | (~x11 & (x00 | ~x12));
  assign z4 = ((~x08 | ~x09) & x00 & ~x07) | (x07 & ~x11);
  assign z6 = ~x07 & (new_n36_ | ~x00);
  assign new_n36_ = ((~x03 & x09) | x01 | x02 | (x03 & ~x09)) & ~x08 & ~x10;
  assign z7 = (new_n38_ & x09) | (~new_n38_ & ~x08) | x10 | ~x00 | x07;
  assign new_n38_ = ~x01 & ~x02 & x03;
  assign z8 = x10 | ~x00 | x07 | (x09 & (~new_n38_ | x12));
  assign z5 = 1'b1;
endmodule
