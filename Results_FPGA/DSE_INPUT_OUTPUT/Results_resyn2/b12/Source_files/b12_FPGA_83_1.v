...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & new_n32_) | (~new_n33_ & ~new_n34_) | (~x07 & x12);
  ...
  assign z5 = x07 | (~x12 & (~x13 | x00 | x10));
  assign z6 = (x01 | x02 | (~x03 ^ ~x09)) & new_n40_ & (~new_n39_ | ~x01 | ~x02);
  assign new_n39_ = ~x00 & x14;
  assign new_n40_ = (~x00 | ~x08) & ~x12 & ~x07 & ~x10;
  assign z7 = (~x08 & (~x03 | x01 | x02)) | ~new_n42_ | (~x01 & ~x02 & x03 & x09);
  assign new_n42_ = ~x12 & ~x07 & ~x10;
  assign z8 = x07 | (~new_n44_ & ~x12);
  assign new_n44_ = ~x10 & ((~x01 & ~x02 & x03 & x09) | (x00 & ~x09));
endmodule
