...
module FAU ( 
  ...
  assign z2 = (x01 & ~x00 & x02) | ((x02 | (~new_n31_ & ~x01)) & ~x07 & (~x00 | ~x08));
  ...
  assign z6 = (~x01 & x07) | (new_n38_ & ((~new_n36_ & ~x01) | (~new_n37_ & x01 & ~x07)));
  assign new_n36_ = ~x02 & (x03 ^ ~x09);
  ...
  assign z8 = (x01 | (~x07 & (~new_n42_ | ~x09 | x10))) & (~x00 | x07 | x09 | x10);
