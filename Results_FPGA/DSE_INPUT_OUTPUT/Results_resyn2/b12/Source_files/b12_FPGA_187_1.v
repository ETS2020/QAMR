...
module FAU ( 
  ...
  assign z2 = (~new_n33_ & new_n34_) | (~x00 & (new_n31_ | new_n32_));
  assign new_n31_ = x02 & (x07 | ~x14);
  assign new_n32_ = ~x01 & ((~x03 & (x07 | (x10 & ~x14))) | (x09 & ~x10 & ~x07 & ~x14));
  assign new_n33_ = ~x02 & (x01 | (x10 ? x03 : ~x09));
  assign new_n34_ = ~x08 & ~x07 & ~x14;
  assign z3 = (~x07 | ~x11) & (~x12 | x00 | (~x07 & x14));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (x07 | ~x14) & (~x07 | ~x11);
  assign z5 = ~new_n38_ | ~x13 | x00 | x12;
  assign new_n38_ = ~x10 & ~x07 & ~x14;
  assign z6 = ~x07 & (x14 | (~new_n40_ & ~x10 & (~x00 | ~x08)));
  assign new_n40_ = (x03 | ~x09) & ~x01 & ~x02 & (~x03 | x09);
  assign z7 = (~x08 & (x01 | x02 | ~x03)) | ~new_n38_ | (x09 & ~x01 & ~x02 & x03);
  assign z8 = x07 | (~x14 & (new_n43_ | x10));
