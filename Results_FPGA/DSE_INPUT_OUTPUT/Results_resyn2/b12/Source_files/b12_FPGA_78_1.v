...
module FAU ( 
  ...
  assign new_n28_ = ((x04 & ~x05) | ~x01 | ~x02) & ((~x01 & ~x02) | ~x03 | (x02 & x04));
  assign z1 = new_n30_ & ~new_n27_ & ~x00 & (x01 | x02);
  assign new_n30_ = (x03 | (x02 & x04)) & (~x01 | ~x02 | ~x05 | ~x06);
  assign z2 = ~new_n32_ & (x06 | ~x07) & (~x00 | (~x07 & ~x08));
  ...
  assign z6 = new_n27_ | ((new_n38_ | ~new_n39_) & (~new_n38_ | new_n39_) & new_n36_ & (~x00 | ~x08));
  assign new_n38_ = ~x01 & ~x02 & (~x03 ^ x09);
  assign new_n39_ = x01 & x02 & ~x00 & x14;
  assign z7 = ~new_n27_ & ((new_n41_ & x09) | ~new_n36_ | (~new_n41_ & ~x08));
