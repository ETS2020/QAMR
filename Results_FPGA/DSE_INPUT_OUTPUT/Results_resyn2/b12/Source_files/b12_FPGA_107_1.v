...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & new_n32_) | (~new_n33_ & ~new_n34_) | (~x10 & x14);
  ...
  assign z3 = (x00 | ~x12) & (~x07 | ~x11) & (x10 | ~x14);
  assign z4 = new_n37_ | (~x10 & x14);
  assign new_n37_ = (~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09);
  assign z5 = x00 | x07 | x10 | x12 | ~x13 | x14;
  assign z6 = ~x10 & (x14 | (~new_n40_ & ~x07 & (~x00 | ~x08)));
  assign new_n40_ = (x03 | ~x09) & ~x01 & ~x02 & (~x03 | x09);
  assign z7 = x10 | (~new_n42_ & ~x14);
  assign new_n42_ = ~x07 & ((x08 & (x01 | x02 | ~x03)) | (~x01 & ~x02 & x03 & ~x09));
