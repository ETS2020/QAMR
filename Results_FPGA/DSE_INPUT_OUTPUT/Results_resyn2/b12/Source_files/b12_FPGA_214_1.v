...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n30_, new_n32_, new_n33_, new_n34_, new_n35_,
    new_n39_, new_n41_, new_n42_, new_n43_, new_n45_;
  ...
  assign z5 = ~x13 | (x09 & (~new_n39_ | x00 | x12));
  assign new_n39_ = ~x07 & ~x10;
  assign z6 = new_n39_ & ((~new_n28_ & ~new_n41_) | new_n43_ | (~new_n42_ & ~x08));
  ...
  assign z7 = (new_n45_ & x09) | (~new_n45_ & ~x08) | ~new_n39_ | (~x09 & x13);
  assign new_n45_ = ~x01 & ~x02 & x03;
  assign z8 = ~new_n39_ | ((x13 | ~x00 | x09) & (x12 | ~new_n45_ | ~x09));
endmodule
