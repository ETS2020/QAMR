...
module FAU ( 
  ...
  assign z6 = ~new_n37_ & (x07 | (~new_n38_ & ~x10 & (~x00 | ~x08)));
  assign new_n37_ = x14 & (x07 | (~x00 & x01 & x02));
  assign new_n38_ = ~x01 & ~x02 & (x03 ^ ~x09);
  assign z7 = (~x08 & (~x03 | x01 | x02)) | ~new_n35_ | (~x01 & ~x02 & x03 & x09);
  assign z8 = (~x07 | x14) & (new_n41_ | x07 | x10);
  assign new_n41_ = (~x00 | x09) & (x12 | ~x03 | ~x09 | x01 | x02);
endmodule
