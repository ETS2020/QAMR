...
module FAU ( 
  ...
  assign z6 = new_n36_ & (x02 | (x03 ^ x09));
  assign new_n36_ = ~x01 & ~x07 & ~x10 & (~x00 | ~x08);
  assign z7 = new_n38_ | x07;
  assign new_n38_ = ~x01 & ((x09 & ~x02 & x03) | x10 | (~x08 & (x02 | ~x03)));
  assign z8 = x07 | (~new_n40_ & ~x01);
  assign new_n40_ = ~x10 & ((x00 & ~x09) | (~x12 & x09 & ~x02 & x03));
endmodule
