...
module FAU ( 
  ...
  assign z1 = new_n29_ & ~x00 & (~x10 | x14) & (x03 | x04);
  assign new_n29_ = (x02 | (x01 & x03)) & (~x01 | ~x02 | ~x05 | ~x06);
  assign z2 = ~new_n31_ & (~x10 | x14) & (~x00 | (~x07 & ~x08));
  ...
  assign z6 = ~new_n37_ & (x10 | (~new_n38_ & ~x07 & (~x00 | ~x08)));
  assign new_n37_ = x14 & (x10 | (~x00 & x01 & x02));
