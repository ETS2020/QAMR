...
module FAU ( 
  ...
  assign z2 = (~new_n32_ & ((~x00 & (x07 | x09)) | (~x08 & ~x07 & x09))) | ((~x00 | ~x08) & new_n33_ & ~x07 & x09);
  assign new_n32_ = ~x02 & (x01 | x03);
  assign new_n33_ = ~x01 & ~x10;
  assign z3 = (~x07 | ~x11) & (x00 | (~x07 & ~x09) | ~x12);
  assign z4 = (~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09);
  assign z5 = ~new_n37_ | x00 | x10 | x12 | ~x13;
  assign new_n37_ = ~x07 & x09;
  assign z6 = ~x07 & (~x09 | (~new_n39_ & new_n40_));
  assign new_n39_ = x01 & x02 & ~x00 & x14;
  assign new_n40_ = (x01 | x02 | ~x03) & ~x10 & (~x00 | ~x08);
  assign z7 = (~x01 & ~x02 & x03) | ~new_n37_ | ~x08 | x10;
  assign z8 = ~new_n37_ | ~new_n33_ | x12 | x02 | ~x03;
endmodule
