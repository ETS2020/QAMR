...
module FAU ( 
  ...
  assign z2 = ~new_n31_ & (~x00 | (~x07 & ~x08)) & (x07 | x09);
  assign new_n31_ = ~x02 & (x01 | (x03 & (x07 | x10)));
  assign z3 = (x00 | ~x12) & (~x07 | ~x11) & (x07 | x09);
  assign z4 = (~x07 | ~x11) & (~x08 | ~x09 | ~x00 | x07);
  assign z5 = x07 | (x09 & (x00 | x10 | x12 | ~x13));
  assign z6 = ~x07 & (~x09 | (~new_n36_ & new_n37_));
  assign new_n36_ = x01 & x02 & ~x00 & x14;
  assign new_n37_ = (x01 | x02 | ~x03) & ~x10 & (~x00 | ~x08);
  assign z7 = ~new_n39_ | (~x01 & ~x02 & x03);
  assign new_n39_ = ~x07 & ~x10 & x08 & x09;
  assign z8 = new_n41_ | x07;
  assign new_n41_ = x09 & (x01 | x02 | x12 | ~x03 | x10);
endmodule
