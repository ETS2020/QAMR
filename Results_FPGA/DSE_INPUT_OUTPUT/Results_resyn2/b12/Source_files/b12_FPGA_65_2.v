...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n30_, new_n32_, new_n37_, new_n38_, new_n39_,
    new_n41_, new_n43_;
  ...
  assign new_n30_ = ~x00 & (~x07 | x11);
  assign z2 = ~new_n32_ & (new_n30_ | (~x07 & ~x08));
  ...
  assign z6 = (x07 & ~x11) | (~new_n37_ & ~new_n38_ & new_n39_);
