...
module FAU ( 
  ...
  assign new_n27_ = ((~x01 & ~x02) | ~x03 | (x05 & x07) | (x02 & x04)) & (~x01 | (x05 & x07) | ~x02 | (x04 & ~x05));
  assign z1 = new_n29_ & (~x05 | (~x07 & (~x06 | ~x01 | ~x02)));
  assign new_n29_ = ~x00 & ((x03 & (x01 | x02)) | (x02 & x04));
  assign z2 = (new_n31_ | x02) & ((~x07 & ~x08) | ~x00 | (x05 & x07));
  assign new_n31_ = ((x09 & ~x10) | x07 | (~x03 & x10)) & (~x01 | (x05 & x07)) & (~x03 | x05 | ~x07);
