...
module FAU ( 
  ...
  assign z6 = ((~x01 & ~x02 & (~x03 ^ x09)) | ~new_n38_ | ~x01 | ~x02) & new_n39_ & (x01 | x02 | (x03 ^ x09) | (new_n38_ & x01 & x02));
  assign new_n38_ = ~x00 & x14;
  assign new_n39_ = (~x00 | ~x08) & ~x10 & x04 & ~x07;
  assign z7 = (x09 & ~x01 & ~x02 & x03) | ~new_n41_ | (~x08 & (x01 | x02 | ~x03));
  assign new_n41_ = ~x10 & x04 & ~x07;
