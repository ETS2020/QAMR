...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & ((~x00 & (x07 | x09)) | (~x08 & ~x07 & x09))) | (new_n32_ & (~x00 | ~x08));
  assign new_n31_ = ~x02 & (x01 | x03);
  assign new_n32_ = ~x07 & x09 & ~x01 & ~x10;
  ...
  assign new_n37_ = ~x10 & (~x03 | x01 | x02);
  assign new_n38_ = (~x00 | ~x08) & (~x01 | ~x02 | x00 | ~x14);
  assign z7 = x07 | (x09 & (~new_n37_ | ~x08));
  assign z8 = ~new_n32_ | x12 | x02 | ~x03;
endmodule
