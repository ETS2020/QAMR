// Benchmark "FAU" written by ABC on Tue Aug 11 21:49:51 2020
...
module FAU ( 
  ...
  assign new_n29_ = (x03 | (x02 & x04)) & ~x00 & (x01 | x02);
  assign z2 = (~x00 | (~x07 & (x05 | ~x08))) & (~new_n32_ | (~x07 & (new_n31_ | x05)));
  ...
  assign z6 = ~x07 & (x05 | (new_n38_ & (~new_n37_ | (x03 ^ x09))));
  assign new_n37_ = ~x01 & ~x02;
  assign new_n38_ = (~x01 | ~x02 | x00 | ~x14) & ~x10 & (~x00 | ~x08);
  assign z7 = (~x08 & (~new_n37_ | ~x03)) | ~new_n40_ | (new_n37_ & x03 & x09);
  assign new_n40_ = ~x05 & ~x07 & ~x10;
