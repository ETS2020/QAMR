...
module FAU ( 
  ...
  assign z1 = new_n30_ & (x03 | x04) & ~x00 & (~x07 | x10);
  ...
  assign new_n40_ = ~x07 & ((~x08 & (~x03 | x01 | x02)) | (~x01 & ~x02 & x03 & x09));
  assign z8 = x10 | (~new_n42_ & ~x07 & (~x00 | x09));
  assign new_n42_ = ~x12 & ~x01 & ~x02 & x03 & x09;
endmodule
