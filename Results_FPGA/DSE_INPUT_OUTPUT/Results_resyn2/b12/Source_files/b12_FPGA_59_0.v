...
module FAU ( 
  ...
  assign z2 = (~x00 & (new_n32_ | new_n34_)) | (~new_n35_ & new_n33_ & ~x08);
  assign new_n32_ = x02 & (x07 | x11);
  assign new_n33_ = ~x07 & x11;
  assign new_n34_ = ~x01 & ((~x03 & (x07 | (x10 & x11))) | (x09 & ~x10 & ~x07 & x11));
  assign new_n35_ = ~x02 & (x01 | (x10 ? x03 : ~x09));
  assign z3 = (~x07 & ~x11) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = x07 ? ~x11 : (x11 & (~x09 | ~x00 | ~x08));
  assign z5 = x07 | (x11 & (x00 | x10 | x12 | ~x13));
  assign z6 = ~x07 & (~x11 | (new_n41_ & ((~x03 & x09) | ~new_n40_ | (x03 & ~x09))));
  assign new_n40_ = ~x01 & ~x02;
  assign new_n41_ = (~x01 | ~x02 | x00 | ~x14) & ~x10 & (~x00 | ~x08);
  assign z7 = ~new_n33_ | x10 | ((~x08 | (new_n40_ & x03)) & (~new_n40_ | ~x03 | x09));
