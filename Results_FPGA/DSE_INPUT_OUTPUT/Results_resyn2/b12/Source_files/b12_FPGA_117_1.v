...
module FAU ( 
  ...
  assign z2 = (x02 & (~x00 | (~x07 & ~x08))) | (~x01 & (new_n31_ | x07));
  assign new_n31_ = (~x03 | ~x10) & (x09 | x10) & (~x00 | ~x08);
  assign z3 = (~x01 & x07) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (x01 | ~x07) & (~x07 | ~x11);
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = (new_n36_ | ~new_n37_) & (~new_n36_ | new_n37_) & (~x00 | ~x08) & ~x07 & ~x10;
  assign new_n36_ = (x03 | ~x09) & ~x01 & ~x02 & (~x03 | x09);
  assign new_n37_ = x01 & x02 & ~x00 & x14;
  assign z7 = (x01 | ~x07) & (new_n39_ | x10);
  assign new_n39_ = ((x03 & ~x01 & ~x02) | x07 | ~x08) & (x01 | x02 | ~x03 | x09);
  assign z8 = (x01 | (~new_n41_ & ~x07)) & (x09 | x10 | ~x00 | x07);
