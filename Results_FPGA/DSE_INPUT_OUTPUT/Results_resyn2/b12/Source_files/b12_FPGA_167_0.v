...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n30_, new_n32_, new_n37_, new_n38_, new_n41_;
  ...
  assign z2 = (~x07 & ~x08) | (~new_n32_ & ~x00);
  assign new_n32_ = ~x02 & ((x03 & (x07 | x10)) | x01 | (~x09 & ~x07 & ~x10));
  assign z3 = (x07 ? ~x11 : x08) & (x00 | ~x12);
  assign z4 = (x07 ? ~x11 : x08) & ((x07 & ~x11) | ~x00 | ~x09);
  assign z5 = x00 | x10 | x07 | ~x08 | x12 | ~x13;
  assign z6 = ~x07 & (~x08 | ((~new_n37_ | new_n38_) & ~x00 & ~x10 & (new_n37_ | ~new_n38_)));
  assign new_n37_ = x14 & x01 & x02;
  assign new_n38_ = ~x01 & ~x02 & (x03 ^ ~x09);
  assign z7 = (new_n29_ & x03 & x09) | x10 | x07 | ~x08;
