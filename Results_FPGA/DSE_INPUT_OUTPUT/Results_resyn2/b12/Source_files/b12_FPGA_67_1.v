...
module FAU ( 
  ...
  assign z1 = new_n29_ & ~x00 & (x07 | ~x12) & (x03 | x04);
  assign new_n29_ = (x02 | (x01 & x03)) & (~x01 | ~x02 | ~x05 | ~x06);
  assign z2 = (~x00 | (~x07 & (~x08 | x12))) & (~new_n32_ | (~x07 & (new_n31_ | x12)));
  ...
  assign z7 = (new_n40_ & x09) | (~new_n40_ & ~x08) | x10 | x07 | x12;
  assign new_n40_ = x03 & ~x01 & ~x02;
  assign z8 = x07 | (~x12 & (x10 | (x09 ? ~new_n40_ : ~x00)));
endmodule
