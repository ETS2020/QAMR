...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & ~x01) | (~new_n32_ & ~new_n33_) | (x07 & x09);
  assign new_n31_ = (~x07 | x00 | x03) & (~x09 | x10 | (x00 & x08));
  assign new_n32_ = x00 & (x07 | x08);
  assign new_n33_ = ~x02 & (~x10 | x01 | x03);
  assign z3 = (~x07 | (~x09 & ~x11)) & (x00 | ~x12);
  assign z4 = (x07 & x09) | ((~x07 | (~x09 & ~x11)) & (~x09 | ~x00 | ~x08));
  ...
  assign z7 = x07 ? ~x09 : ((~x08 & (~new_n41_ | ~x03)) | x10 | (new_n41_ & x03 & x09));
  assign new_n41_ = ~x01 & ~x02;
  assign z8 = (~new_n43_ & x09) | (~x00 & ~x09) | x07 | x10;
