...
module FAU ( 
  ...
  assign z2 = ~new_n31_ & ((~x07 & ~x08) | ~x00 | (x03 & x07));
  assign new_n31_ = ~x02 & ((x01 & (~x03 | ~x07)) | ((~x09 | x10) & ~x07 & (x03 | ~x10)));
  assign z3 = (~x07 | (~x03 & ~x11)) & (x00 | ~x12);
  assign z4 = (~x07 & (~x09 | ~x00 | ~x08)) | (x03 & x07) | (x07 & ~x11);
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = ~new_n36_ & ((x03 & x07) | (~new_n37_ & new_n38_));
  assign new_n36_ = ~x01 & ~x02 & ((~x03 & ~x09) | (~x07 & x03 & x09));
  assign new_n37_ = x01 & x02 & ~x00 & x14;
  assign new_n38_ = (~x00 | ~x08) & ~x07 & ~x10;
  assign z7 = (~x08 & (~new_n40_ | ~x03)) | x07 | x10 | (new_n40_ & x03 & x09);
  assign new_n40_ = ~x01 & ~x02;
  assign z8 = (~x03 | ~x07) & (x10 | (~new_n42_ & (x09 | ~x00 | x07)));
  assign new_n42_ = ~x12 & x03 & x09 & ~x01 & ~x02;
endmodule
