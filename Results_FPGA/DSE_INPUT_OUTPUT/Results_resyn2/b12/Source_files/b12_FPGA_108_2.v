...
module FAU ( 
  ...
  assign z1 = new_n28_ | (new_n30_ & ((x02 & x04) | (x03 & (x01 | x02))));
  assign new_n30_ = ~x00 & (~x01 | ~x02 | ~x05 | ~x06);
  ...
  assign z5 = x06 | x07 | x10 | ~x13 | x00 | x12;
  assign z6 = ((~x01 & ~x02 & (x03 ^ ~x09)) | ~new_n40_ | ~x01 | ~x02) & new_n41_ & (x01 | x02 | (~x03 ^ ~x09) | (new_n40_ & x01 & x02));
  assign new_n40_ = ~x00 & x14;
  assign new_n41_ = (~x00 | ~x08) & ~x06 & ~x07 & ~x10;
  assign z7 = x07 | (~new_n43_ & ~x06);
  assign new_n43_ = (~x09 | ~x03 | x01 | x02) & ~x10 & (x08 | (x03 & ~x01 & ~x02));
  assign z8 = new_n45_ | x06 | x07 | x10;
  assign new_n45_ = (~x00 | x09) & (x12 | ~x09 | x01 | x02 | ~x03);
endmodule
