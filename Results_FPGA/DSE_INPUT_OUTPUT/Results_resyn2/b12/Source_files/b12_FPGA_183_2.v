...
module FAU ( 
  ...
  assign new_n27_ = ((~x05 & x02 & x04) | (~x02 & ~x03) | ~x01 | (x03 & ~x07)) & (x01 | ~x02 | ~x07 | ~x03 | x04);
  ...
  assign z4 = (x07 ? ~x11 : ~x03) & (~x00 | ~x08 | ~x09 | (x07 & ~x11));
  assign z5 = x03 | x07 | x00 | x10 | x12 | ~x13;
  assign z6 = new_n37_ & ((~x01 & x02) | ((x01 | x09) & (~x14 | x00 | ~x02)));
  assign new_n37_ = (~x00 | ~x08) & ~x10 & ~x03 & ~x07;
  assign z7 = x07 | (~x03 & (~x08 | x10));
