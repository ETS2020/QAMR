...
module FAU ( 
  ...
  assign new_n27_ = ~x00 & (~x07 | x12);
  assign z1 = new_n29_ & new_n27_ & (x03 | x04);
  assign new_n29_ = (x02 | (x01 & x03)) & (~x01 | ~x02 | ~x05 | ~x06);
  assign z2 = ~new_n31_ & ((~x00 & x12) | (~x07 & (~x00 | ~x08)));
  assign new_n31_ = ~x02 & ((~x10 & ~x07 & ~x09) | x01 | (x03 & (x07 | x10)));
  assign z3 = (x00 | ~x12) & (~x07 | (~x11 & x12));
  assign z4 = (~x07 & (~x00 | ~x08)) | (x07 & ~x11) | (x07 & ~x12) | (~x07 & ~x09);
  ...
  assign z7 = x07 ? x12 : ~new_n39_;
  assign new_n39_ = (x08 | (x03 & ~x01 & ~x02)) & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (x12 | (~x07 & (~new_n41_ | ~x09 | x10))) & (~x00 | x10 | x07 | x09);
