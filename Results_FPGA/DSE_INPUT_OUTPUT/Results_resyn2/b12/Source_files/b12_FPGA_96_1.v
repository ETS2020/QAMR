...
module FAU ( 
  ...
  assign z5 = (x13 | ~x14) & (x00 | x07 | ~x13 | x10 | x12);
  assign z6 = ~new_n37_ & new_n38_ & (x01 | x02 | (~x03 ^ ~x09));
  assign new_n37_ = x14 & (~x13 | (~x00 & x01 & x02));
  assign new_n38_ = ~x07 & ~x10 & (~x00 | ~x08);
  assign z7 = (~new_n40_ & ~x08) | (new_n40_ & x09) | new_n28_ | x07 | x10;
  assign new_n40_ = ~x01 & ~x02 & x03;
  assign z8 = ~new_n42_ | (x09 & (~new_n40_ | x12));
  assign new_n42_ = (x13 | ~x14) & ~x07 & ~x10 & (x00 | x09);
endmodule
