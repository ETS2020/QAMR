...
module FAU ( 
  ...
  assign z4 = (~x11 | ~x07 | x08) & (~x00 | x07 | x11 | ~x08 | ~x09);
  assign z5 = ~x13 | x10 | x12 | new_n28_ | x00 | x07;
  assign z6 = ~new_n37_ & new_n38_ & (~x08 | (~x00 & ~x11));
  assign new_n37_ = (x03 | ~x09) & ~x01 & ~x02 & (~x03 | x09);
  assign new_n38_ = ~x07 & ~x10 & (~x01 | ~x02 | x00 | ~x14);
  assign z7 = (~x08 | (~x11 & (new_n40_ | x07 | x10))) & (~new_n40_ | x09 | x07 | x10);
  assign new_n40_ = ~x01 & ~x02 & x03;
  assign z8 = ~new_n42_ | (x09 & (~new_n40_ | x12));
  assign new_n42_ = (x00 | x09) & ~x07 & ~x10 & (~x08 | ~x11);
endmodule
