...
module FAU ( 
  ...
  assign z1 = (x06 & ~x07) | (~new_n29_ & new_n30_);
  assign new_n29_ = (~x02 | ~x04) & (~x03 | (~x01 & ~x02));
  assign new_n30_ = ~x00 & (~x01 | ~x02 | ~x05 | ~x06);
  assign z2 = (~x00 | (~x07 & (x06 | ~x08))) & (~new_n33_ | (~x07 & (new_n32_ | x06)));
  ...
  assign z6 = ~x07 & (x06 | (~new_n38_ & new_n39_));
  assign new_n38_ = (x03 | ~x09) & (~x03 | x09) & ~x01 & ~x02;
  assign new_n39_ = (~x01 | ~x02 | x00 | ~x14) & ~x10 & (~x00 | ~x08);
  assign z7 = (new_n41_ & x09) | (~new_n41_ & ~x08) | x10 | x06 | x07;
  assign new_n41_ = x03 & ~x01 & ~x02;
  assign z8 = (~new_n43_ & x09) | x10 | x06 | x07 | (~x00 & ~x09);
