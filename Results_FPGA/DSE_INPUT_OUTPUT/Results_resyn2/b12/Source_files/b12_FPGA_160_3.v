...
module FAU ( 
  ...
  assign z4 = (x11 & x12) | ((~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09));
  assign z5 = (~x11 | ~x12) & (~new_n35_ | ~x13 | x00 | x12);
  assign new_n35_ = ~x07 & ~x10;
  assign z6 = ((~x03 & x09) | x01 | x02 | (x03 & ~x09)) & new_n38_ & (~new_n37_ | ~x01 | ~x02);
  assign new_n37_ = ~x00 & x14;
  assign new_n38_ = (~x00 | ~x08) & (~x11 | ~x12) & ~x07 & ~x10;
  assign z7 = (~x11 | ~x12) & ((new_n40_ & x09) | ~new_n35_ | (~new_n40_ & ~x08));
  assign new_n40_ = ~x01 & ~x02 & x03;
  assign z8 = ~new_n35_ | ((~new_n40_ | ~x09 | x12) & ((x11 & x12) | ~x00 | x09));
endmodule
