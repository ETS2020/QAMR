...
module FAU ( 
  ...
  assign z1 = new_n29_ & ~x00 & (~x07 | ~x10) & (x03 | x04);
  assign new_n29_ = (x02 | (x01 & x03)) & (~x01 | ~x02 | ~x05 | ~x06);
  assign z2 = (~new_n31_ & ~x01 & (~x00 | ~x08)) | new_n32_ | new_n33_;
  assign new_n31_ = (x03 | ~x10) & (~x09 | x07 | x10);
  assign new_n32_ = x02 & (~x00 | (~x07 & ~x08));
  assign new_n33_ = x07 & (x10 | (~x03 & ~x00 & ~x01));
  assign z3 = (x07 & x10) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (x10 | ~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09);
  ...
  assign z7 = (x07 ^ x10) | ((~new_n41_ | x09) & ~x07 & (new_n41_ | ~x08));
  assign new_n41_ = x03 & ~x01 & ~x02;
  assign z8 = (x09 & (~new_n41_ | x12)) | (~x00 & ~x09) | x07 | x10;
endmodule
