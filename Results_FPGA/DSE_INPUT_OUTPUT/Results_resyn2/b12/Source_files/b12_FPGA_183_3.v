...
module FAU ( 
  ...
  assign new_n27_ = ((~x05 & x02 & x04) | ~x01 | (x03 & x07) | (~x02 & ~x03)) & (x01 | ~x02 | x07 | ~x03 | x04);
  ...
  assign z7 = (~x03 & (x07 | ~x08)) | (~x07 & ((~new_n39_ & ~x08) | x10 | (new_n39_ & x03 & x09)));
  assign new_n39_ = ~x01 & ~x02;
  assign z8 = (~x03 | (~new_n41_ & ~x07)) & (x07 | x10 | ~x00 | x09);
  assign new_n41_ = ~x01 & ~x02 & ~x12 & x09 & ~x10;
endmodule
