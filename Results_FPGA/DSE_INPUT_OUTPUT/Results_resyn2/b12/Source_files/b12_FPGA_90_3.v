...
module FAU ( 
  ...
  assign z2 = ~new_n31_ & (~x00 | ~x08) & (~x07 | (~x00 & ~x09));
  assign new_n31_ = ~x02 & ((~x09 & ~x07 & ~x10) | x01 | (x03 & (x07 | x10)));
  assign z3 = (x07 & x09) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (x07 & x09) | ((~x07 | ~x11) & (~x09 | ~x00 | ~x08));
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = ~new_n36_ & (x07 | (~new_n37_ & ~new_n38_ & new_n39_));
  assign new_n36_ = ~x09 & (x07 | (~x03 & ~x01 & ~x02));
  assign new_n37_ = x02 & x14 & ~x00 & x01;
  assign new_n38_ = ~x02 & x03 & ~x01 & x09;
  assign new_n39_ = ~x10 & (~x00 | ~x08);
  assign z7 = (new_n41_ & x09) | x07 | x10 | (~new_n41_ & ~x08);
  assign new_n41_ = ~x01 & ~x02 & x03;
  assign z8 = (x09 & (~new_n41_ | x12)) | x07 | x10 | (~x00 & ~x09);
endmodule
