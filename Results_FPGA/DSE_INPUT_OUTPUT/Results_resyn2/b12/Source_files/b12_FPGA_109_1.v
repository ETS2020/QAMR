...
module FAU ( 
  ...
  assign z1 = ~new_n29_ & ~x00 & (x07 | ~x10);
  assign new_n29_ = ((x06 & x01 & x05) | ~x02 | (~x03 & ~x04)) & (~x03 | ~x01 | x02);
  assign z2 = new_n31_ & (x07 | (~x10 & (x02 | x09)));
  assign new_n31_ = (~x07 | (~x00 & (x02 | ~x03))) & (~x01 | x02) & (~x00 | ~x08);
  assign z3 = (~x07 | ~x11) & (~x12 | x00 | (~x07 & x10));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (x07 | ~x10) & (~x07 | ~x11);
  assign z5 = x07 | (~x10 & (~x13 | x00 | x12));
  assign z6 = (new_n36_ | x01 | x02) & new_n37_ & (~x01 | ~x02 | x00 | ~x14);
  assign new_n36_ = x03 ^ x09;
  assign new_n37_ = ~x07 & ~x10 & (~x00 | ~x08);
  assign z7 = x07 | ((~new_n39_ | x09) & ~x10 & (new_n39_ | ~x08));
  assign new_n39_ = ~x01 & ~x02 & x03;
  assign z8 = x07 | ((~new_n39_ | ~x09 | x12) & ~x10 & (~x00 | x09));
endmodule
