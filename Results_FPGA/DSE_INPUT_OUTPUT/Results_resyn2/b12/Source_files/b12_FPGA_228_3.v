...
module FAU ( 
  ...
  assign z1 = new_n29_ & ~x00 & (~x07 | ~x14) & (x03 | x04);
  assign new_n29_ = (x02 | (x01 & x03)) & (~x01 | ~x02 | ~x05 | ~x06);
  assign z2 = ~new_n31_ & ((~x07 & ~x08) | (~x00 & (~x07 | ~x14)));
  assign new_n31_ = ~x02 & ((~x09 & ~x07 & ~x10) | x01 | (x03 & (x07 | x10)));
  assign z3 = (x07 & x14) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (~x07 | ~x11) & (~x07 | ~x14);
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = (x07 & x14) | (~new_n36_ & ~new_n37_ & new_n38_);
  ...
  assign new_n40_ = (~x08 | (x03 & ~x01 & ~x02)) & (x01 | x02 | ~x03 | x09);
