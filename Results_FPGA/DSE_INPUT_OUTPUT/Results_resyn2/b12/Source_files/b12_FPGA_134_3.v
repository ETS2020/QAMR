...
module FAU ( 
  ...
  assign z1 = new_n29_ & (x03 | x04) & ~x00 & (~x07 | ~x10);
  assign new_n29_ = (x02 | (x01 & x03)) & (~x01 | ~x02 | ~x05 | ~x06);
  assign z2 = new_n32_ | new_n33_ | (~new_n31_ & ~x01 & (~x00 | ~x08));
  ...
  assign z7 = (x07 ^ x10) | (~new_n41_ & ~x10);
  assign new_n41_ = (x08 | (x03 & ~x01 & ~x02)) & (~x03 | ~x09 | x01 | x02);
  assign z8 = (x07 ^ x10) | (~new_n43_ & ~x07 & (~x00 | x09));
