...
module FAU ( 
  ...
  assign z3 = (~x07 | ~x11) & ((~x07 & ~x14) | x00 | ~x12);
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (x07 | x14) & (~x07 | ~x11);
  assign z5 = x07 | x10 | x00 | x12 | ~x13 | ~x14;
  assign z6 = ((~x03 & x09) | (x03 & ~x09) | x01 | x02) & new_n39_ & (~x02 | x00 | ~x01);
  assign new_n39_ = (~x00 | ~x08) & x14 & ~x07 & ~x10;
  assign z7 = (new_n41_ & x09) | (~new_n41_ & ~x08) | ~x14 | x07 | x10;
  assign new_n41_ = ~x01 & ~x02 & x03;
  assign z8 = x07 | (x14 & ((~new_n43_ & x09) | x10 | (~x00 & ~x09)));
