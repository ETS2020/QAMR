...
module FAU ( 
  ...
  assign z2 = ~new_n32_ & ((~x07 & (~x00 | ~x08)) | (~x00 & x12));
  assign new_n32_ = ~x02 & ((~x10 & ~x07 & ~x09) | x01 | (x03 & (x07 | x10)));
  assign z3 = ~x12 | (x00 & (~x07 | ~x11));
  assign z4 = (~new_n35_ & ~x07) | (x07 & ~x11) | (~x07 & ~x09) | (x07 & ~x12);
  assign new_n35_ = x00 & x08;
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = (x07 & ~x12) | (~new_n38_ & ~new_n39_ & ~x10 & ~new_n35_ & ~x07);
  assign new_n38_ = (x03 | ~x09) & (~x03 | x09) & ~x01 & ~x02;
