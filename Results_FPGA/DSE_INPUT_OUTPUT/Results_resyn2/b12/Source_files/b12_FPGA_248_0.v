...
module FAU ( 
  ...
  assign z1 = new_n29_ & (x03 | x04) & ~x00 & (x07 | x09);
  assign new_n29_ = (x02 | (x01 & x03)) & (~x01 | ~x02 | ~x05 | ~x06);
  assign z2 = new_n31_ | new_n32_;
  assign new_n31_ = (~x00 | (~x07 & ~x08)) & (x02 | (~x01 & ~x03));
  assign new_n32_ = ~x07 & (~x09 | ((~x00 | ~x08) & ~x01 & ~x10));
  assign z3 = (x07 ? ~x11 : x09) & (x00 | ~x12);
  assign z4 = (~x07 & (~x00 | ~x08)) | (~x07 & ~x09) | (x07 & ~x11);
  assign z5 = x10 | x07 | ~x09 | ~x13 | x00 | x12;
  assign z6 = new_n37_ & (~x00 | ~x08) & ~x10 & ~x07 & x09;
  assign new_n37_ = (~x01 | ~x02 | x00 | ~x14) & (x01 | x02 | ~x03);
  assign z7 = new_n39_ | x07;
  assign new_n39_ = x09 & ((x03 & ~x01 & ~x02) | ~x08 | x10);
  assign z8 = ~new_n41_ | x01 | x02 | ~x03;
  assign new_n41_ = ~x12 & ~x10 & ~x07 & x09;
endmodule
