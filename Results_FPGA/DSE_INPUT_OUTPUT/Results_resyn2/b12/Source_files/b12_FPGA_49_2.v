...
module FAU ( 
  ...
  assign z2 = ~new_n32_ & ((~x07 & ~x08) | (~x00 & (~x07 | x09)));
  assign new_n32_ = ~x02 & ((x03 & (x07 | x10)) | x01 | (~x09 & ~x10));
  assign z3 = (~x07 | (x09 & ~x11)) & (x00 | ~x12);
  assign z4 = (~x07 | (x09 & ~x11)) & (~x00 | ~x08 | x07 | ~x09);
  ...
  assign z7 = (x09 & (new_n40_ | x07)) | (~x07 & (x10 | (~new_n40_ & ~x08)));
  assign new_n40_ = x03 & ~x01 & ~x02;
  assign z8 = (x09 & (~new_n40_ | x12)) | (~x00 & ~x09) | x07 | x10;
endmodule
