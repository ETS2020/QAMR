...
module FAU ( 
  ...
  wire new_n27_, new_n29_, new_n31_, new_n32_, new_n37_, new_n38_, new_n41_;
  ...
  assign z2 = new_n31_ | (~x07 & (~x09 | (new_n32_ & ~x01)));
  assign new_n31_ = (~x00 | (~x07 & ~x08)) & (x02 | (~x01 & ~x03));
  assign new_n32_ = ~x10 & (~x00 | ~x08);
  assign z3 = (~x07 | ~x11) & ((~x07 & ~x09) | x00 | ~x12);
  assign z4 = (x07 | ~x00 | ~x08) & (x07 | x09) & (~x07 | ~x11);
  assign z5 = x07 | (x09 & (x00 | x10 | x12 | ~x13));
  assign z6 = ~x07 & (~x09 | (~new_n37_ & new_n32_ & ~new_n38_));
  assign new_n37_ = x01 & x02 & ~x00 & x14;
  assign new_n38_ = ~x01 & ~x02 & x03;
  assign z7 = new_n38_ | ~x09 | x10 | x07 | ~x08;
  assign z8 = ~new_n41_ | x12 | ~x03 | x07;
  assign new_n41_ = ~x01 & ~x02 & x09 & ~x10;
endmodule
