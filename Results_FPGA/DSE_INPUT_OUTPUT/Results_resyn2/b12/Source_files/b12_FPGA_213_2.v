...
module FAU ( 
  ...
  assign z2 = (x07 & ~x10) | (~new_n31_ & (~x00 | (~x07 & ~x08)));
  assign new_n31_ = ~x02 & ((x03 & x10) | x01 | (~x09 & ~x10));
  assign z3 = (x07 & ~x10) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (~x10 | ~x07 | ~x11);
  ...
  assign z7 = x10 | ((~new_n39_ | x09) & ~x07 & (new_n39_ | ~x08));
