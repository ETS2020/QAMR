...
module FAU ( 
  ...
  assign z3 = (~x07 | ~x11) & (~x12 | x00 | (~x11 & x13));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (x11 | ~x13) & (~x07 | ~x11);
  assign z5 = x07 | x10 | x12 | ~x13 | x00 | ~x11;
  assign z6 = (x01 | x02 | (~x03 ^ ~x09)) & new_n37_ & (~new_n36_ | ~x01 | ~x02);
  assign new_n36_ = ~x00 & x14;
  assign new_n37_ = (~x00 | ~x08) & (x11 | ~x13) & ~x07 & ~x10;
  assign z7 = (x09 & ~x01 & ~x02 & x03) | ~new_n39_ | (~x08 & (x01 | x02 | ~x03));
  assign new_n39_ = (x11 | ~x13) & ~x07 & ~x10;
  assign z8 = ~new_n39_ | new_n41_;
  assign new_n41_ = (~x00 | x09) & (x12 | ~x09 | x01 | x02 | ~x03);
endmodule
