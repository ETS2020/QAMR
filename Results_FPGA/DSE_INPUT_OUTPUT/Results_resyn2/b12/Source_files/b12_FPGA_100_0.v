...
module FAU ( 
  ...
  assign z2 = (~new_n31_ & ~x00) | (~new_n32_ & ~x08 & x03 & ~x07);
  assign new_n31_ = (~x02 | (~x03 & ~x07)) & ((x03 & (x07 | ~x09 | x10)) | x01 | (~x03 & ~x07));
  ...
  assign new_n37_ = (~x02 | ~x14 | x00 | ~x01) & (x01 | x02 | ~x09);
  assign z7 = new_n39_ | x07;
  assign new_n39_ = x03 & ((~x08 & (x01 | x02)) | x10 | (x09 & ~x01 & ~x02));
  assign z8 = x07 | (~new_n41_ & x03);
  assign new_n41_ = ~x10 & ((x00 & ~x09) | (~x12 & ~x01 & ~x02 & x09));
endmodule
