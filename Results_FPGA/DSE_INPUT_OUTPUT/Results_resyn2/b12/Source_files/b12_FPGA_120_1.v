...
module FAU ( 
  ...
  assign z2 = (~x00 | (~x07 & (~x08 | x10))) & (new_n31_ | x02 | (~x07 & x10));
  assign new_n31_ = (~x03 | ~x07) & ~x01 & (x07 | x09);
  assign z3 = (x07 ? ~x11 : ~x10) & (x00 | ~x12);
  assign z4 = (~x07 & (x10 | ~x00 | ~x08)) | (~x07 & ~x09) | (x07 & ~x11);
  assign z5 = x07 | (~x10 & (~x13 | x00 | x12));
  assign z6 = ((~x03 & x09) | (x03 & ~x09) | x01 | x02) & new_n37_ & (~new_n36_ | ~x01 | ~x02);
  assign new_n36_ = ~x00 & x14;
  assign new_n37_ = (~x00 | ~x08) & ~x07 & ~x10;
  assign z7 = (~x08 & (~x03 | x01 | x02)) | ~new_n39_ | (~x02 & x03 & ~x01 & x09);
  assign new_n39_ = ~x07 & ~x10;
  assign z8 = x07 | (~new_n41_ & ~x10 & (~x00 | x09));
  assign new_n41_ = ~x12 & ~x02 & x03 & ~x01 & x09;
endmodule
