...
module FAU ( 
  ...
  assign new_n27_ = ((x02 & (x04 | x07)) | (~x01 & ~x02) | ~x03) & ((x04 & ~x05) | ~x01 | ~x02);
  assign z1 = (~new_n29_ & ~x00) | (~x01 & x07);
  assign new_n29_ = (~x01 | x02 | ~x03) & ((x06 & x01 & x05) | ~x02 | (~x03 & ~x04));
  assign z2 = ((x02 | (~new_n31_ & ~x01)) & ~x07 & (~x00 | ~x08)) | (x01 & ~x00 & x02);
  assign new_n31_ = x10 ? x03 : ~x09;
  assign z3 = (~x07 | (x01 & ~x11)) & (x00 | ~x12);
  assign z4 = (~x07 | (x01 & ~x11)) & (x07 | ~x08 | ~x00 | ~x09);
  ...
  assign z8 = (x01 | (~x07 & (~new_n41_ | ~x09 | x10))) & (~x00 | x07 | x09 | x10);
  assign new_n41_ = ~x12 & ~x02 & x03;
endmodule
