...
module FAU ( 
  ...
  assign z2 = ~new_n31_ & (~x07 | (~x00 & ~x03)) & (~x00 | ~x08);
  assign new_n31_ = ~x02 & ((~x10 & ~x07 & ~x09) | x01 | (x03 & x10));
  assign z3 = (x03 & x07) | ((~x07 | ~x11) & (x00 | ~x12));
  assign z4 = (~x00 | ~x08 | x07 | ~x09) & (x03 | ~x07 | ~x11);
  ...
  assign z8 = (~x03 | ~x07) & (x10 | (~new_n41_ & (~x00 | x07 | x09)));
  assign new_n41_ = ~x12 & x03 & x09 & ~x01 & ~x02;
endmodule
