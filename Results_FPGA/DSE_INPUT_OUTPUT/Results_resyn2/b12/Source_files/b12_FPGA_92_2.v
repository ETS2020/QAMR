...
module FAU ( 
  ...
  assign z3 = (~x11 | (~x07 & x14)) & (x00 | ~x12);
  assign z4 = (~x11 | (~x07 & x14)) & (~x00 | ~x08 | x07 | ~x09);
  assign z5 = ((x00 | x07) & (~x11 | x14)) | (~new_n36_ & ~x00 & (~x11 | (~x07 & x14)));
  assign new_n36_ = x13 & ~x10 & ~x12;
  assign z6 = (x01 | x02 | (x03 ^ x09)) & new_n39_ & (~new_n38_ | ~x01 | ~x02);
  assign new_n38_ = ~x00 & x14;
  assign new_n39_ = (~x00 | ~x08) & (~x11 | x14) & ~x07 & ~x10;
  assign z7 = (~x08 & (x01 | x02 | ~x03)) | ~new_n41_ | (x09 & ~x01 & ~x02 & x03);
  assign new_n41_ = ~x07 & ~x10 & (~x11 | x14);
