...
module FAU ( 
  ...
  assign z3 = new_n40_ | new_n41_ | (~new_n39_ & x0);
  assign new_n39_ = (x5 | (x6 & (x3 | (new_n37_ & ~x8)))) & ((x6 & (new_n37_ | ~x8)) | ~x3 | (~x6 & (new_n33_ | x8)));
  assign new_n40_ = ~x6 & (((new_n33_ | x8) & ~x0 & x3) | (new_n33_ & ~x5 & x8));
  assign new_n41_ = x6 & (x3 | (new_n37_ & ~x8)) & (new_n37_ | ~x8) & ~x0 & ~x5;
  assign z4 = new_n43_ | (new_n37_ & x6 & ~x8 & ~x0 & ~x5);
  assign new_n43_ = (~x0 | (x5 & (new_n44_ | x6))) & x3 & (x5 | (~new_n45_ & x6));
