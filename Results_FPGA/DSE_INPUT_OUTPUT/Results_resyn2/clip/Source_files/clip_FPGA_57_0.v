...
module FAU ( 
  ...
  assign new_n26_ = (x6 | (~new_n22_ & (~x1 | ~x2 | ~x7) & (x7 | (x1 & x2)))) & ((x1 & (~x6 | (~x2 & ~x7))) | new_n27_ | (x7 & (~x1 | x2)));
  assign new_n27_ = x5 & ~x0 & (x3 | ~x8);
  assign new_n28_ = (new_n30_ | (x1 & x2 & x7) | (~x7 & (~x1 | ~x2))) & (~new_n31_ | ((~x2 | ~x7) & (new_n29_ | ~x1 | x2 | x7)));
  assign new_n29_ = ~x0 & (x3 | ~x8);
  assign new_n30_ = x6 & (x1 | (~x0 & x3 & ~x8));
  assign new_n31_ = x6 & (x0 | (~x3 & x8) | ~x3 | x8);
  assign z2 = new_n33_ | new_n36_ | new_n39_ | (~x4 & ~x5);
  assign new_n33_ = ~x6 & (new_n34_ | new_n22_ | (~new_n35_ & (~x3 ^ x8)));
  assign new_n34_ = (~x2 | ((~x7 | (~x1 & x3)) & (~x4 | (~x1 & (x3 | x8))))) & (~x4 | ~x7) & (x3 | x8) & (~x3 | ~x8);
  assign new_n35_ = (~x1 | ~x2 | ~x7) & (~x4 | (~x7 & (~x1 | ~x2)));
  assign new_n36_ = x6 & ((~new_n38_ & (x3 ^ ~x8)) | (new_n37_ & ~x5 & x3 & ~x8));
  assign new_n37_ = x7 & (~x1 | x2);
  assign new_n38_ = ((x7 & (~x1 | x2)) | (x5 & (~x0 | ~x4))) & (~x0 | ~x1 | x2 | x7);
  assign new_n39_ = (~x4 | (x7 & (~x1 | x2))) & ~new_n40_ & (~x1 | x2 | x7) & (x6 | (~x1 & ~x4));
  assign new_n40_ = (x3 | ~x8) & (~x0 | ~x3 | x8);
  assign z3 = ((~new_n42_ | x0) & ~new_n43_ & ~x6) | new_n48_ | (~new_n46_ & x6);
  ...
  assign z4 = (x5 | (~new_n50_ & x4 & ~x0 & x6)) & (new_n42_ | ~x0 | x6);
  assign new_n50_ = (new_n37_ | (~x3 & x8)) & (~x3 | x8);
endmodule
