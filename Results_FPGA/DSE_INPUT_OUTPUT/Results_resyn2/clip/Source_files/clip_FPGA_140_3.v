...
module FAU ( 
  ...
  assign new_n21_ = (new_n22_ | (x4 & x7) | (~x4 & ~x7)) & (~x0 | (~x3 & ~x8) | (~x4 & ~x7 & (~x3 | ~x8))) & ((x4 & ~x7) | ~new_n22_ | (~x4 & x7));
  ...
  assign new_n28_ = ~x5 & ((new_n29_ & ~x3 & ~x8) | x6 | (x0 & (x3 | x8)));
  assign new_n29_ = (x4 | x7) & ((x1 & x2) | (x4 & x7));
  assign new_n30_ = (new_n29_ | (~x3 ^ ~x8)) & ~x0 & (~new_n29_ | (~x3 & ~x8) | (x3 & x8) | (~x3 & x6));
  assign new_n31_ = (x4 | ~x7) & ((x4 & ~x7) | (x1 & ~x2));
  assign z3 = new_n33_ ? ~x0 : (x0 | ((new_n29_ | (x3 & x8)) & ~x6 & (x3 | x8)));
  assign new_n33_ = ~x5 & x6 & (x3 | ~x8) & (new_n31_ | (x3 & ~x8));
