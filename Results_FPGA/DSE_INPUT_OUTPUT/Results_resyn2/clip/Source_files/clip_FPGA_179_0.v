...
module FAU ( 
  ...
  assign z2 = (~x6 & (~new_n33_ | ~new_n34_)) | new_n28_ | ~new_n31_;
  assign new_n28_ = (new_n29_ | (~new_n30_ & x6)) & (x3 | x8) & (~x3 | ~x8) & (x0 | x8);
  assign new_n29_ = ~x1 & ~x4;
  assign new_n30_ = (~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4));
  assign new_n31_ = (x0 | x5) & (~new_n32_ | (~x3 ^ ~x8) | ~x0 | ~x6);
  assign new_n32_ = (x1 | x4) & (~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4));
  assign new_n33_ = (x5 | (~x3 & ~x8)) & ((x3 & x8) | (~x3 & ~x8) | x7 | (x1 & x4) | (x4 & ~x8));
  assign new_n34_ = ((x1 & x2) | (x4 & x7) | (~x3 & ~x8) | (x3 & x8) | (x2 & ~x3)) & ((~x3 ^ ~x8) | (~x4 & ~x7) | ((~x1 | ~x2) & (~x4 | ~x7)));
  assign z3 = new_n39_ | (~x6 & ((~new_n36_ & x0) | (new_n38_ & ~x0 & x5)));
  assign new_n36_ = ~new_n37_ & x5 & (x8 | (~new_n29_ & x3));
  assign new_n37_ = (~x3 | ~x8) & ((~x7 & (~x1 | ~x4)) | (~x2 & (~x4 | ~x7)));
  assign new_n38_ = (x3 | x8) & ((x3 & x8) | ((x4 | x7) & (new_n24_ | (x4 & x7))));
  assign new_n39_ = (new_n29_ | ~new_n30_ | (~x3 & x8)) & x0 & ((new_n29_ & ~x3) | (x6 & (~x3 | x8)));
