...
module FAU ( 
  ...
  assign new_n22_ = (new_n23_ | (x4 & x7) | (~x4 & ~x7)) & (~x0 | (~x3 & ~x8) | (~x4 & ~x7 & (~x3 | ~x8))) & ((~x4 & x7) | ~new_n23_ | (x4 & ~x7));
  assign new_n23_ = x1 & x2;
  assign new_n24_ = (~x1 | (x6 & (x2 | (~x4 & ~x7) | (x4 & x7)))) & ~new_n25_ & ((x4 & ~x7) | (x1 & ~x2));
  ...
  assign new_n29_ = ~x6 & (~new_n31_ | (x0 & (x3 | x8)) | (new_n30_ & (x3 ^ ~x8)));
  assign new_n30_ = (x4 | x7) & ((x1 & x2) | (x4 & x7));
  assign new_n31_ = ((x4 & x7) | (x1 & x2) | (x2 & ~x3) | (x3 & x8) | (~x3 & ~x8)) & (((x3 | ~x8) & (x4 | ~x3 | x8)) | x7 | (x1 & x4));
  ...
  assign new_n36_ = (~x0 | ~x6 | (~x3 & x8) | (~new_n33_ & (~x3 | x8))) & ~x5 & (x0 | (x6 & (x3 | ~x8) & (new_n33_ | (x3 & ~x8))));
  assign z4 = ~x0 & (x5 | (x6 & (x3 | ~x8) & (new_n33_ | (x3 & ~x8))));
endmodule
