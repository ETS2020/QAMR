...
module FAU ( 
  ...
  assign new_n17_ = x6 & (x3 | ~x8) & ~x0 & x5;
  ...
  assign new_n26_ = (x3 | ~x8) & ~x0 & x5 & ((x3 & ~x8) | x4 | ~x7);
  ...
  assign new_n32_ = (x3 | ~x8) & (~x3 | x8) & x6 & (x0 | ~x5) & (~x0 | x5);
  assign new_n33_ = (~x0 | x5) & (x3 ^ x8);
  assign new_n34_ = (x6 | (~x1 & ~x4)) & (x8 | x0 | ~x5);
  assign z3 = (~x0 & ((~new_n36_ & ~new_n37_ & ~x6) | (new_n38_ & ~x5 & x6))) | (x5 & (new_n36_ | new_n37_ | x6) & x0 & (~new_n38_ | ~x6));
  assign new_n36_ = ((~x4 & ~x7) | ((~x1 | ~x2) & (~x4 | ~x7))) & (~x3 | ~x8);
  assign new_n37_ = ~x3 & ~x8;
  assign new_n38_ = (x3 | ~x8) & ((x3 & ~x8) | ((x4 | ~x7) & ((x4 & ~x7) | (x1 & ~x2))));
  assign z4 = (x5 & (new_n36_ | new_n37_ | x6)) | (new_n38_ & x6) | (x0 & ~x5) | (~x0 & x5);
endmodule
