...
module FAU ( 
  ...
  assign new_n31_ = (x5 | ((~x0 | (~x3 & ~x8)) & (~x3 | (x8 ? ~new_n33_ : new_n32_)))) & ((~new_n33_ & ~x8) | x3 | (new_n32_ & x8));
  assign new_n32_ = (x7 | (x1 & x4)) & (x2 | (x4 & x7));
  assign new_n33_ = (x4 | x7) & ((x1 & x2) | (x4 & x7));
  assign new_n34_ = (new_n35_ | (x8 ? x3 : (~x3 | x5))) & (~new_n36_ | ((x3 | x8 | (~x0 & x5)) & (~x3 | x5 | ~x8)));
  assign new_n35_ = (~x7 | (x1 & x4)) & (~x2 | (x4 & ~x7));
  assign new_n36_ = (x4 | ~x7) & ((x4 & ~x7) | (x1 & ~x2));
  assign new_n37_ = ~x1 & ~x4 & (x8 ? ~x3 : (x3 & ~x5));
  assign z3 = new_n42_ | new_n43_ | (x0 & (new_n40_ | (~new_n39_ & ~x5)));
  assign new_n39_ = x6 & (new_n36_ | ~x8);
  assign new_n40_ = ~new_n41_ & ~x3 & (x6 | ~new_n33_ | ~x8);
  assign new_n41_ = (~x7 | (x1 & x4)) & (~x2 | (x4 & ~x7)) & (x1 | x4) & x6 & ~x8;
  assign new_n42_ = (new_n36_ | (x3 & ~x8)) & (x3 | ~x8) & x6 & ~x0 & ~x5;
  assign new_n43_ = ~x6 & ((x3 & ~x5 & x8) | (new_n33_ & ((x3 & ~x5) | (~x0 & ~x3 & x8))));
  assign z4 = new_n42_ | ((~new_n45_ | ~x0 | x6) & ~x3 & x5);
  assign new_n45_ = new_n33_ & x8;
endmodule
