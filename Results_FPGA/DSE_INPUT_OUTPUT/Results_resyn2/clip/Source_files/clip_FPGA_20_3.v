...
module FAU ( 
  ...
  assign new_n29_ = ((new_n28_ & (x3 ^ x8)) | ~x6 | (~new_n28_ & (x3 | ~x8) & (~x3 | x8))) & ((~new_n30_ & ~x3 & ~x8) | x6 | (~x0 & (x3 | x8)));
  assign new_n30_ = (x4 | x7) & ((x1 & x2) | (x4 & x7));
  assign new_n31_ = ((x4 & (x1 | ~x8)) | x7 | (~x3 ^ x8)) & ((x2 & (x1 | ~x3 | x8)) | (x4 & x7) | (~x3 ^ x8)) & ((~x3 & x8) | (x3 & ~x8) | (~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2)));
  assign z3 = new_n33_ | ((new_n30_ | (x3 & x8)) & ~x0 & ~x6 & (x3 | x8));
  assign new_n33_ = ~x5 & (~x0 ^ (~x6 | (~x3 & x8) | (~new_n28_ & (~x3 | x8))));
