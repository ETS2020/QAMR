...
module FAU ( 
  ...
  assign new_n19_ = x6 & ~x0 & x5 & (x3 | ~x8);
  ...
  assign z3 = ((~new_n34_ & new_n35_) | x0 | (~new_n36_ & new_n37_)) & (~x0 | ((new_n36_ | ~new_n37_) & x5)) & (new_n34_ | ~new_n35_ | (~new_n36_ & new_n37_) | ~x5);
  assign new_n34_ = (~x3 | x8) & ((~x4 & x7) | ((~x1 | x2) & (~x4 | x7)));
  assign new_n35_ = x6 & (x3 | ~x8);
  assign new_n36_ = ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2))) & (~x3 | ~x8);
  assign new_n37_ = ~x6 & (x3 | x8);
  assign z4 = (~x0 | ((new_n36_ | ~new_n37_) & x5)) & (x5 | (~new_n34_ & new_n35_));
endmodule
