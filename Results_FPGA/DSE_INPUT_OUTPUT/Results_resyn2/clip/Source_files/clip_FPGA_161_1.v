...
module FAU ( 
  ...
  assign new_n26_ = (new_n25_ | (~x4 & ~x7) | ((~x1 | ~x2) & (~x4 | ~x7))) & new_n27_ & ((x2 & (x7 | (x1 & x4))) | ~new_n25_ | (x4 & x7));
  assign new_n27_ = ~x6 & ((~x3 & ~x8) | ~x0 | x5);
  assign z3 = (~x6 & ((new_n29_ & ~x0) | (x0 & ~x5) | (~new_n29_ & x5))) | (~x0 & x5) | ((new_n30_ | x0) & x6 & (~new_n30_ | ~x0));
  assign new_n29_ = (x3 | x8) & ((x3 & x8) | ((x4 | x7) & ((x1 & x2) | (x4 & x7))));
  assign new_n30_ = (x3 | ~x8) & (((x4 | ~x7) & ((x4 & ~x7) | (x1 & ~x2))) | (x3 & ~x8));
  assign z4 = (x5 | (new_n30_ & x6)) & (~x0 | (x5 & (~new_n29_ | x6)));
endmodule
