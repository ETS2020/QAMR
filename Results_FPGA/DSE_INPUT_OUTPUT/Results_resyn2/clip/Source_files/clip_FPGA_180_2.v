...
module FAU ( 
  ...
  assign z1 = (~x2 & (new_n21_ | ~new_n23_)) | (new_n27_ & (new_n26_ | ~x6));
  assign new_n21_ = ~x5 & (new_n22_ | (~x1 & (x4 ^ x7)));
  assign new_n22_ = (x4 | (x3 & x8)) & (x3 | x8) & x0 & ~x6;
  assign new_n23_ = (new_n24_ | (x4 ^ x7) | ~x1 | ~x6) & (x6 | (x4 & x7) | (~x4 & ~x7)) & (new_n25_ | x1 | x4 | ~x7);
  assign new_n24_ = x5 & ~x0 & (x3 | ~x8);
  assign new_n25_ = ~x0 & x3 & ~x8;
  assign new_n26_ = (x7 | x0 | (~x3 & x8)) & (x0 | ~x3 | x8) & (x4 ^ x7) & (x2 | x4);
  assign new_n27_ = x5 & ((~x1 & (~x4 ^ ~x7)) | (x1 & x2 & (x6 | (x4 & x7) | (~x4 & ~x7))));
  assign z2 = new_n29_ | new_n32_ | (~x6 & (new_n36_ | (~new_n35_ & ~x2)));
  assign new_n29_ = (x3 | ~x8) & (~x3 | x8) & (new_n31_ | (~new_n30_ & x1));
  assign new_n30_ = (x2 | (~x4 & x7) | ~x6 | (~x0 & x5)) & (~x2 | ~x5 | x6 | (~x4 & ~x7));
  ...
  assign new_n35_ = ((x4 & x7) | (~x3 ^ x8)) & (~x0 | x5 | (~x3 & ~x8));
  assign new_n36_ = (~x4 | ~x7) & (x3 ^ x8) & x5 & (~x1 | (~x4 & ~x7));
  assign z3 = new_n43_ | new_n49_ | (x6 & (new_n38_ | new_n41_));
  assign new_n38_ = x0 & ((~new_n40_ & x8) | (~new_n39_ & (~x3 | x8)));
  assign new_n39_ = ((x4 & ~x7) | ~x2 | ~x5) & (~x7 | x1 | x2);
  assign new_n40_ = (x3 | (x2 & ~x5)) & (x2 | x4 | (x1 & ~x7));
