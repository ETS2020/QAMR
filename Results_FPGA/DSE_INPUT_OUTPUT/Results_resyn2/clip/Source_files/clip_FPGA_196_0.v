...
module FAU ( 
  ...
  assign z1 = (~new_n21_ & ~x6) | new_n23_ | new_n25_ | (~x0 & ~x5);
  assign new_n21_ = (~new_n22_ | (~x4 ^ ~x7)) & (x5 | (~x3 & ~x8) | (~x4 & ~x7 & (~x3 | ~x8))) & (new_n22_ | (~x4 ^ x7));
  ...
  assign z2 = (~new_n30_ & new_n32_) | (x5 & (new_n28_ | (~new_n34_ & ~x6)));
  assign new_n28_ = (~x1 | x2 | (~x4 & x7)) & (x6 | (~x1 & ~x4)) & new_n29_ & (~x4 | x7);
  assign new_n29_ = ~x3 & x8;
  assign new_n30_ = (~new_n31_ | (~x3 & x8) | (x3 & ~x8)) & x6 & (new_n31_ | (~x3 ^ x8));
  assign new_n31_ = (x4 | ~x7) & ((x4 & ~x7) | (x1 & ~x2));
  assign new_n32_ = x0 & ((new_n33_ & ~x3 & ~x8) | x6 | (~x5 & (x3 | x8)));
  assign new_n33_ = (x4 | x7) & ((x1 & x2) | (x4 & x7));
  assign new_n34_ = ((x2 & (x1 | ~x3 | x8)) | (x4 & x7) | (x3 ^ ~x8)) & ((x3 & ~x8) | (~x3 & x8) | (~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2))) & ((x4 & (x1 | x3 | ~x8)) | x7 | (x3 ^ ~x8));
  assign z3 = ~new_n36_ & (~x6 | (~x3 & x8) | (~new_n31_ & (~x3 | x8)));
  assign new_n36_ = x0 ^ (~x5 | (~new_n33_ & (~x3 | ~x8)) | x6 | (~x3 & ~x8));
