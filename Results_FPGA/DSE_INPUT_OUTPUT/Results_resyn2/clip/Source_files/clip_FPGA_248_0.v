...
module FAU ( 
  ...
  assign z1 = (~new_n22_ & ~x6) | new_n24_ | new_n25_ | (~x0 & ~x5);
  assign new_n22_ = (new_n23_ | (~x4 & ~x7) | (x4 & x7)) & (x5 | (~x3 & ~x8) | ((~x3 | ~x8) & ~x4 & ~x7)) & ((~x4 & x7) | ~new_n23_ | (x4 & ~x7));
  assign new_n23_ = x1 & x2;
  assign new_n24_ = (~x1 | (x6 & (x2 | (~x4 & ~x7) | (x4 & x7)))) & (x1 | (x4 & ~x7)) & ~new_n18_ & (~x2 | (x4 & ~x7));
  assign new_n25_ = new_n26_ & (x0 | ~x3 | x8);
  assign new_n26_ = ~x4 & x7 & (~x1 | (x2 & x6));
  assign z2 = new_n28_ | (new_n31_ & ((new_n34_ & (~x3 | x8) & (x3 | ~x8)) | ~x6 | (~new_n34_ & (~x3 ^ ~x8))));
  ...
  assign new_n31_ = x0 & ((new_n32_ & new_n33_) | x6 | (~new_n32_ & ~x5));
  assign new_n32_ = ~x3 & ~x8;
  assign new_n33_ = (x4 | x7) & ((x1 & x2) | (x4 & x7));
  assign new_n34_ = (x1 | (x4 & ~x7)) & (~x2 | (x4 & ~x7)) & (x4 | ~x7);
  assign z3 = (~new_n36_ & ~x6) | (x0 & (new_n40_ | (~new_n34_ & x6 & x8)));
  assign new_n36_ = (~x0 | (~new_n37_ & ~new_n38_ & x5)) & (new_n39_ | new_n32_ | x0 | ~x5);
  ...
  assign new_n41_ = (x1 | (x4 & (~x6 | ~x7))) & (~x6 | (~x8 & (x4 | ~x7) & (~x2 | (x4 & ~x7))));
  assign z4 = x5 & (new_n39_ | ~x0 | new_n32_ | x6);
endmodule
