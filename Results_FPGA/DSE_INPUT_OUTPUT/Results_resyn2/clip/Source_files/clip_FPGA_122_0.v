...
module FAU ( 
  ...
  assign new_n17_ = ~x6 & ((x3 & x8) | ((x4 | x7) & (x3 | x8))) & ((x4 & x7) | x1 | (x3 & x8));
  ...
  assign new_n26_ = ~x5 & ~x6 & ((x3 & x8) | ((x4 | x7) & (x3 | x8)));
  assign z2 = (~new_n28_ & ~x6) | new_n31_ | (x0 ? new_n33_ : ~x5);
  assign new_n28_ = new_n30_ & ~new_n29_ & (x5 | (~x3 & ~x8));
  ...
  assign z3 = ((new_n36_ & ~x0) | ~x5 | (~new_n36_ & x0)) & (new_n38_ | ~x0 | ~x6);
  assign new_n36_ = ~x6 & ((x3 & x8) | ((x4 | x7) & (x3 | x8))) & ((x3 & x8) | new_n37_ | (x4 & x7));
  assign new_n37_ = x1 & x2;
  assign new_n38_ = (~x3 | x8) & ((~x1 & (~x4 | x7)) | (x2 & (~x4 | x7)) | (~x4 & x7) | (~x3 & x8));
