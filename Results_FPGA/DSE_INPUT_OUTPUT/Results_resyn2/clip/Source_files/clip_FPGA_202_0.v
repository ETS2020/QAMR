...
module FAU ( 
  ...
  assign z2 = new_n28_ | new_n31_ | (new_n32_ & new_n34_) | (~x0 & ~x5);
  ...
  assign new_n31_ = new_n33_ & ((~new_n32_ & x6) | (~x1 & ~x4));
  assign new_n32_ = (~x2 | (x4 & ~x7)) & (~x7 | (x1 & x4));
  assign new_n33_ = (x0 | x8) & (x3 | x8) & (~x3 | ~x8);
  assign new_n34_ = (x3 ^ ~x8) & (x1 | x4) & x0 & x6;
  assign z3 = (x0 & (new_n36_ | (~new_n39_ & (~x6 | (~x0 & ~x5))))) | ((~x6 | (~x0 & ~x5)) & (new_n38_ | ~x5));
  assign new_n36_ = ~new_n37_ & (~x3 | x8) & (x6 | (~x3 & ~x1 & ~x4));
  assign new_n37_ = (x1 | (x4 & ~x7)) & (~x2 | (x4 & ~x7)) & (x4 | ~x7) & (x3 | ~x8);
  assign new_n38_ = (new_n29_ | (x3 & x8)) & ~x0 & (x3 | x8);
  assign new_n39_ = (x8 | (x3 & (x1 | x4))) & ((x3 & x8) | ((x7 | (x1 & x4)) & (x2 | (x4 & x7))));
  assign z4 = x5 & (new_n41_ | ~new_n42_);
  assign new_n41_ = (~x3 | ~x8) & (((~x1 | ~x2) & (~x4 | ~x7)) | (~x8 & ~x4 & ~x7));
  assign new_n42_ = x0 & ~x6 & (x3 | (x8 & (x4 | x7)));
endmodule
