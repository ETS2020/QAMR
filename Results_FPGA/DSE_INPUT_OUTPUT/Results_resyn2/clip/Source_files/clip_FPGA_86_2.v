// Benchmark "FAU" written by ABC on Wed Aug 12 15:24:32 2020
...
module FAU ( 
  ...
  assign z0 = (x0 & (new_n17_ | (x1 ^ x2))) | new_n19_ | (~new_n18_ & (x1 | x2));
  assign new_n17_ = ((x4 & x7) | (x3 & x8)) & ~x6 & ~x5 & (x3 | x8);
  assign new_n18_ = x5 & ((x1 & x2) | (x6 & (x3 | ~x8)));
  ...
  assign new_n31_ = (~x6 | (~x7 & (x0 | ~x5))) & (~x2 | x5) & x4 & (x6 | x7);
  assign new_n32_ = new_n33_ & new_n34_ & (~x1 | x2 | (~x4 & x7));
  assign new_n33_ = (x3 ^ x8) & (~x2 | (x5 & x6));
  assign new_n34_ = (~x4 | (x6 & x7)) & (x8 | x0 | ~x5);
  assign new_n35_ = (~x0 | x5 | (~x3 & ~x8)) & ((x4 & x7) | (~x3 ^ x8));
  assign new_n36_ = ((~x4 & ~x7) | (~x1 & (~x4 | ~x7))) & x5 & (x3 ^ x8);
  assign z3 = (~new_n38_ & x0) | (x2 & ~x5) | (~x0 & (new_n42_ | (new_n44_ & ~x5)));
  assign new_n38_ = (new_n39_ | x6) & (new_n40_ | x3) & (new_n41_ | ~x6 | (x3 & ~x8));
  assign new_n39_ = x5 & (x8 | ((x4 | x7) & (x1 | (x4 & x7)) & (x2 | (x4 & x7))));
  ...
  assign new_n43_ = (x4 | x7) & (x1 | (x4 & x7)) & (x2 | (x4 & x7));
  assign new_n44_ = x6 & (x3 | ~x8) & ((x3 & ~x8) | (x4 & ~x7) | (x1 & (x4 | ~x7)));
  assign z4 = (~new_n42_ & x5) | (x2 & ~x5) | (~x0 & (new_n44_ | x5));
endmodule
