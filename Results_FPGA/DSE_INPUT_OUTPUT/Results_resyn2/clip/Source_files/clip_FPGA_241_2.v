...
module FAU ( 
  ...
  assign z0 = new_n17_ | ((new_n18_ | ~new_n19_) & (x1 | x2) & (~x1 | ~x2));
  assign new_n17_ = x0 & ~x5;
  assign new_n18_ = (~x1 | (~x4 & x7)) & (~x3 | x8) & (~x4 | x7);
  assign new_n19_ = x6 & (x3 | ~x8) & ~x0 & x5;
  assign z1 = (~new_n21_ & (new_n22_ | (~new_n23_ & ~new_n24_))) | new_n17_ | (~new_n25_ & new_n21_ & new_n23_);
  assign new_n21_ = x4 ^ ~x7;
  assign new_n22_ = ~x6 & (~x1 | ~x2);
  assign new_n23_ = x1 & (~x2 | ~x6);
  assign new_n24_ = (x3 | ~x8) & ~x0 & x5 & ((x3 & ~x8) | x4 | ~x7);
  assign new_n25_ = ~x2 & (~x6 | (~x0 & x5 & (x3 | ~x8)));
  assign z2 = (~new_n27_ & new_n28_) | (new_n29_ & new_n30_) | (~new_n29_ & new_n31_ & new_n32_);
  assign new_n27_ = ((x4 & (x1 | x3)) | x7 | (~x3 ^ x8)) & ((~x3 & x8) | (x3 & ~x8) | (~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2))) & ((x4 & x7) | (x1 & x2) | (~x3 ^ x8) | (x2 & ~x3));
  assign new_n28_ = ~x6 & (~x0 | x5);
  assign new_n29_ = (x4 | ~x7) & ((x1 & ~x2) | (x4 & ~x7));
  assign new_n30_ = (~x3 | x8) & (x3 | ~x8) & (x0 | ~x5) & x6 & (~x0 | x5);
  assign new_n31_ = (~x0 | x5) & (x3 ^ x8);
  assign new_n32_ = (x6 | (~x1 & ~x4)) & (x8 | x0 | ~x5);
  assign z3 = (~x0 & ((~new_n35_ & new_n36_) | (new_n34_ & ~x5 & x6))) | ((~new_n34_ | ~x6) & (new_n35_ | ~new_n36_) & x0 & x5);
  assign new_n34_ = (x3 | ~x8) & ((x3 & ~x8) | ((x4 | ~x7) & ((x1 & ~x2) | (x4 & ~x7))));
  assign new_n35_ = ((~x4 & ~x7) | ((~x4 | ~x7) & (~x1 | ~x2))) & (~x3 | ~x8);
  assign new_n36_ = ~x6 & (x3 | x8);
  assign z4 = (x0 | x5 | (new_n34_ & x6)) & (new_n35_ | ~new_n36_ | ~x0 | ~x5);
endmodule
