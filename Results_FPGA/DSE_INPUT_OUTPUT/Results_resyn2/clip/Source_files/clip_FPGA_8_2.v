...
module FAU ( 
  ...
  assign z2 = new_n25_ | (new_n29_ & new_n30_) | (new_n27_ & ~new_n29_);
  assign new_n25_ = ~new_n26_ & ~x6 & (~x0 | x5);
  assign new_n26_ = ((x1 & x2) | (x4 & x7) | (x2 & ~x3) | (~x3 ^ x8)) & ((~x3 & x8) | (x3 & ~x8) | ((~x1 | ~x2) & (~x4 | ~x7)) | (~x4 & ~x7)) & (x7 | (x1 & x4) | ((x3 | ~x8) & (x4 | ~x3 | x8)));
  assign new_n27_ = (x3 ^ x8) & (~x0 | x5) & (new_n28_ | x6) & (x8 | x0 | ~x5);
  assign new_n28_ = ~x1 & ~x4;
  assign new_n29_ = (x4 | ~x7) & ((x1 & ~x2) | (x4 & ~x7));
  assign new_n30_ = (~x3 | x8) & (x3 | ~x8) & (x0 | ~x5) & x6 & (~x0 | x5);
  assign z3 = new_n32_ | new_n35_ | (new_n28_ & x0 & ~x3);
