...
module FAU ( 
  ...
  assign z0 = (~new_n17_ & x8) | (~new_n19_ & ~new_n21_);
  ...
  assign new_n34_ = (~new_n35_ | (x8 ? (~x3 | ~x5) : x3)) & (~new_n36_ | ~x3 | ~x5 | x8) & (new_n37_ | (x3 ? (~x5 | x8) : ~x8));
  assign new_n35_ = (x4 | x7) & ((x4 & x7) | (x1 & x2));
  assign new_n36_ = ~x1 & ~x4;
  assign new_n37_ = (x7 | (x1 & x4)) & (x2 | (x4 & x7));
  assign new_n38_ = (~new_n36_ | x3 | ~x8) & (~x0 | ((~new_n36_ | ~x3 | ~x5 | x8) & (x5 | x6 | x3 | ~x8)));
  assign z3 = (~new_n40_ & ~x6) | ~new_n44_ | (~new_n42_ & x6);
  assign new_n40_ = (~x0 | (new_n41_ & (new_n37_ | (x3 & x8)))) & ((~new_n35_ & (~x3 | ~x8)) | x0 | (~x3 & ~x8));
  ...
  assign new_n44_ = (~x3 | x5) & (~new_n36_ | ~x0 | x3);
  assign z4 = (~x3 & (new_n46_ | (x5 & (~new_n35_ | ~x8)))) | (x5 & (~new_n47_ | (~new_n35_ & ~x8)));
  assign new_n46_ = ~x0 & x6 & new_n32_ & ~x8;
