...
module FAU ( 
  ...
  assign z2 = new_n19_ | (~new_n24_ & ~new_n26_ & ~new_n20_);
  assign new_n24_ = ((~new_n22_ & ~x4) | (~x6 & ~x7) | (x6 & x7)) & new_n25_ & (~new_n22_ | ~x4);
  assign new_n25_ = ~x3 ^ x8;
  assign new_n26_ = (~x6 | (x4 & (~x7 | (x1 & ~x2))) | (~x2 & ~x7)) & (x6 | ((x4 | x7) & (x2 | (x4 & x7)))) & ~new_n25_ & (x1 | (x4 & (x6 | x7)));
  assign z3 = (~new_n28_ & x0) | (x5 & (new_n36_ | ~x0)) | (~x0 & (new_n32_ | new_n34_));
  assign new_n28_ = (new_n29_ | x3) & (new_n30_ | x6) & (new_n31_ | ~x6 | (x3 & ~x8));
  assign new_n29_ = (x1 | (x4 & (x6 | x7))) & (x6 | (x8 & (x4 | x7) & (x2 | (x4 & x7))));
  assign new_n30_ = x5 & (x8 | ((x4 | x7) & ((x1 & x2) | (x4 & x7))));
  assign new_n31_ = ((~x2 & ~x7) | (x4 & (~x7 | (x1 & ~x2)))) & (~x8 | (x3 & (x1 | x4)));
  assign new_n32_ = ~x6 & (x3 | x8) & (new_n33_ | (x3 & x8));
  assign new_n33_ = (x4 | x7) & ((x4 & x7) | (x1 & x2));
  assign new_n34_ = ~new_n35_ & x6;
  assign new_n35_ = (~x3 | x8) & ((~x4 & (x7 | ~x1 | x2)) | (x7 & (~x1 | x2)) | (~x3 & x8));
  assign new_n36_ = ~x3 & ~x1 & ~x4;
  assign z4 = (~new_n32_ | ~x0) & (x5 | (new_n34_ & ~x0));
endmodule
