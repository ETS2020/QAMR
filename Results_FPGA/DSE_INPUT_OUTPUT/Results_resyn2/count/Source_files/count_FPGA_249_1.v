...
module FAU ( 
  ...
  assign new_n68_ = ~x27 & (~x09 | x16);
  assign z07 = (x16 & (new_n70_ | (~new_n67_ & x26))) | ~new_n57_ | (~x08 & ~x16);
  assign new_n70_ = new_n65_ & new_n71_;
  assign new_n71_ = ~x26 & ~x24 & ~x25;
  assign z08 = x18 | ((new_n70_ | ~x16) & ~x27 & (~x07 | x16));
  assign z09 = x18 | ((new_n74_ | new_n75_ | ~x16) & ~x27 & (~x06 | x16));
  assign new_n74_ = x28 & (~new_n65_ | ~new_n71_);
  assign new_n75_ = new_n63_ & new_n64_ & ~x25 & ~x26 & ~x28;
  assign z10 = (x16 & (new_n77_ | (~new_n75_ & x29))) | ~new_n57_ | (~x05 & ~x16);
  assign new_n77_ = new_n78_ & ~x22 & new_n55_ & ~x20 & ~x21;
  assign new_n78_ = ~x26 & ~x24 & ~x25 & ~x23 & ~x28 & ~x29;
  assign z11 = x18 | (new_n81_ & (new_n80_ | ~x16 | (~new_n77_ & x30)));
  assign new_n80_ = new_n65_ & new_n71_ & ~x30 & ~x28 & ~x29;
  assign new_n81_ = ~x27 & (~x04 | x16);
  assign z12 = ~new_n57_ | (~x03 & ~x16) | (~new_n83_ & x16);
  assign new_n83_ = (~x31 | (new_n65_ & new_n71_ & ~x30 & ~x28 & ~x29)) & (~new_n65_ | ~new_n71_ | x30 | x31 | x28 | x29);
  assign z13 = x18 | ((new_n85_ | new_n87_ | ~x16) & ~x27 & (~x02 | x16));
  assign new_n85_ = x32 & (~new_n86_ | ~new_n65_ | ~new_n71_);
  assign new_n86_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n87_ = new_n88_ & new_n63_ & new_n64_ & ~x25 & ~x26 & ~x28;
  assign new_n88_ = ~x30 & ~x31 & ~x29 & ~x32;
  assign z14 = x18 | (new_n92_ & ((~new_n87_ & x33) | new_n90_ | ~x16));
  assign new_n90_ = new_n63_ & new_n64_ & new_n86_ & new_n91_;
