...
module FAU ( 
  ...
  assign z04 = new_n61_ | (new_n62_ & ((x23 & (~new_n58_ | x22)) | ~x16 | (new_n58_ & ~x22 & ~x23)));
  ...
  assign z06 = (x02 & x18) | ((new_n68_ | new_n69_ | ~x16) & ~x18 & (~x09 | x16));
  assign new_n68_ = new_n65_ & ~x24 & ~x25;
  assign new_n69_ = x25 & (~new_n57_ | ~new_n66_);
  assign z07 = (x02 & x18) | (~new_n71_ & ~x18 & (~x08 | x16));
  assign new_n71_ = (~x26 | (new_n65_ & ~x24 & ~x25)) & x16 & (~new_n65_ | x24 | x25 | x26);
  assign z08 = (x02 & x18) | ((new_n73_ | new_n74_ | ~x16) & ~x18 & (~x07 | x16));
  assign new_n73_ = x27 & (~new_n65_ | x24 | x25 | x26);
  assign new_n74_ = new_n57_ & new_n66_ & ~x25 & ~x26 & ~x27;
  assign z09 = new_n61_ | (new_n78_ & ((~new_n74_ & x28) | new_n76_ | ~x16));
  ...
  assign new_n80_ = new_n81_ & new_n65_ & ~x24 & ~x25 & ~x26;
  assign new_n81_ = ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (new_n80_ ^ x30));
  assign z12 = ~new_n86_ | (x16 & (new_n84_ | (x31 & (~new_n80_ | x30))));
  assign new_n84_ = new_n57_ & new_n66_ & new_n85_ & ~x25 & ~x26 & ~x27;
  assign new_n85_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n86_ = ~x18 & (x03 | x16);
  assign z13 = (x02 & x18) | (~x18 & (~x02 | x16) & (new_n88_ | ~x16 | (~new_n84_ & x32)));
  assign new_n88_ = new_n57_ & new_n66_ & new_n81_ & new_n89_;
  assign new_n89_ = ~x30 & ~x31 & ~x32 & ~x25 & ~x26;
  ...
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n91_ ^ x34));
endmodule
