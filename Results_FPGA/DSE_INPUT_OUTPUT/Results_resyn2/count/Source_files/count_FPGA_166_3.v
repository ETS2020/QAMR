...
module FAU ( 
  ...
  assign z04 = (~x16 & (~x11 | x18)) | (x16 & ~x18 & (new_n61_ | (~new_n59_ & x23)));
  assign new_n61_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z05 = (~x16 & (~x10 | x18)) | (x16 & ~x18 & (new_n63_ | (~new_n61_ & x24)));
  assign new_n63_ = new_n56_ & new_n64_;
  assign new_n64_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (~x16 & (~x09 | x18)) | (x16 & ~x18 & (new_n66_ | (~new_n63_ & x25)));
  ...
  assign new_n72_ = new_n73_ & new_n56_ & new_n64_;
  assign new_n73_ = ~x27 & ~x25 & ~x26;
  assign z09 = (~x16 & (~x06 | x18)) | (x16 & ~x18 & (new_n75_ | (~new_n72_ & x28)));
  assign new_n75_ = new_n59_ & new_n73_ & ~x28 & ~x23 & ~x24;
  assign z10 = (~x16 & (~x05 | x18)) | (x16 & ~x18 & (new_n77_ | (~new_n75_ & x29)));
  assign new_n77_ = new_n61_ & new_n70_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n79_ & x16) | x18 | (~x04 & ~x16);
  assign new_n79_ = (~x30 | (new_n61_ & new_n70_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n70_ | x28 | x29 | x27 | x30);
  assign z12 = (~x16 & (~x03 | x18)) | (x16 & ~x18 & (new_n83_ | (~new_n81_ & x31)));
  assign new_n81_ = new_n61_ & new_n70_ & new_n82_;
  ...
  assign new_n86_ = new_n56_ & new_n64_ & new_n82_ & new_n87_;
  assign new_n87_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n89_ | (~new_n86_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n89_ = new_n57_ & new_n67_ & new_n84_ & new_n90_;
