...
module FAU ( 
  ...
  assign z09 = (~x16 & (~x06 | x18)) | ((new_n74_ | (~new_n71_ & x28)) & x16 & ~x18);
  assign new_n74_ = new_n72_ & new_n75_;
  assign new_n75_ = ~x27 & ~x28 & ~x24 & ~x25 & ~x23 & ~x26;
  assign z10 = (~x16 & (~x05 | x18)) | ((new_n77_ | (~new_n74_ & x29)) & x16 & ~x18);
  ...
  assign z14 = (~x16 & (~x01 | x18)) | ((new_n89_ | (~new_n86_ & x33)) & x16 & ~x18);
