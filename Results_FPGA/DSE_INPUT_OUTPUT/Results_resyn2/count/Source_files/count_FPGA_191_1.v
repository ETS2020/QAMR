// Benchmark "FAU" written by ABC on Wed Aug 12 18:31:28 2020
...
module FAU ( 
  ...
  assign z01 = (x16 & ((~x17 & ~x19) ^ x20)) | x18 | (~x14 & ~x16);
  ...
  assign new_n79_ = new_n63_ & new_n69_ & new_n80_;
  assign new_n80_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n82_ | (~new_n79_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n82_ = new_n56_ & new_n62_ & new_n72_ & new_n83_;
  assign new_n83_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = (x16 & (new_n85_ | x18 | (new_n61_ & new_n86_))) | (~x02 & ~x16 & ~x18);
  assign new_n85_ = x32 & (~new_n56_ | ~new_n62_ | ~new_n72_ | ~new_n83_);
  assign new_n86_ = new_n80_ & ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = ~new_n90_ | (x16 & (new_n88_ | (x33 & (~new_n61_ | ~new_n86_))));
