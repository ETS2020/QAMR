...
module FAU ( 
  ...
  wire new_n55_, new_n56_, new_n58_, new_n59_, new_n60_, new_n64_, new_n65_,
    ...
    new_n77_, new_n79_, new_n82_, new_n83_, new_n84_, new_n86_, new_n87_,
  ...
  assign new_n64_ = x24 & (~new_n60_ | ~new_n65_);
  ...
  assign new_n69_ = new_n60_ & new_n65_ & ~x24 & ~x25;
  assign z07 = (x05 & x18) | (~new_n71_ & ~x18 & (~x08 | x16));
  assign new_n71_ = (~new_n60_ | ~new_n65_ | x24 | x25 | x26) & x16 & (~x26 | (new_n60_ & new_n65_ & ~x24 & ~x25));
  assign z08 = (x16 & (new_n75_ | (~new_n73_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n73_ = new_n74_ & new_n60_ & new_n65_;
  assign new_n74_ = ~x24 & ~x25 & ~x26;
  assign new_n75_ = new_n59_ & new_n67_ & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n77_ | (~new_n75_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n77_ = new_n60_ & ~x22 & new_n74_ & ~x28 & ~x23 & ~x27;
  assign z10 = (x05 & x18) | (~x18 & (~x05 | x16) & ((~new_n77_ & x29) | new_n79_ | ~x16));
  assign new_n79_ = new_n60_ & new_n65_ & new_n74_ & ~x27 & ~x28 & ~x29;
  assign z11 = (x05 & x18) | (((new_n79_ & ~x30) | ~x16 | (~new_n79_ & x30)) & ~x18 & (~x04 | x16));
  assign z12 = ~new_n84_ | (x16 & (new_n82_ | (x31 & (~new_n79_ | x30))));
  assign new_n82_ = new_n59_ & new_n67_ & new_n83_ & ~x25 & ~x26 & ~x27;
  assign new_n83_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n84_ = ~x18 & (x03 | x16);
  assign z13 = new_n55_ | (new_n88_ & (new_n86_ | ~x16 | (~new_n82_ & x32)));
  assign new_n86_ = new_n59_ & new_n67_ & new_n87_ & ~x27 & ~x28 & ~x29;
  assign new_n87_ = ~x25 & ~x26 & ~x32 & ~x30 & ~x31;
  assign new_n88_ = ~x18 & (~x02 | x16);
  assign z14 = new_n55_ | (new_n92_ & ((~new_n86_ & x33) | new_n90_ | ~x16));
  assign new_n90_ = new_n60_ & new_n65_ & ~x24 & ~x25 & new_n83_ & new_n91_;
  assign new_n91_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign new_n92_ = ~x18 & (~x01 | x16);
  assign z15 = (x05 & x18) | (((new_n90_ & ~x34) | ~x16 | (~new_n90_ & x34)) & ~x18 & (~x00 | x16));
endmodule
