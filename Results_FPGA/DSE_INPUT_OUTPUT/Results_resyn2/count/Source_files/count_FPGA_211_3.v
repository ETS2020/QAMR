...
module FAU ( 
  ...
  assign z04 = (~x23 & (new_n61_ | x18)) | (~x18 & ((~x11 & ~x16) | (~new_n60_ & x16 & x23)));
  assign new_n60_ = ~x22 & ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n61_ = ~x20 & ~x17 & ~x19 & ~x22 & x16 & ~x21;
  ...
  assign z06 = new_n68_ | (~x18 & ((~x09 & ~x16) | (~new_n63_ & x16 & x25)));
  assign new_n68_ = ~x23 & (x18 | (new_n61_ & new_n69_));
  assign new_n69_ = ~x24 & ~x25;
  assign z07 = x18 | (~x08 & ~x16) | (~new_n71_ & x16);
  ...
  assign new_n75_ = new_n60_ & new_n69_ & ~x23 & ~x26 & ~x27;
  assign z09 = new_n77_ | (~x18 & ((~x06 & ~x16) | (~new_n75_ & x16 & x28)));
  assign new_n77_ = ~x23 & (x18 | (new_n78_ & new_n61_ & new_n69_));
  assign new_n78_ = ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n81_ | (~new_n80_ & x29)));
  assign new_n80_ = new_n60_ & new_n78_ & new_n69_ & ~x23;
  assign new_n81_ = new_n66_ & new_n74_ & ~x29 & ~x27 & ~x28;
  assign z11 = new_n83_ | (~x18 & ((~x04 & ~x16) | (~new_n81_ & x16 & x30)));
  assign new_n83_ = ~x23 & (x18 | (new_n61_ & new_n74_ & new_n84_));
  assign new_n84_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (~new_n88_ & ~x18) | (~x23 & (new_n86_ | x18));
  assign new_n86_ = new_n61_ & ~x24 & new_n87_ & ~x25 & ~x26 & ~x27;
  assign new_n87_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign new_n88_ = (x03 | x16) & ((new_n66_ & new_n74_ & new_n84_) | ~x16 | ~x31);
  assign z13 = new_n90_ | (~x18 & ((~x02 & ~x16) | (~new_n92_ & x16 & x32)));
  assign new_n90_ = ~x23 & (x18 | (new_n84_ & new_n91_ & new_n61_ & ~x24));
  assign new_n91_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n92_ = new_n64_ & new_n65_ & new_n87_ & ~x25 & ~x26 & ~x27;
  assign z14 = ~new_n97_ | (x16 & (new_n95_ | (x33 & (~new_n63_ | ~new_n94_))));
  assign new_n94_ = new_n84_ & new_n91_;
  assign new_n95_ = new_n58_ & new_n69_ & ~x22 & ~x23 & new_n87_ & new_n96_;
  assign new_n96_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign new_n97_ = ~x18 & (x01 | x16);
  assign z15 = (~x23 & (new_n99_ | x18)) | (~x18 & (new_n101_ | (~new_n95_ & new_n100_)));
  assign new_n99_ = new_n61_ & new_n69_ & ~x34 & new_n87_ & new_n96_;
