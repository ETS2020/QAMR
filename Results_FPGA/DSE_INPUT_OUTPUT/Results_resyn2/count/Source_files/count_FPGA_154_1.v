...
module FAU ( 
  ...
  assign z04 = new_n60_ | (new_n61_ & ((x23 & (~new_n57_ | x22)) | ~x16 | (new_n57_ & ~x22 & ~x23)));
  assign new_n60_ = x10 & x18;
  assign new_n61_ = ~x18 & (~x11 | x16);
  assign z05 = x18 | (~x10 & ~x16) | (~new_n63_ & x16);
  assign new_n63_ = (new_n64_ | ~x24) & (~new_n56_ | ~new_n65_);
  assign new_n64_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n65_ = ~x22 & ~x23 & ~x21 & ~x24;
  assign z06 = (x10 & x18) | ((new_n67_ | new_n68_ | ~x16) & ~x18 & (~x09 | x16));
  assign new_n67_ = new_n64_ & ~x24 & ~x25;
  ...
  assign z08 = (x10 & x18) | ((new_n73_ | new_n74_ | ~x16) & ~x18 & (~x07 | x16));
  assign new_n73_ = x27 & (~new_n64_ | ~new_n71_);
  assign new_n74_ = new_n56_ & new_n65_ & ~x25 & ~x26 & ~x27;
  assign z09 = new_n60_ | (new_n77_ & ((~new_n74_ & x28) | new_n76_ | ~x16));
  assign new_n76_ = new_n57_ & ~x22 & new_n71_ & ~x28 & ~x23 & ~x27;
  assign new_n77_ = ~x18 & (~x06 | x16);
  assign z10 = new_n60_ | (new_n81_ & (new_n79_ | ~x16 | (~new_n76_ & x29)));
  assign new_n79_ = new_n80_ & new_n64_ & new_n71_;
  assign new_n80_ = ~x27 & ~x28 & ~x29;
  assign new_n81_ = ~x18 & (~x05 | x16);
  assign z11 = x18 | (~x04 & ~x16) | (x16 & ((x30 & (~new_n70_ | ~new_n80_)) | (new_n70_ & new_n80_ & ~x30)));
  assign z12 = (x10 & x18) | ((new_n84_ | new_n86_ | ~x16) & ~x18 & (~x03 | x16));
  assign new_n84_ = x31 & (~new_n85_ | ~new_n64_ | ~new_n71_);
  assign new_n85_ = ~x30 & ~x27 & ~x28 & ~x29;
  assign new_n86_ = new_n87_ & new_n56_ & new_n65_ & ~x25 & ~x26 & ~x27;
  assign new_n87_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n60_ | (new_n91_ & ((~new_n86_ & x32) | new_n89_ | ~x16));
  assign new_n89_ = new_n85_ & new_n90_ & new_n56_ & new_n65_;
  assign new_n90_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n91_ = ~x18 & (~x02 | x16);
  assign z14 = (x16 & (new_n93_ | (~new_n89_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n93_ = new_n64_ & ~x24 & ~x25 & new_n87_ & new_n94_;
