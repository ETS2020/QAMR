...
module FAU ( 
  ...
  wire new_n54_, new_n57_, new_n58_, new_n62_, new_n63_, new_n64_, new_n66_,
    new_n68_, new_n70_, new_n72_, new_n75_, new_n76_, new_n78_, new_n79_,
  ...
  assign z08 = (~new_n68_ & x27) | ~new_n54_ | (new_n62_ & new_n70_);
  assign new_n70_ = ~x25 & ~x26 & ~x27;
  assign z09 = new_n72_ | ~new_n54_ | (x28 & (~new_n62_ | ~new_n70_));
  assign new_n72_ = ~x27 & ~x28 & new_n64_ & ~x24 & ~x25 & ~x26;
  assign z10 = (new_n72_ & ~x29) | ~new_n54_ | (~new_n72_ & x29);
  assign z11 = new_n75_ | ~new_n54_ | (x30 & (~new_n72_ | x29));
  assign new_n75_ = new_n64_ & new_n76_ & ~x24 & ~x25 & ~x26;
  assign new_n76_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (x16 & (new_n78_ | (~new_n75_ & x31)));
  assign new_n78_ = new_n57_ & new_n63_ & ~x21 & ~x24 & new_n70_ & new_n79_;
  assign new_n79_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = x18 | (x16 & (new_n81_ | (~new_n78_ & x32)));
  assign new_n81_ = new_n57_ & new_n63_ & ~x21 & ~x24 & new_n76_ & new_n82_;
  assign new_n82_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = x18 | (x16 & (new_n84_ | (~new_n81_ & x33)));
  assign new_n84_ = new_n58_ & new_n63_ & ~x24 & ~x25 & new_n79_ & new_n85_;
