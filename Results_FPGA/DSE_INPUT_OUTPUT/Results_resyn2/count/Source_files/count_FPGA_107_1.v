...
module FAU ( 
  ...
  assign z06 = (~x09 & ~x16 & ~x18) | (x16 & ((~new_n61_ & x25) | new_n65_ | x18));
  ...
  assign new_n71_ = new_n72_ & new_n56_ & new_n62_;
  assign new_n72_ = ~x25 & ~x26 & ~x27;
  assign z09 = (~x06 & ~x16 & ~x18) | (x16 & ((~new_n71_ & x28) | new_n74_ | x18));
  ...
  assign z12 = (~x03 & ~x16 & ~x18) | (x16 & ((~new_n81_ & x31) | new_n83_ | x18));
  assign new_n81_ = new_n63_ & new_n69_ & new_n82_;
  assign new_n82_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n83_ = new_n56_ & new_n62_ & new_n72_ & new_n84_;
  assign new_n84_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = (x16 & (new_n86_ | x18 | (new_n61_ & new_n87_))) | (~x02 & ~x16 & ~x18);
  assign new_n86_ = x32 & (~new_n56_ | ~new_n62_ | ~new_n72_ | ~new_n84_);
  assign new_n87_ = new_n82_ & new_n88_;
  assign new_n88_ = ~x31 & ~x32 & ~x25 & ~x26;
  assign z14 = (~x01 & ~x16 & ~x18) | (x16 & (new_n90_ | new_n91_ | x18));
  assign new_n90_ = x33 & (~new_n56_ | ~new_n62_ | ~new_n82_ | ~new_n88_);
  assign new_n91_ = new_n57_ & new_n66_ & new_n84_ & new_n92_;
  assign new_n92_ = ~x32 & ~x33 & ~x26 & ~x27;
