...
module FAU ( 
  ...
  assign z04 = (~x11 & ~x16 & ~x18) | (x16 & ((x23 & (~new_n58_ | x22)) | x18 | (new_n58_ & ~x22 & ~x23)));
  ...
  assign z09 = x18 | (~x06 & ~x16) | (x16 & ((x28 & (~new_n63_ | ~new_n70_)) | (new_n63_ & new_n70_ & ~x28)));
  ...
  assign z13 = (x16 & ((~new_n78_ & x32) | new_n83_ | x18)) | (~x02 & ~x16 & ~x18);
