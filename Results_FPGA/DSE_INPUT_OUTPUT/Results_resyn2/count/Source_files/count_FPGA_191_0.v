...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n61_, new_n62_, new_n63_, new_n67_, new_n68_,
    new_n69_, new_n71_, new_n73_, new_n76_, new_n77_, new_n79_, new_n80_,
    new_n82_, new_n83_;
  ...
  assign z13 = x18 | (x16 & ((~new_n76_ & x32) | (new_n61_ & new_n79_)));
  assign new_n79_ = new_n80_ & ~x27 & ~x28 & ~x29;
  assign new_n80_ = ~x30 & ~x31 & ~x32 & ~x25 & ~x26;
  assign z14 = ((~new_n61_ | ~new_n79_) & x33) | new_n82_ | ~x16 | x18;
