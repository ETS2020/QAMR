...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n62_, new_n63_, new_n65_,
    ...
    new_n76_, new_n79_, new_n80_, new_n82_, new_n84_, new_n85_, new_n87_,
  ...
  assign z02 = (x10 & x18) | (~new_n57_ & ~x18 & (~x13 | x16));
  ...
  assign z04 = (x10 & x18) | ((new_n61_ | new_n63_ | ~x16) & ~x18 & (~x11 | x16));
  ...
  assign z06 = (x10 & x18) | ((new_n69_ | new_n70_ | ~x16) & ~x18 & (~x09 | x16));
  ...
  assign z08 = (x10 & x18) | ((new_n74_ | new_n76_ | ~x16) & ~x18 & (~x07 | x16));
  assign new_n74_ = x27 & (~new_n63_ | ~new_n75_);
  assign new_n75_ = ~x24 & ~x25 & ~x26;
  assign new_n76_ = new_n62_ & new_n75_ & ~x23 & ~x27;
  assign z09 = (x10 & x18) | (((new_n76_ & ~x28) | ~x16 | (~new_n76_ & x28)) & ~x18 & (~x06 | x16));
  assign z10 = ~new_n80_ | (x16 & (new_n79_ | (x29 & (~new_n76_ | x28))));
  assign new_n79_ = ~x27 & ~x28 & ~x29 & new_n63_ & new_n75_;
  assign new_n80_ = ~x18 & (x05 | x16);
  assign z11 = (x16 & (new_n82_ | (~new_n79_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n82_ = ~x28 & ~x29 & new_n63_ & new_n75_ & ~x27 & ~x30;
  assign z12 = (x16 & (new_n84_ | (~new_n82_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n84_ = new_n66_ & new_n67_ & new_n85_ & ~x27 & ~x25 & ~x26;
  assign new_n85_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x10 & x18) | ((~new_n87_ | (~new_n84_ & x32)) & ~new_n90_ & ~x18);
  assign new_n87_ = x16 & (~new_n66_ | ~new_n67_ | ~new_n88_ | ~new_n89_);
  assign new_n88_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n89_ = ~x28 & ~x29 & ~x27 & ~x30;
  assign new_n90_ = x02 & ~x16;
  assign z14 = (x10 & x18) | ((new_n92_ | new_n93_ | ~x16) & ~x18 & (~x01 | x16));
  assign new_n92_ = x33 & (~new_n66_ | ~new_n67_ | ~new_n88_ | ~new_n89_);
  assign new_n93_ = new_n63_ & ~x24 & ~x25 & new_n85_ & new_n94_;
