...
module FAU ( 
  ...
  assign z03 = (~x00 & x18) | (((new_n60_ & ~x22) | ~x16 | (~new_n60_ & x22)) & ~x18 & (~x12 | x16));
  assign new_n60_ = ~x21 & ~x20 & ~x17 & ~x19;
  assign z04 = (~x00 & x18) | ((new_n62_ | new_n63_ | ~x16) & ~x18 & (~x11 | x16));
  assign new_n62_ = x23 & (~new_n60_ | x22);
  assign new_n63_ = ~x20 & ~x17 & ~x19 & ~x21 & ~x22 & ~x23;
  assign z05 = x18 | (~x10 & ~x16) | (~new_n65_ & x16);
  assign new_n65_ = (new_n63_ | ~x24) & (~new_n60_ | ~new_n66_ | x24);
  assign new_n66_ = ~x22 & ~x23;
  assign z06 = (~x00 & x18) | (~new_n68_ & ~x18 & (~x09 | x16));
  assign new_n68_ = (~x25 | (new_n58_ & ~x21 & new_n66_ & ~x24)) & x16 & (x24 | x25 | ~new_n58_ | ~new_n66_ | x21);
  assign z07 = (~x00 & x18) | (~new_n70_ & ~x18 & (~x08 | x16));
  assign new_n70_ = (~x26 | (new_n63_ & ~x24 & ~x25)) & x16 & (~new_n63_ | x24 | x25 | x26);
  assign z08 = (x16 & (new_n73_ | (~new_n72_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n72_ = new_n63_ & ~x24 & ~x25 & ~x26;
  assign new_n73_ = new_n60_ & new_n66_ & ~x24 & new_n74_ & ~x25;
  assign new_n74_ = ~x26 & ~x27;
  assign z09 = new_n55_ | (new_n78_ & (new_n76_ | ~x16 | (~new_n73_ & x28)));
  ...
  assign new_n80_ = new_n81_ & new_n63_ & ~x24 & ~x25 & ~x26;
  assign new_n81_ = ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~x04 & ~x16) | (x16 & ((x30 & (~new_n72_ | ~new_n81_)) | (new_n72_ & new_n81_ & ~x30)));
  ...
  assign new_n86_ = new_n87_ & new_n60_ & new_n66_ & ~x24 & new_n74_ & ~x25;
  assign new_n87_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n89_ | (~new_n86_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n89_ = new_n60_ & new_n66_ & ~x24 & new_n85_ & new_n90_;
  assign new_n90_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = new_n55_ | (new_n94_ & (new_n92_ | ~x16 | (~new_n89_ & x33)));
  assign new_n92_ = new_n63_ & ~x24 & ~x25 & new_n87_ & new_n93_;
