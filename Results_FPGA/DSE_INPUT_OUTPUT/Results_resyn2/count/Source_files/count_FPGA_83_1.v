...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n58_, new_n61_, new_n62_, new_n64_, new_n65_,
    ...
    new_n76_, new_n78_, new_n79_, new_n81_, new_n82_, new_n83_, new_n86_,
  ...
  assign z05 = (x01 & x18) | ((new_n64_ | new_n66_ | ~x16) & ~x18 & (~x10 | x16));
  ...
  assign z10 = new_n62_ | (new_n83_ & (new_n81_ | ~x16 | (~new_n78_ & x29)));
  assign new_n81_ = new_n82_ & new_n65_ & ~x26 & ~x24 & ~x25;
  ...
  assign new_n86_ = new_n87_ & new_n65_ & ~x26 & ~x24 & ~x25;
  assign new_n87_ = ~x30 & ~x27 & ~x28 & ~x29;
  assign new_n88_ = new_n89_ & new_n57_ & new_n67_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n62_ | (new_n93_ & (new_n91_ | ~x16 | (~new_n88_ & x32)));
  assign new_n91_ = new_n87_ & new_n92_ & new_n57_ & new_n67_;
  assign new_n92_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n93_ = ~x18 & (~x02 | x16);
  assign z14 = (x01 & x18) | (~x18 & (~x01 | x16) & ((~new_n91_ & x33) | new_n95_ | ~x16));
  assign new_n95_ = new_n58_ & new_n71_ & new_n89_ & new_n96_;
  assign new_n96_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign z15 = (x01 & x18) | (((new_n95_ & ~x34) | ~x16 | (~new_n95_ & x34)) & ~x18 & (~x00 | x16));
endmodule
