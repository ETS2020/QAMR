...
module FAU ( 
  ...
  assign z01 = (x12 & x18) | (((new_n55_ & ~x20) | ~x16 | (~new_n55_ & x20)) & ~x18 & (~x14 | x16));
  assign new_n55_ = ~x17 & ~x19;
  assign z02 = (x12 & x18) | (~new_n57_ & ~x18 & (~x13 | x16));
  assign new_n57_ = (~x21 | (~x20 & ~x17 & ~x19)) & x16 & (x17 | x19 | x20 | x21);
  assign z03 = (x12 & x18) | (((new_n59_ & ~x22) | ~x16 | (~new_n59_ & x22)) & ~x18 & (~x12 | x16));
  ...
  assign z05 = (x12 & x18) | ((new_n64_ | new_n66_ | ~x16) & ~x18 & (~x10 | x16));
  ...
  assign z06 = (x12 & x18) | ((new_n70_ | new_n71_ | ~x16) & ~x18 & (~x09 | x16));
  assign new_n70_ = new_n65_ & ~x24 & ~x25;
  assign new_n71_ = x25 & (~new_n67_ | ~new_n68_);
  assign z07 = (x12 & x18) | (~new_n73_ & ~x18 & (~x08 | x16));
  assign new_n73_ = (~x26 | (new_n65_ & ~x24 & ~x25)) & x16 & (~new_n65_ | x24 | x25 | x26);
  assign z08 = (x12 & x18) | ((new_n75_ | new_n76_ | ~x16) & ~x18 & (~x07 | x16));
  assign new_n75_ = x27 & (~new_n65_ | x24 | x25 | x26);
  ...
  assign z10 = ~new_n82_ | (x16 & ((x29 & (~new_n81_ | x27 | x28)) | (new_n81_ & ~x27 & ~x28 & ~x29)));
  assign new_n81_ = new_n65_ & ~x24 & ~x25 & ~x26;
  assign new_n82_ = ~x18 & (x05 | x16);
  assign z11 = (x16 & ((x30 & (~new_n81_ | ~new_n84_)) | (new_n81_ & new_n84_ & ~x30))) | x18 | (~x04 & ~x16);
  assign new_n84_ = ~x27 & ~x28 & ~x29;
  assign z12 = (x12 & x18) | ((new_n86_ | new_n88_ | ~x16) & ~x18 & (~x03 | x16));
  assign new_n86_ = x31 & (~new_n87_ | ~new_n65_ | x24 | x25 | x26);
  assign new_n87_ = ~x30 & ~x27 & ~x28 & ~x29;
  assign new_n88_ = new_n89_ & new_n67_ & new_n68_ & ~x25 & ~x26 & ~x27;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n61_ | (new_n93_ & ((~new_n88_ & x32) | new_n91_ | ~x16));
  assign new_n91_ = new_n87_ & new_n92_ & new_n67_ & new_n68_;
  assign new_n92_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n93_ = ~x18 & (~x02 | x16);
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n95_ | (~new_n91_ & x33)));
  assign new_n95_ = new_n65_ & ~x24 & ~x25 & new_n89_ & new_n96_;
  assign new_n96_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign z15 = ((~new_n95_ | ~x34) & x16 & (new_n95_ | x34)) | x18 | (~x00 & ~x16);
endmodule
