...
module FAU ( 
  ...
  assign new_n58_ = x22 ^ (~new_n55_ | x20 | x21);
  assign z04 = (x15 & x18) | ((new_n60_ | new_n61_ | ~x16) & ~x18 & (~x11 | x16));
  assign new_n60_ = x23 & (x22 | ~new_n55_ | x20 | x21);
  assign new_n61_ = ~x22 & ~x23 & ~x17 & ~x19 & ~x20 & ~x21;
  assign z05 = (x15 & x18) | ((new_n63_ | new_n64_ | ~x16) & ~x18 & (~x10 | x16));
  ...
  assign new_n76_ = new_n77_ & new_n61_ & new_n72_;
  assign new_n77_ = ~x27 & ~x28;
  assign z10 = x18 | (~x05 & ~x16) | (~new_n79_ & x16);
  assign new_n79_ = (~x29 | (new_n77_ & new_n61_ & new_n72_)) & (~new_n61_ | ~new_n72_ | ~new_n77_ | x29);
  assign z11 = (x15 & x18) | (~new_n81_ & ~x18 & (~x04 | x16));
  assign new_n81_ = (~x30 | (new_n61_ & new_n72_ & new_n77_ & ~x29)) & x16 & (~new_n61_ | ~new_n72_ | ~new_n77_ | x29 | x30);
  assign z12 = (x16 & (new_n85_ | (~new_n83_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n83_ = new_n84_ & new_n61_ & new_n72_;
  assign new_n84_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n85_ = new_n86_ & new_n65_ & new_n66_ & ~x25 & ~x26 & ~x27;
  assign new_n86_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = (x15 & x18) | (~new_n90_ & ~x18 & (~new_n88_ | (~new_n85_ & x32)));
  assign new_n88_ = x16 & (~new_n65_ | ~new_n66_ | ~new_n84_ | ~new_n89_);
  assign new_n89_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n90_ = x02 & ~x16;
  assign z14 = (x15 & x18) | (~x18 & (~x01 | x16) & (new_n92_ | ~new_n94_));
  assign new_n92_ = new_n61_ & ~x24 & ~x25 & new_n86_ & new_n93_;
  assign new_n93_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign new_n94_ = x16 & (~x33 | (new_n65_ & new_n66_ & new_n84_ & new_n89_));
