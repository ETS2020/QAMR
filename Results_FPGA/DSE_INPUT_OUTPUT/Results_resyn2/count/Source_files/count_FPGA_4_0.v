...
module FAU ( 
  ...
  wire new_n54_, new_n57_, new_n58_, new_n62_, new_n63_, new_n64_, new_n66_,
    ...
    new_n79_, new_n80_, new_n82_, new_n84_, new_n86_, new_n87_;
  ...
  assign z06 = (~new_n62_ & x25) | new_n66_ | ~new_n54_;
  assign new_n66_ = new_n58_ & new_n67_;
  assign new_n67_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = new_n69_ | ~new_n54_ | (~new_n66_ & x26);
  assign new_n69_ = new_n64_ & new_n70_ & ~x24;
  assign new_n70_ = ~x25 & ~x26;
  assign z08 = (~new_n69_ & x27) | new_n72_ | ~new_n54_;
  assign new_n72_ = new_n57_ & new_n63_ & new_n70_ & ~x27;
  assign z09 = (~new_n72_ & x28) | new_n74_ | ~new_n54_;
  assign new_n74_ = new_n75_ & new_n58_ & ~x22;
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (x16 & (new_n77_ | (~new_n74_ & x29)));
  assign new_n77_ = new_n64_ & new_n70_ & ~x24 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n77_ & x30) | new_n79_ | ~new_n54_;
  assign new_n79_ = new_n64_ & new_n80_ & new_n70_ & ~x24;
  assign new_n80_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (x16 & ((~new_n79_ & x31) | (new_n72_ & new_n82_)));
  assign new_n82_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = (x32 & (~new_n72_ | ~new_n82_)) | ~new_n54_ | (new_n62_ & new_n84_);
  assign new_n84_ = new_n80_ & new_n70_ & ~x31 & ~x32;
  assign z14 = x18 | (x16 & (new_n86_ | ((~new_n62_ | ~new_n84_) & x33)));
  assign new_n86_ = new_n58_ & new_n67_ & new_n82_ & new_n87_;
