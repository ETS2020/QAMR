...
module FAU ( 
  ...
  assign new_n66_ = new_n58_ & new_n67_ & ~x24 & ~x25;
  assign new_n67_ = ~x22 & ~x23;
  assign z07 = (~x21 & (new_n69_ | x18)) | (~x18 & (new_n72_ | (~x08 & ~x16)));
  assign new_n69_ = new_n70_ & new_n62_ & new_n71_;
  assign new_n70_ = ~x25 & ~x26;
  assign new_n71_ = x16 & ~x22 & ~x23 & ~x24;
  assign new_n72_ = (~new_n58_ | ~new_n67_ | x24 | x25) & x16 & x26;
  assign z08 = (~x21 & (new_n74_ | x18)) | ((new_n76_ | ~x16) & ~x18 & (~x07 | x16));
  assign new_n74_ = new_n75_ & new_n62_ & new_n71_;
  assign new_n75_ = ~x25 & ~x26 & ~x27;
  assign new_n76_ = x27 & (~new_n77_ | ~new_n70_ | x23 | x24);
  assign new_n77_ = ~x22 & ~x17 & ~x19 & ~x20 & ~x21;
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n80_ | (~new_n79_ & x28)));
  assign new_n79_ = new_n75_ & new_n62_ & new_n63_;
  assign new_n80_ = new_n77_ & ~x27 & ~x28 & new_n70_ & ~x23 & ~x24;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n82_ | (~new_n80_ & x29)));
  assign new_n82_ = new_n64_ & new_n70_ & ~x24 & ~x29 & ~x27 & ~x28;
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (new_n84_ | (~new_n82_ & x30)));
  assign new_n84_ = new_n64_ & new_n85_ & new_n70_ & ~x24;
  assign new_n85_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n87_ | (~new_n84_ & x31)));
  assign new_n87_ = new_n62_ & new_n63_ & new_n75_ & new_n88_;
  assign new_n88_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = new_n90_ | (~x18 & ((~x02 & ~x16) | (~new_n87_ & x16 & x32)));
  assign new_n90_ = ~x21 & (x18 | (new_n62_ & new_n71_ & new_n85_ & new_n91_));
  assign new_n91_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = ~new_n96_ | (x16 & (new_n94_ | (x33 & (~new_n61_ | ~new_n93_))));
  assign new_n93_ = new_n85_ & new_n91_;
  assign new_n94_ = new_n88_ & new_n95_ & new_n58_ & new_n67_ & ~x24 & ~x25;
