...
module FAU ( 
  ...
  assign z07 = (x02 & x18) | (~new_n67_ & ~x18 & (~x08 | x16));
  assign new_n67_ = (~x26 | (new_n63_ & new_n68_)) & x16 & (~new_n63_ | ~new_n68_ | x26);
  assign new_n68_ = ~x24 & ~x25;
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n70_ | new_n71_));
  assign new_n70_ = x27 & (~new_n63_ | ~new_n68_ | x26);
  assign new_n71_ = new_n56_ & new_n62_ & ~x25 & ~x26 & ~x27;
  assign z09 = new_n75_ | (new_n76_ & ((~new_n71_ & x28) | new_n73_ | ~x16));
  assign new_n73_ = new_n74_ & new_n56_ & ~x21 & ~x22;
  assign new_n74_ = ~x25 & ~x26 & ~x23 & ~x24 & ~x27 & ~x28;
  assign new_n75_ = x02 & x18;
  assign new_n76_ = ~x18 & (~x06 | x16);
  assign z10 = new_n75_ | (new_n79_ & (new_n78_ | ~x16 | (~new_n73_ & x29)));
  assign new_n78_ = ~x29 & ~x27 & ~x28 & new_n63_ & new_n68_ & ~x26;
  assign new_n79_ = ~x18 & (~x05 | x16);
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (new_n81_ | (~new_n78_ & x30)));
  assign new_n81_ = new_n82_ & new_n63_ & new_n68_ & ~x26;
  assign new_n82_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x02 & x18) | ((new_n84_ | new_n85_ | ~x16) & ~x18 & (~x03 | x16));
  assign new_n84_ = x31 & (~new_n82_ | ~new_n63_ | ~new_n68_ | x26);
  assign new_n85_ = new_n86_ & new_n56_ & new_n62_ & ~x25 & ~x26 & ~x27;
  assign new_n86_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = (x02 & x18) | (~x18 & (~x02 | x16) & (~new_n88_ | (~new_n85_ & x32)));
  assign new_n88_ = x16 & (~new_n56_ | ~new_n62_ | ~new_n82_ | ~new_n89_);
  assign new_n89_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = (x02 & x18) | ((new_n91_ | ~new_n93_) & ~x18 & (~x01 | x16));
  assign new_n91_ = new_n63_ & new_n68_ & new_n86_ & new_n92_;
  assign new_n92_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign new_n93_ = x16 & (~x33 | (new_n56_ & new_n62_ & new_n82_ & new_n89_));
