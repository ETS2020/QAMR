...
module FAU ( 
  ...
  assign z05 = (~x16 & (~x10 | x18)) | (x16 & ~x18 & (new_n61_ | (~new_n63_ & x24)));
  ...
  assign z08 = (~x16 & (~x07 | x18)) | ((new_n71_ | (~new_n68_ & x27)) & x16 & ~x18);
  ...
  assign new_n81_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n82_ = new_n56_ & new_n62_ & new_n83_ & ~x25 & ~x26 & ~x27;
  assign new_n83_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = (~x16 & (~x02 | x18)) | ((new_n85_ | (~new_n82_ & x32)) & x16 & ~x18);
  assign new_n85_ = new_n56_ & new_n62_ & new_n81_ & new_n86_;
  assign new_n86_ = ~x31 & ~x32 & ~x25 & ~x26;
  assign z14 = (~x16 & (~x01 | x18)) | ((new_n88_ | (~new_n85_ & x33)) & x16 & ~x18);
  assign new_n88_ = new_n57_ & new_n66_ & new_n83_ & new_n89_;
  assign new_n89_ = ~x32 & ~x33 & ~x26 & ~x27;
