...
module FAU ( 
  ...
  assign new_n61_ = (~new_n62_ | ~new_n64_) & (new_n63_ | ~x24);
  ...
  assign new_n66_ = (~new_n63_ | x24 | x25) & x16 & (~x25 | (new_n62_ & new_n64_));
  ...
  assign new_n72_ = ~x25 & ~x26 & ~x27 & new_n62_ & new_n64_;
  assign z09 = (x16 & (new_n74_ | (~new_n72_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n74_ = new_n71_ & ~x27 & new_n63_ & ~x28;
  assign z10 = x18 | (~x05 & ~x16) | (~new_n76_ & x16);
  assign new_n76_ = (~x29 | (new_n71_ & ~x27 & new_n63_ & ~x28)) & (~new_n71_ | x27 | ~new_n63_ | x28 | x29);
  assign z11 = (x18 & ~x33) | (~new_n78_ & ~x18 & (~x04 | x16));
  assign new_n78_ = (~x30 | (new_n63_ & new_n79_ & new_n71_ & ~x27)) & x16 & (~new_n63_ | ~new_n71_ | ~new_n79_ | x27 | x30);
  assign new_n79_ = ~x28 & ~x29;
  assign z12 = (x18 & ~x33) | ((new_n81_ | new_n83_ | ~x16) & ~x18 & (~x03 | x16));
  assign new_n81_ = x31 & (~new_n63_ | ~new_n71_ | ~new_n82_);
  assign new_n82_ = ~x28 & ~x29 & ~x27 & ~x30;
  assign new_n83_ = new_n84_ & new_n62_ & new_n64_ & ~x25 & ~x26 & ~x27;
  assign new_n84_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n86_ | (~new_n83_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n86_ = new_n62_ & new_n64_ & new_n82_ & new_n87_;
  assign new_n87_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = (~x33 | (~x18 & (~new_n86_ | ~x16))) & (x18 | (~x01 & ~x16) | (x16 & (new_n86_ | x33)));
  assign z15 = x18 | (~x00 & ~x16) | ((new_n90_ | x34) & x16 & (~new_n90_ | ~x34));
  assign new_n90_ = new_n63_ & ~x24 & ~x25 & new_n84_ & new_n91_;
