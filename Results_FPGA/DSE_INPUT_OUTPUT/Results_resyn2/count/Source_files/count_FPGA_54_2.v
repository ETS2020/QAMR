...
module FAU ( 
  ...
  assign z08 = x18 | ((new_n73_ | new_n74_ | ~x16) & ~x03 & (~x07 | x16));
  assign new_n73_ = x27 & (~new_n64_ | x24 | x25 | x26);
  assign new_n74_ = new_n75_ & new_n57_ & new_n66_;
  assign new_n75_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n77_ | (~new_n74_ & x28))) | ~new_n55_ | (~x06 & ~x16);
  assign new_n77_ = new_n78_ & new_n58_ & ~x22;
  assign new_n78_ = ~x24 & ~x25 & ~x26 & ~x28 & ~x23 & ~x27;
  assign z10 = (x16 & (new_n80_ | (~new_n77_ & x29))) | ~new_n55_ | (~x05 & ~x16);
  assign new_n80_ = new_n81_ & new_n64_ & ~x24 & ~x25 & ~x26;
  assign new_n81_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (~new_n80_ ^ ~x30)) | ~new_n55_ | (~x04 & ~x16);
  assign z12 = (x31 & (~new_n80_ | x30)) | new_n84_ | ~new_n55_ | ~x16;
  assign new_n84_ = new_n57_ & new_n66_ & new_n75_ & new_n85_;
  assign new_n85_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (new_n89_ & (new_n87_ | ~x16 | (~new_n84_ & x32)));
  assign new_n87_ = new_n57_ & new_n66_ & new_n81_ & new_n88_;
  assign new_n88_ = ~x25 & ~x26 & ~x32 & ~x30 & ~x31;
  assign new_n89_ = ~x03 & (~x02 | x16);
  assign z14 = x18 | (new_n93_ & ((~new_n87_ & x33) | new_n91_ | ~x16));
  assign new_n91_ = new_n85_ & new_n92_ & new_n58_ & new_n69_ & ~x24 & ~x25;
