...
module FAU ( 
  ...
  assign z05 = x18 | (~x10 & ((~new_n65_ & x24) | new_n62_ | ~x16));
  ...
  assign new_n83_ = new_n63_ & new_n64_ & new_n74_ & new_n84_;
  assign new_n84_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n85_ = new_n54_ & (x03 | x16);
  assign z13 = x18 | (~new_n87_ & ~x10 & (~x02 | x16));
  assign new_n87_ = (~new_n74_ | ~new_n63_ | ~new_n64_ | ~new_n84_ | x32) & x16 & (~x32 | (new_n63_ & new_n64_ & new_n74_ & new_n84_));
