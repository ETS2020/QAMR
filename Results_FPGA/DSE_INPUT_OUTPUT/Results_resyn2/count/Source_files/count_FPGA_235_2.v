...
module FAU ( 
  ...
  assign z05 = (x18 & x27) | ((new_n64_ | new_n65_ | ~x16) & ~x18 & (~x10 | x16));
  ...
  assign new_n69_ = new_n61_ & new_n70_ & ~x25;
  assign new_n70_ = ~x23 & ~x24;
  assign z07 = (x18 & x27) | ((new_n72_ | new_n73_ | ~x16) & ~x18 & (~x08 | x16));
  assign new_n72_ = x26 & (~new_n61_ | ~new_n70_ | x25);
  ...
  assign z09 = new_n80_ | ((new_n78_ | new_n79_ | ~x16) & ~x18 & (~x06 | x16));
  assign new_n78_ = x28 & (~new_n62_ | ~new_n74_ | x24);
  assign new_n79_ = new_n61_ & new_n70_ & ~x25 & ~x28 & ~x26 & ~x27;
  assign new_n80_ = x27 & (x18 | (x16 & x28));
  assign z10 = (x16 & (new_n82_ | (~new_n79_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n82_ = new_n62_ & new_n74_ & ~x24 & ~x27 & ~x28 & ~x29;
  assign z11 = new_n87_ | ((new_n84_ | new_n86_ | ~x16) & ~x18 & (~x04 | x16));
  assign new_n84_ = ~x27 & new_n62_ & new_n85_ & new_n74_ & ~x24;
  assign new_n85_ = ~x30 & ~x28 & ~x29;
  assign new_n86_ = x30 & (~new_n61_ | x28 | x29 | ~new_n70_ | ~new_n74_);
  assign new_n87_ = x27 & (x18 | (x16 & x30));
  assign z12 = new_n92_ | ((new_n89_ | new_n90_ | ~x16) & ~x18 & (~x03 | x16));
  assign new_n89_ = x31 & (~new_n62_ | ~new_n85_ | ~new_n74_ | x24);
  assign new_n90_ = new_n91_ & new_n66_ & new_n67_ & ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x31 & ~x30 & ~x28 & ~x29;
  assign new_n92_ = x27 & (x18 | (x16 & x31));
  assign z13 = ~new_n96_ | (x16 & ((~new_n90_ & x32) | (new_n94_ & ~x27)));
  assign new_n94_ = new_n66_ & new_n67_ & new_n85_ & new_n95_;
  assign new_n95_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n96_ = ~x18 & (x02 | x16);
  assign z14 = new_n100_ | (new_n101_ & ((~new_n94_ & x33) | new_n98_ | ~x16));
  assign new_n98_ = new_n91_ & new_n99_ & new_n61_ & new_n70_ & ~x25;
