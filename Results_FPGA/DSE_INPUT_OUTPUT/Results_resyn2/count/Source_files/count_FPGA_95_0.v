...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n54_, new_n56_, new_n58_, new_n61_, new_n63_, new_n66_, new_n68_;
  ...
  assign z04 = x18 | (((new_n61_ & ~x23) | ~x16 | (~new_n61_ & x23)) & x27 & (~x11 | x16));
  assign new_n61_ = ~x21 & ~x22 & ~x20 & ~x17 & ~x19;
  assign z05 = ~new_n54_ | (~x10 & ~x16) | (x16 & (~new_n63_ ^ ~x24));
  assign new_n63_ = ~x23 & ~x21 & ~x22 & ~x20 & ~x17 & ~x19;
  assign z06 = (x16 & ((x25 & (~new_n63_ | x24)) | (new_n63_ & ~x24 & ~x25))) | ~new_n54_ | (~x09 & ~x16);
  assign z07 = ~new_n66_ | (x16 & (~x26 ^ (~new_n63_ | x24 | x25)));
  assign new_n66_ = (x08 | x16) & ~x18 & x27;
  assign z08 = ~new_n68_ | (x16 & (x26 | ~new_n63_ | x24 | x25));
