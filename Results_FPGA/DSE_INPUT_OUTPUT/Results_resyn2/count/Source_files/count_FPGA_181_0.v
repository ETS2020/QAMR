...
module FAU ( 
  ...
  assign z01 = (~new_n56_ & x16) | new_n54_ | x18 | (~x14 & ~x16);
  ...
  assign z08 = (~new_n70_ & x16) | (~x07 & ~x16) | new_n54_ | x18;
  assign new_n70_ = (~x27 | (new_n64_ & ~x24 & ~x25 & ~x26)) & (~new_n64_ | x24 | x27 | x25 | x26);
  assign z09 = (~new_n72_ & x16) | (~x06 & ~x16) | new_n54_ | x18;
  assign new_n72_ = (~x28 | (new_n64_ & ~x24 & ~x27 & ~x25 & ~x26)) & (x27 | x28 | ~new_n64_ | x24 | x25 | x26);
  assign z10 = (~new_n74_ & x16) | (~x05 & ~x16) | new_n54_ | x18;
  assign new_n74_ = (~x29 | (~x27 & ~x28 & new_n64_ & new_n75_)) & (~new_n64_ | ~new_n75_ | x29 | x27 | x28);
  assign new_n75_ = ~x24 & ~x25 & ~x26;
  assign z11 = ~new_n54_ & (x18 | (~x04 & ~x16) | (~new_n77_ & x16));
  assign new_n77_ = (~x30 | (new_n64_ & new_n75_ & ~x29 & ~x27 & ~x28)) & (~new_n64_ | ~new_n75_ | x27 | x28 | x29 | x30);
  assign z12 = ~new_n54_ & ((x16 & (new_n79_ | new_n81_)) | x18 | (~x03 & ~x16));
  assign new_n79_ = x31 & (~new_n64_ | ~new_n75_ | ~new_n80_);
  assign new_n80_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n81_ = new_n64_ & new_n82_ & ~x27 & ~x25 & ~x26;
  assign new_n82_ = ~x29 & ~x30 & ~x31 & ~x24 & ~x28;
  assign z13 = (~x32 & (~x33 | (new_n81_ & x16))) | x18 | (~x02 & ~x16) | (~new_n81_ & x16 & x32);
  assign z14 = ((x32 | x33) & (x18 | (~x01 & ~x16))) | (~new_n85_ & x16 & x33);
  assign new_n85_ = new_n80_ & new_n86_ & new_n64_ & ~x24;
