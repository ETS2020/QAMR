...
module FAU ( 
  ...
  assign z03 = (~x12 & ~x16 & ~x18) | (x16 & ((~new_n58_ & x22) | x18 | (new_n58_ & ~x22)));
  ...
  assign z07 = x18 | ((~x08 | x16) & ((new_n64_ & ~x26) | ~x16 | (~new_n64_ & x26)));
  ...
  assign z09 = (x16 & ((x28 & (~new_n63_ | ~new_n70_)) | x18 | (new_n63_ & new_n70_ & ~x28))) | (~x06 & ~x16 & ~x18);
  assign z10 = (x16 & (new_n74_ | (~new_n73_ & x29))) | x18 | (~x05 & ~x16);
  ...
  assign z11 = x18 | (~x04 & ~x16) | (x16 & ((x30 & (~new_n68_ | ~new_n75_)) | (new_n68_ & new_n75_ & ~x30)));
  assign z12 = (~x03 & ~x16 & ~x18) | (x16 & ((~new_n78_ & x31) | new_n80_ | x18));
  assign new_n78_ = new_n79_ & ~x26 & new_n58_ & new_n65_ & ~x24 & ~x25;
  assign new_n79_ = ~x30 & ~x27 & ~x28 & ~x29;
  assign new_n80_ = new_n61_ & ~x24 & new_n70_ & new_n81_;
  assign new_n81_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (~x02 & ~x16 & ~x18) | (x16 & ((~new_n80_ & x32) | new_n83_ | x18));
  assign new_n83_ = new_n61_ & ~x24 & new_n79_ & new_n84_;
  assign new_n84_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = (~x01 & ~x16 & ~x18) | (x16 & ((~new_n83_ & x33) | new_n86_ | x18));
  assign new_n86_ = new_n58_ & new_n65_ & ~x24 & ~x25 & new_n81_ & new_n87_;
