...
module FAU ( 
  ...
  wire new_n54_, new_n57_, new_n58_, new_n62_, new_n63_, new_n64_, new_n68_,
    new_n69_, new_n70_, new_n72_, new_n73_, new_n77_, new_n78_, new_n79_,
  ...
  assign z04 = x18 | (x16 & (((~new_n58_ | x22) & x23) | (new_n58_ & ~x22 & ~x23)));
  ...
  assign z09 = (x28 & (~new_n62_ | ~new_n70_)) | new_n72_ | ~new_n54_;
  assign new_n72_ = new_n58_ & ~x22 & new_n69_ & new_n73_ & ~x23;
  assign new_n73_ = ~x27 & ~x28;
  assign z10 = x18 | (x16 & ((~new_n72_ & x29) | (new_n68_ & new_n73_ & ~x29)));
  assign z11 = (x30 & (~new_n64_ | ~new_n69_ | ~new_n73_ | x29)) | ~new_n54_ | (new_n64_ & new_n69_ & new_n73_ & ~x29 & ~x30);
  assign z12 = x18 | (x16 & (new_n79_ | (~new_n77_ & x31)));
  assign new_n77_ = new_n64_ & new_n69_ & new_n78_;
  assign new_n78_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n79_ = new_n57_ & new_n63_ & ~x21 & ~x24 & new_n70_ & new_n80_;
  assign new_n80_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = x18 | (x16 & (new_n82_ | (~new_n79_ & x32)));
  assign new_n82_ = new_n57_ & new_n63_ & ~x21 & ~x24 & new_n78_ & new_n83_;
  assign new_n83_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = (~new_n82_ & x33) | new_n85_ | ~new_n54_;
  assign new_n85_ = new_n80_ & new_n86_ & new_n64_ & ~x24 & ~x25;
  assign new_n86_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign z15 = (new_n85_ & ~x34) | ~new_n54_ | (~new_n85_ & x34);
endmodule
