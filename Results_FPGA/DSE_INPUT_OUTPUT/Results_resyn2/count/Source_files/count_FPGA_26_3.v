...
module FAU ( 
  ...
  assign new_n68_ = new_n58_ & new_n65_ & ~x24 & ~x25;
  assign z07 = (~x05 & x18) | (~new_n70_ & ~x18 & (~x08 | x16));
  assign new_n70_ = (~new_n58_ | ~new_n65_ | x24 | x25 | x26) & x16 & (~x26 | (new_n58_ & new_n65_ & ~x24 & ~x25));
  assign z08 = (~x05 & x18) | ((new_n72_ | new_n74_ | ~x16) & ~x18 & (~x07 | x16));
  ...
  assign z09 = new_n60_ | (new_n79_ & (new_n77_ | ~x16 | (~new_n74_ & x28)));
  assign new_n77_ = new_n78_ & new_n66_ & ~x28;
  assign new_n78_ = ~x27 & ~x24 & ~x25 & ~x26;
  assign new_n79_ = ~x18 & (~x06 | x16);
  assign z10 = (new_n81_ | ~x05) & ((x29 & (~new_n78_ | ~new_n66_ | x28)) | ~new_n81_ | (new_n78_ & new_n66_ & ~x28 & ~x29));
  assign new_n81_ = x16 & ~x18;
  assign z11 = (~x05 & x18) | (~new_n83_ & ~x18 & (~x04 | x16));
  assign new_n83_ = (~x30 | (new_n73_ & ~x27 & new_n66_ & new_n84_)) & x16 & (~new_n66_ | ~new_n73_ | ~new_n84_ | x27 | x30);
  assign new_n84_ = ~x28 & ~x29;
  assign z12 = (~x05 & x18) | ((new_n86_ | new_n88_ | ~x16) & ~x18 & (~x03 | x16));
  assign new_n86_ = x31 & (~new_n87_ | ~new_n66_ | ~new_n73_);
  assign new_n87_ = ~x28 & ~x29 & ~x27 & ~x30;
  assign new_n88_ = new_n64_ & new_n65_ & ~x21 & ~x24 & new_n75_ & new_n89_;
  assign new_n89_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n60_ | (new_n93_ & (new_n91_ | ~x16 | (~new_n88_ & x32)));
  assign new_n91_ = new_n64_ & new_n65_ & ~x21 & ~x24 & new_n87_ & new_n92_;
  assign new_n92_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n93_ = ~x18 & (~x02 | x16);
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n95_ | (~new_n91_ & x33)));
  assign new_n95_ = new_n58_ & new_n65_ & ~x24 & ~x25 & new_n89_ & new_n96_;
