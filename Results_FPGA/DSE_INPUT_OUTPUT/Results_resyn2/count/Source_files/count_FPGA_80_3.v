...
module FAU ( 
  ...
  assign new_n61_ = (~new_n56_ | ~new_n63_) & (new_n62_ | ~x24);
  ...
  assign new_n73_ = ~x27 & ~x28 & new_n62_ & ~x24 & ~x25 & ~x26;
  assign new_n74_ = ~x05 & x18;
  assign new_n75_ = ~x18 & (~x06 | x16);
  assign z10 = (~x05 | (x16 & ~x18)) & ((~new_n73_ & x29) | new_n77_ | ~x16 | x18);
  assign new_n77_ = new_n62_ & new_n78_ & ~x24 & ~x25 & ~x26;
  assign new_n78_ = ~x27 & ~x28 & ~x29;
  assign z11 = (~x05 & x18) | (((new_n77_ & ~x30) | ~x16 | (~new_n77_ & x30)) & ~x18 & (~x04 | x16));
  assign z12 = ~new_n83_ | (x16 & (new_n81_ | (x31 & (~new_n77_ | x30))));
  assign new_n81_ = new_n82_ & new_n56_ & new_n63_ & ~x25 & ~x26 & ~x27;
  assign new_n82_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n83_ = ~x18 & (x03 | x16);
  assign z13 = (x16 & (new_n85_ | (~new_n81_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n85_ = new_n56_ & new_n63_ & new_n78_ & new_n86_;
  assign new_n86_ = ~x25 & ~x26 & ~x32 & ~x30 & ~x31;
  assign z14 = new_n74_ | (new_n90_ & ((~new_n85_ & x33) | new_n88_ | ~x16));
  assign new_n88_ = new_n57_ & new_n67_ & new_n82_ & new_n89_;
  assign new_n89_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign new_n90_ = ~x18 & (~x01 | x16);
  assign z15 = (~x05 & x18) | (((new_n88_ & ~x34) | ~x16 | (~new_n88_ & x34)) & ~x18 & (~x00 | x16));
endmodule
