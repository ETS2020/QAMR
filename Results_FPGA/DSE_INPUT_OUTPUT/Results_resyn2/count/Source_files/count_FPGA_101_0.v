...
module FAU ( 
  ...
  assign new_n68_ = new_n57_ & new_n63_ & ~x27 & ~x25 & ~x26;
  assign new_n69_ = ~x24 & ~x25 & ~x26;
  assign z09 = (~new_n68_ & x28) | new_n71_ | ~new_n55_;
  assign new_n71_ = new_n58_ & ~x22 & new_n69_ & ~x23 & ~x27 & ~x28;
  ...
  assign z12 = (~new_n77_ & x31) | ~new_n55_ | (new_n68_ & new_n79_);
  assign new_n77_ = new_n78_ & new_n64_ & new_n69_;
  assign new_n78_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n79_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = (x32 & (~new_n68_ | ~new_n79_)) | ~new_n55_ | (new_n62_ & new_n81_);
  ...
  assign z15 = (new_n83_ & ~x34) | ~new_n55_ | (~new_n83_ & x34);
endmodule
