...
module FAU ( 
  ...
  wire new_n54_, new_n57_, new_n58_, new_n62_, new_n63_, new_n64_, new_n66_,
    new_n67_, new_n69_, new_n71_, new_n73_, new_n75_, new_n78_, new_n79_,
    new_n82_, new_n83_;
  ...
  assign new_n69_ = new_n64_ & ~x24 & ~x25 & ~x26;
  assign z08 = (~new_n69_ & x27) | ~new_n54_ | (new_n62_ & new_n71_);
  assign new_n71_ = ~x27 & ~x25 & ~x26;
  assign z09 = new_n73_ | ~new_n54_ | (x28 & (~new_n62_ | ~new_n71_));
  assign new_n73_ = new_n58_ & ~x22 & new_n71_ & ~x23 & ~x24 & ~x28;
  assign z10 = x18 | (x16 & (new_n75_ | (~new_n73_ & x29)));
  assign new_n75_ = new_n64_ & new_n71_ & ~x24 & ~x28 & ~x29;
  assign z11 = x18 | (x16 & (~new_n75_ ^ ~x30));
  assign z12 = new_n78_ | ~new_n54_ | (x31 & (~new_n75_ | x30));
  assign new_n78_ = new_n57_ & new_n63_ & new_n71_ & new_n79_;
  assign new_n79_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x16 & (~new_n78_ ^ ~x32));
  assign z14 = new_n82_ | ~new_n54_ | (x33 & (~new_n78_ | x32));
  assign new_n82_ = new_n58_ & new_n67_ & new_n79_ & new_n83_;
