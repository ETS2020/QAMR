...
module FAU ( 
  ...
  wire new_n55_, new_n58_, new_n61_, new_n62_, new_n63_, new_n64_, new_n65_,
    new_n67_, new_n68_, new_n71_, new_n72_, new_n73_, new_n75_, new_n76_,
  ...
  assign z05 = (x00 & x18) | ((new_n61_ | new_n63_ | ~x16) & ~x18 & (~x10 | x16));
  ...
  assign z08 = (x00 & x18) | ((new_n71_ | new_n73_ | ~x16) & ~x18 & (~x07 | x16));
  assign new_n71_ = x27 & (~new_n62_ | ~new_n72_);
  assign new_n72_ = ~x26 & ~x24 & ~x25;
  assign new_n73_ = new_n64_ & new_n65_ & ~x25 & ~x26 & ~x27;
  assign z09 = new_n76_ | (new_n77_ & ((~new_n73_ & x28) | new_n75_ | ~x16));
  assign new_n75_ = new_n58_ & ~x22 & new_n72_ & ~x28 & ~x23 & ~x27;
  ...
  assign z13 = (x00 & x18) | (((new_n82_ & ~x32) | ~x16 | (~new_n82_ & x32)) & ~x18 & (~x02 | x16));
  assign z14 = ~new_n89_ | (x16 & (new_n87_ | (x33 & (~new_n82_ | x32))));
  assign new_n87_ = new_n62_ & new_n68_ & new_n83_ & new_n88_;
