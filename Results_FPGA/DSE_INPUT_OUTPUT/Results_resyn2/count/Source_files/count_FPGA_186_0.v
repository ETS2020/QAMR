// Benchmark "FAU" written by ABC on Wed Aug 12 18:31:26 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n56_, new_n57_, new_n58_, new_n62_, new_n63_, new_n64_, new_n68_,
  ...
  assign z02 = (~new_n56_ & x21) | new_n57_ | ~new_n58_;
  ...
  assign z07 = (x26 & (~new_n64_ | x24 | x25)) | ~new_n58_ | (new_n64_ & ~x24 & ~x25 & ~x26);
  assign z08 = x18 | (x16 & (new_n70_ | (~new_n68_ & x27)));
  assign new_n68_ = new_n64_ & new_n69_;
  assign new_n69_ = ~x24 & ~x25 & ~x26;
  assign new_n70_ = new_n71_ & new_n56_ & new_n63_;
  assign new_n71_ = ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (x16 & ((~new_n70_ & x28) | (new_n68_ & ~x27 & ~x28)));
  assign z10 = (x29 & (x27 | x28 | ~new_n64_ | ~new_n69_)) | ~new_n58_ | (new_n64_ & new_n69_ & ~x27 & ~x28 & ~x29);
  ...
  assign z14 = x18 | (x16 & (new_n84_ | ((~new_n62_ | ~new_n82_) & x33)));
  assign new_n84_ = new_n64_ & ~x24 & ~x25 & new_n80_ & new_n85_;
  assign new_n85_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign z15 = (new_n84_ & ~x34) | ~new_n58_ | (~new_n84_ & x34);
endmodule
