...
module FAU ( 
  ...
  assign new_n61_ = x27 & (~x11 | x16);
  assign z05 = x18 | (((~new_n63_ & x24) | ~x16 | (new_n63_ & ~x24)) & x27 & (~x10 | x16));
  assign new_n63_ = ~x20 & ~x21 & ~x17 & ~x19 & ~x22 & ~x23;
  assign z06 = ~new_n66_ | (x16 & ((x25 & (x24 | ~new_n59_ | ~new_n65_)) | (new_n59_ & new_n65_ & ~x24 & ~x25)));
  assign new_n65_ = ~x22 & ~x23;
  assign new_n66_ = (x09 | x16) & ~x18 & x27;
  assign z07 = x18 | (new_n69_ & ((x26 & (~new_n59_ | ~new_n68_)) | ~x16 | (~x26 & new_n59_ & new_n68_)));
  assign new_n68_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n69_ = x27 & (~x08 | x16);
  assign z08 = (x16 & (x26 | ~new_n59_ | ~new_n68_)) | ~new_n54_ | (~x07 & ~x16);
