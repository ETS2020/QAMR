...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n61_, new_n62_, new_n63_, new_n67_, new_n68_,
  ...
  assign z03 = (x22 & (~new_n57_ | x21)) | ~new_n55_ | (new_n57_ & ~x21 & ~x22);
  assign z04 = x18 | (x16 & ((x23 & (~new_n57_ | x21 | x22)) | (new_n57_ & ~x23 & ~x21 & ~x22)));
  assign z05 = (~new_n63_ & x24) | new_n61_ | ~new_n55_;
  assign new_n61_ = new_n57_ & new_n62_;
  assign new_n62_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n63_ = ~x20 & ~x17 & ~x19 & ~x23 & ~x21 & ~x22;
  assign z06 = (new_n63_ & ~x24 & ~x25) | ~new_n55_ | (~new_n61_ & x25);
  assign z07 = x18 | (x16 & ((x26 & (~new_n63_ | x24 | x25)) | (new_n63_ & ~x24 & ~x25 & ~x26)));
  assign z08 = (~new_n67_ & x27) | ~new_n55_ | (new_n61_ & new_n69_);
  ...
  assign z11 = (x30 & (~new_n63_ | ~new_n68_ | ~new_n74_ | x29)) | ~new_n55_ | (new_n63_ & new_n68_ & new_n74_ & ~x29 & ~x30);
  ...
  assign z13 = x18 | (x16 & ((new_n61_ & new_n82_) | (~new_n79_ & x32)));
  assign new_n82_ = new_n78_ & ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = new_n84_ | ~new_n55_ | (x33 & (~new_n61_ | ~new_n82_));
