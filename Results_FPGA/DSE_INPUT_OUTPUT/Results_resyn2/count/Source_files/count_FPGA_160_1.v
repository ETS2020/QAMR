...
module FAU ( 
  ...
  assign z04 = (x16 & (((~new_n58_ | ~new_n62_) & x23) | (new_n58_ & new_n62_ & ~x23))) | x18 | (~x11 & ~x16);
  ...
  assign new_n77_ = new_n78_ & new_n58_ & new_n62_;
  assign new_n78_ = ~x27 & ~x25 & ~x26 & ~x23 & ~x24 & ~x28;
  assign z10 = (x05 & x18) | (~x18 & (~x05 | x16) & ((~new_n77_ & x29) | new_n80_ | ~x16));
  assign new_n80_ = new_n65_ & new_n73_ & new_n81_ & ~x27;
  assign new_n81_ = ~x28 & ~x29;
  assign z11 = (x05 & x18) | (~new_n83_ & ~x18 & (~x04 | x16));
  assign new_n83_ = (~x30 | (new_n65_ & new_n73_ & new_n81_ & ~x27)) & x16 & (~new_n65_ | ~new_n73_ | ~new_n81_ | x27 | x30);
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n85_ | new_n87_));
  assign new_n85_ = x31 & (~new_n86_ | ~new_n65_ | ~new_n73_);
  assign new_n86_ = ~x28 & ~x29 & ~x27 & ~x30;
  assign new_n87_ = new_n88_ & new_n75_ & new_n58_ & new_n66_;
  ...
  assign new_n93_ = new_n65_ & ~x24 & ~x25 & new_n88_ & new_n94_;
