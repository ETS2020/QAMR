// Benchmark "FAU" written by ABC on Wed Aug 12 18:31:38 2020
...
module FAU ( 
  ...
  assign z08 = x18 | ((new_n72_ | new_n73_ | ~x16) & x00 & (~x07 | x16));
  assign new_n72_ = x27 & (~new_n65_ | x24 | x25 | x26);
  assign new_n73_ = new_n63_ & new_n64_ & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (new_n76_ & (new_n75_ | ~x16 | (~new_n73_ & x28)));
  assign new_n75_ = ~x27 & ~x28 & new_n65_ & ~x24 & ~x25 & ~x26;
  assign new_n76_ = x00 & (~x06 | x16);
  assign z10 = ~new_n79_ | (x16 & ((x29 & (~new_n78_ | x27 | x28)) | (new_n78_ & ~x27 & ~x28 & ~x29)));
  assign new_n78_ = new_n65_ & ~x24 & ~x25 & ~x26;
  assign new_n79_ = new_n57_ & (x05 | x16);
  assign z11 = ~new_n57_ | (~x04 & ~x16) | (x16 & ((x30 & (~new_n78_ | ~new_n81_)) | (new_n78_ & new_n81_ & ~x30)));
  assign new_n81_ = ~x27 & ~x28 & ~x29;
  assign z12 = x18 | ((new_n83_ | new_n85_ | ~x16) & x00 & (~x03 | x16));
  ...
  assign new_n88_ = new_n84_ & new_n89_ & new_n63_ & new_n64_;
  ...
  assign z15 = x18 | ((~new_n92_ | ~x34) & x00 & x16 & (new_n92_ | x34));
endmodule
