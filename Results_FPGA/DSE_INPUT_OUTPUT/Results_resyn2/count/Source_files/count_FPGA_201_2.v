...
module FAU ( 
  ...
  assign z05 = (x18 & x33) | ((new_n62_ | new_n64_ | ~x16) & ~x18 & (~x10 | x16));
  ...
  assign z08 = (x18 & x33) | ((new_n71_ | new_n73_ | ~x16) & ~x18 & (~x07 | x16));
  ...
  assign new_n76_ = new_n77_ & new_n63_ & new_n72_;
  assign new_n77_ = ~x27 & ~x28;
  assign new_n78_ = x18 & x33;
  assign new_n79_ = ~x18 & (~x06 | x16);
  assign z10 = x18 | (~x05 & ~x16) | (~new_n81_ & x16);
  assign new_n81_ = (~x29 | (new_n77_ & new_n63_ & new_n72_)) & (~new_n63_ | ~new_n72_ | ~new_n77_ | x29);
  assign z11 = (x18 & x33) | (~new_n83_ & ~x18 & (~x04 | x16));
  ...
  assign new_n85_ = x31 & (~new_n86_ | ~new_n63_ | ~new_n72_);
  ...
  assign z15 = new_n96_ | (new_n97_ & (~x16 | (~new_n90_ & x34) | (new_n93_ & ~x34)));
  assign new_n96_ = x33 & (x18 | (x16 & x34));
