...
module FAU ( 
  ...
  assign z06 = x18 | ((new_n66_ | new_n67_ | ~x16) & x05 & (~x09 | x16));
  assign new_n66_ = x25 & (~new_n57_ | ~new_n63_);
  ...
  assign new_n72_ = new_n57_ & new_n63_ & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (new_n75_ & (new_n74_ | ~x16 | (~new_n72_ & x28)));
  assign new_n74_ = ~x27 & ~x28 & new_n64_ & ~x24 & ~x25 & ~x26;
  assign new_n75_ = x05 & (~x06 | x16);
  assign z10 = x18 | ((new_n77_ | (~new_n74_ & x29)) & x05 & x16);
  assign new_n77_ = new_n64_ & new_n78_ & ~x24 & ~x25 & ~x26;
  assign new_n78_ = ~x27 & ~x28 & ~x29;
  assign z11 = x18 | ((~x16 | (~new_n77_ & x30) | (new_n77_ & ~x30)) & x05 & (~x04 | x16));
  assign z12 = ~new_n83_ | (x16 & (new_n81_ | (x31 & (~new_n77_ | x30))));
  assign new_n81_ = new_n82_ & new_n57_ & new_n63_ & ~x25 & ~x26 & ~x27;
  assign new_n82_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n83_ = new_n54_ & (x03 | x16);
  assign z13 = (x16 & (new_n85_ | (~new_n81_ & x32))) | ~new_n54_ | (~x02 & ~x16);
  assign new_n85_ = new_n57_ & new_n63_ & new_n78_ & new_n86_;
  assign new_n86_ = ~x25 & ~x26 & ~x32 & ~x30 & ~x31;
  assign z14 = x18 | (new_n90_ & ((~new_n85_ & x33) | new_n88_ | ~x16));
  assign new_n88_ = new_n58_ & new_n68_ & new_n82_ & new_n89_;
  assign new_n89_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign new_n90_ = x05 & (~x01 | x16);
  assign z15 = x18 | ((~x16 | (~new_n88_ & x34) | (new_n88_ & ~x34)) & x05 & (~x00 | x16));
endmodule
