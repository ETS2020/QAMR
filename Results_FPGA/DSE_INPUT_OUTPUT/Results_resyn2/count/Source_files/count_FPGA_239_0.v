...
module FAU ( 
  ...
  assign z05 = (x16 & (~x24 ^ (~new_n59_ | ~new_n63_))) | ~new_n54_ | (~x10 & ~x16);
  assign new_n63_ = ~x22 & ~x23;
  assign z06 = ~new_n65_ | (x16 & ((x25 & (x24 | ~new_n59_ | ~new_n63_)) | (new_n59_ & new_n63_ & ~x24 & ~x25)));
  ...
  assign z08 = ~new_n54_ | (~x07 & ~x16) | (x16 & (x26 | ~new_n59_ | ~new_n67_));
