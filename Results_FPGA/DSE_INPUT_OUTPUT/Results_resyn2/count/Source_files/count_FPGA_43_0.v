...
module FAU ( 
  ...
  assign new_n65_ = new_n57_ & new_n62_ & ~x24 & ~x25;
  assign z07 = x18 | (x16 & (new_n67_ | (~new_n65_ & x26)));
  assign new_n67_ = new_n63_ & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (x16 & ((~new_n67_ & x27) | (new_n61_ & new_n69_)));
  assign new_n69_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x28 & (~new_n61_ | ~new_n69_)) | new_n71_ | ~x16 | x18;
  assign new_n71_ = ~x27 & ~x28 & new_n63_ & ~x24 & ~x25 & ~x26;
  assign z10 = (new_n71_ & ~x29) | (~new_n71_ & x29) | ~x16 | x18;
  assign z11 = new_n74_ | ~x16 | x18 | (x30 & (~new_n71_ | x29));
  assign new_n74_ = new_n63_ & new_n75_ & ~x24 & ~x25 & ~x26;
  assign new_n75_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (x16 & (new_n77_ | (~new_n74_ & x31)));
  assign new_n77_ = new_n56_ & new_n62_ & ~x21 & ~x24 & new_n69_ & new_n78_;
  assign new_n78_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = x18 | (x16 & (new_n80_ | (~new_n77_ & x32)));
  assign new_n80_ = new_n56_ & new_n62_ & ~x21 & ~x24 & new_n75_ & new_n81_;
  assign new_n81_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = (~new_n80_ & x33) | new_n83_ | ~x16 | x18;
  assign new_n83_ = new_n57_ & new_n62_ & ~x24 & ~x25 & new_n78_ & new_n84_;
