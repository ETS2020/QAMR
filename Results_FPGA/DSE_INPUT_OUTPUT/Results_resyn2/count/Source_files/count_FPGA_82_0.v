...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n54_, new_n57_, new_n59_, new_n60_, new_n63_, new_n66_, new_n68_,
  ...
  assign z03 = x18 | (~new_n59_ & x31 & (~x12 | x16));
  assign new_n59_ = (~x22 | (new_n57_ & ~x21)) & ~new_n60_ & x16;
  assign new_n60_ = ~x21 & ~x22 & ~x20 & ~x17 & ~x19;
  assign z04 = x18 | (((new_n60_ & ~x23) | ~x16 | (~new_n60_ & x23)) & x31 & (~x11 | x16));
  assign z05 = (x16 & (new_n63_ ^ x24)) | ~new_n54_ | (~x10 & ~x16);
  assign new_n63_ = ~x23 & ~x21 & ~x22 & ~x20 & ~x17 & ~x19;
  assign z06 = ~new_n54_ | (~x09 & ~x16) | (x16 & ((x25 & (~new_n63_ | x24)) | (new_n63_ & ~x24 & ~x25)));
  assign z07 = (~new_n66_ & x16) | ~new_n54_ | (~x08 & ~x16);
  assign new_n66_ = (~x26 | (new_n63_ & ~x24 & ~x25)) & (~new_n63_ | x26 | x24 | x25);
  assign z08 = (~new_n68_ & x16) | ~new_n54_ | (~x07 & ~x16);
  assign new_n68_ = (~x27 | (new_n69_ & new_n60_ & ~x23)) & (~new_n60_ | ~new_n69_ | x23 | x27);
  assign new_n69_ = ~x26 & ~x24 & ~x25;
  assign z09 = x18 | (((new_n71_ & ~x28) | ~x16 | (~new_n71_ & x28)) & x31 & (~x06 | x16));
  assign new_n71_ = new_n60_ & new_n69_ & ~x23 & ~x27;
  assign z10 = ~new_n74_ | (x16 & (new_n73_ | (x29 & (~new_n71_ | x28))));
  assign new_n73_ = new_n63_ & new_n69_ & ~x29 & ~x27 & ~x28;
  assign new_n74_ = new_n54_ & (x05 | x16);
  assign z11 = ~new_n54_ | (~x04 & ~x16) | (x16 & (~new_n73_ ^ ~x30));
