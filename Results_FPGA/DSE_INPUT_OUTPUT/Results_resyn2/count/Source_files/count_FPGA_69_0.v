...
module FAU ( 
  ...
  assign z12 = (x31 & (~new_n68_ | ~new_n78_)) | new_n76_ | ~new_n54_;
  assign new_n76_ = new_n57_ & new_n63_ & new_n70_ & new_n77_;
  assign new_n77_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign new_n78_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = x18 | (x16 & ((~new_n76_ & x32) | (new_n62_ & new_n80_)));
  assign new_n80_ = new_n78_ & ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = x18 | (x16 & (new_n82_ | ((~new_n62_ | ~new_n80_) & x33)));
  assign new_n82_ = new_n77_ & new_n83_ & new_n64_ & ~x24 & ~x25;
