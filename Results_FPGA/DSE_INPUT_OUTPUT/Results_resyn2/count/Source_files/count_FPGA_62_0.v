...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n54_, new_n56_, new_n58_, new_n60_, new_n63_, new_n65_, new_n67_;
  ...
  assign z02 = x18 | (((new_n58_ & ~x21) | ~x16 | (~new_n58_ & x21)) & x27 & (~x13 | x16));
  ...
  assign new_n67_ = ~x24 & ~x25 & new_n60_ & ~x22 & ~x23;
  assign z08 = ~new_n54_ | (~x07 & ~x16) | (x16 & (~new_n67_ | x26));
  assign z09 = ~new_n54_ | (~x06 & ~x16) | (x16 & x28);
  assign z10 = x18 | ((~x05 | x16) & x27 & (~x16 | x29));
