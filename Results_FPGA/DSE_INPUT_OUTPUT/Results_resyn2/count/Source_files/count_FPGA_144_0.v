...
module FAU ( 
  ...
  assign z07 = (~new_n65_ & x26) | new_n68_ | ~new_n54_;
  ...
  assign z12 = x18 | (x16 & ((~new_n78_ & x31) | (new_n71_ & new_n80_)));
  assign new_n78_ = new_n63_ & new_n69_ & new_n79_;
  assign new_n79_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n80_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = (x32 & (~new_n80_ | ~new_n61_ | ~new_n72_)) | ~new_n54_ | (new_n61_ & new_n82_);
  assign new_n82_ = new_n79_ & ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = x18 | (x16 & (new_n84_ | (x33 & (~new_n61_ | ~new_n82_))));
  assign new_n84_ = new_n58_ & new_n66_ & ~x24 & ~x25 & new_n80_ & new_n85_;
