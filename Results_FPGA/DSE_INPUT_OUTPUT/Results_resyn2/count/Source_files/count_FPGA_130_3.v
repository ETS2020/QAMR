// Benchmark "FAU" written by ABC on Wed Aug 12 18:31:06 2020
...
module FAU ( 
  ...
  assign z02 = (~x16 & (~x13 | x18)) | ((new_n57_ | (~new_n56_ & x21)) & x16 & ~x18);
  assign new_n56_ = ~x20 & ~x17 & ~x19;
  assign new_n57_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z03 = (~x16 & (~x12 | x18)) | (x16 & ~x18 & (new_n57_ ^ x22));
  ...
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n68_ | (~new_n65_ & x26)));
  ...
  assign z10 = (~x16 & (~x05 | x18)) | ((new_n76_ | (~new_n73_ & x29)) & x16 & ~x18);
  assign new_n76_ = new_n63_ & new_n69_ & ~x29 & ~x27 & ~x28;
  assign z11 = (~x16 & (~x04 | x18)) | (~new_n78_ & x16 & ~x18);
  assign new_n78_ = (~x30 | (new_n63_ & new_n69_ & ~x29 & ~x27 & ~x28)) & (~new_n63_ | ~new_n69_ | x27 | x28 | x29 | x30);
  assign z12 = (~x16 & (~x03 | x18)) | ((new_n82_ | (~new_n80_ & x31)) & x16 & ~x18);
  ...
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n85_ | (~new_n82_ & x32)));
  ...
  assign z15 = (~x16 & (~x00 | x18)) | ((~new_n88_ | ~x34) & x16 & ~x18 & (new_n88_ | x34));
endmodule
