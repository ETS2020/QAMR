...
module FAU ( 
  ...
  assign new_n79_ = ~x30 & ~x31 & new_n64_ & new_n70_ & new_n74_ & ~x29;
  assign z13 = ~new_n84_ | (~x31 & (x18 | (x16 & (new_n81_ | new_n82_))));
  assign new_n81_ = x32 & (~new_n64_ | ~new_n70_ | ~new_n74_ | x29 | x30);
  assign new_n82_ = new_n64_ & ~x24 & new_n83_ & new_n74_ & ~x29;
  assign new_n83_ = ~x25 & ~x26 & ~x30 & ~x32;
  assign new_n84_ = (x00 | (x32 ? (~x16 | ~x31) : ~x18)) & ((x02 & (x00 | ~x18)) | x16 | (x00 & x31));
  assign z14 = ~new_n86_ | (x16 & ((~new_n82_ & x33) | (new_n79_ & ~x32 & ~x33)));
  assign new_n86_ = (~x31 | (~x00 & (~x16 | ~x33))) & ~x18 & (x01 | x16);
  assign z15 = ~new_n92_ | (new_n91_ & (new_n88_ | (x34 & (~new_n78_ | ~new_n90_))));
  assign new_n88_ = new_n89_ & new_n64_ & new_n70_ & new_n74_ & ~x29;
  assign new_n89_ = ~x32 & ~x33 & ~x30 & ~x34;
  assign new_n90_ = ~x32 & ~x33;
  assign new_n91_ = x16 & ~x31;
  assign new_n92_ = (~x18 | (x00 & x31)) & (x00 | (x16 & (~x31 | ~x34)));
endmodule
