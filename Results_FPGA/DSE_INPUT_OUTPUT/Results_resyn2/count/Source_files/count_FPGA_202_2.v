...
module FAU ( 
  ...
  assign new_n64_ = (~x26 | (~x25 & new_n61_ & ~x24)) & (~new_n61_ | x24 | x25 | x26);
  assign z08 = x18 | ((~x07 | x16) & ((~x27 & new_n61_ & new_n66_) | ~x16 | (x27 & (~new_n61_ | ~new_n66_))));
  assign new_n66_ = ~x24 & ~x25 & ~x26;
  assign z09 = (x18 & x31) | ((new_n68_ | new_n69_ | ~x16) & ~x18 & (~x06 | x16));
  assign new_n68_ = x28 & (x27 | ~new_n61_ | ~new_n66_);
  assign new_n69_ = new_n61_ & new_n66_ & ~x27 & ~x28;
  assign z10 = (x18 & x31) | (~x18 & (~x05 | x16) & ((new_n69_ & ~x29) | ~x16 | (~new_n69_ & x29)));
  assign z11 = new_n74_ | (new_n75_ & (~new_n72_ | (x30 & (~new_n69_ | x29))));
  assign new_n72_ = x16 & (~new_n73_ | ~new_n61_ | ~new_n66_);
  assign new_n73_ = ~x28 & ~x29 & ~x27 & ~x30;
  assign new_n74_ = x18 & x31;
  assign new_n75_ = ~x18 & (~x04 | x16);
  assign z12 = (~new_n77_ & ~x18) | (x31 & (new_n72_ | x18));
  assign new_n77_ = (x03 | x16) & (~new_n78_ | ~x16 | x27 | ~new_n61_ | ~new_n66_);
  assign new_n78_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n83_ | ((new_n80_ | new_n81_ | ~x16) & ~x18 & (~x02 | x16));
  assign new_n80_ = x32 & (~new_n73_ | ~new_n61_ | ~new_n66_);
  assign new_n81_ = new_n61_ & ~x24 & new_n73_ & new_n82_;
  assign new_n82_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n83_ = x31 & (x18 | (x16 & x32));
  assign z14 = (x16 & (new_n85_ | (~new_n81_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n85_ = new_n78_ & new_n86_ & ~x25 & new_n61_ & ~x24;
