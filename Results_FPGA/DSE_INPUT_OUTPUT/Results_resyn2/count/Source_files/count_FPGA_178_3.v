...
module FAU ( 
  ...
  assign z05 = (x16 & (new_n61_ | (new_n63_ & new_n56_ & ~x18))) | x18 | (~x10 & ~x16);
  ...
  assign z07 = (~x16 & (~x08 | x18)) | ((new_n69_ | (~new_n66_ & x26)) & x16 & ~x18);
  assign new_n69_ = new_n62_ & new_n70_;
  assign new_n70_ = ~x24 & ~x25 & ~x26;
  assign z08 = (x16 & (new_n72_ | (~new_n69_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n72_ = new_n56_ & new_n63_ & ~x25 & ~x26 & ~x27;
  assign z09 = (~x16 & (~x06 | x18)) | ((new_n74_ | (~new_n72_ & x28)) & x16 & ~x18);
  ...
  assign new_n77_ = new_n62_ & new_n70_ & ~x29 & ~x27 & ~x28;
  assign z11 = (~new_n79_ & x16) | x18 | (~x04 & ~x16);
  assign new_n79_ = (~x30 | (new_n62_ & new_n70_ & ~x29 & ~x27 & ~x28)) & (~new_n62_ | ~new_n70_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n83_ | (~new_n81_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n81_ = new_n62_ & new_n70_ & new_n82_;
  assign new_n82_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n83_ = new_n56_ & new_n63_ & new_n84_ & ~x25 & ~x26 & ~x27;
  assign new_n84_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = (x16 & (new_n86_ | (~new_n83_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n86_ = new_n56_ & new_n63_ & new_n82_ & new_n87_;
