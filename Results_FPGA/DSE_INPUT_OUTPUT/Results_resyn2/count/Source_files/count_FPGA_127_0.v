...
module FAU ( 
  ...
  assign new_n71_ = new_n72_ & new_n56_ & new_n63_ & ~x21 & ~x24;
  assign new_n72_ = ~x25 & ~x26 & ~x27;
  assign z09 = (~new_n71_ & x28) | ~new_n58_ | (new_n68_ & ~x27 & ~x28);
  ...
  assign z12 = new_n78_ | ~new_n58_ | (x31 & (~new_n68_ | ~new_n80_));
  assign new_n78_ = new_n56_ & new_n63_ & ~x21 & ~x24 & new_n72_ & new_n79_;
  assign new_n79_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign new_n80_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = x18 | (x16 & ((~new_n78_ & x32) | (new_n62_ & new_n82_)));
  assign new_n82_ = new_n80_ & ~x31 & ~x32 & ~x25 & ~x26;
  assign z14 = x18 | (x16 & (new_n84_ | (x33 & (~new_n62_ | ~new_n82_))));
  assign new_n84_ = new_n57_ & new_n63_ & ~x24 & ~x25 & new_n79_ & new_n85_;
