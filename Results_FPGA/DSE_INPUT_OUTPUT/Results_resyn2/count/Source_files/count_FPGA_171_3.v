...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n62_, new_n64_, new_n65_,
    new_n66_, new_n67_, new_n68_, new_n70_, new_n73_, new_n74_, new_n75_,
  ...
  assign z02 = (~x15 & x18) | (~new_n57_ & ~x18 & (~x13 | x16));
  assign new_n57_ = (~x21 | (~x20 & ~x17 & ~x19)) & x16 & (x17 | x19 | x20 | x21);
  assign z03 = (~x15 & x18) | (((new_n59_ & ~x22) | ~x16 | (~new_n59_ & x22)) & ~x18 & (~x12 | x16));
  ...
  assign z05 = (~x15 & x18) | ((new_n64_ | new_n66_ | ~x16) & ~x18 & (~x10 | x16));
  assign new_n64_ = ~new_n65_ & x24;
  assign new_n65_ = ~x22 & ~x23 & ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n66_ = new_n67_ & new_n68_ & ~x21 & ~x24;
  ...
  assign z07 = (x16 & (~new_n70_ ^ ~x26)) | x18 | (~x08 & ~x16);
  assign z08 = (~x15 & x18) | ((new_n73_ | new_n74_ | ~x16) & ~x18 & (~x07 | x16));
  assign new_n73_ = x27 & (x26 | ~new_n65_ | x24 | x25);
  assign new_n74_ = new_n75_ & new_n67_ & new_n68_ & ~x21 & ~x24;
  assign new_n75_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n77_ | (~new_n74_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n77_ = new_n78_ & ~x27 & new_n65_ & ~x28;
  assign new_n78_ = ~x24 & ~x25 & ~x26;
  assign z10 = (~x15 & x18) | (~new_n80_ & ~x18 & (~x05 | x16));
  assign new_n80_ = (~x29 | (new_n78_ & ~x27 & new_n65_ & ~x28)) & x16 & (~new_n78_ | x27 | ~new_n65_ | x28 | x29);
  assign z11 = (~x15 & x18) | (~new_n82_ & ~x18 & (~x04 | x16));
  assign new_n82_ = (~x30 | (new_n78_ & ~x27 & new_n65_ & new_n83_)) & x16 & (~new_n65_ | ~new_n78_ | ~new_n83_ | x27 | x30);
  assign new_n83_ = ~x28 & ~x29;
  assign z12 = (~x15 & x18) | ((new_n85_ | new_n87_ | ~x16) & ~x18 & (~x03 | x16));
  assign new_n85_ = x31 & (~new_n65_ | ~new_n78_ | ~new_n86_);
  assign new_n86_ = ~x28 & ~x29 & ~x27 & ~x30;
  assign new_n87_ = new_n67_ & new_n68_ & ~x21 & ~x24 & new_n75_ & new_n88_;
  assign new_n88_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n61_ | (new_n92_ & ((~new_n87_ & x32) | new_n90_ | ~x16));
  assign new_n90_ = new_n67_ & new_n68_ & ~x21 & ~x24 & new_n86_ & new_n91_;
  assign new_n91_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n92_ = ~x18 & (~x02 | x16);
  assign z14 = (x16 & (new_n94_ | (~new_n90_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n94_ = new_n88_ & new_n95_ & new_n65_ & ~x24 & ~x25;
