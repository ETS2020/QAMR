...
module FAU ( 
  ...
  assign z06 = (x18 & x31) | (~new_n63_ & ~x18 & (~x09 | x16));
  assign new_n63_ = (~x25 | (~x24 & new_n58_ & ~x22 & ~x23)) & x16 & (~new_n58_ | x24 | x25 | x22 | x23);
  assign z07 = (x18 & x31) | (~new_n65_ & ~x18 & (~x08 | x16));
  assign new_n65_ = (~new_n58_ | x22 | x23 | ~new_n66_ | x26) & x16 & (~x26 | (new_n58_ & new_n66_ & ~x22 & ~x23));
  assign new_n66_ = ~x24 & ~x25;
  assign z08 = (x18 & x31) | ((new_n68_ | new_n69_ | ~x16) & ~x18 & (~x07 | x16));
  assign new_n68_ = x27 & (~new_n61_ | ~new_n66_ | x26);
  assign new_n69_ = new_n70_ & new_n71_;
  assign new_n70_ = ~x22 & ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n71_ = ~x26 & ~x27 & ~x23 & ~x24 & ~x25;
  assign z09 = new_n74_ | (new_n75_ & (new_n73_ | ~x16 | (~new_n69_ & x28)));
  assign new_n73_ = ~x27 & ~x28 & new_n61_ & new_n66_ & ~x26;
  ...
  assign new_n78_ = ~x26 & ~x24 & ~x25 & ~x27 & ~x28 & ~x29;
  assign z11 = (x18 & x31) | (~x18 & (~x04 | x16) & ((~new_n77_ & x30) | ~x16 | (new_n77_ & ~x30)));
  assign z12 = (x31 & (new_n83_ | x18)) | (~x18 & (new_n87_ | (new_n81_ & new_n84_)));
  assign new_n81_ = new_n58_ & new_n82_;
  assign new_n82_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n83_ = x16 & (x30 | ~new_n61_ | ~new_n78_);
  assign new_n84_ = new_n85_ & new_n86_ & x16;
  assign new_n85_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n86_ = ~x30 & ~x31;
  assign new_n87_ = ~x03 & ~x16;
  assign z13 = (x16 & (new_n90_ | (~new_n89_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n89_ = new_n70_ & new_n71_ & new_n86_ & ~x28 & ~x29;
  assign new_n90_ = new_n61_ & ~x24 & ~x25 & new_n85_ & new_n86_ & ~x32;
  assign z14 = (x16 & (new_n92_ | (~new_n90_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n92_ = new_n85_ & new_n86_ & ~x32 & ~x33 & new_n58_ & new_n82_;
