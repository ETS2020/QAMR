...
module FAU ( 
  ...
  assign new_n65_ = (~x25 | (new_n59_ & ~x22 & ~x23 & ~x24)) & (~new_n59_ | x24 | x25 | x22 | x23);
  ...
  assign z08 = (x16 & (new_n73_ | (~new_n72_ & x27))) | ~new_n54_ | (~x07 & ~x16);
  assign new_n72_ = new_n68_ & new_n70_;
  assign new_n73_ = new_n74_ & new_n75_ & ~x25 & ~x26 & ~x27;
  assign new_n74_ = ~x22 & ~x20 & ~x21 & ~x17 & ~x19;
  assign new_n75_ = ~x23 & ~x24;
  assign z09 = (x16 & (new_n77_ | (~new_n73_ & x28))) | ~new_n54_ | (~x06 & ~x16);
  assign new_n77_ = new_n74_ & ~x27 & ~x28 & new_n75_ & ~x25 & ~x26;
  assign z10 = x18 | (new_n80_ & (new_n79_ | ~x16 | (~new_n77_ & x29)));
  assign new_n79_ = new_n68_ & new_n70_ & ~x29 & ~x27 & ~x28;
  assign new_n80_ = x04 & (~x05 | x16);
  assign z11 = ~new_n54_ | (x16 & (new_n82_ | (~new_n79_ & x30)));
  assign new_n82_ = new_n68_ & new_n70_ & new_n83_;
  assign new_n83_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = x18 | ((new_n85_ | new_n86_ | ~x16) & x04 & (~x03 | x16));
  assign new_n85_ = x31 & (~new_n68_ | ~new_n70_ | ~new_n83_);
  assign new_n86_ = new_n74_ & new_n75_ & new_n87_ & ~x25 & ~x26 & ~x27;
  assign new_n87_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = (x16 & (new_n89_ | (~new_n86_ & x32))) | ~new_n54_ | (~x02 & ~x16);
  assign new_n89_ = new_n74_ & new_n75_ & new_n83_ & new_n90_;
  ...
  assign z15 = x18 | (((new_n92_ & ~x34) | ~x16 | (~new_n92_ & x34)) & x04 & (~x00 | x16));
endmodule
