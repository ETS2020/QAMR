...
module FAU ( 
  ...
  assign new_n61_ = (new_n62_ | ~x24) & (~new_n56_ | ~new_n63_);
  assign new_n62_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n63_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (x05 & x18) | ((new_n65_ | new_n66_ | ~x16) & ~x18 & (~x09 | x16));
  assign new_n65_ = x25 & (~new_n56_ | ~new_n63_);
  ...
  assign new_n71_ = new_n56_ & new_n63_ & ~x27 & ~x25 & ~x26;
  assign z09 = new_n75_ | (new_n76_ & ((~new_n71_ & x28) | new_n73_ | ~x16));
  assign new_n73_ = new_n74_ & new_n57_ & ~x22;
  assign new_n74_ = ~x27 & ~x25 & ~x26 & ~x23 & ~x24 & ~x28;
  assign new_n75_ = x05 & x18;
  assign new_n76_ = ~x18 & (~x06 | x16);
  assign z10 = (x05 & x18) | (((~new_n73_ & x29) | new_n78_ | ~x16) & ~x18 & (~x05 | x16));
  assign new_n78_ = new_n62_ & new_n79_ & ~x24 & ~x25 & ~x26;
  assign new_n79_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x05 & x18) | (((new_n78_ & ~x30) | ~x16 | (~new_n78_ & x30)) & ~x18 & (~x04 | x16));
  assign z12 = ~new_n84_ | (x16 & (new_n82_ | (x31 & (~new_n78_ | x30))));
  assign new_n82_ = new_n83_ & new_n56_ & new_n63_ & ~x27 & ~x25 & ~x26;
  assign new_n83_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n84_ = ~x18 & (x03 | x16);
  assign z13 = (x16 & (new_n86_ | (~new_n82_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n86_ = new_n56_ & new_n63_ & new_n79_ & new_n87_;
  assign new_n87_ = ~x25 & ~x26 & ~x32 & ~x30 & ~x31;
  assign z14 = new_n75_ | (new_n91_ & ((~new_n86_ & x33) | new_n89_ | ~x16));
  assign new_n89_ = new_n57_ & new_n67_ & new_n83_ & new_n90_;
  assign new_n90_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign new_n91_ = ~x18 & (~x01 | x16);
  assign z15 = (x05 & x18) | (((new_n89_ & ~x34) | ~x16 | (~new_n89_ & x34)) & ~x18 & (~x00 | x16));
endmodule
