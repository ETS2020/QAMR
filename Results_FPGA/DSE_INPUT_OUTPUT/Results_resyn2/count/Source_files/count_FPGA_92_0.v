...
module FAU ( 
  ...
  assign z07 = ~new_n54_ | (~x08 & ~x16) | (~new_n66_ & x16);
  assign new_n66_ = (~x26 | (new_n62_ & ~x24 & ~x25)) & (~new_n62_ | x26 | x24 | x25);
  assign z08 = x18 | (~new_n68_ & x31 & (~x07 | x16));
  assign new_n68_ = (~x27 | (new_n69_ & new_n59_ & ~x22 & ~x23)) & x16 & (~new_n69_ | x23 | x27 | ~new_n59_ | x22);
  assign new_n69_ = ~x26 & ~x24 & ~x25;
  assign z09 = x18 | (x31 & (~x06 | x16) & ((~new_n71_ & x28) | ~x16 | (new_n71_ & ~x28)));
  assign new_n71_ = new_n59_ & ~x22 & new_n69_ & ~x23 & ~x27;
  assign z10 = ~new_n74_ | (x16 & (new_n73_ | (x29 & (~new_n71_ | x28))));
  assign new_n73_ = new_n62_ & new_n69_ & ~x29 & ~x27 & ~x28;
