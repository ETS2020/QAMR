...
module FAU ( 
  ...
  assign new_n65_ = new_n66_ & new_n56_ & ~x20;
  assign new_n66_ = ~x22 & ~x23 & ~x21 & ~x24;
  assign z06 = ~new_n68_ | (x16 & ((~new_n65_ & x25) | (new_n64_ & ~x24 & ~x25)));
  assign new_n68_ = new_n54_ & (x09 | x16);
  assign z07 = ~new_n54_ | (~x08 & ~x16) | (~new_n70_ & x16);
  assign new_n70_ = (~x26 | (new_n64_ & ~x24 & ~x25)) & (~new_n64_ | x26 | x24 | x25);
  assign z08 = x18 | ((new_n72_ | new_n74_ | ~x16) & x03 & (~x07 | x16));
  assign new_n72_ = x27 & (~new_n64_ | ~new_n73_);
  assign new_n73_ = ~x26 & ~x24 & ~x25;
  assign new_n74_ = new_n75_ & new_n66_ & new_n56_ & ~x20;
  assign new_n75_ = ~x27 & ~x25 & ~x26;
  assign z09 = (x16 & (new_n77_ | (~new_n74_ & x28))) | ~new_n54_ | (~x06 & ~x16);
  assign new_n77_ = new_n59_ & ~x22 & new_n73_ & ~x23 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n79_ | (~new_n77_ & x29))) | ~new_n54_ | (~x05 & ~x16);
  assign new_n79_ = ~x27 & ~x28 & ~x29 & new_n64_ & new_n73_;
  assign z11 = (x16 & (new_n81_ | (~new_n79_ & x30))) | ~new_n54_ | (~x04 & ~x16);
  assign new_n81_ = ~x28 & ~x29 & new_n64_ & new_n73_ & ~x27 & ~x30;
  assign z12 = ~new_n54_ | (x16 & (new_n83_ | (~new_n81_ & x31)));
  assign new_n83_ = new_n84_ & new_n75_ & new_n66_ & new_n56_ & ~x20;
  assign new_n84_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n86_ | (~new_n83_ & x32))) | ~new_n54_ | (~x02 & ~x16);
  assign new_n86_ = new_n66_ & new_n56_ & ~x20 & new_n87_ & new_n88_;
  assign new_n87_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n88_ = ~x28 & ~x29 & ~x27 & ~x30;
  assign z14 = x18 | (new_n92_ & ((~new_n86_ & x33) | new_n90_ | ~x16));
  assign new_n90_ = new_n64_ & ~x24 & ~x25 & new_n84_ & new_n91_;
  assign new_n91_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign new_n92_ = x03 & (~x01 | x16);
