...
module FAU ( 
  ...
  assign z12 = (~x03 & ~x16 & ~x18) | (x16 & ((~new_n79_ & x31) | new_n82_ | x18));
  ...
  assign new_n86_ = new_n80_ & new_n87_;
  assign new_n87_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign z14 = (~x01 & ~x16 & ~x18) | (x16 & (new_n89_ | new_n90_ | x18));
  assign new_n89_ = x33 & (~new_n56_ | ~new_n62_ | ~new_n80_ | ~new_n87_);
  assign new_n90_ = new_n57_ & new_n66_ & new_n83_ & new_n91_;
