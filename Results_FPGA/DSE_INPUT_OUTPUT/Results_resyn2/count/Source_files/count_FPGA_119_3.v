...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n61_, new_n62_, new_n63_, new_n65_, new_n66_,
    ...
    new_n87_, new_n89_, new_n90_, new_n92_, new_n93_, new_n95_;
  ...
  assign z05 = (~new_n61_ & ~x18) | (~x23 & (x18 | (new_n63_ & x16 & ~x24)));
  assign new_n61_ = (x10 | x16) & (new_n62_ | ~x16 | ~x24);
  ...
  assign new_n73_ = new_n56_ & new_n66_ & ~x25 & ~x26 & ~x27;
  assign z09 = new_n75_ | (~x18 & ((~x06 & ~x16) | (~new_n73_ & x16 & x28)));
  assign new_n75_ = ~x23 & (x18 | (new_n76_ & new_n63_ & new_n77_));
  assign new_n76_ = ~x26 & ~x27 & ~x28;
  assign new_n77_ = x16 & ~x24 & ~x25;
  assign z10 = (x16 & (new_n80_ | (~new_n79_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n79_ = new_n63_ & new_n76_ & new_n68_ & ~x23;
  assign new_n80_ = new_n62_ & new_n71_ & ~x29 & ~x27 & ~x28;
  assign z11 = x18 | (~x04 & ~x16) | (~new_n82_ & x16);
  assign new_n82_ = (~x30 | (new_n62_ & new_n71_ & ~x29 & ~x27 & ~x28)) & (~new_n62_ | ~new_n71_ | x27 | x28 | x29 | x30);
  assign z12 = (x16 & (new_n86_ | (~new_n84_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n84_ = new_n62_ & new_n71_ & new_n85_;
  assign new_n85_ = ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n86_ = new_n56_ & new_n66_ & new_n87_ & ~x25 & ~x26 & ~x27;
  assign new_n87_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = (x16 & (new_n89_ | (~new_n86_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n89_ = new_n85_ & new_n90_ & new_n56_ & new_n66_;
  assign new_n90_ = ~x31 & ~x32 & ~x25 & ~x26;
  assign z14 = new_n92_ | (~x18 & ((~x01 & ~x16) | (~new_n89_ & x16 & x33)));
  assign new_n92_ = ~x23 & (x18 | (new_n87_ & new_n93_ & new_n63_ & new_n77_));
  assign new_n93_ = ~x32 & ~x33 & ~x26 & ~x27;
  assign z15 = x18 | (~x00 & ~x16) | ((x34 | (new_n67_ & new_n95_)) & x16 & (~x34 | ~new_n67_ | ~new_n95_));
