// Benchmark "FAU" written by ABC on Wed Aug 12 18:30:22 2020
...
module FAU ( 
  ...
  assign z01 = (~x16 & (~x14 | x18)) | (((~x17 & ~x19) ^ x20) & x16 & ~x18);
  ...
  assign z07 = (~x16 & (~x08 | x18)) | ((new_n68_ | (~new_n65_ & x26)) & x16 & ~x18);
