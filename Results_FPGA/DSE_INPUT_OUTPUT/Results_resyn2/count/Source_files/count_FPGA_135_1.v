...
module FAU ( 
  ...
  assign z03 = (x11 & x18) | (~x18 & (~x12 | x16) & ((new_n60_ & ~x22) | ~x16 | (~new_n60_ & x22)));
  ...
  assign new_n68_ = x25 & (~new_n59_ | ~new_n66_);
  assign new_n69_ = new_n60_ & new_n70_ & ~x24 & ~x25;
  assign new_n70_ = ~x22 & ~x23;
  assign z07 = (x11 & x18) | (~new_n72_ & ~x18 & (~x08 | x16));
  assign new_n72_ = (~new_n60_ | ~new_n70_ | x24 | x25 | x26) & x16 & (~x26 | (new_n60_ & new_n70_ & ~x24 & ~x25));
  assign z08 = (x11 & x18) | ((new_n74_ | new_n76_ | ~x16) & ~x18 & (~x07 | x16));
  assign new_n74_ = x27 & (~new_n65_ | ~new_n75_ | x24);
  assign new_n75_ = ~x25 & ~x26;
  assign new_n76_ = new_n77_ & new_n59_ & new_n66_;
  assign new_n77_ = ~x27 & ~x25 & ~x26;
  assign z09 = new_n55_ | (new_n80_ & ((~new_n76_ & x28) | new_n79_ | ~x16));
  assign new_n79_ = new_n60_ & ~x22 & new_n77_ & ~x28 & ~x23 & ~x24;
  assign new_n80_ = ~x18 & (~x06 | x16);
  assign z10 = new_n55_ | (new_n83_ & ((~new_n79_ & x29) | new_n82_ | ~x16));
  assign new_n82_ = new_n65_ & new_n75_ & ~x24 & ~x27 & ~x28 & ~x29;
  assign new_n83_ = ~x18 & (~x05 | x16);
  assign z11 = (x11 & x18) | (((new_n82_ & ~x30) | ~x16 | (~new_n82_ & x30)) & ~x18 & (~x04 | x16));
  assign z12 = ~new_n88_ | (x16 & (new_n86_ | (x31 & (~new_n82_ | x30))));
  assign new_n86_ = new_n87_ & new_n77_ & new_n59_ & new_n66_;
  assign new_n87_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n88_ = ~x18 & (x03 | x16);
  assign z13 = (x16 & (new_n90_ | (~new_n86_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n90_ = new_n59_ & new_n66_ & new_n91_ & ~x27 & ~x28 & ~x29;
  assign new_n91_ = ~x25 & ~x26 & ~x32 & ~x30 & ~x31;
  assign z14 = new_n55_ | (new_n95_ & ((~new_n90_ & x33) | new_n93_ | ~x16));
  assign new_n93_ = new_n60_ & new_n70_ & ~x24 & ~x25 & new_n87_ & new_n94_;
  assign new_n94_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign new_n95_ = ~x18 & (~x01 | x16);
  assign z15 = (x11 & x18) | (((new_n93_ & ~x34) | ~x16 | (~new_n93_ & x34)) & ~x18 & (~x00 | x16));
endmodule
