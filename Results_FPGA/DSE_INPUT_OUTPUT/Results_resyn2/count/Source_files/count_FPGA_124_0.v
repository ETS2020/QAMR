...
module FAU ( 
  ...
  assign z02 = ((~new_n56_ | x20) & x16 & x21) | (~x13 & ~x16) | x18 | (~x20 & ~x21);
  assign z03 = ~new_n54_ | (~x12 & ~x16) | (x16 & x22);
  assign z04 = (x20 | x21) & ((x16 & x23) | x18 | (~x11 & ~x16));
  assign z05 = ~new_n54_ | (~x10 & ~x16) | (x16 & x24);
  assign z06 = ~new_n54_ | (~x09 & ~x16) | (x16 & x25);
  assign z07 = (x20 | x21) & ((x16 & x26) | x18 | (~x08 & ~x16));
  ...
  assign z14 = (x20 | x21) & ((x16 & x33) | x18 | (~x01 & ~x16));
