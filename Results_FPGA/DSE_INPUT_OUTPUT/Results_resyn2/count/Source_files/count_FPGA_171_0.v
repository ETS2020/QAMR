...
module FAU ( 
  ...
  assign z01 = x18 | (((new_n55_ & ~x20) | ~x16 | (~new_n55_ & x20)) & x15 & (~x14 | x16));
  ...
  assign z07 = (x16 & (~new_n69_ ^ ~x26)) | ~new_n70_ | (~x08 & ~x16);
  assign z08 = x18 | ((new_n73_ | new_n74_ | ~x16) & x15 & (~x07 | x16));
  assign new_n73_ = x27 & (x26 | ~new_n64_ | x24 | x25);
  assign new_n74_ = new_n75_ & new_n66_ & new_n67_ & ~x21 & ~x24;
  assign new_n75_ = ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n77_ | (~new_n74_ & x28))) | ~new_n70_ | (~x06 & ~x16);
  assign new_n77_ = new_n78_ & ~x27 & new_n64_ & ~x28;
  assign new_n78_ = ~x24 & ~x25 & ~x26;
  assign z10 = x18 | (~new_n80_ & x15 & (~x05 | x16));
  assign new_n80_ = (~x29 | (new_n78_ & ~x27 & new_n64_ & ~x28)) & x16 & (~new_n78_ | x27 | ~new_n64_ | x28 | x29);
  assign z11 = x18 | (~new_n82_ & x15 & (~x04 | x16));
  assign new_n82_ = (~x30 | (new_n78_ & ~x27 & new_n64_ & new_n83_)) & x16 & (~new_n64_ | ~new_n78_ | ~new_n83_ | x27 | x30);
  assign new_n83_ = ~x28 & ~x29;
  assign z12 = x18 | ((new_n85_ | new_n87_ | ~x16) & x15 & (~x03 | x16));
  assign new_n85_ = x31 & (~new_n64_ | ~new_n78_ | ~new_n86_);
  assign new_n86_ = ~x28 & ~x29 & ~x27 & ~x30;
  assign new_n87_ = new_n66_ & new_n67_ & ~x21 & ~x24 & new_n75_ & new_n88_;
  assign new_n88_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (new_n92_ & ((~new_n87_ & x32) | new_n90_ | ~x16));
  assign new_n90_ = new_n66_ & new_n67_ & ~x21 & ~x24 & new_n86_ & new_n91_;
  assign new_n91_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n92_ = x15 & (~x02 | x16);
  assign z14 = (x16 & (new_n94_ | (~new_n90_ & x33))) | ~new_n70_ | (~x01 & ~x16);
  assign new_n94_ = new_n88_ & new_n95_ & new_n64_ & ~x24 & ~x25;
  assign new_n95_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign z15 = ~new_n70_ | (~x00 & ~x16) | ((~new_n94_ | ~x34) & x16 & (new_n94_ | x34));
endmodule
