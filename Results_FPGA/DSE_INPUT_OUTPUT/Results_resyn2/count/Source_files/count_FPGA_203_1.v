...
module FAU ( 
  ...
  assign new_n65_ = new_n60_ & ~x24 & ~x25;
  ...
  assign new_n70_ = new_n56_ & new_n63_ & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n72_ | (~new_n70_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n72_ = new_n59_ & new_n73_ & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n73_ = ~x27 & ~x28;
  assign z10 = new_n76_ | (new_n77_ & ((~new_n72_ & x29) | new_n75_ | ~x16));
  assign new_n75_ = new_n60_ & new_n68_ & new_n73_ & ~x29;
  assign new_n76_ = x15 & x18;
  assign new_n77_ = ~x18 & (~x05 | x16);
  assign z11 = (x15 & x18) | (~new_n79_ & ~x18 & (~x04 | x16));
  assign new_n79_ = (~x30 | (new_n60_ & new_n68_ & new_n73_ & ~x29)) & x16 & (~new_n60_ | ~new_n68_ | ~new_n73_ | x29 | x30);
  assign z12 = (x15 & x18) | ((new_n81_ | new_n83_ | ~x16) & ~x18 & (~x03 | x16));
  assign new_n81_ = x31 & (~new_n82_ | ~new_n60_ | ~new_n68_);
  assign new_n82_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n83_ = new_n84_ & new_n56_ & new_n63_ & ~x25 & ~x26 & ~x27;
  assign new_n84_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = new_n76_ | (new_n88_ & (~new_n86_ | (~new_n83_ & x32)));
  assign new_n86_ = x16 & (~new_n56_ | ~new_n63_ | ~new_n82_ | ~new_n87_);
  assign new_n87_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n88_ = ~x18 & (~x02 | x16);
  assign z14 = (x15 & x18) | (~x18 & (~x01 | x16) & (new_n90_ | ~new_n92_));
  assign new_n90_ = new_n60_ & ~x24 & ~x25 & new_n84_ & new_n91_;
  assign new_n91_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign new_n92_ = x16 & (~x33 | (new_n56_ & new_n63_ & new_n82_ & new_n87_));
