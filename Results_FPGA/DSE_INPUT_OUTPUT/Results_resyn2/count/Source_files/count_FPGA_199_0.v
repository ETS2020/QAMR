...
module FAU ( 
  ...
  assign z13 = new_n96_ | (x16 & (new_n98_ | (x32 & (new_n97_ | x22))));
  assign new_n96_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n97_ = x34 & (~new_n81_ | ~new_n60_ | ~new_n94_);
  assign new_n98_ = new_n99_ & x34 & new_n90_ & new_n63_ & new_n87_ & ~x32;
  assign new_n99_ = ~x30 & ~x31;
  assign z14 = new_n101_ | ((new_n102_ | x22 | ~x33) & x16 & (new_n98_ | x33));
  assign new_n101_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n102_ = x34 & (~new_n103_ | ~new_n84_ | ~new_n59_ | ~new_n70_);
  assign new_n103_ = ~x30 & ~x31 & ~x29 & ~x32;
  assign z15 = ~new_n106_ | (x16 & x34 & (~new_n105_ | ~new_n99_ | x33));
  assign new_n105_ = new_n90_ & new_n63_ & new_n87_ & ~x32;
  assign new_n106_ = (x00 | x16) & ~new_n54_ & ~x18;
endmodule
