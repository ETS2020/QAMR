...
module FAU ( 
  ...
  assign z02 = (~x13 | (x16 & ~x18)) & ((~x21 & new_n55_ & ~x20) | ~x16 | x18 | (x21 & (~new_n55_ | x20)));
  ...
  assign new_n62_ = ((x24 & (~new_n60_ | x23)) | ~x16 | (new_n60_ & ~x23 & ~x24)) & ~x18 & (~x10 | x16);
  ...
  assign new_n79_ = new_n60_ & ~x23 & ~x24 & new_n73_ & new_n80_;
