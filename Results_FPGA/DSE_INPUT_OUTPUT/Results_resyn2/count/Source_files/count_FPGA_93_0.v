...
module FAU ( 
  ...
  assign z07 = x18 | (x16 & (((~new_n63_ | x24 | x25) & x26) | (new_n63_ & ~x24 & ~x25 & ~x26)));
  assign z08 = x18 | (x16 & ((~new_n67_ & x27) | (new_n61_ & new_n68_)));
  assign new_n67_ = new_n63_ & ~x26 & ~x24 & ~x25;
  assign new_n68_ = ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (x16 & (new_n70_ | (x28 & (~new_n61_ | ~new_n68_))));
  assign new_n70_ = new_n57_ & ~x22 & new_n71_ & ~x23 & ~x27 & ~x28;
  assign new_n71_ = ~x24 & ~x25 & ~x26;
  assign z10 = x18 | (x16 & ((~new_n70_ & x29) | (new_n73_ & new_n63_)));
  assign new_n73_ = new_n71_ & ~x29 & ~x27 & ~x28;
  assign z11 = x18 | (~new_n75_ & x16);
  assign new_n75_ = (~x30 | (new_n63_ & new_n71_ & ~x29 & ~x27 & ~x28)) & (~new_n63_ | ~new_n71_ | x27 | x28 | x29 | x30);
  assign z12 = x18 | (x16 & (new_n79_ | (~new_n77_ & x31)));
  assign new_n77_ = new_n63_ & new_n71_ & new_n78_;
  assign new_n78_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n79_ = new_n56_ & new_n62_ & new_n68_ & new_n80_;
  assign new_n80_ = ~x29 & ~x30 & ~x28 & ~x31;
  assign z13 = x18 | (x16 & ((~new_n79_ & x32) | (new_n61_ & new_n82_)));
  assign new_n82_ = new_n78_ & ~x31 & ~x32 & ~x25 & ~x26;
  assign z14 = new_n84_ | ~x16 | x18 | ((~new_n61_ | ~new_n82_) & x33);
  assign new_n84_ = new_n63_ & ~x24 & ~x25 & new_n80_ & new_n85_;
  assign new_n85_ = ~x26 & ~x27 & ~x32 & ~x33;
  assign z15 = (new_n84_ & ~x34) | (~new_n84_ & x34) | ~x16 | x18;
endmodule
