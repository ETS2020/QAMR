...
module FAU ( 
  ...
  assign z04 = ~new_n61_ | (x16 & ((x23 & (~new_n59_ | x22)) | (new_n59_ & ~x22 & ~x23)));
  assign new_n61_ = x11 & ~x18;
  assign z05 = (x16 & (new_n63_ ^ x24)) | ~new_n61_ | (~x10 & ~x16);
  assign new_n63_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z06 = ~new_n61_ | (~x09 & ~x16) | (~new_n65_ & x16);
  assign new_n65_ = (~x25 | (~x24 & new_n59_ & ~x22 & ~x23)) & (~new_n59_ | x24 | x25 | x22 | x23);
  assign z07 = ~new_n61_ | (~x08 & ~x16) | (~new_n67_ & x16);
  assign new_n67_ = (~x26 | (new_n59_ & new_n68_)) & (~new_n63_ | ~new_n69_);
  assign new_n68_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n69_ = ~x26 & ~x24 & ~x25;
  assign z08 = x18 | ((new_n71_ | new_n72_ | ~x16) & x11 & (~x07 | x16));
  assign new_n71_ = x27 & (~new_n63_ | ~new_n69_);
  assign new_n72_ = new_n73_ & new_n74_ & ~x25 & ~x23 & ~x24;
  assign new_n73_ = ~x22 & ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n74_ = ~x26 & ~x27;
  assign z09 = x18 | (new_n77_ & (new_n76_ | ~x16 | (~new_n72_ & x28)));
  assign new_n76_ = new_n63_ & ~x24 & ~x28 & new_n74_ & ~x25;
  assign new_n77_ = x11 & (~x06 | x16);
  assign z10 = x18 | (new_n80_ & ((~new_n76_ & x29) | new_n79_ | ~x16));
  assign new_n79_ = new_n63_ & new_n69_ & ~x27 & ~x28 & ~x29;
  ...
  assign new_n83_ = new_n84_ & new_n73_ & new_n74_ & ~x25 & ~x23 & ~x24;
  assign new_n84_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n85_ = new_n61_ & (x03 | x16);
  assign z13 = (x16 & (new_n87_ | (~new_n83_ & x32))) | ~new_n61_ | (~x02 & ~x16);
  assign new_n87_ = new_n63_ & ~x24 & new_n84_ & ~x32 & new_n74_ & ~x25;
  assign z14 = (x16 & (new_n89_ | (~new_n87_ & x33))) | ~new_n61_ | (~x01 & ~x16);
  assign new_n89_ = new_n59_ & new_n68_ & new_n84_ & new_n90_;
