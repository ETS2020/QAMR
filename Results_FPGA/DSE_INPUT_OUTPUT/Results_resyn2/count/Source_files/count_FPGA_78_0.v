...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n55_, new_n57_, new_n59_, new_n62_, new_n65_, new_n67_, new_n68_,
  ...
  assign z08 = x18 | ((new_n67_ | new_n69_ | ~x16) & x32 & (~x07 | x16));
  assign new_n67_ = x27 & (~new_n62_ | ~new_n68_);
  assign new_n68_ = ~x26 & ~x24 & ~x25;
  assign new_n69_ = new_n70_ & new_n71_;
  assign new_n70_ = ~x22 & ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n71_ = ~x27 & ~x24 & ~x25 & ~x23 & ~x26;
  assign z09 = x18 | (~new_n73_ & x32 & (~x06 | x16));
  assign new_n73_ = (~x28 | (new_n70_ & new_n74_ & ~x27)) & x16 & (~new_n70_ | ~new_n74_ | x27 | x28);
  assign new_n74_ = ~x24 & ~x25 & ~x23 & ~x26;
  assign z10 = x18 | ((new_n76_ | new_n77_ | ~x16) & x32 & (~x05 | x16));
  assign new_n76_ = new_n62_ & new_n68_ & ~x29 & ~x27 & ~x28;
  assign new_n77_ = x29 & (~new_n70_ | ~new_n74_ | x27 | x28);
  assign z11 = (~new_n79_ & x16) | ~new_n55_ | (~x04 & ~x16);
  assign new_n79_ = (~x30 | (new_n62_ & new_n68_ & ~x29 & ~x27 & ~x28)) & (~new_n62_ | ~new_n68_ | x27 | x28 | x29 | x30);
  assign z12 = x18 | (new_n83_ & (new_n82_ | ~x16 | (~new_n81_ & x31)));
  assign new_n81_ = new_n62_ & new_n68_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n82_ = new_n70_ & new_n71_ & ~x29 & ~x30 & ~x28 & ~x31;
  assign new_n83_ = x32 & (~x03 | x16);
  assign z13 = x18 | (x32 & (~x02 | x16) & (~new_n82_ | ~x16));
