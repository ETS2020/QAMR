...
module FAU ( 
  ...
  wire new_n55_, new_n57_, new_n59_, new_n61_, new_n62_, new_n64_, new_n65_,
    new_n66_, new_n67_, new_n68_, new_n70_, new_n73_, new_n74_, new_n76_,
  ...
  assign z08 = (x04 & x18) | ((new_n73_ | new_n74_ | ~x16) & ~x18 & (~x07 | x16));
  assign new_n73_ = x27 & (x26 | ~new_n65_ | x24 | x25);
  assign new_n74_ = new_n67_ & new_n68_ & ~x25 & ~x26 & ~x27;
  assign z09 = new_n61_ | (new_n78_ & (new_n76_ | ~x16 | (~new_n74_ & x28)));
  assign new_n76_ = new_n77_ & new_n65_ & ~x28;
  assign new_n77_ = ~x27 & ~x24 & ~x25 & ~x26;
  assign new_n78_ = ~x18 & (~x06 | x16);
  assign z10 = (x16 & (new_n80_ | (~new_n76_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n80_ = new_n77_ & new_n65_ & ~x28 & ~x29;
  assign z11 = (x04 & x18) | (~x18 & (~x04 | x16) & ((~new_n80_ & x30) | new_n82_ | ~x16));
  assign new_n82_ = new_n65_ & new_n83_ & ~x24 & ~x25 & ~x26;
  assign new_n83_ = ~x28 & ~x29 & ~x27 & ~x30;
  assign z12 = new_n61_ | (new_n87_ & (new_n85_ | ~x16 | (~new_n82_ & x31)));
  assign new_n85_ = new_n86_ & new_n67_ & new_n68_ & ~x25 & ~x26 & ~x27;
  assign new_n86_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n87_ = ~x18 & (~x03 | x16);
  assign z13 = new_n61_ | (new_n91_ & ((~new_n85_ & x32) | new_n89_ | ~x16));
  assign new_n89_ = new_n67_ & new_n68_ & new_n83_ & new_n90_;
  assign new_n90_ = ~x25 & ~x26 & ~x31 & ~x32;
  assign new_n91_ = ~x18 & (~x02 | x16);
  assign z14 = new_n61_ | (new_n95_ & ((~new_n89_ & x33) | new_n93_ | ~x16));
  assign new_n93_ = new_n65_ & ~x24 & ~x25 & new_n86_ & new_n94_;
