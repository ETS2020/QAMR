...
module FAU ( 
  ...
  assign new_n76_ = (~x30 | (new_n64_ & new_n77_ & new_n74_ & ~x29)) & (~new_n64_ | ~new_n77_ | ~new_n74_ | x29 | x30);
  assign new_n77_ = ~x24 & ~x25 & ~x26;
  assign z12 = (~x31 & (~x00 | (new_n79_ & x16))) | x18 | (~x03 & ~x16) | (~new_n79_ & x16 & x31);
  assign new_n79_ = new_n64_ & new_n77_ & new_n74_ & new_n80_;
  assign new_n80_ = ~x29 & ~x30;
  assign z13 = new_n82_ | (x16 & (new_n86_ | (x00 & (new_n83_ | new_n84_))));
  assign new_n82_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n83_ = x32 & (~new_n64_ | ~new_n77_ | ~new_n74_ | ~new_n80_);
  assign new_n84_ = new_n64_ & ~x24 & new_n85_ & ~x32 & new_n80_ & ~x31;
  assign new_n85_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = x31 & x32;
  assign z14 = ~new_n90_ | (x16 & (new_n88_ | (~new_n84_ & x33)));
  assign new_n88_ = new_n89_ & ~x26 & ~x27 & ~x25 & new_n64_ & ~x24;
  assign new_n89_ = ~x31 & ~x29 & ~x30 & ~x28 & ~x32 & ~x33;
  assign new_n90_ = ~x18 & (x01 | x16) & (x00 | (x31 & (~x16 | ~x33)));
  assign z15 = new_n94_ | ((new_n88_ | x34) & ~new_n92_ & x00 & x16);
  assign new_n92_ = new_n93_ & new_n85_ & new_n64_ & ~x24;
  assign new_n93_ = ~x32 & ~x33 & x34 & ~x29 & ~x30;
  assign new_n94_ = (x31 | (x00 & x18)) & ((x16 & x34) | x18 | (~x00 & ~x16));
endmodule
