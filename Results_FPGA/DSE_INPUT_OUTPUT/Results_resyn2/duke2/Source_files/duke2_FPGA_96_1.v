...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28;
  wire new_n54_, new_n55_, new_n57_, new_n59_, new_n64_, new_n71_, new_n74_,
  ...
  assign z13 = z03 | z16;
  assign z14 = new_n64_ & ((new_n71_ & ~x17 & ~x07 & ~x15) | (x17 & (x07 | x15)) | (x07 & (~x01 | x15)));
  assign new_n71_ = ~x14 & ~x21 & x04 & x12;
  assign z15 = (~x17 & x18) | (~x07 & x17 & ~x18 & x05 & ~x09 & ~x15);
  assign z19 = new_n74_ & ~x07 & x17 & ~x18;
  assign new_n74_ = ~x05 & ~x09 & ~x15;
  assign z20 = new_n55_ & ~x17 & ~x07 & ~x15 & ~x09 & ~x18;
  assign z24 = ~x17 & (x18 | (new_n74_ & (new_n77_ | (new_n71_ & ~x07))));
  ...
  assign z25 = 1'b0;
  assign z10 = z03;
  assign z17 = (x17 & (x07 | x15) & new_n64_ & (~x15 | (x00 & ~x07))) | (~x17 & x18);
  assign z18 = z16;
  assign z21 = z16;
  assign z22 = z16;
