...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28;
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n67_, new_n75_,
    new_n78_, new_n79_;
  ...
  assign z02 = new_n60_ & (x08 | x16) & ~x18 & ~x15 & ~x17;
  ...
  assign z11 = ~x17 & (x18 | (new_n60_ & ~x15));
  ...
  assign z24 = ~x17 & (x18 | ((new_n56_ | new_n75_) & new_n55_ & ~x09));
  assign new_n75_ = x08 & x01 & x07;
  assign z26 = z05 | (~x20 & (x14 | x21));
  assign z28 = (~x17 & x18) | (new_n79_ & ((~new_n78_ & ~x05) | (~x07 & x17 & ~x18)));
  assign new_n78_ = (x19 | ~x17 | x18) & ((x02 & x11) | ~x07 | x17);
