...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28;
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n72_,
    new_n73_, new_n74_, new_n78_, new_n80_, new_n83_, new_n84_;
  ...
  assign z01 = new_n58_ & new_n56_ & x07 & x15;
  assign new_n58_ = x02 & x11 & ~x05 & ~x17;
  ...
  assign z14 = (~x17 & x18) | (new_n72_ & (new_n73_ | (new_n74_ & ~x15 & ~x17)));
  assign new_n72_ = ~x05 & ~x09;
  assign new_n73_ = (x17 | (x07 & (~x01 | x15))) & ~x18 & (x07 | x15);
  assign new_n74_ = ~x07 & ~x14 & ~x21 & x04 & x12;
  assign z15 = new_n56_ & x17 & x05 & ~x07 & ~x15;
  assign z19 = new_n56_ & x17 & ~x07 & ~x05 & ~x15;
  assign z20 = new_n56_ & ~x07 & ~x15 & new_n78_ & ~x05 & ~x17;
  assign new_n78_ = ~x14 & ~x21 & x04 & x12;
  assign z24 = new_n80_ & ((new_n78_ & ~x07) | (x08 & x01 & x07));
  assign new_n80_ = ~x15 & ~x17 & ~x18 & ~x05 & ~x09;
  assign z26 = z22 | (~x20 & (x14 | x21));
  assign z28 = (~x07 | (~x05 & (~x17 | ~x19))) & new_n84_ & (x17 | (~new_n83_ & x07));
  assign new_n83_ = x02 & x11;
  assign new_n84_ = ~x09 & ~x18 & (x05 | x15);
  assign z05 = 1'b0;
  assign z07 = 1'b0;
  assign z16 = 1'b0;
  assign z18 = 1'b0;
  ...
  assign z17 = new_n65_ & new_n56_ & x17;
