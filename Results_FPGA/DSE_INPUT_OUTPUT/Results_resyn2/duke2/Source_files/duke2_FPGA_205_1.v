// Benchmark "FAU" written by ABC on Wed Aug 12 20:44:21 2020
...
module FAU ( 
  ...
  assign z17 = (x17 & (x07 | x15) & new_n65_ & (~x15 | (x00 & ~x07))) | (~x17 & x18);
  assign z19 = ~x05 & ~x09 & ~x07 & ~x15 & x17 & ~x18;
  assign z20 = new_n68_ & ~x17 & new_n54_ & ~x07 & ~x15;
  assign z24 = ~x17 & (x18 | (new_n77_ & (new_n78_ | (new_n56_ & ~x07))));
  ...
  assign new_n81_ = ((x02 & x11) | ~x07 | x17) & (x19 | ~x17 | x18);
