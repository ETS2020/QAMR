...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28;
  wire new_n54_, new_n55_, new_n57_, new_n59_, new_n64_, new_n71_, new_n78_,
    new_n79_;
  ...
  assign z01 = ~x17 & (x18 | (new_n57_ & x15 & x02 & x11));
  assign new_n57_ = x07 & ~x05 & ~x09;
  ...
  assign z07 = ~x17 & x18;
  assign z06 = x17 & (x07 | x15) & new_n64_ & (~x15 | (x00 & ~x07));
  assign new_n64_ = ~x18 & ~x05 & ~x09;
  assign z08 = x14 & ~z07 & ~x20;
  assign z09 = (~x17 & x18) | ((new_n55_ | x17) & ~x09 & ~x18 & ~x07 & ~x15);
  assign z11 = ~x17 & (x18 | (new_n57_ & x01 & ~x15));
  assign z12 = (x17 & (x07 | x15) & new_n64_ & (~x15 | (x00 & ~x07))) | (~x17 & x18);
  assign z13 = z03 | z07;
  assign z14 = new_n64_ & ((new_n71_ & ~x15 & ~x17) | (x17 & (x07 | x15)) | (x07 & (~x01 | x15)));
  assign new_n71_ = x12 & ~x14 & ~x21 & x04 & ~x07;
  ...
  assign z25 = 1'b0;
  assign z10 = z03;
  assign z17 = x17 & (x07 | x15) & new_n64_ & (~x15 | (x00 & ~x07));
  assign z23 = z07;
  assign z27 = (x17 & (x07 | x15) & new_n64_ & (~x15 | (x00 & ~x07))) | (~x17 & x18);
endmodule
