...
module FAU ( 
  ...
  assign z06 = x17 & (x07 | x15) & new_n66_ & (~x15 | (x00 & ~x07));
  assign new_n66_ = ~x18 & ~x05 & ~x09;
  assign z08 = z07 | (x14 & ~x20);
  assign z09 = (~x17 & x18) | ((new_n69_ | x17) & ~x07 & ~x15 & ~x09 & ~x18);
  assign new_n69_ = ~x05 & ~x14 & ~x21 & x04 & x12;
  assign z11 = new_n60_ & x01 & x07;
  assign z12 = (~x17 & x18) | (x17 & (x07 | x15) & new_n66_ & (~x15 | (x00 & ~x07)));
  assign z14 = new_n66_ & ((new_n73_ & ~x17 & ~x07 & ~x15) | (x17 & (x07 | x15)) | (x07 & (~x01 | x15)));
  assign new_n73_ = ~x14 & ~x21 & x04 & x12;
  assign z15 = x17 & ~x09 & ~x18 & x05 & ~x07 & ~x15;
  assign z19 = x17 & ~x09 & ~x18 & new_n56_ & ~x07;
  assign z20 = new_n69_ & ~x17 & ~x07 & ~x15 & ~x09 & ~x18;
  assign z24 = new_n60_ & ((new_n73_ & ~x07) | (x08 & x01 & x07));
  ...
  assign z21 = z07;
  assign z25 = z07;
  assign z27 = x17 & (x07 | x15) & new_n66_ & (~x15 | (x00 & ~x07));
endmodule
