...
module FAU ( 
  ...
  assign z14 = (~x17 & x18) | (new_n64_ & (new_n71_ | (new_n70_ & ~x15 & ~x17)));
  ...
  assign z20 = ~x17 & (x18 | (new_n70_ & new_n64_ & ~x15));
  assign z24 = ~x17 & (x18 | ((new_n70_ | new_n76_) & new_n64_ & ~x15));
  ...
  assign z10 = z03;
  assign z13 = z03;
  assign z17 = (~x15 | (x00 & ~x07)) & x17 & ~x18 & new_n64_ & (x07 | x15);
