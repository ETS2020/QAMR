...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n59_, new_n61_, new_n65_, new_n72_,
    new_n73_, new_n74_, new_n78_, new_n80_, new_n81_, new_n84_, new_n85_;
  ...
  assign z02 = ~x17 & (x18 | (new_n61_ & ~x15 & (x08 | x16)));
  assign new_n61_ = x01 & x07 & ~x05 & ~x09;
  assign z03 = (~x05 | ~x07) & new_n56_ & x17;
  assign z04 = z07 | (~x14 & ~x20);
  assign z06 = (~x17 & x18) | (new_n65_ & x17 & ~x09 & ~x18);
  ...
  assign z11 = new_n61_ & ~x18 & ~x15 & ~x17;
  assign z12 = new_n65_ & new_n56_ & x17;
  assign z14 = (~x17 & x18) | (new_n72_ & (new_n74_ | (new_n73_ & ~x15 & ~x17)));
  assign new_n72_ = ~x05 & ~x09;
  assign new_n73_ = ~x07 & ~x14 & ~x21 & x04 & x12;
  assign new_n74_ = (x17 | (x07 & (~x01 | x15))) & ~x18 & (x07 | x15);
  assign z15 = x05 & ~x07 & ~x15 & new_n56_ & x17;
  assign z19 = new_n56_ & x17 & ~x07 & ~x05 & ~x15;
  assign z20 = new_n78_ & new_n56_ & ~x07 & ~x15;
  assign new_n78_ = x04 & x12 & ~x14 & ~x21 & ~x05 & ~x17;
  assign z24 = ~x17 & (x18 | (new_n81_ & (new_n73_ | new_n80_)));
  assign new_n80_ = x08 & x01 & x07;
  assign new_n81_ = ~x09 & ~x05 & ~x15;
  assign z26 = ~z07 & ~x20 & (x14 | x21);
  assign z28 = (~x07 | (~x05 & (~x17 | ~x19))) & new_n85_ & (x17 | (~new_n84_ & x07));
  assign new_n84_ = x02 & x11;
  assign new_n85_ = ~x09 & ~x18 & (x05 | x15);
  assign z05 = 1'b0;
  assign z21 = 1'b0;
  assign z25 = 1'b0;
  ...
  assign z22 = z07;
  assign z23 = z07;
  assign z27 = (~x17 & x18) | (new_n65_ & x17 & ~x09 & ~x18);
endmodule
