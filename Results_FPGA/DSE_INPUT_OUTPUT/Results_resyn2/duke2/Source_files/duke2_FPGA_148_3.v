...
module FAU ( 
  ...
  assign new_n148_ = (~x07 | x15 | ~x17 | x18) & (x07 | (~new_n149_ & (~x00 | ~x15 | ~x17 | x18)));
  ...
  assign new_n168_ = (x09 | ~x08 | ~x15 | x05 | ~x07) & (x07 | ((x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | ~x08 | ~x09 | x15))) & (~x06 | x08 | x09 | ~x05 | x15)));
  ...
  assign new_n175_ = (~x12 | x14 | x05 | x18) & (~x18 | x20 | x12 | ~x05 | ~x08);
