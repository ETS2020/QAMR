...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28;
  wire new_n54_, new_n55_, new_n57_, new_n59_, new_n61_, new_n67_, new_n72_,
  ...
  assign z03 = z07 | (new_n61_ & (~x05 | ~x07));
  assign new_n61_ = x17 & ~x09 & ~x18;
  assign z07 = ~x17 & x18;
  assign z04 = z07 | (~x14 & ~x20);
  assign z06 = z07 | (new_n61_ & (~x15 | (x00 & ~x07)) & ~x05 & (x07 | x15));
  assign z08 = x14 & ~z07 & ~x20;
  assign z09 = (~x17 & x18) | ((new_n67_ | x17) & ~x07 & ~x15 & ~x09 & ~x18);
  assign new_n67_ = x12 & ~x14 & ~x21 & x04 & ~x05;
  assign z10 = new_n61_ & (~x05 | ~x07);
  assign z11 = new_n59_ & x01 & x07;
  assign z12 = new_n61_ & (~x15 | (x00 & ~x07)) & ~x05 & (x07 | x15);
  assign z14 = (~x17 & x18) | (new_n72_ & (new_n73_ | (new_n55_ & ~x15 & ~x17)));
  assign new_n72_ = ~x05 & ~x09;
  assign new_n73_ = (x17 | (x07 & (~x01 | x15))) & ~x18 & (x07 | x15);
  assign z15 = (~x17 & x18) | (x17 & ~x18 & x05 & ~x09 & ~x07 & ~x15);
  assign z19 = new_n61_ & ~x07 & ~x05 & ~x15;
  ...
  assign z23 = 1'b0;
  assign z25 = 1'b0;
  assign z13 = z07 | (new_n61_ & (~x05 | ~x07));
  assign z16 = z07;
  assign z17 = z07 | (new_n61_ & (~x15 | (x00 & ~x07)) & ~x05 & (x07 | x15));
  assign z27 = new_n61_ & (~x15 | (x00 & ~x07)) & ~x05 & (x07 | x15);
endmodule
