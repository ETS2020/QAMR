...
module FAU ( 
  ...
  assign z03 = (~new_n84_ & ~x09) | (new_n87_ & x03 & ~x17 & x09 & x18);
  ...
  assign z27 = (~new_n191_ & x18) | (~x09 & (new_n190_ | (~new_n187_ & ~x17 & x18)));
  ...
  assign new_n191_ = x03 & (~new_n176_ | ~x19);
  assign z28 = new_n204_ | (~x17 & (new_n203_ | (~new_n193_ & x03 & x18)));
  assign new_n193_ = ~new_n201_ & (x05 | (~new_n198_ & (~new_n99_ | (~new_n194_ & ~new_n196_))));
  assign new_n194_ = ~x08 & ((x15 & ~x19) | (new_n195_ & x21 & ~x14 & ~x15));
  assign new_n195_ = ~x06 & x04 & ~x12;
  assign new_n196_ = new_n197_ & (~x13 | x02 | x11);
  assign new_n197_ = x12 & ~x15 & x08 & x10 & ~x14 & ~x21;
  assign new_n198_ = ~new_n200_ & ((x08 & x15) | (new_n199_ & new_n99_ & ~x15));
  assign new_n199_ = x06 & ~x08 & ~x02 & x11 & ~x14 & x21;
  assign new_n200_ = x02 & ~x07 & x11;
  assign new_n201_ = ~new_n202_ & ~x07 & x08;
  assign new_n202_ = (~x21 | x09 | ~x15) & (~x12 | x15 | x04 | ~x05 | (~x09 & x21));
  assign new_n203_ = new_n67_ & ~x18 & (~x02 | ~x11) & ~x05 & x07;
  assign new_n204_ = (~x07 | (~x05 & ~x19)) & new_n57_ & x17 & (x05 | x15);
endmodule
