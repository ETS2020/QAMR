...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n61_, new_n66_,
    new_n69_, new_n72_, new_n73_, new_n81_;
  ...
  assign z02 = (x08 | x16) & new_n60_ & new_n61_ & ~x17 & ~x18;
  assign new_n60_ = ~x09 & ~x05 & ~x15;
  assign new_n61_ = x01 & x07;
  assign z03 = ((~x05 | ~x07) & x17 & ~x09 & ~x18) | (~x17 & x18);
  assign z04 = z16 | (~x14 & ~x20);
  assign z16 = ~x17 & x18;
  assign z06 = new_n66_ & new_n56_ & x17;
  ...
  assign z11 = new_n60_ & new_n61_ & ~x17 & ~x18;
  assign z14 = (~x17 & x18) | (new_n73_ & ((new_n55_ & ~x15 & ~x17) | (~new_n72_ & ~x18)));
  ...
  assign z24 = ~x17 & (x18 | (new_n60_ & (new_n55_ | (new_n61_ & x08))));
  ...
  assign z13 = z03;
  assign z17 = new_n66_ & new_n56_ & x17;
  assign z22 = z16;
  assign z23 = z16;
endmodule
