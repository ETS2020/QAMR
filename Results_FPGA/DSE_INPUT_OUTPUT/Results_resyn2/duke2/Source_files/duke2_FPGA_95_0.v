...
module FAU ( 
  ...
  assign new_n84_ = ~x15 & x01 & x07 & ~x05 & ~x18;
  ...
  assign new_n91_ = ((x05 & ~x15) | (~x05 & x07 & x08 & x15)) & new_n92_ & ((x07 & x08) | (x20 & ~x07 & ~x08));
  ...
  assign new_n168_ = ~new_n169_ & new_n94_ & ~x08 & (~x21 | (~x14 & x20));
  ...
  assign new_n204_ = (x07 | (~new_n185_ & (x08 | ~x20 | x15 | ~x19))) & (~x07 | ~x08 | x15 | ~x19);
  ...
  assign new_n216_ = (x09 | ~x15 | ~x21) & (~x12 | x15 | x04 | ~x05 | (~x09 & x21));
