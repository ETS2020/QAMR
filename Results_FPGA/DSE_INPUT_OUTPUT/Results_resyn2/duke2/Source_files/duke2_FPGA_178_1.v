...
module FAU ( 
  ...
  assign z02 = new_n60_ & new_n61_ & ~x15 & ~x17 & (x08 | x16);
  ...
  assign z09 = (~x17 & x18) | ((new_n68_ | x17) & ~x07 & ~x15 & ~x09 & ~x18);
  assign new_n68_ = ~x05 & ~x14 & ~x21 & x04 & x12;
  assign z11 = ~x17 & (x18 | (new_n61_ & new_n70_));
  assign new_n70_ = ~x09 & ~x05 & ~x15;
  assign z12 = (~x17 & x18) | (x17 & (x07 | x15) & new_n60_ & (~x15 | (x00 & ~x07)));
  assign z14 = new_n60_ & ((new_n55_ & ~x15 & ~x17) | (x17 & (x07 | x15)) | (x07 & (~x01 | x15)));
  assign z15 = (~x17 & x18) | (~x15 & x17 & ~x18 & ~x09 & x05 & ~x07);
  assign z19 = (~x17 & x18) | (~x07 & ~x05 & ~x09 & ~x15 & x17 & ~x18);
  assign z20 = ~x17 & (x18 | (~x09 & new_n55_ & new_n56_));
  assign z24 = ~x17 & (x18 | (new_n70_ & (new_n55_ | (new_n61_ & x08))));
  ...
  assign z10 = z03;
  assign z13 = z03;
  assign z17 = (~x17 & x18) | (x17 & (x07 | x15) & new_n60_ & (~x15 | (x00 & ~x07)));
  assign z21 = z05;
  assign z22 = z05;
  assign z25 = z05;
  assign z27 = (~x17 & x18) | (x17 & (x07 | x15) & new_n60_ & (~x15 | (x00 & ~x07)));
endmodule
