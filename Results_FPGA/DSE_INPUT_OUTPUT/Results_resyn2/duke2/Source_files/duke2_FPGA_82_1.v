...
module FAU ( 
  ...
  assign z02 = (x08 | x16) & new_n60_ & new_n57_ & ~x18;
  assign new_n60_ = ~x15 & ~x17 & x01 & x07;
  assign z03 = z16 | (new_n62_ & (~x05 | ~x07));
  assign new_n62_ = x17 & ~x09 & ~x18;
  assign z16 = ~x17 & x18;
  assign z04 = ~x14 & ~z16 & ~x20;
  assign z06 = z16 | (new_n62_ & (~x15 | (x00 & ~x07)) & ~x05 & (x07 | x15));
  ...
  assign z11 = new_n60_ & new_n57_ & ~x18;
  assign z12 = new_n62_ & (~x15 | (x00 & ~x07)) & ~x05 & (x07 | x15);
  assign z14 = (~x17 & x18) | (new_n57_ & ((~new_n73_ & ~x18) | (new_n55_ & ~x15 & ~x17)));
  assign new_n73_ = (~x07 | (x01 & ~x15)) & (~x17 | (~x07 & ~x15));
  assign z15 = new_n62_ & x05 & ~x07 & ~x15;
  assign z19 = new_n62_ & ~x07 & ~x05 & ~x15;
  assign z20 = ~x17 & (x18 | (~x09 & new_n55_ & ~x05 & ~x15));
  assign z24 = ~x17 & (x18 | ((new_n55_ | new_n78_) & new_n57_ & ~x15));
  ...
  assign z22 = 1'b0;
  assign z23 = 1'b0;
  assign z13 = z16 | (new_n62_ & (~x05 | ~x07));
