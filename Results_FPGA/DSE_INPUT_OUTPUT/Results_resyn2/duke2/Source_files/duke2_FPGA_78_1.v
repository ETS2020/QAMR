...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n72_, new_n77_, new_n80_, new_n81_;
  ...
  assign z05 = ~x17 & x18;
  assign z06 = (~x15 | (x00 & ~x07)) & x17 & ~x18 & new_n65_ & (x07 | x15);
  assign new_n65_ = ~x05 & ~x09;
  assign z08 = x14 & ~z05 & ~x20;
  assign z09 = (new_n68_ | x17) & ~x07 & ~x15 & ~x09 & ~x18;
  assign new_n68_ = ~x05 & ~x14 & ~x21 & x04 & x12;
  assign z11 = new_n60_ & ~x18 & ~x15 & ~x17;
  assign z12 = (~x17 & x18) | ((~x15 | (x00 & ~x07)) & x17 & ~x18 & new_n65_ & (x07 | x15));
  ...
  assign z19 = new_n65_ & ~x07 & ~x15 & x17 & ~x18;
  assign z20 = new_n68_ & ~x17 & ~x07 & ~x15 & ~x09 & ~x18;
  assign z24 = ~x17 & (x18 | ((new_n55_ | new_n77_) & new_n65_ & ~x15));
