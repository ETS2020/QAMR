...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n59_, new_n61_, new_n65_, new_n68_,
    new_n72_, new_n73_, new_n78_, new_n82_, new_n83_;
  assign z00 = z05 | (new_n56_ & (new_n54_ | (new_n55_ & ~x05 & ~x15)));
  ...
  assign new_n59_ = x07 & ~x05 & ~x09 & x15 & x02 & x11;
  assign z02 = ~x17 & (x18 | (new_n61_ & (x08 | x16)));
  assign new_n61_ = x07 & ~x05 & ~x09 & x01 & ~x15;
  ...
  assign z24 = new_n78_ & (new_n55_ | (x08 & x01 & x07));
  assign new_n78_ = ~x15 & ~x17 & ~x18 & ~x05 & ~x09;
  assign z26 = z05 | (~x20 & (x14 | x21));
  assign z27 = new_n65_ & new_n56_ & x17;
