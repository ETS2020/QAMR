...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n65_, new_n68_,
    new_n73_, new_n78_, new_n81_, new_n82_;
  ...
  assign new_n60_ = x01 & x07 & ~x05 & ~x09;
  assign z03 = (~x05 | ~x07) & x17 & ~x09 & ~x18;
  assign z04 = ~x20 & ~z05 & ~x14;
  assign z05 = ~x17 & x18;
  assign z06 = (~x17 & x18) | ((~x15 | (x00 & ~x07)) & x17 & ~x18 & new_n65_ & (x07 | x15));
  assign new_n65_ = ~x05 & ~x09;
  assign z08 = (z05 | x14) & (z05 | ~x20);
  assign z09 = ~new_n68_ & ~x07 & ~x15 & ~x09 & ~x18;
  assign new_n68_ = ~x17 & (x05 | x14 | x21 | ~x04 | ~x12);
  assign z10 = z05 | z03;
  assign z11 = new_n60_ & ~x18 & ~x15 & ~x17;
  assign z12 = (~x15 | (x00 & ~x07)) & x17 & ~x18 & new_n65_ & (x07 | x15);
  assign z14 = (~x17 & x18) | (new_n65_ & (new_n73_ | (new_n55_ & ~x15 & ~x17)));
  assign new_n73_ = (x17 | (x07 & (~x01 | x15))) & ~x18 & (x07 | x15);
  assign z15 = x17 & ~x09 & ~x18 & x05 & ~x07 & ~x15;
  assign z19 = (~x17 & x18) | (new_n65_ & ~x15 & ~x07 & x17 & ~x18);
  assign z20 = new_n55_ & new_n56_ & ~x17 & ~x09 & ~x18;
  assign z24 = ~x17 & (x18 | ((new_n55_ | new_n78_) & new_n65_ & ~x15));
  assign new_n78_ = x08 & x01 & x07;
  assign z26 = (z05 | ~x20) & (z05 | x14 | x21);
  ...
  assign z07 = z05;
  assign z13 = z05 | z03;
  assign z17 = (~x17 & x18) | ((~x15 | (x00 & ~x07)) & x17 & ~x18 & new_n65_ & (x07 | x15));
  assign z18 = z05;
  assign z21 = z05;
  assign z27 = (~x15 | (x00 & ~x07)) & x17 & ~x18 & new_n65_ & (x07 | x15);
endmodule
