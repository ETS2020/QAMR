...
module FAU ( 
  ...
  assign z06 = new_n59_ & ~x18 & (~x15 | (x00 & ~x07)) & x17 & (x07 | x15);
  ...
  assign z12 = (new_n59_ & ~x18 & (~x15 | (x00 & ~x07)) & x17 & (x07 | x15)) | (~x17 & x18);
  assign z14 = (~x17 & x18) | (new_n59_ & ((new_n55_ & ~x15 & ~x17) | (~new_n73_ & ~x18)));
  assign new_n73_ = (~x17 | (~x07 & ~x15)) & (~x07 | (x01 & ~x15));
  assign z15 = x17 & ~x09 & ~x18 & x05 & ~x07 & ~x15;
  assign z19 = (~x17 & x18) | (new_n59_ & ~x18 & x17 & ~x07 & ~x15);
  ...
  assign z10 = z13 | z05;
  assign z16 = z05;
  assign z17 = (new_n59_ & ~x18 & (~x15 | (x00 & ~x07)) & x17 & (x07 | x15)) | (~x17 & x18);
  assign z22 = z05;
  assign z27 = (new_n59_ & ~x18 & (~x15 | (x00 & ~x07)) & x17 & (x07 | x15)) | (~x17 & x18);
endmodule
