...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28;
  wire new_n54_, new_n55_, new_n57_, new_n58_, new_n60_, new_n71_, new_n76_,
  ...
  assign z14 = new_n57_ & ((new_n71_ & ~x17 & ~x07 & ~x15) | (x17 & (x07 | x15)) | (x07 & (~x01 | x15)));
  assign new_n71_ = x04 & x12 & ~x14 & ~x21;
  assign z15 = x17 & ~x09 & ~x18 & x05 & ~x07 & ~x15;
  assign z19 = x17 & ~x09 & ~x18 & ~x07 & ~x05 & ~x15;
  assign z20 = new_n55_ & ~x17 & ~x07 & ~x15 & ~x09 & ~x18;
  assign z24 = ~x17 & (x18 | (new_n76_ & (new_n77_ | new_n78_)));
