...
module FAU ( 
  ...
  assign new_n83_ = (~new_n84_ | new_n89_) & ~x14 & ~x15 & new_n78_ & ~x09;
  assign new_n84_ = ~new_n85_ & (~x06 | (~new_n87_ & (~new_n70_ | x08 | ~x21)));
  ...
  assign z06 = z11 | (~x09 & (new_n106_ | (~new_n92_ & ~x07)));
  assign new_n92_ = ~new_n105_ & (new_n93_ | x17);
  ...
  assign new_n106_ = ~x05 & x07 & ~x15 & ~x18;
  ...
  assign new_n123_ = ~x06 & ~x09 & ~x08 & x15;
  assign z12 = ~x09 & (new_n125_ | (new_n106_ & x17));
  assign new_n125_ = ~x07 & ((new_n105_ & x17) | (~new_n126_ & ~x21 & ~x17 & x18));
  assign new_n126_ = ~new_n104_ & ~new_n128_ & ((new_n99_ & ~new_n127_) | x05);
  assign new_n127_ = ~x15 & (new_n60_ | (new_n98_ & ~x10 & ~x13));
  ...
  assign new_n134_ = ~x05 & ~x18 & (x07 | x15);
  ...
  assign new_n147_ = new_n65_ & ~x17 & ~x21;
  assign z18 = ~x17 & (~x18 | (~new_n149_ & new_n78_ & ~x09));
  assign new_n149_ = ((~new_n150_ & ~new_n85_) | x14 | x15) & (~x15 | x08 | ~x19);
  assign new_n150_ = x12 & ((~new_n151_ & ~x06) | (new_n88_ & x10 & x06 & x08));
  assign new_n151_ = ~new_n90_ & (x04 | x08 | ~x21);
  ...
  assign z21 = new_n66_ & ~new_n159_;
  assign new_n159_ = (x07 | ((x05 | (x06 ? (~x08 | ~x09 | x15) : (x09 | x08 | ~x15))) & (x09 | x15 | ~x05 | ~x06 | x08))) & (x09 | ~x07 | ~x08 | x05 | ~x15);
  ...
  assign z23 = new_n66_ & new_n78_ & x08 & x09 & ~x15;
  assign z24 = ~x17 & (~x18 | (~new_n165_ & new_n119_));
  ...
  assign new_n171_ = ~x21 & (new_n128_ | new_n172_);
  assign new_n172_ = ~x11 & x02 & x06 & ~x05 & ~x08 & ~x15;
  assign new_n173_ = new_n134_ & (~x15 | (x00 & ~x07));
  assign new_n174_ = new_n78_ & x08 & x09 & ~x15 & x03 & x19;
  assign z28 = (~new_n176_ & ~x17 & x18) | (~new_n184_ & ~x18 & ~x09 & x17);
  assign new_n176_ = (new_n183_ | x07 | ~x08) & (x05 | (~new_n177_ & ~new_n180_));
  assign new_n177_ = new_n119_ & (new_n178_ | (~x08 & (new_n179_ | (x15 & ~x19))));
  ...
  assign new_n181_ = (~x08 | ~x15) & (~new_n182_ | x02 | ~x06 | x14);
