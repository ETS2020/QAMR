...
module FAU ( 
  ...
  assign z01 = ~x17 & ((~new_n57_ & ~x05) | (new_n65_ & new_n67_ & new_n68_));
  ...
  assign new_n64_ = ~x09 & x15 & x02 & x11 & x07 & ~x18;
  assign new_n65_ = new_n66_ & ~x11;
  assign new_n66_ = ~x07 & ~x09;
  assign new_n67_ = ~x04 & ~x21 & x05 & x18;
  assign new_n68_ = x08 & x15;
  assign z02 = new_n70_ | (x17 & ~x18) | (~new_n77_ & ~x17 & x18);
  assign new_n70_ = ~x05 & (new_n71_ | (~x09 & (new_n73_ | new_n76_)));
  assign new_n71_ = ~new_n72_ & x18 & x08 & ~x17;
  assign new_n72_ = x15 ? (x11 & x02 & ~x07) : x07;
  assign new_n73_ = (new_n74_ | (x06 & (~x02 | ~x11))) & new_n75_ & ~x07;
  assign new_n74_ = ~x08 & (x15 | (~x06 & (~x04 | ~x12)));
  assign new_n75_ = ~x17 & x18;
  assign new_n76_ = (x08 | x16) & x07 & ~x18 & x01 & ~x15;
  assign new_n77_ = (new_n78_ | ~x08) & (~x05 | x08 | ~new_n66_ | x15);
  assign new_n78_ = ~new_n79_ & (~new_n63_ | x07) & ((~x07 & x12) | ~x05 | x15);
  assign new_n79_ = ~x04 & ((x05 & ~x15) | (~x11 & ~x07 & ~x09));
  assign z03 = new_n75_ & ((~x05 & ~x07) ? (~x15 & x08 & x09) : ((~x05 ^ ~x15) & (~x07 | x08) & ~x09 & (x07 | ~x08)));
  ...
  assign new_n91_ = ~x09 & new_n75_ & ~x05 & ~x07;
  ...
  assign z07 = new_n75_ & ~new_n108_;
  assign new_n108_ = ((~x05 ^ x15) | (x07 & ~x08) | x09 | (~x07 & x08)) & (~x16 | x05 | x07 | x15 | ~x08 | ~x09);
  assign z08 = z13 | (x14 & ~x20);
  assign z09 = ~x17 & ((~new_n111_ & x18) | (new_n120_ & ~x07 & ~x15));
  ...
  assign z12 = ~new_n125_ & ~x21 & new_n66_ & new_n75_;
  ...
  assign z16 = (x17 & ~x18) | (x18 & x08 & ~x17 & (new_n139_ | (~new_n134_ & ~x05)));
  assign new_n134_ = (new_n138_ | ~x09) & (new_n135_ | ~new_n137_ | x09 | x07 | x15);
  assign new_n135_ = (new_n60_ | (new_n136_ & (~x02 | ~x06))) & (new_n136_ | ~x12 | (~x06 ^ x16));
  ...
  assign z17 = (new_n141_ | new_n143_) & new_n66_ & new_n75_;
  assign new_n141_ = new_n142_ & ((~x11 & x02 & x06) | (~x06 & ~x04 & x12));
  assign new_n142_ = ~x05 & ~x08 & ~x15 & (~x14 | ~x21);
  assign new_n143_ = ~x04 & ~x21 & x05 & x08 & ~x11 & x15;
  assign z18 = z13 | (new_n91_ & (new_n145_ | (x15 & ~x08 & x19)));
  assign new_n145_ = new_n92_ & (new_n89_ | (~new_n146_ & x12 & (new_n85_ | ~x06)));
  assign new_n146_ = (~x08 | ~x10 | ~new_n88_ | x21) & ~x06 & (x04 | x08 | ~x21);
  assign z20 = z13 | (~x07 & (new_n153_ | (~new_n148_ & ~x15)));
  assign new_n148_ = ~new_n120_ & (~new_n75_ | (~new_n152_ & (x09 | (~new_n149_ & ~new_n151_))));
  assign new_n149_ = new_n150_ & ~x08 & ~x05 & ~x06;
  assign new_n150_ = (~x14 | ~x21) & (~x04 ^ ~x12);
  assign new_n151_ = ~new_n136_ & new_n101_ & new_n137_ & x08 & x10;
  assign new_n152_ = new_n101_ & ~new_n63_ & x05 & x08;
  assign new_n153_ = new_n67_ & ~x11 & x15 & ~x09 & x08 & ~x17;
  assign z21 = (x17 & ~x18) | (~new_n155_ & ~x17 & x18);
  assign new_n155_ = (x07 | ((x05 | ((x06 | x08 | x09 | ~x15) & (~x06 | x15 | ~x08 | ~x09))) & (x09 | x15 | ~x06 | ~x05 | x08))) & (x09 | ~x07 | ~x08 | x05 | ~x15);
  assign z22 = (x17 & ~x18) | (~new_n157_ & ~x17 & x18);
  assign new_n157_ = (~x07 | ~x08 | x05 | ~x15) & (x07 | ((x09 | x15 | ~x06 | ~x05 | x08) & (x05 | ((x15 | ~x08 | ~x09) & (~x06 | x08 | x09 | ~x15)))));
  assign z23 = ~x15 & x08 & x09 & new_n75_ & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n164_ | (~new_n160_ & ~x07));
  assign new_n160_ = (new_n161_ | x21) & (~x18 | x15 | x05 | x08);
  assign new_n161_ = (new_n162_ | ~x04 | x15) & (~new_n163_ | (~new_n86_ & (x04 | ~x05)));
  assign new_n162_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | x18 | ~x12 | x14);
  assign new_n163_ = (~x05 | ~x11) & x18 & x08 & x15;
  assign new_n164_ = ~x05 & ~x18 & x07 & x08 & x01 & ~x15;
  assign z25 = (x09 ? x08 : x15) & (~x08 | ~x15) & new_n75_ & ~x05 & ~x07;
  assign z26 = ~z13 & ~new_n137_ & ~x20;
  assign z27 = new_n75_ & ((~new_n168_ & ~x09) | (new_n171_ & x03 & x19));
  ...
  assign new_n171_ = ~x05 & ~x07 & ~x15 & x08 & x09;
