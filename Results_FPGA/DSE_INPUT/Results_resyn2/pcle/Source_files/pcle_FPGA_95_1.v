...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n34_, new_n39_, new_n40_, new_n44_,
    new_n46_, new_n47_;
  ...
  assign z4 = new_n39_ | (x03 & x08);
  assign new_n39_ = ((x13 & x11 & x12) | x14) & new_n40_ & ((~x08 & (~x11 | ~x12)) | ~x14 | (x12 & ~x13));
  ...
  assign new_n44_ = x15 & x16 & new_n32_ & new_n33_;
  assign z8 = new_n47_ | (new_n34_ & ((~new_n46_ & x18) | (new_n44_ & x17 & ~x18)));
  assign new_n46_ = new_n32_ & x13 & x15 & x16 & x14 & x17;
