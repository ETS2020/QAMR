...
module FAU ( 
  ...
  assign z4 = (x03 & x08) | (((new_n32_ & x13) | x14) & new_n39_ & (~new_n32_ | ~x13 | ~x14));
  assign new_n39_ = (~x08 | ~x12) & x09 & ~x10;
  ...
  assign new_n43_ = new_n44_ & new_n32_ & new_n33_;
  assign new_n44_ = x15 & x16;
  assign z8 = (x07 & x08) | (~new_n46_ & new_n34_);
  assign new_n46_ = (~x18 | (new_n32_ & x13 & new_n44_ & x14 & x17)) & (~new_n44_ | ~new_n32_ | ~x13 | ~x14 | ~x17 | x18);
endmodule
