// Benchmark "FAU" written by ABC on Wed Jul 29 21:39:12 2020
...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n42_, new_n43_;
  ...
  assign z6 = (x05 & x08) | ((~new_n31_ | ~x16) & new_n33_ & (new_n31_ | x16));
  assign z7 = (x06 & x08) | ((~x17 | ~new_n31_ | ~x16) & new_n33_ & (x17 | (new_n31_ & x16)));
  assign z8 = (x07 & x08) | (new_n43_ & ((~new_n42_ & ~x08) | (~x16 & x18)));
  assign new_n42_ = (~x18 | (new_n32_ & x17 & x14 & x15)) & (~new_n32_ | ~x14 | ~x16 | ~x17 | ~x15 | x18);
