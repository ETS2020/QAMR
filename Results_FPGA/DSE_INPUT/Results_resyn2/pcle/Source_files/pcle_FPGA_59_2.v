...
module FAU ( 
  ...
  assign z1 = (x00 & x08) | (new_n31_ & (~x11 | ~x12));
  assign z2 = (x01 & x08) | (new_n31_ & ~x11 & x12);
  assign z3 = (x02 & x08) | (new_n31_ & (~x11 | ~x13) & (x11 | x13));
  assign z4 = (x03 & x08) | ((x14 | (x11 & x13)) & new_n31_ & (~x14 | ~x11 | ~x13));
  assign z5 = (x04 & x08) | ((~new_n38_ | ~x15) & new_n31_ & (new_n38_ | x15));
  assign new_n38_ = x14 & x11 & x13;
