...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n34_, new_n43_, new_n44_;
  ...
  assign z4 = (x03 & x08) | (((new_n32_ & x13) | x14) & new_n34_ & (~new_n32_ | ~x13 | ~x14));
  ...
  assign z7 = (x06 & x08) | ((~new_n31_ | ~x16 | ~x17) & new_n34_ & ((new_n31_ & x16) | x17));
  assign z8 = (x07 & x08) | (~new_n43_ & x09 & ~x10);
  assign new_n43_ = (x08 | ((~x18 | (new_n44_ & new_n33_ & x11)) & (~new_n44_ | x18 | ~new_n33_ | ~x11 | ~x12))) & (x12 | ~x18);
  assign new_n44_ = x15 & x16 & x17;
endmodule
