...
module FAU ( 
  ...
  assign new_n31_ = x11 & x12 & x15 & x16 & x14 & x17;
  ...
  assign z6 = (x05 & x08) | (~new_n41_ & new_n32_ & ~new_n42_);
  assign new_n41_ = ~x16 & (~x15 | ~x11 | ~x12 | ~x13 | ~x14);
  assign new_n42_ = x13 & x14 & x11 & x12 & x15 & x16;
  assign z7 = (x06 & x08) | ((~new_n42_ | ~x17) & new_n32_ & (new_n42_ | x17));
  assign z8 = new_n45_ | (new_n32_ & ((~new_n31_ & x18) | (new_n42_ & x17 & ~x18)));
