...
module FAU ( 
  ...
  assign z4 = new_n37_ | ((x14 | (x13 & x11 & x12)) & new_n31_ & (~x14 | ~x13 | ~x11 | ~x12));
  assign new_n37_ = x03 & x08;
  assign z5 = (x04 & x08) | ((~new_n39_ | ~x15) & new_n31_ & (new_n39_ | x15));
  assign new_n39_ = x14 & x13 & x11 & x12;
  assign z6 = (x05 & x08) | ((x16 | (new_n39_ & x15)) & new_n31_ & (~new_n39_ | ~x15 | ~x16));
  assign z7 = (x06 & x08) | ((new_n32_ | x17) & (~new_n32_ | ~x17) & new_n42_ & (~x08 | ~x16));
