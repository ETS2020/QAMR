...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n37_, new_n41_;
  ...
  assign z4 = (x03 & x08) | (~new_n37_ & new_n31_ & (x12 | x14));
  assign new_n37_ = x13 & x11 & x12;
  assign z5 = (x04 & x08) | ((~new_n37_ | ~x15) & new_n31_ & (new_n37_ | x15));
  assign z6 = (x05 & x08) | ((~x16 | ~new_n37_ | ~x15) & new_n31_ & (x16 | (new_n37_ & x15)));
  assign z7 = (x06 & x08) | (((new_n37_ & new_n41_) | x17) & new_n31_ & (~new_n37_ | ~new_n41_ | ~x17));
