...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n38_, new_n42_, new_n44_;
  ...
  assign z4 = (x03 & x08) | ((new_n33_ | x14) & new_n31_ & ~new_n38_);
  assign new_n38_ = x13 & x14 & x11 & x12;
  assign z5 = (x04 & x08) | ((~new_n38_ | ~x15) & new_n31_ & (new_n38_ | x15));
  assign z6 = (x05 & x08) | ((x16 | (new_n38_ & x15)) & new_n31_ & (~new_n38_ | ~x15 | ~x16));
  assign z7 = new_n42_ | ((~x17 | ~new_n38_ | ~x15 | ~x16) & new_n31_ & (x17 | (new_n38_ & x15 & x16)));
  assign new_n42_ = x06 & x08;
  assign z8 = new_n44_ | ((x18 | (new_n32_ & new_n38_)) & new_n31_ & (~new_n32_ | ~new_n33_ | ~x18));
