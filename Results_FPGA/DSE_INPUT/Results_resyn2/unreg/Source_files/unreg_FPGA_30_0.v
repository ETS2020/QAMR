...
module FAU ( 
  ...
  assign z04 = (~x19 & ~x24) | (~x17 & ((x18 & ~x25) | (x19 & x07 & ~x18)));
  assign z05 = ~x17 & x19 & (x06 | x18) & (~x18 | ~x26);
  assign z06 = (~x19 & ~x26) | ((~x18 | ~x27) & ~x17 & x19 & (x05 | x18));
  assign z07 = (~x17 & x19 & (x04 | x18) & (~x18 | ~x20)) | (~x19 & ~x27);
  ...
  assign z15 = (~x17 & x19 & (x12 | x18) & (~x18 | ~x28)) | (~x19 & ~x35);
endmodule
