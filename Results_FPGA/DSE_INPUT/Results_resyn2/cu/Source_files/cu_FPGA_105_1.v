// Benchmark "FAU" written by ABC on Wed Jul 29 19:15:07 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n38_, new_n39_;
  ...
  assign z06 = new_n39_ & (new_n38_ | (~new_n34_ & ~new_n35_ & new_n36_ & new_n37_));
  assign new_n34_ = (~x01 | x10) & ~x00 & (x01 | x08);
  assign new_n35_ = x11 & x00 & x01;
  assign new_n36_ = ~x02 & x05 & ~x12 & x13;
  assign new_n37_ = ~x07 & (x01 | ~x09);
  assign new_n38_ = ~x13 & x02 & ~x05;
  assign new_n39_ = ~x03 & x04;
  assign z08 = new_n39_ & (new_n36_ | new_n38_);
  assign z09 = x06 & x13;
