// Benchmark "FAU" written by ABC on Wed Jul 29 19:15:10 2020
...
module FAU ( 
  ...
  assign z06 = z08 & (new_n35_ | new_n36_ | (~x13 & x02 & ~x05));
  assign z08 = ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13)) & ~x03 & x04;
  assign new_n35_ = (x01 | ~x08) & ~x00 & ~x07 & (~x01 | ~x10);
