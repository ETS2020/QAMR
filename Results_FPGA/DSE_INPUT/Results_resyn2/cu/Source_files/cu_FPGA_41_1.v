// Benchmark "FAU" written by ABC on Wed Jul 29 19:14:55 2020
...
module FAU ( 
  ...
  assign z06 = ~x03 & x04 & (new_n36_ | (~new_n34_ & new_n35_));
  assign new_n34_ = ((x01 & x11) | ~x00 | (~x01 & x09)) & (x08 | x00 | x01) & (~x01 | x10);
