// Benchmark "FAU" written by ABC on Wed Jul 29 19:15:27 2020
...
module FAU ( 
  ...
  assign z06 = z08 & (new_n34_ | new_n35_ | (~x13 & x02 & ~x05));
  assign new_n34_ = (x01 | ~x08) & ~x00 & ~x07 & (~x01 | ~x10);
  assign new_n35_ = (~x01 | (~x07 & ~x11)) & x00 & (x01 | ~x09);
