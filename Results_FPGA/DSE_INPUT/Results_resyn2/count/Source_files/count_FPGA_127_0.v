...
module FAU ( 
  ...
  assign new_n62_ = (~x25 | (~x23 & ~x24 & new_n56_ & ~x21 & ~x22)) & (~new_n56_ | x21 | x23 | x24 | x22 | x25);
  assign z07 = x18 | (~x08 & ~x16) | (~new_n64_ & x16);
  assign new_n64_ = (~x26 | (new_n65_ & ~x23 & ~x24 & ~x22 & ~x25)) & (~new_n65_ | x26 | x23 | x24 | x22 | x25);
  assign new_n65_ = ~x21 & ~x20 & ~x17 & ~x19;
  assign z08 = (x16 & (new_n68_ | (~new_n67_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n67_ = new_n65_ & ~x26 & ~x23 & ~x24 & ~x22 & ~x25;
  assign new_n68_ = new_n59_ & ~x23 & ~x24 & ~x27 & ~x25 & ~x26;
  assign z09 = (x16 & (new_n68_ ^ x28)) | x18 | (~x06 & ~x16);
  assign z10 = x18 | (~x05 & ~x16) | ((~new_n68_ | x28) & x16 & x29);
