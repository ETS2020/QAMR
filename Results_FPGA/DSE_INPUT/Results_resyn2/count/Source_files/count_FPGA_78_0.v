...
module FAU ( 
  ...
  assign z07 = x18 | ((~x08 | x16) & ((~x26 & new_n61_ & new_n64_) | ~x16 | (x26 & (~new_n61_ | ~new_n64_))));
  assign new_n64_ = ~x24 & ~x25;
  assign z08 = ~new_n66_ | ((~x27 | x26 | ~new_n61_ | ~new_n64_) & x16 & (x27 | (~x26 & new_n61_ & new_n64_)));
  assign new_n66_ = ~x18 & (x07 | x16);
  assign z09 = ((~new_n61_ | ~new_n68_) & ~new_n69_ & x16) | x18 | (~x06 & ~x16);
  assign new_n68_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n69_ = ~x28 & (x17 | x19 | x20 | x21);
