...
module FAU ( 
  ...
  assign z05 = ~new_n62_ | (x16 & ((x24 & (x23 | ~new_n56_ | ~new_n61_)) | (new_n56_ & new_n61_ & ~x23 & ~x24)));
  assign new_n61_ = ~x21 & ~x22;
  assign new_n62_ = ~x18 & (x10 | x16);
  assign z06 = ~new_n65_ | (x16 & ((x25 & (~new_n56_ | ~new_n61_ | ~new_n64_)) | (new_n56_ & new_n61_ & new_n64_ & ~x25)));
  assign new_n64_ = ~x23 & ~x24;
  assign new_n65_ = ~x18 & (x09 | x16);
  assign z07 = ~new_n68_ | (new_n67_ & (~new_n59_ | ~new_n64_ | x25));
  assign new_n67_ = x16 & (x26 | (~x17 & ~x19));
  assign new_n68_ = ~x18 & (x08 | x16);
