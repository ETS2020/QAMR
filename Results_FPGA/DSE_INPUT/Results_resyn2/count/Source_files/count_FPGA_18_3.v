// Benchmark "FAU" written by ABC on Thu Jul 30 00:56:15 2020
...
module FAU ( 
  ...
  wire new_n56_, new_n59_, new_n60_, new_n63_, new_n64_, new_n66_, new_n67_,
    ...
    new_n89_, new_n90_, new_n91_, new_n92_, new_n93_, new_n95_;
  ...
  assign new_n75_ = new_n56_ & new_n68_ & new_n76_ & ~x27;
  assign new_n76_ = ~x28 & ~x29;
  assign z11 = x18 | (~x04 & ~x16) | ((new_n75_ | x30) & ~new_n78_ & x16);
  assign new_n78_ = new_n60_ & ~x24 & ~x25 & new_n76_ & new_n71_ & x30;
  assign z12 = ~new_n82_ | (x16 & ((x31 & (~new_n80_ | ~new_n81_)) | (new_n74_ & new_n81_ & ~x31)));
  assign new_n80_ = new_n59_ & new_n64_ & new_n71_ & ~x28;
  assign new_n81_ = ~x29 & ~x30;
  assign new_n82_ = ~x18 & (x03 | x16);
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n84_ | new_n86_));
  assign new_n84_ = x32 & (~new_n85_ | ~new_n59_ | ~new_n64_ | ~new_n71_ | x28);
  assign new_n85_ = ~x31 & ~x29 & ~x30;
  assign new_n86_ = new_n87_ & ~x28 & new_n71_ & new_n60_ & ~x24 & ~x25;
  assign new_n87_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n89_ | (~new_n91_ & x33))) | ~new_n93_ | (x19 & x33);
  assign new_n89_ = new_n71_ & new_n59_ & new_n64_ & new_n76_ & new_n90_;
  assign new_n90_ = ~x33 & ~x30 & ~x31 & ~x32;
  assign new_n91_ = new_n92_ & new_n68_ & new_n76_ & ~x27;
  assign new_n92_ = ~x17 & ~x20 & ~x30 & ~x31 & ~x32;
  assign new_n93_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n95_ | ((new_n89_ | x34) & x16 & (~new_n75_ | ~new_n90_ | ~x34));
