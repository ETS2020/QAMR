...
module FAU ( 
  ...
  wire new_n56_, new_n59_, new_n62_, new_n64_, new_n65_, new_n66_, new_n68_,
    new_n69_, new_n71_, new_n72_, new_n76_, new_n78_, new_n79_, new_n80_,
  ...
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n71_ | x29));
  assign z11 = x18 | (~x04 & ~x16) | (x16 & ((x30 & (~new_n68_ | ~new_n72_)) | (new_n68_ & new_n72_ & ~x30)));
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (~x31 ^ (~new_n68_ | ~new_n76_)));
  assign new_n76_ = new_n72_ & ~x30;
  assign z13 = (x16 & (new_n79_ | (~new_n78_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n78_ = ~x30 & ~x31 & new_n59_ & new_n65_ & new_n72_ & ~x26;
  assign new_n79_ = ~x26 & ~x27 & new_n59_ & new_n65_ & new_n80_ & ~x28;
  assign new_n80_ = ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n83_ | (~new_n82_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n82_ = new_n80_ & new_n59_ & new_n65_ & new_n72_ & ~x26;
  assign new_n83_ = new_n84_ & new_n59_ & new_n66_ & new_n72_ & ~x30;
