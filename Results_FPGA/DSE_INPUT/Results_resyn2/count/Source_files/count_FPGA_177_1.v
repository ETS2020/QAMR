...
module FAU ( 
  ...
  wire new_n56_, new_n59_, new_n62_, new_n64_, new_n65_, new_n66_, new_n68_,
    ...
    new_n81_, new_n82_, new_n83_, new_n86_;
  ...
  assign new_n81_ = new_n79_ & new_n59_ & new_n65_ & new_n72_ & ~x26;
  assign new_n82_ = new_n83_ & new_n59_ & new_n66_ & new_n72_ & ~x29;
  assign new_n83_ = ~x32 & ~x30 & ~x31;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n82_ | x33));
  assign z15 = ~new_n86_ | (x16 & ((new_n78_ & ~x32 & ~x34) | (~new_n82_ & x34)));
