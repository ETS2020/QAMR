...
module FAU ( 
  ...
  assign z05 = x18 | ((~x10 | x16) & (x24 | ~x16 | (new_n59_ & ~x23)));
  assign z06 = x18 | (~x09 & ~x16) | (x16 & (~x25 ^ (~new_n59_ | x23)));
  assign z07 = x18 | (~x08 & ~x16) | (~new_n63_ & x16);
  assign new_n63_ = (~x26 | (~x25 & new_n59_ & ~x23)) & (~new_n59_ | x26 | x23 | x25);
  assign z08 = x18 | (~x07 & ~x16) | (~new_n65_ & x16);
  assign new_n65_ = (~x27 | (new_n59_ & new_n66_)) & (~new_n59_ | ~new_n67_);
  assign new_n66_ = ~x26 & ~x23 & ~x25;
  assign new_n67_ = ~x23 & ~x25 & ~x26 & ~x27;
