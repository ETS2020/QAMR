// Benchmark "FAU" written by ABC on Thu Jul 30 00:57:26 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n56_, new_n59_, new_n61_, new_n64_, new_n66_, new_n68_, new_n70_,
  ...
  assign new_n68_ = (~x28 | (~x27 & new_n61_ & new_n64_ & ~x26)) & (~new_n61_ | ~new_n64_ | x26 | x27 | x28);
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n72_ | (~new_n70_ & x29)));
  assign new_n70_ = new_n61_ & new_n64_ & new_n71_ & ~x26;
  assign new_n71_ = ~x27 & ~x28;
  assign new_n72_ = new_n61_ & new_n64_ & ~x26 & new_n71_ & ~x29;
  assign z11 = ~new_n74_ | (x16 & ((new_n70_ & ~x29 & ~x30) | (~new_n72_ & x30)));
  assign new_n74_ = ~x18 & (x04 | x16);
  assign z12 = x18 | (~x03 & ~x16) | (~new_n76_ & x16);
  assign new_n76_ = (~x31 | (new_n77_ & new_n61_ & new_n64_ & new_n71_ & ~x26)) & (~new_n77_ | x31 | ~new_n71_ | ~new_n61_ | ~new_n64_ | x26);
  ...
  assign z14 = ~new_n84_ | (x16 & (new_n81_ | (x33 & (~new_n72_ | ~new_n83_))));
  assign new_n81_ = new_n82_ & new_n71_ & new_n61_ & new_n64_ & ~x26;
  assign new_n82_ = ~x31 & ~x32 & ~x33 & ~x29 & ~x30;
  assign new_n83_ = ~x30 & ~x31 & ~x32;
  assign new_n84_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n86_ | ((new_n81_ | x34) & x16 & (~new_n70_ | ~new_n82_ | ~x34));
