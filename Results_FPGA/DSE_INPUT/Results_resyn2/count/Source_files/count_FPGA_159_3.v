...
module FAU ( 
  ...
  assign new_n68_ = (~x28 | (~x26 & ~x27 & new_n60_ & new_n64_)) & (~new_n60_ | ~new_n64_ | x26 | x27 | x28);
  ...
  assign z12 = ~new_n79_ | (x16 & (new_n77_ | (x31 & (~new_n75_ | ~new_n76_))));
  assign new_n75_ = new_n64_ & ~x17 & ~x20 & ~x26 & ~x30;
  assign new_n76_ = new_n73_ & ~x23 & ~x21 & ~x22;
  assign new_n77_ = new_n78_ & new_n70_ & new_n60_ & new_n64_ & ~x26;
  assign new_n78_ = ~x29 & ~x30 & ~x31;
  assign new_n79_ = (~x19 | ~x31) & ~x18 & (x03 | x16);
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n82_ | (~new_n81_ & x32)));
  assign new_n81_ = new_n78_ & new_n60_ & new_n64_ & new_n70_ & ~x26;
  assign new_n82_ = new_n83_ & new_n73_ & new_n60_ & new_n64_ & ~x26;
  assign new_n83_ = ~x32 & ~x30 & ~x31;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n85_ | (~new_n82_ & x33)));
  assign new_n85_ = new_n86_ & ~x26 & ~x27 & new_n60_ & new_n64_;
  assign new_n86_ = ~x28 & ~x29 & ~x33 & ~x32 & ~x30 & ~x31;
  assign z15 = ~new_n89_ | ((new_n85_ | x34) & x16 & (~new_n72_ | ~new_n88_ | ~x34));
  assign new_n88_ = new_n83_ & ~x33;
