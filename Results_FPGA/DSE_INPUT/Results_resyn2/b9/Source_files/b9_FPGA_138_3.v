// Benchmark "FAU" written by ABC on Thu Jul 30 01:04:55 2020
...
module FAU ( 
  ...
  assign z02 = (x04 & (~new_n73_ | ~x27)) | ~z08 | ~x02;
  assign z08 = x39 & x40;
  ...
  assign z10 = new_n82_ | (new_n81_ & ((z08 & ~new_n70_) | (new_n69_ & (z08 | x07))));
  assign new_n81_ = ~x04 & (x05 | ~x39 | ~x40);
  assign new_n82_ = x37 & x06 & x27;
  assign z11 = ~x09 & ~x30 & ((x04 & x27) | ~new_n73_ | (~x08 & ~x27));
  assign z12 = new_n85_ | ((~z08 | x04) & (new_n65_ | ~x27));
  assign new_n85_ = ~x10 & ((~x37 & ~x35 & ~x36) | (~x27 & x40));
  assign z14 = ~new_n87_ & (~x27 | (~new_n88_ & (new_n89_ | ~new_n90_)));
  ...
  assign z05 = ~z06;
  assign z13 = new_n87_ | (x27 & (new_n88_ | (~new_n89_ & new_n90_)));
  assign z18 = x09 | x30 | ((~x04 | ~x27) & new_n73_ & (x08 | x27));
  assign z19 = ~x09 & ~x30 & ((x04 & x27) | ~new_n73_ | (~x08 & ~x27));
endmodule
