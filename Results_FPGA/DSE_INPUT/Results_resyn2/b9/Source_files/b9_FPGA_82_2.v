// Benchmark "FAU" written by ABC on Thu Jul 30 01:04:33 2020
...
module FAU ( 
  ...
  assign z11 = (new_n85_ | ~new_n83_ | ~x27) & new_n86_ & (~x08 | (~new_n83_ & ~new_n84_) | (~new_n84_ & x27));
  assign new_n83_ = ~x28 & x35;
  assign new_n84_ = x29 & x39;
  assign new_n85_ = x04 & (x40 | ~x29 | ~x39);
  assign new_n86_ = ~x09 & ~x30;
  assign z12 = new_n88_ | ((~z08 | x04) & (new_n65_ | ~x27));
  assign new_n88_ = ~x10 & ((~x27 & x40) | (~x37 & ~x35 & ~x36));
  assign z14 = (~x27 | (~new_n92_ & (new_n90_ | ~new_n91_))) & (~new_n91_ | (~x30 & ~x32));
  ...
  assign z18 = ~new_n86_ | (x08 & (new_n83_ | new_n84_) & (new_n84_ | ~x27)) | (~x04 & new_n83_ & x27);
  assign z20 = ~new_n98_ & new_n86_ & (~x27 | ~x35);
  assign new_n98_ = x08 & ((~x28 & x35) | (x29 & x39));
  assign z05 = ~z06;
  assign z13 = (x27 & (new_n92_ | (~new_n90_ & new_n91_))) | (new_n91_ & (x30 | x32));
  assign z19 = (new_n85_ | ~new_n83_ | ~x27) & new_n86_ & (~x08 | (~new_n83_ & ~new_n84_) | (~new_n84_ & x27));
endmodule
