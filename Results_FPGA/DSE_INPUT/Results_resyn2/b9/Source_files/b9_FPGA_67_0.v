// Benchmark "FAU" written by ABC on Thu Jul 30 01:04:27 2020
...
module FAU ( 
  ...
  assign new_n66_ = (~x36 | x40) & (x35 | x36) & ~x04 & x39;
  ...
  assign new_n80_ = x40 & ((~x36 & (x28 | ~x35)) | (~x05 & x39));
  assign new_n81_ = x27 & (x07 | (x39 & x40));
  ...
  assign z12 = new_n88_ | ((new_n65_ | ~x27) & (~z08 | x04));
  assign new_n88_ = ~x10 & ((~x37 & ~x35 & ~x36) | (~x27 & x40));
  assign z13 = (~new_n69_ & new_n91_) | (x27 & ((~new_n65_ & new_n92_) | (~new_n90_ & new_n91_)));
