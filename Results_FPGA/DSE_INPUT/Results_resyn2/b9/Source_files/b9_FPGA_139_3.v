// Benchmark "FAU" written by ABC on Thu Jul 30 01:04:56 2020
...
module FAU ( 
  ...
  assign z01 = ~x04 | (new_n70_ & (new_n69_ | ~x27));
  ...
  assign z10 = x27 & ((~new_n69_ & new_n81_) | (x06 & x37));
  assign new_n81_ = (~x39 | ~x40) & ~x04 & x07;
  ...
  assign z13 = (~new_n70_ & new_n89_) | (x27 & ((~new_n65_ & new_n90_) | (~new_n88_ & new_n89_)));
  assign new_n88_ = x28 & (~x35 | ~x36);
  assign new_n89_ = ~x13 & ~x04 & x39 & x40;
  assign new_n90_ = x20 & ~x18 & ~x19;
  assign z14 = (~new_n90_ & (~new_n89_ | new_n92_)) | ((~new_n89_ | new_n93_) & (new_n65_ | ~x27));
  assign new_n92_ = ~x30 & ~x32 & x28 & (~x35 | ~x36);
  assign new_n93_ = (~x27 | x28) & ~x30 & ~x32;
