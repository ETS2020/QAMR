...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n71_, new_n76_, new_n80_,
    ...
    new_n91_, new_n92_, new_n97_, new_n98_, new_n100_;
  ...
  assign z11 = ~x30 & ((~new_n83_ & ~x08) | (~new_n84_ & ~new_n85_ & ~new_n86_));
  assign new_n83_ = (x09 | (x27 & ~x28 & x35)) & (~x04 | ~x40);
  assign new_n84_ = x09 & (x39 | ~x40);
  ...
  assign z18 = ~new_n98_ | (new_n97_ & (new_n85_ | ~x27));
  assign new_n97_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign new_n98_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~new_n97_ & new_n100_ & (~x35 | (~x27 & (~x09 | x28)));
  assign new_n100_ = ~x30 & (~x09 | (~x39 & x40));
  assign z05 = ~z06;
  assign z13 = (x27 & (new_n92_ | (~new_n90_ & new_n91_))) | (new_n91_ & (x30 | x32));
  assign z19 = ~x30 & ((~new_n83_ & ~x08) | (~new_n84_ & ~new_n85_ & ~new_n86_));
endmodule
