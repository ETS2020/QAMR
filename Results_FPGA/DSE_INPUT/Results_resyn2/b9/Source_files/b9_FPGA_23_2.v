...
module FAU ( 
  ...
  assign z10 = new_n82_ | ((z08 | new_n81_) & ~new_n69_ & ~x04 & (~z08 | x05));
  assign new_n81_ = x07 & x27 & (x36 | (~x28 & x35));
  assign new_n82_ = x37 & x06 & x27;
  assign z11 = ~x30 & ((~new_n84_ & (~new_n71_ | (x04 & x27))) | (new_n85_ & (~new_n71_ | x04 | ~x27)));
  assign new_n84_ = x40 & (x09 | (x29 & x39));
  ...
  assign z14 = (~new_n93_ & (~new_n90_ | new_n94_)) | ((~new_n90_ | new_n95_) & (new_n65_ | ~x27));
  ...
  assign z18 = ~new_n101_ | (new_n100_ & (~x27 | (x40 & x29 & x39)));
  assign new_n100_ = x08 & ((~x28 & x35) | (x40 & x29 & x39));
  assign new_n101_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = ~new_n100_ & new_n103_;
  assign new_n103_ = (~x09 | (~x40 & (x28 | ~x35))) & ~x30 & (~x27 | ~x35);
  assign z05 = ~z06;
  assign z19 = ~x30 & ((~new_n84_ & (~new_n71_ | (x04 & x27))) | (new_n85_ & (~new_n71_ | x04 | ~x27)));
endmodule
