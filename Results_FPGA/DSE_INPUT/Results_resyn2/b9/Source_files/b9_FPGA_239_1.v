...
module FAU ( 
  ...
  assign z02 = ~new_n71_ | (~x08 & ((x04 & ~x27) | (~x02 & x40)));
  assign new_n71_ = x39 & x40 & (~x04 | (~x28 & x35));
  ...
  assign z11 = new_n84_ & (~new_n83_ | (~z08 & x27));
  assign new_n83_ = x08 & ((x39 & x40) | (~x28 & x35));
  assign new_n84_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z12 = new_n86_ | ((~z08 | x04) & (new_n65_ | ~x27));
  assign new_n86_ = ~x10 & ((~x27 & x40) | (~x37 & ~x35 & ~x36));
  assign z13 = (x27 & ((~new_n89_ & new_n90_) | (~new_n65_ & new_n91_))) | (~new_n88_ & new_n90_);
  ...
  assign z05 = ~z06;
  assign z18 = ~new_n84_ | (new_n83_ & (z08 | ~x27));
  assign z19 = new_n84_ & (~new_n83_ | (~z08 & x27));
endmodule
