...
module FAU ( 
  ...
  assign z00 = ~x16 | (~x15 & (new_n65_ | (x27 & (~new_n66_ | new_n67_))));
  assign new_n65_ = x10 & ~x04 & x39;
  ...
  assign z10 = new_n82_ | (new_n81_ & ((~new_n70_ & z08) | (new_n69_ & (z08 | x07))));
  ...
  assign z12 = new_n87_ | ((new_n66_ | ~x27) & (x04 | ~x39 | (new_n66_ & ~x40)));
  ...
  assign z14 = (~new_n91_ & (~new_n90_ | new_n94_)) | ((~new_n90_ | new_n95_) & (new_n66_ | ~x27));
