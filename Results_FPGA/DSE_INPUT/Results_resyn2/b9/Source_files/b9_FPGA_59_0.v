...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n71_, new_n76_, new_n80_,
  ...
  assign z02 = ~new_n71_ | (x04 & (~new_n70_ | (~x08 & ~x27)));
  ...
  assign z10 = (new_n81_ & (new_n80_ | (~new_n68_ & x27))) | (x37 & x06 & x27);
  assign new_n80_ = x39 & (x30 | x32);
  assign new_n81_ = (x07 | x39) & ~x04 & (x05 | ~x39);
  assign z11 = ~new_n83_ & new_n84_ & (~new_n86_ | (~new_n85_ & x27));
  assign new_n83_ = x40 & ~x04 & x27 & ~x28 & x35;
  ...
  assign z14 = (~new_n80_ | x04 | x13) & (~x27 | (~new_n89_ & ~new_n90_));
  assign new_n89_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign new_n90_ = (~x28 | (x35 & x36)) & x39 & ~x04 & ~x13;
  assign z15 = x27 & x34 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = x01 & x22 & x23 & ~x24;
  assign z18 = (new_n70_ & ~x04 & x27) | ~new_n84_ | (x08 & (new_n70_ | new_n85_) & (new_n85_ | ~x27));
  assign z20 = ~new_n86_ & new_n84_ & (~x27 | ~x35);
  assign z05 = ~z06;
  assign z13 = (new_n80_ & ~x04 & ~x13) | (x27 & (new_n89_ | new_n90_));
  assign z19 = ~new_n83_ & new_n84_ & (~new_n86_ | (~new_n85_ & x27));
endmodule
