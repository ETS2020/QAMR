...
module FAU ( 
  ...
  assign z11 = new_n84_ & (~new_n83_ | (x27 & (~x29 | ~x39)));
  ...
  assign z05 = ~z06;
  assign z18 = ~new_n84_ | (new_n83_ & (~x27 | (x29 & x39)));
  assign z19 = new_n84_ & (~new_n83_ | (x27 & (~x29 | ~x39)));
endmodule
