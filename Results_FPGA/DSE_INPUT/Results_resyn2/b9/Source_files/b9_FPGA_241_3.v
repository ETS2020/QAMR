...
module FAU ( 
  ...
  assign z10 = new_n81_ | ((z08 | new_n69_) & new_n80_ & (new_n69_ | x30 | x32));
  assign new_n80_ = (x05 | ~x39 | ~x40) & ~x04 & (x07 | (x39 & x40));
  ...
  assign z13 = ~new_n88_ & ((~new_n65_ & new_n89_) | (new_n87_ & (new_n90_ | ~new_n91_)));
  assign new_n87_ = x40 & ~x04 & x39;
  assign new_n88_ = ~x27 & ((~x30 & ~x32) | ~x40 | x04 | ~x39);
  assign new_n89_ = x20 & ~x18 & ~x19;
  assign new_n90_ = x35 & x36;
  assign new_n91_ = ~x32 & x28 & ~x30;
  assign z14 = (~new_n89_ & (~new_n87_ | (~new_n90_ & new_n91_))) | new_n88_ | (new_n65_ & (~new_n87_ | new_n91_));
