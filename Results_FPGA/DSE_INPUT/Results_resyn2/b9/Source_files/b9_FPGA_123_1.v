...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n68_, new_n69_, new_n71_, new_n76_, new_n79_, new_n80_,
    new_n81_, new_n83_, new_n84_, new_n85_, new_n86_, new_n89_, new_n90_,
    new_n91_, new_n93_, new_n94_, new_n100_;
  assign z00 = ~x16 | (~x15 & (new_n65_ | (z08 & ~x04)));
  ...
  assign z18 = (x08 & (new_n83_ | new_n86_) & (new_n86_ | ~x27)) | ~new_n84_ | (~x04 & new_n83_ & x27);
  assign z20 = ~new_n100_ & new_n84_ & (~x27 | ~x35);
  assign new_n100_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z05 = ~z06;
  assign z19 = new_n84_ & (new_n85_ | (~new_n83_ & ~new_n86_) | (~new_n86_ & x04 & x27));
endmodule
