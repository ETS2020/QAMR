// Benchmark "FAU" written by ABC on Thu Jul 30 01:05:26 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n67_, new_n68_, new_n70_, new_n75_, new_n79_, new_n80_,
  ...
  assign z10 = new_n81_ | (~x04 & (new_n80_ | (new_n67_ & ~new_n79_)));
  ...
  assign z12 = new_n86_ | (~new_n65_ & (~z08 | x04));
  assign new_n86_ = ~x10 & ((~x27 & x40) | (~x37 & ~x35 & ~x36));
  assign z13 = (~new_n68_ & new_n89_) | ((new_n90_ | (~new_n88_ & new_n89_)) & x27);
  assign new_n88_ = x28 & (~x35 | ~x36);
  assign new_n89_ = ~x13 & ~x04 & x39 & x40;
  assign new_n90_ = (x37 | (x28 & x35)) & x20 & ~x18 & ~x19;
  assign z14 = (~new_n92_ & (~new_n89_ | (new_n68_ & new_n88_))) | (~new_n65_ & (~new_n89_ | (new_n68_ & ~new_n93_)));
