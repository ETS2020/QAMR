...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n68_, new_n69_, new_n71_, new_n72_, new_n77_,
    ...
    new_n104_;
  assign z00 = ~x16 | (~x15 & ((~new_n66_ & x27) | (new_n65_ & x10)));
  assign new_n65_ = ~x04 & x39;
  ...
  assign z10 = new_n83_ | (~x04 & (new_n81_ | (new_n68_ & new_n82_)));
  assign new_n81_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n82_ = (x39 & x40) ? x05 : x07;
  assign new_n83_ = x37 & x06 & x27;
  assign z11 = new_n85_ & (new_n86_ | (~new_n71_ & ~new_n87_) | (~new_n87_ & x04 & x27));
  assign new_n85_ = ~x09 & ~x30;
  assign new_n86_ = ~x08 & ((x04 & x40) | ~x27 | x28 | ~x35);
  assign new_n87_ = x29 & x39 & x40;
  assign z12 = (~x27 | (new_n90_ & (~x40 | new_n89_ | ~new_n65_))) & (~new_n65_ | ~x10 | ~x40);
  assign new_n89_ = ~x35 & ~x36;
  assign new_n90_ = ~x37 & (~x28 | ~x35);
  assign z13 = new_n95_ | (x27 & ((~new_n92_ & new_n93_) | (~new_n90_ & new_n94_)));
  ...
  assign z14 = (~new_n94_ & (~new_n93_ | (new_n69_ & new_n92_))) | (~new_n97_ & (~new_n93_ | (new_n69_ & ~new_n98_)));
  ...
  assign z18 = (x08 & (new_n71_ | new_n87_) & (new_n87_ | ~x27)) | ~new_n85_ | (~x04 & new_n71_ & x27);
  assign z20 = ~new_n104_ & new_n85_ & (~x27 | ~x35);
  assign new_n104_ = x08 & ((~x28 & x35) | (x29 & x39 & x40));
  assign z05 = ~z06;
  assign z19 = new_n85_ & (new_n86_ | (~new_n71_ & ~new_n87_) | (~new_n87_ & x04 & x27));
endmodule
