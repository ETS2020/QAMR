// Benchmark "FAU" written by ABC on Thu Jul 30 01:05:36 2020
...
module FAU ( 
  ...
  assign z03 = (x27 & (~x35 | (~x28 & (~x04 | x37)))) | ~x21 | (~x37 & (~x27 | (x04 & ~x28)));
  assign z04 = (x27 & (~x35 | (~x28 & (~x04 | x37)))) | x21 | (~x37 & (~x27 | (x04 & ~x28)));
