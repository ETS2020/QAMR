...
module FAU ( 
  ...
  assign new_n65_ = ((~x10 & x35) | (x36 & x40)) & ~x04 & x39;
  ...
  assign z12 = (~new_n86_ | ~x10) & (~x27 | (new_n66_ & (~new_n86_ | (~x35 & ~x36))));
  assign new_n86_ = ~x04 & x39 & x40;
  assign z14 = (~new_n89_ | (~x30 & ~x32)) & (~x27 | (~new_n90_ & (new_n88_ | ~new_n89_)));
  ...
  assign z05 = ~z06;
  assign z13 = (new_n89_ & (x30 | x32)) | (x27 & (new_n90_ | (~new_n88_ & new_n89_)));
