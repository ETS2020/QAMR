// Benchmark "FAU" written by ABC on Thu Jul 30 01:04:44 2020
...
module FAU ( 
  ...
  assign z11 = new_n83_ & (~new_n82_ | (x04 & (x27 | (~x39 & x40))));
  assign new_n82_ = (x08 | x27) & ~x28 & x35;
  assign new_n83_ = (~x39 | ~x40 | ~x08 | ~x29) & ~x09 & ~x30;
  assign z12 = ~x27 | (new_n85_ & ~new_n66_);
  assign new_n85_ = ~x37 & (~x28 | ~x35);
  assign z13 = (new_n89_ & (new_n87_ | ~new_n88_)) | (new_n65_ & new_n90_);
  assign new_n87_ = x35 & x36;
  assign new_n88_ = ~x32 & x28 & ~x30;
  assign new_n89_ = ~x13 & ~x04 & x39 & x40;
  assign new_n90_ = x20 & ~x18 & ~x19;
  assign z14 = (new_n85_ & (new_n88_ | ~new_n89_)) | ~x27 | (~new_n90_ & (~new_n89_ | (~new_n87_ & new_n88_)));
  assign z15 = x12 & x26 & x27 & x34;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = x01 & x22 & x23 & ~x24;
  assign z18 = (x08 & (new_n97_ | (new_n68_ & ~x27))) | ~new_n96_ | (new_n68_ & ~x04 & x27);
  assign new_n96_ = ~x09 & ~x30;
  assign new_n97_ = x29 & x39 & x40;
  assign z20 = ((~new_n97_ & ~x35) | ~x08 | (~x27 & x28)) & new_n96_ & (~x27 | ~x35);
  assign z05 = ~z06;
  assign z19 = new_n83_ & (~new_n82_ | (x04 & (x27 | (~x39 & x40))));
endmodule
