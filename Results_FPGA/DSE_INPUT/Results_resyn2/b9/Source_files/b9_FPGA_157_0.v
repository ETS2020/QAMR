// Benchmark "FAU" written by ABC on Thu Jul 30 01:05:03 2020
...
module FAU ( 
  ...
  assign z01 = ~x04 | ((~x27 | (~new_n69_ & ~x36)) & ~x30 & ~x32);
  assign new_n69_ = ~x28 & x35;
  assign z02 = ~new_n71_ | (x04 & (~new_n69_ | (~x08 & ~x27)));
  ...
  assign new_n80_ = x05 & (x30 | x32) & x39 & x40;
  assign new_n81_ = x40 & (~x27 | (~x05 & x39));
  assign new_n82_ = (x36 | (~x28 & x35)) & (x07 | (x39 & x40));
  assign new_n83_ = x37 & x06 & x27;
  assign z11 = ~new_n85_ & (~z08 | ~x08 | ~x29) & ~x09 & ~x30;
  assign new_n85_ = (x08 | x27) & ~x28 & x35 & (~x04 | (~x27 & x40));
  assign z12 = new_n87_ | ((~x40 | x04 | ~x39) & (new_n66_ | (~x27 & (x04 | ~x39))));
  assign new_n87_ = ~x10 & (~x27 | (~x37 & ~x35 & ~x36));
  assign z13 = new_n92_ | (x27 & ((~new_n66_ & new_n91_) | (~new_n89_ & new_n90_)));
  assign new_n89_ = x28 & (~x35 | ~x36);
  assign new_n90_ = x39 & x40 & ~x04 & ~x13;
  assign new_n91_ = x20 & ~x18 & ~x19;
  assign new_n92_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
  assign z14 = (~new_n90_ & (new_n66_ | new_n94_)) | new_n96_ | (~new_n91_ & (~new_n90_ | new_n95_));
  assign new_n94_ = ~x27 & (~x39 | x04 | x13);
  ...
  assign z18 = ~new_n101_ | (x08 & ((new_n69_ & ~x27) | (z08 & x29)));
  assign new_n101_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~new_n103_ & (~x27 | ~x35) & ~x09 & ~x30;
  assign new_n103_ = x08 & ((~x28 & x35) | (x29 & x39 & (x35 | x40)));
  assign z05 = ~z06;
  assign z19 = ~new_n85_ & (~z08 | ~x08 | ~x29) & ~x09 & ~x30;
endmodule
