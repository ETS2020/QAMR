// Benchmark "FAU" written by ABC on Thu Jul 30 01:04:26 2020
...
module FAU ( 
  ...
  assign z13 = new_n91_ | (x27 & ((~new_n88_ & new_n89_) | (~new_n65_ & new_n90_)));
  assign new_n88_ = x28 & (~x35 | ~x36);
  assign new_n89_ = x39 & x40 & ~x04 & ~x13;
  assign new_n90_ = x20 & ~x18 & ~x19;
  assign new_n91_ = ~x04 & ~x13 & (x30 | x32) & x39 & x40;
  assign z14 = (~new_n90_ & (~new_n89_ | (new_n70_ & new_n88_))) | (~new_n93_ & (~new_n89_ | (new_n70_ & ~new_n94_)));
