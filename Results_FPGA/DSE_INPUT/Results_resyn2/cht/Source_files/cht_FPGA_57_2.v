...
module FAU ( 
  ...
  assign z29 = (x41 | ~x09 | x14) & ~x10 & x40;
  assign z30 = ~x10 & (x41 | (x09 & ~x14)) & (x42 | ~x09 | x14);
  assign z31 = ~x10 & (x42 | (x09 & ~x14)) & (x43 | ~x09 | x14);
  assign z32 = ~x10 & (x43 | (x09 & ~x14)) & (x44 | ~x09 | x14);
  assign z33 = ~x10 & (x44 | (x09 & ~x14)) & (x45 | ~x09 | x14);
  assign z34 = ~x10 & (x45 | (x09 & ~x14)) & (x46 | ~x09 | x14);
