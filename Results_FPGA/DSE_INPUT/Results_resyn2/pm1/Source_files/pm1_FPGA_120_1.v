...
module FAU ( 
  ...
  wire new_n34_, new_n37_, new_n41_, new_n42_;
  ...
  assign z09 = x00 & ((~x10 & (x11 ^ ~x12)) | (~x04 & x09 & x11 & x12));
  assign z10 = new_n41_ & new_n42_ & x09;
  assign new_n41_ = x12 & (~x04 | (~x10 & (~x02 | ~x03)));
  assign new_n42_ = x00 & x11;
  assign z11 = new_n42_ & ((new_n41_ & x01 & x09) | (~x12 & ~x01 & ~x10));
