...
module FAU ( 
  ...
  assign z06 = x09 & (~z01 | (~new_n37_ & x01));
  assign new_n37_ = x04 & x02 & x03;
  assign z08 = new_n39_ | (~x11 & (x01 | ~x12)) | ~x00 | x10;
  assign new_n39_ = x04 & x02 & x03 & x11 & x09 & x12;
  assign z09 = x00 & ~x10 & (~x11 ^ x12);
  assign z10 = x11 & x00 & ~x10 & ~new_n37_ & x09 & x12;
  assign z11 = ~new_n43_ & x11 & x00 & ~x10;
  assign new_n43_ = x01 & (~x09 | ~x12 | (x04 & x02 & x03));
