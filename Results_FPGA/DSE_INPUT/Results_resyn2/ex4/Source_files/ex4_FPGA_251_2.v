...
module FAU ( 
  ...
  assign new_n209_ = ~x080 & (~x120 | x016 | x104);
  assign new_n210_ = (~x024 | (x008 & x016)) & ((x008 & x016) | (~x056 & ~x088));
  assign new_n211_ = (~x104 | (x032 & (x112 | ~x120))) & (x032 | (~x112 & (x056 | ~x096)));
  ...
  assign new_n220_ = (new_n221_ | ~x008) & (~x032 | ~x048) & (x048 | ~x064 | x008 | ~x016);
