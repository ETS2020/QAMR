// Benchmark "FAU" written by ABC on Thu Jul 30 10:33:53 2020
...
module FAU ( 
  ...
  assign new_n193_ = (~x110 | ~x118 | (x094 & ~x102)) & (x038 | (~x126 & x110 & ~x118));
  assign new_n194_ = x070 & (~x110 | ~x118 | (x062 & (~x102 | ~x126)));
  assign new_n195_ = x086 & ((~x014 & ~x022) | (x062 & x094));
  assign new_n196_ = (x030 | (~x014 & ~x022)) & (x126 | ~x022 | ~x118);
  assign new_n197_ = ~x014 & x038 & x094 & ~x126;
