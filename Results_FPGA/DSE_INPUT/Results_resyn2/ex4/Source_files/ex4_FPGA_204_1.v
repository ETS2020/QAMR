// Benchmark "FAU" written by ABC on Thu Jul 30 10:36:39 2020
...
module FAU ( 
  ...
  assign new_n208_ = ~x064 & (x104 | x112 | (~x056 & (x096 | x120)));
  assign new_n209_ = ~x080 & (~x120 | x016 | x112);
  assign new_n210_ = (~x024 | (x008 & x016)) & ((x008 & x016) | (~x056 & ~x088));
  assign new_n211_ = (~x112 | (x032 & (x104 | ~x120))) & (x032 | (~x104 & (x088 | ~x096)));
  assign new_n212_ = x008 & ~x032 & ~x088 & x120;
  ...
  assign z13 = ~x045 & (new_n235_ | new_n242_ | ~new_n248_);
  ...
  assign new_n242_ = ~x085 & (new_n247_ | (~x053 & (new_n243_ | (~new_n245_ & ~x077))));
  ...
  assign new_n247_ = x037 & ~x077 & (~new_n186_ | (x029 & (~x013 | ~x021)));
