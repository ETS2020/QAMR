...
module FAU ( 
  ...
  assign z05 = x045 & (new_n174_ | ~new_n188_ | (~x005 & (new_n182_ | new_n187_)));
  assign new_n174_ = x085 & (new_n181_ | ((new_n175_ | ~new_n178_) & x053));
  assign new_n175_ = x077 & ((~new_n176_ & ~x029) | (~new_n177_ & ~x069));
  assign new_n176_ = (~x021 | x069) & ((~x013 & ~x021) | x101 | (~x061 & ~x093));
  assign new_n177_ = x061 & x093;
  assign new_n178_ = (new_n179_ | (x013 & (~x077 | (~new_n180_ & x021)))) & (~new_n180_ | x125 | (~x013 & ~x021));
  assign new_n179_ = x109 & x117;
  assign new_n180_ = ~x029 & (x061 | x093);
  assign new_n181_ = (~new_n177_ | (~x029 & (x013 | x021))) & ~x037 & x077;
  assign new_n182_ = x053 & ((x077 & (~new_n183_ | new_n185_)) | (~new_n186_ & ~x125));
  assign new_n183_ = x085 & (x029 | (~x013 & ~x021)) & ~new_n184_ & (new_n177_ | (~x013 & ~x021));
  assign new_n184_ = (~x109 | ~x117) & (x037 | x069);
  assign new_n185_ = ~x101 & ((x069 & x093) | (x037 & x061));
  assign new_n186_ = (x117 ? ~x021 : ~x109) & (~x069 | ~x093) & (~x061 | x093);
  assign new_n187_ = ~x085 & x013 & x037;
  ...
  assign z13 = ~x045 & (~new_n239_ | ((new_n233_ | ~new_n236_) & ~x077));
  assign new_n233_ = ~x085 & ((~new_n234_ & ~x053) | (x037 & (x061 | x093)));
  assign new_n234_ = new_n235_ & ((x013 & x021) | new_n177_ | ~x029);
  assign new_n235_ = (~x021 | (~x109 & ~x117)) & (~x069 | (~x061 & ~x093));
  assign new_n236_ = (~new_n237_ | new_n238_) & (x037 | ((~new_n237_ | x013) & (~x021 | ~x069)));
  assign new_n237_ = x005 & ~x053;
  assign new_n238_ = (x117 ? x109 : x021) & ~x085 & (x069 | x093);
  assign new_n239_ = (~x013 | (~x077 & (new_n240_ | x053))) & (~x037 | ~x053) & (new_n241_ | x013);
  assign new_n240_ = (x061 | ~x005 | x037) & (x085 | (~x109 & ~x117));
  assign new_n241_ = (x053 | ~x021 | ~x069) & (~x085 | ~x005 | x037);
  ...
  assign new_n247_ = (~x030 | (x014 & x022)) & ((x014 & x022) | (~x062 & ~x094));
