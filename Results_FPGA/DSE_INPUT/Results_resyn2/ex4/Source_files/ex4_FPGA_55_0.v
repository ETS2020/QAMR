...
module FAU ( 
  ...
  assign new_n219_ = (new_n220_ | ~x008) & (~x032 | ~x048) & (x048 | ~x064 | x008 | ~x016);
  ...
  assign z13 = ~x045 & ((~new_n234_ & ~x077) | ~new_n241_ | (x013 & (new_n242_ | x077)));
  assign new_n234_ = new_n237_ & (x053 | ((new_n235_ | x085) & (new_n240_ | ~x005)));
  assign new_n235_ = new_n236_ & ((x013 & x021) | new_n177_ | ~x029);
  assign new_n236_ = (~x069 | (~x061 & ~x093)) & (~x021 | (~x109 & ~x117));
  assign new_n237_ = x037 ? new_n239_ : (~new_n238_ & (x061 | ~x005 | x053));
  assign new_n238_ = x021 & x069;
  assign new_n239_ = (x085 | (~x061 & ~x093)) & (x109 | ~x005 | x013);
  assign new_n240_ = ~x085 & (x021 | x117) & (x069 | x093) & (x013 | ~x093);
  assign new_n241_ = (~x037 | ~x053) & (x013 | ((~new_n238_ | x053) & (~x085 | ~x005 | x037)));
  assign new_n242_ = (x109 | x117) & ~x053 & ~x085;
