// Benchmark "FAU" written by ABC on Wed Jul 29 20:56:57 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n44_, new_n45_, new_n47_, new_n48_;
  assign z01 = x19 & (~x00 | (new_n44_ & new_n45_ & (x08 | ~x09) & (~x08 | x09)));
  assign new_n44_ = ~x04 & ~x03 & ~x01 & ~x02;
  assign new_n45_ = ~x07 & ~x05 & ~x06;
  assign z02 = (x00 & (x04 | (x19 & (~new_n47_ | ~new_n45_)))) | (x19 & new_n47_ & ~x04 & new_n45_ & new_n48_);
  assign new_n47_ = ~x03 & ~x01 & ~x02;
  assign new_n48_ = x08 & ~x09;
  assign z04 = x20 | x21;
  assign z05 = x10 | (new_n44_ & x19 & new_n45_ & ~x08);
