...
module FAU ( 
  ...
  assign new_n62_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x19 | x20 | x21 | x17 | x22);
  assign z13 = (~new_n64_ & x16) | ((x04 | ~x18) & ~x16 & (x12 | x18));
  assign new_n64_ = (~x23 | (~x19 & ~x20 & ~x21 & ~x17 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = new_n69_ | (x16 & ((~new_n66_ & x24) | (~new_n67_ & new_n68_)));
  assign new_n66_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n67_ = x19 & ~x25;
  assign new_n68_ = ~x23 & ~x24 & ~x20 & ~x21 & ~x17 & ~x22;
  assign new_n69_ = (x05 | ~x18) & ~x16 & (x13 | x18);
  assign z15 = ~new_n72_ & ((~new_n68_ & x25) | ~x16 | (new_n71_ & new_n73_));
  assign new_n71_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n72_ = (~x06 | ~x18) & ~x16 & (~x14 | x18);
  assign new_n73_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = ~new_n75_ & ((~x26 & new_n71_ & new_n73_) | ~x16 | (x26 & (~new_n71_ | ~new_n73_)));
  assign new_n75_ = (~x07 | ~x18) & ~x16 & (~x15 | x18);
  assign z17 = x16 & ((new_n77_ & new_n78_) | (x17 & x27));
  assign new_n77_ = x19 & ~x26 & ~x17 & ~x22;
