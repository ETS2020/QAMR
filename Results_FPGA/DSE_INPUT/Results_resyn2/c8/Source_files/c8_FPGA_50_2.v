// Benchmark "FAU" written by ABC on Wed Jul 29 23:43:19 2020
...
module FAU ( 
  ...
  assign new_n62_ = x22 ^ (~new_n63_ | x17 | x19);
  assign new_n63_ = ~x20 & ~x21;
  assign z13 = (~new_n65_ & x16) | ((x04 | ~x18) & ~x16 & (x12 | x18));
  assign new_n65_ = (~x23 | (~x22 & new_n63_ & ~x17 & ~x19)) & (~new_n63_ | x17 | x19 | x22 | x23);
  assign z14 = ((x05 | ~x18) & ~x16 & (x13 | x18)) | ((~new_n67_ | ~x24) & x16 & (new_n67_ | x24));
  assign new_n67_ = new_n68_ & new_n63_ & ~x17 & ~x19;
  assign new_n68_ = ~x22 & ~x23;
  assign z15 = (~new_n70_ & x16) | ((x06 | ~x18) & ~x16 & (x14 | x18));
  assign new_n70_ = (~x25 | (new_n63_ & ~x17 & new_n68_ & ~x24)) & ~x19 & (~new_n63_ | x17 | ~new_n68_ | x24 | x25);
  assign z16 = (~new_n72_ & x16) | ((x07 | ~x18) & ~x16 & (x15 | x18));
  assign new_n72_ = (~x26 | (new_n63_ & ~x17 & new_n68_ & ~x24 & ~x25)) & (~new_n68_ | x24 | ~new_n63_ | x26 | x17 | x25);
