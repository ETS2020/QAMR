...
module FAU ( 
  ...
  assign z15 = new_n72_ | (((new_n66_ & new_n71_) | x25) & x16 & (~x25 | ~new_n66_ | ~new_n68_));
  assign new_n71_ = (~x21 | x26) & ~x22 & ~x23 & ~x24;
  assign new_n72_ = (x06 | ~x18) & ~x16 & (x14 | x18);
  assign z16 = new_n75_ | (x16 & (((~new_n66_ | ~new_n74_) & x26) | (new_n62_ & new_n74_ & ~x26)));
  assign new_n74_ = ~x23 & ~x24 & ~x22 & ~x25;
  assign new_n75_ = (x07 | ~x18) & ~x16 & (x15 | x18);
  assign z17 = x16 & ((x17 & x27) | (new_n78_ & new_n77_ & ~x17 & x19));
  assign new_n77_ = ~x20 & ~x21;
  assign new_n78_ = ~x26 & ~x23 & ~x24 & ~x22 & ~x25;
  assign z08 = x27;
endmodule
