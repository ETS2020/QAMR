// Benchmark "FAU" written by ABC on Wed Jul 29 23:42:54 2020
...
module FAU ( 
  ...
  assign new_n64_ = (x20 | x17 | x19 | x23 | x21 | x22) & (~x23 | (~x20 & ~x17 & ~x19 & ~x21 & ~x22));
  assign z14 = ((x05 | ~x18) & ~x16 & (x13 | x18)) | (x16 & (new_n66_ ^ x24));
  assign new_n66_ = ~x20 & ~x17 & ~x19 & ~x23 & ~x21 & ~x22;
  assign z15 = ~new_n69_ & (~x16 | (~new_n68_ & (~new_n66_ | x24)));
  assign new_n68_ = ~x25 & (x20 | x17 | x19 | x21 | x22);
