// Benchmark "FAU" written by ABC on Wed Jul 29 23:44:17 2020
...
module FAU ( 
  ...
  assign z09 = ((x00 | ~x18) & ~x16 & (x08 | x18)) | (~x17 & ~x19) | (x17 & x16 & x19);
  assign z10 = ~new_n58_ | ((x01 | ~x18) & ~x16 & (x09 | x18));
  assign new_n58_ = x20 ? (x19 ? ~x16 : ~x17) : (x17 | x19);
  assign z11 = (x21 & ((x17 & ~x19) | (x16 & (x19 | x20)))) | new_n60_ | (~x21 & ~x20 & ~x17 & ~x19);
  assign new_n60_ = (x02 | ~x18) & ~x16 & (x10 | x18);
  assign z12 = ~new_n62_ | (~x19 & (new_n64_ | (x17 & x22)));
  assign new_n62_ = ((~x03 & x18) | x16 | (~x11 & ~x18)) & (new_n63_ | ~x16 | ~x22);
  assign new_n63_ = ~x19 & ~x20 & ~x21;
  assign new_n64_ = ~x20 & ~x21 & ~x17 & ~x22;
  assign z13 = new_n66_ | new_n67_ | (x16 & x23 & (~new_n63_ | x22));
  assign new_n66_ = (x23 | (~x17 & ~x20 & ~x21)) & ~x19 & (x17 | (~x22 & ~x23));
  assign new_n67_ = (x04 | ~x18) & ~x16 & (x12 | x18);
  assign z14 = ~new_n69_ | (~x19 & ((x17 & x24) | (new_n64_ & ~x23 & ~x24)));
  assign new_n69_ = ~new_n70_ & (~x16 | ~x24 | (new_n63_ & ~x22 & ~x23));
  assign new_n70_ = (x05 | ~x18) & ~x16 & (x13 | x18);
  assign z15 = new_n72_ | new_n74_ | ((x06 | ~x18) & ~x16 & (x14 | x18));
  assign new_n72_ = ~x19 & ((x17 & x25) | (new_n73_ & ~x17 & ~x20 & ~x21));
  assign new_n73_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n74_ = x16 & x25 & (~new_n63_ | x24 | x22 | x23);
  assign z16 = new_n76_ | new_n78_ | ((x07 | ~x18) & ~x16 & (x15 | x18));
  assign new_n76_ = ~x19 & ((x17 & x26) | (new_n64_ & new_n77_ & ~x25 & ~x26));
  assign new_n77_ = ~x23 & ~x24;
  assign new_n78_ = (~new_n63_ | ~new_n73_) & x16 & x26;
  assign z17 = x16 & ((x17 & x27) | (new_n80_ & ~x17 & ~x20 & ~x21));
  assign new_n80_ = ~x25 & ~x26 & ~x22 & ~x23 & x19 & ~x24;
  assign z08 = x27;
endmodule
