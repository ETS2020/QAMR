...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n58_, new_n60_, new_n62_, new_n64_, new_n66_, new_n67_, new_n71_,
    new_n72_;
  ...
  assign new_n62_ = (~x22 | (~x21 & ~x20 & ~x17 & ~x19)) & x16 & (x20 | x17 | x19 | x21 | x22);
  assign z13 = ((x04 & x18) | x16 | (x12 & ~x18)) & ((new_n64_ & ~x23) | ~x16 | (~new_n64_ & x23));
  assign new_n64_ = ~x20 & ~x17 & ~x19 & ~x21 & ~x22;
  assign z14 = ((x05 | ~x18) & ~x16 & (x13 | x18)) | (~new_n66_ & ~new_n67_ & x16);
  assign new_n66_ = ~x23 & ~x20 & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n67_ = ~x24 & (x17 | x19);
  assign z15 = x16 ? x25 : (x18 ? x06 : x14);
  assign z16 = x16 ? x26 : (x18 ? x07 : x15);
  assign z17 = x16 & ((x17 & x27) | (new_n72_ & new_n71_ & ~x17 & ~x20));
