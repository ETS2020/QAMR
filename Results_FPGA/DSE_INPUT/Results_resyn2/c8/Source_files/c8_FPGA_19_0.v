...
module FAU ( 
  ...
  assign new_n62_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x17 | x19 | x22 | x20 | x21);
  assign z13 = ((x04 | ~x18) & ~x16 & (x12 | x18)) | (x16 & (new_n64_ ^ x23));
  assign new_n64_ = ~x17 & ~x19 & ~x22 & ~x20 & ~x21;
  assign z14 = (~new_n66_ & x16) | ((x05 | ~x18) & ~x16 & (x13 | x18));
  assign new_n66_ = (~x24 | (new_n64_ & ~x23)) & (~new_n64_ | x23 | x24);
  assign z15 = ((new_n68_ & ~x25) | ~x16 | (~new_n68_ & x25)) & ((x06 & x18) | x16 | (x14 & ~x18));
  assign new_n68_ = new_n64_ & ~x23 & ~x24;
  assign z16 = (x16 & (new_n70_ | new_n72_)) | ((x07 | ~x18) & ~x16 & (x15 | x18));
  assign new_n70_ = ~x22 & (x17 | (~new_n71_ & ~x17 & ~x19 & ~x20 & ~x21));
  assign new_n71_ = ~x25 & ~x23 & ~x24;
  assign new_n72_ = x26 & (x20 | x21 | x19 | x22);
