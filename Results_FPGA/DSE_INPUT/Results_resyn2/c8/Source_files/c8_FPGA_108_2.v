...
module FAU ( 
  ...
  assign z12 = ((x03 | ~x18) & ~x16 & (x11 | x18)) | ((~new_n62_ | ~x22) & x16 & (new_n62_ | x22));
  assign new_n62_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z13 = (~new_n64_ & x16) | ((x04 | ~x18) & ~x16 & (x12 | x18));
  assign new_n64_ = (~x23 | (new_n65_ & ~x22)) & ~x17 & (~new_n65_ | x22 | x23);
  assign new_n65_ = ~x19 & ~x20 & ~x21;
  assign z14 = (~new_n67_ & x16) | ((x05 | ~x18) & ~x16 & (x13 | x18));
  assign new_n67_ = (~x24 | (new_n65_ & ~x22 & ~x23)) & (~new_n65_ | x24 | x22 | x23);
  assign z15 = (~new_n69_ & x16) | ((x06 | ~x18) & ~x16 & (x14 | x18));
  assign new_n69_ = (~x25 | (new_n65_ & ~x24 & ~x22 & ~x23)) & (~new_n65_ | x22 | x23 | x24 | x25);
  assign z16 = (~new_n71_ & x16) | ((x07 | ~x18) & ~x16 & (x15 | x18));
  assign new_n71_ = (~x26 | (new_n65_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n65_ | x22 | x24 | x25 | x23 | x26);
