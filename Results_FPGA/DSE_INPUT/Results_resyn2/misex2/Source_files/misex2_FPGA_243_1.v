// Benchmark "FAU" written by ABC on Wed Jul 29 21:22:24 2020
...
module FAU ( 
  ...
  assign z09 = (new_n62_ | (new_n60_ & new_n61_)) & ~x00 & ~x21;
  assign new_n60_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n61_ = ~x14 & ~x15 & ~x16 & x20;
  assign new_n62_ = x18 & ~x19 & ~x22 & x01 & ~x20;
  assign z10 = ~x00 & (new_n65_ | (new_n60_ & new_n64_ & x16 & x20));
  assign new_n64_ = ~x21 & ~x14 & x15;
  assign new_n65_ = x22 & ~x20 & x21 & x01 & x18 & ~x19;
  assign z11 = ~x00 & (new_n67_ | (new_n60_ & new_n64_ & ~x16 & x20));
  assign new_n67_ = x01 & x18 & ~x19 & ~x22 & ~x20 & x21;
