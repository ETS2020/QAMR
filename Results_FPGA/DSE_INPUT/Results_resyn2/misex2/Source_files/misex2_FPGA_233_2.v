...
module FAU ( 
  ...
  assign new_n63_ = ~x14 & x15 & x20 & ~x21;
  assign z11 = ~x00 & ~x22 & (new_n62_ | (new_n59_ & new_n63_ & ~x16));
  assign z12 = ~new_n66_ & x09 & ~x24;
  assign new_n66_ = (x02 | ((~x00 | ~x01) & (x00 | x01 | ~x17 | x19))) & ((~x02 & ~x19) | ~x23 | x00 | x01);
  assign z13 = ~x02 & new_n49_ & x17 & ~x19;
