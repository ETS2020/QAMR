...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n51_, new_n53_, new_n56_, new_n58_, new_n61_, new_n62_,
    new_n63_, new_n65_, new_n66_, new_n69_;
  ...
  assign z03 = (z06 & x12) | (new_n51_ & x18 & ~x00 & ~x01);
  assign z06 = x02 & x00 & x01 & x11 & ~x09 & x10;
  assign new_n51_ = ~x19 & ~x02 & ~x17;
  assign z04 = new_n53_ & x02 & x00 & x01;
  ...
  assign new_n65_ = x21 & x01 & x18 & ~x19 & ~x20;
  assign new_n66_ = x20 & ~x21 & ~x14 & x15;
  assign z11 = ~x00 & ~x22 & (new_n65_ | (new_n62_ & new_n66_ & ~x16));
  assign z12 = ~new_n69_ & x09 & ~x24;
  assign new_n69_ = (~x00 | ~x01 | (x02 & x10)) & (x00 | x01 | (~x19 & ~x02 & ~x17));
