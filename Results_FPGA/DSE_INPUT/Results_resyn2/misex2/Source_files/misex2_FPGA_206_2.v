...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n52_, new_n55_, new_n58_, new_n59_, new_n60_,
    new_n62_, new_n63_, new_n66_;
  assign z00 = new_n46_ & ~x09 & ~x01 & ~x02;
  assign new_n46_ = ~x18 & ~x19 & x10 & ~x17;
  assign z01 = new_n46_ & ~x02 & ~x00 & ~x01 & x09;
  assign z02 = new_n49_ & ~x02 & ~x00 & ~x01 & x09;
  assign new_n49_ = ~x18 & ~x19 & ~x10 & ~x17;
  assign z03 = ~x02 & ~x19 & ~x00 & ~x01 & ~x17 & x18;
  assign z05 = new_n52_ & x00 & x01;
  ...
  assign z12 = ~x24 & ((~new_n52_ & x00 & x01) | (~new_n66_ & ~x00 & ~x01 & x09));
  assign new_n66_ = (~x02 & ~x19) ? ~x17 : ~x23;
  assign z13 = ~x00 & ~x01 & x17 & ~x02 & ~x19;
  assign z14 = new_n49_ & ~x09 & ~x01 & ~x02;
  assign z15 = (~x01 & ~x02 & x19) | (x00 & (~x02 | (x01 & ~x10)));
  assign z16 = ~x00 & x01;
  assign z04 = 1'b0;
  assign z06 = 1'b0;
endmodule
