...
module FAU ( 
  ...
  wire new_n46_, new_n52_, new_n55_, new_n57_, new_n60_, new_n61_, new_n62_,
    new_n64_, new_n65_, new_n66_, new_n68_, new_n70_;
  ...
  assign z09 = new_n62_ & (new_n60_ | (new_n61_ & x20 & ~x15 & ~x16));
  assign new_n60_ = x18 & ~x19 & x01 & ~x20;
  assign new_n61_ = ~x13 & ~x14 & ~x11 & x12 & ~x01 & x02;
  assign new_n62_ = ~x21 & ~x00 & ~x22;
  assign z10 = ~x00 & ((new_n64_ & new_n66_) | (new_n65_ & x22));
  assign new_n64_ = ~x13 & ~x14 & ~x11 & x12;
  assign new_n65_ = x21 & x18 & ~x19 & x01 & ~x20;
  assign new_n66_ = x20 & ~x21 & x02 & x15 & x16 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n65_ | (new_n61_ & new_n68_));
  assign new_n68_ = x15 & ~x16 & x20 & ~x21;
  assign z12 = (new_n70_ | (new_n52_ & (~x02 | ~x10))) & x09 & ~x24;
