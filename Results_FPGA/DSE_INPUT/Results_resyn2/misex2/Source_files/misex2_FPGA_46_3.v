...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n49_, new_n52_, new_n57_, new_n60_, new_n61_, new_n62_,
    new_n64_, new_n65_, new_n67_, new_n69_;
  ...
  assign z04 = new_n52_ & x02 & ~x09 & x10 & ~x11 & ~x12;
  assign new_n52_ = x00 & x01;
  assign z05 = x02 & x10 & new_n52_ & x09;
  assign z06 = new_n52_ & x02 & x11 & ~x09 & x10;
  assign z07 = x00 & x02 & (~x01 | (x11 & ~x09 & x10));
  assign z08 = new_n57_ & z17 & x19 & x17 & ~x18;
  assign new_n57_ = ~x03 & x04 & ~x05 & ~x06 & ~x07 & ~x08;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = (new_n60_ | (new_n61_ & new_n62_)) & ~x00 & ~x21 & ~x22;
  assign new_n60_ = ~x19 & ~x20 & x01 & x18;
  assign new_n61_ = x12 & ~x13 & ~x01 & x02;
  assign new_n62_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((x22 & new_n60_ & x21) | (new_n64_ & new_n65_ & ~x21 & ~x22));
  assign new_n64_ = x12 & ~x13 & ~x01 & x02 & ~x14 & x15;
  assign new_n65_ = x16 & x20;
  assign z11 = ((new_n60_ & x21) | (new_n64_ & new_n67_ & ~x21)) & ~x00 & ~x22;
  assign new_n67_ = ~x16 & x20;
  assign z12 = (new_n69_ | (new_n52_ & (~x02 | ~x10))) & x09 & ~x24;
  assign new_n69_ = (x17 | x02 | x19) & ~x00 & ~x01 & (x23 | (~x02 & ~x19));
