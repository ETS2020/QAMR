...
module FAU ( 
  ...
  assign z09 = (new_n60_ | (new_n61_ & new_n62_)) & ~x22 & ~x00 & ~x21;
  assign new_n60_ = x18 & ~x19 & x01 & ~x20;
  assign new_n61_ = ~x01 & x02 & ~x13 & ~x11 & x12;
  assign new_n62_ = ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((new_n61_ & new_n64_) | (new_n60_ & x21 & x22));
  assign new_n64_ = ~x21 & ~x14 & x15 & x16 & x20;
  assign z11 = ~x00 & ((new_n61_ & new_n66_) | (new_n60_ & x21 & ~x22));
  assign new_n66_ = ~x16 & x20 & ~x21 & ~x14 & x15;
