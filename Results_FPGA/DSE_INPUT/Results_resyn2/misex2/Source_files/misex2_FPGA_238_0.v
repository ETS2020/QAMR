// Benchmark "FAU" written by ABC on Wed Jul 29 21:22:23 2020
...
module FAU ( 
  ...
  assign z09 = (new_n60_ | (new_n61_ & ~x15 & ~x16)) & new_n62_ & ~x21;
  assign new_n60_ = ~x20 & x18 & ~x19;
  assign new_n61_ = ~x13 & ~x14 & ~x11 & x12 & ~x01 & x02;
  assign new_n62_ = ~x00 & ~x22;
  assign z10 = ~x00 & ((x22 & new_n60_ & x21) | (new_n61_ & new_n64_ & ~x21 & ~x22));
  assign new_n64_ = x15 & x16;
  assign z11 = new_n62_ & ((new_n60_ & x21) | (new_n61_ & ~x21 & x15 & ~x16));
  assign z12 = (new_n67_ | (new_n52_ & (~x02 | ~x10))) & x09 & ~x24;
