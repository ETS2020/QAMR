...
module FAU ( 
  ...
  wire new_n46_, new_n52_, new_n55_, new_n57_, new_n58_, new_n59_, new_n61_,
    new_n62_, new_n65_;
  assign z00 = new_n46_ & ~x09 & ~x18 & x10 & ~x17;
  assign new_n46_ = ~x02 & ~x00 & ~x01;
  assign z01 = ~x18 & x10 & ~x17 & new_n46_ & x09;
  assign z02 = new_n46_ & x09 & ~x18 & ~x10 & ~x17;
  ...
  assign new_n65_ = (~x00 | ~x01 | (x02 & x10)) & ((x02 & ~x23) | x00 | x01 | (~x02 & ~x17));
  assign z13 = new_n46_ & x17;
  assign z14 = new_n46_ & ~x09 & ~x18 & ~x10 & ~x17;
