...
module FAU ( 
  ...
  assign z06 = ~x09 & x00 & x01 & x10 & x11;
  assign z04 = ~x09 & x00 & x01 & ~x11 & x10 & ~x12;
  assign z05 = x00 & x01 & x09 & x10;
  assign z07 = ~new_n53_ & x00;
  assign new_n53_ = (x01 | ~x02) & (~x10 | x12 | ~x11 | ~x01 | x09);
  ...
  assign z12 = x09 & ~x24 & ((~new_n65_ & ~x00 & ~x01) | (x00 & x01 & ~x10));
