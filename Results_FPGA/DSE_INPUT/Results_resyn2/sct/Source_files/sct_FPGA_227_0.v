...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n39_, new_n43_, new_n45_, new_n49_, new_n51_;
  ...
  assign z09 = (x13 & (~new_n49_ | (~new_n45_ & x04))) | new_n43_ | ~x04 | (new_n45_ & new_n49_ & ~x13 & ~x16);
  assign new_n49_ = ~x12 & ~x10 & ~x11;
  assign z10 = x04 & ((new_n45_ & (new_n51_ | (~new_n43_ & x00))) | (new_n43_ & x14));
  assign new_n51_ = ~x12 & ~x10 & ~x11 & ~x13 & ~x16;
  assign z12 = x04 & (x03 | (~x02 & x16));
  assign z13 = x04 & (new_n45_ | x03 | x13);
  assign z14 = x04 & x17;
  assign z11 = x02;
endmodule
