// Benchmark "FAU" written by ABC on Wed Jul 29 23:09:42 2020
...
module FAU ( 
  ...
  assign new_n24_ = (~x02 | ~x04 | ((x08 | x10) & (~x09 | ~x13))) & (~x10 | (~x08 & x02 & x04));
  assign z2 = ~new_n29_ | (x03 & (new_n28_ | (new_n22_ & (new_n26_ | new_n27_))));
  assign new_n26_ = x09 & x13;
  assign new_n27_ = ~x11 & ~x08 & ~x10;
  assign new_n28_ = x11 & (~x02 | ~x04 | x08 | x10);
  assign new_n29_ = x05 & (x03 | x06);
  assign z3 = ~new_n31_ | ((x12 | (new_n22_ & (new_n26_ | new_n27_))) & x03 & (~new_n27_ | new_n26_ | ~new_n22_ | ~x12));
