// Benchmark "FAU" written by ABC on Wed Jul 29 23:09:28 2020
...
module FAU ( 
  ...
  assign new_n22_ = x08 ? (x02 & (~x13 | ~x04 | ~x09)) : (~x02 | ~x04);
  assign z1 = (~new_n24_ & x03) | ~x05 | (~x01 & ~x03);
  assign new_n24_ = (~x02 | ~x04 | ((~x09 | ~x13) & (x08 | x10))) & (~x10 | (~x08 & x02 & x04));
  assign z2 = ~new_n30_ | (x03 & (new_n29_ | (new_n26_ & (new_n27_ | new_n28_))));
  ...
  assign z3 = ~new_n32_ | ((x12 | (new_n26_ & (new_n27_ | new_n28_))) & x03 & (~new_n28_ | new_n27_ | ~new_n26_ | ~x12));
