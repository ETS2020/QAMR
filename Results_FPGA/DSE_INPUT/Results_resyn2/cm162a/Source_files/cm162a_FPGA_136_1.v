// Benchmark "FAU" written by ABC on Wed Jul 29 23:09:18 2020
...
module FAU ( 
  ...
  assign new_n27_ = x12 & ~x11 & ~x08 & ~x10;
  assign new_n28_ = (x11 | x12) & (~x09 | ~x13);
  assign new_n29_ = x03 & ((x09 & x13) | (~x08 & ~x10));
  assign new_n30_ = (~x02 | ~x04 | x08 | x10) & x03 & x11;
  assign new_n31_ = x05 & (x03 | x06);
  assign z3 = (new_n26_ & ~new_n28_ & new_n29_) | new_n33_ | ~new_n34_;
