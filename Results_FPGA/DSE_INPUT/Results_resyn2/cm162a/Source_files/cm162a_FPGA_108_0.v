// Benchmark "FAU" written by ABC on Wed Jul 29 23:09:05 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n26_, new_n27_, new_n29_, new_n31_;
  ...
  assign new_n26_ = (x11 | x08 | x10) & (~x13 | ~x04 | ~x09);
  assign new_n27_ = x04 & (~x11 | (x02 & ~x08 & ~x10));
  assign z3 = ~new_n31_ | ((x12 | (x02 & (new_n29_ | z4))) & x03 & (z4 | ~new_n29_ | ~x02 | ~x12));
