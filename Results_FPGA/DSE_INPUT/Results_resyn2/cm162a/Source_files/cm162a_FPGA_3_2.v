// Benchmark "FAU" written by ABC on Wed Jul 29 23:08:16 2020
...
module FAU ( 
  ...
  assign new_n24_ = (x10 | x08 | ~x02 | ~x04) & (~x02 | ~x13 | ~x04 | ~x09) & (~x10 | (~x08 & x02 & x04));
  assign z2 = (x03 & (new_n26_ | ~new_n27_)) | ~x05 | (~x03 & ~x06);
  assign new_n26_ = x02 & x04 & ((x09 & x13) | (~x10 & ~x11));
  assign new_n27_ = ~x08 & (~x11 | (~x10 & x02 & x04));
  assign z3 = ~new_n31_ | ((new_n26_ | x12) & x03 & (~new_n29_ | ~new_n30_ | ~x12));
