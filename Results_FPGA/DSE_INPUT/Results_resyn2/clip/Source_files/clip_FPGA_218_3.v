// Benchmark "FAU" written by ABC on Thu Jul 30 00:48:54 2020
...
module FAU ( 
  ...
  assign z1 = new_n17_ | ((x1 & (~x2 ^ ~x6)) ^ (~x4 ^ ~x7));
  assign z2 = new_n17_ | new_n21_;
  assign new_n21_ = ((x6 & ((~x4 & x7) | ((~x1 | x2) & (~x4 | x7)))) | ~new_n22_ | (~x6 & ((~x4 & ~x7) | ((~x1 | ~x2) & (~x4 | ~x7))))) & ((x1 & ((x2 & (x4 | x7) & (~x6 | ~x7)) | ((x6 | x7) & ~x2 & (x4 | ~x7)))) | new_n22_ | ((~x6 | ~x7) & x4 & (x6 | x7)));
  ...
  assign new_n28_ = ((~new_n29_ & (~x3 | x8)) | x0 | ~x6 | (~x3 & x8)) & (~new_n30_ | x0 | (x6 & x8));
  ...
  assign z4 = new_n34_ | ((~new_n30_ | ~x0) & x5);
  assign new_n34_ = (new_n29_ | (x3 & ~x8)) & ~x0 & x6 & (x3 | ~x8);
endmodule
