...
module FAU ( 
  ...
  assign new_n61_ = (~x16 | ~x17 | ~x18 | ~x14 | x19) & ((~x16 & (~x11 | ~x17 | ~x18)) | ~x19 | (x16 & x17 & x18));
  assign new_n62_ = (x17 | (x12 & x18)) & x15 & (x13 | x18);
  assign new_n63_ = x15 & (new_n65_ | (~new_n64_ & x16));
  ...
  assign new_n67_ = ~x33 & (~new_n68_ | ~x15 | (~new_n65_ & (new_n64_ | ~x16)));
  assign new_n68_ = ~x30 & ~x31;
  assign new_n69_ = ~new_n59_ & ~new_n70_;
  assign new_n70_ = ~x31 & x33;
  assign new_n71_ = new_n59_ & (new_n70_ | (new_n72_ & (new_n65_ | (~new_n64_ & x16))));
  assign new_n72_ = x15 & x30 & x31 & ~x33;
