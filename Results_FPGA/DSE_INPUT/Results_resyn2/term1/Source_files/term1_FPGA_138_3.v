...
module FAU ( 
  ...
  assign new_n58_ = new_n59_ & ((x30 & x32) | (new_n60_ & x19 & ~x32 & ~x30 & x31));
  assign new_n59_ = x29 & (x27 | x28);
  assign new_n60_ = x13 & x15 & x16 & x17;
  assign new_n61_ = ~new_n59_ & ((~x30 & x32) | (new_n60_ & x19 & ~x32 & x30 & x31));
  assign new_n62_ = new_n63_ & x31 & x17 & x19;
  assign new_n63_ = x16 & x13 & x15;
  assign z9 = x00 & ~x26 & (~new_n66_ | (~new_n65_ & x33));
  assign new_n65_ = (~new_n59_ | (x30 & x31)) & new_n63_ & x17 & x19 & (~x30 | x31);
  assign new_n66_ = (new_n59_ | ((~x31 | ~x33) & (~new_n60_ | ~x19 | x33 | x30 | x31))) & (~new_n60_ | ~new_n59_ | ~x19 | x33 | ~x30 | ~x31);
  assign z0 = ~x32;
endmodule
