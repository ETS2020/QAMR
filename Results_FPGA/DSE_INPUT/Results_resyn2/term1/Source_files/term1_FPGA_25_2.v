// Benchmark "FAU" written by ABC on Wed Jul 29 23:25:50 2020
...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & ((x32 & (~new_n58_ | ~new_n60_)) | (new_n63_ & new_n58_ & ~x32));
  assign new_n58_ = x31 & (~new_n59_ ^ ~x30);
  assign new_n59_ = x29 & (x27 | x28);
  assign new_n60_ = ~new_n61_ & new_n62_;
  assign new_n61_ = (~x15 | ~x16 | ~x18 | ~x14 | x19) & ((~x15 & (~x10 | ~x16 | ~x18)) | ~x19 | (x15 & x16 & x18));
  assign new_n62_ = (x16 | (x11 & x18)) & x17 & (x13 | x18);
  assign new_n63_ = x17 & (new_n65_ | (~new_n64_ & x15));
  assign new_n64_ = (~x16 | ((~x18 | ~x14 | x19) & (~x19 | ~x13 | x18))) & (~x11 | ~x18 | x16 | ~x19);
  assign new_n65_ = ~x15 & x19 & x10 & x16 & x18;
  assign z9 = x00 & ~x26 & ((~new_n67_ & new_n69_) | new_n71_ | new_n73_);
  assign new_n67_ = ~x33 & (~new_n68_ | ~x17 | (~new_n65_ & (new_n64_ | ~x15)));
  assign new_n68_ = ~x30 & ~x31;
  assign new_n69_ = ~new_n59_ & ~new_n70_;
  assign new_n70_ = ~x31 & x33;
  assign new_n71_ = new_n59_ & (new_n70_ | (new_n72_ & (new_n65_ | (~new_n64_ & x15))));
  assign new_n72_ = x17 & x30 & x31 & ~x33;
  assign new_n73_ = x33 & (new_n61_ | ~new_n62_ | (x30 ^ x31));
  assign z0 = ~x32;
endmodule
