...
module FAU ( 
  ...
  assign z8 = new_n67_ & ((~new_n58_ & x32) | (new_n65_ & ~new_n64_ & x31 & ~x32));
  ...
  assign new_n65_ = ~new_n63_ & (~x15 | (~new_n62_ & (new_n66_ | ~x16)));
  assign new_n66_ = x17 ? (x18 ? (x14 & ~x19) : (x13 & x19)) : (x19 & x12 & x18);
  assign new_n67_ = x00 & ~x26;
  assign z9 = new_n67_ & (new_n69_ | (new_n75_ & (~x30 | (new_n65_ & new_n76_))));
  assign new_n69_ = x33 & (new_n70_ | new_n71_ | ~new_n72_ | new_n73_ | ~new_n74_);
  assign new_n70_ = (~x10 | ~x16 | ~x17 | ~x18) & (~x15 | (~x16 & (~x11 | ~x17 | ~x18)));
  assign new_n71_ = ~x17 & (~x12 | ~x18);
  assign new_n72_ = (x13 | x18) & (~x30 | x31) & (x14 | x19);
  assign new_n73_ = x31 & (~x29 | (~x27 & ~x28));
