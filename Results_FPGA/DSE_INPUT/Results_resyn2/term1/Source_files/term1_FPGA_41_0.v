...
module FAU ( 
  ...
  assign new_n59_ = ~x15 & (~x16 | ~x18 | ~x10 | ~x19);
  assign new_n60_ = x16 ? (x18 ? (x14 & ~x19) : (x13 & x19)) : (x19 & x11 & x18);
  assign new_n61_ = new_n65_ & (~new_n63_ | ~x31 | (~new_n62_ & ~x30) | ~new_n64_ | (new_n62_ & x30));
  assign new_n62_ = x29 & (x27 | x28);
  assign new_n63_ = (x15 | (x16 & x18 & x10 & x19)) & (x16 | (x19 & x11 & x18)) & (~x19 | ~x15 | ~x16 | ~x18);
  ...
  assign new_n72_ = (~x30 ^ x31) & (x19 | (x16 & x18));
  assign new_n73_ = x15 & x16 & x18 & (~x14 | x19);
  assign new_n74_ = (~x11 | ~x18) & (~x16 | (~x13 & ~x18));
  assign z0 = ~x32;
endmodule
