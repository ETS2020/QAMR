...
module FAU ( 
  ...
  wire new_n48_, new_n50_, new_n51_, new_n52_, new_n53_, new_n58_, new_n59_,
  ...
  assign new_n50_ = ~new_n51_ & new_n52_ & (x16 | x21) & (x15 | x20);
  assign new_n51_ = ~x17 & ~x22;
  assign new_n52_ = (x19 | x24) & (x18 | x23);
  ...
  assign z7 = new_n59_ | ~new_n53_ | (new_n58_ & (~new_n51_ | ~x21));
  assign new_n58_ = new_n52_ & (x16 | x21) & (x15 | x20);
