...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & (~new_n58_ | ~new_n61_);
  assign new_n58_ = new_n60_ & (~new_n59_ | ~x15 | ~x16) & (x15 | (new_n59_ & x10 & x16)) & (x16 | (new_n59_ & x11));
  assign new_n59_ = x17 & x18 & x19;
  assign new_n60_ = (x17 | (x12 & x18 & x19)) & (x14 | x19) & (x18 | (x13 & x19));
  assign new_n61_ = x31 & (~x30 ^ (~x29 | (~x27 & ~x28)));
  assign z9 = x00 & ~x26 & ((~new_n63_ & new_n65_ & ~x33) | (x33 & (~new_n58_ | ~new_n65_)));
  assign new_n63_ = ((~new_n64_ & x16) | ~x15 | (~x16 & (~new_n59_ | ~x11))) & (x15 | ~new_n59_ | ~x10 | ~x16);
  assign new_n64_ = x17 ? ((x18 | (x13 & x19)) & (x14 | x19) & (~x18 | ~x19)) : (x12 & x18 & x19);
  assign new_n65_ = (x31 | ~x29 | (~x27 & ~x28)) & (~x30 | (x29 & (x27 | x28))) & (x30 | ~x31);
  assign z0 = ~x32;
endmodule
