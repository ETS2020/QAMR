// Benchmark "FAU" written by ABC on Wed Jul 29 23:26:51 2020
...
module FAU ( 
  ...
  assign new_n59_ = ~x15 & (~x16 | ~x17 | ~x10 | ~x19);
  assign new_n60_ = x16 ? (x17 ? (x14 & ~x19) : (x12 & x19)) : (x19 & x11 & x17);
  assign new_n61_ = new_n65_ & (~new_n63_ | ~x31 | (~new_n62_ & ~x30) | ~new_n64_ | (new_n62_ & x30));
  assign new_n62_ = x29 & (x27 | x28);
  assign new_n63_ = (x15 | (x16 & x17 & x10 & x19)) & (x16 | (x19 & x11 & x17)) & (~x19 | ~x15 | ~x16 | ~x17);
  assign new_n64_ = (x17 | (x12 & x19)) & x32 & (x14 | x19);
  ...
  assign new_n72_ = (~x30 ^ x31) & (x19 | (x16 & x17));
  assign new_n73_ = x15 & x16 & x17 & (~x14 | x19);
