// Benchmark "FAU" written by ABC on Wed Jul 29 23:26:04 2020
...
module FAU ( 
  ...
  assign z8 = (x32 | (~new_n58_ & new_n64_)) & x00 & ~x26 & (~new_n61_ | ~new_n64_ | ~x32);
  assign new_n58_ = (~x15 | ((new_n59_ | ~x16) & (~new_n60_ | ~x11 | x16))) & (~new_n60_ | ~x16 | ~x10 | x15);
  assign new_n59_ = (~x17 | ((~x18 | ~x14 | x19) & (~x19 | ~x13 | x18))) & (~x12 | ~x18 | ~x19);
  assign new_n60_ = x17 & x18 & x19;
  assign new_n61_ = ~new_n62_ & (x19 | (new_n63_ & x17)) & (new_n63_ | x17) & (~new_n63_ | x12 | (x14 & ~x19));
  assign new_n62_ = (~x10 | ~x16 | ~x18) & (~x15 | ((~x16 | (~x13 & ~x18)) & (~x11 | ~x18)));
  assign new_n63_ = x15 & x16 & x18;
  assign new_n64_ = (x30 | (x29 & (x27 | x28))) & x31 & (~x30 | ~x29 | (~x27 & ~x28));
  assign z9 = (x33 | (~new_n58_ & ~new_n66_)) & x00 & ~x26 & (~new_n61_ | new_n66_ | ~x33);
  assign new_n66_ = x31 ? (~x30 | ~x29 | (~x27 & ~x28)) : (x30 | (x29 & (x27 | x28)));
  assign z0 = ~x32;
endmodule
