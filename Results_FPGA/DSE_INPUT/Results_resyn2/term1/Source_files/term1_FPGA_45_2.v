...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & ((x32 & (~new_n58_ | ~new_n60_)) | (~new_n64_ & new_n58_ & ~x32));
  assign new_n58_ = (~new_n59_ | ~x30) & x31 & (new_n59_ | x30);
  assign new_n59_ = x29 & (x27 | x28);
  assign new_n60_ = ~new_n63_ & new_n61_ & new_n62_;
  assign new_n61_ = (x15 | (x17 & x18 & x10 & x16)) & (x16 | (x11 & x17 & x18));
  assign new_n62_ = (x15 & x16 & x17 & x18) ? (x14 & ~x19) : x19;
  assign new_n63_ = (~x12 | ~x18) & (~x17 | (~x13 & ~x18));
  assign new_n64_ = ~new_n67_ & (~x15 | (~new_n66_ & (new_n65_ | ~x16)));
  assign new_n65_ = (~x17 | ((~x18 | ~x14 | x19) & (~x19 | ~x13 | x18))) & (~x12 | ~x18 | x17 | ~x19);
  assign new_n66_ = ~x16 & x19 & x11 & x17 & x18;
  assign new_n67_ = x17 & x18 & x10 & x16 & ~x15 & x19;
  assign z9 = ~new_n69_ & x00;
  assign new_n69_ = (~new_n59_ | ((~new_n70_ | ~x30 | ~x31) & (~new_n72_ | x31))) & (new_n59_ | ((~new_n70_ | x30 | x31) & (~new_n72_ | ~x31))) & (new_n71_ | ~new_n72_);
  assign new_n70_ = ~x33 & (new_n67_ | (x15 & (new_n66_ | (~new_n65_ & x16))));
  assign new_n71_ = new_n61_ & new_n62_ & ~new_n63_ & (~x30 ^ x31);
  assign new_n72_ = ~x26 & x33;
  assign z0 = ~x32;
endmodule
