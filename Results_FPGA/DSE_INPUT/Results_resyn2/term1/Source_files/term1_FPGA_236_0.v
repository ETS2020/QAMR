...
module FAU ( 
  ...
  assign z3 = new_n50_ & (~x02 | ~x03) & ~x27 & x01 & ~x26;
  assign new_n50_ = (x25 | (~x17 & ~x22)) & (~new_n51_ | (~x17 & ~x22) | (~x18 & ~x23));
  assign new_n51_ = (x19 | x24) & (x16 | x21) & (x15 | x20);
  assign z4 = new_n53_ & new_n50_ & (~x02 | ~x03);
  assign new_n53_ = (x27 | x28) & x01 & ~x26 & (~x27 | ~x28);
  assign z5 = new_n50_ & (x29 | (x27 & x28)) & new_n55_ & (~x29 | ~x27 | ~x28);
  assign new_n55_ = (~x02 | ~x03) & x01 & ~x26;
  assign z6 = new_n50_ & (~x30 | ~x29 | ~x27 | ~x28) & new_n55_ & (x30 | (x29 & x27 & x28));
  assign z7 = new_n59_ | new_n58_ | ~new_n55_ | ~x25;
