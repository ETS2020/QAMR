...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n49_ | (new_n52_ & (new_n53_ | new_n54_));
  ...
  assign new_n58_ = x20 & x11 & x14 & x01 & x03 & x06;
  assign z3 = (~new_n60_ & ~new_n52_ & x24) | (~new_n64_ & ~x24) | (~new_n63_ & new_n52_);
  assign new_n60_ = (~new_n61_ | ~x18) & (~x07 | ~new_n42_ | x01 | x03);
  assign new_n61_ = new_n62_ & x20 & x11 & x14;
  assign new_n62_ = x08 & x01 & x03 & x06;
  assign new_n63_ = (~new_n61_ | ~x15) & (~x19 | ~new_n42_ | x01 | x03);
  assign new_n64_ = (~new_n61_ | new_n46_) & (new_n44_ | ~new_n42_ | x01 | x03);
  assign z4 = new_n66_ | ~new_n70_ | (~new_n74_ & ((~x05 & ~x13) | (~x24 & x05 & x13)));
  assign new_n66_ = x16 & ((x22 & (new_n67_ | ~new_n68_)) | (z7 & ~x09));
  assign new_n67_ = ~x24 & ((~new_n46_ & ~x17) | (new_n57_ & ~x04 & x23));
  assign new_n68_ = ~new_n69_ & (x04 | ~x23 | ~x08 | ~x18 | ~x24);
  assign new_n69_ = ~x17 & ((~x05 & ~x13) ? x15 : (x18 & x24));
  assign new_n70_ = (new_n72_ | x08) & (new_n71_ | (~new_n73_ & ~x08));
  assign new_n71_ = (~new_n37_ | x24) & (~x07 | new_n52_ | ~x24);
  assign new_n72_ = (~new_n57_ | x24) & (new_n52_ | ~x18 | ~x24);
  assign new_n73_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n74_ = (x08 | ~x15) & (~x19 | (~new_n73_ & ~x08));
