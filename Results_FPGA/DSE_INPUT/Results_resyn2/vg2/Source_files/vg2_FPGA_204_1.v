...
module FAU ( 
  ...
  assign new_n38_ = ~x06 & ~x01 & ~x03 & ~x14 & ~x20;
  assign z1 = (~new_n40_ & ~x24) | (~new_n49_ & x24 & (x05 | x13)) | (~new_n53_ & ~x05 & ~x13);
  ...
  assign new_n46_ = ~x06 & ~x01 & ~x03 & ~x04 & ~x12;
  assign new_n47_ = ~x14 & ~x20 & ~x22 & ~x23;
  assign new_n48_ = ~x08 & ~x09 & ~x16 & ~x17;
  assign new_n49_ = ~new_n50_ & (~new_n52_ | ~new_n47_ | ~x07 | x06 | x12);
  assign new_n50_ = new_n51_ & new_n42_ & x22 & x23 & x14 & x16;
  assign new_n51_ = x09 & x11 & x12 & x18 & x17 & x20;
  assign new_n52_ = new_n48_ & ~x04 & ~x01 & ~x03;
  assign new_n53_ = ~new_n54_ & (~new_n52_ | ~new_n47_ | ~x19 | x06 | x12);
  assign new_n54_ = new_n55_ & new_n42_ & x22 & x23 & x14 & x16;
  assign new_n55_ = x15 & x17 & x20 & x09 & x11 & x12;
  ...
  assign z3 = (~new_n60_ & ~x24) | (~new_n62_ & x24 & (x05 | x13)) | (~new_n63_ & ~x05 & ~x13);
  assign new_n60_ = (new_n44_ | ~new_n61_) & (new_n45_ | ~new_n38_ | x08);
  assign new_n61_ = x01 & x03 & x08 & x20 & x11 & x14;
  assign new_n62_ = (~new_n61_ | ~x18) & (~new_n38_ | ~x07 | x08);
  assign new_n63_ = (~new_n61_ | ~x15) & (~new_n38_ | x08 | ~x19);
  assign z4 = (z5 & (x08 | (~new_n65_ & ~x16))) | (z7 & (~x08 | (~new_n66_ & x16)));
  assign new_n65_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n66_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n68_ | (z7 & (~x03 | (~x20 & x11 & x14)));
  assign new_n68_ = z5 & (x03 | (~x11 & (x06 | (~x14 & x20))));
endmodule
