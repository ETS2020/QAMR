...
module FAU ( 
  ...
  assign z6 = new_n75_ | (~new_n76_ & ~x03) | (z5 & (new_n78_ | x03));
  assign new_n75_ = z7 & x11 & (~x06 | (x14 & ~x20));
  assign new_n76_ = (~x05 | ((~x18 | ~x24) & (~x15 | ~x13 | x24))) & ~new_n77_ & (~x13 | ~x18 | ~x24) & (~x15 | x05 | x13);
  assign new_n77_ = ~x02 & x21 & ~x24;
