...
module FAU ( 
  ...
  assign z5 = (x05 & (x24 ? x07 : (x13 & x19))) | (x13 & x07 & x24) | (new_n37_ & ~x24) | (x19 & ~x05 & ~x13);
  assign new_n37_ = x00 & ~x02 & ~x10;
  assign new_n38_ = ~x01 & ~x03 & ~x06 & ~x11 & ~x14 & ~x20;
  assign z1 = new_n40_ | new_n49_ | ((new_n52_ | new_n53_) & ~x05 & ~x13);
  ...
  assign new_n51_ = x14 & x22 & x23 & x17 & x20;
  assign new_n52_ = new_n48_ & x11 & new_n51_ & x15 & x12 & x16;
  assign new_n53_ = new_n42_ & x19 & new_n43_ & ~x23 & ~x17 & ~x22;
  ...
  assign new_n59_ = (~new_n60_ | ~x18) & (~x07 | ~new_n42_ | x01 | x03);
  assign new_n60_ = new_n61_ & x20 & x11 & x14;
  assign new_n61_ = x08 & x01 & x03 & x06;
  assign new_n62_ = (~new_n60_ | ~x15) & (~x19 | ~new_n42_ | x01 | x03);
  assign new_n63_ = (~new_n60_ | new_n46_) & (new_n44_ | ~new_n42_ | x01 | x03);
  assign z4 = (~new_n65_ & x24) | ~new_n68_ | (~new_n75_ & ~x24 & ~x02 & ~x10);
  assign new_n65_ = ~new_n66_ & (~x18 | x09 | ~x16);
  assign new_n66_ = (x05 | x13) & ((x07 & x08) | (~new_n67_ & x18));
  assign new_n67_ = x08 & (~x16 | ~x22 | (x17 & (x04 | ~x23)));
  assign new_n68_ = ~new_n70_ & (x16 | (~new_n72_ & new_n74_ & (new_n69_ | ~x09)));
  assign new_n69_ = (~x13 | ~x07 | ~x24) & (~new_n37_ | x24);
  assign new_n70_ = ((~x05 & ~x13) | (~x24 & x05 & x13)) & (~new_n71_ | (~new_n67_ & x15));
  assign new_n71_ = (~x08 | ~x19) & (x09 | ~x16);
  assign new_n72_ = new_n73_ & ((new_n37_ & ~x24) | (x07 & x24 & ~x08 & x15));
  assign new_n73_ = ~x22 & (x17 | (x04 & ~x23));
  assign new_n74_ = (~x19 | x05 | x13) & (~x05 | ((x24 | ~x13 | ~x19) & (~x09 | ~x07 | ~x24)));
  assign new_n75_ = (~x00 | ~x08) & (~x21 | (~new_n76_ & x08));
