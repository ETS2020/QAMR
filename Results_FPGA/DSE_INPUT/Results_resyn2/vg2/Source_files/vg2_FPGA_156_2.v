...
module FAU ( 
  ...
  assign z1 = (~x24 & (new_n40_ | new_n45_)) | (~new_n50_ & ~new_n56_ & x24) | (~new_n53_ & new_n56_);
  assign new_n40_ = new_n41_ & new_n42_ & ~new_n43_ & new_n44_;
  assign new_n41_ = x14 & x16 & x22 & x23;
  assign new_n42_ = x01 & x03 & x04 & x08;
  assign new_n43_ = (~x21 | x02 | x10) & (~x15 | ~x05 | ~x13);
  assign new_n44_ = x17 & x20 & x09 & x11 & x12;
  assign new_n45_ = ~new_n47_ & new_n48_ & new_n49_ & new_n46_ & ~x08 & ~x09;
  assign new_n46_ = ~x01 & ~x03 & ~x06 & ~x11;
  assign new_n47_ = (~x00 | x02 | x10) & (~x19 | ~x05 | ~x13);
  assign new_n48_ = ~x16 & ~x17 & ~x22 & ~x23;
  assign new_n49_ = ~x12 & ~x14 & ~x20;
  assign new_n50_ = (~new_n51_ | ~new_n41_ | ~new_n42_) & (~new_n52_ | ~new_n46_ | ~new_n48_);
  assign new_n51_ = x09 & x11 & x12 & x18 & x17 & x20;
  assign new_n52_ = x07 & ~x08 & ~x09 & ~x12 & ~x14 & ~x20;
  assign new_n53_ = (~new_n54_ | ~new_n41_ | ~new_n42_) & (~new_n55_ | ~new_n46_ | ~new_n48_);
  assign new_n54_ = x09 & x11 & x12 & x15 & x17 & x20;
  assign new_n55_ = ~x08 & x19 & ~x09 & ~x12 & ~x14 & ~x20;
  ...
  assign new_n60_ = x11 & x14 & x01 & x03 & x06 & x20;
  assign z3 = (~new_n62_ & ~x24) | (~new_n66_ & new_n56_) | (~new_n63_ & ~new_n56_ & x24);
  assign new_n62_ = (~new_n60_ | new_n43_ | ~x08) & (new_n47_ | ~new_n38_ | x08);
  assign new_n63_ = (~new_n64_ | ~new_n65_) & (~new_n38_ | ~x07 | x08);
  assign new_n64_ = x01 & x03 & x06 & x08;
  assign new_n65_ = x11 & x14 & x18 & x20;
  assign new_n66_ = (~new_n64_ | ~new_n67_) & (~new_n38_ | x08 | ~x19);
