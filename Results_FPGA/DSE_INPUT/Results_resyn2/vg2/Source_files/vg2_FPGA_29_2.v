...
module FAU ( 
  ...
  assign new_n40_ = (~new_n41_ | ~new_n43_) & (~new_n45_ | new_n47_ | ~new_n48_ | ~new_n49_);
  assign new_n41_ = new_n42_ & x12 & x16 & x22 & x23;
  assign new_n42_ = x01 & x03 & x04 & x06;
  assign new_n43_ = ~new_n44_ & x09 & x17 & x20 & x08 & x11;
  ...
  assign new_n49_ = ~x09 & ~x20;
  assign new_n50_ = (~new_n41_ | ~new_n51_) & (~new_n45_ | ~new_n48_ | ~new_n49_ | ~x07);
  assign new_n51_ = x18 & x20 & x09 & x17 & x08 & x11;
  assign new_n52_ = (~new_n41_ | ~new_n53_) & (~new_n45_ | ~new_n48_ | ~new_n49_ | ~x19);
  assign new_n53_ = x15 & x20 & x08 & x11 & x09 & x17;
  assign z2 = z7 & new_n57_ & x20 & x11 & x14;
  assign z7 = (x05 & ((x18 & x24) | (x15 & x13 & ~x24))) | (new_n56_ & ~x24) | (x13 & x18 & x24) | (x15 & ~x05 & ~x13);
  assign new_n56_ = x21 & ~x02 & ~x10;
  assign new_n57_ = x01 & x03 & x06;
  assign z3 = (~new_n59_ & x24 & (x05 | x13)) | (~new_n61_ & ~x05 & ~x13) | (~new_n62_ & ~x24);
  assign new_n59_ = (~new_n38_ | ~x07) & (~new_n60_ | ~x18 | ~x20);
  assign new_n60_ = new_n57_ & x08 & x11;
  assign new_n61_ = (~new_n38_ | ~x19) & (~new_n60_ | ~x15 | ~x20);
  assign new_n62_ = (new_n47_ | ~new_n38_) & (~new_n63_ | new_n44_);
  assign new_n63_ = new_n57_ & x20 & x08 & x11;
