...
module FAU ( 
  ...
  assign z1 = (~new_n41_ & ~new_n61_ & x24) | (~new_n50_ & ~x24) | new_n59_ | (~new_n54_ & new_n61_);
  assign new_n41_ = (~new_n42_ | ~new_n44_) & (~new_n46_ | ~new_n49_ | ~x07);
  assign new_n42_ = new_n43_ & x12 & x14 & x16;
  assign new_n43_ = x17 & x20 & x22 & x23;
  assign new_n44_ = new_n45_ & x06 & x08 & x09 & x11;
  ...
  assign new_n50_ = (~new_n42_ | ~new_n51_ | ~new_n45_) & (~new_n46_ | new_n53_ | ~new_n49_);
  assign new_n51_ = new_n52_ & x06 & x08 & x21 & x09 & x11;
  assign new_n52_ = ~x02 & ~x10;
  assign new_n53_ = ~new_n37_ & (~x05 | ~x13 | ~x19);
  assign new_n54_ = (~new_n44_ | ~new_n56_) & (~new_n55_ | ~new_n57_);
  assign new_n55_ = new_n47_ & ~x23 & ~x17 & ~x22;
  ...
  assign new_n65_ = new_n52_ & x21;
  assign z3 = (~new_n67_ & ~x24) | ~new_n69_ | (~new_n68_ & ~new_n61_ & x24);
  ...
  assign new_n69_ = (~new_n71_ | ~new_n58_) & (~new_n70_ | ~x15 | (x05 ^ x13));
  assign new_n70_ = new_n64_ & x06 & x08 & x20;
  assign new_n71_ = new_n39_ & new_n61_ & ~x11 & ~x14;
  ...
  assign z6 = new_n80_ | ~new_n77_ | (~new_n81_ & ((~x05 & ~x13) | (~x24 & x05 & x13)));
  assign new_n77_ = ~new_n78_ & (~z5 | x11 | (~x06 & (x14 | ~x20)));
  assign new_n78_ = (~new_n79_ | x07) & ~new_n61_ & x18 & x24;
  assign new_n79_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n80_ = new_n52_ & ~x24 & ((x00 & x03) | (~new_n79_ & x21));
  assign new_n81_ = (~x03 | ~x19) & (new_n79_ | ~x15);
endmodule
