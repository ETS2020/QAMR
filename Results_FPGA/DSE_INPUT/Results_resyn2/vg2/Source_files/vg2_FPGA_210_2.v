...
module FAU ( 
  ...
  assign new_n50_ = new_n48_ & x11 & new_n51_ & x15 & x12 & x16;
  assign new_n51_ = x14 & x17 & x20 & x22 & x23;
  assign new_n52_ = new_n48_ & x11 & new_n51_ & x18 & x12 & x16;
  ...
  assign z4 = new_n65_ | (~new_n67_ & (new_n66_ | ~x08)) | (~new_n68_ & (new_n69_ | x08));
  assign new_n65_ = new_n53_ & (x07 | (x18 & (new_n66_ | ~x08)));
  assign new_n66_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n67_ = (~new_n56_ | x24) & (~x15 | ((x05 | x13) & (x24 | ~x05 | ~x13)));
  assign new_n68_ = (~new_n37_ | x24) & (~x19 | ((x05 | x13) & (x24 | ~x05 | ~x13)));
  assign new_n69_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = (new_n53_ & (x07 | (~new_n72_ & x18))) | new_n71_ | (~new_n67_ & ~new_n72_);
  assign new_n71_ = ~new_n68_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
