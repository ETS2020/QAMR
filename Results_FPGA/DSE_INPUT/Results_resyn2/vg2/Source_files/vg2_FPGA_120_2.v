...
module FAU ( 
  ...
  assign z7 = (x05 & ((x18 & x24) | (x15 & x13 & ~x24))) | (x13 & x18 & x24) | new_n56_ | (x15 & ~x05 & ~x13);
  ...
  assign z4 = (~new_n68_ & x24 & (x05 | x13)) | ~new_n65_ | (~new_n69_ & ((~x05 & ~x13) | (~x24 & x05 & x13)));
  assign new_n65_ = (~z5 | ~new_n67_) & (~new_n56_ | (~x00 & ~new_n66_ & x08));
  assign new_n66_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n67_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n68_ = (~x07 | ~x08) & (~x18 | (~new_n66_ & x08));
  assign new_n69_ = (~x08 | ~x19) & (~x15 | (~new_n66_ & x08));
