...
module FAU ( 
  ...
  assign z1 = new_n40_ | new_n49_ | (new_n52_ & (new_n53_ | (new_n41_ & x19)));
  assign new_n40_ = ~x24 & ((new_n41_ & ~new_n44_) | (new_n45_ & new_n48_));
  ...
  assign z3 = (~new_n59_ & ~new_n52_ & x24) | (~new_n62_ & new_n52_) | (~new_n63_ & ~x24);
  ...
  assign new_n63_ = (~new_n60_ | new_n46_) & (new_n44_ | ~new_n38_ | x08);
  assign z4 = (z5 & (x08 | (~new_n65_ & ~x16))) | (z7 & (~x08 | (~new_n66_ & x16)));
  assign new_n65_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n66_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n68_ | new_n71_ | new_n77_ | (~new_n73_ & ~x11);
  assign new_n68_ = x24 & ((~new_n69_ & x18) | (~new_n52_ & x03 & x07));
  assign new_n69_ = (x06 | ~x11) & (new_n52_ | (x03 & (~new_n70_ | ~x11)));
  assign new_n70_ = x14 & ~x20;
  assign new_n71_ = (new_n72_ | (x00 & x03)) & ~x24 & ~x02 & ~x10;
  assign new_n72_ = x21 & (~x03 | (x11 & (new_n70_ | ~x06)));
  assign new_n73_ = new_n74_ & (new_n76_ | new_n44_ | x24);
  assign new_n74_ = (~new_n52_ | ~x19) & (~x07 | ~x24 | (~new_n75_ & (new_n52_ | ~x06)));
  assign new_n75_ = ~x14 & x20 & ~x03 & x15;
  assign new_n76_ = (~x19 | ~x05 | ~x13) & ~x06 & (x14 | ~x20);
  assign new_n77_ = ~new_n78_ & ((~x05 & ~x13) | (~x24 & x05 & x13));
  assign new_n78_ = (~x11 | (x06 & (~new_n70_ | ~x15))) & (x03 | ~x15) & (~x03 | ~x19);
endmodule
