// Benchmark "FAU" written by ABC on Wed Jul 29 20:32:27 2020
...
module FAU ( 
  ...
  assign new_n40_ = (new_n41_ | ~new_n42_) & (new_n45_ | ~new_n47_ | ~new_n49_ | ~new_n50_);
  assign new_n41_ = ~new_n37_ & (~x19 | ~x05 | ~x13);
  assign new_n42_ = new_n43_ & new_n44_ & ~x11 & ~x12 & ~x20 & ~x22;
  assign new_n43_ = ~x09 & ~x14 & ~x04 & ~x16 & ~x17;
  assign new_n44_ = ~x01 & ~x03 & ~x06 & ~x08;
  assign new_n45_ = ~new_n46_ & (~x15 | ~x05 | ~x13);
  assign new_n46_ = x21 & ~x02 & ~x10;
  assign new_n47_ = new_n48_ & x12 & x16 & x22 & x23;
  assign new_n48_ = x01 & x03 & x06 & x08;
  assign new_n49_ = x11 & x04 & x09;
  assign new_n50_ = x17 & x20;
  assign new_n51_ = (~new_n52_ | ~new_n53_) & (~new_n47_ | ~new_n49_ | ~new_n50_ | ~x18);
  assign new_n52_ = ~x11 & ~x12 & ~x20 & ~x22 & new_n38_ & ~x04;
  assign new_n53_ = ~x14 & x07 & ~x09 & new_n54_ & ~x06 & ~x08;
  assign new_n54_ = ~x16 & ~x17;
  assign new_n55_ = (~new_n52_ | ~new_n56_) & (~new_n47_ | ~new_n49_ | ~new_n50_ | ~x15);
  ...
  assign new_n61_ = ~x24 & ((~new_n45_ & new_n62_) | (~new_n41_ & new_n63_));
  assign new_n62_ = new_n48_ & x20 & x11 & x14;
  assign new_n63_ = new_n44_ & ~x20 & ~x11 & ~x14;
