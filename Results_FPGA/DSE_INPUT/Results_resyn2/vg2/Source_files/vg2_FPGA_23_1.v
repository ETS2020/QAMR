// Benchmark "FAU" written by ABC on Wed Jul 29 20:32:00 2020
...
module FAU ( 
  ...
  assign z0 = z5 & ~x20 & ~x01 & ~x03 & ~x11 & ~x14;
  ...
  assign new_n41_ = x01 & x06 & x04 & x08;
  ...
  assign new_n46_ = ~x20 & ~x01 & ~x03 & ~x04 & ~x16 & ~x17;
  ...
  assign new_n53_ = ~x20 & ~x01 & ~x03 & ~x08 & ~x11 & ~x14;
  assign new_n54_ = ~x16 & ~x17 & ~x04 & x19;
  assign new_n55_ = ~x05 & ~x13;
  assign z2 = z7 & x01 & x06 & x20 & x11 & x14;
  ...
  assign new_n61_ = x08 & x01 & x06 & x20 & x11 & x14;
  assign new_n62_ = (~new_n61_ | ~x18) & (~new_n49_ | x20 | x01 | x03);
  ...
  assign z6 = (z5 & (new_n68_ | x03)) | (z7 & (new_n69_ | ~x03));
