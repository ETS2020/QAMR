...
module FAU ( 
  ...
  assign new_n50_ = ((new_n47_ & new_n51_) | (new_n52_ & new_n53_)) & ~new_n54_ & x24;
  assign new_n51_ = new_n49_ & x18 & x17 & x20;
  assign new_n52_ = new_n44_ & ~x06 & ~x01 & ~x04;
  assign new_n53_ = new_n38_ & ~x12 & ~x08 & ~x09 & x07 & ~x11;
  assign new_n54_ = ~x05 & ~x13;
  assign new_n55_ = (~new_n52_ | ~new_n57_) & (~new_n47_ | ~new_n56_);
  assign new_n56_ = new_n49_ & x15 & x17 & x20;
  assign new_n57_ = new_n38_ & ~x08 & ~x09 & x19 & ~x11 & ~x12;
  ...
  assign new_n62_ = ~x24 & ((~new_n45_ & new_n63_) | (new_n64_ & ~new_n42_));
  assign new_n63_ = new_n48_ & x20 & x11 & x14;
  assign new_n64_ = new_n38_ & ~x08 & ~x01 & ~x03 & ~x06 & ~x11;
  assign new_n65_ = ~new_n54_ & x24 & ((new_n64_ & x07) | (new_n63_ & x18));
  assign new_n66_ = new_n54_ & ((new_n63_ & x15) | (new_n64_ & x19));
