...
module FAU ( 
  ...
  wire new_n37_, new_n38_, new_n41_, new_n42_, new_n43_, new_n44_, new_n46_,
  ...
  assign new_n43_ = x01 & x03 & x08 & x09 & x04 & x06;
  assign new_n44_ = x11 & x12 & x14 & x16;
  assign z2 = z7 & new_n46_ & (~x08 | x20);
  assign new_n46_ = x01 & x03 & x14 & x06 & x11;
  assign z3 = z7 & new_n46_ & x08 & x20;
