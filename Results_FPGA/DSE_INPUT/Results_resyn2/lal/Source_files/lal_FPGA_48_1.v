...
module FAU ( 
  ...
  assign z14 = new_n67_ | ~new_n62_ | (~new_n58_ & x21);
  assign new_n67_ = x19 & x17 & x18 & ~x20 & ~x21;
  assign z15 = (new_n67_ & ~x22) | ~new_n62_ | (~new_n67_ & x22);
  assign z16 = (x23 & (~new_n67_ | x22)) | ~new_n62_ | (new_n58_ & ~x21 & ~x22 & ~x23);
  assign z17 = x24 | ~new_n62_ | (new_n58_ & new_n59_);
  assign z18 = (~x25 & new_n58_ & new_n59_) | ~new_n62_ | (x25 & (~new_n56_ | ~new_n57_));
  assign z02 = x16;
endmodule
