...
module FAU ( 
  ...
  assign z07 = x06 & x08;
  assign z08 = x07 & x08;
  assign z09 = (x00 & x08) | (~new_n59_ & (~x08 | ~x22) & x09 & ~x10);
  ...
  assign new_n62_ = x12 & new_n60_ & x21 & x22;
  assign z11 = new_n64_ | z03;
  assign new_n64_ = (~x19 | ~x20 | ~x21 | (new_n47_ & x13)) & new_n48_ & ((x19 & x20) | x21);
  assign z12 = z04 | ((~new_n49_ | ~x22 | (new_n60_ & x14)) & new_n48_ & (new_n49_ | x22));
  ...
  assign new_n72_ = (x24 | (x22 & x23 & x21 & x19 & x20)) & (~x23 | ~x24 | ~x19 | ~x20 | ~x21 | ~x22);
