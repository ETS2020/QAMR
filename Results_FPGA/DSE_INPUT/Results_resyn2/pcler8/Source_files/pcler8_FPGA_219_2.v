...
module FAU ( 
  ...
  assign z12 = (x03 & x08) | ((~x22 | (~x08 & (new_n66_ | ~new_n67_))) & new_n68_ & (new_n67_ | x22));
  assign new_n66_ = new_n59_ & x14;
  assign new_n67_ = x21 & x19 & x20;
  assign new_n68_ = x09 & ~x10;
  assign z13 = (x04 & x08) | (new_n68_ & ((~x22 & x23) | (~new_n70_ & ~x08)));
  assign new_n70_ = (~x23 | (new_n67_ & ~new_n71_)) & (~new_n67_ | ~x22 | x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (new_n68_ & ((~x22 & x24) | (new_n73_ & (new_n47_ | x24))));
  assign new_n73_ = ~x08 & (~new_n74_ | ~new_n67_ | (x16 & x25 & x26));
  assign new_n74_ = x23 & x24;
  assign z15 = (x06 & x08) | (new_n68_ & ((~x22 & x25) | (~new_n76_ & ~x08)));
  assign new_n76_ = (~x25 | (new_n67_ & new_n77_)) & (~new_n47_ | ~x24 | x25);
  assign new_n77_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = (x07 & x08) | ((~x22 | (~new_n79_ & ~x08)) & ~new_n80_ & new_n68_);
  assign new_n79_ = new_n64_ & new_n74_ & x21 & x25 & ~x18 & x26;
  assign new_n80_ = ~x26 & (~new_n64_ | ~new_n74_ | ~x22 | ~x21 | ~x25);
endmodule
