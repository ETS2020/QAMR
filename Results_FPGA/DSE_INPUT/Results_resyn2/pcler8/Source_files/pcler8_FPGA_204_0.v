...
module FAU ( 
  ...
  assign z14 = z06 | ((new_n69_ | new_n70_) & x09 & ~x10);
  assign new_n69_ = x23 & ((~x22 & x24) | (new_n47_ & ~x08 & ~x24));
  assign new_n70_ = ~x08 & x24 & (new_n71_ | ~new_n65_ | ~x23);
  ...
  assign new_n76_ = (x26 | (x25 & new_n47_ & new_n74_)) & new_n48_ & (~new_n74_ | ~x25 | ~x26 | ~new_n47_ | x18);
endmodule
