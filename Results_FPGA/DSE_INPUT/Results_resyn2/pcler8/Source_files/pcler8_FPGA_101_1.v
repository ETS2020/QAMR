...
module FAU ( 
  ...
  assign z15 = z07 | ((~new_n71_ | ~x25 | x26) & new_n48_ & (new_n71_ | x25));
  assign new_n71_ = new_n47_ & x23 & x24;
  assign z16 = z08 | (~new_n73_ & new_n48_);
  assign new_n73_ = (~new_n47_ | ~x23 | ~x24 | ~x25 | x26) & (~x26 | (new_n47_ & x23 & x25 & ~x18 & x24));
endmodule
