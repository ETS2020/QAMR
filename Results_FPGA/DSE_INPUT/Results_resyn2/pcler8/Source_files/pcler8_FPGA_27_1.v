// Benchmark "FAU" written by ABC on Wed Jul 29 21:08:08 2020
...
module FAU ( 
  ...
  assign z11 = z03 | ((~new_n63_ | ~x21 | (new_n59_ & x22)) & new_n48_ & (new_n63_ | x21));
  assign new_n63_ = x19 & x20;
  assign z12 = new_n65_ | z04;
  assign new_n65_ = ((new_n59_ & x14) | ~x22 | ~new_n63_ | ~x21) & new_n48_ & (x22 | (new_n63_ & x21));
  assign z13 = z05 | (new_n48_ & (new_n47_ | x23) & (new_n67_ | ~new_n47_ | ~x23));
