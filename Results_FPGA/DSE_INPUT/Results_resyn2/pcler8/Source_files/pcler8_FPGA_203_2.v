...
module FAU ( 
  ...
  assign z12 = z04 | (new_n68_ & (new_n67_ | x22) & (new_n66_ | ~x22));
  assign new_n66_ = ~x10 & (~new_n67_ | (new_n59_ & x14));
  assign new_n67_ = x21 & x19 & x20;
  assign new_n68_ = ~x08 & x09;
  assign z13 = z05 | (~new_n70_ & new_n68_);
  assign new_n70_ = (x22 | ~x23) & (x10 | ((~x23 | (new_n67_ & ~new_n71_)) & (~new_n67_ | ~x22 | x23)));
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (new_n68_ & ((~x22 & x24) | (new_n73_ & (new_n47_ | x24))));
  assign new_n73_ = ~x10 & (new_n74_ | ~new_n67_ | ~x23 | ~x24);
  assign new_n74_ = x16 & x25 & x26;
  assign z15 = z07 | (new_n68_ & (new_n76_ | (~x22 & x25)));
  assign new_n76_ = ~x10 & ((x25 & (~new_n67_ | ~new_n77_)) | (new_n47_ & x24 & ~x25));
  assign new_n77_ = (~x17 | ~x26) & x23 & x24;
  assign z16 = z08 | ((new_n79_ | ~x22) & ~new_n81_ & new_n68_);
  assign new_n79_ = ~x10 & (~new_n80_ | ~x21 | ~x25 | x18 | ~x26);
  assign new_n80_ = x19 & x20 & x23 & x24;
  assign new_n81_ = ~x26 & (~new_n80_ | ~x22 | ~x21 | ~x25);
endmodule
