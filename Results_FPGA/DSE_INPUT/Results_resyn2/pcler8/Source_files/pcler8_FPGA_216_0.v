...
module FAU ( 
  ...
  assign z13 = z05 | (~new_n68_ & ~new_n69_ & new_n48_);
  assign new_n68_ = new_n47_ & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n69_ = ~x23 & (~new_n64_ | ~x21 | ~x22);
  assign z14 = z06 | (~new_n71_ & new_n48_);
  assign new_n71_ = (~x16 | ~x24 | ~x25 | ~x26) & (new_n72_ | (~new_n47_ & ~x24));
  assign new_n72_ = x23 & x24 & x19 & x20 & x21 & x22;
  assign z15 = z07 | ((~new_n72_ | ~x25 | (x17 & x26)) & new_n48_ & (new_n72_ | x25));
  assign z16 = z08 | (~new_n75_ & new_n48_);
  assign new_n75_ = (~x26 | (new_n76_ & new_n77_ & ~x18 & x25)) & x19 & (~new_n76_ | ~new_n77_ | ~x25 | x26);
  assign new_n76_ = x23 & x21 & x22;
  assign new_n77_ = x20 & x24;
endmodule
