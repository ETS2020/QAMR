...
module FAU ( 
  ...
  assign z13 = z05 | (new_n48_ & (new_n68_ | (new_n59_ & x15)));
  assign new_n68_ = (~x22 | ~x23 | ~x21 | ~x19 | ~x20) & (x23 | (x19 & x20 & x21 & x22));
  assign z14 = z06 | (~new_n70_ & x09 & ~x10);
  assign new_n70_ = ((~new_n72_ & new_n71_ & x23 & x24) | ~x22 | (~x24 & (~new_n71_ | ~x23))) & (~x24 | x08 | x22);
  assign new_n71_ = x21 & x19 & x20;
  assign new_n72_ = x16 & x25 & x26;
  assign z15 = z07 | (new_n48_ & ((x17 & x25 & x26) | (new_n74_ ^ x25)));
  assign new_n74_ = x23 & x24 & new_n64_ & x21 & x22;
  assign z16 = z08 | (~new_n76_ & new_n48_ & (x26 | (new_n74_ & x25)));
  assign new_n76_ = new_n47_ & ~x18 & x24 & x25 & x26;
endmodule
