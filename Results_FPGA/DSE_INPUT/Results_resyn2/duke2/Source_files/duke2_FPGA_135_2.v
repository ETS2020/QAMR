...
module FAU ( 
  ...
  assign z20 = ~x07 & ~x17 & ((~new_n165_ & ~x09) | (new_n170_ & new_n63_ & x09));
  assign new_n165_ = ~new_n169_ & (~x18 | (~new_n168_ & (x21 | (~new_n166_ & ~new_n137_))));
  assign new_n166_ = new_n63_ & ~x15 & ((~x05 & ~x06 & ~x08) | (x08 & (new_n167_ | x05)));
  assign new_n167_ = ~new_n152_ & x10 & ~x14;
  assign new_n168_ = new_n138_ & new_n55_ & x21 & (~x04 ^ ~x12);
  assign new_n169_ = new_n55_ & x04 & ~x05 & x12 & ~x18 & ~x21;
  assign new_n170_ = new_n80_ & x05 & ~x15;
  ...
  assign z27 = ~x09 & ((~new_n188_ & new_n86_) | (~new_n185_ & new_n87_));
  ...
  assign new_n188_ = x15 ? (~x00 | x07) : ~x07;
  ...
  assign new_n197_ = ~x18 & (~x02 | ~x11) & new_n82_ & ~x09 & x15;
