// Benchmark "FAU" written by ABC on Thu Jul 30 00:05:16 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n322_, new_n323_, new_n325_, new_n327_, new_n332_, new_n333_,
  ...
  assign z07 = ~x15 & x29 & ~x28 & x43;
  assign z08 = new_n173_ & new_n153_ & new_n159_ & new_n186_ & new_n187_;
  assign new_n186_ = new_n163_ & new_n150_ & ~x58 & new_n162_ & new_n164_;
  assign new_n187_ = new_n142_ & new_n171_ & new_n188_ & x38 & ~x39;
  assign new_n188_ = ~x41 & ~x42 & ~x40 & ~x43;
  assign z09 = new_n153_ & new_n176_ & new_n190_ & new_n194_ & new_n191_ & new_n196_;
  assign new_n190_ = new_n178_ & new_n179_;
  assign new_n191_ = new_n192_ & new_n193_ & new_n174_ & ~x32 & ~x34;
  ...
  assign new_n208_ = new_n209_ & ~x26 & new_n210_ & ~x37 & x41;
  assign new_n209_ = ~x30 & ~x28 & x29;
  assign new_n210_ = ~x39 & ~x40;
  assign z14 = new_n212_ & x50 & ~x43 & ~x58;
  assign new_n212_ = new_n213_ & ~x28 & x29 & ~x37;
  assign new_n213_ = ~x15 & ~x10 & ~x14;
  assign z15 = new_n215_ & ~x28 & x29 & ~x37;
  assign new_n215_ = ~x43 & ~x58 & new_n135_ & x10;
  assign z16 = new_n206_ & new_n217_ & new_n219_ & new_n209_ & x26;
  assign new_n217_ = new_n218_ & ~x62 & ~x58 & ~x60;
  assign new_n218_ = ~x46 & ~x47 & ~x50 & ~x56;
  assign new_n219_ = ~x37 & ~x39 & ~x40 & ~x43;
  assign z17 = new_n221_ & new_n217_ & new_n222_ & new_n170_ & x03 & ~x07;
  assign new_n221_ = new_n207_ & new_n219_;
  assign new_n222_ = ~x08 & ~x10 & ~x25 & ~x28;
  assign z18 = new_n224_ & new_n204_ & x62 & ~x07 & ~x08;
  assign new_n224_ = new_n225_ & new_n226_ & new_n192_ & ~x24 & ~x25;
  ...
  assign new_n228_ = new_n156_ & new_n154_ & new_n155_;
  ...
  assign z20 = new_n240_ & new_n200_ & x51;
  assign new_n240_ = new_n241_ & new_n242_ & new_n207_ & new_n136_ & new_n160_;
  assign new_n241_ = ~x06 & ~x07 & ~x08 & ~x10;
  assign new_n242_ = ~x00 & ~x03 & ~x30 & ~x28 & x29;
  assign z21 = new_n244_ & new_n246_ & new_n207_ & new_n136_ & new_n160_;
  assign new_n244_ = new_n245_ & new_n209_ & new_n218_ & ~x62 & ~x58 & ~x60;
  assign new_n245_ = ~x40 & ~x43 & ~x37 & ~x39 & ~x41;
  assign new_n246_ = new_n241_ & x00 & ~x03;
  assign z22 = new_n248_ & new_n249_ & new_n141_ & new_n250_ & new_n162_ & new_n164_;
  assign new_n248_ = new_n234_ & ~x12 & new_n156_ & new_n154_ & new_n155_;
  assign new_n249_ = new_n171_ & new_n188_ & new_n232_;
  assign new_n250_ = new_n174_ & new_n193_ & ~x34 & ~x37 & x36 & ~x39;
  assign z23 = new_n186_ & new_n253_ & new_n254_ & new_n256_ & new_n252_ & new_n135_;
  assign new_n252_ = ~x12 & new_n156_ & new_n154_ & new_n155_;
  assign new_n253_ = new_n142_ & new_n171_;
  assign new_n254_ = new_n174_ & new_n193_ & new_n255_ & ~x34 & ~x39;
  assign new_n255_ = ~x36 & ~x37;
  assign new_n256_ = new_n257_ & new_n188_ & new_n192_ & new_n160_;
  assign new_n257_ = ~x18 & ~x22 & x16 & ~x17 & ~x21 & ~x24;
  assign z24 = new_n259_ & x11 & new_n192_ & ~x24 & ~x25;
  assign new_n259_ = new_n213_ & new_n219_ & ~x46 & ~x60 & ~x50 & ~x58;
  assign z25 = new_n259_ & new_n192_ & x24 & ~x25;
  assign z26 = new_n176_ & new_n262_ & new_n190_ & new_n264_ & new_n263_ & new_n265_;
  assign new_n262_ = new_n157_ & ~x12 & new_n156_ & new_n154_ & new_n155_;
  assign new_n263_ = new_n193_ & new_n232_;
  assign new_n264_ = new_n255_ & new_n231_;
  assign new_n265_ = ~x20 & ~x21 & new_n174_ & x32 & ~x34;
  assign z27 = new_n161_ & new_n249_ & new_n252_ & new_n254_ & new_n267_;
  assign new_n267_ = new_n268_ & x13 & ~x20 & ~x21;
  assign new_n268_ = ~x15 & ~x17 & ~x18 & ~x14 & ~x16;
  assign z28 = x25 & new_n259_ & new_n192_;
  assign z29 = new_n271_ & ~x50 & ~x58 & ~x46 & x60;
  assign new_n271_ = new_n210_ & new_n213_ & ~x43 & ~x28 & x29 & ~x37;
  assign z30 = new_n248_ & new_n274_ & new_n264_ & new_n275_ & new_n273_ & ~x54;
  assign new_n273_ = new_n150_ & ~x58 & new_n162_ & new_n164_;
  assign new_n274_ = new_n137_ & ~x21 & ~x22;
  assign new_n275_ = new_n134_ & new_n178_ & ~x48 & ~x49 & x52 & ~x53;
  assign z31 = new_n248_ & new_n278_ & new_n235_ & new_n277_ & new_n279_ & new_n281_;
  assign new_n277_ = ~x58 & new_n162_ & new_n164_;
  assign new_n278_ = new_n230_ & new_n231_;
  assign new_n279_ = new_n280_ & new_n166_ & new_n170_;
  assign new_n280_ = ~x25 & ~x28 & ~x24 & ~x26;
  assign new_n281_ = new_n255_ & x21 & ~x22 & ~x34 & ~x35;
  assign z32 = new_n271_ & x46 & ~x50 & ~x58;
  assign z33 = x39 & ~x40 & new_n212_ & ~x50 & ~x43 & ~x58;
  assign z34 = new_n135_ & x58 & ~x43 & ~x28 & x29 & ~x37;
  assign z35 = new_n136_ & new_n137_ & new_n286_ & new_n288_ & new_n289_;
  assign new_n286_ = new_n287_ & new_n236_ & ~x61 & ~x62 & ~x58 & ~x60;
  assign new_n287_ = ~x46 & ~x47 & ~x00 & x04;
  assign new_n288_ = new_n245_ & ~x35;
  assign new_n289_ = new_n204_ & ~x03 & ~x08 & ~x06 & ~x07;
  assign z36 = new_n240_ & new_n288_ & new_n178_ & new_n202_ & ~x55 & x61;
  assign z37 = new_n186_ & new_n262_ & new_n274_ & new_n253_ & new_n292_;
  assign new_n292_ = new_n167_ & new_n293_ & new_n166_ & x19 & ~x20;
  assign new_n293_ = ~x32 & ~x34 & ~x40 & ~x43;
  assign z38 = new_n295_ & new_n299_ & new_n178_ & new_n150_ & ~x62;
  assign new_n295_ = new_n204_ & new_n296_ & new_n298_ & new_n280_ & new_n170_ & new_n297_;
  ...
  assign z39 = new_n295_ & new_n301_ & new_n230_ & x42 & ~x43;
  assign new_n301_ = new_n236_ & ~x61 & ~x62 & ~x58 & ~x60;
  assign z40 = new_n303_ & new_n305_ & new_n238_ & new_n150_ & x54;
  assign new_n303_ = new_n296_ & new_n304_ & new_n136_ & new_n137_;
  assign new_n304_ = ~x09 & ~x10 & ~x14 & ~x15 & ~x11 & ~x17;
  assign new_n305_ = new_n306_ & new_n233_ & new_n210_ & ~x43 & ~x46;
  assign new_n306_ = ~x41 & ~x42 & ~x51 & ~x47 & ~x50;
  assign z41 = new_n303_ & new_n308_ & ~x34 & ~x35 & x33 & ~x37;
  assign new_n308_ = new_n238_ & new_n196_ & new_n201_ & new_n150_ & ~x51;
  assign z42 = new_n310_ & new_n228_ & new_n229_;
  assign new_n310_ = new_n143_ & new_n146_ & ~x50 & ~x51 & x49 & ~x53;
  assign z43 = new_n229_ & new_n312_ & new_n149_ & new_n154_ & new_n155_;
  assign new_n312_ = new_n313_ & x01 & ~x02 & ~x00 & ~x03;
  assign new_n313_ = ~x50 & ~x51 & ~x53 & ~x54;
  assign z44 = new_n136_ & new_n137_ & new_n315_ & new_n317_ & new_n316_ & new_n318_;
  assign new_n315_ = new_n134_ & new_n135_ & ~x11 & ~x17;
  assign new_n316_ = new_n143_ & new_n146_;
  assign new_n317_ = new_n142_ & new_n140_ & ~x09 & ~x10 & ~x07 & ~x08;
  assign new_n318_ = new_n145_ & new_n139_ & ~x05 & ~x06 & x02 & ~x45;
  assign z45 = new_n303_ & new_n320_ & new_n188_ & new_n297_ & x34 & ~x39;
  assign new_n320_ = new_n178_ & new_n151_ & new_n150_ & ~x62;
  assign z46 = new_n308_ & new_n296_ & new_n322_ & new_n280_ & new_n170_ & new_n297_;
  assign new_n322_ = new_n323_ & ~x10 & ~x14 & x09 & ~x11;
  assign new_n323_ = ~x15 & ~x17 & ~x18 & ~x22;
  assign z47 = new_n325_ & new_n188_ & new_n232_ & new_n320_ & new_n204_ & new_n296_;
  assign new_n325_ = ~x30 & ~x37 & x17 & ~x18 & ~x35 & ~x39;
  assign z48 = new_n303_ & new_n148_ & new_n149_ & new_n327_;
  assign new_n327_ = new_n140_ & x31 & ~x33 & ~x34 & ~x35;
  assign z49 = new_n303_ & new_n305_ & new_n149_ & x53 & ~x54;
  assign z50 = new_n238_ & x57 & new_n235_ & new_n228_ & new_n229_;
  assign z51 = new_n228_ & new_n229_ & new_n149_ & new_n313_ & x48 & ~x49;
  assign z52 = new_n273_ & ~x54 & new_n279_ & new_n332_ & new_n228_ & new_n253_;
  assign new_n332_ = new_n333_ & new_n188_ & new_n323_;
  assign new_n333_ = ~x34 & ~x37 & x12 & ~x14 & ~x35 & ~x39;
  assign z53 = x63 & ~x64 & new_n237_ & new_n235_ & new_n228_ & new_n229_;
  assign z54 = new_n202_ & x55 & new_n240_ & new_n288_ & new_n178_;
  assign z55 = new_n240_ & new_n202_ & new_n219_ & new_n178_ & x35 & ~x41;
  assign z56 = new_n274_ & new_n338_ & new_n176_ & new_n252_ & new_n135_;
  assign new_n338_ = new_n134_ & new_n339_ & new_n178_ & new_n179_ & new_n255_ & new_n231_;
  assign new_n339_ = ~x17 & ~x18 & ~x16 & x20;
  assign z57 = new_n200_ & new_n289_ & new_n137_ & x18 & ~x22;
  assign z58 = new_n244_ & new_n289_ & ~x24 & ~x26 & x22 & ~x25;
  assign z59 = x40 & new_n212_ & ~x50 & ~x43 & ~x58;
  assign z60 = new_n224_ & new_n213_ & x07 & ~x08 & ~x11;
  assign z61 = new_n221_ & new_n218_ & new_n345_ & new_n170_ & x08 & ~x10;
  assign new_n345_ = ~x25 & ~x28 & ~x58 & ~x60;
  assign z62 = new_n347_ & x47 & ~x50 & ~x60 & ~x56 & ~x58;
  assign new_n347_ = new_n225_ & new_n204_ & new_n192_ & ~x24 & ~x25;
  assign z63 = new_n347_ & x56 & ~x60 & ~x50 & ~x58;
  assign z64 = new_n350_ & new_n204_ & new_n192_ & ~x24 & ~x25;
  assign new_n350_ = x30 & new_n219_ & ~x46 & ~x60 & ~x50 & ~x58;
  assign z05 = x29;
endmodule
