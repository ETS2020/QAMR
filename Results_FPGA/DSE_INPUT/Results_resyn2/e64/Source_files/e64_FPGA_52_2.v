// Benchmark "FAU" written by ABC on Thu Jul 30 00:05:12 2020
...
module FAU ( 
  ...
  assign z14 = new_n206_ & ~x43 & ~x58 & ~x37 & x50;
  assign new_n206_ = new_n177_ & ~x15 & ~x10 & ~x14;
  assign z15 = new_n177_ & x10 & ~x37 & new_n208_ & ~x43 & ~x58;
  ...
  assign new_n216_ = new_n197_ & ~x30 & new_n217_ & new_n203_ & new_n177_;
  assign new_n217_ = ~x10 & ~x11 & ~x14 & ~x15;
  assign z19 = x64 & new_n228_ & new_n226_ & new_n219_ & new_n221_;
  assign new_n219_ = new_n220_ & new_n159_ & new_n157_ & new_n158_;
  assign new_n220_ = ~x14 & ~x18 & ~x15 & ~x17;
  assign new_n221_ = new_n222_ & new_n224_ & new_n225_ & new_n187_ & new_n223_ & ~x47;
  assign new_n222_ = ~x30 & ~x31;
  assign new_n223_ = ~x45 & ~x46;
  assign new_n224_ = ~x22 & ~x24 & ~x25 & ~x26 & ~x28 & x29;
  assign new_n225_ = ~x34 & ~x39 & ~x33 & ~x35;
  assign new_n226_ = new_n163_ & ~x54 & new_n227_ & ~x48 & ~x49;
  assign new_n227_ = ~x53 & ~x50 & ~x51;
  assign new_n228_ = new_n229_ & ~x57 & ~x59;
  assign new_n229_ = ~x61 & ~x62 & ~x58 & ~x60;
  assign z20 = new_n231_ & new_n233_ & new_n204_ & new_n191_ & new_n232_;
  assign new_n231_ = x51 & ~x41 & new_n196_ & new_n197_ & ~x62;
  assign new_n232_ = ~x24 & ~x18 & ~x22;
  assign new_n233_ = ~x06 & ~x07 & ~x30 & ~x00 & ~x03;
  assign z21 = new_n235_ & new_n237_ & new_n204_ & new_n191_ & new_n232_;
  assign new_n235_ = new_n211_ & new_n212_ & ~x62 & new_n236_ & ~x30 & ~x39;
  ...
  assign new_n240_ = new_n241_ & new_n163_ & ~x54 & new_n227_ & ~x48 & ~x49;
  assign new_n241_ = ~x45 & ~x47 & ~x43 & ~x46;
  assign new_n242_ = new_n222_ & new_n224_ & new_n225_ & new_n236_ & x36 & ~x42;
  assign z23 = new_n244_ & new_n208_ & new_n245_ & new_n246_ & new_n184_ & new_n248_;
  assign new_n244_ = ~x12 & new_n159_ & new_n157_ & new_n158_;
  assign new_n245_ = new_n153_ & ~x34 & ~x39 & ~x36 & ~x40;
  assign new_n246_ = new_n247_ & new_n191_ & new_n222_ & ~x33 & ~x35;
  assign new_n247_ = ~x18 & ~x22 & ~x21 & ~x24 & x16 & ~x17;
  assign new_n248_ = new_n164_ & ~x48 & ~x49 & ~x45 & ~x47;
  assign z24 = new_n203_ & x11 & new_n250_ & new_n251_;
  assign new_n250_ = new_n197_ & new_n177_ & ~x15 & ~x10 & ~x14;
  ...
  assign new_n257_ = new_n224_ & ~x20 & ~x21 & ~x30 & x32;
  assign z27 = new_n244_ & new_n162_ & new_n259_ & new_n260_ & new_n245_ & new_n261_;
  assign new_n259_ = new_n220_ & ~x16;
  assign new_n260_ = new_n224_ & ~x20 & ~x21;
  assign new_n261_ = new_n262_ & new_n222_ & ~x33 & ~x35;
  assign new_n262_ = x13 & ~x48 & ~x49 & ~x45 & ~x47;
  assign z28 = x25 & new_n250_ & new_n251_;
  assign z29 = new_n250_ & ~x50 & ~x58 & ~x46 & x60;
  assign z30 = new_n266_ & new_n268_ & new_n239_ & new_n219_ & ~x12;
  ...
  assign new_n278_ = new_n217_ & ~x08 & ~x06 & ~x07;
  ...
  assign new_n282_ = new_n236_ & new_n280_ & new_n233_ & new_n204_ & new_n191_ & new_n232_;
  assign new_n283_ = ~x62 & ~x58 & ~x60;
  assign z37 = new_n254_ & new_n184_ & new_n285_ & new_n248_ & new_n269_;
  ...
  assign new_n288_ = new_n152_ & new_n217_ & new_n229_ & new_n143_ & new_n142_ & new_n277_;
  assign z39 = new_n288_ & new_n280_ & new_n163_ & x42;
  assign z40 = new_n292_ & x54 & new_n291_ & new_n225_;
  assign new_n291_ = new_n143_ & new_n142_ & new_n136_ & new_n152_;
  assign new_n292_ = new_n134_ & new_n135_ & new_n236_ & new_n280_ & ~x42;
  assign z41 = new_n292_ & x33 & ~x39 & new_n291_ & ~x34 & ~x35;
  assign z42 = new_n295_ & new_n219_ & new_n221_;
  assign new_n295_ = new_n227_ & x49 & ~x54 & new_n134_ & new_n135_;
  assign z43 = new_n146_ & new_n298_ & new_n299_ & new_n297_ & new_n157_ & new_n158_;
  assign new_n297_ = new_n191_ & new_n222_ & ~x33 & ~x35;
  assign new_n298_ = new_n217_ & new_n187_ & x01 & ~x04 & ~x05;
  ...
  assign new_n303_ = new_n241_ & new_n141_ & x02 & ~x05 & ~x06;
  ...
  assign z47 = new_n305_ & new_n310_ & new_n152_ & new_n217_;
  assign new_n310_ = new_n224_ & new_n311_ & ~x41 & ~x42 & ~x30 & ~x39;
  ...
  assign z49 = new_n291_ & new_n225_ & new_n146_ & x53 & new_n315_ & ~x42;
  assign new_n315_ = new_n236_ & new_n280_;
  assign z50 = new_n226_ & new_n219_ & new_n221_ & new_n229_ & x57 & ~x59;
  assign z51 = new_n318_ & new_n219_ & new_n221_;
  assign new_n318_ = new_n134_ & new_n135_ & new_n138_ & x48 & ~x49;
  assign z52 = new_n240_ & new_n320_ & new_n321_ & new_n239_ & new_n141_ & new_n142_;
  assign new_n320_ = new_n159_ & new_n157_ & new_n158_;
  assign new_n321_ = new_n200_ & new_n139_ & ~x18 & ~x22 & x12 & ~x17;
  assign z53 = x63 & ~x64 & new_n228_ & new_n226_ & new_n219_ & new_n221_;
  assign z54 = new_n282_ & ~x35 & ~x39 & new_n283_ & x55 & ~x56;
  assign z55 = new_n282_ & x35 & ~x39 & new_n212_ & ~x62;
  assign z56 = new_n244_ & new_n208_ & new_n326_ & new_n184_ & ~x52;
  ...
  assign new_n329_ = ~x03 & new_n217_ & ~x08 & ~x06 & ~x07;
  assign z58 = new_n235_ & new_n329_ & new_n191_ & x22 & ~x24;
  ...
  assign new_n336_ = new_n212_ & new_n211_ & new_n199_ & x08 & ~x14;
  assign z62 = new_n216_ & new_n212_ & ~x50 & ~x46 & x47;
  assign z63 = new_n216_ & new_n251_ & x56;
  assign z64 = new_n217_ & new_n203_ & new_n177_ & new_n251_ & new_n197_ & x30;
  assign z05 = x29;
endmodule
