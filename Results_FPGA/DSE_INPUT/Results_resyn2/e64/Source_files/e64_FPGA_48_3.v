...
module FAU ( 
  ...
  assign new_n211_ = new_n212_ & new_n184_ & ~x37;
  assign new_n212_ = ~x15 & ~x10 & ~x14;
  assign z15 = new_n184_ & ~x37 & ~x43 & ~x58 & new_n135_ & x10;
  assign z16 = new_n215_ & new_n206_ & new_n216_ & x26 & new_n184_ & ~x30;
  assign new_n215_ = new_n202_ & ~x46 & ~x47 & ~x50;
  assign new_n216_ = ~x37 & ~x39 & ~x40 & ~x43;
  assign z17 = new_n215_ & new_n218_ & new_n207_ & new_n216_;
  assign new_n218_ = new_n219_ & new_n170_ & x03 & ~x07;
  assign new_n219_ = ~x08 & ~x10 & ~x25 & ~x28;
  assign z18 = new_n221_ & new_n204_ & x62 & ~x07 & ~x08;
  assign new_n221_ = new_n222_ & new_n223_ & new_n201_ & ~x60 & ~x56 & ~x58;
  ...
  assign new_n241_ = new_n242_ & new_n243_ & new_n202_ & ~x46 & ~x47 & ~x50;
  ...
  assign z24 = new_n257_ & new_n222_ & x11;
  assign new_n257_ = new_n212_ & new_n216_ & ~x46 & ~x60 & ~x50 & ~x58;
  ...
  assign z29 = new_n269_ & new_n211_ & new_n209_ & ~x43;
  ...
  assign z32 = new_n211_ & new_n209_ & ~x43 & x46 & ~x50 & ~x58;
  ...
  assign new_n285_ = new_n233_ & ~x58 & ~x60 & ~x61 & ~x62;
  ...
  assign new_n302_ = new_n303_ & new_n230_ & new_n209_ & ~x43;
  assign new_n303_ = ~x46 & ~x41 & ~x42 & ~x51 & ~x47 & ~x50;
  assign z41 = new_n300_ & new_n305_ & ~x34 & ~x35 & x33 & ~x37;
  assign new_n305_ = new_n235_ & new_n201_ & new_n196_ & new_n150_ & ~x51;
  ...
  assign z60 = new_n221_ & new_n212_ & x07 & ~x08 & ~x11;
  assign z61 = new_n342_ & new_n207_ & new_n201_ & ~x60 & ~x56 & ~x58;
  assign new_n342_ = new_n170_ & ~x25 & ~x28 & new_n209_ & x08 & ~x10;
  assign z62 = new_n344_ & x47 & ~x50 & ~x60 & ~x56 & ~x58;
  assign new_n344_ = new_n204_ & new_n222_ & new_n223_ & ~x43 & ~x46;
  assign z63 = new_n344_ & x56 & ~x60 & ~x50 & ~x58;
  assign z64 = new_n347_ & new_n204_ & new_n222_;
