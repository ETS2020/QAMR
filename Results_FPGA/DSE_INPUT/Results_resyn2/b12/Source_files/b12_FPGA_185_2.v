...
module FAU ( 
  ...
  assign z6 = new_n36_ & ((new_n38_ & (x02 | (~x03 & x09))) | new_n39_ | (x03 & ~x02 & ~x09));
  assign new_n38_ = ~x01 & (~x00 | ~x08);
  assign new_n39_ = (~x14 | x00 | ~x02) & x01 & (~x00 | ~x08);
  assign z7 = ~new_n36_ | ((~x08 | (~x02 & ~x01 & x03)) & (x01 | ~x03 | x02 | x09));
