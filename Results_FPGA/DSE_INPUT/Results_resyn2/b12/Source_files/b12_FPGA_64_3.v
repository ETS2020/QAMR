// Benchmark "FAU" written by ABC on Wed Jul 29 23:48:46 2020
...
module FAU ( 
  ...
  assign z6 = (new_n35_ | x01) & new_n36_ & (~x01 | ~x02 | x00 | ~x14);
  assign new_n35_ = ~x07 & ((x03 & ~x09) | x02 | (~x03 & x09));
  assign new_n36_ = (~x00 | (~x07 & ~x08)) & ~x10 & (~x07 | x14);
