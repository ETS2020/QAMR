...
module FAU ( 
  ...
  assign z2 = ~new_n30_ & (new_n31_ | ~x00);
  assign new_n30_ = ~x02 & (x01 | ((~x09 | x10) & ~x07 & (x03 | ~x10)));
  assign new_n31_ = ~x08 & (~x07 | (x09 & ~x10 & ~x01 & x03));
  assign z3 = (~x07 | ~x11) & (x00 | ~x12);
  assign z4 = (~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09);
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = new_n38_ & ((new_n36_ & (x02 | (~x03 & x09))) | new_n37_ | (x03 & ~x02 & ~x09));
  assign new_n36_ = ~x01 & ~x07;
  assign new_n37_ = (~x14 | x00 | ~x02) & x01 & ~x07;
  assign new_n38_ = ~x10 & (~x00 | ~x08);
  assign z7 = new_n40_ | x07 | x10;
  assign new_n40_ = (~x08 | (~x02 & ~x01 & x03)) & (x01 | ~x03 | x02 | x09);
  assign z8 = new_n42_ | x07 | x10;
  assign new_n42_ = (~x00 | x09) & (~x09 | x12 | x02 | x01 | ~x03);
endmodule
