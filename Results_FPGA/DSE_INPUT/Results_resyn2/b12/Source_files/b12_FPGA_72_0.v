...
module FAU ( 
  ...
  assign z6 = ((x03 & ~x09) | x01 | x02 | (~x03 & x09)) & new_n36_ & (~new_n35_ | ~x01 | ~x02);
  assign new_n35_ = ~x00 & x14;
  assign new_n36_ = (~x00 | ~x08) & ~x07 & ~x10;
  assign z7 = new_n38_ | x07 | x10;
  assign new_n38_ = (~x08 | (x03 & ~x01 & ~x02)) & (x01 | x02 | ~x03 | x09);
  assign z8 = (x12 & (x09 | (~x00 & ~x07))) | x07 | x10 | (~new_n40_ & ~x12);
