...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n34_, new_n36_, new_n37_, new_n40_;
  assign z0 = ~x00 & (((~x04 | x05) & x01 & x02) | ((x01 | x02) & x03 & (~x02 | ~x04)));
  assign z1 = (~x01 | ~x02 | ~x05 | ~x06) & (x01 | x02) & ~x00 & x03;
  assign z2 = ~new_n30_ & (new_n29_ | (~x07 & ~x08));
  assign new_n29_ = ~x00 & (~x04 | x05 | ~x01 | x03);
