...
module FAU ( 
  ...
  assign z3 = (x00 | ~x12) & (~x11 | (~x07 & (~x00 | x02 | ~x09)));
  assign z4 = (~x11 | (~x07 & (~x00 | x02 | ~x09))) & (~x00 | ~x08 | x07 | ~x09);
  assign z5 = (~new_n34_ & x00) | (~x00 & x12) | ~x13 | x07 | x10;
  assign new_n34_ = x11 & (x07 | (~x02 & x09));
  ...
  assign new_n39_ = (~x08 | (x03 & ~x01 & ~x02)) & (x01 | x02 | ~x03 | x09);
  assign z8 = new_n41_ | x07 | x10;
  assign new_n41_ = (~x00 | x09) & (x02 | ~x09 | x12 | x01 | ~x03);
endmodule
