...
module FAU ( 
  ...
  assign z0 = ~x00 & ((~x02 & x03) | ((~x04 | x05) & x01 & x02));
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = ((~x03 & (~x02 | ~x04)) | (x05 & x06)) & (x02 | ~x03) & (x01 | ~x02 | ~x04);
  assign z2 = ~new_n30_ & (~x00 | (~x07 & ~x08));
  assign new_n30_ = ~x02 & (x01 | (~x09 & ~x07 & ~x10));
  assign z3 = (~x07 | ~x11) & (x00 | ~x12);
  assign z4 = (~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09);
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = (x09 | x01 | x02) & new_n35_ & (x00 | ~x01 | ~x02 | ~x14);
