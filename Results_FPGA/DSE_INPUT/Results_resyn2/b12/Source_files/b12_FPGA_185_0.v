...
module FAU ( 
  ...
  assign new_n30_ = (x07 | x10 | ~x08 | x09) & ~x01 & (~x03 | (~x07 & ~x10));
  ...
  assign new_n35_ = ~x08 & ((x00 & (x01 | x02)) | (~x01 & ~x03));
  assign new_n36_ = (x01 | x02 | (~x03 ^ ~x09)) & ~x00 & (~x14 | ~x01 | ~x02);
  assign z7 = new_n38_ | (~x07 & ~x08) | x07 | x10;
  assign new_n38_ = x03 & x09 & ~x01 & ~x02;
