// Benchmark "FAU" written by ABC on Wed Jul 29 23:49:08 2020
...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n34_, new_n35_, new_n37_, new_n39_;
  ...
  assign z7 = (~x08 & (~new_n37_ | (x02 & ~x07))) | x07 | x10 | (new_n37_ & ~x02 & x09);
  assign new_n37_ = ~x01 & x03;
  assign z8 = new_n39_ | x07 | x10;
  assign new_n39_ = (~x00 | x09) & (x12 | x01 | ~x03 | x02 | ~x09);
  assign z5 = 1'b1;
endmodule
