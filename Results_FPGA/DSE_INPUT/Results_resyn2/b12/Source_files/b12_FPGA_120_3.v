...
module FAU ( 
  ...
  assign z0 = (x03 | (x02 & (~x04 | x05))) & ~x00 & x01;
  assign z1 = ~new_n28_ & ~x00;
  assign new_n28_ = (~x01 | ~x03) & ((x06 & x01 & x05) | ~x02 | ~x04);
  assign z2 = (~x00 & (new_n30_ | new_n31_)) | (~new_n32_ & ~x07 & ~x08);
  assign new_n30_ = ~x01 & ((~x03 & (x07 | x10)) | (~x10 & ~x07 & x09));
  assign new_n31_ = x02 & ((~x07 & ~x10) | x01 | (x04 & ~x05));
  ...
  assign z7 = (~x08 & (~x03 | (x01 & ~x02))) | ~new_n36_ | (x09 & ~x01 & x03);
  assign z8 = ~new_n36_ | ((~x00 | x09) & (x12 | ~x09 | x01 | ~x03));
endmodule
