// Benchmark "FAU" written by ABC on Wed Jul 29 23:48:58 2020
...
module FAU ( 
  ...
  assign z4 = ~x11 & (~x00 | ~x08 | x07 | ~x09);
  assign z5 = ~new_n34_ | ~x13 | x00 | x12;
  assign new_n34_ = ~x11 & ~x07 & ~x10;
  ...
  assign z8 = (~new_n40_ & x09) | ~new_n34_ | (~x00 & ~x09);
  assign new_n40_ = ~x12 & x03 & ~x01 & ~x02;
endmodule
