...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n34_, new_n36_, new_n37_, new_n40_, new_n41_;
  ...
  assign z8 = (x09 & (new_n40_ | ~new_n41_)) | ~new_n34_ | (~x00 & ~x09);
  assign new_n40_ = ~x07 & ~x08 & ~x03 & ~x10;
  assign new_n41_ = ~x12 & ~x01 & ~x02;
endmodule
