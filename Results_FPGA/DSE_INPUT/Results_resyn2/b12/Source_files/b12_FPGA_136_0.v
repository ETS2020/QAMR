// Benchmark "FAU" written by ABC on Wed Jul 29 23:49:23 2020
...
module FAU ( 
  ...
  assign z2 = (x02 & (~x00 | (~x07 & ~x08))) | (~x03 & ~x00 & ~x01);
  assign z3 = (~x07 | ~x11) & (x00 | ~x12);
  assign z4 = (~x07 | ~x11) & (~x00 | ~x08 | x07 | ~x09);
  assign z5 = x07 | x10 | ~x13 | x00 | x12;
  assign z6 = (~x14 | x00 | ~x02) & (~x00 | ~x08) & ~x07 & ~x10;
  assign z7 = (~x07 & ~x08) | x07 | x10;
  assign z8 = x07 | x10 | ~x00 | x09;
endmodule
