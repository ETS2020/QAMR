...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n34_, new_n36_, new_n37_, new_n39_;
  ...
  assign z5 = ~new_n34_ | ~x13 | (x00 & ~x07);
  assign new_n34_ = ~x12 & ~x07 & ~x10;
  ...
  assign new_n39_ = (~x08 | (x03 & ~x01 & ~x02)) & (~x03 | x09 | x01 | x02);
