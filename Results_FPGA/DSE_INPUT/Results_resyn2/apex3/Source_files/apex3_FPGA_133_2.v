// Benchmark "FAU" written by ABC on Thu Jul 30 22:25:49 2020
...
module FAU ( 
  ...
  assign z01 = new_n139_ | (new_n122_ & ~x49 & (new_n158_ | (~new_n156_ & ~x50)));
  assign new_n139_ = ~x46 & ((~new_n140_ & ~new_n146_) | (~new_n155_ & x47 & x52));
  assign new_n140_ = (new_n141_ | ~x47) & ~x53 & (new_n145_ | ~x48 | ~x51);
  assign new_n141_ = (new_n142_ | x51) & ~new_n143_ & (new_n144_ | ~x51);
  assign new_n142_ = (x48 | x50 | ((~x49 | ~x52) & (x09 | x49 | x52))) & (x31 | x49 | ~x52) & ((x48 & x49 & x52) | ~x50 | (~x48 & ~x52));
  assign new_n143_ = (x48 ^ x50) & (~x50 | (~x28 & ~x49 & ~x52));
  assign new_n144_ = (~x49 | x50 | ~x20 | x52) & ((~x52 & x11 & x49) | (~x49 & x52) | x48 | ~x50);
  assign new_n145_ = (~x47 | ~x50 | (x49 & x52)) & (x47 | (x49 & ~x50) | (~x49 & x50) | ~x52 | (~x39 & x50));
  ...
  assign new_n155_ = (x49 | ~x50 | ~x51 | x45 | ~x48) & (x50 | x51 | ~x38 | x48 | ~x49);
  assign new_n156_ = (new_n157_ | ~x51) & (~x48 | x51 | (~x53 & (~x16 | ~x52)));
  ...
  assign new_n179_ = (new_n180_ | ~new_n183_) & ~new_n182_ & ~x47;
  ...
  assign new_n206_ = x49 & ((~x46 & ((x17 & x53) | (~x34 & x48 & ~x53))) | (~x48 & (x46 | x53)));
  ...
  assign new_n218_ = ~x46 & (~new_n159_ | (x53 ? x29 : x08));
  assign new_n219_ = new_n220_ & (~new_n149_ | (x49 ? x53 : (x50 | ~x53)));
  ...
  assign new_n222_ = (new_n224_ | ~new_n225_) & (~x47 | ~x48 | ~new_n148_ | ~new_n223_);
  ...
  assign new_n226_ = (~x49 | x48 | ~x50 | ~x52 | ~x53) & (~x48 | x49 | x50 | x52 | x53);
  ...
  assign new_n243_ = x46 & (new_n244_ | (new_n149_ & (x41 | x49 | ~x53)));
  assign new_n244_ = (x51 | (~x04 & x48)) & ~x49 & (~x52 | (~x51 & ~x53));
  assign new_n245_ = new_n149_ & x51 & ((x14 & ~x49) | (~x35 & x49 & ~x53));
  ...
  assign new_n280_ = (~x31 | x53) & new_n149_ & (x29 | ~x53);
  ...
  assign new_n285_ = new_n151_ & ((x16 & x52 & ~x53) | (~x52 & (x20 | x53)));
  ...
  assign new_n320_ = ~new_n321_ & (x50 | ((new_n323_ | ~x47) & (new_n324_ | ~x49)));
  assign new_n321_ = new_n195_ & new_n322_ & ~x20 & ~x47 & x49;
  assign new_n322_ = x50 & ~x51;
  assign new_n323_ = (~x53 | x13 | x49 | ~x52) & (~x51 | x52 | x53 | ~x20 | ~x49);
  assign new_n324_ = (~x12 | x52 | x53) & (~x51 | ~x52 | ~x53 | ~x17 | x47);
  ...
  assign new_n338_ = (~x47 | (~new_n339_ & (x49 | ~x50))) & x51 & ((x44 & x50) | x47 | (x49 & ~x50) | (~x49 & x50));
  assign new_n339_ = (x43 | ~x50) & (~x29 | x49);
  assign new_n340_ = (x14 | x47) & new_n151_ & x49;
  ...
  assign new_n345_ = new_n151_ & (x25 | x47) & new_n194_ & ~x53;
  ...
  assign new_n352_ = (x49 | x51 | (~x47 & x50)) & (x47 | ~x49 | ((~x20 | x50 | x51) & (~x29 | ~x50)));
  ...
  assign z07 = (~new_n370_ & ~x46) | (~x47 & (~new_n415_ | (x46 & (new_n407_ | new_n409_))));
  ...
  assign new_n375_ = ~new_n378_ & (x51 | (~new_n376_ & ~new_n377_ & (~new_n148_ | x31)));
  ...
  assign new_n387_ = (x52 | ~x08 | ~x48) & (~x49 | ((x47 | (~x48 ^ x52)) & (~x18 | x52) & (x08 | x48 | ~x52)));
  ...
  assign new_n407_ = ~x48 & ((~new_n408_ & ~x53) | (new_n322_ & x49 & ~x52 & x53));
  ...
  assign new_n419_ = (x41 | x52 | x50 | x53) & (((x35 | x53) & (x03 | ~x52)) | ~x50 | (x52 & ~x53));
  ...
  assign new_n443_ = (new_n444_ | x49) & (x48 | ~x50 | ~x51 | ~x49 | ~x53);
  ...
  assign z16 = (~new_n448_ & ~x48) | (new_n133_ & new_n322_ & new_n276_ & x48 & x49);
  ...
  assign new_n456_ = new_n194_ & x53 & new_n151_ & ~x47 & ~x52;
  ...
  assign new_n481_ = (x51 | ((x46 | (((x52 & x53) | x49 | ~x50) & (~x49 | x50 | x52))) & ((~x52 & x53) | (x52 & ~x53) | (~x50 & ~x53) | ~x46 | ~x49))) & (x50 | ~x51 | ~x46 | ~x49);
  ...
  assign z34 = (x52 ^ (x48 | x53)) & new_n133_ & new_n151_ & x49;
  ...
  assign z49 = (~new_n508_ & ~x48) | (new_n195_ & new_n322_ & new_n122_ & x48 & ~x49);
