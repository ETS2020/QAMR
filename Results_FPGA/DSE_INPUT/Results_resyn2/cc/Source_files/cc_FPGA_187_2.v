// Benchmark "FAU" written by ABC on Wed Jul 29 23:26:18 2020
...
module FAU ( 
  ...
  assign z03 = x12 & x15 & x08 & ~x14;
  assign z09 = x08 & x09;
  assign z12 = (x00 | ~x08 | x15) & x12 & (x13 | (x08 & ~x15));
  assign z13 = x12 & (((~x01 | ~x08) & x14) | (x08 & x15));
  assign z14 = ((x02 & x08) | x15) & x12 & (~x08 | ~x15);
  assign z15 = ((x08 & ~x15) | (~x14 & x16)) & x12 & (x03 | ~x08 | x15);
