// Benchmark "FAU" written by ABC on Wed Jul 29 23:25:14 2020
...
module FAU ( 
  ...
  assign z13 = x12 & ((x14 & (~x01 | ~x08 | ~x10)) | ((x10 | x14) & x08 & x15));
  assign z14 = (x15 | (x02 & x08 & x10)) & x12 & (~x15 | ~x08 | ~x10);
  assign z15 = (new_n46_ | (~x14 & x16)) & x12 & (~new_n46_ | x03);
  assign z16 = ~new_n54_ & x12;
  assign new_n54_ = ((~x10 & ~x14) | ~x08 | ~x15) & (~x17 | (~x04 & x08 & x10));
