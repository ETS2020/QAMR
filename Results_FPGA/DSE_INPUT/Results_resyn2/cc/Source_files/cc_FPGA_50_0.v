// Benchmark "FAU" written by ABC on Wed Jul 29 23:25:10 2020
...
module FAU ( 
  ...
  wire new_n52_;
  assign z00 = x11 & x20;
  assign z01 = x08 & x10 & ~x14;
  assign z02 = x14 & ~x11 & x12;
  assign z03 = z01 & x12;
  assign z09 = x08 & x09;
  assign z12 = (x00 | x15 | ~x08 | ~x10) & x12 & (x13 | (~x15 & x08 & x10));
  assign z13 = x12 & ((x14 & (x15 | ~x08 | ~x10)) | (x08 & x10 & (~x01 | ~x14)));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & ~x15 & x08 & x10));
  assign z15 = ~new_n52_ & x12;
  assign new_n52_ = (~x03 | x15 | ~x08 | ~x10) & (x14 | ~x16);
