...
module FAU ( 
  ...
  assign z01 = x19 & (~x00 | (new_n44_ & new_n45_ & ~x07 & x08));
  assign new_n44_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n45_ = ~x05 & ~x06;
  assign z02 = x00 & x19 & (~new_n48_ | ~new_n47_ | x01);
  assign new_n47_ = ~x02 & ~x03;
  assign new_n48_ = ~x04 & ~x05 & ~x06 & ~x07;
  assign z04 = x20 | x21;
  assign z05 = x10 | (new_n44_ & new_n45_ & ~x07 & ~x08 & x19);
  assign z06 = x19 & ((new_n52_ & ~x01) | ~x00 | (x00 & (~new_n48_ | ~new_n47_ | x01)));
