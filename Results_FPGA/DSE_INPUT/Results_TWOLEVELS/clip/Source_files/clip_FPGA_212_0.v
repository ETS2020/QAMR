...
module FAU ( 
  ...
  assign new_n35_ = ~new_n36_ & (~x0 | x5) & (new_n37_ | (~x3 ^ ~x8));
  assign new_n36_ = ~x7 & (x3 ^ x8) & (~x1 | ~x2);
  assign new_n37_ = (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n38_ = x3 & ~x6 & ~x8 & (~x2 | ~x7 | (~x1 & x7));
  assign z3 = x0 ? (new_n43_ | (new_n47_ & x6) | (~new_n48_ & ~x6)) : ~new_n40_;
  assign new_n40_ = (~x3 | (~new_n41_ & ~new_n42_ & (x6 | ~x8))) & (x6 | new_n37_ | ~x8);
  assign new_n41_ = x1 & (x2 ? (~x6 & (x4 | x7)) : (~x5 & x6 & (x4 | ~x7)));
  assign new_n42_ = x4 & ((~x6 & x7) | (~x5 & x6 & ~x7));
  assign new_n43_ = ~x3 & (new_n44_ | new_n45_ | ~new_n46_);
  assign new_n44_ = x2 & ((x7 & ~x8) | (~x4 & x5 & ~x7));
  assign new_n45_ = x5 & ((~x1 & (~x4 | (~x6 & ~x7))) | (~x2 & ~x6 & (~x4 | ~x7)));
  assign new_n46_ = x8 ? ~x6 : (x6 & (~x7 | (x1 & x4)));
  assign new_n47_ = x8 & ((~x4 & x7) | ((~x4 | x7) & (~x1 | x2)));
  assign new_n48_ = x5 & (x8 | ((x4 | x7) & ((x4 & x7) | (x1 & x2))));
  assign z4 = new_n50_ | (~new_n55_ & x0) | (x5 & (~x0 | x6));
  assign new_n50_ = x3 & (new_n53_ | new_n54_ | (~x2 & (new_n51_ | new_n52_)));
  ...
  assign new_n55_ = (x3 | (~new_n56_ & (x6 | x8))) & (x4 | x6 | x7 | x8);
  assign new_n56_ = x5 & ((~x1 & (~x4 | (~x6 & ~x7))) | (~x2 & ~x6 & (~x4 | ~x7)) | (x2 & ~x4 & ~x7));
endmodule
