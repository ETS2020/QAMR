...
module FAU ( 
  ...
  assign new_n58_ = (~x20 | (~x19 & (~x17 | x19))) & (x17 | x19 | x20);
  assign z11 = x16 ? ~new_n60_ : (x18 ? x02 : x10);
  assign new_n60_ = (x17 | x19 | x20 | x21) & (~x21 | (~x17 & ~x19 & ~x20));
  assign z12 = x16 ? ~new_n62_ : (x18 ? x03 : x11);
  assign new_n62_ = (x17 | x19 | x20 | x21 | x22) & (~x22 | (~x20 & ~x21 & ~x17 & ~x19));
  assign z13 = x16 ? ~new_n64_ : (x18 ? x04 : x12);
  assign new_n64_ = (x17 | x19 | x20 | x21 | x22 | x23) & (~x23 | (~x20 & ~x21 & ~x22 & ~x17 & ~x19));
  ...
  assign new_n76_ = (x20 | (~x17 & (x17 | new_n77_ | x19))) & (~x26 | (~x19 & ~x20));
  assign new_n77_ = ~x21 & (x21 | (~x22 & (x22 | (~x23 & (x23 | (~x24 & (x24 | ~x25)))))));
