// Benchmark "FAU" written by ABC on Wed Jul 29 03:44:29 2020
...
module FAU ( 
  ...
  assign new_n66_ = (x17 | x19 | ~new_n68_ | x20) & (~x24 | (new_n67_ & ~x17 & ~x19 & ~x20));
  assign new_n67_ = ~x21 & ~x22 & ~x23;
  assign new_n68_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z15 = x16 ? ~new_n70_ : (x18 ? x06 : x14);
  assign new_n70_ = (~x25 | (new_n71_ & new_n73_)) & (~new_n72_ | ~new_n74_);
  assign new_n71_ = ~x17 & ~x19 & ~x20;
  assign new_n72_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n73_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n74_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? ~new_n76_ : (x18 ? x07 : x15);
  assign new_n76_ = x19 ? ~x26 : (~x17 & (new_n77_ | x17));
  assign new_n77_ = ~x20 & (x20 | (~x21 & (x21 | (~x22 & (x22 | (~x23 & (x23 | (~x24 & (x24 | ~x25)))))))));
  assign z17 = ~new_n79_ & x16;
  assign new_n79_ = (~new_n80_ | x17 | x20 | x21 | x22) & (~x17 | ~x27);
