// Benchmark "FAU" written by ABC on Wed Jul 29 03:44:28 2020
...
module FAU ( 
  ...
  wire new_n58_, new_n60_, new_n62_, new_n64_, new_n66_, new_n67_, new_n68_,
    new_n69_, new_n71_, new_n72_, new_n75_, new_n76_;
  ...
  assign new_n60_ = (x17 | x19 | x20 | x21) & (~x21 | (~x17 & ~x19 & ~x20));
  assign z12 = x16 ? ~new_n62_ : (x18 ? x03 : x11);
  assign new_n62_ = (x17 | x19 | x20 | x21 | x22) & (~x22 | (~x17 & ~x19 & ~x20 & ~x21));
  assign z13 = x16 ? ~new_n64_ : (x18 ? x04 : x12);
  assign new_n64_ = (x17 | x19 | x20 | x21 | x22 | x23) & (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22));
  assign z14 = x16 ? ((x24 & (~new_n66_ | ~new_n67_)) | (new_n66_ & new_n69_)) : ~new_n68_;
  assign new_n66_ = ~x17 & ~x19 & ~x20;
  assign new_n67_ = ~x21 & ~x22 & ~x23;
  assign new_n68_ = x18 ? ~x05 : ~x13;
  assign new_n69_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z15 = x16 ? ((~x17 & ~new_n72_ & ~x19) | (x25 & (x17 | x19))) : ~new_n71_;
  assign new_n71_ = x18 ? ~x06 : ~x14;
  assign new_n72_ = ~x20 & (x20 | (~x21 & (x21 | (~x22 & (x22 | (~x23 & (x23 | ~x24)))))));
  assign z16 = x16 ? x26 : (x18 ? x07 : x15);
  assign z17 = x16 & ((x17 & x27) | (new_n76_ & new_n75_ & ~x17 & ~x20));
