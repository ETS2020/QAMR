...
module FAU ( 
  ...
  assign z14 = x16 ? (new_n66_ | new_n68_) : (x18 ? x05 : x13);
  assign new_n66_ = new_n67_ & ~x17 & ~x19 & ~x20;
  assign new_n67_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n68_ = x24 & (x17 | x20 | x21 | x22 | x23);
  assign z15 = x16 ? (new_n70_ | (~new_n66_ & x25)) : ~new_n72_;
  ...
  assign z17 = x16 & ((x17 & x27) | (new_n77_ & new_n76_ & ~x17 & x19));
