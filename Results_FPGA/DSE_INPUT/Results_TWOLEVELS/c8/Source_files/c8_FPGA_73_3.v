...
module FAU ( 
  ...
  assign z15 = x16 ? (new_n70_ | new_n72_) : (x18 ? x06 : x14);
  assign new_n70_ = ~x17 & ~x20 & new_n71_ & ~x21;
  assign new_n71_ = ~x22 & ~x23 & ~x24 & ~x25 & (x26 | (~x19 & ~x26));
  assign new_n72_ = x25 & (~new_n60_ | x21 | x22 | x23 | x24);
  assign z16 = x16 ? ~new_n74_ : (x18 ? x07 : x15);
  assign new_n74_ = (~x26 | (new_n76_ & new_n75_ & ~x24 & ~x25)) & (~new_n62_ | ~new_n75_ | x24 | x25 | x26);
