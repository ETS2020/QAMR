...
module FAU ( 
  ...
  assign new_n69_ = (~x25 | (new_n70_ & ~x22 & ~x23 & ~x24)) & ~x19 & (~new_n70_ | x22 | x23 | x24 | x25);
  assign new_n70_ = ~x17 & ~x20 & ~x21;
  assign z16 = x16 ? (new_n73_ | (~new_n72_ & x26)) : ~new_n75_;
  assign new_n72_ = new_n70_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n73_ = new_n74_ & ~x17 & ~x20 & ~x21 & ~x22;
