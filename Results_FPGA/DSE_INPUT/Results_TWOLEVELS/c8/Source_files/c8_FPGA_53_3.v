// Benchmark "FAU" written by ABC on Wed Jul 29 03:44:26 2020
...
module FAU ( 
  ...
  assign new_n66_ = (x17 | ~new_n68_ | x20) & (new_n67_ | ~x24);
  assign new_n67_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n68_ = ~x21 & ~x22 & ~x23 & ~x24 & (x25 | (~x19 & ~x25));
  assign z15 = x16 ? ~new_n70_ : (x18 ? x06 : x14);
  assign new_n70_ = (~x25 | (new_n72_ & ~x22 & ~x23 & ~x24)) & (~new_n71_ | x22 | x23 | x24 | x25);
