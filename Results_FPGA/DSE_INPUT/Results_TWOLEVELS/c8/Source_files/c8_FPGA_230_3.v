...
module FAU ( 
  ...
  assign z15 = x16 ? ((new_n71_ & new_n74_) | (~new_n73_ & x25)) : ~new_n72_;
  assign new_n71_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n72_ = x18 ? ~x06 : ~x14;
  assign new_n73_ = ~x17 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n74_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? ((x26 & (~new_n71_ | ~new_n74_)) | (new_n71_ & new_n77_)) : ~new_n76_;
  assign new_n76_ = x18 ? ~x07 : ~x15;
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z17 = x16 & ((x17 & x27) | (new_n80_ & new_n79_ & ~x17 & x19));
  assign new_n79_ = ~x20 & ~x21;
  assign new_n80_ = ~x22 & ~x23 & ~x24 & ~x26;
  assign z08 = x27;
endmodule
