...
module FAU ( 
  ...
  assign new_n66_ = (new_n67_ | ~x24) & (~new_n68_ | x17);
  assign new_n67_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n68_ = ~x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z15 = x16 ? (new_n72_ | (~new_n70_ & x25)) : ~new_n74_;
  assign new_n70_ = new_n71_ & ~x17 & ~x19 & ~x20;
  ...
  assign new_n76_ = (x17 | x19 | ~new_n77_ | x20) & (~x26 | (new_n71_ & ~x17 & ~x19 & ~x20));
