...
module FAU ( 
  ...
  assign new_n66_ = ~x23 & (x17 | x19 | x20 | x21 | x22);
  assign z14 = x16 ? ~new_n68_ : (x18 ? x05 : x13);
  assign new_n68_ = (~x24 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x24);
  assign z15 = x16 ? ~new_n70_ : (x18 ? x06 : x14);
  assign new_n70_ = (~x25 | (new_n60_ & ~x21 & ~x22 & ~x24)) & (~new_n60_ | x21 | x22 | x24 | x25);
  assign z16 = x16 ? (new_n73_ | (~new_n72_ & x26)) : ~new_n74_;
  assign new_n72_ = new_n60_ & ~x21 & ~x22 & ~x24 & ~x25;
  assign new_n73_ = new_n62_ & ~x22 & ~x24 & ~x25 & ~x26;
