// Benchmark "FAU" written by ABC on Wed Jul 29 03:44:40 2020
...
module FAU ( 
  ...
  assign z15 = x16 ? (new_n70_ | x25) : (x18 ? x06 : x14);
  assign new_n70_ = new_n60_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z16 = x16 ? ((~new_n70_ & x26) | (new_n62_ & new_n73_)) : ~new_n72_;
  assign new_n72_ = x18 ? ~x07 : ~x15;
  assign new_n73_ = ~x22 & ~x23 & ~x24 & ~x26;
  assign z17 = ~new_n75_ & x16;
  assign new_n75_ = (~new_n73_ | x20 | x21 | x17 | ~x19) & (~x17 | ~x27);
  assign z08 = x27;
endmodule
