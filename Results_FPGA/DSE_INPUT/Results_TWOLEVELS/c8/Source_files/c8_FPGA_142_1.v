...
module FAU ( 
  ...
  assign z14 = x16 ? (new_n68_ | x24) : (x18 ? x05 : x13);
  assign new_n68_ = new_n60_ & ~x21 & ~x22 & ~x23;
  assign z15 = x16 ? ~new_n70_ : (x18 ? x06 : x14);
  assign new_n70_ = (~x25 | (new_n60_ & ~x21 & ~x22 & ~x23)) & (~new_n60_ | x21 | x22 | x23 | x25);
  assign z16 = x16 ? ((~new_n72_ & x26) | (new_n62_ & new_n74_)) : ~new_n73_;
  assign new_n72_ = new_n60_ & ~x21 & ~x22 & ~x23 & ~x25;
