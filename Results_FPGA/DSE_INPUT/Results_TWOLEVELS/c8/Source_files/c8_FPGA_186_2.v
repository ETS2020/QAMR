// Benchmark "FAU" written by ABC on Wed Jul 29 03:44:51 2020
...
module FAU ( 
  ...
  assign z16 = x16 ? (new_n76_ | (new_n74_ & ~x17)) : ~new_n77_;
  assign new_n74_ = ~x19 & (new_n75_ | x20);
  assign new_n75_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n76_ = x26 & (~new_n72_ | x17 | x19 | x21);
  assign new_n77_ = x18 ? ~x07 : ~x15;
  assign z17 = ~new_n79_ & x16;
  assign new_n79_ = (~new_n80_ | x21 | x22 | x17 | ~x19) & (~x17 | ~x27);
