// Benchmark "FAU" written by ABC on Wed Jul 29 03:44:58 2020
...
module FAU ( 
  ...
  wire new_n58_, new_n60_, new_n61_, new_n62_, new_n64_, new_n66_, new_n68_,
    new_n70_, new_n71_, new_n72_, new_n74_, new_n75_, new_n76_;
  ...
  assign z15 = x16 ? ((~new_n70_ & x25) | (new_n62_ & new_n72_)) : ~new_n71_;
  assign new_n70_ = new_n60_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n71_ = x18 ? ~x06 : ~x14;
  assign new_n72_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z16 = x16 ? (new_n74_ | ~new_n75_) : (x18 ? x07 : x15);
  assign new_n74_ = x26 & (~new_n72_ | x17 | x20 | x21);
  assign new_n75_ = ~x19 & (~new_n76_ | x23 | x24 | x25 | x26);
  assign new_n76_ = ~x17 & ~x20 & ~x21 & ~x22;
