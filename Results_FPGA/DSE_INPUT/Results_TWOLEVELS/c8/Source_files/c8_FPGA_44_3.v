...
module FAU ( 
  ...
  assign z10 = x16 ? (x17 ? x20 : (~x19 & ~x20)) : ~new_n58_;
  ...
  assign new_n64_ = (~x22 | (~x17 & ~x19 & ~x20 & ~x21)) & (x20 | x21 | x22 | x17 | x19);
  assign z13 = x16 ? ~new_n66_ : (x18 ? x04 : x12);
  assign new_n66_ = (~x23 | (~x20 & ~x21 & ~x22 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21 | x22 | x23);
  ...
  assign new_n75_ = (~new_n76_ | x21 | x22 | x17 | ~x19) & (~x17 | ~x27);
