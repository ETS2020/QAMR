// Benchmark "FAU" written by ABC on Wed Jul 29 03:40:56 2020
...
module FAU ( 
  ...
  assign z4 = (~x07 & (~x00 | ~x09)) | ~x08 | (x07 & ~x11);
  assign z5 = (~x07 & (x00 | (~x00 & x12))) | x07 | x10 | ~x13;
  assign z6 = ~x10 & ((~new_n38_ & (new_n37_ | x01)) | new_n40_ | (new_n39_ & ~x01));
  assign new_n37_ = x03 & ~x09;
  assign new_n38_ = x00 ? x08 : (x02 | x07);
  assign new_n39_ = (x02 | (~x03 & x09)) & (~x08 | (~x00 & ~x07));
  assign new_n40_ = ~x07 & ~x14 & ~x00 & x01;
  assign z7 = (~new_n42_ & ~x01) | x07 | x10 | (~x08 & (x01 | ~x03));
  assign new_n42_ = x02 ? (x08 | x10) : (~x03 | ~x09);
