// Benchmark "FAU" written by ABC on Wed Jul 29 03:40:10 2020
...
module FAU ( 
  ...
  assign z1 = ~x00 & ((x02 & ((~x01 & (x04 | (x03 & ~x04))) | (~x05 & (x03 | x04)))) | (x01 & ~x02 & x03));
  ...
  assign new_n37_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (x02 & ~x14) | (~x02 & (x01 | (x03 & ~x09))));
