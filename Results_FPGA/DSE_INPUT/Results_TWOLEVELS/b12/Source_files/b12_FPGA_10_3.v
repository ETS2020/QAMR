// Benchmark "FAU" written by ABC on Wed Jul 29 03:40:11 2020
...
module FAU ( 
  ...
  assign z4 = x07 ? ~x11 : (~x08 | ~x09 | (~x00 & ~x13));
  assign z5 = (~x07 & (x00 | (~x00 & ~x13))) | x07 | x10 | x12;
  assign z6 = ~x07 & ~x10 & (new_n37_ | new_n38_ | new_n39_);
  assign new_n37_ = x02 & (x00 ? ~x08 : ~x01);
  assign new_n38_ = (~x00 | ~x08) & ((~x02 & (x01 | (x03 & ~x09))) | (~x01 & ~x03 & x09));
