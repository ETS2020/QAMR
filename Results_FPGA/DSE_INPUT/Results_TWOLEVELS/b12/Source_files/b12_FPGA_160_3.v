...
module FAU ( 
  ...
  assign new_n28_ = x02 & (x04 ? (~x01 | ~x05 | ~x06) : x03);
  assign z2 = (~x00 & (new_n31_ | (~new_n30_ & x02))) | (new_n32_ & ~x07);
  assign new_n30_ = (~x01 | (x04 & ~x05)) & (x01 | (~x04 & (x07 | x10))) & (~x04 | x05) & (~x03 | x04);
  ...
  assign new_n37_ = ~x08 & ((x00 & (x01 | x02)) | (~x01 & ~x03 & x09) | (x03 & ~x09));
  assign new_n38_ = ~x00 & ((x01 & (~x02 | ~x14)) | (x03 & ~x09) | (~x01 & (x02 | (~x03 & x09))));
