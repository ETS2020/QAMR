...
module FAU ( 
  ...
  assign new_n31_ = (x03 | ~x07) & (x01 | ((x03 | ~x10) & (x07 | ~x09 | x10)));
  ...
  assign z6 = ~x10 & (new_n38_ | (~new_n37_ & ~x07));
  assign new_n37_ = (x08 | ((~x00 | (~x02 & (~x03 | x09))) & (x01 | x03 | ~x09))) & (x00 | ((x01 | (~x02 & (x03 | ~x09))) & (x02 | ~x03 | x09)));
  assign new_n38_ = x01 & ((~x02 & ~x08) | (~x00 & (~x02 | ~x14)));
  assign z7 = (~new_n40_ & ~x02) | x07 | x10 | (~x08 & (~x03 | (x02 & ~x07)));
  assign new_n40_ = x01 ? (x08 | x10) : (~x03 | ~x09);
