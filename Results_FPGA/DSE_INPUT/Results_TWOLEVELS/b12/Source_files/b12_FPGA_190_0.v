// Benchmark "FAU" written by ABC on Wed Jul 29 03:40:45 2020
...
module FAU ( 
  ...
  wire new_n28_, new_n30_, new_n31_, new_n32_, new_n37_, new_n39_, new_n41_;
  ...
  assign new_n37_ = ((~x01 & (~x03 | x09)) | (x00 ? x08 : x02)) & (x01 | (~x02 & (x03 | ~x09)) | (x00 & x08));
