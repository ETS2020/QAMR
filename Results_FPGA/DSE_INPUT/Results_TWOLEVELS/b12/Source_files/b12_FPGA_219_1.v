// Benchmark "FAU" written by ABC on Wed Jul 29 03:40:51 2020
...
module FAU ( 
  ...
  assign z6 = ~x07 & ~x10 & (new_n38_ | (~new_n37_ & ~x08));
  assign new_n37_ = (~x00 | (~x02 & (~x03 | x09))) & (x01 | x03 | ~x09) & (~x01 | x14);
  assign new_n38_ = ~x00 & ((~x01 & (x02 | (~x03 & x09))) | (~x14 & (x01 | (x03 & ~x09))));
  assign z7 = (~x08 & (~x03 | (~new_n40_ & ~x07))) | ~new_n41_ | x07;
  assign new_n40_ = ~x02 & (~x01 | x10 | x14);
