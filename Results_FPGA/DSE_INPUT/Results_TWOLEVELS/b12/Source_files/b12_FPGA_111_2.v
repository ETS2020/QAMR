...
module FAU ( 
  ...
  assign new_n30_ = (~x01 | (x04 & ~x05)) & (x01 | (~x04 & (~x03 | x04))) & (~x04 | x05) & (x07 | x10);
  assign new_n31_ = (x03 | (x07 ? x01 : ~x10)) & (x07 | ~x09 | x10);
  ...
  assign z7 = (~x08 & (~x03 | (x02 & ~x07 & ~x10))) | x07 | x10 | (~x02 & x03 & x09);
