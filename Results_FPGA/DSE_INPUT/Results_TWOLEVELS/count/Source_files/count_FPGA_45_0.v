...
module FAU ( 
  ...
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n69_ | (~new_n71_ & x26)));
  assign new_n69_ = ~x17 & ~x19 & new_n70_ & ~x20;
  ...
  assign z09 = (x16 & (new_n76_ | (~new_n71_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n76_ = ~x17 & ~x19 & ~x20 & new_n77_ & ~x21;
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x25 & (x26 | (~x26 & x27));
