...
module FAU ( 
  ...
  assign new_n61_ = ~new_n63_ & (~x23 | (new_n56_ & (new_n62_ | x17)));
  ...
  assign new_n67_ = new_n56_ & (new_n68_ | x17);
  ...
  assign new_n75_ = (~x27 | (~x17 & ~x20 & (new_n76_ | x17))) & (~new_n77_ | ~new_n62_ | x17 | x20);
  assign new_n76_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n77_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~new_n79_ & x16) | x18 | (~x06 & ~x16);
  assign new_n79_ = (~x28 | (new_n80_ & (new_n76_ | x17))) & (~new_n81_ | ~new_n82_);
  assign new_n80_ = ~x17 & ~x19 & ~x20 & ~x27;
  assign new_n81_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = ~new_n88_ | (x16 & (new_n86_ | (x29 & (new_n84_ | ~new_n80_))));
  assign new_n84_ = ~x17 & (~new_n85_ | x21 | x22 | x23);
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x28;
  assign new_n86_ = new_n63_ & ~x24 & ~x25 & ~x26 & new_n87_ & ~x27;
  assign new_n87_ = ~x28 & ~x29;
  assign new_n88_ = ~x18 & (x05 | x16);
  assign z11 = (x16 & (new_n91_ | (~new_n90_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n90_ = new_n80_ & (x17 | (new_n68_ & new_n87_ & ~x25 & ~x26));
  assign new_n91_ = new_n63_ & new_n92_ & ~x24 & ~x25 & ~x26;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n96_ | (~new_n94_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n94_ = new_n80_ & (x17 | (new_n68_ & new_n95_));
  assign new_n95_ = ~x25 & ~x26 & ~x28 & ~x29 & ~x30;
  assign new_n96_ = new_n56_ & new_n68_ & new_n97_ & ~x25 & ~x26 & ~x27;
  assign new_n97_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = ~new_n104_ | (x16 & ((new_n99_ & new_n102_) | (~new_n100_ & x32)));
  assign new_n99_ = new_n56_ & new_n68_;
  assign new_n100_ = new_n80_ & (x17 | (new_n72_ & new_n101_));
  assign new_n101_ = ~x26 & ~x28 & ~x29 & ~x30 & ~x31;
  ...
  assign new_n106_ = x33 & (~new_n80_ | (~x17 & (~new_n72_ | ~new_n107_)));
  assign new_n107_ = ~x26 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n108_ = new_n109_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n109_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = (x16 & (new_n111_ | (new_n69_ & new_n113_))) | x18 | (~x00 & ~x16);
  assign new_n111_ = x34 & (~new_n80_ | (~x17 & (~new_n76_ | ~new_n112_)));
