// Benchmark "FAU" written by ABC on Wed Jul 29 04:08:06 2020
...
module FAU ( 
  ...
  assign new_n84_ = new_n56_ & (x17 | (new_n66_ & new_n85_));
  ...
  assign new_n91_ = new_n56_ & (x17 | (new_n66_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n87_ & new_n88_ & new_n82_ & ~x29 & ~x30;
  ...
  assign new_n110_ = x34 & (~new_n56_ | (~x17 & (~new_n75_ | ~new_n89_ | ~new_n108_)));
