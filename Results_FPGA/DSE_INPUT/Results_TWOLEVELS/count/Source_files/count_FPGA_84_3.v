// Benchmark "FAU" written by ABC on Wed Jul 29 04:07:50 2020
...
module FAU ( 
  ...
  assign new_n69_ = ~x17 & ~x19 & ~x21 & new_n70_ & ~x22;
  assign new_n70_ = ~x23 & ~x24 & ~x25 & ~x26 & (x27 | (~x20 & ~x27));
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n72_ | new_n74_));
  assign new_n72_ = x27 & (~new_n73_ | x23 | x24 | x25 | x26);
  ...
  assign new_n82_ = (~x30 | (new_n61_ & new_n80_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n80_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n85_ | (~new_n84_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n84_ = new_n61_ & new_n80_ & new_n77_ & ~x29 & ~x30;
  assign new_n85_ = new_n56_ & new_n64_ & new_n86_ & ~x25 & ~x26 & ~x27;
  assign new_n86_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n88_ | (~new_n85_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n88_ = new_n56_ & new_n64_ & new_n89_ & new_n77_ & ~x25 & ~x26;
  ...
  assign z15 = ~new_n96_ | (x16 & ((~new_n91_ & x34) | (new_n66_ & new_n95_)));
