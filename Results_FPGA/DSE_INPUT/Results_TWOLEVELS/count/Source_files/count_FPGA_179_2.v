...
module FAU ( 
  ...
  assign z13 = ~new_n88_ | (~x20 & (new_n85_ | (x32 & (~new_n81_ | ~new_n87_))));
  assign new_n85_ = new_n66_ & ~x17 & ~x19 & ~x21 & new_n74_ & new_n86_;
  assign new_n86_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n87_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n88_ = (x02 | x16) & ~x18 & (~x16 | ~x20 | ~x32);
  assign z14 = ~new_n94_ | (x16 & (new_n91_ | (x33 & (~new_n63_ | ~new_n90_))));
  assign new_n90_ = new_n86_ & ~x25 & ~x26 & ~x27 & ~x28;
  ...
  assign new_n96_ = (~x34 | (new_n57_ & new_n66_ & new_n92_ & new_n93_)) & (~new_n92_ | ~new_n97_ | ~new_n57_ | ~new_n66_);
