...
module FAU ( 
  ...
  assign new_n78_ = new_n61_ & new_n69_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z12 = (x16 & (new_n78_ | x31)) | x18 | (~x03 & ~x16);
  assign z13 = (x16 & (new_n81_ | (~new_n78_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n81_ = new_n56_ & new_n64_ & new_n82_ & ~x25 & ~x26 & ~x27;
  assign new_n82_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign z14 = (x16 & (new_n84_ | (~new_n81_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n84_ = new_n56_ & new_n64_ & new_n85_ & new_n86_;
  assign new_n85_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = ~x29 & ~x30 & ~x32 & ~x33;
  assign z15 = ~new_n90_ | (x16 & ((~new_n84_ & x34) | (new_n66_ & new_n88_)));
  assign new_n88_ = new_n89_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n89_ = ~x30 & ~x32 & ~x33 & ~x34;
