...
module FAU ( 
  ...
  assign z10 = (~new_n76_ & ~x20) | (~x05 & ~x16) | x18 | (x16 & x20 & x29);
  assign new_n76_ = (~x29 | (new_n77_ & new_n74_ & ~x24 & ~x25)) & (~new_n77_ | ~new_n78_);
  assign new_n77_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23;
  assign new_n78_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n80_ & x16) | x18 | (~x04 & ~x16);
  assign new_n80_ = (~x30 | (new_n61_ & new_n69_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n69_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n83_ | (~new_n82_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n82_ = new_n61_ & new_n69_ & ~x29 & ~x30 & ~x27 & ~x28;
