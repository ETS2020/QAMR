...
module FAU ( 
  ...
  assign z09 = ~new_n75_ | (x16 & ((~new_n71_ & x28) | (new_n73_ & ~x17)));
  assign new_n73_ = ~x19 & ~x21 & ~x22 & ~x23 & new_n74_ & ~x24;
  assign new_n74_ = ~x25 & ~x26 & ~x27 & ~x28 & (x29 | (~x20 & ~x29));
  assign new_n75_ = ~x18 & (x06 | x16);
  assign z10 = (x16 & (new_n79_ | (~new_n77_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n77_ = new_n78_ & ~x17 & ~x19 & ~x21 & ~x22 & ~x23;
  assign new_n78_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n79_ = new_n61_ & new_n69_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n81_ & x16) | x18 | (~x04 & ~x16);
  assign new_n81_ = (~x30 | (new_n61_ & new_n69_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n69_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n84_ | (~new_n83_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n83_ = new_n61_ & new_n69_ & ~x29 & ~x30 & ~x27 & ~x28;
  ...
  assign z14 = ~new_n93_ | (x16 & ((~new_n87_ & x33) | (new_n66_ & new_n91_)));
  assign new_n91_ = new_n92_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n92_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n93_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n96_ | (x16 & ((new_n66_ & new_n95_) | (x34 & (~new_n66_ | ~new_n91_))));
