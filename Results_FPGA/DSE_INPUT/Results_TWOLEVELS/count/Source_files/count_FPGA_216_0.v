// Benchmark "FAU" written by ABC on Wed Jul 29 04:08:16 2020
...
module FAU ( 
  ...
  assign z05 = (x16 & (new_n62_ | new_n63_)) | x18 | (~x10 & ~x16);
  assign new_n62_ = ~x17 & ~x19 & ~x20 & (x21 | (~x21 & (x22 | (~x22 & x23))));
  assign new_n63_ = x24 & (x17 | x19 | x20);
