// Benchmark "FAU" written by ABC on Wed Jul 29 04:07:41 2020
...
module FAU ( 
  ...
  assign z11 = (x16 & (new_n80_ | (~new_n79_ & x30))) | ~new_n81_ | (~x04 & ~x16);
  assign new_n79_ = new_n77_ & ~x17 & ~x19 & ~x21 & ~x22 & ~x23;
  assign new_n80_ = new_n61_ & new_n69_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n81_ = ~x18 & (~x20 | ~x30);
  assign z12 = (x16 & (new_n83_ | (~new_n80_ & x31))) | x18 | (~x03 & ~x16);
