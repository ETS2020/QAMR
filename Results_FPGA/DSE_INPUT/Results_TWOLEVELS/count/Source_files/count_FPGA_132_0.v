...
module FAU ( 
  ...
  assign z07 = (x16 & (new_n73_ | (new_n71_ & ~x17))) | x18 | (~x08 & ~x16);
  assign new_n71_ = ~x19 & ~x20 & ~x21 & ~x22 & new_n72_ & ~x23;
  assign new_n72_ = ~x24 & ~x25 & ~x26;
  assign new_n73_ = x26 & (~new_n58_ | x22 | x23 | x24 | x25);
  ...
  assign new_n77_ = x27 & (~new_n58_ | ~new_n72_ | x22 | x23);
  ...
  assign new_n81_ = new_n59_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z10 = (~new_n83_ & x16) | x18 | (~x05 & ~x16);
  assign new_n83_ = (~x29 | (new_n59_ & new_n84_)) & (~new_n65_ | ~new_n85_);
  assign new_n84_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n85_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n89_ | (new_n87_ & ~x17))) | x18 | (~x04 & ~x16);
  assign new_n87_ = ~x19 & ~x20 & ~x21 & ~x22 & ~new_n88_ & ~x23;
  assign new_n88_ = ~x24 & (x24 | (~x25 & (x25 | (~x26 & (x26 | (~x27 & (x27 | (~x28 & (x28 | ~x29)))))))));
  assign new_n89_ = ~new_n65_ & x30;
