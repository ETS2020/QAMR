...
module FAU ( 
  ...
  assign new_n90_ = new_n91_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n92_ = ~x18 & (x01 | x16);
  assign z15 = ~new_n99_ | (~x20 & (new_n95_ | (x34 & (~new_n90_ | ~new_n94_))));
  assign new_n94_ = new_n67_ & ~x17 & ~x19 & ~x21;
  assign new_n95_ = new_n96_ & new_n97_ & new_n82_ & new_n98_;
  assign new_n96_ = ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n97_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n98_ = ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n99_ = (x00 | x16) & ~x18 & (~x16 | ~x20 | ~x34);
endmodule
