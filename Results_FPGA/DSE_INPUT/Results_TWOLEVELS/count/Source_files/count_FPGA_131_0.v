...
module FAU ( 
  ...
  assign new_n76_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n77_ = new_n73_ & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z09 = (~new_n79_ & x16) | x18 | (~x06 & ~x16);
  assign new_n79_ = (~x28 | (new_n80_ & new_n82_)) & (~new_n80_ | ~new_n81_ | x26 | x27 | x28);
  assign new_n80_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n81_ = ~x23 & ~x24 & ~x25;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n84_ | (~new_n86_ & x29)));
  assign new_n84_ = ~x17 & ~x19 & ~x20 & (x21 | (~x21 & (x22 | (~new_n85_ & ~x22))));
  assign new_n85_ = ~x23 & (x23 | (~x24 & (x24 | (~x25 & (x25 | (~x26 & (x26 | (~x27 & (x27 | ~x28)))))))));
  assign new_n86_ = ~x17 & ~x19 & ~x20;
