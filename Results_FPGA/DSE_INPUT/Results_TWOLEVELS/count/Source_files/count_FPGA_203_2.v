...
module FAU ( 
  ...
  assign new_n72_ = new_n59_ & ~x23 & ~x24 & new_n73_ & ~x25;
  ...
  assign new_n78_ = new_n61_ & new_n70_ & new_n79_ & ~x27;
  assign new_n79_ = ~x28 & ~x29;
  assign z11 = (~new_n81_ & x16) | x18 | (~x04 & ~x16);
  assign new_n81_ = (~x30 | (new_n61_ & new_n70_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n70_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n84_ | (~new_n83_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n83_ = new_n61_ & new_n70_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n84_ = new_n56_ & new_n64_ & new_n85_ & new_n73_ & ~x25;
  ...
  assign new_n91_ = new_n92_ & new_n73_ & new_n79_;
  assign new_n92_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n93_ = ~x18 & (x01 | x16);
  assign z15 = (x16 & (new_n100_ | (new_n95_ & ~x17))) | x18 | (~x00 & ~x16);
  assign new_n95_ = ~x19 & (x20 | (new_n96_ & new_n97_ & new_n98_ & new_n99_));
  assign new_n96_ = ~x21 & ~x22 & ~x23;
  assign new_n97_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n98_ = ~x28 & ~x29 & ~x30;
  assign new_n99_ = ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n100_ = x34 & (~new_n92_ | ~new_n73_ | ~new_n79_ | ~new_n67_ | ~new_n101_);
  assign new_n101_ = ~x17 & ~x19 & ~x21;
endmodule
