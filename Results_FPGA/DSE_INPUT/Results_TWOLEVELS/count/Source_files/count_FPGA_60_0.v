...
module FAU ( 
  ...
  assign z10 = (x16 & (new_n84_ | (new_n86_ & new_n64_))) | x18 | (~x05 & ~x16);
  assign new_n84_ = x29 & (~new_n82_ | ~new_n85_);
  assign new_n85_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = new_n71_ & ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n90_ | (new_n88_ & ~x17))) | x18 | (~x04 & ~x16);
  assign new_n88_ = ~x19 & ~x20 & (x21 | (~x21 & (x22 | (~x22 & (x23 | (~new_n89_ & ~x23))))));
  assign new_n89_ = ~x24 & (x24 | (~x25 & (x25 | (~x26 & (x26 | (~x27 & (x27 | (~x28 & (x28 | ~x29)))))))));
  assign new_n90_ = x30 & (x17 | x19 | x20);
