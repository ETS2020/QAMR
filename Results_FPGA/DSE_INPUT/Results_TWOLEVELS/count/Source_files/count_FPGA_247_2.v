// Benchmark "FAU" written by ABC on Wed Jul 29 04:08:23 2020
...
module FAU ( 
  ...
  assign z01 = x18 | (~x14 & ~x16) | (x16 & (x17 | (x19 & x20) | (~x19 & ~x20)));
  assign z02 = (x16 & ((x21 & (x19 | x20)) | (~x19 & ~x20 & ~x21))) | x18 | (~x13 & ~x16);
  assign z03 = (x16 & (new_n58_ | (~new_n57_ & x22))) | x18 | (~x12 & ~x16);
  assign new_n57_ = ~x19 & ~x20 & ~x21;
  assign new_n58_ = ~x19 & ~x20 & ~x21 & ~x22;
  assign z04 = (x16 & (new_n60_ | (~new_n58_ & x23))) | x18 | (~x11 & ~x16);
  assign new_n60_ = ~x19 & ~x20 & ~x21 & ~x22 & ~x23;
  assign z05 = (x16 & (new_n62_ | (~new_n60_ & x24))) | x18 | (~x10 & ~x16);
  assign new_n62_ = ~x22 & ~x23 & ~x24 & ~x19 & ~x20 & ~x21;
  ...
  assign new_n67_ = new_n58_ & ~x25 & ~x26 & ~x23 & ~x24;
  ...
  assign new_n72_ = new_n60_ & ~x26 & ~x27 & ~x28 & ~x24 & ~x25;
  assign z10 = (x16 & (new_n74_ | (~new_n72_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n74_ = new_n60_ & new_n75_;
  assign new_n75_ = ~x27 & ~x28 & ~x29 & ~x24 & ~x25 & ~x26;
  ...
  assign new_n89_ = new_n90_ & ~x29 & ~x30 & ~x27 & ~x28;
