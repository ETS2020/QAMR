...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n59_, new_n61_, new_n63_, new_n64_, new_n66_,
    new_n68_, new_n69_, new_n71_, new_n74_, new_n75_, new_n77_, new_n79_,
  ...
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign z11 = (x16 & (new_n77_ | (~new_n74_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n77_ = new_n61_ & new_n69_ & ~x27 & ~x29 & ~x30;
  assign z12 = x18 | (~x03 & ~x16) | (~new_n79_ & x16);
  assign new_n79_ = (~x31 | (new_n61_ & new_n69_ & ~x27 & ~x29 & ~x30)) & (~new_n61_ | ~new_n69_ | x30 | x31 | x27 | x29);
  assign z13 = (x16 & (new_n82_ | (~new_n81_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n81_ = new_n61_ & new_n69_ & ~x30 & ~x31 & ~x27 & ~x29;
