...
module FAU ( 
  ...
  assign new_n61_ = (~x23 | (new_n56_ & (x17 | (~x21 & ~x22)))) & (~new_n56_ | x21 | x22 | x23);
  ...
  assign new_n75_ = (~x27 | (new_n56_ & (new_n76_ | x17))) & (~new_n77_ | ~new_n78_);
  assign new_n76_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n77_ = ~x17 & ~x19 & ~x20 & ~x21 & ~x22;
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (x16 & (new_n80_ | (new_n83_ & new_n77_))) | x18 | (~x06 & ~x16);
  assign new_n80_ = x28 & (~new_n56_ | (~x17 & (~new_n64_ | ~new_n81_ | ~new_n82_)));
  assign new_n81_ = ~x24 & ~x25;
  assign new_n82_ = ~x26 & ~x27;
  assign new_n83_ = ~x26 & ~x27 & ~x28 & new_n81_ & ~x23;
  assign z10 = (~new_n85_ & ~x19) | (~x05 & ~x16) | x18 | (x16 & x19 & x29);
  assign new_n85_ = (~x29 | (new_n87_ & new_n88_)) & (~new_n87_ | ~new_n86_ | ~new_n89_);
  assign new_n86_ = ~x24 & ~x25 & ~x26;
  assign new_n87_ = ~x17 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n88_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n89_ = ~x27 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n92_ | (~new_n91_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n91_ = new_n56_ & (x17 | (new_n65_ & new_n89_ & ~x25 & ~x26));
  assign new_n92_ = new_n56_ & new_n64_ & new_n86_ & new_n93_ & ~x27 & ~x28;
  assign new_n93_ = ~x29 & ~x30;
  assign z12 = (x16 & (new_n96_ | (~new_n95_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n95_ = new_n56_ & (x17 | (new_n72_ & new_n82_ & new_n93_ & ~x28));
  assign new_n96_ = new_n56_ & new_n65_ & new_n97_ & new_n82_ & ~x25;
  ...
  assign new_n100_ = new_n56_ & (x17 | (new_n72_ & new_n101_));
  ...
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n106_ | new_n108_));
  assign new_n106_ = x33 & (~new_n56_ | (~x17 & (~new_n76_ | ~new_n107_)));
  assign new_n107_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n108_ = new_n57_ & new_n69_ & new_n109_ & new_n110_;
  assign new_n109_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n112_ | (new_n68_ & new_n113_)));
  assign new_n112_ = x34 & (~new_n56_ | (~x17 & (~new_n76_ | ~new_n89_ | ~new_n110_)));
