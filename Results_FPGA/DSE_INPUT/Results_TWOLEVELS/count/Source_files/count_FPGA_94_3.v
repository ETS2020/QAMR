...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n59_, new_n61_, new_n63_, new_n65_, new_n66_,
    ...
    new_n89_, new_n90_, new_n92_, new_n93_, new_n94_, new_n95_;
  ...
  assign new_n84_ = new_n63_ & new_n85_ & ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n85_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = ~new_n90_ | (x16 & ((~new_n84_ & x33) | (new_n87_ & ~x17)));
  assign new_n87_ = ~x19 & ~x21 & ~x22 & ~x23 & new_n88_ & ~x24;
  assign new_n88_ = ~x25 & ~x26 & ~x27 & ~x28 & new_n89_ & ~x29;
  assign new_n89_ = ~x30 & ~x31 & ~x32 & ~x33 & (x34 | (~x20 & ~x34));
  assign new_n90_ = ~x18 & (x01 | x16);
  assign z15 = (x16 & (new_n92_ | (new_n65_ & new_n95_))) | x18 | (~x00 & ~x16);
  assign new_n92_ = x34 & (~new_n93_ | ~new_n66_ | x17 | x19 | x21);
  assign new_n93_ = new_n94_ & ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n94_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = new_n94_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
