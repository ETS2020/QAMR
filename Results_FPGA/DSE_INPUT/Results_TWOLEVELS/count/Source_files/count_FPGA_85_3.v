...
module FAU ( 
  ...
  assign new_n69_ = new_n59_ & new_n70_ & ~x23 & ~x24;
  ...
  assign new_n78_ = (new_n75_ | ~x30) & (x17 | x19 | ~new_n79_ | x21);
  assign new_n79_ = ~x22 & ~x23 & ~x24 & ~x25 & new_n80_ & ~x26;
  assign new_n80_ = ~x27 & ~x28 & ~x29 & ~x30 & (x31 | (~x20 & ~x31));
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n82_ | new_n84_));
  assign new_n82_ = new_n63_ & new_n70_ & new_n83_ & ~x28 & ~x29;
  assign new_n83_ = ~x30 & ~x31;
  assign new_n84_ = x31 & (~new_n85_ | ~new_n70_ | x28 | x29 | x30);
  assign new_n85_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z13 = (x16 & (new_n87_ | (~new_n82_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n87_ = new_n63_ & new_n88_ & ~x27 & ~x28 & ~x25 & ~x26;
  assign new_n88_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n90_ | (~new_n87_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n90_ = new_n65_ & new_n91_ & new_n83_ & ~x32 & ~x33;
  assign new_n91_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z15 = (~new_n93_ & x16) | x18 | (~x00 & ~x16);
  assign new_n93_ = (~x34 | (new_n65_ & new_n91_ & new_n83_ & ~x32 & ~x33)) & (~new_n65_ | ~new_n91_ | ~new_n83_ | x32 | x33 | x34);
endmodule
