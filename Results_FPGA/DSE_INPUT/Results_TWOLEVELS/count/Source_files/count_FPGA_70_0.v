...
module FAU ( 
  ...
  assign new_n65_ = (x17 | x19 | ~new_n67_ | x20) & (~x25 | (new_n66_ & ~x17 & ~x19 & ~x20));
  assign new_n66_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n67_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (~new_n69_ & x16) | x18 | (~x08 & ~x16);
  assign new_n69_ = (~x26 | (new_n57_ & new_n70_ & ~x24 & ~x25)) & (~new_n57_ | ~new_n70_ | x24 | x25 | x26);
  assign new_n70_ = ~x22 & ~x23;
  assign z08 = (~new_n72_ & x16) | x18 | (~x07 & ~x16);
  assign new_n72_ = (~x27 | (new_n57_ & new_n70_ & ~x24 & ~x25)) & (~new_n57_ | ~new_n70_ | x24 | x25 | ~x26);
