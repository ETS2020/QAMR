...
module FAU ( 
  ...
  assign z09 = (x16 & (new_n72_ | (~new_n68_ & x28))) | x18 | (~x06 & ~x16);
  assign new_n72_ = new_n59_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x28;
  assign z10 = (x16 & (new_n74_ | (~new_n72_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n74_ = new_n59_ & new_n75_;
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x28 & ~x29;
  assign z11 = (x16 & (new_n77_ | (~new_n74_ & x30))) | x18 | (~x04 & ~x16);
  assign new_n77_ = new_n61_ & new_n69_ & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x03 & ~x16) | (~new_n79_ & x16);
  assign new_n79_ = (~x31 | (new_n61_ & new_n69_ & ~x28 & ~x29 & ~x30)) & (~new_n61_ | ~new_n69_ | x30 | x31 | x28 | x29);
  assign z13 = (x16 & (new_n82_ | (~new_n81_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n81_ = new_n61_ & new_n69_ & ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n82_ = new_n56_ & new_n64_ & new_n83_ & ~x25 & ~x26 & ~x28;
  ...
  assign new_n86_ = ~x25 & ~x26 & ~x28 & ~x29;
  assign new_n87_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n91_ | (x16 & ((~new_n85_ & x34) | (new_n66_ & new_n89_)));
  assign new_n89_ = new_n90_ & ~x26 & ~x28 & ~x29 & ~x30;
