...
module FAU ( 
  ...
  assign z12 = ~new_n85_ | (x16 & (new_n81_ | (x31 & (~new_n83_ | ~new_n84_))));
  assign new_n81_ = new_n56_ & new_n64_ & new_n82_ & ~x25 & ~x26 & ~x27;
  assign new_n82_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n83_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n84_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n85_ = (x03 | x16) & ~x18 & (~x20 | ~x31);
  assign z13 = (x16 & (new_n87_ | (~new_n81_ & x32))) | x18 | (~x02 & ~x16);
