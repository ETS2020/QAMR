...
module FAU ( 
  ...
  assign z06 = (~new_n65_ & x16) | x18 | (~x09 & ~x16);
  assign new_n65_ = (x19 | ((new_n66_ | ~x25) & (x17 | ~new_n67_ | x20))) & (~x25 | (~x17 & ~x19 & ~x20));
  assign new_n66_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n67_ = ~x21 & ~x22 & ~x23 & ~x24 & (x26 | (~x25 & ~x26));
  assign z07 = (~new_n69_ & x16) | x18 | (~x08 & ~x16);
  assign new_n69_ = (~x26 | (new_n56_ & (new_n66_ | x19))) & (~new_n57_ | ~new_n70_);
  assign new_n70_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (~new_n72_ & x16) | x18 | (~x07 & ~x16);
  assign new_n72_ = (~x27 | (new_n56_ & (new_n73_ | x19))) & (~new_n74_ | ~new_n75_);
  ...
  assign new_n77_ = new_n56_ & (x19 | (new_n78_ & ~x21 & ~x22 & ~x23));
  ...
  assign new_n88_ = new_n56_ & (x19 | (new_n66_ & new_n85_ & ~x25 & ~x26));
  assign new_n89_ = new_n86_ & new_n90_ & ~x24 & ~x25 & ~x26;
  assign new_n90_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = (x16 & (new_n95_ | (~new_n92_ & x31))) | x18 | (~x03 & ~x16);
  assign new_n92_ = new_n56_ & (x19 | (new_n93_ & new_n94_));
  ...
  assign new_n98_ = x32 & (~new_n56_ | (~x19 & (~new_n93_ | ~new_n99_)));
  assign new_n99_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n100_ = new_n83_ & new_n101_ & new_n56_ & new_n66_;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n103_ | (new_n105_ & new_n106_))) | x18 | (~x01 & ~x16);
  assign new_n103_ = x33 & (~new_n56_ | (~x19 & (~new_n73_ | ~new_n104_)));
  assign new_n104_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n105_ = new_n57_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n106_ = new_n107_ & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x00 & ~x16) | (x16 & (new_n109_ | (new_n105_ & new_n110_)));
  assign new_n109_ = x34 & (~new_n56_ | (~x19 & (~new_n73_ | ~new_n85_ | ~new_n107_)));
