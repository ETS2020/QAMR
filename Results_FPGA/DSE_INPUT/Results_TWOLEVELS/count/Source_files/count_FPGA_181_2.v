// Benchmark "FAU" written by ABC on Wed Jul 29 04:08:09 2020
...
module FAU ( 
  ...
  assign new_n74_ = new_n59_ & new_n75_ & ~x23 & ~x24 & ~x25;
  assign new_n75_ = ~x26 & ~x27 & ~x28;
  assign z10 = (x16 & (new_n77_ | (~new_n74_ & x29))) | x18 | (~x05 & ~x16);
  assign new_n77_ = new_n61_ & new_n71_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n79_ & x16) | x18 | (~x04 & ~x16);
  assign new_n79_ = (~x30 | (new_n61_ & new_n71_ & ~x27 & ~x28 & ~x29)) & (~new_n61_ | ~new_n71_ | x29 | x30 | x27 | x28);
  assign z12 = (x16 & (new_n81_ | (new_n63_ & new_n83_))) | x18 | (~x03 & ~x16);
  ...
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n86_ | (~new_n89_ & x32)));
  assign new_n86_ = ~x17 & ~x19 & (x20 | (new_n87_ & new_n88_));
  assign new_n87_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n88_ = ~x27 & ~x28 & ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n89_ = new_n90_ & new_n84_ & ~x25 & ~x26 & ~x27;
  assign new_n90_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z14 = (x16 & (new_n94_ | (~new_n92_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n92_ = new_n75_ & new_n93_ & new_n66_ & ~x17 & ~x19 & ~x21;
  assign new_n93_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n94_ = new_n95_ & new_n96_ & new_n66_ & ~x17 & ~x19 & ~x21;
  assign new_n95_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n96_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n101_ | (x16 & ((~new_n94_ & x34) | (new_n98_ & new_n100_)));
  assign new_n98_ = new_n99_ & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n99_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n100_ = new_n82_ & ~x31 & ~x32 & ~x33 & ~x34;
