...
module FAU ( 
  ...
  assign z08 = (x16 & (new_n71_ | new_n73_)) | ~new_n74_ | (~x07 & ~x16);
  assign new_n71_ = x27 & (~new_n72_ | x23 | x24 | x25 | x26);
  assign new_n72_ = ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n73_ = new_n59_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n74_ = ~x18 & (~x20 | ~x27);
