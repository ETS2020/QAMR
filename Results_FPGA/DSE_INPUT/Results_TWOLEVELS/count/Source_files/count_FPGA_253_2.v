...
module FAU ( 
  ...
  assign new_n78_ = new_n61_ & new_n71_ & new_n79_;
  assign new_n79_ = ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n81_ & x16) | x18 | (~x04 & ~x16);
  assign new_n81_ = (~x30 | (new_n61_ & new_n71_ & new_n79_)) & (~new_n61_ | ~new_n71_ | ~new_n82_);
  assign new_n82_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = ~new_n86_ | (x16 & ((~new_n84_ & x31) | (new_n63_ & new_n85_)));
  assign new_n84_ = new_n61_ & new_n71_ & new_n82_;
  assign new_n85_ = new_n73_ & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n86_ = ~x18 & (x03 | x16);
  assign z13 = ~new_n90_ | (x16 & ((new_n63_ & new_n88_) | (x32 & (~new_n63_ | ~new_n85_))));
  assign new_n88_ = new_n89_ & new_n76_ & ~x25 & ~x26;
  assign new_n89_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n90_ = ~x18 & (x02 | x16);
  assign z14 = ~new_n98_ | (x16 & (new_n92_ | (x33 & (~new_n95_ | ~new_n97_))));
  assign new_n92_ = ~x17 & ~x19 & (x20 | (new_n93_ & new_n79_ & new_n94_));
  assign new_n93_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n94_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n95_ = new_n66_ & new_n96_;
  assign new_n96_ = ~x17 & ~x19 & ~x21;
  assign new_n97_ = new_n89_ & new_n76_ & ~x26;
  assign new_n98_ = ~x18 & (x01 | x16);
  assign z15 = (x16 & (new_n100_ | (new_n102_ & new_n104_))) | x18 | (~x00 & ~x16);
  assign new_n100_ = x34 & (~new_n94_ | ~new_n101_ | ~new_n66_ | ~new_n96_);
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n102_ = new_n103_ & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n103_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n104_ = new_n82_ & ~x31 & ~x32 & ~x33 & ~x34;
endmodule
