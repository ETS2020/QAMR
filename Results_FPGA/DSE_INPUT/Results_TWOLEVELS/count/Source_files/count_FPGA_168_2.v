// Benchmark "FAU" written by ABC on Wed Jul 29 04:08:07 2020
...
module FAU ( 
  ...
  assign new_n68_ = (~x26 | (new_n57_ & ~x22 & ~x23 & ~x24 & ~x25)) & (~new_n57_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = (x16 & (new_n72_ | (~new_n70_ & x27))) | x18 | (~x07 & ~x16);
  ...
  assign new_n75_ = new_n59_ & new_n76_ & ~x23 & ~x24 & ~x25;
  ...
  assign z12 = x18 | (~x03 & ~x16) | (x16 & (new_n82_ | new_n85_));
  assign new_n82_ = ~x17 & ~x19 & (x20 | (new_n83_ & new_n84_));
  assign new_n83_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n84_ = ~x26 & ~x27 & ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n85_ = x31 & (~new_n86_ | ~new_n73_ | x28 | x29 | x30);
  assign new_n86_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z13 = (x16 & (new_n89_ | (~new_n88_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n88_ = new_n86_ & new_n73_ & ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n89_ = new_n66_ & ~x17 & ~x19 & ~x21 & new_n76_ & new_n90_;
  assign new_n90_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = (x16 & (new_n92_ | (~new_n89_ & x33))) | x18 | (~x01 & ~x16);
  assign new_n92_ = new_n66_ & ~x17 & ~x19 & ~x21 & new_n93_ & new_n94_;
  assign new_n93_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n94_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n100_ | (x16 & ((~new_n92_ & x34) | (new_n96_ & new_n98_)));
  assign new_n96_ = new_n97_ & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n97_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n98_ = new_n99_ & ~x31 & ~x32 & ~x33 & ~x34;
