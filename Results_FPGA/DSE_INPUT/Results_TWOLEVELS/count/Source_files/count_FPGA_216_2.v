...
module FAU ( 
  ...
  assign new_n64_ = ~x19 & (x20 | (~x23 & ~x24 & ~x21 & ~x22));
  assign z06 = (x16 & (new_n66_ | (~new_n69_ & x25))) | x18 | (~x09 & ~x16);
  ...
  assign z07 = x18 | (~x08 & ~x16) | (x16 & (new_n71_ | (~new_n66_ & x26)));
  assign new_n71_ = new_n72_ & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n72_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n74_ | (~new_n71_ & x27)));
  assign new_n74_ = new_n75_ & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n75_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n77_ | (~new_n74_ & x28)));
  assign new_n77_ = new_n63_ & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  ...
  assign new_n82_ = new_n69_ & new_n83_ & ~x28 & ~x29 & ~x30;
  assign new_n83_ = ~x25 & ~x26 & ~x27;
  assign z12 = (~new_n85_ & x16) | x18 | (~x03 & ~x16);
  assign new_n85_ = (~x31 | (new_n69_ & new_n83_ & ~x28 & ~x29 & ~x30)) & (~new_n69_ | ~new_n83_ | x30 | x31 | x28 | x29);
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n88_ | (~new_n87_ & x32)));
  assign new_n87_ = new_n69_ & new_n83_ & ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n88_ = new_n67_ & new_n68_ & new_n89_ & ~x26 & ~x27 & ~x28;
  assign new_n89_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n91_ | (~new_n88_ & x33)));
  assign new_n91_ = new_n67_ & new_n68_ & new_n92_ & new_n93_;
  assign new_n92_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n93_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n97_ | (x16 & ((~new_n91_ & x34) | (new_n71_ & new_n95_)));
  assign new_n95_ = new_n96_ & ~x27 & ~x28 & ~x29 & ~x30;
