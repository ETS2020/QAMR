// Benchmark "FAU" written by ABC on Wed Jul 29 04:07:58 2020
...
module FAU ( 
  ...
  assign new_n56_ = (x17 | x19 | x21 | (~x22 & (x20 | x22))) & (~x21 | (~x17 & ~x19 & ~x20));
  assign z03 = (~new_n58_ & x16) | x18 | (~x12 & ~x16);
  assign new_n58_ = (~x22 | (~x17 & ~x19 & ~x21)) & (x17 | x19 | x20 | x21 | x22);
  ...
  assign new_n70_ = new_n68_ & new_n71_ & ~x22 & ~x23;
  assign new_n71_ = ~x24 & ~x25 & ~x26;
  assign z08 = (x16 & (new_n73_ | (~new_n70_ & x27))) | x18 | (~x07 & ~x16);
  assign new_n73_ = new_n60_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  ...
  assign new_n82_ = new_n61_ & new_n71_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n83_ = new_n64_ & new_n65_ & new_n84_ & ~x25 & ~x26 & ~x27;
  assign new_n84_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = (x16 & (new_n86_ | (~new_n83_ & x32))) | x18 | (~x02 & ~x16);
  assign new_n86_ = new_n64_ & new_n65_ & new_n87_ & new_n88_;
