...
module FAU ( 
  ...
  assign z12 = (~new_n82_ & ~x20) | (~x03 & ~x16) | x18 | (x16 & x20 & x31);
  assign new_n82_ = (~x31 | (new_n83_ & new_n73_ & ~x28 & ~x29 & ~x30)) & (~new_n83_ | ~new_n73_ | x30 | x31 | x28 | x29);
  assign new_n83_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z13 = ~new_n89_ | (x16 & (new_n86_ | (x32 & (~new_n63_ | ~new_n85_))));
  ...
  assign z14 = (x16 & (new_n91_ | (~new_n86_ & x33))) | x18 | (~x01 & ~x16);
