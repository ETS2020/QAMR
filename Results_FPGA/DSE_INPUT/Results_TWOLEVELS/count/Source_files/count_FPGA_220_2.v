// Benchmark "FAU" written by ABC on Wed Jul 29 04:08:17 2020
...
module FAU ( 
  ...
  assign new_n62_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x21 | x22 | x23 | x24);
  assign new_n63_ = ~x17 & ~x19 & ~x20;
  assign z06 = (~new_n65_ & x16) | x18 | (~x09 & ~x16);
  assign new_n65_ = (x17 | x19 | (~new_n66_ & ~x20)) & (new_n67_ | ~x25);
  assign new_n66_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n67_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z07 = (x16 & (new_n69_ | new_n72_)) | x18 | (~x08 & ~x16);
  assign new_n69_ = x26 & (~new_n70_ | ~new_n71_);
  assign new_n70_ = ~x17 & ~x19 & ~x21;
  assign new_n71_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n72_ = new_n73_ & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n73_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x07 & ~x16) | (x16 & (new_n75_ | (~new_n72_ & x27)));
  assign new_n75_ = new_n76_ & ~x17 & ~x19 & ~x21 & ~x22;
  assign new_n76_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x06 & ~x16) | (x16 & (new_n78_ | (~new_n75_ & x28)));
  assign new_n78_ = new_n79_ & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n79_ = ~x17 & ~x19 & ~x21 & ~x22 & ~x23;
  assign z10 = x18 | (~x05 & ~x16) | (x16 & (new_n81_ | (~new_n78_ & x29)));
  assign new_n81_ = new_n79_ & new_n82_;
  assign new_n82_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~x04 & ~x16) | (x16 & (new_n84_ | (~new_n81_ & x30)));
  assign new_n84_ = new_n67_ & new_n85_ & ~x28 & ~x29 & ~x30;
  assign new_n85_ = ~x25 & ~x26 & ~x27;
  assign z12 = (~new_n87_ & x16) | x18 | (~x03 & ~x16);
  assign new_n87_ = (~x31 | (new_n67_ & new_n85_ & ~x28 & ~x29 & ~x30)) & (~new_n67_ | ~new_n85_ | x30 | x31 | x28 | x29);
  assign z13 = x18 | (~x02 & ~x16) | (x16 & (new_n90_ | (~new_n89_ & x32)));
  assign new_n89_ = new_n67_ & new_n85_ & ~x30 & ~x31 & ~x28 & ~x29;
  assign new_n90_ = new_n70_ & new_n71_ & new_n91_ & ~x26 & ~x27 & ~x28;
  assign new_n91_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x01 & ~x16) | (x16 & (new_n93_ | (~new_n90_ & x33)));
  assign new_n93_ = new_n70_ & new_n71_ & new_n94_ & new_n95_;
  assign new_n94_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n95_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = ~new_n99_ | (x16 & ((~new_n93_ & x34) | (new_n72_ & new_n97_)));
  assign new_n97_ = new_n98_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n98_ = ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n99_ = ~x18 & (x00 | x16);
endmodule
