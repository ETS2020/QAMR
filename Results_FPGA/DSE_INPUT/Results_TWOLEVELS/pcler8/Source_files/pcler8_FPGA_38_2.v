...
module FAU ( 
  ...
  assign new_n61_ = (x08 | ~x20 | (x19 & (~new_n59_ | ~new_n58_ | ~x12))) & (~x19 | x20);
  assign z11 = z03 | (new_n63_ & x09);
  assign new_n63_ = ~x10 & ((~x08 & ((x21 & (new_n64_ | ~x19)) | (x19 & x20 & ~x21))) | (~x20 & x21));
  ...
  assign new_n69_ = (~x23 | (~new_n70_ & x22 & x19 & x21)) & (~x21 | ~x22 | x23 | ~x19 | ~x20);
  assign new_n70_ = x15 & x24 & x25 & x26;
  assign new_n71_ = ~x20 & x23;
  assign z14 = z06 | (x09 & ~x10 & (new_n73_ | (~x20 & x24)));
  assign new_n73_ = ~x08 & (new_n75_ | (x24 & (~new_n74_ | ~x19 | ~x21)));
  assign new_n74_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n75_ = x22 & x23 & ~x24 & x19 & x20 & x21;
  assign z15 = z07 | (x09 & ~x10 & (new_n77_ | (~x20 & x25)));
  assign new_n77_ = ~x08 & ((new_n78_ & new_n81_) | (x25 & (~new_n79_ | ~new_n80_)));
  assign new_n78_ = x19 & x20 & x21;
  assign new_n79_ = x19 & x21 & x22;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (x09 & ~x10 & (new_n83_ | (~x20 & x26)));
  assign new_n83_ = ~x08 & ((new_n86_ & new_n87_) | (x26 & (~new_n84_ | ~new_n85_)));
