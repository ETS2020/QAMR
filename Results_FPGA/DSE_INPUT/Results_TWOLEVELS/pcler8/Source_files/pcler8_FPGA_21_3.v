// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:04 2020
...
module FAU ( 
  ...
  assign z13 = x08 ? x04 : (new_n69_ & x09);
  assign new_n69_ = ~x10 & ((x23 & (~x19 | ~x20 | ~x21 | ~x22)) | (x19 & x20 & x21 & x22 & ~x23));
  ...
  assign new_n75_ = (~x25 | (new_n72_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n72_ | ~new_n63_ | ~x24 | x25);
  assign z16 = x08 ? x07 : (new_n77_ & x09);
  assign new_n77_ = ~x10 & ((new_n78_ & new_n81_) | (x26 & (~new_n79_ | ~new_n80_)));
