...
module FAU ( 
  ...
  assign new_n57_ = (x19 | (~x22 & ~x25)) & (~new_n59_ | ~new_n58_ | ~x21 | ~x22);
  ...
  assign new_n63_ = (~x21 | (~new_n64_ & x19 & (x20 | (~x22 & ~x25)))) & (~x19 | ~x20 | x21);
  assign new_n64_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = x08 ? x03 : (new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x21 & ((~x20 & x22) | (x19 & x20 & ~x22))) | (x22 & (~x19 | new_n67_ | ~x21)));
  ...
  assign new_n76_ = (~x21 | ((x20 | ~x25) & (~x19 | new_n77_ | ~x20))) & (~x25 | (new_n78_ & x19 & x21));
