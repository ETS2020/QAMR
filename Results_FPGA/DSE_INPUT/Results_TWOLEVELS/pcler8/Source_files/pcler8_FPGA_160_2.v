// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:38 2020
...
module FAU ( 
  ...
  assign new_n57_ = x11 & x20 & x21 & new_n58_ & x23 & x24;
  assign new_n58_ = x25 & x26;
  assign z10 = x08 ? x01 : (x09 & ~new_n60_ & ~x10);
  assign new_n60_ = x20 ? (x19 & (~new_n61_ | ~x12 | ~x21 | ~x23)) : ~x19;
  assign new_n61_ = x24 & x25 & x26;
  assign z11 = x08 ? x02 : (x09 & ~new_n63_ & ~x10);
  assign new_n63_ = (~x21 | (x19 & x20 & (~new_n61_ | ~x13 | ~x23))) & (~x19 | ~x20 | x21);
  assign z12 = x08 ? x03 : (new_n65_ & x09);
  assign new_n65_ = ~x10 & (x20 ? (~x19 | new_n66_ | (x19 & ~x21)) : x22);
  assign new_n66_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = x08 ? x04 : (x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (~x23 | (new_n69_ & x21 & (~new_n58_ | ~x15 | ~x24))) & (~new_n69_ | ~x21 | x23);
  assign new_n69_ = x19 & x20;
  assign z14 = x08 ? x05 : (x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x24 | (new_n69_ & x21 & x23 & (~new_n58_ | ~x16))) & (~new_n69_ | ~x21 | ~x23 | x24);
