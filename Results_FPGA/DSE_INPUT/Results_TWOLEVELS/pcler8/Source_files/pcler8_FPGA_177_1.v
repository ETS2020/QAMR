// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:44 2020
...
module FAU ( 
  ...
  assign new_n72_ = (~x19 | ~x20 | ~new_n73_ | ~x21) & (~x24 | (x19 & x20 & new_n63_ & x21));
  assign new_n73_ = x22 & x23 & (~x24 | (x24 & x25 & x26));
  assign z15 = x08 ? x06 : (x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x25 | (new_n76_ & new_n63_ & x24 & (~x17 | ~x26))) & (~new_n76_ | ~new_n63_ | ~x24 | x25);
