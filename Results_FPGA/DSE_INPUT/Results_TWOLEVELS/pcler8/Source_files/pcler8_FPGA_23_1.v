...
module FAU ( 
  ...
  assign new_n72_ = (~x24 | (new_n73_ & x19 & x20)) & (~new_n74_ | ~x19 | ~x20 | ~x21);
  assign new_n73_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n74_ = x22 & x23 & ~x24;
  assign z15 = x08 ? x06 : (x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (~new_n77_ | ~x23 | ~x24 | x25) & (~x25 | (new_n77_ & x23 & x24 & (~x17 | ~x26)));
  assign new_n77_ = x19 & x20 & x22;
  assign z16 = x08 ? x07 : (x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (~x26 | (new_n80_ & new_n67_ & ~x18)) & (~new_n77_ | ~new_n81_);
