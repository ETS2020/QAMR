// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:34 2020
...
module FAU ( 
  ...
  assign new_n58_ = x19 & x20 & x21 & x22;
  assign new_n59_ = x23 & x24 & x25 & x26;
  assign z10 = x08 ? x01 : (x09 & ~new_n61_ & ~x10);
  ...
  assign z12 = x08 ? x03 : (x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x22 | (new_n68_ & x21 & (~new_n65_ | ~x14 | ~x23))) & (~new_n68_ | ~x21 | x22);
  assign new_n68_ = x19 & x20;
  assign z13 = x08 ? x04 : (x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x23 | (new_n68_ & x21 & ~new_n71_ & x22)) & (~new_n68_ | ~x21 | ~x22 | x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = x08 ? x05 : (x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x24 | (new_n75_ & x22 & x23 & (~new_n74_ | ~x16))) & (~new_n75_ | ~x22 | ~x23 | x24);
  assign new_n74_ = x25 & x26;
  assign new_n75_ = x19 & x20 & x21;
  assign z15 = x08 ? x06 : (x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x25 | (new_n75_ & new_n64_ & x24 & (~x17 | ~x26))) & (~new_n75_ | ~new_n64_ | ~x24 | x25);
  assign z16 = x08 ? x07 : (new_n79_ & x09);
  assign new_n79_ = ~x10 & ((new_n58_ & new_n82_) | (x26 & (~new_n80_ | ~new_n81_)));
