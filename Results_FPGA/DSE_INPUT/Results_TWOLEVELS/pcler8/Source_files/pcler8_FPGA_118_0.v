// Benchmark "FAU" written by ABC on Wed Jul 29 03:58:23 2020
...
module FAU ( 
  ...
  assign z15 = (x06 & x08) | (x09 & ~x10 & (new_n79_ | (~new_n75_ & ~x08)));
  assign new_n75_ = (~new_n72_ | ~new_n78_) & (~x25 | (new_n76_ & new_n77_));
  assign new_n76_ = x19 & x21 & x22;
  assign new_n77_ = x23 & x24 & (~x17 | ~x26);
  assign new_n78_ = x22 & x23 & x24 & ~x25;
  assign new_n79_ = ~x20 & x25;
  assign z16 = x08 ? x07 : (new_n81_ & x09);
