...
module FAU ( 
  ...
  assign z14 = x08 ? x05 : (new_n71_ & x09);
  assign new_n71_ = ~x10 & ((x24 & (~new_n72_ | ~x22 | new_n73_ | ~x23)) | (new_n72_ & x22 & x23 & ~x24));
  assign new_n72_ = x19 & x20 & x21;
  assign new_n73_ = x16 & x25 & x26;
  assign z15 = x08 ? x06 : (x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x19 | ~x20 | ~new_n76_ | ~x21) & (~x25 | (new_n77_ & x19 & x20 & x21));
  assign new_n76_ = x22 & x23 & x24 & (~x25 | (x25 & x26));
