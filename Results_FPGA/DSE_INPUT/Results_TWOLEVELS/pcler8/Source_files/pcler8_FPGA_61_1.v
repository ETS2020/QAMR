...
module FAU ( 
  ...
  assign new_n57_ = new_n58_ & x11 & x21 & x22;
  assign new_n58_ = x23 & x24 & x25 & x26;
  assign z10 = x08 ? x01 : (x09 & ~new_n60_ & ~x10);
  assign new_n60_ = (x19 | ~x20) & (~x19 | x20) & (~new_n58_ | ~x12 | ~x21 | ~x22);
  ...
  assign new_n68_ = (~x23 | (x19 & x21 & ~new_n69_ & x22)) & (~x19 | ~x20 | ~x21 | ~x22 | x23);
  assign new_n69_ = x15 & x24 & x25 & x26;
  assign z14 = x08 ? x05 : (x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (~x24 | (new_n73_ & x22 & x23 & (~new_n72_ | ~x16))) & (~new_n73_ | ~x22 | ~x23 | x24);
  ...
  assign new_n78_ = (~new_n76_ | ~new_n80_) & (~x26 | (new_n79_ & new_n73_ & ~x18));
