// Benchmark "FAU" written by ABC on Wed Jul 29 15:33:30 2020
...
module FAU ( 
  ...
  assign new_n241_ = ~x069 & (x109 | x117 | (~x061 & (x101 | x125)));
  assign new_n242_ = x117 & (~x037 | (~x109 & x125));
  assign new_n243_ = ~x037 & (x109 | (~x093 & x101));
  assign new_n244_ = ~x085 & (x021 | x117 | ~x125);
  assign new_n245_ = ~x093 & x125;
  ...
  assign z14 = ~x046 & ((~new_n253_ & x006) | ~new_n266_ | (~new_n261_ & ~x078));
  ...
  assign new_n261_ = (new_n262_ | ~x070) & (x086 | (~new_n265_ & (new_n263_ | x054)));
  assign new_n262_ = (x038 | (~x022 & (~x030 | x054 | x086))) & (x054 | new_n201_ | x086);
  assign new_n263_ = (~new_n264_ | ~x030) & ((~x110 & ~x118) | (~x022 & (new_n203_ | ~x030)));
  assign new_n264_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n265_ = x038 & (~new_n201_ | (x030 & (~x014 | ~x022)));
  assign new_n266_ = (new_n267_ | ~x014) & (~x038 | ~x054) & (x014 | ~x022 | x054 | ~x070);
  assign new_n267_ = ~x078 & (x054 | x086 | (~x110 & ~x118));
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
