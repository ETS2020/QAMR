// Benchmark "FAU" written by ABC on Wed Jul 29 15:31:32 2020
...
module FAU ( 
  ...
  assign new_n211_ = ~x088 & ((~x032 & x096) | (~x064 & x120));
  assign new_n212_ = (x104 | x112) & (~x032 | ~x064);
  assign new_n213_ = x120 & (x112 ? ~x104 : ~x016);
  assign new_n214_ = ~x080 & (x056 | x064 | ~x096);
  ...
  assign new_n248_ = ~x077 & ((new_n249_ & x029) | (x069 & (~new_n184_ | (~x021 & x029))));
