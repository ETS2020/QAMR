// Benchmark "FAU" written by ABC on Wed Jul 29 15:33:02 2020
...
module FAU ( 
  ...
  assign new_n209_ = (x072 | (~new_n210_ & (~new_n216_ | x008 | ~x032))) & (x008 | x032 | ~x080);
  assign new_n210_ = ~x048 & (new_n211_ | new_n212_ | new_n213_ | new_n214_ | ~new_n215_);
  assign new_n211_ = (~x008 | ~x016) & (x024 | x056 | x088);
  assign new_n212_ = ~x056 & ((~x064 & x096) | (x088 & x120));
  assign new_n213_ = ~x088 & ((~x032 & x096) | (~x064 & x120));
  assign new_n214_ = (x104 | x112) & (~x032 | ~x064);
  assign new_n215_ = ~x080 & (x016 | x112 | ~x120);
  assign new_n216_ = ~x104 & x120;
  ...
  assign new_n247_ = ~new_n251_ & (x053 | (~new_n249_ & (new_n248_ | (~x109 & ~x117))));
  assign new_n248_ = ~x013 & (x077 | (~x021 & (new_n186_ | ~x029)));
  assign new_n249_ = ~x077 & ((new_n250_ & x029) | (x069 & (~new_n184_ | (~x021 & x029))));
  assign new_n250_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n251_ = x037 & ~x077 & (~new_n184_ | (x029 & (~x013 | ~x021)));
  assign new_n252_ = (~x021 | ~x069 | ((x013 | x053) & (x037 | x077))) & (~x037 | ~x053) & (~x013 | ~x077);
  assign z14 = ~x046 & ((~new_n254_ & x006) | ~new_n267_ | (~new_n262_ & ~x086));
  assign new_n254_ = (x014 | x038 | ~x086) & (x054 | (~new_n255_ & (~new_n261_ | ~x014 | x038)));
  ...
  assign new_n263_ = ~x014 & (x078 | (~x022 & (new_n201_ | ~x030)));
  assign new_n264_ = ~x078 & ((new_n265_ & x030) | (x070 & (~new_n203_ | (~x022 & x030))));
  assign new_n265_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n266_ = x038 & ~x078 & (~new_n203_ | (x030 & (~x014 | ~x022)));
