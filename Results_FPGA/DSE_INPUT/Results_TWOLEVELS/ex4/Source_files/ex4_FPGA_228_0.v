...
module FAU ( 
  ...
  assign z06 = x046 & ((~new_n191_ & ~x006) | ~new_n205_ | (~new_n198_ & x086));
  assign new_n191_ = ~new_n197_ & (~x054 | (~new_n195_ & (~x078 | (new_n192_ & ~new_n196_))));
  ...
  assign new_n195_ = (x014 | x022) & (~x062 | (x078 & (~x030 | ~x094)));
  ...
  assign new_n201_ = x078 & ((new_n202_ & ~x030) | (~x070 & (~x094 | (x022 & ~x030))));
