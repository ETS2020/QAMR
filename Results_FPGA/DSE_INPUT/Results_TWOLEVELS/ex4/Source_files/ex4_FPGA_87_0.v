// Benchmark "FAU" written by ABC on Wed Jul 29 15:32:38 2020
...
module FAU ( 
  ...
  assign z06 = x046 & (new_n191_ | ~new_n206_ | (~new_n198_ & x086));
  ...
  assign new_n194_ = x038 & (~x118 | (x062 & ~x102));
  assign new_n195_ = x070 & (~x118 | (x094 & (~x102 | ~x126)));
  assign new_n196_ = x086 & (x126 | (x118 ? ~x022 : ~x110));
  assign new_n197_ = (~x038 | (x110 & (x014 | ~x062 | x126))) & (~x070 | x110);
  assign new_n198_ = ~new_n203_ & (~x054 | (~new_n205_ & ~new_n199_ & (new_n201_ | ~x078)));
  assign new_n199_ = ~new_n200_ & (~x110 | (x078 & ~x118));
  assign new_n200_ = x022 & (x030 | (~x062 & ~x094));
  assign new_n201_ = (x070 | ((~x022 | x030) & x062 & x094)) & (~new_n202_ | x030);
  assign new_n202_ = (~x102 | ~x126) & (x062 | x094) & (x014 | x022);
  assign new_n203_ = new_n204_ & ~x038;
  assign new_n204_ = x078 & (~x062 | ~x094 | (~x030 & (x014 | x022)));
  assign new_n205_ = ~x014 & (~x110 | ~x118);
  assign new_n206_ = (x022 | x070 | ((~x014 | ~x054) & (~x038 | ~x078))) & (x038 | x054) & (x014 | x078);
  assign z08 = ~x040 & ((~new_n208_ & x000) | ~new_n222_ | (~new_n216_ & ~x080));
  ...
  assign new_n216_ = ~new_n220_ & (x048 | (~new_n217_ & (new_n221_ | (~x104 & ~x112))));
  assign new_n217_ = ~x072 & ((x064 & (~new_n218_ | (~x016 & x024))) | (new_n219_ & x024));
  assign new_n218_ = ~x056 & ~x088;
  assign new_n219_ = (x096 | x120) & (~x008 | ~x016) & (~x056 | ~x088);
  assign new_n220_ = x032 & ~x072 & (~new_n218_ | (x024 & (~x008 | ~x016)));
  ...
  assign new_n245_ = ~x013 & (x077 | (~x021 & (new_n186_ | ~x029)));
  assign new_n246_ = ~x077 & ((x069 & (~new_n184_ | (~x021 & x029))) | (new_n247_ & x029));
  assign new_n247_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n248_ = x037 & ~x077 & (~new_n184_ | (x029 & (~x013 | ~x021)));
  assign new_n249_ = (~x021 | ~x069 | ((x013 | x053) & (x037 | x077))) & (~x037 | ~x053) & (~x013 | ~x077);
  assign z14 = ~x046 & ((~new_n256_ & x014) | new_n251_ | new_n258_ | (~new_n257_ & ~x014));
  assign new_n251_ = ~x078 & (new_n254_ | new_n255_ | (~new_n252_ & ~x054));
  assign new_n252_ = ~new_n253_ & (x086 | ((~x030 | (x062 & x094)) & (~x070 | (~x062 & ~x094))));
  assign new_n253_ = x006 & (~x038 | ~x070 | x086 | (~x118 & x126));
  assign new_n254_ = x022 & ((~x038 & x070) | (~x054 & ~x086));
  assign new_n255_ = x038 & ~x086 & (x062 | x094);
  assign new_n256_ = ~x078 & (x054 | x086);
  assign new_n257_ = (~x022 | x054 | ~x070) & (~x006 | x038 | ~x086);
  assign new_n258_ = x038 & x054;
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
