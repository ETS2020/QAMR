...
module FAU ( 
  ...
  assign new_n260_ = ~x014 & (x078 | (~x022 & (new_n203_ | ~x030)));
  assign new_n261_ = ~x078 & ((x070 & (~new_n201_ | (~x022 & x030))) | (new_n262_ & x030));
  assign new_n262_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n263_ = x038 & ~x078 & (~new_n201_ | (x030 & (~x014 | ~x022)));
