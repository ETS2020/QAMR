...
module FAU ( 
  ...
  assign new_n253_ = ~x014 & (x078 | (~x022 & (new_n203_ | ~x030)));
  assign new_n254_ = ~x078 & ((x070 & (~new_n201_ | (~x022 & x030))) | (new_n255_ & x030));
  assign new_n255_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n256_ = x038 & ~x078 & (~new_n201_ | (x030 & (~x014 | ~x022)));
