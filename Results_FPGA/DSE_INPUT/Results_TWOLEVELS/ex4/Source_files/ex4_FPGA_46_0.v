...
module FAU ( 
  ...
  assign z06 = (~x014 & ~x078) | (x046 & (~new_n199_ | (~new_n191_ & ~x006)));
  ...
  assign new_n199_ = (~x086 | ((~new_n205_ | x038) & (new_n200_ | ~x054))) & ~new_n206_ & (x038 | x054);
  ...
  assign new_n203_ = ~x070 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n204_ = (~x102 | ~x126) & (x062 | x094) & (x014 | x022);
  assign new_n205_ = x078 & (~x062 | ~x094 | (~x030 & (x014 | x022)));
  assign new_n206_ = ~x022 & ~x070 & ((x014 & x054) | (x038 & x078));
  ...
  assign z14 = ~x046 & (~new_n251_ | x014 | (x038 & x054));
  assign new_n251_ = (~x022 | x054 | ~x070) & (~x006 | x038 | ~x086);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
