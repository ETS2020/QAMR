// Benchmark "FAU" written by ABC on Wed Jul 29 15:31:40 2020
...
module FAU ( 
  ...
  assign z06 = x046 & (new_n191_ | ~new_n204_ | (~new_n198_ & x078));
  assign new_n191_ = ~x006 & (new_n197_ | (x078 & (new_n195_ | ~new_n192_ | new_n196_)));
  assign new_n192_ = (x118 | (~x038 & (~x110 | x126))) & new_n194_ & (~x038 | (~new_n193_ & x110));
  assign new_n193_ = x062 & ~x102;
  ...
  assign new_n197_ = x038 & (~x086 | (~x014 & x062 & ~x126));
  assign new_n198_ = (x070 | (~new_n203_ & (~x086 | (x062 & x094)))) & (new_n199_ | ~x086);
  assign new_n199_ = ~new_n200_ & ~new_n202_ & (x030 | new_n201_ | (~x014 & ~x022));
  assign new_n200_ = (~x110 | ~x118) & (~x022 | (~x030 & (x062 | x094)));
  assign new_n201_ = x038 & ((x102 & x126) | (~x062 & ~x094));
  assign new_n202_ = ~x038 & (~x062 | ~x094);
  assign new_n203_ = x038 & (~x022 | (~x030 & x086));
  assign new_n204_ = (new_n205_ | x014) & (x038 | x054) & (~x014 | x022 | ~x054 | x070);
  assign new_n205_ = x078 & (~x086 | (x110 & x118));
  ...
  assign new_n245_ = ~x077 & ((x069 & (~new_n184_ | (~x021 & x029))) | (new_n246_ & x029));
  assign new_n246_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n247_ = x037 & ~x077 & (~new_n184_ | (x029 & (~x013 | ~x021)));
  assign new_n248_ = (~x021 | ~x069 | ((x013 | x053) & (x037 | x077))) & (~x037 | ~x053) & (~x013 | ~x077);
  assign z14 = ~x046 & (new_n256_ | ~new_n260_ | (~x054 & (~new_n250_ | new_n258_)));
  assign new_n250_ = (~x006 | (new_n253_ & ~new_n255_)) & (new_n251_ | (x014 & x022));
  assign new_n251_ = (~x030 | (~x006 & (x086 | new_n252_ | (x062 & x094)))) & (~x006 | (~x062 & ~x094));
  assign new_n252_ = ~x102 & ~x126;
  assign new_n253_ = (x070 | x094 | (~x102 & ~x126)) & ~x086 & (new_n254_ | ~x126);
  assign new_n254_ = x118 ? x110 : x022;
  assign new_n255_ = ~x062 & ((~x038 & x102) | (x094 & x126));
  assign new_n256_ = x070 & (new_n257_ | (x022 & ~x078 & (~x014 | ~x038)));
  assign new_n257_ = ~x054 & ~x086 & ((x030 & ~x038) | x062 | x094);
  assign new_n258_ = (x110 | x118) & (new_n259_ | (x006 & (~x038 | ~x070)));
  assign new_n259_ = ~x086 & (x014 | x022 | (x030 & (~x062 | ~x094)));
  assign new_n260_ = (new_n261_ | x014) & (new_n262_ | ~x038) & (~x014 | ~x078);
  assign new_n261_ = (~x006 | ~x086) & (~x030 | ~x038 | x086);
  assign new_n262_ = ~x054 & (x086 | ((x022 | ~x030) & ~x062 & ~x094));
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
