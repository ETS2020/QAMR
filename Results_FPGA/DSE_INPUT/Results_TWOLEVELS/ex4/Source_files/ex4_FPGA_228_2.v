// Benchmark "FAU" written by ABC on Wed Jul 29 15:34:37 2020
...
module FAU ( 
  ...
  assign new_n195_ = x070 & x094 & (~x102 | ~x126);
  assign new_n196_ = x086 & (x126 | (x118 ? ~x022 : ~x110));
  assign new_n197_ = x062 & ((x038 & ~x102) | (~x094 & ~x126));
  assign new_n198_ = (~new_n205_ | x038) & ((~new_n199_ & new_n201_) | ~x054);
  assign new_n199_ = ~new_n200_ & (~x110 | ~x118);
  assign new_n200_ = (x030 | (~x062 & (~x078 | ~x094))) & x014 & (x022 | ~x078);
  assign new_n201_ = (~new_n204_ | x030) & (~x078 | (~new_n203_ & (new_n202_ | x030)));
  assign new_n202_ = (~x022 | x070) & (~x094 | (~x014 & ~x022) | (x102 & x126));
  assign new_n203_ = ~x070 & (~x062 | ~x094);
  assign new_n204_ = x062 & (~x102 | ~x126) & (x014 | x022);
  ...
  assign z14 = ~x046 & ((~new_n251_ & x006) | ~new_n261_ | (~new_n256_ & ~x078));
  assign new_n251_ = (x054 | new_n252_ | x078) & (x014 | x038 | ~x086);
  assign new_n252_ = ~new_n253_ & ~new_n254_ & ~new_n255_ & ~x086;
  assign new_n253_ = (x030 | x094) & (~x014 | ~x022);
  assign new_n254_ = (~x038 | ~x070) & (x102 | x110 | x118);
  assign new_n255_ = x126 & (~x070 | (~x014 & ~x110) | (~x022 & ~x118));
  assign new_n256_ = (new_n259_ | ~x070) & (x086 | (~new_n260_ & (new_n257_ | x054)));
  assign new_n257_ = (~x030 | (new_n258_ & ((x014 & x022) | (~x102 & ~x126)))) & (new_n258_ | ~x022);
  assign new_n258_ = ~x110 & ~x118;
  assign new_n259_ = (x038 | (~x022 & (~x030 | x054 | x086))) & (x054 | x086 | ~x094);
  assign new_n260_ = x038 & (x094 | (x030 & (~x014 | ~x022)));
  assign new_n261_ = (new_n262_ | ~x014) & (~x038 | ~x054) & (x014 | ~x022 | x054 | ~x070);
  assign new_n262_ = ~x078 & (x054 | new_n258_ | x086);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
