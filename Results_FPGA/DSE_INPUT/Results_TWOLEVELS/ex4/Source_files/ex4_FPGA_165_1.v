...
module FAU ( 
  ...
  assign z06 = new_n191_ | (~new_n205_ & x046) | (x078 & (new_n197_ | new_n204_));
  assign new_n191_ = ~x006 & (new_n192_ | (x014 & x038 & x046 & ~x086));
  assign new_n192_ = x054 & x078 & (new_n193_ | new_n194_ | new_n195_ | ~new_n196_);
  ...
  assign new_n197_ = x086 & (new_n198_ | new_n203_);
  assign new_n198_ = x054 & ((~new_n199_ & ~new_n200_) | new_n201_ | (new_n202_ & ~x030));
  assign new_n199_ = x110 & x118;
  assign new_n200_ = x014 & x022 & (x030 | (~x062 & ~x094));
  assign new_n201_ = ~x070 & ((~x030 & x038) | ~x062 | ~x094);
  assign new_n202_ = (~x102 | ~x126) & (x062 | x094) & (x014 | x022);
  assign new_n203_ = ~x038 & (~x062 | ~x094 | (~x030 & (x014 | x022)));
  assign new_n204_ = ~x022 & x038 & ~x070;
  assign new_n205_ = (x038 | x054) & (x014 | x078) & (~x014 | x022 | ~x054 | x070);
  ...
  assign z14 = ~x046 & (~new_n258_ | (~x054 & (~new_n250_ | new_n262_)));
  assign new_n250_ = (new_n257_ | x038) & ~new_n251_ & ~new_n253_ & (new_n255_ | ~x006);
  assign new_n251_ = ~new_n252_ & (x062 | x094);
  assign new_n252_ = (~x070 | x086) & (~x006 | (x014 & x022));
  assign new_n253_ = (x102 | x126) & (new_n254_ | (x006 & ~x070 & ~x094));
  assign new_n254_ = x030 & ~x086 & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n255_ = new_n256_ & (x014 | ~x030) & (x022 | (~x030 & (x118 | ~x126)));
  assign new_n256_ = ~x086 & (x062 | ~x094 | ~x126);
  assign new_n257_ = (~x030 | ~x070 | x086) & (~x006 | x062 | ~x102);
  assign new_n258_ = (new_n259_ | x014) & (new_n261_ | ~x038) & (~x022 | x038 | ~x070);
  assign new_n259_ = new_n260_ & (~x006 | (~x086 & (~x038 | x110 | ~x126)));
  assign new_n260_ = (~x022 | ~x070) & (~x030 | ~x038 | x086);
  assign new_n261_ = ~x054 & (x086 | ((x022 | ~x030) & ~x062 & ~x094));
  assign new_n262_ = (x110 | x118) & (new_n263_ | (x006 & (~x038 | ~x070)));
  assign new_n263_ = ~x086 & (x014 | x022 | (x030 & (~x062 | ~x094)));
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
