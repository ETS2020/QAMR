...
module FAU ( 
  ...
  assign z06 = x046 & ((~new_n191_ & ~x006) | ~new_n206_ | (~new_n198_ & x086));
  assign new_n191_ = ~new_n197_ & (~x054 | (~new_n195_ & ~new_n196_ & (new_n192_ | ~x078)));
  assign new_n192_ = ((~x038 & ~x070) | (x110 & x118)) & new_n194_ & (~new_n193_ | ~x070);
  assign new_n193_ = x094 & (~x102 | ~x126);
  assign new_n194_ = x086 & (~x022 | ~x118 | x126);
  assign new_n195_ = (x014 | x022) & (~x094 | (x078 & (~x030 | ~x062)));
  assign new_n196_ = x062 & ((x038 & x078 & ~x102) | (~x094 & ~x126));
  assign new_n197_ = x014 & ((x038 & ~x086) | (~x038 & x078 & x110 & ~x126));
  assign new_n198_ = ~new_n204_ & (~x054 | (~new_n199_ & ~new_n203_ & (new_n201_ | ~x078)));
  assign new_n199_ = ~new_n200_ & (~x110 | ~x118);
  assign new_n200_ = (x030 | (x094 ? ~x078 : ~x062)) & x014 & (x022 | ~x078);
  assign new_n201_ = (x030 | ((~new_n202_ | ~x094) & (~x022 | x070))) & (x062 | x070);
  assign new_n202_ = (x014 | x022) & (~x102 | ~x126);
  assign new_n203_ = ~x094 & (~x070 | (~x030 & new_n202_ & x062));
  assign new_n204_ = ~new_n205_ & ~x038;
  assign new_n205_ = x094 & (~x078 | (x062 & (x030 | (~x014 & ~x022))));
  ...
  assign z14 = ~x046 & ((~new_n257_ & x038) | ~new_n251_ | (~new_n258_ & ~x038));
  assign new_n251_ = (x054 | (new_n255_ & (new_n252_ | x086))) & (~x014 | ~x078);
  assign new_n252_ = (x078 | (~new_n254_ & ~x070)) & (new_n253_ | (~x110 & ~x118));
  assign new_n253_ = ~x014 & (x078 | (~x022 & (~x030 | x062)));
  assign new_n254_ = x030 & ~x062 & (~x014 | ~x022) & (x102 | x126);
  assign new_n255_ = (x014 | ((~x022 | ~x070) & (~x006 | x078))) & (~x006 | new_n256_ | x078);
  assign new_n256_ = (x062 | (~x102 & ~x126)) & x022 & ~x086;
  assign new_n257_ = ~x054 & (x078 | x086);
  assign new_n258_ = (~x022 | ~x070 | x078) & (~x006 | x014 | ~x086);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
