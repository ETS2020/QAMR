// Benchmark "FAU" written by ABC on Wed Jul 29 15:33:58 2020
...
module FAU ( 
  ...
  assign new_n195_ = ~x110 & (x038 | (x118 & ~x126));
  assign new_n196_ = x038 & (~x118 | (x062 & ~x102));
  assign new_n197_ = x086 & (~x022 | ~x110 | x126);
  assign new_n198_ = x062 & ~x126;
  assign new_n199_ = (new_n200_ | x070) & (new_n205_ | x038) & (new_n202_ | ~x054);
  assign new_n200_ = (~x038 | (x022 & (x030 | ~x054 | ~x110))) & (~new_n201_ | ~x054);
  assign new_n201_ = x086 & (~x062 | ~x094);
  assign new_n202_ = (~new_n204_ | ~x014) & (new_n203_ | (x110 ? x118 : ~x086));
  assign new_n203_ = x022 & (x030 | (~x062 & ~x094));
  assign new_n204_ = ~x030 & x110 & (x062 | x094) & (~x102 | ~x126);
  assign new_n205_ = ~new_n201_ & (~x014 | x030 | ~x110);
  assign new_n206_ = ~new_n209_ & (new_n207_ | x014) & (~x014 | x022 | ~x054 | x070);
  assign new_n207_ = x078 & (~x054 | (x110 ? (~new_n208_ & x118) : ~x086));
  assign new_n208_ = x022 & ~x030 & (x062 | x094) & (~x102 | ~x126);
  assign new_n209_ = ~x038 & (~x054 | (~x014 & x022 & ~x030 & x110));
  ...
  assign z14 = ~x046 & (new_n254_ | ~new_n259_ | (x014 & (new_n261_ | x078)));
  assign new_n254_ = x006 & ((~x014 & ~x038 & x086) | (new_n255_ & ~x054));
  assign new_n255_ = ~x078 & (new_n256_ | new_n257_ | ~new_n258_);
  assign new_n256_ = (~x014 | ~x022) & (x030 | x062 | x094);
  assign new_n257_ = ((~x070 & ~x094) | (~x038 & ~x062)) & (x102 | x126);
  assign new_n258_ = (~x118 | (x038 & x070)) & ~x086 & (x022 | ~x126);
  assign new_n259_ = new_n267_ & (x078 | (~new_n260_ & (x086 | (~new_n262_ & ~new_n264_))));
  assign new_n260_ = x022 & (new_n261_ | (~x038 & x070));
  assign new_n261_ = ~x054 & ~x086 & x118;
  assign new_n262_ = ~new_n263_ & (x038 | (~x054 & x070));
  assign new_n263_ = (x022 | ~x030) & ~x062 & ~x094;
  assign new_n264_ = x030 & (new_n265_ | (~x054 & ~new_n266_ & (~x062 | ~x094)));
  assign new_n265_ = ~x014 & x038;
  assign new_n266_ = ~x118 & ((x014 & x022) | (~x102 & ~x126));
  assign new_n267_ = (~x038 | ~x054) & (x014 | ~x022 | x054 | ~x070);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
