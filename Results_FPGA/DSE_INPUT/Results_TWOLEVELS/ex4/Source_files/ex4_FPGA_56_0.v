// Benchmark "FAU" written by ABC on Wed Jul 29 15:32:12 2020
...
module FAU ( 
  ...
  assign z06 = x046 & ((~new_n191_ & ~x006) | ~new_n205_ | (~new_n199_ & x086));
  ...
  assign new_n199_ = ~new_n203_ & (~x054 | (~new_n200_ & (new_n204_ | (x110 & x118))));
  ...
  assign new_n205_ = (x038 | x054) & (x014 | x078) & (x022 | x070 | (~x014 & ~x038));
  ...
  assign z14 = ~x046 & (~new_n250_ | (x022 & x070 & (~x054 | ~x078)));
  assign new_n250_ = (~x038 | ~x054) & (~x014 | ~x078) & (~x006 | x014 | x038 | ~x086);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
