// Benchmark "FAU" written by ABC on Wed Jul 29 15:33:12 2020
...
module FAU ( 
  ...
  assign z05 = x045 & (new_n174_ | ~new_n187_ | (~new_n181_ & x077));
  assign new_n174_ = ~x005 & (new_n180_ | (x077 & (new_n178_ | ~new_n175_ | new_n179_)));
  assign new_n175_ = (x117 | (~x037 & (~x109 | x125))) & new_n177_ & (~x037 | (~new_n176_ & x109));
  assign new_n176_ = x061 & ~x101;
  ...
  assign new_n180_ = x037 & (~x085 | (~x013 & x061 & ~x125));
  assign new_n181_ = (x069 | (~new_n186_ & (~x085 | (x061 & x093)))) & (new_n182_ | ~x085);
  assign new_n182_ = ~new_n183_ & ~new_n185_ & (x029 | new_n184_ | (~x013 & ~x021));
  assign new_n183_ = (~x109 | ~x117) & (~x021 | (~x029 & (x061 | x093)));
  assign new_n184_ = x037 & ((x101 & x125) | (~x061 & ~x093));
  assign new_n185_ = ~x037 & (~x061 | ~x093);
  assign new_n186_ = x037 & (~x021 | (~x029 & x085));
  assign new_n187_ = (new_n188_ | x013) & (x037 | x053) & (~x013 | x021 | ~x053 | x069);
  assign new_n188_ = x077 & (~x085 | (x109 & x117));
  ...
  assign new_n223_ = x001 & x081 & ((~x049 & ~x073) | (~x009 & ~x033));
  assign new_n224_ = (~x017 | ~x065 | ((x009 | x049) & (x033 | x073))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign z10 = ~x042 & (new_n226_ | ~new_n227_);
  assign new_n226_ = x002 & x082 & ((~x050 & ~x074) | (~x010 & ~x034));
  assign new_n227_ = (~x018 | ~x066 | ((x010 | x050) & (x034 | x074))) & (~x034 | ~x050) & (~x010 | ~x074);
  assign z11 = ~x043 & (new_n229_ | ~new_n230_);
  assign new_n229_ = x003 & x083 & ((~x051 & ~x075) | (~x011 & ~x035));
  assign new_n230_ = (~x019 | ~x067 | ((x011 | x051) & (x035 | x075))) & (~x035 | ~x051) & (~x011 | ~x075);
  assign z12 = ~x044 & (new_n232_ | ~new_n233_);
  assign new_n232_ = x004 & x084 & ((~x052 & ~x076) | (~x012 & ~x036));
  assign new_n233_ = (~x020 | ~x068 | ((x012 | x052) & (x036 | x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign z13 = ~x045 & (new_n241_ | ~new_n245_ | (~x053 & (~new_n235_ | new_n243_)));
  assign new_n235_ = (~x005 | (new_n238_ & ~new_n240_)) & (new_n236_ | (x013 & x021));
  assign new_n236_ = (~x029 | (~x005 & (x085 | new_n237_ | (x061 & x093)))) & (~x005 | (~x061 & ~x093));
  assign new_n237_ = ~x101 & ~x125;
  assign new_n238_ = (x069 | x093 | (~x101 & ~x125)) & ~x085 & (new_n239_ | ~x125);
  assign new_n239_ = x117 ? x109 : x021;
  assign new_n240_ = ~x061 & ((~x037 & x101) | (x093 & x125));
  assign new_n241_ = x069 & (new_n242_ | (x021 & ~x077 & (~x013 | ~x037)));
  assign new_n242_ = ~x053 & ~x085 & ((x029 & ~x037) | x061 | x093);
  assign new_n243_ = (x109 | x117) & (new_n244_ | (x005 & (~x037 | ~x069)));
  assign new_n244_ = ~x085 & (x013 | x021 | (x029 & (~x061 | ~x093)));
  assign new_n245_ = (new_n246_ | x013) & (new_n247_ | ~x037) & (~x013 | ~x077);
  assign new_n246_ = (~x005 | ~x085) & (~x029 | ~x037 | x085);
  assign new_n247_ = ~x053 & (x085 | ((x021 | ~x029) & ~x061 & ~x093));
  ...
  assign new_n258_ = ~x014 & (x078 | (~x022 & (new_n202_ | ~x030)));
  assign new_n259_ = ~x078 & ((x070 & (~new_n200_ | (~x022 & x030))) | (new_n260_ & x030));
  assign new_n260_ = (x102 | x126) & (~x062 | ~x094) & (~x014 | ~x022);
  assign new_n261_ = x038 & ~x078 & (~new_n200_ | (x030 & (~x014 | ~x022)));
