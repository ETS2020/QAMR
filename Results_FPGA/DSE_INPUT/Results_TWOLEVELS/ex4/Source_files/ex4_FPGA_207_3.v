// Benchmark "FAU" written by ABC on Wed Jul 29 15:34:19 2020
...
module FAU ( 
  ...
  assign new_n178_ = ~x109 & (x037 | (x117 & ~x125));
  assign new_n179_ = x037 & (~x117 | (x061 & ~x101));
  assign new_n180_ = x085 & (~x021 | ~x109 | x125);
  ...
  assign new_n185_ = ((x109 & x117) | (x021 & (new_n186_ | x029))) & (~new_n187_ | x029);
