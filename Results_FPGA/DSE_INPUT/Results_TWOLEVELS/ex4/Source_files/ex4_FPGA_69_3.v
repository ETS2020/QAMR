// Benchmark "FAU" written by ABC on Wed Jul 29 15:32:23 2020
...
module FAU ( 
  ...
  assign new_n241_ = ~x093 & ((~x037 & x101) | (~x069 & x125));
  assign new_n242_ = (x109 | x117) & (~x037 | ~x069);
  assign new_n243_ = x125 & (x117 ? ~x109 : ~x021);
  assign new_n244_ = ~x085 & (x061 | x069 | ~x101);
  assign new_n245_ = ~x061 & x125;
  assign new_n246_ = (new_n247_ | ~x069) & (x085 | (~new_n250_ & (new_n248_ | x053)));
  assign new_n247_ = (x037 | (~x021 & (~x029 | x053 | x085))) & (x053 | new_n186_ | x085);
  assign new_n248_ = (~new_n249_ | ~x029) & ((~x109 & ~x117) | (~x021 & (new_n184_ | ~x029)));
  assign new_n249_ = (x101 | x125) & (~x013 | ~x021) & (~x061 | ~x093);
  assign new_n250_ = x037 & (~new_n186_ | (x029 & (~x013 | ~x021)));
  ...
  assign new_n263_ = ~x014 & (x078 | (~x022 & (new_n202_ | ~x030)));
  assign new_n264_ = ~x078 & ((x070 & (~new_n204_ | (~x022 & x030))) | (new_n265_ & x030));
