// Benchmark "FAU" written by ABC on Sat Aug  1 07:36:14 2020
...
module FAU ( 
  ...
  assign z13 = x64 ? (~x65 & (x66 ? new_n391_ : ~new_n383_)) : ~new_n365_;
  assign new_n365_ = ((~x66 & ~x67) | (~new_n366_ & ~new_n376_)) & (~x65 | x66 | ~new_n382_ | x67);
  ...
  assign new_n369_ = x72 & ((x56 & x74) | (x73 & (x53 | x74)));
  assign new_n370_ = ~x72 & ((x59 & ~x74) | (~x73 & (x60 | ~x74)));
  assign new_n371_ = (~x58 | ~x73 | ~x74) & (~x57 | x73 | x74);
  ...
  assign new_n376_ = x70 & (x65 ? (~x68 & ~new_n377_ & x69) : (x68 & new_n381_ & ~x69));
  ...
  assign new_n382_ = x68 & ~x69 & (x70 ? new_n381_ : new_n368_);
  assign new_n383_ = x68 ? (~new_n388_ | x69) : (x67 ? new_n390_ : (new_n384_ | ~x69));
  assign new_n384_ = ((~x70 ^ x71) | (new_n385_ & ~new_n373_)) & (~x70 | ~x71 | (new_n386_ & ~new_n387_));
  assign new_n385_ = ~new_n374_ & ~new_n375_;
  assign new_n386_ = ~new_n379_ & ~new_n380_;
  assign new_n387_ = ~new_n126_ & x61;
  assign new_n388_ = ~x70 & ~x71 & (x67 ? x45 : ~new_n389_);
  assign new_n389_ = ~new_n369_ & ~new_n370_ & new_n371_;
  assign new_n390_ = (~x13 | (x71 ? x70 : ~x69)) & (~x70 | ((~x45 | ~x71) & (~x29 | x69 | x71))) & (~x69 | x70 | x71);
  assign new_n391_ = ~x67 & ((~new_n390_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~new_n409_ & ~x65) : (new_n393_ | (x65 & new_n416_ & ~x66));
  assign new_n393_ = ~new_n112_ & (x70 ? ~new_n403_ : (new_n394_ | new_n399_));
  assign new_n394_ = x68 & ~x69 & (x65 ? (~new_n395_ & ~x71) : new_n398_);
  assign new_n395_ = (new_n396_ | x74) & (new_n397_ | ~x74) & (~x62 | (x72 ? (~x73 | ~x74) : x73));
  assign new_n396_ = (~x72 | (x73 ? ~x54 : ~x58)) & (~x60 | x72 | ~x73);
  assign new_n397_ = (~x57 | x73) & (x72 | (~x59 & x73));
  assign new_n398_ = x71 & ((x14 & (~x00 | ~x15)) | (x00 & ~x14 & x15));
  ...
  assign new_n403_ = x65 ? (x68 | ~x69 | (~new_n404_ & new_n405_)) : (~x68 | ~new_n408_ | x69);
  assign new_n404_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n405_ = x71 ? (~new_n406_ & ~new_n407_) : (x72 ? new_n401_ : new_n402_);
  ...
  assign new_n409_ = x66 ? (new_n415_ | x67) : (x68 ? ~new_n414_ : new_n410_);
  assign new_n410_ = x67 ? new_n411_ : (~x69 | (~new_n413_ & (new_n400_ | new_n194_)));
  assign new_n411_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n412_ | ~x70);
  assign new_n412_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n413_ = x70 & x71 & ((~new_n126_ & x62) | new_n406_ | new_n407_);
  assign new_n414_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n395_);
  assign new_n415_ = (~new_n108_ | ~x46 | ~x68) & (new_n411_ | x68);
  assign new_n416_ = ~x67 & x68 & ~x69 & (x70 ? new_n408_ : new_n398_);
  assign z15 = x64 ? (~x65 & (new_n431_ | new_n435_)) : (new_n418_ | (new_n436_ & x65));
  assign new_n418_ = ~new_n112_ & (x65 ? (x68 ? new_n426_ : new_n419_) : new_n430_);
  assign new_n419_ = x69 & ((~new_n420_ & (x70 ^ x71)) | (x70 & ~new_n423_ & x71));
  assign new_n420_ = (new_n126_ | ~x31) & (new_n421_ | ~x72) & (new_n422_ | x72);
  assign new_n421_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n422_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n423_ = (new_n126_ | ~x63) & (new_n424_ | ~x72) & (new_n425_ | x72);
  ...
  assign new_n427_ = (~x63 | (x72 ? (~x73 | ~x74) : x74)) & (new_n428_ | x73) & (new_n429_ | ~x73);
  assign new_n428_ = (~x72 | (x74 ? ~x58 : ~x59)) & (~x62 | x72 | ~x74);
  assign new_n429_ = (~x55 | x74) & (x72 | (~x60 & x74));
  assign new_n430_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n431_ = ~x66 & (x68 ? new_n432_ : (x67 ? ~new_n433_ : new_n419_));
  assign new_n432_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n427_);
  assign new_n433_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n434_ | ~x70);
  assign new_n434_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n435_ = x66 & ~x67 & ((~new_n433_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n436_ = ~x66 & new_n430_ & ~x67;
endmodule
