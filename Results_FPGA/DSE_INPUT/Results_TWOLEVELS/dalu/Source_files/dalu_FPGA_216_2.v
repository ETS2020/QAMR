// Benchmark "FAU" written by ABC on Sat Aug  1 07:43:19 2020
...
module FAU ( 
  ...
  assign z07 = x64 ? (~x65 & (new_n244_ | new_n248_)) : (new_n229_ | (new_n243_ & x65));
  assign new_n229_ = ~new_n112_ & (x65 ? (x68 ? new_n238_ : new_n230_) : new_n240_);
  assign new_n230_ = x69 & ((~new_n231_ & (x70 ^ x71)) | new_n234_ | (x70 & ~new_n235_ & x71));
  ...
  assign new_n234_ = ~new_n126_ & ((x23 & ~x70) | (x55 & x70 & x71));
  ...
  assign new_n238_ = ~x69 & ~x70 & ~x71 & (~new_n235_ | new_n239_);
  ...
  assign new_n244_ = ~x66 & (x68 ? new_n245_ : (x67 ? ~new_n247_ : new_n230_));
  assign new_n245_ = ~x69 & new_n246_ & ~x70;
  assign new_n246_ = ~x71 & (x67 ? x39 : (new_n239_ | new_n236_ | new_n237_));
  assign new_n247_ = (~x07 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x55 | ~x69) & (~x39 | ~x70 | ~x71);
  assign new_n248_ = x66 & ~x67 & ((~new_n247_ & ~x68) | (new_n108_ & x39 & x68));
  assign z08 = x64 ? (~x65 & (new_n264_ | new_n268_)) : (new_n250_ | (new_n262_ & x65));
  assign new_n250_ = ~new_n112_ & ((x68 & ~new_n251_ & ~x69) | (x65 & new_n257_ & ~x68));
  ...
  assign new_n254_ = (new_n126_ | ~x56) & (new_n255_ | ~x72) & (new_n256_ | x72);
  assign new_n255_ = (x73 | (x74 ? ~x51 : ~x52)) & (~x48 | ~x73 | x74);
  assign new_n256_ = (~x73 | (x74 ? ~x53 : ~x54)) & (~x55 | x73 | ~x74);
  assign new_n257_ = x69 & ((~new_n258_ & (x70 ^ x71)) | new_n261_ | (x70 & ~new_n254_ & x71));
  assign new_n258_ = (~x24 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n260_ | ~x73) & (~x72 | new_n259_ | x73);
  assign new_n259_ = x74 ? ~x19 : ~x20;
  assign new_n260_ = (x72 | (x74 ? ~x21 : ~x22)) & (~x16 | ~x72 | x74);
  assign new_n261_ = ~x72 & ~x73 & x74 & x23 & ~x70;
  assign new_n262_ = ~x66 & ~x67 & x68 & ~new_n263_ & ~x69;
  assign new_n263_ = x70 ? (new_n253_ | x71) : (new_n252_ | ~x71);
  assign new_n264_ = ~x66 & (x68 ? new_n265_ : (x67 ? ~new_n266_ : new_n257_));
  assign new_n265_ = ~x69 & ~x70 & ~x71 & (x67 ? x40 : ~new_n254_);
  assign new_n266_ = (~x08 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x56 | ~x69) & (new_n267_ | ~x70);
  assign new_n267_ = (~x40 | ~x71) & (~x24 | x69 | x71);
  assign new_n268_ = x66 & ~x67 & ((~new_n266_ & ~x68) | (new_n108_ & x40 & x68));
  assign z09 = x64 ? (~x65 & (new_n286_ | new_n290_)) : (new_n270_ | (new_n284_ & x65));
  assign new_n270_ = ~new_n112_ & ((x68 & ~new_n271_ & ~x69) | (x65 & new_n278_ & ~x68));
  assign new_n271_ = x65 ? (x70 | new_n274_ | x71) : (x70 ? (new_n273_ | x71) : (new_n272_ | ~x71));
  assign new_n272_ = (~x09 | (~new_n158_ & x00)) & (~x00 | new_n158_ | x09);
  assign new_n273_ = (~x41 | (~new_n161_ & x32)) & (~x32 | new_n161_ | x41);
  ...
  assign new_n278_ = x69 & (~new_n282_ | (~new_n279_ & ~new_n194_));
  assign new_n279_ = (~x25 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n280_ | ~x74) & (~x72 | new_n281_ | x74);
  assign new_n280_ = (x72 | (x73 ? ~x22 : ~x24)) & (~x20 | ~x72 | x73);
  assign new_n281_ = x73 ? ~x17 : ~x21;
  assign new_n282_ = ~new_n283_ & (~x70 | ~x71 | (~new_n275_ & ~new_n276_ & ~new_n277_));
  assign new_n283_ = ~x72 & x73 & ~x74 & x23 & ~x70;
  assign new_n284_ = ~x66 & ~x67 & x68 & ~new_n285_ & ~x69;
  assign new_n285_ = x70 ? (new_n273_ | x71) : (new_n272_ | ~x71);
  assign new_n286_ = ~x66 & (x68 ? new_n287_ : (x67 ? ~new_n288_ : new_n278_));
  assign new_n287_ = ~x69 & ~x70 & ~x71 & (x67 ? x41 : ~new_n274_);
  assign new_n288_ = (~x09 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x57 | ~x69) & (new_n289_ | ~x70);
  assign new_n289_ = (~x41 | ~x71) & (~x25 | x69 | x71);
  assign new_n290_ = x66 & ~x67 & ((~new_n288_ & ~x68) | (new_n108_ & x41 & x68));
  assign z10 = x64 ? new_n311_ : (new_n309_ | (~new_n112_ & (new_n292_ | new_n305_)));
  assign new_n292_ = ~x70 & ((x68 & ~new_n293_ & ~x69) | (x65 & ~x68 & ~new_n300_ & x69));
  assign new_n293_ = x65 ? (x71 | (new_n296_ & ~new_n299_)) : (new_n294_ | ~x71);
  ...
  assign new_n300_ = ~new_n304_ & (~x71 | (new_n301_ & (new_n126_ | ~x26)));
  assign new_n301_ = x72 ? new_n303_ : new_n302_;
  assign new_n302_ = (~x25 | x73 | ~x74) & (~x24 | ~x73 | x74);
  assign new_n303_ = (x73 | (x74 ? ~x21 : ~x22)) & (~x18 | ~x73 | x74);
  assign new_n304_ = x73 & x74 & x23 & ~x72;
  assign new_n305_ = x70 & (x65 ? (~x68 & ~new_n306_ & x69) : (x68 & new_n307_ & ~x69));
  assign new_n306_ = (new_n126_ | (x71 ? ~x58 : ~x26)) & (new_n301_ | x71) & (new_n296_ | ~x71);
  ...
  assign new_n310_ = x70 ? ~new_n307_ : (new_n294_ | ~x71);
  assign new_n311_ = ~x65 & (x66 ? new_n320_ : (new_n312_ | new_n318_));
  assign new_n312_ = ~x68 & (x67 ? ~new_n313_ : (x69 & (new_n315_ | ~new_n316_)));
  assign new_n313_ = (~x10 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x58 | ~x69) & (new_n314_ | ~x70);
  assign new_n314_ = (~x42 | ~x71) & (~x26 | x69 | x71);
  assign new_n315_ = ~new_n194_ & ((~new_n126_ & x26) | (~new_n302_ & ~x72) | (~new_n303_ & x72));
  assign new_n316_ = ~new_n317_ & (~x70 | ~x71 | (~new_n299_ & ~new_n297_ & ~new_n298_));
  assign new_n317_ = x23 & ~x70 & ~x72 & x73 & x74;
  assign new_n318_ = x68 & ~x69 & new_n319_ & ~x70;
  assign new_n319_ = ~x71 & (x67 ? x42 : (new_n299_ | new_n297_ | new_n298_));
  assign new_n320_ = ~x67 & ((~new_n313_ & ~x68) | (new_n108_ & x42 & x68));
  assign z11 = x64 ? (~x65 & (x66 ? new_n348_ : ~new_n340_)) : ~new_n322_;
  assign new_n322_ = ~new_n338_ & (new_n112_ | (~new_n323_ & ~new_n333_));
  ...
  assign new_n329_ = ~new_n332_ & (~x71 | (~new_n330_ & ~new_n331_ & (new_n126_ | ~x27)));
  assign new_n330_ = x72 & ((x19 & x73 & ~x74) | (x22 & ~x73 & x74));
  assign new_n331_ = ~x72 & ((x73 & (x74 ? x24 : x25)) | (x26 & ~x73 & x74));
  assign new_n332_ = ~x73 & ~x74 & x23 & x72;
  assign new_n333_ = x70 & (x65 ? (~x68 & ~new_n334_ & x69) : (x68 & new_n336_ & ~x69));
  assign new_n334_ = ~new_n335_ & (x71 | (~new_n330_ & ~new_n331_)) & (~x71 | (~new_n327_ & ~new_n328_));
  assign new_n335_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x59 : x27);
  assign new_n336_ = ~new_n337_ & ~x71;
  assign new_n337_ = (~x43 | (x32 & (x46 | x47 | x44 | x45))) & (~x32 | x43 | (~x46 & ~x47 & ~x44 & ~x45));
  assign new_n338_ = x65 & ~x66 & ~x67 & x68 & ~new_n339_ & ~x69;
  assign new_n339_ = x70 ? (new_n337_ | x71) : (new_n325_ | ~x71);
  assign new_n340_ = x68 ? (~new_n344_ | x69) : (x67 ? new_n346_ : (new_n341_ | ~x69));
  assign new_n341_ = new_n342_ & (new_n194_ | (~new_n330_ & ~new_n331_ & (new_n126_ | ~x27)));
  assign new_n342_ = ~new_n343_ & (~x70 | ~x71 | (~new_n326_ & ~new_n327_ & ~new_n328_));
  assign new_n343_ = x23 & ~x70 & x72 & ~x73 & ~x74;
  assign new_n344_ = ~x70 & ~x71 & (x67 ? x43 : ~new_n345_);
  assign new_n345_ = ~new_n326_ & ~new_n327_ & ~new_n328_;
  assign new_n346_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n347_ | ~x70);
  assign new_n347_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n348_ = ~x67 & ((~new_n346_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~new_n371_ & ~x65) : ((new_n369_ & x65) | (~new_n350_ & ~new_n112_));
  assign new_n350_ = x70 ? (x65 ? (~new_n361_ | x68) : (~new_n367_ | ~x68)) : new_n351_;
  assign new_n351_ = (~x68 | new_n352_ | x69) & (~x65 | x68 | new_n357_ | ~x69);
  ...
  assign new_n357_ = ~new_n360_ & (~x71 | (~new_n358_ & ~new_n359_ & (new_n126_ | ~x28)));
  assign new_n358_ = ~x74 & ((x72 & (x73 ? x20 : x24)) | (x26 & ~x72 & x73));
  assign new_n359_ = ~x72 & x74 & (x73 ? x25 : x27);
  assign new_n360_ = x23 & x72 & ~x73 & x74;
  assign new_n361_ = x69 & (new_n362_ | (~new_n363_ & ~x74) | (~new_n365_ & x74));
  assign new_n362_ = ~new_n126_ & (x71 ? x60 : x28);
  assign new_n363_ = (new_n364_ | ~x73) & (~x72 | x73 | (x71 ? ~x56 : ~x24));
  assign new_n364_ = x71 ? (x72 ? ~x52 : ~x58) : (x72 ? ~x20 : ~x26);
  assign new_n365_ = (new_n366_ | x72) & (~x72 | x73 | ~x55 | ~x71);
  assign new_n366_ = x71 ? (x73 ? ~x57 : ~x59) : (x73 ? ~x25 : ~x27);
  assign new_n367_ = ~x69 & ~new_n368_ & ~x71;
  assign new_n368_ = (~x44 | (~new_n308_ & x32)) & (~x32 | new_n308_ | x44);
  assign new_n369_ = ~x66 & ~x67 & x68 & ~new_n370_ & ~x69;
  assign new_n370_ = x70 ? (new_n368_ | x71) : (new_n353_ | ~x71);
  assign new_n371_ = x66 ? ~new_n380_ : (x68 ? ~new_n378_ : new_n372_);
  assign new_n372_ = x67 ? new_n374_ : (~x69 | (new_n376_ & (new_n373_ | new_n194_)));
  assign new_n373_ = (new_n126_ | ~x28) & ~new_n358_ & ~new_n359_;
  assign new_n374_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n375_ | ~x70);
  assign new_n375_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n376_ = ~new_n377_ & (~x70 | ~x71 | (~new_n354_ & ~new_n355_ & ~new_n356_));
  assign new_n377_ = x23 & ~x70 & x72 & ~x73 & x74;
  assign new_n378_ = ~x69 & ~x70 & ~x71 & (x67 ? x44 : ~new_n379_);
  assign new_n379_ = ~new_n354_ & ~new_n355_ & ~new_n356_;
  assign new_n380_ = ~x67 & ((~new_n374_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n405_ : ~new_n398_)) : ~new_n382_;
  assign new_n382_ = ((~x66 & ~x67) | (~new_n383_ & ~new_n393_)) & (~x65 | x66 | ~new_n397_ | x67);
  ...
  assign new_n405_ = ~x67 & ((~new_n403_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n428_ : ~new_n423_)) : ~new_n407_;
  assign new_n407_ = ~new_n421_ & (new_n112_ | (x70 ? new_n417_ : (~new_n408_ & ~new_n413_)));
  assign new_n408_ = x68 & ~x69 & (x65 ? (~new_n409_ & ~x71) : (~new_n412_ & x71));
  assign new_n409_ = (new_n126_ | ~x62) & (new_n410_ | ~x72) & (new_n411_ | x72);
  ...
  assign new_n414_ = (new_n126_ | ~x30) & (new_n415_ | ~x72) & (new_n416_ | x72);
  ...
  assign z15 = x64 ? (~x65 & (new_n441_ | new_n445_)) : (new_n430_ | (new_n446_ & x65));
  assign new_n430_ = ~new_n112_ & (x65 ? (x68 ? new_n439_ : new_n431_) : new_n440_);
  assign new_n431_ = x69 & ((~new_n432_ & (x70 ^ x71)) | new_n438_ | (x70 & ~new_n435_ & x71));
  assign new_n432_ = (~x31 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n433_ | x73) & (x72 | new_n434_ | ~x73);
  assign new_n433_ = (~x72 | (x74 ? ~x26 : ~x27)) & (~x30 | x72 | ~x74);
  assign new_n434_ = x74 ? ~x28 : ~x29;
  assign new_n435_ = (new_n126_ | ~x63) & (new_n436_ | ~x72) & (new_n437_ | x72);
  assign new_n436_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n437_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n438_ = x23 & ~x70 & x72 & x73 & ~x74;
  assign new_n439_ = ~x69 & ~x70 & ~new_n435_ & ~x71;
  assign new_n440_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n441_ = ~x66 & (x68 ? new_n442_ : (x67 ? ~new_n443_ : new_n431_));
  assign new_n442_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n435_);
  ...
  assign new_n446_ = ~x66 & new_n440_ & ~x67;
endmodule
