// Benchmark "FAU" written by ABC on Sat Aug  1 07:40:24 2020
...
module FAU ( 
  ...
  assign z14 = x64 ? (~x65 & (x66 ? new_n417_ : ~new_n411_)) : ~new_n389_;
  assign new_n389_ = ~new_n409_ & (new_n112_ | (new_n400_ & (~x71 | (~new_n390_ & ~new_n395_))));
  assign new_n390_ = ~x70 & (x65 ? (~x68 & ~new_n391_ & x69) : (x68 & ~new_n394_ & ~x69));
  ...
  assign new_n395_ = x65 & ~x68 & x69 & (new_n396_ | (~new_n397_ & x70));
  assign new_n396_ = ~new_n126_ & (x30 | x70);
  assign new_n397_ = ~new_n398_ & ~new_n399_ & (~x59 | ~x73 | ~x74) & (~x58 | x73 | x74);
  assign new_n398_ = x72 & ((x57 & x74) | (x54 & x73));
  assign new_n399_ = ~x72 & ((x61 & ~x73) | (x60 & ~x74));
  assign new_n400_ = x65 ? (~new_n401_ & (x71 | (~new_n403_ & ~new_n406_))) : ~new_n407_;
  assign new_n401_ = ~new_n126_ & ~new_n402_;
  assign new_n402_ = (~x30 | x68 | ~x69 | ~x70) & (x69 | x70 | x71 | ~x62 | ~x68);
  assign new_n403_ = x68 & ~x69 & ~x70 & (x72 ? ~new_n404_ : ~new_n405_);
  assign new_n404_ = (x73 | (x74 ? ~x57 : ~x58)) & (~x54 | ~x73 | x74);
  assign new_n405_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n406_ = ~x68 & x69 & x70 & (x72 ? ~new_n392_ : ~new_n393_);
  assign new_n407_ = new_n408_ & x68;
  assign new_n408_ = ~x69 & x70 & ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n409_ = x65 & ~x66 & ~x67 & x68 & ~new_n410_ & ~x69;
  assign new_n410_ = x70 ? (x71 | ((~x32 | x46 | ~x47) & (~x46 | (x32 & x47)))) : (new_n394_ | ~x71);
  assign new_n411_ = x68 ? (~new_n413_ | x69) : (x67 ? new_n415_ : (new_n412_ | ~x69));
  assign new_n412_ = (new_n391_ | (~x70 ^ x71)) & (~x70 | new_n397_ | ~x71) & (new_n126_ | ((~x70 | ~x71) & (~x30 | (~x70 & ~x71))));
  assign new_n413_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n414_);
  assign new_n414_ = (new_n126_ | ~x62) & (new_n404_ | ~x72) & (new_n405_ | x72);
  ...
  assign z15 = x64 ? (~x65 & (new_n433_ | new_n437_)) : (new_n419_ | (new_n438_ & x65));
  assign new_n419_ = ~new_n112_ & (x65 ? (x68 ? new_n428_ : new_n420_) : new_n432_);
  assign new_n420_ = x69 & (new_n421_ | new_n424_ | (~x72 & (new_n426_ | new_n427_)));
  assign new_n421_ = (x70 ^ x71) & ((~new_n126_ & x31) | new_n422_ | new_n423_);
  assign new_n422_ = x73 & ((~x72 & (x74 ? x28 : x29)) | (x23 & x72 & ~x74));
  assign new_n423_ = x72 & ~x73 & (x74 ? x26 : x27);
  assign new_n424_ = x70 & x71 & (new_n425_ | (x58 & ~x73 & x74));
  assign new_n425_ = x72 & ((x73 & (x74 ? x63 : x55)) | (x59 & ~x73 & ~x74));
  assign new_n426_ = ~x73 & ((x63 & x70 & x71) | (x74 & ((x70 & x71) | (x30 & (x70 | x71)))));
  assign new_n427_ = x70 & x71 & ((x60 & x74) | (x61 & x73 & ~x74));
  assign new_n428_ = ~x69 & ~x70 & ~new_n429_ & ~x71;
  assign new_n429_ = (new_n126_ | ~x63) & (new_n430_ | ~x72) & (new_n431_ | x72);
  ...
  assign new_n433_ = ~x66 & (x68 ? new_n434_ : (x67 ? ~new_n435_ : new_n420_));
  assign new_n434_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n429_);
  assign new_n435_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n436_ | ~x70);
  assign new_n436_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n437_ = x66 & ~x67 & ((~new_n435_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n438_ = ~x66 & new_n432_ & ~x67;
endmodule
