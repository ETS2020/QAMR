// Benchmark "FAU" written by ABC on Sat Aug  1 07:40:33 2020
...
module FAU ( 
  ...
  assign z04 = x64 ? (~x65 & (new_n193_ | new_n198_)) : ~new_n183_;
  ...
  assign new_n191_ = x32 ? (x36 | (~x37 & ~x38 & ~x39 & (x37 | x38 | new_n192_ | x39))) : ~x36;
  ...
  assign new_n198_ = x66 & ~x67 & ((~new_n196_ & ~x68) | (new_n106_ & x36 & x68));
  ...
  assign new_n210_ = x32 ? (x37 | (~x38 & ~x39 & (x38 | x39 | (~x36 & (new_n192_ | x36))))) : ~x37;
  ...
  assign new_n229_ = x32 ? (x38 | (~x39 & (x39 | (~x37 & (x37 | (~x36 & (new_n192_ | x36))))))) : ~x38;
  ...
  assign new_n248_ = x32 ? (x39 | (~x38 & (x38 | (~x37 & (x37 | (~x36 & (new_n192_ | x36))))))) : ~x39;
  ...
  assign z08 = (~x65 & ((new_n265_ & x64) | (~new_n256_ & ~x69))) | (~x64 & ~new_n273_ & x65);
  assign new_n256_ = (~x68 | (x64 ? ~new_n260_ : ~new_n257_)) & (~x24 | ~x64 | ~new_n264_ | x68);
  assign new_n257_ = ~new_n99_ & (x70 ? new_n259_ : new_n258_);
  assign new_n258_ = x71 & ((x08 & (~x00 | (new_n116_ & new_n117_))) | (x00 & ~x08 & (~new_n116_ | ~new_n117_)));
  assign new_n259_ = ~x71 & (~x32 | (new_n192_ & ~x41 & ~x42 & ~x43));
  assign new_n260_ = ~x70 & ~x71 & (x67 ? ~x66 : ~new_n261_);
  assign new_n261_ = (new_n161_ | ~x56) & ~new_n263_ & ~x66 & (new_n262_ | ~x72);
  assign new_n262_ = (x73 | (x74 ? ~x51 : ~x52)) & (~x73 | x74 | ~x48 | x66);
  assign new_n263_ = ~x72 & ((x55 & ~x73 & x74) | (x73 & (x74 ? x53 : x54)));
  assign new_n264_ = x70 & ~x71 & (x66 ^ x67);
  assign new_n265_ = ~x68 & (x66 ? (~new_n272_ & ~x67) : (x67 ? ~new_n272_ : (~new_n266_ & x69)));
  assign new_n266_ = (~x70 | new_n270_ | ~x71) & ((~x70 ^ x71) | (new_n267_ & (new_n161_ | ~x24)));
  ...
  assign new_n270_ = (new_n161_ | ~x56) & ~new_n263_ & (new_n271_ | ~x72);
  assign new_n271_ = (x73 | (x74 ? ~x51 : ~x52)) & (~x48 | ~x73 | x74);
  assign new_n272_ = (~x08 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x40 | ~x70 | ~x71) & (x70 | x71 | ~x56 | ~x69);
  assign new_n273_ = x70 ? (~new_n279_ & (~new_n276_ | x68)) : (x68 ? ~new_n274_ : ~new_n275_);
  assign new_n274_ = ~x69 & ((~x66 & new_n258_ & ~x67) | (~x71 & ~new_n270_ & (x66 | x67)));
  assign new_n275_ = x69 & x71 & ~new_n99_ & (~new_n267_ | (~new_n161_ & x24));
  assign new_n276_ = x69 & ~new_n99_ & (new_n278_ | (~new_n267_ & ~x71) | (~new_n277_ & x71));
  assign new_n277_ = ~new_n263_ & (new_n271_ | ~x72);
  assign new_n278_ = ~new_n161_ & (x71 ? x56 : x24);
  assign new_n279_ = ~x66 & ~x67 & x68 & new_n259_ & ~x69;
  assign z09 = x64 ? (~x65 & (new_n295_ | new_n299_)) : (new_n281_ | (new_n293_ & x65));
  assign new_n281_ = ~new_n99_ & ((x65 & new_n289_ & ~x68) | (x68 & ~new_n282_ & ~x69));
  assign new_n282_ = x65 ? (x70 | new_n286_ | x71) : (x70 ? (new_n284_ | x71) : (new_n283_ | ~x71));
  assign new_n283_ = (~x09 | (~new_n159_ & x00)) & (~x00 | new_n159_ | x09);
  assign new_n284_ = (~x41 | (x32 & (~new_n285_ | x42 | x43 | x44))) & (~x32 | x41 | (new_n285_ & ~x42 & ~x43 & ~x44));
  assign new_n285_ = ~x45 & ~x46 & ~x47;
  assign new_n286_ = ~new_n287_ & ~new_n288_ & (new_n161_ | ~x57);
  ...
  assign new_n290_ = (new_n161_ | ~x25) & (new_n292_ | x72) & (new_n291_ | ~x72);
  ...
  assign new_n299_ = x66 & ~x67 & ((~new_n297_ & ~x68) | (new_n106_ & x41 & x68));
  assign z10 = x64 ? (~x65 & (x66 ? new_n328_ : ~new_n321_)) : ~new_n301_;
  assign new_n301_ = (new_n99_ | (x70 ? new_n313_ : new_n302_)) & (~new_n318_ | ~x65);
  ...
  assign new_n315_ = (x71 ? x58 : x26) & (x72 ? (x73 & x74) : (~x73 & ~x74));
  ...
  assign new_n328_ = ~x67 & ((~new_n326_ & ~x68) | (new_n106_ & x42 & x68));
  ...
  assign new_n343_ = (x71 ? x59 : x27) & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n344_ = ~x71 & ((x43 & (new_n192_ | ~x32)) | (x32 & ~new_n192_ & ~x43));
  ...
  assign new_n353_ = ~x67 & ((~new_n351_ & ~x68) | (new_n106_ & x43 & x68));
  ...
  assign new_n368_ = (x71 ? x60 : x28) & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n369_ = ~x71 & ((x44 & (new_n285_ | ~x32)) | (x32 & ~new_n285_ & ~x44));
  ...
  assign new_n378_ = ~x67 & ((~new_n376_ & ~x68) | (new_n106_ & x44 & x68));
  ...
  assign new_n393_ = (x71 ? x61 : x29) & (x72 ? (x73 & x74) : (~x73 & ~x74));
  ...
  assign new_n403_ = ~x67 & ((~new_n401_ & ~x68) | (new_n106_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n426_ : ~new_n421_)) : ~new_n405_;
  assign new_n405_ = ~new_n419_ & (new_n99_ | (x70 ? new_n415_ : (~new_n406_ & ~new_n411_)));
  assign new_n406_ = x68 & ~x69 & (x65 ? (~new_n407_ & ~x71) : (~new_n410_ & x71));
  assign new_n407_ = (new_n161_ | ~x62) & (new_n409_ | x72) & (new_n408_ | ~x72);
  ...
  assign new_n412_ = (new_n161_ | ~x30) & (new_n414_ | x72) & (new_n413_ | ~x72);
  ...
  assign new_n416_ = ~new_n161_ & (x71 ? x62 : x30);
  ...
  assign new_n426_ = ~x67 & ((~new_n424_ & ~x68) | (new_n106_ & x46 & x68));
  ...
  assign new_n430_ = (new_n161_ | ~x31) & (new_n432_ | x72) & (new_n431_ | ~x72);
  assign new_n431_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n432_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n433_ = (new_n161_ | ~x63) & (new_n435_ | x72) & (new_n434_ | ~x72);
  ...
  assign new_n438_ = x65 & x69 & ~new_n429_ & ~new_n99_;
  assign new_n439_ = x64 ? (~new_n441_ | x65) : ((new_n440_ | new_n99_) & (~new_n442_ | ~x65));
