// Benchmark "FAU" written by ABC on Sat Aug  1 07:38:07 2020
...
module FAU ( 
  ...
  assign new_n413_ = ~new_n414_ & (~x70 | new_n415_ | ~x71) & ((~new_n418_ & ~new_n419_) | (~x70 ^ x71));
  assign new_n414_ = ~new_n126_ & ((x31 & ~x70) | (x63 & x70 & x71));
  ...
  assign new_n420_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (~x47 | ~x70 | ~x71);
  assign new_n421_ = x65 & x69 & ~new_n413_ & ~new_n112_;
  assign new_n422_ = x64 ? (~new_n425_ | x65) : ((new_n423_ | new_n112_) & (~new_n426_ | ~x65));
  assign new_n423_ = (x70 | ((~x65 | new_n424_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n424_ = (new_n126_ | ~x63) & (new_n416_ | ~x72) & (new_n417_ | x72);
  assign new_n425_ = ~x70 & ~x71 & ((~x66 & ~new_n424_ & ~x67) | (x47 & (x66 ^ x67)));
