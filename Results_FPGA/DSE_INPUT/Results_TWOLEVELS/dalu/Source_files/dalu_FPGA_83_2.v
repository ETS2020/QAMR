// Benchmark "FAU" written by ABC on Sat Aug  1 07:38:14 2020
...
module FAU ( 
  ...
  assign z15 = x68 ? new_n422_ : (x64 ? new_n412_ : new_n421_);
  assign new_n412_ = ~x65 & (x66 ? (~new_n420_ & ~x67) : (x67 ? ~new_n420_ : (~new_n413_ & x69)));
  assign new_n413_ = (new_n414_ | (~x70 ^ x71)) & (~x70 | ((new_n126_ | ~x63) & (new_n417_ | ~x71)));
  ...
  assign new_n420_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x70 | ((~x47 | ~x71) & (~x31 | x69 | x71)));
  assign new_n421_ = x65 & x69 & ~new_n413_ & ~new_n112_;
  assign new_n422_ = ~x69 & (x64 ? (new_n425_ & ~x65) : (new_n423_ | (new_n426_ & x65)));
  assign new_n423_ = ~new_n112_ & (x65 ? (~x70 & ~new_n417_ & ~x71) : ~new_n424_);
  assign new_n424_ = (~x15 | x70 | ~x71) & (~x47 | ~x70 | x71);
  assign new_n425_ = ~x70 & ~x71 & ((~x66 & ~new_n417_ & ~x67) | (x47 & (x66 ^ x67)));
  assign new_n426_ = ~x66 & ~new_n424_ & ~x67;
endmodule
