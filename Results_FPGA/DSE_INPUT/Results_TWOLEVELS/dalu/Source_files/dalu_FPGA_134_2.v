// Benchmark "FAU" written by ABC on Sat Aug  1 07:40:12 2020
...
module FAU ( 
  ...
  assign new_n122_ = ~x37 & ~x39 & ~x40 & ~x34 & ~x35 & ~x36;
  ...
  assign new_n141_ = ~x39 & ~x40 & ~x41 & ~x35 & ~x36 & ~x37;
  ...
  assign new_n160_ = ~x36 & ~x37 & ~x39 & ~x40 & ~x41;
  ...
  assign new_n182_ = x32 ? (x36 | (~x37 & ~x39 & (x37 | new_n124_ | x39))) : ~x36;
  ...
  assign new_n201_ = x32 ? (x37 | (~x39 & (x39 | (~x36 & (new_n124_ | x36))))) : ~x37;
  ...
  assign z06 = x68 ? (~new_n220_ & ~x69) : (x64 ? new_n209_ : new_n219_);
  assign new_n209_ = ~x65 & (x66 ? (~new_n217_ & ~x67) : (x67 ? ~new_n217_ : (~new_n210_ & x69)));
  assign new_n210_ = (new_n211_ | (~x70 ^ x71)) & (~x70 | ~x71 | (~new_n214_ & ~new_n215_ & ~new_n216_));
  ...
  assign new_n214_ = x54 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n215_ = x72 & ((~x73 & (x74 ? x49 : x50)) | (x48 & x73 & ~x74));
  assign new_n216_ = ~x72 & ((x73 & (x74 ? x51 : x52)) | (x53 & ~x73 & x74));
  assign new_n217_ = (~x06 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x54 | ~x69) & (new_n218_ | ~x70);
  assign new_n218_ = ~x38 & (~x22 | x69 | x71);
  assign new_n219_ = x65 & x69 & ~new_n210_ & ~new_n113_;
  assign new_n220_ = x64 ? (x65 | x66 | ~new_n225_ | x67) : (((~x66 & ~x67) | (x65 ? ~new_n225_ : new_n221_)) & (~x65 | x66 | new_n221_ | x67));
  assign new_n221_ = (x70 | new_n224_ | ~x71) & (~x32 | ~x70 | new_n222_ | x71);
  assign new_n222_ = (new_n223_ | x39) & ~x39 & (x46 | ~x47) & (x45 | ~x46);
  assign new_n223_ = ~x37 & (x37 | (~x36 & (x36 | (~x44 & ~x45))));
  assign new_n224_ = x00 ? (x06 | (~x07 & (x07 | (~x05 & (x05 | (~x04 & (new_n120_ | x04))))))) : ~x06;
  assign new_n225_ = ~x70 & ~x71 & (new_n214_ | new_n215_ | new_n216_);
  ...
  assign new_n238_ = x32 ? (x39 | (~x37 & (x37 | (~x36 & (new_n124_ | x36))))) : ~x39;
