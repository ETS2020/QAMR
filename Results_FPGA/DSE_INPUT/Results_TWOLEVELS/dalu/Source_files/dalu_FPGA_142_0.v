...
module FAU ( 
  ...
  assign new_n201_ = x71 & (x00 ? (~x05 & (x06 | x07 | (~x06 & ~new_n202_ & ~x07))) : x05);
  assign new_n202_ = ~x04 & (x04 | (~x12 & ~x13 & ~x14 & ~x15));
  ...
  assign new_n237_ = x00 ? (x06 | (~x07 & (x07 | (~x05 & (new_n202_ | x05))))) : ~x06;
  ...
  assign new_n256_ = x00 ? (x07 | (~x06 & (x06 | (~x05 & (new_n202_ | x05))))) : ~x07;
