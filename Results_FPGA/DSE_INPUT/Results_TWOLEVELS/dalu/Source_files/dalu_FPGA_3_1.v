// Benchmark "FAU" written by ABC on Sat Aug  1 07:35:07 2020
...
module FAU ( 
  ...
  assign z12 = x64 ? (~x65 & (x66 ? new_n378_ : ~new_n359_)) : ~new_n340_;
  assign new_n340_ = ~new_n357_ & (new_n112_ | (new_n350_ & (new_n341_ | x70)));
  ...
  assign new_n347_ = ~new_n348_ & ~new_n349_ & (~x25 | ~x73 | ~x74) & (~x24 | x73 | x74);
  assign new_n348_ = x72 & ((x23 & x74) | (x73 & (x20 | x74)));
  assign new_n349_ = ~x72 & ((x26 & ~x74) | (~x73 & (x27 | ~x74)));
  assign new_n350_ = x65 ? (x68 | ~x69 | (~new_n351_ & ~new_n352_)) : (~x68 | ~new_n355_ | x69);
  assign new_n351_ = ~new_n126_ & ((x60 & x71) | (x28 & x70 & ~x71));
  assign new_n352_ = x70 & (x71 ? (new_n345_ | new_n346_) : (new_n353_ | new_n354_));
  assign new_n353_ = x72 & ((~x73 & (x74 ? x23 : x24)) | (x20 & x73 & ~x74));
  assign new_n354_ = ~x72 & ((x73 & (x74 ? x25 : x26)) | (x27 & ~x73 & x74));
  assign new_n355_ = x70 & ~x71 & ((x44 & (new_n356_ | ~x32)) | (x32 & ~new_n356_ & ~x44));
  assign new_n356_ = ~x45 & ~x46 & ~x47;
  assign new_n357_ = x65 & ~x66 & ~x67 & x68 & ~new_n358_ & ~x69;
  assign new_n358_ = x70 ? (x71 | ((~x44 | (~new_n356_ & x32)) & (~x32 | new_n356_ | x44))) : ~new_n343_;
  assign new_n359_ = x68 ? (~new_n374_ | x69) : (x67 ? new_n376_ : (new_n360_ | ~x69));
  assign new_n360_ = (new_n361_ | ~x72) & ~new_n366_ & ~new_n373_ & (new_n369_ | x72);
  assign new_n361_ = ~new_n364_ & ~new_n365_ & (~x73 | (~new_n362_ & new_n363_));
  assign new_n362_ = x20 & (x70 ? (~x71 & ~x74) : x71);
  assign new_n363_ = (~x70 | ((~x28 | x71 | ~x74) & (~x52 | ~x71 | x74))) & (~x71 | ~x74 | (~x60 & x70));
  assign new_n364_ = x74 & ((x23 & (x70 ? (~x71 & ~x73) : x71)) | (x71 & ~x73 & x55 & x70));
  assign new_n365_ = x70 & ~x73 & ~x74 & (x71 ? x56 : x24);
  assign new_n366_ = x73 & ((~new_n368_ & x74) | (x70 & ~x72 & ~new_n367_ & ~x74));
  assign new_n367_ = x71 ? ~x58 : ~x26;
  assign new_n368_ = (~x25 | (x70 ? (x71 | x72) : ~x71)) & (~x71 | x72 | ~x57 | ~x70);
  assign new_n369_ = ~new_n372_ & (x73 | (~new_n370_ & new_n371_));
  assign new_n370_ = x27 & (x70 ? (~x71 & x74) : x71);
  assign new_n371_ = (~x70 | ((~x59 | ~x71 | ~x74) & (~x28 | x71 | x74))) & (~x71 | x74 | (~x60 & x70));
  assign new_n372_ = x71 & ~x74 & x26 & ~x70;
  assign new_n373_ = x24 & ~x70 & x71 & ~x73 & ~x74;
  assign new_n374_ = ~x70 & ~x71 & (x67 ? x44 : (~new_n375_ | new_n344_));
  assign new_n375_ = ~new_n345_ & ~new_n346_;
  ...
  assign z13 = x64 ? (~new_n400_ & ~x65) : (new_n380_ | (x65 & new_n418_ & ~x66));
  assign new_n380_ = ~new_n112_ & ((~new_n381_ & ~x70) | new_n398_ | (x70 & (new_n390_ | new_n396_)));
  ...
  assign new_n387_ = (new_n388_ | x74) & (new_n389_ | ~x74) & (~x29 | (x72 ? (~x73 | ~x74) : x73));
  assign new_n388_ = (~x72 | (x73 ? ~x21 : ~x25)) & (~x27 | x72 | ~x73);
  assign new_n389_ = (~x24 | x73) & (x72 | (~x26 & x73));
  assign new_n390_ = x65 & ~x68 & x69 & (new_n391_ | new_n392_ | new_n394_);
  assign new_n391_ = ~new_n126_ & (x71 ? x61 : x29);
  assign new_n392_ = x73 & ((~new_n393_ & ~x74) | (~x72 & ~new_n367_ & x74));
  assign new_n393_ = x71 ? (x72 ? ~x53 : ~x59) : (x72 ? ~x21 : ~x27);
  assign new_n394_ = ~x73 & ((~new_n395_ & x72) | (x28 & ~x71 & ~x72 & x74));
  assign new_n395_ = x71 ? (x74 ? ~x56 : ~x57) : (x74 ? ~x24 : ~x25);
  assign new_n396_ = ~x65 & x68 & new_n397_ & ~x69;
  assign new_n397_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n398_ = new_n399_ & ~x68 & x69 & x60 & x65;
  assign new_n399_ = ~x73 & x74 & x71 & ~x72;
  assign new_n400_ = x66 ? ~new_n417_ : (x68 ? ~new_n415_ : new_n401_);
  assign new_n401_ = x67 ? new_n402_ : (~x69 | (~new_n404_ & ~new_n406_ & new_n411_));
  assign new_n402_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n403_ | ~x70);
  assign new_n403_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n404_ = ~new_n194_ & ((~new_n405_ & x72) | (x27 & ~x72 & x73 & ~x74));
  assign new_n405_ = (~x25 | x73 | x74) & (~x73 | (x74 ? ~x29 : ~x21));
  assign new_n406_ = ~x73 & (new_n409_ | new_n410_ | (x74 & (new_n407_ | ~new_n408_)));
  assign new_n407_ = x24 & (x70 ? (~x71 & x72) : x71);
  assign new_n408_ = (~x70 | ((~x56 | ~x71 | ~x72) & (~x28 | x71 | x72))) & (~x71 | x72 | (~x60 & x70));
  assign new_n409_ = ~x72 & ((x29 & (x70 ? (~x71 & ~x74) : x71)) | (x61 & x70 & x71 & ~x74));
  assign new_n410_ = x57 & x70 & x71 & x72 & ~x74;
  assign new_n411_ = (~new_n414_ | ~x70) & (x72 | (~new_n412_ & ~new_n413_));
  assign new_n412_ = x74 & ((x26 & (x70 ? (~x71 & x73) : x71)) | (x58 & x70 & x71 & x73));
  assign new_n413_ = x59 & x70 & x71 & x73 & ~x74;
  assign new_n414_ = x71 & x72 & x73 & (x74 ? x61 : x53);
  assign new_n415_ = ~x69 & ~x70 & ~x71 & (x67 ? x45 : ~new_n416_);
  assign new_n416_ = ~new_n384_ & ~new_n385_ & ~new_n386_;
  assign new_n417_ = ~x67 & ((~new_n402_ & ~x68) | (new_n108_ & x45 & x68));
  assign new_n418_ = ~x67 & x68 & ~x69 & (x70 ? new_n397_ : new_n383_);
  assign z14 = x64 ? (~x65 & (new_n441_ | new_n458_)) : (new_n420_ | (new_n456_ & x65));
  assign new_n420_ = ~new_n112_ & ((~new_n421_ & ~x70) | new_n439_ | (x70 & (new_n430_ | new_n437_)));
  assign new_n421_ = (~x68 | new_n422_ | x69) & (~x65 | x68 | ~x69 | new_n427_ | ~x71);
  ...
  assign new_n427_ = (~x30 | (x72 ? (~x73 | ~x74) : x74)) & (new_n428_ | x73) & (new_n429_ | ~x73);
  assign new_n428_ = (~x72 | (x74 ? ~x25 : ~x26)) & (~x29 | x72 | ~x74);
  assign new_n429_ = (~x22 | x74) & (x72 | (~x27 & x74));
  assign new_n430_ = x65 & ~x68 & x69 & (new_n431_ | new_n432_ | new_n435_);
  assign new_n431_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n432_ = x74 & ((~new_n434_ & ~x73) | (~x72 & ~new_n433_ & x73));
  assign new_n433_ = x71 ? ~x59 : ~x27;
  assign new_n434_ = x71 ? (x72 ? ~x57 : ~x61) : (x72 ? ~x25 : ~x29);
  assign new_n435_ = ~x74 & ((~new_n436_ & x72) | (x28 & ~x71 & ~x72 & x73));
  assign new_n436_ = x71 ? (x73 ? ~x54 : ~x58) : (x73 ? ~x22 : ~x26);
  assign new_n437_ = ~x65 & x68 & new_n438_ & ~x69;
  assign new_n438_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n439_ = new_n440_ & ~x68 & x69 & x60 & x65;
  assign new_n440_ = x73 & ~x74 & x71 & ~x72;
  assign new_n441_ = ~x66 & (x68 ? new_n452_ : (x67 ? ~new_n454_ : new_n442_));
  assign new_n442_ = x69 & ((~new_n443_ & x73) | new_n451_ | (~new_n448_ & ~x73));
  assign new_n443_ = (x74 | (~new_n444_ & new_n445_)) & (new_n446_ | x72) & (~x72 | new_n447_ | ~x74);
  assign new_n444_ = x22 & (x70 ? (~x71 & x72) : x71);
  assign new_n445_ = (~x70 | ((~x54 | ~x71 | ~x72) & (~x28 | x71 | x72))) & (~x71 | x72 | (~x60 & x70));
  assign new_n446_ = (~x27 | (x70 ? (x71 | ~x74) : ~x71)) & (~x59 | ~x70 | ~x71 | ~x74);
  assign new_n447_ = (~x62 | ~x70 | ~x71) & (~x30 | (~x70 ^ x71));
  assign new_n448_ = (new_n428_ | (~x70 ^ x71)) & (~x70 | ((new_n450_ | ~x71) & (~new_n449_ | ~x30 | x71)));
  assign new_n449_ = ~x72 & ~x74;
  assign new_n450_ = x72 ? (x74 ? ~x57 : ~x58) : (x74 ? ~x61 : ~x62);
  assign new_n451_ = x30 & ~x70 & new_n449_ & x71;
  assign new_n452_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n453_);
  assign new_n453_ = ~new_n424_ & ~new_n425_ & ~new_n426_;
  ...
  assign new_n457_ = x70 ? ~new_n438_ : (new_n423_ | ~x71);
  assign new_n458_ = x66 & ~x67 & ((~new_n454_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x64 ? (~x65 & (new_n478_ | new_n482_)) : (new_n460_ | (new_n483_ & x65));
  assign new_n460_ = ~new_n112_ & (x65 ? (x68 ? new_n473_ : new_n461_) : new_n477_);
  assign new_n461_ = x69 & (new_n462_ | new_n464_ | ~new_n469_);
  assign new_n462_ = ~new_n194_ & ((~new_n463_ & x72) | (~x73 & ~x74 & x31 & ~x72));
  assign new_n463_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n464_ = ~x72 & (new_n467_ | new_n468_ | (x73 & (new_n465_ | ~new_n466_)));
  assign new_n465_ = x29 & (x70 ? (~x71 & ~x74) : x71);
  assign new_n466_ = (~x71 | ~x74 | (~x60 & x70)) & (~x70 | ((~x28 | x71 | ~x74) & (~x61 | ~x71 | x74)));
  assign new_n467_ = x74 & ((x30 & (x70 ? (~x71 & ~x73) : x71)) | (x71 & ~x73 & x62 & x70));
  assign new_n468_ = x63 & x70 & x71 & ~x73 & ~x74;
  assign new_n469_ = (~new_n472_ | ~x70) & (~x73 | (~new_n471_ & (~new_n470_ | ~x55 | ~x70)));
  assign new_n470_ = x71 & x72 & ~x74;
  assign new_n471_ = x74 & ((x31 & (x70 ? (~x71 & x72) : x71)) | (x63 & x70 & x71 & x72));
  assign new_n472_ = x71 & x72 & ~x73 & (x74 ? x58 : x59);
  assign new_n473_ = ~x69 & ~x70 & ~new_n474_ & ~x71;
  assign new_n474_ = (new_n126_ | ~x63) & (new_n475_ | ~x72) & (new_n476_ | x72);
  assign new_n475_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n476_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n477_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n478_ = ~x66 & (x68 ? new_n479_ : (x67 ? ~new_n480_ : new_n461_));
  assign new_n479_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n474_);
  assign new_n480_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n481_ | ~x70);
  assign new_n481_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n482_ = x66 & ~x67 & ((~new_n480_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n483_ = ~x66 & new_n477_ & ~x67;
endmodule
