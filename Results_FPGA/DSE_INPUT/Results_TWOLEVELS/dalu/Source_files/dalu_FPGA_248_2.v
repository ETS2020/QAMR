// Benchmark "FAU" written by ABC on Sat Aug  1 07:44:34 2020
...
module FAU ( 
  ...
  assign z10 = x64 ? (~x65 & (x66 ? new_n308_ : ~new_n303_)) : ~new_n285_;
  assign new_n285_ = ((~x66 & ~x67) | (~new_n286_ & ~new_n296_)) & (~x65 | x66 | ~new_n301_ | x67);
  assign new_n286_ = ~x70 & ((new_n293_ & x65) | (x71 & (x65 ? new_n289_ : new_n287_)));
  assign new_n287_ = x68 & ~x69 & ((x10 & (new_n288_ | ~x00)) | (x00 & ~new_n288_ & ~x10));
  assign new_n288_ = ~x11 & ~x12 & ~x13 & ~x14 & ~x15;
  assign new_n289_ = ~x68 & x69 & (new_n290_ | new_n291_ | new_n292_);
  assign new_n290_ = x26 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n291_ = x72 & ((~x73 & (x74 ? x21 : x22)) | (x18 & x73 & ~x74));
  assign new_n292_ = ~x72 & ((x73 & (x74 ? x23 : x24)) | (x25 & ~x73 & x74));
  assign new_n293_ = x68 & ~x69 & ~x71 & (new_n294_ | new_n295_);
  assign new_n294_ = x72 & ((~x73 & (x74 ? x53 : x54)) | (x50 & x73 & ~x74));
  assign new_n295_ = ~x72 & ((x73 & (x74 ? x55 : x56)) | (x57 & ~x73 & x74));
  assign new_n296_ = x70 & (x65 ? (~x68 & ~new_n297_ & x69) : (x68 & new_n299_ & ~x69));
  assign new_n297_ = ~new_n298_ & (x71 | (~new_n291_ & ~new_n292_)) & (~x71 | (~new_n294_ & ~new_n295_));
  assign new_n298_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x58 | (x26 & ~x71));
  assign new_n299_ = ~x71 & ((x42 & (~x32 | (new_n300_ & ~x43 & ~x44))) | (x32 & ~x42 & (~new_n300_ | x43 | x44)));
  assign new_n300_ = ~x45 & ~x46 & ~x47;
  assign new_n301_ = x68 & ~x69 & (x70 ? new_n299_ : new_n302_);
  assign new_n302_ = x71 & ((x10 & (new_n288_ | ~x00)) | (x00 & ~new_n288_ & ~x10));
  assign new_n303_ = x68 ? (~new_n306_ | x69) : (x67 ? new_n307_ : (new_n304_ | ~x69));
  assign new_n304_ = (new_n305_ | ~x70) & ((~x70 ^ x71) | (~new_n290_ & ~new_n291_ & ~new_n292_));
  assign new_n305_ = (new_n126_ | ~x58) & (~x71 | (~new_n294_ & ~new_n295_));
  assign new_n306_ = ~x70 & ~x71 & (x67 ? x42 : (new_n294_ | new_n295_));
  assign new_n307_ = (~x10 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x70 | ((~x42 | ~x71) & (~x26 | x69 | x71)));
  assign new_n308_ = ~x67 & ((~new_n307_ & ~x68) | (new_n108_ & x42 & x68));
  assign z11 = x64 ? (~x65 & (x66 ? new_n342_ : ~new_n334_)) : ~new_n310_;
  assign new_n310_ = ~new_n332_ & (new_n112_ | (x70 ? (~new_n322_ & ~new_n330_) : new_n311_));
  assign new_n311_ = (~new_n318_ | ~x65) & (~x71 | (x65 ? ~new_n314_ : ~new_n312_));
  assign new_n312_ = x68 & ~new_n313_ & ~x69;
  assign new_n313_ = (~x11 | (x00 & (x14 | x15 | x12 | x13))) & (~x00 | x11 | (~x14 & ~x15 & ~x12 & ~x13));
  assign new_n314_ = ~x68 & x69 & (new_n315_ | (~new_n317_ & ~x72) | (~new_n316_ & x72));
  assign new_n315_ = x27 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n316_ = (x73 | (x74 ? ~x22 : ~x23)) & (~x19 | ~x73 | x74);
  assign new_n317_ = (~x73 | (x74 ? ~x24 : ~x25)) & (~x26 | x73 | ~x74);
  assign new_n318_ = x68 & ~x69 & ~x71 & (new_n319_ | new_n320_ | new_n321_);
  assign new_n319_ = x59 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n320_ = x73 & ((~x72 & (x74 ? x56 : x57)) | (x51 & x72 & ~x74));
  assign new_n321_ = x72 & ~x73 & (x74 ? x54 : x55);
  assign new_n322_ = x65 & ~x68 & x69 & (new_n323_ | new_n324_ | new_n327_);
  assign new_n323_ = ~new_n126_ & (x71 ? x59 : x27);
  assign new_n324_ = ~x72 & (x73 ? ~new_n325_ : new_n326_);
  assign new_n325_ = x71 ? (x74 ? ~x56 : ~x57) : (x74 ? ~x24 : ~x25);
  assign new_n326_ = x74 & (x58 | (x26 & ~x71));
  assign new_n327_ = x72 & ((~new_n328_ & ~x74) | (~x73 & ~new_n329_ & x74));
  assign new_n328_ = x71 ? (x73 ? ~x51 : ~x55) : (x73 ? ~x19 : ~x23);
  ...
  assign new_n333_ = x70 ? (x71 | ((~x43 | (~new_n124_ & x32)) & (~x32 | new_n124_ | x43))) : (new_n313_ | ~x71);
  assign new_n334_ = x68 ? ~new_n339_ : (x67 ? new_n340_ : ~new_n335_);
  assign new_n335_ = x69 & ((~new_n336_ & (x70 ^ x71)) | (x70 & (new_n338_ | (~new_n337_ & x71))));
  assign new_n336_ = ~new_n315_ & (new_n317_ | x72) & (new_n316_ | ~x72);
  assign new_n337_ = ~new_n319_ & ~new_n320_ & ~new_n321_;
  assign new_n338_ = ~x73 & x74 & x58 & ~x72;
  assign new_n339_ = ~x69 & ~x70 & ~x71 & (x67 ? x43 : ~new_n337_);
  assign new_n340_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n341_ | ~x70);
  assign new_n341_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n342_ = ~x67 & ((~new_n340_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~x65 & (x66 ? new_n372_ : ~new_n366_)) : ~new_n344_;
  assign new_n344_ = ~new_n364_ & (new_n112_ | (x70 ? new_n355_ : (~new_n345_ & ~new_n351_)));
  assign new_n345_ = x71 & (x65 ? (~x68 & ~new_n348_ & x69) : (x68 & ~new_n346_ & ~x69));
  assign new_n346_ = (~x12 | (~new_n347_ & x00)) & (~x00 | new_n347_ | x12);
  assign new_n347_ = ~x13 & ~x14 & ~x15;
  assign new_n348_ = (new_n126_ | ~x28) & (new_n349_ | ~x72) & (new_n350_ | x72);
  ...
  assign new_n352_ = (~x60 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n353_ | ~x74) & (~x72 | new_n354_ | x74);
  assign new_n353_ = (x72 | (x73 ? ~x57 : ~x59)) & (~x55 | ~x72 | x73);
  assign new_n354_ = x73 ? ~x52 : ~x56;
  assign new_n355_ = x65 ? (x68 | ~x69 | (~new_n356_ & new_n358_)) : (~x68 | ~new_n363_ | x69);
  assign new_n356_ = ~new_n126_ & ~new_n357_;
  assign new_n357_ = x71 ? ~x60 : ~x28;
  assign new_n358_ = x72 ? (~new_n362_ & (new_n361_ | x74)) : (~new_n360_ & (new_n359_ | ~x74));
  assign new_n359_ = x71 ? (x73 ? ~x57 : ~x59) : (x73 ? ~x25 : ~x27);
  assign new_n360_ = x73 & ~x74 & (x58 | (x26 & ~x71));
  assign new_n361_ = x71 ? (x73 ? ~x52 : ~x56) : (x73 ? ~x20 : ~x24);
  assign new_n362_ = ~x73 & x74 & (x71 ? x55 : x23);
  assign new_n363_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n364_ = x65 & ~x66 & ~x67 & x68 & ~new_n365_ & ~x69;
  assign new_n365_ = x70 ? ~new_n363_ : (~x71 | ((~x12 | (~new_n347_ & x00)) & (~x00 | new_n347_ | x12)));
  assign new_n366_ = x68 ? ~new_n369_ : (x67 ? new_n370_ : ~new_n367_);
  assign new_n367_ = x69 & ((~new_n348_ & (x70 ^ x71)) | (x70 & (new_n368_ | (~new_n352_ & x71))));
  assign new_n368_ = x73 & ~x74 & x58 & ~x72;
  assign new_n369_ = ~x69 & ~x70 & ~x71 & (x67 ? x44 : ~new_n352_);
  assign new_n370_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n371_ | ~x70);
  assign new_n371_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n372_ = ~x67 & ((~new_n370_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? new_n393_ : (new_n403_ | (~new_n112_ & (new_n374_ | new_n384_)));
  assign new_n374_ = ~x70 & (new_n375_ | (x65 & x68 & new_n380_ & ~x69));
  assign new_n375_ = x71 & (x65 ? (~x68 & ~new_n376_ & x69) : (x68 & ~new_n379_ & ~x69));
  assign new_n376_ = (new_n126_ | ~x29) & ~new_n377_ & ~new_n378_;
  assign new_n377_ = x72 & ((~x73 & (x74 ? x24 : x25)) | (x21 & x73 & ~x74));
  assign new_n378_ = ~x72 & ((x73 & (x74 ? x26 : x27)) | (x28 & ~x73 & x74));
  ...
  assign new_n382_ = ~x72 & ((x59 & x73 & ~x74) | (x60 & ~x73 & x74));
  assign new_n383_ = x72 & ((~x73 & (x74 ? x56 : x57)) | (x53 & x73 & ~x74));
  assign new_n384_ = x70 & (x65 ? (~x68 & ~new_n385_ & x69) : (x68 & new_n392_ & ~x69));
  assign new_n385_ = (new_n126_ | new_n391_) & (new_n386_ | x72) & (new_n389_ | ~x72);
  assign new_n386_ = (new_n388_ | ~x71) & (~x58 | ~x73 | ~x74) & (new_n387_ | x71);
  assign new_n387_ = (~x73 | (x74 ? ~x26 : ~x27)) & (~x28 | x73 | ~x74);
  assign new_n388_ = (~x60 | x73 | ~x74) & (~x59 | ~x73 | x74);
  assign new_n389_ = (new_n390_ | x74) & (x73 | ~x74 | (x71 ? ~x56 : ~x24));
  assign new_n390_ = x71 ? (x73 ? ~x53 : ~x57) : (x73 ? ~x21 : ~x25);
  assign new_n391_ = x71 ? ~x61 : ~x29;
  assign new_n392_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n393_ = ~x65 & (x66 ? new_n402_ : (new_n394_ | new_n400_));
  assign new_n394_ = ~x68 & (x67 ? ~new_n395_ : (x69 & (new_n397_ | new_n398_)));
  assign new_n395_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n396_ | ~x70);
  assign new_n396_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n397_ = (x70 ^ x71) & ((~new_n126_ & x29) | new_n377_ | new_n378_);
  assign new_n398_ = x70 & (new_n399_ | (x71 & (new_n381_ | new_n382_ | new_n383_)));
  assign new_n399_ = x73 & x74 & x58 & ~x72;
  assign new_n400_ = x68 & ~x69 & new_n401_ & ~x70;
  assign new_n401_ = ~x71 & (x67 ? x45 : (new_n381_ | new_n382_ | new_n383_));
  assign new_n402_ = ~x67 & ((~new_n395_ & ~x68) | (new_n108_ & x45 & x68));
  assign new_n403_ = x65 & ~x66 & new_n404_ & ~x67;
  assign new_n404_ = x68 & ~x69 & (x70 ? new_n392_ : (~new_n379_ & x71));
  assign z14 = x64 ? (~x65 & (x66 ? new_n435_ : ~new_n427_)) : ~new_n406_;
  assign new_n406_ = ~new_n423_ & (new_n112_ | (x70 ? (~new_n417_ & ~new_n425_) : new_n407_));
  assign new_n407_ = (~x71 | (x65 ? (~new_n410_ | x68) : (~new_n408_ | ~x68))) & (~x65 | ~new_n413_ | ~x68);
  assign new_n408_ = ~new_n409_ & ~x69;
  assign new_n409_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n410_ = x69 & ((~new_n126_ & x30) | (~new_n412_ & ~x72) | (~new_n411_ & x72));
  assign new_n411_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n412_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n413_ = ~x69 & ~x71 & (new_n414_ | (~new_n416_ & ~x72) | (~new_n415_ & x72));
  assign new_n414_ = x62 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n415_ = (~x57 | x73 | ~x74) & (~x54 | ~x73 | x74);
  assign new_n416_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n417_ = x65 & ~x68 & x69 & (new_n418_ | new_n419_ | new_n421_);
  assign new_n418_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n419_ = x72 & ((~new_n415_ & x71) | (~new_n411_ & ~x71) | (new_n420_ & x58));
  assign new_n420_ = ~x73 & ~x74;
  assign new_n421_ = ~x72 & ((~new_n422_ & x74) | (x73 & ~new_n357_ & ~x74));
  assign new_n422_ = x71 ? (x73 ? ~x59 : ~x61) : (x73 ? ~x27 : ~x29);
  assign new_n423_ = x65 & ~x66 & ~x67 & x68 & ~new_n424_ & ~x69;
  assign new_n424_ = x70 ? (x71 | ((~x32 | x46 | ~x47) & (~x46 | (x32 & x47)))) : (new_n409_ | ~x71);
  assign new_n425_ = new_n426_ & ~x65;
  assign new_n426_ = x68 & ~x69 & ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n427_ = x68 ? ~new_n432_ : (x67 ? new_n433_ : ~new_n428_);
  assign new_n428_ = x69 & ((~new_n429_ & (x70 ^ x71)) | (x70 & (new_n431_ | (~new_n430_ & x71))));
  assign new_n429_ = (new_n126_ | ~x30) & (new_n411_ | ~x72) & (new_n412_ | x72);
  assign new_n430_ = ~new_n414_ & (new_n416_ | x72) & (new_n415_ | ~x72);
  assign new_n431_ = new_n420_ & x58 & x72;
  assign new_n432_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n430_);
  assign new_n433_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n434_ | ~x70);
  assign new_n434_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n435_ = ~x67 & ((~new_n433_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x64 ? (~x65 & (new_n448_ | new_n452_)) : (new_n437_ | (new_n453_ & x65));
  assign new_n437_ = ~new_n112_ & (x65 ? (x68 ? new_n446_ : new_n438_) : new_n447_);
  assign new_n438_ = x69 & ((~new_n439_ & (x70 ^ x71)) | (x70 & (new_n445_ | (~new_n442_ & x71))));
  assign new_n439_ = (new_n126_ | ~x31) & (new_n440_ | ~x72) & (new_n441_ | x72);
  assign new_n440_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n441_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n442_ = (~x63 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n443_ | x74) & (x72 | new_n444_ | ~x74);
  assign new_n443_ = (~x72 | (x73 ? ~x55 : ~x59)) & (~x61 | x72 | ~x73);
  assign new_n444_ = x73 ? ~x60 : ~x62;
  assign new_n445_ = x58 & x72 & ~x73 & x74;
  assign new_n446_ = ~x69 & ~x70 & ~new_n442_ & ~x71;
  assign new_n447_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n448_ = ~x66 & (x68 ? new_n449_ : (x67 ? ~new_n450_ : new_n438_));
  assign new_n449_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n442_);
  assign new_n450_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n451_ | ~x70);
  assign new_n451_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n452_ = x66 & ~x67 & ((~new_n450_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n453_ = ~x66 & new_n447_ & ~x67;
endmodule
