// Benchmark "FAU" written by ABC on Sat Aug  1 07:40:56 2020
...
module FAU ( 
  ...
  assign z14 = x64 ? (~x65 & (x66 ? new_n409_ : ~new_n405_)) : ~new_n389_;
  assign new_n389_ = ~new_n403_ & (new_n112_ | (x70 ? new_n399_ : (~new_n390_ & ~new_n395_)));
  assign new_n390_ = x71 & (x65 ? (~x68 & ~new_n391_ & x69) : (x68 & ~new_n394_ & ~x69));
  assign new_n391_ = (new_n126_ | ~x30) & (new_n392_ | ~x72) & (new_n393_ | x72);
  ...
  assign new_n398_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n399_ = x65 ? (x68 | ~x69 | (~new_n400_ & new_n401_)) : (~x68 | ~new_n402_ | x69);
  assign new_n400_ = ~new_n126_ & (x62 | (x30 & ~x71));
  assign new_n401_ = x71 ? (x72 ? new_n397_ : new_n398_) : (x72 ? new_n392_ : new_n393_);
  ...
  assign new_n406_ = (new_n391_ | (~x70 ^ x71)) & (~x70 | ((new_n126_ | ~x62) & (new_n396_ | ~x71)));
  assign new_n407_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n396_);
  assign new_n408_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x70 | ((~x46 | ~x71) & (~x30 | x69 | x71)));
  assign new_n409_ = ~x67 & ((~new_n408_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x64 ? (~x65 & (new_n422_ | new_n426_)) : (new_n411_ | (new_n427_ & x65));
  assign new_n411_ = ~new_n112_ & (x65 ? (x68 ? new_n420_ : new_n412_) : new_n421_);
  assign new_n412_ = x69 & ((~new_n413_ & (x70 ^ x71)) | (x70 & (new_n419_ | (~new_n416_ & x71))));
  ...
  assign new_n416_ = (~x63 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n418_ | ~x73) & (~x72 | new_n417_ | x73);
  assign new_n417_ = x74 ? ~x58 : ~x59;
  assign new_n418_ = (x72 | (x74 ? ~x60 : ~x61)) & (~x55 | ~x72 | x74);
  assign new_n419_ = ~x73 & x74 & x62 & ~x72;
  assign new_n420_ = ~x69 & ~x70 & ~new_n416_ & ~x71;
  assign new_n421_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n422_ = ~x66 & (x68 ? new_n423_ : (x67 ? ~new_n424_ : new_n412_));
  assign new_n423_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n416_);
  assign new_n424_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n425_ | ~x70);
  assign new_n425_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n426_ = x66 & ~x67 & ((~new_n424_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n427_ = ~x66 & new_n421_ & ~x67;
endmodule
