// Benchmark "FAU" written by ABC on Sat Aug  1 07:42:44 2020
...
module FAU ( 
  ...
  assign new_n364_ = ((~x66 & ~x67) | (~new_n365_ & ~new_n374_)) & (~x65 | x66 | ~new_n378_ | x67);
  assign new_n365_ = ~x70 & ((new_n370_ & x65) | (x71 & (x65 ? new_n366_ : new_n373_)));
  assign new_n366_ = ~x68 & x69 & (new_n367_ | new_n368_ | new_n369_);
  ...
  assign new_n370_ = x68 & ~x69 & ~x71 & (new_n371_ | new_n372_);
  assign new_n371_ = x72 & ((~x73 & (x74 ? x56 : x57)) | (x53 & x73 & ~x74));
  assign new_n372_ = ~x72 & ((x73 & (x74 ? x58 : x59)) | (x60 & ~x73 & x74));
  assign new_n373_ = x68 & ~x69 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n374_ = x70 & (x65 ? (~x68 & ~new_n375_ & x69) : (x68 & new_n377_ & ~x69));
  assign new_n375_ = ~new_n376_ & (x71 | (~new_n368_ & ~new_n369_)) & (~x71 | (~new_n371_ & ~new_n372_));
  assign new_n376_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x61 | (x29 & ~x71));
  assign new_n377_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n378_ = x68 & ~x69 & (x70 ? new_n377_ : new_n379_);
  assign new_n379_ = x71 & ((x00 & ~x13 & (x14 | x15)) | (x13 & (~x00 | (~x14 & ~x15))));
  assign new_n380_ = x68 ? (~new_n383_ | x69) : (x67 ? new_n384_ : (new_n381_ | ~x69));
  assign new_n381_ = (new_n382_ | ~x70) & ((~x70 ^ x71) | (~new_n367_ & ~new_n368_ & ~new_n369_));
  assign new_n382_ = (new_n126_ | ~x61) & (~x71 | (~new_n371_ & ~new_n372_));
  assign new_n383_ = ~x70 & ~x71 & (x67 ? x45 : (new_n371_ | new_n372_));
  assign new_n384_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x70 | ((~x45 | ~x71) & (~x29 | x69 | x71)));
  assign new_n385_ = ~x67 & ((~new_n384_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (x66 ? new_n419_ : ~new_n411_)) : ~new_n387_;
  assign new_n387_ = ~new_n407_ & (new_n112_ | (x70 ? (~new_n399_ & ~new_n409_) : new_n388_));
  assign new_n388_ = (~new_n395_ | ~x65) & (~x71 | (x65 ? ~new_n391_ : ~new_n389_));
  assign new_n389_ = x68 & ~new_n390_ & ~x69;
  assign new_n390_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n391_ = ~x68 & x69 & (new_n392_ | (~new_n394_ & ~x72) | (~new_n393_ & x72));
  assign new_n392_ = x30 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n393_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n394_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n395_ = x68 & ~x69 & ~x71 & (new_n396_ | new_n397_ | new_n398_);
  assign new_n396_ = x62 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n397_ = x73 & ((~x72 & (x74 ? x59 : x60)) | (x54 & x72 & ~x74));
  assign new_n398_ = x72 & ~x73 & (x74 ? x57 : x58);
  assign new_n399_ = x65 & ~x68 & x69 & (new_n400_ | new_n401_ | new_n404_);
  assign new_n400_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n401_ = ~x72 & (x73 ? ~new_n402_ : new_n403_);
  assign new_n402_ = x71 ? (x74 ? ~x59 : ~x60) : (x74 ? ~x27 : ~x28);
  assign new_n403_ = x74 & (x61 | (x29 & ~x71));
  assign new_n404_ = x72 & ((~new_n405_ & ~x74) | (~x73 & ~new_n406_ & x74));
  assign new_n405_ = x71 ? (x73 ? ~x54 : ~x58) : (x73 ? ~x22 : ~x26);
  assign new_n406_ = x71 ? ~x57 : ~x25;
  assign new_n407_ = x65 & ~x66 & ~x67 & x68 & ~new_n408_ & ~x69;
  assign new_n408_ = x70 ? (x71 | ((~x32 | x46 | ~x47) & (~x46 | (x32 & x47)))) : (new_n390_ | ~x71);
  assign new_n409_ = new_n410_ & ~x65;
  assign new_n410_ = x68 & ~x69 & ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n411_ = x68 ? ~new_n416_ : (x67 ? new_n417_ : ~new_n412_);
  assign new_n412_ = x69 & ((~new_n413_ & (x70 ^ x71)) | (x70 & (new_n415_ | (~new_n414_ & x71))));
  assign new_n413_ = ~new_n392_ & (new_n394_ | x72) & (new_n393_ | ~x72);
  assign new_n414_ = ~new_n396_ & ~new_n397_ & ~new_n398_;
  assign new_n415_ = ~x73 & x74 & x61 & ~x72;
  assign new_n416_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n414_);
  assign new_n417_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n418_ | ~x70);
  assign new_n418_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n419_ = ~x67 & ((~new_n417_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x64 ? (~x65 & (new_n432_ | new_n436_)) : (new_n421_ | (new_n437_ & x65));
  assign new_n421_ = ~new_n112_ & (x65 ? (x68 ? new_n430_ : new_n422_) : new_n431_);
  assign new_n422_ = x69 & ((~new_n423_ & (x70 ^ x71)) | (x70 & (new_n429_ | (~new_n426_ & x71))));
  assign new_n423_ = (new_n126_ | ~x31) & (new_n424_ | ~x72) & (new_n425_ | x72);
  assign new_n424_ = (x73 | (x74 ? ~x26 : ~x27)) & (~x23 | ~x73 | x74);
  assign new_n425_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n426_ = (~x63 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n427_ | ~x74) & (~x72 | new_n428_ | x74);
  assign new_n427_ = (x72 | (x73 ? ~x60 : ~x62)) & (~x58 | ~x72 | x73);
  assign new_n428_ = x73 ? ~x55 : ~x59;
  assign new_n429_ = x73 & ~x74 & x61 & ~x72;
  assign new_n430_ = ~x69 & ~x70 & ~new_n426_ & ~x71;
  assign new_n431_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n432_ = ~x66 & (x68 ? new_n433_ : (x67 ? ~new_n434_ : new_n422_));
  assign new_n433_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n426_);
  assign new_n434_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n435_ | ~x70);
  assign new_n435_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n436_ = x66 & ~x67 & ((~new_n434_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n437_ = ~x66 & new_n431_ & ~x67;
endmodule
