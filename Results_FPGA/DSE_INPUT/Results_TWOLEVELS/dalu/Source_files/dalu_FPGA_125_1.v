// Benchmark "FAU" written by ABC on Sat Aug  1 07:39:51 2020
...
module FAU ( 
  ...
  assign z06 = x64 ? (~x65 & (new_n221_ | new_n226_)) : (new_n209_ | (new_n220_ & x65));
  assign new_n209_ = ~new_n112_ & (x65 ? ~new_n210_ : new_n217_);
  assign new_n210_ = x68 ? (x69 | x70 | new_n214_ | x71) : (~x69 | (~new_n211_ & (~x70 | new_n214_ | ~x71)));
  assign new_n211_ = (x70 ^ x71) & ((~new_n126_ & x22) | new_n212_ | new_n213_);
  assign new_n212_ = x72 & ((~x73 & (x74 ? x17 : x18)) | (x16 & x73 & ~x74));
  assign new_n213_ = ~x72 & ((x21 & ~x73 & x74) | (x73 & (x74 ? x19 : x20)));
  ...
  assign new_n222_ = x69 & (new_n211_ | (x70 & ~new_n214_ & x71));
  ...
  assign z07 = x64 ? (~x65 & (new_n240_ | new_n245_)) : (new_n228_ | (new_n239_ & x65));
  assign new_n228_ = ~new_n112_ & (x65 ? ~new_n229_ : new_n236_);
  assign new_n229_ = x68 ? (x69 | x70 | new_n233_ | x71) : (~x69 | (~new_n230_ & (~x70 | new_n233_ | ~x71)));
  assign new_n230_ = (x70 ^ x71) & ((~new_n126_ & x23) | new_n231_ | new_n232_);
  assign new_n231_ = x72 & ((~x73 & (x74 ? x18 : x19)) | (x16 & x73 & ~x74));
  assign new_n232_ = ~x72 & ((x22 & ~x73 & x74) | (x73 & (x74 ? x20 : x21)));
  ...
  assign new_n237_ = x00 ? (x07 | (~x06 & (x06 | (~x05 & (x05 | (~x04 & (new_n119_ | x04))))))) : ~x07;
  assign new_n238_ = x32 ? (x39 | (~x38 & (x38 | (~x37 & (x37 | (~x36 & (new_n124_ | x36))))))) : ~x39;
  assign new_n239_ = ~x66 & new_n236_ & ~x67;
  assign new_n240_ = ~x66 & (x68 ? new_n242_ : (x67 ? ~new_n243_ : new_n241_));
  assign new_n241_ = x69 & (new_n230_ | (x70 & ~new_n233_ & x71));
  ...
  assign new_n254_ = x69 & (new_n255_ | (x70 & ~new_n251_ & x71));
  assign new_n255_ = (x70 ^ x71) & ((~new_n126_ & x24) | new_n256_ | new_n257_);
  assign new_n256_ = x72 & ((~x73 & (x74 ? x19 : x20)) | (x16 & x73 & ~x74));
  assign new_n257_ = ~x72 & ((x23 & ~x73 & x74) | (x73 & (x74 ? x21 : x22)));
  ...
  assign new_n306_ = ~new_n308_ & (~x70 | ~x71 | (new_n307_ & ~new_n290_));
  ...
  assign z11 = x64 ? (~x65 & (x66 ? new_n352_ : ~new_n332_)) : ~new_n314_;
  assign new_n314_ = ~new_n330_ & (new_n112_ | (new_n324_ & (new_n315_ | x70)));
  assign new_n315_ = (~x68 | new_n316_ | x69) & (~x65 | x68 | ~x69 | new_n321_ | ~x71);
  ...
  assign new_n321_ = ~new_n322_ & ~new_n323_ & (~x24 | ~x73 | ~x74) & (~x23 | x73 | x74);
  assign new_n322_ = x72 & ((x22 & x74) | (x73 & (x19 | x74)));
  assign new_n323_ = ~x72 & ((x25 & ~x74) | (~x73 & (x26 | ~x74)));
  assign new_n324_ = x65 ? (x68 | ~x69 | (~new_n325_ & ~new_n326_)) : (~x68 | ~new_n329_ | x69);
  assign new_n325_ = ~new_n126_ & ((x59 & x71) | (x27 & x70 & ~x71));
  assign new_n326_ = x70 & (x71 ? (new_n319_ | new_n320_) : (new_n327_ | new_n328_));
  assign new_n327_ = x72 & ((~x73 & (x74 ? x22 : x23)) | (x19 & x73 & ~x74));
  assign new_n328_ = ~x72 & ((x26 & ~x73 & x74) | (x73 & (x74 ? x24 : x25)));
  assign new_n329_ = x70 & ~x71 & ((x43 & (new_n124_ | ~x32)) | (x32 & ~new_n124_ & ~x43));
  assign new_n330_ = x65 & ~x66 & ~x67 & x68 & ~new_n331_ & ~x69;
  assign new_n331_ = x70 ? (x71 | ((~x43 | (~new_n124_ & x32)) & (~x32 | new_n124_ | x43))) : (new_n317_ | ~x71);
  assign new_n332_ = x68 ? (~new_n348_ | x69) : (x67 ? new_n350_ : (new_n333_ | ~x69));
  assign new_n333_ = (new_n334_ | ~x72) & ~new_n339_ & ~new_n346_ & (new_n342_ | x72);
  assign new_n334_ = ~new_n337_ & ~new_n338_ & (~x73 | (~new_n335_ & new_n336_));
  assign new_n335_ = x19 & (x70 ? (~x71 & ~x74) : x71);
  assign new_n336_ = (~x70 | ((~x51 | ~x71 | x74) & (~x27 | x71 | ~x74))) & (~x71 | ~x74 | (~x59 & x70));
  assign new_n337_ = x74 & ((x22 & (x70 ? (~x71 & ~x73) : x71)) | (x71 & ~x73 & x54 & x70));
  assign new_n338_ = x70 & ~x73 & ~x74 & (x71 ? x55 : x23);
  assign new_n339_ = x73 & ((~new_n340_ & x74) | (x70 & ~x72 & ~new_n341_ & ~x74));
  assign new_n340_ = (~x24 | (x70 ? (x71 | x72) : ~x71)) & (~x71 | x72 | ~x56 | ~x70);
  assign new_n341_ = x71 ? ~x57 : ~x25;
  assign new_n342_ = ~new_n345_ & (x73 | (~new_n343_ & new_n344_));
  assign new_n343_ = x26 & (x70 ? (~x71 & x74) : x71);
  assign new_n344_ = (~x70 | ((~x58 | ~x71 | ~x74) & (~x27 | x71 | x74))) & (~x71 | x74 | (~x59 & x70));
  assign new_n345_ = x71 & ~x74 & x25 & ~x70;
  assign new_n346_ = x23 & ~x70 & new_n347_ & x71;
  assign new_n347_ = ~x73 & ~x74;
  assign new_n348_ = ~x70 & ~x71 & (x67 ? x43 : (~new_n349_ | new_n318_));
  assign new_n349_ = ~new_n319_ & ~new_n320_;
  ...
  assign z12 = x64 ? (~new_n375_ & ~x65) : (new_n354_ | (x65 & new_n394_ & ~x66));
  assign new_n354_ = ~new_n112_ & ((~new_n355_ & ~x70) | new_n372_ | (x70 & (new_n364_ | new_n370_)));
  assign new_n355_ = (~x68 | new_n356_ | x69) & (~x65 | x68 | ~x69 | new_n361_ | ~x71);
  ...
  assign new_n361_ = (new_n362_ | x74) & (new_n363_ | ~x74) & (~x28 | (x72 ? (~x73 | ~x74) : x73));
  assign new_n362_ = (~x72 | (x73 ? ~x20 : ~x24)) & (~x26 | x72 | ~x73);
  assign new_n363_ = (~x23 | x73) & (x72 | (~x25 & x73));
  assign new_n364_ = x65 & ~x68 & x69 & (new_n365_ | new_n366_ | new_n368_);
  assign new_n365_ = ~new_n126_ & (x71 ? x60 : x28);
  assign new_n366_ = x73 & ((~new_n367_ & ~x74) | (~x72 & ~new_n341_ & x74));
  assign new_n367_ = x71 ? (x72 ? ~x52 : ~x58) : (x72 ? ~x20 : ~x26);
  assign new_n368_ = ~x73 & ((~new_n369_ & x72) | (x27 & ~x71 & ~x72 & x74));
  assign new_n369_ = x71 ? (x74 ? ~x55 : ~x56) : (x74 ? ~x23 : ~x24);
  assign new_n370_ = ~x65 & x68 & new_n371_ & ~x69;
  assign new_n371_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n372_ = new_n374_ & new_n373_ & ~x73 & x74;
  assign new_n373_ = x71 & ~x72;
  assign new_n374_ = x59 & x65 & ~x68 & x69;
  assign new_n375_ = x66 ? ~new_n393_ : (x68 ? ~new_n391_ : new_n376_);
  assign new_n376_ = x67 ? new_n377_ : (~x69 | (~new_n379_ & ~new_n382_ & new_n387_));
  assign new_n377_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n378_ | ~x70);
  assign new_n378_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n379_ = (x70 ^ x71) & ((~new_n381_ & x72) | (new_n380_ & x26 & ~x72));
  assign new_n380_ = x73 & ~x74;
  assign new_n381_ = (~x24 | x73 | x74) & (~x73 | (x74 ? ~x28 : ~x20));
  assign new_n382_ = ~x73 & (new_n385_ | new_n386_ | (x74 & (new_n383_ | ~new_n384_)));
  assign new_n383_ = x23 & (x70 ? (~x71 & x72) : x71);
  assign new_n384_ = (~x70 | ((~x55 | ~x71 | ~x72) & (~x27 | x71 | x72))) & (~x71 | x72 | (~x59 & x70));
  assign new_n385_ = ~x72 & ((x28 & (x70 ? (~x71 & ~x74) : x71)) | (x60 & x70 & x71 & ~x74));
  assign new_n386_ = x56 & x70 & x71 & x72 & ~x74;
  assign new_n387_ = (~new_n390_ | ~x70) & (x72 | (~new_n388_ & ~new_n389_));
  assign new_n388_ = x74 & ((x25 & (x70 ? (~x71 & x73) : x71)) | (x57 & x70 & x71 & x73));
  assign new_n389_ = x58 & x70 & x71 & x73 & ~x74;
  assign new_n390_ = x71 & x72 & x73 & (x74 ? x60 : x52);
  assign new_n391_ = ~x69 & ~x70 & ~x71 & (x67 ? x44 : ~new_n392_);
  assign new_n392_ = ~new_n358_ & ~new_n359_ & ~new_n360_;
  assign new_n393_ = ~x67 & ((~new_n377_ & ~x68) | (new_n108_ & x44 & x68));
  assign new_n394_ = ~x67 & x68 & ~x69 & (x70 ? new_n371_ : new_n357_);
  assign z13 = x64 ? (~x65 & (new_n419_ | new_n434_)) : (new_n396_ | (new_n416_ & x65));
  assign new_n396_ = ~new_n112_ & ((~new_n397_ & ~x70) | new_n415_ | (x70 & (new_n406_ | new_n413_)));
  assign new_n397_ = (~x68 | new_n398_ | x69) & (~x65 | x68 | ~x69 | new_n403_ | ~x71);
  ...
  assign new_n403_ = (~x29 | (x72 ? (~x73 | ~x74) : x74)) & (new_n404_ | x73) & (new_n405_ | ~x73);
  assign new_n404_ = (~x72 | (x74 ? ~x24 : ~x25)) & (~x28 | x72 | ~x74);
  assign new_n405_ = (~x21 | x74) & (x72 | (~x26 & x74));
  assign new_n406_ = x65 & ~x68 & x69 & (new_n407_ | new_n408_ | new_n411_);
  assign new_n407_ = ~new_n126_ & (x71 ? x61 : x29);
  assign new_n408_ = x74 & ((~new_n410_ & ~x73) | (~x72 & ~new_n409_ & x73));
  assign new_n409_ = x71 ? ~x58 : ~x26;
  assign new_n410_ = x71 ? (x72 ? ~x56 : ~x60) : (x72 ? ~x24 : ~x28);
  assign new_n411_ = ~x74 & ((~new_n412_ & x72) | (x27 & ~x71 & ~x72 & x73));
  assign new_n412_ = x71 ? (x73 ? ~x53 : ~x57) : (x73 ? ~x21 : ~x25);
  assign new_n413_ = ~x65 & x68 & new_n414_ & ~x69;
  assign new_n414_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n415_ = new_n374_ & new_n380_ & new_n373_;
  assign new_n416_ = new_n417_ & ~x66;
  assign new_n417_ = ~x67 & x68 & ~x69 & (x70 ? new_n414_ : new_n418_);
  assign new_n418_ = ~new_n399_ & x71;
  assign new_n419_ = ~x66 & (x68 ? new_n430_ : (x67 ? ~new_n432_ : new_n420_));
  assign new_n420_ = x69 & ((~new_n421_ & x73) | new_n429_ | (~new_n426_ & ~x73));
  assign new_n421_ = (x74 | (~new_n422_ & new_n423_)) & (new_n424_ | x72) & (~x72 | new_n425_ | ~x74);
  assign new_n422_ = x21 & (x70 ? (~x71 & x72) : x71);
  assign new_n423_ = (~x70 | ((~x53 | ~x71 | ~x72) & (~x27 | x71 | x72))) & (~x71 | x72 | (~x59 & x70));
  assign new_n424_ = (~x26 | (x70 ? (x71 | ~x74) : ~x71)) & (~x58 | ~x70 | ~x71 | ~x74);
  assign new_n425_ = (~x61 | ~x70 | ~x71) & (~x29 | (~x70 ^ x71));
  assign new_n426_ = (new_n404_ | (~x70 ^ x71)) & (~x70 | ((new_n428_ | ~x71) & (~new_n427_ | ~x29 | x71)));
  assign new_n427_ = ~x72 & ~x74;
  assign new_n428_ = x72 ? (x74 ? ~x56 : ~x57) : (x74 ? ~x60 : ~x61);
  assign new_n429_ = x29 & ~x70 & new_n427_ & x71;
  assign new_n430_ = ~x69 & ~x70 & ~x71 & (x67 ? x45 : ~new_n431_);
  assign new_n431_ = ~new_n400_ & ~new_n401_ & ~new_n402_;
  assign new_n432_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n433_ | ~x70);
  assign new_n433_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n434_ = x66 & ~x67 & ((~new_n432_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~new_n453_ & ~x65) : ((~new_n436_ & ~new_n112_) | (new_n470_ & x65));
  assign new_n436_ = (new_n437_ | x70) & (new_n447_ | ~x70) & (~new_n374_ | ~new_n442_ | ~new_n373_);
  assign new_n437_ = (~x68 | x69 | (x65 ? ~new_n438_ : ~new_n446_)) & (~x65 | x68 | ~new_n441_ | ~x69);
  assign new_n438_ = ~x71 & ((~new_n126_ & x62) | new_n439_ | (~new_n440_ & ~x72));
  assign new_n439_ = x72 & ((~x73 & (x74 ? x57 : x58)) | (x54 & x73 & ~x74));
  assign new_n440_ = (~x73 | (x74 ? ~x59 : ~x60)) & (~x61 | x73 | ~x74);
  assign new_n441_ = x71 & (new_n444_ | new_n445_ | (x30 & (new_n442_ | new_n443_)));
  assign new_n442_ = x73 & x74;
  assign new_n443_ = ~x72 & ~x73 & ~x74;
  assign new_n444_ = x72 & ((~x73 & (x74 ? x25 : x26)) | (x22 & x73 & ~x74));
  assign new_n445_ = ~x72 & ((x29 & x74) | (x73 & (x28 | x74)));
  assign new_n446_ = x71 & ((x14 & (~x00 | ~x15)) | (x00 & ~x14 & x15));
  assign new_n447_ = x65 ? (x68 | new_n448_ | ~x69) : (~x68 | ~new_n452_ | x69);
  assign new_n448_ = ~new_n449_ & (~x71 | (~new_n439_ & ~new_n450_)) & (x71 | (~new_n444_ & ~new_n451_));
  assign new_n449_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x62 : x30);
  assign new_n450_ = ~x72 & ((x60 & x73 & ~x74) | (x61 & ~x73 & x74));
  assign new_n451_ = ~x72 & ((x29 & ~x73 & x74) | (x73 & (x74 ? x27 : x28)));
  assign new_n452_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n453_ = x66 ? (new_n469_ | x67) : (x68 ? ~new_n467_ : new_n454_);
  assign new_n454_ = x67 ? new_n455_ : (~x69 | (~new_n457_ & ~new_n458_ & new_n463_));
  assign new_n455_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n456_ | ~x70);
  assign new_n456_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n457_ = (x70 ^ x71) & (new_n444_ | (new_n347_ & x30 & ~x72));
  assign new_n458_ = ~x72 & (new_n461_ | new_n462_ | (x73 & (new_n459_ | ~new_n460_)));
  assign new_n459_ = x28 & (x70 ? (~x71 & ~x74) : x71);
  assign new_n460_ = (~x71 | ~x74 | (~x59 & x70)) & (~x70 | ((~x27 | x71 | ~x74) & (~x60 | ~x71 | x74)));
  assign new_n461_ = x74 & ((x29 & (x70 ? (~x71 & ~x73) : x71)) | (x71 & ~x73 & x61 & x70));
  assign new_n462_ = x62 & x70 & x71 & ~x73 & ~x74;
  assign new_n463_ = (~new_n466_ | ~x70) & (~x73 | (~new_n465_ & (~new_n464_ | ~x54 | ~x70)));
  assign new_n464_ = x71 & x72 & ~x74;
  assign new_n465_ = x74 & ((x30 & (x70 ? (~x71 & x72) : x71)) | (x62 & x70 & x71 & x72));
  assign new_n466_ = x71 & x72 & ~x73 & (x74 ? x57 : x58);
  assign new_n467_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n468_);
  assign new_n468_ = (new_n126_ | ~x62) & ~new_n439_ & (new_n440_ | x72);
  assign new_n469_ = (~new_n108_ | ~x46 | ~x68) & (new_n455_ | x68);
  assign new_n470_ = ~x66 & ~x67 & x68 & ~new_n471_ & ~x69;
  assign new_n471_ = x70 ? ~new_n452_ : ~new_n446_;
  assign z15 = x64 ? (~x65 & (new_n488_ | new_n492_)) : (new_n473_ | (new_n493_ & x65));
  assign new_n473_ = ~new_n112_ & (x65 ? (x68 ? new_n483_ : new_n474_) : new_n487_);
  assign new_n474_ = x69 & ((~new_n475_ & x72) | new_n482_ | (~new_n479_ & ~x72));
  assign new_n475_ = (x74 | (~new_n476_ & new_n477_)) & (new_n424_ | x73) & (~x73 | new_n478_ | ~x74);
  assign new_n476_ = x23 & (x70 ? (~x71 & x73) : x71);
  assign new_n477_ = (~x70 | ((~x55 | ~x71 | ~x73) & (~x27 | x71 | x73))) & (~x71 | x73 | (~x59 & x70));
  assign new_n478_ = (~x63 | ~x70 | ~x71) & (~x31 | (~x70 ^ x71));
  assign new_n479_ = (new_n480_ | (~x70 ^ x71)) & (~x70 | ((new_n481_ | ~x71) & (~new_n347_ | ~x31 | x71)));
  assign new_n480_ = (~x73 | (x74 ? ~x28 : ~x29)) & (~x30 | x73 | ~x74);
  assign new_n481_ = x73 ? (x74 ? ~x60 : ~x61) : (x74 ? ~x62 : ~x63);
  assign new_n482_ = x31 & ~x70 & new_n347_ & x71;
  assign new_n483_ = ~x69 & ~x70 & ~new_n484_ & ~x71;
  assign new_n484_ = (new_n126_ | ~x63) & (new_n485_ | ~x72) & (new_n486_ | x72);
  assign new_n485_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n486_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n487_ = x68 & ~x69 & ((x47 & x70 & ~x71) | (x15 & ~x70 & x71));
  assign new_n488_ = ~x66 & (x68 ? new_n489_ : (x67 ? ~new_n490_ : new_n474_));
  assign new_n489_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n484_);
  assign new_n490_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n491_ | ~x70);
  assign new_n491_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n492_ = x66 & ~x67 & ((~new_n490_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n493_ = ~x66 & new_n487_ & ~x67;
endmodule
