// Benchmark "FAU" written by ABC on Sat Aug  1 07:38:06 2020
...
module FAU ( 
  ...
  assign z14 = x64 ? (~x65 & (x66 ? new_n412_ : ~new_n407_)) : ~new_n391_;
  assign new_n391_ = ~new_n405_ & (new_n112_ | (x70 ? new_n401_ : (~new_n392_ & ~new_n397_)));
  assign new_n392_ = x68 & ~x69 & (x65 ? (~new_n393_ & ~x71) : (~new_n396_ & x71));
  assign new_n393_ = (new_n126_ | ~x62) & (new_n394_ | ~x72) & (new_n395_ | x72);
  ...
  assign new_n397_ = x65 & ~x68 & x69 & ~new_n398_ & x71;
  assign new_n398_ = (new_n126_ | ~x30) & (new_n399_ | ~x72) & (new_n400_ | x72);
  assign new_n399_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n400_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n401_ = x65 ? (x68 | ~x69 | (~new_n402_ & new_n403_)) : (~x68 | ~new_n404_ | x69);
  assign new_n402_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n403_ = x71 ? (x72 ? new_n394_ : new_n395_) : (x72 ? new_n399_ : new_n400_);
  assign new_n404_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n405_ = x65 & ~x66 & ~x67 & x68 & ~new_n406_ & ~x69;
  assign new_n406_ = x70 ? ~new_n404_ : (new_n396_ | ~x71);
  assign new_n407_ = x68 ? (~new_n409_ | x69) : (x67 ? new_n410_ : (new_n408_ | ~x69));
  assign new_n408_ = (new_n398_ | (~x70 ^ x71)) & (~x70 | new_n393_ | ~x71);
  assign new_n409_ = ~x70 & ~x71 & (x67 ? x46 : ~new_n393_);
  assign new_n410_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n411_ | ~x70);
  assign new_n411_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n412_ = ~x67 & ((~new_n410_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = ~new_n426_ | (~new_n435_ & (x68 ? (new_n432_ & ~x69) : (~new_n414_ & x69)));
  assign new_n414_ = ~new_n415_ & ~new_n420_ & ~new_n425_ & (~x73 | (~new_n423_ & ~new_n424_));
  assign new_n415_ = x72 & ((~new_n416_ & x73) | new_n418_ | (x71 & new_n419_ & ~x73));
  assign new_n416_ = (~x23 | (x70 ? x71 : (~x71 | x74))) & (new_n417_ | ~x71) & (~x70 | ~x74 | (~x63 & x71));
  assign new_n417_ = (~x31 | x70 | ~x74) & (~x55 | ~x70 | x74);
  assign new_n418_ = x74 & ((x26 & (x70 ? ~x71 : (x71 & ~x73))) | (x71 & ~x73 & x58 & x70));
  assign new_n419_ = ~x74 & (x70 ? x59 : x27);
  assign new_n420_ = ~x72 & (new_n421_ | (~x71 & ~x74 & x29 & x70));
  assign new_n421_ = ~x73 & (~new_n422_ | (x30 & (x70 ? ~x71 : (x71 & x74))));
  assign new_n422_ = (~x71 | ((~x31 | x70 | x74) & (~x62 | ~x70 | ~x74))) & (~x70 | x74 | (~x63 & x71));
  assign new_n423_ = x74 & ((x28 & (x70 ? ~x71 : (x71 & ~x72))) | (x71 & ~x72 & x60 & x70));
  assign new_n424_ = x71 & ~x72 & ~x74 & (x70 ? x61 : x29);
  assign new_n425_ = ~x71 & ~x73 & ~x74 & x27 & x70;
  assign new_n426_ = (new_n427_ | x65) & (x64 | ~x65 | x66 | ~new_n431_ | x67);
  assign new_n427_ = x64 ? ~new_n428_ : (~x68 | x69 | new_n112_ | new_n430_);
  assign new_n428_ = (x66 ^ x67) & ((~new_n429_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n429_ = (~x15 | (~x70 ^ x71)) & (x70 | x71 | ~x63 | ~x69) & (~x70 | (x71 ? ~x47 : x69));
  assign new_n430_ = (~x15 | x70 | ~x71) & (~x47 | ~x70 | x71);
  assign new_n431_ = x68 & ~new_n430_ & ~x69;
  assign new_n432_ = ~x70 & ~x71 & ((~new_n126_ & x63) | new_n433_ | new_n434_);
  assign new_n433_ = x72 & ((~x73 & (x74 ? x58 : x59)) | (x55 & x73 & ~x74));
  assign new_n434_ = ~x72 & ((x73 & (x74 ? x60 : x61)) | (x62 & ~x73 & x74));
  assign new_n435_ = (~new_n112_ | ~x64 | x65) & (x64 | new_n112_ | ~x65);
endmodule
