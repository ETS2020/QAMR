// Benchmark "FAU" written by ABC on Sat Aug  1 07:35:17 2020
...
module FAU ( 
  ...
  assign z11 = x64 ? (~x65 & (x66 ? new_n339_ : ~new_n332_)) : ~new_n314_;
  assign new_n314_ = ~new_n330_ & (new_n112_ | (~new_n315_ & ~new_n325_));
  ...
  assign new_n328_ = ~new_n329_ & ~x71;
  ...
  assign new_n333_ = ((new_n335_ & ~new_n322_) | (~x70 ^ x71)) & (~x70 | ~x71 | (new_n334_ & ~new_n318_));
  assign new_n334_ = ~new_n319_ & ~new_n320_;
  assign new_n335_ = ~new_n323_ & ~new_n324_;
  assign new_n336_ = ~x70 & ~x71 & (x67 ? x43 : (~new_n334_ | new_n318_));
  assign new_n337_ = (~x11 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x59 | ~x69) & (new_n338_ | ~x70);
  assign new_n338_ = (~x43 | ~x71) & (~x27 | x69 | x71);
  assign new_n339_ = ~x67 & ((~new_n337_ & ~x68) | (new_n108_ & x43 & x68));
  assign z12 = x64 ? (~x65 & (x66 ? new_n364_ : ~new_n357_)) : ~new_n341_;
  ...
  assign new_n343_ = x65 ? (x71 | (~new_n345_ & ~new_n346_ & ~new_n347_)) : ~new_n344_;
  assign new_n344_ = x71 & ((x12 & (~x00 | (~x13 & ~x14 & ~x15))) | (x00 & ~x12 & (x13 | x14 | x15)));
  ...
  assign new_n354_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x60 : x28);
  assign new_n355_ = ~x71 & ((x44 & (~x32 | (~x45 & ~x46 & ~x47))) | (x32 & ~x44 & (x45 | x46 | x47)));
  assign new_n356_ = x68 & ~x69 & (x70 ? new_n355_ : new_n344_);
  ...
  assign new_n361_ = ~x70 & ~x71 & (x67 ? x44 : (~new_n359_ | new_n345_));
  assign new_n362_ = (~x12 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x60 | ~x69) & (new_n363_ | ~x70);
  assign new_n363_ = (~x44 | ~x71) & (~x28 | x69 | x71);
  assign new_n364_ = ~x67 & ((~new_n362_ & ~x68) | (new_n108_ & x44 & x68));
  assign z13 = x64 ? (~x65 & (x66 ? new_n403_ : ~new_n384_)) : ~new_n366_;
  assign new_n366_ = (~new_n382_ | ~x65) & (new_n112_ | (new_n376_ & (new_n367_ | x70)));
  assign new_n367_ = (~x68 | new_n368_ | x69) & (~x65 | x68 | ~x69 | new_n373_ | ~x71);
  ...
  assign new_n373_ = ~new_n374_ & ~new_n375_ & (~x26 | ~x73 | ~x74) & (~x25 | x73 | x74);
  assign new_n374_ = x72 & ((x24 & x74) | (x73 & (x21 | x74)));
  assign new_n375_ = ~x72 & ((x27 & ~x74) | (~x73 & (x28 | ~x74)));
  assign new_n376_ = x65 ? (x68 | ~x69 | (~new_n377_ & ~new_n378_)) : (~x68 | ~new_n381_ | x69);
  assign new_n377_ = ~new_n126_ & ((x61 & x71) | (x29 & x70 & ~x71));
  assign new_n378_ = x70 & (x71 ? (new_n371_ | new_n372_) : (new_n379_ | new_n380_));
  ...
  assign new_n382_ = ~x66 & ~x67 & x68 & ~x69 & (new_n383_ | new_n381_);
  assign new_n383_ = ~x70 & ~new_n369_ & x71;
  assign new_n384_ = x68 ? (~new_n399_ | x69) : (x67 ? new_n401_ : (new_n385_ | ~x69));
  assign new_n385_ = (new_n386_ | ~x72) & ~new_n391_ & ~new_n398_ & (new_n394_ | x72);
  assign new_n386_ = ~new_n389_ & ~new_n390_ & (~x73 | (~new_n387_ & new_n388_));
  assign new_n387_ = x21 & (x70 ? (~x71 & ~x74) : x71);
  assign new_n388_ = (~x70 | ((~x29 | x71 | ~x74) & (~x53 | ~x71 | x74))) & (~x71 | ~x74 | (~x61 & x70));
  assign new_n389_ = x74 & ((x24 & (x70 ? (~x71 & ~x73) : x71)) | (x71 & ~x73 & x56 & x70));
  assign new_n390_ = x70 & ~x73 & ~x74 & (x71 ? x57 : x25);
  assign new_n391_ = x73 & ((~new_n393_ & x74) | (x70 & ~x72 & ~new_n392_ & ~x74));
  assign new_n392_ = x71 ? ~x59 : ~x27;
  assign new_n393_ = (~x26 | (x70 ? (x71 | x72) : ~x71)) & (~x71 | x72 | ~x58 | ~x70);
  assign new_n394_ = ~new_n397_ & (x73 | (~new_n395_ & new_n396_));
  assign new_n395_ = x28 & (x70 ? (~x71 & x74) : x71);
  assign new_n396_ = (~x70 | ((~x60 | ~x71 | ~x74) & (~x29 | x71 | x74))) & (~x71 | x74 | (~x61 & x70));
  assign new_n397_ = x71 & ~x74 & x27 & ~x70;
  assign new_n398_ = x25 & ~x70 & x71 & ~x73 & ~x74;
  assign new_n399_ = ~x70 & ~x71 & (x67 ? x45 : (~new_n400_ | new_n370_));
  assign new_n400_ = ~new_n371_ & ~new_n372_;
  ...
  assign z14 = x64 ? (~new_n425_ & ~x65) : (new_n405_ | (x65 & new_n444_ & ~x66));
  assign new_n405_ = ~new_n112_ & ((~new_n406_ & ~x70) | new_n423_ | (x70 & (new_n415_ | new_n421_)));
  ...
  assign new_n412_ = (new_n413_ | x74) & (new_n414_ | ~x74) & (~x30 | (x72 ? (~x73 | ~x74) : x73));
  assign new_n413_ = (~x72 | (x73 ? ~x22 : ~x26)) & (~x28 | x72 | ~x73);
  assign new_n414_ = (~x25 | x73) & (x72 | (~x27 & x73));
  assign new_n415_ = x65 & ~x68 & x69 & (new_n416_ | new_n417_ | new_n419_);
  assign new_n416_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n417_ = x73 & ((~new_n418_ & ~x74) | (~x72 & ~new_n392_ & x74));
  assign new_n418_ = x71 ? (x72 ? ~x54 : ~x60) : (x72 ? ~x22 : ~x28);
  assign new_n419_ = ~x73 & ((~new_n420_ & x72) | (x29 & ~x71 & ~x72 & x74));
  assign new_n420_ = x71 ? (x74 ? ~x57 : ~x58) : (x74 ? ~x25 : ~x26);
  assign new_n421_ = ~x65 & x68 & new_n422_ & ~x69;
  assign new_n422_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n423_ = new_n424_ & ~x68 & x69 & x61 & x65;
  assign new_n424_ = ~x73 & x74 & x71 & ~x72;
  assign new_n425_ = x66 ? (new_n443_ | x67) : (x68 ? ~new_n441_ : new_n426_);
  assign new_n426_ = x67 ? new_n427_ : (~x69 | (~new_n429_ & ~new_n432_ & new_n437_));
  assign new_n427_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n428_ | ~x70);
  assign new_n428_ = (~x46 | ~x71) & (~x30 | x69 | x71);
  assign new_n429_ = (x70 ^ x71) & ((~new_n431_ & x72) | (new_n430_ & x28 & ~x72));
  assign new_n430_ = x73 & ~x74;
  assign new_n431_ = (~x26 | x73 | x74) & (~x73 | (x74 ? ~x30 : ~x22));
  assign new_n432_ = ~x73 & (new_n435_ | new_n436_ | (x74 & (new_n433_ | ~new_n434_)));
  assign new_n433_ = x25 & (x70 ? (~x71 & x72) : x71);
  assign new_n434_ = (~x70 | ((~x57 | ~x71 | ~x72) & (~x29 | x71 | x72))) & (~x71 | x72 | (~x61 & x70));
  assign new_n435_ = ~x72 & ((x30 & (x70 ? (~x71 & ~x74) : x71)) | (x62 & x70 & x71 & ~x74));
  assign new_n436_ = x58 & x70 & x71 & x72 & ~x74;
  assign new_n437_ = (~new_n440_ | ~x70) & (x72 | (~new_n438_ & ~new_n439_));
  assign new_n438_ = x74 & ((x27 & (x70 ? (~x71 & x73) : x71)) | (x59 & x70 & x71 & x73));
  assign new_n439_ = x60 & x70 & x71 & x73 & ~x74;
  assign new_n440_ = x71 & x72 & x73 & (x74 ? x62 : x54);
  assign new_n441_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n442_);
  assign new_n442_ = ~new_n409_ & ~new_n410_ & ~new_n411_;
  assign new_n443_ = (~new_n108_ | ~x46 | ~x68) & (new_n427_ | x68);
  assign new_n444_ = ~x67 & x68 & ~x69 & (x70 ? new_n422_ : new_n408_);
  assign z15 = x64 ? (~x65 & (new_n463_ | new_n467_)) : (new_n446_ | (new_n468_ & x65));
  assign new_n446_ = ~new_n112_ & (x65 ? (x68 ? new_n458_ : new_n447_) : new_n462_);
  assign new_n447_ = x69 & ((~new_n448_ & x73) | new_n457_ | (~new_n453_ & ~x73));
  assign new_n448_ = (x74 | (~new_n449_ & new_n450_)) & (new_n451_ | x72) & (~x72 | new_n452_ | ~x74);
  assign new_n449_ = x23 & (x70 ? (~x71 & x72) : x71);
  assign new_n450_ = (~x70 | ((~x55 | ~x71 | ~x72) & (~x29 | x71 | x72))) & (~x71 | x72 | (~x61 & x70));
  assign new_n451_ = (~x28 | (x70 ? (x71 | ~x74) : ~x71)) & (~x60 | ~x70 | ~x71 | ~x74);
  assign new_n452_ = (~x63 | ~x70 | ~x71) & (~x31 | (~x70 ^ x71));
  assign new_n453_ = (new_n454_ | (~x70 ^ x71)) & (~x70 | ((new_n455_ | ~x71) & (~new_n456_ | ~x31 | x71)));
  assign new_n454_ = (~x72 | (x74 ? ~x26 : ~x27)) & (~x30 | x72 | ~x74);
  assign new_n455_ = x72 ? (x74 ? ~x58 : ~x59) : (x74 ? ~x62 : ~x63);
  assign new_n456_ = ~x72 & ~x74;
  assign new_n457_ = x31 & ~x70 & new_n456_ & x71;
  assign new_n458_ = ~x69 & ~x70 & ~new_n459_ & ~x71;
  assign new_n459_ = (new_n126_ | ~x63) & (new_n460_ | ~x72) & (new_n461_ | x72);
  assign new_n460_ = (x73 | (x74 ? ~x58 : ~x59)) & (~x55 | ~x73 | x74);
  assign new_n461_ = (~x73 | (x74 ? ~x60 : ~x61)) & (~x62 | x73 | ~x74);
  assign new_n462_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n463_ = ~x66 & (x68 ? new_n464_ : (x67 ? ~new_n465_ : new_n447_));
  assign new_n464_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n459_);
  assign new_n465_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n466_ | ~x70);
  assign new_n466_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n467_ = x66 & ~x67 & ((~new_n465_ & ~x68) | (new_n108_ & x47 & x68));
  assign new_n468_ = ~x66 & new_n462_ & ~x67;
endmodule
