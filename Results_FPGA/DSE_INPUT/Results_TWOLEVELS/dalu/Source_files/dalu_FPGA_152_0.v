// Benchmark "FAU" written by ABC on Sat Aug  1 07:40:55 2020
...
module FAU ( 
  ...
  assign new_n386_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n387_ | ~x70);
  assign new_n387_ = (~x45 | ~x71) & (~x29 | x69 | x71);
  assign new_n388_ = ~x67 & ((~new_n386_ & ~x68) | (new_n108_ & x45 & x68));
  assign z14 = x64 ? (~x65 & (new_n406_ | new_n413_)) : (new_n390_ | (new_n411_ & x65));
  assign new_n390_ = ~new_n112_ & (x70 ? ~new_n400_ : (new_n391_ | new_n396_));
  assign new_n391_ = x68 & ~x69 & (x65 ? (~new_n392_ & ~x71) : (~new_n395_ & x71));
  assign new_n392_ = ~new_n393_ & ~new_n394_ & (~x59 | ~x73 | ~x74) & (~x58 | x73 | x74);
  assign new_n393_ = x72 & ((x57 & x74) | (x73 & (x54 | x74)));
  assign new_n394_ = ~x72 & ((x60 & ~x74) | (~x73 & (x61 | ~x74)));
  assign new_n395_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n396_ = x65 & ~x68 & x69 & ~new_n397_ & x71;
  assign new_n397_ = (new_n126_ | ~x30) & (new_n398_ | ~x72) & (new_n399_ | x72);
  assign new_n398_ = (x73 | (x74 ? ~x25 : ~x26)) & (~x22 | ~x73 | x74);
  assign new_n399_ = (~x73 | (x74 ? ~x27 : ~x28)) & (~x29 | x73 | ~x74);
  assign new_n400_ = x65 ? (x68 | ~x69 | (~new_n401_ & new_n402_)) : (~x68 | ~new_n405_ | x69);
  assign new_n401_ = ~new_n126_ & (x71 ? x62 : x30);
  assign new_n402_ = x71 ? (~new_n403_ & ~new_n404_) : (x72 ? new_n398_ : new_n399_);
  assign new_n403_ = x72 & ((~x73 & (x74 ? x57 : x58)) | (x54 & x73 & ~x74));
  assign new_n404_ = ~x72 & ((x73 & (x74 ? x59 : x60)) | (x61 & ~x73 & x74));
  assign new_n405_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n406_ = ~x66 & (x68 ? new_n410_ : ~new_n407_);
  assign new_n407_ = x67 ? new_n409_ : (~x69 | (~new_n408_ & (new_n397_ | new_n194_)));
  assign new_n408_ = x70 & x71 & ((~new_n126_ & x62) | new_n403_ | new_n404_);
  assign new_n409_ = (~x14 | (x71 ? x70 : ~x69)) & (~x70 | ((~x46 | ~x71) & (~x30 | x69 | x71))) & (~x69 | x70 | x71);
  assign new_n410_ = ~x69 & ~x70 & ~x71 & (x67 ? x46 : ~new_n392_);
  assign new_n411_ = ~x66 & ~x67 & x68 & ~new_n412_ & ~x69;
  assign new_n412_ = x70 ? ~new_n405_ : (new_n395_ | ~x71);
  assign new_n413_ = x66 & ~x67 & ((~new_n409_ & ~x68) | (new_n108_ & x46 & x68));
  assign z15 = x64 ? (~new_n428_ & ~x65) : (new_n415_ | (new_n434_ & x65));
  assign new_n415_ = ~new_n112_ & (x65 ? (x68 ? new_n423_ : new_n416_) : new_n427_);
  assign new_n416_ = x69 & (new_n417_ | (new_n420_ & x70));
  assign new_n417_ = ~new_n194_ & (new_n418_ | new_n419_ | (~new_n126_ & x31));
  assign new_n418_ = x72 & ((~x73 & (x74 ? x26 : x27)) | (x23 & x73 & ~x74));
  assign new_n419_ = ~x72 & ((x73 & (x74 ? x28 : x29)) | (x30 & ~x73 & x74));
  assign new_n420_ = x71 & ((~new_n126_ & x63) | (~new_n422_ & ~x72) | (~new_n421_ & x72));
  ...
  assign new_n424_ = (new_n425_ | x74) & (new_n426_ | ~x74) & (~x63 | (x72 ? (~x73 | ~x74) : x73));
  assign new_n425_ = (~x72 | (x73 ? ~x55 : ~x59)) & (~x61 | x72 | ~x73);
  assign new_n426_ = (~x58 | x73) & (x72 | (~x60 & x73));
  assign new_n427_ = x68 & ~x69 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n428_ = x66 ? (new_n433_ | x67) : (x68 ? ~new_n432_ : new_n429_);
  assign new_n429_ = x67 ? new_n430_ : (~x69 | (~new_n417_ & (~new_n420_ | ~x70)));
  assign new_n430_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n431_ | ~x70);
  assign new_n431_ = (~x47 | ~x71) & (~x31 | x69 | x71);
  assign new_n432_ = ~x69 & ~x70 & ~x71 & (x67 ? x47 : ~new_n424_);
  assign new_n433_ = (~new_n108_ | ~x47 | ~x68) & (new_n430_ | x68);
  assign new_n434_ = ~x66 & new_n427_ & ~x67;
endmodule
