// Benchmark "FAU" written by ABC on Wed Jul 29 03:04:32 2020
...
module FAU ( 
  ...
  assign z02 = ~x13 & x05 & ~x04 & ~x03 & ~x00 & ~x02;
  assign z03 = ~x13 & x05 & ~x04 & ~x03 & x00 & ~x02;
  assign z06 = ~x03 & x04 & (x02 ? (~x05 & ~x13) : (new_n32_ & x05));
  assign new_n32_ = ~x07 & ~x12 & (x00 ? ~new_n33_ : ~new_n34_);
  assign new_n33_ = x01 ? x11 : (x09 | ~x13);
  assign new_n34_ = x01 ? x10 : (x08 | ~x13);
