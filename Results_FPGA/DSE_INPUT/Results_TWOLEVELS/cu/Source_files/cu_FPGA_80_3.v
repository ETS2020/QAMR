// Benchmark "FAU" written by ABC on Wed Jul 29 03:04:58 2020
...
module FAU ( 
  ...
  assign z01 = ~x03 & ((~x04 & x05 & (x13 | (~x02 & ~x13))) | (x02 & x04 & ~x05));
  ...
  assign new_n38_ = x05 ? (x07 | x12 | new_n39_ | ~x13) : ~x02;
  assign new_n39_ = x00 ? (x01 ? x11 : x09) : (x01 ? x10 : x08);
  assign z07 = ~x02 & ~x03 & ~x04 & x05 & ~x13;
  assign z08 = ~x03 & x04 & (x05 ? (~x12 & x13) : x02);
  assign z09 = x06 & x13;
