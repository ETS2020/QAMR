// Benchmark "FAU" written by ABC on Wed Jul 29 03:04:33 2020
...
module FAU ( 
  ...
  assign z06 = ~x03 & x04 & ((new_n38_ & x05) | (x02 & ~x05 & ~x13));
  assign new_n38_ = ~x07 & ~x12 & x13 & (x00 ? ~new_n39_ : new_n40_);
  assign new_n39_ = x01 ? x11 : (x02 | x09);
  assign new_n40_ = ~x02 & (x01 ? ~x10 : ~x08);
