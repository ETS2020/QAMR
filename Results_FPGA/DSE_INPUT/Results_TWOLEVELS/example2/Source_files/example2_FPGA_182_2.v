...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    new_n184_, new_n186_, new_n191_, new_n196_, new_n197_, new_n198_,
  ...
  assign z29 = ~x01 & ~x04 & new_n191_ & ~x42;
  assign new_n191_ = x47 & x77 & x79 & (x81 ? (~x82 ^ x84) : (x82 ^ x84));
  ...
  assign new_n243_ = ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & (new_n246_ | (new_n245_ & x04))));
  assign new_n245_ = x78 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n246_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n236_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign z61 = ~x01 & x79 & ~new_n249_ & x80;
  assign new_n249_ = ((~x81 ^ ~x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n251_ : (new_n252_ | new_n253_))) | (new_n253_ & x77 & ~x78));
  assign new_n251_ = x04 ? (x79 & (x42 | (new_n180_ & new_n181_))) : (~x79 | ~x81);
  assign new_n252_ = x04 & ~x79;
  assign new_n253_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n249_ & x82;
  assign z64 = ~x01 & ((new_n256_ & x78 & ~x79) | (x79 & ~new_n249_ & x83));
