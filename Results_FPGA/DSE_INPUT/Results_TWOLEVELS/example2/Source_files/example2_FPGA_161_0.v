// Benchmark "FAU" written by ABC on Wed Jul 29 06:49:30 2020
...
module FAU ( 
  ...
  assign z22 = ~x01 & (new_n177_ | (~x41 & new_n181_ & x79));
  assign new_n177_ = x04 & (new_n178_ | (~x42 & x77 & (~new_n179_ | ~new_n180_)));
  assign new_n178_ = x78 & ~x79;
  ...
  assign new_n186_ = x77 & x79 & (x81 ? (x82 ^ ~x84) : (x82 ^ x84));
  ...
  assign z33 = ~x01 & new_n195_ & ~x04;
  assign new_n195_ = x77 & x79 & ((~new_n196_ & (~x82 ^ x84)) | (~new_n197_ & (x82 ^ x84)));
  assign new_n196_ = (~x05 | ~x42 | ~x78 | (~x81 ^ x83)) & (x42 | ~x51 | ~x81);
  assign new_n197_ = (~x05 | ~x42 | ~x78 | (x81 ^ x83)) & (x42 | ~x51 | x81);
  assign z34 = ~x01 & ~x04 & new_n199_ & x52;
  assign new_n199_ = x77 & ~new_n200_ & x79;
  assign new_n200_ = ((~x82 ^ x84) | ((~x78 | ((x81 | x83) & (~x42 | ~x81 | ~x83))) & (x42 | x81))) & ((x82 ^ x84) | ((x42 | ~x81) & (~x78 | ((~x81 | x83) & (~x42 | x81 | ~x83)))));
  ...
  assign z56 = (~new_n234_ & x79) | ~x00 | x01 | (~x01 & ~x77 & ~x78);
  assign new_n234_ = (~new_n235_ | x01) & (~x76 | (x77 & x78));
  assign new_n235_ = (x81 ^ x84) & (x77 ^ x78);
  assign z57 = x03 & ~x02 & x00 & ~x01;
  assign z58 = ~x01 & (x04 ? (x77 ? (~new_n238_ & x79) : (x78 & ~x79)) : ~x79);
  assign new_n238_ = (x40 | ~x42 | ~x78) & (~new_n180_ | ~new_n239_ | x42 | ~x43);
  assign new_n239_ = ~x74 & x80;
  assign z59 = ~x01 & ((~x04 & ~x79) | (~new_n241_ & x77));
  assign new_n241_ = ~new_n242_ & (~x04 | (~new_n178_ & (x42 | (new_n179_ & new_n180_))));
  assign new_n242_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n235_ & x79) | new_n177_ | (~x04 & ~x79));
  assign z61 = ~x01 & x79 & ~new_n245_ & x80;
  assign new_n245_ = ((~x81 ^ ~x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & (new_n248_ | (x77 & (new_n249_ | (new_n247_ & x04))));
  assign new_n247_ = ~x42 & (~new_n179_ | ~new_n180_);
  assign new_n248_ = x78 & (x79 ? (x81 & (x77 ? ~x04 : x84)) : x04);
  assign new_n249_ = x81 & x84 & ~x78 & x79;
  assign z63 = ~x01 & x79 & ~new_n245_ & x82;
  assign z64 = ~x01 & ((new_n252_ & x79) | (x04 & ~x77 & x78 & ~x79));
  assign new_n252_ = ~new_n245_ & x83;
