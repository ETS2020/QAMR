// Benchmark "FAU" written by ABC on Wed Jul 29 06:48:35 2020
...
module FAU ( 
  ...
  assign z04 = ~x01 & (~x78 | ~x77 | (x77 & x78 & x79));
  ...
  assign z56 = (~new_n234_ & ~x01) | ~x00 | x01 | (x76 & ~x77 & x79);
  assign new_n234_ = (x78 | ~x79) & (x77 | (x78 & (~x78 | ~x79 | (~x81 ^ x84))));
  ...
  assign z60 = ~x01 & ((new_n246_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n179_ | ~x79)));
