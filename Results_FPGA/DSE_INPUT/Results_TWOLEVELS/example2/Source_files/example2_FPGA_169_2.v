...
module FAU ( 
  ...
  assign z22 = ~x01 & x78 & ((~new_n180_ & ~x77) | (x04 & ~new_n177_ & x77));
  assign new_n177_ = x79 & (x42 | (new_n178_ & new_n179_));
  assign new_n178_ = x43 & ~x74 & x80;
  assign new_n179_ = x81 & x82 & ~x83 & x84;
  assign new_n180_ = (x41 | ~x75 | ~x79 | (x81 ^ x84)) & (~x04 | x79);
  ...
  assign new_n243_ = x04 & x78 & (~x79 | (~x42 & (~new_n178_ | ~new_n179_)));
  assign new_n244_ = x40 & (x78 ? x04 : ~x79);
  assign z60 = ~x01 & ((new_n234_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n246_ | ~x79)));
  assign new_n246_ = ~x42 & x77 & (~new_n178_ | ~new_n179_);
  ...
  assign new_n250_ = x04 ? (x79 & (x42 | (new_n178_ & new_n179_))) : (~x79 | ~x81);
