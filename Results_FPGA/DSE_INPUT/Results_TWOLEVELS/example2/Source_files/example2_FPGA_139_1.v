...
module FAU ( 
  ...
  assign new_n212_ = x79 & (x67 | x75) & (x81 ^ ~x84);
  ...
  assign new_n242_ = (~x40 | (x78 ? ~x04 : x79)) & (~x04 | ~x78 | (x79 & (new_n178_ | x42)));
  assign z60 = ~x01 & ((new_n232_ & x79) | new_n177_ | (~x04 & ~x79));
  assign z61 = ~x01 & x79 & ~new_n245_ & x80;
  assign new_n245_ = (x04 | ~x77 | ~x78) & ((~x81 ^ ~x84) | (x77 ^ ~x78));
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n247_ : (new_n248_ | new_n249_))) | (new_n249_ & x77 & ~x78));
  assign new_n247_ = x04 ? (x79 & (new_n178_ | x42)) : (~x79 | ~x81);
  assign new_n248_ = x04 & ~x79;
  assign new_n249_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n245_ & x82;
  assign z64 = ~x01 & ((new_n252_ & x78 & ~x79) | (x79 & ~new_n245_ & x83));
