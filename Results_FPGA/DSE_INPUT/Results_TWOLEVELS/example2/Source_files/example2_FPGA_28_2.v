...
module FAU ( 
  ...
  assign z01 = (~x77 & (~x78 | (~x01 & x04 & x78 & ~x79))) | (~x78 & ~x79) | (~x01 & ((x77 & x78) | (~x04 & ~x79)));
  assign z02 = ~new_n157_ & x79;
  assign new_n157_ = (x01 | ~x75 | x77 | ~x78) & (~x66 | ~x77 | x78);
  ...
  assign z22 = new_n178_ | (~x01 & x04 & x78 & (new_n179_ | ~x79));
  ...
  assign z49 = (new_n218_ & x69) | (~x01 & new_n220_ & x04);
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = (new_n218_ & x70) | (~x01 & new_n222_ & x04);
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = (new_n218_ & x71) | (~x01 & new_n224_ & x04);
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = (new_n218_ & x72) | (~x01 & new_n226_ & x04);
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = (new_n218_ & x73) | (~x01 & new_n228_ & x04);
  ...
  assign z56 = (x79 & (new_n234_ | (x76 & (~x77 | ~x78)))) | ~new_n235_ | (~x77 & ~x78);
  assign new_n234_ = (~x81 ^ ~x84) & ((x77 & ~x78) | (~x01 & ~x77 & x78));
  assign new_n235_ = x00 & ~x01;
  assign z57 = x03 & new_n235_ & ~x02;
  assign z58 = (new_n241_ & ~x01) | (x77 & (new_n240_ | (~x01 & new_n238_ & x04)));
  assign new_n238_ = x78 & x79 & ((new_n181_ & new_n239_) | (~x40 & x42));
  assign new_n239_ = ~x42 & x43 & ~x74 & x80;
  assign new_n240_ = ~x78 & ~x79 & x40 & ~x42;
  assign new_n241_ = ~x79 & (~x04 | (x04 & ~x77 & x78));
  assign z59 = (x77 & (new_n244_ | (~x01 & new_n243_ & x04))) | (~x01 & ~x04 & ~x79);
  assign new_n243_ = x78 & (~x79 | (~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n244_ = x40 & ((~x78 & ~x79) | (~x01 & x04 & x78));
  assign z60 = (new_n234_ & x79) | (~x01 & (x04 ? (x78 & (new_n179_ | ~x79)) : ~x79));
  assign z61 = x79 & ~new_n247_ & x80;
  assign new_n247_ = ((x81 ^ x84) | ((~x77 | x78) & (x01 | x77 | ~x78))) & (~x77 | ~x78 | x01 | x04);
  ...
  assign z64 = (x79 & ~new_n247_ & x83) | (new_n254_ & ~x77 & x78 & ~x79);
  assign new_n254_ = ~x01 & x04;
  assign z65 = new_n256_ & x79;
  assign new_n256_ = x84 & ((~x01 & x78 & (x77 ? ~x04 : x81)) | (x77 & ~x78 & x81));
endmodule
