// Benchmark "FAU" written by ABC on Wed Jul 29 06:48:46 2020
...
module FAU ( 
  ...
  assign z22 = ~x01 & ((~x41 & new_n181_ & x79) | (~new_n178_ & x04));
  assign new_n178_ = (x79 | (x77 & (~x77 | ~x78))) & (x42 | ~x77 | ~x78 | (new_n179_ & new_n180_));
  assign new_n179_ = x43 & ~x74 & x80;
  assign new_n180_ = x81 & x82 & ~x83 & x84;
  assign new_n181_ = ((x75 & ~x77) | (x66 & ~x78)) & (~x81 ^ x84);
  assign z23 = x01 | ~x00 | (~x04 & x05 & ~x79);
  assign z24 = ~x01 & ~x04 & x05 & ~x43 & (new_n156_ | ~x79);
  ...
  assign z56 = ~x00 | x01 | (x79 & ~new_n156_ & (x76 | (~new_n233_ & ~x01)));
  assign new_n233_ = ~x81 ^ x84;
  assign z57 = x03 & ~x02 & x00 & ~x01;
  assign z58 = ~x01 & (~new_n239_ | (~x42 & (new_n236_ | new_n238_)));
  assign new_n236_ = new_n237_ & new_n156_ & ~x74 & x04 & x43;
  assign new_n237_ = x79 & x80 & x81 & x82 & ~x83 & x84;
  assign new_n238_ = x40 & ~x78 & ~x79;
  assign new_n239_ = x04 ? ((x77 | x79) & (x40 | ~x42 | ~x77 | ~x78 | ~x79)) : x79;
  assign z59 = ~x01 & (new_n242_ | (new_n241_ & x04) | (~x79 & (~x04 | (new_n156_ & x04))));
  assign new_n241_ = ~x42 & x77 & x78 & (~new_n179_ | ~new_n180_);
  assign new_n242_ = x40 & ((~x78 & ~x79) | (x04 & x77 & x78));
  assign z60 = ~x01 & ((x79 & ~new_n156_ & ~new_n233_) | (~x04 & ~x79) | (~new_n178_ & x04));
  assign z61 = ~x01 & x79 & ~new_n245_ & x80;
  assign new_n245_ = new_n156_ ? x04 : (x81 ^ x84);
  assign z62 = ~x01 & (new_n248_ | new_n249_ | (new_n247_ & x04));
  assign new_n247_ = x77 & x78 & (~x79 | (~x42 & (~new_n179_ | ~new_n180_)));
  ...
  assign z65 = ~x01 & x79 & x84 & (new_n156_ ? ~x04 : x81);
endmodule
