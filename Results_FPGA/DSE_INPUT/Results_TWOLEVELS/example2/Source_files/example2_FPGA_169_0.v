...
module FAU ( 
  ...
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x77 & ~x78));
  ...
  assign new_n178_ = x79 & ((x77 & ~x78) | (x75 & ~x77 & x78)) & (~x81 ^ x84);
  ...
  assign new_n245_ = x40 & (x78 ? x04 : ~x79);
  ...
  assign z64 = ~x01 & ((x79 & ~new_n248_ & x83) | (new_n255_ & x78 & ~x79));
