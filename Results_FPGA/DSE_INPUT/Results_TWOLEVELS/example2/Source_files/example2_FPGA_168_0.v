...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n242_, new_n244_, new_n247_, new_n249_, new_n250_, new_n251_,
    new_n254_, new_n256_;
  assign z00 = new_n154_ | (x06 & ~x40) | (x40 & x52);
  assign new_n154_ = ~x01 & ((x40 & (~x77 | x79)) | (x77 & ~x78 & ~x79));
  assign z01 = ~x01 & ((~x79 & ((x04 & x78) | ~x04 | (x77 & ~x78))) | (~x77 & ~x78) | (x77 & x78 & x79));
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = ~x01 & ((x77 & (x78 ^ ~x79)) | ~x77 | (x40 & x79));
  ...
  assign z51 = ~x01 & ((new_n224_ & x04) | (new_n218_ & x71));
  ...
  assign z53 = ~x01 & ((new_n228_ & x04) | (new_n218_ & x73));
  ...
  assign z58 = ~x01 & ((~new_n238_ & x77) | (~x79 & (~x04 | (x04 & ~x77 & x78))));
  assign new_n238_ = ~new_n242_ & (~x04 | ~x79 | (~new_n239_ & (~new_n240_ | ~new_n241_)));
  assign new_n239_ = ~x40 & x42;
  assign new_n240_ = ~x42 & x43 & ~x74 & x78;
  assign new_n241_ = x82 & ~x83 & x84 & x80 & x81;
  assign new_n242_ = ~x42 & ~x78 & ~x79;
  assign z59 = ~x01 & ((x77 & ((~x79 & (~x78 | (x04 & x78))) | (x04 & ~new_n244_ & x78))) | (~x04 & ~x79));
  assign new_n244_ = ~x40 & (x42 | (new_n180_ & new_n181_));
  assign z60 = ~x01 & ((new_n235_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n179_ | ~x79)));
