// Benchmark "FAU" written by ABC on Wed Jul 29 06:49:04 2020
...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    ...
    new_n234_, new_n237_, new_n239_, new_n242_, new_n244_, new_n245_,
  ...
  assign z58 = ~x01 & (x04 ? (x78 & (x77 ? (~new_n237_ & x79) : ~x79)) : ~x79);
  assign new_n237_ = (x40 | ~x42) & (~new_n180_ | x42 | ~x43 | x74 | ~x80);
  assign z59 = ~x01 & ((~x79 & (~x04 | (x04 & x77 & x78))) | (x04 & ~new_n239_ & x77));
  assign new_n239_ = ~x40 & (x42 | ~x78 | (new_n179_ & new_n180_));
  assign z60 = ~x01 & ((new_n234_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n178_ | ~x79)));
  assign z61 = ~x01 & x79 & ~new_n242_ & x80;
  assign new_n242_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n244_ : (new_n245_ | new_n246_))) | (new_n246_ & x77 & ~x78));
  assign new_n244_ = x04 ? (x79 & (x42 | (new_n179_ & new_n180_))) : (~x79 | ~x81);
  assign new_n245_ = x04 & ~x79;
  assign new_n246_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n242_ & x82;
  assign z64 = ~x01 & ((new_n249_ & x78 & ~x79) | (x79 & ~new_n242_ & x83));
