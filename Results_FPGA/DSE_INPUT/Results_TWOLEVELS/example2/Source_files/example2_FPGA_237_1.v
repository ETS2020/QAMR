// Benchmark "FAU" written by ABC on Wed Jul 29 06:49:58 2020
...
module FAU ( 
  ...
  assign new_n195_ = ((~x82 ^ x84) | ((x42 | x81) & (~x05 | ((~x42 | ~x81 | ~x83) & (x81 | x83))))) & ((x82 ^ x84) | ((x42 | ~x81) & (~x05 | ((~x42 | x81 | ~x83) & (~x81 | x83)))));
  assign z34 = ~x01 & ~x04 & new_n197_ & x52;
  assign new_n197_ = x77 & new_n198_ & x78;
  assign new_n198_ = x79 & (((x82 ^ x84) & ((x42 & x81 & x83) | (~x81 & (~x42 | ~x83)))) | ((~x82 ^ x84) & ((x42 & ~x81 & x83) | (x81 & (~x42 | ~x83)))));
