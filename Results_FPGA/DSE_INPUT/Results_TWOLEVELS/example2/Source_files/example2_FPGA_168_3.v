// Benchmark "FAU" written by ABC on Wed Jul 29 06:49:33 2020
...
module FAU ( 
  ...
  wire new_n176_, new_n177_, new_n178_, new_n179_, new_n180_, new_n183_,
    ...
    new_n246_, new_n247_, new_n248_, new_n251_, new_n253_;
  ...
  assign z58 = ~x01 & ((new_n237_ & x04) | (~x79 & (new_n238_ | ~x04)));
  assign new_n237_ = x78 & (x77 ? (x79 & (x42 | (new_n179_ & new_n180_))) : ~x79);
  assign new_n238_ = x40 & ~x42 & x77;
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & ((new_n240_ & x04) | (~new_n241_ & ~x79))));
  assign new_n240_ = ~x42 & x78 & (~new_n179_ | ~new_n180_);
  assign new_n241_ = ~x40 & (~x04 | ~x78);
  assign z60 = ~x01 & ((new_n234_ & x79) | (~x04 & ~x79) | (x04 & x78 & (new_n178_ | ~x79)));
  assign z61 = ~x01 & x79 & ~new_n244_ & x80;
  assign new_n244_ = ((x81 ^ x84) | (x77 ^ ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x78 & (x77 ? ~new_n246_ : (new_n247_ | new_n248_))) | (new_n248_ & x77 & ~x78));
  assign new_n246_ = x04 ? (x79 & (x42 | (new_n179_ & new_n180_))) : (~x79 | ~x81);
  assign new_n247_ = x04 & ~x79;
  assign new_n248_ = x79 & x81 & x84;
  assign z63 = ~x01 & x79 & ~new_n244_ & x82;
  assign z64 = ~x01 & ((new_n251_ & x78 & ~x79) | (x79 & ~new_n244_ & x83));
