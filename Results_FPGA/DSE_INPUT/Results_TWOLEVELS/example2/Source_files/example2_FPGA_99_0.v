// Benchmark "FAU" written by ABC on Wed Jul 29 06:49:07 2020
...
module FAU ( 
  ...
  assign z01 = ~x01 & ((~x77 & (~x78 | (x04 & ~x79))) | (~x04 & ~x79) | (x77 & x78));
  assign z02 = ~new_n157_ & ~x01;
  assign new_n157_ = (~x66 | ~x77 | x78) & (~x75 | x77 | ~x78 | ~x79);
  ...
  assign z22 = ~x01 & (new_n177_ | (x04 & ((new_n178_ & ~x42) | ~x79)));
  assign new_n177_ = ~x41 & ~new_n157_ & (~x81 ^ x84);
  ...
  assign z47 = ~x01 & ((x04 & new_n213_ & ~x77) | (new_n214_ & x77));
  assign new_n213_ = ~x79 & (x52 ? x15 : x07);
  assign new_n214_ = ~x78 & (x67 | x75) & (~x81 ^ x84);
  assign z48 = ~x01 & (new_n216_ | (new_n217_ & x68));
  assign new_n216_ = x04 & ~x77 & ~x79 & (x52 ? x16 : x08);
  assign new_n217_ = x77 & ~x78 & (~x81 ^ x84);
  ...
  assign z56 = ~new_n233_ | (x76 & (~x78 | (~x77 & x79)));
  assign new_n233_ = x00 & ~x01 & (x01 | (~new_n234_ & (x77 | x78)));
  assign new_n234_ = (~x81 ^ ~x84) & (x77 ? ~x78 : (x78 & x79));
  assign z57 = x03 & ~x02 & x00 & ~x01;
  assign z58 = ~x01 & (x04 ? (x77 ? (x78 & ~new_n237_ & x79) : ~x79) : ~x79);
  assign new_n237_ = (x40 | ~x42) & (~new_n180_ | x42 | ~x43 | x74 | ~x80);
  assign z59 = ~x01 & ((~x79 & (~x04 | (x04 & x77))) | (x04 & x77 & ~new_n239_ & x78));
  assign new_n239_ = ~x40 & (x42 | (new_n179_ & new_n180_));
  assign z60 = ~x01 & (new_n234_ | (~x04 & ~x79) | (x04 & (~x79 | (new_n178_ & ~x42))));
  assign z61 = ~x01 & ~new_n242_ & x80;
  assign new_n242_ = ((x81 ^ x84) | (x77 ? x78 : (~x78 | ~x79))) & (~x78 | ~x79 | x04 | ~x77);
  assign z62 = ~x01 & (x77 ? (new_n244_ | new_n246_) : ~new_n245_);
  assign new_n244_ = x04 & (~x79 | (~x42 & x78 & (~new_n179_ | ~new_n180_)));
  assign new_n245_ = (~x04 | x79) & (~x81 | ~x84 | ~x78 | ~x79);
  assign new_n246_ = x81 & ((~x04 & x78 & x79) | (~x78 & x84));
  assign z63 = ~x01 & ~new_n242_ & x82;
  assign z64 = ~x01 & ((~new_n242_ & x83) | (x04 & ~x77 & ~x79));
  assign z65 = new_n250_ & ~x01;
  assign new_n250_ = x84 & ((x77 & ((~x78 & x81) | (~x04 & x78 & x79))) | (x79 & x81 & ~x77 & x78));
endmodule
