...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n234_, new_n235_, new_n238_, new_n239_, new_n240_, new_n243_,
    new_n245_, new_n247_, new_n250_, new_n252_;
  assign z00 = (x40 & (x52 | (~x01 & ~x78))) | (~x01 & ~new_n154_ & x78) | (x06 & ~x40);
  assign new_n154_ = x77 & (~x77 | ~x79);
  assign z01 = ~x01 & ((~x77 & ~x78) | ~x79 | (x77 & x78 & x79));
  assign z02 = ~x01 & x79 & ((x75 & ~x77 & x78) | (x66 & x77 & ~x78));
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = ~x01 & (~x78 | (~new_n154_ & x78));
  ...
  assign z58 = ~x01 & ((x04 & ~new_n238_ & x78) | (~x79 & (new_n240_ | ~x04)));
  assign new_n238_ = (x77 | x79) & (~new_n239_ | x42 | ~x43 | x74 | ~x77 | ~x79);
  assign new_n239_ = x80 & x81 & x82 & ~x83 & x84;
  assign new_n240_ = x77 & ~x78 & x40 & ~x42;
  assign z59 = ~x01 & ((~x04 & ~x79) | (x77 & ((x04 & x78) | (x40 & ~x79))));
  assign z60 = ~x01 & ((new_n235_ & x79) | (new_n243_ & x04) | (~x79 & (~x04 | (x04 & x78))));
  assign new_n243_ = ~x42 & x77 & x78 & (~new_n180_ | ~new_n181_);
  assign z61 = ~x01 & x79 & ~new_n245_ & x80;
  assign new_n245_ = ((x81 ^ x84) | (~x77 ^ x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((new_n247_ & x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign new_n247_ = x81 & (x77 ? (x78 ? ~x04 : x84) : (x78 & x84));
  assign z63 = ~x01 & x79 & ~new_n245_ & x82;
  assign z64 = ~x01 & ((new_n250_ & x78 & ~x79) | (x79 & ~new_n245_ & x83));
