// Benchmark "FAU" written by ABC on Wed Jul 29 03:50:25 2020
...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n39_ & (x07 ^ x08);
  assign z05 = (x09 & (~x07 | ~x08)) | new_n43_ | ~x04 | (x07 & x08 & ~x09);
  assign new_n43_ = x16 & (x03 | (~x02 & x04));
  assign z06 = new_n43_ | ((~x07 | ~x08 | x09) & x10) | ~x04 | (x07 & x08 & ~x09 & ~x10);
  ...
  assign new_n48_ = x12 & (~x07 | ~x08 | x09 | x10 | x11);
  assign new_n49_ = ~x10 & ~x11 & ~x12 & x07 & x08 & ~x09;
  assign z09 = (~new_n51_ & x04) | (~new_n49_ & x13) | ~x04 | (x03 & x16);
  assign new_n51_ = ~new_n53_ & (~x07 | ~x08 | x09 | ~new_n52_ | x10);
  assign new_n52_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n53_ = ~x02 & x16;
  assign z10 = x04 & (new_n56_ | (x07 & x08 & new_n55_ & ~x09));
  assign new_n55_ = ~new_n39_ & (x00 | (~x12 & ~x13 & ~x10 & ~x11));
