...
module FAU ( 
  ...
  assign z05 = new_n43_ | (x09 & (~x06 | ~x07 | ~x08)) | ~x04 | (x06 & x07 & x08 & ~x09);
  assign new_n43_ = x16 & (x03 | (~x02 & x04));
  assign z06 = new_n43_ | (x10 & (~new_n45_ | ~x08 | x09)) | ~x04 | (new_n45_ & x08 & ~x09 & ~x10);
  assign new_n45_ = x06 & x07;
  assign z07 = new_n43_ | (x11 & (~new_n45_ | ~new_n49_)) | new_n47_ | ~x04;
  ...
  assign z09 = (x04 & ((~new_n53_ & ((x02 & ~x03) | ~x16)) | (~x02 & x16))) | new_n54_ | ~x04 | (x03 & x16);
  assign new_n53_ = x06 ? (x07 & (~new_n49_ | x11 | x12 | x13)) : ~x13;
  assign new_n54_ = x13 & (~x08 | x09 | x10 | x11 | x12);
  assign z10 = ~new_n56_ & x04;
  assign new_n56_ = (~x06 | ~x08 | x09 | new_n39_ | new_n57_) & (~new_n39_ | ~x14);
  assign new_n57_ = (~x00 | ~x07) & (x12 | x13 | x10 | x11);
