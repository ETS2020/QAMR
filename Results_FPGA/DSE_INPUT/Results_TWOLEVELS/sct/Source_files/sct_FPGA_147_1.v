...
module FAU ( 
  ...
  assign z06 = new_n43_ | ~x04 | x10 | (new_n45_ & x08 & ~x09);
  assign new_n45_ = x06 & x07;
  assign z07 = new_n43_ | (x11 & (~new_n45_ | ~x08 | x09)) | ~x04 | (new_n45_ & x08 & ~x09 & ~x11);
  assign z08 = new_n43_ | new_n48_ | new_n49_ | ~x04;
  assign new_n48_ = x12 & (~new_n45_ | ~x08 | x09 | x11);
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x11 & ~x12;
  assign z09 = (~new_n51_ & x04) | (~new_n49_ & x13) | ~x04 | (x03 & x16);
  assign new_n51_ = ~new_n53_ & (~x06 | ~x07 | ~x08 | ~new_n52_ | x09);
  assign new_n52_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n53_ = ~x02 & x16;
  assign z10 = x04 & (new_n56_ | (x06 & x07 & new_n55_ & x08));
  assign new_n55_ = ~x09 & ~new_n39_ & (x00 | (~x11 & ~x12 & ~x13));
