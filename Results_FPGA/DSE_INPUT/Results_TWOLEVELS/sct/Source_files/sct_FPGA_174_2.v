...
module FAU ( 
  ...
  assign z06 = ~new_n48_ | ~x04 | (x04 & (new_n46_ | ~new_n47_));
  assign new_n46_ = x08 & (~x06 | ~x07) & ((x02 & ~x03) | ~x16);
  assign new_n47_ = (~x09 | ~x10) & (x02 | ~x16);
  assign new_n48_ = (~x03 | ~x16) & (x08 | ~x10);
  ...
  assign z13 = x04 & (new_n56_ | ~new_n47_ | new_n43_ | x03);
