...
module FAU ( 
  ...
  assign z07 = new_n43_ | ~x04 | new_n47_ | x11;
  assign new_n47_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = new_n43_ | new_n49_ | ~x04 | (~new_n47_ & x12);
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x12;
  assign z09 = (~new_n51_ & x04) | (~new_n49_ & x13) | ~x04 | (x03 & x16);
  assign new_n51_ = ~new_n53_ & (~x06 | ~x07 | ~x08 | ~new_n52_ | x09);
  assign new_n52_ = ~x10 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign new_n53_ = ~x02 & x16;
  assign z10 = x04 & (new_n56_ | (x06 & x07 & new_n55_ & x08));
  assign new_n55_ = ~x09 & ~new_n39_ & (x00 | (~x10 & ~x12 & ~x13));
