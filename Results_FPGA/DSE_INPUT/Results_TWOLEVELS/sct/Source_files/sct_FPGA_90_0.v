...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ~new_n39_ & (x07 | x10);
  ...
  assign z06 = (~new_n45_ & x04) | ~new_n47_ | ~x04 | ((~x08 | x09) & x10);
  assign new_n45_ = ~new_n46_ & (new_n39_ | (x06 ? x07 : ~x10));
  assign new_n46_ = ~x02 & x16;
  assign new_n47_ = (x09 | x10 | ~x06 | ~x08) & (~x03 | ~x16);
  ...
  assign z09 = (~new_n54_ & x04) | (~new_n52_ & x13) | ~x04 | (x03 & x16);
  assign new_n54_ = ~new_n46_ & (~x06 | ~x08 | x09 | ~new_n55_ | x10);
  assign new_n55_ = ~x11 & ~x12 & ~x13 & ((x02 & ~x03) | ~x16);
  assign z10 = ~new_n57_ & x04;
  assign new_n57_ = (~new_n39_ | ~x14) & (~x06 | ~x08 | x09 | new_n39_ | new_n58_);
  assign new_n58_ = (~x00 | ~x07) & (x12 | x13 | x10 | x11);
  assign z12 = x04 & (new_n46_ | x03);
  assign z14 = x04 & x17;
  assign z11 = x02;
  assign z13 = x04;
endmodule
