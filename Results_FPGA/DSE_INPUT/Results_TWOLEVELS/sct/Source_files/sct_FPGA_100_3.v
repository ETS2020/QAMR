...
module FAU ( 
  ...
  assign z03 = x04 & ((x02 & ((~x06 & x07) | (~x03 & x06 & ~x07))) | (~x16 & (x06 ^ x07)));
  assign z04 = ~new_n41_ & x04;
  assign new_n41_ = (~x07 | ((~x02 | (~x06 ^ x08)) & (~x06 | x08 | x16))) & (~x08 | ((x07 | ((~x02 | x03) & x16)) & (x06 | x16)));
  ...
  assign z07 = ~new_n47_ | (x16 & (x03 | (~x02 & x04)));
  assign new_n47_ = (new_n49_ | ~x11) & x04 & (~new_n48_ | x09 | x10 | x11);
  assign new_n48_ = x06 & x07 & x08;
  assign new_n49_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = ~new_n51_ | (x16 & (x03 | (~x02 & x04)));
  assign new_n51_ = (~x12 | (new_n48_ & ~x09 & ~x10 & ~x11)) & x04 & (~new_n48_ | x11 | x12 | x09 | x10);
  assign z09 = (~new_n53_ & x04) | new_n56_ | ~x04 | (x03 & x16);
  assign new_n53_ = ~new_n54_ & (~x06 | ~x07 | ~x08 | ~new_n55_ | x09);
  assign new_n54_ = ~x02 & x16;
  assign new_n55_ = ~x10 & ~x11 & ~x12 & ~x13 & (x02 | ~x16);
  assign new_n56_ = x13 & (~new_n48_ | x11 | x12 | x09 | x10);
  assign z10 = x04 & (new_n58_ | (x14 & x16 & (~x02 | x03)));
  assign new_n58_ = x06 & x07 & x08 & ~x09 & ~new_n54_ & ~new_n59_;
  assign new_n59_ = ~x00 & (x12 | x13 | x10 | x11);
  assign z12 = x04 & (new_n54_ | x03);
  assign z14 = x04 & x17;
  assign z11 = x02;
  assign z13 = x04;
endmodule
