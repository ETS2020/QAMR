...
module FAU ( 
  ...
  assign z03 = ~new_n39_ & ((~x06 & x07) | (x04 & x06 & ~x07));
  assign z04 = ~new_n39_ & ((x07 & (x06 ^ x08)) | (x04 & ~x07 & x08));
  assign z05 = ~new_n43_ | (x16 & (x03 | (~x02 & x04)));
  assign new_n43_ = (~x09 | (x06 & x07 & x08)) & x04 & (~x06 | ~x07 | ~x08 | x09);
  assign z06 = ~new_n45_ | (x16 & (x03 | (~x02 & x04)));
  assign new_n45_ = ((x06 & x07 & x08 & ~x09) | ~x10) & x04 & (~x06 | ~x07 | ~x08 | x09 | x10);
  ...
  assign z09 = new_n53_ | (x16 & (x03 | (~x02 & x04))) | new_n55_ | ~x04;
  ...
  assign z10 = new_n58_ | (x06 & x07 & x08 & new_n57_ & ~x09);
  assign new_n57_ = ~new_n39_ & (x00 | (~x12 & ~x13 & ~x10 & ~x11));
  assign new_n58_ = x04 & new_n39_ & x14;
  assign z12 = x04 & (x03 | (~x02 & x16));
  assign z13 = x07 | (x04 & (x03 | (~x02 & x16) | (((x02 & ~x03) | ~x16) & (~x06 | (x06 & ~x07)))));
  assign z14 = x04 & x17;
  assign z11 = x02;
endmodule
