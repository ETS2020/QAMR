// Benchmark "FAU" written by ABC on Wed Jul 29 03:50:03 2020
...
module FAU ( 
  ...
  assign z02 = x04 & ~new_n39_ & (~x08 | (~x06 & x08));
  assign new_n39_ = x16 & (~x02 | x03);
  assign z03 = x04 & ~new_n39_ & (x06 ^ x07);
  assign z04 = x04 & ~new_n39_ & (x06 ? ~x07 : x08);
  assign z05 = (x09 & (~x06 | ~x07)) | new_n43_ | ~x04 | (x06 & x07 & ~x09);
  assign new_n43_ = x16 & (x03 | (~x02 & x04));
  assign z06 = new_n43_ | ((~x06 | ~x07 | x09) & x10) | ~x04 | (x06 & x07 & ~x09 & ~x10);
  assign z07 = new_n43_ | ~new_n46_;
  assign new_n46_ = (~x11 | (x06 & x07 & ~x09 & ~x10)) & x04 & (~x06 | ~x07 | x09 | x10 | x11);
  assign z08 = new_n43_ | new_n48_ | new_n49_ | ~x04;
  assign new_n48_ = x12 & (~x06 | ~x07 | x09 | x10 | x11);
  assign new_n49_ = ~x10 & ~x11 & ~x12 & x06 & x07 & ~x09;
  assign z09 = (~new_n51_ & x04) | (~new_n49_ & x13) | ~x04 | (x03 & x16);
  assign new_n51_ = ~new_n53_ & (~x06 | ~x07 | x09 | ~new_n52_ | x10);
