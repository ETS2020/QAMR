// Benchmark "FAU" written by ABC on Wed Jul 29 03:50:14 2020
...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & (~x16 | (x02 & (~x07 | (~x03 & x07))));
  assign z03 = x04 & ((x02 & ((~x03 & ~x06 & x07) | (x06 & ~x07))) | (~x16 & (x06 ^ x07)));
  assign z04 = ~new_n41_ & x04;
  assign new_n41_ = ((x06 ? (~x07 | x08) : ~x08) | ((~x02 | x03) & x16)) & (x07 | ~x08 | (~x02 & x16));
  ...
  assign z10 = x04 & (new_n59_ | (x06 & new_n57_ & x07));
  assign new_n57_ = x08 & ~x09 & ~new_n58_ & (~x16 | (x02 & ~x03));
