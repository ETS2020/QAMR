// Benchmark "FAU" written by ABC on Wed Jul 29 03:08:35 2020
...
module FAU ( 
  ...
  assign new_n24_ = ~x10 & (~x02 | ~x04 | (x08 & (~x09 | ~x13)));
  assign z2 = (~new_n26_ & x03) | ~x05 | (~x03 & ~x06);
  assign new_n26_ = (~x02 | ~x04 | ((~x09 | ~x13) & (x08 | x11))) & (~x11 | (x02 & x04 & ~x08));
  assign z3 = (x03 & (new_n29_ | (new_n28_ & x02))) | ~x05 | (~x03 & ~x07);
  assign new_n28_ = x04 & ((x09 & x13) | (~x08 & ~x11 & ~x12));
  assign new_n29_ = x12 & (~x02 | ~x04 | x08 | x11);
