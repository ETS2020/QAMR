// Benchmark "FAU" written by ABC on Wed Jul 29 03:08:29 2020
...
module FAU ( 
  ...
  assign new_n26_ = (x08 | x10 | x11) & (~x04 | ~x09 | ~x13);
  assign new_n27_ = x04 & (~x11 | (x02 & ~x08 & ~x10));
  assign z3 = ~new_n32_ | (x03 & (new_n31_ | (x02 & (new_n29_ | new_n30_))));
  assign new_n29_ = x04 & x09 & x13;
