...
module FAU ( 
  ...
  assign new_n36_ = (new_n39_ | ~x05) & (new_n37_ | x06) & (x05 | x13 | ~x19);
  assign new_n37_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n38_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n39_ = (~x07 | x13 | ~x24) & (x06 | ~x13 | ~x19 | x24);
  ...
  assign new_n51_ = (x05 | x13 | ~x19) & (~x07 | ~x24 | (x13 ? x06 : ~x05));
  ...
  assign new_n59_ = (~new_n61_ | ~x01 | ~x03 | ~x06 | ~x08) & (x01 | x03 | ~new_n60_ | x08);
  ...
  assign z6 = (~new_n71_ & ~x24) | (~new_n77_ & ~x13) | (x24 & (new_n79_ | ~new_n80_));
  assign new_n71_ = (new_n47_ | new_n75_) & ~new_n72_ & (~new_n76_ | ~x06);
  assign new_n72_ = ~new_n73_ & (~x03 | (x11 & (new_n74_ | ~x06)));
  assign new_n73_ = (x02 | x10 | ~x21) & (~x05 | ~x13 | ~x15);
  assign new_n74_ = x14 & ~x20;
  assign new_n75_ = ~x03 & (x11 | x14 | ~x20);
  assign new_n76_ = ~x11 & ((x00 & ~x02 & ~x10) | (x05 & x19));
  assign new_n77_ = (new_n78_ | x05) & (~x11 | (x05 ? (~x18 | ~x24) : ~x15));
  assign new_n78_ = (x03 | ~x15) & (new_n75_ | ~x19);
  assign new_n79_ = (x05 | x13) & ((~new_n75_ & x07) | (~x03 & x18));
  assign new_n80_ = (~x11 | ~x13 | ~x18 | (~new_n74_ & x06)) & (~x06 | ~x07 | x11);
endmodule
