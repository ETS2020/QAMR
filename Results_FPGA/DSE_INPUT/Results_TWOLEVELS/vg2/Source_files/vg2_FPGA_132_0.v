...
module FAU ( 
  ...
  assign z6 = ~new_n80_ | (z7 & (~x03 | (~x06 & x11)));
  assign new_n80_ = (new_n81_ | (x05 ? (~x13 | x24) : x13)) & ~new_n84_ & (~x24 | new_n83_ | (~x05 & ~x13));
  assign new_n81_ = (new_n82_ | ~x19) & (~x15 | x20 | ~x11 | ~x14);
  assign new_n82_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n83_ = (new_n82_ | ~x07) & (~x18 | x20 | ~x11 | ~x14);
  assign new_n84_ = ~x02 & ~x10 & ~new_n85_ & ~x24;
  assign new_n85_ = (~x11 | ~x14 | x20) & (~x00 | (~x03 & (x11 | (~x06 & x14))));
endmodule
