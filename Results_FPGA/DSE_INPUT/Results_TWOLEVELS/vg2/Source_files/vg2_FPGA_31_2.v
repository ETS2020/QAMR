...
module FAU ( 
  ...
  assign z4 = (~new_n80_ & ~x24) | (x24 & ~new_n84_ & (x05 | x13)) | (~x05 & ~new_n88_ & ~x13);
  assign new_n80_ = (new_n81_ | x16) & (new_n69_ | (~new_n83_ & x08)) & (new_n71_ | ~x08);
  assign new_n81_ = (new_n71_ | (~x09 & (~x17 | x22))) & (~x04 | ~new_n82_ | x22);
  assign new_n82_ = ~x23 & ((x05 & x13 & x19) | (x00 & ~x10));
  assign new_n83_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n84_ = (new_n85_ | ~x18) & (new_n86_ | ~x07);
  assign new_n85_ = ~new_n83_ & x08;
  assign new_n86_ = ~new_n87_ & ~x08;
  assign new_n87_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n88_ = (new_n85_ | ~x15) & (new_n86_ | ~x19);
