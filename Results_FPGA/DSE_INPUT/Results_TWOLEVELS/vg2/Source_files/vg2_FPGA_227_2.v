...
module FAU ( 
  ...
  assign z6 = new_n82_ | (new_n83_ & x11) | (z7 & (~x03 | (~x06 & x11)));
  assign new_n82_ = z5 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n83_ = x14 & ~new_n84_ & ~x20;
  assign new_n84_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n85_ & (x05 | x13 | ~x15);
  assign new_n85_ = ~x02 & x21 & ~x24;
endmodule
