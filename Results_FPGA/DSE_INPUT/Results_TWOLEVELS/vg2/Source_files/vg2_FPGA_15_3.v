...
module FAU ( 
  ...
  assign new_n46_ = x00 & ~x02 & ~x10;
  assign new_n47_ = x05 & x13 & ~x16 & x19;
  ...
  assign new_n67_ = x01 ? (~x03 | ~x06 | ~new_n70_ | ~x08) : (x03 | x06 | ~new_n68_ | x08);
  assign new_n68_ = ~x11 & ~x14 & ~new_n69_ & ~x20;
  assign new_n69_ = ~new_n46_ & (~x05 | ~x13 | ~x19);
  ...
  assign z4 = (~new_n84_ & (new_n38_ | new_n85_)) | ~new_n79_ | (new_n83_ & x24);
  assign new_n79_ = (new_n80_ | (x05 ? (~x13 | x24) : x13)) & (~new_n82_ | x02);
  assign new_n80_ = (~x15 | (~new_n81_ & x08)) & (~x08 | ~x19);
  assign new_n81_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n82_ = ~x10 & ~x24 & ((x00 & x08) | (x21 & (new_n81_ | ~x08)));
  assign new_n83_ = (x05 | x13) & ((x07 & x08) | (x18 & (new_n81_ | ~x08)));
  assign new_n84_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n85_ = ~x16 & ((x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | (~x05 & ~x13 & x19));
