// Benchmark "FAU" written by ABC on Wed Jul 29 04:18:41 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_, new_n44_,
    ...
    new_n75_, new_n78_, new_n79_, new_n81_, new_n82_, new_n83_, new_n84_;
  ...
  assign new_n55_ = ~new_n56_ & (~new_n58_ | ~new_n60_ | x01 | x03 | x04);
  assign new_n56_ = new_n52_ & new_n57_ & x15 & x16 & x12 & x14;
  ...
  assign new_n62_ = (~x05 | (~new_n65_ & (~x18 | ~x24))) & ~new_n63_ & (~x13 | ~x18 | ~x24);
  assign new_n63_ = x20 & (new_n64_ | (~x05 & ~x13 & x15));
  assign new_n64_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n65_ = x13 & x15 & x20 & ~x24;
  assign z3 = (~new_n67_ & ~x24) | (x24 & ~new_n70_ & (x05 | x13)) | (~x05 & ~new_n73_ & ~x13);
  assign new_n67_ = x01 ? (~x03 | ~x06 | ~new_n68_ | ~x08) : (x03 | x06 | ~new_n69_ | x08);
  assign new_n68_ = x11 & x14 & ~new_n43_ & x20;
  assign new_n69_ = ~x11 & ~x14 & ~new_n46_ & ~x20;
  assign new_n70_ = (~new_n71_ | ~x01 | ~x03 | ~x06) & (~new_n72_ | x01 | x03 | x06 | ~x07);
  assign new_n71_ = x14 & x18 & x08 & x11;
  assign new_n72_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n73_ = (~new_n74_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n75_ | x01 | x03 | x06 | x08);
  ...
  assign z6 = new_n81_ | new_n82_ | (new_n84_ & x18);
  assign new_n81_ = z5 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n82_ = ~new_n83_ & (new_n64_ | (x15 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n83_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n84_ = x24 & (x05 | x13) & (~x03 | (~x06 & x11));
endmodule
