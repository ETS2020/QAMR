...
module FAU ( 
  ...
  assign new_n56_ = new_n53_ & ~x17 & ~x20 & ~x22 & ~x23 & ~x24;
  assign new_n57_ = ~x04 & ~x06 & ~x08 & ~x09 & ~x10;
  assign z2 = x01 & x03 & x06 & x11 & new_n59_ & x14;
  assign new_n59_ = x20 & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
  ...
  assign new_n69_ = ~x08 & ~x10 & ~x11 & ~x14 & ~x20 & ~x24;
  assign z4 = (z5 & (x08 | (~new_n73_ & ~x16))) | (z7 & (~x08 | (~new_n74_ & x16)));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | new_n72_ | (~x05 & ~x13 & x15);
  assign new_n72_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n73_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n74_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (z5 & (x03 | (~new_n80_ & ~x11))) | (z7 & ~x03) | (~new_n76_ & x11);
  assign new_n76_ = (new_n77_ | x24) & (new_n79_ | (x06 & (~x14 | x20)));
  assign new_n77_ = ~new_n78_ & (x02 | x10 | ~x21 | (x06 & ~x14));
  assign new_n78_ = x05 & x13 & x15 & (~x06 | (x14 & ~x20));
  assign new_n79_ = (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
