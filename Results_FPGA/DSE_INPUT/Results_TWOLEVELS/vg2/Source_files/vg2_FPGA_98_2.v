...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n75_, new_n76_, new_n77_, new_n80_, new_n81_, new_n82_, new_n84_,
  ...
  assign z1 = new_n40_ | (x24 & ~new_n50_ & ~new_n62_) | (~x10 & ~new_n57_ & ~x24);
  assign new_n40_ = ~new_n49_ & (new_n43_ | (new_n41_ & new_n48_ & new_n47_ & x01));
  ...
  assign new_n51_ = new_n52_ & new_n53_ & new_n48_ & new_n47_ & x01;
  ...
  assign new_n57_ = (~new_n58_ | ~new_n48_ | ~new_n52_ | ~new_n61_) & (~new_n54_ | ~new_n59_);
  assign new_n58_ = new_n47_ & x01 & ~x02;
  ...
  assign z3 = (~new_n75_ & ~new_n49_) | (new_n68_ & x24) | (~x10 & ~new_n72_ & ~x24);
  assign new_n68_ = ~new_n62_ & (new_n69_ | (new_n71_ & new_n60_ & ~x06 & x07));
  assign new_n69_ = new_n70_ & x11 & x14 & x18 & x20;
  assign new_n70_ = x01 & x03 & x06 & x08;
  assign new_n71_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n72_ = ~new_n73_ & (~new_n71_ | x03 | x06 | ~x00 | x01);
  assign new_n73_ = new_n74_ & x03 & x06 & x01 & ~x02;
  ...
  assign z4 = (z5 & (x08 | (~new_n81_ & ~x16))) | (z7 & (~x08 | (~new_n82_ & x16)));
  assign z5 = (x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | new_n80_ | (~x05 & ~x13 & x19);
  assign new_n80_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n81_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n82_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = ~new_n84_ | (z5 & (x03 | (x06 & ~x11)));
  assign new_n84_ = (~x24 | new_n85_ | (~x05 & ~x13)) & ~new_n88_ & (new_n87_ | (x05 ? (~x13 | x24) : x13));
  assign new_n85_ = (new_n86_ | ~x18) & (~x07 | x11 | x14 | ~x20);
  assign new_n86_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n87_ = (new_n86_ | ~x15) & (x11 | x14 | ~x19 | ~x20);
  assign new_n88_ = ~x10 & ~x24 & (new_n89_ | (~x02 & ~new_n86_ & x21));
  assign new_n89_ = x00 & ~x11 & ~x14 & x20;
endmodule
