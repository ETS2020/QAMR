...
module FAU ( 
  ...
  assign new_n47_ = x08 & x09 & x12 & x14 & new_n48_ & x16;
  assign new_n48_ = x17 & x20 & x22 & x23 & ~new_n49_ & ~x24;
  ...
  assign z2 = x01 & x03 & x06 & x14 & ~new_n58_ & x20;
  assign new_n58_ = ~new_n59_ & ~new_n60_ & ~new_n61_;
  assign new_n59_ = x05 & ((x11 & x18 & x24) | (x13 & x15 & ~x24));
  assign new_n60_ = x11 & ((~x05 & ~x13 & x15) | (x13 & x18 & x24));
  ...
  assign new_n68_ = x08 & x14 & x20 & ~new_n49_ & ~x24;
  ...
  assign z6 = ~new_n83_ | (~new_n79_ & (x05 | x13));
  assign new_n79_ = (~x24 | ((~x03 | ~x07) & (~x18 | (~new_n80_ & x03)))) & (~new_n82_ | ~x07);
  assign new_n80_ = ~new_n81_ & x11;
  assign new_n81_ = x06 & (~x14 | x20);
  assign new_n82_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n83_ = (new_n84_ | new_n81_) & ~new_n87_ & (new_n85_ | x24);
  assign new_n84_ = ~new_n61_ & (~x15 | (x05 ? (~x13 | x24) : (~x11 | x13)));
  assign new_n85_ = ~new_n86_ & (x02 | x10 | (x03 ? ~x00 : ~x21));
  assign new_n86_ = x05 & x13 & (x03 ? x19 : x15);
  assign new_n87_ = ~x05 & ~x13 & ((~x03 & x15) | (x19 & (new_n82_ | x03)));
endmodule
