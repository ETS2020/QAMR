...
module FAU ( 
  ...
  assign new_n47_ = ~x23 & (x05 ? (x07 & x24) : x19);
  assign new_n48_ = x09 & x11 & x12 & new_n49_ & x14;
  assign new_n49_ = x16 & x17 & x20 & x22 & ~new_n50_ & x23;
  assign new_n50_ = (~x08 | (x05 ? (~x18 | ~x24) : (x13 | ~x15))) & (~x13 | ~x18 | ~x24);
  ...
  assign new_n56_ = x11 & x14 & (~new_n57_ | new_n60_) & x20;
  assign new_n57_ = (x05 | ~x15 | (x08 & (~x08 | x13))) & ~new_n59_ & (~new_n58_ | ~x13);
  assign new_n58_ = x18 & x24;
  assign new_n59_ = x21 & ~x24 & ~x02 & ~x10;
  assign new_n60_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  ...
  assign new_n64_ = x01 ? (~x03 | ~new_n67_ | ~x06) : (x03 | ~new_n65_ | x06);
  assign new_n65_ = ~x08 & ~x11 & new_n66_ & ~x14;
  assign new_n66_ = ~x20 & (x05 ? (x07 & x24) : x19);
  assign new_n67_ = x11 & x14 & ~new_n50_ & x20;
  assign new_n68_ = new_n69_ & x00 & ~x01 & ~x02 & ~x03 & ~x06;
  assign new_n69_ = ~x08 & ~x10 & ~x11 & ~x14 & ~x20;
  assign z4 = new_n71_ | new_n76_ | new_n77_ | (new_n74_ & x16);
  assign new_n71_ = (~new_n72_ | (~x05 & ~x13 & x19)) & (new_n73_ | x08);
  assign new_n72_ = ~new_n38_ & (~x05 | ~x07 | ~x24);
  assign new_n73_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n74_ = z7 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | new_n59_ | (~x05 & ~x13 & x15);
  assign new_n76_ = ~x08 & ((~x05 & x15) | new_n59_ | (new_n58_ & x05));
  assign new_n77_ = x13 & ((x07 & x24) | (x05 & x19 & ~x24));
