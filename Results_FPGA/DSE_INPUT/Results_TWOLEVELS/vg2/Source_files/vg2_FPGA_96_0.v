...
module FAU ( 
  ...
  assign z6 = new_n84_ | ~new_n80_ | (~new_n86_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n80_ = (new_n81_ | (x03 & (x06 | ~x11))) & (~x11 | ~new_n83_ | ~x14);
  assign new_n81_ = ~new_n64_ & (~x18 | new_n82_ | ~x24);
  assign new_n82_ = ~x05 & ~x13;
  assign new_n83_ = ~x20 & (new_n64_ | (x18 & x24));
  assign new_n84_ = ~new_n85_ & (new_n38_ | (x07 & ~new_n82_ & x24));
  assign new_n85_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n86_ = new_n87_ & (~x11 | ((~x14 | x20) & (x06 | ~x15)));
  assign new_n87_ = (x03 | ~x15) & (~x19 | (~x03 & (x11 | (~x06 & x14))));
endmodule
