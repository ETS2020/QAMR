...
module FAU ( 
  ...
  assign new_n56_ = new_n57_ & new_n58_ & x06 & x08 & ~x10 & x11;
  ...
  assign z4 = (~x24 & (new_n77_ | (x05 & ~new_n80_ & x13))) | (x24 & ~new_n84_ & (x05 | x13)) | (~x05 & ~new_n80_ & ~x13);
  assign new_n77_ = new_n78_ & ~x02;
  assign new_n78_ = ~x10 & ((x00 & (x08 | ~x16)) | (x21 & (~x08 | (new_n79_ & x16))));
  assign new_n79_ = x22 & (~x17 | (~x04 & x23));
  assign new_n80_ = (new_n81_ | ~x15) & (new_n82_ | ~x19);
  assign new_n81_ = x08 & (~x16 | (~new_n79_ & x09));
  assign new_n82_ = ~new_n83_ & ~x08;
  assign new_n83_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n84_ = (new_n81_ | ~x18) & (new_n82_ | ~x07);
