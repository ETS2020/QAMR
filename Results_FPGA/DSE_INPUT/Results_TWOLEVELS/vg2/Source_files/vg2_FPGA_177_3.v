// Benchmark "FAU" written by ABC on Wed Jul 29 04:19:08 2020
...
module FAU ( 
  ...
  assign z4 = (z5 & (x08 | (~new_n60_ & ~x16))) | (z7 & (~x08 | (~new_n61_ & x16)));
  assign new_n60_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n61_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (z5 & (x03 | (~new_n63_ & ~x11))) | (z7 & (~x03 | (~new_n64_ & x11)));
