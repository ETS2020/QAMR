...
module FAU ( 
  ...
  assign z1 = (~new_n40_ & ~x24) | (x24 & ~new_n48_ & (x05 | x13)) | (~x05 & ~new_n57_ & ~x13);
  assign new_n40_ = x01 ? (~x03 | ~x04 | ~new_n41_ | ~x06) : (x03 | x04 | ~new_n45_ | x06);
  assign new_n41_ = x08 & x09 & x11 & x12 & new_n42_ & x14;
  assign new_n42_ = x16 & x17 & x22 & x23 & (new_n43_ | new_n44_);
  assign new_n43_ = x05 & x13 & x15 & x20;
  ...
  assign z2 = x01 & x03 & x06 & new_n63_ & x11;
  assign new_n63_ = x14 & (new_n64_ | new_n65_);
  assign new_n64_ = x20 & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (~x05 & ~x13 & x15) | (x13 & x18 & x24));
  assign new_n65_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = (~new_n67_ & ~x24) | (x24 & ~new_n70_ & (x05 | x13)) | (~x05 & ~new_n74_ & ~x13);
  assign new_n67_ = x01 ? (~x03 | ~x06 | ~new_n68_ | ~x08) : (x03 | x06 | ~new_n69_ | x08);
  assign new_n68_ = x11 & x14 & (new_n43_ | new_n44_);
  ...
  assign new_n83_ = (new_n84_ | ~x19) & (~x11 | ~x14 | ~x15 | x20);
