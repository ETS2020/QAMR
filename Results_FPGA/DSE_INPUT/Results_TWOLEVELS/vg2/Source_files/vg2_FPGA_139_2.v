...
module FAU ( 
  ...
  assign new_n56_ = (~new_n57_ | ~new_n58_) & (~new_n53_ | ~new_n59_);
  assign new_n57_ = new_n42_ & x03 & x04 & x01 & ~x02;
  ...
  assign z3 = (~new_n67_ & ~x24) | (x24 & ~new_n72_ & (x05 | x13)) | (~x05 & ~new_n76_ & ~x13);
  ...
  assign z4 = (z5 & (new_n83_ | x08)) | new_n80_ | (z7 & (new_n84_ | ~x08));
  assign new_n80_ = ~x16 & ~x22 & ~new_n81_ & (x17 | (x04 & ~x23));
  assign new_n81_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n82_ & (x05 | x13 | ~x19);
  assign new_n82_ = x00 & ~x10 & ~x24;
