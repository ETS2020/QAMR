// Benchmark "FAU" written by ABC on Wed Jul 29 04:18:33 2020
...
module FAU ( 
  ...
  assign new_n36_ = (new_n39_ | ~x05) & (x20 | (new_n37_ & (x05 | x13 | ~x19)));
  assign new_n37_ = ~new_n38_ & (~x07 | ~x13 | ~x24);
  assign new_n38_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n39_ = (~x07 | ~x24) & (~x13 | ~x19 | x24);
  ...
  assign new_n48_ = x13 ? (~x18 | ~x24) : ~x15;
  assign new_n49_ = ~x08 & ~x09 & ~x11 & new_n50_ & ~x12;
  assign new_n50_ = ~x14 & ~x16 & ~x17 & ~x22 & ~new_n51_ & ~x23;
  assign new_n51_ = (~x07 | ~x24 | (~x05 & (~x13 | x20))) & (x05 | x13 | ~x19 | x20);
  assign new_n52_ = new_n53_ & new_n55_ & x11 & x12 & x14 & x16;
  assign new_n53_ = new_n54_ & x01 & ~x02 & x03 & x04;
  assign new_n54_ = x09 & ~x10 & x06 & x08;
  assign new_n55_ = x17 & x20 & x21 & x22 & x23;
  assign z2 = x01 & x03 & new_n57_ & x06;
  assign new_n57_ = x11 & x14 & x20 & (~new_n58_ | (~x13 & x15));
  ...
  assign z6 = new_n78_ | ~new_n73_ | (~new_n79_ & (x03 | (x06 & ~x11)));
  assign new_n73_ = new_n74_ & (new_n77_ | (new_n58_ & (x05 | x13 | ~x15)));
  assign new_n74_ = ~new_n75_ & (x11 | x13 | x14 | ~x19 | ~x20);
  assign new_n75_ = x05 & ~new_n76_ & (~x03 | (x11 & (~x06 | x14)));
  assign new_n76_ = (~x18 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n77_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n78_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n79_ = x05 ? new_n39_ : (x13 | ~x19);
endmodule
