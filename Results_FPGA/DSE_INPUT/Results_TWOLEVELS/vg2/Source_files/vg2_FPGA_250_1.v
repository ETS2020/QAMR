// Benchmark "FAU" written by ABC on Wed Jul 29 04:19:23 2020
...
module FAU ( 
  ...
  assign new_n46_ = ~new_n47_ & (~new_n51_ | ~new_n53_ | ~x12 | ~x16 | ~x17);
  ...
  assign new_n54_ = ~new_n55_ & (~new_n51_ | ~new_n57_ | ~x12 | ~x15 | ~x16);
  ...
  assign z2 = x01 & x03 & x06 & x11 & z7 & x20;
  ...
  assign new_n63_ = x11 & ~new_n42_ & x20;
  assign new_n64_ = ~x11 & ~new_n45_ & ~x14;
  assign new_n65_ = (~new_n66_ | x01 | x03 | x06) & (~new_n67_ | ~x01 | ~x03 | ~x06);
  assign new_n66_ = x07 & ~x08 & ~x11 & ~x14;
  assign new_n67_ = x18 & x20 & x08 & x11;
  assign new_n68_ = (~new_n69_ | x01 | x03 | x06) & (~new_n70_ | ~x01 | ~x03 | ~x06);
  assign new_n69_ = ~x14 & x19 & ~x08 & ~x11;
  assign new_n70_ = x15 & x20 & x08 & x11;
