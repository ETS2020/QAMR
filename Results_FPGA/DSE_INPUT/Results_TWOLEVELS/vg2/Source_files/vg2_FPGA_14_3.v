...
module FAU ( 
  ...
  assign z4 = (z5 & (new_n85_ | x08)) | ~new_n79_ | (z7 & (new_n86_ | ~x08));
  assign new_n79_ = (~x24 | new_n80_ | (~x05 & ~x13)) & ~new_n83_ & (new_n82_ | (x05 ? (~x13 | x24) : x13));
  assign new_n80_ = (~x16 | ~new_n81_ | ~x18) & (~x07 | ~x09 | x16);
  assign new_n81_ = x22 & (~x17 | (~x04 & x23));
  assign new_n82_ = (~x15 | ~new_n81_ | ~x16) & (~x09 | x16 | ~x19);
  assign new_n83_ = x09 & ~x10 & ~x24 & (x16 ? new_n84_ : x00);
