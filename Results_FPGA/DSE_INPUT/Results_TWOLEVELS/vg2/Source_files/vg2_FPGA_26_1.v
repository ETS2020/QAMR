...
module FAU ( 
  ...
  wire new_n36_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_, new_n44_,
    ...
    new_n84_, new_n86_, new_n87_, new_n88_, new_n89_, new_n90_;
  ...
  assign z1 = (~new_n40_ & ~x24) | new_n48_ | new_n61_ | (x24 & ~new_n57_ & ~new_n64_);
  ...
  assign new_n58_ = new_n59_ & new_n56_ & ~x08 & ~x09 & ~x06 & x07;
  assign new_n59_ = new_n60_ & ~x11 & ~x12 & ~x14 & ~x16;
  assign new_n60_ = ~x22 & ~x23 & ~x17 & ~x20;
  assign new_n61_ = new_n62_ & new_n51_ & x04 & x05 & x01 & x03;
  assign new_n62_ = new_n63_ & x14 & x15 & x12 & x13;
  assign new_n63_ = x16 & x17 & x20 & x22 & x23;
  assign new_n64_ = ~x05 & ~x13;
  assign z2 = x01 & x03 & x06 & x11 & new_n66_ & x14;
  assign new_n66_ = x20 & ((x05 & (x24 | (x13 & x15))) | (x13 & x24) | new_n67_ | (~x05 & ~x13 & x15));
  ...
  assign new_n73_ = (~new_n75_ | x08 | x11 | x14 | x20) & (~new_n74_ | ~x14 | ~x20 | ~x08 | ~x11);
  assign new_n74_ = x01 & x03 & x06;
  assign new_n75_ = ~x01 & ~x03 & ~x06 & x07;
  assign new_n76_ = new_n77_ & x05 & x06 & x08 & x01 & x03;
  assign new_n77_ = x11 & x13 & x14 & x15 & x20;
  assign new_n78_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n43_ & ~x20;
  assign new_n79_ = new_n80_ & x01 & ~x02 & x03 & x06 & x08;
  assign new_n80_ = x14 & x20 & x21 & ~x10 & x11;
  ...
  assign z6 = new_n86_ | new_n90_ | (x24 & ~new_n88_ & ~new_n64_);
  assign new_n86_ = ~new_n87_ & (new_n38_ | (x19 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n87_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n88_ = (~x07 | (~x03 & (~x06 | x11))) & (new_n89_ | ~x18);
  assign new_n89_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n90_ = ~new_n89_ & (new_n67_ | (x15 & (x05 ? (x13 & ~x24) : ~x13)));
endmodule
