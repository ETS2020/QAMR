...
module FAU ( 
  ...
  assign z1 = new_n38_ | new_n54_ | (new_n47_ & x24);
  ...
  assign new_n47_ = (x05 | x13) & (new_n48_ | (new_n39_ & new_n52_ & new_n53_));
  assign new_n48_ = new_n50_ & new_n51_ & new_n49_ & ~x01 & ~x03 & ~x04;
  assign new_n49_ = ~x08 & ~x09 & ~x06 & x07;
  ...
  assign new_n57_ = x17 & x21 & x22 & x23 & ~x24;
  assign z2 = x01 & x03 & x06 & new_n59_ & x11;
  assign new_n59_ = x14 & (new_n60_ | new_n61_);
  ...
  assign new_n71_ = ~x10 & x11 & x14 & x21 & ~x24;
