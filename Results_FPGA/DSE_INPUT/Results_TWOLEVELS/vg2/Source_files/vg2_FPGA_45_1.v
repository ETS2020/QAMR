...
module FAU ( 
  ...
  assign new_n52_ = new_n53_ & x01 & x04 & x06;
  ...
  assign new_n65_ = x01 ? (~new_n66_ | ~x06) : (x03 | ~new_n67_ | x06);
  assign new_n66_ = x08 & x11 & x14 & ~new_n43_ & x20;
  assign new_n67_ = ~x11 & ~x14 & ~new_n46_ & ~x20;
  assign new_n68_ = (~new_n70_ | x01 | x03 | x06) & (~new_n69_ | ~x01 | ~x06 | ~x08);
  assign new_n69_ = x18 & x20 & x11 & x14;
  assign new_n70_ = x07 & ~x11 & ~x14 & ~x20;
  assign new_n71_ = (~new_n73_ | x01 | x03 | x06) & (~new_n72_ | ~x01 | ~x06 | ~x08);
