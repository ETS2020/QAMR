...
module FAU ( 
  ...
  assign z6 = new_n80_ | ~new_n84_ | (x24 & ~new_n82_ & (x05 | x13));
  assign new_n80_ = ~new_n81_ & (new_n38_ | (x19 & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n81_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n82_ = new_n83_ & (~x11 | ((~x14 | x20) & (x06 | ~x18)));
  assign new_n83_ = (x03 | ~x18) & (~x07 | (~x03 & (x11 | (~x06 & x14))));
  assign new_n84_ = (new_n85_ | (~new_n64_ & (x05 | x13 | ~x15))) & (~x05 | ~x13 | new_n86_ | ~x15);
  assign new_n85_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n86_ = (x03 | x24) & (~x11 | ((~x14 | x20) & (x06 | x24)));
endmodule
