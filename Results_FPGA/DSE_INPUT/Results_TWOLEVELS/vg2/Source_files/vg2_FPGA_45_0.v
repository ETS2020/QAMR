...
module FAU ( 
  ...
  assign z2 = x01 & new_n45_ & x06;
  assign new_n45_ = x11 & x14 & x20 & z7 & (~x08 | (x03 & x08));
  assign z3 = x01 & new_n47_ & x03;
  assign new_n47_ = x06 & x08 & x11 & x14 & z7 & x20;
  assign z4 = (~new_n37_ & (x08 | (~new_n49_ & ~x16))) | (z7 & (~x08 | (~new_n50_ & x16)));
  assign new_n49_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n50_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = ~new_n37_ & (x03 | x08);
  assign z6 = (~new_n37_ & (x03 | (~new_n53_ & ~x11))) | (z7 & (~x03 | (~new_n54_ & x11)));
  assign new_n53_ = ~x06 & (x14 | ~x20);
  assign new_n54_ = x06 & (~x14 | x20);
endmodule
