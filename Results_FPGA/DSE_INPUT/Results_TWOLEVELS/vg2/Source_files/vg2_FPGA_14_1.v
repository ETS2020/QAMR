...
module FAU ( 
  ...
  assign new_n57_ = ~x08 & ~x10 & ~x04 & ~x06;
  ...
  assign z3 = (~new_n63_ & ~x24) | (x24 & ~new_n68_ & (x05 | x13)) | (~x05 & ~new_n72_ & ~x13);
  assign new_n63_ = x01 ? (~x03 | ~x06 | ~new_n64_ | ~x08) : (x03 | x06 | ~new_n66_ | x08);
  ...
  assign z4 = (~new_n76_ & ~x24) | new_n85_ | (new_n81_ & x24);
  assign new_n76_ = (new_n67_ | new_n79_) & ~new_n80_ & (~x05 | new_n77_ | ~x13);
  assign new_n77_ = (~x15 | (~new_n78_ & x08)) & (~x09 | x16 | ~x19);
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = ~x08 & (x16 | x22 | (~x17 & (~x04 | x23)));
  assign new_n80_ = ~x02 & ~x10 & x21 & (~x08 | x16);
  assign new_n81_ = (x05 | x13) & ((~new_n82_ & x18) | (~new_n83_ & x07));
  assign new_n82_ = ~new_n78_ & x08;
  assign new_n83_ = ~new_n84_ & ~x08;
  assign new_n84_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n85_ = ~x05 & ~x13 & ((~new_n82_ & x15) | (~new_n83_ & x19));
