...
module FAU ( 
  ...
  assign z4 = ~new_n83_ | (new_n80_ & ~x16) | (z5 & (x08 | (x09 & ~x16)));
  assign new_n80_ = ~x22 & ~new_n81_ & (x17 | (x04 & ~x23));
  assign new_n81_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & ~new_n82_ & (x05 | x13 | ~x19);
  assign new_n82_ = x00 & ~x09 & ~x10 & ~x24;
  assign new_n83_ = (x09 | new_n84_ | ~x16) & (~z7 | (x08 & (~new_n86_ | ~x16)));
  assign new_n84_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n85_ & (x05 | x13 | ~x15);
  assign new_n85_ = ~x10 & x21 & ~x24;
