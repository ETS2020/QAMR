...
module FAU ( 
  ...
  assign z1 = new_n38_ | new_n54_ | (x24 & ~new_n47_ & (x05 | x13));
  ...
  assign new_n54_ = new_n55_ & new_n56_ & x03 & x04 & x01 & ~x02;
  assign new_n55_ = new_n49_ & x22 & x23 & ~x24 & x20 & x21;
  assign new_n56_ = x06 & x08 & x09 & ~x10 & x11;
  assign z2 = new_n58_ & x01;
  assign new_n58_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = (x05 & ((x13 & x15 & ~x24) | (x18 & x24))) | (x13 & x18 & x24) | new_n60_ | (~x05 & ~x13 & x15);
  ...
  assign z5 = (x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | new_n73_ | (~x05 & ~x13 & x19);
  assign new_n73_ = ~x10 & ~x24 & x00 & ~x02;
  assign new_n74_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n75_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n77_ & ~x24) | (x24 & ~new_n84_ & (x05 | x13)) | (~x05 & ~new_n86_ & ~x13);
  assign new_n77_ = new_n80_ & (new_n78_ | (~x03 & (~x06 | x11)));
  assign new_n78_ = ~new_n79_ & (~x05 | ~x13 | ~x19);
  assign new_n79_ = x00 & ~x02 & ~x10;
  assign new_n80_ = (new_n81_ | new_n82_) & (x11 | x14 | (~new_n79_ & ~new_n83_));
  assign new_n81_ = (~x05 | ~x13 | ~x15) & (x02 | x10 | ~x21);
  assign new_n82_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n83_ = x05 & x13 & x19 & x20;
  assign new_n84_ = (new_n82_ | ~x18) & (new_n85_ | ~x07);
  assign new_n85_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n86_ = (new_n82_ | ~x15) & (new_n85_ | ~x19);
endmodule
