// Benchmark "FAU" written by ABC on Wed Jul 29 04:19:01 2020
...
module FAU ( 
  ...
  assign new_n36_ = ~x20 & ((~new_n37_ & ~x24) | (~x05 & ~x13) | (x07 & x24));
  ...
  assign new_n45_ = x01 ? (~x03 | ~x04 | ~new_n49_ | ~x06) : (x03 | x04 | ~new_n46_ | x06);
  assign new_n46_ = ~x08 & ~x09 & ~x11 & new_n47_ & ~x12;
  assign new_n47_ = ~x14 & ~x16 & ~x17 & ~x20 & new_n48_ & ~x22;
  assign new_n48_ = ~x23 & ((~x05 & ~x13) | (x07 & x24));
  assign new_n49_ = x08 & x09 & x11 & x12 & new_n50_ & x14;
  assign new_n50_ = x16 & x17 & x20 & x22 & ~new_n51_ & x23;
  assign new_n51_ = (~x18 | ~x24 | (~x05 & ~x13)) & (x05 | x13 | ~x15);
  assign z2 = new_n53_ & x01;
  assign new_n53_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | new_n55_ | (~x05 & ~x13 & x15);
  assign new_n55_ = ~x02 & ~x10 & x21 & ~x24;
  assign z3 = ~new_n57_ | (~x24 & (x01 ? (new_n61_ & x03) : (new_n62_ & ~x03)));
  assign new_n57_ = x01 ? (~x03 | ~x06 | ~new_n60_ | ~x08) : (x03 | x06 | ~new_n58_ | x08);
  assign new_n58_ = new_n59_ & ~x11;
  assign new_n59_ = ~x14 & ~x20 & ((~x05 & ~x13) | (x07 & x24));
  assign new_n60_ = x11 & x14 & ~new_n51_ & x20;
  ...
  assign new_n65_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n66_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n67_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n69_ | ~new_n73_ | (~new_n77_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n69_ = x11 & (new_n70_ | new_n72_ | (~new_n51_ & ~x06));
  assign new_n70_ = ~x24 & (new_n71_ | (x13 & x15 & x05 & ~x06));
  assign new_n71_ = ~x02 & ~x10 & x21 & (~x06 | (x14 & ~x20));
  assign new_n72_ = x03 & x14 & x18 & ~x20 & x24;
  assign new_n73_ = (~new_n74_ | ~x24) & (x02 | x10 | new_n76_ | x24);
  assign new_n74_ = (x05 | x13) & ((~new_n75_ & x07) | (~x03 & x18));
  assign new_n75_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n76_ = (x03 | ~x21) & (new_n75_ | ~x00);
  assign new_n77_ = (x03 | ~x15) & (new_n75_ | ~x19);
endmodule
