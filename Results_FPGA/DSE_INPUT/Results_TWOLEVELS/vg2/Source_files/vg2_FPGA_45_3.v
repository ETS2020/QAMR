...
module FAU ( 
  ...
  wire new_n36_, new_n38_, new_n40_, new_n41_, new_n43_, new_n44_, new_n45_,
    new_n47_, new_n49_, new_n50_, new_n52_, new_n53_;
  assign z0 = ~x01 & new_n36_ & ~x06;
  assign new_n36_ = ~x11 & ~x14 & ~x20 & z5 & (x08 | (~x03 & ~x08));
  ...
  assign z4 = (~new_n44_ & (~x08 | (~new_n50_ & x16))) | (z5 & (x08 | (~new_n49_ & ~x16)));
  assign new_n49_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n50_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n44_ & (~x03 | (~new_n53_ & x11))) | (z5 & (x03 | (~new_n52_ & ~x11)));
  assign new_n52_ = ~x06 & (x14 | ~x20);
  assign new_n53_ = x06 & (~x14 | x20);
  assign z7 = ~new_n44_ & (~x03 | ~x08);
endmodule
