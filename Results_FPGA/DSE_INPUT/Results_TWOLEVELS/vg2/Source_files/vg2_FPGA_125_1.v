...
module FAU ( 
  ...
  assign new_n51_ = new_n52_ & x03 & x04 & x06;
  ...
  assign z2 = x03 & x06 & x11 & x14 & z7 & x20;
  ...
  assign new_n63_ = ~x11 & ~new_n42_ & ~x14;
  assign new_n64_ = x11 & x14 & ~new_n45_ & x20;
  assign new_n65_ = (~new_n66_ | x01 | x03 | x06) & (~new_n67_ | ~x03 | ~x06 | ~x08);
  assign new_n66_ = x07 & ~x08 & ~x11 & ~x14;
  assign new_n67_ = x18 & x20 & x11 & x14;
  assign new_n68_ = (~new_n69_ | x01 | x03 | x06) & (~new_n70_ | ~x03 | ~x06 | ~x08);
