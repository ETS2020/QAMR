...
module FAU ( 
  ...
  assign z6 = new_n84_ | ~new_n80_ | new_n86_;
  assign new_n80_ = (~x24 | new_n81_ | (~x05 & ~x13)) & (~x05 | ~x13 | new_n83_ | ~x19);
  assign new_n81_ = new_n82_ & (~x07 | (~x03 & (~x06 | x11)));
  assign new_n82_ = (~x18 | (x03 & (~x11 | (x06 & ~x14)))) & (x11 | x14 | ~x20);
  assign new_n83_ = (~x03 | x24) & (x11 | ((x14 | ~x20) & (~x06 | x24)));
  assign new_n84_ = ~new_n85_ & (new_n38_ | (~x05 & ~x13 & x19));
  assign new_n85_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n86_ = ~new_n87_ & (new_n64_ | (x15 & (x05 ? (x13 & ~x24) : ~x13)));
