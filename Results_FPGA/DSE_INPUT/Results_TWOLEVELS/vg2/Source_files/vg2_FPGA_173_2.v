// Benchmark "FAU" written by ABC on Wed Jul 29 04:19:07 2020
...
module FAU ( 
  ...
  assign z4 = (~new_n78_ & ~x24) | (x24 & ~new_n83_ & (x05 | x13)) | (~x05 & ~new_n87_ & ~x13);
  assign new_n78_ = ~new_n79_ & (new_n43_ | (~new_n82_ & x08)) & (new_n69_ | ~x08);
  assign new_n79_ = ~x16 & ((~new_n69_ & x09) | (~x22 & (new_n80_ | new_n81_)));
  assign new_n80_ = x00 & ~x02 & ((~x10 & x17) | (x04 & ~x23));
  assign new_n81_ = x05 & x13 & x19 & (x17 | (x04 & ~x23));
  assign new_n82_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n83_ = (new_n84_ | ~x18) & (new_n85_ | ~x07);
  assign new_n84_ = ~new_n82_ & x08;
  assign new_n85_ = ~new_n86_ & ~x08;
  assign new_n86_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n87_ = (new_n84_ | ~x15) & (new_n85_ | ~x19);
