...
module FAU ( 
  ...
  assign new_n70_ = ~x08 & ~x10 & ~x11 & ~x14 & ~x20 & ~x24;
  assign z4 = (z5 & (x08 | (~new_n74_ & ~x16))) | (z7 & (~x08 | (~new_n75_ & x16)));
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | new_n73_ | (~x05 & ~x13 & x15);
  assign new_n73_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n74_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n75_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n79_ | (~new_n60_ & (new_n78_ | ~x03)) | (z5 & (new_n77_ | x03));
