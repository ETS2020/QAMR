...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n60_, new_n61_, new_n62_, new_n63_, new_n66_, new_n68_, new_n69_,
  ...
  assign z2 = x01 & x03 & x06 & x11 & ~new_n54_ & x14;
  assign new_n54_ = ~new_n57_ & (~x20 | (~new_n55_ & ~new_n56_));
  assign new_n55_ = x05 & ((x18 & x24) | (x13 & x15 & ~x24));
  assign new_n56_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n57_ = ~x05 & (x13 ? (x18 & x24) : x15);
  assign z3 = ~new_n59_ | (~x24 & (x01 ? (new_n62_ & x03) : (new_n63_ & ~x03)));
  assign new_n59_ = (~x01 | ~x03 | ~new_n60_ | ~x06) & (~new_n61_ | x01 | x03 | x06 | ~x07);
  assign new_n60_ = x08 & x11 & ~new_n48_ & x14;
  assign new_n61_ = ~x08 & ~x11 & ~x14 & ~x20 & x24;
  assign new_n62_ = x06 & x08 & x11 & x14 & ~new_n42_ & x20;
  assign new_n63_ = ~x06 & ~x08 & ~x11 & ~x14 & ~new_n37_ & ~x20;
  assign z4 = (z5 & (x08 | (~new_n68_ & ~x16))) | (z7 & (~x08 | (~new_n69_ & x16)));
  assign z5 = (x05 & ((x07 & x24) | (x13 & x19 & ~x24))) | (x07 & x13 & x24) | new_n66_ | (~x05 & ~x13 & x19);
  ...
  assign z6 = new_n71_ | new_n73_ | new_n77_ | (~x05 & ~new_n78_ & ~x13);
  assign new_n71_ = ~new_n72_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n72_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & ~new_n66_ & (~x07 | ~x13 | ~x24);
  ...
  assign new_n77_ = ~x03 & (new_n55_ | new_n56_ | (x13 & x18 & x24));
  assign new_n78_ = (~x19 | (~x03 & (x11 | (~x06 & x14)))) & (~x15 | (x03 & (x06 | ~x11)));
endmodule
