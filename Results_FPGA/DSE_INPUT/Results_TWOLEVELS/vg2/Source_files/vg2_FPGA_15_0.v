...
module FAU ( 
  ...
  assign z4 = ~new_n78_ | (~new_n84_ & (new_n64_ | new_n85_));
  assign new_n78_ = new_n79_ & (new_n83_ | (x05 ? (~x13 | x24) : x13));
  assign new_n79_ = (~new_n80_ | ~x24) & (x02 | x10 | new_n82_ | x24);
  assign new_n80_ = (x05 | x13) & ((x07 & (new_n81_ | x08)) | (~x08 & x18));
  assign new_n81_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n82_ = ~new_n81_ & (x08 | ~x21) & (~x00 | ~x08);
  assign new_n83_ = (~x19 | (~new_n81_ & ~x08)) & (x08 | ~x15);
  assign new_n84_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n85_ = x16 & ((x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | (~x05 & ~x13 & x15));
