...
module FAU ( 
  ...
  assign new_n59_ = ~x16 & ~x17 & ~x20 & ~x23 & ~x24;
  ...
  assign z4 = new_n79_ | ~new_n83_ | (~x16 & (new_n88_ | (~new_n80_ & ~x24)));
  assign new_n79_ = z7 & (~x08 | (~x09 & x16));
  assign new_n80_ = (new_n81_ | (~x17 & (~x04 | x23))) & (new_n70_ | ~x09);
  assign new_n81_ = ~new_n82_ & (~x00 | x02 | x10);
  assign new_n82_ = x05 & x13 & x19 & ~x22;
  assign new_n83_ = (~x24 | new_n84_ | (~x05 & ~x13)) & ~new_n87_ & (new_n86_ | (x05 ? (~x13 | x24) : x13));
  assign new_n84_ = (~x07 | ~x08) & (~x16 | ~new_n85_ | ~x18);
  assign new_n85_ = x22 & (~x17 | (~x04 & x23));
  assign new_n86_ = (~x15 | ~new_n85_ | ~x16) & (~x08 | ~x19);
  assign new_n87_ = x00 & ~x02 & x08 & ~x10 & ~x24;
  assign new_n88_ = ~new_n89_ & ((~x05 & ~x13 & x19) | (x07 & x24 & (x05 | x13)));
