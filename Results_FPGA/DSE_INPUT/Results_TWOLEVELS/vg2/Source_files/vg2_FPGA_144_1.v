...
module FAU ( 
  ...
  assign z6 = (~new_n80_ & ~x24) | ~new_n84_ | (~x11 & (new_n88_ | new_n90_));
  assign new_n80_ = (new_n46_ | (~x03 & (~x06 | x11))) & new_n81_ & (new_n43_ | (x03 & (x06 | ~x11)));
  assign new_n81_ = ~new_n83_ & (~new_n82_ | x02);
  assign new_n82_ = ~x10 & ((~x14 & x20 & x00 & ~x11) | (x11 & x14 & ~x20 & x21));
  assign new_n83_ = x05 & x13 & (x11 ? (x14 & x15) : (~x14 & x20));
  assign new_n84_ = (~x24 | new_n85_ | (~x05 & ~x13)) & (x05 | new_n87_ | x13);
  assign new_n85_ = (~x03 | ~x07) & (~x18 | (~new_n86_ & x03));
  assign new_n86_ = x11 & (~x06 | (x14 & ~x20));
  assign new_n87_ = (~x03 | ~x19) & (~x15 | (x03 & (~x11 | (x06 & ~x14))));
  assign new_n88_ = x07 & x24 & ((~x14 & x20) | (~new_n89_ & x06));
  assign new_n89_ = ~x05 & ~x13;
  assign new_n90_ = ~x05 & ~x13 & ((~x14 & x20) | (x06 & x19));
endmodule
