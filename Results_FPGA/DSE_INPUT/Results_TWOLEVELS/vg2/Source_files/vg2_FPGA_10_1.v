...
module FAU ( 
  ...
  assign new_n40_ = x03 & x04 & x08 & x09 & new_n41_ & x11;
  assign new_n41_ = x12 & x14 & x16 & x17 & new_n42_ & x20;
  assign new_n42_ = x22 & x23 & (new_n43_ | (x05 & x13 & x15));
  assign new_n43_ = ~x02 & x06 & ~x10 & x21;
  assign new_n44_ = x01 ? (~x03 | ~new_n48_ | ~x04) : (x03 | x04 | ~new_n45_ | x06);
  ...
  assign new_n50_ = (~x06 | (x05 ? (~x18 | ~x24) : (x13 | ~x15))) & (~x13 | ~x18 | ~x24);
  ...
  assign z2 = x01 & x03 & x11 & x14 & ~new_n56_ & x20;
  assign new_n56_ = ~new_n59_ & ~new_n58_ & (~x06 | (~new_n57_ & ~new_n60_));
  assign new_n57_ = ~x05 & ~x13 & x15;
  assign new_n58_ = x13 & x18 & x24;
  assign new_n59_ = x05 & ((x06 & x18 & x24) | (x13 & x15 & ~x24));
  assign new_n60_ = x21 & ~x24 & ~x02 & ~x10;
  assign z3 = ~new_n64_ | (~x24 & (new_n68_ | (x01 & new_n62_ & x03)));
  assign new_n62_ = x08 & x11 & x14 & ~new_n63_ & x20;
  assign new_n63_ = ~new_n43_ & (~x05 | ~x13 | ~x15);
  assign new_n64_ = x01 ? (~x03 | ~new_n67_ | ~x08) : (x03 | x06 | ~new_n65_ | x08);
  ...
  assign z6 = ~new_n76_ | (~new_n82_ & (~new_n37_ | (~x05 & ~x13 & x19)));
  assign new_n76_ = (new_n79_ | ~x13) & ~new_n77_ & (new_n81_ | (new_n78_ & ~new_n57_));
  assign new_n77_ = ~x06 & x11 & (~new_n78_ | (~x05 & x15));
  assign new_n78_ = ~new_n60_ & (~x05 | ~x18 | ~x24);
  assign new_n79_ = ~new_n80_ & (new_n81_ | ((~x18 | ~x24) & (~x05 | ~x15 | x24)));
  assign new_n80_ = (x03 | ~x11) & ((x07 & x24) | (x05 & x19 & ~x24));
