...
module FAU ( 
  ...
  wire new_n36_, new_n38_, new_n40_, new_n41_, new_n45_, new_n46_, new_n47_,
    new_n49_;
  ...
  assign z7 = (x05 & ((x18 & x24) | (x13 & x15 & ~x24))) | (x13 & x18 & x24) | new_n45_ | (~x05 & ~x13 & x15);
  assign new_n45_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n46_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n47_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n49_ | (z7 & (~x03 | (x11 & (~x06 | x14))));
  assign new_n49_ = z5 & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign z2 = 1'b0;
endmodule
