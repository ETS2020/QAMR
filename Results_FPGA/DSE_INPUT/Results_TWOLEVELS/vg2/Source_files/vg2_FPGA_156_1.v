// Benchmark "FAU" written by ABC on Wed Jul 29 04:19:03 2020
...
module FAU ( 
  ...
  assign new_n39_ = x01 ? (~x04 | ~new_n40_ | ~x06) : (x03 | x04 | ~new_n43_ | x06);
  ...
  assign new_n51_ = new_n52_ & x01 & x04 & x06;
  ...
  assign z2 = x01 & x06 & x11 & x14 & z7 & x20;
  ...
  assign new_n62_ = x01 ? (~x06 | ~new_n63_ | ~x08) : (x03 | x06 | ~new_n64_ | x08);
  assign new_n63_ = x11 & x14 & ~new_n42_ & x20;
  assign new_n64_ = ~x11 & ~new_n45_ & ~x14;
  assign new_n65_ = (~new_n66_ | x01 | x03 | x06) & (~new_n67_ | ~x01 | ~x06 | ~x08);
  assign new_n66_ = x07 & ~x08 & ~x11 & ~x14;
  assign new_n67_ = x18 & x20 & x11 & x14;
  assign new_n68_ = (~new_n69_ | x01 | x03 | x06) & (~new_n70_ | ~x01 | ~x06 | ~x08);
