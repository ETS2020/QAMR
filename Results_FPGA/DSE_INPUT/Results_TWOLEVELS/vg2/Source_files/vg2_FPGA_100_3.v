...
module FAU ( 
  ...
  assign z6 = ~new_n83_ | (z5 & (x03 | (x06 & ~x11)));
  assign new_n83_ = (~x24 | new_n84_ | (~x05 & ~x13)) & ~new_n87_ & (new_n86_ | (x05 ? (~x13 | x24) : x13));
  assign new_n84_ = (new_n85_ | ~x18) & (~x07 | x11 | x14 | ~x20);
  assign new_n85_ = x03 & (~x11 | (x06 & (~x14 | x20)));
  assign new_n86_ = (new_n85_ | ~x15) & (x11 | x14 | ~x19 | ~x20);
  assign new_n87_ = ~x10 & ~x24 & (new_n88_ | (~x02 & ~new_n85_ & x21));
  assign new_n88_ = x00 & ~x11 & ~x14 & x20;
endmodule
