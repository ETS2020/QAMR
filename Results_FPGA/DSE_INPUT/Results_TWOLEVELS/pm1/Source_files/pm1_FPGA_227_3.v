// Benchmark "FAU" written by ABC on Wed Jul 29 02:05:30 2020
...
module FAU ( 
  ...
  assign z08 = (x00 & ((new_n39_ & x09 & x11 & x12) | (~x10 & ~x11 & ~x12))) | (~x11 & x12) | ~x00 | x10;
  assign new_n39_ = x02 & x03 & x04;
  assign z09 = x00 & ((~x10 & ~x11 & ~x12) | (x11 & ~new_n41_ & x12));
  assign new_n41_ = x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = x00 & x09 & x11 & ~new_n39_ & x12;
  assign z11 = x00 & x11 & (x01 ? new_n44_ : (~x10 & ~x12));
  assign new_n44_ = x09 & x12 & (~x02 | ~x03 | ~x04);
  assign z12 = x12 & x11 & x00 & ~x09;
  assign z04 = ~x14;
  assign z05 = ~x13;
  assign z07 = ~x15;
endmodule
