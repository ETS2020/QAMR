// Benchmark "FAU" written by ABC on Wed Jul 29 02:05:35 2020
...
module FAU ( 
  ...
  assign z00 = (x11 & (~x05 | ~x06 | ~x08 | (x05 & x06 & x08))) | x01 | (~x11 & x12);
  assign z01 = ~x12 | (x11 & (~x05 | ~x06 | ~x08 | (x05 & x06 & x08)));
  assign z02 = (x11 & (~x05 | ~x06 | ~x08)) | ~x09 | ~x12 | (~x11 & x12);
  assign z03 = ~x09 | ~x12 | (~x11 & x12) | (x05 & x06 & x08 & x11);
