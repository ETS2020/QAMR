// Benchmark "FAU" written by ABC on Wed Jul 29 02:04:57 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n38_, new_n40_, new_n43_;
  assign z00 = (x11 & (~x06 | ~x07 | ~x08 | (x06 & x07 & x08))) | x01 | (~x11 & x12);
  assign z01 = ~x12 | (x11 & (~x06 | ~x07 | ~x08 | (x06 & x07 & x08)));
  assign z02 = (x11 & (~x06 | ~x07 | ~x08)) | ~x09 | ~x12 | (~x11 & x12);
  assign z03 = ~x09 | ~x12 | (~x11 & x12) | (x06 & x07 & x08 & x11);
