...
module FAU ( 
  ...
  assign z00 = (x11 & (~x05 | x10)) | x01 | (~x11 & x12);
  assign z01 = ~x12 | (x11 & (~x05 | x10));
  assign z02 = ~x12 | ~x08 | ~x09 | ~new_n34_ | (~x11 & x12) | (~x05 & x11);
  assign new_n34_ = x06 & x07;
  assign z03 = ~x09 | ~x12 | new_n36_ | (~x11 & x12);
  assign new_n36_ = x07 & x08 & x05 & x06;
  assign z06 = new_n38_ & x01;
  assign new_n38_ = x09 & (~x02 | ~x03 | ~x04 | (~x11 & x12));
  assign z08 = (x11 & (x10 | (new_n40_ & x00 & x02 & x03))) | ~x00 | ~x11;
  assign new_n40_ = x04 & x09 & ~x10 & x12;
