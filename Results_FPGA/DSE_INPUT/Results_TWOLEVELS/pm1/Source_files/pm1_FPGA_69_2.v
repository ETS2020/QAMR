...
module FAU ( 
  ...
  assign z08 = (x00 & ((new_n39_ & x09 & ~x10 & x11 & x12) | (~x11 & ~x12))) | (~x11 & x12) | ~x00 | x10;
  assign new_n39_ = x02 & x03 & x04;
  assign z09 = x00 & ((~x11 & ~x12) | (~x10 & x11 & ~new_n41_ & x12));
  assign new_n41_ = x09 & (~x09 | (x02 & x03 & x04 & (~x02 | ~x03 | ~x04)));
  assign z10 = x00 & x09 & ~x10 & x11 & ~new_n39_ & x12;
  assign z11 = x00 & x11 & (x01 ? new_n44_ : ~x12);
  assign new_n44_ = x09 & ~x10 & x12 & (~x02 | ~x03 | ~x04);
