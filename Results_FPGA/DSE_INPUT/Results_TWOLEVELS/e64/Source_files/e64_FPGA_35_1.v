// Benchmark "FAU" written by ABC on Wed Jul 29 03:59:40 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n389_, new_n391_, new_n394_, new_n395_, new_n397_, new_n398_,
  ...
  assign z14 = x50 & new_n202_ & ~x43;
  assign new_n202_ = ~x37 & x29 & ~x28 & ~x15 & ~x10 & ~x14;
  assign z15 = new_n204_ & ~x43;
  ...
  assign z25 = ~x60 & ~x50 & new_n263_ & ~x46;
  ...
  assign z28 = ~x60 & ~x50 & new_n283_ & ~x46;
  assign new_n283_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n284_ & x29;
  assign new_n284_ = ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = new_n286_ & x60;
  assign new_n286_ = ~x50 & ~x43 & ~x40 & new_n202_ & ~x39 & ~x46;
  ...
  assign z32 = ~x50 & ~x43 & ~x40 & new_n202_ & ~x39 & x46;
  assign z33 = ~x50 & ~x43 & ~x40 & new_n202_ & x39;
  assign z35 = ~x62 & new_n306_ & ~x61;
  assign new_n306_ = ~x60 & ~x55 & ~x51 & new_n307_ & ~x50 & ~x56;
  assign new_n307_ = ~x47 & ~x43 & ~x41 & new_n308_ & ~x40 & ~x46;
  assign new_n308_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n309_ & x29;
  assign new_n309_ = ~x28 & ~x25 & ~x24 & new_n310_ & ~x22 & ~x26;
  assign new_n310_ = ~x18 & ~x14 & ~x11 & new_n311_ & ~x10 & ~x15;
  assign new_n311_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = ~x62 & ~x60 & ~x56 & new_n313_ & ~x55 & x61;
  assign new_n313_ = ~x51 & ~x47 & ~x46 & new_n314_ & ~x43 & ~x50;
  assign new_n314_ = ~x41 & ~x39 & ~x37 & new_n230_ & ~x35 & ~x40;
  assign z37 = new_n316_ & ~x64;
  assign new_n316_ = ~x63 & ~x61 & ~x60 & new_n317_ & ~x59 & ~x62;
  ...
  assign new_n323_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n159_ & x19;
  assign z38 = ~x62 & new_n325_ & ~x61;
  assign new_n325_ = ~x60 & ~x56 & ~x55 & new_n326_ & ~x51 & x59;
  assign new_n326_ = ~x50 & ~x46 & ~x43 & new_n327_ & ~x42 & ~x47;
  assign new_n327_ = ~x40 & ~x39 & new_n328_ & ~x37 & ~x41;
  assign new_n328_ = ~x35 & ~x30 & x29 & ~x28 & new_n329_ & ~x26;
  assign new_n329_ = ~x24 & ~x22 & new_n330_ & ~x18 & ~x25;
  assign new_n330_ = ~x14 & ~x11 & new_n331_ & ~x10 & ~x15;
  assign new_n331_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = new_n333_ & ~x62;
  assign new_n333_ = ~x61 & ~x56 & ~x55 & new_n334_ & ~x51 & ~x60;
  assign new_n334_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n327_ & x42;
  assign z40 = ~x62 & new_n336_ & ~x61;
  assign new_n336_ = ~x60 & ~x59 & ~x56 & ~x55 & new_n337_ & x54;
  ...
  assign z41 = ~x61 & ~x60 & new_n344_ & ~x59 & ~x62;
  ...
  assign z42 = new_n348_ & ~x62;
  assign new_n348_ = ~x61 & ~x59 & ~x56 & new_n349_ & ~x55 & ~x60;
  assign new_n349_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n221_ & x49;
  assign z43 = ~x62 & ~x60 & ~x59 & new_n351_ & ~x56 & ~x61;
  assign new_n351_ = ~x55 & ~x53 & ~x51 & new_n352_ & ~x50 & ~x54;
  assign new_n352_ = ~x47 & ~x45 & ~x43 & new_n353_ & ~x42 & ~x46;
  assign new_n353_ = ~x41 & ~x39 & ~x37 & new_n354_ & ~x35 & ~x40;
  assign new_n354_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n355_ & x29;
  assign new_n355_ = ~x28 & ~x25 & ~x24 & new_n356_ & ~x22 & ~x26;
  assign new_n356_ = ~x18 & ~x15 & ~x14 & new_n357_ & ~x11 & ~x17;
  assign new_n357_ = ~x10 & ~x08 & ~x07 & new_n358_ & ~x06 & ~x09;
  assign new_n358_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & x01;
  assign z44 = ~x61 & ~x60 & new_n360_ & ~x59 & ~x62;
  assign new_n360_ = ~x56 & ~x54 & ~x53 & new_n361_ & ~x51 & ~x55;
  assign new_n361_ = ~x50 & ~x46 & ~x45 & new_n362_ & ~x43 & ~x47;
  assign new_n362_ = ~x42 & ~x40 & ~x39 & new_n363_ & ~x37 & ~x41;
  assign new_n363_ = ~x35 & ~x33 & ~x31 & new_n364_ & ~x30 & ~x34;
  assign new_n364_ = x29 & ~x26 & ~x25 & new_n365_ & ~x24 & ~x28;
  assign new_n365_ = ~x22 & ~x17 & ~x15 & new_n366_ & ~x14 & ~x18;
  assign new_n366_ = ~x11 & ~x09 & ~x08 & new_n367_ & ~x07 & ~x10;
  assign new_n367_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & new_n369_ & ~x60;
  assign new_n369_ = ~x59 & ~x55 & ~x51 & new_n370_ & ~x50 & ~x56;
  assign new_n370_ = ~x47 & ~x43 & ~x42 & new_n371_ & ~x41 & ~x46;
  assign new_n371_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n340_ & x34;
  assign z46 = new_n373_ & ~x62;
  assign new_n373_ = ~x61 & ~x59 & ~x56 & new_n374_ & ~x55 & ~x60;
  assign new_n374_ = ~x51 & ~x47 & ~x46 & new_n375_ & ~x43 & ~x50;
  assign new_n375_ = ~x42 & ~x40 & ~x39 & new_n376_ & ~x37 & ~x41;
  assign new_n376_ = ~x35 & ~x30 & x29 & ~x28 & new_n377_ & ~x26;
  assign new_n377_ = ~x25 & ~x22 & ~x18 & new_n378_ & ~x17 & ~x24;
  assign new_n378_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n331_ & x09;
  assign z47 = ~x62 & ~x60 & ~x59 & new_n380_ & ~x56 & ~x61;
  assign new_n380_ = ~x55 & ~x50 & ~x47 & new_n381_ & ~x46 & ~x51;
  assign new_n381_ = ~x43 & ~x41 & ~x40 & new_n382_ & ~x39 & ~x42;
  assign new_n382_ = ~x37 & ~x35 & ~x30 & x29 & new_n383_ & ~x28;
  assign new_n383_ = ~x26 & ~x24 & ~x22 & new_n384_ & ~x18 & ~x25;
  assign new_n384_ = new_n330_ & x17;
  assign z48 = ~x62 & new_n386_ & ~x61;
  assign new_n386_ = ~x60 & ~x56 & ~x55 & new_n387_ & ~x54 & ~x59;
  assign new_n387_ = ~x53 & ~x50 & ~x47 & new_n388_ & ~x46 & ~x51;
  assign new_n388_ = ~x43 & ~x41 & ~x40 & new_n389_ & ~x39 & ~x42;
  assign new_n389_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n340_ & x31;
  assign z49 = ~x62 & ~x61 & new_n391_ & ~x60;
  assign new_n391_ = ~x59 & ~x56 & ~x55 & ~x54 & new_n337_ & x53;
  assign z50 = ~x62 & ~x61 & ~x60 & ~x59 & new_n219_ & x57;
  assign z51 = ~x62 & new_n394_ & ~x61;
  assign new_n394_ = ~x60 & ~x56 & ~x55 & new_n395_ & ~x54 & ~x59;
  assign new_n395_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n221_ & x48;
  assign z52 = ~x64 & ~x62 & ~x61 & new_n397_ & ~x60 & ~x63;
  assign new_n397_ = ~x59 & ~x56 & ~x55 & new_n398_ & ~x54 & ~x57;
  assign new_n398_ = ~x53 & ~x50 & ~x49 & new_n399_ & ~x48 & ~x51;
  assign new_n399_ = ~x47 & ~x45 & ~x43 & new_n400_ & ~x42 & ~x46;
  assign new_n400_ = ~x41 & ~x39 & ~x37 & new_n401_ & ~x35 & ~x40;
  assign new_n401_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n402_ & x29;
  assign new_n402_ = ~x28 & ~x25 & ~x24 & new_n403_ & ~x22 & ~x26;
  assign new_n403_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n226_ & x12;
  assign z53 = ~x64 & new_n218_ & x63;
  assign z54 = ~x62 & ~x60 & ~x56 & new_n313_ & x55;
  assign z55 = ~x62 & ~x60 & new_n407_ & ~x56;
  assign new_n407_ = ~x51 & ~x47 & ~x46 & new_n408_ & ~x43 & ~x50;
  assign new_n408_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n230_ & x35;
  assign z56 = ~x63 & ~x62 & new_n410_ & ~x61 & ~x64;
  assign new_n410_ = ~x60 & ~x57 & ~x56 & new_n411_ & ~x55 & ~x59;
  assign new_n411_ = ~x54 & ~x52 & ~x51 & new_n412_ & ~x50 & ~x53;
  assign new_n412_ = ~x49 & ~x47 & ~x46 & new_n413_ & ~x45 & ~x48;
  assign new_n413_ = ~x43 & ~x41 & ~x40 & new_n414_ & ~x39 & ~x42;
  assign new_n414_ = ~x37 & ~x35 & ~x34 & new_n415_ & ~x33 & ~x36;
  assign new_n415_ = ~x31 & ~x30 & x29 & ~x28 & new_n416_ & ~x26;
  assign new_n416_ = ~x25 & ~x24 & ~x22 & ~x21 & new_n417_ & x20;
  assign new_n417_ = ~x18 & ~x16 & ~x15 & new_n249_ & ~x14 & ~x17;
  assign z57 = ~x60 & ~x56 & new_n419_ & ~x50 & ~x62;
  assign new_n419_ = ~x47 & ~x43 & ~x41 & new_n420_ & ~x40 & ~x46;
  ...
  assign z58 = ~x62 & ~x60 & new_n425_ & ~x56;
  ...
  assign z59 = ~x50 & ~x43 & new_n202_ & x40;
  assign z60 = ~x56 & ~x50 & new_n430_ & ~x47 & ~x60;
  assign new_n430_ = ~x46 & ~x40 & ~x39 & new_n431_ & ~x37 & ~x43;
  assign new_n431_ = ~x30 & ~x28 & ~x25 & new_n432_ & ~x24 & x29;
  assign new_n432_ = ~x15 & ~x11 & ~x10 & x07 & ~x08 & ~x14;
  assign z61 = ~x60 & ~x56 & new_n434_ & ~x50;
  assign new_n434_ = ~x47 & ~x43 & ~x40 & new_n435_ & ~x39 & ~x46;
  assign new_n435_ = ~x37 & ~x30 & x29 & ~x28 & new_n436_ & ~x25;
  assign new_n436_ = ~x24 & ~x14 & ~x11 & x08 & ~x10 & ~x15;
  assign z62 = ~x60 & ~x56 & ~x50 & new_n438_ & x47;
  assign new_n438_ = new_n439_ & ~x46;
  assign new_n439_ = ~x43 & ~x39 & ~x37 & new_n440_ & ~x30 & ~x40;
  assign new_n440_ = x29 & new_n441_ & ~x28;
  assign new_n441_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & x56 & new_n438_ & ~x50;
  assign z64 = ~x60 & ~x50 & new_n444_ & ~x46;
