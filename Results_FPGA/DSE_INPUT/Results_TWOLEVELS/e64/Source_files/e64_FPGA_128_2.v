// Benchmark "FAU" written by ABC on Wed Jul 29 04:00:08 2020
...
module FAU ( 
  ...
  assign new_n144_ = ~x41 & ~x37 & ~x35 & new_n145_ & ~x34 & ~x40;
  ...
  assign new_n178_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n179_ & x38;
  ...
  assign new_n185_ = ~x40 & ~x36 & ~x35 & new_n186_ & ~x34 & ~x37;
  ...
  assign new_n193_ = ~x40 & ~x37 & ~x30 & x29 & new_n194_ & ~x28;
  ...
  assign new_n210_ = ~x46 & ~x40 & ~x37 & new_n211_ & ~x30 & ~x43;
  ...
  assign new_n214_ = ~x47 & ~x43 & ~x40 & new_n215_ & ~x37 & ~x46;
  ...
  assign new_n223_ = ~x43 & ~x41 & ~x40 & new_n224_ & ~x37 & ~x42;
  ...
  assign new_n230_ = ~x46 & ~x41 & ~x40 & new_n231_ & ~x37 & ~x43;
  ...
  assign new_n237_ = ~x43 & ~x40 & ~x37 & new_n238_ & ~x30 & ~x41;
  ...
  assign new_n246_ = ~x41 & ~x40 & ~x37 & x36 & new_n247_ & ~x35;
  ...
  assign new_n256_ = ~x40 & ~x36 & ~x35 & new_n257_ & ~x34 & ~x37;
  ...
  assign new_n261_ = ~x43 & ~x40 & ~x37 & x29 & new_n262_ & ~x28;
  assign new_n262_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x60 & ~x58 & new_n264_ & ~x50;
  assign new_n264_ = ~x46 & ~x43 & ~x40 & ~x37 & new_n265_ & x29;
  ...
  assign new_n270_ = ~x43 & ~x41 & ~x40 & new_n271_ & ~x37 & ~x42;
  ...
  assign new_n278_ = ~x43 & ~x41 & ~x40 & new_n279_ & ~x37 & ~x42;
  ...
  assign new_n284_ = ~x46 & ~x43 & ~x40 & ~x37 & new_n285_ & x29;
  assign new_n285_ = ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = new_n287_ & x60;
  assign new_n287_ = ~x58 & ~x46 & ~x43 & new_n202_ & ~x40 & ~x50;
  ...
  assign new_n293_ = ~x40 & ~x36 & ~x35 & new_n294_ & ~x34 & ~x37;
  ...
  assign new_n301_ = ~x40 & ~x36 & ~x35 & new_n302_ & ~x34 & ~x37;
  ...
  assign new_n310_ = ~x40 & ~x37 & ~x35 & ~x30 & new_n311_ & x29;
  ...
  assign new_n316_ = ~x50 & ~x47 & new_n317_ & ~x46 & ~x51;
  assign new_n317_ = ~x43 & ~x40 & ~x37 & new_n231_ & ~x35 & ~x41;
  ...
  assign new_n323_ = ~x42 & ~x40 & ~x37 & new_n324_ & ~x36 & ~x41;
  ...
  assign new_n330_ = ~x41 & ~x40 & new_n331_ & ~x37;
  ...
  assign new_n340_ = ~x51 & new_n341_ & ~x50;
  assign new_n341_ = ~x47 & ~x43 & ~x42 & new_n342_ & ~x41 & ~x46;
  assign new_n342_ = ~x40 & ~x35 & ~x34 & new_n343_ & ~x33 & ~x37;
  ...
  assign new_n347_ = ~x58 & ~x55 & ~x51 & new_n348_ & ~x50 & ~x56;
  assign new_n348_ = ~x47 & ~x43 & ~x42 & new_n349_ & ~x41 & ~x46;
  assign new_n349_ = ~x40 & ~x37 & ~x35 & ~x34 & new_n343_ & x33;
  ...
  assign new_n356_ = ~x42 & ~x40 & ~x37 & new_n357_ & ~x35 & ~x41;
  ...
  assign new_n365_ = ~x43 & ~x41 & ~x40 & new_n366_ & ~x37 & ~x42;
  ...
  assign new_n373_ = ~x50 & ~x46 & ~x43 & new_n374_ & ~x42 & ~x47;
  assign new_n374_ = ~x41 & ~x40 & ~x37 & ~x35 & new_n343_ & x34;
  assign z46 = new_n376_ & ~x62;
  assign new_n376_ = ~x61 & ~x59 & ~x58 & new_n377_ & ~x56 & ~x60;
  assign new_n377_ = ~x55 & ~x50 & ~x47 & new_n378_ & ~x46 & ~x51;
  assign new_n378_ = ~x43 & ~x41 & ~x40 & new_n379_ & ~x37 & ~x42;
  ...
  assign new_n390_ = ~x54 & ~x51 & ~x50 & new_n391_ & ~x47 & ~x53;
  assign new_n391_ = ~x46 & ~x42 & ~x41 & new_n392_ & ~x40 & ~x43;
  ...
  assign new_n404_ = ~x42 & ~x40 & ~x37 & new_n405_ & ~x35 & ~x41;
  ...
  assign new_n411_ = ~x56 & ~x50 & ~x47 & new_n412_ & ~x46 & ~x51;
  assign new_n412_ = ~x43 & ~x41 & ~x40 & ~x37 & new_n231_ & x35;
  ...
  assign new_n421_ = ~x18 & ~x16 & ~x15 & new_n250_ & ~x14 & ~x17;
  assign z57 = ~x60 & ~x58 & new_n423_ & ~x56 & ~x62;
  assign new_n423_ = ~x50 & ~x46 & ~x43 & new_n424_ & ~x41 & ~x47;
  assign new_n424_ = ~x40 & ~x37 & ~x30 & x29 & new_n425_ & ~x28;
  ...
  assign new_n442_ = ~x46 & ~x40 & ~x37 & new_n443_ & ~x30 & ~x43;
  assign new_n443_ = x29 & new_n444_ & ~x28;
  assign new_n444_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n442_ & ~x50;
  assign z64 = ~x60 & ~x58 & new_n447_ & ~x50;
  assign new_n447_ = ~x46 & ~x43 & ~x40 & ~x37 & new_n443_ & x30;
  assign z33 = 1'b0;
  assign z05 = x29;
endmodule
