...
module FAU ( 
  ...
  wire new_n138_, new_n139_, new_n140_, new_n141_, new_n143_, new_n144_,
    ...
    new_n189_, new_n192_, new_n193_, new_n194_, new_n196_, new_n197_,
  ...
  assign new_n175_ = ~x43 & ~x40 & new_n149_ & ~x39;
  ...
  assign z57 = ~x62 & ~x60 & ~x58 & new_n181_ & ~x56;
  assign new_n181_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n182_ & ~x41;
  assign new_n182_ = ~x40 & ~x39 & ~x37 & new_n183_ & x29 & ~x30;
  assign new_n183_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n184_ & ~x22;
  assign new_n184_ = ~x15 & new_n185_ & ~x14;
  assign new_n185_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n187_ & ~x56;
  assign new_n187_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n188_ & ~x41;
  assign new_n188_ = ~x40 & ~x39 & ~x37 & new_n189_ & x29 & ~x30;
  assign new_n189_ = ~x28 & ~x26 & ~x25 & new_n184_ & x22 & ~x24;
  assign z59 = ~x58 & ~x50 & new_n149_ & x40 & ~x43;
  assign z60 = ~x60 & ~x58 & ~x56 & ~x50 & new_n192_ & ~x47;
  ...
  assign z61 = ~x60 & ~x58 & ~x56 & new_n196_ & ~x50;
  assign new_n196_ = ~x47 & ~x46 & ~x43 & ~x40 & new_n197_ & ~x39;
  assign new_n197_ = ~x37 & ~x30 & x29 & ~x28 & new_n198_ & ~x25;
  assign new_n198_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = ~x60 & ~x58 & ~x56 & new_n200_ & x47 & ~x50;
  assign new_n200_ = new_n201_ & ~x46;
  assign new_n201_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n202_ & ~x30;
  assign new_n202_ = x29 & new_n203_ & ~x28;
  assign new_n203_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n200_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n206_ & ~x46;
  assign new_n206_ = ~x43 & ~x40 & ~x39 & new_n202_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
