// Benchmark "FAU" written by ABC on Wed Jul 29 04:00:38 2020
...
module FAU ( 
  ...
  assign new_n220_ = ~x62 & ~x60 & ~x59 & new_n221_ & ~x57 & ~x61;
  ...
  assign new_n253_ = ~x61 & ~x59 & ~x57 & new_n254_ & ~x56 & ~x60;
  ...
  assign new_n268_ = ~x59 & ~x56 & ~x55 & new_n269_ & ~x54 & ~x57;
  ...
  assign new_n276_ = ~x59 & ~x56 & ~x55 & new_n277_ & ~x54 & ~x57;
  ...
  assign new_n290_ = ~x61 & ~x59 & ~x57 & new_n291_ & ~x56 & ~x60;
  ...
  assign new_n298_ = ~x62 & ~x60 & ~x59 & new_n299_ & ~x57 & ~x61;
  ...
  assign new_n310_ = ~x60 & ~x55 & ~x51 & new_n311_ & ~x50 & ~x56;
  ...
  assign new_n322_ = ~x57 & ~x55 & ~x54 & new_n323_ & ~x53 & ~x56;
  assign new_n323_ = ~x52 & ~x50 & ~x49 & new_n324_ & ~x48 & ~x51;
  assign new_n324_ = ~x47 & ~x45 & ~x43 & new_n325_ & ~x42 & ~x46;
  assign new_n325_ = ~x41 & ~x39 & ~x37 & new_n326_ & ~x36 & ~x40;
  assign new_n326_ = ~x35 & ~x33 & ~x32 & new_n327_ & ~x31 & ~x34;
  assign new_n327_ = ~x30 & ~x28 & ~x26 & new_n328_ & ~x25 & x29;
  assign new_n328_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n159_ & x19;
  assign z38 = ~x62 & new_n330_ & ~x61;
  assign new_n330_ = ~x60 & ~x56 & ~x55 & new_n331_ & ~x51 & x59;
  assign new_n331_ = ~x50 & ~x46 & ~x43 & new_n332_ & ~x42 & ~x47;
  assign new_n332_ = ~x40 & ~x39 & new_n333_ & ~x37 & ~x41;
  ...
  assign z39 = new_n338_ & ~x62;
  assign new_n338_ = ~x61 & ~x56 & ~x55 & new_n339_ & ~x51 & ~x60;
  assign new_n339_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n332_ & x42;
  assign z40 = ~x62 & new_n341_ & ~x61;
  assign new_n341_ = ~x60 & ~x59 & ~x56 & ~x55 & new_n342_ & x54;
  ...
  assign z41 = ~x61 & ~x60 & new_n349_ & ~x59 & ~x62;
  ...
  assign new_n353_ = ~x61 & ~x59 & ~x56 & new_n354_ & ~x55 & ~x60;
  assign new_n354_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n223_ & x49;
  assign z43 = ~x62 & ~x60 & ~x59 & new_n356_ & ~x56 & ~x61;
  assign new_n356_ = ~x55 & ~x53 & ~x51 & new_n357_ & ~x50 & ~x54;
  assign new_n357_ = ~x47 & ~x45 & ~x43 & new_n358_ & ~x42 & ~x46;
  assign new_n358_ = ~x41 & ~x39 & ~x37 & new_n359_ & ~x35 & ~x40;
  assign new_n359_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n360_ & x29;
  ...
  assign new_n365_ = ~x56 & ~x54 & ~x53 & new_n366_ & ~x51 & ~x55;
  assign new_n366_ = ~x50 & ~x46 & ~x45 & new_n367_ & ~x43 & ~x47;
  assign new_n367_ = ~x42 & ~x40 & ~x39 & new_n368_ & ~x37 & ~x41;
  assign new_n368_ = ~x35 & ~x33 & ~x31 & new_n369_ & ~x30 & ~x34;
  assign new_n369_ = x29 & ~x26 & ~x25 & new_n370_ & ~x24 & ~x28;
  ...
  assign z45 = ~x62 & ~x61 & new_n374_ & ~x60;
  assign new_n374_ = ~x59 & ~x55 & ~x51 & new_n375_ & ~x50 & ~x56;
  assign new_n375_ = ~x47 & ~x43 & ~x42 & new_n376_ & ~x41 & ~x46;
  assign new_n376_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n345_ & x34;
  assign z46 = new_n378_ & ~x62;
  assign new_n378_ = ~x61 & ~x59 & ~x56 & new_n379_ & ~x55 & ~x60;
  ...
  assign z47 = ~x62 & ~x60 & ~x59 & new_n385_ & ~x56 & ~x61;
  assign new_n385_ = ~x55 & ~x50 & ~x47 & new_n386_ & ~x46 & ~x51;
  assign new_n386_ = ~x43 & ~x41 & ~x40 & new_n387_ & ~x39 & ~x42;
  assign new_n387_ = ~x37 & ~x35 & ~x30 & x29 & new_n388_ & ~x28;
  assign new_n388_ = ~x26 & ~x24 & ~x22 & new_n389_ & ~x18 & ~x25;
  assign new_n389_ = new_n335_ & x17;
  assign z48 = ~x62 & new_n391_ & ~x61;
  assign new_n391_ = ~x60 & ~x56 & ~x55 & new_n392_ & ~x54 & ~x59;
  ...
  assign z49 = ~x62 & ~x61 & new_n396_ & ~x60;
  assign new_n396_ = ~x59 & ~x56 & ~x55 & ~x54 & new_n342_ & x53;
  assign z50 = ~x62 & ~x61 & ~x60 & ~x59 & new_n221_ & x57;
  assign z51 = ~x62 & new_n399_ & ~x61;
  assign new_n399_ = ~x60 & ~x56 & ~x55 & new_n400_ & ~x54 & ~x59;
  assign new_n400_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n223_ & x48;
  assign z52 = ~x64 & ~x62 & ~x61 & new_n402_ & ~x60 & ~x63;
  assign new_n402_ = ~x59 & ~x56 & ~x55 & new_n403_ & ~x54 & ~x57;
  ...
  assign new_n415_ = ~x60 & ~x57 & ~x56 & new_n416_ & ~x55 & ~x59;
  assign new_n416_ = ~x54 & ~x52 & ~x51 & new_n417_ & ~x50 & ~x53;
  assign new_n417_ = ~x49 & ~x47 & ~x46 & new_n418_ & ~x45 & ~x48;
  ...
  assign new_n422_ = ~x18 & ~x16 & ~x15 & new_n251_ & ~x14 & ~x17;
  ...
  assign z60 = ~x60 & ~x56 & ~x50 & new_n435_ & ~x47 & ~x58;
  ...
  assign z61 = ~x58 & ~x56 & new_n439_ & ~x50 & ~x60;
  assign new_n439_ = ~x47 & ~x43 & ~x40 & new_n440_ & ~x39 & ~x46;
