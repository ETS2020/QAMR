...
module FAU ( 
  ...
  wire new_n138_, new_n139_, new_n140_, new_n141_, new_n143_, new_n144_,
    ...
    new_n240_, new_n241_, new_n242_, new_n245_, new_n246_, new_n248_,
    new_n249_, new_n250_, new_n251_, new_n252_, new_n254_, new_n255_,
    new_n256_, new_n259_, new_n260_, new_n261_, new_n263_, new_n264_,
  ...
  assign new_n218_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n219_ & ~x33;
  assign new_n219_ = ~x30 & x29 & ~x28 & new_n220_ & ~x26;
  ...
  assign new_n225_ = ~x39 & ~x37 & ~x35 & new_n219_ & x33 & ~x34;
  assign z45 = ~x62 & ~x61 & ~x60 & new_n227_ & ~x59;
  assign new_n227_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n228_ & ~x50;
  assign new_n228_ = ~x47 & ~x46 & ~x43 & ~x42 & new_n229_ & ~x41;
  assign new_n229_ = ~x40 & ~x39 & ~x37 & new_n219_ & x34 & ~x35;
  assign z46 = ~x62 & new_n231_ & ~x61;
  assign new_n231_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n232_ & ~x55;
  assign new_n232_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n233_ & ~x43;
  assign new_n233_ = ~x42 & ~x41 & ~x40 & ~x39 & new_n234_ & ~x37;
  assign new_n234_ = ~x35 & ~x30 & x29 & ~x28 & new_n235_ & ~x26;
  assign new_n235_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n236_ & ~x17;
  assign new_n236_ = ~x15 & ~x14 & ~x11 & new_n211_ & x09 & ~x10;
  ...
  assign new_n242_ = ~x25 & ~x24 & ~x22 & new_n210_ & x17 & ~x18;
  assign z54 = ~x62 & ~x60 & ~x58 & new_n202_ & x55 & ~x56;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n245_ & ~x56;
  assign new_n245_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n246_ & ~x43;
  assign new_n246_ = ~x41 & ~x40 & ~x39 & new_n168_ & x35 & ~x37;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n248_ & ~x50;
  ...
  assign z58 = ~x62 & ~x60 & ~x58 & new_n254_ & ~x56;
  assign new_n254_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n255_ & ~x41;
  assign new_n255_ = ~x40 & ~x39 & ~x37 & new_n256_ & x29 & ~x30;
  assign new_n256_ = ~x28 & ~x26 & ~x25 & new_n251_ & x22 & ~x24;
  assign z59 = ~x58 & ~x50 & new_n149_ & x40 & ~x43;
  assign z60 = ~x60 & ~x58 & ~x56 & ~x50 & new_n259_ & ~x47;
  assign new_n259_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n260_ & ~x37;
  assign new_n260_ = ~x30 & x29 & ~x28 & ~x25 & new_n261_ & ~x24;
  assign new_n261_ = ~x15 & ~x14 & ~x11 & ~x10 & x07 & ~x08;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n263_ & ~x50;
  assign new_n263_ = ~x47 & ~x46 & ~x43 & ~x40 & new_n264_ & ~x39;
  assign new_n264_ = ~x37 & ~x30 & x29 & ~x28 & new_n265_ & ~x25;
  assign new_n265_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = ~x60 & ~x58 & ~x56 & new_n267_ & x47 & ~x50;
  assign new_n267_ = new_n268_ & ~x46;
  assign new_n268_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n269_ & ~x30;
  assign new_n269_ = x29 & new_n270_ & ~x28;
  assign new_n270_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n267_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n273_ & ~x46;
  assign new_n273_ = ~x43 & ~x40 & ~x39 & new_n269_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
