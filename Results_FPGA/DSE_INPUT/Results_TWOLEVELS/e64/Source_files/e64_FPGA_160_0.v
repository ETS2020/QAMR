// Benchmark "FAU" written by ABC on Wed Jul 29 04:00:17 2020
...
module FAU ( 
  ...
  assign z38 = ~x62 & ~x61 & ~x60 & new_n205_ & ~x58;
  ...
  assign z54 = ~x62 & ~x60 & ~x58 & new_n215_ & x55 & ~x56;
  assign new_n215_ = new_n202_ & ~x51;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n217_ & ~x56;
  assign new_n217_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n218_ & ~x43;
  assign new_n218_ = ~x41 & ~x40 & ~x39 & new_n168_ & x35 & ~x37;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n220_ & ~x50;
  assign new_n220_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n221_ & ~x40;
  assign new_n221_ = ~x39 & ~x37 & ~x30 & x29 & new_n222_ & ~x28;
  assign new_n222_ = ~x26 & ~x25 & ~x24 & new_n223_ & x18 & ~x22;
  assign new_n223_ = ~x15 & new_n224_ & ~x14;
  assign new_n224_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n226_ & ~x56;
  assign new_n226_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n227_ & ~x41;
  assign new_n227_ = ~x40 & ~x39 & ~x37 & new_n228_ & x29 & ~x30;
  assign new_n228_ = ~x28 & ~x26 & ~x25 & new_n223_ & x22 & ~x24;
  assign z59 = ~x58 & ~x50 & new_n149_ & x40 & ~x43;
  assign z60 = ~x60 & ~x58 & ~x56 & ~x50 & new_n231_ & ~x47;
  assign new_n231_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n232_ & ~x37;
  assign new_n232_ = ~x30 & x29 & ~x28 & ~x25 & new_n233_ & ~x24;
  assign new_n233_ = ~x15 & ~x14 & ~x11 & ~x10 & x07 & ~x08;
  assign z61 = ~x60 & ~x58 & ~x56 & new_n235_ & ~x50;
  ...
  assign z62 = ~x60 & ~x58 & ~x56 & new_n239_ & x47 & ~x50;
  assign new_n239_ = new_n240_ & ~x46;
  assign new_n240_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n241_ & ~x30;
  assign new_n241_ = x29 & new_n242_ & ~x28;
  assign new_n242_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n239_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n245_ & ~x46;
  assign new_n245_ = ~x43 & ~x40 & ~x39 & new_n241_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
