...
module FAU ( 
  ...
  assign z07 = (~new_n379_ & ~x46) | (~x47 & (~new_n421_ | (~new_n413_ & x46)));
  assign new_n379_ = ~new_n409_ & (new_n397_ | ~x53) & (x53 | (~new_n380_ & ~new_n388_ & new_n393_));
  assign new_n380_ = x47 & (~new_n383_ | (x51 & (x48 ? ~new_n381_ : ~new_n387_)));
  assign new_n381_ = (~x01 | ((~x49 | x50) & (~x26 | x49 | ~x50))) & (new_n382_ | x50) & (~x50 | (~x52 & (x49 | x52 | (x01 & x26))));
  assign new_n382_ = (~x27 | ~x52) & (~x49 | (x43 & ~x52));
  assign new_n383_ = ~new_n386_ & (~x05 | ~x49) & (x51 | (~new_n384_ & new_n385_));
  assign new_n384_ = ~x48 & (x50 ? (x49 | (~x49 & (x52 | (x28 & ~x52)))) : (x49 | (~x09 & ~x49 & ~x52)));
  assign new_n385_ = (x31 | x49 | ~x52) & (~x48 | ((~x49 | (x50 ^ x52)) & (x01 | x52) & (~x50 | (x52 & (x49 | ~x52)))));
  ...
  assign new_n389_ = (~new_n252_ | ~x29 | ~x48) & (~x51 | (~new_n250_ & (~new_n390_ | x48)));
  ...
  assign new_n400_ = ~new_n402_ & (~x51 | ((new_n401_ | x50) & (~x49 | new_n258_ | ~x50)));
  ...
  assign new_n409_ = x47 & ((~new_n410_ & x50) | (new_n162_ & x38 & new_n160_ & ~x50));
  ...
  assign new_n414_ = new_n417_ & (~x50 | (~new_n415_ & ~new_n135_ & (new_n416_ | x49)));
  assign new_n415_ = ~x51 & (x49 ? ~new_n377_ : (x53 & (x52 | (x41 & ~x52))));
  assign new_n416_ = (~x52 | (~x27 & (~x21 | ~x51 | x53))) & (x21 | x53) & (~x51 | new_n303_ | x52);
  ...
  assign new_n422_ = ~x50 & ((new_n160_ & x26) | (new_n173_ & ~x29));
  ...
  assign new_n433_ = new_n331_ & ~x46 & ~x48 & ~x49;
  ...
  assign new_n461_ = x50 ? (x51 | new_n268_ | ~x52) : (~x51 | x52);
  assign new_n462_ = new_n162_ & ~x47 & new_n173_ & ~x50 & ~x51;
  ...
  assign new_n486_ = new_n281_ & new_n139_ & x46 & x48 & ~x49;
  ...
  assign new_n497_ = (~new_n498_ | x46) & (~new_n281_ | ~new_n139_ | ~x46 | x47 | x48);
  ...
  assign z49 = (~x48 & (new_n521_ | (new_n331_ & ~x46 & x47 & ~x49))) | (new_n331_ & x46 & ~x47 & x48 & ~x49);
