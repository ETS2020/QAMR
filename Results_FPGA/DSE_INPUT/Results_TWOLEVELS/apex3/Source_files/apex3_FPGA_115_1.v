...
module FAU ( 
  ...
  assign new_n207_ = (~x51 | (~new_n208_ & ~new_n209_)) & (~x49 | ~new_n210_ | x51);
  assign new_n208_ = ~x52 & ((x49 & x53) | (x43 & ((x50 & x53) | (~x01 & x49))));
  assign new_n209_ = x50 & x52 & x53 & (x49 | (x45 & ~x49));
  ...
  assign new_n381_ = (~x01 | ((~x49 | x50) & (~x26 | x49 | ~x50))) & (new_n382_ | x50) & (x49 | ~x50 | (~x52 & (x52 | (x01 & x26))));
  ...
  assign new_n408_ = x50 & x51 & x52 & ((~x48 & x49) | (x45 & x48 & ~x49));
