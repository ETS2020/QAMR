// Benchmark "FAU" written by ABC on Wed Jul 29 11:21:24 2020
...
module FAU ( 
  ...
  assign new_n393_ = (~x08 | ((~x48 | x52) & (~x49 | ~x52 | x47 | x48))) & (x47 | (x48 ? (~x49 | x52) : (x49 | ~x52))) & (~x49 | ((~x18 | x52) & (x08 | x48 | ~x52)));
  ...
  assign new_n425_ = ~x53 & (x33 ? x50 : new_n149_);
