...
module FAU ( 
  ...
  assign new_n50_ = (x19 | (~x17 & ~x18)) & (~x19 | x20) & x21 & x22;
  ...
  assign z13 = ~new_n69_ | (x20 & (~x17 | ~x18));
  assign new_n69_ = ~x07 & ~x15 & ~new_n62_ & (~new_n51_ | x07 | x15);
  assign z14 = (~new_n62_ & x21) | x07 | x15 | new_n71_ | (new_n51_ & ~x07 & ~x15);
  ...
  assign z18 = new_n81_ | x07 | x15 | new_n82_ | (new_n51_ & ~x07 & ~x15);
