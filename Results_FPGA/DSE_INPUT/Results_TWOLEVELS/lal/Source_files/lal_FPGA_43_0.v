...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n53_, new_n58_, new_n59_, new_n60_, new_n61_,
    new_n62_, new_n63_, new_n68_, new_n70_, new_n72_, new_n74_, new_n76_,
  ...
  assign new_n68_ = ~x15 & ((~x05 & (~x17 | (x17 & ~x18))) | (~x04 & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19))));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n70_ | (new_n51_ & new_n70_) | (x17 & x18 & x19 & ~x20);
  assign new_n70_ = ~x07 & ~x15;
  assign z14 = (~new_n62_ & x21) | ~new_n70_ | new_n72_ | (new_n51_ & new_n70_);
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n72_ & x22) | ~new_n70_ | new_n74_ | (new_n51_ & new_n70_);
  assign new_n74_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n74_ & x23) | ~new_n70_ | new_n76_ | (new_n51_ & new_n70_);
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (x17 & new_n80_ & x18) | ~new_n79_ | (~new_n76_ & x24);
  assign new_n79_ = ~x07 & ~x15 & (~new_n51_ | x07 | x15);
  assign new_n80_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n82_ | ~new_n70_ | new_n83_ | (new_n51_ & new_n70_);
  assign new_n82_ = x25 & (~new_n62_ | x21 | x22 | x23 | x24);
  assign new_n83_ = new_n62_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z02 = x16;
endmodule
