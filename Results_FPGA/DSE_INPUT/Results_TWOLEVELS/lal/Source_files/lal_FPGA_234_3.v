// Benchmark "FAU" written by ABC on Wed Jul 29 04:26:09 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n50_, new_n51_, new_n53_, new_n63_, new_n65_, new_n66_, new_n68_,
  ...
  assign z12 = ~x07 & ~x15 & ((x17 & x18 & ~new_n51_ & ~x19) | (x19 & (~x17 | ~x18)));
  assign z13 = (x20 & (~x17 | ~x18 | ~x19)) | ~new_n63_ | (new_n51_ & new_n63_) | (x17 & x18 & x19 & ~x20);
  assign new_n63_ = ~x07 & ~x15;
  assign z14 = (~new_n65_ & x21) | ~new_n63_ | new_n66_ | (new_n51_ & new_n63_);
  assign new_n65_ = x17 & x18 & x19 & ~x20;
  assign new_n66_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = (~new_n66_ & x22) | ~new_n63_ | new_n68_ | (new_n51_ & new_n63_);
  assign new_n68_ = x17 & x18 & x19 & ~x20 & ~x21 & ~x22;
  assign z16 = (~new_n68_ & x23) | ~new_n63_ | new_n70_ | (new_n51_ & new_n63_);
  assign new_n70_ = new_n71_ & x17 & x18 & x19;
  assign new_n71_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (~new_n70_ & x24) | ~new_n63_ | new_n73_ | (new_n51_ & new_n63_);
  assign new_n73_ = new_n65_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = (~new_n73_ & x25) | ~new_n63_ | new_n75_ | (new_n51_ & new_n63_);
