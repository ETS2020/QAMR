...
module FAU ( 
  ...
  assign z16 = (x17 & new_n72_ & x18) | ~new_n71_ | (~new_n69_ & x23);
  assign new_n71_ = ~x07 & ~x15 & (~new_n50_ | x07 | x15);
  assign new_n72_ = ~x20 & ~x21 & ~x22 & ~x23 & (x24 | (x19 & ~x24));
  assign z17 = (x17 & new_n74_ & x18) | ~new_n71_ | (~new_n75_ & x24);
