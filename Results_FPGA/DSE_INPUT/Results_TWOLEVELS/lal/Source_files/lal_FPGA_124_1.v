// Benchmark "FAU" written by ABC on Wed Jul 29 04:25:46 2020
...
module FAU ( 
  ...
  assign z03 = ~x25 & (~x24 | (~x23 & (~x20 | ~x22 | (~x21 & x22))));
  ...
  assign z14 = new_n68_ | ~new_n67_ | (~new_n60_ & x21);
  assign new_n67_ = ~x07 & ~x15 & (~new_n50_ | x07 | x15);
  assign new_n68_ = x17 & x18 & ~x20 & ~x21 & (x22 | (x19 & ~x22));
  assign z15 = new_n71_ | x07 | x15 | new_n70_ | (new_n50_ & ~x07 & ~x15);
  assign new_n70_ = new_n58_ & new_n59_ & ~x20;
  assign new_n71_ = x22 & (~x17 | ~x18 | x20 | x21);
  assign z16 = (~new_n70_ & x23) | x07 | x15 | new_n73_ | (new_n50_ & ~x07 & ~x15);
  assign new_n73_ = new_n58_ & ~x20 & ~x21 & ~x22 & ~x23;
  assign z17 = (x17 & new_n75_ & x18) | ~new_n67_ | (~new_n73_ & x24);
  assign new_n75_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n77_ | x07 | x15 | new_n78_ | (new_n50_ & ~x07 & ~x15);
  assign new_n77_ = x25 & (~new_n60_ | ~new_n59_ | x23 | x24);
  assign new_n78_ = new_n60_ & new_n59_ & ~x23 & ~x24 & ~x25;
  assign z02 = x16;
endmodule
