...
module FAU ( 
  ...
  assign new_n60_ = ~x17 & (x25 | (~x18 & ~x19 & x21 & x24));
  assign new_n61_ = x20 & (x25 | (x21 & x22 & x24));
  assign z09 = new_n51_ & ~x07 & ~x15;
  assign z10 = ~x07 & ~x15 & ~x17 & ~new_n51_ & (x18 | x22);
  ...
  assign z15 = (~x07 & ~new_n71_ & ~x15) | new_n72_ | x07 | new_n73_ | x15;
  assign new_n71_ = ~new_n51_ & (new_n51_ | (x17 ? x18 : ~x22));
  ...
  assign new_n81_ = new_n82_ & ~x20 & ~x21 & x17 & x19;
