...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n53_, new_n58_, new_n59_, new_n60_, new_n61_,
    new_n62_, new_n63_, new_n69_, new_n71_, new_n73_, new_n74_, new_n76_,
    new_n77_, new_n78_, new_n80_, new_n82_, new_n83_;
  assign z00 = x08 & ~x16;
  assign z01 = z03 | new_n51_ | x07;
  assign z03 = ~x25 & (new_n50_ | ~x24 | (~x23 & x24 & (~x21 | ~x22)));
  assign new_n50_ = ~x20 & (x19 ? ~x23 : (x17 | x18));
  ...
  assign z15 = (new_n74_ & x17) | ~new_n73_ | (~new_n71_ & x22);
  assign new_n73_ = ~x07 & ~x15 & (~new_n51_ | x07 | x15);
  assign new_n74_ = x18 & ~x20 & ~x21 & ~x22 & (x23 | (x19 & ~x23));
  assign z16 = new_n78_ | ~new_n69_ | new_n76_ | (new_n51_ & new_n69_);
  assign new_n76_ = new_n77_ & x17 & x18 & x19;
  assign new_n77_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n78_ = x23 & (~x17 | ~x18 | x20 | x21 | x22);
  assign z17 = (x17 & new_n80_ & x18) | ~new_n73_ | (~new_n76_ & x24);
  assign new_n80_ = x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = new_n82_ | ~new_n69_ | new_n83_ | (new_n51_ & new_n69_);
