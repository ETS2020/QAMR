// Benchmark "FAU" written by ABC on Wed Jul 29 03:34:44 2020
...
module FAU ( 
  ...
  assign z09 = ~x00 & ~x21 & (new_n62_ | (new_n64_ & ~x19 & ~x20));
  assign new_n62_ = new_n63_ & ~x11 & x12 & ~x01 & x02;
  assign new_n63_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n64_ = x01 & x18;
  assign z10 = ~x00 & (new_n66_ | (new_n64_ & ~x19 & ~x20 & x22));
  assign new_n66_ = new_n67_ & x16 & x20 & ~x21 & ~x14 & x15;
  assign new_n67_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign z11 = ~x00 & (new_n69_ | new_n70_);
  assign new_n69_ = new_n67_ & ~x14 & x15 & ~x16 & x20 & ~x21;
