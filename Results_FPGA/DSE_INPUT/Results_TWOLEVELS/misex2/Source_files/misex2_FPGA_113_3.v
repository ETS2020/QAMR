...
module FAU ( 
  ...
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n62_ | (new_n50_ & x01));
  assign new_n62_ = new_n63_ & ~x14 & ~x15 & ~x16 & x20;
  assign new_n63_ = x02 & ~x11 & x12 & ~x13;
  assign z10 = ~x00 & (new_n65_ | (new_n67_ & ~x19 & x21 & x22));
  assign new_n65_ = new_n66_ & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n66_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n67_ = x01 & x18;
  assign z11 = ~x00 & ~x22 & (new_n69_ | (new_n67_ & ~x19 & x21));
  assign new_n69_ = new_n63_ & ~x14 & x15 & ~x16 & x20 & ~x21;
