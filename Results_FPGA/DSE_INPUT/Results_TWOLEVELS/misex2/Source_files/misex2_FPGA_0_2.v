...
module FAU ( 
  ...
  assign z09 = ~x00 & ~x22 & (new_n62_ | (new_n64_ & ~x19 & ~x20));
  assign new_n62_ = new_n63_ & ~x11 & x12 & ~x01 & x02;
  assign new_n63_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n64_ = x01 & x18;
  assign z10 = ~x00 & (new_n66_ | (new_n64_ & ~x19 & ~x20 & x21));
  assign new_n66_ = new_n67_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n67_ = ~x14 & x15 & x16 & x20 & ~x22;
  assign z11 = ~x22 & x20 & ~x16 & x15 & new_n69_ & ~x14;
  assign new_n69_ = ~x13 & x12 & z17 & ~x11;
