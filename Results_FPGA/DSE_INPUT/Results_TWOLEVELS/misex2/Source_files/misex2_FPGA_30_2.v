// Benchmark "FAU" written by ABC on Wed Jul 29 03:34:55 2020
...
module FAU ( 
  ...
  assign z10 = ~x00 & (new_n64_ | (new_n66_ & ~x19 & ~x20 & x22));
  assign new_n64_ = new_n65_ & x02 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n65_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n66_ = x01 & x18;
  assign z11 = ~x00 & ~x22 & (new_n68_ | (new_n66_ & ~x19 & ~x20));
  assign new_n68_ = new_n69_ & x02 & ~x11 & x12 & ~x13;
