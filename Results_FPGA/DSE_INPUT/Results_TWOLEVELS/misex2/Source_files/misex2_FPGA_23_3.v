// Benchmark "FAU" written by ABC on Wed Jul 29 03:34:52 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n50_, new_n51_, new_n53_, new_n57_, new_n59_, new_n62_,
    new_n63_, new_n64_, new_n66_, new_n68_, new_n69_, new_n71_, new_n72_;
  ...
  assign z09 = ~x00 & ~x21 & (new_n62_ | new_n64_);
  assign new_n62_ = new_n63_ & ~x14 & ~x15 & ~x16 & x20 & ~x22;
  ...
  assign z11 = ~x00 & (new_n68_ | (new_n63_ & new_n69_));
