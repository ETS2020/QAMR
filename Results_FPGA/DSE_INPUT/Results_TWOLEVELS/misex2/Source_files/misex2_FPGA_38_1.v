// Benchmark "FAU" written by ABC on Wed Jul 29 03:34:57 2020
...
module FAU ( 
  ...
  assign z03 = (new_n50_ & ~x00 & ~x01 & ~x02) | (new_n51_ & x00 & x02 & ~x09);
  ...
  assign new_n56_ = x02 & ~x09 & x10 & x11 & (x12 | (x01 & ~x12));
