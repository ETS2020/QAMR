// Benchmark "FAU" written by ABC on Wed Jul 29 03:35:19 2020
...
module FAU ( 
  ...
  assign z00 = ~x18 & ~x17 & x10 & new_n46_ & ~x09;
  assign new_n46_ = ~x02 & ~x00 & ~x01;
  assign z01 = ~x18 & ~x17 & x10 & new_n46_ & x09;
  assign z02 = ~x18 & ~x17 & ~x10 & new_n46_ & x09;
  assign z03 = (~x00 & ~x01 & ~x02 & ~x17 & x18) | (new_n50_ & x00 & x01 & x02);
  ...
  assign new_n69_ = x00 ? (~x01 | (x02 & x10)) : (x01 | (x02 ? ~x23 : ~x17));
  assign z13 = new_n46_ & x17;
  assign z14 = ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
