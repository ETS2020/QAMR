...
module FAU ( 
  ...
  assign z1 = x08 ? x00 : (x09 & ~x10 & (~x16 | (~x11 & x16)));
  ...
  assign new_n41_ = x11 ? (x12 & (~x12 | (x13 & (~x13 | (x14 & (~x14 | x15)))))) : ~x16;
  assign z7 = x08 ? x06 : (x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x17 | (x11 & x12 & x13 & x14 & x15)) & (~x14 | ~x15 | x17 | ~x11 | ~x12 | ~x13);
  assign z8 = x08 ? x07 : (new_n45_ & x09);
  assign new_n45_ = ~x10 & ((x18 & (~new_n46_ | ~x14 | ~x15 | ~x17)) | (new_n46_ & x17 & ~x18 & x14 & x15));
