...
module FAU ( 
  ...
  assign z6 = x08 ? x05 : (~x10 & (new_n43_ | (~new_n41_ & x16)));
  assign new_n41_ = ~new_n42_ & (~x12 | (x11 & x14 & x15));
  assign new_n42_ = x09 & (~x12 | ~x13);
  assign new_n43_ = new_n44_ & x14 & x15 & ~x16;
  assign new_n44_ = x11 & x12 & x13;
  assign z7 = x08 ? x06 : new_n46_;
  assign new_n46_ = ~x10 & ((new_n44_ & new_n48_) | (x17 & (new_n42_ | new_n47_)));
  assign new_n47_ = x12 & (~x15 | ~x16 | ~x11 | ~x14);
  assign new_n48_ = x14 & x15 & x16 & ~x17;
  assign z8 = x08 ? x07 : new_n50_;
  assign new_n50_ = ~x10 & ((new_n52_ & new_n53_) | (x18 & (new_n42_ | new_n51_)));
  assign new_n51_ = x12 & (~x11 | ~x14 | ~x15 | ~x16 | ~x17);
