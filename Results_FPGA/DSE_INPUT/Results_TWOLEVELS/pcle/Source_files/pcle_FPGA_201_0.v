// Benchmark "FAU" written by ABC on Wed Jul 29 03:53:16 2020
...
module FAU ( 
  ...
  assign new_n33_ = x09 & ~x10 & ~x11 & (x12 | x16);
  ...
  assign new_n42_ = (~x11 | (x12 & (~x15 | x16 | ~x13 | ~x14))) & (~x16 | (x14 & x15 & x11 & x13));
