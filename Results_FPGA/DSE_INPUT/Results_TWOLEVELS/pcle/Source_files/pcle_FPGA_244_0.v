...
module FAU ( 
  ...
  assign new_n33_ = x09 & ~x10 & ~x11 & (x14 | x17);
  assign z2 = x08 ? x01 : new_n35_;
  assign new_n35_ = x09 & ~x10 & (x11 ? (~x12 & (x14 | x17)) : x12);
  ...
  assign z7 = x08 ? x06 : (x09 & ~new_n45_ & ~x10);
  assign new_n45_ = (new_n46_ | ~x11) & (~x17 | (new_n47_ & x11 & x13));
  assign new_n46_ = x12 ? (~x13 | (x14 & (~x15 | ~x16 | x17))) : ~x17;
  assign new_n47_ = x15 & x16;
  assign z8 = x08 ? x07 : (x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (~x18 | (new_n51_ & new_n52_)) & (~new_n50_ | ~new_n47_ | ~x17 | x18);
