...
module FAU ( 
  ...
  assign z8 = (x07 & x08) | (x09 & ~new_n46_ & ~x10);
  assign new_n46_ = (~x18 | (~new_n49_ & ~new_n50_)) & (~new_n47_ | ~new_n48_ | ~x17 | x18);
  assign new_n47_ = x11 & x12 & x13 & x14;
  assign new_n48_ = x15 & x16;
  assign new_n49_ = ~x08 & (~x11 | ~x12 | ~x15);
  assign new_n50_ = x12 & (~x13 | ~x14 | ~x16 | ~x17);
endmodule
