// Benchmark "FAU" written by ABC on Wed Jul 29 03:52:41 2020
...
module FAU ( 
  ...
  assign z7 = (x06 & x08) | (x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x17 | (~new_n46_ & (new_n44_ | x08))) & (~new_n44_ | ~new_n45_ | ~x16 | x17);
  assign new_n44_ = x11 & x12 & x13;
  assign new_n45_ = x14 & x15;
  assign new_n46_ = x12 & (~x14 | ~x15 | ~x16);
  assign z8 = x08 ? x07 : (x09 & ~new_n48_ & ~x10);
  assign new_n48_ = (~x18 | (new_n44_ & new_n51_)) & (~new_n49_ | ~new_n50_ | ~x17 | x18);
