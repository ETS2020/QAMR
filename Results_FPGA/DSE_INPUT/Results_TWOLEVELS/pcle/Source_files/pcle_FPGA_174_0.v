...
module FAU ( 
  ...
  assign new_n33_ = x09 & ~x10 & ~x11 & (x15 | x18);
  ...
  assign new_n38_ = (~x14 | (x11 & ((x12 & x13) | (~x15 & ~x18)))) & (~x11 | ~x12 | ~x13 | x14);
  ...
  assign new_n47_ = ~x10 & ((x17 & (new_n48_ | ~x15)) | (~new_n49_ & x18));
  assign new_n48_ = x14 & x16 & ~x18 & x11 & x12 & x13;
  assign new_n49_ = (~x14 | (x12 & x13)) & x11 & x14 & x16 & x17;
endmodule
