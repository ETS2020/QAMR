...
module FAU ( 
  ...
  assign new_n33_ = x09 & ~x10 & ~x11 & (x12 | x18);
  ...
  assign new_n47_ = ~x10 & ((x11 & (new_n48_ | ~x12)) | (~new_n49_ & x18));
  assign new_n48_ = x16 & x17 & ~x18 & x13 & x14 & x15;
  assign new_n49_ = x11 & x13 & x14 & x15 & x16 & x17;
endmodule
