// Benchmark "FAU" written by ABC on Wed Jul 29 03:52:50 2020
...
module FAU ( 
  ...
  wire new_n31_, new_n35_, new_n37_, new_n39_, new_n41_, new_n43_, new_n44_,
    new_n46_, new_n47_;
  assign z0 = x18 & x16 & x15 & new_n31_ & x14;
  ...
  assign z7 = x08 ? x06 : new_n43_;
  assign new_n43_ = x09 & ~x10 & (x12 ? ~new_n44_ : x17);
  assign new_n44_ = x11 & (~x11 | (x13 & (~x13 | (x14 & (~x14 | (x15 & (~x15 | x16)))))));
  assign z8 = x08 ? x07 : (new_n46_ & x09);
  assign new_n46_ = ~x10 & ((x18 & (~new_n47_ | ~x14 | ~x15 | ~x16)) | (new_n47_ & x16 & ~x18 & x14 & x15));
