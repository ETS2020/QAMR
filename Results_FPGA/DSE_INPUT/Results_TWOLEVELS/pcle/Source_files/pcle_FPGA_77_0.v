...
module FAU ( 
  ...
  assign new_n33_ = x09 & ~x10 & ~x11 & (x15 | x17);
  assign z2 = x08 ? x01 : (x09 & ~x10 & (x11 ^ x12));
  assign z3 = x08 ? x02 : new_n36_;
  assign new_n36_ = x09 & ~x10 & ((x13 & (~x11 | ~x12)) | (x11 & x12 & ~x13));
  assign z4 = x08 ? x03 : (x09 & ~new_n38_ & ~x10);
  assign new_n38_ = (~x14 | (x11 & ((x12 & x13) | (~x15 & ~x17)))) & (~x11 | ~x12 | ~x13 | x14);
  assign z5 = x08 ? x04 : (new_n40_ & x09);
  assign new_n40_ = ~x10 & ((x15 & ((x14 & (~x12 | ~x13)) | ~x11 | ~x14)) | (x11 & x12 & x13 & x14 & ~x15));
  ...
  assign new_n44_ = ~x10 & ((~new_n45_ & x14) | (x17 & (~x11 | ~x14 | ~x16)));
  assign new_n45_ = (~x11 | ~x12 | ~x13 | (x15 & (~x16 | x17))) & (~x17 | (x12 & x13));
  assign z8 = x08 ? x07 : (new_n47_ & x09);
  assign new_n47_ = ~x10 & ((new_n50_ & new_n51_) | (x18 & (~new_n48_ | ~new_n49_)));
