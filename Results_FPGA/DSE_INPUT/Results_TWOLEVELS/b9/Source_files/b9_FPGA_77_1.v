...
module FAU ( 
  ...
  assign z00 = ~x16 | (~x15 & (new_n65_ | (~x04 & x10 & x40)));
  assign new_n65_ = x27 & (~new_n66_ | (~x04 & x40 & (x35 | x36)));
  assign new_n66_ = ~x37 & (~x28 | ~x35);
  assign z01 = ~x04 | (~x30 & ~x32 & (~x27 | (~new_n68_ & ~x36)));
  assign new_n68_ = ~x28 & x35;
  assign z02 = ~new_n70_ | (~x02 & (~x08 | ~x29));
  assign new_n70_ = x40 & (~x04 | (new_n68_ & (x08 | x27)));
  ...
  assign new_n79_ = (new_n68_ | x36) & (x40 ? x05 : x07);
  assign new_n80_ = x05 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n82_ & ~x30;
  assign new_n82_ = ((x29 & x40) | (new_n68_ & (~x04 | ~x27))) & (x08 | (new_n68_ & ~x04 & x27));
  assign z12 = (~x10 & (new_n84_ | ~x27)) | ((x04 | ~x40) & (new_n66_ | ~x27));
  assign new_n84_ = ~x35 & ~x36 & ~x37;
  assign z13 = new_n86_ | (~x04 & ~x13 & x40 & (x30 | x32));
  assign new_n86_ = x27 & (new_n87_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n87_ = ~x04 & ~x13 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n90_ | (~new_n89_ & (x04 | x13 | ~x40));
  ...
  assign z18 = ~new_n96_ | (x08 & ((x29 & x40) | (new_n68_ & ~x27)));
  assign new_n96_ = ~x09 & ~x30 & (~new_n68_ | x04 | ~x27);
  assign z20 = ~x09 & ~new_n98_ & ~x30;
  assign new_n98_ = (x08 | (x27 & x35)) & ((x29 & x40) | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
  assign z08 = x40;
