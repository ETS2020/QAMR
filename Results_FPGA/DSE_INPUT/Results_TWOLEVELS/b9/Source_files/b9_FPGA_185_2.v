// Benchmark "FAU" written by ABC on Wed Jul 29 04:53:46 2020
...
module FAU ( 
  ...
  assign z11 = ~x30 & (new_n86_ | (~new_n85_ & (~z08 | ~x29)));
  assign new_n85_ = x35 & (x09 | (~x28 & (~x04 | ~x27)));
  assign new_n86_ = ~x08 & (~x35 | (~x09 & (x04 | ~x27 | x28)));
  ...
  assign z18 = ~new_n103_ | (~new_n102_ & x08);
  assign new_n102_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign new_n103_ = ~x09 & ~x30 & (x04 | ~x27 | x28 | ~x35);
  assign z20 = ~x30 & (new_n105_ | (~new_n106_ & (~z08 | ~x29)));
  assign new_n105_ = ~x08 & (~x35 | (~x09 & ~x27));
  assign new_n106_ = x35 & (x09 | x27 | ~x28);
  assign z05 = ~z06;
  assign z19 = ~x30 & (new_n86_ | (~new_n85_ & (~z08 | ~x29)));
endmodule
