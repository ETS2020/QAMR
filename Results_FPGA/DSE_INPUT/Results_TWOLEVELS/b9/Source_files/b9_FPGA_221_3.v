...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n70_, new_n72_, new_n73_, new_n78_,
    new_n79_, new_n82_, new_n83_, new_n86_, new_n87_, new_n89_, new_n90_,
    new_n92_, new_n93_, new_n94_, new_n95_, new_n100_;
  ...
  assign z02 = new_n72_ | ~z08 | ~x02;
  assign new_n72_ = x04 & ((~new_n73_ & x40) | (~x08 & ~x27));
  ...
  assign z11 = ~x09 & ~x30 & (~new_n73_ | (~x08 & ~x27) | (x04 & x27));
