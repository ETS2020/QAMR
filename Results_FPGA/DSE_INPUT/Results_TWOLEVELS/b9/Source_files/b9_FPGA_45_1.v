...
module FAU ( 
  ...
  assign z02 = ~x39 | ~x40 | (x04 & ((~new_n71_ & x40) | (~x08 & ~x27)));
  ...
  assign new_n83_ = ((z08 & x29) | (new_n71_ & (~x04 | ~x27))) & (x08 | (new_n71_ & ~x04 & x27));
  ...
  assign z18 = ~new_n100_ | (x08 & ((z08 & x29) | (new_n71_ & ~x27)));
  assign new_n100_ = ~x09 & ~x30 & (~new_n71_ | x04 | ~x27);
