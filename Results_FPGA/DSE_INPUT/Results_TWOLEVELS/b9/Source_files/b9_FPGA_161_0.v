...
module FAU ( 
  ...
  assign new_n91_ = ~x04 & ~x13 & x35 & x36 & x39 & x40;
  assign new_n92_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (~new_n94_ & (new_n95_ | ~new_n96_)) | new_n99_ | (~new_n97_ & ~new_n98_);
  assign new_n94_ = ~x18 & ~x19 & x20;
  assign new_n95_ = ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n96_ = x39 & x40 & ~x04 & ~x13;
  assign new_n97_ = x27 & (x35 | x37);
  assign new_n98_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign new_n99_ = ~x28 & ~x37 & (x04 | x13 | ~x39 | ~x40);
