...
module FAU ( 
  ...
  assign new_n80_ = x07 & (~x39 | ~x40) & (x36 | (~x28 & x35));
  assign new_n81_ = x05 & x36 & x39 & x40;
  ...
  assign z13 = new_n90_ | (x27 & (new_n88_ | new_n89_));
  assign new_n88_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n89_ = ~x04 & ~x13 & ~x28 & x39 & x40;
  assign new_n90_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (~x30 & ~new_n92_ & ~x32) | (~new_n93_ & (new_n66_ | ~new_n94_));
  assign new_n92_ = x27 & (~x28 | (~x18 & ~x19 & x20 & x37));
  ...
  assign z20 = ~x09 & ~x30 & (~z08 | ~x08 | ~x29);
endmodule
