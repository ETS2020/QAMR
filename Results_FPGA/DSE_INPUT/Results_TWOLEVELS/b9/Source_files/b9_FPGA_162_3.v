...
module FAU ( 
  ...
  assign new_n71_ = x39 & x40 & (~x04 | (x27 & ~x28 & x35));
  ...
  assign z11 = ~x09 & ~x30 & (x35 ? ~new_n85_ : ~new_n86_);
  assign new_n85_ = ~x04 & x27 & ~x28;
  assign new_n86_ = x08 & x29 & x39 & x40;
  ...
  assign z18 = x09 | x30 | new_n86_ | (new_n102_ & ~x04 & x27);
  assign new_n102_ = ~x28 & x35;
  assign z20 = ~x09 & ~x30 & (x35 ? ~x27 : ~new_n86_);
  assign z05 = ~z06;
  assign z19 = ~x09 & ~x30 & (x35 ? ~new_n85_ : ~new_n86_);
endmodule
