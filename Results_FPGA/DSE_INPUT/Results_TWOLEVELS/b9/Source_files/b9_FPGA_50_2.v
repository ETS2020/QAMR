...
module FAU ( 
  ...
  assign z14 = (~new_n94_ & (new_n95_ | ~new_n96_)) | new_n98_ | new_n99_ | (~new_n96_ & ~new_n97_);
  ...
  assign new_n99_ = ~x35 & ~x37 & (x04 | ~x39 | ~x40);
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n105_ | (x08 & ((new_n104_ & ~x27) | (z08 & x29)));
