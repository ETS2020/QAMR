...
module FAU ( 
  ...
  assign z14 = ~new_n91_ | (~new_n94_ & (x04 | x13 | ~x40));
  assign new_n91_ = new_n93_ & (x30 | x32 | (x27 & (new_n92_ | ~x28)));
  assign new_n92_ = ((x35 & x36) | (~x18 & ~x19 & x20)) & (x35 | x37);
  assign new_n93_ = x39 & (x27 | (~x04 & x40 & (~x13 | ~x39)));
