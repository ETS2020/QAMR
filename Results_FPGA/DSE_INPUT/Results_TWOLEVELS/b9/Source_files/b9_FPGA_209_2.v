...
module FAU ( 
  ...
  assign new_n83_ = x39 & (x30 | (x32 & x40));
  assign z11 = ~new_n85_ & ~x09;
  assign new_n85_ = (new_n86_ | (new_n73_ & (~x04 | ~x27))) & (x08 | x30 | (new_n73_ & ~x04 & x27));
  assign new_n86_ = x40 & (x30 | (x29 & x39));
  ...
  assign new_n94_ = ~new_n95_ & (~x40 | (~x04 & ~x13)) & x39 & x40;
  ...
  assign z20 = ~new_n104_ & ~x09;
  assign new_n104_ = (new_n105_ | x30) & (x40 | (x35 & (x27 | ~x28)));
  assign new_n105_ = (x08 | (x27 & x35)) & ((x35 & (x27 | ~x28)) | (x29 & x39));
  assign z05 = ~z06;
