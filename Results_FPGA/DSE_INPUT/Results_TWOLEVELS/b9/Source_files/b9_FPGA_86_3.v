...
module FAU ( 
  ...
  assign z13 = new_n89_ | (new_n82_ & ~x04);
  assign new_n89_ = x27 & (new_n90_ | (~x18 & ~x19 & ~new_n67_ & x20));
  assign new_n90_ = ~x04 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n92_ | ((new_n67_ | ~new_n94_) & (~z08 | x04));
  assign new_n92_ = ~x30 & ~x32 & (~x27 | (~new_n93_ & x28));
