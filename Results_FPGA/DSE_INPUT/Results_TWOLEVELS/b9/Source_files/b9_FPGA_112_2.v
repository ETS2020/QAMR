...
module FAU ( 
  ...
  assign new_n81_ = x39 & (x36 | (~x28 & x35 & x40));
  assign new_n82_ = x07 & ((~x28 & x35 & (~x39 | ~x40)) | (x36 & ~x39));
  assign new_n83_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n85_ & ~x30;
  assign new_n85_ = (new_n86_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (~x28 & x35 & ~x04 & x27));
  ...
  assign new_n91_ = x39 & ((x35 & x36) | (~x28 & x40));
