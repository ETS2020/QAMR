...
module FAU ( 
  ...
  assign z06 = ~x37 & (~x27 | x40 | (~x28 & ~x40));
  ...
  assign new_n82_ = x05 & x39 & x40 & (x35 | x36);
  assign new_n83_ = x07 & (~x39 | ~x40) & (x36 | (~x28 & x35));
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign new_n85_ = x06 & x27 & x37;
  assign z11 = ~x09 & ~x30 & (new_n87_ | ~new_n88_);
  assign new_n87_ = (~x35 | (x04 & x27)) & (~x29 | ~x39 | ~x40);
  assign new_n88_ = ~x28 & (x08 | (~x04 & x27 & x35));
  assign z12 = new_n90_ | new_n91_ | ~new_n92_;
  assign new_n90_ = x04 & ((~x27 & x40) | (~x28 & ~x37));
  assign new_n91_ = ~x10 & ((~x27 & x40) | (~x35 & ~x36 & ~x37));
  assign new_n92_ = (~x28 | x35 | x37) & ((x39 & x40) | (x27 & (x28 | x37)));
  assign z13 = (x27 & (new_n95_ | (z08 & ~x04 & ~x13))) | (~x04 & new_n94_ & ~x13);
  assign new_n94_ = x39 & x40 & (x30 | x32);
  assign new_n95_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = (~new_n97_ & ~new_n98_) | new_n99_ | new_n101_ | (~new_n100_ & x40);
  assign new_n97_ = ~x04 & x39 & x40;
  assign new_n98_ = ~x18 & ~x19 & x20 & (x28 | x37);
  assign new_n99_ = ~x37 & ((x28 & ~x35) | (x13 & x40));
  assign new_n100_ = (x27 | (~x04 & ~x13)) & (~x13 | (~x18 & ~x19 & x20));
  assign new_n101_ = ~x27 & ((~x30 & ~x32) | ~x39 | ~x40);
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n107_ | (~new_n106_ & x08);
  assign new_n106_ = (~x29 | ~x39 | ~x40) & (x27 | x28 | ~x35);
  assign new_n107_ = ~x09 & ~x30 & (x28 | ~x35 | x04 | ~x27);
  assign z20 = ~x09 & ~x30 & (~new_n109_ | (~x08 & (~x27 | ~x35)));
