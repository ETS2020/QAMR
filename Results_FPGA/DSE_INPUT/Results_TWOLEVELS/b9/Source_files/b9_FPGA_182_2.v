...
module FAU ( 
  ...
  assign new_n86_ = x39 & (x08 | (new_n69_ & ~x04 & x27));
  assign z12 = (~x10 & (new_n88_ | (~x27 & x39))) | new_n89_ | (~x39 & (~x27 | ~x37));
  ...
  assign new_n91_ = x40 & ((x35 & x36) | (~x28 & x39));
  assign new_n92_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = ~new_n94_ | (~new_n99_ & (x04 | x13 | ~x40));
  assign new_n94_ = (new_n95_ | new_n96_) & ~new_n98_ & (x30 | new_n97_ | x32);
  assign new_n95_ = x39 & (~x28 | x30 | x32 | x35);
  assign new_n96_ = x20 & x37 & ~x18 & ~x19;
  assign new_n97_ = x27 & (~x28 | x36 | (~x18 & ~x19 & x20));
  assign new_n98_ = ~x27 & (~x39 | ~x40 | x04 | (x13 & x39));
  assign new_n99_ = (x37 | (x28 & x35)) & ~x18 & ~x19 & x20;
  ...
  assign new_n106_ = x39 & ((x29 & x40) | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
