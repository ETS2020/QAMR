...
module FAU ( 
  ...
  assign z10 = x27 & ((x06 & x37) | (new_n80_ & ~x04));
  assign new_n80_ = x07 & ~z08 & (x36 | (~x28 & x35));
  assign z11 = ~x09 & ~new_n82_ & ~x30;
  assign new_n82_ = (new_n83_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (~x28 & x35 & ~x04 & x27));
  assign new_n83_ = x29 & x39 & x40;
  assign z12 = new_n85_ | (~new_n86_ & (~z08 | x04));
  assign new_n85_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n86_ = x27 & (x37 | (x28 & x35));
  assign z13 = (x27 & (new_n89_ | (~x04 & new_n88_ & ~x13))) | (~x04 & new_n90_ & ~x13);
  ...
  assign new_n103_ = ~new_n83_ & (~x35 | (~x27 & x28));
  assign z05 = ~z06;
