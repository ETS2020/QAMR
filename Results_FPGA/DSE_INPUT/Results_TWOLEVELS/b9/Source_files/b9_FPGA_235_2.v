...
module FAU ( 
  ...
  assign new_n85_ = (~x29 | ~x39) & (~new_n69_ | (x04 & x27));
  assign new_n86_ = x40 & (x08 | (x27 & ~x28 & x35 & (~x04 | ~x40)));
  assign z12 = (~x10 & (new_n88_ | (~x27 & x40))) | new_n89_ | (~x40 & (~x27 | ~x37));
  ...
  assign z14 = ~new_n94_ | (~new_n99_ & (x04 | x13 | ~x39));
  assign new_n94_ = (new_n95_ | new_n96_) & ~new_n98_ & (x30 | new_n97_ | x32);
  assign new_n95_ = x40 & (~x28 | x30 | x32 | x35);
  ...
  assign new_n106_ = x40 & ((x29 & x39) | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
