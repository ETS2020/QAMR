// Benchmark "FAU" written by ABC on Wed Jul 29 04:53:29 2020
...
module FAU ( 
  ...
  assign new_n81_ = x05 & x39 & x40 & (x36 | (~x28 & x35));
  assign new_n82_ = x07 & (~x39 | ~x40) & (~x28 | x36);
  ...
  assign z12 = new_n90_ | ((new_n66_ | ~x27) & (~z08 | x04));
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n94_ | (~x04 & new_n93_ & ~x13))) | (~x04 & new_n92_ & ~x13);
  assign new_n92_ = x39 & x40 & (x30 | x32);
  assign new_n93_ = x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = (~new_n96_ & (new_n97_ | ~new_n98_)) | new_n99_ | (~new_n98_ & (new_n66_ | ~x27));
