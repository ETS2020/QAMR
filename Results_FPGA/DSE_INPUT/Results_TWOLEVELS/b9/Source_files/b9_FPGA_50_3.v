...
module FAU ( 
  ...
  assign z13 = (x27 & (new_n89_ | (new_n90_ & ~x04))) | (~x04 & new_n82_ & ~x13);
  assign new_n89_ = ~x18 & ~x19 & ~new_n67_ & x20;
  assign new_n90_ = x39 & x40 & ((x35 & x36) | (~x13 & ~x28));
  assign z14 = new_n92_ | ~new_n94_ | (~x27 & (x13 | (~x30 & ~x32)));
  assign new_n92_ = (new_n67_ | ~new_n93_) & (~z08 | x04);
  assign new_n93_ = x20 & x27 & ~x18 & ~x19;
  assign new_n94_ = (~new_n97_ | ~x28) & (new_n95_ | new_n96_);
  assign new_n95_ = ~x13 & (~x28 | x30 | x32 | x35);
  assign new_n96_ = x20 & x37 & ~x18 & ~x19;
  assign new_n97_ = ~x30 & ~x32 & ~x36 & (x18 | x19 | ~x20);
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n102_ | (x08 & (new_n85_ | (~x27 & ~x28 & x35)));
