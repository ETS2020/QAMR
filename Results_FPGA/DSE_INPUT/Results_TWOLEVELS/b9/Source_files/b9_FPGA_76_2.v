...
module FAU ( 
  ...
  assign new_n71_ = (x02 | (x08 & x29)) & (new_n69_ | ~x04);
  ...
  assign new_n80_ = (new_n69_ | x36) & ((x07 & ~x39) | (x05 & x39 & x40));
  assign new_n81_ = new_n82_ & x05;
  assign new_n82_ = x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n84_ & ~x30;
  assign new_n84_ = (new_n85_ | (new_n69_ & (~x04 | ~x27))) & (x08 | (new_n69_ & ~x04 & x27));
  ...
  assign z18 = ~new_n102_ | (x08 & (new_n85_ | (new_n69_ & ~x27)));
  assign new_n102_ = ~x09 & ~x30 & (~new_n69_ | x04 | ~x27);
  assign z20 = ~x09 & ~x30 & (new_n104_ | (~x08 & (~x27 | ~x35)));
  assign new_n104_ = ~new_n85_ & (~x35 | (~x27 & x28));
  assign z05 = ~z06;
