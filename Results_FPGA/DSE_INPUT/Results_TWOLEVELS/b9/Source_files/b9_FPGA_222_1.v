...
module FAU ( 
  ...
  assign new_n81_ = (~x05 | (~new_n82_ & (~x07 | new_n70_ | ~x27))) & (~x27 | new_n70_ | new_n83_);
  assign new_n82_ = x39 & x40 & (x30 | x32);
  assign new_n83_ = x40 ? x39 : ~x07;
  assign z11 = ~x09 & ~x30 & (new_n85_ | new_n86_);
  assign new_n85_ = (~z08 | ~x29) & (x28 | ~x35 | (x04 & x27));
  ...
  assign z13 = (x27 & (new_n91_ | (~x04 & new_n92_ & ~x13))) | (~x04 & new_n82_ & ~x13);
  ...
  assign new_n96_ = ((~x04 & ~x13) | (~new_n67_ & (x27 | ~x40))) & ((~new_n67_ & x27) | (x39 & x40));
