...
module FAU ( 
  ...
  assign z12 = new_n86_ | (new_n87_ & ~x37) | (~new_n88_ & ~x27);
  assign new_n86_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x40));
  assign new_n87_ = (~x28 | ~x35) & (x04 | ~x39 | ~x40);
  assign new_n88_ = x39 & x40 & (~x04 | ~x40);
  assign z13 = (new_n81_ & ~x04) | (x27 & (new_n91_ | (new_n90_ & ~x04)));
  assign new_n90_ = x39 & x40 & (~x28 | (x35 & x36));
  assign new_n91_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n93_ | new_n95_ | (~new_n94_ & (x18 | x19 | ~x20));
  assign new_n93_ = ~x37 & (new_n87_ | (~x32 & ~x35 & x28 & ~x30));
  assign new_n94_ = new_n88_ & (~x28 | x30 | x32 | (x35 & x36));
  assign new_n95_ = ~x27 & (~x40 | (x04 & x40) | ~x39 | (~x30 & ~x32));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n101_ | (~new_n100_ & x08);
  assign new_n100_ = (~z08 | ~x29) & (x27 | x28 | ~x35);
