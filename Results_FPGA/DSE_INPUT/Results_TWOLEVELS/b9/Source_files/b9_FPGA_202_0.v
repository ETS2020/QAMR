...
module FAU ( 
  ...
  wire new_n65_, new_n67_, new_n69_, new_n75_, new_n76_, new_n79_, new_n80_,
    ...
    new_n104_;
  assign z00 = ~x16 | (~x15 & (new_n65_ | (x27 & (x28 | x37))));
  ...
  assign z10 = new_n81_ | (~x04 & (new_n80_ | (x27 & ~new_n67_ & ~new_n79_)));
  ...
  assign z14 = (~new_n94_ & (new_n95_ | ~new_n96_)) | new_n97_ | (~new_n88_ & ~new_n96_);
  ...
  assign z18 = ~new_n102_ | (x08 & (new_n83_ | (~x27 & ~x28 & x35)));
