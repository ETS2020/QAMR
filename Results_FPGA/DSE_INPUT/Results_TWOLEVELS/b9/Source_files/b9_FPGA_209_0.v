...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n70_, new_n72_, new_n73_, new_n78_,
    new_n79_, new_n82_, new_n83_, new_n85_, new_n87_, new_n88_, new_n90_,
  ...
  assign new_n85_ = ((x29 & x39) | (new_n73_ & (~x04 | ~x27))) & (x08 | (new_n73_ & ~x04 & x27));
  ...
  assign new_n91_ = x39 & ((~x28 & x40) | (~x30 & x35 & x36));
