...
module FAU ( 
  ...
  assign z11 = ~x09 & (new_n85_ | (~new_n83_ & ~new_n84_)) & ~x30;
  ...
  assign z14 = (~new_n91_ & (new_n92_ | ~new_n93_)) | new_n94_ | (~new_n66_ & ~new_n93_);
  ...
  assign z05 = ~z06;
  assign z19 = ~x09 & (new_n85_ | (~new_n83_ & ~new_n84_)) & ~x30;
endmodule
