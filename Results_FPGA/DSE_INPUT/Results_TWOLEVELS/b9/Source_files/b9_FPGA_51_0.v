...
module FAU ( 
  ...
  assign new_n70_ = z08 & (~x04 | (new_n68_ & (x08 | x27)));
  assign z08 = x39 & x40;
  ...
  assign new_n80_ = (new_n68_ | x36) & (x39 ? x05 : x07);
  assign new_n81_ = x05 & x39 & (x30 | x32);
  assign z11 = ~x09 & ~new_n83_ & ~x30;
  assign new_n83_ = (new_n84_ | x27) & ~new_n85_ & ~new_n86_ & (x40 | (~x27 & x35));
  assign new_n84_ = x08 & (~x28 | x40);
  assign new_n85_ = (~x29 | ~x39) & ((x04 & x27) | x28 | ~x35);
  assign new_n86_ = ~x08 & (x04 | x28 | ~x35);
  assign z12 = (~x10 & (new_n88_ | ~x27)) | ((x04 | ~x39) & (new_n66_ | ~x27));
  assign new_n88_ = ~x35 & ~x36 & ~x37;
  assign z13 = new_n90_ | (~x04 & ~x13 & x39 & (x30 | x32));
  assign new_n90_ = x27 & (new_n91_ | (~x18 & ~x19 & ~new_n66_ & x20));
  assign new_n91_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign z14 = new_n94_ | (~new_n93_ & (x04 | x13 | ~x39));
  assign new_n93_ = ~new_n66_ & ~x18 & ~x19 & x20 & x27;
  assign new_n94_ = ~x30 & ~x32 & (~x27 | (~new_n95_ & x28));
  assign new_n95_ = ((x35 & x36) | (~x18 & ~x19 & x20)) & (x35 | x37);
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = new_n100_ | x09 | x30 | (new_n68_ & ~x04 & x27);
  assign new_n100_ = x08 & ((new_n68_ & ~x27) | (z08 & x29));
