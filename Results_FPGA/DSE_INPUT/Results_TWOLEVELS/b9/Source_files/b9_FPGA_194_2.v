...
module FAU ( 
  ...
  assign new_n85_ = (new_n69_ | (x08 & x40)) & (x08 | (~x04 & x27));
  assign z12 = new_n87_ | ~x40 | ((x04 | ~x39) & (new_n66_ | ~x27));
  ...
  assign z14 = ~new_n93_ | (~new_n92_ & (x04 | x13 | ~x39));
  assign new_n92_ = ~new_n66_ & ~x18 & ~x19 & x20;
  assign new_n93_ = new_n95_ & (x30 | x32 | (x27 & (new_n94_ | ~x28)));
  assign new_n94_ = ((x35 & x36) | (~x18 & ~x19 & x20)) & (x35 | x37);
  assign new_n95_ = x40 & (x27 | (~x04 & x39 & (~x13 | ~x40)));
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = new_n100_ | x09 | x30 | (new_n69_ & ~x04 & x27);
  assign new_n100_ = x08 & ((z08 & x29) | (new_n69_ & ~x27));
  assign z20 = ~x09 & ~x30 & (~new_n102_ | (~x08 & (~x27 | ~x35)));
  assign new_n102_ = ((x29 & x39) | (x35 & (x27 | ~x28))) & (x40 | (~x28 & x35));
  assign z05 = ~z06;
