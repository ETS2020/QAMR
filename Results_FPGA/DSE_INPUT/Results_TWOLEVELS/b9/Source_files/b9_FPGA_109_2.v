...
module FAU ( 
  ...
  assign new_n71_ = x39 & ((~x02 & (~x08 | ~x29)) | (x04 & ~x35));
  ...
  assign new_n80_ = (new_n81_ | (~x36 & (x28 | ~x35))) & (~x07 | x39 | (~x35 & ~x36));
  ...
  assign new_n87_ = x28 & (~x08 | ~x29 | ~x40);
  assign z12 = new_n89_ | new_n90_ | (~x27 & (~x39 | ~x40 | (x04 & x39)));
  assign new_n89_ = ~x10 & ((~x35 & ~x36 & ~x37) | (~x27 & x39));
  assign new_n90_ = ~x37 & (~x39 | ((~x28 | ~x35) & (x04 | ~x40)));
  assign z13 = (x27 & (new_n93_ | (~x04 & new_n92_ & ~x13))) | (~x04 & new_n83_ & ~x13);
  assign new_n92_ = x40 & (x28 ? (x35 & x36) : x39);
  assign new_n93_ = ~x18 & ~x19 & x20 & (x37 | (x28 & x35));
  assign z14 = new_n95_ | (~new_n98_ & ~new_n100_) | (~new_n101_ & ~x27);
  assign new_n95_ = ~x37 & (new_n96_ | ~new_n97_);
  assign new_n96_ = (~x28 | ~x35) & (x04 | x13 | ~x40);
  assign new_n97_ = x39 & (~x28 | x30 | x32 | x35);
  assign new_n98_ = ~new_n99_ & x39 & x40 & (~x39 | (~x04 & ~x13));
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x18 & ~x19 & x20;
  assign new_n101_ = (~x39 | (~x04 & ~x13)) & x39 & x40 & (x30 | x32);
  assign z15 = x34 & x27 & x12 & x26;
  assign z16 = ~x23 & x01 & x22;
  assign z17 = ~x24 & x23 & x01 & x22;
  assign z18 = ~new_n106_ | (x08 & (new_n86_ | (new_n69_ & ~x27)));
  assign new_n106_ = ~x09 & ~x30 & (~new_n69_ | x04 | ~x27);
  assign z20 = ~x09 & ~x30 & (~new_n108_ | (~x08 & (~x27 | ~x35)));
  assign new_n108_ = (x35 | x39) & ((x29 & x40) | (x35 & (x27 | ~x28)));
  assign z05 = ~z06;
