// Benchmark "FAU" written by ABC on Wed Jul 29 03:28:08 2020
...
module FAU ( 
  ...
  assign z3 = (x13 & (new_n29_ | new_n30_)) | ~x05 | new_n31_ | new_n32_;
  assign new_n29_ = ~x07 & (~x02 | x09);
  assign new_n30_ = x04 & (~x03 | x11 | x12);
