...
module FAU ( 
  ...
  assign new_n138_ = ~x40 & ((x37 & x39) | (x27 & ~x37 & ~x39));
  ...
  assign new_n187_ = x35 ? (x38 | (~x25 & (x25 | ~x26))) : (~x38 | (~x40 & (x27 | x40)));
  ...
  assign new_n256_ = (~x39 | ((~x37 | (~x38 ^ x40)) & (~new_n162_ | x37 | x38 | ~x40))) & (x37 | ~x38 | x39 | (~x40 & (x27 | x40)));
  ...
  assign new_n292_ = x40 ? (x37 ? (x38 ^ x39) : (x38 ? x39 : (new_n293_ | ~x39))) : ((~x37 | x38 | ~x39) & (~x27 | x37 | ~x38 | x39));
  ...
  assign new_n313_ = (~x39 | x40 | ~x37 | x38) & (x37 | ((~x39 | ~x40 | ~x11 | x38) & (x39 | x40 | x27 | ~x38)));
  ...
  assign new_n363_ = x35 & ~x37 & ((~x39 & ~x40 & ~x36 & x38) | (~x38 & (x36 ? ~x39 : (x39 & x40))));
  ...
  assign new_n400_ = ~x40 & ((x35 & x37 & ~x38 & x39) | (x27 & ~x35 & ~x37 & x38 & ~x39));
  ...
  assign new_n421_ = (new_n422_ | (~x37 ^ x39)) & (~x37 | ~x39) & (x37 | x39 | (~x40 & (x27 | x40)));
  ...
  assign new_n559_ = new_n170_ & x38 & x27 & ~x35 & ~x37;
  ...
  assign new_n580_ = new_n581_ & x27 & ~x34 & ~x35 & x36;
  ...
  assign new_n595_ = ~x34 & ((~new_n596_ & x35) | (new_n581_ & x27 & ~x35 & x36));
  ...
  assign new_n624_ = (~x37 | x38 | x39 | x40) & (x37 | ((~x38 | x39 | (~x40 & (x27 | x40))) & (~x39 | (x38 ? x40 : (new_n293_ | ~x40)))));
