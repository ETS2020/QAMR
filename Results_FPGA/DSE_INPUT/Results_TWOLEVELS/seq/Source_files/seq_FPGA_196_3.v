...
module FAU ( 
  ...
  assign z10 = ~x07 & ~x32 & x33 & (new_n341_ | (new_n345_ & x34));
  assign new_n341_ = ~x05 & x15 & x21 & new_n342_ & x22;
  assign new_n342_ = ~new_n343_ & ~new_n92_ & (x20 | (x25 & ~x36));
  assign new_n343_ = (~x24 | x34 | new_n344_ | ~x35) & (~x34 | x35 | ~new_n87_ | x38);
  assign new_n344_ = (~x37 | x38 | x39 | ~x40) & (x37 | (x38 ? (~x39 | (~x23 & ~x40)) : (x39 | x40)));
  assign new_n345_ = ~x35 & ~x36 & ~x37 & (x38 ? ~x39 : (x39 & x40));
