...
module FAU ( 
  ...
  assign z02 = ~x17 & ((new_n78_ & x08) | (~new_n69_ & ~x09));
  assign new_n69_ = (new_n70_ | ~x18) & (x05 | (x15 ? (new_n76_ | ~x18) : new_n74_));
  assign new_n70_ = (new_n71_ | x07) & (~x05 | ~x07 | ~x08 | x15 | ~x19);
  assign new_n71_ = (new_n73_ | ~x08) & (~x05 | x08 | new_n72_ | x15);
  assign new_n72_ = ~x06 & x19 & (x06 | ~x19);
  assign new_n73_ = (~x15 | ~x21) & (~x05 | (~x21 & (x04 | x11 | ~x15 | x21)));
  assign new_n74_ = (~x01 | ~x07 | x18 | (~x08 & ~x16)) & (x07 | new_n75_ | ~x18);
  assign new_n75_ = x06 ? (x02 & x11) : (x04 & x12);
  assign new_n76_ = (~x08 | ((~x07 | ~x19) & (~new_n77_ | x02 | x07))) & (x07 | x08 | (~x06 & x19 & (x06 | ~x19)));
  assign new_n77_ = x11 & ~x21;
  ...
  assign z03 = x05 ? (~new_n82_ & ~x09) : ~new_n83_;
  assign new_n82_ = (x07 | ((~x17 | x18) & (x08 | x15 | x17 | new_n72_ | ~x18))) & (~x07 | ~x08 | x15 | x17 | ~x18);
  assign new_n83_ = (~x08 | x17 | ~x18 | (x07 ? (x09 | ~x15) : (~x09 | x15))) & (x09 | ~x17 | x18);
  assign z04 = ~x14 & ~x20;
  ...
  assign z06 = ~x09 & (new_n101_ | (~x05 & (new_n103_ | (~new_n94_ & ~x07))));
  assign new_n94_ = (x17 | ~x18 | (~new_n62_ & (new_n95_ | x15))) & (~x00 | ~x15 | ~x17 | x18);
  ...
  assign new_n101_ = new_n66_ & x04 & x05 & new_n102_ & ~x12 & ~x15;
  assign new_n102_ = ~x17 & x18 & ~x21;
  assign new_n103_ = x07 & ~x15 & x17 & ~x18;
  assign z07 = ~x17 & x18 & (new_n106_ | (new_n105_ & ~x09));
  assign new_n105_ = (x05 ^ x15) & (x07 ? x08 : (~new_n72_ & ~x08));
  ...
  assign z10 = (~new_n126_ & ~x09) | (x08 & new_n129_ & ~x15);
  assign new_n126_ = x07 ? new_n128_ : ((~x17 | x18) & (x08 | x17 | ~new_n127_ | ~x18));
  assign new_n127_ = (~x19 | (~x06 & x19)) & (x05 ^ x15);
  ...
  assign new_n153_ = (~x06 | (~new_n154_ & (~x12 | new_n155_ | x16))) & ~new_n97_ & (x06 | ~x12 | new_n155_ | ~x16);
  ...
  assign new_n159_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n160_ = new_n65_ & new_n102_ & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n162_ & x18;
  assign new_n162_ = (x14 | new_n163_ | x15) & (x08 | ~x15 | (~x06 & (x06 | ~x19)));
  assign new_n163_ = ~new_n87_ & (~x12 | (~new_n165_ & (new_n164_ | x06)));
  ...
  assign new_n169_ = ~x21 & (x04 ? (new_n170_ & ~x12) : ~new_n138_);
  ...
  assign new_n178_ = (new_n179_ | x07) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign new_n179_ = (~x06 | x15 | (x05 ? (x08 | x09) : (~x08 | ~x09))) & (x05 | x08 | x09 | ~x15 | (x19 & (x06 | ~x19)));
  assign z22 = ~x17 & x18 & ((~new_n181_ & ~x07) | (~x05 & new_n182_ & x07));
  assign new_n181_ = (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15);
  ...
  assign new_n188_ = (x12 | ~x18 | ~x05 | ~x08) & (x14 | x18 | x05 | ~x12);
  assign new_n189_ = x18 & ((~x02 & ~x05 & x11) | (~x04 & x05 & ~x11));
  assign new_n190_ = x01 & ~x05 & x07 & x08 & ~x15 & ~x18;
  assign z25 = ~x05 & ~x07 & new_n192_ & ~x17;
  assign new_n192_ = x18 & (x08 ? (x09 & ~x15) : (~x09 & ~new_n72_ & x15));
  assign z26 = ~x20 & (x14 | x21);
  assign z27 = new_n195_ | (new_n201_ & new_n66_ & x03 & ~x05);
  assign new_n195_ = ~x09 & ((~x17 & ~new_n196_ & x18) | (~x05 & x17 & ~new_n200_ & ~x18));
  assign new_n196_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : new_n197_;
  assign new_n197_ = ~new_n199_ & (x21 | (~new_n198_ & (new_n138_ | x04)));
  assign new_n198_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n199_ = x05 & ~x08 & ~x15 & (x06 | (~x06 & x19));
  assign new_n200_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n201_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n203_ | (new_n210_ & ~x05))) | (~x09 & new_n211_ & x17);
  assign new_n203_ = x18 & ((~new_n204_ & x08) | (~x05 & ~x07 & new_n209_ & ~x08));
  ...
  assign new_n207_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n208_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n209_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n100_ & x21));
