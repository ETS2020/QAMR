...
module FAU ( 
  ...
  assign new_n81_ = x07 ? ((~x08 | x17 | ~x18 | (x05 ^ ~x15)) & (x05 | ~x17 | x18)) : ((~x17 | x18) & (~x05 | x08 | x15 | x17 | ~x18));
  assign z04 = ~x14 & ~x20;
  ...
  assign new_n92_ = (x07 | ((x17 | ~x18 | (~new_n63_ & (new_n93_ | x15))) & (~x15 | ~x17 | x18))) & (~x17 | x18 | ~x07 | x15);
  ...
  assign new_n127_ = (x07 | ((x17 | ~new_n128_ | ~x18) & (~x17 | x18 | x05 | ~x15))) & (x15 | ~x17 | x18 | x05 | ~x07);
  ...
  assign z17 = ~x09 & ((~new_n152_ & ~x05) | (new_n154_ & new_n66_ & ~x04 & x05));
  assign new_n152_ = (~x17 | x18 | ~x07 | x15) & (x07 | ((~x15 | ~x17 | x18) & (x08 | x15 | x17 | ~new_n153_ | ~x18)));
  ...
  assign new_n156_ = (x14 | x15 | (~new_n157_ & ~new_n85_)) & (x08 | ~x15 | ~x19);
  ...
  assign z27 = (~new_n188_ & ~x09) | (new_n192_ & new_n66_ & x03 & ~x05);
  assign new_n188_ = (x17 | new_n189_ | ~x18) & (x05 | ~x17 | x18 | (~x07 ^ x15));
  assign new_n189_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n190_ & (~x05 | x08 | x15 | ~x19));
  assign new_n190_ = ~x21 & (new_n191_ | (~new_n132_ & ~x04));
  ...
  assign new_n200_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n98_ & x21));
