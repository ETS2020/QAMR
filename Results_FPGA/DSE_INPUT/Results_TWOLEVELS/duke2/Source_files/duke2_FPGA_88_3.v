...
module FAU ( 
  ...
  assign new_n79_ = x17 ? (x18 | (x15 ? (x05 & x07) : (x05 & (~x05 | x07)))) : (~x18 | ((~x07 | ~x08 | (x05 ^ ~x15)) & (~x05 | x07 | x08 | x15)));
  ...
  assign new_n91_ = (x07 | x17 | ~x18 | (~new_n62_ & (new_n92_ | x15))) & (~x17 | x18 | ~x07 | x15);
  ...
  assign z10 = (~x09 & (~new_n120_ | (~new_n119_ & ~x07))) | (x08 & new_n121_ & x09);
  assign new_n119_ = x15 ? ((~x17 | x18) & (x05 | x06 | x08 | x17 | ~x18)) : (x05 ? ((~x17 | x18) & (x06 | x08 | x17 | ~x18)) : (~x17 | x18));
  assign new_n120_ = (x05 | ~x17 | x18 | (~x15 & (~x07 | x15))) & (~x05 | ~x07 | ~x08 | x15 | x17 | ~x18);
  assign new_n121_ = ~x15 & ~x17 & x18 & (x05 ^ ~x07);
  assign z11 = new_n123_ & ~x18;
  assign new_n123_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & (new_n131_ | (~x07 & ~x17 & new_n125_ & x18));
  assign new_n125_ = ~x21 & ((~new_n129_ & ~x04) | (~new_n126_ & ~x05) | (new_n130_ & x04 & x05));
  assign new_n126_ = (new_n127_ | x15) & (x02 | ~x08 | ~x11 | ~x15);
  ...
  assign new_n140_ = ~x18 & ((x15 & x17) | (x07 & (~x01 | (~x15 & x17))));
  ...
  assign z17 = ~x09 & (new_n152_ | (new_n150_ & ~x05));
  assign new_n150_ = ~x15 & (x07 ? (x17 & ~x18) : (~x08 & ~x17 & new_n151_ & x18));
  ...
  assign new_n161_ = ~x21 & (x04 ? (new_n162_ & ~x12) : ~new_n129_);
  ...
  assign z27 = new_n186_ | (new_n190_ & new_n66_ & x03 & ~x05);
  assign new_n186_ = ~x09 & (new_n131_ | (~x17 & ~new_n187_ & x18));
  assign new_n187_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n188_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n188_ = ~x21 & (new_n189_ | (~new_n129_ & ~x04));
  ...
  assign new_n200_ = ~x18 & ((~x07 & (x15 | (x05 & ~x15))) | (~x05 & x15 & ~x19));
endmodule
