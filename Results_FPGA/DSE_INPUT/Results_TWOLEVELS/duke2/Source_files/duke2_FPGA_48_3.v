...
module FAU ( 
  ...
  assign new_n73_ = (~x01 | x15 | (~x08 & ~x16)) & (~x08 | ~x15 | ~x18 | ~x19);
  ...
  assign new_n180_ = (new_n181_ | x07) & (~x01 | x05 | ~x07 | ~x08 | x15);
