...
module FAU ( 
  ...
  assign new_n104_ = (x05 ^ x15) & (x07 ? x08 : (~new_n72_ & ~x08));
  assign new_n105_ = new_n66_ & ~x05 & x09 & ~x15 & x16;
  assign z08 = x14 & ~x20;
  ...
  assign z10 = (~new_n125_ & ~x09) | (x08 & new_n128_ & ~x15);
  assign new_n125_ = x07 ? new_n127_ : ((~x17 | x18) & (x08 | x17 | ~new_n126_ | ~x18));
  assign new_n126_ = (x19 | (~x06 & ~x19)) & (x05 ^ x15);
  ...
  assign new_n151_ = ~x14 & ~x21 & (new_n155_ | (~new_n152_ & x06));
  assign new_n152_ = (~new_n154_ | ~x12) & (~x02 | (~new_n153_ & (~x04 | x12)));
  assign new_n153_ = ~x09 & ~x10 & x13;
  assign new_n154_ = ~x16 & ((~x02 & x11) | (~x09 & x10 & ~x13));
  assign new_n155_ = ~x09 & (new_n97_ | (~x06 & new_n156_ & x12));
  assign new_n156_ = x16 & ((~x02 & x11) | (x10 & ~x13));
  ...
  assign new_n181_ = (~x06 | x15 | (x05 ? (x08 | x09) : (~x08 | ~x09))) & (x05 | x08 | x09 | ~x15 | (~x19 & (x06 | x19)));
  ...
  assign new_n194_ = x18 & (x08 ? (x09 & ~x15) : (~x09 & ~new_n72_ & x15));
  ...
  assign z28 = (~x17 & (new_n204_ | (new_n213_ & ~x05))) | (~x09 & new_n214_ & x17);
  ...
  assign new_n210_ = ~x09 & (x06 ? (new_n211_ | x15) : (new_n212_ | (x15 & ~x19)));
  assign new_n211_ = ~x02 & x11 & ~x14 & ~x15 & x21;
  assign new_n212_ = x04 & ~x12 & ~x14 & ~x15 & x21;
