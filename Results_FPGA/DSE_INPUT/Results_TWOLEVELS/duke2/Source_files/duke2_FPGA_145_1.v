...
module FAU ( 
  ...
  assign new_n77_ = (~x07 | (~x09 & x19)) & x11 & (~x09 | ~x11 | x02 | x07);
  ...
  assign new_n102_ = (x09 | (x07 ? (~x08 | (~x05 ^ x15)) : (x08 | (~x05 ^ x15)))) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20;
  ...
  assign new_n176_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  ...
  assign z27 = new_n190_ | (new_n195_ & ~x07 & x08 & x03 & ~x05);
  ...
  assign new_n201_ = (x02 | x07 | ~x11 | (~x09 & (x09 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
