// Benchmark "FAU" written by ABC on Wed Jul 29 04:21:53 2020
...
module FAU ( 
  ...
  assign z02 = ~x17 & x18 & ((~new_n68_ & ~x07) | (~new_n75_ & x08));
  assign new_n68_ = ~new_n71_ & (x09 | (~new_n69_ & new_n74_ & (new_n73_ | x05)));
  assign new_n69_ = ~x04 & ((~x06 & ~x15) | (new_n70_ & ~x11 & x15 & ~x21));
  ...
  assign z08 = x14 & ~x20;
  assign z09 = new_n117_ | (~x17 & (new_n115_ | (~new_n104_ & x18)));
  assign new_n104_ = (~new_n113_ | x07) & (x15 | (~new_n114_ & (x07 | (~new_n105_ & ~new_n112_))));
  ...
  assign new_n112_ = ~x04 & x05 & x08 & ~new_n72_ & x12;
  assign new_n113_ = x08 & ((x02 & ~x05 & ~x11 & ~new_n72_ & x15) | (new_n72_ & x05));
  assign new_n114_ = x05 & x08 & (~x12 | (x07 & (x09 | ~x19 | (~x09 & x19))));
  ...
  assign z14 = x07 ? ~new_n138_ : (new_n140_ | (~x17 & (new_n134_ | new_n136_)));
  assign new_n134_ = x08 & x18 & ~new_n135_ & (x09 | (~x09 & ~x21));
  assign new_n135_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n136_ = new_n137_ & x04 & ~x05 & ~x09 & x12;
  assign new_n137_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n138_ = (x05 | ((x09 | x18) & (~new_n139_ | ~x08 | ~x15))) & (~new_n139_ | ~x05 | ~x08 | x15);
  assign new_n139_ = ~x17 & x18 & ~x19;
  assign new_n140_ = ~x05 & ~x09 & x15 & x17 & ~x18;
  ...
  assign new_n145_ = (~x06 | (~new_n146_ & (~x12 | new_n147_ | x16))) & ~new_n93_ & (x06 | ~x12 | new_n147_ | ~x16);
  assign new_n146_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n147_ = x13 & (x02 | ~x11);
  assign new_n148_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n152_ | (~x05 & (new_n99_ | (~new_n150_ & ~x07))));
  assign new_n150_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n151_ | ~x18);
  assign new_n151_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n152_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n154_ & x18;
  assign new_n154_ = (x14 | x15 | (~new_n155_ & ~new_n83_)) & (x08 | ~x15 | ~x19);
  assign new_n155_ = x12 & ((~new_n156_ & ~x06) | (new_n157_ & x06 & x08 & x10));
  assign new_n156_ = (x04 | x08 | ~x21) & (~new_n88_ | ~x08 | ~x10);
  assign new_n157_ = ~x13 & x16 & ~x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n160_ | new_n166_);
  assign new_n160_ = ~x09 & (new_n161_ | (new_n137_ & x04 & ~x05 & x12));
  assign new_n161_ = x18 & (new_n164_ | (~x21 & (x04 ? new_n162_ : ~new_n130_)));
  assign new_n162_ = ~x12 & ~x15 & (x05 ? x08 : (x08 ? new_n163_ : ~x06));
  assign new_n163_ = x10 & ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n164_ = ~x05 & new_n165_ & ~x06;
  assign new_n165_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n166_ = new_n70_ & x04 & ~x15 & x18 & x09 & ~x12;
  assign z21 = ~x17 & ~new_n168_ & x18;
  assign new_n168_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign new_n185_ = ~x21 & (new_n186_ | (~new_n130_ & ~x04));
