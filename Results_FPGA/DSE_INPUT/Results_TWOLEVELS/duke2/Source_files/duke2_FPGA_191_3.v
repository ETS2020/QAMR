...
module FAU ( 
  ...
  assign new_n73_ = (x15 | ((~x05 | x08) & (x06 | x12))) & (~x08 | ~x21 | (~x05 & ~x15));
  ...
  assign z06 = ~x09 & ((~new_n92_ & ~x05) | (new_n100_ & new_n66_ & x04 & x05));
  ...
  assign z08 = x14 & ~x20;
  assign z09 = new_n119_ | (~x17 & (new_n105_ | new_n117_));
  assign new_n105_ = x18 & (new_n116_ | (~x07 & (new_n114_ | (~new_n106_ & ~x15))));
  ...
  assign z12 = ~x09 & ((~new_n128_ & ~x07) | (~x05 & x07 & new_n120_ & ~x15));
  assign new_n128_ = ~new_n135_ & (x17 | ~x18 | x21 | (new_n129_ & ~new_n133_));
  ...
  assign new_n135_ = x00 & ~x05 & new_n120_ & x15;
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | (x05 & ~x07));
  assign z14 = (~x17 & (new_n138_ | (~x05 & new_n141_ & ~x09))) | (~x05 & new_n143_ & ~x09);
  assign new_n138_ = x08 & ~new_n139_ & x18;
  assign new_n139_ = x07 ? (~x05 ^ x15) : (new_n140_ | (~x09 & (x09 | x21)));
  ...
  assign z16 = x08 & ~x17 & x18 & (x05 ? new_n153_ : ~new_n146_);
  assign new_n146_ = (x07 | x15 | (~x09 & (~new_n147_ | x14))) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n147_ = ~x21 & ((~new_n148_ & x06) | new_n152_ | (~new_n151_ & ~x09));
  assign new_n148_ = (~x02 | (~new_n149_ & (~x04 | x12))) & (~new_n150_ | ~x12);
  assign new_n149_ = ~x09 & ~x10 & x13;
  assign new_n150_ = ~x16 & ((~x02 & x11) | (~x09 & x10 & ~x13));
  assign new_n151_ = ~new_n95_ & (x06 | ~x10 | ~x12 | x13 | ~x16);
  assign new_n152_ = x11 & x12 & x16 & ~x02 & ~x06;
  assign new_n153_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n158_ | (~new_n155_ & ~x05));
  assign new_n155_ = (~new_n120_ | ~x07 | x15) & (x07 | ((x08 | ~new_n156_ | x15) & (~new_n120_ | ~x00 | ~x15)));
  ...
  assign z18 = ~x05 & ~x07 & ~x09 & new_n160_ & ~x14;
  assign new_n160_ = ~x15 & ~x17 & x18 & (new_n85_ | (~new_n161_ & x12));
  assign new_n161_ = (x06 | (~new_n163_ & (~new_n90_ | ~x08 | ~x10))) & (~new_n162_ | ~x06 | ~x08 | ~x10);
  assign new_n162_ = ~x13 & x16 & ~x21;
  assign new_n163_ = ~x04 & ~x08 & x21;
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n173_ | (~new_n166_ & ~x09));
  assign new_n166_ = ~new_n170_ & (~x18 | (~new_n167_ & (x05 | ~new_n172_ | x06)));
  assign new_n167_ = ~x21 & (x04 ? (new_n168_ & ~x12) : ~new_n134_);
  ...
  assign new_n175_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  ...
  assign z27 = ~x09 & ((~new_n190_ & ~x07) | (~x05 & x07 & new_n120_ & ~x15));
  assign new_n190_ = ~new_n135_ & (x17 | ~x18 | (~new_n133_ & ~new_n191_) | x21);
  assign new_n191_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign z28 = (~x17 & (new_n204_ | (~new_n193_ & x18))) | (~x09 & x17 & ~new_n206_ & ~x18);
  assign new_n193_ = (x07 | ((new_n194_ | ~x08) & (x05 | ~new_n199_ | x08))) & (x05 | ~new_n203_ | ~x08);
  assign new_n194_ = new_n198_ & (x05 | (~new_n195_ & (x09 | ~new_n197_ | ~x10)));
  assign new_n195_ = x11 & (new_n196_ | (~x02 & x15 & (x09 | (~x09 & ~x21))));
  assign new_n196_ = ~x14 & ~x15 & ~x21 & ~x09 & x10 & x12;
  assign new_n197_ = x12 & ~x14 & ~x15 & ~x21 & (~x13 | (x02 & x13));
  assign new_n198_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n199_ = ~new_n200_ & ~x09;
  assign new_n200_ = x06 ? (~x15 & (~new_n201_ | x14 | x15 | ~x21)) : (~x15 & (~new_n202_ | x14 | x15 | ~x21));
  assign new_n201_ = ~x02 & x11;
  assign new_n202_ = x04 & ~x12;
