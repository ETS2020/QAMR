...
module FAU ( 
  ...
  assign new_n55_ = x05 ? (x07 & x15) : (x07 ? ~x15 : (x00 & x15));
  ...
  assign new_n107_ = (~new_n115_ | x07) & (x15 | (~new_n118_ & ((~new_n108_ & ~new_n117_) | x07)));
  ...
  assign new_n125_ = x05 ? ((~x17 | x18) & (~new_n126_ | x15 | x17 | ~x18)) : ((~x15 | ((~new_n126_ | x17 | ~x18) & (~x00 | ~x17 | x18))) & (~x17 | x18 | (x00 & x15)));
  ...
  assign new_n140_ = x17 & ~x18 & (x05 ? ~x07 : (x07 | (~x07 & (~x00 | ~x15 | (x00 & x15)))));
  ...
  assign new_n148_ = ~x18 & ((~x01 & x07) | (x17 & (x07 | (~x07 & (~x00 | (x00 & x15))))));
