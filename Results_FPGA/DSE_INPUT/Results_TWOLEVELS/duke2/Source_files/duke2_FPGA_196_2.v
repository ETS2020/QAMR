...
module FAU ( 
  ...
  assign new_n55_ = (x05 | (~x15 & (x07 | x15))) & (x07 | ~x15) & (~x05 | x15);
  ...
  assign z03 = (~new_n80_ & ~x09) | (new_n66_ & ~x05 & new_n81_ & x09 & ~x15);
  assign new_n80_ = x17 ? (x18 | (x15 ? (x05 & x07) : (x05 & (~x05 | x07)))) : (~x18 | ((~x07 | ~x08 | (x05 ^ ~x15)) & (~x05 | x07 | x08 | x15)));
  ...
  assign z06 = ~x09 & ((~new_n92_ & ~x05) | (new_n99_ & new_n66_ & x04 & x05));
  assign new_n92_ = (x07 | x17 | ~x18 | (~new_n63_ & (new_n93_ | x15))) & (~x17 | x18 | ~x07 | x15);
  ...
  assign new_n118_ = ~x07 & ~x09 & ~x15 & x17 & ~x18;
  assign z10 = (~new_n120_ & ~x09) | (x08 & new_n124_ & ~x15);
  assign new_n120_ = (new_n121_ | x07) & (~new_n122_ | x05) & (~new_n123_ | ~x05 | ~x07 | ~x08);
  assign new_n121_ = x15 ? ((~x17 | x18) & (x05 | x06 | x08 | x17 | ~x18)) : (x05 ? ((~x17 | x18) & (x06 | x08 | x17 | ~x18)) : (~x17 | x18));
  assign new_n122_ = x17 & ~x18 & (x15 | (x07 & ~x15));
  assign new_n123_ = ~x15 & ~x17 & x18 & x19;
  assign new_n124_ = ~x17 & x18 & (x05 ? (x07 & (x09 | ~x19)) : (~x07 & x09));
  assign z11 = new_n126_ & ~x18;
  assign new_n126_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & (new_n134_ | (~x07 & ~x17 & new_n128_ & x18));
  assign new_n128_ = ~x21 & ((~new_n132_ & ~x04) | (~new_n129_ & ~x05) | (new_n133_ & x04 & x05));
  assign new_n129_ = (new_n130_ | x15) & (x02 | ~x08 | ~x11 | ~x15);
  ...
  assign new_n134_ = ~x05 & x07 & ~x15 & x17 & ~x18;
  assign z13 = ~x09 & x17 & ~x18 & (x15 ? (~x05 | ~x07) : (~x05 | (x05 & ~x07)));
  ...
  assign new_n143_ = ~x18 & ((x15 & x17) | (x07 & (~x01 | (~x15 & x17))));
  ...
  assign z17 = ~x09 & ((new_n155_ & new_n66_ & ~x04 & x05) | (new_n153_ & ~x05));
  assign new_n153_ = ~x15 & (x07 ? (x17 & ~x18) : (~x08 & ~x17 & new_n154_ & x18));
  assign new_n154_ = ~new_n61_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n155_ = ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n157_ & x18;
  assign new_n157_ = (x14 | x15 | (~new_n158_ & ~new_n85_)) & (x08 | ~x15 | ~x19);
  assign new_n158_ = x12 & ((~new_n159_ & ~x06) | (new_n160_ & x06 & x08 & x10));
  assign new_n159_ = (x04 | x08 | ~x21) & (~new_n90_ | ~x08 | ~x10);
  ...
  assign new_n164_ = ~x21 & (x04 ? (new_n165_ & ~x12) : ~new_n132_);
  ...
  assign z22 = ~x17 & x18 & ((~new_n175_ & ~x07) | (~x05 & new_n176_ & x07));
  assign new_n175_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)));
  assign new_n176_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  ...
  assign z27 = new_n189_ | (new_n193_ & new_n66_ & x03 & ~x05);
  assign new_n189_ = ~x09 & (new_n134_ | (~x17 & ~new_n190_ & x18));
  assign new_n190_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n191_ & (~x05 | x08 | x15 | ~x19));
  assign new_n191_ = ~x21 & (new_n192_ | (~new_n132_ & ~x04));
  assign new_n192_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n193_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n195_ | (new_n202_ & ~x05))) | (~x09 & new_n203_ & x17);
  assign new_n195_ = x18 & ((~new_n196_ & x08) | (~x05 & ~x07 & new_n201_ & ~x08));
  assign new_n196_ = (new_n200_ | x07) & (x05 | ((~new_n197_ | x07) & (new_n199_ | ~x15)));
  assign new_n197_ = ~x09 & x10 & new_n198_ & x12;
  assign new_n198_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n199_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  ...
  assign new_n203_ = ~x18 & ((~x07 & (x15 | (x05 & ~x15))) | (~x05 & x15 & ~x19));
endmodule
