...
module FAU ( 
  ...
  assign new_n55_ = x17 & ((~x18 & (x05 ? (~x07 | ~x15) : (~x07 ^ x15))) | (~x00 & ~x05 & ~x07 & x15));
  ...
  assign z03 = (new_n82_ & x09 & ~x15 & ~x17 & x18) | (~new_n79_ & ~x09);
  assign new_n79_ = x07 ? new_n80_ : new_n81_;
  assign new_n80_ = (~x08 | x17 | ~x18 | (x05 ^ ~x15)) & (x05 | ~x17 | x18);
  assign new_n81_ = x05 ? ((~x17 | x18) & (x08 | x15 | x17 | ~x18)) : (~x17 | (x15 ? (x00 & (~x00 | x18)) : x18));
  ...
  assign new_n93_ = (~x00 | ~x15 | ~x17 | x18) & (x17 | ~x18 | (~new_n62_ & (new_n94_ | x15)));
  ...
  assign new_n107_ = (~new_n115_ | x07) & (x15 | (~new_n118_ & (x07 | (~new_n108_ & ~new_n117_))));
  ...
  assign new_n120_ = ~x15 & ~x18 & ~x21 & x12 & ~x14;
  assign new_n121_ = ~x07 & new_n122_ & ~x09;
  assign new_n122_ = ~x15 & x17 & ~x18;
  assign z10 = new_n124_ | (x08 & new_n128_ & ~x15);
  assign new_n124_ = ~x09 & (x07 ? ~new_n127_ : ~new_n125_);
  assign new_n125_ = x05 ? ((~x17 | x18) & (~new_n126_ | x15 | x17 | ~x18)) : ((~x17 | (x15 ? (x00 & (~x00 | x18)) : x18)) & (~new_n126_ | ~x15 | x17 | ~x18));
  ...
  assign z13 = new_n140_ & ~x09;
  assign new_n140_ = x17 & (x05 ? (~x07 & ~x18) : ((~x18 & (x07 | (~x07 & (~x15 | (x00 & x15))))) | (~x00 & ~x07 & x15)));
  ...
  assign new_n148_ = (~x17 | ((x00 | x07 | ~x15) & (x18 | (~x07 & (~x00 | x07 | ~x15))))) & (x01 | ~x07 | x18);
  ...
  assign new_n162_ = (x14 | (~new_n163_ & ~new_n86_) | x15) & (x08 | ~x15 | ~x19);
  ...
  assign new_n180_ = (x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  assign new_n181_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n183_ & x18;
  assign new_n183_ = ~x17 & ~x15 & x09 & ~x05 & ~x07 & x08;
  assign z24 = ~x09 & (new_n185_ | new_n189_) & ~x17;
  ...
  assign z27 = new_n194_ | (new_n199_ & x03 & ~x05 & ~x07 & x08);
  ...
  assign new_n207_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n99_ & x21));
