...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n99_ | (~x05 & (new_n101_ | (~new_n92_ & ~x07))));
  assign new_n92_ = (x17 | ~x18 | (~new_n62_ & (new_n93_ | x15))) & (~x00 | ~x15 | ~x17 | x18);
  ...
  assign new_n132_ = ~new_n134_ & (x15 | (x08 ? (~new_n95_ | x14) : new_n133_));
  ...
  assign new_n150_ = (~x06 | (~new_n151_ & (~x12 | new_n152_ | x16))) & ~new_n95_ & (x06 | ~x12 | new_n152_ | ~x16);
  assign new_n151_ = x02 & ((~x10 & x13) | (x04 & ~x12));
  assign new_n152_ = x13 & (x02 | ~x11);
  assign new_n153_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n157_ | (~x05 & (new_n101_ | (~new_n155_ & ~x07))));
  assign new_n155_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n156_ | ~x18);
  assign new_n156_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n157_ = new_n65_ & new_n100_ & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n159_ & x18;
  assign new_n159_ = (x14 | x15 | (~new_n160_ & ~new_n85_)) & (x08 | ~x15 | ~x19);
  assign new_n160_ = x12 & ((~new_n161_ & ~x06) | (new_n162_ & x06 & x08 & x10));
  assign new_n161_ = (~new_n90_ | ~x08 | ~x10) & (x04 | x08 | ~x21);
  ...
  assign new_n166_ = ~x21 & (x04 ? (new_n167_ & ~x12) : ~new_n135_);
  ...
  assign z22 = ~x17 & x18 & ((~new_n177_ & ~x07) | (~x05 & new_n178_ & x07));
  assign new_n177_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  ...
  assign new_n193_ = ~x21 & (new_n194_ | (~new_n135_ & ~x04));
  ...
  assign new_n199_ = (new_n203_ | x07) & (x05 | ((~new_n200_ | x07) & (new_n202_ | ~x15)));
  ...
  assign new_n204_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n98_ & x21));
