// Benchmark "FAU" written by ABC on Wed Jul 29 04:22:40 2020
...
module FAU ( 
  ...
  assign new_n73_ = (~x01 | x15 | (~x16 & (~x08 | x18))) & (~x08 | ~x15 | ~x18 | ~x19);
  ...
  assign new_n83_ = ~x14 & ~x15 & ~x17 & x18 & (new_n84_ | ~new_n86_);
  ...
  assign z06 = ~x09 & (new_n94_ | (~x05 & (new_n96_ | (~new_n89_ & ~x07))));
  assign new_n89_ = (~x00 | ~x15 | ~x17 | x18) & (x17 | ~x18 | (~new_n62_ & (new_n90_ | x15)));
  assign new_n90_ = x08 ? (x14 | new_n91_ | x21) : (new_n93_ | (x21 & (x14 | ~x21)));
  assign new_n91_ = ~new_n92_ & (x06 | ((~x10 | ~x12 | x13) & (~x02 | x10 | ~x13)));
  ...
  assign new_n96_ = x07 & ~x15 & x17 & ~x18;
  assign z07 = ~x09 & ~x17 & x18 & ~new_n98_ & (x07 ^ ~x08);
  assign new_n98_ = x05 ^ ~x15;
  assign z08 = x14 & ~x20;
  assign z09 = new_n115_ | (~x17 & (new_n113_ | (~new_n101_ & x18)));
  assign new_n101_ = (~new_n109_ | x07) & (x15 | (~new_n112_ & ((~new_n102_ & ~new_n111_) | x07)));
  ...
  assign new_n105_ = ~x05 & ((~new_n106_ & x06) | (new_n107_ & x02));
  ...
  assign z12 = ~x09 & ((~new_n125_ & ~x07) | (new_n116_ & ~x05 & x07));
  ...
  assign z14 = (~x17 & (new_n134_ | (~x05 & new_n137_ & ~x09))) | (~x05 & new_n139_ & ~x09);
  assign new_n134_ = x08 & ~new_n135_ & x18;
  assign new_n135_ = x07 ? (new_n98_ | x19) : (new_n136_ | (~x09 & (x09 | x21)));
  ...
  assign z16 = x08 & ~x17 & ~new_n142_ & x18;
  assign new_n142_ = x05 ? (~x09 | x15 | (~x07 & x12)) : new_n143_;
  assign new_n143_ = (x07 | x15 | (x09 ? x19 : ~new_n144_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n144_ = ~x14 & ~x21 & (new_n92_ | (~new_n145_ & x06));
  assign new_n145_ = (~x02 | ((x10 | ~x13) & (~x04 | x12))) & (~x12 | ((x02 | ~x11) & (~x10 | x13)));
  assign z17 = ~x09 & (new_n149_ | (~x05 & (new_n96_ | (~new_n147_ & ~x07))));
  assign new_n147_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n148_ | ~x18);
  assign new_n148_ = ~new_n60_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n149_ = new_n65_ & ~x17 & x18 & ~x21 & ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & new_n151_ & ~x17;
  assign new_n151_ = x18 & ((~x14 & ~new_n152_ & ~x15) | (~x08 & x15 & x19));
  assign new_n152_ = ~new_n84_ & (~new_n153_ | x06);
  assign new_n153_ = x12 & ((~x13 & ~x21 & x08 & x10) | (~x04 & ~x08 & x21));
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n163_ | (~new_n156_ & ~x09));
  assign new_n156_ = ~new_n160_ & (~x18 | (~new_n157_ & (x05 | ~new_n162_ | x06)));
  assign new_n157_ = ~x21 & (x04 ? (new_n158_ & ~x12) : ~new_n130_);
  assign new_n158_ = ~x15 & (x05 ? x08 : (x08 ? (new_n159_ & x10) : ~x06));
  assign new_n159_ = ~x14 & (~x13 | (~x02 & x11 & x13));
  assign new_n160_ = new_n161_ & x04 & ~x05 & x12;
  assign new_n161_ = ~x18 & ~x21 & ~x14 & ~x15;
  assign new_n162_ = ~x08 & ~x14 & ~x15 & x21 & (~x04 ^ ~x12);
  assign new_n163_ = new_n164_ & x04 & x05 & x08;
  assign new_n164_ = x09 & ~x12 & ~x15 & x18;
  ...
  assign new_n168_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (~x06 | x08 | x09 | ~x15)));
  assign new_n169_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n171_ & x18;
  assign new_n171_ = ~x17 & ~x15 & x09 & x08 & ~x05 & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n173_ | new_n177_);
  assign new_n173_ = ~x07 & (new_n174_ | (~x05 & ~x08 & ~x15 & x18));
  assign new_n174_ = ~x21 & ((x04 & ~new_n175_ & ~x15) | (x08 & new_n176_ & x15));
  assign new_n175_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x18);
  ...
  assign z27 = new_n182_ | (new_n187_ & ~x07 & x08 & x03 & ~x05);
  assign new_n182_ = ~x09 & ((~x17 & ~new_n183_ & x18) | (~x05 & x17 & ~new_n186_ & ~x18));
  ...
  assign new_n186_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n187_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n189_ | (new_n196_ & ~x05))) | (~x09 & new_n197_ & x17);
  assign new_n189_ = x18 & ((~new_n190_ & x08) | (~x05 & ~x07 & new_n195_ & ~x08));
  assign new_n190_ = (new_n194_ | x07) & (x05 | ((~new_n191_ | x07) & (new_n193_ | ~x15)));
  assign new_n191_ = ~x09 & x10 & new_n192_ & x12;
  assign new_n192_ = ~x14 & ~x15 & ~x21 & (~x13 | x11 | (x02 & x13));
  assign new_n193_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n194_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n195_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n93_ & x21));
