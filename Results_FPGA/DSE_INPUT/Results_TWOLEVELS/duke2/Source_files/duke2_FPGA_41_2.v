// Benchmark "FAU" written by ABC on Wed Jul 29 04:21:52 2020
...
module FAU ( 
  ...
  assign z02 = ~x17 & (new_n69_ | (new_n77_ & x01 & ~x05 & x07));
  assign new_n69_ = x18 & ((~new_n74_ & x08) | (~x07 & (new_n70_ | (new_n76_ & x08))));
  ...
  assign new_n74_ = new_n75_ & (~x07 | (~x05 ^ x15) | (~x09 & x19 & (x09 | ~x19)));
  assign new_n75_ = x05 ? (x12 | x15) : (~x15 | (x11 & (x02 | ~x09)));
  assign new_n76_ = ~x15 & (~x05 | (~x04 & x05 & x12 & (x09 | ~x21)));
  assign new_n77_ = ~x15 & ~x18 & x08 & ~x09;
  assign z03 = (~new_n80_ & ~x09) | (new_n79_ & ~x17 & x18 & x09 & ~x15);
  assign new_n79_ = new_n66_ & ~x05;
  ...
  assign new_n83_ = ~x15 & ~x17 & (new_n89_ | (x18 & (~new_n84_ | new_n87_)));
  assign new_n84_ = (new_n85_ | x06) & (x02 | ~x06 | x08 | ~x11 | ~x21);
  ...
  assign new_n89_ = new_n90_ & x06 & x08 & x10;
  assign new_n90_ = x12 & ~x13 & x16 & ~x21;
  assign z06 = ~x09 & ((~new_n92_ & ~x05) | (new_n104_ & new_n66_ & x04 & x05));
  assign new_n92_ = (x07 | ((new_n93_ | x17) & (~x17 | x18 | ~x00 | ~x15))) & (~x17 | x18 | ~x07 | x15);
  assign new_n93_ = ~new_n103_ & (x15 | (~new_n101_ & (x14 | (~new_n94_ & ~new_n97_))));
  assign new_n94_ = x06 & (new_n95_ | new_n96_);
  assign new_n95_ = ~x02 & ~x08 & x11 & x18 & x21;
  assign new_n96_ = ~x13 & x16 & ~x21 & x08 & x10 & x12;
  assign new_n97_ = x18 & (new_n100_ | (x08 & ~x21 & (new_n98_ | new_n99_)));
  ...
  assign new_n101_ = ~x08 & x18 & ~new_n102_ & ~x21;
  assign new_n102_ = (x02 | ~x06 | ~x11) & (~x04 | x06 | x12);
  assign new_n103_ = x15 & x18 & ~x21 & ~x02 & x08 & x11;
  assign new_n104_ = ~x12 & ~x15 & ~x17 & x18 & ~x21;
  assign z07 = ~x17 & ((new_n106_ & ~x09) | (new_n79_ & x09 & ~x15 & x16));
  assign new_n106_ = x18 & (x05 ^ x15) & (x07 ^ ~x08);
  assign z08 = x14 & ~x20;
  ...
  assign new_n123_ = ~x07 & new_n124_ & ~x09;
  ...
  assign new_n142_ = new_n143_ & x08;
  ...
  assign z16 = x08 & ~x17 & (x05 ? new_n157_ : ~new_n151_);
  assign new_n151_ = (x07 | new_n152_ | x15) & (~x09 | ~x15 | ~x18 | (x02 & ~x07));
  assign new_n152_ = x09 ? (~x18 | x19) : (x14 | new_n153_ | x21);
  assign new_n153_ = (~new_n156_ | x06) & (~x18 | (~new_n98_ & (~x06 | (~new_n154_ & ~new_n155_))));
  ...
  assign z17 = ~x09 & (new_n159_ | new_n162_);
  assign new_n159_ = ~x05 & ((~new_n160_ & ~x07) | (x17 & ~x18 & x07 & ~x15));
  assign new_n160_ = (~x17 | x18 | ~x00 | ~x15) & (x08 | x15 | x17 | ~new_n161_ | ~x18);
  assign new_n161_ = ~new_n61_ & ((x02 & x06 & ~x11) | (~x04 & ~x06 & x12));
  assign new_n162_ = new_n65_ & ~x11 & x15 & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~new_n164_ & ~x17;
  assign new_n164_ = (x14 | new_n165_ | x15) & (~x18 | ~x19 | x08 | ~x15);
  assign new_n165_ = ~new_n89_ & (~x18 | (~new_n87_ & (x06 | new_n166_ | ~x12)));
  assign new_n166_ = (x04 | x08 | ~x21) & (~new_n86_ | ~x08 | ~x10);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n176_ | (~new_n169_ & ~x09));
  ...
  assign new_n176_ = new_n177_ & x04 & x05 & x08;
  assign new_n177_ = x09 & ~x12 & ~x15 & x18;
  assign z21 = ~x17 & ~new_n179_ & x18;
  assign new_n179_ = (x07 | ((x05 | ((~x09 | x15 | ~x06 | ~x08) & (x06 | x08 | x09 | ~x15))) & (~x05 | ~x06 | x08 | x09 | x15))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x17 & x18 & ((~new_n181_ & ~x07) | (~x05 & new_n182_ & x07));
  assign new_n181_ = (~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x06 | x08 | x09 | ~x15) & (~x08 | ~x09 | x15)));
  assign new_n182_ = x08 & x15 & (x09 | ~x19 | (~x09 & x19));
  assign z23 = new_n184_ & x18;
  ...
  assign new_n188_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x12 | x14 | x18);
  ...
  assign z27 = new_n195_ | (new_n200_ & new_n66_ & x03 & ~x05);
  assign new_n195_ = ~x09 & ((~x17 & ~new_n196_ & x18) | (~x05 & x17 & ~new_n199_ & ~x18));
  assign new_n196_ = x07 ? (~x08 | ~x19 | (~x05 ^ x15)) : (~new_n197_ & (~x05 | x08 | x15 | ~x19));
  assign new_n197_ = ~x21 & (new_n198_ | (~new_n138_ & ~x04));
  assign new_n198_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n199_ = (~x07 | x15) & (~x00 | x07 | ~x15);
  assign new_n200_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~x17 & (new_n202_ | (new_n209_ & ~x05))) | (~x09 & new_n210_ & x17);
  assign new_n202_ = x18 & ((~new_n203_ & x08) | (~x05 & ~x07 & new_n208_ & ~x08));
  assign new_n203_ = (new_n207_ | x07) & (x05 | ((~new_n204_ | x07) & (new_n206_ | ~x15)));
  assign new_n204_ = ~x09 & x10 & new_n205_ & x12;
  assign new_n205_ = ~x14 & ~x15 & ~x21 & (x11 | ~x13 | (x02 & x13));
  assign new_n206_ = (x02 | (~x09 & (x07 | x09 | ~x11 | x21))) & x11 & (~x07 | (~x09 & x19 & (x09 | ~x19)));
  assign new_n207_ = (x04 | ~x05 | ~x12 | x15 | (~x09 & x21)) & (x09 | ~x15 | ~x21);
  assign new_n208_ = ~x09 & ((x15 & ~x19) | (~x14 & ~x15 & ~new_n102_ & x21));
