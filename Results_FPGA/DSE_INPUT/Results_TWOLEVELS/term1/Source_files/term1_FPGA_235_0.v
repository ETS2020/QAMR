// Benchmark "FAU" written by ABC on Wed Jul 29 06:24:37 2020
...
module FAU ( 
  ...
  assign z8 = ~x26 & ((x31 & new_n65_ & ~x32) | ((~new_n70_ | new_n77_) & x32));
  ...
  assign new_n70_ = ~new_n71_ & ~new_n72_ & new_n74_ & (x17 | (new_n73_ & x12));
  assign new_n71_ = ~x15 & (~new_n68_ | ~x10 | ~x16);
  assign new_n72_ = ~x16 & (~new_n73_ | ~x11 | ~x17);
  assign new_n73_ = x18 & x19;
  assign new_n74_ = new_n75_ & new_n76_ & (x18 | (x13 & x19));
  assign new_n75_ = (x14 | x19) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  assign new_n76_ = (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n77_ = ~x28 & (x27 ? (x29 & x30) : ~x30);
  assign z9 = ~x26 & (new_n79_ | new_n80_ | (x33 & (~new_n81_ | new_n71_)));
  assign new_n79_ = x29 & ~new_n69_ & ((~x31 & x33) | (x30 & x31 & ~new_n66_ & ~x33));
  assign new_n80_ = (new_n69_ | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n66_ & ~x33));
  assign new_n81_ = ~new_n72_ & new_n82_ & (x17 | (new_n73_ & x12));
  assign new_n82_ = (x18 | (x13 & x19)) & new_n75_ & (x30 | ~x31) & (~x30 | x31);
  assign z0 = ~x32;
endmodule
