...
module FAU ( 
  ...
  assign z5 = x01 & x25 & ~x26 & new_n51_ & (x27 ^ x29);
  assign z6 = x01 & x25 & ~x26 & new_n56_ & (~x02 | ~x03);
  assign new_n56_ = (~new_n52_ | ~new_n53_) & ((x30 & (~x27 | ~x29)) | (x27 & x29 & ~x30));
  assign z7 = new_n60_ | new_n58_ | ~new_n61_ | ~x01 | (x02 & x03);
  assign new_n58_ = ~new_n59_ & (x18 | x23) & new_n52_ & (x17 | x22);
  assign new_n59_ = ~x19 & ~x24;
  assign new_n60_ = x31 & (~x27 | ~x29 | ~x30);
  assign new_n61_ = x25 & ~x26 & (~x27 | ~x29 | ~x30 | x31);
