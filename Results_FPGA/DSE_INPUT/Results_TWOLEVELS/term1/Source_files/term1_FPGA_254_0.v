...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & (new_n72_ | ~new_n65_ | new_n71_);
  assign new_n65_ = ~new_n66_ & new_n68_ & (x17 | (new_n67_ & x12));
  assign new_n66_ = ~x16 & (~new_n67_ | ~x11 | ~x17);
  assign new_n67_ = x18 & x19;
  assign new_n68_ = (x18 | (x13 & x19)) & new_n70_ & ~new_n69_ & (x14 | x19);
  assign new_n69_ = x15 & x16 & x17 & x18 & x19;
  assign new_n70_ = (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n71_ = ~x15 & (~x10 | ~x16 | ~new_n67_ | ~x17);
  assign new_n72_ = ~x28 & (x27 ? (x29 & x30) : ~x30);
  assign z9 = x00 & ~x26 & (new_n74_ | new_n80_ | (~new_n81_ & x33));
  assign new_n74_ = x29 & ~new_n79_ & ((~x31 & x33) | (x30 & new_n75_ & x31));
  ...
  assign new_n80_ = (new_n79_ | ~x29) & (x30 ? x33 : (new_n75_ & ~x31));
  assign new_n81_ = ~new_n71_ & ~new_n66_ & new_n82_ & (x17 | (new_n67_ & x12));
  assign new_n82_ = (x18 | (x13 & x19)) & (x14 | x19) & ~new_n69_ & ~new_n83_;
