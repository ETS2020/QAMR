...
module FAU ( 
  ...
  assign z3 = x01 & x25 & new_n51_ & ~x26;
  ...
  assign new_n61_ = (~x28 | ~x29) & (x30 ? (x31 & ~new_n62_ & ~x32) : x32);
  ...
  assign new_n68_ = x14 & ~x19 & x28;
  assign new_n69_ = x31 & ~x32 & x29 & ~x30;
  assign new_n70_ = x19 & x28 & x13 & ~x18;
  assign new_n71_ = x18 & x19 & x12 & ~x17;
  assign new_n72_ = x11 & ~x16 & x17 & x18 & x19;
  assign new_n73_ = x28 & x29 & ~x30 & x31 & ~x32;
  assign new_n74_ = (~x28 | new_n75_ | ~x29) & (~x32 | (~new_n78_ & new_n79_));
  ...
  assign new_n82_ = (~x28 | ~x29) & ((x31 & x33) | (~x30 & ~x31 & ~new_n62_ & ~x33));
  assign new_n83_ = ~new_n88_ & (~x16 | (~new_n87_ & (~x17 | (~new_n84_ & ~new_n86_))));
  assign new_n84_ = x19 & ((x18 & x33) | (new_n85_ & x13 & ~x18 & x28));
  assign new_n85_ = x31 & ~x33 & x29 & x30;
  assign new_n86_ = x18 & ((new_n68_ & new_n85_) | (~x14 & x33));
  assign new_n87_ = new_n71_ & x28 & x29 & x30 & x31 & ~x33;
  assign new_n88_ = new_n72_ & x28 & x29 & x30 & x31 & ~x33;
  assign new_n89_ = (~x28 | new_n90_ | ~x29) & (~x33 | (~new_n91_ & new_n93_));
