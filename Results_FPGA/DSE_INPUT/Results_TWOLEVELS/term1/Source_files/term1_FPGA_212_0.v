...
module FAU ( 
  ...
  assign new_n66_ = (~x15 | ((new_n68_ | ~x16) & (~new_n67_ | x16 | ~x17))) & (~x10 | x15 | ~x16 | ~new_n67_ | ~x17);
  assign new_n67_ = x18 & x19;
  assign new_n68_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n69_ = ~new_n76_ & ~new_n70_ & ~new_n71_ & new_n72_;
  assign new_n70_ = ~x16 & (~new_n67_ | ~x15 | ~x17);
  assign new_n71_ = ~x15 & (~new_n67_ | ~x10 | ~x17);
  ...
  assign new_n81_ = x33 & (new_n84_ | new_n70_ | ~new_n82_);
  assign new_n82_ = (x19 | (x15 & x17 & x18)) & new_n83_ & (x15 | (x10 & x17 & x18));
