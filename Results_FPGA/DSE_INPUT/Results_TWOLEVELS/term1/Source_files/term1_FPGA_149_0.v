...
module FAU ( 
  ...
  assign new_n67_ = (~x17 | ((~x18 | x19) & (~x13 | x18 | ~x19))) & (~x18 | ~x19 | ~x12 | x17);
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = new_n70_ & (x28 | (x27 ? (~x29 | ~x30) : x30));
  ...
  assign new_n75_ = (x13 | x18) & (~x15 | ~x16 | ~x17 | ~x18 | ~x19);
  ...
  assign new_n82_ = ~new_n74_ & new_n75_ & (x30 | ~x31) & (~x30 | x31);
  assign z0 = ~x32;
endmodule
