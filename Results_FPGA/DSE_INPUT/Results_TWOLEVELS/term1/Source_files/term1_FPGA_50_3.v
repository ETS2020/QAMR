...
module FAU ( 
  ...
  assign z6 = x01 & x25 & new_n58_ & ~x26;
  assign new_n58_ = ~new_n52_ & (~x02 | ~x03) & (x30 | (new_n59_ & x27));
  assign new_n59_ = x28 & x29;
  assign z7 = ~new_n62_ | ((x19 | x24) & new_n61_ & (x18 | x23));
  assign new_n61_ = (x17 | x22) & (x15 | x20) & (x16 | x21);
  assign new_n62_ = x01 & (~x02 | ~x03) & x25 & ~x26 & ~x31;
  assign z8 = x00 & ~x26 & ((x31 & new_n64_ & ~x32) | (~new_n69_ & x32));
  assign new_n64_ = ~new_n65_ & (new_n68_ | (~new_n59_ & x30));
  ...
  assign new_n68_ = x29 & (x27 | (x28 & ~x30));
  assign new_n69_ = (new_n75_ | x30) & ~new_n70_ & new_n71_ & ~new_n76_;
  assign new_n70_ = ~x15 & (~new_n67_ | ~x10 | ~x16);
  ...
  assign new_n74_ = x31 & (~x28 | ~x29 | ~x30);
  assign new_n75_ = x29 & (x27 | x28);
  assign new_n76_ = ~x16 & (~x18 | ~x19 | ~x11 | ~x17);
  assign z9 = x00 & ~x26 & (x33 ? ~new_n79_ : new_n78_);
  assign new_n78_ = ~new_n65_ & ((~x30 & ~new_n75_ & ~x31) | (new_n59_ & x30 & x31));
  assign new_n79_ = ~new_n84_ & ~new_n68_ & (new_n59_ | ~x31) & ~new_n80_ & new_n82_;
  assign new_n80_ = ~x19 & (~new_n81_ | ~x15 | ~x16);
  assign new_n81_ = x17 & x18;
  assign new_n82_ = (x15 | (new_n81_ & x10 & x16)) & new_n83_ & (x16 | (new_n81_ & x11));
  assign new_n83_ = (x17 | (x12 & x18)) & (x13 | x18) & (~x30 | x31);
