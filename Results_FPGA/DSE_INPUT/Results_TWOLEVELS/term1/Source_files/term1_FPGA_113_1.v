...
module FAU ( 
  ...
  assign z8 = x00 & ((~new_n65_ & ~x26) | (~x13 & ~x18 & x32));
  ...
  assign new_n73_ = ~x15 & (~x17 | ~x19 | ~x10 | ~x16);
  assign new_n74_ = ~x16 & (~x11 | ~x17 | ~x19);
  assign new_n75_ = ~x17 & (~x12 | ~x19);
