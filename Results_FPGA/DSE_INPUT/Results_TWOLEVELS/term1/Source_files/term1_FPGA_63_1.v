...
module FAU ( 
  ...
  assign new_n52_ = ~x26 & (~new_n53_ | (~x16 & ~x21) | (~x17 & ~x22));
  ...
  assign new_n63_ = (x17 | x22) & ~new_n55_ & (x16 | x21);
  ...
  assign new_n67_ = ~new_n68_ & (new_n73_ | (x15 & ~new_n70_ & ~x26));
  assign new_n68_ = (~x29 | new_n69_ | x30) & (~x30 | (~new_n69_ & x29));
  assign new_n69_ = ~x27 & ~x28;
  assign new_n70_ = ~new_n72_ & (new_n71_ | ~x16);
  ...
  assign z9 = x00 & (new_n88_ | new_n93_ | (new_n83_ & x29));
  assign new_n83_ = ~new_n69_ & (new_n85_ | (~x26 & (new_n87_ | (new_n84_ & x15))));
  assign new_n84_ = x30 & x31 & ~x33 & (new_n72_ | (~new_n71_ & x16));
  assign new_n85_ = new_n86_ & x18 & x19 & x30 & x31 & ~x33;
  assign new_n86_ = x16 & x17 & x10 & ~x15;
  assign new_n87_ = ~x31 & x33;
  assign new_n88_ = ~new_n89_ & (new_n91_ | (~x26 & (new_n92_ | (new_n90_ & x15))));
  assign new_n89_ = ~new_n69_ & x29;
  assign new_n90_ = ~x30 & ~x31 & ~x33 & (new_n72_ | (~new_n71_ & x16));
  assign new_n91_ = new_n86_ & x18 & x19 & ~x30 & ~x31 & ~x33;
  assign new_n92_ = x31 & x33;
  assign new_n93_ = x33 & (new_n81_ | (~x26 & (~new_n94_ | new_n96_)));
  assign new_n94_ = (x19 | (x16 & x17 & x18)) & new_n95_ & (x16 | (x11 & x17 & x18));
  assign new_n95_ = (x17 | (x12 & x18)) & (x13 | x18) & (~x30 | x31) & (x30 | ~x31);
