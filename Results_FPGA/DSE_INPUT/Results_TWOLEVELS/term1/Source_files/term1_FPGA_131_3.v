...
module FAU ( 
  ...
  assign z8 = x00 & ((x31 & new_n65_ & ~x32) | (~x26 & ~new_n72_ & x32));
  assign new_n65_ = (new_n66_ | new_n69_) & ((x30 & (new_n71_ | ~x29)) | (x29 & ~new_n71_ & ~x30));
  assign new_n66_ = x15 & ((x16 & ~new_n67_ & ~x26) | (new_n68_ & x11 & ~x16));
  assign new_n67_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n68_ = x17 & x18 & x19;
  assign new_n69_ = x10 & ~x15 & x16 & new_n70_ & x19 & ~x26;
  assign new_n70_ = x17 & x18;
  assign new_n71_ = ~x27 & ~x28;
  assign new_n72_ = ~new_n77_ & ~new_n78_ & ~new_n73_ & ~new_n74_ & new_n75_;
  assign new_n73_ = ~x19 & (~new_n70_ | ~x15 | ~x16);
  assign new_n74_ = ~x15 & (~new_n70_ | ~x10 | ~x16);
  assign new_n75_ = (x16 | (x11 & x17 & x18)) & new_n76_ & (x17 | (x12 & x18));
  assign new_n76_ = (x13 | x18) & (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n77_ = x15 & x16 & x17 & x18 & (~x14 | x19);
  assign new_n78_ = ~x28 & (x27 ? (x29 & x30) : ~x30);
  assign z9 = x00 & (new_n86_ | new_n91_ | (new_n80_ & x29));
  assign new_n80_ = ~new_n71_ & (new_n83_ | (~x26 & (new_n85_ | (new_n81_ & x16))));
  assign new_n81_ = x30 & x31 & ~x33 & (new_n82_ | (~new_n67_ & x15));
  assign new_n82_ = x17 & x18 & x19 & x10 & ~x15;
  assign new_n83_ = new_n84_ & x18 & x19 & x30 & x31 & ~x33;
  assign new_n84_ = ~x16 & x17 & x11 & x15;
  assign new_n85_ = ~x31 & x33;
  assign new_n86_ = ~new_n87_ & (new_n89_ | (~x26 & (new_n90_ | (new_n88_ & x16))));
  assign new_n87_ = ~new_n71_ & x29;
  assign new_n88_ = ~x30 & ~x31 & ~x33 & (new_n82_ | (~new_n67_ & x15));
  assign new_n89_ = new_n84_ & x18 & x19 & ~x30 & ~x31 & ~x33;
  assign new_n90_ = x31 & x33;
  assign new_n91_ = ~x26 & x33 & (new_n77_ | new_n73_ | ~new_n92_);
  assign new_n92_ = (x15 | (new_n70_ & x10 & x16)) & new_n93_ & (x16 | (new_n70_ & x11));
