...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & (new_n69_ | (x15 & new_n65_ & x31));
  assign new_n65_ = ~x32 & ~new_n66_ & ((x29 & ~new_n68_ & ~x30) | (x30 & (new_n68_ | ~x29)));
  ...
  assign new_n69_ = x32 & (new_n73_ | new_n74_ | new_n75_ | ~new_n70_ | new_n76_);
  assign new_n70_ = ~new_n71_ & new_n72_ & x15 & (x13 | x18);
  assign new_n71_ = ~x17 & (~x12 | ~x18);
  assign new_n72_ = (~x28 | ~x29 | ~x30) & x31 & (x29 | x30);
  assign new_n73_ = x16 & x17 & x18 & (~x14 | x19);
  assign new_n74_ = ~x28 & (x27 ? (x29 & x30) : ~x30);
  assign new_n75_ = ~x19 & (~x16 | ~x17 | ~x18);
  assign new_n76_ = ~x16 & (~x11 | ~x17 | ~x18);
  assign z9 = x00 & ~x26 & (new_n79_ | new_n81_ | (new_n78_ & x29));
  assign new_n78_ = ~new_n68_ & ((~x31 & x33) | (x15 & x30 & x31 & ~new_n66_ & ~x33));
  assign new_n79_ = ~new_n80_ & ((x31 & x33) | (x15 & ~x30 & ~x31 & ~new_n66_ & ~x33));
  assign new_n80_ = ~new_n68_ & x29;
  assign new_n81_ = x33 & (new_n73_ | new_n75_ | ~new_n82_ | new_n76_);
  assign new_n82_ = ~new_n71_ & (x30 | ~x31) & (~x30 | x31) & x15 & (x13 | x18);
  assign z0 = ~x32;
endmodule
