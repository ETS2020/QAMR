...
module FAU ( 
  ...
  assign new_n63_ = (x15 | x20) & (x19 ? (x16 | x21) : x24);
  ...
  assign new_n67_ = x19 & ((x12 & ~x17 & x18) | (x13 & x17 & ~x18));
  assign new_n68_ = x17 & x18 & ((x11 & ~x16) | (x14 & ~x19));
  ...
  assign new_n76_ = ~x16 & (~x17 | ~x18 | ~x11 | ~x15);
  assign new_n77_ = ~x15 & (~x18 | ~x19 | ~x10 | ~x17);
  assign z9 = x00 & ~x26 & (~new_n80_ | (new_n79_ & x29));
  assign new_n79_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n66_ & ~x33));
  assign new_n80_ = (new_n81_ | ~x33) & (new_n87_ | ((~x31 | ~x33) & (x30 | x31 | new_n66_ | x33)));
  assign new_n81_ = ~new_n82_ & ~new_n83_ & ~new_n84_ & ~new_n85_ & new_n86_;
  assign new_n82_ = x15 & x16 & x17 & x18 & (~x14 | x19);
  assign new_n83_ = (~x15 | ~x17 | ~x18) & (~x16 | ~x19);
  assign new_n84_ = ~x15 & (~x10 | ~x17 | ~x18);
  assign new_n85_ = ~x17 & (~x12 | ~x18);
  assign new_n86_ = (x30 | ~x31) & (~x30 | x31) & (x13 | x18) & (x11 | x16);
