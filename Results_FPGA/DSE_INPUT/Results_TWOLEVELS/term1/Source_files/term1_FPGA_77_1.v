...
module FAU ( 
  ...
  assign z8 = x00 & ((~new_n65_ & ~x26) | (~x14 & ~x19 & x32));
  assign new_n65_ = (~x31 | x32 | new_n66_ | new_n76_) & ((new_n69_ & ~new_n77_) | ~x32);
  ...
  assign z9 = x00 & (new_n84_ | (~x26 & (~new_n80_ | (new_n79_ & x29))));
  assign new_n79_ = (x27 | x28) & ((~x31 & x33) | (x30 & x31 & ~new_n66_ & ~x33));
  assign new_n80_ = (new_n83_ | ((~x31 | ~x33) & (x30 | x31 | new_n66_ | x33))) & (new_n81_ | ~x33);
  assign new_n81_ = ~new_n70_ & ~new_n71_ & ~new_n72_ & ~new_n73_ & new_n74_ & new_n82_;
  assign new_n82_ = x30 ^ ~x31;
  assign new_n83_ = x29 & (x27 | x28);
  assign new_n84_ = x17 & x18 & x33 & ~x14 & x15 & x16;
  assign z0 = ~x32;
endmodule
