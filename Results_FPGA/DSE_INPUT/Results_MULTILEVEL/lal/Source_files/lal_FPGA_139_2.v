...
module FAU ( 
  ...
  assign z01 = (~new_n49_ & (~x15 | x23)) | (~x15 & ~x23 & ~new_n51_ & ~x25);
  ...
  assign z16 = ((new_n50_ | x07) & (~x15 | x23)) | new_n78_ | (~new_n76_ & x23);
  assign new_n76_ = new_n77_ & ~x15 & x17 & x18;
  assign new_n77_ = ~x21 & ~x22 & x19 & ~x20;
  assign new_n78_ = new_n79_ & x18 & x19 & ~x15 & x17;
  assign new_n79_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign z17 = (x23 & (x15 | x24)) | (~x15 & (~new_n81_ | new_n50_ | (~new_n73_ & x24)));
  assign new_n81_ = ~x07 & (~new_n69_ | x21 | x22 | x23 | x24);
  assign z18 = (x23 & (x15 | x25)) | (~x15 & (~new_n84_ | new_n50_ | (~new_n83_ & x25)));
  assign new_n83_ = new_n68_ & ~x20 & ~x21 & ~x22 & ~x24;
  assign new_n84_ = ~x07 & (~new_n69_ | ~new_n85_);
