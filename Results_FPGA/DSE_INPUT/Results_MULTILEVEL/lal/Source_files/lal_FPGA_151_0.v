...
module FAU ( 
  ...
  assign z01 = (~new_n50_ & (x22 | x24)) | (~x25 & ((~x23 & ~new_n51_ & x24) | (x22 & ~x24)));
  assign new_n50_ = ~x07 & (~x04 | ~x05);
  assign new_n51_ = (x20 | (~x17 & ~x18 & ~x19)) & x21 & x22;
  assign z02 = ~new_n48_ & x16;
  assign z03 = ~x25 & ((~x23 & ~new_n51_ & x24) | (x22 & ~x24));
  ...
  assign z08 = (x24 & ((x21 & ~new_n61_ & x22) | x23 | x25)) | (x22 & x25);
  ...
  assign new_n65_ = (x22 | x24) & (~x04 | ~x05) & (x17 ^ x18);
  assign z12 = ~x07 & ~x15 & ~new_n48_ & new_n67_;
  assign new_n67_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = ~new_n48_ & ((~new_n69_ & x20) | ~new_n50_ | new_n70_ | x15);
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = ~new_n48_ & ((~new_n70_ & x21) | ~new_n50_ | new_n72_ | x15);
  assign new_n72_ = x17 & x18 & x19 & ~x20 & ~x21;
  assign z15 = new_n75_ | (~new_n72_ & x22) | (new_n69_ & new_n74_ & ~x22 & x24);
  assign new_n74_ = ~x20 & ~x21;
  assign new_n75_ = (x22 | x24) & ((x04 & x05) | x07 | x15);
  assign z16 = new_n75_ | (x23 & (new_n77_ | x22)) | (new_n70_ & new_n78_);
  assign new_n77_ = x24 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign new_n78_ = ~x21 & ~x22 & ~x23 & x24;
  assign z17 = new_n75_ | (x24 & (~new_n69_ | ~new_n74_ | x22 | x23));
