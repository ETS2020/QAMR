...
module FAU ( 
  ...
  assign z08 = ((x16 | x21) & (x25 | (x23 & x24))) | (new_n60_ & x21);
  ...
  assign z13 = ~new_n55_ & (~new_n68_ | (~new_n70_ & x20));
  ...
  assign new_n72_ = ~new_n55_ & (x07 | x15 | (x04 & x05));
  assign new_n73_ = (~x21 | (x17 & x18 & x19 & ~x20)) & (~x16 | ~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = new_n72_ | (x21 & x22) | (~new_n75_ & x16);
  assign new_n75_ = (new_n69_ | ~x22) & (~new_n70_ | x20 | x21 | x22);
  assign z16 = new_n72_ | (x21 & x23) | (~new_n77_ & x16);
  assign new_n77_ = (new_n78_ | ~x23) & (~new_n70_ | x20 | x21 | x22 | x23);
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x22;
  assign z17 = new_n72_ | (x21 & x24) | (~new_n80_ & x16);
  assign new_n80_ = (new_n81_ | ~x24) & (~new_n69_ | x21 | x22 | x23 | x24);
  assign new_n81_ = x17 & x18 & x19 & ~x20 & ~x22 & ~x23;
  assign z18 = new_n72_ | new_n83_ | (x21 & x25);
  assign new_n83_ = x16 & ((x25 & (~new_n70_ | ~new_n84_)) | (new_n69_ & new_n85_));
  assign new_n84_ = ~x23 & ~x24 & ~x20 & ~x22;
