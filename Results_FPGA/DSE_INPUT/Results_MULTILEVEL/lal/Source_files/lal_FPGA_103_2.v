...
module FAU ( 
  ...
  assign z15 = x15 | (~x06 & (new_n75_ | new_n51_ | new_n74_ | x07));
  ...
  assign z17 = x15 | (~x06 & (new_n79_ | new_n51_ | new_n80_ | x07));
  assign new_n79_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x06 & (~new_n82_ | new_n51_ | (~new_n80_ & x25)));
