...
module FAU ( 
  ...
  assign z08 = (x24 & ~x25 & (x23 | (x21 & ~new_n51_ & x22))) | (~x21 & x25);
  ...
  assign z14 = ~new_n72_ | (~new_n48_ & ~new_n71_);
  assign new_n71_ = (~x04 | ~x05) & ~x07 & ~x15;
  assign new_n72_ = (~x21 | x25 | (x17 & x18 & x19 & ~x20)) & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = (~new_n71_ & (~x21 | (~x22 & ~x25))) | (~new_n74_ & ~x21) | (x21 & x22 & ~x25);
  assign new_n74_ = (~x17 | ~x18 | ~x19 | x20 | x22) & (~x22 | (x17 & x18 & x19 & ~x20));
  assign z16 = (~new_n71_ & (~x21 | (~x23 & ~x25))) | (~new_n76_ & ~x21) | (x21 & x23 & ~x25);
  assign new_n76_ = (~x23 | (x17 & x18 & x19 & ~x20 & ~x22)) & (~x17 | ~x18 | ~x19 | x20 | x22 | x23);
  assign z17 = (~new_n71_ & (~x21 | (~x24 & ~x25))) | (~new_n78_ & ~x21) | (x21 & x24 & ~x25);
  assign new_n78_ = (~x24 | (new_n69_ & ~x20 & ~x22 & ~x23)) & (~new_n69_ | x20 | x22 | x23 | x24);
  assign z18 = (~new_n71_ & (~x21 | ~x25)) | (~x21 & (new_n80_ | (x25 & (~new_n69_ | ~new_n81_))));
  assign new_n80_ = new_n68_ & ~x22 & ~x23 & ~x24 & ~x25;
