...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n48_, new_n51_, new_n54_, new_n55_, new_n63_, new_n65_, new_n67_,
  ...
  assign z08 = (x21 & (x25 | (x22 & ~new_n51_ & x24))) | (x23 & x24 & ~x25);
  assign z09 = x04 & x05 & ~x07 & ~new_n48_ & ~x15;
  assign z10 = ~x07 & ~x15 & ~x17 & ~new_n48_ & (~x04 | ~x05);
  assign z11 = ~x07 & new_n63_ & ~x15;
  assign new_n63_ = ~new_n48_ & (~x04 | ~x05) & (x17 ^ x18);
  assign z12 = ~x07 & ~new_n48_ & new_n65_ & ~x15;
  assign new_n65_ = (~x04 | ~x05) & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = ~new_n48_ & (~new_n67_ | (~new_n69_ & x20));
  assign new_n67_ = ~new_n68_ & ~x15 & ~x07 & (~x04 | ~x05);
  assign new_n68_ = x17 & x18 & x19 & ~x20;
  assign new_n69_ = x17 & x18 & x19;
  assign z14 = new_n71_ | (~new_n68_ & x21) | (new_n69_ & ~x20 & ~x21 & ~x25);
  assign new_n71_ = ~new_n48_ & ((x04 & x05) | x07 | x15);
  assign z15 = new_n71_ | ~new_n73_;
  assign new_n73_ = (~x22 | (~x21 & (new_n68_ | x25))) & (~new_n69_ | x22 | x25 | x20 | x21);
  assign z16 = new_n71_ | ~new_n75_;
  assign new_n75_ = (~new_n68_ | x23 | x25 | x21 | x22) & (~x23 | (~x21 & (new_n76_ | x25)));
  assign new_n76_ = x17 & x18 & x19 & ~x20 & ~x22;
  assign z17 = new_n71_ | new_n79_ | (x24 & (x21 | (~new_n78_ & ~x25)));
  assign new_n78_ = new_n69_ & ~x20 & ~x22 & ~x23;
  assign new_n79_ = new_n68_ & ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z18 = x25 ? x21 : (~new_n81_ | x07 | (x04 & x05));
  assign new_n81_ = ~x15 & (~new_n68_ | x23 | x24 | x21 | x22);
endmodule
