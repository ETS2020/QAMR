...
module FAU ( 
  ...
  assign z03 = x12 & ~x25 & ((~new_n51_ & ~x23) | ~x24);
  ...
  assign z08 = x25 | (x12 & (new_n60_ | x23) & x24);
  ...
  assign new_n80_ = (~x25 | (new_n69_ & new_n74_ & ~x23 & ~x24)) & (~new_n81_ | ~new_n74_ | x23 | x24 | x25);
  assign new_n81_ = x12 & x17 & x18 & x19 & ~x20;
endmodule
