...
module FAU ( 
  ...
  assign z08 = (~x14 | x15) & (x25 | (x24 & (new_n61_ | x23)));
  assign new_n61_ = x21 & x22 & (x20 | (~x17 & ~x18 & ~x19));
  assign z09 = ~x15 & ~x14 & new_n51_ & ~x07;
  assign z10 = ~x07 & ~x14 & ~x15 & ~new_n51_ & ~x17;
  assign z11 = ~x07 & ~x14 & ~x15 & ~new_n51_ & (x17 ^ x18);
  assign z12 = ~x07 & new_n66_ & ~x14;
  assign new_n66_ = ~x15 & ~new_n51_ & ((x19 & (~x17 | ~x18)) | (x17 & x18 & ~x19));
  assign z13 = x15 | (~new_n68_ & ~x14);
  assign new_n68_ = (new_n69_ | ~x20) & ~new_n51_ & ~new_n70_ & ~x07;
  assign new_n69_ = x17 & x18 & x19;
  assign new_n70_ = x17 & x18 & x19 & ~x20;
  assign z14 = x15 | (~x14 & (new_n51_ | ~new_n72_ | (~new_n70_ & x21)));
  assign new_n72_ = ~x07 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z15 = x15 | (~x14 & (new_n75_ | new_n51_ | new_n74_ | x07));
  assign new_n74_ = new_n69_ & ~x20 & ~x21 & ~x22;
  assign new_n75_ = x22 & (~x17 | ~x18 | ~x19 | x20 | x21);
  assign z16 = x15 | (~x14 & (~new_n77_ | new_n51_ | (~new_n74_ & x23)));
  assign new_n77_ = ~x07 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign z17 = x15 | (~x14 & (new_n79_ | new_n51_ | new_n80_ | x07));
  assign new_n79_ = x24 & (~new_n69_ | x20 | x21 | x22 | x23);
  assign new_n80_ = new_n70_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 | (~x14 & (~new_n82_ | new_n51_ | (~new_n80_ & x25)));
