...
module FAU ( 
  ...
  assign z01 = (x06 | ~x15) & ((~new_n49_ & ~x25) | new_n51_ | x07);
  ...
  assign z08 = (x06 | ~x15) & (x25 | (x24 & (new_n61_ | x23)));
  ...
  assign z17 = x15 ? x06 : (new_n78_ | new_n51_ | new_n79_ | x07);
  assign new_n78_ = x24 & (~new_n68_ | x20 | x21 | x22 | x23);
  assign new_n79_ = new_n69_ & ~x21 & ~x22 & ~x23 & ~x24;
  assign z18 = x15 ? x06 : ((~new_n79_ & x25) | ~new_n81_ | new_n51_);
