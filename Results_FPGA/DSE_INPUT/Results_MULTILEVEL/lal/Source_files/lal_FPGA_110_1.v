...
module FAU ( 
  ...
  assign z08 = (x21 & (x25 | (x24 & (x23 | (~new_n51_ & x22))))) | (~x23 & x25);
  ...
  assign z14 = new_n71_ | (~new_n68_ & x21) | (new_n69_ & ~x20 & ~x21 & ~x23);
  assign new_n71_ = ~new_n48_ & ((x04 & x05) | x07 | x15);
  assign z15 = new_n71_ | ~new_n73_;
  assign new_n73_ = (~x22 | (~x21 & (new_n68_ | x23))) & (~new_n69_ | x22 | x23 | x20 | x21);
  assign z16 = x23 ? x21 : (~new_n75_ | x07 | (x04 & x05));
  assign new_n75_ = ~x15 & (~new_n69_ | x20 | x21 | x22);
  assign z17 = new_n71_ | (~new_n77_ & ~x23) | (x21 & x24);
  assign new_n77_ = (~new_n69_ | x22 | x24 | x20 | x21) & (new_n78_ | ~x24);
  assign new_n78_ = x17 & x18 & x19 & ~x20 & ~x22;
  assign z18 = new_n71_ | (~new_n80_ & ~x23) | (x21 & x25);
  assign new_n80_ = (~new_n68_ | x24 | x25 | x21 | x22) & (new_n81_ | ~x25);
