...
module FAU ( 
  ...
  assign z08 = (~x20 & (x25 | (x23 & x24))) | (~x23 & (x25 | (new_n61_ & x21)));
  ...
  assign z13 = (~new_n69_ & (~x20 | ~x23)) | new_n71_ | (x20 & ~new_n70_ & ~x23);
  assign new_n69_ = (~x04 | ~x05) & ~x07 & ~x15;
  assign new_n70_ = x17 & x18 & x19;
  assign new_n71_ = x17 & x18 & x19 & ~x20;
  assign z14 = (~new_n69_ & (~x20 | (~x21 & ~x23))) | (~new_n73_ & ~x20) | (x20 & x21 & ~x23);
  assign new_n73_ = (~x17 | ~x18 | ~x19 | x21) & (~x21 | (x17 & x18 & x19));
  assign z15 = (~new_n69_ & (~x20 | (~x22 & ~x23))) | (~new_n75_ & ~x20) | (x20 & x22 & ~x23);
  assign new_n75_ = (~x22 | (x17 & x18 & x19 & ~x21)) & (~x17 | ~x18 | ~x19 | x21 | x22);
  assign z16 = (~new_n69_ & (~x20 | ~x23)) | (~new_n77_ & ~x20);
  assign new_n77_ = (~x23 | (x17 & x18 & x19 & ~x21 & ~x22)) & (~x17 | ~x18 | ~x19 | x21 | x22 | x23);
  assign z17 = ~new_n79_ | (~new_n69_ & (~x20 | (~x23 & ~x24)));
  assign new_n79_ = (x23 | ((~x20 | ~x24) & (~new_n70_ | x20 | x21 | x22 | x24))) & (x20 | ~x24 | (new_n70_ & ~x21 & ~x22 & ~x23));
  assign z18 = (~new_n69_ & (~x20 | (~x23 & ~x25))) | (~new_n81_ & ~x23) | (~x20 & ~new_n82_ & x25);
  assign new_n81_ = (~x20 | ~x25) & (~new_n71_ | x21 | x22 | x24 | x25);
  assign new_n82_ = new_n70_ & ~x23 & ~x24 & ~x21 & ~x22;
endmodule
