...
module FAU ( 
  ...
  assign z01 = x07 | (~x19 & (new_n50_ | (~x25 & (new_n49_ | ~x24))));
  ...
  assign z04 = ~x08 & (~new_n56_ | ~new_n57_) & (x07 | ~x19);
  ...
  assign z08 = (~new_n62_ & (x07 | ~x19)) | (new_n63_ & ~x17 & ~x18 & ~x19);
  ...
  assign z12 = ~x07 & ~x15 & x17 & x18 & ~new_n50_ & ~x19;
  assign z13 = x07 | (~x19 & (new_n50_ | x15 | x20));
  assign z14 = x07 | (~x19 & (new_n50_ | x15 | x21));
  assign z15 = x07 | (~x19 & (new_n50_ | x15 | x22));
  assign z16 = x07 | (~x19 & (new_n50_ | x15 | x23));
  assign z17 = x07 | (~x19 & (new_n50_ | x15 | x24));
  assign z18 = x07 | (~x19 & (new_n50_ | x15 | x25));
endmodule
