...
module FAU ( 
  ...
  assign new_n51_ = x18 & ~x23 & ~x25 & (~x20 | ~x21 | ~x22);
  assign z02 = ~new_n48_ & x16;
  assign z03 = ~new_n54_ & ~x25;
  assign new_n54_ = (x24 | (~x18 & ~x23)) & (~x18 | x23 | (x20 & x21 & x22));
  ...
  assign z14 = (~new_n69_ & (x18 | (~x21 & x23))) | (~x18 & x21 & x23) | (~new_n71_ & x18);
  assign new_n71_ = (~x21 | (x17 & x19 & ~x20)) & (~x17 | ~x19 | x20 | x21);
  assign z15 = (~new_n69_ & (x18 | (~x22 & x23))) | (~x18 & x22 & x23) | (~new_n73_ & x18);
  assign new_n73_ = (~x22 | (x17 & x19 & ~x20 & ~x21)) & (~x17 | ~x19 | x20 | x21 | x22);
  assign z16 = ~new_n75_ | (~new_n69_ & ~new_n48_);
  assign new_n75_ = (~x23 | (new_n76_ & ~x20 & ~x21 & ~x22)) & (~new_n76_ | x20 | x21 | x22 | x23);
  assign new_n76_ = x17 & x18 & x19;
  assign z17 = (~new_n69_ & (x18 | x23)) | (x23 & x24) | (~new_n78_ & x18);
  assign new_n78_ = (~x24 | (x17 & x19 & new_n79_ & ~x20)) & (~x17 | ~x19 | x20 | ~new_n79_ | x23 | x24);
  assign new_n79_ = ~x21 & ~x22;
  assign z18 = (~new_n69_ & (x18 | x23)) | (x23 & x25) | (~new_n81_ & x18);
  assign new_n81_ = (new_n83_ | ~x25) & (~new_n82_ | x24 | x25 | x22 | x23);
  assign new_n82_ = x17 & x19 & ~x20 & ~x21;
  assign new_n83_ = x17 & x19 & ~x20 & ~x21 & ~x22 & ~x24;
endmodule
