...
module FAU ( 
  ...
  assign z12 = x12 & ~x17 & (((~new_n47_ | ~x08) & x13) | (new_n47_ & x00 & x08));
  assign z13 = new_n58_ & x12;
  assign new_n58_ = ~x17 & ((x14 & (~x01 | ~x08 | ~x10)) | (x08 & x10 & x15));
  assign z14 = x12 & ~x17 & (((~x08 | ~x10) & x15) | (x02 & x08 & x10 & ~x15));
  assign z15 = x12 & ~new_n61_ & ~x17;
  assign new_n61_ = (~x03 | ~x08 | ~x10 | x15) & (x14 | ~x16 | (x08 & x10 & ~x15));
  assign z16 = ~x17 & ~x15 & x12 & x10 & x04 & x08;
  assign z17 = x12 & ~x17 & ((new_n47_ & x05 & x08) | ((~new_n47_ | ~x08) & x18));
  assign z18 = x12 & ~x17 & ((new_n47_ & x06 & x08) | ((~new_n47_ | ~x08) & x19));
  assign z19 = x12 & ~x17 & ((new_n47_ & x07 & x08) | ((~new_n47_ | ~x08) & x20));
endmodule
