...
module FAU ( 
  ...
  assign z00 = x20 & x07 & x11;
  assign z01 = x08 & x10 & ~x14 & ~new_n45_ & x15;
  assign new_n45_ = ~x07 & x20;
  assign z02 = ~x11 & new_n47_ & x12;
  assign new_n47_ = (x07 | ~x20) & (x14 | (x08 & x10 & ~x15));
  ...
  assign z13 = x12 & ~new_n45_ & ~new_n60_;
  assign new_n60_ = (~x14 | (x01 & x08 & x10)) & (~x08 | ~x10 | ~x15);
  assign z14 = x12 & ~new_n45_ & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15));
  assign z15 = x12 & ~new_n45_ & ~new_n63_;
  ...
  assign z18 = x12 & ~new_n45_ & ((x19 & (~new_n58_ | ~x08)) | (new_n58_ & x06 & x08));
  assign z19 = x07 & x12 & (x20 | (new_n58_ & x08));
endmodule
