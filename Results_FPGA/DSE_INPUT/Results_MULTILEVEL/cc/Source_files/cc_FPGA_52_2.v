...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n59_;
  assign z00 = x11 & x20 & (~x06 | x12);
  assign z01 = x08 & x10 & z06 & ~x14;
  assign z06 = x15 & (~x06 | x12);
  assign z02 = ~x11 & x12 & (x14 | (x08 & x10 & ~x15));
  assign z03 = x15 & ~x14 & x12 & x08 & x10;
  assign z04 = ~x18 & (~x06 | x12);
  assign z05 = x19 & (~x06 | x12);
  assign z07 = x17 & (~x06 | x12);
  assign z08 = x16 & (~x06 | x12);
  assign z09 = x08 & x09 & (~x06 | x12);
  assign z10 = (~x06 | x12) & (~x08 | ~x09);
  assign z11 = x14 & (~x06 | x12);
  ...
  assign z18 = x12 & ((x19 & (~x08 | ~x10 | x15)) | (x06 & (x19 | (x08 & x10 & ~x15))));
