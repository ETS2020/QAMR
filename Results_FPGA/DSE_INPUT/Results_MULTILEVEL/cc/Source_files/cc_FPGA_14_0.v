...
module FAU ( 
  ...
  assign new_n56_ = (~x13 | ~x15) & (~x04 | ((~x13 | (x08 & x10)) & (~x10 | x15 | ~x00 | ~x08)));
  assign z13 = ~new_n58_ & x12;
  assign new_n58_ = (~x15 | (~x14 & (~x08 | ~x10))) & (~x04 | ~x14 | (x01 & x08 & x10));
  assign z14 = x12 & ((x15 & (~x08 | ~x10)) | (x02 & x04 & x08 & x10 & ~x15));
  assign z15 = x12 & ((~new_n61_ & x04) | (~x14 & x15 & x16));
  assign new_n61_ = (x14 | ~x16 | (x08 & x10)) & (~x03 | ~x08 | ~x10 | x15);
  assign z16 = x12 & ((x15 & x17) | (x04 & (x17 | (x08 & x10 & ~x15))));
  assign z17 = ~new_n64_ & x12;
  assign new_n64_ = (~x15 | ~x18) & (~x04 | ((~x18 | (x08 & x10)) & (~x05 | ~x08 | ~x10 | x15)));
  assign z18 = ~new_n66_ & x12;
  assign new_n66_ = (~x15 | ~x19) & (~x04 | ((~x19 | (x08 & x10)) & (~x06 | ~x08 | ~x10 | x15)));
  assign z19 = ~new_n68_ & x12;
  assign new_n68_ = (~x15 | ~x20) & (~x04 | ((~x20 | (x08 & x10)) & (~x07 | ~x08 | ~x10 | x15)));
  assign z06 = x15;
endmodule
