...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n44_, new_n47_, new_n56_, new_n58_, new_n61_, new_n64_;
  ...
  assign z12 = x12 & ~new_n44_ & ((x13 & (~new_n56_ | ~x08)) | (new_n56_ & x00 & x08));
  assign new_n56_ = x10 & ~x15;
  assign z13 = x12 & ~new_n44_ & ~new_n58_;
  assign new_n58_ = (~x14 | (x01 & x08 & x10)) & (~x08 | ~x10 | ~x15);
  assign z14 = x12 & ~new_n44_ & ((x15 & (~x08 | ~x10)) | (x02 & x08 & x10 & ~x15));
  assign z15 = x12 & (new_n61_ | (~x14 & ~new_n47_ & x16));
  assign new_n61_ = x03 & x08 & x10 & ~x15 & (x16 | ~x18);
  assign z16 = x12 & ~new_n44_ & ((x17 & (~new_n56_ | ~x08)) | (new_n56_ & x04 & x08));
  assign z17 = ~new_n64_ & x12;
  assign new_n64_ = (~x05 | ((~x16 | ~x18) & (~x08 | ~x10 | x15 | x18))) & (~x16 | ~x18 | (x08 & x10 & ~x15));
  assign z18 = x12 & ~new_n44_ & ((x19 & (~new_n56_ | ~x08)) | (new_n56_ & x06 & x08));
