...
module FAU ( 
  ...
  assign z13 = x12 & ((x15 & (new_n45_ | x14)) | (x14 & (~new_n45_ | ~x01) & x20));
  ...
  assign z18 = x12 & ((~new_n56_ & x19) | (new_n57_ & x06 & x08));
  assign z19 = x12 & x20 & (x07 | ~x08 | ~x10 | x15);
  assign z06 = x15;
endmodule
