// Benchmark "FAU" written by ABC on Sat Aug  8 21:52:07 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n39_, new_n42_, new_n46_, new_n47_;
  assign z00 = x12 | (~x08 & (x01 | x11));
  assign z01 = (~x08 & (x11 | ~x12)) | (x11 & x12);
  assign z02 = (~x08 & (x11 | ~x12)) | (x12 & (~x11 | (x11 & (~new_n34_ | ~x07 | ~x09))));
  assign new_n34_ = x05 & x06;
  assign z03 = x12 ? ((new_n34_ & x07 & x08) | ~x09 | ~x11) : ~x08;
  assign z04 = ~x14 & (~x08 | x12);
  assign z05 = ~x13 & (~x08 | x12);
  assign z06 = x01 & x09 & ((~x11 & x12) | (~new_n39_ & (~x08 | x12)));
  ...
  assign z11 = x00 & ~x10 & x11 & (x01 ? new_n47_ : new_n46_);
