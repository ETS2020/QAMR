...
module FAU ( 
  ...
  assign z02 = (x06 & (~x11 | ~x12)) | (x11 & (~new_n34_ | ~x05 | ~x06 | ~x07));
  assign new_n34_ = x08 & x09 & x12;
  assign z03 = (x06 & (new_n36_ | ~x11)) | (x11 & (~x09 | ~x12));
  assign new_n36_ = x05 & x07 & x08;
  assign z04 = ~x14 & (x06 | x11);
  assign z05 = ~x13 & (x06 | x11);
  assign z06 = x01 & x09 & ((~new_n40_ & (x06 | x11)) | (x06 & ~x11 & x12));
  assign new_n40_ = x02 & x03 & x04;
  assign z07 = ~x15 & (x06 | x11);
  assign z08 = x11 ? (~new_n43_ | ~x00) : x06;
