// Benchmark "FAU" written by ABC on Sat Aug  8 21:52:13 2020
...
module FAU ( 
  ...
  assign new_n40_ = ((x12 & ~x14) | (x02 & x03 & x04)) & (x11 | ~x12 | ~x14);
  assign z07 = ~x15 & (~x12 | x14);
  assign z08 = new_n43_ | ((~x12 | x14) & (~x00 | x10 | ~x11));
  ...
  assign new_n48_ = x09 & x12 & x14 & (~x02 | ~x03 | ~x04);
