// Benchmark "FAU" written by ABC on Sat Aug  8 21:52:47 2020
...
module FAU ( 
  ...
  assign new_n40_ = x09 & (x03 ? (~x02 | ~x04 | (~x11 & x12)) : ~x12);
  ...
  assign z10 = x00 & new_n46_ & x03;
  assign new_n46_ = x09 & ~x10 & x11 & (~x02 | ~x04) & x12;
  assign z11 = x00 & ~x10 & ~new_n48_ & x11;
  assign new_n48_ = x01 ? (~x03 | ~x09 | (x02 & x04) | ~x12) : x12;
