...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & (x12 ? (x14 & (x11 ^ x13)) : x13);
  ...
  assign new_n42_ = ~x10 & ((x14 & ((x15 & (~x11 | ~x13)) | (x11 & x12 & x13 & ~x15))) | (~x12 & x15));
  ...
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & x14) | (~x12 & x17));
  assign new_n47_ = (~x17 | (x15 & x16 & x11 & x13)) & (~x11 | ~x12 | ~x13 | ~x15 | ~x16 | x17);
