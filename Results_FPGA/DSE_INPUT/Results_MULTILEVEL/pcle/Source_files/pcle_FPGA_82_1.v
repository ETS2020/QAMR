...
module FAU ( 
  ...
  assign new_n43_ = (new_n46_ | ~x16) & (~new_n44_ | ~new_n45_ | x16 | x17);
  assign new_n44_ = x11 & x12 & x13;
  assign new_n45_ = x14 & x15;
  assign new_n46_ = x11 & x12 & x13 & x14 & x15;
  assign z7 = (x06 & ~new_n33_ & x08) | (~x08 & x09 & new_n48_ & ~x10);
  assign new_n48_ = x16 & ((~new_n46_ & x17) | (new_n44_ & x14 & x15 & ~x17));
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n50_ & ~x10);
  assign new_n50_ = (x17 | ~x18) & (~x16 | ((new_n46_ | ~x18) & (~new_n44_ | ~new_n45_ | ~x17 | x18)));
endmodule
