...
module FAU ( 
  ...
  assign z1 = (x00 & x08 & (x05 | ~x10)) | (~x08 & x09 & ~x10 & ~x11);
  assign z2 = (x01 & x08 & (x05 | ~x10)) | (~x08 & x09 & ~new_n34_ & ~x10);
  assign new_n34_ = ~x11 ^ x12;
  assign z3 = (x02 & x08 & (x05 | ~x10)) | (~x08 & x09 & ~new_n36_ & ~x10);
  assign new_n36_ = x11 ? (~x12 ^ x13) : ~x13;
  assign z4 = (x03 & x08 & (x05 | ~x10)) | (~x08 & x09 & ~new_n38_ & ~x10);
  assign new_n38_ = (~x14 | (x11 & x12 & x13)) & (~x11 | ~x12 | ~x13 | x14);
  assign z5 = (x04 & x08 & (x05 | ~x10)) | (~x08 & x09 & ~new_n40_ & ~x10);
  ...
  assign z7 = (~x08 & x09 & ~new_n44_ & ~x10) | (x06 & x08 & (x05 | ~x10));
  assign new_n44_ = (~x17 | (new_n45_ & x14 & x15 & x16)) & (~new_n45_ | ~x14 | ~x15 | ~x16 | x17);
  assign new_n45_ = x11 & x12 & x13;
  assign z8 = (~x08 & x09 & ~new_n47_ & ~x10) | (x07 & x08 & (x05 | ~x10));
