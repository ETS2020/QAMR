...
module FAU ( 
  ...
  assign z1 = (x00 & x08 & (~x07 | x09)) | (~x08 & x09 & ~x10 & ~x11);
  assign z2 = (x01 & x08 & (~x07 | x09)) | (~x08 & new_n34_ & x09);
  assign new_n34_ = ~x10 & (x11 ^ x12);
  assign z3 = (x02 & x08 & (~x07 | x09)) | (~x08 & new_n36_ & x09);
  assign new_n36_ = ~x10 & (x11 ? (x12 ^ x13) : x13);
  assign z4 = (x03 & x08 & (~x07 | x09)) | (~x08 & new_n38_ & x09);
  assign new_n38_ = ~x10 & ((x14 & (~x11 | ~x12 | ~x13)) | (x11 & x12 & x13 & ~x14));
  assign z5 = (x04 & x08 & (~x07 | x09)) | (~x08 & new_n40_ & x09);
  assign new_n40_ = ~x10 & (x14 ? ((x15 & (~x11 | ~x12 | ~x13)) | (x11 & x12 & x13 & ~x15)) : x15);
  assign z6 = (x05 & x08 & (~x07 | x09)) | (~x08 & x09 & ~new_n42_ & ~x10);
  assign new_n42_ = (~x16 | (x11 & x12 & x13 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (~x08 & new_n44_ & x09) | (x06 & x08 & (~x07 | (x07 & x09)));
  assign new_n44_ = ~x10 & ((x17 & (~new_n45_ | ~x14 | ~x15 | ~x16)) | (new_n45_ & x14 & x15 & x16 & ~x17));
  assign new_n45_ = x11 & x12 & x13;
  assign z8 = x09 & (x08 ? x07 : (~new_n47_ & ~x10));
