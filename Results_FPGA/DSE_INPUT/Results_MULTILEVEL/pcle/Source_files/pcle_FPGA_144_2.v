...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & (x12 ? (x16 & (x11 ^ x13)) : x13);
  ...
  assign new_n41_ = (~x15 | (x12 & (~x16 | (x14 & (~x14 | (x11 & x13)))))) & (~x14 | x15 | ~x16 | ~x11 | ~x12 | ~x13);
  ...
  assign new_n46_ = (~x17 | (x14 & x15 & x11 & x13)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x17);
  ...
  assign new_n50_ = x18 & (~x11 | ~x13 | ~x14 | ~x15 | ~x17);
