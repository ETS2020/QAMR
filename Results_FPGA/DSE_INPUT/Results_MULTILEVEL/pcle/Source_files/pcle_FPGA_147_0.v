// Benchmark "FAU" written by ABC on Thu Aug  6 15:05:07 2020
...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & (x12 ? (x11 ^ x13) : (x13 & x18));
  ...
  assign new_n42_ = x14 & (x12 ? ((x15 & (~x11 | ~x13)) | (x11 & x13 & ~x15)) : (x15 & x18));
  assign z6 = (x05 & ~new_n33_ & x08) | (new_n44_ & ~x08);
  assign new_n44_ = x09 & ~x10 & (x12 ? ~new_n45_ : (x16 & x18));
  assign new_n45_ = (~x16 | (x11 & x13 & x14 & x15)) & (~x11 | ~x13 | ~x14 | ~x15 | x16);
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n47_ & ~x08);
  assign new_n47_ = x09 & ~x10 & (x12 ? ~new_n48_ : (x17 & x18));
  assign new_n48_ = (~x17 | (x11 & x13 & x14 & x15 & x16)) & (~x11 | ~x13 | ~x14 | ~x15 | ~x16 | x17);
