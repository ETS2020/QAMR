...
module FAU ( 
  ...
  assign new_n42_ = x14 & (x13 ? ((x15 & (~x11 | ~x12)) | (x11 & x12 & ~x15)) : (x15 & ~x16));
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & new_n44_ & ~x10);
  assign new_n44_ = x13 & ((x16 & (~x11 | ~x12 | ~x14 | ~x15)) | (x11 & x12 & x14 & x15 & ~x16));
  assign z7 = (x06 & ~new_n33_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & ((~x16 & x17) | (~new_n47_ & x13));
  assign new_n47_ = (~x17 | (x11 & x12 & x14 & x15)) & (~x15 | ~x16 | x17 | ~x11 | ~x12 | ~x14);
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (x16 | ~x18) & (~x13 | ((new_n51_ | ~x18) & (~new_n50_ | ~new_n52_)));
  assign new_n50_ = x11 & x12 & x14;
  assign new_n51_ = x11 & x12 & x14 & x15 & x17;
