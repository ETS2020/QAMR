...
module FAU ( 
  ...
  assign new_n35_ = x09 & ~x10 & (~x13 | (x13 & x17)) & (x11 ^ x12);
  assign z3 = (x02 & ~new_n33_ & x08) | (new_n37_ & ~x08);
  assign new_n37_ = x09 & ~x10 & (x11 ? (x12 ? ~x13 : (x13 & x17)) : (x13 & x17));
  assign z4 = (x03 & ~new_n33_ & x08) | (~x08 & new_n39_ & x09);
  assign new_n39_ = ~x10 & ((x14 & (~x13 | (x17 & (~x11 | ~x12)))) | (x11 & x12 & x13 & ~x14 & x17));
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n41_ & ~x10);
  assign new_n41_ = (~x15 | (x13 & (~x17 | (x14 & (~x14 | (x11 & x12)))))) & (~x14 | x15 | ~x17 | ~x11 | ~x12 | ~x13);
  assign z6 = (x05 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n43_ & ~x10);
  assign new_n43_ = (~x16 | (x13 & (~x17 | (new_n44_ & x11 & x12)))) & (~x11 | ~x12 | ~x13 | ~new_n44_ | x16 | ~x17);
  ...
  assign new_n50_ = x18 & (~x11 | ~x12 | ~x14 | ~x15 | ~x16);
