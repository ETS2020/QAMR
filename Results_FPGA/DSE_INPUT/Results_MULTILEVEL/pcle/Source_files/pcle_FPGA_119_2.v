// Benchmark "FAU" written by ABC on Thu Aug  6 15:05:00 2020
...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & (x11 ? (x14 & (x12 ^ x13)) : x13);
  ...
  assign new_n42_ = ~x10 & ((x14 & ((x15 & (~x12 | ~x13)) | (x11 & x12 & x13 & ~x15))) | (~x11 & x15));
  assign z6 = (x05 & ~new_n34_ & x08) | (~x08 & x09 & ~new_n44_ & ~x10);
  assign new_n44_ = (~x14 | ((~x16 | (x12 & x13 & x15)) & (~x11 | ~x12 | ~x13 | ~x15 | x16))) & (x11 | ~x16);
  assign z7 = (x06 & ~new_n34_ & x08) | (new_n46_ & ~x08);
  assign new_n46_ = x09 & ~x10 & ((~new_n47_ & x14) | (~x11 & x17));
  assign new_n47_ = (~x17 | (x12 & x13 & x15 & x16)) & (~x11 | ~x12 | ~x13 | ~x15 | ~x16 | x17);
  assign z8 = (x07 & ~new_n34_ & x08) | (~x08 & new_n49_ & x09);
  assign new_n49_ = ~x10 & (new_n52_ | (x14 & (new_n50_ | (new_n40_ & new_n51_))));
