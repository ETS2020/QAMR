...
module FAU ( 
  ...
  assign new_n37_ = x09 & ~x10 & (x12 ? (x18 & (x11 ^ x13)) : x13);
  assign z4 = (x03 & ~new_n33_ & x08) | (~x08 & new_n39_ & x09);
  assign new_n39_ = ~x10 & ((x14 & (~x12 | (x18 & (~x11 | ~x13)))) | (x11 & x12 & x13 & ~x14 & x18));
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n41_ & ~x10);
  assign new_n41_ = (~x15 | (x12 & (~x18 | (x14 & (~x14 | (x11 & x13)))))) & (~x14 | x15 | ~x18 | ~x11 | ~x12 | ~x13);
  ...
  assign new_n46_ = ~x10 & ((new_n48_ & new_n49_) | (x17 & (new_n47_ | ~x12)));
  assign new_n47_ = x18 & (~x11 | ~x13 | ~x14 | ~x15 | ~x16);
