// Benchmark "FAU" written by ABC on Thu Aug  6 15:05:19 2020
...
module FAU ( 
  ...
  assign new_n35_ = x09 & ~x10 & (~x13 | (x13 & x16)) & (x11 ^ x12);
  assign z3 = (x02 & ~new_n33_ & x08) | (new_n37_ & ~x08);
  assign new_n37_ = x09 & ~x10 & (x11 ? (x12 ? ~x13 : (x13 & x16)) : (x13 & x16));
  assign z4 = (x03 & ~new_n33_ & x08) | (~x08 & new_n39_ & x09);
  assign new_n39_ = ~x10 & ((x14 & (~x13 | (x16 & (~x11 | ~x12)))) | (x11 & x12 & x13 & ~x14 & x16));
  assign z5 = (x04 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n41_ & ~x10);
  assign new_n41_ = (~x15 | (x13 & (~x16 | (x14 & (~x14 | (x11 & x12)))))) & (~x14 | x15 | ~x16 | ~x11 | ~x12 | ~x13);
  ...
  assign new_n45_ = x09 & ~x10 & ((~new_n46_ & x16) | (~x13 & x17));
  assign new_n46_ = (~x17 | (x11 & x12 & x14 & x15)) & (~x11 | ~x12 | ~x13 | ~x14 | ~x15 | x17);
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & new_n48_ & x09);
  assign new_n48_ = ~x10 & (new_n52_ | (x16 & (new_n50_ | (new_n49_ & new_n51_))));
  assign new_n49_ = x11 & x12 & x13;
  assign new_n50_ = x18 & (~x11 | ~x12 | ~x14 | ~x15 | ~x17);
