...
module FAU ( 
  ...
  assign new_n43_ = (~x16 | new_n45_ | ~x17) & (~new_n44_ | ~x14 | ~x15 | x16);
  assign new_n44_ = x11 & x12 & x13;
  assign new_n45_ = x11 & x12 & x13 & x14 & x15;
  assign z7 = (x06 & ~new_n33_ & x08) | (~x08 & new_n47_ & x09);
  assign new_n47_ = ~x10 & x17 & (~new_n44_ | ~x14 | ~x15 | ~x16);
  assign z8 = (x07 & ~new_n33_ & x08) | (~x08 & x09 & ~new_n49_ & ~x10);
  assign new_n49_ = (~x17 | ((new_n45_ | ~x18) & (~new_n44_ | ~new_n50_ | ~x16 | x18))) & (x16 | ~x18);
