// Benchmark "FAU" written by ABC on Sat Aug  8 21:41:19 2020
...
module FAU ( 
  ...
  assign z02 = (~x01 & ((~x19 & ~x22) | (~x17 & x18 & x19 & ~x23))) | (~x18 & ((~x19 & ~x22) | (x01 & ~x17 & x19)));
  assign z03 = new_n60_ | (~x18 & ((~x19 & ~x23) | (x00 & ~x17 & x19)));
  assign new_n60_ = ~x01 & ((~x19 & ~x23) | (x16 & ~x17 & x18 & x19));
  ...
  assign new_n72_ = ~x01 & ((~x19 & ~x29) | (~x17 & x18 & x19 & ~x30));
  ...
  assign new_n82_ = ~x01 & ((~x19 & ~x34) | (~x17 & x18 & x19 & ~x35));
