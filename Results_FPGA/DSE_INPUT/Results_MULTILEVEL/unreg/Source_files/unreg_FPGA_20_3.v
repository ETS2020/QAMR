...
module FAU ( 
  ...
  assign z10 = (~x17 & ~new_n75_ & x19) | (~x19 & ~x30 & (~x31 | ~x35));
  assign new_n75_ = (~x09 | (x31 & (x18 | x35))) & (~x18 | x31);
  assign z11 = (~new_n77_ & ~x17) | (~x19 & ~x31);
  assign new_n77_ = (~x08 | x18 | (x31 & (~x19 | x35))) & (~x18 | ~x19 | x24 | (x31 & x35));
  ...
  assign z14 = (~x17 & ~new_n83_ & x19) | (~x19 & ~x34 & (~x31 | ~x35));
  assign new_n83_ = (~x13 | (x35 & (x18 | x31))) & (~x18 | x35);
  assign z15 = (~new_n85_ & ~x17) | (~x19 & ~x35);
  assign new_n85_ = (~x18 | ~x19 | x28 | (x31 & x35)) & (~x12 | x18 | (x35 & (~x19 | x31)));
endmodule
