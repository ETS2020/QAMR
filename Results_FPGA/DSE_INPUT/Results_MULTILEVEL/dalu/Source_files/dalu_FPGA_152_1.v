// Benchmark "FAU" written by ABC on Thu Aug  6 22:31:32 2020
...
module FAU ( 
  ...
  assign new_n106_ = (x11 | ~x69) & (x70 ? x32 : x00);
  assign new_n107_ = (~x11 | ~x69 | (x70 ? ~x00 : ~x48)) & (~x16 | x69 | ~x70);
  assign new_n108_ = ~x69 & ~x70 & ~x71;
  assign new_n109_ = (~x11 | x68 | new_n110_ | ~x69) & (~new_n108_ | ~x48 | ~x68);
  assign new_n110_ = (~x16 | (~x70 ^ x71)) & (~x48 | ~x70 | ~x71);
  assign new_n111_ = x11 & x65 & ~x68 & x69 & ~new_n112_ & ~new_n110_;
  ...
  assign new_n125_ = x11 & x65 & new_n126_ & ~x68;
  ...
  assign new_n133_ = ~new_n127_ & ((x11 & new_n134_ & ~x68) | (new_n108_ & x49 & x68));
  assign new_n134_ = ~new_n129_ & x69;
  assign new_n135_ = (x68 | (x71 ? ~new_n136_ : new_n137_)) & (~new_n108_ | ~x33 | ~x68);
  assign new_n136_ = (x11 | ~x69) & (x70 ? x33 : x01);
  ...
  assign new_n146_ = x11 & x65 & new_n147_ & ~x68;
  ...
  assign new_n152_ = (~new_n154_ | ~x67) & (~x11 | (x67 ? new_n153_ : ~new_n147_));
  ...
  assign new_n157_ = (x11 | ~x69) & (x70 ? x34 : x02);
  assign new_n158_ = (~x11 | ~x69 | (x70 ? ~x02 : ~x50)) & (~x18 | x69 | ~x70);
  assign z03 = x64 ? (~new_n174_ & ~x65) : (new_n160_ | (new_n179_ & x65));
  assign new_n160_ = ~new_n112_ & (new_n161_ | (x11 & new_n170_ & x65));
  ...
  assign new_n174_ = x66 ? (new_n176_ | x67) : (x67 ? new_n176_ : (~new_n175_ & (~new_n170_ | ~x11)));
  assign new_n175_ = x68 & new_n168_ & ~x69;
  assign new_n176_ = (x68 | (x71 ? ~new_n177_ : new_n178_)) & (~new_n108_ | ~x35 | ~x68);
  assign new_n177_ = (x11 | ~x69) & (x70 ? x35 : x03);
  assign new_n178_ = (~x11 | ~x69 | (x70 ? ~x03 : ~x51)) & (~x19 | x69 | ~x70);
  ...
  assign new_n182_ = (~x11 | x68 | ~x69 | (~new_n183_ & ~new_n187_)) & (~x68 | ~new_n190_ | x69);
  ...
  assign new_n196_ = (x11 | ~x69) & (x70 ? x36 : x04);
  assign new_n197_ = (~x11 | ~x69 | (x70 ? ~x04 : ~x52)) & (~x20 | x69 | ~x70);
  assign z05 = new_n199_ | new_n211_;
  assign new_n199_ = ~x64 & (((x66 | x67) & (x65 ? ~new_n200_ : new_n208_)) | (x65 & ~x66 & new_n208_ & ~x67));
  assign new_n200_ = (~x11 | x68 | ~x69 | (~new_n201_ & ~new_n204_)) & (~x68 | ~new_n207_ | x69);
  ...
  assign new_n213_ = (x11 | ~x69) & (x70 ? x37 : x05);
  assign new_n214_ = (~x11 | ~x69 | (x70 ? ~x05 : ~x53)) & (~x21 | x69 | ~x70);
  assign z06 = new_n216_ | new_n229_;
  assign new_n216_ = ~x64 & (((x66 | x67) & (x65 ? ~new_n217_ : new_n226_)) | (x65 & ~x66 & new_n226_ & ~x67));
  assign new_n217_ = (~x11 | x68 | ~x69 | (~new_n218_ & ~new_n221_)) & (~x68 | ~new_n225_ | x69);
  ...
  assign new_n231_ = (x11 | ~x69) & (x70 ? x38 : x06);
  assign new_n232_ = (~x11 | ~x69 | (x70 ? ~x06 : ~x54)) & (~x22 | x69 | ~x70);
  assign z07 = new_n234_ | new_n247_;
  assign new_n234_ = ~x64 & (((x66 | x67) & (x65 ? ~new_n235_ : new_n244_)) | (x65 & ~x66 & new_n244_ & ~x67));
  assign new_n235_ = (~x11 | x68 | ~x69 | (~new_n236_ & ~new_n239_)) & (~x68 | ~new_n243_ | x69);
  ...
  assign new_n249_ = (x11 | ~x69) & (x70 ? x39 : x07);
  assign new_n250_ = (~x11 | ~x69 | (x70 ? ~x07 : ~x55)) & (~x23 | x69 | ~x70);
  assign z08 = x64 ? (~new_n265_ & ~x65) : ((~new_n252_ & ~new_n112_) | (new_n263_ & x65));
  assign new_n252_ = (~x68 | new_n253_ | x69) & (~x11 | ~new_n259_ | ~x65);
  ...
  assign new_n265_ = x66 ? (new_n267_ | x67) : (x67 ? new_n267_ : (~new_n266_ & (~new_n259_ | ~x11)));
  assign new_n266_ = x68 & ~x69 & ~x70 & ~new_n256_ & ~x71;
  assign new_n267_ = (x68 | (x71 ? ~new_n268_ : new_n269_)) & (~new_n108_ | ~x40 | ~x68);
  assign new_n268_ = (x11 | ~x69) & (x70 ? x40 : x08);
  assign new_n269_ = (~x11 | ~x69 | (x70 ? ~x08 : ~x56)) & (~x24 | x69 | ~x70);
  assign z09 = x64 ? (~new_n285_ & ~x65) : ((~new_n271_ & ~new_n112_) | (new_n283_ & x65));
  assign new_n271_ = (~x68 | new_n272_ | x69) & (~x11 | ~new_n278_ | ~x65);
  ...
  assign new_n285_ = x66 ? (new_n287_ | x67) : (x67 ? new_n287_ : (~new_n286_ & (~new_n278_ | ~x11)));
  assign new_n286_ = x68 & new_n275_ & ~x69;
  assign new_n287_ = (x68 | (x71 ? ~new_n288_ : new_n289_)) & (~new_n108_ | ~x41 | ~x68);
  assign new_n288_ = (x11 | ~x69) & (x70 ? x41 : x09);
  assign new_n289_ = (~x11 | ~x69 | (x70 ? ~x09 : ~x57)) & (~x25 | x69 | ~x70);
  ...
  assign new_n298_ = x11 & x65 & ~x68 & x69 & ~new_n299_ & x71;
  ...
  assign new_n302_ = (~x11 | ~x65 | x68 | new_n303_ | ~x69) & (x65 | ~x68 | ~new_n305_ | x69);
  ...
  assign new_n307_ = x66 ? (new_n311_ | x67) : (x67 ? new_n311_ : (~new_n310_ & (~new_n308_ | ~x11)));
  ...
  assign new_n311_ = (x68 | (x71 ? ~new_n312_ : new_n313_)) & (~new_n108_ | ~x42 | ~x68);
  assign new_n312_ = (x11 | ~x69) & (x70 ? x42 : x10);
  assign new_n313_ = (~x11 | ~x69 | (x70 ? ~x10 : ~x58)) & (~x26 | x69 | ~x70);
  assign new_n314_ = ~x67 & x68 & ~x69 & (x70 ? new_n305_ : new_n293_);
  assign z11 = x64 ? (~x65 & (x66 ? new_n336_ : ~new_n329_)) : ~new_n316_;
  assign new_n316_ = ((~x66 & ~x67) | (x65 ? new_n317_ : ~new_n326_)) & (~x65 | x66 | ~new_n326_ | x67);
  assign new_n317_ = (~x11 | x68 | ~x69 | (~new_n318_ & ~new_n321_)) & (~x68 | ~new_n325_ | x69);
  assign new_n318_ = ~new_n184_ & (new_n319_ | new_n320_ | (~new_n127_ & x27));
  assign new_n319_ = x72 & ((~x73 & (x74 ? x22 : x23)) | (x19 & x73 & ~x74));
  ...
  assign new_n326_ = x68 & ~x69 & (x70 ? (~new_n328_ & ~x71) : (~new_n327_ & x71));
  assign new_n327_ = (~x11 | (~new_n119_ & x00)) & (~x00 | new_n119_ | x11);
  assign new_n328_ = (~x43 | (~new_n124_ & x32)) & (~x32 | new_n124_ | x43);
  assign new_n329_ = x68 ? ~new_n333_ : (~new_n335_ & (new_n330_ | ~x11));
  assign new_n330_ = (~new_n332_ | ~x67) & (~x69 | (~new_n318_ & (~new_n321_ | x67) & (new_n331_ | ~x67)));
  assign new_n331_ = x70 ? x71 : ~x59;
  assign new_n332_ = x71 & (x43 | ~x70);
  assign new_n333_ = ~x69 & ~x70 & ~x71 & (x67 ? x43 : ~new_n334_);
  assign new_n334_ = ~new_n322_ & ~new_n323_ & ~new_n324_;
  assign new_n335_ = x67 & ~x69 & x70 & (x71 ? x43 : x27);
  assign new_n336_ = ~x67 & ((~new_n337_ & ~x68) | (new_n108_ & x43 & x68));
  assign new_n337_ = new_n338_ & (~x71 | ((~x43 | x69 | ~x70) & (~x11 | (~x43 & x70))));
  assign new_n338_ = (~x11 | ~x69 | (x70 ? x71 : ~x59)) & (~x70 | x71 | ~x27 | x69);
  assign z12 = x64 ? (~x65 & (x66 ? new_n364_ : ~new_n356_)) : ~new_n340_;
  assign new_n340_ = ~new_n354_ & (new_n112_ | (x70 ? new_n350_ : new_n341_));
  assign new_n341_ = (~x68 | new_n342_ | x69) & (~x11 | ~x65 | x68 | ~new_n347_ | ~x69);
  ...
  assign new_n346_ = ~x72 & ((x59 & ~x73 & x74) | (x73 & (x74 ? x57 : x58)));
  assign new_n347_ = x71 & (new_n348_ | new_n349_ | (~new_n127_ & x28));
  assign new_n348_ = x72 & ((~x73 & (x74 ? x23 : x24)) | (x20 & x73 & ~x74));
  assign new_n349_ = ~x72 & ((x27 & ~x73 & x74) | (x73 & (x74 ? x25 : x26)));
  assign new_n350_ = (~x11 | ~x65 | x68 | new_n351_ | ~x69) & (x65 | ~x68 | ~new_n353_ | x69);
  ...
  assign new_n355_ = x70 ? ~new_n353_ : (new_n343_ | ~x71);
  assign new_n356_ = x67 ? new_n361_ : ((~new_n360_ | ~x68) & (~x11 | ~new_n357_ | x68));
  assign new_n357_ = x69 & (new_n359_ | (~new_n184_ & (~new_n358_ | (~new_n127_ & x28))));
  assign new_n358_ = ~new_n348_ & ~new_n349_;
  assign new_n359_ = x70 & x71 & (new_n344_ | new_n345_ | new_n346_);
  assign new_n360_ = ~x69 & ~x70 & ~x71 & (new_n344_ | new_n345_ | new_n346_);
  assign new_n361_ = (x68 | (x71 ? ~new_n362_ : new_n363_)) & (~new_n108_ | ~x44 | ~x68);
  assign new_n362_ = (x11 | ~x69) & (x70 ? x44 : x12);
  assign new_n363_ = (~x28 | x69 | ~x70) & (~x11 | ~x69 | (x70 ? ~x12 : ~x60));
  assign new_n364_ = ~new_n361_ & ~x67;
  assign z13 = x64 ? new_n382_ : (new_n390_ | (~new_n112_ & (new_n366_ | new_n377_)));
  assign new_n366_ = ~x70 & ((new_n367_ & x68) | (x11 & x65 & new_n373_ & ~x68));
  assign new_n367_ = ~x69 & (x65 ? (~x71 & (~new_n368_ | new_n372_)) : (~new_n371_ & x71));
  assign new_n368_ = ~new_n369_ & ~new_n370_;
  assign new_n369_ = x72 & ((~x73 & (x74 ? x56 : x57)) | (x53 & x73 & ~x74));
  assign new_n370_ = ~x72 & ((x60 & ~x73 & x74) | (x73 & (x74 ? x58 : x59)));
  assign new_n371_ = (~x00 | x13 | (~x14 & ~x15)) & (~x13 | (x00 & (x14 | x15)));
  assign new_n372_ = x61 & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n373_ = x69 & x71 & (~new_n374_ | (~new_n127_ & x29));
  ...
  assign new_n377_ = x70 & ((x11 & x65 & new_n378_ & ~x68) | (~x65 & new_n380_ & x68));
  assign new_n378_ = x69 & (new_n379_ | (~new_n374_ & ~x71) | (~new_n368_ & x71));
  assign new_n379_ = ~new_n127_ & (x71 ? x61 : x29);
  assign new_n380_ = ~x69 & ~new_n381_ & ~x71;
  assign new_n381_ = (~x32 | x45 | (~x46 & ~x47)) & (~x45 | (x32 & (x46 | x47)));
  assign new_n382_ = ~x65 & (x66 ? (~new_n387_ & ~x67) : (x67 ? ~new_n387_ : ~new_n383_));
  assign new_n383_ = (~x11 | x68 | ~x69 | (~new_n384_ & ~new_n385_)) & (~x68 | ~new_n386_ | x69);
  assign new_n384_ = ~new_n184_ & ((~new_n127_ & x29) | (~new_n375_ & x72) | (~new_n376_ & ~x72));
  assign new_n385_ = x70 & x71 & (new_n372_ | new_n369_ | new_n370_);
  assign new_n386_ = ~x70 & ~x71 & (new_n372_ | new_n369_ | new_n370_);
  assign new_n387_ = (x68 | (x71 ? ~new_n388_ : new_n389_)) & (~new_n108_ | ~x45 | ~x68);
  assign new_n388_ = (x11 | ~x69) & (x70 ? x45 : x13);
  assign new_n389_ = (~x29 | x69 | ~x70) & (~x11 | ~x69 | (x70 ? ~x13 : ~x61));
  assign new_n390_ = x65 & ~x66 & new_n391_ & ~x67;
  assign new_n391_ = x68 & ~x69 & (x70 ? (~new_n381_ & ~x71) : (~new_n371_ & x71));
  assign z14 = x64 ? (~new_n407_ & ~x65) : (new_n393_ | (new_n413_ & x65));
  assign new_n393_ = ~new_n112_ & (x70 ? ~new_n403_ : (new_n394_ | new_n399_));
  assign new_n394_ = x68 & ~x69 & (x65 ? (~new_n395_ & ~x71) : (~new_n398_ & x71));
  assign new_n395_ = ~new_n396_ & ~new_n397_ & (new_n127_ | ~x62);
  assign new_n396_ = x72 & ((~x73 & (x74 ? x57 : x58)) | (x54 & x73 & ~x74));
  assign new_n397_ = ~x72 & ((x61 & ~x73 & x74) | (x73 & (x74 ? x59 : x60)));
  assign new_n398_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n399_ = x11 & x65 & ~x68 & x69 & ~new_n400_ & x71;
  assign new_n400_ = ~new_n401_ & ~new_n402_ & (new_n127_ | ~x30);
  assign new_n401_ = x72 & ((~x73 & (x74 ? x25 : x26)) | (x22 & x73 & ~x74));
  assign new_n402_ = ~x72 & ((x29 & ~x73 & x74) | (x73 & (x74 ? x27 : x28)));
  assign new_n403_ = (~x11 | ~x65 | x68 | new_n404_ | ~x69) & (x65 | ~x68 | ~new_n406_ | x69);
  assign new_n404_ = ~new_n405_ & (~x71 | (~new_n396_ & ~new_n397_)) & (x71 | (~new_n401_ & ~new_n402_));
  assign new_n405_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & (x71 ? x62 : x30);
  assign new_n406_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n407_ = x66 ? (new_n410_ | x67) : (x67 ? new_n410_ : (~new_n409_ & (~new_n408_ | ~x11)));
  assign new_n408_ = ~x68 & x69 & ((~new_n400_ & (x70 ^ x71)) | (x70 & ~new_n395_ & x71));
  assign new_n409_ = x68 & ~x69 & ~x70 & ~new_n395_ & ~x71;
  assign new_n410_ = (x68 | (x71 ? ~new_n411_ : new_n412_)) & (~new_n108_ | ~x46 | ~x68);
  assign new_n411_ = (x11 | ~x69) & (x70 ? x46 : x14);
  assign new_n412_ = (~x30 | x69 | ~x70) & (~x11 | ~x69 | (x70 ? ~x14 : ~x62));
  assign new_n413_ = ~x66 & ~x67 & x68 & ~new_n414_ & ~x69;
  assign new_n414_ = x70 ? ~new_n406_ : (~x71 | ((~x00 | x14 | ~x15) & (~x14 | (x15 & (x00 | ~x15)))));
  assign z15 = x68 ? (~new_n428_ & ~x69) : ~new_n416_;
  assign new_n416_ = (~x64 | ~new_n426_ | x65) & (~x11 | (x64 ? (new_n417_ | x65) : (~new_n425_ | ~x65)));
  assign new_n417_ = x66 ? (new_n424_ | x67) : (x67 ? new_n424_ : (~x69 | (~new_n418_ & ~new_n421_)));
  assign new_n418_ = ~new_n184_ & (new_n419_ | new_n420_ | (~new_n127_ & x31));
  assign new_n419_ = x72 & ((~x73 & (x74 ? x26 : x27)) | (x23 & x73 & ~x74));
  assign new_n420_ = ~x72 & ((x30 & ~x73 & x74) | (x73 & (x74 ? x28 : x29)));
  assign new_n421_ = x70 & x71 & (new_n422_ | new_n423_ | (~new_n127_ & x63));
  assign new_n422_ = x72 & ((~x73 & (x74 ? x58 : x59)) | (x55 & x73 & ~x74));
  assign new_n423_ = ~x72 & ((x62 & ~x73 & x74) | (x73 & (x74 ? x60 : x61)));
  assign new_n424_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x47 | ~x70 | ~x71) & (x70 | x71 | ~x63 | ~x69);
  assign new_n425_ = x69 & ~new_n112_ & (new_n418_ | new_n421_);
  assign new_n426_ = ~x69 & ~new_n427_ & (~x66 ^ ~x67);
  assign new_n427_ = (~x70 | (x71 ? ~x47 : ~x31)) & (~x15 | x70 | ~x71);
  assign new_n428_ = x64 ? (~new_n431_ | x65) : ((new_n429_ | new_n112_) & (~new_n432_ | ~x65));
  assign new_n429_ = (x70 | ((~x65 | new_n430_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n430_ = ~new_n422_ & ~new_n423_ & (new_n127_ | ~x63);
  assign new_n431_ = ~x70 & ~x71 & ((x47 & (x66 ^ x67)) | (~x66 & ~new_n430_ & ~x67));
