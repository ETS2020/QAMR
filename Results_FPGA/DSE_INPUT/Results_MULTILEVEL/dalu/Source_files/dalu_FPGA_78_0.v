...
module FAU ( 
  ...
  assign z01 = x64 ? new_n133_ : ((new_n131_ & x31) | (~new_n116_ & ~new_n114_));
  ...
  assign z09 = x64 ? new_n317_ : ((new_n315_ & x31) | (~new_n302_ & ~new_n114_));
  ...
  assign new_n355_ = (new_n114_ | (x70 ? new_n366_ : new_n356_)) & (~new_n371_ | ~x31);
  ...
  assign new_n382_ = (new_n114_ | (x70 ? new_n393_ : new_n383_)) & (~new_n397_ | ~x31);
  ...
  assign new_n434_ = (new_n114_ | (x70 ? new_n444_ : new_n435_)) & (~new_n448_ | ~x31);
  ...
  assign z15 = (~new_n461_ & ~x68) | (x31 & x68 & ~new_n477_ & ~x69);
  assign new_n461_ = x64 ? (x65 | (~new_n475_ & (new_n462_ | ~x69))) : (~x65 | ~new_n472_ | ~x69);
  ...
  assign new_n472_ = ~new_n114_ & ((~new_n473_ & (x70 ^ x71)) | (x70 & ~new_n474_ & x71));
  assign new_n473_ = ~new_n464_ & ~new_n465_ & ~new_n466_;
  assign new_n474_ = ~new_n469_ & ~new_n470_ & ~new_n471_;
  assign new_n475_ = x31 & ~new_n157_ & ~new_n476_;
  assign new_n476_ = (~x15 | x70 | ~x71) & (~x70 | (x71 ? ~x47 : x69));
  assign new_n477_ = x64 ? (~new_n479_ | x65) : ((new_n478_ | new_n114_) & (~new_n480_ | ~x65));
  assign new_n478_ = (x70 | ((~x65 | new_n474_ | x71) & (~x15 | x65 | ~x71))) & (~x70 | x71 | ~x47 | x65);
