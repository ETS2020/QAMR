...
module FAU ( 
  ...
  assign new_n327_ = x70 & ((x31 & x65 & new_n328_ & ~x68) | (~x65 & new_n330_ & x68));
  ...
  assign new_n369_ = ~x70 & (new_n376_ | (new_n370_ & x68));
  ...
  assign new_n376_ = x31 & x65 & ~x68 & x69 & ~new_n377_ & x71;
  assign new_n377_ = ~new_n378_ & ~new_n379_ & (new_n127_ | ~x29);
  assign new_n378_ = x72 & ((~x73 & (x74 ? x24 : x25)) | (x21 & x73 & ~x74));
  assign new_n379_ = ~x72 & ((x28 & ~x73 & x74) | (x73 & (x74 ? x26 : x27)));
  assign new_n380_ = x70 & ((x31 & x65 & new_n381_ & ~x68) | (~x65 & new_n383_ & x68));
  assign new_n381_ = x69 & (new_n382_ | (~new_n371_ & x71) | (~x71 & (new_n378_ | new_n379_)));
  ...
  assign new_n387_ = ~new_n184_ & (new_n378_ | new_n379_ | (~new_n127_ & x29));
  ...
  assign z15 = x68 ? (~x69 & (new_n430_ | new_n436_)) : (new_n419_ | new_n438_);
  assign new_n419_ = x31 & (x64 ? (~x65 & (new_n420_ | ~new_n424_)) : (new_n429_ & x65));
  assign new_n420_ = ~new_n184_ & ((x15 & (x66 ^ x67)) | (~x66 & ~x67 & ~new_n421_ & x69));
  assign new_n421_ = ~new_n422_ & ~new_n423_ & (~x28 | ~x73 | ~x74) & (~x27 | x73 | x74);
  assign new_n422_ = x72 & ((x26 & x74) | (x73 & (x23 | x74)));
  assign new_n423_ = ~x72 & ((x29 & ~x74) | (~x73 & (x30 | ~x74)));
  assign new_n424_ = (new_n428_ | (~x66 ^ x67)) & (x66 | x67 | ~new_n425_ | ~x69);
  assign new_n425_ = x70 & ((~new_n127_ & x63) | (x71 & (new_n426_ | new_n427_)));
  assign new_n426_ = x72 & ((~x73 & (x74 ? x58 : x59)) | (x55 & x73 & ~x74));
  assign new_n427_ = ~x72 & ((x62 & ~x73 & x74) | (x73 & (x74 ? x60 : x61)));
  assign new_n428_ = (~x70 | (x71 ? ~x47 : x69)) & (x70 | x71 | ~x63 | ~x69);
  assign new_n429_ = x69 & ~new_n112_ & (new_n425_ | (~new_n421_ & ~new_n184_));
  assign new_n430_ = ~x64 & (new_n433_ | (~new_n112_ & (new_n435_ | (~new_n431_ & ~x70))));
  assign new_n431_ = (~x65 | x71 | (~new_n432_ & ~new_n426_ & ~new_n427_)) & (~x15 | x65 | ~x71);
  assign new_n432_ = ~new_n127_ & x63;
  assign new_n433_ = new_n434_ & x65;
  assign new_n434_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n435_ = x70 & ~x71 & x47 & ~x65;
  assign new_n436_ = x64 & ~x65 & ~x70 & ~new_n437_ & ~x71;
  assign new_n437_ = (x66 | x67 | (~new_n432_ & ~new_n426_ & ~new_n427_)) & (~x47 | (~x66 ^ x67));
  assign new_n438_ = x64 & ~x65 & new_n439_ & ~x69;
  assign new_n439_ = x71 & (x66 ^ x67) & (x70 ? x47 : x15);
endmodule
