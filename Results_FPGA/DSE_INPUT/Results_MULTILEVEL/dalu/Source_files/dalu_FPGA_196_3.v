// Benchmark "FAU" written by ABC on Thu Aug  6 22:31:54 2020
...
module FAU ( 
  ...
  assign new_n143_ = (~x50 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (~x48 | (x72 ? (x73 & x74) : ~x73)) & (~x49 | x72 | x73 | ~x74);
  assign new_n144_ = x69 & ((~new_n145_ & (x70 ^ x71)) | (x70 & ~new_n143_ & x71));
  assign new_n145_ = (~x18 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (~x16 | (x72 ? (x73 & x74) : ~x73)) & (~x17 | x72 | x73 | ~x74);
  ...
  assign new_n162_ = (~x51 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n163_ | x72) & (~x48 | (x72 ^ (~x73 | ~x74)));
  assign new_n163_ = (~x50 | x73 | ~x74) & (~x49 | ~x73 | x74);
  assign new_n164_ = x69 & ((~new_n165_ & (x70 ^ x71)) | (x70 & ~new_n162_ & x71));
  assign new_n165_ = (~x19 | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n166_ | x72) & (~x16 | (x72 ^ (~x73 | ~x74)));
  ...
  assign new_n177_ = x72 ? ((x73 & x74) ? ~x20 : ~x16) : new_n178_;
  assign new_n178_ = x73 ? (x74 ? ~x17 : ~x18) : (x74 ? ~x19 : ~x20);
  assign new_n179_ = x72 ? ((x73 & x74) ? ~x52 : ~x48) : new_n180_;
  assign new_n180_ = x73 ? (x74 ? ~x49 : ~x50) : (x74 ? ~x51 : ~x52);
  assign new_n181_ = x68 & ~x69 & (x70 ? (~new_n183_ & ~x71) : (~new_n182_ & x71));
  assign new_n182_ = x00 ? (x04 | (new_n119_ & ~x05 & ~x06 & ~x07)) : ~x04;
  assign new_n183_ = x32 ? (x36 | (new_n124_ & ~x37 & ~x38 & ~x39)) : ~x36;
  ...
  assign new_n219_ = x00 ? (x06 | (new_n119_ & ~x04 & ~x05 & ~x07)) : ~x06;
  assign new_n220_ = x32 ? (x38 | (new_n124_ & ~x36 & ~x37 & ~x39)) : ~x38;
  ...
  assign new_n238_ = x00 ? (x07 | (new_n119_ & ~x04 & ~x05 & ~x06)) : ~x07;
  assign new_n239_ = x32 ? (x39 | (new_n124_ & ~x36 & ~x37 & ~x38)) : ~x39;
  ...
  assign new_n385_ = (~x13 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x61 | ~x69) & (new_n386_ | ~x70);
  ...
  assign new_n404_ = x70 ? ~new_n402_ : (~x71 | ((~x00 | x14 | ~x15) & (~x14 | (x15 & (x00 | ~x15)))));
  ...
  assign new_n408_ = (~x14 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x62 | ~x69) & (new_n409_ | ~x70);
  ...
  assign new_n420_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (x70 | x71 | ~x63 | ~x69) & (new_n421_ | ~x70);
  ...
  assign new_n424_ = (x70 | ((~x65 | new_n417_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
