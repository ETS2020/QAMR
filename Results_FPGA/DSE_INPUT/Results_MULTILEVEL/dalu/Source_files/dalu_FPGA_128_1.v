// Benchmark "FAU" written by ABC on Thu Aug  6 22:31:20 2020
...
module FAU ( 
  ...
  assign new_n106_ = (x62 | ~x69) & (x70 ? x32 : x00);
  assign new_n107_ = (~x62 | ~x69 | (x70 ? ~x00 : ~x48)) & (~x16 | x69 | ~x70);
  assign new_n108_ = ~x69 & ~x70 & ~x71;
  assign new_n109_ = (~x62 | x68 | new_n110_ | ~x69) & (~new_n108_ | ~x48 | ~x68);
  assign new_n110_ = (~x16 | (~x70 ^ x71)) & (~x48 | ~x70 | ~x71);
  assign new_n111_ = x62 & x65 & ~x68 & x69 & ~new_n112_ & ~new_n110_;
  ...
  assign new_n125_ = x62 & x65 & new_n126_ & ~x68;
  ...
  assign new_n133_ = ~new_n127_ & ((x62 & new_n134_ & ~x68) | (new_n108_ & x49 & x68));
  assign new_n134_ = ~new_n129_ & x69;
  assign new_n135_ = (x68 | (x71 ? ~new_n136_ : new_n137_)) & (~new_n108_ | ~x33 | ~x68);
  assign new_n136_ = (x62 | ~x69) & (x70 ? x33 : x01);
  assign new_n137_ = (~x62 | ~x69 | (x70 ? ~x01 : ~x49)) & (~x17 | x69 | ~x70);
  ...
  assign new_n146_ = x62 & x65 & new_n147_ & ~x68;
  ...
  assign new_n152_ = (~new_n154_ | ~x67) & (~x62 | (x67 ? new_n153_ : ~new_n147_));
  ...
  assign new_n157_ = (x62 | ~x69) & (x70 ? x34 : x02);
  assign new_n158_ = (~x62 | ~x69 | (x70 ? ~x02 : ~x50)) & (~x18 | x69 | ~x70);
  assign z03 = x64 ? (~new_n174_ & ~x65) : (new_n160_ | (new_n179_ & x65));
  assign new_n160_ = ~new_n112_ & (new_n161_ | (x62 & new_n170_ & x65));
  ...
  assign new_n174_ = x66 ? (new_n176_ | x67) : (x67 ? new_n176_ : (~new_n175_ & (~new_n170_ | ~x62)));
  assign new_n175_ = x68 & new_n168_ & ~x69;
  assign new_n176_ = (x68 | (x71 ? ~new_n177_ : new_n178_)) & (~new_n108_ | ~x35 | ~x68);
  assign new_n177_ = (x62 | ~x69) & (x70 ? x35 : x03);
  assign new_n178_ = (~x62 | ~x69 | (x70 ? ~x03 : ~x51)) & (~x19 | x69 | ~x70);
  ...
  assign new_n182_ = (~x62 | x68 | ~x69 | (~new_n183_ & ~new_n187_)) & (~x68 | ~new_n190_ | x69);
  ...
  assign new_n196_ = (x62 | ~x69) & (x70 ? x36 : x04);
  assign new_n197_ = (~x62 | ~x69 | (x70 ? ~x04 : ~x52)) & (~x20 | x69 | ~x70);
  assign z05 = new_n199_ | new_n211_;
  assign new_n199_ = ~x64 & (((x66 | x67) & (x65 ? ~new_n200_ : new_n208_)) | (x65 & ~x66 & new_n208_ & ~x67));
  assign new_n200_ = (~x62 | x68 | ~x69 | (~new_n201_ & ~new_n204_)) & (~x68 | ~new_n207_ | x69);
  ...
  assign new_n213_ = (x62 | ~x69) & (x70 ? x37 : x05);
  assign new_n214_ = (~x62 | ~x69 | (x70 ? ~x05 : ~x53)) & (~x21 | x69 | ~x70);
  assign z06 = new_n216_ | new_n229_;
  assign new_n216_ = ~x64 & (((x66 | x67) & (x65 ? ~new_n217_ : new_n226_)) | (x65 & ~x66 & new_n226_ & ~x67));
  assign new_n217_ = (~x62 | x68 | ~x69 | (~new_n218_ & ~new_n221_)) & (~x68 | ~new_n225_ | x69);
  ...
  assign new_n231_ = (x62 | ~x69) & (x70 ? x38 : x06);
  assign new_n232_ = (~x62 | ~x69 | (x70 ? ~x06 : ~x54)) & (~x22 | x69 | ~x70);
  assign z07 = new_n234_ | new_n247_;
  assign new_n234_ = ~x64 & (((x66 | x67) & (x65 ? ~new_n235_ : new_n244_)) | (x65 & ~x66 & new_n244_ & ~x67));
  assign new_n235_ = (~x62 | x68 | ~x69 | (~new_n236_ & ~new_n239_)) & (~x68 | ~new_n243_ | x69);
  ...
  assign new_n249_ = (x62 | ~x69) & (x70 ? x39 : x07);
  assign new_n250_ = (~x62 | ~x69 | (x70 ? ~x07 : ~x55)) & (~x23 | x69 | ~x70);
  assign z08 = x64 ? (~new_n265_ & ~x65) : ((~new_n252_ & ~new_n112_) | (new_n263_ & x65));
  assign new_n252_ = (~x68 | new_n253_ | x69) & (~x62 | ~new_n259_ | ~x65);
  ...
  assign new_n265_ = x66 ? (new_n267_ | x67) : (x67 ? new_n267_ : (~new_n266_ & (~new_n259_ | ~x62)));
  assign new_n266_ = x68 & ~x69 & ~x70 & ~new_n256_ & ~x71;
  assign new_n267_ = (x68 | (x71 ? ~new_n268_ : new_n269_)) & (~new_n108_ | ~x40 | ~x68);
  assign new_n268_ = (x62 | ~x69) & (x70 ? x40 : x08);
  assign new_n269_ = (~x62 | ~x69 | (x70 ? ~x08 : ~x56)) & (~x24 | x69 | ~x70);
  assign z09 = x64 ? (~new_n285_ & ~x65) : ((~new_n271_ & ~new_n112_) | (new_n283_ & x65));
  assign new_n271_ = (~x68 | new_n272_ | x69) & (~x62 | ~new_n278_ | ~x65);
  ...
  assign new_n285_ = x66 ? (new_n287_ | x67) : (x67 ? new_n287_ : (~new_n286_ & (~new_n278_ | ~x62)));
  assign new_n286_ = x68 & new_n275_ & ~x69;
  assign new_n287_ = (x68 | (x71 ? ~new_n288_ : new_n289_)) & (~new_n108_ | ~x41 | ~x68);
  assign new_n288_ = (x62 | ~x69) & (x70 ? x41 : x09);
  assign new_n289_ = (~x62 | ~x69 | (x70 ? ~x09 : ~x57)) & (~x25 | x69 | ~x70);
  ...
  assign new_n298_ = x62 & x65 & ~x68 & x69 & ~new_n299_ & x71;
  ...
  assign new_n302_ = (~x62 | ~x65 | x68 | new_n303_ | ~x69) & (x65 | ~x68 | ~new_n305_ | x69);
  ...
  assign new_n307_ = x66 ? (new_n311_ | x67) : (x67 ? new_n311_ : (~new_n310_ & (~new_n308_ | ~x62)));
  ...
  assign new_n312_ = (x62 | ~x69) & (x70 ? x42 : x10);
  assign new_n313_ = (~x62 | ~x69 | (x70 ? ~x10 : ~x58)) & (~x26 | x69 | ~x70);
  assign new_n314_ = ~x67 & x68 & ~x69 & (x70 ? new_n305_ : new_n293_);
  assign z11 = x64 ? new_n334_ : (new_n332_ | (~new_n112_ & (new_n316_ | new_n327_)));
  assign new_n316_ = ~x70 & ((new_n317_ & x68) | (x62 & x65 & new_n323_ & ~x68));
  ...
  assign new_n327_ = x70 & ((x62 & x65 & new_n328_ & ~x68) | (~x65 & new_n330_ & x68));
  ...
  assign new_n335_ = (~x62 | x68 | ~x69 | (~new_n336_ & ~new_n337_)) & (~x68 | ~new_n338_ | x69);
  ...
  assign new_n339_ = (x68 | (x71 ? ~new_n340_ : new_n341_)) & (~new_n108_ | ~x43 | ~x68);
  assign new_n340_ = (x62 | ~x69) & (x70 ? x43 : x11);
  assign new_n341_ = (~x62 | ~x69 | (x70 ? ~x11 : ~x59)) & (~x27 | x69 | ~x70);
  assign z12 = x64 ? (~x65 & (x66 ? new_n367_ : ~new_n359_)) : ~new_n343_;
  assign new_n343_ = ~new_n357_ & (new_n112_ | (x70 ? new_n353_ : new_n344_));
  assign new_n344_ = (~x68 | new_n345_ | x69) & (~x62 | ~x65 | x68 | ~new_n350_ | ~x69);
  ...
  assign new_n353_ = (~x62 | ~x65 | x68 | new_n354_ | ~x69) & (x65 | ~x68 | ~new_n356_ | x69);
  ...
  assign new_n359_ = x67 ? new_n364_ : ((~new_n363_ | ~x68) & (~x62 | ~new_n360_ | x68));
  ...
  assign new_n364_ = (x68 | (x71 ? ~new_n365_ : new_n366_)) & (~new_n108_ | ~x44 | ~x68);
  assign new_n365_ = (x62 | ~x69) & (x70 ? x44 : x12);
  assign new_n366_ = (~x62 | ~x69 | (x70 ? ~x12 : ~x60)) & (~x28 | x69 | ~x70);
  assign new_n367_ = ~new_n364_ & ~x67;
  assign z13 = x64 ? new_n385_ : (new_n393_ | (~new_n112_ & (new_n369_ | new_n380_)));
  assign new_n369_ = ~x70 & ((new_n370_ & x68) | (x62 & x65 & new_n376_ & ~x68));
  ...
  assign new_n380_ = x70 & ((x62 & x65 & new_n381_ & ~x68) | (~x65 & new_n383_ & x68));
  ...
  assign new_n386_ = (~x62 | x68 | ~x69 | (~new_n387_ & ~new_n388_)) & (~x68 | ~new_n389_ | x69);
  ...
  assign new_n390_ = (x68 | (x71 ? ~new_n391_ : new_n392_)) & (~new_n108_ | ~x45 | ~x68);
  assign new_n391_ = (x62 | ~x69) & (x70 ? x45 : x13);
  assign new_n392_ = (~x62 | ~x69 | (x70 ? ~x13 : ~x61)) & (~x29 | x69 | ~x70);
  assign new_n393_ = x65 & ~x66 & new_n394_ & ~x67;
  assign new_n394_ = x68 & ~x69 & (x70 ? (~new_n384_ & ~x71) : (~new_n374_ & x71));
  assign z14 = x64 ? new_n416_ : (new_n425_ | (~new_n396_ & ~new_n112_));
  assign new_n396_ = new_n408_ & (~x71 | ((~new_n402_ | ~x62) & (new_n397_ | x70)));
  assign new_n397_ = (~x62 | ~x65 | x68 | new_n398_ | ~x69) & (x65 | ~x68 | new_n401_ | x69);
  assign new_n398_ = ~new_n399_ & ~new_n400_;
  assign new_n399_ = x72 & ((~x73 & (x74 ? x25 : x26)) | (x22 & x73 & ~x74));
  assign new_n400_ = ~x72 & ((x29 & ~x73 & x74) | (x73 & (x74 ? x27 : x28)));
  assign new_n401_ = (~x14 | (x00 & x15)) & (~x00 | x14 | ~x15);
  assign new_n402_ = x65 & ~x68 & x69 & (new_n403_ | (~new_n404_ & x70));
  assign new_n403_ = ~new_n127_ & (x30 | x70);
  assign new_n404_ = ~new_n405_ & ~new_n406_ & new_n407_;
  assign new_n405_ = x72 & ((x57 & x74) | (x54 & x73));
  assign new_n406_ = ~x72 & ((x60 & ~x74) | (x61 & ~x73));
  assign new_n407_ = (~x59 | ~x73 | ~x74) & (~x58 | x73 | x74);
  assign new_n408_ = x65 ? (~new_n411_ & (~x62 | (~new_n409_ & ~new_n410_))) : ~new_n414_;
  assign new_n409_ = ~new_n127_ & ((x30 & ~x68 & x69 & x70) | (~x70 & ~x71 & x68 & ~x69));
  assign new_n410_ = ~x68 & x69 & x70 & ~x71 & (new_n399_ | new_n400_);
  assign new_n411_ = x68 & ~x69 & ~x70 & ~x71 & (new_n412_ | new_n413_);
  ...
  assign new_n415_ = x70 & ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n416_ = ~x65 & (x66 ? (~new_n422_ & ~x67) : (x67 ? ~new_n422_ : (new_n417_ | new_n411_)));
  assign new_n417_ = x62 & (x68 ? (new_n421_ & ~x69) : (x69 & (new_n418_ | ~new_n419_)));
  assign new_n418_ = ~new_n184_ & (new_n399_ | new_n400_);
  assign new_n419_ = ~new_n420_ & (~x70 | ~x71 | (~new_n405_ & ~new_n406_ & new_n407_));
  assign new_n420_ = (x72 ? (x73 & x74) : (~x73 & ~x74)) & ((x70 & x71) | (x30 & (x70 | x71)));
  assign new_n421_ = ~x70 & ~new_n127_ & ~x71;
  assign new_n422_ = (x68 | (x71 ? ~new_n423_ : new_n424_)) & (~new_n108_ | ~x46 | ~x68);
  assign new_n423_ = (x62 | ~x69) & (x70 ? x46 : x14);
  assign new_n424_ = (~x62 | ~x69 | (~x14 & x70)) & (~x30 | x69 | ~x70);
  assign new_n425_ = x65 & ~x66 & ~x67 & x68 & ~new_n426_ & ~x69;
  assign new_n426_ = ~new_n415_ & (x70 | ~x71 | ((~x00 | x14 | ~x15) & (~x14 | (x15 & (x00 | ~x15)))));
  assign z15 = x68 ? new_n441_ : (new_n452_ | (~new_n428_ & x62));
  assign new_n428_ = x64 ? (x65 | (x66 ? ~new_n440_ : new_n429_)) : (~new_n439_ | ~x65);
  assign new_n429_ = x67 ? new_n438_ : (~x69 | (~new_n430_ & ~new_n433_ & ~new_n436_));
  assign new_n430_ = ~new_n184_ & (new_n431_ | new_n432_ | (~new_n127_ & x31));
  assign new_n431_ = x73 & ((~x72 & (x74 ? x28 : x29)) | (x23 & x72 & ~x74));
  assign new_n432_ = x72 & ~x73 & (x74 ? x26 : x27);
  assign new_n433_ = ~x72 & (new_n434_ | new_n435_);
  assign new_n434_ = ~x73 & ((x63 & x70 & x71) | (x74 & ((x70 & x71) | (x30 & (x70 | x71)))));
  assign new_n435_ = x70 & x71 & ((x60 & x74) | (x61 & x73 & ~x74));
  assign new_n436_ = x70 & x71 & (new_n437_ | (x58 & ~x73 & x74));
  assign new_n437_ = x72 & ((x73 & (x74 ? x63 : x55)) | (x59 & ~x73 & ~x74));
  assign new_n438_ = (~x15 | ((x70 | ~x71) & (~x69 | ~x70 | x71))) & (~x47 | ~x70 | ~x71) & (x70 | x71 | ~x63 | ~x69);
  assign new_n439_ = x69 & ~new_n112_ & (new_n430_ | new_n433_ | new_n436_);
  assign new_n440_ = ~new_n438_ & ~x67;
  assign new_n441_ = ~x69 & (new_n442_ | new_n450_);
  assign new_n442_ = ~x64 & (new_n447_ | (~new_n112_ & (new_n449_ | (~new_n443_ & ~x70))));
  assign new_n443_ = (~x65 | x71 | (~new_n444_ & ~new_n445_ & ~new_n446_)) & (~x15 | x65 | ~x71);
  ...
  assign new_n447_ = new_n448_ & x65;
  assign new_n448_ = ~x66 & ~x67 & ((x15 & ~x70 & x71) | (x47 & x70 & ~x71));
  assign new_n449_ = x70 & ~x71 & x47 & ~x65;
  assign new_n450_ = x64 & ~x65 & ~x70 & ~new_n451_ & ~x71;
  assign new_n451_ = (x66 | x67 | (~new_n444_ & ~new_n445_ & ~new_n446_)) & (~x47 | (~x66 ^ x67));
  assign new_n452_ = x64 & ~x65 & ~x69 & ~new_n453_ & (x66 ^ x67);
