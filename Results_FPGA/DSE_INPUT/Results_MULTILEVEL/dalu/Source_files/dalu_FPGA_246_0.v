// Benchmark "FAU" written by ABC on Thu Aug  6 22:32:20 2020
...
module FAU ( 
  ...
  assign new_n94_ = ~new_n100_ & (x71 | (~new_n102_ & (~x11 | ~new_n95_ | ~x68)));
  ...
  assign new_n104_ = new_n105_ & x11 & x32 & ~x33;
  ...
  assign new_n110_ = (~x11 | ((new_n111_ | ~x32) & (new_n112_ | x68))) & (~new_n113_ | x68);
  ...
  assign new_n114_ = (~new_n115_ | x68) & (~new_n116_ | ~x11 | ~x48 | ~x68);
  assign new_n115_ = x69 & ((x16 & (x70 ^ x71)) | (x48 & x70 & x71));
  assign new_n116_ = ~x69 & ~x70 & ~x71;
  assign new_n117_ = ~x66 & ~x67;
  assign z01 = x64 ? (~new_n136_ & ~x65) : (new_n119_ | (x11 & new_n134_ & x65));
  ...
  assign new_n124_ = x11 & ~x65 & x68 & ~x69 & ~new_n125_ & ~x71;
  ...
  assign new_n129_ = (new_n130_ | ~x65) & (~x11 | x65 | ~x68 | ~new_n133_ | x69);
  assign new_n130_ = (new_n131_ | (x72 ? (~x73 | ~x74) : (x73 | x74))) & (new_n132_ | (x74 ? (x72 & x73) : (~x72 & ~x73)));
  assign new_n131_ = (~x69 | ~x71 | ~x17 | x68) & (~x11 | ~x49 | ~x68 | x69 | x71);
  assign new_n132_ = (~x69 | ~x71 | ~x16 | x68) & (~x11 | ~x48 | ~x68 | x69 | x71);
  ...
  assign new_n138_ = new_n116_ & x11 & x49 & x68;
  assign new_n139_ = ~x68 & x69 & ((x17 & (x70 ^ x71)) | (x49 & x70 & x71));
  assign new_n140_ = (~x11 | ((new_n111_ | ~x33) & (new_n141_ | x68))) & (~new_n142_ | x68);
  ...
  assign new_n144_ = ((~x66 & ~x67) | ((new_n145_ | ~x65) & (~x11 | ~new_n150_ | x65))) & (~x11 | ~x65 | x66 | ~new_n150_ | x67);
  ...
  assign new_n149_ = x11 & x68 & ~x69 & ~x70 & ~new_n148_ & ~x71;
  ...
  assign new_n154_ = ~x65 & ((~new_n155_ & ~x68) | (x11 & x68 & new_n162_ & ~x69));
  assign new_n155_ = (~x69 | (~new_n156_ & new_n158_)) & (~x11 | new_n160_ | new_n161_);
  ...
  assign new_n164_ = (~x65 | ((~x11 | ~new_n170_ | ~x68) & (~new_n165_ | x68))) & (~x11 | ~new_n172_ | x65);
  ...
  assign new_n177_ = x11 & x65 & ~x66 & new_n172_ & ~x67;
  assign new_n178_ = (x68 | ((~new_n183_ | ~x11) & (new_n179_ | ~x69))) & (~x11 | ~x68 | ~new_n182_ | x69);
  ...
  assign new_n186_ = ((~x66 & ~x67) | ((new_n187_ | ~x65) & (~x11 | ~new_n195_ | x65))) & (~x11 | ~x65 | x66 | ~new_n195_ | x67);
  assign new_n187_ = (x68 | ~x69 | (~new_n188_ & ~new_n191_)) & (~x11 | ~x68 | ~new_n194_ | x69);
  ...
  assign new_n204_ = x11 & x68 & ~x69 & ~x70 & ~new_n205_ & ~x71;
  assign new_n205_ = (~x36 | (~x66 ^ x67)) & (x66 | x67 | (x72 ? new_n192_ : new_n193_));
  assign new_n206_ = x11 & ~new_n160_ & ~new_n207_;
  assign new_n207_ = (~x70 | ((~x36 | ~x71) & (~x20 | x69 | x71))) & (~x04 | x70 | ~x71);
  assign z05 = x64 ? (~new_n221_ & ~x65) : ~new_n209_;
  assign new_n209_ = ((~x66 & ~x67) | ((new_n210_ | ~x65) & (~x11 | ~new_n218_ | x65))) & (~x11 | ~x65 | x66 | ~new_n218_ | x67);
  assign new_n210_ = (x68 | ~x69 | (~new_n211_ & ~new_n214_)) & (~x11 | ~x68 | ~new_n217_ | x69);
  ...
  assign new_n226_ = x11 & x68 & ~x69 & ~x70 & ~new_n227_ & ~x71;
  assign new_n227_ = (~x37 | (~x66 ^ x67)) & (x66 | x67 | (x72 ? new_n215_ : new_n216_));
  assign new_n228_ = x11 & ~new_n160_ & ~new_n229_;
  assign new_n229_ = (~x70 | ((~x37 | ~x71) & (~x21 | x69 | x71))) & (~x05 | x70 | ~x71);
  assign z06 = x64 ? (~new_n245_ & ~x65) : ~new_n231_;
  assign new_n231_ = ((~x66 & ~x67) | ((new_n232_ | ~x65) & (~x11 | ~new_n242_ | x65))) & (~x11 | ~x65 | x66 | ~new_n242_ | x67);
  assign new_n232_ = (x68 | ~x69 | (~new_n233_ & ~new_n237_)) & (~x11 | ~x68 | ~new_n241_ | x69);
  ...
  assign new_n245_ = (x68 | ((~new_n251_ | ~x11) & (new_n246_ | ~x69))) & (~x11 | ~x68 | ~new_n249_ | x69);
  ...
  assign new_n254_ = ((~x66 & ~x67) | ((new_n255_ | ~x65) & (~x11 | ~new_n265_ | x65))) & (~x11 | ~x65 | x66 | ~new_n265_ | x67);
  assign new_n255_ = (x68 | ~x69 | (~new_n256_ & ~new_n260_)) & (~x11 | ~x68 | ~new_n264_ | x69);
  ...
  assign new_n268_ = (x68 | ((~new_n274_ | ~x11) & (new_n269_ | ~x69))) & (~x11 | ~x68 | ~new_n272_ | x69);
  ...
  assign z08 = x64 ? (~new_n291_ & ~x65) : (new_n290_ | (~new_n277_ & ~new_n117_));
  assign new_n277_ = (~x65 | ((~x11 | ~new_n286_ | ~x68) & (~new_n278_ | x68))) & (~x11 | ~new_n287_ | x65);
  assign new_n278_ = x69 & ((~new_n279_ & (x70 ^ x71)) | (x70 & ~new_n282_ & x71));
  assign new_n279_ = (new_n122_ | ~x24) & (new_n281_ | x72) & (new_n280_ | ~x72);
  ...
  assign new_n286_ = ~x69 & ~x70 & ~new_n282_ & ~x71;
  ...
  assign new_n289_ = x00 ^ ~x08;
  assign new_n290_ = x11 & x65 & ~x66 & new_n287_ & ~x67;
  assign new_n291_ = ~new_n295_ & (x68 | (~new_n297_ & (~x69 | (~new_n292_ & new_n293_))));
  assign new_n292_ = ~new_n157_ & ((x08 & (x66 ^ x67)) | (~x66 & ~new_n279_ & ~x67));
  assign new_n293_ = (new_n294_ | (x66 ^ ~x67)) & (x66 | x67 | ~x70 | new_n282_ | ~x71);
  assign new_n294_ = (~x40 | ~x70 | ~x71) & (~x56 | x70 | x71);
  assign new_n295_ = x11 & x68 & ~x69 & ~x70 & ~new_n296_ & ~x71;
  assign new_n296_ = (~x40 | (~x66 ^ x67)) & (x66 | x67 | (~new_n283_ & ~new_n284_ & ~new_n285_));
  assign new_n297_ = x11 & ~new_n160_ & ~new_n298_;
  assign new_n298_ = (~x70 | ((~x40 | ~x71) & (~x24 | x69 | x71))) & (~x08 | x70 | ~x71);
  assign z09 = x64 ? (~new_n314_ & ~x65) : ~new_n300_;
  assign new_n300_ = ((~x66 & ~x67) | ((new_n301_ | ~x65) & (~x11 | ~new_n311_ | x65))) & (~x11 | ~x65 | x66 | ~new_n311_ | x67);
  assign new_n301_ = (x68 | ~x69 | (~new_n302_ & ~new_n306_)) & (~x11 | ~x68 | ~new_n310_ | x69);
  assign new_n302_ = ~new_n157_ & (new_n303_ | new_n304_ | new_n305_);
  ...
  assign new_n312_ = (~x41 | (~new_n175_ & x32)) & (~x32 | new_n175_ | x41);
  assign new_n313_ = x00 ^ ~x09;
  assign new_n314_ = (x68 | ((~new_n320_ | ~x11) & (new_n315_ | ~x69))) & (~x11 | ~x68 | ~new_n318_ | x69);
  assign new_n315_ = (new_n316_ | new_n157_) & (new_n317_ | (~x66 ^ x67)) & (x66 | ~new_n306_ | x67);
  assign new_n316_ = (~x09 | (~x66 ^ x67)) & (x66 | x67 | (~new_n303_ & ~new_n304_ & ~new_n305_));
  assign new_n317_ = (~x41 | ~x70 | ~x71) & (~x57 | x70 | x71);
  assign new_n318_ = ~x70 & ~x71 & ((~x66 & ~new_n319_ & ~x67) | (x41 & (~x66 ^ ~x67)));
  assign new_n319_ = ~new_n307_ & ~new_n308_ & ~new_n309_;
  assign new_n320_ = ~new_n160_ & ~new_n321_;
  assign new_n321_ = (~x70 | ((~x41 | ~x71) & (~x25 | x69 | x71))) & (~x09 | x70 | ~x71);
  assign z10 = x64 ? (~new_n338_ & ~x65) : ~new_n323_;
  assign new_n323_ = ((~x66 & ~x67) | ((new_n324_ | ~x65) & (~x11 | ~new_n334_ | x65))) & (~x11 | ~x65 | x66 | ~new_n334_ | x67);
  assign new_n324_ = (x68 | ~x69 | (~new_n325_ & ~new_n329_)) & (~x11 | ~x68 | ~new_n333_ | x69);
  assign new_n325_ = ~new_n157_ & (new_n326_ | new_n327_ | new_n328_);
  ...
  assign new_n334_ = x68 & ~x69 & (x70 ? (~new_n335_ & ~x71) : (~new_n337_ & x71));
  assign new_n335_ = (~x42 | (x32 & (~new_n336_ | x43 | x44))) & (~x32 | x42 | (new_n336_ & ~x43 & ~x44));
  assign new_n336_ = ~x45 & ~x46 & ~x47;
  assign new_n337_ = x00 ^ ~x10;
  assign new_n338_ = (x68 | ((~new_n344_ | ~x11) & (new_n339_ | ~x69))) & (~x11 | ~x68 | ~new_n342_ | x69);
  assign new_n339_ = (new_n340_ | new_n157_) & (new_n341_ | (~x66 ^ x67)) & (x66 | ~new_n329_ | x67);
  assign new_n340_ = (~x10 | (~x66 ^ x67)) & (x66 | x67 | (~new_n326_ & ~new_n327_ & ~new_n328_));
  assign new_n341_ = (~x42 | ~x70 | ~x71) & (~x58 | x70 | x71);
  assign new_n342_ = ~x70 & ~x71 & ((~x66 & ~new_n343_ & ~x67) | (x42 & (~x66 ^ ~x67)));
  assign new_n343_ = ~new_n330_ & ~new_n331_ & ~new_n332_;
  assign new_n344_ = ~new_n160_ & ~new_n345_;
  assign new_n345_ = (~x70 | ((~x42 | ~x71) & (~x26 | x69 | x71))) & (~x10 | x70 | ~x71);
  assign z11 = x64 ? new_n360_ : ~new_n347_;
  assign new_n347_ = ((~x66 & ~x67) | ((new_n348_ | ~x65) & (~x11 | ~new_n357_ | x65))) & (~x11 | ~x65 | x66 | ~new_n357_ | x67);
  assign new_n348_ = (x68 | ~x69 | (~new_n349_ & ~new_n352_)) & (~x11 | ~x68 | ~new_n356_ | x69);
  assign new_n349_ = ~new_n157_ & (new_n350_ | new_n351_ | (~new_n122_ & x27));
  ...
  assign new_n357_ = x68 & ~x69 & (x70 ? (~new_n358_ & ~x71) : (~new_n359_ & x71));
  assign new_n358_ = (~x43 | (~new_n128_ & x32)) & (~x32 | new_n128_ | x43);
  assign new_n359_ = ~new_n197_ & x00;
  assign new_n360_ = ~x65 & (x66 ? (~new_n361_ & ~x67) : (x67 ? ~new_n361_ : ~new_n348_));
  assign new_n361_ = ~new_n363_ & (new_n362_ | ~x11);
  assign new_n362_ = (~x43 | ((~x68 | x69 | x70 | x71) & (x68 | ~x71))) & (x68 | (x70 ? ((~x27 & ~x69) | x71) : ~x71));
  assign new_n363_ = ~x68 & x69 & ((x43 & x70 & x71) | (x59 & ~x70 & ~x71));
  assign z12 = x64 ? (~new_n382_ & ~x65) : ~new_n365_;
  assign new_n365_ = (~new_n380_ | ~x11) & (new_n117_ | (x70 ? new_n376_ : new_n366_));
  assign new_n366_ = (~x11 | ~x68 | new_n367_ | x69) & (~x65 | x68 | ~new_n372_ | ~x69);
  ...
  assign new_n376_ = (~x11 | x65 | ~x68 | ~new_n379_ | x69) & (~x65 | x68 | new_n377_ | ~x69);
  assign new_n377_ = ~new_n378_ & (~x71 | (~new_n370_ & ~new_n371_)) & (x71 | (~new_n374_ & ~new_n375_));
  assign new_n378_ = (x71 ? x60 : x28) & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n379_ = ~x71 & ((x44 & (new_n336_ | ~x32)) | (x32 & ~new_n336_ & ~x44));
  assign new_n380_ = x65 & ~x66 & ~x67 & x68 & ~new_n381_ & ~x69;
  assign new_n381_ = x70 ? (x71 | ((~x32 | new_n336_ | x44) & (~x44 | (~new_n336_ & x32)))) : ~new_n368_;
  assign new_n382_ = (x68 | (~new_n383_ & (~x11 | new_n160_ | new_n389_))) & (~x11 | ~new_n387_ | ~x68);
  assign new_n383_ = x69 & ((~new_n384_ & ~new_n157_) | new_n385_ | (new_n386_ & ~x66));
  assign new_n384_ = (~x12 | (~x66 ^ x67)) & (x66 | x67 | (~new_n373_ & ~new_n374_ & ~new_n375_));
  assign new_n385_ = ~new_n160_ & ((x44 & x70 & x71) | (x60 & ~x70 & ~x71));
  assign new_n386_ = ~x67 & x70 & x71 & (new_n369_ | new_n370_ | new_n371_);
  assign new_n387_ = ~x69 & ~x70 & ~new_n388_ & ~x71;
  assign new_n388_ = (~x44 | (~x66 ^ x67)) & (x66 | x67 | (~new_n369_ & ~new_n370_ & ~new_n371_));
  assign new_n389_ = (~x70 | ((~x44 | ~x71) & (~x28 | x69 | x71))) & (~x12 | x70 | ~x71);
  assign z13 = x64 ? (~new_n408_ & ~x65) : ~new_n391_;
  assign new_n391_ = ~new_n406_ & (new_n117_ | (x70 ? new_n402_ : new_n392_));
  assign new_n392_ = (~x11 | ~x68 | new_n393_ | x69) & (~x65 | x68 | ~new_n398_ | ~x69);
  ...
  assign new_n402_ = (~x11 | x65 | ~x68 | ~new_n405_ | x69) & (~x65 | x68 | new_n403_ | ~x69);
  assign new_n403_ = ~new_n404_ & (~x71 | (~new_n396_ & ~new_n397_)) & (x71 | (~new_n400_ & ~new_n401_));
  assign new_n404_ = (x71 ? x61 : x29) & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n405_ = ~x71 & ((x32 & ~x45 & (x46 | x47)) | (x45 & (~x32 | (~x46 & ~x47))));
  assign new_n406_ = x11 & x65 & ~x66 & new_n407_ & ~x67;
  assign new_n407_ = x68 & ~x69 & (x70 ? new_n405_ : (~new_n394_ & x71));
  assign new_n408_ = (x68 | (~new_n409_ & (~x11 | new_n160_ | new_n415_))) & (~x11 | ~new_n413_ | ~x68);
  assign new_n409_ = x69 & ((~new_n410_ & ~new_n157_) | new_n411_ | (new_n412_ & ~x66));
  assign new_n410_ = (~x13 | (~x66 ^ x67)) & (x66 | x67 | (~new_n399_ & ~new_n400_ & ~new_n401_));
  assign new_n411_ = ~new_n160_ & ((x45 & x70 & x71) | (x61 & ~x70 & ~x71));
  assign new_n412_ = ~x67 & x70 & x71 & (new_n395_ | new_n396_ | new_n397_);
  assign new_n413_ = ~x69 & ~x70 & ~new_n414_ & ~x71;
  assign new_n414_ = (~x45 | (~x66 ^ x67)) & (x66 | x67 | (~new_n395_ & ~new_n396_ & ~new_n397_));
  assign new_n415_ = (~x70 | ((~x45 | ~x71) & (~x29 | x69 | x71))) & (~x13 | x70 | ~x71);
  assign z14 = x64 ? (~new_n433_ & ~x65) : ~new_n417_;
  assign new_n417_ = (~new_n431_ | ~x11) & (new_n117_ | (x70 ? new_n427_ : new_n418_));
  assign new_n418_ = (~x11 | ~x68 | new_n419_ | x69) & (~x65 | x68 | ~new_n424_ | ~x69);
  ...
  assign new_n424_ = x71 & (new_n425_ | new_n426_ | (~new_n122_ & x30));
  assign new_n425_ = x72 & ((~x73 & (x74 ? x25 : x26)) | (x22 & x73 & ~x74));
  assign new_n426_ = ~x72 & ((x29 & ~x73 & x74) | (x73 & (x74 ? x27 : x28)));
  assign new_n427_ = (~x11 | x65 | ~x68 | ~new_n430_ | x69) & (~x65 | x68 | new_n428_ | ~x69);
  assign new_n428_ = ~new_n429_ & (~x71 | (~new_n422_ & ~new_n423_)) & (x71 | (~new_n425_ & ~new_n426_));
  assign new_n429_ = (x71 ? x62 : x30) & (x72 ? (x73 & x74) : (~x73 & ~x74));
  assign new_n430_ = ~x71 & ((x46 & (~x32 | ~x47)) | (x32 & ~x46 & x47));
  assign new_n431_ = x65 & ~x66 & ~x67 & x68 & ~new_n432_ & ~x69;
  assign new_n432_ = x70 ? ~new_n430_ : (~x71 | ((~x00 | x14 | ~x15) & (~x14 | (x15 & (x00 | ~x15)))));
  assign new_n433_ = ~new_n439_ & (x68 | (~new_n441_ & (~x69 | (~new_n434_ & new_n436_))));
  assign new_n434_ = ~new_n157_ & ((x14 & (x66 ^ x67)) | (~x66 & ~new_n435_ & ~x67));
  assign new_n435_ = ~new_n425_ & ~new_n426_ & (new_n122_ | ~x30);
  assign new_n436_ = (new_n438_ | (x66 ^ ~x67)) & (x66 | x67 | ~x70 | new_n437_ | ~x71);
  assign new_n437_ = ~new_n421_ & ~new_n422_ & ~new_n423_;
  assign new_n438_ = (~x46 | ~x70 | ~x71) & (~x62 | x70 | x71);
  assign new_n439_ = x11 & x68 & ~x69 & ~x70 & ~new_n440_ & ~x71;
  assign new_n440_ = (~x46 | (~x66 ^ x67)) & (x66 | x67 | (~new_n421_ & ~new_n422_ & ~new_n423_));
  assign new_n441_ = x11 & ~new_n160_ & ~new_n442_;
  assign new_n442_ = (~x70 | ((~x46 | ~x71) & (~x30 | x69 | x71))) & (~x14 | x70 | ~x71);
  assign z15 = (~new_n444_ & ~x68) | (x11 & x68 & ~new_n460_ & ~x69);
  assign new_n444_ = x64 ? (x65 | (~new_n445_ & ~new_n458_)) : (~new_n455_ | ~x65);
  assign new_n445_ = x69 & ((~new_n446_ & ~new_n157_) | new_n450_ | (new_n451_ & ~x66));
  ...
  assign new_n450_ = ~new_n160_ & ((x47 & x70 & x71) | (x63 & ~x70 & ~x71));
  ...
  assign new_n455_ = x69 & ~new_n117_ & ((~new_n456_ & (x70 ^ x71)) | (x70 & ~new_n457_ & x71));
  assign new_n456_ = ~new_n447_ & ~new_n448_ & ~new_n449_;
  assign new_n457_ = ~new_n452_ & ~new_n453_ & ~new_n454_;
  assign new_n458_ = x11 & ~new_n160_ & ~new_n459_;
  assign new_n459_ = (~x70 | ((~x47 | ~x71) & (~x31 | x69 | x71))) & (~x15 | x70 | ~x71);
  assign new_n460_ = x64 ? (~new_n462_ | x65) : ((new_n461_ | new_n117_) & (~new_n463_ | ~x65));
  assign new_n461_ = (x70 | ((~x65 | new_n457_ | x71) & (~x15 | x65 | ~x71))) & (~x47 | x65 | ~x70 | x71);
  assign new_n462_ = ~x70 & ~x71 & ((~x66 & ~new_n457_ & ~x67) | (x47 & (~x66 ^ ~x67)));
