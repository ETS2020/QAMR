...
module FAU ( 
  ...
  assign z7 = (~new_n56_ & (x12 | x21)) | (~x02 & ~x10 & x21 & ~x24);
  ...
  assign z4 = (~new_n74_ & (new_n78_ | x08)) | new_n77_ | (z7 & (new_n79_ | ~x08));
  assign new_n74_ = (new_n76_ | (~x12 & ~x21)) & (~new_n75_ | x10 | ~x12 | x24);
  assign new_n75_ = x00 & ~x02;
  assign new_n76_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign new_n77_ = new_n75_ & ~x10 & x21 & ~x24;
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = new_n81_ | new_n82_ | new_n77_;
  assign new_n81_ = ~new_n74_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n82_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
