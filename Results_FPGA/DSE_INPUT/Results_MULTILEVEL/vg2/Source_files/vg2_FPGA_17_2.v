...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n75_, new_n76_, new_n78_, new_n79_, new_n82_, new_n83_;
  ...
  assign new_n68_ = x11 & x14 & x16 & ~new_n43_ & x20;
  ...
  assign new_n72_ = x11 & x14 & x16 & x18 & x20;
  assign new_n73_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n74_ = (~new_n76_ | x01 | x03 | x06 | x08) & (~new_n75_ | ~x06 | ~x08 | ~x01 | ~x03);
  assign new_n75_ = x11 & x14 & x15 & x16 & x20;
  assign new_n76_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = (~new_n37_ & (x08 ? x16 : (~new_n78_ & ~x16))) | (~new_n64_ & (~x08 | (~new_n79_ & x16)));
  assign new_n78_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n79_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z5 = ~new_n37_ & (~x08 | (x08 & x16));
  assign z6 = (new_n82_ | new_n83_) & (~x08 | x16);
