// Benchmark "FAU" written by ABC on Sat Aug  8 22:06:53 2020
...
module FAU ( 
  ...
  assign z1 = new_n49_ | new_n57_ | ((new_n41_ | new_n45_) & new_n61_);
  ...
  assign new_n49_ = x24 & ~new_n56_ & ~new_n38_ & (new_n52_ | (new_n42_ & new_n50_));
  ...
  assign new_n58_ = new_n59_ & x11 & x12 & x14 & x16 & x17;
  assign new_n59_ = x22 & x23 & ~x24 & x20 & x21;
  assign new_n60_ = x08 & x09 & ~x10 & x04 & x06;
  assign new_n61_ = ~new_n38_ & (x05 ? (x13 & ~x24) : ~x13);
  assign z2 = new_n63_ & x01;
  assign new_n63_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = (~new_n65_ & (~x00 | x02)) | (~x00 & ~x02 & ~x10 & x21 & ~x24);
  assign new_n65_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (new_n61_ & ~new_n72_) | (new_n75_ & new_n76_) | (new_n67_ & x24);
  assign new_n67_ = ~new_n56_ & ~new_n38_ & (new_n68_ | new_n70_);
  ...
  assign new_n76_ = ~x10 & x11 & x14 & x20 & x21 & ~x24;
  assign z4 = (~new_n38_ & ~new_n39_ & (new_n79_ | x08)) | (z7 & (new_n78_ | ~x08));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n79_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = (~new_n38_ & ~new_n39_ & (new_n82_ | x03)) | (z7 & (new_n81_ | ~x03));
