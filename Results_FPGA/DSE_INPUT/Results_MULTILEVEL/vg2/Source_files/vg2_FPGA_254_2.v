...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (~x02 | x08)) | (x00 & ~x02 & ~x10 & ~x24);
  ...
  assign z7 = (~new_n65_ & (~x02 | x08)) | (~x02 & ~x10 & x21 & ~x24);
  ...
  assign z4 = new_n78_ | (~x02 & (new_n82_ | new_n84_ | (new_n86_ & ~x10)));
  assign new_n78_ = x08 & (new_n79_ | (~new_n50_ & (x19 | (new_n81_ & x15))));
  assign new_n79_ = x24 & ~new_n61_ & (x07 | (new_n80_ & x16));
  assign new_n80_ = x18 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n81_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n82_ = ~new_n50_ & ((~x08 & x15) | (new_n83_ & ~x16));
  assign new_n83_ = x19 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n84_ = x24 & ~new_n61_ & ((new_n85_ & x07) | (~x08 & x18));
  assign new_n85_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n86_ = ~x24 & ((x21 & (new_n81_ | ~x08)) | (x00 & (new_n85_ | x08)));
