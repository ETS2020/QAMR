...
module FAU ( 
  ...
  assign z5 = (~x03 & ~x10 & ~x24 & x00 & ~x02) | (~new_n74_ & (x02 | ~x03));
  assign new_n74_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = (~new_n61_ & (x02 | ~x03)) | (~x02 & ~x03 & ~x10 & x21 & ~x24);
  assign new_n76_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n77_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = new_n82_ | (~new_n79_ & ~x03);
  assign new_n79_ = new_n80_ & (x11 | new_n37_ | (~x06 & (x14 | ~x20)));
  assign new_n80_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n81_ & (x05 | x13 | ~x15);
  assign new_n81_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n82_ = x02 & ((x24 & ~new_n83_ & (x05 | x13)) | (~new_n85_ & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n83_ = (~x03 | ~x07) & (~x11 | new_n84_ | ~x18);
  assign new_n84_ = x06 & (~x14 | x20);
  assign new_n85_ = (~x03 | ~x19) & (~x11 | new_n84_ | ~x15);
endmodule
