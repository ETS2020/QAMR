...
module FAU ( 
  ...
  assign z7 = (~new_n62_ & (x02 | x22)) | (x21 & x22 & ~x24 & ~x02 & ~x10);
  ...
  assign new_n80_ = z5 & (x08 | (x09 & ~x16));
  assign new_n81_ = x02 & ((new_n82_ & ~x16) | (~new_n62_ & (~x08 | (~x09 & x16))));
  assign new_n82_ = ~x22 & ~new_n38_ & (x17 | (x04 & ~x23));
