...
module FAU ( 
  ...
  assign z5 = (~new_n37_ & (x02 | x20)) | (~x10 & x20 & ~x24 & x00 & ~x02);
  assign z7 = (~new_n74_ & (x02 | x20)) | (x20 & x21 & ~x24 & ~x02 & ~x10);
  ...
  assign z6 = ~new_n78_ | (z7 & (~x03 | (~x06 & x11)));
  assign new_n78_ = ~new_n83_ & (~x24 | new_n82_ | (~x05 & ~x13)) & (new_n79_ | (x05 ? (~x13 | x24) : x13));
  assign new_n79_ = (new_n80_ | ~x19) & (~new_n81_ | ~x14 | ~x15 | x20);
  assign new_n80_ = ((~x02 & ~x20) | (~x03 & (~x06 | x11))) & (x11 | x14 | ~x20);
  assign new_n81_ = x02 & x11;
  assign new_n82_ = (new_n80_ | ~x07) & (~new_n81_ | ~x14 | ~x18 | x20);
  assign new_n83_ = x00 & ~x02 & new_n84_ & ~x10;
  assign new_n84_ = x20 & ~x24 & (x03 | (~x11 & (x06 | ~x14)));
endmodule
