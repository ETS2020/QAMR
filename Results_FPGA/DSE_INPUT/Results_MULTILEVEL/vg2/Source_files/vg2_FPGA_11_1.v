...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (x02 | ~x21)) | (x00 & ~x02 & ~x10 & ~x21 & ~x24);
  assign new_n38_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z1 = new_n56_ | (~new_n60_ & (new_n40_ | new_n49_));
  ...
  assign new_n56_ = new_n57_ & new_n59_ & ~x02 & ~x03 & x00 & ~x01;
  assign new_n57_ = new_n58_ & ~x14 & ~x16 & ~x17 & ~x11 & ~x12;
  assign new_n58_ = ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n59_ = ~x04 & ~x06 & ~x08 & ~x09 & ~x10;
  assign new_n60_ = ~x02 & x21;
  assign z2 = x01 & x03 & new_n62_ & x06;
  assign new_n62_ = x11 & x14 & z7 & x20;
  assign z7 = ~new_n60_ & ~new_n64_;
  assign new_n64_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (new_n75_ & new_n76_) | (~new_n60_ & (new_n66_ | new_n70_));
  ...
  assign new_n75_ = ~x03 & ~x06 & ~x08 & x00 & ~x01 & ~x02;
  assign new_n76_ = ~x20 & ~x21 & ~x24 & ~x10 & ~x11 & ~x14;
  assign z4 = (~new_n60_ & ~new_n64_ & (new_n79_ | ~x08)) | (z5 & (new_n78_ | x08));
  assign new_n78_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n79_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (~new_n60_ & ~new_n64_ & (new_n82_ | ~x03)) | (z5 & (new_n81_ | x03));
