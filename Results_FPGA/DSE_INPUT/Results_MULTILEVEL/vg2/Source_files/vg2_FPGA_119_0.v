...
module FAU ( 
  ...
  assign new_n69_ = (new_n70_ | (~x20 & ~x21)) & (~new_n39_ | x10 | ~x20 | x24);
  assign new_n70_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign z7 = new_n60_ | (~new_n56_ & (x20 | x21));
  ...
  assign z6 = (~new_n77_ & x20) | (~new_n78_ & x21);
  assign new_n77_ = (new_n37_ | (~x03 & (x11 | (~x06 & x14)))) & (new_n56_ | (x03 & (x06 | ~x11)));
  assign new_n78_ = ~new_n79_ & ~new_n38_ & (new_n70_ | (~x03 & (~x06 | x11)));
