// Benchmark "FAU" written by ABC on Sat Aug  8 22:07:43 2020
...
module FAU ( 
  ...
  assign new_n36_ = ~x06 & x09 & ~x11 & ~x14 & ~new_n37_ & ~x20;
  ...
  assign new_n50_ = x09 & ~x11 & ~x14 & ~new_n51_ & ~x20;
  ...
  assign new_n55_ = ~x08 & x09 & ~x11 & ~x14 & ~x20;
  assign new_n56_ = (~new_n57_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n58_ | x01 | x03 | x06 | x08);
  assign new_n57_ = x11 & x14 & x15 & x20;
  assign new_n58_ = x09 & ~x11 & ~x14 & x19 & ~x20;
  assign z4 = ~new_n60_ | (~new_n63_ & (x09 | x14));
  assign new_n60_ = x16 ? (new_n42_ | new_n62_) : (new_n37_ | new_n61_);
  assign new_n61_ = ~x09 & (~x14 | x22 | (~x17 & (~x04 | x23)));
  assign new_n62_ = x09 ? (~x22 | (x17 & (x04 | ~x23))) : ~x14;
  assign new_n63_ = (x24 | (~new_n64_ & (~x05 | new_n65_ | ~x13))) & (~x24 | new_n66_ | (~x05 & ~x13)) & (x05 | new_n65_ | x13);
  assign new_n64_ = ~x02 & ~x10 & (x08 ? x00 : x21);
  assign new_n65_ = x08 ? ~x19 : ~x15;
  assign new_n66_ = x08 ? ~x07 : ~x18;
  assign z5 = ~new_n37_ & (x09 | x14);
  assign z6 = ~new_n70_ | (~new_n69_ & (x09 | x14));
  ...
  assign new_n72_ = (~x00 | ~x09 | x11 | x14 | ~x20) & (x20 | ~x21 | ~x11 | ~x14);
  assign new_n73_ = (~x09 | x11 | x14 | ~x19 | ~x20) & (~x15 | x20 | ~x11 | ~x14);
  assign new_n74_ = (~x07 | ~x09 | x11 | x14 | ~x20) & (~x18 | x20 | ~x11 | ~x14);
  assign z7 = ~new_n42_ & (x09 | x14);
endmodule
