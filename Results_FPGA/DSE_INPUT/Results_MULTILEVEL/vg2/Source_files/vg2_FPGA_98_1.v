// Benchmark "FAU" written by ABC on Sat Aug  8 22:07:21 2020
...
module FAU ( 
  ...
  assign z7 = (~new_n48_ & x05) | new_n49_ | (x15 & (new_n50_ | (~x05 & ~x13)));
  assign new_n48_ = (~x18 | x21 | ~x24) & (~x13 | ~x15 | x24);
  assign new_n49_ = x18 & x24 & (x15 | (x13 & ~x21));
  assign new_n50_ = ~x02 & ~x10 & x21 & ~x24;
  assign z2 = x01 & x03 & new_n52_ & x06;
  assign new_n52_ = x11 & x14 & z7 & x20;
  assign z3 = x01 ? (x03 & x06 & new_n52_ & x08) : (~x03 & ~x06 & new_n36_ & ~x08);
  assign z4 = new_n55_ | new_n62_ | (~new_n59_ & x08) | (z7 & (new_n63_ | ~x08));
  assign new_n55_ = ~x16 & ~new_n56_ & ~new_n58_;
  assign new_n56_ = (new_n57_ | x21) & (~x07 | x08 | ~x15 | ~x24);
  assign new_n57_ = ~new_n38_ & ~new_n39_ & ~new_n40_ & ~new_n41_;
  assign new_n58_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n59_ = (new_n60_ | (~x15 & x21)) & (~x19 | new_n61_ | x21);
  assign new_n60_ = ~new_n40_ & (~x07 | ~x24 | (~x05 & ~x13));
  assign new_n61_ = x05 ? (~x13 | x24) : x13;
  assign new_n62_ = x15 & ~new_n61_ & x19;
  assign new_n63_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = new_n65_ | new_n62_ | (~new_n59_ & x03) | (z7 & (new_n67_ | ~x03));
  assign new_n65_ = ~x11 & ~new_n66_ & (x06 | (~x14 & x20));
  assign new_n66_ = (new_n57_ | x21) & (x03 | ~x07 | ~x15 | ~x24);
