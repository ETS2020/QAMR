...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (x02 | x04)) | (x00 & ~x02 & x04 & ~x10 & ~x24);
  ...
  assign z7 = (~new_n63_ & (x02 | x04)) | (~x02 & x04 & ~x10 & x21 & ~x24);
  assign new_n63_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (x04 & (new_n65_ | new_n70_ | new_n75_)) | (x02 & (new_n70_ | new_n79_));
  ...
  assign new_n70_ = x24 & ~new_n59_ & (new_n71_ | new_n73_);
  ...
  assign new_n83_ = (new_n84_ | (~x02 & ~x04)) & (~new_n49_ | ~x04 | x16);
  assign new_n84_ = ~x08 & (x16 | (~x09 & (~x17 | x22)));
  assign new_n85_ = x02 & ~x04 & x15 & x16 & x22 & x23;
  assign new_n86_ = ~new_n87_ & (~x24 | new_n59_ | (~new_n89_ & (new_n83_ | ~x07)));
  assign new_n87_ = x00 & ~x02 & x04 & ~x10 & ~new_n88_ & ~x24;
  assign new_n88_ = ~x08 & (x16 | (~x09 & (x22 | (~x17 & x23))));
