...
module FAU ( 
  ...
  assign z7 = (~new_n62_ & (~x04 | ~x21)) | (~x02 & ~x04 & ~x10 & x21 & ~x24);
  ...
  assign z4 = new_n79_ | (~x04 & (new_n82_ | new_n87_ | (~new_n84_ & ~new_n86_)));
  assign new_n79_ = ~x21 & ((~new_n37_ & (new_n80_ | x08)) | (~new_n62_ & (new_n81_ | ~x08)));
  ...
  assign z6 = new_n90_ | (~new_n91_ & ~new_n39_) | (x00 & new_n94_ & ~x02);
  assign new_n90_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n91_ = ~new_n93_ & (new_n83_ | (~x03 & (new_n92_ | x11)));
  assign new_n92_ = ~x06 & (x14 | ~x20);
  assign new_n93_ = x00 & ~x02 & x03 & ~x10 & ~x24;
  assign new_n94_ = ~x10 & ~x11 & ~x21 & ~new_n92_ & ~x24;
endmodule
