...
module FAU ( 
  ...
  assign new_n68_ = x11 & x14 & x17 & ~new_n43_ & x20;
  ...
  assign new_n72_ = x11 & x14 & x17 & x18 & x20;
  assign new_n73_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n74_ = (~new_n76_ | x01 | x03 | x06 | x08) & (~new_n75_ | ~x06 | ~x08 | ~x01 | ~x03);
  assign new_n75_ = x11 & x14 & x15 & x17 & x20;
  assign new_n76_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = new_n78_ | (~new_n64_ & (new_n80_ | ~x08));
  assign new_n78_ = ~new_n37_ & ((~x16 & ((x17 & ~x22) | (~new_n79_ & ~x08))) | (x08 & x17));
  assign new_n79_ = ~x09 & (~x04 | x22 | x23);
  assign new_n80_ = x16 & x17 & (~x09 | (new_n55_ & ~x04));
  assign z5 = ~new_n37_ & (~x08 | (x17 & (x08 | (~x16 & ~x22))));
  assign z6 = (new_n83_ | new_n84_) & (~x08 | x17);
