...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (~x02 | ~x10)) | (x00 & ~x02 & ~x10 & ~x24);
  assign new_n38_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z1 = ((~x02 | ~x10) & (new_n40_ | new_n49_)) | (~x02 & new_n56_ & ~x10);
  ...
  assign new_n56_ = ~x24 & (new_n58_ | (new_n41_ & new_n57_));
  assign new_n57_ = new_n51_ & x22 & x23 & x20 & x21;
  assign new_n58_ = new_n54_ & new_n55_ & new_n59_ & x00 & ~x01 & ~x03;
  assign new_n59_ = ~x04 & ~x06 & ~x08 & ~x09;
  assign z2 = new_n61_ & x01;
  assign new_n61_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = (~new_n63_ & (~x02 | ~x10)) | (x21 & ~x24 & ~x02 & ~x10);
  assign new_n63_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n65_ & (~x02 | ~x10)) | (~x02 & ~x10 & ~new_n74_ & ~x24);
  assign new_n65_ = (new_n66_ | (x05 ? (~x13 | x24) : x13)) & (~x24 | new_n69_ | (~x05 & ~x13));
  assign new_n66_ = (~new_n67_ | ~x01 | ~x03 | ~x06 | ~x08) & (~new_n68_ | x06 | x08 | x01 | x03);
  assign new_n67_ = x15 & x20 & x11 & x14;
  assign new_n68_ = ~x11 & ~x14 & x19 & ~x20;
  assign new_n69_ = (~new_n72_ | ~new_n73_) & (~new_n70_ | ~new_n71_);
  assign new_n70_ = x06 & x08 & x01 & x03;
  assign new_n71_ = x18 & x20 & x11 & x14;
  assign new_n72_ = ~x06 & x07 & ~x01 & ~x03;
  assign new_n73_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n74_ = ~new_n75_ & (~new_n73_ | x03 | x06 | ~x00 | x01);
  assign new_n75_ = new_n70_ & x20 & x21 & x11 & x14;
