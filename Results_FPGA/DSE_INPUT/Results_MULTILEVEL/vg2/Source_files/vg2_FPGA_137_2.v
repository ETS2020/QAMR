...
module FAU ( 
  ...
  assign z7 = (~new_n64_ & (~x02 | x23)) | (~x02 & ~x10 & x21 & ~x24);
  assign new_n64_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~x02 & (new_n66_ | new_n70_ | (new_n76_ & ~x10))) | (x23 & (new_n66_ | new_n70_));
  ...
  assign z4 = (~new_n79_ & ~x02) | (x23 & (new_n88_ | (~new_n64_ & ~new_n89_)));
  assign new_n79_ = (new_n80_ | (~new_n86_ & ~x08)) & ~new_n84_ & (new_n82_ | (~new_n87_ & x08));
  ...
  assign new_n84_ = new_n85_ & ~x04 & ~x10 & x16;
  assign new_n85_ = x21 & x22 & x23 & ~x24;
  assign new_n86_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n87_ = x16 & (~x09 | (~x17 & x22));
  assign new_n88_ = ~new_n38_ & (x08 | (~x16 & (x09 | (x17 & ~x22))));
  assign new_n89_ = x08 & (~x16 | (x09 & (~x22 | (x04 & x17))));
