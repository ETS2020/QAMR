...
module FAU ( 
  ...
  assign z5 = (~new_n79_ & (~x02 | x11)) | (x00 & ~x02 & ~x10 & ~x24);
  assign new_n79_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = new_n65_ | (~new_n81_ & (~x02 | x11));
  ...
  assign z6 = new_n92_ | (~x02 & ((~new_n85_ & ~x24) | new_n91_ | (new_n90_ & x24)));
  assign new_n85_ = ~new_n86_ & (~new_n89_ | x10) & (x03 | (~new_n88_ & (x10 | ~x21)));
  assign new_n86_ = ~new_n87_ & ((x05 & x13 & x19) | (x00 & ~x10));
  assign new_n87_ = ~x03 & (x11 | (~x06 & (x14 | ~x20)));
  assign new_n88_ = x05 & x13 & x15;
  assign new_n89_ = x11 & x21 & (~x06 | (x14 & ~x20));
  assign new_n90_ = ~new_n61_ & ((~new_n87_ & x07) | (~x03 & x18));
  assign new_n91_ = ~x05 & ~x13 & ((~new_n87_ & x19) | (~x03 & x15));
  assign new_n92_ = x11 & ((x24 & ~new_n93_ & (x05 | x13)) | (~new_n94_ & (x05 ? (x13 & ~x24) : ~x13)));
  assign new_n93_ = (~x03 | ~x07) & (~x18 | (x03 & x06 & (~x14 | x20)));
  assign new_n94_ = (~x15 | (x03 & x06 & (~x14 | x20))) & (~x03 | ~x19);
endmodule
