...
module FAU ( 
  ...
  assign new_n69_ = (new_n70_ | (~x06 & ~x21)) & (~new_n39_ | ~x06 | x10 | x24);
  assign new_n70_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (x05 | x13 | ~x19) & (~x07 | ~x13 | ~x24);
  assign z7 = new_n60_ | (~new_n56_ & (x06 | x21));
  ...
  assign z6 = (~new_n77_ & x06) | (x21 & (~new_n83_ | (~new_n78_ & ~x24)));
  assign new_n77_ = (new_n37_ | (~x03 & x11)) & (new_n56_ | (x03 & (~x11 | ~x14 | x20)));
  assign new_n78_ = new_n79_ & (new_n82_ | (x03 & (x06 | ~x11)));
  assign new_n79_ = ~new_n80_ & (~x05 | ~x13 | new_n81_ | ~x19);
  assign new_n80_ = ~x02 & ~x10 & (x00 | (x11 & x14 & ~x20));
  assign new_n81_ = ~x03 & (x11 | x14 | ~x20);
  assign new_n82_ = (x02 | x10) & (~x05 | ~x13 | ~x15);
  assign new_n83_ = (new_n52_ | new_n81_) & (new_n84_ | (x03 & (x06 | ~x11)));
