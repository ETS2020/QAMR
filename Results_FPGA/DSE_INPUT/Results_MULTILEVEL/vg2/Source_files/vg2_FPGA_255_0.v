...
module FAU ( 
  ...
  assign z4 = (~new_n62_ & (x06 | x16)) | (x06 & new_n60_ & ~x16) | (new_n61_ & x16);
  ...
  assign new_n68_ = ~new_n37_ & (x06 | (~x14 & x16 & x20));
  assign new_n69_ = ~new_n42_ & (x06 ? (x14 & ~x20) : x16);
