...
module FAU ( 
  ...
  assign z1 = new_n39_ | new_n56_ | (x24 & ~new_n50_ & (x05 | x13));
  ...
  assign z3 = new_n70_ | (x24 & ~new_n68_ & (x05 | x13)) | (~new_n64_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n64_ = ~new_n65_ & (~new_n67_ | ~x11 | ~x14 | ~x15 | ~x20);
  assign new_n65_ = new_n66_ & ~x08 & ~x11 & ~x14 & x19 & ~x20;
  assign new_n66_ = ~x01 & x02 & ~x03 & ~x06;
  assign new_n67_ = x01 & x03 & x06 & x08;
  assign new_n68_ = ~new_n69_ & (~new_n67_ | ~x11 | ~x14 | ~x18 | ~x20);
  assign new_n69_ = new_n66_ & x07 & ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n70_ = new_n71_ & x01 & ~x02 & x03 & x06 & x08;
  assign new_n71_ = x20 & x21 & ~x24 & ~x10 & x11 & x14;
  assign z4 = (~new_n74_ & (~x08 | (~new_n77_ & x16))) | (z5 & (x08 | (~new_n76_ & ~x16)));
  assign z5 = (~new_n37_ & (x02 | x03)) | (x00 & ~x02 & x03 & ~x10 & ~x24);
  assign new_n74_ = (new_n75_ | (~x02 & ~x03)) & (x10 | ~x21 | x24 | x02 | ~x03);
  assign new_n75_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n76_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n77_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n79_ & x03) | (x02 & (new_n87_ | (new_n84_ & x24)));
  assign new_n79_ = (~new_n80_ | ~x24) & ~new_n82_ & (x02 | x10 | new_n83_ | x24);
  assign new_n80_ = (x05 | x13) & (x07 | (x11 & ~new_n81_ & x18));
  assign new_n81_ = x06 & (~x14 | x20);
  assign new_n82_ = ~new_n49_ & (x19 | (x11 & ~new_n81_ & x15));
  assign new_n83_ = ~x00 & (~x11 | new_n81_ | ~x21);
  assign new_n84_ = (x05 | x13) & (new_n85_ | (~x03 & x18));
  assign new_n85_ = x07 & ~new_n86_ & ~x11;
  assign new_n86_ = ~x06 & (x14 | ~x20);
  assign new_n87_ = ~new_n49_ & ((~x11 & ~new_n86_ & x19) | (~x03 & x15));
  assign z7 = (~x10 & x21 & ~x24 & ~x02 & x03) | (~new_n75_ & (x03 | (x02 & ~x03)));
endmodule
