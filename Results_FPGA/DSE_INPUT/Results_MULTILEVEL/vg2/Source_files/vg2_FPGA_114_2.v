// Benchmark "FAU" written by ABC on Sat Aug  8 22:07:28 2020
...
module FAU ( 
  ...
  assign new_n53_ = ~new_n54_ & (new_n55_ | x13) & (~x07 | ~x13 | ~x21 | ~x24);
  assign new_n54_ = x05 & ((x07 & ~x13 & x24) | (x13 & x19 & x21 & ~x24));
  assign new_n55_ = (x05 | ~x19) & (x10 | x24 | ~x00 | x02);
  assign new_n56_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n57_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n58_ = x00 & ~x02 & ~x10 & x21 & ~x24;
  assign z6 = (~new_n53_ & (new_n60_ | x03)) | new_n58_ | (z7 & (new_n61_ | ~x03));
