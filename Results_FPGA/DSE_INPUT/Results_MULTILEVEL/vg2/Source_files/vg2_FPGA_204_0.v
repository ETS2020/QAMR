...
module FAU ( 
  ...
  assign new_n52_ = ~x11 & ~x14 & x17 & ~new_n53_ & ~x20;
  ...
  assign new_n57_ = ~x08 & ~x11 & ~x14 & x17 & ~x20;
  assign new_n58_ = (~new_n59_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n60_ | x01 | x03 | x06 | x08);
  assign new_n59_ = x11 & x14 & x15 & x20;
  assign new_n60_ = ~x11 & ~x14 & x17 & x19 & ~x20;
  assign z4 = (~new_n38_ & (new_n62_ | x08)) | (~new_n43_ & (x08 ? new_n63_ : x17));
  assign new_n62_ = ~x16 & x17 & (x09 | ~x22);
  assign new_n63_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z6 = (x08 | x17) & (new_n65_ | new_n66_);
