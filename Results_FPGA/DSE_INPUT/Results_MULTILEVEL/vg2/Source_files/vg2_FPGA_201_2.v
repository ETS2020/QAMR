// Benchmark "FAU" written by ABC on Sat Aug  8 22:08:06 2020
...
module FAU ( 
  ...
  assign z1 = new_n40_ | (new_n57_ & ~x02) | (x24 & ~new_n51_ & ~new_n62_);
  ...
  assign new_n51_ = ~new_n52_ & (~new_n41_ | ~new_n55_ | ~new_n56_ | ~x22 | ~x23);
  assign new_n52_ = new_n46_ & new_n53_ & new_n54_ & new_n49_ & ~x17 & ~x20;
  ...
  assign new_n58_ = new_n54_ & new_n49_ & ~x17 & ~x20;
  assign new_n59_ = new_n55_ & x20 & x21 & x22 & x23;
  ...
  assign z7 = (~new_n66_ & (~x02 | x17)) | (x21 & ~x24 & ~x02 & ~x10);
  assign new_n66_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~x02 & (new_n68_ | new_n73_ | (new_n77_ & ~x10))) | (x17 & (new_n68_ | new_n73_));
  assign new_n68_ = ~new_n50_ & (new_n69_ | (new_n71_ & new_n72_ & x15 & x20));
  assign new_n69_ = new_n70_ & ~x01 & ~x03 & ~x06 & ~x08;
  ...
  assign new_n74_ = (~new_n75_ | ~new_n76_) & (~new_n71_ | ~new_n56_ | ~new_n72_);
  ...
  assign z4 = (~new_n80_ & ~x02) | (x17 & (new_n89_ | (~new_n66_ & ~new_n90_)));
  assign new_n80_ = (x24 | (~new_n81_ & ~new_n83_ & ~new_n85_)) & ~new_n88_ & (~new_n87_ | ~x24);
  assign new_n81_ = ~new_n82_ & ((x00 & ~x10) | (x05 & x13 & x19));
  assign new_n82_ = ~x08 & (x16 | (~x09 & (~x04 | x22 | x23)));
  assign new_n83_ = ~new_n84_ & ((x05 & x13 & x15) | (~x10 & x21));
  assign new_n84_ = x08 & (~x16 | (x09 & (x17 | ~x22)));
  assign new_n85_ = ~x10 & (new_n86_ | (x17 & ~x22 & x00 & ~x16));
  assign new_n86_ = ~x04 & x16 & x21 & x22 & x23;
  assign new_n87_ = ~new_n62_ & ((~new_n84_ & x18) | (~new_n82_ & x07));
  assign new_n88_ = ~x05 & ~x13 & ((~new_n82_ & x19) | (~new_n84_ & x15));
  assign new_n89_ = ~new_n38_ & (x08 | (~x16 & (x09 | ~x22)));
  assign new_n90_ = x08 & (~x16 | (x09 & (x04 | ~x22 | ~x23)));
