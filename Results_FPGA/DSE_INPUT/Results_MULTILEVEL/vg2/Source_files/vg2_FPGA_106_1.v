...
module FAU ( 
  ...
  assign z5 = (~new_n38_ & (x02 | ~x17)) | (x00 & ~x02 & ~x10 & ~x17 & ~x24);
  assign new_n38_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z1 = new_n40_ | new_n50_ | new_n56_;
  ...
  assign z4 = (~new_n86_ & x02) | (~x17 & (new_n80_ | (~new_n83_ & ~new_n84_)));
  assign new_n80_ = ~new_n81_ & (~x08 | (x16 & (~x09 | x22)));
  assign new_n81_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n82_ & (x05 | x13 | ~x15);
  assign new_n82_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n83_ = ~x08 & (x16 | (~x09 & (~new_n49_ | ~x04)));
  assign new_n84_ = (~x05 | ((~x13 | ~x19 | x24) & (~x07 | ~x24))) & (~x07 | ~x13 | ~x24) & ~new_n85_ & (x05 | x13 | ~x19);
  assign new_n85_ = x00 & ~x02 & ~x10 & ~x24;
  assign new_n86_ = (new_n62_ | (x08 & (new_n87_ | ~x16))) & (new_n38_ | (~x08 & (new_n88_ | x16)));
  assign new_n87_ = x09 & (x04 | ~x22 | ~x23);
  assign new_n88_ = ~x09 & (~x17 | x22);
