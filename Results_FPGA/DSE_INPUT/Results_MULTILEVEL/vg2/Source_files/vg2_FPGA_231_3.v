...
module FAU ( 
  ...
  assign new_n64_ = x06 & x11 & x14 & ~x15 & ~new_n65_ & x20;
  ...
  assign z4 = new_n76_ | (~new_n82_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n76_ = (~x15 | ~x20) & (~new_n77_ | (~new_n37_ & x08));
  assign new_n77_ = (x16 | new_n78_ | new_n81_) & (new_n65_ | new_n79_);
  assign new_n78_ = ~new_n38_ & (~x07 | new_n62_ | ~x24);
  assign new_n79_ = ~new_n80_ & x08;
  assign new_n80_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n81_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n82_ = x15 ? (new_n79_ | x20) : (x16 | new_n81_ | ~x19);
  assign z5 = ~new_n37_ & (~x15 | ~x20);
  assign z6 = ~new_n87_ | (~new_n85_ & (~x15 | ~x20));
  assign new_n85_ = (new_n78_ | (~x03 & (~x06 | x11))) & (~new_n86_ | ~x03) & (new_n65_ | (x03 & (x06 | ~x11)));
  assign new_n86_ = x19 & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n87_ = (x24 | (~new_n88_ & (~x05 | new_n90_ | ~x13))) & (~x24 | new_n93_ | (~x05 & ~x13)) & (x05 | new_n90_ | x13);
  assign new_n88_ = ~x02 & ~new_n89_ & ~x10;
  assign new_n89_ = (~x00 | x11 | x14 | x15 | ~x20) & (~x11 | ~x14 | x20 | ~x21);
  assign new_n90_ = (~x15 | x20 | (x03 & (new_n91_ | ~x11))) & (x11 | ~new_n92_ | x15);
  assign new_n91_ = x06 & ~x14;
  assign new_n92_ = x19 & (x06 | (~x14 & x20));
  assign new_n93_ = (~x07 | x11 | x14 | x15 | ~x20) & (~x18 | x20 | ~x11 | ~x14);
  assign z7 = (~new_n65_ & (~x15 | ~x20)) | (x15 & ~x20 & (x05 ? (x13 & ~x24) : ~x13));
endmodule
