...
module FAU ( 
  ...
  assign new_n64_ = x02 & (new_n48_ | (~new_n58_ & (x05 ? (x13 & ~x24) : ~x13)));
  assign z2 = new_n66_ & x01;
  assign new_n66_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = (~new_n68_ & (x02 | ~x10)) | (x21 & ~x24 & ~x02 & ~x10);
  assign new_n68_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~x10 & (new_n75_ | new_n70_ | new_n78_)) | (x02 & (new_n70_ | new_n82_));
