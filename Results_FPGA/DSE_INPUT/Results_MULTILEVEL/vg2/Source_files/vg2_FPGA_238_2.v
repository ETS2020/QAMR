// Benchmark "FAU" written by ABC on Sat Aug  8 22:08:22 2020
...
module FAU ( 
  ...
  assign new_n61_ = x06 & x11 & x14 & x20 & ~new_n62_ & x21;
  ...
  assign new_n77_ = (new_n78_ | (x01 & ~x21)) & (~new_n63_ | ~x00 | x01);
  assign new_n78_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = (~new_n80_ & (~x01 | x21)) | (x21 & ~x24 & ~x02 & ~x10);
