...
module FAU ( 
  ...
  assign new_n36_ = ~x11 & ~x14 & ~x20 & ~new_n37_ & (~x08 | ~x17);
  ...
  assign new_n49_ = x11 & x14 & ~x17 & ~new_n50_ & x20;
  ...
  assign new_n55_ = x11 & x14 & ~x17 & x18 & x20;
  assign new_n56_ = ~x14 & ~x20 & ~x08 & ~x11;
  assign new_n57_ = (~new_n58_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n59_ | x01 | x03 | x06 | x08);
  assign new_n58_ = x11 & x14 & x15 & ~x17 & x20;
  assign new_n59_ = ~x11 & ~x14 & x19 & ~x20;
  assign z4 = (~new_n45_ & (new_n61_ | ~x08)) | (~new_n37_ & (x08 ? ~x17 : new_n62_));
  assign new_n61_ = x16 & ~x17 & (~x09 | x22);
  assign new_n62_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z5 = ~new_n37_ & (~x08 | (x08 & ~x17));
  assign z6 = (new_n65_ | new_n66_) & (~x08 | ~x17);
  assign new_n65_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n66_ = ~new_n45_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
