// Benchmark "FAU" written by ABC on Sat Aug  8 22:07:19 2020
...
module FAU ( 
  ...
  assign z5 = ~new_n37_ & (~x03 | ~x11);
  assign z6 = new_n51_ | (new_n53_ & x24) | (~x02 & ~x10 & ~new_n55_ & ~x24);
  assign new_n51_ = (x05 ? (x13 & ~x24) : ~x13) & (new_n52_ | (~x03 & x15));
  assign new_n52_ = ~x11 & x19 & (x03 | x06 | (~x14 & x20));
  assign new_n53_ = (x05 | x13) & ((new_n54_ & x07) | (~x03 & x18));
  assign new_n54_ = ~x11 & (x03 | x06 | (~x14 & x20));
  assign new_n55_ = (x03 | ~x21) & (~new_n54_ | ~x00);
  assign z7 = ~new_n45_ & (~x03 | ~x11);
  assign z2 = 1'b0;
endmodule
