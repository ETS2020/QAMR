...
module FAU ( 
  ...
  assign new_n43_ = x06 & ~x09 & x11 & x14 & ~new_n44_ & x20;
  ...
  assign new_n48_ = ~x09 & x11 & x14 & ~new_n49_ & x20;
  ...
  assign new_n69_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n44_ | (x03 & (x06 | ~x11)));
  assign new_n70_ = (x24 | (~new_n71_ & (~x05 | new_n73_ | ~x13))) & (~x24 | new_n74_ | (~x05 & ~x13)) & (x05 | new_n73_ | x13);
  assign new_n71_ = ~x02 & ~new_n72_ & ~x10;
  assign new_n72_ = (x14 | ~x20 | ~x00 | x11) & (x09 | ~x11 | ~x14 | x20 | ~x21);
  assign new_n73_ = (~x19 | ~x20 | x11 | x14) & (~x14 | ~x15 | x20 | x09 | ~x11);
  assign new_n74_ = (~x07 | x11 | x14 | ~x20) & (~x14 | ~x18 | x20 | x09 | ~x11);
  assign z7 = ~new_n44_ & (~x09 | ~x14);
endmodule
