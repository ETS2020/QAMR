...
module FAU ( 
  ...
  assign z7 = (~new_n66_ & (~x21 | x22)) | (x21 & x22 & ~x24 & ~x02 & ~x10);
  assign new_n66_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n68_ & (~x21 | x22)) | (new_n78_ & new_n79_ & x21 & x22 & ~x24);
  ...
  assign new_n78_ = x06 & x08 & ~x10 & x01 & ~x02 & x03;
  assign new_n79_ = x11 & x14 & x20;
  assign z4 = new_n81_ | (~new_n88_ & ~x21);
  assign new_n81_ = x22 & (~new_n82_ | (~new_n87_ & (x08 | (x09 & ~x16))));
  assign new_n82_ = (new_n83_ | (~new_n86_ & x08)) & (~x00 | x02 | ~new_n85_ | ~x08);
  assign new_n83_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n84_ & (x05 | x13 | ~x15);
  assign new_n84_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n85_ = ~x10 & ~x24;
  assign new_n86_ = x16 & (~x09 | ~x17 | (~x04 & x23));
  assign new_n87_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n88_ = (new_n38_ | (~x08 & (x16 | (~new_n89_ & ~x09)))) & (new_n66_ | (x08 & (x09 | ~x16)));
  assign new_n89_ = ~x22 & (x17 | (x04 & ~x23));
  assign z6 = new_n91_ | new_n94_ | (~new_n92_ & (~x21 | x22));
  assign new_n91_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n92_ = (new_n87_ | (~new_n93_ & ~x03)) & (~new_n85_ | ~x03 | ~x00 | x02);
  assign new_n93_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n94_ = x00 & ~x02 & ~x10 & new_n95_ & ~x11;
  assign new_n95_ = ~x21 & ~x24 & (x06 | (~x14 & x20));
endmodule
