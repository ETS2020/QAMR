// Benchmark "FAU" written by ABC on Sat Aug  8 22:07:03 2020
...
module FAU ( 
  ...
  assign z5 = (~new_n37_ & (x02 | x14)) | (~x10 & x14 & ~x24 & x00 & ~x02);
  assign z7 = (~new_n74_ & (x02 | x14)) | (x14 & x21 & ~x24 & ~x02 & ~x10);
  ...
  assign z6 = ~new_n78_ | (z5 & (x03 | (x06 & ~x11)));
  assign new_n78_ = ~new_n79_ & ~new_n82_ & (x02 | x10 | ~new_n84_ | ~x14);
  assign new_n79_ = x24 & (x05 | x13) & (new_n81_ | (~new_n80_ & x18));
  assign new_n80_ = (~x11 | ~x14 | x20) & ((~x02 & ~x14) | (x03 & (x06 | ~x11)));
  assign new_n81_ = x02 & x07 & ~x11 & ~x14 & x20;
  assign new_n82_ = (new_n83_ | (~new_n80_ & x15)) & (x05 ? (x13 & ~x24) : ~x13);
  assign new_n83_ = x02 & ~x11 & ~x14 & x19 & x20;
