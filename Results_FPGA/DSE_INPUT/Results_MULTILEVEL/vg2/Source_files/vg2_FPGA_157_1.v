...
module FAU ( 
  ...
  assign new_n62_ = x06 & x11 & x12 & x14 & ~new_n63_ & x20;
  ...
  assign new_n67_ = x11 & x12 & x14 & ~new_n43_ & x20;
  ...
  assign z5 = ~new_n37_ & (x12 | ~x14);
  assign z6 = ~new_n83_ | (~new_n82_ & (x12 | ~x14));
  assign new_n82_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n63_ | (x03 & (x06 | ~x11)));
  assign new_n83_ = (x24 | (~new_n84_ & (~x05 | new_n86_ | ~x13))) & (~x24 | new_n87_ | (~x05 & ~x13)) & (x05 | new_n86_ | x13);
  assign new_n84_ = ~x02 & ~new_n85_ & ~x10;
  assign new_n85_ = (~x00 | x11 | x14 | ~x20) & (~x11 | ~x12 | ~x14 | x20 | ~x21);
  assign new_n86_ = (~x19 | ~x20 | x11 | x14) & (~x11 | ~x12 | ~x14 | ~x15 | x20);
  assign new_n87_ = (~x07 | x11 | x14 | ~x20) & (~x14 | ~x18 | x20 | ~x11 | ~x12);
  assign z7 = ~new_n63_ & (x12 | ~x14);
endmodule
