...
module FAU ( 
  ...
  assign z1 = (~x02 & (new_n40_ | (new_n50_ & x24) | (~x10 & ~new_n58_ & ~x24))) | (x10 & (new_n40_ | (new_n50_ & x24)));
  ...
  assign new_n50_ = ~new_n57_ & (new_n53_ | (new_n41_ & new_n51_));
  ...
  assign new_n58_ = (~new_n41_ | ~new_n59_) & (~new_n60_ | ~new_n55_ | ~new_n56_);
  ...
  assign z7 = (~new_n65_ & (~x02 | x10)) | (x21 & ~x24 & ~x02 & ~x10);
  assign new_n65_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~x02 & (new_n67_ | (new_n72_ & x24) | (~x10 & ~new_n75_ & ~x24))) | (x10 & (new_n67_ | (new_n72_ & x24)));
  ...
  assign new_n72_ = ~new_n57_ & (new_n73_ | (new_n70_ & new_n71_ & x18 & x20));
  assign new_n73_ = new_n74_ & ~x01 & ~x03 & ~x06 & x07;
  assign new_n74_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n75_ = ~new_n76_ & (~new_n70_ | ~new_n71_ | ~x20 | ~x21);
  ...
  assign z6 = (z5 & (x03 | (~new_n81_ & ~x11))) | (z7 & (~x03 | (~new_n82_ & x11)));
