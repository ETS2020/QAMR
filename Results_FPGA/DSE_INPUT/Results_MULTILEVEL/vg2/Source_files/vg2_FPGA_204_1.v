...
module FAU ( 
  ...
  assign new_n70_ = ~x11 & ~x14 & ~x17 & ~new_n47_ & ~x20;
  assign new_n71_ = ~new_n72_ & (~new_n74_ | x01 | x03 | x06 | ~x07);
  assign new_n72_ = new_n73_ & x18 & x20 & x11 & x14;
  assign new_n73_ = x06 & x08 & x01 & x03;
  assign new_n74_ = ~x08 & ~x11 & ~x14 & ~x17 & ~x20;
  assign new_n75_ = (~new_n77_ | x01 | x03 | x06 | x08) & (~new_n76_ | ~x06 | ~x08 | ~x01 | ~x03);
  assign new_n76_ = x15 & x20 & x11 & x14;
  assign new_n77_ = ~x11 & ~x14 & ~x17 & x19 & ~x20;
  assign z4 = new_n79_ | (~new_n38_ & (new_n81_ | x08));
  assign new_n79_ = ~new_n65_ & ((~x08 & ~x17) | (x16 & ((~new_n80_ & x08) | (~x17 & x22))));
  assign new_n80_ = x09 & (~new_n56_ | x04);
  assign new_n81_ = ~x16 & ~x17 & (x09 | (x04 & ~x22 & ~x23));
  assign z6 = (x08 | ~x17) & (new_n83_ | new_n84_);
  assign new_n83_ = ~new_n38_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n84_ = ~new_n65_ & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
endmodule
