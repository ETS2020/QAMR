...
module FAU ( 
  ...
  assign z5 = ~new_n45_ & (x03 | x11);
  assign z6 = (x24 & ~new_n54_ & (x05 | x13)) | new_n51_ | (~new_n55_ & (x05 ? (x13 & ~x24) : ~x13));
  assign new_n51_ = ~x02 & ~x10 & ~x24 & (new_n52_ | (x00 & x03));
  assign new_n52_ = x11 & ~new_n53_ & x21;
  assign new_n53_ = x03 & x06 & (~x14 | x20);
  assign new_n54_ = (~x11 | new_n53_ | ~x18) & (~x03 | ~x07);
  assign new_n55_ = (~x11 | new_n53_ | ~x15) & (~x03 | ~x19);
  assign z7 = ~new_n38_ & (x03 | (~new_n53_ & x11));
  assign z0 = 1'b0;
endmodule
