// Benchmark "FAU" written by ABC on Sat Aug  8 22:07:29 2020
...
module FAU ( 
  ...
  assign z1 = new_n39_ | new_n56_ | (x24 & ~new_n50_ & ~new_n59_);
  assign new_n39_ = ~new_n49_ & (new_n44_ | (new_n40_ & new_n42_));
  ...
  assign z5 = (~new_n37_ & (x02 | x11)) | (x00 & ~x02 & ~x10 & x11 & ~x24);
  assign z7 = (~new_n76_ & (x02 | x11)) | (x11 & x21 & ~x24 & ~x02 & ~x10);
  assign new_n76_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign new_n77_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n78_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign z6 = (~new_n80_ & x11) | (x02 & (new_n85_ | new_n87_));
  assign new_n80_ = (~x24 | new_n83_ | (~x05 & ~x13)) & ~new_n81_ & (new_n84_ | (x05 ? (~x13 | x24) : x13));
  assign new_n81_ = ~x02 & ~x10 & ~new_n82_ & ~x24;
  assign new_n82_ = (~x00 | ~x03) & (~x21 | (x03 & x06 & (~x14 | x20)));
  assign new_n83_ = (~x03 | ~x07) & (~x18 | (x03 & x06 & (~x14 | x20)));
  assign new_n84_ = (~x15 | (x03 & x06 & (~x14 | x20))) & (~x03 | ~x19);
  assign new_n85_ = ~new_n49_ & ((~x03 & x15) | (x19 & (new_n86_ | x03)));
  assign new_n86_ = ~x11 & (x06 | (~x14 & x20));
  assign new_n87_ = x24 & ~new_n59_ & ((x07 & (new_n86_ | x03)) | (~x03 & x18));
endmodule
