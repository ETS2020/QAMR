...
module FAU ( 
  ...
  assign z7 = (~new_n62_ & (x02 | x17)) | (x17 & x21 & ~x24 & ~x02 & ~x10);
  ...
  assign z4 = (x17 & (new_n80_ | (~new_n86_ & ~new_n88_))) | (~new_n83_ & x02);
  ...
  assign new_n83_ = (new_n38_ | (~x08 & (new_n84_ | x16))) & (new_n62_ | (x08 & (new_n85_ | ~x16)));
  assign new_n84_ = ~x09 & (~new_n49_ | ~x04);
  assign new_n85_ = x09 & (x17 | ~x22);
  assign new_n86_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n87_ & (x05 | x13 | ~x15);
  assign new_n87_ = ~x02 & ~x10 & x21 & ~x24;
  assign new_n88_ = x08 & (~x16 | (x09 & (x04 | ~x22 | ~x23)));
