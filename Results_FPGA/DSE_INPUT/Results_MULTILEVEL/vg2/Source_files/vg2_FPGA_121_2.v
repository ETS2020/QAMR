...
module FAU ( 
  ...
  assign z5 = (~new_n79_ & (~x02 | x14)) | (x00 & ~x02 & ~x10 & ~x24);
  assign new_n79_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = new_n65_ | (~new_n81_ & (~x02 | x14));
  ...
  assign z6 = (~x02 & (new_n85_ | ~new_n86_)) | (~new_n90_ & x14);
  assign new_n85_ = ~new_n37_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n86_ = ~new_n89_ & (new_n87_ | (x03 & (x06 | ~x11)));
  assign new_n87_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & ~new_n88_ & (x05 | x13 | ~x15);
  assign new_n88_ = ~x10 & x21 & ~x24;
  assign new_n89_ = new_n71_ & ~x10 & ~x20 & x21 & ~x24;
  assign new_n90_ = (new_n79_ | (~x03 & (~x06 | x11))) & (new_n81_ | (x03 & (~x11 | (x06 & x20))));
endmodule
