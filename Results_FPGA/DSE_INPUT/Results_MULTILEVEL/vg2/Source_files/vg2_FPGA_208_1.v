...
module FAU ( 
  ...
  assign new_n56_ = ~x22 & ~x23 & ~x20 & ~x21;
  assign new_n57_ = ~x04 & ~x06 & ~x01 & ~x03;
  assign new_n58_ = (~new_n61_ | ~new_n62_) & (~new_n51_ | ~new_n59_);
  assign new_n59_ = new_n60_ & x15 & x16 & x12 & x14;
  assign new_n60_ = x22 & x23 & x17 & x20;
  assign new_n61_ = new_n57_ & ~x11 & ~x12 & ~x08 & ~x09;
  assign new_n62_ = new_n56_ & ~x17 & x19 & ~x14 & ~x16;
  assign z2 = new_n64_ & x01;
  assign new_n64_ = x03 & x06 & x11 & x14 & z7 & x20;
  assign z7 = (~new_n66_ & (x08 | ~x21)) | (~x02 & x08 & ~x10 & x21 & ~x24);
  assign new_n66_ = (~x05 | ((~x18 | ~x24) & (~x13 | ~x15 | x24))) & (~x13 | ~x18 | ~x24) & (x05 | x13 | ~x15);
  assign z3 = (~new_n68_ & ~x24) | (~x05 & ~new_n75_ & ~x13) | (x24 & ~new_n71_ & (x05 | x13));
  assign new_n68_ = x01 ? (~x03 | ~x06 | ~new_n69_ | ~x08) : (x03 | x06 | ~new_n70_ | x08);
  assign new_n69_ = x11 & x14 & ~new_n44_ & x20;
  assign new_n70_ = ~x11 & ~x14 & ~x20 & ~new_n48_ & ~x21;
  assign new_n71_ = ~new_n72_ & (~new_n74_ | x01 | x03 | x06 | ~x07);
  assign new_n72_ = new_n73_ & x18 & x20 & x11 & x14;
  assign new_n73_ = x06 & x08 & x01 & x03;
  assign new_n74_ = ~x08 & ~x11 & ~x14 & ~x20 & ~x21;
  assign new_n75_ = (~new_n76_ | ~x06 | ~x08 | ~x01 | ~x03) & (~new_n77_ | x01 | x03 | x06 | x08);
  assign new_n76_ = x15 & x20 & x11 & x14;
  assign new_n77_ = ~x11 & ~x14 & x19 & ~x20 & ~x21;
  assign z4 = (~new_n85_ & ~x21) | (~new_n79_ & x08);
  assign new_n79_ = (~x24 | new_n83_ | (~x05 & ~x13)) & ~new_n80_ & (new_n84_ | (x05 ? (~x13 | x24) : x13));
  assign new_n80_ = ~x02 & ~x10 & ~new_n81_ & ~x24;
  assign new_n81_ = ~x00 & (~x16 | new_n82_ | ~x21);
  assign new_n82_ = x09 & (~x22 | (x17 & (x04 | ~x23)));
  assign new_n83_ = ~x07 & (~x16 | new_n82_ | ~x18);
  assign new_n84_ = ~x19 & (~x15 | new_n82_ | ~x16);
  assign new_n85_ = (new_n86_ | (x05 ? (~x13 | x24) : x13)) & ~new_n89_ & (~x24 | new_n88_ | (~x05 & ~x13));
  assign new_n86_ = (x08 | ~x15) & (x16 | new_n87_ | ~x19);
  assign new_n87_ = ~x09 & (x22 | (~x17 & (~x04 | x23)));
  assign new_n88_ = (x08 | ~x18) & (~x07 | new_n87_ | x16);
  assign new_n89_ = x00 & ~x02 & ~x10 & ~x16 & ~new_n87_ & ~x24;
  assign z6 = new_n91_ | new_n95_ | (~new_n92_ & (x08 | ~x21));
  assign new_n91_ = z7 & (~x03 | (x11 & (~x06 | (x14 & ~x20))));
  assign new_n92_ = ~new_n93_ & (~x00 | x02 | ~x03 | x10 | x24);
  assign new_n93_ = ~new_n94_ & (x03 | (~x11 & (x06 | (~x14 & x20))));
  assign new_n94_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign new_n95_ = x00 & ~x02 & ~x10 & new_n96_ & ~x11;
  assign new_n96_ = ~x21 & ~x24 & (x06 | (~x14 & x20));
endmodule
