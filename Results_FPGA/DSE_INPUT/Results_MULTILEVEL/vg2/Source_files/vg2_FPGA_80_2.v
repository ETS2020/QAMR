...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (x08 ? x14 : new_n77_)) | (~new_n63_ & (~x08 | (new_n78_ & x14)));
  assign new_n77_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign new_n78_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign z5 = ~new_n37_ & (~x08 | (x08 & x14));
  assign z6 = ~new_n82_ | (~new_n81_ & (~x08 | x14));
  assign new_n81_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n63_ | (x03 & (x06 | ~x11)));
  assign new_n82_ = (x24 | (~new_n83_ & (~x05 | new_n85_ | ~x13))) & (~x24 | new_n86_ | (~x05 & ~x13)) & (x05 | new_n85_ | x13);
  assign new_n83_ = ~x02 & ~new_n84_ & ~x10;
  assign new_n84_ = (~x00 | x08 | x11 | x14 | ~x20) & (~x11 | ~x14 | x20 | ~x21);
  assign new_n85_ = (x08 | x11 | x14 | ~x19 | ~x20) & (~x15 | x20 | ~x11 | ~x14);
  assign new_n86_ = (~x07 | x08 | x11 | x14 | ~x20) & (~x18 | x20 | ~x11 | ~x14);
  assign z7 = ~new_n63_ & (~x08 | x14);
endmodule
