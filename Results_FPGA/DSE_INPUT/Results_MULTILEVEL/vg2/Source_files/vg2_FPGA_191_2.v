// Benchmark "FAU" written by ABC on Sat Aug  8 22:08:02 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n74_, new_n75_, new_n76_, new_n79_, new_n81_, new_n82_, new_n83_,
  ...
  assign z3 = new_n67_ | (new_n72_ & x24) | (~x02 & ~x10 & ~new_n74_ & ~x24);
  ...
  assign new_n72_ = ~new_n61_ & (new_n73_ | (new_n70_ & new_n71_ & x18 & x20));
  assign new_n73_ = new_n69_ & x07 & ~x08 & ~x11 & ~x14 & ~x20;
  assign new_n74_ = ~new_n75_ & (~new_n70_ | ~new_n71_ | ~x20 | ~x21);
  assign new_n75_ = new_n76_ & x00 & ~x01 & ~x03 & ~x06;
  assign new_n76_ = ~x08 & ~x11 & ~x14 & ~x20;
  assign z4 = (z5 & (x08 | (~new_n82_ & ~x16))) | (z7 & (~x08 | (~new_n83_ & x16)));
  assign z5 = (~new_n79_ & (~x02 | x06)) | (x00 & ~x02 & ~x10 & ~x24);
  assign new_n79_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = new_n65_ | (~new_n81_ & (~x02 | x06));
  ...
  assign z6 = (~x02 & (~new_n91_ | (~new_n85_ & ~x24))) | (~new_n94_ & x06);
  assign new_n85_ = (new_n89_ | (~new_n88_ & (~x00 | x10))) & ~new_n86_ & (new_n90_ | x10);
  assign new_n86_ = ~new_n87_ & (~x03 | (~x06 & x11));
  assign new_n87_ = (~x05 | ~x13 | ~x15) & (x10 | ~x21);
  assign new_n88_ = x05 & x13 & x19;
  assign new_n89_ = ~x03 & (x11 | x14 | ~x20);
  assign new_n90_ = (~x00 | ~x06 | x11) & (~x11 | ~x14 | x20 | ~x21);
  assign new_n91_ = ~new_n92_ & (new_n93_ | (x03 & (x06 | ~x11)));
  assign new_n92_ = ~new_n89_ & ((~x05 & ~x13 & x19) | (x07 & x24 & (x05 | x13)));
  assign new_n93_ = (x05 | x13 | ~x15) & (~x18 | ~x24 | (~x05 & ~x13));
  assign new_n94_ = (new_n79_ | (~x03 & x11)) & (new_n81_ | (x03 & (~x11 | ~x14 | x20)));
endmodule
