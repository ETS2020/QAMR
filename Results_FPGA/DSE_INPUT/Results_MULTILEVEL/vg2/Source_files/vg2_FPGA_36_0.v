...
module FAU ( 
  ...
  assign new_n85_ = ~new_n69_ & ((~x00 & ~x02) | new_n68_ | (~new_n86_ & x08));
  assign new_n86_ = x16 & (~x09 | (x22 & (~x17 | (~x04 & x23))));
  assign new_n87_ = ~x16 & (x09 | (~x22 & (x17 | (x04 & ~x23))));
  assign z6 = new_n89_ | new_n69_ | (new_n90_ & (x00 | x02));
