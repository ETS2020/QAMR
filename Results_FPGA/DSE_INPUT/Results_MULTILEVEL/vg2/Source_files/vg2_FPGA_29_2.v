...
module FAU ( 
  ...
  assign z5 = (~new_n80_ & (~x02 | x20)) | (x00 & ~x02 & ~x10 & ~x24);
  assign new_n80_ = (~x05 | ((~x07 | ~x24) & (~x13 | ~x19 | x24))) & (~x07 | ~x13 | ~x24) & (x05 | x13 | ~x19);
  assign z7 = new_n65_ | (~new_n82_ & (~x02 | x20));
  ...
  assign z6 = (~x02 & (~new_n91_ | (~new_n86_ & ~x24))) | (~new_n94_ & x20);
  ...
  assign new_n94_ = (new_n80_ | (~x03 & (x11 | (~x06 & x14)))) & (new_n82_ | (x03 & (x06 | ~x11)));
endmodule
