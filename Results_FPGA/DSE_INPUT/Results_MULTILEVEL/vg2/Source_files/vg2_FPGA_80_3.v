...
module FAU ( 
  ...
  assign z4 = (~new_n37_ & (x08 ? ~x14 : new_n48_)) | (~new_n44_ & (~x08 | (new_n49_ & ~x14)));
  ...
  assign new_n52_ = (new_n37_ | (~x03 & (~x06 | x11))) & (new_n44_ | (x03 & (x06 | ~x11)));
  assign new_n53_ = (x24 | (~new_n54_ & (~x05 | new_n56_ | ~x13))) & (~x24 | new_n57_ | (~x05 & ~x13)) & (x05 | new_n56_ | x13);
  assign new_n54_ = ~x02 & ~new_n55_ & ~x10;
  assign new_n55_ = (x14 | ~x20 | ~x00 | x11) & (x08 | ~x11 | ~x14 | x20 | ~x21);
  assign new_n56_ = (~x19 | ~x20 | x11 | x14) & (~x14 | ~x15 | x20 | x08 | ~x11);
  assign new_n57_ = (~x07 | x11 | x14 | ~x20) & (~x14 | ~x18 | x20 | x08 | ~x11);
  assign z7 = ~new_n44_ & (~x08 | ~x14);
endmodule
