...
module FAU ( 
  ...
  assign z2 = (~x05 & (x04 | x12)) | (~new_n28_ & x04) | (~x04 & ~x06 & x12);
  assign new_n28_ = (~x12 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | x11 | x12);
  assign z3 = (~x05 & (x04 | x12)) | (~new_n30_ & x04) | (x12 & (x04 ? x13 : ~x07));
  assign new_n30_ = ((x02 & x03 & ~x09 & ~x11) | ~x13) & (~x02 | ~x03 | x09 | x11 | x12 | x13);
  assign z4 = new_n32_ & x03;
  assign new_n32_ = x08 & x10 & x14 & x15 & (x04 | x12);
endmodule
