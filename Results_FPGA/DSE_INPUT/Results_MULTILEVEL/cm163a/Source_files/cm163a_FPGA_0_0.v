...
module FAU ( 
  ...
  assign z0 = (~x05 & (x04 | x14)) | (~new_n24_ & x04) | (~x00 & ~x04 & x14);
  assign new_n24_ = (~x09 | (x02 & x03)) & (~x02 | ~x03 | x09);
  assign z1 = (~x05 & (x04 | x14)) | (~new_n26_ & x04) | (~x01 & ~x04 & x14);
  assign new_n26_ = (~x11 | (x02 & x03 & ~x09)) & (~x02 | ~x03 | x09 | x11);
  assign z2 = (~x05 & (x04 | x14)) | (~new_n28_ & x04) | (~x04 & ~x06 & x14);
  assign new_n28_ = (~x12 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | x11 | x12);
  assign z3 = (~x05 & (x04 | x14)) | (~new_n30_ & x04) | (~x04 & ~x07 & x14);
