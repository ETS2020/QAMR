...
module FAU ( 
  ...
  assign z0 = (~x04 & (~x00 | ~x05)) | (x08 & (~x05 | (~new_n24_ & x04)));
  assign new_n24_ = (~x09 | (x02 & x03)) & (~x02 | ~x03 | x09);
  assign z1 = (~x04 & (~x01 | ~x05)) | (x08 & (~x05 | (~new_n26_ & x04)));
  assign new_n26_ = (~x11 | (x02 & x03 & ~x09)) & (~x02 | ~x03 | x09 | x11);
  assign z2 = (~x04 & (~x05 | ~x06)) | (x08 & (~x05 | (~new_n28_ & x04)));
  assign new_n28_ = (~x12 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | x11 | x12);
  assign z3 = (~x04 & (~x05 | ~x07)) | (x08 & (~x05 | (~new_n30_ & x04)));
