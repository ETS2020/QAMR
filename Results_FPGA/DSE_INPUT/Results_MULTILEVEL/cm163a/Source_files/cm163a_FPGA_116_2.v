...
module FAU ( 
  ...
  assign z0 = x04 ? (x05 & ((x09 & (~x02 | ~x03)) | (x02 & x03 & ~x09))) : (~x00 | ~x05);
  assign z1 = x04 ? (~new_n25_ & x05) : (~x01 | ~x05);
  assign new_n25_ = (~x11 | (x02 & x03 & ~x09)) & (~x02 | ~x03 | x09 | x11);
  assign z2 = x04 ? (~new_n27_ & x05) : (~x05 | ~x06);
  assign new_n27_ = (~x12 | (x02 & x03 & ~x09 & ~x11)) & (~x02 | ~x03 | x09 | x11 | x12);
  assign z3 = x04 ? (~new_n29_ & x05) : (~x05 | ~x07);
