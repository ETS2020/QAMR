...
module FAU ( 
  ...
  assign new_n51_ = ~x17 & x18 & ~x19 & ~x22;
  ...
  assign new_n58_ = (~x01 | x09 | ~x10 | ~x11 | x12) & (x01 | x22);
  assign z08 = ~x22 & x19 & new_n60_ & ~x18;
  ...
  assign new_n75_ = ~x22 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
  assign z13 = ~x22 & ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x22 & ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & ~x22))) | (x19 & ~x22 & ~x01 & ~x02);
  assign z16 = ~x00 & x01;
