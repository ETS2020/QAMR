...
module FAU ( 
  ...
  assign new_n50_ = x05 & ~x17 & x18 & ~x19;
  ...
  assign new_n57_ = (x01 | ~x05) & (~x01 | x09 | ~x10 | ~x11 | x12);
  assign z09 = ~x00 & ~x21 & ~x22 & (new_n61_ | (new_n59_ & new_n60_));
  assign new_n59_ = ~x01 & x02 & x05 & ~x11 & x12;
  ...
  assign new_n64_ = ~x01 & x02 & x05 & ~x11 & x12 & ~x13;
  ...
  assign new_n71_ = ~x01 & x05 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
