...
module FAU ( 
  ...
  assign z03 = ~x17 & ((new_n50_ & x00 & x01 & x02) | (~x00 & ~x01 & new_n51_ & ~x02));
  assign new_n50_ = ~x09 & x10 & x11 & x12;
  assign new_n51_ = x18 & ~x19;
  assign z04 = ~x17 & ~x12 & new_n53_ & ~x11;
  assign new_n53_ = x10 & ~x09 & x02 & x00 & x01;
  assign z05 = ~x17 & x10 & x09 & x02 & x00 & x01;
  assign z06 = ~x17 & new_n53_ & x11;
  assign z07 = x00 & ~new_n57_ & x02;
  assign new_n57_ = x01 & (x09 | ~x10 | ~x11 | x12 | x17);
  ...
  assign new_n64_ = x01 & ~x17 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n66_ | (new_n68_ & new_n69_));
  assign new_n66_ = new_n67_ & x01 & ~x17 & x18;
  ...
  assign new_n72_ = x01 & ~x17 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n74_ & ~x24;
  assign new_n74_ = x00 ? (~x01 | x17 | (x02 & x10)) : (new_n75_ | x01);
