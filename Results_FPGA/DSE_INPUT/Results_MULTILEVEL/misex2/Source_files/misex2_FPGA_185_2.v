...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n50_, new_n51_, new_n54_, new_n57_, new_n60_, new_n61_,
  ...
  assign z09 = ~x00 & x12 & ~x21 & ~new_n60_ & ~x22;
  assign new_n60_ = ~new_n62_ & (~new_n61_ | x14 | x15 | x16 | ~x20);
  assign new_n61_ = ~x01 & x02 & ~x11 & ~x13;
  assign new_n62_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & x12 & (new_n64_ | new_n66_);
  assign new_n64_ = new_n65_ & ~x01 & x02 & ~x11 & ~x13 & ~x14;
  assign new_n65_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n66_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & x12 & ~x22 & (new_n68_ | new_n69_);
  assign new_n68_ = new_n61_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n71_ & ~x24;
  assign new_n71_ = x00 ? (~x01 | ~x12 | (x02 & x10)) : (new_n72_ | x01);
