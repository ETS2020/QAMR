...
module FAU ( 
  ...
  assign new_n65_ = x01 & x17 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n67_ | (new_n69_ & new_n70_));
  assign new_n67_ = new_n68_ & x01 & x17 & x18;
  ...
  assign new_n73_ = x01 & x17 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n75_ & ~x24;
  assign new_n75_ = ~new_n76_ & (x00 | x01 | ~x23 | (~x02 & ~x19));
  assign new_n76_ = x17 & ((x00 & x01 & (~x02 | ~x10)) | (~x00 & ~x01 & ~x02 & ~x19));
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (~x02 & ((x00 & (~x01 | x17)) | (~x01 & x19))) | (x00 & x01 & ~x10 & x17);
