// Benchmark "FAU" written by ABC on Thu Aug  6 15:09:20 2020
...
module FAU ( 
  ...
  assign z03 = x10 & ((new_n49_ & x00 & x01 & x02) | (new_n50_ & ~x00 & ~x01 & ~x02));
  ...
  assign new_n72_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~x01 & ~new_n73_ & x10));
  assign new_n73_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & x17 & new_n46_ & x10;
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x10))) | (x10 & x19 & ~x01 & ~x02);
  assign z16 = ~x00 & x01;
