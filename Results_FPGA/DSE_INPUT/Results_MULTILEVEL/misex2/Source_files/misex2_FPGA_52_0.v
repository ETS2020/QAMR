...
module FAU ( 
  ...
  assign new_n46_ = x04 & ~x02 & ~x00 & ~x01;
  ...
  assign new_n50_ = x04 & ~x17 & x18 & ~x19;
  ...
  assign new_n57_ = (x01 | ~x04) & (~x01 | x09 | ~x10 | ~x11 | x12);
  ...
  assign new_n62_ = new_n63_ & ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n63_ = ~x01 & x02 & x04 & ~x11 & x12;
  assign new_n64_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n66_ | (new_n67_ & new_n68_));
  assign new_n66_ = ~x20 & x21 & x22 & x01 & x18 & ~x19;
  assign new_n67_ = ~x01 & x02 & x04 & ~x11 & x12 & ~x13;
  assign new_n68_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n70_ | (new_n63_ & new_n71_));
  ...
  assign z15 = (x00 & ((x01 & (~x02 | ~x10)) | (~x02 & x04))) | (~x01 & ~x02 & x04 & x19);
  assign z16 = ~x00 & x01;
