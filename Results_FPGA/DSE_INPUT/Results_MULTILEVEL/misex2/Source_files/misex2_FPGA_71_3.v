...
module FAU ( 
  ...
  assign new_n50_ = ~x09 & x10 & x11 & x12 & (~x19 | ~x24);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign z04 = x00 & x01 & new_n53_ & x02;
  assign new_n53_ = ~x09 & x10 & ~x11 & ~x12 & (~x19 | ~x24);
  assign z05 = new_n55_ & x00;
  assign new_n55_ = x01 & x02 & x09 & x10 & (~x19 | ~x24);
  assign z06 = x00 & new_n57_ & x01;
  assign new_n57_ = x02 & ~x09 & x10 & x11 & (~x19 | ~x24);
  assign z07 = x00 & x02 & ~new_n59_ & (~x19 | ~x24);
  ...
  assign new_n73_ = x15 & ~x16 & x20 & ~x21 & (~x19 | ~x24);
  ...
  assign z15 = (x00 & ((~x02 & (~x19 | (x01 & ~x24))) | (x01 & ~x10 & (~x19 | ~x24)))) | (~x01 & ~x02 & x19 & ~x24);
