...
module FAU ( 
  ...
  assign new_n51_ = ~x09 & x10 & x11 & x12 & (x19 | ~x21);
  assign new_n52_ = ~x17 & x18 & ~x19 & ~x21;
  assign z04 = x00 & x01 & new_n54_ & x02;
  assign new_n54_ = ~x09 & x10 & ~x11 & ~x12 & (x19 | ~x21);
  assign z05 = new_n56_ & x00;
  assign new_n56_ = x01 & x02 & x09 & x10 & (x19 | ~x21);
  assign z06 = x00 & new_n58_ & x01;
  assign new_n58_ = x02 & ~x09 & x10 & x11 & (x19 | ~x21);
  assign z07 = x00 & x02 & ~new_n60_ & (x19 | ~x21);
  ...
  assign new_n72_ = (~x02 | ~x10) & (x19 | ~x21);
  assign new_n73_ = (x21 | (x02 ? ~x23 : (~x17 | x19))) & (~x19 | ~x23);
  assign z13 = ~x21 & ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x21 & ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = (x00 & (x19 | ~x21) & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x19);
