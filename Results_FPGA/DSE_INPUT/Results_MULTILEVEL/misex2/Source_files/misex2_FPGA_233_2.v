...
module FAU ( 
  ...
  assign z09 = ~x00 & x02 & ~x21 & ~new_n62_ & ~x22;
  assign new_n62_ = ~new_n64_ & (~new_n63_ | x14 | x15 | x16 | ~x20);
  assign new_n63_ = ~x01 & ~x11 & x12 & ~x13;
  assign new_n64_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & x02 & (new_n66_ | new_n68_);
  assign new_n66_ = new_n67_ & ~x01 & ~x11 & x12 & ~x13 & ~x14;
  assign new_n67_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n68_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & x02 & ~x22 & (new_n70_ | new_n71_);
  assign new_n70_ = new_n63_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n71_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n73_ & ~x24;
  assign new_n73_ = (~x02 | (x00 ? (~x01 | x10) : (x01 | ~x23))) & (x00 | new_n74_ | x01);
  assign new_n74_ = (x02 | ~x17 | x19) & (~x19 | ~x23);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (x00 & (x01 ? (x02 & ~x10) : ~x02)) | (~x01 & ~x02 & x19);
