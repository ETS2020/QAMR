...
module FAU ( 
  ...
  assign z04 = x15 & ~x12 & new_n53_ & ~x11;
  assign new_n53_ = x10 & ~x09 & x02 & x00 & x01;
  assign z05 = x15 & x10 & x09 & x02 & x00 & x01;
  assign z06 = x15 & new_n53_ & x11;
  assign z07 = x00 & new_n57_ & x02;
  assign new_n57_ = x15 & (~x01 | (~x09 & x10 & x11 & ~x12));
