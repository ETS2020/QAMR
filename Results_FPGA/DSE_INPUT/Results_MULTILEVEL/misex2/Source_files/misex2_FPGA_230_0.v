...
module FAU ( 
  ...
  assign new_n64_ = ~x01 & x02 & x10 & ~x11 & x12;
  assign new_n65_ = x01 & x18 & ~x19 & ~x20 & (x10 | x11);
  assign z10 = ~x00 & ((new_n68_ & new_n69_) | (x01 & new_n67_ & x18));
  assign new_n67_ = ~x19 & ~x20 & x21 & (x10 | x11) & x22;
  assign new_n68_ = ~x01 & x02 & x10 & ~x11 & x12 & ~x13;
  assign new_n69_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & ((new_n71_ & x01) | (new_n64_ & new_n72_));
  assign new_n71_ = x18 & ~x19 & ~x20 & (x10 | x11) & x21;
