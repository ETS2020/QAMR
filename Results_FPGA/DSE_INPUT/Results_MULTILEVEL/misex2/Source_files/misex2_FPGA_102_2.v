...
module FAU ( 
  ...
  assign new_n66_ = new_n67_ & x01 & x10 & x18;
  ...
  assign new_n72_ = x01 & x10 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n74_ & ~x24;
  assign new_n74_ = (new_n75_ | x02) & (x00 | x01 | ~x23 | (~x02 & ~x19));
  assign new_n75_ = (~x00 | ~x01 | ~x10) & (x00 | x01 | ~x17 | x19);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = ~x02 & ((x00 & (~x01 | x10)) | (~x01 & x19));
