...
module FAU ( 
  ...
  assign new_n63_ = ~x08 & x17 & ~x18 & x19 & (x16 | x23);
  ...
  assign z10 = ~x00 & ((new_n67_ & new_n70_) | (x01 & new_n69_ & x18));
  assign new_n69_ = ~x19 & ~x20 & x21 & ~new_n47_ & x22;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & ((new_n72_ & x01) | (new_n67_ & new_n73_));
  assign new_n72_ = x18 & ~x19 & ~x20 & ~new_n47_ & x21;
  assign new_n73_ = ~x14 & x15 & ~x16 & x20 & ~x21 & x23;
  assign z12 = x09 & ~x24 & (x00 ? (new_n75_ & x01) : (~new_n76_ & ~x01));
  assign new_n75_ = ~new_n47_ & (~x02 | ~x10);
  assign new_n76_ = (~x17 | (~x23 & (x02 | ~x16 | x19))) & (~x23 | (~x02 & ~x19));
