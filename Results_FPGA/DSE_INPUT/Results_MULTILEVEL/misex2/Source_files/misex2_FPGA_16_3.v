// Benchmark "FAU" written by ABC on Thu Aug  6 15:08:42 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n51_, new_n55_, new_n58_, new_n59_, new_n60_, new_n62_,
  ...
  assign z09 = ~x00 & ~x11 & ~x21 & ~new_n58_ & ~x22;
  assign new_n58_ = ~new_n60_ & (~new_n59_ | x14 | x15 | x16 | ~x20);
  assign new_n59_ = ~x01 & x02 & x12 & ~x13;
  assign new_n60_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & ~x11 & (new_n62_ | new_n64_);
  assign new_n62_ = new_n63_ & ~x01 & x02 & x12 & ~x13 & ~x14;
  assign new_n63_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n64_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & ~x11 & ~x22 & (new_n66_ | new_n67_);
  assign new_n66_ = new_n59_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n67_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n69_ & ~x24;
  assign new_n69_ = x00 ? (~x01 | x11 | (x02 & x10)) : (new_n70_ | x01);
  assign new_n70_ = (~x23 | (~x02 & ~x19)) & (x02 | ~x17 | x19);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (~x02 & ((x00 & (~x01 | ~x11)) | (~x01 & x19))) | (x00 & x01 & ~x10 & ~x11);
