...
module FAU ( 
  ...
  assign z03 = (~x00 & ~x01 & new_n52_ & ~x02) | (new_n53_ & x00 & x01 & x02 & x05);
  ...
  assign z06 = x11 & x10 & ~x09 & new_n55_ & x05;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = (x01 | (~x05 & x11)) & (~x05 | x09 | ~x10 | ~x11 | x12);
  ...
  assign new_n65_ = x18 & ~x19 & ~x20 & (x05 | ~x11);
