...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n51_, new_n52_, new_n54_, new_n58_, new_n60_,
    new_n61_, new_n63_, new_n66_, new_n67_, new_n68_, new_n71_, new_n72_;
  ...
  assign new_n60_ = x16 & ~x08 & ~x07 & ~x06 & new_n61_ & ~x05;
  assign new_n61_ = x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x22 & new_n63_ & ~x21;
  assign new_n63_ = ~x20 & ~x19 & z16 & x18;
  assign z16 = ~x00 & x01;
