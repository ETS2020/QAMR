...
module FAU ( 
  ...
  assign new_n64_ = x01 & ~x05 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n66_ | (new_n68_ & new_n69_));
  assign new_n66_ = new_n67_ & x01 & ~x05 & x18;
  ...
  assign new_n72_ = x01 & ~x05 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n74_ & ~x24;
  assign new_n74_ = x00 ? (~x01 | x05 | (x02 & x10)) : (new_n75_ | x01);
