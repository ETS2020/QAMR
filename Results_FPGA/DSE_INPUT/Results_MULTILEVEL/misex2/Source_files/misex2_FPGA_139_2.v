...
module FAU ( 
  ...
  assign new_n70_ = x15 & ~x16 & x20 & ~x21 & (~x17 | x18);
  assign new_n71_ = ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (new_n73_ | (new_n74_ & ~x00));
  assign new_n73_ = ~new_n51_ & ((x00 & x01 & (~x02 | ~x10)) | (~x00 & ~x01 & x02 & x23));
  assign new_n74_ = ~x01 & (x17 ? (x18 & (x23 | (~x02 & ~x19))) : (x19 & x23));
