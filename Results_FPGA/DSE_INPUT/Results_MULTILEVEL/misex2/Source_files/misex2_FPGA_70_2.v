...
module FAU ( 
  ...
  assign new_n69_ = x15 & ~x16 & x20 & ~x21 & (~x09 | x18);
  assign new_n70_ = ~x19 & ~x20 & x21;
  assign z12 = x09 & new_n72_ & x18;
  assign new_n72_ = ~x24 & (x00 ? (x01 & (~x02 | ~x10)) : (~new_n73_ & ~x01));
  assign new_n73_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x00 & ~x01 & ~x02 & x17 & ~new_n75_ & ~x19;
  assign new_n75_ = x09 & ~x18;
  assign z14 = ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
  assign z15 = ~new_n75_ & ((x00 & (~x02 | (x01 & ~x10))) | (~x01 & ~x02 & x19));
  assign z16 = ~x00 & ~new_n75_ & x01;
  assign z17 = ~x00 & ~x01 & ~new_n75_ & x02;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
endmodule
