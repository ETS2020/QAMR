// Benchmark "FAU" written by ABC on Thu Aug  6 15:08:53 2020
...
module FAU ( 
  ...
  assign new_n73_ = x15 & ~x16 & x20 & ~x21 & (~x05 | ~x19);
  assign new_n74_ = ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n76_ & x01) : (~new_n77_ & ~x01));
  assign new_n76_ = (~x02 | ~x10) & (~x05 | ~x19);
  assign new_n77_ = (x19 | (x02 ? ~x23 : ~x17)) & (x05 | ~x19 | ~x23);
