...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n50_, new_n52_, new_n53_, new_n55_, new_n58_,
    new_n60_, new_n62_, new_n63_, new_n65_, new_n68_, new_n69_;
  assign z00 = ~x00 & ~x01 & ~x02 & new_n46_ & ~x09;
  assign new_n46_ = x10 & ~x17 & ~x18 & ~new_n47_ & ~x19;
  assign new_n47_ = ~x21 & ~x22;
  ...
  assign new_n63_ = ~x08 & x17 & ~x18 & x19 & (x21 | x22);
  assign z10 = new_n65_ & x22;
  assign new_n65_ = x21 & ~x20 & ~x19 & x18 & ~x00 & x01;
  assign z11 = new_n65_ & ~x22;
  assign z12 = x09 & ~x24 & ~new_n68_ & ~new_n47_;
  assign new_n68_ = x00 ? (~x01 | (x02 & x10)) : (new_n69_ | x01);
