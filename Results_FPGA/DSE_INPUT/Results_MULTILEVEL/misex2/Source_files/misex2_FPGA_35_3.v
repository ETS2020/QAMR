...
module FAU ( 
  ...
  assign z09 = ~x00 & ~x13 & ~x21 & ~new_n63_ & ~x22;
  assign new_n63_ = ~new_n65_ & (~new_n64_ | x14 | x15 | x16 | ~x20);
  assign new_n64_ = ~x01 & x02 & ~x11 & x12;
  assign new_n65_ = x01 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & ~x13 & (new_n67_ | new_n69_);
  assign new_n67_ = new_n68_ & ~x01 & x02 & ~x11 & x12 & ~x14;
  assign new_n68_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & ~x13 & ~x22 & (new_n71_ | new_n72_);
  assign new_n71_ = new_n64_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n72_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n74_ & ~x24;
  assign new_n74_ = x00 ? (~x01 | x13 | (x02 & x10)) : (new_n75_ | x01);
