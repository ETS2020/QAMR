...
module FAU ( 
  ...
  assign new_n50_ = (~new_n51_ | ~x00 | ~x01 | ~x02) & (x00 | x01 | x02 | ~x18 | x19);
  ...
  assign new_n57_ = (x01 | (x10 & x17)) & (x09 | ~x10 | ~x11 | x12 | x17);
  ...
  assign new_n74_ = (~x23 | ((~x02 | (x10 & x17)) & (x10 | ~x17) & (x17 | ~x19))) & (x02 | x10 | ~x17 | x19);
