// Benchmark "FAU" written by ABC on Thu Aug  6 15:09:13 2020
...
module FAU ( 
  ...
  assign new_n50_ = ~x09 & x10 & x11 & x12 & (~x19 | x21);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign z04 = x00 & x01 & new_n53_ & x02;
  assign new_n53_ = ~x09 & x10 & ~x11 & ~x12 & (~x19 | x21);
  assign z05 = new_n55_ & x00;
  assign new_n55_ = x01 & x02 & x09 & x10 & (~x19 | x21);
  assign z06 = x00 & new_n57_ & x01;
  assign new_n57_ = x02 & ~x09 & x10 & x11 & (~x19 | x21);
  assign z07 = x00 & x02 & ~new_n59_ & (~x19 | x21);
  assign new_n59_ = x01 & (~x11 | x12 | x09 | ~x10);
  assign z08 = x21 & new_n61_ & x19;
  assign new_n61_ = ~x18 & x17 & ~x08 & ~x07 & new_n62_ & ~x06;
  assign new_n62_ = ~x05 & x04 & ~x03 & x02 & ~x00 & ~x01;
  assign z09 = ~x00 & ~x19 & ~x21 & ~new_n64_ & ~x22;
  assign new_n64_ = (~new_n65_ | x01 | ~x02 | x11 | ~x12) & (~new_n66_ | ~x01);
  assign new_n65_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n66_ = x18 & ~x20;
  assign z10 = ~x00 & ~x19 & (new_n68_ | (new_n69_ & new_n70_));
  assign new_n68_ = x01 & x18 & ~x20 & x21 & x22;
  assign new_n69_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x19 & ~x22 & (new_n72_ | new_n73_);
  assign new_n72_ = new_n69_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n73_ = x01 & x18 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n75_ & x01) : (~new_n76_ & ~x01));
  assign new_n75_ = (~x02 | ~x10) & (~x19 | x21);
  assign new_n76_ = x19 ? (~x21 | ~x23) : (x02 ? ~x23 : ~x17);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (x00 & ((~x02 & (~x19 | (x01 & x21))) | (x01 & ~x10 & (~x19 | x21)))) | (~x01 & ~x02 & x19 & x21);
  assign z16 = ~x00 & x01 & (~x19 | x21);
