...
module FAU ( 
  ...
  assign new_n50_ = ~x09 & x10 & x11 & x12 & (x17 | ~x19);
  assign new_n51_ = ~x17 & x18 & ~x19;
  assign z04 = x00 & x01 & new_n53_ & x02;
  assign new_n53_ = ~x09 & x10 & ~x11 & ~x12 & (x17 | ~x19);
  assign z05 = new_n55_ & x00;
  assign new_n55_ = x01 & x02 & x09 & x10 & (x17 | ~x19);
  assign z06 = x00 & new_n57_ & x01;
  assign new_n57_ = x02 & ~x09 & x10 & x11 & (x17 | ~x19);
  assign z07 = x00 & x02 & ~new_n59_ & (x17 | ~x19);
  ...
  assign new_n73_ = x15 & ~x16 & x20 & ~x21 & (x17 | ~x19);
  assign new_n74_ = ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n76_ & x01) : (~new_n77_ & ~x01));
  assign new_n76_ = (~x02 | ~x10) & (x17 | ~x19);
  assign new_n77_ = (~x17 | (x19 ? ~x23 : x02)) & (~x02 | x19 | ~x23);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (x00 & ((~x02 & (~x19 | (x01 & x17))) | (x01 & ~x10 & (x17 | ~x19)))) | (x17 & x19 & ~x01 & ~x02);
