// Benchmark "FAU" written by ABC on Thu Aug  6 15:09:19 2020
...
module FAU ( 
  ...
  assign z03 = (~x00 & ~x01 & new_n52_ & ~x02) | (new_n53_ & x00 & x01 & x02 & ~x07);
  assign new_n52_ = ~x17 & x18 & ~new_n47_ & ~x19;
  assign new_n53_ = x11 & x12 & ~x09 & x10;
  assign z04 = ~x12 & ~x11 & x10 & new_n55_ & ~x09;
  assign new_n55_ = x02 & x00 & x01;
  assign z05 = x00 & x01 & x02 & x09 & ~new_n47_ & x10;
  assign z06 = x11 & x10 & ~x09 & new_n55_ & ~x07;
  assign z07 = x00 & ~new_n59_ & x02;
  assign new_n59_ = (x01 | (x07 & x11)) & (x07 | x09 | ~x10 | ~x11 | x12);
  ...
  assign new_n64_ = (~new_n65_ | ~x01) & (~new_n66_ | x01 | ~x02 | x11 | ~x12);
  assign new_n65_ = x18 & ~x19 & ~x20 & (~x07 | ~x11);
  assign new_n66_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((new_n69_ & new_n70_) | (x01 & new_n68_ & x18));
  assign new_n68_ = ~x19 & ~x20 & x21 & ~new_n47_ & x22;
  assign new_n69_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n70_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n73_ | (new_n72_ & x01));
  assign new_n72_ = x18 & ~x19 & ~x20 & ~new_n47_ & x21;
  assign new_n73_ = new_n69_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign z12 = x09 & ~x24 & ~new_n75_ & ~new_n47_;
  assign new_n75_ = x00 ? (~x01 | (x02 & x10)) : (new_n76_ | x01);
