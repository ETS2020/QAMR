// Benchmark "FAU" written by ABC on Thu Aug  6 15:09:07 2020
...
module FAU ( 
  ...
  assign new_n69_ = x15 & x16 & x20 & ~x21 & ~x22 & ~x23;
  ...
  assign new_n74_ = (~x00 | ~x01 | (x02 & x10)) & (~new_n75_ | x00 | x01 | x02);
  assign new_n75_ = x17 & ~x19 & ~x23;
  assign z13 = ~x23 & ~x19 & x17 & ~x02 & ~x00 & ~x01;
  assign z14 = ~x23 & ~x19 & ~x18 & ~x17 & new_n46_ & ~x10;
