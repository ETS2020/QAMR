// Benchmark "FAU" written by ABC on Thu Aug  6 15:08:43 2020
...
module FAU ( 
  ...
  assign new_n51_ = x10 & x11 & x12 & x15;
  assign z04 = x15 & new_n53_ & ~x12;
  assign new_n53_ = ~x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z05 = x15 & x10 & x09 & x02 & x00 & x01;
  assign z06 = new_n56_ & x15;
  assign new_n56_ = x11 & x10 & ~x09 & x02 & x00 & x01;
  assign z07 = x00 & ~new_n58_ & x02;
  assign new_n58_ = x01 & (x09 | ~x10 | ~x11 | x12 | ~x15);
  ...
  assign new_n65_ = x01 & x15 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & x15 & (new_n67_ | new_n69_);
  assign new_n67_ = new_n68_ & ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n68_ = ~x14 & x16 & x20 & ~x21 & ~x22;
  assign new_n69_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & x15 & ~x22 & (new_n71_ | new_n72_);
  assign new_n71_ = new_n64_ & ~x13 & ~x14 & ~x16 & x20 & ~x21;
  assign new_n72_ = x01 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n74_ & ~x24;
  assign new_n74_ = x00 ? (~x01 | ~x15 | (x02 & x10)) : (new_n75_ | x01);
  assign new_n75_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (~x02 & ((x00 & (~x01 | x15)) | (~x01 & x19))) | (x00 & x01 & ~x10 & x15);
