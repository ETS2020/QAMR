...
module FAU ( 
  ...
  assign new_n59_ = (x01 | (~x11 & x21)) & (x09 | ~x10 | ~x11 | x12);
  assign z08 = ~x00 & ~x01 & new_n61_ & x02;
  assign new_n61_ = ~x03 & x04 & ~x05 & ~x06 & new_n62_ & ~x07;
  assign new_n62_ = ~x08 & x17 & ~x18 & x19 & (x11 | ~x21);
  ...
  assign new_n68_ = new_n69_ & x01 & x11 & x18;
  ...
  assign new_n74_ = x01 & x11 & x18 & ~x19 & ~x20 & x21;
