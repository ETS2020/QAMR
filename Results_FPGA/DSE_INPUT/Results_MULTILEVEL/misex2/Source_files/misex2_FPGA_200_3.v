// Benchmark "FAU" written by ABC on Thu Aug  6 15:09:12 2020
...
module FAU ( 
  ...
  assign new_n55_ = (~new_n56_ | x01 | ~x02 | x11 | ~x12) & (~new_n57_ | ~x01 | x02);
  assign new_n56_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n57_ = x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n59_ | (new_n61_ & new_n62_));
  assign new_n59_ = new_n60_ & x01 & ~x02 & x18;
  ...
  assign new_n65_ = x01 & ~x02 & x18 & ~x19 & ~x20 & x21;
