...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n46_, new_n51_, new_n55_, new_n57_, new_n60_, new_n61_, new_n62_,
  ...
  assign z04 = ~x12 & new_n51_ & ~x11;
  assign new_n51_ = x10 & ~x09 & x02 & x00 & x01;
  assign z05 = ~x12 & x10 & x09 & x02 & x00 & x01;
  assign z06 = ~x12 & new_n51_ & x11;
  assign z07 = new_n55_ & x00;
  assign new_n55_ = x02 & (~x01 | (~x09 & x10 & x11 & ~x12));
  assign z08 = x19 & ~x18 & x17 & new_n57_ & ~x08;
  assign new_n57_ = ~x07 & ~x06 & ~x05 & x04 & z17 & ~x03;
  assign z17 = x02 & ~x00 & ~x01;
  assign z09 = ~x00 & ~x21 & ~new_n60_ & ~x22;
  assign new_n60_ = (~new_n61_ | x01 | ~x02 | x11 | ~x12) & (~new_n62_ | ~x01 | x12);
  assign new_n61_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign new_n62_ = x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n64_ | (new_n66_ & new_n67_));
  assign new_n64_ = new_n65_ & x01 & ~x12 & x18;
  ...
  assign new_n70_ = x01 & ~x12 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n72_ & ~x24;
  assign new_n72_ = x00 ? (~x01 | x12 | (x02 & x10)) : (new_n73_ | x01);
