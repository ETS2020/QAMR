...
module FAU ( 
  ...
  assign new_n70_ = x15 & ~x16 & x20 & ~x21 & (~x17 | ~x19);
  assign new_n71_ = ~x19 & ~x20 & x21;
  assign z12 = x09 & ~x24 & (x00 ? (new_n73_ & x01) : (~new_n74_ & ~x01));
  assign new_n73_ = (~x02 | ~x10) & (~x17 | ~x19);
  assign new_n74_ = (x19 | (x02 ? ~x23 : ~x17)) & (x17 | ~x19 | ~x23);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (x00 & ((~x02 & (~x19 | (x01 & ~x17))) | (x01 & ~x10 & (~x17 | ~x19)))) | (~x01 & ~x02 & ~x17 & x19);
