...
module FAU ( 
  ...
  assign new_n61_ = (~new_n62_ | ~x01) & (~new_n63_ | x01 | ~x02 | x11 | ~x12);
  assign new_n62_ = x18 & ~x19 & ~x20 & (x02 | x09);
  assign new_n63_ = ~x13 & ~x14 & ~x15 & ~x16 & x20;
  assign z10 = ~x00 & ((new_n66_ & new_n67_) | (x01 & new_n65_ & x18));
  assign new_n65_ = ~x19 & ~x20 & x21 & (x02 | x09) & x22;
  assign new_n66_ = ~x01 & x02 & ~x11 & x12 & ~x13;
  assign new_n67_ = ~x14 & x15 & x16 & x20 & ~x21 & ~x22;
  assign z11 = ~x00 & ~x22 & (new_n69_ | (new_n70_ & x01));
  assign new_n69_ = new_n66_ & ~x14 & x15 & ~x16 & x20 & ~x21;
  assign new_n70_ = x18 & ~x19 & ~x20 & (x02 | x09) & x21;
