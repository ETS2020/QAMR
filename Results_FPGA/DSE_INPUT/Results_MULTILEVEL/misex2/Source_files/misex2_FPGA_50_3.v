...
module FAU ( 
  ...
  assign new_n63_ = x01 & ~x09 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n65_ | (new_n67_ & new_n68_));
  assign new_n65_ = new_n66_ & x01 & ~x09 & x18;
  ...
  assign z12 = ~x00 & new_n73_ & ~x01;
  assign new_n73_ = x09 & ~x24 & ((x23 & (x02 | x19)) | (~x02 & x17 & ~x19));
