...
module FAU ( 
  ...
  assign new_n73_ = (~x02 | ~x10) & (x18 | ~x19);
  assign new_n74_ = (x19 | (x02 ? ~x23 : ~x17)) & (~x18 | ~x19 | ~x23);
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (x00 & ((~x02 & (~x19 | (x01 & x18))) | (x01 & ~x10 & (x18 | ~x19)))) | (x18 & x19 & ~x01 & ~x02);
