...
module FAU ( 
  ...
  assign z03 = (new_n50_ & ~x00 & ~x01 & ~x02) | (new_n51_ & x00 & x01 & x02 & ~x08);
  assign new_n50_ = ~x17 & x18 & ~x19;
  assign new_n51_ = x11 & x12 & ~x09 & x10;
  assign z04 = ~x12 & new_n53_ & ~x11;
  assign new_n53_ = x10 & ~x09 & ~x08 & x02 & x00 & x01;
  assign z05 = x10 & x09 & ~x08 & x02 & x00 & x01;
  assign z06 = new_n53_ & x11;
  assign z07 = x00 & ~new_n57_ & x02;
  assign new_n57_ = x01 & (x08 | x09 | ~x10 | ~x11 | x12);
  ...
  assign new_n64_ = x01 & ~x08 & x18 & ~x19 & ~x20;
  assign z10 = ~x00 & (new_n66_ | (new_n68_ & new_n69_));
  assign new_n66_ = new_n67_ & x01 & ~x08 & x18;
  ...
  assign new_n72_ = x01 & ~x08 & x18 & ~x19 & ~x20 & x21;
  assign z12 = x09 & ~new_n74_ & ~x24;
  assign new_n74_ = x00 ? (~x01 | x08 | (x02 & x10)) : (new_n75_ | x01);
  assign new_n75_ = (x02 | ~x17 | x19) & (~x23 | (~x02 & ~x19));
  assign z13 = ~x19 & new_n46_ & x17;
  assign z14 = ~x19 & ~x18 & ~x17 & ~x10 & new_n46_ & ~x09;
  assign z15 = (~x02 & ((x00 & (~x01 | ~x08)) | (~x01 & x19))) | (x00 & x01 & ~x08 & ~x10);
