...
module FAU ( 
  ...
  assign z10 = ~x00 & ~x11 & (new_n68_ | new_n70_);
  assign new_n68_ = new_n69_ & ~x01 & x02 & x12 & ~x13 & ~x14;
  assign new_n69_ = x15 & x16 & x20 & ~x21 & ~x22;
  assign new_n70_ = x01 & x18 & ~x19 & ~x20 & x21 & x22;
  assign z11 = ~x00 & ~x11 & ~new_n72_ & ~x22;
  assign new_n72_ = ~new_n73_ & (~new_n74_ | ~x12 | x13 | x01 | ~x02);
