...
module FAU ( 
  ...
  assign z4 = x07 ? (~x11 & (~x02 | ~x09)) : (~x09 | (~x02 & (~x00 | (x00 & ~x08))));
  assign z5 = (x00 & (~x02 | (~x07 & ~x09))) | (x07 & (~x02 | ~x09)) | (~x07 & ~new_n37_ & (~x09 | (~x00 & ~x02)));
  assign new_n37_ = ~x10 & ~x12 & x13;
  assign z6 = ~x07 & ~x10 & (x02 ? new_n40_ : new_n39_);
  assign new_n39_ = (~x00 | ~x08) & (x01 | (~x03 & x09) | (x03 & ~x09));
  assign new_n40_ = ~x09 & (x00 ? ~x08 : (~x01 | ~x14));
  assign z7 = (~new_n42_ & (~x02 | ~x09)) | (~x02 & ((~x08 & (x01 | ~x03)) | (~x01 & x03 & x09))) | (x02 & ~x08 & ~x09);
  assign new_n42_ = ~x07 & ~x10;
  assign z8 = (~new_n42_ & (~x02 | ~x09)) | (~x00 & ~x09) | (~x02 & ~new_n44_ & x09);
