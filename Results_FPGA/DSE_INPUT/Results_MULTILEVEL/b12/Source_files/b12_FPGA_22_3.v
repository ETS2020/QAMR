// Benchmark "FAU" written by ABC on Wed Aug  5 21:23:00 2020
...
module FAU ( 
  ...
  assign new_n28_ = (~x02 | (~x03 ^ x04) | (x01 & x05 & x06)) & (~x03 | x04 | ~x01 | x02);
  assign z2 = (~new_n30_ & ~new_n31_) | (~x01 & (new_n32_ | new_n33_));
  assign new_n30_ = x00 & (x07 | x08);
  assign new_n31_ = (x03 | (~x02 & (x01 | (~x09 & ~x10)))) & (~x02 | x04);
  assign new_n32_ = ~x00 & ((~x03 & x07) | (~x04 & ~x07 & x09 & ~x10));
  ...
  assign z6 = ~x07 & ~x10 & (new_n40_ | (~new_n35_ & ~new_n39_));
  assign new_n39_ = x01 ? (x00 ? x08 : (x02 & x14)) : (~x02 | (x00 & x08));
  assign new_n40_ = ~x01 & (~x00 | ~x08) & (x03 ? (~x04 & ~x09) : x09);
  assign z7 = new_n42_ | ~new_n43_;
  assign new_n42_ = (x07 | x10) & (~x03 | ~x04);
  assign new_n43_ = (x04 | ((~x01 & ~x02) ? (~x03 | ~x09) : x08)) & (x03 | x08);
  assign z8 = (~x00 & (~x03 | (~x04 & ~x09))) | new_n42_ | (x09 & (~x03 | (~new_n45_ & ~x04)));
