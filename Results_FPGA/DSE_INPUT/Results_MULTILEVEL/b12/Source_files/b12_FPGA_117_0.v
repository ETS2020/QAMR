...
module FAU ( 
  ...
  assign z4 = x07 ? (~x11 & (x12 | x13)) : ((~new_n36_ & (x12 | (x00 & x13))) | (~x00 & (x12 | x13)));
  assign new_n36_ = x08 & x09;
  assign z5 = x12 | (x13 & (x00 | x07 | (~x00 & ~x07 & x10)));
  ...
  assign z8 = (~x00 & (x12 | (~x09 & x13))) | (~new_n45_ & (x12 | x13)) | (x09 & (x12 | (~new_n42_ & x13)));
