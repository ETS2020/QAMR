...
module FAU ( 
  ...
  assign new_n28_ = (~x01 | (((x05 & x06) | (~x03 & (~x02 | ~x04))) & (x02 | ~x03))) & (x01 | ~x02 | ~x03 | x04);
  assign z2 = (~new_n30_ & ~new_n31_) | (~x01 & ~new_n32_ & ~x04);
  assign new_n30_ = x00 & (x07 | x08);
  assign new_n31_ = (~x02 | (~x01 & x04)) & (x01 | x03 | x04 | ~x10);
  ...
  assign new_n41_ = (x01 | ~x04) & (x07 | x10);
  assign new_n42_ = (x04 | ((x08 | (~x02 & x03)) & (x01 | x02 | ~x03 | ~x09))) & (~x01 | x08);
  assign z8 = (~x00 & (x01 | (~x04 & ~x09))) | new_n41_ | (x09 & (x01 | (~new_n44_ & ~x04)));
