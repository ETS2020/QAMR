...
module FAU ( 
  ...
  assign new_n27_ = (~x03 | ((~x02 | x04) & (~x01 | x02 | x08))) & (~x01 | ~x02 | (x04 & ~x05));
  ...
  assign new_n39_ = ~x02 & ~x08 & (x01 | (~x03 & x09) | (x03 & ~x09));
  assign z7 = new_n41_ | (~x08 & (x01 | x02 | ~x03 | x09));
  assign new_n41_ = (x07 | x10) & (x02 | ~x08);
  assign z8 = (~x00 & (x02 | (~x08 & ~x09))) | new_n41_ | (x09 & (x02 | (~new_n43_ & ~x08)));
