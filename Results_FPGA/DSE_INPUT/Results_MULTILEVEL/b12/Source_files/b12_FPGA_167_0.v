...
module FAU ( 
  ...
  assign z1 = ~x00 & (new_n30_ | new_n31_);
  assign new_n30_ = x03 & ((x01 & ~x02 & (x06 | x11)) | (x02 & (x06 ? (~x01 | ~x05) : x11)));
  assign new_n31_ = x02 & x04 & (x06 ? (~x01 | ~x05) : x11);
  ...
  assign z3 = (x11 ? ~x07 : x06) & (x00 | ~x12);
  assign z4 = (~x07 & (x06 | x11) & (~x00 | (x00 & (~x08 | ~x09)))) | (x06 & x07 & ~x11);
  assign z5 = (x00 & (x11 | (x06 & ~x07))) | (x07 & (x11 | (x06 & ~x11))) | (~x00 & ~x07 & ~new_n39_ & (x06 | x11));
  assign new_n39_ = ~x10 & ~x12 & x13;
  assign z6 = ~x07 & ~x10 & ~new_n27_ & (new_n41_ | new_n42_);
  assign new_n41_ = ~x01 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n42_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = ~new_n27_ & (~new_n44_ | (~x08 & (x01 | x02 | ~x03)));
