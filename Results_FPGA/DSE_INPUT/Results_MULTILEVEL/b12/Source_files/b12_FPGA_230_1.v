...
module FAU ( 
  ...
  assign z2 = (~x08 & (new_n33_ | (~x00 & (x02 | (new_n32_ & ~x01))))) | (~x00 & x01 & x02);
  assign new_n32_ = ~x03 & x07;
  assign new_n33_ = ~x07 & (x02 | (~x01 & (x10 ? ~x03 : x09)));
  assign z3 = (~x07 | ~x11) & (x01 | ~x08) & (x00 | ~x12);
  assign z4 = x07 ? (~x11 & (x01 | ~x08)) : (~x08 | (x01 & (~x00 | (x00 & ~x09))));
  assign z5 = (x00 & (x01 | (~x07 & ~x08))) | (x07 & (x01 | ~x08)) | (~x07 & ~new_n37_ & (~x08 | (~x00 & x01)));
  assign new_n37_ = ~x10 & ~x12 & x13;
  assign z6 = ~x07 & (new_n39_ | new_n40_) & ~x10;
  assign new_n39_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign new_n40_ = ~x01 & ~x08 & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign z7 = new_n42_ | (~x08 & (~x03 | x09 | x01 | x02));
  assign new_n42_ = (x01 | ~x08) & (x07 | x10);
  assign z8 = (~x00 & (x01 | (~x08 & ~x09))) | new_n42_ | (x09 & (x01 | (~new_n44_ & ~x08)));
