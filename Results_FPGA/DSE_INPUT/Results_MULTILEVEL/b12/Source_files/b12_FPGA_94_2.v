...
module FAU ( 
  ...
  assign z4 = x07 ? (~x11 & (~x08 | x12)) : (~x08 | (x12 & (~x00 | ~x09)));
  assign z5 = x12 | (~x08 & (x07 | (~x07 & (x00 | x10 | ~x13))));
  ...
  assign new_n42_ = (~x08 | x12) & (x07 | x10);
  assign new_n43_ = (~x09 | (x08 & (x01 | x02 | ~x03 | ~x12))) & (x08 | (~x01 & ~x02 & x03));
  assign z8 = (~x00 & (x12 | (~x08 & ~x09))) | new_n42_ | (x09 & (x12 | (~new_n45_ & ~x08)));
