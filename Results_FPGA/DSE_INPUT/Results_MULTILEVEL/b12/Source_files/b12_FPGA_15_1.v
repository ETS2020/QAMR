// Benchmark "FAU" written by ABC on Wed Aug  5 21:22:59 2020
...
module FAU ( 
  ...
  assign new_n31_ = (x01 | x03 | (~x07 & (x09 | ~x10))) & (~x02 | (~x07 & x09));
  assign new_n32_ = ~x08 & ~x09 & (x02 | (~x01 & ~x03 & x10));
  assign z3 = z4 & (x00 | ~x12);
  assign z4 = x07 ? ~x11 : ~x09;
  assign z5 = x07 | (~x07 & ~x09 & (x12 | ~x13 | x00 | x10));
