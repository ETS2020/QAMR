...
module FAU ( 
  ...
  assign new_n28_ = x02 & (x03 | x04) & (~x01 | ~x05 | ~x06);
  ...
  assign new_n38_ = x02 & (x00 ? ~x08 : ~x14);
  assign z7 = (~new_n40_ & (~x01 | x02)) | (~x01 & ((~x03 & ~x08) | (~x02 & x03 & x09))) | (x02 & ~x08);
  assign new_n40_ = ~x07 & ~x10;
  assign z8 = (~x00 & (x01 ? x02 : ~x09)) | (~new_n40_ & (~x01 | x02)) | (x09 & (x02 | (~new_n42_ & ~x01)));
  assign new_n42_ = x03 & ~x12;
endmodule
