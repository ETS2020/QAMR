...
module FAU ( 
  ...
  assign new_n27_ = ~x12 & ((x03 & (x02 ? ~x04 : x01)) | (x01 & x02 & (~x04 | x05)));
  ...
  assign z4 = x07 ? (~x11 & (x00 | ~x12)) : (x00 ? (~x08 | ~x09) : ~x12);
  assign z5 = x00 | (~x12 & (x07 | (~x00 & ~x07 & (x10 | ~x13))));
  ...
  assign z7 = (x00 | ~x12) & (~new_n44_ | (~new_n43_ & ~x08));
  assign new_n43_ = ~x01 & ~x02 & x03;
  assign new_n44_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = (~new_n43_ & (x00 ? x09 : ~x12)) | ((x00 | ~x12) & (x07 | x10)) | (x00 & x09 & x12) | (~x00 & ~x09 & ~x12);
endmodule
