...
module FAU ( 
  ...
  assign new_n27_ = (~x01 | (x02 ? (x04 ? ~x05 : ~x06) : (~x03 | (~x04 & ~x06)))) & (x04 | ~x06 | ~x02 | ~x03);
  assign z1 = ~new_n29_ & ~x00;
  assign new_n29_ = (~x03 | ((~x01 | x02 | (~x04 & ~x06)) & (~x02 | ~x06 | (x01 & x05)))) & (~x02 | ~x04 | (x01 & x05 & x06));
  assign z2 = ~new_n31_ & ((~new_n32_ & ~new_n33_) | (~new_n34_ & ~x01));
  ...
  assign z6 = ~x07 & ~x10 & ~new_n31_ & (new_n39_ | new_n40_);
  assign new_n39_ = ~x01 & (~x00 | ~x08) & (x02 | (~x03 & x09) | (x03 & ~x09));
  assign new_n40_ = x01 & (x00 ? ~x08 : (~x02 | ~x14));
  assign z7 = ~new_n31_ & (~new_n42_ | (~x08 & (x01 | x02 | ~x03)));
  assign new_n42_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = ~new_n31_ & ((~new_n44_ & x09) | x07 | x10 | (~x00 & ~x09));
