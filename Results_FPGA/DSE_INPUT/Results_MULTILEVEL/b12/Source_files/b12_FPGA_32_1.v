...
module FAU ( 
  ...
  assign new_n29_ = (~x03 | ((~x01 | new_n30_ | x02) & (new_n31_ | ~x02))) & (~x02 | new_n31_ | ~x04);
  assign new_n30_ = ~x05 & x14;
  assign new_n31_ = x05 ? (x01 & x06) : x14;
  assign z2 = ~new_n33_ & ~new_n30_;
  ...
  assign z7 = ~new_n30_ & (~new_n44_ | (~x08 & (x01 | x02 | ~x03)));
  assign new_n44_ = ~x07 & ~x10 & (x01 | x02 | ~x03 | ~x09);
  assign z8 = ~new_n30_ & ((~new_n46_ & x09) | x07 | x10 | (~x00 & ~x09));
