...
module FAU ( 
  ...
  assign new_n31_ = (~x02 | (x03 & ~x09)) & (x01 | x03 | ~x10);
  ...
  assign new_n39_ = (x08 | ((x01 | ~x09 | (~x02 & x03)) & (x03 | x09 | ~x00 | ~x02))) & (x00 | x01 | x03 | ~x09);
  assign z7 = (~new_n41_ & (~x03 | x09)) | (x03 & x09 & ~x01 & ~x02);
  assign new_n41_ = ~x07 & x08 & ~x10;
  assign z8 = ((~x03 | x09) & (x07 | x10)) | (~x03 & (~x00 | x09)) | (~new_n43_ & x09);
