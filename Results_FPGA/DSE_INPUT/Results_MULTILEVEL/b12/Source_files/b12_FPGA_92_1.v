...
module FAU ( 
  ...
  assign z2 = new_n32_ | (~new_n31_ & ~x00);
  assign new_n31_ = (x01 | (x07 ? x03 : (~x09 | x10))) & (~x02 | (~x07 & x10));
  assign new_n32_ = ~x07 & ~x08 & ~x10 & (x02 | (~x01 & x09));
  assign z3 = (x00 | ~x12) & (x07 ? ~x11 : ~x10);
  assign z4 = x07 ? ~x11 : (~x10 & (~x00 | (x00 & (~x08 | ~x09))));
  assign z5 = x07 | (~x10 & (x00 | (~x00 & ~x07 & (x12 | ~x13))));
  ...
  assign z8 = x07 | (~new_n42_ & ~x10);
  assign new_n42_ = x09 ? (~x01 & ~x02 & x03 & ~x12) : x00;
endmodule
