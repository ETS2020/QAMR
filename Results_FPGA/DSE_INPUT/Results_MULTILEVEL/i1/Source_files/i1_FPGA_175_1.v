...
module FAU ( 
  ...
  assign z02 = x19 & ((x00 & (new_n48_ | x06)) | (new_n49_ & new_n50_));
  assign new_n48_ = ~x07 & (x01 | x02 | x03 | x04 | x05);
  assign new_n49_ = ~x01 & ~x02 & ~x03 & ~x04;
  assign new_n50_ = ~x05 & ~x06 & ~x07 & x08 & ~x09;
  assign z03 = x20 & (x06 | ~x07);
  assign z04 = (x20 | x21) & (x06 | ~x07);
  ...
  assign z13 = x17 & x23 & ~x24 & (x06 | ~x07);
  assign z14 = x16 & ~x24 & (x06 | ~x07);
  assign z15 = (x06 | ~x07) & (x14 | x15 | x12 | x13);
endmodule
