// Benchmark "FAU" written by ABC on Thu Aug  6 21:11:41 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n219_, new_n220_, new_n222_, new_n226_, new_n228_, new_n229_,
    ...
    new_n310_, new_n312_, new_n313_, new_n318_, new_n319_, new_n321_,
    new_n322_, new_n323_, new_n324_, new_n325_, new_n327_, new_n328_,
    new_n329_, new_n332_, new_n333_, new_n334_, new_n335_, new_n337_,
  ...
  assign new_n139_ = x12 & ~x11 & ~x10 & ~x09 & new_n140_ & ~x08;
  ...
  assign new_n148_ = x12 & ~x11 & ~x10 & ~x09 & new_n149_ & ~x08;
  assign new_n149_ = ~x07 & ~x06 & x05 & ~x04 & ~x00 & ~x03;
  assign z04 = z05 & x15;
  assign z05 = x29 & (x12 | x43);
  assign z06 = new_n153_ & ~x43;
  assign new_n153_ = ~x37 & x29 & ~x28 & ~x15 & x12 & x14;
  assign z07 = x43 & ~x37 & x29 & ~x15 & ~x28;
  assign z10 = ~x15 & x28 & x29 & ~x37 & (x12 | x43);
  assign z11 = ~x15 & x29 & x37 & (x12 | x43);
  ...
  assign new_n161_ = ~x25 & ~x24 & ~x15 & ~x14 & new_n162_ & x12;
  ...
  assign new_n168_ = x12 & ~x11 & ~x10 & ~x08 & ~x03 & ~x07;
  assign z14 = ~x58 & x50 & new_n170_ & ~x43;
  assign new_n170_ = new_n171_ & ~x37;
  assign new_n171_ = x29 & ~x28 & ~x15 & ~x14 & ~x10 & x12;
  assign z15 = ~x58 & ~x43 & new_n173_ & ~x37;
  assign new_n173_ = x29 & ~x28 & ~x15 & ~x14 & x10 & x12;
  ...
  assign new_n181_ = x12 & ~x11 & ~x10 & ~x08 & x03 & ~x07;
  ...
  assign new_n186_ = ~x14 & x12 & ~x11 & ~x10 & ~x07 & ~x08;
  ...
  assign new_n192_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n193_ & ~x34;
  assign new_n193_ = ~x33 & ~x31 & ~x30 & x29 & new_n194_ & ~x28;
  assign new_n194_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n195_ & ~x18;
  assign new_n195_ = ~x17 & ~x15 & ~x14 & x12 & new_n196_ & ~x11;
  ...
  assign new_n201_ = ~x30 & new_n202_ & x29;
  assign new_n202_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n203_ & ~x22;
  assign new_n203_ = ~x18 & ~x15 & ~x14 & x12 & new_n204_ & ~x11;
  ...
  assign new_n209_ = ~x18 & ~x15 & ~x14 & x12 & new_n210_ & ~x11;
  assign new_n210_ = ~x10 & ~x08 & ~x07 & ~x06 & x00 & ~x03;
  assign z24 = new_n212_ & ~x60;
  assign new_n212_ = ~x58 & ~x50 & ~x46 & ~x43 & new_n213_ & ~x40;
  assign new_n213_ = ~x39 & ~x37 & x29 & ~x28 & new_n214_ & ~x25;
  assign new_n214_ = ~x24 & ~x15 & ~x14 & x12 & ~x10 & x11;
  assign z25 = ~x60 & ~x58 & ~x50 & ~x46 & new_n216_ & ~x43;
  assign new_n216_ = ~x40 & ~x39 & ~x37 & x29 & new_n217_ & ~x28;
  assign new_n217_ = ~x25 & x24 & ~x15 & ~x14 & ~x10 & x12;
  assign z28 = ~x60 & ~x58 & ~x50 & new_n219_ & ~x46;
  assign new_n219_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n220_ & x29;
  assign new_n220_ = ~x28 & x25 & ~x15 & ~x14 & ~x10 & x12;
  assign z29 = x60 & ~x58 & ~x50 & new_n222_ & ~x46;
  assign new_n222_ = ~x43 & ~x40 & new_n170_ & ~x39;
  assign z32 = ~x58 & ~x50 & new_n222_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n170_ & x39;
  assign z34 = x58 & new_n226_ & ~x43;
  assign new_n226_ = ~x37 & x29 & ~x28 & ~x15 & x12 & ~x14;
  assign z35 = ~x62 & ~x61 & ~x60 & new_n228_ & ~x58;
  assign new_n228_ = ~x56 & ~x55 & ~x51 & ~x50 & new_n229_ & ~x47;
  ...
  assign new_n232_ = ~x15 & ~x14 & x12 & ~x11 & new_n233_ & ~x10;
  assign new_n233_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n235_ & ~x62;
  assign new_n235_ = x61 & ~x60 & ~x58 & ~x56 & new_n236_ & ~x55;
  assign new_n236_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n237_ & ~x43;
  assign new_n237_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n201_ & ~x35;
  assign z38 = ~x62 & ~x61 & new_n239_ & ~x60;
  assign new_n239_ = x59 & ~x58 & ~x56 & ~x55 & new_n240_ & ~x51;
  assign new_n240_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n241_ & ~x42;
  assign new_n241_ = ~x41 & ~x40 & new_n242_ & ~x39;
  assign new_n242_ = ~x37 & ~x35 & ~x30 & x29 & new_n243_ & ~x28;
  assign new_n243_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n244_ & ~x18;
  assign new_n244_ = ~x15 & ~x14 & x12 & ~x11 & new_n245_ & ~x10;
  assign new_n245_ = ~x08 & ~x07 & ~x06 & ~x04 & ~x00 & ~x03;
  assign z39 = ~x62 & new_n247_ & ~x61;
  assign new_n247_ = ~x60 & ~x58 & ~x56 & ~x55 & new_n248_ & ~x51;
  assign new_n248_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n241_ & x42;
  assign z40 = ~x62 & ~x61 & new_n250_ & ~x60;
  assign new_n250_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n251_ & x54;
  assign new_n251_ = ~x51 & ~x50 & new_n252_ & ~x47;
  ...
  assign new_n255_ = ~x24 & ~x22 & ~x18 & ~x17 & new_n256_ & ~x15;
  assign new_n256_ = ~x14 & x12 & ~x11 & ~x10 & new_n245_ & ~x09;
  assign z41 = ~x62 & ~x61 & ~x60 & ~x59 & new_n258_ & ~x58;
  assign new_n258_ = ~x56 & ~x55 & ~x51 & ~x50 & new_n259_ & ~x47;
  assign new_n259_ = ~x46 & ~x43 & ~x42 & ~x41 & new_n260_ & ~x40;
  assign new_n260_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n254_ & x33;
  assign z42 = ~x62 & new_n262_ & ~x61;
  assign new_n262_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n263_ & ~x55;
  assign new_n263_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n264_ & x49;
  assign new_n264_ = new_n191_ & ~x47;
  assign z43 = ~x62 & new_n266_ & ~x61;
  assign new_n266_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n267_ & ~x55;
  assign new_n267_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n268_ & ~x47;
  assign new_n268_ = ~x46 & ~x45 & ~x43 & ~x42 & new_n269_ & ~x41;
  assign new_n269_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n270_ & ~x34;
  assign new_n270_ = ~x33 & ~x31 & ~x30 & x29 & new_n271_ & ~x28;
  assign new_n271_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n272_ & ~x18;
  assign new_n272_ = ~x17 & ~x15 & ~x14 & x12 & new_n273_ & ~x11;
  ...
  assign new_n282_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n283_ & x12;
  ...
  assign new_n288_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n254_ & x34;
  assign z46 = ~x62 & ~x61 & new_n290_ & ~x60;
  assign new_n290_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n291_ & ~x51;
  assign new_n291_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n292_ & ~x42;
  assign new_n292_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n293_ & ~x35;
  assign new_n293_ = ~x30 & x29 & ~x28 & ~x26 & new_n294_ & ~x25;
  assign new_n294_ = ~x24 & ~x22 & ~x18 & ~x17 & new_n295_ & ~x15;
  assign new_n295_ = ~x14 & x12 & ~x11 & ~x10 & new_n245_ & x09;
  ...
  assign new_n301_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n244_ & x17;
  ...
  assign new_n306_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n254_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n308_ & ~x59;
  assign new_n308_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n251_ & x53;
  assign z50 = ~x62 & ~x61 & ~x60 & ~x59 & new_n310_ & ~x58;
  assign new_n310_ = x57 & ~x56 & ~x55 & ~x54 & new_n190_ & ~x53;
  assign z51 = ~x62 & ~x61 & new_n312_ & ~x60;
  assign new_n312_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n313_ & ~x54;
  assign new_n313_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n264_ & x48;
  assign z52 = ~x64 & new_n188_ & ~x63;
  assign z53 = ~x64 & new_n188_ & x63;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n236_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & new_n318_ & ~x56;
  assign new_n318_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n319_ & ~x43;
  assign new_n319_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n201_ & x35;
  assign z57 = ~x62 & ~x60 & ~x58 & ~x56 & new_n321_ & ~x50;
  ...
  assign new_n324_ = ~x15 & ~x14 & new_n325_ & x12;
  assign new_n325_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & new_n327_ & ~x56;
  assign new_n327_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n328_ & ~x41;
  ...
  assign z60 = new_n332_ & ~x60;
  assign new_n332_ = ~x58 & ~x56 & ~x50 & ~x47 & new_n333_ & ~x46;
  assign new_n333_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n334_ & ~x30;
  assign new_n334_ = x29 & ~x28 & ~x25 & ~x24 & new_n335_ & ~x15;
  assign new_n335_ = ~x14 & x12 & ~x11 & ~x10 & x07 & ~x08;
  assign z61 = ~x60 & ~x58 & ~x56 & ~x50 & new_n337_ & ~x47;
  assign new_n337_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n338_ & ~x37;
  assign new_n338_ = ~x30 & x29 & ~x28 & ~x25 & new_n339_ & ~x24;
  assign new_n339_ = ~x15 & ~x14 & x12 & ~x11 & x08 & ~x10;
  assign z62 = ~x60 & ~x58 & ~x56 & ~x50 & new_n341_ & x47;
  assign new_n341_ = new_n342_ & ~x46;
  assign new_n342_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n343_ & ~x30;
  assign new_n343_ = x29 & ~x28 & new_n344_ & ~x25;
  assign new_n344_ = ~x24 & ~x15 & ~x14 & x12 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n341_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & new_n347_ & ~x46;
  assign new_n347_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n343_ & x30;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
  assign z08 = 1'b0;
  assign z09 = 1'b0;
