...
module FAU ( 
  ...
  assign new_n270_ = ~x28 & ~x25 & new_n271_ & x24;
  assign new_n271_ = ~x15 & ~x10 & ~x14;
  ...
  assign new_n294_ = x29 & ~x28 & new_n271_ & x25;
  assign z29 = x60 & ~x58 & ~x50 & new_n296_ & ~x46;
  assign new_n296_ = ~x43 & ~x40 & new_n297_ & ~x39;
  assign new_n297_ = ~x37 & x29 & new_n271_ & ~x28;
  ...
  assign new_n305_ = ~x25 & ~x24 & ~x22 & new_n254_ & ~x21 & ~x26;
  ...
  assign new_n313_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n254_ & x21;
  assign z32 = ~x58 & ~x50 & new_n296_ & x46;
  assign z33 = ~x58 & ~x50 & ~x43 & ~x40 & new_n316_ & x39;
  assign new_n316_ = ~x37 & x31 & x29 & new_n271_ & ~x28;
  ...
  assign new_n338_ = ~x24 & ~x22 & ~x21 & ~x20 & new_n281_ & x19;
  ...
  assign new_n447_ = ~x37 & x40 & ~x43 & ~x50 & ~new_n173_ & ~x58;
