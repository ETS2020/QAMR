...
module FAU ( 
  ...
  wire new_n135_, new_n137_, new_n141_, new_n142_, new_n143_, new_n144_,
    ...
    new_n192_, new_n194_, new_n197_, new_n199_, new_n201_, new_n202_,
    ...
    new_n250_, new_n251_, new_n252_, new_n255_;
  assign z04 = z05 & x15;
  assign z05 = x29 & (x58 | x59);
  assign z06 = x14 & new_n135_ & ~x15;
  assign new_n135_ = ~x28 & x29 & ~x37 & ~x43 & (x58 | x59);
  assign z07 = new_n137_ & ~x15;
  assign new_n137_ = ~x28 & x29 & ~x37 & x43 & (x58 | x59);
  ...
  assign z14 = x59 & ~x58 & x50 & new_n153_ & ~x43;
  ...
  assign z17 = ~x62 & new_n161_ & x59 & ~x60;
  ...
  assign new_n166_ = x59 & ~x58 & ~x56 & ~x50 & new_n167_ & ~x47;
  ...
  assign z20 = ~x62 & ~x60 & x59 & new_n171_ & ~x58;
  ...
  assign z21 = ~x62 & ~x60 & x59 & new_n178_ & ~x58;
  ...
  assign new_n184_ = x59 & ~x58 & ~x50 & ~x46 & new_n185_ & ~x43;
  assign new_n185_ = ~x40 & ~x39 & ~x37 & x29 & new_n186_ & ~x28;
  assign new_n186_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x60 & x59 & ~x58 & ~x50 & new_n188_ & ~x46;
  assign new_n188_ = ~x43 & ~x40 & ~x39 & new_n189_ & x29 & ~x37;
  assign new_n189_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z28 = ~x60 & x59 & ~x58 & new_n191_ & ~x50;
  assign new_n191_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n192_ & ~x37;
  assign new_n192_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & x59 & ~x58 & ~x50 & new_n194_ & ~x46;
  assign new_n194_ = ~x43 & ~x40 & new_n153_ & ~x39;
  assign z32 = x59 & ~x58 & new_n194_ & x46 & ~x50;
  assign z33 = new_n197_ & x59;
  assign new_n197_ = ~x58 & ~x50 & ~x43 & new_n153_ & x39 & ~x40;
  assign z34 = new_n199_ & x58;
  assign new_n199_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & new_n201_ & x59 & ~x60;
  assign new_n201_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n202_ & ~x50;
  assign new_n202_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n203_ & ~x40;
  assign new_n203_ = ~x39 & ~x37 & ~x35 & new_n204_ & x29 & ~x30;
  ...
  assign z36 = ~x62 & x61 & new_n208_ & ~x60;
  assign new_n208_ = x59 & ~x58 & ~x56 & ~x55 & new_n209_ & ~x51;
  assign new_n209_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n210_ & ~x41;
  assign new_n210_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n174_ & ~x30;
  assign z38 = ~x62 & ~x61 & ~x60 & x59 & new_n212_ & ~x58;
  assign new_n212_ = ~x56 & ~x55 & ~x51 & ~x50 & new_n213_ & ~x47;
  assign new_n213_ = ~x46 & ~x43 & ~x42 & ~x41 & new_n214_ & ~x40;
  assign new_n214_ = ~x39 & ~x37 & ~x35 & new_n215_ & x29 & ~x30;
  ...
  assign z39 = ~x62 & ~x61 & ~x60 & x59 & new_n219_ & ~x58;
  assign new_n219_ = ~x56 & ~x55 & ~x51 & ~x50 & new_n220_ & ~x47;
  assign new_n220_ = ~x46 & ~x43 & x42 & ~x41 & new_n214_ & ~x40;
  assign z54 = ~x62 & new_n222_ & ~x60;
  assign new_n222_ = x59 & ~x58 & ~x56 & x55 & new_n209_ & ~x51;
  assign z55 = ~x62 & ~x60 & x59 & ~x58 & new_n224_ & ~x56;
  assign new_n224_ = ~x51 & ~x50 & ~x47 & ~x46 & new_n225_ & ~x43;
  assign new_n225_ = ~x41 & ~x40 & ~x39 & new_n173_ & x35 & ~x37;
  assign z57 = new_n227_ & ~x62;
  ...
  assign new_n230_ = ~x26 & ~x25 & ~x24 & new_n231_ & x18 & ~x22;
  assign new_n231_ = ~x15 & new_n232_ & ~x14;
  assign new_n232_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & x59 & ~x58 & new_n234_ & ~x56;
  assign new_n234_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n235_ & ~x41;
  assign new_n235_ = ~x40 & ~x39 & ~x37 & new_n236_ & x29 & ~x30;
  assign new_n236_ = ~x28 & ~x26 & ~x25 & new_n231_ & x22 & ~x24;
  assign z59 = x59 & ~x58 & ~x50 & new_n153_ & x40 & ~x43;
  assign z60 = new_n239_ & ~x60;
  assign new_n239_ = x59 & ~x58 & ~x56 & ~x50 & new_n240_ & ~x47;
  ...
  assign z61 = ~x60 & x59 & ~x58 & ~x56 & new_n244_ & ~x50;
  assign new_n244_ = ~x47 & ~x46 & ~x43 & ~x40 & new_n245_ & ~x39;
  assign new_n245_ = ~x37 & ~x30 & x29 & ~x28 & new_n246_ & ~x25;
  assign new_n246_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = new_n248_ & ~x60;
  assign new_n248_ = x59 & ~x58 & ~x56 & new_n249_ & x47 & ~x50;
  assign new_n249_ = new_n250_ & ~x46;
  assign new_n250_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n251_ & ~x30;
  assign new_n251_ = x29 & new_n252_ & ~x28;
  assign new_n252_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & x59 & ~x58 & x56 & new_n249_ & ~x50;
  assign z64 = ~x60 & x59 & ~x58 & ~x50 & new_n255_ & ~x46;
  assign new_n255_ = ~x43 & ~x40 & ~x39 & new_n251_ & x30 & ~x37;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
