// Benchmark "FAU" written by ABC on Thu Aug  6 21:12:11 2020
...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n309_, new_n312_, new_n313_, new_n315_, new_n316_, new_n317_,
  ...
  assign new_n158_ = ~x60 & ~x58 & ~x56 & ~x50 & new_n159_ & x48;
  ...
  assign new_n164_ = ~x58 & ~x56 & ~x50 & x48 & new_n165_ & ~x47;
  ...
  assign z14 = ~x58 & x50 & x48 & new_n170_ & ~x43;
  assign new_n170_ = ~x37 & x29 & ~x28 & ~x15 & ~x10 & ~x14;
  assign z15 = ~x58 & x48 & new_n172_ & ~x43;
  assign new_n172_ = ~x37 & x29 & ~x28 & ~x15 & x10 & ~x14;
  assign z16 = new_n174_ & ~x62;
  assign new_n174_ = ~x60 & ~x58 & ~x56 & ~x50 & new_n175_ & x48;
  ...
  assign new_n178_ = ~x56 & ~x50 & x48 & ~x47 & new_n179_ & ~x46;
  ...
  assign new_n183_ = ~x58 & ~x56 & ~x50 & x48 & new_n184_ & ~x47;
  ...
  assign new_n188_ = x51 & ~x50 & x48 & ~x47 & new_n189_ & ~x46;
  assign new_n189_ = ~x43 & ~x41 & ~x40 & ~x39 & new_n190_ & ~x37;
  assign new_n190_ = ~x30 & x29 & new_n191_ & ~x28;
  assign new_n191_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n192_ & ~x18;
  assign new_n192_ = ~x15 & ~x14 & ~x11 & new_n193_ & ~x10;
  assign new_n193_ = ~x08 & ~x07 & ~x06 & ~x00 & ~x03;
  assign z21 = ~x62 & ~x60 & ~x58 & new_n195_ & ~x56;
  assign new_n195_ = ~x50 & x48 & ~x47 & ~x46 & new_n196_ & ~x43;
  assign new_n196_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n197_ & ~x30;
  assign new_n197_ = x29 & ~x28 & ~x26 & ~x25 & new_n198_ & ~x24;
  assign new_n198_ = ~x22 & ~x18 & ~x15 & ~x14 & new_n199_ & ~x11;
  assign new_n199_ = ~x10 & ~x08 & ~x07 & ~x06 & x00 & ~x03;
  assign z24 = new_n201_ & ~x60;
  assign new_n201_ = ~x58 & ~x50 & x48 & ~x46 & new_n202_ & ~x43;
  assign new_n202_ = ~x40 & ~x39 & ~x37 & x29 & new_n203_ & ~x28;
  assign new_n203_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & x11;
  assign z25 = ~x60 & ~x58 & ~x50 & x48 & new_n205_ & ~x46;
  assign new_n205_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n206_ & x29;
  assign new_n206_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z28 = ~x60 & ~x58 & ~x50 & new_n208_ & x48;
  assign new_n208_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n209_ & ~x37;
  assign new_n209_ = x29 & ~x28 & x25 & ~x15 & ~x10 & ~x14;
  assign z29 = x60 & ~x58 & ~x50 & x48 & new_n211_ & ~x46;
  assign new_n211_ = ~x43 & ~x40 & new_n170_ & ~x39;
  assign z32 = ~x58 & ~x50 & x48 & new_n211_ & x46;
  assign z33 = new_n214_ & ~x58;
  assign new_n214_ = ~x50 & x48 & ~x43 & ~x40 & new_n170_ & x39;
  assign z34 = x58 & new_n216_ & x48;
  assign new_n216_ = ~x43 & ~x37 & x29 & ~x28 & ~x14 & ~x15;
  assign z35 = ~x62 & ~x61 & ~x60 & new_n218_ & ~x58;
  assign new_n218_ = ~x56 & ~x55 & ~x51 & ~x50 & new_n219_ & x48;
  assign new_n219_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n220_ & ~x40;
  assign new_n220_ = ~x39 & ~x37 & ~x35 & ~x30 & new_n221_ & x29;
  assign new_n221_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n222_ & ~x22;
  assign new_n222_ = ~x18 & ~x15 & ~x14 & ~x11 & new_n223_ & ~x10;
  assign new_n223_ = ~x08 & ~x07 & ~x06 & x04 & ~x00 & ~x03;
  assign z36 = new_n225_ & ~x62;
  assign new_n225_ = x61 & ~x60 & ~x58 & ~x56 & new_n226_ & ~x55;
  assign new_n226_ = new_n227_ & ~x51;
  assign new_n227_ = ~x50 & x48 & ~x47 & ~x46 & new_n228_ & ~x43;
  assign new_n228_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n190_ & ~x35;
  assign z38 = ~x62 & ~x61 & ~x60 & new_n230_ & x59;
  assign new_n230_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n231_ & ~x50;
  assign new_n231_ = x48 & ~x47 & ~x46 & ~x43 & new_n232_ & ~x42;
  ...
  assign new_n238_ = ~x58 & ~x56 & ~x55 & ~x51 & new_n239_ & ~x50;
  assign new_n239_ = x48 & ~x47 & ~x46 & ~x43 & new_n232_ & x42;
  assign z40 = ~x62 & ~x61 & new_n241_ & ~x60;
  assign new_n241_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n242_ & x54;
  assign new_n242_ = ~x51 & ~x50 & x48 & new_n243_ & ~x47;
  ...
  assign new_n250_ = ~x55 & ~x51 & ~x50 & x48 & new_n251_ & ~x47;
  assign new_n251_ = ~x46 & ~x43 & ~x42 & ~x41 & new_n252_ & ~x40;
  assign new_n252_ = ~x39 & ~x37 & ~x35 & ~x34 & new_n245_ & x33;
  assign z42 = ~x62 & ~x61 & new_n254_ & ~x60;
  assign new_n254_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n255_ & ~x54;
  assign new_n255_ = ~x53 & ~x51 & ~x50 & x49 & new_n256_ & x48;
  assign new_n256_ = ~x47 & ~x46 & ~x45 & ~x43 & new_n257_ & ~x42;
  assign new_n257_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n258_ & ~x35;
  assign new_n258_ = ~x34 & ~x33 & ~x31 & ~x30 & new_n259_ & x29;
  assign new_n259_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n260_ & ~x22;
  assign new_n260_ = ~x18 & ~x17 & ~x15 & ~x14 & new_n261_ & ~x11;
  assign new_n261_ = ~x10 & ~x09 & ~x08 & ~x07 & new_n262_ & ~x06;
  assign new_n262_ = ~x05 & ~x04 & ~x03 & ~x02 & ~x00 & ~x01;
  assign z43 = ~x62 & new_n264_ & ~x61;
  assign new_n264_ = ~x60 & ~x59 & ~x58 & ~x56 & new_n265_ & ~x55;
  assign new_n265_ = ~x54 & ~x53 & ~x51 & ~x50 & new_n266_ & x48;
  ...
  assign z44 = new_n274_ & ~x62;
  assign new_n274_ = ~x61 & ~x60 & ~x59 & ~x58 & new_n275_ & ~x56;
  ...
  assign new_n280_ = ~x22 & ~x18 & ~x17 & ~x15 & new_n281_ & ~x14;
  assign new_n281_ = ~x11 & ~x10 & ~x09 & ~x08 & new_n282_ & ~x07;
  assign new_n282_ = ~x06 & ~x05 & ~x04 & ~x03 & ~x00 & x02;
  assign z45 = ~x62 & ~x61 & ~x60 & ~x59 & new_n284_ & ~x58;
  assign new_n284_ = ~x56 & ~x55 & ~x51 & ~x50 & new_n285_ & x48;
  assign new_n285_ = ~x47 & ~x46 & ~x43 & ~x42 & new_n286_ & ~x41;
  assign new_n286_ = ~x40 & ~x39 & ~x37 & ~x35 & new_n245_ & x34;
  assign z46 = ~x62 & ~x61 & new_n288_ & ~x60;
  assign new_n288_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n289_ & ~x51;
  assign new_n289_ = ~x50 & x48 & ~x47 & ~x46 & new_n290_ & ~x43;
  assign new_n290_ = ~x42 & ~x41 & ~x40 & ~x39 & new_n291_ & ~x37;
  assign new_n291_ = ~x35 & ~x30 & x29 & ~x28 & new_n292_ & ~x26;
  assign new_n292_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n293_ & ~x17;
  assign new_n293_ = ~x15 & ~x14 & ~x11 & ~x10 & new_n236_ & x09;
  assign z47 = ~x62 & ~x61 & new_n295_ & ~x60;
  assign new_n295_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n296_ & ~x51;
  assign new_n296_ = ~x50 & x48 & ~x47 & ~x46 & new_n297_ & ~x43;
  assign new_n297_ = ~x42 & ~x41 & ~x40 & ~x39 & new_n298_ & ~x37;
  assign new_n298_ = ~x35 & ~x30 & x29 & ~x28 & new_n299_ & ~x26;
  assign new_n299_ = ~x25 & ~x24 & ~x22 & ~x18 & new_n235_ & x17;
  assign z48 = ~x62 & ~x61 & ~x60 & new_n301_ & ~x59;
  assign new_n301_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n302_ & ~x53;
  assign new_n302_ = ~x51 & ~x50 & x48 & ~x47 & new_n303_ & ~x46;
  assign new_n303_ = ~x43 & ~x42 & ~x41 & ~x40 & new_n304_ & ~x39;
  assign new_n304_ = ~x37 & ~x35 & ~x34 & ~x33 & new_n245_ & x31;
  assign z49 = ~x62 & ~x61 & ~x60 & new_n306_ & ~x59;
  assign new_n306_ = ~x58 & ~x56 & ~x55 & ~x54 & new_n242_ & x53;
  assign z51 = ~x62 & ~x61 & new_n308_ & ~x60;
  assign new_n308_ = ~x59 & ~x58 & ~x56 & ~x55 & new_n309_ & ~x54;
  assign new_n309_ = ~x53 & ~x51 & ~x50 & ~x49 & new_n256_ & x48;
  assign z54 = ~x62 & ~x60 & ~x58 & ~x56 & new_n226_ & x55;
  assign z55 = ~x62 & ~x60 & ~x58 & ~x56 & new_n312_ & ~x51;
  assign new_n312_ = ~x50 & x48 & ~x47 & ~x46 & new_n313_ & ~x43;
  assign new_n313_ = ~x41 & ~x40 & ~x39 & ~x37 & new_n190_ & x35;
  assign z57 = new_n315_ & ~x62;
  assign new_n315_ = ~x60 & ~x58 & ~x56 & ~x50 & new_n316_ & x48;
  assign new_n316_ = ~x47 & ~x46 & ~x43 & ~x41 & new_n317_ & ~x40;
  assign new_n317_ = ~x39 & ~x37 & ~x30 & x29 & new_n318_ & ~x28;
  assign new_n318_ = ~x26 & ~x25 & ~x24 & ~x22 & new_n319_ & x18;
  assign new_n319_ = ~x15 & new_n320_ & ~x14;
  assign new_n320_ = ~x11 & ~x10 & ~x08 & ~x07 & ~x03 & ~x06;
  assign z58 = ~x62 & ~x60 & ~x58 & ~x56 & new_n322_ & ~x50;
  assign new_n322_ = x48 & ~x47 & ~x46 & ~x43 & new_n323_ & ~x41;
  assign new_n323_ = ~x40 & ~x39 & ~x37 & ~x30 & new_n324_ & x29;
  assign new_n324_ = ~x28 & ~x26 & ~x25 & ~x24 & new_n319_ & x22;
  assign z59 = ~x58 & ~x50 & x48 & ~x43 & new_n170_ & x40;
  assign z60 = new_n327_ & ~x60;
  assign new_n327_ = ~x58 & ~x56 & ~x50 & x48 & new_n328_ & ~x47;
  assign new_n328_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n329_ & ~x37;
  assign new_n329_ = ~x30 & x29 & ~x28 & ~x25 & new_n330_ & ~x24;
  assign new_n330_ = ~x15 & ~x14 & ~x11 & ~x10 & x07 & ~x08;
  assign z61 = ~x60 & ~x58 & ~x56 & ~x50 & new_n332_ & x48;
  assign new_n332_ = ~x47 & ~x46 & ~x43 & ~x40 & new_n333_ & ~x39;
  assign new_n333_ = ~x37 & ~x30 & x29 & ~x28 & new_n334_ & ~x25;
  assign new_n334_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = new_n336_ & ~x60;
  assign new_n336_ = ~x58 & ~x56 & ~x50 & x48 & new_n337_ & x47;
  assign new_n337_ = new_n338_ & ~x46;
  assign new_n338_ = ~x43 & ~x40 & ~x39 & ~x37 & new_n339_ & ~x30;
  assign new_n339_ = x29 & new_n340_ & ~x28;
  assign new_n340_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & ~x50 & new_n337_ & x48;
  assign z64 = ~x60 & ~x58 & ~x50 & x48 & new_n343_ & ~x46;
