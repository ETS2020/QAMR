...
module FAU ( 
  ...
  wire new_n135_, new_n140_, new_n141_, new_n142_, new_n143_, new_n144_,
    ...
    new_n193_, new_n197_, new_n200_, new_n201_, new_n202_, new_n203_,
    new_n204_, new_n206_, new_n207_, new_n208_, new_n209_, new_n212_,
    new_n213_, new_n214_, new_n215_, new_n217_, new_n218_, new_n219_,
    new_n221_, new_n222_, new_n223_, new_n224_, new_n227_;
  assign z04 = z05 & x15;
  assign z05 = x29 & (x35 | x43);
  assign z06 = new_n135_ & ~x43;
  assign new_n135_ = ~x37 & x35 & x29 & ~x28 & x14 & ~x15;
  ...
  assign new_n142_ = ~x37 & x35 & ~x30 & x29 & new_n143_ & ~x28;
  ...
  assign new_n148_ = x35 & ~x30 & x29 & ~x28 & new_n149_ & ~x26;
  ...
  assign new_n167_ = ~x43 & ~x40 & ~x39 & new_n168_ & x35 & ~x37;
  assign new_n168_ = ~x30 & x29 & ~x28 & ~x25 & new_n169_ & ~x24;
  assign new_n169_ = ~x15 & ~x14 & ~x11 & ~x10 & ~x07 & ~x08;
  assign z20 = ~x62 & ~x60 & ~x58 & new_n171_ & x51 & ~x56;
  assign new_n171_ = ~x50 & ~x47 & ~x46 & ~x43 & new_n172_ & ~x41;
  assign new_n172_ = ~x40 & ~x39 & ~x37 & x35 & new_n173_ & ~x30;
  ...
  assign new_n178_ = ~x40 & ~x39 & ~x37 & x35 & new_n179_ & ~x30;
  ...
  assign new_n187_ = ~x40 & ~x39 & ~x37 & new_n188_ & x29 & x35;
  assign new_n188_ = ~x28 & ~x25 & x24 & ~x15 & ~x10 & ~x14;
  assign z28 = ~x60 & ~x58 & ~x50 & new_n190_ & ~x46;
  assign new_n190_ = ~x43 & ~x40 & ~x39 & new_n191_ & x35 & ~x37;
  ...
  assign new_n197_ = ~x37 & x35 & x29 & ~x28 & ~x14 & ~x15;
  assign z55 = ~x62 & ~x60 & ~x58 & ~x56 & new_n171_ & ~x51;
  assign z57 = ~x62 & ~x60 & new_n200_ & ~x58;
  assign new_n200_ = ~x56 & ~x50 & ~x47 & ~x46 & new_n201_ & ~x43;
  assign new_n201_ = ~x41 & ~x40 & ~x39 & new_n202_ & x35 & ~x37;
  ...
  assign z58 = ~x62 & ~x60 & ~x58 & ~x56 & new_n206_ & ~x50;
  assign new_n206_ = ~x47 & ~x46 & ~x43 & new_n207_ & ~x41;
  ...
  assign new_n212_ = ~x58 & ~x56 & ~x50 & ~x47 & new_n213_ & ~x46;
  assign new_n213_ = ~x43 & ~x40 & ~x39 & new_n214_ & x35 & ~x37;
  assign new_n214_ = ~x30 & x29 & ~x28 & ~x25 & new_n215_ & ~x24;
  assign new_n215_ = ~x15 & ~x14 & ~x11 & ~x10 & x07 & ~x08;
  assign z61 = ~x60 & ~x58 & ~x56 & ~x50 & new_n217_ & ~x47;
  assign new_n217_ = ~x46 & ~x43 & ~x40 & ~x39 & new_n218_ & ~x37;
  assign new_n218_ = x35 & ~x30 & x29 & ~x28 & new_n219_ & ~x25;
  assign new_n219_ = ~x24 & ~x15 & ~x14 & ~x11 & x08 & ~x10;
  assign z62 = ~x60 & ~x58 & ~x56 & new_n221_ & x47 & ~x50;
  assign new_n221_ = ~x46 & new_n222_ & ~x43;
  assign new_n222_ = ~x40 & ~x39 & ~x37 & x35 & new_n223_ & ~x30;
  assign new_n223_ = x29 & new_n224_ & ~x28;
  assign new_n224_ = ~x25 & ~x24 & ~x15 & ~x14 & ~x10 & ~x11;
  assign z63 = ~x60 & ~x58 & x56 & new_n221_ & ~x50;
  assign z64 = ~x60 & ~x58 & ~x50 & ~x46 & new_n227_ & ~x43;
  assign new_n227_ = ~x40 & ~x39 & ~x37 & new_n223_ & x30 & x35;
  assign z00 = 1'b0;
  assign z01 = 1'b0;
  assign z02 = 1'b0;
  assign z03 = 1'b0;
