...
module FAU ( 
  ...
  assign new_n54_ = (~new_n55_ | x12) & (~new_n56_ | ~x04 | x05 | x07 | ~x12);
  ...
  assign z02 = ~x17 & (x15 ? new_n73_ : (new_n77_ | (~new_n70_ & ~x09)));
  ...
  assign new_n73_ = x18 & ((~new_n74_ & x08) | (new_n76_ & ~x08 & ~x09));
  ...
  assign new_n79_ = (x17 | new_n80_ | ~x18) & (x12 | ~x17 | x18 | (x05 & x07));
  ...
  assign new_n103_ = x15 & x17 & ~x18 & x00 & ~x05 & ~x12;
  assign new_n104_ = ~x05 & x07 & ~x12 & ~x15 & x17 & ~x18;
  assign z07 = ~x17 & ~new_n106_ & x18;
  assign new_n106_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20 & (~x12 | ~x17);
  assign z09 = (~x17 & (new_n117_ | (~new_n109_ & x18))) | (new_n119_ & ~x15 & x17 & ~x18);
  ...
  assign z12 = ~x09 & (new_n104_ | (~x07 & (new_n103_ | (new_n126_ & ~x17))));
  ...
  assign new_n141_ = ~x09 & ~x12 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  ...
  assign new_n154_ = x00 & ~x12 & x15 & x17 & ~x18;
  assign new_n155_ = x07 & ~x12 & ~x15 & x17 & ~x18;
  ...
  assign z19 = ~x18 & x17 & ~x15 & ~x12 & new_n76_ & ~x09;
  assign z20 = new_n163_ & ~x07;
  assign new_n163_ = ~x17 & (new_n170_ | (~x15 & (new_n168_ | (~new_n164_ & x18))));
  ...
  assign new_n168_ = new_n169_ & x04 & ~x05 & ~x09;
  assign new_n169_ = ~x18 & ~x21 & x12 & ~x14;
  assign new_n170_ = new_n68_ & new_n156_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign new_n190_ = ~x12 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n191_ = new_n192_ & x03 & ~x05 & ~x07 & x08;
  assign new_n192_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n194_ & ~x17) | (~x09 & ~x12 & new_n208_ & x17);
