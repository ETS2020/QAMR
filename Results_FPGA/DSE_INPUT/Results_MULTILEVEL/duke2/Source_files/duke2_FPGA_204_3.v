...
module FAU ( 
  ...
  assign z02 = ~x17 & ((~new_n70_ & ~x05) | (x18 & (new_n75_ | (new_n78_ & x05))));
  assign new_n70_ = ~new_n74_ & (x09 | (~new_n73_ & (new_n71_ | x15)));
  assign new_n71_ = (~x01 | ~x07 | x18 | (~x08 & ~x16)) & (x07 | new_n72_ | ~x18);
  assign new_n72_ = x06 ? x02 : (x04 & x12);
  assign new_n73_ = ~x07 & x18 & ((~x11 & (x06 | x15)) | (~x08 & x15));
  assign new_n74_ = x08 & x18 & (x15 ? (~x02 | x07 | ~x11) : ~x07);
  assign new_n75_ = x08 & (~new_n77_ | (~new_n76_ & ~x04));
  assign new_n76_ = (~x05 | x15) & (x07 | x09 | x11 | ~x15);
  assign new_n77_ = (~x05 | x15 | (~x07 & x12)) & (x07 | x09 | ~x15 | ~x21);
  assign new_n78_ = ~x07 & ~x09 & ~x15 & (~x08 | x21);
  assign z03 = (~new_n80_ & ~x09) | (new_n82_ & x09 & ~x15 & ~x17 & x18);
  assign new_n80_ = (x17 | new_n81_ | ~x18) & (x11 | ~x17 | x18 | (x05 & x07));
  ...
  assign z06 = ~x09 & (new_n105_ | (~x07 & (new_n104_ | (new_n94_ & ~x17))));
  ...
  assign new_n142_ = ~x09 & ~x11 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  assign z15 = new_n144_ & ~x18;
  assign new_n144_ = x17 & ~x15 & ~x11 & ~x09 & x05 & ~x07;
  ...
  assign z17 = ~x09 & (new_n152_ | (new_n66_ & new_n157_ & new_n67_ & ~x17));
  assign new_n152_ = ~x05 & (new_n156_ | (~x07 & (new_n155_ | (new_n153_ & ~x08))));
  assign new_n153_ = ~x15 & ~x17 & x18 & ~new_n154_ & (~x21 | (~x14 & x21));
  assign new_n154_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n155_ = x00 & ~x11 & x15 & x17 & ~x18;
  assign new_n156_ = x07 & ~x11 & ~x15 & x17 & ~x18;
  ...
  assign z19 = ~x18 & x17 & ~x15 & ~x11 & new_n163_ & ~x09;
  ...
  assign new_n168_ = x08 & x10 & ~x12 & ~x14 & ~new_n149_ & ~x21;
  assign new_n169_ = x08 & ~new_n64_ & ~x12;
  assign new_n170_ = x04 & ~x05 & ~x09;
  assign new_n171_ = new_n67_ & new_n157_ & ~x04 & x05 & x08 & ~x09;
