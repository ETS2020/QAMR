// Benchmark "FAU" written by ABC on Thu Aug  6 17:59:10 2020
...
module FAU ( 
  ...
  assign new_n100_ = x08 ? (x14 | new_n102_ | x21) : (new_n101_ | (x14 & (~x13 | x21)));
  ...
  assign new_n152_ = x09 & x13 & ((x15 & (~x02 | x07)) | (~x07 & ~x15 & ~x19));
  ...
  assign new_n160_ = (x14 | ((new_n161_ | x15) & (x08 | ~x15 | ~x19))) & (x08 | ~x13 | ~x15 | ~x19);
  ...
  assign new_n170_ = ~x15 & (x04 ^ x12) & (~x14 | (x13 & ~x21));
