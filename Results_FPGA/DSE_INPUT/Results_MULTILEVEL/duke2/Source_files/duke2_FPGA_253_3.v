...
module FAU ( 
  ...
  assign new_n77_ = (x17 | new_n78_ | ~x18) & (x10 | ~x17 | x18 | (x05 & x07));
  ...
  assign new_n101_ = x00 & ~x05 & ~x10 & new_n102_ & x15;
  assign new_n102_ = x17 & ~x18;
  assign new_n103_ = ~x05 & x07 & ~x10 & new_n102_ & ~x15;
  ...
  assign new_n108_ = (x17 | (~new_n114_ & (new_n109_ | ~x18))) & (x07 | x10 | ~x17 | x18);
  ...
  assign new_n139_ = ~x09 & ~x10 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  assign z15 = new_n141_ & ~x18;
  assign new_n141_ = x17 & ~x15 & ~x10 & ~x09 & x05 & ~x07;
  ...
  assign new_n149_ = (x08 | ~new_n150_ | x15) & (~new_n102_ | ~x15 | ~x00 | x10);
  assign new_n150_ = ~x17 & x18 & ~new_n151_ & (~x21 | (~x14 & x21));
  assign new_n151_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n152_ = x07 & ~x10 & new_n102_ & ~x15;
  ...
  assign new_n184_ = ~x21 & (new_n130_ | new_n185_);
  assign new_n185_ = ~x08 & ~x11 & ~x15 & x02 & ~x05 & x06;
  assign new_n186_ = new_n187_ & ~x05;
  assign new_n187_ = ~x10 & x17 & ~x18 & ((x00 & ~x07 & x15) | (x07 & ~x15));
  assign new_n188_ = new_n189_ & x03 & ~x05 & ~x07 & x08;
  assign new_n189_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n191_ & ~x17) | (~x09 & ~x10 & new_n205_ & x17);
  assign new_n191_ = (~new_n204_ | x05) & (~x18 | (~new_n202_ & (x05 | (~new_n192_ & new_n195_))));
  assign new_n192_ = ~new_n193_ & ~x02;
  assign new_n193_ = (~x08 | ~x15) & (~new_n194_ | ~x11 | x14 | x15 | ~x21);
  assign new_n194_ = ~x08 & ~x09 & x06 & ~x07;
