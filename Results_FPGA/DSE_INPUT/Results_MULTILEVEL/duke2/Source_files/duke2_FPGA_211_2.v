...
module FAU ( 
  ...
  assign z02 = ~x01 & ~x17 & ~new_n69_ & x18;
  ...
  assign new_n78_ = (x01 | x17 | new_n79_ | ~x18) & (~x17 | x18 | (x05 & x07));
  assign new_n79_ = (~x05 | x15 | (~x07 ^ ~x08)) & (~x08 | ~x15 | x05 | ~x07);
  assign new_n80_ = ~x07 & x08 & ~x01 & ~x05;
  assign z04 = ~x14 & ~x20 & (~x01 | x17);
  assign z05 = ~x01 & ~x05 & ~x07 & ~x09 & new_n83_ & ~x14;
  ...
  assign new_n91_ = ~new_n103_ & (x01 | x17 | new_n92_ | ~x18);
  ...
  assign z10 = z13 | (~x01 & ~x17 & ~new_n121_ & x18);
  assign new_n121_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x06 | x07 | x08 | x09))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z13 = ~x09 & x17 & ~x18 & (~x05 | ~x07);
  assign z12 = ~x09 & ((~new_n124_ & ~x07) | (~x05 & x07 & new_n104_ & ~x15));
  assign new_n124_ = ~new_n103_ & (x01 | x17 | ~new_n125_ | ~x18);
  ...
  assign z14 = new_n143_ | (~new_n137_ & ~x01);
  assign new_n137_ = (new_n138_ | x17) & (x05 | ~x07 | x09 | x18);
  assign new_n138_ = (~x08 | new_n139_ | ~x18) & (~new_n141_ | ~new_n142_ | x18 | x21);
  assign new_n139_ = x07 ? (x19 | (~x05 ^ x15)) : (new_n64_ | new_n140_);
  assign new_n140_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n141_ = ~x09 & x12 & x04 & ~x05;
  assign new_n142_ = ~x14 & ~x15;
  assign new_n143_ = ~x05 & ~x09 & x17 & ~x18 & (x07 | x15);
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = ~x01 & x08 & ~x17 & x18 & (new_n146_ | new_n151_);
  ...
  assign z20 = ~x01 & ~x07 & ~x17 & (new_n172_ | (~new_n166_ & ~x15));
  assign new_n166_ = (new_n167_ | ~x18) & (~new_n171_ | x18 | x21 | ~x12 | x14);
  ...
  assign new_n172_ = new_n67_ & new_n157_ & ~x04 & x05 & x08 & ~x09;
  assign z21 = ~x01 & ~x17 & ~new_n174_ & x18;
  assign new_n174_ = (x07 | ((x05 | ((x09 | ~x15 | x06 | x08) & (~x09 | x15 | ~x06 | ~x08))) & (x08 | x09 | x15 | ~x05 | ~x06))) & (x05 | ~x07 | ~x08 | x09 | ~x15);
  assign z22 = ~x01 & ~x17 & ~new_n176_ & x18;
  assign new_n176_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((x08 | x09 | x15 | ~x05 | ~x06) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  assign z23 = x18 & new_n178_ & ~x17;
  assign new_n178_ = ~x15 & x09 & x08 & ~x07 & ~x01 & ~x05;
  assign z24 = ~x01 & ~x07 & new_n180_ & ~x09;
  assign new_n180_ = ~x17 & (new_n181_ | (~x05 & ~x08 & ~x15 & x18));
  ...
  assign new_n205_ = (~x08 | ~x15) & (~new_n72_ | x08 | x09 | ~new_n206_ | x15 | ~x21);
