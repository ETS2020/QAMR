// Benchmark "FAU" written by ABC on Thu Aug  6 17:58:34 2020
...
module FAU ( 
  ...
  assign new_n171_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  ...
  assign new_n197_ = ~x14 & ~x15 & x21 & x04 & ~x06 & ~x12;
