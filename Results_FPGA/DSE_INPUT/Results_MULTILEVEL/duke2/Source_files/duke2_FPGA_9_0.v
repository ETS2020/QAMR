...
module FAU ( 
  ...
  assign new_n178_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | ~x12 | x14 | x18 | ~x19);
  ...
  assign z28 = (~new_n193_ & ~x17) | (~x07 & ~x09 & new_n208_ & x17);
  ...
  assign new_n207_ = ~x09 & x15 & ~x18 & x19 & (~x02 | ~x11);
  assign new_n208_ = ~x18 & x19 & (x05 | x15);
endmodule
