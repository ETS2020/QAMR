...
module FAU ( 
  ...
  assign z02 = ~x17 & (x15 ? new_n72_ : (new_n76_ | (~new_n69_ & ~x09)));
  ...
  assign new_n72_ = x18 & ((~new_n73_ & x08) | (new_n75_ & ~x08 & ~x09));
  ...
  assign new_n78_ = (x17 | new_n79_ | ~x18) & (~x14 | ~x17 | x18 | (x05 & x07));
  ...
  assign new_n114_ = x08 & ((new_n64_ & x05) | (x02 & ~x05 & ~x11 & ~new_n64_ & x15));
  assign new_n115_ = x05 & x08 & (~x04 | x07 | ~x12);
  assign new_n116_ = new_n117_ & x04 & ~x05 & ~x07 & ~x09;
  assign new_n117_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n118_ = ~x07 & ~x09 & x14;
  assign z10 = z13 | (~x17 & ~new_n120_ & x18);
  assign new_n120_ = (x15 | ((~x05 | ((~x07 | ~x08) & (x06 | x07 | x08 | x09))) & (x05 | x07 | ~x08 | ~x09))) & (x05 | x06 | x07 | x08 | x09 | ~x15);
  assign z13 = ~x09 & x14 & x17 & ~x18 & (~x05 | ~x07);
  assign z11 = new_n123_ & ~x18;
  assign new_n123_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & (new_n103_ | (~x07 & (new_n102_ | (new_n125_ & ~x17))));
  ...
  assign new_n133_ = x04 & x08 & ~x12 & (new_n128_ | x05) & ~x15;
  assign z14 = (new_n140_ & ~x05) | (~x17 & ((new_n138_ & ~x05) | (new_n135_ & x08)));
  assign new_n135_ = x18 & (x07 ? new_n137_ : (~new_n64_ & ~new_n136_));
  ...
  assign new_n140_ = ~x09 & x14 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  assign z15 = new_n142_ & ~x18;
  assign new_n142_ = x17 & ~x15 & x14 & ~x09 & x05 & ~x07;
  ...
  assign z17 = ~x09 & (new_n155_ | (~new_n150_ & ~x05));
  assign new_n150_ = (new_n151_ | x07) & (~x07 | ~x14 | x15 | ~x17 | x18);
  assign new_n151_ = (x08 | x15 | x17 | ~new_n152_ | ~x18) & (~new_n154_ | ~x15 | ~x17 | x18);
  assign new_n152_ = ~new_n153_ & (~x14 | ~x21);
  assign new_n153_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n154_ = x00 & x14;
  ...
  assign z19 = ~x18 & x17 & ~x15 & x14 & new_n75_ & ~x09;
  ...
  assign new_n190_ = x14 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n191_ = new_n192_ & x03 & ~x05 & ~x07 & x08;
  assign new_n192_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n194_ & ~x17) | (~x09 & x14 & new_n208_ & x17);
