...
module FAU ( 
  ...
  assign new_n55_ = x10 & x17 & ((x05 & (~x07 | ~x15)) | (~x05 & x15 & (~x00 | x07)) | (~x07 & ~x15));
  ...
  assign new_n141_ = ~x09 & x10 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  ...
  assign new_n154_ = x00 & x10 & x15 & x17 & ~x18;
  assign new_n155_ = x07 & x10 & ~x15 & x17 & ~x18;
  ...
  assign z19 = ~x18 & x17 & ~x15 & x10 & new_n76_ & ~x09;
  ...
  assign new_n170_ = new_n68_ & new_n156_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign z28 = (~new_n194_ & ~x17) | (~x09 & x10 & new_n208_ & x17);
