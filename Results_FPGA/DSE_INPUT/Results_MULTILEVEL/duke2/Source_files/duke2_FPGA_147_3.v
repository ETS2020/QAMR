...
module FAU ( 
  ...
  assign new_n54_ = (~new_n55_ | x04) & (~new_n56_ | ~x04 | x05 | x07 | ~x12);
  assign new_n55_ = x17 & ((x05 & (~x07 | ~x15)) | (~x05 & x15 & (~x00 | x07)) | (~x07 & ~x15));
  assign new_n56_ = ~x17 & ~x21 & ~x14 & ~x15;
  ...
  assign new_n78_ = ~new_n79_ & (x17 | new_n80_ | ~x18);
  assign new_n79_ = ~x04 & x17 & ~x18 & (~x05 | ~x07);
  ...
  assign z06 = ~x09 & (new_n99_ | (~x05 & (new_n102_ | (~new_n93_ & ~x07))));
  assign new_n93_ = ~new_n98_ & (x17 | ~x18 | (~new_n94_ & (~new_n97_ | x02)));
  ...
  assign new_n98_ = x00 & ~x04 & x15 & x17 & ~x18;
  assign new_n99_ = x04 & ~x07 & x08 & ~x12 & new_n100_ & ~x15;
  assign new_n100_ = ~x17 & x18 & ~x21 & (x05 | (~new_n101_ & ~x14));
  assign new_n101_ = x13 & (x02 | ~x11);
  assign new_n102_ = new_n103_ & ~x04 & x07;
  ...
  assign z09 = new_n116_ | (~x15 & (new_n108_ | (~new_n118_ & ~x04)));
  assign new_n108_ = ~x17 & (new_n115_ | (~x09 & (new_n114_ | (~new_n109_ & x18))));
  ...
  assign new_n114_ = new_n74_ & x04 & x12 & ~x14 & ~x18 & ~x21;
  ...
  assign new_n118_ = (x17 | ~x18 | ~x05 | ~x08) & (~x17 | x18 | x07 | x09);
  assign z10 = (new_n121_ & x08) | (~x09 & (new_n79_ | (new_n120_ & ~x06)));
  assign new_n120_ = ~x07 & ~x08 & ~x17 & x18 & (~x05 ^ ~x15);
  assign new_n121_ = ~x15 & ~x17 & x18 & (x05 ? x07 : (~x07 & x09));
  assign z11 = new_n123_ & ~x18;
  assign new_n123_ = ~x17 & ~x15 & ~x09 & x07 & x01 & ~x05;
  assign z12 = ~x09 & ((~new_n125_ & ~x07) | (new_n103_ & ~x04 & ~x05 & x07));
  assign new_n125_ = (x17 | ~new_n126_ | ~x18) & (~x15 | ~x17 | x18 | ~new_n137_ | ~x00);
  ...
  assign z14 = (~new_n140_ & ~x17) | (new_n145_ & ~x04);
  ...
  assign new_n144_ = (~x07 | (x01 & ~x15)) & (~new_n76_ | x14 | x15 | x21);
  assign new_n145_ = ~x05 & ~x09 & ~x18 & ((x07 & (x15 | x17)) | (x15 & x17));
  assign z15 = new_n147_ & ~x18;
  assign new_n147_ = x17 & ~x15 & ~x09 & ~x07 & ~x04 & x05;
  assign z16 = x08 & ~x17 & x18 & (x05 ? new_n152_ : ~new_n149_);
  assign new_n149_ = (x07 | x15 | (x09 ? x19 : ~new_n150_)) & (~x09 | ~x15 | (x02 & ~x07));
  assign new_n150_ = ~x14 & ~new_n151_ & ~x21;
  assign new_n151_ = (new_n61_ | (new_n101_ & (~x02 | ~x06))) & (~x12 | new_n101_ | (x06 ^ ~x16));
  assign new_n152_ = x09 & ~x15 & (x07 | ~x12);
  assign z17 = ~x09 & (new_n157_ | (~x05 & (new_n102_ | (~new_n154_ & ~x07))));
  assign new_n154_ = ~new_n98_ & (x08 | x15 | x17 | ~new_n155_ | ~x18);
  assign new_n155_ = ~new_n156_ & (~x21 | (~x14 & x21));
  ...
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & new_n137_ & ~x07;
  ...
  assign new_n167_ = x08 & x10 & ~x12 & ~x14 & ~new_n101_ & ~x21;
  ...
  assign new_n175_ = (x05 | ~x07 | ~x08 | ~x15) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  ...
  assign z27 = new_n192_ | (~x09 & (new_n190_ | (~x17 & ~new_n187_ & x18)));
  assign new_n187_ = x07 ? (~x08 | ~x19 | (x05 ^ ~x15)) : (~new_n188_ & (x15 | ~x19 | ~x05 | x08));
  assign new_n188_ = ~x21 & (new_n127_ | new_n189_);
  ...
  assign new_n202_ = x04 & ~x06 & ~x12 & ~x14 & ~x15 & x21;
