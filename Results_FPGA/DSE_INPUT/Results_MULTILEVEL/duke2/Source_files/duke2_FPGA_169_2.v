...
module FAU ( 
  ...
  assign z01 = ~x17 & (new_n66_ | (~x05 & (new_n58_ | (new_n64_ & ~x02))));
  assign new_n58_ = ~x09 & (new_n63_ | (~x07 & ~new_n59_ & x18));
  ...
  assign new_n63_ = x02 & x07 & ~x10 & x11 & x15 & ~x18;
  ...
  assign new_n71_ = x01 & x07 & ~x10 & ~x18 & (x08 | x16);
  ...
  assign new_n96_ = (x06 | ((~x02 | x10) & (x13 | x16 | ~x10 | ~x12))) & (x13 | (x10 & (~x06 | ~x10 | ~x12 | ~x16)));
  ...
  assign new_n103_ = x15 & x17 & ~x18 & x00 & ~x05 & ~x10;
  assign new_n104_ = ~x05 & x07 & ~x10 & ~x15 & x17 & ~x18;
  ...
  assign new_n116_ = x08 & ((new_n65_ & x05) | (x02 & ~x05 & ~x11 & ~new_n65_ & x15));
  assign new_n117_ = ~x09 & ~x10 & ~x15 & ~new_n118_ & ~x18;
  ...
  assign new_n136_ = x07 ? (x19 | (x05 ^ ~x15)) : (new_n65_ | new_n137_);
  assign new_n137_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n138_ = new_n139_ & x04 & ~x05 & ~x07 & ~x09 & ~x10;
  assign new_n139_ = x12 & ~x14 & ~x15 & ~x18 & ~x21;
  assign new_n140_ = ~x10 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = new_n142_ & ~x18;
  assign new_n142_ = x17 & ~x15 & ~x10 & ~x09 & x05 & ~x07;
  ...
  assign new_n153_ = x00 & ~x10 & x15 & x17 & ~x18;
  assign new_n154_ = x07 & ~x10 & ~x15 & x17 & ~x18;
  ...
  assign new_n166_ = x08 & ~new_n65_ & ~x12;
  assign new_n167_ = new_n168_ & ~x09 & ~x10 & x04 & ~x05;
  assign new_n168_ = x12 & ~x14 & ~x18 & ~x21;
  assign new_n169_ = new_n68_ & new_n155_ & x08 & ~x09 & ~x04 & x05;
  ...
  assign new_n178_ = (~x05 | ~x08 | x12 | ~x18) & (x05 | x10 | ~x12 | x14 | x18);
  assign new_n179_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n180_ = ~x05 & ~x08 & ~x15 & x18;
  assign new_n181_ = x08 & ~x10 & ~x15 & ~x18;
  ...
  assign z28 = (~new_n194_ & ~x17) | (~x09 & ~x10 & new_n209_ & x17);
  ...
  assign new_n201_ = x04 & ~x06 & ~x12 & ~x14 & ~x15 & x21;
  ...
  assign new_n208_ = ~x09 & ~x10 & x15 & ~x18 & (~x02 | ~x11);
