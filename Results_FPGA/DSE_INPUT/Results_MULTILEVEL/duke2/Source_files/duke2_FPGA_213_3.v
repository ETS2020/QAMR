...
module FAU ( 
  ...
  assign new_n78_ = ~x19 & ((x05 & ~x15 & (x07 ^ ~x08)) | (~x05 & x07 & x08 & x15));
  assign new_n79_ = ~x15 & ~x17 & x18 & ~x19;
  ...
  assign z07 = ~x17 & x18 & ~new_n106_ & ~x19;
  assign new_n106_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20 & (~x18 | ~x19);
  assign z09 = new_n118_ | (~x17 & x18 & ~new_n109_ & ~x19);
  assign new_n109_ = (x15 | (~new_n110_ & ~new_n116_)) & (x07 | new_n117_ | ~x08);
  assign new_n110_ = ~x09 & ((~x07 & ((x05 & ~x08) | (~new_n111_ & ~x21))) | (x05 & x08 & x21));
  assign new_n111_ = (~x04 | (~new_n112_ & ~new_n113_)) & ~new_n115_ & (~new_n114_ | ~x02);
  ...
  assign new_n126_ = ~new_n103_ & (x17 | ~x18 | ~new_n127_ | x19);
  ...
  assign new_n139_ = x18 & ~new_n140_ & ~x19;
  assign new_n140_ = (new_n141_ | (~x09 & x21)) & (~x07 | (x05 ^ ~x15));
  assign new_n141_ = (x02 | x05 | ~x11 | ~x15) & (x12 | x15 | ~x04 | ~x05);
  assign new_n142_ = new_n143_ & new_n56_ & ~x15 & ~x18 & ~x21;
  assign new_n143_ = ~x07 & ~x09 & x04 & ~x05;
  assign new_n144_ = ~x09 & ~x18 & ((x15 & (x07 | x17)) | (x07 & (~x01 | x17)));
  assign z15 = ~x18 & x17 & ~x15 & ~x09 & x05 & ~x07;
  assign z16 = x08 & ~x17 & x18 & ~x19 & (new_n147_ | new_n151_);
  assign new_n147_ = ~x05 & ((~x07 & ~x15 & (new_n148_ | x09)) | (x09 & x15 & (~x02 | x07)));
  ...
  assign new_n153_ = (x07 | ((x08 | ~new_n154_ | x15) & (~new_n104_ | ~x00 | ~x15))) & (~new_n104_ | ~x07 | x15);
  ...
  assign new_n159_ = ~x17 & x18 & ~x19 & (new_n83_ | (~new_n160_ & x12));
  assign new_n160_ = (new_n161_ | x06) & (~new_n87_ | ~x06 | ~x08 | ~x10);
  assign new_n161_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & ~x05 & ~x07;
  assign z20 = ~x07 & ~x17 & (new_n170_ | (~new_n164_ & ~x15));
  assign new_n164_ = ~new_n168_ & (~x18 | x19 | (~new_n169_ & (new_n165_ | x09)));
  assign new_n165_ = (~new_n167_ | x05) & (~x04 | ~x08 | ~new_n166_ | ~x10);
  assign new_n166_ = ~x12 & ~x14 & ~new_n150_ & ~x21;
  ...
  assign z27 = ~new_n187_ & ~x09;
  assign new_n187_ = (~new_n104_ | x15 | x05 | ~x07) & (x07 | (~new_n188_ & (~x00 | x05 | ~new_n104_ | ~x15)));
  assign new_n188_ = ~x17 & x18 & ~x19 & ~x21 & (new_n128_ | new_n189_);
  assign new_n189_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign z28 = (~x17 & (new_n191_ | (new_n201_ & ~x05))) | (~x09 & new_n202_ & x17);
  assign new_n191_ = x18 & ~x19 & (new_n199_ | (~x05 & (~new_n192_ | new_n197_)));
  assign new_n192_ = (x07 | new_n193_ | x09) & (~x08 | ~x15 | (~x07 & x11));
  assign new_n193_ = (new_n194_ | x08) & ~new_n196_ & (~x08 | ~x10 | ~new_n195_ | ~x12);
  assign new_n194_ = ~x15 & (~x04 | x06 | x12 | x14 | ~x21);
  assign new_n195_ = ~x14 & ~x15 & ~x21 & (x02 | x11 | ~x13);
  assign new_n196_ = x15 & x21;
  assign new_n197_ = ~x02 & ((x08 & x15) | (new_n198_ & x06 & ~x07 & ~x08));
  assign new_n198_ = ~x09 & x11 & ~x14 & x21;
