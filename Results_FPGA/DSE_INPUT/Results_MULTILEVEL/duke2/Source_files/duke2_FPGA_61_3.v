...
module FAU ( 
  ...
  assign z06 = ~x09 & ((~new_n92_ & ~x07) | (~x05 & x07 & new_n104_ & ~x15));
  assign new_n92_ = (x00 | x17 | new_n93_ | ~x18) & (~x00 | x05 | ~x15 | ~x17 | x18);
  ...
  assign new_n98_ = (x06 | ((~x02 | x10) & (~x10 | ~x12 | x13 | x16))) & (x13 | (x10 & (~x12 | ~x16 | ~x06 | ~x10)));
  ...
  assign z09 = new_n117_ | (~x00 & ~x17 & ~new_n109_ & x18);
  ...
  assign z10 = z13 | (~x00 & ~x17 & ~new_n120_ & x18);
  ...
  assign new_n125_ = (~x00 | x05 | ~x15 | ~x17 | x18) & (x00 | x17 | ~new_n126_ | ~x18);
  ...
  assign new_n138_ = ~x17 & (new_n141_ | (~x00 & x08 & ~new_n139_ & x18));
  ...
  assign new_n152_ = (x07 | ((x00 | x08 | ~new_n153_ | x15) & (~new_n104_ | ~x00 | ~x15))) & (~new_n104_ | ~x07 | x15);
  assign new_n153_ = ~x17 & x18 & ~new_n154_ & (~x21 | (~x14 & x21));
  assign new_n154_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n155_ = new_n156_ & ~x00 & ~x04 & x05 & ~x07 & x08;
