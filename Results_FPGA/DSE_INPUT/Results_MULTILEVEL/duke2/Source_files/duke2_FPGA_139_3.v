...
module FAU ( 
  ...
  assign z06 = ~x09 & (new_n105_ | (~x07 & (new_n103_ | (new_n92_ & ~x17))));
  assign new_n92_ = x18 & (new_n101_ | (~x15 & (new_n99_ | (~new_n93_ & ~x21))));
  assign new_n93_ = (x02 | new_n94_ | ~x11) & ~new_n98_ & (new_n96_ | ~x08);
  assign new_n94_ = ~new_n95_ & (x12 | x14 | ~x04 | ~x08);
  assign new_n95_ = ~x05 & x06 & ~x08;
  ...
  assign z09 = new_n119_ | (~x15 & ((~new_n110_ & ~x09) | (new_n118_ & x05)));
  assign new_n110_ = ~new_n117_ & (x07 | (~new_n116_ & (new_n111_ | x17)));
  assign new_n111_ = ~new_n115_ & (~x18 | (x05 ? (x08 | x19) : ~new_n112_));
  ...
  assign new_n116_ = ~x02 & ((x17 & ~x18) | (new_n95_ & x18 & ~x21 & x11 & ~x17));
  assign new_n117_ = x05 & x08 & ~x17 & x18 & x21;
  assign new_n118_ = x08 & ~x17 & ~new_n76_ & x18;
  assign new_n119_ = ~x07 & x08 & ~x17 & ~new_n120_ & x18;
  assign new_n120_ = (~x02 | x05 | x11 | ~x15 | (~x09 & x21)) & (~x05 | x09 | ~x21);
  assign z10 = (new_n123_ & x08) | (~x09 & (new_n79_ | (new_n122_ & ~x06)));
  ...
  assign z14 = (~new_n137_ & ~x17) | (new_n142_ & ~x02);
  assign new_n137_ = (~x08 | new_n138_ | ~x18) & (x05 | x09 | new_n141_ | x18);
  ...
  assign new_n141_ = (~x07 | (x01 & ~x15)) & (~new_n76_ | x14 | x15 | x21);
  assign new_n142_ = ~x05 & ~x09 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  assign z15 = new_n144_ & ~x18;
  assign new_n144_ = x17 & ~x15 & ~x09 & ~x07 & ~x02 & x05;
  ...
  assign z17 = ~x09 & (new_n155_ | (~x05 & (new_n156_ | (~new_n152_ & ~x07))));
  ...
  assign new_n156_ = new_n104_ & ~x15 & ~x02 & x07;
  ...
  assign new_n162_ = x17 & ~x15 & ~x09 & ~x07 & ~x02 & ~x05;
  ...
  assign new_n175_ = (~x08 | ~x15 | x05 | ~x07) & (x07 | ((~x05 | ~x06 | x08 | x09 | x15) & (x05 | ((~x08 | ~x09 | x15) & (x09 | ~x15 | ~x06 | x08)))));
  ...
  assign z27 = (~new_n188_ & ~x09) | (new_n193_ & new_n66_ & x03 & ~x05);
  assign new_n188_ = x05 ? (x17 | new_n190_ | ~x18) : (~new_n192_ & (x17 | new_n189_ | ~x18));
  assign new_n189_ = (x07 | x08 | x15 | new_n154_ | x21) & (~x15 | ~x19 | ~x07 | ~x08);
  assign new_n190_ = (x07 | ((x08 | x15 | ~x19) & (~new_n191_ | x04 | ~x08))) & (x15 | ~x19 | ~x07 | ~x08);
  assign new_n191_ = ~x11 & x15 & ~x21;
  assign new_n192_ = ~x02 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n193_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n195_ & ~x17) | (~x02 & ~x09 & new_n209_ & x17);
