...
module FAU ( 
  ...
  assign z01 = ~x17 & (new_n67_ | (x01 & new_n58_ & ~x07));
  ...
  assign new_n70_ = (new_n71_ | x05) & (~x08 | (~new_n75_ & new_n76_)) & (~new_n77_ | ~x05);
  assign new_n71_ = ~new_n72_ & (x07 | ((x09 | (~new_n74_ & (x08 | ~x15))) & (~x08 | x15))) & (~x07 | ~x08 | ~x15);
  assign new_n72_ = ~new_n73_ & ((x08 & x15) | (x06 & ~x07 & ~x09 & ~x15));
  ...
  assign new_n82_ = new_n83_ & ~x07 & x08;
  ...
  assign z06 = ~x09 & (new_n94_ | (new_n68_ & ~x15 & x17 & ~x18));
  assign new_n94_ = ~x07 & (new_n106_ | (x01 & ~x17 & ~new_n95_ & x18));
  ...
  assign new_n100_ = (x06 | ((~x02 | x10) & (~x10 | ~x12 | x13 | x16))) & (x13 | (x10 & (~x12 | ~x16 | ~x06 | ~x10)));
  ...
  assign z09 = new_n119_ | (x01 & ~x17 & ~new_n111_ & x18);
  ...
  assign new_n139_ = ~x17 & (new_n142_ | (x01 & x08 & ~new_n140_ & x18));
  ...
  assign z16 = x01 & x08 & ~x17 & x18 & (new_n147_ | new_n151_);
  ...
  assign new_n154_ = x01 & new_n155_ & ~x08;
  ...
  assign z20 = ~x07 & ~x17 & (new_n171_ | (new_n166_ & x01));
  ...
  assign new_n178_ = ~x15 & x09 & x08 & new_n83_ & ~x07;
  assign z24 = ~x09 & ~x17 & (new_n184_ | (~new_n180_ & ~x07));
  assign new_n180_ = (new_n181_ | x21) & (~new_n83_ | x08 | x15 | ~x18);
  assign new_n181_ = (~x04 | new_n182_ | x15) & (~x01 | ~x08 | ~new_n183_ | ~x15);
  assign new_n182_ = (~x01 | ~x05 | ~x08 | x12 | ~x18) & (x14 | x18 | x05 | ~x12);
  assign new_n183_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n184_ = x08 & ~x15 & ~x18 & new_n68_ & x01;
  assign z25 = x01 & new_n186_ & ~x05;
  assign new_n186_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x14 | x21) & (x01 | ~x18);
  assign z27 = new_n194_ | (~x09 & (new_n196_ | (x01 & new_n189_ & ~x17)));
  assign new_n189_ = x18 & (x07 ? new_n193_ : ~new_n190_);
  assign new_n190_ = ~new_n192_ & (x21 | (~new_n128_ & ~new_n191_));
  assign new_n191_ = x02 & ~x05 & x06 & ~x08 & ~x11 & ~x15;
  assign new_n192_ = x05 & ~x08 & ~x15 & x19;
  assign new_n193_ = x08 & x19 & (~x05 ^ ~x15);
  ...
  assign z28 = (~x17 & (new_n210_ | (new_n198_ & x01))) | (~x09 & new_n211_ & x17);
  ...
  assign new_n210_ = ~x05 & x07 & ~x09 & x15 & ~new_n73_ & ~x18;
