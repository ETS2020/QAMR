// Benchmark "FAU" written by ABC on Thu Aug  6 17:58:36 2020
...
module FAU ( 
  ...
  assign new_n65_ = new_n66_ & x02 & x06 & x07;
  ...
  assign new_n105_ = new_n106_ & x00 & x15 & x17 & ~x18;
  assign new_n106_ = ~x05 & x06;
  assign new_n107_ = ~x05 & x06 & x07 & ~x15 & x17 & ~x18;
  assign z07 = ~x17 & ~new_n109_ & x18;
  assign new_n109_ = (x09 | (~x07 ^ ~x08) | (~x05 ^ x15)) & (x05 | x07 | ~x08 | ~x09 | x15 | ~x16);
  assign z08 = x14 & ~x20 & (x06 | x18);
  assign z09 = new_n120_ | (~x17 & x18 & (new_n112_ | (new_n119_ & ~x07)));
  assign new_n112_ = ~x15 & (new_n118_ | (~new_n113_ & ~x09));
  ...
  assign new_n119_ = x08 & ((new_n64_ & x05) | (x02 & ~x05 & ~x11 & ~new_n64_ & x15));
  assign new_n120_ = x06 & ~x07 & ~x09 & ~x15 & ~new_n121_ & ~x18;
  ...
  assign z11 = ~x18 & new_n126_ & ~x17;
  assign new_n126_ = ~x15 & ~x09 & x07 & x06 & x01 & ~x05;
  assign z12 = ~x09 & (new_n107_ | (~x07 & (new_n105_ | (new_n128_ & ~x17))));
  ...
  assign z14 = new_n138_ | (~x05 & new_n143_ & x06);
  ...
  assign z17 = ~x09 & (new_n153_ | (new_n68_ & new_n158_ & new_n69_ & ~x17));
  assign new_n153_ = ~x05 & (new_n157_ | (~x07 & (new_n156_ | (new_n154_ & ~x08))));
  assign new_n154_ = ~x15 & ~x17 & x18 & ~new_n155_ & (~x21 | (~x14 & x21));
  assign new_n155_ = (~x02 | ~x06 | x11) & (x04 | x06 | ~x12);
  assign new_n156_ = x00 & x06 & x15 & x17 & ~x18;
  assign new_n157_ = x06 & x07 & ~x15 & x17 & ~x18;
  assign new_n158_ = ~x11 & x15;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n160_ & x18;
  assign new_n160_ = (x14 | x15 | (~new_n86_ & ~new_n161_)) & (x08 | ~x15 | ~x19);
  assign new_n161_ = x12 & ((~new_n162_ & ~x06) | (new_n90_ & x06 & x08 & x10));
  assign new_n162_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & ~x15 & ~x09 & new_n106_ & ~x07;
  assign z20 = new_n165_ & ~x07;
  assign new_n165_ = ~x17 & (new_n172_ | (~x15 & (new_n170_ | (~new_n166_ & x18))));
  assign new_n166_ = (x09 | ((~new_n168_ | ~x04) & (~new_n167_ | x05))) & (~x04 | ~new_n169_ | ~x05);
  assign new_n167_ = ~x06 & ~x08 & ~new_n92_ & (~x14 | ~x21);
  assign new_n168_ = x08 & x10 & ~x12 & ~x14 & ~new_n150_ & ~x21;
  assign new_n169_ = x08 & ~new_n64_ & ~x12;
  assign new_n170_ = new_n171_ & x04 & ~x05 & x06 & ~x09;
  assign new_n171_ = x12 & ~x14 & ~x18 & ~x21;
  assign new_n172_ = new_n69_ & new_n158_ & ~x04 & x05 & x08 & ~x09;
  ...
  assign new_n181_ = (x12 | ~x18 | ~x05 | ~x08) & (x05 | ~x06 | ~x12 | x14 | x18);
  assign new_n182_ = x18 & ((~x04 & x05 & ~x11) | (~x02 & ~x05 & x11));
  assign new_n183_ = new_n106_ & x01 & ~x15 & ~x18 & x07 & x08;
  assign z25 = new_n185_ & ~x05;
  assign new_n185_ = ~x07 & ~x17 & x18 & (x08 ? (x09 & ~x15) : (~x09 & x15));
  assign z26 = ~x20 & (x06 | x18) & (x14 | x21);
  ...
  assign new_n190_ = new_n106_ & x02 & ~x08 & ~x11 & ~x15;
  assign new_n191_ = new_n192_ & ~x05;
  assign new_n192_ = x06 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n193_ = new_n194_ & ~x07 & x08 & x03 & ~x05;
  assign new_n194_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n196_ & ~x17) | (x06 & ~x09 & new_n210_ & x17);
  assign new_n196_ = (~new_n209_ | x05) & (~x18 | (~new_n207_ & (x05 | (~new_n197_ & new_n200_))));
  assign new_n197_ = ~new_n198_ & ~x02;
  assign new_n198_ = (~x08 | ~x15) & (~new_n199_ | ~x11 | x14 | x15 | ~x21);
  ...
  assign new_n209_ = x06 & x07 & ~x09 & x15 & ~new_n74_ & ~x18;
