...
module FAU ( 
  ...
  assign new_n55_ = x00 & x17 & ((x05 & (~x07 | ~x15)) | (~x07 & ~x15) | (~x05 & x07 & x15));
  ...
  assign new_n78_ = x09 & ~x15 & ~x17 & x18 & new_n66_ & ~x05;
  assign new_n79_ = x00 & x17 & ~x18 & (~x05 | ~x07);
  assign new_n80_ = ~x17 & x18 & ((x05 & ~x15 & (x07 ^ ~x08)) | (x08 & x15 & ~x05 & x07));
  ...
  assign new_n95_ = (x06 | ((~x02 | x10) & (~x10 | ~x12 | x13 | x16))) & (x13 | (x10 & (~x06 | ~x10 | ~x12 | ~x16)));
  ...
  assign z14 = (~new_n133_ & ~x17) | (new_n137_ & x00);
  ...
  assign new_n137_ = ~x05 & ~x09 & ~x18 & ((x07 & (x15 | x17)) | (x15 & x17));
  assign z15 = new_n139_ & ~x18;
  assign new_n139_ = x17 & ~x15 & ~x09 & ~x07 & x00 & x05;
  ...
  assign new_n146_ = ~new_n100_ & (x07 | x08 | ~new_n147_ | x15);
  assign new_n147_ = ~x17 & x18 & ~new_n148_ & (~x21 | (~x14 & x21));
  assign new_n148_ = (x04 | x06 | ~x12) & (~x02 | ~x06 | x11);
  assign new_n149_ = new_n130_ & ~x17 & x18 & ~x21;
  assign z18 = ~x05 & ~x07 & ~x09 & ~x17 & ~new_n151_ & x18;
  assign new_n151_ = (x14 | x15 | (~new_n84_ & ~new_n152_)) & (x08 | ~x15 | ~x19);
  assign new_n152_ = x12 & ((~new_n153_ & ~x06) | (new_n88_ & x06 & x08 & x10));
  assign new_n153_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = new_n155_ & ~x18;
  assign new_n155_ = x17 & ~x15 & ~x09 & ~x07 & x00 & ~x05;
  assign z20 = new_n157_ & ~x07;
  ...
  assign new_n159_ = ~x06 & ~x08 & ~new_n90_ & (~x14 | ~x21);
  assign new_n160_ = x08 & x10 & ~x12 & ~x14 & ~new_n99_ & ~x21;
  assign new_n161_ = x08 & ~new_n64_ & ~x12;
  assign new_n162_ = new_n163_ & x04 & ~x05 & ~x09;
  assign new_n163_ = ~x18 & ~x21 & x12 & ~x14;
  assign new_n164_ = new_n165_ & new_n130_ & x18 & ~x21;
  assign new_n165_ = x08 & ~x09 & ~x04 & x05;
  ...
  assign z27 = (~new_n182_ & ~x09) | (new_n186_ & new_n66_ & x03 & ~x05);
  assign new_n182_ = x05 ? (x17 | new_n184_ | ~x18) : (~new_n100_ & (x17 | new_n183_ | ~x18));
  assign new_n183_ = (x07 | x08 | x15 | new_n148_ | x21) & (~x07 | ~x08 | ~x15 | ~x19);
  assign new_n184_ = (x07 | ((x08 | x15 | ~x19) & (~new_n185_ | x04 | ~x08))) & (x15 | ~x19 | ~x07 | ~x08);
  assign new_n185_ = ~x11 & x15 & ~x21;
  assign new_n186_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n188_ & ~x17) | (x00 & ~x09 & new_n202_ & x17);
  assign new_n188_ = (~new_n201_ | x05) & (~x18 | (~new_n199_ & (x05 | (~new_n189_ & new_n192_))));
  assign new_n189_ = ~new_n190_ & ~x02;
  assign new_n190_ = (~x08 | ~x15) & (~new_n191_ | ~x06 | x07 | x08 | x09);
