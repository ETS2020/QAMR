...
module FAU ( 
  ...
  assign new_n55_ = x16 & x17 & ((x05 & (~x07 | ~x15)) | (~x07 & ~x15) | (~x05 & x15 & (~x00 | x07)));
  ...
  assign new_n78_ = (x17 | new_n79_ | ~x18) & (~x16 | ~x17 | x18 | (x05 & x07));
  ...
  assign z14 = (new_n141_ & ~x05) | (~x17 & ((new_n139_ & ~x05) | (new_n136_ & x08)));
  assign new_n136_ = x18 & (x07 ? new_n138_ : (~new_n64_ & ~new_n137_));
  ...
  assign new_n141_ = ~x09 & x16 & ~x18 & ((x15 & x17) | (x07 & (x15 | x17)));
  assign z15 = new_n143_ & ~x18;
  assign new_n143_ = x17 & x16 & ~x15 & ~x09 & x05 & ~x07;
  ...
  assign new_n151_ = (x07 | ((x08 | ~new_n152_ | x15) & (~new_n103_ | ~x00 | ~x15))) & (~new_n103_ | ~x07 | x15);
  ...
  assign new_n156_ = (x14 | x15 | (~new_n84_ & ~new_n157_)) & (x08 | ~x15 | ~x19);
  assign new_n157_ = x12 & ((~new_n158_ & ~x06) | (new_n88_ & x06 & x08 & x10));
  assign new_n158_ = (x04 | x08 | ~x21) & (~x08 | ~x10 | x13 | x16 | x21);
  assign z19 = ~x18 & x17 & x16 & ~x15 & new_n75_ & ~x09;
  assign z20 = new_n161_ & ~x07;
  assign new_n161_ = ~x17 & (new_n168_ | (~x15 & (new_n166_ | (~new_n162_ & x18))));
  assign new_n162_ = (x09 | ((~new_n163_ | x05) & (~new_n164_ | ~x04))) & (~x04 | ~new_n165_ | ~x05);
  assign new_n163_ = ~x06 & ~x08 & ~new_n90_ & (~x14 | ~x21);
  assign new_n164_ = x08 & x10 & ~x12 & ~x14 & ~new_n148_ & ~x21;
  assign new_n165_ = x08 & ~new_n64_ & ~x12;
  assign new_n166_ = new_n167_ & x04 & ~x05 & ~x09;
  assign new_n167_ = ~x18 & ~x21 & x12 & ~x14;
  ...
  assign new_n189_ = x16 & x17 & ~x18 & ((x07 & ~x15) | (x00 & ~x07 & x15));
  assign new_n190_ = new_n191_ & x03 & ~x05 & ~x07 & x08;
  assign new_n191_ = x09 & ~x15 & ~x17 & x18 & x19;
  assign z28 = (~new_n193_ & ~x17) | (~x09 & x16 & new_n207_ & x17);
