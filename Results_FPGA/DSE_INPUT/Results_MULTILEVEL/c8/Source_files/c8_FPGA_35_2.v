...
module FAU ( 
  ...
  assign z07 = (~x11 & (x27 ? ~x15 : ~x26)) | (~x15 & x26 & x27);
  ...
  assign z16 = x16 ? (new_n77_ | (~new_n74_ & x26)) : (~new_n79_ & (~x11 | x26));
  assign new_n77_ = new_n78_ & ~x11 & ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n78_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n79_ = x18 ? ~x07 : ~x15;
  assign z17 = x16 & ((~x11 & (new_n81_ | (x17 & x27))) | (x17 & x26 & x27));
  assign new_n81_ = new_n78_ & ~x20 & ~x21 & ~x17 & x19;
endmodule
