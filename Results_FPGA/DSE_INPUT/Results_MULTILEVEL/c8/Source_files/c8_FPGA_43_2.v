...
module FAU ( 
  ...
  assign new_n67_ = (x20 | ((~x23 | (~x17 & ~x19 & ~x21)) & (x17 | x19 | x21 | x22 | x23))) & (~x22 | ~x23);
  ...
  assign new_n72_ = (~x22 | ~x25) & (x20 | ((~new_n73_ | ~new_n75_) & (new_n74_ | ~x25)));
  assign new_n73_ = ~x17 & ~x19 & ~x21;
  assign new_n74_ = ~x17 & ~x19 & ~x21 & ~x23 & ~x24;
  assign new_n75_ = ~x24 & ~x25 & ~x22 & ~x23;
  assign z16 = x16 ? ((x22 & x26) | (~new_n77_ & ~x20)) : (~new_n79_ & (~x20 | x22));
