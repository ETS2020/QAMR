...
module FAU ( 
  ...
  assign new_n65_ = x19 ? (~x22 | ~x26) : ((~x22 | (~x17 & ~x20 & ~x21)) & (x17 | x20 | x21 | x22));
  assign z13 = x16 ? (x19 ? (x23 & x26) : ~new_n68_) : (~new_n67_ & (~x19 | x26));
  assign new_n67_ = x18 ? ~x04 : ~x12;
  assign new_n68_ = (~x23 | (~x21 & ~x22 & ~x17 & ~x20)) & (x17 | x20 | x21 | x22 | x23);
  ...
  assign new_n77_ = (~x26 | (new_n78_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n78_ | x22 | x23 | x24 | x25 | x26);
