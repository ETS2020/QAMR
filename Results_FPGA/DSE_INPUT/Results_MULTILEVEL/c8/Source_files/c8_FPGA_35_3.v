...
module FAU ( 
  ...
  assign z12 = x16 ? (~new_n67_ & (~x11 | ~x26)) : ((x03 & (x11 ? ~x26 : x18)) | (x11 & ~x18 & ~x26));
  ...
  assign z14 = ~new_n49_ & (x16 ? ~new_n71_ : (x18 ? x05 : x13));
  assign new_n71_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x21 | x22 | x23 | x24);
  assign z15 = ~new_n49_ & (x16 ? (new_n73_ | new_n74_) : ~new_n76_);
  ...
  assign z16 = x16 ? ~new_n78_ : (~new_n49_ & (x18 ? x07 : x15));
  assign new_n78_ = (x11 | ~x26 | (new_n65_ & new_n75_ & ~x24 & ~x25)) & (~new_n65_ | ~new_n75_ | x24 | x25 | x26);
