...
module FAU ( 
  ...
  assign z04 = (~x23 & ~x27) | (~x12 & (~x23 | (x14 & x27)));
  ...
  assign new_n70_ = (~x14 | new_n68_ | ~x23) & (~new_n63_ | x21 | x22 | x23);
  assign z14 = x16 ? ((~new_n72_ & ~x23) | (x14 & x23 & x24)) : (~new_n73_ & (x14 | ~x23));
  assign new_n72_ = (new_n68_ | ~x24) & (~new_n63_ | x21 | x22 | x24);
  assign new_n73_ = x18 ? ~x05 : ~x13;
  assign z15 = x16 ? ((~new_n75_ & ~x23) | (x14 & x23 & x25)) : ~new_n76_;
  assign new_n75_ = (~x25 | (new_n63_ & ~x21 & ~x22 & ~x24)) & (~new_n63_ | x21 | x22 | x24 | x25);
  assign new_n76_ = (~x14 | x18) & (~x06 | (~x14 & (~x18 | x23)));
  assign z16 = x16 ? ((~new_n78_ & ~x23) | (x14 & x23 & x26)) : (~new_n81_ & (x14 | ~x23));
  assign new_n78_ = (~x26 | (new_n63_ & new_n80_)) & (~new_n65_ | ~new_n79_ | x25 | x26);
