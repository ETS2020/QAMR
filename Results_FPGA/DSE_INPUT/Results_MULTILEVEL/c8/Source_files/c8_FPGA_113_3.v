...
module FAU ( 
  ...
  assign z14 = x16 ? (x23 ? (x24 & ~x25) : ~new_n72_) : (~new_n73_ & (~x23 | ~x25));
  assign new_n72_ = (new_n68_ | ~x24) & (~new_n63_ | x21 | x22 | x24);
  assign new_n73_ = x18 ? ~x05 : ~x13;
  assign z15 = x16 ? new_n75_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n75_ = ~x23 & ((x25 & (~new_n63_ | x21 | x22 | x24)) | (new_n63_ & ~x21 & ~x22 & ~x24 & ~x25));
  assign z16 = x16 ? ((new_n78_ & ~x23) | (~new_n77_ & ~x25)) : (~new_n79_ & (~x23 | ~x25));
  assign new_n77_ = (~x23 | ~x26) & (~new_n65_ | x22 | x23 | x24 | x26);
  assign new_n78_ = x26 & (~new_n63_ | x21 | x22 | x24 | x25);
