...
module FAU ( 
  ...
  assign z09 = x16 ? (x17 ? (~x18 & x19) : ~x19) : ((x08 & ~x18) | (x00 & x18 & ~x19));
  ...
  assign z13 = x16 ? ~new_n67_ : ((x12 & ~x18) | (x04 & x18 & ~x19));
  assign new_n67_ = (x19 | ((~x23 | (new_n68_ & ~x21 & ~x22)) & (~new_n68_ | x21 | x22 | x23))) & (x18 | ~x19 | ~x23);
  assign new_n68_ = ~x17 & ~x20;
  assign z14 = x16 ? ((~new_n71_ & ~x19) | (~x18 & x19 & x24)) : ~new_n70_;
  assign new_n70_ = (~x13 | x18) & (~x05 | ~x18 | x19);
  ...
  assign new_n74_ = (~x14 | x18) & (~x06 | ~x18 | x19);
