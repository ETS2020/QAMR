...
module FAU ( 
  ...
  assign z06 = (~x08 & ~x25 & (~x14 | ~x27)) | (~x14 & x25 & x27);
  ...
  assign new_n73_ = (~x25 | (new_n63_ & new_n74_ & ~x23 & ~x24)) & (~new_n75_ | ~new_n74_ | x23 | x24 | x25);
  assign new_n74_ = ~x21 & ~x22;
  assign new_n75_ = ~x19 & ~x20 & ~x08 & ~x17;
  assign z16 = x16 ? ((~new_n77_ & ~x08) | (x25 & x26)) : (~new_n80_ & (~x08 | x25));
  assign new_n77_ = (~new_n65_ | ~new_n79_) & (~x26 | (new_n63_ & new_n78_));
  assign new_n78_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign new_n79_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign new_n80_ = x18 ? ~x07 : ~x15;
  assign z17 = x16 & ((~x08 & (new_n82_ | (x17 & x27))) | (x17 & x25 & x27));
  assign new_n82_ = new_n79_ & ~x20 & ~x21 & ~x17 & x19;
endmodule
