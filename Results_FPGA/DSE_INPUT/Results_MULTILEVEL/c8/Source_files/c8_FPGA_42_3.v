...
module FAU ( 
  ...
  assign new_n67_ = x20 ? (~x23 | x24) : ((~x23 | (new_n68_ & ~x21 & ~x22)) & (~new_n68_ | x21 | x22 | x23));
  assign new_n68_ = ~x17 & ~x19;
  assign z14 = x16 ? (~new_n70_ & ~x20) : (~new_n73_ & (~x20 | ~x24));
  assign new_n70_ = ~new_n72_ & (~x24 | (new_n68_ & new_n71_ & ~x21));
  ...
  assign new_n75_ = (x24 | ((~x20 | ~x25) & (~new_n76_ | ~new_n77_))) & (x20 | new_n72_ | ~x25);
  assign new_n76_ = ~x17 & ~x19 & ~x20;
  assign new_n77_ = ~x23 & ~x25 & ~x21 & ~x22;
  assign z16 = x16 ? ((new_n80_ & ~x20) | (~new_n79_ & ~x24)) : (~new_n82_ & (~x20 | ~x24));
  assign new_n79_ = (~x20 | ~x26) & (~new_n68_ | x20 | x21 | ~new_n71_ | x25 | x26);
  ...
  assign new_n84_ = new_n71_ & ~x24 & ~x25 & ~x26;
