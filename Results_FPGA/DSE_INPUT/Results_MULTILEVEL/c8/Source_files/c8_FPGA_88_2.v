...
module FAU ( 
  ...
  assign z06 = (~x14 & (x25 ? x27 : ~x18)) | (~x18 & ~x25 & ~x27);
  ...
  assign z10 = x16 ? (~new_n60_ & (~x18 | x25)) : ((x09 & ~x18) | (x01 & x18 & x25));
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n62_ & (~x18 | x25)) : ((x10 & ~x18) | (x02 & x18 & x25));
  assign new_n62_ = ~new_n64_ & (new_n63_ | ~x21);
  assign new_n63_ = ~x17 & ~x19 & ~x20;
  assign new_n64_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = x16 ? (~new_n66_ & (~x18 | x25)) : ((x11 & ~x18) | (x03 & x18 & x25));
  assign new_n66_ = (~x22 | (~x20 & ~x21 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = x16 ? (~new_n68_ & (~x18 | x25)) : ((x12 & ~x18) | (x04 & x18 & x25));
  assign new_n68_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n70_ & (~x18 | x25)) : ((x13 & ~x18) | (x05 & x18 & x25));
  assign new_n70_ = (~x24 | (new_n63_ & ~x21 & ~x22 & ~x23)) & (~new_n63_ | x21 | x22 | x23 | x24);
  assign z15 = x16 ? ~new_n72_ : ((x14 & ~x18) | (x06 & x18 & x25));
  assign new_n72_ = (~x25 | (new_n63_ & new_n73_ & ~x23 & ~x24)) & (~new_n74_ | ~new_n73_ | x23 | x24 | x25);
  assign new_n73_ = ~x21 & ~x22;
  assign new_n74_ = ~x19 & ~x20 & ~x17 & ~x18;
  assign z16 = x16 ? (new_n76_ | (x25 & x26)) : ~new_n79_;
  ...
  assign new_n79_ = (~x15 | x18) & (~x07 | ~x18 | ~x25);
  assign z17 = x16 & ((z08 & x17) | (new_n78_ & new_n81_ & ~x17 & ~x18));
