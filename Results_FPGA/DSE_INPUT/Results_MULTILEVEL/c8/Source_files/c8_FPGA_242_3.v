...
module FAU ( 
  ...
  assign z01 = (x27 ? ~x09 : ~x20) & (~x08 | ~x18);
  ...
  assign z09 = x16 ? ((~x08 | ~x18) & (~x17 ^ x19)) : ((x00 & ~x08 & x18) | (x08 & ~x18));
  assign z10 = x16 ? (~new_n59_ & (~x08 | ~x18)) : ((x01 & ~x08 & x18) | (x09 & ~x18));
  assign new_n59_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n61_ & (~x08 | ~x18)) : ((x02 & ~x08 & x18) | (x10 & ~x18));
  assign new_n61_ = ~new_n63_ & (new_n62_ | ~x21);
  assign new_n62_ = ~x17 & ~x19 & ~x20;
  assign new_n63_ = ~x20 & ~x21 & ~x17 & ~x19;
  assign z12 = x16 ? (~new_n65_ & (~x08 | ~x18)) : ((x03 & ~x08 & x18) | (x11 & ~x18));
  assign new_n65_ = (~x22 | (~x20 & ~x21 & ~x17 & ~x19)) & (x17 | x19 | x20 | x21 | x22);
  assign z13 = x16 ? (~new_n67_ & (~x08 | ~x18)) : ((x04 & ~x08 & x18) | (x12 & ~x18));
  assign new_n67_ = (~x23 | (~x17 & ~x19 & ~x20 & ~x21 & ~x22)) & (x17 | x19 | x20 | x21 | x22 | x23);
  assign z14 = x16 ? (~new_n69_ & (~x08 | ~x18)) : ((x05 & ~x08 & x18) | (x13 & ~x18));
  assign new_n69_ = (~x24 | (new_n62_ & ~x21 & ~x22 & ~x23)) & (~new_n62_ | x23 | x24 | x21 | x22);
  assign z15 = x16 ? ((~x08 | ~x18) & (new_n71_ | new_n72_)) : ~new_n73_;
  assign new_n71_ = x25 & (~new_n62_ | x23 | x24 | x21 | x22);
  assign new_n72_ = new_n63_ & ~x24 & ~x25 & ~x22 & ~x23;
  assign new_n73_ = (~x14 | x18) & (~x06 | x08 | ~x18);
  assign z16 = x16 ? (~new_n75_ & (~x08 | ~x18)) : ((x07 & ~x08 & x18) | (x15 & ~x18));
