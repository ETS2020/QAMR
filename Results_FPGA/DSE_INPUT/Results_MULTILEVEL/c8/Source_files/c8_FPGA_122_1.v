...
module FAU ( 
  ...
  assign new_n63_ = (~x21 | (~x17 & (x24 | (~x19 & ~x20)))) & (x20 | x21 | x24 | x17 | x19);
  ...
  assign new_n67_ = (~x23 | (~x17 & (x24 | (new_n68_ & ~x21 & ~x22)))) & (x21 | x22 | x23 | x24 | ~new_n68_ | x17);
  assign new_n68_ = ~x19 & ~x20;
  assign z14 = x16 ? ~new_n70_ : (~new_n49_ & (x18 ? x05 : x13));
  assign new_n70_ = (x21 | x22 | x23 | x24 | ~new_n68_ | x17) & (~x17 | ~x24);
  assign z15 = x16 ? ((~new_n72_ & ~x24) | (x17 & x25)) : (~new_n73_ & (x17 | ~x24));
  assign new_n72_ = (x21 | x22 | x23 | x25 | ~new_n68_ | x17) & (~x25 | (new_n68_ & ~x21 & ~x22 & ~x23));
  assign new_n73_ = x18 ? ~x06 : ~x14;
  assign z16 = x16 ? ((~new_n75_ & ~x24) | (x17 & x26)) : (~new_n78_ & (x17 | ~x24));
  assign new_n75_ = (new_n76_ | ~x26) & (~new_n77_ | x22 | x23 | x25 | x26);
  assign new_n76_ = ~x19 & ~x20 & ~x21 & ~x22 & ~x23 & ~x25;
