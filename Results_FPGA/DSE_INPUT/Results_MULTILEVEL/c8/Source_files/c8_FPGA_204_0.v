...
module FAU ( 
  ...
  assign z14 = x16 ? ~new_n68_ : ((x05 & x18) | (x13 & ~x18 & x19));
  assign new_n68_ = (~x19 | ~x24) & (~x18 | ((~new_n69_ | ~new_n71_) & (new_n70_ | ~x24)));
  assign new_n69_ = ~x17 & ~x19 & ~x20;
  assign new_n70_ = ~x17 & ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n71_ = ~x23 & ~x24 & ~x21 & ~x22;
  assign z15 = x16 ? ((~new_n73_ & x18) | (x19 & x25)) : ~new_n76_;
