...
module FAU ( 
  ...
  assign z04 = (~x12 & x27 & (x17 | x24)) | (~x23 & ~x27 & (x24 | (x17 & ~x24)));
  assign z05 = (~x13 & x27 & (x17 | x24)) | (x17 & ~x24 & ~x27);
  assign z06 = ~new_n49_ & (x27 ? ~x14 : ~x25);
  assign z07 = ~new_n49_ & (x27 ? ~x15 : ~x26);
  assign z08 = ~new_n49_ & x27;
  assign z09 = x16 ? (x17 ? x19 : (~x19 & x24)) : (~new_n59_ & (x17 | x24));
  assign new_n59_ = x18 ? ~x00 : ~x08;
  assign z10 = x16 ? ((x20 & (x17 | (x19 & x24))) | (~x17 & ~x19 & ~x20 & x24)) : (~new_n61_ & (x17 | x24));
  assign new_n61_ = x18 ? ~x01 : ~x09;
  assign z11 = x16 ? ~new_n63_ : (~new_n49_ & (x18 ? x02 : x10));
  assign new_n63_ = (~x21 | (~x17 & (~x24 | (~x19 & ~x20)))) & (x17 | x19 | x20 | x21 | ~x24);
  assign z12 = x16 ? ~new_n65_ : (~new_n49_ & (x18 ? x03 : x11));
  assign new_n65_ = (~x22 | (~x17 & (~x24 | (~x19 & ~x20 & ~x21)))) & (x17 | x19 | x20 | x21 | x22 | ~x24);
  assign z13 = x16 ? ((new_n67_ & new_n70_) | (~new_n69_ & x23)) : new_n68_;
  assign new_n67_ = ~x17 & ~x19 & ~x20;
  assign new_n68_ = (x17 | x24) & (x18 ? x04 : x12);
  assign new_n69_ = ~x17 & (~x24 | (~x19 & ~x20 & ~x21 & ~x22));
  assign new_n70_ = ~x21 & ~x22 & ~x23 & x24;
  assign z14 = x16 ? (~new_n73_ & x24) : (~new_n72_ & (x17 | x24));
