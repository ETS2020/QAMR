...
module FAU ( 
  ...
  assign z10 = x16 ? (~new_n60_ & (~x07 | x18)) : ((x01 & x18) | (~x07 & x09 & ~x18));
  assign new_n60_ = (~x20 | (~x17 & ~x19)) & (x17 | x19 | x20);
  assign z11 = x16 ? (~new_n62_ & (~x07 | x18)) : ((x02 & x18) | (~x07 & x10 & ~x18));
  assign new_n62_ = ~new_n64_ & (new_n63_ | ~x21);
  assign new_n63_ = ~x17 & ~x19 & ~x20;
  assign new_n64_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign z12 = x16 ? (~new_n66_ & (~x07 | x18)) : ((x03 & x18) | (~x07 & x11 & ~x18));
  ...
  assign z16 = x16 ? (~new_n76_ & (~x07 | x18)) : (x07 ? x18 : (x15 & ~x18));
