...
module FAU ( 
  ...
  assign z11 = x16 ? (x17 & x21) : (x18 ? x02 : x10);
  assign z12 = x16 ? (x17 & x22) : (x18 ? x03 : x11);
  assign z13 = x16 ? (x17 & x23) : (x18 ? x04 : x12);
  assign z14 = x16 ? (x17 & x24) : (x18 ? x05 : x13);
  assign z15 = x16 ? (x17 & x25) : (x18 ? x06 : x14);
  assign z16 = x16 ? (x17 & x26) : (x18 ? x07 : x15);
