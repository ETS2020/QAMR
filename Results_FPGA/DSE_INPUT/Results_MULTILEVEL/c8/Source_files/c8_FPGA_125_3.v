...
module FAU ( 
  ...
  assign z02 = (~x10 & (~x21 | (~x22 & x27))) | (~x21 & ~x27);
  ...
  assign z11 = x16 ? (new_n65_ | (x21 & ~new_n63_ & ~x22)) : (~new_n64_ & (~x21 | ~x22));
  ...
  assign new_n67_ = ~x21 & ((x22 & (x17 | x19 | x20)) | (~x17 & ~x19 & ~x20 & ~x22));
  assign z13 = x16 ? ~new_n69_ : (~new_n49_ & (x18 ? x04 : x12));
  assign new_n69_ = (x22 | ((~x21 | ~x23) & (x17 | x19 | x20 | x21 | x23))) & (x21 | ~x23 | (~x17 & ~x19 & ~x20 & ~x22));
  assign z14 = x16 ? ~new_n71_ : (~new_n49_ & (x18 ? x05 : x13));
  assign new_n71_ = (x22 | ((~x21 | ~x24) & (~new_n63_ | x21 | x23 | x24))) & (x21 | new_n72_ | ~x24);
  assign new_n72_ = ~x17 & ~x19 & ~x20 & ~x22 & ~x23;
  assign z15 = x16 ? ~new_n74_ : (~new_n49_ & (x18 ? x06 : x14));
  assign new_n74_ = (x22 | ((~x21 | ~x25) & (~new_n63_ | x21 | x23 | x24 | x25))) & (x21 | ~x25 | (new_n63_ & ~x22 & ~x23 & ~x24));
  assign z16 = x16 ? ((new_n77_ & ~x21) | (~new_n76_ & ~x22)) : (~new_n78_ & (~x21 | ~x22));
  assign new_n76_ = (~x21 | ~x26) & (~new_n65_ | x23 | x24 | x25 | x26);
  assign new_n77_ = x26 & (~new_n63_ | x22 | x23 | x24 | x25);
