...
module FAU ( 
  ...
  assign z05 = (~x13 & x27 & (x23 | x25)) | (~x24 & ~x27 & (x23 | (~x23 & x25)));
  ...
  assign new_n70_ = (new_n68_ | ~x23) & (~new_n63_ | x21 | x22 | x23 | ~x25);
  assign z14 = x16 ? ~new_n72_ : (~new_n49_ & (x18 ? x05 : x13));
  assign new_n72_ = (~x24 | (~x23 & (new_n68_ | ~x25))) & (~new_n65_ | x22 | x23 | x24 | ~x25);
