...
module FAU ( 
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : ~x30;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x30 | new_n66_ | x40) & (~x40 | ((new_n66_ | new_n99_) & (~new_n101_ | x30)));
  ...
  assign z18 = x30 | (x40 & (new_n106_ | new_n87_ | x09));
