...
module FAU ( 
  ...
  assign new_n82_ = x06 & x37 & (x30 | ~x40);
  assign new_n83_ = (x36 | (~x28 & x35)) & (~x40 | (x30 & ~x39));
  assign new_n84_ = ~x04 & x05 & x30 & x39 & x40;
  ...
  assign z14 = ~new_n94_ & (~new_n95_ | (~x37 & (~x28 | ~x35)));
  assign new_n94_ = x40 & (~x30 | (~x04 & ~x13 & x39));
  ...
  assign z18 = x30 | (~new_n100_ & ~x40);
  assign new_n100_ = ~x09 & (x28 | ~x35 | (x27 ? x04 : ~x08));
