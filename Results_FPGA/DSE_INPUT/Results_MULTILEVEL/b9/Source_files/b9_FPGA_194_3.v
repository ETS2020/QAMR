// Benchmark "FAU" written by ABC on Wed Aug  5 21:58:51 2020
...
module FAU ( 
  ...
  assign z12 = z02 & (new_n66_ | ~x27);
  assign z13 = ~x18 & ~x19 & x20 & x27 & z02 & ~new_n66_;
  assign z14 = z02 & (new_n66_ | x18 | x19 | ~x20 | ~x27);
  assign z15 = x12 & x26 & x27 & z02 & x34;
  assign z16 = x01 & x22 & z02 & ~x23;
  assign z17 = x01 & x22 & x23 & z02 & ~x24;
  assign z18 = z02 & (new_n88_ | x09 | x30);
  assign new_n88_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = ~x09 & new_n90_ & ~x30;
  assign new_n90_ = (~x39 | ~x40) & (~x35 | (~x27 & (~x08 | x28)));
  assign z08 = 1'b0;
