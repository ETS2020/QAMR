...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n72_ | (~x02 & (~x08 | ~x29))) : ~x09;
  ...
  assign new_n84_ = (~x07 | (x40 ? x39 : x09)) & (~x05 | ~x39 | ~x40);
  assign new_n85_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = new_n87_ & ~x09;
  assign new_n87_ = ~x30 & ((~new_n88_ & (~new_n70_ | (x04 & x27))) | (~x08 & (~new_n70_ | x04 | ~x27)));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = (x40 & (new_n90_ | (~new_n66_ & (x04 | ~x39)))) | (~x09 & ~new_n66_ & ~x40);
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n94_ | (x27 & ((x40 & (new_n92_ | new_n93_)) | (new_n93_ & ~x09)));
  ...
  assign new_n96_ = x40 ? (~new_n97_ & new_n98_) : x09;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x39;
  assign new_n99_ = (x09 | new_n66_ | x40) & (~x40 | (~new_n100_ & (new_n66_ | new_n98_)));
  ...
  assign z18 = ~new_n105_ | (x08 & (new_n88_ | (new_n70_ & ~x09 & ~x27)));
  assign new_n105_ = x09 ? ~x40 : (~x30 & (~new_n70_ | x04 | ~x27));
  assign z20 = ~x09 & ~x30 & (new_n107_ | (~x08 & (~x27 | ~x35)));
  assign new_n107_ = ~new_n88_ & (~x35 | (~x27 & x28));
  assign z19 = new_n87_ & ~x09;
endmodule
