...
module FAU ( 
  ...
  assign z02 = ~x40 | (x05 & (~new_n72_ | (~x02 & (~x08 | ~x29))));
  ...
  assign z10 = (x27 & (new_n83_ | (~x04 & new_n84_ & x05))) | (~x04 & new_n85_ & x05);
  assign new_n83_ = ~new_n67_ & ((~x04 & ~new_n70_ & x07) | (x06 & x37));
  assign new_n84_ = x39 & ~new_n70_ & x40;
  ...
  assign new_n89_ = (x27 | (~x05 & x40)) & (~x05 | (~x04 & ~x28 & x35));
  assign z12 = (x05 & (new_n91_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & x27) | (~x04 & x05 & new_n85_ & ~x13);
  assign new_n93_ = (~x05 | ((~new_n94_ | x04) & (~new_n95_ | x18))) & (~new_n96_ | x18);
  ...
  assign new_n98_ = x05 & (new_n99_ | ~new_n100_);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (new_n68_ | x40) & (~x05 | (~new_n102_ & (new_n68_ | new_n100_)));
  ...
  assign z18 = (~new_n107_ & (x05 | ~x40)) | (x05 & x08 & x29 & x39 & x40);
  ...
  assign new_n111_ = ~x08 & ((x05 & (~x27 | ~x35)) | (~x27 & ~x40));
