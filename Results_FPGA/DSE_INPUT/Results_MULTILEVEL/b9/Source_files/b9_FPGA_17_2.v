...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : ~x20;
  ...
  assign new_n83_ = (~x07 | (x40 ? x39 : x20)) & (~x05 | ~x39 | ~x40);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & ((x04 & x27) | x28 | ~x35);
  assign new_n87_ = x40 ? (x29 & x39) : x20;
  assign new_n88_ = (x27 | (x20 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n90_ | (~new_n66_ & (x04 | ~x39)))) | (~x20 & ~new_n66_ & ~x40);
  ...
  assign z14 = new_n96_ | (~x20 & ~x40) | (~x30 & ~new_n98_ & ~x32);
  assign new_n96_ = (x04 | x13 | ~x39) & (~x20 | (~new_n97_ & x40));
  assign new_n97_ = (x37 | (x28 & x35)) & ~x18 & ~x19 & x27;
  assign new_n98_ = (~x28 | (~new_n99_ & (x35 | x37 | ~x40))) & (x27 | ~x40);
  assign new_n99_ = (~x35 | ~x36) & (~x20 | (x40 & (x18 | x19)));
  ...
  assign new_n108_ = ~x08 & ((~x35 & x40) | (~x27 & (~x20 | x40)));
