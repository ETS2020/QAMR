// Benchmark "FAU" written by ABC on Wed Aug  5 21:58:55 2020
...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x18;
  ...
  assign z14 = new_n96_ | (x18 & ~x40) | (~x30 & ~new_n98_ & ~x32);
  assign new_n96_ = (x04 | x13 | ~x39) & (x18 | (~new_n97_ & x40));
  assign new_n97_ = (x37 | (x28 & x35)) & ~x19 & x20 & x27;
  assign new_n98_ = (~x28 | (~new_n99_ & (x35 | x37 | ~x40))) & (x27 | ~x40);
  assign new_n99_ = (~x35 | ~x36) & (x18 | (x40 & (x19 | ~x20)));
  ...
  assign new_n107_ = ~x30 & (new_n108_ | (~new_n87_ & (~x35 | (~x27 & x28))));
  assign new_n108_ = ~x08 & ((~x35 & x40) | (~x27 & (x18 | x40)));
