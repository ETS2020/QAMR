...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x05;
  ...
  assign new_n82_ = ~x04 & ~new_n69_ & ((x05 & (x40 ? x39 : x07)) | (x07 & ~x39 & x40));
  assign new_n83_ = ~x04 & x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n85_ | (~new_n87_ & ~x08));
  assign new_n85_ = ~new_n86_ & ((x04 & x27) | x28 | ~x35);
  assign new_n86_ = x40 ? (x29 & x39) : ~x05;
  assign new_n87_ = (x27 | (~x05 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n89_ | (~new_n66_ & (x04 | ~x39)))) | (x05 & ~new_n66_ & ~x40);
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n93_ | (x27 & ((x40 & (new_n91_ | new_n92_)) | (new_n92_ & x05)));
  ...
  assign new_n95_ = x40 ? (~new_n96_ & new_n97_) : ~x05;
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = ~x04 & ~x13 & x39;
  assign new_n98_ = (~x05 | new_n66_ | x40) & (~x40 | (~new_n99_ & (new_n66_ | new_n97_)));
  ...
  assign new_n108_ = ~x08 & ((~x35 & x40) | (~x27 & (x05 | x40)));
