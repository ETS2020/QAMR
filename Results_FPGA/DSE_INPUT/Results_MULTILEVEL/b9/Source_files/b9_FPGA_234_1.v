...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (x18 | ~x40)) | (~x04 & ~x15 & new_n67_ & x18);
  ...
  assign new_n85_ = x18 & x39 & x40 & (x30 | x32);
  ...
  assign z12 = (x18 & (new_n91_ | (~new_n92_ & (new_n66_ | ~x27)))) | (~x40 & (new_n66_ | ~x27));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = ~x04 & x39;
  assign z13 = (x27 & (new_n94_ | (~x04 & new_n95_ & ~x13))) | (~x04 & new_n85_ & ~x13);
  assign new_n94_ = ~x18 & ~x19 & x20 & ~new_n66_ & ~x40;
  assign new_n95_ = x18 & x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = new_n99_ | new_n97_ | (~x40 & (new_n66_ | x19 | ~x20));
  assign new_n97_ = x18 & (new_n98_ | x04 | x13 | ~x39 | ~x40);
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x27 & (~x40 | (x18 & ~x30 & ~x32));
  assign z15 = x12 & x26 & x27 & ~new_n69_ & x34;
  assign z16 = x01 & x22 & ~new_n69_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n69_ & ~x24;
  assign z18 = (~new_n104_ & (x18 | ~x40)) | (x08 & x18 & x29 & x39 & x40);
  assign new_n104_ = ~new_n105_ & ~x09 & ~x30;
  assign new_n105_ = ~x28 & x35 & (x27 ? ~x04 : x08);
  assign z20 = new_n107_ & ~x09;
  assign new_n107_ = ~x30 & (new_n108_ | (~new_n88_ & (~x35 | (~x27 & x28))));
  assign new_n108_ = ~x08 & ((x18 & (~x27 | ~x35)) | (~x27 & ~x40));
