...
module FAU ( 
  ...
  assign z14 = new_n96_ | (x19 & ~x40) | (~x30 & ~new_n98_ & ~x32);
  assign new_n96_ = (x04 | x13 | ~x39) & (x19 | (~new_n97_ & x40));
  assign new_n97_ = (x37 | (x28 & x35)) & ~x18 & x20 & x27;
  assign new_n98_ = (~x28 | (~new_n99_ & (x35 | x37 | ~x40))) & (x27 | ~x40);
  assign new_n99_ = (~x35 | ~x36) & (x19 | (x40 & (x18 | ~x20)));
  ...
  assign new_n108_ = ~x08 & ((~x35 & x40) | (~x27 & (x19 | x40)));
