...
module FAU ( 
  ...
  assign z10 = x27 & (new_n83_ | (~x04 & new_n84_ & x07));
  assign new_n83_ = x06 & ~new_n67_ & x37;
  assign new_n84_ = (x36 | (~x28 & x35)) & (~x40 | (~x05 & ~x39));
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & ((x04 & x27) | x28 | ~x35);
  assign new_n87_ = x40 & (x05 | (x29 & x39));
  assign new_n88_ = (x27 | (x05 & x40)) & (x05 | (~x04 & ~x28 & x35));
  assign z12 = (~x05 & (new_n90_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n92_ & x27) | (new_n96_ & ~x04);
  assign new_n92_ = (x05 | ((~new_n93_ | x04) & (~new_n94_ | x18))) & (~new_n95_ | x18);
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n95_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign new_n96_ = ~x05 & ~x13 & x39 & x40 & (x30 | x32);
