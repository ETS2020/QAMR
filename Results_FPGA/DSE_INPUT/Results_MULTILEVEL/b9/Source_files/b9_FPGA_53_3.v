...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n78_,
    ...
    new_n111_, new_n112_;
  assign z00 = (~x16 & (~x15 | ~x40)) | (~x15 & (new_n67_ | (~new_n65_ & x27)));
  ...
  assign z02 = ~x40 | (~x15 & (~new_n72_ | (~x02 & (~x08 | ~x29))));
  ...
  assign new_n78_ = ~x14 & ~new_n69_ & (x00 | x25 | ~x38);
  assign new_n79_ = (x15 ? ~x40 : ~x17) & (~x38 | (x00 & ~x25));
  assign z08 = x40 & ~x15 & x39;
  assign z09 = x11 & x26 & x27 & ~new_n69_ & x34;
  assign z10 = (x27 & (new_n84_ | (new_n83_ & ~x04))) | (~x04 & new_n85_ & x05);
  assign new_n83_ = ~new_n70_ & ((x07 & (~x40 | (~x15 & ~x39))) | (x39 & x40 & x05 & ~x15));
  assign new_n84_ = x06 & ~new_n69_ & x37;
  assign new_n85_ = ~x15 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n87_ | (~new_n89_ & ~x08));
  assign new_n87_ = ~new_n88_ & (x28 | ~x35 | (x04 & x27));
  assign new_n88_ = x40 & (x15 | (x29 & x39));
  assign new_n89_ = (x27 | (x15 & x40)) & (x15 | (~x04 & ~x28 & x35));
  assign z12 = (~x15 & (new_n91_ | (~new_n92_ & (new_n66_ | ~x27)))) | (~x40 & (new_n66_ | ~x27));
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n92_ = ~x04 & x39;
  assign z13 = (~new_n94_ & x27) | (~x04 & new_n85_ & ~x13);
  assign new_n94_ = (x15 | ((~new_n96_ | x18) & (~new_n95_ | x04))) & (~new_n97_ | x18);
  ...
  assign new_n102_ = (x40 | (~new_n66_ & x27)) & (x15 | (~new_n103_ & (new_n101_ | (~new_n66_ & x27))));
  ...
  assign z18 = (~new_n108_ & (~x15 | ~x40)) | (x08 & ~x15 & x29 & x39 & x40);
  ...
  assign new_n112_ = ~x08 & ((~x15 & (~x27 | ~x35)) | (~x27 & ~x40));
