...
module FAU ( 
  ...
  assign z00 = (~x16 & (x15 | x40)) | (~x15 & ~new_n65_ & x40);
  assign new_n65_ = (new_n66_ | ~x27) & (x04 | ~x10 | ~x39);
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x15;
  ...
  assign new_n77_ = ~x14 & ~new_n68_ & (x00 | x25 | ~x38);
  assign new_n78_ = (x15 | (~x17 & x40)) & (~x38 | (x00 & ~x25));
  assign z08 = x39 & x40;
  ...
  assign new_n83_ = (~x07 | (x40 ? x39 : ~x15)) & (~x05 | ~x39 | ~x40);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & ((x04 & x27) | x28 | ~x35);
  assign new_n87_ = x40 ? (x29 & x39) : ~x15;
  assign new_n88_ = (x27 | (~x15 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n90_ | (~new_n91_ & (x04 | ~x39)))) | (x15 & ~new_n91_ & ~x40);
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign new_n91_ = x27 & (x37 | (x28 & x35));
  assign z13 = new_n95_ | (x27 & ((x40 & (new_n93_ | new_n94_)) | (new_n94_ & x15)));
  ...
  assign new_n97_ = x40 ? (~new_n98_ & new_n99_) : ~x15;
  assign new_n98_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n99_ = ~x04 & ~x13 & x39;
  assign new_n100_ = (~x15 | new_n91_ | x40) & (~x40 | (~new_n101_ & (new_n91_ | new_n99_)));
  ...
  assign new_n110_ = ~x08 & ((~x35 & x40) | (~x27 & (x15 | x40)));
