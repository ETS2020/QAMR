...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : ~x13;
  ...
  assign new_n83_ = (~x07 | (x40 ? x39 : x13)) & (~x05 | ~x39 | ~x40);
  ...
  assign new_n88_ = (x27 | (x13 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n90_ | (~new_n66_ & (x04 | ~x39)))) | (~x13 & ~new_n66_ & ~x40);
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n96_ | (~new_n92_ & x27);
  assign new_n92_ = (x13 | (~new_n93_ & (x18 | ~new_n94_ | x19))) & (x18 | ~new_n95_ | x19);
  ...
  assign new_n98_ = x13 ? ~x40 : (~new_n99_ & ~x04 & x39 & x40);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = x13 ? (new_n66_ | ~x40) : (~new_n101_ & (new_n66_ | (~x04 & x39 & x40)));
