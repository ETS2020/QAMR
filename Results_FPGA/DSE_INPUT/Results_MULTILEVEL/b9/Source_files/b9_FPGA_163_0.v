// Benchmark "FAU" written by ABC on Wed Aug  5 21:58:46 2020
...
module FAU ( 
  ...
  assign new_n101_ = (~x24 | new_n66_ | x40) & (~x40 | (~new_n102_ & (new_n66_ | new_n100_)));
  ...
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (x24 | x40)));
