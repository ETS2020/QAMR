...
module FAU ( 
  ...
  assign z02 = (~x08 & (new_n71_ | ~x02)) | (~x02 & (~x29 | ~x40)) | (~new_n72_ & x40);
  assign new_n71_ = x04 & ~x27 & x40;
  assign new_n72_ = x39 & (~x04 | (~x28 & x35));
  ...
  assign new_n83_ = ~x04 & ~new_n69_ & ~new_n84_;
  assign new_n84_ = (~x07 | (x40 ? x39 : x02)) & (~x05 | ~x39 | ~x40);
  ...
  assign new_n89_ = x40 ? (x29 & x39) : x02;
  assign new_n90_ = (x27 | (x02 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n92_ | (~new_n66_ & (x04 | ~x39)))) | (~x02 & ~new_n66_ & ~x40);
  assign new_n92_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (x27 & (new_n94_ | (~x04 & new_n96_ & ~x13))) | (~x04 & new_n86_ & ~x13);
  assign new_n94_ = ~x18 & new_n95_ & ~x19;
  assign new_n95_ = x20 & (~x02 | x40) & (x37 | (x28 & x35));
  assign new_n96_ = x39 & x40 & (~x28 | (x35 & x36));
  assign z14 = ~new_n101_ | (~new_n98_ & (x18 | x19 | ~x20));
  assign new_n98_ = x40 ? (~new_n99_ & new_n100_) : x02;
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (x02 | new_n66_ | x40) & (~x40 | (~new_n102_ & (new_n66_ | new_n100_)));
  ...
  assign new_n111_ = ~x08 & ((~x35 & x40) | (~x27 & (~x02 | x40)));
