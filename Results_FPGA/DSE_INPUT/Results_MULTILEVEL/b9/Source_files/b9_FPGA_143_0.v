...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x17;
  ...
  assign z07 = x03 & (new_n77_ | (~x31 & new_n78_ & ~x33));
  assign new_n77_ = ~x14 & ~new_n65_ & (x00 | x25 | ~x38);
  assign new_n78_ = (x17 ? x15 : x40) & (~x38 | (x00 & ~x25));
  assign z08 = x39 & x40;
  ...
  assign new_n96_ = x40 ? (~new_n97_ & new_n98_) : ~x17;
  assign new_n97_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n98_ = ~x04 & ~x13 & x39;
  assign new_n99_ = (~x17 | new_n66_ | x40) & (~x40 | (~new_n100_ & (new_n66_ | new_n98_)));
  ...
  assign new_n109_ = ~x08 & ((~x35 & x40) | (~x27 & (x17 | x40)));
