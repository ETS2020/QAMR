...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n72_ | (~x02 & (~x08 | ~x29))) : ~x19;
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (x40 ? ~x39 : ~x19)) | (x05 & x39 & x40));
  ...
  assign new_n88_ = x40 ? (x29 & x39) : x19;
  assign new_n89_ = (x27 | (x19 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n91_ | (~new_n65_ & (x04 | ~x39)))) | (~x19 & ~new_n65_ & ~x40);
  ...
  assign new_n109_ = ~x08 & ((~x35 & x40) | (~x27 & (~x19 | x40)));
