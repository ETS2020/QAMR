...
module FAU ( 
  ...
  assign new_n78_ = (x40 | ((x31 | ~new_n79_ | x33) & (new_n80_ | x14))) & (x14 | new_n80_ | ~x33);
  ...
  assign new_n99_ = x33 & (new_n100_ | ~new_n101_);
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (new_n68_ | x40) & (~x33 | (~new_n103_ & (new_n68_ | new_n101_)));
  ...
  assign new_n112_ = ~x08 & ((~x27 & (x33 | ~x40)) | (x33 & ~x35));
