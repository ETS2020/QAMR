...
module FAU ( 
  ...
  assign z14 = new_n97_ | (~new_n100_ & ~x30) | (x39 & ~new_n66_ & ~new_n99_);
  assign new_n97_ = (x18 | x19 | ~x20) & (new_n98_ | (~new_n99_ & x39));
  assign new_n98_ = ~x30 & (~x39 | (x28 & ~x32 & (~x35 | ~x36)));
  assign new_n99_ = ~x04 & ~x13 & x40;
  assign new_n100_ = (x27 | (x32 & x39)) & (x37 | ((x35 | (x39 & (~x28 | x32))) & (x28 | x39)));
  assign z15 = x12 & x26 & x27 & ~new_n65_ & x34;
  assign z16 = x01 & x22 & ~new_n65_ & ~x23;
  assign z17 = x01 & x22 & x23 & ~new_n65_ & ~x24;
  assign z18 = new_n105_ | (x30 & x39) | (~new_n106_ & ~x30);
