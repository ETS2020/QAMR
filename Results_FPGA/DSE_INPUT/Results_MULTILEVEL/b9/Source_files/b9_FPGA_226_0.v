...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x36;
  ...
  assign new_n87_ = x40 ? (x29 & x39) : ~x36;
  assign new_n88_ = (x27 | (~x36 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n90_ | (~new_n66_ & (x04 | ~x39)))) | (x36 & ~new_n66_ & ~x40);
  ...
  assign new_n101_ = (~x36 | new_n66_ | x40) & (~x40 | (~new_n102_ & (new_n66_ | new_n100_)));
