...
module FAU ( 
  ...
  assign z02 = x40 ? (~new_n71_ | (~x02 & (~x08 | ~x29))) : x09;
  ...
  assign new_n83_ = (~x07 | (x40 ? x39 : ~x09)) & (~x05 | ~x39 | ~x40);
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & x40 & (new_n86_ | (~new_n87_ & ~x08));
  assign new_n86_ = (~x29 | ~x39) & ((x04 & x27) | x28 | ~x35);
  assign new_n87_ = ~x04 & x27 & ~x28 & x35;
  assign z12 = (x40 & (new_n89_ | (~new_n66_ & (x04 | ~x39)))) | (x09 & ~new_n66_ & ~x40);
  assign new_n89_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = new_n93_ | (x27 & ((x40 & (new_n91_ | new_n92_)) | (new_n92_ & x09)));
  ...
  assign new_n95_ = x40 ? (~new_n96_ & new_n97_) : ~x09;
  assign new_n96_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n97_ = ~x04 & ~x13 & x39;
  assign new_n98_ = (~x09 | new_n66_ | x40) & (~x40 | (~new_n99_ & (new_n66_ | new_n97_)));
  ...
  assign z18 = x09 | (x40 & (new_n104_ | new_n87_ | x30));
  assign new_n104_ = x08 & ((x29 & x39) | (~x27 & ~x28 & x35));
  assign z20 = ~x09 & ~x30 & ~new_n106_ & x40;
