...
module FAU ( 
  ...
  assign new_n77_ = (~x40 | ((new_n79_ | x14) & (x31 | ~new_n78_ | x33))) & (x14 | new_n79_ | ~x33);
  ...
  assign new_n99_ = x40 ? (~new_n100_ & new_n101_) : ~x33;
  assign new_n100_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n101_ = ~x04 & ~x13 & x39;
  assign new_n102_ = (~x33 | new_n66_ | x40) & (~x40 | (~new_n103_ & (new_n66_ | new_n101_)));
  ...
  assign z18 = (~new_n108_ & ~new_n65_) | (z08 & x08 & x29);
  ...
  assign new_n112_ = ~x08 & ((~x35 & x40) | (~x27 & (x33 | x40)));
