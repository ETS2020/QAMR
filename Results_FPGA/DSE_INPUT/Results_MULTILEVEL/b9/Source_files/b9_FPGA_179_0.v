...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20;
  wire new_n65_, new_n66_, new_n68_, new_n70_, new_n72_, new_n74_, new_n79_,
  ...
  assign z03 = (~x21 & (x37 | (x27 & x40))) | (x27 & ~new_n74_ & (x37 | x40)) | (~x27 & ~x37 & x40);
  assign new_n74_ = x28 & x35;
  assign z04 = (x27 & ~new_n74_ & (x37 | x40)) | (~x27 & ~x37 & x40) | (x21 & (x37 | (x27 & x40)));
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (x40 ? ~x39 : x37)) | (x05 & x39 & x40));
  assign new_n84_ = x05 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & ((x04 & x27) | x28 | ~x35);
  assign new_n87_ = x40 ? (x29 & x39) : ~x37;
  assign new_n88_ = (x27 | (~x37 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  assign z12 = (x40 & (new_n90_ | (~x10 & (new_n91_ | ~x27)))) | (~x27 & x37 & ~x40);
  assign new_n90_ = (x04 | ~x39) & (~x27 | (~new_n74_ & ~x37));
  assign new_n91_ = ~x35 & ~x36 & ~x37;
  assign z13 = new_n96_ | (x27 & (new_n95_ | (x40 & (new_n93_ | new_n94_))));
  assign new_n93_ = ~x18 & ~x19 & new_n74_ & x20;
  assign new_n94_ = ~x04 & ~x13 & x39 & (~x28 | (x35 & x36));
  assign new_n95_ = ~x18 & ~x19 & x20 & x37;
  assign new_n96_ = ~x04 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = (x40 & (new_n98_ | (~new_n100_ & (~new_n101_ | (~new_n74_ & ~x37))))) | (x37 & ~new_n101_ & ~x40);
  assign new_n98_ = ~x30 & ~x32 & (~x27 | (~new_n99_ & x28));
  ...
  assign z18 = (~new_n106_ & ~new_n68_) | (z08 & x08 & x29);
  ...
  assign new_n110_ = ~x08 & ((~x27 & (x37 | x40)) | (~x35 & x40));
