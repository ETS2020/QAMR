...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (x10 | ~x40)) | (~x04 & x10 & ~x15 & x39 & x40);
  ...
  assign z02 = ~x40 | (x10 & (~new_n71_ | (~x02 & (~x08 | ~x29))));
  ...
  assign z10 = (x27 & (new_n83_ | (new_n82_ & ~x04))) | (new_n84_ & ~x04);
  assign new_n82_ = ~new_n69_ & ((x07 & (~x40 | (x10 & ~x39))) | (x39 & x40 & x05 & x10));
  assign new_n83_ = x06 & ~new_n68_ & x37;
  assign new_n84_ = x05 & x10 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~x30 & (new_n86_ | (~new_n88_ & ~x08));
  assign new_n86_ = ~new_n87_ & ((x04 & x27) | x28 | ~x35);
  assign new_n87_ = x40 & (~x10 | (x29 & x39));
  assign new_n88_ = (x27 | (~x10 & x40)) & (~x10 | (~x04 & ~x28 & x35));
  assign z12 = ~new_n66_ & (~x40 | (x10 & (x04 | ~x39)));
  assign z13 = (~new_n91_ & x27) | (new_n95_ & ~x04);
  assign new_n91_ = (~x10 | ((~new_n92_ | x04) & (~new_n93_ | x18))) & (~new_n94_ | x18);
  assign new_n92_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n93_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n94_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign new_n95_ = x10 & ~x13 & x39 & x40 & (x30 | x32);
  ...
  assign new_n100_ = (~x10 | (~new_n101_ & (new_n66_ | new_n99_))) & (new_n66_ | x40);
  ...
  assign z18 = (~new_n106_ & (x10 | ~x40)) | (x08 & x10 & x29 & x39 & x40);
  ...
  assign new_n110_ = ~x08 & ((x10 & (~x27 | ~x35)) | (~x27 & ~x40));
