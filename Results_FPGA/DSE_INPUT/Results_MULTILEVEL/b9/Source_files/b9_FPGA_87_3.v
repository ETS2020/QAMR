// Benchmark "FAU" written by ABC on Wed Aug  5 21:58:34 2020
...
module FAU ( 
  ...
  assign z02 = ~x40 | (~new_n72_ & ~x02);
  assign new_n72_ = (~x04 | (~x28 & x35)) & x08 & x29 & x39;
  ...
  assign new_n88_ = x40 & (x02 | (x29 & x39));
  assign new_n89_ = (x27 | (x02 & x40)) & (x02 | (~x04 & ~x28 & x35));
  assign z12 = (~x02 & (new_n91_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n91_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n93_ & x27) | (new_n97_ & ~x02);
  assign new_n93_ = (x02 | ((~new_n94_ | x04) & (~new_n95_ | x18))) & (~new_n96_ | x18);
  ...
  assign new_n102_ = (new_n68_ | x40) & (x02 | (~new_n103_ & (new_n68_ | new_n101_)));
  ...
  assign z18 = (~new_n108_ & (~x02 | ~x40)) | (~x02 & x08 & x29 & x39 & x40);
  ...
  assign new_n112_ = ~x08 & ((~x02 & (~x27 | ~x35)) | (~x27 & ~x40));
