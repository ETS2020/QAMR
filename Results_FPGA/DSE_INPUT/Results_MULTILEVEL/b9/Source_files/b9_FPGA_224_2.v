...
module FAU ( 
  ...
  assign z02 = (~x02 & (~x29 | (~x08 & x40))) | (~new_n71_ & x40) | (~x29 & ~x40);
  ...
  assign new_n86_ = ~new_n87_ & (~x29 | (~x39 & x40));
  assign new_n87_ = (~x04 | ~x27) & ~x28 & x35;
  assign new_n88_ = (x27 | (x29 & ~x40)) & (~x40 | (~x04 & ~x28 & x35));
  ...
  assign new_n110_ = ~new_n111_ & (x08 | ((x35 | ~x40) & (x27 | (x29 & ~x40))));
  assign new_n111_ = (~x35 | (~x27 & x28)) & (~x29 | (~x39 & x40));
