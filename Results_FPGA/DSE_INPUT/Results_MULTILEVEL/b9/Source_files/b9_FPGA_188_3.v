...
module FAU ( 
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (~x40 | (~x09 & ~x39))) | (x05 & ~x09 & x39 & x40));
  assign new_n84_ = x06 & ~new_n67_ & x37;
  assign new_n85_ = x05 & ~x09 & x39 & x40 & (x30 | x32);
  assign z11 = ~x09 & ~new_n87_ & ~x30;
  assign new_n87_ = (new_n88_ | (~x28 & x35 & (~x04 | ~x27))) & (x08 | (~x04 & x27 & ~x28 & x35));
  assign new_n88_ = x29 & x39 & x40;
  assign z12 = (~x09 & (new_n90_ | (~new_n68_ & (x04 | ~x39)))) | (~new_n68_ & ~x40);
  assign new_n90_ = ~x10 & (~x27 | (~x35 & ~x36 & ~x37));
  assign z13 = (~new_n92_ & x27) | (new_n96_ & ~x04);
  assign new_n92_ = (x09 | ((~new_n93_ | x04) & (~new_n94_ | x18))) & (~new_n95_ | x18);
  assign new_n93_ = ~x13 & x39 & x40 & (~x28 | (x35 & x36));
  assign new_n94_ = ~x19 & x20 & (x37 | (x28 & x35));
  assign new_n95_ = ~x19 & x20 & ~x40 & (x37 | (x28 & x35));
  assign new_n96_ = ~x09 & ~x13 & x39 & x40 & (x30 | x32);
  assign z14 = ~new_n101_ | ((x18 | x19 | ~x20) & (new_n98_ | ~x40));
  assign new_n98_ = ~x09 & (new_n99_ | ~new_n100_);
  assign new_n99_ = x28 & ~x30 & ~x32 & (~x35 | ~x36);
  assign new_n100_ = ~x04 & ~x13 & x39;
  assign new_n101_ = (new_n68_ | x40) & (x09 | (~new_n102_ & (new_n68_ | new_n100_)));
