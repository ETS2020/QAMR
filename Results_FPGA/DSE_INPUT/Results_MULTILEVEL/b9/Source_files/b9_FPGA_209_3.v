...
module FAU ( 
  ...
  assign z00 = (~new_n65_ & (~x13 | ~x40)) | (~x04 & ~x13 & new_n67_ & ~x15);
  ...
  assign z02 = ~x40 | (~x13 & (~new_n72_ | (~x02 & (~x08 | ~x29))));
  ...
  assign new_n83_ = ~new_n70_ & ((x07 & (~x40 | (~x13 & ~x39))) | (x05 & ~x13 & x39 & x40));
  assign new_n84_ = x06 & ~new_n69_ & x37;
  assign new_n85_ = ~x13 & x39 & x40 & (x30 | x32);
  ...
  assign z13 = (x27 & (new_n94_ | (new_n96_ & ~x18))) | (new_n85_ & ~x04);
  ...
  assign z14 = (new_n99_ & ~x13) | (~new_n98_ & (~x40 | (~new_n92_ & ~x13)));
  ...
  assign z18 = (~new_n105_ & (~x13 | ~x40)) | (x08 & ~x13 & x29 & x39 & x40);
