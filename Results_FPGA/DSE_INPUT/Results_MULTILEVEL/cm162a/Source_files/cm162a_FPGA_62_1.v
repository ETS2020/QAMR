// Benchmark "FAU" written by ABC on Thu Aug  6 17:10:48 2020
...
module FAU ( 
  ...
  assign new_n24_ = (~x03 | (x04 ? new_n25_ : (~x10 | x13))) & (x05 | (~x04 & (x10 | x13)));
  ...
  assign new_n32_ = ~x13 & ((~x03 & (~x05 | ~x07)) | (x03 & ~x04 & x12) | (~x05 & ~x12));
