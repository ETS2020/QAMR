...
module FAU ( 
  ...
  assign z2 = (x03 & ((~new_n30_ & x09) | (~new_n28_ & x11))) | (~new_n31_ & (x09 | x11));
  assign new_n28_ = new_n29_ & x02 & x04;
  assign new_n29_ = ~x08 & ~x10;
  assign new_n30_ = (~x02 | ~x04 | (~x13 & (x08 | x10 | x11))) & (~x11 | ~x13);
  assign new_n31_ = x05 & (x03 | x06);
  assign z3 = new_n34_ | (x09 & ((~new_n33_ & x03) | ~x05 | (~x03 & ~x07)));
  assign new_n33_ = (~x04 | ((~x12 | ~x13) & (~x02 | (~x13 & (~new_n29_ | x11 | x12))))) & (~x12 | (new_n29_ & x02 & x04));
