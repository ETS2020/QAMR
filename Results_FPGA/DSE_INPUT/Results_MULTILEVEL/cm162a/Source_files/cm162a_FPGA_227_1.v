...
module FAU ( 
  ...
  assign z0 = (x03 & (new_n22_ | ~new_n23_)) | (x00 & ~x05) | (~x00 & ~x03 & ~x09);
  assign new_n22_ = (x00 | ~x09) & ((x08 & (~x02 | ~x04)) | (x02 & x04 & ~x08));
  assign new_n23_ = (x05 | x09) & (~x00 | ~x08 | ~x09 | ~x13);
  assign z1 = ((new_n25_ | ~new_n26_) & (x00 | ~x09)) | (new_n27_ & x00);
