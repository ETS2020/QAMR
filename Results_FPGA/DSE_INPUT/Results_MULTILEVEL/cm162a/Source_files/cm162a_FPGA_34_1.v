...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n32_;
  assign z0 = (x06 | ~x12) & ((~new_n22_ & x03) | ~x05 | (~x00 & ~x03));
  ...
  assign z2 = (x03 & ((~new_n27_ & (x06 | ~x12)) | (~x05 & ~x12))) | (~x05 & x06) | (~x03 & ~x06 & ~x12);
  ...
  assign new_n30_ = x06 & x12 & (~new_n31_ | ~x02 | ~x04 | x08);
  assign new_n31_ = ~x10 & ~x11 & (~x09 | ~x13);
  assign new_n32_ = (x06 | ~x12) & (~x05 | (~x03 & ~x07));
