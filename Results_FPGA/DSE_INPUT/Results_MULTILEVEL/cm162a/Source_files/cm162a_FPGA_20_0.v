// Benchmark "FAU" written by ABC on Thu Aug  6 17:10:34 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_, new_n33_;
  assign z0 = x05 ? (x03 ? ~new_n22_ : ~x00) : x11;
  assign new_n22_ = (~x08 | (x02 & x04 & (~x09 | ~x13))) & (~x02 | ~x04 | x08);
  assign z1 = x05 ? (x03 ? ~new_n24_ : ~x01) : x11;
  assign new_n24_ = (~x02 | ~x04 | ((~x09 | ~x13) & (x08 | x10))) & (~x10 | (x02 & x04 & ~x08 & (~x09 | ~x13)));
  assign z2 = (~new_n26_ & x03) | (~x05 & x11) | (~x03 & x05 & ~x06);
  assign new_n26_ = (~x02 | ~new_n27_ | ~x04) & (~x11 | (new_n28_ & x02 & x04));
  assign new_n27_ = x05 & ((x09 & x13) | (~x08 & ~x10 & ~x11));
  assign new_n28_ = ~x08 & ~x10 & (~x09 | ~x13);
  assign z3 = (~x05 & x11) | (~x03 & x05 & ~x07) | (x03 & ((~new_n30_ & x05) | (x11 & x12)));
  ...
  assign z4 = x04 & x09 & x13 & (x05 | (~x05 & x11));
endmodule
