// Benchmark "FAU" written by ABC on Thu Aug  6 17:10:50 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_;
  assign z0 = (~new_n22_ & (x09 | x13)) | (x03 & x08 & x09 & x13);
  assign new_n22_ = (~x03 | ((~x08 | (x02 & x04)) & (~x02 | ~x04 | x08))) & x05 & (x00 | x03);
  assign z1 = (~new_n24_ & ((~new_n25_ & x03) | (~x01 & ~x03) | ~x05)) | (new_n26_ & x03);
