// Benchmark "FAU" written by ABC on Thu Aug  6 17:10:39 2020
...
module FAU ( 
  ...
  assign new_n22_ = ~x13 & (x03 ? ((x08 & (~x02 | ~x04)) | (x02 & x04 & ~x08)) : ~x00);
  assign z1 = ~x05 | (~new_n24_ & ~x13);
  assign new_n24_ = x03 ? ((~x10 | (x02 & x04 & ~x08)) & (~x02 | ~x04 | x08 | x10)) : x01;
  assign z2 = ~x05 | (~x13 & (x03 ? ~new_n26_ : ~x06));
