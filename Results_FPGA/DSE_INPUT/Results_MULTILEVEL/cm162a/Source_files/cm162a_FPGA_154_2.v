...
module FAU ( 
  ...
  assign z2 = (~new_n28_ & x03) | (~new_n24_ & (~x05 | (~x03 & ~x06)));
  assign new_n28_ = (~x02 | new_n29_ | ~x04) & (~x11 | ~x13 | (new_n30_ & x02 & x04));
  assign new_n29_ = (~x09 | ~x13) & (x08 | x10 | x11);
  assign new_n30_ = ~x08 & ~x09 & ~x10;
  assign z3 = ~new_n35_ | (x03 & ((~new_n34_ & x12) | (~new_n32_ & x04)));
  assign new_n32_ = (~x02 | ((~x09 | ~x13) & (~new_n33_ | x11 | x12))) & (~x09 | ~x12 | ~x13);
  assign new_n33_ = ~x08 & ~x10;
  assign new_n34_ = (x04 | (x11 & ~x13)) & (x11 | (new_n33_ & x02)) & (~x11 | ~x13);
