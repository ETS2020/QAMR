...
module FAU ( 
  ...
  assign new_n92_ = new_n80_ & new_n93_ & new_n94_;
  assign new_n93_ = ~x28 & ~x29;
  assign new_n94_ = ~x30 & ~x31;
  assign z13 = new_n99_ | new_n96_ | (x18 & (~x31 | (~x32 & x34)));
  assign new_n96_ = x16 & (x31 ? (x32 & x34) : (new_n97_ | (~new_n91_ & x32)));
  assign new_n97_ = new_n59_ & new_n70_ & new_n80_ & new_n98_;
  assign new_n98_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign new_n99_ = ~x16 & ((x18 & x34) | (~x02 & (~x31 | x34)));
  assign z14 = (~new_n104_ & ~x16) | new_n105_ | (~new_n101_ & x16);
  assign new_n101_ = x31 ? (~x33 | ~x34) : ((new_n97_ | ~x33) & (~new_n69_ | ~new_n102_));
  assign new_n102_ = new_n103_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n103_ = ~x29 & ~x30 & ~x32 & ~x33;
  assign new_n104_ = (~x18 | ~x34) & (x01 | (x31 & ~x34));
  assign new_n105_ = x18 & (~x31 | (~x33 & x34));
  assign z15 = (~new_n107_ & x16) | ((~x31 | x34) & (x18 | (~x00 & ~x16)));
  assign new_n107_ = (~x34 | (new_n73_ & new_n108_ & new_n94_ & ~x32 & ~x33)) & (~new_n73_ | ~new_n108_ | ~new_n94_ | x32 | x33 | x34);
  assign new_n108_ = new_n93_ & ~x26 & ~x27;
endmodule
