...
module FAU ( 
  ...
  assign new_n82_ = (~new_n63_ | ~new_n83_) & (~x28 | ~x30 | (new_n63_ & new_n80_));
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (~new_n87_ & ~x16) | new_n88_ | (~new_n85_ & x16);
  assign new_n85_ = x28 ? (~x29 | ~x30) : ((~new_n63_ | ~new_n86_) & (~x29 | (new_n63_ & new_n80_)));
  assign new_n86_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n87_ = (x05 | (x28 & ~x30)) & (~x18 | ~x30);
  assign new_n88_ = x18 & (~x28 | (~x29 & x30));
  assign z11 = (~new_n90_ & x16) | (~new_n54_ & (x18 | (~x04 & ~x16)));
  assign new_n90_ = (~x30 | (new_n66_ & new_n78_ & ~x27 & ~x28 & ~x29)) & (~new_n66_ | ~new_n78_ | x29 | x30 | x27 | x28);
  assign z12 = (~new_n94_ & (~x28 | x30)) | (x16 & ((x30 & x31) | (~new_n92_ & ~x28)));
  assign new_n92_ = (~x31 | (new_n63_ & new_n86_)) & (~new_n66_ | ~new_n78_ | ~new_n93_);
  assign new_n93_ = ~x27 & ~x29 & ~x30 & ~x31;
  assign new_n94_ = ~x18 & (x03 | x16);
  assign z13 = new_n96_ | (x16 & (new_n101_ | (~x28 & (new_n97_ | new_n98_))));
  assign new_n96_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n97_ = x32 & (~new_n66_ | ~new_n78_ | x27 | x29 | x31);
  assign new_n98_ = new_n59_ & new_n69_ & new_n99_ & new_n100_;
  assign new_n99_ = ~x25 & ~x26 & ~x27;
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n101_ = x30 & x32;
  assign z14 = new_n103_ | (x16 & (new_n109_ | (~x28 & (new_n104_ | new_n106_))));
  assign new_n103_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n104_ = x33 & (~new_n66_ | ~new_n78_ | ~new_n105_);
  assign new_n105_ = ~x27 & ~x29 & ~x31 & ~x32;
  ...
  assign z15 = new_n111_ | (x16 & (new_n117_ | (~x28 & (new_n112_ | new_n114_))));
  assign new_n111_ = ~new_n54_ & (x18 | (~x00 & ~x16));
  assign new_n112_ = x34 & (~new_n59_ | ~new_n69_ | ~new_n99_ | ~new_n113_);
  assign new_n113_ = ~x29 & ~x31 & ~x32 & ~x33;
  assign new_n114_ = new_n60_ & new_n73_ & new_n115_ & new_n116_;
  assign new_n115_ = ~x26 & ~x27 & ~x29 & ~x30;
