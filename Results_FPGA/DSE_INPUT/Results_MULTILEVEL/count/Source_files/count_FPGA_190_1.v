...
module FAU ( 
  ...
  assign new_n82_ = new_n63_ & new_n83_ & ~x26 & ~x27 & ~x28;
  ...
  assign z12 = new_n94_ | (x16 & ((~new_n92_ & x31) | (new_n91_ & new_n95_)));
  assign new_n91_ = new_n59_ & new_n69_;
  assign new_n92_ = new_n66_ & new_n78_ & new_n93_;
  assign new_n93_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n94_ = ~new_n54_ & (x18 | (~x03 & ~x16));
  assign new_n95_ = new_n96_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n96_ = ~x29 & ~x30 & ~x31 & ~x34;
  assign z13 = new_n98_ | (x16 & (new_n99_ | (new_n72_ & new_n100_)));
  assign new_n98_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n99_ = x32 & (x31 | (~x34 & (~new_n66_ | ~new_n78_ | ~new_n93_)));
  assign new_n100_ = new_n101_ & ~x30 & ~x31 & ~x32 & ~x34;
  assign new_n101_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z14 = new_n103_ | (x16 & (new_n106_ | (~new_n104_ & x33)));
  assign new_n103_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n104_ = ~x31 & (x34 | (new_n59_ & new_n69_ & new_n80_ & new_n105_));
  assign new_n105_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign new_n106_ = new_n60_ & new_n73_ & new_n101_ & new_n107_;
  assign new_n107_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign z15 = (~x00 & (x34 ? x31 : ~x16)) | (x16 & (new_n106_ | (x31 & x34))) | (x18 & (x31 | ~x34));
endmodule
