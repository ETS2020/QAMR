...
module FAU ( 
  ...
  assign new_n55_ = ~x27 & (x16 ? ((x20 & (x17 | x19)) | (~x17 & ~x19 & ~x20)) : ~x14);
  ...
  assign z08 = x18 | (~x27 & (new_n76_ | (~x07 & ~x16)));
  assign new_n76_ = new_n74_ & ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign z09 = x18 | (~x27 & (x16 ? ~new_n78_ : ~x06));
  assign new_n78_ = (~x28 | (new_n59_ & new_n74_)) & (~new_n62_ | ~new_n79_);
  assign new_n79_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x28;
  assign z10 = x18 | (~x27 & (x16 ? ~new_n81_ : ~x05));
  assign new_n81_ = (~new_n62_ | ~new_n82_) & (~x29 | (new_n62_ & new_n79_));
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x28 & ~x29;
  assign z11 = x18 | (~x27 & (x16 ? (new_n84_ | new_n85_) : ~x04));
  assign new_n84_ = x30 & (~new_n62_ | ~new_n82_);
  assign new_n85_ = new_n65_ & new_n86_ & ~x28 & ~x29 & ~x30;
  assign new_n86_ = ~x24 & ~x25 & ~x26;
  assign z12 = x18 | (~x27 & (x16 ? ~new_n88_ : ~x03));
  assign new_n88_ = (~x31 | (new_n65_ & new_n86_ & ~x28 & ~x29 & ~x30)) & (~new_n65_ | ~new_n86_ | x28 | x29 | x30 | x31);
  assign z13 = x18 | (~x27 & (x16 ? (new_n90_ | new_n92_) : ~x02));
  assign new_n90_ = x32 & (~new_n65_ | ~new_n86_ | ~new_n91_);
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n92_ = new_n58_ & new_n68_ & new_n93_ & new_n94_;
  assign new_n93_ = ~x25 & ~x26 & ~x28;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x27 & (x16 ? (new_n96_ | new_n97_) : ~x01));
