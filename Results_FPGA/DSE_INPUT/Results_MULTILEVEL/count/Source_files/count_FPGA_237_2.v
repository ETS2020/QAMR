...
module FAU ( 
  ...
  assign z08 = x18 ? x34 : (x16 ? (new_n75_ | new_n77_) : ~x07);
  ...
  assign z09 = x18 ? x34 : (x16 ? ~new_n80_ : ~x06);
  assign new_n80_ = (~new_n62_ | ~new_n81_) & (~x28 | (new_n62_ & new_n78_ & ~x23 & ~x24));
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? x34 : (x16 ? ~new_n83_ : ~x05);
  assign new_n83_ = (~x29 | (new_n62_ & new_n81_)) & (~new_n65_ | ~new_n84_);
  assign new_n84_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = x18 ? x34 : (x16 ? ~new_n86_ : ~x04);
  assign new_n86_ = (~x30 | (new_n65_ & new_n84_)) & (~new_n65_ | ~new_n76_ | ~new_n87_);
  assign new_n87_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 ? x34 : (x16 ? (new_n89_ | new_n90_) : ~x03);
  assign new_n89_ = x31 & (~new_n65_ | ~new_n76_ | ~new_n87_);
  ...
  assign new_n93_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n78_ | ~new_n91_);
  ...
  assign z15 = (~x18 & (new_n103_ | (~x00 & ~x16))) | (x34 & (x18 | (~new_n99_ & x16)));
  assign new_n103_ = new_n104_ & new_n105_ & new_n100_ & new_n106_;
