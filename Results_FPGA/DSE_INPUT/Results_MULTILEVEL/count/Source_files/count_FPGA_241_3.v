...
module FAU ( 
  ...
  assign z08 = ~new_n79_ | (x16 & (new_n77_ | (new_n75_ & ~x17)));
  assign new_n75_ = ~x19 & ~x20 & ~x21 & ~x22 & new_n76_ & ~x23;
  assign new_n76_ = ~x24 & ~x25 & ~x26 & ~x27 & (~x18 | ~x28);
  assign new_n77_ = ~x18 & x27 & (~new_n59_ | ~new_n78_ | x22 | x23);
  ...
  assign new_n83_ = new_n62_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  ...
  assign new_n88_ = x29 & (~new_n62_ | ~new_n87_ | x26 | x27 | x28);
  assign z11 = (~x28 & (new_n90_ | x18)) | (~x18 & (x16 ? new_n91_ : ~x04));
  assign new_n90_ = new_n86_ & new_n87_ & ~x26 & ~x27 & ~x29 & ~x30;
  assign new_n91_ = x30 & (~new_n65_ | ~new_n78_ | x27 | x28 | x29);
  assign z12 = new_n93_ | (~x18 & (x16 ? (~new_n97_ & x31) : ~x03));
  assign new_n93_ = ~x28 & (x18 | (new_n94_ & new_n95_ & new_n78_ & new_n96_));
  assign new_n94_ = x16 & ~x17 & ~x19;
  assign new_n95_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n96_ = ~x27 & ~x29 & ~x30 & ~x31;
  assign new_n97_ = new_n65_ & new_n78_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = new_n99_ | (~x18 & (x16 ? (~new_n102_ & x32) : ~x02));
  assign new_n99_ = ~x28 & (x18 | (new_n94_ & new_n95_ & new_n100_ & new_n101_));
  assign new_n100_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n101_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n102_ = new_n58_ & new_n68_ & new_n103_ & ~x25 & ~x26 & ~x27;
  assign new_n103_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z14 = new_n105_ | (~x18 & (x16 ? (~new_n109_ & x33) : ~x01));
  assign new_n105_ = ~x28 & (x18 | (new_n68_ & new_n106_ & new_n107_ & new_n108_));
  assign new_n106_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n107_ = ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n108_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n109_ = new_n58_ & new_n68_ & new_n101_ & new_n110_;
  assign new_n110_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z15 = (~x28 & (x18 | (new_n112_ & new_n113_))) | (~x18 & (new_n114_ | new_n116_));
  assign new_n112_ = new_n68_ & new_n106_;
  assign new_n113_ = new_n107_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n114_ = x16 & x34 & (~new_n59_ | ~new_n71_ | ~new_n108_ | ~new_n115_);
