...
module FAU ( 
  ...
  assign z04 = x18 | (x03 & (x16 ? ~new_n64_ : ~x11));
  ...
  assign z06 = x18 | (x03 & (x16 ? ~new_n70_ : ~x09));
  ...
  assign z12 = x18 | (x03 & x16 & (new_n89_ | (~new_n88_ & x31)));
  assign new_n88_ = new_n65_ & new_n84_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign new_n89_ = new_n58_ & new_n68_ & new_n90_ & new_n91_;
  assign new_n90_ = ~x25 & ~x26 & ~x27;
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = x18 | (x03 & (x16 ? (new_n93_ | new_n94_) : ~x02));
  assign new_n93_ = x32 & (~new_n58_ | ~new_n68_ | ~new_n90_ | ~new_n91_);
  ...
  assign new_n98_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n95_ | ~new_n96_);
  assign new_n99_ = new_n59_ & new_n71_ & new_n100_ & new_n101_;
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (x03 & (x16 ? ~new_n103_ : ~x00));
  assign new_n103_ = (~x34 | (new_n59_ & new_n71_ & new_n100_ & new_n101_)) & (~new_n59_ | ~new_n71_ | ~new_n100_ | ~new_n104_);
