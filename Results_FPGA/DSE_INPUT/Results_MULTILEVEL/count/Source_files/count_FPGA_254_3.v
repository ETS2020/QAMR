...
module FAU ( 
  ...
  assign z05 = x18 ? ~x27 : (x16 ? ~new_n67_ : ~x10);
  ...
  assign z07 = x18 ? ~x27 : (x16 ? ~new_n73_ : ~x08);
  assign new_n73_ = (~x26 | (new_n59_ & ~x24 & ~x25 & ~x22 & ~x23)) & (~new_n59_ | x22 | x23 | x24 | x25 | x26);
  assign z08 = (~x27 & (new_n77_ | x18)) | (~x18 & (x16 ? (~new_n75_ & x27) : ~x07));
  assign new_n75_ = new_n59_ & new_n76_ & ~x22 & ~x23;
  assign new_n76_ = ~x24 & ~x25 & ~x26;
  assign new_n77_ = new_n78_ & new_n76_ & ~x22 & ~x23;
  assign new_n78_ = ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign z09 = (~x27 & (new_n80_ | x18)) | (~x18 & (x16 ? new_n82_ : ~x06));
  assign new_n80_ = new_n78_ & ~x25 & ~x26 & ~x28 & new_n81_ & ~x22;
  assign new_n81_ = ~x23 & ~x24;
  assign new_n82_ = x28 & (~new_n62_ | ~new_n81_ | x25 | x26 | x27);
  assign z10 = (~x27 & (new_n84_ | x18)) | (~x18 & (x16 ? new_n87_ : ~x05));
  assign new_n84_ = new_n85_ & new_n86_ & ~x26 & ~x28 & ~x29;
  assign new_n85_ = ~x20 & ~x21 & ~x22 & x16 & ~x17 & ~x19;
  assign new_n86_ = ~x23 & ~x24 & ~x25;
  assign new_n87_ = x29 & (~new_n62_ | ~new_n86_ | x26 | x27 | x28);
  assign z11 = (~x27 & (new_n89_ | x18)) | (~x18 & (x16 ? new_n90_ : ~x04));
  assign new_n89_ = new_n85_ & new_n86_ & ~x26 & ~x28 & ~x29 & ~x30;
  assign new_n90_ = x30 & (~new_n65_ | ~new_n76_ | x27 | x28 | x29);
  assign z12 = new_n92_ | (~x18 & (x16 ? (~new_n96_ & x31) : ~x03));
  assign new_n92_ = ~x27 & (x18 | (new_n93_ & new_n94_ & new_n76_ & new_n95_));
  assign new_n93_ = x16 & ~x17 & ~x19;
  assign new_n94_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29 & ~x30;
  assign z13 = new_n98_ | (~x18 & (x16 ? (~new_n101_ & x32) : ~x02));
  assign new_n98_ = ~x27 & (x18 | (new_n93_ & new_n94_ & new_n99_ & new_n100_));
  assign new_n99_ = ~x24 & ~x25 & ~x26 & ~x28;
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n101_ = new_n58_ & new_n68_ & new_n95_ & ~x25 & ~x26 & ~x27;
  assign z14 = new_n103_ | (~x18 & (x16 ? (~new_n107_ & x33) : ~x01));
  assign new_n103_ = ~x27 & (x18 | (new_n68_ & new_n104_ & new_n105_ & new_n106_));
  assign new_n104_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n105_ = ~x25 & ~x26 & ~x28 & ~x29;
  assign new_n106_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n107_ = new_n58_ & new_n68_ & new_n100_ & new_n108_;
  assign new_n108_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z15 = (~x27 & (x18 | (new_n110_ & new_n111_))) | (~x18 & (new_n112_ | new_n114_));
  assign new_n110_ = new_n68_ & new_n104_;
  assign new_n111_ = new_n105_ & ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n112_ = x16 & x34 & (~new_n59_ | ~new_n71_ | ~new_n106_ | ~new_n113_);
