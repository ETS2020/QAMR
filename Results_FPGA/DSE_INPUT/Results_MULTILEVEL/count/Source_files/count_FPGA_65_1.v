...
module FAU ( 
  ...
  assign new_n92_ = new_n80_ & new_n87_ & ~x30 & ~x34;
  assign z12 = new_n94_ | (x16 & ((new_n90_ & new_n96_) | (~new_n95_ & x31)));
  assign new_n94_ = ~new_n54_ & (x18 | (~x03 & ~x16));
  assign new_n95_ = ~x30 & (x34 | (new_n66_ & new_n78_ & new_n87_ & ~x27));
  assign new_n96_ = new_n97_ & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x34;
  assign z13 = new_n99_ | (x16 & (new_n100_ | (new_n72_ & new_n102_)));
  assign new_n99_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n100_ = x32 & (x30 | (~x34 & (~new_n66_ | ~new_n78_ | ~new_n101_)));
  assign new_n101_ = ~x27 & ~x28 & ~x29 & ~x31;
  assign new_n102_ = new_n103_ & ~x30 & ~x31 & ~x32 & ~x34;
  assign new_n103_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z14 = new_n105_ | (x16 & (new_n108_ | (~new_n106_ & x33)));
  assign new_n105_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n106_ = ~x30 & (x34 | (new_n59_ & new_n69_ & new_n80_ & new_n107_));
  assign new_n107_ = ~x28 & ~x29 & ~x31 & ~x32;
  assign new_n108_ = new_n60_ & new_n73_ & new_n103_ & new_n109_;
  assign new_n109_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign z15 = (~x00 & (x34 ? x30 : ~x16)) | (x16 & (new_n108_ | (x30 & x34))) | (x18 & (x30 | ~x34));
endmodule
