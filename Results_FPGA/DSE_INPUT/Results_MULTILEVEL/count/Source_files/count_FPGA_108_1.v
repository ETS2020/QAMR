...
module FAU ( 
  ...
  assign z10 = (~new_n88_ & (x29 | ~x31)) | (x16 & (new_n86_ | (~new_n82_ & x29)));
  assign new_n86_ = new_n66_ & new_n78_ & new_n87_ & ~x29 & ~x31;
  assign new_n87_ = ~x27 & ~x28;
  assign new_n88_ = ~x18 & (x05 | x16);
  assign z11 = new_n90_ | (x16 & (new_n92_ | (x30 & (new_n91_ | x29))));
  assign new_n90_ = ~new_n54_ & (x18 | (~x04 & ~x16));
  assign new_n91_ = ~x31 & (~new_n63_ | ~new_n83_);
  assign new_n92_ = new_n59_ & new_n69_ & new_n80_ & new_n93_;
  assign new_n93_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign z12 = (~x03 & (x31 ? x29 : ~x16)) | (x16 & (new_n92_ | (x29 & x31))) | (x18 & (x29 | ~x31));
  assign z13 = new_n96_ | (x16 & (new_n100_ | (~x31 & (new_n97_ | new_n98_))));
  assign new_n96_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n97_ = x32 & (~new_n66_ | ~new_n78_ | x27 | x28 | x30);
  assign new_n98_ = new_n59_ & new_n69_ & new_n80_ & new_n99_;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign new_n100_ = x29 & x32;
  assign z14 = new_n102_ | (x16 & (new_n107_ | (~x31 & (new_n103_ | new_n104_))));
  assign new_n102_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n103_ = x33 & (~new_n66_ | ~new_n78_ | ~new_n87_ | x30 | x32);
  assign new_n104_ = new_n59_ & new_n69_ & new_n105_ & new_n106_;
  assign new_n105_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n106_ = ~x29 & ~x30 & ~x32 & ~x33;
  assign new_n107_ = x29 & x33;
  assign z15 = new_n109_ | (x16 & (new_n115_ | (~x31 & (new_n110_ | new_n112_))));
  assign new_n109_ = ~new_n54_ & (x18 | (~x00 & ~x16));
  assign new_n110_ = x34 & (~new_n59_ | ~new_n69_ | ~new_n80_ | ~new_n111_);
  assign new_n111_ = ~x28 & ~x30 & ~x32 & ~x33;
  assign new_n112_ = new_n60_ & new_n73_ & new_n113_ & new_n114_;
  assign new_n113_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n114_ = ~x30 & ~x32 & ~x33 & ~x34;
  assign new_n115_ = x29 & x34;
endmodule
