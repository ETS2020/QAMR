// Benchmark "FAU" written by ABC on Thu Aug  6 17:25:06 2020
...
module FAU ( 
  ...
  assign z11 = x18 | (~x04 & (new_n86_ | ~x16 | (~new_n83_ & x30)));
  assign new_n86_ = new_n65_ & new_n84_ & new_n87_;
  assign new_n87_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = x18 | (~x04 & (x16 ? (new_n89_ | new_n90_) : ~x03));
  assign new_n89_ = x31 & (~new_n65_ | ~new_n84_ | ~new_n87_);
