...
module FAU ( 
  ...
  assign new_n91_ = ~x25 & ~x26 & ~x27 & new_n92_ & ~x30 & ~x31;
  ...
  assign z14 = (~new_n100_ & ~x16) | (~new_n98_ & x16) | (x18 & (new_n101_ | ~x32));
  assign new_n98_ = x32 ? (~x33 | x34) : ((~x33 | (new_n69_ & new_n91_)) & (~new_n69_ | ~new_n99_));
  assign new_n99_ = new_n95_ & ~x29 & ~x30 & ~x31 & ~x33;
  assign new_n100_ = (x01 | (x32 & x34)) & (~x18 | x34);
  assign new_n101_ = ~x33 & ~x34;
  assign z15 = ((~x32 | ~x34) & (x18 | (~x00 & ~x16))) | (x16 & ~new_n103_ & ~x32);
  assign new_n103_ = (~x34 | (new_n69_ & new_n99_)) & (~new_n72_ | ~new_n104_);
  assign new_n104_ = new_n92_ & ~x26 & ~x27 & new_n101_ & ~x30 & ~x31;
endmodule
