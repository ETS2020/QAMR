...
module FAU ( 
  ...
  assign z06 = (~new_n70_ & ~x18) | (x25 & (x18 | (x16 & (~new_n58_ | ~new_n68_))));
  assign new_n70_ = (x09 | x16) & (~new_n71_ | x19 | x20 | ~x16 | x17);
  assign new_n71_ = ~x21 & ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (~x18 & (x16 ? ~new_n73_ : ~x08)) | (x25 & (x18 | (x16 & x26)));
  assign new_n73_ = (~x26 | (new_n58_ & new_n68_)) & (~new_n59_ | ~new_n74_);
  assign new_n74_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (~x18 & (x16 ? ~new_n76_ : ~x07)) | (x25 & (x18 | (x16 & x27)));
  assign new_n76_ = (~x27 | (new_n59_ & new_n77_)) & (~new_n62_ | ~new_n78_);
  assign new_n77_ = ~x22 & ~x23 & ~x24 & ~x26;
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~x18 & (x16 ? ~new_n80_ : ~x06)) | (x25 & (x18 | (x16 & x28)));
  assign new_n80_ = (~x28 | (new_n59_ & new_n81_)) & (~new_n62_ | ~new_n82_);
  assign new_n81_ = ~x22 & ~x23 & ~x24 & ~x26 & ~x27;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (~x18 & (x16 ? ~new_n84_ : ~x05)) | (x25 & (x18 | (x16 & x29)));
  assign new_n84_ = (~x29 | (new_n62_ & new_n85_)) & (~new_n65_ | ~new_n86_);
  assign new_n85_ = ~x23 & ~x24 & ~x26 & ~x27 & ~x28;
  assign new_n86_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~x18 & (x16 ? ~new_n88_ : ~x04)) | (x25 & (x18 | (x16 & x30)));
  assign new_n88_ = (~x30 | (new_n62_ & new_n90_)) & (~new_n65_ | ~new_n89_ | ~new_n91_);
  assign new_n89_ = ~x24 & ~x25 & ~x26;
  assign new_n90_ = ~x23 & ~x24 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n91_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n97_ | (~x18 & (x16 ? (new_n93_ | new_n95_) : ~x03));
  assign new_n93_ = x31 & (~new_n65_ | ~new_n94_);
  assign new_n94_ = ~x24 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n95_ = new_n58_ & new_n68_ & new_n96_ & ~x25 & ~x26 & ~x27;
  assign new_n96_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n97_ = x25 & (x18 | (x16 & x31));
  assign z13 = new_n103_ | (~x18 & (x16 ? (new_n99_ | new_n100_) : ~x02));
  assign new_n99_ = x32 & (~new_n65_ | ~new_n96_ | x24 | x26 | x27);
  assign new_n100_ = new_n58_ & new_n68_ & new_n101_ & new_n102_;
  assign new_n101_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n102_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n103_ = x25 & (x18 | (x16 & x32));
  assign z14 = new_n111_ | (~x18 & (x16 ? (new_n105_ | new_n107_) : ~x01));
  assign new_n105_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n106_ | ~new_n102_);
  assign new_n106_ = ~x26 & ~x27 & ~x28;
  assign new_n107_ = new_n59_ & new_n108_ & new_n109_ & new_n110_;
  assign new_n108_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n109_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n111_ = x25 & (x18 | (x16 & x33));
  assign z15 = new_n116_ | (~x18 & (x16 ? (new_n113_ | new_n114_) : ~x00));
  assign new_n113_ = x34 & (~new_n58_ | ~new_n68_ | ~new_n109_ | ~new_n110_);
  assign new_n114_ = new_n59_ & new_n108_ & new_n109_ & new_n115_;
  assign new_n115_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n116_ = x25 & (x18 | (x16 & x34));
endmodule
