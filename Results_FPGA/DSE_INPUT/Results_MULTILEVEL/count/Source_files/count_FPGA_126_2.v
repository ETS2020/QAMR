...
module FAU ( 
  ...
  assign z09 = x18 ? x30 : (x16 ? (new_n80_ | new_n81_) : ~x06);
  assign new_n80_ = x28 & (~new_n62_ | ~new_n78_ | x23 | x24);
  assign new_n81_ = new_n62_ & new_n82_;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 ? x30 : (x16 ? (new_n84_ | new_n85_) : ~x05);
  assign new_n84_ = x29 & (~new_n62_ | ~new_n82_);
  assign new_n85_ = new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29;
  assign z11 = (~new_n87_ & ~x18) | (x30 & (x18 | (~new_n85_ & x16)));
  assign new_n87_ = (x04 | x16) & (~new_n76_ | ~new_n90_ | ~new_n89_ | ~new_n88_ | ~x16);
  ...
  assign new_n92_ = x31 & (~new_n65_ | ~new_n76_ | x27 | x28 | x29);
  assign new_n93_ = new_n58_ & new_n68_ & new_n78_ & new_n94_;
  assign new_n94_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n95_ = x30 & (x18 | (x16 & x31));
  assign z13 = new_n102_ | (~x18 & (x16 ? (new_n97_ | new_n99_) : ~x02));
  assign new_n97_ = x32 & (~new_n65_ | ~new_n76_ | ~new_n98_ | x29 | x31);
