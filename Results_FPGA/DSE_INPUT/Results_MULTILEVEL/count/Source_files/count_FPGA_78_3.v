// Benchmark "FAU" written by ABC on Thu Aug  6 17:25:10 2020
...
module FAU ( 
  ...
  assign z13 = (~x16 & (~x02 | x18)) | (~x15 & (x18 | (x16 & (new_n94_ | new_n95_))));
  ...
  assign z14 = (~x16 & (~x01 | x18)) | (~x15 & (x18 | (x16 & (new_n99_ | new_n100_))));
  ...
  assign z15 = (~x16 & (~x00 | x18)) | (~x15 & (x18 | (~new_n104_ & x16)));
  assign new_n104_ = (~x34 | (new_n59_ & new_n71_ & new_n101_ & new_n102_)) & (~new_n101_ | ~new_n105_ | ~new_n59_ | ~new_n71_);
