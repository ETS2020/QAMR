...
module FAU ( 
  ...
  assign z00 = (x16 & (x17 ? (~x18 & x19) : (~x19 & (~x18 | ~x20)))) | (~x15 & ~x16 & ~x18) | (x18 & ~x20);
  assign z01 = (~x14 & ~x16 & ~x18) | (x18 & ~x20) | (x16 & ((~x18 & x20 & (x17 | x19)) | (~x17 & ~x19 & ~x20)));
  ...
  assign z05 = (~x20 & (new_n68_ | x18)) | (~x18 & (x16 ? new_n70_ : ~x10));
  ...
  assign z06 = (~x20 & (new_n73_ | x18)) | (~x18 & (x16 ? new_n75_ : ~x09));
  ...
  assign z14 = (~x20 & (x18 | (new_n73_ & new_n104_))) | (~x18 & (new_n107_ | new_n108_));
  ...
  assign new_n110_ = ~x20 & (x18 | (new_n58_ & new_n74_ & new_n105_ & new_n111_));
