...
module FAU ( 
  ...
  assign z06 = x18 ? x26 : (x16 ? (new_n70_ | new_n71_) : ~x09);
  assign new_n70_ = x25 & (~new_n58_ | ~new_n68_);
  assign new_n71_ = new_n59_ & new_n72_;
  assign new_n72_ = ~x22 & ~x23 & ~x24 & ~x25;
  assign z07 = (~x18 & (new_n74_ | (~x08 & ~x16))) | (x26 & (x18 | (~new_n71_ & x16)));
  assign new_n74_ = new_n75_ & ~x19 & ~x20 & ~x21 & x16 & ~x17;
  assign new_n75_ = ~x22 & ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = (x26 & (x18 | (x16 & x27))) | (~x18 & (new_n77_ | (~x07 & ~x16)));
  assign new_n77_ = x16 & ((x27 & (~new_n59_ | ~new_n72_)) | (new_n62_ & new_n78_));
  assign new_n78_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = (~x18 & (x16 ? ~new_n80_ : ~x06)) | (x26 & (x18 | (x16 & x28)));
  assign new_n80_ = (~x28 | (new_n59_ & new_n81_ & new_n82_)) & (~new_n62_ | ~new_n83_);
  assign new_n81_ = ~x22 & ~x23;
  assign new_n82_ = ~x24 & ~x25 & ~x27;
  assign new_n83_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = (~x18 & (x16 ? ~new_n85_ : ~x05)) | (x26 & (x18 | (x16 & x29)));
  assign new_n85_ = (~new_n65_ | ~new_n87_) & (~x29 | (new_n62_ & new_n86_));
  assign new_n86_ = ~x23 & ~x24 & ~x25 & ~x27 & ~x28;
  assign new_n87_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (~x18 & (x16 ? ~new_n89_ : ~x04)) | (x26 & (x18 | (x16 & x30)));
  assign new_n89_ = (~x30 | (new_n62_ & new_n91_)) & (~new_n65_ | ~new_n90_ | ~new_n92_);
  assign new_n90_ = ~x24 & ~x25 & ~x26;
  assign new_n91_ = ~x23 & ~x24 & ~x25 & ~x27 & ~x28 & ~x29;
  assign new_n92_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n97_ | (~x18 & (x16 ? (new_n94_ | new_n95_) : ~x03));
  assign new_n94_ = x31 & (~new_n65_ | ~new_n82_ | x28 | x29 | x30);
