...
module FAU ( 
  ...
  assign z12 = x18 | (~x32 & (x16 ? (new_n89_ | new_n91_) : ~x03));
  ...
  assign new_n94_ = ~x32 & (new_n95_ | (new_n96_ & new_n97_ & new_n92_ & new_n98_));
  assign new_n95_ = ~x02 & ~x16;
  assign new_n96_ = x16 & ~x17 & ~x19;
  assign new_n97_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign new_n98_ = ~x24 & ~x25 & ~x26 & ~x27;
  assign z14 = x18 | (~x32 & (x16 ? (new_n100_ | new_n101_) : ~x01));
  assign new_n100_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n78_ | ~new_n92_);
  assign new_n101_ = new_n58_ & new_n68_ & new_n102_ & new_n103_;
  assign new_n102_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n103_ = ~x29 & ~x30 & ~x31 & ~x33;
  assign z15 = x18 | (~x32 & (x16 ? (new_n105_ | new_n106_) : ~x00));
  assign new_n105_ = x34 & (~new_n58_ | ~new_n68_ | ~new_n102_ | ~new_n103_);
