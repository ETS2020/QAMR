...
module FAU ( 
  ...
  assign z09 = new_n81_ | (x16 & ((~new_n78_ & x28) | (new_n82_ & new_n66_)));
  assign new_n81_ = ~new_n54_ & (x18 | (~x06 & ~x16));
  assign new_n82_ = new_n77_ & ~x27 & ~x28 & x31;
  assign z10 = new_n84_ | (x16 & (new_n86_ | (~new_n85_ & x29)));
  assign new_n84_ = ~new_n54_ & (x18 | (~x05 & ~x16));
  assign new_n85_ = ~x28 & (~x31 | (new_n63_ & new_n79_ & ~x23 & ~x24));
  assign new_n86_ = new_n66_ & new_n77_ & ~x27 & ~x28 & ~x29 & x31;
  assign z11 = new_n88_ | (x16 & (new_n89_ | (new_n70_ & new_n91_)));
  assign new_n88_ = ~new_n54_ & (x18 | (~x04 & ~x16));
  assign new_n89_ = x30 & (x28 | (x31 & (~new_n63_ | ~new_n90_)));
  assign new_n90_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n91_ = new_n79_ & ~x28 & ~x29 & ~x30 & x31;
  assign z12 = ((x28 | x31) & (x18 | (~x03 & ~x16))) | (x16 & ~new_n93_ & x31);
  assign new_n93_ = new_n66_ & new_n77_ & ~x29 & ~x30 & ~x27 & ~x28;
