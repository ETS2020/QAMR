// Benchmark "FAU" written by ABC on Thu Aug  6 17:25:22 2020
...
module FAU ( 
  ...
  assign z10 = (~new_n87_ & (~x29 | x31)) | (x16 & (new_n86_ | (x29 & ~new_n82_ & x31)));
  assign new_n86_ = new_n66_ & new_n78_ & ~x27 & ~x28 & ~x29;
  assign new_n87_ = ~x18 & (x05 | x16);
  assign z11 = (~new_n91_ & ~x16) | new_n92_ | (x16 & (new_n89_ | new_n93_));
  assign new_n89_ = ~x29 & ((x30 & (~new_n63_ | ~new_n83_)) | (new_n66_ & new_n90_));
  assign new_n90_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x30;
  assign new_n91_ = (~x18 | ~x31) & (x04 | (x29 & ~x31));
  assign new_n92_ = x18 & (~x29 | (~x30 & x31));
  assign new_n93_ = x29 & x30 & x31;
  assign z12 = new_n96_ | (x16 & ((~new_n97_ & x31) | (new_n95_ & new_n99_)));
  assign new_n95_ = new_n59_ & new_n69_;
  assign new_n96_ = ~new_n54_ & (x18 | (~x03 & ~x16));
  assign new_n97_ = new_n66_ & new_n78_ & new_n98_ & ~x29 & ~x30;
  assign new_n98_ = ~x27 & ~x28;
  assign new_n99_ = new_n80_ & ~x28 & ~x29 & ~x30 & ~x31;
  assign z13 = new_n101_ | (x16 & (new_n105_ | (~x29 & (new_n102_ | new_n103_))));
  assign new_n101_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n102_ = x32 & (~new_n66_ | ~new_n90_);
  assign new_n103_ = new_n59_ & new_n69_ & new_n80_ & new_n104_;
  assign new_n104_ = ~x28 & ~x30 & ~x31 & ~x32;
  assign new_n105_ = x31 & x32;
  assign z14 = new_n107_ | (x16 & (new_n112_ | (~x29 & (new_n108_ | new_n109_))));
  assign new_n107_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n108_ = x33 & (~new_n66_ | ~new_n78_ | ~new_n98_ | x30 | x32);
  assign new_n109_ = new_n59_ & new_n69_ & new_n110_ & new_n111_;
  assign new_n110_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n111_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign new_n112_ = x31 & x33;
  assign z15 = new_n114_ | (x16 & (new_n120_ | (~x29 & (new_n115_ | new_n117_))));
  assign new_n114_ = ~new_n54_ & (x18 | (~x00 & ~x16));
  assign new_n115_ = x34 & (~new_n59_ | ~new_n69_ | ~new_n80_ | ~new_n116_);
  assign new_n116_ = ~x28 & ~x30 & ~x32 & ~x33;
  assign new_n117_ = new_n60_ & new_n73_ & new_n118_ & new_n119_;
  assign new_n118_ = ~x26 & ~x27 & ~x28 & ~x30;
  assign new_n119_ = ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n120_ = x31 & x34;
endmodule
