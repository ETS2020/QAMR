...
module FAU ( 
  ...
  assign new_n64_ = (~x23 | (~x22 & (new_n60_ | ~x34))) & (~new_n59_ | x21 | x22 | x23 | ~x34);
  assign z05 = (~new_n66_ & x16) | (~new_n54_ & (x18 | (~x10 & ~x16)));
  assign new_n66_ = (~new_n60_ | x22 | x23 | x24 | ~x34) & (~x24 | (~x22 & (new_n67_ | ~x34)));
  ...
  assign new_n90_ = x29 & (x22 | (x34 & (~new_n67_ | ~new_n91_)));
  ...
  assign new_n95_ = x30 & (x22 | (x34 & (~new_n67_ | ~new_n96_)));
  assign new_n96_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n97_ = new_n59_ & new_n98_ & new_n86_ & new_n99_;
  assign new_n98_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign new_n99_ = ~x28 & ~x29 & ~x30 & x34;
  assign z12 = (~new_n54_ & (x18 | (~x03 & ~x16))) | (x16 & (new_n101_ | new_n103_));
  assign new_n101_ = x31 & (x22 | (x34 & (~new_n70_ | ~new_n102_)));
  assign new_n102_ = ~x25 & ~x26 & ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n103_ = new_n59_ & new_n98_ & new_n104_ & new_n105_;
  assign new_n104_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n105_ = ~x29 & ~x30 & ~x31 & x34;
  assign z13 = new_n107_ | (x16 & ((~new_n108_ & x32) | (new_n111_ & new_n112_)));
  assign new_n107_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n108_ = ~x22 & (~x34 | (new_n70_ & new_n86_ & new_n109_ & new_n110_));
  assign new_n109_ = ~x28 & ~x29;
  assign new_n110_ = ~x30 & ~x31;
  assign new_n111_ = new_n60_ & ~x22 & ~x23 & ~x24 & ~x25;
  assign new_n112_ = new_n113_ & new_n110_ & ~x32 & x34;
  assign new_n113_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z14 = new_n115_ | (x16 & ((~new_n116_ & x33) | (new_n111_ & new_n119_)));
  assign new_n115_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n116_ = ~x22 & (~x34 | (new_n59_ & new_n75_ & new_n117_ & new_n118_));
  assign new_n117_ = ~x26 & ~x27 & ~x28;
  assign new_n118_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n119_ = new_n113_ & new_n110_ & ~x32 & ~x33 & x34;
  assign z15 = (~new_n122_ & (x22 | x34)) | (x16 & x34 & (~new_n111_ | ~new_n121_));
  assign new_n121_ = new_n113_ & new_n110_ & ~x32 & ~x33;
