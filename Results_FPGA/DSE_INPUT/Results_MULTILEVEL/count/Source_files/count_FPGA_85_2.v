...
module FAU ( 
  ...
  assign new_n67_ = ~x21 & ~x22 & ~x23 & ~x17 & ~x20;
  assign new_n68_ = ~x21 & ~x22 & ~x23 & ~x24;
  assign z06 = (x19 & (x18 | (x16 & x25))) | (~x18 & (x16 ? ~new_n70_ : ~x09));
  assign new_n70_ = (new_n72_ | ~x25) & (~new_n71_ | ~new_n73_);
  assign new_n71_ = ~x17 & ~x19 & ~x20 & ~x21;
  assign new_n72_ = ~x17 & ~x20 & ~x21 & ~x22 & ~x23 & ~x24;
  ...
  assign z09 = (x19 & (x18 | (x16 & x28))) | (~x18 & (x16 ? ~new_n81_ : ~x06));
  ...
  assign z10 = (x19 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n85_ : ~x05));
  ...
  assign z11 = (x19 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n90_ : ~x04));
  ...
  assign new_n97_ = x19 & (x18 | (x16 & x31));
  ...
  assign new_n103_ = x19 & (x18 | (x16 & x32));
  ...
  assign new_n109_ = x19 & (x18 | (x16 & x33));
  ...
  assign new_n114_ = x19 & (x18 | (x16 & x34));
endmodule
