...
module FAU ( 
  ...
  assign z08 = ~new_n54_ & ((~new_n76_ & x16) | x18 | (~x07 & ~x16));
  assign new_n76_ = ~new_n77_ & (~x27 | (new_n60_ & new_n78_ & ~x22 & ~x23));
  assign new_n77_ = new_n63_ & ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign new_n78_ = ~x24 & ~x25 & ~x26;
  assign z09 = ~new_n80_ & ~new_n54_;
  assign new_n80_ = ~x18 & (x06 | x16) & (~x16 | (~new_n81_ & (new_n77_ | ~x28)));
  assign new_n81_ = new_n63_ & new_n82_;
  assign new_n82_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = ~new_n54_ & ((~new_n84_ & x16) | x18 | (~x05 & ~x16));
  assign new_n84_ = (new_n81_ | ~x29) & (~new_n66_ | ~new_n78_ | x27 | x28 | x29);
  assign z11 = ~new_n54_ & ((~new_n86_ & x16) | x18 | (~x04 & ~x16));
  assign new_n86_ = (~x30 | (new_n66_ & new_n78_ & ~x27 & ~x28 & ~x29)) & (~new_n66_ | ~new_n78_ | x29 | x30 | x27 | x28);
  assign z12 = ~new_n54_ & ((x16 & (new_n88_ | new_n90_)) | x18 | (~x03 & ~x16));
  assign new_n88_ = x31 & (~new_n66_ | ~new_n78_ | ~new_n89_);
  assign new_n89_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign new_n90_ = new_n69_ & new_n91_;
  assign new_n91_ = ~x25 & ~x26 & ~x27 & new_n92_ & ~x28 & ~x29;
  assign new_n92_ = ~x30 & ~x31;
  assign z13 = (~new_n96_ & (~x32 | x34)) | (x16 & (new_n94_ | (x32 & ~new_n90_ & x34)));
  assign new_n94_ = new_n69_ & new_n95_ & ~x31 & ~x32 & ~x29 & ~x30;
  assign new_n95_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n96_ = ~x18 & (x02 | x16);
  assign z14 = (~x16 & (new_n100_ | (x18 & x34))) | (~new_n98_ & x16) | (~new_n101_ & x18);
  assign new_n98_ = x32 ? (~x33 | ~x34) : ((~x33 | (new_n69_ & new_n91_)) & (~new_n69_ | ~new_n99_));
  assign new_n99_ = new_n95_ & ~x29 & ~x30 & ~x31 & ~x33;
  assign new_n100_ = ~new_n54_ & ~x01;
  assign new_n101_ = x32 & (x33 | ~x34);
  assign z15 = (~new_n103_ & x16) | (~new_n54_ & (x18 | (~x00 & ~x16)));
  assign new_n103_ = (~x34 | (new_n72_ & new_n104_ & new_n92_ & ~x32 & ~x33)) & (~new_n72_ | ~new_n104_ | ~new_n92_ | x32 | x33 | x34);
