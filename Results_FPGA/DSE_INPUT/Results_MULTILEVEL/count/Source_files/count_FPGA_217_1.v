...
module FAU ( 
  ...
  assign new_n55_ = ~x31 & (x16 ? ((x20 & (x17 | x19)) | (~x17 & ~x19 & ~x20)) : ~x14);
  ...
  assign z11 = x18 | (~x31 & (x16 ? ~new_n87_ : ~x04));
  assign new_n87_ = (~x30 | (new_n65_ & new_n76_ & ~x27 & ~x28 & ~x29)) & (~new_n65_ | ~new_n76_ | x27 | x28 | x29 | x30);
  assign z12 = x18 | (~x31 & ((~x03 & ~x16) | (new_n89_ & new_n91_)));
  assign new_n89_ = new_n76_ & new_n90_ & ~x29 & ~x30;
  assign new_n90_ = ~x27 & ~x28;
  assign new_n91_ = new_n92_ & x16 & ~x17 & ~x19;
  assign new_n92_ = ~x20 & ~x21 & ~x22 & ~x23;
  assign z13 = x18 | (~x31 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  assign new_n94_ = x32 & (~new_n65_ | ~new_n76_ | ~new_n90_ | x29 | x30);
  assign new_n95_ = new_n58_ & new_n68_ & new_n78_ & new_n96_;
  assign new_n96_ = ~x28 & ~x29 & ~x30 & ~x32;
  assign z14 = x18 | (~x31 & (x16 ? (new_n98_ | new_n99_) : ~x01));
  assign new_n98_ = x33 & (~new_n58_ | ~new_n68_ | ~new_n78_ | ~new_n96_);
  assign new_n99_ = new_n58_ & new_n68_ & new_n100_ & new_n101_;
  assign new_n100_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n101_ = ~x29 & ~x30 & ~x32 & ~x33;
  assign z15 = x18 | (~x31 & (x16 ? (new_n103_ | new_n104_) : ~x00));
  assign new_n103_ = x34 & (~new_n58_ | ~new_n68_ | ~new_n100_ | ~new_n101_);
  assign new_n104_ = new_n59_ & new_n71_ & new_n105_ & new_n106_;
  assign new_n105_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n106_ = ~x30 & ~x32 & ~x33 & ~x34;
endmodule
