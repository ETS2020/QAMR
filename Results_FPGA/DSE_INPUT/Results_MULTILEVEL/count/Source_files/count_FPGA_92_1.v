...
module FAU ( 
  ...
  assign z09 = new_n82_ | (x16 & ((~new_n79_ & x28) | (new_n83_ & new_n66_)));
  assign new_n82_ = ~new_n54_ & (x18 | (~x06 & ~x16));
  assign new_n83_ = new_n78_ & ~x27 & ~x28 & ~x30;
  assign z10 = (x16 & (new_n85_ | new_n86_)) | (~new_n54_ & (x18 | (~x05 & ~x16)));
  assign new_n85_ = x29 & (x28 | (~x30 & (~new_n63_ | ~new_n80_)));
  assign new_n86_ = new_n66_ & new_n78_ & ~x29 & ~x30 & ~x27 & ~x28;
  assign z11 = (~x04 & (x30 ? x28 : ~x16)) | (x16 & (new_n86_ | (x28 & x30))) | (x18 & (x28 | ~x30));
  assign z12 = (~new_n92_ & (x28 | ~x30)) | (x16 & ((x28 & x31) | (~new_n89_ & ~x30)));
  assign new_n89_ = (~x31 | (new_n63_ & new_n90_)) & (~new_n66_ | ~new_n78_ | ~new_n91_);
  assign new_n90_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x29;
  assign new_n91_ = ~x27 & ~x28 & ~x29 & ~x31;
  assign new_n92_ = ~x18 & (x03 | x16);
  assign z13 = new_n94_ | (x16 & (new_n99_ | (~x30 & (new_n95_ | new_n96_))));
  assign new_n94_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n95_ = x32 & (~new_n66_ | ~new_n78_ | x27 | x29 | x31);
  ...
  assign z14 = new_n101_ | (x16 & (new_n107_ | (~x30 & (new_n102_ | new_n104_))));
  assign new_n101_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n102_ = x33 & (~new_n66_ | ~new_n78_ | ~new_n103_);
  assign new_n103_ = ~x27 & ~x29 & ~x31 & ~x32;
  ...
  assign z15 = new_n109_ | (x16 & (new_n114_ | (~x30 & (new_n110_ | new_n111_))));
  assign new_n109_ = ~new_n54_ & (x18 | (~x00 & ~x16));
  assign new_n110_ = x34 & (~new_n59_ | ~new_n69_ | ~new_n97_ | ~new_n106_);
  assign new_n111_ = new_n60_ & new_n73_ & new_n112_ & new_n113_;
  assign new_n112_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n113_ = ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n114_ = x28 & x34;
endmodule
