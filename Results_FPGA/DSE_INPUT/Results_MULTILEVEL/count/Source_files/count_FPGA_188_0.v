...
module FAU ( 
  ...
  assign z06 = ~new_n54_ & (~new_n72_ | (x16 & (new_n71_ | (~new_n70_ & x25))));
  ...
  assign z09 = ~new_n54_ & (~new_n82_ | (x16 & (new_n80_ | (~new_n78_ & x28))));
  assign new_n80_ = new_n63_ & new_n81_;
  assign new_n81_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n82_ = ~x18 & (x06 | x16);
  assign z10 = ~new_n54_ & (~new_n86_ | (x16 & (new_n84_ | (~new_n80_ & x29))));
  assign new_n84_ = new_n66_ & new_n77_ & new_n85_ & ~x27;
  assign new_n85_ = ~x28 & ~x29;
  assign new_n86_ = ~x18 & (x05 | x16);
  assign z11 = new_n88_ | (x16 & ((~new_n84_ & x30) | (new_n70_ & new_n89_)));
  assign new_n88_ = ~new_n54_ & (x18 | (~x04 & ~x16));
  assign new_n89_ = ~x25 & ~x26 & ~x27 & new_n85_ & ~x30 & x33;
  assign z12 = new_n91_ | (x16 & ((new_n70_ & new_n93_) | (~new_n92_ & x31)));
  assign new_n91_ = ~new_n54_ & (x18 | (~x03 & ~x16));
  assign new_n92_ = ~x30 & (~x33 | (new_n66_ & new_n77_ & new_n85_ & ~x27));
  assign new_n93_ = new_n94_ & ~x29 & ~x30 & ~x31 & x33;
  assign new_n94_ = ~x25 & ~x26 & ~x27 & ~x28;
  assign z13 = new_n96_ | (x16 & (new_n97_ | (new_n71_ & new_n99_)));
  assign new_n96_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n97_ = x32 & (x30 | (x33 & (~new_n66_ | ~new_n77_ | ~new_n98_)));
  assign new_n98_ = ~x27 & ~x28 & ~x29 & ~x31;
  assign new_n99_ = new_n100_ & new_n85_ & ~x26 & ~x27;
  assign new_n100_ = ~x30 & ~x31 & ~x32 & x33;
  assign z14 = (~new_n103_ & (x30 | x33)) | (x16 & x33 & (~new_n70_ | ~new_n102_));
  assign new_n102_ = new_n94_ & ~x29 & ~x30 & ~x31 & ~x32;
