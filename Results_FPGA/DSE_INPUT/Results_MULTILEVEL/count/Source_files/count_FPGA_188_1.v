...
module FAU ( 
  ...
  assign z10 = ~new_n54_ & (~new_n88_ | (x16 & (new_n86_ | (~new_n82_ & x29))));
  assign new_n86_ = new_n66_ & new_n78_ & new_n87_ & ~x27;
  assign new_n87_ = ~x28 & ~x29;
  assign new_n88_ = ~x18 & (x05 | x16);
  assign z11 = new_n91_ | (x16 & ((~new_n86_ & x30) | (new_n90_ & new_n92_)));
  assign new_n90_ = new_n59_ & new_n69_;
  assign new_n91_ = ~new_n54_ & (x18 | (~x04 & ~x16));
  assign new_n92_ = new_n80_ & new_n87_ & ~x30 & ~x33;
  assign z12 = new_n94_ | (x16 & ((new_n90_ & new_n96_) | (~new_n95_ & x31)));
  assign new_n94_ = ~new_n54_ & (x18 | (~x03 & ~x16));
  assign new_n95_ = ~x30 & (x33 | (new_n66_ & new_n78_ & new_n87_ & ~x27));
  assign new_n96_ = new_n97_ & new_n83_ & ~x25 & ~x26;
  assign new_n97_ = ~x29 & ~x30 & ~x31 & ~x33;
  assign z13 = new_n99_ | (x16 & (new_n101_ | (x32 & (new_n100_ | x30))));
  assign new_n99_ = ~new_n54_ & (x18 | (~x02 & ~x16));
  assign new_n100_ = ~x33 & (~new_n66_ | ~new_n78_ | ~new_n83_ | x29 | x31);
  assign new_n101_ = new_n60_ & new_n73_ & new_n102_ & new_n103_;
  assign new_n102_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n103_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z14 = (~x01 & (x33 ? x30 : ~x16)) | (x16 & (new_n101_ | (x30 & x33))) | (x18 & (x30 | ~x33));
  assign z15 = new_n106_ | (x16 & (new_n111_ | (~x33 & (new_n107_ | new_n109_))));
  assign new_n106_ = ~new_n54_ & (x18 | (~x00 & ~x16));
  assign new_n107_ = x34 & (~new_n59_ | ~new_n69_ | ~new_n80_ | ~new_n108_);
  assign new_n108_ = ~x28 & ~x29 & ~x31 & ~x32;
  assign new_n109_ = new_n60_ & new_n73_ & new_n102_ & new_n110_;
  assign new_n110_ = ~x30 & ~x31 & ~x32 & ~x34;
