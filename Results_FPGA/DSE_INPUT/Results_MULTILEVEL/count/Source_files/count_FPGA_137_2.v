// Benchmark "FAU" written by ABC on Thu Aug  6 17:25:30 2020
...
module FAU ( 
  ...
  assign new_n55_ = ~x01 & (x16 ? ((x20 & (x17 | x19)) | (~x17 & ~x19 & ~x20)) : ~x14);
  assign z02 = x18 | (~new_n57_ & ~x01);
  ...
  assign z13 = x18 | (~x01 & (x16 ? (new_n94_ | new_n95_) : ~x02));
  ...
  assign z14 = x18 | (~x01 & (~new_n99_ | (~new_n95_ & x33)));
  assign new_n99_ = x16 & (~new_n59_ | ~new_n71_ | ~new_n100_ | ~new_n101_);
  assign new_n100_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n101_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x01 & (x16 ? ~new_n103_ : ~x00));
