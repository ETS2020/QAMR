...
module FAU ( 
  ...
  assign new_n55_ = ~x21 & (x16 ? ((x20 & (x17 | x19)) | (~x17 & ~x19 & ~x20)) : ~x14);
  assign z02 = new_n57_ | x18;
  assign new_n57_ = ~x21 & ((~x13 & ~x16) | (~x19 & ~x20 & x16 & ~x17));
  ...
  assign z07 = x18 | (~x21 & (x16 ? ~new_n72_ : ~x08));
  assign new_n72_ = (~x26 | (new_n60_ & new_n70_)) & (~new_n61_ | ~new_n73_);
  assign new_n73_ = ~x23 & ~x24 & ~x25 & ~x26;
  assign z08 = x18 | (~x21 & (x16 ? ~new_n75_ : ~x07));
  assign new_n75_ = (~new_n61_ | ~new_n76_) & (~x27 | (new_n61_ & new_n73_));
  assign new_n76_ = ~x23 & ~x24 & ~x25 & ~x26 & ~x27;
  assign z09 = x18 | (~x21 & (x16 ? ~new_n78_ : ~x06));
  assign new_n78_ = (~x28 | (new_n61_ & new_n76_)) & (~new_n64_ | ~new_n79_);
  assign new_n79_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign z10 = x18 | (~x21 & (x16 ? ~new_n81_ : ~x05));
  assign new_n81_ = (~new_n64_ | ~new_n82_) & (~x29 | (new_n64_ & new_n79_));
  assign new_n82_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = x18 | (~x21 & (x16 ? (new_n84_ | new_n85_) : ~x04));
  assign new_n84_ = x30 & (~new_n64_ | ~new_n82_);
  assign new_n85_ = new_n67_ & new_n86_ & ~x28 & ~x29 & ~x30;
  assign new_n86_ = ~x25 & ~x26 & ~x27;
  assign z12 = x18 | (~x21 & (x16 ? ~new_n88_ : ~x03));
  assign new_n88_ = (~x31 | (new_n67_ & new_n86_ & ~x28 & ~x29 & ~x30)) & (~new_n67_ | ~new_n86_ | x28 | x29 | x30 | x31);
  assign z13 = x18 | (~x21 & (x16 ? (new_n90_ | new_n92_) : ~x02));
  assign new_n90_ = x32 & (~new_n67_ | ~new_n86_ | ~new_n91_);
  assign new_n91_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n92_ = new_n60_ & new_n70_ & new_n93_ & new_n94_;
  assign new_n93_ = ~x26 & ~x27 & ~x28;
  assign new_n94_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign z14 = x18 | (~x21 & (x16 ? (new_n96_ | new_n97_) : ~x01));
  assign new_n96_ = x33 & (~new_n60_ | ~new_n70_ | ~new_n93_ | ~new_n94_);
  assign new_n97_ = new_n60_ & new_n70_ & new_n98_ & new_n99_;
  assign new_n98_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n99_ = ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = x18 | (~x21 & (x16 ? (new_n101_ | new_n102_) : ~x00));
  assign new_n101_ = x34 & (~new_n60_ | ~new_n70_ | ~new_n98_ | ~new_n99_);
  assign new_n102_ = new_n61_ & new_n73_ & new_n103_ & new_n104_;
