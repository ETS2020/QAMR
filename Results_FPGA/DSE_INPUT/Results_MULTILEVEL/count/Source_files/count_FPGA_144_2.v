...
module FAU ( 
  ...
  assign z10 = (x20 & (x18 | (x16 & x29))) | (~x18 & (x16 ? ~new_n85_ : ~x05));
  assign new_n85_ = (~x29 | (new_n67_ & new_n86_)) & (~new_n64_ | ~new_n87_);
  assign new_n86_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28;
  assign new_n87_ = ~x24 & ~x25 & ~x26 & ~x27 & ~x28 & ~x29;
  assign z11 = (x20 & (x18 | (x16 & x30))) | (~x18 & (x16 ? ~new_n89_ : ~x04));
  assign new_n89_ = (~x30 | (new_n67_ & new_n87_)) & (~new_n64_ | ~new_n90_ | ~new_n91_);
  assign new_n90_ = ~x24 & ~x25 & ~x26;
  assign new_n91_ = ~x27 & ~x28 & ~x29 & ~x30;
  assign z12 = new_n96_ | (~x18 & (x16 ? (new_n93_ | new_n94_) : ~x03));
  assign new_n93_ = x31 & (~new_n72_ | ~new_n82_ | x28 | x29 | x30);
  assign new_n94_ = new_n82_ & new_n95_ & new_n68_ & ~x17 & ~x19 & ~x20;
  assign new_n95_ = ~x28 & ~x29 & ~x30 & ~x31;
  assign new_n96_ = x20 & (x18 | (x16 & x31));
  assign z13 = new_n102_ | (~x18 & (x16 ? (new_n98_ | new_n99_) : ~x02));
  assign new_n98_ = x32 & (~new_n72_ | ~new_n82_ | ~new_n95_);
  assign new_n99_ = new_n100_ & new_n101_ & new_n68_ & ~x17 & ~x19 & ~x20;
  ...
  assign new_n104_ = x33 & (~new_n105_ | ~new_n101_ | ~new_n59_ | ~new_n73_);
  ...
  assign new_n114_ = x20 & (x18 | (x16 & x34));
endmodule
