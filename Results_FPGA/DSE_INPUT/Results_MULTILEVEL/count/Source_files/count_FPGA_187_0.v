...
module FAU ( 
  ...
  assign new_n68_ = (~x24 | (~x23 & (new_n63_ | ~x34))) & (~new_n60_ | x22 | x23 | x24 | ~x34);
  ...
  assign new_n108_ = ~x23 & (~x34 | (new_n71_ & new_n86_ & new_n109_ & new_n110_));
  assign new_n109_ = ~x28 & ~x29;
  assign new_n110_ = ~x30 & ~x31;
  assign new_n111_ = new_n60_ & new_n82_ & ~x22 & ~x23;
  assign new_n112_ = new_n113_ & new_n110_ & ~x32 & x34;
  assign new_n113_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign z14 = new_n115_ | (x16 & ((~new_n116_ & x33) | (new_n111_ & new_n118_)));
  assign new_n115_ = ~new_n54_ & (x18 | (~x01 & ~x16));
  assign new_n116_ = ~x23 & (~x34 | (new_n59_ & new_n76_ & new_n91_ & new_n117_));
  assign new_n117_ = ~x29 & ~x30 & ~x31 & ~x32;
  assign new_n118_ = new_n113_ & new_n110_ & ~x32 & ~x33 & x34;
  assign z15 = (~new_n121_ & (x23 | x34)) | (x16 & x34 & (~new_n111_ | ~new_n120_));
  assign new_n120_ = new_n113_ & new_n110_ & ~x32 & ~x33;
