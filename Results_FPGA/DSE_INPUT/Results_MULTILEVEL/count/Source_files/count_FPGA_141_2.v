...
module FAU ( 
  ...
  assign z09 = x18 ? x33 : (x16 ? ~new_n79_ : ~x06);
  ...
  assign z11 = x18 ? x33 : (x16 ? ~new_n85_ : ~x04);
  ...
  assign z13 = x18 ? x33 : (x16 ? (new_n93_ | new_n94_) : ~x02);
  ...
  assign z14 = (~x18 & (new_n98_ | (~x01 & ~x16))) | (x33 & (x18 | (~new_n94_ & x16)));
  assign new_n98_ = new_n68_ & new_n99_ & new_n95_ & new_n100_;
  assign new_n99_ = ~x19 & ~x20 & x16 & ~x17;
  assign new_n100_ = ~x29 & ~x30 & ~x31 & ~x32 & ~x33;
  assign z15 = new_n106_ | (~x18 & (x16 ? (new_n102_ | new_n103_) : ~x00));
  assign new_n102_ = x34 & (~new_n95_ | ~new_n96_ | ~new_n58_ | ~new_n68_);
  assign new_n103_ = new_n104_ & new_n105_ & new_n59_ & new_n71_ & ~x24 & ~x25;
  assign new_n104_ = ~x26 & ~x27 & ~x28 & ~x29;
  assign new_n105_ = ~x30 & ~x31 & ~x32 & ~x33 & ~x34;
  assign new_n106_ = x33 & (x18 | (x16 & x34));
endmodule
