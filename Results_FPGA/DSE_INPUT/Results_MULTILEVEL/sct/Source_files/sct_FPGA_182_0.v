...
module FAU ( 
  ...
  assign z05 = new_n44_ | (x09 & (~x06 | ~x07 | ~x08)) | (x00 & x06 & x07 & x08 & ~x09);
  assign new_n44_ = ~new_n37_ & (new_n40_ | ~x04);
  assign z06 = new_n44_ | ~new_n46_;
  assign new_n46_ = (~x00 | ((~x10 | (x06 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10))) & (~x09 | ~x10);
  assign z07 = new_n44_ | (~new_n48_ & x00) | (x09 & x11);
  assign new_n48_ = (~x11 | (x06 & x07 & x08 & ~x10)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = new_n44_ | (~new_n50_ & x00) | (x09 & x12);
  assign new_n50_ = (new_n52_ | ~x12) & (~new_n51_ | x11 | x12 | x09 | x10);
  assign new_n51_ = x06 & x07 & x08;
  assign new_n52_ = x06 & x07 & x08 & ~x10 & ~x11;
  assign z09 = new_n44_ | (~new_n54_ & x00) | (x09 & x13);
  assign new_n54_ = (~x13 | (new_n51_ & ~x10 & ~x11 & ~x12)) & (~new_n55_ | x12 | x13 | x10 | x11);
  assign new_n55_ = x06 & x07 & x08 & ~x09;
  assign z10 = x04 & (new_n57_ | (x00 & new_n58_ & x06));
  assign new_n57_ = x14 & x16 & ~new_n37_ & (~x02 | x03);
  assign new_n58_ = x07 & x08 & ~new_n40_ & ~x09;
