// Benchmark "FAU" written by ABC on Sat Aug  8 21:54:17 2020
...
module FAU ( 
  ...
  assign z01 = (~x04 & x05 & (~x15 | ~x16)) | (~x05 & (x15 ? ~x16 : ~x18));
  ...
  assign new_n58_ = x14 & ~x15 & x16 & (~x02 | x03);
  assign z11 = x02 & (~x15 | ~x16);
  assign z12 = x04 & ((x03 & (~x15 | ~x16)) | (~x02 & ~x15 & x16));
  assign z13 = x04 & (~x15 | ~x16);
  assign z14 = x04 & x17 & (~x15 | ~x16);
endmodule
