...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n37_, new_n40_, new_n44_, new_n46_, new_n47_, new_n50_, new_n51_,
  ...
  assign z06 = (~new_n46_ & (~x10 | ~x11)) | (x10 & ~x11 & (~new_n47_ | ~x08 | x09)) | (new_n47_ & x08 & ~x09 & ~x10);
  assign new_n46_ = ~new_n40_ & x04;
  assign new_n47_ = x06 & x07;
  assign z07 = (~new_n46_ & (~x10 | ~x11)) | (~x10 & ((x11 & (~new_n47_ | ~x08 | x09)) | (new_n47_ & x08 & ~x09 & ~x11)));
  assign z08 = ~new_n50_ | (~new_n46_ & (~x10 | (~x11 & ~x12)));
  assign new_n50_ = (x11 | ((~x10 | ~x12) & (~new_n51_ | x09 | x10 | x12))) & (x10 | new_n52_ | ~x12);
  assign new_n51_ = x06 & x07 & x08;
  assign new_n52_ = x06 & x07 & x08 & ~x09 & ~x11;
  assign z09 = ~new_n54_ | (~new_n46_ & (~x10 | (~x11 & ~x13)));
  assign new_n54_ = (x11 | ((~x10 | ~x13) & (~new_n51_ | x09 | x10 | x12 | x13))) & (x10 | ~x13 | (new_n51_ & ~x09 & ~x11 & ~x12));
