...
module FAU ( 
  ...
  assign z02 = x04 & ~x06 & ((x08 & ((x02 & ~x03) | ~x16)) | (x03 & ~x16));
  assign z03 = new_n40_ & x04;
  assign new_n40_ = ((x08 & ((x02 & ~x03) | ~x16)) | (x03 & ~x16)) & (x06 ^ x07);
  assign z04 = ~new_n42_ & x04;
  assign new_n42_ = (~x08 | ((~x02 | x03) & x16) | (x06 & (~x06 | x07))) & (~x03 | ~x06 | ~x07 | x08 | x16);
  assign z05 = (~x04 & (x08 | (x03 & ~x09))) | (x03 & (x16 | (~x08 & x09))) | (~new_n44_ & x08);
  assign new_n44_ = (~x09 | (x06 & x07)) & ~new_n45_ & (~x06 | ~x07 | x09);
  assign new_n45_ = ~x02 & x16;
  assign z06 = (~x04 & (x08 | (x03 & ~x10))) | (x03 & (x16 | (~x08 & x10))) | (~new_n47_ & x08);
  assign new_n47_ = (~x10 | (x06 & x07 & ~x09)) & ~new_n45_ & (~x06 | ~x07 | x09 | x10);
  assign z07 = (~x04 & (x08 | (x03 & ~x11))) | (x03 & (x16 | (~x08 & x11))) | (~new_n49_ & x08);
  assign new_n49_ = (~x11 | (x06 & x07 & ~x09 & ~x10)) & ~new_n45_ & (~x06 | ~x07 | x09 | x10 | x11);
  assign z08 = (~x04 & (x08 | (x03 & ~x12))) | (x03 & (x16 | (~x08 & x12))) | (~new_n51_ & x08);
  assign new_n51_ = (new_n53_ | ~x12) & ~new_n45_ & (~new_n52_ | x10 | x11 | x12);
  assign new_n52_ = x06 & x07 & ~x09;
  assign new_n53_ = x06 & x07 & ~x09 & ~x10 & ~x11;
  assign z09 = (~x04 & (x08 | (x03 & ~x13))) | (x03 & (x16 | (~x08 & x13))) | (~new_n55_ & x08);
  assign new_n55_ = (~x13 | (new_n52_ & ~x10 & ~x11 & ~x12)) & ~new_n45_ & (~new_n52_ | x10 | x11 | x12 | x13);
  assign z10 = x04 & ((x08 & (new_n57_ | (new_n60_ & ~x02))) | (new_n60_ & x03));
  ...
  assign z12 = x04 & (x03 | (~x02 & x08 & x16));
