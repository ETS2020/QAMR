...
module FAU ( 
  ...
  assign z05 = (~new_n44_ & (~x09 | x18)) | (x09 & x18 & (~x06 | ~x07 | ~x08)) | (x08 & ~x09 & x06 & x07);
  assign new_n44_ = ~new_n40_ & x04;
  assign z06 = (~new_n44_ & (~x09 | (~x10 & x18))) | (~new_n46_ & ~x09) | (x09 & x10 & x18);
  assign new_n46_ = (~x10 | (x06 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x10);
  assign z07 = (~new_n44_ & (~x09 | (~x11 & x18))) | (~new_n48_ & ~x09) | (x09 & x11 & x18);
  assign new_n48_ = (~x11 | (x06 & x07 & x08 & ~x10)) & (~x06 | ~x07 | ~x08 | x10 | x11);
  assign z08 = (~new_n44_ & (~x09 | (~x12 & x18))) | (~new_n50_ & ~x09) | (x09 & x12 & x18);
  assign new_n50_ = (~x12 | (x06 & x07 & x08 & ~x10 & ~x11)) & (~x06 | ~x07 | ~x08 | x10 | x11 | x12);
  assign z09 = (~new_n44_ & (~x09 | (~x13 & x18))) | (~new_n52_ & ~x09) | (x09 & x13 & x18);
  assign new_n52_ = (~x13 | (new_n53_ & ~x10 & ~x11 & ~x12)) & (~new_n53_ | x10 | x11 | x12 | x13);
  assign new_n53_ = x06 & x07 & x08;
  assign z10 = x04 & ((~x09 & (new_n55_ | (new_n40_ & x14))) | (new_n57_ & x14));
  assign new_n55_ = x06 & x07 & x08 & ~new_n40_ & ~new_n56_;
  assign new_n56_ = ~x00 & (x10 | x11 | x12 | x13);
  assign new_n57_ = x16 & x18 & (~x02 | x03);
