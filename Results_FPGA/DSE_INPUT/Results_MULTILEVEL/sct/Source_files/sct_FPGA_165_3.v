// Benchmark "FAU" written by ABC on Sat Aug  8 21:55:06 2020
...
module FAU ( 
  ...
  assign new_n41_ = (x07 | ~x08 | x16) & (x03 | ((~x07 | (~x02 & x16) | (~x06 ^ x08)) & (~x02 | x07 | ~x08)));
  assign z05 = (~x04 & (~x03 | ~x07)) | (~new_n43_ & ~x03) | (~x07 & (x09 | (x03 & x16)));
  assign new_n43_ = ~new_n44_ & ~new_n45_ & (~x09 | (x06 & x08));
  assign new_n44_ = ~x02 & x16;
  assign new_n45_ = x06 & x07 & x08 & ~x09;
  assign z06 = (~x04 & (~x03 | ~x07)) | (~new_n47_ & ~x03) | (~x07 & (x10 | (x03 & x16)));
  assign new_n47_ = (~x10 | (x06 & x08 & ~x09)) & ~new_n44_ & (~x08 | x09 | x10 | ~x06 | ~x07);
  assign z07 = (~x04 & (~x03 | ~x07)) | (~new_n49_ & ~x03) | (~x07 & (x11 | (x03 & x16)));
  assign new_n49_ = (~x11 | (new_n50_ & x06 & x08)) & ~new_n44_ & ~new_n51_;
  assign new_n50_ = ~x09 & ~x10;
  assign new_n51_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = (~x04 & (~x03 | ~x07)) | (~new_n53_ & ~x03) | (~x07 & (x12 | (x03 & x16)));
  assign new_n53_ = ~new_n54_ & ~new_n44_ & (~new_n55_ | ~x06 | ~x07 | ~x08);
  assign new_n54_ = x12 & (~x06 | ~x08 | x09 | x10 | x11);
  assign new_n55_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z09 = (~x04 & (~x03 | ~x07)) | (~new_n57_ & ~x03) | (~x07 & (x13 | (x03 & x16)));
  assign new_n57_ = (new_n58_ | ~x13) & ~new_n44_ & (~new_n45_ | ~new_n59_);
