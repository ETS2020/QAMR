...
module FAU ( 
  ...
  assign z07 = ~new_n38_ & (~new_n48_ | new_n40_);
  assign new_n48_ = (new_n50_ | ~x11) & x04 & (~new_n49_ | x09 | x10 | x11);
  assign new_n49_ = x06 & x07 & x08;
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10;
  assign z08 = ~new_n52_ | (~new_n38_ & (new_n40_ | ~x04));
  assign new_n52_ = (~x12 | x14 | (new_n49_ & ~x09 & ~x10 & ~x11)) & (~new_n49_ | x11 | x12 | x09 | x10);
  assign z09 = ((new_n40_ | ~x04) & (~x12 | (~x13 & ~x14))) | (~new_n54_ & ~x12) | (x12 & x13 & ~x14);
  assign new_n54_ = (~new_n49_ | x11 | x13 | x09 | x10) & (~x13 | (new_n49_ & ~x09 & ~x10 & ~x11));
