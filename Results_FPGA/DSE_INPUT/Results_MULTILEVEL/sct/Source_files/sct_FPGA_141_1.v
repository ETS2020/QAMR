// Benchmark "FAU" written by ABC on Sat Aug  8 21:54:56 2020
...
module FAU ( 
  ...
  assign z08 = (~new_n49_ & x07) | (~new_n43_ & (x07 | ~x12));
  assign new_n49_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = (~new_n43_ & (x07 | (~x12 & ~x13))) | (~new_n51_ & ~x12) | (x07 & ~new_n53_ & x13);
  assign new_n51_ = (x07 | ~x13) & (~x06 | ~x07 | ~x08 | ~new_n52_ | x11 | x13);
