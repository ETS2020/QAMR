...
module FAU ( 
  ...
  assign z03 = x04 & (~x08 | (x08 & ~x18)) & ~new_n40_ & (x06 ^ x07);
  assign z04 = x04 & ~new_n40_ & (x06 ? (x07 ? ~x08 : (x08 & ~x18)) : (x08 & ~x18));
  assign z05 = new_n44_ | (x09 & (~x08 | (~x18 & (~x06 | ~x07)))) | (x06 & x07 & x08 & ~x09 & ~x18);
  ...
  assign new_n51_ = ~x18 & (~x06 | ~x07 | x09 | x10 | x11);
  assign new_n52_ = x06 & x07 & x08 & ~x09;
  assign new_n53_ = ~x10 & ~x11 & ~x12 & ~x18;
  assign z09 = new_n44_ | new_n55_ | (x13 & (~x08 | (~new_n56_ & ~x18)));
  assign new_n55_ = new_n52_ & ~x12 & ~x13 & ~x18 & ~x10 & ~x11;
  assign new_n56_ = ~x10 & ~x11 & ~x12 & x06 & x07 & ~x09;
  assign z10 = x04 & ((~x18 & (new_n58_ | (new_n40_ & x14))) | (~x08 & new_n40_ & x14));
