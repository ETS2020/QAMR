...
module FAU ( 
  ...
  assign z08 = (~new_n50_ & ~x09) | (~new_n44_ & (~x09 | ~x12));
  assign new_n50_ = (~x12 | (x06 & x07 & x08 & ~x10 & ~x11)) & (~x06 | ~x07 | ~x08 | x10 | x11 | x12);
  assign z09 = ~new_n52_ | (~new_n44_ & (~x09 | (~x12 & ~x13)));
  assign new_n52_ = (x12 | ((~x09 | ~x13) & (~new_n53_ | x09 | x10 | x11 | x13))) & (x09 | ~x13 | (new_n53_ & ~x10 & ~x11 & ~x12));
