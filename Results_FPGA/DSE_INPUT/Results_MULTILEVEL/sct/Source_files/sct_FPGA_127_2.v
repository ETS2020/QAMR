...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n40_ & (x07 ? (x13 & (x06 ^ x08)) : x08);
  ...
  assign new_n51_ = new_n52_ & x06 & x07 & x08 & ~x09;
  assign new_n52_ = ~x10 & ~x11 & ~x12 & x13;
  assign new_n53_ = x13 & (~x06 | ~x08 | x09 | x10 | x11);
  assign z09 = new_n44_ | (x13 & (~new_n55_ | ~x06 | ~x07 | ~x08));
  assign new_n55_ = new_n49_ & ~x11 & ~x12;
  assign z10 = x04 & ((x13 & (new_n57_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
