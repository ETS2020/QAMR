...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n40_ & (x07 ? (x12 & (x06 ^ x08)) : x08);
  ...
  assign z08 = (~new_n44_ & (~x07 | x12)) | (x12 & (~new_n51_ | ~x06 | ~x07 | ~x08));
  assign new_n51_ = ~x09 & ~x10 & ~x11;
  assign z09 = ~new_n37_ & (new_n40_ | ~x04 | x13);
  assign z10 = x04 & ((x12 & (new_n54_ | (new_n40_ & x14))) | (~x07 & new_n40_ & x14));
