// Benchmark "FAU" written by ABC on Sat Aug  8 21:55:15 2020
...
module FAU ( 
  ...
  assign z05 = (~new_n44_ & (x09 | ~x12)) | (x09 & (~x06 | ~x07 | ~x08)) | (x06 & x07 & x08 & ~x09 & ~x12);
  assign new_n44_ = ~new_n40_ & x04;
  assign z06 = (~new_n44_ & (x09 | ~x12)) | (x10 & (x09 | (~new_n46_ & ~x12))) | (new_n46_ & ~x09 & ~x10 & ~x12);
  assign new_n46_ = x06 & x07 & x08;
  assign z07 = ~new_n48_ | (~new_n44_ & ~new_n37_);
  assign new_n48_ = (~x11 | (~x09 & (new_n49_ | x12))) & (~new_n46_ | x11 | x12 | x09 | x10);
  assign new_n49_ = x06 & x07 & x08 & ~x10;
  assign z08 = x12 ? x09 : (new_n40_ | ~x04 | (new_n46_ & new_n51_ & ~x09));
  assign new_n51_ = ~x10 & ~x11;
  assign z09 = (~new_n44_ & (x09 | ~x12)) | (~new_n53_ & ~x12) | (x09 & x13);
  assign new_n53_ = (~new_n46_ | x11 | x13 | x09 | x10) & (new_n54_ | ~x13);
  assign new_n54_ = x06 & x07 & x08 & ~x10 & ~x11;
  assign z10 = x04 & ((~x12 & (new_n56_ | (new_n40_ & x14))) | (x09 & new_n40_ & x14));
