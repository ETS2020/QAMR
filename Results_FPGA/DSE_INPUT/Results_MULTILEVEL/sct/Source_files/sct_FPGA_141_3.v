...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n39_ & (x07 ? (~x12 & (x06 ^ x08)) : x08);
  ...
  assign z07 = ~new_n47_ | (~new_n43_ & (~x07 | ~x12));
  assign new_n47_ = (~x11 | (x07 & (x12 | (new_n48_ & x06 & x08)))) & (~x06 | ~x07 | ~x08 | ~new_n48_ | x11 | x12);
  assign new_n48_ = ~x09 & ~x10;
  assign z08 = x12 ? ~x07 : (new_n39_ | new_n50_ | ~x04);
  assign new_n50_ = new_n51_ & ~x09 & ~x10 & ~x11;
  assign new_n51_ = x06 & x07 & x08;
  assign z09 = (~new_n43_ & (~x07 | ~x12)) | (~x07 & x13) | (~new_n53_ & ~x12);
  assign new_n53_ = (~x13 | (new_n54_ & ~x09 & ~x10 & ~x11)) & (~new_n51_ | x11 | x13 | x09 | x10);
  assign new_n54_ = x06 & x08;
  assign z10 = x04 & ((~x12 & (new_n58_ | (x06 & new_n56_ & x07))) | (new_n58_ & ~x07));
