...
module FAU ( 
  ...
  assign z05 = ~new_n43_ | (~x04 & (x09 | ~x16));
  assign new_n43_ = (~x09 | (~new_n44_ & x06 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x16);
  assign new_n44_ = x16 & (~x02 | x03);
  assign z06 = (~x04 & (x09 | ~x16)) | (x09 & (new_n44_ | x10)) | (~new_n46_ & ~x16);
  assign new_n46_ = (~x10 | (x06 & x07 & x08)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = (~x04 & (x09 | ~x16)) | (x09 & (new_n44_ | x11)) | (~new_n48_ & ~x16);
  assign new_n48_ = (~x11 | (x06 & x07 & x08 & ~x10)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = (~x04 & (x09 | ~x16)) | (x09 & (new_n44_ | x12)) | (~new_n50_ & ~x16);
  assign new_n50_ = (new_n52_ | ~x12) & (~new_n51_ | x11 | x12 | x09 | x10);
  assign new_n51_ = x06 & x07 & x08;
  assign new_n52_ = x06 & x07 & x08 & ~x10 & ~x11;
  assign z09 = (~x04 & (x09 | ~x16)) | (x09 & (new_n44_ | x13)) | (~new_n54_ & ~x16);
  assign new_n54_ = (~x13 | (new_n51_ & ~x10 & ~x11 & ~x12)) & (~new_n55_ | x12 | x13 | x10 | x11);
  assign new_n55_ = x08 & ~x09 & x06 & x07;
  assign z10 = x04 & (new_n57_ | (x09 & new_n44_ & x14));
