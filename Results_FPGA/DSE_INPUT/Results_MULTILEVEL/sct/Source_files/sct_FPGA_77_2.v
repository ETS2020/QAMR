...
module FAU ( 
  ...
  assign new_n46_ = (~x10 | ~x11 | (x06 & x07 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign z07 = ~new_n48_ | (~new_n37_ & (new_n40_ | ~x04));
  assign new_n48_ = (~x11 | (x06 & x07 & x08 & ~x09 & ~x10)) & (~x06 | ~x07 | ~x08 | x09 | x10 | x11);
  assign z08 = ((~x10 | x11) & (new_n40_ | ~x04)) | (~new_n50_ & ~x10) | (x11 & x12);
  assign new_n50_ = (~x12 | (x06 & x07 & x08 & ~x09)) & (~x06 | ~x07 | ~x08 | x09 | x11 | x12);
  assign z09 = ((new_n40_ | ~x04) & (~x10 | x11)) | (x11 & x13) | (~new_n52_ & ~x10);
  assign new_n52_ = (new_n54_ | ~x13) & (~new_n53_ | x12 | x13 | x09 | x11);
