// Benchmark "FAU" written by ABC on Sat Aug  8 21:54:15 2020
...
module FAU ( 
  ...
  assign z01 = (~x04 & ((x05 & ~x13) | ~x18)) | (~x05 & (~x18 | (~x13 & x15)));
  ...
  assign z09 = ((new_n40_ | ~x04) & (~x13 | ~x18)) | new_n54_ | (x13 & ~new_n52_ & ~x18);
