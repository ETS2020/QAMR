...
module FAU ( 
  ...
  assign z06 = (~x04 & (x07 | (~x10 & x16))) | (~new_n46_ & x16) | (~new_n47_ & x07);
  assign new_n46_ = x02 & ~x03 & (x07 | ~x10);
  assign new_n47_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~x04 & (x07 | (~x11 & x16))) | (~new_n49_ & x16) | (~new_n50_ & x07);
  assign new_n49_ = x02 & ~x03 & (x07 | ~x11);
  assign new_n50_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (~x04 & (x07 | (~x12 & x16))) | (~new_n52_ & x16) | (~new_n53_ & x07);
  assign new_n52_ = x02 & ~x03 & (x07 | ~x12);
  assign new_n53_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = (~x04 & (x07 | (~x13 & x16))) | (~new_n57_ & x16) | (~new_n55_ & x07);
  assign new_n55_ = (~x13 | (new_n56_ & ~x10 & ~x11 & ~x12)) & (~new_n56_ | x12 | x13 | x10 | x11);
  assign new_n56_ = x06 & x08 & ~x09;
  assign new_n57_ = x02 & ~x03 & (x07 | ~x13);
  assign z10 = x04 & ((new_n59_ & x06) | (x14 & ~new_n41_ & x16));
  assign new_n59_ = x07 & x08 & ~x09 & ~new_n60_ & (new_n41_ | ~x16);
