...
module FAU ( 
  ...
  assign z05 = (~x04 & (x07 | (x03 & ~x09))) | (x03 & (x16 | (~x07 & x09))) | (~new_n43_ & x07);
  assign new_n43_ = (~x09 | (x06 & x08)) & ~new_n44_ & (~x06 | ~x08 | x09);
  assign new_n44_ = ~x02 & x16;
  assign z06 = (~x04 & (x07 | (x03 & ~x10))) | (x03 & (x16 | (~x07 & x10))) | (~new_n46_ & x07);
  assign new_n46_ = (~x10 | (x06 & x08 & ~x09)) & ~new_n44_ & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~x04 & (x07 | (x03 & ~x11))) | (x03 & (x16 | (~x07 & x11))) | (~new_n48_ & x07);
  assign new_n48_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & ~new_n44_ & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (~x04 & (x07 | (x03 & ~x12))) | (x03 & (x16 | (~x07 & x12))) | (~new_n50_ & x07);
  assign new_n50_ = (new_n52_ | ~x12) & ~new_n44_ & (~new_n51_ | x10 | x11 | x12);
  assign new_n51_ = x06 & x08 & ~x09;
  assign new_n52_ = x06 & x08 & ~x09 & ~x10 & ~x11;
  assign z09 = (~x04 & (x07 | (x03 & ~x13))) | (x03 & (x16 | (~x07 & x13))) | (~new_n54_ & x07);
  assign new_n54_ = (~x13 | (new_n51_ & ~x10 & ~x11 & ~x12)) & ~new_n44_ & (~new_n51_ | x10 | x11 | x12 | x13);
  assign z10 = x04 & ((new_n59_ & x03) | (x07 & (new_n56_ | (new_n59_ & ~x02))));
  assign new_n56_ = x06 & x08 & ~x09 & ~new_n57_ & ~new_n58_;
