// Benchmark "FAU" written by ABC on Sat Aug  8 21:55:22 2020
...
module FAU ( 
  ...
  assign z07 = ~new_n37_ & (new_n40_ | new_n49_ | new_n50_ | ~x04);
  assign new_n49_ = x11 & (~x06 | ~x07 | ~x08 | x09 | x10);
  assign new_n50_ = x06 & x07 & x08 & ~x09 & ~x10 & ~x11;
  assign z08 = new_n53_ | (~new_n50_ & x12) | (new_n45_ & new_n52_ & ~x12 & x13);
  assign new_n52_ = ~x10 & ~x11;
  assign new_n53_ = (x12 | x13) & (~x04 | ((~x02 | x03) & x16));
  assign z09 = new_n53_ | (x13 & (~new_n44_ | ~new_n55_));
  assign new_n55_ = ~x09 & ~x10 & ~x11 & ~x12;
  assign z10 = x04 & ~new_n37_ & (new_n58_ | (x00 & new_n57_ & x06));
