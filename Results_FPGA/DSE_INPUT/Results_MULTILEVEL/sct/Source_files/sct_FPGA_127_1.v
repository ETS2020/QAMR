...
module FAU ( 
  ...
  assign z04 = x04 & ~new_n39_ & (x07 ? (x06 ^ x08) : (x08 & ~x13));
  assign z05 = (~new_n43_ & (x07 | (~x09 & ~x13))) | (x07 & ((x09 & (~x06 | ~x08)) | (x06 & x08 & ~x09))) | (~x07 & x09 & ~x13);
  assign new_n43_ = ~new_n39_ & x04;
  assign z06 = (~new_n43_ & (x07 | (~x10 & ~x13))) | (~new_n45_ & x07) | (~x07 & x10 & ~x13);
  assign new_n45_ = (~x10 | (x06 & x08 & ~x09)) & (~x06 | ~x08 | x09 | x10);
  assign z07 = (~new_n43_ & (x07 | (~x11 & ~x13))) | (~new_n47_ & x07) | (~x07 & x11 & ~x13);
  assign new_n47_ = (~x11 | (x06 & x08 & ~x09 & ~x10)) & (~x06 | ~x08 | x09 | x10 | x11);
  assign z08 = (~new_n43_ & (x07 | (~x12 & ~x13))) | (~new_n49_ & x07) | (~x07 & x12 & ~x13);
  assign new_n49_ = (~x12 | (x06 & x08 & ~x09 & ~x10 & ~x11)) & (~x06 | ~x08 | x09 | x10 | x11 | x12);
  assign z09 = (~new_n51_ & x07) | (~new_n43_ & (x07 | ~x13));
  assign new_n51_ = (~x13 | (new_n52_ & ~x10 & ~x11 & ~x12)) & (~new_n52_ | x12 | x13 | x10 | x11);
  assign new_n52_ = x06 & x08 & ~x09;
  assign z10 = x04 & ((x07 & (new_n54_ | (new_n39_ & x14))) | (~x13 & new_n39_ & x14));
