...
module FAU ( 
  ...
  assign z06 = ~x04 | (~x09 & (new_n39_ | ~new_n45_));
  assign new_n45_ = (~x10 | (x06 & x07 & x08)) & (~x08 | x10 | ~x06 | ~x07);
  assign z07 = ~x04 | (~x09 & (new_n39_ | ~new_n47_));
  assign new_n47_ = (~x11 | (x08 & ~x10 & x06 & x07)) & (~x06 | ~x07 | ~x08 | x10 | x11);
  assign z08 = ~x04 | (~x09 & (new_n39_ | ~new_n49_));
  assign new_n49_ = (~x12 | (x06 & x07 & x08 & ~x10 & ~x11)) & (~x06 | ~x07 | ~x08 | x10 | x11 | x12);
  assign z09 = ~x04 | (~new_n51_ & ~x09);
  assign new_n51_ = ~new_n39_ & (~x13 | (new_n43_ & ~x10 & ~x11 & ~x12)) & (~new_n43_ | x12 | x13 | x10 | x11);
