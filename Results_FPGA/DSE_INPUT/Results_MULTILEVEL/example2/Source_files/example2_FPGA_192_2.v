...
module FAU ( 
  ...
  assign z58 = ~x01 & (new_n241_ | (~new_n238_ & x78));
  ...
  assign new_n241_ = ~x42 & ~x79 & (~x04 | (x40 & x77 & ~x78));
  assign z59 = ~x01 & (new_n244_ | (x04 & x77 & ~new_n243_ & x78));
  assign new_n243_ = ~x40 & (x42 | (new_n180_ & x43 & ~x74 & x80));
  assign new_n244_ = ~x79 & ((~x04 & (~x42 | x78)) | (x77 & (x78 | (x40 & ~x42))));
  assign z60 = ~x01 & (new_n247_ | new_n248_ | (x04 & new_n246_ & ~x42));
  assign new_n246_ = x77 & x78 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign new_n247_ = (x81 ^ x84) & ((~x77 & x78) | (~x42 & x77 & ~x78 & x79));
  assign new_n248_ = ~x79 & (x78 | (~x04 & ~x42));
  assign z61 = ~x01 & x79 & ~new_n250_ & x80;
  assign new_n250_ = ((x81 ^ x84) | ((x77 | ~x78) & (x42 | ~x77 | x78))) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((new_n252_ & x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign new_n252_ = x81 & (x77 ? ((~x04 & x78) | (~x42 & ~x78 & x84)) : (x78 & x84));
  assign z63 = ~x01 & x79 & ~new_n250_ & x82;
  assign z64 = ~new_n255_ & ~x01;
  assign new_n255_ = (~x79 | new_n250_ | ~x83) & (~x04 | x77 | ~x78 | x79);
  assign z65 = ~x01 & new_n257_ & x79;
  assign new_n257_ = x84 & (x77 ? ((~x04 & x78) | (~x42 & ~x78 & x81)) : (x78 & x81));
endmodule
