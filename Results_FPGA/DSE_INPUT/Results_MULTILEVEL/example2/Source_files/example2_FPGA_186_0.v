...
module FAU ( 
  ...
  assign new_n154_ = ~x01 & x40 & (x78 ? (~x77 | x79) : x38);
  assign z01 = ~x01 & ((x38 & (~x79 | (~x77 & ~x78))) | (x78 & (x77 | ~x79)));
  assign z02 = ~x01 & ~new_n157_ & x79;
  assign new_n157_ = (~x75 | x77 | ~x78) & (~x38 | ~x66 | ~x77 | x78);
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = ~x01 & (x78 ? (~x77 | x79) : x38);
  ...
  assign z20 = (x38 & (~x40 | x45)) | (x40 & x45 & x78);
  assign z21 = (x38 | x78) & (x40 ? x44 : x39);
  ...
  assign z23 = ~new_n182_ & (x38 | x78);
  assign new_n182_ = x00 & ~x01 & (x04 | ~x05 | x79);
  assign z24 = ~x01 & new_n184_ & ~x04;
  assign new_n184_ = x05 & ~x43 & ((x78 & (x77 | ~x79)) | (x38 & ~x79));
  ...
  assign z47 = ~x01 & ((x04 & new_n214_ & ~x77) | (x38 & new_n215_ & x77));
  assign new_n214_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n215_ = ~x78 & x79 & (~x81 ^ x84) & (x67 | x75);
  assign z48 = ~x01 & ((new_n217_ & x04) | (x38 & new_n218_ & x68));
  assign new_n217_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign new_n218_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((new_n220_ & x04) | (x38 & new_n218_ & x69));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n222_ & x04) | (x38 & new_n218_ & x70));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n224_ & x04) | (x38 & new_n218_ & x71));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n226_ & x04) | (x38 & new_n218_ & x72));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n228_ & x04) | (x38 & new_n218_ & x73));
  ...
  assign z56 = (~new_n234_ & (x38 | x78)) | (x79 & ~new_n235_ & (x78 ? ~x77 : x38)) | (x38 & ~x77 & ~x78);
  assign new_n234_ = x00 & ~x01;
  assign new_n235_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z57 = x00 & ~x01 & ~x02 & x03 & (x38 | x78);
  assign z58 = ~x01 & ((new_n241_ & x38) | (~new_n238_ & x78));
  ...
  assign new_n244_ = ~x79 & ((~x04 & (x38 | x78)) | (x77 & (x78 | (x38 & x40))));
  assign z60 = ~x01 & (new_n247_ | new_n248_ | (x04 & new_n246_ & ~x42));
  assign new_n246_ = x77 & x78 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign new_n247_ = (x81 ^ x84) & ((x38 & x77 & ~x78 & x79) | (~x77 & x78));
  assign new_n248_ = ~x79 & (x78 | (~x04 & x38));
  assign z61 = ~x01 & x79 & ~new_n250_ & x80;
  assign new_n250_ = ((x81 ^ x84) | ((x77 | ~x78) & (~x38 | ~x77 | x78))) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((new_n252_ & x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign new_n252_ = x81 & (x77 ? ((~x04 & x78) | (x38 & ~x78 & x84)) : (x78 & x84));
  ...
  assign new_n257_ = x84 & (x77 ? ((~x04 & x78) | (x38 & ~x78 & x81)) : (x78 & x81));
endmodule
