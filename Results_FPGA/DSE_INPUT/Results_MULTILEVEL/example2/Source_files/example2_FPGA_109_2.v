...
module FAU ( 
  ...
  assign z22 = ~x01 & x78 & (new_n180_ | (~new_n177_ & x04));
  assign new_n177_ = x79 & (x42 | ~x77 | (new_n178_ & new_n179_));
  ...
  assign z58 = ~x01 & ((~new_n238_ & x78) | (new_n241_ & ~x66));
  assign new_n238_ = (~x04 | ~x77 | ~x79 | (~new_n239_ & (~new_n179_ | ~new_n240_))) & (x79 | (x04 & x77));
  ...
  assign new_n246_ = x77 & x78 & (~new_n178_ | ~new_n179_);
  assign new_n247_ = (~x81 ^ ~x84) & ((~x77 & x78) | (~x66 & x77 & ~x78 & x79));
  assign new_n248_ = ~x79 & (x78 | (~x04 & ~x66));
  assign z61 = ~x01 & x79 & ~new_n250_ & x80;
  assign new_n250_ = ((x81 ^ x84) | ((x77 | ~x78) & (x66 | ~x77 | x78))) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((new_n252_ & x79) | (x04 & ~new_n177_ & x78));
