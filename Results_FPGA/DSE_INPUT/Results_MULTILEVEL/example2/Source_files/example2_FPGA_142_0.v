...
module FAU ( 
  ...
  assign z49 = ~x01 & ((new_n220_ & x04) | (x68 & new_n218_ & x69));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((new_n222_ & x04) | (x68 & new_n218_ & x70));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((new_n224_ & x04) | (x68 & new_n218_ & x71));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n226_ & x04) | (x68 & new_n218_ & x72));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n228_ & x04) | (x68 & new_n218_ & x73));
  ...
  assign z58 = ~x01 & ((new_n241_ & x68) | (~new_n238_ & x78));
  ...
  assign new_n247_ = (x81 ^ x84) & ((x68 & x77 & ~x78 & x79) | (~x77 & x78));
