...
module FAU ( 
  ...
  assign z48 = ~x01 & (new_n218_ | (new_n220_ & x68));
  assign new_n218_ = x04 & x08 & ~x16 & new_n219_ & ~x52 & ~x77;
  assign new_n219_ = x78 & ~x79;
  assign new_n220_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign z49 = ~x01 & ((x04 & new_n222_ & ~x16) | (new_n220_ & x69));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((x04 & new_n224_ & ~x16) | (new_n220_ & x70));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((x04 & new_n226_ & ~x16) | (new_n220_ & x71));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((x04 & new_n228_ & ~x16) | (new_n220_ & x72));
  assign new_n228_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((x04 & new_n230_ & ~x16) | (new_n220_ & x73));
  assign new_n230_ = ~x77 & x78 & ~x79 & (x52 ? x21 : x13);
  assign z54 = ~x01 & x04 & new_n232_ & ~x16;
  assign new_n232_ = ~x77 & x78 & ~x79 & (x52 ? x22 : x14);
  assign z55 = x84 & x83 & ~x82 & ~x81 & new_n234_ & ~x80;
  assign new_n234_ = x79 & x78 & x77 & ~x16 & ~x01 & ~x04;
  assign z56 = (~new_n236_ & (~x16 | ~x78)) | (~x77 & ~x78) | (x79 & ~new_n237_ & (~x78 | (~x16 & ~x77)));
  assign new_n236_ = x00 & ~x01;
  assign new_n237_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z57 = x00 & ~x01 & ~x02 & x03 & (~x16 | ~x78);
  assign z58 = ~x01 & (new_n243_ | (~x16 & (x77 ? ~new_n240_ : new_n219_)));
  ...
  assign new_n249_ = (x81 ^ x84) & ((x77 & ~x78 & x79) | (~x16 & ~x77 & x78));
  ...
  assign z62 = ~x01 & ((new_n254_ & x79) | (x04 & new_n179_ & ~x16));
  ...
  assign new_n257_ = x04 & ~x16 & new_n219_ & ~x77;
