...
module FAU ( 
  ...
  assign new_n154_ = ~x01 & x40 & (x78 ? (~x77 | x79) : x71);
  assign z01 = ~x01 & ((x71 & (~x79 | (~x77 & ~x78))) | (x78 & (x77 | ~x79)));
  assign z02 = ~x01 & ~new_n157_ & x79;
  assign new_n157_ = (~x75 | x77 | ~x78) & (~x66 | ~x71 | ~x77 | x78);
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = ~x01 & (x78 ? (~x77 | x79) : x71);
  ...
  assign z23 = ~new_n182_ & (x71 | x78);
  assign new_n182_ = x00 & ~x01 & (x04 | ~x05 | x79);
  assign z24 = ~x01 & new_n184_ & ~x04;
  assign new_n184_ = x05 & ~x43 & ((x78 & (x77 | ~x79)) | (x71 & ~x79));
  ...
  assign z51 = ~x01 & (new_n217_ | (new_n225_ & x04));
  assign new_n225_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((new_n227_ & x04) | (x71 & new_n218_ & x72));
  assign new_n227_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n229_ & x04) | (x71 & new_n218_ & x73));
  ...
  assign z56 = (~new_n235_ & (x71 | x78)) | (x79 & ~new_n236_ & (x78 ? ~x77 : x71)) | (x71 & ~x77 & ~x78);
  assign new_n235_ = x00 & ~x01;
  assign new_n236_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z57 = x00 & ~x01 & ~x02 & x03 & (x71 | x78);
  assign z58 = ~x01 & ((new_n242_ & x71) | (~new_n239_ & x78));
  ...
  assign new_n245_ = ~x79 & ((~x04 & (x71 | x78)) | (x77 & (x78 | (x40 & x71))));
  assign z60 = ~x01 & (new_n248_ | new_n249_ | (x04 & new_n247_ & ~x42));
  assign new_n247_ = x77 & x78 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign new_n248_ = (x81 ^ x84) & ((x71 & x77 & ~x78 & x79) | (~x77 & x78));
  assign new_n249_ = ~x79 & (x78 | (~x04 & x71));
  assign z61 = ~x01 & x79 & ~new_n251_ & x80;
  assign new_n251_ = ((~x81 ^ ~x84) | ((x77 | ~x78) & (~x71 | ~x77 | x78))) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((new_n253_ & x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign new_n253_ = x81 & (x77 ? ((~x04 & x78) | (x71 & ~x78 & x84)) : (x78 & x84));
  ...
  assign new_n258_ = x84 & (x77 ? ((~x04 & x78) | (x71 & ~x78 & x81)) : (x78 & x81));
endmodule
