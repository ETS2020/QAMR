...
module FAU ( 
  ...
  assign new_n154_ = ~x01 & x40 & (x78 ? (~x77 | x79) : ~x03);
  assign z01 = ~x01 & ((~x03 & (~x79 | (~x77 & ~x78))) | (x78 & (x77 | ~x79)));
  assign z02 = ~x01 & ~new_n157_ & x79;
  assign new_n157_ = (~x75 | x77 | ~x78) & (x03 | ~x66 | ~x77 | x78);
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = ~x01 & (x78 ? (~x77 | x79) : ~x03);
  ...
  assign z23 = ~new_n182_ & (~x03 | x78);
  assign new_n182_ = x00 & ~x01 & (x04 | ~x05 | x79);
  assign z24 = ~x01 & new_n184_ & ~x04;
  assign new_n184_ = x05 & ~x43 & ((x78 & (x77 | ~x79)) | (~x03 & ~x79));
  ...
  assign z47 = ~x01 & ((x04 & new_n214_ & ~x77) | (~x03 & new_n215_ & x77));
  assign new_n214_ = x78 & ~x79 & (x52 ? x15 : x07);
  assign new_n215_ = ~x78 & x79 & (~x81 ^ x84) & (x67 | x75);
  assign z48 = ~x01 & ((~x03 & new_n217_ & x68) | (new_n218_ & x04));
  assign new_n217_ = x77 & ~x78 & x79 & (~x81 ^ x84);
  assign new_n218_ = ~x77 & x78 & ~x79 & (x52 ? x16 : x08);
  assign z49 = ~x01 & ((~x03 & new_n217_ & x69) | (new_n220_ & x04));
  assign new_n220_ = ~x77 & x78 & ~x79 & (x52 ? x17 : x09);
  assign z50 = ~x01 & ((~x03 & new_n217_ & x70) | (new_n222_ & x04));
  assign new_n222_ = ~x77 & x78 & ~x79 & (x52 ? x18 : x10);
  assign z51 = ~x01 & ((~x03 & new_n217_ & x71) | (new_n224_ & x04));
  assign new_n224_ = ~x77 & x78 & ~x79 & (x52 ? x19 : x11);
  assign z52 = ~x01 & ((~x03 & new_n217_ & x72) | (new_n226_ & x04));
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((~x03 & new_n217_ & x73) | (new_n228_ & x04));
  ...
  assign z56 = (~new_n234_ & (~x03 | x78)) | (x79 & ~new_n235_ & (x78 ? ~x77 : ~x03)) | (~x03 & ~x77 & ~x78);
  assign new_n234_ = x00 & ~x01;
  assign new_n235_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z57 = x78 & x03 & new_n234_ & ~x02;
  ...
  assign new_n240_ = (x03 | (x04 & (~x40 | x42 | ~x77 | x78))) & (~x78 | (x04 & x77));
  assign z59 = ~x01 & (new_n243_ | (x04 & x77 & ~new_n242_ & x78));
  assign new_n242_ = ~x40 & (x42 | (new_n180_ & x43 & ~x74 & x80));
  assign new_n243_ = ~x79 & ((~x03 & (~x04 | (x40 & x77))) | (x78 & (~x04 | x77)));
  assign z60 = ~x01 & (new_n246_ | new_n247_ | (x04 & new_n245_ & ~x42));
  assign new_n245_ = x77 & x78 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign new_n246_ = (x81 ^ x84) & ((~x77 & x78) | (~x03 & x77 & ~x78 & x79));
  assign new_n247_ = ~x79 & (x78 | (~x03 & ~x04));
  assign z61 = ~x01 & x79 & ~new_n249_ & x80;
  assign new_n249_ = (x04 | ~x77 | ~x78) & ((x81 ^ x84) | ((x77 | ~x78) & (x03 | ~x77 | x78)));
  assign z62 = ~x01 & ((new_n251_ & x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign new_n251_ = x81 & (x77 ? ((~x04 & x78) | (~x03 & ~x78 & x84)) : (x78 & x84));
  ...
  assign new_n256_ = x84 & (x77 ? ((~x04 & x78) | (~x03 & ~x78 & x81)) : (x78 & x81));
endmodule
