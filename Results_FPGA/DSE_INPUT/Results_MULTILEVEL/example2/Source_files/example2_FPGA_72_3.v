// Benchmark "FAU" written by ABC on Thu Aug  6 18:11:48 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n177_, new_n178_, new_n179_, new_n180_, new_n181_,
    ...
    new_n254_, new_n256_;
  assign z00 = ((~x01 | ~x78) & (x40 ? x52 : x06)) | (~x01 & ~new_n154_ & x40);
  ...
  assign z56 = (x79 & ~new_n234_ & (~x78 | (~x01 & ~x77))) | (~x00 & ~x01) | (~x78 & (x01 | ~x77));
  ...
  assign new_n243_ = x78 & (~x79 | (x04 & ~x42 & (~new_n180_ | ~new_n181_)));
  assign new_n244_ = x40 & (~x79 | (x04 & x78));
  assign z60 = ~x01 & (new_n247_ | (new_n246_ & x04) | (~x79 & (~x04 | x78)));
  assign new_n246_ = ~x42 & x77 & x78 & (~new_n180_ | ~new_n181_);
