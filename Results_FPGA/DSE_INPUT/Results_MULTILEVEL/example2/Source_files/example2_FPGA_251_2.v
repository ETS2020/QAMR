...
module FAU ( 
  ...
  assign z00 = new_n154_ | ((~x72 | x78) & (x40 ? x52 : x06));
  assign new_n154_ = ~x01 & x40 & (x78 ? (~x77 | x79) : ~x72);
  assign z01 = ~x01 & ((~x72 & (~x79 | (~x77 & ~x78))) | (x78 & (x77 | ~x79)));
  assign z02 = ~x01 & ~new_n157_ & x79;
  assign new_n157_ = (~x75 | x77 | ~x78) & (~x66 | x72 | ~x77 | x78);
  assign z03 = ~x79 & x78 & ~x01 & x52;
  assign z04 = ~x01 & (x78 ? (~x77 | x79) : ~x72);
  assign z05 = (~x72 | x78) & (x40 ? x65 : x23);
  assign z06 = (~x72 | x78) & (x40 ? x64 : x24);
  assign z07 = (~x72 | x78) & (x40 ? x63 : x25);
  assign z08 = (~x72 | x78) & (x40 ? x62 : x26);
  assign z09 = (~x72 | x78) & (x40 ? x61 : x27);
  assign z10 = (~x72 | x78) & (x40 ? x60 : x28);
  assign z11 = (~x72 | x78) & (x40 ? x59 : x29);
  assign z12 = (~x72 | x78) & (x40 ? x58 : x30);
  assign z13 = (~x72 | x78) & (x40 ? x57 : x31);
  assign z14 = (~x72 | x78) & (x40 ? x51 : x32);
  assign z15 = (~x72 | x78) & (x40 ? x50 : x33);
  assign z16 = (~x72 | x78) & (x40 ? x49 : x34);
  assign z17 = (~x72 | x78) & (x40 ? x48 : x35);
  assign z18 = (~x72 | x78) & (x40 ? x47 : x36);
  assign z19 = (~x72 | x78) & (x40 ? x46 : x37);
  assign z20 = (~x72 | x78) & (x40 ? x45 : x38);
  assign z21 = (~x72 | x78) & (x40 ? x44 : x39);
  ...
  assign z23 = ~new_n182_ & (~x72 | x78);
  assign new_n182_ = x00 & ~x01 & (x04 | ~x05 | x79);
  assign z24 = ~x01 & new_n184_ & ~x04;
  assign new_n184_ = x05 & ~x43 & ((x78 & (x77 | ~x79)) | (~x72 & ~x79));
  ...
  assign z47 = ~x01 & ((x04 & new_n214_ & ~x77) | (~x72 & new_n215_ & x77));
  ...
  assign new_n218_ = ~x72 & x77 & ~x78 & x79 & (~x81 ^ x84);
  ...
  assign z52 = ~x01 & new_n226_ & x04;
  assign new_n226_ = ~x77 & x78 & ~x79 & (x52 ? x20 : x12);
  assign z53 = ~x01 & ((new_n228_ & x04) | (new_n229_ & ~x72));
  ...
  assign z56 = (~new_n235_ & (~x72 | x78)) | (x79 & ~new_n236_ & (x78 ? ~x77 : ~x72)) | (~x72 & ~x77 & ~x78);
  assign new_n235_ = x00 & ~x01;
  assign new_n236_ = ~x76 & (~x81 | x84) & (x81 | ~x84);
  assign z57 = x00 & ~x01 & ~x02 & x03 & (~x72 | x78);
  assign z58 = ~x01 & ((~new_n239_ & x78) | (new_n242_ & ~x72));
  assign new_n239_ = (~x04 | ~x77 | ~x79 | (~new_n240_ & (~new_n180_ | ~new_n241_))) & (x79 | (x04 & x77));
  assign new_n240_ = ~x40 & x42;
  assign new_n241_ = ~x42 & x43 & ~x74 & x80;
  assign new_n242_ = ~x79 & (~x04 | (x40 & ~x42 & x77 & ~x78));
  assign z59 = ~x01 & (new_n245_ | (x04 & x77 & ~new_n244_ & x78));
  assign new_n244_ = ~x40 & (x42 | (new_n180_ & x43 & ~x74 & x80));
  assign new_n245_ = ~x79 & ((~x04 & (~x72 | x78)) | (x77 & (x78 | (x40 & ~x72))));
  assign z60 = ~x01 & (new_n248_ | new_n249_ | (x04 & new_n247_ & ~x42));
  assign new_n247_ = x77 & x78 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign new_n248_ = (~x81 ^ ~x84) & ((~x77 & x78) | (~x72 & x77 & ~x78 & x79));
  assign new_n249_ = ~x79 & (x78 | (~x04 & ~x72));
  assign z61 = ~x01 & x79 & ~new_n251_ & x80;
  assign new_n251_ = ((x81 ^ x84) | ((x77 | ~x78) & (x72 | ~x77 | x78))) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((new_n253_ & x79) | (x04 & x78 & (new_n179_ | ~x79)));
  assign new_n253_ = x81 & (x77 ? ((~x04 & x78) | (~x72 & ~x78 & x84)) : (x78 & x84));
  assign z63 = ~x01 & x79 & ~new_n251_ & x82;
  assign z64 = ~new_n256_ & ~x01;
  assign new_n256_ = (~x04 | x77 | ~x78 | x79) & (~x79 | new_n251_ | ~x83);
  assign z65 = ~x01 & new_n258_ & x79;
  assign new_n258_ = x84 & (x77 ? ((~x04 & x78) | (~x72 & ~x78 & x81)) : (x78 & x81));
endmodule
