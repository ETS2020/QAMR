...
module FAU ( 
  ...
  assign z18 = (x40 & x47 & (~x36 | x78)) | (x36 & ~x40 & x78);
  assign z19 = (~x36 & (x40 ? x46 : x37)) | (x78 & ((x40 & x46) | (x36 & x37 & ~x40)));
  assign z20 = (x40 ? x45 : x38) & (~x36 | x78);
  assign z21 = (x40 ? x44 : x39) & (~x36 | x78);
  ...
  assign new_n247_ = (x81 ^ x84) & ((~x77 & x78) | (~x36 & x77 & ~x78 & x79));
