...
module FAU ( 
  ...
  assign new_n247_ = (x81 ^ x84) & ((~x77 & x78) | (x77 & ~x78 & x79 & ~x80));
  assign new_n248_ = ~x79 & (x78 | (~x04 & ~x80));
  assign z61 = ~x01 & new_n250_ & x78;
  assign new_n250_ = x79 & x80 & (x77 ? ~x04 : (x81 ^ ~x84));
  assign z62 = ~x01 & (new_n254_ | (x77 & (new_n253_ | (new_n252_ & x04))));
  assign new_n252_ = ~x42 & x78 & (~new_n180_ | ~x43 | x74 | ~x80);
  assign new_n253_ = x79 & x81 & (x78 ? ~x04 : (~x80 & x84));
  assign new_n254_ = x78 & ((x04 & ~x79) | (~x77 & x79 & x81 & x84));
  assign z63 = ~x01 & x79 & ~new_n256_ & x82;
  assign new_n256_ = ((~x81 ^ ~x84) | (x77 ? (x78 | x80) : ~x78)) & (x04 | ~x77 | ~x78);
  assign z64 = ~new_n258_ & ~x01;
  assign new_n258_ = (~x04 | x77 | ~x78 | x79) & (~x79 | new_n256_ | ~x83);
  assign z65 = ~x01 & new_n260_ & x79;
  assign new_n260_ = x84 & (x77 ? (x78 ? ~x04 : (~x80 & x81)) : (x78 & x81));
endmodule
