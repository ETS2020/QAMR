...
module FAU ( 
  ...
  assign new_n247_ = (x81 ^ x84) & ((~x77 & x78) | (x79 & ~x83 & x77 & ~x78));
  assign new_n248_ = ~x79 & (x78 | (~x04 & ~x83));
  assign z61 = ~x01 & x79 & ~new_n250_ & x80;
  assign new_n250_ = ((~x81 ^ ~x84) | (x77 ? (x78 | x83) : ~x78)) & (x04 | ~x77 | ~x78);
  assign z62 = ~x01 & ((x04 & x78 & (new_n179_ | ~x79)) | (new_n252_ & x79));
  assign new_n252_ = x81 & (x77 ? (x78 ? ~x04 : (~x83 & x84)) : (x78 & x84));
  ...
  assign new_n257_ = x84 & (x77 ? (x78 ? ~x04 : (x81 & ~x83)) : (x78 & x81));
endmodule
