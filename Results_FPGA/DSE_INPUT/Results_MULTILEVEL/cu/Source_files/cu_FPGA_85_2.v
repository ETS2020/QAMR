// Benchmark "FAU" written by ABC on Thu Aug  6 17:16:17 2020
...
module FAU ( 
  ...
  assign new_n36_ = (x07 | (x02 ? (x05 | x13) : (~x05 | x12 | new_n37_ | ~x13))) & (~x12 | x13 | ~x02 | x05);
  assign new_n37_ = x00 ? (x01 ? x11 : x09) : (x01 ? x10 : x08);
  assign z08 = new_n39_ & ~x03;
  assign new_n39_ = x04 & ((x02 & ~x05 & ~x13 & (~x07 | x12)) | (~x02 & x05 & ~x07 & ~x12 & x13));
