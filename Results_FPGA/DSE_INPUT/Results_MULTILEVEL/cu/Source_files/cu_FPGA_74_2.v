...
module FAU ( 
  ...
  assign z00 = (x07 & (x03 | (x02 & (~x04 | x05)))) | (~x02 & (x03 | x04 | ~x05));
  ...
  assign new_n42_ = x04 & ((x07 & ~x13 & x02 & ~x05) | (~x02 & x05 & ~x12 & x13));
  assign z09 = x06 & x13 & (~x02 | x07);
  assign z10 = ~x03 & x06 & (~x02 | (~x05 & x07));
endmodule
