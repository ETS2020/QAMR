// Benchmark "FAU" written by ABC on Thu Aug  6 17:17:15 2020
...
module FAU ( 
  ...
  assign z00 = (~x06 | x12) & ((x02 & (~x04 | x05)) | x03 | (~x02 & (x04 | ~x05)));
  assign z01 = ~x03 & (~x06 | x12) & (x02 ? (x04 & ~x05) : (~x04 & x05));
  assign z02 = ~x00 & z07 & ~x01;
  assign z07 = new_n31_ & ~x02;
  assign new_n31_ = ~x03 & ~x04 & x05 & ~x13 & (~x06 | x12);
  assign z03 = x00 & z07 & ~x01;
  assign z04 = ~x00 & z07 & x01;
  assign z05 = x00 & z07 & x01;
  assign z06 = ~x03 & x04 & (new_n38_ | (~new_n36_ & ~x06));
  ...
  assign new_n40_ = x04 & ((x02 & ~x05 & ~x13 & (~x06 | x12)) | (~x02 & x05 & ~x06 & ~x12 & x13));
  assign z09 = x13 & x06 & x12;
  assign z10 = ~x03 & x06 & x12 & (~x02 | ~x05);
endmodule
