// Benchmark "FAU" written by ABC on Thu Aug  6 17:16:06 2020
...
module FAU ( 
  ...
  assign z00 = (x06 | x07) & ((x02 & (~x04 | x05)) | x03 | (~x02 & (x04 | ~x05)));
  ...
  assign new_n40_ = (x06 | x07) & ((x02 & ~x05 & ~x13) | (~x02 & x05 & ~x12 & x13));
  assign z09 = x06 & x13;
