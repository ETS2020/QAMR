// Benchmark "FAU" written by ABC on Thu Aug  6 17:17:09 2020
...
module FAU ( 
  ...
  assign z06 = ~x03 & x04 & (new_n38_ | (~new_n36_ & x11));
  assign new_n36_ = x02 ? (x05 | x13) : (~x05 | x07 | x12 | new_n37_ | ~x13);
  assign new_n37_ = x00 ? (x01 | x09) : (x01 ? x10 : x08);
  assign new_n38_ = x12 & ~x13 & x02 & ~x05;
  assign z08 = new_n40_ & ~x03;
  assign new_n40_ = x04 & ((x02 & ~x05 & ~x13 & (x11 | x12)) | (~x02 & x05 & x11 & ~x12 & x13));
