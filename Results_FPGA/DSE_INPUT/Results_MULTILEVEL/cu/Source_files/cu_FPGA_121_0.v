// Benchmark "FAU" written by ABC on Thu Aug  6 17:16:32 2020
...
module FAU ( 
  ...
  assign z00 = x03 | (x07 & (x02 ? (~x04 | x05) : (x04 | ~x05)));
  assign z01 = ~x03 & x07 & (x02 ? (x04 & ~x05) : (~x04 & x05));
  ...
  assign z06 = ~x13 & x07 & ~x05 & x04 & x02 & ~x03;
  assign z07 = ~x13 & x07 & x05 & ~x04 & ~x02 & ~x03;
  assign z08 = new_n40_ & ~x03;
  assign new_n40_ = x04 & x07 & ((~x02 & x05 & ~x12 & x13) | (x02 & ~x05 & ~x13));
  assign z09 = x06 & x13 & (x03 | x07);
  assign z10 = ~x03 & x06 & x07 & (~x02 | ~x05);
endmodule
