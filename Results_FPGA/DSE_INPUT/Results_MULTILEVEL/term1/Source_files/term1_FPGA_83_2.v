...
module FAU ( 
  ...
  assign z0 = ~x32 & (~x21 | x31);
  assign z1 = (~x21 | x31) & (x02 ? (x03 ? ~x33 : ~x32) : (x03 ? ~x32 : ~x33));
  assign z2 = x08 & new_n49_ & ~x09;
  assign new_n49_ = (~x21 | x31) & ((~new_n50_ & (~x04 ^ x07)) | (~new_n51_ & (~x04 ^ ~x07)));
  ...
  assign new_n54_ = (x16 | x21) & ((x21 & ~x31) | (new_n55_ & new_n56_));
  ...
  assign z7 = ~new_n63_ | ((~x21 | x31) & (~new_n66_ | (new_n64_ & x16)));
  assign new_n63_ = (~x31 | ((~new_n64_ | ~x21) & new_n65_ & x29 & x30)) & (~new_n65_ | x21 | ~x29 | ~x30 | x31);
  assign new_n64_ = (x19 | x24) & new_n55_ & (x18 | x23);
  assign new_n65_ = x27 & x28;
  assign new_n66_ = x25 & ~x26 & x01 & (~x02 | ~x03);
  assign z8 = x00 & ~x26 & ((~new_n68_ & x31) | (~x21 & ~x31 & x32));
  ...
  assign new_n79_ = (new_n72_ | (x21 & ~x31)) & (x21 | x31 | (~x30 & (new_n77_ | ~x29))) & (~x31 | (~new_n77_ & x29 & x30));
  assign new_n80_ = (x21 | x30 | x31 | (~new_n77_ & x29)) & (~x29 | ~x30 | new_n77_ | ~x31);
endmodule
