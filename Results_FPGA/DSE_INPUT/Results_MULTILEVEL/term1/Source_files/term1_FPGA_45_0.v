...
module FAU ( 
  ...
  assign z7 = (~new_n62_ & (x08 | x31)) | (x31 & (~new_n65_ | ~x29 | ~x30)) | (new_n65_ & x08 & x29 & x30 & ~x31);
  ...
  assign z8 = x00 & ~x26 & ((x08 & ~x31 & x32) | (~new_n67_ & x31));
  ...
  assign new_n78_ = (new_n71_ | (~x08 & ~x31)) & (~x08 | x31 | (~x30 & (new_n76_ | ~x29))) & (~x31 | (~new_n76_ & x29 & x30));
  assign new_n79_ = (~x08 | x30 | x31 | (~new_n76_ & x29)) & (~x29 | ~x30 | new_n76_ | ~x31);
endmodule
