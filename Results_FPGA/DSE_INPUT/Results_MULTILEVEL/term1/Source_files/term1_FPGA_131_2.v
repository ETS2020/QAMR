...
module FAU ( 
  ...
  assign new_n54_ = (x17 | x22) & ((x22 & ~x32) | (new_n55_ & new_n56_));
  ...
  assign new_n66_ = (x18 | x23) & new_n55_ & (x22 ? x32 : x17);
  assign z8 = x00 & ~x26 & (new_n73_ | new_n75_ | (new_n68_ & x29));
  assign new_n68_ = ~new_n72_ & ((x30 & x32) | (~x22 & ~x30 & x31 & ~new_n69_ & ~x32));
