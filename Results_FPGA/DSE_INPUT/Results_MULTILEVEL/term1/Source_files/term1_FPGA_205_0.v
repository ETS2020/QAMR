...
module FAU ( 
  ...
  assign z7 = (~new_n65_ & (x23 | x31)) | new_n63_ | ~new_n66_;
  assign new_n63_ = (x19 | x24) & ~new_n64_ & new_n55_ & (x17 | x22);
  assign new_n64_ = ~x23 & (~x18 | ~x31);
  assign new_n65_ = x01 & (~x02 | ~x03) & x25 & ~x26;
  assign new_n66_ = (~x31 | (x27 & x28 & x29 & x30)) & (~x29 | ~x30 | x31 | ~x23 | ~x27 | ~x28);
  assign z8 = x00 & ~x26 & ((x23 & ~x31 & x32) | (~new_n68_ & x31));
