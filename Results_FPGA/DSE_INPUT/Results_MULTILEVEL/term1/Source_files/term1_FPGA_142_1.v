...
module FAU ( 
  ...
  assign z0 = ~x32 & (x18 | ~x31);
  assign z1 = (x18 | ~x31) & (x02 ? (x03 ? ~x33 : ~x32) : (x03 ? ~x32 : ~x33));
  assign z2 = x08 & new_n49_ & ~x09;
  assign new_n49_ = (x18 | ~x31) & ((~new_n50_ & (~x04 ^ x07)) | (~new_n51_ & (x04 ^ x07)));
  ...
  assign new_n54_ = ((~x18 & x31) | (new_n55_ & new_n56_)) & (x18 | x23 | x31);
  ...
  assign z7 = (~new_n64_ & (x18 | ~x31)) | (x18 & (new_n63_ | (~new_n65_ & x31))) | (~x31 & (new_n65_ | (new_n63_ & x23)));
  assign new_n63_ = (x19 | x24) & new_n55_ & (x17 | x22);
  assign new_n64_ = x01 & (~x02 | ~x03) & x25 & ~x26;
  assign new_n65_ = x29 & x30 & x27 & x28;
  assign z8 = x00 & ~x26 & ((~x31 & x32) | (~new_n67_ & x18));
  ...
  assign new_n69_ = (~x16 | ((~x12 | x17 | ~x19) & (~x14 | ~x17 | x19))) & (~x11 | x16 | ~x17 | ~x19);
  assign new_n70_ = x16 & x17 & x19;
  assign new_n71_ = (~x15 | ~x16 | ~x17 | (x14 & ~x19)) & new_n72_ & (x19 | (x15 & x16 & x17));
  assign new_n72_ = (x15 | (x10 & x16 & x17)) & (x16 | (x11 & x17)) & (x12 | x17);
  assign new_n73_ = ~x27 & ~x28;
  assign z9 = x00 & ~x26 & (x33 ? ~new_n75_ : ~new_n81_);
  assign new_n75_ = (new_n76_ | (~x18 & x31)) & (new_n78_ | x31) & (~x18 | (~new_n80_ & (new_n77_ | ~x31)));
  assign new_n76_ = new_n72_ & (x19 | (x15 & x16 & x17));
  assign new_n77_ = ~new_n73_ & x29 & x30;
  assign new_n78_ = ~new_n79_ & ~x30 & (x18 | (new_n70_ & x13 & x15));
  assign new_n79_ = x29 & (x27 | x28);
  assign new_n80_ = x15 & x16 & x17 & (~x14 | x19);
  assign new_n81_ = (x30 | ~new_n82_ | x31) & (~x18 | ~x29 | ~x30 | ~new_n86_ | ~x31);
  assign new_n82_ = ~new_n79_ & (new_n85_ | (x15 & (new_n84_ | (~new_n83_ & x16))));
  assign new_n83_ = (~x17 | ((~x13 | x18 | ~x19) & (~x14 | ~x18 | x19))) & (~x12 | x17 | ~x18 | ~x19);
  assign new_n84_ = x17 & x18 & x19 & x11 & ~x16;
  assign new_n85_ = x17 & x18 & x19 & x10 & ~x15 & x16;
  assign new_n86_ = ~new_n73_ & ((~new_n69_ & x15) | (new_n70_ & x10 & ~x15));
endmodule
