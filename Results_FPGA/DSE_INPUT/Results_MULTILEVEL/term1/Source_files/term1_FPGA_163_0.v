...
module FAU ( 
  ...
  assign z7 = (~new_n65_ & (x18 | x31)) | new_n63_ | ~new_n66_;
  assign new_n63_ = (x19 | x24) & ~new_n64_ & new_n55_ & (x17 | x22);
  assign new_n64_ = ~x18 & (~x23 | ~x31);
  assign new_n65_ = x01 & (~x02 | ~x03) & x25 & ~x26;
  assign new_n66_ = (~x31 | (x27 & x28 & x29 & x30)) & (~x29 | ~x30 | x31 | ~x18 | ~x27 | ~x28);
  assign z8 = x00 & ~x26 & (new_n74_ | new_n76_ | (new_n68_ & x29));
  assign new_n68_ = ~new_n73_ & (x30 ? (x32 & (x18 | x31)) : (x31 & ~new_n69_ & ~x32));
  ...
  assign new_n74_ = ~new_n75_ & (x30 ? (x31 & ~new_n69_ & ~x32) : (x32 & (x18 | x31)));
  assign new_n75_ = ~new_n73_ & x29;
  assign new_n76_ = x32 & (x18 ? (~new_n77_ | new_n79_) : (~new_n80_ & x31));
  assign new_n77_ = (x19 | (x15 & x16 & x17)) & new_n78_ & (x15 | (x10 & x16 & x17));
  assign new_n78_ = (x16 | (x11 & x17)) & x31 & (x12 | x17);
  assign new_n79_ = x15 & x16 & x17 & (~x14 | x19);
  assign new_n80_ = x13 & x15 & x16 & x17 & x19;
  assign z9 = x00 & ~x26 & (x33 ? ~new_n82_ : ~new_n87_);
  assign new_n82_ = (new_n83_ | (~x18 & ~x31)) & (new_n85_ | ~x18) & (~x31 | (new_n86_ & (new_n80_ | x18)));
  assign new_n83_ = (x19 | (x15 & x16 & x17)) & new_n84_ & (x15 | (x10 & x16 & x17));
  assign new_n84_ = (x12 | x17) & (x16 | (x11 & x17));
  assign new_n85_ = ~new_n79_ & (x31 | (~x30 & (new_n73_ | ~x29)));
  assign new_n86_ = ~new_n73_ & x29 & x30;
  assign new_n87_ = (~x29 | ~x30 | ~new_n88_ | ~x31) & (~x18 | x30 | ~new_n89_ | x31);
  ...
  assign new_n91_ = x10 & ~x15 & x16 & x17 & x19;
endmodule
