...
module FAU ( 
  ...
  assign new_n54_ = (x17 | x22) & ((x22 & ~x31) | (new_n55_ & new_n56_));
  ...
  assign z7 = ~new_n63_ | ((~x22 | x31) & (~new_n66_ | (new_n64_ & x17)));
  assign new_n63_ = (~x31 | ((~new_n64_ | ~x22) & new_n65_ & x29 & x30)) & (~new_n65_ | x22 | ~x29 | ~x30 | x31);
  assign new_n64_ = (x19 | x24) & new_n55_ & (x18 | x23);
  assign new_n65_ = x27 & x28;
  assign new_n66_ = x25 & ~x26 & x01 & (~x02 | ~x03);
  assign z8 = x00 & ~x26 & ((~new_n68_ & x31) | (~x22 & ~x31 & x32));
