// Benchmark "FAU" written by ABC on Sat Aug  8 22:32:32 2020
...
module FAU ( 
  ...
  assign z0 = ~x32 & (~x06 | ~x31);
  assign z1 = (~x06 | ~x31) & (x02 ? (x03 ? ~x33 : ~x32) : (x03 ? ~x32 : ~x33));
  assign z2 = x08 & ~x09 & ((~new_n49_ & (~x04 ^ x07)) | (~new_n50_ & (x04 ^ x07)));
  assign new_n49_ = x01 ? ((x06 & x31) | (x02 ^ x03)) : ((x31 | (x02 ? (x03 | ~x05) : (~x06 | (~x03 & x05)))) & (x03 | ~x05 | x06));
  assign new_n50_ = (x01 | (((~x03 & x05) | (x06 & (~x02 | x31))) & (x02 | x03 | ~x05 | ~x06 | x31))) & (~x01 | (x02 ? (x03 | (x06 & x31)) : (~x03 | x31))) & (x02 | ~x03 | x06);
  assign z3 = x01 & x25 & ~x26 & new_n52_ & ~x27;
  assign new_n52_ = (~x06 | ~x31) & ~new_n53_ & (~x02 | ~x03);
  assign new_n53_ = new_n54_ & (x15 | x20) & (x16 | x21);
  assign new_n54_ = (x17 | x22) & (x18 | x23) & (x19 | x24);
  assign z4 = x01 & x25 & ~x26 & new_n52_ & (~x27 ^ ~x28);
  assign z5 = x01 & x25 & ~x26 & new_n57_ & (~x06 | ~x31);
  assign new_n57_ = (~x02 | ~x03) & ~new_n53_ & ((x27 & x28 & ~x29) | (x29 & (~x27 | ~x28)));
  assign z6 = x01 & x25 & ~x26 & new_n59_ & (~x06 | ~x31);
  assign new_n59_ = (~x02 | ~x03) & ~new_n53_ & ~new_n60_;
  assign new_n60_ = x29 ? (((x27 & x28) | ~x30) & (~x27 | ~x28 | x30)) : ~x30;
  assign z7 = (~new_n62_ & (~x06 | ~x31)) | (~x06 & x31 & (~new_n65_ | ~x29 | ~x30)) | (new_n65_ & x29 & x30 & ~x31);
  ...
  assign z8 = x00 & ~x26 & (new_n79_ | (~x06 & (new_n67_ | ~new_n72_)));
  ...
  assign new_n81_ = (new_n74_ | (x06 & x31)) & (x31 | (~x30 & (new_n71_ | ~x29))) & (x06 | ~x31 | (~new_n71_ & x29 & x30));
  assign new_n82_ = (x06 | ~x29 | ~x30 | new_n71_ | ~x31) & (x30 | x31 | (~new_n71_ & x29));
endmodule
