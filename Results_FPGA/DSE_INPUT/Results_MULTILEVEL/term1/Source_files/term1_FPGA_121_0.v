...
module FAU ( 
  ...
  assign z7 = (~new_n64_ & (x24 | x31)) | ~new_n65_ | (new_n63_ & (x24 | (x19 & x31)));
  assign new_n63_ = (x18 | x23) & new_n55_ & (x17 | x22);
  assign new_n64_ = x01 & (~x02 | ~x03) & x25 & ~x26;
  assign new_n65_ = (~x31 | (x27 & x28 & x29 & x30)) & (~x29 | ~x30 | x31 | ~x24 | ~x27 | ~x28);
  assign z8 = x00 & ~x26 & ((x24 & ~x31 & x32) | (~new_n67_ & x31));
  ...
  assign new_n75_ = (x16 | (x11 & x17 & x18)) & (x17 | (x12 & x18)) & (x13 | x18);
  assign new_n76_ = ~x27 & ~x28;
  assign z9 = x00 & ~x26 & (x33 ? ~new_n78_ : (~new_n68_ & ~new_n79_));
  assign new_n78_ = (new_n71_ | (~x24 & ~x31)) & (~x24 | x31 | (~x30 & (new_n76_ | ~x29))) & (~x31 | (~new_n76_ & x29 & x30));
  assign new_n79_ = (~x24 | x30 | x31 | (~new_n76_ & x29)) & (~x29 | ~x30 | new_n76_ | ~x31);
endmodule
