// Benchmark "FAU" written by ABC on Sat Aug  8 22:32:38 2020
...
module FAU ( 
  ...
  assign new_n54_ = (x18 | x23) & ((x23 & ~x31) | (new_n55_ & new_n56_));
  ...
  assign z7 = ~new_n63_ | ((~x23 | x31) & (~new_n66_ | (new_n64_ & x18)));
  assign new_n63_ = (~x31 | ((~new_n64_ | ~x23) & new_n65_ & x29 & x30)) & (~new_n65_ | x23 | ~x29 | ~x30 | x31);
  assign new_n64_ = (x19 | x24) & new_n55_ & (x17 | x22);
  assign new_n65_ = x27 & x28;
  assign new_n66_ = x25 & ~x26 & x01 & (~x02 | ~x03);
  assign z8 = x00 & ~x26 & ((~new_n68_ & x31) | (~x23 & ~x31 & x32));
  ...
  assign new_n79_ = (new_n72_ | (x23 & ~x31)) & (x23 | x31 | (~x30 & (new_n77_ | ~x29))) & (~x31 | (~new_n77_ & x29 & x30));
  assign new_n80_ = (x23 | x30 | x31 | (~new_n77_ & x29)) & (~x29 | ~x30 | new_n77_ | ~x31);
endmodule
