...
module FAU ( 
  ...
  assign new_n52_ = ~new_n53_ & ~new_n56_;
  ...
  assign new_n59_ = ~new_n56_ & ~new_n53_ & ((x29 & (~x27 | ~x28)) | (x27 & x28 & ~x29));
  assign z6 = x01 & x25 & ~x26 & new_n61_ & ~new_n56_;
  assign new_n61_ = ~new_n53_ & (x29 ? ((x30 & (~x27 | ~x28)) | (x27 & x28 & ~x30)) : x30);
  assign z7 = ~new_n65_ | (~new_n63_ & (x01 | x31));
  assign new_n63_ = (~new_n64_ | (~x19 & ~x24)) & ~new_n56_ & x25 & ~x26;
  assign new_n64_ = (x18 | x23) & new_n54_ & (x17 | x22);
  assign new_n65_ = (~x31 | (x01 & x27 & x28 & x29 & x30)) & (~x01 | ~x27 | ~x28 | ~x29 | ~x30 | x31);
  assign z8 = x00 & ~x26 & ((x01 & ~x31 & x32) | (~new_n67_ & x31));
  ...
  assign new_n78_ = (new_n71_ | (~x01 & ~x31)) & (~x01 | x31 | (~x30 & (new_n76_ | ~x29))) & (~x31 | (~new_n76_ & x29 & x30));
  assign new_n79_ = (~x01 | x30 | x31 | (~new_n76_ & x29)) & (~x29 | ~x30 | new_n76_ | ~x31);
endmodule
