...
module FAU ( 
  ...
  assign z0 = ~x32 & (~x09 | x31);
  assign z1 = (~x09 | x31) & (x02 ? (x03 ? ~x33 : ~x32) : (x03 ? ~x32 : ~x33));
  ...
  assign z8 = x00 & ~x26 & ((~new_n67_ & x31) | (~x09 & ~x31 & x32));
  ...
  assign new_n78_ = (new_n71_ | (x09 & ~x31)) & (x09 | x31 | (~x30 & (new_n76_ | ~x29))) & (~x31 | (~new_n76_ & x29 & x30));
  assign new_n79_ = (x09 | x30 | x31 | (~new_n76_ & x29)) & (~x29 | ~x30 | new_n76_ | ~x31);
endmodule
