...
module FAU ( 
  ...
  assign new_n49_ = x01 ? ((~x06 & x31) | (x02 ^ x03)) : ((~x06 | (~x02 ^ (x03 | ~x05))) & (x03 | ~x05 | x06 | x31));
  assign new_n50_ = x01 ? ((~x06 & x31) | (~x02 ^ x03)) : (((~x03 & x05) | (x06 ? ~x02 : x31)) & (x02 | x03 | ~x05 | ~x06));
  ...
  assign z8 = x00 & ~x26 & (new_n79_ | ((new_n67_ | ~new_n72_) & x06));
