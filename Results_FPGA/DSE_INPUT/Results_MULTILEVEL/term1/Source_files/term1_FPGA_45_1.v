...
module FAU ( 
  ...
  assign z8 = x00 & ~x26 & (new_n79_ | ((new_n67_ | ~new_n72_) & x08));
  ...
  assign new_n81_ = (new_n74_ | (~x08 & x31)) & (x31 | (~x30 & (new_n71_ | ~x29))) & (~x08 | ~x31 | (~new_n71_ & x29 & x30));
  assign new_n82_ = (~x08 | ~x29 | ~x30 | new_n71_ | ~x31) & (x30 | x31 | (~new_n71_ & x29));
endmodule
