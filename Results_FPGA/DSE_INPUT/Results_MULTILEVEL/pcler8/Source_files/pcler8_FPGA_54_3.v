...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n47_, new_n57_, new_n59_, new_n61_, new_n63_;
  ...
  assign new_n59_ = x09 & ~x10 & (x19 ? (~x22 & (x20 ^ x21)) : x21);
  assign z12 = (x03 & ~new_n47_ & x08) | (new_n61_ & ~x08);
  assign new_n61_ = x09 & ~x10 & ((~x19 & x22) | (x19 & x20 & x21 & ~x22));
  assign z13 = (x04 & ~new_n47_ & x08) | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ~x10 & x23 & (~x22 | (~x19 & x22));
