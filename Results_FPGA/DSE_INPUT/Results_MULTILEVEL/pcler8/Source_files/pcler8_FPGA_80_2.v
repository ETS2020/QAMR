...
module FAU ( 
  ...
  assign new_n65_ = ~x10 & ((x20 & (x19 ? (new_n66_ | ~x21) : x21)) | (~x07 & ~x20 & x21));
  ...
  assign new_n71_ = ~new_n72_ & (~x07 | x20);
  assign new_n72_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n73_ = (x07 | x20 | ~x23) & (~x20 | ((~x19 | ~x21 | (~new_n74_ & x23)) & (~x23 | (x19 & x21))));
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n76_ & ~x10);
  assign new_n76_ = (x07 | x20 | ~x24) & (~x20 | ((~new_n77_ | ~new_n79_) & (~x24 | (new_n77_ & new_n78_))));
  assign new_n77_ = x19 & x21;
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = (new_n61_ & x06) | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (x07 | x20 | ~x25) & (~x20 | ((~new_n82_ | ~new_n84_) & (~x25 | (new_n82_ & new_n83_))));
