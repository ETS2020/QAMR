...
module FAU ( 
  ...
  assign z04 = x03 & x08;
  assign z05 = x04 & x08 & (x19 | (x03 & ~x19));
  ...
  assign z12 = (x03 & (x08 | (new_n70_ & x09 & ~x10))) | (~x08 & x09 & new_n68_ & ~x10);
  assign new_n68_ = x19 & ((x22 & (~x20 | new_n69_ | ~x21)) | (x20 & x21 & ~x22));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign new_n70_ = ~x19 & x22;
  assign z13 = new_n72_ | (~x08 & x09 & ~x10 & ~new_n74_ & x22);
  assign new_n72_ = ~new_n73_ & (x03 | x19);
  assign new_n73_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n74_ = (~x19 | ((~x20 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x20 & x21)))) & (~x03 | x19 | ~x23);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = new_n77_ | (x19 & (x08 ? x05 : (new_n79_ & x09)));
  assign new_n77_ = ~new_n78_ & x03;
  assign new_n78_ = (~x05 | ~x08) & (x08 | ~x09 | x10 | x19 | ~x24);
  assign new_n79_ = ~x10 & ((x24 & (~new_n58_ | ~x22 | new_n80_ | ~x23)) | (new_n58_ & x22 & x23 & ~x24));
