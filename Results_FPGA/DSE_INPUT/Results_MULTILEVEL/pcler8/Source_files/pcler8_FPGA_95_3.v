// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:24 2020
...
module FAU ( 
  ...
  assign z09 = (~x08 & x09 & ~x10 & (new_n57_ | ~x19)) | (x00 & x08 & ~x19);
  assign new_n57_ = new_n58_ & x11 & x20 & x21 & x22;
  assign new_n58_ = x23 & x24 & x25 & x26;
  assign z10 = (x01 & x08 & ~x19) | (~x08 & x09 & ~new_n60_ & ~x10);
  assign new_n60_ = x19 ? (x20 & (~new_n58_ | ~x12 | ~x21 | ~x22)) : ~x20;
  assign z11 = (~new_n64_ & ~x19) | (~x08 & x09 & ~x10 & ~new_n62_ & x19);
  assign new_n62_ = x20 ? (~new_n63_ & x21) : ~x21;
  assign new_n63_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign new_n64_ = (~x02 | ~x08) & (x08 | ~x09 | x10 | ~x21);
  assign z12 = (~x19 & ((x03 & x08) | (new_n68_ & ~x08 & x09))) | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x22 & (~x20 | new_n67_ | ~x21)) | (x19 & x20 & x21 & ~x22));
  assign new_n67_ = x14 & x23 & x24 & x25 & x26;
  assign new_n68_ = ~x10 & x22;
  assign z13 = (x04 & x08 & ~x19) | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n71_ & x23)) & (~x23 | (x19 & x20 & x21))) : ~x23;
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = new_n76_ | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x24 | (new_n74_ & x22 & ~new_n75_ & x23)) & (~new_n74_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n74_ = x20 & x21;
  assign new_n75_ = x16 & x25 & x26;
  assign new_n76_ = ~x19 & ((x05 & x08) | (~x08 & x09 & ~x10 & x24));
  assign z15 = new_n82_ | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x25 | (new_n79_ & new_n80_)) & (~new_n81_ | ~new_n74_ | ~x19);
  assign new_n79_ = x20 & x21 & x22;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign new_n81_ = x22 & x23 & x24 & ~x25;
  assign new_n82_ = ~x19 & ((x06 & x08) | (~x08 & x09 & ~x10 & x25));
  assign z16 = (~x19 & ((x07 & x08) | (new_n89_ & ~x08 & x09))) | (~x08 & new_n84_ & x09);
