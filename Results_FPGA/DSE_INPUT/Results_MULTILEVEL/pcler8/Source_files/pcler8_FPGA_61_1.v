...
module FAU ( 
  ...
  assign new_n62_ = ~x10 & ((x20 & (~x19 | (new_n63_ & new_n64_))) | (x19 & ~x20 & ~x26));
  assign new_n63_ = x12 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & (x20 ? (x19 ? (new_n67_ | ~x21) : x21) : (x21 & ~x26));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = x20 ? ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x21 | x22)) : (~x22 | x26);
  ...
  assign new_n74_ = x20 ? ((~x19 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x19 & x21))) : (~x23 | x26);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = x20 ? ((~x24 | (new_n78_ & new_n79_)) & (~new_n78_ | ~new_n80_)) : (~x24 | x26);
  assign new_n78_ = x19 & x21;
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = x20 ? ((~x25 | (new_n83_ & new_n84_)) & (~new_n83_ | ~new_n85_)) : (~x25 | x26);
