...
module FAU ( 
  ...
  assign new_n73_ = (x15 | (x22 ? ((~x23 | (x20 & x21)) & (~x19 | ~x20 | ~x21 | x23)) : ~x23)) & (x19 | ~x23);
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (x19 | ~x24) & (x15 | (((new_n60_ & new_n76_) | ~x24) & (~new_n77_ | ~new_n60_ | ~x19)));
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n77_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n79_ | new_n84_));
  assign new_n79_ = ~x15 & ((new_n80_ & new_n83_) | (x25 & (~new_n81_ | ~new_n82_)));
  ...
  assign new_n86_ = ~x15 & (((~new_n87_ | ~new_n88_) & x26) | (new_n89_ & new_n90_));
