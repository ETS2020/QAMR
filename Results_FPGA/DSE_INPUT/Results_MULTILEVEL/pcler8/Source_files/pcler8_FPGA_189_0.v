...
module FAU ( 
  ...
  assign new_n77_ = (~x20 | ((~x24 | (new_n78_ & new_n79_)) & (~new_n78_ | ~new_n80_))) & (~x18 | x20 | ~x24);
  assign new_n78_ = x19 & x21;
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (~x20 | ((~x25 | (new_n83_ & new_n84_)) & (~new_n83_ | ~new_n85_))) & (~x18 | x20 | ~x25);
  ...
  assign new_n87_ = x20 & ((x26 & (~new_n83_ | ~x23 | ~x24 | ~x25)) | (new_n83_ & x25 & ~x26 & x23 & x24));
  assign new_n88_ = x18 & x26;
endmodule
