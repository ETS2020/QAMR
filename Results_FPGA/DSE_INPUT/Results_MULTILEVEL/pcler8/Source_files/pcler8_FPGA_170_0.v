...
module FAU ( 
  ...
  assign z04 = x03 & x08 & (x20 | (x04 & (~x19 | ~x20)));
  assign z05 = x04 & x08;
  ...
  assign new_n62_ = ~x10 & ((x20 & (~x19 | (new_n63_ & new_n64_))) | (x04 & x19 & ~x20));
  ...
  assign new_n69_ = (~x20 | ((~x19 | ~x21 | x22) & (~x22 | (x19 & ~new_n70_ & x21)))) & (~x04 | x20 | ~x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08) | (x09 & ~x10 & (new_n72_ | (new_n74_ & ~x08)));
  assign new_n72_ = x23 & ((x04 & (~x22 | (~x08 & ~x20 & x22))) | (~x08 & x20 & (~x22 | (~new_n73_ & x22))));
  assign new_n73_ = x19 & x21;
  assign new_n74_ = x19 & x20 & new_n75_ & x21;
  assign new_n75_ = x22 & (~x23 | (x25 & x26 & x15 & x24));
