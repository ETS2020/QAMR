...
module FAU ( 
  ...
  assign z09 = (~new_n61_ & (x11 | ~x20)) | (new_n59_ & new_n48_ & ~x10 & x11 & x20);
  ...
  assign new_n63_ = x09 & ~x10 & ((x11 & x20 & (new_n64_ | ~x19)) | (x19 & ~x20));
  assign new_n64_ = new_n65_ & x12 & x25 & x26 & x23 & x24;
  assign new_n65_ = x21 & x22;
  assign z11 = z03 | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((~x20 & x21) | (x11 & x20 & (x19 ? (new_n68_ | ~x21) : x21)));
  assign new_n68_ = new_n60_ & x13 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (x20 | ~x22) & (~x11 | ((~x22 | (x19 & ~new_n71_ & x21)) & (~x21 | x22 | ~x19 | ~x20)));
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (new_n73_ & ~x08);
  assign new_n73_ = x09 & ~x10 & ((~x20 & x23) | (~new_n74_ & x11));
  ...
  assign new_n77_ = (x20 | ~x24) & (~x11 | (~new_n80_ & (~x24 | (new_n78_ & new_n79_))));
  ...
  assign new_n82_ = ~x10 & ((~x20 & x25) | (x11 & (new_n84_ | (~new_n83_ & x25))));
  assign new_n83_ = new_n65_ & x19 & x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x19 & x20 & x21 & new_n60_ & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n86_ | new_n89_));
  assign new_n86_ = x11 & (new_n87_ | (new_n88_ & new_n65_ & x19 & x20));
  assign new_n87_ = x26 & (~new_n60_ | ~x24 | ~x25 | ~new_n78_ | x18);
