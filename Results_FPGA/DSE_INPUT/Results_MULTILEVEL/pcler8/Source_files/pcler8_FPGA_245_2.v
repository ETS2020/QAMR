...
module FAU ( 
  ...
  assign new_n66_ = ~x10 & ((x19 & (x20 ? (new_n67_ | ~x21) : x21)) | (~x17 & ~x19 & x21));
  ...
  assign new_n72_ = ~new_n73_ & (~x17 | x19);
  assign new_n73_ = (~x04 | ~x08) & (x10 | x22 | ~x23 | x08 | ~x09);
  assign new_n74_ = (x17 | x19 | ~x23) & (~x19 | ((~x20 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x20 & x21))));
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x17 | x19 | ~x24) & (~x19 | ((~x24 | (new_n59_ & new_n78_)) & (~new_n59_ | ~new_n79_)));
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (x17 | x19 | ~x25) & (~x19 | ((~x25 | (new_n82_ & new_n83_)) & (~new_n82_ | ~new_n84_)));
