// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:01 2020
...
module FAU ( 
  ...
  assign new_n62_ = ~x10 & ((x20 & (~x19 | (new_n63_ & new_n64_))) | (x19 & ~x20 & ~x24));
  assign new_n63_ = x12 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & (x20 ? (x19 ? (new_n67_ | ~x21) : x21) : (x21 & ~x24));
  ...
  assign new_n72_ = ~new_n49_ & ~new_n73_;
  assign new_n73_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n74_ = x20 ? ((~x19 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x19 & x21))) : (~x23 | x24);
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~x10 & ~new_n77_ & x20);
  assign new_n77_ = (~x24 | (x19 & x21 & x22 & ~new_n78_ & x23)) & (~x19 | ~x21 | ~x22 | ~x23 | x24);
  assign new_n78_ = x16 & x25 & x26;
  assign z15 = z07 | (~x08 & x09 & ~new_n80_ & ~x10);
  assign new_n80_ = (x24 | ~x25) & (~x20 | ((new_n81_ | ~x25) & (~new_n82_ | ~x23 | ~x24 | x25)));
  assign new_n81_ = x19 & x21 & x22 & x23 & (~x17 | ~x26);
  assign new_n82_ = x19 & x21 & x22;
  assign z16 = z08 | (~x08 & x09 & ~new_n84_ & ~x10);
  assign new_n84_ = (x24 | ~x26) & (~x20 | ((new_n85_ | ~x26) & (~new_n82_ | ~new_n86_)));
