...
module FAU ( 
  ...
  assign new_n62_ = x09 & ~x10 & (x20 ? (x26 & (new_n63_ | ~x19)) : x19);
  assign new_n63_ = x12 & x21 & x22 & x23 & x24 & x25;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x20 ? (x26 & (x19 ? (new_n66_ | ~x21) : x21)) : x21);
  ...
  assign new_n71_ = x26 & (x22 ? ((new_n72_ & x19) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n72_ = x20 & x21 & (~x23 | (x15 & x24 & x25));
  assign new_n73_ = ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (~x24 | (x20 & (new_n77_ | ~x26))) & (~new_n78_ | ~new_n76_ | x24 | ~x26);
  assign new_n76_ = x22 & x23;
  assign new_n77_ = x19 & x21 & x22 & x23 & (~x16 | ~x25);
  ...
  assign new_n85_ = ~x10 & x26 & (~new_n86_ | ~new_n76_ | ~x24 | ~x25);
