...
module FAU ( 
  ...
  assign new_n59_ = x09 & ~x10 & (x20 ? (~x26 & (x19 ^ x21)) : x21);
  ...
  assign new_n63_ = (~x23 | (x20 & (x26 | (x22 & (~x22 | (x19 & x21)))))) & (~x22 | x23 | x26 | ~x19 | ~x20 | ~x21);
  assign z14 = z06 | (~x08 & x09 & ~new_n65_ & ~x10);
  assign new_n65_ = (~x24 | (x20 & (x26 | (new_n66_ & x19 & x21)))) & (~x19 | ~x20 | ~x21 | ~new_n66_ | x24 | x26);
  assign new_n66_ = x22 & x23;
  assign z15 = z07 | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((new_n70_ & new_n71_) | (x25 & (new_n69_ | ~x20)));
  assign new_n69_ = ~x26 & (~x19 | ~x21 | ~x22 | ~x23 | ~x24);
  assign new_n70_ = x19 & x20 & x21 & x22;
  assign new_n71_ = x23 & x24 & ~x25 & ~x26;
  assign z16 = z08 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (x20 | ~x26) & (~new_n70_ | ~x23 | ~x24 | ~x25 | x26);
  assign z00 = 1'b0;
endmodule
