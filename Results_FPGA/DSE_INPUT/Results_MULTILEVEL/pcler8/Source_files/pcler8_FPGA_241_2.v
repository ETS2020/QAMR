...
module FAU ( 
  ...
  assign new_n61_ = x09 & ~x10 & (x19 ? (x23 & (new_n62_ | ~x20)) : x20);
  assign new_n62_ = x12 & x21 & x22 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & (x19 ? (x23 & (x20 ? (new_n65_ | ~x21) : x21)) : x21);
  assign new_n65_ = x13 & x22 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x22 | (x19 & (~x23 | (x20 & ~new_n68_ & x21)))) & (~x19 | ~x20 | ~x21 | x22 | ~x23);
  assign new_n68_ = x14 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~x10 & ~new_n70_ & x23);
  assign new_n70_ = (new_n71_ | ~x22) & x22 & (~x15 | ~x24 | ~x25 | ~x26);
  assign new_n71_ = x19 & x20 & x21;
  assign z14 = z06 | (~x08 & new_n73_ & x09);
  assign new_n73_ = ~x10 & ((x23 & (new_n75_ | (~new_n74_ & x24))) | (~x19 & x24));
  assign new_n74_ = x20 & x21 & x22 & (~x16 | ~x25 | ~x26);
  assign new_n75_ = x19 & x20 & x21 & x22 & ~x24;
  assign z15 = z07 | (~x08 & new_n77_ & x09);
  assign new_n77_ = ~x10 & ((x23 & (new_n79_ | (~new_n78_ & x25))) | (~x19 & x25));
  assign new_n78_ = x20 & x21 & x22 & x24 & (~x17 | ~x26);
  assign new_n79_ = x19 & x20 & x21 & x22 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (x19 | ~x26) & (~x23 | ((new_n82_ | ~x26) & (~new_n71_ | ~new_n83_)));
  assign new_n82_ = x22 & x24 & x25 & ~x18 & x20 & x21;
  assign new_n83_ = x22 & x24 & x25 & ~x26;
endmodule
