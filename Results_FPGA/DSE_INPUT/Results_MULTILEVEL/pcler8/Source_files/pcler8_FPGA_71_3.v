...
module FAU ( 
  ...
  assign z09 = ~new_n50_ & ((x00 & x08) | (~x08 & x09 & ~x10 & ~x19));
  assign z10 = z02 | (new_n60_ & ~x08);
  assign new_n60_ = x09 & ~x10 & ((~x11 & x20 & (new_n61_ | ~x19)) | (x19 & ~x20));
  assign new_n61_ = new_n62_ & x12 & x23 & x24 & x25 & x26;
  assign new_n62_ = x21 & x22;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & ((~x11 & x20 & (x19 ? (new_n65_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n65_ = new_n66_ & x13 & x24 & x25 & x26;
  assign new_n66_ = x22 & x23;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (x20 | ~x22) & (x11 | ((~x22 | (x19 & ~new_n69_ & x21)) & (~x21 | x22 | ~x19 | ~x20)));
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (new_n71_ & ~x08);
  assign new_n71_ = x09 & ~x10 & ((~x20 & x23) | (~new_n72_ & ~x11));
  assign new_n72_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n73_ & x23)) & (~x23 | (x19 & x21))) : ~x23;
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n75_ & ~x10);
  assign new_n75_ = (x20 | ~x24) & (x11 | (~new_n78_ & ((new_n76_ & new_n77_) | ~x24)));
  ...
  assign new_n80_ = ~x10 & ((~x20 & x25) | (~x11 & (new_n82_ | (~new_n81_ & x25))));
  assign new_n81_ = new_n62_ & x19 & x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = x19 & x20 & x21 & new_n66_ & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n84_ | new_n87_));
  assign new_n84_ = ~x11 & (new_n85_ | (new_n86_ & new_n62_ & x19 & x20));
  assign new_n85_ = x26 & (~new_n66_ | ~x24 | ~x25 | ~new_n76_ | x18);
  assign new_n86_ = x23 & x24 & x25 & ~x26;
  assign new_n87_ = ~x20 & x26;
endmodule
