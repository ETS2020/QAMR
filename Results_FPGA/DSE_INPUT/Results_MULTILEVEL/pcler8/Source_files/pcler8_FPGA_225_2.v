// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:56 2020
...
module FAU ( 
  ...
  assign new_n61_ = x09 & ~x10 & (x19 ? (x24 & (new_n62_ | ~x20)) : x20);
  assign new_n62_ = x12 & x21 & x22 & x23 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n64_ & x09);
  assign new_n64_ = ~x10 & (x19 ? (x24 & (x20 ? (new_n65_ | ~x21) : x21)) : x21);
  assign new_n65_ = x13 & x22 & x23 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n67_ & ~x10);
  assign new_n67_ = (~x22 | (x19 & (~x24 | (x20 & ~new_n68_ & x21)))) & (~x19 | ~x20 | ~x21 | x22 | ~x24);
  assign new_n68_ = x14 & x23 & x25 & x26;
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (x19 | ~x23) & (~x24 | (x22 ? ((~new_n71_ | ~x19) & (new_n72_ | ~x23)) : ~x23));
  assign new_n71_ = x20 & x21 & (~x23 | (x15 & x25 & x26));
  assign new_n72_ = x20 & x21;
  assign z14 = z06 | (~x08 & x09 & ~x10 & ~new_n74_ & x24);
  assign new_n74_ = new_n75_ & new_n72_ & x19;
  assign new_n75_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & new_n77_ & x09);
  assign new_n77_ = ~x10 & ((x24 & (new_n79_ | (~new_n78_ & x25))) | (~x19 & x25));
  assign new_n78_ = x20 & x21 & x22 & x23 & (~x17 | ~x26);
  assign new_n79_ = x19 & x20 & x21 & x22 & x23 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (x19 | ~x26) & (~x24 | ((new_n82_ | ~x26) & (~new_n83_ | ~new_n72_ | ~x19)));
  assign new_n82_ = x22 & x23 & x25 & ~x18 & x20 & x21;
