...
module FAU ( 
  ...
  assign new_n58_ = ~x10 & x20 & (~x19 | (new_n60_ & new_n59_ & x11));
  assign new_n59_ = x21 & x22;
  assign new_n60_ = x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & (x19 ? (~x20 | (new_n60_ & new_n59_ & x12)) : x20);
  assign z11 = z03 | (new_n64_ & ~x08);
  assign new_n64_ = x09 & ~x10 & ((x21 & (x19 ^ x20)) | (x19 & x20 & (new_n65_ | ~x21)));
  assign new_n65_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x20 & (x19 ? (x21 & ~x22) : x22)) | (x19 & x22 & (~x20 | new_n68_ | ~x21)));
  assign new_n68_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (~new_n49_ & ~new_n72_) | (~x08 & x09 & new_n70_ & ~x10);
  assign new_n70_ = x22 & (x19 ? ((x20 & x21 & (new_n71_ | ~x23)) | (x23 & (~x20 | ~x21))) : (x20 & x23));
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign new_n72_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign z14 = z06 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (~x20 | ((x19 | ~x24) & (~new_n75_ | ~x19 | ~x21))) & (~x19 | ~x24 | (new_n76_ & x20 & x21));
  assign new_n75_ = x22 & x23 & ~x24;
  assign new_n76_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x20 | ((~new_n79_ | ~new_n59_ | ~x19) & (x19 | ~x25))) & (~x19 | ~x25 | (new_n80_ & new_n59_ & x20));
  assign new_n79_ = x23 & x24 & ~x25;
  assign new_n80_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n82_ | new_n84_));
  assign new_n82_ = x20 & ((~x19 & x26) | (new_n83_ & new_n59_ & x19));
