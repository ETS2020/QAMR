...
module FAU ( 
  ...
  assign z01 = x00 & x08 & (x20 | x26);
  assign z02 = x01 & x08 & (x20 | x26);
  assign z03 = x02 & x08 & (x20 | x26);
  assign z04 = x03 & x08 & (x20 | x26);
  assign z05 = x04 & x08 & (x20 | x26);
  assign z06 = x05 & x08 & (x20 | x26);
  assign z07 = x06 & x08 & (x20 | x26);
  assign z08 = x07 & x08 & (x20 | x26);
  assign z09 = new_n57_ | (~new_n59_ & (x20 | x26));
  ...
  assign new_n61_ = ~x10 & ((x20 & (~x19 | (new_n62_ & new_n63_))) | (x19 & ~x20 & x26));
  assign new_n62_ = x12 & x21 & x22;
  assign new_n63_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & (x20 ? (x19 ? (new_n66_ | ~x21) : x21) : (x21 & x26));
  assign new_n66_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((x22 & (new_n69_ | (x20 & (~x19 | ~x21)))) | (x19 & x20 & x21 & ~x22));
  assign new_n69_ = x26 & (~x20 | (x14 & x23 & x24 & x25));
  assign z13 = new_n71_ | (~x08 & x09 & ~x10 & ~new_n73_ & x22);
  assign new_n71_ = ~new_n72_ & (x20 | x26);
  assign new_n72_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n73_ = x20 ? ((~x19 | ~x21 | (~new_n74_ & x23)) & (~x23 | (x19 & x21))) : (~x23 | ~x26);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (new_n76_ & ~x08);
  assign new_n76_ = x09 & ~x10 & (new_n79_ | (x24 & (new_n77_ | new_n78_)));
  assign new_n77_ = x26 & (~x20 | (x16 & x25));
  assign new_n78_ = x20 & (~x19 | ~x21 | ~x22 | ~x23);
  ...
  assign new_n83_ = x26 & (x17 | ~x20);
  assign new_n84_ = x20 & (~x22 | ~x23 | ~x24 | ~x19 | ~x21);
  assign new_n85_ = x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & new_n87_ & x09);
