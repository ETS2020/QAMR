...
module FAU ( 
  ...
  assign new_n59_ = x09 & ~x10 & (x19 ? (~x25 & (x20 ^ x21)) : x21);
  assign z12 = z04 | (~x08 & new_n61_ & x09);
  assign new_n61_ = ~x10 & ((x22 & (~x19 | (~x25 & (~x20 | ~x21)))) | (x19 & x20 & x21 & ~x22 & ~x25));
  assign z13 = z05 | (~x08 & new_n63_ & x09);
  assign new_n63_ = ~x10 & ((x23 & (~x19 | (~x25 & (~x22 | (~new_n64_ & x22))))) | (x22 & ~x23 & ~x25 & new_n64_ & x19));
  assign new_n64_ = x20 & x21;
  assign z14 = z06 | (~x08 & x09 & ~new_n66_ & ~x10);
  assign new_n66_ = (~x24 | (x19 & (x25 | (new_n64_ & x22 & x23)))) & (~new_n64_ | ~x19 | ~x22 | ~x23 | x24 | x25);
  assign z15 = z07 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (x19 | ~x25) & (~new_n64_ | ~x19 | ~x22 | ~x23 | ~x24 | x25);
