...
module FAU ( 
  ...
  assign z09 = new_n58_ | (new_n59_ & new_n60_ & x21 & new_n61_ & x24);
  ...
  assign new_n63_ = ~x10 & ((x20 & (~x19 | (new_n64_ & new_n65_))) | (x19 & ~x20 & x24));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & (x20 ? (x19 ? (new_n68_ | ~x21) : x21) : (x21 & x24));
  assign new_n68_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & new_n70_ & x09);
  assign new_n70_ = ~x10 & ((x22 & (new_n71_ | (x20 & (~x19 | ~x21)))) | (x19 & x20 & x21 & ~x22));
  assign new_n71_ = x24 & (~x20 | (x25 & x26 & x14 & x23));
  assign z13 = new_n73_ | (~x08 & x09 & ~x10 & ~new_n75_ & x22);
  assign new_n73_ = ~new_n49_ & ~new_n74_;
  assign new_n74_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n75_ = x20 ? ((~x19 | ~x21 | (~new_n76_ & x23)) & (~x23 | (x19 & x21))) : (~x23 | ~x24);
  assign new_n76_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (~x24 | (new_n79_ & x22 & x23 & (~new_n61_ | ~x16))) & (~new_n79_ | ~x22 | ~x23 | x24);
  assign new_n79_ = x19 & x20 & x21;
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (new_n82_ | ~x24) & (~x20 | ~x25 | (new_n83_ & new_n84_));
  assign new_n82_ = (x20 | ~x25) & (~x19 | ~x20 | ~x21 | ~x22 | ~x23 | x25);
  assign new_n83_ = x19 & x21 & x22;
  assign new_n84_ = x23 & x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n86_ | new_n87_));
  assign new_n86_ = x24 & ((~x20 & x26) | (new_n79_ & new_n60_ & x25 & ~x26));
