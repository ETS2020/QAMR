...
module FAU ( 
  ...
  assign new_n62_ = ~x10 & ((x20 & (~x19 | (new_n63_ & new_n64_))) | (x06 & x19 & ~x20));
  assign new_n63_ = x12 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x20 & (x19 ? (new_n67_ | ~x21) : x21)) | (x06 & ~x20 & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x20 | ((~x19 | ~x21 | x22) & (~x22 | (x19 & ~new_n70_ & x21)))) & (~x06 | x20 | ~x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n72_ | (~x08 & x09 & ~x10 & ~new_n74_ & x22);
  assign new_n72_ = ~new_n50_ & ~new_n73_;
  assign new_n73_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n74_ = (~x06 | x20 | ~x23) & (~x20 | ((~x19 | ~x21 | (~new_n75_ & x23)) & (~x23 | (x19 & x21))));
  assign new_n75_ = x15 & x24 & x25 & x26;
  assign z14 = (x05 & ~new_n50_ & x08) | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (~x20 | ((~x24 | (new_n78_ & new_n79_)) & (~new_n78_ | ~new_n80_))) & (~x06 | x20 | ~x24);
  assign new_n78_ = x19 & x21;
  assign new_n79_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n80_ = x22 & x23 & ~x24;
  assign z15 = new_n84_ | (~x08 & x09 & ~x10 & ~new_n82_ & x20);
  assign new_n82_ = (~x25 | (new_n83_ & x23 & x24 & (~x17 | ~x26))) & (~new_n83_ | ~x23 | ~x24 | x25);
  assign new_n83_ = x19 & x21 & x22;
  assign new_n84_ = x06 & (x08 | (~x20 & x25 & x09 & ~x10));
  assign z16 = new_n86_ | (x20 & (x08 ? x07 : (new_n88_ & x09)));
  assign new_n86_ = ~new_n87_ & x06;
  assign new_n87_ = (~x07 | ~x08) & (x08 | ~x09 | x10 | x20 | ~x26);
