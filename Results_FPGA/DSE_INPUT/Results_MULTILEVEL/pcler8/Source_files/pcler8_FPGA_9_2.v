...
module FAU ( 
  ...
  assign z09 = new_n58_ | (~new_n60_ & (~x21 | x25));
  ...
  assign new_n62_ = ~new_n63_ & (~new_n64_ | ~x21 | ~x22 | ~x12 | ~x19);
  assign new_n63_ = (~x21 | (x21 & x25)) & (x19 ^ x20);
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & (x19 ? (x20 ? (new_n67_ | ~x21) : (x21 & x25)) : (x21 & x25));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x22 | (x21 & (~x25 | (x19 & ~new_n70_ & x20)))) & (~x19 | ~x20 | ~x21 | x22 | ~x25);
  assign new_n70_ = x14 & x23 & x24 & x26;
  assign z13 = z05 | (~x08 & x09 & ~x10 & (new_n72_ | new_n74_));
  assign new_n72_ = x25 & (x22 ? ((x19 & new_n73_ & x20) | (x23 & (~x19 | ~x20))) : x23);
  assign new_n73_ = x21 & (~x23 | (x15 & x24 & x26));
  ...
  assign new_n83_ = (~x25 | ((~new_n79_ | ~new_n85_) & (new_n84_ | ~x26))) & (x21 | ~x26);
  assign new_n84_ = x22 & x23 & x24 & ~x18 & x19 & x20;
  assign new_n85_ = x22 & x23 & x24 & ~x26;
endmodule
