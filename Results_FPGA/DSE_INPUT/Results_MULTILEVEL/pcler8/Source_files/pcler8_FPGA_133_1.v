...
module FAU ( 
  ...
  assign new_n84_ = (x25 | ~x26) & (~x19 | ((new_n86_ | ~x26) & (~new_n82_ | ~new_n85_ | ~x25 | x26)));
  assign new_n85_ = x23 & x24;
  assign new_n86_ = x22 & x23 & x24 & ~x18 & x20 & x21;
endmodule
