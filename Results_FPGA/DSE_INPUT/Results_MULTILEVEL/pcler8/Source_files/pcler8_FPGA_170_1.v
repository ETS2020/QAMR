...
module FAU ( 
  ...
  assign z04 = x03 & x08 & (~x20 | (x04 & x20));
  assign z05 = x04 & x08;
  ...
  assign new_n63_ = ~x10 & ((x04 & x20 & ((new_n64_ & new_n65_) | ~x19)) | (x19 & ~x20));
  ...
  assign new_n74_ = ~x08 & x23 & (~x19 | ~x21);
  ...
  assign new_n83_ = x04 & ((new_n84_ & new_n87_) | (x25 & (~new_n85_ | ~new_n86_)));
  ...
  assign new_n90_ = x04 & ((new_n93_ & new_n94_) | ((~new_n91_ | ~new_n92_) & x26));
