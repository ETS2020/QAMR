...
module FAU ( 
  ...
  assign new_n65_ = new_n61_ & new_n66_ & x12 & x21 & x22;
  assign new_n66_ = x23 & x24;
  assign z11 = z03 | (~x08 & new_n68_ & x09);
  assign new_n68_ = ~x10 & ((~x17 & x19 & (x20 ? (new_n69_ | ~x21) : x21)) | (~x19 & x21));
  assign new_n69_ = new_n61_ & x24 & x13 & x22 & x23;
  assign z12 = z04 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (x17 | ((~x22 | (x20 & ~new_n72_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n72_ = x14 & x23 & new_n61_ & x24;
  assign z13 = z05 | (~x08 & x09 & ~new_n74_ & ~x10);
  assign new_n74_ = (x19 | ~x23) & (x17 | (x22 ? ((~new_n75_ | ~x19) & (new_n62_ | ~x23)) : ~x23));
  assign new_n75_ = x20 & x21 & (~x23 | (new_n61_ & x15 & x24));
  assign z14 = z06 | (new_n77_ & ~x08);
  assign new_n77_ = x09 & ~x10 & ((~x19 & x24) | (~new_n78_ & ~x17));
  assign new_n78_ = (~x24 | (new_n62_ & x22 & ~new_n79_ & x23)) & (~new_n62_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n79_ = x16 & x25 & x26;
  assign z15 = z07 | (new_n81_ & ~x08);
  assign new_n81_ = x09 & ~x10 & ((~x19 & x25) | (~new_n82_ & ~x17));
  assign new_n82_ = (~x25 | (new_n62_ & x22 & x23 & x24)) & (~new_n62_ | ~x19 | ~x22 | ~x23 | ~x24 | x25);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n84_ | new_n87_));
  assign new_n84_ = ~x17 & ((~new_n85_ & x26) | (new_n86_ & new_n66_ & x25 & ~x26));
  assign new_n85_ = new_n62_ & ~x18 & x22 & x23 & x24 & x25;
