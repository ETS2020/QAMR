...
module FAU ( 
  ...
  assign new_n59_ = new_n60_ & x09 & ~x10 & new_n62_ & x11;
  ...
  assign new_n74_ = (x19 | ~x23) & (~x00 | (x22 ? ((~new_n75_ | ~x19) & (new_n62_ | ~x23)) : ~x23));
  assign new_n75_ = x20 & x21 & (~x23 | (new_n61_ & x15 & x24));
  assign z14 = z06 | (new_n77_ & ~x08);
  assign new_n77_ = x09 & ~x10 & ((~x19 & x24) | (~new_n78_ & x00));
  ...
  assign new_n85_ = x00 & (new_n86_ | (x26 & (~new_n88_ | ~new_n62_ | x18)));
