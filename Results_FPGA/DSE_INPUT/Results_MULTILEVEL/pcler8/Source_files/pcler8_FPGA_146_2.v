...
module FAU ( 
  ...
  assign new_n77_ = (~x24 | ~x25 | (new_n78_ & x22 & ~new_n79_ & x23)) & (~new_n78_ | ~x22 | ~x23 | x24);
  assign new_n78_ = x19 & x20 & x21;
  assign new_n79_ = x16 & x26;
  assign z15 = z07 | (~x08 & x09 & new_n81_ & ~x10);
  assign new_n81_ = x25 & (~new_n78_ | ~new_n82_ | ~x24 | (x17 & x26));
  assign new_n82_ = x22 & x23;
  assign z16 = z08 | (~x08 & x09 & ~new_n84_ & ~x10);
  assign new_n84_ = (~x25 | ((new_n85_ | ~x26) & (~new_n78_ | ~new_n82_ | ~x24 | x26))) & (x24 | ~x26);
