...
module FAU ( 
  ...
  assign new_n64_ = (~x00 | ~x20 | (x19 & (~new_n61_ | ~new_n60_ | ~x12))) & (~x19 | x20);
  ...
  assign new_n70_ = (x20 | ~x22) & (~x00 | ((~x22 | (x19 & ~new_n71_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign new_n71_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (new_n73_ & ~x08);
  assign new_n73_ = x09 & ~x10 & ((~x20 & x23) | (~new_n74_ & x00));
  ...
  assign new_n77_ = (x20 | ~x24) & (~x00 | (~new_n80_ & ((new_n78_ & new_n79_) | ~x24)));
  ...
  assign new_n82_ = ~x10 & ((~x20 & x25) | (x00 & (new_n84_ | (~new_n83_ & x25))));
  assign new_n83_ = new_n60_ & x19 & x23 & x24 & (~x17 | ~x26);
  assign new_n84_ = x19 & x20 & x21 & new_n68_ & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n86_ | new_n89_));
  assign new_n86_ = x00 & (new_n87_ | (new_n88_ & new_n60_ & x19 & x20));
  assign new_n87_ = x26 & (~new_n68_ | ~x24 | ~x25 | ~new_n78_ | x18);
