...
module FAU ( 
  ...
  assign new_n71_ = x24 & (x22 ? ((new_n72_ & x19) | (x23 & (~x19 | ~x21))) : x23);
  assign new_n72_ = x20 & x21 & (~x23 | (x15 & x25 & x26));
  assign new_n73_ = ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~x10 & ~new_n75_ & x24);
  assign new_n75_ = new_n76_ & x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n76_ = x19 & x20 & x21;
  assign z15 = z07 | (~x08 & new_n78_ & x09);
  assign new_n78_ = ~x10 & ((x24 & (new_n80_ | (~new_n79_ & x25))) | (~x20 & x25));
  assign new_n79_ = x19 & x21 & x22 & x23 & (~x17 | ~x26);
  assign new_n80_ = x19 & x20 & x21 & x22 & x23 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n82_ & ~x10);
  assign new_n82_ = (x20 | ~x26) & (~x24 | ((new_n83_ | ~x26) & (~new_n76_ | ~new_n84_)));
  assign new_n83_ = x22 & x23 & x25 & ~x18 & x19 & x21;
