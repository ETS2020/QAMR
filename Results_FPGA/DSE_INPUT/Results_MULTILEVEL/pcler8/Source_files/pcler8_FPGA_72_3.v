...
module FAU ( 
  ...
  assign z15 = new_n86_ | (~x06 & ~x08 & x09 & ~new_n83_ & ~x10);
  ...
  assign new_n86_ = ~x20 & ((x06 & x08) | (~x08 & x09 & ~x10 & x25));
  assign z16 = new_n91_ | (~x08 & x09 & ~x10 & (new_n88_ | new_n92_));
  ...
  assign new_n91_ = x07 & x08 & (~x06 | (x06 & ~x20));
