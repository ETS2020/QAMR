...
module FAU ( 
  ...
  assign new_n58_ = (~x04 | x19) & (~new_n60_ | ~new_n59_ | ~x11 | ~x19);
  assign new_n59_ = x20 & x21;
  assign new_n60_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & new_n62_ & x09);
  assign new_n62_ = ~x10 & ((x19 & (~x20 | (new_n63_ & new_n64_))) | (x04 & ~x19 & x20));
  assign new_n63_ = x12 & x21 & x22;
  assign new_n64_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n66_ & x09);
  assign new_n66_ = ~x10 & ((x19 & (x20 ? (new_n67_ | ~x21) : x21)) | (x04 & ~x19 & x21));
  assign new_n67_ = x13 & x22 & x23 & x24 & x25 & x26;
  assign z12 = (new_n49_ & x03) | (~x08 & x09 & ~new_n69_ & ~x10);
  assign new_n69_ = (~x19 | ((~x22 | (x20 & ~new_n70_ & x21)) & (~x20 | ~x21 | x22))) & (~x04 | x19 | ~x22);
  assign new_n70_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = (x04 & x08) | (x09 & ~x10 & (new_n72_ | (new_n73_ & ~x08)));
  assign new_n72_ = x23 & ((x04 & (~x22 | (~x08 & ~x19 & x22))) | (~x08 & x19 & (~x22 | (~new_n59_ & x22))));
  assign new_n73_ = x19 & x20 & new_n74_ & x21;
  assign new_n74_ = x22 & (~x23 | (x25 & x26 & x15 & x24));
  assign z14 = new_n76_ | (x19 & (x08 ? x05 : (new_n78_ & x09)));
  assign new_n76_ = ~new_n77_ & x04;
  assign new_n77_ = (~x05 | ~x08) & (x08 | ~x09 | x10 | x19 | ~x24);
  assign new_n78_ = ~x10 & ((x24 & (~new_n59_ | ~x22 | new_n79_ | ~x23)) | (new_n59_ & x22 & x23 & ~x24));
