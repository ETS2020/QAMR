...
module FAU ( 
  ...
  assign z06 = x05 & x08 & (~x06 | (x20 & (x19 | (x06 & ~x19))));
  ...
  assign new_n69_ = (~x20 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x21 | x22))) & (x06 | x20 | ~x22);
