...
module FAU ( 
  ...
  assign new_n64_ = new_n65_ & x12 & x21 & x22;
  ...
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n82_ | new_n86_));
  assign new_n82_ = ~x18 & (new_n83_ | (new_n85_ & x19 & x20 & x21));
  ...
  assign new_n88_ = x09 & ~x10 & ((~x20 & x26) | (~new_n89_ & ~x18));
  assign new_n89_ = (~x26 | (new_n84_ & x23 & x24 & x25)) & (~new_n90_ | ~x25 | x26 | ~x23 | ~x24);
