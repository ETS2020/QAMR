...
module FAU ( 
  ...
  assign z07 = x06 & x08 & (~x05 | (x20 & (x19 | (x05 & ~x19))));
  ...
  assign new_n69_ = (~x20 | ((~x22 | (x19 & ~new_n70_ & x21)) & (~x19 | ~x21 | x22))) & (x05 | x20 | ~x22);
  ...
  assign new_n77_ = (x05 | x20 | ~x24) & (~x20 | ((~x24 | (new_n78_ & new_n79_)) & (~new_n78_ | ~new_n80_)));
  ...
  assign new_n90_ = ~x10 & ((x26 & (~new_n91_ | ~new_n92_)) | (new_n85_ & new_n93_));
