...
module FAU ( 
  ...
  assign new_n59_ = x19 & (~new_n61_ | ~new_n60_ | ~x11 | x12);
  assign new_n60_ = x20 & x21;
  assign new_n61_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = z02 | (new_n63_ & ~x08);
  assign new_n63_ = x09 & ~x10 & ((~x19 & x20) | (~x12 & x19 & ~x20));
  assign z11 = z03 | (~x08 & new_n65_ & x09);
  assign new_n65_ = ~x10 & ((~x12 & x19 & (x20 ? (new_n66_ | ~x21) : x21)) | (~x19 & x21));
  assign new_n66_ = x24 & x25 & x26 & x13 & x22 & x23;
  assign z12 = z04 | (~x08 & x09 & ~new_n68_ & ~x10);
  assign new_n68_ = (x12 | ((~x22 | (x20 & ~new_n69_ & x21)) & (~x19 | ~x20 | ~x21 | x22))) & (x19 | ~x22);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (~x08 & new_n71_ & x09);
  assign new_n71_ = ~x10 & ((~x19 & x23) | (~x12 & (x22 ? ~new_n72_ : x23)));
  assign new_n72_ = (~x19 | ~x20 | ~x21 | (~new_n73_ & x23)) & (~x23 | (x20 & x21));
  assign new_n73_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (new_n75_ & ~x08);
  assign new_n75_ = x09 & ~x10 & ((~x19 & x24) | (~new_n76_ & ~x12));
  assign new_n76_ = (~x24 | (new_n60_ & x22 & ~new_n77_ & x23)) & (~new_n60_ | ~x19 | ~x22 | ~x23 | x24);
  assign new_n77_ = x16 & x25 & x26;
  assign z15 = z07 | (~x08 & new_n79_ & x09);
  assign new_n79_ = ~x10 & ((~x19 & x25) | (~x12 & (new_n82_ | (~new_n80_ & x25))));
  assign new_n80_ = new_n81_ & x20 & x21 & x22;
  assign new_n81_ = x23 & x24 & (~x17 | ~x26);
  assign new_n82_ = new_n60_ & x19 & x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n84_ | new_n88_));
  assign new_n84_ = ~x12 & (new_n85_ | (x26 & (~new_n87_ | ~new_n60_ | x18)));
  assign new_n85_ = new_n86_ & x19 & x20 & x21 & x22;
