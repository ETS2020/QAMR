...
module FAU ( 
  ...
  assign new_n62_ = x19 ? (x20 & (~new_n63_ | ~new_n60_ | ~x23 | ~x24)) : (~x20 | ~x23);
  ...
  assign z12 = (~x08 & new_n69_ & x09) | (~new_n68_ & (x19 | x23));
  assign new_n68_ = x08 ? ~x03 : (~x09 | x10 | new_n59_ | ~x22);
  ...
  assign new_n75_ = ~new_n76_ & (~x19 | ~x24 | (new_n59_ & new_n77_));
  assign new_n76_ = x23 & ((~x19 & x24) | (x19 & x20 & x21 & x22 & ~x24));
  assign new_n77_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign z15 = z07 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (new_n80_ | ~x23) & (~x19 | ~x25 | (new_n81_ & new_n82_ & x23));
  assign new_n80_ = (x19 | ~x25) & (~x19 | ~x20 | ~x21 | ~x22 | ~x24 | x25);
  assign new_n81_ = x20 & x21 & x22;
  assign new_n82_ = x24 & (~x17 | ~x26);
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n84_ | new_n86_));
  assign new_n84_ = x23 & ((~x19 & x26) | (new_n85_ & new_n59_ & x19));
  assign new_n85_ = x22 & x24 & x25 & ~x26;
  assign new_n86_ = x19 & x26 & (~new_n87_ | ~new_n59_ | x18);
