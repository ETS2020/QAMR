...
module FAU ( 
  ...
  assign new_n48_ = x20 & x19 & x15 & ~x10 & ~x08 & x09;
  assign z01 = new_n50_ & x00;
  assign new_n50_ = x08 & (x15 | ~x19);
  ...
  assign new_n63_ = ~x10 & ((x15 & x19 & ((new_n64_ & new_n65_) | ~x20)) | (~x19 & x20));
  assign new_n64_ = x12 & x21 & x22;
  assign new_n65_ = x23 & x24 & x25 & x26;
  assign z11 = z03 | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x15 & x19 & (x20 ? (new_n68_ | ~x21) : x21)) | (~x19 & x21));
  ...
  assign new_n73_ = (x19 | ~x23) & (~x15 | (x22 ? ((~new_n74_ | ~x19) & (new_n75_ | ~x23)) : ~x23));
  assign new_n74_ = x20 & x21 & (~x23 | (x24 & x25 & x26));
  assign new_n75_ = x20 & x21 & (~x25 | ~x26 | ~x14 | ~x24);
  assign z14 = z06 | (~x08 & x09 & ~new_n77_ & ~x10);
  assign new_n77_ = (x19 | ~x24) & (~x15 | (((new_n60_ & new_n78_) | ~x24) & (~new_n79_ | ~new_n60_ | ~x19)));
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~x10 & (new_n81_ | new_n86_));
  assign new_n81_ = x15 & ((new_n82_ & new_n85_) | (x25 & (~new_n83_ | ~new_n84_)));
  ...
  assign new_n88_ = x15 & ((new_n91_ & new_n92_) | ((~new_n89_ | ~new_n90_) & x26));
