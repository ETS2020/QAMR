...
module FAU ( 
  ...
  assign new_n48_ = x20 & x19 & x17 & ~x10 & ~x08 & x09;
  ...
  assign new_n59_ = x19 & (~new_n60_ | ~new_n62_ | ~x11 | ~x17);
  assign new_n60_ = x22 & x23 & new_n61_ & x24;
  assign new_n61_ = x25 & x26;
  assign new_n62_ = x20 & x21;
  assign z10 = z02 | (new_n64_ & ~x08);
  assign new_n64_ = x09 & ~x10 & ((x17 & x19 & (new_n65_ | ~x20)) | (~x19 & x20));
  assign new_n65_ = x12 & x21 & x22 & new_n61_ & x23 & x24;
  assign z11 = z03 | (~x08 & new_n67_ & x09);
  assign new_n67_ = ~x10 & ((x17 & x19 & (x20 ? (new_n68_ | ~x21) : x21)) | (~x19 & x21));
  assign new_n68_ = x13 & x22 & x23 & new_n61_ & x24;
  ...
  assign new_n73_ = (x19 | ~x23) & (~x17 | (x22 ? ((~new_n74_ | ~x19) & (new_n62_ | ~x23)) : ~x23));
  assign new_n74_ = x20 & x21 & (~x23 | (new_n61_ & x15 & x24));
  assign z14 = z06 | (new_n76_ & ~x08);
  assign new_n76_ = x09 & ~x10 & ((~x19 & x24) | (~new_n77_ & x17));
  ...
  assign new_n80_ = ~x10 & ((~x19 & x25) | (x17 & (new_n81_ | (~new_n82_ & x25))));
  assign new_n81_ = new_n62_ & x19 & x22 & x23 & x24 & ~x25;
  assign new_n82_ = x23 & x24 & ~x26 & x20 & x21 & x22;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n84_ | new_n88_));
  assign new_n84_ = x17 & (new_n85_ | (x26 & (~new_n87_ | ~new_n62_ | x18)));
