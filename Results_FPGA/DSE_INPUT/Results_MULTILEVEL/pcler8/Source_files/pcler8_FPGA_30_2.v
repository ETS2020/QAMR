...
module FAU ( 
  ...
  assign new_n62_ = (~x20 | (x19 & (~new_n63_ | ~x12 | ~x21 | ~x22))) & (x12 | ~x19 | x20);
  ...
  assign new_n76_ = (x12 | x20 | ~x24) & (~x20 | ((~x24 | (new_n77_ & new_n78_)) & (~new_n77_ | ~new_n79_)));
  assign new_n77_ = x19 & x21;
  assign new_n78_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n79_ = x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (x12 | x20 | ~x25) & (~x20 | ((~x25 | (new_n82_ & new_n83_)) & (~new_n82_ | ~new_n84_)));
