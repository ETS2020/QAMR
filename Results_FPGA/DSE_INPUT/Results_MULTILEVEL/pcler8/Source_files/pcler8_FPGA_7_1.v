...
module FAU ( 
  ...
  assign z09 = (new_n59_ & new_n62_) | (~new_n50_ & ~new_n61_);
  assign new_n59_ = new_n60_ & x21 & x24 & x25 & x26;
  assign new_n60_ = x22 & x23;
  assign new_n61_ = (~x00 | ~x08) & (x08 | ~x09 | x10 | x19);
  assign new_n62_ = x01 & ~x08 & x09 & ~x10 & x11 & x20;
  assign z10 = (x01 & (x08 | (x09 & new_n64_ & ~x10))) | (~x08 & x09 & new_n67_ & ~x10);
  assign new_n64_ = x20 & (~x19 | (new_n66_ & new_n65_ & x12));
  assign new_n65_ = x21 & x22;
  assign new_n66_ = x23 & x24 & x25 & x26;
  assign new_n67_ = x19 & ~x20;
  assign z11 = (x02 & ~new_n50_ & x08) | (~x08 & new_n69_ & x09);
  assign new_n69_ = ~x10 & ((x01 & x20 & (x19 ? (new_n70_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n70_ = new_n60_ & x13 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n72_ & ~x10);
  assign new_n72_ = (x20 | ~x22) & (~x01 | ((~x22 | (x19 & ~new_n73_ & x21)) & (~x19 | ~x20 | ~x21 | x22)));
  assign new_n73_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = z05 | (new_n75_ & ~x08);
  assign new_n75_ = x09 & ~x10 & ((~new_n76_ & x01) | (~x20 & x23));
  assign new_n76_ = x22 ? ((~x19 | ~x20 | ~x21 | (~new_n77_ & x23)) & (~x23 | (x19 & x21))) : ~x23;
  assign new_n77_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n79_ & ~x10);
  assign new_n79_ = (x20 | ~x24) & (~x01 | (~new_n82_ & ((new_n80_ & new_n81_) | ~x24)));
  assign new_n80_ = x19 & x21;
  assign new_n81_ = x22 & x23 & (~x16 | ~x25 | ~x26);
  assign new_n82_ = x19 & x20 & x21 & x22 & x23 & ~x24;
  assign z15 = z07 | (~x08 & new_n84_ & x09);
  assign new_n84_ = ~x10 & ((~x20 & x25) | (x01 & (new_n86_ | (~new_n85_ & x25))));
  assign new_n85_ = new_n65_ & x19 & x23 & x24 & (~x17 | ~x26);
  assign new_n86_ = x19 & x20 & x21 & new_n60_ & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n88_ | new_n91_));
  assign new_n88_ = x01 & (new_n89_ | (new_n90_ & new_n65_ & x19 & x20));
  assign new_n89_ = x26 & (~new_n60_ | ~x24 | ~x25 | ~new_n80_ | x18);
