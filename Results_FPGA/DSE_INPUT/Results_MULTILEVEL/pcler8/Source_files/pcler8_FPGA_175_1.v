...
module FAU ( 
  ...
  assign z13 = z05 | (~x08 & x09 & ~x10 & (new_n73_ | new_n76_));
  assign new_n73_ = x15 & (x22 ? ((new_n74_ & x19) | (x23 & (~new_n75_ | ~x19))) : x23);
  assign new_n74_ = x20 & x21 & (~x23 | (x24 & x25 & x26));
  assign new_n75_ = x21 & (~x25 | ~x26 | ~x14 | ~x24);
  assign new_n76_ = ~x20 & x23;
  assign z14 = z06 | (~x08 & x09 & ~new_n78_ & ~x10);
  assign new_n78_ = (x20 | ~x24) & (~x15 | (~new_n81_ & ((new_n79_ & new_n80_) | ~x24)));
  ...
  assign new_n83_ = x15 & ((new_n84_ & new_n87_) | (x25 & (~new_n85_ | ~new_n86_)));
  ...
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n90_ | new_n95_));
  assign new_n90_ = x15 & ((new_n93_ & new_n94_) | ((~new_n91_ | ~new_n92_) & x26));
