...
module FAU ( 
  ...
  assign z09 = (~new_n61_ & (x17 | ~x20)) | (new_n59_ & new_n62_ & x11 & x17 & x20);
  ...
  assign new_n78_ = (x20 | ~x24) & (~x17 | (~new_n81_ & ((new_n79_ & new_n80_) | ~x24)));
  ...
  assign new_n83_ = ~x10 & ((~x20 & x25) | (x17 & (new_n85_ | (~new_n84_ & x25))));
  assign new_n84_ = new_n66_ & x19 & x23 & x24 & ~x26;
  assign new_n85_ = x19 & x20 & x21 & new_n60_ & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~x10 & (new_n87_ | new_n90_));
  assign new_n87_ = x17 & (new_n88_ | (new_n89_ & new_n66_ & x19 & x20));
  assign new_n88_ = x26 & (~new_n79_ | x18 | ~new_n60_ | ~x24 | ~x25);
