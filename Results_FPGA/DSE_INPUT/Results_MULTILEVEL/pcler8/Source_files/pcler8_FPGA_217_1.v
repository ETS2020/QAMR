// Benchmark "FAU" written by ABC on Thu Aug  6 18:49:54 2020
...
module FAU ( 
  ...
  assign new_n58_ = (x19 | x24) & (~new_n59_ | ~x20 | ~x21 | ~x11 | ~x19);
  assign new_n59_ = x22 & x23 & x24 & x25 & x26;
  assign z10 = z02 | (~x08 & new_n61_ & x09);
  assign new_n61_ = ~x10 & (x19 ? (~x20 | (new_n62_ & new_n63_)) : (x20 & ~x24));
  ...
  assign new_n68_ = x19 ? ((~x22 | (x20 & ~new_n69_ & x21)) & (~x20 | ~x21 | x22)) : (~x22 | x24);
  assign new_n69_ = x14 & x23 & x24 & x25 & x26;
  assign z13 = new_n71_ | (~x08 & x09 & ~x10 & ~new_n73_ & x22);
  assign new_n71_ = ~new_n72_ & (x19 | ~x24);
  assign new_n72_ = (~x04 | ~x08) & (x08 | ~x09 | x10 | x22 | ~x23);
  assign new_n73_ = x19 ? ((~x20 | ~x21 | (~new_n74_ & x23)) & (~x23 | (x20 & x21))) : (~x23 | x24);
  assign new_n74_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~x10 & ~new_n76_ & x19);
  ...
  assign new_n79_ = (x24 | ~x25) & (~x19 | ((new_n80_ | ~x25) & (~new_n81_ | ~x23 | ~x24 | x25)));
  assign new_n80_ = x20 & x21 & x22 & x23 & (~x17 | ~x26);
  assign new_n81_ = x20 & x21 & x22;
  assign z16 = z08 | (~x08 & x09 & ~new_n83_ & ~x10);
  assign new_n83_ = (x24 | ~x26) & (~x19 | ((new_n84_ | ~x26) & (~new_n81_ | ~new_n85_)));
  assign new_n84_ = x22 & x23 & x25 & ~x18 & x20 & x21;
