...
module FAU ( 
  ...
  assign z10 = (x01 & x08 & (~x02 | (x02 & ~x20))) | (new_n64_ & ~x08);
  assign new_n64_ = x09 & ~x10 & ((~x02 & x20 & (new_n65_ | ~x19)) | (x19 & ~x20));
  assign new_n65_ = new_n66_ & x12 & x25 & x26 & x23 & x24;
  assign new_n66_ = x21 & x22;
  assign z11 = (~x08 & new_n68_ & x09) | (x02 & x08 & ~x20);
  assign new_n68_ = ~x10 & ((~x02 & x20 & (x19 ? (new_n69_ | ~x21) : x21)) | (~x20 & x21));
  assign new_n69_ = new_n60_ & x13 & x24 & x25 & x26;
  assign z12 = z04 | (~x08 & x09 & ~new_n71_ & ~x10);
  assign new_n71_ = (x20 | ~x22) & (x02 | ((~x22 | (x19 & ~new_n72_ & x21)) & (~x21 | x22 | ~x19 | ~x20)));
