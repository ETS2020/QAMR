...
module FAU ( 
  ...
  assign new_n81_ = ~x10 & ((~x19 & x25) | (x02 & (new_n83_ | (~new_n82_ & x25))));
  ...
  assign new_n85_ = x02 & (new_n86_ | (x26 & (~new_n88_ | ~new_n62_ | x18)));
