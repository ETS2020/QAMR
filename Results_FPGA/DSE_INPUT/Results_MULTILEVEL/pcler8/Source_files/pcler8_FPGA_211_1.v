...
module FAU ( 
  ...
  assign z12 = z04 | (~x08 & x09 & ~x10 & ~new_n68_ & x20);
  assign new_n68_ = (~x22 | (x19 & x21 & (~new_n60_ | ~x14 | ~x23))) & (~x19 | ~x21 | x22);
  assign z13 = z05 | (~x08 & x09 & ~new_n70_ & ~x10);
  assign new_n70_ = (~x20 | ~x22 | ((~x19 | ~x21 | (~new_n71_ & x23)) & (~x23 | (x19 & x21)))) & (x22 | ~x23);
  assign new_n71_ = x15 & x24 & x25 & x26;
  assign z14 = z06 | (~x08 & x09 & ~new_n73_ & ~x10);
  assign new_n73_ = (~x20 | ((~x24 | (new_n74_ & ~new_n75_ & x23)) & (~new_n74_ | ~x22 | ~x23 | x24))) & (x22 | ~x24);
  assign new_n74_ = x19 & x21;
  assign new_n75_ = x16 & x25 & x26;
  assign z15 = z07 | (~x08 & new_n77_ & x09);
  assign new_n77_ = ~x10 & ((~x22 & x25) | (x20 & (new_n79_ | (~new_n78_ & x25))));
  assign new_n78_ = x19 & x21 & x23 & x24 & (~x17 | ~x26);
  assign new_n79_ = x19 & x21 & x22 & x23 & x24 & ~x25;
  assign z16 = z08 | (~x08 & x09 & ~new_n81_ & ~x10);
  assign new_n81_ = (x22 | ~x26) & (~x20 | ((new_n83_ | ~x26) & (~new_n82_ | ~new_n84_)));
