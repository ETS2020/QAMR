...
module FAU ( 
  ...
  assign z06 = x046 & (new_n235_ | ~new_n230_ | (~new_n211_ & x054));
  ...
  assign new_n216_ = ~x070 & (new_n217_ | (x078 & (new_n218_ | new_n219_)));
  assign new_n217_ = ~x022 & (x014 | x038);
  ...
  assign z14 = ~x046 & x070 & (~new_n309_ | new_n318_);
  assign new_n309_ = ~new_n316_ & (x054 | (~new_n310_ & ~new_n312_ & new_n314_)) & (new_n317_ | ~x054);
  assign new_n310_ = ~new_n311_ & (x110 | x118);
  assign new_n311_ = (x086 | (~x014 & ~x022)) & (~x006 | x038 | x078);
  assign new_n312_ = x006 & ((~x078 & (new_n313_ | x086 | (~x038 & x102))) | (~x038 & x086));
  assign new_n313_ = ~x022 & x126 & (~x110 | ~x118);
  assign new_n314_ = (x078 | x086 | (new_n315_ & (x022 | ~x030))) & (~x022 | x038);
  assign new_n315_ = ~x062 & ~x094;
  assign new_n316_ = x078 & (x014 | (x022 & ~x054));
  assign new_n317_ = ~x038 & (~x022 | (~x014 & x078));
  assign new_n318_ = ~x014 & ((x022 & ~x054) | (x006 & x054 & x086));
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
