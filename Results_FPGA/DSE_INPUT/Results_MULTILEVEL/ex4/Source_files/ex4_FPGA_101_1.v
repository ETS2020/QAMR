...
module FAU ( 
  ...
  assign z04 = x044 & ((~new_n180_ & (x020 | ~x070)) | (~x020 & ~x068 & ~new_n181_ & ~x070));
  ...
  assign z06 = x046 & (new_n209_ | new_n213_ | (x020 & ~new_n218_ & x078));
  ...
  assign z12 = ~x044 & ((new_n270_ & x020) | (~new_n269_ & (x020 | ~x070)));
  assign new_n269_ = (~x004 | ~x084 | (x012 ? (~x036 & x052) : (x036 & x076))) & (~x036 | ~x052) & (~x012 | ~x076);
  assign new_n270_ = x068 & (x012 ? ~x036 : (x036 | ~x052 | ~x076));
  ...
  assign z14 = ~x046 & ((~new_n298_ & (x020 | ~x070)) | (~new_n302_ & x020) | (new_n308_ & ~x070));
