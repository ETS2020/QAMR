// Benchmark "FAU" written by ABC on Thu Aug  6 18:30:32 2020
...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n185_ & (x069 | ~x070)) | (new_n196_ & x069) | (~new_n189_ & ~x070));
  assign new_n185_ = ~new_n186_ & new_n188_;
  assign new_n186_ = x053 & ((~x005 & ~x085 & (x037 | x077)) | (new_n187_ & x085));
  assign new_n187_ = (~x109 | ~x117) & (~x013 | (~x021 & x077));
  assign new_n188_ = (x013 | x077) & (x053 | (x037 & (x005 | ~x013 | x085)));
  assign new_n189_ = ~new_n193_ & (x069 | (~new_n195_ & (~x053 | new_n190_ | ~x077)));
  assign new_n190_ = ~new_n192_ & (x005 | ~x037 | (new_n191_ & x101));
  assign new_n191_ = x109 & x117;
  assign new_n192_ = x085 & (~x061 | ~x093 | (x021 & ~x029));
  assign new_n193_ = ~x005 & x021 & x053 & x077 & ~new_n194_ & ~x125;
  assign new_n194_ = ~x109 & ~x117;
  assign new_n195_ = ~x021 & (x053 ? (x013 | x037 | ~x077) : (~x013 | x077));
  assign new_n196_ = x077 & (new_n202_ | (x053 & (new_n197_ | (new_n201_ & ~x029))));
  assign new_n197_ = ~x005 & (new_n198_ | (~new_n191_ & x021) | (~new_n199_ & (~new_n200_ | x021)));
  assign new_n198_ = (x021 | (x013 & x037)) & (~x029 | ~x061 | ~x093);
  assign new_n199_ = x101 & x125;
  assign new_n200_ = ~x061 & ~x093;
  assign new_n201_ = x085 & ~new_n200_ & (~new_n191_ | (~new_n199_ & (x013 | x021)));
  assign new_n202_ = ~x037 & (new_n203_ | (~new_n199_ & ~x005));
  assign new_n203_ = x085 & (~x061 | ~x093 | (~x029 & (x013 | x021)));
  assign z06 = x046 & (new_n205_ | new_n209_ | (x069 & ~new_n214_ & x078));
  assign new_n205_ = ~new_n162_ & ((~new_n208_ & ~x054) | (~new_n206_ & x054) | (~x014 & ~x078));
  assign new_n206_ = (x006 | x086 | (~x038 & ~x078)) & (x014 | new_n207_ | ~x086);
  assign new_n207_ = x110 & x118;
  assign new_n208_ = x038 & (x006 | ~x014 | x086);
  assign new_n209_ = ~x070 & ((~new_n210_ & ~x022) | (x054 & ~new_n211_ & x078));
  assign new_n210_ = x054 ? ((new_n207_ | ~x086) & ~x014 & ~x038 & x078) : (x014 & ~x078);
  assign new_n211_ = ~new_n213_ & (new_n212_ | x006);
  assign new_n212_ = (~x022 | x126 | (~x110 & ~x118)) & (~x038 | (x102 & x110 & x118));
  assign new_n213_ = x086 & (~x062 | ~x094 | (x022 & ~x030));
  assign new_n214_ = ~new_n221_ & (~x054 | (~new_n215_ & ~new_n217_ & (~new_n220_ | ~x022)));
  assign new_n215_ = ~new_n207_ & ((~x022 & x086) | (~new_n216_ & x070));
  assign new_n216_ = (x006 | ~x022) & (x030 | ~x086 | (~x062 & ~x094));
  assign new_n217_ = x070 & ((new_n220_ & x014) | (~x006 & (new_n218_ | new_n219_)));
  assign new_n218_ = (x022 | (x014 & x038)) & (~x030 | ~x062 | ~x094);
  assign new_n219_ = (~x102 | ~x126) & (x022 | x062 | x094);
  assign new_n220_ = ~x030 & x086 & (~x102 | ~x126) & (x062 | x094);
  assign new_n221_ = ~x038 & (new_n213_ | (~new_n222_ & x070));
  ...
  assign new_n231_ = ~x080 & ((~x016 & x024) | x056 | x088);
  ...
  assign z13 = ~x045 & (new_n270_ | new_n273_ | (~x070 & ~new_n278_ & ~x077));
  assign new_n270_ = ~new_n162_ & ((~new_n272_ & x053) | (x013 & x077) | (~new_n271_ & ~x053));
  assign new_n271_ = (~x005 | ~x085 | (x037 & x077)) & (~x013 | new_n194_ | x085);
  assign new_n272_ = ~x037 & (~x005 | x013 | ~x085);
  assign new_n273_ = x069 & ((~new_n274_ & x021) | (~x053 & ~new_n275_ & ~x077));
  assign new_n274_ = x053 ? (~x013 & x077) : ((new_n194_ | x085) & x013 & x037 & ~x077);
  assign new_n275_ = ~new_n277_ & (new_n276_ | ~x005);
  assign new_n276_ = (x021 | ~x125 | (x109 & x117)) & (x037 | (~x101 & ~x109 & ~x117));
  assign new_n277_ = ~x085 & ((~x021 & x029) | x061 | x093);
  assign new_n278_ = ~new_n285_ & (x053 | (~new_n279_ & ~new_n281_ & (~new_n284_ | x021)));
  assign new_n279_ = ~new_n194_ & ((~new_n280_ & ~x069) | (x021 & ~x085));
  assign new_n280_ = (~x005 | x021) & (~x029 | x085 | (x061 & x093));
  ...
  assign new_n285_ = x037 & (new_n277_ | (~new_n286_ & ~x069));
  assign new_n286_ = (~x005 | (~x101 & ~x125)) & (x013 | ~x029 | x085);
  ...
  assign new_n296_ = x006 & ~x022 & ~x054 & ~x078 & ~new_n207_ & x126;
