...
module FAU ( 
  ...
  assign z06 = x046 & (new_n211_ | new_n215_ | (x070 & ~new_n223_ & x078));
  ...
  assign new_n215_ = ~x102 & (~new_n221_ | (x054 & (new_n218_ | (~new_n216_ & ~x070))));
  assign new_n216_ = (~x038 | (x022 & (x006 | ~x078))) & (~new_n217_ | ~x078) & (x022 | (~x014 & x078));
  assign new_n217_ = x086 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n218_ = x078 & (new_n220_ | (~new_n219_ & (x062 | x094)));
  assign new_n219_ = (x030 | ~x086 | (~x022 & (~x014 | ~x070))) & (x006 | ~x070);
  assign new_n220_ = ~x006 & x022 & (x070 | (~x126 & (x110 | x118)));
  assign new_n221_ = (x022 | x054 | x070 | (x014 & ~x078)) & (~new_n222_ | ~x070 | ~x078);
  assign new_n222_ = ~x006 & ~x038;
  assign new_n223_ = ~new_n229_ & (~x054 | ((new_n224_ | x006) & (~new_n227_ | x030)));
  assign new_n224_ = new_n226_ & ((~x022 & (~x014 | ~x038)) | (new_n225_ & x030));
  assign new_n225_ = x062 & x094;
  assign new_n226_ = (~x022 | (x110 & x118 & x126)) & (x126 | (~x062 & ~x094));
  assign new_n227_ = x086 & ~new_n228_ & (x062 | x094);
  assign new_n228_ = x110 & x118 & (x126 | (~x014 & ~x022));
  assign new_n229_ = ~x038 & (new_n230_ | (~x006 & ~x126));
  ...
  assign z14 = ~x046 & (new_n304_ | new_n308_ | (~x078 & ~new_n313_ & ~x102));
  assign new_n304_ = ~new_n162_ & ((~new_n307_ & x054) | (~new_n305_ & ~x054) | (x014 & x078));
  assign new_n305_ = (~x006 | ~x086 | (x038 & x078)) & (~x014 | new_n306_ | x086);
  assign new_n306_ = ~x110 & ~x118;
  assign new_n307_ = ~x038 & (~x006 | x014 | ~x086);
  assign new_n308_ = x070 & (new_n310_ | (~new_n309_ & x022));
  assign new_n309_ = x054 ? (~x014 & x078) : ((new_n306_ | x086) & x014 & x038 & ~x078);
  assign new_n310_ = ~x054 & ~x078 & ((~new_n311_ & x006) | (~new_n312_ & ~x086));
  assign new_n311_ = (x022 | ~x126 | (x110 & x118)) & (x038 | (~x102 & ~x110 & ~x118));
  assign new_n312_ = ~x062 & ~x094 & (x022 | ~x030);
  assign new_n313_ = ~new_n320_ & (x054 | (new_n315_ & (new_n314_ | new_n306_)));
  assign new_n314_ = (x070 | ((~x006 | x022) & (~x030 | new_n225_ | x086))) & (~x022 | x086);
  assign new_n315_ = ~new_n319_ & (x070 | (~new_n318_ & (~x006 | (~new_n316_ & ~new_n317_))));
  assign new_n316_ = (~x022 | (~x014 & ~x038)) & (x030 | x062 | x094);
  assign new_n317_ = x126 & (~x022 | ~x062 | ~x094);
  assign new_n318_ = ~x014 & x030 & ~x086 & x126 & (~x062 | ~x094);
  assign new_n319_ = ~x022 & x030 & ~x086 & x126 & (~x062 | ~x094);
  assign new_n320_ = x038 & ((~new_n321_ & ~x086) | (x006 & ~x070 & x126));
