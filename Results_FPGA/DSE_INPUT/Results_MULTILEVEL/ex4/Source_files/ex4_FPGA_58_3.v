...
module FAU ( 
  ...
  assign new_n162_ = x017 & x070;
  assign new_n163_ = x032 & ((~x008 & ~x016 & ~x064) | (~x000 & x008 & ~x080));
  assign z01 = x041 & ((~new_n165_ & (~x017 | ~x070)) | (new_n166_ & ~x017));
  assign new_n165_ = (x001 | x081 | (x009 ? (~x033 & ~x073) : (x033 & ~x049))) & (x033 | x049) & (x009 | x073);
  assign new_n166_ = ~x065 & (x009 ? (~x033 | x049 | x073) : x033);
  ...
  assign new_n190_ = x085 & (~x061 | ~x093 | (x021 & ~x029));
  ...
  assign z06 = x046 & (new_n209_ | new_n213_ | (~x017 & ~new_n218_ & x078));
  ...
  assign new_n217_ = x086 & (~x062 | ~x094 | (x022 & ~x030));
  ...
  assign z09 = ~x041 & ((~new_n254_ & (~x017 | ~x070)) | (x017 & x065 & ~new_n255_ & ~x070));
  assign new_n254_ = (~x001 | ~x081 | (x009 ? (~x033 & x049) : (x033 & x073))) & (~x033 | ~x049) & (~x009 | ~x073);
  assign new_n255_ = x009 ? x033 : (~x033 & x049 & x073);
  ...
  assign z14 = ~x046 & ((~new_n298_ & (~x017 | ~x070)) | (~new_n302_ & ~x017) | (new_n308_ & ~x070));
