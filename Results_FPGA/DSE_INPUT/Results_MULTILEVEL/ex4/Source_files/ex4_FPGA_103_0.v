...
module FAU ( 
  ...
  assign z05 = x045 & ((~new_n185_ & (x069 | x070)) | (~new_n189_ & x070) | (new_n196_ & x069));
  ...
  assign z06 = x046 & ((~new_n205_ & (x069 | x070)) | (~new_n209_ & x069) | (new_n216_ & x070));
  ...
  assign z13 = ~x045 & (new_n271_ | new_n274_ | (x070 & ~new_n279_ & ~x077));
  assign new_n271_ = ~new_n162_ & ((~new_n273_ & x053) | (x013 & x077) | (~new_n272_ & ~x053));
  assign new_n272_ = (~x005 | ~x085 | (x037 & x077)) & (~x013 | new_n194_ | x085);
  assign new_n273_ = ~x037 & (~x005 | x013 | ~x085);
  assign new_n274_ = x069 & ((~new_n275_ & x021) | (~x053 & ~new_n276_ & ~x077));
  assign new_n275_ = x053 ? (~x013 & x077) : ((new_n194_ | x085) & x013 & x037 & ~x077);
  assign new_n276_ = ~new_n278_ & (new_n277_ | ~x005);
  assign new_n277_ = (x021 | ~x125 | (x109 & x117)) & (x037 | (~x101 & ~x109 & ~x117));
  assign new_n278_ = ~x085 & (x061 | x093 | (~x021 & x029));
  assign new_n279_ = ~new_n286_ & (x053 | (~new_n280_ & ~new_n282_ & (~new_n285_ | x021)));
  assign new_n280_ = ~new_n194_ & ((~new_n281_ & ~x069) | (x021 & ~x085));
  assign new_n281_ = (~x005 | x021) & (~x029 | x085 | (x061 & x093));
  assign new_n282_ = ~x069 & ((x005 & (new_n283_ | new_n284_)) | (new_n285_ & ~x013));
  ...
  assign new_n286_ = x037 & (new_n278_ | (~new_n287_ & ~x069));
  assign new_n287_ = (~x005 | (~x101 & ~x125)) & (x013 | ~x029 | x085);
  ...
  assign new_n290_ = (~x006 | ~x086 | (x038 & x078)) & (~x014 | new_n214_ | x086);
  assign new_n291_ = ~x038 & (~x006 | x014 | ~x086);
  assign new_n292_ = x070 & ((~new_n293_ & x022) | (~x054 & ~new_n294_ & ~x078));
  assign new_n293_ = x054 ? (~x014 & x078) : ((new_n214_ | x086) & x014 & x038 & ~x078);
  ...
  assign new_n298_ = ~new_n214_ & ((~new_n299_ & ~x070) | (x022 & ~x086));
