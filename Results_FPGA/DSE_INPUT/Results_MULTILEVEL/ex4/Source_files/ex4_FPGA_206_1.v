...
module FAU ( 
  ...
  assign new_n244_ = ~x080 & ((~x016 & x024) | x056 | x088);
  ...
  assign new_n290_ = ~x085 & ((~x021 & x029) | x061 | x093);
  ...
  assign z14 = ~x046 & ~x070 & (~new_n316_ | (~new_n309_ & ~x054));
  assign new_n309_ = ~new_n310_ & (new_n312_ | x078) & (~x006 | x038 | ~x086);
  assign new_n310_ = (x110 | x118) & ((~new_n311_ & ~x078) | (x014 & ~x086));
  assign new_n311_ = (~x006 | x022) & (x086 | (~x022 & (~x030 | (x062 & x094))));
  assign new_n312_ = (~x006 | (~new_n313_ & ~new_n314_ & ~x086)) & (~x030 | ~new_n315_ | x086);
  assign new_n313_ = (~x022 | (~x014 & ~x038)) & (x030 | x062 | x094);
  assign new_n314_ = (x102 | x126) & (~x022 | ~x062 | ~x094);
  assign new_n315_ = (x102 | x126) & (~x014 | ~x022) & (~x062 | ~x094);
  assign new_n316_ = (new_n319_ | x014) & (~x014 | ~x078) & (~x038 | (~x054 & (new_n317_ | x078)));
  assign new_n317_ = ~new_n318_ & (~x006 | (~x102 & ~x126));
  assign new_n318_ = ~x086 & ((~x022 & x030) | x062 | x094);
  assign new_n319_ = (~x006 | ~x054 | ~x086) & (x078 | x086 | ~x030 | ~x038);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
