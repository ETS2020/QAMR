...
module FAU ( 
  ...
  assign z06 = x046 & ((~new_n231_ & (x070 | ~x118)) | (~new_n211_ & ~x118) | (~new_n221_ & x070));
  ...
  assign new_n214_ = ~x006 & (~x022 | (x078 & x110 & ~x126));
  ...
  assign new_n224_ = (~x022 | x110) & ((~x022 & ~x062 & ~x094) | (x102 & x126));
  assign new_n225_ = x086 & (new_n227_ | (~x030 & ~new_n226_ & (x062 | x094)));
  assign new_n226_ = x110 & ((~x014 & ~x022) | (x102 & x126));
  assign new_n227_ = ~x022 & ~x110;
  assign new_n228_ = ~x038 & (new_n229_ | (~x006 & (~x102 | ~x126)));
  assign new_n229_ = x086 & (~x062 | ~x094 | (~x030 & (x014 | x022)));
  assign new_n230_ = ~x014 & x054 & x086 & ~x110;
  ...
  assign new_n306_ = new_n307_ & (~x014 | (~x078 & (x054 | x086 | ~x110)));
  ...
  assign new_n310_ = ~x022 & ((x030 & ~x086) | (x006 & ~x110 & x126));
  assign new_n311_ = x006 & ~x038 & (x102 | x110 | x118);
  assign new_n312_ = x014 & (x054 ? x022 : (~x086 & x118));
  assign new_n313_ = (x086 | (~x110 & ~x118)) & x014 & x038 & ~x078;
  assign new_n314_ = ~x118 & (new_n321_ | (~x054 & (~new_n319_ | (~new_n315_ & ~x070))));
  assign new_n315_ = (~x006 | (~new_n316_ & new_n317_)) & (~x030 | ~new_n318_ | x086);
  assign new_n316_ = (~x022 | (~x014 & ~x038)) & (x030 | x062 | x094);
  assign new_n317_ = (x022 | (~x102 & ~x110)) & ((~x102 & ~x126) | (x062 & x094));
  assign new_n318_ = (~x062 | ~x094) & (x110 | (~x014 & (x102 | x126)));
  assign new_n319_ = x022 ? (x086 | ~x110) : (~new_n320_ & (~x006 | ~x126));
