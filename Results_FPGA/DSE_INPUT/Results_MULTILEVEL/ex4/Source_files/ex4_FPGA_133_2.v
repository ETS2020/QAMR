...
module FAU ( 
  ...
  assign z01 = x041 & ((~new_n165_ & (~x070 | x081)) | (~x001 & ~x070 & ~new_n166_ & ~x081));
  ...
  assign z06 = x046 & (new_n209_ | new_n213_ | (x078 & ~new_n218_ & x081));
  ...
  assign z09 = ~x041 & ((x001 & ~new_n255_ & x081) | (~new_n254_ & (~x070 | x081)));
  assign new_n254_ = (~x009 | (~x073 & (~x017 | x033 | ~x065))) & (~x033 | (~x049 & (x009 | ~x017 | ~x065))) & (x009 | ~x017 | ~x065 | (x049 & x073));
  assign new_n255_ = x009 ? (~x033 & x049) : (x033 & x073);
  ...
  assign z14 = ~x046 & ((~new_n298_ & (~x070 | x081)) | (~new_n302_ & x081) | (new_n308_ & ~x070));
