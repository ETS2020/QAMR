...
module FAU ( 
  ...
  assign z06 = x046 & (~new_n226_ | (~new_n211_ & x054));
  assign new_n211_ = ~new_n212_ & ~new_n224_ & (~x078 | (~new_n216_ & ~new_n219_ & ~new_n222_));
  assign new_n212_ = (~x110 | ~x118) & (new_n215_ | (x078 & (new_n213_ | new_n214_)));
  assign new_n213_ = ~x006 & ((x022 & x070) | (x014 & x038 & ~x070));
  assign new_n214_ = x070 & x086 & (~x022 | (~x030 & (x062 | x094)));
  assign new_n215_ = ~x014 & x070 & x086;
  assign new_n216_ = ~new_n217_ & (~new_n218_ | ~x030);
  assign new_n217_ = (x006 | ~x070 | (~x022 & (~x014 | ~x038))) & (~x014 | x070 | ~x086);
  assign new_n218_ = x062 & x094;
  assign new_n219_ = ~x006 & ((~new_n220_ & x070) | (x014 & ~new_n221_ & ~x070));
  assign new_n220_ = x086 & ((x102 & x126) | (~x022 & ~x062 & ~x094));
  assign new_n221_ = (~x038 | x102) & (x126 | (~x110 & ~x118));
  assign new_n222_ = ~x030 & x086 & new_n223_ & (~x102 | ~x126);
  assign new_n223_ = (x062 | x094) & (x014 | (x022 & x070));
  assign new_n224_ = new_n225_ & x014;
  assign new_n225_ = ~x022 & ~x070;
  assign new_n226_ = (new_n227_ | x038) & (new_n231_ | ~x014) & (x014 | ~x070 | x078);
  assign new_n227_ = ~new_n230_ & (~x070 | (x054 & (~x078 | (~new_n228_ & ~new_n229_))));
  assign new_n228_ = ~x006 & (~x102 | ~x126);
  assign new_n229_ = x086 & ((x022 & ~x030) | ~x062 | ~x094);
  assign new_n230_ = x014 & (~x054 | (~x030 & x078 & x086));
  assign new_n231_ = (~x078 | (~new_n225_ & (x006 | x086))) & (x006 | x086 | (~x038 & x054));
  ...
  assign z14 = ~x046 & (new_n305_ | (x014 & (~new_n314_ | new_n321_)));
  assign new_n305_ = x070 & (new_n312_ | (~new_n313_ & x054) | (~x054 & (new_n306_ | ~new_n309_)));
  assign new_n306_ = x006 & ((~x038 & x086) | (~x078 & (new_n307_ | x086 | (~new_n308_ & ~x038))));
  assign new_n307_ = ~x022 & x126 & (~x110 | ~x118);
  assign new_n308_ = ~x102 & ~x110 & ~x118;
  assign new_n309_ = (new_n311_ | ~x022) & (x086 | (~new_n310_ & (~x022 | (~x110 & ~x118))));
  assign new_n310_ = ~x078 & (x062 | x094 | (~x022 & x030));
  assign new_n311_ = x038 & ~x078;
  assign new_n312_ = ~x014 & ((x022 & ~x054) | (x006 & x054 & x086));
  assign new_n313_ = ~x038 & (~x022 | (~x014 & x078));
  assign new_n314_ = new_n317_ & ((~x102 & ~x126) | (~new_n315_ & ~new_n320_));
  assign new_n315_ = ~x054 & ((~new_n218_ & ((x006 & ~x070) | (new_n316_ & ~x022))) | (x006 & ~x022 & ~x070));
  assign new_n316_ = x030 & ~x086;
  assign new_n317_ = new_n319_ & (x054 | (~new_n318_ & (x086 | (~x110 & ~x118))));
  assign new_n318_ = x006 & (x086 | (~x022 & x030 & ~x070));
  assign new_n319_ = ~x078 & (~x038 | (~x054 & (x022 | ~x030 | x086)));
  assign new_n320_ = x006 & x038 & ~x070;
  assign new_n321_ = ~new_n322_ & (x062 | x094);
  assign new_n322_ = (~x038 | x086) & (x054 | x070 | ~x006 | x022);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
