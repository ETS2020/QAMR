// Benchmark "FAU" written by ABC on Thu Aug  6 18:30:56 2020
...
module FAU ( 
  ...
  assign z00 = x040 & ((~new_n161_ & x008) | new_n162_ | (~new_n159_ & ~x070));
  assign new_n159_ = (x008 | (x072 & (x016 | ~x032 | x064))) & (new_n160_ | ~x032);
  assign new_n160_ = (x016 | x064 | (~x048 & ~x072)) & (x000 | ~x048 | x080);
  assign new_n161_ = (x016 | x032 | x064) & (x000 | ~x032 | x070 | x080);
  assign new_n162_ = ~x032 & ((~x000 & ~x080 & (~x008 | x072)) | ~x048 | (~x008 & ~x072));
  ...
  assign z06 = x046 & (new_n211_ | new_n215_ | (~x032 & ~new_n220_ & x078));
  ...
  assign new_n221_ = ~new_n213_ & ((~new_n222_ & x070) | (~x022 & x086));
  ...
  assign z08 = ~x040 & (new_n230_ | new_n241_ | (~x032 & (new_n233_ | ~new_n237_)));
  assign new_n230_ = x008 & (new_n232_ | new_n231_ | (x016 & ~x032 & x064));
  assign new_n231_ = ~x048 & ~x080 & ~new_n167_ & (x104 | x112);
  assign new_n232_ = x072 & (~x032 | (~x048 & ~x070));
  assign new_n233_ = x000 & ((~x008 & x080) | (~x048 & (x080 | (~new_n234_ & ~x072))));
  assign new_n234_ = (~new_n235_ | x064) & ~new_n236_ & ((~x104 & ~x112) | (x016 & ~x064));
  assign new_n235_ = (~x008 | ~x016) & (x024 | x056 | x088);
  assign new_n236_ = (x096 | x120) & (~x016 | ~x056 | x064 | ~x088);
  assign new_n237_ = (x048 | ((~x016 | ~x064) & (x072 | new_n238_ | x080))) & (~x016 | ~x064 | x072);
  assign new_n238_ = ~new_n239_ & (~x064 | (~x024 & ~x056 & ~x088)) & (~new_n240_ | ~x024);
  assign new_n239_ = (x104 | x112) & (x016 | (x024 & (~x056 | ~x088)));
  assign new_n240_ = (x096 | x120) & (~x008 | ~x016) & (~x056 | ~x088);
  assign new_n241_ = ~x070 & (new_n242_ | ~new_n250_ | (~x072 & (new_n244_ | new_n248_)));
  assign new_n242_ = ~x008 & (new_n243_ | (x016 & ~x048 & x064));
  assign new_n243_ = x024 & x032 & ~x064 & ~x072 & ~x080;
  assign new_n244_ = ~x048 & (new_n245_ | new_n247_ | (x000 & (new_n246_ | x080)));
  assign new_n245_ = (x104 | x112) & ((x016 & ~x080) | (x000 & ~x016 & ~x064));
  assign new_n246_ = ~x016 & ((~x064 & (x096 | x120)) | (x120 & (~x104 | ~x112)));
  assign new_n247_ = x064 & ~x080 & (x056 | x088 | (~x016 & x024));
  assign new_n248_ = x032 & (new_n249_ | (x000 & ~x064 & (x096 | x120)));
  assign new_n249_ = ~x080 & (x056 | x088 | (~x016 & x024));
  assign new_n250_ = (~x032 | ~x048) & (~x016 | x048 | ~x064 | ~x072);
  assign z09 = ~x041 & ~new_n167_ & (~new_n252_ | new_n255_);
  ...
  assign z10 = ~x042 & ~new_n167_ & (~new_n257_ | new_n260_);
  ...
  assign z11 = ~x043 & ~new_n167_ & (~new_n262_ | new_n265_);
  ...
  assign z12 = ~x044 & ~new_n167_ & (~new_n267_ | new_n270_);
  ...
  assign z13 = ~x045 & ~new_n167_ & (new_n296_ | ~new_n291_ | (~new_n272_ & ~x053));
  ...
  assign new_n284_ = x029 & ~x085 & (x101 | x125) & (~x061 | ~x093);
  ...
  assign z14 = ~x046 & ((~new_n298_ & (~x032 | ~x070)) | (new_n308_ & ~x070) | (~new_n302_ & ~x032));
  ...
  assign new_n306_ = x006 & ~x022 & ~x054 & ~x078 & ~new_n213_ & x126;
