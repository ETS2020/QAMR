...
module FAU ( 
  ...
  assign z08 = ~x040 & (new_n237_ | new_n257_ | (~x048 & (new_n241_ | ~new_n247_)));
  assign new_n237_ = ~new_n162_ & (~new_n238_ | new_n240_);
  assign new_n238_ = ~new_n239_ & (~x048 | (~x032 & (~x000 | x008 | ~x080)));
  assign new_n239_ = x064 & ((x016 & (x048 ^ x072)) | (~x016 & x024 & ~x048 & ~x072 & ~x080));
  assign new_n240_ = x008 & (x072 | (x016 & x048 & x064));
  assign new_n241_ = ~x080 & ((~new_n245_ & (x008 | (~new_n246_ & ~x072))) | (~new_n242_ & ~x072));
  assign new_n242_ = ~new_n243_ & (~x024 | x104 | ~new_n244_ | (~x096 & ~x120));
  assign new_n243_ = x064 & (x056 | x088) & (~x104 | (~x016 & ~x120));
  assign new_n244_ = (~x056 | ~x088) & (~x016 | (~x008 & ~x064));
  assign new_n245_ = x104 ? x120 : ~x112;
  assign new_n246_ = ~x016 & (~x024 | x064 | (x056 & x088));
  assign new_n247_ = ~new_n253_ & (~x000 | (~new_n256_ & (x072 | (~new_n248_ & ~new_n255_))));
  assign new_n248_ = ~x104 & (new_n251_ | ~new_n252_ | (~x064 & (new_n249_ | ~new_n250_)));
  assign new_n249_ = (x024 | x056 | x088) & (~x016 | (~x008 & ~x032));
  assign new_n250_ = (x016 | (~x096 & ~x112)) & ((~x096 & ~x120) | (x056 & x088));
  assign new_n251_ = ~x032 & x064 & (x096 | x112);
  assign new_n252_ = ~x080 & (x016 | ~x120);
  assign new_n253_ = new_n254_ & x016;
  assign new_n254_ = x064 & (~x008 | ~x032) & (~x104 | (x080 & ~x120));
  assign new_n255_ = ~x120 & ((x064 & x080) | (x104 & (~x064 | (~x016 & ~x032))));
  assign new_n256_ = ~x032 & x080 & (~x104 | (x072 & ~x120));
  assign new_n257_ = x032 & ~new_n258_ & ~x072;
  assign new_n258_ = (x104 | ((new_n260_ | x080) & (new_n259_ | x064))) & (x064 | ~new_n261_ | x080);
  assign new_n259_ = (x008 | ~x024 | x080) & (~x000 | (~x096 & ~x120));
  assign new_n260_ = ~x056 & ~x088 & (x016 | ~x024);
  assign new_n261_ = ~x120 & (x056 | x088);
  ...
  assign new_n284_ = ~new_n285_ & ((x013 & ~x085) | (~x077 & (new_n286_ | (~new_n287_ & ~x085))));
  ...
  assign new_n292_ = ~x069 & ((new_n295_ & ~x013) | (x005 & (new_n293_ | new_n294_)));
  assign new_n293_ = (x029 | x061 | x093) & (~x021 | (~x013 & ~x037));
  ...
  assign new_n310_ = ~new_n311_ & ((x014 & ~x086) | (~x078 & (new_n312_ | (~new_n313_ & ~x086))));
  ...
  assign new_n319_ = (x030 | x062 | x094) & (~x022 | (~x014 & ~x038));
