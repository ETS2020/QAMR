...
module FAU ( 
  ...
  assign z06 = x046 & ((~new_n211_ & (x070 | x094)) | (~new_n215_ & x094) | (new_n225_ & x070));
  ...
  assign new_n215_ = (x070 | (~new_n224_ & (new_n216_ | ~x054))) & (~x054 | new_n219_ | ~x078);
  assign new_n216_ = (~x078 | (~new_n217_ & ~new_n218_)) & (x022 | (~x014 & ~x038 & x078));
  assign new_n217_ = ~x006 & x038 & (~x110 | ~x118);
  assign new_n218_ = x086 & (~x062 | (x022 & ~x030));
  assign new_n219_ = (new_n220_ | new_n221_) & ~new_n223_ & (new_n222_ | x006);
  assign new_n220_ = x102 & x126;
  assign new_n221_ = (x030 | ~x086 | (~x022 & (~x014 | ~x070))) & (x006 | ~x070);
  assign new_n222_ = (~x038 | x102) & (~x022 | x126 | (~x110 & ~x118));
  assign new_n223_ = ~x030 & x070 & x086 & (~x110 | ~x118);
  assign new_n224_ = ~x022 & ~x054 & (~x014 | x078);
  assign new_n225_ = x078 & (new_n230_ | (x054 & (new_n226_ | (new_n229_ & ~x030))));
  assign new_n226_ = ~x006 & (new_n228_ | (~new_n227_ & x022) | (~new_n220_ & (x022 | x062)));
  assign new_n227_ = x110 & x118;
  assign new_n228_ = (x022 | (x014 & x038)) & (~x030 | ~x062 | ~x094);
  assign new_n229_ = x062 & x086 & (~new_n227_ | (~new_n220_ & (x014 | x022)));
  assign new_n230_ = ~x038 & (new_n231_ | (~new_n220_ & ~x006));
  ...
  assign z14 = ~x046 & (new_n305_ | (new_n319_ & x022) | (~new_n309_ & ~x078));
  assign new_n305_ = ~new_n162_ & (new_n308_ | new_n306_ | (x014 & x078));
  assign new_n306_ = ~x054 & (new_n307_ | (x006 & x086 & (~x038 | ~x078)));
  assign new_n307_ = x014 & ~x086 & (x110 | x118);
  assign new_n308_ = x054 & (x038 | (x006 & ~x014 & x086));
  assign new_n309_ = ~new_n315_ & (~x094 | (~new_n318_ & (x054 | (~new_n310_ & ~new_n313_))));
  assign new_n310_ = ~x086 & (~new_n312_ | (x030 & ~new_n311_ & ~x062));
  assign new_n311_ = ~x110 & ~x118 & ((~x102 & ~x126) | (x014 & x022));
  assign new_n312_ = ~x070 & (~x022 | (~x110 & ~x118));
  assign new_n313_ = new_n314_ & x006;
  assign new_n314_ = ~x070 & (~x014 | ~x022 | (~x062 & (x102 | x126)));
  assign new_n315_ = x070 & (x054 ? x022 : (new_n316_ | (~new_n317_ & x006)));
  assign new_n316_ = ~x086 & (x062 | (~x022 & x030));
  assign new_n317_ = (x022 | ~x126 | (x110 & x118)) & (x038 | (~x102 & ~x110 & ~x118));
  assign new_n318_ = x038 & (~x086 | (x006 & ~x070));
  assign new_n319_ = x070 & (x054 ? x014 : (new_n320_ | ~x014 | ~x038 | x078));
  assign new_n320_ = ~x086 & (x110 | x118);
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
