...
module FAU ( 
  ...
  assign z06 = x046 & (new_n219_ | ((~new_n211_ | new_n230_) & x070));
  assign new_n211_ = x078 ? (~new_n218_ & (~x054 | (~new_n212_ & ~new_n217_))) : x014;
  assign new_n212_ = ~x006 & (new_n213_ | (~new_n216_ & x022) | (~new_n214_ & (~new_n215_ | x022)));
  ...
  assign new_n217_ = ~x030 & x086 & ~new_n215_ & (~new_n216_ | (~new_n214_ & x014));
  assign new_n218_ = ~x038 & ((~new_n214_ & ~x006) | (x014 & ~x030 & x086));
  assign new_n219_ = x054 & (~new_n227_ | (x078 & (new_n220_ | new_n221_ | new_n225_)));
  assign new_n220_ = ~new_n216_ & ((~x022 & x086) | (~x006 & x038 & ~x070));
  assign new_n221_ = x086 & ((x022 & ~x030 & (new_n223_ | ~new_n224_)) | (~new_n222_ & ~new_n224_));
  assign new_n222_ = x062 & x094;
  assign new_n223_ = (x062 | x094) & (~x102 | ~x126);
  assign new_n224_ = x038 & x070;
  assign new_n225_ = ~x006 & (~new_n226_ | (x022 & ~x126 & (x110 | x118)));
  assign new_n226_ = x086 & (~x038 | x070 | x102);
  assign new_n227_ = ~new_n228_ & (x022 | x070 | (~x014 & x078)) & (x014 | (~new_n229_ & x078));
  assign new_n228_ = x038 & ((~x022 & ~x070) | (~x006 & ~x086));
  assign new_n229_ = x086 & (~x110 | ~x118);
  assign new_n230_ = ~x054 & (~x038 | (~x006 & x014 & ~x086));
  ...
  assign z14 = ~x046 & (new_n314_ | new_n313_ | (~new_n304_ & x070));
  assign new_n304_ = ~new_n305_ & ~new_n312_ & (x054 | (~new_n307_ & ~new_n309_ & ~new_n311_));
  assign new_n305_ = x022 & (x054 ? (x014 | ~x078) : (new_n306_ | ~x038 | x078));
  assign new_n306_ = ~x086 & (x110 | x118);
  assign new_n307_ = ~new_n308_ & (x110 | x118);
  assign new_n308_ = (~x014 | x086) & (~x006 | x038 | x078);
  assign new_n309_ = x006 & ((~x078 & (new_n310_ | x086 | (~x038 & x102))) | (~x038 & x086));
  assign new_n310_ = ~x022 & x126 & (~x110 | ~x118);
  assign new_n311_ = ~x078 & ~x086 & (~new_n215_ | (~x022 & x030));
  assign new_n312_ = x014 & x078;
  assign new_n313_ = x054 & (new_n312_ | x038);
  assign new_n314_ = ~x014 & ((x022 & ~x054 & x070) | (x006 & x054 & x086));
  assign z07 = 1'b0;
  assign z15 = 1'b0;
  assign z16 = 1'b0;
  assign z17 = 1'b0;
