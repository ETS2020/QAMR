...
module FAU ( 
  ...
  assign z3 = (~x6 & (x0 ? ~new_n34_ : (~new_n39_ & x5))) | (~new_n36_ & x0);
  ...
  assign new_n42_ = (x3 | (x8 & (x4 | x7))) & x0 & ~x6 & (x4 | x7 | x8);
endmodule
