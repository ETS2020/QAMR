...
module FAU ( 
  ...
  assign z1 = new_n21_ | (~new_n19_ & x0);
  assign new_n19_ = (~x6 | ((~x1 | x2 | (~x4 ^ ~x7)) & (~x2 | (~x4 ^ x7)))) & ~new_n20_ & (x1 | (~x4 ^ x7));
  assign new_n20_ = ~x5 & ~x6 & ((x3 & x8) | ((x3 | x8) & (x4 | x7)));
  assign new_n21_ = ~x6 & ((x1 & x2 & (x4 ^ ~x7)) | ((x4 ^ x7) & (~x1 | ~x2)));
  assign z2 = (~new_n23_ & x0) | (~new_n26_ & ~x6);
  assign new_n23_ = (x5 | x6 | (~x3 & ~x8)) & ~new_n25_ & (new_n24_ | ~x6);
  ...
  assign z3 = (~new_n28_ & ~x6) | (x0 & ((~new_n32_ & ~x3) | (new_n33_ & x6)));
  assign new_n28_ = x0 ? (new_n31_ & (new_n30_ | (x3 & x8))) : ((~x3 | ~x8) & (new_n29_ | (~x3 & ~x8)));
  assign new_n29_ = (~x4 | ~x7) & (~x1 | ~x2 | (~x4 & ~x7));
  assign new_n30_ = (x2 | (x4 & x7)) & (x7 | (x1 & x4));
  assign new_n31_ = x5 & (x8 | (x3 & (x1 | x4)));
  assign new_n32_ = (x1 | (x4 & (~x6 | ~x7))) & (~x6 | ((~x2 | (x4 & ~x7)) & ~x8 & (x4 | ~x7)));
  assign new_n33_ = x8 & ((~x4 & x7) | ((~x4 | x7) & (~x1 | x2)));
  assign z4 = x5 & (x0 ? ~new_n35_ : ~x6);
