...
module FAU ( 
  ...
  and2   g045(.a(x20), .b(x18), .O(new_n79_));
  nand3  g046(.a(new_n79_), .b(x23), .c(x22), .O(new_n80_));
  nor2   g047(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  nand3  g048(.a(new_n81_), .b(new_n58_), .c(new_n56_), .O(new_n82_));
  inv1   g049(.a(x08), .O(new_n83_));
  inv1   g050(.a(x07), .O(new_n84_));
  nor2   g051(.a(new_n84_), .b(x06), .O(new_n85_));
  nand4  g052(.a(new_n85_), .b(new_n64_), .c(new_n63_), .d(new_n83_), .O(new_n86_));
  ...
  nand4  g059(.a(new_n92_), .b(new_n71_), .c(new_n37_), .d(new_n87_), .O(new_n93_));
  oai21  g060(.a(new_n93_), .b(new_n86_), .c(new_n82_), .O(new_n94_));
  nand3  g061(.a(new_n94_), .b(new_n74_), .c(x24), .O(new_n95_));
  nand4  g062(.a(x08), .b(x06), .c(x04), .d(x03), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  nor2   g064(.a(new_n88_), .b(new_n36_), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n97_), .c(new_n45_), .d(x09), .O(new_n99_));
  ...
  nand3  g077(.a(new_n45_), .b(new_n63_), .c(new_n83_), .O(new_n111_));
  ...
  nand4  g082(.a(new_n115_), .b(new_n112_), .c(new_n110_), .d(new_n92_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n106_), .c(new_n95_), .d(new_n77_), .O(z1));
  ...
  nor2   g100(.a(new_n36_), .b(new_n83_), .O(new_n134_));
  ...
  nand4  g106(.a(new_n139_), .b(new_n138_), .c(new_n70_), .d(new_n65_), .O(new_n140_));
  oai21  g107(.a(new_n137_), .b(new_n133_), .c(new_n140_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n76_), .O(new_n142_));
  nand3  g109(.a(new_n134_), .b(new_n79_), .c(x14), .O(new_n143_));
  nor2   g110(.a(x11), .b(x08), .O(new_n144_));
  nor2   g111(.a(x20), .b(x14), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n144_), .c(new_n138_), .d(new_n85_), .O(new_n146_));
  oai21  g113(.a(new_n143_), .b(new_n133_), .c(new_n146_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n74_), .c(x24), .O(new_n148_));
  nor2   g115(.a(new_n34_), .b(x02), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n45_), .c(x08), .d(x06), .O(new_n150_));
  inv1   g117(.a(x21), .O(new_n151_));
  nor2   g118(.a(x24), .b(new_n151_), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(x20), .c(x14), .d(x11), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n150_), .c(new_n44_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(x01), .O(new_n155_));
  nor3   g122(.a(x06), .b(x03), .c(x02), .O(new_n156_));
  nor3   g123(.a(x11), .b(x10), .c(x08), .O(new_n157_));
  nor3   g124(.a(x24), .b(x20), .c(x14), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n157_), .c(new_n156_), .d(new_n108_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n155_), .c(new_n148_), .d(new_n142_), .O(z3));
  inv1   g127(.a(x04), .O(new_n161_));
  oai21  g128(.a(x23), .b(new_n161_), .c(new_n87_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n113_), .c(x09), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x16), .c(new_n83_), .O(new_n164_));
  oai21  g131(.a(new_n49_), .b(new_n42_), .c(new_n164_), .O(new_n165_));
  inv1   g132(.a(new_n122_), .O(new_n166_));
  oai21  g133(.a(new_n102_), .b(x04), .c(x17), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x22), .c(new_n63_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n90_), .c(x08), .O(new_n169_));
  nand3  g136(.a(new_n152_), .b(new_n45_), .c(new_n44_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n124_), .c(new_n123_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n166_), .c(new_n169_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n165_), .c(new_n53_), .O(z4));
  nand4  g140(.a(new_n53_), .b(new_n48_), .c(new_n46_), .d(new_n43_), .O(new_n174_));
  or2    g141(.a(new_n174_), .b(new_n42_), .O(z5));
  aoi21  g142(.a(x20), .b(new_n89_), .c(x06), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(x11), .c(new_n34_), .O(new_n177_));
  nand2  g144(.a(new_n48_), .b(new_n43_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n42_), .c(new_n53_), .O(new_n179_));
  ...
  nand3  g150(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n53_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n170_), .O(z7));
  nand2  g153(.a(z7), .b(new_n183_), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(new_n181_), .O(z6));
endmodule
