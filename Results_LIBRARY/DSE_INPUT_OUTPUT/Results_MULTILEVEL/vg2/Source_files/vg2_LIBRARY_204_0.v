...
module FAU ( 
  ...
  nand4  g091(.a(new_n109_), .b(x08), .c(x06), .d(x03), .O(new_n125_));
  nor2   g092(.a(new_n37_), .b(new_n36_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n112_), .c(x20), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n125_), .c(x01), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n55_), .O(new_n129_));
  nand3  g096(.a(new_n59_), .b(x03), .c(x01), .O(new_n130_));
  nand3  g097(.a(new_n126_), .b(x20), .c(x15), .O(new_n131_));
  nand3  g098(.a(new_n81_), .b(new_n34_), .c(new_n108_), .O(new_n132_));
  ...
  nand4  g122(.a(new_n112_), .b(new_n109_), .c(new_n55_), .d(x01), .O(new_n156_));
  oai21  g123(.a(new_n147_), .b(new_n155_), .c(new_n156_), .O(z7));
  nand2  g124(.a(z7), .b(new_n154_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n151_), .O(z4));
  aoi21  g126(.a(new_n148_), .b(x00), .c(new_n108_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x02), .c(new_n146_), .O(z5));
  aoi21  g128(.a(x20), .b(new_n37_), .c(x06), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x11), .c(new_n34_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n150_), .O(new_n164_));
  aoi21  g131(.a(new_n38_), .b(x14), .c(new_n35_), .O(new_n165_));
