...
module FAU ( 
  ...
  aoi21  g093(.a(new_n126_), .b(x22), .c(new_n71_), .O(z2));
  ...
  nor2   g104(.a(new_n68_), .b(new_n36_), .O(new_n138_));
  ...
  nor2   g116(.a(x22), .b(new_n71_), .O(new_n150_));
  inv1   g117(.a(new_n150_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n149_), .c(new_n143_), .d(new_n135_), .O(z3));
  oai21  g119(.a(new_n73_), .b(x04), .c(x17), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x22), .c(new_n67_), .O(new_n154_));
  nor2   g121(.a(new_n154_), .b(new_n69_), .O(new_n155_));
  nor2   g122(.a(new_n155_), .b(new_n66_), .O(new_n156_));
  inv1   g123(.a(new_n49_), .O(new_n157_));
  aoi21  g124(.a(new_n73_), .b(x04), .c(x17), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x22), .c(new_n67_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n69_), .c(new_n66_), .O(new_n160_));
  oai21  g127(.a(new_n150_), .b(new_n66_), .c(new_n160_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n157_), .c(new_n150_), .O(new_n162_));
  oai21  g129(.a(new_n156_), .b(new_n124_), .c(new_n162_), .O(z4));
  nor2   g130(.a(new_n150_), .b(new_n49_), .O(z5));
  ...
  nand3  g135(.a(new_n138_), .b(x21), .c(new_n71_), .O(new_n169_));
  nand2  g136(.a(new_n36_), .b(x00), .O(new_n170_));
  nand3  g137(.a(x22), .b(x20), .c(new_n68_), .O(new_n171_));
  ...
  nand4  g141(.a(new_n146_), .b(x22), .c(x20), .d(x19), .O(new_n175_));
  ...
  nand4  g154(.a(new_n187_), .b(new_n151_), .c(new_n122_), .d(new_n186_), .O(z7));
endmodule
