...
module FAU ( 
  ...
  nand2  g093(.a(new_n126_), .b(new_n85_), .O(new_n127_));
  nand4  g094(.a(new_n43_), .b(x19), .c(new_n42_), .d(new_n41_), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n125_), .c(new_n92_), .O(new_n130_));
  inv1   g097(.a(new_n123_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n95_), .c(x14), .O(new_n132_));
  nor2   g099(.a(x11), .b(x08), .O(new_n133_));
  nor2   g100(.a(x20), .b(x14), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n133_), .c(new_n126_), .d(new_n100_), .O(new_n135_));
  oai21  g102(.a(new_n132_), .b(new_n122_), .c(new_n135_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n90_), .c(x24), .O(new_n137_));
  nor2   g104(.a(x01), .b(new_n38_), .O(new_n138_));
  ...
  oai21  g111(.a(x23), .b(new_n144_), .c(new_n68_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n65_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n83_), .c(x16), .O(new_n147_));
  nor2   g114(.a(new_n56_), .b(new_n52_), .O(new_n148_));
  nor2   g115(.a(x02), .b(new_n35_), .O(new_n149_));
  nand4  g116(.a(new_n138_), .b(new_n44_), .c(new_n37_), .d(new_n34_), .O(new_n150_));
  oai21  g117(.a(new_n149_), .b(new_n148_), .c(new_n150_), .O(new_n151_));
  oai21  g118(.a(new_n147_), .b(x08), .c(new_n151_), .O(new_n152_));
  inv1   g119(.a(x23), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x04), .c(x17), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x22), .c(new_n83_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n67_), .c(x08), .O(new_n156_));
  inv1   g123(.a(new_n117_), .O(new_n157_));
  nand3  g124(.a(new_n44_), .b(x21), .c(new_n37_), .O(new_n158_));
  inv1   g125(.a(new_n158_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n34_), .c(new_n35_), .O(new_n160_));
  oai21  g127(.a(new_n149_), .b(new_n157_), .c(new_n160_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n156_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n152_), .O(z4));
  nand3  g130(.a(new_n44_), .b(new_n37_), .c(x00), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n35_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n34_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n148_), .O(z5));
  aoi21  g134(.a(x20), .b(new_n42_), .c(x06), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(x11), .c(new_n48_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n151_), .O(new_n170_));
  aoi21  g137(.a(new_n43_), .b(x14), .c(new_n36_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n41_), .c(x03), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n161_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n170_), .O(z6));
  oai21  g141(.a(new_n159_), .b(x01), .c(new_n34_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n157_), .O(z7));
endmodule
