...
module FAU ( 
  ...
  aoi21  g076(.a(new_n109_), .b(new_n108_), .c(new_n47_), .O(new_n110_));
  nand3  g077(.a(x24), .b(x18), .c(x13), .O(new_n111_));
  nand3  g078(.a(x15), .b(new_n53_), .c(new_n47_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(new_n110_), .c(x20), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(new_n41_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x11), .c(x06), .d(x03), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(x02), .c(new_n35_), .O(z2));
  nand3  g084(.a(new_n73_), .b(new_n36_), .c(x00), .O(new_n118_));
  nand4  g085(.a(new_n42_), .b(new_n41_), .c(new_n40_), .d(new_n38_), .O(new_n119_));
  ...
  nand2  g091(.a(new_n124_), .b(new_n73_), .O(new_n125_));
  nand3  g092(.a(new_n78_), .b(new_n41_), .c(new_n40_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n125_), .c(new_n123_), .d(new_n122_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n84_), .O(new_n128_));
  nand3  g095(.a(new_n88_), .b(x14), .c(x11), .O(new_n129_));
  nand3  g096(.a(new_n124_), .b(x07), .c(new_n37_), .O(new_n130_));
  nand4  g097(.a(new_n46_), .b(new_n41_), .c(new_n40_), .d(new_n101_), .O(new_n131_));
  ...
  oai21  g104(.a(new_n137_), .b(x16), .c(new_n101_), .O(new_n138_));
  nor2   g105(.a(x02), .b(new_n35_), .O(new_n139_));
  inv1   g106(.a(new_n139_), .O(new_n140_));
  oai21  g107(.a(new_n55_), .b(new_n51_), .c(new_n140_), .O(new_n141_));
  nor2   g108(.a(x24), .b(x10), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n141_), .O(z5));
  nand2  g111(.a(z5), .b(new_n138_), .O(new_n145_));
  oai21  g112(.a(new_n68_), .b(x04), .c(x17), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x22), .c(new_n71_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n93_), .c(x08), .O(new_n148_));
  nor2   g115(.a(new_n113_), .b(new_n110_), .O(new_n149_));
  nor2   g116(.a(x02), .b(x01), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n49_), .c(x21), .d(new_n38_), .O(new_n151_));
  oai21  g118(.a(new_n139_), .b(new_n149_), .c(new_n151_), .O(z7));
  nand2  g119(.a(z7), .b(new_n148_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n145_), .O(z4));
  nand2  g121(.a(x20), .b(new_n41_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n37_), .c(x11), .O(new_n156_));
  nand3  g123(.a(new_n142_), .b(new_n34_), .c(x00), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n54_), .c(new_n52_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n51_), .c(new_n156_), .d(x03), .O(new_n159_));
  oai21  g126(.a(x20), .b(new_n41_), .c(x06), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(x11), .c(x03), .O(new_n161_));
  inv1   g128(.a(new_n161_), .O(new_n162_));
  nand4  g129(.a(new_n49_), .b(x21), .c(new_n38_), .d(new_n34_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n112_), .c(new_n111_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n110_), .c(new_n162_), .d(new_n124_), .O(new_n165_));
  nor2   g132(.a(new_n149_), .b(x03), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(x02), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n165_), .c(new_n159_), .d(new_n140_), .O(z6));
endmodule
