...
module FAU ( 
  ...
  oai21  g108(.a(new_n141_), .b(new_n53_), .c(new_n138_), .O(new_n142_));
  inv1   g109(.a(x23), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x04), .c(x17), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x22), .c(new_n84_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n68_), .c(x08), .O(new_n146_));
  inv1   g113(.a(x21), .O(new_n147_));
  nor2   g114(.a(x24), .b(new_n147_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n37_), .c(new_n34_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n111_), .c(new_n110_), .d(new_n109_), .O(new_n150_));
  nor2   g117(.a(x02), .b(new_n35_), .O(new_n151_));
  aoi21  g118(.a(new_n150_), .b(new_n146_), .c(new_n151_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n142_), .O(z4));
  nor2   g120(.a(new_n57_), .b(new_n53_), .O(new_n154_));
  aoi21  g121(.a(new_n139_), .b(x00), .c(x01), .O(new_n155_));
  ...
  aoi21  g128(.a(new_n48_), .b(x14), .c(new_n36_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n41_), .c(x03), .O(new_n163_));
  inv1   g130(.a(new_n151_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n113_), .O(new_n165_));
  nand4  g132(.a(new_n148_), .b(new_n37_), .c(new_n34_), .d(new_n35_), .O(new_n166_));
