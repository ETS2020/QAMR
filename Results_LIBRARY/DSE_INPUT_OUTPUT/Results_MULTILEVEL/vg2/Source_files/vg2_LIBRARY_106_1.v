...
module FAU ( 
  ...
  nand4  g048(.a(new_n81_), .b(new_n80_), .c(new_n61_), .d(new_n57_), .O(new_n82_));
  nor2   g049(.a(x09), .b(x08), .O(new_n83_));
  nand4  g050(.a(new_n83_), .b(new_n64_), .c(x07), .d(new_n34_), .O(new_n84_));
  ...
  nand4  g058(.a(new_n91_), .b(new_n80_), .c(new_n61_), .d(new_n57_), .O(new_n92_));
  ...
  nand3  g064(.a(new_n97_), .b(new_n90_), .c(new_n78_), .O(new_n98_));
  nand2  g065(.a(new_n98_), .b(new_n49_), .O(new_n99_));
  nand2  g066(.a(new_n90_), .b(new_n78_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(x00), .O(new_n101_));
  ...
  nor3   g082(.a(new_n115_), .b(new_n104_), .c(new_n103_), .O(z2));
  ...
  nand4  g095(.a(new_n128_), .b(new_n34_), .c(new_n104_), .d(new_n103_), .O(new_n129_));
  ...
  nand3  g099(.a(new_n81_), .b(x14), .c(x11), .O(new_n133_));
  nand3  g100(.a(new_n93_), .b(x07), .c(new_n34_), .O(new_n134_));
  ...
  nand2  g105(.a(new_n93_), .b(new_n65_), .O(new_n139_));
  nand3  g106(.a(new_n70_), .b(new_n36_), .c(new_n35_), .O(new_n140_));
  ...
  inv1   g115(.a(new_n108_), .O(new_n149_));
  and2   g116(.a(new_n113_), .b(new_n110_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n109_), .c(new_n149_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  aoi21  g119(.a(new_n145_), .b(x04), .c(x17), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x22), .c(new_n63_), .O(new_n154_));
  inv1   g121(.a(x07), .O(new_n155_));
  oai21  g122(.a(new_n74_), .b(new_n155_), .c(new_n46_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(x24), .c(new_n117_), .O(new_n157_));
  nand2  g124(.a(x13), .b(x05), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n75_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n38_), .c(x19), .O(new_n160_));
  ...
  nand3  g130(.a(new_n163_), .b(new_n154_), .c(new_n144_), .O(new_n164_));
  nand2  g131(.a(new_n51_), .b(new_n48_), .O(z5));
  nand2  g132(.a(z5), .b(x08), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n164_), .c(new_n152_), .d(new_n38_), .O(z4));
  nand2  g134(.a(new_n113_), .b(new_n112_), .O(new_n168_));
  aoi21  g135(.a(new_n105_), .b(x14), .c(new_n34_), .O(new_n169_));
  ...
  oai21  g139(.a(new_n172_), .b(x11), .c(new_n104_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(z5), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n171_), .O(z6));
  nand4  g142(.a(new_n150_), .b(new_n109_), .c(new_n149_), .d(new_n38_), .O(z7));
endmodule
