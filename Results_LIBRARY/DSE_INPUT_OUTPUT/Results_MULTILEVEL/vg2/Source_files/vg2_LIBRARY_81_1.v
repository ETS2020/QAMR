...
module FAU ( 
  ...
  oai21  g125(.a(x23), .b(new_n60_), .c(new_n71_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n92_), .c(x09), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x16), .c(new_n90_), .O(new_n161_));
  nand4  g128(.a(new_n42_), .b(new_n59_), .c(new_n34_), .d(x00), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n53_), .c(new_n51_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n50_), .c(new_n161_), .O(new_n164_));
  oai21  g131(.a(new_n93_), .b(x04), .c(x17), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x22), .c(new_n91_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n73_), .c(x08), .O(new_n167_));
  nand4  g134(.a(new_n42_), .b(x21), .c(new_n59_), .d(new_n34_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n132_), .c(new_n131_), .d(new_n81_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  nand2  g137(.a(x05), .b(new_n34_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n170_), .c(new_n164_), .O(z4));
  ...
  oai21  g143(.a(new_n41_), .b(x14), .c(new_n38_), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(new_n47_), .c(x03), .O(new_n178_));
  nand3  g145(.a(new_n162_), .b(new_n94_), .c(new_n51_), .O(new_n179_));
  aoi22  g146(.a(new_n179_), .b(new_n35_), .c(new_n50_), .d(x02), .O(new_n180_));
  aoi21  g147(.a(new_n41_), .b(x14), .c(new_n38_), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(new_n47_), .c(x03), .O(new_n182_));
  nand3  g149(.a(new_n168_), .b(new_n81_), .c(new_n80_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n35_), .O(new_n184_));
  oai21  g151(.a(new_n131_), .b(new_n34_), .c(new_n184_), .O(z7));
  nand2  g152(.a(z7), .b(new_n182_), .O(new_n186_));
  oai21  g153(.a(new_n180_), .b(new_n178_), .c(new_n186_), .O(z6));
endmodule
