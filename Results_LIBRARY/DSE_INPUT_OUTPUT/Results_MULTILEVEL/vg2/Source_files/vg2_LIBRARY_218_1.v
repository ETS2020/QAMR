...
module FAU ( 
  ...
  nand4  g125(.a(new_n158_), .b(new_n142_), .c(new_n44_), .d(new_n157_), .O(z5));
  ...
  and2   g134(.a(new_n114_), .b(new_n113_), .O(new_n168_));
  nand4  g135(.a(new_n142_), .b(new_n168_), .c(new_n112_), .d(new_n167_), .O(z7));
endmodule
