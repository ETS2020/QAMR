...
module FAU ( 
  ...
  and2   g112(.a(new_n145_), .b(new_n111_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n110_), .c(new_n144_), .O(new_n147_));
  ...
  nand4  g117(.a(new_n149_), .b(new_n48_), .c(new_n46_), .d(new_n43_), .O(new_n151_));
  or2    g118(.a(new_n151_), .b(new_n42_), .O(z5));
  aoi21  g119(.a(x20), .b(new_n72_), .c(x06), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x11), .c(new_n34_), .O(new_n154_));
  nand2  g121(.a(new_n48_), .b(new_n43_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n42_), .c(new_n149_), .O(new_n156_));
  ...
  nand4  g132(.a(new_n149_), .b(new_n146_), .c(new_n110_), .d(new_n144_), .O(z7));
endmodule
