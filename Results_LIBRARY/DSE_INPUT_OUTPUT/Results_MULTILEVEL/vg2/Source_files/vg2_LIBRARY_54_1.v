...
module FAU ( 
  ...
  nand4  g024(.a(new_n57_), .b(new_n41_), .c(new_n36_), .d(new_n35_), .O(new_n58_));
  ...
  nor2   g055(.a(new_n43_), .b(new_n88_), .O(new_n89_));
  ...
  nand4  g060(.a(new_n93_), .b(new_n72_), .c(new_n71_), .d(new_n91_), .O(new_n94_));
  ...
  nand4  g083(.a(new_n116_), .b(x11), .c(x06), .d(x01), .O(new_n117_));
  ...
  nand3  g095(.a(new_n128_), .b(new_n89_), .c(x14), .O(new_n129_));
  nor2   g096(.a(x11), .b(x08), .O(new_n130_));
  nor2   g097(.a(x20), .b(x14), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n130_), .c(new_n123_), .d(new_n93_), .O(new_n132_));
  ...
  oai21  g109(.a(new_n142_), .b(x16), .c(new_n91_), .O(new_n143_));
  nor2   g110(.a(new_n55_), .b(new_n51_), .O(new_n144_));
  nor2   g111(.a(new_n35_), .b(x02), .O(new_n145_));
  nor2   g112(.a(x24), .b(x10), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n35_), .c(new_n34_), .d(x00), .O(new_n147_));
  oai21  g114(.a(new_n145_), .b(new_n144_), .c(new_n147_), .O(z5));
  nand2  g115(.a(z5), .b(new_n143_), .O(new_n149_));
  oai21  g116(.a(new_n68_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n71_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n96_), .c(x08), .O(new_n152_));
  nor2   g119(.a(new_n114_), .b(new_n112_), .O(new_n153_));
  nand3  g120(.a(new_n44_), .b(x21), .c(new_n37_), .O(new_n154_));
  inv1   g121(.a(new_n154_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n35_), .c(new_n34_), .O(new_n156_));
  ...
  oai21  g126(.a(new_n43_), .b(x14), .c(new_n36_), .O(new_n160_));
  nand3  g127(.a(new_n146_), .b(new_n34_), .c(x00), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n54_), .c(new_n52_), .O(new_n162_));
  or2    g129(.a(new_n162_), .b(new_n51_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n41_), .O(new_n164_));
  oai21  g131(.a(new_n155_), .b(x03), .c(new_n34_), .O(new_n165_));
  oai21  g132(.a(x20), .b(new_n42_), .c(x06), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x11), .c(new_n35_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n88_), .c(new_n92_), .d(new_n35_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n82_), .c(x24), .O(new_n169_));
  inv1   g136(.a(x15), .O(new_n170_));
  oai22  g137(.a(new_n167_), .b(new_n170_), .c(new_n77_), .d(new_n35_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n84_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n169_), .c(new_n165_), .d(new_n164_), .O(z6));
  nand2  g140(.a(new_n165_), .b(new_n153_), .O(z7));
endmodule
