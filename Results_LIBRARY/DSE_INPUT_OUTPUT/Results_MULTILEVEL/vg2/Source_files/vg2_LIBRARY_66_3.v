...
module FAU ( 
  ...
  nand4  g076(.a(new_n109_), .b(x11), .c(x06), .d(x01), .O(new_n110_));
  aoi21  g077(.a(new_n110_), .b(new_n44_), .c(new_n34_), .O(z2));
  nand4  g078(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n112_));
  nor2   g079(.a(new_n71_), .b(new_n36_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(x20), .c(x15), .O(new_n114_));
  nand3  g081(.a(new_n95_), .b(new_n66_), .c(new_n35_), .O(new_n115_));
  nand4  g082(.a(new_n37_), .b(x19), .c(new_n71_), .d(new_n36_), .O(new_n116_));
  oai22  g083(.a(new_n116_), .b(new_n115_), .c(new_n114_), .d(new_n112_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n80_), .O(new_n118_));
  nand3  g085(.a(new_n113_), .b(x20), .c(x18), .O(new_n119_));
  nand3  g086(.a(new_n95_), .b(x07), .c(new_n35_), .O(new_n120_));
  nand4  g087(.a(new_n37_), .b(new_n71_), .c(new_n36_), .d(new_n66_), .O(new_n121_));
  oai22  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n112_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(new_n78_), .c(x24), .O(new_n123_));
  nand4  g090(.a(new_n45_), .b(x08), .c(x06), .d(x01), .O(new_n124_));
  ...
  nand2  g095(.a(new_n128_), .b(x03), .O(new_n129_));
  ...
  oai21  g103(.a(x23), .b(new_n55_), .c(new_n73_), .O(new_n137_));
  ...
  nand2  g108(.a(new_n141_), .b(new_n46_), .O(z5));
  nand2  g109(.a(z5), .b(new_n139_), .O(new_n143_));
  ...
  nand2  g114(.a(new_n105_), .b(new_n104_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n103_), .c(new_n53_), .O(new_n149_));
  nand3  g116(.a(new_n126_), .b(new_n45_), .c(new_n44_), .O(new_n150_));
  ...
  nand3  g122(.a(new_n155_), .b(new_n154_), .c(new_n36_), .O(new_n156_));
  ...
  nand3  g128(.a(new_n161_), .b(new_n78_), .c(x24), .O(new_n162_));
  inv1   g129(.a(x15), .O(new_n163_));
  nand2  g130(.a(x19), .b(x03), .O(new_n164_));
  oai21  g131(.a(new_n159_), .b(new_n163_), .c(new_n164_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n80_), .O(new_n166_));
  nand3  g133(.a(new_n158_), .b(x21), .c(x11), .O(new_n167_));
  ...
  nor3   g137(.a(new_n106_), .b(x03), .c(x02), .O(new_n171_));
  aoi21  g138(.a(new_n170_), .b(x03), .c(new_n171_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n166_), .c(new_n162_), .d(new_n156_), .O(z6));
  inv1   g140(.a(new_n103_), .O(new_n174_));
  nand2  g141(.a(new_n106_), .b(new_n44_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(x03), .O(new_n176_));
  inv1   g143(.a(new_n105_), .O(new_n177_));
  nor2   g144(.a(new_n171_), .b(new_n177_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n176_), .c(new_n104_), .d(new_n174_), .O(z7));
endmodule
