...
module FAU ( 
  ...
  nand4  g030(.a(new_n63_), .b(new_n60_), .c(new_n53_), .d(new_n52_), .O(new_n64_));
  ...
  and2   g076(.a(new_n109_), .b(new_n104_), .O(new_n110_));
  aoi21  g077(.a(new_n110_), .b(new_n97_), .c(new_n54_), .O(z3));
  ...
  nand2  g088(.a(x08), .b(x07), .O(new_n122_));
  oai21  g089(.a(new_n121_), .b(x08), .c(new_n122_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n98_), .c(x24), .O(new_n124_));
  nand3  g091(.a(new_n118_), .b(new_n46_), .c(new_n37_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n120_), .c(new_n55_), .O(new_n127_));
  inv1   g094(.a(new_n79_), .O(new_n128_));
  inv1   g095(.a(x22), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(x09), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n128_), .c(new_n53_), .d(x16), .O(new_n131_));
  inv1   g098(.a(new_n49_), .O(new_n132_));
  aoi21  g099(.a(new_n61_), .b(x04), .c(x17), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(x22), .c(new_n58_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n132_), .c(new_n52_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n131_), .c(new_n127_), .O(z4));
  inv1   g103(.a(new_n41_), .O(new_n137_));
  and2   g104(.a(new_n45_), .b(new_n42_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n55_), .c(new_n47_), .d(new_n137_), .O(z5));
  nand2  g106(.a(x20), .b(new_n71_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n35_), .c(x11), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x03), .c(new_n132_), .O(new_n142_));
  nand2  g109(.a(new_n60_), .b(x14), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(x06), .c(new_n36_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n34_), .c(new_n128_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n142_), .c(new_n54_), .O(z6));
  inv1   g113(.a(new_n74_), .O(new_n147_));
  and2   g114(.a(new_n76_), .b(new_n75_), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n77_), .c(new_n147_), .d(new_n55_), .O(z7));
endmodule
