...
module FAU ( 
  ...
  nand4  g079(.a(new_n112_), .b(x06), .c(x03), .d(x02), .O(new_n113_));
  nor2   g080(.a(new_n113_), .b(new_n54_), .O(z2));
  nand3  g081(.a(new_n58_), .b(new_n34_), .c(x00), .O(new_n115_));
  nor2   g082(.a(x11), .b(x10), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n40_), .c(new_n37_), .d(new_n62_), .O(new_n117_));
  oai21  g084(.a(new_n117_), .b(new_n115_), .c(new_n54_), .O(new_n118_));
  ...
  nand3  g088(.a(new_n58_), .b(new_n34_), .c(new_n54_), .O(new_n122_));
  nand3  g089(.a(new_n85_), .b(new_n62_), .c(new_n36_), .O(new_n123_));
  ...
  nand4  g093(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n54_), .O(new_n127_));
  inv1   g094(.a(x08), .O(new_n128_));
  nand4  g095(.a(new_n37_), .b(new_n62_), .c(new_n36_), .d(new_n128_), .O(new_n129_));
  ...
  nand3  g098(.a(new_n131_), .b(new_n125_), .c(new_n119_), .O(z3));
  ...
  aoi21  g103(.a(new_n136_), .b(new_n133_), .c(x09), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(x16), .c(new_n128_), .O(new_n138_));
  nand2  g105(.a(new_n44_), .b(x01), .O(new_n139_));
  nand2  g106(.a(new_n48_), .b(new_n43_), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(new_n42_), .c(new_n139_), .O(new_n141_));
  nand3  g108(.a(new_n56_), .b(new_n45_), .c(new_n44_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n141_), .O(z5));
  nand2  g110(.a(z5), .b(new_n138_), .O(new_n144_));
  ...
  oai21  g114(.a(new_n147_), .b(new_n63_), .c(x08), .O(new_n148_));
  nand2  g115(.a(new_n139_), .b(new_n110_), .O(new_n149_));
  inv1   g116(.a(x10), .O(new_n150_));
  nand3  g117(.a(new_n40_), .b(x21), .c(new_n150_), .O(new_n151_));
  inv1   g118(.a(new_n151_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n44_), .c(new_n54_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n149_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n148_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n144_), .O(z4));
  nand2  g123(.a(x20), .b(new_n62_), .O(new_n157_));
  ...
  nand4  g128(.a(new_n40_), .b(x21), .c(new_n150_), .d(new_n44_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n108_), .c(new_n107_), .d(new_n106_), .O(new_n163_));
  oai21  g130(.a(new_n161_), .b(new_n34_), .c(new_n163_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n159_), .c(new_n139_), .O(z6));
  oai21  g132(.a(new_n152_), .b(x01), .c(new_n44_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n109_), .c(new_n106_), .O(z7));
endmodule
