...
module FAU ( 
  ...
  oai21  g039(.a(new_n72_), .b(new_n55_), .c(new_n53_), .O(z1));
  ...
  nand2  g092(.a(x22), .b(new_n125_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n124_), .c(x17), .d(new_n123_), .O(new_n127_));
  ...
  oai21  g098(.a(new_n131_), .b(new_n58_), .c(x09), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n128_), .c(x16), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n127_), .c(new_n122_), .O(z4));
  inv1   g101(.a(new_n41_), .O(new_n135_));
  and2   g102(.a(new_n45_), .b(new_n42_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n53_), .c(new_n47_), .d(new_n135_), .O(z5));
  nand2  g104(.a(x20), .b(new_n57_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n35_), .c(x11), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x03), .c(new_n124_), .O(new_n140_));
  nand2  g107(.a(new_n74_), .b(x14), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(x06), .c(new_n36_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n34_), .c(new_n128_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n140_), .c(new_n52_), .O(z6));
  inv1   g111(.a(new_n61_), .O(new_n145_));
  and2   g112(.a(new_n63_), .b(new_n62_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n64_), .c(new_n145_), .d(new_n53_), .O(z7));
endmodule
