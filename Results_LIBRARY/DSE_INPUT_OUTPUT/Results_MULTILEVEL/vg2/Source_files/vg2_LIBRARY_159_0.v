...
module FAU ( 
  ...
  nor2   g118(.a(new_n151_), .b(new_n108_), .O(new_n152_));
  nand2  g119(.a(new_n133_), .b(new_n111_), .O(new_n153_));
  inv1   g120(.a(new_n153_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n130_), .O(new_n155_));
  oai21  g122(.a(new_n152_), .b(new_n143_), .c(new_n155_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n150_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n147_), .O(z4));
  aoi21  g125(.a(x20), .b(new_n97_), .c(x06), .O(new_n159_));
  ...
  oai21  g132(.a(new_n154_), .b(new_n105_), .c(new_n51_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n152_), .O(z7));
endmodule
