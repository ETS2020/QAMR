...
module FAU ( 
  ...
  nand2  g004(.a(x16), .b(new_n37_), .O(new_n38_));
  ...
  nor2   g016(.a(x24), .b(x16), .O(new_n50_));
  ...
  and2   g029(.a(x23), .b(x22), .O(new_n63_));
  ...
  nor2   g049(.a(new_n61_), .b(new_n82_), .O(new_n83_));
  nand4  g050(.a(new_n83_), .b(new_n81_), .c(new_n63_), .d(new_n57_), .O(new_n84_));
  inv1   g051(.a(x08), .O(new_n85_));
  nand2  g052(.a(new_n65_), .b(new_n85_), .O(new_n86_));
  ...
  nand4  g059(.a(new_n92_), .b(new_n73_), .c(new_n61_), .d(new_n60_), .O(new_n93_));
  ...
  nand3  g066(.a(new_n49_), .b(new_n65_), .c(new_n85_), .O(new_n100_));
  nor3   g067(.a(new_n100_), .b(x06), .c(x04), .O(new_n101_));
  nand2  g068(.a(new_n61_), .b(new_n60_), .O(new_n102_));
  ...
  nand4  g079(.a(new_n112_), .b(new_n41_), .c(x21), .d(new_n90_), .O(new_n113_));
  nand2  g080(.a(new_n113_), .b(new_n111_), .O(z7));
  nand4  g081(.a(z7), .b(x20), .c(x14), .d(x11), .O(new_n115_));
  nor4   g082(.a(new_n115_), .b(new_n34_), .c(new_n97_), .d(new_n96_), .O(z2));
  nand3  g083(.a(x15), .b(x13), .c(x05), .O(new_n117_));
  nand3  g084(.a(x21), .b(new_n49_), .c(new_n37_), .O(new_n118_));
  ...
  nand3  g089(.a(new_n49_), .b(new_n37_), .c(x00), .O(new_n123_));
  nand3  g090(.a(x19), .b(x13), .c(x05), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n61_), .c(new_n36_), .d(new_n35_), .O(new_n126_));
  ...
  nand3  g097(.a(new_n83_), .b(x14), .c(x11), .O(new_n131_));
  nand4  g098(.a(x07), .b(new_n34_), .c(new_n97_), .d(new_n96_), .O(new_n132_));
  nand4  g099(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n85_), .O(new_n133_));
  ...
  nand3  g103(.a(new_n67_), .b(new_n97_), .c(new_n96_), .O(new_n137_));
  nand3  g104(.a(new_n72_), .b(new_n36_), .c(new_n35_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n130_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n45_), .c(new_n39_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n135_), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n129_), .c(new_n90_), .O(new_n142_));
  nand2  g109(.a(new_n139_), .b(new_n78_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n135_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(x02), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n142_), .O(z3));
  ...
  aoi21  g117(.a(new_n150_), .b(new_n148_), .c(new_n86_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n71_), .c(new_n147_), .d(x08), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n78_), .O(new_n153_));
  inv1   g120(.a(x07), .O(new_n154_));
  oai22  g121(.a(new_n151_), .b(new_n154_), .c(new_n82_), .d(x08), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n76_), .c(x24), .O(new_n156_));
  inv1   g123(.a(x00), .O(new_n157_));
  nand2  g124(.a(x21), .b(new_n85_), .O(new_n158_));
  oai21  g125(.a(new_n151_), .b(new_n157_), .c(new_n158_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n41_), .c(new_n49_), .d(new_n37_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n156_), .c(new_n153_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n90_), .O(new_n162_));
  aoi21  g129(.a(x23), .b(new_n149_), .c(new_n60_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n148_), .c(x09), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x16), .c(new_n85_), .O(new_n165_));
  nand2  g132(.a(x08), .b(x07), .O(new_n166_));
  oai21  g133(.a(new_n165_), .b(new_n82_), .c(new_n166_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n76_), .c(x24), .O(new_n168_));
  nand2  g135(.a(x19), .b(x08), .O(new_n169_));
  oai21  g136(.a(new_n165_), .b(new_n147_), .c(new_n169_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n78_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(x02), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n162_), .O(z4));
  nor2   g141(.a(new_n47_), .b(new_n43_), .O(new_n175_));
  nand3  g142(.a(new_n41_), .b(new_n49_), .c(x00), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n90_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n37_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n175_), .O(z5));
  nand2  g146(.a(new_n51_), .b(new_n48_), .O(new_n180_));
  aoi21  g147(.a(x20), .b(new_n36_), .c(x06), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(x11), .c(new_n97_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n180_), .O(new_n183_));
  aoi21  g150(.a(new_n61_), .b(x14), .c(new_n34_), .O(new_n184_));
