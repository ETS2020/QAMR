...
module FAU ( 
  ...
  nand2  g019(.a(x09), .b(x02), .O(new_n53_));
  ...
  nand4  g055(.a(new_n88_), .b(new_n66_), .c(x07), .d(new_n35_), .O(new_n89_));
  nand4  g056(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n36_), .O(new_n90_));
  inv1   g057(.a(new_n90_), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n76_), .c(new_n37_), .d(new_n74_), .O(new_n92_));
  oai22  g059(.a(new_n92_), .b(new_n89_), .c(new_n87_), .d(new_n59_), .O(new_n93_));
  nand3  g060(.a(new_n93_), .b(new_n81_), .c(x24), .O(new_n94_));
  nand3  g061(.a(new_n64_), .b(x21), .c(x20), .O(new_n95_));
  nor2   g062(.a(new_n95_), .b(new_n85_), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n58_), .c(new_n56_), .d(x01), .O(new_n97_));
  ...
  oai21  g077(.a(new_n110_), .b(new_n107_), .c(new_n53_), .O(new_n111_));
  ...
  nor3   g081(.a(new_n114_), .b(new_n34_), .c(new_n104_), .O(z2));
  nand4  g082(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n116_));
  nor2   g083(.a(new_n72_), .b(new_n36_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(x20), .c(x15), .O(new_n118_));
  nand3  g085(.a(new_n98_), .b(new_n67_), .c(new_n35_), .O(new_n119_));
  nand4  g086(.a(new_n37_), .b(x19), .c(new_n72_), .d(new_n36_), .O(new_n120_));
  oai22  g087(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n116_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n83_), .O(new_n122_));
  nand3  g089(.a(new_n117_), .b(x20), .c(x18), .O(new_n123_));
  nand3  g090(.a(new_n98_), .b(x07), .c(new_n35_), .O(new_n124_));
  nand4  g091(.a(new_n37_), .b(new_n72_), .c(new_n36_), .d(new_n67_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n116_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n81_), .c(x24), .O(new_n127_));
  nand4  g094(.a(new_n35_), .b(new_n34_), .c(new_n104_), .d(x00), .O(new_n128_));
  nand3  g095(.a(new_n117_), .b(x21), .c(x20), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n116_), .c(new_n128_), .d(new_n125_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n40_), .c(new_n45_), .O(new_n131_));
  ...
  nand2  g101(.a(new_n134_), .b(new_n68_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n133_), .O(z3));
  inv1   g103(.a(x04), .O(new_n137_));
  oai21  g104(.a(x23), .b(new_n137_), .c(new_n74_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n62_), .c(new_n73_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n67_), .O(new_n140_));
  nand2  g107(.a(new_n48_), .b(new_n43_), .O(new_n141_));
  nor2   g108(.a(new_n141_), .b(new_n42_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x09), .c(new_n46_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand2  g111(.a(new_n73_), .b(x09), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n67_), .c(new_n142_), .O(new_n146_));
  oai21  g113(.a(new_n63_), .b(x04), .c(x17), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(x22), .c(x16), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(x08), .O(new_n149_));
  nand3  g116(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n109_), .c(new_n108_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n107_), .c(new_n149_), .O(new_n152_));
  inv1   g119(.a(x00), .O(new_n153_));
  nand3  g120(.a(x21), .b(x16), .c(new_n68_), .O(new_n154_));
  oai21  g121(.a(new_n145_), .b(new_n153_), .c(new_n154_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n40_), .c(new_n45_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n146_), .c(new_n44_), .O(new_n158_));
  or2    g125(.a(new_n110_), .b(new_n107_), .O(new_n159_));
  nand2  g126(.a(new_n73_), .b(x08), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n159_), .c(new_n68_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n144_), .O(z4));
  nand4  g129(.a(new_n53_), .b(new_n48_), .c(new_n46_), .d(new_n43_), .O(new_n163_));
  or2    g130(.a(new_n163_), .b(new_n42_), .O(z5));
  aoi21  g131(.a(x20), .b(new_n72_), .c(x06), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x11), .c(new_n34_), .O(new_n166_));
  inv1   g133(.a(new_n53_), .O(new_n167_));
  oai21  g134(.a(new_n142_), .b(new_n167_), .c(new_n46_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n166_), .O(new_n169_));
  nand2  g136(.a(new_n112_), .b(new_n111_), .O(z7));
  aoi21  g137(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n36_), .c(x03), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(z7), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n169_), .O(z6));
endmodule
