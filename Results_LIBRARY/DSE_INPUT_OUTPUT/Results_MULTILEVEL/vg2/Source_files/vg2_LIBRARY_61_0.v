...
module FAU ( 
  ...
  oai21  g083(.a(new_n116_), .b(new_n61_), .c(new_n107_), .O(z2));
  ...
  nand4  g087(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n61_), .O(new_n121_));
  nand4  g088(.a(new_n70_), .b(new_n108_), .c(new_n36_), .d(new_n53_), .O(new_n122_));
  ...
  nand2  g096(.a(new_n119_), .b(new_n94_), .O(new_n130_));
  nand2  g097(.a(new_n104_), .b(x20), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n91_), .c(new_n54_), .d(x03), .O(new_n133_));
  ...
  nand4  g109(.a(new_n142_), .b(new_n102_), .c(x01), .d(x00), .O(new_n143_));
  ...
  nand3  g119(.a(new_n104_), .b(new_n91_), .c(new_n94_), .O(new_n153_));
  oai21  g120(.a(new_n141_), .b(new_n152_), .c(new_n153_), .O(z7));
  nand2  g121(.a(z7), .b(new_n151_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n145_), .O(z4));
  aoi21  g123(.a(new_n142_), .b(x00), .c(new_n61_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x02), .c(new_n140_), .O(z5));
  aoi21  g125(.a(x20), .b(new_n108_), .c(x06), .O(new_n159_));
