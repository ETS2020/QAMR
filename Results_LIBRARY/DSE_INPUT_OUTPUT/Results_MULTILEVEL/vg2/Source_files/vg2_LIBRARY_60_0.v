...
module FAU ( 
  ...
  nand4  g062(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n96_));
  nand4  g063(.a(new_n74_), .b(new_n57_), .c(new_n36_), .d(new_n56_), .O(new_n97_));
  ...
  nand4  g067(.a(new_n56_), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n101_));
  nand4  g068(.a(new_n74_), .b(x19), .c(new_n57_), .d(new_n36_), .O(new_n102_));
  ...
  and2   g071(.a(new_n104_), .b(new_n99_), .O(new_n105_));
  aoi21  g072(.a(new_n105_), .b(new_n92_), .c(new_n52_), .O(z3));
  ...
  nand3  g085(.a(new_n118_), .b(new_n93_), .c(x24), .O(new_n119_));
  nand3  g086(.a(new_n113_), .b(new_n46_), .c(new_n37_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(new_n115_), .c(new_n53_), .O(new_n122_));
  inv1   g089(.a(x16), .O(new_n123_));
  inv1   g090(.a(new_n49_), .O(new_n124_));
  inv1   g091(.a(x09), .O(new_n125_));
  inv1   g092(.a(x04), .O(new_n126_));
  inv1   g093(.a(x17), .O(new_n127_));
  oai21  g094(.a(x23), .b(new_n126_), .c(new_n127_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n58_), .c(x12), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n125_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n124_), .c(new_n123_), .O(new_n131_));
  inv1   g098(.a(new_n75_), .O(new_n132_));
  inv1   g099(.a(x23), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(x04), .c(x17), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(x22), .c(x09), .O(new_n135_));
  nand2  g102(.a(x12), .b(new_n125_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n132_), .c(x16), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n131_), .c(new_n122_), .O(z4));
  nor2   g106(.a(new_n52_), .b(new_n49_), .O(z5));
  nand2  g107(.a(x20), .b(new_n57_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n35_), .c(x11), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x03), .c(new_n124_), .O(new_n143_));
  nand2  g110(.a(new_n74_), .b(x14), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x06), .c(new_n36_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n34_), .c(new_n132_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n143_), .c(new_n53_), .O(z6));
  inv1   g114(.a(new_n61_), .O(new_n148_));
  and2   g115(.a(new_n64_), .b(new_n63_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n62_), .c(new_n148_), .d(new_n53_), .O(z7));
endmodule
