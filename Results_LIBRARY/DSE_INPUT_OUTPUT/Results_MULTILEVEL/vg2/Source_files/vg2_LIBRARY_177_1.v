...
module FAU ( 
  ...
  nand2  g083(.a(x02), .b(new_n70_), .O(new_n117_));
  oai21  g084(.a(new_n116_), .b(new_n70_), .c(new_n117_), .O(z2));
  ...
  nand4  g088(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n122_));
  nand4  g089(.a(new_n79_), .b(new_n38_), .c(new_n37_), .d(new_n69_), .O(new_n123_));
  oai22  g090(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n119_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n85_), .O(new_n125_));
  nand2  g092(.a(new_n120_), .b(new_n89_), .O(new_n126_));
  nor2   g093(.a(x20), .b(x14), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n37_), .c(new_n69_), .d(x07), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n122_), .c(new_n126_), .d(new_n119_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n83_), .c(x24), .O(new_n130_));
  nand4  g097(.a(new_n36_), .b(new_n35_), .c(new_n70_), .d(x00), .O(new_n131_));
  nand3  g098(.a(new_n127_), .b(new_n37_), .c(new_n69_), .O(new_n132_));
  nand2  g099(.a(new_n120_), .b(new_n99_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n119_), .c(new_n132_), .d(new_n131_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n41_), .c(new_n46_), .d(new_n34_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n130_), .c(new_n125_), .O(z3));
  oai21  g103(.a(x23), .b(new_n71_), .c(new_n63_), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n65_), .c(x09), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(x16), .c(new_n69_), .O(new_n139_));
  nand4  g106(.a(new_n41_), .b(new_n46_), .c(new_n34_), .d(x00), .O(new_n140_));
  and2   g107(.a(new_n140_), .b(new_n50_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n45_), .c(new_n44_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  inv1   g110(.a(x16), .O(new_n144_));
  inv1   g111(.a(x09), .O(new_n145_));
  oai21  g112(.a(new_n66_), .b(x04), .c(x17), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x22), .c(new_n145_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n144_), .c(x08), .O(new_n148_));
  oai21  g115(.a(new_n113_), .b(new_n109_), .c(new_n148_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n143_), .c(new_n117_), .O(z4));
  nand4  g117(.a(new_n141_), .b(new_n117_), .c(new_n45_), .d(new_n44_), .O(z5));
  aoi21  g118(.a(x20), .b(new_n38_), .c(x06), .O(new_n152_));
  ...
  nand2  g122(.a(new_n155_), .b(new_n140_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  aoi21  g124(.a(new_n39_), .b(x14), .c(new_n36_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n37_), .c(x03), .O(new_n159_));
  nand2  g126(.a(new_n111_), .b(new_n110_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n109_), .c(new_n117_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n112_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n157_), .O(z6));
  nand4  g131(.a(new_n117_), .b(new_n112_), .c(new_n111_), .d(new_n110_), .O(new_n165_));
  or2    g132(.a(new_n165_), .b(new_n109_), .O(z7));
endmodule
