...
module FAU ( 
  ...
  nand2  g100(.a(new_n133_), .b(new_n69_), .O(new_n134_));
  nand3  g101(.a(new_n74_), .b(new_n90_), .c(new_n36_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n134_), .c(new_n132_), .d(new_n130_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n80_), .O(new_n137_));
  nand3  g104(.a(new_n131_), .b(x20), .c(x18), .O(new_n138_));
  nand3  g105(.a(new_n133_), .b(x07), .c(new_n35_), .O(new_n139_));
  nand4  g106(.a(new_n37_), .b(new_n90_), .c(new_n36_), .d(new_n59_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n130_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n78_), .c(x24), .O(new_n142_));
  nand4  g109(.a(new_n45_), .b(x08), .c(x06), .d(x03), .O(new_n143_));
  inv1   g110(.a(x21), .O(new_n144_));
  nor2   g111(.a(x24), .b(new_n144_), .O(new_n145_));
  nand3  g112(.a(new_n131_), .b(new_n145_), .c(x20), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n143_), .c(new_n44_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(x01), .O(new_n148_));
  nor3   g115(.a(x06), .b(x03), .c(x02), .O(new_n149_));
  nor3   g116(.a(x11), .b(x10), .c(x08), .O(new_n150_));
  nor3   g117(.a(x24), .b(x20), .c(x14), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n108_), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n148_), .c(new_n142_), .d(new_n137_), .O(z3));
  oai21  g120(.a(x23), .b(new_n55_), .c(new_n88_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n113_), .c(x09), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x16), .c(new_n59_), .O(new_n156_));
  nand2  g123(.a(new_n48_), .b(new_n43_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n42_), .c(new_n53_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n46_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  oai21  g127(.a(new_n102_), .b(x04), .c(x17), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x22), .c(new_n67_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n91_), .c(x08), .O(new_n163_));
  nand2  g130(.a(new_n123_), .b(new_n122_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n121_), .c(new_n53_), .O(new_n165_));
  nand3  g132(.a(new_n145_), .b(new_n45_), .c(new_n44_), .O(new_n166_));
  ...
  and2   g137(.a(new_n53_), .b(new_n43_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n48_), .c(new_n46_), .d(new_n170_), .O(z5));
  nand2  g139(.a(x20), .b(new_n90_), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(new_n35_), .c(x11), .O(new_n174_));
  oai22  g141(.a(new_n174_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n175_));
  oai21  g142(.a(x20), .b(new_n90_), .c(x06), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(x11), .c(x03), .O(new_n177_));
  nand2  g144(.a(new_n53_), .b(new_n34_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n78_), .c(x18), .O(new_n180_));
  inv1   g147(.a(new_n123_), .O(new_n181_));
  nand2  g148(.a(new_n133_), .b(new_n181_), .O(new_n182_));
  ...
  nand3  g152(.a(new_n185_), .b(new_n47_), .c(new_n38_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n79_), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(x15), .O(new_n188_));
  nand2  g155(.a(new_n188_), .b(new_n166_), .O(new_n189_));
  nand3  g156(.a(new_n189_), .b(new_n176_), .c(x11), .O(new_n190_));
  inv1   g157(.a(new_n53_), .O(new_n191_));
  and2   g158(.a(new_n124_), .b(new_n123_), .O(new_n192_));
  nand2  g159(.a(x13), .b(x05), .O(new_n193_));
  nand2  g160(.a(new_n193_), .b(new_n78_), .O(new_n194_));
  nand3  g161(.a(new_n194_), .b(new_n40_), .c(x15), .O(new_n195_));
  oai21  g162(.a(new_n192_), .b(x02), .c(new_n195_), .O(new_n196_));
  aoi21  g163(.a(new_n196_), .b(new_n34_), .c(new_n191_), .O(new_n197_));
  nand4  g164(.a(new_n197_), .b(new_n190_), .c(new_n184_), .d(new_n175_), .O(z6));
endmodule
