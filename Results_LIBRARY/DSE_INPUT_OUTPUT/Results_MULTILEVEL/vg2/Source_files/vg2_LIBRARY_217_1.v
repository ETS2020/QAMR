...
module FAU ( 
  ...
  nor2   g050(.a(new_n36_), .b(new_n83_), .O(new_n84_));
  nand4  g051(.a(new_n84_), .b(new_n82_), .c(new_n64_), .d(new_n57_), .O(new_n85_));
  inv1   g052(.a(x06), .O(new_n86_));
  nor2   g053(.a(x09), .b(x08), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n67_), .c(x07), .d(new_n86_), .O(new_n88_));
  inv1   g055(.a(x12), .O(new_n89_));
  inv1   g056(.a(x16), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n35_), .c(new_n89_), .d(new_n34_), .O(new_n91_));
  inv1   g058(.a(new_n91_), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n74_), .c(new_n36_), .d(new_n60_), .O(new_n93_));
  oai21  g060(.a(new_n93_), .b(new_n88_), .c(new_n85_), .O(new_n94_));
  ...
  nand3  g068(.a(new_n101_), .b(new_n66_), .c(new_n100_), .O(new_n102_));
  nor3   g069(.a(new_n102_), .b(x06), .c(x04), .O(new_n103_));
  nand3  g070(.a(new_n41_), .b(new_n63_), .c(new_n62_), .O(new_n104_));
  nor3   g071(.a(new_n104_), .b(x20), .c(x17), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n103_), .c(new_n99_), .d(new_n92_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n95_), .c(new_n80_), .O(z1));
  ...
  aoi21  g083(.a(new_n116_), .b(new_n113_), .c(new_n36_), .O(new_n117_));
  ...
  nand3  g087(.a(x21), .b(new_n101_), .c(new_n37_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x20), .c(x14), .d(x11), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(new_n100_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x06), .c(x03), .d(x01), .O(new_n125_));
  nand3  g092(.a(new_n101_), .b(new_n37_), .c(x00), .O(new_n126_));
  nand3  g093(.a(x19), .b(x13), .c(x05), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(x08), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n86_), .c(new_n97_), .d(new_n96_), .O(new_n131_));
  ...
  nand4  g101(.a(x07), .b(new_n86_), .c(new_n97_), .d(new_n96_), .O(new_n135_));
  nand4  g102(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n100_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n133_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n77_), .c(x24), .O(new_n138_));
  nand4  g105(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n139_));
  nand3  g106(.a(new_n68_), .b(new_n97_), .c(new_n96_), .O(new_n140_));
  nand3  g107(.a(new_n73_), .b(new_n35_), .c(new_n34_), .O(new_n141_));
  ...
  oai21  g111(.a(new_n144_), .b(new_n132_), .c(new_n49_), .O(new_n145_));
  nand2  g112(.a(new_n142_), .b(new_n79_), .O(new_n146_));
  ...
  oai21  g117(.a(new_n150_), .b(x16), .c(new_n100_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(z5), .O(new_n152_));
  aoi21  g119(.a(x22), .b(new_n60_), .c(new_n66_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n90_), .c(x08), .O(new_n154_));
  nor2   g121(.a(new_n90_), .b(x04), .O(new_n155_));
  aoi22  g122(.a(new_n155_), .b(new_n64_), .c(new_n154_), .d(new_n38_), .O(new_n156_));
  nand3  g123(.a(x07), .b(x04), .c(x02), .O(new_n157_));
  nand2  g124(.a(new_n74_), .b(new_n90_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n157_), .c(new_n156_), .d(new_n83_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n77_), .c(x24), .O(new_n160_));
  inv1   g127(.a(x15), .O(new_n161_));
  nor2   g128(.a(x16), .b(new_n49_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n74_), .c(x19), .d(x02), .O(new_n163_));
  oai21  g130(.a(new_n156_), .b(new_n161_), .c(new_n163_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n79_), .O(new_n165_));
  aoi21  g132(.a(new_n63_), .b(x17), .c(new_n62_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n66_), .c(x16), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(x08), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n41_), .c(x21), .d(new_n101_), .O(new_n169_));
  inv1   g136(.a(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n49_), .c(new_n37_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n165_), .c(new_n160_), .d(new_n152_), .O(z4));
  aoi21  g139(.a(x20), .b(new_n35_), .c(x06), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x11), .c(new_n97_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(z5), .O(new_n175_));
  nand2  g142(.a(new_n116_), .b(new_n113_), .O(new_n176_));
  aoi21  g143(.a(new_n36_), .b(x14), .c(new_n86_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n34_), .c(x03), .O(new_n178_));
  ...
  oai21  g148(.a(new_n115_), .b(x04), .c(new_n37_), .O(new_n182_));
