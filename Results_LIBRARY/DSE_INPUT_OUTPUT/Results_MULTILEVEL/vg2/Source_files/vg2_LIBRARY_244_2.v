...
module FAU ( 
  ...
  nand4  g055(.a(new_n88_), .b(new_n86_), .c(new_n65_), .d(new_n58_), .O(new_n89_));
  ...
  nand4  g066(.a(new_n99_), .b(new_n86_), .c(new_n65_), .d(new_n58_), .O(new_n100_));
  ...
  nor2   g082(.a(new_n115_), .b(new_n107_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x11), .c(x06), .d(x03), .O(new_n117_));
  oai21  g084(.a(new_n117_), .b(new_n68_), .c(new_n54_), .O(z2));
  nand4  g085(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n119_));
  nor2   g086(.a(new_n107_), .b(new_n36_), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(x20), .c(x15), .O(new_n121_));
  nand2  g088(.a(new_n101_), .b(new_n72_), .O(new_n122_));
  nand3  g089(.a(new_n77_), .b(new_n107_), .c(new_n36_), .O(new_n123_));
  ...
  nand3  g093(.a(new_n101_), .b(x07), .c(new_n35_), .O(new_n127_));
  inv1   g094(.a(x08), .O(new_n128_));
  nand4  g095(.a(new_n37_), .b(new_n107_), .c(new_n36_), .d(new_n128_), .O(new_n129_));
  ...
  nand4  g098(.a(new_n35_), .b(new_n34_), .c(new_n68_), .d(x00), .O(new_n132_));
  ...
  nand3  g109(.a(x24), .b(new_n128_), .c(x07), .O(new_n143_));
  nand4  g110(.a(new_n40_), .b(x19), .c(x13), .d(new_n44_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(x05), .O(new_n146_));
  nand2  g113(.a(new_n45_), .b(x00), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n48_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n40_), .c(new_n44_), .O(new_n149_));
  nand2  g116(.a(x13), .b(x07), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n48_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(x24), .c(new_n128_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n149_), .c(new_n146_), .O(new_n153_));
  ...
  nand3  g123(.a(new_n54_), .b(x08), .c(x07), .O(new_n157_));
  aoi21  g124(.a(x23), .b(new_n69_), .c(new_n61_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n63_), .c(x09), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x16), .c(new_n128_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n87_), .c(new_n157_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n81_), .c(x24), .O(new_n162_));
  inv1   g129(.a(x15), .O(new_n163_));
  nand3  g130(.a(new_n54_), .b(x19), .c(x08), .O(new_n164_));
  oai21  g131(.a(new_n160_), .b(new_n163_), .c(new_n164_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n83_), .O(new_n166_));
  inv1   g133(.a(new_n159_), .O(new_n167_));
  nand2  g134(.a(x13), .b(x05), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n81_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(x15), .c(x02), .O(new_n170_));
  nand4  g137(.a(x21), .b(x16), .c(new_n45_), .d(new_n44_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n170_), .c(new_n167_), .O(new_n172_));
  nand2  g139(.a(x08), .b(x00), .O(new_n173_));
  oai21  g140(.a(new_n98_), .b(x08), .c(new_n173_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n45_), .c(new_n44_), .O(new_n175_));
  inv1   g142(.a(new_n175_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n172_), .c(new_n40_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n166_), .c(new_n162_), .d(new_n156_), .O(z4));
  nand2  g145(.a(new_n48_), .b(new_n43_), .O(new_n179_));
  oai21  g146(.a(new_n179_), .b(new_n42_), .c(new_n54_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n46_), .O(z5));
  aoi21  g148(.a(x20), .b(new_n107_), .c(x06), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(x11), .c(new_n34_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(z5), .O(new_n184_));
  inv1   g151(.a(new_n113_), .O(new_n185_));
  aoi21  g152(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(new_n36_), .c(x03), .O(new_n187_));
  inv1   g154(.a(new_n54_), .O(new_n188_));
  inv1   g155(.a(new_n110_), .O(new_n189_));
  and2   g156(.a(new_n112_), .b(new_n111_), .O(new_n190_));
  aoi21  g157(.a(new_n190_), .b(new_n189_), .c(new_n188_), .O(new_n191_));
  oai21  g158(.a(new_n191_), .b(new_n185_), .c(new_n187_), .O(new_n192_));
  nand2  g159(.a(new_n192_), .b(new_n184_), .O(z6));
  nand4  g160(.a(new_n190_), .b(new_n113_), .c(new_n189_), .d(new_n54_), .O(z7));
endmodule
