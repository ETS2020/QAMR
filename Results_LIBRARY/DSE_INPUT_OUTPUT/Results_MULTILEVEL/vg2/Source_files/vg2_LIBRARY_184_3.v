...
module FAU ( 
  ...
  oai21  g078(.a(new_n111_), .b(new_n108_), .c(new_n37_), .O(new_n112_));
  nand4  g079(.a(new_n40_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(new_n112_), .c(new_n74_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x14), .c(x11), .d(x06), .O(new_n115_));
  nor3   g082(.a(new_n115_), .b(new_n105_), .c(new_n104_), .O(z2));
  ...
  nand4  g094(.a(new_n127_), .b(new_n34_), .c(new_n105_), .d(new_n104_), .O(new_n128_));
  ...
  nand3  g112(.a(new_n40_), .b(new_n49_), .c(x00), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n45_), .c(new_n43_), .O(new_n147_));
  nor2   g114(.a(new_n147_), .b(new_n42_), .O(new_n148_));
  aoi21  g115(.a(new_n145_), .b(new_n66_), .c(new_n148_), .O(new_n149_));
  oai21  g116(.a(new_n61_), .b(x17), .c(x09), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x16), .c(new_n66_), .O(new_n151_));
  nand3  g118(.a(new_n40_), .b(x21), .c(new_n49_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n110_), .c(new_n109_), .O(new_n153_));
  nor2   g120(.a(new_n153_), .b(new_n108_), .O(new_n154_));
  inv1   g121(.a(x04), .O(new_n155_));
  nand3  g122(.a(x16), .b(new_n49_), .c(new_n155_), .O(new_n156_));
  nand4  g123(.a(new_n40_), .b(x23), .c(x22), .d(x21), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n156_), .c(new_n154_), .d(new_n151_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n149_), .c(new_n48_), .O(new_n159_));
  nor2   g126(.a(new_n46_), .b(new_n42_), .O(new_n160_));
  oai21  g127(.a(x22), .b(new_n72_), .c(new_n67_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n71_), .c(x08), .O(new_n162_));
  nor2   g129(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nor2   g130(.a(new_n111_), .b(new_n108_), .O(new_n164_));
  aoi21  g131(.a(new_n62_), .b(x17), .c(new_n61_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n67_), .c(x16), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x08), .c(new_n164_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n163_), .c(new_n155_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n159_), .O(z4));
  nand2  g136(.a(new_n50_), .b(new_n47_), .O(z5));
  aoi21  g137(.a(x20), .b(new_n36_), .c(x06), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(x11), .c(new_n105_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(z5), .O(new_n173_));
  nand2  g140(.a(new_n113_), .b(new_n112_), .O(new_n174_));
  aoi21  g141(.a(new_n74_), .b(x14), .c(new_n34_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n35_), .c(x03), .O(new_n176_));
  ...
  nand4  g147(.a(new_n180_), .b(new_n109_), .c(new_n179_), .d(new_n37_), .O(z7));
endmodule
