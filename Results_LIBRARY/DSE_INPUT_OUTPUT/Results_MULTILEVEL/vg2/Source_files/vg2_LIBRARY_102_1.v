...
module FAU ( 
  ...
  nand2  g124(.a(z5), .b(new_n153_), .O(new_n158_));
  ...
  nand2  g130(.a(new_n163_), .b(new_n124_), .O(z7));
  nand2  g131(.a(z7), .b(new_n161_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n158_), .O(z4));
  aoi21  g133(.a(x20), .b(new_n38_), .c(x06), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x11), .c(new_n35_), .O(new_n168_));
