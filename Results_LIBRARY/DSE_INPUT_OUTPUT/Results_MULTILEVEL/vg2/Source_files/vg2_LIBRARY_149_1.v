// Benchmark "FAU" written by ABC on Fri Aug 14 02:35:59 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_,
    ...
    new_n160_, new_n161_, new_n162_, new_n163_, new_n166_, new_n167_,
  ...
  nand4  g063(.a(new_n96_), .b(new_n95_), .c(x07), .d(new_n34_), .O(new_n97_));
  nand4  g064(.a(new_n71_), .b(new_n36_), .c(new_n55_), .d(new_n35_), .O(new_n98_));
  inv1   g065(.a(new_n98_), .O(new_n99_));
  nor2   g066(.a(x23), .b(x22), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n99_), .c(new_n73_), .d(new_n72_), .O(new_n101_));
  ...
  nand4  g075(.a(new_n108_), .b(new_n95_), .c(new_n35_), .d(new_n70_), .O(new_n109_));
  ...
  nand3  g082(.a(new_n115_), .b(new_n46_), .c(new_n40_), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n103_), .O(new_n117_));
  oai21  g084(.a(new_n117_), .b(new_n86_), .c(new_n37_), .O(new_n118_));
  nand3  g085(.a(new_n42_), .b(x13), .c(x05), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n87_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n115_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n103_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(x02), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n118_), .O(z1));
  nand4  g091(.a(x11), .b(x06), .c(x03), .d(x01), .O(new_n125_));
  nor2   g092(.a(x24), .b(new_n56_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(x20), .c(x14), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n125_), .c(new_n37_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n50_), .O(new_n129_));
  nand2  g096(.a(x24), .b(x18), .O(new_n130_));
  nand3  g097(.a(new_n42_), .b(x15), .c(x13), .O(new_n131_));
  ...
  nand3  g101(.a(x15), .b(new_n46_), .c(new_n40_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .O(new_n136_));
  inv1   g103(.a(new_n136_), .O(new_n137_));
  nor3   g104(.a(new_n137_), .b(new_n73_), .c(new_n36_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(x11), .c(x06), .d(x03), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n66_), .c(new_n129_), .O(z2));
  nand4  g107(.a(new_n58_), .b(x20), .c(x14), .d(x11), .O(new_n141_));
  nor2   g108(.a(new_n141_), .b(new_n69_), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(x06), .c(x03), .d(x01), .O(new_n143_));
  nand4  g110(.a(new_n78_), .b(new_n73_), .c(new_n36_), .d(new_n35_), .O(new_n144_));
  nor2   g111(.a(new_n144_), .b(x08), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n34_), .c(new_n67_), .d(new_n66_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n143_), .c(x24), .O(new_n147_));
  nand4  g114(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n148_));
  nand3  g115(.a(new_n92_), .b(x14), .c(x11), .O(new_n149_));
  nand4  g116(.a(x07), .b(new_n34_), .c(new_n67_), .d(new_n66_), .O(new_n150_));
  nand4  g117(.a(new_n73_), .b(new_n36_), .c(new_n35_), .d(new_n69_), .O(new_n151_));
  ...
  nand3  g121(.a(new_n108_), .b(new_n67_), .c(new_n66_), .O(new_n155_));
  nand3  g122(.a(new_n113_), .b(new_n36_), .c(new_n35_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n155_), .c(new_n154_), .d(new_n148_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n46_), .c(new_n40_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n153_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n147_), .c(new_n37_), .O(new_n160_));
  nand2  g127(.a(new_n157_), .b(new_n120_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n153_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x02), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n160_), .O(z3));
  nand2  g131(.a(new_n51_), .b(new_n49_), .O(z5));
  oai21  g132(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n74_), .c(x09), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x16), .c(new_n69_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(z5), .O(new_n169_));
  oai21  g136(.a(new_n75_), .b(x04), .c(x17), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(x22), .c(new_n70_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n71_), .c(x08), .O(new_n172_));
  nand3  g139(.a(new_n126_), .b(new_n37_), .c(new_n50_), .O(new_n173_));
  oai21  g140(.a(new_n137_), .b(new_n38_), .c(new_n173_), .O(z7));
  nand2  g141(.a(z7), .b(new_n172_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n169_), .O(z4));
  nand2  g143(.a(x20), .b(new_n36_), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(new_n34_), .c(x11), .O(new_n178_));
  nand3  g145(.a(new_n42_), .b(new_n50_), .c(x00), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n47_), .c(new_n45_), .O(new_n180_));
  oai22  g147(.a(new_n180_), .b(new_n44_), .c(new_n178_), .d(x03), .O(new_n181_));
  oai21  g148(.a(x20), .b(new_n36_), .c(x06), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(x11), .c(x03), .O(new_n183_));
  oai21  g150(.a(x10), .b(x03), .c(new_n183_), .O(new_n184_));
  nand2  g151(.a(new_n126_), .b(new_n50_), .O(new_n185_));
  nand3  g152(.a(new_n185_), .b(new_n135_), .c(new_n134_), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(new_n132_), .c(new_n184_), .O(new_n187_));
  nand3  g154(.a(new_n136_), .b(new_n67_), .c(x02), .O(new_n188_));
  nand4  g155(.a(new_n188_), .b(new_n187_), .c(new_n181_), .d(new_n39_), .O(z6));
endmodule
