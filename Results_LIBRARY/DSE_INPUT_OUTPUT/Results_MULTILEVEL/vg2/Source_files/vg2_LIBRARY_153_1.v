...
module FAU ( 
  ...
  nand3  g100(.a(new_n73_), .b(new_n35_), .c(new_n69_), .O(new_n134_));
  nand3  g101(.a(new_n78_), .b(new_n38_), .c(new_n37_), .O(new_n135_));
  ...
  nand4  g105(.a(x07), .b(new_n36_), .c(new_n35_), .d(new_n69_), .O(new_n139_));
  nand4  g106(.a(new_n39_), .b(new_n38_), .c(new_n37_), .d(new_n60_), .O(new_n140_));
  ...
  nand3  g109(.a(new_n73_), .b(new_n35_), .c(x00), .O(new_n143_));
  ...
  nand2  g113(.a(new_n146_), .b(new_n69_), .O(new_n147_));
  nor2   g114(.a(x02), .b(new_n69_), .O(new_n148_));
  nand2  g115(.a(new_n132_), .b(new_n46_), .O(new_n149_));
  nand3  g116(.a(new_n41_), .b(x21), .c(x20), .O(new_n150_));
  nor2   g117(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n148_), .c(new_n61_), .d(x03), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n147_), .c(new_n142_), .d(new_n137_), .O(z3));
  inv1   g120(.a(x04), .O(new_n154_));
  inv1   g121(.a(x17), .O(new_n155_));
  oai21  g122(.a(x23), .b(new_n154_), .c(new_n155_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n113_), .c(x09), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x16), .c(new_n60_), .O(new_n158_));
  nand3  g125(.a(new_n50_), .b(new_n45_), .c(new_n44_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n129_), .O(new_n160_));
  nand3  g127(.a(new_n101_), .b(new_n41_), .c(new_n46_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(z5));
  nand2  g129(.a(z5), .b(new_n158_), .O(new_n163_));
  ...
  oai21  g134(.a(new_n167_), .b(new_n121_), .c(new_n129_), .O(new_n168_));
  ...
  inv1   g145(.a(new_n121_), .O(new_n179_));
  and2   g146(.a(new_n124_), .b(new_n123_), .O(new_n180_));
  nand4  g147(.a(new_n129_), .b(new_n180_), .c(new_n122_), .d(new_n179_), .O(z7));
endmodule
