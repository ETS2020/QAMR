...
module FAU ( 
  ...
  nand2  g070(.a(new_n36_), .b(x02), .O(new_n104_));
  ...
  oai21  g082(.a(new_n115_), .b(new_n56_), .c(new_n104_), .O(z2));
  ...
  nand4  g114(.a(new_n49_), .b(x08), .c(x06), .d(new_n46_), .O(new_n148_));
  ...
  nand3  g141(.a(new_n157_), .b(new_n168_), .c(new_n45_), .O(new_n175_));
  oai22  g142(.a(new_n175_), .b(new_n172_), .c(new_n174_), .d(x03), .O(new_n176_));
  inv1   g143(.a(new_n161_), .O(new_n177_));
  nand2  g144(.a(new_n36_), .b(new_n34_), .O(new_n178_));
  nand2  g145(.a(new_n39_), .b(x14), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n178_), .c(new_n37_), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n35_), .c(x15), .O(new_n181_));
  nand3  g148(.a(x19), .b(new_n37_), .c(x02), .O(new_n182_));
  aoi21  g149(.a(new_n182_), .b(new_n181_), .c(new_n177_), .O(new_n183_));
  aoi21  g150(.a(new_n179_), .b(x06), .c(new_n37_), .O(new_n184_));
  or2    g151(.a(new_n184_), .b(new_n35_), .O(new_n185_));
  nand4  g152(.a(new_n185_), .b(x21), .c(new_n96_), .d(new_n34_), .O(new_n186_));
  inv1   g153(.a(new_n186_), .O(new_n187_));
  oai21  g154(.a(new_n187_), .b(new_n183_), .c(new_n41_), .O(new_n188_));
  nand2  g155(.a(new_n184_), .b(x03), .O(new_n189_));
  nand2  g156(.a(new_n104_), .b(new_n35_), .O(new_n190_));
  nand2  g157(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  nand3  g158(.a(new_n191_), .b(new_n79_), .c(x18), .O(new_n192_));
  nand3  g159(.a(x11), .b(new_n36_), .c(x03), .O(new_n193_));
  oai21  g160(.a(new_n36_), .b(x03), .c(new_n193_), .O(new_n194_));
  nand4  g161(.a(new_n194_), .b(x15), .c(new_n78_), .d(new_n46_), .O(new_n195_));
  nand2  g162(.a(new_n195_), .b(new_n192_), .O(new_n196_));
  nand2  g163(.a(x11), .b(x03), .O(new_n197_));
  oai22  g164(.a(new_n197_), .b(new_n179_), .c(x03), .d(x02), .O(new_n198_));
  nand4  g165(.a(new_n198_), .b(x15), .c(new_n78_), .d(new_n46_), .O(new_n199_));
  nand2  g166(.a(new_n199_), .b(new_n104_), .O(new_n200_));
  aoi21  g167(.a(new_n196_), .b(x24), .c(new_n200_), .O(new_n201_));
  nand3  g168(.a(new_n201_), .b(new_n188_), .c(new_n176_), .O(z6));
  nand2  g169(.a(new_n110_), .b(new_n109_), .O(new_n203_));
  oai21  g170(.a(new_n203_), .b(new_n108_), .c(new_n104_), .O(new_n204_));
  nand2  g171(.a(new_n204_), .b(new_n111_), .O(z7));
endmodule
