...
module FAU ( 
  ...
  nand4  g113(.a(new_n43_), .b(new_n38_), .c(new_n34_), .d(x00), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n53_), .c(new_n51_), .O(new_n148_));
  or2    g115(.a(new_n148_), .b(new_n50_), .O(new_n149_));
  ...
  nand2  g123(.a(new_n34_), .b(x01), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n156_), .c(new_n150_), .O(z4));
  nor2   g125(.a(new_n54_), .b(new_n50_), .O(new_n159_));
  nand3  g126(.a(new_n43_), .b(new_n38_), .c(x00), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n35_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n34_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n159_), .O(z5));
  nand2  g130(.a(x20), .b(new_n41_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n37_), .c(x11), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x03), .c(new_n149_), .O(new_n166_));
  nand2  g133(.a(new_n42_), .b(x14), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x06), .c(new_n40_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n36_), .c(new_n155_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n157_), .O(z6));
  nand3  g137(.a(new_n43_), .b(x21), .c(new_n38_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n35_), .c(x02), .O(new_n172_));
  or2    g139(.a(new_n172_), .b(new_n117_), .O(z7));
endmodule
