...
module FAU ( 
  ...
  nand4  g071(.a(x11), .b(new_n96_), .c(x06), .d(x03), .O(new_n105_));
  nor2   g072(.a(x24), .b(new_n99_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(x20), .c(x14), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n105_), .c(x01), .O(new_n108_));
  ...
  oai21  g085(.a(new_n118_), .b(new_n63_), .c(new_n109_), .O(z2));
  nand3  g086(.a(new_n56_), .b(x03), .c(x01), .O(new_n120_));
  nand2  g087(.a(x14), .b(x11), .O(new_n121_));
  inv1   g088(.a(new_n121_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(x20), .c(x15), .O(new_n123_));
  nand4  g090(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n63_), .O(new_n124_));
  nand4  g091(.a(new_n72_), .b(new_n37_), .c(new_n36_), .d(new_n55_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n120_), .O(new_n126_));
  ...
  oai22  g097(.a(new_n130_), .b(new_n124_), .c(new_n128_), .d(new_n120_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n76_), .c(x24), .O(new_n132_));
  nand2  g099(.a(new_n106_), .b(x20), .O(new_n133_));
  nor3   g100(.a(new_n133_), .b(new_n121_), .c(x10), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n93_), .c(new_n56_), .d(x03), .O(new_n135_));
  ...
  nand3  g108(.a(new_n141_), .b(new_n137_), .c(new_n55_), .O(new_n142_));
  oai21  g109(.a(new_n55_), .b(new_n63_), .c(new_n142_), .O(new_n143_));
  nor2   g110(.a(x24), .b(x10), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n104_), .c(x00), .O(new_n145_));
  ...
  aoi21  g115(.a(new_n148_), .b(x22), .c(new_n138_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n137_), .c(x08), .O(new_n150_));
  ...
  nand4  g125(.a(new_n150_), .b(new_n40_), .c(x21), .d(new_n96_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(x01), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n104_), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n158_), .c(new_n154_), .d(new_n147_), .O(z4));
  nor2   g129(.a(x02), .b(x01), .O(new_n163_));
  inv1   g130(.a(new_n163_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n48_), .O(new_n165_));
  nand4  g132(.a(new_n144_), .b(new_n104_), .c(x01), .d(x00), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n165_), .O(z5));
  nand2  g134(.a(x20), .b(new_n37_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n35_), .c(x11), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(x03), .c(new_n146_), .O(new_n170_));
  nand2  g137(.a(new_n38_), .b(x14), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(x06), .c(new_n36_), .O(new_n172_));
  nand3  g139(.a(new_n106_), .b(new_n96_), .c(new_n104_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n114_), .c(new_n113_), .O(new_n174_));
  oai22  g141(.a(new_n174_), .b(new_n112_), .c(new_n172_), .d(new_n34_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n170_), .c(new_n164_), .O(z6));
  aoi21  g143(.a(new_n106_), .b(new_n96_), .c(new_n63_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(x02), .c(new_n116_), .O(z7));
endmodule
