...
module FAU ( 
  ...
  nand4  g076(.a(new_n72_), .b(new_n52_), .c(new_n71_), .d(new_n56_), .O(new_n110_));
  ...
  nor3   g091(.a(new_n124_), .b(new_n73_), .c(new_n71_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x11), .c(x06), .d(x03), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n67_), .c(new_n54_), .O(z2));
  ...
  nand4  g097(.a(new_n78_), .b(new_n73_), .c(new_n71_), .d(new_n36_), .O(new_n131_));
  ...
  nand4  g106(.a(new_n73_), .b(new_n71_), .c(new_n36_), .d(new_n69_), .O(new_n140_));
  ...
  nand4  g110(.a(new_n69_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n144_));
  nand4  g111(.a(new_n73_), .b(x19), .c(new_n71_), .d(new_n36_), .O(new_n145_));
  ...
  aoi21  g115(.a(new_n148_), .b(new_n135_), .c(new_n53_), .O(z3));
  inv1   g116(.a(new_n124_), .O(new_n150_));
  nand2  g117(.a(x22), .b(new_n72_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x09), .c(new_n52_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n69_), .c(new_n150_), .O(new_n153_));
  inv1   g120(.a(new_n49_), .O(new_n154_));
  nand2  g121(.a(new_n99_), .b(new_n52_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n69_), .c(new_n68_), .O(new_n156_));
  aoi21  g123(.a(new_n74_), .b(x17), .c(x09), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n69_), .c(x16), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n156_), .c(new_n154_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n153_), .c(new_n54_), .O(z4));
  ...
  oai21  g130(.a(new_n163_), .b(x03), .c(new_n154_), .O(new_n164_));
  nand2  g131(.a(new_n73_), .b(x14), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x06), .c(new_n36_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n34_), .c(new_n150_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n164_), .c(new_n53_), .O(z6));
  nor2   g135(.a(new_n124_), .b(new_n53_), .O(z7));
endmodule
