...
module FAU ( 
  ...
  nand2  g095(.a(x02), .b(new_n69_), .O(new_n129_));
  oai21  g096(.a(new_n128_), .b(new_n69_), .c(new_n129_), .O(z2));
  nand3  g097(.a(new_n61_), .b(x03), .c(x01), .O(new_n131_));
  nor2   g098(.a(new_n38_), .b(new_n37_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(x20), .c(x15), .O(new_n133_));
  nand4  g100(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(new_n134_));
  nand4  g101(.a(new_n78_), .b(new_n38_), .c(new_n37_), .d(new_n60_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n131_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n84_), .O(new_n137_));
  nand3  g104(.a(new_n132_), .b(x20), .c(x18), .O(new_n138_));
  nor2   g105(.a(x20), .b(x14), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n37_), .c(new_n60_), .d(x07), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n134_), .c(new_n138_), .d(new_n131_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n82_), .c(x24), .O(new_n142_));
  nand4  g109(.a(new_n36_), .b(new_n35_), .c(new_n69_), .d(x00), .O(new_n143_));
  nand3  g110(.a(new_n139_), .b(new_n37_), .c(new_n60_), .O(new_n144_));
  nand3  g111(.a(new_n132_), .b(x21), .c(x20), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n131_), .c(new_n144_), .d(new_n143_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n41_), .c(new_n46_), .d(new_n34_), .O(new_n147_));
  ...
  nand3  g122(.a(new_n101_), .b(new_n41_), .c(new_n46_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n153_), .O(new_n158_));
  oai21  g125(.a(new_n114_), .b(x04), .c(x17), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x22), .c(new_n68_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n93_), .c(x08), .O(new_n161_));
  nand2  g128(.a(new_n123_), .b(new_n122_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n121_), .c(new_n129_), .O(new_n163_));
  ...
  and2   g133(.a(new_n129_), .b(new_n45_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n156_), .c(new_n50_), .d(new_n44_), .O(z5));
  aoi21  g135(.a(x20), .b(new_n38_), .c(x06), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(x11), .c(new_n35_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n157_), .O(new_n171_));
  aoi21  g138(.a(new_n39_), .b(x14), .c(new_n36_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n37_), .c(x03), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n164_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n171_), .O(z6));
  inv1   g142(.a(new_n121_), .O(new_n176_));
  and2   g143(.a(new_n124_), .b(new_n123_), .O(new_n177_));
  nand4  g144(.a(new_n129_), .b(new_n177_), .c(new_n122_), .d(new_n176_), .O(z7));
endmodule
