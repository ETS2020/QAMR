...
module FAU ( 
  ...
  nand2  g102(.a(new_n44_), .b(x01), .O(new_n136_));
  nand2  g103(.a(new_n48_), .b(new_n43_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n42_), .c(new_n136_), .O(new_n138_));
  ...
  inv1   g113(.a(new_n136_), .O(new_n147_));
  inv1   g114(.a(x10), .O(new_n148_));
  nand3  g115(.a(new_n40_), .b(x21), .c(new_n148_), .O(new_n149_));
  inv1   g116(.a(new_n149_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n44_), .c(new_n54_), .O(new_n151_));
  oai21  g118(.a(new_n147_), .b(new_n146_), .c(new_n151_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n145_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n141_), .O(z4));
  ...
  nand2  g126(.a(new_n159_), .b(new_n152_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n157_), .O(z6));
  oai21  g128(.a(new_n150_), .b(x01), .c(new_n44_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n146_), .O(z7));
endmodule
