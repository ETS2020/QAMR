...
module FAU ( 
  ...
  aoi21  g046(.a(new_n79_), .b(new_n68_), .c(new_n58_), .O(z2));
  ...
  nor2   g077(.a(new_n68_), .b(new_n58_), .O(new_n111_));
  inv1   g078(.a(new_n111_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n110_), .c(new_n104_), .d(new_n96_), .O(z3));
  oai21  g080(.a(new_n59_), .b(x04), .c(x17), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(x22), .c(new_n54_), .O(new_n115_));
  nor2   g082(.a(new_n115_), .b(new_n56_), .O(new_n116_));
  nor2   g083(.a(new_n116_), .b(new_n81_), .O(new_n117_));
  inv1   g084(.a(new_n49_), .O(new_n118_));
  oai21  g085(.a(x23), .b(new_n53_), .c(new_n57_), .O(new_n119_));
  aoi22  g086(.a(new_n119_), .b(new_n68_), .c(x09), .d(new_n81_), .O(new_n120_));
  oai22  g087(.a(new_n120_), .b(x16), .c(new_n111_), .d(new_n81_), .O(new_n121_));
  aoi21  g088(.a(new_n121_), .b(new_n118_), .c(new_n111_), .O(new_n122_));
  oai21  g089(.a(new_n117_), .b(new_n77_), .c(new_n122_), .O(z4));
  nor2   g090(.a(new_n111_), .b(new_n49_), .O(z5));
  aoi21  g091(.a(new_n36_), .b(x06), .c(x03), .O(new_n125_));
  aoi21  g092(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n77_), .c(new_n125_), .d(new_n49_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n112_), .O(new_n128_));
  nand3  g095(.a(new_n99_), .b(x21), .c(new_n58_), .O(new_n129_));
  nand2  g096(.a(new_n36_), .b(x00), .O(new_n130_));
  nand3  g097(.a(new_n68_), .b(x20), .c(new_n69_), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n44_), .c(new_n43_), .O(new_n133_));
  nand3  g100(.a(new_n99_), .b(new_n58_), .c(x15), .O(new_n134_));
  nand4  g101(.a(new_n107_), .b(new_n68_), .c(x20), .d(x19), .O(new_n135_));
  ...
  nand3  g106(.a(new_n99_), .b(new_n58_), .c(x18), .O(new_n140_));
  nand2  g107(.a(new_n36_), .b(x07), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n131_), .c(new_n140_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n97_), .c(x24), .O(new_n143_));
  nand3  g110(.a(new_n136_), .b(new_n46_), .c(new_n37_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n143_), .c(new_n139_), .d(new_n128_), .O(z6));
  inv1   g112(.a(new_n72_), .O(new_n146_));
  and2   g113(.a(new_n74_), .b(new_n73_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n112_), .c(new_n75_), .d(new_n146_), .O(z7));
endmodule
