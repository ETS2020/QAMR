...
module FAU ( 
  ...
  nand4  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n81_), .O(new_n126_));
  ...
  nand3  g098(.a(new_n63_), .b(x14), .c(x11), .O(new_n132_));
  nand4  g099(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n56_), .O(new_n133_));
  nand4  g100(.a(new_n37_), .b(new_n73_), .c(new_n36_), .d(new_n91_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n131_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n55_), .c(x24), .O(new_n136_));
  nand4  g103(.a(new_n83_), .b(x20), .c(x14), .d(x11), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(new_n91_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(x06), .c(x03), .d(x01), .O(new_n139_));
  nand4  g106(.a(new_n94_), .b(new_n37_), .c(new_n73_), .d(new_n36_), .O(new_n140_));
  nor2   g107(.a(new_n140_), .b(x08), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n35_), .c(new_n34_), .d(new_n56_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n139_), .c(new_n136_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n44_), .O(new_n144_));
  nand4  g111(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n145_));
  nand3  g112(.a(new_n110_), .b(new_n34_), .c(new_n56_), .O(new_n146_));
  nand3  g113(.a(new_n115_), .b(new_n73_), .c(new_n36_), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n131_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n105_), .c(new_n40_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n144_), .O(z3));
  oai21  g117(.a(x23), .b(new_n57_), .c(new_n71_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n64_), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n91_), .O(new_n153_));
  oai21  g120(.a(new_n39_), .b(x02), .c(new_n41_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(x05), .O(new_n155_));
  nand4  g122(.a(new_n53_), .b(x19), .c(new_n47_), .d(new_n38_), .O(new_n156_));
  nand2  g123(.a(new_n93_), .b(new_n43_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n44_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n156_), .c(new_n155_), .O(z5));
  nand2  g126(.a(z5), .b(new_n153_), .O(new_n160_));
  oai21  g127(.a(new_n65_), .b(x04), .c(x17), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x22), .c(new_n92_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n74_), .c(x08), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n126_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n160_), .c(new_n53_), .O(z4));
  aoi21  g132(.a(x20), .b(new_n73_), .c(x06), .O(new_n166_));
  ...
  nor3   g137(.a(new_n40_), .b(new_n62_), .c(x02), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n122_), .c(x05), .O(new_n172_));
  nand4  g139(.a(new_n53_), .b(x15), .c(new_n47_), .d(new_n38_), .O(new_n173_));
  nand2  g140(.a(new_n124_), .b(new_n82_), .O(new_n174_));
