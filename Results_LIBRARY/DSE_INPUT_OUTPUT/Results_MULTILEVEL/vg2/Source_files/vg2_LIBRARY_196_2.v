...
module FAU ( 
  ...
  nand2  g039(.a(new_n45_), .b(new_n39_), .O(new_n73_));
  nand3  g040(.a(new_n41_), .b(x13), .c(x05), .O(new_n74_));
  ...
  nand4  g048(.a(new_n81_), .b(new_n78_), .c(new_n60_), .d(new_n56_), .O(new_n82_));
  nor2   g049(.a(x09), .b(x08), .O(new_n83_));
  nand4  g050(.a(new_n83_), .b(new_n63_), .c(x07), .d(new_n34_), .O(new_n84_));
  nor2   g051(.a(x12), .b(x11), .O(new_n85_));
  nor2   g052(.a(x16), .b(x14), .O(new_n86_));
  nor2   g053(.a(x20), .b(x17), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n70_), .O(new_n88_));
  oai21  g055(.a(new_n88_), .b(new_n84_), .c(new_n82_), .O(new_n89_));
  nand3  g056(.a(new_n89_), .b(new_n73_), .c(x24), .O(new_n90_));
  and2   g057(.a(x21), .b(x20), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n78_), .c(new_n60_), .d(new_n56_), .O(new_n92_));
  nor2   g059(.a(x03), .b(x01), .O(new_n93_));
  nor2   g060(.a(x06), .b(x04), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n93_), .c(new_n83_), .d(x00), .O(new_n95_));
  oai21  g062(.a(new_n95_), .b(new_n88_), .c(new_n92_), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(new_n41_), .c(new_n37_), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n90_), .c(new_n76_), .O(new_n98_));
  nand2  g065(.a(new_n98_), .b(new_n49_), .O(new_n99_));
  nand2  g066(.a(new_n90_), .b(new_n76_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(x10), .O(new_n101_));
  ...
  nand3  g074(.a(x15), .b(new_n45_), .c(new_n39_), .O(new_n108_));
  nand3  g075(.a(new_n41_), .b(x21), .c(new_n37_), .O(new_n109_));
  ...
  oai21  g080(.a(new_n113_), .b(new_n103_), .c(new_n38_), .O(z2));
  ...
  nand2  g084(.a(new_n93_), .b(new_n64_), .O(new_n118_));
  nand3  g085(.a(new_n69_), .b(new_n36_), .c(new_n35_), .O(new_n119_));
  oai22  g086(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n115_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n75_), .O(new_n121_));
  nand2  g088(.a(new_n116_), .b(new_n81_), .O(new_n122_));
  nand3  g089(.a(new_n93_), .b(x07), .c(new_n34_), .O(new_n123_));
  inv1   g090(.a(x08), .O(new_n124_));
  nand4  g091(.a(new_n80_), .b(new_n36_), .c(new_n35_), .d(new_n124_), .O(new_n125_));
  ...
  inv1   g094(.a(x03), .O(new_n128_));
  nand4  g095(.a(new_n34_), .b(new_n128_), .c(new_n103_), .d(x00), .O(new_n129_));
  nand2  g096(.a(new_n116_), .b(new_n91_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n115_), .c(new_n129_), .d(new_n125_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n41_), .c(new_n37_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n127_), .c(new_n121_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n49_), .O(new_n134_));
  nand2  g101(.a(new_n127_), .b(new_n121_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(x10), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n134_), .O(z3));
  inv1   g104(.a(x16), .O(new_n138_));
  inv1   g105(.a(x23), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(x04), .c(x17), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x22), .c(new_n62_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n138_), .c(new_n124_), .O(new_n142_));
  oai21  g109(.a(new_n124_), .b(x02), .c(new_n142_), .O(new_n143_));
  nand3  g110(.a(new_n41_), .b(new_n37_), .c(x00), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n46_), .c(new_n44_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n43_), .c(new_n143_), .O(new_n146_));
  oai21  g113(.a(new_n139_), .b(x04), .c(x17), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x22), .c(new_n62_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n138_), .c(x08), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(x18), .O(new_n150_));
  nand3  g117(.a(x10), .b(x08), .c(x07), .O(new_n151_));
  ...
  nand3  g121(.a(x19), .b(x10), .c(x08), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n75_), .O(new_n157_));
  nand3  g124(.a(new_n149_), .b(new_n41_), .c(x21), .O(new_n158_));
  ...
  nand2  g128(.a(new_n50_), .b(new_n48_), .O(z5));
  aoi21  g129(.a(x20), .b(new_n36_), .c(x06), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x11), .c(new_n128_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(z5), .O(new_n165_));
  aoi21  g132(.a(new_n80_), .b(x14), .c(new_n34_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n35_), .c(x03), .O(new_n167_));
  nand2  g134(.a(new_n108_), .b(new_n107_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n106_), .c(new_n38_), .O(new_n169_));
  nand4  g136(.a(new_n41_), .b(x21), .c(new_n37_), .d(new_n49_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n169_), .O(z7));
