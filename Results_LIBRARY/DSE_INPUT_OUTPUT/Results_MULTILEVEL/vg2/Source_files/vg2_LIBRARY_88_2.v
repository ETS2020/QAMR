...
module FAU ( 
  ...
  nand3  g108(.a(new_n141_), .b(new_n98_), .c(new_n44_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n109_), .c(new_n108_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n107_), .c(new_n139_), .O(new_n144_));
  nor2   g111(.a(x02), .b(new_n94_), .O(new_n145_));
  inv1   g112(.a(new_n145_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n144_), .c(new_n136_), .O(z4));
  aoi21  g114(.a(new_n45_), .b(x00), .c(x01), .O(new_n148_));
  nand2  g115(.a(new_n48_), .b(new_n43_), .O(new_n149_));
  nor2   g116(.a(new_n149_), .b(new_n42_), .O(new_n150_));
  oai21  g117(.a(new_n148_), .b(x02), .c(new_n150_), .O(z5));
  aoi21  g118(.a(x20), .b(new_n87_), .c(x06), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x11), .c(new_n34_), .O(new_n153_));
  nand4  g120(.a(new_n45_), .b(new_n44_), .c(new_n94_), .d(x00), .O(new_n154_));
  oai21  g121(.a(new_n150_), .b(new_n145_), .c(new_n154_), .O(new_n155_));
  ...
  oai21  g125(.a(new_n110_), .b(new_n107_), .c(new_n146_), .O(new_n159_));
  nand4  g126(.a(new_n141_), .b(new_n98_), .c(new_n44_), .d(new_n94_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n159_), .O(z7));
