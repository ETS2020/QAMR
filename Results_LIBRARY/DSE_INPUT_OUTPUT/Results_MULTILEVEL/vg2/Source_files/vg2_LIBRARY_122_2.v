...
module FAU ( 
  ...
  nor3   g078(.a(new_n111_), .b(new_n37_), .c(new_n62_), .O(new_n112_));
  ...
  nand3  g087(.a(new_n85_), .b(new_n62_), .c(new_n36_), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  oai21  g089(.a(new_n122_), .b(new_n118_), .c(new_n91_), .O(new_n123_));
  inv1   g090(.a(new_n116_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n96_), .c(x14), .O(new_n125_));
  nor2   g092(.a(x11), .b(x08), .O(new_n126_));
  nor2   g093(.a(x20), .b(x14), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n126_), .c(new_n119_), .d(new_n100_), .O(new_n128_));
  ...
  nand4  g100(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n56_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n130_), .c(new_n123_), .O(z3));
  inv1   g102(.a(x23), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(x04), .c(x17), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(x22), .c(new_n79_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n63_), .c(new_n98_), .O(new_n139_));
  oai21  g106(.a(new_n98_), .b(x01), .c(new_n139_), .O(new_n140_));
  oai21  g107(.a(new_n49_), .b(new_n42_), .c(new_n140_), .O(new_n141_));
  oai21  g108(.a(new_n136_), .b(x04), .c(x17), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(x22), .c(new_n79_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n63_), .c(x08), .O(new_n144_));
  ...
  nand2  g118(.a(new_n151_), .b(new_n91_), .O(new_n152_));
  nand4  g119(.a(new_n144_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n54_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n44_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n152_), .c(new_n148_), .d(new_n141_), .O(z4));
  nor2   g123(.a(x02), .b(new_n54_), .O(new_n157_));
  nand2  g124(.a(new_n48_), .b(new_n43_), .O(new_n158_));
  nor2   g125(.a(new_n158_), .b(new_n42_), .O(new_n159_));
  nand4  g126(.a(new_n56_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n160_));
  oai21  g127(.a(new_n159_), .b(new_n157_), .c(new_n160_), .O(z5));
  aoi21  g128(.a(x20), .b(new_n62_), .c(x06), .O(new_n162_));
  ...
  nor2   g133(.a(x02), .b(x01), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n168_));
  oai21  g135(.a(new_n157_), .b(new_n111_), .c(new_n168_), .O(z7));
