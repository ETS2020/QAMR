...
module FAU ( 
  ...
  aoi22  g080(.a(new_n113_), .b(new_n39_), .c(new_n108_), .d(x13), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n38_), .c(x20), .d(x14), .O(new_n116_));
  ...
  nand3  g088(.a(new_n58_), .b(new_n71_), .c(new_n70_), .O(new_n122_));
  ...
  nand3  g092(.a(new_n100_), .b(x14), .c(x11), .O(new_n126_));
  nand4  g093(.a(x07), .b(new_n34_), .c(new_n71_), .d(new_n70_), .O(new_n127_));
  inv1   g094(.a(x08), .O(new_n128_));
  nand4  g095(.a(new_n99_), .b(new_n36_), .c(new_n35_), .d(new_n128_), .O(new_n129_));
  ...
  nand3  g100(.a(new_n37_), .b(new_n70_), .c(x00), .O(new_n134_));
  inv1   g101(.a(new_n134_), .O(new_n135_));
  nor3   g102(.a(x08), .b(x06), .c(x03), .O(new_n136_));
  nor3   g103(.a(x14), .b(x11), .c(x10), .O(new_n137_));
  nor3   g104(.a(x24), .b(x21), .c(x20), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n135_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n133_), .O(z3));
  inv1   g107(.a(x17), .O(new_n141_));
  oai21  g108(.a(x23), .b(new_n72_), .c(new_n141_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n76_), .c(x09), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n128_), .O(new_n144_));
  inv1   g111(.a(new_n43_), .O(new_n145_));
  nand4  g112(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n46_), .c(new_n44_), .d(new_n145_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  oai21  g115(.a(new_n77_), .b(x04), .c(x17), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n82_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n62_), .c(x08), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n115_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n148_), .c(new_n38_), .O(z4));
  nand3  g120(.a(new_n41_), .b(new_n49_), .c(x00), .O(new_n154_));
  inv1   g121(.a(new_n154_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x21), .c(new_n37_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n46_), .c(new_n44_), .d(new_n145_), .O(z5));
  and2   g124(.a(new_n51_), .b(new_n48_), .O(new_n158_));
  oai21  g125(.a(new_n99_), .b(x14), .c(new_n34_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n35_), .c(x03), .O(new_n160_));
  aoi21  g127(.a(new_n99_), .b(x14), .c(new_n34_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n35_), .c(x03), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n115_), .c(new_n38_), .O(new_n163_));
  oai21  g130(.a(new_n160_), .b(new_n158_), .c(new_n163_), .O(z6));
  and2   g131(.a(new_n115_), .b(new_n38_), .O(z7));
endmodule
