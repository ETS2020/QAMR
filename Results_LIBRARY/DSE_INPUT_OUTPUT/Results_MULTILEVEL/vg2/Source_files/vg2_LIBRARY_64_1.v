...
module FAU ( 
  ...
  nand2  g081(.a(x02), .b(new_n67_), .O(new_n115_));
  oai21  g082(.a(new_n114_), .b(new_n67_), .c(new_n115_), .O(z2));
  ...
  nand2  g086(.a(new_n98_), .b(new_n71_), .O(new_n120_));
  nand3  g087(.a(new_n76_), .b(new_n104_), .c(new_n37_), .O(new_n121_));
  ...
  nand3  g091(.a(new_n98_), .b(x07), .c(new_n36_), .O(new_n125_));
  ...
  nand3  g096(.a(new_n71_), .b(new_n35_), .c(x00), .O(new_n130_));
  ...
  nand2  g100(.a(new_n133_), .b(new_n67_), .O(new_n134_));
  nor4   g101(.a(new_n55_), .b(new_n35_), .c(x02), .d(new_n67_), .O(new_n135_));
  ...
  oai21  g106(.a(x23), .b(new_n68_), .c(new_n60_), .O(new_n140_));
  ...
  oai21  g110(.a(new_n143_), .b(new_n43_), .c(new_n115_), .O(new_n144_));
  ...
  nand2  g118(.a(new_n109_), .b(new_n108_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n107_), .c(new_n115_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n110_), .O(z7));
  ...
  nand4  g125(.a(new_n158_), .b(new_n115_), .c(new_n44_), .d(new_n157_), .O(z5));
