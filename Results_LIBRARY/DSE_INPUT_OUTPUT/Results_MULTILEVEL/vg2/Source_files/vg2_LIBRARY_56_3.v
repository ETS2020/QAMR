...
module FAU ( 
  ...
  oai21  g133(.a(x20), .b(new_n73_), .c(x06), .O(new_n167_));
  oai21  g134(.a(new_n108_), .b(new_n34_), .c(new_n109_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x05), .O(new_n169_));
  nand2  g136(.a(new_n159_), .b(x03), .O(new_n170_));
  nand2  g137(.a(new_n120_), .b(new_n112_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n40_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n170_), .c(new_n169_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n167_), .c(x11), .O(new_n174_));
  nand3  g141(.a(new_n133_), .b(new_n53_), .c(x18), .O(new_n175_));
  nand4  g142(.a(x15), .b(new_n47_), .c(new_n45_), .d(new_n38_), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(new_n175_), .c(new_n40_), .O(new_n177_));
  ...
  nand2  g148(.a(new_n181_), .b(new_n133_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n40_), .c(x15), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n180_), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n177_), .c(new_n34_), .O(new_n185_));
  nand4  g152(.a(new_n185_), .b(new_n174_), .c(new_n166_), .d(new_n53_), .O(z6));
endmodule
