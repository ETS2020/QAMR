...
module FAU ( 
  ...
  nand4  g124(.a(new_n40_), .b(x15), .c(x13), .d(new_n88_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n105_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(x05), .O(new_n160_));
  nand2  g127(.a(new_n110_), .b(new_n109_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n88_), .O(new_n162_));
  nand2  g129(.a(x18), .b(x13), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n109_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(x24), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n162_), .c(new_n160_), .O(z7));
  nand2  g133(.a(z7), .b(new_n157_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n152_), .O(z4));
  nand2  g135(.a(x20), .b(new_n104_), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(new_n35_), .c(x11), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(x03), .c(new_n48_), .d(new_n42_), .O(new_n171_));
  aoi21  g138(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n36_), .c(x03), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(z7), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n171_), .c(new_n52_), .O(z6));
endmodule
