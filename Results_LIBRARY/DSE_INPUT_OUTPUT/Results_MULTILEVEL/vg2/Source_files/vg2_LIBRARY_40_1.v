...
module FAU ( 
  ...
  nand2  g030(.a(new_n40_), .b(x05), .O(new_n64_));
  nand2  g031(.a(new_n50_), .b(new_n64_), .O(new_n65_));
  nand4  g032(.a(new_n65_), .b(new_n63_), .c(new_n62_), .d(new_n61_), .O(new_n66_));
  inv1   g033(.a(new_n66_), .O(new_n67_));
  nand4  g034(.a(new_n67_), .b(new_n60_), .c(new_n59_), .d(new_n36_), .O(new_n68_));
  nor2   g035(.a(new_n68_), .b(x12), .O(new_n69_));
  nand4  g036(.a(new_n69_), .b(new_n35_), .c(new_n58_), .d(new_n57_), .O(new_n70_));
  nor2   g037(.a(new_n70_), .b(x06), .O(new_n71_));
  nand4  g038(.a(new_n71_), .b(new_n56_), .c(new_n55_), .d(new_n54_), .O(new_n72_));
  nor2   g039(.a(new_n55_), .b(new_n54_), .O(new_n73_));
  nor2   g040(.a(new_n34_), .b(new_n56_), .O(new_n74_));
  nor2   g041(.a(new_n58_), .b(new_n57_), .O(new_n75_));
  ...
  nor2   g047(.a(x24), .b(new_n63_), .O(new_n81_));
  ...
  oai21  g075(.a(new_n108_), .b(new_n54_), .c(new_n105_), .O(z2));
  nand3  g076(.a(new_n73_), .b(x08), .c(x06), .O(new_n110_));
  nand3  g077(.a(new_n102_), .b(x20), .c(x15), .O(new_n111_));
  nand4  g078(.a(new_n57_), .b(new_n34_), .c(new_n55_), .d(new_n54_), .O(new_n112_));
  nand4  g079(.a(new_n61_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n113_));
  ...
  nand4  g088(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n57_), .O(new_n122_));
  ...
  nand4  g091(.a(new_n34_), .b(new_n55_), .c(new_n54_), .d(x00), .O(new_n125_));
  ...
  nand2  g098(.a(new_n50_), .b(new_n41_), .O(new_n132_));
  nor2   g099(.a(x23), .b(new_n56_), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(x17), .c(new_n62_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n58_), .c(x16), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x08), .c(new_n132_), .O(new_n136_));
  aoi21  g103(.a(x23), .b(new_n56_), .c(new_n60_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n62_), .c(x09), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(x16), .c(new_n57_), .O(new_n139_));
  inv1   g106(.a(new_n89_), .O(new_n140_));
  nand2  g107(.a(x15), .b(new_n43_), .O(new_n141_));
  nand4  g108(.a(new_n38_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n141_), .c(new_n90_), .O(new_n143_));
  aoi22  g110(.a(new_n143_), .b(new_n42_), .c(new_n140_), .d(x02), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n139_), .c(new_n136_), .O(z4));
  nand3  g112(.a(new_n116_), .b(x24), .c(x07), .O(new_n146_));
  nand2  g113(.a(new_n39_), .b(x02), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(x05), .O(new_n148_));
  aoi21  g115(.a(x08), .b(x05), .c(x24), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n47_), .c(new_n46_), .d(x00), .O(new_n150_));
  nand3  g117(.a(x19), .b(new_n43_), .c(new_n42_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n150_), .c(new_n148_), .d(new_n146_), .O(z5));
  aoi21  g119(.a(x20), .b(new_n36_), .c(x06), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x11), .c(new_n55_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n132_), .O(new_n155_));
  oai21  g122(.a(x20), .b(new_n36_), .c(x06), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x11), .c(new_n55_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n144_), .c(new_n155_), .O(z6));
  inv1   g125(.a(new_n144_), .O(z7));
endmodule
