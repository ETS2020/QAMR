...
module FAU ( 
  ...
  nor2   g076(.a(new_n40_), .b(new_n89_), .O(new_n110_));
  ...
  nand3  g081(.a(x15), .b(new_n82_), .c(new_n38_), .O(new_n115_));
  ...
  nand2  g145(.a(x20), .b(new_n74_), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n35_), .c(x11), .O(new_n180_));
  oai22  g147(.a(new_n180_), .b(x03), .c(new_n50_), .d(new_n42_), .O(new_n181_));
  nand2  g148(.a(new_n37_), .b(x14), .O(new_n182_));
  aoi21  g149(.a(new_n182_), .b(x06), .c(new_n36_), .O(new_n183_));
  and2   g150(.a(new_n158_), .b(new_n115_), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n114_), .c(new_n113_), .O(new_n185_));
  oai21  g152(.a(new_n183_), .b(new_n34_), .c(new_n185_), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(new_n181_), .c(new_n141_), .O(z6));
  nand4  g154(.a(new_n184_), .b(new_n141_), .c(new_n114_), .d(new_n113_), .O(z7));
endmodule
