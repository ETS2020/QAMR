...
module FAU ( 
  ...
  nand4  g027(.a(new_n60_), .b(x12), .c(x09), .d(x08), .O(new_n61_));
  ...
  nor2   g054(.a(new_n55_), .b(new_n70_), .O(new_n88_));
  ...
  nor3   g059(.a(x16), .b(x14), .c(x11), .O(new_n93_));
  nor2   g060(.a(x23), .b(x22), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n93_), .c(new_n69_), .d(new_n68_), .O(new_n95_));
  ...
  nand4  g069(.a(new_n102_), .b(new_n90_), .c(new_n36_), .d(new_n67_), .O(new_n103_));
  nor3   g070(.a(x17), .b(x16), .c(x14), .O(new_n104_));
  inv1   g071(.a(x19), .O(new_n105_));
  nor2   g072(.a(x20), .b(new_n105_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n104_), .c(new_n94_), .O(new_n107_));
  ...
  nand3  g079(.a(new_n112_), .b(new_n109_), .c(new_n97_), .O(new_n113_));
  inv1   g080(.a(new_n113_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n80_), .O(z1));
  nor2   g082(.a(new_n39_), .b(new_n86_), .O(new_n116_));
  ...
  nor3   g092(.a(new_n125_), .b(new_n69_), .c(new_n53_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x11), .c(x06), .d(x03), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n64_), .c(new_n112_), .O(z2));
  nand2  g095(.a(new_n57_), .b(new_n56_), .O(new_n129_));
  ...
  nand4  g100(.a(new_n133_), .b(new_n69_), .c(new_n53_), .d(new_n110_), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(x11), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n66_), .c(new_n35_), .d(new_n34_), .O(new_n136_));
  ...
  nand4  g107(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n141_));
  nor2   g108(.a(x11), .b(x08), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n69_), .c(new_n53_), .d(new_n110_), .O(new_n143_));
  ...
  nand3  g113(.a(new_n102_), .b(new_n34_), .c(new_n64_), .O(new_n147_));
  nand4  g114(.a(new_n106_), .b(new_n53_), .c(new_n110_), .d(new_n36_), .O(new_n148_));
  ...
  inv1   g118(.a(new_n49_), .O(new_n152_));
  oai21  g119(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n70_), .c(x09), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x16), .c(new_n66_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  inv1   g123(.a(new_n125_), .O(new_n157_));
  oai21  g124(.a(new_n55_), .b(x04), .c(x17), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x22), .c(new_n67_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n54_), .c(x08), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n156_), .c(new_n111_), .O(z4));
  inv1   g129(.a(new_n41_), .O(new_n163_));
  and2   g130(.a(new_n45_), .b(new_n42_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n112_), .c(new_n47_), .d(new_n163_), .O(z5));
  nand2  g132(.a(x20), .b(new_n53_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n35_), .c(x11), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x03), .c(new_n152_), .O(new_n168_));
  nand2  g135(.a(new_n69_), .b(x14), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x06), .c(new_n36_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n34_), .c(new_n157_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n168_), .c(new_n112_), .O(z6));
  inv1   g139(.a(new_n119_), .O(new_n173_));
  nand4  g140(.a(new_n123_), .b(new_n120_), .c(new_n173_), .d(new_n112_), .O(z7));
endmodule
