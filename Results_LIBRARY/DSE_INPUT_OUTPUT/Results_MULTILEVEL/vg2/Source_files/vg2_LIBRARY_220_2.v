...
module FAU ( 
  ...
  nand3  g079(.a(new_n58_), .b(new_n34_), .c(x00), .O(new_n113_));
  nor2   g080(.a(x11), .b(x10), .O(new_n114_));
  ...
  nand3  g088(.a(new_n85_), .b(new_n62_), .c(new_n36_), .O(new_n122_));
  oai22  g089(.a(new_n122_), .b(new_n121_), .c(new_n119_), .d(new_n118_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n91_), .O(new_n124_));
  nand4  g091(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n125_));
  nand3  g092(.a(new_n120_), .b(x07), .c(new_n35_), .O(new_n126_));
  inv1   g093(.a(x08), .O(new_n127_));
  nand4  g094(.a(new_n37_), .b(new_n62_), .c(new_n36_), .d(new_n127_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n126_), .c(new_n125_), .d(new_n118_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n89_), .c(x24), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n124_), .c(new_n117_), .O(z3));
  ...
  oai21  g103(.a(new_n136_), .b(x16), .c(new_n127_), .O(new_n137_));
  nand2  g104(.a(new_n44_), .b(x01), .O(new_n138_));
  nand2  g105(.a(new_n48_), .b(new_n43_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n42_), .c(new_n138_), .O(new_n140_));
  nand3  g107(.a(new_n56_), .b(new_n45_), .c(new_n44_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n140_), .O(z5));
  nand2  g109(.a(z5), .b(new_n137_), .O(new_n143_));
  inv1   g110(.a(x23), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x04), .c(x17), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x22), .c(new_n79_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n63_), .c(x08), .O(new_n147_));
  nor2   g114(.a(new_n108_), .b(new_n105_), .O(new_n148_));
  inv1   g115(.a(new_n138_), .O(new_n149_));
  inv1   g116(.a(x10), .O(new_n150_));
  nor2   g117(.a(x02), .b(x01), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n40_), .c(x21), .d(new_n150_), .O(new_n152_));
  oai21  g119(.a(new_n149_), .b(new_n148_), .c(new_n152_), .O(z7));
  nand2  g120(.a(z7), .b(new_n147_), .O(new_n154_));
  ...
  oai22  g124(.a(new_n157_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n158_));
  oai21  g125(.a(x20), .b(new_n62_), .c(x06), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(x11), .c(x03), .O(new_n160_));
  inv1   g127(.a(new_n160_), .O(new_n161_));
  nand4  g128(.a(new_n40_), .b(x21), .c(new_n150_), .d(new_n44_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n107_), .c(new_n106_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n105_), .c(new_n161_), .d(new_n120_), .O(new_n164_));
  nor2   g131(.a(new_n148_), .b(x03), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(x02), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n164_), .c(new_n158_), .d(new_n138_), .O(z6));
endmodule
