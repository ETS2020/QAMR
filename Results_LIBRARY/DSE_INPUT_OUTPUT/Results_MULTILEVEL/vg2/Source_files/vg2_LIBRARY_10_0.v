...
module FAU ( 
  ...
  nand4  g054(.a(new_n87_), .b(new_n73_), .c(new_n54_), .d(new_n84_), .O(new_n88_));
  ...
  nand4  g063(.a(new_n73_), .b(new_n54_), .c(new_n84_), .d(new_n53_), .O(new_n97_));
  ...
  nand4  g068(.a(new_n73_), .b(x19), .c(new_n54_), .d(new_n84_), .O(new_n102_));
  ...
  nand4  g071(.a(new_n104_), .b(new_n99_), .c(new_n92_), .d(new_n71_), .O(z3));
  ...
  aoi21  g087(.a(new_n120_), .b(new_n112_), .c(new_n70_), .O(z4));
  inv1   g088(.a(new_n41_), .O(new_n122_));
  and2   g089(.a(new_n45_), .b(new_n42_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n71_), .c(new_n47_), .d(new_n122_), .O(z5));
  ...
  nor2   g094(.a(new_n70_), .b(x03), .O(new_n128_));
  ...
  nand3  g099(.a(new_n132_), .b(new_n127_), .c(new_n71_), .O(z6));
