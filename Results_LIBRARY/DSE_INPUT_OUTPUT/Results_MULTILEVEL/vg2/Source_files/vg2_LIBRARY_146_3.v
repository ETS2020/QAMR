...
module FAU ( 
  ...
  inv1   g108(.a(new_n42_), .O(new_n142_));
  ...
  oai21  g119(.a(new_n152_), .b(new_n75_), .c(x08), .O(new_n153_));
  nand4  g120(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n154_));
  and2   g121(.a(new_n154_), .b(new_n114_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n113_), .c(new_n112_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n149_), .c(new_n53_), .O(z4));
  and2   g125(.a(new_n53_), .b(new_n43_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n48_), .c(new_n46_), .d(new_n142_), .O(z5));
  nand2  g127(.a(x20), .b(new_n74_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n35_), .c(x11), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x03), .c(new_n144_), .O(new_n163_));
  nand2  g130(.a(new_n37_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n36_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n34_), .c(new_n156_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n53_), .O(z6));
  nand4  g134(.a(new_n155_), .b(new_n113_), .c(new_n112_), .d(new_n53_), .O(z7));
endmodule
