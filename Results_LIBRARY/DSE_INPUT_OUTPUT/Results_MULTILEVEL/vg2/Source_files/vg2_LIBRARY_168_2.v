...
module FAU ( 
  ...
  nor3   g080(.a(new_n113_), .b(new_n37_), .c(new_n90_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x11), .c(x06), .d(x03), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(x02), .c(new_n107_), .O(z2));
  ...
  nand2  g087(.a(new_n34_), .b(new_n107_), .O(new_n121_));
  inv1   g088(.a(new_n121_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n67_), .O(new_n123_));
  nand3  g090(.a(new_n72_), .b(new_n90_), .c(new_n36_), .O(new_n124_));
  nor2   g091(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n120_), .c(new_n78_), .O(new_n126_));
  inv1   g093(.a(new_n118_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n83_), .c(x14), .O(new_n128_));
  nor2   g095(.a(x11), .b(x08), .O(new_n129_));
  nor2   g096(.a(x20), .b(x14), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n129_), .c(new_n122_), .d(new_n87_), .O(new_n131_));
  oai21  g098(.a(new_n128_), .b(new_n117_), .c(new_n131_), .O(new_n132_));
  ...
  nand4  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n98_), .O(new_n137_));
  ...
  nand3  g107(.a(new_n140_), .b(new_n91_), .c(new_n85_), .O(new_n141_));
  oai21  g108(.a(new_n85_), .b(x01), .c(new_n141_), .O(new_n142_));
  ...
  oai21  g112(.a(new_n145_), .b(new_n91_), .c(x08), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(x18), .O(new_n147_));
  nand3  g114(.a(x08), .b(x07), .c(x02), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n76_), .c(x24), .O(new_n150_));
  nand2  g117(.a(new_n146_), .b(x15), .O(new_n151_));
  ...
  nand4  g121(.a(new_n146_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n107_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n44_), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n154_), .c(new_n150_), .d(new_n143_), .O(z4));
  nor2   g125(.a(x02), .b(new_n107_), .O(new_n159_));
  nand2  g126(.a(new_n48_), .b(new_n43_), .O(new_n160_));
  nor2   g127(.a(new_n160_), .b(new_n42_), .O(new_n161_));
  nand4  g128(.a(new_n98_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n162_));
  oai21  g129(.a(new_n161_), .b(new_n159_), .c(new_n162_), .O(z5));
  aoi21  g130(.a(x20), .b(new_n90_), .c(x06), .O(new_n164_));
  ...
  nor2   g135(.a(x02), .b(x01), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n170_));
  oai21  g137(.a(new_n159_), .b(new_n113_), .c(new_n170_), .O(z7));
