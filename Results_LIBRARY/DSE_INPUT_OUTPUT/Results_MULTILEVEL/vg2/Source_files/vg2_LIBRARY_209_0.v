...
module FAU ( 
  ...
  nand3  g073(.a(new_n79_), .b(new_n34_), .c(new_n94_), .O(new_n107_));
  nand3  g074(.a(new_n84_), .b(new_n95_), .c(new_n36_), .O(new_n108_));
  ...
  nand3  g078(.a(new_n65_), .b(new_n34_), .c(new_n94_), .O(new_n112_));
  nand4  g079(.a(new_n37_), .b(new_n95_), .c(new_n36_), .d(new_n61_), .O(new_n113_));
  oai22  g080(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(new_n105_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(new_n73_), .c(x24), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n110_), .c(new_n51_), .O(z3));
  nand3  g083(.a(x24), .b(new_n44_), .c(new_n38_), .O(new_n117_));
  inv1   g084(.a(new_n117_), .O(new_n118_));
  aoi21  g085(.a(new_n91_), .b(x02), .c(new_n118_), .O(new_n119_));
  ...
  aoi21  g093(.a(new_n126_), .b(x16), .c(new_n61_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n121_), .O(new_n128_));
  ...
  nor2   g100(.a(new_n133_), .b(new_n83_), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n128_), .c(new_n120_), .O(new_n135_));
  inv1   g102(.a(x18), .O(new_n136_));
  oai22  g103(.a(new_n133_), .b(new_n64_), .c(new_n127_), .d(new_n136_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n73_), .c(x24), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n135_), .O(z4));
  nand2  g106(.a(new_n73_), .b(x24), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n64_), .c(new_n119_), .d(new_n83_), .O(z5));
  nand2  g108(.a(x20), .b(new_n95_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n35_), .c(x11), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(x03), .c(new_n46_), .d(new_n42_), .O(new_n144_));
  aoi21  g111(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n36_), .c(x03), .O(new_n146_));
  oai22  g113(.a(new_n140_), .b(new_n136_), .c(new_n119_), .d(new_n121_), .O(z7));
  nand2  g114(.a(z7), .b(new_n146_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n144_), .c(new_n51_), .O(z6));
endmodule
