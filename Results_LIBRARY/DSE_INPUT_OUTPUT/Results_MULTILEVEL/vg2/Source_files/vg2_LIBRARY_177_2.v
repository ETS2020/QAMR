...
module FAU ( 
  ...
  oai21  g112(.a(new_n145_), .b(new_n90_), .c(x08), .O(new_n146_));
  nand4  g113(.a(new_n40_), .b(x21), .c(new_n100_), .d(new_n44_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n112_), .c(new_n111_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n110_), .c(new_n146_), .O(new_n149_));
  nor2   g116(.a(x02), .b(new_n107_), .O(new_n150_));
  ...
  oai21  g122(.a(new_n153_), .b(x02), .c(new_n155_), .O(z5));
  aoi21  g123(.a(x20), .b(new_n89_), .c(x06), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x11), .c(new_n34_), .O(new_n158_));
  nand3  g125(.a(new_n97_), .b(new_n45_), .c(new_n44_), .O(new_n159_));
  oai21  g126(.a(new_n155_), .b(new_n150_), .c(new_n159_), .O(new_n160_));
  ...
  nor2   g130(.a(new_n113_), .b(new_n110_), .O(new_n164_));
  nand3  g131(.a(new_n40_), .b(x21), .c(new_n100_), .O(new_n165_));
  inv1   g132(.a(new_n165_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n44_), .c(new_n107_), .O(new_n167_));
  oai21  g134(.a(new_n150_), .b(new_n164_), .c(new_n167_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n163_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n161_), .O(z6));
  oai21  g137(.a(new_n166_), .b(x01), .c(new_n44_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n164_), .O(z7));
endmodule
