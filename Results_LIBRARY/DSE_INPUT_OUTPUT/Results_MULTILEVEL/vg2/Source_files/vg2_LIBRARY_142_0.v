...
module FAU ( 
  ...
  nand3  g110(.a(new_n143_), .b(new_n79_), .c(x24), .O(new_n144_));
  nand3  g111(.a(new_n141_), .b(x16), .c(x15), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n74_), .O(new_n146_));
  ...
  nand4  g117(.a(new_n150_), .b(new_n42_), .c(new_n99_), .d(new_n37_), .O(new_n151_));
  ...
  oai21  g123(.a(new_n156_), .b(x22), .c(new_n64_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(x19), .c(new_n154_), .O(new_n158_));
  inv1   g125(.a(new_n158_), .O(new_n159_));
  inv1   g126(.a(x15), .O(new_n160_));
  nor2   g127(.a(new_n160_), .b(x08), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n159_), .c(new_n81_), .O(new_n162_));
  nand3  g129(.a(new_n157_), .b(new_n154_), .c(x07), .O(new_n163_));
  nand2  g130(.a(x18), .b(new_n38_), .O(new_n164_));
  ...
  nand2  g135(.a(new_n168_), .b(new_n153_), .O(z4));
  nor2   g136(.a(new_n48_), .b(new_n44_), .O(new_n170_));
  aoi21  g137(.a(new_n50_), .b(x00), .c(new_n38_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(x02), .c(new_n170_), .O(z5));
  nand2  g139(.a(x20), .b(new_n36_), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(new_n34_), .c(x11), .O(new_n174_));
  nand3  g141(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n47_), .c(new_n45_), .O(new_n176_));
  oai22  g143(.a(new_n176_), .b(new_n44_), .c(new_n174_), .d(x03), .O(new_n177_));
  oai21  g144(.a(x20), .b(new_n36_), .c(x06), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(x11), .c(x03), .O(new_n179_));
  oai21  g146(.a(new_n38_), .b(x03), .c(new_n179_), .O(new_n180_));
  nand3  g147(.a(new_n115_), .b(new_n99_), .c(new_n37_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n112_), .c(new_n111_), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(new_n110_), .c(new_n180_), .O(new_n183_));
  or2    g150(.a(new_n113_), .b(new_n110_), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n66_), .c(x02), .O(new_n185_));
  nand4  g152(.a(new_n185_), .b(new_n183_), .c(new_n177_), .d(new_n39_), .O(z6));
  nand2  g153(.a(new_n116_), .b(new_n114_), .O(z7));
endmodule
