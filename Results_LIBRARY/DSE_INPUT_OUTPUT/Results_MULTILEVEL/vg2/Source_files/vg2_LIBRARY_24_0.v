...
module FAU ( 
  ...
  nand4  g095(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n108_), .O(new_n129_));
  nand4  g096(.a(new_n85_), .b(new_n37_), .c(new_n36_), .d(new_n58_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n126_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n92_), .O(new_n132_));
  nand3  g099(.a(new_n127_), .b(x20), .c(x18), .O(new_n133_));
  nor2   g100(.a(x20), .b(x14), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n36_), .c(new_n58_), .d(x07), .O(new_n135_));
  ...
  nor2   g104(.a(x02), .b(new_n108_), .O(new_n138_));
  nand2  g105(.a(new_n127_), .b(new_n109_), .O(new_n139_));
  nand2  g106(.a(new_n112_), .b(x20), .O(new_n140_));
  nor2   g107(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n138_), .c(new_n59_), .d(x03), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n137_), .c(new_n132_), .O(z3));
  inv1   g110(.a(x22), .O(new_n144_));
  oai21  g111(.a(x23), .b(new_n56_), .c(new_n100_), .O(new_n145_));
  ...
  nand4  g117(.a(new_n150_), .b(new_n55_), .c(x01), .d(x00), .O(new_n151_));
  ...
  oai21  g122(.a(new_n155_), .b(new_n101_), .c(x08), .O(new_n156_));
  inv1   g123(.a(new_n138_), .O(new_n157_));
  nand2  g124(.a(new_n112_), .b(new_n109_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n157_), .c(new_n149_), .d(new_n122_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n153_), .O(z4));
  aoi21  g128(.a(new_n150_), .b(x00), .c(new_n108_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x02), .c(new_n148_), .O(z5));
  aoi21  g130(.a(x20), .b(new_n37_), .c(x06), .O(new_n164_));
  ...
  nand2  g135(.a(new_n168_), .b(new_n159_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n166_), .O(z6));
  aoi21  g137(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(x02), .c(new_n122_), .O(z7));
endmodule
