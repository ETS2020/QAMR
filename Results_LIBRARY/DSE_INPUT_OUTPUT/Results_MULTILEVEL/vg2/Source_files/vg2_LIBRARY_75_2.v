...
module FAU ( 
  ...
  nand3  g075(.a(x15), .b(new_n55_), .c(new_n49_), .O(new_n109_));
  oai21  g076(.a(new_n106_), .b(new_n55_), .c(new_n109_), .O(new_n110_));
  oai21  g077(.a(new_n110_), .b(new_n108_), .c(x20), .O(new_n111_));
  ...
  nand2  g081(.a(new_n86_), .b(new_n39_), .O(new_n115_));
  nand3  g082(.a(new_n64_), .b(new_n43_), .c(new_n42_), .O(new_n116_));
  oai21  g083(.a(new_n116_), .b(new_n115_), .c(new_n35_), .O(new_n117_));
  ...
  nand3  g087(.a(new_n86_), .b(new_n47_), .c(new_n35_), .O(new_n121_));
  nand4  g088(.a(new_n48_), .b(x19), .c(new_n42_), .d(new_n41_), .O(new_n122_));
  ...
  nand4  g092(.a(x07), .b(new_n36_), .c(new_n47_), .d(new_n35_), .O(new_n126_));
  inv1   g093(.a(x08), .O(new_n127_));
  nand4  g094(.a(new_n48_), .b(new_n42_), .c(new_n41_), .d(new_n127_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n126_), .c(new_n125_), .d(new_n119_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n91_), .c(x24), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n124_), .c(new_n118_), .O(z3));
  inv1   g098(.a(x04), .O(new_n132_));
  oai21  g099(.a(x23), .b(new_n132_), .c(new_n69_), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(new_n66_), .c(x09), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(x16), .c(new_n127_), .O(new_n135_));
  nor2   g102(.a(new_n57_), .b(new_n53_), .O(new_n136_));
  nor2   g103(.a(x02), .b(new_n35_), .O(new_n137_));
  nor2   g104(.a(x24), .b(x10), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n139_));
  oai21  g106(.a(new_n137_), .b(new_n136_), .c(new_n139_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n135_), .O(new_n141_));
  inv1   g108(.a(x23), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x04), .c(x17), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(x22), .c(new_n84_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n68_), .c(x08), .O(new_n145_));
  nor2   g112(.a(new_n110_), .b(new_n108_), .O(new_n146_));
  nor2   g113(.a(x02), .b(x01), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n51_), .c(x21), .d(new_n37_), .O(new_n148_));
  oai21  g115(.a(new_n137_), .b(new_n146_), .c(new_n148_), .O(z7));
  nand2  g116(.a(z7), .b(new_n145_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n141_), .O(z4));
  aoi21  g118(.a(new_n138_), .b(x00), .c(x01), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x02), .c(new_n136_), .O(z5));
  aoi21  g120(.a(x20), .b(new_n42_), .c(x06), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x11), .c(new_n47_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n140_), .O(new_n156_));
  aoi21  g123(.a(new_n48_), .b(x14), .c(new_n36_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n41_), .c(x03), .O(new_n158_));
