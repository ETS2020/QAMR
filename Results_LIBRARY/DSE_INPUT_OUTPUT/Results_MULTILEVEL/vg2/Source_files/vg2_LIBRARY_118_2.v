...
module FAU ( 
  ...
  nand3  g073(.a(new_n106_), .b(new_n98_), .c(new_n86_), .O(z1));
  nand2  g074(.a(x24), .b(x18), .O(new_n108_));
  nand3  g075(.a(new_n41_), .b(x15), .c(x13), .O(new_n109_));
  aoi21  g076(.a(new_n109_), .b(new_n108_), .c(new_n48_), .O(new_n110_));
  nand3  g077(.a(x24), .b(x18), .c(x13), .O(new_n111_));
  nand3  g078(.a(x15), .b(new_n49_), .c(new_n48_), .O(new_n112_));
  nand4  g079(.a(new_n41_), .b(x21), .c(new_n46_), .d(new_n34_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n112_), .c(new_n111_), .O(new_n114_));
  oai21  g081(.a(new_n114_), .b(new_n110_), .c(x20), .O(new_n115_));
  nor2   g082(.a(new_n115_), .b(new_n38_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x11), .c(x06), .d(x03), .O(new_n117_));
  nor2   g084(.a(new_n117_), .b(new_n70_), .O(z2));
  ...
  nand2  g099(.a(new_n120_), .b(new_n100_), .O(new_n133_));
  ...
  nor2   g106(.a(x14), .b(new_n34_), .O(new_n140_));
  nand2  g107(.a(new_n50_), .b(new_n45_), .O(new_n141_));
  aoi21  g108(.a(new_n43_), .b(x05), .c(new_n141_), .O(new_n142_));
  nand4  g109(.a(new_n41_), .b(new_n46_), .c(new_n34_), .d(x00), .O(new_n143_));
  oai21  g110(.a(new_n142_), .b(new_n140_), .c(new_n143_), .O(z5));
  ...
  nand2  g117(.a(new_n112_), .b(new_n111_), .O(new_n151_));
  nor2   g118(.a(new_n151_), .b(new_n110_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n140_), .c(new_n113_), .O(z7));
  nand2  g120(.a(z7), .b(new_n150_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n145_), .O(z4));
  nand2  g122(.a(x20), .b(new_n38_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n36_), .c(x11), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x03), .c(new_n53_), .O(new_n158_));
  oai21  g125(.a(new_n37_), .b(x06), .c(x03), .O(new_n159_));
  nor2   g126(.a(x24), .b(new_n99_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n46_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n112_), .c(new_n111_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n110_), .c(new_n159_), .O(new_n163_));
  nand4  g130(.a(new_n120_), .b(new_n160_), .c(new_n39_), .d(new_n46_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n163_), .c(new_n158_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n34_), .O(new_n166_));
  aoi21  g133(.a(new_n37_), .b(x06), .c(x03), .O(new_n167_));
  nand2  g134(.a(x20), .b(x06), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x11), .c(new_n35_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n152_), .c(new_n167_), .d(new_n142_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(x14), .O(new_n171_));
