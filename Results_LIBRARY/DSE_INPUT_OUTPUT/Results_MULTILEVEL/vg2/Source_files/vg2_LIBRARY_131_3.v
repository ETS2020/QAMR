...
module FAU ( 
  ...
  nor2   g39(.a(new_n36_), .b(new_n35_), .O(new_n74_));
  ...
  oai21  g43(.a(new_n77_), .b(x16), .c(new_n70_), .O(new_n78_));
  ...
  nand3  g53(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n88_));
  nand4  g54(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n89_));
  ...
  aoi21  g59(.a(new_n93_), .b(new_n79_), .c(new_n74_), .O(z4));
  nor2   g60(.a(new_n74_), .b(new_n49_), .O(z5));
  inv1   g61(.a(new_n74_), .O(new_n96_));
  inv1   g62(.a(x21), .O(new_n97_));
  nand2  g63(.a(x03), .b(x00), .O(new_n98_));
  oai21  g64(.a(new_n97_), .b(x03), .c(new_n98_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n44_), .c(new_n43_), .O(new_n100_));
  ...
  nand2  g71(.a(new_n46_), .b(new_n37_), .O(new_n106_));
  nand2  g72(.a(x07), .b(x03), .O(new_n107_));
  oai21  g73(.a(new_n83_), .b(x03), .c(new_n107_), .O(new_n108_));
  nand3  g74(.a(new_n108_), .b(new_n106_), .c(x24), .O(new_n109_));
  nand3  g75(.a(new_n103_), .b(new_n46_), .c(new_n37_), .O(new_n110_));
  nand2  g76(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  oai21  g77(.a(new_n111_), .b(new_n105_), .c(new_n96_), .O(new_n112_));
  nand2  g78(.a(x20), .b(new_n35_), .O(new_n113_));
  oai21  g79(.a(x20), .b(new_n55_), .c(new_n113_), .O(new_n114_));
  nand3  g80(.a(new_n114_), .b(new_n50_), .c(new_n34_), .O(new_n115_));
  nand2  g81(.a(new_n35_), .b(new_n55_), .O(new_n116_));
  oai21  g82(.a(x20), .b(new_n35_), .c(new_n116_), .O(new_n117_));
  nand3  g83(.a(new_n117_), .b(new_n92_), .c(x11), .O(new_n118_));
  nand3  g84(.a(new_n118_), .b(new_n115_), .c(new_n112_), .O(z6));
  aoi21  g85(.a(new_n91_), .b(new_n86_), .c(new_n74_), .O(z7));
  zero   g86(.O(z2));
endmodule
