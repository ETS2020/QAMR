...
module FAU ( 
  ...
  nor2   g005(.a(new_n38_), .b(x02), .O(new_n39_));
  ...
  nand4  g017(.a(new_n42_), .b(new_n38_), .c(new_n50_), .d(x00), .O(new_n51_));
  ...
  nand4  g047(.a(new_n80_), .b(new_n73_), .c(new_n72_), .d(new_n36_), .O(new_n81_));
  nor2   g048(.a(new_n81_), .b(x12), .O(new_n82_));
  nand4  g049(.a(new_n82_), .b(new_n35_), .c(new_n71_), .d(new_n70_), .O(new_n83_));
  nor2   g050(.a(new_n83_), .b(x06), .O(new_n84_));
  nand4  g051(.a(new_n84_), .b(new_n69_), .c(new_n68_), .d(new_n67_), .O(new_n85_));
  aoi21  g052(.a(new_n85_), .b(new_n66_), .c(x24), .O(new_n86_));
  ...
  nand4  g076(.a(new_n109_), .b(new_n96_), .c(new_n35_), .d(new_n71_), .O(new_n110_));
  ...
  oai21  g085(.a(new_n118_), .b(new_n86_), .c(new_n38_), .O(new_n119_));
  ...
  nand4  g093(.a(new_n42_), .b(x21), .c(x20), .d(x14), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n126_), .c(new_n38_), .O(new_n128_));
  ...
  nand3  g099(.a(x15), .b(new_n46_), .c(new_n40_), .O(new_n133_));
  oai21  g100(.a(new_n130_), .b(new_n46_), .c(new_n133_), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nor3   g102(.a(new_n135_), .b(new_n37_), .c(new_n36_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(x11), .c(x06), .d(x03), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n67_), .c(new_n129_), .O(z2));
  ...
  nand4  g108(.a(new_n78_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n142_));
  nor2   g109(.a(new_n142_), .b(x08), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n141_), .c(x24), .O(new_n145_));
  nand4  g112(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n146_));
  nand3  g113(.a(new_n93_), .b(x14), .c(x11), .O(new_n147_));
  nand4  g114(.a(x07), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n148_));
  nand4  g115(.a(new_n37_), .b(new_n36_), .c(new_n35_), .d(new_n70_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n146_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n87_), .c(x24), .O(new_n151_));
  nand4  g118(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n152_));
  nand3  g119(.a(new_n109_), .b(new_n68_), .c(new_n67_), .O(new_n153_));
  nand3  g120(.a(new_n114_), .b(new_n36_), .c(new_n35_), .O(new_n154_));
  oai22  g121(.a(new_n154_), .b(new_n153_), .c(new_n152_), .d(new_n146_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n46_), .c(new_n40_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n151_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n145_), .c(new_n38_), .O(new_n158_));
  nand2  g125(.a(new_n155_), .b(new_n121_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n151_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(x02), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n158_), .O(z3));
  aoi21  g129(.a(new_n75_), .b(x04), .c(x17), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x22), .c(new_n71_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n72_), .c(new_n70_), .O(new_n165_));
  oai21  g132(.a(x10), .b(new_n70_), .c(new_n165_), .O(new_n166_));
  nand3  g133(.a(new_n42_), .b(new_n50_), .c(x00), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n47_), .c(new_n45_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n44_), .c(new_n166_), .O(new_n169_));
  ...
  nand2  g148(.a(new_n181_), .b(new_n38_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n50_), .O(new_n183_));
  nand4  g150(.a(new_n183_), .b(new_n179_), .c(new_n175_), .d(new_n169_), .O(z4));
  aoi21  g151(.a(x20), .b(new_n36_), .c(x06), .O(new_n185_));
  oai21  g152(.a(new_n185_), .b(x11), .c(new_n68_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(z5), .O(new_n187_));
  aoi21  g154(.a(new_n37_), .b(x14), .c(new_n34_), .O(new_n188_));
  oai21  g155(.a(new_n188_), .b(new_n35_), .c(x03), .O(new_n189_));
  nand4  g156(.a(new_n42_), .b(x21), .c(new_n38_), .d(new_n50_), .O(new_n190_));
  oai21  g157(.a(new_n135_), .b(new_n39_), .c(new_n190_), .O(z7));
  nand2  g158(.a(z7), .b(new_n189_), .O(new_n192_));
  nand2  g159(.a(new_n192_), .b(new_n187_), .O(z6));
endmodule
