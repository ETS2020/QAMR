...
module FAU ( 
  ...
  inv1   g063(.a(new_n85_), .O(new_n97_));
  ...
  nor3   g067(.a(new_n100_), .b(new_n58_), .c(new_n34_), .O(new_n101_));
  inv1   g068(.a(x22), .O(new_n102_));
  inv1   g069(.a(x23), .O(new_n103_));
  nand2  g070(.a(x21), .b(x20), .O(new_n104_));
  nor4   g071(.a(new_n104_), .b(x24), .c(new_n103_), .d(new_n102_), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n101_), .c(new_n99_), .d(new_n97_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n96_), .c(new_n84_), .O(z1));
  ...
  oai21  g080(.a(new_n113_), .b(new_n111_), .c(new_n39_), .O(new_n114_));
  nor2   g081(.a(x10), .b(x02), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n42_), .c(x21), .d(x16), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n114_), .c(new_n108_), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(x14), .c(x11), .d(x06), .O(new_n118_));
  nor3   g085(.a(new_n118_), .b(new_n68_), .c(new_n67_), .O(z2));
  nand3  g086(.a(x15), .b(x13), .c(x05), .O(new_n120_));
  nand3  g087(.a(x21), .b(new_n50_), .c(new_n37_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x20), .c(x14), .d(x11), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(new_n58_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x06), .c(x03), .d(x01), .O(new_n125_));
  nand3  g092(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n126_));
  nand3  g093(.a(x19), .b(x13), .c(x05), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n108_), .c(new_n36_), .d(new_n35_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(x08), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n131_));
  ...
  nand4  g101(.a(x07), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n135_));
  nand4  g102(.a(new_n108_), .b(new_n36_), .c(new_n35_), .d(new_n58_), .O(new_n136_));
  ...
  nand3  g106(.a(new_n72_), .b(new_n68_), .c(new_n67_), .O(new_n140_));
  nand3  g107(.a(new_n77_), .b(new_n36_), .c(new_n35_), .O(new_n141_));
  ...
  oai21  g111(.a(new_n144_), .b(new_n132_), .c(x16), .O(new_n145_));
  nand2  g112(.a(new_n142_), .b(new_n83_), .O(new_n146_));
  ...
  nor2   g116(.a(new_n48_), .b(new_n44_), .O(new_n150_));
  inv1   g117(.a(new_n150_), .O(new_n151_));
  inv1   g118(.a(new_n39_), .O(new_n152_));
  aoi21  g119(.a(new_n103_), .b(x04), .c(x17), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x22), .c(new_n66_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n38_), .c(x02), .O(new_n155_));
  oai21  g122(.a(new_n152_), .b(new_n58_), .c(new_n155_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n151_), .O(new_n157_));
  nor2   g124(.a(new_n152_), .b(x08), .O(new_n158_));
  nand2  g125(.a(x23), .b(new_n69_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x17), .c(new_n102_), .O(new_n160_));
  nor2   g127(.a(new_n160_), .b(new_n66_), .O(new_n161_));
  nor2   g128(.a(new_n161_), .b(new_n38_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n158_), .c(new_n113_), .d(new_n111_), .O(new_n163_));
  nand2  g130(.a(x09), .b(x08), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n160_), .c(x21), .O(new_n165_));
  nand2  g132(.a(x08), .b(x00), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n165_), .c(x24), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(x16), .c(new_n50_), .d(new_n37_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n163_), .c(new_n157_), .O(z4));
  nand2  g136(.a(new_n38_), .b(x08), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n42_), .c(new_n50_), .d(x00), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(x16), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n37_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n150_), .O(z5));
  nand2  g141(.a(new_n52_), .b(new_n49_), .O(new_n175_));
  aoi21  g142(.a(x20), .b(new_n36_), .c(x06), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(x11), .c(new_n68_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n175_), .O(new_n178_));
  nand2  g145(.a(new_n116_), .b(new_n114_), .O(z7));
  aoi21  g146(.a(new_n108_), .b(x14), .c(new_n34_), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n35_), .c(x03), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(z7), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n178_), .O(z6));
endmodule
