...
module FAU ( 
  ...
  inv1   g087(.a(new_n93_), .O(new_n121_));
  ...
  aoi21  g096(.a(new_n129_), .b(new_n120_), .c(new_n50_), .O(z4));
  and2   g097(.a(new_n51_), .b(new_n113_), .O(z5));
  oai21  g098(.a(x20), .b(new_n90_), .c(x06), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(x11), .c(x03), .O(new_n133_));
  oai21  g100(.a(new_n50_), .b(x03), .c(new_n133_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n123_), .O(new_n135_));
  nand2  g102(.a(x20), .b(new_n90_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n35_), .c(x11), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(x03), .c(new_n113_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n135_), .c(new_n51_), .O(z6));
  aoi21  g106(.a(new_n122_), .b(new_n121_), .c(new_n50_), .O(z7));
endmodule
