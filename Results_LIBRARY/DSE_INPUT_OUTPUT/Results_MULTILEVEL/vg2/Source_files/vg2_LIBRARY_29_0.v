...
module FAU ( 
  ...
  nand4  g017(.a(new_n50_), .b(x08), .c(new_n37_), .d(x00), .O(new_n51_));
  ...
  oai21  g032(.a(new_n65_), .b(new_n60_), .c(x08), .O(new_n66_));
  nand2  g033(.a(new_n66_), .b(new_n37_), .O(new_n67_));
  nand3  g034(.a(x04), .b(x03), .c(x01), .O(new_n68_));
  inv1   g035(.a(new_n68_), .O(new_n69_));
  nor2   g036(.a(new_n38_), .b(new_n34_), .O(new_n70_));
  nand3  g037(.a(new_n70_), .b(x11), .c(x09), .O(new_n71_));
  ...
  nand4  g045(.a(new_n78_), .b(new_n77_), .c(new_n38_), .d(new_n34_), .O(new_n79_));
  ...
  nand3  g054(.a(new_n42_), .b(x13), .c(x05), .O(new_n88_));
  ...
  nand3  g060(.a(new_n93_), .b(new_n72_), .c(new_n69_), .O(new_n94_));
  nor2   g061(.a(x09), .b(x08), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n77_), .c(x07), .d(new_n34_), .O(new_n96_));
  inv1   g063(.a(x17), .O(new_n97_));
  inv1   g064(.a(x20), .O(new_n98_));
  inv1   g065(.a(x16), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n36_), .c(new_n58_), .d(new_n35_), .O(new_n100_));
  inv1   g067(.a(new_n100_), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n84_), .c(new_n98_), .d(new_n97_), .O(new_n102_));
  oai21  g069(.a(new_n102_), .b(new_n96_), .c(new_n94_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n87_), .c(x24), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n90_), .c(new_n67_), .O(z1));
  ...
  aoi21  g076(.a(new_n109_), .b(new_n108_), .c(new_n40_), .O(new_n110_));
  nand3  g077(.a(x15), .b(new_n46_), .c(new_n40_), .O(new_n111_));
  oai21  g078(.a(new_n108_), .b(new_n46_), .c(new_n111_), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(new_n110_), .c(new_n39_), .O(new_n113_));
  inv1   g080(.a(x21), .O(new_n114_));
  nor2   g081(.a(x24), .b(new_n114_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n55_), .O(new_n116_));
  inv1   g083(.a(new_n116_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(x08), .c(new_n37_), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(new_n113_), .c(new_n98_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x14), .c(x11), .d(x06), .O(new_n120_));
  nor3   g087(.a(new_n120_), .b(new_n107_), .c(new_n106_), .O(z2));
  nand3  g088(.a(new_n70_), .b(x03), .c(x01), .O(new_n122_));
  nor2   g089(.a(new_n36_), .b(new_n35_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(x20), .c(x15), .O(new_n124_));
  nand4  g091(.a(new_n34_), .b(new_n107_), .c(x02), .d(new_n106_), .O(new_n125_));
  nand4  g092(.a(new_n83_), .b(new_n36_), .c(new_n35_), .d(new_n38_), .O(new_n126_));
  ...
  nand4  g097(.a(new_n130_), .b(new_n35_), .c(new_n38_), .d(x07), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n125_), .c(new_n129_), .d(new_n122_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n87_), .c(x24), .O(new_n133_));
  nor2   g100(.a(x02), .b(new_n106_), .O(new_n134_));
  nand2  g101(.a(new_n123_), .b(new_n55_), .O(new_n135_));
  nand2  g102(.a(new_n115_), .b(x20), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n134_), .c(new_n70_), .d(x03), .O(new_n138_));
  ...
  aoi21  g109(.a(x23), .b(new_n142_), .c(new_n97_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n141_), .c(x09), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(x18), .c(x16), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n140_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n87_), .c(x24), .O(new_n147_));
  nand3  g114(.a(new_n144_), .b(x16), .c(x15), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n82_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n89_), .O(new_n150_));
  inv1   g117(.a(x00), .O(new_n151_));
  nand3  g118(.a(new_n144_), .b(x21), .c(x16), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n42_), .c(new_n55_), .d(new_n37_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n150_), .c(new_n147_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(x08), .O(new_n156_));
  inv1   g123(.a(x09), .O(new_n157_));
  aoi21  g124(.a(new_n63_), .b(x04), .c(x17), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x22), .c(new_n157_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(x19), .c(new_n99_), .O(new_n160_));
  inv1   g127(.a(new_n160_), .O(new_n161_));
  inv1   g128(.a(x15), .O(new_n162_));
  nor2   g129(.a(new_n162_), .b(x08), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n161_), .c(new_n89_), .O(new_n164_));
  nand3  g131(.a(new_n159_), .b(new_n99_), .c(x07), .O(new_n165_));
  nand2  g132(.a(x18), .b(new_n38_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n87_), .c(x24), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n164_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(x02), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n156_), .O(z4));
  nand2  g138(.a(new_n51_), .b(new_n49_), .O(z5));
  aoi21  g139(.a(x20), .b(new_n36_), .c(x06), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x11), .c(new_n107_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(z5), .O(new_n175_));
  nand2  g142(.a(new_n118_), .b(new_n113_), .O(new_n176_));
  aoi21  g143(.a(new_n98_), .b(x14), .c(new_n34_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n35_), .c(x03), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n176_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n175_), .O(z6));
  nor2   g147(.a(new_n112_), .b(new_n110_), .O(new_n181_));
  oai21  g148(.a(new_n117_), .b(new_n38_), .c(new_n37_), .O(new_n182_));
