...
module FAU ( 
  ...
  nor3   g046(.a(new_n79_), .b(new_n75_), .c(new_n71_), .O(new_n80_));
  ...
  nand4  g062(.a(new_n73_), .b(new_n36_), .c(new_n72_), .d(new_n35_), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n78_), .c(new_n89_), .d(new_n74_), .O(new_n98_));
  ...
  aoi21  g085(.a(new_n118_), .b(new_n117_), .c(new_n89_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x14), .c(x11), .d(x06), .O(new_n120_));
  nor3   g087(.a(new_n120_), .b(new_n110_), .c(new_n54_), .O(z2));
  nand3  g088(.a(new_n55_), .b(x06), .c(x03), .O(new_n122_));
  inv1   g089(.a(x08), .O(new_n123_));
  nor2   g090(.a(new_n35_), .b(new_n123_), .O(new_n124_));
  ...
  nand4  g100(.a(new_n89_), .b(new_n36_), .c(new_n35_), .d(new_n123_), .O(new_n134_));
  ...
  nand4  g103(.a(new_n34_), .b(new_n110_), .c(new_n54_), .d(x00), .O(new_n137_));
  ...
  nand4  g108(.a(new_n141_), .b(new_n136_), .c(new_n131_), .d(new_n37_), .O(z3));
  inv1   g109(.a(x09), .O(new_n143_));
  aoi21  g110(.a(new_n64_), .b(x04), .c(x17), .O(new_n144_));
  ...
  aoi21  g116(.a(x23), .b(new_n149_), .c(new_n74_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n63_), .c(x09), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x16), .c(new_n123_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n88_), .c(new_n123_), .d(new_n92_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n82_), .c(x24), .O(new_n154_));
  oai22  g121(.a(new_n152_), .b(new_n125_), .c(new_n76_), .d(new_n123_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n84_), .O(new_n156_));
  inv1   g123(.a(x00), .O(new_n157_));
  nand3  g124(.a(new_n151_), .b(x21), .c(x16), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n40_), .c(new_n49_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n48_), .O(new_n161_));
  nand3  g128(.a(new_n40_), .b(x21), .c(new_n49_), .O(new_n162_));
  nor3   g129(.a(new_n162_), .b(x08), .c(x02), .O(new_n163_));
  aoi21  g130(.a(new_n161_), .b(x08), .c(new_n163_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n156_), .c(new_n154_), .d(new_n148_), .O(z4));
  aoi21  g132(.a(new_n123_), .b(x02), .c(x10), .O(new_n166_));
  nor2   g133(.a(new_n76_), .b(new_n44_), .O(new_n167_));
  aoi22  g134(.a(new_n167_), .b(x05), .c(new_n166_), .d(x00), .O(new_n168_));
  nor2   g135(.a(new_n81_), .b(new_n40_), .O(new_n169_));
  nand2  g136(.a(new_n45_), .b(new_n37_), .O(new_n170_));
  aoi21  g137(.a(new_n169_), .b(x07), .c(new_n170_), .O(new_n171_));
  oai21  g138(.a(new_n168_), .b(x24), .c(new_n171_), .O(z5));
  nand2  g139(.a(new_n50_), .b(new_n47_), .O(new_n173_));
  aoi21  g140(.a(x20), .b(new_n36_), .c(x06), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(x11), .c(new_n110_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand2  g143(.a(new_n118_), .b(new_n117_), .O(new_n177_));
  aoi21  g144(.a(new_n89_), .b(x14), .c(new_n34_), .O(new_n178_));
  ...
  inv1   g148(.a(new_n113_), .O(new_n182_));
  and2   g149(.a(new_n118_), .b(new_n115_), .O(new_n183_));
  nand4  g150(.a(new_n183_), .b(new_n114_), .c(new_n182_), .d(new_n37_), .O(z7));
endmodule
