...
module FAU ( 
  ...
  oai21  g112(.a(new_n110_), .b(new_n106_), .c(new_n145_), .O(new_n146_));
  nand2  g113(.a(x02), .b(new_n66_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n146_), .c(new_n140_), .O(z4));
  nand4  g115(.a(new_n147_), .b(new_n138_), .c(new_n44_), .d(new_n136_), .O(z5));
  ...
  oai21  g119(.a(new_n152_), .b(new_n43_), .c(new_n147_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n137_), .O(new_n154_));
  ...
  oai21  g125(.a(new_n158_), .b(new_n106_), .c(new_n147_), .O(new_n159_));
  ...
  nand4  g129(.a(new_n147_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(new_n163_));
