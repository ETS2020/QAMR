...
module FAU ( 
  ...
  nand4  g089(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n107_), .O(new_n123_));
  nand4  g090(.a(new_n85_), .b(new_n37_), .c(new_n36_), .d(new_n57_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n120_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n91_), .O(new_n126_));
  nand3  g093(.a(new_n121_), .b(x20), .c(x18), .O(new_n127_));
  nor2   g094(.a(x20), .b(x14), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n36_), .c(new_n57_), .d(x07), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n123_), .c(new_n127_), .d(new_n120_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n89_), .c(x24), .O(new_n131_));
  nor2   g098(.a(x02), .b(new_n107_), .O(new_n132_));
  nand2  g099(.a(new_n121_), .b(new_n113_), .O(new_n133_));
  inv1   g100(.a(x21), .O(new_n134_));
  nor2   g101(.a(x24), .b(new_n134_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(x20), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n132_), .c(new_n58_), .d(x03), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n131_), .c(new_n126_), .O(z3));
  inv1   g106(.a(x22), .O(new_n140_));
  oai21  g107(.a(x23), .b(new_n55_), .c(new_n99_), .O(new_n141_));
  ...
  nand4  g113(.a(new_n146_), .b(new_n54_), .c(x01), .d(x00), .O(new_n147_));
  oai21  g114(.a(new_n145_), .b(new_n144_), .c(new_n147_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  oai21  g116(.a(new_n66_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n59_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n100_), .c(x08), .O(new_n152_));
  inv1   g119(.a(new_n132_), .O(new_n153_));
  nand2  g120(.a(new_n112_), .b(new_n111_), .O(new_n154_));
  nor2   g121(.a(new_n154_), .b(new_n110_), .O(new_n155_));
  nand2  g122(.a(new_n135_), .b(new_n113_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n153_), .c(new_n155_), .d(new_n145_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n152_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n149_), .O(z4));
  aoi21  g126(.a(new_n146_), .b(x00), .c(new_n107_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x02), .c(new_n144_), .O(z5));
  inv1   g128(.a(new_n145_), .O(new_n162_));
  nand2  g129(.a(x20), .b(new_n37_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n35_), .c(x11), .O(new_n164_));
  nand3  g131(.a(new_n146_), .b(new_n54_), .c(x00), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n166_));
  oai21  g133(.a(new_n164_), .b(x03), .c(new_n166_), .O(new_n167_));
  nand2  g134(.a(new_n38_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n36_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n34_), .c(new_n115_), .d(new_n110_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n162_), .O(z6));
  nand2  g138(.a(new_n156_), .b(x01), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n54_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n155_), .O(z7));
endmodule
