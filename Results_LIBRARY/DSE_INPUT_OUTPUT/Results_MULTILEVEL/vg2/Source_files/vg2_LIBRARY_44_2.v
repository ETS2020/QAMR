...
module FAU ( 
  ...
  nor3   g081(.a(new_n114_), .b(new_n59_), .c(new_n90_), .O(new_n115_));
  ...
  nand4  g123(.a(new_n148_), .b(new_n39_), .c(x21), .d(new_n44_), .O(new_n157_));
  ...
  nand2  g127(.a(new_n43_), .b(x01), .O(new_n161_));
  nand2  g128(.a(new_n47_), .b(new_n42_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n41_), .c(new_n161_), .O(new_n163_));
  nand4  g130(.a(new_n98_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n163_), .O(z5));
  nand2  g132(.a(x20), .b(new_n90_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n35_), .c(x11), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x03), .c(new_n140_), .O(new_n168_));
  nand2  g135(.a(new_n59_), .b(x14), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x06), .c(new_n36_), .O(new_n170_));
  nand4  g137(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n112_), .c(new_n111_), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(new_n110_), .c(new_n170_), .d(new_n34_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n168_), .c(new_n161_), .O(z6));
  nand3  g141(.a(new_n39_), .b(x21), .c(new_n44_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n107_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n43_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n114_), .O(z7));
endmodule
