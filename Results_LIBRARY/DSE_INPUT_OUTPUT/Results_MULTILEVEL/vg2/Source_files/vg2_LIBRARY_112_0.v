...
module FAU ( 
  ...
  and2   g020(.a(x04), .b(x03), .O(new_n54_));
  ...
  oai21  g033(.a(new_n66_), .b(new_n61_), .c(x01), .O(new_n67_));
  nand2  g034(.a(new_n67_), .b(new_n53_), .O(new_n68_));
  nand2  g035(.a(new_n54_), .b(x01), .O(new_n69_));
  ...
  nand4  g045(.a(new_n78_), .b(new_n77_), .c(new_n36_), .d(new_n57_), .O(new_n79_));
  ...
  inv1   g071(.a(x10), .O(new_n105_));
  nand4  g072(.a(x11), .b(new_n105_), .c(x06), .d(x03), .O(new_n106_));
  inv1   g073(.a(x21), .O(new_n107_));
  nor2   g074(.a(x24), .b(new_n107_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(x20), .c(x14), .O(new_n109_));
  oai21  g076(.a(new_n109_), .b(new_n106_), .c(x01), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n53_), .O(new_n111_));
  ...
  nand3  g083(.a(x15), .b(new_n46_), .c(new_n45_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(new_n116_), .c(new_n115_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(x20), .O(new_n119_));
  nor2   g086(.a(new_n119_), .b(new_n37_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(x11), .c(x06), .d(x03), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(new_n104_), .c(new_n111_), .O(z2));
  nand4  g089(.a(new_n105_), .b(x08), .c(x06), .d(x03), .O(new_n123_));
  nor2   g090(.a(new_n37_), .b(new_n36_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n108_), .c(x20), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n123_), .c(x01), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n53_), .O(new_n127_));
  nand3  g094(.a(new_n56_), .b(x03), .c(x01), .O(new_n128_));
  nand3  g095(.a(new_n124_), .b(x20), .c(x15), .O(new_n129_));
  nand3  g096(.a(new_n78_), .b(new_n34_), .c(new_n104_), .O(new_n130_));
  nand3  g097(.a(new_n83_), .b(new_n37_), .c(new_n36_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n128_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n89_), .O(new_n133_));
  nand3  g100(.a(new_n124_), .b(x20), .c(x18), .O(new_n134_));
  nand4  g101(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n104_), .O(new_n135_));
  nand4  g102(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n55_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n128_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n87_), .c(x24), .O(new_n138_));
  ...
  nand3  g109(.a(new_n142_), .b(new_n140_), .c(new_n55_), .O(new_n143_));
  oai21  g110(.a(new_n55_), .b(new_n104_), .c(new_n143_), .O(new_n144_));
  ...
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n57_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n140_), .c(x08), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(x18), .O(new_n152_));
  nand3  g119(.a(x08), .b(x07), .c(x02), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n87_), .c(x24), .O(new_n155_));
  nand2  g122(.a(new_n151_), .b(x15), .O(new_n156_));
  nand3  g123(.a(x19), .b(x08), .c(x02), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n89_), .O(new_n159_));
  nand4  g126(.a(new_n151_), .b(new_n40_), .c(x21), .d(new_n105_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(x01), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n53_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n159_), .c(new_n155_), .d(new_n148_), .O(z4));
  nor2   g130(.a(x02), .b(x01), .O(new_n164_));
  inv1   g131(.a(new_n164_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n48_), .O(new_n166_));
  nand4  g133(.a(new_n145_), .b(new_n53_), .c(x01), .d(x00), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n166_), .O(z5));
  nand2  g135(.a(x20), .b(new_n37_), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(new_n35_), .c(x11), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(x03), .c(new_n147_), .O(new_n171_));
  oai21  g138(.a(x20), .b(new_n37_), .c(x06), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(x11), .c(x03), .O(new_n173_));
  oai21  g140(.a(x03), .b(new_n104_), .c(new_n173_), .O(new_n174_));
  nand3  g141(.a(new_n108_), .b(new_n105_), .c(new_n53_), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n117_), .c(new_n116_), .d(new_n115_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n174_), .O(new_n177_));
  nand3  g144(.a(new_n118_), .b(new_n34_), .c(x02), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n177_), .c(new_n171_), .d(new_n165_), .O(z6));
  nand2  g146(.a(new_n165_), .b(new_n118_), .O(new_n180_));
  nand4  g147(.a(new_n108_), .b(new_n105_), .c(new_n53_), .d(x01), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n180_), .O(z7));
endmodule
