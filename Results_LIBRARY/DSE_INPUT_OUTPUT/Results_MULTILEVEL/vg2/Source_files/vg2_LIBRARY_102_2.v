...
module FAU ( 
  ...
  nand2  g108(.a(new_n44_), .b(x01), .O(new_n142_));
  nand2  g109(.a(new_n48_), .b(new_n43_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n42_), .c(new_n142_), .O(new_n144_));
  nand4  g111(.a(new_n56_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n145_));
  ...
  oai21  g118(.a(new_n110_), .b(new_n108_), .c(new_n142_), .O(new_n152_));
  nor2   g119(.a(x02), .b(x01), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n154_));
