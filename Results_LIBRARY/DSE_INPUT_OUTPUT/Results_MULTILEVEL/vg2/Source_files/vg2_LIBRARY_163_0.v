...
module FAU ( 
  ...
  oai21  g106(.a(new_n37_), .b(new_n55_), .c(new_n139_), .O(new_n140_));
  inv1   g107(.a(x00), .O(new_n141_));
  nor2   g108(.a(x02), .b(new_n141_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n40_), .c(new_n96_), .O(new_n143_));
  ...
  oai21  g113(.a(new_n136_), .b(x04), .c(x17), .O(new_n147_));
  ...
  aoi21  g124(.a(new_n147_), .b(x22), .c(new_n135_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n134_), .c(x08), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n40_), .c(x21), .d(new_n96_), .O(new_n160_));
  ...
  nand2  g130(.a(new_n37_), .b(new_n93_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n48_), .O(new_n165_));
  nand4  g132(.a(new_n142_), .b(new_n40_), .c(x14), .d(new_n96_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n165_), .O(z5));
  oai21  g134(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n144_), .O(new_n169_));
  oai22  g136(.a(x20), .b(new_n37_), .c(x06), .d(new_n34_), .O(new_n170_));
  aoi22  g137(.a(new_n170_), .b(x11), .c(new_n164_), .d(new_n34_), .O(new_n171_));
  nand4  g138(.a(x20), .b(new_n37_), .c(new_n36_), .d(x07), .O(new_n172_));
  oai21  g139(.a(new_n171_), .b(new_n146_), .c(new_n172_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n76_), .c(x24), .O(new_n174_));
  nand4  g141(.a(x20), .b(x19), .c(new_n37_), .d(new_n36_), .O(new_n175_));
  oai21  g142(.a(new_n171_), .b(new_n154_), .c(new_n175_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n78_), .O(new_n177_));
  nand2  g144(.a(x20), .b(x06), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(x11), .c(x03), .O(new_n179_));
  oai21  g146(.a(new_n37_), .b(x03), .c(new_n179_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n40_), .c(x21), .d(new_n96_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(x14), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n93_), .O(new_n183_));
  nand4  g150(.a(new_n183_), .b(new_n177_), .c(new_n174_), .d(new_n169_), .O(z6));
  nand2  g151(.a(new_n108_), .b(new_n107_), .O(new_n185_));
  oai21  g152(.a(new_n185_), .b(new_n106_), .c(new_n164_), .O(new_n186_));
  nand4  g153(.a(new_n109_), .b(x14), .c(new_n96_), .d(new_n93_), .O(new_n187_));
