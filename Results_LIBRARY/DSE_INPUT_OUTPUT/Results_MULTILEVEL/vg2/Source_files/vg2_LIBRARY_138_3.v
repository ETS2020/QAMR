...
module FAU ( 
  ...
  nand4  g026(.a(new_n59_), .b(new_n57_), .c(new_n44_), .d(x01), .O(new_n60_));
  ...
  oai21  g047(.a(new_n66_), .b(new_n60_), .c(new_n80_), .O(new_n81_));
  ...
  nand4  g055(.a(new_n88_), .b(new_n65_), .c(x20), .d(x18), .O(new_n89_));
  nor2   g056(.a(x09), .b(x08), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n67_), .c(x07), .d(new_n35_), .O(new_n91_));
  nand4  g058(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n36_), .O(new_n92_));
  inv1   g059(.a(new_n92_), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n77_), .c(new_n37_), .d(new_n75_), .O(new_n94_));
  oai22  g061(.a(new_n94_), .b(new_n91_), .c(new_n89_), .d(new_n60_), .O(new_n95_));
  nand3  g062(.a(new_n95_), .b(new_n83_), .c(x24), .O(new_n96_));
  inv1   g063(.a(x01), .O(new_n97_));
  nor3   g064(.a(new_n58_), .b(new_n56_), .c(new_n97_), .O(new_n98_));
  inv1   g065(.a(x21), .O(new_n99_));
  nor2   g066(.a(new_n99_), .b(new_n37_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n98_), .c(new_n88_), .d(new_n65_), .O(new_n101_));
  ...
  oai21  g071(.a(new_n104_), .b(new_n94_), .c(new_n101_), .O(new_n105_));
  ...
  nand3  g078(.a(x15), .b(new_n82_), .c(new_n38_), .O(new_n112_));
  ...
  aoi21  g085(.a(new_n118_), .b(new_n44_), .c(new_n97_), .O(z2));
  ...
  nand3  g099(.a(new_n121_), .b(new_n113_), .c(x20), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n132_), .c(new_n44_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(x01), .O(new_n135_));
  ...
  nand4  g108(.a(new_n141_), .b(new_n135_), .c(new_n131_), .d(new_n126_), .O(z3));
  inv1   g109(.a(x07), .O(new_n143_));
  nand2  g110(.a(new_n54_), .b(x08), .O(new_n144_));
  aoi21  g111(.a(new_n64_), .b(x04), .c(x17), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x22), .c(new_n69_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n74_), .c(new_n68_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n144_), .c(new_n143_), .O(new_n148_));
  ...
  aoi21  g120(.a(new_n153_), .b(x08), .c(new_n149_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n148_), .c(new_n83_), .O(new_n155_));
  nand4  g122(.a(new_n48_), .b(x08), .c(new_n38_), .d(new_n97_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(x24), .O(new_n158_));
  nand2  g125(.a(new_n85_), .b(x15), .O(new_n159_));
  nand3  g126(.a(new_n113_), .b(new_n45_), .c(new_n44_), .O(new_n160_));
  aoi22  g127(.a(new_n160_), .b(new_n159_), .c(new_n153_), .d(x08), .O(new_n161_));
  nand2  g128(.a(x24), .b(x08), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n82_), .c(new_n38_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n84_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(x19), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n46_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n146_), .c(new_n74_), .O(new_n167_));
  nand3  g134(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n49_), .c(x02), .O(new_n169_));
  nand2  g136(.a(x13), .b(x05), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n83_), .O(new_n171_));
  ...
  nand3  g141(.a(new_n174_), .b(new_n167_), .c(new_n54_), .O(new_n175_));
  nor2   g142(.a(new_n175_), .b(new_n161_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n158_), .O(z4));
  nand2  g144(.a(new_n49_), .b(new_n43_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n42_), .c(new_n54_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n46_), .O(z5));
  ...
  oai21  g151(.a(new_n184_), .b(new_n36_), .c(x03), .O(new_n185_));
  nand2  g152(.a(new_n112_), .b(new_n111_), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(new_n110_), .c(new_n54_), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(new_n160_), .O(z7));
  nand2  g155(.a(z7), .b(new_n185_), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n183_), .O(z6));
endmodule
