...
module FAU ( 
  ...
  oai21  g115(.a(new_n63_), .b(x14), .c(new_n34_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n35_), .c(x03), .O(new_n150_));
  oai21  g117(.a(x20), .b(new_n36_), .c(x06), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x11), .c(new_n57_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n147_), .c(new_n150_), .d(new_n52_), .O(z6));
  inv1   g120(.a(new_n147_), .O(z7));
endmodule
