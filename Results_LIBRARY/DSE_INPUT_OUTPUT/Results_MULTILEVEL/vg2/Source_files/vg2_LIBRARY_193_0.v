...
module FAU ( 
  ...
  aoi21  g060(.a(new_n93_), .b(new_n92_), .c(new_n46_), .O(new_n94_));
  ...
  oai21  g067(.a(new_n100_), .b(new_n91_), .c(new_n39_), .O(z2));
  nand4  g068(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n102_));
  nand4  g069(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n103_));
  nand3  g070(.a(new_n65_), .b(new_n34_), .c(new_n91_), .O(new_n104_));
  nand3  g071(.a(new_n70_), .b(new_n37_), .c(new_n36_), .O(new_n105_));
  oai22  g072(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n102_), .O(new_n106_));
  nand2  g073(.a(new_n106_), .b(new_n76_), .O(new_n107_));
  nand4  g074(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n108_));
  nand4  g075(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n91_), .O(new_n109_));
  ...
  nand3  g079(.a(new_n112_), .b(new_n74_), .c(x24), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n107_), .c(new_n39_), .O(z3));
  inv1   g081(.a(new_n39_), .O(new_n115_));
  ...
  nand2  g088(.a(new_n121_), .b(new_n50_), .O(new_n122_));
  inv1   g089(.a(new_n94_), .O(new_n123_));
  nand3  g090(.a(new_n96_), .b(new_n95_), .c(new_n123_), .O(new_n124_));
  ...
  aoi21  g097(.a(new_n130_), .b(new_n122_), .c(new_n115_), .O(z4));
  ...
  nand4  g106(.a(new_n96_), .b(new_n95_), .c(new_n123_), .d(new_n39_), .O(z7));
endmodule
