...
module FAU ( 
  ...
  nand3  g121(.a(new_n112_), .b(new_n111_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g123(.a(new_n132_), .b(new_n135_), .c(new_n113_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n156_), .O(z7));
  nand2  g125(.a(z7), .b(new_n152_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n149_), .O(z4));
  aoi21  g127(.a(new_n146_), .b(x00), .c(new_n107_), .O(new_n161_));
  ...
  oai21  g134(.a(x20), .b(new_n37_), .c(x06), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(x11), .c(x03), .O(new_n169_));
  oai21  g136(.a(x03), .b(new_n107_), .c(new_n169_), .O(new_n170_));
  oai21  g137(.a(new_n115_), .b(new_n110_), .c(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n155_), .b(new_n34_), .c(x02), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n171_), .c(new_n167_), .d(new_n153_), .O(z6));
endmodule
