...
module FAU ( 
  ...
  nand2  g014(.a(x24), .b(x10), .O(new_n48_));
  ...
  nand3  g018(.a(new_n42_), .b(new_n51_), .c(x00), .O(new_n52_));
  nand2  g019(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  nand2  g020(.a(new_n53_), .b(new_n40_), .O(new_n54_));
  nand3  g021(.a(new_n54_), .b(new_n49_), .c(new_n45_), .O(z5));
  ...
  nand3  g028(.a(x21), .b(new_n40_), .c(new_n51_), .O(new_n62_));
  ...
  nand3  g044(.a(new_n40_), .b(new_n51_), .c(x00), .O(new_n78_));
  ...
  nand3  g062(.a(new_n71_), .b(new_n35_), .c(new_n34_), .O(new_n96_));
  nand4  g063(.a(new_n73_), .b(new_n72_), .c(x07), .d(new_n36_), .O(new_n97_));
  nor2   g064(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand4  g065(.a(new_n74_), .b(new_n38_), .c(new_n60_), .d(new_n37_), .O(new_n99_));
  nor2   g066(.a(x23), .b(x22), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(new_n39_), .c(new_n75_), .O(new_n101_));
  nor2   g068(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  aoi22  g069(.a(new_n102_), .b(new_n98_), .c(new_n95_), .d(new_n92_), .O(new_n103_));
  oai21  g070(.a(new_n103_), .b(new_n90_), .c(new_n40_), .O(new_n104_));
  ...
  inv1   g075(.a(new_n96_), .O(new_n109_));
  nor2   g076(.a(x08), .b(x06), .O(new_n110_));
  nand4  g077(.a(new_n110_), .b(new_n109_), .c(new_n37_), .d(new_n73_), .O(new_n111_));
  ...
  nand4  g082(.a(new_n115_), .b(new_n113_), .c(new_n112_), .d(new_n100_), .O(new_n116_));
  oai21  g083(.a(new_n116_), .b(new_n111_), .c(new_n108_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(new_n47_), .c(new_n46_), .O(new_n118_));
  inv1   g085(.a(new_n118_), .O(new_n119_));
  aoi21  g086(.a(new_n104_), .b(x24), .c(new_n119_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n89_), .O(z1));
  inv1   g088(.a(x18), .O(new_n122_));
  nor3   g089(.a(new_n42_), .b(new_n122_), .c(x10), .O(new_n123_));
  nand3  g090(.a(new_n42_), .b(x15), .c(x13), .O(new_n124_));
  inv1   g091(.a(new_n124_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n123_), .c(x05), .O(new_n126_));
  nand4  g093(.a(new_n48_), .b(x15), .c(new_n47_), .d(new_n46_), .O(new_n127_));
  nor2   g094(.a(new_n42_), .b(new_n122_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(x13), .O(new_n129_));
  inv1   g096(.a(x21), .O(new_n130_));
  nor2   g097(.a(x24), .b(new_n130_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n51_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n40_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n127_), .c(new_n126_), .O(new_n135_));
  ...
  nand4  g106(.a(new_n63_), .b(x20), .c(x14), .d(x11), .O(new_n140_));
  nor2   g107(.a(new_n140_), .b(new_n72_), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(x06), .c(x03), .d(x01), .O(new_n142_));
  nand4  g109(.a(new_n80_), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n143_));
  ...
  nand2  g113(.a(new_n146_), .b(new_n42_), .O(new_n147_));
  ...
  nand4  g117(.a(x07), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n151_));
  ...
  nand3  g124(.a(new_n110_), .b(new_n35_), .c(new_n34_), .O(new_n158_));
  nand3  g125(.a(new_n115_), .b(new_n38_), .c(new_n37_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n158_), .c(new_n157_), .d(new_n149_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n47_), .c(new_n46_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n156_), .c(new_n147_), .O(z3));
  oai21  g129(.a(x23), .b(new_n71_), .c(new_n75_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n76_), .c(x09), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x16), .c(new_n72_), .O(new_n165_));
  ...
  oai21  g136(.a(new_n125_), .b(new_n128_), .c(x05), .O(new_n170_));
  nor2   g137(.a(x10), .b(x02), .O(new_n171_));
  inv1   g138(.a(x15), .O(new_n172_));
  nor2   g139(.a(new_n172_), .b(x13), .O(new_n173_));
  aoi22  g140(.a(new_n173_), .b(new_n46_), .c(new_n131_), .d(new_n171_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n170_), .c(new_n129_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n169_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n166_), .c(new_n48_), .O(z4));
  aoi21  g144(.a(x20), .b(new_n38_), .c(x06), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(x11), .c(new_n35_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(z5), .O(new_n180_));
  aoi21  g147(.a(new_n39_), .b(x14), .c(new_n36_), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(new_n37_), .c(x03), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n135_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n180_), .O(z6));
  oai21  g151(.a(new_n122_), .b(new_n47_), .c(new_n40_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(x24), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(new_n174_), .c(new_n170_), .O(z7));
endmodule
