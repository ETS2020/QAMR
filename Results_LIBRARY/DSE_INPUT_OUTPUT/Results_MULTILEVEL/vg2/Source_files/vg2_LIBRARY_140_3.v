...
module FAU ( 
  ...
  and2   g134(.a(new_n153_), .b(new_n43_), .O(new_n168_));
  ...
  oai21  g139(.a(x20), .b(new_n91_), .c(x06), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(x11), .c(x03), .O(new_n174_));
  nand2  g141(.a(new_n153_), .b(new_n34_), .O(new_n175_));
  ...
  nand2  g145(.a(new_n134_), .b(new_n178_), .O(new_n179_));
  ...
  inv1   g154(.a(new_n153_), .O(new_n188_));
