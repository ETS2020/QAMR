...
module FAU ( 
  ...
  nor2   g079(.a(new_n112_), .b(new_n62_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(x11), .c(x06), .d(x03), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(x02), .c(new_n54_), .O(z2));
  ...
  oai21  g090(.a(new_n123_), .b(new_n119_), .c(new_n91_), .O(new_n124_));
  inv1   g091(.a(new_n117_), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n94_), .c(x14), .O(new_n126_));
  nor2   g093(.a(x11), .b(x08), .O(new_n127_));
  nor2   g094(.a(x20), .b(x14), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n127_), .c(new_n120_), .d(new_n100_), .O(new_n129_));
  ...
  nand4  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n56_), .O(new_n135_));
  ...
  oai21  g108(.a(new_n141_), .b(x16), .c(new_n98_), .O(new_n142_));
  nor2   g109(.a(x02), .b(new_n54_), .O(new_n143_));
  nand2  g110(.a(new_n48_), .b(new_n43_), .O(new_n144_));
  nor2   g111(.a(new_n144_), .b(new_n42_), .O(new_n145_));
  nand3  g112(.a(new_n56_), .b(new_n45_), .c(new_n44_), .O(new_n146_));
  oai21  g113(.a(new_n145_), .b(new_n143_), .c(new_n146_), .O(new_n147_));
  ...
  nor2   g119(.a(new_n111_), .b(new_n108_), .O(new_n153_));
  inv1   g120(.a(x10), .O(new_n154_));
  nand3  g121(.a(new_n40_), .b(x21), .c(new_n154_), .O(new_n155_));
  inv1   g122(.a(new_n155_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n44_), .c(new_n54_), .O(new_n157_));
  oai21  g124(.a(new_n143_), .b(new_n153_), .c(new_n157_), .O(new_n158_));
  ...
  oai21  g128(.a(new_n161_), .b(x02), .c(new_n145_), .O(z5));
  inv1   g129(.a(new_n143_), .O(new_n163_));
  nand2  g130(.a(x20), .b(new_n62_), .O(new_n164_));
  ...
  nand4  g135(.a(new_n40_), .b(x21), .c(new_n154_), .d(new_n44_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n110_), .c(new_n109_), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n108_), .c(new_n168_), .d(new_n34_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n166_), .c(new_n163_), .O(z6));
  oai21  g139(.a(new_n156_), .b(x01), .c(new_n44_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n153_), .O(z7));
endmodule
