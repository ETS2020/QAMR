...
module FAU ( 
  ...
  and2   g106(.a(new_n139_), .b(new_n50_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n45_), .c(new_n44_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  inv1   g109(.a(new_n109_), .O(new_n143_));
  inv1   g110(.a(new_n113_), .O(new_n144_));
  ...
  nand2  g118(.a(x02), .b(new_n70_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n151_), .c(new_n142_), .O(z4));
  nand4  g120(.a(new_n152_), .b(new_n140_), .c(new_n45_), .d(new_n44_), .O(z5));
  ...
  aoi21  g125(.a(new_n158_), .b(x06), .c(new_n37_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n35_), .c(new_n145_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n157_), .c(new_n152_), .O(z6));
  and2   g128(.a(new_n152_), .b(new_n110_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n112_), .c(new_n111_), .d(new_n143_), .O(z7));
endmodule
