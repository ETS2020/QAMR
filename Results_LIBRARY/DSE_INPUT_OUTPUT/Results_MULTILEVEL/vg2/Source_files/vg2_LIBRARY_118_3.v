...
module FAU ( 
  ...
  nand3  g066(.a(new_n59_), .b(new_n57_), .c(x01), .O(new_n100_));
  inv1   g067(.a(x21), .O(new_n101_));
  nor2   g068(.a(new_n101_), .b(new_n37_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n87_), .c(new_n65_), .O(new_n103_));
  ...
  nor2   g089(.a(new_n122_), .b(new_n54_), .O(z2));
  nand3  g090(.a(new_n55_), .b(x06), .c(x03), .O(new_n124_));
  ...
  nand4  g095(.a(new_n128_), .b(new_n104_), .c(new_n78_), .d(new_n69_), .O(new_n129_));
  oai21  g096(.a(new_n127_), .b(new_n124_), .c(new_n129_), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n84_), .O(new_n131_));
  nand3  g098(.a(new_n126_), .b(new_n89_), .c(x14), .O(new_n132_));
  nand2  g099(.a(new_n104_), .b(new_n92_), .O(new_n133_));
  nand4  g100(.a(new_n37_), .b(new_n73_), .c(new_n36_), .d(new_n125_), .O(new_n134_));
  ...
  oai21  g110(.a(x23), .b(new_n143_), .c(new_n75_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n63_), .c(x09), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x16), .c(new_n125_), .O(new_n146_));
  nor2   g113(.a(new_n73_), .b(new_n44_), .O(new_n147_));
  nand2  g114(.a(new_n48_), .b(new_n43_), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(new_n42_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n147_), .c(new_n46_), .O(z5));
  nand2  g117(.a(z5), .b(new_n146_), .O(new_n151_));
  inv1   g118(.a(x09), .O(new_n152_));
  oai21  g119(.a(new_n64_), .b(x04), .c(x17), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x22), .c(new_n152_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n74_), .c(x08), .O(new_n155_));
  nand3  g122(.a(new_n115_), .b(new_n114_), .c(new_n113_), .O(new_n156_));
  oai21  g123(.a(new_n73_), .b(new_n44_), .c(new_n156_), .O(new_n157_));
  nand4  g124(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n157_), .O(z7));
  nand2  g126(.a(z7), .b(new_n155_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n151_), .O(z4));
  inv1   g128(.a(x00), .O(new_n162_));
  nor2   g129(.a(x10), .b(new_n162_), .O(new_n163_));
  nand3  g130(.a(x19), .b(x13), .c(x05), .O(new_n164_));
  inv1   g131(.a(new_n164_), .O(new_n165_));
  oai21  g132(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n166_));
  oai21  g133(.a(new_n165_), .b(new_n163_), .c(new_n166_), .O(new_n167_));
  nand3  g134(.a(x15), .b(x13), .c(x05), .O(new_n168_));
  oai21  g135(.a(new_n101_), .b(x10), .c(new_n168_), .O(new_n169_));
  ...
  nand4  g139(.a(new_n163_), .b(x20), .c(new_n73_), .d(new_n36_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n172_), .c(new_n167_), .O(new_n174_));
  nand2  g141(.a(new_n82_), .b(x24), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n91_), .c(new_n48_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n166_), .O(new_n177_));
  oai21  g144(.a(new_n175_), .b(new_n88_), .c(new_n115_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n171_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n177_), .O(new_n180_));
  aoi21  g147(.a(new_n174_), .b(new_n40_), .c(new_n180_), .O(new_n181_));
  nor2   g148(.a(x20), .b(x06), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(x11), .c(new_n34_), .O(new_n183_));
  oai21  g150(.a(new_n148_), .b(new_n42_), .c(new_n183_), .O(new_n184_));
  oai21  g151(.a(new_n36_), .b(x06), .c(x03), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n156_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n184_), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(new_n73_), .O(new_n188_));
  oai21  g155(.a(new_n181_), .b(x02), .c(new_n188_), .O(z6));
endmodule
