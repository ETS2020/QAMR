// Benchmark "FAU" written by ABC on Fri Aug 14 02:36:00 2020
...
module FAU ( 
  ...
  nand4  g064(.a(new_n72_), .b(new_n56_), .c(new_n36_), .d(new_n55_), .O(new_n98_));
  oai22  g065(.a(new_n98_), .b(new_n97_), .c(new_n96_), .d(new_n94_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n93_), .c(x24), .O(new_n100_));
  nand3  g067(.a(new_n95_), .b(x20), .c(x15), .O(new_n101_));
  nand4  g068(.a(new_n55_), .b(new_n35_), .c(new_n34_), .d(new_n54_), .O(new_n102_));
  nand4  g069(.a(new_n72_), .b(x19), .c(new_n56_), .d(new_n36_), .O(new_n103_));
  oai22  g070(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n94_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n47_), .c(new_n38_), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n100_), .c(new_n92_), .d(new_n77_), .O(z3));
  ...
  nor2   g079(.a(new_n112_), .b(new_n55_), .O(new_n113_));
  inv1   g080(.a(new_n50_), .O(new_n114_));
  aoi21  g081(.a(new_n109_), .b(x04), .c(x17), .O(new_n115_));
  oai21  g082(.a(new_n115_), .b(x22), .c(new_n108_), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(new_n107_), .c(new_n55_), .O(new_n117_));
  oai21  g084(.a(new_n76_), .b(new_n55_), .c(new_n117_), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(new_n114_), .c(new_n76_), .O(new_n119_));
  oai21  g086(.a(new_n113_), .b(new_n73_), .c(new_n119_), .O(z4));
  nor2   g087(.a(new_n76_), .b(new_n50_), .O(z5));
  aoi21  g088(.a(new_n36_), .b(x06), .c(x03), .O(new_n122_));
  aoi21  g089(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n123_));
  oai22  g090(.a(new_n123_), .b(new_n73_), .c(new_n122_), .d(new_n50_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n77_), .O(new_n125_));
  inv1   g092(.a(new_n95_), .O(new_n126_));
  nand4  g093(.a(x20), .b(new_n56_), .c(new_n36_), .d(x00), .O(new_n127_));
  nand3  g094(.a(x22), .b(x21), .c(new_n72_), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(new_n126_), .c(new_n127_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n45_), .c(new_n44_), .O(new_n130_));
  nand4  g097(.a(x20), .b(x19), .c(new_n56_), .d(new_n36_), .O(new_n131_));
  nand3  g098(.a(x22), .b(new_n72_), .c(x15), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n126_), .c(new_n131_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(x13), .c(x05), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n40_), .O(new_n136_));
  nand4  g103(.a(x20), .b(new_n56_), .c(new_n36_), .d(x07), .O(new_n137_));
  nand3  g104(.a(x22), .b(new_n72_), .c(x18), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(new_n126_), .c(new_n137_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n93_), .c(x24), .O(new_n140_));
  nand3  g107(.a(new_n133_), .b(new_n47_), .c(new_n38_), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n140_), .c(new_n136_), .d(new_n125_), .O(z6));
  inv1   g109(.a(new_n59_), .O(new_n143_));
  and2   g110(.a(new_n61_), .b(new_n60_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n77_), .c(new_n62_), .d(new_n143_), .O(z7));
endmodule
