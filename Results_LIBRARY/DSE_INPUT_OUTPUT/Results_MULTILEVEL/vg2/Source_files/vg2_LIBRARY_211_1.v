...
module FAU ( 
  ...
  oai21  g085(.a(new_n116_), .b(new_n69_), .c(new_n118_), .O(z2));
  ...
  nand2  g089(.a(new_n101_), .b(new_n73_), .O(new_n123_));
  nand3  g090(.a(new_n78_), .b(new_n38_), .c(new_n37_), .O(new_n124_));
  ...
  nand3  g099(.a(new_n73_), .b(new_n35_), .c(x00), .O(new_n133_));
  nor2   g100(.a(x11), .b(x10), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n41_), .c(new_n39_), .d(new_n38_), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(new_n133_), .c(new_n34_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n69_), .O(new_n137_));
  nor4   g104(.a(new_n60_), .b(new_n35_), .c(x02), .d(new_n69_), .O(new_n138_));
  nand2  g105(.a(new_n41_), .b(x21), .O(new_n139_));
  nand2  g106(.a(new_n121_), .b(new_n46_), .O(new_n140_));
  nor3   g107(.a(new_n140_), .b(new_n139_), .c(new_n39_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n137_), .c(new_n132_), .d(new_n126_), .O(z3));
  inv1   g110(.a(x17), .O(new_n144_));
  oai21  g111(.a(x23), .b(new_n70_), .c(new_n144_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n63_), .c(x09), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x16), .c(new_n129_), .O(new_n147_));
  ...
  aoi21  g121(.a(new_n154_), .b(x22), .c(new_n58_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n153_), .c(x08), .O(new_n156_));
  nand2  g123(.a(new_n111_), .b(new_n110_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n109_), .c(new_n118_), .O(new_n158_));
  ...
  nand4  g129(.a(new_n162_), .b(new_n118_), .c(new_n45_), .d(new_n44_), .O(z5));
  ...
  oai21  g134(.a(x20), .b(new_n38_), .c(x06), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(x11), .c(x03), .O(new_n169_));
  oai21  g136(.a(new_n117_), .b(x03), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n82_), .c(x18), .O(new_n171_));
  inv1   g138(.a(new_n111_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n35_), .c(x01), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n171_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(x24), .O(new_n175_));
  nand2  g142(.a(x24), .b(new_n35_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n49_), .c(new_n48_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n83_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(x15), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n112_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n168_), .c(x11), .O(new_n181_));
  oai21  g148(.a(new_n139_), .b(x10), .c(new_n111_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n34_), .O(new_n183_));
  nand2  g150(.a(x13), .b(x05), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n82_), .O(new_n185_));
  nand3  g152(.a(new_n185_), .b(new_n41_), .c(x15), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n183_), .O(new_n187_));
  aoi21  g154(.a(new_n187_), .b(new_n35_), .c(new_n117_), .O(new_n188_));
  nand4  g155(.a(new_n188_), .b(new_n181_), .c(new_n175_), .d(new_n167_), .O(z6));
endmodule
