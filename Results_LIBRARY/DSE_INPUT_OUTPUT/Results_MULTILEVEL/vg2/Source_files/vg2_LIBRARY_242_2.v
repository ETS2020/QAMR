...
module FAU ( 
  ...
  nor2   g121(.a(x24), .b(new_n154_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n38_), .c(new_n34_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n115_), .c(new_n114_), .d(new_n113_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n153_), .O(new_n158_));
  nor2   g125(.a(x02), .b(new_n35_), .O(new_n159_));
  inv1   g126(.a(new_n159_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n158_), .c(new_n150_), .O(z4));
  nor2   g128(.a(new_n54_), .b(new_n50_), .O(new_n162_));
  nand3  g129(.a(new_n43_), .b(new_n38_), .c(x00), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n35_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n34_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n162_), .O(z5));
  nand2  g133(.a(x20), .b(new_n41_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n37_), .c(x11), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(x03), .c(new_n149_), .O(new_n169_));
  oai21  g136(.a(x20), .b(new_n41_), .c(x06), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(x11), .c(x03), .O(new_n171_));
  inv1   g138(.a(new_n171_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n126_), .c(new_n157_), .O(new_n173_));
  nand3  g140(.a(new_n117_), .b(new_n36_), .c(x02), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n173_), .c(new_n169_), .d(new_n160_), .O(z6));
  nand2  g142(.a(new_n160_), .b(new_n117_), .O(new_n176_));
  nand4  g143(.a(new_n155_), .b(new_n38_), .c(new_n34_), .d(new_n35_), .O(new_n177_));
