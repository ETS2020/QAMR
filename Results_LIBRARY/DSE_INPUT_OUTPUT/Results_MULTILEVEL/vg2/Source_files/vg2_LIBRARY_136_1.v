...
module FAU ( 
  ...
  nor2   g083(.a(new_n116_), .b(new_n69_), .O(z2));
  ...
  nand2  g087(.a(new_n101_), .b(new_n73_), .O(new_n121_));
  nand3  g088(.a(new_n78_), .b(new_n38_), .c(new_n37_), .O(new_n122_));
  oai22  g089(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n118_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n84_), .O(new_n124_));
  nand2  g091(.a(new_n119_), .b(new_n88_), .O(new_n125_));
  nand3  g092(.a(new_n101_), .b(x07), .c(new_n36_), .O(new_n126_));
  inv1   g093(.a(x08), .O(new_n127_));
  nand4  g094(.a(new_n39_), .b(new_n38_), .c(new_n37_), .d(new_n127_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n126_), .c(new_n125_), .d(new_n118_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n82_), .c(x24), .O(new_n130_));
  nand3  g097(.a(new_n73_), .b(new_n35_), .c(x00), .O(new_n131_));
  ...
  nor4   g102(.a(new_n60_), .b(new_n35_), .c(x02), .d(new_n69_), .O(new_n136_));
  nand3  g103(.a(new_n41_), .b(x21), .c(x20), .O(new_n137_));
  inv1   g104(.a(new_n137_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n136_), .c(new_n119_), .d(new_n46_), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n135_), .c(new_n130_), .d(new_n124_), .O(z3));
  inv1   g107(.a(x17), .O(new_n141_));
  oai21  g108(.a(x23), .b(new_n70_), .c(new_n141_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n63_), .c(x09), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n127_), .O(new_n144_));
  nand4  g111(.a(new_n41_), .b(new_n46_), .c(new_n34_), .d(x00), .O(new_n145_));
  and2   g112(.a(new_n145_), .b(new_n50_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n45_), .c(new_n44_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  inv1   g115(.a(x16), .O(new_n149_));
  oai21  g116(.a(new_n64_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n58_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n149_), .c(x08), .O(new_n152_));
  oai21  g119(.a(new_n113_), .b(new_n109_), .c(new_n152_), .O(new_n153_));
  nand2  g120(.a(x02), .b(new_n69_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z4));
  nand4  g122(.a(new_n154_), .b(new_n146_), .c(new_n45_), .d(new_n44_), .O(z5));
  aoi21  g123(.a(x20), .b(new_n38_), .c(x06), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x11), .c(new_n35_), .O(new_n158_));
  nand3  g125(.a(new_n50_), .b(new_n45_), .c(new_n44_), .O(new_n159_));
  ...
  aoi21  g129(.a(new_n39_), .b(x14), .c(new_n36_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n37_), .c(x03), .O(new_n164_));
  nand2  g131(.a(new_n111_), .b(new_n110_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n109_), .c(new_n154_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n112_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n162_), .O(z6));
  nand4  g136(.a(new_n154_), .b(new_n112_), .c(new_n111_), .d(new_n110_), .O(new_n170_));
  or2    g137(.a(new_n170_), .b(new_n109_), .O(z7));
endmodule
