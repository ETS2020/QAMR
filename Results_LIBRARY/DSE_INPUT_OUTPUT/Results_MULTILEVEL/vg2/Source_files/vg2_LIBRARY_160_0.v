...
module FAU ( 
  ...
  nand2  g068(.a(new_n51_), .b(x22), .O(new_n102_));
  nor3   g069(.a(new_n102_), .b(new_n101_), .c(new_n85_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n100_), .c(new_n98_), .d(new_n59_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n96_), .c(new_n84_), .O(z1));
  ...
  nand4  g079(.a(new_n51_), .b(x21), .c(new_n50_), .d(new_n37_), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(new_n112_), .c(new_n106_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x14), .c(x11), .d(x06), .O(new_n115_));
  nor3   g082(.a(new_n115_), .b(new_n68_), .c(new_n67_), .O(z2));
  nand3  g083(.a(new_n59_), .b(x03), .c(x01), .O(new_n117_));
  nor2   g084(.a(new_n36_), .b(new_n35_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(x20), .c(x15), .O(new_n119_));
  nand3  g086(.a(new_n72_), .b(new_n68_), .c(new_n67_), .O(new_n120_));
  ...
  nand4  g091(.a(x07), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n125_));
  nand4  g092(.a(new_n106_), .b(new_n36_), .c(new_n35_), .d(new_n58_), .O(new_n126_));
  ...
  nand3  g096(.a(new_n118_), .b(x21), .c(x20), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n117_), .c(new_n129_), .d(new_n126_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n42_), .c(new_n50_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(x23), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n37_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n128_), .c(new_n123_), .O(z3));
  inv1   g102(.a(x16), .O(new_n136_));
  inv1   g103(.a(x17), .O(new_n137_));
  oai21  g104(.a(x22), .b(new_n137_), .c(new_n66_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n136_), .c(new_n58_), .O(new_n139_));
  oai21  g106(.a(new_n38_), .b(new_n58_), .c(new_n139_), .O(new_n140_));
  nand4  g107(.a(new_n42_), .b(new_n50_), .c(new_n37_), .d(x00), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n47_), .c(new_n45_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n44_), .c(new_n140_), .O(new_n143_));
  nand2  g110(.a(new_n58_), .b(x04), .O(new_n144_));
  nand2  g111(.a(new_n78_), .b(new_n136_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n144_), .c(new_n58_), .d(new_n37_), .O(new_n146_));
  oai21  g113(.a(new_n48_), .b(new_n44_), .c(new_n146_), .O(new_n147_));
  oai21  g114(.a(new_n38_), .b(x04), .c(x17), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x22), .c(new_n66_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n136_), .c(x08), .O(new_n150_));
  oai21  g117(.a(new_n111_), .b(new_n109_), .c(new_n150_), .O(new_n151_));
  nand2  g118(.a(x17), .b(x04), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n66_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n136_), .c(x08), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n42_), .c(x21), .d(new_n50_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(x23), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n37_), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n151_), .c(new_n147_), .d(new_n143_), .O(z4));
  nand2  g125(.a(new_n52_), .b(new_n49_), .O(z5));
  aoi21  g126(.a(x20), .b(new_n36_), .c(x06), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x11), .c(new_n68_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(z5), .O(new_n162_));
  nand2  g129(.a(new_n113_), .b(new_n112_), .O(z7));
  aoi21  g130(.a(new_n106_), .b(x14), .c(new_n34_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n35_), .c(x03), .O(new_n165_));
