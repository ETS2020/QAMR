...
module FAU ( 
  ...
  nand2  g033(.a(x20), .b(x04), .O(new_n67_));
  ...
  aoi21  g046(.a(new_n79_), .b(new_n53_), .c(new_n58_), .O(z2));
  ...
  nand4  g066(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n88_), .O(new_n100_));
  ...
  nand4  g071(.a(new_n81_), .b(new_n35_), .c(new_n34_), .d(new_n88_), .O(new_n105_));
  ...
  nand4  g075(.a(new_n108_), .b(new_n103_), .c(new_n96_), .d(new_n67_), .O(z3));
  inv1   g076(.a(new_n49_), .O(new_n110_));
  inv1   g077(.a(x22), .O(new_n111_));
  oai21  g078(.a(x23), .b(new_n53_), .c(new_n57_), .O(new_n112_));
  aoi21  g079(.a(new_n112_), .b(new_n111_), .c(x09), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(x16), .c(new_n81_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n110_), .O(new_n115_));
  inv1   g082(.a(new_n77_), .O(new_n116_));
  oai21  g083(.a(new_n59_), .b(x04), .c(x17), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(x22), .c(new_n54_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n56_), .c(x08), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(new_n115_), .c(new_n67_), .O(z4));
  inv1   g088(.a(new_n41_), .O(new_n122_));
  and2   g089(.a(new_n45_), .b(new_n42_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n67_), .c(new_n47_), .d(new_n122_), .O(z5));
  nand2  g091(.a(x20), .b(new_n69_), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(new_n35_), .c(x11), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(x03), .c(new_n110_), .O(new_n127_));
  nand2  g094(.a(new_n58_), .b(x14), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(x06), .c(new_n36_), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n34_), .c(new_n116_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n127_), .c(new_n67_), .O(z6));
  inv1   g098(.a(new_n72_), .O(new_n132_));
  and2   g099(.a(new_n74_), .b(new_n73_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n75_), .c(new_n132_), .d(new_n67_), .O(z7));
endmodule
