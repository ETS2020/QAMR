...
module FAU ( 
  ...
  nand4  g107(.a(new_n140_), .b(new_n139_), .c(new_n134_), .d(new_n129_), .O(z3));
  inv1   g108(.a(x04), .O(new_n142_));
  oai21  g109(.a(x23), .b(new_n142_), .c(new_n75_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n63_), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n123_), .O(new_n145_));
  nand2  g112(.a(new_n48_), .b(new_n43_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n42_), .c(new_n140_), .O(new_n147_));
  ...
  nand2  g121(.a(new_n154_), .b(new_n140_), .O(new_n155_));
  ...
  and2   g127(.a(new_n140_), .b(new_n48_), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n46_), .c(new_n43_), .d(new_n160_), .O(z5));
  nand2  g129(.a(x20), .b(new_n73_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n35_), .c(x11), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n165_));
  nand2  g132(.a(x13), .b(x05), .O(new_n166_));
  nand3  g133(.a(new_n37_), .b(x14), .c(new_n44_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x06), .c(new_n36_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n34_), .c(x15), .O(new_n169_));
  nand4  g136(.a(x20), .b(x19), .c(new_n36_), .d(x02), .O(new_n170_));
  aoi22  g137(.a(new_n170_), .b(new_n169_), .c(new_n166_), .d(new_n82_), .O(new_n171_));
  nand2  g138(.a(new_n37_), .b(x14), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(x06), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(x11), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(x03), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n176_));
  inv1   g143(.a(new_n176_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n171_), .c(new_n40_), .O(new_n178_));
  nand3  g145(.a(new_n173_), .b(x11), .c(x03), .O(new_n179_));
  nand2  g146(.a(new_n140_), .b(new_n34_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n82_), .c(x18), .O(new_n182_));
  nand2  g149(.a(x11), .b(x03), .O(new_n183_));
  oai22  g150(.a(new_n183_), .b(new_n172_), .c(x14), .d(x03), .O(new_n184_));
  nand4  g151(.a(new_n184_), .b(x15), .c(new_n47_), .d(new_n38_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n182_), .O(new_n186_));
  nand3  g153(.a(x11), .b(new_n35_), .c(x03), .O(new_n187_));
  oai21  g154(.a(x03), .b(x02), .c(new_n187_), .O(new_n188_));
  nand4  g155(.a(new_n188_), .b(x15), .c(new_n47_), .d(new_n38_), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n140_), .O(new_n190_));
  aoi21  g157(.a(new_n186_), .b(x24), .c(new_n190_), .O(new_n191_));
  nand3  g158(.a(new_n191_), .b(new_n178_), .c(new_n165_), .O(z6));
endmodule
