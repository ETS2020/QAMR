...
module FAU ( 
  ...
  inv1   g111(.a(new_n103_), .O(new_n145_));
  nand3  g112(.a(new_n126_), .b(new_n45_), .c(new_n44_), .O(new_n146_));
  and2   g113(.a(new_n146_), .b(new_n105_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n104_), .c(new_n145_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n144_), .O(new_n149_));
  nand2  g116(.a(x02), .b(x01), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n149_), .c(new_n140_), .O(z4));
  nand4  g118(.a(new_n150_), .b(new_n48_), .c(new_n46_), .d(new_n43_), .O(new_n152_));
  or2    g119(.a(new_n152_), .b(new_n42_), .O(z5));
  aoi21  g120(.a(x20), .b(new_n70_), .c(x06), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x11), .c(new_n34_), .O(new_n155_));
  nand2  g122(.a(new_n48_), .b(new_n43_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n42_), .c(new_n150_), .O(new_n157_));
  ...
  nand2  g128(.a(new_n105_), .b(new_n104_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n103_), .c(new_n150_), .O(new_n163_));
  ...
  nand4  g133(.a(new_n150_), .b(new_n147_), .c(new_n104_), .d(new_n145_), .O(z7));
endmodule
