...
module FAU ( 
  ...
  nor2   g022(.a(x09), .b(new_n55_), .O(new_n56_));
  ...
  nor2   g057(.a(new_n36_), .b(new_n72_), .O(new_n91_));
  nand3  g058(.a(new_n91_), .b(x08), .c(x06), .O(new_n92_));
  nor4   g059(.a(new_n92_), .b(new_n70_), .c(new_n34_), .d(new_n55_), .O(new_n93_));
  ...
  nand4  g070(.a(new_n74_), .b(new_n73_), .c(new_n59_), .d(new_n36_), .O(new_n104_));
  nand4  g071(.a(new_n77_), .b(new_n76_), .c(new_n37_), .d(new_n75_), .O(new_n105_));
  nor2   g072(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n103_), .c(new_n102_), .d(new_n100_), .O(new_n107_));
  aoi21  g074(.a(new_n107_), .b(new_n99_), .c(new_n90_), .O(new_n108_));
  nand4  g075(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n109_));
  nand3  g076(.a(new_n98_), .b(x20), .c(x17), .O(new_n110_));
  ...
  nand4  g081(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n59_), .O(new_n115_));
  inv1   g082(.a(x19), .O(new_n116_));
  nor2   g083(.a(x20), .b(new_n116_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(new_n77_), .c(new_n76_), .O(new_n118_));
  nor2   g085(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(new_n114_), .c(new_n113_), .d(new_n100_), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(new_n112_), .c(x13), .O(new_n121_));
  aoi22  g088(.a(new_n121_), .b(new_n38_), .c(new_n108_), .d(x24), .O(new_n122_));
  ...
  nand4  g095(.a(new_n40_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n129_));
  and2   g096(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n127_), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(new_n126_), .O(new_n132_));
  nor4   g099(.a(new_n132_), .b(new_n37_), .c(new_n73_), .d(new_n36_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(x09), .c(x06), .d(x03), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(new_n55_), .O(z2));
  nand4  g102(.a(new_n62_), .b(x20), .c(x14), .d(x11), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(new_n72_), .O(new_n137_));
  ...
  nand4  g107(.a(new_n140_), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n141_));
  oai21  g108(.a(new_n138_), .b(new_n55_), .c(new_n141_), .O(new_n142_));
  ...
  nand4  g112(.a(new_n145_), .b(new_n97_), .c(new_n91_), .d(x14), .O(new_n146_));
  nor2   g113(.a(x03), .b(x01), .O(new_n147_));
  nor2   g114(.a(x11), .b(x08), .O(new_n148_));
  nor2   g115(.a(x20), .b(x14), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n102_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n146_), .c(new_n90_), .O(new_n151_));
  inv1   g118(.a(x15), .O(new_n152_));
  nor2   g119(.a(new_n37_), .b(new_n152_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n145_), .c(new_n91_), .d(x14), .O(new_n154_));
  nor2   g121(.a(x14), .b(x11), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n147_), .c(new_n117_), .d(new_n113_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n154_), .c(x13), .O(new_n157_));
  aoi22  g124(.a(new_n157_), .b(new_n38_), .c(new_n151_), .d(x24), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n143_), .O(z3));
  inv1   g126(.a(x21), .O(new_n160_));
  nand2  g127(.a(x08), .b(x00), .O(new_n161_));
  oai21  g128(.a(new_n160_), .b(x08), .c(new_n161_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n46_), .c(new_n45_), .O(new_n163_));
  nand2  g130(.a(x19), .b(x08), .O(new_n164_));
  oai21  g131(.a(new_n152_), .b(x08), .c(new_n164_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(x13), .c(x05), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n163_), .c(x24), .O(new_n167_));
  inv1   g134(.a(new_n90_), .O(new_n168_));
  nand2  g135(.a(x08), .b(x07), .O(new_n169_));
  oai21  g136(.a(new_n96_), .b(x08), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n168_), .c(x24), .O(new_n171_));
  nand3  g138(.a(new_n165_), .b(new_n48_), .c(new_n38_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n167_), .c(new_n57_), .O(new_n174_));
  oai21  g141(.a(x23), .b(new_n70_), .c(new_n75_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n76_), .c(new_n55_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n72_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n51_), .c(new_n74_), .O(new_n178_));
  inv1   g145(.a(new_n132_), .O(new_n179_));
  oai21  g146(.a(new_n77_), .b(x04), .c(x17), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(x22), .c(x09), .O(new_n181_));
  oai21  g148(.a(x09), .b(x01), .c(new_n181_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n179_), .c(x16), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(new_n178_), .c(new_n174_), .O(z4));
  nand4  g151(.a(new_n57_), .b(new_n50_), .c(new_n44_), .d(new_n43_), .O(z5));
  nand2  g152(.a(x20), .b(new_n73_), .O(new_n186_));
  aoi21  g153(.a(new_n186_), .b(new_n35_), .c(x11), .O(new_n187_));
  oai21  g154(.a(new_n187_), .b(x03), .c(new_n51_), .O(new_n188_));
  nand2  g155(.a(new_n37_), .b(x14), .O(new_n189_));
  aoi21  g156(.a(new_n189_), .b(x06), .c(new_n36_), .O(new_n190_));
  oai21  g157(.a(new_n190_), .b(new_n34_), .c(new_n179_), .O(new_n191_));
  aoi21  g158(.a(new_n191_), .b(new_n188_), .c(new_n56_), .O(z6));
  inv1   g159(.a(new_n126_), .O(new_n193_));
  nand4  g160(.a(new_n130_), .b(new_n127_), .c(new_n193_), .d(new_n57_), .O(z7));
endmodule
