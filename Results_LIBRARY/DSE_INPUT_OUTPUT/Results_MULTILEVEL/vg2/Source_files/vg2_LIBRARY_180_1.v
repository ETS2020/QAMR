...
module FAU ( 
  ...
  nor4   g027(.a(new_n60_), .b(new_n59_), .c(new_n37_), .d(new_n36_), .O(new_n61_));
  ...
  nand4  g038(.a(new_n71_), .b(new_n70_), .c(new_n40_), .d(new_n69_), .O(new_n72_));
  ...
  nand3  g047(.a(new_n43_), .b(x13), .c(x05), .O(new_n81_));
  ...
  nand4  g053(.a(new_n86_), .b(new_n85_), .c(new_n65_), .d(new_n61_), .O(new_n87_));
  nor2   g054(.a(x09), .b(x08), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n70_), .c(x07), .d(new_n38_), .O(new_n89_));
  inv1   g056(.a(x12), .O(new_n90_));
  inv1   g057(.a(x16), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n41_), .c(new_n90_), .d(new_n40_), .O(new_n92_));
  inv1   g059(.a(new_n92_), .O(new_n93_));
  inv1   g060(.a(x17), .O(new_n94_));
  nand3  g061(.a(new_n77_), .b(new_n42_), .c(new_n94_), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nand2  g063(.a(new_n96_), .b(new_n93_), .O(new_n97_));
  oai21  g064(.a(new_n97_), .b(new_n89_), .c(new_n87_), .O(new_n98_));
  nand3  g065(.a(new_n98_), .b(new_n80_), .c(x24), .O(new_n99_));
  inv1   g066(.a(x21), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n42_), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n85_), .c(new_n65_), .d(new_n61_), .O(new_n102_));
  nor2   g069(.a(x03), .b(x01), .O(new_n103_));
  nand2  g070(.a(new_n103_), .b(x00), .O(new_n104_));
  nand3  g071(.a(new_n88_), .b(new_n38_), .c(new_n59_), .O(new_n105_));
  nor2   g072(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n96_), .c(new_n93_), .O(new_n107_));
  aoi21  g074(.a(new_n107_), .b(new_n102_), .c(x24), .O(new_n108_));
  oai21  g075(.a(new_n108_), .b(x10), .c(new_n34_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n99_), .c(new_n83_), .O(z1));
  nand2  g077(.a(x10), .b(new_n34_), .O(new_n111_));
  nand2  g078(.a(x24), .b(x18), .O(new_n112_));
  nand3  g079(.a(new_n43_), .b(x15), .c(x13), .O(new_n113_));
  ...
  oai21  g084(.a(new_n117_), .b(new_n114_), .c(new_n111_), .O(new_n118_));
  nor2   g085(.a(x24), .b(new_n100_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n35_), .c(new_n34_), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(new_n118_), .c(new_n42_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(x14), .c(x11), .d(x06), .O(new_n122_));
  nor3   g089(.a(new_n122_), .b(new_n37_), .c(new_n36_), .O(z2));
  inv1   g090(.a(x08), .O(new_n124_));
  nand3  g091(.a(x15), .b(x13), .c(x05), .O(new_n125_));
  oai21  g092(.a(new_n100_), .b(x02), .c(new_n125_), .O(new_n126_));
  ...
  nand4  g099(.a(new_n132_), .b(new_n42_), .c(new_n41_), .d(new_n40_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x08), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n129_), .c(x24), .O(new_n136_));
  nand4  g103(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n137_));
  nand3  g104(.a(new_n86_), .b(x14), .c(x11), .O(new_n138_));
  nand3  g105(.a(new_n103_), .b(x07), .c(new_n38_), .O(new_n139_));
  nand4  g106(.a(new_n42_), .b(new_n41_), .c(new_n40_), .d(new_n124_), .O(new_n140_));
  ...
  nand2  g110(.a(new_n103_), .b(new_n71_), .O(new_n144_));
  nand3  g111(.a(new_n76_), .b(new_n41_), .c(new_n40_), .O(new_n145_));
  ...
  oai21  g115(.a(new_n148_), .b(new_n136_), .c(new_n35_), .O(new_n149_));
  nand2  g116(.a(new_n146_), .b(new_n82_), .O(new_n150_));
  ...
  oai21  g120(.a(x23), .b(new_n59_), .c(new_n94_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n63_), .c(x09), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x16), .c(new_n124_), .O(new_n156_));
  inv1   g123(.a(new_n111_), .O(new_n157_));
  nand4  g124(.a(new_n43_), .b(new_n35_), .c(new_n34_), .d(x00), .O(new_n158_));
  oai21  g125(.a(new_n157_), .b(new_n55_), .c(new_n158_), .O(z5));
  nand2  g126(.a(z5), .b(new_n156_), .O(new_n160_));
  nand2  g127(.a(new_n120_), .b(new_n118_), .O(new_n161_));
  oai21  g128(.a(new_n64_), .b(x04), .c(x17), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x22), .c(new_n69_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n91_), .c(x08), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n160_), .O(z4));
  nand2  g133(.a(x20), .b(new_n41_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n38_), .c(x11), .O(new_n168_));
  nand3  g135(.a(new_n43_), .b(new_n34_), .c(x00), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n53_), .c(new_n51_), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n50_), .c(new_n168_), .d(x03), .O(new_n171_));
  nand2  g138(.a(new_n42_), .b(x14), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(x06), .c(new_n40_), .O(new_n173_));
  nand2  g140(.a(new_n119_), .b(new_n34_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n116_), .c(new_n115_), .O(new_n175_));
  oai22  g142(.a(new_n175_), .b(new_n114_), .c(new_n173_), .d(new_n37_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n171_), .c(new_n111_), .O(z6));
  nor2   g144(.a(new_n117_), .b(new_n114_), .O(new_n178_));
  oai21  g145(.a(new_n119_), .b(x10), .c(new_n34_), .O(new_n179_));
