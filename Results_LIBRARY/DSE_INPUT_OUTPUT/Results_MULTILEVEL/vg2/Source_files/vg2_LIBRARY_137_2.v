...
module FAU ( 
  ...
  nand4  g047(.a(new_n80_), .b(new_n67_), .c(new_n66_), .d(new_n34_), .O(new_n81_));
  ...
  nor4   g054(.a(new_n87_), .b(new_n65_), .c(new_n36_), .d(new_n35_), .O(new_n88_));
  ...
  nand4  g065(.a(new_n69_), .b(new_n68_), .c(new_n54_), .d(new_n67_), .O(new_n99_));
  ...
  nand4  g076(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n54_), .O(new_n110_));
  ...
  aoi22  g083(.a(new_n116_), .b(new_n38_), .c(new_n103_), .d(x24), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n85_), .O(z1));
  nor2   g085(.a(new_n40_), .b(new_n91_), .O(new_n119_));
  ...
  nor3   g094(.a(new_n127_), .b(new_n71_), .c(new_n68_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(x11), .c(x06), .d(x03), .O(new_n129_));
  nor2   g096(.a(x20), .b(new_n34_), .O(new_n130_));
  inv1   g097(.a(new_n130_), .O(new_n131_));
  oai21  g098(.a(new_n129_), .b(new_n35_), .c(new_n131_), .O(z2));
  nand4  g099(.a(new_n57_), .b(x20), .c(x14), .d(x11), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(new_n34_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(x06), .c(x03), .d(x01), .O(new_n135_));
  nand4  g102(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n67_), .O(new_n136_));
  ...
  nor2   g109(.a(new_n68_), .b(new_n67_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n142_), .c(new_n92_), .O(new_n144_));
  nor2   g111(.a(x03), .b(x01), .O(new_n145_));
  nor2   g112(.a(x11), .b(x08), .O(new_n146_));
  nor2   g113(.a(x20), .b(x14), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n97_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n144_), .c(new_n86_), .O(new_n149_));
  nand4  g116(.a(new_n143_), .b(new_n142_), .c(x20), .d(x15), .O(new_n150_));
  nor2   g117(.a(x14), .b(x11), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n145_), .c(new_n112_), .d(new_n108_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n150_), .c(x13), .O(new_n153_));
  aoi22  g120(.a(new_n153_), .b(new_n38_), .c(new_n149_), .d(x24), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n140_), .O(z3));
  aoi21  g122(.a(new_n73_), .b(x04), .c(x17), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x22), .c(new_n66_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n69_), .c(new_n34_), .O(new_n158_));
  inv1   g125(.a(new_n158_), .O(new_n159_));
  aoi21  g126(.a(x20), .b(x08), .c(new_n159_), .O(new_n160_));
  aoi21  g127(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n72_), .c(x09), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(x20), .c(x16), .O(new_n163_));
  and2   g130(.a(new_n163_), .b(x08), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n127_), .c(new_n160_), .d(new_n50_), .O(z4));
  inv1   g132(.a(new_n42_), .O(new_n166_));
  and2   g133(.a(new_n46_), .b(new_n43_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n131_), .c(new_n48_), .d(new_n166_), .O(z5));
  aoi21  g135(.a(new_n67_), .b(x06), .c(x03), .O(new_n169_));
  aoi21  g136(.a(x11), .b(new_n37_), .c(new_n36_), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n127_), .c(new_n169_), .d(new_n50_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n131_), .O(new_n172_));
  nand4  g139(.a(x20), .b(new_n68_), .c(new_n67_), .d(x00), .O(new_n173_));
  nand2  g140(.a(x11), .b(new_n34_), .O(new_n174_));
  nand3  g141(.a(x21), .b(new_n71_), .c(x14), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n174_), .c(new_n173_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n45_), .c(new_n44_), .O(new_n177_));
  nand3  g144(.a(new_n151_), .b(x20), .c(x19), .O(new_n178_));
  nand3  g145(.a(new_n71_), .b(x15), .c(x14), .O(new_n179_));
  oai21  g146(.a(new_n179_), .b(new_n174_), .c(new_n178_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(x13), .c(x05), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n177_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n40_), .O(new_n183_));
  inv1   g150(.a(new_n86_), .O(new_n184_));
  nand4  g151(.a(x20), .b(new_n68_), .c(new_n67_), .d(x07), .O(new_n185_));
  nand3  g152(.a(new_n71_), .b(x18), .c(x14), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(new_n174_), .c(new_n185_), .O(new_n187_));
  nand3  g154(.a(new_n187_), .b(new_n184_), .c(x24), .O(new_n188_));
  nand3  g155(.a(new_n180_), .b(new_n47_), .c(new_n38_), .O(new_n189_));
  nand4  g156(.a(new_n189_), .b(new_n188_), .c(new_n183_), .d(new_n172_), .O(z6));
  nor2   g157(.a(new_n130_), .b(new_n127_), .O(z7));
endmodule
