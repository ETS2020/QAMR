...
module FAU ( 
  ...
  nor2   g093(.a(new_n72_), .b(x20), .O(new_n127_));
  ...
  nand4  g113(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n147_));
  nand4  g114(.a(new_n71_), .b(x19), .c(new_n68_), .d(new_n36_), .O(new_n148_));
  ...
  nand4  g117(.a(new_n150_), .b(new_n145_), .c(new_n137_), .d(new_n128_), .O(z3));
  ...
  nor2   g121(.a(new_n154_), .b(new_n66_), .O(new_n155_));
  inv1   g122(.a(new_n49_), .O(new_n156_));
  oai21  g123(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n157_));
  aoi22  g124(.a(new_n157_), .b(new_n72_), .c(x09), .d(new_n66_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(x16), .c(new_n127_), .d(new_n66_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n156_), .c(new_n127_), .O(new_n160_));
  oai21  g127(.a(new_n155_), .b(new_n124_), .c(new_n160_), .O(z4));
  nor2   g128(.a(new_n127_), .b(new_n49_), .O(z5));
  ...
  inv1   g133(.a(new_n140_), .O(new_n167_));
  nand4  g134(.a(x20), .b(new_n68_), .c(new_n36_), .d(x00), .O(new_n168_));
  nand3  g135(.a(new_n72_), .b(x21), .c(new_n71_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n167_), .c(new_n168_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n44_), .c(new_n43_), .O(new_n171_));
  nand4  g138(.a(x20), .b(x19), .c(new_n68_), .d(new_n36_), .O(new_n172_));
  nor2   g139(.a(x22), .b(x20), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n140_), .c(x15), .O(new_n174_));
  ...
  nand4  g145(.a(x20), .b(new_n68_), .c(new_n36_), .d(x07), .O(new_n179_));
  nand3  g146(.a(new_n173_), .b(new_n140_), .c(x18), .O(new_n180_));
  aoi21  g147(.a(new_n180_), .b(new_n179_), .c(new_n86_), .O(new_n181_));
  ...
  nand4  g153(.a(new_n186_), .b(new_n128_), .c(new_n122_), .d(new_n185_), .O(z7));
endmodule
