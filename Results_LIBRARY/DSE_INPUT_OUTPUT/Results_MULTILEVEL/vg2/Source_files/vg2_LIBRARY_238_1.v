...
module FAU ( 
  ...
  nand2  g080(.a(x02), .b(new_n66_), .O(new_n114_));
  oai21  g081(.a(new_n113_), .b(new_n66_), .c(new_n114_), .O(z2));
  nand4  g082(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n116_));
  nor2   g083(.a(new_n103_), .b(new_n37_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(x20), .c(x15), .O(new_n118_));
  nand4  g085(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n66_), .O(new_n119_));
  nand4  g086(.a(new_n75_), .b(new_n103_), .c(new_n37_), .d(new_n65_), .O(new_n120_));
  oai22  g087(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n116_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n81_), .O(new_n122_));
  nand2  g089(.a(new_n117_), .b(new_n85_), .O(new_n123_));
  nor2   g090(.a(x20), .b(x14), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n37_), .c(new_n65_), .d(x07), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n119_), .c(new_n123_), .d(new_n116_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n79_), .c(x24), .O(new_n127_));
  nand4  g094(.a(new_n36_), .b(new_n35_), .c(new_n66_), .d(x00), .O(new_n128_));
  nand3  g095(.a(new_n124_), .b(new_n37_), .c(new_n65_), .O(new_n129_));
  nand2  g096(.a(new_n117_), .b(new_n95_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n116_), .c(new_n129_), .d(new_n128_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n41_), .c(new_n45_), .d(new_n34_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n127_), .c(new_n122_), .O(z3));
  oai21  g100(.a(x23), .b(new_n67_), .c(new_n59_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n61_), .c(x09), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x16), .c(new_n65_), .O(new_n136_));
  inv1   g103(.a(new_n43_), .O(new_n137_));
  nand4  g104(.a(new_n41_), .b(new_n45_), .c(new_n34_), .d(x00), .O(new_n138_));
  and2   g105(.a(new_n138_), .b(new_n48_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n44_), .c(new_n137_), .O(new_n140_));
  ...
  oai21  g113(.a(new_n110_), .b(new_n106_), .c(new_n146_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n141_), .c(new_n114_), .O(z4));
  nand4  g115(.a(new_n139_), .b(new_n114_), .c(new_n44_), .d(new_n137_), .O(z5));
  aoi21  g116(.a(x20), .b(new_n103_), .c(x06), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x11), .c(new_n35_), .O(new_n151_));
  nand2  g118(.a(new_n48_), .b(new_n44_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n43_), .c(new_n114_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n138_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  aoi21  g122(.a(new_n38_), .b(x14), .c(new_n36_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n37_), .c(x03), .O(new_n157_));
  nand2  g124(.a(new_n108_), .b(new_n107_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n106_), .c(new_n114_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n109_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n155_), .O(z6));
  nand4  g129(.a(new_n114_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(new_n163_));
