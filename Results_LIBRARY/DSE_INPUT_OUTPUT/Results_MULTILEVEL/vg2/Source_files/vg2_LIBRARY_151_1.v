...
module FAU ( 
  ...
  nor4   g081(.a(new_n114_), .b(x24), .c(new_n113_), .d(new_n112_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n111_), .c(new_n108_), .d(new_n106_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n105_), .c(new_n97_), .d(new_n83_), .O(z1));
  ...
  nand3  g089(.a(x15), .b(new_n79_), .c(new_n46_), .O(new_n123_));
  nand4  g090(.a(new_n41_), .b(x21), .c(new_n109_), .d(new_n34_), .O(new_n124_));
  and2   g091(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n122_), .c(new_n121_), .O(new_n126_));
  ...
  nand2  g096(.a(x02), .b(new_n67_), .O(new_n130_));
  oai21  g097(.a(new_n129_), .b(new_n67_), .c(new_n130_), .O(z2));
  ...
  nand3  g101(.a(new_n71_), .b(new_n35_), .c(new_n67_), .O(new_n135_));
  nand3  g102(.a(new_n75_), .b(new_n38_), .c(new_n37_), .O(new_n136_));
  ...
  nand3  g106(.a(new_n88_), .b(new_n35_), .c(new_n67_), .O(new_n140_));
  nand4  g107(.a(new_n39_), .b(new_n38_), .c(new_n37_), .d(new_n58_), .O(new_n141_));
  ...
  nand3  g110(.a(new_n71_), .b(new_n35_), .c(x00), .O(new_n144_));
  nor2   g111(.a(x11), .b(x10), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n41_), .c(new_n39_), .d(new_n38_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n144_), .c(new_n34_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n67_), .O(new_n148_));
  nor2   g115(.a(x02), .b(new_n67_), .O(new_n149_));
  nand2  g116(.a(new_n133_), .b(new_n109_), .O(new_n150_));
  nand3  g117(.a(new_n41_), .b(x21), .c(x20), .O(new_n151_));
  nor2   g118(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n149_), .c(new_n59_), .d(x03), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n148_), .c(new_n143_), .d(new_n138_), .O(z3));
  nand2  g121(.a(new_n130_), .b(x08), .O(new_n155_));
  aoi21  g122(.a(new_n113_), .b(x04), .c(x17), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x22), .c(new_n66_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n91_), .c(new_n58_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n155_), .c(new_n40_), .O(new_n159_));
  inv1   g126(.a(x18), .O(new_n160_));
  inv1   g127(.a(x04), .O(new_n161_));
  inv1   g128(.a(x17), .O(new_n162_));
  aoi21  g129(.a(x23), .b(new_n161_), .c(new_n162_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n112_), .c(x09), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(x16), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x08), .c(new_n160_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n159_), .c(new_n80_), .O(new_n167_));
  nand4  g134(.a(new_n49_), .b(x08), .c(new_n46_), .d(x01), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(x24), .O(new_n170_));
  nand2  g137(.a(new_n82_), .b(x15), .O(new_n171_));
  aoi22  g138(.a(new_n171_), .b(new_n124_), .c(new_n165_), .d(x08), .O(new_n172_));
  nand2  g139(.a(x24), .b(x08), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n79_), .c(new_n46_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n81_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(x19), .O(new_n176_));
  nand2  g143(.a(new_n99_), .b(new_n47_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n157_), .c(new_n91_), .O(new_n179_));
  nand2  g146(.a(x13), .b(x05), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n80_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n41_), .c(x19), .O(new_n182_));
  oai21  g149(.a(new_n50_), .b(x02), .c(new_n182_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(x08), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n179_), .c(new_n130_), .O(new_n185_));
  nor2   g152(.a(new_n185_), .b(new_n172_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n170_), .O(z4));
  nand2  g154(.a(new_n49_), .b(new_n46_), .O(new_n188_));
  nand3  g155(.a(new_n188_), .b(new_n45_), .c(new_n44_), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n130_), .O(new_n190_));
  nand2  g157(.a(new_n190_), .b(new_n177_), .O(z5));
  ...
  nand2  g163(.a(new_n123_), .b(new_n122_), .O(new_n197_));
  oai21  g164(.a(new_n197_), .b(new_n120_), .c(new_n130_), .O(new_n198_));
  nand2  g165(.a(new_n198_), .b(new_n124_), .O(new_n199_));
  nand2  g166(.a(new_n199_), .b(new_n196_), .O(new_n200_));
  nand2  g167(.a(new_n200_), .b(new_n194_), .O(z6));
  nand4  g168(.a(new_n130_), .b(new_n125_), .c(new_n122_), .d(new_n121_), .O(z7));
endmodule
