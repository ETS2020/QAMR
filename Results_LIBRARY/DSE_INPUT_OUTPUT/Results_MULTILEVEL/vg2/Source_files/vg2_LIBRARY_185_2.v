...
module FAU ( 
  ...
  oai21  g110(.a(new_n109_), .b(new_n107_), .c(new_n135_), .O(new_n144_));
  nor2   g111(.a(x02), .b(x01), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n40_), .c(x21), .d(new_n98_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n144_), .O(z7));
  ...
  aoi21  g119(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n36_), .c(x03), .O(new_n154_));
