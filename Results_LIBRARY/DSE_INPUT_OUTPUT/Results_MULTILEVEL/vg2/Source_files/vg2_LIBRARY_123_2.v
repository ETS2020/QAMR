...
module FAU ( 
  ...
  nand4  g034(.a(new_n67_), .b(new_n36_), .c(new_n34_), .d(new_n35_), .O(new_n68_));
  inv1   g035(.a(new_n68_), .O(new_n69_));
  nor2   g036(.a(x08), .b(x06), .O(new_n70_));
  nand4  g037(.a(new_n70_), .b(new_n69_), .c(new_n37_), .d(new_n66_), .O(new_n71_));
  ...
  oai21  g044(.a(new_n77_), .b(new_n71_), .c(new_n65_), .O(new_n78_));
  ...
  nand4  g052(.a(new_n85_), .b(new_n84_), .c(new_n64_), .d(new_n57_), .O(new_n86_));
  inv1   g053(.a(x06), .O(new_n87_));
  nor2   g054(.a(x09), .b(x08), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n69_), .c(x07), .d(new_n87_), .O(new_n89_));
  ...
  nand4  g063(.a(new_n96_), .b(new_n84_), .c(new_n64_), .d(new_n57_), .O(new_n97_));
  ...
  nand2  g081(.a(new_n87_), .b(x02), .O(new_n115_));
  oai21  g082(.a(new_n114_), .b(new_n35_), .c(new_n115_), .O(z2));
  nand4  g083(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n117_));
  nor2   g084(.a(new_n104_), .b(new_n37_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(x20), .c(x15), .O(new_n119_));
  nand2  g086(.a(new_n98_), .b(new_n70_), .O(new_n120_));
  nand3  g087(.a(new_n75_), .b(new_n104_), .c(new_n37_), .O(new_n121_));
  oai22  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n117_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n81_), .O(new_n123_));
  nand2  g090(.a(new_n118_), .b(new_n85_), .O(new_n124_));
  nand3  g091(.a(new_n98_), .b(x07), .c(new_n87_), .O(new_n125_));
  inv1   g092(.a(x08), .O(new_n126_));
  nand4  g093(.a(new_n38_), .b(new_n104_), .c(new_n37_), .d(new_n126_), .O(new_n127_));
  ...
  nand4  g096(.a(new_n126_), .b(new_n36_), .c(new_n35_), .d(x00), .O(new_n130_));
  nor2   g097(.a(x11), .b(x10), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n41_), .c(new_n38_), .d(new_n104_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n130_), .c(new_n34_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n87_), .O(new_n134_));
  nor4   g101(.a(new_n55_), .b(new_n36_), .c(x02), .d(new_n35_), .O(new_n135_));
  nand3  g102(.a(new_n41_), .b(x21), .c(x20), .O(new_n136_));
  inv1   g103(.a(new_n136_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n135_), .c(new_n118_), .d(new_n45_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n134_), .c(new_n129_), .d(new_n123_), .O(z3));
  oai21  g106(.a(x23), .b(new_n67_), .c(new_n60_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n62_), .c(x09), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x16), .c(new_n126_), .O(new_n142_));
  inv1   g109(.a(new_n43_), .O(new_n143_));
  nand4  g110(.a(new_n41_), .b(new_n45_), .c(new_n34_), .d(x00), .O(new_n144_));
  and2   g111(.a(new_n144_), .b(new_n48_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n44_), .c(new_n143_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n142_), .O(new_n147_));
  inv1   g114(.a(x16), .O(new_n148_));
  oai21  g115(.a(new_n63_), .b(x04), .c(x17), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n66_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n148_), .c(x08), .O(new_n151_));
  oai21  g118(.a(new_n111_), .b(new_n107_), .c(new_n151_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n147_), .c(new_n115_), .O(z4));
  nand4  g120(.a(new_n145_), .b(new_n115_), .c(new_n44_), .d(new_n143_), .O(z5));
  nand2  g121(.a(x20), .b(new_n104_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n87_), .c(x11), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x03), .c(new_n146_), .O(new_n157_));
  xor2a  g124(.a(x13), .b(x05), .O(new_n158_));
  nand2  g125(.a(new_n87_), .b(new_n34_), .O(new_n159_));
  nand2  g126(.a(new_n38_), .b(x14), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n159_), .c(new_n37_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n36_), .c(x15), .O(new_n162_));
  nand3  g129(.a(x19), .b(new_n37_), .c(x02), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n162_), .c(new_n158_), .O(new_n164_));
  oai21  g131(.a(x20), .b(new_n104_), .c(x06), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(x11), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(x03), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(x21), .c(new_n45_), .d(new_n34_), .O(new_n168_));
  inv1   g135(.a(new_n168_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n164_), .c(new_n41_), .O(new_n170_));
  nand3  g137(.a(new_n165_), .b(x11), .c(x03), .O(new_n171_));
  nand2  g138(.a(new_n115_), .b(new_n36_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n79_), .c(x18), .O(new_n174_));
  nand3  g141(.a(x11), .b(new_n87_), .c(x03), .O(new_n175_));
  oai21  g142(.a(new_n87_), .b(x03), .c(new_n175_), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(x15), .c(new_n47_), .d(new_n39_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n174_), .O(new_n178_));
  nand2  g145(.a(x11), .b(x03), .O(new_n179_));
  oai22  g146(.a(new_n179_), .b(new_n160_), .c(x03), .d(x02), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(x15), .c(new_n47_), .d(new_n39_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n115_), .O(new_n182_));
  aoi21  g149(.a(new_n178_), .b(x24), .c(new_n182_), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(new_n170_), .c(new_n157_), .O(z6));
  nand2  g151(.a(new_n109_), .b(new_n108_), .O(new_n185_));
  oai21  g152(.a(new_n185_), .b(new_n107_), .c(new_n115_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n110_), .O(z7));
endmodule
