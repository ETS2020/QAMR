...
module FAU ( 
  ...
  nand3  g014(.a(x19), .b(new_n42_), .c(new_n37_), .O(new_n48_));
  nand3  g015(.a(new_n48_), .b(new_n47_), .c(new_n44_), .O(new_n49_));
  ...
  nand2  g054(.a(new_n42_), .b(new_n37_), .O(new_n88_));
  nand4  g055(.a(x11), .b(x09), .c(x08), .d(x06), .O(new_n89_));
  nor4   g056(.a(new_n89_), .b(new_n67_), .c(new_n34_), .d(new_n66_), .O(new_n90_));
  nand4  g057(.a(x17), .b(x16), .c(x14), .d(x12), .O(new_n91_));
  inv1   g058(.a(new_n91_), .O(new_n92_));
  inv1   g059(.a(x18), .O(new_n93_));
  nor2   g060(.a(new_n73_), .b(new_n93_), .O(new_n94_));
  ...
  nand4  g066(.a(new_n99_), .b(new_n97_), .c(new_n69_), .d(new_n68_), .O(new_n100_));
  nand4  g067(.a(new_n71_), .b(new_n70_), .c(new_n55_), .d(new_n36_), .O(new_n101_));
  ...
  nand4  g078(.a(new_n111_), .b(new_n97_), .c(new_n36_), .d(new_n69_), .O(new_n112_));
  ...
  nand3  g085(.a(new_n118_), .b(new_n42_), .c(new_n37_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n106_), .c(new_n53_), .O(new_n120_));
  inv1   g087(.a(new_n120_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n87_), .O(z1));
  nand3  g089(.a(new_n39_), .b(x13), .c(x05), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n88_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n53_), .c(x15), .O(new_n125_));
  nand3  g092(.a(new_n88_), .b(x24), .c(x18), .O(new_n126_));
  nand3  g093(.a(new_n39_), .b(x21), .c(new_n46_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n45_), .O(new_n129_));
  aoi21  g096(.a(new_n129_), .b(new_n125_), .c(new_n73_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(x14), .c(x11), .d(x06), .O(new_n131_));
  nor3   g098(.a(new_n131_), .b(new_n34_), .c(new_n66_), .O(z2));
  nand4  g099(.a(x06), .b(x03), .c(new_n45_), .d(x01), .O(new_n133_));
  nand4  g100(.a(new_n94_), .b(x14), .c(x11), .d(x08), .O(new_n134_));
  nor2   g101(.a(x03), .b(x01), .O(new_n135_));
  nor2   g102(.a(x11), .b(x08), .O(new_n136_));
  nor2   g103(.a(x20), .b(x14), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n99_), .O(new_n138_));
  oai21  g105(.a(new_n134_), .b(new_n133_), .c(new_n138_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n88_), .c(x24), .O(new_n140_));
  nand4  g107(.a(new_n78_), .b(new_n73_), .c(new_n70_), .d(new_n36_), .O(new_n141_));
  nor2   g108(.a(new_n141_), .b(x08), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n35_), .c(new_n34_), .d(new_n66_), .O(new_n143_));
  inv1   g110(.a(new_n56_), .O(new_n144_));
  aoi21  g111(.a(x21), .b(new_n46_), .c(new_n144_), .O(new_n145_));
  nand4  g112(.a(new_n93_), .b(x15), .c(x13), .d(x05), .O(new_n146_));
  oai21  g113(.a(new_n145_), .b(x02), .c(new_n146_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(x20), .c(x14), .d(x11), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(new_n68_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(x06), .c(x03), .d(x01), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n143_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n39_), .O(new_n152_));
  nand4  g119(.a(new_n53_), .b(x20), .c(x15), .d(x14), .O(new_n153_));
  nor3   g120(.a(new_n153_), .b(new_n36_), .c(new_n68_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(x06), .c(x03), .d(x01), .O(new_n155_));
  nor2   g122(.a(x14), .b(x11), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n135_), .c(new_n116_), .d(new_n111_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n42_), .c(new_n37_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n152_), .c(new_n140_), .d(new_n53_), .O(z3));
  inv1   g127(.a(new_n50_), .O(new_n161_));
  oai21  g128(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n74_), .c(x09), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x16), .c(new_n68_), .O(new_n164_));
  ...
  oai21  g134(.a(new_n167_), .b(new_n71_), .c(x08), .O(new_n168_));
  nand3  g135(.a(new_n39_), .b(x15), .c(x13), .O(new_n169_));
  oai21  g136(.a(new_n39_), .b(new_n93_), .c(new_n169_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(x05), .O(new_n171_));
  nand3  g138(.a(x24), .b(x18), .c(x13), .O(new_n172_));
  nand3  g139(.a(x15), .b(new_n42_), .c(new_n37_), .O(new_n173_));
  nand4  g140(.a(new_n39_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n174_));
  and2   g141(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n172_), .c(new_n171_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n168_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n165_), .c(new_n53_), .O(z4));
  inv1   g145(.a(new_n41_), .O(new_n179_));
  and2   g146(.a(new_n53_), .b(new_n48_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n47_), .c(new_n44_), .d(new_n179_), .O(z5));
  nand2  g148(.a(x20), .b(new_n70_), .O(new_n182_));
  aoi21  g149(.a(new_n182_), .b(new_n35_), .c(x11), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(x03), .c(new_n161_), .O(new_n184_));
  nand2  g151(.a(new_n73_), .b(x14), .O(new_n185_));
  aoi21  g152(.a(new_n185_), .b(x06), .c(new_n36_), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(new_n34_), .c(new_n176_), .O(new_n187_));
  nand3  g154(.a(new_n187_), .b(new_n184_), .c(new_n53_), .O(z6));
  oai21  g155(.a(new_n43_), .b(x02), .c(x18), .O(new_n189_));
  nand3  g156(.a(new_n189_), .b(new_n175_), .c(new_n171_), .O(z7));
endmodule
