...
module FAU ( 
  ...
  nand2  g033(.a(x16), .b(x14), .O(new_n67_));
  ...
  aoi21  g046(.a(new_n79_), .b(new_n56_), .c(new_n69_), .O(z2));
  ...
  nand4  g073(.a(new_n58_), .b(x19), .c(new_n69_), .d(new_n36_), .O(new_n107_));
  ...
  nand4  g076(.a(new_n109_), .b(new_n104_), .c(new_n96_), .d(new_n67_), .O(z3));
  ...
  oai21  g081(.a(new_n114_), .b(x16), .c(new_n81_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n111_), .O(new_n116_));
  inv1   g083(.a(new_n77_), .O(new_n117_));
  oai21  g084(.a(new_n59_), .b(x04), .c(x17), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(x22), .c(new_n54_), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n56_), .c(x08), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n116_), .c(new_n67_), .O(z4));
  inv1   g089(.a(new_n41_), .O(new_n123_));
  and2   g090(.a(new_n45_), .b(new_n42_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n67_), .c(new_n47_), .d(new_n123_), .O(z5));
  aoi21  g092(.a(new_n36_), .b(x06), .c(x03), .O(new_n126_));
  aoi21  g093(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n77_), .c(new_n126_), .d(new_n49_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n67_), .O(new_n129_));
  inv1   g096(.a(new_n99_), .O(new_n130_));
  nand4  g097(.a(x20), .b(new_n69_), .c(new_n36_), .d(x00), .O(new_n131_));
  nand3  g098(.a(x21), .b(new_n58_), .c(new_n56_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n130_), .c(new_n131_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n44_), .c(new_n43_), .O(new_n134_));
  nand4  g101(.a(x20), .b(x19), .c(new_n69_), .d(new_n36_), .O(new_n135_));
  nand4  g102(.a(new_n99_), .b(new_n58_), .c(new_n56_), .d(x15), .O(new_n136_));
  ...
  nand4  g107(.a(x20), .b(new_n69_), .c(new_n36_), .d(x07), .O(new_n141_));
  nand3  g108(.a(new_n58_), .b(x18), .c(new_n56_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n130_), .c(new_n141_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n97_), .c(x24), .O(new_n144_));
  nand3  g111(.a(new_n137_), .b(new_n46_), .c(new_n37_), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n144_), .c(new_n140_), .d(new_n129_), .O(z6));
  inv1   g113(.a(new_n72_), .O(new_n147_));
  and2   g114(.a(new_n74_), .b(new_n73_), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n75_), .c(new_n147_), .d(new_n67_), .O(z7));
endmodule
