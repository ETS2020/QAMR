...
module FAU ( 
  ...
  nand2  g125(.a(z5), .b(new_n154_), .O(new_n159_));
  ...
  aoi21  g135(.a(x20), .b(new_n89_), .c(x06), .O(new_n169_));
  ...
  inv1   g142(.a(new_n120_), .O(new_n176_));
  and2   g143(.a(new_n155_), .b(new_n121_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n165_), .c(new_n122_), .d(new_n176_), .O(z7));
endmodule
