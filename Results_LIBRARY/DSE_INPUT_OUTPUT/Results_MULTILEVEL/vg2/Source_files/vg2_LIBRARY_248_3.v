...
module FAU ( 
  ...
  nor2   g35(.a(new_n36_), .b(new_n55_), .O(z2));
  inv1   g36(.a(z2), .O(new_n70_));
  nor2   g37(.a(new_n51_), .b(x08), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n55_), .c(new_n53_), .O(new_n72_));
  oai21  g39(.a(new_n72_), .b(x01), .c(new_n70_), .O(z3));
  inv1   g40(.a(x22), .O(new_n74_));
  oai21  g41(.a(x23), .b(new_n54_), .c(new_n59_), .O(new_n75_));
  nand2  g42(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  aoi21  g43(.a(new_n76_), .b(new_n56_), .c(x16), .O(new_n77_));
  oai21  g44(.a(new_n77_), .b(x08), .c(new_n50_), .O(new_n78_));
  oai21  g45(.a(new_n60_), .b(x04), .c(x17), .O(new_n79_));
  aoi21  g46(.a(new_n79_), .b(x22), .c(new_n56_), .O(new_n80_));
  oai21  g47(.a(new_n80_), .b(new_n58_), .c(x08), .O(new_n81_));
  and2   g48(.a(x24), .b(x18), .O(new_n82_));
  nand3  g49(.a(new_n39_), .b(x15), .c(x13), .O(new_n83_));
  inv1   g50(.a(new_n83_), .O(new_n84_));
  oai21  g51(.a(new_n84_), .b(new_n82_), .c(x05), .O(new_n85_));
  nand2  g52(.a(new_n82_), .b(x13), .O(new_n86_));
  nand3  g53(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n87_));
  nand4  g54(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n88_));
  nand4  g55(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n89_));
  nand2  g56(.a(new_n89_), .b(new_n81_), .O(new_n90_));
  aoi21  g57(.a(new_n90_), .b(new_n78_), .c(z2), .O(z4));
  nor2   g58(.a(z2), .b(new_n49_), .O(z5));
  nand2  g59(.a(x20), .b(new_n35_), .O(new_n93_));
  aoi21  g60(.a(new_n93_), .b(new_n55_), .c(x11), .O(new_n94_));
  oai21  g61(.a(new_n94_), .b(x03), .c(new_n50_), .O(new_n95_));
  nor2   g62(.a(z2), .b(x03), .O(new_n96_));
  nand2  g63(.a(x14), .b(x03), .O(new_n97_));
  aoi21  g64(.a(new_n97_), .b(x06), .c(new_n34_), .O(new_n98_));
  oai21  g65(.a(new_n98_), .b(new_n96_), .c(new_n89_), .O(new_n99_));
  nand3  g66(.a(new_n99_), .b(new_n95_), .c(new_n70_), .O(z6));
  and2   g67(.a(new_n89_), .b(new_n70_), .O(z7));
endmodule
