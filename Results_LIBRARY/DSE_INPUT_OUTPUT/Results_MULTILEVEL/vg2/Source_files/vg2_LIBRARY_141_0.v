...
module FAU ( 
  ...
  nor4   g015(.a(new_n48_), .b(x20), .c(x14), .d(x11), .O(new_n49_));
  nand4  g016(.a(new_n49_), .b(x09), .c(new_n35_), .d(new_n34_), .O(new_n50_));
  ...
  aoi21  g024(.a(new_n57_), .b(new_n56_), .c(new_n36_), .O(new_n58_));
  nand3  g025(.a(x24), .b(x18), .c(x13), .O(new_n59_));
  nand3  g026(.a(x15), .b(new_n45_), .c(new_n36_), .O(new_n60_));
  nand4  g027(.a(new_n38_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n61_));
  ...
  nor2   g036(.a(x20), .b(x09), .O(new_n70_));
  inv1   g037(.a(new_n70_), .O(new_n71_));
  oai21  g038(.a(new_n69_), .b(new_n52_), .c(new_n71_), .O(z1));
  ...
  nor2   g043(.a(new_n76_), .b(new_n52_), .O(z2));
  nand3  g044(.a(x15), .b(x13), .c(x05), .O(new_n78_));
  nand3  g045(.a(x21), .b(new_n43_), .c(new_n42_), .O(new_n79_));
  ...
  nand3  g051(.a(new_n43_), .b(new_n42_), .c(x00), .O(new_n85_));
  ...
  nand4  g056(.a(new_n89_), .b(new_n35_), .c(new_n34_), .d(new_n52_), .O(new_n90_));
  ...
  aoi22  g070(.a(new_n103_), .b(new_n96_), .c(new_n45_), .d(new_n36_), .O(new_n104_));
  ...
  nand4  g074(.a(new_n107_), .b(new_n97_), .c(new_n53_), .d(new_n35_), .O(new_n108_));
  ...
  inv1   g078(.a(new_n74_), .O(new_n112_));
  inv1   g079(.a(x16), .O(new_n113_));
  inv1   g080(.a(x23), .O(new_n114_));
  oai21  g081(.a(new_n114_), .b(x04), .c(x17), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(x22), .c(new_n100_), .O(new_n116_));
  oai21  g083(.a(new_n116_), .b(new_n113_), .c(x08), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n112_), .O(new_n118_));
  inv1   g085(.a(new_n48_), .O(new_n119_));
  nor2   g086(.a(new_n70_), .b(new_n53_), .O(new_n120_));
  inv1   g087(.a(x04), .O(new_n121_));
  inv1   g088(.a(x17), .O(new_n122_));
  oai21  g089(.a(x23), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n55_), .c(new_n53_), .O(new_n124_));
  aoi21  g091(.a(new_n124_), .b(new_n100_), .c(x16), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n120_), .c(new_n119_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n118_), .c(new_n71_), .O(z4));
  nor2   g094(.a(new_n70_), .b(new_n48_), .O(z5));
  nand2  g095(.a(x20), .b(new_n54_), .O(new_n129_));
  aoi21  g096(.a(new_n129_), .b(new_n35_), .c(x11), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(x03), .c(new_n119_), .O(new_n131_));
  nand2  g098(.a(new_n73_), .b(x14), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(x06), .c(new_n84_), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n34_), .c(new_n112_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n131_), .c(new_n71_), .O(z6));
  inv1   g102(.a(new_n58_), .O(new_n136_));
  and2   g103(.a(new_n60_), .b(new_n59_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n71_), .c(new_n61_), .d(new_n136_), .O(z7));
endmodule
