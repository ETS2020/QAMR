...
module FAU ( 
  ...
  nand3  g092(.a(new_n111_), .b(x20), .c(x15), .O(new_n126_));
  nand2  g093(.a(new_n87_), .b(new_n66_), .O(new_n127_));
  nand3  g094(.a(new_n92_), .b(new_n42_), .c(new_n41_), .O(new_n128_));
  ...
  nand4  g100(.a(new_n133_), .b(new_n111_), .c(x20), .d(x18), .O(new_n134_));
  inv1   g101(.a(x08), .O(new_n135_));
  nand4  g102(.a(new_n43_), .b(new_n42_), .c(new_n41_), .d(new_n135_), .O(new_n136_));
  inv1   g103(.a(new_n136_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n102_), .c(new_n66_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n134_), .c(new_n78_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n34_), .c(x24), .O(new_n140_));
  oai22  g107(.a(new_n136_), .b(new_n39_), .c(new_n125_), .d(new_n112_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n40_), .c(new_n34_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n140_), .c(new_n132_), .O(z3));
  inv1   g110(.a(x22), .O(new_n144_));
  inv1   g111(.a(x04), .O(new_n145_));
  inv1   g112(.a(x17), .O(new_n146_));
  oai21  g113(.a(x23), .b(new_n145_), .c(new_n146_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n144_), .c(x09), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n135_), .O(new_n149_));
  oai21  g116(.a(new_n48_), .b(new_n34_), .c(new_n49_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x05), .O(new_n151_));
  nand2  g118(.a(new_n54_), .b(x02), .O(new_n152_));
  nand3  g119(.a(new_n40_), .b(new_n34_), .c(x00), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n53_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n35_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n152_), .c(new_n151_), .O(z5));
  ...
  aoi21  g127(.a(new_n160_), .b(x22), .c(new_n85_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n158_), .c(x08), .O(new_n162_));
  inv1   g129(.a(x21), .O(new_n163_));
  nor2   g130(.a(new_n163_), .b(x10), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n34_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n119_), .c(new_n118_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n117_), .c(new_n162_), .O(new_n167_));
  nand2  g134(.a(x24), .b(new_n34_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n167_), .c(new_n157_), .O(z4));
  aoi21  g136(.a(x20), .b(new_n42_), .c(x06), .O(new_n170_));
  ...
  oai21  g140(.a(new_n173_), .b(new_n41_), .c(x03), .O(new_n174_));
  oai21  g141(.a(new_n115_), .b(new_n34_), .c(new_n116_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(x05), .O(new_n176_));
  nand2  g143(.a(new_n120_), .b(x02), .O(new_n177_));
  nand2  g144(.a(new_n165_), .b(new_n119_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n35_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n177_), .c(new_n176_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n174_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n172_), .O(z6));
  nor2   g149(.a(new_n120_), .b(new_n117_), .O(new_n183_));
  oai21  g150(.a(new_n164_), .b(x24), .c(new_n34_), .O(new_n184_));
