...
module FAU ( 
  ...
  nand4  g32(.a(new_n65_), .b(new_n58_), .c(new_n36_), .d(new_n57_), .O(new_n66_));
  ...
  oai21  g79(.a(x23), .b(new_n59_), .c(x22), .O(new_n113_));
  aoi21  g80(.a(new_n113_), .b(x09), .c(new_n53_), .O(new_n114_));
  oai21  g81(.a(new_n114_), .b(new_n83_), .c(new_n112_), .O(new_n115_));
  inv1   g82(.a(new_n49_), .O(new_n116_));
  nor2   g83(.a(new_n54_), .b(new_n83_), .O(new_n117_));
  inv1   g84(.a(x22), .O(new_n118_));
  aoi21  g85(.a(new_n118_), .b(x17), .c(x09), .O(new_n119_));
  nand4  g86(.a(new_n61_), .b(new_n118_), .c(new_n83_), .d(x04), .O(new_n120_));
  oai21  g87(.a(new_n119_), .b(x16), .c(new_n120_), .O(new_n121_));
  oai21  g88(.a(new_n121_), .b(new_n117_), .c(new_n116_), .O(new_n122_));
  nand3  g89(.a(new_n122_), .b(new_n115_), .c(new_n55_), .O(z4));
  nor2   g90(.a(new_n54_), .b(new_n49_), .O(z5));
  nand2  g91(.a(x20), .b(new_n71_), .O(new_n125_));
  aoi21  g92(.a(new_n125_), .b(new_n35_), .c(x11), .O(new_n126_));
  oai21  g93(.a(new_n126_), .b(x03), .c(new_n116_), .O(new_n127_));
  nand2  g94(.a(new_n60_), .b(x14), .O(new_n128_));
  aoi21  g95(.a(new_n128_), .b(x06), .c(new_n36_), .O(new_n129_));
  oai21  g96(.a(new_n129_), .b(new_n34_), .c(new_n112_), .O(new_n130_));
  aoi21  g97(.a(new_n130_), .b(new_n127_), .c(new_n54_), .O(z6));
  nor2   g98(.a(new_n79_), .b(new_n54_), .O(z7));
endmodule
