...
module FAU ( 
  ...
  nor2   g020(.a(new_n53_), .b(x10), .O(new_n54_));
  ...
  nand4  g055(.a(new_n88_), .b(new_n87_), .c(new_n53_), .d(new_n36_), .O(new_n89_));
  inv1   g056(.a(new_n89_), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n73_), .c(new_n37_), .d(new_n86_), .O(new_n91_));
  oai21  g058(.a(new_n91_), .b(new_n85_), .c(new_n83_), .O(new_n92_));
  nand3  g059(.a(new_n92_), .b(new_n76_), .c(x24), .O(new_n93_));
  nand4  g060(.a(new_n34_), .b(new_n44_), .c(new_n57_), .d(x00), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n84_), .c(new_n35_), .d(new_n58_), .O(new_n96_));
  nor2   g063(.a(x14), .b(x11), .O(new_n97_));
  nor2   g064(.a(x22), .b(x20), .O(new_n98_));
  nor2   g065(.a(x24), .b(x23), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n70_), .O(new_n100_));
  oai21  g067(.a(new_n100_), .b(new_n96_), .c(new_n53_), .O(new_n101_));
  nand2  g068(.a(new_n101_), .b(new_n45_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n93_), .c(new_n79_), .O(z1));
  ...
  nand3  g076(.a(new_n109_), .b(new_n40_), .c(x21), .O(new_n110_));
  ...
  oai21  g081(.a(new_n114_), .b(new_n57_), .c(new_n55_), .O(z2));
  ...
  nand4  g094(.a(new_n127_), .b(new_n35_), .c(new_n34_), .d(new_n57_), .O(new_n128_));
  ...
  nand4  g099(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n57_), .O(new_n133_));
  nand4  g100(.a(new_n37_), .b(new_n87_), .c(new_n36_), .d(new_n116_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n131_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n76_), .c(x24), .O(new_n136_));
  nand4  g103(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n137_));
  nand3  g104(.a(new_n67_), .b(new_n34_), .c(new_n57_), .O(new_n138_));
  nand2  g105(.a(new_n97_), .b(new_n72_), .O(new_n139_));
  ...
  nand3  g108(.a(new_n141_), .b(new_n136_), .c(new_n55_), .O(new_n142_));
  ...
  oai21  g115(.a(x23), .b(new_n58_), .c(new_n86_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n148_), .c(x09), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x16), .c(new_n116_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  or2    g119(.a(new_n111_), .b(new_n106_), .O(new_n153_));
  ...
  nand3  g125(.a(new_n158_), .b(new_n152_), .c(new_n55_), .O(z4));
  nand3  g126(.a(new_n40_), .b(new_n44_), .c(x00), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n53_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n45_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n48_), .c(new_n43_), .d(new_n145_), .O(z5));
  nand2  g130(.a(x20), .b(new_n87_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n35_), .c(x11), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x03), .c(new_n147_), .O(new_n166_));
  oai21  g133(.a(x20), .b(new_n87_), .c(x06), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(x11), .c(x03), .O(new_n168_));
  oai21  g135(.a(x12), .b(x03), .c(new_n168_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n153_), .O(new_n170_));
  nand2  g137(.a(new_n108_), .b(new_n107_), .O(new_n171_));
  nor2   g138(.a(new_n171_), .b(new_n106_), .O(new_n172_));
  nor2   g139(.a(new_n172_), .b(new_n45_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n34_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n170_), .c(new_n166_), .d(new_n55_), .O(z6));
  nand4  g142(.a(new_n109_), .b(new_n40_), .c(x21), .d(new_n53_), .O(new_n176_));
  oai21  g143(.a(new_n172_), .b(new_n54_), .c(new_n176_), .O(z7));
endmodule
