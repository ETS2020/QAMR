...
module FAU ( 
  ...
  oai21  g113(.a(new_n146_), .b(new_n42_), .c(new_n53_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n46_), .O(z5));
  nand2  g115(.a(z5), .b(new_n145_), .O(new_n149_));
  ...
  nand3  g120(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n53_), .O(new_n155_));
  nand4  g122(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n155_), .O(z7));
  nand2  g124(.a(z7), .b(new_n153_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n149_), .O(z4));
  aoi21  g126(.a(x20), .b(new_n74_), .c(x06), .O(new_n160_));
