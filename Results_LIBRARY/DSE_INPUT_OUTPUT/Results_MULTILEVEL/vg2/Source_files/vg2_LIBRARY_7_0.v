...
module FAU ( 
  ...
  nand3  g077(.a(x15), .b(new_n79_), .c(new_n44_), .O(new_n111_));
  oai21  g078(.a(new_n108_), .b(new_n79_), .c(new_n111_), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(new_n110_), .c(x20), .O(new_n113_));
  nor2   g080(.a(x24), .b(new_n102_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(new_n70_), .c(new_n97_), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(new_n113_), .c(new_n37_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x11), .c(x06), .d(x03), .O(new_n117_));
  nand2  g084(.a(new_n38_), .b(new_n70_), .O(new_n118_));
  oai21  g085(.a(new_n117_), .b(new_n107_), .c(new_n118_), .O(z2));
  ...
  nand3  g089(.a(new_n67_), .b(new_n57_), .c(new_n35_), .O(new_n123_));
  nand3  g090(.a(new_n75_), .b(new_n71_), .c(new_n37_), .O(new_n124_));
  ...
  nand3  g094(.a(new_n67_), .b(x07), .c(new_n35_), .O(new_n128_));
  nor2   g095(.a(x20), .b(x14), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n36_), .c(x10), .d(new_n57_), .O(new_n130_));
  ...
  nand2  g099(.a(new_n58_), .b(x03), .O(new_n133_));
  nor3   g100(.a(new_n133_), .b(x02), .c(new_n107_), .O(new_n134_));
  nand2  g101(.a(new_n114_), .b(x20), .O(new_n135_));
  inv1   g102(.a(new_n135_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n134_), .c(new_n121_), .d(new_n70_), .O(new_n137_));
  ...
  nand2  g110(.a(new_n118_), .b(new_n50_), .O(new_n144_));
  nor2   g111(.a(x24), .b(new_n38_), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n70_), .c(new_n97_), .d(x00), .O(new_n146_));
  ...
  oai21  g120(.a(new_n112_), .b(new_n110_), .c(new_n118_), .O(new_n154_));
  nand3  g121(.a(new_n136_), .b(new_n70_), .c(new_n97_), .O(new_n155_));
  ...
  nor2   g128(.a(new_n38_), .b(x14), .O(new_n162_));
  aoi22  g129(.a(new_n162_), .b(new_n36_), .c(new_n161_), .d(new_n118_), .O(new_n163_));
  nor2   g130(.a(new_n163_), .b(new_n47_), .O(new_n164_));
  nand3  g131(.a(new_n38_), .b(x15), .c(x14), .O(new_n165_));
  nor3   g132(.a(new_n165_), .b(new_n36_), .c(new_n70_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n164_), .c(new_n82_), .O(new_n167_));
  inv1   g134(.a(x07), .O(new_n168_));
  nor2   g135(.a(new_n36_), .b(new_n70_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n38_), .c(x18), .d(x14), .O(new_n170_));
  oai21  g137(.a(new_n163_), .b(new_n168_), .c(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n80_), .c(x24), .O(new_n172_));
  oai21  g139(.a(new_n37_), .b(x06), .c(new_n36_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n34_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n40_), .c(x20), .d(new_n70_), .O(new_n175_));
  inv1   g142(.a(new_n175_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n97_), .c(x00), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n172_), .c(new_n167_), .d(new_n160_), .O(z6));
  inv1   g145(.a(new_n110_), .O(new_n179_));
  nand2  g146(.a(new_n114_), .b(new_n97_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(x20), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(new_n70_), .c(new_n112_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n179_), .O(z7));
endmodule
