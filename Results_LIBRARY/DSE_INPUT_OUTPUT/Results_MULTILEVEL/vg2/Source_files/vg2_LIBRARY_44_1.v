...
module FAU ( 
  ...
  nand2  g084(.a(x02), .b(new_n56_), .O(new_n118_));
  oai21  g085(.a(new_n117_), .b(new_n56_), .c(new_n118_), .O(z2));
  ...
  nand4  g089(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n56_), .O(new_n123_));
  nand4  g090(.a(new_n74_), .b(new_n38_), .c(new_n37_), .d(new_n67_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n120_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n81_), .O(new_n126_));
  nand2  g093(.a(new_n121_), .b(new_n86_), .O(new_n127_));
  nor2   g094(.a(x20), .b(x14), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n37_), .c(new_n67_), .d(x07), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n123_), .c(new_n127_), .d(new_n120_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n79_), .c(x24), .O(new_n131_));
  nand4  g098(.a(new_n36_), .b(new_n35_), .c(new_n56_), .d(x00), .O(new_n132_));
  nand3  g099(.a(new_n128_), .b(new_n37_), .c(new_n67_), .O(new_n133_));
  nand2  g100(.a(new_n121_), .b(new_n97_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n120_), .c(new_n133_), .d(new_n132_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n41_), .c(new_n96_), .d(new_n34_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n131_), .c(new_n126_), .O(z3));
  nand2  g104(.a(new_n118_), .b(x08), .O(new_n138_));
  ...
  nand3  g109(.a(new_n142_), .b(new_n139_), .c(new_n67_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n138_), .c(new_n40_), .O(new_n144_));
  inv1   g111(.a(x17), .O(new_n145_));
  aoi21  g112(.a(x23), .b(new_n57_), .c(new_n145_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n61_), .c(x09), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(x16), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x08), .c(new_n85_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n144_), .c(new_n79_), .O(new_n150_));
  nand4  g117(.a(new_n49_), .b(x08), .c(new_n46_), .d(x01), .O(new_n151_));
  ...
  aoi22  g121(.a(new_n154_), .b(new_n111_), .c(new_n148_), .d(x08), .O(new_n155_));
  nand2  g122(.a(x24), .b(x08), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n78_), .c(new_n46_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n80_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x19), .O(new_n159_));
  nand3  g126(.a(new_n47_), .b(new_n34_), .c(x00), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n142_), .c(new_n139_), .O(new_n162_));
  nand2  g129(.a(x13), .b(x05), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n79_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n41_), .c(x19), .O(new_n165_));
  oai21  g132(.a(new_n50_), .b(x02), .c(new_n165_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(x08), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n162_), .c(new_n118_), .O(new_n168_));
  nor2   g135(.a(new_n168_), .b(new_n155_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n153_), .O(z4));
  nand2  g137(.a(new_n49_), .b(new_n46_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n45_), .c(new_n44_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n118_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n160_), .O(z5));
  inv1   g141(.a(new_n44_), .O(new_n175_));
  nand2  g142(.a(x20), .b(new_n38_), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(new_n36_), .c(x11), .O(new_n177_));
  nand3  g144(.a(new_n160_), .b(new_n171_), .c(new_n45_), .O(new_n178_));
  oai22  g145(.a(new_n178_), .b(new_n175_), .c(new_n177_), .d(x03), .O(new_n179_));
  nand2  g146(.a(new_n39_), .b(x14), .O(new_n180_));
  aoi21  g147(.a(new_n180_), .b(x06), .c(new_n37_), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(new_n35_), .c(new_n114_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n179_), .c(new_n118_), .O(z6));
  nand4  g150(.a(new_n118_), .b(new_n113_), .c(new_n109_), .d(new_n108_), .O(z7));
endmodule
