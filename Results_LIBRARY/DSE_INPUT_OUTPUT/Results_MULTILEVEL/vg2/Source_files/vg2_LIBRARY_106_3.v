...
module FAU ( 
  ...
  nand4  g046(.a(new_n79_), .b(new_n78_), .c(new_n60_), .d(new_n56_), .O(new_n80_));
  nor2   g047(.a(x09), .b(x08), .O(new_n81_));
  nand4  g048(.a(new_n81_), .b(new_n63_), .c(x07), .d(new_n34_), .O(new_n82_));
  ...
  and2   g055(.a(x21), .b(x20), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n78_), .c(new_n60_), .d(new_n56_), .O(new_n90_));
  nor2   g057(.a(x03), .b(x01), .O(new_n91_));
  nor2   g058(.a(x06), .b(x04), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n91_), .c(new_n81_), .d(x00), .O(new_n93_));
  oai21  g060(.a(new_n93_), .b(new_n86_), .c(new_n90_), .O(new_n94_));
  nand3  g061(.a(new_n94_), .b(new_n40_), .c(new_n49_), .O(new_n95_));
  nand3  g062(.a(new_n95_), .b(new_n88_), .c(new_n76_), .O(new_n96_));
  nand2  g063(.a(new_n96_), .b(new_n48_), .O(new_n97_));
  and2   g064(.a(new_n88_), .b(new_n76_), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(x00), .c(new_n97_), .O(z1));
  inv1   g066(.a(x01), .O(new_n100_));
  inv1   g067(.a(x03), .O(new_n101_));
  ...
  oai21  g075(.a(new_n108_), .b(new_n105_), .c(new_n37_), .O(new_n109_));
  ...
  nor3   g079(.a(new_n112_), .b(new_n101_), .c(new_n100_), .O(z2));
  nand2  g080(.a(new_n91_), .b(new_n64_), .O(new_n114_));
  nor2   g081(.a(x11), .b(x10), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n40_), .c(new_n102_), .d(new_n36_), .O(new_n116_));
  oai21  g083(.a(new_n116_), .b(new_n114_), .c(new_n48_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(x00), .O(new_n118_));
  ...
  oai22  g089(.a(new_n122_), .b(new_n114_), .c(new_n121_), .d(new_n119_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n75_), .O(new_n124_));
  nand2  g091(.a(new_n120_), .b(new_n79_), .O(new_n125_));
  nand3  g092(.a(new_n91_), .b(x07), .c(new_n34_), .O(new_n126_));
  inv1   g093(.a(x08), .O(new_n127_));
  nand4  g094(.a(new_n102_), .b(new_n36_), .c(new_n35_), .d(new_n127_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n126_), .c(new_n125_), .d(new_n119_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n73_), .c(x24), .O(new_n130_));
  nand3  g097(.a(x08), .b(x06), .c(x03), .O(new_n131_));
  nor3   g098(.a(new_n131_), .b(x02), .c(new_n100_), .O(new_n132_));
  nand3  g099(.a(new_n40_), .b(x21), .c(x20), .O(new_n133_));
  inv1   g100(.a(new_n133_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n132_), .c(new_n120_), .d(new_n49_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n130_), .c(new_n124_), .d(new_n118_), .O(z3));
  ...
  nand3  g108(.a(new_n141_), .b(new_n138_), .c(new_n127_), .O(new_n142_));
  oai21  g109(.a(new_n137_), .b(new_n127_), .c(new_n142_), .O(new_n143_));
  oai21  g110(.a(new_n46_), .b(new_n42_), .c(new_n143_), .O(new_n144_));
  nand3  g111(.a(x15), .b(x13), .c(x05), .O(new_n145_));
  nand3  g112(.a(x21), .b(new_n49_), .c(new_n48_), .O(new_n146_));
  ...
  nand2  g118(.a(x08), .b(new_n48_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n142_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n49_), .c(x00), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n40_), .O(new_n156_));
  nand3  g123(.a(new_n73_), .b(x24), .c(x18), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n107_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n150_), .c(new_n137_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n156_), .c(new_n144_), .O(z4));
  nand2  g127(.a(new_n50_), .b(new_n47_), .O(z5));
  aoi21  g128(.a(x20), .b(new_n36_), .c(x06), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x11), .c(new_n101_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(z5), .O(new_n164_));
  nand2  g131(.a(new_n110_), .b(new_n109_), .O(new_n165_));
  aoi21  g132(.a(new_n102_), .b(x14), .c(new_n34_), .O(new_n166_));
  ...
  inv1   g136(.a(new_n105_), .O(new_n170_));
  and2   g137(.a(new_n110_), .b(new_n107_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n106_), .c(new_n170_), .d(new_n37_), .O(z7));
endmodule
