...
module FAU ( 
  ...
  nor2   g075(.a(x24), .b(new_n99_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n96_), .c(new_n93_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n108_), .c(new_n107_), .O(new_n111_));
  oai21  g078(.a(new_n111_), .b(new_n106_), .c(x20), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(new_n37_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(x11), .c(x06), .d(x03), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(new_n63_), .O(z2));
  nand3  g082(.a(new_n56_), .b(x03), .c(x01), .O(new_n116_));
  nor2   g083(.a(new_n37_), .b(new_n36_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(x20), .c(x15), .O(new_n118_));
  nand4  g085(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n63_), .O(new_n119_));
  nand4  g086(.a(new_n72_), .b(new_n37_), .c(new_n36_), .d(new_n55_), .O(new_n120_));
  ...
  nand4  g091(.a(new_n124_), .b(new_n36_), .c(new_n55_), .d(x07), .O(new_n125_));
  ...
  nor2   g094(.a(x02), .b(new_n63_), .O(new_n128_));
  nand2  g095(.a(new_n117_), .b(new_n96_), .O(new_n129_));
  nand2  g096(.a(new_n109_), .b(x20), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n128_), .c(new_n56_), .d(x03), .O(new_n132_));
  ...
  oai21  g106(.a(new_n55_), .b(new_n34_), .c(new_n139_), .O(new_n140_));
  nor2   g107(.a(x24), .b(x10), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n93_), .c(x00), .O(new_n142_));
  ...
  nand2  g124(.a(new_n157_), .b(new_n93_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n155_), .c(new_n151_), .d(new_n144_), .O(z4));
  inv1   g126(.a(new_n48_), .O(new_n160_));
  nor2   g127(.a(x03), .b(x02), .O(new_n161_));
  nand4  g128(.a(new_n141_), .b(x03), .c(new_n93_), .d(x00), .O(new_n162_));
  oai21  g129(.a(new_n161_), .b(new_n160_), .c(new_n162_), .O(z5));
  oai21  g130(.a(x20), .b(new_n37_), .c(x06), .O(new_n164_));
  oai21  g131(.a(new_n111_), .b(new_n106_), .c(new_n164_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n36_), .c(new_n160_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(x03), .O(new_n167_));
  nand2  g134(.a(new_n141_), .b(x00), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x03), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n93_), .O(new_n170_));
  oai21  g137(.a(new_n38_), .b(x14), .c(new_n35_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(x19), .c(new_n36_), .O(new_n172_));
  nand3  g139(.a(x15), .b(new_n34_), .c(x02), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n78_), .O(new_n175_));
  nand3  g142(.a(new_n171_), .b(new_n36_), .c(x07), .O(new_n176_));
  ...
  nand4  g146(.a(new_n179_), .b(new_n175_), .c(new_n170_), .d(new_n167_), .O(z6));
  nand2  g147(.a(new_n108_), .b(new_n107_), .O(new_n181_));
  oai22  g148(.a(new_n181_), .b(new_n106_), .c(x03), .d(x02), .O(new_n182_));
  nand4  g149(.a(new_n109_), .b(new_n96_), .c(x03), .d(new_n93_), .O(new_n183_));
