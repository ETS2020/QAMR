...
module FAU ( 
  ...
  nand4  g060(.a(new_n93_), .b(new_n73_), .c(new_n37_), .d(new_n59_), .O(new_n94_));
  ...
  nand3  g065(.a(new_n98_), .b(new_n34_), .c(new_n44_), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  nand3  g067(.a(new_n45_), .b(new_n65_), .c(new_n85_), .O(new_n101_));
  ...
  aoi21  g080(.a(new_n110_), .b(x05), .c(new_n113_), .O(new_n114_));
  nor3   g081(.a(new_n114_), .b(new_n37_), .c(new_n90_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x11), .c(x06), .d(x03), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(x02), .c(new_n107_), .O(z2));
  ...
  nand2  g088(.a(new_n34_), .b(new_n107_), .O(new_n122_));
  inv1   g089(.a(new_n122_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n67_), .O(new_n124_));
  nand3  g091(.a(new_n72_), .b(new_n90_), .c(new_n36_), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n121_), .c(new_n78_), .O(new_n127_));
  inv1   g094(.a(new_n119_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n83_), .c(x14), .O(new_n129_));
  nor2   g096(.a(x11), .b(x08), .O(new_n130_));
  nor2   g097(.a(x20), .b(x14), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n130_), .c(new_n123_), .d(new_n87_), .O(new_n132_));
  oai21  g099(.a(new_n129_), .b(new_n118_), .c(new_n132_), .O(new_n133_));
  ...
  nand4  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n98_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n134_), .c(new_n127_), .O(z3));
  aoi21  g106(.a(new_n62_), .b(x04), .c(x17), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x22), .c(new_n65_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n91_), .c(new_n85_), .O(new_n142_));
  oai21  g109(.a(new_n85_), .b(x01), .c(new_n142_), .O(new_n143_));
  oai21  g110(.a(new_n49_), .b(new_n42_), .c(new_n143_), .O(new_n144_));
  oai21  g111(.a(new_n62_), .b(x04), .c(x17), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x22), .c(new_n65_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n91_), .c(x08), .O(new_n147_));
  ...
  nand4  g122(.a(new_n147_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n156_));
  ...
  nor2   g126(.a(x02), .b(new_n107_), .O(new_n160_));
  nand2  g127(.a(new_n48_), .b(new_n43_), .O(new_n161_));
  nor2   g128(.a(new_n161_), .b(new_n42_), .O(new_n162_));
  nand4  g129(.a(new_n98_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n163_));
  oai21  g130(.a(new_n162_), .b(new_n160_), .c(new_n163_), .O(z5));
  aoi21  g131(.a(x20), .b(new_n90_), .c(x06), .O(new_n165_));
  ...
  nand3  g136(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n170_));
  inv1   g137(.a(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n44_), .c(new_n107_), .O(new_n172_));
  oai21  g139(.a(new_n160_), .b(new_n114_), .c(new_n172_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n169_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n167_), .O(z6));
  oai21  g142(.a(new_n171_), .b(x01), .c(new_n44_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n114_), .O(z7));
endmodule
