...
module FAU ( 
  ...
  nand3  g061(.a(new_n94_), .b(new_n73_), .c(new_n71_), .O(new_n95_));
  inv1   g062(.a(x08), .O(new_n96_));
  inv1   g063(.a(x07), .O(new_n97_));
  nor2   g064(.a(new_n97_), .b(x06), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n79_), .c(new_n78_), .d(new_n96_), .O(new_n99_));
  nand3  g066(.a(new_n85_), .b(new_n65_), .c(new_n64_), .O(new_n100_));
  oai21  g067(.a(new_n100_), .b(new_n99_), .c(new_n95_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n88_), .c(x24), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n91_), .c(new_n69_), .O(z1));
  ...
  nand3  g080(.a(new_n56_), .b(new_n35_), .c(new_n34_), .O(new_n114_));
  nor2   g081(.a(x10), .b(x08), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n40_), .c(new_n37_), .d(new_n36_), .O(new_n116_));
  oai21  g083(.a(new_n116_), .b(new_n114_), .c(new_n54_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n44_), .O(new_n118_));
  nand4  g085(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n119_));
  nor2   g086(.a(new_n54_), .b(new_n36_), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(x20), .c(x15), .O(new_n121_));
  inv1   g088(.a(x01), .O(new_n122_));
  nand3  g089(.a(new_n58_), .b(new_n34_), .c(new_n122_), .O(new_n123_));
  nand3  g090(.a(new_n84_), .b(new_n54_), .c(new_n36_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n121_), .d(new_n119_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n90_), .O(new_n126_));
  nand3  g093(.a(new_n120_), .b(x20), .c(x18), .O(new_n127_));
  nand3  g094(.a(new_n98_), .b(new_n34_), .c(new_n122_), .O(new_n128_));
  nand4  g095(.a(new_n37_), .b(new_n54_), .c(new_n36_), .d(new_n96_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n119_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n88_), .c(x24), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n126_), .c(new_n118_), .O(z3));
  ...
  oai21  g104(.a(new_n137_), .b(x16), .c(new_n96_), .O(new_n138_));
  nor2   g105(.a(new_n54_), .b(x02), .O(new_n139_));
  nand2  g106(.a(new_n48_), .b(new_n43_), .O(new_n140_));
  nor2   g107(.a(new_n140_), .b(new_n42_), .O(new_n141_));
  nor2   g108(.a(x24), .b(x14), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n45_), .c(new_n44_), .d(x00), .O(new_n143_));
  ...
  aoi21  g114(.a(new_n147_), .b(x22), .c(new_n78_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n62_), .c(x08), .O(new_n149_));
  nor2   g116(.a(new_n109_), .b(new_n106_), .O(new_n150_));
  inv1   g117(.a(x21), .O(new_n151_));
  nor2   g118(.a(x24), .b(new_n151_), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n54_), .c(new_n45_), .d(new_n44_), .O(new_n153_));
  oai21  g120(.a(new_n139_), .b(new_n150_), .c(new_n153_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n149_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n145_), .O(z4));
  nand3  g123(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n54_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n44_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n141_), .O(z5));
  oai21  g127(.a(new_n36_), .b(x06), .c(x03), .O(new_n161_));
  nand3  g128(.a(new_n152_), .b(new_n45_), .c(new_n44_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n108_), .c(new_n107_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n106_), .c(new_n161_), .O(new_n164_));
  oai21  g131(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n36_), .c(x03), .O(new_n166_));
  nand3  g133(.a(new_n120_), .b(new_n37_), .c(x15), .O(new_n167_));
  oai21  g134(.a(new_n166_), .b(new_n83_), .c(new_n167_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n90_), .O(new_n169_));
  nand3  g136(.a(new_n120_), .b(new_n37_), .c(x18), .O(new_n170_));
  oai21  g137(.a(new_n166_), .b(new_n97_), .c(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n88_), .c(x24), .O(new_n172_));
  nor2   g139(.a(x20), .b(x06), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x11), .c(new_n34_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n40_), .c(new_n45_), .d(x00), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n54_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n44_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n172_), .c(new_n169_), .d(new_n164_), .O(z6));
  aoi21  g145(.a(new_n152_), .b(new_n45_), .c(x14), .O(new_n179_));
  oai21  g146(.a(new_n179_), .b(x02), .c(new_n150_), .O(z7));
endmodule
