...
module FAU ( 
  ...
  aoi21  g062(.a(new_n95_), .b(new_n94_), .c(new_n45_), .O(new_n96_));
  nand3  g063(.a(x15), .b(new_n75_), .c(new_n45_), .O(new_n97_));
  oai21  g064(.a(new_n94_), .b(new_n75_), .c(new_n97_), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(new_n96_), .c(x20), .O(new_n99_));
  nor2   g066(.a(new_n99_), .b(new_n37_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(x11), .c(x06), .d(x03), .O(new_n101_));
  oai21  g068(.a(new_n101_), .b(new_n93_), .c(new_n39_), .O(z2));
  nand4  g069(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n103_));
  nand4  g070(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n104_));
  nand3  g071(.a(new_n67_), .b(new_n34_), .c(new_n93_), .O(new_n105_));
  nand3  g072(.a(new_n71_), .b(new_n37_), .c(new_n36_), .O(new_n106_));
  oai22  g073(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n103_), .O(new_n107_));
  nand2  g074(.a(new_n107_), .b(new_n78_), .O(new_n108_));
  nand4  g075(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n109_));
  nand4  g076(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n93_), .O(new_n110_));
  inv1   g077(.a(x08), .O(new_n111_));
  nand4  g078(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n111_), .O(new_n112_));
  oai22  g079(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n103_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n76_), .c(x24), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n108_), .c(new_n56_), .O(z3));
  ...
  oai21  g087(.a(new_n120_), .b(x16), .c(new_n111_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n51_), .O(new_n122_));
  inv1   g089(.a(new_n96_), .O(new_n123_));
  inv1   g090(.a(new_n98_), .O(new_n124_));
  ...
  oai21  g096(.a(new_n129_), .b(new_n126_), .c(x08), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n125_), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(new_n122_), .c(new_n56_), .O(z4));
  ...
  aoi21  g108(.a(new_n124_), .b(new_n123_), .c(new_n56_), .O(z7));
endmodule
