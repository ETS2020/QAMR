...
module FAU ( 
  ...
  nand2  g067(.a(x14), .b(x02), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n100_), .c(new_n91_), .d(new_n79_), .O(z1));
  ...
  aoi21  g080(.a(new_n113_), .b(new_n44_), .c(new_n103_), .O(z2));
  nand4  g081(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n115_));
  nor2   g082(.a(new_n103_), .b(new_n36_), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(x20), .c(x15), .O(new_n117_));
  nand3  g084(.a(new_n67_), .b(new_n34_), .c(new_n95_), .O(new_n118_));
  nand3  g085(.a(new_n72_), .b(new_n103_), .c(new_n36_), .O(new_n119_));
  ...
  oai22  g093(.a(new_n126_), .b(new_n123_), .c(new_n122_), .d(new_n115_), .O(new_n127_));
  ...
  oai22  g097(.a(new_n130_), .b(new_n115_), .c(new_n129_), .d(new_n96_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n40_), .c(new_n45_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n128_), .c(new_n121_), .d(new_n101_), .O(z3));
  oai21  g100(.a(x23), .b(new_n94_), .c(new_n59_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n61_), .c(x09), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x16), .c(new_n124_), .O(new_n136_));
  nand2  g103(.a(new_n48_), .b(new_n43_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n42_), .c(new_n101_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n46_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  inv1   g107(.a(x16), .O(new_n141_));
  oai21  g108(.a(new_n62_), .b(x04), .c(x17), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(x22), .c(new_n65_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n141_), .c(x08), .O(new_n144_));
  nand2  g111(.a(new_n108_), .b(new_n107_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n106_), .c(new_n101_), .O(new_n146_));
  nand4  g113(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n147_));
  ...
  and2   g118(.a(new_n101_), .b(new_n48_), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n46_), .c(new_n43_), .d(new_n151_), .O(z5));
  nand2  g120(.a(x20), .b(new_n103_), .O(new_n154_));
  ...
  nand3  g124(.a(new_n147_), .b(new_n108_), .c(new_n107_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n106_), .c(new_n157_), .O(new_n159_));
  nand3  g126(.a(new_n116_), .b(new_n37_), .c(x15), .O(new_n160_));
  nand2  g127(.a(new_n36_), .b(x02), .O(new_n161_));
  nand3  g128(.a(new_n40_), .b(x20), .c(x19), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n161_), .c(new_n160_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n47_), .c(new_n38_), .O(new_n164_));
  nand3  g131(.a(x13), .b(new_n36_), .c(x05), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n162_), .c(new_n103_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(x02), .O(new_n167_));
  nand2  g134(.a(new_n105_), .b(new_n104_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x05), .O(new_n169_));
  nand3  g136(.a(new_n109_), .b(new_n107_), .c(new_n169_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n37_), .c(x14), .d(x11), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n167_), .c(new_n164_), .O(new_n172_));
  inv1   g139(.a(new_n172_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n159_), .c(new_n156_), .O(z6));
  inv1   g141(.a(new_n145_), .O(new_n175_));
  nand3  g142(.a(new_n37_), .b(x14), .c(x11), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(x02), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n175_), .c(new_n169_), .d(new_n101_), .O(z7));
endmodule
