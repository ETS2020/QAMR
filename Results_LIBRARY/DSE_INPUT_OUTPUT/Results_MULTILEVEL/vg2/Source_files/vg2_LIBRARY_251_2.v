...
module FAU ( 
  ...
  nand4  g044(.a(new_n77_), .b(new_n57_), .c(new_n37_), .d(new_n69_), .O(new_n78_));
  nor2   g045(.a(new_n78_), .b(x08), .O(new_n79_));
  nand4  g046(.a(new_n79_), .b(new_n36_), .c(new_n68_), .d(new_n35_), .O(new_n80_));
  nand2  g047(.a(new_n80_), .b(new_n67_), .O(new_n81_));
  nand2  g048(.a(new_n81_), .b(new_n39_), .O(new_n82_));
  nand2  g049(.a(new_n48_), .b(new_n47_), .O(new_n83_));
  nor2   g050(.a(new_n68_), .b(new_n34_), .O(new_n84_));
  ...
  nor4   g055(.a(new_n88_), .b(new_n87_), .c(new_n58_), .d(new_n57_), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n86_), .c(new_n84_), .d(x01), .O(new_n90_));
  inv1   g057(.a(x08), .O(new_n91_));
  nor3   g058(.a(x06), .b(x04), .c(x01), .O(new_n92_));
  nor2   g059(.a(x11), .b(x09), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(x07), .O(new_n94_));
  nor3   g061(.a(x16), .b(x14), .c(x12), .O(new_n95_));
  nor2   g062(.a(x23), .b(x22), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n95_), .c(new_n71_), .d(new_n70_), .O(new_n97_));
  oai21  g064(.a(new_n97_), .b(new_n94_), .c(new_n90_), .O(new_n98_));
  nand3  g065(.a(new_n98_), .b(new_n83_), .c(x24), .O(new_n99_));
  nand4  g066(.a(new_n86_), .b(new_n47_), .c(x04), .d(x01), .O(new_n100_));
  nor2   g067(.a(x13), .b(new_n57_), .O(new_n101_));
  nand4  g068(.a(x23), .b(x22), .c(x17), .d(x16), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n101_), .c(x15), .d(x14), .O(new_n104_));
  oai21  g071(.a(new_n104_), .b(new_n100_), .c(x20), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(x03), .O(new_n106_));
  nand4  g073(.a(new_n36_), .b(new_n47_), .c(new_n68_), .d(new_n35_), .O(new_n107_));
  nand4  g074(.a(new_n57_), .b(new_n37_), .c(new_n69_), .d(new_n91_), .O(new_n108_));
  nor2   g075(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand4  g076(.a(new_n70_), .b(new_n87_), .c(new_n58_), .d(new_n48_), .O(new_n110_));
  nand3  g077(.a(new_n96_), .b(new_n71_), .c(x19), .O(new_n111_));
  nor2   g078(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n106_), .c(new_n99_), .O(new_n114_));
  ...
  nor2   g091(.a(new_n124_), .b(new_n58_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x11), .c(x06), .d(x01), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(x20), .c(new_n34_), .O(z2));
  ...
  nand4  g099(.a(new_n132_), .b(new_n71_), .c(new_n58_), .d(new_n37_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x08), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n36_), .c(new_n34_), .d(new_n35_), .O(new_n135_));
  ...
  nand4  g106(.a(x07), .b(new_n36_), .c(new_n34_), .d(new_n35_), .O(new_n140_));
  nand4  g107(.a(new_n71_), .b(new_n58_), .c(new_n37_), .d(new_n91_), .O(new_n141_));
  ...
  nand4  g111(.a(new_n91_), .b(new_n36_), .c(new_n34_), .d(new_n35_), .O(new_n145_));
  nand4  g112(.a(new_n71_), .b(x19), .c(new_n58_), .d(new_n37_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n138_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n48_), .c(new_n47_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n143_), .c(new_n137_), .O(z3));
  inv1   g116(.a(new_n124_), .O(new_n150_));
  oai21  g117(.a(new_n59_), .b(x04), .c(x17), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x22), .c(new_n69_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n87_), .c(x08), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nor2   g121(.a(x20), .b(new_n34_), .O(new_n155_));
  aoi21  g122(.a(new_n59_), .b(x04), .c(x17), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x22), .c(new_n69_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n87_), .c(new_n91_), .O(new_n158_));
  oai21  g125(.a(new_n155_), .b(new_n91_), .c(new_n158_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n52_), .c(new_n155_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n154_), .O(z4));
  nor2   g128(.a(new_n155_), .b(new_n53_), .O(z5));
  nand2  g129(.a(x20), .b(x11), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x06), .c(x03), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n150_), .O(new_n165_));
  nand2  g132(.a(x06), .b(new_n34_), .O(new_n166_));
  nand2  g133(.a(x20), .b(new_n58_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n166_), .c(x11), .O(new_n168_));
  nor2   g135(.a(new_n71_), .b(new_n34_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n168_), .c(new_n52_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n165_), .O(z6));
  inv1   g138(.a(new_n119_), .O(new_n172_));
  inv1   g139(.a(new_n122_), .O(new_n173_));
  nor2   g140(.a(new_n155_), .b(new_n173_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n121_), .c(new_n120_), .d(new_n172_), .O(z7));
endmodule
