...
module FAU ( 
  ...
  nand3  g049(.a(new_n47_), .b(x13), .c(x05), .O(new_n83_));
  ...
  nand3  g071(.a(new_n47_), .b(new_n68_), .c(new_n67_), .O(new_n105_));
  ...
  nand3  g076(.a(new_n47_), .b(x15), .c(x13), .O(new_n110_));
  aoi21  g077(.a(new_n110_), .b(new_n109_), .c(new_n51_), .O(new_n111_));
  nand3  g078(.a(x15), .b(new_n52_), .c(new_n51_), .O(new_n112_));
  oai21  g079(.a(new_n109_), .b(new_n52_), .c(new_n112_), .O(new_n113_));
  nor2   g080(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nor3   g081(.a(new_n114_), .b(new_n65_), .c(new_n41_), .O(new_n115_));
  ...
  nand3  g091(.a(new_n78_), .b(new_n41_), .c(new_n40_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n84_), .O(new_n127_));
  nand3  g094(.a(new_n89_), .b(x14), .c(x11), .O(new_n128_));
  nand4  g095(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n129_));
  nand4  g096(.a(new_n65_), .b(new_n41_), .c(new_n40_), .d(new_n102_), .O(new_n130_));
  ...
  oai21  g101(.a(new_n134_), .b(x22), .c(new_n71_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n94_), .c(new_n102_), .O(new_n136_));
  oai21  g103(.a(new_n102_), .b(x01), .c(new_n136_), .O(new_n137_));
  nand2  g104(.a(new_n49_), .b(x05), .O(new_n138_));
  nor2   g105(.a(x24), .b(x10), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n34_), .c(x00), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n53_), .c(new_n50_), .d(new_n138_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n137_), .O(new_n142_));
  oai21  g109(.a(new_n68_), .b(x04), .c(x17), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(x22), .c(new_n71_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n94_), .c(x08), .O(new_n145_));
  ...
  nand3  g115(.a(new_n148_), .b(new_n82_), .c(x24), .O(new_n149_));
  ...
  nand2  g119(.a(new_n152_), .b(new_n84_), .O(new_n153_));
  nand4  g120(.a(new_n145_), .b(new_n47_), .c(x21), .d(new_n38_), .O(new_n154_));
  ...
  nand4  g125(.a(new_n139_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n159_));
  oai21  g126(.a(new_n158_), .b(new_n55_), .c(new_n159_), .O(z5));
  ...
  aoi21  g130(.a(new_n65_), .b(x14), .c(new_n37_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n40_), .c(x03), .O(new_n165_));
  nor2   g132(.a(x02), .b(x01), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n47_), .c(x21), .d(new_n38_), .O(new_n167_));
  oai21  g134(.a(new_n158_), .b(new_n114_), .c(new_n167_), .O(z7));
  nand2  g135(.a(z7), .b(new_n165_), .O(new_n169_));
