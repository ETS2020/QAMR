...
module FAU ( 
  ...
  nand3  g079(.a(x15), .b(new_n89_), .c(new_n44_), .O(new_n113_));
  inv1   g080(.a(x10), .O(new_n114_));
  nand4  g081(.a(new_n40_), .b(x21), .c(new_n114_), .d(new_n55_), .O(new_n115_));
  ...
  nor2   g086(.a(new_n119_), .b(new_n108_), .O(z2));
  nand3  g087(.a(new_n59_), .b(x03), .c(x01), .O(new_n121_));
  nor2   g088(.a(new_n37_), .b(new_n36_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(x20), .c(x15), .O(new_n123_));
  nand4  g090(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n108_), .O(new_n124_));
  nand4  g091(.a(new_n85_), .b(new_n37_), .c(new_n36_), .d(new_n58_), .O(new_n125_));
  ...
  nand4  g096(.a(new_n129_), .b(new_n36_), .c(new_n58_), .d(x07), .O(new_n130_));
  ...
  nor2   g099(.a(x02), .b(new_n108_), .O(new_n133_));
  nand2  g100(.a(new_n122_), .b(new_n114_), .O(new_n134_));
  inv1   g101(.a(x21), .O(new_n135_));
  nor2   g102(.a(x24), .b(new_n135_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(x20), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n133_), .c(new_n59_), .d(x03), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n132_), .c(new_n127_), .O(z3));
  inv1   g107(.a(x22), .O(new_n141_));
  oai21  g108(.a(x23), .b(new_n56_), .c(new_n100_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n141_), .c(x09), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n58_), .O(new_n144_));
  oai21  g111(.a(x02), .b(x01), .c(new_n50_), .O(new_n145_));
  nor2   g112(.a(x24), .b(x10), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n55_), .c(x01), .d(x00), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n145_), .O(z5));
  nand2  g115(.a(z5), .b(new_n144_), .O(new_n149_));
  oai21  g116(.a(new_n67_), .b(x04), .c(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n60_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n101_), .c(x08), .O(new_n152_));
  inv1   g119(.a(new_n133_), .O(new_n153_));
  nor2   g120(.a(x02), .b(x01), .O(new_n154_));
  nand2  g121(.a(new_n113_), .b(new_n112_), .O(new_n155_));
  nor2   g122(.a(new_n155_), .b(new_n111_), .O(new_n156_));
  nand2  g123(.a(new_n136_), .b(new_n114_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n153_), .c(new_n156_), .d(new_n154_), .O(new_n158_));
  ...
  nand2  g134(.a(new_n157_), .b(x01), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n55_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n156_), .O(z7));
endmodule
