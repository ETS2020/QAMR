...
module FAU ( 
  ...
  nand3  g075(.a(x15), .b(new_n78_), .c(new_n46_), .O(new_n109_));
  nand4  g076(.a(new_n41_), .b(x21), .c(new_n96_), .d(new_n34_), .O(new_n110_));
  ...
  nand2  g081(.a(x02), .b(new_n56_), .O(new_n115_));
  oai21  g082(.a(new_n114_), .b(new_n56_), .c(new_n115_), .O(z2));
  ...
  nand4  g114(.a(new_n49_), .b(x08), .c(new_n46_), .d(x01), .O(new_n148_));
  ...
  aoi22  g118(.a(new_n151_), .b(new_n110_), .c(new_n145_), .d(x08), .O(new_n152_));
  ...
  nand3  g131(.a(new_n164_), .b(new_n159_), .c(new_n115_), .O(new_n165_));
  ...
  aoi21  g138(.a(x20), .b(new_n38_), .c(x06), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(x11), .c(new_n35_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(z5), .O(new_n174_));
  aoi21  g141(.a(new_n39_), .b(x14), .c(new_n36_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n37_), .c(x03), .O(new_n176_));
  nand2  g143(.a(new_n109_), .b(new_n108_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n107_), .c(new_n115_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n110_), .O(z7));
  nand2  g146(.a(z7), .b(new_n176_), .O(new_n180_));
