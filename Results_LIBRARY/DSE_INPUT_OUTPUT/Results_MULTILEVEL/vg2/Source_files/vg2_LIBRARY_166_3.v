...
module FAU ( 
  ...
  nor4   g044(.a(new_n77_), .b(x22), .c(new_n58_), .d(new_n69_), .O(new_n78_));
  ...
  nand4  g063(.a(new_n58_), .b(new_n69_), .c(new_n36_), .d(new_n81_), .O(new_n97_));
  inv1   g064(.a(new_n97_), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n96_), .c(x07), .d(new_n35_), .O(new_n99_));
  nand4  g066(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n100_));
  inv1   g067(.a(new_n100_), .O(new_n101_));
  nor2   g068(.a(new_n69_), .b(new_n36_), .O(new_n102_));
  nor2   g069(.a(x22), .b(new_n58_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(x18), .O(new_n104_));
  aoi22  g071(.a(new_n104_), .b(new_n99_), .c(new_n46_), .d(new_n37_), .O(new_n105_));
  nand4  g072(.a(new_n58_), .b(x19), .c(new_n69_), .d(new_n36_), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n96_), .c(new_n81_), .d(new_n35_), .O(new_n108_));
  nand4  g075(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(x15), .O(new_n109_));
  aoi21  g076(.a(new_n109_), .b(new_n108_), .c(x13), .O(new_n110_));
  aoi22  g077(.a(new_n110_), .b(new_n37_), .c(new_n105_), .d(x24), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n95_), .O(z3));
  inv1   g079(.a(new_n49_), .O(new_n113_));
  aoi21  g080(.a(new_n56_), .b(x09), .c(x08), .O(new_n114_));
  ...
  nand3  g084(.a(new_n117_), .b(new_n115_), .c(new_n56_), .O(new_n118_));
  ...
  aoi21  g088(.a(x16), .b(new_n54_), .c(new_n81_), .O(new_n122_));
  oai21  g089(.a(new_n59_), .b(x04), .c(x17), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(x22), .c(x16), .d(new_n35_), .O(new_n124_));
  oai21  g091(.a(new_n122_), .b(new_n116_), .c(new_n124_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n121_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n120_), .O(z4));
  inv1   g094(.a(new_n41_), .O(new_n128_));
  inv1   g095(.a(new_n116_), .O(new_n129_));
  and2   g096(.a(new_n45_), .b(new_n42_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n129_), .c(new_n47_), .d(new_n128_), .O(z5));
  nand2  g098(.a(x20), .b(new_n69_), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(new_n35_), .c(x11), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(x03), .c(new_n113_), .O(new_n134_));
  nor2   g101(.a(new_n116_), .b(x03), .O(new_n135_));
  nand3  g102(.a(new_n58_), .b(x14), .c(x03), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(x06), .c(new_n36_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n135_), .c(new_n121_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n134_), .c(new_n129_), .O(z6));
  nor2   g106(.a(new_n116_), .b(new_n77_), .O(z7));
endmodule
