...
module FAU ( 
  ...
  inv1   g102(.a(new_n43_), .O(new_n136_));
  nand4  g103(.a(new_n41_), .b(new_n45_), .c(new_n34_), .d(x00), .O(new_n137_));
  and2   g104(.a(new_n137_), .b(new_n48_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n44_), .c(new_n136_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  inv1   g107(.a(new_n106_), .O(new_n141_));
  inv1   g108(.a(new_n110_), .O(new_n142_));
  ...
  nand2  g116(.a(x02), .b(new_n66_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n149_), .c(new_n140_), .O(z4));
  nand4  g118(.a(new_n150_), .b(new_n138_), .c(new_n44_), .d(new_n136_), .O(z5));
  nand2  g119(.a(x20), .b(new_n103_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n36_), .c(x11), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x03), .c(new_n139_), .O(new_n155_));
  nand2  g122(.a(new_n38_), .b(x14), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x06), .c(new_n37_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n35_), .c(new_n143_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n155_), .c(new_n150_), .O(z6));
  and2   g126(.a(new_n150_), .b(new_n107_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n109_), .c(new_n108_), .d(new_n141_), .O(z7));
endmodule
