...
module FAU ( 
  ...
  nand3  g088(.a(new_n86_), .b(new_n47_), .c(new_n35_), .O(new_n122_));
  nand4  g089(.a(new_n48_), .b(x19), .c(new_n42_), .d(new_n41_), .O(new_n123_));
  oai22  g090(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n120_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n93_), .O(new_n125_));
  nand4  g092(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n126_));
  nand4  g093(.a(x07), .b(new_n36_), .c(new_n47_), .d(new_n35_), .O(new_n127_));
  inv1   g094(.a(x08), .O(new_n128_));
  nand4  g095(.a(new_n48_), .b(new_n42_), .c(new_n41_), .d(new_n128_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n127_), .c(new_n126_), .d(new_n120_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n91_), .c(x24), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n125_), .c(new_n119_), .O(z3));
  inv1   g099(.a(x04), .O(new_n133_));
  oai21  g100(.a(x23), .b(new_n133_), .c(new_n69_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n66_), .c(x09), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x16), .c(new_n128_), .O(new_n136_));
  nor2   g103(.a(x24), .b(x10), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n34_), .c(x00), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n56_), .c(new_n54_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n53_), .c(new_n136_), .O(new_n140_));
  inv1   g107(.a(x23), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x04), .c(x17), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(x22), .c(new_n84_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n68_), .c(x08), .O(new_n144_));
  inv1   g111(.a(x21), .O(new_n145_));
  nor2   g112(.a(x24), .b(new_n145_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n37_), .c(new_n34_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n110_), .c(new_n109_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n108_), .c(new_n144_), .O(new_n149_));
  nor2   g116(.a(x02), .b(new_n35_), .O(new_n150_));
  inv1   g117(.a(new_n150_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n149_), .c(new_n140_), .O(z4));
  nor2   g119(.a(new_n57_), .b(new_n53_), .O(new_n153_));
  aoi21  g120(.a(new_n137_), .b(x00), .c(x01), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x02), .c(new_n153_), .O(z5));
  aoi21  g122(.a(x20), .b(new_n42_), .c(x06), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x11), .c(new_n47_), .O(new_n157_));
  nand4  g124(.a(new_n137_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n158_));
  oai21  g125(.a(new_n150_), .b(new_n153_), .c(new_n158_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  aoi21  g127(.a(new_n48_), .b(x14), .c(new_n36_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n41_), .c(x03), .O(new_n162_));
  oai21  g129(.a(new_n111_), .b(new_n108_), .c(new_n151_), .O(new_n163_));
  nand4  g130(.a(new_n146_), .b(new_n37_), .c(new_n34_), .d(new_n35_), .O(new_n164_));
