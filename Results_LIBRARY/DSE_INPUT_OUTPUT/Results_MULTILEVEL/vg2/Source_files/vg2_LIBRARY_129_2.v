...
module FAU ( 
  ...
  oai21  g107(.a(new_n140_), .b(x16), .c(new_n128_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n135_), .O(new_n142_));
  inv1   g109(.a(x23), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x04), .c(x17), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x22), .c(new_n79_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n63_), .c(x08), .O(new_n146_));
  nand4  g113(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n108_), .c(new_n107_), .d(new_n106_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g116(.a(new_n44_), .b(x01), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n149_), .c(new_n142_), .O(z4));
  nand3  g118(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n54_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n44_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n48_), .c(new_n43_), .d(new_n133_), .O(z5));
  nand2  g122(.a(x20), .b(new_n62_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n35_), .c(x11), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x03), .c(new_n135_), .O(new_n158_));
  nand2  g125(.a(new_n37_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n36_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n34_), .c(new_n148_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n150_), .O(z6));
  nand3  g129(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n54_), .c(x02), .O(new_n164_));
  or2    g131(.a(new_n164_), .b(new_n110_), .O(z7));
endmodule
