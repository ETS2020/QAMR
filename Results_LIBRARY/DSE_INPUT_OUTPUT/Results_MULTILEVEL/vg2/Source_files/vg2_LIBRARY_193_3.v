...
module FAU ( 
  ...
  nand3  g063(.a(new_n78_), .b(x21), .c(x20), .O(new_n97_));
  ...
  nand4  g083(.a(new_n40_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n117_));
  and2   g084(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  ...
  oai21  g089(.a(new_n122_), .b(new_n57_), .c(new_n37_), .O(z2));
  nand3  g090(.a(x15), .b(x13), .c(x05), .O(new_n124_));
  nand3  g091(.a(x21), .b(new_n49_), .c(new_n48_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x20), .c(x14), .d(x11), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n60_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(x06), .c(x03), .d(x01), .O(new_n129_));
  nand3  g096(.a(new_n49_), .b(new_n48_), .c(x00), .O(new_n130_));
  nand3  g097(.a(x19), .b(x13), .c(x05), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n65_), .c(new_n36_), .d(new_n35_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x08), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n34_), .c(new_n58_), .d(new_n57_), .O(new_n135_));
  ...
  nand3  g106(.a(new_n100_), .b(x07), .c(new_n34_), .O(new_n140_));
  nand4  g107(.a(new_n65_), .b(new_n36_), .c(new_n35_), .d(new_n60_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(new_n138_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n54_), .c(x24), .O(new_n143_));
  nand4  g110(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n144_));
  nand3  g111(.a(new_n100_), .b(new_n60_), .c(new_n34_), .O(new_n145_));
  nand4  g112(.a(new_n65_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n146_));
  ...
  nand4  g115(.a(new_n148_), .b(new_n143_), .c(new_n137_), .d(new_n37_), .O(z3));
  nand2  g116(.a(new_n50_), .b(new_n47_), .O(new_n150_));
  oai21  g117(.a(x23), .b(new_n59_), .c(new_n63_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n66_), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n60_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  oai21  g121(.a(new_n67_), .b(x04), .c(x17), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x22), .c(new_n61_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n62_), .c(x08), .O(new_n157_));
  nand2  g124(.a(new_n116_), .b(new_n115_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n114_), .c(new_n37_), .O(new_n159_));
  ...
  and2   g130(.a(new_n50_), .b(new_n45_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n43_), .c(new_n163_), .d(new_n37_), .O(z5));
  nand2  g132(.a(x20), .b(new_n36_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n34_), .c(x11), .O(new_n167_));
  nand3  g134(.a(new_n164_), .b(new_n43_), .c(new_n163_), .O(new_n168_));
  oai21  g135(.a(new_n167_), .b(x03), .c(new_n168_), .O(new_n169_));
  nand2  g136(.a(new_n65_), .b(x14), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(x06), .c(new_n35_), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(new_n58_), .c(new_n119_), .d(new_n114_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n169_), .c(new_n37_), .O(z6));
  inv1   g140(.a(new_n114_), .O(new_n174_));
  nand4  g141(.a(new_n118_), .b(new_n115_), .c(new_n174_), .d(new_n37_), .O(z7));
endmodule
