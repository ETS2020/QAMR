...
module FAU ( 
  ...
  nor2   g43(.a(x23), .b(x20), .O(new_n77_));
  inv1   g44(.a(new_n77_), .O(new_n78_));
  oai21  g45(.a(new_n76_), .b(new_n54_), .c(new_n78_), .O(z2));
  nand3  g46(.a(x15), .b(x13), .c(x05), .O(new_n80_));
  nand3  g47(.a(x21), .b(new_n45_), .c(new_n44_), .O(new_n81_));
  nand2  g48(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand4  g49(.a(new_n82_), .b(x20), .c(x14), .d(x11), .O(new_n83_));
  nor2   g50(.a(new_n83_), .b(new_n55_), .O(new_n84_));
  nand4  g51(.a(new_n84_), .b(x06), .c(x03), .d(x01), .O(new_n85_));
  nand3  g52(.a(new_n45_), .b(new_n44_), .c(x00), .O(new_n86_));
  nand3  g53(.a(x19), .b(x13), .c(x05), .O(new_n87_));
  aoi21  g54(.a(new_n87_), .b(new_n86_), .c(new_n37_), .O(new_n88_));
  nand4  g55(.a(new_n88_), .b(new_n73_), .c(new_n56_), .d(new_n36_), .O(new_n89_));
  nor2   g56(.a(new_n89_), .b(x08), .O(new_n90_));
  nand4  g57(.a(new_n90_), .b(new_n35_), .c(new_n34_), .d(new_n54_), .O(new_n91_));
  nand2  g58(.a(new_n91_), .b(new_n85_), .O(new_n92_));
  nand2  g59(.a(new_n92_), .b(new_n40_), .O(new_n93_));
  nand2  g60(.a(new_n47_), .b(new_n38_), .O(new_n94_));
  nand4  g61(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n95_));
  nand4  g62(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n96_));
  nand4  g63(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n54_), .O(new_n97_));
  nor2   g64(.a(new_n37_), .b(x20), .O(new_n98_));
  nand4  g65(.a(new_n98_), .b(new_n56_), .c(new_n36_), .d(new_n55_), .O(new_n99_));
  ...
  nand4  g69(.a(new_n55_), .b(new_n35_), .c(new_n34_), .d(new_n54_), .O(new_n103_));
  nand4  g70(.a(new_n98_), .b(x19), .c(new_n56_), .d(new_n36_), .O(new_n104_));
  oai22  g71(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n95_), .O(new_n105_));
  nand3  g72(.a(new_n105_), .b(new_n47_), .c(new_n38_), .O(new_n106_));
  nand3  g73(.a(new_n106_), .b(new_n101_), .c(new_n93_), .O(z3));
  inv1   g74(.a(new_n74_), .O(new_n108_));
  inv1   g75(.a(x16), .O(new_n109_));
  inv1   g76(.a(x09), .O(new_n110_));
  oai21  g77(.a(new_n37_), .b(x04), .c(x17), .O(new_n111_));
  aoi21  g78(.a(new_n111_), .b(x22), .c(new_n110_), .O(new_n112_));
  oai21  g79(.a(new_n112_), .b(new_n109_), .c(x08), .O(new_n113_));
  nand2  g80(.a(new_n113_), .b(new_n108_), .O(new_n114_));
  inv1   g81(.a(new_n50_), .O(new_n115_));
  aoi21  g82(.a(new_n37_), .b(x04), .c(x17), .O(new_n116_));
  oai21  g83(.a(new_n116_), .b(x22), .c(new_n110_), .O(new_n117_));
  nand3  g84(.a(new_n117_), .b(new_n109_), .c(new_n55_), .O(new_n118_));
  oai21  g85(.a(new_n77_), .b(new_n55_), .c(new_n118_), .O(new_n119_));
  nand2  g86(.a(new_n119_), .b(new_n115_), .O(new_n120_));
  nand3  g87(.a(new_n120_), .b(new_n114_), .c(new_n78_), .O(z4));
  nor2   g88(.a(new_n77_), .b(new_n50_), .O(z5));
  nand2  g89(.a(x20), .b(new_n56_), .O(new_n123_));
  aoi21  g90(.a(new_n123_), .b(new_n35_), .c(x11), .O(new_n124_));
  oai21  g91(.a(new_n124_), .b(x03), .c(new_n115_), .O(new_n125_));
  nand2  g92(.a(new_n73_), .b(x14), .O(new_n126_));
  aoi21  g93(.a(new_n126_), .b(x06), .c(new_n36_), .O(new_n127_));
  oai21  g94(.a(new_n127_), .b(new_n34_), .c(new_n108_), .O(new_n128_));
  nand3  g95(.a(new_n128_), .b(new_n125_), .c(new_n78_), .O(z6));
  inv1   g96(.a(new_n60_), .O(new_n130_));
  and2   g97(.a(new_n62_), .b(new_n61_), .O(new_n131_));
  nand4  g98(.a(new_n131_), .b(new_n78_), .c(new_n63_), .d(new_n130_), .O(z7));
endmodule
