...
module FAU ( 
  ...
  nor2   g084(.a(x24), .b(new_n103_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n45_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(new_n117_), .c(new_n116_), .d(new_n115_), .O(new_n120_));
  ...
  nor2   g090(.a(new_n123_), .b(new_n56_), .O(z2));
  ...
  nand4  g096(.a(new_n129_), .b(new_n106_), .c(new_n79_), .d(new_n71_), .O(new_n130_));
  oai21  g097(.a(new_n128_), .b(new_n125_), .c(new_n130_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n86_), .O(new_n132_));
  nand3  g099(.a(new_n127_), .b(new_n91_), .c(x14), .O(new_n133_));
  nor2   g100(.a(x11), .b(x08), .O(new_n134_));
  nor2   g101(.a(x20), .b(x14), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n134_), .c(new_n106_), .d(new_n94_), .O(new_n136_));
  ...
  nand4  g107(.a(new_n118_), .b(x20), .c(x14), .d(x11), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n140_), .c(new_n44_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(x01), .O(new_n143_));
  ...
  nand4  g116(.a(new_n149_), .b(new_n143_), .c(new_n138_), .d(new_n132_), .O(z3));
  nand2  g117(.a(new_n54_), .b(x08), .O(new_n151_));
  inv1   g118(.a(x09), .O(new_n152_));
  aoi21  g119(.a(new_n66_), .b(x04), .c(x17), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x22), .c(new_n152_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n76_), .c(new_n126_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n151_), .c(new_n93_), .O(new_n156_));
  inv1   g123(.a(x04), .O(new_n157_));
  aoi21  g124(.a(x23), .b(new_n157_), .c(new_n77_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n65_), .c(x09), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(x16), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x08), .c(new_n90_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n156_), .c(new_n84_), .O(new_n162_));
  nand4  g129(.a(new_n48_), .b(x08), .c(new_n38_), .d(new_n56_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(x24), .O(new_n165_));
  nand2  g132(.a(new_n86_), .b(x15), .O(new_n166_));
  nand3  g133(.a(new_n118_), .b(new_n45_), .c(new_n44_), .O(new_n167_));
  aoi22  g134(.a(new_n167_), .b(new_n166_), .c(new_n160_), .d(x08), .O(new_n168_));
  nand2  g135(.a(x24), .b(x08), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n83_), .c(new_n38_), .O(new_n170_));
  ...
  nand3  g140(.a(new_n173_), .b(new_n154_), .c(new_n76_), .O(new_n174_));
  ...
  nand2  g144(.a(new_n177_), .b(new_n84_), .O(new_n178_));
  ...
  nand3  g148(.a(new_n181_), .b(new_n174_), .c(new_n54_), .O(new_n182_));
  ...
  oai21  g152(.a(new_n185_), .b(new_n42_), .c(new_n54_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n46_), .O(z5));
  nand2  g154(.a(x20), .b(new_n75_), .O(new_n188_));
  aoi21  g155(.a(new_n188_), .b(new_n35_), .c(x11), .O(new_n189_));
  oai22  g156(.a(new_n189_), .b(x03), .c(new_n50_), .d(new_n42_), .O(new_n190_));
  nand2  g157(.a(new_n37_), .b(x14), .O(new_n191_));
  aoi21  g158(.a(new_n191_), .b(x06), .c(new_n36_), .O(new_n192_));
  and2   g159(.a(new_n167_), .b(new_n117_), .O(new_n193_));
  nand3  g160(.a(new_n193_), .b(new_n116_), .c(new_n115_), .O(new_n194_));
  oai21  g161(.a(new_n192_), .b(new_n34_), .c(new_n194_), .O(new_n195_));
  nand3  g162(.a(new_n195_), .b(new_n190_), .c(new_n54_), .O(z6));
  nand4  g163(.a(new_n193_), .b(new_n116_), .c(new_n115_), .d(new_n54_), .O(z7));
endmodule
