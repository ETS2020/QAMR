...
module FAU ( 
  ...
  and2   g044(.a(x20), .b(x18), .O(new_n78_));
  nand3  g045(.a(new_n78_), .b(x23), .c(x22), .O(new_n79_));
  ...
  nand4  g051(.a(new_n84_), .b(new_n63_), .c(new_n62_), .d(new_n82_), .O(new_n85_));
  ...
  nand4  g058(.a(new_n91_), .b(new_n70_), .c(new_n37_), .d(new_n86_), .O(new_n92_));
  oai21  g059(.a(new_n92_), .b(new_n85_), .c(new_n81_), .O(new_n93_));
  nand3  g060(.a(new_n93_), .b(new_n73_), .c(x24), .O(new_n94_));
  nand4  g061(.a(x08), .b(x06), .c(x04), .d(x03), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nor2   g063(.a(new_n87_), .b(new_n36_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n96_), .c(new_n45_), .d(x09), .O(new_n98_));
  ...
  nand3  g076(.a(new_n45_), .b(new_n62_), .c(new_n82_), .O(new_n110_));
  ...
  nand4  g081(.a(new_n114_), .b(new_n111_), .c(new_n109_), .d(new_n91_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n105_), .c(new_n94_), .d(new_n76_), .O(z1));
  ...
  nor2   g099(.a(new_n36_), .b(new_n82_), .O(new_n133_));
  ...
  nand4  g105(.a(new_n138_), .b(new_n137_), .c(new_n69_), .d(new_n64_), .O(new_n139_));
  oai21  g106(.a(new_n136_), .b(new_n132_), .c(new_n139_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n75_), .O(new_n141_));
  nand3  g108(.a(new_n133_), .b(new_n78_), .c(x14), .O(new_n142_));
  nor2   g109(.a(x11), .b(x08), .O(new_n143_));
  nor2   g110(.a(x20), .b(x14), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n143_), .c(new_n137_), .d(new_n84_), .O(new_n145_));
  oai21  g112(.a(new_n142_), .b(new_n132_), .c(new_n145_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n73_), .c(x24), .O(new_n147_));
  nor2   g114(.a(new_n34_), .b(x02), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n45_), .c(x08), .d(x06), .O(new_n149_));
  inv1   g116(.a(x21), .O(new_n150_));
  nor2   g117(.a(x24), .b(new_n150_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(x20), .c(x14), .d(x11), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n149_), .c(new_n44_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x01), .O(new_n154_));
  nor3   g121(.a(x06), .b(x03), .c(x02), .O(new_n155_));
  nor3   g122(.a(x11), .b(x10), .c(x08), .O(new_n156_));
  nor3   g123(.a(x24), .b(x20), .c(x14), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(new_n107_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n154_), .c(new_n147_), .d(new_n141_), .O(z3));
  inv1   g126(.a(x04), .O(new_n160_));
  oai21  g127(.a(x23), .b(new_n160_), .c(new_n86_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n112_), .c(x09), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x16), .c(new_n82_), .O(new_n163_));
  nand2  g130(.a(x02), .b(x01), .O(new_n164_));
  nand2  g131(.a(new_n48_), .b(new_n43_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n42_), .c(new_n164_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n46_), .O(z5));
  nand2  g134(.a(z5), .b(new_n163_), .O(new_n168_));
  oai21  g135(.a(new_n101_), .b(x04), .c(x17), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x22), .c(new_n62_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n89_), .c(x08), .O(new_n171_));
  nand3  g138(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n164_), .O(new_n173_));
  nand3  g140(.a(new_n151_), .b(new_n45_), .c(new_n44_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n168_), .O(z4));
  nand2  g144(.a(x20), .b(new_n88_), .O(new_n178_));
  aoi21  g145(.a(new_n178_), .b(new_n35_), .c(x11), .O(new_n179_));
  oai22  g146(.a(new_n179_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n180_));
  nand2  g147(.a(new_n37_), .b(x14), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(x06), .c(new_n36_), .O(new_n182_));
  and2   g149(.a(new_n174_), .b(new_n123_), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(new_n122_), .c(new_n121_), .O(new_n184_));
  oai21  g151(.a(new_n182_), .b(new_n34_), .c(new_n184_), .O(new_n185_));
  nand3  g152(.a(new_n185_), .b(new_n180_), .c(new_n164_), .O(z6));
  nand4  g153(.a(new_n183_), .b(new_n164_), .c(new_n122_), .d(new_n121_), .O(z7));
endmodule
