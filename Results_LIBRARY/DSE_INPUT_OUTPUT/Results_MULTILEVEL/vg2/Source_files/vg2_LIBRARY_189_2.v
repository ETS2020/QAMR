...
module FAU ( 
  ...
  nand4  g037(.a(new_n70_), .b(new_n69_), .c(new_n66_), .d(new_n65_), .O(new_n71_));
  ...
  nor2   g052(.a(new_n38_), .b(new_n85_), .O(new_n86_));
  nand4  g053(.a(new_n86_), .b(new_n84_), .c(new_n63_), .d(new_n56_), .O(new_n87_));
  nor2   g054(.a(x09), .b(x08), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n69_), .c(x07), .d(new_n65_), .O(new_n89_));
  ...
  nor2   g063(.a(new_n96_), .b(new_n38_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n84_), .c(new_n63_), .d(new_n56_), .O(new_n98_));
  ...
  nand4  g069(.a(new_n102_), .b(new_n41_), .c(new_n45_), .d(new_n34_), .O(new_n103_));
  ...
  nand3  g076(.a(x15), .b(new_n47_), .c(new_n39_), .O(new_n110_));
  nand4  g077(.a(new_n41_), .b(x21), .c(new_n45_), .d(new_n34_), .O(new_n111_));
  ...
  nand2  g082(.a(new_n65_), .b(x02), .O(new_n116_));
  oai21  g083(.a(new_n115_), .b(new_n35_), .c(new_n116_), .O(z2));
  ...
  nand4  g087(.a(new_n65_), .b(new_n36_), .c(new_n34_), .d(new_n35_), .O(new_n121_));
  nand4  g088(.a(new_n75_), .b(new_n105_), .c(new_n37_), .d(new_n66_), .O(new_n122_));
  ...
  nand4  g093(.a(new_n126_), .b(new_n37_), .c(new_n66_), .d(x07), .O(new_n127_));
  ...
  nand4  g096(.a(new_n65_), .b(new_n36_), .c(new_n35_), .d(x00), .O(new_n130_));
  nand3  g097(.a(new_n126_), .b(new_n37_), .c(new_n66_), .O(new_n131_));
  nand2  g098(.a(new_n119_), .b(new_n97_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n118_), .c(new_n131_), .d(new_n130_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n41_), .c(new_n45_), .d(new_n34_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n129_), .c(new_n124_), .O(z3));
  oai21  g102(.a(x23), .b(new_n67_), .c(new_n59_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n61_), .c(x09), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(x16), .c(new_n66_), .O(new_n138_));
  inv1   g105(.a(new_n43_), .O(new_n139_));
  nand4  g106(.a(new_n41_), .b(new_n45_), .c(new_n34_), .d(x00), .O(new_n140_));
  and2   g107(.a(new_n140_), .b(new_n48_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n44_), .c(new_n139_), .O(new_n142_));
  ...
  oai21  g115(.a(new_n112_), .b(new_n108_), .c(new_n148_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n143_), .c(new_n116_), .O(z4));
  nand4  g117(.a(new_n141_), .b(new_n116_), .c(new_n44_), .d(new_n139_), .O(z5));
  inv1   g118(.a(x00), .O(new_n152_));
  nand3  g119(.a(x19), .b(x13), .c(x05), .O(new_n153_));
  oai21  g120(.a(x10), .b(new_n152_), .c(new_n153_), .O(new_n154_));
  nand3  g121(.a(x20), .b(new_n105_), .c(new_n37_), .O(new_n155_));
  ...
  oai21  g125(.a(new_n96_), .b(x10), .c(new_n158_), .O(new_n159_));
  oai21  g126(.a(new_n37_), .b(x06), .c(x03), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand3  g128(.a(new_n37_), .b(x06), .c(x00), .O(new_n162_));
  nand4  g129(.a(x21), .b(new_n38_), .c(x14), .d(x11), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n45_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n161_), .c(new_n157_), .O(new_n166_));
  oai21  g133(.a(x13), .b(x05), .c(x24), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n85_), .c(new_n110_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n160_), .O(new_n169_));
  inv1   g136(.a(x07), .O(new_n170_));
  oai21  g137(.a(new_n167_), .b(new_n170_), .c(new_n48_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n156_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n169_), .O(new_n173_));
  aoi21  g140(.a(new_n166_), .b(new_n41_), .c(new_n173_), .O(new_n174_));
  nand2  g141(.a(new_n48_), .b(new_n44_), .O(new_n175_));
  oai22  g142(.a(new_n175_), .b(new_n43_), .c(new_n37_), .d(x03), .O(new_n176_));
  nand3  g143(.a(new_n38_), .b(x14), .c(x11), .O(new_n177_));
  ...
  nand2  g148(.a(new_n181_), .b(x06), .O(new_n182_));
  oai21  g149(.a(new_n174_), .b(x02), .c(new_n182_), .O(z6));
  nand4  g150(.a(new_n116_), .b(new_n111_), .c(new_n110_), .d(new_n109_), .O(new_n184_));
  or2    g151(.a(new_n184_), .b(new_n108_), .O(z7));
endmodule
