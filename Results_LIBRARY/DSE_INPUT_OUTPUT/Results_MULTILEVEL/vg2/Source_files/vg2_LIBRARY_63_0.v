...
module FAU ( 
  ...
  nand4  g076(.a(new_n40_), .b(x21), .c(new_n95_), .d(new_n109_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n108_), .c(new_n107_), .O(new_n111_));
  oai21  g078(.a(new_n111_), .b(new_n106_), .c(x20), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(new_n103_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(x11), .c(x06), .d(x03), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(new_n62_), .O(z2));
  nor2   g082(.a(new_n34_), .b(new_n62_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n95_), .c(x08), .d(x06), .O(new_n117_));
  nor2   g084(.a(x24), .b(new_n98_), .O(new_n118_));
  nor2   g085(.a(new_n103_), .b(new_n36_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n118_), .c(x20), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(new_n117_), .c(x01), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n109_), .O(new_n122_));
  nand2  g089(.a(new_n116_), .b(new_n54_), .O(new_n123_));
  nand3  g090(.a(new_n119_), .b(x20), .c(x15), .O(new_n124_));
  nand3  g091(.a(new_n66_), .b(new_n34_), .c(new_n62_), .O(new_n125_));
  nand3  g092(.a(new_n71_), .b(new_n103_), .c(new_n36_), .O(new_n126_));
  ...
  nand4  g096(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n62_), .O(new_n130_));
  nand4  g097(.a(new_n37_), .b(new_n103_), .c(new_n36_), .d(new_n53_), .O(new_n131_));
  ...
  nor2   g106(.a(x02), .b(x01), .O(new_n140_));
  inv1   g107(.a(new_n140_), .O(new_n141_));
  oai21  g108(.a(new_n46_), .b(new_n42_), .c(new_n141_), .O(new_n142_));
  nor2   g109(.a(x24), .b(x10), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n109_), .c(x01), .d(x00), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n142_), .O(z5));
  nand2  g112(.a(z5), .b(new_n139_), .O(new_n146_));
  ...
  nand2  g118(.a(new_n105_), .b(new_n104_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x05), .O(new_n153_));
  nand3  g120(.a(new_n108_), .b(new_n107_), .c(new_n153_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n141_), .O(new_n155_));
  nand3  g122(.a(new_n118_), .b(new_n92_), .c(new_n95_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n155_), .O(z7));
  nand2  g124(.a(z7), .b(new_n151_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n146_), .O(z4));
  nand2  g126(.a(x20), .b(new_n103_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n35_), .c(x11), .O(new_n161_));
  nand3  g128(.a(new_n143_), .b(new_n109_), .c(x00), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n45_), .c(new_n43_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n42_), .c(new_n161_), .d(x03), .O(new_n164_));
  oai21  g131(.a(x20), .b(new_n103_), .c(x06), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(x11), .c(x03), .O(new_n166_));
  oai21  g133(.a(x03), .b(new_n62_), .c(new_n166_), .O(new_n167_));
  oai21  g134(.a(new_n111_), .b(new_n106_), .c(new_n167_), .O(new_n168_));
  nand3  g135(.a(new_n154_), .b(new_n34_), .c(x02), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n168_), .c(new_n164_), .d(new_n141_), .O(z6));
endmodule
