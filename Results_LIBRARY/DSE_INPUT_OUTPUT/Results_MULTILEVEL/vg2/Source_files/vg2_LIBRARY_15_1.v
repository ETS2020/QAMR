...
module FAU ( 
  ...
  nand2  g044(.a(x21), .b(x20), .O(new_n78_));
  nor4   g045(.a(new_n78_), .b(x24), .c(new_n77_), .d(new_n62_), .O(new_n79_));
  nand3  g046(.a(new_n79_), .b(new_n76_), .c(new_n74_), .O(new_n80_));
  oai21  g047(.a(new_n71_), .b(x01), .c(new_n80_), .O(new_n81_));
  nand2  g048(.a(new_n81_), .b(new_n50_), .O(new_n82_));
  inv1   g049(.a(x01), .O(new_n83_));
  nand4  g050(.a(x11), .b(x09), .c(x08), .d(x06), .O(new_n84_));
  nor4   g051(.a(new_n84_), .b(new_n57_), .c(new_n56_), .d(new_n83_), .O(new_n85_));
  nand4  g052(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n86_));
  nor2   g053(.a(new_n77_), .b(new_n62_), .O(new_n87_));
  ...
  nand4  g057(.a(new_n57_), .b(new_n56_), .c(new_n83_), .d(x00), .O(new_n91_));
  inv1   g058(.a(new_n91_), .O(new_n92_));
  nor2   g059(.a(x08), .b(x06), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n92_), .c(new_n35_), .d(new_n58_), .O(new_n94_));
  ...
  oai21  g067(.a(new_n100_), .b(new_n94_), .c(new_n90_), .O(new_n101_));
  ...
  nor2   g073(.a(new_n61_), .b(new_n106_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n87_), .c(new_n85_), .d(new_n76_), .O(new_n108_));
  nor2   g075(.a(x09), .b(x08), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(new_n92_), .c(x07), .d(new_n34_), .O(new_n110_));
  inv1   g077(.a(x16), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(new_n36_), .c(new_n59_), .d(new_n35_), .O(new_n112_));
  inv1   g079(.a(new_n112_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n99_), .c(new_n61_), .d(new_n60_), .O(new_n114_));
  oai21  g081(.a(new_n114_), .b(new_n110_), .c(new_n108_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n102_), .c(x24), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(new_n105_), .c(new_n38_), .O(new_n117_));
  inv1   g084(.a(new_n117_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n82_), .O(z1));
  nor2   g086(.a(new_n40_), .b(new_n106_), .O(new_n120_));
  ...
  nand4  g093(.a(new_n40_), .b(x21), .c(new_n51_), .d(new_n50_), .O(new_n127_));
  and2   g094(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n125_), .c(new_n124_), .O(new_n129_));
  ...
  oai21  g099(.a(new_n132_), .b(new_n83_), .c(new_n38_), .O(z2));
  ...
  nand3  g103(.a(new_n93_), .b(new_n56_), .c(new_n83_), .O(new_n137_));
  nand3  g104(.a(new_n98_), .b(new_n36_), .c(new_n35_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n134_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n104_), .O(new_n140_));
  nand2  g107(.a(new_n135_), .b(new_n107_), .O(new_n141_));
  nand4  g108(.a(x07), .b(new_n34_), .c(new_n56_), .d(new_n83_), .O(new_n142_));
  inv1   g109(.a(x08), .O(new_n143_));
  nand4  g110(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n143_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n142_), .c(new_n141_), .d(new_n134_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n102_), .c(x24), .O(new_n146_));
  nand4  g113(.a(new_n34_), .b(new_n56_), .c(new_n83_), .d(x00), .O(new_n147_));
  nand3  g114(.a(new_n135_), .b(x21), .c(x20), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n134_), .c(new_n147_), .d(new_n144_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n40_), .c(new_n51_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n146_), .c(new_n140_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n50_), .O(new_n152_));
  nand2  g119(.a(new_n146_), .b(new_n140_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x00), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n152_), .O(z3));
  oai21  g122(.a(new_n77_), .b(x04), .c(x17), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n58_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n111_), .c(x08), .O(new_n158_));
  nand2  g125(.a(new_n126_), .b(new_n125_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n123_), .c(new_n38_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n127_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g129(.a(new_n52_), .b(new_n49_), .O(z5));
  oai21  g130(.a(x23), .b(new_n57_), .c(new_n60_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n62_), .c(x09), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x16), .c(new_n143_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(z5), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n162_), .O(z4));
  ...
  nand3  g138(.a(new_n52_), .b(new_n47_), .c(new_n44_), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(new_n169_), .c(new_n171_), .d(x03), .O(new_n173_));
  nand2  g140(.a(new_n61_), .b(x14), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x06), .c(new_n35_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n56_), .c(new_n129_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n173_), .c(new_n38_), .O(z6));
  nand4  g144(.a(new_n128_), .b(new_n125_), .c(new_n124_), .d(new_n38_), .O(z7));
endmodule
