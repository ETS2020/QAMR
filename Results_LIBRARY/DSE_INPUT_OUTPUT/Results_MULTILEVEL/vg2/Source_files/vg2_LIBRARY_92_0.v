...
module FAU ( 
  ...
  nor4   g075(.a(new_n108_), .b(x24), .c(new_n107_), .d(new_n106_), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(new_n105_), .c(new_n102_), .d(new_n100_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n99_), .c(new_n85_), .O(z1));
  nand2  g078(.a(new_n93_), .b(new_n34_), .O(new_n112_));
  nand2  g079(.a(x24), .b(x18), .O(new_n113_));
  nand3  g080(.a(new_n41_), .b(x15), .c(x13), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n113_), .c(new_n47_), .O(new_n115_));
  nand3  g082(.a(x24), .b(x18), .c(x13), .O(new_n116_));
  nand3  g083(.a(x15), .b(new_n52_), .c(new_n47_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n115_), .c(new_n112_), .O(new_n119_));
  nor2   g086(.a(x10), .b(x02), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(new_n41_), .c(x21), .d(x12), .O(new_n121_));
  aoi21  g088(.a(new_n121_), .b(new_n119_), .c(new_n40_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x14), .c(x11), .d(x06), .O(new_n123_));
  nor3   g090(.a(new_n123_), .b(new_n36_), .c(new_n35_), .O(z2));
  nand3  g091(.a(new_n62_), .b(x03), .c(x01), .O(new_n125_));
  nor2   g092(.a(new_n39_), .b(new_n46_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(x20), .c(x15), .O(new_n127_));
  nand3  g094(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n128_));
  nand3  g095(.a(new_n78_), .b(new_n39_), .c(new_n46_), .O(new_n129_));
  ...
  nand4  g099(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n133_));
  nand4  g100(.a(new_n40_), .b(new_n39_), .c(new_n46_), .d(new_n61_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n125_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n82_), .c(x24), .O(new_n136_));
  nand3  g103(.a(new_n126_), .b(x21), .c(x20), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n125_), .c(new_n134_), .d(new_n38_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n41_), .c(new_n103_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(x12), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n34_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n136_), .c(new_n131_), .O(z3));
  oai21  g109(.a(x23), .b(new_n70_), .c(new_n92_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n106_), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n61_), .O(new_n145_));
  inv1   g112(.a(new_n112_), .O(new_n146_));
  nor2   g113(.a(x24), .b(new_n93_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n103_), .c(new_n34_), .d(x00), .O(new_n148_));
  oai21  g115(.a(new_n146_), .b(new_n55_), .c(new_n148_), .O(z5));
  nand2  g116(.a(z5), .b(new_n145_), .O(new_n150_));
  nand2  g117(.a(new_n121_), .b(new_n119_), .O(z7));
  oai21  g118(.a(new_n107_), .b(x04), .c(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n69_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n94_), .c(x08), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(z7), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n150_), .O(z4));
  nand2  g123(.a(x20), .b(new_n39_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n37_), .c(x11), .O(new_n158_));
  nand4  g125(.a(new_n41_), .b(new_n103_), .c(new_n34_), .d(x00), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n53_), .c(new_n51_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n50_), .c(new_n158_), .d(x03), .O(new_n161_));
  oai21  g128(.a(x20), .b(new_n39_), .c(x06), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(x11), .c(x03), .O(new_n163_));
  oai21  g130(.a(new_n93_), .b(x03), .c(new_n163_), .O(new_n164_));
  nand3  g131(.a(new_n120_), .b(new_n41_), .c(x21), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n117_), .c(new_n116_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n115_), .c(new_n164_), .O(new_n167_));
  or2    g134(.a(new_n118_), .b(new_n115_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n36_), .c(x02), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n167_), .c(new_n161_), .d(new_n112_), .O(z6));
endmodule
