...
module FAU ( 
  ...
  nand4  g088(.a(new_n106_), .b(x08), .c(x06), .d(x03), .O(new_n122_));
  ...
  nand3  g093(.a(new_n55_), .b(x03), .c(x01), .O(new_n127_));
  nand3  g094(.a(new_n123_), .b(x20), .c(x15), .O(new_n128_));
  nand3  g095(.a(new_n77_), .b(new_n34_), .c(new_n105_), .O(new_n129_));
  nand3  g096(.a(new_n82_), .b(new_n97_), .c(new_n36_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n127_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n88_), .O(new_n132_));
  nand3  g099(.a(new_n123_), .b(x20), .c(x18), .O(new_n133_));
  nand4  g100(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n105_), .O(new_n134_));
  nand4  g101(.a(new_n37_), .b(new_n97_), .c(new_n36_), .d(new_n54_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n127_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n86_), .c(x24), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n132_), .c(new_n126_), .O(z3));
  inv1   g105(.a(x22), .O(new_n139_));
  oai21  g106(.a(x23), .b(new_n52_), .c(new_n96_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n139_), .c(x09), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x16), .c(new_n54_), .O(new_n142_));
  nor2   g109(.a(new_n46_), .b(new_n42_), .O(new_n143_));
  ...
  nand4  g119(.a(new_n109_), .b(new_n106_), .c(new_n51_), .d(x01), .O(new_n153_));
  oai21  g120(.a(new_n144_), .b(new_n152_), .c(new_n153_), .O(z7));
  nand2  g121(.a(z7), .b(new_n151_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n148_), .O(z4));
  aoi21  g123(.a(new_n145_), .b(x00), .c(new_n105_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x02), .c(new_n143_), .O(z5));
