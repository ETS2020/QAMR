...
module FAU ( 
  ...
  nand2  g124(.a(x02), .b(new_n69_), .O(new_n158_));
  nand3  g125(.a(new_n50_), .b(new_n45_), .c(new_n44_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand3  g127(.a(new_n101_), .b(new_n41_), .c(new_n46_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(z5));
  nand2  g129(.a(z5), .b(new_n157_), .O(new_n163_));
  oai21  g130(.a(new_n114_), .b(x04), .c(x17), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x22), .c(new_n68_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n93_), .c(x08), .O(new_n166_));
  nand2  g133(.a(new_n123_), .b(new_n122_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n121_), .c(new_n158_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n124_), .O(new_n169_));
  ...
  nand3  g141(.a(new_n161_), .b(new_n50_), .c(new_n45_), .O(new_n175_));
  oai22  g142(.a(new_n175_), .b(new_n172_), .c(new_n174_), .d(x03), .O(new_n176_));
  nand2  g143(.a(new_n39_), .b(x14), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(x06), .c(new_n37_), .O(new_n178_));
  oai22  g145(.a(new_n178_), .b(new_n35_), .c(new_n125_), .d(new_n121_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n176_), .c(new_n158_), .O(z6));
  nand4  g147(.a(new_n158_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n181_));
  or2    g148(.a(new_n181_), .b(new_n121_), .O(z7));
endmodule
