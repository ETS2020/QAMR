...
module FAU ( 
  ...
  aoi21  g084(.a(new_n114_), .b(x05), .c(new_n117_), .O(new_n118_));
  ...
  nand3  g111(.a(new_n144_), .b(new_n106_), .c(x00), .O(new_n145_));
  ...
  nand2  g119(.a(new_n114_), .b(x05), .O(new_n153_));
  nand3  g120(.a(new_n108_), .b(new_n98_), .c(new_n106_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n116_), .c(new_n115_), .d(new_n153_), .O(new_n155_));
  ...
  aoi21  g126(.a(new_n144_), .b(x00), .c(new_n65_), .O(new_n160_));
  ...
  nand4  g130(.a(new_n144_), .b(new_n106_), .c(x01), .d(x00), .O(new_n164_));
  ...
  nand3  g135(.a(new_n108_), .b(new_n95_), .c(new_n98_), .O(new_n169_));
  oai21  g136(.a(new_n156_), .b(new_n118_), .c(new_n169_), .O(z7));
