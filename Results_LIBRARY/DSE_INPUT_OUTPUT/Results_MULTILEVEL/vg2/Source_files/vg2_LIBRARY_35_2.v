...
module FAU ( 
  ...
  nand4  g037(.a(new_n70_), .b(new_n69_), .c(new_n34_), .d(new_n67_), .O(new_n71_));
  ...
  nand4  g056(.a(new_n89_), .b(new_n69_), .c(x07), .d(new_n88_), .O(new_n90_));
  inv1   g057(.a(x17), .O(new_n91_));
  inv1   g058(.a(x16), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n35_), .c(new_n37_), .d(new_n34_), .O(new_n93_));
  inv1   g060(.a(new_n93_), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n76_), .c(new_n36_), .d(new_n91_), .O(new_n95_));
  oai21  g062(.a(new_n95_), .b(new_n90_), .c(new_n87_), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(new_n79_), .c(x24), .O(new_n97_));
  and2   g064(.a(x21), .b(x20), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n84_), .c(new_n63_), .d(new_n59_), .O(new_n99_));
  ...
  nand3  g071(.a(new_n104_), .b(new_n97_), .c(new_n82_), .O(z1));
  ...
  nor4   g082(.a(new_n115_), .b(new_n88_), .c(new_n56_), .d(new_n55_), .O(z2));
  ...
  nand2  g086(.a(new_n100_), .b(new_n70_), .O(new_n120_));
  nand3  g087(.a(new_n75_), .b(new_n35_), .c(new_n34_), .O(new_n121_));
  ...
  nand3  g091(.a(new_n100_), .b(x07), .c(new_n88_), .O(new_n125_));
  inv1   g092(.a(x08), .O(new_n126_));
  nand4  g093(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n126_), .O(new_n127_));
  ...
  nand4  g096(.a(new_n88_), .b(new_n56_), .c(new_n55_), .d(x00), .O(new_n130_));
  ...
  nand2  g106(.a(new_n38_), .b(x08), .O(new_n140_));
  aoi21  g107(.a(new_n62_), .b(x04), .c(x17), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x22), .c(new_n67_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n92_), .c(new_n126_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n140_), .c(new_n139_), .O(new_n144_));
  aoi21  g111(.a(x23), .b(new_n57_), .c(new_n91_), .O(new_n145_));
  ...
  oai21  g115(.a(new_n148_), .b(new_n144_), .c(new_n79_), .O(new_n149_));
  nor2   g116(.a(new_n74_), .b(x13), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(x12), .c(x08), .d(new_n39_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x24), .O(new_n153_));
  nand2  g120(.a(new_n81_), .b(x15), .O(new_n154_));
  aoi22  g121(.a(new_n154_), .b(new_n113_), .c(new_n147_), .d(x08), .O(new_n155_));
  nand2  g122(.a(x24), .b(x08), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n45_), .c(new_n39_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n80_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x19), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n51_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n142_), .c(new_n92_), .O(new_n161_));
  nand3  g128(.a(new_n41_), .b(new_n50_), .c(x00), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n46_), .c(x02), .O(new_n163_));
  nand2  g130(.a(x13), .b(x05), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n79_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n41_), .c(x19), .O(new_n166_));
  inv1   g133(.a(new_n166_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n163_), .c(x08), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n161_), .c(new_n38_), .O(new_n169_));
  nor2   g136(.a(new_n169_), .b(new_n155_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n153_), .O(z4));
  aoi21  g138(.a(x20), .b(new_n35_), .c(x06), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(x11), .c(new_n56_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(z5), .O(new_n174_));
  aoi21  g141(.a(new_n36_), .b(x14), .c(new_n88_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n34_), .c(x03), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n114_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n174_), .O(z6));
  inv1   g145(.a(new_n108_), .O(new_n179_));
  and2   g146(.a(new_n113_), .b(new_n110_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n109_), .c(new_n179_), .d(new_n38_), .O(z7));
endmodule
