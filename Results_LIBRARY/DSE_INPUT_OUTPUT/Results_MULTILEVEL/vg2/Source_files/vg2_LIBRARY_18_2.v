...
module FAU ( 
  ...
  nand4  g097(.a(new_n127_), .b(new_n35_), .c(new_n69_), .d(x00), .O(new_n131_));
  ...
  nand2  g111(.a(new_n36_), .b(x02), .O(new_n145_));
  ...
  nand4  g127(.a(new_n160_), .b(new_n145_), .c(new_n45_), .d(new_n44_), .O(z5));
  ...
  nand2  g133(.a(new_n36_), .b(new_n34_), .O(new_n167_));
  nand2  g134(.a(new_n39_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n167_), .c(new_n37_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n35_), .c(x15), .O(new_n170_));
  nand3  g137(.a(x19), .b(new_n37_), .c(x02), .O(new_n171_));
  aoi22  g138(.a(new_n171_), .b(new_n170_), .c(new_n166_), .d(new_n82_), .O(new_n172_));
  nand2  g139(.a(new_n168_), .b(x06), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(x11), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(x03), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(x21), .c(new_n46_), .d(new_n34_), .O(new_n176_));
  inv1   g143(.a(new_n176_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n172_), .c(new_n41_), .O(new_n178_));
  nand3  g145(.a(new_n173_), .b(x11), .c(x03), .O(new_n179_));
  nand2  g146(.a(new_n145_), .b(new_n35_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n82_), .c(x18), .O(new_n182_));
  nand3  g149(.a(x11), .b(new_n36_), .c(x03), .O(new_n183_));
  oai21  g150(.a(new_n36_), .b(x03), .c(new_n183_), .O(new_n184_));
  nand4  g151(.a(new_n184_), .b(x15), .c(new_n49_), .d(new_n48_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n182_), .O(new_n186_));
  nand2  g153(.a(x11), .b(x03), .O(new_n187_));
  oai22  g154(.a(new_n187_), .b(new_n168_), .c(x03), .d(x02), .O(new_n188_));
  nand4  g155(.a(new_n188_), .b(x15), .c(new_n49_), .d(new_n48_), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n145_), .O(new_n190_));
