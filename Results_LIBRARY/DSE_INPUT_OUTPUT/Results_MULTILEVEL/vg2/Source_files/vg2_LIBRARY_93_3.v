...
module FAU ( 
  ...
  oai21  g39(.a(new_n60_), .b(x04), .c(x17), .O(new_n74_));
  aoi21  g40(.a(new_n74_), .b(x22), .c(new_n56_), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n58_), .c(x08), .O(new_n76_));
  and2   g42(.a(x24), .b(x18), .O(new_n77_));
  nand3  g43(.a(new_n39_), .b(x15), .c(x13), .O(new_n78_));
  inv1   g44(.a(new_n78_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n77_), .c(x05), .O(new_n80_));
  nand2  g46(.a(new_n77_), .b(x13), .O(new_n81_));
  nand3  g47(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n82_));
  nand4  g48(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n83_));
  and2   g49(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n81_), .c(new_n80_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n76_), .O(new_n86_));
  nor2   g52(.a(new_n34_), .b(new_n55_), .O(new_n87_));
  inv1   g53(.a(new_n87_), .O(new_n88_));
  aoi21  g54(.a(new_n60_), .b(x04), .c(x17), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(x22), .c(new_n56_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n58_), .c(new_n70_), .O(new_n91_));
  oai21  g57(.a(new_n87_), .b(new_n70_), .c(new_n91_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n50_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n88_), .c(new_n86_), .O(z4));
  nor2   g60(.a(new_n87_), .b(new_n49_), .O(z5));
  oai21  g61(.a(x11), .b(new_n53_), .c(new_n85_), .O(new_n96_));
  nand3  g62(.a(x20), .b(new_n35_), .c(new_n34_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n55_), .c(new_n53_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n50_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(new_n96_), .c(new_n88_), .O(z6));
  nand4  g66(.a(new_n88_), .b(new_n84_), .c(new_n81_), .d(new_n80_), .O(z7));
  zero   g67(.O(z2));
endmodule
