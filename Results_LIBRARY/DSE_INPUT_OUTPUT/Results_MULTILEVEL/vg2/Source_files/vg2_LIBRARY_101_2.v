...
module FAU ( 
  ...
  nor2   g118(.a(x20), .b(new_n35_), .O(new_n152_));
  ...
  nand2  g143(.a(x14), .b(new_n35_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n154_), .c(x20), .d(new_n36_), .O(new_n178_));
  nand3  g145(.a(new_n122_), .b(x11), .c(new_n35_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n178_), .c(new_n176_), .O(z6));
  and2   g147(.a(new_n120_), .b(new_n119_), .O(new_n181_));
  nand4  g148(.a(new_n181_), .b(new_n153_), .c(new_n121_), .d(new_n118_), .O(z7));
endmodule
