...
module FAU ( 
  ...
  nand2  g115(.a(new_n148_), .b(new_n109_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n141_), .O(z4));
  inv1   g118(.a(new_n43_), .O(new_n152_));
  and2   g119(.a(new_n139_), .b(new_n48_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n136_), .c(new_n44_), .d(new_n152_), .O(z5));
  nand2  g121(.a(x20), .b(new_n103_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n36_), .c(x11), .O(new_n156_));
  nand3  g123(.a(new_n153_), .b(new_n44_), .c(new_n152_), .O(new_n157_));
  oai21  g124(.a(new_n156_), .b(x03), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n38_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n37_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n35_), .c(new_n110_), .d(new_n106_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n136_), .O(z6));
  nand4  g129(.a(new_n136_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(new_n163_));
  or2    g130(.a(new_n163_), .b(new_n106_), .O(z7));
endmodule
