...
module FAU ( 
  ...
  nor2   g084(.a(new_n34_), .b(new_n105_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(new_n111_), .c(x08), .d(x06), .O(new_n119_));
  inv1   g086(.a(x21), .O(new_n120_));
  nor2   g087(.a(x24), .b(new_n120_), .O(new_n121_));
  nor2   g088(.a(new_n97_), .b(new_n36_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(new_n121_), .c(x20), .O(new_n123_));
  oai21  g090(.a(new_n123_), .b(new_n119_), .c(x01), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n51_), .O(new_n125_));
  nand2  g092(.a(new_n118_), .b(new_n55_), .O(new_n126_));
  nand3  g093(.a(new_n122_), .b(x20), .c(x15), .O(new_n127_));
  nand3  g094(.a(new_n77_), .b(new_n34_), .c(new_n105_), .O(new_n128_));
  nand3  g095(.a(new_n82_), .b(new_n97_), .c(new_n36_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n126_), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n88_), .O(new_n131_));
  nand3  g098(.a(new_n122_), .b(x20), .c(x18), .O(new_n132_));
  nand4  g099(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n105_), .O(new_n133_));
  nand4  g100(.a(new_n37_), .b(new_n97_), .c(new_n36_), .d(new_n54_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n126_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n86_), .c(x24), .O(new_n136_));
  ...
  oai21  g111(.a(new_n144_), .b(new_n42_), .c(new_n141_), .O(new_n145_));
  oai21  g112(.a(new_n63_), .b(x04), .c(x17), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x22), .c(new_n56_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n98_), .c(x08), .O(new_n148_));
  oai21  g115(.a(new_n113_), .b(new_n108_), .c(new_n148_), .O(new_n149_));
  nand2  g116(.a(new_n51_), .b(new_n105_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n149_), .c(new_n145_), .O(z4));
  nor2   g118(.a(new_n46_), .b(new_n42_), .O(new_n152_));
  aoi21  g119(.a(new_n142_), .b(x00), .c(new_n105_), .O(new_n153_));
  ...
  nand4  g124(.a(new_n142_), .b(new_n51_), .c(x01), .d(x00), .O(new_n158_));
  oai21  g125(.a(new_n157_), .b(new_n152_), .c(new_n158_), .O(new_n159_));
  ...
  oai21  g130(.a(new_n163_), .b(new_n108_), .c(new_n150_), .O(new_n164_));
  nand4  g131(.a(new_n121_), .b(new_n111_), .c(new_n51_), .d(x01), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n164_), .O(z7));
  nand2  g133(.a(z7), .b(new_n162_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n160_), .O(z6));
endmodule
