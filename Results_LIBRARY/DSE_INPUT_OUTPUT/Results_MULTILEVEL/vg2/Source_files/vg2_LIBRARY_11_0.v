...
module FAU ( 
  ...
  nand4  g129(.a(new_n141_), .b(new_n93_), .c(x01), .d(x00), .O(new_n163_));
  ...
  oai21  g133(.a(new_n166_), .b(x03), .c(new_n143_), .O(new_n167_));
  nand2  g134(.a(new_n38_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n36_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n34_), .c(new_n111_), .d(new_n106_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n161_), .O(z6));
  aoi21  g138(.a(new_n109_), .b(new_n96_), .c(new_n63_), .O(new_n172_));
  nand2  g139(.a(new_n108_), .b(new_n107_), .O(new_n173_));
  nor2   g140(.a(new_n173_), .b(new_n106_), .O(new_n174_));
  oai21  g141(.a(new_n172_), .b(x02), .c(new_n174_), .O(z7));
endmodule
