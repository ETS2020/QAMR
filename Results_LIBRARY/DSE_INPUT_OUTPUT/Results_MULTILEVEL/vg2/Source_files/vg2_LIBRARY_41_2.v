...
module FAU ( 
  ...
  nand4  g065(.a(new_n71_), .b(new_n70_), .c(new_n56_), .d(new_n36_), .O(new_n99_));
  ...
  nand4  g076(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n56_), .O(new_n110_));
  ...
  oai21  g094(.a(new_n127_), .b(new_n67_), .c(new_n54_), .O(z2));
  ...
  nor2   g117(.a(new_n53_), .b(new_n49_), .O(z5));
  nand2  g118(.a(z5), .b(x08), .O(new_n152_));
  oai21  g119(.a(x22), .b(new_n72_), .c(new_n69_), .O(new_n153_));
  nand3  g120(.a(x24), .b(new_n68_), .c(x07), .O(new_n154_));
  nand4  g121(.a(new_n39_), .b(x19), .c(x13), .d(new_n52_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n154_), .c(new_n37_), .O(new_n156_));
  nand2  g123(.a(new_n76_), .b(new_n47_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n39_), .c(new_n52_), .O(new_n158_));
  nand2  g125(.a(x13), .b(x07), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n47_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(x24), .c(new_n68_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n156_), .c(new_n153_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n52_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n71_), .O(new_n165_));
  inv1   g132(.a(new_n125_), .O(new_n166_));
  oai21  g133(.a(new_n75_), .b(x04), .c(x17), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x22), .c(new_n69_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n71_), .c(x08), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n165_), .c(new_n152_), .O(z4));
  nand2  g138(.a(x20), .b(new_n70_), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n35_), .c(x11), .O(new_n173_));
  oai22  g140(.a(new_n173_), .b(x03), .c(new_n48_), .d(new_n41_), .O(new_n174_));
  nand2  g141(.a(new_n73_), .b(x14), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(x06), .c(new_n36_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n34_), .c(new_n166_), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(new_n174_), .c(new_n53_), .O(z6));
  nor2   g145(.a(new_n125_), .b(new_n53_), .O(z7));
endmodule
