...
module FAU ( 
  ...
  nor2   g37(.a(new_n70_), .b(new_n52_), .O(new_n71_));
  nand4  g38(.a(new_n71_), .b(x06), .c(x04), .d(x03), .O(new_n72_));
  oai21  g39(.a(new_n72_), .b(new_n56_), .c(new_n54_), .O(z1));
  ...
  oai21  g44(.a(new_n77_), .b(new_n56_), .c(new_n54_), .O(z2));
  ...
  nor2   g49(.a(new_n82_), .b(new_n52_), .O(new_n83_));
  ...
  nand4  g56(.a(new_n89_), .b(new_n35_), .c(new_n34_), .d(new_n56_), .O(new_n90_));
  ...
  nand4  g62(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n56_), .O(new_n96_));
  nand4  g63(.a(new_n74_), .b(new_n57_), .c(new_n36_), .d(new_n52_), .O(new_n97_));
  ...
  nand4  g67(.a(new_n52_), .b(new_n35_), .c(new_n34_), .d(new_n56_), .O(new_n101_));
  ...
  nand4  g71(.a(new_n104_), .b(new_n99_), .c(new_n92_), .d(new_n54_), .O(z3));
  inv1   g72(.a(x16), .O(new_n106_));
  inv1   g73(.a(x09), .O(new_n107_));
  aoi21  g74(.a(x22), .b(new_n107_), .c(new_n53_), .O(new_n108_));
  aoi21  g75(.a(new_n108_), .b(new_n106_), .c(x08), .O(new_n109_));
  inv1   g76(.a(new_n75_), .O(new_n110_));
  inv1   g77(.a(x04), .O(new_n111_));
  aoi21  g78(.a(x23), .b(new_n111_), .c(new_n53_), .O(new_n112_));
  oai21  g79(.a(new_n112_), .b(new_n58_), .c(x09), .O(new_n113_));
  nand3  g80(.a(new_n113_), .b(x16), .c(x08), .O(new_n114_));
  oai21  g81(.a(new_n53_), .b(x08), .c(new_n114_), .O(new_n115_));
  nand2  g82(.a(new_n115_), .b(new_n110_), .O(new_n116_));
  oai21  g83(.a(new_n109_), .b(new_n49_), .c(new_n116_), .O(z4));
  inv1   g84(.a(new_n41_), .O(new_n118_));
  and2   g85(.a(new_n45_), .b(new_n42_), .O(new_n119_));
  nand4  g86(.a(new_n119_), .b(new_n54_), .c(new_n47_), .d(new_n118_), .O(z5));
  nand2  g87(.a(x20), .b(new_n57_), .O(new_n121_));
  aoi21  g88(.a(new_n121_), .b(new_n35_), .c(x11), .O(new_n122_));
  oai22  g89(.a(new_n122_), .b(x03), .c(new_n48_), .d(new_n41_), .O(new_n123_));
  nand2  g90(.a(new_n74_), .b(x14), .O(new_n124_));
  aoi21  g91(.a(new_n124_), .b(x06), .c(new_n36_), .O(new_n125_));
  oai21  g92(.a(new_n125_), .b(new_n34_), .c(new_n110_), .O(new_n126_));
  nand3  g93(.a(new_n126_), .b(new_n123_), .c(new_n54_), .O(z6));
  inv1   g94(.a(new_n61_), .O(new_n128_));
  and2   g95(.a(new_n63_), .b(new_n62_), .O(new_n129_));
  nand4  g96(.a(new_n129_), .b(new_n64_), .c(new_n128_), .d(new_n54_), .O(z7));
endmodule
