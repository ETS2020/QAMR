...
module FAU ( 
  ...
  nor2   g033(.a(new_n58_), .b(new_n54_), .O(new_n67_));
  ...
  nor4   g046(.a(new_n79_), .b(new_n58_), .c(new_n71_), .d(new_n36_), .O(new_n80_));
  nand4  g047(.a(new_n80_), .b(new_n54_), .c(x06), .d(x03), .O(new_n81_));
  ...
  aoi21  g052(.a(new_n85_), .b(new_n84_), .c(new_n58_), .O(new_n86_));
  nand4  g053(.a(new_n86_), .b(x14), .c(x11), .d(new_n54_), .O(new_n87_));
  ...
  nor2   g066(.a(new_n36_), .b(x09), .O(new_n100_));
  ...
  nand4  g071(.a(new_n58_), .b(new_n71_), .c(new_n36_), .d(new_n83_), .O(new_n105_));
  ...
  nand4  g078(.a(new_n58_), .b(x19), .c(new_n71_), .d(new_n36_), .O(new_n112_));
  inv1   g079(.a(new_n112_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n104_), .c(new_n83_), .d(new_n35_), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n111_), .c(x13), .O(new_n115_));
  aoi22  g082(.a(new_n115_), .b(new_n37_), .c(new_n108_), .d(x24), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n97_), .O(z3));
  inv1   g084(.a(new_n79_), .O(new_n118_));
  ...
  aoi21  g090(.a(new_n59_), .b(x04), .c(x17), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(x22), .c(new_n54_), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n56_), .c(new_n83_), .O(new_n126_));
  oai21  g093(.a(new_n67_), .b(new_n83_), .c(new_n126_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n122_), .c(new_n68_), .O(z4));
  nor2   g096(.a(new_n67_), .b(new_n49_), .O(z5));
  nand2  g097(.a(x20), .b(new_n71_), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(new_n35_), .c(x11), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(x03), .c(new_n123_), .O(new_n133_));
  nand2  g100(.a(new_n58_), .b(x14), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(x06), .c(new_n36_), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(new_n34_), .c(new_n118_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n133_), .c(new_n68_), .O(z6));
  inv1   g104(.a(new_n74_), .O(new_n138_));
  and2   g105(.a(new_n76_), .b(new_n75_), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n77_), .c(new_n138_), .d(new_n68_), .O(z7));
endmodule
