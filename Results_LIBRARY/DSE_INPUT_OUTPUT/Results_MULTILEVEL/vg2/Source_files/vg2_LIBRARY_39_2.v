...
module FAU ( 
  ...
  nor2   g020(.a(x22), .b(new_n36_), .O(new_n54_));
  ...
  nand4  g081(.a(new_n114_), .b(new_n109_), .c(new_n108_), .d(new_n96_), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(new_n107_), .c(x13), .O(new_n116_));
  aoi22  g083(.a(new_n116_), .b(new_n47_), .c(new_n103_), .d(x24), .O(new_n117_));
  ...
  aoi21  g089(.a(new_n122_), .b(new_n121_), .c(new_n47_), .O(new_n123_));
  ...
  nor3   g095(.a(new_n128_), .b(new_n37_), .c(new_n72_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x06), .c(x03), .d(x01), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(x22), .c(new_n36_), .O(z2));
  nand4  g098(.a(new_n60_), .b(x22), .c(x20), .d(x14), .O(new_n132_));
  ...
  oai21  g104(.a(new_n134_), .b(new_n68_), .c(new_n137_), .O(new_n138_));
  ...
  nand4  g109(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n97_), .O(new_n143_));
  nand4  g110(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n144_));
  inv1   g111(.a(new_n144_), .O(new_n145_));
  nor2   g112(.a(new_n72_), .b(new_n36_), .O(new_n146_));
  nor2   g113(.a(new_n75_), .b(new_n37_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(x18), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n143_), .c(new_n89_), .O(new_n149_));
  nor2   g116(.a(x14), .b(x11), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n140_), .c(new_n112_), .d(new_n108_), .O(new_n151_));
  nand4  g118(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(x15), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n151_), .c(x13), .O(new_n153_));
  aoi22  g120(.a(new_n153_), .b(new_n47_), .c(new_n149_), .d(x24), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n139_), .O(z3));
  aoi21  g122(.a(new_n73_), .b(x09), .c(x08), .O(new_n156_));
  oai21  g123(.a(x23), .b(new_n69_), .c(new_n74_), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n75_), .c(new_n73_), .d(new_n36_), .O(new_n158_));
  oai21  g125(.a(new_n156_), .b(new_n54_), .c(new_n158_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n50_), .O(new_n160_));
  oai21  g127(.a(new_n73_), .b(x09), .c(x08), .O(new_n161_));
  ...
  aoi21  g131(.a(new_n161_), .b(new_n55_), .c(new_n164_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n128_), .c(new_n160_), .O(z4));
  and2   g133(.a(new_n46_), .b(new_n43_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n55_), .c(new_n49_), .d(new_n42_), .O(z5));
  ...
  nand2  g139(.a(x15), .b(new_n34_), .O(new_n173_));
  oai21  g140(.a(new_n111_), .b(new_n34_), .c(new_n173_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(x13), .c(x05), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(new_n172_), .c(x24), .O(new_n176_));
  inv1   g143(.a(new_n89_), .O(new_n177_));
  nand2  g144(.a(x07), .b(x03), .O(new_n178_));
  oai21  g145(.a(new_n119_), .b(x03), .c(new_n178_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n177_), .c(x24), .O(new_n180_));
  nand3  g147(.a(new_n174_), .b(new_n48_), .c(new_n47_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(new_n176_), .c(new_n55_), .O(new_n183_));
  oai21  g150(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n50_), .c(new_n36_), .O(new_n185_));
  inv1   g152(.a(new_n128_), .O(new_n186_));
  oai21  g153(.a(x20), .b(new_n72_), .c(x06), .O(new_n187_));
  nand4  g154(.a(new_n187_), .b(new_n186_), .c(x22), .d(x11), .O(new_n188_));
  nand3  g155(.a(new_n188_), .b(new_n185_), .c(new_n183_), .O(z6));
  nor2   g156(.a(new_n128_), .b(new_n54_), .O(z7));
endmodule
