...
module FAU ( 
  ...
  nor2   g025(.a(new_n36_), .b(new_n58_), .O(new_n59_));
  and2   g026(.a(x16), .b(x15), .O(new_n60_));
  ...
  nand4  g031(.a(new_n64_), .b(new_n60_), .c(new_n59_), .d(new_n57_), .O(new_n65_));
  ...
  nand2  g047(.a(new_n45_), .b(new_n39_), .O(new_n81_));
  ...
  nand3  g051(.a(new_n59_), .b(x17), .c(x16), .O(new_n85_));
  ...
  nand4  g056(.a(new_n89_), .b(new_n86_), .c(new_n62_), .d(new_n57_), .O(new_n90_));
  nor2   g057(.a(x09), .b(x08), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n71_), .c(x07), .d(new_n34_), .O(new_n92_));
  inv1   g059(.a(x16), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n36_), .c(new_n58_), .d(new_n35_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n78_), .c(new_n88_), .d(new_n37_), .O(new_n96_));
  ...
  nand4  g066(.a(new_n99_), .b(new_n86_), .c(new_n62_), .d(new_n57_), .O(new_n100_));
  ...
  nand2  g086(.a(new_n101_), .b(new_n72_), .O(new_n120_));
  nand3  g087(.a(new_n77_), .b(new_n36_), .c(new_n35_), .O(new_n121_));
  oai22  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n117_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n83_), .O(new_n123_));
  nand2  g090(.a(new_n118_), .b(new_n89_), .O(new_n124_));
  nand3  g091(.a(new_n101_), .b(x07), .c(new_n34_), .O(new_n125_));
  inv1   g092(.a(x08), .O(new_n126_));
  nand4  g093(.a(new_n88_), .b(new_n36_), .c(new_n35_), .d(new_n126_), .O(new_n127_));
  ...
  nand2  g097(.a(new_n118_), .b(new_n99_), .O(new_n131_));
  ...
  nand2  g103(.a(new_n136_), .b(x17), .O(new_n137_));
  ...
  nand3  g108(.a(new_n50_), .b(new_n49_), .c(x00), .O(new_n142_));
  nand3  g109(.a(x19), .b(x13), .c(x05), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .O(new_n144_));
  xnor2a g111(.a(x13), .b(x05), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(x19), .c(x02), .O(new_n146_));
  inv1   g113(.a(new_n146_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n144_), .c(new_n139_), .O(new_n148_));
  nand2  g115(.a(new_n143_), .b(new_n142_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(x09), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n148_), .c(x16), .O(new_n151_));
  nand3  g118(.a(x15), .b(x13), .c(x05), .O(new_n152_));
  nand3  g119(.a(x21), .b(new_n50_), .c(new_n49_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  aoi21  g121(.a(new_n62_), .b(new_n69_), .c(new_n66_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n93_), .c(x08), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g124(.a(new_n60_), .b(x22), .c(new_n37_), .O(new_n158_));
  oai21  g125(.a(new_n76_), .b(new_n126_), .c(new_n158_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(x13), .c(x05), .O(new_n160_));
  nand3  g127(.a(x08), .b(new_n49_), .c(x00), .O(new_n161_));
  nand4  g128(.a(x22), .b(x21), .c(new_n37_), .d(x16), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n50_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n160_), .c(new_n157_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n151_), .c(new_n41_), .O(new_n166_));
  inv1   g133(.a(x07), .O(new_n167_));
  aoi21  g134(.a(x23), .b(new_n69_), .c(new_n37_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n139_), .c(x09), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x16), .c(new_n126_), .O(new_n170_));
  oai21  g137(.a(new_n141_), .b(x22), .c(new_n66_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n93_), .c(x08), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(new_n167_), .c(new_n170_), .d(new_n87_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n81_), .c(x24), .O(new_n174_));
  nand3  g141(.a(x22), .b(x16), .c(x15), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n81_), .c(new_n49_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n37_), .O(new_n177_));
  nand2  g144(.a(new_n156_), .b(x15), .O(new_n178_));
  oai21  g145(.a(new_n172_), .b(new_n76_), .c(new_n178_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n45_), .c(new_n39_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n177_), .c(new_n174_), .d(new_n166_), .O(z4));
  inv1   g148(.a(new_n43_), .O(new_n182_));
  and2   g149(.a(new_n51_), .b(new_n44_), .O(new_n183_));
  nand4  g150(.a(new_n183_), .b(new_n46_), .c(new_n182_), .d(new_n38_), .O(z5));
  nand2  g151(.a(x20), .b(new_n36_), .O(new_n185_));
  aoi21  g152(.a(new_n185_), .b(new_n34_), .c(x11), .O(new_n186_));
  nand3  g153(.a(new_n51_), .b(new_n46_), .c(new_n44_), .O(new_n187_));
  oai22  g154(.a(new_n187_), .b(new_n43_), .c(new_n186_), .d(x03), .O(new_n188_));
  nand2  g155(.a(new_n88_), .b(x14), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(x06), .O(new_n190_));
  aoi21  g157(.a(new_n190_), .b(x11), .c(new_n68_), .O(new_n191_));
  or2    g158(.a(new_n191_), .b(new_n113_), .O(new_n192_));
  nand3  g159(.a(new_n192_), .b(new_n188_), .c(new_n38_), .O(z6));
  nand2  g160(.a(new_n108_), .b(x05), .O(new_n194_));
  and2   g161(.a(new_n110_), .b(new_n109_), .O(new_n195_));
  nand4  g162(.a(new_n195_), .b(new_n111_), .c(new_n194_), .d(new_n38_), .O(z7));
endmodule
