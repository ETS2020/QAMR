...
module FAU ( 
  ...
  oai21  g115(.a(new_n56_), .b(new_n52_), .c(new_n107_), .O(new_n149_));
  inv1   g116(.a(x10), .O(new_n150_));
  nor2   g117(.a(x24), .b(x21), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n150_), .c(new_n34_), .d(x00), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n149_), .O(z5));
  nand2  g120(.a(z5), .b(new_n148_), .O(new_n154_));
  inv1   g121(.a(x23), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x04), .c(x17), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n82_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n66_), .c(x08), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n117_), .c(new_n107_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n154_), .O(z4));
  nand2  g127(.a(x20), .b(new_n41_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n37_), .c(x11), .O(new_n162_));
  nand4  g129(.a(new_n43_), .b(new_n150_), .c(new_n34_), .d(x00), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n55_), .c(new_n53_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n52_), .c(new_n162_), .d(x03), .O(new_n165_));
  inv1   g132(.a(new_n107_), .O(new_n166_));
  oai21  g133(.a(x20), .b(new_n41_), .c(x06), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(x11), .c(x03), .O(new_n168_));
  oai21  g135(.a(new_n166_), .b(x03), .c(new_n168_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n117_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n165_), .c(new_n107_), .O(z6));
  aoi21  g138(.a(new_n116_), .b(new_n111_), .c(new_n166_), .O(z7));
endmodule
