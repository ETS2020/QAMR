...
module FAU ( 
  ...
  aoi21  g125(.a(new_n144_), .b(x00), .c(new_n105_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x02), .c(new_n142_), .O(z5));
  ...
  oai21  g134(.a(new_n154_), .b(new_n105_), .c(new_n51_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n152_), .O(z7));
endmodule
