...
module FAU ( 
  ...
  nand4  g032(.a(new_n65_), .b(new_n53_), .c(new_n36_), .d(new_n52_), .O(new_n66_));
  ...
  nor4   g047(.a(new_n80_), .b(new_n54_), .c(new_n60_), .d(new_n71_), .O(new_n81_));
  ...
  nand4  g060(.a(new_n93_), .b(new_n60_), .c(new_n71_), .d(new_n36_), .O(new_n94_));
  ...
  nand4  g068(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n102_));
  nand4  g069(.a(new_n60_), .b(new_n71_), .c(new_n36_), .d(new_n84_), .O(new_n103_));
  ...
  nand4  g073(.a(new_n84_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n107_));
  nand4  g074(.a(new_n60_), .b(x19), .c(new_n71_), .d(new_n36_), .O(new_n108_));
  ...
  and2   g077(.a(new_n110_), .b(new_n105_), .O(new_n111_));
  aoi21  g078(.a(new_n111_), .b(new_n98_), .c(new_n54_), .O(z3));
  inv1   g079(.a(x21), .O(new_n113_));
  nand2  g080(.a(x08), .b(x00), .O(new_n114_));
  oai21  g081(.a(new_n113_), .b(x08), .c(new_n114_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n44_), .c(new_n43_), .O(new_n116_));
  inv1   g083(.a(x15), .O(new_n117_));
  nand2  g084(.a(x19), .b(x08), .O(new_n118_));
  oai21  g085(.a(new_n117_), .b(x08), .c(new_n118_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(x13), .c(x05), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(new_n116_), .c(x24), .O(new_n121_));
  inv1   g088(.a(x18), .O(new_n122_));
  nand2  g089(.a(x08), .b(x07), .O(new_n123_));
  oai21  g090(.a(new_n122_), .b(x08), .c(new_n123_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n99_), .c(x24), .O(new_n125_));
  nand3  g092(.a(new_n119_), .b(new_n46_), .c(new_n37_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n121_), .c(new_n55_), .O(new_n128_));
  inv1   g095(.a(new_n49_), .O(new_n129_));
  inv1   g096(.a(x22), .O(new_n130_));
  oai21  g097(.a(x23), .b(new_n57_), .c(new_n59_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n130_), .c(new_n52_), .O(new_n132_));
  oai21  g099(.a(x12), .b(new_n52_), .c(new_n132_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n129_), .c(new_n58_), .O(new_n134_));
  inv1   g101(.a(new_n80_), .O(new_n135_));
  oai21  g102(.a(new_n61_), .b(x04), .c(x17), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(x22), .c(new_n53_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(x09), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n135_), .c(x16), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n134_), .c(new_n128_), .O(z4));
  nor2   g107(.a(new_n54_), .b(new_n49_), .O(z5));
  nand2  g108(.a(x20), .b(new_n71_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n35_), .c(x11), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x03), .c(new_n129_), .O(new_n144_));
  nand2  g111(.a(new_n60_), .b(x14), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x06), .c(new_n36_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n34_), .c(new_n135_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n144_), .c(new_n55_), .O(z6));
  inv1   g115(.a(new_n74_), .O(new_n149_));
  nand4  g116(.a(new_n78_), .b(new_n75_), .c(new_n149_), .d(new_n55_), .O(z7));
endmodule
