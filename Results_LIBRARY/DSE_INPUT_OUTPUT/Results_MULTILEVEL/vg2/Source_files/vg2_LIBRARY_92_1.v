...
module FAU ( 
  ...
  nand4  g083(.a(new_n116_), .b(new_n42_), .c(x21), .d(new_n35_), .O(new_n117_));
  ...
  nor2   g088(.a(new_n40_), .b(new_n47_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(x20), .c(x15), .O(new_n123_));
  nand3  g090(.a(new_n73_), .b(new_n37_), .c(new_n36_), .O(new_n124_));
  nand3  g091(.a(new_n78_), .b(new_n40_), .c(new_n47_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n121_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n84_), .O(new_n127_));
  nand2  g094(.a(new_n122_), .b(new_n88_), .O(new_n128_));
  nand4  g095(.a(x07), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n129_));
  nand4  g096(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n100_), .O(new_n130_));
  ...
  nand3  g099(.a(new_n122_), .b(x21), .c(x20), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n121_), .c(new_n130_), .d(new_n39_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n42_), .c(new_n101_), .O(new_n135_));
  ...
  inv1   g109(.a(new_n108_), .O(new_n143_));
  nor2   g110(.a(x24), .b(x12), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n101_), .c(new_n34_), .d(x00), .O(new_n145_));
  oai21  g112(.a(new_n143_), .b(new_n56_), .c(new_n145_), .O(z5));
  nand2  g113(.a(z5), .b(new_n142_), .O(new_n147_));
  nand2  g114(.a(new_n117_), .b(new_n115_), .O(z7));
  oai21  g115(.a(new_n68_), .b(x04), .c(x17), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n71_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n92_), .c(x08), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(z7), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n147_), .O(z4));
  nand2  g120(.a(x20), .b(new_n40_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n38_), .c(x11), .O(new_n155_));
  nand4  g122(.a(new_n42_), .b(new_n101_), .c(new_n34_), .d(x00), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n54_), .c(new_n52_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n51_), .c(new_n155_), .d(x03), .O(new_n158_));
  oai21  g125(.a(x20), .b(new_n40_), .c(x06), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(x11), .c(x03), .O(new_n160_));
  oai21  g127(.a(x12), .b(x03), .c(new_n160_), .O(new_n161_));
  nand3  g128(.a(new_n116_), .b(new_n42_), .c(x21), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n113_), .c(new_n112_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n111_), .c(new_n161_), .O(new_n164_));
  or2    g131(.a(new_n114_), .b(new_n111_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n37_), .c(x02), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n164_), .c(new_n158_), .d(new_n108_), .O(z6));
endmodule
