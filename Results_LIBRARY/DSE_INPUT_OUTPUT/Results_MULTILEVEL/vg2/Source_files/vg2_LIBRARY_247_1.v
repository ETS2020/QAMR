...
module FAU ( 
  ...
  nor2   g045(.a(new_n42_), .b(new_n35_), .O(new_n79_));
  ...
  nand4  g066(.a(new_n99_), .b(new_n98_), .c(new_n81_), .d(new_n76_), .O(new_n100_));
  ...
  nand2  g074(.a(x17), .b(new_n34_), .O(new_n108_));
  nand2  g075(.a(x24), .b(x18), .O(new_n109_));
  nand3  g076(.a(new_n43_), .b(x15), .c(x13), .O(new_n110_));
  aoi21  g077(.a(new_n110_), .b(new_n109_), .c(new_n53_), .O(new_n111_));
  nand3  g078(.a(x24), .b(x18), .c(x13), .O(new_n112_));
  nand3  g079(.a(x15), .b(new_n54_), .c(new_n53_), .O(new_n113_));
  ...
  nor2   g084(.a(x24), .b(new_n117_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(new_n116_), .c(new_n35_), .O(new_n119_));
  aoi21  g086(.a(new_n119_), .b(new_n115_), .c(new_n42_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(x14), .c(x11), .d(x06), .O(new_n121_));
  nor3   g088(.a(new_n121_), .b(new_n36_), .c(new_n107_), .O(z2));
  inv1   g089(.a(x08), .O(new_n123_));
  nand3  g090(.a(x15), .b(x13), .c(x05), .O(new_n124_));
  inv1   g091(.a(x10), .O(new_n125_));
  nand3  g092(.a(x21), .b(new_n125_), .c(new_n34_), .O(new_n126_));
  ...
  nand3  g097(.a(new_n125_), .b(new_n34_), .c(x00), .O(new_n131_));
  nand3  g098(.a(x19), .b(x13), .c(x05), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n42_), .c(new_n41_), .d(new_n48_), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(x08), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n37_), .c(new_n36_), .d(new_n107_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n130_), .c(x24), .O(new_n137_));
  nand4  g104(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n138_));
  nand3  g105(.a(new_n99_), .b(x14), .c(x11), .O(new_n139_));
  nand4  g106(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n107_), .O(new_n140_));
  nand4  g107(.a(new_n42_), .b(new_n41_), .c(new_n48_), .d(new_n123_), .O(new_n141_));
  ...
  nand3  g111(.a(new_n62_), .b(new_n36_), .c(new_n107_), .O(new_n145_));
  nand3  g112(.a(new_n89_), .b(new_n41_), .c(new_n48_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n138_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n54_), .c(new_n53_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n137_), .c(new_n35_), .O(new_n150_));
  nand2  g117(.a(new_n147_), .b(new_n95_), .O(new_n151_));
  ...
  nand2  g121(.a(new_n90_), .b(x04), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n83_), .c(x16), .O(new_n156_));
  nand2  g123(.a(new_n51_), .b(x05), .O(new_n157_));
  nand4  g124(.a(new_n43_), .b(new_n125_), .c(new_n34_), .d(x00), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n55_), .c(new_n52_), .d(new_n157_), .O(new_n159_));
  oai21  g126(.a(new_n156_), .b(x08), .c(new_n159_), .O(new_n160_));
  aoi21  g127(.a(new_n65_), .b(x09), .c(new_n67_), .O(new_n161_));
  nand2  g128(.a(new_n118_), .b(new_n116_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n113_), .c(new_n112_), .O(new_n163_));
  or2    g130(.a(new_n163_), .b(new_n111_), .O(new_n164_));
  oai21  g131(.a(new_n161_), .b(new_n123_), .c(new_n164_), .O(new_n165_));
  ...
  oai21  g135(.a(new_n80_), .b(x04), .c(x09), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x16), .c(new_n123_), .O(new_n170_));
  nor2   g137(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  oai21  g138(.a(x22), .b(new_n35_), .c(new_n83_), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n67_), .c(x08), .O(new_n173_));
  nor2   g140(.a(new_n173_), .b(new_n57_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n171_), .c(x02), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n167_), .O(z4));
  nand3  g143(.a(new_n43_), .b(new_n125_), .c(x00), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n35_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n34_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n57_), .O(z5));
  nand2  g147(.a(x20), .b(new_n41_), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(new_n37_), .c(x11), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(x03), .c(new_n159_), .O(new_n183_));
  nand2  g150(.a(new_n42_), .b(x14), .O(new_n184_));
  aoi21  g151(.a(new_n184_), .b(x06), .c(new_n48_), .O(new_n185_));
  oai21  g152(.a(new_n185_), .b(new_n36_), .c(new_n164_), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(new_n183_), .c(new_n108_), .O(z6));
  aoi21  g154(.a(new_n118_), .b(new_n125_), .c(x17), .O(new_n188_));
  oai21  g155(.a(new_n188_), .b(x02), .c(new_n168_), .O(z7));
endmodule
