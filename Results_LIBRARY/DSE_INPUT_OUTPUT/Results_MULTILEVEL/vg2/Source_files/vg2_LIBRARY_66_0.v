...
module FAU ( 
  ...
  nand4  g070(.a(x11), .b(new_n96_), .c(x06), .d(x01), .O(new_n104_));
  nor2   g071(.a(x24), .b(new_n99_), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(x20), .c(x14), .O(new_n106_));
  oai21  g073(.a(new_n106_), .b(new_n104_), .c(x03), .O(new_n107_));
  nand2  g074(.a(new_n107_), .b(new_n93_), .O(new_n108_));
  ...
  oai21  g085(.a(new_n118_), .b(new_n34_), .c(new_n108_), .O(z2));
  nand4  g086(.a(new_n96_), .b(x08), .c(x06), .d(x01), .O(new_n120_));
  nor2   g087(.a(new_n109_), .b(new_n36_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n105_), .c(x20), .O(new_n122_));
  oai21  g089(.a(new_n122_), .b(new_n120_), .c(x03), .O(new_n123_));
  ...
  nand3  g093(.a(new_n66_), .b(new_n62_), .c(new_n34_), .O(new_n127_));
  ...
  nand3  g098(.a(new_n84_), .b(new_n62_), .c(new_n34_), .O(new_n132_));
  ...
  nor2   g108(.a(new_n46_), .b(new_n42_), .O(new_n142_));
  nor2   g109(.a(x03), .b(x02), .O(new_n143_));
  nor2   g110(.a(x24), .b(x10), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(x03), .c(new_n93_), .d(x00), .O(new_n145_));
  oai21  g112(.a(new_n143_), .b(new_n142_), .c(new_n145_), .O(z5));
  ...
  nor2   g119(.a(new_n115_), .b(new_n112_), .O(new_n153_));
  nand2  g120(.a(new_n105_), .b(new_n96_), .O(new_n154_));
  inv1   g121(.a(new_n154_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(x03), .c(new_n93_), .O(new_n156_));
  oai21  g123(.a(new_n143_), .b(new_n153_), .c(new_n156_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n152_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n147_), .O(z4));
  oai21  g126(.a(x20), .b(new_n109_), .c(x06), .O(new_n160_));
  nand3  g127(.a(new_n105_), .b(new_n96_), .c(new_n93_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n114_), .c(new_n113_), .O(new_n162_));
  or2    g129(.a(new_n162_), .b(new_n112_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(x11), .O(new_n164_));
  nand2  g131(.a(new_n144_), .b(x00), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(x03), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n93_), .O(new_n167_));
  oai21  g134(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n36_), .c(x03), .O(new_n169_));
  nand2  g136(.a(x15), .b(new_n62_), .O(new_n170_));
  oai21  g137(.a(new_n169_), .b(new_n70_), .c(new_n170_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n77_), .O(new_n172_));
  nand2  g139(.a(x18), .b(new_n62_), .O(new_n173_));
  oai21  g140(.a(new_n169_), .b(new_n83_), .c(new_n173_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n75_), .c(x24), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n172_), .c(new_n167_), .d(new_n164_), .O(z6));
  oai21  g143(.a(new_n155_), .b(new_n62_), .c(new_n93_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n153_), .O(z7));
endmodule
