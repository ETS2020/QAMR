...
module FAU ( 
  ...
  nor2   g098(.a(x03), .b(x01), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n68_), .O(new_n133_));
  nand3  g100(.a(new_n73_), .b(new_n89_), .c(new_n36_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n131_), .d(new_n129_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n79_), .O(new_n136_));
  nand3  g103(.a(new_n130_), .b(x20), .c(x18), .O(new_n137_));
  nand3  g104(.a(new_n132_), .b(x07), .c(new_n35_), .O(new_n138_));
  nand4  g105(.a(new_n37_), .b(new_n89_), .c(new_n36_), .d(new_n58_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n129_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n77_), .c(x24), .O(new_n141_));
  nand4  g108(.a(new_n45_), .b(x08), .c(x06), .d(x03), .O(new_n142_));
  inv1   g109(.a(x21), .O(new_n143_));
  nor2   g110(.a(x24), .b(new_n143_), .O(new_n144_));
  nand3  g111(.a(new_n130_), .b(new_n144_), .c(x20), .O(new_n145_));
  ...
  nand4  g117(.a(new_n150_), .b(new_n149_), .c(new_n148_), .d(new_n107_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n147_), .c(new_n141_), .d(new_n136_), .O(z3));
  oai21  g119(.a(x23), .b(new_n54_), .c(new_n87_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n112_), .c(x09), .O(new_n154_));
  ...
  oai21  g127(.a(new_n101_), .b(x04), .c(x17), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x22), .c(new_n66_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n90_), .c(x08), .O(new_n163_));
  nand2  g130(.a(new_n122_), .b(new_n121_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n120_), .c(new_n156_), .O(new_n165_));
  nand3  g132(.a(new_n144_), .b(new_n45_), .c(new_n44_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n165_), .O(z7));
  nand2  g134(.a(z7), .b(new_n163_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n160_), .O(z4));
  nand2  g136(.a(x20), .b(new_n89_), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(new_n35_), .c(x11), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n172_));
  oai21  g139(.a(x20), .b(new_n89_), .c(x06), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(x11), .c(x03), .O(new_n174_));
  nand2  g141(.a(new_n156_), .b(new_n34_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n77_), .c(x18), .O(new_n177_));
  inv1   g144(.a(new_n122_), .O(new_n178_));
  nand2  g145(.a(new_n132_), .b(new_n178_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n177_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(x24), .O(new_n181_));
  nand2  g148(.a(x24), .b(new_n34_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n47_), .c(new_n38_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n78_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(x15), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n166_), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(new_n173_), .c(x11), .O(new_n187_));
  inv1   g154(.a(new_n156_), .O(new_n188_));
  and2   g155(.a(new_n123_), .b(new_n122_), .O(new_n189_));
  nand2  g156(.a(x13), .b(x05), .O(new_n190_));
  nand2  g157(.a(new_n190_), .b(new_n77_), .O(new_n191_));
  nand3  g158(.a(new_n191_), .b(new_n40_), .c(x15), .O(new_n192_));
  oai21  g159(.a(new_n189_), .b(x02), .c(new_n192_), .O(new_n193_));
  aoi21  g160(.a(new_n193_), .b(new_n34_), .c(new_n188_), .O(new_n194_));
  nand4  g161(.a(new_n194_), .b(new_n187_), .c(new_n181_), .d(new_n172_), .O(z6));
endmodule
