...
module FAU ( 
  ...
  nand3  g062(.a(new_n95_), .b(new_n73_), .c(new_n71_), .O(new_n96_));
  ...
  aoi21  g079(.a(new_n112_), .b(x02), .c(new_n54_), .O(z2));
  ...
  nand3  g086(.a(new_n84_), .b(new_n54_), .c(new_n36_), .O(new_n120_));
  nor2   g087(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(new_n117_), .c(new_n90_), .O(new_n122_));
  inv1   g089(.a(new_n115_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n93_), .c(x14), .O(new_n124_));
  ...
  nand3  g095(.a(new_n128_), .b(new_n88_), .c(x24), .O(new_n129_));
  nor3   g096(.a(x06), .b(x03), .c(x02), .O(new_n130_));
  nor3   g097(.a(x11), .b(x10), .c(x08), .O(new_n131_));
  nor3   g098(.a(x24), .b(x20), .c(x14), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n56_), .O(new_n133_));
  ...
  oai21  g104(.a(x23), .b(new_n136_), .c(new_n137_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n135_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n97_), .O(new_n140_));
  nand2  g107(.a(x14), .b(new_n44_), .O(new_n141_));
  nand2  g108(.a(new_n48_), .b(new_n43_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n42_), .c(new_n141_), .O(new_n143_));
  nor2   g110(.a(x24), .b(x14), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n45_), .c(new_n44_), .d(x00), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n143_), .O(z5));
  nand2  g113(.a(z5), .b(new_n140_), .O(new_n147_));
  inv1   g114(.a(x23), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x04), .c(x17), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n78_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n62_), .c(x08), .O(new_n151_));
  oai21  g118(.a(new_n109_), .b(new_n107_), .c(new_n141_), .O(new_n152_));
  nor2   g119(.a(x10), .b(x02), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n40_), .c(x21), .d(new_n54_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n152_), .O(z7));
  ...
  oai21  g126(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n160_));
  nor2   g127(.a(new_n37_), .b(x14), .O(new_n161_));
  aoi22  g128(.a(new_n161_), .b(new_n36_), .c(new_n160_), .d(new_n141_), .O(new_n162_));
  nor2   g129(.a(new_n162_), .b(new_n83_), .O(new_n163_));
  nand3  g130(.a(new_n37_), .b(x15), .c(x14), .O(new_n164_));
  nor3   g131(.a(new_n164_), .b(new_n36_), .c(new_n44_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n163_), .c(new_n90_), .O(new_n166_));
  nor2   g133(.a(new_n36_), .b(new_n44_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n37_), .c(x18), .d(x14), .O(new_n168_));
  oai21  g135(.a(new_n162_), .b(new_n98_), .c(new_n168_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n88_), .c(x24), .O(new_n170_));
  nor2   g137(.a(x20), .b(x06), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(x11), .c(new_n34_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n40_), .c(new_n54_), .d(new_n45_), .O(new_n173_));
  inv1   g140(.a(new_n173_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n44_), .c(x00), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n170_), .c(new_n166_), .d(new_n159_), .O(z6));
endmodule
