...
module FAU ( 
  ...
  nand4  g055(.a(new_n88_), .b(new_n87_), .c(new_n65_), .d(new_n58_), .O(new_n89_));
  nor2   g056(.a(x09), .b(x08), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n71_), .c(x07), .d(new_n35_), .O(new_n91_));
  inv1   g058(.a(x14), .O(new_n92_));
  inv1   g059(.a(x16), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n92_), .c(new_n53_), .d(new_n36_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n78_), .c(new_n37_), .d(new_n61_), .O(new_n96_));
  ...
  nand4  g066(.a(new_n99_), .b(new_n87_), .c(new_n65_), .d(new_n58_), .O(new_n100_));
  ...
  nand3  g072(.a(new_n105_), .b(new_n98_), .c(new_n85_), .O(z1));
  ...
  nor2   g081(.a(new_n114_), .b(new_n92_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x11), .c(x06), .d(x03), .O(new_n116_));
  oai21  g083(.a(new_n116_), .b(new_n68_), .c(new_n54_), .O(z2));
  ...
  nand4  g094(.a(new_n127_), .b(new_n37_), .c(new_n92_), .d(new_n36_), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(x08), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n130_));
  ...
  nand3  g101(.a(new_n101_), .b(x07), .c(new_n35_), .O(new_n135_));
  nand4  g102(.a(new_n37_), .b(new_n92_), .c(new_n36_), .d(new_n118_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n133_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n82_), .c(x24), .O(new_n138_));
  nand4  g105(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n139_));
  nand2  g106(.a(new_n101_), .b(new_n72_), .O(new_n140_));
  nand3  g107(.a(new_n77_), .b(new_n92_), .c(new_n36_), .O(new_n141_));
  ...
  nand3  g110(.a(new_n143_), .b(new_n138_), .c(new_n54_), .O(new_n144_));
  inv1   g111(.a(new_n144_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n132_), .O(z3));
  oai21  g113(.a(x23), .b(new_n69_), .c(new_n61_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n63_), .c(x09), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n118_), .O(new_n149_));
  ...
  nand2  g119(.a(z5), .b(new_n149_), .O(new_n153_));
  oai21  g120(.a(new_n64_), .b(x04), .c(x17), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x22), .c(new_n67_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n93_), .c(x08), .O(new_n156_));
  nand2  g123(.a(new_n111_), .b(new_n110_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n109_), .c(new_n54_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n112_), .O(z7));
  nand2  g126(.a(z7), .b(new_n156_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n153_), .O(z4));
  aoi21  g128(.a(x20), .b(new_n92_), .c(x06), .O(new_n162_));
