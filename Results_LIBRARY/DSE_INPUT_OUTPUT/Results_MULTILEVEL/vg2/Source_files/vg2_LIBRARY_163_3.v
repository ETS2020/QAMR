...
module FAU ( 
  ...
  nor2   g055(.a(new_n37_), .b(new_n88_), .O(new_n89_));
  nand3  g056(.a(new_n89_), .b(new_n87_), .c(new_n65_), .O(new_n90_));
  ...
  nand3  g066(.a(new_n65_), .b(x21), .c(x20), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n59_), .c(new_n57_), .d(x01), .O(new_n102_));
  ...
  oai21  g078(.a(new_n111_), .b(new_n109_), .c(x05), .O(new_n112_));
  nand2  g079(.a(new_n109_), .b(x13), .O(new_n113_));
  nand3  g080(.a(x15), .b(new_n47_), .c(new_n38_), .O(new_n114_));
  nand3  g081(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(new_n112_), .O(new_n116_));
  ...
  nor2   g086(.a(new_n119_), .b(new_n54_), .O(z2));
  nand3  g087(.a(new_n55_), .b(x06), .c(x03), .O(new_n121_));
  ...
  nand4  g092(.a(new_n125_), .b(new_n103_), .c(new_n78_), .d(new_n69_), .O(new_n126_));
  oai21  g093(.a(new_n124_), .b(new_n121_), .c(new_n126_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n84_), .O(new_n128_));
  nand3  g095(.a(new_n123_), .b(new_n89_), .c(x14), .O(new_n129_));
  nand2  g096(.a(new_n103_), .b(new_n92_), .O(new_n130_));
  nand4  g097(.a(new_n37_), .b(new_n73_), .c(new_n36_), .d(new_n122_), .O(new_n131_));
  ...
  nand2  g106(.a(x14), .b(x02), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(x08), .O(new_n141_));
  inv1   g108(.a(x09), .O(new_n142_));
  aoi21  g109(.a(new_n64_), .b(x04), .c(x17), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x22), .c(new_n142_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n74_), .c(new_n122_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n141_), .c(new_n91_), .O(new_n146_));
  inv1   g113(.a(x04), .O(new_n147_));
  aoi21  g114(.a(x23), .b(new_n147_), .c(new_n75_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n63_), .c(x09), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(x16), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x08), .c(new_n88_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n146_), .c(new_n82_), .O(new_n152_));
  nor2   g119(.a(new_n122_), .b(x05), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(x19), .c(new_n73_), .d(new_n47_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(x24), .O(new_n156_));
  nand2  g123(.a(new_n84_), .b(x15), .O(new_n157_));
  nand4  g124(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n158_));
  aoi22  g125(.a(new_n158_), .b(new_n157_), .c(new_n150_), .d(x08), .O(new_n159_));
  nand2  g126(.a(x24), .b(x08), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n47_), .c(new_n38_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n83_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x19), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n46_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n144_), .c(new_n74_), .O(new_n165_));
  nand3  g132(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n48_), .c(x02), .O(new_n167_));
  nand2  g134(.a(x13), .b(x05), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n82_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n40_), .c(x19), .O(new_n170_));
  inv1   g137(.a(new_n170_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n167_), .c(x08), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n165_), .c(new_n140_), .O(new_n173_));
  nor2   g140(.a(new_n173_), .b(new_n159_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n156_), .O(z4));
  nand2  g142(.a(new_n48_), .b(new_n43_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n42_), .c(new_n140_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n46_), .O(z5));
  nand2  g145(.a(x20), .b(new_n73_), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n35_), .c(x11), .O(new_n180_));
  oai22  g147(.a(new_n180_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n181_));
  inv1   g148(.a(new_n169_), .O(new_n182_));
  nand3  g149(.a(new_n37_), .b(x14), .c(new_n44_), .O(new_n183_));
  aoi21  g150(.a(new_n183_), .b(x06), .c(new_n36_), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n34_), .c(x15), .O(new_n185_));
  nand4  g152(.a(x20), .b(x19), .c(new_n36_), .d(x02), .O(new_n186_));
  aoi21  g153(.a(new_n186_), .b(new_n185_), .c(new_n182_), .O(new_n187_));
  nand2  g154(.a(new_n37_), .b(x14), .O(new_n188_));
  aoi21  g155(.a(new_n188_), .b(x06), .c(new_n36_), .O(new_n189_));
  or2    g156(.a(new_n189_), .b(new_n34_), .O(new_n190_));
  nand4  g157(.a(new_n190_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n191_));
  inv1   g158(.a(new_n191_), .O(new_n192_));
  oai21  g159(.a(new_n192_), .b(new_n187_), .c(new_n40_), .O(new_n193_));
  nand2  g160(.a(new_n189_), .b(x03), .O(new_n194_));
  nand2  g161(.a(new_n140_), .b(new_n34_), .O(new_n195_));
  nand2  g162(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  nand3  g163(.a(new_n196_), .b(new_n82_), .c(x18), .O(new_n197_));
  nand2  g164(.a(x11), .b(x03), .O(new_n198_));
  oai22  g165(.a(new_n198_), .b(new_n188_), .c(x14), .d(x03), .O(new_n199_));
  nand4  g166(.a(new_n199_), .b(x15), .c(new_n47_), .d(new_n38_), .O(new_n200_));
  nand2  g167(.a(new_n200_), .b(new_n197_), .O(new_n201_));
  nand3  g168(.a(x11), .b(new_n35_), .c(x03), .O(new_n202_));
  oai21  g169(.a(x03), .b(x02), .c(new_n202_), .O(new_n203_));
  nand4  g170(.a(new_n203_), .b(x15), .c(new_n47_), .d(new_n38_), .O(new_n204_));
  nand2  g171(.a(new_n204_), .b(new_n140_), .O(new_n205_));
  aoi21  g172(.a(new_n201_), .b(x24), .c(new_n205_), .O(new_n206_));
  nand3  g173(.a(new_n206_), .b(new_n193_), .c(new_n181_), .O(z6));
  nand3  g174(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(new_n208_));
  nand2  g175(.a(new_n208_), .b(new_n140_), .O(new_n209_));
  nand2  g176(.a(new_n209_), .b(new_n158_), .O(z7));
endmodule
