...
module FAU ( 
  ...
  nor2   g053(.a(new_n55_), .b(new_n68_), .O(new_n87_));
  ...
  nand4  g062(.a(new_n95_), .b(new_n94_), .c(new_n67_), .d(new_n66_), .O(new_n96_));
  oai21  g063(.a(new_n96_), .b(new_n91_), .c(new_n88_), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n79_), .c(x24), .O(new_n98_));
  nand3  g065(.a(x15), .b(x14), .c(x12), .O(new_n99_));
  nand3  g066(.a(new_n87_), .b(x20), .c(x17), .O(new_n100_));
  ...
  nand4  g070(.a(new_n103_), .b(new_n89_), .c(new_n36_), .d(new_n65_), .O(new_n104_));
  ...
  nand4  g075(.a(new_n108_), .b(new_n106_), .c(new_n105_), .d(new_n95_), .O(new_n109_));
  oai21  g076(.a(new_n109_), .b(new_n104_), .c(new_n102_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n46_), .c(new_n37_), .O(new_n111_));
  nand2  g078(.a(new_n92_), .b(x14), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n111_), .c(new_n98_), .O(new_n113_));
  inv1   g080(.a(new_n113_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n78_), .O(z1));
  nor2   g082(.a(new_n39_), .b(new_n85_), .O(new_n116_));
  ...
  nor3   g091(.a(new_n124_), .b(new_n67_), .c(new_n36_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x06), .c(x03), .d(x01), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(x16), .c(new_n54_), .O(z2));
  ...
  nand2  g099(.a(new_n70_), .b(new_n69_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n67_), .c(new_n54_), .d(new_n36_), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(x08), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n35_), .c(new_n34_), .d(new_n80_), .O(new_n136_));
  ...
  nor2   g106(.a(new_n54_), .b(new_n36_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n86_), .O(new_n141_));
  nand4  g108(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n80_), .O(new_n142_));
  nand4  g109(.a(new_n67_), .b(new_n54_), .c(new_n36_), .d(new_n128_), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n139_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n79_), .c(x24), .O(new_n145_));
  nand3  g112(.a(new_n140_), .b(x20), .c(x15), .O(new_n146_));
  nand3  g113(.a(new_n103_), .b(new_n34_), .c(new_n80_), .O(new_n147_));
  nand3  g114(.a(new_n108_), .b(new_n54_), .c(new_n36_), .O(new_n148_));
  ...
  nand4  g117(.a(new_n150_), .b(new_n145_), .c(new_n138_), .d(new_n112_), .O(z3));
  inv1   g118(.a(new_n49_), .O(new_n152_));
  oai21  g119(.a(x23), .b(new_n64_), .c(new_n66_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n68_), .c(x09), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x16), .c(new_n128_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  oai21  g123(.a(new_n55_), .b(x04), .c(x17), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x22), .c(new_n65_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n92_), .c(x08), .O(new_n159_));
  oai21  g126(.a(new_n123_), .b(new_n119_), .c(new_n159_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n156_), .c(new_n112_), .O(z4));
  inv1   g128(.a(new_n41_), .O(new_n162_));
  and2   g129(.a(new_n45_), .b(new_n42_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n112_), .c(new_n47_), .d(new_n162_), .O(z5));
  aoi21  g131(.a(new_n36_), .b(x06), .c(x03), .O(new_n165_));
  aoi21  g132(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n124_), .c(new_n165_), .d(new_n49_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n112_), .O(new_n168_));
  inv1   g135(.a(new_n140_), .O(new_n169_));
  nand4  g136(.a(x20), .b(new_n54_), .c(new_n36_), .d(x00), .O(new_n170_));
  nand3  g137(.a(x21), .b(new_n67_), .c(x16), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n169_), .c(new_n170_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n44_), .c(new_n43_), .O(new_n173_));
  nand4  g140(.a(x20), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n174_));
  nand3  g141(.a(new_n67_), .b(x16), .c(x15), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n169_), .c(new_n174_), .O(new_n176_));
  ...
  nand4  g146(.a(x20), .b(new_n54_), .c(new_n36_), .d(x07), .O(new_n180_));
  nand3  g147(.a(new_n67_), .b(x18), .c(x16), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(new_n169_), .c(new_n180_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n79_), .c(x24), .O(new_n183_));
  nand3  g150(.a(new_n176_), .b(new_n46_), .c(new_n37_), .O(new_n184_));
  nand4  g151(.a(new_n184_), .b(new_n183_), .c(new_n179_), .d(new_n168_), .O(z6));
  inv1   g152(.a(new_n119_), .O(new_n186_));
  and2   g153(.a(new_n121_), .b(new_n120_), .O(new_n187_));
  nand4  g154(.a(new_n187_), .b(new_n122_), .c(new_n186_), .d(new_n112_), .O(z7));
endmodule
