...
module FAU ( 
  ...
  oai21  g085(.a(new_n118_), .b(x22), .c(new_n65_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n116_), .c(new_n111_), .O(new_n120_));
  oai21  g087(.a(new_n56_), .b(new_n111_), .c(new_n120_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n51_), .O(new_n122_));
  or2    g089(.a(new_n98_), .b(new_n96_), .O(new_n123_));
  oai21  g090(.a(new_n117_), .b(x04), .c(x17), .O(new_n124_));
  aoi21  g091(.a(new_n124_), .b(x22), .c(new_n65_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n116_), .c(x08), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(new_n123_), .c(new_n56_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n122_), .O(z4));
  aoi21  g095(.a(new_n50_), .b(new_n44_), .c(new_n56_), .O(z5));
  nand2  g096(.a(x20), .b(new_n37_), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n35_), .c(x11), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(x03), .c(new_n51_), .O(new_n132_));
  nand2  g099(.a(new_n38_), .b(x14), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(x06), .c(new_n36_), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n34_), .c(new_n123_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n132_), .c(new_n56_), .O(z6));
  and2   g103(.a(new_n123_), .b(new_n39_), .O(z7));
endmodule
