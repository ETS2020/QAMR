...
module FAU ( 
  ...
  nand2  g019(.a(x16), .b(new_n52_), .O(new_n53_));
  ...
  nand4  g063(.a(new_n68_), .b(new_n67_), .c(x07), .d(new_n35_), .O(new_n97_));
  inv1   g064(.a(new_n97_), .O(new_n98_));
  nand4  g065(.a(new_n70_), .b(new_n69_), .c(new_n52_), .d(new_n36_), .O(new_n99_));
  ...
  nand4  g074(.a(new_n36_), .b(new_n68_), .c(new_n67_), .d(new_n35_), .O(new_n108_));
  inv1   g075(.a(new_n108_), .O(new_n109_));
  nand4  g076(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(new_n52_), .O(new_n110_));
  ...
  nor3   g092(.a(new_n125_), .b(new_n72_), .c(new_n69_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x11), .c(x06), .d(x03), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n65_), .c(new_n53_), .O(z2));
  nand4  g095(.a(new_n57_), .b(x20), .c(x14), .d(x11), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(new_n67_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(x06), .c(x03), .d(x01), .O(new_n131_));
  nand4  g098(.a(new_n77_), .b(new_n72_), .c(new_n69_), .d(new_n36_), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(x08), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n134_));
  ...
  nand4  g106(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n140_));
  nand4  g107(.a(new_n72_), .b(new_n69_), .c(new_n36_), .d(new_n67_), .O(new_n141_));
  ...
  nand4  g111(.a(new_n67_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n145_));
  nand4  g112(.a(new_n72_), .b(x19), .c(new_n69_), .d(new_n36_), .O(new_n146_));
  ...
  nand3  g134(.a(new_n167_), .b(new_n165_), .c(new_n70_), .O(new_n168_));
  ...
  nand4  g138(.a(new_n171_), .b(new_n169_), .c(x16), .d(x12), .O(new_n172_));
  ...
  nand2  g143(.a(x20), .b(new_n69_), .O(new_n177_));
