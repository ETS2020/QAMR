...
module FAU ( 
  ...
  nor2   g066(.a(new_n99_), .b(new_n39_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n88_), .c(new_n67_), .d(new_n60_), .O(new_n101_));
  ...
  nand4  g072(.a(new_n105_), .b(new_n41_), .c(new_n46_), .d(new_n34_), .O(new_n106_));
  nor2   g073(.a(x14), .b(new_n34_), .O(new_n107_));
  inv1   g074(.a(new_n107_), .O(new_n108_));
  nand4  g075(.a(new_n108_), .b(new_n106_), .c(new_n98_), .d(new_n86_), .O(z1));
  nand2  g076(.a(x24), .b(x18), .O(new_n110_));
  nand3  g077(.a(new_n41_), .b(x15), .c(x13), .O(new_n111_));
  aoi21  g078(.a(new_n111_), .b(new_n110_), .c(new_n48_), .O(new_n112_));
  nand3  g079(.a(x24), .b(x18), .c(x13), .O(new_n113_));
  nand3  g080(.a(x15), .b(new_n49_), .c(new_n48_), .O(new_n114_));
  nand4  g081(.a(new_n41_), .b(x21), .c(new_n46_), .d(new_n34_), .O(new_n115_));
  ...
  oai21  g086(.a(new_n119_), .b(new_n70_), .c(new_n108_), .O(z2));
  ...
  nand4  g090(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n124_));
  nand4  g091(.a(new_n79_), .b(new_n38_), .c(new_n37_), .d(new_n69_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n121_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n85_), .O(new_n127_));
  nand2  g094(.a(new_n122_), .b(new_n89_), .O(new_n128_));
  nor2   g095(.a(x20), .b(x14), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n37_), .c(new_n69_), .d(x07), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n124_), .c(new_n128_), .d(new_n121_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n83_), .c(x24), .O(new_n132_));
  nand4  g099(.a(new_n36_), .b(new_n35_), .c(new_n70_), .d(x00), .O(new_n133_));
  nand3  g100(.a(new_n129_), .b(new_n37_), .c(new_n69_), .O(new_n134_));
  nand2  g101(.a(new_n122_), .b(new_n100_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n121_), .c(new_n134_), .d(new_n133_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n41_), .c(new_n46_), .d(new_n34_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n132_), .c(new_n127_), .O(z3));
  oai21  g105(.a(x23), .b(new_n71_), .c(new_n63_), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(new_n65_), .c(x09), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x16), .c(new_n69_), .O(new_n141_));
  nand2  g108(.a(new_n50_), .b(new_n45_), .O(new_n142_));
  aoi21  g109(.a(new_n43_), .b(x05), .c(new_n142_), .O(new_n143_));
  nand4  g110(.a(new_n41_), .b(new_n46_), .c(new_n34_), .d(x00), .O(new_n144_));
  oai21  g111(.a(new_n143_), .b(new_n107_), .c(new_n144_), .O(z5));
  nand2  g112(.a(z5), .b(new_n141_), .O(new_n146_));
  ...
  nand2  g118(.a(new_n114_), .b(new_n113_), .O(new_n152_));
  nor2   g119(.a(new_n152_), .b(new_n112_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n107_), .c(new_n115_), .O(z7));
  nand2  g121(.a(z7), .b(new_n151_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n146_), .O(z4));
  nand2  g123(.a(x20), .b(new_n38_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n36_), .c(x11), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x03), .c(new_n53_), .O(new_n159_));
  oai21  g126(.a(new_n37_), .b(x06), .c(x03), .O(new_n160_));
  nor2   g127(.a(x24), .b(new_n99_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n46_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n114_), .c(new_n113_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n112_), .c(new_n160_), .O(new_n164_));
  nand4  g131(.a(new_n122_), .b(new_n161_), .c(new_n39_), .d(new_n46_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n164_), .c(new_n159_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n34_), .O(new_n167_));
  aoi21  g134(.a(new_n37_), .b(x06), .c(x03), .O(new_n168_));
  nand2  g135(.a(x20), .b(x06), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x11), .c(new_n35_), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n153_), .c(new_n168_), .d(new_n143_), .O(new_n171_));
