...
module FAU ( 
  ...
  oai21  g082(.a(new_n115_), .b(new_n68_), .c(new_n38_), .O(z2));
  ...
  oai21  g105(.a(x23), .b(new_n70_), .c(new_n60_), .O(new_n139_));
  ...
  nand4  g109(.a(new_n51_), .b(new_n46_), .c(new_n44_), .d(new_n142_), .O(new_n143_));
  ...
  oai21  g114(.a(new_n112_), .b(new_n108_), .c(new_n147_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n144_), .c(new_n38_), .O(z4));
  and2   g116(.a(new_n46_), .b(new_n38_), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n51_), .c(new_n44_), .d(new_n142_), .O(z5));
  nand2  g118(.a(new_n51_), .b(new_n48_), .O(new_n152_));
  aoi21  g119(.a(x20), .b(new_n36_), .c(x06), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x11), .c(new_n69_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  aoi21  g122(.a(new_n61_), .b(x14), .c(new_n34_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n35_), .c(x03), .O(new_n157_));
  nand2  g124(.a(new_n110_), .b(new_n109_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n108_), .c(new_n38_), .O(new_n159_));
  ...
  inv1   g129(.a(new_n108_), .O(new_n163_));
  and2   g130(.a(new_n111_), .b(new_n110_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n109_), .c(new_n163_), .d(new_n38_), .O(z7));
endmodule
