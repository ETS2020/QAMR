...
module FAU ( 
  ...
  nand4  g066(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n60_), .c(new_n58_), .d(x01), .O(new_n102_));
  ...
  aoi21  g085(.a(new_n118_), .b(new_n44_), .c(new_n34_), .O(z2));
  nand3  g086(.a(new_n56_), .b(x06), .c(x03), .O(new_n120_));
  inv1   g087(.a(x08), .O(new_n121_));
  nor2   g088(.a(new_n36_), .b(new_n121_), .O(new_n122_));
  inv1   g089(.a(x15), .O(new_n123_));
  nor2   g090(.a(new_n37_), .b(new_n123_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n122_), .c(x14), .O(new_n125_));
  nor2   g092(.a(x14), .b(x11), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n103_), .c(new_n78_), .d(new_n70_), .O(new_n127_));
  oai21  g094(.a(new_n125_), .b(new_n120_), .c(new_n127_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n84_), .O(new_n129_));
  nand3  g096(.a(new_n122_), .b(new_n89_), .c(x14), .O(new_n130_));
  nand2  g097(.a(new_n103_), .b(new_n92_), .O(new_n131_));
  nand4  g098(.a(new_n37_), .b(new_n73_), .c(new_n36_), .d(new_n121_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n120_), .O(new_n133_));
  ...
  oai21  g107(.a(x23), .b(new_n57_), .c(new_n75_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n63_), .c(x09), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x16), .c(new_n121_), .O(new_n143_));
  nand2  g110(.a(new_n48_), .b(new_n43_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n42_), .c(new_n53_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n46_), .O(z5));
  nand2  g113(.a(z5), .b(new_n143_), .O(new_n147_));
  oai21  g114(.a(new_n64_), .b(x04), .c(x17), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x22), .c(new_n68_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n74_), .c(x08), .O(new_n150_));
  nand2  g117(.a(new_n113_), .b(new_n112_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n111_), .c(new_n53_), .O(new_n152_));
  ...
  or2    g123(.a(new_n49_), .b(new_n42_), .O(new_n157_));
  oai21  g124(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n157_), .c(new_n36_), .O(new_n159_));
  oai21  g126(.a(x20), .b(new_n73_), .c(x06), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x11), .c(new_n34_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n88_), .c(new_n91_), .d(new_n34_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n82_), .c(x24), .O(new_n163_));
  oai22  g130(.a(new_n161_), .b(new_n123_), .c(new_n77_), .d(new_n34_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n84_), .O(new_n165_));
  inv1   g132(.a(x00), .O(new_n166_));
  nand3  g133(.a(new_n160_), .b(x21), .c(x11), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n40_), .c(new_n45_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n44_), .O(new_n170_));
  nor3   g137(.a(new_n114_), .b(x03), .c(x02), .O(new_n171_));
  aoi21  g138(.a(new_n170_), .b(x03), .c(new_n171_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n165_), .c(new_n163_), .d(new_n159_), .O(z6));
  inv1   g140(.a(new_n111_), .O(new_n174_));
  nand2  g141(.a(new_n114_), .b(new_n44_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(x03), .O(new_n176_));
  inv1   g143(.a(new_n113_), .O(new_n177_));
  nor2   g144(.a(new_n171_), .b(new_n177_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n176_), .c(new_n112_), .d(new_n174_), .O(z7));
endmodule
