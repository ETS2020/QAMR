...
module FAU ( 
  ...
  nand3  g077(.a(x15), .b(new_n53_), .c(new_n47_), .O(new_n111_));
  ...
  nand3  g083(.a(new_n73_), .b(new_n36_), .c(x00), .O(new_n117_));
  nand4  g084(.a(new_n42_), .b(new_n41_), .c(new_n40_), .d(new_n38_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n117_), .c(new_n35_), .O(new_n119_));
  ...
  nand3  g089(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n123_));
  nand3  g090(.a(new_n78_), .b(new_n41_), .c(new_n40_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n84_), .O(new_n126_));
  nand3  g093(.a(new_n88_), .b(x14), .c(x11), .O(new_n127_));
  nand4  g094(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n128_));
  nand4  g095(.a(new_n46_), .b(new_n41_), .c(new_n40_), .d(new_n101_), .O(new_n129_));
  ...
  oai21  g102(.a(new_n135_), .b(x16), .c(new_n101_), .O(new_n136_));
  nor2   g103(.a(new_n55_), .b(new_n51_), .O(new_n137_));
  ...
  oai21  g111(.a(new_n144_), .b(new_n93_), .c(x08), .O(new_n145_));
  nor2   g112(.a(new_n112_), .b(new_n110_), .O(new_n146_));
  nor2   g113(.a(x02), .b(x01), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n49_), .c(x21), .d(new_n38_), .O(new_n148_));
  oai21  g115(.a(new_n138_), .b(new_n146_), .c(new_n148_), .O(z7));
  nand2  g116(.a(z7), .b(new_n145_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n142_), .O(z4));
  aoi21  g118(.a(new_n139_), .b(x00), .c(x01), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x02), .c(new_n137_), .O(z5));
  aoi21  g120(.a(x20), .b(new_n41_), .c(x06), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x11), .c(new_n36_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n141_), .O(new_n156_));
