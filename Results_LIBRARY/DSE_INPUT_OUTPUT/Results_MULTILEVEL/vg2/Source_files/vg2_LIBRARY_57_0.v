...
module FAU ( 
  ...
  nor2   g110(.a(x02), .b(x01), .O(new_n144_));
  inv1   g111(.a(new_n144_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n49_), .O(new_n146_));
  nor2   g113(.a(x24), .b(x10), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n54_), .c(x01), .d(x00), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n146_), .O(z5));
  nand2  g116(.a(z5), .b(new_n143_), .O(new_n150_));
  oai21  g117(.a(new_n66_), .b(x04), .c(x17), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x22), .c(new_n59_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n100_), .c(x08), .O(new_n153_));
  nand2  g120(.a(new_n112_), .b(new_n111_), .O(new_n154_));
  nor2   g121(.a(new_n154_), .b(new_n110_), .O(new_n155_));
  nand2  g122(.a(new_n123_), .b(new_n113_), .O(new_n156_));
  inv1   g123(.a(new_n156_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n54_), .c(x01), .O(new_n158_));
  oai21  g125(.a(new_n155_), .b(new_n144_), .c(new_n158_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n153_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n150_), .O(z4));
  nand2  g128(.a(x20), .b(new_n37_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n35_), .c(x11), .O(new_n163_));
  nand3  g130(.a(new_n147_), .b(new_n54_), .c(x00), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n165_));
  oai21  g132(.a(new_n163_), .b(x03), .c(new_n165_), .O(new_n166_));
  nand2  g133(.a(new_n38_), .b(x14), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x06), .c(new_n36_), .O(new_n168_));
  oai22  g135(.a(new_n168_), .b(new_n34_), .c(new_n115_), .d(new_n110_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n145_), .O(z6));
  oai21  g137(.a(new_n157_), .b(new_n107_), .c(new_n54_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n155_), .O(z7));
endmodule
