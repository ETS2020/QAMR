...
module FAU ( 
  ...
  nand4  g060(.a(new_n93_), .b(new_n92_), .c(new_n78_), .d(new_n76_), .O(new_n94_));
  nand2  g061(.a(new_n94_), .b(new_n90_), .O(new_n95_));
  nand3  g062(.a(new_n95_), .b(new_n54_), .c(x24), .O(new_n96_));
  and2   g063(.a(x21), .b(x20), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n92_), .c(new_n78_), .d(new_n76_), .O(new_n98_));
  nor2   g065(.a(x03), .b(x01), .O(new_n99_));
  nor2   g066(.a(x06), .b(x04), .O(new_n100_));
  nor2   g067(.a(x09), .b(x08), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(x00), .O(new_n102_));
  nand4  g069(.a(new_n62_), .b(new_n36_), .c(new_n84_), .d(new_n35_), .O(new_n103_));
  inv1   g070(.a(new_n103_), .O(new_n104_));
  nor2   g071(.a(x23), .b(x22), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n104_), .c(new_n65_), .d(new_n63_), .O(new_n106_));
  oai21  g073(.a(new_n106_), .b(new_n102_), .c(new_n98_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n40_), .c(new_n49_), .d(new_n48_), .O(new_n108_));
  and2   g075(.a(new_n108_), .b(new_n37_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n96_), .c(new_n83_), .O(z1));
  ...
  oai21  g083(.a(new_n116_), .b(new_n113_), .c(new_n37_), .O(new_n117_));
  nand4  g084(.a(new_n40_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(new_n117_), .c(new_n65_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x14), .c(x11), .d(x06), .O(new_n120_));
  nor3   g087(.a(new_n120_), .b(new_n58_), .c(new_n57_), .O(z2));
  ...
  nand3  g091(.a(new_n99_), .b(new_n60_), .c(new_n34_), .O(new_n125_));
  nand4  g092(.a(new_n65_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n122_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n56_), .O(new_n128_));
  nand2  g095(.a(new_n123_), .b(new_n93_), .O(new_n129_));
  nand3  g096(.a(new_n99_), .b(x07), .c(new_n34_), .O(new_n130_));
  nand4  g097(.a(new_n65_), .b(new_n36_), .c(new_n35_), .d(new_n60_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n122_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n54_), .c(x24), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n128_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n37_), .O(new_n135_));
  nand4  g102(.a(new_n34_), .b(new_n58_), .c(new_n57_), .d(x00), .O(new_n136_));
  nand2  g103(.a(new_n123_), .b(new_n97_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n122_), .c(new_n136_), .d(new_n131_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n40_), .c(new_n49_), .d(new_n48_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n135_), .O(z3));
  nand2  g107(.a(new_n50_), .b(new_n47_), .O(new_n141_));
  oai21  g108(.a(x23), .b(new_n59_), .c(new_n63_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n66_), .c(x09), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n60_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand2  g112(.a(new_n118_), .b(new_n117_), .O(new_n146_));
  oai21  g113(.a(new_n67_), .b(x04), .c(x17), .O(new_n147_));
  ...
  nand2  g117(.a(new_n150_), .b(new_n145_), .O(z4));
  inv1   g118(.a(new_n42_), .O(new_n152_));
  and2   g119(.a(new_n50_), .b(new_n45_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n43_), .c(new_n152_), .d(new_n37_), .O(z5));
  nand2  g121(.a(x20), .b(new_n36_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n34_), .c(x11), .O(new_n156_));
  nand3  g123(.a(new_n153_), .b(new_n43_), .c(new_n152_), .O(new_n157_));
  oai21  g124(.a(new_n156_), .b(x03), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n65_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n35_), .O(new_n160_));
  inv1   g127(.a(new_n113_), .O(new_n161_));
  and2   g128(.a(new_n118_), .b(new_n115_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n114_), .c(new_n161_), .O(new_n163_));
  oai21  g130(.a(new_n160_), .b(new_n58_), .c(new_n163_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n158_), .c(new_n37_), .O(z6));
  nand4  g132(.a(new_n162_), .b(new_n114_), .c(new_n161_), .d(new_n37_), .O(z7));
endmodule
