...
module FAU ( 
  ...
  nand2  g091(.a(new_n124_), .b(new_n72_), .O(new_n125_));
  nand3  g092(.a(new_n77_), .b(new_n41_), .c(new_n40_), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n123_), .c(new_n83_), .O(new_n128_));
  inv1   g095(.a(new_n121_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n87_), .c(x14), .O(new_n130_));
  nor2   g097(.a(x11), .b(x08), .O(new_n131_));
  nor2   g098(.a(x20), .b(x14), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n131_), .c(new_n124_), .d(new_n91_), .O(new_n133_));
  ...
  nand4  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n101_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n135_), .c(new_n128_), .O(z3));
  inv1   g107(.a(x04), .O(new_n141_));
  oai21  g108(.a(x23), .b(new_n141_), .c(new_n64_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n66_), .c(x09), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n89_), .O(new_n144_));
  nor2   g111(.a(x24), .b(x10), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n34_), .c(x00), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n53_), .c(new_n51_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n50_), .c(new_n144_), .O(new_n148_));
  ...
  nand4  g118(.a(new_n43_), .b(x21), .c(new_n38_), .d(new_n34_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n114_), .c(new_n113_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n112_), .c(new_n151_), .O(new_n154_));
  ...
  aoi21  g125(.a(new_n145_), .b(x00), .c(x01), .O(new_n159_));
  ...
  nand3  g129(.a(new_n145_), .b(new_n101_), .c(new_n34_), .O(new_n163_));
  ...
  nor2   g134(.a(new_n115_), .b(new_n112_), .O(new_n168_));
  nand3  g135(.a(new_n43_), .b(x21), .c(new_n38_), .O(new_n169_));
  inv1   g136(.a(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n34_), .c(new_n35_), .O(new_n171_));
  ...
  oai21  g141(.a(new_n170_), .b(x01), .c(new_n34_), .O(new_n175_));
