...
module FAU ( 
  ...
  aoi22  g069(.a(new_n102_), .b(new_n95_), .c(new_n46_), .d(new_n37_), .O(new_n103_));
  ...
  nor3   g092(.a(new_n125_), .b(new_n73_), .c(new_n36_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x06), .c(x03), .d(x01), .O(new_n127_));
  aoi21  g094(.a(new_n127_), .b(x12), .c(new_n52_), .O(z2));
  ...
  nand4  g098(.a(new_n78_), .b(new_n73_), .c(new_n52_), .d(new_n36_), .O(new_n132_));
  ...
  nand4  g115(.a(new_n148_), .b(new_n143_), .c(new_n136_), .d(new_n54_), .O(z3));
  inv1   g116(.a(new_n49_), .O(new_n150_));
  oai21  g117(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n74_), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n69_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  inv1   g121(.a(new_n125_), .O(new_n155_));
  oai21  g122(.a(new_n75_), .b(x04), .c(x17), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n70_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n71_), .c(x08), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n154_), .c(new_n54_), .O(z4));
  inv1   g127(.a(new_n41_), .O(new_n161_));
  and2   g128(.a(new_n45_), .b(new_n42_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n54_), .c(new_n47_), .d(new_n161_), .O(z5));
  nand2  g130(.a(x20), .b(new_n52_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n35_), .c(x11), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x03), .c(new_n150_), .O(new_n166_));
  oai21  g133(.a(x20), .b(new_n52_), .c(x06), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(x11), .c(x03), .O(new_n168_));
  oai21  g135(.a(new_n53_), .b(x03), .c(new_n168_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n155_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n166_), .c(new_n54_), .O(z6));
  nor2   g138(.a(new_n125_), .b(new_n53_), .O(z7));
endmodule
