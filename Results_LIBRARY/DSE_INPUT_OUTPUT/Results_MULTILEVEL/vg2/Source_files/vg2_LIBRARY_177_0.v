...
module FAU ( 
  ...
  inv1   g135(.a(new_n94_), .O(new_n169_));
  nand2  g136(.a(new_n107_), .b(new_n97_), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n169_), .c(new_n156_), .d(new_n117_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n166_), .O(z6));
  aoi21  g140(.a(new_n107_), .b(new_n97_), .c(new_n64_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(x02), .c(new_n117_), .O(z7));
endmodule
