...
module FAU ( 
  ...
  nor2   g077(.a(x24), .b(new_n100_), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n97_), .c(new_n110_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(new_n107_), .c(x20), .O(new_n114_));
  ...
  nand4  g085(.a(new_n118_), .b(new_n97_), .c(x08), .d(x06), .O(new_n119_));
  ...
  nand2  g089(.a(new_n122_), .b(new_n110_), .O(new_n123_));
  ...
  oai21  g107(.a(new_n55_), .b(new_n64_), .c(new_n140_), .O(new_n141_));
  nor2   g108(.a(x24), .b(x10), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n110_), .c(x00), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  oai21  g112(.a(new_n137_), .b(x04), .c(x17), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x22), .c(new_n63_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n136_), .c(x08), .O(new_n148_));
  ...
  nand3  g118(.a(new_n151_), .b(new_n77_), .c(x24), .O(new_n152_));
  ...
  nand2  g122(.a(new_n155_), .b(new_n79_), .O(new_n156_));
  nand4  g123(.a(new_n148_), .b(new_n40_), .c(x21), .d(new_n97_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(x01), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n110_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n156_), .c(new_n152_), .d(new_n145_), .O(z4));
  nor2   g127(.a(x02), .b(x01), .O(new_n161_));
  inv1   g128(.a(new_n161_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n48_), .O(new_n163_));
  nand4  g130(.a(new_n142_), .b(new_n110_), .c(x01), .d(x00), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n163_), .O(z5));
  nand2  g132(.a(x20), .b(new_n37_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n35_), .c(x11), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x03), .c(new_n144_), .O(new_n168_));
  oai21  g135(.a(x20), .b(new_n37_), .c(x06), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(x11), .c(x03), .O(new_n170_));
  oai21  g137(.a(x03), .b(new_n64_), .c(new_n170_), .O(new_n171_));
  oai21  g138(.a(new_n113_), .b(new_n107_), .c(new_n171_), .O(new_n172_));
  nand2  g139(.a(new_n109_), .b(new_n108_), .O(new_n173_));
  nor2   g140(.a(new_n173_), .b(new_n107_), .O(new_n174_));
  nor2   g141(.a(new_n174_), .b(x03), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(x02), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(new_n172_), .c(new_n168_), .d(new_n162_), .O(z6));
  nand3  g144(.a(new_n111_), .b(new_n94_), .c(new_n97_), .O(new_n178_));
  oai21  g145(.a(new_n174_), .b(new_n161_), .c(new_n178_), .O(z7));
endmodule
