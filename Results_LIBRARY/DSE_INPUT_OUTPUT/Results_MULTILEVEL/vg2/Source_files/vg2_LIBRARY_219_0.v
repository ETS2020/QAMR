...
module FAU ( 
  ...
  nand3  g096(.a(x15), .b(new_n50_), .c(new_n39_), .O(new_n130_));
  nand4  g097(.a(new_n41_), .b(x21), .c(new_n48_), .d(new_n47_), .O(new_n131_));
  ...
  nor2   g102(.a(new_n135_), .b(new_n68_), .O(z2));
  ...
  nand4  g106(.a(new_n78_), .b(new_n38_), .c(new_n72_), .d(new_n36_), .O(new_n140_));
  ...
  inv1   g111(.a(new_n88_), .O(new_n145_));
  nand4  g112(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n146_));
  nand4  g113(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n147_));
  nand3  g114(.a(new_n94_), .b(x07), .c(new_n35_), .O(new_n148_));
  nand4  g115(.a(new_n38_), .b(new_n72_), .c(new_n36_), .d(new_n70_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n146_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n145_), .c(x24), .O(new_n151_));
  nand4  g118(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n152_));
  nand3  g119(.a(new_n94_), .b(new_n70_), .c(new_n35_), .O(new_n153_));
  nand3  g120(.a(new_n119_), .b(new_n72_), .c(new_n36_), .O(new_n154_));
  oai22  g121(.a(new_n154_), .b(new_n153_), .c(new_n152_), .d(new_n146_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n50_), .c(new_n39_), .O(new_n156_));
  nand2  g123(.a(new_n37_), .b(new_n36_), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n156_), .c(new_n151_), .d(new_n144_), .O(z3));
  inv1   g125(.a(new_n49_), .O(new_n159_));
  nor3   g126(.a(new_n88_), .b(new_n41_), .c(new_n40_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n159_), .c(x08), .O(new_n161_));
  ...
  aoi21  g132(.a(new_n165_), .b(x09), .c(new_n73_), .O(new_n166_));
  ...
  nand2  g136(.a(new_n169_), .b(new_n73_), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n162_), .c(new_n167_), .d(new_n163_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n41_), .c(new_n48_), .d(new_n47_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n161_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n157_), .O(new_n174_));
  nand3  g141(.a(new_n41_), .b(x13), .c(x05), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n145_), .O(new_n176_));
  nand2  g143(.a(new_n118_), .b(x08), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n166_), .c(x15), .O(new_n178_));
  nand2  g145(.a(new_n170_), .b(new_n70_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(x19), .c(x11), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n178_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n176_), .O(new_n182_));
  inv1   g149(.a(x18), .O(new_n183_));
  oai22  g150(.a(new_n170_), .b(new_n40_), .c(new_n167_), .d(new_n183_), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n145_), .c(x11), .O(new_n185_));
  nand4  g152(.a(new_n169_), .b(new_n73_), .c(new_n70_), .d(x07), .O(new_n186_));
  oai21  g153(.a(new_n167_), .b(new_n183_), .c(new_n186_), .O(new_n187_));
  ...
  nand3  g157(.a(new_n190_), .b(new_n182_), .c(new_n174_), .O(z4));
  inv1   g158(.a(new_n45_), .O(new_n192_));
  and2   g159(.a(new_n49_), .b(new_n46_), .O(new_n193_));
  nand4  g160(.a(new_n193_), .b(new_n157_), .c(new_n51_), .d(new_n192_), .O(z5));
  aoi21  g161(.a(x20), .b(new_n72_), .c(x06), .O(new_n195_));
  nand2  g162(.a(new_n42_), .b(new_n34_), .O(new_n196_));
  aoi21  g163(.a(new_n196_), .b(new_n49_), .c(new_n195_), .O(new_n197_));
  nand2  g164(.a(x13), .b(x05), .O(new_n198_));
  nand2  g165(.a(new_n198_), .b(new_n145_), .O(new_n199_));
  nand3  g166(.a(new_n199_), .b(new_n41_), .c(x19), .O(new_n200_));
  nand2  g167(.a(new_n200_), .b(x15), .O(new_n201_));
  oai21  g168(.a(new_n201_), .b(new_n197_), .c(new_n36_), .O(new_n202_));
  aoi21  g169(.a(new_n38_), .b(x14), .c(new_n35_), .O(new_n203_));
  nand2  g170(.a(new_n203_), .b(x03), .O(new_n204_));
  nand3  g171(.a(new_n204_), .b(x18), .c(x11), .O(new_n205_));
  nand2  g172(.a(x07), .b(x03), .O(new_n206_));
  aoi21  g173(.a(new_n206_), .b(new_n205_), .c(new_n88_), .O(new_n207_));
  nand3  g174(.a(x18), .b(x15), .c(new_n34_), .O(new_n208_));
  nand4  g175(.a(x19), .b(new_n50_), .c(new_n39_), .d(x03), .O(new_n209_));
  nand2  g176(.a(new_n209_), .b(new_n208_), .O(new_n210_));
  oai21  g177(.a(new_n210_), .b(new_n207_), .c(x24), .O(new_n211_));
  inv1   g178(.a(new_n203_), .O(new_n212_));
  nand2  g179(.a(new_n212_), .b(x15), .O(new_n213_));
  nand2  g180(.a(x19), .b(x03), .O(new_n214_));
  aoi21  g181(.a(new_n214_), .b(new_n213_), .c(new_n36_), .O(new_n215_));
  nor2   g182(.a(new_n37_), .b(x03), .O(new_n216_));
  oai21  g183(.a(new_n216_), .b(new_n215_), .c(new_n176_), .O(new_n217_));
  aoi22  g184(.a(new_n212_), .b(x11), .c(new_n157_), .d(new_n34_), .O(new_n218_));
  oai22  g185(.a(new_n218_), .b(new_n163_), .c(new_n34_), .d(new_n162_), .O(new_n219_));
  nand4  g186(.a(new_n219_), .b(new_n41_), .c(new_n48_), .d(new_n47_), .O(new_n220_));
  nand4  g187(.a(new_n220_), .b(new_n217_), .c(new_n211_), .d(new_n202_), .O(z6));
  nand4  g188(.a(new_n157_), .b(x21), .c(new_n48_), .d(new_n47_), .O(new_n222_));
  nand2  g189(.a(new_n222_), .b(new_n58_), .O(new_n223_));
  nand2  g190(.a(new_n223_), .b(new_n41_), .O(new_n224_));
  nand2  g191(.a(new_n145_), .b(x11), .O(new_n225_));
  nand2  g192(.a(new_n225_), .b(new_n37_), .O(new_n226_));
  nand3  g193(.a(new_n226_), .b(x24), .c(x18), .O(new_n227_));
  nand3  g194(.a(new_n227_), .b(new_n224_), .c(new_n130_), .O(z7));
endmodule
