...
module FAU ( 
  ...
  nor2   g086(.a(new_n34_), .b(new_n107_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(new_n113_), .c(x08), .d(x06), .O(new_n121_));
  inv1   g088(.a(x21), .O(new_n122_));
  nor2   g089(.a(x24), .b(new_n122_), .O(new_n123_));
  nor2   g090(.a(new_n37_), .b(new_n36_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n123_), .c(x20), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n121_), .c(x01), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n54_), .O(new_n127_));
  nand2  g094(.a(new_n120_), .b(new_n58_), .O(new_n128_));
  nand3  g095(.a(new_n124_), .b(x20), .c(x15), .O(new_n129_));
  nand3  g096(.a(new_n80_), .b(new_n34_), .c(new_n107_), .O(new_n130_));
  nand3  g097(.a(new_n85_), .b(new_n37_), .c(new_n36_), .O(new_n131_));
  ...
  nand4  g101(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n107_), .O(new_n135_));
  nand4  g102(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n57_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n128_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n89_), .c(x24), .O(new_n138_));
  ...
  nand4  g110(.a(new_n40_), .b(new_n113_), .c(new_n54_), .d(x00), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  or2    g113(.a(new_n115_), .b(new_n110_), .O(new_n147_));
  oai21  g114(.a(new_n66_), .b(x04), .c(x17), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x22), .c(new_n59_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n100_), .c(x08), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g118(.a(new_n54_), .b(new_n107_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n151_), .c(new_n146_), .O(z4));
  nand3  g120(.a(new_n40_), .b(new_n113_), .c(x00), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x01), .c(x02), .O(new_n155_));
  or2    g122(.a(new_n155_), .b(new_n49_), .O(z5));
  nand2  g123(.a(x20), .b(new_n37_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n35_), .c(x11), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x03), .c(new_n145_), .O(new_n159_));
  nand2  g126(.a(new_n38_), .b(x14), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x06), .c(new_n36_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n34_), .c(new_n147_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n152_), .O(z6));
  aoi21  g130(.a(new_n123_), .b(new_n113_), .c(new_n107_), .O(new_n164_));
  nand2  g131(.a(new_n112_), .b(new_n111_), .O(new_n165_));
  nor2   g132(.a(new_n165_), .b(new_n110_), .O(new_n166_));
  oai21  g133(.a(new_n164_), .b(x02), .c(new_n166_), .O(z7));
endmodule
