...
module FAU ( 
  ...
  nor2   g40(.a(x11), .b(x06), .O(new_n75_));
  ...
  oai21  g59(.a(new_n93_), .b(x03), .c(new_n89_), .O(new_n94_));
  inv1   g60(.a(x20), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(x14), .c(x11), .O(new_n96_));
  nand3  g62(.a(new_n96_), .b(x06), .c(x03), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n61_), .c(new_n75_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n94_), .O(z6));
  and2   g65(.a(new_n49_), .b(new_n46_), .O(new_n100_));
  nand4  g66(.a(new_n76_), .b(new_n100_), .c(new_n44_), .d(new_n59_), .O(z7));
  zero   g67(.O(z0));
endmodule
