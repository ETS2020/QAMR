...
module FAU ( 
  ...
  nand4  g127(.a(new_n41_), .b(new_n61_), .c(new_n34_), .d(x00), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n53_), .c(new_n51_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n50_), .c(new_n160_), .O(new_n163_));
  oai21  g130(.a(new_n77_), .b(x04), .c(x17), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x22), .c(new_n73_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n74_), .c(x08), .O(new_n166_));
  nand4  g133(.a(new_n41_), .b(x21), .c(new_n61_), .d(new_n34_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n107_), .c(new_n104_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n132_), .c(new_n166_), .O(new_n169_));
  nand2  g136(.a(new_n47_), .b(new_n34_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n169_), .c(new_n163_), .O(z4));
  nand3  g138(.a(new_n41_), .b(new_n61_), .c(x00), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(x05), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n34_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n55_), .O(z5));
  aoi21  g142(.a(x20), .b(new_n39_), .c(x06), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(x11), .c(new_n36_), .O(new_n177_));
  nand2  g144(.a(new_n54_), .b(x02), .O(new_n178_));
  inv1   g145(.a(new_n48_), .O(new_n179_));
  aoi21  g146(.a(new_n80_), .b(new_n41_), .c(new_n179_), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n47_), .c(new_n178_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n177_), .O(new_n182_));
  aoi21  g149(.a(new_n40_), .b(x14), .c(new_n37_), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(new_n46_), .c(x03), .O(new_n184_));
  nand2  g151(.a(new_n108_), .b(x02), .O(new_n185_));
  aoi21  g152(.a(new_n63_), .b(new_n41_), .c(new_n106_), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(new_n47_), .c(new_n185_), .O(z7));
