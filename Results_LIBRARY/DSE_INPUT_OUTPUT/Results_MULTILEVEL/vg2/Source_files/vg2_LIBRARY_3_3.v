...
module FAU ( 
  ...
  and2   g122(.a(new_n48_), .b(new_n46_), .O(new_n156_));
  nand4  g123(.a(new_n140_), .b(new_n156_), .c(new_n43_), .d(new_n155_), .O(z5));
  aoi21  g124(.a(x20), .b(new_n70_), .c(x06), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x11), .c(new_n34_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n143_), .O(new_n160_));
