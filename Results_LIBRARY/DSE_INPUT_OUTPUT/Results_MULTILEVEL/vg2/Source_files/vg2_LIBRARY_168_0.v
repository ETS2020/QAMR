...
module FAU ( 
  ...
  nor3   g082(.a(new_n115_), .b(new_n38_), .c(new_n37_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x11), .c(x06), .d(x03), .O(new_n117_));
  oai21  g084(.a(new_n117_), .b(new_n63_), .c(new_n109_), .O(z2));
  ...
  nand4  g088(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n63_), .O(new_n122_));
  nand4  g089(.a(new_n72_), .b(new_n37_), .c(new_n36_), .d(new_n55_), .O(new_n123_));
  ...
  nand2  g097(.a(new_n120_), .b(new_n96_), .O(new_n131_));
  nand2  g098(.a(new_n106_), .b(x20), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n93_), .c(new_n56_), .d(x03), .O(new_n134_));
  ...
  nand3  g107(.a(new_n140_), .b(new_n136_), .c(new_n55_), .O(new_n141_));
  oai21  g108(.a(new_n55_), .b(new_n63_), .c(new_n141_), .O(new_n142_));
  nor2   g109(.a(x24), .b(x10), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n104_), .c(x00), .O(new_n144_));
  ...
  aoi21  g114(.a(new_n147_), .b(x22), .c(new_n137_), .O(new_n148_));
  ...
  nand4  g124(.a(new_n149_), .b(new_n40_), .c(x21), .d(new_n96_), .O(new_n158_));
  ...
  nand4  g129(.a(new_n143_), .b(new_n104_), .c(x01), .d(x00), .O(new_n163_));
  ...
  nand3  g137(.a(new_n106_), .b(new_n93_), .c(new_n96_), .O(new_n171_));
  oai21  g138(.a(new_n170_), .b(new_n115_), .c(new_n171_), .O(z7));
