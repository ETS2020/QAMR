...
module FAU ( 
  ...
  oai21  g077(.a(new_n110_), .b(new_n107_), .c(new_n38_), .O(new_n111_));
  nand4  g078(.a(new_n41_), .b(x21), .c(new_n37_), .d(new_n49_), .O(new_n112_));
  aoi21  g079(.a(new_n112_), .b(new_n111_), .c(new_n80_), .O(new_n113_));
  ...
  nand2  g085(.a(new_n93_), .b(new_n64_), .O(new_n119_));
  ...
  nand2  g089(.a(new_n117_), .b(new_n81_), .O(new_n123_));
  nand3  g090(.a(new_n93_), .b(x07), .c(new_n34_), .O(new_n124_));
  inv1   g091(.a(x08), .O(new_n125_));
  nand4  g092(.a(new_n80_), .b(new_n36_), .c(new_n35_), .d(new_n125_), .O(new_n126_));
  ...
  nand4  g095(.a(new_n34_), .b(new_n104_), .c(new_n103_), .d(x00), .O(new_n129_));
  nand2  g096(.a(new_n117_), .b(new_n91_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n116_), .c(new_n129_), .d(new_n126_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n41_), .c(new_n37_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n128_), .c(new_n122_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n49_), .O(new_n134_));
  nand2  g101(.a(new_n128_), .b(new_n122_), .O(new_n135_));
  ...
  nand3  g108(.a(new_n141_), .b(new_n138_), .c(new_n125_), .O(new_n142_));
  oai21  g109(.a(new_n125_), .b(x02), .c(new_n142_), .O(new_n143_));
  nand3  g110(.a(new_n41_), .b(new_n37_), .c(x00), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n46_), .c(new_n44_), .O(new_n145_));
  or2    g112(.a(new_n145_), .b(new_n43_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  oai21  g114(.a(new_n139_), .b(x04), .c(x17), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x22), .c(new_n62_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n138_), .c(x08), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x18), .O(new_n151_));
  nand3  g118(.a(x10), .b(x08), .c(x07), .O(new_n152_));
  ...
  nand3  g122(.a(x19), .b(x10), .c(x08), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n75_), .O(new_n158_));
  nand3  g125(.a(new_n150_), .b(new_n41_), .c(x21), .O(new_n159_));
  ...
  nand2  g129(.a(new_n50_), .b(new_n48_), .O(z5));
  nand2  g130(.a(x20), .b(new_n36_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n34_), .c(x11), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x03), .c(new_n146_), .O(new_n166_));
  oai21  g133(.a(x20), .b(new_n36_), .c(x06), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(x11), .c(x03), .O(new_n168_));
  oai21  g135(.a(x03), .b(x02), .c(new_n168_), .O(new_n169_));
  nand3  g136(.a(new_n41_), .b(x21), .c(new_n37_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n109_), .c(new_n108_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n107_), .c(new_n169_), .O(new_n172_));
  inv1   g139(.a(new_n107_), .O(new_n173_));
  nand3  g140(.a(new_n109_), .b(new_n108_), .c(new_n173_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(x10), .c(new_n104_), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n172_), .c(new_n166_), .d(new_n38_), .O(z6));
  nand2  g143(.a(new_n112_), .b(new_n111_), .O(z7));
endmodule
