...
module FAU ( 
  ...
  nand3  g085(.a(new_n68_), .b(new_n34_), .c(new_n104_), .O(new_n119_));
  nand3  g086(.a(new_n73_), .b(new_n116_), .c(new_n36_), .O(new_n120_));
  ...
  nand4  g090(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n104_), .O(new_n124_));
  inv1   g091(.a(x08), .O(new_n125_));
  nand4  g092(.a(new_n37_), .b(new_n116_), .c(new_n36_), .d(new_n125_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n124_), .c(new_n123_), .d(new_n115_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n77_), .c(x24), .O(new_n128_));
  nand3  g095(.a(new_n97_), .b(new_n35_), .c(new_n34_), .O(new_n129_));
  nand2  g096(.a(new_n117_), .b(new_n94_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n115_), .c(new_n129_), .d(new_n126_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n40_), .c(new_n45_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n128_), .c(new_n122_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n44_), .O(new_n134_));
  ...
  oai21  g109(.a(new_n142_), .b(new_n42_), .c(new_n53_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n46_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand2  g112(.a(new_n111_), .b(new_n110_), .O(z7));
  ...
  nand2  g117(.a(new_n150_), .b(z7), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n145_), .O(z4));
  inv1   g119(.a(new_n42_), .O(new_n153_));
  and2   g120(.a(new_n53_), .b(new_n48_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n46_), .c(new_n43_), .d(new_n153_), .O(z5));
  nand2  g122(.a(x20), .b(new_n116_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n35_), .c(x11), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n158_));
  oai21  g125(.a(x20), .b(new_n116_), .c(x06), .O(new_n159_));
  nand2  g126(.a(new_n77_), .b(x18), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n108_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(x24), .c(x03), .O(new_n162_));
  nand2  g129(.a(x13), .b(x05), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n77_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n53_), .c(x15), .O(new_n165_));
  nand3  g132(.a(x21), .b(new_n45_), .c(new_n44_), .O(new_n166_));
  ...
  nand3  g136(.a(new_n169_), .b(new_n159_), .c(x11), .O(new_n170_));
  nand2  g137(.a(z7), .b(new_n34_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n170_), .c(new_n158_), .d(new_n53_), .O(z6));
endmodule
