...
module FAU ( 
  ...
  nand3  g079(.a(x15), .b(new_n52_), .c(new_n47_), .O(new_n113_));
  ...
  nand2  g090(.a(new_n123_), .b(new_n72_), .O(new_n124_));
  nand3  g091(.a(new_n77_), .b(new_n41_), .c(new_n40_), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n122_), .c(new_n83_), .O(new_n127_));
  inv1   g094(.a(new_n120_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n87_), .c(x14), .O(new_n129_));
  nor2   g096(.a(x11), .b(x08), .O(new_n130_));
  nor2   g097(.a(x20), .b(x14), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n130_), .c(new_n123_), .d(new_n91_), .O(new_n132_));
  oai21  g099(.a(new_n129_), .b(new_n119_), .c(new_n132_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n81_), .c(x24), .O(new_n134_));
  nor3   g101(.a(x06), .b(x03), .c(x02), .O(new_n135_));
  nor3   g102(.a(x11), .b(x10), .c(x08), .O(new_n136_));
  nor3   g103(.a(x24), .b(x20), .c(x14), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n101_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n134_), .c(new_n127_), .O(z3));
  inv1   g106(.a(x04), .O(new_n140_));
  oai21  g107(.a(x23), .b(new_n140_), .c(new_n64_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n66_), .c(x09), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x16), .c(new_n89_), .O(new_n143_));
  nor2   g110(.a(new_n54_), .b(new_n50_), .O(new_n144_));
  nor2   g111(.a(x02), .b(new_n35_), .O(new_n145_));
  nand4  g112(.a(new_n101_), .b(new_n43_), .c(new_n38_), .d(new_n34_), .O(new_n146_));
  oai21  g113(.a(new_n145_), .b(new_n144_), .c(new_n146_), .O(new_n147_));
  ...
  oai21  g117(.a(new_n150_), .b(new_n94_), .c(x08), .O(new_n151_));
  nor2   g118(.a(new_n114_), .b(new_n112_), .O(new_n152_));
  nor2   g119(.a(x02), .b(x01), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n43_), .c(x21), .d(new_n38_), .O(new_n154_));
  oai21  g121(.a(new_n145_), .b(new_n152_), .c(new_n154_), .O(z7));
  nand2  g122(.a(z7), .b(new_n151_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n148_), .O(z4));
  nand3  g124(.a(new_n43_), .b(new_n38_), .c(x00), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n35_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n34_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n144_), .O(z5));
  aoi21  g128(.a(x20), .b(new_n41_), .c(x06), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x11), .c(new_n36_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n147_), .O(new_n164_));
  aoi21  g131(.a(new_n42_), .b(x14), .c(new_n37_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n40_), .c(x03), .O(new_n166_));
