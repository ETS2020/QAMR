...
module FAU ( 
  ...
  nand3  g083(.a(new_n67_), .b(new_n34_), .c(x00), .O(new_n117_));
  nor2   g084(.a(x11), .b(x10), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(new_n40_), .c(new_n37_), .d(new_n87_), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n117_), .c(new_n94_), .O(new_n120_));
  ...
  oai21  g104(.a(new_n49_), .b(new_n42_), .c(new_n137_), .O(new_n138_));
  oai21  g105(.a(new_n62_), .b(x04), .c(x17), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(x22), .c(new_n65_), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(new_n88_), .c(x08), .O(new_n141_));
  nand4  g108(.a(new_n40_), .b(x21), .c(new_n98_), .d(new_n44_), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n110_), .c(new_n109_), .d(new_n108_), .O(new_n143_));
  nor2   g110(.a(x02), .b(new_n94_), .O(new_n144_));
  aoi21  g111(.a(new_n143_), .b(new_n141_), .c(new_n144_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n138_), .O(z4));
  aoi21  g113(.a(new_n45_), .b(x00), .c(x01), .O(new_n147_));
  nand2  g114(.a(new_n48_), .b(new_n43_), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(new_n42_), .O(new_n149_));
  oai21  g116(.a(new_n147_), .b(x02), .c(new_n149_), .O(z5));
  aoi21  g117(.a(x20), .b(new_n87_), .c(x06), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x11), .c(new_n34_), .O(new_n152_));
  nand4  g119(.a(new_n45_), .b(new_n44_), .c(new_n94_), .d(x00), .O(new_n153_));
  oai21  g120(.a(new_n149_), .b(new_n144_), .c(new_n153_), .O(new_n154_));
  ...
  inv1   g124(.a(new_n112_), .O(new_n158_));
  nand3  g125(.a(new_n40_), .b(x21), .c(new_n98_), .O(new_n159_));
  inv1   g126(.a(new_n159_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n44_), .c(new_n94_), .O(new_n161_));
  oai21  g128(.a(new_n144_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n157_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n155_), .O(z6));
  oai21  g131(.a(new_n160_), .b(x01), .c(new_n44_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n158_), .O(z7));
endmodule
