...
module FAU ( 
  ...
  nand4  g122(.a(new_n155_), .b(new_n40_), .c(x21), .d(new_n154_), .O(new_n156_));
  oai21  g123(.a(new_n143_), .b(new_n153_), .c(new_n156_), .O(z7));
  nand2  g124(.a(z7), .b(new_n152_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n148_), .O(z4));
  aoi21  g126(.a(new_n45_), .b(x00), .c(x01), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x02), .c(new_n145_), .O(z5));
  nand2  g128(.a(x20), .b(new_n62_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n35_), .c(x11), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n164_));
  oai21  g131(.a(x20), .b(new_n62_), .c(x06), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(x11), .c(x03), .O(new_n166_));
  inv1   g133(.a(new_n166_), .O(new_n167_));
  nand4  g134(.a(new_n40_), .b(x21), .c(new_n154_), .d(new_n44_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n110_), .c(new_n109_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n108_), .c(new_n167_), .d(new_n120_), .O(new_n170_));
  nor2   g137(.a(new_n153_), .b(x03), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(x02), .c(new_n143_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n170_), .c(new_n164_), .O(z6));
endmodule
