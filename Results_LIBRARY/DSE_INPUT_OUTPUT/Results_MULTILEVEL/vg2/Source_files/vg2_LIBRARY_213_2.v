...
module FAU ( 
  ...
  oai21  g108(.a(new_n141_), .b(x22), .c(new_n65_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n91_), .c(new_n85_), .O(new_n143_));
  oai21  g110(.a(new_n85_), .b(x01), .c(new_n143_), .O(new_n144_));
  ...
  oai21  g114(.a(new_n147_), .b(new_n91_), .c(x08), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(x18), .O(new_n149_));
  nand3  g116(.a(x08), .b(x07), .c(x02), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n76_), .c(x24), .O(new_n152_));
  ...
  nand2  g122(.a(new_n155_), .b(new_n78_), .O(new_n156_));
  nand4  g123(.a(new_n148_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n107_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n44_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n156_), .c(new_n152_), .d(new_n145_), .O(z4));
  nor2   g127(.a(x02), .b(new_n107_), .O(new_n161_));
  nand2  g128(.a(new_n48_), .b(new_n43_), .O(new_n162_));
  nor2   g129(.a(new_n162_), .b(new_n42_), .O(new_n163_));
  nand4  g130(.a(new_n98_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n164_));
  oai21  g131(.a(new_n163_), .b(new_n161_), .c(new_n164_), .O(z5));
  aoi21  g132(.a(x20), .b(new_n90_), .c(x06), .O(new_n166_));
  ...
  oai21  g137(.a(x02), .b(new_n107_), .c(new_n114_), .O(new_n171_));
  nor2   g138(.a(x02), .b(x01), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n171_), .O(z7));
  nand2  g141(.a(z7), .b(new_n170_), .O(new_n175_));
