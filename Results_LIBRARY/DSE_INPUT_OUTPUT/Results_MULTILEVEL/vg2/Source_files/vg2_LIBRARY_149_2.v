...
module FAU ( 
  ...
  nand3  g078(.a(new_n41_), .b(x21), .c(new_n37_), .O(new_n112_));
  ...
  oai21  g085(.a(new_n118_), .b(new_n105_), .c(new_n38_), .O(z2));
  ...
  nand2  g089(.a(new_n95_), .b(new_n68_), .O(new_n123_));
  ...
  nand3  g094(.a(new_n95_), .b(x07), .c(new_n34_), .O(new_n128_));
  ...
  nand4  g100(.a(new_n34_), .b(new_n133_), .c(new_n105_), .d(x00), .O(new_n134_));
  nand2  g101(.a(new_n121_), .b(new_n93_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n120_), .c(new_n134_), .d(new_n130_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n41_), .c(new_n37_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n132_), .c(new_n126_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n49_), .O(new_n139_));
  nand2  g106(.a(new_n132_), .b(new_n126_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(x10), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n139_), .O(z3));
  nand2  g109(.a(new_n50_), .b(new_n48_), .O(z5));
  inv1   g110(.a(x04), .O(new_n144_));
  oai21  g111(.a(x23), .b(new_n144_), .c(new_n59_), .O(new_n145_));
  ...
  nand3  g119(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n38_), .O(new_n154_));
  nand4  g121(.a(new_n41_), .b(x21), .c(new_n37_), .d(new_n49_), .O(new_n155_));
  ...
  nand3  g127(.a(new_n41_), .b(new_n37_), .c(x00), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n46_), .c(new_n44_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n43_), .c(new_n160_), .d(x03), .O(new_n163_));
  oai21  g130(.a(x20), .b(new_n36_), .c(x06), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(x11), .c(x03), .O(new_n165_));
  oai21  g132(.a(x03), .b(x02), .c(new_n165_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n115_), .O(new_n167_));
  nand3  g134(.a(new_n153_), .b(x10), .c(new_n133_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n167_), .c(new_n163_), .d(new_n38_), .O(z6));
endmodule
