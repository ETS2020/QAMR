...
module FAU ( 
  ...
  nand3  g030(.a(new_n63_), .b(new_n35_), .c(new_n62_), .O(new_n64_));
  ...
  nand2  g066(.a(x21), .b(x20), .O(new_n100_));
  nor4   g067(.a(new_n100_), .b(x24), .c(new_n99_), .d(new_n98_), .O(new_n101_));
  ...
  nand4  g077(.a(new_n40_), .b(x21), .c(new_n66_), .d(new_n93_), .O(new_n111_));
  ...
  nor2   g082(.a(new_n115_), .b(new_n104_), .O(z2));
  nand3  g083(.a(new_n54_), .b(x03), .c(x01), .O(new_n117_));
  nor2   g084(.a(new_n105_), .b(new_n36_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(x20), .c(x15), .O(new_n119_));
  nand3  g086(.a(new_n63_), .b(new_n53_), .c(new_n35_), .O(new_n120_));
  nand3  g087(.a(new_n72_), .b(new_n67_), .c(new_n105_), .O(new_n121_));
  ...
  nand3  g091(.a(new_n63_), .b(x07), .c(new_n35_), .O(new_n125_));
  nor2   g092(.a(x20), .b(x14), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n36_), .c(x10), .d(new_n53_), .O(new_n127_));
  ...
  nor2   g096(.a(x02), .b(new_n104_), .O(new_n130_));
  nand2  g097(.a(new_n118_), .b(new_n66_), .O(new_n131_));
  nand3  g098(.a(new_n40_), .b(x21), .c(x20), .O(new_n132_));
  ...
  aoi21  g104(.a(new_n137_), .b(new_n98_), .c(x09), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(x16), .c(new_n53_), .O(new_n139_));
  inv1   g106(.a(new_n42_), .O(new_n140_));
  nand4  g107(.a(new_n40_), .b(new_n66_), .c(new_n93_), .d(x00), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(new_n45_), .c(new_n43_), .d(new_n140_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  inv1   g110(.a(new_n108_), .O(new_n144_));
  inv1   g111(.a(new_n112_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  inv1   g113(.a(x16), .O(new_n147_));
  oai21  g114(.a(new_n99_), .b(x04), .c(x17), .O(new_n148_));
  ...
  nand2  g118(.a(new_n66_), .b(new_n104_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n151_), .c(new_n143_), .O(z4));
  nand3  g120(.a(new_n40_), .b(new_n93_), .c(x00), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(x01), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n66_), .c(new_n46_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n140_), .O(z5));
  nand2  g124(.a(x20), .b(new_n105_), .O(new_n158_));
  ...
  oai21  g129(.a(new_n162_), .b(new_n34_), .c(new_n146_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n160_), .c(new_n152_), .O(z6));
  nand3  g131(.a(new_n40_), .b(x21), .c(new_n93_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(x01), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n66_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n110_), .c(new_n109_), .d(new_n144_), .O(z7));
endmodule
