...
module FAU ( 
  ...
  nand2  g033(.a(x11), .b(x04), .O(new_n67_));
  ...
  oai21  g038(.a(new_n39_), .b(new_n70_), .c(new_n71_), .O(new_n72_));
  ...
  nand2  g044(.a(new_n77_), .b(x20), .O(new_n78_));
  nor2   g045(.a(new_n78_), .b(new_n69_), .O(new_n79_));
  nand4  g046(.a(new_n79_), .b(x06), .c(x03), .d(x01), .O(new_n80_));
  aoi21  g047(.a(new_n80_), .b(new_n53_), .c(new_n36_), .O(z2));
  nand3  g048(.a(x15), .b(x13), .c(x05), .O(new_n82_));
  nand3  g049(.a(x21), .b(new_n44_), .c(new_n43_), .O(new_n83_));
  aoi21  g050(.a(new_n83_), .b(new_n82_), .c(new_n58_), .O(new_n84_));
  nand4  g051(.a(new_n84_), .b(x14), .c(x11), .d(x08), .O(new_n85_));
  nor2   g052(.a(new_n85_), .b(new_n35_), .O(new_n86_));
  nand4  g053(.a(new_n86_), .b(new_n53_), .c(x03), .d(x01), .O(new_n87_));
  ...
  nand4  g063(.a(x06), .b(new_n53_), .c(x03), .d(x01), .O(new_n97_));
  ...
  nand4  g069(.a(new_n58_), .b(new_n69_), .c(new_n36_), .d(new_n88_), .O(new_n103_));
  ...
  nand4  g076(.a(new_n58_), .b(x19), .c(new_n69_), .d(new_n36_), .O(new_n110_));
  ...
  oai21  g084(.a(x23), .b(new_n53_), .c(new_n57_), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(new_n117_), .c(x09), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(x16), .c(new_n88_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n116_), .O(new_n121_));
  oai21  g088(.a(new_n59_), .b(x04), .c(x17), .O(new_n122_));
  aoi21  g089(.a(new_n122_), .b(x22), .c(new_n54_), .O(new_n123_));
  oai21  g090(.a(new_n123_), .b(new_n56_), .c(x08), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n77_), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n121_), .c(new_n67_), .O(z4));
  inv1   g093(.a(new_n41_), .O(new_n127_));
  and2   g094(.a(new_n45_), .b(new_n42_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n67_), .c(new_n47_), .d(new_n127_), .O(z5));
  inv1   g096(.a(x21), .O(new_n130_));
  nand2  g097(.a(x03), .b(x00), .O(new_n131_));
  oai21  g098(.a(new_n130_), .b(x03), .c(new_n131_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n44_), .c(new_n43_), .O(new_n133_));
  inv1   g100(.a(x15), .O(new_n134_));
  nand2  g101(.a(x19), .b(x03), .O(new_n135_));
  oai21  g102(.a(new_n134_), .b(x03), .c(new_n135_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(x13), .c(x05), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n133_), .c(x24), .O(new_n138_));
  nand2  g105(.a(new_n46_), .b(new_n37_), .O(new_n139_));
  nand2  g106(.a(x07), .b(x03), .O(new_n140_));
  oai21  g107(.a(new_n70_), .b(x03), .c(new_n140_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n139_), .c(x24), .O(new_n142_));
  nand3  g109(.a(new_n136_), .b(new_n46_), .c(new_n37_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n138_), .c(new_n67_), .O(new_n145_));
  oai21  g112(.a(new_n58_), .b(x14), .c(new_n35_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n116_), .c(new_n36_), .O(new_n147_));
  oai21  g114(.a(x20), .b(new_n69_), .c(x06), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n77_), .c(x11), .d(new_n53_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n147_), .c(new_n145_), .O(z6));
  and2   g117(.a(new_n77_), .b(new_n67_), .O(z7));
endmodule
