...
module FAU ( 
  ...
  nand2  g044(.a(new_n46_), .b(new_n38_), .O(new_n78_));
  ...
  nand4  g051(.a(new_n84_), .b(new_n83_), .c(new_n65_), .d(new_n58_), .O(new_n85_));
  ...
  nand3  g059(.a(new_n75_), .b(new_n37_), .c(new_n61_), .O(new_n93_));
  inv1   g060(.a(new_n93_), .O(new_n94_));
  nand2  g061(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  oai21  g062(.a(new_n95_), .b(new_n87_), .c(new_n85_), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(new_n78_), .c(x24), .O(new_n97_));
  inv1   g064(.a(x21), .O(new_n98_));
  nor2   g065(.a(new_n98_), .b(new_n37_), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n83_), .c(new_n65_), .d(new_n58_), .O(new_n100_));
  nor2   g067(.a(x03), .b(x01), .O(new_n101_));
  nand2  g068(.a(new_n101_), .b(x00), .O(new_n102_));
  inv1   g069(.a(x04), .O(new_n103_));
  nand3  g070(.a(new_n86_), .b(new_n35_), .c(new_n103_), .O(new_n104_));
  nor2   g071(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n94_), .c(new_n92_), .O(new_n106_));
  aoi21  g073(.a(new_n106_), .b(new_n100_), .c(x24), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(x02), .c(new_n44_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n97_), .c(new_n81_), .O(z1));
  ...
  nand3  g081(.a(x15), .b(new_n46_), .c(new_n38_), .O(new_n115_));
  nand3  g082(.a(new_n40_), .b(x21), .c(new_n44_), .O(new_n116_));
  ...
  oai21  g087(.a(new_n120_), .b(new_n110_), .c(new_n54_), .O(z2));
  nand4  g088(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n122_));
  nor2   g089(.a(new_n89_), .b(new_n36_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(x20), .c(x15), .O(new_n124_));
  nand2  g091(.a(new_n101_), .b(new_n69_), .O(new_n125_));
  nand3  g092(.a(new_n74_), .b(new_n89_), .c(new_n36_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n122_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n80_), .O(new_n128_));
  nand2  g095(.a(new_n123_), .b(new_n84_), .O(new_n129_));
  nand3  g096(.a(new_n101_), .b(x07), .c(new_n35_), .O(new_n130_));
  inv1   g097(.a(x08), .O(new_n131_));
  nand4  g098(.a(new_n37_), .b(new_n89_), .c(new_n36_), .d(new_n131_), .O(new_n132_));
  ...
  nand4  g101(.a(new_n35_), .b(new_n34_), .c(new_n110_), .d(x00), .O(new_n135_));
  nand2  g102(.a(new_n123_), .b(new_n99_), .O(new_n136_));
  ...
  nand2  g106(.a(new_n139_), .b(new_n52_), .O(new_n140_));
  ...
  oai21  g110(.a(x23), .b(new_n103_), .c(new_n61_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n63_), .c(x09), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x16), .c(new_n131_), .O(new_n146_));
  oai21  g113(.a(new_n48_), .b(new_n42_), .c(new_n146_), .O(new_n147_));
  oai21  g114(.a(new_n64_), .b(x04), .c(x17), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x22), .c(new_n67_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n90_), .c(x08), .O(new_n150_));
  oai21  g117(.a(new_n117_), .b(new_n113_), .c(new_n150_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n147_), .c(new_n54_), .O(z4));
  inv1   g119(.a(new_n42_), .O(new_n153_));
  inv1   g120(.a(x00), .O(new_n154_));
  oai21  g121(.a(x24), .b(new_n154_), .c(new_n52_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n44_), .O(new_n156_));
  and2   g123(.a(new_n47_), .b(new_n43_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n156_), .c(new_n153_), .O(z5));
  aoi21  g125(.a(x20), .b(new_n89_), .c(x06), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x11), .c(new_n34_), .O(new_n160_));
  aoi21  g127(.a(new_n157_), .b(new_n153_), .c(new_n53_), .O(new_n161_));
  nand4  g128(.a(new_n40_), .b(new_n44_), .c(new_n52_), .d(x00), .O(new_n162_));
  ...
  and2   g134(.a(new_n115_), .b(new_n114_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n167_), .c(new_n53_), .O(new_n169_));
  nor2   g136(.a(x24), .b(new_n98_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n44_), .c(new_n52_), .O(new_n171_));
  inv1   g138(.a(new_n171_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n169_), .c(new_n166_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n164_), .O(z6));
  oai21  g141(.a(new_n170_), .b(x02), .c(new_n44_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n168_), .c(new_n167_), .O(z7));
endmodule
