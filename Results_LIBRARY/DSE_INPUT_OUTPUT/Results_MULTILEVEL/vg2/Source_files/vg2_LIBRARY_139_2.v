...
module FAU ( 
  ...
  nor2   g081(.a(x24), .b(new_n93_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n37_), .c(new_n49_), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n114_), .c(new_n60_), .O(new_n117_));
  ...
  nand2  g089(.a(new_n96_), .b(new_n68_), .O(new_n123_));
  nand3  g090(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n120_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n79_), .O(new_n126_));
  nand2  g093(.a(new_n121_), .b(new_n83_), .O(new_n127_));
  nand3  g094(.a(new_n96_), .b(x07), .c(new_n34_), .O(new_n128_));
  inv1   g095(.a(x08), .O(new_n129_));
  nand4  g096(.a(new_n60_), .b(new_n36_), .c(new_n35_), .d(new_n129_), .O(new_n130_));
  ...
  nand4  g099(.a(new_n34_), .b(new_n107_), .c(new_n106_), .d(x00), .O(new_n133_));
  nand2  g100(.a(new_n121_), .b(new_n94_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n120_), .c(new_n133_), .d(new_n130_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n41_), .c(new_n37_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n132_), .c(new_n126_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n49_), .O(new_n138_));
  nand2  g105(.a(new_n132_), .b(new_n126_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(x10), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n138_), .O(z3));
  ...
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n129_), .O(new_n145_));
  inv1   g112(.a(new_n43_), .O(new_n146_));
  nand3  g113(.a(new_n41_), .b(new_n37_), .c(x00), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n46_), .c(new_n44_), .d(new_n146_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  inv1   g116(.a(x16), .O(new_n150_));
  oai21  g117(.a(new_n63_), .b(x04), .c(x17), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x22), .c(new_n66_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n150_), .c(x08), .O(new_n153_));
  inv1   g120(.a(new_n110_), .O(new_n154_));
  nand2  g121(.a(new_n115_), .b(new_n37_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n112_), .c(new_n111_), .d(new_n154_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n149_), .c(new_n38_), .O(z4));
  inv1   g125(.a(x00), .O(new_n159_));
  oai21  g126(.a(x24), .b(new_n159_), .c(new_n49_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n37_), .c(new_n47_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n146_), .O(z5));
  nand2  g129(.a(x20), .b(new_n36_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n34_), .c(x11), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x03), .c(new_n148_), .O(new_n165_));
  nand2  g132(.a(new_n60_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n35_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n107_), .c(new_n156_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n38_), .O(z6));
  inv1   g136(.a(new_n113_), .O(new_n170_));
  oai21  g137(.a(new_n115_), .b(x02), .c(new_n37_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n170_), .c(new_n154_), .O(z7));
endmodule
