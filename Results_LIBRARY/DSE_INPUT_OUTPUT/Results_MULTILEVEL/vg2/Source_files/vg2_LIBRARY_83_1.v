...
module FAU ( 
  ...
  nand2  g083(.a(x02), .b(new_n56_), .O(new_n117_));
  oai21  g084(.a(new_n116_), .b(new_n56_), .c(new_n117_), .O(z2));
  ...
  nand4  g088(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n56_), .O(new_n122_));
  nand4  g089(.a(new_n74_), .b(new_n38_), .c(new_n37_), .d(new_n67_), .O(new_n123_));
  oai22  g090(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n119_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n81_), .O(new_n125_));
  nand2  g092(.a(new_n120_), .b(new_n86_), .O(new_n126_));
  nor2   g093(.a(x20), .b(x14), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n37_), .c(new_n67_), .d(x07), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n122_), .c(new_n126_), .d(new_n119_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n79_), .c(x24), .O(new_n130_));
  nand4  g097(.a(new_n36_), .b(new_n35_), .c(new_n56_), .d(x00), .O(new_n131_));
  nand3  g098(.a(new_n127_), .b(new_n37_), .c(new_n67_), .O(new_n132_));
  nand2  g099(.a(new_n120_), .b(new_n97_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n119_), .c(new_n132_), .d(new_n131_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n41_), .c(new_n96_), .d(new_n34_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n130_), .c(new_n125_), .O(z3));
  nand2  g103(.a(new_n117_), .b(x08), .O(new_n137_));
  ...
  nand3  g133(.a(new_n166_), .b(new_n161_), .c(new_n117_), .O(new_n167_));
  ...
  nand2  g138(.a(new_n171_), .b(new_n117_), .O(new_n172_));
  ...
  oai21  g146(.a(new_n179_), .b(new_n107_), .c(new_n117_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n111_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n178_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n176_), .O(z6));
  nand4  g150(.a(new_n117_), .b(new_n112_), .c(new_n109_), .d(new_n108_), .O(z7));
endmodule
