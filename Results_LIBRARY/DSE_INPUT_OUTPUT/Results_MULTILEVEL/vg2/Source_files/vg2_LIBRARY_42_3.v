...
module FAU ( 
  ...
  nand3  g086(.a(new_n68_), .b(new_n34_), .c(new_n104_), .O(new_n120_));
  nand3  g087(.a(new_n73_), .b(new_n117_), .c(new_n36_), .O(new_n121_));
  ...
  nand4  g091(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n104_), .O(new_n125_));
  inv1   g092(.a(x08), .O(new_n126_));
  nand4  g093(.a(new_n37_), .b(new_n117_), .c(new_n36_), .d(new_n126_), .O(new_n127_));
  ...
  nand3  g096(.a(new_n97_), .b(new_n35_), .c(new_n34_), .O(new_n130_));
  nand2  g097(.a(new_n118_), .b(new_n94_), .O(new_n131_));
  ...
  nand2  g111(.a(new_n144_), .b(new_n46_), .O(z5));
  nand2  g112(.a(z5), .b(new_n142_), .O(new_n146_));
  nand2  g113(.a(new_n112_), .b(new_n111_), .O(z7));
  ...
  oai22  g128(.a(new_n161_), .b(new_n107_), .c(new_n159_), .d(new_n98_), .O(new_n162_));
  or2    g129(.a(new_n110_), .b(new_n107_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n93_), .c(new_n34_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n162_), .c(new_n156_), .d(new_n53_), .O(z6));
endmodule
