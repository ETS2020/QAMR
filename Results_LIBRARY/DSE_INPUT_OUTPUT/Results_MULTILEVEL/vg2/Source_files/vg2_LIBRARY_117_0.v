...
module FAU ( 
  ...
  nand4  g033(.a(new_n66_), .b(new_n65_), .c(new_n62_), .d(new_n61_), .O(new_n67_));
  ...
  nor2   g062(.a(new_n62_), .b(x10), .O(new_n96_));
  nand2  g063(.a(new_n96_), .b(x09), .O(new_n97_));
  nor3   g064(.a(new_n97_), .b(new_n53_), .c(new_n36_), .O(new_n98_));
  inv1   g065(.a(x20), .O(new_n99_));
  inv1   g066(.a(x21), .O(new_n100_));
  nand3  g067(.a(new_n40_), .b(x23), .c(x22), .O(new_n101_));
  nor3   g068(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n98_), .c(new_n95_), .d(new_n92_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n91_), .c(new_n78_), .O(z1));
  inv1   g071(.a(x10), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(x06), .c(x03), .d(x01), .O(new_n106_));
  nor2   g073(.a(new_n37_), .b(new_n62_), .O(new_n107_));
  nor2   g074(.a(x24), .b(new_n100_), .O(new_n108_));
  ...
  oai21  g082(.a(new_n112_), .b(new_n44_), .c(new_n115_), .O(new_n116_));
  oai21  g083(.a(new_n116_), .b(new_n114_), .c(x20), .O(new_n117_));
  nor2   g084(.a(new_n117_), .b(new_n37_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x11), .c(x06), .d(x03), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n34_), .c(new_n111_), .O(z2));
  nand3  g087(.a(new_n54_), .b(x03), .c(x01), .O(new_n121_));
  nand3  g088(.a(new_n108_), .b(new_n96_), .c(x14), .O(new_n122_));
  oai21  g089(.a(new_n122_), .b(new_n121_), .c(x20), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n93_), .O(new_n124_));
  nand3  g091(.a(new_n107_), .b(x20), .c(x15), .O(new_n125_));
  nand3  g092(.a(new_n66_), .b(new_n35_), .c(new_n34_), .O(new_n126_));
  nand3  g093(.a(new_n71_), .b(new_n37_), .c(new_n62_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n121_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n77_), .O(new_n129_));
  nand3  g096(.a(new_n107_), .b(x20), .c(x18), .O(new_n130_));
  nand3  g097(.a(new_n84_), .b(new_n35_), .c(new_n34_), .O(new_n131_));
  nand4  g098(.a(new_n99_), .b(new_n37_), .c(new_n62_), .d(new_n53_), .O(new_n132_));
  ...
  nand2  g108(.a(new_n99_), .b(new_n93_), .O(new_n142_));
  inv1   g109(.a(new_n142_), .O(new_n143_));
  nor2   g110(.a(x24), .b(new_n99_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n105_), .c(new_n93_), .d(x00), .O(new_n145_));
  oai21  g112(.a(new_n143_), .b(new_n141_), .c(new_n145_), .O(new_n146_));
  ...
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n61_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n148_), .c(x08), .O(new_n152_));
  nor2   g119(.a(new_n116_), .b(new_n114_), .O(new_n153_));
  nand4  g120(.a(new_n108_), .b(x20), .c(new_n105_), .d(new_n93_), .O(new_n154_));
  oai21  g121(.a(new_n143_), .b(new_n153_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n147_), .O(z4));
  nand3  g124(.a(new_n40_), .b(new_n105_), .c(x00), .O(new_n158_));
  ...
  oai21  g128(.a(new_n62_), .b(x06), .c(x03), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n155_), .O(new_n163_));
  oai21  g130(.a(x11), .b(new_n36_), .c(new_n35_), .O(new_n164_));
  nor2   g131(.a(new_n99_), .b(x14), .O(new_n165_));
  aoi22  g132(.a(new_n165_), .b(new_n62_), .c(new_n164_), .d(new_n142_), .O(new_n166_));
  nor2   g133(.a(new_n166_), .b(new_n70_), .O(new_n167_));
  nand3  g134(.a(new_n99_), .b(x15), .c(x14), .O(new_n168_));
  nor3   g135(.a(new_n168_), .b(new_n62_), .c(new_n93_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n167_), .c(new_n77_), .O(new_n170_));
  nor2   g137(.a(new_n62_), .b(new_n93_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n99_), .c(x18), .d(x14), .O(new_n172_));
  oai21  g139(.a(new_n166_), .b(new_n83_), .c(new_n172_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n75_), .c(x24), .O(new_n174_));
  oai21  g141(.a(new_n37_), .b(x06), .c(new_n62_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n35_), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(new_n40_), .c(x20), .d(new_n105_), .O(new_n177_));
  inv1   g144(.a(new_n177_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n93_), .c(x00), .O(new_n179_));
  nand4  g146(.a(new_n179_), .b(new_n174_), .c(new_n170_), .d(new_n163_), .O(z6));
  aoi21  g147(.a(new_n108_), .b(new_n105_), .c(new_n99_), .O(new_n181_));
