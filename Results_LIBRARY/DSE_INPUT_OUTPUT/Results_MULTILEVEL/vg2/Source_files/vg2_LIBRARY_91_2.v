...
module FAU ( 
  ...
  nand3  g011(.a(new_n39_), .b(new_n44_), .c(x00), .O(new_n45_));
  ...
  nand2  g021(.a(new_n44_), .b(x02), .O(new_n55_));
  ...
  nand3  g047(.a(new_n39_), .b(x13), .c(x05), .O(new_n81_));
  ...
  nand4  g053(.a(new_n86_), .b(new_n85_), .c(new_n67_), .d(new_n60_), .O(new_n87_));
  nor2   g054(.a(x09), .b(x08), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n70_), .c(x07), .d(new_n35_), .O(new_n89_));
  ...
  nand4  g064(.a(new_n97_), .b(new_n85_), .c(new_n67_), .d(new_n60_), .O(new_n98_));
  ...
  nand3  g069(.a(new_n102_), .b(new_n39_), .c(new_n44_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n95_), .c(new_n83_), .O(new_n104_));
  nand2  g071(.a(new_n104_), .b(new_n57_), .O(new_n105_));
  nand2  g072(.a(new_n95_), .b(new_n83_), .O(new_n106_));
  nand2  g073(.a(new_n106_), .b(x10), .O(new_n107_));
  nand2  g074(.a(new_n107_), .b(new_n105_), .O(z1));
  ...
  oai21  g082(.a(new_n115_), .b(new_n112_), .c(new_n55_), .O(new_n116_));
  nor2   g083(.a(x24), .b(new_n96_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(new_n44_), .c(new_n57_), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(new_n116_), .c(new_n37_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x14), .c(x11), .d(x06), .O(new_n120_));
  nor3   g087(.a(new_n120_), .b(new_n34_), .c(new_n109_), .O(z2));
  ...
  nand2  g092(.a(new_n99_), .b(new_n71_), .O(new_n126_));
  nand3  g093(.a(new_n76_), .b(new_n123_), .c(new_n36_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n122_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n82_), .O(new_n129_));
  nand2  g096(.a(new_n124_), .b(new_n86_), .O(new_n130_));
  nand3  g097(.a(new_n99_), .b(x07), .c(new_n35_), .O(new_n131_));
  inv1   g098(.a(x08), .O(new_n132_));
  nand4  g099(.a(new_n37_), .b(new_n123_), .c(new_n36_), .d(new_n132_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n131_), .c(new_n130_), .d(new_n122_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n80_), .c(x24), .O(new_n135_));
  nand4  g102(.a(new_n35_), .b(new_n34_), .c(new_n109_), .d(x00), .O(new_n136_));
  nand2  g103(.a(new_n124_), .b(new_n97_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n122_), .c(new_n136_), .d(new_n133_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n39_), .c(new_n44_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n135_), .c(new_n129_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n57_), .O(new_n141_));
  nand2  g108(.a(new_n135_), .b(new_n129_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(x10), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n141_), .O(z3));
  inv1   g111(.a(x04), .O(new_n145_));
  oai21  g112(.a(x23), .b(new_n145_), .c(new_n63_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n65_), .c(x09), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x16), .c(new_n132_), .O(new_n148_));
  ...
  inv1   g120(.a(new_n112_), .O(new_n154_));
  nand2  g121(.a(new_n117_), .b(new_n44_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n114_), .c(new_n113_), .d(new_n154_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n149_), .c(new_n55_), .O(z4));
  inv1   g125(.a(x00), .O(new_n159_));
  oai21  g126(.a(x24), .b(new_n159_), .c(new_n57_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n44_), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n48_), .c(new_n43_), .d(new_n42_), .O(z5));
  nand2  g129(.a(x20), .b(new_n123_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n35_), .c(x11), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x03), .c(new_n51_), .O(new_n165_));
  nand2  g132(.a(new_n37_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n36_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n34_), .c(new_n156_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n55_), .O(z6));
  inv1   g136(.a(new_n115_), .O(new_n170_));
  oai21  g137(.a(new_n117_), .b(x02), .c(new_n44_), .O(new_n171_));
