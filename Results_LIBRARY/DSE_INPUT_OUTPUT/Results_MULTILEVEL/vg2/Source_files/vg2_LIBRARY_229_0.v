...
module FAU ( 
  ...
  nand3  g118(.a(new_n151_), .b(new_n149_), .c(new_n141_), .O(z4));
  nor2   g119(.a(new_n46_), .b(new_n42_), .O(new_n153_));
  nand3  g120(.a(new_n40_), .b(new_n94_), .c(x00), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(x01), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n108_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(z5));
  nand2  g124(.a(x20), .b(new_n102_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n35_), .c(x11), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x03), .c(new_n140_), .O(new_n160_));
  oai21  g127(.a(x20), .b(new_n102_), .c(x06), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(x11), .c(x03), .O(new_n162_));
  oai21  g129(.a(x03), .b(new_n61_), .c(new_n162_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n142_), .O(new_n164_));
  nand2  g131(.a(new_n107_), .b(new_n106_), .O(new_n165_));
  nor2   g132(.a(new_n165_), .b(new_n105_), .O(new_n166_));
  nor2   g133(.a(new_n166_), .b(x03), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(x02), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n164_), .c(new_n160_), .d(new_n151_), .O(z6));
  nand3  g136(.a(new_n128_), .b(new_n91_), .c(new_n94_), .O(new_n170_));
  oai21  g137(.a(new_n166_), .b(new_n150_), .c(new_n170_), .O(z7));
endmodule
