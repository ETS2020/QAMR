...
module FAU ( 
  ...
  nand4  g026(.a(new_n59_), .b(new_n46_), .c(new_n37_), .d(new_n36_), .O(new_n60_));
  oai21  g027(.a(new_n60_), .b(x01), .c(new_n45_), .O(z0));
  nand3  g028(.a(x04), .b(x03), .c(x01), .O(new_n62_));
  inv1   g029(.a(new_n62_), .O(new_n63_));
  inv1   g030(.a(x08), .O(new_n64_));
  nor2   g031(.a(new_n64_), .b(new_n37_), .O(new_n65_));
  nand4  g032(.a(new_n65_), .b(new_n63_), .c(x11), .d(x09), .O(new_n66_));
  ...
  nand4  g041(.a(new_n74_), .b(new_n73_), .c(new_n46_), .d(new_n72_), .O(new_n75_));
  nor2   g042(.a(x14), .b(x12), .O(new_n76_));
  nor2   g043(.a(x17), .b(x16), .O(new_n77_));
  nor2   g044(.a(x20), .b(new_n54_), .O(new_n78_));
  nor2   g045(.a(x23), .b(x22), .O(new_n79_));
  nand4  g046(.a(new_n79_), .b(new_n78_), .c(new_n77_), .d(new_n76_), .O(new_n80_));
  oai22  g047(.a(new_n80_), .b(new_n75_), .c(new_n71_), .d(new_n66_), .O(new_n81_));
  ...
  nand4  g055(.a(new_n88_), .b(new_n87_), .c(x23), .d(x22), .O(new_n89_));
  ...
  oai22  g062(.a(new_n95_), .b(new_n91_), .c(new_n89_), .d(new_n66_), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(new_n82_), .c(x24), .O(new_n97_));
  inv1   g064(.a(x10), .O(new_n98_));
  nand4  g065(.a(new_n70_), .b(x16), .c(x14), .d(x12), .O(new_n99_));
  ...
  oai22  g069(.a(new_n102_), .b(new_n95_), .c(new_n99_), .d(new_n66_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n41_), .c(new_n98_), .O(new_n104_));
  ...
  aoi21  g078(.a(new_n111_), .b(new_n110_), .c(new_n51_), .O(new_n112_));
  nand3  g079(.a(x15), .b(new_n52_), .c(new_n51_), .O(new_n113_));
  ...
  nand3  g083(.a(new_n116_), .b(new_n98_), .c(new_n34_), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(new_n115_), .c(new_n40_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x14), .c(x11), .d(x06), .O(new_n119_));
  nor3   g086(.a(new_n119_), .b(new_n36_), .c(new_n35_), .O(z2));
  nand3  g087(.a(x15), .b(x13), .c(x05), .O(new_n121_));
  oai21  g088(.a(x10), .b(x02), .c(new_n121_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x20), .c(x14), .d(x11), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(new_n64_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x06), .c(x03), .d(x01), .O(new_n125_));
  nand3  g092(.a(new_n98_), .b(new_n34_), .c(x00), .O(new_n126_));
  nand3  g093(.a(x19), .b(x13), .c(x05), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n40_), .c(new_n39_), .d(new_n46_), .O(new_n129_));
  ...
  nand3  g099(.a(new_n65_), .b(x03), .c(x01), .O(new_n133_));
  nand3  g100(.a(new_n88_), .b(x14), .c(x11), .O(new_n134_));
  nand3  g101(.a(new_n100_), .b(x07), .c(new_n37_), .O(new_n135_));
  nand4  g102(.a(new_n40_), .b(new_n39_), .c(new_n46_), .d(new_n64_), .O(new_n136_));
  ...
  nand2  g106(.a(new_n100_), .b(new_n74_), .O(new_n140_));
  ...
  nand3  g109(.a(new_n142_), .b(new_n52_), .c(new_n51_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n138_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n132_), .c(x21), .O(new_n145_));
  nand2  g112(.a(new_n142_), .b(new_n84_), .O(new_n146_));
  ...
  oai21  g126(.a(x23), .b(new_n158_), .c(new_n159_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n157_), .c(x09), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x16), .c(new_n64_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n109_), .c(new_n57_), .O(new_n163_));
  nand4  g130(.a(new_n116_), .b(new_n98_), .c(new_n34_), .d(x00), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n163_), .c(new_n156_), .O(z4));
  inv1   g132(.a(new_n57_), .O(new_n166_));
  nand3  g133(.a(new_n41_), .b(new_n98_), .c(x00), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(x21), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n34_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n166_), .O(z5));
  oai21  g137(.a(x20), .b(new_n39_), .c(x06), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(x11), .O(new_n172_));
  nand2  g139(.a(new_n109_), .b(new_n36_), .O(new_n173_));
  oai21  g140(.a(new_n172_), .b(new_n36_), .c(new_n173_), .O(new_n174_));
  oai21  g141(.a(new_n114_), .b(new_n112_), .c(new_n174_), .O(new_n175_));
  inv1   g142(.a(x00), .O(new_n176_));
  nand2  g143(.a(new_n172_), .b(new_n176_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n41_), .c(new_n98_), .d(new_n34_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n56_), .c(new_n50_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(x03), .O(new_n180_));
  nand3  g147(.a(new_n116_), .b(new_n98_), .c(new_n36_), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(x21), .c(x02), .O(new_n182_));
  aoi21  g149(.a(x20), .b(new_n39_), .c(x06), .O(new_n183_));
  nor2   g150(.a(new_n183_), .b(new_n166_), .O(new_n184_));
  aoi21  g151(.a(new_n184_), .b(new_n46_), .c(new_n182_), .O(new_n185_));
