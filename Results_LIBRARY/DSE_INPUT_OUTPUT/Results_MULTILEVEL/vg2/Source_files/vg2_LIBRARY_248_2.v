...
module FAU ( 
  ...
  nand4  g091(.a(new_n124_), .b(x11), .c(x03), .d(x01), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(x20), .c(new_n35_), .O(z2));
  nand4  g093(.a(new_n56_), .b(x14), .c(x11), .d(x08), .O(new_n127_));
  ...
  nor4   g096(.a(new_n129_), .b(x08), .c(x03), .d(x01), .O(new_n130_));
  ...
  nand3  g101(.a(x07), .b(new_n34_), .c(new_n64_), .O(new_n135_));
  nand4  g102(.a(new_n71_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n136_));
  ...
  nand3  g106(.a(new_n66_), .b(new_n34_), .c(new_n64_), .O(new_n140_));
  nand4  g107(.a(new_n71_), .b(x19), .c(new_n68_), .d(new_n36_), .O(new_n141_));
  ...
  nor2   g110(.a(x20), .b(new_n35_), .O(new_n144_));
  inv1   g111(.a(new_n144_), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n143_), .c(new_n138_), .d(new_n131_), .O(z3));
  ...
  oai21  g126(.a(new_n159_), .b(x03), .c(new_n147_), .O(new_n160_));
  oai22  g127(.a(new_n144_), .b(x03), .c(new_n36_), .d(x06), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n122_), .c(new_n144_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n160_), .O(z6));
  nor2   g130(.a(new_n144_), .b(new_n123_), .O(z7));
endmodule
