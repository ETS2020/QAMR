...
module FAU ( 
  ...
  nand2  g093(.a(new_n126_), .b(new_n73_), .O(new_n127_));
  nand3  g094(.a(new_n78_), .b(new_n41_), .c(new_n40_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n127_), .c(new_n125_), .d(new_n124_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n84_), .O(new_n130_));
  nand3  g097(.a(new_n88_), .b(x14), .c(x11), .O(new_n131_));
  nand3  g098(.a(new_n126_), .b(x07), .c(new_n37_), .O(new_n132_));
  nand4  g099(.a(new_n46_), .b(new_n41_), .c(new_n40_), .d(new_n101_), .O(new_n133_));
  ...
  oai21  g104(.a(x23), .b(new_n137_), .c(new_n65_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n67_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n101_), .O(new_n140_));
  nor2   g107(.a(x02), .b(new_n35_), .O(new_n141_));
  inv1   g108(.a(new_n141_), .O(new_n142_));
  oai21  g109(.a(new_n55_), .b(new_n51_), .c(new_n142_), .O(new_n143_));
  nor2   g110(.a(x24), .b(x10), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n145_));
  ...
  aoi21  g115(.a(new_n148_), .b(x22), .c(new_n71_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n93_), .c(x08), .O(new_n150_));
  nand2  g117(.a(new_n142_), .b(new_n115_), .O(new_n151_));
  nor2   g118(.a(x02), .b(x01), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n49_), .c(x21), .d(new_n38_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n151_), .O(z7));
  nand2  g121(.a(z7), .b(new_n150_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n147_), .O(z4));
  nand2  g123(.a(x20), .b(new_n41_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n37_), .c(x11), .O(new_n158_));
  nand3  g125(.a(new_n144_), .b(new_n34_), .c(x00), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n54_), .c(new_n52_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n51_), .c(new_n158_), .d(x03), .O(new_n161_));
  oai21  g128(.a(x20), .b(new_n41_), .c(x06), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(x11), .c(x03), .O(new_n163_));
  inv1   g130(.a(new_n163_), .O(new_n164_));
  nand4  g131(.a(new_n49_), .b(x21), .c(new_n38_), .d(new_n34_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n166_));
  oai21  g133(.a(new_n164_), .b(new_n126_), .c(new_n166_), .O(new_n167_));
  nand3  g134(.a(new_n115_), .b(new_n36_), .c(x02), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n167_), .c(new_n161_), .d(new_n142_), .O(z6));
endmodule
