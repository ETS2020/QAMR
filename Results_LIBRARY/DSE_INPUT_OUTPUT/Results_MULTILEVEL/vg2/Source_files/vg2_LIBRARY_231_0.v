...
module FAU ( 
  ...
  nand3  g086(.a(new_n119_), .b(x06), .c(x03), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(new_n64_), .c(new_n110_), .O(z2));
  nand3  g088(.a(new_n57_), .b(x03), .c(x01), .O(new_n122_));
  nor2   g089(.a(new_n37_), .b(new_n36_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(x20), .c(x15), .O(new_n124_));
  nand4  g091(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n64_), .O(new_n125_));
  nand4  g092(.a(new_n73_), .b(new_n37_), .c(new_n36_), .d(new_n56_), .O(new_n126_));
  ...
  nand4  g097(.a(new_n130_), .b(new_n36_), .c(new_n56_), .d(x07), .O(new_n131_));
  ...
  nand4  g113(.a(new_n146_), .b(new_n105_), .c(x01), .d(x00), .O(new_n147_));
  ...
  aoi21  g120(.a(new_n153_), .b(x22), .c(new_n151_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n150_), .c(x08), .O(new_n155_));
  inv1   g122(.a(new_n145_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n117_), .O(new_n157_));
  nand3  g124(.a(new_n107_), .b(new_n94_), .c(new_n97_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n157_), .O(z7));
  nand2  g126(.a(z7), .b(new_n155_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n149_), .O(z4));
  aoi21  g128(.a(new_n146_), .b(x00), .c(new_n64_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x02), .c(new_n144_), .O(z5));
  nand2  g130(.a(x20), .b(new_n37_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n35_), .c(x11), .O(new_n165_));
  nand3  g132(.a(new_n146_), .b(new_n105_), .c(x00), .O(new_n166_));
  ...
  nand3  g138(.a(new_n107_), .b(new_n97_), .c(new_n105_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n116_), .c(new_n115_), .d(new_n114_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n171_), .O(new_n174_));
  nand3  g141(.a(new_n117_), .b(new_n34_), .c(x02), .O(new_n175_));
