...
module FAU ( 
  ...
  nor2   g083(.a(new_n116_), .b(new_n70_), .O(z2));
  ...
  nand4  g087(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n121_));
  nand4  g088(.a(new_n79_), .b(new_n38_), .c(new_n37_), .d(new_n69_), .O(new_n122_));
  oai22  g089(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n118_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n85_), .O(new_n124_));
  nand2  g091(.a(new_n119_), .b(new_n89_), .O(new_n125_));
  nor2   g092(.a(x20), .b(x14), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n37_), .c(new_n69_), .d(x07), .O(new_n127_));
  ...
  nand4  g096(.a(new_n36_), .b(new_n35_), .c(new_n70_), .d(x00), .O(new_n130_));
  nand3  g097(.a(new_n126_), .b(new_n37_), .c(new_n69_), .O(new_n131_));
  nand2  g098(.a(new_n119_), .b(new_n99_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n118_), .c(new_n131_), .d(new_n130_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n41_), .c(new_n46_), .d(new_n34_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n129_), .c(new_n124_), .O(z3));
  oai21  g102(.a(x23), .b(new_n71_), .c(new_n63_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n65_), .c(x09), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(x16), .c(new_n69_), .O(new_n138_));
  nor2   g105(.a(new_n34_), .b(x01), .O(new_n139_));
  ...
  nand2  g110(.a(new_n143_), .b(new_n142_), .O(z5));
  ...
  oai21  g118(.a(new_n151_), .b(new_n109_), .c(new_n140_), .O(new_n152_));
  ...
  nand3  g125(.a(new_n143_), .b(new_n50_), .c(new_n45_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n156_), .c(new_n158_), .d(x03), .O(new_n160_));
  oai21  g127(.a(x20), .b(new_n38_), .c(x06), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(x11), .c(x03), .O(new_n162_));
  oai21  g129(.a(new_n139_), .b(x03), .c(new_n162_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n83_), .c(x18), .O(new_n164_));
  inv1   g131(.a(new_n111_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n35_), .c(x01), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n164_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(x24), .O(new_n168_));
  nand2  g135(.a(x24), .b(new_n35_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n49_), .c(new_n48_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n84_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(x15), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n112_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n161_), .c(x11), .O(new_n174_));
  nand3  g141(.a(new_n41_), .b(x21), .c(new_n46_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n111_), .O(new_n176_));
  ...
  nand3  g146(.a(new_n179_), .b(new_n41_), .c(x15), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n177_), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(new_n35_), .c(new_n139_), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n174_), .c(new_n168_), .d(new_n160_), .O(z6));
endmodule
