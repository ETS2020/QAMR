...
module FAU ( 
  ...
  aoi21  g072(.a(new_n47_), .b(new_n38_), .c(new_n40_), .O(new_n106_));
  ...
  nand3  g080(.a(new_n113_), .b(new_n104_), .c(new_n55_), .O(new_n114_));
  ...
  nor3   g091(.a(new_n124_), .b(new_n37_), .c(new_n72_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x11), .c(x06), .d(x03), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n68_), .c(new_n55_), .O(z2));
  nand4  g094(.a(new_n60_), .b(x20), .c(x14), .d(x11), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(new_n70_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x06), .c(x03), .d(x01), .O(new_n130_));
  nand4  g097(.a(new_n79_), .b(new_n37_), .c(new_n72_), .d(new_n36_), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(x08), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n40_), .O(new_n135_));
  nor2   g102(.a(x13), .b(x05), .O(new_n136_));
  ...
  nand4  g107(.a(new_n37_), .b(new_n72_), .c(new_n36_), .d(new_n70_), .O(new_n141_));
  ...
  nand4  g111(.a(new_n70_), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n145_));
  nand3  g112(.a(new_n101_), .b(new_n72_), .c(new_n36_), .O(new_n146_));
  ...
  nand4  g115(.a(new_n148_), .b(new_n143_), .c(new_n135_), .d(new_n55_), .O(z3));
  nand3  g116(.a(new_n40_), .b(x13), .c(x05), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n137_), .O(new_n151_));
  inv1   g118(.a(x15), .O(new_n152_));
  aoi21  g119(.a(x23), .b(new_n69_), .c(new_n74_), .O(new_n153_));
  nor2   g120(.a(new_n153_), .b(new_n75_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n71_), .c(x16), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x08), .c(new_n152_), .O(new_n156_));
  aoi21  g123(.a(new_n76_), .b(x04), .c(x17), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x22), .c(new_n71_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n73_), .c(new_n70_), .O(new_n159_));
  inv1   g126(.a(new_n159_), .O(new_n160_));
  aoi21  g127(.a(x08), .b(new_n53_), .c(new_n160_), .O(new_n161_));
  nor2   g128(.a(new_n161_), .b(new_n100_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n156_), .c(new_n151_), .O(new_n163_));
  nand3  g130(.a(new_n73_), .b(x09), .c(new_n70_), .O(new_n164_));
  nand2  g131(.a(x22), .b(x08), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n164_), .c(new_n53_), .O(new_n166_));
  aoi21  g133(.a(new_n71_), .b(new_n53_), .c(new_n154_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n73_), .c(x08), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x18), .c(new_n166_), .O(new_n169_));
  nand2  g136(.a(new_n153_), .b(x09), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(x16), .c(x15), .O(new_n171_));
  oai21  g138(.a(new_n75_), .b(new_n100_), .c(new_n171_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(x08), .c(x07), .O(new_n173_));
  oai21  g140(.a(new_n169_), .b(new_n136_), .c(new_n173_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(x24), .O(new_n175_));
  inv1   g142(.a(x00), .O(new_n176_));
  inv1   g143(.a(x21), .O(new_n177_));
  nor2   g144(.a(new_n153_), .b(new_n177_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(x16), .O(new_n179_));
  oai21  g146(.a(new_n70_), .b(new_n176_), .c(new_n179_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n45_), .c(new_n44_), .O(new_n181_));
  nand2  g148(.a(x13), .b(x05), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n137_), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(x19), .c(x08), .O(new_n184_));
  aoi21  g151(.a(new_n184_), .b(new_n181_), .c(new_n75_), .O(new_n185_));
  nand2  g152(.a(x16), .b(new_n71_), .O(new_n186_));
  aoi21  g153(.a(new_n186_), .b(x08), .c(new_n177_), .O(new_n187_));
  nor2   g154(.a(new_n161_), .b(new_n176_), .O(new_n188_));
  oai21  g155(.a(new_n188_), .b(new_n187_), .c(new_n45_), .O(new_n189_));
  nor2   g156(.a(new_n189_), .b(x02), .O(new_n190_));
  oai21  g157(.a(new_n190_), .b(new_n185_), .c(new_n40_), .O(new_n191_));
  nand4  g158(.a(new_n191_), .b(new_n175_), .c(new_n163_), .d(new_n55_), .O(z4));
  aoi21  g159(.a(new_n78_), .b(new_n77_), .c(new_n54_), .O(new_n193_));
  nand3  g160(.a(new_n136_), .b(x22), .c(x19), .O(new_n194_));
  inv1   g161(.a(new_n194_), .O(new_n195_));
  oai21  g162(.a(new_n195_), .b(new_n193_), .c(new_n40_), .O(new_n196_));
  nand3  g163(.a(new_n47_), .b(new_n53_), .c(new_n38_), .O(new_n197_));
  nand3  g164(.a(x24), .b(x22), .c(x07), .O(new_n198_));
  aoi21  g165(.a(new_n198_), .b(new_n197_), .c(new_n100_), .O(new_n199_));
  nor3   g166(.a(new_n136_), .b(new_n40_), .c(new_n75_), .O(new_n200_));
  aoi21  g167(.a(new_n200_), .b(x07), .c(new_n199_), .O(new_n201_));
  nand2  g168(.a(new_n201_), .b(new_n196_), .O(z5));
  nand2  g169(.a(x20), .b(new_n72_), .O(new_n203_));
  aoi21  g170(.a(new_n203_), .b(new_n35_), .c(x11), .O(new_n204_));
  oai22  g171(.a(new_n204_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n205_));
  oai21  g172(.a(x20), .b(new_n72_), .c(x06), .O(new_n206_));
  nand3  g173(.a(new_n206_), .b(x11), .c(x03), .O(new_n207_));
  oai21  g174(.a(new_n54_), .b(x03), .c(new_n207_), .O(new_n208_));
  oai21  g175(.a(new_n123_), .b(new_n119_), .c(new_n208_), .O(new_n209_));
  nand3  g176(.a(new_n209_), .b(new_n205_), .c(new_n55_), .O(z6));
  nor2   g177(.a(new_n124_), .b(new_n54_), .O(z7));
endmodule
