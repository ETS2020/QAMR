...
module FAU ( 
  ...
  nand4  g035(.a(new_n36_), .b(new_n39_), .c(new_n68_), .d(new_n35_), .O(new_n69_));
  ...
  nand4  g078(.a(new_n81_), .b(x21), .c(new_n38_), .d(new_n55_), .O(new_n112_));
  ...
  nand3  g109(.a(new_n142_), .b(new_n63_), .c(new_n73_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n68_), .O(new_n144_));
  ...
  oai21  g118(.a(new_n150_), .b(x09), .c(new_n151_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n144_), .O(new_n153_));
  aoi21  g120(.a(new_n73_), .b(x09), .c(x08), .O(new_n154_));
  ...
  nand3  g125(.a(new_n81_), .b(x21), .c(new_n38_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n109_), .c(new_n108_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n107_), .c(new_n158_), .O(new_n161_));
  nand3  g128(.a(new_n73_), .b(x09), .c(x00), .O(new_n162_));
  nand3  g129(.a(x21), .b(x16), .c(new_n39_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n81_), .c(new_n38_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n161_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n155_), .c(new_n55_), .O(new_n167_));
  or2    g134(.a(new_n110_), .b(new_n107_), .O(new_n168_));
  nand2  g135(.a(new_n73_), .b(x08), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n168_), .c(new_n39_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n153_), .O(z4));
  inv1   g138(.a(new_n53_), .O(new_n172_));
  oai21  g139(.a(new_n150_), .b(new_n172_), .c(new_n151_), .O(z5));
