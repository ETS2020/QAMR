...
module FAU ( 
  ...
  nand4  g037(.a(new_n70_), .b(new_n69_), .c(new_n66_), .d(new_n37_), .O(new_n71_));
  ...
  nand4  g052(.a(new_n85_), .b(new_n84_), .c(new_n64_), .d(new_n56_), .O(new_n86_));
  nor2   g053(.a(x09), .b(x08), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n69_), .c(x07), .d(new_n37_), .O(new_n88_));
  ...
  nand4  g063(.a(new_n96_), .b(new_n84_), .c(new_n64_), .d(new_n56_), .O(new_n97_));
  ...
  nand2  g080(.a(new_n60_), .b(x02), .O(new_n114_));
  oai21  g081(.a(new_n113_), .b(new_n35_), .c(new_n114_), .O(z2));
  ...
  nand4  g086(.a(new_n37_), .b(new_n36_), .c(new_n34_), .d(new_n35_), .O(new_n120_));
  nand4  g087(.a(new_n75_), .b(new_n38_), .c(new_n117_), .d(new_n66_), .O(new_n121_));
  oai22  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n116_), .O(new_n122_));
  ...
  nand4  g092(.a(new_n125_), .b(new_n117_), .c(new_n66_), .d(x07), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n120_), .c(new_n124_), .d(new_n116_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n79_), .c(x24), .O(new_n128_));
  nand4  g095(.a(new_n37_), .b(new_n36_), .c(new_n35_), .d(x00), .O(new_n129_));
  nand3  g096(.a(new_n125_), .b(new_n117_), .c(new_n66_), .O(new_n130_));
  nand2  g097(.a(new_n118_), .b(new_n96_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n116_), .c(new_n130_), .d(new_n129_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n41_), .c(new_n45_), .d(new_n34_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n128_), .c(new_n123_), .O(z3));
  oai21  g101(.a(x23), .b(new_n67_), .c(new_n59_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n62_), .c(x09), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(x16), .c(new_n66_), .O(new_n137_));
  nand2  g104(.a(new_n48_), .b(new_n44_), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(new_n43_), .c(new_n114_), .O(new_n139_));
  ...
  oai21  g115(.a(new_n148_), .b(new_n106_), .c(new_n114_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n109_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n142_), .O(z4));
  inv1   g119(.a(new_n43_), .O(new_n153_));
  and2   g120(.a(new_n140_), .b(new_n44_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n114_), .c(new_n48_), .d(new_n153_), .O(z5));
  nand2  g122(.a(x20), .b(new_n38_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n37_), .c(x11), .O(new_n157_));
  nand3  g124(.a(new_n140_), .b(new_n48_), .c(new_n44_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n43_), .c(new_n157_), .d(x03), .O(new_n159_));
  oai21  g126(.a(new_n117_), .b(x06), .c(x03), .O(new_n160_));
  oai21  g127(.a(new_n110_), .b(new_n106_), .c(new_n160_), .O(new_n161_));
  nand3  g128(.a(new_n118_), .b(new_n60_), .c(x15), .O(new_n162_));
  nand2  g129(.a(new_n117_), .b(x02), .O(new_n163_));
  nand3  g130(.a(new_n41_), .b(x19), .c(new_n38_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n163_), .c(new_n162_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n47_), .c(new_n39_), .O(new_n166_));
  nand3  g133(.a(x13), .b(new_n117_), .c(x05), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n164_), .c(x20), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x02), .O(new_n169_));
  nand2  g136(.a(new_n105_), .b(new_n104_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(x05), .O(new_n171_));
  nand3  g138(.a(new_n41_), .b(x21), .c(new_n45_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n107_), .c(new_n171_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n60_), .c(x14), .d(x11), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n169_), .c(new_n166_), .O(new_n175_));
  inv1   g142(.a(new_n175_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n161_), .c(new_n159_), .O(z6));
  inv1   g144(.a(new_n148_), .O(new_n178_));
  nand3  g145(.a(new_n60_), .b(x14), .c(x11), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(x02), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n41_), .c(x21), .d(new_n45_), .O(new_n181_));
  nand4  g148(.a(new_n181_), .b(new_n178_), .c(new_n114_), .d(new_n171_), .O(z7));
endmodule
