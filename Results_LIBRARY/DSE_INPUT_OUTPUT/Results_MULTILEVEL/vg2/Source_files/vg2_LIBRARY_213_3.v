...
module FAU ( 
  ...
  or2    g083(.a(new_n116_), .b(new_n112_), .O(new_n117_));
  ...
  nor2   g087(.a(new_n120_), .b(new_n55_), .O(z2));
  nand3  g088(.a(new_n56_), .b(x06), .c(x03), .O(new_n122_));
  ...
  nand4  g093(.a(new_n126_), .b(new_n104_), .c(new_n78_), .d(new_n70_), .O(new_n127_));
  oai21  g094(.a(new_n125_), .b(new_n122_), .c(new_n127_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n85_), .O(new_n129_));
  nand3  g096(.a(new_n124_), .b(new_n90_), .c(x14), .O(new_n130_));
  nand2  g097(.a(new_n104_), .b(new_n93_), .O(new_n131_));
  nand4  g098(.a(new_n37_), .b(new_n74_), .c(new_n36_), .d(new_n123_), .O(new_n132_));
  ...
  nand4  g101(.a(new_n35_), .b(new_n34_), .c(new_n55_), .d(x00), .O(new_n135_));
  ...
  nand2  g107(.a(x02), .b(x01), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(x08), .O(new_n142_));
  inv1   g109(.a(x09), .O(new_n143_));
  aoi21  g110(.a(new_n65_), .b(x04), .c(x17), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x22), .c(new_n143_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n75_), .c(new_n123_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n142_), .c(new_n92_), .O(new_n147_));
  inv1   g114(.a(x04), .O(new_n148_));
  aoi21  g115(.a(x23), .b(new_n148_), .c(new_n76_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n64_), .c(x09), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x16), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x08), .c(new_n89_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n147_), .c(new_n83_), .O(new_n153_));
  nand4  g120(.a(new_n48_), .b(x08), .c(new_n38_), .d(new_n55_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(x24), .O(new_n156_));
  nand2  g123(.a(new_n85_), .b(x15), .O(new_n157_));
  nand4  g124(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n158_));
  aoi22  g125(.a(new_n158_), .b(new_n157_), .c(new_n151_), .d(x08), .O(new_n159_));
  nand2  g126(.a(x24), .b(x08), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n82_), .c(new_n38_), .O(new_n161_));
  ...
  nand3  g131(.a(new_n164_), .b(new_n145_), .c(new_n75_), .O(new_n165_));
  nand3  g132(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n49_), .c(x02), .O(new_n167_));
  nand2  g134(.a(x13), .b(x05), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n83_), .O(new_n169_));
  ...
  nand3  g139(.a(new_n172_), .b(new_n165_), .c(new_n141_), .O(new_n173_));
  nor2   g140(.a(new_n173_), .b(new_n159_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n156_), .O(z4));
  nand2  g142(.a(new_n49_), .b(new_n43_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n42_), .c(new_n141_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n46_), .O(z5));
  aoi21  g145(.a(x20), .b(new_n74_), .c(x06), .O(new_n179_));
  ...
  oai21  g151(.a(new_n184_), .b(new_n112_), .c(new_n141_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n158_), .O(z7));
