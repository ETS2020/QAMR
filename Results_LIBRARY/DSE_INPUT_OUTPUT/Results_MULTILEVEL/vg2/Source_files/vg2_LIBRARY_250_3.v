...
module FAU ( 
  ...
  nor3   g063(.a(new_n57_), .b(new_n55_), .c(new_n96_), .O(new_n97_));
  inv1   g064(.a(x21), .O(new_n98_));
  nor2   g065(.a(new_n98_), .b(new_n37_), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n97_), .c(new_n87_), .d(new_n64_), .O(new_n100_));
  ...
  nand3  g077(.a(x15), .b(new_n81_), .c(new_n38_), .O(new_n111_));
  ...
  aoi21  g084(.a(new_n117_), .b(new_n44_), .c(new_n96_), .O(z2));
  nand4  g085(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n119_));
  nor2   g086(.a(new_n72_), .b(new_n36_), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(x20), .c(x15), .O(new_n121_));
  nand3  g088(.a(new_n101_), .b(new_n67_), .c(new_n35_), .O(new_n122_));
  nand4  g089(.a(new_n37_), .b(x19), .c(new_n72_), .d(new_n36_), .O(new_n123_));
  ...
  nand4  g094(.a(new_n37_), .b(new_n72_), .c(new_n36_), .d(new_n67_), .O(new_n128_));
  ...
  nand4  g097(.a(new_n45_), .b(x08), .c(x06), .d(x03), .O(new_n131_));
  nand3  g098(.a(new_n120_), .b(new_n112_), .c(x20), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n131_), .c(new_n44_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(x01), .O(new_n134_));
  ...
  nand4  g107(.a(new_n140_), .b(new_n134_), .c(new_n130_), .d(new_n125_), .O(z3));
  inv1   g108(.a(x07), .O(new_n142_));
  nand2  g109(.a(x02), .b(x01), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(x08), .O(new_n144_));
  aoi21  g111(.a(new_n63_), .b(x04), .c(x17), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x22), .c(new_n68_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n73_), .c(new_n67_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n144_), .c(new_n142_), .O(new_n148_));
  inv1   g115(.a(x18), .O(new_n149_));
  inv1   g116(.a(x04), .O(new_n150_));
  aoi21  g117(.a(x23), .b(new_n150_), .c(new_n74_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n62_), .c(x09), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x16), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x08), .c(new_n149_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n148_), .c(new_n82_), .O(new_n155_));
  nand4  g122(.a(new_n48_), .b(x08), .c(new_n38_), .d(new_n96_), .O(new_n156_));
  ...
  nand3  g126(.a(new_n112_), .b(new_n45_), .c(new_n44_), .O(new_n160_));
  aoi22  g127(.a(new_n160_), .b(new_n159_), .c(new_n153_), .d(x08), .O(new_n161_));
  nand2  g128(.a(x24), .b(x08), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n81_), .c(new_n38_), .O(new_n163_));
  ...
  nand3  g133(.a(new_n166_), .b(new_n146_), .c(new_n73_), .O(new_n167_));
  ...
  oai21  g145(.a(new_n178_), .b(new_n42_), .c(new_n143_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n46_), .O(z5));
  aoi21  g147(.a(x20), .b(new_n72_), .c(x06), .O(new_n181_));
  ...
  nand2  g152(.a(new_n111_), .b(new_n110_), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(new_n109_), .c(new_n143_), .O(new_n187_));
