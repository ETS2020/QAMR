...
module FAU ( 
  ...
  oai21  g105(.a(new_n138_), .b(new_n88_), .c(x08), .O(new_n139_));
  nand4  g106(.a(new_n40_), .b(x21), .c(new_n98_), .d(new_n44_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n109_), .c(new_n108_), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n107_), .c(new_n139_), .O(new_n142_));
  nor2   g109(.a(x02), .b(new_n94_), .O(new_n143_));
  inv1   g110(.a(new_n143_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n142_), .c(new_n136_), .O(z4));
  ...
  aoi21  g116(.a(x20), .b(new_n87_), .c(x06), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x11), .c(new_n34_), .O(new_n151_));
  nand4  g118(.a(new_n45_), .b(new_n44_), .c(new_n94_), .d(x00), .O(new_n152_));
  ...
  nor2   g123(.a(new_n110_), .b(new_n107_), .O(new_n157_));
  nand3  g124(.a(new_n40_), .b(x21), .c(new_n98_), .O(new_n158_));
  inv1   g125(.a(new_n158_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n44_), .c(new_n94_), .O(new_n160_));
