...
module FAU ( 
  ...
  nand4  g038(.a(new_n71_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n72_));
  inv1   g039(.a(new_n72_), .O(new_n73_));
  nor2   g040(.a(x11), .b(x09), .O(new_n74_));
  nand4  g041(.a(new_n74_), .b(new_n73_), .c(new_n69_), .d(new_n36_), .O(new_n75_));
  ...
  oai21  g048(.a(new_n81_), .b(new_n75_), .c(new_n68_), .O(new_n82_));
  nand2  g049(.a(new_n49_), .b(new_n48_), .O(new_n83_));
  ...
  nand4  g056(.a(new_n89_), .b(new_n88_), .c(new_n67_), .d(new_n60_), .O(new_n90_));
  ...
  nand4  g066(.a(new_n99_), .b(new_n88_), .c(new_n67_), .d(new_n60_), .O(new_n100_));
  ...
  oai21  g070(.a(new_n103_), .b(new_n96_), .c(new_n100_), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n41_), .c(new_n46_), .d(new_n34_), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n98_), .c(new_n86_), .O(z1));
  ...
  nor2   g083(.a(new_n34_), .b(x01), .O(new_n117_));
  inv1   g084(.a(new_n117_), .O(new_n118_));
  oai21  g085(.a(new_n116_), .b(new_n70_), .c(new_n118_), .O(z2));
  ...
  nand4  g089(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n70_), .O(new_n123_));
  nand4  g090(.a(new_n79_), .b(new_n38_), .c(new_n37_), .d(new_n69_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n120_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n85_), .O(new_n126_));
  nand2  g093(.a(new_n121_), .b(new_n89_), .O(new_n127_));
  nor2   g094(.a(x20), .b(x14), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n37_), .c(new_n69_), .d(x07), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n123_), .c(new_n127_), .d(new_n120_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n83_), .c(x24), .O(new_n131_));
  nand4  g098(.a(new_n36_), .b(new_n35_), .c(new_n70_), .d(x00), .O(new_n132_));
  nand3  g099(.a(new_n128_), .b(new_n37_), .c(new_n69_), .O(new_n133_));
  nand2  g100(.a(new_n121_), .b(new_n99_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n120_), .c(new_n133_), .d(new_n132_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n41_), .c(new_n46_), .d(new_n34_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n131_), .c(new_n126_), .O(z3));
  oai21  g104(.a(x23), .b(new_n71_), .c(new_n63_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n65_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n69_), .O(new_n140_));
  nand3  g107(.a(new_n50_), .b(new_n45_), .c(new_n44_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n118_), .O(new_n142_));
  nand4  g109(.a(new_n41_), .b(new_n46_), .c(new_n34_), .d(x00), .O(new_n143_));
  ...
  oai21  g114(.a(new_n66_), .b(x04), .c(x17), .O(new_n148_));
  ...
  oai21  g118(.a(new_n151_), .b(new_n109_), .c(new_n118_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n112_), .O(z7));
  nand2  g120(.a(z7), .b(new_n150_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n145_), .O(z4));
  and2   g122(.a(new_n143_), .b(new_n50_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n118_), .c(new_n45_), .d(new_n44_), .O(z5));
  nand2  g124(.a(x20), .b(new_n38_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n36_), .c(x11), .O(new_n159_));
  nand3  g126(.a(new_n156_), .b(new_n45_), .c(new_n44_), .O(new_n160_));
  oai21  g127(.a(new_n159_), .b(x03), .c(new_n160_), .O(new_n161_));
  oai21  g128(.a(x20), .b(new_n38_), .c(x06), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(x11), .c(x03), .O(new_n163_));
  oai21  g130(.a(new_n117_), .b(x03), .c(new_n163_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n83_), .c(x18), .O(new_n165_));
  inv1   g132(.a(new_n111_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n35_), .c(x01), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x24), .O(new_n169_));
  nand2  g136(.a(x24), .b(new_n35_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n49_), .c(new_n48_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n84_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(x15), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n112_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n162_), .c(x11), .O(new_n175_));
  nand3  g142(.a(new_n41_), .b(x21), .c(new_n46_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n111_), .O(new_n177_));
  ...
  nand3  g147(.a(new_n180_), .b(new_n41_), .c(x15), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n178_), .O(new_n182_));
  aoi21  g149(.a(new_n182_), .b(new_n35_), .c(new_n117_), .O(new_n183_));
  nand4  g150(.a(new_n183_), .b(new_n175_), .c(new_n169_), .d(new_n161_), .O(z6));
endmodule
