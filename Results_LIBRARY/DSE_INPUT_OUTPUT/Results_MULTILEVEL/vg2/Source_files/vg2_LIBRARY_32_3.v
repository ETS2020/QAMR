...
module FAU ( 
  ...
  nand3  g067(.a(new_n100_), .b(new_n87_), .c(new_n65_), .O(new_n101_));
  ...
  oai22  g071(.a(new_n104_), .b(new_n96_), .c(new_n101_), .d(new_n99_), .O(new_n105_));
  ...
  nor2   g111(.a(new_n44_), .b(new_n54_), .O(new_n145_));
  inv1   g112(.a(new_n145_), .O(new_n146_));
  nand2  g113(.a(new_n48_), .b(new_n43_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n42_), .c(new_n146_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n46_), .O(z5));
  ...
  nand3  g121(.a(new_n113_), .b(new_n112_), .c(new_n111_), .O(new_n155_));
  ...
  oai22  g129(.a(new_n162_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n163_));
  oai21  g130(.a(x20), .b(new_n73_), .c(x06), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(x11), .c(x03), .O(new_n165_));
  oai21  g132(.a(new_n145_), .b(x03), .c(new_n165_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n82_), .c(x18), .O(new_n167_));
  inv1   g134(.a(new_n113_), .O(new_n168_));
  ...
  nand2  g138(.a(x24), .b(new_n34_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n47_), .c(new_n38_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n83_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(x15), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n157_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n164_), .c(x11), .O(new_n177_));
  and2   g144(.a(new_n114_), .b(new_n113_), .O(new_n178_));
  nand2  g145(.a(x13), .b(x05), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n82_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n40_), .c(x15), .O(new_n181_));
  oai21  g148(.a(new_n178_), .b(x02), .c(new_n181_), .O(new_n182_));
  aoi21  g149(.a(new_n182_), .b(new_n34_), .c(new_n145_), .O(new_n183_));
  nand4  g150(.a(new_n183_), .b(new_n177_), .c(new_n171_), .d(new_n163_), .O(z6));
endmodule
