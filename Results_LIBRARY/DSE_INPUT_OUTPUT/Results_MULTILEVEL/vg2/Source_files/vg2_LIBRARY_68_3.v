...
module FAU ( 
  ...
  xnor2a g110(.a(x13), .b(x05), .O(new_n144_));
  ...
  aoi21  g114(.a(new_n147_), .b(new_n145_), .c(new_n143_), .O(new_n148_));
  nand4  g115(.a(new_n146_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n149_));
  inv1   g116(.a(new_n149_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n148_), .c(x22), .O(new_n151_));
  nand2  g118(.a(new_n118_), .b(new_n67_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n151_), .c(new_n71_), .O(new_n153_));
  aoi21  g120(.a(new_n75_), .b(x04), .c(x09), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x16), .c(new_n66_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n125_), .O(new_n156_));
  nand4  g123(.a(new_n61_), .b(x19), .c(x17), .d(new_n71_), .O(new_n157_));
  oai21  g124(.a(new_n143_), .b(x08), .c(new_n157_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(x13), .c(x05), .O(new_n159_));
  nand3  g126(.a(x21), .b(new_n66_), .c(new_n48_), .O(new_n160_));
  nand4  g127(.a(new_n61_), .b(x17), .c(new_n71_), .d(x00), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n49_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n159_), .c(new_n156_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n153_), .c(new_n40_), .O(new_n165_));
  inv1   g132(.a(x07), .O(new_n166_));
  aoi21  g133(.a(new_n146_), .b(x22), .c(new_n67_), .O(new_n167_));
  ...
  aoi21  g138(.a(new_n171_), .b(new_n71_), .c(x08), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n166_), .c(new_n169_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n81_), .c(x24), .O(new_n174_));
  nand4  g141(.a(new_n80_), .b(new_n61_), .c(x19), .d(new_n71_), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(new_n48_), .c(new_n72_), .O(new_n176_));
  nand2  g143(.a(new_n155_), .b(x19), .O(new_n177_));
  nand2  g144(.a(new_n168_), .b(x15), .O(new_n178_));
  aoi21  g145(.a(new_n178_), .b(new_n177_), .c(x13), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n38_), .c(new_n176_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n174_), .c(new_n165_), .O(z4));
  inv1   g148(.a(new_n124_), .O(new_n182_));
  nand3  g149(.a(new_n61_), .b(x17), .c(new_n71_), .O(new_n183_));
  aoi21  g150(.a(new_n183_), .b(x02), .c(x10), .O(new_n184_));
  aoi21  g151(.a(new_n184_), .b(x00), .c(new_n182_), .O(new_n185_));
  nor2   g152(.a(new_n80_), .b(new_n40_), .O(new_n186_));
  nand2  g153(.a(new_n45_), .b(new_n37_), .O(new_n187_));
  aoi21  g154(.a(new_n186_), .b(x07), .c(new_n187_), .O(new_n188_));
  oai21  g155(.a(new_n185_), .b(x24), .c(new_n188_), .O(z5));
  nand2  g156(.a(x20), .b(new_n36_), .O(new_n190_));
  aoi21  g157(.a(new_n190_), .b(new_n34_), .c(x11), .O(new_n191_));
  nand3  g158(.a(new_n50_), .b(new_n45_), .c(new_n43_), .O(new_n192_));
  oai22  g159(.a(new_n192_), .b(new_n42_), .c(new_n191_), .d(x03), .O(new_n193_));
  oai21  g160(.a(x20), .b(new_n36_), .c(x06), .O(new_n194_));
  oai21  g161(.a(new_n105_), .b(new_n122_), .c(new_n106_), .O(new_n195_));
  nand2  g162(.a(new_n195_), .b(x05), .O(new_n196_));
  nand2  g163(.a(new_n109_), .b(new_n108_), .O(new_n197_));
  nand2  g164(.a(new_n197_), .b(x03), .O(new_n198_));
  nand2  g165(.a(new_n117_), .b(new_n109_), .O(new_n199_));
  nand2  g166(.a(new_n199_), .b(new_n40_), .O(new_n200_));
  nand3  g167(.a(new_n200_), .b(new_n198_), .c(new_n196_), .O(new_n201_));
  nand3  g168(.a(new_n201_), .b(new_n194_), .c(x11), .O(new_n202_));
  nand3  g169(.a(new_n81_), .b(new_n37_), .c(x18), .O(new_n203_));
  nand3  g170(.a(new_n80_), .b(new_n72_), .c(x15), .O(new_n204_));
  aoi21  g171(.a(new_n204_), .b(new_n203_), .c(new_n40_), .O(new_n205_));
  nand3  g172(.a(new_n40_), .b(x21), .c(new_n49_), .O(new_n206_));
  nand2  g173(.a(new_n206_), .b(new_n109_), .O(new_n207_));
  nand2  g174(.a(new_n207_), .b(new_n48_), .O(new_n208_));
  nand3  g175(.a(new_n144_), .b(new_n40_), .c(x15), .O(new_n209_));
  nand2  g176(.a(new_n209_), .b(new_n208_), .O(new_n210_));
  oai21  g177(.a(new_n210_), .b(new_n205_), .c(new_n122_), .O(new_n211_));
  nand4  g178(.a(new_n211_), .b(new_n202_), .c(new_n193_), .d(new_n37_), .O(z6));
  oai21  g179(.a(new_n197_), .b(new_n107_), .c(new_n37_), .O(new_n213_));
  nand2  g180(.a(new_n213_), .b(new_n110_), .O(z7));
endmodule
