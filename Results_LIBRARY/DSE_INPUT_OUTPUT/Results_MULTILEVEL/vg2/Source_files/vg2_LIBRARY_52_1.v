...
module FAU ( 
  ...
  nand2  g077(.a(x19), .b(new_n34_), .O(new_n111_));
  nand2  g078(.a(x24), .b(x18), .O(new_n112_));
  nand3  g079(.a(new_n42_), .b(x15), .c(x13), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(new_n112_), .c(new_n48_), .O(new_n114_));
  nand3  g081(.a(x24), .b(x18), .c(x13), .O(new_n115_));
  nand3  g082(.a(x15), .b(new_n53_), .c(new_n48_), .O(new_n116_));
  ...
  nand4  g086(.a(new_n119_), .b(new_n35_), .c(new_n99_), .d(new_n34_), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(new_n118_), .c(new_n41_), .O(new_n121_));
  ...
  nor2   g091(.a(new_n40_), .b(new_n47_), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(x20), .c(x15), .O(new_n126_));
  nand2  g093(.a(new_n103_), .b(new_n73_), .O(new_n127_));
  nand3  g094(.a(new_n77_), .b(new_n40_), .c(new_n47_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n124_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n85_), .O(new_n130_));
  inv1   g097(.a(new_n124_), .O(new_n131_));
  nand3  g098(.a(new_n125_), .b(new_n131_), .c(new_n89_), .O(new_n132_));
  nand3  g099(.a(new_n103_), .b(x07), .c(new_n38_), .O(new_n133_));
  inv1   g100(.a(x08), .O(new_n134_));
  nand4  g101(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n134_), .O(new_n135_));
  or2    g102(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n132_), .c(new_n81_), .O(new_n137_));
  nand4  g104(.a(new_n77_), .b(new_n40_), .c(new_n47_), .d(new_n134_), .O(new_n138_));
  nor2   g105(.a(new_n138_), .b(new_n133_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n137_), .c(x24), .O(new_n140_));
  nand3  g107(.a(new_n125_), .b(new_n131_), .c(new_n101_), .O(new_n141_));
  oai21  g108(.a(new_n135_), .b(new_n39_), .c(new_n141_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n42_), .c(new_n99_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n35_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n34_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n140_), .c(new_n130_), .O(z3));
  inv1   g113(.a(x04), .O(new_n147_));
  oai21  g114(.a(x23), .b(new_n147_), .c(new_n65_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n67_), .c(x09), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x16), .c(new_n134_), .O(new_n150_));
  inv1   g117(.a(x07), .O(new_n151_));
  nor3   g118(.a(new_n81_), .b(new_n42_), .c(new_n151_), .O(new_n152_));
  nand4  g119(.a(new_n42_), .b(new_n99_), .c(new_n34_), .d(x00), .O(new_n153_));
  inv1   g120(.a(new_n153_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n152_), .c(new_n35_), .O(new_n155_));
  oai21  g122(.a(new_n56_), .b(new_n34_), .c(new_n155_), .O(z5));
  nand2  g123(.a(z5), .b(new_n150_), .O(new_n157_));
  inv1   g124(.a(x16), .O(new_n158_));
  oai21  g125(.a(new_n68_), .b(x04), .c(x17), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x22), .c(new_n71_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n158_), .c(x08), .O(new_n161_));
  nand4  g128(.a(new_n111_), .b(new_n82_), .c(x24), .d(x18), .O(new_n162_));
  inv1   g129(.a(x15), .O(new_n163_));
  nor2   g130(.a(new_n84_), .b(new_n163_), .O(new_n164_));
  nand3  g131(.a(new_n119_), .b(new_n99_), .c(new_n34_), .O(new_n165_));
  inv1   g132(.a(new_n165_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n164_), .c(new_n35_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n162_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n161_), .O(new_n169_));
  nand3  g136(.a(new_n164_), .b(new_n134_), .c(x02), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n169_), .c(new_n157_), .O(z4));
  nand2  g138(.a(x20), .b(new_n40_), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n38_), .c(x11), .O(new_n173_));
  nand3  g140(.a(new_n153_), .b(new_n54_), .c(new_n52_), .O(new_n174_));
  ...
  nand3  g144(.a(new_n165_), .b(new_n116_), .c(new_n115_), .O(new_n178_));
  oai22  g145(.a(new_n178_), .b(new_n114_), .c(new_n177_), .d(new_n37_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n175_), .c(new_n111_), .O(z6));
  nor2   g147(.a(new_n117_), .b(new_n114_), .O(new_n181_));
  aoi21  g148(.a(new_n119_), .b(new_n99_), .c(x19), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(x02), .c(new_n181_), .O(z7));
endmodule
