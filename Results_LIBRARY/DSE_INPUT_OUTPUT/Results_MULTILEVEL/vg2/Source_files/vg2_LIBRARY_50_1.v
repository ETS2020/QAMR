...
module FAU ( 
  ...
  nand2  g085(.a(x02), .b(new_n92_), .O(new_n119_));
  oai21  g086(.a(new_n118_), .b(new_n92_), .c(new_n119_), .O(z2));
  ...
  nand4  g090(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n92_), .O(new_n124_));
  ...
  nand3  g095(.a(new_n122_), .b(x20), .c(x18), .O(new_n129_));
  ...
  nand4  g100(.a(new_n36_), .b(new_n35_), .c(new_n92_), .d(x00), .O(new_n134_));
  ...
  oai21  g106(.a(x23), .b(new_n93_), .c(new_n69_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n79_), .c(x09), .O(new_n141_));
  ...
  oai21  g115(.a(new_n80_), .b(x04), .c(x17), .O(new_n149_));
  ...
  nand2  g120(.a(new_n153_), .b(new_n114_), .O(z7));
