...
module FAU ( 
  ...
  nand3  g115(.a(new_n148_), .b(new_n100_), .c(new_n44_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n112_), .c(new_n111_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n110_), .c(new_n146_), .O(new_n151_));
  nor2   g118(.a(x02), .b(new_n107_), .O(new_n152_));
  inv1   g119(.a(new_n152_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n151_), .c(new_n143_), .O(z4));
  aoi21  g121(.a(new_n45_), .b(x00), .c(x01), .O(new_n155_));
  nand2  g122(.a(new_n48_), .b(new_n43_), .O(new_n156_));
  nor2   g123(.a(new_n156_), .b(new_n42_), .O(new_n157_));
  oai21  g124(.a(new_n155_), .b(x02), .c(new_n157_), .O(z5));
  aoi21  g125(.a(x20), .b(new_n89_), .c(x06), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x11), .c(new_n34_), .O(new_n160_));
  nand3  g127(.a(new_n97_), .b(new_n45_), .c(new_n44_), .O(new_n161_));
  oai21  g128(.a(new_n157_), .b(new_n152_), .c(new_n161_), .O(new_n162_));
  ...
  oai21  g132(.a(new_n113_), .b(new_n110_), .c(new_n153_), .O(new_n166_));
  nand4  g133(.a(new_n148_), .b(new_n100_), .c(new_n44_), .d(new_n107_), .O(new_n167_));
