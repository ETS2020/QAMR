...
module FAU ( 
  ...
  nor2   g019(.a(x12), .b(new_n52_), .O(new_n53_));
  ...
  nand4  g049(.a(new_n82_), .b(new_n36_), .c(new_n52_), .d(new_n69_), .O(new_n83_));
  ...
  nand4  g064(.a(new_n52_), .b(new_n69_), .c(x07), .d(new_n35_), .O(new_n98_));
  inv1   g065(.a(new_n98_), .O(new_n99_));
  nand4  g066(.a(new_n71_), .b(new_n70_), .c(new_n56_), .d(new_n36_), .O(new_n100_));
  ...
  nand4  g075(.a(new_n36_), .b(new_n52_), .c(new_n69_), .d(new_n35_), .O(new_n109_));
  inv1   g076(.a(new_n109_), .O(new_n110_));
  nand4  g077(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n56_), .O(new_n111_));
  ...
  nor2   g095(.a(new_n128_), .b(new_n67_), .O(z2));
  nand4  g096(.a(new_n59_), .b(x20), .c(x14), .d(x11), .O(new_n130_));
  ...
  nand4  g108(.a(new_n73_), .b(new_n70_), .c(new_n36_), .d(new_n69_), .O(new_n142_));
  ...
  oai21  g134(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n74_), .c(new_n52_), .O(new_n169_));
  oai21  g136(.a(new_n56_), .b(new_n52_), .c(new_n169_), .O(new_n170_));
  ...
  nand3  g140(.a(new_n173_), .b(x22), .c(x12), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(x09), .O(new_n175_));
