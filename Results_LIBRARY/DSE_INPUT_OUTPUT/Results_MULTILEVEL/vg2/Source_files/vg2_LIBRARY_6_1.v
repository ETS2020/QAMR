...
module FAU ( 
  ...
  inv1   g059(.a(new_n90_), .O(new_n93_));
  inv1   g060(.a(x18), .O(new_n94_));
  nor2   g061(.a(new_n39_), .b(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n39_), .b(x20), .c(x15), .d(x13), .O(new_n96_));
  ...
  nand4  g066(.a(new_n39_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  aoi22  g068(.a(new_n101_), .b(x20), .c(new_n95_), .d(x13), .O(new_n102_));
  aoi21  g069(.a(new_n102_), .b(new_n98_), .c(new_n37_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(x11), .c(x06), .d(x03), .O(new_n104_));
  oai21  g071(.a(new_n104_), .b(new_n61_), .c(new_n93_), .O(z2));
  nand4  g072(.a(new_n53_), .b(x20), .c(x14), .d(x11), .O(new_n106_));
  nor2   g073(.a(new_n106_), .b(new_n63_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(x06), .c(x03), .d(x01), .O(new_n108_));
  nand4  g075(.a(new_n45_), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n109_));
  nor2   g076(.a(new_n109_), .b(x08), .O(new_n110_));
  nand4  g077(.a(new_n110_), .b(new_n35_), .c(new_n34_), .d(new_n61_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n39_), .O(new_n113_));
  nand2  g080(.a(new_n99_), .b(new_n81_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x20), .c(x14), .d(x11), .O(new_n115_));
  nor2   g082(.a(new_n115_), .b(new_n63_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x06), .c(x03), .d(x01), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n113_), .O(z3));
  oai21  g085(.a(x23), .b(new_n62_), .c(new_n66_), .O(new_n119_));
  aoi21  g086(.a(new_n119_), .b(new_n67_), .c(x09), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(x16), .c(new_n63_), .O(new_n121_));
  inv1   g088(.a(x07), .O(new_n122_));
  nor2   g089(.a(new_n39_), .b(new_n38_), .O(new_n123_));
  inv1   g090(.a(new_n123_), .O(new_n124_));
  nand3  g091(.a(new_n39_), .b(x19), .c(x13), .O(new_n125_));
  oai21  g092(.a(new_n124_), .b(new_n122_), .c(new_n125_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(x05), .O(new_n127_));
  nand4  g094(.a(new_n93_), .b(x19), .c(new_n79_), .d(new_n78_), .O(new_n128_));
  nand4  g095(.a(new_n39_), .b(new_n43_), .c(new_n42_), .d(x00), .O(new_n129_));
  inv1   g096(.a(new_n129_), .O(new_n130_));
  nor2   g097(.a(new_n79_), .b(new_n122_), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(new_n123_), .c(new_n130_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n128_), .c(new_n127_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n121_), .O(new_n134_));
  oai21  g101(.a(new_n68_), .b(x04), .c(x17), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(x22), .c(new_n64_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(new_n65_), .c(x08), .O(new_n137_));
  nand3  g104(.a(new_n39_), .b(x15), .c(x13), .O(new_n138_));
  oai21  g105(.a(new_n124_), .b(new_n94_), .c(new_n138_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(x05), .O(new_n140_));
  nand4  g107(.a(new_n93_), .b(x15), .c(new_n79_), .d(new_n78_), .O(new_n141_));
  nand3  g108(.a(new_n123_), .b(x18), .c(x13), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n100_), .O(z7));
  nand2  g110(.a(z7), .b(new_n137_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n134_), .O(z4));
  oai21  g112(.a(new_n39_), .b(new_n122_), .c(new_n125_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(x05), .O(new_n147_));
  oai21  g114(.a(new_n131_), .b(new_n38_), .c(x24), .O(new_n148_));
  nand3  g115(.a(x19), .b(new_n79_), .c(new_n78_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n129_), .O(z5));
  nand2  g117(.a(x20), .b(new_n37_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n35_), .c(x11), .O(new_n152_));
  nand3  g119(.a(new_n39_), .b(x13), .c(x05), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n80_), .c(new_n40_), .O(new_n154_));
  oai22  g121(.a(new_n154_), .b(new_n130_), .c(new_n152_), .d(x03), .O(new_n155_));
  inv1   g122(.a(new_n80_), .O(new_n156_));
  aoi21  g123(.a(x14), .b(new_n35_), .c(x11), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x03), .c(x07), .O(new_n158_));
  oai21  g125(.a(new_n36_), .b(x06), .c(x03), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(x20), .c(x18), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n158_), .c(new_n156_), .O(new_n161_));
  nand2  g128(.a(new_n36_), .b(new_n78_), .O(new_n162_));
  nand3  g129(.a(x19), .b(new_n37_), .c(new_n79_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n162_), .c(x20), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n161_), .c(x24), .O(new_n165_));
  inv1   g132(.a(new_n100_), .O(new_n166_));
  inv1   g133(.a(x15), .O(new_n167_));
  nand3  g134(.a(new_n93_), .b(new_n79_), .c(new_n78_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n153_), .c(new_n167_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n166_), .c(new_n159_), .O(new_n170_));
  inv1   g137(.a(new_n41_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(x15), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n52_), .c(x24), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n38_), .c(x14), .d(x11), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n170_), .c(new_n165_), .d(new_n155_), .O(z6));
endmodule
