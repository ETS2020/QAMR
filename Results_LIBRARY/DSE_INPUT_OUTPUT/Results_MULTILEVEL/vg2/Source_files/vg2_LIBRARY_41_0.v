...
module FAU ( 
  ...
  nand2  g76(.a(x22), .b(new_n109_), .O(new_n110_));
  aoi21  g77(.a(new_n110_), .b(x09), .c(new_n108_), .O(new_n111_));
  nand2  g78(.a(x23), .b(x22), .O(new_n112_));
  oai21  g79(.a(new_n112_), .b(x04), .c(x08), .O(new_n113_));
  oai21  g80(.a(new_n113_), .b(new_n111_), .c(new_n107_), .O(new_n114_));
  inv1   g81(.a(new_n49_), .O(new_n115_));
  aoi21  g82(.a(x23), .b(new_n109_), .c(x22), .O(new_n116_));
  or2    g83(.a(new_n116_), .b(x09), .O(new_n117_));
  nand3  g84(.a(new_n117_), .b(new_n108_), .c(new_n56_), .O(new_n118_));
  oai21  g85(.a(new_n52_), .b(new_n56_), .c(new_n118_), .O(new_n119_));
  nand2  g86(.a(new_n119_), .b(new_n115_), .O(new_n120_));
  nand3  g87(.a(new_n120_), .b(new_n114_), .c(new_n53_), .O(z4));
  ...
  oai21  g94(.a(new_n127_), .b(new_n34_), .c(new_n107_), .O(new_n128_));
  aoi21  g95(.a(new_n128_), .b(new_n125_), .c(new_n52_), .O(z6));
