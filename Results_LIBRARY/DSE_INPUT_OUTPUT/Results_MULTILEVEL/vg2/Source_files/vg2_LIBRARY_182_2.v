...
module FAU ( 
  ...
  nand2  g041(.a(new_n46_), .b(new_n38_), .O(new_n75_));
  ...
  nand4  g049(.a(new_n82_), .b(new_n80_), .c(new_n59_), .d(new_n57_), .O(new_n83_));
  ...
  nand4  g060(.a(new_n93_), .b(new_n80_), .c(new_n59_), .d(new_n57_), .O(new_n94_));
  ...
  nand3  g066(.a(new_n99_), .b(new_n91_), .c(new_n78_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n52_), .O(new_n101_));
  nand2  g068(.a(new_n91_), .b(new_n78_), .O(new_n102_));
  ...
  nand3  g078(.a(new_n40_), .b(x21), .c(new_n44_), .O(new_n112_));
  ...
  nor2   g085(.a(new_n106_), .b(new_n36_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(x20), .c(x15), .O(new_n120_));
  nand2  g087(.a(new_n95_), .b(new_n66_), .O(new_n121_));
  nand3  g088(.a(new_n71_), .b(new_n106_), .c(new_n36_), .O(new_n122_));
  oai22  g089(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n118_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n77_), .O(new_n124_));
  nand3  g091(.a(new_n119_), .b(x20), .c(x18), .O(new_n125_));
  nand3  g092(.a(new_n95_), .b(x07), .c(new_n35_), .O(new_n126_));
  inv1   g093(.a(x08), .O(new_n127_));
  nand4  g094(.a(new_n37_), .b(new_n106_), .c(new_n36_), .d(new_n127_), .O(new_n128_));
  ...
  nand3  g119(.a(new_n152_), .b(new_n146_), .c(new_n54_), .O(z4));
  inv1   g120(.a(new_n42_), .O(new_n154_));
  inv1   g121(.a(x00), .O(new_n155_));
  oai21  g122(.a(x24), .b(new_n155_), .c(new_n52_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n44_), .O(new_n157_));
  and2   g124(.a(new_n47_), .b(new_n43_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n157_), .c(new_n154_), .O(z5));
  aoi21  g126(.a(x20), .b(new_n106_), .c(x06), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x11), .c(new_n34_), .O(new_n161_));
  aoi21  g128(.a(new_n158_), .b(new_n154_), .c(new_n53_), .O(new_n162_));
  nand4  g129(.a(new_n40_), .b(new_n44_), .c(new_n52_), .d(x00), .O(new_n163_));
  ...
  and2   g135(.a(new_n111_), .b(new_n110_), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(new_n168_), .c(new_n53_), .O(new_n170_));
  inv1   g137(.a(x21), .O(new_n171_));
  nor2   g138(.a(x24), .b(new_n171_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n44_), .c(new_n52_), .O(new_n173_));
  inv1   g140(.a(new_n173_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n170_), .c(new_n167_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n165_), .O(z6));
  oai21  g143(.a(new_n172_), .b(x02), .c(new_n44_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n169_), .c(new_n168_), .O(z7));
endmodule
