...
module FAU ( 
  ...
  inv1   g123(.a(new_n121_), .O(new_n157_));
  inv1   g124(.a(new_n138_), .O(new_n158_));
  nand2  g125(.a(new_n111_), .b(new_n108_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n158_), .c(new_n149_), .d(new_n157_), .O(new_n160_));
  ...
  nand3  g134(.a(new_n150_), .b(new_n54_), .c(x00), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n169_));
  ...
  nand3  g140(.a(new_n173_), .b(new_n120_), .c(new_n119_), .O(new_n174_));
  inv1   g141(.a(new_n174_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n118_), .O(new_n176_));
  oai21  g143(.a(new_n172_), .b(new_n34_), .c(new_n176_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n170_), .c(new_n165_), .O(z6));
  nand2  g145(.a(new_n159_), .b(x01), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n54_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n157_), .O(z7));
endmodule
