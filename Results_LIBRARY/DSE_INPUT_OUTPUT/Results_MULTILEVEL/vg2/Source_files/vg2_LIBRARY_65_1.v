...
module FAU ( 
  ...
  nand4  g037(.a(new_n70_), .b(new_n69_), .c(new_n47_), .d(new_n35_), .O(new_n71_));
  ...
  oai21  g044(.a(new_n77_), .b(new_n71_), .c(new_n68_), .O(new_n78_));
  nand2  g045(.a(new_n53_), .b(new_n48_), .O(new_n79_));
  ...
  nand4  g052(.a(new_n85_), .b(new_n84_), .c(new_n67_), .d(new_n62_), .O(new_n86_));
  nor2   g053(.a(x09), .b(x08), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n69_), .c(x07), .d(new_n38_), .O(new_n88_));
  inv1   g055(.a(x12), .O(new_n89_));
  inv1   g056(.a(x16), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n40_), .c(new_n89_), .d(new_n47_), .O(new_n91_));
  inv1   g058(.a(new_n91_), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n76_), .c(new_n41_), .d(new_n65_), .O(new_n93_));
  oai21  g060(.a(new_n93_), .b(new_n88_), .c(new_n86_), .O(new_n94_));
  nand3  g061(.a(new_n94_), .b(new_n79_), .c(x24), .O(new_n95_));
  nand4  g062(.a(new_n37_), .b(new_n34_), .c(new_n36_), .d(x00), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  inv1   g064(.a(x08), .O(new_n98_));
  inv1   g065(.a(x10), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n35_), .c(new_n98_), .O(new_n100_));
  nor3   g067(.a(new_n100_), .b(x06), .c(x04), .O(new_n101_));
  nand2  g068(.a(new_n41_), .b(new_n65_), .O(new_n102_));
  nor4   g069(.a(new_n102_), .b(x24), .c(x23), .d(x22), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n101_), .c(new_n97_), .d(new_n92_), .O(new_n104_));
  ...
  oai22  g078(.a(new_n111_), .b(new_n108_), .c(new_n35_), .d(x02), .O(new_n112_));
  nor2   g079(.a(x09), .b(x02), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n42_), .c(x21), .d(new_n99_), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n112_), .c(new_n41_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x14), .c(x11), .d(x06), .O(new_n116_));
  nor3   g083(.a(new_n116_), .b(new_n37_), .c(new_n36_), .O(z2));
  nand3  g084(.a(x15), .b(x13), .c(x05), .O(new_n118_));
  nand3  g085(.a(x21), .b(new_n99_), .c(new_n34_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(x20), .c(x14), .d(x11), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n98_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x06), .c(x03), .d(x01), .O(new_n123_));
  nand3  g090(.a(new_n99_), .b(new_n34_), .c(x00), .O(new_n124_));
  nand3  g091(.a(x19), .b(x13), .c(x05), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n41_), .c(new_n40_), .d(new_n47_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(x08), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n129_));
  ...
  nand4  g099(.a(x07), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n133_));
  nand4  g100(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n98_), .O(new_n134_));
  ...
  nand3  g104(.a(new_n70_), .b(new_n37_), .c(new_n36_), .O(new_n138_));
  nand3  g105(.a(new_n75_), .b(new_n40_), .c(new_n47_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n131_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n53_), .c(new_n48_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n136_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n130_), .c(new_n35_), .O(new_n143_));
  ...
  nand4  g114(.a(new_n42_), .b(x21), .c(new_n99_), .d(new_n34_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n110_), .c(new_n109_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n108_), .c(x16), .d(new_n98_), .O(new_n150_));
  inv1   g117(.a(x23), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(x04), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n65_), .c(x22), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n90_), .c(x08), .O(new_n154_));
  nor2   g121(.a(x24), .b(x10), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n34_), .c(x00), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n54_), .c(new_n52_), .O(new_n157_));
  nor2   g124(.a(new_n157_), .b(new_n51_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n154_), .c(new_n150_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n35_), .O(new_n160_));
  nor2   g127(.a(new_n111_), .b(new_n108_), .O(new_n161_));
  oai21  g128(.a(new_n151_), .b(x04), .c(x17), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(x22), .c(x16), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x08), .c(new_n161_), .O(new_n164_));
  aoi21  g131(.a(new_n90_), .b(x09), .c(x08), .O(new_n165_));
  nor2   g132(.a(new_n165_), .b(new_n56_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n164_), .c(x02), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n160_), .O(z4));
  aoi21  g135(.a(new_n155_), .b(x00), .c(x09), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(x02), .c(new_n56_), .O(z5));
  aoi21  g137(.a(x20), .b(new_n40_), .c(x06), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(x11), .c(new_n37_), .O(new_n172_));
  nor2   g139(.a(new_n35_), .b(x02), .O(new_n173_));
  nand4  g140(.a(new_n155_), .b(new_n35_), .c(new_n34_), .d(x00), .O(new_n174_));
  oai21  g141(.a(new_n173_), .b(new_n56_), .c(new_n174_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n172_), .O(new_n176_));
  nand2  g143(.a(new_n114_), .b(new_n112_), .O(z7));
  aoi21  g144(.a(new_n41_), .b(x14), .c(new_n38_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n47_), .c(x03), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(z7), .O(new_n180_));
