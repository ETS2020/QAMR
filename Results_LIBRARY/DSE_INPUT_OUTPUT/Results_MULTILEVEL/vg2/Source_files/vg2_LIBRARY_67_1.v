...
module FAU ( 
  ...
  nor2   g055(.a(new_n56_), .b(new_n70_), .O(new_n89_));
  ...
  nand4  g060(.a(new_n55_), .b(new_n54_), .c(new_n67_), .d(new_n36_), .O(new_n94_));
  ...
  nor4   g068(.a(new_n101_), .b(new_n55_), .c(new_n100_), .d(new_n54_), .O(new_n102_));
  nand2  g069(.a(new_n102_), .b(new_n84_), .O(new_n103_));
  nor2   g070(.a(x08), .b(x06), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n91_), .c(new_n36_), .d(new_n66_), .O(new_n105_));
  ...
  nor2   g079(.a(new_n69_), .b(x06), .O(new_n113_));
  ...
  nor2   g084(.a(new_n39_), .b(new_n87_), .O(new_n118_));
  ...
  nor2   g089(.a(new_n100_), .b(x13), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n37_), .O(new_n124_));
  nand4  g091(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n124_), .c(new_n122_), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(new_n121_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n54_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(x11), .c(x03), .d(x01), .O(new_n129_));
  aoi21  g096(.a(new_n129_), .b(x06), .c(new_n69_), .O(z2));
  nand2  g097(.a(new_n58_), .b(new_n57_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(x20), .c(x14), .d(x11), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(new_n53_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(x06), .c(x03), .d(x01), .O(new_n134_));
  nand2  g101(.a(new_n72_), .b(new_n71_), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n69_), .c(new_n54_), .d(new_n36_), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(x08), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n35_), .c(new_n34_), .d(new_n82_), .O(new_n138_));
  ...
  nand3  g108(.a(new_n88_), .b(x14), .c(x11), .O(new_n142_));
  nand4  g109(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n82_), .O(new_n143_));
  nand4  g110(.a(new_n69_), .b(new_n54_), .c(new_n36_), .d(new_n53_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n141_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n81_), .c(x24), .O(new_n146_));
  nand4  g113(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n147_));
  nand3  g114(.a(new_n104_), .b(new_n34_), .c(new_n82_), .O(new_n148_));
  nand3  g115(.a(new_n109_), .b(new_n54_), .c(new_n36_), .O(new_n149_));
  ...
  nand3  g118(.a(new_n151_), .b(new_n146_), .c(new_n140_), .O(z3));
  inv1   g119(.a(new_n49_), .O(new_n153_));
  oai21  g120(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n70_), .c(x09), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x16), .c(new_n53_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  inv1   g124(.a(new_n127_), .O(new_n158_));
  oai21  g125(.a(new_n56_), .b(x04), .c(x17), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x22), .c(new_n66_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n55_), .c(x08), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n157_), .c(new_n114_), .O(z4));
  inv1   g130(.a(new_n41_), .O(new_n164_));
  and2   g131(.a(new_n45_), .b(new_n42_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n114_), .c(new_n47_), .d(new_n164_), .O(z5));
  oai21  g133(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n153_), .O(new_n168_));
  oai21  g135(.a(x20), .b(new_n54_), .c(x06), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n158_), .c(x11), .O(new_n170_));
  inv1   g137(.a(new_n121_), .O(new_n171_));
  inv1   g138(.a(new_n122_), .O(new_n172_));
  oai21  g139(.a(new_n123_), .b(new_n172_), .c(new_n37_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n125_), .c(new_n171_), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(new_n34_), .c(new_n113_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n170_), .c(new_n168_), .O(z6));
  and2   g143(.a(new_n124_), .b(new_n122_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n125_), .c(new_n171_), .d(new_n114_), .O(z7));
endmodule
