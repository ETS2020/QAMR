...
module FAU ( 
  ...
  nor2   g023(.a(new_n38_), .b(new_n34_), .O(new_n57_));
  ...
  nand4  g034(.a(new_n67_), .b(new_n66_), .c(x02), .d(new_n65_), .O(new_n68_));
  inv1   g035(.a(new_n68_), .O(new_n69_));
  nor2   g036(.a(x08), .b(x06), .O(new_n70_));
  nand4  g037(.a(new_n70_), .b(new_n69_), .c(new_n35_), .d(new_n64_), .O(new_n71_));
  ...
  oai21  g044(.a(new_n77_), .b(new_n71_), .c(new_n63_), .O(new_n78_));
  ...
  nand4  g055(.a(new_n88_), .b(new_n69_), .c(new_n64_), .d(new_n38_), .O(new_n89_));
  ...
  nor3   g067(.a(new_n100_), .b(new_n38_), .c(new_n34_), .O(new_n101_));
  ...
  nand4  g072(.a(new_n105_), .b(new_n101_), .c(new_n98_), .d(new_n96_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n95_), .c(new_n82_), .O(z1));
  ...
  nor2   g081(.a(x24), .b(new_n103_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n99_), .c(x08), .d(new_n37_), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n114_), .c(new_n102_), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(x14), .c(x11), .d(x06), .O(new_n118_));
  nor3   g085(.a(new_n118_), .b(new_n66_), .c(new_n65_), .O(z2));
  nor2   g086(.a(new_n66_), .b(new_n65_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(new_n99_), .c(x08), .d(x06), .O(new_n121_));
  nor2   g088(.a(new_n36_), .b(new_n35_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(new_n115_), .c(x20), .O(new_n123_));
  oai21  g090(.a(new_n123_), .b(new_n121_), .c(x08), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n37_), .O(new_n125_));
  nand2  g092(.a(new_n120_), .b(new_n57_), .O(new_n126_));
  nand3  g093(.a(new_n122_), .b(x20), .c(x15), .O(new_n127_));
  nand3  g094(.a(new_n70_), .b(new_n66_), .c(new_n65_), .O(new_n128_));
  nand3  g095(.a(new_n75_), .b(new_n36_), .c(new_n35_), .O(new_n129_));
  ...
  nand3  g099(.a(new_n88_), .b(new_n66_), .c(new_n65_), .O(new_n133_));
  nand4  g100(.a(new_n102_), .b(new_n36_), .c(new_n35_), .d(new_n38_), .O(new_n134_));
  ...
  nand3  g108(.a(new_n115_), .b(new_n99_), .c(new_n37_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n112_), .c(new_n111_), .O(new_n143_));
  or2    g110(.a(new_n143_), .b(new_n110_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n141_), .c(x16), .O(new_n145_));
  nand2  g112(.a(new_n50_), .b(x00), .O(new_n146_));
  ...
  oai21  g118(.a(new_n151_), .b(x22), .c(new_n64_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n149_), .c(x08), .O(new_n153_));
  nand2  g120(.a(x15), .b(new_n38_), .O(new_n154_));
  oai21  g121(.a(new_n153_), .b(new_n74_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n81_), .O(new_n156_));
  nand2  g123(.a(x18), .b(new_n38_), .O(new_n157_));
  oai21  g124(.a(new_n153_), .b(new_n87_), .c(new_n157_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n79_), .c(x24), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n156_), .c(new_n148_), .d(new_n145_), .O(z4));
  nor2   g127(.a(new_n48_), .b(new_n44_), .O(new_n161_));
  nand2  g128(.a(new_n148_), .b(new_n161_), .O(z5));
  ...
  nand2  g133(.a(new_n116_), .b(new_n114_), .O(new_n167_));
  aoi21  g134(.a(new_n102_), .b(x14), .c(new_n34_), .O(new_n168_));
  ...
  nor2   g138(.a(new_n113_), .b(new_n110_), .O(new_n172_));
  aoi21  g139(.a(new_n115_), .b(new_n99_), .c(new_n38_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x02), .c(new_n172_), .O(z7));
endmodule
