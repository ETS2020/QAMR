...
module FAU ( 
  ...
  nand4  g055(.a(new_n88_), .b(new_n85_), .c(new_n63_), .d(new_n59_), .O(new_n89_));
  nor2   g056(.a(x09), .b(x08), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n69_), .c(x07), .d(new_n34_), .O(new_n91_));
  nor2   g058(.a(x12), .b(x11), .O(new_n92_));
  nor2   g059(.a(x16), .b(x14), .O(new_n93_));
  nor2   g060(.a(x20), .b(x17), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n76_), .O(new_n95_));
  ...
  nand4  g065(.a(new_n98_), .b(new_n85_), .c(new_n63_), .d(new_n59_), .O(new_n99_));
  ...
  nand3  g071(.a(new_n104_), .b(new_n97_), .c(new_n83_), .O(z1));
  ...
  aoi21  g079(.a(new_n112_), .b(new_n111_), .c(new_n87_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(x14), .c(x11), .d(x06), .O(new_n114_));
  nor3   g081(.a(new_n114_), .b(new_n56_), .c(new_n55_), .O(z2));
  ...
  nand2  g085(.a(new_n100_), .b(new_n70_), .O(new_n119_));
  nand3  g086(.a(new_n75_), .b(new_n36_), .c(new_n35_), .O(new_n120_));
  oai22  g087(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n116_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n82_), .O(new_n122_));
  nand2  g089(.a(new_n117_), .b(new_n88_), .O(new_n123_));
  nand3  g090(.a(new_n100_), .b(x07), .c(new_n34_), .O(new_n124_));
  inv1   g091(.a(x08), .O(new_n125_));
  nand4  g092(.a(new_n87_), .b(new_n36_), .c(new_n35_), .d(new_n125_), .O(new_n126_));
  ...
  nand4  g095(.a(new_n34_), .b(new_n56_), .c(new_n55_), .d(x00), .O(new_n129_));
  nand2  g096(.a(new_n117_), .b(new_n98_), .O(new_n130_));
  ...
  aoi21  g107(.a(new_n140_), .b(new_n37_), .c(x08), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n74_), .c(new_n138_), .d(x08), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n82_), .O(new_n143_));
  inv1   g110(.a(x07), .O(new_n144_));
  oai22  g111(.a(new_n141_), .b(new_n144_), .c(new_n86_), .d(x08), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n80_), .c(x24), .O(new_n146_));
  oai21  g113(.a(new_n62_), .b(x04), .c(x17), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(x22), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x09), .c(new_n37_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n125_), .c(x21), .O(new_n150_));
  inv1   g117(.a(x17), .O(new_n151_));
  oai21  g118(.a(x23), .b(new_n57_), .c(new_n151_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n61_), .c(x09), .O(new_n153_));
  ...
  nand3  g124(.a(new_n157_), .b(new_n146_), .c(new_n143_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n49_), .O(new_n159_));
  nand2  g126(.a(x09), .b(x08), .O(new_n160_));
  aoi21  g127(.a(new_n147_), .b(x22), .c(new_n160_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n86_), .c(new_n125_), .d(new_n144_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n80_), .c(x24), .O(new_n163_));
  oai22  g130(.a(new_n161_), .b(new_n138_), .c(new_n74_), .d(new_n125_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n82_), .O(new_n165_));
  ...
  nand3  g135(.a(new_n37_), .b(x08), .c(x02), .O(new_n169_));
  nor2   g136(.a(new_n41_), .b(x13), .O(new_n170_));
  aoi22  g137(.a(new_n170_), .b(new_n39_), .c(new_n169_), .d(new_n82_), .O(new_n171_));
  nor2   g138(.a(new_n79_), .b(new_n41_), .O(new_n172_));
  nand2  g139(.a(new_n51_), .b(new_n38_), .O(new_n173_));
  aoi21  g140(.a(new_n172_), .b(x07), .c(new_n173_), .O(new_n174_));
  oai21  g141(.a(new_n171_), .b(new_n74_), .c(new_n174_), .O(z5));
  nand2  g142(.a(new_n51_), .b(new_n48_), .O(new_n176_));
  aoi21  g143(.a(x20), .b(new_n36_), .c(x06), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(x11), .c(new_n56_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n176_), .O(new_n179_));
  nand2  g146(.a(new_n112_), .b(new_n111_), .O(z7));
  aoi21  g147(.a(new_n87_), .b(x14), .c(new_n34_), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(new_n35_), .c(x03), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(z7), .O(new_n183_));
