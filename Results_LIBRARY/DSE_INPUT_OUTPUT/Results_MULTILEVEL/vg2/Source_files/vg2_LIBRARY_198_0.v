...
module FAU ( 
  ...
  aoi21  g021(.a(new_n54_), .b(x09), .c(x01), .O(z0));
  ...
  nand3  g027(.a(new_n40_), .b(x15), .c(x13), .O(new_n61_));
  aoi21  g028(.a(new_n61_), .b(new_n60_), .c(new_n38_), .O(new_n62_));
  nand3  g029(.a(x24), .b(x18), .c(x13), .O(new_n63_));
  nand3  g030(.a(x15), .b(new_n48_), .c(new_n38_), .O(new_n64_));
  nand4  g031(.a(new_n40_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n65_));
  ...
  nand3  g051(.a(new_n46_), .b(new_n45_), .c(x00), .O(new_n85_));
  nand3  g052(.a(x19), .b(x13), .c(x05), .O(new_n86_));
  aoi21  g053(.a(new_n86_), .b(new_n85_), .c(x20), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n58_), .c(new_n36_), .d(x09), .O(new_n88_));
  nor2   g055(.a(new_n88_), .b(x08), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n35_), .c(new_n34_), .d(new_n56_), .O(new_n90_));
  ...
  nand3  g072(.a(new_n37_), .b(x19), .c(new_n58_), .O(new_n106_));
  nor3   g073(.a(new_n106_), .b(x11), .c(new_n100_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n97_), .c(new_n57_), .d(new_n35_), .O(new_n108_));
  aoi21  g075(.a(new_n108_), .b(new_n105_), .c(x13), .O(new_n109_));
  aoi22  g076(.a(new_n109_), .b(new_n38_), .c(new_n104_), .d(x24), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n92_), .O(z3));
  nor2   g078(.a(x09), .b(x01), .O(new_n112_));
  inv1   g079(.a(new_n112_), .O(new_n113_));
  inv1   g080(.a(x21), .O(new_n114_));
  nand2  g081(.a(x08), .b(x00), .O(new_n115_));
  oai21  g082(.a(new_n114_), .b(x08), .c(new_n115_), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(new_n46_), .c(new_n45_), .O(new_n117_));
  inv1   g084(.a(x15), .O(new_n118_));
  nand2  g085(.a(x19), .b(x08), .O(new_n119_));
  ...
  nand2  g089(.a(new_n48_), .b(new_n38_), .O(new_n123_));
  nand2  g090(.a(x18), .b(new_n57_), .O(new_n124_));
  oai21  g091(.a(new_n57_), .b(new_n98_), .c(new_n124_), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n123_), .c(x24), .O(new_n126_));
  nand3  g093(.a(new_n120_), .b(new_n48_), .c(new_n38_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(new_n122_), .c(new_n113_), .O(new_n129_));
  ...
  nand3  g100(.a(new_n133_), .b(new_n59_), .c(x01), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n100_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n51_), .c(new_n130_), .O(new_n136_));
  inv1   g103(.a(new_n75_), .O(new_n137_));
  inv1   g104(.a(x23), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(x04), .c(x17), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(x22), .c(x09), .O(new_n140_));
  oai21  g107(.a(x09), .b(new_n56_), .c(new_n140_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n137_), .c(x16), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n136_), .c(new_n129_), .O(z4));
  nand4  g110(.a(new_n113_), .b(new_n50_), .c(new_n44_), .d(new_n43_), .O(z5));
  nand2  g111(.a(x20), .b(new_n58_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n35_), .c(x11), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x03), .c(new_n51_), .O(new_n147_));
  nand2  g114(.a(new_n37_), .b(x14), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x06), .c(new_n36_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n34_), .c(new_n137_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n147_), .c(new_n112_), .O(z6));
  inv1   g118(.a(new_n62_), .O(new_n152_));
  and2   g119(.a(new_n65_), .b(new_n64_), .O(new_n153_));
  nand4  g120(.a(new_n113_), .b(new_n153_), .c(new_n63_), .d(new_n152_), .O(z7));
endmodule
