...
module FAU ( 
  ...
  inv1   g125(.a(new_n49_), .O(new_n159_));
  aoi21  g126(.a(new_n143_), .b(x00), .c(new_n64_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x02), .c(new_n159_), .O(z5));
  aoi21  g128(.a(x20), .b(new_n37_), .c(x06), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x11), .c(new_n34_), .O(new_n163_));
  nand4  g130(.a(new_n143_), .b(new_n105_), .c(x01), .d(x00), .O(new_n164_));
  oai21  g131(.a(new_n156_), .b(new_n159_), .c(new_n164_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  aoi21  g133(.a(new_n38_), .b(x14), .c(new_n35_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n36_), .c(x03), .O(new_n168_));
  nand3  g135(.a(new_n107_), .b(new_n94_), .c(new_n97_), .O(new_n169_));
  oai21  g136(.a(new_n156_), .b(new_n117_), .c(new_n169_), .O(z7));
  nand2  g137(.a(z7), .b(new_n168_), .O(new_n171_));
