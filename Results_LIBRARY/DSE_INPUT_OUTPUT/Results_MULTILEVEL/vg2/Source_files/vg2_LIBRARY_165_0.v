...
module FAU ( 
  ...
  aoi21  g016(.a(new_n49_), .b(x10), .c(x01), .O(z0));
  ...
  inv1   g054(.a(x10), .O(new_n88_));
  inv1   g055(.a(x02), .O(new_n89_));
  inv1   g056(.a(x04), .O(new_n90_));
  nor2   g057(.a(new_n35_), .b(new_n90_), .O(new_n91_));
  nand4  g058(.a(x12), .b(x11), .c(x09), .d(x08), .O(new_n92_));
  inv1   g059(.a(new_n92_), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n91_), .c(x03), .d(new_n89_), .O(new_n94_));
  nand4  g061(.a(x20), .b(x17), .c(x16), .d(x14), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  inv1   g063(.a(x23), .O(new_n97_));
  nor2   g064(.a(x24), .b(new_n97_), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n96_), .c(x22), .d(x21), .O(new_n99_));
  oai21  g066(.a(new_n99_), .b(new_n94_), .c(x01), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n88_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n87_), .c(new_n75_), .O(z1));
  ...
  nand4  g076(.a(new_n40_), .b(x21), .c(new_n88_), .d(new_n89_), .O(new_n110_));
  ...
  nor2   g081(.a(new_n114_), .b(new_n103_), .O(z2));
  ...
  nand3  g085(.a(new_n63_), .b(new_n34_), .c(new_n103_), .O(new_n119_));
  nand4  g086(.a(new_n68_), .b(new_n104_), .c(new_n36_), .d(x10), .O(new_n120_));
  ...
  nand4  g090(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n103_), .O(new_n124_));
  nor2   g091(.a(x20), .b(x14), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n36_), .c(x10), .d(new_n53_), .O(new_n126_));
  ...
  nor2   g095(.a(x02), .b(new_n103_), .O(new_n129_));
  nand2  g096(.a(new_n117_), .b(new_n88_), .O(new_n130_));
  inv1   g097(.a(x21), .O(new_n131_));
  nor2   g098(.a(x24), .b(new_n131_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(x20), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n129_), .c(new_n54_), .d(x03), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n128_), .c(new_n122_), .O(z3));
  inv1   g103(.a(x22), .O(new_n137_));
  inv1   g104(.a(x17), .O(new_n138_));
  oai21  g105(.a(x23), .b(new_n90_), .c(new_n138_), .O(new_n139_));
  ...
  nand4  g109(.a(new_n40_), .b(new_n88_), .c(new_n89_), .d(x00), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n45_), .c(new_n43_), .d(new_n142_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  or2    g112(.a(new_n111_), .b(new_n107_), .O(new_n146_));
  inv1   g113(.a(x16), .O(new_n147_));
  oai21  g114(.a(new_n97_), .b(x04), .c(x17), .O(new_n148_));
  ...
  nor2   g118(.a(x10), .b(x01), .O(new_n152_));
  inv1   g119(.a(new_n152_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n151_), .c(new_n145_), .O(z4));
  nand3  g121(.a(new_n40_), .b(new_n89_), .c(x00), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(x01), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n88_), .c(new_n46_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n142_), .O(z5));
  nand2  g125(.a(x20), .b(new_n104_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n35_), .c(x11), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x03), .c(new_n144_), .O(new_n161_));
  oai21  g128(.a(x20), .b(new_n104_), .c(x06), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(x11), .c(x03), .O(new_n163_));
  oai21  g130(.a(x03), .b(new_n103_), .c(new_n163_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n146_), .O(new_n165_));
  nand2  g132(.a(new_n109_), .b(new_n108_), .O(new_n166_));
  nor2   g133(.a(new_n166_), .b(new_n107_), .O(new_n167_));
  nor2   g134(.a(new_n167_), .b(new_n88_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n34_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n165_), .c(new_n161_), .d(new_n153_), .O(z6));
  nand3  g137(.a(new_n129_), .b(new_n132_), .c(new_n88_), .O(new_n171_));
  oai21  g138(.a(new_n167_), .b(new_n152_), .c(new_n171_), .O(z7));
endmodule
