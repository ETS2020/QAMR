...
module FAU ( 
  ...
  nor2   g081(.a(new_n114_), .b(new_n89_), .O(new_n115_));
  ...
  nand3  g090(.a(new_n72_), .b(new_n89_), .c(new_n36_), .O(new_n124_));
  nor2   g091(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n121_), .c(new_n78_), .O(new_n126_));
  inv1   g093(.a(new_n119_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n82_), .c(x14), .O(new_n128_));
  nor2   g095(.a(x11), .b(x08), .O(new_n129_));
  nor2   g096(.a(x20), .b(x14), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n129_), .c(new_n122_), .d(new_n86_), .O(new_n131_));
  ...
  nand4  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n97_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n133_), .c(new_n126_), .O(z3));
  inv1   g105(.a(x04), .O(new_n139_));
  oai21  g106(.a(x23), .b(new_n139_), .c(new_n59_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n61_), .c(x09), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x16), .c(new_n84_), .O(new_n142_));
  nor2   g109(.a(x02), .b(new_n107_), .O(new_n143_));
  nand2  g110(.a(new_n48_), .b(new_n43_), .O(new_n144_));
  nor2   g111(.a(new_n144_), .b(new_n42_), .O(new_n145_));
  nand3  g112(.a(new_n97_), .b(new_n45_), .c(new_n44_), .O(new_n146_));
  ...
  oai21  g117(.a(new_n150_), .b(new_n90_), .c(x08), .O(new_n151_));
  nor2   g118(.a(new_n113_), .b(new_n110_), .O(new_n152_));
  nor2   g119(.a(x02), .b(x01), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n40_), .c(x21), .d(new_n100_), .O(new_n154_));
  oai21  g121(.a(new_n143_), .b(new_n152_), .c(new_n154_), .O(z7));
  nand2  g122(.a(z7), .b(new_n151_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n148_), .O(z4));
  aoi21  g124(.a(new_n45_), .b(x00), .c(x01), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x02), .c(new_n145_), .O(z5));
  ...
  oai21  g129(.a(x20), .b(new_n89_), .c(x06), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(x11), .c(x03), .O(new_n164_));
  inv1   g131(.a(new_n164_), .O(new_n165_));
  nand4  g132(.a(new_n40_), .b(x21), .c(new_n100_), .d(new_n44_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n112_), .c(new_n111_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n110_), .c(new_n165_), .d(new_n122_), .O(new_n168_));
  nor2   g135(.a(new_n152_), .b(x03), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x02), .c(new_n143_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n168_), .c(new_n162_), .O(z6));
endmodule
