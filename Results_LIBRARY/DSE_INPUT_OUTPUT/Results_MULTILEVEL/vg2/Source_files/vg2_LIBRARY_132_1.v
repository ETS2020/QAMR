...
module FAU ( 
  ...
  nor2   g032(.a(new_n35_), .b(new_n65_), .O(new_n66_));
  ...
  nand4  g063(.a(new_n96_), .b(new_n43_), .c(new_n95_), .d(new_n42_), .O(new_n97_));
  inv1   g064(.a(new_n97_), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n79_), .c(new_n35_), .d(new_n65_), .O(new_n99_));
  oai21  g066(.a(new_n99_), .b(new_n94_), .c(new_n90_), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(new_n82_), .c(x24), .O(new_n101_));
  nand3  g068(.a(new_n39_), .b(new_n36_), .c(new_n34_), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(new_n103_));
  nand3  g070(.a(new_n41_), .b(new_n71_), .c(new_n91_), .O(new_n104_));
  ...
  nand3  g091(.a(new_n78_), .b(new_n43_), .c(new_n42_), .O(new_n125_));
  ...
  nor2   g112(.a(x24), .b(x20), .O(new_n146_));
  ...
  nand4  g121(.a(new_n154_), .b(new_n44_), .c(x21), .d(new_n35_), .O(new_n155_));
  oai21  g122(.a(new_n145_), .b(new_n153_), .c(new_n155_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n149_), .O(z4));
  nand3  g125(.a(new_n44_), .b(new_n41_), .c(x00), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n35_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n34_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n144_), .O(z5));
  oai21  g129(.a(x11), .b(new_n37_), .c(new_n36_), .O(new_n163_));
  nand4  g130(.a(new_n44_), .b(new_n41_), .c(new_n34_), .d(x00), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n54_), .c(new_n52_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n51_), .c(new_n163_), .O(new_n166_));
  oai21  g133(.a(x20), .b(new_n43_), .c(x06), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x11), .c(new_n36_), .O(new_n168_));
  nand4  g135(.a(x20), .b(new_n43_), .c(new_n42_), .d(x07), .O(new_n169_));
  oai21  g136(.a(new_n168_), .b(new_n88_), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n82_), .c(x24), .O(new_n171_));
  inv1   g138(.a(x15), .O(new_n172_));
  nand4  g139(.a(x20), .b(x19), .c(new_n43_), .d(new_n42_), .O(new_n173_));
  oai21  g140(.a(new_n168_), .b(new_n172_), .c(new_n173_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n84_), .O(new_n175_));
  oai21  g142(.a(x14), .b(new_n37_), .c(x11), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(x03), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n44_), .c(x21), .d(new_n41_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n35_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n34_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n175_), .c(new_n171_), .d(new_n166_), .O(z6));
  nand3  g148(.a(new_n44_), .b(x21), .c(new_n41_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n35_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n34_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n153_), .O(z7));
endmodule
