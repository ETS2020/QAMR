...
module FAU ( 
  ...
  nor2   g121(.a(x11), .b(new_n35_), .O(new_n155_));
  aoi21  g122(.a(new_n73_), .b(x04), .c(x17), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x22), .c(new_n67_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n69_), .c(new_n66_), .O(new_n158_));
  oai21  g125(.a(new_n155_), .b(new_n66_), .c(new_n158_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n154_), .c(new_n155_), .O(new_n160_));
  oai21  g127(.a(new_n153_), .b(new_n125_), .c(new_n160_), .O(z4));
  nor2   g128(.a(new_n155_), .b(new_n49_), .O(z5));
  inv1   g129(.a(new_n155_), .O(new_n163_));
  nand3  g130(.a(x20), .b(new_n68_), .c(new_n36_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n34_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n154_), .O(new_n166_));
  nand2  g133(.a(x11), .b(new_n35_), .O(new_n167_));
  nand3  g134(.a(new_n71_), .b(x14), .c(x06), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n167_), .c(x03), .O(new_n169_));
  oai21  g136(.a(new_n122_), .b(new_n118_), .c(new_n169_), .O(new_n170_));
  oai21  g137(.a(new_n35_), .b(new_n37_), .c(new_n34_), .O(new_n171_));
  nand3  g138(.a(x11), .b(new_n35_), .c(new_n37_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n171_), .c(new_n168_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(x24), .c(x18), .d(x13), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n170_), .c(new_n166_), .d(new_n163_), .O(z6));
  inv1   g142(.a(new_n118_), .O(new_n176_));
  nand4  g143(.a(new_n163_), .b(new_n123_), .c(new_n119_), .d(new_n176_), .O(z7));
endmodule
