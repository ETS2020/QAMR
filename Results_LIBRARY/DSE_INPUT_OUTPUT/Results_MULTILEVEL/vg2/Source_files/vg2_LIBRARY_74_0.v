...
module FAU ( 
  ...
  or2    g109(.a(new_n111_), .b(new_n107_), .O(new_n143_));
  ...
  nand2  g117(.a(new_n94_), .b(new_n64_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n150_), .c(new_n142_), .O(z4));
  nand3  g119(.a(new_n40_), .b(new_n97_), .c(x00), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x01), .c(x02), .O(new_n154_));
  or2    g121(.a(new_n154_), .b(new_n49_), .O(z5));
  nand2  g122(.a(x20), .b(new_n37_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n35_), .c(x11), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x03), .c(new_n141_), .O(new_n158_));
  nand2  g125(.a(new_n38_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n36_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n34_), .c(new_n143_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n151_), .O(z6));
  aoi21  g129(.a(new_n130_), .b(new_n97_), .c(new_n64_), .O(new_n163_));
  nand2  g130(.a(new_n109_), .b(new_n108_), .O(new_n164_));
  nor2   g131(.a(new_n164_), .b(new_n107_), .O(new_n165_));
  oai21  g132(.a(new_n163_), .b(x02), .c(new_n165_), .O(z7));
endmodule
