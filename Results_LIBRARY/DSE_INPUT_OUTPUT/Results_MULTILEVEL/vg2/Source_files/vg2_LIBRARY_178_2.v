...
module FAU ( 
  ...
  nor4   g052(.a(new_n85_), .b(new_n84_), .c(new_n54_), .d(new_n34_), .O(new_n86_));
  ...
  nand4  g067(.a(new_n100_), .b(new_n88_), .c(new_n67_), .d(new_n66_), .O(new_n101_));
  ...
  nand2  g074(.a(new_n69_), .b(x12), .O(new_n108_));
  ...
  nor3   g086(.a(new_n119_), .b(new_n69_), .c(new_n54_), .O(new_n120_));
  ...
  nand4  g094(.a(new_n127_), .b(new_n69_), .c(new_n54_), .d(new_n34_), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(x11), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n65_), .c(new_n37_), .d(new_n36_), .O(new_n130_));
  ...
  nand4  g101(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n135_));
  nor2   g102(.a(x11), .b(x08), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n69_), .c(new_n54_), .d(new_n34_), .O(new_n137_));
  ...
  nand3  g107(.a(new_n100_), .b(new_n36_), .c(new_n35_), .O(new_n141_));
  nand4  g108(.a(new_n104_), .b(new_n54_), .c(new_n34_), .d(new_n67_), .O(new_n142_));
  ...
  oai21  g113(.a(x23), .b(new_n64_), .c(new_n68_), .O(new_n147_));
