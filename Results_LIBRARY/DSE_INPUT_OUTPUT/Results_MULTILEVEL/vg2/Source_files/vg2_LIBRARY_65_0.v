...
module FAU ( 
  ...
  aoi21  g077(.a(new_n110_), .b(new_n109_), .c(new_n47_), .O(new_n111_));
  ...
  oai22  g081(.a(new_n114_), .b(new_n111_), .c(x09), .d(x02), .O(new_n115_));
  nor2   g082(.a(x24), .b(new_n104_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n101_), .c(x09), .d(new_n34_), .O(new_n117_));
  ...
  nand3  g088(.a(x21), .b(new_n101_), .c(new_n34_), .O(new_n122_));
  ...
  nand3  g093(.a(new_n101_), .b(new_n34_), .c(x00), .O(new_n127_));
  ...
  nand3  g100(.a(new_n62_), .b(x03), .c(x01), .O(new_n134_));
  nand4  g101(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n135_));
  nand4  g102(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n136_));
  nand4  g103(.a(new_n40_), .b(new_n39_), .c(new_n46_), .d(new_n61_), .O(new_n137_));
  ...
  nand3  g107(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n141_));
  nand3  g108(.a(new_n78_), .b(new_n39_), .c(new_n46_), .O(new_n142_));
  oai22  g109(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n134_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n52_), .c(new_n47_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n139_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n133_), .c(x09), .O(new_n146_));
  ...
  nor2   g118(.a(x24), .b(x10), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n34_), .c(x00), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n53_), .c(new_n51_), .O(new_n154_));
  oai22  g121(.a(new_n154_), .b(new_n50_), .c(new_n151_), .d(x08), .O(new_n155_));
  inv1   g122(.a(x22), .O(new_n156_));
  nand2  g123(.a(x23), .b(new_n70_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x17), .c(new_n156_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x16), .c(new_n61_), .O(new_n159_));
  nand3  g126(.a(new_n116_), .b(new_n101_), .c(new_n34_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n113_), .c(new_n112_), .O(new_n161_));
  ...
  oai21  g132(.a(x23), .b(new_n70_), .c(new_n165_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n156_), .c(new_n151_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n61_), .c(new_n55_), .O(new_n168_));
  nor2   g135(.a(new_n114_), .b(new_n111_), .O(new_n169_));
  aoi21  g136(.a(x16), .b(new_n69_), .c(new_n61_), .O(new_n170_));
  nor2   g137(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n168_), .c(x02), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n164_), .O(z4));
  inv1   g140(.a(new_n50_), .O(new_n174_));
  nand2  g141(.a(new_n69_), .b(x08), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n41_), .c(new_n101_), .d(x00), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(x09), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(new_n34_), .c(new_n54_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n174_), .O(z5));
  aoi21  g146(.a(x20), .b(new_n39_), .c(x06), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(x11), .c(new_n36_), .O(new_n181_));
  nor2   g148(.a(x09), .b(x02), .O(new_n182_));
  nand4  g149(.a(new_n152_), .b(x09), .c(new_n34_), .d(x00), .O(new_n183_));
  oai21  g150(.a(new_n182_), .b(new_n55_), .c(new_n183_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n181_), .O(new_n185_));
  nand2  g152(.a(new_n117_), .b(new_n115_), .O(z7));
  aoi21  g153(.a(new_n40_), .b(x14), .c(new_n37_), .O(new_n187_));
  oai21  g154(.a(new_n187_), .b(new_n46_), .c(x03), .O(new_n188_));
  nand2  g155(.a(new_n188_), .b(z7), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n185_), .O(z6));
endmodule
