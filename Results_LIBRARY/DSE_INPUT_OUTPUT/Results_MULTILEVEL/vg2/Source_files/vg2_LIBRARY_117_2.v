...
module FAU ( 
  ...
  nand4  g035(.a(new_n68_), .b(new_n36_), .c(new_n34_), .d(new_n35_), .O(new_n69_));
  inv1   g036(.a(new_n69_), .O(new_n70_));
  nor2   g037(.a(x08), .b(x06), .O(new_n71_));
  nand4  g038(.a(new_n71_), .b(new_n70_), .c(new_n67_), .d(new_n66_), .O(new_n72_));
  ...
  nor2   g053(.a(new_n60_), .b(new_n86_), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n85_), .c(new_n64_), .d(new_n56_), .O(new_n88_));
  nor2   g055(.a(x09), .b(x08), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n70_), .c(x07), .d(new_n37_), .O(new_n90_));
  ...
  nand4  g065(.a(new_n98_), .b(new_n85_), .c(new_n64_), .d(new_n56_), .O(new_n99_));
  ...
  nand4  g070(.a(new_n103_), .b(new_n41_), .c(new_n45_), .d(new_n34_), .O(new_n104_));
  ...
  nor2   g082(.a(x20), .b(new_n34_), .O(new_n116_));
  inv1   g083(.a(new_n116_), .O(new_n117_));
  oai21  g084(.a(new_n115_), .b(new_n35_), .c(new_n117_), .O(z2));
  nand4  g085(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n119_));
  nand4  g086(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n120_));
  nand2  g087(.a(new_n100_), .b(new_n71_), .O(new_n121_));
  nand3  g088(.a(new_n76_), .b(new_n38_), .c(new_n67_), .O(new_n122_));
  oai22  g089(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n119_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n82_), .O(new_n124_));
  nand3  g091(.a(new_n87_), .b(x14), .c(x11), .O(new_n125_));
  nand3  g092(.a(new_n100_), .b(x07), .c(new_n37_), .O(new_n126_));
  inv1   g093(.a(x08), .O(new_n127_));
  nand4  g094(.a(new_n60_), .b(new_n38_), .c(new_n67_), .d(new_n127_), .O(new_n128_));
  ...
  nand4  g097(.a(new_n37_), .b(new_n36_), .c(new_n35_), .d(x00), .O(new_n131_));
  nand4  g098(.a(x06), .b(x03), .c(new_n34_), .d(x01), .O(new_n132_));
  nor2   g099(.a(new_n67_), .b(new_n127_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n98_), .c(x14), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n132_), .c(new_n131_), .d(new_n128_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n41_), .c(new_n45_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n130_), .c(new_n124_), .d(new_n117_), .O(z3));
  oai21  g104(.a(x23), .b(new_n68_), .c(new_n59_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n62_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n127_), .O(new_n140_));
  nand2  g107(.a(new_n48_), .b(new_n44_), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n43_), .c(new_n117_), .O(new_n142_));
  ...
  oai21  g118(.a(new_n151_), .b(new_n116_), .c(new_n111_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n145_), .O(z4));
  inv1   g121(.a(new_n43_), .O(new_n155_));
  and2   g122(.a(new_n143_), .b(new_n44_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n117_), .c(new_n48_), .d(new_n155_), .O(z5));
  inv1   g124(.a(x00), .O(new_n158_));
  nor2   g125(.a(x10), .b(new_n158_), .O(new_n159_));
  ...
  oai21  g131(.a(new_n97_), .b(x10), .c(new_n164_), .O(new_n165_));
  aoi21  g132(.a(new_n60_), .b(x14), .c(new_n37_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n67_), .c(x03), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand4  g135(.a(new_n159_), .b(x20), .c(new_n38_), .d(new_n67_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n168_), .c(new_n163_), .O(new_n170_));
  inv1   g137(.a(x07), .O(new_n171_));
  oai21  g138(.a(x13), .b(x05), .c(x24), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n171_), .c(new_n48_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n162_), .O(new_n174_));
  oai21  g141(.a(new_n172_), .b(new_n86_), .c(new_n110_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n167_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n174_), .O(new_n177_));
  aoi21  g144(.a(new_n170_), .b(new_n41_), .c(new_n177_), .O(new_n178_));
  oai21  g145(.a(new_n38_), .b(x06), .c(new_n67_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n36_), .O(new_n180_));
  oai21  g147(.a(new_n141_), .b(new_n43_), .c(new_n180_), .O(new_n181_));
  aoi21  g148(.a(x11), .b(new_n37_), .c(new_n36_), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(new_n151_), .c(new_n181_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(x20), .O(new_n184_));
  oai21  g151(.a(new_n178_), .b(x02), .c(new_n184_), .O(z6));
  inv1   g152(.a(new_n108_), .O(new_n186_));
  inv1   g153(.a(new_n150_), .O(new_n187_));
  nand4  g154(.a(new_n187_), .b(new_n117_), .c(new_n111_), .d(new_n186_), .O(z7));
endmodule
