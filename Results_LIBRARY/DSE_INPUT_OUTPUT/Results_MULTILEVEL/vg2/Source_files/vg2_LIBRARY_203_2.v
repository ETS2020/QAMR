...
module FAU ( 
  ...
  nor2   g124(.a(x23), .b(new_n71_), .O(new_n158_));
  ...
  nand3  g129(.a(new_n162_), .b(new_n69_), .c(new_n66_), .O(new_n163_));
  oai21  g130(.a(new_n158_), .b(new_n66_), .c(new_n163_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n160_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n159_), .c(new_n157_), .O(z4));
  nor2   g133(.a(new_n158_), .b(new_n49_), .O(z5));
  nand2  g134(.a(x20), .b(new_n68_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n35_), .c(x11), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(x03), .c(new_n160_), .O(new_n170_));
  nand2  g137(.a(new_n71_), .b(x14), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(x06), .c(new_n36_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n34_), .c(new_n153_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n170_), .c(new_n159_), .O(z6));
  inv1   g141(.a(new_n119_), .O(new_n175_));
  and2   g142(.a(new_n121_), .b(new_n120_), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(new_n159_), .c(new_n122_), .d(new_n175_), .O(z7));
endmodule
