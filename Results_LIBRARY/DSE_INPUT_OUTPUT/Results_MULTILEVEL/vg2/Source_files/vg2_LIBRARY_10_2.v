...
module FAU ( 
  ...
  nand4  g097(.a(new_n130_), .b(new_n69_), .c(new_n113_), .d(new_n67_), .O(new_n131_));
  ...
  nand3  g103(.a(new_n87_), .b(x14), .c(x11), .O(new_n137_));
  nand4  g104(.a(x07), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n138_));
  nand4  g105(.a(new_n69_), .b(new_n113_), .c(new_n67_), .d(new_n65_), .O(new_n139_));
  ...
  nand4  g110(.a(new_n69_), .b(x19), .c(new_n113_), .d(new_n67_), .O(new_n144_));
  ...
  nand4  g113(.a(new_n146_), .b(new_n141_), .c(new_n135_), .d(new_n109_), .O(z3));
  inv1   g114(.a(new_n50_), .O(new_n148_));
  oai21  g115(.a(x23), .b(new_n64_), .c(new_n68_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n70_), .c(x09), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x16), .c(new_n65_), .O(new_n151_));
  ...
  oai21  g122(.a(new_n155_), .b(new_n54_), .c(x08), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n152_), .c(new_n108_), .O(z4));
  ...
  nand2  g128(.a(x20), .b(new_n113_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n37_), .c(x11), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x03), .c(new_n148_), .O(new_n164_));
  nor2   g131(.a(new_n108_), .b(x03), .O(new_n165_));
  nand2  g132(.a(new_n37_), .b(x03), .O(new_n166_));
  nand2  g133(.a(new_n69_), .b(x14), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n166_), .c(new_n67_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n165_), .c(new_n153_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n164_), .c(new_n109_), .O(z6));
  nor2   g137(.a(new_n122_), .b(new_n108_), .O(z7));
endmodule
