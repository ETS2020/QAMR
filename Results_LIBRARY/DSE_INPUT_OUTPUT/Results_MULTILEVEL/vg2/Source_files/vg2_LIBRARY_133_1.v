...
module FAU ( 
  ...
  and2   g117(.a(new_n150_), .b(new_n48_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n44_), .c(new_n149_), .O(new_n152_));
  ...
  oai21  g123(.a(new_n117_), .b(new_n113_), .c(new_n156_), .O(new_n157_));
  nand2  g124(.a(x02), .b(new_n90_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n157_), .c(new_n153_), .O(z4));
  nand4  g126(.a(new_n158_), .b(new_n151_), .c(new_n44_), .d(new_n149_), .O(z5));
  ...
  oai21  g130(.a(new_n163_), .b(new_n43_), .c(new_n158_), .O(new_n164_));
  ...
  oai21  g136(.a(new_n169_), .b(new_n113_), .c(new_n158_), .O(new_n170_));
