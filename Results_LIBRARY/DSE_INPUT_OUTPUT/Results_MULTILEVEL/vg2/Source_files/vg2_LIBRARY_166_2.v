...
module FAU ( 
  ...
  nor4   g091(.a(new_n124_), .b(new_n72_), .c(new_n71_), .d(new_n68_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x11), .c(x06), .d(x03), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(new_n64_), .O(z2));
  nand4  g094(.a(new_n56_), .b(x22), .c(x20), .d(x14), .O(new_n128_));
  ...
  oai21  g100(.a(new_n130_), .b(new_n64_), .c(new_n133_), .O(new_n134_));
  ...
  nand4  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n95_), .O(new_n139_));
  nand4  g106(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n140_));
  inv1   g107(.a(new_n140_), .O(new_n141_));
  nor2   g108(.a(new_n68_), .b(new_n36_), .O(new_n142_));
  nor2   g109(.a(new_n72_), .b(new_n71_), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(x18), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n139_), .c(new_n86_), .O(new_n145_));
  nor2   g112(.a(x14), .b(x11), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n136_), .c(new_n110_), .d(new_n106_), .O(new_n147_));
  nand4  g114(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(x15), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n147_), .c(x13), .O(new_n149_));
  aoi22  g116(.a(new_n149_), .b(new_n37_), .c(new_n145_), .d(x24), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n135_), .O(z3));
  inv1   g118(.a(new_n49_), .O(new_n152_));
  nor2   g119(.a(x22), .b(new_n35_), .O(new_n153_));
  aoi21  g120(.a(new_n69_), .b(x09), .c(x08), .O(new_n154_));
  oai21  g121(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n72_), .c(new_n69_), .d(new_n35_), .O(new_n156_));
  oai21  g123(.a(new_n154_), .b(new_n153_), .c(new_n156_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n152_), .O(new_n158_));
  inv1   g125(.a(new_n124_), .O(new_n159_));
  aoi21  g126(.a(x16), .b(new_n67_), .c(new_n66_), .O(new_n160_));
  oai21  g127(.a(new_n73_), .b(x04), .c(x17), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(x22), .c(x16), .O(new_n162_));
  oai21  g129(.a(new_n160_), .b(new_n153_), .c(new_n162_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n159_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n158_), .O(z4));
  ...
  oai21  g138(.a(new_n171_), .b(x03), .c(new_n152_), .O(new_n172_));
  nor2   g139(.a(new_n153_), .b(x03), .O(new_n173_));
  nand3  g140(.a(new_n71_), .b(x14), .c(x03), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x06), .c(new_n36_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n173_), .c(new_n159_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n172_), .c(new_n167_), .O(z6));
  nor2   g144(.a(new_n153_), .b(new_n124_), .O(z7));
endmodule
