...
module FAU ( 
  ...
  nor3   g045(.a(new_n78_), .b(new_n61_), .c(new_n36_), .O(new_n79_));
  nand4  g046(.a(new_n79_), .b(x06), .c(x03), .d(x01), .O(new_n80_));
  aoi21  g047(.a(new_n80_), .b(new_n52_), .c(new_n53_), .O(z2));
  ...
  nand4  g067(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n89_), .O(new_n101_));
  nand4  g068(.a(new_n61_), .b(new_n53_), .c(new_n36_), .d(new_n82_), .O(new_n102_));
  ...
  nand4  g072(.a(new_n82_), .b(new_n35_), .c(new_n34_), .d(new_n89_), .O(new_n106_));
  ...
  nand2  g092(.a(x20), .b(new_n53_), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(new_n35_), .c(x11), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(x03), .c(new_n111_), .O(new_n128_));
  oai21  g095(.a(x20), .b(new_n53_), .c(x06), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(x11), .c(x03), .O(new_n130_));
  oai21  g097(.a(new_n54_), .b(x03), .c(new_n130_), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(new_n117_), .c(new_n54_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n128_), .O(z6));
  nor2   g100(.a(new_n78_), .b(new_n54_), .O(z7));
endmodule
