...
module FAU ( 
  ...
  oai21  g130(.a(x23), .b(new_n163_), .c(new_n86_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n112_), .c(x09), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x16), .c(new_n82_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n162_), .O(new_n167_));
  oai21  g134(.a(new_n101_), .b(x04), .c(x17), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x22), .c(new_n62_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n89_), .c(x08), .O(new_n170_));
  inv1   g137(.a(new_n123_), .O(new_n171_));
  nor2   g138(.a(x10), .b(x02), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n151_), .c(new_n171_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n122_), .c(new_n121_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand2  g142(.a(x02), .b(x01), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n175_), .c(new_n167_), .O(z4));
  and2   g144(.a(new_n176_), .b(new_n43_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n48_), .c(new_n46_), .d(new_n160_), .O(z5));
  nand2  g146(.a(x20), .b(new_n88_), .O(new_n180_));
  aoi21  g147(.a(new_n180_), .b(new_n35_), .c(x11), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(x03), .c(new_n162_), .O(new_n182_));
  nand2  g149(.a(new_n37_), .b(x14), .O(new_n183_));
  aoi21  g150(.a(new_n183_), .b(x06), .c(new_n36_), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n34_), .c(new_n174_), .O(new_n185_));
  nand3  g152(.a(new_n185_), .b(new_n182_), .c(new_n176_), .O(z6));
  nand4  g153(.a(new_n176_), .b(new_n173_), .c(new_n122_), .d(new_n121_), .O(z7));
endmodule
