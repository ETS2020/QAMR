...
module FAU ( 
  ...
  nand4  g025(.a(new_n58_), .b(x20), .c(x17), .d(x16), .O(new_n59_));
  ...
  nand2  g045(.a(new_n46_), .b(new_n37_), .O(new_n79_));
  ...
  nand4  g050(.a(x23), .b(x20), .c(x18), .d(x17), .O(new_n84_));
  nor4   g051(.a(new_n84_), .b(new_n83_), .c(new_n54_), .d(new_n53_), .O(new_n85_));
  ...
  nand4  g056(.a(new_n83_), .b(new_n54_), .c(new_n53_), .d(new_n36_), .O(new_n90_));
  inv1   g057(.a(new_n90_), .O(new_n91_));
  nor2   g058(.a(x23), .b(x22), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n91_), .c(new_n67_), .d(new_n66_), .O(new_n93_));
  oai21  g060(.a(new_n93_), .b(new_n89_), .c(new_n86_), .O(new_n94_));
  nand3  g061(.a(new_n94_), .b(new_n79_), .c(x24), .O(new_n95_));
  nand3  g062(.a(x15), .b(x14), .c(x12), .O(new_n96_));
  nand4  g063(.a(x23), .b(x20), .c(x17), .d(x16), .O(new_n97_));
  nor2   g064(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g065(.a(new_n98_), .b(new_n82_), .O(new_n99_));
  nor2   g066(.a(x08), .b(x06), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n87_), .c(new_n36_), .d(new_n65_), .O(new_n101_));
  ...
  nand4  g072(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(new_n92_), .O(new_n106_));
  oai21  g073(.a(new_n106_), .b(new_n101_), .c(new_n99_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n46_), .c(new_n37_), .O(new_n108_));
  nand2  g075(.a(new_n68_), .b(x20), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n108_), .c(new_n95_), .O(new_n110_));
  inv1   g077(.a(new_n110_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n78_), .O(z1));
  ...
  nor3   g087(.a(new_n120_), .b(new_n54_), .c(new_n36_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(x06), .c(x03), .d(x01), .O(new_n122_));
  aoi21  g089(.a(new_n122_), .b(x22), .c(new_n67_), .O(z2));
  ...
  nor2   g093(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(x06), .c(x03), .d(x01), .O(new_n128_));
  nand2  g095(.a(new_n70_), .b(new_n69_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n67_), .c(new_n54_), .d(new_n36_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(x08), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n35_), .c(new_n34_), .d(new_n80_), .O(new_n132_));
  ...
  nor2   g102(.a(new_n54_), .b(new_n36_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(x20), .c(x18), .O(new_n137_));
  nand4  g104(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n80_), .O(new_n138_));
  nand4  g105(.a(new_n67_), .b(new_n54_), .c(new_n36_), .d(new_n124_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n135_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n79_), .c(x24), .O(new_n141_));
  nand3  g108(.a(new_n136_), .b(x20), .c(x15), .O(new_n142_));
  nand3  g109(.a(new_n100_), .b(new_n34_), .c(new_n80_), .O(new_n143_));
  nor2   g110(.a(x14), .b(x11), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n105_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n143_), .c(new_n142_), .d(new_n135_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n46_), .c(new_n37_), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n141_), .c(new_n134_), .d(new_n109_), .O(z3));
  inv1   g115(.a(new_n49_), .O(new_n149_));
  oai21  g116(.a(x23), .b(new_n64_), .c(new_n66_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n68_), .c(x09), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x16), .c(new_n124_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  inv1   g120(.a(new_n120_), .O(new_n154_));
  oai21  g121(.a(new_n55_), .b(x04), .c(x17), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x22), .c(new_n65_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n83_), .c(x08), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n153_), .c(new_n109_), .O(z4));
  inv1   g126(.a(new_n41_), .O(new_n160_));
  and2   g127(.a(new_n45_), .b(new_n42_), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n109_), .c(new_n47_), .d(new_n160_), .O(z5));
  aoi21  g129(.a(new_n36_), .b(x06), .c(x03), .O(new_n163_));
  aoi21  g130(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n120_), .c(new_n163_), .d(new_n49_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n109_), .O(new_n166_));
  nand3  g133(.a(new_n136_), .b(x21), .c(new_n67_), .O(new_n167_));
  nand2  g134(.a(new_n36_), .b(x00), .O(new_n168_));
  nand3  g135(.a(x22), .b(x20), .c(new_n54_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n168_), .c(new_n167_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n44_), .c(new_n43_), .O(new_n171_));
  nand3  g138(.a(new_n136_), .b(new_n67_), .c(x15), .O(new_n172_));
  nand4  g139(.a(new_n144_), .b(x22), .c(x20), .d(x19), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(x13), .c(x05), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n39_), .O(new_n177_));
  nand3  g144(.a(new_n136_), .b(new_n67_), .c(x18), .O(new_n178_));
  nand2  g145(.a(new_n36_), .b(x07), .O(new_n179_));
  oai21  g146(.a(new_n179_), .b(new_n169_), .c(new_n178_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n79_), .c(x24), .O(new_n181_));
  nand3  g148(.a(new_n174_), .b(new_n46_), .c(new_n37_), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n181_), .c(new_n177_), .d(new_n166_), .O(z6));
  inv1   g150(.a(new_n115_), .O(new_n184_));
  and2   g151(.a(new_n117_), .b(new_n116_), .O(new_n185_));
  nand4  g152(.a(new_n185_), .b(new_n118_), .c(new_n184_), .d(new_n109_), .O(z7));
endmodule
