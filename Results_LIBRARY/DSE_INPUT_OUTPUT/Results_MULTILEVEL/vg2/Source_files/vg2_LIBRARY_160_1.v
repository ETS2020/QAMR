...
module FAU ( 
  ...
  nand4  g055(.a(new_n88_), .b(new_n68_), .c(new_n67_), .d(new_n86_), .O(new_n89_));
  ...
  nand4  g080(.a(new_n50_), .b(x21), .c(new_n49_), .d(new_n37_), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n113_), .c(new_n61_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x14), .c(x11), .d(x06), .O(new_n116_));
  nor3   g083(.a(new_n116_), .b(new_n98_), .c(new_n97_), .O(z2));
  ...
  nand3  g087(.a(new_n69_), .b(new_n98_), .c(new_n97_), .O(new_n121_));
  ...
  nand3  g092(.a(new_n88_), .b(new_n98_), .c(new_n97_), .O(new_n126_));
  nand4  g093(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n86_), .O(new_n127_));
  ...
  nand4  g096(.a(new_n34_), .b(new_n98_), .c(new_n97_), .d(x00), .O(new_n130_));
  nand3  g097(.a(new_n119_), .b(x21), .c(x20), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n118_), .c(new_n130_), .d(new_n127_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n41_), .c(new_n49_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n64_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n37_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n129_), .c(new_n124_), .O(z3));
  nand2  g103(.a(x22), .b(new_n60_), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(x09), .c(new_n91_), .O(new_n138_));
  nand4  g105(.a(new_n41_), .b(x21), .c(new_n49_), .d(new_n37_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n111_), .c(new_n110_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n109_), .c(new_n138_), .d(new_n86_), .O(new_n141_));
  aoi21  g108(.a(new_n63_), .b(x17), .c(x09), .O(new_n142_));
  nand2  g109(.a(new_n75_), .b(x04), .O(new_n143_));
  oai21  g110(.a(new_n142_), .b(x08), .c(new_n143_), .O(new_n144_));
  aoi22  g111(.a(new_n144_), .b(new_n91_), .c(new_n38_), .d(x08), .O(new_n145_));
  inv1   g112(.a(x04), .O(new_n146_));
  nand4  g113(.a(new_n65_), .b(x16), .c(x15), .d(new_n146_), .O(new_n147_));
  oai21  g114(.a(new_n145_), .b(new_n73_), .c(new_n147_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n80_), .O(new_n149_));
  nand4  g116(.a(new_n65_), .b(x18), .c(x16), .d(new_n146_), .O(new_n150_));
  oai21  g117(.a(new_n145_), .b(new_n87_), .c(new_n150_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n78_), .c(x24), .O(new_n152_));
  nor2   g119(.a(x17), .b(x04), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x22), .c(new_n67_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n91_), .c(new_n86_), .O(new_n155_));
  oai21  g122(.a(x23), .b(new_n86_), .c(new_n155_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n41_), .c(new_n49_), .d(x00), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n64_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n37_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n152_), .c(new_n149_), .d(new_n141_), .O(z4));
  nand2  g127(.a(new_n51_), .b(new_n48_), .O(z5));
  aoi21  g128(.a(x20), .b(new_n36_), .c(x06), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x11), .c(new_n98_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(z5), .O(new_n164_));
  nand2  g131(.a(new_n114_), .b(new_n113_), .O(z7));
  aoi21  g132(.a(new_n61_), .b(x14), .c(new_n34_), .O(new_n166_));
