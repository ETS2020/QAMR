...
module FAU ( 
  ...
  nand2  g110(.a(new_n44_), .b(x01), .O(new_n144_));
  nand2  g111(.a(new_n48_), .b(new_n43_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n42_), .c(new_n144_), .O(new_n146_));
  nand4  g113(.a(new_n97_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n147_));
  ...
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n65_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n90_), .c(x08), .O(new_n152_));
  nand2  g119(.a(new_n144_), .b(new_n114_), .O(new_n153_));
  nor2   g120(.a(x02), .b(x01), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n153_), .O(z7));
  nand2  g123(.a(z7), .b(new_n152_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n149_), .O(z4));
  nand2  g125(.a(x20), .b(new_n89_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n35_), .c(x11), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n161_));
  oai21  g128(.a(x20), .b(new_n89_), .c(x06), .O(new_n162_));
  ...
  nand4  g132(.a(new_n165_), .b(new_n112_), .c(new_n111_), .d(new_n110_), .O(new_n166_));
  oai21  g133(.a(new_n164_), .b(new_n123_), .c(new_n166_), .O(new_n167_));
  nand3  g134(.a(new_n114_), .b(new_n34_), .c(x02), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n167_), .c(new_n161_), .d(new_n144_), .O(z6));
endmodule
