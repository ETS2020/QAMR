...
module FAU ( 
  ...
  nand3  g084(.a(x15), .b(new_n53_), .c(new_n48_), .O(new_n118_));
  oai21  g085(.a(new_n115_), .b(new_n53_), .c(new_n118_), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n117_), .c(x20), .O(new_n120_));
  nor2   g087(.a(new_n120_), .b(new_n40_), .O(new_n121_));
  ...
  nand3  g091(.a(new_n109_), .b(x20), .c(x15), .O(new_n125_));
  nand3  g092(.a(new_n73_), .b(new_n37_), .c(new_n36_), .O(new_n126_));
  nand3  g093(.a(new_n78_), .b(new_n40_), .c(new_n47_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n124_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n84_), .O(new_n129_));
  nand2  g096(.a(new_n109_), .b(new_n88_), .O(new_n130_));
  nand4  g097(.a(x07), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n131_));
  nand4  g098(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n100_), .O(new_n132_));
  ...
  nand3  g101(.a(new_n109_), .b(x21), .c(x20), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n124_), .c(new_n132_), .d(new_n39_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n42_), .c(new_n101_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n35_), .O(new_n138_));
  ...
  oai21  g108(.a(x23), .b(new_n141_), .c(new_n65_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n67_), .c(x09), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n100_), .O(new_n144_));
  nor2   g111(.a(new_n55_), .b(new_n51_), .O(new_n145_));
  nor2   g112(.a(new_n35_), .b(x02), .O(new_n146_));
  nor2   g113(.a(x24), .b(x12), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n101_), .c(new_n34_), .d(x00), .O(new_n148_));
  oai21  g115(.a(new_n146_), .b(new_n145_), .c(new_n148_), .O(z5));
  nand2  g116(.a(z5), .b(new_n144_), .O(new_n150_));
  oai21  g117(.a(new_n68_), .b(x04), .c(x17), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x22), .c(new_n71_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n92_), .c(x08), .O(new_n153_));
  nor2   g120(.a(new_n119_), .b(new_n117_), .O(new_n154_));
  nand4  g121(.a(new_n111_), .b(new_n35_), .c(new_n101_), .d(new_n34_), .O(new_n155_));
  oai21  g122(.a(new_n146_), .b(new_n154_), .c(new_n155_), .O(z7));
  nand2  g123(.a(z7), .b(new_n153_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n150_), .O(z4));
  aoi21  g125(.a(x20), .b(new_n40_), .c(x06), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x11), .c(new_n37_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(z5), .O(new_n161_));
  aoi21  g128(.a(new_n41_), .b(x14), .c(new_n38_), .O(new_n162_));
