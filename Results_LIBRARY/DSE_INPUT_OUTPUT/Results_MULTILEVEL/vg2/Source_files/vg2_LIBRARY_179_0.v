...
module FAU ( 
  ...
  nand3  g105(.a(new_n138_), .b(new_n108_), .c(x00), .O(new_n139_));
  ...
  aoi21  g112(.a(new_n145_), .b(x22), .c(new_n143_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n142_), .c(x08), .O(new_n147_));
  oai21  g114(.a(new_n110_), .b(new_n105_), .c(new_n147_), .O(new_n148_));
  nor2   g115(.a(x02), .b(x01), .O(new_n149_));
  inv1   g116(.a(new_n149_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n148_), .c(new_n141_), .O(z4));
  nor2   g118(.a(new_n46_), .b(new_n42_), .O(new_n152_));
  aoi21  g119(.a(new_n138_), .b(x00), .c(new_n61_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x02), .c(new_n152_), .O(z5));
  aoi21  g121(.a(x20), .b(new_n102_), .c(x06), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x11), .c(new_n34_), .O(new_n156_));
  nand4  g123(.a(new_n138_), .b(new_n108_), .c(x01), .d(x00), .O(new_n157_));
  ...
  nand2  g128(.a(new_n107_), .b(new_n106_), .O(new_n162_));
  nor2   g129(.a(new_n162_), .b(new_n105_), .O(new_n163_));
  nand2  g130(.a(new_n128_), .b(new_n94_), .O(new_n164_));
  inv1   g131(.a(new_n164_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n91_), .O(new_n166_));
  oai21  g133(.a(new_n163_), .b(new_n149_), .c(new_n166_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n161_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n159_), .O(z6));
  oai21  g136(.a(new_n165_), .b(new_n61_), .c(new_n108_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n163_), .O(z7));
endmodule
