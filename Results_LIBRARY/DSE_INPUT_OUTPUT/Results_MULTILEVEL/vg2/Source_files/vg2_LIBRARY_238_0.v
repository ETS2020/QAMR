...
module FAU ( 
  ...
  nand3  g108(.a(new_n141_), .b(new_n102_), .c(x00), .O(new_n142_));
  ...
  nand3  g122(.a(new_n155_), .b(new_n153_), .c(new_n144_), .O(z4));
  nor2   g123(.a(new_n46_), .b(new_n42_), .O(new_n157_));
  aoi21  g124(.a(new_n141_), .b(x00), .c(new_n61_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x02), .c(new_n157_), .O(z5));
  aoi21  g126(.a(x20), .b(new_n108_), .c(x06), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x11), .c(new_n34_), .O(new_n161_));
  nand4  g128(.a(new_n141_), .b(new_n102_), .c(x01), .d(x00), .O(new_n162_));
  ...
  nand2  g134(.a(new_n104_), .b(new_n94_), .O(new_n168_));
  inv1   g135(.a(new_n168_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n91_), .O(new_n170_));
  oai21  g137(.a(new_n154_), .b(new_n167_), .c(new_n170_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n166_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n164_), .O(z6));
  oai21  g140(.a(new_n169_), .b(new_n61_), .c(new_n102_), .O(new_n174_));
