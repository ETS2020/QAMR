...
module FAU ( 
  ...
  inv1   g020(.a(new_n37_), .O(new_n54_));
  ...
  nand4  g036(.a(new_n35_), .b(new_n69_), .c(new_n68_), .d(new_n34_), .O(new_n70_));
  inv1   g037(.a(new_n70_), .O(new_n71_));
  inv1   g038(.a(x12), .O(new_n72_));
  inv1   g039(.a(x16), .O(new_n73_));
  nand4  g040(.a(new_n60_), .b(new_n73_), .c(new_n36_), .d(new_n72_), .O(new_n74_));
  nor2   g041(.a(x23), .b(x22), .O(new_n75_));
  nand3  g042(.a(new_n75_), .b(new_n61_), .c(x19), .O(new_n76_));
  nor2   g043(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand3  g044(.a(new_n77_), .b(new_n71_), .c(new_n67_), .O(new_n78_));
  nand2  g045(.a(new_n78_), .b(new_n66_), .O(new_n79_));
  ...
  nand4  g053(.a(new_n86_), .b(new_n85_), .c(new_n65_), .d(new_n57_), .O(new_n87_));
  nor2   g054(.a(x09), .b(x08), .O(new_n88_));
  nand3  g055(.a(new_n88_), .b(x07), .c(new_n34_), .O(new_n89_));
  inv1   g056(.a(new_n89_), .O(new_n90_));
  nand4  g057(.a(new_n73_), .b(new_n36_), .c(new_n72_), .d(new_n35_), .O(new_n91_));
  inv1   g058(.a(new_n91_), .O(new_n92_));
  nand3  g059(.a(new_n75_), .b(new_n61_), .c(new_n60_), .O(new_n93_));
  inv1   g060(.a(new_n93_), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n92_), .c(new_n90_), .d(new_n67_), .O(new_n95_));
  aoi21  g062(.a(new_n95_), .b(new_n87_), .c(new_n80_), .O(new_n96_));
  aoi22  g063(.a(new_n96_), .b(x24), .c(new_n83_), .d(new_n79_), .O(new_n97_));
  nand2  g064(.a(new_n94_), .b(new_n92_), .O(new_n98_));
  and2   g065(.a(x21), .b(x20), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n85_), .c(new_n65_), .d(new_n57_), .O(new_n100_));
  ...
  nand4  g071(.a(new_n104_), .b(new_n40_), .c(new_n49_), .d(new_n48_), .O(new_n105_));
  oai21  g072(.a(new_n97_), .b(new_n54_), .c(new_n105_), .O(z1));
  ...
  oai21  g081(.a(new_n114_), .b(new_n111_), .c(new_n37_), .O(new_n115_));
  nand4  g082(.a(new_n40_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n115_), .c(new_n61_), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(x14), .c(x11), .d(x06), .O(new_n118_));
  nor3   g085(.a(new_n118_), .b(new_n108_), .c(new_n107_), .O(z2));
  ...
  nand3  g089(.a(new_n101_), .b(new_n68_), .c(new_n34_), .O(new_n123_));
  nand4  g090(.a(new_n61_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n120_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n83_), .O(new_n126_));
  nand2  g093(.a(new_n121_), .b(new_n86_), .O(new_n127_));
  nand3  g094(.a(new_n101_), .b(x07), .c(new_n34_), .O(new_n128_));
  nand4  g095(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n68_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n120_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n81_), .c(x24), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n126_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n37_), .O(new_n133_));
  nand4  g100(.a(new_n34_), .b(new_n108_), .c(new_n107_), .d(x00), .O(new_n134_));
  nand2  g101(.a(new_n121_), .b(new_n99_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n120_), .c(new_n134_), .d(new_n129_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n40_), .c(new_n49_), .d(new_n48_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n133_), .O(z3));
  inv1   g105(.a(x04), .O(new_n139_));
  oai21  g106(.a(x23), .b(new_n139_), .c(new_n60_), .O(new_n140_));
  ...
  and2   g110(.a(new_n50_), .b(new_n45_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n43_), .c(new_n143_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  oai21  g113(.a(new_n64_), .b(x04), .c(x17), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x22), .c(new_n69_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n73_), .c(x08), .O(new_n149_));
  inv1   g116(.a(new_n111_), .O(new_n150_));
  and2   g117(.a(new_n116_), .b(new_n113_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n112_), .c(new_n150_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n146_), .c(new_n37_), .O(z4));
  nand4  g121(.a(new_n144_), .b(new_n43_), .c(new_n143_), .d(new_n37_), .O(z5));
  nand2  g122(.a(x20), .b(new_n36_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n34_), .c(x11), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x03), .c(new_n145_), .O(new_n158_));
  nand2  g125(.a(new_n61_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n35_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n108_), .c(new_n152_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n37_), .O(z6));
  nand4  g129(.a(new_n151_), .b(new_n112_), .c(new_n150_), .d(new_n37_), .O(z7));
endmodule
