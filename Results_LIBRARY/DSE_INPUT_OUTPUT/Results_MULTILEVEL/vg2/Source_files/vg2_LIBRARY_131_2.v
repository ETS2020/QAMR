...
module FAU ( 
  ...
  nor2   g114(.a(x20), .b(new_n68_), .O(new_n148_));
  inv1   g115(.a(new_n49_), .O(new_n149_));
  oai21  g116(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n150_));
  ...
  aoi21  g125(.a(new_n158_), .b(new_n153_), .c(new_n148_), .O(z4));
  nor2   g126(.a(new_n148_), .b(new_n49_), .O(z5));
  oai21  g127(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n161_));
  oai21  g128(.a(new_n36_), .b(x06), .c(x03), .O(new_n162_));
  aoi22  g129(.a(new_n162_), .b(new_n154_), .c(new_n161_), .d(new_n149_), .O(new_n163_));
  nand4  g130(.a(new_n149_), .b(x20), .c(new_n68_), .d(new_n36_), .O(new_n164_));
  oai21  g131(.a(new_n163_), .b(new_n148_), .c(new_n164_), .O(z6));
  nor2   g132(.a(new_n148_), .b(new_n123_), .O(z7));
endmodule
