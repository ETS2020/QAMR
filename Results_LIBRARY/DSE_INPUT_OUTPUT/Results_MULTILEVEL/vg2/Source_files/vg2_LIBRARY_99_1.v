...
module FAU ( 
  ...
  nor2   g093(.a(new_n35_), .b(x02), .O(new_n127_));
  inv1   g094(.a(new_n127_), .O(new_n128_));
  nor2   g095(.a(new_n43_), .b(new_n93_), .O(new_n129_));
  inv1   g096(.a(new_n129_), .O(new_n130_));
  nand3  g097(.a(new_n43_), .b(x15), .c(x13), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(new_n130_), .c(new_n47_), .O(new_n132_));
  nand3  g099(.a(x15), .b(new_n52_), .c(new_n47_), .O(new_n133_));
  oai21  g100(.a(new_n130_), .b(new_n52_), .c(new_n133_), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n132_), .c(new_n128_), .O(new_n135_));
  nand2  g102(.a(new_n35_), .b(new_n34_), .O(new_n136_));
  nand2  g103(.a(new_n43_), .b(x21), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .O(z7));
  and2   g105(.a(z7), .b(x20), .O(new_n139_));
  ...
  nand4  g135(.a(new_n43_), .b(new_n35_), .c(new_n34_), .d(x00), .O(new_n169_));
  oai21  g136(.a(new_n127_), .b(new_n55_), .c(new_n169_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  oai21  g138(.a(new_n76_), .b(x04), .c(x17), .O(new_n172_));
  ...
  nand2  g142(.a(new_n175_), .b(new_n171_), .O(z4));
  aoi21  g143(.a(new_n43_), .b(x00), .c(x10), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(x02), .c(new_n55_), .O(z5));
  nand2  g145(.a(x20), .b(new_n41_), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n38_), .c(x11), .O(new_n180_));
  nand3  g147(.a(new_n43_), .b(new_n34_), .c(x00), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n53_), .c(new_n51_), .O(new_n182_));
  oai22  g149(.a(new_n182_), .b(new_n50_), .c(new_n180_), .d(x03), .O(new_n183_));
  oai21  g150(.a(x20), .b(new_n41_), .c(x06), .O(new_n184_));
  nand2  g151(.a(new_n47_), .b(x03), .O(new_n185_));
  oai21  g152(.a(x10), .b(new_n47_), .c(new_n185_), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(x21), .c(new_n34_), .O(new_n187_));
  nand4  g154(.a(new_n128_), .b(x15), .c(x13), .d(x05), .O(new_n188_));
  aoi21  g155(.a(new_n188_), .b(new_n187_), .c(x24), .O(new_n189_));
  nand3  g156(.a(new_n88_), .b(x24), .c(x18), .O(new_n190_));
  aoi21  g157(.a(new_n190_), .b(new_n133_), .c(new_n37_), .O(new_n191_));
  or2    g158(.a(new_n191_), .b(new_n189_), .O(new_n192_));
  nand3  g159(.a(new_n192_), .b(new_n184_), .c(x11), .O(new_n193_));
  inv1   g160(.a(new_n135_), .O(new_n194_));
  oai21  g161(.a(new_n137_), .b(x03), .c(new_n35_), .O(new_n195_));
  aoi22  g162(.a(new_n195_), .b(new_n34_), .c(new_n194_), .d(new_n37_), .O(new_n196_));
  nand3  g163(.a(new_n196_), .b(new_n193_), .c(new_n183_), .O(z6));
endmodule
