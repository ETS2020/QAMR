...
module FAU ( 
  ...
  nand2  g074(.a(new_n41_), .b(x21), .O(new_n108_));
  ...
  nand3  g090(.a(x21), .b(new_n49_), .c(new_n37_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x20), .c(x14), .d(x11), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(new_n99_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(x06), .c(x03), .d(x01), .O(new_n128_));
  nand3  g095(.a(new_n49_), .b(new_n37_), .c(x00), .O(new_n129_));
  nand3  g096(.a(x19), .b(x13), .c(x05), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n61_), .c(new_n36_), .d(new_n35_), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(x08), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n34_), .c(new_n96_), .d(new_n95_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n128_), .c(x24), .O(new_n135_));
  nand4  g102(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n136_));
  nand2  g103(.a(new_n107_), .b(new_n84_), .O(new_n137_));
  nand4  g104(.a(x07), .b(new_n34_), .c(new_n96_), .d(new_n95_), .O(new_n138_));
  nand4  g105(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n99_), .O(new_n139_));
  ...
  nand3  g108(.a(new_n107_), .b(x20), .c(x15), .O(new_n142_));
  nand3  g109(.a(new_n69_), .b(new_n96_), .c(new_n95_), .O(new_n143_));
  ...
  oai21  g114(.a(new_n147_), .b(new_n135_), .c(new_n88_), .O(new_n148_));
  nand2  g115(.a(new_n145_), .b(new_n80_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n141_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x02), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n148_), .O(z3));
  ...
  oai21  g122(.a(new_n155_), .b(x16), .c(new_n99_), .O(new_n156_));
  nand4  g123(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n157_));
  ...
  oai21  g128(.a(new_n161_), .b(new_n89_), .c(x08), .O(new_n162_));
  nor2   g129(.a(x10), .b(x02), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n109_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n117_), .c(new_n116_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n115_), .c(new_n162_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n159_), .c(new_n38_), .O(z4));
  nor2   g134(.a(new_n47_), .b(new_n43_), .O(new_n168_));
  nand3  g135(.a(new_n41_), .b(new_n49_), .c(x00), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n88_), .O(new_n170_));
  ...
  oai21  g141(.a(new_n174_), .b(x11), .c(new_n96_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  aoi21  g143(.a(new_n61_), .b(x14), .c(new_n34_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n35_), .c(x03), .O(new_n178_));
  inv1   g145(.a(new_n38_), .O(new_n179_));
  nand3  g146(.a(new_n163_), .b(new_n109_), .c(new_n88_), .O(new_n180_));
  oai21  g147(.a(new_n119_), .b(new_n179_), .c(new_n180_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n178_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n176_), .O(z6));
  aoi21  g150(.a(new_n109_), .b(new_n49_), .c(x12), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(x02), .c(new_n119_), .O(z7));
endmodule
