...
module FAU ( 
  ...
  nor2   g060(.a(x03), .b(new_n93_), .O(new_n94_));
  nor2   g061(.a(x06), .b(x04), .O(new_n95_));
  nor2   g062(.a(x11), .b(x10), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n85_), .O(new_n97_));
  nor2   g064(.a(x24), .b(x23), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n71_), .c(new_n79_), .d(new_n38_), .O(new_n99_));
  oai21  g066(.a(new_n99_), .b(new_n97_), .c(new_n34_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n92_), .O(new_n101_));
  nand4  g068(.a(x04), .b(x03), .c(new_n34_), .d(x01), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(new_n103_));
  inv1   g070(.a(x08), .O(new_n104_));
  nand3  g071(.a(x11), .b(new_n45_), .c(x09), .O(new_n105_));
  nor3   g072(.a(new_n105_), .b(new_n104_), .c(new_n36_), .O(new_n106_));
  nand2  g073(.a(x21), .b(x20), .O(new_n107_));
  nor4   g074(.a(new_n107_), .b(x24), .c(new_n80_), .d(new_n79_), .O(new_n108_));
  nand4  g075(.a(new_n108_), .b(new_n106_), .c(new_n103_), .d(new_n83_), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(new_n101_), .c(new_n91_), .d(new_n78_), .O(z1));
  ...
  nand2  g087(.a(x02), .b(new_n92_), .O(new_n121_));
  oai21  g088(.a(new_n120_), .b(new_n92_), .c(new_n121_), .O(z2));
  nor2   g089(.a(new_n104_), .b(new_n36_), .O(new_n123_));
  ...
  nand3  g093(.a(new_n64_), .b(new_n35_), .c(new_n92_), .O(new_n127_));
  ...
  nand3  g097(.a(new_n125_), .b(x20), .c(x18), .O(new_n131_));
  nand4  g098(.a(x07), .b(new_n36_), .c(new_n35_), .d(new_n92_), .O(new_n132_));
  nand4  g099(.a(new_n38_), .b(new_n67_), .c(new_n37_), .d(new_n104_), .O(new_n133_));
  ...
  nand2  g102(.a(new_n94_), .b(new_n64_), .O(new_n136_));
  nand4  g103(.a(new_n96_), .b(new_n41_), .c(new_n38_), .d(new_n67_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n136_), .c(new_n34_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n92_), .O(new_n139_));
  nor2   g106(.a(x02), .b(new_n92_), .O(new_n140_));
  ...
  aoi21  g114(.a(new_n147_), .b(new_n79_), .c(x09), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n104_), .O(new_n149_));
  nand2  g116(.a(new_n48_), .b(new_n44_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n43_), .c(new_n121_), .O(new_n151_));
  nand4  g118(.a(new_n41_), .b(new_n45_), .c(new_n34_), .d(x00), .O(new_n152_));
  ...
  nand2  g124(.a(new_n115_), .b(new_n114_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n113_), .c(new_n121_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n116_), .O(z7));
  nand2  g127(.a(z7), .b(new_n157_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n154_), .O(z4));
  inv1   g129(.a(new_n43_), .O(new_n163_));
  and2   g130(.a(new_n152_), .b(new_n48_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n121_), .c(new_n44_), .d(new_n163_), .O(z5));
  aoi21  g132(.a(x20), .b(new_n67_), .c(x06), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(x11), .c(new_n35_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n153_), .O(new_n168_));
  aoi21  g135(.a(new_n38_), .b(x14), .c(new_n36_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n37_), .c(x03), .O(new_n170_));
