...
module FAU ( 
  ...
  nor2   g047(.a(new_n37_), .b(new_n80_), .O(new_n81_));
  nand3  g048(.a(new_n81_), .b(x23), .c(x22), .O(new_n82_));
  inv1   g049(.a(new_n82_), .O(new_n83_));
  nand4  g050(.a(new_n83_), .b(new_n79_), .c(new_n58_), .d(new_n55_), .O(new_n84_));
  ...
  nand4  g061(.a(new_n94_), .b(new_n71_), .c(new_n37_), .d(new_n89_), .O(new_n95_));
  oai21  g062(.a(new_n95_), .b(new_n88_), .c(new_n84_), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(new_n74_), .c(x24), .O(new_n97_));
  inv1   g064(.a(x00), .O(new_n98_));
  nor2   g065(.a(x01), .b(new_n98_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n34_), .c(new_n44_), .O(new_n100_));
  inv1   g067(.a(new_n100_), .O(new_n101_));
  nand3  g068(.a(new_n45_), .b(new_n63_), .c(new_n85_), .O(new_n102_));
  ...
  nand4  g074(.a(new_n107_), .b(new_n103_), .c(new_n101_), .d(new_n94_), .O(new_n108_));
  ...
  oai21  g080(.a(new_n110_), .b(new_n47_), .c(new_n113_), .O(new_n114_));
  ...
  aoi21  g084(.a(new_n117_), .b(x10), .c(new_n37_), .O(z2));
  nand4  g085(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n119_));
  nand3  g086(.a(x20), .b(x15), .c(x14), .O(new_n120_));
  nor4   g087(.a(new_n120_), .b(new_n119_), .c(new_n36_), .d(new_n45_), .O(new_n121_));
  nor2   g088(.a(x03), .b(x01), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n65_), .O(new_n123_));
  nand3  g090(.a(new_n70_), .b(new_n91_), .c(new_n36_), .O(new_n124_));
  nor2   g091(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n121_), .c(new_n76_), .O(new_n126_));
  nand3  g093(.a(new_n81_), .b(new_n56_), .c(x14), .O(new_n127_));
  nor2   g094(.a(x11), .b(x08), .O(new_n128_));
  nor2   g095(.a(x20), .b(x14), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n128_), .c(new_n122_), .d(new_n87_), .O(new_n130_));
  oai21  g097(.a(new_n127_), .b(new_n119_), .c(new_n130_), .O(new_n131_));
  ...
  oai21  g105(.a(x23), .b(new_n138_), .c(new_n89_), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(new_n104_), .c(x09), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x16), .c(new_n85_), .O(new_n141_));
  ...
  oai21  g115(.a(new_n105_), .b(x04), .c(x17), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n63_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n92_), .c(x08), .O(new_n151_));
  oai21  g118(.a(new_n114_), .b(new_n112_), .c(new_n142_), .O(new_n152_));
  ...
  nor2   g127(.a(x20), .b(new_n91_), .O(new_n161_));
  aoi22  g128(.a(new_n161_), .b(x11), .c(new_n160_), .d(new_n142_), .O(new_n162_));
  nor2   g129(.a(new_n45_), .b(new_n86_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(x20), .c(new_n91_), .d(new_n36_), .O(new_n164_));
  oai21  g131(.a(new_n162_), .b(new_n80_), .c(new_n164_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n74_), .c(x24), .O(new_n166_));
  inv1   g133(.a(x15), .O(new_n167_));
  nor2   g134(.a(new_n162_), .b(new_n167_), .O(new_n168_));
  nand3  g135(.a(x20), .b(x19), .c(new_n91_), .O(new_n169_));
  nor3   g136(.a(new_n169_), .b(x11), .c(new_n45_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n168_), .c(new_n76_), .O(new_n171_));
  ...
  inv1   g144(.a(new_n112_), .O(new_n178_));
  nand3  g145(.a(new_n40_), .b(x21), .c(new_n44_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n37_), .O(new_n180_));
  aoi21  g147(.a(new_n180_), .b(new_n45_), .c(new_n114_), .O(new_n181_));
