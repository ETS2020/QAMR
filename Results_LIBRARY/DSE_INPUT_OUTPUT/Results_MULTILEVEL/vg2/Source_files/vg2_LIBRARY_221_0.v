...
module FAU ( 
  ...
  nor2   g03(.a(x22), .b(x08), .O(new_n37_));
  ...
  nor4   g42(.a(new_n75_), .b(new_n37_), .c(new_n74_), .d(new_n57_), .O(new_n76_));
  nand4  g43(.a(new_n76_), .b(x11), .c(x06), .d(x03), .O(new_n77_));
  nor2   g44(.a(new_n77_), .b(new_n54_), .O(z2));
  ...
  nand3  g74(.a(x22), .b(new_n107_), .c(x09), .O(new_n108_));
  nand2  g75(.a(new_n108_), .b(new_n56_), .O(new_n109_));
  nand2  g76(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  inv1   g77(.a(x04), .O(new_n111_));
  inv1   g78(.a(x17), .O(new_n112_));
  aoi21  g79(.a(x23), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  oai22  g80(.a(new_n113_), .b(new_n58_), .c(x09), .d(new_n56_), .O(new_n114_));
  aoi22  g81(.a(new_n114_), .b(x16), .c(x22), .d(new_n56_), .O(new_n115_));
  oai21  g82(.a(new_n115_), .b(new_n75_), .c(new_n110_), .O(z4));
  inv1   g83(.a(new_n42_), .O(new_n117_));
  and2   g84(.a(new_n46_), .b(new_n43_), .O(new_n118_));
  nand4  g85(.a(new_n118_), .b(new_n48_), .c(new_n117_), .d(new_n55_), .O(z5));
  nand2  g86(.a(x20), .b(new_n57_), .O(new_n120_));
  aoi21  g87(.a(new_n120_), .b(new_n35_), .c(x11), .O(new_n121_));
  oai21  g88(.a(new_n121_), .b(x03), .c(new_n106_), .O(new_n122_));
  nand2  g89(.a(new_n74_), .b(x14), .O(new_n123_));
  aoi21  g90(.a(new_n123_), .b(x06), .c(new_n36_), .O(new_n124_));
  oai22  g91(.a(new_n124_), .b(new_n34_), .c(new_n65_), .d(new_n61_), .O(new_n125_));
  aoi21  g92(.a(new_n125_), .b(new_n122_), .c(new_n37_), .O(z6));
  inv1   g93(.a(new_n61_), .O(new_n127_));
  and2   g94(.a(new_n63_), .b(new_n62_), .O(new_n128_));
  nand4  g95(.a(new_n128_), .b(new_n64_), .c(new_n127_), .d(new_n55_), .O(z7));
endmodule
