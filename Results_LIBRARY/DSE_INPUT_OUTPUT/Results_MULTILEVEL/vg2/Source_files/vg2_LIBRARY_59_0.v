...
module FAU ( 
  ...
  oai21  g088(.a(new_n121_), .b(new_n118_), .c(x14), .O(new_n122_));
  ...
  nand2  g107(.a(new_n37_), .b(new_n95_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n49_), .O(new_n142_));
  nor2   g109(.a(x24), .b(new_n37_), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n98_), .c(new_n95_), .d(x00), .O(new_n144_));
  ...
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n64_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n147_), .c(x08), .O(new_n151_));
  nand2  g118(.a(new_n110_), .b(new_n109_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n108_), .c(new_n141_), .O(new_n153_));
  nand4  g120(.a(new_n119_), .b(x14), .c(new_n98_), .d(new_n95_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n153_), .O(z7));
  nand2  g122(.a(z7), .b(new_n151_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n146_), .O(z4));
  nand3  g124(.a(new_n40_), .b(new_n98_), .c(x00), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x14), .c(x02), .O(new_n159_));
  or2    g126(.a(new_n159_), .b(new_n49_), .O(z5));
  oai21  g127(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n161_));
  nand4  g128(.a(new_n40_), .b(new_n98_), .c(new_n95_), .d(x00), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  inv1   g131(.a(x18), .O(new_n165_));
  oai22  g132(.a(x20), .b(new_n37_), .c(x06), .d(new_n34_), .O(new_n166_));
  aoi22  g133(.a(new_n166_), .b(x11), .c(new_n141_), .d(new_n34_), .O(new_n167_));
  nand4  g134(.a(x20), .b(new_n37_), .c(new_n36_), .d(x07), .O(new_n168_));
  oai21  g135(.a(new_n167_), .b(new_n165_), .c(new_n168_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n78_), .c(x24), .O(new_n170_));
  inv1   g137(.a(x15), .O(new_n171_));
  nand4  g138(.a(x20), .b(x19), .c(new_n37_), .d(new_n36_), .O(new_n172_));
  oai21  g139(.a(new_n167_), .b(new_n171_), .c(new_n172_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n80_), .O(new_n174_));
  nand2  g141(.a(x20), .b(x06), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(x11), .c(x03), .O(new_n176_));
  oai21  g143(.a(new_n37_), .b(x03), .c(new_n176_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n40_), .c(x21), .d(new_n98_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(x14), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n95_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n174_), .c(new_n170_), .d(new_n164_), .O(z6));
endmodule
