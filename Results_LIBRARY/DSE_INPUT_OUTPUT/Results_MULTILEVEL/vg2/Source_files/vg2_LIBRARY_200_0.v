...
module FAU ( 
  ...
  nand4  g120(.a(new_n109_), .b(new_n106_), .c(new_n51_), .d(x01), .O(new_n154_));
  ...
  nand2  g126(.a(x20), .b(new_n97_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n35_), .c(x11), .O(new_n161_));
  nand3  g128(.a(new_n146_), .b(new_n51_), .c(x00), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n45_), .c(new_n43_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n42_), .c(new_n161_), .d(x03), .O(new_n164_));
  oai21  g131(.a(x20), .b(new_n97_), .c(x06), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(x11), .c(x03), .O(new_n166_));
  oai21  g133(.a(x03), .b(new_n105_), .c(new_n166_), .O(new_n167_));
  nand3  g134(.a(new_n109_), .b(new_n106_), .c(new_n51_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n117_), .c(new_n116_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n115_), .c(new_n167_), .O(new_n170_));
  nor2   g137(.a(new_n153_), .b(x03), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(x02), .c(new_n145_), .O(new_n172_));
