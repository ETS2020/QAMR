...
module FAU ( 
  ...
  nand2  g102(.a(new_n41_), .b(x21), .O(new_n136_));
  nand2  g103(.a(new_n118_), .b(new_n45_), .O(new_n137_));
  nor3   g104(.a(new_n137_), .b(new_n136_), .c(new_n38_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n134_), .c(new_n129_), .d(new_n123_), .O(z3));
  oai21  g107(.a(x23), .b(new_n68_), .c(new_n60_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n62_), .c(x09), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x16), .c(new_n126_), .O(new_n143_));
  nand2  g110(.a(new_n48_), .b(new_n44_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n43_), .c(new_n115_), .O(new_n145_));
  nand4  g112(.a(new_n41_), .b(new_n45_), .c(new_n34_), .d(x00), .O(new_n146_));
  ...
  oai21  g120(.a(new_n153_), .b(new_n107_), .c(new_n115_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n110_), .O(z7));
  nand2  g122(.a(z7), .b(new_n152_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n148_), .O(z4));
  nand2  g124(.a(x20), .b(new_n104_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n36_), .c(x11), .O(new_n159_));
  nand3  g126(.a(new_n146_), .b(new_n48_), .c(new_n44_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n43_), .c(new_n159_), .d(x03), .O(new_n161_));
  oai21  g128(.a(x20), .b(new_n104_), .c(x06), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(x11), .c(x03), .O(new_n163_));
  nand2  g130(.a(new_n115_), .b(new_n35_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n80_), .c(x18), .O(new_n166_));
  inv1   g133(.a(new_n166_), .O(new_n167_));
  nor3   g134(.a(new_n109_), .b(x03), .c(new_n67_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n167_), .c(x24), .O(new_n169_));
  nand2  g136(.a(x24), .b(new_n35_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n47_), .c(new_n39_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n81_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(x15), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n110_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n162_), .c(x11), .O(new_n175_));
  inv1   g142(.a(new_n115_), .O(new_n176_));
  oai21  g143(.a(new_n136_), .b(x10), .c(new_n109_), .O(new_n177_));
  ...
  aoi21  g149(.a(new_n182_), .b(new_n35_), .c(new_n176_), .O(new_n183_));
