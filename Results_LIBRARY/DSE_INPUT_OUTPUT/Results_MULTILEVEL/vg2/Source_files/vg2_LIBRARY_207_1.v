...
module FAU ( 
  ...
  nand3  g067(.a(new_n88_), .b(new_n66_), .c(new_n65_), .O(new_n101_));
  ...
  oai21  g077(.a(new_n110_), .b(new_n106_), .c(new_n55_), .O(new_n111_));
  ...
  nor3   g086(.a(new_n119_), .b(new_n76_), .c(new_n36_), .O(new_n120_));
  ...
  nand3  g092(.a(new_n59_), .b(new_n125_), .c(new_n105_), .O(new_n126_));
  nand3  g093(.a(new_n87_), .b(new_n36_), .c(new_n35_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n126_), .c(new_n124_), .d(new_n123_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n93_), .O(new_n129_));
  nand2  g096(.a(new_n107_), .b(new_n97_), .O(new_n130_));
  nand4  g097(.a(x07), .b(new_n34_), .c(new_n125_), .d(new_n105_), .O(new_n131_));
  inv1   g098(.a(x08), .O(new_n132_));
  nand4  g099(.a(new_n76_), .b(new_n36_), .c(new_n35_), .d(new_n132_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n131_), .c(new_n130_), .d(new_n123_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n91_), .c(x24), .O(new_n135_));
  nand3  g102(.a(new_n57_), .b(new_n34_), .c(new_n125_), .O(new_n136_));
  nand3  g103(.a(new_n107_), .b(x21), .c(x20), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n123_), .c(new_n136_), .d(new_n133_), .O(new_n138_));
  ...
  nand2  g109(.a(new_n88_), .b(x04), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n81_), .c(x16), .O(new_n144_));
  ...
  oai21  g114(.a(new_n144_), .b(x08), .c(new_n147_), .O(new_n148_));
  oai21  g115(.a(x22), .b(new_n81_), .c(x16), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(x08), .O(new_n150_));
  nand2  g117(.a(new_n115_), .b(x05), .O(new_n151_));
  nand3  g118(.a(new_n109_), .b(new_n49_), .c(new_n37_), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n117_), .c(new_n116_), .d(new_n151_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n148_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n55_), .O(new_n156_));
  oai21  g123(.a(new_n78_), .b(x04), .c(x09), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x16), .c(new_n132_), .O(new_n158_));
  nor2   g125(.a(new_n158_), .b(new_n119_), .O(new_n159_));
  nor2   g126(.a(new_n47_), .b(new_n43_), .O(new_n160_));
  oai21  g127(.a(x22), .b(new_n55_), .c(new_n81_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n63_), .c(x08), .O(new_n162_));
  nor2   g129(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n159_), .c(x02), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n156_), .O(z4));
  ...
  oai21  g135(.a(new_n168_), .b(x03), .c(new_n147_), .O(new_n169_));
  nand2  g136(.a(new_n76_), .b(x14), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(x06), .c(new_n35_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n125_), .c(new_n153_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n169_), .c(new_n38_), .O(z6));
  aoi21  g140(.a(new_n109_), .b(new_n49_), .c(x17), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(x02), .c(new_n119_), .O(z7));
endmodule
