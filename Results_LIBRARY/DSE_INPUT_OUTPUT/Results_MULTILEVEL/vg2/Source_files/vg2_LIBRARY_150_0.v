...
module FAU ( 
  ...
  nand4  g017(.a(new_n50_), .b(x09), .c(new_n37_), .d(x00), .O(new_n51_));
  ...
  nand4  g026(.a(new_n59_), .b(new_n57_), .c(new_n55_), .d(x08), .O(new_n60_));
  inv1   g027(.a(x17), .O(new_n61_));
  inv1   g028(.a(x20), .O(new_n62_));
  nor2   g029(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand3  g030(.a(new_n63_), .b(x16), .c(x14), .O(new_n64_));
  ...
  oai21  g035(.a(new_n68_), .b(new_n60_), .c(x09), .O(new_n69_));
  ...
  nor2   g045(.a(new_n66_), .b(new_n78_), .O(new_n79_));
  nand4  g046(.a(new_n79_), .b(new_n77_), .c(new_n75_), .d(new_n63_), .O(new_n80_));
  nor3   g047(.a(x04), .b(x03), .c(x01), .O(new_n81_));
  nor2   g048(.a(x08), .b(x06), .O(new_n82_));
  nand4  g049(.a(new_n82_), .b(new_n81_), .c(new_n35_), .d(new_n38_), .O(new_n83_));
  ...
  nand2  g057(.a(new_n46_), .b(new_n40_), .O(new_n91_));
  nand3  g058(.a(new_n42_), .b(x13), .c(x05), .O(new_n92_));
  ...
  nand4  g064(.a(new_n97_), .b(new_n96_), .c(new_n79_), .d(new_n75_), .O(new_n98_));
  nor2   g065(.a(x09), .b(x08), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n81_), .c(x07), .d(new_n34_), .O(new_n100_));
  inv1   g067(.a(x16), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n36_), .c(new_n58_), .d(new_n35_), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n88_), .c(new_n62_), .d(new_n61_), .O(new_n104_));
  oai21  g071(.a(new_n104_), .b(new_n100_), .c(new_n98_), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n91_), .c(x24), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n94_), .c(new_n70_), .O(z1));
  ...
  oai21  g080(.a(new_n113_), .b(new_n110_), .c(new_n39_), .O(new_n114_));
  nand3  g081(.a(new_n42_), .b(x21), .c(new_n55_), .O(new_n115_));
  inv1   g082(.a(new_n115_), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(x09), .c(new_n37_), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(new_n114_), .c(new_n62_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x14), .c(x11), .d(x06), .O(new_n119_));
  nor3   g086(.a(new_n119_), .b(new_n72_), .c(new_n71_), .O(z2));
  ...
  nand3  g090(.a(new_n82_), .b(new_n72_), .c(new_n71_), .O(new_n124_));
  nand3  g091(.a(new_n87_), .b(new_n36_), .c(new_n35_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n121_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n93_), .O(new_n127_));
  nand2  g094(.a(new_n122_), .b(new_n97_), .O(new_n128_));
  nand4  g095(.a(x07), .b(new_n34_), .c(new_n72_), .d(new_n71_), .O(new_n129_));
  inv1   g096(.a(x08), .O(new_n130_));
  nand4  g097(.a(new_n62_), .b(new_n36_), .c(new_n35_), .d(new_n130_), .O(new_n131_));
  ...
  nand4  g100(.a(new_n34_), .b(new_n72_), .c(new_n71_), .d(x00), .O(new_n134_));
  nand3  g101(.a(new_n122_), .b(x21), .c(x20), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n121_), .c(new_n134_), .d(new_n131_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n42_), .c(new_n55_), .O(new_n137_));
  ...
  nor2   g107(.a(new_n101_), .b(x08), .O(new_n141_));
  nand3  g108(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n47_), .c(new_n45_), .O(new_n143_));
  nor2   g110(.a(new_n143_), .b(new_n44_), .O(new_n144_));
  nand2  g111(.a(x23), .b(new_n73_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x17), .c(new_n78_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x16), .c(new_n130_), .O(new_n147_));
  nand4  g114(.a(new_n42_), .b(x21), .c(new_n55_), .d(new_n37_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n112_), .c(new_n111_), .O(new_n149_));
  nor2   g116(.a(new_n149_), .b(new_n110_), .O(new_n150_));
  oai22  g117(.a(new_n150_), .b(new_n147_), .c(new_n144_), .d(new_n141_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(x09), .O(new_n152_));
  nor2   g119(.a(new_n48_), .b(new_n44_), .O(new_n153_));
  oai21  g120(.a(x23), .b(new_n73_), .c(new_n61_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n78_), .c(new_n101_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n130_), .c(new_n153_), .O(new_n156_));
  nor2   g123(.a(new_n113_), .b(new_n110_), .O(new_n157_));
  aoi21  g124(.a(x16), .b(new_n38_), .c(new_n130_), .O(new_n158_));
  nor2   g125(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n156_), .c(x02), .O(new_n160_));
  ...
  oai22  g131(.a(new_n164_), .b(x03), .c(new_n143_), .d(new_n44_), .O(new_n165_));
  nand2  g132(.a(new_n62_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n35_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n72_), .c(new_n149_), .d(new_n110_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n39_), .O(z6));
  oai21  g136(.a(new_n116_), .b(new_n38_), .c(new_n37_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n157_), .O(z7));
endmodule
