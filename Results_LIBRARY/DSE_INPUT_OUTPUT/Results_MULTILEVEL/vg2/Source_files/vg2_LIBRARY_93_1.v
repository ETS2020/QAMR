...
module FAU ( 
  ...
  nand2  g102(.a(new_n46_), .b(new_n37_), .O(new_n136_));
  ...
  nor2   g117(.a(new_n150_), .b(new_n69_), .O(new_n151_));
  nor2   g118(.a(new_n151_), .b(new_n66_), .O(new_n152_));
  inv1   g119(.a(new_n49_), .O(new_n153_));
  nor2   g120(.a(new_n36_), .b(x06), .O(new_n154_));
  aoi21  g121(.a(new_n73_), .b(x04), .c(x17), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x22), .c(new_n67_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n69_), .c(new_n66_), .O(new_n157_));
  oai21  g124(.a(new_n154_), .b(new_n66_), .c(new_n157_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n153_), .c(new_n154_), .O(new_n159_));
  oai21  g126(.a(new_n152_), .b(new_n124_), .c(new_n159_), .O(z4));
  nor2   g127(.a(new_n154_), .b(new_n49_), .O(z5));
  nor2   g128(.a(x20), .b(new_n68_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x11), .c(new_n34_), .O(new_n163_));
  nand2  g130(.a(new_n36_), .b(x06), .O(new_n164_));
  nand3  g131(.a(x20), .b(new_n68_), .c(new_n35_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n164_), .c(new_n34_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n153_), .c(new_n154_), .O(new_n167_));
  oai21  g134(.a(new_n163_), .b(new_n124_), .c(new_n167_), .O(z6));
  inv1   g135(.a(new_n118_), .O(new_n169_));
  inv1   g136(.a(new_n154_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n122_), .c(new_n119_), .d(new_n169_), .O(z7));
endmodule
