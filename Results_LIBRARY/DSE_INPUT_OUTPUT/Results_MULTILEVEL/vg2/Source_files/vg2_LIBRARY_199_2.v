...
module FAU ( 
  ...
  nor2   g004(.a(x17), .b(new_n37_), .O(new_n38_));
  ...
  nand4  g026(.a(new_n59_), .b(x22), .c(x20), .d(x16), .O(new_n60_));
  nor3   g027(.a(new_n60_), .b(new_n55_), .c(new_n37_), .O(new_n61_));
  ...
  nand3  g036(.a(new_n46_), .b(new_n45_), .c(x00), .O(new_n70_));
  ...
  nand4  g041(.a(new_n74_), .b(new_n37_), .c(new_n36_), .d(new_n66_), .O(new_n75_));
  nor2   g042(.a(new_n75_), .b(x08), .O(new_n76_));
  nand4  g043(.a(new_n76_), .b(new_n35_), .c(new_n65_), .d(new_n34_), .O(new_n77_));
  oai21  g044(.a(new_n77_), .b(x01), .c(new_n64_), .O(new_n78_));
  nand2  g045(.a(new_n78_), .b(new_n41_), .O(new_n79_));
  inv1   g046(.a(new_n38_), .O(new_n80_));
  nand2  g047(.a(new_n48_), .b(new_n39_), .O(new_n81_));
  inv1   g048(.a(x01), .O(new_n82_));
  nand4  g049(.a(x11), .b(x09), .c(x08), .d(x06), .O(new_n83_));
  nor4   g050(.a(new_n83_), .b(new_n65_), .c(new_n34_), .d(new_n82_), .O(new_n84_));
  nand3  g051(.a(x16), .b(x14), .c(x12), .O(new_n85_));
  inv1   g052(.a(new_n85_), .O(new_n86_));
  inv1   g053(.a(x18), .O(new_n87_));
  nor2   g054(.a(new_n68_), .b(new_n87_), .O(new_n88_));
  nor2   g055(.a(new_n56_), .b(new_n69_), .O(new_n89_));
  ...
  nand4  g061(.a(new_n94_), .b(new_n55_), .c(new_n37_), .d(new_n36_), .O(new_n95_));
  ...
  nand3  g068(.a(new_n89_), .b(x20), .c(x16), .O(new_n102_));
  ...
  nand4  g072(.a(new_n105_), .b(new_n91_), .c(new_n36_), .d(new_n66_), .O(new_n106_));
  ...
  nand3  g079(.a(new_n112_), .b(new_n48_), .c(new_n39_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n100_), .c(new_n80_), .O(new_n114_));
  inv1   g081(.a(new_n114_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n79_), .O(z1));
  nor2   g083(.a(new_n41_), .b(new_n87_), .O(new_n117_));
  inv1   g084(.a(new_n117_), .O(new_n118_));
  nand3  g085(.a(new_n41_), .b(x15), .c(x13), .O(new_n119_));
  aoi21  g086(.a(new_n119_), .b(new_n118_), .c(new_n39_), .O(new_n120_));
  nand2  g087(.a(new_n117_), .b(x13), .O(new_n121_));
  nand3  g088(.a(x15), .b(new_n48_), .c(new_n39_), .O(new_n122_));
  nand4  g089(.a(new_n41_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(new_n124_));
  nor2   g091(.a(new_n124_), .b(new_n120_), .O(new_n125_));
  nor3   g092(.a(new_n125_), .b(new_n68_), .c(new_n55_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x11), .c(x06), .d(x03), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(new_n82_), .c(new_n80_), .O(z2));
  inv1   g095(.a(x08), .O(new_n129_));
  nand2  g096(.a(new_n58_), .b(new_n57_), .O(new_n130_));
  ...
  nand2  g100(.a(new_n71_), .b(new_n70_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n68_), .c(new_n55_), .d(new_n36_), .O(new_n135_));
  nor2   g102(.a(new_n135_), .b(x08), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n35_), .c(new_n34_), .d(new_n82_), .O(new_n137_));
  ...
  nand4  g108(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n82_), .O(new_n142_));
  nand4  g109(.a(new_n68_), .b(new_n55_), .c(new_n36_), .d(new_n129_), .O(new_n143_));
  ...
  nand3  g113(.a(new_n105_), .b(new_n34_), .c(new_n82_), .O(new_n147_));
  nand3  g114(.a(new_n110_), .b(new_n55_), .c(new_n36_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n140_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n48_), .c(new_n39_), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n145_), .c(new_n139_), .d(new_n80_), .O(z3));
  inv1   g118(.a(new_n51_), .O(new_n152_));
  oai21  g119(.a(x23), .b(new_n65_), .c(new_n67_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n69_), .c(x09), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x16), .c(new_n129_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  inv1   g123(.a(new_n125_), .O(new_n157_));
  oai21  g124(.a(new_n56_), .b(x04), .c(x17), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x22), .c(new_n66_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n94_), .c(x08), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n156_), .c(new_n80_), .O(z4));
  inv1   g129(.a(new_n43_), .O(new_n163_));
  and2   g130(.a(new_n47_), .b(new_n44_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n49_), .c(new_n163_), .d(new_n80_), .O(z5));
  ...
  nand3  g136(.a(new_n169_), .b(x11), .c(x03), .O(new_n170_));
  oai21  g137(.a(new_n38_), .b(x03), .c(new_n170_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n157_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n168_), .c(new_n80_), .O(z6));
  nor2   g140(.a(new_n125_), .b(new_n38_), .O(z7));
endmodule
