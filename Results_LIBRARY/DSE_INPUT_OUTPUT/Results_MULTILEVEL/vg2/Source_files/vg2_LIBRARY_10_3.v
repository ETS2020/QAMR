...
module FAU ( 
  ...
  nor2   g067(.a(x12), .b(new_n36_), .O(new_n101_));
  ...
  nand3  g072(.a(new_n105_), .b(x07), .c(new_n35_), .O(new_n106_));
  nand4  g073(.a(new_n61_), .b(new_n53_), .c(new_n36_), .d(new_n83_), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n106_), .c(new_n104_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n98_), .c(x24), .O(new_n109_));
  ...
  nand3  g079(.a(new_n105_), .b(new_n83_), .c(new_n35_), .O(new_n113_));
  nand4  g080(.a(new_n61_), .b(x19), .c(new_n53_), .d(new_n36_), .O(new_n114_));
  oai21  g081(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n46_), .c(new_n37_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n109_), .c(new_n97_), .d(new_n55_), .O(z3));
  inv1   g084(.a(new_n49_), .O(new_n118_));
  inv1   g085(.a(x22), .O(new_n119_));
  oai21  g086(.a(x23), .b(new_n57_), .c(new_n60_), .O(new_n120_));
  ...
  oai21  g091(.a(new_n62_), .b(x04), .c(x17), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(x22), .c(new_n58_), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n59_), .c(x08), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(new_n123_), .c(new_n54_), .O(z4));
  inv1   g096(.a(new_n41_), .O(new_n130_));
  and2   g097(.a(new_n45_), .b(new_n42_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n55_), .c(new_n47_), .d(new_n130_), .O(z5));
  nand2  g099(.a(x20), .b(new_n53_), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(new_n35_), .c(x11), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(x03), .c(new_n118_), .O(new_n135_));
  oai21  g102(.a(x20), .b(new_n53_), .c(x06), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(x11), .c(x03), .O(new_n137_));
  oai21  g104(.a(new_n54_), .b(x03), .c(new_n137_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n124_), .c(new_n54_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n135_), .O(z6));
  nor2   g107(.a(new_n79_), .b(new_n54_), .O(z7));
endmodule
