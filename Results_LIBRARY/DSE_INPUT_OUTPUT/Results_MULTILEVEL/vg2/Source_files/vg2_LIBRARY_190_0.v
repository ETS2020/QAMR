...
module FAU ( 
  ...
  nand4  g045(.a(new_n57_), .b(new_n34_), .c(x02), .d(new_n55_), .O(new_n79_));
  ...
  oai21  g055(.a(new_n88_), .b(new_n82_), .c(new_n78_), .O(new_n89_));
  ...
  nand4  g069(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n87_), .O(new_n103_));
  ...
  nand3  g074(.a(new_n56_), .b(new_n107_), .c(x06), .O(new_n108_));
  inv1   g075(.a(x21), .O(new_n109_));
  nor2   g076(.a(x24), .b(new_n109_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(x20), .c(x11), .O(new_n111_));
  oai21  g078(.a(new_n111_), .b(new_n108_), .c(x14), .O(new_n112_));
  ...
  nand3  g090(.a(new_n56_), .b(x08), .c(x06), .O(new_n124_));
  nand3  g091(.a(new_n110_), .b(new_n62_), .c(x20), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n124_), .c(x14), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n54_), .O(new_n127_));
  nand4  g094(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n128_));
  nand3  g095(.a(new_n81_), .b(new_n34_), .c(new_n55_), .O(new_n129_));
  nand3  g096(.a(new_n86_), .b(new_n37_), .c(new_n36_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n124_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n92_), .O(new_n132_));
  nand4  g099(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n133_));
  nand4  g100(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n55_), .O(new_n134_));
  nand4  g101(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n59_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n124_), .O(new_n136_));
  ...
  oai21  g109(.a(new_n142_), .b(x16), .c(new_n59_), .O(new_n143_));
  inv1   g110(.a(new_n49_), .O(new_n144_));
  nor2   g111(.a(x14), .b(x02), .O(new_n145_));
  nor2   g112(.a(x24), .b(new_n37_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n107_), .c(new_n54_), .d(x00), .O(new_n147_));
  ...
  aoi21  g118(.a(new_n151_), .b(x22), .c(new_n60_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n150_), .c(x08), .O(new_n153_));
  nand4  g120(.a(new_n110_), .b(x14), .c(new_n107_), .d(new_n54_), .O(new_n154_));
  oai21  g121(.a(new_n145_), .b(new_n120_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n149_), .O(z4));
  nand3  g124(.a(new_n40_), .b(new_n107_), .c(x00), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x14), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n54_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n144_), .O(z5));
  oai21  g128(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n162_));
  nand4  g129(.a(new_n40_), .b(new_n107_), .c(new_n54_), .d(x00), .O(new_n163_));
  ...
  nand4  g135(.a(x20), .b(new_n37_), .c(new_n36_), .d(x07), .O(new_n169_));
  oai21  g136(.a(new_n168_), .b(new_n166_), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n90_), .c(x24), .O(new_n171_));
  inv1   g138(.a(x15), .O(new_n172_));
  nand4  g139(.a(x20), .b(x19), .c(new_n37_), .d(new_n36_), .O(new_n173_));
  oai21  g140(.a(new_n168_), .b(new_n172_), .c(new_n173_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n92_), .O(new_n175_));
  oai21  g142(.a(new_n38_), .b(new_n35_), .c(x11), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(x03), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n40_), .c(x21), .d(new_n107_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(x14), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n54_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n175_), .c(new_n171_), .d(new_n165_), .O(z6));
  aoi21  g148(.a(new_n110_), .b(new_n107_), .c(new_n37_), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(x02), .c(new_n120_), .O(z7));
endmodule
