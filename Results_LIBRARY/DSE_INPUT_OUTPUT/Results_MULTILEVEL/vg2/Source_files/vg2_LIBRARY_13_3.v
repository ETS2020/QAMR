...
module FAU ( 
  ...
  nand4  g084(.a(x11), .b(x06), .c(x03), .d(x01), .O(new_n118_));
  nand4  g085(.a(x24), .b(x20), .c(x18), .d(x14), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n118_), .c(new_n42_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(x05), .O(new_n121_));
  inv1   g088(.a(x13), .O(new_n122_));
  nand2  g089(.a(x15), .b(new_n122_), .O(new_n123_));
  nand3  g090(.a(x24), .b(x18), .c(x13), .O(new_n124_));
  nand4  g091(.a(new_n37_), .b(x21), .c(new_n39_), .d(new_n38_), .O(new_n125_));
  ...
  nand2  g096(.a(new_n129_), .b(new_n121_), .O(z2));
  inv1   g097(.a(x01), .O(new_n131_));
  ...
  nand4  g102(.a(new_n135_), .b(new_n86_), .c(new_n36_), .d(new_n35_), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(x08), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n34_), .c(new_n132_), .d(new_n131_), .O(new_n138_));
  nor2   g105(.a(new_n107_), .b(new_n34_), .O(new_n139_));
  nor2   g106(.a(x02), .b(new_n131_), .O(new_n140_));
  nand2  g107(.a(new_n61_), .b(x14), .O(new_n141_));
  nor3   g108(.a(new_n141_), .b(new_n35_), .c(x10), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n140_), .c(new_n139_), .d(x03), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n138_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n37_), .O(new_n145_));
  nand2  g112(.a(new_n122_), .b(new_n46_), .O(new_n146_));
  nand3  g113(.a(new_n139_), .b(x03), .c(x01), .O(new_n147_));
  ...
  aoi21  g131(.a(x15), .b(x05), .c(x24), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(x21), .c(new_n39_), .d(new_n38_), .O(new_n166_));
  nand2  g133(.a(new_n124_), .b(new_n123_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n46_), .O(new_n168_));
  nand3  g135(.a(new_n92_), .b(x24), .c(x18), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(z7));
  nand2  g137(.a(z7), .b(new_n164_), .O(new_n171_));
  nand2  g138(.a(new_n52_), .b(new_n45_), .O(z5));
  oai21  g139(.a(x23), .b(new_n77_), .c(new_n104_), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(new_n62_), .c(x09), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(x16), .c(new_n107_), .O(new_n175_));
  ...
  nand2  g146(.a(x24), .b(x07), .O(new_n180_));
  nand3  g147(.a(new_n37_), .b(x19), .c(x13), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(new_n180_), .c(new_n46_), .O(new_n182_));
  nand4  g149(.a(new_n37_), .b(new_n39_), .c(new_n38_), .d(x00), .O(new_n183_));
  nand3  g150(.a(x19), .b(new_n122_), .c(new_n46_), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n183_), .c(new_n48_), .O(new_n185_));
  oai22  g152(.a(new_n185_), .b(new_n182_), .c(new_n179_), .d(x03), .O(new_n186_));
  ...
  nand3  g156(.a(new_n189_), .b(new_n186_), .c(new_n40_), .O(z6));
endmodule
