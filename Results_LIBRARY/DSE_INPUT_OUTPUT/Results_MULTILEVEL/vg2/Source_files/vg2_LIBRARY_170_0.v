...
module FAU ( 
  ...
  nand2  g113(.a(new_n146_), .b(new_n50_), .O(new_n147_));
  ...
  nand2  g117(.a(z5), .b(new_n144_), .O(new_n151_));
  ...
  oai21  g122(.a(new_n155_), .b(new_n111_), .c(new_n146_), .O(new_n156_));
  nand3  g123(.a(new_n133_), .b(new_n136_), .c(new_n114_), .O(new_n157_));
