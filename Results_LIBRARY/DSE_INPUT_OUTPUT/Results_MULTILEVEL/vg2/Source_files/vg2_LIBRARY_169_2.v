...
module FAU ( 
  ...
  nand2  g122(.a(new_n155_), .b(new_n113_), .O(new_n156_));
  inv1   g123(.a(x10), .O(new_n157_));
  nor2   g124(.a(x02), .b(x01), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n40_), .c(x21), .d(new_n157_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(z7));
  nand2  g127(.a(z7), .b(new_n154_), .O(new_n161_));
  ...
  nand2  g131(.a(x20), .b(new_n62_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n35_), .c(x11), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n167_));
  oai21  g134(.a(x20), .b(new_n62_), .c(x06), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(x11), .c(x03), .O(new_n169_));
  inv1   g136(.a(new_n169_), .O(new_n170_));
  nand4  g137(.a(new_n40_), .b(x21), .c(new_n157_), .d(new_n44_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n111_), .c(new_n110_), .d(new_n109_), .O(new_n172_));
  oai21  g139(.a(new_n170_), .b(new_n122_), .c(new_n172_), .O(new_n173_));
  nand3  g140(.a(new_n113_), .b(new_n34_), .c(x02), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n173_), .c(new_n167_), .d(new_n155_), .O(z6));
endmodule
