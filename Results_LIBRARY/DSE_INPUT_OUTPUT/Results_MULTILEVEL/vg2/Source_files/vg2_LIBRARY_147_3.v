...
module FAU ( 
  ...
  inv1   g141(.a(new_n120_), .O(new_n175_));
  and2   g142(.a(new_n163_), .b(new_n122_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n121_), .c(new_n175_), .O(new_n177_));
  oai21  g144(.a(new_n174_), .b(new_n34_), .c(new_n177_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n172_), .c(new_n153_), .O(z6));
  nand4  g146(.a(new_n176_), .b(new_n153_), .c(new_n121_), .d(new_n175_), .O(z7));
endmodule
