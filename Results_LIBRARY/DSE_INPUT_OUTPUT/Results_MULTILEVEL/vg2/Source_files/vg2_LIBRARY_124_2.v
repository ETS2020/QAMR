...
module FAU ( 
  ...
  nor2   g113(.a(new_n54_), .b(new_n50_), .O(new_n147_));
  nor2   g114(.a(x02), .b(new_n35_), .O(new_n148_));
  nor2   g115(.a(x24), .b(x10), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n101_), .c(new_n34_), .O(new_n150_));
  ...
  oai21  g121(.a(new_n154_), .b(new_n94_), .c(x08), .O(new_n155_));
  inv1   g122(.a(new_n117_), .O(new_n156_));
  nand3  g123(.a(new_n43_), .b(x21), .c(new_n38_), .O(new_n157_));
  inv1   g124(.a(new_n157_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n34_), .c(new_n35_), .O(new_n159_));
  oai21  g126(.a(new_n148_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n155_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n152_), .O(z4));
  aoi21  g129(.a(new_n149_), .b(x00), .c(x01), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x02), .c(new_n147_), .O(z5));
  inv1   g131(.a(new_n148_), .O(new_n165_));
  nand2  g132(.a(x20), .b(new_n41_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n37_), .c(x11), .O(new_n167_));
  nand3  g134(.a(new_n149_), .b(new_n34_), .c(x00), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n53_), .c(new_n51_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n50_), .c(new_n167_), .d(x03), .O(new_n170_));
  nand2  g137(.a(new_n42_), .b(x14), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(x06), .c(new_n40_), .O(new_n172_));
  nand4  g139(.a(new_n43_), .b(x21), .c(new_n38_), .d(new_n34_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n115_), .c(new_n114_), .d(new_n113_), .O(new_n174_));
  oai21  g141(.a(new_n172_), .b(new_n36_), .c(new_n174_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n170_), .c(new_n165_), .O(z6));
  oai21  g143(.a(new_n158_), .b(x01), .c(new_n34_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n156_), .O(z7));
endmodule
