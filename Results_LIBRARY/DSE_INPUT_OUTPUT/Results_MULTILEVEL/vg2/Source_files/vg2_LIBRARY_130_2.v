...
module FAU ( 
  ...
  nand3  g020(.a(new_n53_), .b(new_n52_), .c(new_n45_), .O(new_n54_));
  ...
  oai21  g048(.a(new_n80_), .b(x02), .c(new_n81_), .O(new_n82_));
  ...
  nand2  g076(.a(x13), .b(x02), .O(new_n110_));
  nand4  g077(.a(new_n110_), .b(new_n42_), .c(x21), .d(new_n49_), .O(new_n111_));
  ...
  oai22  g084(.a(new_n117_), .b(new_n34_), .c(x13), .d(new_n40_), .O(z2));
  nand4  g085(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(x00), .O(new_n119_));
  inv1   g086(.a(x08), .O(new_n120_));
  nand4  g087(.a(new_n39_), .b(new_n38_), .c(new_n37_), .d(new_n120_), .O(new_n121_));
  nand4  g088(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n122_));
  inv1   g089(.a(new_n122_), .O(new_n123_));
  nor2   g090(.a(new_n38_), .b(new_n37_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n123_), .c(new_n99_), .O(new_n125_));
  oai21  g092(.a(new_n121_), .b(new_n119_), .c(new_n125_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n110_), .c(new_n49_), .O(new_n127_));
  nand3  g094(.a(new_n124_), .b(x20), .c(x15), .O(new_n128_));
  nand2  g095(.a(new_n101_), .b(new_n71_), .O(new_n129_));
  nand3  g096(.a(new_n76_), .b(new_n38_), .c(new_n37_), .O(new_n130_));
  ...
  nand3  g101(.a(new_n124_), .b(new_n123_), .c(new_n88_), .O(new_n135_));
  nand3  g102(.a(new_n101_), .b(x07), .c(new_n36_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(new_n121_), .c(new_n135_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n80_), .c(x24), .O(new_n138_));
  and2   g105(.a(new_n131_), .b(new_n46_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x02), .c(new_n47_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n138_), .c(new_n134_), .O(z3));
  inv1   g108(.a(x00), .O(new_n142_));
  inv1   g109(.a(x17), .O(new_n143_));
  aoi21  g110(.a(x23), .b(new_n59_), .c(new_n143_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n63_), .c(x09), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x16), .c(new_n120_), .O(new_n146_));
  inv1   g113(.a(x16), .O(new_n147_));
  aoi21  g114(.a(new_n64_), .b(x04), .c(x17), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x22), .c(new_n69_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n147_), .c(x08), .O(new_n150_));
  oai22  g117(.a(new_n150_), .b(new_n142_), .c(new_n146_), .d(new_n98_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n110_), .c(new_n49_), .O(new_n152_));
  inv1   g119(.a(x15), .O(new_n153_));
  oai22  g120(.a(new_n150_), .b(new_n75_), .c(new_n146_), .d(new_n153_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(x13), .c(x05), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n42_), .O(new_n157_));
  inv1   g124(.a(x07), .O(new_n158_));
  oai22  g125(.a(new_n150_), .b(new_n158_), .c(new_n146_), .d(new_n87_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n80_), .c(x24), .O(new_n160_));
  nand2  g127(.a(new_n145_), .b(x16), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(x08), .O(new_n162_));
  nand2  g129(.a(new_n149_), .b(new_n147_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n120_), .O(new_n164_));
  aoi22  g131(.a(new_n164_), .b(x19), .c(new_n162_), .d(x15), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x05), .c(new_n40_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n47_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n160_), .c(new_n157_), .O(z4));
  nand3  g135(.a(new_n110_), .b(new_n49_), .c(x00), .O(new_n169_));
  nand3  g136(.a(x19), .b(x13), .c(x05), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n42_), .O(new_n172_));
  nand3  g139(.a(new_n80_), .b(x24), .c(x07), .O(new_n173_));
  oai21  g140(.a(new_n75_), .b(x05), .c(new_n40_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n47_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n173_), .c(new_n172_), .O(z5));
  oai21  g143(.a(x20), .b(new_n38_), .c(x06), .O(new_n177_));
  nand2  g144(.a(x21), .b(new_n49_), .O(new_n178_));
  aoi21  g145(.a(new_n178_), .b(new_n112_), .c(x02), .O(new_n179_));
  nand3  g146(.a(x15), .b(x13), .c(x05), .O(new_n180_));
  inv1   g147(.a(new_n180_), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(new_n179_), .c(new_n42_), .O(new_n182_));
  nand2  g149(.a(x18), .b(x05), .O(new_n183_));
  aoi21  g150(.a(new_n183_), .b(new_n112_), .c(new_n35_), .O(new_n184_));
  nor2   g151(.a(new_n87_), .b(new_n47_), .O(new_n185_));
  oai21  g152(.a(new_n185_), .b(new_n184_), .c(x24), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n182_), .O(new_n187_));
  nand3  g154(.a(new_n187_), .b(new_n177_), .c(x11), .O(new_n188_));
  oai21  g155(.a(new_n107_), .b(x02), .c(new_n108_), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(x05), .O(new_n190_));
  nand3  g157(.a(new_n42_), .b(x21), .c(new_n49_), .O(new_n191_));
  nand2  g158(.a(new_n191_), .b(new_n112_), .O(new_n192_));
  nand2  g159(.a(new_n192_), .b(new_n40_), .O(new_n193_));
  nand3  g160(.a(new_n193_), .b(new_n190_), .c(new_n113_), .O(z7));
  nand2  g161(.a(z7), .b(new_n35_), .O(new_n195_));
  aoi21  g162(.a(x20), .b(new_n38_), .c(x06), .O(new_n196_));
  oai21  g163(.a(new_n196_), .b(x11), .c(new_n35_), .O(new_n197_));
  nand3  g164(.a(new_n173_), .b(new_n172_), .c(new_n48_), .O(new_n198_));
  aoi22  g165(.a(new_n198_), .b(new_n197_), .c(new_n47_), .d(x02), .O(new_n199_));
  nand3  g166(.a(new_n199_), .b(new_n195_), .c(new_n188_), .O(z6));
endmodule
