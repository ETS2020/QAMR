...
module FAU ( 
  ...
  nor2   g108(.a(x02), .b(new_n54_), .O(new_n142_));
  nand2  g109(.a(new_n48_), .b(new_n43_), .O(new_n143_));
  nor2   g110(.a(new_n143_), .b(new_n42_), .O(new_n144_));
  nand3  g111(.a(new_n56_), .b(new_n45_), .c(new_n44_), .O(new_n145_));
  oai21  g112(.a(new_n144_), .b(new_n142_), .c(new_n145_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n141_), .O(new_n147_));
  inv1   g114(.a(x23), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x04), .c(x17), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n79_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n63_), .c(x08), .O(new_n151_));
  nor2   g118(.a(new_n110_), .b(new_n108_), .O(new_n152_));
  inv1   g119(.a(x10), .O(new_n153_));
  nand3  g120(.a(new_n40_), .b(x21), .c(new_n153_), .O(new_n154_));
  inv1   g121(.a(new_n154_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n44_), .c(new_n54_), .O(new_n156_));
  oai21  g123(.a(new_n142_), .b(new_n152_), .c(new_n156_), .O(new_n157_));
  ...
  oai21  g135(.a(new_n155_), .b(x01), .c(new_n44_), .O(new_n169_));
