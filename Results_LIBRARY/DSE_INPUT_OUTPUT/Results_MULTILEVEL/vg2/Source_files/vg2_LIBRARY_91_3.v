...
module FAU ( 
  ...
  nand3  g060(.a(new_n76_), .b(new_n37_), .c(new_n61_), .O(new_n94_));
  ...
  nand4  g067(.a(new_n100_), .b(new_n86_), .c(new_n65_), .d(new_n58_), .O(new_n101_));
  ...
  oai21  g073(.a(new_n98_), .b(new_n55_), .c(new_n106_), .O(z1));
  ...
  oai21  g081(.a(new_n114_), .b(new_n111_), .c(new_n53_), .O(new_n115_));
  nand4  g082(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n116_));
  ...
  nand4  g090(.a(new_n37_), .b(x19), .c(new_n73_), .d(new_n36_), .O(new_n124_));
  ...
  nand4  g095(.a(new_n37_), .b(new_n73_), .c(new_n36_), .d(new_n68_), .O(new_n129_));
  ...
  nand2  g099(.a(new_n132_), .b(new_n53_), .O(new_n133_));
  ...
  oai21  g115(.a(new_n148_), .b(new_n74_), .c(x08), .O(new_n149_));
  ...
  nand3  g120(.a(new_n153_), .b(new_n146_), .c(new_n53_), .O(z4));
  and2   g121(.a(new_n53_), .b(new_n43_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n48_), .c(new_n46_), .d(new_n139_), .O(z5));
  nand2  g123(.a(x20), .b(new_n73_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n35_), .c(x11), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x03), .c(new_n141_), .O(new_n159_));
  nand2  g126(.a(new_n37_), .b(x14), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x06), .c(new_n36_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n34_), .c(new_n152_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n53_), .O(z6));
  nand4  g130(.a(new_n151_), .b(new_n112_), .c(new_n150_), .d(new_n53_), .O(z7));
endmodule
