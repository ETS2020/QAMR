...
module FAU ( 
  ...
  nand4  g075(.a(new_n50_), .b(x06), .c(x03), .d(x01), .O(new_n109_));
  ...
  aoi21  g083(.a(new_n116_), .b(new_n115_), .c(new_n40_), .O(new_n117_));
  ...
  nor3   g088(.a(new_n121_), .b(new_n92_), .c(new_n36_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x11), .c(x06), .d(x03), .O(new_n123_));
  oai21  g090(.a(new_n123_), .b(new_n67_), .c(new_n114_), .O(z2));
  nand3  g091(.a(x15), .b(x13), .c(x05), .O(new_n125_));
  nand3  g092(.a(x21), .b(new_n50_), .c(new_n37_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(x20), .c(x14), .d(x11), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(new_n58_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x06), .c(x03), .d(x01), .O(new_n130_));
  nand3  g097(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n131_));
  nand3  g098(.a(x19), .b(x13), .c(x05), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n92_), .c(new_n36_), .d(new_n35_), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(x08), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n130_), .c(x24), .O(new_n137_));
  nand3  g104(.a(new_n59_), .b(x03), .c(x01), .O(new_n138_));
  nand3  g105(.a(new_n110_), .b(x20), .c(x18), .O(new_n139_));
  nand4  g106(.a(x07), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n140_));
  nand4  g107(.a(new_n92_), .b(new_n36_), .c(new_n35_), .d(new_n58_), .O(new_n141_));
  ...
  nand3  g111(.a(new_n72_), .b(new_n68_), .c(new_n67_), .O(new_n145_));
  nand3  g112(.a(new_n77_), .b(new_n36_), .c(new_n35_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n138_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n46_), .c(new_n40_), .O(new_n148_));
  ...
  oai21  g122(.a(x23), .b(new_n69_), .c(new_n91_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n155_), .c(x09), .O(new_n157_));
  ...
  oai21  g127(.a(new_n160_), .b(new_n44_), .c(new_n158_), .O(new_n161_));
  inv1   g128(.a(x23), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x04), .c(x17), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x22), .c(new_n66_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n93_), .c(x08), .O(new_n165_));
  nor2   g132(.a(x10), .b(x02), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n111_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n119_), .c(new_n118_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n117_), .c(new_n165_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n161_), .c(new_n39_), .O(z4));
  ...
  aoi21  g146(.a(new_n92_), .b(x14), .c(new_n34_), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n35_), .c(x03), .O(new_n181_));
  inv1   g148(.a(new_n39_), .O(new_n182_));
  nand3  g149(.a(new_n166_), .b(new_n111_), .c(x12), .O(new_n183_));
  oai21  g150(.a(new_n121_), .b(new_n182_), .c(new_n183_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n181_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n179_), .O(z6));
  aoi21  g153(.a(new_n111_), .b(new_n50_), .c(new_n38_), .O(new_n187_));
