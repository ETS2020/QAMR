...
module FAU ( 
  ...
  oai21  g010(.a(new_n43_), .b(new_n38_), .c(x16), .O(new_n44_));
  ...
  oai21  g079(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  ...
  nand3  g106(.a(new_n90_), .b(new_n36_), .c(new_n35_), .O(new_n140_));
  ...
  oai21  g116(.a(new_n149_), .b(new_n137_), .c(x16), .O(new_n150_));
  ...
  inv1   g121(.a(new_n55_), .O(new_n155_));
  nor2   g122(.a(x16), .b(x02), .O(new_n156_));
  inv1   g123(.a(x16), .O(new_n157_));
  inv1   g124(.a(x23), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x04), .c(x17), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x22), .c(new_n69_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n157_), .c(new_n61_), .O(new_n161_));
  oai21  g128(.a(new_n156_), .b(new_n61_), .c(new_n161_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n155_), .O(new_n163_));
  inv1   g130(.a(x22), .O(new_n164_));
  inv1   g131(.a(x17), .O(new_n165_));
  aoi21  g132(.a(x23), .b(new_n70_), .c(new_n165_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n164_), .c(x09), .O(new_n167_));
  nor2   g134(.a(x10), .b(x02), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n111_), .O(new_n169_));
  oai21  g136(.a(new_n121_), .b(new_n157_), .c(new_n169_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n167_), .O(new_n171_));
  inv1   g138(.a(new_n117_), .O(new_n172_));
  nand4  g139(.a(new_n169_), .b(new_n119_), .c(new_n118_), .d(new_n172_), .O(new_n173_));
  nand3  g140(.a(new_n41_), .b(x16), .c(new_n101_), .O(new_n174_));
  inv1   g141(.a(new_n174_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(x08), .c(x00), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(x16), .c(x02), .O(new_n177_));
  aoi21  g144(.a(new_n173_), .b(new_n61_), .c(new_n177_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n171_), .c(new_n163_), .O(z4));
  nand3  g146(.a(new_n175_), .b(new_n34_), .c(x00), .O(new_n180_));
  oai21  g147(.a(new_n156_), .b(new_n55_), .c(new_n180_), .O(z5));
  aoi21  g148(.a(x20), .b(new_n39_), .c(x06), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(x11), .c(new_n36_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(z5), .O(new_n184_));
  aoi21  g151(.a(new_n40_), .b(x14), .c(new_n37_), .O(new_n185_));
  oai21  g152(.a(new_n185_), .b(new_n46_), .c(x03), .O(new_n186_));
  nand3  g153(.a(new_n168_), .b(new_n111_), .c(x16), .O(new_n187_));
  oai21  g154(.a(new_n156_), .b(new_n121_), .c(new_n187_), .O(new_n188_));
  nand2  g155(.a(new_n188_), .b(new_n186_), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n184_), .O(z6));
  aoi21  g157(.a(new_n111_), .b(new_n101_), .c(new_n157_), .O(new_n191_));
  oai21  g158(.a(new_n191_), .b(x02), .c(new_n121_), .O(z7));
endmodule
