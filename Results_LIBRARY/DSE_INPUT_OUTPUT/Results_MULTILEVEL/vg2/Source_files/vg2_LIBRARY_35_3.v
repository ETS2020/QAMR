...
module FAU ( 
  ...
  nand4  g035(.a(new_n34_), .b(new_n68_), .c(new_n67_), .d(new_n66_), .O(new_n69_));
  ...
  nand3  g042(.a(new_n75_), .b(new_n36_), .c(x19), .O(new_n76_));
  nor2   g043(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand3  g044(.a(new_n77_), .b(new_n70_), .c(new_n65_), .O(new_n78_));
  ...
  nand4  g054(.a(new_n87_), .b(new_n65_), .c(x07), .d(new_n66_), .O(new_n88_));
  nand4  g055(.a(new_n72_), .b(new_n35_), .c(new_n71_), .d(new_n34_), .O(new_n89_));
  inv1   g056(.a(new_n89_), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n75_), .c(new_n36_), .d(new_n73_), .O(new_n91_));
  ...
  nor4   g081(.a(new_n114_), .b(new_n66_), .c(new_n104_), .d(new_n103_), .O(z2));
  ...
  nand3  g085(.a(new_n97_), .b(new_n67_), .c(new_n66_), .O(new_n119_));
  nand4  g086(.a(new_n36_), .b(x19), .c(new_n35_), .d(new_n34_), .O(new_n120_));
  ...
  nand3  g090(.a(new_n97_), .b(x07), .c(new_n66_), .O(new_n124_));
  nand4  g091(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n125_));
  ...
  nand4  g094(.a(new_n66_), .b(new_n104_), .c(new_n103_), .d(x00), .O(new_n128_));
  ...
  nand2  g101(.a(new_n134_), .b(new_n71_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n133_), .O(z3));
  inv1   g103(.a(x07), .O(new_n137_));
  nand2  g104(.a(new_n37_), .b(x08), .O(new_n138_));
  aoi21  g105(.a(new_n62_), .b(x04), .c(x17), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x22), .c(new_n68_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n72_), .c(new_n67_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n138_), .c(new_n137_), .O(new_n142_));
  inv1   g109(.a(x18), .O(new_n143_));
  inv1   g110(.a(x04), .O(new_n144_));
  aoi21  g111(.a(x23), .b(new_n144_), .c(new_n73_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n61_), .c(x09), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(x16), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x08), .c(new_n143_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n142_), .c(new_n80_), .O(new_n149_));
  nor2   g116(.a(new_n67_), .b(x05), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(x19), .c(new_n44_), .d(new_n71_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x24), .O(new_n153_));
  nand2  g120(.a(new_n82_), .b(x15), .O(new_n154_));
  aoi22  g121(.a(new_n154_), .b(new_n112_), .c(new_n147_), .d(x08), .O(new_n155_));
  nand2  g122(.a(x24), .b(x08), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n44_), .c(new_n38_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n81_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x19), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n50_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n140_), .c(new_n72_), .O(new_n161_));
  nand3  g128(.a(new_n40_), .b(new_n49_), .c(x00), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n45_), .c(x02), .O(new_n163_));
  nand2  g130(.a(x13), .b(x05), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n80_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n40_), .c(x19), .O(new_n166_));
  inv1   g133(.a(new_n166_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n163_), .c(x08), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n161_), .c(new_n37_), .O(new_n169_));
  ...
  aoi21  g141(.a(new_n36_), .b(x14), .c(new_n66_), .O(new_n175_));
  ...
  inv1   g145(.a(new_n107_), .O(new_n179_));
  and2   g146(.a(new_n112_), .b(new_n109_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n108_), .c(new_n179_), .d(new_n37_), .O(z7));
endmodule
