...
module FAU ( 
  ...
  oai21  g082(.a(new_n39_), .b(new_n90_), .c(new_n115_), .O(new_n116_));
  ...
  aoi21  g093(.a(new_n126_), .b(x06), .c(new_n71_), .O(z2));
  nand4  g094(.a(new_n56_), .b(x20), .c(x14), .d(x11), .O(new_n128_));
  nor4   g095(.a(new_n128_), .b(new_n66_), .c(new_n34_), .d(new_n64_), .O(new_n129_));
  nand4  g096(.a(new_n76_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n130_));
  ...
  nand3  g100(.a(new_n35_), .b(new_n34_), .c(new_n64_), .O(new_n134_));
  nand4  g101(.a(new_n68_), .b(new_n36_), .c(new_n66_), .d(x07), .O(new_n135_));
  nand3  g102(.a(x08), .b(x03), .c(x01), .O(new_n136_));
  ...
  nand4  g106(.a(x19), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n140_));
  ...
  nor2   g110(.a(new_n71_), .b(x06), .O(new_n144_));
  ...
  oai21  g114(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n148_));
  ...
  aoi21  g122(.a(new_n155_), .b(new_n151_), .c(new_n144_), .O(z4));
  nor2   g123(.a(new_n144_), .b(new_n49_), .O(z5));
  oai21  g124(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n147_), .O(new_n159_));
  nor2   g126(.a(new_n144_), .b(x03), .O(new_n160_));
  nand2  g127(.a(new_n35_), .b(x03), .O(new_n161_));
  nand2  g128(.a(new_n71_), .b(x14), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n161_), .c(new_n36_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n160_), .c(new_n123_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n159_), .c(new_n145_), .O(z6));
