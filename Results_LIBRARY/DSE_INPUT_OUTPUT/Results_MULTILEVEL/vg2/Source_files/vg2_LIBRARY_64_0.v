...
module FAU ( 
  ...
  oai21  g080(.a(new_n110_), .b(new_n44_), .c(new_n113_), .O(new_n114_));
  ...
  oai21  g084(.a(new_n117_), .b(new_n62_), .c(new_n108_), .O(z2));
  nand4  g085(.a(new_n95_), .b(x08), .c(x06), .d(x03), .O(new_n119_));
  nor2   g086(.a(new_n109_), .b(new_n36_), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(new_n105_), .c(x20), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(new_n119_), .c(x01), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n103_), .O(new_n123_));
  nand3  g090(.a(new_n54_), .b(x03), .c(x01), .O(new_n124_));
  nand3  g091(.a(new_n120_), .b(x20), .c(x15), .O(new_n125_));
  nand3  g092(.a(new_n66_), .b(new_n34_), .c(new_n62_), .O(new_n126_));
  nand3  g093(.a(new_n71_), .b(new_n109_), .c(new_n36_), .O(new_n127_));
  ...
  nand4  g097(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n62_), .O(new_n131_));
  nand4  g098(.a(new_n37_), .b(new_n109_), .c(new_n36_), .d(new_n53_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n124_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n75_), .c(x24), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n129_), .c(new_n123_), .O(z3));
  inv1   g102(.a(x22), .O(new_n136_));
  inv1   g103(.a(x17), .O(new_n137_));
  oai21  g104(.a(x23), .b(new_n63_), .c(new_n137_), .O(new_n138_));
  ...
  nand4  g110(.a(new_n143_), .b(new_n103_), .c(x01), .d(x00), .O(new_n144_));
  ...
  nor2   g118(.a(new_n114_), .b(new_n112_), .O(new_n152_));
  nand3  g119(.a(new_n105_), .b(new_n92_), .c(new_n95_), .O(new_n153_));
  oai21  g120(.a(new_n142_), .b(new_n152_), .c(new_n153_), .O(z7));
  nand2  g121(.a(z7), .b(new_n151_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n146_), .O(z4));
  aoi21  g123(.a(new_n143_), .b(x00), .c(new_n62_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x02), .c(new_n141_), .O(z5));
  aoi21  g125(.a(x20), .b(new_n109_), .c(x06), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x11), .c(new_n34_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n145_), .O(new_n161_));
  aoi21  g128(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n162_));
