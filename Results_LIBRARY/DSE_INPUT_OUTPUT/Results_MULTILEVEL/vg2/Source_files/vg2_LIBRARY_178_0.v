...
module FAU ( 
  ...
  aoi21  g018(.a(new_n51_), .b(x12), .c(x20), .O(z0));
  ...
  oai21  g039(.a(new_n69_), .b(new_n34_), .c(new_n72_), .O(z1));
  nor2   g040(.a(new_n62_), .b(new_n58_), .O(new_n74_));
  nor3   g041(.a(new_n74_), .b(new_n71_), .c(new_n54_), .O(new_n75_));
  ...
  nand3  g064(.a(new_n71_), .b(new_n54_), .c(x12), .O(new_n98_));
  ...
  nand3  g069(.a(new_n71_), .b(x19), .c(new_n54_), .O(new_n103_));
  nor3   g070(.a(new_n103_), .b(new_n70_), .c(x11), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n97_), .c(new_n53_), .d(new_n36_), .O(new_n105_));
  aoi21  g072(.a(new_n105_), .b(new_n102_), .c(x13), .O(new_n106_));
  aoi22  g073(.a(new_n106_), .b(new_n37_), .c(new_n101_), .d(x24), .O(new_n107_));
  nand2  g074(.a(new_n107_), .b(new_n92_), .O(z3));
  ...
  aoi21  g079(.a(new_n112_), .b(new_n55_), .c(x09), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(x16), .c(new_n53_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n109_), .O(new_n115_));
  inv1   g082(.a(new_n74_), .O(new_n116_));
  ...
  nand3  g090(.a(new_n123_), .b(new_n115_), .c(new_n72_), .O(z4));
  inv1   g091(.a(new_n41_), .O(new_n125_));
  and2   g092(.a(new_n45_), .b(new_n42_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n72_), .c(new_n47_), .d(new_n125_), .O(z5));
  nand2  g094(.a(x20), .b(new_n54_), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(new_n36_), .c(x11), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(x03), .c(new_n109_), .O(new_n130_));
  nand2  g097(.a(new_n71_), .b(x14), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(x06), .c(new_n84_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n35_), .c(new_n116_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n130_), .c(new_n72_), .O(z6));
  inv1   g101(.a(new_n58_), .O(new_n135_));
  and2   g102(.a(new_n60_), .b(new_n59_), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n72_), .c(new_n61_), .d(new_n135_), .O(z7));
endmodule
