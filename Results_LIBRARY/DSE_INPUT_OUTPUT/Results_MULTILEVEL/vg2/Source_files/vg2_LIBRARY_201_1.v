...
module FAU ( 
  ...
  nand4  g069(.a(new_n49_), .b(new_n63_), .c(new_n62_), .d(new_n34_), .O(new_n103_));
  ...
  nor2   g086(.a(x24), .b(new_n99_), .O(new_n120_));
  aoi22  g087(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n38_), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n67_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x14), .c(x11), .d(x06), .O(new_n123_));
  nor3   g090(.a(new_n123_), .b(new_n60_), .c(new_n59_), .O(z2));
  nand3  g091(.a(x15), .b(x13), .c(x05), .O(new_n125_));
  oai21  g092(.a(new_n99_), .b(x02), .c(new_n125_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x20), .c(x14), .d(x11), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n62_), .O(new_n128_));
  ...
  nand4  g099(.a(new_n132_), .b(new_n67_), .c(new_n36_), .d(new_n35_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x08), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n34_), .c(new_n60_), .d(new_n59_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n129_), .c(x24), .O(new_n136_));
  nand4  g103(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n137_));
  nand3  g104(.a(new_n95_), .b(x14), .c(x11), .O(new_n138_));
  nand4  g105(.a(x07), .b(new_n34_), .c(new_n60_), .d(new_n59_), .O(new_n139_));
  nand4  g106(.a(new_n67_), .b(new_n36_), .c(new_n35_), .d(new_n62_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n137_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n56_), .c(x24), .O(new_n142_));
  nand4  g109(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n143_));
  nand4  g110(.a(new_n62_), .b(new_n34_), .c(new_n60_), .d(new_n59_), .O(new_n144_));
  nand4  g111(.a(new_n67_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n137_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n46_), .c(new_n45_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n142_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n136_), .c(new_n49_), .O(new_n149_));
  nand2  g116(.a(new_n146_), .b(new_n58_), .O(new_n150_));
  ...
  oai21  g120(.a(x23), .b(new_n61_), .c(new_n65_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n68_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n63_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n64_), .c(x08), .O(new_n157_));
  oai21  g124(.a(new_n69_), .b(x04), .c(x17), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x22), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(x09), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x16), .c(new_n62_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n121_), .c(new_n157_), .d(new_n52_), .O(z4));
  inv1   g129(.a(new_n48_), .O(new_n163_));
  aoi21  g130(.a(new_n40_), .b(x00), .c(x10), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x02), .c(new_n163_), .O(z5));
  ...
  nand3  g135(.a(new_n40_), .b(new_n37_), .c(x00), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n47_), .c(new_n44_), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n166_), .c(new_n168_), .d(x03), .O(new_n171_));
  inv1   g138(.a(new_n115_), .O(new_n172_));
  nand2  g139(.a(new_n67_), .b(x14), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(x06), .c(new_n35_), .O(new_n174_));
  nand2  g141(.a(new_n120_), .b(new_n37_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n117_), .c(new_n116_), .O(new_n176_));
  oai22  g143(.a(new_n176_), .b(new_n172_), .c(new_n174_), .d(new_n60_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n171_), .c(new_n38_), .O(z6));
  inv1   g145(.a(new_n118_), .O(new_n179_));
  oai21  g146(.a(new_n120_), .b(x10), .c(new_n37_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n179_), .O(z7));
endmodule
