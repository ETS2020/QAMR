...
module FAU ( 
  ...
  nor4   g053(.a(new_n86_), .b(new_n64_), .c(new_n36_), .d(new_n35_), .O(new_n87_));
  ...
  nand4  g061(.a(new_n66_), .b(new_n65_), .c(x07), .d(new_n37_), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nand4  g063(.a(new_n69_), .b(new_n68_), .c(new_n34_), .d(new_n67_), .O(new_n97_));
  ...
  nand4  g072(.a(new_n67_), .b(new_n66_), .c(new_n65_), .d(new_n37_), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  nand4  g074(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n34_), .O(new_n108_));
  ...
  nor2   g081(.a(new_n40_), .b(new_n90_), .O(new_n115_));
  ...
  nor2   g092(.a(x14), .b(new_n34_), .O(new_n126_));
  ...
  nand4  g107(.a(new_n71_), .b(new_n68_), .c(new_n67_), .d(new_n65_), .O(new_n141_));
  ...
  nand4  g111(.a(new_n65_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n145_));
  nand4  g112(.a(new_n71_), .b(x19), .c(new_n68_), .d(new_n67_), .O(new_n146_));
  ...
  nand4  g115(.a(new_n148_), .b(new_n143_), .c(new_n136_), .d(new_n127_), .O(z3));
  inv1   g116(.a(new_n50_), .O(new_n150_));
  oai21  g117(.a(x23), .b(new_n64_), .c(new_n70_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n72_), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n65_), .O(new_n153_));
  ...
  nand3  g126(.a(new_n159_), .b(new_n154_), .c(new_n127_), .O(z4));
  ...
  nand2  g130(.a(x20), .b(new_n68_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n37_), .c(x11), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x03), .c(new_n150_), .O(new_n166_));
  nor2   g133(.a(new_n126_), .b(x03), .O(new_n167_));
  nand2  g134(.a(new_n37_), .b(x03), .O(new_n168_));
  nand2  g135(.a(new_n71_), .b(x14), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(new_n168_), .c(new_n67_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n167_), .c(new_n155_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n166_), .c(new_n127_), .O(z6));
  nor2   g139(.a(new_n126_), .b(new_n123_), .O(z7));
endmodule
