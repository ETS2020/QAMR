...
module FAU ( 
  ...
  nand4  g034(.a(new_n67_), .b(new_n66_), .c(new_n34_), .d(new_n35_), .O(new_n68_));
  ...
  nand2  g082(.a(new_n66_), .b(x02), .O(new_n116_));
  ...
  nand4  g087(.a(new_n36_), .b(new_n66_), .c(new_n34_), .d(new_n35_), .O(new_n121_));
  nand4  g088(.a(new_n75_), .b(new_n105_), .c(new_n37_), .d(new_n65_), .O(new_n122_));
  ...
  nand4  g093(.a(new_n126_), .b(new_n37_), .c(new_n65_), .d(x07), .O(new_n127_));
  ...
  nand4  g096(.a(new_n36_), .b(new_n66_), .c(new_n35_), .d(x00), .O(new_n130_));
  nand3  g097(.a(new_n126_), .b(new_n37_), .c(new_n65_), .O(new_n131_));
  ...
  nand2  g105(.a(new_n48_), .b(new_n44_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n43_), .c(new_n116_), .O(new_n140_));
  nand3  g107(.a(new_n45_), .b(new_n34_), .c(x00), .O(new_n141_));
  ...
  oai21  g116(.a(new_n149_), .b(new_n108_), .c(new_n116_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n111_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n143_), .O(z4));
  oai21  g120(.a(new_n38_), .b(x14), .c(new_n36_), .O(new_n154_));
  nand3  g121(.a(new_n45_), .b(new_n66_), .c(x00), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n48_), .c(new_n44_), .O(new_n156_));
  or2    g123(.a(new_n156_), .b(new_n43_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n154_), .c(new_n37_), .O(new_n158_));
  oai21  g125(.a(x20), .b(new_n105_), .c(x06), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x11), .c(new_n66_), .O(new_n160_));
  ...
  oai22  g131(.a(new_n160_), .b(new_n164_), .c(new_n74_), .d(new_n66_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n81_), .O(new_n166_));
  nand3  g133(.a(new_n41_), .b(x21), .c(new_n96_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n34_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n66_), .O(new_n169_));
  nand3  g136(.a(new_n159_), .b(x21), .c(x11), .O(new_n170_));
  nand2  g137(.a(x03), .b(x00), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n41_), .c(new_n96_), .d(new_n34_), .O(new_n173_));
  and2   g140(.a(new_n173_), .b(new_n169_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n166_), .c(new_n163_), .d(new_n158_), .O(z6));
  nor2   g142(.a(new_n112_), .b(new_n108_), .O(new_n176_));
  nand2  g143(.a(new_n169_), .b(new_n176_), .O(z7));
endmodule
