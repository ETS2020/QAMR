...
module FAU ( 
  ...
  nand3  g057(.a(new_n90_), .b(new_n89_), .c(new_n69_), .O(new_n91_));
  ...
  oai21  g062(.a(new_n95_), .b(new_n91_), .c(new_n87_), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(new_n79_), .c(x24), .O(new_n97_));
  inv1   g064(.a(x21), .O(new_n98_));
  nor2   g065(.a(new_n98_), .b(new_n37_), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n84_), .c(new_n66_), .d(new_n59_), .O(new_n100_));
  inv1   g067(.a(x00), .O(new_n101_));
  nor2   g068(.a(x01), .b(new_n101_), .O(new_n102_));
  nor2   g069(.a(x03), .b(x02), .O(new_n103_));
  nor2   g070(.a(x06), .b(x04), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n90_), .O(new_n105_));
  oai21  g072(.a(new_n105_), .b(new_n95_), .c(new_n100_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n40_), .c(new_n45_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n97_), .c(new_n82_), .d(new_n55_), .O(z1));
  ...
  aoi21  g085(.a(new_n118_), .b(new_n44_), .c(new_n53_), .O(z2));
  nand4  g086(.a(x06), .b(x03), .c(new_n44_), .d(x01), .O(new_n120_));
  ...
  nand4  g094(.a(new_n127_), .b(new_n126_), .c(new_n75_), .d(new_n70_), .O(new_n128_));
  oai21  g095(.a(new_n125_), .b(new_n120_), .c(new_n128_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n81_), .O(new_n130_));
  nand3  g097(.a(new_n122_), .b(new_n86_), .c(x14), .O(new_n131_));
  nand2  g098(.a(new_n126_), .b(new_n89_), .O(new_n132_));
  nand4  g099(.a(new_n37_), .b(new_n53_), .c(new_n36_), .d(new_n121_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n120_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n79_), .c(x24), .O(new_n135_));
  nand3  g102(.a(new_n102_), .b(new_n35_), .c(new_n34_), .O(new_n136_));
  nand4  g103(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n137_));
  nand3  g104(.a(new_n99_), .b(x14), .c(x11), .O(new_n138_));
  ...
  oai21  g109(.a(x23), .b(new_n142_), .c(new_n62_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n64_), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n121_), .O(new_n145_));
  nand2  g112(.a(new_n48_), .b(new_n43_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n42_), .c(new_n55_), .O(new_n147_));
  ...
  nand2  g120(.a(new_n113_), .b(new_n112_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n111_), .c(new_n55_), .O(new_n155_));
  ...
  nand4  g128(.a(new_n161_), .b(new_n55_), .c(new_n48_), .d(new_n160_), .O(z5));
  nor2   g129(.a(x10), .b(new_n101_), .O(new_n163_));
  ...
  oai21  g135(.a(new_n98_), .b(x10), .c(new_n168_), .O(new_n169_));
  ...
  nand4  g139(.a(new_n163_), .b(x20), .c(new_n53_), .d(new_n36_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n172_), .c(new_n167_), .O(new_n174_));
  oai21  g141(.a(x13), .b(x05), .c(x24), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n88_), .c(new_n48_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n166_), .O(new_n177_));
  oai21  g144(.a(new_n175_), .b(new_n85_), .c(new_n113_), .O(new_n178_));
  ...
  oai21  g150(.a(new_n146_), .b(new_n42_), .c(new_n183_), .O(new_n184_));
  oai21  g151(.a(new_n36_), .b(x06), .c(x03), .O(new_n185_));
  oai21  g152(.a(new_n154_), .b(new_n111_), .c(new_n185_), .O(new_n186_));
