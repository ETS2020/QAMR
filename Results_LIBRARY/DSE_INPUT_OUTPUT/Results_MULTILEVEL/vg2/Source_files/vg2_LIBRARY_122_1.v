...
module FAU ( 
  ...
  nand3  g088(.a(x15), .b(new_n79_), .c(new_n46_), .O(new_n122_));
  nand4  g089(.a(new_n41_), .b(x21), .c(new_n109_), .d(new_n34_), .O(new_n123_));
  ...
  nand2  g094(.a(x02), .b(new_n67_), .O(new_n128_));
  oai21  g095(.a(new_n127_), .b(new_n67_), .c(new_n128_), .O(z2));
  ...
  nand4  g099(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n133_));
  nand4  g100(.a(new_n75_), .b(new_n38_), .c(new_n37_), .d(new_n58_), .O(new_n134_));
  ...
  nand4  g105(.a(new_n138_), .b(new_n37_), .c(new_n58_), .d(x07), .O(new_n139_));
  ...
  nand4  g108(.a(new_n36_), .b(new_n35_), .c(new_n67_), .d(x00), .O(new_n142_));
  nand3  g109(.a(new_n138_), .b(new_n37_), .c(new_n58_), .O(new_n143_));
  nand3  g110(.a(new_n131_), .b(x21), .c(x20), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n130_), .c(new_n143_), .d(new_n142_), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n41_), .c(new_n109_), .d(new_n34_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n141_), .c(new_n136_), .O(z3));
  nand2  g114(.a(new_n128_), .b(x08), .O(new_n148_));
  aoi21  g115(.a(new_n113_), .b(x04), .c(x17), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x22), .c(new_n66_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n91_), .c(new_n58_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n148_), .c(new_n40_), .O(new_n152_));
  inv1   g119(.a(x18), .O(new_n153_));
  inv1   g120(.a(x04), .O(new_n154_));
  inv1   g121(.a(x17), .O(new_n155_));
  aoi21  g122(.a(x23), .b(new_n154_), .c(new_n155_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n112_), .c(x09), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(x16), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x08), .c(new_n153_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n152_), .c(new_n80_), .O(new_n160_));
  nand4  g127(.a(new_n49_), .b(x08), .c(new_n46_), .d(x01), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x24), .O(new_n163_));
  nand2  g130(.a(new_n82_), .b(x15), .O(new_n164_));
  aoi22  g131(.a(new_n164_), .b(new_n123_), .c(new_n158_), .d(x08), .O(new_n165_));
  nand2  g132(.a(x24), .b(x08), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n79_), .c(new_n46_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n81_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x19), .O(new_n169_));
  nand2  g136(.a(new_n99_), .b(new_n47_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n150_), .c(new_n91_), .O(new_n172_));
  nand2  g139(.a(x13), .b(x05), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n80_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n41_), .c(x19), .O(new_n175_));
  oai21  g142(.a(new_n50_), .b(x02), .c(new_n175_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(x08), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n172_), .c(new_n128_), .O(new_n178_));
  nor2   g145(.a(new_n178_), .b(new_n165_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n163_), .O(z4));
  nand2  g147(.a(new_n49_), .b(new_n46_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n45_), .c(new_n44_), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n128_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n170_), .O(z5));
  ...
  nand2  g156(.a(new_n122_), .b(new_n121_), .O(new_n190_));
  oai21  g157(.a(new_n190_), .b(new_n120_), .c(new_n128_), .O(new_n191_));
  nand2  g158(.a(new_n191_), .b(new_n123_), .O(z7));
  nand2  g159(.a(z7), .b(new_n189_), .O(new_n193_));
  nand2  g160(.a(new_n193_), .b(new_n187_), .O(z6));
endmodule
