...
module FAU ( 
  ...
  nand2  g083(.a(x02), .b(new_n67_), .O(new_n117_));
  oai21  g084(.a(new_n116_), .b(new_n67_), .c(new_n117_), .O(z2));
  ...
  nand4  g106(.a(new_n139_), .b(new_n137_), .c(new_n120_), .d(new_n97_), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n136_), .c(new_n131_), .d(new_n125_), .O(z3));
  nand2  g108(.a(new_n117_), .b(x08), .O(new_n142_));
  ...
  nand3  g112(.a(new_n145_), .b(new_n143_), .c(new_n128_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n142_), .c(new_n40_), .O(new_n147_));
  inv1   g114(.a(x17), .O(new_n148_));
  aoi21  g115(.a(x23), .b(new_n68_), .c(new_n148_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n61_), .c(x09), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x16), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x08), .c(new_n86_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n147_), .c(new_n80_), .O(new_n153_));
  nand4  g120(.a(new_n49_), .b(x08), .c(new_n46_), .d(x01), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(x24), .O(new_n156_));
  nand2  g123(.a(new_n82_), .b(x15), .O(new_n157_));
  aoi22  g124(.a(new_n157_), .b(new_n112_), .c(new_n151_), .d(x08), .O(new_n158_));
  nand2  g125(.a(x24), .b(x08), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n79_), .c(new_n46_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n81_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(x19), .O(new_n162_));
  nand3  g129(.a(new_n47_), .b(new_n34_), .c(x00), .O(new_n163_));
  ...
  nand2  g133(.a(new_n166_), .b(new_n80_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n41_), .c(x19), .O(new_n168_));
  oai21  g135(.a(new_n50_), .b(x02), .c(new_n168_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(x08), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n165_), .c(new_n117_), .O(new_n171_));
  nor2   g138(.a(new_n171_), .b(new_n158_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n156_), .O(z4));
  nand2  g140(.a(new_n49_), .b(new_n46_), .O(new_n174_));
  ...
  nand2  g149(.a(new_n111_), .b(new_n110_), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(new_n109_), .c(new_n117_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n112_), .O(z7));
