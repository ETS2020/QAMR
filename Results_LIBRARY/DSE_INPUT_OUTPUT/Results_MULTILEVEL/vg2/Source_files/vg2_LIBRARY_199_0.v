...
module FAU ( 
  ...
  nor2   g03(.a(x17), .b(x12), .O(new_n37_));
  ...
  nand4  g71(.a(new_n104_), .b(new_n99_), .c(new_n92_), .d(new_n55_), .O(z3));
  inv1   g72(.a(new_n50_), .O(new_n106_));
  ...
  nand3  g87(.a(new_n120_), .b(new_n112_), .c(new_n55_), .O(z4));
  inv1   g88(.a(new_n42_), .O(new_n122_));
  and2   g89(.a(new_n46_), .b(new_n43_), .O(new_n123_));
  nand4  g90(.a(new_n123_), .b(new_n48_), .c(new_n122_), .d(new_n55_), .O(z5));
  nand2  g91(.a(x20), .b(new_n57_), .O(new_n125_));
  aoi21  g92(.a(new_n125_), .b(new_n35_), .c(x11), .O(new_n126_));
  oai21  g93(.a(new_n126_), .b(x03), .c(new_n106_), .O(new_n127_));
  oai21  g94(.a(x20), .b(new_n57_), .c(x06), .O(new_n128_));
  nand3  g95(.a(new_n128_), .b(x11), .c(x03), .O(new_n129_));
  oai21  g96(.a(new_n37_), .b(x03), .c(new_n129_), .O(new_n130_));
  aoi21  g97(.a(new_n130_), .b(new_n113_), .c(new_n37_), .O(new_n131_));
  nand2  g98(.a(new_n131_), .b(new_n127_), .O(z6));
  nor2   g99(.a(new_n75_), .b(new_n37_), .O(z7));
endmodule
