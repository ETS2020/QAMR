...
module FAU ( 
  ...
  nor2   g080(.a(x24), .b(new_n98_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(new_n50_), .c(new_n49_), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(new_n113_), .c(new_n87_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x14), .c(x11), .d(x06), .O(new_n117_));
  nor3   g084(.a(new_n117_), .b(new_n67_), .c(new_n66_), .O(z2));
  nand4  g085(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n119_));
  nor2   g086(.a(new_n36_), .b(new_n35_), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(x20), .c(x15), .O(new_n121_));
  nand2  g088(.a(new_n101_), .b(new_n71_), .O(new_n122_));
  ...
  nand3  g093(.a(new_n101_), .b(x07), .c(new_n34_), .O(new_n127_));
  nand4  g094(.a(new_n87_), .b(new_n36_), .c(new_n35_), .d(new_n37_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n119_), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n80_), .c(x24), .O(new_n130_));
  nand4  g097(.a(new_n34_), .b(new_n67_), .c(new_n66_), .d(x00), .O(new_n131_));
  nor2   g098(.a(x11), .b(x10), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n41_), .c(new_n87_), .d(new_n36_), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n131_), .c(new_n49_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n37_), .O(new_n135_));
  nor4   g102(.a(new_n57_), .b(new_n67_), .c(x02), .d(new_n66_), .O(new_n136_));
  nor3   g103(.a(new_n36_), .b(new_n35_), .c(x10), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n136_), .c(new_n114_), .d(x20), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n135_), .c(new_n130_), .d(new_n125_), .O(z3));
  inv1   g106(.a(x16), .O(new_n140_));
  aoi21  g107(.a(new_n61_), .b(x04), .c(x17), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x22), .c(new_n55_), .O(new_n142_));
  nand4  g109(.a(new_n41_), .b(new_n50_), .c(new_n37_), .d(x00), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n46_), .c(new_n44_), .O(new_n144_));
  or2    g111(.a(new_n144_), .b(new_n43_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n142_), .c(new_n140_), .O(new_n146_));
  inv1   g113(.a(x17), .O(new_n147_));
  aoi21  g114(.a(x23), .b(new_n68_), .c(new_n147_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n60_), .c(x09), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x16), .c(new_n37_), .O(new_n150_));
  nand2  g117(.a(x08), .b(x07), .O(new_n151_));
  oai21  g118(.a(new_n150_), .b(new_n86_), .c(new_n151_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n80_), .c(x24), .O(new_n153_));
  inv1   g120(.a(x15), .O(new_n154_));
  oai22  g121(.a(new_n150_), .b(new_n154_), .c(new_n75_), .d(new_n37_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n82_), .O(new_n156_));
  nand2  g123(.a(new_n114_), .b(new_n50_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n49_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n37_), .O(new_n159_));
  nand3  g126(.a(new_n149_), .b(x21), .c(x16), .O(new_n160_));
  nand2  g127(.a(x08), .b(x00), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n41_), .c(new_n50_), .d(new_n49_), .O(new_n163_));
  and2   g130(.a(new_n163_), .b(new_n159_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n156_), .c(new_n153_), .d(new_n146_), .O(z4));
  nand2  g132(.a(x08), .b(x02), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n50_), .c(x00), .O(new_n167_));
  ...
  nand3  g137(.a(new_n80_), .b(x24), .c(x07), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n170_), .c(new_n46_), .d(new_n38_), .O(z5));
  nand2  g139(.a(new_n51_), .b(new_n48_), .O(new_n173_));
  aoi21  g140(.a(x20), .b(new_n36_), .c(x06), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(x11), .c(new_n67_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand2  g143(.a(new_n115_), .b(new_n113_), .O(new_n177_));
  aoi21  g144(.a(new_n87_), .b(x14), .c(new_n34_), .O(new_n178_));
  ...
  inv1   g148(.a(new_n109_), .O(new_n182_));
  and2   g149(.a(new_n110_), .b(new_n38_), .O(new_n183_));
  nand4  g150(.a(new_n183_), .b(new_n115_), .c(new_n111_), .d(new_n182_), .O(z7));
endmodule
