...
module FAU ( 
  ...
  nand2  g132(.a(new_n109_), .b(new_n57_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n164_), .O(z5));
  oai21  g134(.a(x20), .b(new_n39_), .c(x06), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x11), .O(new_n169_));
  nand2  g136(.a(new_n109_), .b(new_n36_), .O(new_n170_));
  oai21  g137(.a(new_n169_), .b(new_n36_), .c(new_n170_), .O(new_n171_));
  oai21  g138(.a(new_n114_), .b(new_n112_), .c(new_n171_), .O(new_n172_));
  inv1   g139(.a(x00), .O(new_n173_));
  nand2  g140(.a(new_n169_), .b(new_n173_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n41_), .c(new_n98_), .d(new_n34_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n56_), .c(new_n50_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(x03), .O(new_n177_));
  nand3  g144(.a(new_n116_), .b(new_n98_), .c(new_n36_), .O(new_n178_));
  aoi21  g145(.a(new_n178_), .b(x21), .c(x02), .O(new_n179_));
  aoi21  g146(.a(x20), .b(new_n39_), .c(x06), .O(new_n180_));
  aoi21  g147(.a(new_n56_), .b(new_n50_), .c(new_n180_), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(new_n46_), .c(new_n179_), .O(new_n182_));
