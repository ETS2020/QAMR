...
module FAU ( 
  ...
  nand4  g134(.a(new_n167_), .b(new_n129_), .c(new_n45_), .d(new_n44_), .O(z5));
  ...
  oai22  g141(.a(new_n174_), .b(new_n35_), .c(new_n125_), .d(new_n121_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n172_), .c(new_n129_), .O(z6));
  nand4  g143(.a(new_n129_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n177_));
  or2    g144(.a(new_n177_), .b(new_n121_), .O(z7));
endmodule
