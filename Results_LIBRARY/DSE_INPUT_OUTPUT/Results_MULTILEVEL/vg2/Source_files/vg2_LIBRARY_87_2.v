...
module FAU ( 
  ...
  nand2  g070(.a(new_n35_), .b(x02), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n103_), .c(new_n95_), .d(new_n82_), .O(z1));
  nand2  g072(.a(x24), .b(x18), .O(new_n106_));
  nand3  g073(.a(new_n41_), .b(x15), .c(x13), .O(new_n107_));
  aoi21  g074(.a(new_n107_), .b(new_n106_), .c(new_n46_), .O(new_n108_));
  ...
  nor3   g080(.a(new_n113_), .b(new_n39_), .c(new_n38_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x11), .c(x06), .d(x03), .O(new_n115_));
  nor2   g082(.a(new_n115_), .b(new_n56_), .O(z2));
  ...
  nand4  g086(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n56_), .O(new_n120_));
  nand4  g087(.a(new_n74_), .b(new_n38_), .c(new_n37_), .d(new_n67_), .O(new_n121_));
  oai22  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n117_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n81_), .O(new_n123_));
  nand2  g090(.a(new_n118_), .b(new_n86_), .O(new_n124_));
  nor2   g091(.a(x20), .b(x14), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n37_), .c(new_n67_), .d(x07), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n120_), .c(new_n124_), .d(new_n117_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n79_), .c(x24), .O(new_n128_));
  nand4  g095(.a(new_n36_), .b(new_n35_), .c(new_n56_), .d(x00), .O(new_n129_));
  nand3  g096(.a(new_n125_), .b(new_n37_), .c(new_n67_), .O(new_n130_));
  nand2  g097(.a(new_n118_), .b(new_n97_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n117_), .c(new_n130_), .d(new_n129_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n41_), .c(new_n96_), .d(new_n34_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n128_), .c(new_n123_), .O(z3));
  nand2  g101(.a(new_n104_), .b(x08), .O(new_n135_));
  inv1   g102(.a(x16), .O(new_n136_));
  inv1   g103(.a(x09), .O(new_n137_));
  aoi21  g104(.a(new_n62_), .b(x04), .c(x17), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(x22), .c(new_n137_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n136_), .c(new_n67_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n135_), .c(new_n40_), .O(new_n141_));
  inv1   g108(.a(x17), .O(new_n142_));
  aoi21  g109(.a(x23), .b(new_n57_), .c(new_n142_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n61_), .c(x09), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(x16), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x08), .c(new_n85_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n141_), .c(new_n79_), .O(new_n147_));
  nand4  g114(.a(new_n49_), .b(x08), .c(new_n46_), .d(x03), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(x24), .O(new_n150_));
  nand2  g117(.a(new_n81_), .b(x15), .O(new_n151_));
  aoi22  g118(.a(new_n151_), .b(new_n111_), .c(new_n145_), .d(x08), .O(new_n152_));
  nand2  g119(.a(x24), .b(x08), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n78_), .c(new_n46_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n80_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(x19), .O(new_n156_));
  nand3  g123(.a(new_n47_), .b(new_n34_), .c(x00), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n139_), .c(new_n136_), .O(new_n159_));
  nand2  g126(.a(x13), .b(x05), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n79_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n41_), .c(x19), .O(new_n162_));
  oai21  g129(.a(new_n50_), .b(x02), .c(new_n162_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(x08), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n159_), .c(new_n104_), .O(new_n165_));
  nor2   g132(.a(new_n165_), .b(new_n152_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n150_), .O(z4));
  nand2  g134(.a(new_n49_), .b(new_n46_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n45_), .c(new_n44_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n104_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n157_), .O(z5));
  oai21  g138(.a(new_n39_), .b(x14), .c(new_n36_), .O(new_n172_));
  nand3  g139(.a(new_n47_), .b(new_n35_), .c(x00), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n168_), .c(new_n45_), .d(new_n44_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n172_), .c(new_n37_), .O(new_n175_));
  oai21  g142(.a(x20), .b(new_n38_), .c(x06), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(x11), .c(new_n35_), .O(new_n177_));
  oai22  g144(.a(new_n177_), .b(new_n85_), .c(new_n40_), .d(new_n35_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n79_), .c(x24), .O(new_n179_));
  inv1   g146(.a(x15), .O(new_n180_));
  oai22  g147(.a(new_n177_), .b(new_n180_), .c(new_n48_), .d(new_n35_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n81_), .O(new_n182_));
  nand3  g149(.a(new_n41_), .b(x21), .c(new_n96_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n34_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n35_), .O(new_n185_));
  nand3  g152(.a(new_n176_), .b(x21), .c(x11), .O(new_n186_));
  nand2  g153(.a(x03), .b(x00), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand4  g155(.a(new_n188_), .b(new_n41_), .c(new_n96_), .d(new_n34_), .O(new_n189_));
  and2   g156(.a(new_n189_), .b(new_n185_), .O(new_n190_));
  nand4  g157(.a(new_n190_), .b(new_n182_), .c(new_n179_), .d(new_n175_), .O(z6));
  nand2  g158(.a(new_n185_), .b(new_n113_), .O(z7));
endmodule
