...
module FAU ( 
  ...
  nand3  g084(.a(new_n117_), .b(x20), .c(x18), .O(new_n118_));
  nand3  g085(.a(new_n95_), .b(x07), .c(new_n35_), .O(new_n119_));
  inv1   g086(.a(x08), .O(new_n120_));
  nand4  g087(.a(new_n37_), .b(new_n104_), .c(new_n36_), .d(new_n120_), .O(new_n121_));
  oai22  g088(.a(new_n121_), .b(new_n119_), .c(new_n118_), .d(new_n116_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n70_), .O(new_n123_));
  nand3  g090(.a(new_n117_), .b(x20), .c(x15), .O(new_n124_));
  nand2  g091(.a(new_n95_), .b(new_n77_), .O(new_n125_));
  nand3  g092(.a(new_n82_), .b(new_n104_), .c(new_n36_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n116_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n46_), .c(new_n38_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n123_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(x24), .O(new_n130_));
  nand2  g097(.a(new_n127_), .b(new_n90_), .O(new_n131_));
  nand4  g098(.a(new_n35_), .b(new_n34_), .c(new_n103_), .d(x00), .O(new_n132_));
  nand3  g099(.a(new_n117_), .b(x21), .c(x20), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n116_), .c(new_n132_), .d(new_n121_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n40_), .c(new_n44_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n88_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n130_), .O(z3));
  ...
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n120_), .O(new_n144_));
  nand4  g111(.a(new_n40_), .b(x19), .c(x13), .d(new_n88_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n39_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(x05), .O(new_n147_));
  nand2  g114(.a(new_n47_), .b(new_n45_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n88_), .O(new_n149_));
  nand2  g116(.a(x13), .b(x07), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n47_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(x24), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n149_), .c(new_n147_), .O(z5));
  nand2  g120(.a(z5), .b(new_n144_), .O(new_n154_));
  inv1   g121(.a(x16), .O(new_n155_));
  inv1   g122(.a(x23), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x04), .c(x17), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x22), .c(new_n76_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n155_), .c(x08), .O(new_n159_));
  oai21  g126(.a(new_n111_), .b(new_n107_), .c(new_n159_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n154_), .c(new_n52_), .O(z4));
  aoi21  g128(.a(x20), .b(new_n104_), .c(x06), .O(new_n162_));
  ...
  nand4  g133(.a(new_n40_), .b(x15), .c(x13), .d(new_n88_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n105_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x05), .O(new_n169_));
  nand2  g136(.a(new_n110_), .b(new_n109_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n88_), .O(new_n171_));
  nand2  g138(.a(x18), .b(x13), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n109_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(x24), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n171_), .c(new_n169_), .O(z7));
  nand2  g142(.a(z7), .b(new_n166_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n164_), .O(z6));
endmodule
