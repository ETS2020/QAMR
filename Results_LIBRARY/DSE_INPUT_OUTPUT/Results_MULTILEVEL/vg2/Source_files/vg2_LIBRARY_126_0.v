...
module FAU ( 
  ...
  nand3  g077(.a(new_n51_), .b(new_n50_), .c(new_n37_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n110_), .O(z7));
  nand4  g079(.a(z7), .b(x20), .c(x14), .d(x11), .O(new_n113_));
  nor4   g080(.a(new_n113_), .b(new_n34_), .c(new_n103_), .d(new_n102_), .O(z2));
  nand3  g081(.a(x15), .b(x13), .c(x05), .O(new_n115_));
  oai21  g082(.a(x10), .b(x02), .c(new_n115_), .O(new_n116_));
  ...
  nand3  g087(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n121_));
  nand3  g088(.a(x19), .b(x13), .c(x05), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n120_), .c(new_n36_), .d(new_n35_), .O(new_n124_));
  nor2   g091(.a(new_n124_), .b(x08), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n34_), .c(new_n103_), .d(new_n102_), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(new_n119_), .c(x24), .O(new_n127_));
  nand3  g094(.a(new_n59_), .b(x03), .c(x01), .O(new_n128_));
  nand3  g095(.a(new_n83_), .b(x14), .c(x11), .O(new_n129_));
  nand3  g096(.a(new_n94_), .b(x07), .c(new_n34_), .O(new_n130_));
  nand4  g097(.a(new_n120_), .b(new_n36_), .c(new_n35_), .d(new_n58_), .O(new_n131_));
  ...
  nand3  g102(.a(new_n73_), .b(new_n36_), .c(new_n35_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n128_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n46_), .c(new_n40_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n133_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n127_), .c(x21), .O(new_n140_));
  nand2  g107(.a(new_n137_), .b(new_n79_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n133_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(x02), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n140_), .O(z3));
  inv1   g111(.a(x22), .O(new_n145_));
  inv1   g112(.a(x04), .O(new_n146_));
  inv1   g113(.a(x17), .O(new_n147_));
  oai21  g114(.a(x23), .b(new_n146_), .c(new_n147_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n145_), .c(x09), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x16), .c(new_n58_), .O(new_n150_));
  oai21  g117(.a(new_n48_), .b(new_n44_), .c(new_n150_), .O(new_n151_));
  ...
  nand3  g123(.a(new_n42_), .b(new_n50_), .c(new_n37_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n108_), .c(new_n107_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n106_), .c(new_n156_), .O(new_n159_));
  nand3  g126(.a(new_n42_), .b(new_n50_), .c(x00), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(x21), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n37_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n151_), .O(z4));
  nor2   g130(.a(new_n48_), .b(new_n44_), .O(new_n164_));
  nand2  g131(.a(new_n162_), .b(new_n164_), .O(z5));
  aoi21  g132(.a(new_n120_), .b(x14), .c(new_n34_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n35_), .c(x03), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(z7), .O(new_n168_));
  oai21  g135(.a(new_n120_), .b(x14), .c(new_n34_), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(new_n35_), .c(x03), .O(new_n170_));
  nor2   g137(.a(new_n170_), .b(new_n164_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n39_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n168_), .c(new_n52_), .O(z6));
endmodule
