...
module FAU ( 
  ...
  oai21  g010(.a(new_n43_), .b(new_n38_), .c(x04), .O(new_n44_));
  ...
  oai22  g048(.a(new_n81_), .b(new_n75_), .c(new_n69_), .d(new_n65_), .O(new_n82_));
  ...
  nand4  g055(.a(new_n88_), .b(new_n67_), .c(x20), .d(x18), .O(new_n89_));
  inv1   g056(.a(x07), .O(new_n90_));
  nor2   g057(.a(new_n90_), .b(x06), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n73_), .c(new_n70_), .d(new_n61_), .O(new_n92_));
  ...
  oai22  g063(.a(new_n96_), .b(new_n92_), .c(new_n89_), .d(new_n65_), .O(new_n97_));
  ...
  nand4  g073(.a(new_n106_), .b(new_n103_), .c(new_n100_), .d(new_n88_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n98_), .c(new_n86_), .O(z1));
  ...
  oai21  g079(.a(new_n112_), .b(new_n109_), .c(x04), .O(new_n113_));
  ...
  nand3  g106(.a(new_n91_), .b(new_n36_), .c(new_n35_), .O(new_n140_));
  ...
  nand3  g111(.a(new_n74_), .b(new_n36_), .c(new_n35_), .O(new_n145_));
  nand3  g112(.a(new_n79_), .b(new_n39_), .c(new_n46_), .O(new_n146_));
  ...
  oai21  g116(.a(new_n149_), .b(new_n137_), .c(x04), .O(new_n150_));
  nand2  g117(.a(new_n147_), .b(new_n85_), .O(new_n151_));
  ...
  aoi21  g123(.a(x22), .b(new_n156_), .c(new_n70_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n155_), .c(x08), .O(new_n158_));
  nor2   g125(.a(x04), .b(x02), .O(new_n159_));
  nand4  g126(.a(new_n111_), .b(new_n101_), .c(x04), .d(new_n34_), .O(new_n160_));
  oai21  g127(.a(new_n159_), .b(new_n121_), .c(new_n160_), .O(z7));
  nand2  g128(.a(z7), .b(new_n158_), .O(new_n162_));
  inv1   g129(.a(new_n159_), .O(new_n163_));
  inv1   g130(.a(x22), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x17), .c(x09), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x16), .c(new_n61_), .O(new_n166_));
  nor2   g133(.a(x16), .b(new_n71_), .O(new_n167_));
  aoi22  g134(.a(new_n167_), .b(new_n80_), .c(new_n166_), .d(new_n163_), .O(new_n168_));
  nand3  g135(.a(x15), .b(new_n71_), .c(x02), .O(new_n169_));
  nand2  g136(.a(new_n67_), .b(x16), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n169_), .c(new_n168_), .d(new_n78_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n85_), .O(new_n172_));
  nor2   g139(.a(new_n155_), .b(x04), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n67_), .c(x18), .d(x02), .O(new_n174_));
  oai21  g141(.a(new_n168_), .b(new_n90_), .c(new_n174_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n83_), .c(x24), .O(new_n176_));
  aoi21  g143(.a(x23), .b(new_n156_), .c(x22), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(x09), .c(new_n155_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n61_), .O(new_n179_));
  nand4  g146(.a(new_n179_), .b(new_n41_), .c(new_n101_), .d(x04), .O(new_n180_));
  inv1   g147(.a(new_n180_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n34_), .c(x00), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n176_), .c(new_n172_), .d(new_n162_), .O(z4));
  nor2   g150(.a(x24), .b(x10), .O(new_n184_));
  nand4  g151(.a(new_n184_), .b(x04), .c(new_n34_), .d(x00), .O(new_n185_));
  oai21  g152(.a(new_n159_), .b(new_n55_), .c(new_n185_), .O(z5));
  nand2  g153(.a(x20), .b(new_n39_), .O(new_n187_));
  aoi21  g154(.a(new_n187_), .b(new_n37_), .c(x11), .O(new_n188_));
  nand3  g155(.a(new_n184_), .b(new_n34_), .c(x00), .O(new_n189_));
  nand3  g156(.a(new_n189_), .b(new_n53_), .c(new_n51_), .O(new_n190_));
  oai22  g157(.a(new_n190_), .b(new_n50_), .c(new_n188_), .d(x03), .O(new_n191_));
  oai21  g158(.a(x20), .b(new_n39_), .c(x06), .O(new_n192_));
  nand3  g159(.a(new_n192_), .b(x11), .c(x03), .O(new_n193_));
  oai21  g160(.a(new_n71_), .b(x03), .c(new_n193_), .O(new_n194_));
  nand3  g161(.a(new_n111_), .b(new_n101_), .c(new_n34_), .O(new_n195_));
  nand3  g162(.a(new_n195_), .b(new_n119_), .c(new_n118_), .O(new_n196_));
  oai21  g163(.a(new_n196_), .b(new_n117_), .c(new_n194_), .O(new_n197_));
  inv1   g164(.a(new_n121_), .O(new_n198_));
  nand3  g165(.a(new_n198_), .b(new_n36_), .c(x02), .O(new_n199_));
  nand4  g166(.a(new_n199_), .b(new_n197_), .c(new_n191_), .d(new_n163_), .O(z6));
endmodule
