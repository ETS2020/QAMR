...
module FAU ( 
  ...
  oai21  g124(.a(new_n106_), .b(x04), .c(x17), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x22), .c(new_n62_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n68_), .c(x08), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n154_), .c(new_n121_), .O(z4));
  nand4  g129(.a(new_n152_), .b(new_n121_), .c(new_n44_), .d(new_n150_), .O(z5));
  nand2  g130(.a(x20), .b(new_n67_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n36_), .c(x11), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x03), .c(new_n153_), .O(new_n166_));
  nand2  g133(.a(new_n38_), .b(x14), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x06), .c(new_n37_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n35_), .c(new_n157_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n121_), .O(z6));
  and2   g137(.a(new_n121_), .b(new_n114_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n116_), .c(new_n115_), .d(new_n155_), .O(z7));
endmodule
