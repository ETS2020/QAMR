...
module FAU ( 
  ...
  nand2  g018(.a(x22), .b(x11), .O(new_n52_));
  ...
  nand2  g045(.a(new_n78_), .b(x20), .O(new_n79_));
  nor2   g046(.a(new_n79_), .b(new_n70_), .O(new_n80_));
  nand4  g047(.a(new_n80_), .b(x06), .c(x03), .d(x01), .O(new_n81_));
  aoi21  g048(.a(new_n81_), .b(new_n69_), .c(new_n36_), .O(z2));
  inv1   g049(.a(x08), .O(new_n83_));
  nand3  g050(.a(x15), .b(x13), .c(x05), .O(new_n84_));
  nand3  g051(.a(x21), .b(new_n44_), .c(new_n43_), .O(new_n85_));
  aoi21  g052(.a(new_n85_), .b(new_n84_), .c(x22), .O(new_n86_));
  ...
  nand4  g059(.a(new_n92_), .b(new_n59_), .c(new_n70_), .d(new_n36_), .O(new_n93_));
  inv1   g060(.a(new_n93_), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n83_), .c(new_n35_), .d(new_n34_), .O(new_n95_));
  oai21  g062(.a(new_n95_), .b(x01), .c(new_n89_), .O(new_n96_));
  nand2  g063(.a(new_n96_), .b(new_n39_), .O(new_n97_));
  nor2   g064(.a(x03), .b(x01), .O(new_n98_));
  nand4  g065(.a(new_n59_), .b(new_n70_), .c(new_n36_), .d(new_n83_), .O(new_n99_));
  ...
  nor2   g070(.a(new_n70_), .b(new_n36_), .O(new_n104_));
  nor2   g071(.a(x22), .b(new_n59_), .O(new_n105_));
  ...
  inv1   g081(.a(new_n49_), .O(new_n115_));
  oai21  g082(.a(x16), .b(new_n55_), .c(new_n83_), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n52_), .O(new_n117_));
  oai21  g084(.a(x23), .b(new_n54_), .c(new_n58_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(new_n69_), .c(new_n57_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n115_), .O(new_n121_));
  oai21  g088(.a(new_n57_), .b(x09), .c(x08), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n52_), .O(new_n123_));
  oai21  g090(.a(new_n60_), .b(x04), .c(x17), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x22), .c(x16), .d(new_n36_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n78_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n121_), .O(z4));
  inv1   g095(.a(new_n41_), .O(new_n129_));
  and2   g096(.a(new_n45_), .b(new_n42_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n52_), .c(new_n47_), .d(new_n129_), .O(z5));
  inv1   g098(.a(x21), .O(new_n132_));
  nand2  g099(.a(x03), .b(x00), .O(new_n133_));
  ...
  oai21  g104(.a(new_n136_), .b(x03), .c(new_n137_), .O(new_n138_));
  ...
  oai21  g113(.a(new_n146_), .b(new_n140_), .c(new_n52_), .O(new_n147_));
  oai21  g114(.a(new_n59_), .b(x14), .c(new_n35_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n115_), .c(new_n36_), .O(new_n149_));
  oai21  g116(.a(x20), .b(new_n70_), .c(x06), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n78_), .c(new_n69_), .d(x11), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n149_), .c(new_n147_), .O(z6));
  and2   g119(.a(new_n78_), .b(new_n52_), .O(z7));
endmodule
