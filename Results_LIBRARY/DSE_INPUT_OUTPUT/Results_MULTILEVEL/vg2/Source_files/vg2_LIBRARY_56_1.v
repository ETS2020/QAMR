...
module FAU ( 
  ...
  nor2   g060(.a(new_n76_), .b(new_n75_), .O(new_n94_));
  ...
  nand4  g064(.a(new_n97_), .b(new_n96_), .c(x07), .d(new_n38_), .O(new_n98_));
  nand4  g065(.a(new_n73_), .b(new_n41_), .c(new_n59_), .d(new_n40_), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  nor2   g067(.a(x23), .b(x22), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n100_), .c(new_n42_), .d(new_n74_), .O(new_n102_));
  oai21  g069(.a(new_n102_), .b(new_n98_), .c(new_n95_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n88_), .c(x24), .O(new_n104_));
  ...
  nand4  g076(.a(new_n109_), .b(new_n96_), .c(new_n40_), .d(new_n72_), .O(new_n110_));
  ...
  nand3  g083(.a(new_n116_), .b(new_n52_), .c(new_n47_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n104_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n87_), .c(new_n35_), .O(new_n119_));
  nand3  g086(.a(new_n43_), .b(x13), .c(x05), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n88_), .O(new_n121_));
  ...
  nand4  g092(.a(x11), .b(x06), .c(x03), .d(x01), .O(new_n126_));
  nor2   g093(.a(x24), .b(new_n60_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(x20), .c(x14), .O(new_n128_));
  ...
  nand3  g098(.a(new_n43_), .b(x15), .c(x13), .O(new_n132_));
  ...
  nand3  g102(.a(x15), .b(new_n52_), .c(new_n47_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .O(new_n137_));
  inv1   g104(.a(new_n137_), .O(new_n138_));
  nor3   g105(.a(new_n138_), .b(new_n42_), .c(new_n41_), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(x11), .c(x06), .d(x03), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(new_n36_), .c(new_n130_), .O(z2));
  nand4  g108(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n142_));
  nor2   g109(.a(new_n41_), .b(new_n40_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(x20), .c(x15), .O(new_n144_));
  nand3  g111(.a(new_n109_), .b(new_n37_), .c(new_n36_), .O(new_n145_));
  nand3  g112(.a(new_n114_), .b(new_n41_), .c(new_n40_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n142_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n121_), .O(new_n148_));
  inv1   g115(.a(new_n142_), .O(new_n149_));
  nand3  g116(.a(new_n143_), .b(new_n149_), .c(new_n93_), .O(new_n150_));
  ...
  oai21  g119(.a(new_n152_), .b(new_n151_), .c(new_n150_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n88_), .c(x24), .O(new_n154_));
  or2    g121(.a(new_n152_), .b(new_n39_), .O(new_n155_));
  nand4  g122(.a(new_n143_), .b(new_n149_), .c(x21), .d(x20), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n155_), .c(x24), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x10), .c(new_n34_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n154_), .c(new_n148_), .O(z3));
  oai21  g126(.a(x23), .b(new_n70_), .c(new_n74_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n75_), .c(x09), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x16), .c(new_n71_), .O(new_n162_));
  nor2   g129(.a(new_n35_), .b(x02), .O(new_n163_));
  nand4  g130(.a(new_n43_), .b(new_n35_), .c(new_n34_), .d(x00), .O(new_n164_));
  oai21  g131(.a(new_n163_), .b(new_n55_), .c(new_n164_), .O(z5));
  nand2  g132(.a(z5), .b(new_n162_), .O(new_n166_));
  oai21  g133(.a(new_n76_), .b(x04), .c(x17), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x22), .c(new_n72_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n73_), .c(x08), .O(new_n169_));
  nand3  g136(.a(new_n127_), .b(new_n35_), .c(new_n34_), .O(new_n170_));
  oai21  g137(.a(new_n163_), .b(new_n138_), .c(new_n170_), .O(z7));
  nand2  g138(.a(z7), .b(new_n169_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n166_), .O(z4));
  inv1   g140(.a(new_n163_), .O(new_n174_));
  nand2  g141(.a(x20), .b(new_n41_), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(new_n38_), .c(x11), .O(new_n176_));
  nand3  g143(.a(new_n43_), .b(new_n34_), .c(x00), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n53_), .c(new_n51_), .O(new_n178_));
  oai22  g145(.a(new_n178_), .b(new_n50_), .c(new_n176_), .d(x03), .O(new_n179_));
  oai21  g146(.a(x20), .b(new_n41_), .c(x06), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(x11), .c(x03), .O(new_n181_));
  oai21  g148(.a(x10), .b(x03), .c(new_n181_), .O(new_n182_));
  nand2  g149(.a(new_n127_), .b(new_n34_), .O(new_n183_));
  nand3  g150(.a(new_n183_), .b(new_n136_), .c(new_n135_), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n133_), .c(new_n182_), .O(new_n185_));
  nand3  g152(.a(new_n137_), .b(new_n37_), .c(x02), .O(new_n186_));
  nand4  g153(.a(new_n186_), .b(new_n185_), .c(new_n179_), .d(new_n174_), .O(z6));
endmodule
