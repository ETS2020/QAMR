...
module FAU ( 
  ...
  nand4  g113(.a(new_n146_), .b(new_n107_), .c(x01), .d(x00), .O(new_n147_));
  ...
  nor2   g121(.a(new_n117_), .b(new_n115_), .O(new_n155_));
  ...
  aoi21  g126(.a(new_n146_), .b(x00), .c(new_n66_), .O(new_n160_));
