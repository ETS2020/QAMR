...
module FAU ( 
  ...
  nand3  g074(.a(x15), .b(new_n45_), .c(new_n44_), .O(new_n108_));
  oai21  g075(.a(new_n105_), .b(new_n45_), .c(new_n108_), .O(new_n109_));
  oai21  g076(.a(new_n109_), .b(new_n107_), .c(new_n53_), .O(new_n110_));
  nand4  g077(.a(new_n81_), .b(x21), .c(new_n38_), .d(new_n55_), .O(new_n111_));
  aoi21  g078(.a(new_n111_), .b(new_n110_), .c(new_n37_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(x14), .c(x11), .d(x06), .O(new_n113_));
  nor3   g080(.a(new_n113_), .b(new_n34_), .c(new_n104_), .O(z2));
  nand3  g081(.a(x15), .b(x13), .c(x05), .O(new_n115_));
  nand3  g082(.a(x21), .b(new_n38_), .c(new_n55_), .O(new_n116_));
  ...
  nand3  g087(.a(new_n38_), .b(new_n55_), .c(x00), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n42_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n37_), .c(new_n72_), .d(new_n36_), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(x08), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n35_), .c(new_n34_), .d(new_n104_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n120_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n81_), .O(new_n127_));
  nand4  g094(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n128_));
  nand4  g095(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n129_));
  nand3  g096(.a(new_n98_), .b(x07), .c(new_n35_), .O(new_n130_));
  nand4  g097(.a(new_n37_), .b(new_n72_), .c(new_n36_), .d(new_n68_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n128_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n46_), .c(x24), .O(new_n133_));
  nand4  g100(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n134_));
  nand3  g101(.a(new_n98_), .b(new_n68_), .c(new_n35_), .O(new_n135_));
  nand4  g102(.a(new_n37_), .b(x19), .c(new_n72_), .d(new_n36_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n128_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n45_), .c(new_n44_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n133_), .c(new_n127_), .d(new_n53_), .O(z3));
  inv1   g106(.a(x04), .O(new_n140_));
  oai21  g107(.a(x23), .b(new_n140_), .c(new_n74_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n63_), .c(x09), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x16), .c(new_n68_), .O(new_n143_));
  nand2  g110(.a(x24), .b(x07), .O(new_n144_));
  nand3  g111(.a(new_n81_), .b(x19), .c(x13), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n144_), .c(new_n44_), .O(new_n146_));
  nand3  g113(.a(x24), .b(x13), .c(x07), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n48_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n146_), .c(new_n53_), .O(new_n149_));
  nand4  g116(.a(new_n81_), .b(new_n38_), .c(new_n55_), .d(x00), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n149_), .O(z5));
  nand2  g118(.a(z5), .b(new_n143_), .O(new_n152_));
  nand2  g119(.a(new_n111_), .b(new_n110_), .O(z7));
  ...
  nand2  g124(.a(new_n157_), .b(new_n152_), .O(z4));
  nand2  g125(.a(x20), .b(new_n72_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n35_), .c(x11), .O(new_n160_));
  nand3  g127(.a(new_n150_), .b(new_n147_), .c(new_n48_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n146_), .c(new_n160_), .d(x03), .O(new_n162_));
  oai21  g129(.a(x20), .b(new_n72_), .c(x06), .O(new_n163_));
  oai21  g130(.a(new_n105_), .b(new_n34_), .c(new_n106_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(x05), .O(new_n165_));
  nand2  g132(.a(new_n109_), .b(x03), .O(new_n166_));
  nand2  g133(.a(new_n116_), .b(new_n108_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n81_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n166_), .c(new_n165_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n163_), .c(x11), .O(new_n170_));
  nand3  g137(.a(new_n53_), .b(new_n46_), .c(x18), .O(new_n171_));
  nand4  g138(.a(x15), .b(new_n45_), .c(new_n39_), .d(new_n44_), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n171_), .c(new_n81_), .O(new_n173_));
  nand3  g140(.a(new_n81_), .b(x21), .c(new_n38_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n108_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n55_), .O(new_n176_));
  nand2  g143(.a(x13), .b(x05), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n46_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n81_), .c(x15), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n176_), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n173_), .c(new_n34_), .O(new_n181_));
  nand4  g148(.a(new_n181_), .b(new_n170_), .c(new_n162_), .d(new_n53_), .O(z6));
endmodule
