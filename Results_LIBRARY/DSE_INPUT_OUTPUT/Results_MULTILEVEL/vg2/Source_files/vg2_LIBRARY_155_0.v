...
module FAU ( 
  ...
  oai21  g045(.a(new_n78_), .b(new_n54_), .c(new_n73_), .O(z2));
  ...
  nand3  g065(.a(new_n75_), .b(new_n56_), .c(x12), .O(new_n99_));
  nor3   g066(.a(new_n99_), .b(x11), .c(x08), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n98_), .c(x07), .d(new_n35_), .O(new_n101_));
  aoi22  g068(.a(new_n101_), .b(new_n97_), .c(new_n47_), .d(new_n38_), .O(new_n102_));
  nand4  g069(.a(new_n96_), .b(new_n95_), .c(x20), .d(x15), .O(new_n103_));
  nand3  g070(.a(new_n75_), .b(x19), .c(new_n56_), .O(new_n104_));
  nor3   g071(.a(new_n104_), .b(new_n37_), .c(x11), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n98_), .c(new_n55_), .d(new_n35_), .O(new_n106_));
  aoi21  g073(.a(new_n106_), .b(new_n103_), .c(x13), .O(new_n107_));
  aoi22  g074(.a(new_n107_), .b(new_n38_), .c(new_n102_), .d(x24), .O(new_n108_));
  nand2  g075(.a(new_n108_), .b(new_n93_), .O(z3));
  ...
  inv1   g092(.a(new_n42_), .O(new_n126_));
  and2   g093(.a(new_n46_), .b(new_n43_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n73_), .c(new_n48_), .d(new_n126_), .O(z5));
  nand2  g095(.a(x20), .b(new_n56_), .O(new_n129_));
  aoi21  g096(.a(new_n129_), .b(new_n35_), .c(x11), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(x03), .c(new_n110_), .O(new_n131_));
  nand2  g098(.a(new_n75_), .b(x14), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(x06), .c(new_n36_), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n34_), .c(new_n117_), .O(new_n134_));
