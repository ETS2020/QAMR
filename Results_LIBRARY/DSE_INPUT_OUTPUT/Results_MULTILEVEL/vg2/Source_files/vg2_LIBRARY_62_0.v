...
module FAU ( 
  ...
  nor2   g104(.a(new_n46_), .b(new_n42_), .O(new_n138_));
  nor2   g105(.a(x02), .b(x01), .O(new_n139_));
  nor2   g106(.a(x24), .b(x10), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n108_), .c(x01), .d(x00), .O(new_n141_));
  oai21  g108(.a(new_n139_), .b(new_n138_), .c(new_n141_), .O(new_n142_));
  ...
  nor2   g117(.a(new_n150_), .b(new_n105_), .O(new_n151_));
  nand2  g118(.a(new_n128_), .b(new_n94_), .O(new_n152_));
  inv1   g119(.a(new_n152_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n91_), .O(new_n154_));
  oai21  g121(.a(new_n151_), .b(new_n139_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n149_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n143_), .O(z4));
  aoi21  g124(.a(new_n140_), .b(x00), .c(new_n61_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x02), .c(new_n138_), .O(z5));
  inv1   g126(.a(new_n139_), .O(new_n160_));
  nand2  g127(.a(x20), .b(new_n102_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n35_), .c(x11), .O(new_n162_));
  nand3  g129(.a(new_n140_), .b(new_n108_), .c(x00), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n45_), .c(new_n43_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n42_), .c(new_n162_), .d(x03), .O(new_n165_));
  nand2  g132(.a(new_n37_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n36_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n34_), .c(new_n110_), .d(new_n105_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n160_), .O(z6));
  oai21  g136(.a(new_n153_), .b(new_n61_), .c(new_n108_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n151_), .O(z7));
endmodule
