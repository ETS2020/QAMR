...
module FAU ( 
  ...
  nand4  g031(.a(new_n57_), .b(new_n34_), .c(new_n44_), .d(new_n56_), .O(new_n65_));
  inv1   g032(.a(new_n65_), .O(new_n66_));
  nor2   g033(.a(x08), .b(x06), .O(new_n67_));
  nand4  g034(.a(new_n67_), .b(new_n66_), .c(new_n36_), .d(new_n53_), .O(new_n68_));
  ...
  nand4  g050(.a(new_n83_), .b(new_n81_), .c(new_n61_), .d(new_n59_), .O(new_n84_));
  ...
  nand3  g059(.a(new_n61_), .b(x21), .c(x20), .O(new_n93_));
  nor2   g060(.a(new_n93_), .b(new_n80_), .O(new_n94_));
  nand2  g061(.a(new_n94_), .b(new_n59_), .O(new_n95_));
  ...
  nand3  g067(.a(new_n100_), .b(new_n92_), .c(new_n79_), .O(z1));
  ...
  oai21  g072(.a(new_n102_), .b(new_n47_), .c(new_n105_), .O(new_n106_));
  oai21  g073(.a(new_n106_), .b(new_n104_), .c(new_n54_), .O(new_n107_));
  ...
  nor3   g077(.a(new_n110_), .b(new_n34_), .c(new_n56_), .O(z2));
  inv1   g078(.a(x08), .O(new_n112_));
  nand3  g079(.a(x15), .b(x13), .c(x05), .O(new_n113_));
  nand3  g080(.a(x21), .b(new_n45_), .c(new_n44_), .O(new_n114_));
  ...
  nand4  g089(.a(new_n122_), .b(new_n37_), .c(new_n119_), .d(new_n36_), .O(new_n123_));
  ...
  nand3  g096(.a(new_n96_), .b(x07), .c(new_n35_), .O(new_n130_));
  nand4  g097(.a(new_n37_), .b(new_n119_), .c(new_n36_), .d(new_n112_), .O(new_n131_));
  ...
  nand2  g101(.a(new_n96_), .b(new_n67_), .O(new_n135_));
  nand3  g102(.a(new_n72_), .b(new_n119_), .c(new_n36_), .O(new_n136_));
  ...
  nand4  g105(.a(new_n138_), .b(new_n133_), .c(new_n127_), .d(new_n54_), .O(z3));
  inv1   g106(.a(x00), .O(new_n140_));
  oai21  g107(.a(x10), .b(new_n140_), .c(new_n121_), .O(new_n141_));
  inv1   g108(.a(x16), .O(new_n142_));
  inv1   g109(.a(x22), .O(new_n143_));
  inv1   g110(.a(x17), .O(new_n144_));
  oai21  g111(.a(x23), .b(new_n57_), .c(new_n144_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n143_), .c(new_n142_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n112_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n141_), .O(new_n148_));
  oai21  g115(.a(new_n142_), .b(x09), .c(x08), .O(new_n149_));
  inv1   g116(.a(x21), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x10), .c(new_n113_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  inv1   g119(.a(x23), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x04), .c(x17), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(x22), .c(x21), .d(x16), .O(new_n155_));
  nand3  g122(.a(new_n142_), .b(x09), .c(x00), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n45_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n152_), .c(new_n148_), .O(new_n159_));
  nand2  g126(.a(new_n76_), .b(x24), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n82_), .c(new_n105_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n149_), .O(new_n162_));
  inv1   g129(.a(x07), .O(new_n163_));
  oai21  g130(.a(new_n160_), .b(new_n163_), .c(new_n48_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n147_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n162_), .O(new_n166_));
  aoi21  g133(.a(new_n159_), .b(new_n40_), .c(new_n166_), .O(new_n167_));
  nor2   g134(.a(new_n106_), .b(new_n104_), .O(new_n168_));
  nand3  g135(.a(new_n154_), .b(x22), .c(x16), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x08), .c(new_n168_), .O(new_n170_));
  nand2  g137(.a(new_n48_), .b(new_n43_), .O(new_n171_));
  nor2   g138(.a(new_n171_), .b(new_n42_), .O(new_n172_));
  aoi21  g139(.a(x16), .b(new_n112_), .c(new_n172_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n170_), .c(x09), .O(new_n174_));
  oai21  g141(.a(new_n167_), .b(x02), .c(new_n174_), .O(z4));
  inv1   g142(.a(new_n54_), .O(new_n176_));
  oai21  g143(.a(new_n172_), .b(new_n176_), .c(new_n46_), .O(z5));
  aoi21  g144(.a(x20), .b(new_n119_), .c(x06), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(x11), .c(new_n34_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(z5), .O(new_n180_));
  nand2  g147(.a(new_n108_), .b(new_n107_), .O(z7));
  aoi21  g148(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(new_n36_), .c(x03), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(z7), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n180_), .O(z6));
endmodule
