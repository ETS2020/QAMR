...
module FAU ( 
  ...
  aoi21  g064(.a(new_n97_), .b(new_n38_), .c(new_n95_), .O(new_n98_));
  nand2  g065(.a(new_n98_), .b(new_n93_), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n50_), .c(x20), .d(x14), .O(new_n100_));
  inv1   g067(.a(new_n100_), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(x11), .c(x06), .d(x03), .O(new_n102_));
  nor2   g069(.a(new_n102_), .b(new_n89_), .O(z2));
  nand4  g070(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n104_));
  nand4  g071(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n105_));
  nand3  g072(.a(new_n63_), .b(new_n34_), .c(new_n89_), .O(new_n106_));
  inv1   g073(.a(x14), .O(new_n107_));
  nand3  g074(.a(new_n68_), .b(new_n107_), .c(new_n36_), .O(new_n108_));
  oai22  g075(.a(new_n108_), .b(new_n106_), .c(new_n105_), .d(new_n104_), .O(new_n109_));
  nand2  g076(.a(new_n109_), .b(new_n74_), .O(new_n110_));
  nand4  g077(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n111_));
  nand4  g078(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n89_), .O(new_n112_));
  inv1   g079(.a(x08), .O(new_n113_));
  nand4  g080(.a(new_n37_), .b(new_n107_), .c(new_n36_), .d(new_n113_), .O(new_n114_));
  oai22  g081(.a(new_n114_), .b(new_n112_), .c(new_n111_), .d(new_n104_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n72_), .c(x24), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n110_), .c(new_n52_), .O(z3));
  inv1   g084(.a(new_n42_), .O(new_n118_));
  nand3  g085(.a(new_n45_), .b(new_n43_), .c(new_n118_), .O(new_n119_));
  ...
  aoi21  g090(.a(new_n123_), .b(new_n120_), .c(x09), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(x16), .c(new_n113_), .O(new_n125_));
  ...
  aoi21  g096(.a(new_n129_), .b(x22), .c(new_n61_), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n127_), .c(x08), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n99_), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(new_n126_), .c(new_n52_), .O(z4));
  nand4  g100(.a(new_n50_), .b(new_n45_), .c(new_n43_), .d(new_n118_), .O(z5));
  oai21  g101(.a(x20), .b(new_n107_), .c(x06), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(x11), .c(x03), .O(new_n136_));
  oai21  g103(.a(new_n52_), .b(x03), .c(new_n136_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n99_), .O(new_n138_));
  nand2  g105(.a(x20), .b(new_n107_), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(new_n35_), .c(x11), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x03), .c(new_n119_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n138_), .c(new_n50_), .O(z6));
  aoi21  g109(.a(new_n98_), .b(new_n93_), .c(new_n52_), .O(z7));
endmodule
