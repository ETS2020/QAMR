...
module FAU ( 
  ...
  nor2   g122(.a(new_n44_), .b(new_n108_), .O(new_n156_));
  inv1   g123(.a(new_n156_), .O(new_n157_));
  nand2  g124(.a(new_n48_), .b(new_n43_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n42_), .c(new_n157_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n46_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n155_), .O(new_n161_));
  oai21  g128(.a(new_n103_), .b(x04), .c(x17), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x22), .c(new_n66_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n92_), .c(x08), .O(new_n164_));
  nand3  g131(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n157_), .O(new_n166_));
  nand4  g133(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n166_), .O(z7));
  nand2  g135(.a(z7), .b(new_n164_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n161_), .O(z4));
  inv1   g137(.a(new_n42_), .O(new_n171_));
  inv1   g138(.a(new_n43_), .O(new_n172_));
  nor2   g139(.a(new_n156_), .b(new_n172_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n48_), .c(new_n46_), .d(new_n171_), .O(z5));
  nand2  g141(.a(x20), .b(new_n91_), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(new_n35_), .c(x11), .O(new_n176_));
  oai22  g143(.a(new_n176_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n177_));
  oai21  g144(.a(x20), .b(new_n91_), .c(x06), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(x11), .c(x03), .O(new_n179_));
  oai21  g146(.a(new_n156_), .b(x03), .c(new_n179_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n77_), .c(x18), .O(new_n181_));
  inv1   g148(.a(new_n123_), .O(new_n182_));
  nand2  g149(.a(new_n137_), .b(new_n182_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n181_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(x24), .O(new_n185_));
  nand2  g152(.a(x24), .b(new_n34_), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(new_n47_), .c(new_n38_), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(new_n78_), .O(new_n188_));
  nand2  g155(.a(new_n188_), .b(x15), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n167_), .O(new_n190_));
  nand3  g157(.a(new_n190_), .b(new_n178_), .c(x11), .O(new_n191_));
  and2   g158(.a(new_n124_), .b(new_n123_), .O(new_n192_));
  nand2  g159(.a(x13), .b(x05), .O(new_n193_));
  nand2  g160(.a(new_n193_), .b(new_n77_), .O(new_n194_));
  nand3  g161(.a(new_n194_), .b(new_n40_), .c(x15), .O(new_n195_));
  oai21  g162(.a(new_n192_), .b(x02), .c(new_n195_), .O(new_n196_));
  aoi21  g163(.a(new_n196_), .b(new_n34_), .c(new_n156_), .O(new_n197_));
  nand4  g164(.a(new_n197_), .b(new_n191_), .c(new_n185_), .d(new_n177_), .O(z6));
endmodule
