...
module FAU ( 
  ...
  and2   g127(.a(new_n53_), .b(new_n43_), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n48_), .c(new_n46_), .d(new_n160_), .O(z5));
  nand2  g129(.a(x20), .b(new_n74_), .O(new_n163_));
  ...
  and2   g134(.a(new_n156_), .b(new_n114_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n113_), .c(new_n112_), .O(new_n169_));
  oai21  g136(.a(new_n167_), .b(new_n34_), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n165_), .c(new_n53_), .O(z6));
  nand4  g138(.a(new_n168_), .b(new_n113_), .c(new_n112_), .d(new_n53_), .O(z7));
endmodule
