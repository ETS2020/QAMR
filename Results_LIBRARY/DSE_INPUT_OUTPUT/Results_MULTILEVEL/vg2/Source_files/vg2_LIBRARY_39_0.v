...
module FAU ( 
  ...
  aoi21  g020(.a(new_n53_), .b(x22), .c(x11), .O(z0));
  ...
  nor2   g038(.a(new_n71_), .b(new_n34_), .O(z1));
  nor2   g039(.a(new_n64_), .b(new_n60_), .O(new_n73_));
  nor3   g040(.a(new_n73_), .b(new_n37_), .c(new_n56_), .O(new_n74_));
  nand4  g041(.a(new_n74_), .b(x11), .c(x06), .d(x03), .O(new_n75_));
  nor2   g042(.a(x22), .b(x11), .O(new_n76_));
  inv1   g043(.a(new_n76_), .O(new_n77_));
  oai21  g044(.a(new_n75_), .b(new_n34_), .c(new_n77_), .O(z2));
  ...
  aoi21  g054(.a(new_n87_), .b(new_n86_), .c(new_n57_), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n37_), .c(new_n56_), .d(new_n85_), .O(new_n89_));
  nor2   g056(.a(new_n89_), .b(x08), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n91_));
  ...
  nor2   g064(.a(new_n57_), .b(x20), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n56_), .c(new_n85_), .d(new_n55_), .O(new_n99_));
  ...
  nand4  g069(.a(new_n55_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n103_));
  nand4  g070(.a(new_n98_), .b(x19), .c(new_n56_), .d(new_n85_), .O(new_n104_));
  oai22  g071(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n95_), .O(new_n105_));
  ...
  aoi21  g075(.a(new_n108_), .b(x09), .c(x08), .O(new_n109_));
  inv1   g076(.a(x04), .O(new_n110_));
  inv1   g077(.a(x17), .O(new_n111_));
  oai21  g078(.a(x23), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n57_), .c(new_n108_), .d(x11), .O(new_n113_));
  oai21  g080(.a(new_n109_), .b(new_n76_), .c(new_n113_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n50_), .O(new_n115_));
  inv1   g082(.a(new_n73_), .O(new_n116_));
  oai21  g083(.a(new_n108_), .b(x09), .c(x08), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n77_), .O(new_n118_));
  ...
  nand2  g090(.a(new_n123_), .b(new_n115_), .O(z4));
  and2   g091(.a(new_n46_), .b(new_n43_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n77_), .c(new_n49_), .d(new_n42_), .O(z5));
  inv1   g093(.a(x21), .O(new_n127_));
  nand2  g094(.a(x03), .b(x00), .O(new_n128_));
  ...
  nand2  g098(.a(x19), .b(x03), .O(new_n132_));
  oai21  g099(.a(new_n131_), .b(x03), .c(new_n132_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(x13), .c(x05), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n130_), .c(x24), .O(new_n135_));
  inv1   g102(.a(x18), .O(new_n136_));
  nand2  g103(.a(x07), .b(x03), .O(new_n137_));
  oai21  g104(.a(new_n136_), .b(x03), .c(new_n137_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n94_), .c(x24), .O(new_n139_));
  nand3  g106(.a(new_n133_), .b(new_n48_), .c(new_n47_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n135_), .c(new_n77_), .O(new_n142_));
  oai21  g109(.a(new_n37_), .b(x14), .c(new_n36_), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n50_), .c(x22), .d(new_n85_), .O(new_n144_));
  oai21  g111(.a(x20), .b(new_n56_), .c(x06), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n116_), .c(x11), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n144_), .c(new_n142_), .O(z6));
  nor2   g114(.a(new_n76_), .b(new_n73_), .O(z7));
endmodule
