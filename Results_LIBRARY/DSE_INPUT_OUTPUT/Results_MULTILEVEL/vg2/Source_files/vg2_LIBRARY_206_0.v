...
module FAU ( 
  ...
  nand2  g038(.a(new_n37_), .b(new_n56_), .O(new_n72_));
  oai21  g039(.a(new_n71_), .b(new_n54_), .c(new_n72_), .O(z1));
  inv1   g040(.a(x20), .O(new_n74_));
  nor2   g041(.a(new_n64_), .b(new_n60_), .O(new_n75_));
  nor3   g042(.a(new_n75_), .b(new_n74_), .c(new_n56_), .O(new_n76_));
  nand4  g043(.a(new_n76_), .b(x11), .c(x06), .d(x03), .O(new_n77_));
  oai21  g044(.a(new_n77_), .b(new_n54_), .c(new_n72_), .O(z2));
  ...
  nand4  g054(.a(new_n87_), .b(new_n74_), .c(new_n56_), .d(new_n36_), .O(new_n88_));
  ...
  nand4  g064(.a(new_n74_), .b(new_n56_), .c(new_n36_), .d(new_n55_), .O(new_n98_));
  ...
  nand3  g070(.a(new_n103_), .b(new_n74_), .c(x19), .O(new_n104_));
  oai22  g071(.a(new_n104_), .b(new_n102_), .c(new_n101_), .d(new_n94_), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n47_), .c(new_n38_), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n100_), .c(new_n92_), .d(new_n72_), .O(z3));
  inv1   g074(.a(new_n50_), .O(new_n108_));
  inv1   g075(.a(x04), .O(new_n109_));
  inv1   g076(.a(x17), .O(new_n110_));
  oai21  g077(.a(x23), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  aoi21  g078(.a(new_n111_), .b(new_n57_), .c(x09), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(x16), .c(new_n55_), .O(new_n113_));
  nand2  g080(.a(new_n113_), .b(new_n108_), .O(new_n114_));
  inv1   g081(.a(new_n75_), .O(new_n115_));
  ...
  oai21  g086(.a(new_n119_), .b(new_n37_), .c(x08), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n115_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n114_), .c(new_n72_), .O(z4));
  inv1   g089(.a(new_n42_), .O(new_n123_));
  and2   g090(.a(new_n46_), .b(new_n43_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n72_), .c(new_n48_), .d(new_n123_), .O(z5));
  aoi21  g092(.a(new_n36_), .b(x06), .c(x03), .O(new_n126_));
  aoi21  g093(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n75_), .c(new_n126_), .d(new_n50_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n72_), .O(new_n129_));
  nand2  g096(.a(new_n36_), .b(x00), .O(new_n130_));
  nand3  g097(.a(x20), .b(x16), .c(new_n56_), .O(new_n131_));
  nand3  g098(.a(new_n95_), .b(x21), .c(new_n74_), .O(new_n132_));
  oai21  g099(.a(new_n131_), .b(new_n130_), .c(new_n132_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n45_), .c(new_n44_), .O(new_n134_));
  nand4  g101(.a(new_n103_), .b(x20), .c(x19), .d(x16), .O(new_n135_));
  nand3  g102(.a(new_n95_), .b(new_n74_), .c(x15), .O(new_n136_));
  ...
  nand3  g108(.a(new_n95_), .b(new_n74_), .c(x18), .O(new_n142_));
  ...
  inv1   g113(.a(new_n60_), .O(new_n147_));
  and2   g114(.a(new_n62_), .b(new_n61_), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n72_), .c(new_n63_), .d(new_n147_), .O(z7));
endmodule
