...
module FAU ( 
  ...
  nor2   g019(.a(new_n37_), .b(new_n44_), .O(new_n53_));
  ...
  oai22  g057(.a(new_n90_), .b(new_n87_), .c(new_n85_), .d(new_n60_), .O(new_n91_));
  ...
  nand4  g061(.a(new_n94_), .b(new_n59_), .c(new_n57_), .d(x01), .O(new_n95_));
  ...
  oai21  g075(.a(new_n108_), .b(new_n104_), .c(x14), .O(new_n109_));
  nor2   g076(.a(new_n109_), .b(new_n36_), .O(new_n110_));
  nand4  g077(.a(new_n110_), .b(x06), .c(x03), .d(x01), .O(new_n111_));
  aoi21  g078(.a(new_n111_), .b(new_n44_), .c(new_n37_), .O(z2));
  nand4  g079(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n113_));
  nor2   g080(.a(new_n72_), .b(new_n36_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(x20), .c(x15), .O(new_n115_));
  nand2  g082(.a(new_n96_), .b(new_n69_), .O(new_n116_));
  nand4  g083(.a(new_n37_), .b(x19), .c(new_n72_), .d(new_n36_), .O(new_n117_));
  ...
  nand3  g087(.a(new_n96_), .b(x07), .c(new_n35_), .O(new_n121_));
  inv1   g088(.a(x08), .O(new_n122_));
  nor2   g089(.a(x20), .b(x14), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n36_), .c(new_n122_), .O(new_n124_));
  ...
  inv1   g093(.a(x01), .O(new_n127_));
  nand4  g094(.a(new_n34_), .b(new_n44_), .c(new_n127_), .d(x00), .O(new_n128_));
  nand3  g095(.a(new_n123_), .b(new_n69_), .c(new_n36_), .O(new_n129_));
  nand3  g096(.a(new_n114_), .b(x21), .c(x20), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n113_), .c(new_n129_), .d(new_n128_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n40_), .c(new_n45_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n126_), .c(new_n119_), .d(new_n54_), .O(z3));
  oai21  g100(.a(x23), .b(new_n56_), .c(new_n74_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n62_), .c(x09), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x16), .c(new_n122_), .O(new_n136_));
  nand2  g103(.a(new_n48_), .b(new_n43_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n42_), .c(new_n54_), .O(new_n138_));
  ...
  nand2  g110(.a(new_n106_), .b(new_n105_), .O(new_n144_));
  nor2   g111(.a(new_n144_), .b(new_n104_), .O(new_n145_));
  ...
  oai21  g115(.a(new_n145_), .b(new_n53_), .c(new_n148_), .O(new_n149_));
  ...
  nand4  g120(.a(new_n153_), .b(new_n54_), .c(new_n48_), .d(new_n152_), .O(z5));
  nand2  g121(.a(x20), .b(new_n72_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n35_), .c(x11), .O(new_n156_));
  nand3  g123(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n48_), .c(new_n43_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n42_), .c(new_n156_), .d(x03), .O(new_n159_));
  oai21  g126(.a(new_n36_), .b(x06), .c(x03), .O(new_n160_));
  oai21  g127(.a(new_n108_), .b(new_n104_), .c(new_n160_), .O(new_n161_));
  nand4  g128(.a(new_n114_), .b(new_n147_), .c(new_n37_), .d(new_n45_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n161_), .c(new_n159_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n44_), .O(new_n164_));
  oai21  g131(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n165_));
  oai21  g132(.a(new_n137_), .b(new_n42_), .c(new_n165_), .O(new_n166_));
  nand2  g133(.a(new_n72_), .b(x06), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x11), .c(new_n34_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n145_), .c(new_n166_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n37_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n164_), .O(z6));
  nand4  g138(.a(new_n148_), .b(new_n106_), .c(new_n105_), .d(new_n54_), .O(new_n172_));
  or2    g139(.a(new_n172_), .b(new_n104_), .O(z7));
endmodule
