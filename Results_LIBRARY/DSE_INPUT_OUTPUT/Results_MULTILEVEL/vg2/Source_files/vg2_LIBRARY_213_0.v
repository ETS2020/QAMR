...
module FAU ( 
  ...
  nor2   g059(.a(x02), .b(new_n63_), .O(new_n93_));
  nand3  g060(.a(new_n93_), .b(x04), .c(x03), .O(new_n94_));
  ...
  nor2   g076(.a(x24), .b(new_n99_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n96_), .c(new_n109_), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n108_), .c(new_n107_), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(new_n106_), .c(x20), .O(new_n113_));
  nor2   g080(.a(new_n113_), .b(new_n37_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x11), .c(x06), .d(x03), .O(new_n115_));
  nor2   g082(.a(new_n115_), .b(new_n63_), .O(z2));
  nand3  g083(.a(new_n56_), .b(x03), .c(x01), .O(new_n117_));
  nor2   g084(.a(new_n37_), .b(new_n36_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(x20), .c(x15), .O(new_n119_));
  nand4  g086(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n63_), .O(new_n120_));
  nand4  g087(.a(new_n72_), .b(new_n37_), .c(new_n36_), .d(new_n55_), .O(new_n121_));
  ...
  nand4  g092(.a(new_n125_), .b(new_n36_), .c(new_n55_), .d(x07), .O(new_n126_));
  ...
  nand2  g095(.a(new_n118_), .b(new_n96_), .O(new_n129_));
  nand2  g096(.a(new_n110_), .b(x20), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n93_), .c(new_n56_), .d(x03), .O(new_n132_));
  ...
  nand3  g105(.a(new_n138_), .b(new_n134_), .c(new_n55_), .O(new_n139_));
  oai21  g106(.a(new_n55_), .b(new_n63_), .c(new_n139_), .O(new_n140_));
  nor2   g107(.a(x24), .b(x10), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n109_), .c(x00), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  oai21  g111(.a(new_n136_), .b(x04), .c(x17), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x22), .c(new_n135_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n134_), .c(x08), .O(new_n147_));
  ...
  nand3  g117(.a(new_n150_), .b(new_n76_), .c(x24), .O(new_n151_));
  ...
  nand2  g121(.a(new_n154_), .b(new_n78_), .O(new_n155_));
  nand4  g122(.a(new_n147_), .b(new_n40_), .c(x21), .d(new_n96_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(x01), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n109_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n155_), .c(new_n151_), .d(new_n144_), .O(z4));
  nor2   g126(.a(x02), .b(x01), .O(new_n160_));
  inv1   g127(.a(new_n160_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n48_), .O(new_n162_));
  nand4  g129(.a(new_n141_), .b(new_n109_), .c(x01), .d(x00), .O(new_n163_));
  ...
  nand2  g136(.a(new_n108_), .b(new_n107_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n106_), .c(new_n161_), .O(new_n171_));
  nand3  g138(.a(new_n110_), .b(new_n93_), .c(new_n96_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n171_), .O(z7));
  nand2  g140(.a(z7), .b(new_n169_), .O(new_n174_));
