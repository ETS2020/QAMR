...
module FAU ( 
  ...
  inv1   g080(.a(new_n83_), .O(new_n114_));
  ...
  nand2  g104(.a(x15), .b(x11), .O(new_n138_));
  nand3  g105(.a(new_n105_), .b(new_n103_), .c(new_n37_), .O(new_n139_));
  nor2   g106(.a(x13), .b(x11), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n57_), .c(x19), .d(new_n95_), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n139_), .c(new_n138_), .O(new_n142_));
  aoi21  g109(.a(new_n137_), .b(x24), .c(new_n142_), .O(new_n143_));
  ...
  nand2  g123(.a(new_n156_), .b(new_n138_), .O(new_n157_));
  nand3  g124(.a(new_n39_), .b(x13), .c(x05), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n114_), .O(new_n159_));
  nand3  g126(.a(new_n154_), .b(x15), .c(new_n36_), .O(new_n160_));
  nand4  g127(.a(new_n149_), .b(x19), .c(new_n96_), .d(new_n75_), .O(new_n161_));
  ...
  nand4  g133(.a(new_n166_), .b(new_n138_), .c(new_n47_), .d(new_n165_), .O(z5));
  nand2  g134(.a(x20), .b(new_n95_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n35_), .c(x11), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(x03), .c(new_n145_), .O(new_n170_));
  aoi21  g137(.a(new_n57_), .b(x14), .c(new_n35_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n36_), .c(x03), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n117_), .O(new_n173_));
  aoi21  g140(.a(new_n158_), .b(new_n114_), .c(x03), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(x11), .c(x15), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n173_), .c(new_n170_), .O(z6));
  nand3  g143(.a(new_n39_), .b(x15), .c(x13), .O(new_n177_));
  oai21  g144(.a(new_n39_), .b(new_n113_), .c(new_n177_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(x05), .O(new_n179_));
  oai21  g146(.a(new_n83_), .b(x11), .c(x15), .O(new_n180_));
  nand3  g147(.a(x24), .b(x18), .c(x13), .O(new_n181_));
  nand4  g148(.a(new_n181_), .b(new_n180_), .c(new_n179_), .d(new_n116_), .O(z7));
endmodule
