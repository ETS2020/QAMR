...
module FAU ( 
  ...
  nand4  g055(.a(new_n88_), .b(new_n68_), .c(new_n67_), .d(new_n49_), .O(new_n89_));
  ...
  nand4  g060(.a(new_n93_), .b(new_n75_), .c(new_n61_), .d(new_n60_), .O(new_n94_));
  ...
  nand4  g065(.a(new_n98_), .b(new_n37_), .c(new_n97_), .d(x00), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  inv1   g067(.a(x10), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n67_), .c(new_n49_), .O(new_n102_));
  ...
  nand4  g072(.a(new_n105_), .b(new_n103_), .c(new_n100_), .d(new_n93_), .O(new_n106_));
  ...
  nor3   g085(.a(new_n118_), .b(new_n98_), .c(new_n97_), .O(z2));
  nand4  g086(.a(new_n34_), .b(new_n98_), .c(new_n97_), .d(x00), .O(new_n120_));
  nor2   g087(.a(x11), .b(x10), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(new_n41_), .c(new_n61_), .d(new_n36_), .O(new_n122_));
  oai21  g089(.a(new_n122_), .b(new_n120_), .c(new_n49_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n37_), .O(new_n124_));
  nand4  g091(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n125_));
  nand4  g092(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n126_));
  nand3  g093(.a(new_n69_), .b(new_n98_), .c(new_n97_), .O(new_n127_));
  nand3  g094(.a(new_n74_), .b(new_n36_), .c(new_n35_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n125_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n80_), .O(new_n130_));
  nand3  g097(.a(new_n85_), .b(x14), .c(x11), .O(new_n131_));
  nand3  g098(.a(new_n88_), .b(new_n98_), .c(new_n97_), .O(new_n132_));
  nand4  g099(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n49_), .O(new_n133_));
  ...
  oai21  g104(.a(new_n137_), .b(x22), .c(new_n67_), .O(new_n138_));
  nand3  g105(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n46_), .c(new_n44_), .O(new_n140_));
  or2    g107(.a(new_n140_), .b(new_n43_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n138_), .c(new_n91_), .O(new_n142_));
  oai21  g109(.a(new_n115_), .b(x08), .c(new_n37_), .O(new_n143_));
  inv1   g110(.a(x04), .O(new_n144_));
  aoi21  g111(.a(x23), .b(new_n144_), .c(new_n60_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n63_), .c(x09), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x16), .c(new_n49_), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(new_n84_), .c(new_n49_), .d(new_n87_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n78_), .c(x24), .O(new_n149_));
  inv1   g116(.a(x15), .O(new_n150_));
  oai22  g117(.a(new_n147_), .b(new_n150_), .c(new_n73_), .d(new_n49_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n80_), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n149_), .c(new_n143_), .d(new_n142_), .O(z4));
  nor2   g120(.a(new_n47_), .b(new_n43_), .O(new_n154_));
  aoi21  g121(.a(new_n50_), .b(x00), .c(x08), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x02), .c(new_n154_), .O(z5));
  nand2  g123(.a(new_n51_), .b(new_n48_), .O(new_n157_));
  aoi21  g124(.a(x20), .b(new_n36_), .c(x06), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x11), .c(new_n98_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g127(.a(new_n116_), .b(new_n113_), .O(new_n161_));
  aoi21  g128(.a(new_n61_), .b(x14), .c(new_n34_), .O(new_n162_));
  ...
  nor2   g132(.a(new_n112_), .b(new_n110_), .O(new_n166_));
  nand2  g133(.a(new_n143_), .b(new_n166_), .O(z7));
endmodule
