...
module FAU ( 
  ...
  nor2   g061(.a(new_n66_), .b(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n93_), .c(new_n79_), .d(new_n77_), .O(new_n96_));
  ...
  nand4  g067(.a(new_n100_), .b(new_n93_), .c(new_n79_), .d(new_n77_), .O(new_n101_));
  inv1   g068(.a(x00), .O(new_n102_));
  nor2   g069(.a(x01), .b(new_n102_), .O(new_n103_));
  nor2   g070(.a(x03), .b(x02), .O(new_n104_));
  nand4  g071(.a(new_n62_), .b(new_n61_), .c(new_n34_), .d(new_n60_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  nand4  g073(.a(new_n63_), .b(new_n36_), .c(new_n85_), .d(new_n35_), .O(new_n107_));
  nand4  g074(.a(new_n68_), .b(new_n67_), .c(new_n66_), .d(new_n64_), .O(new_n108_));
  ...
  oai21  g078(.a(new_n111_), .b(x02), .c(new_n37_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n98_), .c(new_n84_), .O(z1));
  ...
  oai21  g092(.a(new_n125_), .b(new_n58_), .c(new_n38_), .O(z2));
  ...
  nand4  g096(.a(new_n61_), .b(new_n34_), .c(new_n59_), .d(new_n58_), .O(new_n130_));
  nand4  g097(.a(new_n66_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n127_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n57_), .O(new_n133_));
  inv1   g100(.a(new_n127_), .O(new_n134_));
  nand3  g101(.a(new_n128_), .b(new_n134_), .c(new_n95_), .O(new_n135_));
  nand4  g102(.a(x07), .b(new_n34_), .c(new_n59_), .d(new_n58_), .O(new_n136_));
  nand4  g103(.a(new_n66_), .b(new_n36_), .c(new_n35_), .d(new_n61_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n55_), .c(x24), .O(new_n139_));
  inv1   g106(.a(new_n137_), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n103_), .c(new_n34_), .d(new_n59_), .O(new_n141_));
  nand3  g108(.a(new_n128_), .b(new_n134_), .c(new_n100_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n141_), .c(x24), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x02), .c(new_n37_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n139_), .c(new_n133_), .O(z3));
  oai21  g112(.a(x23), .b(new_n60_), .c(new_n64_), .O(new_n146_));
  ...
  aoi21  g117(.a(new_n150_), .b(x22), .c(new_n62_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n63_), .c(x08), .O(new_n152_));
  nand2  g119(.a(new_n119_), .b(new_n118_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n117_), .c(new_n38_), .O(new_n154_));
  nand3  g121(.a(new_n120_), .b(new_n37_), .c(new_n49_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  oai21  g124(.a(new_n149_), .b(new_n51_), .c(new_n157_), .O(z4));
  inv1   g125(.a(new_n43_), .O(new_n159_));
  oai21  g126(.a(x24), .b(new_n102_), .c(new_n49_), .O(new_n160_));
  ...
  nand3  g131(.a(new_n41_), .b(new_n37_), .c(x00), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n46_), .c(new_n44_), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n43_), .c(new_n164_), .d(x03), .O(new_n167_));
  nand2  g134(.a(new_n66_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n35_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n59_), .c(new_n122_), .d(new_n117_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n38_), .O(z6));
  inv1   g138(.a(new_n117_), .O(new_n172_));
  inv1   g139(.a(new_n153_), .O(new_n173_));
  oai21  g140(.a(new_n120_), .b(x02), .c(new_n37_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n173_), .c(new_n172_), .O(z7));
endmodule
