...
module FAU ( 
  ...
  oai21  g087(.a(new_n120_), .b(new_n104_), .c(new_n111_), .O(z2));
  nand4  g088(.a(new_n105_), .b(x08), .c(x06), .d(x03), .O(new_n122_));
  ...
  nand3  g093(.a(new_n56_), .b(x03), .c(x01), .O(new_n127_));
  nand3  g094(.a(new_n123_), .b(x20), .c(x15), .O(new_n128_));
  nand3  g095(.a(new_n78_), .b(new_n34_), .c(new_n104_), .O(new_n129_));
  nand3  g096(.a(new_n83_), .b(new_n37_), .c(new_n36_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n127_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n89_), .O(new_n132_));
  nand3  g099(.a(new_n123_), .b(x20), .c(x18), .O(new_n133_));
  nand4  g100(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n104_), .O(new_n134_));
  nand4  g101(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n55_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n127_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n87_), .c(x24), .O(new_n137_));
  ...
  nand2  g138(.a(new_n53_), .b(x01), .O(new_n172_));
  nand2  g139(.a(new_n108_), .b(new_n105_), .O(new_n173_));
  oai22  g140(.a(new_n173_), .b(new_n172_), .c(new_n171_), .d(new_n118_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n168_), .O(z6));
  aoi21  g143(.a(new_n108_), .b(new_n105_), .c(new_n104_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(x02), .c(new_n118_), .O(z7));
endmodule
