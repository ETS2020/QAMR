...
module FAU ( 
  ...
  nand4  g099(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n66_), .O(new_n133_));
  ...
  nor2   g103(.a(new_n34_), .b(new_n64_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n86_), .O(new_n138_));
  nand3  g105(.a(new_n92_), .b(x14), .c(x11), .O(new_n139_));
  nand3  g106(.a(new_n35_), .b(new_n34_), .c(new_n64_), .O(new_n140_));
  nand4  g107(.a(new_n71_), .b(new_n68_), .c(new_n66_), .d(x07), .O(new_n141_));
  ...
  nand4  g110(.a(new_n66_), .b(new_n35_), .c(new_n37_), .d(new_n64_), .O(new_n144_));
  nand4  g111(.a(new_n71_), .b(x19), .c(new_n68_), .d(new_n46_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n144_), .c(new_n36_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n34_), .O(new_n147_));
  nand3  g114(.a(x20), .b(x15), .c(x14), .O(new_n148_));
  nor3   g115(.a(new_n148_), .b(x13), .c(new_n36_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n137_), .c(new_n86_), .d(new_n37_), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n147_), .c(new_n143_), .d(new_n135_), .O(z3));
  inv1   g118(.a(new_n49_), .O(new_n152_));
  oai21  g119(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n153_));
  ...
  nand2  g128(.a(x11), .b(new_n34_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n161_), .c(new_n156_), .O(z4));
  inv1   g130(.a(new_n41_), .O(new_n164_));
  and2   g131(.a(new_n45_), .b(new_n42_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n162_), .c(new_n47_), .d(new_n164_), .O(z5));
  nand2  g133(.a(x20), .b(new_n68_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n35_), .c(new_n34_), .O(new_n168_));
  ...
  nand4  g141(.a(new_n162_), .b(new_n123_), .c(new_n120_), .d(new_n174_), .O(z7));
endmodule
