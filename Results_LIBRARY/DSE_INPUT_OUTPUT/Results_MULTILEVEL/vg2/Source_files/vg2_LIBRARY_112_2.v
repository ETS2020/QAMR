...
module FAU ( 
  ...
  oai21  g034(.a(new_n67_), .b(new_n59_), .c(new_n53_), .O(new_n68_));
  ...
  nand4  g046(.a(new_n79_), .b(new_n57_), .c(new_n36_), .d(new_n78_), .O(new_n80_));
  ...
  nand3  g055(.a(new_n39_), .b(x13), .c(x05), .O(new_n89_));
  ...
  nand4  g063(.a(new_n96_), .b(new_n93_), .c(new_n74_), .d(new_n72_), .O(new_n97_));
  nor2   g064(.a(x09), .b(x08), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n79_), .c(x07), .d(new_n35_), .O(new_n99_));
  nand3  g066(.a(new_n85_), .b(new_n65_), .c(new_n64_), .O(new_n100_));
  oai21  g067(.a(new_n100_), .b(new_n99_), .c(new_n97_), .O(new_n101_));
  ...
  nor2   g078(.a(new_n111_), .b(new_n61_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(x11), .c(x06), .d(x03), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(x02), .c(new_n53_), .O(z2));
  nand3  g081(.a(new_n57_), .b(new_n34_), .c(x00), .O(new_n115_));
  nor2   g082(.a(x11), .b(x10), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n39_), .c(new_n95_), .d(new_n61_), .O(new_n117_));
  oai21  g084(.a(new_n117_), .b(new_n115_), .c(new_n53_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n43_), .O(new_n119_));
  ...
  inv1   g100(.a(new_n49_), .O(new_n134_));
  inv1   g101(.a(x23), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(x04), .c(x17), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(x22), .c(new_n78_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n62_), .c(new_n129_), .O(new_n138_));
  oai21  g105(.a(new_n129_), .b(x01), .c(new_n138_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n134_), .O(new_n140_));
  oai21  g107(.a(new_n135_), .b(x04), .c(x17), .O(new_n141_));
  ...
  nand3  g113(.a(new_n146_), .b(new_n88_), .c(x24), .O(new_n147_));
  ...
  nand2  g117(.a(new_n150_), .b(new_n90_), .O(new_n151_));
  inv1   g118(.a(x10), .O(new_n152_));
  nand4  g119(.a(new_n143_), .b(new_n39_), .c(x21), .d(new_n152_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n53_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n43_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n151_), .c(new_n147_), .d(new_n140_), .O(z4));
  nor2   g123(.a(x02), .b(new_n53_), .O(new_n157_));
  inv1   g124(.a(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n47_), .b(new_n42_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n41_), .c(new_n158_), .O(new_n160_));
  nand3  g127(.a(new_n55_), .b(new_n44_), .c(new_n43_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(z5));
  nand2  g129(.a(x20), .b(new_n61_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n35_), .c(x11), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x03), .c(new_n134_), .O(new_n165_));
  oai21  g132(.a(x20), .b(new_n61_), .c(x06), .O(new_n166_));
  ...
  nand3  g137(.a(new_n170_), .b(new_n152_), .c(new_n43_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(new_n172_));
  oai21  g139(.a(new_n168_), .b(new_n122_), .c(new_n172_), .O(new_n173_));
  nand3  g140(.a(new_n110_), .b(new_n34_), .c(x02), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n173_), .c(new_n165_), .d(new_n158_), .O(z6));
  nand2  g142(.a(new_n158_), .b(new_n110_), .O(new_n176_));
  nand4  g143(.a(new_n170_), .b(new_n152_), .c(new_n43_), .d(new_n53_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n176_), .O(z7));
endmodule
