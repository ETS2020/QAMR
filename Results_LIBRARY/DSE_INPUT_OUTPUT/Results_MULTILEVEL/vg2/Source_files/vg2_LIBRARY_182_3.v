...
module FAU ( 
  ...
  nor2   g048(.a(x24), .b(new_n47_), .O(new_n82_));
  ...
  nand3  g060(.a(new_n77_), .b(new_n37_), .c(new_n61_), .O(new_n94_));
  ...
  aoi21  g064(.a(new_n97_), .b(x24), .c(new_n84_), .O(new_n98_));
  ...
  oai21  g085(.a(new_n118_), .b(new_n108_), .c(new_n53_), .O(z2));
  inv1   g086(.a(new_n83_), .O(new_n120_));
  nand4  g087(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n121_));
  nor2   g088(.a(new_n73_), .b(new_n36_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(x20), .c(x15), .O(new_n123_));
  nand3  g090(.a(new_n102_), .b(new_n68_), .c(new_n35_), .O(new_n124_));
  nand4  g091(.a(new_n37_), .b(x19), .c(new_n73_), .d(new_n36_), .O(new_n125_));
  ...
  nand2  g095(.a(new_n122_), .b(new_n87_), .O(new_n129_));
  nand3  g096(.a(new_n102_), .b(x07), .c(new_n35_), .O(new_n130_));
  nand4  g097(.a(new_n37_), .b(new_n73_), .c(new_n36_), .d(new_n68_), .O(new_n131_));
  ...
  nand2  g101(.a(new_n134_), .b(new_n53_), .O(new_n135_));
  nand4  g102(.a(new_n35_), .b(new_n34_), .c(new_n108_), .d(x00), .O(new_n136_));
  nand2  g103(.a(new_n122_), .b(new_n100_), .O(new_n137_));
  ...
  oai21  g108(.a(x23), .b(new_n141_), .c(new_n61_), .O(new_n142_));
  ...
  nand3  g116(.a(new_n149_), .b(new_n145_), .c(new_n53_), .O(z4));
  nand4  g117(.a(new_n53_), .b(new_n48_), .c(new_n46_), .d(new_n43_), .O(new_n151_));
  ...
  oai21  g122(.a(new_n155_), .b(new_n42_), .c(new_n53_), .O(new_n156_));
  ...
  nand2  g127(.a(new_n113_), .b(new_n112_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n111_), .c(new_n53_), .O(new_n162_));
  ...
  nand4  g132(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(new_n53_), .O(new_n166_));
  or2    g133(.a(new_n166_), .b(new_n111_), .O(z7));
endmodule
