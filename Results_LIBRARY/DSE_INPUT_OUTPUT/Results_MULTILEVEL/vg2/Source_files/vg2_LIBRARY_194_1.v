...
module FAU ( 
  ...
  nand2  g078(.a(new_n42_), .b(x21), .O(new_n112_));
  ...
  nand2  g107(.a(new_n111_), .b(new_n87_), .O(new_n141_));
  nand3  g108(.a(new_n91_), .b(new_n37_), .c(new_n36_), .O(new_n142_));
  nand4  g109(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n89_), .O(new_n143_));
  ...
  nand3  g113(.a(new_n72_), .b(new_n37_), .c(new_n36_), .O(new_n147_));
  nand3  g114(.a(new_n77_), .b(new_n40_), .c(new_n47_), .O(new_n148_));
  ...
  nand2  g119(.a(new_n149_), .b(new_n83_), .O(new_n153_));
  ...
  aoi21  g123(.a(x22), .b(new_n65_), .c(new_n70_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n94_), .c(x08), .O(new_n158_));
  nand2  g125(.a(x23), .b(new_n34_), .O(new_n159_));
  inv1   g126(.a(new_n159_), .O(new_n160_));
  nor2   g127(.a(x10), .b(x02), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n105_), .c(x21), .O(new_n162_));
  oai21  g129(.a(new_n160_), .b(new_n123_), .c(new_n162_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n158_), .O(new_n164_));
  aoi21  g131(.a(new_n67_), .b(x17), .c(x09), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x16), .c(new_n89_), .O(new_n166_));
  inv1   g133(.a(x04), .O(new_n167_));
  nor2   g134(.a(x16), .b(new_n167_), .O(new_n168_));
  aoi22  g135(.a(new_n168_), .b(new_n78_), .c(new_n166_), .d(new_n159_), .O(new_n169_));
  nand3  g136(.a(x15), .b(new_n167_), .c(x02), .O(new_n170_));
  nand2  g137(.a(new_n68_), .b(x16), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(new_n170_), .c(new_n169_), .d(new_n76_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n83_), .O(new_n173_));
  nor2   g140(.a(new_n94_), .b(x04), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n68_), .c(x18), .d(x02), .O(new_n175_));
  oai21  g142(.a(new_n169_), .b(new_n90_), .c(new_n175_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n81_), .c(x24), .O(new_n177_));
  nor2   g144(.a(x17), .b(x04), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(x22), .c(new_n70_), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n94_), .c(x08), .O(new_n180_));
  nor3   g147(.a(new_n180_), .b(x24), .c(x23), .O(new_n181_));
  nand4  g148(.a(new_n181_), .b(new_n102_), .c(new_n34_), .d(x00), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n177_), .c(new_n173_), .d(new_n164_), .O(z4));
  nand4  g150(.a(new_n105_), .b(new_n102_), .c(new_n34_), .d(x00), .O(new_n184_));
  oai21  g151(.a(new_n160_), .b(new_n56_), .c(new_n184_), .O(z5));
  nand2  g152(.a(x20), .b(new_n40_), .O(new_n186_));
  aoi21  g153(.a(new_n186_), .b(new_n38_), .c(x11), .O(new_n187_));
  nand4  g154(.a(new_n42_), .b(new_n102_), .c(new_n34_), .d(x00), .O(new_n188_));
  nand3  g155(.a(new_n188_), .b(new_n54_), .c(new_n52_), .O(new_n189_));
  oai22  g156(.a(new_n189_), .b(new_n51_), .c(new_n187_), .d(x03), .O(new_n190_));
  nand2  g157(.a(new_n41_), .b(x14), .O(new_n191_));
  aoi21  g158(.a(new_n191_), .b(x06), .c(new_n47_), .O(new_n192_));
  nand2  g159(.a(new_n161_), .b(new_n113_), .O(new_n193_));
  nand3  g160(.a(new_n193_), .b(new_n121_), .c(new_n120_), .O(new_n194_));
  oai22  g161(.a(new_n194_), .b(new_n119_), .c(new_n192_), .d(new_n37_), .O(new_n195_));
  nand3  g162(.a(new_n195_), .b(new_n190_), .c(new_n159_), .O(z6));
  aoi21  g163(.a(new_n113_), .b(new_n102_), .c(x23), .O(new_n197_));
  oai21  g164(.a(new_n197_), .b(x02), .c(new_n123_), .O(z7));
endmodule
