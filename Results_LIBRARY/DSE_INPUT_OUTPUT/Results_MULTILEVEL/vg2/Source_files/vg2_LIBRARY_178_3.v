...
module FAU ( 
  ...
  nand2  g018(.a(x20), .b(x12), .O(new_n52_));
  ...
  nor4   g045(.a(new_n78_), .b(new_n59_), .c(new_n70_), .d(x12), .O(new_n79_));
  ...
  aoi21  g051(.a(new_n84_), .b(new_n83_), .c(new_n59_), .O(new_n85_));
  nand4  g052(.a(new_n85_), .b(x14), .c(new_n56_), .d(x11), .O(new_n86_));
  ...
  nand4  g070(.a(new_n59_), .b(new_n70_), .c(new_n36_), .d(new_n82_), .O(new_n104_));
  ...
  nand4  g077(.a(new_n59_), .b(x19), .c(new_n70_), .d(new_n36_), .O(new_n111_));
  ...
  oai21  g085(.a(x23), .b(new_n54_), .c(new_n58_), .O(new_n119_));
  ...
  aoi21  g091(.a(new_n124_), .b(x22), .c(new_n55_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n57_), .c(x08), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n122_), .c(new_n52_), .O(z4));
  ...
  nand2  g101(.a(new_n59_), .b(x14), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(x06), .c(new_n36_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(new_n34_), .c(new_n123_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n134_), .c(new_n52_), .O(z6));
  inv1   g105(.a(new_n73_), .O(new_n139_));
  and2   g106(.a(new_n75_), .b(new_n74_), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n76_), .c(new_n139_), .d(new_n52_), .O(z7));
endmodule
