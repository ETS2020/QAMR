...
module FAU ( 
  ...
  nand4  g037(.a(new_n70_), .b(new_n68_), .c(x21), .d(x20), .O(new_n71_));
  oai21  g038(.a(new_n71_), .b(new_n66_), .c(x22), .O(new_n72_));
  nand2  g039(.a(new_n72_), .b(new_n34_), .O(new_n73_));
  nand4  g040(.a(x11), .b(x09), .c(x08), .d(x06), .O(new_n74_));
  nor4   g041(.a(new_n74_), .b(new_n60_), .c(new_n36_), .d(new_n35_), .O(new_n75_));
  nand4  g042(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n76_));
  inv1   g043(.a(x22), .O(new_n77_));
  nor2   g044(.a(new_n69_), .b(new_n77_), .O(new_n78_));
  nand3  g045(.a(new_n78_), .b(x20), .c(x17), .O(new_n79_));
  nor2   g046(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nand2  g047(.a(new_n80_), .b(new_n75_), .O(new_n81_));
  ...
  nand4  g063(.a(new_n96_), .b(new_n78_), .c(new_n75_), .d(new_n68_), .O(new_n97_));
  nor2   g064(.a(new_n47_), .b(x06), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n82_), .c(new_n63_), .d(new_n62_), .O(new_n99_));
  nor2   g066(.a(x12), .b(x11), .O(new_n100_));
  nor2   g067(.a(x16), .b(x14), .O(new_n101_));
  nor2   g068(.a(x20), .b(x17), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n89_), .O(new_n103_));
  oai21  g070(.a(new_n103_), .b(new_n99_), .c(new_n97_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n92_), .c(x24), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n95_), .c(new_n73_), .O(z1));
  inv1   g073(.a(x10), .O(new_n107_));
  nand3  g074(.a(new_n59_), .b(new_n107_), .c(x06), .O(new_n108_));
  ...
  oai21  g079(.a(new_n112_), .b(new_n108_), .c(x22), .O(new_n113_));
  ...
  nand3  g085(.a(x15), .b(new_n52_), .c(new_n51_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nor2   g087(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nor3   g088(.a(new_n121_), .b(new_n40_), .c(new_n39_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x11), .c(x06), .d(x03), .O(new_n123_));
  oai21  g090(.a(new_n123_), .b(new_n35_), .c(new_n114_), .O(z2));
  nand3  g091(.a(x15), .b(x13), .c(x05), .O(new_n125_));
  nand3  g092(.a(x21), .b(new_n107_), .c(new_n34_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(x20), .c(x14), .d(x11), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(new_n62_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x06), .c(x03), .d(x01), .O(new_n130_));
  nand3  g097(.a(new_n107_), .b(new_n34_), .c(x00), .O(new_n131_));
  nand3  g098(.a(x19), .b(x13), .c(x05), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n40_), .c(new_n39_), .d(new_n46_), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(x08), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n130_), .c(x24), .O(new_n137_));
  nand3  g104(.a(new_n59_), .b(x08), .c(x06), .O(new_n138_));
  nand2  g105(.a(new_n109_), .b(new_n96_), .O(new_n139_));
  nand3  g106(.a(new_n98_), .b(new_n36_), .c(new_n35_), .O(new_n140_));
  nand4  g107(.a(new_n40_), .b(new_n39_), .c(new_n46_), .d(new_n62_), .O(new_n141_));
  ...
  nand3  g111(.a(new_n83_), .b(new_n36_), .c(new_n35_), .O(new_n145_));
  nand3  g112(.a(new_n88_), .b(new_n39_), .c(new_n46_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n138_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n52_), .c(new_n51_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n137_), .c(x22), .O(new_n150_));
  nand2  g117(.a(new_n147_), .b(new_n94_), .O(new_n151_));
  ...
  oai21  g121(.a(x16), .b(new_n63_), .c(new_n62_), .O(new_n155_));
  nor2   g122(.a(x22), .b(x02), .O(new_n156_));
  nor2   g123(.a(x24), .b(new_n77_), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n107_), .c(new_n34_), .d(x00), .O(new_n158_));
  oai21  g125(.a(new_n156_), .b(new_n55_), .c(new_n158_), .O(z5));
  nand2  g126(.a(z5), .b(new_n155_), .O(new_n160_));
  nand2  g127(.a(x23), .b(new_n60_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(x17), .c(x09), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(x08), .O(new_n164_));
  inv1   g131(.a(new_n117_), .O(new_n165_));
  nor2   g132(.a(x10), .b(x02), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n111_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n119_), .c(new_n118_), .d(new_n165_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n164_), .c(x22), .O(new_n169_));
  inv1   g136(.a(new_n55_), .O(new_n170_));
  inv1   g137(.a(x17), .O(new_n171_));
  oai21  g138(.a(x23), .b(new_n60_), .c(new_n171_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n170_), .c(new_n77_), .O(new_n173_));
  aoi21  g140(.a(x16), .b(new_n63_), .c(new_n62_), .O(new_n174_));
  oai22  g141(.a(new_n174_), .b(new_n121_), .c(new_n173_), .d(x16), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(x02), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n169_), .c(new_n160_), .O(z4));
  ...
  aoi21  g147(.a(new_n40_), .b(x14), .c(new_n37_), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(new_n46_), .c(x03), .O(new_n182_));
  nand3  g149(.a(new_n157_), .b(new_n166_), .c(x21), .O(new_n183_));
  oai21  g150(.a(new_n156_), .b(new_n121_), .c(new_n183_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(new_n182_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n180_), .O(z6));
  aoi21  g153(.a(new_n111_), .b(new_n107_), .c(new_n77_), .O(new_n187_));
  oai21  g154(.a(new_n187_), .b(x02), .c(new_n121_), .O(z7));
endmodule
