...
module FAU ( 
  ...
  oai21  g033(.a(new_n66_), .b(new_n58_), .c(new_n34_), .O(new_n67_));
  ...
  and2   g039(.a(x23), .b(x22), .O(new_n73_));
  nand3  g040(.a(new_n73_), .b(x20), .c(x17), .O(new_n74_));
  ...
  nand4  g062(.a(new_n95_), .b(new_n92_), .c(new_n73_), .d(new_n71_), .O(new_n96_));
  ...
  nand3  g073(.a(new_n39_), .b(x15), .c(x13), .O(new_n107_));
  ...
  aoi22  g079(.a(new_n112_), .b(new_n37_), .c(new_n110_), .d(x13), .O(new_n113_));
  ...
  nor2   g084(.a(new_n117_), .b(new_n105_), .O(z2));
  ...
  nand2  g090(.a(new_n123_), .b(new_n56_), .O(new_n124_));
  nand3  g091(.a(new_n83_), .b(new_n60_), .c(new_n36_), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n122_), .c(new_n89_), .O(new_n127_));
  inv1   g094(.a(new_n120_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n95_), .c(x14), .O(new_n129_));
  nor2   g096(.a(x11), .b(x08), .O(new_n130_));
  nor2   g097(.a(x20), .b(x14), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n130_), .c(new_n123_), .d(new_n99_), .O(new_n132_));
  oai21  g099(.a(new_n129_), .b(new_n119_), .c(new_n132_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n87_), .c(x24), .O(new_n134_));
  nor3   g101(.a(x06), .b(x03), .c(x02), .O(new_n135_));
  nor3   g102(.a(x11), .b(x10), .c(x08), .O(new_n136_));
  nor3   g103(.a(x24), .b(x20), .c(x14), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n54_), .O(new_n138_));
  ...
  oai21  g109(.a(new_n142_), .b(x22), .c(new_n77_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n61_), .c(new_n97_), .O(new_n144_));
  oai21  g111(.a(new_n97_), .b(x03), .c(new_n144_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n140_), .O(new_n146_));
  oai21  g113(.a(new_n141_), .b(x04), .c(x17), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(x22), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(x09), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x16), .c(new_n97_), .O(new_n150_));
  nand3  g117(.a(x08), .b(x07), .c(x02), .O(new_n151_));
  oai21  g118(.a(new_n150_), .b(new_n93_), .c(new_n151_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n87_), .c(x24), .O(new_n153_));
  nand3  g120(.a(x19), .b(x08), .c(x02), .O(new_n154_));
  oai21  g121(.a(new_n150_), .b(new_n111_), .c(new_n154_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n89_), .O(new_n156_));
  inv1   g123(.a(x10), .O(new_n157_));
  aoi21  g124(.a(new_n147_), .b(x22), .c(new_n77_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n61_), .c(x08), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n39_), .c(x21), .d(new_n157_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n34_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n43_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n156_), .c(new_n153_), .d(new_n146_), .O(z4));
  nand2  g130(.a(new_n47_), .b(new_n42_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n41_), .c(new_n34_), .d(x02), .O(new_n165_));
  nand4  g132(.a(new_n44_), .b(new_n34_), .c(new_n43_), .d(x00), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n165_), .O(z5));
  oai21  g134(.a(new_n94_), .b(x14), .c(new_n35_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n140_), .c(new_n36_), .O(new_n169_));
  nand3  g136(.a(new_n39_), .b(x21), .c(new_n157_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n34_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n43_), .O(new_n172_));
  oai21  g139(.a(x20), .b(new_n60_), .c(x06), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(x11), .c(new_n34_), .O(new_n174_));
  oai22  g141(.a(new_n174_), .b(new_n93_), .c(new_n98_), .d(new_n34_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n87_), .c(x24), .O(new_n176_));
  oai22  g143(.a(new_n174_), .b(new_n111_), .c(new_n82_), .d(new_n34_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n89_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n176_), .c(new_n172_), .d(new_n169_), .O(z6));
  nand3  g146(.a(new_n172_), .b(new_n113_), .c(new_n109_), .O(z7));
endmodule
