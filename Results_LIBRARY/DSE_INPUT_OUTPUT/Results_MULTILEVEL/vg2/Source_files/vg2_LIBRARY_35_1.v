...
module FAU ( 
  ...
  nand3  g067(.a(new_n49_), .b(new_n66_), .c(new_n100_), .O(new_n101_));
  nor3   g068(.a(new_n101_), .b(x06), .c(x04), .O(new_n102_));
  nand3  g069(.a(new_n41_), .b(new_n63_), .c(new_n62_), .O(new_n103_));
  nor3   g070(.a(new_n103_), .b(x20), .c(x17), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n102_), .c(new_n99_), .d(new_n92_), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n95_), .c(new_n80_), .O(z1));
  ...
  oai21  g077(.a(new_n107_), .b(new_n45_), .c(new_n110_), .O(new_n111_));
  oai21  g078(.a(new_n111_), .b(new_n109_), .c(new_n38_), .O(new_n112_));
  nor2   g079(.a(x10), .b(x02), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n41_), .c(x21), .d(new_n89_), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n112_), .c(new_n36_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x14), .c(x11), .d(x06), .O(new_n116_));
  nor3   g083(.a(new_n116_), .b(new_n97_), .c(new_n96_), .O(z2));
  ...
  nor2   g088(.a(new_n121_), .b(new_n100_), .O(new_n122_));
  ...
  nand4  g095(.a(new_n128_), .b(new_n86_), .c(new_n97_), .d(new_n96_), .O(new_n129_));
  ...
  nand4  g099(.a(x07), .b(new_n86_), .c(new_n97_), .d(new_n96_), .O(new_n133_));
  nand4  g100(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n100_), .O(new_n134_));
  ...
  nand3  g104(.a(new_n68_), .b(new_n97_), .c(new_n96_), .O(new_n138_));
  nand3  g105(.a(new_n73_), .b(new_n35_), .c(new_n34_), .O(new_n139_));
  ...
  oai21  g109(.a(new_n142_), .b(new_n130_), .c(new_n89_), .O(new_n143_));
  nand2  g110(.a(new_n140_), .b(new_n79_), .O(new_n144_));
  ...
  aoi21  g114(.a(new_n63_), .b(x04), .c(x17), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x22), .c(new_n66_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n90_), .c(new_n100_), .O(new_n150_));
  oai21  g117(.a(x12), .b(new_n100_), .c(new_n150_), .O(new_n151_));
  nand4  g118(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n46_), .c(new_n44_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n43_), .c(new_n151_), .O(new_n154_));
  oai21  g121(.a(new_n63_), .b(x04), .c(x17), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x22), .c(new_n66_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n90_), .c(x08), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(x18), .O(new_n158_));
  nand3  g125(.a(x08), .b(x07), .c(x02), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n77_), .c(x24), .O(new_n161_));
  nand2  g128(.a(new_n157_), .b(x15), .O(new_n162_));
  nand3  g129(.a(x19), .b(x08), .c(x02), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n79_), .O(new_n165_));
  nand4  g132(.a(new_n157_), .b(new_n41_), .c(x21), .d(new_n49_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n89_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n37_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n165_), .c(new_n161_), .d(new_n154_), .O(z4));
  aoi21  g136(.a(x20), .b(new_n35_), .c(x06), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(x11), .c(new_n97_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(z5), .O(new_n172_));
  nand2  g139(.a(new_n114_), .b(new_n112_), .O(new_n173_));
  aoi21  g140(.a(new_n36_), .b(x14), .c(new_n86_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(new_n34_), .c(x03), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n172_), .O(z6));
  nor2   g144(.a(new_n111_), .b(new_n109_), .O(new_n178_));
  nand3  g145(.a(new_n41_), .b(x21), .c(new_n49_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n89_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n37_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n178_), .O(z7));
endmodule
