...
module FAU ( 
  ...
  nand3  g060(.a(new_n93_), .b(new_n35_), .c(new_n65_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n36_), .b(new_n67_), .c(new_n66_), .d(x07), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  nand4  g064(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n53_), .O(new_n98_));
  inv1   g065(.a(new_n98_), .O(new_n99_));
  nor2   g066(.a(x21), .b(x20), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(new_n73_), .c(new_n72_), .O(new_n101_));
  inv1   g068(.a(new_n101_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n99_), .c(new_n97_), .d(new_n95_), .O(new_n103_));
  aoi22  g070(.a(new_n103_), .b(new_n92_), .c(new_n46_), .d(new_n37_), .O(new_n104_));
  nand4  g071(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n105_));
  nand3  g072(.a(new_n91_), .b(x20), .c(x17), .O(new_n106_));
  nor2   g073(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g074(.a(new_n107_), .b(new_n87_), .O(new_n108_));
  nand4  g075(.a(new_n53_), .b(new_n36_), .c(new_n67_), .d(new_n66_), .O(new_n109_));
  inv1   g076(.a(new_n109_), .O(new_n110_));
  nand4  g077(.a(x19), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(new_n111_));
  inv1   g078(.a(new_n111_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n110_), .c(new_n102_), .d(new_n95_), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(new_n108_), .c(x13), .O(new_n114_));
  aoi22  g081(.a(new_n114_), .b(new_n37_), .c(new_n104_), .d(x24), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n85_), .O(z1));
  inv1   g083(.a(x20), .O(new_n117_));
  ...
  oai21  g090(.a(new_n123_), .b(new_n120_), .c(x06), .O(new_n124_));
  nand4  g091(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(new_n124_), .c(new_n117_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x14), .c(x11), .d(x03), .O(new_n127_));
  nand2  g094(.a(x21), .b(new_n35_), .O(new_n128_));
  oai21  g095(.a(new_n127_), .b(new_n64_), .c(new_n128_), .O(z2));
  ...
  nand4  g099(.a(new_n76_), .b(new_n71_), .c(new_n117_), .d(new_n68_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x11), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n66_), .c(new_n35_), .d(new_n34_), .O(new_n135_));
  ...
  nand3  g107(.a(new_n93_), .b(x07), .c(new_n35_), .O(new_n141_));
  nand4  g108(.a(new_n100_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n142_));
  ...
  nand3  g112(.a(new_n93_), .b(new_n66_), .c(new_n35_), .O(new_n146_));
  nand4  g113(.a(new_n100_), .b(x19), .c(new_n68_), .d(new_n36_), .O(new_n147_));
  ...
  inv1   g125(.a(new_n120_), .O(new_n159_));
  nand2  g126(.a(new_n125_), .b(new_n122_), .O(new_n160_));
  inv1   g127(.a(new_n160_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n121_), .c(new_n159_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n158_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n155_), .c(new_n128_), .O(z4));
  inv1   g131(.a(new_n41_), .O(new_n165_));
  and2   g132(.a(new_n45_), .b(new_n42_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n128_), .c(new_n47_), .d(new_n165_), .O(z5));
  nand2  g134(.a(x20), .b(new_n68_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n35_), .c(x11), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(x03), .c(new_n151_), .O(new_n170_));
  nand3  g137(.a(new_n117_), .b(x14), .c(x11), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(x03), .O(new_n172_));
  oai21  g139(.a(new_n160_), .b(new_n120_), .c(new_n172_), .O(new_n173_));
  inv1   g140(.a(new_n123_), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(new_n159_), .c(new_n36_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(x21), .c(new_n35_), .O(new_n176_));
  oai21  g143(.a(x05), .b(x03), .c(new_n171_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(x24), .c(x18), .d(x13), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n176_), .c(new_n173_), .d(new_n170_), .O(z6));
  nor3   g146(.a(x24), .b(x10), .c(x02), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n35_), .c(x21), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n174_), .c(new_n159_), .O(z7));
endmodule
