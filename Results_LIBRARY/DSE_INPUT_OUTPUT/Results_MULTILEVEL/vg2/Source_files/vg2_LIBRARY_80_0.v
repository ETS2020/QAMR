...
module FAU ( 
  ...
  nand4  g110(.a(new_n40_), .b(new_n106_), .c(new_n51_), .d(x00), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n45_), .c(new_n43_), .O(new_n145_));
  or2    g112(.a(new_n145_), .b(new_n42_), .O(new_n146_));
  ...
  or2    g119(.a(new_n152_), .b(new_n115_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g121(.a(new_n51_), .b(new_n105_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n154_), .c(new_n147_), .O(z4));
  nor2   g123(.a(new_n46_), .b(new_n42_), .O(new_n157_));
  nand3  g124(.a(new_n40_), .b(new_n106_), .c(x00), .O(new_n158_));
  ...
  nand2  g128(.a(x20), .b(new_n97_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n35_), .c(x11), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x03), .c(new_n146_), .O(new_n164_));
  ...
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n155_), .O(z6));
  nor2   g135(.a(new_n118_), .b(new_n115_), .O(new_n169_));
  aoi21  g136(.a(new_n109_), .b(new_n106_), .c(new_n105_), .O(new_n170_));
