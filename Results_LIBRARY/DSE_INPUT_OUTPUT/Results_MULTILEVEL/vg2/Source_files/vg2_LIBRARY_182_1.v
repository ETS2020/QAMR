...
module FAU ( 
  ...
  nand3  g101(.a(x15), .b(new_n52_), .c(new_n47_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nor3   g104(.a(new_n137_), .b(new_n42_), .c(new_n41_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(x11), .c(x06), .d(x03), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n36_), .c(new_n130_), .O(z2));
  nand4  g107(.a(new_n62_), .b(x20), .c(x14), .d(x11), .O(new_n141_));
  nor2   g108(.a(new_n141_), .b(new_n71_), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(x06), .c(x03), .d(x01), .O(new_n143_));
  nand4  g110(.a(new_n79_), .b(new_n42_), .c(new_n41_), .d(new_n40_), .O(new_n144_));
  nor2   g111(.a(new_n144_), .b(x08), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n143_), .c(x24), .O(new_n147_));
  nand4  g114(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n148_));
  nand3  g115(.a(new_n93_), .b(x14), .c(x11), .O(new_n149_));
  nand4  g116(.a(x07), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n150_));
  nand4  g117(.a(new_n42_), .b(new_n41_), .c(new_n40_), .d(new_n71_), .O(new_n151_));
  ...
  nand3  g121(.a(new_n109_), .b(new_n37_), .c(new_n36_), .O(new_n155_));
  nand3  g122(.a(new_n114_), .b(new_n41_), .c(new_n40_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n155_), .c(new_n154_), .d(new_n148_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n52_), .c(new_n47_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n153_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n147_), .c(new_n35_), .O(new_n160_));
  nand2  g127(.a(new_n157_), .b(new_n121_), .O(new_n161_));
  ...
  oai21  g131(.a(x23), .b(new_n70_), .c(new_n74_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n75_), .c(x09), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(x16), .c(new_n71_), .O(new_n167_));
  nand3  g134(.a(new_n43_), .b(new_n34_), .c(x00), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n53_), .c(new_n51_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n50_), .c(new_n167_), .O(new_n170_));
  oai21  g137(.a(new_n76_), .b(x04), .c(x17), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(x22), .c(new_n72_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n73_), .c(x08), .O(new_n173_));
  nand2  g140(.a(new_n127_), .b(new_n34_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n135_), .c(new_n134_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n133_), .c(new_n173_), .O(new_n176_));
  nor2   g143(.a(new_n35_), .b(x02), .O(new_n177_));
  inv1   g144(.a(new_n177_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n176_), .c(new_n170_), .O(z4));
  ...
  oai21  g149(.a(new_n182_), .b(x11), .c(new_n37_), .O(new_n183_));
  nand4  g150(.a(new_n43_), .b(new_n35_), .c(new_n34_), .d(x00), .O(new_n184_));
  oai21  g151(.a(new_n177_), .b(new_n55_), .c(new_n184_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n183_), .O(new_n186_));
  aoi21  g153(.a(new_n42_), .b(x14), .c(new_n38_), .O(new_n187_));
  oai21  g154(.a(new_n187_), .b(new_n40_), .c(x03), .O(new_n188_));
  nand3  g155(.a(new_n127_), .b(new_n35_), .c(new_n34_), .O(new_n189_));
  oai21  g156(.a(new_n177_), .b(new_n137_), .c(new_n189_), .O(new_n190_));
  nand2  g157(.a(new_n190_), .b(new_n188_), .O(new_n191_));
  nand2  g158(.a(new_n191_), .b(new_n186_), .O(z6));
  oai21  g159(.a(new_n127_), .b(x10), .c(new_n34_), .O(new_n193_));
  nand2  g160(.a(new_n193_), .b(new_n137_), .O(z7));
endmodule
