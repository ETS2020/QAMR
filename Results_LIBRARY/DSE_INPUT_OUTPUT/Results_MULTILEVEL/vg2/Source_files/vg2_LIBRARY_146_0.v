...
module FAU ( 
  ...
  inv1   g057(.a(x02), .O(new_n91_));
  nand4  g058(.a(x04), .b(x03), .c(new_n91_), .d(x01), .O(new_n92_));
  ...
  nand2  g065(.a(x21), .b(x20), .O(new_n99_));
  ...
  nand4  g075(.a(new_n40_), .b(x21), .c(new_n94_), .d(new_n91_), .O(new_n109_));
  ...
  nand4  g085(.a(new_n70_), .b(new_n103_), .c(new_n36_), .d(new_n53_), .O(new_n119_));
  ...
  nor2   g093(.a(x02), .b(new_n61_), .O(new_n127_));
  nand2  g094(.a(new_n116_), .b(new_n94_), .O(new_n128_));
  nand3  g095(.a(new_n40_), .b(x21), .c(x20), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n127_), .c(new_n54_), .d(x03), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n126_), .c(new_n121_), .O(z3));
  inv1   g099(.a(x17), .O(new_n133_));
  oai21  g100(.a(x23), .b(new_n62_), .c(new_n133_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n97_), .c(x09), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x16), .c(new_n53_), .O(new_n136_));
  nand4  g103(.a(new_n40_), .b(new_n94_), .c(new_n91_), .d(x00), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n45_), .c(new_n43_), .O(new_n138_));
  or2    g105(.a(new_n138_), .b(new_n42_), .O(new_n139_));
  ...
  nand2  g116(.a(new_n91_), .b(new_n61_), .O(new_n150_));
  ...
  oai21  g125(.a(new_n158_), .b(x03), .c(new_n139_), .O(new_n159_));
  nand2  g126(.a(new_n37_), .b(x14), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x06), .c(new_n36_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n34_), .c(new_n143_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n150_), .O(z6));
  nand3  g130(.a(new_n40_), .b(x21), .c(new_n94_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(x01), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n91_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n108_), .c(new_n107_), .d(new_n141_), .O(z7));
endmodule
