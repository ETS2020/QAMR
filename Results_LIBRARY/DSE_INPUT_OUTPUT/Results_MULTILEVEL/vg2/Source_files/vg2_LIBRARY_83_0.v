...
module FAU ( 
  ...
  nand4  g089(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n63_), .O(new_n123_));
  nand4  g090(.a(new_n72_), .b(new_n37_), .c(new_n36_), .d(new_n55_), .O(new_n124_));
  ...
  nand4  g095(.a(new_n128_), .b(new_n36_), .c(new_n55_), .d(x07), .O(new_n129_));
  ...
  nand2  g098(.a(new_n121_), .b(new_n96_), .O(new_n132_));
  ...
  nand4  g130(.a(new_n144_), .b(new_n104_), .c(x01), .d(x00), .O(new_n164_));
  ...
  inv1   g137(.a(new_n93_), .O(new_n171_));
  nor2   g138(.a(x02), .b(x01), .O(new_n172_));
  nand2  g139(.a(new_n106_), .b(new_n96_), .O(new_n173_));
  oai22  g140(.a(new_n173_), .b(new_n171_), .c(new_n172_), .d(new_n116_), .O(new_n174_));
