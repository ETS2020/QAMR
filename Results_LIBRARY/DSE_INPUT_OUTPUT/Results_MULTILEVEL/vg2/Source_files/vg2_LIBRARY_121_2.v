...
module FAU ( 
  ...
  nor2   g098(.a(new_n131_), .b(new_n64_), .O(new_n132_));
  nand4  g099(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n133_));
  nor4   g100(.a(new_n133_), .b(x08), .c(x06), .d(x01), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n132_), .c(new_n39_), .O(new_n135_));
  nand2  g102(.a(new_n46_), .b(new_n37_), .O(new_n136_));
  nand3  g103(.a(new_n86_), .b(x03), .c(x01), .O(new_n137_));
  nand3  g104(.a(new_n92_), .b(x14), .c(x11), .O(new_n138_));
  nand3  g105(.a(x07), .b(new_n35_), .c(new_n64_), .O(new_n139_));
  ...
  nand3  g109(.a(new_n86_), .b(new_n37_), .c(x01), .O(new_n143_));
  nor2   g110(.a(x13), .b(new_n36_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(x20), .c(x15), .d(x14), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n143_), .c(x11), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(x03), .O(new_n147_));
  nor2   g114(.a(x05), .b(x01), .O(new_n148_));
  nand3  g115(.a(new_n71_), .b(x19), .c(new_n68_), .O(new_n149_));
  nor3   g116(.a(new_n149_), .b(x13), .c(x11), .O(new_n150_));
  nand4  g117(.a(new_n150_), .b(new_n148_), .c(new_n66_), .d(new_n35_), .O(new_n151_));
  nand4  g118(.a(new_n151_), .b(new_n147_), .c(new_n142_), .d(new_n135_), .O(z3));
  ...
  nand2  g129(.a(new_n36_), .b(x03), .O(new_n163_));
  ...
  nand3  g138(.a(new_n171_), .b(x06), .c(x03), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n158_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n170_), .c(new_n163_), .O(z6));
  inv1   g141(.a(new_n119_), .O(new_n175_));
  nand4  g142(.a(new_n163_), .b(new_n123_), .c(new_n120_), .d(new_n175_), .O(z7));
endmodule
