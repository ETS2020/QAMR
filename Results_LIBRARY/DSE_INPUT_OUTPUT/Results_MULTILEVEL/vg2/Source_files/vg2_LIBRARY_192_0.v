...
module FAU ( 
  ...
  nor2   g003(.a(x21), .b(x02), .O(new_n37_));
  ...
  aoi21  g013(.a(new_n41_), .b(x05), .c(new_n46_), .O(new_n47_));
  or2    g014(.a(new_n47_), .b(new_n37_), .O(new_n48_));
  inv1   g015(.a(x02), .O(new_n49_));
  inv1   g016(.a(x10), .O(new_n50_));
  inv1   g017(.a(x21), .O(new_n51_));
  nor2   g018(.a(x24), .b(new_n51_), .O(new_n52_));
  nand4  g019(.a(new_n52_), .b(new_n50_), .c(new_n49_), .d(x00), .O(new_n53_));
  aoi21  g020(.a(new_n53_), .b(new_n48_), .c(x20), .O(new_n54_));
  ...
  oai21  g025(.a(x10), .b(x02), .c(new_n58_), .O(new_n59_));
  ...
  nand3  g043(.a(new_n50_), .b(new_n49_), .c(x00), .O(new_n77_));
  ...
  nand2  g054(.a(new_n44_), .b(new_n43_), .O(new_n88_));
  nand4  g055(.a(x11), .b(x09), .c(x08), .d(x06), .O(new_n89_));
  nor4   g056(.a(new_n89_), .b(new_n69_), .c(new_n68_), .d(new_n67_), .O(new_n90_));
  ...
  nand4  g066(.a(new_n72_), .b(new_n36_), .c(new_n57_), .d(new_n35_), .O(new_n100_));
  inv1   g067(.a(new_n100_), .O(new_n101_));
  nor2   g068(.a(x23), .b(x22), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n101_), .c(new_n74_), .d(new_n73_), .O(new_n103_));
  ...
  nand4  g077(.a(new_n110_), .b(new_n97_), .c(new_n35_), .d(new_n71_), .O(new_n111_));
  ...
  oai21  g086(.a(new_n119_), .b(new_n87_), .c(x21), .O(new_n120_));
  ...
  nand4  g093(.a(new_n50_), .b(x06), .c(x03), .d(x01), .O(new_n127_));
  nor2   g094(.a(new_n36_), .b(new_n35_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n39_), .c(x20), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n127_), .c(x21), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n49_), .O(new_n131_));
  nor2   g098(.a(new_n39_), .b(new_n93_), .O(new_n132_));
  ...
  nand3  g103(.a(x15), .b(new_n44_), .c(new_n43_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nor2   g105(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nor3   g106(.a(new_n139_), .b(new_n74_), .c(new_n36_), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(x11), .c(x06), .d(x03), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n67_), .c(new_n131_), .O(z2));
  nand4  g109(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n143_));
  nand3  g110(.a(new_n128_), .b(x20), .c(x15), .O(new_n144_));
  nand3  g111(.a(new_n110_), .b(new_n68_), .c(new_n67_), .O(new_n145_));
  nand3  g112(.a(new_n115_), .b(new_n36_), .c(new_n35_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n143_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n122_), .O(new_n148_));
  nand2  g115(.a(new_n128_), .b(new_n94_), .O(new_n149_));
  nand4  g116(.a(x07), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n150_));
  nand4  g117(.a(new_n74_), .b(new_n36_), .c(new_n35_), .d(new_n70_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n143_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n88_), .c(x24), .O(new_n153_));
  nand3  g120(.a(x06), .b(x03), .c(x01), .O(new_n154_));
  nand4  g121(.a(x20), .b(x14), .c(x11), .d(x08), .O(new_n155_));
  nand4  g122(.a(new_n34_), .b(new_n68_), .c(new_n67_), .d(x00), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n151_), .c(new_n155_), .d(new_n154_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n39_), .c(new_n50_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x21), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n49_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n153_), .c(new_n148_), .O(z3));
  inv1   g128(.a(new_n47_), .O(new_n162_));
  ...
  oai21  g132(.a(new_n37_), .b(new_n70_), .c(new_n165_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n162_), .O(new_n167_));
  oai21  g134(.a(new_n76_), .b(x04), .c(x17), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x22), .c(new_n71_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n72_), .c(x08), .O(new_n170_));
  inv1   g137(.a(new_n135_), .O(new_n171_));
  nor2   g138(.a(x24), .b(x10), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n49_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n137_), .c(new_n136_), .d(new_n171_), .O(new_n174_));
  nand3  g141(.a(new_n52_), .b(new_n50_), .c(x00), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(x21), .c(x02), .O(new_n176_));
  aoi21  g143(.a(new_n174_), .b(new_n170_), .c(new_n176_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n167_), .O(z4));
  nand2  g145(.a(new_n53_), .b(new_n48_), .O(z5));
  ...
  oai21  g151(.a(new_n184_), .b(new_n68_), .c(new_n174_), .O(new_n185_));
  nand2  g152(.a(new_n172_), .b(x00), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(x21), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(new_n49_), .O(new_n188_));
  nand3  g155(.a(new_n188_), .b(new_n185_), .c(new_n182_), .O(z6));
  oai21  g156(.a(new_n172_), .b(new_n51_), .c(new_n49_), .O(new_n190_));
  nand2  g157(.a(new_n190_), .b(new_n139_), .O(z7));
endmodule
