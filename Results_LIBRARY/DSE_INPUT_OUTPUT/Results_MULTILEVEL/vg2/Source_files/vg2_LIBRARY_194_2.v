...
module FAU ( 
  ...
  nor2   g019(.a(x23), .b(new_n44_), .O(new_n53_));
  ...
  nand4  g064(.a(new_n97_), .b(new_n86_), .c(new_n65_), .d(new_n58_), .O(new_n98_));
  nor2   g065(.a(x03), .b(x01), .O(new_n99_));
  nor2   g066(.a(x06), .b(x04), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n99_), .c(new_n89_), .d(x00), .O(new_n101_));
  oai21  g068(.a(new_n101_), .b(new_n94_), .c(new_n98_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n40_), .c(new_n45_), .d(new_n44_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n96_), .c(new_n84_), .O(z1));
  ...
  nand2  g086(.a(new_n99_), .b(new_n72_), .O(new_n120_));
  nand3  g087(.a(new_n77_), .b(new_n105_), .c(new_n36_), .O(new_n121_));
  ...
  nand3  g091(.a(new_n99_), .b(x07), .c(new_n35_), .O(new_n125_));
  ...
  nand2  g097(.a(new_n118_), .b(new_n97_), .O(new_n131_));
  ...
  oai21  g107(.a(new_n140_), .b(x22), .c(new_n67_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand3  g109(.a(new_n40_), .b(new_n45_), .c(x00), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n48_), .c(new_n43_), .O(new_n144_));
  nor2   g111(.a(new_n144_), .b(new_n42_), .O(new_n145_));
  aoi21  g112(.a(new_n142_), .b(new_n126_), .c(new_n145_), .O(new_n146_));
  oai21  g113(.a(new_n63_), .b(x17), .c(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n126_), .O(new_n148_));
  nand3  g115(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n110_), .c(new_n109_), .O(new_n150_));
  nor2   g117(.a(new_n150_), .b(new_n108_), .O(new_n151_));
  nand3  g118(.a(x16), .b(new_n45_), .c(new_n69_), .O(new_n152_));
  nand4  g119(.a(new_n40_), .b(x23), .c(x22), .d(x21), .O(new_n153_));
  oai22  g120(.a(new_n153_), .b(new_n152_), .c(new_n151_), .d(new_n148_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n146_), .c(new_n44_), .O(new_n155_));
  nand2  g122(.a(new_n110_), .b(new_n109_), .O(new_n156_));
  oai21  g123(.a(new_n61_), .b(new_n69_), .c(x22), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x09), .c(new_n139_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n126_), .c(new_n156_), .d(new_n108_), .O(new_n159_));
  nand2  g126(.a(new_n63_), .b(x17), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n67_), .c(x16), .O(new_n161_));
  nand2  g128(.a(new_n48_), .b(new_n43_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n42_), .c(new_n161_), .d(x08), .O(new_n163_));
  ...
  oai21  g133(.a(new_n162_), .b(new_n42_), .c(new_n54_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n46_), .O(z5));
  nand2  g135(.a(x20), .b(new_n105_), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(new_n35_), .c(x11), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n171_));
  nand2  g138(.a(new_n37_), .b(x14), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(x06), .c(new_n36_), .O(new_n173_));
  oai22  g140(.a(new_n173_), .b(new_n34_), .c(new_n112_), .d(new_n108_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n171_), .c(new_n54_), .O(z6));
  nand4  g142(.a(new_n111_), .b(new_n110_), .c(new_n109_), .d(new_n54_), .O(new_n176_));
  or2    g143(.a(new_n176_), .b(new_n108_), .O(z7));
endmodule
