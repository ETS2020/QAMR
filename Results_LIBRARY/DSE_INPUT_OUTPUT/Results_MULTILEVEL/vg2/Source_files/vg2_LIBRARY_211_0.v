...
module FAU ( 
  ...
  oai21  g088(.a(new_n121_), .b(new_n65_), .c(new_n111_), .O(z2));
  nand4  g089(.a(new_n98_), .b(x08), .c(x06), .d(x03), .O(new_n123_));
  ...
  nand3  g094(.a(new_n57_), .b(x03), .c(x01), .O(new_n128_));
  nand3  g095(.a(new_n124_), .b(x20), .c(x15), .O(new_n129_));
  nand3  g096(.a(new_n69_), .b(new_n34_), .c(new_n65_), .O(new_n130_));
  nand3  g097(.a(new_n74_), .b(new_n37_), .c(new_n36_), .O(new_n131_));
  ...
  nand4  g101(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n135_));
  nand4  g102(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n56_), .O(new_n136_));
  ...
  oai21  g108(.a(x23), .b(new_n66_), .c(new_n141_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n140_), .c(x09), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x16), .c(new_n56_), .O(new_n144_));
  ...
  nand2  g123(.a(new_n156_), .b(new_n118_), .O(new_n157_));
  nand3  g124(.a(new_n108_), .b(new_n95_), .c(new_n98_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n157_), .O(z7));
  nand2  g126(.a(z7), .b(new_n155_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n150_), .O(z4));
  aoi21  g128(.a(new_n147_), .b(x00), .c(new_n65_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x02), .c(new_n145_), .O(z5));
  nand2  g130(.a(x20), .b(new_n37_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n35_), .c(x11), .O(new_n165_));
  nand3  g132(.a(new_n147_), .b(new_n106_), .c(x00), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n167_));
  oai21  g134(.a(new_n165_), .b(x03), .c(new_n167_), .O(new_n168_));
  oai21  g135(.a(x20), .b(new_n37_), .c(x06), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(x11), .c(x03), .O(new_n170_));
  oai21  g137(.a(x03), .b(new_n65_), .c(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n108_), .b(new_n98_), .c(new_n106_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n117_), .c(new_n116_), .d(new_n115_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n171_), .O(new_n174_));
  nand3  g141(.a(new_n118_), .b(new_n34_), .c(x02), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n174_), .c(new_n168_), .d(new_n156_), .O(z6));
endmodule
