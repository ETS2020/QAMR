...
module FAU ( 
  ...
  nand4  g017(.a(new_n41_), .b(new_n50_), .c(new_n37_), .d(x00), .O(new_n51_));
  ...
  nand2  g053(.a(new_n46_), .b(new_n39_), .O(new_n87_));
  ...
  nand3  g083(.a(new_n116_), .b(new_n46_), .c(new_n39_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n104_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n86_), .c(new_n50_), .O(new_n119_));
  nand3  g086(.a(new_n41_), .b(x13), .c(x05), .O(new_n120_));
  ...
  nor2   g092(.a(new_n41_), .b(new_n92_), .O(new_n126_));
  inv1   g093(.a(new_n126_), .O(new_n127_));
  nand3  g094(.a(new_n41_), .b(x15), .c(x13), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(new_n127_), .c(new_n39_), .O(new_n129_));
  inv1   g096(.a(new_n129_), .O(new_n130_));
  nand2  g097(.a(new_n126_), .b(x13), .O(new_n131_));
  nand3  g098(.a(x15), .b(new_n46_), .c(new_n39_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n131_), .c(new_n130_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n38_), .O(new_n134_));
  nor2   g101(.a(x24), .b(new_n56_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n50_), .c(new_n37_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n134_), .c(new_n73_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(x14), .c(x11), .d(x06), .O(new_n138_));
  nor3   g105(.a(new_n138_), .b(new_n67_), .c(new_n66_), .O(z2));
  nand4  g106(.a(new_n58_), .b(x20), .c(x14), .d(x11), .O(new_n140_));
  nor2   g107(.a(new_n140_), .b(new_n69_), .O(new_n141_));
  nand4  g108(.a(new_n141_), .b(x06), .c(x03), .d(x01), .O(new_n142_));
  nand4  g109(.a(new_n78_), .b(new_n73_), .c(new_n36_), .d(new_n35_), .O(new_n143_));
  nor2   g110(.a(new_n143_), .b(x08), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n34_), .c(new_n67_), .d(new_n66_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n142_), .c(x24), .O(new_n146_));
  nand4  g113(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n147_));
  nand3  g114(.a(new_n93_), .b(x14), .c(x11), .O(new_n148_));
  nand4  g115(.a(x07), .b(new_n34_), .c(new_n67_), .d(new_n66_), .O(new_n149_));
  ...
  nand3  g118(.a(new_n151_), .b(new_n87_), .c(x24), .O(new_n152_));
  nand4  g119(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n153_));
  nand3  g120(.a(new_n109_), .b(new_n67_), .c(new_n66_), .O(new_n154_));
  nand3  g121(.a(new_n114_), .b(new_n36_), .c(new_n35_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n147_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n46_), .c(new_n39_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n152_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n146_), .c(new_n50_), .O(new_n159_));
  nand2  g126(.a(new_n156_), .b(new_n121_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n152_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(x02), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n159_), .O(z3));
  oai21  g130(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n74_), .c(x09), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x16), .c(new_n69_), .O(new_n166_));
  nand3  g133(.a(new_n41_), .b(new_n37_), .c(x00), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n47_), .c(new_n45_), .d(new_n44_), .O(new_n168_));
  ...
  nand2  g139(.a(new_n135_), .b(new_n37_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n132_), .c(new_n131_), .d(new_n130_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n172_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n169_), .c(new_n38_), .O(z4));
  inv1   g143(.a(new_n48_), .O(new_n177_));
  aoi21  g144(.a(new_n41_), .b(x00), .c(x10), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(x02), .c(new_n177_), .O(z5));
  nand2  g146(.a(x20), .b(new_n36_), .O(new_n180_));
  aoi21  g147(.a(new_n180_), .b(new_n34_), .c(x11), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(x03), .c(new_n168_), .O(new_n182_));
  nand2  g149(.a(new_n73_), .b(x14), .O(new_n183_));
  aoi21  g150(.a(new_n183_), .b(x06), .c(new_n35_), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n67_), .c(new_n174_), .O(new_n185_));
  nand3  g152(.a(new_n185_), .b(new_n182_), .c(new_n38_), .O(z6));
  inv1   g153(.a(new_n133_), .O(new_n187_));
  oai21  g154(.a(new_n135_), .b(x10), .c(new_n37_), .O(new_n188_));
  nand2  g155(.a(new_n188_), .b(new_n187_), .O(z7));
endmodule
