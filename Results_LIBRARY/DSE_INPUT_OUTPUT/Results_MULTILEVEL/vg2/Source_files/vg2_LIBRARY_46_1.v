...
module FAU ( 
  ...
  nand2  g116(.a(x20), .b(new_n103_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n36_), .c(x11), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x03), .c(new_n139_), .O(new_n152_));
  oai21  g119(.a(x20), .b(new_n103_), .c(x06), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(x11), .c(x03), .O(new_n154_));
  nand2  g121(.a(new_n147_), .b(new_n35_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n79_), .c(x18), .O(new_n157_));
  inv1   g124(.a(new_n157_), .O(new_n158_));
  nor3   g125(.a(new_n108_), .b(x03), .c(new_n66_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n158_), .c(x24), .O(new_n160_));
  nand2  g127(.a(x24), .b(new_n35_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n47_), .c(new_n39_), .O(new_n162_));
  ...
  nand3  g132(.a(new_n165_), .b(new_n153_), .c(x11), .O(new_n166_));
  inv1   g133(.a(new_n147_), .O(new_n167_));
  nand3  g134(.a(new_n41_), .b(x21), .c(new_n45_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n108_), .O(new_n169_));
  ...
  nand3  g139(.a(new_n172_), .b(new_n41_), .c(x15), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n170_), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(new_n35_), .c(new_n167_), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n166_), .c(new_n160_), .d(new_n152_), .O(z6));
  nand2  g143(.a(new_n108_), .b(new_n107_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n106_), .c(new_n147_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n109_), .O(z7));
endmodule
