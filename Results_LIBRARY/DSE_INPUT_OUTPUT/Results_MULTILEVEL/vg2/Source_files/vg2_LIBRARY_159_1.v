...
module FAU ( 
  ...
  nand2  g108(.a(x02), .b(new_n90_), .O(new_n142_));
  ...
  oai21  g119(.a(new_n152_), .b(new_n111_), .c(new_n142_), .O(new_n153_));
  ...
  aoi21  g123(.a(x20), .b(new_n67_), .c(x06), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x11), .c(new_n35_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(z5), .O(new_n159_));
  aoi21  g126(.a(new_n38_), .b(x14), .c(new_n36_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n37_), .c(x03), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n154_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n159_), .O(z6));
  inv1   g130(.a(new_n111_), .O(new_n164_));
  and2   g131(.a(new_n114_), .b(new_n113_), .O(new_n165_));
  nand4  g132(.a(new_n142_), .b(new_n165_), .c(new_n112_), .d(new_n164_), .O(z7));
endmodule
