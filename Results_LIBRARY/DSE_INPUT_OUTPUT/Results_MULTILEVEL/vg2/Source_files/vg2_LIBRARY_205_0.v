...
module FAU ( 
  ...
  nor2   g019(.a(x12), .b(x10), .O(new_n53_));
  ...
  nand2  g049(.a(new_n82_), .b(new_n60_), .O(new_n83_));
  ...
  nand4  g058(.a(new_n91_), .b(new_n73_), .c(new_n37_), .d(new_n86_), .O(new_n92_));
  oai21  g059(.a(new_n92_), .b(new_n85_), .c(new_n83_), .O(new_n93_));
  ...
  nand4  g067(.a(new_n100_), .b(new_n98_), .c(x22), .d(x21), .O(new_n101_));
  oai21  g068(.a(new_n101_), .b(new_n96_), .c(x12), .O(new_n102_));
  nand2  g069(.a(new_n102_), .b(new_n45_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n94_), .c(new_n79_), .O(z1));
  ...
  nand4  g094(.a(new_n127_), .b(new_n37_), .c(new_n88_), .d(new_n36_), .O(new_n128_));
  ...
  nand4  g102(.a(new_n37_), .b(new_n88_), .c(new_n36_), .d(new_n118_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n133_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n76_), .c(x24), .O(new_n138_));
  nand4  g105(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n139_));
  nand3  g106(.a(new_n67_), .b(new_n34_), .c(new_n105_), .O(new_n140_));
  nand3  g107(.a(new_n72_), .b(new_n88_), .c(new_n36_), .O(new_n141_));
  ...
  oai21  g117(.a(x23), .b(new_n56_), .c(new_n86_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n150_), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n118_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n149_), .O(new_n154_));
  or2    g121(.a(new_n113_), .b(new_n108_), .O(new_n155_));
  oai21  g122(.a(new_n99_), .b(x04), .c(x17), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n65_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n89_), .c(x08), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n154_), .c(new_n54_), .O(z4));
  nand3  g127(.a(new_n40_), .b(new_n44_), .c(x00), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(x12), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n45_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n48_), .c(new_n43_), .d(new_n147_), .O(z5));
  nand2  g131(.a(x20), .b(new_n88_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n35_), .c(x11), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(x03), .c(new_n149_), .O(new_n167_));
  oai21  g134(.a(x20), .b(new_n88_), .c(x06), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(x11), .c(x03), .O(new_n169_));
  oai21  g136(.a(new_n87_), .b(x03), .c(new_n169_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n155_), .O(new_n171_));
  nand2  g138(.a(new_n110_), .b(new_n109_), .O(new_n172_));
  nor2   g139(.a(new_n172_), .b(new_n108_), .O(new_n173_));
  nor2   g140(.a(new_n173_), .b(new_n45_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n34_), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n171_), .c(new_n167_), .d(new_n54_), .O(z6));
  nand4  g143(.a(new_n111_), .b(new_n40_), .c(x21), .d(x12), .O(new_n177_));
  oai21  g144(.a(new_n173_), .b(new_n53_), .c(new_n177_), .O(z7));
endmodule
