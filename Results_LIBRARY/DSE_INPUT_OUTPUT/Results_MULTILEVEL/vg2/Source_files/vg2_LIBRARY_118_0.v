...
module FAU ( 
  ...
  nand3  g083(.a(new_n58_), .b(x03), .c(x01), .O(new_n117_));
  nor2   g084(.a(new_n37_), .b(new_n36_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(x20), .c(x15), .O(new_n119_));
  nand4  g086(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n65_), .O(new_n120_));
  nand4  g087(.a(new_n73_), .b(new_n37_), .c(new_n36_), .d(new_n57_), .O(new_n121_));
  oai22  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n117_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n80_), .O(new_n123_));
  nand3  g090(.a(new_n118_), .b(x20), .c(x18), .O(new_n124_));
  nor2   g091(.a(x20), .b(x14), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n36_), .c(new_n57_), .d(x07), .O(new_n126_));
  ...
  nor2   g095(.a(x02), .b(new_n65_), .O(new_n129_));
  nand2  g096(.a(new_n118_), .b(new_n98_), .O(new_n130_));
  ...
  nand4  g100(.a(new_n133_), .b(new_n129_), .c(new_n58_), .d(x03), .O(new_n134_));
  ...
  oai21  g120(.a(new_n153_), .b(new_n108_), .c(new_n141_), .O(new_n154_));
  nand4  g121(.a(new_n131_), .b(x14), .c(new_n98_), .d(new_n95_), .O(new_n155_));
  ...
  aoi22  g130(.a(new_n163_), .b(x11), .c(new_n162_), .d(new_n141_), .O(new_n164_));
  nor2   g131(.a(new_n38_), .b(x14), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n36_), .c(x07), .d(x02), .O(new_n166_));
  oai21  g133(.a(new_n164_), .b(new_n161_), .c(new_n166_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n78_), .c(x24), .O(new_n168_));
  inv1   g135(.a(x15), .O(new_n169_));
  nor2   g136(.a(new_n164_), .b(new_n169_), .O(new_n170_));
  nand3  g137(.a(x20), .b(x19), .c(new_n37_), .O(new_n171_));
  nor3   g138(.a(new_n171_), .b(x11), .c(new_n95_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n170_), .c(new_n80_), .O(new_n173_));
  nand2  g140(.a(x20), .b(x06), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x11), .c(new_n34_), .O(new_n175_));
  nor3   g142(.a(new_n175_), .b(x24), .c(new_n101_), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(x14), .c(new_n98_), .d(new_n95_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n173_), .c(new_n168_), .d(new_n160_), .O(z6));
endmodule
