...
module FAU ( 
  ...
  nand4  g135(.a(new_n153_), .b(new_n168_), .c(new_n43_), .d(new_n167_), .O(z5));
  ...
  nand2  g141(.a(new_n174_), .b(new_n164_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n172_), .O(z6));
  inv1   g143(.a(new_n120_), .O(new_n177_));
  and2   g144(.a(new_n163_), .b(new_n122_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n153_), .c(new_n121_), .d(new_n177_), .O(z7));
endmodule
