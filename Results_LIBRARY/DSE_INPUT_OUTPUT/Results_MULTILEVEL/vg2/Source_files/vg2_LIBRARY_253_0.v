...
module FAU ( 
  ...
  nand3  g066(.a(x15), .b(new_n44_), .c(new_n38_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  oai21  g068(.a(new_n101_), .b(new_n98_), .c(x20), .O(new_n102_));
  nor2   g069(.a(new_n102_), .b(new_n95_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(x11), .c(x06), .d(x03), .O(new_n104_));
  oai21  g071(.a(new_n104_), .b(new_n94_), .c(new_n51_), .O(z2));
  nand4  g072(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n106_));
  nand4  g073(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n107_));
  nand3  g074(.a(new_n79_), .b(new_n34_), .c(new_n94_), .O(new_n108_));
  nand3  g075(.a(new_n84_), .b(new_n95_), .c(new_n36_), .O(new_n109_));
  oai22  g076(.a(new_n109_), .b(new_n108_), .c(new_n107_), .d(new_n106_), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n91_), .O(new_n111_));
  nand4  g078(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n112_));
  nand3  g079(.a(new_n65_), .b(new_n34_), .c(new_n94_), .O(new_n113_));
  nand4  g080(.a(new_n37_), .b(new_n95_), .c(new_n36_), .d(new_n61_), .O(new_n114_));
  oai22  g081(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(new_n106_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n73_), .c(x24), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(new_n111_), .c(new_n51_), .O(z3));
  inv1   g084(.a(x16), .O(new_n118_));
  inv1   g085(.a(x23), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(x04), .c(x17), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(x22), .c(new_n62_), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(new_n118_), .c(x08), .O(new_n122_));
  oai21  g089(.a(new_n101_), .b(new_n98_), .c(new_n122_), .O(new_n123_));
  nor2   g090(.a(new_n40_), .b(x13), .O(new_n124_));
  aoi22  g091(.a(new_n124_), .b(new_n38_), .c(new_n91_), .d(x02), .O(new_n125_));
  nand3  g092(.a(new_n73_), .b(x24), .c(x07), .O(new_n126_));
  oai21  g093(.a(new_n125_), .b(new_n83_), .c(new_n126_), .O(z5));
  ...
  oai21  g099(.a(new_n132_), .b(x16), .c(new_n61_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(z5), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n123_), .c(new_n51_), .O(z4));
  inv1   g102(.a(x15), .O(new_n136_));
  oai21  g103(.a(x20), .b(new_n95_), .c(x06), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(x11), .c(new_n34_), .O(new_n138_));
  nor2   g105(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  oai21  g106(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n36_), .c(x03), .O(new_n141_));
  nor2   g108(.a(new_n141_), .b(new_n83_), .O(new_n142_));
  nor2   g109(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  inv1   g110(.a(x18), .O(new_n144_));
  oai22  g111(.a(new_n141_), .b(new_n64_), .c(new_n138_), .d(new_n144_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n73_), .c(x24), .O(new_n146_));
  oai21  g113(.a(new_n143_), .b(new_n125_), .c(new_n146_), .O(z6));
  nand3  g114(.a(new_n100_), .b(new_n99_), .c(new_n51_), .O(new_n148_));
  or2    g115(.a(new_n148_), .b(new_n98_), .O(z7));
endmodule
