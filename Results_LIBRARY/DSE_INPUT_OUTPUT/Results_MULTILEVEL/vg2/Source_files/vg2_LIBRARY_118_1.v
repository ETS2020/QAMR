...
module FAU ( 
  ...
  aoi21  g108(.a(new_n141_), .b(new_n61_), .c(x09), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x16), .c(new_n84_), .O(new_n143_));
  nand2  g110(.a(x14), .b(new_n44_), .O(new_n144_));
  nand2  g111(.a(new_n48_), .b(new_n43_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n42_), .c(new_n144_), .O(new_n146_));
  nor2   g113(.a(x24), .b(x14), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n45_), .c(new_n44_), .d(x00), .O(new_n148_));
  ...
  nand2  g120(.a(new_n144_), .b(new_n114_), .O(new_n154_));
  nor2   g121(.a(x10), .b(x02), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n40_), .c(x21), .d(new_n89_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n154_), .O(z7));
  ...
  nor2   g129(.a(new_n37_), .b(x14), .O(new_n163_));
  aoi22  g130(.a(new_n163_), .b(new_n36_), .c(new_n162_), .d(new_n144_), .O(new_n164_));
  nor2   g131(.a(new_n164_), .b(new_n71_), .O(new_n165_));
  nand3  g132(.a(new_n37_), .b(x15), .c(x14), .O(new_n166_));
  nor3   g133(.a(new_n166_), .b(new_n36_), .c(new_n44_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n165_), .c(new_n78_), .O(new_n168_));
  nor2   g135(.a(new_n36_), .b(new_n44_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n37_), .c(x18), .d(x14), .O(new_n170_));
  oai21  g137(.a(new_n164_), .b(new_n85_), .c(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n76_), .c(x24), .O(new_n172_));
  nor2   g139(.a(x20), .b(x06), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x11), .c(new_n34_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n40_), .c(new_n89_), .d(new_n45_), .O(new_n175_));
  inv1   g142(.a(new_n175_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n44_), .c(x00), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n172_), .c(new_n168_), .d(new_n161_), .O(z6));
endmodule
