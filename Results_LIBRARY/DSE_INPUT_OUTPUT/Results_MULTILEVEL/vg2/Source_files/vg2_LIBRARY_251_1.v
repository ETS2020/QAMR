...
module FAU ( 
  ...
  nand4  g034(.a(new_n67_), .b(x06), .c(x04), .d(x01), .O(new_n68_));
  ...
  nand4  g043(.a(new_n76_), .b(new_n73_), .c(new_n72_), .d(new_n59_), .O(new_n77_));
  nor3   g044(.a(new_n77_), .b(x14), .c(x12), .O(new_n78_));
  nand4  g045(.a(new_n78_), .b(new_n37_), .c(new_n71_), .d(new_n57_), .O(new_n79_));
  nor2   g046(.a(new_n79_), .b(x06), .O(new_n80_));
  nand4  g047(.a(new_n80_), .b(new_n70_), .c(new_n69_), .d(new_n35_), .O(new_n81_));
  ...
  nor2   g051(.a(new_n36_), .b(new_n70_), .O(new_n85_));
  ...
  nor4   g055(.a(new_n88_), .b(new_n72_), .c(new_n59_), .d(new_n58_), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n87_), .c(new_n85_), .d(x01), .O(new_n90_));
  nor3   g057(.a(x04), .b(x03), .c(x01), .O(new_n91_));
  nor2   g058(.a(new_n38_), .b(x06), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n91_), .c(new_n71_), .d(new_n57_), .O(new_n93_));
  nor3   g060(.a(x14), .b(x12), .c(x11), .O(new_n94_));
  nor2   g061(.a(x23), .b(x22), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n94_), .c(new_n72_), .d(new_n59_), .O(new_n96_));
  oai21  g063(.a(new_n96_), .b(new_n93_), .c(new_n90_), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n84_), .c(x24), .O(new_n98_));
  nor3   g065(.a(x05), .b(x04), .c(x01), .O(new_n99_));
  nor2   g066(.a(x11), .b(x09), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n99_), .c(new_n57_), .d(new_n36_), .O(new_n101_));
  inv1   g068(.a(x12), .O(new_n102_));
  nand4  g069(.a(new_n59_), .b(new_n58_), .c(new_n48_), .d(new_n102_), .O(new_n103_));
  inv1   g070(.a(new_n103_), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n95_), .c(x19), .d(new_n72_), .O(new_n105_));
  oai21  g072(.a(new_n105_), .b(new_n101_), .c(new_n34_), .O(new_n106_));
  nand2  g073(.a(new_n106_), .b(new_n69_), .O(new_n107_));
  nand4  g074(.a(x06), .b(new_n47_), .c(x04), .d(x01), .O(new_n108_));
  nor2   g075(.a(new_n108_), .b(new_n86_), .O(new_n109_));
  nand4  g076(.a(x16), .b(x15), .c(x14), .d(new_n48_), .O(new_n110_));
  ...
  nand3  g080(.a(new_n113_), .b(new_n107_), .c(new_n98_), .O(new_n114_));
  ...
  aoi21  g093(.a(new_n126_), .b(x03), .c(new_n34_), .O(z2));
  nand2  g094(.a(new_n62_), .b(new_n61_), .O(new_n128_));
  ...
  nand4  g099(.a(new_n132_), .b(new_n34_), .c(new_n58_), .d(new_n37_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x08), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n36_), .c(new_n69_), .d(new_n35_), .O(new_n135_));
  ...
  nand3  g106(.a(new_n92_), .b(new_n69_), .c(new_n35_), .O(new_n140_));
  nand4  g107(.a(new_n34_), .b(new_n58_), .c(new_n37_), .d(new_n57_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(new_n138_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n84_), .c(x24), .O(new_n143_));
  nand4  g110(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n144_));
  nand4  g111(.a(new_n57_), .b(new_n36_), .c(new_n69_), .d(new_n35_), .O(new_n145_));
  nand4  g112(.a(new_n34_), .b(x19), .c(new_n58_), .d(new_n37_), .O(new_n146_));
  ...
  nor2   g119(.a(new_n152_), .b(new_n57_), .O(new_n153_));
  nor2   g120(.a(new_n34_), .b(x03), .O(new_n154_));
  aoi21  g121(.a(new_n60_), .b(x04), .c(x17), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x22), .c(new_n71_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n59_), .c(new_n57_), .O(new_n157_));
  oai21  g124(.a(new_n154_), .b(new_n57_), .c(new_n157_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n52_), .c(new_n154_), .O(new_n159_));
  oai21  g126(.a(new_n153_), .b(new_n124_), .c(new_n159_), .O(z4));
  nor2   g127(.a(new_n154_), .b(new_n53_), .O(z5));
  nand3  g128(.a(new_n34_), .b(new_n37_), .c(x06), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n69_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n52_), .O(new_n164_));
  nand2  g131(.a(new_n36_), .b(x03), .O(new_n165_));
  nand2  g132(.a(new_n34_), .b(x14), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  aoi22  g134(.a(new_n167_), .b(x11), .c(new_n34_), .d(new_n69_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n124_), .c(new_n164_), .O(z6));
  inv1   g136(.a(new_n119_), .O(new_n170_));
  inv1   g137(.a(new_n122_), .O(new_n171_));
  nor2   g138(.a(new_n154_), .b(new_n171_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n121_), .c(new_n120_), .d(new_n170_), .O(z7));
endmodule
