...
module FAU ( 
  ...
  nand4  g053(.a(new_n86_), .b(new_n67_), .c(new_n63_), .d(new_n55_), .O(new_n87_));
  ...
  oai21  g058(.a(new_n91_), .b(new_n87_), .c(new_n84_), .O(new_n92_));
  nand3  g059(.a(new_n92_), .b(new_n77_), .c(x24), .O(new_n93_));
  inv1   g060(.a(new_n81_), .O(new_n94_));
  inv1   g061(.a(x02), .O(new_n95_));
  nand4  g062(.a(x04), .b(x03), .c(new_n95_), .d(x01), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  inv1   g064(.a(x10), .O(new_n98_));
  nand3  g065(.a(x11), .b(new_n98_), .c(x09), .O(new_n99_));
  nor3   g066(.a(new_n99_), .b(new_n55_), .c(new_n35_), .O(new_n100_));
  ...
  nand3  g071(.a(new_n104_), .b(new_n93_), .c(new_n80_), .O(z1));
  nand2  g072(.a(x24), .b(x18), .O(new_n106_));
  nand3  g073(.a(new_n40_), .b(x15), .c(x13), .O(new_n107_));
  aoi21  g074(.a(new_n107_), .b(new_n106_), .c(new_n45_), .O(new_n108_));
  nand3  g075(.a(x24), .b(x18), .c(x13), .O(new_n109_));
  nand3  g076(.a(x15), .b(new_n46_), .c(new_n45_), .O(new_n110_));
  nor2   g077(.a(x24), .b(new_n101_), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n98_), .c(new_n95_), .O(new_n112_));
  ...
  nor2   g084(.a(new_n34_), .b(new_n64_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(new_n98_), .c(x08), .d(x06), .O(new_n119_));
  nor2   g086(.a(new_n37_), .b(new_n36_), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(new_n111_), .c(x20), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(new_n119_), .c(x11), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n95_), .O(new_n123_));
  nand2  g090(.a(new_n118_), .b(new_n56_), .O(new_n124_));
  nand3  g091(.a(new_n120_), .b(x20), .c(x15), .O(new_n125_));
  nand3  g092(.a(new_n68_), .b(new_n34_), .c(new_n64_), .O(new_n126_));
  nand3  g093(.a(new_n73_), .b(new_n37_), .c(new_n36_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n124_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n79_), .O(new_n129_));
  nand3  g096(.a(new_n120_), .b(x20), .c(x18), .O(new_n130_));
  nand3  g097(.a(new_n86_), .b(new_n34_), .c(new_n64_), .O(new_n131_));
  nand4  g098(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n55_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n124_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n77_), .c(x24), .O(new_n134_));
  ...
  oai21  g105(.a(new_n138_), .b(x22), .c(new_n63_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n136_), .c(new_n55_), .O(new_n140_));
  oai21  g107(.a(new_n36_), .b(new_n55_), .c(new_n140_), .O(new_n141_));
  inv1   g108(.a(x00), .O(new_n142_));
  nor2   g109(.a(x02), .b(new_n142_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n40_), .c(new_n98_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  oai21  g113(.a(new_n137_), .b(x04), .c(x17), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x22), .c(new_n63_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n136_), .c(x08), .O(new_n149_));
  ...
  nand4  g124(.a(new_n149_), .b(new_n40_), .c(x21), .d(new_n98_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x11), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n95_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n157_), .c(new_n153_), .d(new_n146_), .O(z4));
  oai21  g128(.a(x11), .b(x02), .c(new_n48_), .O(new_n162_));
  nand4  g129(.a(new_n143_), .b(new_n40_), .c(x11), .d(new_n98_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n162_), .O(z5));
  or2    g131(.a(new_n113_), .b(new_n108_), .O(new_n165_));
  nand2  g132(.a(new_n38_), .b(x14), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(x06), .c(x03), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n165_), .c(x11), .O(new_n168_));
  nand4  g135(.a(new_n40_), .b(new_n98_), .c(x03), .d(x00), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(x11), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n95_), .O(new_n171_));
  oai21  g138(.a(new_n38_), .b(x14), .c(new_n35_), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n36_), .c(x03), .O(new_n173_));
  nand3  g140(.a(x15), .b(new_n34_), .c(x02), .O(new_n174_));
  oai21  g141(.a(new_n173_), .b(new_n72_), .c(new_n174_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n79_), .O(new_n176_));
  nand3  g143(.a(x18), .b(new_n34_), .c(x02), .O(new_n177_));
  oai21  g144(.a(new_n173_), .b(new_n85_), .c(new_n177_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n77_), .c(x24), .O(new_n179_));
  nand4  g146(.a(new_n179_), .b(new_n176_), .c(new_n171_), .d(new_n168_), .O(z6));
  nand2  g147(.a(new_n110_), .b(new_n109_), .O(new_n181_));
  oai22  g148(.a(new_n181_), .b(new_n108_), .c(x11), .d(x02), .O(new_n182_));
  nand4  g149(.a(new_n111_), .b(x11), .c(new_n98_), .d(new_n95_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n182_), .O(z7));
endmodule
