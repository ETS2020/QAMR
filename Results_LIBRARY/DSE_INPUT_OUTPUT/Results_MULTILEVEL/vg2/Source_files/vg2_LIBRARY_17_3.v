...
module FAU ( 
  ...
  aoi21  g090(.a(new_n123_), .b(new_n122_), .c(new_n46_), .O(new_n124_));
  nand3  g091(.a(x24), .b(x18), .c(x13), .O(new_n125_));
  nand3  g092(.a(x15), .b(new_n47_), .c(new_n46_), .O(new_n126_));
  nand4  g093(.a(new_n42_), .b(x21), .c(new_n40_), .d(new_n51_), .O(new_n127_));
  ...
  oai21  g098(.a(new_n131_), .b(new_n34_), .c(new_n48_), .O(z2));
  nand4  g099(.a(new_n63_), .b(x20), .c(x14), .d(x11), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(new_n72_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(x06), .c(x03), .d(x01), .O(new_n135_));
  nand4  g102(.a(new_n80_), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n136_));
  ...
  inv1   g107(.a(new_n90_), .O(new_n141_));
  nand4  g108(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n142_));
  nand4  g109(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n143_));
  nand4  g110(.a(x07), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n144_));
  nand4  g111(.a(new_n39_), .b(new_n38_), .c(new_n37_), .d(new_n72_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n141_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n40_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(x24), .O(new_n149_));
  nand4  g116(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n150_));
  nand3  g117(.a(new_n110_), .b(new_n35_), .c(new_n34_), .O(new_n151_));
  nand3  g118(.a(new_n115_), .b(new_n38_), .c(new_n37_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n142_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n47_), .c(new_n46_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n149_), .c(new_n140_), .O(z3));
  oai21  g122(.a(x23), .b(new_n71_), .c(new_n75_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n76_), .c(x09), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x16), .c(new_n72_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n55_), .O(new_n159_));
  oai21  g126(.a(new_n77_), .b(x04), .c(x17), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x22), .c(new_n73_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n74_), .c(x08), .O(new_n162_));
  oai21  g129(.a(new_n122_), .b(x10), .c(new_n123_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(x05), .O(new_n164_));
  nand4  g131(.a(new_n48_), .b(x15), .c(new_n47_), .d(new_n46_), .O(new_n165_));
  nand3  g132(.a(new_n42_), .b(x21), .c(new_n51_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n125_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n40_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n164_), .O(z7));
  nand2  g136(.a(z7), .b(new_n162_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n159_), .O(z4));
  inv1   g138(.a(x07), .O(new_n172_));
  oai21  g139(.a(new_n42_), .b(new_n172_), .c(new_n43_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(x05), .O(new_n174_));
  oai21  g141(.a(new_n47_), .b(new_n172_), .c(new_n40_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(x24), .O(new_n176_));
  nand3  g143(.a(x19), .b(new_n47_), .c(new_n46_), .O(new_n177_));
  nand4  g144(.a(new_n42_), .b(new_n40_), .c(new_n51_), .d(x00), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n177_), .c(new_n176_), .d(new_n174_), .O(z5));
  aoi21  g146(.a(x20), .b(new_n38_), .c(x06), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(x11), .c(new_n35_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n55_), .O(new_n182_));
  aoi21  g149(.a(new_n39_), .b(x14), .c(new_n36_), .O(new_n183_));
  oai21  g150(.a(new_n183_), .b(new_n37_), .c(x03), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(z7), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n182_), .O(z6));
endmodule
