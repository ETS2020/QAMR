...
module FAU ( 
  ...
  nand2  g101(.a(new_n127_), .b(new_n122_), .O(new_n135_));
  ...
  oai21  g105(.a(new_n138_), .b(x22), .c(new_n67_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n71_), .O(new_n140_));
  nand3  g107(.a(new_n40_), .b(new_n49_), .c(x00), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n45_), .c(new_n43_), .O(new_n142_));
  nor2   g109(.a(new_n142_), .b(new_n42_), .O(new_n143_));
  aoi21  g110(.a(new_n140_), .b(new_n66_), .c(new_n143_), .O(new_n144_));
  oai21  g111(.a(new_n61_), .b(x17), .c(x09), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x16), .c(new_n66_), .O(new_n146_));
  nand3  g113(.a(new_n40_), .b(x21), .c(new_n49_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n109_), .c(new_n108_), .O(new_n148_));
  nor2   g115(.a(new_n148_), .b(new_n107_), .O(new_n149_));
  nand3  g116(.a(x16), .b(new_n49_), .c(new_n134_), .O(new_n150_));
  nand4  g117(.a(new_n40_), .b(x23), .c(x22), .d(x21), .O(new_n151_));
  ...
  nor2   g120(.a(new_n46_), .b(new_n42_), .O(new_n154_));
  oai21  g121(.a(x22), .b(new_n72_), .c(new_n67_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n71_), .c(x08), .O(new_n156_));
  nor2   g123(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nor2   g124(.a(new_n110_), .b(new_n107_), .O(new_n158_));
  aoi21  g125(.a(new_n62_), .b(x17), .c(new_n61_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n67_), .c(x16), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x08), .c(new_n158_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n157_), .c(new_n134_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n153_), .O(z4));
  nand2  g130(.a(new_n50_), .b(new_n47_), .O(z5));
  aoi21  g131(.a(x20), .b(new_n36_), .c(x06), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x11), .c(new_n104_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(z5), .O(new_n167_));
  nand2  g134(.a(new_n112_), .b(new_n111_), .O(new_n168_));
  aoi21  g135(.a(new_n74_), .b(x14), .c(new_n34_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n35_), .c(x03), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n167_), .O(z6));
  inv1   g139(.a(new_n107_), .O(new_n173_));
  and2   g140(.a(new_n112_), .b(new_n109_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n108_), .c(new_n173_), .d(new_n37_), .O(z7));
endmodule
