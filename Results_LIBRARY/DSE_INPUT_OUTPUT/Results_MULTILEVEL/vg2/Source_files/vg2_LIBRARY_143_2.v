...
module FAU ( 
  ...
  nand4  g065(.a(new_n75_), .b(new_n74_), .c(new_n52_), .d(new_n73_), .O(new_n99_));
  ...
  nand4  g076(.a(new_n75_), .b(new_n74_), .c(new_n52_), .d(x19), .O(new_n110_));
  ...
  nor4   g090(.a(new_n123_), .b(new_n75_), .c(new_n52_), .d(new_n71_), .O(new_n124_));
  ...
  nand4  g096(.a(new_n78_), .b(new_n52_), .c(new_n71_), .d(new_n36_), .O(new_n130_));
  ...
  nand4  g105(.a(new_n52_), .b(new_n71_), .c(new_n36_), .d(new_n69_), .O(new_n139_));
  ...
  nand4  g110(.a(new_n52_), .b(x19), .c(new_n71_), .d(new_n36_), .O(new_n144_));
  ...
  oai21  g115(.a(new_n75_), .b(x04), .c(x17), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n70_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n72_), .c(x08), .O(new_n151_));
  ...
  oai21  g121(.a(new_n154_), .b(x22), .c(new_n70_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n72_), .c(new_n69_), .O(new_n156_));
  oai21  g123(.a(new_n53_), .b(new_n69_), .c(new_n156_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n153_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n152_), .c(new_n54_), .O(z4));
  nor2   g126(.a(new_n53_), .b(new_n49_), .O(z5));
  nand2  g127(.a(x20), .b(new_n71_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n35_), .c(x11), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x03), .c(new_n153_), .O(new_n163_));
  nand2  g130(.a(new_n52_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n36_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n34_), .c(new_n148_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n54_), .O(z6));
  inv1   g134(.a(new_n118_), .O(new_n168_));
  and2   g135(.a(new_n120_), .b(new_n119_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n121_), .c(new_n168_), .d(new_n54_), .O(z7));
endmodule
