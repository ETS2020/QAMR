...
module FAU ( 
  ...
  inv1   g082(.a(new_n42_), .O(new_n116_));
  nand3  g083(.a(new_n45_), .b(new_n43_), .c(new_n116_), .O(new_n117_));
  ...
  nand2  g096(.a(new_n129_), .b(new_n97_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n124_), .c(new_n50_), .O(z4));
  nand4  g098(.a(new_n50_), .b(new_n45_), .c(new_n43_), .d(new_n116_), .O(z5));
  nand2  g099(.a(x20), .b(new_n105_), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(new_n35_), .c(x11), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(x03), .c(new_n117_), .O(new_n135_));
  nand2  g102(.a(new_n37_), .b(x14), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(x06), .c(new_n36_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n34_), .c(new_n97_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n135_), .c(new_n50_), .O(z6));
  nand4  g106(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n50_), .O(z7));
endmodule
