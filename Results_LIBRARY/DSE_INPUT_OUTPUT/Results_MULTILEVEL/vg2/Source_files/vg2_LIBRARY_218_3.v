...
module FAU ( 
  ...
  oai21  g120(.a(x23), .b(new_n55_), .c(new_n90_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n114_), .c(x09), .O(new_n155_));
  ...
  oai21  g127(.a(new_n104_), .b(x04), .c(x17), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x22), .c(new_n67_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n93_), .c(x08), .O(new_n163_));
  nand3  g130(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(new_n164_));
  ...
  and2   g137(.a(new_n48_), .b(new_n46_), .O(new_n171_));
  nand4  g138(.a(new_n53_), .b(new_n171_), .c(new_n43_), .d(new_n170_), .O(z5));
  aoi21  g139(.a(x20), .b(new_n92_), .c(x06), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x11), .c(new_n34_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n159_), .O(new_n175_));
  aoi21  g142(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n36_), .c(x03), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n167_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n175_), .O(z6));
  and2   g146(.a(new_n123_), .b(new_n53_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n166_), .c(new_n124_), .d(new_n122_), .O(z7));
endmodule
