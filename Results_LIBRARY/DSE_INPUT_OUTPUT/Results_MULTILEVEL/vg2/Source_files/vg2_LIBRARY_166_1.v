...
module FAU ( 
  ...
  nor4   g016(.a(new_n49_), .b(x22), .c(x20), .d(x14), .O(new_n50_));
  ...
  nand4  g096(.a(new_n76_), .b(new_n72_), .c(new_n71_), .d(new_n68_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(x11), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n66_), .c(new_n35_), .d(new_n34_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(x01), .c(new_n129_), .O(new_n133_));
  ...
  nor2   g105(.a(x22), .b(x20), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n138_), .c(new_n137_), .d(new_n136_), .O(new_n141_));
  ...
  nand4  g111(.a(new_n139_), .b(x19), .c(new_n68_), .d(new_n36_), .O(new_n145_));
  ...
  oai21  g115(.a(x16), .b(new_n67_), .c(new_n66_), .O(new_n149_));
  nor2   g116(.a(new_n72_), .b(x06), .O(new_n150_));
  inv1   g117(.a(new_n150_), .O(new_n151_));
  oai21  g118(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n72_), .c(new_n69_), .O(new_n153_));
  inv1   g120(.a(new_n153_), .O(new_n154_));
  aoi21  g121(.a(new_n151_), .b(new_n149_), .c(new_n154_), .O(new_n155_));
  oai21  g122(.a(new_n69_), .b(x09), .c(x08), .O(new_n156_));
  oai21  g123(.a(new_n73_), .b(x04), .c(x17), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(x22), .c(x16), .d(x06), .O(new_n158_));
  inv1   g125(.a(new_n158_), .O(new_n159_));
  aoi21  g126(.a(new_n156_), .b(new_n151_), .c(new_n159_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n123_), .c(new_n155_), .d(new_n49_), .O(z4));
  inv1   g128(.a(new_n41_), .O(new_n162_));
  and2   g129(.a(new_n45_), .b(new_n42_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n151_), .c(new_n47_), .d(new_n162_), .O(z5));
  nand2  g131(.a(x20), .b(new_n68_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n35_), .c(x11), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(x03), .c(new_n48_), .d(new_n41_), .O(new_n167_));
  oai21  g134(.a(x20), .b(new_n68_), .c(x06), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(x11), .c(x03), .O(new_n169_));
  oai21  g136(.a(new_n150_), .b(x03), .c(new_n169_), .O(new_n170_));
  oai21  g137(.a(new_n122_), .b(new_n118_), .c(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n167_), .c(new_n151_), .O(z6));
  nor2   g139(.a(new_n150_), .b(new_n123_), .O(z7));
endmodule
