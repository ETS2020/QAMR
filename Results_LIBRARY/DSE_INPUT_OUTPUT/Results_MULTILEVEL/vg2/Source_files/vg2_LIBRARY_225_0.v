...
module FAU ( 
  ...
  nand3  g041(.a(new_n74_), .b(new_n56_), .c(new_n54_), .O(new_n75_));
  ...
  nand3  g051(.a(new_n84_), .b(new_n44_), .c(new_n38_), .O(new_n85_));
  ...
  nand3  g056(.a(new_n89_), .b(new_n84_), .c(x10), .O(new_n90_));
  nand2  g057(.a(new_n90_), .b(new_n87_), .O(z1));
  inv1   g058(.a(x01), .O(new_n92_));
  inv1   g059(.a(x14), .O(new_n93_));
  nand2  g060(.a(x24), .b(x18), .O(new_n94_));
  nand3  g061(.a(new_n40_), .b(x15), .c(x13), .O(new_n95_));
  aoi21  g062(.a(new_n95_), .b(new_n94_), .c(new_n38_), .O(new_n96_));
  nand3  g063(.a(x24), .b(x18), .c(x13), .O(new_n97_));
  nand3  g064(.a(x15), .b(new_n44_), .c(new_n38_), .O(new_n98_));
  nand2  g065(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g066(.a(new_n99_), .b(new_n96_), .c(x20), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n93_), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(x11), .c(x06), .d(x03), .O(new_n102_));
  oai21  g069(.a(new_n102_), .b(new_n92_), .c(new_n51_), .O(z2));
  nand4  g070(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n104_));
  nand4  g071(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n105_));
  nand3  g072(.a(new_n77_), .b(new_n34_), .c(new_n92_), .O(new_n106_));
  nand3  g073(.a(new_n82_), .b(new_n93_), .c(new_n36_), .O(new_n107_));
  oai22  g074(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(new_n104_), .O(new_n108_));
  nand2  g075(.a(new_n108_), .b(new_n89_), .O(new_n109_));
  nand4  g076(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n110_));
  nand4  g077(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n92_), .O(new_n111_));
  inv1   g078(.a(x08), .O(new_n112_));
  nand4  g079(.a(new_n37_), .b(new_n93_), .c(new_n36_), .d(new_n112_), .O(new_n113_));
  oai22  g080(.a(new_n113_), .b(new_n111_), .c(new_n110_), .d(new_n104_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(new_n70_), .c(x24), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n109_), .c(new_n51_), .O(z3));
  nand4  g083(.a(new_n40_), .b(x19), .c(x13), .d(x10), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n39_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(x05), .O(new_n119_));
  nand4  g086(.a(new_n51_), .b(x19), .c(new_n44_), .d(new_n38_), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(new_n119_), .c(new_n43_), .O(new_n121_));
  ...
  oai21  g093(.a(new_n126_), .b(x16), .c(new_n112_), .O(new_n127_));
  ...
  aoi21  g098(.a(new_n131_), .b(x22), .c(new_n76_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n129_), .c(x08), .O(new_n133_));
  nand4  g100(.a(new_n40_), .b(x15), .c(x13), .d(x10), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n94_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(x05), .O(new_n136_));
  nand4  g103(.a(new_n51_), .b(x15), .c(new_n44_), .d(new_n38_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n136_), .c(new_n97_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n133_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n128_), .O(z4));
  inv1   g107(.a(new_n42_), .O(new_n141_));
  nand4  g108(.a(new_n51_), .b(new_n45_), .c(new_n43_), .d(new_n141_), .O(z5));
  aoi21  g109(.a(x20), .b(new_n93_), .c(x06), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x11), .c(new_n34_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n121_), .O(new_n145_));
  aoi21  g112(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n36_), .c(x03), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n138_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n145_), .O(z6));
  inv1   g116(.a(new_n96_), .O(new_n150_));
  nand4  g117(.a(new_n98_), .b(new_n97_), .c(new_n150_), .d(new_n51_), .O(z7));
endmodule
