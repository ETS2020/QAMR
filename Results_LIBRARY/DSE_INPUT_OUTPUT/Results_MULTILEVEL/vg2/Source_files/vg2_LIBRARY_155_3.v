...
module FAU ( 
  ...
  nor2   g033(.a(new_n55_), .b(new_n36_), .O(new_n67_));
  ...
  nand2  g046(.a(new_n79_), .b(x20), .O(new_n80_));
  nor2   g047(.a(new_n80_), .b(new_n70_), .O(new_n81_));
  nand4  g048(.a(new_n81_), .b(x06), .c(x03), .d(x01), .O(new_n82_));
  aoi21  g049(.a(new_n82_), .b(new_n55_), .c(new_n36_), .O(z2));
  ...
  nand4  g054(.a(new_n87_), .b(x14), .c(new_n55_), .d(x11), .O(new_n88_));
  ...
  nand4  g060(.a(new_n93_), .b(new_n58_), .c(new_n70_), .d(new_n36_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n84_), .c(new_n35_), .d(new_n34_), .O(new_n96_));
  oai21  g063(.a(new_n96_), .b(x01), .c(new_n90_), .O(new_n97_));
  ...
  nand4  g072(.a(new_n58_), .b(new_n70_), .c(new_n36_), .d(new_n84_), .O(new_n106_));
  ...
  nand4  g079(.a(new_n58_), .b(x19), .c(new_n70_), .d(new_n36_), .O(new_n113_));
  ...
  oai21  g087(.a(x23), .b(new_n53_), .c(new_n57_), .O(new_n121_));
  ...
  oai21  g091(.a(new_n59_), .b(x04), .c(x17), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(x22), .c(new_n54_), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n56_), .c(x08), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n79_), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(new_n124_), .c(new_n67_), .O(z4));
  inv1   g096(.a(new_n41_), .O(new_n130_));
  and2   g097(.a(new_n45_), .b(new_n42_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n68_), .c(new_n47_), .d(new_n130_), .O(z5));
  nand2  g099(.a(x20), .b(new_n70_), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(new_n35_), .c(x11), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(x03), .c(new_n119_), .O(new_n135_));
  nand2  g102(.a(new_n58_), .b(x14), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(x06), .c(new_n36_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n34_), .c(new_n79_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n135_), .c(new_n68_), .O(z6));
  nand4  g106(.a(new_n78_), .b(new_n75_), .c(new_n74_), .d(new_n68_), .O(z7));
endmodule
