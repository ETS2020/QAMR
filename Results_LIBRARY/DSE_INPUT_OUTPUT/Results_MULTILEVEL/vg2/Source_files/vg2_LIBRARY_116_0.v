...
module FAU ( 
  ...
  nand2  g040(.a(new_n43_), .b(new_n37_), .O(new_n74_));
  ...
  nand3  g065(.a(new_n39_), .b(x23), .c(x22), .O(new_n99_));
  ...
  nand3  g074(.a(x15), .b(new_n43_), .c(new_n37_), .O(new_n108_));
  nor2   g075(.a(x24), .b(new_n98_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n94_), .c(new_n91_), .O(new_n110_));
  ...
  nor2   g081(.a(new_n114_), .b(new_n61_), .O(z2));
  nor2   g082(.a(new_n34_), .b(new_n61_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n94_), .c(x08), .d(x06), .O(new_n117_));
  nor2   g084(.a(new_n103_), .b(new_n36_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(new_n109_), .c(x20), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n117_), .c(x01), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n91_), .O(new_n121_));
  nand2  g088(.a(new_n116_), .b(new_n53_), .O(new_n122_));
  nand3  g089(.a(new_n118_), .b(x20), .c(x15), .O(new_n123_));
  nand3  g090(.a(new_n65_), .b(new_n34_), .c(new_n61_), .O(new_n124_));
  nand3  g091(.a(new_n70_), .b(new_n103_), .c(new_n36_), .O(new_n125_));
  ...
  nand4  g095(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n61_), .O(new_n129_));
  nand4  g096(.a(new_n97_), .b(new_n103_), .c(new_n36_), .d(new_n52_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n122_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n74_), .c(x24), .O(new_n132_));
  ...
  nand3  g104(.a(new_n137_), .b(new_n134_), .c(new_n52_), .O(new_n138_));
  oai21  g105(.a(new_n52_), .b(new_n61_), .c(new_n138_), .O(new_n139_));
  nor2   g106(.a(x24), .b(x10), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n91_), .c(x00), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n44_), .c(new_n42_), .O(new_n142_));
  or2    g109(.a(new_n142_), .b(new_n41_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n139_), .O(new_n144_));
  oai21  g111(.a(new_n135_), .b(x04), .c(x17), .O(new_n145_));
  ...
  nand3  g117(.a(new_n150_), .b(new_n74_), .c(x24), .O(new_n151_));
  ...
  nand4  g122(.a(new_n147_), .b(new_n39_), .c(x21), .d(new_n94_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(x01), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n91_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n155_), .c(new_n151_), .d(new_n144_), .O(z4));
  nor2   g126(.a(x02), .b(x01), .O(new_n160_));
  nand4  g127(.a(new_n140_), .b(new_n91_), .c(x01), .d(x00), .O(new_n161_));
  oai21  g128(.a(new_n160_), .b(new_n46_), .c(new_n161_), .O(z5));
  inv1   g129(.a(new_n160_), .O(new_n163_));
  nand2  g130(.a(x20), .b(new_n103_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n35_), .c(x11), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x03), .c(new_n143_), .O(new_n166_));
  nand2  g133(.a(new_n97_), .b(x14), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x06), .c(new_n36_), .O(new_n168_));
  oai22  g135(.a(new_n168_), .b(new_n34_), .c(new_n111_), .d(new_n106_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n166_), .c(new_n163_), .O(z6));
  aoi21  g137(.a(new_n109_), .b(new_n94_), .c(new_n61_), .O(new_n171_));
  nand2  g138(.a(new_n108_), .b(new_n107_), .O(new_n172_));
  nor2   g139(.a(new_n172_), .b(new_n106_), .O(new_n173_));
  oai21  g140(.a(new_n171_), .b(x02), .c(new_n173_), .O(z7));
endmodule
