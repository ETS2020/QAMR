...
module FAU ( 
  ...
  nand3  g068(.a(new_n42_), .b(x23), .c(x22), .O(new_n102_));
  ...
  nand4  g072(.a(new_n50_), .b(x06), .c(x03), .d(x01), .O(new_n106_));
  nor2   g073(.a(new_n36_), .b(new_n35_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n42_), .c(x21), .d(x20), .O(new_n108_));
  oai21  g075(.a(new_n108_), .b(new_n106_), .c(x22), .O(new_n109_));
  ...
  nand3  g082(.a(x15), .b(new_n46_), .c(new_n40_), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  aoi21  g084(.a(new_n114_), .b(x05), .c(new_n117_), .O(new_n118_));
  nor3   g085(.a(new_n118_), .b(new_n111_), .c(new_n36_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x11), .c(x06), .d(x03), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(new_n67_), .c(new_n110_), .O(z2));
  nand3  g088(.a(new_n59_), .b(x03), .c(x01), .O(new_n122_));
  nand3  g089(.a(new_n107_), .b(x20), .c(x15), .O(new_n123_));
  nand3  g090(.a(new_n72_), .b(new_n68_), .c(new_n67_), .O(new_n124_));
  nand3  g091(.a(new_n77_), .b(new_n36_), .c(new_n35_), .O(new_n125_));
  oai22  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n83_), .O(new_n127_));
  nand3  g094(.a(new_n107_), .b(x20), .c(x18), .O(new_n128_));
  nand4  g095(.a(x07), .b(new_n34_), .c(new_n68_), .d(new_n67_), .O(new_n129_));
  nand4  g096(.a(new_n111_), .b(new_n36_), .c(new_n35_), .d(new_n58_), .O(new_n130_));
  ...
  nand4  g099(.a(new_n34_), .b(new_n68_), .c(new_n67_), .d(x00), .O(new_n133_));
  nand3  g100(.a(new_n107_), .b(x21), .c(x20), .O(new_n134_));
  ...
  nand2  g106(.a(new_n52_), .b(new_n49_), .O(new_n140_));
  oai21  g107(.a(x16), .b(new_n66_), .c(new_n58_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g109(.a(x23), .b(new_n69_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(x17), .c(x09), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(x08), .O(new_n146_));
  nand2  g113(.a(new_n114_), .b(x05), .O(new_n147_));
  nor2   g114(.a(x10), .b(x02), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n42_), .c(x21), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n116_), .c(new_n115_), .d(new_n147_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n146_), .c(x22), .O(new_n151_));
  inv1   g118(.a(x16), .O(new_n152_));
  or2    g119(.a(new_n48_), .b(new_n44_), .O(new_n153_));
  inv1   g120(.a(x17), .O(new_n154_));
  oai21  g121(.a(x23), .b(new_n69_), .c(new_n154_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n153_), .c(new_n38_), .d(new_n152_), .O(new_n156_));
  aoi21  g123(.a(x16), .b(new_n66_), .c(new_n58_), .O(new_n157_));
  ...
  nand3  g127(.a(new_n160_), .b(new_n151_), .c(new_n142_), .O(z4));
  nand3  g128(.a(new_n42_), .b(new_n50_), .c(x00), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x22), .c(x02), .O(new_n163_));
  or2    g130(.a(new_n163_), .b(new_n153_), .O(z5));
  aoi21  g131(.a(x20), .b(new_n36_), .c(x06), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x11), .c(new_n68_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n140_), .O(new_n167_));
  aoi21  g134(.a(new_n111_), .b(x14), .c(new_n34_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n35_), .c(x03), .O(new_n169_));
  inv1   g136(.a(new_n39_), .O(new_n170_));
  nand3  g137(.a(new_n148_), .b(new_n51_), .c(x21), .O(new_n171_));
  oai21  g138(.a(new_n118_), .b(new_n170_), .c(new_n171_), .O(z7));
