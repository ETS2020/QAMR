...
module FAU ( 
  ...
  nand4  g040(.a(new_n73_), .b(new_n53_), .c(new_n65_), .d(new_n64_), .O(new_n74_));
  nor2   g041(.a(new_n74_), .b(x08), .O(new_n75_));
  nand4  g042(.a(new_n75_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n76_));
  ...
  nor2   g046(.a(new_n35_), .b(new_n34_), .O(new_n80_));
  ...
  nand4  g055(.a(new_n88_), .b(new_n87_), .c(x07), .d(new_n36_), .O(new_n89_));
  ...
  nand4  g063(.a(new_n82_), .b(new_n37_), .c(x03), .d(x01), .O(new_n97_));
  ...
  nand2  g069(.a(new_n102_), .b(x04), .O(new_n103_));
  nor2   g070(.a(x03), .b(x01), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n37_), .c(new_n35_), .O(new_n105_));
  inv1   g072(.a(x08), .O(new_n106_));
  nand4  g073(.a(new_n65_), .b(new_n64_), .c(new_n106_), .d(new_n36_), .O(new_n107_));
  nor2   g074(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  nor2   g075(.a(x13), .b(x12), .O(new_n109_));
  nand2  g076(.a(x19), .b(new_n66_), .O(new_n110_));
  nand2  g077(.a(new_n93_), .b(new_n67_), .O(new_n111_));
  nor2   g078(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n109_), .c(new_n108_), .d(new_n91_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n103_), .c(new_n96_), .O(new_n114_));
  inv1   g081(.a(new_n114_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n78_), .O(z1));
  ...
  nor3   g092(.a(new_n125_), .b(new_n67_), .c(new_n54_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x11), .c(x06), .d(x03), .O(new_n127_));
  nand2  g094(.a(new_n67_), .b(x04), .O(new_n128_));
  oai21  g095(.a(new_n127_), .b(new_n117_), .c(new_n128_), .O(z2));
  nand2  g096(.a(new_n57_), .b(new_n56_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(x20), .c(x14), .d(x11), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(new_n106_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x06), .c(x03), .d(x01), .O(new_n133_));
  nand2  g100(.a(new_n70_), .b(new_n69_), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n67_), .c(new_n54_), .d(new_n65_), .O(new_n135_));
  nor2   g102(.a(new_n135_), .b(x08), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n36_), .c(new_n34_), .d(new_n117_), .O(new_n137_));
  ...
  nand3  g108(.a(new_n104_), .b(x07), .c(new_n36_), .O(new_n142_));
  nand4  g109(.a(new_n67_), .b(new_n54_), .c(new_n65_), .d(new_n106_), .O(new_n143_));
  ...
  nand3  g113(.a(new_n104_), .b(new_n106_), .c(new_n36_), .O(new_n147_));
  nand4  g114(.a(new_n67_), .b(x19), .c(new_n54_), .d(new_n65_), .O(new_n148_));
  ...
  nand4  g117(.a(new_n150_), .b(new_n145_), .c(new_n139_), .d(new_n128_), .O(z3));
  inv1   g118(.a(new_n49_), .O(new_n152_));
  oai21  g119(.a(x23), .b(new_n35_), .c(new_n66_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n68_), .c(x09), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x16), .c(new_n106_), .O(new_n155_));
  ...
  aoi21  g125(.a(new_n158_), .b(x22), .c(new_n64_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n83_), .c(x08), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n156_), .c(new_n128_), .O(z4));
  inv1   g129(.a(new_n41_), .O(new_n163_));
  and2   g130(.a(new_n45_), .b(new_n42_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n128_), .c(new_n47_), .d(new_n163_), .O(z5));
  nand2  g132(.a(x20), .b(new_n54_), .O(new_n166_));
  ...
  aoi21  g136(.a(new_n169_), .b(x06), .c(new_n65_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n34_), .c(new_n157_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n168_), .c(new_n128_), .O(z6));
  inv1   g139(.a(new_n120_), .O(new_n173_));
  and2   g140(.a(new_n122_), .b(new_n121_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n128_), .c(new_n123_), .d(new_n173_), .O(z7));
endmodule
