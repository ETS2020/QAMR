...
module FAU ( 
  ...
  nor2   g053(.a(new_n70_), .b(new_n86_), .O(new_n87_));
  nor2   g054(.a(new_n56_), .b(new_n34_), .O(new_n88_));
  ...
  nand2  g075(.a(x22), .b(new_n108_), .O(new_n109_));
  ...
  nor3   g088(.a(new_n121_), .b(new_n70_), .c(new_n108_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x11), .c(x06), .d(x03), .O(new_n123_));
  oai21  g090(.a(new_n123_), .b(new_n35_), .c(new_n109_), .O(z2));
  ...
  nand4  g096(.a(new_n129_), .b(new_n34_), .c(new_n70_), .d(new_n108_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(x11), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n66_), .c(new_n37_), .d(new_n36_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(x01), .c(new_n128_), .O(new_n133_));
  ...
  nor2   g104(.a(x22), .b(x20), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n108_), .c(new_n68_), .d(new_n66_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n137_), .c(new_n136_), .d(new_n135_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n81_), .c(x24), .O(new_n141_));
  nand4  g108(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n142_));
  nand3  g109(.a(new_n102_), .b(new_n36_), .c(new_n35_), .O(new_n143_));
  nand4  g110(.a(new_n138_), .b(x19), .c(new_n108_), .d(new_n68_), .O(new_n144_));
  ...
  oai21  g114(.a(x16), .b(new_n67_), .c(new_n66_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n109_), .O(new_n149_));
  oai21  g116(.a(x23), .b(new_n65_), .c(new_n69_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n34_), .c(new_n55_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n149_), .c(new_n50_), .O(new_n152_));
  oai21  g119(.a(new_n55_), .b(x09), .c(x08), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n109_), .O(new_n154_));
  oai21  g121(.a(new_n56_), .b(x04), .c(x17), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(x22), .c(x16), .d(x14), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n154_), .c(new_n121_), .O(new_n157_));
  or2    g124(.a(new_n157_), .b(new_n152_), .O(z4));
  inv1   g125(.a(new_n42_), .O(new_n159_));
  and2   g126(.a(new_n46_), .b(new_n43_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n109_), .c(new_n48_), .d(new_n159_), .O(z5));
  nand2  g128(.a(x20), .b(new_n108_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n37_), .c(x11), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n164_));
  nand2  g131(.a(new_n70_), .b(x14), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x06), .c(new_n68_), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n36_), .c(new_n120_), .d(new_n116_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n164_), .c(new_n109_), .O(z6));
  inv1   g135(.a(new_n116_), .O(new_n169_));
  and2   g136(.a(new_n118_), .b(new_n117_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n119_), .c(new_n169_), .d(new_n109_), .O(z7));
endmodule
