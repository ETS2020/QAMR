...
module FAU ( 
  ...
  nand4  g034(.a(new_n67_), .b(new_n62_), .c(new_n61_), .d(new_n59_), .O(new_n68_));
  inv1   g035(.a(x09), .O(new_n69_));
  nand4  g036(.a(new_n57_), .b(new_n56_), .c(new_n49_), .d(new_n55_), .O(new_n70_));
  inv1   g037(.a(new_n70_), .O(new_n71_));
  nor2   g038(.a(x08), .b(x06), .O(new_n72_));
  nand4  g039(.a(new_n72_), .b(new_n71_), .c(new_n35_), .d(new_n69_), .O(new_n73_));
  ...
  oai21  g046(.a(new_n79_), .b(new_n73_), .c(new_n68_), .O(new_n80_));
  ...
  nand3  g052(.a(new_n61_), .b(x17), .c(x16), .O(new_n86_));
  inv1   g053(.a(new_n86_), .O(new_n87_));
  and2   g054(.a(x20), .b(x18), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n87_), .c(new_n65_), .d(new_n59_), .O(new_n89_));
  nor2   g056(.a(x09), .b(x08), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n71_), .c(x07), .d(new_n34_), .O(new_n91_));
  inv1   g058(.a(x20), .O(new_n92_));
  inv1   g059(.a(x16), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n36_), .c(new_n60_), .d(new_n35_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n78_), .c(new_n92_), .d(new_n37_), .O(new_n96_));
  ...
  nor2   g066(.a(new_n99_), .b(new_n92_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n87_), .c(new_n65_), .d(new_n59_), .O(new_n101_));
  ...
  oai21  g084(.a(new_n117_), .b(new_n55_), .c(new_n38_), .O(z2));
  ...
  nand4  g095(.a(new_n128_), .b(new_n92_), .c(new_n36_), .d(new_n35_), .O(new_n129_));
  ...
  nand4  g103(.a(new_n92_), .b(new_n36_), .c(new_n35_), .d(new_n119_), .O(new_n137_));
  ...
  aoi21  g114(.a(new_n78_), .b(x04), .c(x09), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x16), .c(new_n119_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  oai21  g117(.a(new_n99_), .b(x10), .c(new_n120_), .O(new_n151_));
  oai21  g118(.a(new_n64_), .b(x04), .c(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n69_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n93_), .c(x08), .O(new_n154_));
  nand2  g121(.a(new_n81_), .b(new_n57_), .O(new_n155_));
  nand2  g122(.a(new_n65_), .b(new_n62_), .O(new_n156_));
  nand3  g123(.a(new_n63_), .b(x17), .c(new_n93_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n146_), .c(new_n156_), .d(new_n155_), .O(new_n158_));
  aoi21  g125(.a(new_n154_), .b(new_n151_), .c(new_n158_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n150_), .c(x24), .O(new_n160_));
  aoi21  g127(.a(x22), .b(new_n37_), .c(new_n69_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n93_), .c(x08), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x18), .O(new_n163_));
  nand2  g130(.a(new_n149_), .b(x07), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n82_), .c(x24), .O(new_n166_));
  nand2  g133(.a(new_n162_), .b(x15), .O(new_n167_));
  nand2  g134(.a(new_n149_), .b(x19), .O(new_n168_));
  ...
  oai21  g138(.a(new_n171_), .b(new_n160_), .c(new_n49_), .O(new_n172_));
  inv1   g139(.a(new_n110_), .O(new_n173_));
  and2   g140(.a(new_n112_), .b(new_n111_), .O(new_n174_));
  nor3   g141(.a(new_n64_), .b(new_n63_), .c(x04), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n69_), .c(x16), .O(new_n176_));
  aoi22  g143(.a(new_n176_), .b(x08), .c(new_n174_), .d(new_n173_), .O(new_n177_));
  nor2   g144(.a(new_n47_), .b(new_n43_), .O(new_n178_));
  nand2  g145(.a(x22), .b(new_n69_), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n93_), .c(x08), .O(new_n180_));
  nor2   g147(.a(new_n180_), .b(new_n178_), .O(new_n181_));
  oai21  g148(.a(new_n181_), .b(new_n177_), .c(x17), .O(new_n182_));
  nand2  g149(.a(new_n182_), .b(new_n172_), .O(z4));
  nand2  g150(.a(new_n51_), .b(new_n48_), .O(z5));
  ...
  nand2  g155(.a(new_n92_), .b(x14), .O(new_n189_));
  aoi21  g156(.a(new_n189_), .b(x06), .c(new_n35_), .O(new_n190_));
  oai22  g157(.a(new_n190_), .b(new_n56_), .c(new_n114_), .d(new_n110_), .O(new_n191_));
  nand3  g158(.a(new_n191_), .b(new_n188_), .c(new_n38_), .O(z6));
  nand4  g159(.a(new_n174_), .b(new_n113_), .c(new_n173_), .d(new_n38_), .O(z7));
endmodule
