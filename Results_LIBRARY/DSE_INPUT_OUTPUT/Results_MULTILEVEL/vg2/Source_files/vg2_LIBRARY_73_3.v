...
module FAU ( 
  ...
  nand4  g075(.a(new_n40_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n109_));
  ...
  oai21  g080(.a(new_n113_), .b(new_n103_), .c(new_n37_), .O(z2));
  ...
  nand3  g084(.a(new_n97_), .b(new_n66_), .c(new_n34_), .O(new_n118_));
  nand4  g085(.a(new_n74_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n119_));
  ...
  nand3  g089(.a(new_n97_), .b(x07), .c(new_n34_), .O(new_n123_));
  nand4  g090(.a(new_n74_), .b(new_n36_), .c(new_n35_), .d(new_n66_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n115_), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n80_), .c(x24), .O(new_n126_));
  inv1   g093(.a(x03), .O(new_n127_));
  nand4  g094(.a(new_n34_), .b(new_n127_), .c(new_n103_), .d(x00), .O(new_n128_));
  nand3  g095(.a(new_n116_), .b(x21), .c(x20), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n115_), .c(new_n128_), .d(new_n124_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n40_), .c(new_n49_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n126_), .c(new_n121_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n48_), .O(new_n133_));
  nand2  g100(.a(new_n126_), .b(new_n121_), .O(new_n134_));
  ...
  nand3  g114(.a(new_n147_), .b(new_n143_), .c(new_n37_), .O(z4));
  and2   g115(.a(new_n45_), .b(new_n37_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n50_), .c(new_n43_), .d(new_n141_), .O(z5));
  nand2  g117(.a(new_n50_), .b(new_n47_), .O(new_n151_));
  aoi21  g118(.a(x20), .b(new_n36_), .c(x06), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x11), .c(new_n127_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  aoi21  g121(.a(new_n74_), .b(x14), .c(new_n34_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n35_), .c(x03), .O(new_n156_));
  nand2  g123(.a(new_n108_), .b(new_n107_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n106_), .c(new_n37_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n109_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n154_), .O(z6));
  inv1   g128(.a(new_n106_), .O(new_n162_));
  and2   g129(.a(new_n109_), .b(new_n108_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n107_), .c(new_n162_), .d(new_n37_), .O(z7));
endmodule
