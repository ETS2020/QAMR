...
module FAU ( 
  ...
  nand2  g144(.a(x20), .b(new_n74_), .O(new_n178_));
  aoi21  g145(.a(new_n178_), .b(new_n35_), .c(x11), .O(new_n179_));
  oai22  g146(.a(new_n179_), .b(x03), .c(new_n50_), .d(new_n42_), .O(new_n180_));
  nand2  g147(.a(new_n37_), .b(x14), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(x06), .c(new_n36_), .O(new_n182_));
  inv1   g149(.a(new_n112_), .O(new_n183_));
  and2   g150(.a(new_n157_), .b(new_n114_), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n113_), .c(new_n183_), .O(new_n185_));
  oai21  g152(.a(new_n182_), .b(new_n34_), .c(new_n185_), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(new_n180_), .c(new_n140_), .O(z6));
  nand4  g154(.a(new_n184_), .b(new_n140_), .c(new_n113_), .d(new_n183_), .O(z7));
endmodule
