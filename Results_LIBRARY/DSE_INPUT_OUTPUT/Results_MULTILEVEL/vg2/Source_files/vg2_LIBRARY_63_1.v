...
module FAU ( 
  ...
  nand2  g101(.a(new_n41_), .b(x21), .O(new_n135_));
  nand2  g102(.a(new_n117_), .b(new_n45_), .O(new_n136_));
  nor3   g103(.a(new_n136_), .b(new_n135_), .c(new_n38_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n133_), .c(new_n128_), .d(new_n122_), .O(z3));
  ...
  nand2  g109(.a(x02), .b(new_n67_), .O(new_n143_));
  nand2  g110(.a(new_n48_), .b(new_n44_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n43_), .c(new_n143_), .O(new_n145_));
  ...
  oai21  g120(.a(new_n153_), .b(new_n107_), .c(new_n143_), .O(new_n154_));
  ...
  nand2  g130(.a(new_n143_), .b(new_n35_), .O(new_n164_));
  ...
  inv1   g142(.a(new_n143_), .O(new_n176_));
  oai21  g143(.a(new_n135_), .b(x10), .c(new_n109_), .O(new_n177_));
