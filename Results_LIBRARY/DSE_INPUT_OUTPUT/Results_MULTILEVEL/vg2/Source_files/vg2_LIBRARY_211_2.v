...
module FAU ( 
  ...
  nand3  g090(.a(new_n72_), .b(new_n87_), .c(new_n36_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n121_), .d(new_n120_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n78_), .O(new_n126_));
  nand3  g093(.a(new_n82_), .b(x14), .c(x11), .O(new_n127_));
  nand3  g094(.a(new_n122_), .b(x07), .c(new_n35_), .O(new_n128_));
  nand4  g095(.a(new_n37_), .b(new_n87_), .c(new_n36_), .d(new_n97_), .O(new_n129_));
  ...
  nand3  g098(.a(new_n131_), .b(new_n126_), .c(new_n119_), .O(z3));
  inv1   g099(.a(x04), .O(new_n133_));
  oai21  g100(.a(x23), .b(new_n133_), .c(new_n59_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n61_), .c(x09), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x16), .c(new_n97_), .O(new_n136_));
  nor2   g103(.a(x02), .b(new_n94_), .O(new_n137_));
  nand2  g104(.a(new_n48_), .b(new_n43_), .O(new_n138_));
  nor2   g105(.a(new_n138_), .b(new_n42_), .O(new_n139_));
  nand4  g106(.a(new_n45_), .b(new_n44_), .c(new_n94_), .d(x00), .O(new_n140_));
  oai21  g107(.a(new_n139_), .b(new_n137_), .c(new_n140_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n136_), .O(new_n142_));
  oai21  g109(.a(new_n62_), .b(x04), .c(x17), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(x22), .c(new_n65_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n88_), .c(x08), .O(new_n145_));
  nor2   g112(.a(new_n110_), .b(new_n107_), .O(new_n146_));
  ...
  oai21  g119(.a(new_n152_), .b(x02), .c(new_n139_), .O(z5));
  ...
  oai21  g123(.a(x20), .b(new_n87_), .c(x06), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(x11), .c(x03), .O(new_n158_));
  inv1   g125(.a(new_n158_), .O(new_n159_));
  nand4  g126(.a(new_n40_), .b(x21), .c(new_n98_), .d(new_n44_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n109_), .c(new_n108_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n107_), .c(new_n159_), .d(new_n122_), .O(new_n162_));
  nor2   g129(.a(new_n146_), .b(x03), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x02), .c(new_n137_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n162_), .c(new_n156_), .O(z6));
endmodule
