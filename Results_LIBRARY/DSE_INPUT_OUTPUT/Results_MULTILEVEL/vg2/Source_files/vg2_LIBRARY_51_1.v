...
module FAU ( 
  ...
  nand4  g056(.a(new_n89_), .b(new_n35_), .c(new_n88_), .d(new_n34_), .O(new_n90_));
  inv1   g057(.a(new_n90_), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n74_), .c(new_n36_), .d(new_n60_), .O(new_n92_));
  ...
  nand3  g066(.a(new_n49_), .b(new_n66_), .c(new_n99_), .O(new_n100_));
  nor3   g067(.a(new_n100_), .b(x06), .c(x04), .O(new_n101_));
  nand3  g068(.a(new_n41_), .b(new_n63_), .c(new_n62_), .O(new_n102_));
  nor3   g069(.a(new_n102_), .b(x20), .c(x17), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n101_), .c(new_n98_), .d(new_n91_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n94_), .c(new_n80_), .O(z1));
  ...
  nand4  g079(.a(new_n112_), .b(new_n41_), .c(x21), .d(new_n88_), .O(new_n113_));
  aoi21  g080(.a(new_n113_), .b(new_n111_), .c(new_n36_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(x14), .c(x11), .d(x06), .O(new_n115_));
  nor3   g082(.a(new_n115_), .b(new_n96_), .c(new_n95_), .O(z2));
  ...
  nor2   g087(.a(new_n120_), .b(new_n99_), .O(new_n121_));
  ...
  nand4  g094(.a(new_n127_), .b(new_n85_), .c(new_n96_), .d(new_n95_), .O(new_n128_));
  ...
  nand4  g098(.a(x07), .b(new_n85_), .c(new_n96_), .d(new_n95_), .O(new_n132_));
  nand4  g099(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n99_), .O(new_n133_));
  ...
  nand3  g103(.a(new_n68_), .b(new_n96_), .c(new_n95_), .O(new_n137_));
  nand3  g104(.a(new_n73_), .b(new_n35_), .c(new_n34_), .O(new_n138_));
  ...
  oai21  g108(.a(new_n141_), .b(new_n129_), .c(new_n88_), .O(new_n142_));
  nand2  g109(.a(new_n139_), .b(new_n79_), .O(new_n143_));
  ...
  oai21  g116(.a(new_n149_), .b(x16), .c(new_n99_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(z5), .O(new_n151_));
  nand2  g118(.a(new_n113_), .b(new_n111_), .O(new_n152_));
  ...
  aoi21  g124(.a(x20), .b(new_n35_), .c(x06), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x11), .c(new_n96_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(z5), .O(new_n160_));
  aoi21  g127(.a(new_n36_), .b(x14), .c(new_n85_), .O(new_n161_));
  ...
  nor2   g131(.a(new_n110_), .b(new_n108_), .O(new_n165_));
  nand3  g132(.a(new_n41_), .b(x21), .c(new_n49_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n88_), .O(new_n167_));
