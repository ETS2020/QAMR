...
module FAU ( 
  ...
  nor4   g023(.a(new_n56_), .b(new_n55_), .c(new_n37_), .d(new_n54_), .O(new_n57_));
  ...
  nand4  g033(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n67_));
  inv1   g034(.a(new_n67_), .O(new_n68_));
  nor2   g035(.a(x08), .b(x06), .O(new_n69_));
  nand4  g036(.a(new_n69_), .b(new_n68_), .c(new_n37_), .d(new_n54_), .O(new_n70_));
  ...
  nor2   g051(.a(new_n38_), .b(new_n84_), .O(new_n85_));
  nand4  g052(.a(new_n85_), .b(new_n83_), .c(new_n61_), .d(new_n57_), .O(new_n86_));
  ...
  nand3  g062(.a(new_n61_), .b(x21), .c(x20), .O(new_n96_));
  nor2   g063(.a(new_n96_), .b(new_n82_), .O(new_n97_));
  nand2  g064(.a(new_n97_), .b(new_n57_), .O(new_n98_));
  ...
  nand4  g069(.a(new_n102_), .b(new_n41_), .c(new_n95_), .d(new_n34_), .O(new_n103_));
  ...
  nand3  g077(.a(x15), .b(new_n77_), .c(new_n39_), .O(new_n111_));
  nand4  g078(.a(new_n41_), .b(x21), .c(new_n95_), .d(new_n34_), .O(new_n112_));
  ...
  nor2   g086(.a(new_n105_), .b(new_n37_), .O(new_n120_));
  nand3  g087(.a(new_n120_), .b(x20), .c(x15), .O(new_n121_));
  nand2  g088(.a(new_n99_), .b(new_n69_), .O(new_n122_));
  nand3  g089(.a(new_n73_), .b(new_n105_), .c(new_n37_), .O(new_n123_));
  ...
  nand3  g093(.a(new_n99_), .b(x07), .c(new_n36_), .O(new_n127_));
  inv1   g094(.a(x08), .O(new_n128_));
  nand4  g095(.a(new_n38_), .b(new_n105_), .c(new_n37_), .d(new_n128_), .O(new_n129_));
  ...
  nand3  g098(.a(new_n69_), .b(new_n35_), .c(x00), .O(new_n132_));
  nor2   g099(.a(x11), .b(x10), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n41_), .c(new_n38_), .d(new_n105_), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n132_), .c(new_n34_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n65_), .O(new_n136_));
  nor4   g103(.a(new_n56_), .b(new_n35_), .c(x02), .d(new_n65_), .O(new_n137_));
  nand3  g104(.a(new_n41_), .b(x21), .c(x20), .O(new_n138_));
  inv1   g105(.a(new_n138_), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n137_), .c(new_n120_), .d(new_n95_), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n136_), .c(new_n131_), .d(new_n125_), .O(z3));
  inv1   g108(.a(x07), .O(new_n142_));
  nand2  g109(.a(x02), .b(new_n65_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(x08), .O(new_n144_));
  inv1   g111(.a(x16), .O(new_n145_));
  aoi21  g112(.a(new_n60_), .b(x04), .c(x17), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x22), .c(new_n54_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n145_), .c(new_n128_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n144_), .c(new_n142_), .O(new_n149_));
  inv1   g116(.a(x17), .O(new_n150_));
  aoi21  g117(.a(x23), .b(new_n66_), .c(new_n150_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n59_), .c(x09), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x16), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x08), .c(new_n84_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n149_), .c(new_n78_), .O(new_n155_));
  nand4  g122(.a(new_n47_), .b(x08), .c(new_n39_), .d(x01), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(x24), .O(new_n158_));
  nand2  g125(.a(new_n80_), .b(x15), .O(new_n159_));
  aoi22  g126(.a(new_n159_), .b(new_n112_), .c(new_n153_), .d(x08), .O(new_n160_));
  nand2  g127(.a(x24), .b(x08), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n77_), .c(new_n39_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n79_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(x19), .O(new_n164_));
  nand3  g131(.a(new_n45_), .b(new_n34_), .c(x00), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n147_), .c(new_n145_), .O(new_n167_));
  nand2  g134(.a(x13), .b(x05), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n78_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n41_), .c(x19), .O(new_n170_));
  oai21  g137(.a(new_n48_), .b(x02), .c(new_n170_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(x08), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n167_), .c(new_n143_), .O(new_n173_));
  nor2   g140(.a(new_n173_), .b(new_n160_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n158_), .O(z4));
  nand3  g142(.a(x19), .b(new_n77_), .c(new_n39_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n44_), .O(new_n177_));
  oai21  g144(.a(new_n177_), .b(new_n43_), .c(new_n143_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n165_), .O(z5));
  nand2  g146(.a(x20), .b(new_n105_), .O(new_n180_));
  aoi21  g147(.a(new_n180_), .b(new_n36_), .c(x11), .O(new_n181_));
  nand3  g148(.a(new_n165_), .b(new_n176_), .c(new_n44_), .O(new_n182_));
  oai22  g149(.a(new_n182_), .b(new_n43_), .c(new_n181_), .d(x03), .O(new_n183_));
  nand2  g150(.a(new_n38_), .b(x14), .O(new_n184_));
  aoi21  g151(.a(new_n184_), .b(x06), .c(new_n37_), .O(new_n185_));
  oai21  g152(.a(new_n185_), .b(new_n35_), .c(new_n114_), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(new_n183_), .c(new_n143_), .O(z6));
  nand4  g154(.a(new_n143_), .b(new_n113_), .c(new_n110_), .d(new_n109_), .O(z7));
endmodule
