...
module FAU ( 
  ...
  nand4  g058(.a(new_n91_), .b(new_n72_), .c(new_n71_), .d(new_n90_), .O(new_n92_));
  inv1   g059(.a(x12), .O(new_n93_));
  nand4  g060(.a(new_n35_), .b(new_n40_), .c(new_n93_), .d(new_n47_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n79_), .c(new_n41_), .d(new_n65_), .O(new_n96_));
  oai21  g063(.a(new_n96_), .b(new_n92_), .c(new_n89_), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n82_), .c(x24), .O(new_n98_));
  nand4  g065(.a(new_n37_), .b(new_n34_), .c(new_n36_), .d(x00), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  inv1   g067(.a(x10), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n71_), .c(new_n90_), .O(new_n102_));
  ...
  aoi21  g083(.a(new_n116_), .b(new_n115_), .c(new_n52_), .O(new_n117_));
  nand3  g084(.a(x15), .b(new_n53_), .c(new_n52_), .O(new_n118_));
  oai21  g085(.a(new_n115_), .b(new_n53_), .c(new_n118_), .O(new_n119_));
  nor2   g086(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nor3   g087(.a(new_n120_), .b(new_n41_), .c(new_n40_), .O(new_n121_));
  ...
  nand2  g104(.a(new_n109_), .b(new_n88_), .O(new_n138_));
  nand3  g105(.a(new_n91_), .b(new_n37_), .c(new_n36_), .O(new_n139_));
  nand4  g106(.a(new_n41_), .b(new_n40_), .c(new_n47_), .d(new_n90_), .O(new_n140_));
  ...
  nand3  g110(.a(new_n73_), .b(new_n37_), .c(new_n36_), .O(new_n144_));
  nand3  g111(.a(new_n78_), .b(new_n40_), .c(new_n47_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n137_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n53_), .c(new_n52_), .O(new_n147_));
  ...
  aoi21  g120(.a(new_n68_), .b(x04), .c(x17), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x22), .c(new_n71_), .O(new_n155_));
  inv1   g122(.a(x00), .O(new_n156_));
  nor2   g123(.a(x02), .b(new_n156_), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n42_), .c(new_n101_), .d(new_n90_), .O(new_n158_));
  oai21  g125(.a(new_n56_), .b(x16), .c(new_n158_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n155_), .O(new_n160_));
  nand3  g127(.a(new_n35_), .b(x08), .c(x00), .O(new_n161_));
  oai21  g128(.a(new_n110_), .b(x08), .c(new_n161_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n101_), .c(new_n34_), .O(new_n163_));
  inv1   g130(.a(x15), .O(new_n164_));
  nand2  g131(.a(x16), .b(new_n34_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(x19), .c(x08), .O(new_n166_));
  inv1   g133(.a(x04), .O(new_n167_));
  aoi21  g134(.a(x23), .b(new_n167_), .c(new_n65_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n67_), .c(x09), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x16), .c(new_n90_), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(new_n164_), .c(new_n166_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(x13), .c(x05), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n163_), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n42_), .O(new_n174_));
  inv1   g141(.a(new_n165_), .O(new_n175_));
  aoi21  g142(.a(new_n53_), .b(new_n52_), .c(new_n42_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(x07), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(new_n54_), .c(new_n175_), .O(new_n178_));
  inv1   g145(.a(new_n118_), .O(new_n179_));
  aoi21  g146(.a(new_n176_), .b(x18), .c(new_n179_), .O(new_n180_));
  oai21  g147(.a(new_n180_), .b(new_n170_), .c(new_n165_), .O(new_n181_));
  aoi21  g148(.a(new_n178_), .b(x08), .c(new_n181_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n174_), .c(new_n160_), .O(z4));
  nand4  g150(.a(new_n157_), .b(new_n42_), .c(new_n35_), .d(new_n101_), .O(new_n184_));
  oai21  g151(.a(new_n175_), .b(new_n56_), .c(new_n184_), .O(z5));
  aoi21  g152(.a(x20), .b(new_n40_), .c(x06), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(x11), .c(new_n37_), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(z5), .O(new_n188_));
  aoi21  g155(.a(new_n41_), .b(x14), .c(new_n38_), .O(new_n189_));
  oai21  g156(.a(new_n189_), .b(new_n47_), .c(x03), .O(new_n190_));
  nand4  g157(.a(new_n111_), .b(new_n35_), .c(new_n101_), .d(new_n34_), .O(new_n191_));
  oai21  g158(.a(new_n175_), .b(new_n120_), .c(new_n191_), .O(new_n192_));
  nand2  g159(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  nand2  g160(.a(new_n193_), .b(new_n188_), .O(z6));
  aoi21  g161(.a(new_n111_), .b(new_n101_), .c(x16), .O(new_n195_));
  oai21  g162(.a(new_n195_), .b(x02), .c(new_n120_), .O(z7));
endmodule
