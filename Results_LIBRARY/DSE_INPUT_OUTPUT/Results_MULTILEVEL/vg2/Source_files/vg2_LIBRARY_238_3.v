...
module FAU ( 
  ...
  aoi21  g109(.a(new_n142_), .b(x22), .c(new_n68_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n74_), .c(x08), .O(new_n144_));
  inv1   g111(.a(new_n110_), .O(new_n145_));
  nand4  g112(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n146_));
  and2   g113(.a(new_n146_), .b(new_n112_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n111_), .c(new_n145_), .O(new_n148_));
  ...
  nand2  g127(.a(new_n112_), .b(new_n111_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n110_), .c(new_n53_), .O(new_n162_));
  ...
  nand4  g132(.a(new_n147_), .b(new_n111_), .c(new_n145_), .d(new_n53_), .O(z7));
endmodule
