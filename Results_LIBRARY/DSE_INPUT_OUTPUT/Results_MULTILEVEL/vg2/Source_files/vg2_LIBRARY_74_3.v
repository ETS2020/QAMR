...
module FAU ( 
  ...
  nand2  g123(.a(x02), .b(x01), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n156_), .c(new_n148_), .O(z4));
  and2   g125(.a(new_n157_), .b(new_n43_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n48_), .c(new_n46_), .d(new_n141_), .O(z5));
  ...
  oai21  g132(.a(new_n165_), .b(new_n34_), .c(new_n155_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n163_), .c(new_n157_), .O(z6));
  nand4  g134(.a(new_n157_), .b(new_n154_), .c(new_n112_), .d(new_n111_), .O(z7));
endmodule
