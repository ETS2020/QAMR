...
module FAU ( 
  ...
  nor2   g32(.a(x20), .b(x14), .O(new_n67_));
  inv1   g33(.a(x04), .O(new_n68_));
  inv1   g34(.a(x17), .O(new_n69_));
  oai21  g35(.a(x23), .b(new_n68_), .c(new_n69_), .O(new_n70_));
  aoi21  g36(.a(new_n70_), .b(new_n38_), .c(x09), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(x16), .c(new_n36_), .O(new_n72_));
  ...
  aoi21  g45(.a(new_n75_), .b(x05), .c(new_n79_), .O(new_n80_));
  ...
  aoi21  g55(.a(new_n89_), .b(new_n82_), .c(new_n67_), .O(z4));
  nor2   g56(.a(new_n80_), .b(new_n67_), .O(z5));
  ...
  oai21  g74(.a(new_n108_), .b(new_n101_), .c(new_n92_), .O(new_n109_));
  inv1   g75(.a(x11), .O(new_n110_));
  inv1   g76(.a(x06), .O(new_n111_));
  nand2  g77(.a(x20), .b(new_n37_), .O(new_n112_));
  oai21  g78(.a(new_n37_), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand3  g79(.a(new_n113_), .b(new_n81_), .c(new_n110_), .O(new_n114_));
  nand2  g80(.a(x20), .b(new_n111_), .O(new_n115_));
  oai21  g81(.a(x20), .b(new_n37_), .c(new_n115_), .O(new_n116_));
  nand3  g82(.a(new_n116_), .b(new_n60_), .c(x11), .O(new_n117_));
  nand3  g83(.a(new_n117_), .b(new_n114_), .c(new_n109_), .O(z6));
  nor2   g84(.a(new_n67_), .b(new_n59_), .O(z7));
  zero   g85(.O(z0));
endmodule
