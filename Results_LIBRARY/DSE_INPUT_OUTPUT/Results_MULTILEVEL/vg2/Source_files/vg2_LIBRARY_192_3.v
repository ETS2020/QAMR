...
module FAU ( 
  ...
  nand4  g060(.a(new_n93_), .b(new_n78_), .c(new_n60_), .d(new_n56_), .O(new_n94_));
  ...
  nand3  g065(.a(new_n98_), .b(new_n40_), .c(new_n91_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n90_), .c(new_n76_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n48_), .O(new_n101_));
  nand2  g068(.a(new_n90_), .b(new_n76_), .O(new_n102_));
  ...
  nand3  g078(.a(new_n40_), .b(x21), .c(new_n91_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n111_), .c(new_n110_), .d(new_n109_), .O(new_n113_));
  ...
  oai21  g083(.a(new_n116_), .b(new_n105_), .c(new_n37_), .O(z2));
  ...
  nand2  g087(.a(new_n95_), .b(new_n64_), .O(new_n121_));
  nand3  g088(.a(new_n69_), .b(new_n36_), .c(new_n35_), .O(new_n122_));
  oai22  g089(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n118_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n75_), .O(new_n124_));
  nand2  g091(.a(new_n119_), .b(new_n81_), .O(new_n125_));
  nand3  g092(.a(new_n95_), .b(x07), .c(new_n34_), .O(new_n126_));
  inv1   g093(.a(x08), .O(new_n127_));
  nor2   g094(.a(x20), .b(x14), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n35_), .c(new_n127_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n126_), .c(new_n125_), .d(new_n118_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n73_), .c(x24), .O(new_n131_));
  inv1   g098(.a(x03), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n48_), .c(new_n105_), .d(x00), .O(new_n133_));
  nand3  g100(.a(new_n128_), .b(new_n64_), .c(new_n35_), .O(new_n134_));
  nand2  g101(.a(new_n119_), .b(new_n93_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n118_), .c(new_n134_), .d(new_n133_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n40_), .c(new_n91_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n131_), .c(new_n124_), .d(new_n37_), .O(z3));
  inv1   g105(.a(x16), .O(new_n139_));
  inv1   g106(.a(x23), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(x04), .c(x17), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x22), .c(new_n62_), .O(new_n142_));
  oai21  g109(.a(new_n46_), .b(new_n42_), .c(new_n127_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n50_), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n142_), .c(new_n139_), .O(new_n145_));
  nand3  g112(.a(new_n37_), .b(x08), .c(x07), .O(new_n146_));
  oai21  g113(.a(new_n140_), .b(x04), .c(x17), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x22), .c(new_n62_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n139_), .c(x08), .O(new_n149_));
  ...
  nand3  g119(.a(new_n37_), .b(x19), .c(x08), .O(new_n153_));
  ...
  inv1   g123(.a(new_n37_), .O(new_n157_));
  nand2  g124(.a(new_n149_), .b(x21), .O(new_n158_));
  nand3  g125(.a(x08), .b(new_n48_), .c(x00), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n158_), .c(x24), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n91_), .c(new_n157_), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n156_), .c(new_n152_), .d(new_n145_), .O(z4));
  nand2  g129(.a(new_n50_), .b(new_n47_), .O(z5));
  nand2  g130(.a(x20), .b(new_n36_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n34_), .c(x11), .O(new_n165_));
  nand3  g132(.a(new_n50_), .b(new_n45_), .c(new_n43_), .O(new_n166_));
  oai22  g133(.a(new_n166_), .b(new_n42_), .c(new_n165_), .d(x03), .O(new_n167_));
  nand2  g134(.a(new_n80_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n35_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n132_), .c(new_n113_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n167_), .c(new_n37_), .O(z6));
  oai21  g138(.a(new_n49_), .b(x02), .c(x21), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n111_), .c(new_n110_), .d(new_n109_), .O(z7));
endmodule
