...
module FAU ( 
  ...
  nand4  g014(.a(new_n41_), .b(new_n47_), .c(new_n46_), .d(x00), .O(new_n48_));
  ...
  aoi21  g022(.a(new_n55_), .b(new_n34_), .c(x01), .O(z0));
  ...
  nand4  g049(.a(new_n82_), .b(new_n37_), .c(new_n34_), .d(new_n70_), .O(new_n83_));
  nor2   g050(.a(new_n83_), .b(x06), .O(new_n84_));
  nand4  g051(.a(new_n84_), .b(new_n69_), .c(new_n35_), .d(new_n68_), .O(new_n85_));
  ...
  nor4   g055(.a(new_n88_), .b(new_n69_), .c(new_n35_), .d(new_n68_), .O(new_n89_));
  ...
  nand3  g064(.a(new_n97_), .b(x07), .c(new_n36_), .O(new_n98_));
  inv1   g065(.a(new_n98_), .O(new_n99_));
  nand4  g066(.a(new_n72_), .b(new_n71_), .c(new_n57_), .d(new_n37_), .O(new_n100_));
  nand4  g067(.a(new_n75_), .b(new_n74_), .c(new_n38_), .d(new_n73_), .O(new_n101_));
  nor2   g068(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n99_), .c(new_n96_), .O(new_n103_));
  aoi22  g070(.a(new_n103_), .b(new_n95_), .c(new_n49_), .d(new_n39_), .O(new_n104_));
  ...
  nand4  g077(.a(new_n73_), .b(new_n72_), .c(new_n71_), .d(new_n57_), .O(new_n111_));
  nand4  g078(.a(new_n75_), .b(new_n74_), .c(new_n38_), .d(x19), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n110_), .c(new_n109_), .d(new_n96_), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n108_), .c(x13), .O(new_n115_));
  aoi22  g082(.a(new_n115_), .b(new_n39_), .c(new_n104_), .d(x24), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n87_), .O(z1));
  nor2   g084(.a(new_n41_), .b(new_n92_), .O(new_n118_));
  inv1   g085(.a(new_n118_), .O(new_n119_));
  nand3  g086(.a(new_n41_), .b(x15), .c(x13), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(new_n119_), .c(new_n39_), .O(new_n121_));
  nand2  g088(.a(new_n118_), .b(x13), .O(new_n122_));
  nand3  g089(.a(x15), .b(new_n49_), .c(new_n39_), .O(new_n123_));
  nand4  g090(.a(new_n41_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n124_));
  and2   g091(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(new_n121_), .O(new_n127_));
  nor3   g094(.a(new_n127_), .b(new_n38_), .c(new_n71_), .O(new_n128_));
  ...
  nand4  g100(.a(new_n78_), .b(new_n38_), .c(new_n71_), .d(new_n37_), .O(new_n134_));
  nor2   g101(.a(new_n134_), .b(x09), .O(new_n135_));
  nand4  g102(.a(new_n135_), .b(new_n70_), .c(new_n36_), .d(new_n35_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(x01), .c(new_n133_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n41_), .O(new_n138_));
  nand2  g105(.a(new_n49_), .b(new_n39_), .O(new_n139_));
  nand4  g106(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n140_));
  nand3  g107(.a(new_n93_), .b(x14), .c(x11), .O(new_n141_));
  nand4  g108(.a(x07), .b(new_n36_), .c(new_n35_), .d(new_n68_), .O(new_n142_));
  nand4  g109(.a(new_n97_), .b(new_n38_), .c(new_n71_), .d(new_n37_), .O(new_n143_));
  ...
  nand3  g113(.a(new_n109_), .b(new_n35_), .c(new_n68_), .O(new_n147_));
  nand4  g114(.a(new_n110_), .b(new_n38_), .c(x19), .d(new_n71_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n140_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n49_), .c(new_n39_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n145_), .c(new_n138_), .O(z3));
  nand2  g118(.a(new_n72_), .b(x09), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n70_), .c(new_n68_), .O(new_n153_));
  oai21  g120(.a(x23), .b(new_n69_), .c(new_n73_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n74_), .c(new_n72_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n70_), .c(x09), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n153_), .c(new_n52_), .O(new_n157_));
  nor2   g124(.a(new_n34_), .b(x01), .O(new_n158_));
  inv1   g125(.a(new_n158_), .O(new_n159_));
  oai21  g126(.a(new_n75_), .b(x04), .c(x17), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(x22), .c(x01), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(x09), .O(new_n162_));
  aoi22  g129(.a(new_n162_), .b(x16), .c(new_n159_), .d(new_n70_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n127_), .c(new_n157_), .O(z4));
  nand4  g131(.a(new_n159_), .b(new_n51_), .c(new_n45_), .d(new_n44_), .O(z5));
  ...
  nand2  g135(.a(new_n38_), .b(x14), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x06), .c(new_n37_), .O(new_n170_));
  oai22  g137(.a(new_n170_), .b(new_n35_), .c(new_n126_), .d(new_n121_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n168_), .c(new_n158_), .O(z6));
  inv1   g139(.a(new_n121_), .O(new_n173_));
  nand4  g140(.a(new_n159_), .b(new_n125_), .c(new_n122_), .d(new_n173_), .O(z7));
endmodule
