...
module FAU ( 
  ...
  nand3  g101(.a(new_n73_), .b(new_n35_), .c(new_n69_), .O(new_n135_));
  nand3  g102(.a(new_n78_), .b(new_n38_), .c(new_n37_), .O(new_n136_));
  ...
  nand4  g106(.a(x07), .b(new_n36_), .c(new_n35_), .d(new_n69_), .O(new_n140_));
  nand4  g107(.a(new_n39_), .b(new_n38_), .c(new_n37_), .d(new_n60_), .O(new_n141_));
  ...
  nand3  g110(.a(new_n73_), .b(new_n35_), .c(x00), .O(new_n144_));
  ...
  nor2   g115(.a(x02), .b(new_n69_), .O(new_n149_));
  nand2  g116(.a(new_n133_), .b(new_n46_), .O(new_n150_));
  nand3  g117(.a(new_n41_), .b(x21), .c(x20), .O(new_n151_));
  nor2   g118(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n149_), .c(new_n61_), .d(x03), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n148_), .c(new_n143_), .d(new_n138_), .O(z3));
  inv1   g121(.a(x04), .O(new_n155_));
  inv1   g122(.a(x17), .O(new_n156_));
  oai21  g123(.a(x23), .b(new_n155_), .c(new_n156_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n113_), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n60_), .O(new_n159_));
  nand3  g126(.a(new_n50_), .b(new_n45_), .c(new_n44_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n130_), .O(new_n161_));
  nand3  g128(.a(new_n101_), .b(new_n41_), .c(new_n46_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n161_), .O(z5));
  nand2  g130(.a(z5), .b(new_n159_), .O(new_n164_));
  oai21  g131(.a(new_n114_), .b(x04), .c(x17), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x22), .c(new_n68_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n93_), .c(x08), .O(new_n167_));
  nand2  g134(.a(new_n123_), .b(new_n122_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n121_), .c(new_n130_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n124_), .O(z7));
  ...
  nand3  g142(.a(new_n162_), .b(new_n50_), .c(new_n45_), .O(new_n176_));
  oai22  g143(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(x03), .O(new_n177_));
  oai21  g144(.a(x20), .b(new_n38_), .c(x06), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(x11), .c(x03), .O(new_n179_));
  oai21  g146(.a(new_n129_), .b(x03), .c(new_n179_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n82_), .c(x18), .O(new_n181_));
  inv1   g148(.a(new_n123_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n35_), .c(x01), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n181_), .O(new_n184_));
  nand2  g151(.a(new_n184_), .b(x24), .O(new_n185_));
  nand2  g152(.a(x24), .b(new_n35_), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(new_n49_), .c(new_n48_), .O(new_n187_));
  nand2  g154(.a(new_n187_), .b(new_n83_), .O(new_n188_));
  nand2  g155(.a(new_n188_), .b(x15), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n124_), .O(new_n190_));
  nand3  g157(.a(new_n190_), .b(new_n178_), .c(x11), .O(new_n191_));
  nand3  g158(.a(new_n41_), .b(x21), .c(new_n46_), .O(new_n192_));
  nand2  g159(.a(new_n192_), .b(new_n123_), .O(new_n193_));
  nand2  g160(.a(new_n193_), .b(new_n34_), .O(new_n194_));
  nand2  g161(.a(x13), .b(x05), .O(new_n195_));
  nand2  g162(.a(new_n195_), .b(new_n82_), .O(new_n196_));
  nand3  g163(.a(new_n196_), .b(new_n41_), .c(x15), .O(new_n197_));
  nand2  g164(.a(new_n197_), .b(new_n194_), .O(new_n198_));
  aoi21  g165(.a(new_n198_), .b(new_n35_), .c(new_n129_), .O(new_n199_));
  nand4  g166(.a(new_n199_), .b(new_n191_), .c(new_n185_), .d(new_n177_), .O(z6));
endmodule
