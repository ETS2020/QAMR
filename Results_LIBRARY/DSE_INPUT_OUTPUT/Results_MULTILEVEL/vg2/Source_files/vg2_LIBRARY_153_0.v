...
module FAU ( 
  ...
  nand3  g086(.a(x15), .b(new_n89_), .c(new_n44_), .O(new_n120_));
  ...
  oai21  g091(.a(new_n124_), .b(new_n108_), .c(new_n115_), .O(z2));
  nand4  g092(.a(new_n109_), .b(x08), .c(x06), .d(x03), .O(new_n126_));
  nor2   g093(.a(new_n37_), .b(new_n36_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n112_), .c(x20), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(new_n126_), .c(x01), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n55_), .O(new_n130_));
  nand3  g097(.a(new_n59_), .b(x03), .c(x01), .O(new_n131_));
  nand3  g098(.a(new_n127_), .b(x20), .c(x15), .O(new_n132_));
  nand3  g099(.a(new_n81_), .b(new_n34_), .c(new_n108_), .O(new_n133_));
  nand3  g100(.a(new_n85_), .b(new_n37_), .c(new_n36_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n131_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n92_), .O(new_n136_));
  nand3  g103(.a(new_n127_), .b(x20), .c(x18), .O(new_n137_));
  nand4  g104(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n108_), .O(new_n138_));
  nand4  g105(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n58_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n131_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n90_), .c(x24), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n136_), .c(new_n130_), .O(z3));
  ...
  nand2  g122(.a(new_n55_), .b(x01), .O(new_n156_));
  nand2  g123(.a(new_n112_), .b(new_n109_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(new_n122_), .O(new_n158_));
  ...
  aoi21  g134(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(x02), .c(new_n122_), .O(z7));
endmodule
