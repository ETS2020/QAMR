...
module FAU ( 
  ...
  nand4  g030(.a(new_n63_), .b(new_n36_), .c(new_n62_), .d(new_n35_), .O(new_n64_));
  ...
  nor2   g046(.a(new_n79_), .b(new_n55_), .O(new_n80_));
  nand4  g047(.a(new_n80_), .b(new_n78_), .c(new_n75_), .d(new_n73_), .O(new_n81_));
  inv1   g048(.a(x09), .O(new_n82_));
  nor3   g049(.a(x04), .b(x03), .c(x01), .O(new_n83_));
  nand4  g050(.a(new_n83_), .b(new_n59_), .c(new_n35_), .d(new_n82_), .O(new_n84_));
  ...
  nand4  g065(.a(new_n98_), .b(new_n97_), .c(new_n80_), .d(new_n73_), .O(new_n99_));
  nor2   g066(.a(x09), .b(x08), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n83_), .c(x07), .d(new_n34_), .O(new_n101_));
  nand3  g068(.a(new_n89_), .b(new_n66_), .c(new_n65_), .O(new_n102_));
  ...
  nand3  g078(.a(x15), .b(new_n45_), .c(new_n39_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(new_n110_), .c(new_n38_), .O(new_n114_));
  nand4  g081(.a(new_n50_), .b(x21), .c(new_n49_), .d(new_n37_), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(new_n114_), .c(new_n77_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x14), .c(x11), .d(x06), .O(new_n117_));
  nor3   g084(.a(new_n117_), .b(new_n107_), .c(new_n106_), .O(z2));
  ...
  nand3  g088(.a(new_n59_), .b(new_n107_), .c(new_n106_), .O(new_n122_));
  nand3  g089(.a(new_n88_), .b(new_n36_), .c(new_n35_), .O(new_n123_));
  oai22  g090(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n119_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n94_), .O(new_n125_));
  nand2  g092(.a(new_n120_), .b(new_n98_), .O(new_n126_));
  nand4  g093(.a(x07), .b(new_n34_), .c(new_n107_), .d(new_n106_), .O(new_n127_));
  inv1   g094(.a(x08), .O(new_n128_));
  nand4  g095(.a(new_n77_), .b(new_n36_), .c(new_n35_), .d(new_n128_), .O(new_n129_));
  ...
  nand3  g098(.a(new_n57_), .b(new_n34_), .c(new_n107_), .O(new_n132_));
  nand3  g099(.a(new_n120_), .b(x21), .c(x20), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n119_), .c(new_n132_), .d(new_n129_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n41_), .c(new_n49_), .O(new_n135_));
  ...
  nand2  g105(.a(new_n115_), .b(new_n114_), .O(z7));
  oai21  g106(.a(new_n63_), .b(x09), .c(x08), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(z7), .O(new_n141_));
  nand2  g108(.a(new_n79_), .b(x04), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n76_), .c(new_n82_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n63_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n128_), .O(new_n145_));
  nand4  g112(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n46_), .c(new_n44_), .O(new_n147_));
  or2    g114(.a(new_n147_), .b(new_n43_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n145_), .c(new_n55_), .O(new_n149_));
  nor2   g116(.a(new_n47_), .b(new_n43_), .O(new_n150_));
  nand2  g117(.a(new_n109_), .b(new_n108_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(x05), .O(new_n152_));
  nand3  g119(.a(new_n112_), .b(new_n111_), .c(new_n152_), .O(new_n153_));
  oai21  g120(.a(new_n79_), .b(x04), .c(x17), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n153_), .c(x22), .d(x16), .O(new_n155_));
  aoi21  g122(.a(new_n63_), .b(x09), .c(x08), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n150_), .c(new_n155_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(x02), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n149_), .c(new_n141_), .O(z4));
  nand2  g126(.a(new_n51_), .b(new_n48_), .O(z5));
  ...
  oai21  g130(.a(x20), .b(new_n36_), .c(x06), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(x11), .c(x03), .O(new_n165_));
  oai21  g132(.a(x22), .b(x03), .c(new_n165_), .O(new_n166_));
  nand4  g133(.a(new_n41_), .b(x21), .c(new_n49_), .d(new_n37_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n112_), .c(new_n111_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n110_), .c(new_n166_), .O(new_n169_));
  nand3  g136(.a(new_n153_), .b(new_n107_), .c(x02), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n169_), .c(new_n163_), .d(new_n38_), .O(z6));
endmodule
