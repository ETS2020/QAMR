...
module FAU ( 
  ...
  nor2   g021(.a(x21), .b(new_n40_), .O(new_n55_));
  ...
  nand2  g059(.a(x08), .b(x06), .O(new_n93_));
  nor4   g060(.a(new_n93_), .b(new_n92_), .c(new_n36_), .d(new_n72_), .O(new_n94_));
  ...
  nand4  g070(.a(new_n103_), .b(new_n101_), .c(new_n72_), .d(new_n71_), .O(new_n104_));
  nand4  g071(.a(new_n74_), .b(new_n73_), .c(new_n58_), .d(new_n36_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  nor2   g073(.a(x23), .b(x22), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n106_), .c(new_n37_), .d(new_n75_), .O(new_n108_));
  oai21  g075(.a(new_n108_), .b(new_n104_), .c(new_n100_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n91_), .c(x24), .O(new_n110_));
  nand4  g077(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n111_));
  nand3  g078(.a(new_n99_), .b(x20), .c(x17), .O(new_n112_));
  ...
  nand4  g082(.a(new_n115_), .b(new_n101_), .c(new_n71_), .d(new_n35_), .O(new_n116_));
  nand4  g083(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n58_), .O(new_n117_));
  ...
  nand3  g087(.a(new_n120_), .b(new_n49_), .c(new_n38_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n110_), .c(new_n56_), .O(new_n122_));
  inv1   g089(.a(new_n122_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n89_), .O(z1));
  nand2  g091(.a(x24), .b(x18), .O(new_n125_));
  nand3  g092(.a(new_n47_), .b(x15), .c(x13), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(new_n125_), .c(new_n38_), .O(new_n127_));
  nand3  g094(.a(x15), .b(new_n49_), .c(new_n38_), .O(new_n128_));
  oai21  g095(.a(new_n125_), .b(new_n49_), .c(new_n128_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g097(.a(new_n47_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n131_));
  oai21  g098(.a(new_n130_), .b(new_n55_), .c(new_n131_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x20), .c(x14), .d(x11), .O(new_n133_));
  nor4   g100(.a(new_n133_), .b(new_n35_), .c(new_n34_), .d(new_n69_), .O(z2));
  inv1   g101(.a(x21), .O(new_n135_));
  nand4  g102(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n136_));
  nand3  g103(.a(new_n98_), .b(x14), .c(x11), .O(new_n137_));
  nand3  g104(.a(new_n103_), .b(new_n34_), .c(new_n69_), .O(new_n138_));
  ...
  nand3  g107(.a(new_n140_), .b(new_n91_), .c(x24), .O(new_n141_));
  nand3  g108(.a(new_n47_), .b(x13), .c(x05), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n91_), .O(new_n143_));
  ...
  nand3  g121(.a(new_n154_), .b(new_n148_), .c(new_n141_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n56_), .O(new_n156_));
  nand4  g123(.a(new_n143_), .b(new_n37_), .c(x19), .d(new_n73_), .O(new_n157_));
  nor2   g124(.a(new_n157_), .b(x11), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n71_), .c(new_n35_), .d(new_n34_), .O(new_n159_));
  nor2   g126(.a(new_n159_), .b(x01), .O(new_n160_));
  nor4   g127(.a(new_n93_), .b(new_n34_), .c(x02), .d(new_n69_), .O(new_n161_));
  nand3  g128(.a(new_n47_), .b(x20), .c(x14), .O(new_n162_));
  nor3   g129(.a(new_n162_), .b(new_n36_), .c(x10), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n161_), .c(new_n160_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n135_), .c(new_n156_), .O(z3));
  oai21  g132(.a(x23), .b(new_n70_), .c(new_n75_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n76_), .c(x09), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x16), .c(new_n71_), .O(new_n168_));
  nand2  g135(.a(new_n50_), .b(new_n44_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n43_), .c(x21), .O(new_n170_));
  inv1   g137(.a(new_n48_), .O(new_n171_));
  nand2  g138(.a(new_n91_), .b(x24), .O(new_n172_));
  nor2   g139(.a(new_n172_), .b(new_n102_), .O(new_n173_));
  nor2   g140(.a(new_n173_), .b(new_n171_), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(x19), .c(new_n170_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n168_), .O(new_n176_));
  oai21  g143(.a(new_n77_), .b(x04), .c(x17), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(x22), .c(new_n72_), .O(new_n178_));
  oai21  g145(.a(new_n178_), .b(new_n74_), .c(x08), .O(new_n179_));
  nand3  g146(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(new_n180_));
  oai21  g147(.a(new_n172_), .b(new_n97_), .c(new_n180_), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(x21), .O(new_n182_));
  oai21  g149(.a(new_n130_), .b(x19), .c(new_n182_), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n179_), .O(new_n184_));
  nand3  g151(.a(new_n143_), .b(x15), .c(new_n71_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n48_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(x21), .O(new_n187_));
  nand3  g154(.a(new_n187_), .b(new_n184_), .c(new_n176_), .O(z4));
  nand3  g155(.a(new_n143_), .b(x21), .c(x19), .O(new_n189_));
  oai21  g156(.a(new_n174_), .b(new_n55_), .c(new_n189_), .O(z5));
  nand2  g157(.a(x20), .b(new_n73_), .O(new_n191_));
  aoi21  g158(.a(new_n191_), .b(new_n35_), .c(x11), .O(new_n192_));
  oai22  g159(.a(new_n192_), .b(x03), .c(new_n51_), .d(new_n43_), .O(new_n193_));
  oai21  g160(.a(x20), .b(new_n73_), .c(x06), .O(new_n194_));
  nand2  g161(.a(x19), .b(x03), .O(new_n195_));
  oai21  g162(.a(new_n135_), .b(x19), .c(new_n195_), .O(new_n196_));
  nand3  g163(.a(new_n196_), .b(new_n46_), .c(new_n45_), .O(new_n197_));
  nand2  g164(.a(x13), .b(x05), .O(new_n198_));
  nand2  g165(.a(new_n198_), .b(new_n91_), .O(new_n199_));
  nand3  g166(.a(new_n199_), .b(new_n40_), .c(x15), .O(new_n200_));
  nand2  g167(.a(new_n200_), .b(new_n197_), .O(new_n201_));
  nand2  g168(.a(new_n201_), .b(new_n47_), .O(new_n202_));
  oai21  g169(.a(new_n90_), .b(new_n97_), .c(new_n128_), .O(new_n203_));
  nand3  g170(.a(new_n203_), .b(x24), .c(x03), .O(new_n204_));
  nand2  g171(.a(new_n204_), .b(new_n202_), .O(new_n205_));
  nand3  g172(.a(new_n205_), .b(new_n194_), .c(x11), .O(new_n206_));
  nand4  g173(.a(new_n199_), .b(new_n47_), .c(x21), .d(x15), .O(new_n207_));
  aoi21  g174(.a(new_n207_), .b(x21), .c(new_n40_), .O(new_n208_));
  aoi21  g175(.a(new_n132_), .b(new_n34_), .c(new_n208_), .O(new_n209_));
  nand3  g176(.a(new_n209_), .b(new_n206_), .c(new_n193_), .O(z6));
  aoi21  g177(.a(x21), .b(new_n34_), .c(new_n40_), .O(new_n211_));
  nor2   g178(.a(new_n211_), .b(new_n144_), .O(new_n212_));
  nand2  g179(.a(new_n47_), .b(new_n40_), .O(new_n213_));
  nand3  g180(.a(new_n213_), .b(new_n49_), .c(new_n38_), .O(new_n214_));
  nand3  g181(.a(new_n41_), .b(x13), .c(x05), .O(new_n215_));
  aoi21  g182(.a(new_n215_), .b(new_n214_), .c(new_n135_), .O(new_n216_));
  oai21  g183(.a(new_n216_), .b(new_n212_), .c(x15), .O(new_n217_));
  nand4  g184(.a(new_n91_), .b(new_n56_), .c(x24), .d(x18), .O(new_n218_));
  nand3  g185(.a(new_n218_), .b(new_n217_), .c(new_n131_), .O(z7));
endmodule
