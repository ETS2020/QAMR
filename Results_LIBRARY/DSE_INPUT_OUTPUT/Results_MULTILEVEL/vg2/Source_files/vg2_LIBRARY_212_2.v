...
module FAU ( 
  ...
  nor2   g083(.a(new_n38_), .b(new_n37_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(x20), .c(x15), .O(new_n118_));
  nand4  g085(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n56_), .O(new_n119_));
  nand4  g086(.a(new_n74_), .b(new_n38_), .c(new_n37_), .d(new_n67_), .O(new_n120_));
  ...
  nand4  g091(.a(new_n124_), .b(new_n37_), .c(new_n67_), .d(x07), .O(new_n125_));
  ...
  nand3  g131(.a(new_n164_), .b(new_n159_), .c(new_n134_), .O(new_n165_));
  ...
  nand2  g136(.a(new_n169_), .b(new_n134_), .O(new_n170_));
  ...
  nand3  g143(.a(new_n176_), .b(x18), .c(x11), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n40_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(x03), .O(new_n179_));
  nand3  g146(.a(x18), .b(new_n35_), .c(new_n34_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n79_), .c(x24), .O(new_n182_));
  nand3  g149(.a(new_n176_), .b(x15), .c(x11), .O(new_n183_));
  aoi21  g150(.a(new_n183_), .b(new_n48_), .c(new_n35_), .O(new_n184_));
  nand3  g151(.a(x15), .b(new_n35_), .c(new_n34_), .O(new_n185_));
  inv1   g152(.a(new_n185_), .O(new_n186_));
  oai21  g153(.a(new_n186_), .b(new_n184_), .c(new_n81_), .O(new_n187_));
  aoi21  g154(.a(new_n110_), .b(new_n34_), .c(x03), .O(new_n188_));
  nand3  g155(.a(new_n176_), .b(x21), .c(x11), .O(new_n189_));
  nand2  g156(.a(x03), .b(x00), .O(new_n190_));
  nand2  g157(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  nand3  g158(.a(new_n191_), .b(new_n41_), .c(new_n96_), .O(new_n192_));
  inv1   g159(.a(new_n192_), .O(new_n193_));
  aoi21  g160(.a(new_n193_), .b(new_n34_), .c(new_n188_), .O(new_n194_));
  nand4  g161(.a(new_n194_), .b(new_n187_), .c(new_n182_), .d(new_n175_), .O(z6));
  nand2  g162(.a(new_n109_), .b(new_n108_), .O(new_n196_));
  oai22  g163(.a(new_n196_), .b(new_n107_), .c(x03), .d(new_n34_), .O(new_n197_));
  nand2  g164(.a(new_n197_), .b(new_n110_), .O(z7));
endmodule
