...
module FAU ( 
  ...
  inv1   g134(.a(new_n42_), .O(new_n168_));
  and2   g135(.a(new_n46_), .b(new_n43_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n54_), .c(new_n48_), .d(new_n168_), .O(z5));
  nand2  g137(.a(x20), .b(new_n71_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n35_), .c(x11), .O(new_n172_));
  oai22  g139(.a(new_n172_), .b(x03), .c(new_n49_), .d(new_n42_), .O(new_n173_));
  oai21  g140(.a(x20), .b(new_n71_), .c(x06), .O(new_n174_));
  oai21  g141(.a(new_n122_), .b(new_n34_), .c(new_n123_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(x05), .O(new_n176_));
  nand2  g143(.a(new_n126_), .b(x03), .O(new_n177_));
  nand2  g144(.a(new_n125_), .b(new_n58_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n40_), .O(new_n179_));
  nand3  g146(.a(new_n179_), .b(new_n177_), .c(new_n176_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n174_), .c(x11), .O(new_n181_));
  nand3  g148(.a(new_n89_), .b(new_n54_), .c(x18), .O(new_n182_));
  nand3  g149(.a(new_n88_), .b(x21), .c(x15), .O(new_n183_));
  aoi21  g150(.a(new_n183_), .b(new_n182_), .c(new_n40_), .O(new_n184_));
  nand3  g151(.a(new_n40_), .b(x21), .c(new_n45_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n125_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n44_), .O(new_n187_));
  nand2  g154(.a(x13), .b(x05), .O(new_n188_));
  nand2  g155(.a(new_n188_), .b(new_n89_), .O(new_n189_));
  nand3  g156(.a(new_n189_), .b(new_n40_), .c(x15), .O(new_n190_));
  nand2  g157(.a(new_n190_), .b(new_n187_), .O(new_n191_));
  oai21  g158(.a(new_n191_), .b(new_n184_), .c(new_n34_), .O(new_n192_));
  nand4  g159(.a(new_n192_), .b(new_n181_), .c(new_n173_), .d(new_n54_), .O(z6));
endmodule
