...
module FAU ( 
  ...
  oai21  g083(.a(new_n113_), .b(new_n44_), .c(new_n116_), .O(new_n117_));
  oai21  g084(.a(new_n117_), .b(new_n115_), .c(x20), .O(new_n118_));
  nor2   g085(.a(new_n118_), .b(new_n97_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x11), .c(x06), .d(x03), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(new_n105_), .c(new_n112_), .O(z2));
  nand3  g088(.a(new_n55_), .b(x03), .c(x01), .O(new_n122_));
  nor2   g089(.a(new_n97_), .b(new_n36_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(x20), .c(x15), .O(new_n124_));
  nand4  g091(.a(new_n35_), .b(new_n34_), .c(x02), .d(new_n105_), .O(new_n125_));
  nand4  g092(.a(new_n82_), .b(new_n97_), .c(new_n36_), .d(new_n54_), .O(new_n126_));
  ...
  nand4  g097(.a(new_n130_), .b(new_n36_), .c(new_n54_), .d(x07), .O(new_n131_));
  ...
  nor2   g100(.a(x02), .b(new_n105_), .O(new_n134_));
  ...
  nand4  g104(.a(new_n137_), .b(new_n134_), .c(new_n55_), .d(x03), .O(new_n138_));
  ...
  nor2   g119(.a(new_n117_), .b(new_n115_), .O(new_n153_));
  nand3  g120(.a(new_n134_), .b(new_n109_), .c(new_n106_), .O(new_n154_));
  oai21  g121(.a(new_n145_), .b(new_n153_), .c(new_n154_), .O(z7));
  nand2  g122(.a(z7), .b(new_n152_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n149_), .O(z4));
  aoi21  g124(.a(new_n146_), .b(x00), .c(new_n105_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x02), .c(new_n144_), .O(z5));
