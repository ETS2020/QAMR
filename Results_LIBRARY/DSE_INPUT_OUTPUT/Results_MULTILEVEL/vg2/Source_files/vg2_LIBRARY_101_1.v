...
module FAU ( 
  ...
  nand3  g112(.a(new_n145_), .b(new_n46_), .c(new_n45_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n141_), .c(new_n134_), .O(z3));
  oai21  g114(.a(new_n73_), .b(x04), .c(x17), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x22), .c(new_n67_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n69_), .c(x08), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n122_), .O(new_n151_));
  nor2   g118(.a(new_n71_), .b(x06), .O(new_n152_));
  ...
  oai21  g124(.a(new_n152_), .b(new_n66_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n154_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n153_), .c(new_n151_), .O(z4));
  nor2   g127(.a(new_n152_), .b(new_n49_), .O(z5));
  inv1   g128(.a(x21), .O(new_n162_));
  nand2  g129(.a(x03), .b(x00), .O(new_n163_));
  oai21  g130(.a(new_n162_), .b(x03), .c(new_n163_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n43_), .c(new_n42_), .O(new_n165_));
  ...
  aoi21  g136(.a(new_n169_), .b(new_n165_), .c(x24), .O(new_n170_));
  nand2  g137(.a(x07), .b(x03), .O(new_n171_));
  oai21  g138(.a(new_n91_), .b(x03), .c(new_n171_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n135_), .c(x24), .O(new_n173_));
  nand3  g140(.a(new_n168_), .b(new_n46_), .c(new_n45_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n170_), .c(new_n153_), .O(new_n176_));
  nand2  g143(.a(new_n68_), .b(x06), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n71_), .c(x18), .d(x11), .O(new_n178_));
  nand3  g145(.a(new_n36_), .b(x07), .c(x06), .O(new_n179_));
  ...
  nand4  g150(.a(new_n177_), .b(new_n71_), .c(x15), .d(x11), .O(new_n184_));
  nand3  g151(.a(x19), .b(new_n36_), .c(x06), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand2  g153(.a(new_n186_), .b(new_n183_), .O(new_n187_));
  nand4  g154(.a(new_n177_), .b(x21), .c(new_n71_), .d(x11), .O(new_n188_));
  nand3  g155(.a(new_n36_), .b(x06), .c(x00), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand4  g157(.a(new_n190_), .b(new_n38_), .c(new_n43_), .d(new_n42_), .O(new_n191_));
  nand4  g158(.a(new_n191_), .b(new_n187_), .c(new_n181_), .d(new_n176_), .O(z6));
  and2   g159(.a(new_n120_), .b(new_n119_), .O(new_n193_));
  nand4  g160(.a(new_n193_), .b(new_n153_), .c(new_n121_), .d(new_n118_), .O(z7));
endmodule
