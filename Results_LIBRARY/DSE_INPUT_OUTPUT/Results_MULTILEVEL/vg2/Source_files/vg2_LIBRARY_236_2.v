...
module FAU ( 
  ...
  nor2   g083(.a(new_n116_), .b(x13), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(new_n47_), .c(new_n115_), .O(new_n118_));
  ...
  nand4  g088(.a(new_n121_), .b(x06), .c(x03), .d(x02), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n35_), .O(z2));
  nand4  g090(.a(x06), .b(x03), .c(x02), .d(x01), .O(new_n124_));
  nand2  g091(.a(x11), .b(x08), .O(new_n125_));
  nand3  g092(.a(x20), .b(x15), .c(x14), .O(new_n126_));
  nor3   g093(.a(new_n126_), .b(new_n125_), .c(new_n124_), .O(new_n127_));
  nor2   g094(.a(x03), .b(x01), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n72_), .O(new_n129_));
  nand3  g096(.a(new_n77_), .b(new_n41_), .c(new_n40_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n127_), .c(new_n83_), .O(new_n132_));
  inv1   g099(.a(new_n125_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n87_), .c(x14), .O(new_n134_));
  nor2   g101(.a(x11), .b(x08), .O(new_n135_));
  nor2   g102(.a(x20), .b(x14), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n135_), .c(new_n128_), .d(new_n91_), .O(new_n137_));
  oai21  g104(.a(new_n134_), .b(new_n124_), .c(new_n137_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n81_), .c(x24), .O(new_n139_));
  nor3   g106(.a(x06), .b(x03), .c(x02), .O(new_n140_));
  nor3   g107(.a(x11), .b(x10), .c(x08), .O(new_n141_));
  nor3   g108(.a(x24), .b(x20), .c(x14), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n101_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n139_), .c(new_n132_), .O(z3));
  ...
  oai21  g114(.a(new_n147_), .b(x16), .c(new_n89_), .O(new_n148_));
  nor2   g115(.a(new_n54_), .b(new_n50_), .O(new_n149_));
  nor2   g116(.a(x02), .b(new_n35_), .O(new_n150_));
  nand4  g117(.a(new_n101_), .b(new_n43_), .c(new_n38_), .d(new_n34_), .O(new_n151_));
  oai21  g118(.a(new_n150_), .b(new_n149_), .c(new_n151_), .O(z5));
  nand2  g119(.a(z5), .b(new_n148_), .O(new_n153_));
  oai21  g120(.a(new_n67_), .b(x04), .c(x17), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x22), .c(new_n70_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n94_), .c(x08), .O(new_n156_));
  oai21  g123(.a(x02), .b(new_n35_), .c(new_n119_), .O(new_n157_));
  nor2   g124(.a(x02), .b(x01), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n43_), .c(x21), .d(new_n38_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n157_), .O(z7));
  nand2  g127(.a(z7), .b(new_n156_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n153_), .O(z4));
  aoi21  g129(.a(x20), .b(new_n41_), .c(x06), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x11), .c(new_n36_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(z5), .O(new_n165_));
  aoi21  g132(.a(new_n42_), .b(x14), .c(new_n37_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n40_), .c(x03), .O(new_n167_));
