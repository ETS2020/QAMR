...
module FAU ( 
  ...
  nand4  g112(.a(new_n41_), .b(new_n46_), .c(new_n34_), .d(x00), .O(new_n146_));
  and2   g113(.a(new_n146_), .b(new_n50_), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n45_), .c(new_n44_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  inv1   g116(.a(x16), .O(new_n150_));
  oai21  g117(.a(new_n64_), .b(x04), .c(x17), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x22), .c(new_n58_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n150_), .c(x08), .O(new_n153_));
  oai21  g120(.a(new_n113_), .b(new_n109_), .c(new_n153_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n149_), .c(new_n117_), .O(z4));
  nand4  g122(.a(new_n147_), .b(new_n117_), .c(new_n45_), .d(new_n44_), .O(z5));
  ...
  nand2  g126(.a(new_n159_), .b(new_n117_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n146_), .O(new_n161_));
  ...
  oai21  g132(.a(new_n165_), .b(new_n109_), .c(new_n117_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n112_), .O(z7));
  nand2  g134(.a(z7), .b(new_n164_), .O(new_n168_));
