...
module FAU ( 
  ...
  nor2   g005(.a(x23), .b(new_n38_), .O(new_n39_));
  ...
  nand4  g046(.a(new_n79_), .b(new_n76_), .c(new_n38_), .d(new_n37_), .O(new_n80_));
  ...
  nor2   g061(.a(new_n76_), .b(new_n38_), .O(new_n95_));
  ...
  nand4  g067(.a(new_n76_), .b(new_n38_), .c(new_n37_), .d(new_n75_), .O(new_n101_));
  ...
  nand4  g078(.a(new_n76_), .b(new_n38_), .c(new_n37_), .d(x19), .O(new_n112_));
  ...
  inv1   g119(.a(new_n127_), .O(new_n153_));
  oai21  g120(.a(new_n75_), .b(new_n70_), .c(x22), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x09), .c(new_n74_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n71_), .c(new_n153_), .O(new_n156_));
  inv1   g123(.a(new_n52_), .O(new_n157_));
  oai21  g124(.a(x23), .b(new_n70_), .c(new_n72_), .O(new_n158_));
  aoi22  g125(.a(new_n158_), .b(new_n71_), .c(new_n38_), .d(x17), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(x16), .c(new_n39_), .d(new_n71_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n157_), .c(new_n39_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n156_), .O(z4));
  nand2  g129(.a(x20), .b(new_n73_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n35_), .c(x11), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x03), .c(new_n157_), .O(new_n165_));
  nand2  g132(.a(new_n37_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n36_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n34_), .c(new_n153_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n118_), .O(z6));
  inv1   g136(.a(new_n122_), .O(new_n170_));
  and2   g137(.a(new_n124_), .b(new_n123_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n125_), .c(new_n170_), .d(new_n118_), .O(z7));
endmodule
