...
module FAU ( 
  ...
  aoi21  g074(.a(new_n107_), .b(new_n106_), .c(new_n49_), .O(new_n108_));
  nand3  g075(.a(x24), .b(x18), .c(x13), .O(new_n109_));
  nand3  g076(.a(x15), .b(new_n55_), .c(new_n49_), .O(new_n110_));
  ...
  nand2  g082(.a(new_n86_), .b(new_n39_), .O(new_n116_));
  nand3  g083(.a(new_n64_), .b(new_n43_), .c(new_n42_), .O(new_n117_));
  oai21  g084(.a(new_n117_), .b(new_n116_), .c(new_n35_), .O(new_n118_));
  ...
  nand2  g089(.a(new_n122_), .b(new_n86_), .O(new_n123_));
  nand4  g090(.a(new_n48_), .b(x19), .c(new_n42_), .d(new_n41_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n121_), .d(new_n120_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n93_), .O(new_n126_));
  nand4  g093(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n127_));
  nand3  g094(.a(new_n122_), .b(x07), .c(new_n36_), .O(new_n128_));
  inv1   g095(.a(x08), .O(new_n129_));
  nand4  g096(.a(new_n48_), .b(new_n42_), .c(new_n41_), .d(new_n129_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n128_), .c(new_n127_), .d(new_n120_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n91_), .c(x24), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n126_), .c(new_n119_), .O(z3));
  inv1   g100(.a(x04), .O(new_n134_));
  oai21  g101(.a(x23), .b(new_n134_), .c(new_n69_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n66_), .c(x09), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(x16), .c(new_n129_), .O(new_n137_));
  nor2   g104(.a(new_n57_), .b(new_n53_), .O(new_n138_));
  nor2   g105(.a(x02), .b(new_n35_), .O(new_n139_));
  nor2   g106(.a(x24), .b(x10), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n141_));
  ...
  aoi21  g112(.a(new_n145_), .b(x22), .c(new_n84_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n68_), .c(x08), .O(new_n147_));
  nor2   g114(.a(new_n111_), .b(new_n108_), .O(new_n148_));
  nor2   g115(.a(x02), .b(x01), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n51_), .c(x21), .d(new_n37_), .O(new_n150_));
  oai21  g117(.a(new_n139_), .b(new_n148_), .c(new_n150_), .O(z7));
  nand2  g118(.a(z7), .b(new_n147_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n143_), .O(z4));
  aoi21  g120(.a(new_n140_), .b(x00), .c(x01), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x02), .c(new_n138_), .O(z5));
  nand2  g122(.a(x20), .b(new_n42_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n36_), .c(x11), .O(new_n157_));
  nand3  g124(.a(new_n140_), .b(new_n34_), .c(x00), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n56_), .c(new_n54_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n53_), .c(new_n157_), .d(x03), .O(new_n160_));
  oai21  g127(.a(x20), .b(new_n42_), .c(x06), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(x11), .c(x03), .O(new_n162_));
  inv1   g129(.a(new_n162_), .O(new_n163_));
  nand4  g130(.a(new_n51_), .b(x21), .c(new_n37_), .d(new_n34_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n110_), .c(new_n109_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n108_), .c(new_n163_), .d(new_n122_), .O(new_n166_));
  nor2   g133(.a(new_n148_), .b(x03), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x02), .c(new_n139_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n166_), .c(new_n160_), .O(z6));
endmodule
