...
module FAU ( 
  ...
  nand4  g074(.a(new_n107_), .b(new_n41_), .c(x21), .d(x20), .O(new_n108_));
  oai21  g075(.a(new_n108_), .b(new_n106_), .c(new_n63_), .O(new_n109_));
  ...
  nor3   g084(.a(new_n117_), .b(new_n61_), .c(new_n36_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x11), .c(x06), .d(x03), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n95_), .c(new_n110_), .O(z2));
  nand4  g087(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n121_));
  nand3  g088(.a(new_n107_), .b(x20), .c(x15), .O(new_n122_));
  nand3  g089(.a(new_n69_), .b(new_n96_), .c(new_n95_), .O(new_n123_));
  ...
  nand2  g093(.a(new_n107_), .b(new_n84_), .O(new_n127_));
  nand4  g094(.a(x07), .b(new_n34_), .c(new_n96_), .d(new_n95_), .O(new_n128_));
  nand4  g095(.a(new_n61_), .b(new_n36_), .c(new_n35_), .d(new_n99_), .O(new_n129_));
  ...
  nand4  g098(.a(new_n34_), .b(new_n96_), .c(new_n95_), .d(x00), .O(new_n132_));
  nand3  g099(.a(new_n107_), .b(x21), .c(x20), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n121_), .c(new_n132_), .d(new_n129_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n41_), .c(new_n49_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n63_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n37_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n131_), .c(new_n126_), .O(z3));
  oai21  g105(.a(new_n89_), .b(x09), .c(x08), .O(new_n139_));
  inv1   g106(.a(new_n38_), .O(new_n140_));
  nand4  g107(.a(new_n50_), .b(x21), .c(new_n49_), .d(new_n37_), .O(new_n141_));
  oai21  g108(.a(new_n117_), .b(new_n140_), .c(new_n141_), .O(z7));
  nand2  g109(.a(z7), .b(new_n139_), .O(new_n143_));
  nand2  g110(.a(new_n64_), .b(x04), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(new_n60_), .c(new_n67_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n89_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n99_), .O(new_n147_));
  nand4  g114(.a(new_n41_), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n46_), .c(new_n44_), .O(new_n149_));
  or2    g116(.a(new_n149_), .b(new_n43_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n147_), .c(new_n63_), .O(new_n151_));
  nor2   g118(.a(new_n47_), .b(new_n43_), .O(new_n152_));
  nand2  g119(.a(new_n113_), .b(x05), .O(new_n153_));
  nand3  g120(.a(new_n115_), .b(new_n114_), .c(new_n153_), .O(new_n154_));
  oai21  g121(.a(new_n64_), .b(x04), .c(x17), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n154_), .c(x22), .d(x16), .O(new_n156_));
  aoi21  g123(.a(new_n89_), .b(x09), .c(x08), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n152_), .c(new_n156_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x02), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n151_), .c(new_n143_), .O(z4));
  nand3  g127(.a(new_n41_), .b(new_n49_), .c(x00), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n63_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n37_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n152_), .O(z5));
  nand2  g131(.a(new_n51_), .b(new_n48_), .O(new_n165_));
  aoi21  g132(.a(x20), .b(new_n36_), .c(x06), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(x11), .c(new_n96_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  aoi21  g135(.a(new_n61_), .b(x14), .c(new_n34_), .O(new_n169_));
