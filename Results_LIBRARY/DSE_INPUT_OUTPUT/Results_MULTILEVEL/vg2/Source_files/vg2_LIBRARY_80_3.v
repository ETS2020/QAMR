...
module FAU ( 
  ...
  oai21  g122(.a(x23), .b(new_n55_), .c(new_n88_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n113_), .c(x09), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x16), .c(new_n59_), .O(new_n158_));
  ...
  inv1   g130(.a(new_n123_), .O(new_n164_));
  nor2   g131(.a(x10), .b(x02), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n144_), .c(new_n164_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n122_), .c(new_n163_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n162_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n159_), .c(new_n53_), .O(z4));
  and2   g136(.a(new_n53_), .b(new_n43_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n48_), .c(new_n46_), .d(new_n153_), .O(z5));
  nand2  g138(.a(x20), .b(new_n90_), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n35_), .c(x11), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(x03), .c(new_n155_), .O(new_n174_));
  nand2  g141(.a(new_n37_), .b(x14), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(x06), .c(new_n36_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n34_), .c(new_n167_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n174_), .c(new_n53_), .O(z6));
  nand4  g145(.a(new_n166_), .b(new_n122_), .c(new_n163_), .d(new_n53_), .O(z7));
endmodule
