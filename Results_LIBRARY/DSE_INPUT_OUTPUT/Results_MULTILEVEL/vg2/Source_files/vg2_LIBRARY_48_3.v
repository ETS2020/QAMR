...
module FAU ( 
  ...
  oai21  g084(.a(new_n117_), .b(new_n104_), .c(new_n37_), .O(z2));
  ...
  nand3  g088(.a(new_n98_), .b(new_n66_), .c(new_n34_), .O(new_n122_));
  nand4  g089(.a(new_n74_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n123_));
  ...
  nand3  g093(.a(new_n98_), .b(x07), .c(new_n34_), .O(new_n127_));
  nand4  g094(.a(new_n74_), .b(new_n36_), .c(new_n35_), .d(new_n66_), .O(new_n128_));
  ...
  nand4  g098(.a(new_n34_), .b(new_n131_), .c(new_n104_), .d(x00), .O(new_n132_));
  nand3  g099(.a(new_n120_), .b(x21), .c(x20), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n119_), .c(new_n132_), .d(new_n128_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n40_), .c(new_n49_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n130_), .c(new_n125_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n48_), .O(new_n137_));
  nand2  g104(.a(new_n130_), .b(new_n125_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n72_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n137_), .O(z3));
  inv1   g107(.a(x15), .O(new_n141_));
  xnor2a g108(.a(x13), .b(x05), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(x02), .O(new_n143_));
  oai21  g110(.a(new_n62_), .b(x04), .c(x17), .O(new_n144_));
  nand3  g111(.a(new_n144_), .b(x13), .c(x05), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n143_), .c(new_n141_), .O(new_n146_));
  nand4  g113(.a(new_n144_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n147_));
  inv1   g114(.a(new_n147_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n146_), .c(x22), .O(new_n149_));
  nand3  g116(.a(x15), .b(x13), .c(x05), .O(new_n150_));
  nand3  g117(.a(x21), .b(new_n49_), .c(new_n48_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n67_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n149_), .c(new_n71_), .O(new_n154_));
  nand3  g121(.a(new_n49_), .b(new_n48_), .c(x00), .O(new_n155_));
  nand3  g122(.a(x19), .b(x13), .c(x05), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  aoi21  g124(.a(new_n75_), .b(x04), .c(x09), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x16), .c(new_n66_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand4  g127(.a(new_n61_), .b(x19), .c(x17), .d(new_n71_), .O(new_n161_));
  oai21  g128(.a(new_n141_), .b(x08), .c(new_n161_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(x13), .c(x05), .O(new_n163_));
  nand3  g130(.a(x21), .b(new_n66_), .c(new_n48_), .O(new_n164_));
  nand4  g131(.a(new_n61_), .b(x17), .c(new_n71_), .d(x00), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n49_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n163_), .c(new_n160_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n154_), .c(new_n40_), .O(new_n169_));
  inv1   g136(.a(x07), .O(new_n170_));
  aoi21  g137(.a(new_n144_), .b(x22), .c(new_n67_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n71_), .c(x08), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(x18), .O(new_n173_));
  aoi21  g140(.a(new_n62_), .b(x04), .c(x17), .O(new_n174_));
  oai21  g141(.a(new_n174_), .b(x22), .c(new_n67_), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(new_n71_), .c(x08), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n170_), .c(new_n173_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n81_), .c(x24), .O(new_n178_));
  nand4  g145(.a(new_n80_), .b(new_n61_), .c(x19), .d(new_n71_), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(new_n48_), .c(new_n72_), .O(new_n180_));
  nand2  g147(.a(new_n159_), .b(x19), .O(new_n181_));
  nand2  g148(.a(new_n172_), .b(x15), .O(new_n182_));
  aoi21  g149(.a(new_n182_), .b(new_n181_), .c(x13), .O(new_n183_));
  aoi21  g150(.a(new_n183_), .b(new_n38_), .c(new_n180_), .O(new_n184_));
  nand3  g151(.a(new_n184_), .b(new_n178_), .c(new_n169_), .O(z4));
  inv1   g152(.a(new_n156_), .O(new_n186_));
  nand3  g153(.a(new_n61_), .b(x17), .c(new_n71_), .O(new_n187_));
  aoi21  g154(.a(new_n187_), .b(x02), .c(x10), .O(new_n188_));
  aoi21  g155(.a(new_n188_), .b(x00), .c(new_n186_), .O(new_n189_));
  nor2   g156(.a(new_n80_), .b(new_n40_), .O(new_n190_));
  nand2  g157(.a(new_n45_), .b(new_n37_), .O(new_n191_));
  aoi21  g158(.a(new_n190_), .b(x07), .c(new_n191_), .O(new_n192_));
  oai21  g159(.a(new_n189_), .b(x24), .c(new_n192_), .O(z5));
  nand2  g160(.a(x20), .b(new_n36_), .O(new_n194_));
  aoi21  g161(.a(new_n194_), .b(new_n34_), .c(x11), .O(new_n195_));
  nand3  g162(.a(new_n50_), .b(new_n45_), .c(new_n43_), .O(new_n196_));
  oai22  g163(.a(new_n196_), .b(new_n42_), .c(new_n195_), .d(x03), .O(new_n197_));
  nand2  g164(.a(new_n74_), .b(x14), .O(new_n198_));
  aoi21  g165(.a(new_n198_), .b(x06), .c(new_n35_), .O(new_n199_));
  oai21  g166(.a(new_n199_), .b(new_n131_), .c(new_n114_), .O(new_n200_));
  nand3  g167(.a(new_n200_), .b(new_n197_), .c(new_n37_), .O(z6));
  and2   g168(.a(new_n110_), .b(new_n109_), .O(new_n202_));
  nand4  g169(.a(new_n202_), .b(new_n111_), .c(new_n108_), .d(new_n37_), .O(z7));
endmodule
