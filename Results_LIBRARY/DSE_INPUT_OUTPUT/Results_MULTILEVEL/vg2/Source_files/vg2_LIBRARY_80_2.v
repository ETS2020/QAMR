...
module FAU ( 
  ...
  nand4  g103(.a(new_n51_), .b(new_n37_), .c(new_n34_), .d(x00), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n56_), .c(new_n54_), .O(new_n138_));
  or2    g105(.a(new_n138_), .b(new_n53_), .O(new_n139_));
  ...
  nand4  g111(.a(new_n51_), .b(x21), .c(new_n37_), .d(new_n34_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n110_), .c(new_n109_), .O(new_n146_));
  or2    g113(.a(new_n146_), .b(new_n108_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g115(.a(new_n34_), .b(x01), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n148_), .c(new_n140_), .O(z4));
  nor2   g117(.a(new_n57_), .b(new_n53_), .O(new_n151_));
  nand3  g118(.a(new_n51_), .b(new_n37_), .c(x00), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n35_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n34_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n151_), .O(z5));
  ...
  nand2  g125(.a(new_n48_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n41_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n47_), .c(new_n147_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n158_), .c(new_n149_), .O(z6));
  nor2   g129(.a(new_n111_), .b(new_n108_), .O(new_n163_));
  nand3  g130(.a(new_n51_), .b(x21), .c(new_n37_), .O(new_n164_));
