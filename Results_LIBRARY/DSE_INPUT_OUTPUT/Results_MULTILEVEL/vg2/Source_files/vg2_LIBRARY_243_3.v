...
module FAU ( 
  ...
  and2   g144(.a(new_n166_), .b(new_n123_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n122_), .c(new_n121_), .O(new_n179_));
  oai21  g146(.a(new_n177_), .b(new_n34_), .c(new_n179_), .O(new_n180_));
  nand3  g147(.a(new_n180_), .b(new_n175_), .c(new_n156_), .O(z6));
  nand4  g148(.a(new_n178_), .b(new_n156_), .c(new_n122_), .d(new_n121_), .O(z7));
endmodule
