...
module FAU ( 
  ...
  nand2  g119(.a(x02), .b(new_n69_), .O(new_n153_));
  ...
  oai21  g129(.a(new_n162_), .b(new_n121_), .c(new_n153_), .O(new_n163_));
  ...
  nand4  g134(.a(new_n167_), .b(new_n153_), .c(new_n45_), .d(new_n44_), .O(z5));
  ...
  nand3  g142(.a(new_n175_), .b(new_n172_), .c(new_n153_), .O(z6));
  nand4  g143(.a(new_n153_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n177_));
