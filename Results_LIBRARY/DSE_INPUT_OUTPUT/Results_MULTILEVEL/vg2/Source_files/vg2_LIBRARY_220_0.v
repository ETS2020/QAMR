...
module FAU ( 
  ...
  nand4  g092(.a(new_n108_), .b(x08), .c(x06), .d(x03), .O(new_n126_));
  nor2   g093(.a(new_n37_), .b(new_n36_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n111_), .c(x20), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(new_n126_), .c(x01), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n54_), .O(new_n130_));
  nand3  g097(.a(new_n58_), .b(x03), .c(x01), .O(new_n131_));
  nand3  g098(.a(new_n127_), .b(x20), .c(x15), .O(new_n132_));
  nand3  g099(.a(new_n80_), .b(new_n34_), .c(new_n107_), .O(new_n133_));
  ...
  nand2  g102(.a(new_n135_), .b(new_n91_), .O(new_n136_));
  nand3  g103(.a(new_n127_), .b(x20), .c(x18), .O(new_n137_));
  nand4  g104(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n107_), .O(new_n138_));
  nand4  g105(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n57_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n131_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n89_), .c(x24), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n136_), .c(new_n130_), .O(z3));
  inv1   g109(.a(x22), .O(new_n143_));
  oai21  g110(.a(x23), .b(new_n55_), .c(new_n99_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n143_), .c(x09), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x16), .c(new_n57_), .O(new_n146_));
  nor2   g113(.a(x02), .b(x01), .O(new_n147_));
  inv1   g114(.a(new_n147_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n49_), .O(new_n149_));
  ...
  nand2  g119(.a(z5), .b(new_n146_), .O(new_n153_));
  ...
  nand2  g123(.a(new_n148_), .b(new_n121_), .O(new_n157_));
  nand4  g124(.a(new_n111_), .b(new_n108_), .c(new_n54_), .d(x01), .O(new_n158_));
  ...
  nand3  g130(.a(new_n150_), .b(new_n54_), .c(x00), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n47_), .c(new_n44_), .d(new_n43_), .O(new_n165_));
  oai21  g132(.a(new_n163_), .b(x03), .c(new_n165_), .O(new_n166_));
  oai21  g133(.a(x20), .b(new_n37_), .c(x06), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(x11), .c(x03), .O(new_n168_));
  oai21  g135(.a(x03), .b(new_n107_), .c(new_n168_), .O(new_n169_));
  nand3  g136(.a(new_n111_), .b(new_n108_), .c(new_n54_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand3  g139(.a(new_n121_), .b(new_n34_), .c(x02), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n172_), .c(new_n166_), .d(new_n148_), .O(z6));
endmodule
