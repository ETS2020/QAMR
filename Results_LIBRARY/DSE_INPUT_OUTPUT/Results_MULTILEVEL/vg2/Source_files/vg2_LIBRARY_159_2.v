...
module FAU ( 
  ...
  oai21  g118(.a(new_n147_), .b(x08), .c(z5), .O(new_n152_));
  ...
  aoi21  g130(.a(x20), .b(new_n42_), .c(x06), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(x11), .c(new_n48_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(z5), .O(new_n166_));
  aoi21  g133(.a(new_n43_), .b(x14), .c(new_n36_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n41_), .c(x03), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n161_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n166_), .O(z6));
  oai21  g137(.a(new_n159_), .b(x01), .c(new_n34_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n157_), .O(z7));
endmodule
