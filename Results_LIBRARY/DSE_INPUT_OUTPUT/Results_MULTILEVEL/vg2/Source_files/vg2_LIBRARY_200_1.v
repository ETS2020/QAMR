...
module FAU ( 
  ...
  nand2  g138(.a(new_n121_), .b(new_n35_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n75_), .c(x18), .O(new_n174_));
  inv1   g141(.a(new_n174_), .O(new_n175_));
  nor3   g142(.a(new_n115_), .b(x03), .c(new_n92_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n175_), .c(x24), .O(new_n177_));
  nand2  g144(.a(x24), .b(new_n35_), .O(new_n178_));
  nand3  g145(.a(new_n178_), .b(new_n47_), .c(new_n39_), .O(new_n179_));
  nand2  g146(.a(new_n179_), .b(new_n76_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(x15), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n116_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n170_), .c(x11), .O(new_n183_));
  inv1   g150(.a(new_n121_), .O(new_n184_));
  nand3  g151(.a(new_n41_), .b(x21), .c(new_n45_), .O(new_n185_));
  nand2  g152(.a(new_n185_), .b(new_n115_), .O(new_n186_));
  ...
  nand3  g156(.a(new_n189_), .b(new_n41_), .c(x15), .O(new_n190_));
  nand2  g157(.a(new_n190_), .b(new_n187_), .O(new_n191_));
  aoi21  g158(.a(new_n191_), .b(new_n35_), .c(new_n184_), .O(new_n192_));
  nand4  g159(.a(new_n192_), .b(new_n183_), .c(new_n177_), .d(new_n169_), .O(z6));
endmodule
