...
module FAU ( 
  ...
  oai21  g020(.a(new_n72_), .b(x13), .c(x19), .O(new_n73_));
  ...
  nand4  g027(.a(new_n79_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n80_));
  ...
  nand4  g031(.a(new_n83_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n84_));
  ...
  nand4  g037(.a(new_n89_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n90_));
  ...
  oai21  g050(.a(new_n102_), .b(x13), .c(x19), .O(new_n103_));
  ...
  nand4  g062(.a(new_n114_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n115_));
  ...
  oai21  g070(.a(new_n122_), .b(x13), .c(x19), .O(new_n123_));
  ...
  oai21  g075(.a(x24), .b(new_n55_), .c(new_n127_), .O(new_n128_));
  nand4  g076(.a(new_n128_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n129_));
  nand2  g077(.a(new_n120_), .b(new_n59_), .O(new_n130_));
  ...
  oai21  g083(.a(new_n135_), .b(x13), .c(x19), .O(new_n136_));
  ...
  nand3  g093(.a(new_n145_), .b(x18), .c(new_n54_), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n53_), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(x19), .O(new_n148_));
  oai21  g096(.a(x34), .b(x19), .c(new_n148_), .O(z14));
  ...
  oai21  g100(.a(new_n152_), .b(x13), .c(x19), .O(new_n153_));
  nand2  g101(.a(new_n145_), .b(new_n59_), .O(new_n154_));
