...
module FAU ( 
  ...
  nand4  g020(.a(new_n72_), .b(x19), .c(new_n53_), .d(x12), .O(new_n73_));
  ...
  nand4  g026(.a(new_n78_), .b(x19), .c(new_n53_), .d(x12), .O(new_n79_));
  ...
  oai21  g032(.a(new_n84_), .b(new_n62_), .c(x19), .O(new_n85_));
  ...
  nand4  g038(.a(new_n90_), .b(x19), .c(new_n53_), .d(x12), .O(new_n91_));
  nand2  g039(.a(new_n82_), .b(new_n58_), .O(new_n92_));
  ...
  oai21  g045(.a(new_n97_), .b(new_n62_), .c(x19), .O(new_n98_));
  inv1   g046(.a(x26), .O(new_n99_));
  nand2  g047(.a(new_n99_), .b(new_n58_), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(new_n98_), .O(z06));
  nand2  g049(.a(new_n54_), .b(x04), .O(new_n102_));
  nand2  g050(.a(new_n59_), .b(x18), .O(new_n103_));
  aoi21  g051(.a(new_n103_), .b(new_n102_), .c(x17), .O(new_n104_));
  oai21  g052(.a(new_n104_), .b(new_n62_), .c(x19), .O(new_n105_));
  ...
  oai21  g071(.a(new_n123_), .b(new_n62_), .c(x19), .O(new_n124_));
  ...
  oai21  g085(.a(new_n137_), .b(new_n62_), .c(x19), .O(new_n138_));
  ...
  oai21  g093(.a(new_n145_), .b(new_n62_), .c(x19), .O(new_n146_));
  ...
  aoi21  g099(.a(new_n151_), .b(new_n149_), .c(x17), .O(new_n152_));
  oai21  g100(.a(new_n152_), .b(new_n62_), .c(x19), .O(new_n153_));
  nand2  g101(.a(new_n143_), .b(new_n58_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n153_), .O(z14));
  aoi21  g103(.a(x28), .b(x18), .c(x17), .O(new_n156_));
  oai21  g104(.a(new_n156_), .b(new_n62_), .c(x19), .O(new_n157_));
  oai21  g105(.a(x35), .b(x19), .c(new_n157_), .O(z15));
endmodule
