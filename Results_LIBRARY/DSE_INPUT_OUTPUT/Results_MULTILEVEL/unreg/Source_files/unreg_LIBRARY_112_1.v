...
module FAU ( 
  ...
  inv1   g009(.a(x25), .O(new_n62_));
  nand3  g010(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(new_n63_));
  ...
  nand3  g017(.a(new_n62_), .b(new_n56_), .c(new_n60_), .O(new_n70_));
  ...
  oai21  g024(.a(x25), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g042(.a(new_n94_), .b(new_n93_), .c(new_n53_), .O(new_n95_));
  nand2  g043(.a(new_n95_), .b(x19), .O(z05));
  ...
  oai21  g050(.a(new_n102_), .b(x25), .c(new_n60_), .O(new_n103_));
  ...
  oai21  g056(.a(new_n98_), .b(x25), .c(new_n60_), .O(new_n109_));
  ...
  oai21  g064(.a(new_n116_), .b(x25), .c(new_n60_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n112_), .b(new_n62_), .c(new_n60_), .O(new_n124_));
  ...
  oai21  g092(.a(new_n144_), .b(x25), .c(new_n60_), .O(new_n145_));
  ...
  nand3  g099(.a(new_n140_), .b(new_n62_), .c(new_n60_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n148_), .b(new_n62_), .c(new_n60_), .O(new_n159_));
  ...
  oai21  g112(.a(new_n155_), .b(x25), .c(new_n60_), .O(new_n165_));
