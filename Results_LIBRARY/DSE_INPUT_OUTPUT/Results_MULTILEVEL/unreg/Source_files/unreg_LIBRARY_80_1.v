...
module FAU ( 
  ...
  nand3  g080(.a(new_n62_), .b(new_n122_), .c(new_n60_), .O(new_n133_));
  ...
  nand3  g086(.a(new_n62_), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  ...
  nand3  g107(.a(new_n149_), .b(new_n62_), .c(new_n60_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n156_), .b(x33), .c(new_n60_), .O(new_n166_));
