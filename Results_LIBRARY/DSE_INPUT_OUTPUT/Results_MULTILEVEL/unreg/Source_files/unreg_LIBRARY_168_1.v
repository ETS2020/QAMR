...
module FAU ( 
  ...
  nand2  g037(.a(new_n69_), .b(new_n60_), .O(new_n90_));
  nand2  g038(.a(new_n90_), .b(new_n89_), .O(z04));
  ...
  nand3  g044(.a(new_n86_), .b(new_n69_), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n93_), .b(new_n69_), .c(new_n60_), .O(new_n104_));
  ...
  nand3  g072(.a(new_n113_), .b(new_n69_), .c(new_n60_), .O(new_n125_));
  ...
  nand2  g082(.a(new_n69_), .b(x18), .O(new_n135_));
