...
module FAU ( 
  ...
  nand4  g026(.a(new_n78_), .b(x19), .c(new_n53_), .d(x05), .O(new_n79_));
  ...
  nand2  g041(.a(new_n82_), .b(new_n58_), .O(new_n94_));
  nand2  g042(.a(new_n94_), .b(new_n93_), .O(z05));
  aoi21  g043(.a(x27), .b(x18), .c(x17), .O(new_n96_));
  ...
  nand4  g055(.a(new_n107_), .b(x19), .c(new_n53_), .d(x05), .O(new_n108_));
  ...
  nand4  g061(.a(new_n113_), .b(x19), .c(new_n53_), .d(x05), .O(new_n114_));
  ...
  nand4  g075(.a(new_n127_), .b(x19), .c(new_n53_), .d(x05), .O(new_n128_));
  ...
  nand4  g080(.a(new_n132_), .b(x19), .c(new_n53_), .d(x05), .O(new_n133_));
  ...
  nand4  g086(.a(new_n138_), .b(x19), .c(new_n53_), .d(x05), .O(new_n139_));
  ...
  nand2  g097(.a(new_n109_), .b(x18), .O(new_n150_));
