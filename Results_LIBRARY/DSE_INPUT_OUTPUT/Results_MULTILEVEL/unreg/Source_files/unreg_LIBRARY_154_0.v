...
module FAU ( 
  ...
  nand3  g024(.a(x26), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g030(.a(x26), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g038(.a(x26), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  nand2  g039(.a(new_n91_), .b(new_n89_), .O(z04));
  nand3  g040(.a(x19), .b(new_n54_), .c(x06), .O(new_n93_));
  nand2  g041(.a(new_n62_), .b(x18), .O(new_n94_));
  nand2  g042(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g043(.a(new_n95_), .b(new_n53_), .O(new_n96_));
  oai21  g044(.a(new_n62_), .b(new_n86_), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g056(.a(new_n100_), .b(x26), .c(new_n60_), .O(new_n109_));
  ...
  nand2  g091(.a(x32), .b(x26), .O(new_n144_));
  ...
  nand3  g099(.a(new_n140_), .b(x26), .c(new_n60_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n148_), .b(x26), .c(new_n60_), .O(new_n159_));
