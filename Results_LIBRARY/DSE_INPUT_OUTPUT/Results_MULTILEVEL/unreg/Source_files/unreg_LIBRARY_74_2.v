...
module FAU ( 
  ...
  oai21  g016(.a(new_n56_), .b(x16), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(new_n65_), .b(x16), .c(new_n60_), .O(new_n76_));
  nand2  g024(.a(new_n76_), .b(new_n75_), .O(z02));
  oai21  g025(.a(new_n54_), .b(x17), .c(x19), .O(new_n78_));
  nand2  g026(.a(new_n78_), .b(x16), .O(new_n79_));
  nand4  g027(.a(x19), .b(new_n54_), .c(new_n53_), .d(x00), .O(new_n80_));
  ...
  oai21  g044(.a(new_n84_), .b(x16), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n60_), .c(new_n88_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n113_), .b(new_n60_), .c(new_n88_), .O(new_n125_));
  ...
  oai21  g079(.a(new_n121_), .b(x16), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n60_), .c(new_n88_), .O(new_n146_));
  ...
  oai21  g100(.a(new_n141_), .b(x16), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g113(.a(new_n156_), .b(new_n60_), .c(new_n88_), .O(new_n166_));
