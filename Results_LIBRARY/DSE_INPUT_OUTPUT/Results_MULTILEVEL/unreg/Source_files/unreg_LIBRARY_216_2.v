...
module FAU ( 
  ...
  nand4  g020(.a(new_n72_), .b(x26), .c(x19), .d(new_n53_), .O(new_n73_));
  ...
  nand4  g026(.a(new_n78_), .b(x26), .c(x19), .d(new_n53_), .O(new_n79_));
  ...
  nand4  g030(.a(new_n82_), .b(x26), .c(x19), .d(new_n53_), .O(new_n83_));
  inv1   g031(.a(x24), .O(new_n84_));
  nand2  g032(.a(new_n84_), .b(new_n58_), .O(new_n85_));
  nand2  g033(.a(new_n85_), .b(new_n83_), .O(z04));
  nor2   g034(.a(x18), .b(x17), .O(new_n87_));
  aoi21  g035(.a(new_n87_), .b(x06), .c(new_n62_), .O(new_n88_));
  ...
  oai21  g062(.a(new_n114_), .b(new_n62_), .c(x19), .O(new_n115_));
  nand2  g063(.a(new_n104_), .b(new_n58_), .O(new_n116_));
  ...
  oai21  g069(.a(new_n121_), .b(new_n62_), .c(x19), .O(new_n122_));
  nand2  g070(.a(new_n112_), .b(new_n58_), .O(new_n123_));
  ...
  nand4  g080(.a(new_n132_), .b(x26), .c(x19), .d(new_n53_), .O(new_n133_));
  ...
  nand4  g086(.a(new_n138_), .b(x26), .c(x19), .d(new_n53_), .O(new_n139_));
  ...
  nand2  g102(.a(new_n144_), .b(new_n58_), .O(new_n155_));
