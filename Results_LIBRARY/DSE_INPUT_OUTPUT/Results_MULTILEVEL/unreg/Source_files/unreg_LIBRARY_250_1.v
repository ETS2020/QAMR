...
module FAU ( 
  ...
  oai21  g052(.a(x35), .b(new_n93_), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g058(.a(new_n97_), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g073(.a(new_n97_), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g086(.a(new_n97_), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  ...
  nand2  g113(.a(new_n97_), .b(new_n60_), .O(new_n166_));
