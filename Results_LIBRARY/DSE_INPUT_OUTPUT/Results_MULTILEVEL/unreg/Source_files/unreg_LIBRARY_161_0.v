...
module FAU ( 
  ...
  oai21  g030(.a(new_n73_), .b(new_n69_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g073(.a(new_n114_), .b(new_n69_), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g080(.a(new_n122_), .b(new_n60_), .c(x06), .O(new_n133_));
  ...
  oai21  g086(.a(new_n129_), .b(new_n69_), .c(new_n60_), .O(new_n139_));
  ...
  nand2  g093(.a(x32), .b(x06), .O(new_n146_));
  ...
  oai21  g101(.a(new_n142_), .b(new_n69_), .c(new_n60_), .O(new_n154_));
