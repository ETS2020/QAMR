...
module FAU ( 
  ...
  nand4  g39(.a(x19), .b(new_n67_), .c(new_n54_), .d(x09), .O(new_n92_));
  oai21  g40(.a(x30), .b(x19), .c(new_n92_), .O(z10));
  aoi21  g41(.a(new_n54_), .b(x08), .c(x18), .O(new_n94_));
  inv1   g42(.a(x31), .O(new_n95_));
  nand2  g43(.a(new_n95_), .b(new_n53_), .O(new_n96_));
  oai21  g44(.a(new_n94_), .b(new_n53_), .c(new_n96_), .O(z11));
  aoi21  g45(.a(new_n54_), .b(x15), .c(x18), .O(new_n98_));
  inv1   g46(.a(x32), .O(new_n99_));
  nand2  g47(.a(new_n99_), .b(new_n53_), .O(new_n100_));
  oai21  g48(.a(new_n98_), .b(new_n53_), .c(new_n100_), .O(z12));
  nand4  g49(.a(x19), .b(new_n67_), .c(new_n54_), .d(x14), .O(new_n102_));
  oai21  g50(.a(x33), .b(x19), .c(new_n102_), .O(z13));
  nand4  g51(.a(x19), .b(new_n67_), .c(new_n54_), .d(x13), .O(new_n104_));
