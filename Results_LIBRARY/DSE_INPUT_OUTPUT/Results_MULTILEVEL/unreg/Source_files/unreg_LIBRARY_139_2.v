...
module FAU ( 
  ...
  oai21  g024(.a(new_n66_), .b(x10), .c(new_n61_), .O(new_n77_));
  ...
  oai21  g094(.a(new_n146_), .b(x10), .c(new_n61_), .O(new_n147_));
  ...
  oai21  g101(.a(new_n142_), .b(x10), .c(new_n61_), .O(new_n154_));
  ...
  oai21  g108(.a(new_n150_), .b(x10), .c(new_n61_), .O(new_n161_));
  ...
  nand3  g114(.a(new_n157_), .b(new_n61_), .c(new_n60_), .O(new_n167_));
