...
module FAU ( 
  ...
  nand2  g29(.a(new_n77_), .b(new_n60_), .O(new_n82_));
  nand2  g30(.a(new_n82_), .b(new_n81_), .O(z07));
  inv1   g31(.a(x29), .O(new_n84_));
  nand2  g32(.a(new_n84_), .b(x19), .O(new_n85_));
  oai22  g33(.a(new_n85_), .b(new_n54_), .c(x28), .d(x19), .O(z08));
  inv1   g34(.a(x30), .O(new_n87_));
  nand2  g35(.a(new_n87_), .b(x19), .O(new_n88_));
  oai22  g36(.a(new_n88_), .b(new_n54_), .c(x29), .d(x19), .O(z09));
  inv1   g37(.a(x31), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(x19), .O(new_n91_));
  oai22  g39(.a(new_n91_), .b(new_n54_), .c(x30), .d(x19), .O(z10));
  inv1   g40(.a(x24), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(x19), .O(new_n94_));
  oai22  g42(.a(new_n94_), .b(new_n54_), .c(x31), .d(x19), .O(z11));
  inv1   g43(.a(x33), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(x19), .O(new_n97_));
  oai22  g45(.a(new_n97_), .b(new_n54_), .c(x32), .d(x19), .O(z12));
  oai21  g46(.a(x34), .b(x17), .c(x18), .O(new_n99_));
  nand2  g47(.a(new_n99_), .b(x19), .O(new_n100_));
  nand2  g48(.a(new_n96_), .b(new_n60_), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(new_n100_), .O(z13));
