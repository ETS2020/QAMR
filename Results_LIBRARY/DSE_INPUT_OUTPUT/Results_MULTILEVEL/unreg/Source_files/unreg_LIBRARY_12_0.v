...
module FAU ( 
  ...
  nand3  g009(.a(new_n61_), .b(new_n60_), .c(x15), .O(new_n62_));
  ...
  nand3  g024(.a(new_n65_), .b(new_n60_), .c(x15), .O(new_n77_));
  ...
  nand3  g030(.a(new_n73_), .b(new_n60_), .c(x15), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n60_), .c(x15), .O(new_n91_));
  ...
  oai21  g066(.a(new_n118_), .b(new_n69_), .c(new_n60_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n60_), .c(x15), .O(new_n126_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n60_), .c(x15), .O(new_n139_));
  ...
  nand3  g101(.a(new_n142_), .b(new_n60_), .c(x15), .O(new_n154_));
  ...
  nand3  g108(.a(new_n150_), .b(new_n60_), .c(x15), .O(new_n161_));
  ...
  nand3  g114(.a(new_n157_), .b(new_n60_), .c(x15), .O(new_n167_));
