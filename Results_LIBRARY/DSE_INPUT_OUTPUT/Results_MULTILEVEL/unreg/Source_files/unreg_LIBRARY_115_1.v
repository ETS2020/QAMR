...
module FAU ( 
  ...
  nand2  g044(.a(new_n69_), .b(new_n60_), .O(new_n97_));
  ...
  nand3  g057(.a(new_n100_), .b(new_n69_), .c(new_n60_), .O(new_n110_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n69_), .c(new_n60_), .O(new_n153_));
