...
module FAU ( 
  ...
  oai21  g032(.a(new_n84_), .b(x31), .c(x19), .O(new_n85_));
  ...
  oai21  g045(.a(new_n97_), .b(x31), .c(x19), .O(new_n98_));
  ...
  oai21  g052(.a(new_n104_), .b(x31), .c(x19), .O(new_n105_));
  ...
  oai21  g059(.a(new_n111_), .b(x31), .c(x19), .O(new_n112_));
  ...
  oai21  g075(.a(new_n127_), .b(x31), .c(x19), .O(new_n128_));
  nand2  g076(.a(new_n64_), .b(new_n59_), .O(new_n129_));
  ...
  oai21  g103(.a(new_n155_), .b(x31), .c(x19), .O(new_n156_));
