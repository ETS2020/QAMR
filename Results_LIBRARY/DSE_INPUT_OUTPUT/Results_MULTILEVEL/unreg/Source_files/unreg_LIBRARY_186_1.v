...
module FAU ( 
  ...
  nand4  g28(.a(new_n80_), .b(x19), .c(x18), .d(new_n61_), .O(new_n81_));
  ...
  nand4  g35(.a(new_n56_), .b(x19), .c(x18), .d(new_n61_), .O(new_n88_));
  ...
  nand2  g45(.a(new_n97_), .b(new_n55_), .O(new_n98_));
  ...
  nand2  g50(.a(new_n102_), .b(new_n55_), .O(new_n103_));
  ...
  nand4  g65(.a(new_n117_), .b(x19), .c(x18), .d(new_n61_), .O(new_n118_));
  ...
  nand2  g74(.a(new_n126_), .b(new_n55_), .O(new_n127_));
