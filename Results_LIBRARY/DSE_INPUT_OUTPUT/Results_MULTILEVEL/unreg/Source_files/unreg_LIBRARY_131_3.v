...
module FAU ( 
  ...
  oai21  g014(.a(new_n66_), .b(x33), .c(x19), .O(new_n67_));
  ...
  nand4  g020(.a(new_n72_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n73_));
  ...
  aoi21  g026(.a(new_n78_), .b(new_n53_), .c(x33), .O(new_n79_));
  ...
  oai21  g040(.a(new_n92_), .b(x33), .c(x19), .O(new_n93_));
  ...
  nand2  g047(.a(new_n90_), .b(new_n59_), .O(new_n100_));
  ...
  oai21  g059(.a(new_n111_), .b(x33), .c(x19), .O(new_n112_));
  ...
  oai21  g067(.a(new_n119_), .b(x33), .c(x19), .O(new_n120_));
  nand2  g068(.a(new_n109_), .b(new_n59_), .O(new_n121_));
  nand2  g069(.a(new_n121_), .b(new_n120_), .O(z09));
  nand2  g070(.a(new_n55_), .b(x09), .O(new_n123_));
  oai21  g071(.a(x31), .b(new_n55_), .c(new_n123_), .O(new_n124_));
  nand4  g072(.a(new_n124_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n125_));
  nand2  g073(.a(new_n117_), .b(new_n59_), .O(new_n126_));
  ...
  oai21  g078(.a(new_n130_), .b(x33), .c(x19), .O(new_n131_));
  inv1   g079(.a(x31), .O(new_n132_));
  nand2  g080(.a(new_n132_), .b(new_n59_), .O(new_n133_));
  nand2  g081(.a(new_n133_), .b(new_n131_), .O(z11));
  nor2   g082(.a(x18), .b(x15), .O(new_n135_));
  oai21  g083(.a(new_n135_), .b(x17), .c(new_n54_), .O(new_n136_));
  nand2  g084(.a(new_n136_), .b(x19), .O(new_n137_));
  oai21  g085(.a(x32), .b(x19), .c(new_n137_), .O(z12));
  inv1   g086(.a(x14), .O(new_n139_));
  nor2   g087(.a(x18), .b(new_n139_), .O(new_n140_));
  inv1   g088(.a(x34), .O(new_n141_));
  nand3  g089(.a(new_n141_), .b(x19), .c(x18), .O(new_n142_));
  inv1   g090(.a(new_n142_), .O(new_n143_));
  oai21  g091(.a(new_n143_), .b(new_n140_), .c(new_n53_), .O(new_n144_));
  aoi21  g092(.a(new_n144_), .b(x19), .c(x33), .O(z13));
  nand2  g093(.a(new_n55_), .b(x13), .O(new_n146_));
  oai21  g094(.a(x35), .b(new_n55_), .c(new_n146_), .O(new_n147_));
  nand4  g095(.a(new_n147_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n148_));
  nand2  g096(.a(new_n141_), .b(new_n59_), .O(new_n149_));
  ...
  oai21  g101(.a(new_n153_), .b(x33), .c(x19), .O(new_n154_));
