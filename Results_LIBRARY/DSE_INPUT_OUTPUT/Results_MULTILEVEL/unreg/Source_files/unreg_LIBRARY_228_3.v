...
module FAU ( 
  ...
  oai21  g052(.a(new_n104_), .b(new_n102_), .c(new_n77_), .O(new_n105_));
  ...
  nand4  g071(.a(new_n123_), .b(new_n78_), .c(x19), .d(new_n77_), .O(new_n124_));
  ...
  oai21  g077(.a(new_n129_), .b(x27), .c(x19), .O(new_n130_));
  ...
  oai21  g085(.a(new_n137_), .b(x27), .c(x19), .O(new_n138_));
  ...
  nand4  g091(.a(new_n143_), .b(new_n78_), .c(x19), .d(new_n77_), .O(new_n144_));
  ...
  nand4  g096(.a(new_n148_), .b(new_n78_), .c(x19), .d(new_n77_), .O(new_n149_));
