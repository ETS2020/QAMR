...
module FAU ( 
  ...
  nand4  g004(.a(new_n56_), .b(x24), .c(x19), .d(new_n53_), .O(new_n57_));
  ...
  nand2  g033(.a(new_n85_), .b(x24), .O(z04));
  ...
  oai21  g046(.a(new_n98_), .b(new_n68_), .c(x19), .O(new_n99_));
  ...
  nand4  g051(.a(new_n103_), .b(x24), .c(x19), .d(new_n53_), .O(new_n104_));
  nand2  g052(.a(new_n96_), .b(new_n58_), .O(new_n105_));
  ...
  nand4  g056(.a(new_n108_), .b(x24), .c(x19), .d(new_n53_), .O(new_n109_));
  ...
  nand2  g073(.a(new_n114_), .b(new_n58_), .O(new_n126_));
  nand2  g074(.a(new_n126_), .b(new_n125_), .O(z10));
  nand2  g075(.a(new_n53_), .b(x08), .O(new_n128_));
  nand3  g076(.a(x24), .b(x19), .c(new_n54_), .O(new_n129_));
  oai22  g077(.a(new_n129_), .b(new_n128_), .c(x31), .d(x19), .O(z11));
  ...
  nand4  g095(.a(new_n147_), .b(x24), .c(x19), .d(new_n53_), .O(new_n148_));
