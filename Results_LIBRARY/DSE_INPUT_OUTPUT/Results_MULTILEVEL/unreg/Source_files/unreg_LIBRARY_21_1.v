...
module FAU ( 
  ...
  nand3  g043(.a(new_n95_), .b(new_n76_), .c(new_n60_), .O(new_n96_));
  ...
  oai21  g050(.a(new_n91_), .b(x24), .c(new_n60_), .O(new_n103_));
  ...
  oai21  g056(.a(new_n99_), .b(x24), .c(new_n60_), .O(new_n109_));
  ...
  nand3  g064(.a(new_n116_), .b(new_n76_), .c(new_n60_), .O(new_n117_));
  ...
  oai21  g099(.a(new_n140_), .b(x24), .c(new_n60_), .O(new_n152_));
  ...
  nand3  g112(.a(new_n155_), .b(new_n76_), .c(new_n60_), .O(new_n165_));
