...
module FAU ( 
  ...
  aoi21  g025(.a(new_n77_), .b(new_n54_), .c(x12), .O(new_n78_));
  ...
  oai21  g039(.a(new_n91_), .b(x12), .c(x19), .O(new_n92_));
  ...
  oai21  g044(.a(x27), .b(new_n55_), .c(new_n96_), .O(new_n97_));
  nand4  g045(.a(new_n97_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n98_));
  ...
  oai21  g051(.a(new_n103_), .b(x12), .c(x19), .O(new_n104_));
  ...
  nand4  g091(.a(new_n143_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n144_));
  ...
  oai21  g098(.a(new_n150_), .b(x12), .c(x19), .O(new_n151_));
  inv1   g099(.a(x34), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n59_), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(new_n151_), .O(z14));
  nand2  g102(.a(new_n54_), .b(new_n53_), .O(new_n155_));
  nand3  g103(.a(new_n111_), .b(x19), .c(x18), .O(new_n156_));
  oai22  g104(.a(new_n156_), .b(new_n155_), .c(x35), .d(x19), .O(z15));
endmodule
