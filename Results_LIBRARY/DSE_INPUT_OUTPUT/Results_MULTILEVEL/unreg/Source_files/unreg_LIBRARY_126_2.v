...
module FAU ( 
  ...
  nand4  g029(.a(new_n81_), .b(x35), .c(x19), .d(new_n78_), .O(new_n82_));
  ...
  nand4  g086(.a(new_n138_), .b(x35), .c(x19), .d(new_n78_), .O(new_n139_));
  ...
  nand4  g092(.a(new_n144_), .b(x35), .c(x19), .d(new_n78_), .O(new_n145_));
  ...
  nand3  g103(.a(new_n155_), .b(x19), .c(new_n78_), .O(new_n156_));
