...
module FAU ( 
  ...
  nand3  g024(.a(x28), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g045(.a(x28), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g058(.a(x28), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  nand2  g065(.a(new_n62_), .b(new_n60_), .O(new_n118_));
  nand2  g066(.a(new_n118_), .b(new_n117_), .O(z08));
  ...
  nand3  g072(.a(new_n114_), .b(x28), .c(new_n60_), .O(new_n125_));
  ...
  nand3  g085(.a(new_n128_), .b(x28), .c(new_n60_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(x28), .c(new_n60_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n141_), .b(x28), .c(new_n60_), .O(new_n153_));
  ...
  nand2  g110(.a(new_n62_), .b(x18), .O(new_n163_));
