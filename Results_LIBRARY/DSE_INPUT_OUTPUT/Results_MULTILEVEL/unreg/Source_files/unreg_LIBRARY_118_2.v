...
module FAU ( 
  ...
  inv1   g006(.a(x24), .O(new_n59_));
  nor2   g007(.a(x27), .b(new_n59_), .O(new_n60_));
  ...
  inv1   g030(.a(new_n60_), .O(new_n83_));
  ...
  inv1   g034(.a(x27), .O(new_n87_));
  oai21  g035(.a(new_n87_), .b(new_n59_), .c(new_n66_), .O(new_n88_));
  nand3  g036(.a(new_n88_), .b(new_n86_), .c(new_n83_), .O(z04));
  ...
  nor2   g041(.a(new_n93_), .b(new_n60_), .O(new_n94_));
  ...
  aoi22  g047(.a(new_n87_), .b(x24), .c(new_n99_), .d(new_n66_), .O(new_n100_));
  ...
  nand4  g051(.a(new_n103_), .b(new_n83_), .c(x19), .d(new_n53_), .O(new_n104_));
  nand3  g052(.a(new_n87_), .b(new_n59_), .c(new_n66_), .O(new_n105_));
  ...
  nor2   g064(.a(new_n116_), .b(new_n60_), .O(new_n117_));
  ...
  nand2  g070(.a(new_n122_), .b(new_n66_), .O(new_n123_));
  aoi21  g071(.a(new_n123_), .b(new_n121_), .c(new_n60_), .O(z10));
  inv1   g072(.a(x08), .O(new_n125_));
  aoi21  g073(.a(x27), .b(new_n54_), .c(new_n59_), .O(new_n126_));
  nand2  g074(.a(new_n59_), .b(x18), .O(new_n127_));
  oai21  g075(.a(new_n126_), .b(new_n125_), .c(new_n127_), .O(new_n128_));
  nand3  g076(.a(new_n128_), .b(x19), .c(new_n53_), .O(new_n129_));
  inv1   g077(.a(x31), .O(new_n130_));
  nand3  g078(.a(new_n83_), .b(new_n130_), .c(new_n66_), .O(new_n131_));
  ...
  aoi21  g097(.a(new_n149_), .b(new_n147_), .c(new_n60_), .O(z14));
