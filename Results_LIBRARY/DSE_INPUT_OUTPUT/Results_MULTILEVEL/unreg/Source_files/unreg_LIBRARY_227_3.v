...
module FAU ( 
  ...
  oai21  g014(.a(new_n66_), .b(x09), .c(x19), .O(new_n67_));
  ...
  oai21  g022(.a(new_n74_), .b(x09), .c(x19), .O(new_n75_));
  ...
  oai21  g058(.a(new_n110_), .b(x09), .c(x19), .O(new_n111_));
  ...
  nand3  g068(.a(new_n120_), .b(x18), .c(new_n54_), .O(new_n121_));
  nand2  g069(.a(new_n121_), .b(new_n53_), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(x19), .O(new_n123_));
  ...
  nand2  g075(.a(new_n120_), .b(new_n59_), .O(new_n128_));
  ...
  oai21  g087(.a(new_n139_), .b(x09), .c(x19), .O(new_n140_));
