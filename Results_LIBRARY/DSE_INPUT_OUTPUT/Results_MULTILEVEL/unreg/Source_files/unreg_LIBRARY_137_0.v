...
module FAU ( 
  ...
  nand3  g009(.a(x34), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  nand3  g016(.a(x34), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  nand3  g023(.a(x34), .b(new_n65_), .c(new_n60_), .O(new_n76_));
  ...
  oai21  g045(.a(new_n82_), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g052(.a(x34), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g058(.a(x34), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  oai21  g066(.a(new_n82_), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  oai21  g073(.a(new_n82_), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  oai21  g080(.a(new_n82_), .b(new_n122_), .c(new_n60_), .O(new_n133_));
  ...
  oai21  g086(.a(new_n82_), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  ...
  oai21  g112(.a(new_n156_), .b(new_n82_), .c(new_n60_), .O(new_n165_));
