...
module FAU ( 
  ...
  nand2  g25(.a(new_n75_), .b(new_n55_), .O(new_n78_));
  inv1   g26(.a(x26), .O(new_n79_));
  nand2  g27(.a(new_n79_), .b(x19), .O(new_n80_));
  oai21  g28(.a(new_n80_), .b(new_n62_), .c(new_n78_), .O(z05));
  nand2  g29(.a(new_n79_), .b(new_n55_), .O(new_n82_));
  inv1   g30(.a(x27), .O(new_n83_));
  nand2  g31(.a(new_n83_), .b(x19), .O(new_n84_));
  oai21  g32(.a(new_n84_), .b(new_n62_), .c(new_n82_), .O(z06));
  ...
  oai21  g59(.a(new_n111_), .b(new_n62_), .c(new_n109_), .O(z12));
  oai21  g60(.a(x34), .b(x17), .c(x18), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(x19), .O(new_n114_));
  nand2  g62(.a(new_n110_), .b(new_n55_), .O(new_n115_));
