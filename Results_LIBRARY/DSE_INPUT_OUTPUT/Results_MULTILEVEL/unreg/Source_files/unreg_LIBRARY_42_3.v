...
module FAU ( 
  ...
  oai21  g020(.a(new_n72_), .b(x24), .c(x19), .O(new_n73_));
  ...
  aoi21  g027(.a(new_n79_), .b(new_n53_), .c(x24), .O(new_n80_));
  ...
  oai21  g034(.a(new_n86_), .b(x24), .c(x19), .O(new_n87_));
  nand2  g035(.a(new_n54_), .b(new_n59_), .O(new_n88_));
  ...
  oai21  g041(.a(new_n93_), .b(x24), .c(x19), .O(new_n94_));
  nand2  g042(.a(new_n84_), .b(new_n59_), .O(new_n95_));
  ...
  oai21  g048(.a(new_n100_), .b(x24), .c(x19), .O(new_n101_));
  ...
  oai21  g066(.a(new_n118_), .b(x24), .c(x19), .O(new_n119_));
  ...
  oai21  g074(.a(new_n126_), .b(x24), .c(x19), .O(new_n127_));
  nand2  g075(.a(new_n116_), .b(new_n59_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n127_), .O(z10));
  inv1   g077(.a(x08), .O(new_n130_));
  nand2  g078(.a(new_n55_), .b(new_n130_), .O(new_n131_));
  ...
  oai21  g085(.a(new_n137_), .b(x24), .c(x19), .O(new_n138_));
  ...
  oai21  g093(.a(new_n145_), .b(x24), .c(x19), .O(new_n146_));
  ...
  oai21  g097(.a(x35), .b(new_n55_), .c(new_n149_), .O(new_n150_));
