...
module FAU ( 
  ...
  aoi21  g29(.a(new_n53_), .b(x11), .c(x18), .O(new_n82_));
  inv1   g30(.a(x28), .O(new_n83_));
  nand2  g31(.a(new_n83_), .b(new_n57_), .O(new_n84_));
  oai21  g32(.a(new_n82_), .b(new_n57_), .c(new_n84_), .O(z08));
  ...
  aoi21  g37(.a(new_n53_), .b(x09), .c(x18), .O(new_n90_));
  inv1   g38(.a(x30), .O(new_n91_));
  nand2  g39(.a(new_n91_), .b(new_n57_), .O(new_n92_));
  oai21  g40(.a(new_n90_), .b(new_n57_), .c(new_n92_), .O(z10));
  nand4  g41(.a(x19), .b(new_n54_), .c(new_n53_), .d(x08), .O(new_n94_));
