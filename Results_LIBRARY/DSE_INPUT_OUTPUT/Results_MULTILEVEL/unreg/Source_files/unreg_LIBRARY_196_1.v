...
module FAU ( 
  ...
  aoi21  g20(.a(new_n72_), .b(new_n53_), .c(new_n61_), .O(new_n73_));
  nand2  g21(.a(new_n69_), .b(new_n60_), .O(new_n74_));
  oai21  g22(.a(new_n73_), .b(new_n60_), .c(new_n74_), .O(z05));
  inv1   g23(.a(x27), .O(new_n76_));
  aoi21  g24(.a(new_n76_), .b(new_n53_), .c(new_n61_), .O(new_n77_));
  nand2  g25(.a(new_n72_), .b(new_n60_), .O(new_n78_));
  oai21  g26(.a(new_n77_), .b(new_n60_), .c(new_n78_), .O(z06));
  oai21  g27(.a(x20), .b(x17), .c(x18), .O(new_n80_));
  nand2  g28(.a(new_n80_), .b(x19), .O(new_n81_));
  nand2  g29(.a(new_n76_), .b(new_n60_), .O(new_n82_));
  ...
  nand2  g36(.a(new_n84_), .b(new_n60_), .O(new_n89_));
