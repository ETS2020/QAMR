...
module FAU ( 
  ...
  nand3  g024(.a(x34), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g038(.a(x34), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g052(.a(new_n62_), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  oai21  g058(.a(new_n62_), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  oai21  g066(.a(new_n62_), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  oai21  g073(.a(new_n62_), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  oai21  g080(.a(new_n62_), .b(new_n122_), .c(new_n60_), .O(new_n133_));
  ...
  nand3  g086(.a(x34), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  ...
  nand2  g107(.a(new_n62_), .b(new_n60_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n156_), .b(x34), .c(new_n60_), .O(new_n166_));
