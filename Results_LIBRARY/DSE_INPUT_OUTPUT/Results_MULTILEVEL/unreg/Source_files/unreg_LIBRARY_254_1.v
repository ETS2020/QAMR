...
module FAU ( 
  ...
  nor2   g007(.a(new_n59_), .b(x23), .O(new_n60_));
  ...
  oai21  g028(.a(x26), .b(new_n79_), .c(new_n80_), .O(new_n81_));
  nand2  g029(.a(new_n81_), .b(new_n78_), .O(z03));
  ...
  nor2   g034(.a(new_n86_), .b(new_n60_), .O(new_n87_));
  ...
  oai21  g042(.a(new_n80_), .b(new_n79_), .c(x26), .O(new_n95_));
  ...
  nand2  g046(.a(new_n59_), .b(new_n79_), .O(new_n99_));
  ...
  nor2   g052(.a(new_n104_), .b(new_n60_), .O(new_n105_));
  ...
  aoi21  g058(.a(new_n110_), .b(new_n79_), .c(new_n60_), .O(new_n111_));
  ...
  nand2  g066(.a(new_n118_), .b(new_n79_), .O(new_n119_));
  ...
  aoi21  g071(.a(new_n114_), .b(new_n79_), .c(new_n60_), .O(new_n124_));
  ...
  nand2  g085(.a(new_n137_), .b(new_n79_), .O(new_n138_));
  ...
  aoi21  g090(.a(new_n133_), .b(new_n79_), .c(new_n60_), .O(new_n143_));
  ...
  nand2  g098(.a(new_n150_), .b(new_n79_), .O(new_n151_));
  aoi21  g099(.a(new_n151_), .b(new_n149_), .c(new_n60_), .O(z14));
  ...
  nand2  g104(.a(new_n146_), .b(new_n79_), .O(new_n157_));
  aoi21  g105(.a(new_n157_), .b(new_n156_), .c(new_n60_), .O(z15));
endmodule
