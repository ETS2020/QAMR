...
module FAU ( 
  ...
  oai21  g024(.a(x32), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g030(.a(x32), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g106(.a(new_n147_), .b(new_n62_), .c(new_n60_), .O(new_n159_));
