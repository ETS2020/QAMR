...
module FAU ( 
  ...
  oai21  g009(.a(new_n61_), .b(x15), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g024(.a(new_n65_), .b(x15), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g066(.a(new_n118_), .b(x15), .c(new_n60_), .O(new_n119_));
  ...
  oai21  g080(.a(new_n122_), .b(x15), .c(new_n60_), .O(new_n133_));
  ...
  oai21  g100(.a(new_n145_), .b(x15), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n149_), .b(new_n60_), .c(new_n69_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n156_), .b(new_n60_), .c(new_n69_), .O(new_n166_));
