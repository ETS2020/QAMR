...
module FAU ( 
  ...
  nand4  g028(.a(new_n80_), .b(x19), .c(new_n53_), .d(x05), .O(new_n81_));
  ...
  nand4  g040(.a(new_n92_), .b(x19), .c(new_n53_), .d(x05), .O(new_n93_));
  ...
  nand4  g048(.a(new_n100_), .b(x19), .c(new_n53_), .d(x05), .O(new_n101_));
  ...
  oai21  g056(.a(new_n108_), .b(new_n62_), .c(x19), .O(new_n109_));
  ...
  oai21  g064(.a(new_n116_), .b(new_n62_), .c(x19), .O(new_n117_));
  ...
  nand2  g072(.a(new_n114_), .b(new_n58_), .O(new_n125_));
  nand2  g073(.a(new_n125_), .b(new_n124_), .O(z10));
  nand2  g074(.a(new_n54_), .b(x08), .O(new_n127_));
  nand2  g075(.a(new_n88_), .b(x18), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(new_n127_), .c(x17), .O(new_n129_));
  oai21  g077(.a(new_n129_), .b(new_n62_), .c(x19), .O(new_n130_));
  ...
  nand4  g082(.a(new_n134_), .b(x19), .c(new_n53_), .d(x05), .O(new_n135_));
  ...
  nand4  g088(.a(new_n140_), .b(x19), .c(new_n53_), .d(x05), .O(new_n141_));
