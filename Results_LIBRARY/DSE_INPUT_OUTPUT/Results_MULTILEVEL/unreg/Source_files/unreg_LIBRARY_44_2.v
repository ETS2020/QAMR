...
module FAU ( 
  ...
  aoi21  g057(.a(x34), .b(new_n57_), .c(new_n109_), .O(new_n110_));
  oai22  g058(.a(new_n110_), .b(new_n108_), .c(x29), .d(new_n57_), .O(new_n111_));
  nand3  g059(.a(new_n111_), .b(x19), .c(new_n56_), .O(new_n112_));
  inv1   g060(.a(x28), .O(new_n113_));
  nand3  g061(.a(new_n54_), .b(new_n113_), .c(new_n61_), .O(new_n114_));
  nand2  g062(.a(new_n114_), .b(new_n112_), .O(z08));
  oai21  g063(.a(new_n53_), .b(new_n61_), .c(x29), .O(new_n116_));
  nand3  g064(.a(new_n116_), .b(new_n57_), .c(x10), .O(new_n117_));
  inv1   g065(.a(x30), .O(new_n118_));
  nand4  g066(.a(new_n54_), .b(new_n118_), .c(x19), .d(x18), .O(new_n119_));
  ...
  nand2  g090(.a(new_n53_), .b(new_n109_), .O(new_n143_));
  aoi21  g091(.a(new_n143_), .b(new_n142_), .c(new_n141_), .O(new_n144_));
  nand3  g092(.a(new_n53_), .b(new_n109_), .c(x18), .O(new_n145_));
  ...
  oai21  g101(.a(x29), .b(new_n61_), .c(new_n53_), .O(new_n154_));
