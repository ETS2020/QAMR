...
module FAU ( 
  ...
  oai21  g024(.a(x33), .b(new_n65_), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g038(.a(x33), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g058(.a(x33), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g066(.a(new_n69_), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  oai21  g106(.a(new_n158_), .b(x33), .c(new_n60_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n154_), .b(new_n69_), .c(new_n60_), .O(new_n165_));
