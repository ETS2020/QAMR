...
module FAU ( 
  ...
  nand4  g23(.a(x19), .b(new_n59_), .c(new_n54_), .d(x04), .O(new_n76_));
  oai21  g24(.a(x27), .b(x19), .c(new_n76_), .O(z07));
  aoi21  g25(.a(new_n54_), .b(x11), .c(x18), .O(new_n78_));
  inv1   g26(.a(x28), .O(new_n79_));
  nand2  g27(.a(new_n79_), .b(new_n53_), .O(new_n80_));
  oai21  g28(.a(new_n78_), .b(new_n53_), .c(new_n80_), .O(z08));
  ...
  nand4  g45(.a(x19), .b(new_n59_), .c(new_n54_), .d(x14), .O(new_n98_));
  ...
  aoi21  g51(.a(new_n54_), .b(x12), .c(x18), .O(new_n104_));
  inv1   g52(.a(x35), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(new_n53_), .O(new_n106_));
  oai21  g54(.a(new_n104_), .b(new_n53_), .c(new_n106_), .O(z15));
endmodule
