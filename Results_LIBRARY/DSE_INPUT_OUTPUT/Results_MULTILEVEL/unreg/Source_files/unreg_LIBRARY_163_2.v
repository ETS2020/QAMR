...
module FAU ( 
  ...
  oai21  g024(.a(new_n65_), .b(x12), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g030(.a(new_n73_), .b(x12), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g038(.a(new_n90_), .b(x12), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g052(.a(new_n94_), .b(x12), .c(new_n60_), .O(new_n105_));
  ...
  oai21  g080(.a(new_n122_), .b(x12), .c(new_n60_), .O(new_n133_));
  ...
  oai21  g101(.a(new_n142_), .b(x12), .c(new_n60_), .O(new_n154_));
