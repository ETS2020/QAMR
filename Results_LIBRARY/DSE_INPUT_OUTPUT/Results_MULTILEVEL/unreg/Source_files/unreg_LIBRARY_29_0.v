...
module FAU ( 
  ...
  oai21  g024(.a(new_n69_), .b(new_n65_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g038(.a(x33), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  nand3  g045(.a(x33), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g052(.a(new_n69_), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  nand2  g089(.a(new_n69_), .b(x18), .O(new_n142_));
  ...
  nand3  g112(.a(new_n155_), .b(x33), .c(new_n60_), .O(new_n165_));
