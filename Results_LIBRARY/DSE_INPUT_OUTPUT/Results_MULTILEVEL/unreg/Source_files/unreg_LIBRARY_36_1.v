...
module FAU ( 
  ...
  oai21  g009(.a(x27), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g024(.a(x27), .b(new_n65_), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g030(.a(x27), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g038(.a(x27), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  nand2  g057(.a(new_n69_), .b(new_n60_), .O(new_n110_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n69_), .c(new_n60_), .O(new_n118_));
  ...
  oai21  g072(.a(new_n113_), .b(x27), .c(new_n60_), .O(new_n125_));
  ...
  nand3  g079(.a(new_n121_), .b(new_n69_), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n69_), .c(new_n60_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n69_), .c(new_n60_), .O(new_n146_));
  ...
  oai21  g100(.a(new_n141_), .b(x27), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n149_), .b(new_n69_), .c(new_n60_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n156_), .b(x27), .c(new_n60_), .O(new_n166_));
