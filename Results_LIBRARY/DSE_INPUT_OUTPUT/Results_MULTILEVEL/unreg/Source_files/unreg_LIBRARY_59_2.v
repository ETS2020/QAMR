...
module FAU ( 
  ...
  nand4  g021(.a(new_n73_), .b(x27), .c(x19), .d(new_n71_), .O(new_n74_));
  ...
  nand4  g027(.a(new_n79_), .b(x27), .c(x19), .d(new_n71_), .O(new_n80_));
  ...
  nand4  g031(.a(new_n83_), .b(x27), .c(x19), .d(new_n71_), .O(new_n84_));
  ...
  nand4  g037(.a(new_n89_), .b(x27), .c(x19), .d(new_n71_), .O(new_n90_));
  inv1   g038(.a(x25), .O(new_n91_));
  nand2  g039(.a(new_n91_), .b(new_n60_), .O(new_n92_));
  nand2  g040(.a(new_n92_), .b(new_n90_), .O(z05));
  nor2   g041(.a(x18), .b(x17), .O(new_n94_));
  aoi21  g042(.a(new_n94_), .b(x05), .c(new_n53_), .O(new_n95_));
  inv1   g043(.a(x26), .O(new_n96_));
  nand2  g044(.a(new_n96_), .b(new_n60_), .O(new_n97_));
  oai21  g045(.a(new_n95_), .b(new_n60_), .c(new_n97_), .O(z06));
  nand2  g046(.a(new_n54_), .b(x04), .O(new_n99_));
  oai21  g047(.a(x20), .b(new_n54_), .c(new_n99_), .O(new_n100_));
  nand4  g048(.a(new_n100_), .b(x27), .c(x19), .d(new_n71_), .O(new_n101_));
  nand2  g049(.a(new_n53_), .b(new_n60_), .O(new_n102_));
  ...
  nand2  g071(.a(new_n113_), .b(new_n60_), .O(new_n124_));
  ...
  nand4  g075(.a(new_n127_), .b(x27), .c(x19), .d(new_n71_), .O(new_n128_));
  nand2  g076(.a(new_n120_), .b(new_n60_), .O(new_n129_));
  ...
  nand2  g091(.a(new_n132_), .b(new_n60_), .O(new_n144_));
  ...
  nand2  g098(.a(new_n140_), .b(new_n60_), .O(new_n151_));
  ...
  oai21  g103(.a(new_n155_), .b(new_n53_), .c(x19), .O(new_n156_));
  nand2  g104(.a(new_n147_), .b(new_n60_), .O(new_n157_));
