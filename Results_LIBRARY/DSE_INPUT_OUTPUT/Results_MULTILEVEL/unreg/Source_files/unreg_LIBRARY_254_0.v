...
module FAU ( 
  ...
  nor2   g006(.a(x26), .b(x23), .O(new_n59_));
  ...
  inv1   g027(.a(x26), .O(new_n80_));
  oai21  g028(.a(new_n80_), .b(new_n78_), .c(new_n79_), .O(new_n81_));
  ...
  aoi21  g045(.a(new_n97_), .b(new_n95_), .c(new_n59_), .O(new_n98_));
  nand3  g046(.a(new_n98_), .b(x19), .c(new_n53_), .O(new_n99_));
  nand3  g047(.a(new_n80_), .b(x23), .c(new_n78_), .O(new_n100_));
  ...
  aoi22  g052(.a(new_n96_), .b(new_n78_), .c(new_n80_), .d(new_n79_), .O(new_n105_));
