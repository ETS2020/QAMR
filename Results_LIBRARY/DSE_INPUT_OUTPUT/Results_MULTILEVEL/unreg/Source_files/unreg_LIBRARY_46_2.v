...
module FAU ( 
  ...
  nand4  g028(.a(new_n80_), .b(x29), .c(x19), .d(new_n53_), .O(new_n81_));
  ...
  nand4  g038(.a(new_n90_), .b(x29), .c(x19), .d(new_n53_), .O(new_n91_));
  ...
  nand4  g044(.a(new_n96_), .b(x29), .c(x19), .d(new_n53_), .O(new_n97_));
  ...
  nor2   g055(.a(x18), .b(x17), .O(new_n108_));
  aoi21  g056(.a(new_n108_), .b(x11), .c(new_n62_), .O(new_n109_));
  inv1   g057(.a(x28), .O(new_n110_));
  nand2  g058(.a(new_n110_), .b(new_n58_), .O(new_n111_));
  oai21  g059(.a(new_n109_), .b(new_n58_), .c(new_n111_), .O(z08));
  ...
  nand4  g073(.a(new_n125_), .b(x29), .c(x19), .d(new_n53_), .O(new_n126_));
  ...
  nand4  g087(.a(new_n139_), .b(x29), .c(x19), .d(new_n53_), .O(new_n140_));
  nand2  g088(.a(new_n131_), .b(new_n58_), .O(new_n141_));
  ...
  oai21  g094(.a(new_n146_), .b(new_n62_), .c(x19), .O(new_n147_));
  ...
  nand4  g100(.a(new_n152_), .b(x29), .c(x19), .d(new_n53_), .O(new_n153_));
