...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n61_,
    ...
    new_n93_, new_n95_, new_n96_, new_n97_, new_n99_, new_n101_;
  ...
  aoi21  g08(.a(new_n53_), .b(x01), .c(x18), .O(new_n61_));
  inv1   g09(.a(x22), .O(new_n62_));
  nand2  g10(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  oai21  g11(.a(new_n61_), .b(new_n60_), .c(new_n63_), .O(z02));
  aoi21  g12(.a(new_n53_), .b(x00), .c(x18), .O(new_n65_));
  inv1   g13(.a(x23), .O(new_n66_));
  nand2  g14(.a(new_n66_), .b(new_n60_), .O(new_n67_));
  oai21  g15(.a(new_n65_), .b(new_n60_), .c(new_n67_), .O(z03));
  ...
  aoi21  g20(.a(new_n53_), .b(x05), .c(x18), .O(new_n73_));
  inv1   g21(.a(x26), .O(new_n74_));
  nand2  g22(.a(new_n74_), .b(new_n60_), .O(new_n75_));
  oai21  g23(.a(new_n73_), .b(new_n60_), .c(new_n75_), .O(z06));
  ...
  nand2  g28(.a(new_n80_), .b(new_n60_), .O(new_n81_));
  oai21  g29(.a(new_n79_), .b(new_n60_), .c(new_n81_), .O(z08));
  aoi21  g30(.a(new_n53_), .b(x10), .c(x18), .O(new_n83_));
  inv1   g31(.a(x29), .O(new_n84_));
  nand2  g32(.a(new_n84_), .b(new_n60_), .O(new_n85_));
  oai21  g33(.a(new_n83_), .b(new_n60_), .c(new_n85_), .O(z09));
  ...
  nand2  g38(.a(new_n90_), .b(new_n60_), .O(new_n91_));
  oai21  g39(.a(new_n89_), .b(new_n60_), .c(new_n91_), .O(z11));
  nand2  g40(.a(new_n53_), .b(x15), .O(new_n93_));
  oai22  g41(.a(new_n93_), .b(new_n56_), .c(x32), .d(x19), .O(z12));
  aoi21  g42(.a(new_n53_), .b(x14), .c(x18), .O(new_n95_));
  inv1   g43(.a(x33), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n60_), .O(new_n97_));
  oai21  g45(.a(new_n95_), .b(new_n60_), .c(new_n97_), .O(z13));
  nand2  g46(.a(new_n53_), .b(x13), .O(new_n99_));
  oai22  g47(.a(new_n99_), .b(new_n56_), .c(x34), .d(x19), .O(z14));
