...
module FAU ( 
  ...
  oai21  g050(.a(new_n93_), .b(new_n76_), .c(new_n60_), .O(new_n103_));
  ...
  oai21  g064(.a(new_n116_), .b(new_n76_), .c(new_n60_), .O(new_n117_));
  ...
  oai21  g078(.a(new_n120_), .b(new_n76_), .c(new_n60_), .O(new_n131_));
  ...
  oai21  g084(.a(new_n127_), .b(new_n76_), .c(new_n60_), .O(new_n137_));
  ...
  nand2  g091(.a(x32), .b(x25), .O(new_n144_));
  ...
  oai21  g106(.a(new_n148_), .b(new_n76_), .c(new_n60_), .O(new_n159_));
  ...
  oai21  g112(.a(new_n155_), .b(new_n76_), .c(new_n60_), .O(new_n165_));
