...
module FAU ( 
  ...
  inv1   g66(.a(x35), .O(new_n119_));
  nand2  g67(.a(new_n119_), .b(x19), .O(new_n120_));
  oai21  g68(.a(new_n120_), .b(new_n57_), .c(new_n118_), .O(z14));
  nand2  g69(.a(new_n119_), .b(new_n53_), .O(new_n122_));
  nand2  g70(.a(new_n91_), .b(x19), .O(new_n123_));
