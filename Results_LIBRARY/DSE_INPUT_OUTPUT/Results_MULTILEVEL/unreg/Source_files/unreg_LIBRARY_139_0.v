...
module FAU ( 
  ...
  nand3  g030(.a(new_n73_), .b(new_n60_), .c(x10), .O(new_n83_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n60_), .c(x10), .O(new_n119_));
  ...
  nand3  g114(.a(new_n157_), .b(new_n60_), .c(x10), .O(new_n167_));
