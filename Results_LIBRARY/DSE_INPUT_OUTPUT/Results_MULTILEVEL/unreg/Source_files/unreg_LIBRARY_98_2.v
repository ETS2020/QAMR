...
module FAU ( 
  ...
  nand4  g042(.a(new_n94_), .b(x28), .c(x19), .d(new_n78_), .O(new_n95_));
  ...
  nand4  g047(.a(new_n99_), .b(x28), .c(x19), .d(new_n78_), .O(new_n100_));
  ...
  nand3  g060(.a(new_n112_), .b(x19), .c(new_n78_), .O(new_n113_));
  nand2  g061(.a(new_n113_), .b(x28), .O(z08));
  nand2  g062(.a(new_n54_), .b(x10), .O(new_n115_));
  oai21  g063(.a(x30), .b(new_n54_), .c(new_n115_), .O(new_n116_));
  nand4  g064(.a(new_n116_), .b(x28), .c(x19), .d(new_n78_), .O(new_n117_));
  ...
  nand4  g070(.a(new_n122_), .b(x28), .c(x19), .d(new_n78_), .O(new_n123_));
  ...
  nand4  g076(.a(new_n128_), .b(x28), .c(x19), .d(new_n78_), .O(new_n129_));
  ...
  nand2  g100(.a(new_n142_), .b(new_n60_), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(new_n152_), .O(z14));
  nand2  g102(.a(new_n78_), .b(x12), .O(new_n155_));
  nand3  g103(.a(x28), .b(x19), .c(new_n54_), .O(new_n156_));
