...
module FAU ( 
  ...
  nand4  g26(.a(new_n78_), .b(x19), .c(x18), .d(new_n56_), .O(new_n79_));
  nand2  g27(.a(new_n79_), .b(new_n77_), .O(z05));
  oai21  g28(.a(x27), .b(x17), .c(x18), .O(new_n81_));
  nand2  g29(.a(new_n81_), .b(x19), .O(new_n82_));
  nand2  g30(.a(new_n78_), .b(new_n53_), .O(new_n83_));
  nand2  g31(.a(new_n83_), .b(new_n82_), .O(z06));
  ...
  nand4  g44(.a(new_n96_), .b(x19), .c(x18), .d(new_n56_), .O(new_n97_));
  ...
  nand2  g54(.a(new_n106_), .b(new_n104_), .O(z11));
  ...
  nand4  g68(.a(new_n120_), .b(x19), .c(x18), .d(new_n56_), .O(new_n121_));
