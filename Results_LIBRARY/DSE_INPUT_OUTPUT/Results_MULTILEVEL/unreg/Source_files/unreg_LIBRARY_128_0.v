...
module FAU ( 
  ...
  nand3  g017(.a(new_n56_), .b(new_n61_), .c(x13), .O(new_n70_));
  ...
  nand3  g024(.a(new_n66_), .b(new_n61_), .c(x13), .O(new_n77_));
  ...
  oai21  g030(.a(new_n73_), .b(new_n60_), .c(new_n61_), .O(new_n83_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n61_), .c(x13), .O(new_n98_));
  ...
  oai21  g058(.a(new_n101_), .b(new_n60_), .c(new_n61_), .O(new_n111_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n61_), .c(x13), .O(new_n119_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n61_), .c(x13), .O(new_n126_));
  ...
  oai21  g086(.a(new_n129_), .b(new_n60_), .c(new_n61_), .O(new_n139_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n61_), .c(x13), .O(new_n147_));
