...
module FAU ( 
  ...
  oai21  g052(.a(new_n82_), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g066(.a(x34), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  nand3  g080(.a(x34), .b(new_n122_), .c(new_n60_), .O(new_n133_));
