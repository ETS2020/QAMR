...
module FAU ( 
  ...
  nand4  g41(.a(new_n93_), .b(x19), .c(x18), .d(new_n71_), .O(new_n94_));
  ...
  nand2  g52(.a(new_n102_), .b(new_n55_), .O(new_n105_));
  nand4  g53(.a(new_n74_), .b(x19), .c(x18), .d(new_n71_), .O(new_n106_));
