...
module FAU ( 
  ...
  oai21  g020(.a(new_n72_), .b(x35), .c(x19), .O(new_n73_));
  ...
  aoi21  g027(.a(new_n79_), .b(new_n53_), .c(x35), .O(new_n80_));
  ...
  oai21  g055(.a(new_n107_), .b(x35), .c(x19), .O(new_n108_));
  ...
  oai21  g067(.a(x30), .b(new_n55_), .c(new_n119_), .O(new_n120_));
  ...
  oai21  g085(.a(x33), .b(new_n55_), .c(new_n137_), .O(new_n138_));
  nand4  g086(.a(new_n138_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n139_));
