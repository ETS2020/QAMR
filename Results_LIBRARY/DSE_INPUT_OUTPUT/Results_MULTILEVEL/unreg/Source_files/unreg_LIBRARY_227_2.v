...
module FAU ( 
  ...
  oai21  g017(.a(new_n56_), .b(x09), .c(new_n61_), .O(new_n70_));
  ...
  oai21  g024(.a(new_n66_), .b(x09), .c(new_n61_), .O(new_n77_));
  ...
  nand3  g052(.a(new_n94_), .b(new_n61_), .c(new_n60_), .O(new_n105_));
  ...
  oai21  g066(.a(new_n118_), .b(x09), .c(new_n61_), .O(new_n119_));
  ...
  oai21  g075(.a(x18), .b(x17), .c(x19), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(x09), .O(new_n129_));
  nand2  g077(.a(new_n122_), .b(new_n61_), .O(new_n130_));
  inv1   g078(.a(x31), .O(new_n131_));
  nand4  g079(.a(new_n131_), .b(x19), .c(x18), .d(new_n53_), .O(new_n132_));
  nand3  g080(.a(new_n132_), .b(new_n130_), .c(new_n129_), .O(z10));
  ...
  nand3  g085(.a(new_n131_), .b(new_n61_), .c(new_n60_), .O(new_n138_));
  ...
  oai21  g100(.a(new_n141_), .b(x09), .c(new_n61_), .O(new_n153_));
