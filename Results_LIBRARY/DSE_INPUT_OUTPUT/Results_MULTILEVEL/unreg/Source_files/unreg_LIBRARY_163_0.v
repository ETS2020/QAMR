...
module FAU ( 
  ...
  nand3  g017(.a(new_n56_), .b(new_n61_), .c(x12), .O(new_n70_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n61_), .c(x12), .O(new_n111_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n61_), .c(x12), .O(new_n119_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n61_), .c(x12), .O(new_n126_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n61_), .c(x12), .O(new_n139_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n61_), .c(x12), .O(new_n147_));
  ...
  nand2  g111(.a(new_n157_), .b(new_n61_), .O(new_n164_));
