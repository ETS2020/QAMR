...
module FAU ( 
  ...
  nand2  g45(.a(new_n93_), .b(new_n55_), .O(new_n98_));
  ...
  nand4  g60(.a(new_n112_), .b(x19), .c(x18), .d(new_n61_), .O(new_n113_));
  ...
  nand2  g68(.a(new_n116_), .b(new_n55_), .O(new_n121_));
  nand2  g69(.a(new_n121_), .b(new_n120_), .O(z14));
  inv1   g70(.a(x35), .O(new_n123_));
  nand2  g71(.a(new_n123_), .b(new_n55_), .O(new_n124_));
  nand4  g72(.a(new_n91_), .b(x19), .c(x18), .d(new_n61_), .O(new_n125_));
