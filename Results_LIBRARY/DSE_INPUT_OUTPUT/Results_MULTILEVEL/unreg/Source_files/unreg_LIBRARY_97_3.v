...
module FAU ( 
  ...
  oai21  g29(.a(new_n79_), .b(new_n58_), .c(new_n81_), .O(z08));
  ...
  nand2  g36(.a(new_n53_), .b(x15), .O(new_n89_));
  oai22  g37(.a(new_n89_), .b(new_n56_), .c(x32), .d(x19), .O(z12));
