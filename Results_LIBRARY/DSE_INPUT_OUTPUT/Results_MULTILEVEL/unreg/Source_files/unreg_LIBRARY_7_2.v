...
module FAU ( 
  ...
  oai21  g017(.a(new_n56_), .b(x13), .c(new_n61_), .O(new_n70_));
  ...
  oai21  g030(.a(new_n73_), .b(x13), .c(new_n61_), .O(new_n83_));
  ...
  oai21  g038(.a(new_n90_), .b(x13), .c(new_n61_), .O(new_n91_));
  ...
  oai21  g052(.a(new_n94_), .b(x13), .c(new_n61_), .O(new_n105_));
  ...
  oai21  g066(.a(new_n118_), .b(x13), .c(new_n61_), .O(new_n119_));
  ...
  oai21  g073(.a(new_n114_), .b(x13), .c(new_n61_), .O(new_n126_));
  ...
  oai21  g101(.a(new_n142_), .b(x13), .c(new_n61_), .O(new_n154_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n61_), .c(new_n60_), .O(new_n166_));
