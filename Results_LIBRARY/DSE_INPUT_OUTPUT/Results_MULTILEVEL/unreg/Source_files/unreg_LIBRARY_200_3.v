...
module FAU ( 
  ...
  nand4  g17(.a(x19), .b(new_n59_), .c(new_n54_), .d(x06), .O(new_n70_));
  oai21  g18(.a(x25), .b(x19), .c(new_n70_), .O(z05));
  aoi21  g19(.a(new_n54_), .b(x05), .c(x18), .O(new_n72_));
  inv1   g20(.a(x26), .O(new_n73_));
  nand2  g21(.a(new_n73_), .b(new_n53_), .O(new_n74_));
  oai21  g22(.a(new_n72_), .b(new_n53_), .c(new_n74_), .O(z06));
  ...
  nand4  g31(.a(x19), .b(new_n59_), .c(new_n54_), .d(x10), .O(new_n84_));
  ...
  nand4  g39(.a(x19), .b(new_n59_), .c(new_n54_), .d(x15), .O(new_n92_));
  oai21  g40(.a(x32), .b(x19), .c(new_n92_), .O(z12));
  nand4  g41(.a(x19), .b(new_n59_), .c(new_n54_), .d(x14), .O(new_n94_));
  oai21  g42(.a(x33), .b(x19), .c(new_n94_), .O(z13));
  aoi21  g43(.a(new_n54_), .b(x13), .c(x18), .O(new_n96_));
  inv1   g44(.a(x34), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n53_), .O(new_n98_));
  oai21  g46(.a(new_n96_), .b(new_n53_), .c(new_n98_), .O(z14));
  aoi21  g47(.a(new_n54_), .b(x12), .c(x18), .O(new_n100_));
  inv1   g48(.a(x35), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(new_n53_), .O(new_n102_));
  oai21  g50(.a(new_n100_), .b(new_n53_), .c(new_n102_), .O(z15));
endmodule
