...
module FAU ( 
  ...
  aoi21  g12(.a(new_n53_), .b(x07), .c(x18), .O(new_n65_));
  inv1   g13(.a(x24), .O(new_n66_));
  nand2  g14(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  oai21  g15(.a(new_n65_), .b(new_n64_), .c(new_n67_), .O(z04));
  ...
  nand2  g20(.a(new_n53_), .b(x04), .O(new_n73_));
  oai22  g21(.a(new_n73_), .b(new_n56_), .c(x27), .d(x19), .O(z07));
  aoi21  g22(.a(new_n53_), .b(x11), .c(x18), .O(new_n75_));
  inv1   g23(.a(x28), .O(new_n76_));
  nand2  g24(.a(new_n76_), .b(new_n64_), .O(new_n77_));
  oai21  g25(.a(new_n75_), .b(new_n64_), .c(new_n77_), .O(z08));
  nand2  g26(.a(new_n53_), .b(x10), .O(new_n79_));
  oai22  g27(.a(new_n79_), .b(new_n56_), .c(x29), .d(x19), .O(z09));
  aoi21  g28(.a(new_n53_), .b(x09), .c(x18), .O(new_n81_));
  inv1   g29(.a(x30), .O(new_n82_));
  nand2  g30(.a(new_n82_), .b(new_n64_), .O(new_n83_));
  oai21  g31(.a(new_n81_), .b(new_n64_), .c(new_n83_), .O(z10));
  ...
  nand2  g36(.a(new_n88_), .b(new_n64_), .O(new_n89_));
  oai21  g37(.a(new_n87_), .b(new_n64_), .c(new_n89_), .O(z12));
  nand2  g38(.a(new_n53_), .b(x14), .O(new_n91_));
  oai22  g39(.a(new_n91_), .b(new_n56_), .c(x33), .d(x19), .O(z13));
  aoi21  g40(.a(new_n53_), .b(x13), .c(x18), .O(new_n93_));
  inv1   g41(.a(x34), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(new_n64_), .O(new_n95_));
  oai21  g43(.a(new_n93_), .b(new_n64_), .c(new_n95_), .O(z14));
  aoi21  g44(.a(new_n53_), .b(x12), .c(x18), .O(new_n97_));
  inv1   g45(.a(x35), .O(new_n98_));
  nand2  g46(.a(new_n98_), .b(new_n64_), .O(new_n99_));
  oai21  g47(.a(new_n97_), .b(new_n64_), .c(new_n99_), .O(z15));
endmodule
