...
module FAU ( 
  ...
  nand3  g009(.a(x25), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  nand3  g016(.a(x25), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  nand3  g032(.a(x19), .b(new_n54_), .c(x07), .O(new_n85_));
  nand2  g033(.a(new_n76_), .b(x18), .O(new_n86_));
  nand2  g034(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g035(.a(new_n87_), .b(new_n53_), .O(new_n88_));
  inv1   g036(.a(x24), .O(new_n89_));
  oai21  g037(.a(new_n76_), .b(new_n89_), .c(new_n60_), .O(new_n90_));
  ...
  nand2  g044(.a(new_n76_), .b(new_n60_), .O(new_n97_));
  ...
  oai21  g051(.a(new_n93_), .b(new_n76_), .c(new_n60_), .O(new_n104_));
  ...
  oai21  g057(.a(new_n100_), .b(new_n76_), .c(new_n60_), .O(new_n110_));
  ...
  oai21  g065(.a(new_n117_), .b(new_n76_), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n113_), .b(x25), .c(new_n60_), .O(new_n125_));
  ...
  nand3  g079(.a(new_n121_), .b(x25), .c(new_n60_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n128_), .b(new_n76_), .c(new_n60_), .O(new_n138_));
  ...
  nand2  g092(.a(x32), .b(x25), .O(new_n145_));
  ...
  nand3  g100(.a(new_n141_), .b(x25), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n149_), .b(x25), .c(new_n60_), .O(new_n160_));
