...
module FAU ( 
  ...
  oai21  g016(.a(new_n56_), .b(x15), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(new_n65_), .b(x15), .c(new_n60_), .O(new_n76_));
  ...
  oai21  g038(.a(new_n90_), .b(x15), .c(new_n60_), .O(new_n91_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n60_), .c(new_n82_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n60_), .c(new_n82_), .O(new_n126_));
  ...
  oai21  g108(.a(new_n150_), .b(x15), .c(new_n60_), .O(new_n161_));
