...
module FAU ( 
  ...
  aoi21  g17(.a(new_n69_), .b(new_n53_), .c(new_n61_), .O(new_n70_));
  inv1   g18(.a(x24), .O(new_n71_));
  nand2  g19(.a(new_n71_), .b(new_n60_), .O(new_n72_));
  oai21  g20(.a(new_n70_), .b(new_n60_), .c(new_n72_), .O(z04));
  inv1   g21(.a(x26), .O(new_n74_));
  aoi21  g22(.a(new_n74_), .b(new_n53_), .c(new_n61_), .O(new_n75_));
  nand2  g23(.a(new_n69_), .b(new_n60_), .O(new_n76_));
  oai21  g24(.a(new_n75_), .b(new_n60_), .c(new_n76_), .O(z05));
  oai21  g25(.a(x27), .b(x17), .c(x18), .O(new_n78_));
  nand2  g26(.a(new_n78_), .b(x19), .O(new_n79_));
  nand2  g27(.a(new_n74_), .b(new_n60_), .O(new_n80_));
  ...
  nand2  g40(.a(new_n88_), .b(new_n60_), .O(new_n93_));
  oai21  g41(.a(new_n92_), .b(new_n60_), .c(new_n93_), .O(z10));
  aoi21  g42(.a(new_n71_), .b(new_n53_), .c(new_n61_), .O(new_n95_));
  nand2  g43(.a(new_n91_), .b(new_n60_), .O(new_n96_));
  ...
  nand2  g55(.a(new_n103_), .b(new_n60_), .O(new_n108_));
