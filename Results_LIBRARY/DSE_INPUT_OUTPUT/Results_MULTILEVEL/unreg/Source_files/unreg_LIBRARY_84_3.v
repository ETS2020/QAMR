...
module FAU ( 
  ...
  aoi21  g025(.a(new_n77_), .b(new_n53_), .c(x35), .O(new_n78_));
  ...
  oai21  g051(.a(new_n103_), .b(x35), .c(x19), .O(new_n104_));
  ...
  oai21  g065(.a(new_n117_), .b(x35), .c(x19), .O(new_n118_));
  ...
  nand4  g083(.a(new_n135_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n136_));
  ...
  oai21  g091(.a(new_n143_), .b(x35), .c(x19), .O(new_n144_));
  ...
  nand2  g096(.a(new_n55_), .b(new_n148_), .O(new_n149_));
  ...
  nand3  g101(.a(new_n111_), .b(x19), .c(x18), .O(new_n154_));
  inv1   g102(.a(new_n154_), .O(new_n155_));
  oai21  g103(.a(new_n155_), .b(new_n153_), .c(new_n53_), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(x19), .c(x35), .O(z15));
endmodule
