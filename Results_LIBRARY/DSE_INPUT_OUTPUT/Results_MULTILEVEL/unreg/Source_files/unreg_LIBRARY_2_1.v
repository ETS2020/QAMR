...
module FAU ( 
  ...
  oai21  g58(.a(new_n110_), .b(new_n57_), .c(new_n108_), .O(z12));
  nand2  g59(.a(new_n109_), .b(new_n53_), .O(new_n112_));
  inv1   g60(.a(x34), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(x19), .O(new_n114_));
  oai21  g62(.a(new_n114_), .b(new_n57_), .c(new_n112_), .O(z13));
  nand2  g63(.a(new_n113_), .b(new_n53_), .O(new_n116_));
  inv1   g64(.a(x35), .O(new_n117_));
  nand2  g65(.a(new_n117_), .b(x19), .O(new_n118_));
  oai21  g66(.a(new_n118_), .b(new_n57_), .c(new_n116_), .O(z14));
  nand2  g67(.a(new_n117_), .b(new_n53_), .O(new_n120_));
  nand2  g68(.a(new_n90_), .b(x19), .O(new_n121_));
  oai21  g69(.a(new_n121_), .b(new_n57_), .c(new_n120_), .O(z15));
endmodule
