// Benchmark "FAU" written by ABC on Fri Aug 14 02:05:06 2020
...
module FAU ( 
  ...
  nand4  g004(.a(new_n56_), .b(x19), .c(new_n53_), .d(x13), .O(new_n57_));
  ...
  nand4  g011(.a(new_n63_), .b(x19), .c(new_n53_), .d(x13), .O(new_n64_));
  ...
  nand4  g027(.a(new_n79_), .b(x19), .c(new_n53_), .d(x13), .O(new_n80_));
  ...
  nand4  g031(.a(new_n83_), .b(x19), .c(new_n53_), .d(x13), .O(new_n84_));
  ...
  nand4  g037(.a(new_n89_), .b(x19), .c(new_n53_), .d(x13), .O(new_n90_));
  ...
  nand4  g043(.a(new_n95_), .b(x19), .c(new_n53_), .d(x13), .O(new_n96_));
  inv1   g044(.a(x26), .O(new_n97_));
  nand2  g045(.a(new_n97_), .b(new_n58_), .O(new_n98_));
  nand2  g046(.a(new_n98_), .b(new_n96_), .O(z06));
  nand2  g047(.a(new_n54_), .b(x04), .O(new_n100_));
  nand2  g048(.a(new_n59_), .b(x18), .O(new_n101_));
  aoi21  g049(.a(new_n101_), .b(new_n100_), .c(x17), .O(new_n102_));
  oai21  g050(.a(new_n102_), .b(new_n68_), .c(x19), .O(new_n103_));
  ...
  nand4  g056(.a(new_n108_), .b(x19), .c(new_n53_), .d(x13), .O(new_n109_));
  ...
  nand4  g062(.a(new_n114_), .b(x19), .c(new_n53_), .d(x13), .O(new_n115_));
  ...
  nand2  g072(.a(new_n124_), .b(new_n58_), .O(new_n125_));
  ...
  nand4  g076(.a(new_n128_), .b(x19), .c(new_n53_), .d(x13), .O(new_n129_));
  ...
  oai21  g083(.a(new_n135_), .b(new_n68_), .c(x19), .O(new_n136_));
  ...
  nand4  g089(.a(new_n141_), .b(x19), .c(new_n53_), .d(x13), .O(new_n142_));
  nand2  g090(.a(new_n133_), .b(new_n58_), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n142_), .O(z13));
  aoi21  g092(.a(x35), .b(x18), .c(x17), .O(new_n145_));
  oai21  g093(.a(new_n145_), .b(new_n68_), .c(x19), .O(new_n146_));
  oai21  g094(.a(x34), .b(x19), .c(new_n146_), .O(z14));
  nand2  g095(.a(new_n54_), .b(x12), .O(new_n148_));
  nand2  g096(.a(new_n110_), .b(x18), .O(new_n149_));
  aoi21  g097(.a(new_n149_), .b(new_n148_), .c(x17), .O(new_n150_));
  oai21  g098(.a(new_n150_), .b(new_n68_), .c(x19), .O(new_n151_));
