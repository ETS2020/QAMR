...
module FAU ( 
  ...
  oai21  g017(.a(x29), .b(new_n56_), .c(new_n60_), .O(new_n70_));
  ...
  oai21  g045(.a(x29), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g052(.a(x29), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  oai21  g058(.a(x29), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g079(.a(new_n121_), .b(new_n62_), .c(new_n60_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n128_), .b(x29), .c(new_n60_), .O(new_n138_));
  ...
  oai21  g100(.a(new_n141_), .b(x29), .c(new_n60_), .O(new_n153_));
  ...
  oai21  g107(.a(new_n149_), .b(x29), .c(new_n60_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n156_), .b(x29), .c(new_n60_), .O(new_n166_));
