...
module FAU ( 
  ...
  oai21  g009(.a(x34), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g016(.a(x34), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(x34), .b(new_n65_), .c(new_n60_), .O(new_n76_));
  ...
  oai21  g029(.a(x34), .b(new_n72_), .c(new_n60_), .O(new_n82_));
  ...
  nand3  g045(.a(new_n90_), .b(new_n85_), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g052(.a(new_n90_), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g080(.a(new_n90_), .b(new_n122_), .c(new_n60_), .O(new_n133_));
  ...
  nand3  g094(.a(new_n90_), .b(new_n146_), .c(new_n60_), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n145_), .O(z12));
  nand2  g096(.a(new_n54_), .b(x14), .O(new_n149_));
  nand2  g097(.a(new_n90_), .b(x18), .O(new_n150_));
  ...
  nand2  g107(.a(new_n90_), .b(new_n60_), .O(new_n160_));
