...
module FAU ( 
  ...
  nand3  g017(.a(new_n69_), .b(x18), .c(new_n54_), .O(new_n70_));
  ...
  nand4  g024(.a(new_n76_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n77_));
  ...
  oai21  g042(.a(new_n94_), .b(x01), .c(x19), .O(new_n95_));
  ...
  oai21  g063(.a(new_n115_), .b(x01), .c(x19), .O(new_n116_));
  ...
  oai21  g070(.a(new_n122_), .b(x01), .c(x19), .O(new_n123_));
  ...
  oai21  g074(.a(x24), .b(new_n55_), .c(new_n126_), .O(new_n127_));
  nand4  g075(.a(new_n127_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n128_));
  ...
  oai21  g082(.a(new_n134_), .b(x01), .c(x19), .O(new_n135_));
  ...
  oai21  g095(.a(new_n147_), .b(x01), .c(x19), .O(new_n148_));
  ...
  oai21  g102(.a(new_n154_), .b(x01), .c(x19), .O(new_n155_));
