...
module FAU ( 
  ...
  nand3  g024(.a(x35), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g030(.a(x35), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g058(.a(x35), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g086(.a(x35), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  ...
  oai21  g101(.a(new_n62_), .b(new_n142_), .c(new_n60_), .O(new_n154_));
  ...
  oai21  g107(.a(new_n62_), .b(new_n150_), .c(new_n60_), .O(new_n160_));
  ...
  nand2  g113(.a(new_n62_), .b(new_n60_), .O(new_n166_));
