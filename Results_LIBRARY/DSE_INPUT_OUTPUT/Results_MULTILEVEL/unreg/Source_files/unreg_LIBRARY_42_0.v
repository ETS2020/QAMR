...
module FAU ( 
  ...
  nand3  g009(.a(x24), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  nand3  g016(.a(x24), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  nand2  g037(.a(new_n76_), .b(new_n60_), .O(new_n90_));
  ...
  oai21  g044(.a(new_n86_), .b(new_n76_), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g057(.a(new_n100_), .b(x24), .c(new_n60_), .O(new_n110_));
  ...
  nand3  g065(.a(new_n117_), .b(x24), .c(new_n60_), .O(new_n118_));
  ...
  oai21  g072(.a(new_n113_), .b(new_n76_), .c(new_n60_), .O(new_n125_));
  ...
  nand2  g092(.a(x32), .b(x24), .O(new_n145_));
  ...
  nand3  g107(.a(new_n149_), .b(x24), .c(new_n60_), .O(new_n160_));
