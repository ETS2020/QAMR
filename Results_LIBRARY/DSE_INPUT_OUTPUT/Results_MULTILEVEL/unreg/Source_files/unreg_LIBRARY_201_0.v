...
module FAU ( 
  ...
  nand3  g030(.a(new_n73_), .b(new_n60_), .c(x02), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n60_), .c(x02), .O(new_n91_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n60_), .c(x02), .O(new_n126_));
  ...
  nand3  g080(.a(new_n122_), .b(new_n60_), .c(x02), .O(new_n133_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n60_), .c(x02), .O(new_n139_));
  ...
  nand3  g108(.a(new_n150_), .b(new_n60_), .c(x02), .O(new_n161_));
