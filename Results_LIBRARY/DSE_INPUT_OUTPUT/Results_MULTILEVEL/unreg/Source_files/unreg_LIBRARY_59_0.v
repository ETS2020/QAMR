...
module FAU ( 
  ...
  nand3  g024(.a(x27), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g030(.a(x27), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g038(.a(x27), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  nand3  g045(.a(x27), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  nand2  g046(.a(new_n98_), .b(new_n97_), .O(z05));
  nand3  g047(.a(x19), .b(new_n54_), .c(x05), .O(new_n100_));
  nand2  g048(.a(new_n62_), .b(x18), .O(new_n101_));
  nand2  g049(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g050(.a(new_n102_), .b(new_n53_), .O(new_n103_));
  oai21  g051(.a(new_n62_), .b(new_n94_), .c(new_n60_), .O(new_n104_));
  ...
  nand3  g084(.a(new_n127_), .b(x27), .c(new_n60_), .O(new_n137_));
  ...
  nand2  g091(.a(x32), .b(x27), .O(new_n144_));
  ...
  oai21  g106(.a(new_n148_), .b(new_n62_), .c(new_n60_), .O(new_n159_));
