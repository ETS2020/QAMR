...
module FAU ( 
  ...
  nand3  g024(.a(new_n65_), .b(new_n60_), .c(x00), .O(new_n77_));
  nand2  g025(.a(new_n77_), .b(new_n76_), .O(z02));
  nand3  g026(.a(x19), .b(new_n54_), .c(new_n53_), .O(new_n79_));
  nand2  g027(.a(new_n73_), .b(new_n60_), .O(new_n80_));
  nand2  g028(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g029(.a(new_n81_), .b(x00), .O(new_n82_));
  nand4  g030(.a(x19), .b(x18), .c(new_n53_), .d(x16), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n60_), .c(x00), .O(new_n91_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n60_), .c(x00), .O(new_n98_));
  ...
  nand3  g052(.a(new_n94_), .b(new_n60_), .c(x00), .O(new_n105_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n60_), .c(x00), .O(new_n111_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n60_), .c(x00), .O(new_n126_));
  ...
  nand3  g080(.a(new_n122_), .b(new_n60_), .c(x00), .O(new_n133_));
  ...
  nand2  g093(.a(x32), .b(x00), .O(new_n146_));
