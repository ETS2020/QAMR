...
module FAU ( 
  ...
  nand2  g001(.a(x26), .b(new_n53_), .O(new_n54_));
  ...
  nand3  g031(.a(new_n54_), .b(new_n57_), .c(x07), .O(new_n84_));
  nor2   g032(.a(x26), .b(x25), .O(new_n85_));
  ...
  aoi21  g036(.a(x26), .b(new_n53_), .c(x24), .O(new_n89_));
  ...
  aoi21  g041(.a(x25), .b(new_n57_), .c(new_n93_), .O(new_n94_));
  nand2  g042(.a(new_n93_), .b(x18), .O(new_n95_));
  oai21  g043(.a(new_n94_), .b(new_n92_), .c(new_n95_), .O(new_n96_));
  nand3  g044(.a(new_n96_), .b(x19), .c(new_n56_), .O(new_n97_));
  nand2  g045(.a(new_n85_), .b(new_n61_), .O(new_n98_));
  nand2  g046(.a(new_n98_), .b(new_n97_), .O(z05));
  oai21  g047(.a(new_n53_), .b(new_n61_), .c(x26), .O(new_n100_));
  nand2  g048(.a(new_n57_), .b(x05), .O(new_n101_));
  oai21  g049(.a(x27), .b(new_n57_), .c(new_n101_), .O(new_n102_));
  nand3  g050(.a(new_n102_), .b(new_n100_), .c(new_n56_), .O(new_n103_));
  oai21  g051(.a(x26), .b(x19), .c(new_n103_), .O(z06));
  ...
  aoi21  g057(.a(new_n109_), .b(new_n107_), .c(new_n55_), .O(z07));
  ...
  aoi21  g075(.a(new_n127_), .b(new_n125_), .c(new_n55_), .O(z10));
  ...
  nand2  g086(.a(new_n138_), .b(new_n61_), .O(new_n139_));
  aoi21  g087(.a(new_n139_), .b(new_n137_), .c(new_n55_), .O(z12));
  ...
  nand2  g092(.a(new_n144_), .b(new_n61_), .O(new_n145_));
  aoi21  g093(.a(new_n145_), .b(new_n143_), .c(new_n55_), .O(z13));
  ...
  nor2   g097(.a(x34), .b(x19), .O(new_n150_));
  nor2   g098(.a(new_n150_), .b(new_n55_), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(new_n149_), .O(z14));
  nand2  g100(.a(new_n57_), .b(x12), .O(new_n153_));
  oai21  g101(.a(x28), .b(new_n57_), .c(new_n153_), .O(new_n154_));
  ...
  aoi21  g105(.a(new_n157_), .b(new_n155_), .c(new_n55_), .O(z15));
endmodule
