...
module FAU ( 
  ...
  nand3  g030(.a(x29), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g038(.a(new_n62_), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g045(.a(new_n62_), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g052(.a(x29), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g058(.a(x29), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  nand2  g059(.a(new_n111_), .b(new_n110_), .O(z07));
  nand2  g060(.a(new_n54_), .b(x11), .O(new_n113_));
  nand2  g061(.a(new_n62_), .b(x18), .O(new_n114_));
  nand2  g062(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand3  g063(.a(new_n115_), .b(x19), .c(new_n53_), .O(new_n116_));
  inv1   g064(.a(x28), .O(new_n117_));
  nand3  g065(.a(x29), .b(new_n117_), .c(new_n60_), .O(new_n118_));
  ...
  nand2  g072(.a(new_n62_), .b(new_n60_), .O(new_n125_));
  ...
  oai21  g079(.a(new_n121_), .b(new_n62_), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g085(.a(new_n128_), .b(x29), .c(new_n60_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(x29), .c(new_n60_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n141_), .b(x29), .c(new_n60_), .O(new_n153_));
  ...
  oai21  g107(.a(new_n149_), .b(new_n62_), .c(new_n60_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n156_), .b(x29), .c(new_n60_), .O(new_n166_));
