...
module FAU ( 
  ...
  oai21  g029(.a(x29), .b(new_n72_), .c(new_n60_), .O(new_n82_));
  ...
  oai21  g045(.a(x29), .b(new_n85_), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g058(.a(new_n90_), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  nand2  g059(.a(new_n111_), .b(new_n110_), .O(z07));
  nand2  g060(.a(new_n54_), .b(x11), .O(new_n113_));
  nand2  g061(.a(new_n90_), .b(x18), .O(new_n114_));
  ...
  nand3  g065(.a(new_n90_), .b(new_n117_), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g084(.a(new_n126_), .b(new_n90_), .c(new_n60_), .O(new_n137_));
  ...
  nand3  g099(.a(new_n140_), .b(new_n90_), .c(new_n60_), .O(new_n152_));
