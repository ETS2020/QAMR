...
module FAU ( 
  ...
  oai21  g024(.a(new_n66_), .b(x13), .c(new_n61_), .O(new_n77_));
  ...
  oai21  g058(.a(new_n101_), .b(x13), .c(new_n61_), .O(new_n111_));
  ...
  oai21  g080(.a(new_n122_), .b(x13), .c(new_n61_), .O(new_n133_));
  ...
  oai21  g094(.a(new_n146_), .b(x13), .c(new_n61_), .O(new_n147_));
  ...
  nand2  g105(.a(new_n150_), .b(new_n61_), .O(new_n158_));
  ...
  oai21  g113(.a(new_n159_), .b(x13), .c(new_n61_), .O(new_n166_));
