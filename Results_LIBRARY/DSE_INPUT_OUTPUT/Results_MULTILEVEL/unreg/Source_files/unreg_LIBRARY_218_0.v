...
module FAU ( 
  ...
  nand3  g023(.a(x23), .b(new_n65_), .c(new_n60_), .O(new_n76_));
  ...
  nand3  g050(.a(new_n92_), .b(x23), .c(new_n60_), .O(new_n103_));
  ...
  nand3  g056(.a(new_n99_), .b(x23), .c(new_n60_), .O(new_n109_));
  ...
  oai21  g064(.a(new_n116_), .b(new_n72_), .c(new_n60_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n112_), .b(x23), .c(new_n60_), .O(new_n124_));
  ...
  oai21  g084(.a(new_n127_), .b(new_n72_), .c(new_n60_), .O(new_n137_));
  ...
  nand3  g092(.a(new_n144_), .b(x23), .c(new_n60_), .O(new_n145_));
  ...
  nand3  g099(.a(new_n140_), .b(x23), .c(new_n60_), .O(new_n152_));
  ...
  oai21  g106(.a(new_n148_), .b(new_n72_), .c(new_n60_), .O(new_n159_));
