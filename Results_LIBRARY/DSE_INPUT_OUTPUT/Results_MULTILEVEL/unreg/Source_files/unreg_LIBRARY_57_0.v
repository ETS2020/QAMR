...
module FAU ( 
  ...
  oai21  g017(.a(new_n56_), .b(new_n69_), .c(new_n60_), .O(new_n70_));
  ...
  oai21  g024(.a(new_n65_), .b(new_n69_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g030(.a(new_n73_), .b(new_n60_), .c(x13), .O(new_n83_));
  ...
  oai21  g045(.a(new_n86_), .b(new_n69_), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g052(.a(new_n94_), .b(new_n69_), .c(new_n60_), .O(new_n105_));
  ...
  oai21  g058(.a(new_n101_), .b(new_n69_), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g080(.a(new_n122_), .b(new_n60_), .c(x13), .O(new_n133_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n60_), .c(x13), .O(new_n147_));
  ...
  nand3  g114(.a(new_n160_), .b(new_n60_), .c(x13), .O(new_n167_));
