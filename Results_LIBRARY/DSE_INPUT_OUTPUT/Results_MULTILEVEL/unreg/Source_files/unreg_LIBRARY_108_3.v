...
module FAU ( 
  ...
  oai21  g005(.a(new_n57_), .b(x32), .c(x19), .O(new_n58_));
  ...
  oai21  g032(.a(new_n84_), .b(x32), .c(x19), .O(new_n85_));
  ...
  oai21  g040(.a(new_n92_), .b(x32), .c(x19), .O(new_n93_));
  nand2  g041(.a(new_n82_), .b(new_n59_), .O(new_n94_));
  nand2  g042(.a(new_n94_), .b(new_n93_), .O(z05));
  nand2  g043(.a(new_n53_), .b(x05), .O(new_n96_));
  oai21  g044(.a(x27), .b(new_n53_), .c(new_n96_), .O(new_n97_));
  nand4  g045(.a(new_n97_), .b(new_n64_), .c(x19), .d(new_n63_), .O(new_n98_));
  nand2  g046(.a(new_n90_), .b(new_n59_), .O(new_n99_));
  ...
  oai21  g051(.a(new_n103_), .b(x32), .c(x19), .O(new_n104_));
  ...
  oai21  g059(.a(new_n111_), .b(x32), .c(x19), .O(new_n112_));
  ...
  nand4  g065(.a(new_n117_), .b(new_n64_), .c(x19), .d(new_n63_), .O(new_n118_));
  ...
  nand2  g075(.a(new_n86_), .b(x18), .O(new_n128_));
  aoi21  g076(.a(new_n128_), .b(new_n127_), .c(x17), .O(new_n129_));
  oai21  g077(.a(new_n129_), .b(x32), .c(x19), .O(new_n130_));
  ...
  nand2  g086(.a(new_n64_), .b(new_n59_), .O(new_n139_));
