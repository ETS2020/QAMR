...
module FAU ( 
  ...
  inv1   g19(.a(x18), .O(new_n72_));
  nand2  g20(.a(x19), .b(new_n72_), .O(new_n73_));
  oai22  g21(.a(new_n73_), .b(new_n71_), .c(x24), .d(x19), .O(z04));
  nand2  g22(.a(new_n54_), .b(x06), .O(new_n75_));
  oai22  g23(.a(new_n75_), .b(new_n73_), .c(x25), .d(x19), .O(z05));
  nand2  g24(.a(new_n54_), .b(x05), .O(new_n77_));
  oai22  g25(.a(new_n77_), .b(new_n73_), .c(x26), .d(x19), .O(z06));
  nand2  g26(.a(new_n54_), .b(x04), .O(new_n79_));
  oai22  g27(.a(new_n79_), .b(new_n73_), .c(x27), .d(x19), .O(z07));
  nand2  g28(.a(new_n54_), .b(x11), .O(new_n81_));
  oai22  g29(.a(new_n81_), .b(new_n73_), .c(x28), .d(x19), .O(z08));
  nand2  g30(.a(new_n54_), .b(x10), .O(new_n83_));
  oai22  g31(.a(new_n83_), .b(new_n73_), .c(x29), .d(x19), .O(z09));
  nand2  g32(.a(new_n54_), .b(x09), .O(new_n85_));
  oai22  g33(.a(new_n85_), .b(new_n73_), .c(x30), .d(x19), .O(z10));
  ...
  oai22  g39(.a(new_n91_), .b(new_n73_), .c(x32), .d(x19), .O(z12));
  nand2  g40(.a(new_n54_), .b(x14), .O(new_n93_));
  oai22  g41(.a(new_n93_), .b(new_n73_), .c(x33), .d(x19), .O(z13));
  aoi21  g42(.a(new_n54_), .b(x13), .c(x18), .O(new_n95_));
  inv1   g43(.a(x34), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n53_), .O(new_n97_));
  oai21  g45(.a(new_n95_), .b(new_n53_), .c(new_n97_), .O(z14));
  nand2  g46(.a(new_n54_), .b(x12), .O(new_n99_));
  oai22  g47(.a(new_n99_), .b(new_n73_), .c(x35), .d(x19), .O(z15));
endmodule
