...
module FAU ( 
  ...
  aoi21  g49(.a(new_n101_), .b(new_n53_), .c(new_n61_), .O(new_n102_));
  nand2  g50(.a(new_n98_), .b(new_n60_), .O(new_n103_));
  oai21  g51(.a(new_n102_), .b(new_n60_), .c(new_n103_), .O(z13));
  inv1   g52(.a(x35), .O(new_n105_));
  aoi21  g53(.a(new_n105_), .b(new_n53_), .c(new_n61_), .O(new_n106_));
  nand2  g54(.a(new_n101_), .b(new_n60_), .O(new_n107_));
