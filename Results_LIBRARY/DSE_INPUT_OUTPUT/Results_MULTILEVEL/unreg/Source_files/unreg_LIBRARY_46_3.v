...
module FAU ( 
  ...
  oai21  g022(.a(new_n74_), .b(x29), .c(x19), .O(new_n75_));
  ...
  oai21  g051(.a(new_n103_), .b(x29), .c(x19), .O(new_n104_));
  inv1   g052(.a(x27), .O(new_n105_));
  nand2  g053(.a(new_n105_), .b(new_n59_), .O(new_n106_));
  nand2  g054(.a(new_n106_), .b(new_n104_), .O(z07));
  nor2   g055(.a(x18), .b(x11), .O(new_n108_));
  oai21  g056(.a(new_n108_), .b(x17), .c(new_n54_), .O(new_n109_));
  nand2  g057(.a(new_n109_), .b(x19), .O(new_n110_));
  ...
  oai21  g064(.a(new_n116_), .b(new_n113_), .c(new_n53_), .O(new_n117_));
  aoi21  g065(.a(new_n117_), .b(x19), .c(x29), .O(z09));
  ...
  nand2  g069(.a(new_n114_), .b(new_n59_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n125_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n126_));
  ...
  oai21  g094(.a(new_n146_), .b(x29), .c(x19), .O(new_n147_));
