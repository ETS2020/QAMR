...
module FAU ( 
  ...
  nand2  g006(.a(x26), .b(x21), .O(new_n59_));
  ...
  oai21  g011(.a(x26), .b(new_n63_), .c(x21), .O(new_n64_));
  nand3  g012(.a(new_n64_), .b(new_n54_), .c(x02), .O(new_n65_));
  inv1   g013(.a(x22), .O(new_n66_));
  nand4  g014(.a(new_n59_), .b(new_n66_), .c(x19), .d(x18), .O(new_n67_));
  ...
  nand2  g023(.a(new_n66_), .b(new_n63_), .O(new_n76_));
  ...
  aoi21  g031(.a(new_n83_), .b(new_n81_), .c(new_n60_), .O(z03));
  ...
  oai21  g038(.a(x21), .b(x18), .c(x26), .O(new_n91_));
  nand2  g039(.a(new_n91_), .b(x06), .O(new_n92_));
  ...
  nand3  g043(.a(new_n59_), .b(new_n95_), .c(new_n63_), .O(new_n96_));
  nand2  g044(.a(new_n96_), .b(new_n94_), .O(z05));
  oai21  g045(.a(x21), .b(new_n63_), .c(x26), .O(new_n98_));
  ...
  nor2   g054(.a(new_n106_), .b(new_n60_), .O(new_n107_));
  ...
  aoi21  g061(.a(new_n113_), .b(new_n111_), .c(new_n60_), .O(z08));
  ...
  nand2  g066(.a(new_n118_), .b(new_n63_), .O(new_n119_));
  ...
  nand2  g078(.a(new_n130_), .b(new_n63_), .O(new_n131_));
  ...
  aoi21  g085(.a(new_n137_), .b(new_n135_), .c(new_n60_), .O(z12));
  ...
  nor2   g096(.a(new_n148_), .b(new_n60_), .O(new_n149_));
  ...
  nand2  g102(.a(new_n154_), .b(new_n63_), .O(new_n155_));
