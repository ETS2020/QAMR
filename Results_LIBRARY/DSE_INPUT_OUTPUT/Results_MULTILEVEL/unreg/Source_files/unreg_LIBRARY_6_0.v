...
module FAU ( 
  ...
  aoi22  g009(.a(new_n61_), .b(new_n60_), .c(new_n59_), .d(new_n58_), .O(new_n62_));
  nand2  g010(.a(new_n62_), .b(new_n57_), .O(z00));
  nor2   g011(.a(x26), .b(x21), .O(new_n64_));
  ...
  nand3  g016(.a(x26), .b(new_n60_), .c(new_n58_), .O(new_n69_));
  ...
  nand2  g038(.a(x26), .b(new_n54_), .O(new_n91_));
  nand2  g039(.a(new_n61_), .b(x21), .O(new_n92_));
  aoi21  g040(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
  nand3  g041(.a(new_n61_), .b(x21), .c(x18), .O(new_n94_));
  inv1   g042(.a(new_n94_), .O(new_n95_));
  oai21  g043(.a(new_n95_), .b(new_n93_), .c(x19), .O(new_n96_));
  inv1   g044(.a(x25), .O(new_n97_));
  nand3  g045(.a(new_n65_), .b(new_n97_), .c(new_n58_), .O(new_n98_));
  oai21  g046(.a(new_n96_), .b(x17), .c(new_n98_), .O(z05));
  nand2  g047(.a(new_n54_), .b(x05), .O(new_n100_));
  oai21  g048(.a(x27), .b(new_n54_), .c(new_n100_), .O(new_n101_));
  nand4  g049(.a(new_n101_), .b(new_n65_), .c(x19), .d(new_n53_), .O(new_n102_));
  oai21  g050(.a(new_n92_), .b(x19), .c(new_n102_), .O(z06));
  ...
  aoi22  g055(.a(new_n107_), .b(new_n58_), .c(new_n61_), .d(new_n60_), .O(new_n108_));
  ...
  aoi21  g062(.a(new_n114_), .b(new_n112_), .c(new_n64_), .O(z08));
  ...
  aoi21  g068(.a(new_n120_), .b(new_n118_), .c(new_n64_), .O(z09));
  ...
  aoi21  g080(.a(new_n132_), .b(new_n130_), .c(new_n64_), .O(z11));
  ...
  aoi21  g086(.a(new_n138_), .b(new_n136_), .c(new_n64_), .O(z12));
  ...
  aoi21  g092(.a(new_n144_), .b(new_n142_), .c(new_n64_), .O(z13));
  ...
  nor2   g097(.a(new_n149_), .b(new_n64_), .O(new_n150_));
  ...
  aoi21  g104(.a(new_n156_), .b(new_n154_), .c(new_n64_), .O(z15));
endmodule
