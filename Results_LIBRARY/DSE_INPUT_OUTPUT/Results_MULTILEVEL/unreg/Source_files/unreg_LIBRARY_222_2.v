...
module FAU ( 
  ...
  oai21  g038(.a(new_n90_), .b(x02), .c(new_n61_), .O(new_n91_));
  ...
  oai21  g045(.a(new_n86_), .b(x02), .c(new_n61_), .O(new_n98_));
  ...
  oai21  g058(.a(new_n101_), .b(x02), .c(new_n61_), .O(new_n111_));
  ...
  oai21  g073(.a(new_n114_), .b(x02), .c(new_n61_), .O(new_n126_));
  ...
  oai21  g080(.a(new_n122_), .b(x02), .c(new_n61_), .O(new_n133_));
  ...
  oai21  g086(.a(new_n129_), .b(x02), .c(new_n61_), .O(new_n139_));
  ...
  oai21  g094(.a(new_n146_), .b(x02), .c(new_n61_), .O(new_n147_));
  ...
  oai21  g108(.a(new_n150_), .b(x02), .c(new_n61_), .O(new_n161_));
