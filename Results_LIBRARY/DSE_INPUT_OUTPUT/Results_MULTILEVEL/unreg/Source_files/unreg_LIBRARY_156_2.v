...
module FAU ( 
  ...
  oai21  g026(.a(x18), .b(x17), .c(x19), .O(new_n79_));
  nand2  g027(.a(new_n79_), .b(x00), .O(new_n80_));
  nand4  g028(.a(x19), .b(x18), .c(new_n53_), .d(x16), .O(new_n81_));
  nand2  g029(.a(new_n73_), .b(new_n60_), .O(new_n82_));
  nand3  g030(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(z03));
  ...
  nand3  g037(.a(new_n89_), .b(new_n60_), .c(new_n69_), .O(new_n90_));
  ...
  nand3  g044(.a(new_n85_), .b(new_n60_), .c(new_n69_), .O(new_n97_));
  ...
  oai21  g051(.a(new_n93_), .b(x00), .c(new_n60_), .O(new_n104_));
  ...
  nand3  g072(.a(new_n113_), .b(new_n60_), .c(new_n69_), .O(new_n125_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n60_), .c(new_n69_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n60_), .c(new_n69_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n60_), .c(new_n69_), .O(new_n153_));
