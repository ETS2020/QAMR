...
module FAU ( 
  ...
  nand3  g019(.a(x19), .b(new_n54_), .c(new_n53_), .O(new_n72_));
  nand2  g020(.a(new_n66_), .b(new_n61_), .O(new_n73_));
  nand2  g021(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g022(.a(new_n74_), .b(x01), .O(new_n75_));
  ...
  nand3  g030(.a(new_n76_), .b(new_n61_), .c(x01), .O(new_n83_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n61_), .c(x01), .O(new_n98_));
  ...
  nand3  g080(.a(new_n122_), .b(new_n61_), .c(x01), .O(new_n133_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n61_), .c(x01), .O(new_n139_));
  ...
  nand2  g093(.a(x32), .b(x01), .O(new_n146_));
  ...
  nand3  g101(.a(new_n142_), .b(new_n61_), .c(x01), .O(new_n154_));
