...
module FAU ( 
  ...
  nand3  g051(.a(new_n93_), .b(x21), .c(new_n60_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n100_), .b(x21), .c(new_n60_), .O(new_n110_));
  ...
  nand3  g079(.a(new_n121_), .b(x21), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g100(.a(new_n141_), .b(x21), .c(new_n60_), .O(new_n153_));
