...
module FAU ( 
  ...
  oai21  g045(.a(x35), .b(new_n85_), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g066(.a(new_n90_), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n90_), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  nand2  g113(.a(new_n90_), .b(new_n60_), .O(new_n166_));
