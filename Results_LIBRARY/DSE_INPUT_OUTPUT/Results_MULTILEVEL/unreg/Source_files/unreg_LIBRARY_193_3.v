...
module FAU ( 
  ...
  nor2   g016(.a(x18), .b(x01), .O(new_n69_));
  oai21  g017(.a(new_n69_), .b(x17), .c(new_n54_), .O(new_n70_));
  nand2  g018(.a(new_n70_), .b(x19), .O(new_n71_));
  ...
  oai21  g052(.a(x29), .b(new_n55_), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g061(.a(new_n113_), .b(x23), .c(x19), .O(new_n114_));
  ...
  oai21  g069(.a(new_n121_), .b(x23), .c(x19), .O(new_n122_));
  ...
  oai21  g081(.a(new_n133_), .b(x23), .c(x19), .O(new_n134_));
  ...
  oai21  g089(.a(new_n141_), .b(x23), .c(x19), .O(new_n142_));
  ...
  nand4  g094(.a(new_n146_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n147_));
