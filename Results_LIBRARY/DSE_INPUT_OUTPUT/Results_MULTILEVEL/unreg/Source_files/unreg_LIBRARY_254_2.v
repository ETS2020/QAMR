...
module FAU ( 
  ...
  nand2  g007(.a(new_n59_), .b(x23), .O(new_n60_));
  ...
  inv1   g027(.a(x19), .O(new_n80_));
  inv1   g028(.a(x23), .O(new_n81_));
  oai21  g029(.a(new_n59_), .b(new_n81_), .c(new_n80_), .O(new_n82_));
  nand3  g030(.a(new_n82_), .b(new_n79_), .c(new_n60_), .O(z03));
  ...
  nor2   g035(.a(new_n87_), .b(new_n61_), .O(new_n88_));
  ...
  nor2   g041(.a(new_n93_), .b(new_n61_), .O(new_n94_));
  ...
  nand4  g047(.a(new_n99_), .b(new_n60_), .c(x19), .d(new_n53_), .O(new_n100_));
  nand3  g048(.a(new_n59_), .b(new_n81_), .c(new_n80_), .O(new_n101_));
  ...
  aoi22  g053(.a(new_n97_), .b(new_n80_), .c(new_n59_), .d(x23), .O(new_n106_));
  ...
  aoi21  g059(.a(new_n111_), .b(new_n80_), .c(new_n61_), .O(new_n112_));
  ...
  nand2  g067(.a(new_n119_), .b(new_n80_), .O(new_n120_));
  aoi21  g068(.a(new_n120_), .b(new_n118_), .c(new_n61_), .O(z09));
  ...
  aoi21  g072(.a(new_n115_), .b(new_n80_), .c(new_n61_), .O(new_n125_));
  ...
  nor2   g077(.a(x31), .b(x19), .O(new_n130_));
  nor2   g078(.a(new_n130_), .b(new_n61_), .O(new_n131_));
  ...
  nand2  g086(.a(new_n138_), .b(new_n80_), .O(new_n139_));
  aoi21  g087(.a(new_n139_), .b(new_n137_), .c(new_n61_), .O(z12));
  ...
  aoi21  g091(.a(new_n134_), .b(new_n80_), .c(new_n61_), .O(new_n144_));
  ...
  nand2  g099(.a(new_n151_), .b(new_n80_), .O(new_n152_));
  aoi21  g100(.a(new_n152_), .b(new_n150_), .c(new_n61_), .O(z14));
  nand2  g101(.a(new_n54_), .b(x12), .O(new_n154_));
  nand2  g102(.a(new_n111_), .b(x18), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand3  g104(.a(new_n156_), .b(x19), .c(new_n53_), .O(new_n157_));
  nand2  g105(.a(new_n147_), .b(new_n80_), .O(new_n158_));
  aoi21  g106(.a(new_n158_), .b(new_n157_), .c(new_n61_), .O(z15));
endmodule
