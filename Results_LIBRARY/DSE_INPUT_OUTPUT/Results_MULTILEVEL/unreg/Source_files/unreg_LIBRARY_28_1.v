...
module FAU ( 
  ...
  nand4  g34(.a(new_n86_), .b(x19), .c(x18), .d(new_n71_), .O(new_n87_));
  nand2  g35(.a(new_n87_), .b(new_n85_), .O(z06));
  ...
  nand4  g48(.a(new_n100_), .b(x19), .c(x18), .d(new_n71_), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(new_n99_), .O(z09));
  oai21  g50(.a(x31), .b(x17), .c(x18), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(x19), .O(new_n104_));
  nand2  g52(.a(new_n100_), .b(new_n55_), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(new_n104_), .O(z10));
  inv1   g54(.a(x31), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(new_n55_), .O(new_n108_));
  nand4  g56(.a(new_n76_), .b(x19), .c(x18), .d(new_n71_), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n108_), .O(z11));
  ...
  nand4  g66(.a(new_n118_), .b(x19), .c(x18), .d(new_n71_), .O(new_n119_));
  nand2  g67(.a(new_n119_), .b(new_n117_), .O(z13));
  oai21  g68(.a(x35), .b(x17), .c(x18), .O(new_n121_));
  nand2  g69(.a(new_n121_), .b(x19), .O(new_n122_));
  nand2  g70(.a(new_n118_), .b(new_n55_), .O(new_n123_));
  nand2  g71(.a(new_n123_), .b(new_n122_), .O(z14));
