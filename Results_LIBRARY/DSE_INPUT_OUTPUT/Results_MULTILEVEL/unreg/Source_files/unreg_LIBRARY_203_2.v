...
module FAU ( 
  ...
  oai21  g024(.a(new_n66_), .b(x16), .c(new_n61_), .O(new_n77_));
  ...
  oai21  g052(.a(new_n94_), .b(x16), .c(new_n61_), .O(new_n105_));
  ...
  oai21  g058(.a(new_n101_), .b(x16), .c(new_n61_), .O(new_n111_));
  ...
  oai21  g073(.a(new_n114_), .b(x16), .c(new_n61_), .O(new_n126_));
  ...
  oai21  g094(.a(new_n146_), .b(x16), .c(new_n61_), .O(new_n147_));
  ...
  oai21  g108(.a(new_n150_), .b(x16), .c(new_n61_), .O(new_n161_));
  ...
  oai21  g114(.a(new_n157_), .b(x16), .c(new_n61_), .O(new_n167_));
