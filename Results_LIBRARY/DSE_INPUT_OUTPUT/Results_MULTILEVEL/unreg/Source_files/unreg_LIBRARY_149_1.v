...
module FAU ( 
  ...
  oai21  g40(.a(x29), .b(x17), .c(x18), .O(new_n93_));
  ...
  inv1   g47(.a(x29), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(new_n55_), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(new_n99_), .O(z09));
  inv1   g50(.a(x30), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(new_n55_), .O(new_n104_));
  inv1   g52(.a(x31), .O(new_n105_));
  nand4  g53(.a(new_n105_), .b(x19), .c(x18), .d(new_n71_), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n104_), .O(z10));
  oai21  g55(.a(x24), .b(x17), .c(x18), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(x19), .O(new_n109_));
  nand2  g57(.a(new_n105_), .b(new_n55_), .O(new_n110_));
  nand2  g58(.a(new_n110_), .b(new_n109_), .O(z11));
  oai21  g59(.a(x33), .b(x17), .c(x18), .O(new_n112_));
  nand2  g60(.a(new_n112_), .b(x19), .O(new_n113_));
  inv1   g61(.a(x32), .O(new_n114_));
  nand2  g62(.a(new_n114_), .b(new_n55_), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(new_n113_), .O(z12));
  inv1   g64(.a(x33), .O(new_n117_));
  nand2  g65(.a(new_n117_), .b(new_n55_), .O(new_n118_));
  inv1   g66(.a(x34), .O(new_n119_));
  nand4  g67(.a(new_n119_), .b(x19), .c(x18), .d(new_n71_), .O(new_n120_));
  nand2  g68(.a(new_n120_), .b(new_n118_), .O(z13));
  nand2  g69(.a(new_n119_), .b(new_n55_), .O(new_n122_));
  inv1   g70(.a(x35), .O(new_n123_));
  nand4  g71(.a(new_n123_), .b(x19), .c(x18), .d(new_n71_), .O(new_n124_));
  nand2  g72(.a(new_n124_), .b(new_n122_), .O(z14));
  oai21  g73(.a(x28), .b(x17), .c(x18), .O(new_n126_));
  nand2  g74(.a(new_n126_), .b(x19), .O(new_n127_));
  nand2  g75(.a(new_n123_), .b(new_n55_), .O(new_n128_));
  nand2  g76(.a(new_n128_), .b(new_n127_), .O(z15));
endmodule
