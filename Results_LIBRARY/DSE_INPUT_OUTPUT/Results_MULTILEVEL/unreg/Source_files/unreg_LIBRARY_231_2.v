...
module FAU ( 
  ...
  nand4  g034(.a(new_n86_), .b(x24), .c(x19), .d(new_n78_), .O(new_n87_));
  nand2  g035(.a(new_n53_), .b(new_n60_), .O(new_n88_));
  nand2  g036(.a(new_n88_), .b(new_n87_), .O(z04));
  ...
  nand4  g047(.a(new_n99_), .b(x24), .c(x19), .d(new_n78_), .O(new_n100_));
  ...
  nand4  g074(.a(new_n126_), .b(x24), .c(x19), .d(new_n78_), .O(new_n127_));
  nand2  g075(.a(new_n119_), .b(new_n60_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n127_), .O(z10));
  nand2  g077(.a(new_n78_), .b(x08), .O(new_n130_));
  nand3  g078(.a(x24), .b(x19), .c(new_n54_), .O(new_n131_));
  oai22  g079(.a(new_n131_), .b(new_n130_), .c(x31), .d(x19), .O(z11));
  nand2  g080(.a(new_n54_), .b(x15), .O(new_n133_));
  oai21  g081(.a(x33), .b(new_n54_), .c(new_n133_), .O(new_n134_));
  nand4  g082(.a(new_n134_), .b(x24), .c(x19), .d(new_n78_), .O(new_n135_));
  ...
  nand4  g096(.a(new_n148_), .b(x24), .c(x19), .d(new_n78_), .O(new_n149_));
  ...
  nand2  g100(.a(new_n115_), .b(x18), .O(new_n153_));
