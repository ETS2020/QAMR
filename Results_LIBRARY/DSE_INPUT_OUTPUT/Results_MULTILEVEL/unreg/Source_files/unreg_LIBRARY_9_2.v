...
module FAU ( 
  ...
  nand4  g014(.a(new_n66_), .b(x33), .c(x19), .d(new_n64_), .O(new_n67_));
  ...
  nand4  g028(.a(new_n80_), .b(x33), .c(x19), .d(new_n64_), .O(new_n81_));
  ...
  nand4  g060(.a(new_n112_), .b(x33), .c(x19), .d(new_n64_), .O(new_n113_));
  ...
  nand4  g066(.a(new_n118_), .b(x33), .c(x19), .d(new_n64_), .O(new_n119_));
  ...
  nor2   g084(.a(x18), .b(x17), .O(new_n137_));
  aoi21  g085(.a(new_n137_), .b(x15), .c(new_n53_), .O(new_n138_));
  inv1   g086(.a(x32), .O(new_n139_));
  nand2  g087(.a(new_n139_), .b(new_n60_), .O(new_n140_));
  oai21  g088(.a(new_n138_), .b(new_n60_), .c(new_n140_), .O(z12));
  nand2  g089(.a(new_n54_), .b(x14), .O(new_n142_));
  oai21  g090(.a(x34), .b(new_n54_), .c(new_n142_), .O(new_n143_));
  nand3  g091(.a(new_n143_), .b(x19), .c(new_n64_), .O(new_n144_));
  nand2  g092(.a(new_n144_), .b(x33), .O(z13));
  ...
  nand4  g103(.a(new_n155_), .b(x33), .c(x19), .d(new_n64_), .O(new_n156_));
