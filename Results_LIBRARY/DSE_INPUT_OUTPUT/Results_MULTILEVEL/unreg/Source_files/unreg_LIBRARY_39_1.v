...
module FAU ( 
  ...
  nand3  g086(.a(new_n69_), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  ...
  nand2  g097(.a(new_n69_), .b(x18), .O(new_n150_));
  ...
  oai21  g112(.a(new_n164_), .b(x34), .c(new_n60_), .O(new_n165_));
