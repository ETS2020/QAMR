...
module FAU ( 
  ...
  nand3  g017(.a(x33), .b(new_n56_), .c(new_n60_), .O(new_n70_));
  ...
  nand3  g030(.a(x33), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g066(.a(x33), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  nand3  g073(.a(x33), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  oai21  g086(.a(new_n62_), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  nand2  g087(.a(new_n139_), .b(new_n138_), .O(z11));
  nand3  g088(.a(x19), .b(new_n54_), .c(x15), .O(new_n141_));
  nand2  g089(.a(new_n62_), .b(x18), .O(new_n142_));
  nand2  g090(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n53_), .O(new_n144_));
  nand2  g092(.a(x33), .b(x32), .O(new_n145_));
  ...
  nand2  g100(.a(new_n62_), .b(new_n60_), .O(new_n153_));
  ...
  nand3  g113(.a(new_n156_), .b(x33), .c(new_n60_), .O(new_n166_));
