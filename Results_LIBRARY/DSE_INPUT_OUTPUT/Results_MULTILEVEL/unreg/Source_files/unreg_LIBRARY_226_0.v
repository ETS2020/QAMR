...
module FAU ( 
  ...
  nand3  g024(.a(new_n65_), .b(new_n60_), .c(x12), .O(new_n77_));
  ...
  nand3  g030(.a(new_n73_), .b(new_n60_), .c(x12), .O(new_n83_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n60_), .c(x12), .O(new_n98_));
  ...
  oai21  g108(.a(new_n150_), .b(new_n69_), .c(new_n60_), .O(new_n161_));
