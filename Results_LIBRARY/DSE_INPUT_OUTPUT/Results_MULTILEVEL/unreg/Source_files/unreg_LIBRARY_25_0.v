...
module FAU ( 
  ...
  nand3  g072(.a(x30), .b(new_n114_), .c(new_n60_), .O(new_n125_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n62_), .c(new_n60_), .O(new_n137_));
  ...
  nand3  g106(.a(new_n148_), .b(x30), .c(new_n60_), .O(new_n159_));
