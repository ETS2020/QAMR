...
module FAU ( 
  ...
  nand4  g43(.a(new_n71_), .b(x19), .c(x18), .d(new_n53_), .O(new_n96_));
  ...
  nand4  g52(.a(new_n104_), .b(x19), .c(x18), .d(new_n53_), .O(new_n105_));
  oai21  g53(.a(x34), .b(x19), .c(new_n105_), .O(z14));
  oai21  g54(.a(x28), .b(x17), .c(x18), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(x19), .O(new_n108_));
  nand2  g56(.a(new_n104_), .b(new_n59_), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n108_), .O(z15));
endmodule
