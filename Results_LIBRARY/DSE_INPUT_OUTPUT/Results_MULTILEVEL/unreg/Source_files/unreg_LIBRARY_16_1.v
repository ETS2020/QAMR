...
module FAU ( 
  ...
  aoi21  g36(.a(new_n88_), .b(new_n53_), .c(new_n64_), .O(new_n89_));
  nand2  g37(.a(new_n85_), .b(new_n63_), .O(new_n90_));
  oai21  g38(.a(new_n89_), .b(new_n63_), .c(new_n90_), .O(z09));
  oai21  g39(.a(x31), .b(x17), .c(x18), .O(new_n92_));
  nand2  g40(.a(new_n92_), .b(x19), .O(new_n93_));
  nand2  g41(.a(new_n88_), .b(new_n63_), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(new_n93_), .O(z10));
  nand4  g43(.a(new_n70_), .b(x19), .c(x18), .d(new_n53_), .O(new_n96_));
  ...
  nand2  g48(.a(new_n100_), .b(new_n63_), .O(new_n101_));
  ...
  nand2  g55(.a(new_n103_), .b(new_n63_), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(new_n107_), .O(z14));
  inv1   g57(.a(x28), .O(new_n110_));
  nand4  g58(.a(new_n110_), .b(x19), .c(x18), .d(new_n53_), .O(new_n111_));
