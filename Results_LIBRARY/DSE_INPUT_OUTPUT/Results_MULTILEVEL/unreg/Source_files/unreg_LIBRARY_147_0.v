...
module FAU ( 
  ...
  oai21  g052(.a(new_n76_), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  oai21  g066(.a(new_n76_), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  nand2  g104(.a(new_n76_), .b(x18), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n53_), .O(new_n159_));
  oai21  g107(.a(new_n76_), .b(new_n150_), .c(new_n60_), .O(new_n160_));
  ...
  nand2  g113(.a(new_n76_), .b(new_n60_), .O(new_n166_));
