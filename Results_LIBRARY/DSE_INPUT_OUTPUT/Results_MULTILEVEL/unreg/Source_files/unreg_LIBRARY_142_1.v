...
module FAU ( 
  ...
  oai22  g46(.a(new_n98_), .b(new_n65_), .c(x31), .d(x19), .O(z11));
  inv1   g47(.a(x33), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(x19), .O(new_n101_));
  oai22  g49(.a(new_n101_), .b(new_n65_), .c(x32), .d(x19), .O(z12));
  inv1   g50(.a(x34), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(x19), .O(new_n104_));
  oai22  g52(.a(new_n104_), .b(new_n65_), .c(x33), .d(x19), .O(z13));
  inv1   g53(.a(x35), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(x19), .O(new_n107_));
  oai22  g55(.a(new_n107_), .b(new_n65_), .c(x34), .d(x19), .O(z14));
  nand2  g56(.a(new_n86_), .b(x19), .O(new_n109_));
  oai22  g57(.a(new_n109_), .b(new_n65_), .c(x35), .d(x19), .O(z15));
endmodule
