...
module FAU ( 
  ...
  nand2  g17(.a(new_n69_), .b(new_n59_), .O(new_n70_));
  oai21  g18(.a(new_n68_), .b(new_n59_), .c(new_n70_), .O(z04));
  aoi21  g19(.a(new_n53_), .b(x06), .c(x18), .O(new_n72_));
  inv1   g20(.a(x25), .O(new_n73_));
  nand2  g21(.a(new_n73_), .b(new_n59_), .O(new_n74_));
  oai21  g22(.a(new_n72_), .b(new_n59_), .c(new_n74_), .O(z05));
  aoi21  g23(.a(new_n53_), .b(x05), .c(x18), .O(new_n76_));
  inv1   g24(.a(x26), .O(new_n77_));
  nand2  g25(.a(new_n77_), .b(new_n59_), .O(new_n78_));
  oai21  g26(.a(new_n76_), .b(new_n59_), .c(new_n78_), .O(z06));
  nand4  g27(.a(x19), .b(new_n54_), .c(new_n53_), .d(x04), .O(new_n80_));
  ...
  oai21  g36(.a(new_n86_), .b(new_n59_), .c(new_n88_), .O(z10));
  aoi21  g37(.a(new_n53_), .b(x08), .c(x18), .O(new_n90_));
  inv1   g38(.a(x31), .O(new_n91_));
  nand2  g39(.a(new_n91_), .b(new_n59_), .O(new_n92_));
  oai21  g40(.a(new_n90_), .b(new_n59_), .c(new_n92_), .O(z11));
  aoi21  g41(.a(new_n53_), .b(x15), .c(x18), .O(new_n94_));
  inv1   g42(.a(x32), .O(new_n95_));
  nand2  g43(.a(new_n95_), .b(new_n59_), .O(new_n96_));
  oai21  g44(.a(new_n94_), .b(new_n59_), .c(new_n96_), .O(z12));
  ...
  oai21  g50(.a(new_n100_), .b(new_n59_), .c(new_n102_), .O(z14));
