...
module FAU ( 
  ...
  nand3  g023(.a(new_n62_), .b(new_n66_), .c(new_n60_), .O(new_n76_));
  ...
  oai21  g065(.a(new_n117_), .b(x23), .c(new_n60_), .O(new_n118_));
  ...
  oai21  g085(.a(new_n128_), .b(x23), .c(new_n60_), .O(new_n138_));
  ...
  oai21  g107(.a(new_n149_), .b(x23), .c(new_n60_), .O(new_n160_));
