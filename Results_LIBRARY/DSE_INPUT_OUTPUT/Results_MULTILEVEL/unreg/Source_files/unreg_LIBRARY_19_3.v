...
module FAU ( 
  ...
  nand3  g021(.a(new_n73_), .b(new_n71_), .c(new_n53_), .O(new_n74_));
  ...
  nand3  g070(.a(new_n122_), .b(new_n120_), .c(new_n53_), .O(new_n123_));
  ...
  nand3  g111(.a(new_n163_), .b(new_n162_), .c(new_n53_), .O(new_n164_));
