...
module FAU ( 
  ...
  nand2  g27(.a(new_n79_), .b(new_n55_), .O(new_n80_));
  inv1   g28(.a(x26), .O(new_n81_));
  nand4  g29(.a(new_n81_), .b(x19), .c(x18), .d(new_n71_), .O(new_n82_));
  nand2  g30(.a(new_n82_), .b(new_n80_), .O(z05));
  oai21  g31(.a(x27), .b(x17), .c(x18), .O(new_n84_));
  nand2  g32(.a(new_n84_), .b(x19), .O(new_n85_));
  nand2  g33(.a(new_n81_), .b(new_n55_), .O(new_n86_));
  nand2  g34(.a(new_n86_), .b(new_n85_), .O(z06));
  ...
  nand4  g52(.a(new_n104_), .b(x19), .c(x18), .d(new_n71_), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(new_n103_), .O(z10));
  nand2  g54(.a(new_n104_), .b(new_n55_), .O(new_n107_));
  nand4  g55(.a(new_n76_), .b(x19), .c(x18), .d(new_n71_), .O(new_n108_));
  ...
  nand4  g60(.a(new_n112_), .b(x19), .c(x18), .d(new_n71_), .O(new_n113_));
  ...
  nand4  g71(.a(new_n94_), .b(x19), .c(x18), .d(new_n71_), .O(new_n124_));
