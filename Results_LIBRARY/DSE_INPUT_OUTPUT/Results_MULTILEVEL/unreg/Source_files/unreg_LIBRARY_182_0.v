...
module FAU ( 
  ...
  nand3  g009(.a(x32), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  nand3  g016(.a(x32), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  nand3  g066(.a(x32), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  nand3  g086(.a(x32), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  ...
  nand2  g093(.a(new_n76_), .b(new_n60_), .O(new_n146_));
  ...
  oai21  g100(.a(new_n142_), .b(new_n76_), .c(new_n60_), .O(new_n153_));
