...
module FAU ( 
  ...
  nand3  g009(.a(x26), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  nand3  g016(.a(x26), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  nand3  g023(.a(x26), .b(new_n65_), .c(new_n60_), .O(new_n76_));
  ...
  inv1   g029(.a(x26), .O(new_n82_));
  oai21  g030(.a(new_n82_), .b(new_n72_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g056(.a(new_n100_), .b(new_n82_), .c(new_n60_), .O(new_n109_));
  ...
  oai21  g064(.a(new_n116_), .b(new_n82_), .c(new_n60_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n112_), .b(x26), .c(new_n60_), .O(new_n124_));
  ...
  oai21  g084(.a(new_n127_), .b(new_n82_), .c(new_n60_), .O(new_n137_));
  ...
  oai21  g099(.a(new_n140_), .b(new_n82_), .c(new_n60_), .O(new_n152_));
  ...
  nand3  g112(.a(new_n155_), .b(x26), .c(new_n60_), .O(new_n165_));
