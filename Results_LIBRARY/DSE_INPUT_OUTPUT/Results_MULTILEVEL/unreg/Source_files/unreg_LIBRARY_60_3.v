...
module FAU ( 
  ...
  oai21  g031(.a(new_n83_), .b(x27), .c(x19), .O(new_n84_));
  ...
  oai21  g039(.a(new_n91_), .b(x27), .c(x19), .O(new_n92_));
  nand2  g040(.a(new_n81_), .b(new_n59_), .O(new_n93_));
  nand2  g041(.a(new_n93_), .b(new_n92_), .O(z05));
  inv1   g042(.a(x05), .O(new_n95_));
  nand2  g043(.a(new_n55_), .b(new_n95_), .O(new_n96_));
  nand4  g044(.a(new_n96_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n97_));
  oai21  g045(.a(x26), .b(x19), .c(new_n97_), .O(z06));
  ...
  oai21  g049(.a(new_n101_), .b(x27), .c(x19), .O(new_n102_));
  nand2  g050(.a(new_n54_), .b(new_n59_), .O(new_n103_));
  ...
  nand4  g060(.a(new_n112_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n113_));
  ...
  oai21  g065(.a(x31), .b(new_n55_), .c(new_n117_), .O(new_n118_));
  nand4  g066(.a(new_n118_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n119_));
  ...
  oai21  g093(.a(new_n145_), .b(x27), .c(x19), .O(new_n146_));
