...
module FAU ( 
  ...
  nand4  g70(.a(new_n122_), .b(x19), .c(x18), .d(new_n56_), .O(new_n123_));
  nand2  g71(.a(new_n123_), .b(new_n121_), .O(z14));
  oai21  g72(.a(x28), .b(x17), .c(x18), .O(new_n125_));
  nand2  g73(.a(new_n125_), .b(x19), .O(new_n126_));
  nand2  g74(.a(new_n122_), .b(new_n53_), .O(new_n127_));
  nand2  g75(.a(new_n127_), .b(new_n126_), .O(z15));
endmodule
