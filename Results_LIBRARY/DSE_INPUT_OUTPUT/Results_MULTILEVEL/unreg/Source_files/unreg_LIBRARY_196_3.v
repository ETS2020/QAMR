...
module FAU ( 
  ...
  nand2  g23(.a(new_n75_), .b(new_n59_), .O(new_n76_));
  oai21  g24(.a(new_n74_), .b(new_n59_), .c(new_n76_), .O(z06));
  aoi21  g25(.a(new_n53_), .b(x04), .c(x18), .O(new_n78_));
  inv1   g26(.a(x27), .O(new_n79_));
  nand2  g27(.a(new_n79_), .b(new_n59_), .O(new_n80_));
  oai21  g28(.a(new_n78_), .b(new_n59_), .c(new_n80_), .O(z07));
  ...
  oai21  g34(.a(new_n84_), .b(new_n59_), .c(new_n86_), .O(z09));
  nand4  g35(.a(x19), .b(new_n54_), .c(new_n53_), .d(x09), .O(new_n88_));
  ...
  nand2  g45(.a(new_n97_), .b(new_n59_), .O(new_n98_));
  oai21  g46(.a(new_n96_), .b(new_n59_), .c(new_n98_), .O(z13));
