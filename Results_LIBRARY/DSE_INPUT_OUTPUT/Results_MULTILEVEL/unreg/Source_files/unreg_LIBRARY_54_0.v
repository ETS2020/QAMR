...
module FAU ( 
  ...
  nand3  g038(.a(x32), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g099(.a(new_n142_), .b(new_n62_), .c(new_n60_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n148_), .b(x32), .c(new_n60_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n155_), .b(x32), .c(new_n60_), .O(new_n165_));
