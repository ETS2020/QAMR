...
module FAU ( 
  ...
  oai21  g043(.a(new_n95_), .b(new_n68_), .c(x19), .O(new_n96_));
  ...
  nand2  g051(.a(new_n93_), .b(new_n58_), .O(new_n104_));
  ...
  nand4  g063(.a(new_n115_), .b(x25), .c(x19), .d(new_n53_), .O(new_n116_));
  ...
  nand4  g068(.a(new_n120_), .b(x25), .c(x19), .d(new_n53_), .O(new_n121_));
  ...
  nand2  g073(.a(new_n85_), .b(x18), .O(new_n126_));
  aoi21  g074(.a(new_n126_), .b(new_n125_), .c(x17), .O(new_n127_));
  oai21  g075(.a(new_n127_), .b(new_n68_), .c(x19), .O(new_n128_));
  ...
  nand4  g094(.a(new_n146_), .b(x25), .c(x19), .d(new_n53_), .O(new_n147_));
