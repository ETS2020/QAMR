...
module FAU ( 
  ...
  oai21  g040(.a(new_n92_), .b(x34), .c(x19), .O(new_n93_));
  ...
  oai21  g052(.a(new_n104_), .b(x34), .c(x19), .O(new_n105_));
  ...
  oai21  g066(.a(new_n118_), .b(x34), .c(x19), .O(new_n119_));
  ...
  oai21  g074(.a(new_n126_), .b(x34), .c(x19), .O(new_n127_));
  ...
  oai21  g080(.a(new_n132_), .b(x34), .c(x19), .O(new_n133_));
  nand2  g081(.a(new_n124_), .b(new_n59_), .O(new_n134_));
  ...
  nor2   g091(.a(x18), .b(x14), .O(new_n144_));
  oai21  g092(.a(new_n144_), .b(x17), .c(new_n54_), .O(new_n145_));
  nand2  g093(.a(new_n145_), .b(x19), .O(new_n146_));
  ...
  aoi21  g099(.a(new_n151_), .b(x19), .c(x34), .O(z14));
