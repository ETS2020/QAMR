...
module FAU ( 
  ...
  nand4  g034(.a(new_n86_), .b(x30), .c(x19), .d(new_n78_), .O(new_n87_));
  ...
  nand2  g067(.a(new_n78_), .b(x10), .O(new_n120_));
  nand3  g068(.a(x30), .b(x19), .c(new_n54_), .O(new_n121_));
  ...
  nand4  g072(.a(new_n124_), .b(x30), .c(x19), .d(new_n78_), .O(new_n125_));
  nand2  g073(.a(new_n53_), .b(new_n60_), .O(new_n126_));
  ...
  oai21  g086(.a(new_n138_), .b(new_n53_), .c(x19), .O(new_n139_));
  ...
  nand4  g092(.a(new_n144_), .b(x30), .c(x19), .d(new_n78_), .O(new_n145_));
  nand2  g093(.a(new_n136_), .b(new_n60_), .O(new_n146_));
  ...
  nand4  g097(.a(new_n149_), .b(x30), .c(x19), .d(new_n78_), .O(new_n150_));
  ...
  nand2  g102(.a(new_n117_), .b(x18), .O(new_n155_));
