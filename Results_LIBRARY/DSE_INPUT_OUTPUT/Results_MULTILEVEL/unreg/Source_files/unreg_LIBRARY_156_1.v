...
module FAU ( 
  ...
  nand4  g019(.a(new_n71_), .b(x19), .c(new_n64_), .d(x00), .O(new_n72_));
  ...
  aoi21  g024(.a(x18), .b(new_n76_), .c(x17), .O(new_n77_));
  oai21  g025(.a(new_n77_), .b(new_n53_), .c(x19), .O(new_n78_));
  ...
  nand4  g029(.a(new_n81_), .b(x19), .c(new_n64_), .d(x00), .O(new_n82_));
  ...
  nand4  g035(.a(new_n87_), .b(x19), .c(new_n64_), .d(x00), .O(new_n88_));
  ...
  nand4  g063(.a(new_n115_), .b(x19), .c(new_n64_), .d(x00), .O(new_n116_));
  nand2  g064(.a(new_n107_), .b(new_n60_), .O(new_n117_));
  ...
  nand4  g076(.a(new_n128_), .b(x19), .c(new_n64_), .d(x00), .O(new_n129_));
  ...
  nand4  g081(.a(new_n133_), .b(x19), .c(new_n64_), .d(x00), .O(new_n134_));
  ...
  nand4  g087(.a(new_n139_), .b(x19), .c(new_n64_), .d(x00), .O(new_n140_));
  ...
  nand4  g093(.a(new_n145_), .b(x19), .c(new_n64_), .d(x00), .O(new_n146_));
