...
module FAU ( 
  ...
  aoi21  g028(.a(new_n80_), .b(new_n64_), .c(x12), .O(new_n81_));
  ...
  oai21  g035(.a(new_n87_), .b(x12), .c(x19), .O(new_n88_));
  ...
  oai21  g043(.a(new_n95_), .b(x12), .c(x19), .O(new_n96_));
  ...
  oai21  g050(.a(new_n102_), .b(x12), .c(x19), .O(new_n103_));
  ...
  nand4  g055(.a(new_n107_), .b(x19), .c(new_n64_), .d(new_n63_), .O(new_n108_));
  ...
  nand4  g060(.a(new_n112_), .b(x19), .c(new_n64_), .d(new_n63_), .O(new_n113_));
  ...
  oai21  g074(.a(new_n126_), .b(x12), .c(x19), .O(new_n127_));
  ...
  nand4  g080(.a(new_n132_), .b(x19), .c(new_n64_), .d(new_n63_), .O(new_n133_));
  ...
  oai21  g101(.a(new_n153_), .b(x12), .c(x19), .O(new_n154_));
  nand2  g102(.a(new_n143_), .b(new_n59_), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n154_), .O(z14));
  nand2  g104(.a(new_n64_), .b(new_n63_), .O(new_n157_));
  nand3  g105(.a(new_n114_), .b(x19), .c(x18), .O(new_n158_));
