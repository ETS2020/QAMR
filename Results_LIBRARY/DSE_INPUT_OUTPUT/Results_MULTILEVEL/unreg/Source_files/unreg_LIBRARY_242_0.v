...
module FAU ( 
  ...
  nand3  g009(.a(x21), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g050(.a(new_n92_), .b(new_n56_), .c(new_n60_), .O(new_n103_));
  ...
  nand3  g064(.a(new_n116_), .b(x21), .c(new_n60_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n112_), .b(x21), .c(new_n60_), .O(new_n124_));
  ...
  oai21  g084(.a(new_n127_), .b(new_n56_), .c(new_n60_), .O(new_n137_));
