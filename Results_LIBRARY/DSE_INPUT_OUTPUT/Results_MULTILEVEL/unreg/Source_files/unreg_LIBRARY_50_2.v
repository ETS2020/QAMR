...
module FAU ( 
  ...
  oai21  g030(.a(new_n72_), .b(x14), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g038(.a(new_n90_), .b(x14), .c(new_n60_), .O(new_n91_));
  ...
  nand3  g052(.a(new_n94_), .b(new_n60_), .c(new_n76_), .O(new_n105_));
  ...
  oai21  g058(.a(new_n101_), .b(x14), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n60_), .c(new_n76_), .O(new_n119_));
  ...
  oai21  g094(.a(new_n146_), .b(x14), .c(new_n60_), .O(new_n147_));
  ...
  oai21  g108(.a(new_n150_), .b(x14), .c(new_n60_), .O(new_n161_));
  ...
  nand3  g114(.a(new_n157_), .b(new_n60_), .c(new_n76_), .O(new_n167_));
