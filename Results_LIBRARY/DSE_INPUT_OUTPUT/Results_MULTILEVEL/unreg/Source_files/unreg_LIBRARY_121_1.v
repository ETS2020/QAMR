...
module FAU ( 
  ...
  oai21  g023(.a(x29), .b(new_n65_), .c(new_n60_), .O(new_n76_));
  ...
  oai21  g038(.a(x29), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  nand3  g052(.a(new_n82_), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g058(.a(new_n82_), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  nand2  g059(.a(new_n111_), .b(new_n110_), .O(z07));
  nand2  g060(.a(new_n54_), .b(x11), .O(new_n113_));
  nand2  g061(.a(new_n82_), .b(x18), .O(new_n114_));
  ...
  nand3  g065(.a(new_n82_), .b(new_n117_), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g084(.a(new_n126_), .b(new_n82_), .c(new_n60_), .O(new_n137_));
  ...
  nand3  g092(.a(new_n144_), .b(new_n82_), .c(new_n60_), .O(new_n145_));
  ...
  nand3  g099(.a(new_n140_), .b(new_n82_), .c(new_n60_), .O(new_n152_));
  ...
  oai21  g106(.a(new_n148_), .b(x29), .c(new_n60_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n155_), .b(new_n82_), .c(new_n60_), .O(new_n165_));
