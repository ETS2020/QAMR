...
module FAU ( 
  ...
  nand3  g017(.a(new_n56_), .b(new_n61_), .c(new_n60_), .O(new_n70_));
  ...
  oai21  g030(.a(new_n73_), .b(x03), .c(new_n61_), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n61_), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g052(.a(new_n94_), .b(x03), .c(new_n61_), .O(new_n105_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n61_), .c(new_n60_), .O(new_n111_));
  ...
  oai21  g094(.a(new_n146_), .b(x03), .c(new_n61_), .O(new_n147_));
  ...
  oai21  g101(.a(new_n142_), .b(x03), .c(new_n61_), .O(new_n154_));
  ...
  oai21  g108(.a(new_n150_), .b(x03), .c(new_n61_), .O(new_n161_));
  ...
  oai21  g114(.a(new_n157_), .b(x03), .c(new_n61_), .O(new_n167_));
