...
module FAU ( 
  ...
  nand3  g017(.a(new_n56_), .b(new_n61_), .c(x03), .O(new_n70_));
  ...
  nand3  g024(.a(new_n66_), .b(new_n61_), .c(x03), .O(new_n77_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n61_), .c(x03), .O(new_n111_));
  ...
  nand3  g080(.a(new_n122_), .b(new_n61_), .c(x03), .O(new_n133_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n61_), .c(x03), .O(new_n139_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n61_), .c(x03), .O(new_n147_));
  ...
  nand3  g101(.a(new_n142_), .b(new_n61_), .c(x03), .O(new_n154_));
  ...
  nand3  g108(.a(new_n150_), .b(new_n61_), .c(x03), .O(new_n161_));
