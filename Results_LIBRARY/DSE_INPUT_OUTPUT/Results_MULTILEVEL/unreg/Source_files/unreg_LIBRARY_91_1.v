...
module FAU ( 
  ...
  nand4  g39(.a(new_n91_), .b(x19), .c(x18), .d(new_n66_), .O(new_n92_));
  ...
  nand2  g44(.a(new_n96_), .b(new_n95_), .O(z09));
  ...
  nand4  g68(.a(new_n120_), .b(x19), .c(x18), .d(new_n66_), .O(new_n121_));
  nand2  g69(.a(new_n121_), .b(new_n119_), .O(z14));
  nand2  g70(.a(new_n120_), .b(new_n55_), .O(new_n123_));
  nand4  g71(.a(new_n89_), .b(x19), .c(x18), .d(new_n66_), .O(new_n124_));
