...
module FAU ( 
  ...
  aoi21  g025(.a(new_n77_), .b(new_n53_), .c(x26), .O(new_n78_));
  inv1   g026(.a(x23), .O(new_n79_));
  nand2  g027(.a(new_n79_), .b(new_n59_), .O(new_n80_));
  oai21  g028(.a(new_n78_), .b(new_n59_), .c(new_n80_), .O(z03));
  ...
  oai21  g033(.a(new_n85_), .b(x26), .c(x19), .O(new_n86_));
  inv1   g034(.a(x24), .O(new_n87_));
  nand2  g035(.a(new_n87_), .b(new_n59_), .O(new_n88_));
  nand2  g036(.a(new_n88_), .b(new_n86_), .O(z04));
  nor2   g037(.a(x18), .b(x06), .O(new_n90_));
  oai21  g038(.a(new_n90_), .b(x17), .c(new_n54_), .O(new_n91_));
  nand2  g039(.a(new_n91_), .b(x19), .O(new_n92_));
  ...
  aoi21  g045(.a(new_n97_), .b(x19), .c(x26), .O(z06));
  ...
  oai21  g049(.a(new_n101_), .b(x26), .c(x19), .O(new_n102_));
  ...
  oai21  g057(.a(new_n109_), .b(x26), .c(x19), .O(new_n110_));
  ...
  nand4  g068(.a(new_n120_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n121_));
  ...
  oai21  g075(.a(new_n127_), .b(x26), .c(x19), .O(new_n128_));
  ...
  oai21  g083(.a(new_n135_), .b(x26), .c(x19), .O(new_n136_));
  ...
  oai21  g091(.a(new_n143_), .b(x26), .c(x19), .O(new_n144_));
  ...
  nand4  g101(.a(new_n153_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n154_));
