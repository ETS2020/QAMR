...
module FAU ( 
  ...
  nand3  g038(.a(new_n90_), .b(new_n61_), .c(x08), .O(new_n91_));
  ...
  nand3  g052(.a(new_n94_), .b(new_n61_), .c(x08), .O(new_n105_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n61_), .c(x08), .O(new_n126_));
  ...
  nand3  g080(.a(new_n122_), .b(new_n61_), .c(x08), .O(new_n133_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n61_), .c(x08), .O(new_n147_));
  ...
  nand3  g114(.a(new_n157_), .b(new_n61_), .c(x08), .O(new_n167_));
