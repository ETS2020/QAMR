...
module FAU ( 
  ...
  oai21  g038(.a(x34), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g066(.a(x34), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  nand3  g100(.a(new_n62_), .b(new_n142_), .c(new_n60_), .O(new_n153_));
  ...
  oai21  g113(.a(new_n156_), .b(x34), .c(new_n60_), .O(new_n166_));
