...
module FAU ( 
  ...
  nand2  g029(.a(new_n62_), .b(new_n60_), .O(new_n82_));
  ...
  nand3  g037(.a(new_n89_), .b(x23), .c(new_n60_), .O(new_n90_));
  ...
  oai21  g044(.a(new_n85_), .b(new_n62_), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n93_), .b(x23), .c(new_n60_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n100_), .b(x23), .c(new_n60_), .O(new_n110_));
  ...
  oai21  g065(.a(new_n117_), .b(new_n62_), .c(new_n60_), .O(new_n118_));
  ...
  oai21  g072(.a(new_n113_), .b(new_n62_), .c(new_n60_), .O(new_n125_));
  ...
  nand3  g079(.a(new_n121_), .b(x23), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g093(.a(new_n145_), .b(x23), .c(new_n60_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n141_), .b(x23), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n149_), .b(x23), .c(new_n60_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n156_), .b(x23), .c(new_n60_), .O(new_n166_));
