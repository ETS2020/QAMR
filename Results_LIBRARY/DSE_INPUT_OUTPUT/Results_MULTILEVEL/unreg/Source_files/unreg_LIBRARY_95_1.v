...
module FAU ( 
  ...
  nand4  g54(.a(new_n72_), .b(x19), .c(x18), .d(new_n61_), .O(new_n107_));
  ...
  nand4  g59(.a(new_n111_), .b(x19), .c(x18), .d(new_n61_), .O(new_n112_));
  nand2  g60(.a(new_n112_), .b(new_n110_), .O(z12));
  nand2  g61(.a(new_n111_), .b(new_n55_), .O(new_n114_));
  inv1   g62(.a(x34), .O(new_n115_));
  nand4  g63(.a(new_n115_), .b(x19), .c(x18), .d(new_n61_), .O(new_n116_));
