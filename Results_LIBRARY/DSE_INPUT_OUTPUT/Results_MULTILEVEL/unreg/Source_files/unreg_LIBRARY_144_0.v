...
module FAU ( 
  ...
  oai21  g037(.a(new_n89_), .b(new_n65_), .c(new_n60_), .O(new_n90_));
  ...
  oai21  g057(.a(new_n100_), .b(new_n65_), .c(new_n60_), .O(new_n110_));
  ...
  nand3  g085(.a(new_n128_), .b(x22), .c(new_n60_), .O(new_n138_));
  ...
  nand2  g092(.a(x32), .b(x22), .O(new_n145_));
