...
module FAU ( 
  ...
  oai21  g009(.a(new_n61_), .b(x12), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g016(.a(new_n56_), .b(x12), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(new_n65_), .b(x12), .c(new_n60_), .O(new_n76_));
  ...
  oai21  g045(.a(new_n86_), .b(x12), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g052(.a(new_n94_), .b(new_n60_), .c(new_n82_), .O(new_n105_));
  ...
  oai21  g058(.a(new_n101_), .b(x12), .c(new_n60_), .O(new_n111_));
  ...
  oai21  g066(.a(new_n118_), .b(x12), .c(new_n60_), .O(new_n119_));
  ...
  oai21  g073(.a(new_n114_), .b(x12), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g080(.a(new_n122_), .b(new_n60_), .c(new_n82_), .O(new_n133_));
  ...
  oai21  g086(.a(new_n129_), .b(x12), .c(new_n60_), .O(new_n139_));
  ...
  oai21  g108(.a(new_n150_), .b(x12), .c(new_n60_), .O(new_n161_));
  ...
  nand3  g114(.a(new_n157_), .b(new_n60_), .c(new_n82_), .O(new_n167_));
