...
module FAU ( 
  ...
  nand2  g52(.a(new_n104_), .b(new_n55_), .O(new_n105_));
  nand4  g53(.a(new_n73_), .b(x19), .c(x18), .d(new_n66_), .O(new_n106_));
  ...
  nand2  g68(.a(new_n120_), .b(new_n55_), .O(new_n121_));
  ...
  nand2  g73(.a(new_n125_), .b(new_n55_), .O(new_n126_));
