...
module FAU ( 
  ...
  aoi21  g029(.a(new_n81_), .b(new_n78_), .c(new_n53_), .O(new_n82_));
  nand2  g030(.a(new_n72_), .b(new_n60_), .O(new_n83_));
  oai21  g031(.a(new_n82_), .b(new_n60_), .c(new_n83_), .O(z03));
  ...
  oai21  g036(.a(new_n88_), .b(new_n53_), .c(x19), .O(new_n89_));
  ...
  nand4  g042(.a(new_n94_), .b(x35), .c(x19), .d(new_n78_), .O(new_n95_));
  nand2  g043(.a(new_n86_), .b(new_n60_), .O(new_n96_));
  ...
  oai21  g049(.a(new_n101_), .b(new_n53_), .c(x19), .O(new_n102_));
  ...
  nand4  g055(.a(new_n107_), .b(x35), .c(x19), .d(new_n78_), .O(new_n108_));
  ...
  oai21  g062(.a(new_n114_), .b(new_n53_), .c(x19), .O(new_n115_));
  ...
  nand4  g068(.a(new_n120_), .b(x35), .c(x19), .d(new_n78_), .O(new_n121_));
  ...
  oai21  g080(.a(x24), .b(new_n54_), .c(new_n132_), .O(new_n133_));
  nand4  g081(.a(new_n133_), .b(x35), .c(x19), .d(new_n78_), .O(new_n134_));
  ...
  oai21  g096(.a(new_n148_), .b(new_n53_), .c(x19), .O(new_n149_));
  nand2  g097(.a(new_n138_), .b(new_n60_), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n149_), .O(z13));
  nand2  g099(.a(new_n78_), .b(x13), .O(new_n152_));
  nand3  g100(.a(x35), .b(x19), .c(new_n54_), .O(new_n153_));
  oai22  g101(.a(new_n153_), .b(new_n152_), .c(x34), .d(x19), .O(z14));
  nand2  g102(.a(new_n54_), .b(x12), .O(new_n155_));
  oai21  g103(.a(x28), .b(new_n54_), .c(new_n155_), .O(new_n156_));
  nand4  g104(.a(new_n156_), .b(x35), .c(x19), .d(new_n78_), .O(new_n157_));
  nand2  g105(.a(new_n53_), .b(new_n60_), .O(new_n158_));
