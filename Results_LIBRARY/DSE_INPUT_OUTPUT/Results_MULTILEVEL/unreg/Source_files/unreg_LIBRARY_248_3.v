...
module FAU ( 
  ...
  aoi21  g051(.a(new_n60_), .b(x27), .c(x19), .O(new_n104_));
  ...
  aoi21  g072(.a(new_n114_), .b(new_n118_), .c(new_n61_), .O(new_n125_));
  ...
  nand2  g086(.a(new_n138_), .b(new_n118_), .O(new_n139_));
  ...
  nand2  g093(.a(new_n134_), .b(new_n118_), .O(new_n146_));
  aoi21  g094(.a(new_n146_), .b(new_n145_), .c(new_n61_), .O(z13));
  ...
  nand2  g100(.a(new_n142_), .b(new_n118_), .O(new_n153_));
  aoi21  g101(.a(new_n153_), .b(new_n152_), .c(new_n61_), .O(z14));
  ...
  aoi21  g105(.a(new_n149_), .b(new_n118_), .c(new_n61_), .O(new_n158_));
