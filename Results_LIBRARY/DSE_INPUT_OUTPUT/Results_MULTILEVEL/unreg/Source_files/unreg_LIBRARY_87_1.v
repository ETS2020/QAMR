...
module FAU ( 
  ...
  nand4  g20(.a(new_n72_), .b(x19), .c(x18), .d(new_n53_), .O(new_n73_));
  oai21  g21(.a(x25), .b(x19), .c(new_n73_), .O(z05));
  ...
  oai21  g27(.a(x27), .b(x19), .c(new_n79_), .O(z07));
  inv1   g28(.a(x29), .O(new_n81_));
  aoi21  g29(.a(new_n81_), .b(new_n53_), .c(new_n61_), .O(new_n82_));
  inv1   g30(.a(x28), .O(new_n83_));
  nand2  g31(.a(new_n83_), .b(new_n60_), .O(new_n84_));
  oai21  g32(.a(new_n82_), .b(new_n60_), .c(new_n84_), .O(z08));
  oai21  g33(.a(x30), .b(x17), .c(x18), .O(new_n86_));
  nand2  g34(.a(new_n86_), .b(x19), .O(new_n87_));
  nand2  g35(.a(new_n81_), .b(new_n60_), .O(new_n88_));
  ...
  nand2  g42(.a(new_n90_), .b(new_n60_), .O(new_n95_));
  ...
  aoi21  g56(.a(new_n83_), .b(new_n53_), .c(new_n61_), .O(new_n109_));
