// Benchmark "FAU" written by ABC on Fri Aug 14 02:05:32 2020
...
module FAU ( 
  ...
  oai21  g009(.a(new_n61_), .b(x10), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g016(.a(new_n56_), .b(x10), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(new_n65_), .b(x10), .c(new_n60_), .O(new_n76_));
  ...
  oai21  g029(.a(new_n72_), .b(x10), .c(new_n60_), .O(new_n82_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n60_), .c(new_n89_), .O(new_n91_));
  nand2  g039(.a(new_n91_), .b(new_n88_), .O(z04));
  ...
  oai21  g045(.a(new_n85_), .b(x10), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g052(.a(new_n94_), .b(x10), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n60_), .c(new_n89_), .O(new_n111_));
  ...
  oai21  g066(.a(new_n118_), .b(x10), .c(new_n60_), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n117_), .O(z08));
  oai21  g068(.a(x18), .b(x17), .c(x19), .O(new_n121_));
  nand2  g069(.a(new_n121_), .b(x10), .O(new_n122_));
  nand2  g070(.a(new_n114_), .b(new_n60_), .O(new_n123_));
  inv1   g071(.a(x30), .O(new_n124_));
  nand4  g072(.a(new_n124_), .b(x19), .c(x18), .d(new_n53_), .O(new_n125_));
  nand3  g073(.a(new_n125_), .b(new_n123_), .c(new_n122_), .O(z09));
  ...
  nand3  g079(.a(new_n124_), .b(new_n60_), .c(new_n89_), .O(new_n132_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n60_), .c(new_n89_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n60_), .c(new_n89_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n60_), .c(new_n89_), .O(new_n153_));
