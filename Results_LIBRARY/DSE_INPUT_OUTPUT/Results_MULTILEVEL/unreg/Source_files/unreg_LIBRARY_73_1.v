...
module FAU ( 
  ...
  oai21  g029(.a(new_n72_), .b(x22), .c(new_n60_), .O(new_n82_));
  ...
  nand3  g037(.a(new_n89_), .b(new_n65_), .c(new_n60_), .O(new_n90_));
  ...
  oai21  g072(.a(new_n113_), .b(x22), .c(new_n60_), .O(new_n125_));
  ...
  nand3  g079(.a(new_n121_), .b(new_n65_), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n65_), .c(new_n60_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n65_), .c(new_n60_), .O(new_n146_));
  ...
  nand3  g107(.a(new_n149_), .b(new_n65_), .c(new_n60_), .O(new_n160_));
