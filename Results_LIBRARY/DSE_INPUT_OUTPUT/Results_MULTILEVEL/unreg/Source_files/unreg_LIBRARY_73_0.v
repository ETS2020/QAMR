...
module FAU ( 
  ...
  nand3  g012(.a(x19), .b(new_n54_), .c(x02), .O(new_n65_));
  ...
  oai21  g016(.a(new_n62_), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g028(.a(new_n72_), .b(new_n62_), .c(new_n60_), .O(new_n81_));
  ...
  nand3  g043(.a(new_n84_), .b(x22), .c(new_n60_), .O(new_n96_));
  ...
  nand3  g064(.a(new_n116_), .b(x22), .c(new_n60_), .O(new_n117_));
  ...
  nand3  g078(.a(new_n120_), .b(x22), .c(new_n60_), .O(new_n131_));
  ...
  nand3  g106(.a(new_n148_), .b(x22), .c(new_n60_), .O(new_n159_));
