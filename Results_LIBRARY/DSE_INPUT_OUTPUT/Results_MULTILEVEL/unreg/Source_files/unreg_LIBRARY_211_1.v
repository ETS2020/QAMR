...
module FAU ( 
  ...
  nand4  g50(.a(new_n102_), .b(x19), .c(x18), .d(new_n66_), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(new_n101_), .O(z10));
  nand2  g52(.a(new_n102_), .b(new_n55_), .O(new_n105_));
  nand4  g53(.a(new_n75_), .b(x19), .c(x18), .d(new_n66_), .O(new_n106_));
  ...
  nand4  g58(.a(new_n110_), .b(x19), .c(x18), .d(new_n66_), .O(new_n111_));
