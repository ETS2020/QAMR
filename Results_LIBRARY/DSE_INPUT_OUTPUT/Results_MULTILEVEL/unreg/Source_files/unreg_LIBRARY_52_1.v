// Benchmark "FAU" written by ABC on Fri Aug 14 02:04:48 2020
...
module FAU ( 
  ...
  nand4  g014(.a(new_n66_), .b(x19), .c(new_n64_), .d(x00), .O(new_n67_));
  ...
  oai21  g021(.a(new_n73_), .b(new_n53_), .c(x19), .O(new_n74_));
  ...
  aoi21  g026(.a(x18), .b(new_n78_), .c(x17), .O(new_n79_));
  oai21  g027(.a(new_n79_), .b(new_n53_), .c(x19), .O(new_n80_));
  ...
  nand4  g031(.a(new_n83_), .b(x19), .c(new_n64_), .d(x00), .O(new_n84_));
  ...
  aoi21  g038(.a(new_n90_), .b(new_n88_), .c(x17), .O(new_n91_));
  oai21  g039(.a(new_n91_), .b(new_n53_), .c(x19), .O(new_n92_));
  ...
  nand4  g045(.a(new_n97_), .b(x19), .c(new_n64_), .d(x00), .O(new_n98_));
  nand2  g046(.a(new_n89_), .b(new_n60_), .O(new_n99_));
  ...
  nand4  g050(.a(new_n102_), .b(x19), .c(new_n64_), .d(x00), .O(new_n103_));
  ...
  nand4  g056(.a(new_n108_), .b(x19), .c(new_n64_), .d(x00), .O(new_n109_));
  ...
  nand4  g062(.a(new_n114_), .b(x19), .c(new_n64_), .d(x00), .O(new_n115_));
  ...
  oai21  g070(.a(new_n122_), .b(new_n53_), .c(x19), .O(new_n123_));
  ...
  oai21  g084(.a(new_n136_), .b(new_n53_), .c(x19), .O(new_n137_));
  inv1   g085(.a(x32), .O(new_n138_));
  nand2  g086(.a(new_n138_), .b(new_n60_), .O(new_n139_));
  nand2  g087(.a(new_n139_), .b(new_n137_), .O(z12));
  nand2  g088(.a(new_n54_), .b(x14), .O(new_n141_));
  oai21  g089(.a(x34), .b(new_n54_), .c(new_n141_), .O(new_n142_));
  nand4  g090(.a(new_n142_), .b(x19), .c(new_n64_), .d(x00), .O(new_n143_));
  nand2  g091(.a(new_n134_), .b(new_n60_), .O(new_n144_));
  ...
  nand2  g100(.a(new_n152_), .b(new_n150_), .O(z14));
  nand2  g101(.a(new_n54_), .b(x12), .O(new_n154_));
  nand2  g102(.a(new_n110_), .b(x18), .O(new_n155_));
  aoi21  g103(.a(new_n155_), .b(new_n154_), .c(x17), .O(new_n156_));
  oai21  g104(.a(new_n156_), .b(new_n53_), .c(x19), .O(new_n157_));
  nand2  g105(.a(new_n147_), .b(new_n60_), .O(new_n158_));
