...
module FAU ( 
  ...
  oai21  g020(.a(new_n72_), .b(x16), .c(x19), .O(new_n73_));
  inv1   g021(.a(x22), .O(new_n74_));
  nand2  g022(.a(new_n74_), .b(new_n59_), .O(new_n75_));
  nand2  g023(.a(new_n75_), .b(new_n73_), .O(z02));
  nand2  g024(.a(new_n53_), .b(x00), .O(new_n77_));
  nand3  g025(.a(x19), .b(new_n55_), .c(new_n54_), .O(new_n78_));
  ...
  nand4  g035(.a(new_n87_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n88_));
  ...
  oai21  g043(.a(new_n95_), .b(x16), .c(x19), .O(new_n96_));
  ...
  nand2  g048(.a(new_n60_), .b(x18), .O(new_n101_));
  aoi21  g049(.a(new_n101_), .b(new_n100_), .c(x17), .O(new_n102_));
  oai21  g050(.a(new_n102_), .b(x16), .c(x19), .O(new_n103_));
  ...
  oai21  g068(.a(x31), .b(new_n55_), .c(new_n120_), .O(new_n121_));
  nand4  g069(.a(new_n121_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n122_));
  ...
  nand4  g088(.a(new_n140_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n141_));
  ...
  oai21  g095(.a(new_n147_), .b(x16), .c(x19), .O(new_n148_));
  inv1   g096(.a(x34), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n59_), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n148_), .O(z14));
  nand2  g099(.a(new_n55_), .b(x12), .O(new_n152_));
  nand2  g100(.a(new_n109_), .b(x18), .O(new_n153_));
  aoi21  g101(.a(new_n153_), .b(new_n152_), .c(x17), .O(new_n154_));
  oai21  g102(.a(new_n154_), .b(x16), .c(x19), .O(new_n155_));
  nand2  g103(.a(new_n145_), .b(new_n59_), .O(new_n156_));
