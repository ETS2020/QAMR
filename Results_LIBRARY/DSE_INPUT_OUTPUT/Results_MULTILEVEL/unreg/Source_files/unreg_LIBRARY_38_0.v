...
module FAU ( 
  ...
  nand3  g017(.a(new_n56_), .b(new_n61_), .c(x10), .O(new_n70_));
  ...
  nand3  g024(.a(new_n66_), .b(new_n61_), .c(x10), .O(new_n77_));
  ...
  nand3  g030(.a(new_n73_), .b(new_n61_), .c(x10), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n61_), .c(x10), .O(new_n91_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n61_), .c(x10), .O(new_n111_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n61_), .c(x10), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n117_), .O(z08));
  nand3  g068(.a(x19), .b(new_n54_), .c(new_n53_), .O(new_n121_));
  nand2  g069(.a(new_n114_), .b(new_n61_), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(x10), .O(new_n124_));
  inv1   g072(.a(x30), .O(new_n125_));
  nand4  g073(.a(new_n125_), .b(x19), .c(x18), .d(new_n53_), .O(new_n126_));
  ...
  nand3  g080(.a(new_n125_), .b(new_n61_), .c(x10), .O(new_n133_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n61_), .c(x10), .O(new_n139_));
  ...
  nand2  g093(.a(x32), .b(x10), .O(new_n146_));
