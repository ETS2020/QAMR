...
module FAU ( 
  ...
  oai21  g17(.a(new_n69_), .b(new_n67_), .c(new_n65_), .O(z02));
  nand2  g18(.a(new_n68_), .b(new_n55_), .O(new_n71_));
  nand4  g19(.a(x19), .b(x18), .c(new_n66_), .d(x16), .O(new_n72_));
  nand2  g20(.a(new_n72_), .b(new_n71_), .O(z03));
  ...
  oai21  g25(.a(new_n77_), .b(new_n67_), .c(new_n75_), .O(z04));
  nand2  g26(.a(new_n76_), .b(new_n55_), .O(new_n79_));
  inv1   g27(.a(x26), .O(new_n80_));
  nand2  g28(.a(new_n80_), .b(x19), .O(new_n81_));
  oai21  g29(.a(new_n81_), .b(new_n67_), .c(new_n79_), .O(z05));
  nand2  g30(.a(new_n80_), .b(new_n55_), .O(new_n83_));
  inv1   g31(.a(x27), .O(new_n84_));
  nand2  g32(.a(new_n84_), .b(x19), .O(new_n85_));
  oai21  g33(.a(new_n85_), .b(new_n67_), .c(new_n83_), .O(z06));
  ...
  oai21  g54(.a(new_n106_), .b(new_n67_), .c(new_n105_), .O(z11));
  ...
  oai21  g64(.a(new_n116_), .b(new_n67_), .c(new_n114_), .O(z13));
  oai21  g65(.a(x35), .b(x17), .c(x18), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(x19), .O(new_n119_));
  nand2  g67(.a(new_n115_), .b(new_n55_), .O(new_n120_));
  nand2  g68(.a(new_n120_), .b(new_n119_), .O(z14));
  inv1   g69(.a(x35), .O(new_n122_));
  nand2  g70(.a(new_n122_), .b(new_n55_), .O(new_n123_));
  nand2  g71(.a(new_n91_), .b(x19), .O(new_n124_));
  oai21  g72(.a(new_n124_), .b(new_n67_), .c(new_n123_), .O(z15));
endmodule
