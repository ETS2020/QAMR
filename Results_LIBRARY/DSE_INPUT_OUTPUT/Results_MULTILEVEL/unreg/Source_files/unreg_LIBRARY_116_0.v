...
module FAU ( 
  ...
  nand3  g017(.a(new_n56_), .b(new_n61_), .c(x15), .O(new_n70_));
  ...
  nand3  g030(.a(new_n73_), .b(new_n61_), .c(x15), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n61_), .c(x15), .O(new_n91_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n61_), .c(x15), .O(new_n98_));
  ...
  nand3  g052(.a(new_n94_), .b(new_n61_), .c(x15), .O(new_n105_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n61_), .c(x15), .O(new_n111_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n61_), .c(x15), .O(new_n126_));
  ...
  oai21  g080(.a(new_n122_), .b(new_n60_), .c(new_n61_), .O(new_n133_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n61_), .c(x15), .O(new_n139_));
  ...
  nand2  g093(.a(x32), .b(x15), .O(new_n146_));
  ...
  oai21  g101(.a(new_n142_), .b(new_n60_), .c(new_n61_), .O(new_n154_));
  ...
  nand3  g108(.a(new_n150_), .b(new_n61_), .c(x15), .O(new_n161_));
  ...
  nand3  g114(.a(new_n157_), .b(new_n61_), .c(x15), .O(new_n167_));
