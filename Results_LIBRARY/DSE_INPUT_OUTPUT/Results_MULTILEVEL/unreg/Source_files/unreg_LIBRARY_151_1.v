...
module FAU ( 
  ...
  nand3  g038(.a(new_n82_), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  nand2  g079(.a(new_n82_), .b(new_n60_), .O(new_n132_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n82_), .c(new_n60_), .O(new_n138_));
  ...
  oai21  g107(.a(new_n149_), .b(x30), .c(new_n60_), .O(new_n160_));
