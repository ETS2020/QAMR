...
module FAU ( 
  ...
  oai21  g005(.a(new_n57_), .b(x15), .c(x19), .O(new_n58_));
  ...
  oai21  g014(.a(new_n66_), .b(x15), .c(x19), .O(new_n67_));
  ...
  oai21  g021(.a(new_n73_), .b(x15), .c(x19), .O(new_n74_));
  ...
  aoi21  g028(.a(new_n80_), .b(new_n77_), .c(x15), .O(new_n81_));
  ...
  nand4  g047(.a(new_n99_), .b(x19), .c(new_n77_), .d(new_n92_), .O(new_n100_));
  ...
  oai21  g052(.a(x20), .b(new_n53_), .c(new_n104_), .O(new_n105_));
  nand4  g053(.a(new_n105_), .b(x19), .c(new_n77_), .d(new_n92_), .O(new_n106_));
  ...
  nand4  g059(.a(new_n111_), .b(x19), .c(new_n77_), .d(new_n92_), .O(new_n112_));
  ...
  nand4  g065(.a(new_n117_), .b(x19), .c(new_n77_), .d(new_n92_), .O(new_n118_));
  ...
  oai21  g073(.a(new_n125_), .b(x15), .c(x19), .O(new_n126_));
  ...
  nand2  g078(.a(new_n89_), .b(x18), .O(new_n131_));
  aoi21  g079(.a(new_n131_), .b(new_n130_), .c(x17), .O(new_n132_));
  oai21  g080(.a(new_n132_), .b(x15), .c(x19), .O(new_n133_));
  nand2  g081(.a(new_n123_), .b(new_n59_), .O(new_n134_));
  nand2  g082(.a(new_n134_), .b(new_n133_), .O(z11));
  inv1   g083(.a(x33), .O(new_n136_));
  nand3  g084(.a(new_n136_), .b(x18), .c(new_n77_), .O(new_n137_));
  nand2  g085(.a(new_n137_), .b(new_n92_), .O(new_n138_));
  ...
  oai21  g092(.a(new_n144_), .b(x15), .c(x19), .O(new_n145_));
  nand2  g093(.a(new_n136_), .b(new_n59_), .O(new_n146_));
  ...
  oai21  g099(.a(new_n151_), .b(x15), .c(x19), .O(new_n152_));
  ...
  oai21  g105(.a(new_n157_), .b(x15), .c(x19), .O(new_n158_));
  nand2  g106(.a(new_n149_), .b(new_n59_), .O(new_n159_));
