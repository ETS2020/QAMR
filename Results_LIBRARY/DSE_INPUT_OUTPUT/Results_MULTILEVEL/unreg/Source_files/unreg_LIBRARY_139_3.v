...
module FAU ( 
  ...
  oai21  g022(.a(new_n74_), .b(x10), .c(x19), .O(new_n75_));
  ...
  oai21  g034(.a(new_n86_), .b(x10), .c(x19), .O(new_n87_));
  ...
  oai21  g054(.a(new_n106_), .b(x10), .c(x19), .O(new_n107_));
  ...
  nand2  g063(.a(new_n54_), .b(new_n53_), .O(new_n116_));
  inv1   g064(.a(x30), .O(new_n117_));
  nand3  g065(.a(new_n117_), .b(x19), .c(x18), .O(new_n118_));
  oai22  g066(.a(new_n118_), .b(new_n116_), .c(x29), .d(x19), .O(z09));
  ...
  nand2  g070(.a(new_n117_), .b(new_n59_), .O(new_n123_));
  ...
  oai21  g082(.a(new_n134_), .b(x10), .c(x19), .O(new_n135_));
  ...
  oai21  g090(.a(new_n142_), .b(x10), .c(x19), .O(new_n143_));
  ...
  oai21  g097(.a(new_n149_), .b(x10), .c(x19), .O(new_n150_));
