...
module FAU ( 
  ...
  oai21  g080(.a(x32), .b(new_n122_), .c(new_n60_), .O(new_n133_));
  ...
  nand2  g093(.a(new_n69_), .b(new_n60_), .O(new_n146_));
  ...
  oai21  g100(.a(new_n142_), .b(x32), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g113(.a(new_n156_), .b(new_n69_), .c(new_n60_), .O(new_n166_));
