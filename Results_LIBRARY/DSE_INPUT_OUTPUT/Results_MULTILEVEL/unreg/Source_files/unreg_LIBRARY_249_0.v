...
module FAU ( 
  ...
  nand2  g027(.a(new_n73_), .b(new_n61_), .O(new_n80_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n61_), .c(x00), .O(new_n91_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n61_), .c(x00), .O(new_n98_));
  ...
  nand3  g052(.a(new_n94_), .b(new_n61_), .c(x00), .O(new_n105_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n61_), .c(x00), .O(new_n119_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n61_), .c(x00), .O(new_n139_));
  ...
  nand3  g101(.a(new_n142_), .b(new_n61_), .c(x00), .O(new_n154_));
