...
module FAU ( 
  ...
  nand2  g029(.a(new_n73_), .b(new_n61_), .O(new_n82_));
  ...
  oai21  g057(.a(new_n100_), .b(x00), .c(new_n61_), .O(new_n110_));
  ...
  oai21  g093(.a(new_n145_), .b(x00), .c(new_n61_), .O(new_n146_));
  ...
  oai21  g100(.a(new_n141_), .b(x00), .c(new_n61_), .O(new_n153_));
