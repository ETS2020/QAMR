...
module FAU ( 
  ...
  nand4  g029(.a(new_n81_), .b(x29), .c(x19), .d(new_n78_), .O(new_n82_));
  ...
  nand4  g048(.a(new_n100_), .b(x29), .c(x19), .d(new_n78_), .O(new_n101_));
  ...
  nand3  g062(.a(new_n114_), .b(x19), .c(new_n78_), .O(new_n115_));
  nand2  g063(.a(new_n115_), .b(x29), .O(z09));
  ...
  nand4  g074(.a(new_n126_), .b(x29), .c(x19), .d(new_n78_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n131_), .b(x29), .c(x19), .d(new_n78_), .O(new_n132_));
  ...
  nand4  g085(.a(new_n137_), .b(x29), .c(x19), .d(new_n78_), .O(new_n138_));
  ...
  nand4  g099(.a(new_n151_), .b(x29), .c(x19), .d(new_n78_), .O(new_n152_));
