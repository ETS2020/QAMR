...
module FAU ( 
  ...
  oai21  g036(.a(new_n88_), .b(x00), .c(new_n60_), .O(new_n89_));
  ...
  inv1   g043(.a(x00), .O(new_n96_));
  nand3  g044(.a(new_n84_), .b(new_n60_), .c(new_n96_), .O(new_n97_));
  ...
  oai21  g051(.a(new_n92_), .b(x00), .c(new_n60_), .O(new_n104_));
  ...
  oai21  g057(.a(new_n100_), .b(x00), .c(new_n60_), .O(new_n110_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n60_), .c(new_n96_), .O(new_n118_));
  ...
  oai21  g085(.a(new_n128_), .b(x00), .c(new_n60_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n60_), .c(new_n96_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n60_), .c(new_n96_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n149_), .b(new_n60_), .c(new_n96_), .O(new_n160_));
