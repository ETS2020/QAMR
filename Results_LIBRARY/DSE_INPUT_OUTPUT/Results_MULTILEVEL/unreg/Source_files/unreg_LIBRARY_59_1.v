...
module FAU ( 
  ...
  nand2  g048(.a(new_n76_), .b(x18), .O(new_n101_));
  ...
  nand2  g057(.a(new_n76_), .b(new_n60_), .O(new_n110_));
  ...
  oai21  g079(.a(new_n121_), .b(x27), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n76_), .c(new_n60_), .O(new_n138_));
  ...
  oai21  g107(.a(new_n149_), .b(x27), .c(new_n60_), .O(new_n160_));
