...
module FAU ( 
  ...
  nand3  g031(.a(x25), .b(x19), .c(new_n54_), .O(new_n84_));
  oai22  g032(.a(new_n84_), .b(new_n83_), .c(x24), .d(x19), .O(z04));
  nand2  g033(.a(new_n54_), .b(x06), .O(new_n86_));
  oai21  g034(.a(x26), .b(new_n54_), .c(new_n86_), .O(new_n87_));
  nand4  g035(.a(new_n87_), .b(x25), .c(x19), .d(new_n53_), .O(new_n88_));
  nand2  g036(.a(new_n68_), .b(new_n58_), .O(new_n89_));
  nand2  g037(.a(new_n89_), .b(new_n88_), .O(z05));
  ...
  nand4  g048(.a(new_n100_), .b(x25), .c(x19), .d(new_n53_), .O(new_n101_));
  ...
  oai21  g055(.a(new_n107_), .b(new_n68_), .c(x19), .O(new_n108_));
  ...
  oai21  g060(.a(x30), .b(new_n54_), .c(new_n112_), .O(new_n113_));
  nand4  g061(.a(new_n113_), .b(x25), .c(x19), .d(new_n53_), .O(new_n114_));
  nand2  g062(.a(new_n105_), .b(new_n58_), .O(new_n115_));
  ...
  inv1   g073(.a(x24), .O(new_n126_));
  nand2  g074(.a(new_n126_), .b(x18), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n125_), .c(x17), .O(new_n128_));
  oai21  g076(.a(new_n128_), .b(new_n68_), .c(x19), .O(new_n129_));
  nand2  g077(.a(new_n118_), .b(new_n58_), .O(new_n130_));
  ...
  nand4  g089(.a(new_n141_), .b(x25), .c(x19), .d(new_n53_), .O(new_n142_));
  ...
  oai21  g096(.a(new_n148_), .b(new_n68_), .c(x19), .O(new_n149_));
  ...
  nand2  g101(.a(new_n109_), .b(x18), .O(new_n154_));
  aoi21  g102(.a(new_n154_), .b(new_n153_), .c(x17), .O(new_n155_));
  oai21  g103(.a(new_n155_), .b(new_n68_), .c(x19), .O(new_n156_));
  nand2  g104(.a(new_n146_), .b(new_n58_), .O(new_n157_));
