...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n59_, new_n60_,
    ...
    new_n83_, new_n85_, new_n87_, new_n88_, new_n89_, new_n91_, new_n93_,
    new_n95_, new_n97_;
  ...
  oai22  g31(.a(new_n83_), .b(new_n61_), .c(x29), .d(x19), .O(z09));
  nand2  g32(.a(new_n54_), .b(x09), .O(new_n85_));
  oai22  g33(.a(new_n85_), .b(new_n61_), .c(x30), .d(x19), .O(z10));
  ...
  nand2  g38(.a(new_n54_), .b(x15), .O(new_n91_));
  oai22  g39(.a(new_n91_), .b(new_n61_), .c(x32), .d(x19), .O(z12));
  nand2  g40(.a(new_n54_), .b(x14), .O(new_n93_));
  oai22  g41(.a(new_n93_), .b(new_n61_), .c(x33), .d(x19), .O(z13));
  nand2  g42(.a(new_n54_), .b(x13), .O(new_n95_));
  oai22  g43(.a(new_n95_), .b(new_n61_), .c(x34), .d(x19), .O(z14));
  nand2  g44(.a(new_n54_), .b(x12), .O(new_n97_));
  oai22  g45(.a(new_n97_), .b(new_n61_), .c(x35), .d(x19), .O(z15));
endmodule
