// Benchmark "FAU" written by ABC on Fri Aug 14 02:05:12 2020
...
module FAU ( 
  ...
  oai21  g005(.a(new_n57_), .b(x28), .c(x19), .O(new_n58_));
  ...
  oai21  g014(.a(new_n66_), .b(x28), .c(x19), .O(new_n67_));
  ...
  oai21  g021(.a(new_n73_), .b(x28), .c(x19), .O(new_n74_));
  ...
  aoi21  g028(.a(new_n80_), .b(new_n77_), .c(x28), .O(new_n81_));
  nand2  g029(.a(new_n71_), .b(new_n59_), .O(new_n82_));
  oai21  g030(.a(new_n81_), .b(new_n59_), .c(new_n82_), .O(z03));
  inv1   g031(.a(x28), .O(new_n84_));
  nand2  g032(.a(new_n53_), .b(x07), .O(new_n85_));
  oai21  g033(.a(x25), .b(new_n53_), .c(new_n85_), .O(new_n86_));
  nand4  g034(.a(new_n86_), .b(new_n84_), .c(x19), .d(new_n77_), .O(new_n87_));
  ...
  oai21  g042(.a(new_n94_), .b(x28), .c(x19), .O(new_n95_));
  inv1   g043(.a(x25), .O(new_n96_));
  nand2  g044(.a(new_n96_), .b(new_n59_), .O(new_n97_));
  ...
  oai21  g050(.a(new_n102_), .b(x28), .c(x19), .O(new_n103_));
  nand2  g051(.a(new_n92_), .b(new_n59_), .O(new_n104_));
  ...
  oai21  g056(.a(new_n108_), .b(x28), .c(x19), .O(new_n109_));
  ...
  oai21  g063(.a(new_n115_), .b(x28), .c(x19), .O(new_n116_));
  nand2  g064(.a(new_n84_), .b(new_n59_), .O(new_n117_));
  nand2  g065(.a(new_n117_), .b(new_n116_), .O(z08));
  ...
  oai21  g070(.a(new_n122_), .b(x28), .c(x19), .O(new_n123_));
  nand2  g071(.a(new_n113_), .b(new_n59_), .O(new_n124_));
  nand2  g072(.a(new_n124_), .b(new_n123_), .O(z09));
  nand2  g073(.a(new_n53_), .b(x09), .O(new_n126_));
  oai21  g074(.a(x31), .b(new_n53_), .c(new_n126_), .O(new_n127_));
  nand4  g075(.a(new_n127_), .b(new_n84_), .c(x19), .d(new_n77_), .O(new_n128_));
  nand2  g076(.a(new_n120_), .b(new_n59_), .O(new_n129_));
