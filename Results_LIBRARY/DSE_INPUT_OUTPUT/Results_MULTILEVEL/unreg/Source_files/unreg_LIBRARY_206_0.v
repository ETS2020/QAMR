...
module FAU ( 
  ...
  oai21  g016(.a(new_n56_), .b(new_n61_), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(new_n65_), .b(new_n61_), .c(new_n60_), .O(new_n76_));
  ...
  oai21  g029(.a(new_n72_), .b(new_n61_), .c(new_n60_), .O(new_n82_));
  ...
  oai21  g044(.a(new_n85_), .b(new_n61_), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g085(.a(new_n128_), .b(x20), .c(new_n60_), .O(new_n138_));
  ...
  nand2  g092(.a(x32), .b(x20), .O(new_n145_));
  ...
  nand3  g100(.a(new_n141_), .b(x20), .c(new_n60_), .O(new_n153_));
  ...
  oai21  g113(.a(new_n156_), .b(new_n61_), .c(new_n60_), .O(new_n166_));
