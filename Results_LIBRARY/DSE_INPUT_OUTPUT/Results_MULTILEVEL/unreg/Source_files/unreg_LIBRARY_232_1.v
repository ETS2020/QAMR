...
module FAU ( 
  ...
  nand4  g014(.a(new_n66_), .b(x19), .c(new_n64_), .d(x09), .O(new_n67_));
  ...
  nand4  g028(.a(new_n80_), .b(x19), .c(new_n64_), .d(x09), .O(new_n81_));
  ...
  nand4  g054(.a(new_n106_), .b(x19), .c(new_n64_), .d(x09), .O(new_n107_));
  ...
  nand4  g073(.a(new_n125_), .b(x19), .c(new_n64_), .d(x09), .O(new_n126_));
  oai21  g074(.a(x30), .b(x19), .c(new_n126_), .O(z10));
  ...
  nand4  g092(.a(new_n144_), .b(x19), .c(new_n64_), .d(x09), .O(new_n145_));
  ...
  oai21  g106(.a(new_n158_), .b(new_n53_), .c(x19), .O(new_n159_));
