...
module FAU ( 
  ...
  aoi21  g013(.a(x28), .b(x21), .c(x19), .O(new_n66_));
  ...
  oai21  g058(.a(x21), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  ...
  nand2  g073(.a(new_n114_), .b(new_n109_), .O(new_n126_));
  ...
  aoi21  g078(.a(new_n122_), .b(new_n109_), .c(new_n60_), .O(new_n131_));
  ...
  nand2  g092(.a(new_n144_), .b(new_n109_), .O(new_n145_));
  ...
  aoi21  g097(.a(new_n140_), .b(new_n109_), .c(new_n60_), .O(new_n150_));
