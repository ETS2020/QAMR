...
module FAU ( 
  ...
  nand2  g007(.a(x33), .b(x27), .O(new_n60_));
  ...
  aoi21  g022(.a(new_n74_), .b(new_n72_), .c(new_n61_), .O(z02));
  ...
  aoi21  g029(.a(new_n81_), .b(new_n79_), .c(new_n61_), .O(z03));
  ...
  oai21  g042(.a(x33), .b(x18), .c(x27), .O(new_n95_));
  nand2  g043(.a(new_n95_), .b(x05), .O(new_n96_));
  ...
  nand3  g047(.a(new_n60_), .b(new_n99_), .c(new_n58_), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(new_n98_), .O(z06));
  oai21  g049(.a(x33), .b(new_n58_), .c(x27), .O(new_n102_));
  nand3  g050(.a(new_n102_), .b(new_n54_), .c(x04), .O(new_n103_));
  nand4  g051(.a(new_n60_), .b(new_n59_), .c(x19), .d(x18), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand2  g053(.a(new_n105_), .b(new_n53_), .O(new_n106_));
  ...
  nor2   g060(.a(x28), .b(x19), .O(new_n113_));
  ...
  aoi21  g074(.a(new_n126_), .b(new_n124_), .c(new_n61_), .O(z10));
  ...
  nor2   g079(.a(new_n131_), .b(new_n61_), .O(new_n132_));
  ...
  oai21  g087(.a(x27), .b(new_n58_), .c(x33), .O(new_n140_));
  nand3  g088(.a(new_n140_), .b(new_n54_), .c(x14), .O(new_n141_));
  inv1   g089(.a(x34), .O(new_n142_));
  nand4  g090(.a(new_n60_), .b(new_n142_), .c(x19), .d(x18), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g092(.a(new_n144_), .b(new_n53_), .O(new_n145_));
  inv1   g093(.a(x33), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n58_), .O(new_n147_));
  ...
  nand2  g099(.a(new_n142_), .b(new_n58_), .O(new_n152_));
  aoi21  g100(.a(new_n152_), .b(new_n151_), .c(new_n61_), .O(z14));
  ...
  nor2   g104(.a(x35), .b(x19), .O(new_n157_));
  nor2   g105(.a(new_n157_), .b(new_n61_), .O(new_n158_));
