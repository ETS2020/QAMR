...
module FAU ( 
  ...
  nand3  g009(.a(new_n61_), .b(new_n60_), .c(x16), .O(new_n62_));
  ...
  nand3  g016(.a(new_n56_), .b(new_n60_), .c(x16), .O(new_n69_));
  ...
  nand3  g037(.a(new_n89_), .b(new_n60_), .c(x16), .O(new_n90_));
  ...
  nand3  g044(.a(new_n85_), .b(new_n60_), .c(x16), .O(new_n97_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n60_), .c(x16), .O(new_n118_));
  ...
  nand3  g079(.a(new_n121_), .b(new_n60_), .c(x16), .O(new_n132_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n60_), .c(x16), .O(new_n138_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n60_), .c(x16), .O(new_n153_));
