...
module FAU ( 
  ...
  nand2  g12(.a(x19), .b(new_n64_), .O(new_n65_));
  oai22  g13(.a(new_n65_), .b(new_n63_), .c(x22), .d(x19), .O(z02));
  ...
  oai22  g19(.a(new_n71_), .b(new_n65_), .c(x24), .d(x19), .O(z04));
  nand2  g20(.a(new_n54_), .b(x06), .O(new_n73_));
  oai22  g21(.a(new_n73_), .b(new_n65_), .c(x25), .d(x19), .O(z05));
  nand2  g22(.a(new_n54_), .b(x05), .O(new_n75_));
  oai22  g23(.a(new_n75_), .b(new_n65_), .c(x26), .d(x19), .O(z06));
  ...
  aoi21  g28(.a(new_n54_), .b(x11), .c(x18), .O(new_n81_));
  inv1   g29(.a(x28), .O(new_n82_));
  nand2  g30(.a(new_n82_), .b(new_n53_), .O(new_n83_));
  oai21  g31(.a(new_n81_), .b(new_n53_), .c(new_n83_), .O(z08));
  ...
  aoi21  g36(.a(new_n54_), .b(x09), .c(x18), .O(new_n89_));
  inv1   g37(.a(x30), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(new_n53_), .O(new_n91_));
  oai21  g39(.a(new_n89_), .b(new_n53_), .c(new_n91_), .O(z10));
  nand2  g40(.a(new_n54_), .b(x08), .O(new_n93_));
  oai22  g41(.a(new_n93_), .b(new_n65_), .c(x31), .d(x19), .O(z11));
  nand2  g42(.a(new_n54_), .b(x15), .O(new_n95_));
  oai22  g43(.a(new_n95_), .b(new_n65_), .c(x32), .d(x19), .O(z12));
  nand2  g44(.a(new_n54_), .b(x14), .O(new_n97_));
  oai22  g45(.a(new_n97_), .b(new_n65_), .c(x33), .d(x19), .O(z13));
  nand2  g46(.a(new_n54_), .b(x13), .O(new_n99_));
  oai22  g47(.a(new_n99_), .b(new_n65_), .c(x34), .d(x19), .O(z14));
  nand2  g48(.a(new_n54_), .b(x12), .O(new_n101_));
  oai22  g49(.a(new_n101_), .b(new_n65_), .c(x35), .d(x19), .O(z15));
endmodule
