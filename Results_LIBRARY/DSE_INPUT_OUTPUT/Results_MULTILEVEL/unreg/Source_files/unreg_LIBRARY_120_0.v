...
module FAU ( 
  ...
  oai21  g016(.a(new_n65_), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g029(.a(new_n72_), .b(new_n65_), .c(new_n60_), .O(new_n82_));
  ...
  nand3  g037(.a(new_n89_), .b(x22), .c(new_n60_), .O(new_n90_));
  ...
  oai21  g051(.a(new_n93_), .b(new_n65_), .c(new_n60_), .O(new_n104_));
  ...
  oai21  g065(.a(new_n117_), .b(new_n65_), .c(new_n60_), .O(new_n118_));
  ...
  oai21  g072(.a(new_n113_), .b(new_n65_), .c(new_n60_), .O(new_n125_));
  ...
  oai21  g079(.a(new_n121_), .b(new_n65_), .c(new_n60_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n128_), .b(new_n65_), .c(new_n60_), .O(new_n138_));
  ...
  nand3  g100(.a(new_n141_), .b(x22), .c(new_n60_), .O(new_n153_));
  ...
  oai21  g107(.a(new_n149_), .b(new_n65_), .c(new_n60_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n156_), .b(x22), .c(new_n60_), .O(new_n166_));
