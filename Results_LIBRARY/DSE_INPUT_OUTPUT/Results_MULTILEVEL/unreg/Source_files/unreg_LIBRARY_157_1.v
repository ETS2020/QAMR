...
module FAU ( 
  ...
  nand3  g043(.a(new_n54_), .b(new_n57_), .c(x05), .O(new_n96_));
  nor2   g044(.a(x34), .b(x27), .O(new_n97_));
  ...
  nand2  g049(.a(x34), .b(new_n53_), .O(new_n102_));
  nand3  g050(.a(new_n102_), .b(new_n101_), .c(new_n61_), .O(new_n103_));
  nand2  g051(.a(new_n103_), .b(new_n100_), .O(z06));
  nand3  g052(.a(new_n54_), .b(new_n57_), .c(x04), .O(new_n105_));
  nand3  g053(.a(new_n102_), .b(new_n62_), .c(x18), .O(new_n106_));
  ...
  aoi21  g090(.a(x27), .b(new_n57_), .c(new_n142_), .O(new_n143_));
