...
module FAU ( 
  ...
  nand4  g026(.a(new_n78_), .b(x19), .c(new_n53_), .d(x16), .O(new_n79_));
  ...
  nand4  g030(.a(new_n82_), .b(x19), .c(new_n53_), .d(x16), .O(new_n83_));
  ...
  nand4  g036(.a(new_n88_), .b(x19), .c(new_n53_), .d(x16), .O(new_n89_));
  ...
  oai21  g044(.a(new_n96_), .b(new_n68_), .c(x19), .O(new_n97_));
  ...
  oai21  g051(.a(new_n103_), .b(new_n68_), .c(x19), .O(new_n104_));
  ...
  nand4  g056(.a(new_n108_), .b(x19), .c(new_n53_), .d(x16), .O(new_n109_));
  ...
  oai21  g064(.a(new_n116_), .b(new_n68_), .c(x19), .O(new_n117_));
  ...
  nand4  g070(.a(new_n122_), .b(x19), .c(new_n53_), .d(x16), .O(new_n123_));
  nand2  g071(.a(new_n114_), .b(new_n58_), .O(new_n124_));
  ...
  nand4  g075(.a(new_n127_), .b(x19), .c(new_n53_), .d(x16), .O(new_n128_));
  ...
  nand4  g089(.a(new_n141_), .b(x19), .c(new_n53_), .d(x16), .O(new_n142_));
