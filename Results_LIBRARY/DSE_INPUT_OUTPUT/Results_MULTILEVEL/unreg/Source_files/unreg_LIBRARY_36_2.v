...
module FAU ( 
  ...
  nand4  g014(.a(new_n66_), .b(x27), .c(x19), .d(new_n64_), .O(new_n67_));
  ...
  aoi21  g028(.a(new_n80_), .b(new_n64_), .c(new_n53_), .O(new_n81_));
  nand2  g029(.a(new_n71_), .b(new_n60_), .O(new_n82_));
  oai21  g030(.a(new_n81_), .b(new_n60_), .c(new_n82_), .O(z03));
  ...
  oai21  g043(.a(new_n95_), .b(new_n53_), .c(x19), .O(new_n96_));
  nand2  g044(.a(new_n85_), .b(new_n60_), .O(new_n97_));
  nand2  g045(.a(new_n97_), .b(new_n96_), .O(z05));
  nor2   g046(.a(x18), .b(x17), .O(new_n99_));
  aoi21  g047(.a(new_n99_), .b(x05), .c(new_n53_), .O(new_n100_));
  nand2  g048(.a(new_n93_), .b(new_n60_), .O(new_n101_));
  oai21  g049(.a(new_n100_), .b(new_n60_), .c(new_n101_), .O(z06));
  nand2  g050(.a(new_n54_), .b(x04), .O(new_n103_));
  oai21  g051(.a(x20), .b(new_n54_), .c(new_n103_), .O(new_n104_));
  nand4  g052(.a(new_n104_), .b(x27), .c(x19), .d(new_n64_), .O(new_n105_));
  nand2  g053(.a(new_n53_), .b(new_n60_), .O(new_n106_));
  ...
  nand4  g057(.a(new_n109_), .b(x27), .c(x19), .d(new_n64_), .O(new_n110_));
  ...
  nand4  g071(.a(new_n123_), .b(x27), .c(x19), .d(new_n64_), .O(new_n124_));
  ...
  nand4  g076(.a(new_n128_), .b(x27), .c(x19), .d(new_n64_), .O(new_n129_));
  ...
  nand4  g082(.a(new_n134_), .b(x27), .c(x19), .d(new_n64_), .O(new_n135_));
  ...
  nand4  g096(.a(new_n148_), .b(x27), .c(x19), .d(new_n64_), .O(new_n149_));
  ...
  nand2  g100(.a(new_n111_), .b(x18), .O(new_n153_));
  aoi21  g101(.a(new_n153_), .b(new_n152_), .c(x17), .O(new_n154_));
  oai21  g102(.a(new_n154_), .b(new_n53_), .c(x19), .O(new_n155_));
