...
module FAU ( 
  ...
  nand4  g017(.a(new_n69_), .b(x19), .c(new_n53_), .d(x13), .O(new_n70_));
  ...
  nand4  g024(.a(new_n76_), .b(x19), .c(new_n53_), .d(x13), .O(new_n77_));
  ...
  oai21  g037(.a(new_n89_), .b(new_n85_), .c(x19), .O(new_n90_));
  ...
  nand2  g044(.a(new_n87_), .b(new_n58_), .O(new_n97_));
  ...
  nand4  g048(.a(new_n100_), .b(x19), .c(new_n53_), .d(x13), .O(new_n101_));
  ...
  nand4  g054(.a(new_n106_), .b(x19), .c(new_n53_), .d(x13), .O(new_n107_));
  ...
  nand4  g060(.a(new_n112_), .b(x19), .c(new_n53_), .d(x13), .O(new_n113_));
  ...
  oai21  g068(.a(new_n120_), .b(new_n85_), .c(x19), .O(new_n121_));
  ...
  nand4  g074(.a(new_n126_), .b(x19), .c(new_n53_), .d(x13), .O(new_n127_));
  nand2  g075(.a(new_n118_), .b(new_n58_), .O(new_n128_));
  ...
  oai21  g081(.a(new_n133_), .b(new_n85_), .c(x19), .O(new_n134_));
  ...
  oai21  g098(.a(new_n150_), .b(new_n85_), .c(x19), .O(new_n151_));
