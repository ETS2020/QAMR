...
module FAU ( 
  ...
  nand3  g004(.a(new_n56_), .b(x19), .c(x18), .O(new_n57_));
  ...
  nand3  g029(.a(new_n72_), .b(new_n60_), .c(x18), .O(new_n82_));
  ...
  nand3  g079(.a(new_n121_), .b(new_n60_), .c(x18), .O(new_n132_));
  nand2  g080(.a(new_n132_), .b(new_n131_), .O(z10));
  nand2  g081(.a(new_n54_), .b(x08), .O(new_n134_));
  nand3  g082(.a(new_n89_), .b(x19), .c(x18), .O(new_n135_));
  nand2  g083(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand2  g084(.a(new_n136_), .b(new_n53_), .O(new_n137_));
  oai21  g085(.a(new_n128_), .b(new_n54_), .c(new_n60_), .O(new_n138_));
  nand2  g086(.a(new_n138_), .b(new_n137_), .O(z11));
  nand2  g087(.a(new_n54_), .b(x15), .O(new_n140_));
  ...
  nand2  g092(.a(x32), .b(x18), .O(new_n145_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n60_), .c(x18), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(new_n152_), .O(z13));
  nand2  g102(.a(new_n54_), .b(x13), .O(new_n155_));
  inv1   g103(.a(x35), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(x18), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g106(.a(new_n158_), .b(x19), .c(new_n53_), .O(new_n159_));
  nand3  g107(.a(new_n149_), .b(new_n60_), .c(x18), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n159_), .O(z14));
  nand2  g109(.a(new_n54_), .b(x12), .O(new_n162_));
  nand3  g110(.a(new_n117_), .b(x19), .c(x18), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(new_n53_), .O(new_n165_));
  oai21  g113(.a(new_n156_), .b(new_n54_), .c(new_n60_), .O(new_n166_));
