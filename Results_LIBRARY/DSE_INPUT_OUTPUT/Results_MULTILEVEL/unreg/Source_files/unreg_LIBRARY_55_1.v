...
module FAU ( 
  ...
  oai21  g024(.a(x34), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g030(.a(x34), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g045(.a(x34), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g058(.a(x34), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g066(.a(new_n62_), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  oai21  g073(.a(x34), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  oai21  g080(.a(x34), .b(new_n122_), .c(new_n60_), .O(new_n133_));
  ...
  oai21  g086(.a(x34), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  ...
  oai21  g094(.a(x34), .b(new_n146_), .c(new_n60_), .O(new_n147_));
  ...
  oai21  g100(.a(x34), .b(new_n142_), .c(new_n60_), .O(new_n153_));
