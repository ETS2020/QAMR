...
module FAU ( 
  ...
  nand4  g42(.a(new_n94_), .b(x19), .c(x18), .d(new_n61_), .O(new_n95_));
  ...
  nand4  g54(.a(new_n75_), .b(x19), .c(x18), .d(new_n61_), .O(new_n107_));
  ...
  nand2  g73(.a(new_n121_), .b(new_n55_), .O(new_n126_));
