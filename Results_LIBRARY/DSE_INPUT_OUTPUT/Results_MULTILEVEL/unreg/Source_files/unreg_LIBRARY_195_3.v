...
module FAU ( 
  ...
  oai21  g005(.a(new_n57_), .b(x08), .c(x19), .O(new_n58_));
  ...
  oai21  g014(.a(new_n66_), .b(x08), .c(x19), .O(new_n67_));
  ...
  oai21  g021(.a(new_n73_), .b(x08), .c(x19), .O(new_n74_));
  ...
  aoi21  g028(.a(new_n80_), .b(new_n77_), .c(x08), .O(new_n81_));
  ...
  oai21  g042(.a(new_n94_), .b(x08), .c(x19), .O(new_n95_));
  ...
  nand4  g048(.a(new_n100_), .b(x19), .c(new_n77_), .d(new_n84_), .O(new_n101_));
  ...
  oai21  g054(.a(new_n106_), .b(x08), .c(x19), .O(new_n107_));
  ...
  oai21  g062(.a(new_n114_), .b(x08), .c(x19), .O(new_n115_));
  ...
  nand4  g068(.a(new_n120_), .b(x19), .c(new_n77_), .d(new_n84_), .O(new_n121_));
  ...
  nand3  g077(.a(new_n88_), .b(x18), .c(new_n77_), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(new_n84_), .O(new_n131_));
  nand2  g079(.a(new_n131_), .b(x19), .O(new_n132_));
  ...
  nand4  g083(.a(new_n135_), .b(x19), .c(new_n77_), .d(new_n84_), .O(new_n136_));
  ...
  oai21  g091(.a(new_n143_), .b(x08), .c(x19), .O(new_n144_));
  ...
  oai21  g099(.a(new_n151_), .b(x08), .c(x19), .O(new_n152_));
  nand2  g100(.a(new_n141_), .b(new_n59_), .O(new_n153_));
  ...
  nand4  g104(.a(new_n156_), .b(x19), .c(new_n77_), .d(new_n84_), .O(new_n157_));
