// Benchmark "FAU" written by ABC on Fri Aug 14 02:05:16 2020
...
module FAU ( 
  ...
  oai21  g017(.a(new_n56_), .b(x05), .c(new_n61_), .O(new_n70_));
  ...
  oai21  g024(.a(new_n66_), .b(x05), .c(new_n61_), .O(new_n77_));
  ...
  nand3  g030(.a(new_n73_), .b(new_n61_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g038(.a(new_n90_), .b(x05), .c(new_n61_), .O(new_n91_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n61_), .c(new_n60_), .O(new_n98_));
  nand2  g046(.a(new_n98_), .b(new_n97_), .O(z05));
  oai21  g047(.a(x18), .b(x17), .c(x19), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(x05), .O(new_n101_));
  nand2  g049(.a(new_n94_), .b(new_n61_), .O(new_n102_));
  inv1   g050(.a(x27), .O(new_n103_));
  nand4  g051(.a(new_n103_), .b(x19), .c(x18), .d(new_n53_), .O(new_n104_));
  nand3  g052(.a(new_n104_), .b(new_n102_), .c(new_n101_), .O(z06));
  nand2  g053(.a(new_n54_), .b(x04), .O(new_n106_));
  nand2  g054(.a(new_n62_), .b(x18), .O(new_n107_));
  nand2  g055(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g056(.a(new_n108_), .b(x19), .c(new_n53_), .O(new_n109_));
  nand3  g057(.a(new_n103_), .b(new_n61_), .c(new_n60_), .O(new_n110_));
  ...
  oai21  g065(.a(new_n117_), .b(x05), .c(new_n61_), .O(new_n118_));
  ...
  oai21  g072(.a(new_n113_), .b(x05), .c(new_n61_), .O(new_n125_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n61_), .c(new_n60_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n61_), .c(new_n60_), .O(new_n153_));
  ...
  oai21  g107(.a(new_n149_), .b(x05), .c(new_n61_), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n159_), .O(z14));
  nand2  g109(.a(new_n54_), .b(x12), .O(new_n162_));
  nand2  g110(.a(new_n117_), .b(x18), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand3  g112(.a(new_n164_), .b(x19), .c(new_n53_), .O(new_n165_));
  oai21  g113(.a(new_n156_), .b(x05), .c(new_n61_), .O(new_n166_));
