...
module FAU ( 
  ...
  nand2  g031(.a(new_n55_), .b(new_n83_), .O(new_n84_));
  nand4  g032(.a(new_n84_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n85_));
  ...
  oai21  g045(.a(new_n97_), .b(x25), .c(x19), .O(new_n98_));
  nand2  g046(.a(new_n89_), .b(new_n59_), .O(new_n99_));
  nand2  g047(.a(new_n99_), .b(new_n98_), .O(z06));
  nand2  g048(.a(new_n55_), .b(x04), .O(new_n101_));
  oai21  g049(.a(x20), .b(new_n55_), .c(new_n101_), .O(new_n102_));
  nand4  g050(.a(new_n102_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n103_));
  nand2  g051(.a(new_n95_), .b(new_n59_), .O(new_n104_));
  ...
  nand2  g064(.a(new_n107_), .b(new_n59_), .O(new_n117_));
  ...
  oai21  g070(.a(new_n122_), .b(x25), .c(x19), .O(new_n123_));
  inv1   g071(.a(x30), .O(new_n124_));
  nand2  g072(.a(new_n124_), .b(new_n59_), .O(new_n125_));
  nand2  g073(.a(new_n125_), .b(new_n123_), .O(z10));
  nand2  g074(.a(new_n55_), .b(x08), .O(new_n127_));
  inv1   g075(.a(x24), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(x18), .O(new_n129_));
  aoi21  g077(.a(new_n129_), .b(new_n127_), .c(x17), .O(new_n130_));
  oai21  g078(.a(new_n130_), .b(x25), .c(x19), .O(new_n131_));
  nand2  g079(.a(new_n120_), .b(new_n59_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n137_), .b(x25), .c(x19), .O(new_n138_));
  inv1   g086(.a(x32), .O(new_n139_));
  nand2  g087(.a(new_n139_), .b(new_n59_), .O(new_n140_));
  nand2  g088(.a(new_n140_), .b(new_n138_), .O(z12));
  nand2  g089(.a(new_n55_), .b(x14), .O(new_n142_));
  oai21  g090(.a(x34), .b(new_n55_), .c(new_n142_), .O(new_n143_));
  nand4  g091(.a(new_n143_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n144_));
  nand2  g092(.a(new_n135_), .b(new_n59_), .O(new_n145_));
  nand2  g093(.a(new_n145_), .b(new_n144_), .O(z13));
  nand2  g094(.a(new_n55_), .b(x13), .O(new_n147_));
  inv1   g095(.a(x35), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(x18), .O(new_n149_));
  aoi21  g097(.a(new_n149_), .b(new_n147_), .c(x17), .O(new_n150_));
  oai21  g098(.a(new_n150_), .b(x25), .c(x19), .O(new_n151_));
  ...
  nand2  g103(.a(new_n111_), .b(x18), .O(new_n156_));
  aoi21  g104(.a(new_n156_), .b(new_n155_), .c(x17), .O(new_n157_));
  oai21  g105(.a(new_n157_), .b(x25), .c(x19), .O(new_n158_));
  nand2  g106(.a(new_n148_), .b(new_n59_), .O(new_n159_));
