...
module FAU ( 
  ...
  nand3  g037(.a(new_n62_), .b(new_n89_), .c(new_n60_), .O(new_n90_));
  ...
  nand2  g044(.a(new_n62_), .b(new_n60_), .O(new_n97_));
  ...
  oai21  g051(.a(new_n93_), .b(x25), .c(new_n60_), .O(new_n104_));
  ...
  oai21  g065(.a(new_n117_), .b(x25), .c(new_n60_), .O(new_n118_));
  ...
  oai21  g079(.a(new_n121_), .b(x25), .c(new_n60_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n128_), .b(x25), .c(new_n60_), .O(new_n138_));
  ...
  oai21  g093(.a(new_n145_), .b(x25), .c(new_n60_), .O(new_n146_));
  ...
  oai21  g107(.a(new_n149_), .b(x25), .c(new_n60_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n156_), .b(x25), .c(new_n60_), .O(new_n166_));
