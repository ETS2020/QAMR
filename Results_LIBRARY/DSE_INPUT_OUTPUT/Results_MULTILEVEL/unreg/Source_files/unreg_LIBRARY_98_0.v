...
module FAU ( 
  ...
  nand3  g052(.a(x28), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g079(.a(new_n121_), .b(x28), .c(new_n60_), .O(new_n132_));
  ...
  nand2  g092(.a(x32), .b(x28), .O(new_n145_));
  ...
  nand3  g113(.a(new_n156_), .b(x28), .c(new_n60_), .O(new_n166_));
