...
module FAU ( 
  ...
  oai21  g005(.a(new_n57_), .b(x00), .c(x19), .O(new_n58_));
  ...
  oai21  g014(.a(new_n66_), .b(x00), .c(x19), .O(new_n67_));
  ...
  oai21  g021(.a(new_n73_), .b(x00), .c(x19), .O(new_n74_));
  ...
  nand3  g026(.a(x18), .b(new_n78_), .c(x16), .O(new_n79_));
  ...
  oai21  g034(.a(new_n86_), .b(x00), .c(x19), .O(new_n87_));
  ...
  oai21  g039(.a(x26), .b(new_n53_), .c(new_n91_), .O(new_n92_));
  nand4  g040(.a(new_n92_), .b(x19), .c(new_n78_), .d(new_n77_), .O(new_n93_));
  ...
  nand4  g059(.a(new_n111_), .b(x19), .c(new_n78_), .d(new_n77_), .O(new_n112_));
  ...
  oai21  g067(.a(new_n119_), .b(x00), .c(x19), .O(new_n120_));
  ...
  oai21  g075(.a(new_n127_), .b(x00), .c(x19), .O(new_n128_));
  ...
  oai21  g081(.a(new_n133_), .b(x00), .c(x19), .O(new_n134_));
  ...
  nand4  g086(.a(new_n138_), .b(x19), .c(new_n78_), .d(new_n77_), .O(new_n139_));
  ...
  nand4  g092(.a(new_n144_), .b(x19), .c(new_n78_), .d(new_n77_), .O(new_n145_));
  inv1   g093(.a(x33), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n59_), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n145_), .O(z13));
  nand2  g096(.a(new_n53_), .b(x13), .O(new_n149_));
  oai21  g097(.a(x35), .b(new_n53_), .c(new_n149_), .O(new_n150_));
  nand4  g098(.a(new_n150_), .b(x19), .c(new_n78_), .d(new_n77_), .O(new_n151_));
  ...
  oai21  g105(.a(new_n157_), .b(x00), .c(x19), .O(new_n158_));
  inv1   g106(.a(x35), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n59_), .O(new_n160_));
