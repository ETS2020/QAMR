...
module FAU ( 
  ...
  nand4  g034(.a(new_n86_), .b(x28), .c(x19), .d(new_n78_), .O(new_n87_));
  ...
  nand3  g061(.a(new_n113_), .b(x19), .c(new_n78_), .O(new_n114_));
  nand2  g062(.a(new_n114_), .b(x28), .O(z08));
  ...
  nand4  g073(.a(new_n125_), .b(x28), .c(x19), .d(new_n78_), .O(new_n126_));
  ...
  aoi21  g101(.a(new_n153_), .b(new_n151_), .c(x17), .O(new_n154_));
  ...
  nand2  g105(.a(new_n78_), .b(x12), .O(new_n158_));
  nand3  g106(.a(x28), .b(x19), .c(new_n54_), .O(new_n159_));
  oai22  g107(.a(new_n159_), .b(new_n158_), .c(x35), .d(x19), .O(z15));
endmodule
