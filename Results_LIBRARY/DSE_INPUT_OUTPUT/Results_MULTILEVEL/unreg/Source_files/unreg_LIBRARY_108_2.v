...
module FAU ( 
  ...
  nand4  g045(.a(new_n97_), .b(x32), .c(x19), .d(new_n64_), .O(new_n98_));
  nand2  g046(.a(new_n90_), .b(new_n60_), .O(new_n99_));
  ...
  nand4  g065(.a(new_n117_), .b(x32), .c(x19), .d(new_n64_), .O(new_n118_));
  ...
  nand4  g070(.a(new_n122_), .b(x32), .c(x19), .d(new_n64_), .O(new_n123_));
  ...
  nand3  g083(.a(new_n135_), .b(x19), .c(new_n64_), .O(new_n136_));
  ...
  nand4  g095(.a(new_n147_), .b(x32), .c(x19), .d(new_n64_), .O(new_n148_));
