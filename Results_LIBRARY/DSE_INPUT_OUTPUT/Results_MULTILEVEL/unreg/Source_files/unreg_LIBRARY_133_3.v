...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n59_, new_n60_,
    ...
    new_n82_, new_n84_, new_n86_, new_n88_, new_n90_, new_n91_, new_n92_,
  ...
  nand4  g29(.a(x19), .b(new_n71_), .c(new_n54_), .d(x11), .O(new_n82_));
  ...
  nand4  g33(.a(x19), .b(new_n71_), .c(new_n54_), .d(x09), .O(new_n86_));
  oai21  g34(.a(x30), .b(x19), .c(new_n86_), .O(z10));
  nand4  g35(.a(x19), .b(new_n71_), .c(new_n54_), .d(x08), .O(new_n88_));
  ...
  nand4  g41(.a(x19), .b(new_n71_), .c(new_n54_), .d(x14), .O(new_n94_));
