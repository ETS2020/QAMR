...
module FAU ( 
  ...
  aoi21  g025(.a(new_n77_), .b(new_n53_), .c(x34), .O(new_n78_));
  ...
  nand4  g031(.a(new_n83_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n84_));
  ...
  nand4  g037(.a(new_n89_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n90_));
  ...
  oai21  g045(.a(new_n97_), .b(x34), .c(x19), .O(new_n98_));
  ...
  oai21  g065(.a(new_n117_), .b(x34), .c(x19), .O(new_n118_));
  ...
  nand4  g076(.a(new_n128_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n129_));
  ...
  oai21  g084(.a(new_n136_), .b(x34), .c(x19), .O(new_n137_));
  ...
  oai21  g091(.a(x33), .b(x19), .c(new_n143_), .O(z13));
  inv1   g092(.a(x13), .O(new_n145_));
  nor2   g093(.a(x18), .b(new_n145_), .O(new_n146_));
  nor2   g094(.a(x35), .b(new_n55_), .O(new_n147_));
  oai21  g095(.a(new_n147_), .b(new_n146_), .c(new_n53_), .O(new_n148_));
  aoi21  g096(.a(new_n148_), .b(x19), .c(x34), .O(z14));
  ...
  oai21  g100(.a(new_n152_), .b(x34), .c(x19), .O(new_n153_));
