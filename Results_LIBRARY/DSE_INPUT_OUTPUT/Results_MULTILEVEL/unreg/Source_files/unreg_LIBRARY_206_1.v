...
module FAU ( 
  ...
  oai21  g027(.a(new_n70_), .b(x20), .c(new_n65_), .O(new_n80_));
  nand2  g028(.a(new_n80_), .b(new_n79_), .O(z03));
  nand2  g029(.a(new_n56_), .b(x07), .O(new_n82_));
  ...
  inv1   g034(.a(x20), .O(new_n87_));
  inv1   g035(.a(x24), .O(new_n88_));
  nand3  g036(.a(new_n88_), .b(new_n87_), .c(new_n65_), .O(new_n89_));
  ...
  oai21  g043(.a(new_n83_), .b(x20), .c(new_n65_), .O(new_n96_));
  ...
  nand3  g050(.a(new_n92_), .b(new_n87_), .c(new_n65_), .O(new_n103_));
  nand2  g051(.a(new_n103_), .b(new_n102_), .O(z06));
  nand2  g052(.a(new_n56_), .b(x04), .O(new_n105_));
  nand2  g053(.a(new_n87_), .b(x18), .O(new_n106_));
  ...
  nand3  g071(.a(new_n112_), .b(new_n87_), .c(new_n65_), .O(new_n124_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n87_), .c(new_n65_), .O(new_n137_));
  ...
  oai21  g092(.a(new_n144_), .b(x20), .c(new_n65_), .O(new_n145_));
  ...
  nand3  g099(.a(new_n140_), .b(new_n87_), .c(new_n65_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n148_), .b(new_n87_), .c(new_n65_), .O(new_n159_));
