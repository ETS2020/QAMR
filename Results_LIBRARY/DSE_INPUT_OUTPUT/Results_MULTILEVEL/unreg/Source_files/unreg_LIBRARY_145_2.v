...
module FAU ( 
  ...
  oai21  g034(.a(new_n86_), .b(new_n68_), .c(x19), .O(new_n87_));
  ...
  nand4  g040(.a(new_n92_), .b(x34), .c(x19), .d(new_n53_), .O(new_n93_));
  ...
  oai21  g047(.a(new_n99_), .b(new_n68_), .c(x19), .O(new_n100_));
  ...
  oai21  g054(.a(new_n106_), .b(new_n68_), .c(x19), .O(new_n107_));
  nand2  g055(.a(new_n97_), .b(new_n58_), .O(new_n108_));
  ...
  nand4  g067(.a(new_n119_), .b(x34), .c(x19), .d(new_n53_), .O(new_n120_));
  nand2  g068(.a(new_n111_), .b(new_n58_), .O(new_n121_));
  ...
  nand4  g072(.a(new_n124_), .b(x34), .c(x19), .d(new_n53_), .O(new_n125_));
  ...
  oai21  g079(.a(new_n131_), .b(new_n68_), .c(x19), .O(new_n132_));
  ...
  oai21  g087(.a(new_n139_), .b(new_n68_), .c(x19), .O(new_n140_));
  ...
  nand2  g097(.a(new_n149_), .b(x34), .O(z14));
  nand2  g098(.a(new_n54_), .b(x12), .O(new_n151_));
  nand2  g099(.a(new_n115_), .b(x18), .O(new_n152_));
  aoi21  g100(.a(new_n152_), .b(new_n151_), .c(x17), .O(new_n153_));
  oai21  g101(.a(new_n153_), .b(new_n68_), .c(x19), .O(new_n154_));
