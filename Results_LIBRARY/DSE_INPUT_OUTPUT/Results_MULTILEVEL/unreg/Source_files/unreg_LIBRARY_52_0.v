...
module FAU ( 
  ...
  oai21  g044(.a(new_n85_), .b(new_n60_), .c(new_n61_), .O(new_n97_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n61_), .c(x00), .O(new_n118_));
  ...
  oai21  g085(.a(new_n128_), .b(new_n60_), .c(new_n61_), .O(new_n138_));
  ...
  oai21  g107(.a(new_n149_), .b(new_n60_), .c(new_n61_), .O(new_n160_));
