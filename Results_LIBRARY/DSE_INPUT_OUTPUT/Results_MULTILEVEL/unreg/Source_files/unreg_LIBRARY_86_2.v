...
module FAU ( 
  ...
  aoi21  g036(.a(new_n88_), .b(new_n86_), .c(new_n55_), .O(z04));
  ...
  nor2   g059(.a(new_n111_), .b(new_n55_), .O(new_n112_));
  nand2  g060(.a(new_n112_), .b(new_n110_), .O(z08));
  nand2  g061(.a(x34), .b(x19), .O(new_n114_));
  nand2  g062(.a(new_n114_), .b(x29), .O(new_n115_));
  nand3  g063(.a(new_n115_), .b(new_n57_), .c(x10), .O(new_n116_));
  inv1   g064(.a(x30), .O(new_n117_));
  nand4  g065(.a(new_n54_), .b(new_n117_), .c(x19), .d(x18), .O(new_n118_));
  ...
  nand2  g074(.a(new_n117_), .b(new_n61_), .O(new_n127_));
  ...
  nand2  g088(.a(new_n57_), .b(x14), .O(new_n141_));
  oai21  g089(.a(x34), .b(new_n57_), .c(new_n141_), .O(new_n142_));
  nand3  g090(.a(new_n142_), .b(x19), .c(new_n56_), .O(new_n143_));
  nor2   g091(.a(x33), .b(x19), .O(new_n144_));
  nor2   g092(.a(new_n144_), .b(new_n55_), .O(new_n145_));
  ...
  oai21  g097(.a(x29), .b(new_n61_), .c(new_n53_), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n149_), .O(z14));
  nand2  g099(.a(new_n57_), .b(x12), .O(new_n152_));
  oai21  g100(.a(x28), .b(new_n57_), .c(new_n152_), .O(new_n153_));
  ...
  aoi21  g104(.a(new_n156_), .b(new_n154_), .c(new_n55_), .O(z15));
endmodule
