...
module FAU ( 
  ...
  nand3  g044(.a(new_n85_), .b(new_n60_), .c(x18), .O(new_n97_));
  ...
  nand3  g051(.a(new_n93_), .b(new_n60_), .c(x18), .O(new_n104_));
  ...
  nand3  g057(.a(new_n100_), .b(new_n60_), .c(x18), .O(new_n110_));
  ...
  nand2  g082(.a(new_n89_), .b(x18), .O(new_n135_));
  nand2  g083(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g084(.a(new_n136_), .b(x19), .c(new_n53_), .O(new_n137_));
  nand3  g085(.a(new_n128_), .b(new_n60_), .c(x18), .O(new_n138_));
