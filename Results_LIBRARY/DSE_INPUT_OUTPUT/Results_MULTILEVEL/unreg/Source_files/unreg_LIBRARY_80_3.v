...
module FAU ( 
  ...
  nand4  g025(.a(new_n77_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n78_));
  ...
  oai21  g037(.a(new_n89_), .b(x33), .c(x19), .O(new_n90_));
  ...
  oai21  g056(.a(new_n108_), .b(x33), .c(x19), .O(new_n109_));
  ...
  oai21  g064(.a(new_n116_), .b(x33), .c(x19), .O(new_n117_));
  ...
  nand2  g070(.a(new_n114_), .b(new_n59_), .O(new_n123_));
  ...
  nand4  g074(.a(new_n126_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n127_));
  inv1   g075(.a(x31), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n59_), .O(new_n129_));
  nand2  g077(.a(new_n129_), .b(new_n127_), .O(z11));
  nor2   g078(.a(x18), .b(x15), .O(new_n131_));
  oai21  g079(.a(new_n131_), .b(x17), .c(new_n54_), .O(new_n132_));
  nand2  g080(.a(new_n132_), .b(x19), .O(new_n133_));
  oai21  g081(.a(x32), .b(x19), .c(new_n133_), .O(z12));
  inv1   g082(.a(x14), .O(new_n135_));
  nor2   g083(.a(x18), .b(new_n135_), .O(new_n136_));
  inv1   g084(.a(x34), .O(new_n137_));
  nand3  g085(.a(new_n137_), .b(x19), .c(x18), .O(new_n138_));
  inv1   g086(.a(new_n138_), .O(new_n139_));
  oai21  g087(.a(new_n139_), .b(new_n136_), .c(new_n53_), .O(new_n140_));
  aoi21  g088(.a(new_n140_), .b(x19), .c(x33), .O(z13));
  nand2  g089(.a(new_n55_), .b(x13), .O(new_n142_));
  oai21  g090(.a(x35), .b(new_n55_), .c(new_n142_), .O(new_n143_));
  nand4  g091(.a(new_n143_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n144_));
  nand2  g092(.a(new_n137_), .b(new_n59_), .O(new_n145_));
  nand2  g093(.a(new_n145_), .b(new_n144_), .O(z14));
  nand2  g094(.a(new_n55_), .b(x12), .O(new_n147_));
  nand2  g095(.a(new_n110_), .b(x18), .O(new_n148_));
  aoi21  g096(.a(new_n148_), .b(new_n147_), .c(x17), .O(new_n149_));
  oai21  g097(.a(new_n149_), .b(x33), .c(x19), .O(new_n150_));
