...
module FAU ( 
  ...
  oai21  g015(.a(x28), .b(new_n66_), .c(new_n67_), .O(new_n68_));
  ...
  nor2   g021(.a(new_n73_), .b(new_n60_), .O(new_n74_));
  ...
  nor2   g028(.a(new_n80_), .b(new_n60_), .O(new_n81_));
  ...
  nor2   g046(.a(new_n98_), .b(new_n60_), .O(new_n99_));
  ...
  aoi21  g057(.a(x28), .b(x21), .c(x19), .O(new_n110_));
  nor2   g058(.a(new_n110_), .b(new_n60_), .O(new_n111_));
  ...
  nand2  g066(.a(new_n118_), .b(new_n66_), .O(new_n119_));
  ...
  nand2  g073(.a(new_n114_), .b(new_n66_), .O(new_n126_));
  aoi21  g074(.a(new_n126_), .b(new_n125_), .c(new_n60_), .O(z10));
  ...
  aoi21  g078(.a(new_n122_), .b(new_n66_), .c(new_n60_), .O(new_n131_));
  ...
  aoi21  g093(.a(new_n145_), .b(new_n143_), .c(new_n60_), .O(z13));
  ...
  aoi21  g097(.a(new_n140_), .b(new_n66_), .c(new_n60_), .O(new_n150_));
  ...
  nor2   g102(.a(x35), .b(x19), .O(new_n155_));
  nor2   g103(.a(new_n155_), .b(new_n60_), .O(new_n156_));
