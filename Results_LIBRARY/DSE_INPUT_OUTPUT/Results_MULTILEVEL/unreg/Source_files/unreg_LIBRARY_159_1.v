...
module FAU ( 
  ...
  oai21  g009(.a(x31), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g016(.a(x31), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g038(.a(x31), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g052(.a(x31), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  oai21  g058(.a(x31), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g066(.a(new_n76_), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n76_), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g079(.a(new_n76_), .b(new_n122_), .c(new_n60_), .O(new_n132_));
  ...
  oai21  g093(.a(new_n145_), .b(x31), .c(new_n60_), .O(new_n146_));
  ...
  oai21  g100(.a(new_n141_), .b(x31), .c(new_n60_), .O(new_n153_));
  ...
  oai21  g107(.a(new_n149_), .b(x31), .c(new_n60_), .O(new_n160_));
