...
module FAU ( 
  ...
  nand2  g32(.a(new_n84_), .b(new_n83_), .O(z06));
  ...
  inv1   g54(.a(x31), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(new_n53_), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(new_n106_), .O(z11));
  ...
  nand4  g65(.a(new_n117_), .b(x19), .c(x18), .d(new_n56_), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(new_n116_), .O(z13));
  nand2  g67(.a(new_n117_), .b(new_n53_), .O(new_n120_));
  inv1   g68(.a(x35), .O(new_n121_));
  nand4  g69(.a(new_n121_), .b(x19), .c(x18), .d(new_n56_), .O(new_n122_));
  nand2  g70(.a(new_n122_), .b(new_n120_), .O(z14));
  nand2  g71(.a(new_n121_), .b(new_n53_), .O(new_n124_));
  nand4  g72(.a(new_n91_), .b(x19), .c(x18), .d(new_n56_), .O(new_n125_));
