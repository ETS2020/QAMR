...
module FAU ( 
  ...
  nor2   g007(.a(x34), .b(new_n59_), .O(new_n60_));
  ...
  aoi21  g043(.a(x34), .b(new_n54_), .c(new_n59_), .O(new_n96_));
  ...
  inv1   g048(.a(new_n60_), .O(new_n101_));
  nand3  g049(.a(new_n101_), .b(new_n100_), .c(new_n79_), .O(new_n102_));
  ...
  inv1   g054(.a(x34), .O(new_n107_));
  oai21  g055(.a(new_n107_), .b(new_n59_), .c(new_n79_), .O(new_n108_));
  ...
  nor2   g061(.a(new_n113_), .b(new_n60_), .O(new_n114_));
  ...
  nand2  g067(.a(new_n119_), .b(new_n79_), .O(new_n120_));
  aoi21  g068(.a(new_n120_), .b(new_n118_), .c(new_n60_), .O(z09));
  ...
  nor2   g073(.a(new_n125_), .b(new_n60_), .O(new_n126_));
  ...
  nand2  g079(.a(new_n131_), .b(new_n79_), .O(new_n132_));
  aoi21  g080(.a(new_n132_), .b(new_n130_), .c(new_n60_), .O(z11));
  ...
  nand4  g087(.a(x19), .b(new_n54_), .c(new_n53_), .d(x14), .O(new_n140_));
  oai21  g088(.a(x33), .b(x19), .c(new_n140_), .O(new_n141_));
  nand2  g089(.a(new_n141_), .b(new_n101_), .O(new_n142_));
  nor2   g090(.a(x34), .b(x27), .O(new_n143_));
  nand4  g091(.a(new_n143_), .b(x19), .c(x18), .d(new_n53_), .O(new_n144_));
  ...
  oai21  g096(.a(x27), .b(new_n79_), .c(new_n107_), .O(new_n149_));
