...
module FAU ( 
  ...
  nand3  g024(.a(x31), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g030(.a(x31), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g045(.a(x31), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g066(.a(x31), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  nand2  g091(.a(x32), .b(x31), .O(new_n144_));
