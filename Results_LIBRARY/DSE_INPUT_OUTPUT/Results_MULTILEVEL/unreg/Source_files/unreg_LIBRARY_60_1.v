...
module FAU ( 
  ...
  nand3  g051(.a(new_n62_), .b(new_n94_), .c(new_n60_), .O(new_n104_));
  ...
  oai21  g056(.a(new_n108_), .b(new_n107_), .c(new_n53_), .O(new_n109_));
  ...
  nand3  g064(.a(new_n116_), .b(new_n62_), .c(new_n60_), .O(new_n117_));
  ...
  oai21  g084(.a(new_n127_), .b(x27), .c(new_n60_), .O(new_n137_));
  ...
  oai21  g106(.a(new_n148_), .b(x27), .c(new_n60_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n155_), .b(new_n62_), .c(new_n60_), .O(new_n165_));
