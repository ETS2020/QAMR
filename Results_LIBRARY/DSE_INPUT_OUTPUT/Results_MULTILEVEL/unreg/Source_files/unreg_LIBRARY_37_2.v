...
module FAU ( 
  ...
  nand4  g04(.a(new_n56_), .b(x22), .c(x19), .d(new_n53_), .O(new_n57_));
  ...
  nand2  g09(.a(new_n53_), .b(x02), .O(new_n62_));
  nand3  g10(.a(x22), .b(x19), .c(new_n54_), .O(new_n63_));
  oai22  g11(.a(new_n63_), .b(new_n62_), .c(x21), .d(x19), .O(z01));
  nand2  g12(.a(new_n54_), .b(x01), .O(new_n65_));
  oai21  g13(.a(x23), .b(new_n54_), .c(new_n65_), .O(new_n66_));
  nand4  g14(.a(new_n66_), .b(x22), .c(x19), .d(new_n53_), .O(new_n67_));
  inv1   g15(.a(x22), .O(new_n68_));
  nand2  g16(.a(new_n68_), .b(new_n58_), .O(new_n69_));
  nand2  g17(.a(new_n69_), .b(new_n67_), .O(z02));
  inv1   g18(.a(x00), .O(new_n71_));
  nand2  g19(.a(x18), .b(x16), .O(new_n72_));
  oai21  g20(.a(x18), .b(new_n71_), .c(new_n72_), .O(new_n73_));
  nand4  g21(.a(new_n73_), .b(x22), .c(x19), .d(new_n53_), .O(new_n74_));
  ...
  nand4  g25(.a(new_n77_), .b(x22), .c(x19), .d(new_n53_), .O(new_n78_));
  ...
  aoi21  g32(.a(new_n84_), .b(new_n82_), .c(x17), .O(new_n85_));
  oai21  g33(.a(new_n85_), .b(new_n68_), .c(x19), .O(new_n86_));
  inv1   g34(.a(x25), .O(new_n87_));
  nand2  g35(.a(new_n87_), .b(new_n58_), .O(new_n88_));
  nand2  g36(.a(new_n88_), .b(new_n86_), .O(z05));
  nand2  g37(.a(new_n54_), .b(x05), .O(new_n90_));
  oai21  g38(.a(x27), .b(new_n54_), .c(new_n90_), .O(new_n91_));
  nand4  g39(.a(new_n91_), .b(x22), .c(x19), .d(new_n53_), .O(new_n92_));
  nand2  g40(.a(new_n83_), .b(new_n58_), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(new_n92_), .O(z06));
  nand2  g42(.a(new_n54_), .b(x04), .O(new_n95_));
  oai21  g43(.a(x20), .b(new_n54_), .c(new_n95_), .O(new_n96_));
  nand4  g44(.a(new_n96_), .b(x22), .c(x19), .d(new_n53_), .O(new_n97_));
  inv1   g45(.a(x27), .O(new_n98_));
  nand2  g46(.a(new_n98_), .b(new_n58_), .O(new_n99_));
  nand2  g47(.a(new_n99_), .b(new_n97_), .O(z07));
  ...
  oai21  g52(.a(new_n104_), .b(new_n68_), .c(x19), .O(new_n105_));
  ...
  nand4  g58(.a(new_n110_), .b(x22), .c(x19), .d(new_n53_), .O(new_n111_));
  ...
  oai21  g65(.a(new_n117_), .b(new_n68_), .c(x19), .O(new_n118_));
  ...
  oai21  g70(.a(x24), .b(new_n54_), .c(new_n122_), .O(new_n123_));
  nand4  g71(.a(new_n123_), .b(x22), .c(x19), .d(new_n53_), .O(new_n124_));
  nand2  g72(.a(new_n115_), .b(new_n58_), .O(new_n125_));
  nand2  g73(.a(new_n125_), .b(new_n124_), .O(z11));
  nand2  g74(.a(new_n54_), .b(x15), .O(new_n127_));
  oai21  g75(.a(x33), .b(new_n54_), .c(new_n127_), .O(new_n128_));
  nand4  g76(.a(new_n128_), .b(x22), .c(x19), .d(new_n53_), .O(new_n129_));
  ...
  nand4  g82(.a(new_n134_), .b(x22), .c(x19), .d(new_n53_), .O(new_n135_));
  ...
  oai21  g90(.a(new_n142_), .b(new_n68_), .c(x19), .O(new_n143_));
  ...
  nand4  g96(.a(new_n148_), .b(x22), .c(x19), .d(new_n53_), .O(new_n149_));
