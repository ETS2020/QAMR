...
module FAU ( 
  ...
  oai21  g024(.a(new_n66_), .b(x06), .c(new_n61_), .O(new_n77_));
  ...
  oai21  g080(.a(new_n122_), .b(x06), .c(new_n61_), .O(new_n133_));
  ...
  oai21  g101(.a(new_n142_), .b(x06), .c(new_n61_), .O(new_n154_));
