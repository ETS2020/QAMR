...
module FAU ( 
  ...
  oai21  g009(.a(new_n61_), .b(x00), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g016(.a(new_n56_), .b(x00), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(new_n65_), .b(x00), .c(new_n60_), .O(new_n76_));
  nand2  g024(.a(new_n76_), .b(new_n75_), .O(z02));
  oai21  g025(.a(x18), .b(x17), .c(x19), .O(new_n78_));
  nand2  g026(.a(new_n78_), .b(x00), .O(new_n79_));
  nand4  g027(.a(x19), .b(x18), .c(new_n53_), .d(x16), .O(new_n80_));
  nand2  g028(.a(new_n72_), .b(new_n60_), .O(new_n81_));
  nand3  g029(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(z03));
  ...
  inv1   g035(.a(x00), .O(new_n88_));
  inv1   g036(.a(x24), .O(new_n89_));
  nand3  g037(.a(new_n89_), .b(new_n60_), .c(new_n88_), .O(new_n90_));
  ...
  nand3  g044(.a(new_n84_), .b(new_n60_), .c(new_n88_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n93_), .b(new_n60_), .c(new_n88_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n100_), .b(new_n60_), .c(new_n88_), .O(new_n110_));
  ...
  oai21  g065(.a(new_n117_), .b(x00), .c(new_n60_), .O(new_n118_));
  ...
  oai21  g072(.a(new_n113_), .b(x00), .c(new_n60_), .O(new_n125_));
  ...
  oai21  g079(.a(new_n121_), .b(x00), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n60_), .c(new_n88_), .O(new_n138_));
  ...
  oai21  g093(.a(new_n145_), .b(x00), .c(new_n60_), .O(new_n146_));
  ...
  oai21  g100(.a(new_n141_), .b(x00), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n149_), .b(new_n60_), .c(new_n88_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n156_), .b(x00), .c(new_n60_), .O(new_n166_));
