...
module FAU ( 
  ...
  nand4  g028(.a(new_n80_), .b(x19), .c(new_n53_), .d(x10), .O(new_n81_));
  ...
  nand4  g059(.a(new_n111_), .b(x19), .c(new_n53_), .d(x10), .O(new_n112_));
  ...
  nand4  g064(.a(new_n116_), .b(x19), .c(new_n53_), .d(x10), .O(new_n117_));
  oai21  g065(.a(x29), .b(x19), .c(new_n117_), .O(z09));
  nand2  g066(.a(new_n54_), .b(x09), .O(new_n119_));
  oai21  g067(.a(x31), .b(new_n54_), .c(new_n119_), .O(new_n120_));
  nand4  g068(.a(new_n120_), .b(x19), .c(new_n53_), .d(x10), .O(new_n121_));
  ...
  nand4  g074(.a(new_n126_), .b(x19), .c(new_n53_), .d(x10), .O(new_n127_));
  ...
  oai21  g090(.a(new_n142_), .b(new_n62_), .c(x19), .O(new_n143_));
  ...
  oai21  g097(.a(new_n149_), .b(new_n62_), .c(x19), .O(new_n150_));
  nand2  g098(.a(new_n140_), .b(new_n58_), .O(new_n151_));
  ...
  nand4  g102(.a(new_n154_), .b(x19), .c(new_n53_), .d(x10), .O(new_n155_));
  nand2  g103(.a(new_n147_), .b(new_n58_), .O(new_n156_));
