...
module FAU ( 
  ...
  nor2   g007(.a(x32), .b(new_n59_), .O(new_n60_));
  ...
  aoi21  g013(.a(x32), .b(x21), .c(x19), .O(new_n66_));
  ...
  inv1   g021(.a(x19), .O(new_n74_));
  inv1   g022(.a(x22), .O(new_n75_));
  nand2  g023(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  aoi21  g024(.a(new_n76_), .b(new_n73_), .c(new_n60_), .O(z02));
  ...
  aoi21  g029(.a(new_n70_), .b(new_n74_), .c(new_n60_), .O(new_n82_));
  ...
  nand2  g037(.a(new_n89_), .b(new_n74_), .O(new_n90_));
  ...
  nand2  g044(.a(new_n85_), .b(new_n74_), .O(new_n97_));
  ...
  aoi21  g049(.a(new_n93_), .b(new_n74_), .c(new_n60_), .O(new_n102_));
  ...
  aoi21  g061(.a(new_n113_), .b(new_n74_), .c(new_n60_), .O(new_n114_));
  ...
  nand2  g069(.a(new_n121_), .b(new_n74_), .O(new_n122_));
  ...
  aoi21  g074(.a(new_n117_), .b(new_n74_), .c(new_n60_), .O(new_n127_));
  ...
  nand2  g081(.a(new_n133_), .b(new_n74_), .O(new_n134_));
  ...
  oai21  g087(.a(x21), .b(new_n74_), .c(new_n139_), .O(new_n140_));
  ...
  nand2  g095(.a(new_n147_), .b(new_n74_), .O(new_n148_));
  ...
  aoi21  g100(.a(new_n143_), .b(new_n74_), .c(new_n60_), .O(new_n153_));
  ...
  nand2  g107(.a(new_n159_), .b(new_n74_), .O(new_n160_));
