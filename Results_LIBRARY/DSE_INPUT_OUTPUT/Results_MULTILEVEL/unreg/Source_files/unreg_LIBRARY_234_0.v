...
module FAU ( 
  ...
  nand3  g024(.a(x29), .b(new_n65_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g092(.a(new_n144_), .b(x29), .c(new_n60_), .O(new_n145_));
  ...
  oai21  g099(.a(new_n140_), .b(new_n69_), .c(new_n60_), .O(new_n152_));
