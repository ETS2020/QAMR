...
module FAU ( 
  ...
  nand3  g029(.a(new_n72_), .b(x22), .c(new_n60_), .O(new_n82_));
  ...
  oai21  g037(.a(new_n89_), .b(new_n62_), .c(new_n60_), .O(new_n90_));
  ...
  nand3  g044(.a(new_n85_), .b(x22), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n93_), .b(x22), .c(new_n60_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n100_), .b(x22), .c(new_n60_), .O(new_n110_));
  ...
  nand3  g065(.a(new_n117_), .b(x22), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n113_), .b(x22), .c(new_n60_), .O(new_n125_));
  ...
  oai21  g085(.a(new_n128_), .b(new_n62_), .c(new_n60_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(x22), .c(new_n60_), .O(new_n146_));
  ...
  nand3  g107(.a(new_n149_), .b(x22), .c(new_n60_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n156_), .b(new_n62_), .c(new_n60_), .O(new_n166_));
