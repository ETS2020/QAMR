...
module FAU ( 
  ...
  nand4  g032(.a(new_n84_), .b(x19), .c(new_n82_), .d(x00), .O(new_n85_));
  ...
  nand4  g038(.a(new_n90_), .b(x19), .c(new_n82_), .d(x00), .O(new_n91_));
  ...
  nand4  g044(.a(new_n96_), .b(x19), .c(new_n82_), .d(x00), .O(new_n97_));
  ...
  nand4  g050(.a(new_n102_), .b(x19), .c(new_n82_), .d(x00), .O(new_n103_));
  ...
  oai21  g073(.a(new_n125_), .b(new_n53_), .c(x19), .O(new_n126_));
  ...
  nand4  g078(.a(new_n130_), .b(x19), .c(new_n82_), .d(x00), .O(new_n131_));
  nand2  g079(.a(new_n123_), .b(new_n60_), .O(new_n132_));
  ...
  oai21  g093(.a(new_n145_), .b(new_n53_), .c(x19), .O(new_n146_));
  nand2  g094(.a(new_n135_), .b(new_n60_), .O(new_n147_));
  ...
  nand4  g098(.a(new_n150_), .b(x19), .c(new_n82_), .d(x00), .O(new_n151_));
  nand2  g099(.a(new_n143_), .b(new_n60_), .O(new_n152_));
