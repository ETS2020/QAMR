...
module FAU ( 
  ...
  oai21  g016(.a(new_n56_), .b(x14), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(new_n65_), .b(x14), .c(new_n60_), .O(new_n76_));
  ...
  inv1   g029(.a(x14), .O(new_n82_));
  nand3  g030(.a(new_n72_), .b(new_n60_), .c(new_n82_), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n60_), .c(new_n82_), .O(new_n91_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n60_), .c(new_n82_), .O(new_n98_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n60_), .c(new_n82_), .O(new_n111_));
  ...
  oai21  g066(.a(new_n118_), .b(x14), .c(new_n60_), .O(new_n119_));
  ...
  oai21  g080(.a(new_n122_), .b(x14), .c(new_n60_), .O(new_n133_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n60_), .c(new_n82_), .O(new_n139_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n60_), .c(new_n82_), .O(new_n147_));
  ...
  nand3  g101(.a(new_n142_), .b(new_n60_), .c(new_n82_), .O(new_n154_));
  ...
  nand3  g108(.a(new_n150_), .b(new_n60_), .c(new_n82_), .O(new_n161_));
  ...
  oai21  g114(.a(new_n157_), .b(x14), .c(new_n60_), .O(new_n167_));
