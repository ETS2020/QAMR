...
module FAU ( 
  ...
  nand3  g024(.a(x33), .b(new_n65_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g052(.a(x33), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  oai21  g066(.a(new_n69_), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  oai21  g073(.a(new_n69_), .b(new_n114_), .c(new_n60_), .O(new_n126_));
