...
module FAU ( 
  ...
  oai21  g009(.a(new_n61_), .b(x14), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g030(.a(new_n73_), .b(x14), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n60_), .c(new_n69_), .O(new_n91_));
  ...
  oai21  g052(.a(new_n94_), .b(x14), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n60_), .c(new_n69_), .O(new_n119_));
  ...
  oai21  g073(.a(new_n114_), .b(x14), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n60_), .c(new_n69_), .O(new_n147_));
