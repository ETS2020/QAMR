...
module FAU ( 
  ...
  oai21  g21(.a(new_n71_), .b(new_n64_), .c(new_n73_), .O(z06));
  ...
  nand2  g30(.a(new_n53_), .b(x08), .O(new_n83_));
  oai22  g31(.a(new_n83_), .b(new_n56_), .c(x31), .d(x19), .O(z11));
  nand2  g32(.a(new_n53_), .b(x15), .O(new_n85_));
  oai22  g33(.a(new_n85_), .b(new_n56_), .c(x32), .d(x19), .O(z12));
  nand2  g34(.a(new_n53_), .b(x14), .O(new_n87_));
  oai22  g35(.a(new_n87_), .b(new_n56_), .c(x33), .d(x19), .O(z13));
  aoi21  g36(.a(new_n53_), .b(x13), .c(x18), .O(new_n89_));
  inv1   g37(.a(x34), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(new_n64_), .O(new_n91_));
  oai21  g39(.a(new_n89_), .b(new_n64_), .c(new_n91_), .O(z14));
  aoi21  g40(.a(new_n53_), .b(x12), .c(x18), .O(new_n93_));
  inv1   g41(.a(x35), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(new_n64_), .O(new_n95_));
  oai21  g43(.a(new_n93_), .b(new_n64_), .c(new_n95_), .O(z15));
endmodule
