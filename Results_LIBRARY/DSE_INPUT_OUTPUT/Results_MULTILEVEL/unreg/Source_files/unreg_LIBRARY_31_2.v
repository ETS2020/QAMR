...
module FAU ( 
  ...
  nand2  g007(.a(new_n59_), .b(x26), .O(new_n60_));
  ...
  oai21  g045(.a(new_n59_), .b(new_n69_), .c(x26), .O(new_n98_));
  ...
  nand2  g050(.a(new_n102_), .b(new_n69_), .O(new_n103_));
  ...
  nor2   g055(.a(x27), .b(x19), .O(new_n108_));
  nor2   g056(.a(new_n108_), .b(new_n61_), .O(new_n109_));
  ...
  nand2  g064(.a(new_n116_), .b(new_n69_), .O(new_n117_));
  aoi21  g065(.a(new_n117_), .b(new_n115_), .c(new_n61_), .O(z08));
  ...
  aoi21  g069(.a(new_n112_), .b(new_n69_), .c(new_n61_), .O(new_n122_));
  ...
  nand2  g077(.a(new_n129_), .b(new_n69_), .O(new_n130_));
  aoi21  g078(.a(new_n130_), .b(new_n128_), .c(new_n61_), .O(z10));
  nand2  g079(.a(new_n54_), .b(x08), .O(new_n132_));
  nand2  g080(.a(new_n90_), .b(x18), .O(new_n133_));
  nand2  g081(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand3  g082(.a(new_n134_), .b(x19), .c(new_n53_), .O(new_n135_));
  nand2  g083(.a(new_n125_), .b(new_n69_), .O(new_n136_));
  aoi21  g084(.a(new_n136_), .b(new_n135_), .c(new_n61_), .O(z11));
  ...
  nand4  g089(.a(new_n141_), .b(new_n60_), .c(x19), .d(new_n53_), .O(new_n142_));
  nand3  g090(.a(new_n59_), .b(new_n102_), .c(new_n69_), .O(new_n143_));
  ...
  nand4  g096(.a(new_n148_), .b(new_n60_), .c(x19), .d(new_n53_), .O(new_n149_));
  nand2  g097(.a(new_n59_), .b(x26), .O(new_n150_));
  nand3  g098(.a(new_n150_), .b(new_n139_), .c(new_n69_), .O(new_n151_));
  ...
  nand2  g105(.a(new_n146_), .b(new_n69_), .O(new_n158_));
  aoi21  g106(.a(new_n158_), .b(new_n157_), .c(new_n61_), .O(z14));
  ...
  aoi21  g110(.a(new_n154_), .b(new_n69_), .c(new_n61_), .O(new_n163_));
