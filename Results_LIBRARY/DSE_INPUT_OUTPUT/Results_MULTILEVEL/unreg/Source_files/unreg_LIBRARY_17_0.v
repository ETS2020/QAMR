...
module FAU ( 
  ...
  nand3  g009(.a(new_n61_), .b(new_n60_), .c(x00), .O(new_n62_));
  ...
  nand3  g016(.a(new_n56_), .b(new_n60_), .c(x00), .O(new_n69_));
  ...
  oai21  g027(.a(x18), .b(new_n76_), .c(new_n79_), .O(new_n80_));
  nand3  g028(.a(new_n80_), .b(x19), .c(new_n53_), .O(new_n81_));
  oai21  g029(.a(new_n72_), .b(new_n76_), .c(new_n60_), .O(new_n82_));
  ...
  nand3  g037(.a(new_n89_), .b(new_n60_), .c(x00), .O(new_n90_));
  ...
  oai21  g044(.a(new_n85_), .b(new_n76_), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n93_), .b(new_n60_), .c(x00), .O(new_n104_));
  ...
  nand3  g072(.a(new_n113_), .b(new_n60_), .c(x00), .O(new_n125_));
  ...
  oai21  g079(.a(new_n121_), .b(new_n76_), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n60_), .c(x00), .O(new_n138_));
  ...
  oai21  g100(.a(new_n141_), .b(new_n76_), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n149_), .b(new_n60_), .c(x00), .O(new_n160_));
  ...
  nand3  g113(.a(new_n156_), .b(new_n60_), .c(x00), .O(new_n166_));
