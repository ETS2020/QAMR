...
module FAU ( 
  ...
  oai21  g024(.a(x29), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g030(.a(x29), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g045(.a(new_n62_), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g052(.a(new_n62_), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g058(.a(new_n62_), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g065(.a(new_n62_), .b(new_n117_), .c(new_n60_), .O(new_n118_));
  nand2  g066(.a(new_n118_), .b(new_n116_), .O(z08));
  inv1   g067(.a(x10), .O(new_n120_));
  nor2   g068(.a(x18), .b(new_n120_), .O(new_n121_));
  nor2   g069(.a(x30), .b(new_n54_), .O(new_n122_));
  oai21  g070(.a(new_n122_), .b(new_n121_), .c(new_n53_), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(x19), .O(z09));
  ...
  nand3  g078(.a(new_n130_), .b(new_n62_), .c(new_n60_), .O(new_n131_));
  ...
  nand3  g084(.a(new_n126_), .b(new_n62_), .c(new_n60_), .O(new_n137_));
  ...
  oai21  g112(.a(new_n155_), .b(x29), .c(new_n60_), .O(new_n165_));
