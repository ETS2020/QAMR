...
module FAU ( 
  ...
  aoi21  g21(.a(new_n53_), .b(x06), .c(x18), .O(new_n74_));
  inv1   g22(.a(x25), .O(new_n75_));
  nand2  g23(.a(new_n75_), .b(new_n57_), .O(new_n76_));
  oai21  g24(.a(new_n74_), .b(new_n57_), .c(new_n76_), .O(z05));
  nand4  g25(.a(x19), .b(new_n54_), .c(new_n53_), .d(x05), .O(new_n78_));
  oai21  g26(.a(x26), .b(x19), .c(new_n78_), .O(z06));
  aoi21  g27(.a(new_n53_), .b(x04), .c(x18), .O(new_n80_));
  inv1   g28(.a(x27), .O(new_n81_));
  nand2  g29(.a(new_n81_), .b(new_n57_), .O(new_n82_));
  oai21  g30(.a(new_n80_), .b(new_n57_), .c(new_n82_), .O(z07));
  nand4  g31(.a(x19), .b(new_n54_), .c(new_n53_), .d(x11), .O(new_n84_));
  oai21  g32(.a(x28), .b(x19), .c(new_n84_), .O(z08));
  aoi21  g33(.a(new_n53_), .b(x10), .c(x18), .O(new_n86_));
  inv1   g34(.a(x29), .O(new_n87_));
  nand2  g35(.a(new_n87_), .b(new_n57_), .O(new_n88_));
  oai21  g36(.a(new_n86_), .b(new_n57_), .c(new_n88_), .O(z09));
  nand4  g37(.a(x19), .b(new_n54_), .c(new_n53_), .d(x09), .O(new_n90_));
  ...
  oai21  g48(.a(new_n98_), .b(new_n57_), .c(new_n100_), .O(z13));
