...
module FAU ( 
  ...
  nand2  g23(.a(new_n75_), .b(new_n61_), .O(new_n76_));
  oai21  g24(.a(new_n74_), .b(new_n61_), .c(new_n76_), .O(z06));
  aoi21  g25(.a(new_n53_), .b(x04), .c(x18), .O(new_n78_));
  inv1   g26(.a(x27), .O(new_n79_));
  nand2  g27(.a(new_n79_), .b(new_n61_), .O(new_n80_));
  oai21  g28(.a(new_n78_), .b(new_n61_), .c(new_n80_), .O(z07));
  ...
  oai21  g34(.a(new_n84_), .b(new_n61_), .c(new_n86_), .O(z09));
  ...
  nand2  g51(.a(new_n103_), .b(new_n61_), .O(new_n104_));
  oai21  g52(.a(new_n102_), .b(new_n61_), .c(new_n104_), .O(z15));
endmodule
