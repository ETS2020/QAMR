...
module FAU ( 
  ...
  nand3  g030(.a(x25), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g051(.a(new_n93_), .b(new_n62_), .c(new_n60_), .O(new_n104_));
  ...
  nand3  g065(.a(new_n117_), .b(x25), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g085(.a(new_n128_), .b(x25), .c(new_n60_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(x25), .c(new_n60_), .O(new_n146_));
  ...
  nand3  g113(.a(new_n156_), .b(x25), .c(new_n60_), .O(new_n166_));
