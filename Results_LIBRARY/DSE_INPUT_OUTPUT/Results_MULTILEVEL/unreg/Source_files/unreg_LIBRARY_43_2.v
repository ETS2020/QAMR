...
module FAU ( 
  ...
  oai21  g009(.a(new_n61_), .b(x17), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g016(.a(new_n56_), .b(x17), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(new_n65_), .b(x17), .c(new_n60_), .O(new_n76_));
  ...
  aoi21  g030(.a(new_n82_), .b(new_n81_), .c(x17), .O(z03));
  ...
  oai21  g037(.a(new_n89_), .b(x17), .c(new_n60_), .O(new_n90_));
  ...
  nand2  g043(.a(new_n85_), .b(new_n60_), .O(new_n96_));
  ...
  nand2  g057(.a(new_n99_), .b(new_n60_), .O(new_n110_));
  ...
  oai21  g065(.a(new_n117_), .b(x17), .c(new_n60_), .O(new_n118_));
  ...
  oai21  g072(.a(new_n113_), .b(x17), .c(new_n60_), .O(new_n125_));
  ...
  nor2   g082(.a(x24), .b(new_n54_), .O(new_n135_));
  oai21  g083(.a(new_n135_), .b(new_n134_), .c(x19), .O(new_n136_));
  inv1   g084(.a(x31), .O(new_n137_));
  nand2  g085(.a(new_n137_), .b(new_n60_), .O(new_n138_));
  aoi21  g086(.a(new_n138_), .b(new_n136_), .c(x17), .O(z11));
  ...
  nor2   g096(.a(x34), .b(new_n54_), .O(new_n149_));
  ...
  oai21  g107(.a(new_n159_), .b(x17), .c(new_n60_), .O(new_n160_));
  ...
  nand2  g113(.a(new_n155_), .b(new_n60_), .O(new_n166_));
