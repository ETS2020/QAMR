// Benchmark "FAU" written by ABC on Fri Aug 14 02:05:28 2020
...
module FAU ( 
  ...
  nand3  g017(.a(x26), .b(new_n56_), .c(new_n60_), .O(new_n70_));
  ...
  nand3  g044(.a(x26), .b(new_n86_), .c(new_n60_), .O(new_n97_));
  ...
  nand2  g051(.a(new_n62_), .b(new_n60_), .O(new_n104_));
  ...
  oai21  g057(.a(new_n100_), .b(new_n62_), .c(new_n60_), .O(new_n110_));
  ...
  nand3  g065(.a(new_n117_), .b(x26), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n113_), .b(x26), .c(new_n60_), .O(new_n125_));
  ...
  nand3  g085(.a(new_n128_), .b(x26), .c(new_n60_), .O(new_n138_));
  ...
  nand2  g092(.a(x32), .b(x26), .O(new_n145_));
  ...
  oai21  g100(.a(new_n141_), .b(new_n62_), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g113(.a(new_n156_), .b(x26), .c(new_n60_), .O(new_n166_));
