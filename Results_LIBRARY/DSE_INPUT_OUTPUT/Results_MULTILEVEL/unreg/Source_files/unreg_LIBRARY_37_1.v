...
module FAU ( 
  ...
  nand2  g013(.a(new_n62_), .b(x18), .O(new_n66_));
  nand2  g014(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g015(.a(new_n67_), .b(x19), .c(new_n53_), .O(new_n68_));
  nand3  g016(.a(new_n62_), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  nand2  g023(.a(new_n62_), .b(new_n60_), .O(new_n76_));
  ...
  nand3  g029(.a(new_n72_), .b(new_n62_), .c(new_n60_), .O(new_n82_));
  ...
  nand3  g037(.a(new_n89_), .b(new_n62_), .c(new_n60_), .O(new_n90_));
  ...
  oai21  g044(.a(new_n85_), .b(x22), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n93_), .b(new_n62_), .c(new_n60_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n100_), .b(new_n62_), .c(new_n60_), .O(new_n110_));
  ...
  oai21  g065(.a(new_n117_), .b(x22), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n113_), .b(new_n62_), .c(new_n60_), .O(new_n125_));
  ...
  oai21  g079(.a(new_n121_), .b(x22), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n62_), .c(new_n60_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n62_), .c(new_n60_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n62_), .c(new_n60_), .O(new_n153_));
  ...
  oai21  g107(.a(new_n149_), .b(x22), .c(new_n60_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n156_), .b(new_n62_), .c(new_n60_), .O(new_n166_));
