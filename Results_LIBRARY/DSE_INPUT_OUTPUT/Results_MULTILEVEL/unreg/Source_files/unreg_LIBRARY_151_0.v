...
module FAU ( 
  ...
  nand3  g030(.a(x30), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g038(.a(x30), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  nand3  g045(.a(x30), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g058(.a(x30), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g068(.a(x19), .b(new_n54_), .c(x10), .O(new_n121_));
  nand2  g069(.a(new_n62_), .b(x18), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(new_n53_), .O(new_n124_));
  oai21  g072(.a(new_n62_), .b(new_n114_), .c(new_n60_), .O(new_n125_));
  ...
  nand3  g084(.a(new_n128_), .b(x30), .c(new_n60_), .O(new_n137_));
  ...
  nand2  g091(.a(x32), .b(x30), .O(new_n144_));
  ...
  nand3  g099(.a(new_n140_), .b(x30), .c(new_n60_), .O(new_n152_));
  ...
  nand3  g112(.a(new_n155_), .b(x30), .c(new_n60_), .O(new_n165_));
