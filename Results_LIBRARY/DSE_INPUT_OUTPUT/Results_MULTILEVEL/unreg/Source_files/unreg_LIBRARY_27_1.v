...
module FAU ( 
  ...
  oai21  g035(.a(new_n87_), .b(new_n86_), .c(new_n53_), .O(new_n88_));
  ...
  nand3  g043(.a(new_n95_), .b(new_n69_), .c(new_n60_), .O(new_n96_));
  ...
  nand3  g050(.a(new_n91_), .b(new_n69_), .c(new_n60_), .O(new_n103_));
  ...
  nand3  g056(.a(new_n99_), .b(new_n69_), .c(new_n60_), .O(new_n109_));
  ...
  oai21  g064(.a(new_n116_), .b(x24), .c(new_n60_), .O(new_n117_));
  ...
  oai21  g071(.a(new_n112_), .b(x24), .c(new_n60_), .O(new_n124_));
  ...
  oai21  g092(.a(new_n144_), .b(x24), .c(new_n60_), .O(new_n145_));
  ...
  nand3  g099(.a(new_n140_), .b(new_n69_), .c(new_n60_), .O(new_n152_));
  ...
  oai21  g106(.a(new_n148_), .b(x24), .c(new_n60_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n155_), .b(new_n69_), .c(new_n60_), .O(new_n165_));
