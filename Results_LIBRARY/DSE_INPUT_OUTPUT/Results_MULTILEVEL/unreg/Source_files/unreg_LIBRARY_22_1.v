...
module FAU ( 
  ...
  aoi21  g26(.a(new_n78_), .b(new_n53_), .c(new_n65_), .O(new_n79_));
  nand2  g27(.a(new_n74_), .b(new_n59_), .O(new_n80_));
  oai21  g28(.a(new_n79_), .b(new_n59_), .c(new_n80_), .O(z06));
  oai21  g29(.a(x20), .b(x17), .c(x18), .O(new_n82_));
  nand2  g30(.a(new_n82_), .b(x19), .O(new_n83_));
  nand2  g31(.a(new_n78_), .b(new_n59_), .O(new_n84_));
  ...
  nand2  g41(.a(new_n89_), .b(new_n59_), .O(new_n94_));
  ...
  nand2  g51(.a(new_n99_), .b(new_n59_), .O(new_n104_));
