...
module FAU ( 
  ...
  nand4  g042(.a(new_n94_), .b(x19), .c(new_n78_), .d(x15), .O(new_n95_));
  ...
  nand4  g047(.a(new_n99_), .b(x19), .c(new_n78_), .d(x15), .O(new_n100_));
  ...
  nand4  g053(.a(new_n105_), .b(x19), .c(new_n78_), .d(x15), .O(new_n106_));
  ...
  nand4  g059(.a(new_n111_), .b(x19), .c(new_n78_), .d(x15), .O(new_n112_));
  ...
  nand4  g065(.a(new_n117_), .b(x19), .c(new_n78_), .d(x15), .O(new_n118_));
  ...
  aoi21  g083(.a(x33), .b(x18), .c(x17), .O(new_n136_));
