...
module FAU ( 
  ...
  nand3  g009(.a(new_n56_), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g051(.a(new_n93_), .b(x21), .c(new_n60_), .O(new_n104_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n56_), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n113_), .b(new_n56_), .c(new_n60_), .O(new_n125_));
  ...
  oai21  g085(.a(new_n128_), .b(x21), .c(new_n60_), .O(new_n138_));
