...
module FAU ( 
  ...
  nand3  g017(.a(x24), .b(new_n56_), .c(new_n60_), .O(new_n70_));
  ...
  nand3  g024(.a(x24), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g030(.a(x24), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g043(.a(new_n86_), .b(x24), .c(new_n60_), .O(new_n96_));
  ...
  nand3  g071(.a(new_n112_), .b(x24), .c(new_n60_), .O(new_n124_));
  ...
  nand3  g112(.a(new_n155_), .b(x24), .c(new_n60_), .O(new_n165_));
