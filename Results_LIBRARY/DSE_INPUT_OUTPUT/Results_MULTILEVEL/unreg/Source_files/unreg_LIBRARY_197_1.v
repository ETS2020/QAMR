...
module FAU ( 
  ...
  oai21  g036(.a(new_n88_), .b(x23), .c(new_n60_), .O(new_n89_));
  ...
  nand3  g043(.a(new_n84_), .b(new_n69_), .c(new_n60_), .O(new_n96_));
  ...
  nand3  g050(.a(new_n92_), .b(new_n69_), .c(new_n60_), .O(new_n103_));
  ...
  oai21  g056(.a(new_n99_), .b(x23), .c(new_n60_), .O(new_n109_));
  ...
  nand3  g078(.a(new_n120_), .b(new_n69_), .c(new_n60_), .O(new_n131_));
  ...
  nand3  g092(.a(new_n144_), .b(new_n69_), .c(new_n60_), .O(new_n145_));
  ...
  oai21  g099(.a(new_n140_), .b(x23), .c(new_n60_), .O(new_n152_));
  ...
  oai21  g106(.a(new_n148_), .b(x23), .c(new_n60_), .O(new_n159_));
  ...
  oai21  g112(.a(new_n155_), .b(x23), .c(new_n60_), .O(new_n165_));
