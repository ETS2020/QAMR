...
module FAU ( 
  ...
  oai21  g26(.a(new_n76_), .b(new_n59_), .c(new_n78_), .O(z08));
  aoi21  g27(.a(new_n53_), .b(x10), .c(x18), .O(new_n80_));
  inv1   g28(.a(x29), .O(new_n81_));
  nand2  g29(.a(new_n81_), .b(new_n59_), .O(new_n82_));
  oai21  g30(.a(new_n80_), .b(new_n59_), .c(new_n82_), .O(z09));
  nand4  g31(.a(x19), .b(new_n54_), .c(new_n53_), .d(x09), .O(new_n84_));
