...
module FAU ( 
  ...
  oai21  g024(.a(x31), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g045(.a(x31), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g079(.a(x31), .b(new_n122_), .c(new_n60_), .O(new_n132_));
  ...
  oai21  g084(.a(new_n136_), .b(new_n135_), .c(new_n53_), .O(new_n137_));
  ...
  oai21  g106(.a(new_n148_), .b(x31), .c(new_n60_), .O(new_n159_));
