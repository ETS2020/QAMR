...
module FAU ( 
  ...
  nand2  g37(.a(new_n89_), .b(new_n55_), .O(new_n90_));
  ...
  nand4  g42(.a(new_n94_), .b(x19), .c(x18), .d(new_n66_), .O(new_n95_));
  nand2  g43(.a(new_n95_), .b(new_n93_), .O(z08));
  oai21  g44(.a(x30), .b(x17), .c(x18), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(x19), .O(new_n98_));
  nand2  g46(.a(new_n94_), .b(new_n55_), .O(new_n99_));
  ...
  inv1   g55(.a(x31), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(new_n55_), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n107_), .O(z11));
  oai21  g58(.a(x33), .b(x17), .c(x18), .O(new_n111_));
  nand2  g59(.a(new_n111_), .b(x19), .O(new_n112_));
  inv1   g60(.a(x32), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n55_), .O(new_n114_));
  nand2  g62(.a(new_n114_), .b(new_n112_), .O(z12));
  inv1   g63(.a(x33), .O(new_n116_));
  nand2  g64(.a(new_n116_), .b(new_n55_), .O(new_n117_));
  inv1   g65(.a(x34), .O(new_n118_));
  nand4  g66(.a(new_n118_), .b(x19), .c(x18), .d(new_n66_), .O(new_n119_));
  nand2  g67(.a(new_n119_), .b(new_n117_), .O(z13));
  nand2  g68(.a(new_n118_), .b(new_n55_), .O(new_n121_));
  inv1   g69(.a(x35), .O(new_n122_));
  nand4  g70(.a(new_n122_), .b(x19), .c(x18), .d(new_n66_), .O(new_n123_));
  nand2  g71(.a(new_n123_), .b(new_n121_), .O(z14));
  nand2  g72(.a(new_n122_), .b(new_n55_), .O(new_n125_));
  nand4  g73(.a(new_n92_), .b(x19), .c(x18), .d(new_n66_), .O(new_n126_));
