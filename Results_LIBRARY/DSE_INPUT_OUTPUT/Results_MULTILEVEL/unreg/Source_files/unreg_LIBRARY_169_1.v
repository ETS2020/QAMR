...
module FAU ( 
  ...
  oai21  g016(.a(x35), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(x35), .b(new_n65_), .c(new_n60_), .O(new_n76_));
  ...
  oai21  g029(.a(x35), .b(new_n72_), .c(new_n60_), .O(new_n82_));
  ...
  oai21  g037(.a(x35), .b(new_n89_), .c(new_n60_), .O(new_n90_));
  ...
  oai21  g044(.a(x35), .b(new_n85_), .c(new_n60_), .O(new_n97_));
  ...
  oai21  g051(.a(x35), .b(new_n93_), .c(new_n60_), .O(new_n104_));
  ...
  oai21  g057(.a(x35), .b(new_n100_), .c(new_n60_), .O(new_n110_));
  ...
  oai21  g065(.a(x35), .b(new_n117_), .c(new_n60_), .O(new_n118_));
  ...
  inv1   g072(.a(x35), .O(new_n125_));
  nand3  g073(.a(new_n125_), .b(new_n113_), .c(new_n60_), .O(new_n126_));
  ...
  oai21  g080(.a(x35), .b(new_n121_), .c(new_n60_), .O(new_n133_));
  ...
  nand3  g086(.a(new_n125_), .b(new_n129_), .c(new_n60_), .O(new_n139_));
