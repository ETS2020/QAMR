...
module FAU ( 
  ...
  nand3  g060(.a(x19), .b(new_n54_), .c(x11), .O(new_n113_));
  nand2  g061(.a(new_n69_), .b(x18), .O(new_n114_));
  nand2  g062(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand2  g063(.a(new_n115_), .b(new_n53_), .O(new_n116_));
  inv1   g064(.a(x28), .O(new_n117_));
  oai21  g065(.a(new_n69_), .b(new_n117_), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g078(.a(new_n121_), .b(x29), .c(new_n60_), .O(new_n131_));
  ...
  nand3  g084(.a(new_n127_), .b(x29), .c(new_n60_), .O(new_n137_));
  ...
  nand2  g091(.a(x32), .b(x29), .O(new_n144_));
  ...
  nand3  g099(.a(new_n140_), .b(x29), .c(new_n60_), .O(new_n152_));
  ...
  nand3  g112(.a(new_n155_), .b(x29), .c(new_n60_), .O(new_n165_));
