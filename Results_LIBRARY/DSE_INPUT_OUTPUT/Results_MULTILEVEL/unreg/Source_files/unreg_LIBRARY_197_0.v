...
module FAU ( 
  ...
  nand3  g017(.a(x23), .b(new_n56_), .c(new_n60_), .O(new_n70_));
  ...
  oai21  g023(.a(new_n62_), .b(new_n66_), .c(new_n60_), .O(new_n76_));
  ...
  nand3  g044(.a(new_n85_), .b(x23), .c(new_n60_), .O(new_n97_));
