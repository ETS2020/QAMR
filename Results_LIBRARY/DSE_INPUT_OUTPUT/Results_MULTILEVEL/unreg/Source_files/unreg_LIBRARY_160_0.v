...
module FAU ( 
  ...
  nand3  g030(.a(new_n73_), .b(new_n61_), .c(x12), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n61_), .c(x12), .O(new_n91_));
  ...
  nand3  g052(.a(new_n94_), .b(new_n61_), .c(x12), .O(new_n105_));
  ...
  nand3  g080(.a(new_n122_), .b(new_n61_), .c(x12), .O(new_n133_));
  ...
  nand3  g101(.a(new_n142_), .b(new_n61_), .c(x12), .O(new_n154_));
