...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n58_, new_n59_, new_n60_,
    ...
    new_n73_, new_n75_, new_n77_, new_n79_, new_n81_, new_n82_, new_n83_,
  ...
  oai21  g17(.a(new_n67_), .b(new_n58_), .c(new_n69_), .O(z04));
  ...
  oai21  g31(.a(new_n81_), .b(new_n58_), .c(new_n83_), .O(z10));
  ...
  oai21  g37(.a(new_n87_), .b(new_n58_), .c(new_n89_), .O(z12));
  ...
  aoi21  g42(.a(new_n53_), .b(x13), .c(x18), .O(new_n95_));
  inv1   g43(.a(x34), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n58_), .O(new_n97_));
  oai21  g45(.a(new_n95_), .b(new_n58_), .c(new_n97_), .O(z14));
