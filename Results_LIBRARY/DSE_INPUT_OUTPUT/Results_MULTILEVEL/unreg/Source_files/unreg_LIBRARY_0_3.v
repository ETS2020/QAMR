...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n59_, new_n60_,
    ...
    new_n91_, new_n93_, new_n95_, new_n97_, new_n99_, new_n101_;
  ...
  nand2  g22(.a(new_n54_), .b(x06), .O(new_n75_));
  oai22  g23(.a(new_n75_), .b(new_n69_), .c(x25), .d(x19), .O(z05));
  aoi21  g24(.a(new_n54_), .b(x05), .c(x18), .O(new_n77_));
  inv1   g25(.a(x26), .O(new_n78_));
  nand2  g26(.a(new_n78_), .b(new_n53_), .O(new_n79_));
  oai21  g27(.a(new_n77_), .b(new_n53_), .c(new_n79_), .O(z06));
  nand2  g28(.a(new_n54_), .b(x04), .O(new_n81_));
  oai22  g29(.a(new_n81_), .b(new_n69_), .c(x27), .d(x19), .O(z07));
  aoi21  g30(.a(new_n54_), .b(x11), .c(x18), .O(new_n83_));
  inv1   g31(.a(x28), .O(new_n84_));
  nand2  g32(.a(new_n84_), .b(new_n53_), .O(new_n85_));
  oai21  g33(.a(new_n83_), .b(new_n53_), .c(new_n85_), .O(z08));
  aoi21  g34(.a(new_n54_), .b(x10), .c(x18), .O(new_n87_));
  inv1   g35(.a(x29), .O(new_n88_));
  nand2  g36(.a(new_n88_), .b(new_n53_), .O(new_n89_));
  oai21  g37(.a(new_n87_), .b(new_n53_), .c(new_n89_), .O(z09));
  nand2  g38(.a(new_n54_), .b(x09), .O(new_n91_));
  oai22  g39(.a(new_n91_), .b(new_n69_), .c(x30), .d(x19), .O(z10));
  nand2  g40(.a(new_n54_), .b(x08), .O(new_n93_));
  oai22  g41(.a(new_n93_), .b(new_n69_), .c(x31), .d(x19), .O(z11));
  nand2  g42(.a(new_n54_), .b(x15), .O(new_n95_));
  oai22  g43(.a(new_n95_), .b(new_n69_), .c(x32), .d(x19), .O(z12));
  nand2  g44(.a(new_n54_), .b(x14), .O(new_n97_));
  oai22  g45(.a(new_n97_), .b(new_n69_), .c(x33), .d(x19), .O(z13));
  nand2  g46(.a(new_n54_), .b(x13), .O(new_n99_));
  oai22  g47(.a(new_n99_), .b(new_n69_), .c(x34), .d(x19), .O(z14));
  nand2  g48(.a(new_n54_), .b(x12), .O(new_n101_));
  oai22  g49(.a(new_n101_), .b(new_n69_), .c(x35), .d(x19), .O(z15));
endmodule
