...
module FAU ( 
  ...
  nand3  g009(.a(x29), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  nand3  g016(.a(x29), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  inv1   g023(.a(x29), .O(new_n76_));
  oai21  g024(.a(new_n76_), .b(new_n65_), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g030(.a(new_n76_), .b(new_n72_), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g038(.a(x29), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  nand3  g045(.a(x29), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  nand2  g061(.a(new_n76_), .b(x18), .O(new_n114_));
  ...
  nand2  g072(.a(new_n76_), .b(new_n60_), .O(new_n125_));
  ...
  nand3  g079(.a(new_n121_), .b(x29), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g107(.a(new_n149_), .b(x29), .c(new_n60_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n156_), .b(new_n76_), .c(new_n60_), .O(new_n166_));
