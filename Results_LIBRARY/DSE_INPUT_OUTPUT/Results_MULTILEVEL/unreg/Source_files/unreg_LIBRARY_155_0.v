...
module FAU ( 
  ...
  nand3  g052(.a(new_n94_), .b(new_n61_), .c(x01), .O(new_n105_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n61_), .c(x01), .O(new_n119_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n61_), .c(x01), .O(new_n147_));
  ...
  nand3  g108(.a(new_n150_), .b(new_n61_), .c(x01), .O(new_n161_));
  ...
  nand3  g114(.a(new_n157_), .b(new_n61_), .c(x01), .O(new_n167_));
