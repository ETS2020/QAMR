...
module FAU ( 
  ...
  oai21  g050(.a(new_n92_), .b(x21), .c(new_n60_), .O(new_n103_));
  ...
  oai21  g056(.a(new_n99_), .b(x21), .c(new_n60_), .O(new_n109_));
  ...
  oai21  g078(.a(new_n120_), .b(x21), .c(new_n60_), .O(new_n131_));
  ...
  oai21  g099(.a(new_n140_), .b(x21), .c(new_n60_), .O(new_n152_));
