...
module FAU ( 
  ...
  nand3  g009(.a(x27), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g051(.a(new_n69_), .b(new_n94_), .c(new_n60_), .O(new_n104_));
  ...
  oai21  g064(.a(new_n116_), .b(new_n69_), .c(new_n60_), .O(new_n117_));
  ...
  oai21  g071(.a(new_n112_), .b(new_n69_), .c(new_n60_), .O(new_n124_));
  ...
  oai21  g078(.a(new_n120_), .b(new_n69_), .c(new_n60_), .O(new_n131_));
  ...
  oai21  g084(.a(new_n127_), .b(new_n69_), .c(new_n60_), .O(new_n137_));
  ...
  nand3  g099(.a(new_n140_), .b(x27), .c(new_n60_), .O(new_n152_));
  ...
  oai21  g106(.a(new_n148_), .b(new_n69_), .c(new_n60_), .O(new_n159_));
  ...
  oai21  g112(.a(new_n155_), .b(new_n69_), .c(new_n60_), .O(new_n165_));
