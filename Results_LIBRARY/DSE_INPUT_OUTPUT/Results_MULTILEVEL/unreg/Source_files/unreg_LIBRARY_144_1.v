...
module FAU ( 
  ...
  oai21  g016(.a(x22), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  nand3  g028(.a(new_n80_), .b(new_n62_), .c(new_n60_), .O(new_n81_));
  ...
  nand3  g043(.a(new_n84_), .b(new_n62_), .c(new_n60_), .O(new_n96_));
  ...
  nand3  g050(.a(new_n92_), .b(new_n62_), .c(new_n60_), .O(new_n103_));
  ...
  oai21  g056(.a(new_n99_), .b(x22), .c(new_n60_), .O(new_n109_));
  ...
  oai21  g071(.a(new_n112_), .b(x22), .c(new_n60_), .O(new_n124_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n62_), .c(new_n60_), .O(new_n137_));
  ...
  oai21  g092(.a(new_n144_), .b(x22), .c(new_n60_), .O(new_n145_));
  ...
  oai21  g106(.a(new_n148_), .b(x22), .c(new_n60_), .O(new_n159_));
