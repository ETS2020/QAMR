...
module FAU ( 
  ...
  nand3  g044(.a(new_n69_), .b(new_n86_), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g064(.a(new_n116_), .b(new_n69_), .c(new_n60_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n112_), .b(new_n69_), .c(new_n60_), .O(new_n124_));
  ...
  oai21  g092(.a(new_n144_), .b(x26), .c(new_n60_), .O(new_n145_));
  ...
  oai21  g099(.a(new_n140_), .b(x26), .c(new_n60_), .O(new_n152_));
