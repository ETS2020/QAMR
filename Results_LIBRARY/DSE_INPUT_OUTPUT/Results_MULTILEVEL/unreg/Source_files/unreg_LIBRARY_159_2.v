...
module FAU ( 
  ...
  nand4  g021(.a(new_n73_), .b(x31), .c(x19), .d(new_n71_), .O(new_n74_));
  ...
  nand4  g027(.a(new_n79_), .b(x31), .c(x19), .d(new_n71_), .O(new_n80_));
  ...
  oai21  g033(.a(new_n85_), .b(new_n53_), .c(x19), .O(new_n86_));
  ...
  nand4  g039(.a(new_n91_), .b(x31), .c(x19), .d(new_n71_), .O(new_n92_));
  nand2  g040(.a(new_n83_), .b(new_n60_), .O(new_n93_));
  ...
  nand4  g058(.a(new_n110_), .b(x31), .c(x19), .d(new_n71_), .O(new_n111_));
  ...
  nand4  g073(.a(new_n125_), .b(x31), .c(x19), .d(new_n71_), .O(new_n126_));
  nand2  g074(.a(new_n53_), .b(new_n60_), .O(new_n127_));
  ...
  nand2  g089(.a(new_n130_), .b(new_n60_), .O(new_n142_));
  ...
  oai21  g095(.a(new_n147_), .b(new_n53_), .c(x19), .O(new_n148_));
  nand2  g096(.a(new_n138_), .b(new_n60_), .O(new_n149_));
  ...
  nand4  g100(.a(new_n152_), .b(x31), .c(x19), .d(new_n71_), .O(new_n153_));
  nand2  g101(.a(new_n145_), .b(new_n60_), .O(new_n154_));
