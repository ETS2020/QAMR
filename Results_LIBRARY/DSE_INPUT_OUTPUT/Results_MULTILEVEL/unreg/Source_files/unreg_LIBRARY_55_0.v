...
module FAU ( 
  ...
  oai21  g058(.a(new_n76_), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  oai21  g073(.a(new_n76_), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  oai21  g080(.a(new_n76_), .b(new_n122_), .c(new_n60_), .O(new_n133_));
  ...
  oai21  g086(.a(new_n76_), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  ...
  oai21  g100(.a(new_n76_), .b(new_n142_), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g112(.a(new_n156_), .b(x34), .c(new_n60_), .O(new_n165_));
