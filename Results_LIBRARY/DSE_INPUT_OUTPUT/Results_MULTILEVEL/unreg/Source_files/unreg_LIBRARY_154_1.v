...
module FAU ( 
  ...
  oai21  g009(.a(x26), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g016(.a(x26), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  nand2  g041(.a(new_n76_), .b(x18), .O(new_n94_));
  ...
  nand2  g051(.a(new_n76_), .b(new_n60_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n100_), .b(new_n76_), .c(new_n60_), .O(new_n110_));
  ...
  oai21  g072(.a(new_n113_), .b(x26), .c(new_n60_), .O(new_n125_));
  ...
  nand3  g079(.a(new_n121_), .b(new_n76_), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n76_), .c(new_n60_), .O(new_n153_));
  ...
  oai21  g113(.a(new_n156_), .b(x26), .c(new_n60_), .O(new_n166_));
