...
module FAU ( 
  ...
  oai21  g15(.a(x25), .b(x17), .c(x18), .O(new_n68_));
  nand2  g16(.a(new_n68_), .b(x19), .O(new_n69_));
  inv1   g17(.a(x24), .O(new_n70_));
  nand2  g18(.a(new_n70_), .b(new_n63_), .O(new_n71_));
  nand2  g19(.a(new_n71_), .b(new_n69_), .O(z04));
  ...
  nand2  g28(.a(new_n76_), .b(new_n63_), .O(new_n81_));
  ...
  aoi21  g39(.a(new_n91_), .b(new_n53_), .c(new_n64_), .O(new_n92_));
  nand2  g40(.a(new_n88_), .b(new_n63_), .O(new_n93_));
  oai21  g41(.a(new_n92_), .b(new_n63_), .c(new_n93_), .O(z10));
  aoi21  g42(.a(new_n70_), .b(new_n53_), .c(new_n64_), .O(new_n95_));
  nand2  g43(.a(new_n91_), .b(new_n63_), .O(new_n96_));
  ...
  aoi21  g49(.a(new_n101_), .b(new_n53_), .c(new_n64_), .O(new_n102_));
  nand2  g50(.a(new_n98_), .b(new_n63_), .O(new_n103_));
  oai21  g51(.a(new_n102_), .b(new_n63_), .c(new_n103_), .O(z13));
  inv1   g52(.a(x35), .O(new_n105_));
  aoi21  g53(.a(new_n105_), .b(new_n53_), .c(new_n64_), .O(new_n106_));
  nand2  g54(.a(new_n101_), .b(new_n63_), .O(new_n107_));
  oai21  g55(.a(new_n106_), .b(new_n63_), .c(new_n107_), .O(z14));
  aoi21  g56(.a(new_n85_), .b(new_n53_), .c(new_n64_), .O(new_n109_));
  nand2  g57(.a(new_n105_), .b(new_n63_), .O(new_n110_));
  oai21  g58(.a(new_n109_), .b(new_n63_), .c(new_n110_), .O(z15));
endmodule
