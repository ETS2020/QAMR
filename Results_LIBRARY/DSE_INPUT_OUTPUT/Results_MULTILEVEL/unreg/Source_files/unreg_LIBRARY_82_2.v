// Benchmark "FAU" written by ABC on Fri Aug 14 02:04:56 2020
...
module FAU ( 
  ...
  nand3  g023(.a(new_n65_), .b(new_n60_), .c(new_n54_), .O(new_n76_));
  ...
  nand3  g029(.a(new_n72_), .b(new_n60_), .c(new_n54_), .O(new_n82_));
  ...
  oai21  g037(.a(new_n89_), .b(x18), .c(new_n60_), .O(new_n90_));
  ...
  nand3  g044(.a(new_n85_), .b(new_n60_), .c(new_n54_), .O(new_n97_));
  nand2  g045(.a(new_n97_), .b(new_n96_), .O(z05));
  nand3  g046(.a(x19), .b(new_n54_), .c(x05), .O(new_n99_));
  ...
  nand3  g059(.a(x19), .b(new_n54_), .c(x11), .O(new_n112_));
  ...
  oai21  g065(.a(new_n117_), .b(x18), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g081(.a(x19), .b(new_n54_), .c(x08), .O(new_n134_));
  ...
  oai21  g085(.a(new_n128_), .b(x18), .c(new_n60_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n60_), .c(new_n54_), .O(new_n146_));
  ...
  nand3  g102(.a(x19), .b(new_n54_), .c(x13), .O(new_n155_));
  ...
  oai21  g107(.a(new_n149_), .b(x18), .c(new_n60_), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n159_), .O(z14));
  nand3  g109(.a(x19), .b(new_n54_), .c(x12), .O(new_n162_));
  ...
  oai21  g113(.a(new_n156_), .b(x18), .c(new_n60_), .O(new_n166_));
