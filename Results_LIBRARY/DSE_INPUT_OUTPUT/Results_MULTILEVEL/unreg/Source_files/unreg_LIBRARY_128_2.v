...
module FAU ( 
  ...
  oai21  g009(.a(new_n61_), .b(x13), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g030(.a(new_n73_), .b(x13), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g038(.a(new_n90_), .b(x13), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g052(.a(new_n94_), .b(x13), .c(new_n60_), .O(new_n105_));
  ...
  oai21  g058(.a(new_n101_), .b(x13), .c(new_n60_), .O(new_n111_));
  ...
  oai21  g080(.a(new_n122_), .b(x13), .c(new_n60_), .O(new_n133_));
  ...
  oai21  g086(.a(new_n129_), .b(x13), .c(new_n60_), .O(new_n139_));
  ...
  oai21  g101(.a(new_n142_), .b(x13), .c(new_n60_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n153_), .O(z13));
  oai21  g103(.a(x18), .b(x17), .c(x19), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(x13), .O(new_n157_));
  nand2  g105(.a(new_n150_), .b(new_n60_), .O(new_n158_));
  inv1   g106(.a(x35), .O(new_n159_));
  nand4  g107(.a(new_n159_), .b(x19), .c(x18), .d(new_n53_), .O(new_n160_));
  nand3  g108(.a(new_n160_), .b(new_n158_), .c(new_n157_), .O(z14));
  ...
  oai21  g113(.a(new_n159_), .b(x13), .c(new_n60_), .O(new_n166_));
