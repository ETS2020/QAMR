...
module FAU ( 
  ...
  nand4  g17(.a(x19), .b(new_n54_), .c(new_n53_), .d(x07), .O(new_n70_));
  ...
  nand4  g25(.a(x19), .b(new_n54_), .c(new_n53_), .d(x11), .O(new_n78_));
