...
module FAU ( 
  ...
  nand4  g15(.a(x19), .b(new_n54_), .c(new_n53_), .d(x06), .O(new_n68_));
  oai21  g16(.a(x25), .b(x19), .c(new_n68_), .O(z05));
  aoi21  g17(.a(new_n53_), .b(x05), .c(x18), .O(new_n70_));
  inv1   g18(.a(x26), .O(new_n71_));
  nand2  g19(.a(new_n71_), .b(new_n63_), .O(new_n72_));
  oai21  g20(.a(new_n70_), .b(new_n63_), .c(new_n72_), .O(z06));
  ...
  nand2  g25(.a(new_n77_), .b(new_n63_), .O(new_n78_));
  oai21  g26(.a(new_n76_), .b(new_n63_), .c(new_n78_), .O(z08));
  nand4  g27(.a(x19), .b(new_n54_), .c(new_n53_), .d(x10), .O(new_n80_));
  oai21  g28(.a(x29), .b(x19), .c(new_n80_), .O(z09));
  aoi21  g29(.a(new_n53_), .b(x09), .c(x18), .O(new_n82_));
  inv1   g30(.a(x30), .O(new_n83_));
  nand2  g31(.a(new_n83_), .b(new_n63_), .O(new_n84_));
  oai21  g32(.a(new_n82_), .b(new_n63_), .c(new_n84_), .O(z10));
  aoi21  g33(.a(new_n53_), .b(x08), .c(x18), .O(new_n86_));
  inv1   g34(.a(x31), .O(new_n87_));
  nand2  g35(.a(new_n87_), .b(new_n63_), .O(new_n88_));
  oai21  g36(.a(new_n86_), .b(new_n63_), .c(new_n88_), .O(z11));
  aoi21  g37(.a(new_n53_), .b(x15), .c(x18), .O(new_n90_));
  inv1   g38(.a(x32), .O(new_n91_));
  nand2  g39(.a(new_n91_), .b(new_n63_), .O(new_n92_));
  oai21  g40(.a(new_n90_), .b(new_n63_), .c(new_n92_), .O(z12));
  aoi21  g41(.a(new_n53_), .b(x14), .c(x18), .O(new_n94_));
  inv1   g42(.a(x33), .O(new_n95_));
  nand2  g43(.a(new_n95_), .b(new_n63_), .O(new_n96_));
  oai21  g44(.a(new_n94_), .b(new_n63_), .c(new_n96_), .O(z13));
  ...
  nand2  g49(.a(new_n101_), .b(new_n63_), .O(new_n102_));
  oai21  g50(.a(new_n100_), .b(new_n63_), .c(new_n102_), .O(z15));
endmodule
