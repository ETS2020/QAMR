...
module FAU ( 
  ...
  oai21  g48(.a(new_n98_), .b(new_n59_), .c(new_n100_), .O(z13));
  ...
  nand2  g53(.a(new_n105_), .b(new_n59_), .O(new_n106_));
  oai21  g54(.a(new_n104_), .b(new_n59_), .c(new_n106_), .O(z15));
endmodule
