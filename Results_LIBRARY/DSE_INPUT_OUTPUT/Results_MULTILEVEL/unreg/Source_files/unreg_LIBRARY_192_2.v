...
module FAU ( 
  ...
  nand4  g034(.a(new_n86_), .b(x29), .c(x19), .d(new_n78_), .O(new_n87_));
  ...
  nand4  g055(.a(new_n107_), .b(x29), .c(x19), .d(new_n78_), .O(new_n108_));
  nand2  g056(.a(new_n100_), .b(new_n60_), .O(new_n109_));
  nand2  g057(.a(new_n109_), .b(new_n108_), .O(z07));
  nand2  g058(.a(new_n78_), .b(x11), .O(new_n111_));
  nand3  g059(.a(x29), .b(x19), .c(new_n54_), .O(new_n112_));
  oai22  g060(.a(new_n112_), .b(new_n111_), .c(x28), .d(x19), .O(z08));
  nand2  g061(.a(new_n54_), .b(x10), .O(new_n114_));
  oai21  g062(.a(x30), .b(new_n54_), .c(new_n114_), .O(new_n115_));
  nand3  g063(.a(new_n115_), .b(x19), .c(new_n78_), .O(new_n116_));
  nand2  g064(.a(new_n116_), .b(x29), .O(z09));
  ...
  nand4  g075(.a(new_n127_), .b(x29), .c(x19), .d(new_n78_), .O(new_n128_));
  ...
  nand4  g088(.a(new_n140_), .b(x29), .c(x19), .d(new_n78_), .O(new_n141_));
