...
module FAU ( 
  ...
  nand3  g030(.a(new_n73_), .b(new_n61_), .c(x14), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n61_), .c(x14), .O(new_n91_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n61_), .c(x14), .O(new_n111_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n61_), .c(x14), .O(new_n147_));
  ...
  nand3  g108(.a(new_n153_), .b(new_n61_), .c(x14), .O(new_n161_));
