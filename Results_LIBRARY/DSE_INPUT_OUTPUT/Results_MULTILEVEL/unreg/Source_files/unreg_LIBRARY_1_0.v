...
module FAU ( 
  ...
  nor2   g006(.a(x28), .b(x21), .O(new_n59_));
  ...
  inv1   g014(.a(x28), .O(new_n67_));
  oai21  g015(.a(new_n67_), .b(new_n65_), .c(new_n66_), .O(new_n68_));
  ...
  nor2   g021(.a(new_n73_), .b(new_n59_), .O(new_n74_));
  ...
  nor2   g028(.a(new_n80_), .b(new_n59_), .O(new_n81_));
  ...
  nor2   g046(.a(new_n98_), .b(new_n59_), .O(new_n99_));
  ...
  oai21  g057(.a(new_n66_), .b(new_n65_), .c(new_n67_), .O(new_n110_));
  ...
  nand2  g065(.a(new_n117_), .b(new_n65_), .O(new_n118_));
  ...
  nand2  g072(.a(new_n113_), .b(new_n65_), .O(new_n125_));
  aoi21  g073(.a(new_n125_), .b(new_n124_), .c(new_n59_), .O(z10));
  ...
  aoi21  g077(.a(new_n121_), .b(new_n65_), .c(new_n59_), .O(new_n130_));
  ...
  aoi21  g092(.a(new_n144_), .b(new_n142_), .c(new_n59_), .O(z13));
  ...
  aoi21  g096(.a(new_n139_), .b(new_n65_), .c(new_n59_), .O(new_n149_));
  ...
  nor2   g102(.a(new_n154_), .b(new_n59_), .O(new_n155_));
