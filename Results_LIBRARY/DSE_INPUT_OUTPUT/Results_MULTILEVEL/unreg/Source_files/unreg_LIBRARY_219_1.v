...
module FAU ( 
  ...
  nand4  g040(.a(new_n92_), .b(x19), .c(new_n53_), .d(x10), .O(new_n93_));
  ...
  oai21  g054(.a(new_n106_), .b(new_n62_), .c(x19), .O(new_n107_));
  ...
  nand4  g066(.a(new_n118_), .b(x19), .c(new_n53_), .d(x10), .O(new_n119_));
  oai21  g067(.a(x29), .b(x19), .c(new_n119_), .O(z09));
  nand2  g068(.a(new_n54_), .b(x09), .O(new_n121_));
  oai21  g069(.a(x31), .b(new_n54_), .c(new_n121_), .O(new_n122_));
  nand4  g070(.a(new_n122_), .b(x19), .c(new_n53_), .d(x10), .O(new_n123_));
  ...
  nand4  g076(.a(new_n128_), .b(x19), .c(new_n53_), .d(x10), .O(new_n129_));
  ...
  nand4  g082(.a(new_n134_), .b(x19), .c(new_n53_), .d(x10), .O(new_n135_));
  ...
  nand4  g088(.a(new_n140_), .b(x19), .c(new_n53_), .d(x10), .O(new_n141_));
  ...
  nand4  g094(.a(new_n146_), .b(x19), .c(new_n53_), .d(x10), .O(new_n147_));
