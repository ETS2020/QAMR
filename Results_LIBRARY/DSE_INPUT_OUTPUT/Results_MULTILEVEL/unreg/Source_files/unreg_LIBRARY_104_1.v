...
module FAU ( 
  ...
  nand2  g12(.a(new_n62_), .b(new_n55_), .O(new_n65_));
  inv1   g13(.a(x23), .O(new_n66_));
  nand4  g14(.a(new_n66_), .b(x19), .c(x18), .d(new_n61_), .O(new_n67_));
  nand2  g15(.a(new_n67_), .b(new_n65_), .O(z02));
  nand2  g16(.a(new_n66_), .b(new_n55_), .O(new_n69_));
  nand4  g17(.a(x19), .b(x18), .c(new_n61_), .d(x16), .O(new_n70_));
  ...
  nand4  g40(.a(new_n92_), .b(x19), .c(x18), .d(new_n61_), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(new_n91_), .O(z08));
  nand2  g42(.a(new_n92_), .b(new_n55_), .O(new_n95_));
  inv1   g43(.a(x30), .O(new_n96_));
  nand4  g44(.a(new_n96_), .b(x19), .c(x18), .d(new_n61_), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n95_), .O(z09));
  nand2  g46(.a(new_n96_), .b(new_n55_), .O(new_n99_));
  inv1   g47(.a(x31), .O(new_n100_));
  nand4  g48(.a(new_n100_), .b(x19), .c(x18), .d(new_n61_), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(new_n99_), .O(z10));
  oai21  g50(.a(x24), .b(x17), .c(x18), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(x19), .O(new_n104_));
  nand2  g52(.a(new_n100_), .b(new_n55_), .O(new_n105_));
