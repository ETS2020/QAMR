// Benchmark "FAU" written by ABC on Fri Aug 14 02:05:02 2020
...
module FAU ( 
  ...
  oai21  g009(.a(x32), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  nand3  g030(.a(new_n69_), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g038(.a(x32), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g045(.a(x32), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  nand3  g052(.a(new_n69_), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  oai21  g058(.a(x32), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  oai21  g066(.a(x32), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n69_), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g080(.a(new_n69_), .b(new_n122_), .c(new_n60_), .O(new_n133_));
  ...
  oai21  g086(.a(x32), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  nand2  g087(.a(new_n139_), .b(new_n138_), .O(z11));
  inv1   g088(.a(x15), .O(new_n141_));
  nor2   g089(.a(x18), .b(new_n141_), .O(new_n142_));
  nor2   g090(.a(x33), .b(new_n54_), .O(new_n143_));
  oai21  g091(.a(new_n143_), .b(new_n142_), .c(new_n53_), .O(new_n144_));
  ...
  oai21  g099(.a(new_n151_), .b(x32), .c(new_n60_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n147_), .b(new_n69_), .c(new_n60_), .O(new_n159_));
  ...
  oai21  g112(.a(new_n155_), .b(x32), .c(new_n60_), .O(new_n165_));
