...
module FAU ( 
  ...
  oai21  g030(.a(x26), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g038(.a(x26), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g057(.a(new_n100_), .b(x26), .c(new_n60_), .O(new_n110_));
  ...
  oai21  g065(.a(new_n117_), .b(x26), .c(new_n60_), .O(new_n118_));
  ...
  oai21  g085(.a(new_n128_), .b(x26), .c(new_n60_), .O(new_n138_));
  ...
  oai21  g093(.a(new_n145_), .b(x26), .c(new_n60_), .O(new_n146_));
  ...
  oai21  g100(.a(new_n141_), .b(x26), .c(new_n60_), .O(new_n153_));
