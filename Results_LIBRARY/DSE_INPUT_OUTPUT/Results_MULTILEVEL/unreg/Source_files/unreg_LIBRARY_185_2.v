...
module FAU ( 
  ...
  oai21  g017(.a(new_n56_), .b(x00), .c(new_n61_), .O(new_n70_));
  ...
  oai21  g024(.a(new_n66_), .b(x00), .c(new_n61_), .O(new_n77_));
  ...
  nand3  g029(.a(new_n73_), .b(new_n61_), .c(new_n60_), .O(new_n82_));
  ...
  oai21  g037(.a(new_n89_), .b(x00), .c(new_n61_), .O(new_n90_));
  ...
  oai21  g044(.a(new_n85_), .b(x00), .c(new_n61_), .O(new_n97_));
  ...
  oai21  g051(.a(new_n93_), .b(x00), .c(new_n61_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n100_), .b(new_n61_), .c(new_n60_), .O(new_n110_));
  ...
  oai21  g065(.a(new_n117_), .b(x00), .c(new_n61_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n113_), .b(new_n61_), .c(new_n60_), .O(new_n125_));
  ...
  oai21  g079(.a(new_n121_), .b(x00), .c(new_n61_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n128_), .b(x00), .c(new_n61_), .O(new_n138_));
  ...
  oai21  g107(.a(new_n149_), .b(x00), .c(new_n61_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n156_), .b(x00), .c(new_n61_), .O(new_n166_));
