...
module FAU ( 
  ...
  nand2  g36(.a(new_n84_), .b(new_n53_), .O(new_n89_));
  nand2  g37(.a(new_n89_), .b(new_n88_), .O(z09));
  inv1   g38(.a(x31), .O(new_n91_));
  nand4  g39(.a(new_n91_), .b(x19), .c(x18), .d(new_n54_), .O(new_n92_));
  oai21  g40(.a(x30), .b(x19), .c(new_n92_), .O(z10));
  aoi21  g41(.a(new_n73_), .b(new_n54_), .c(new_n55_), .O(new_n94_));
  nand2  g42(.a(new_n91_), .b(new_n53_), .O(new_n95_));
  oai21  g43(.a(new_n94_), .b(new_n53_), .c(new_n95_), .O(z11));
  inv1   g44(.a(x33), .O(new_n97_));
  aoi21  g45(.a(new_n97_), .b(new_n54_), .c(new_n55_), .O(new_n98_));
  inv1   g46(.a(x32), .O(new_n99_));
  nand2  g47(.a(new_n99_), .b(new_n53_), .O(new_n100_));
  oai21  g48(.a(new_n98_), .b(new_n53_), .c(new_n100_), .O(z12));
  oai21  g49(.a(x34), .b(x17), .c(x18), .O(new_n102_));
  nand2  g50(.a(new_n102_), .b(x19), .O(new_n103_));
  nand2  g51(.a(new_n97_), .b(new_n53_), .O(new_n104_));
  nand2  g52(.a(new_n104_), .b(new_n103_), .O(z13));
  inv1   g53(.a(x35), .O(new_n106_));
  nand4  g54(.a(new_n106_), .b(x19), .c(x18), .d(new_n54_), .O(new_n107_));
  oai21  g55(.a(x34), .b(x19), .c(new_n107_), .O(z14));
  inv1   g56(.a(x28), .O(new_n109_));
  nand4  g57(.a(new_n109_), .b(x19), .c(x18), .d(new_n54_), .O(new_n110_));
