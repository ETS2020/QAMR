...
module FAU ( 
  ...
  oai21  g009(.a(x25), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g016(.a(x25), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(x25), .b(new_n65_), .c(new_n60_), .O(new_n76_));
  ...
  nand3  g064(.a(new_n116_), .b(new_n82_), .c(new_n60_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n112_), .b(new_n82_), .c(new_n60_), .O(new_n124_));
  ...
  oai21  g078(.a(new_n120_), .b(x25), .c(new_n60_), .O(new_n131_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n82_), .c(new_n60_), .O(new_n137_));
  ...
  oai21  g106(.a(new_n148_), .b(x25), .c(new_n60_), .O(new_n159_));
