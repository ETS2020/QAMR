...
module FAU ( 
  ...
  nand3  g017(.a(x27), .b(new_n56_), .c(new_n60_), .O(new_n70_));
  ...
  nand3  g064(.a(new_n116_), .b(x27), .c(new_n60_), .O(new_n117_));
  ...
  nand3  g078(.a(new_n120_), .b(x27), .c(new_n60_), .O(new_n131_));
  ...
  nand3  g092(.a(new_n144_), .b(x27), .c(new_n60_), .O(new_n145_));
  ...
  nand3  g106(.a(new_n148_), .b(x27), .c(new_n60_), .O(new_n159_));
