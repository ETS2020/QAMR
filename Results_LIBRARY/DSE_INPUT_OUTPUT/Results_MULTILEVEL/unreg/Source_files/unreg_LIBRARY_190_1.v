...
module FAU ( 
  ...
  oai21  g016(.a(new_n56_), .b(x20), .c(new_n60_), .O(new_n69_));
  ...
  oai21  g023(.a(new_n65_), .b(x20), .c(new_n60_), .O(new_n76_));
  ...
  oai21  g029(.a(new_n72_), .b(x20), .c(new_n60_), .O(new_n82_));
  ...
  nand3  g051(.a(new_n93_), .b(new_n61_), .c(new_n60_), .O(new_n104_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n61_), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g079(.a(new_n121_), .b(new_n61_), .c(new_n60_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n128_), .b(x20), .c(new_n60_), .O(new_n138_));
  ...
  oai21  g113(.a(new_n156_), .b(x20), .c(new_n60_), .O(new_n166_));
