...
module FAU ( 
  ...
  oai21  g030(.a(x34), .b(new_n72_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g052(.a(x34), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g086(.a(new_n76_), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  ...
  nand2  g097(.a(new_n76_), .b(x18), .O(new_n150_));
  ...
  oai21  g105(.a(new_n157_), .b(new_n156_), .c(new_n53_), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(x19), .O(z14));
  nand2  g107(.a(new_n54_), .b(x12), .O(new_n160_));
  nand2  g108(.a(new_n118_), .b(x18), .O(new_n161_));
  ...
  nand3  g112(.a(new_n164_), .b(new_n76_), .c(new_n60_), .O(new_n165_));
