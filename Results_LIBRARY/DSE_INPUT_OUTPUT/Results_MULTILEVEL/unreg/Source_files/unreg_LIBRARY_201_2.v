...
module FAU ( 
  ...
  oai21  g012(.a(x18), .b(x17), .c(x19), .O(new_n65_));
  nand2  g013(.a(new_n65_), .b(x02), .O(new_n66_));
  nand2  g014(.a(new_n56_), .b(new_n61_), .O(new_n67_));
  inv1   g015(.a(x22), .O(new_n68_));
  nand4  g016(.a(new_n68_), .b(x19), .c(x18), .d(new_n53_), .O(new_n69_));
  nand3  g017(.a(new_n69_), .b(new_n67_), .c(new_n66_), .O(z01));
  ...
  oai21  g023(.a(new_n68_), .b(x02), .c(new_n61_), .O(new_n76_));
  ...
  nand3  g029(.a(new_n72_), .b(new_n61_), .c(new_n60_), .O(new_n82_));
  ...
  oai21  g044(.a(new_n85_), .b(x02), .c(new_n61_), .O(new_n97_));
  ...
  oai21  g057(.a(new_n100_), .b(x02), .c(new_n61_), .O(new_n110_));
  ...
  oai21  g093(.a(new_n145_), .b(x02), .c(new_n61_), .O(new_n146_));
  ...
  oai21  g100(.a(new_n141_), .b(x02), .c(new_n61_), .O(new_n153_));
  ...
  oai21  g113(.a(new_n156_), .b(x02), .c(new_n61_), .O(new_n166_));
