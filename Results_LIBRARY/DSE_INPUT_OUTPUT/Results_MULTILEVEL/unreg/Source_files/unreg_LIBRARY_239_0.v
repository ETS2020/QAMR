...
module FAU ( 
  ...
  nand3  g066(.a(new_n118_), .b(new_n61_), .c(x15), .O(new_n119_));
  ...
  nand3  g088(.a(x19), .b(new_n54_), .c(new_n53_), .O(new_n141_));
  ...
  nand4  g094(.a(new_n146_), .b(x19), .c(x18), .d(new_n53_), .O(new_n147_));
  ...
  nand3  g101(.a(new_n146_), .b(new_n61_), .c(x15), .O(new_n154_));
