...
module FAU ( 
  ...
  oai21  g017(.a(new_n56_), .b(x15), .c(new_n61_), .O(new_n70_));
  ...
  oai21  g045(.a(new_n86_), .b(x15), .c(new_n61_), .O(new_n98_));
  ...
  oai21  g052(.a(new_n94_), .b(x15), .c(new_n61_), .O(new_n105_));
  ...
  oai21  g058(.a(new_n101_), .b(x15), .c(new_n61_), .O(new_n111_));
  ...
  oai21  g066(.a(new_n118_), .b(x15), .c(new_n61_), .O(new_n119_));
  ...
  oai21  g080(.a(new_n122_), .b(x15), .c(new_n61_), .O(new_n133_));
  ...
  oai21  g088(.a(x18), .b(x17), .c(x19), .O(new_n141_));
  nand2  g089(.a(new_n141_), .b(x15), .O(new_n142_));
  inv1   g090(.a(x32), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n61_), .O(new_n144_));
  inv1   g092(.a(x33), .O(new_n145_));
  nand4  g093(.a(new_n145_), .b(x19), .c(x18), .d(new_n53_), .O(new_n146_));
  nand3  g094(.a(new_n146_), .b(new_n144_), .c(new_n142_), .O(z12));
  ...
  nand3  g100(.a(new_n145_), .b(new_n61_), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n149_), .b(new_n61_), .c(new_n60_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n156_), .b(new_n61_), .c(new_n60_), .O(new_n166_));
