...
module FAU ( 
  ...
  nand4  g068(.a(new_n120_), .b(x35), .c(x19), .d(new_n53_), .O(new_n121_));
  nand2  g069(.a(new_n112_), .b(new_n58_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n125_), .b(x35), .c(x19), .d(new_n53_), .O(new_n126_));
  ...
  nand4  g086(.a(new_n138_), .b(x35), .c(x19), .d(new_n53_), .O(new_n139_));
  ...
  nand4  g092(.a(new_n144_), .b(x35), .c(x19), .d(new_n53_), .O(new_n145_));
  ...
  aoi21  g097(.a(new_n149_), .b(x13), .c(new_n68_), .O(new_n150_));
