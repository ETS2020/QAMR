...
module FAU ( 
  ...
  nand3  g016(.a(x35), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  nand3  g023(.a(x35), .b(new_n65_), .c(new_n60_), .O(new_n76_));
  ...
  nand3  g045(.a(x35), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g058(.a(new_n82_), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g080(.a(x35), .b(new_n122_), .c(new_n60_), .O(new_n133_));
  ...
  nand3  g094(.a(x35), .b(new_n146_), .c(new_n60_), .O(new_n147_));
