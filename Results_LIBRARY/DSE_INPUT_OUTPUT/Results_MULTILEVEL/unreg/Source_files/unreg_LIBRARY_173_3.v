...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n59_, new_n60_,
    ...
    new_n73_, new_n75_, new_n76_, new_n77_, new_n79_, new_n81_, new_n83_,
  ...
  oai22  g15(.a(new_n67_), .b(new_n65_), .c(x23), .d(x19), .O(z03));
  nand2  g16(.a(new_n54_), .b(x07), .O(new_n69_));
  oai22  g17(.a(new_n69_), .b(new_n65_), .c(x24), .d(x19), .O(z04));
  nand2  g18(.a(new_n54_), .b(x06), .O(new_n71_));
  oai22  g19(.a(new_n71_), .b(new_n65_), .c(x25), .d(x19), .O(z05));
  nand2  g20(.a(new_n54_), .b(x05), .O(new_n73_));
  oai22  g21(.a(new_n73_), .b(new_n65_), .c(x26), .d(x19), .O(z06));
  aoi21  g22(.a(new_n54_), .b(x04), .c(x18), .O(new_n75_));
  inv1   g23(.a(x27), .O(new_n76_));
  nand2  g24(.a(new_n76_), .b(new_n53_), .O(new_n77_));
  oai21  g25(.a(new_n75_), .b(new_n53_), .c(new_n77_), .O(z07));
  nand2  g26(.a(new_n54_), .b(x11), .O(new_n79_));
  oai22  g27(.a(new_n79_), .b(new_n65_), .c(x28), .d(x19), .O(z08));
  nand2  g28(.a(new_n54_), .b(x10), .O(new_n81_));
  oai22  g29(.a(new_n81_), .b(new_n65_), .c(x29), .d(x19), .O(z09));
  ...
  nand2  g34(.a(new_n54_), .b(x08), .O(new_n87_));
  oai22  g35(.a(new_n87_), .b(new_n65_), .c(x31), .d(x19), .O(z11));
  ...
  oai22  g41(.a(new_n93_), .b(new_n65_), .c(x33), .d(x19), .O(z13));
  ...
  oai22  g47(.a(new_n99_), .b(new_n65_), .c(x35), .d(x19), .O(z15));
endmodule
