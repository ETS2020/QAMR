...
module FAU ( 
  ...
  nand4  g034(.a(new_n86_), .b(x19), .c(new_n78_), .d(x08), .O(new_n87_));
  ...
  nand4  g048(.a(new_n100_), .b(x19), .c(new_n78_), .d(x08), .O(new_n101_));
  ...
  nand4  g068(.a(new_n120_), .b(x19), .c(new_n78_), .d(x08), .O(new_n121_));
  ...
  nand4  g103(.a(new_n155_), .b(x19), .c(new_n78_), .d(x08), .O(new_n156_));
  nand2  g104(.a(new_n148_), .b(new_n60_), .O(new_n157_));
