...
module FAU ( 
  ...
  oai21  g017(.a(new_n56_), .b(x10), .c(new_n61_), .O(new_n70_));
  ...
  oai21  g030(.a(new_n73_), .b(x10), .c(new_n61_), .O(new_n83_));
  ...
  oai21  g038(.a(new_n90_), .b(x10), .c(new_n61_), .O(new_n91_));
  ...
  oai21  g052(.a(new_n94_), .b(x10), .c(new_n61_), .O(new_n105_));
  ...
  oai21  g058(.a(new_n101_), .b(x10), .c(new_n61_), .O(new_n111_));
  ...
  oai21  g066(.a(new_n118_), .b(x10), .c(new_n61_), .O(new_n119_));
  ...
  nand3  g080(.a(new_n122_), .b(new_n61_), .c(new_n60_), .O(new_n133_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n61_), .c(new_n60_), .O(new_n139_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n61_), .c(new_n60_), .O(new_n147_));
  ...
  nand3  g101(.a(new_n142_), .b(new_n61_), .c(new_n60_), .O(new_n154_));
  ...
  nand3  g108(.a(new_n150_), .b(new_n61_), .c(new_n60_), .O(new_n161_));
  ...
  oai21  g114(.a(new_n157_), .b(x10), .c(new_n61_), .O(new_n167_));
