...
module FAU ( 
  ...
  oai21  g038(.a(new_n90_), .b(x10), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g058(.a(new_n101_), .b(x10), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g079(.a(new_n124_), .b(new_n60_), .c(new_n69_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n128_), .b(x10), .c(new_n60_), .O(new_n138_));
  ...
  oai21  g100(.a(new_n141_), .b(x10), .c(new_n60_), .O(new_n153_));
