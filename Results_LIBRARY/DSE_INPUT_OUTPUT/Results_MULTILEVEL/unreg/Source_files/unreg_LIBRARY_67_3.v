...
module FAU ( 
  ...
  oai21  g27(.a(new_n77_), .b(new_n62_), .c(new_n79_), .O(z07));
  ...
  oai21  g33(.a(new_n83_), .b(new_n62_), .c(new_n85_), .O(z09));
  ...
  nand2  g40(.a(new_n53_), .b(x14), .O(new_n93_));
  oai22  g41(.a(new_n93_), .b(new_n56_), .c(x33), .d(x19), .O(z13));
