...
module FAU ( 
  ...
  inv1   g007(.a(x33), .O(new_n60_));
  nand2  g008(.a(new_n60_), .b(x27), .O(new_n61_));
  ...
  aoi21  g045(.a(x33), .b(new_n54_), .c(new_n97_), .O(new_n98_));
  nand2  g046(.a(new_n97_), .b(x18), .O(new_n99_));
  oai21  g047(.a(new_n98_), .b(new_n96_), .c(new_n99_), .O(new_n100_));
  nand3  g048(.a(new_n100_), .b(x19), .c(new_n53_), .O(new_n101_));
  inv1   g049(.a(x26), .O(new_n102_));
  nand3  g050(.a(new_n61_), .b(new_n102_), .c(new_n58_), .O(new_n103_));
  nand2  g051(.a(new_n103_), .b(new_n101_), .O(z06));
  nand2  g052(.a(x33), .b(x19), .O(new_n105_));
  nand2  g053(.a(new_n105_), .b(x27), .O(new_n106_));
  nand3  g054(.a(new_n106_), .b(new_n54_), .c(x04), .O(new_n107_));
  nand4  g055(.a(new_n61_), .b(new_n59_), .c(x19), .d(x18), .O(new_n108_));
  nand2  g056(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g057(.a(new_n109_), .b(new_n53_), .O(new_n110_));
  nand2  g058(.a(new_n97_), .b(new_n58_), .O(new_n111_));
  ...
  nor2   g064(.a(new_n116_), .b(new_n62_), .O(new_n117_));
  ...
  nor2   g070(.a(new_n122_), .b(new_n62_), .O(new_n123_));
  ...
  aoi21  g077(.a(new_n129_), .b(new_n127_), .c(new_n62_), .O(z10));
  ...
  aoi22  g088(.a(new_n60_), .b(x27), .c(new_n140_), .d(new_n58_), .O(new_n141_));
  ...
  nand4  g092(.a(new_n144_), .b(new_n61_), .c(x19), .d(new_n53_), .O(new_n145_));
  nand3  g093(.a(new_n60_), .b(new_n97_), .c(new_n58_), .O(new_n146_));
  ...
  aoi21  g100(.a(new_n152_), .b(new_n150_), .c(new_n62_), .O(z14));
  ...
  nor2   g105(.a(new_n157_), .b(new_n62_), .O(new_n158_));
