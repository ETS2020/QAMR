...
module FAU ( 
  ...
  nand3  g017(.a(x25), .b(new_n56_), .c(new_n60_), .O(new_n70_));
  ...
  nand3  g024(.a(x25), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g037(.a(x25), .b(new_n89_), .c(new_n60_), .O(new_n90_));
  ...
  oai21  g050(.a(new_n93_), .b(new_n62_), .c(new_n60_), .O(new_n103_));
  ...
  nand3  g056(.a(new_n99_), .b(x25), .c(new_n60_), .O(new_n109_));
  ...
  nand3  g071(.a(new_n112_), .b(x25), .c(new_n60_), .O(new_n124_));
  ...
  oai21  g078(.a(new_n120_), .b(new_n62_), .c(new_n60_), .O(new_n131_));
  ...
  nand3  g084(.a(new_n127_), .b(x25), .c(new_n60_), .O(new_n137_));
  ...
  nand3  g092(.a(new_n144_), .b(x25), .c(new_n60_), .O(new_n145_));
  ...
  nand3  g099(.a(new_n140_), .b(x25), .c(new_n60_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n148_), .b(x25), .c(new_n60_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n155_), .b(x25), .c(new_n60_), .O(new_n165_));
