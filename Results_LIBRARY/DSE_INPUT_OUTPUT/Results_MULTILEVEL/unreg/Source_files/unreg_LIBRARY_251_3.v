...
module FAU ( 
  ...
  nand2  g026(.a(new_n54_), .b(x00), .O(new_n79_));
  nand3  g027(.a(new_n79_), .b(new_n78_), .c(new_n53_), .O(new_n80_));
  ...
  nand3  g042(.a(new_n94_), .b(new_n92_), .c(new_n53_), .O(new_n95_));
  ...
  nand3  g049(.a(new_n101_), .b(new_n99_), .c(new_n53_), .O(new_n102_));
  ...
  nand3  g083(.a(new_n135_), .b(new_n134_), .c(new_n53_), .O(new_n136_));
  ...
  nand3  g090(.a(new_n142_), .b(new_n140_), .c(new_n53_), .O(new_n143_));
  ...
  nand3  g105(.a(new_n157_), .b(new_n155_), .c(new_n53_), .O(new_n158_));
