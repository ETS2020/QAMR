...
module FAU ( 
  ...
  oai21  g017(.a(new_n56_), .b(x06), .c(new_n61_), .O(new_n70_));
  ...
  oai21  g030(.a(new_n73_), .b(x06), .c(new_n61_), .O(new_n83_));
  ...
  oai21  g058(.a(new_n101_), .b(x06), .c(new_n61_), .O(new_n111_));
  ...
  oai21  g073(.a(new_n114_), .b(x06), .c(new_n61_), .O(new_n126_));
  ...
  oai21  g086(.a(new_n129_), .b(x06), .c(new_n61_), .O(new_n139_));
  ...
  oai21  g094(.a(new_n146_), .b(x06), .c(new_n61_), .O(new_n147_));
