...
module FAU ( 
  ...
  nand4  g28(.a(new_n58_), .b(x19), .c(x18), .d(new_n54_), .O(new_n81_));
  ...
  nand4  g46(.a(new_n98_), .b(x19), .c(x18), .d(new_n54_), .O(new_n99_));
  oai21  g47(.a(x32), .b(x19), .c(new_n99_), .O(z12));
  inv1   g48(.a(x34), .O(new_n101_));
  aoi21  g49(.a(new_n101_), .b(new_n54_), .c(new_n55_), .O(new_n102_));
  nand2  g50(.a(new_n98_), .b(new_n53_), .O(new_n103_));
  oai21  g51(.a(new_n102_), .b(new_n53_), .c(new_n103_), .O(z13));
  inv1   g52(.a(x35), .O(new_n105_));
  aoi21  g53(.a(new_n105_), .b(new_n54_), .c(new_n55_), .O(new_n106_));
  nand2  g54(.a(new_n101_), .b(new_n53_), .O(new_n107_));
  oai21  g55(.a(new_n106_), .b(new_n53_), .c(new_n107_), .O(z14));
  aoi21  g56(.a(new_n85_), .b(new_n54_), .c(new_n55_), .O(new_n109_));
  nand2  g57(.a(new_n105_), .b(new_n53_), .O(new_n110_));
  oai21  g58(.a(new_n109_), .b(new_n53_), .c(new_n110_), .O(z15));
endmodule
