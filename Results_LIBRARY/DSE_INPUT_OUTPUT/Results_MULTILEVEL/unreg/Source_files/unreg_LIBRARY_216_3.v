...
module FAU ( 
  ...
  nor2   g034(.a(x18), .b(x06), .O(new_n87_));
  oai21  g035(.a(new_n87_), .b(x17), .c(new_n54_), .O(new_n88_));
  nand2  g036(.a(new_n88_), .b(x19), .O(new_n89_));
  oai21  g037(.a(x25), .b(x19), .c(new_n89_), .O(z05));
  ...
  oai21  g042(.a(new_n94_), .b(x26), .c(x19), .O(new_n95_));
  nand2  g043(.a(new_n54_), .b(new_n59_), .O(new_n96_));
  ...
  oai21  g048(.a(new_n100_), .b(x26), .c(x19), .O(new_n101_));
  ...
  oai21  g055(.a(new_n107_), .b(x26), .c(x19), .O(new_n108_));
  ...
  oai21  g063(.a(new_n115_), .b(x26), .c(x19), .O(new_n116_));
  ...
  oai21  g070(.a(new_n122_), .b(x26), .c(x19), .O(new_n123_));
  ...
  nand2  g074(.a(new_n84_), .b(x18), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n126_), .c(x17), .O(new_n128_));
  oai21  g076(.a(new_n128_), .b(x26), .c(x19), .O(new_n129_));
  ...
  nand4  g081(.a(new_n133_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n134_));
  ...
  nand4  g087(.a(new_n139_), .b(new_n54_), .c(x19), .d(new_n53_), .O(new_n140_));
  ...
  oai21  g095(.a(new_n147_), .b(x26), .c(x19), .O(new_n148_));
  ...
  oai21  g102(.a(new_n154_), .b(x26), .c(x19), .O(new_n155_));
