...
module FAU ( 
  ...
  oai21  g021(.a(new_n73_), .b(x27), .c(x19), .O(new_n74_));
  ...
  aoi21  g028(.a(new_n80_), .b(new_n63_), .c(x27), .O(new_n81_));
  ...
  oai21  g035(.a(new_n87_), .b(x27), .c(x19), .O(new_n88_));
  ...
  oai21  g043(.a(new_n95_), .b(x27), .c(x19), .O(new_n96_));
  nand2  g044(.a(new_n85_), .b(new_n59_), .O(new_n97_));
  nand2  g045(.a(new_n97_), .b(new_n96_), .O(z05));
  nor2   g046(.a(x18), .b(x05), .O(new_n99_));
  oai21  g047(.a(new_n99_), .b(x17), .c(new_n64_), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(x19), .O(new_n101_));
  oai21  g049(.a(x26), .b(x19), .c(new_n101_), .O(z06));
  inv1   g050(.a(x04), .O(new_n103_));
  nor2   g051(.a(x18), .b(new_n103_), .O(new_n104_));
  nand3  g052(.a(new_n60_), .b(x19), .c(x18), .O(new_n105_));
  inv1   g053(.a(new_n105_), .O(new_n106_));
  oai21  g054(.a(new_n106_), .b(new_n104_), .c(new_n63_), .O(new_n107_));
  aoi21  g055(.a(new_n107_), .b(x19), .c(x27), .O(z07));
  nand2  g056(.a(new_n53_), .b(x11), .O(new_n109_));
  oai21  g057(.a(x29), .b(new_n53_), .c(new_n109_), .O(new_n110_));
  nand4  g058(.a(new_n110_), .b(new_n64_), .c(x19), .d(new_n63_), .O(new_n111_));
  ...
  nand4  g072(.a(new_n124_), .b(new_n64_), .c(x19), .d(new_n63_), .O(new_n125_));
  nand2  g073(.a(new_n116_), .b(new_n59_), .O(new_n126_));
  ...
  nand4  g077(.a(new_n129_), .b(new_n64_), .c(x19), .d(new_n63_), .O(new_n130_));
  ...
  nand4  g083(.a(new_n135_), .b(new_n64_), .c(x19), .d(new_n63_), .O(new_n136_));
  ...
  oai21  g091(.a(new_n143_), .b(x27), .c(x19), .O(new_n144_));
  ...
  nand4  g097(.a(new_n149_), .b(new_n64_), .c(x19), .d(new_n63_), .O(new_n150_));
