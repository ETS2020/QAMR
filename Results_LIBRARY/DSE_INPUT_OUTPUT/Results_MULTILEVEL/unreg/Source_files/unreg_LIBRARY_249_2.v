...
module FAU ( 
  ...
  nand3  g029(.a(new_n72_), .b(new_n60_), .c(new_n76_), .O(new_n82_));
  ...
  nand3  g037(.a(new_n89_), .b(new_n60_), .c(new_n76_), .O(new_n90_));
  ...
  nand3  g044(.a(new_n85_), .b(new_n60_), .c(new_n76_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n93_), .b(new_n60_), .c(new_n76_), .O(new_n104_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n60_), .c(new_n76_), .O(new_n118_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n60_), .c(new_n76_), .O(new_n138_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n60_), .c(new_n76_), .O(new_n153_));
  ...
  oai21  g107(.a(new_n149_), .b(x00), .c(new_n60_), .O(new_n160_));
