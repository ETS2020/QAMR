...
module FAU ( 
  ...
  oai21  g023(.a(x23), .b(new_n66_), .c(new_n60_), .O(new_n76_));
  ...
  nand3  g044(.a(new_n85_), .b(new_n62_), .c(new_n60_), .O(new_n97_));
  ...
  oai21  g051(.a(new_n93_), .b(x23), .c(new_n60_), .O(new_n104_));
  ...
  oai21  g057(.a(new_n100_), .b(x23), .c(new_n60_), .O(new_n110_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n62_), .c(new_n60_), .O(new_n118_));
  ...
  oai21  g072(.a(new_n113_), .b(x23), .c(new_n60_), .O(new_n125_));
