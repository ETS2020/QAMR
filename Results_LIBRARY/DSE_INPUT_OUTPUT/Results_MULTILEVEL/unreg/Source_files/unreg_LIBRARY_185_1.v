...
module FAU ( 
  ...
  nand4  g027(.a(new_n79_), .b(x19), .c(new_n53_), .d(x00), .O(new_n80_));
  ...
  oai21  g033(.a(new_n85_), .b(new_n62_), .c(x19), .O(new_n86_));
  ...
  oai21  g041(.a(new_n93_), .b(new_n62_), .c(x19), .O(new_n94_));
  ...
  nand2  g049(.a(new_n91_), .b(new_n58_), .O(new_n102_));
  ...
  nand4  g053(.a(new_n105_), .b(x19), .c(new_n53_), .d(x00), .O(new_n106_));
  nand2  g054(.a(new_n98_), .b(new_n58_), .O(new_n107_));
  ...
  nand2  g067(.a(new_n110_), .b(new_n58_), .O(new_n120_));
  ...
  nand4  g085(.a(new_n137_), .b(x19), .c(new_n53_), .d(x00), .O(new_n138_));
  ...
  nand4  g091(.a(new_n143_), .b(x19), .c(new_n53_), .d(x00), .O(new_n144_));
  ...
  oai21  g106(.a(new_n158_), .b(new_n62_), .c(x19), .O(new_n159_));
  nand2  g107(.a(new_n149_), .b(new_n58_), .O(new_n160_));
