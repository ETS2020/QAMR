...
module FAU ( 
  ...
  nand3  g009(.a(new_n61_), .b(new_n60_), .c(x17), .O(new_n62_));
  ...
  nand3  g016(.a(new_n56_), .b(new_n60_), .c(x17), .O(new_n69_));
  ...
  nand3  g023(.a(new_n65_), .b(new_n60_), .c(x17), .O(new_n76_));
  nand2  g024(.a(new_n76_), .b(new_n75_), .O(z02));
  oai21  g025(.a(new_n72_), .b(new_n53_), .c(new_n60_), .O(new_n78_));
  inv1   g026(.a(x00), .O(new_n79_));
  nand2  g027(.a(x18), .b(x16), .O(new_n80_));
  oai21  g028(.a(x18), .b(new_n79_), .c(new_n80_), .O(new_n81_));
  nand2  g029(.a(new_n81_), .b(new_n53_), .O(new_n82_));
  nand2  g030(.a(new_n82_), .b(new_n78_), .O(z03));
  ...
  nand3  g037(.a(new_n89_), .b(new_n60_), .c(x17), .O(new_n90_));
  nand2  g038(.a(new_n90_), .b(new_n88_), .O(z04));
  oai21  g039(.a(new_n85_), .b(new_n53_), .c(new_n60_), .O(new_n92_));
  inv1   g040(.a(x06), .O(new_n93_));
  nor2   g041(.a(x18), .b(new_n93_), .O(new_n94_));
  nor2   g042(.a(x26), .b(new_n54_), .O(new_n95_));
  oai21  g043(.a(new_n95_), .b(new_n94_), .c(new_n53_), .O(new_n96_));
  nand2  g044(.a(new_n96_), .b(new_n92_), .O(z05));
  nand2  g045(.a(x26), .b(x17), .O(new_n98_));
  nand2  g046(.a(new_n98_), .b(new_n60_), .O(new_n99_));
  inv1   g047(.a(x05), .O(new_n100_));
  nor2   g048(.a(x18), .b(new_n100_), .O(new_n101_));
  nor2   g049(.a(x27), .b(new_n54_), .O(new_n102_));
  oai21  g050(.a(new_n102_), .b(new_n101_), .c(new_n53_), .O(new_n103_));
  nand2  g051(.a(new_n103_), .b(new_n99_), .O(z06));
  nand2  g052(.a(new_n54_), .b(x04), .O(new_n105_));
  nand2  g053(.a(new_n61_), .b(x18), .O(new_n106_));
  nand2  g054(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand3  g055(.a(new_n107_), .b(x19), .c(new_n53_), .O(new_n108_));
  inv1   g056(.a(x27), .O(new_n109_));
  nand3  g057(.a(new_n109_), .b(new_n60_), .c(x17), .O(new_n110_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n60_), .c(x17), .O(new_n118_));
  ...
  nand3  g072(.a(new_n113_), .b(new_n60_), .c(x17), .O(new_n125_));
  ...
  nand3  g079(.a(new_n121_), .b(new_n60_), .c(x17), .O(new_n132_));
  nand2  g080(.a(new_n132_), .b(new_n131_), .O(z10));
  oai21  g081(.a(new_n128_), .b(new_n53_), .c(new_n60_), .O(new_n134_));
  inv1   g082(.a(x08), .O(new_n135_));
  nor2   g083(.a(x18), .b(new_n135_), .O(new_n136_));
  nor2   g084(.a(x24), .b(new_n54_), .O(new_n137_));
  oai21  g085(.a(new_n137_), .b(new_n136_), .c(new_n53_), .O(new_n138_));
  nand2  g086(.a(new_n138_), .b(new_n134_), .O(z11));
  nand2  g087(.a(x32), .b(x17), .O(new_n140_));
  nand2  g088(.a(new_n140_), .b(new_n60_), .O(new_n141_));
  inv1   g089(.a(x15), .O(new_n142_));
  nor2   g090(.a(x18), .b(new_n142_), .O(new_n143_));
  nor2   g091(.a(x33), .b(new_n54_), .O(new_n144_));
  oai21  g092(.a(new_n144_), .b(new_n143_), .c(new_n53_), .O(new_n145_));
  nand2  g093(.a(new_n145_), .b(new_n141_), .O(z12));
  nand2  g094(.a(new_n54_), .b(x14), .O(new_n147_));
  inv1   g095(.a(x34), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(x18), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g098(.a(new_n150_), .b(x19), .c(new_n53_), .O(new_n151_));
  inv1   g099(.a(x33), .O(new_n152_));
  nand3  g100(.a(new_n152_), .b(new_n60_), .c(x17), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(new_n151_), .O(z13));
  oai21  g102(.a(new_n148_), .b(new_n53_), .c(new_n60_), .O(new_n155_));
  inv1   g103(.a(x13), .O(new_n156_));
  nor2   g104(.a(x18), .b(new_n156_), .O(new_n157_));
  nor2   g105(.a(x35), .b(new_n54_), .O(new_n158_));
  oai21  g106(.a(new_n158_), .b(new_n157_), .c(new_n53_), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n155_), .O(z14));
  nand2  g108(.a(new_n54_), .b(x12), .O(new_n161_));
  nand2  g109(.a(new_n117_), .b(x18), .O(new_n162_));
  ...
  nand3  g113(.a(new_n165_), .b(new_n60_), .c(x17), .O(new_n166_));
