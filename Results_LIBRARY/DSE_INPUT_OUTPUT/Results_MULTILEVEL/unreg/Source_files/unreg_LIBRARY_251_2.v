...
module FAU ( 
  ...
  oai21  g034(.a(new_n86_), .b(new_n85_), .c(x19), .O(new_n87_));
  inv1   g035(.a(x24), .O(new_n88_));
  nand2  g036(.a(new_n88_), .b(new_n58_), .O(new_n89_));
  aoi21  g037(.a(new_n89_), .b(new_n87_), .c(x17), .O(z04));
  ...
  nand3  g042(.a(new_n94_), .b(x19), .c(new_n76_), .O(new_n95_));
  inv1   g043(.a(x25), .O(new_n96_));
  oai21  g044(.a(new_n96_), .b(x17), .c(new_n58_), .O(new_n97_));
  nand2  g045(.a(new_n97_), .b(new_n95_), .O(z05));
  nand2  g046(.a(new_n55_), .b(x05), .O(new_n99_));
  inv1   g047(.a(x27), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(x18), .O(new_n101_));
  nand2  g049(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand3  g050(.a(new_n102_), .b(x19), .c(new_n76_), .O(new_n103_));
  oai21  g051(.a(new_n92_), .b(x17), .c(new_n58_), .O(new_n104_));
  ...
  nand2  g057(.a(new_n100_), .b(new_n58_), .O(new_n110_));
  ...
  oai21  g069(.a(new_n121_), .b(new_n120_), .c(x19), .O(new_n122_));
  inv1   g070(.a(x29), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(new_n58_), .O(new_n124_));
  aoi21  g072(.a(new_n124_), .b(new_n122_), .c(x17), .O(z09));
  ...
  nand3  g091(.a(new_n143_), .b(x19), .c(new_n76_), .O(new_n144_));
