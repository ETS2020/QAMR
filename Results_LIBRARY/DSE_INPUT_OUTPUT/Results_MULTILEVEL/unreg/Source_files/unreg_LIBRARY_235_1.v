...
module FAU ( 
  ...
  nand4  g61(.a(new_n113_), .b(x19), .c(x18), .d(new_n61_), .O(new_n114_));
  nand2  g62(.a(new_n114_), .b(new_n112_), .O(z12));
  oai21  g63(.a(x34), .b(x17), .c(x18), .O(new_n116_));
  nand2  g64(.a(new_n116_), .b(x19), .O(new_n117_));
  nand2  g65(.a(new_n113_), .b(new_n55_), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(new_n117_), .O(z13));
  ...
  nand4  g74(.a(new_n93_), .b(x19), .c(x18), .d(new_n61_), .O(new_n127_));
