...
module FAU ( 
  ...
  oai21  g045(.a(x28), .b(new_n85_), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g071(.a(new_n123_), .b(x28), .c(new_n60_), .O(new_n124_));
  ...
  nand3  g078(.a(new_n119_), .b(new_n90_), .c(new_n60_), .O(new_n131_));
  ...
  oai21  g084(.a(new_n127_), .b(x28), .c(new_n60_), .O(new_n137_));
