...
module FAU ( 
  ...
  nand3  g009(.a(new_n61_), .b(new_n60_), .c(new_n54_), .O(new_n62_));
  ...
  nand3  g072(.a(new_n113_), .b(new_n60_), .c(new_n54_), .O(new_n125_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n60_), .c(new_n54_), .O(new_n153_));
