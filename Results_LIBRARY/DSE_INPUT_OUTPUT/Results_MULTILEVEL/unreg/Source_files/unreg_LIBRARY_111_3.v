...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n71_, new_n72_, new_n74_, new_n76_, new_n77_, new_n78_, new_n80_,
  ...
  aoi21  g43(.a(new_n53_), .b(x15), .c(x18), .O(new_n96_));
  inv1   g44(.a(x32), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n57_), .O(new_n98_));
  oai21  g46(.a(new_n96_), .b(new_n57_), .c(new_n98_), .O(z12));
  aoi21  g47(.a(new_n53_), .b(x14), .c(x18), .O(new_n100_));
  inv1   g48(.a(x33), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(new_n57_), .O(new_n102_));
  oai21  g50(.a(new_n100_), .b(new_n57_), .c(new_n102_), .O(z13));
  aoi21  g51(.a(new_n53_), .b(x13), .c(x18), .O(new_n104_));
  inv1   g52(.a(x34), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(new_n57_), .O(new_n106_));
  oai21  g54(.a(new_n104_), .b(new_n57_), .c(new_n106_), .O(z14));
  aoi21  g55(.a(new_n53_), .b(x12), .c(x18), .O(new_n108_));
  inv1   g56(.a(x35), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n57_), .O(new_n110_));
  oai21  g58(.a(new_n108_), .b(new_n57_), .c(new_n110_), .O(z15));
endmodule
