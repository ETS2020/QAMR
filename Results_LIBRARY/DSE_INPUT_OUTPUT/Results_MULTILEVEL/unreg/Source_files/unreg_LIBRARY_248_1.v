...
module FAU ( 
  ...
  oai21  g052(.a(x28), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand2  g053(.a(new_n105_), .b(new_n102_), .O(z07));
  ...
  aoi21  g057(.a(x28), .b(x27), .c(x19), .O(new_n110_));
  ...
  nand2  g066(.a(new_n118_), .b(new_n103_), .O(new_n119_));
  ...
  aoi21  g071(.a(new_n114_), .b(new_n103_), .c(new_n60_), .O(new_n124_));
  ...
  nand2  g085(.a(new_n137_), .b(new_n103_), .O(new_n138_));
  ...
  nand2  g092(.a(new_n133_), .b(new_n103_), .O(new_n145_));
  ...
  nand2  g099(.a(new_n141_), .b(new_n103_), .O(new_n152_));
  ...
  aoi21  g104(.a(new_n148_), .b(new_n103_), .c(new_n60_), .O(new_n157_));
