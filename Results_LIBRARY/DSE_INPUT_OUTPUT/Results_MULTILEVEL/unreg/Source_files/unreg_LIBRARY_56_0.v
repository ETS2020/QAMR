...
module FAU ( 
  ...
  nand3  g023(.a(new_n65_), .b(new_n60_), .c(x16), .O(new_n76_));
  nand2  g024(.a(new_n76_), .b(new_n75_), .O(z02));
  nand2  g025(.a(x19), .b(x18), .O(new_n78_));
  oai22  g026(.a(new_n78_), .b(x17), .c(x23), .d(x19), .O(new_n79_));
  nand2  g027(.a(new_n79_), .b(x16), .O(new_n80_));
  ...
  nand3  g036(.a(new_n88_), .b(new_n60_), .c(x16), .O(new_n89_));
  ...
  nand3  g043(.a(new_n84_), .b(new_n60_), .c(x16), .O(new_n96_));
  ...
  inv1   g050(.a(x16), .O(new_n103_));
  oai21  g051(.a(new_n92_), .b(new_n103_), .c(new_n60_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n99_), .b(new_n60_), .c(x16), .O(new_n110_));
  ...
  oai21  g072(.a(new_n113_), .b(new_n103_), .c(new_n60_), .O(new_n125_));
  ...
  oai21  g079(.a(new_n121_), .b(new_n103_), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n60_), .c(x16), .O(new_n146_));
  ...
  oai21  g100(.a(new_n141_), .b(new_n103_), .c(new_n60_), .O(new_n153_));
  ...
  oai21  g107(.a(new_n149_), .b(new_n103_), .c(new_n60_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n156_), .b(new_n60_), .c(x16), .O(new_n166_));
