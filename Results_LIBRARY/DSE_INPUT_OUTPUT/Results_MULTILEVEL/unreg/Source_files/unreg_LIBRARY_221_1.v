// Benchmark "FAU" written by ABC on Fri Aug 14 02:05:31 2020
...
module FAU ( 
  ...
  nand4  g45(.a(new_n97_), .b(x19), .c(x18), .d(new_n56_), .O(new_n98_));
  ...
  inv1   g53(.a(x31), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n53_), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(new_n105_), .O(z11));
  ...
  nand2  g61(.a(new_n111_), .b(new_n53_), .O(new_n114_));
  inv1   g62(.a(x34), .O(new_n115_));
  nand4  g63(.a(new_n115_), .b(x19), .c(x18), .d(new_n56_), .O(new_n116_));
  nand2  g64(.a(new_n116_), .b(new_n114_), .O(z13));
  oai21  g65(.a(x35), .b(x17), .c(x18), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(x19), .O(new_n119_));
  nand2  g67(.a(new_n115_), .b(new_n53_), .O(new_n120_));
  nand2  g68(.a(new_n120_), .b(new_n119_), .O(z14));
