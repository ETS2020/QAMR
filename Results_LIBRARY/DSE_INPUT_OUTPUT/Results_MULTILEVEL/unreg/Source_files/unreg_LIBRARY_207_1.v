...
module FAU ( 
  ...
  aoi21  g26(.a(new_n78_), .b(new_n54_), .c(new_n55_), .O(new_n79_));
  nand2  g27(.a(new_n74_), .b(new_n53_), .O(new_n80_));
  oai21  g28(.a(new_n79_), .b(new_n53_), .c(new_n80_), .O(z06));
  aoi21  g29(.a(new_n58_), .b(new_n54_), .c(new_n55_), .O(new_n82_));
  nand2  g30(.a(new_n78_), .b(new_n53_), .O(new_n83_));
  oai21  g31(.a(new_n82_), .b(new_n53_), .c(new_n83_), .O(z07));
  ...
  nand4  g57(.a(new_n87_), .b(x19), .c(x18), .d(new_n54_), .O(new_n110_));
