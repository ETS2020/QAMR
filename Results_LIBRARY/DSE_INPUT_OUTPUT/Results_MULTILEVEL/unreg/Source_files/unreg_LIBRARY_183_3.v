...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n59_, new_n60_,
    ...
    new_n72_, new_n74_, new_n76_, new_n78_, new_n80_, new_n81_, new_n82_,
  ...
  nand4  g15(.a(x19), .b(new_n63_), .c(new_n54_), .d(x07), .O(new_n68_));
  ...
  nand4  g21(.a(x19), .b(new_n63_), .c(new_n54_), .d(x05), .O(new_n74_));
  oai21  g22(.a(x26), .b(x19), .c(new_n74_), .O(z06));
  nand4  g23(.a(x19), .b(new_n63_), .c(new_n54_), .d(x04), .O(new_n76_));
  oai21  g24(.a(x27), .b(x19), .c(new_n76_), .O(z07));
  nand4  g25(.a(x19), .b(new_n63_), .c(new_n54_), .d(x11), .O(new_n78_));
  oai21  g26(.a(x28), .b(x19), .c(new_n78_), .O(z08));
  aoi21  g27(.a(new_n54_), .b(x10), .c(x18), .O(new_n80_));
  inv1   g28(.a(x29), .O(new_n81_));
  nand2  g29(.a(new_n81_), .b(new_n53_), .O(new_n82_));
  oai21  g30(.a(new_n80_), .b(new_n53_), .c(new_n82_), .O(z09));
  aoi21  g31(.a(new_n54_), .b(x09), .c(x18), .O(new_n84_));
  inv1   g32(.a(x30), .O(new_n85_));
  nand2  g33(.a(new_n85_), .b(new_n53_), .O(new_n86_));
  oai21  g34(.a(new_n84_), .b(new_n53_), .c(new_n86_), .O(z10));
  nand4  g35(.a(x19), .b(new_n63_), .c(new_n54_), .d(x08), .O(new_n88_));
  oai21  g36(.a(x31), .b(x19), .c(new_n88_), .O(z11));
  aoi21  g37(.a(new_n54_), .b(x15), .c(x18), .O(new_n90_));
  inv1   g38(.a(x32), .O(new_n91_));
  nand2  g39(.a(new_n91_), .b(new_n53_), .O(new_n92_));
  oai21  g40(.a(new_n90_), .b(new_n53_), .c(new_n92_), .O(z12));
