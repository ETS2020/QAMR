...
module FAU ( 
  ...
  oai21  g017(.a(x35), .b(new_n56_), .c(new_n60_), .O(new_n70_));
  ...
  oai21  g038(.a(x35), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  oai21  g045(.a(x35), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g058(.a(x35), .b(new_n101_), .c(new_n60_), .O(new_n111_));
  ...
  nand3  g073(.a(new_n62_), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g101(.a(new_n62_), .b(new_n142_), .c(new_n60_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n153_), .O(z13));
  nand2  g103(.a(new_n54_), .b(x13), .O(new_n156_));
  nand2  g104(.a(new_n62_), .b(x18), .O(new_n157_));
