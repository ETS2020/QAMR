...
module FAU ( 
  ...
  oai21  g20(.a(new_n70_), .b(new_n59_), .c(new_n72_), .O(z04));
  inv1   g21(.a(x26), .O(new_n74_));
  aoi21  g22(.a(new_n74_), .b(new_n53_), .c(new_n65_), .O(new_n75_));
  nand2  g23(.a(new_n69_), .b(new_n59_), .O(new_n76_));
  oai21  g24(.a(new_n75_), .b(new_n59_), .c(new_n76_), .O(z05));
  oai21  g25(.a(x27), .b(x17), .c(x18), .O(new_n78_));
  nand2  g26(.a(new_n78_), .b(x19), .O(new_n79_));
  nand2  g27(.a(new_n74_), .b(new_n59_), .O(new_n80_));
  ...
  aoi21  g33(.a(new_n85_), .b(new_n53_), .c(new_n65_), .O(new_n86_));
  inv1   g34(.a(x28), .O(new_n87_));
  nand2  g35(.a(new_n87_), .b(new_n59_), .O(new_n88_));
  oai21  g36(.a(new_n86_), .b(new_n59_), .c(new_n88_), .O(z08));
  inv1   g37(.a(x30), .O(new_n90_));
  aoi21  g38(.a(new_n90_), .b(new_n53_), .c(new_n65_), .O(new_n91_));
  nand2  g39(.a(new_n85_), .b(new_n59_), .O(new_n92_));
  oai21  g40(.a(new_n91_), .b(new_n59_), .c(new_n92_), .O(z09));
  oai21  g41(.a(x31), .b(x17), .c(x18), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(x19), .O(new_n95_));
  nand2  g43(.a(new_n90_), .b(new_n59_), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n95_), .O(z10));
  nand4  g45(.a(new_n71_), .b(x19), .c(x18), .d(new_n53_), .O(new_n98_));
  oai21  g46(.a(x31), .b(x19), .c(new_n98_), .O(z11));
  inv1   g47(.a(x33), .O(new_n100_));
  nand4  g48(.a(new_n100_), .b(x19), .c(x18), .d(new_n53_), .O(new_n101_));
  ...
  nand4  g56(.a(new_n87_), .b(x19), .c(x18), .d(new_n53_), .O(new_n109_));
