...
module FAU ( 
  ...
  oai21  g029(.a(new_n72_), .b(x15), .c(new_n60_), .O(new_n82_));
  ...
  oai21  g037(.a(new_n89_), .b(x15), .c(new_n60_), .O(new_n90_));
  ...
  inv1   g044(.a(x15), .O(new_n97_));
  nand3  g045(.a(new_n85_), .b(new_n60_), .c(new_n97_), .O(new_n98_));
  ...
  nand3  g052(.a(new_n93_), .b(new_n60_), .c(new_n97_), .O(new_n105_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n60_), .c(new_n97_), .O(new_n111_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n60_), .c(new_n97_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n60_), .c(new_n97_), .O(new_n126_));
  ...
  oai21  g086(.a(new_n129_), .b(x15), .c(new_n60_), .O(new_n139_));
  ...
  oai21  g107(.a(new_n149_), .b(x15), .c(new_n60_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n156_), .b(x15), .c(new_n60_), .O(new_n166_));
