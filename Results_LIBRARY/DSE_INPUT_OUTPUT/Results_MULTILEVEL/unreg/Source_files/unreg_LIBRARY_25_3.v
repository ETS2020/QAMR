...
module FAU ( 
  ...
  oai21  g042(.a(new_n94_), .b(x30), .c(x19), .O(new_n95_));
  ...
  oai21  g050(.a(new_n102_), .b(x30), .c(x19), .O(new_n103_));
  ...
  oai21  g056(.a(new_n108_), .b(x30), .c(x19), .O(new_n109_));
  ...
  oai21  g063(.a(new_n115_), .b(x30), .c(x19), .O(new_n116_));
  ...
  nand4  g069(.a(new_n121_), .b(new_n84_), .c(x19), .d(new_n77_), .O(new_n122_));
  oai21  g070(.a(x29), .b(x19), .c(new_n122_), .O(z09));
  inv1   g071(.a(x09), .O(new_n124_));
  nor2   g072(.a(x18), .b(new_n124_), .O(new_n125_));
  nor2   g073(.a(x31), .b(new_n53_), .O(new_n126_));
  oai21  g074(.a(new_n126_), .b(new_n125_), .c(new_n77_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(x19), .c(x30), .O(z10));
  ...
  oai21  g079(.a(new_n131_), .b(x30), .c(x19), .O(new_n132_));
  ...
  oai21  g087(.a(new_n139_), .b(x30), .c(x19), .O(new_n140_));
  ...
  nand4  g093(.a(new_n145_), .b(new_n84_), .c(x19), .d(new_n77_), .O(new_n146_));
  ...
  nand4  g098(.a(new_n150_), .b(new_n84_), .c(x19), .d(new_n77_), .O(new_n151_));
  ...
  oai21  g105(.a(new_n157_), .b(x30), .c(x19), .O(new_n158_));
