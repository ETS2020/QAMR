...
module FAU ( 
  ...
  aoi21  g026(.a(new_n78_), .b(new_n54_), .c(x05), .O(new_n79_));
  ...
  nand2  g053(.a(new_n98_), .b(new_n59_), .O(new_n106_));
  ...
  oai21  g059(.a(new_n111_), .b(x05), .c(x19), .O(new_n112_));
  ...
  oai21  g067(.a(new_n119_), .b(x05), .c(x19), .O(new_n120_));
  ...
  oai21  g074(.a(new_n126_), .b(x05), .c(x19), .O(new_n127_));
  ...
  oai21  g080(.a(new_n132_), .b(x05), .c(x19), .O(new_n133_));
  ...
  oai21  g087(.a(new_n139_), .b(x05), .c(x19), .O(new_n140_));
  ...
  oai21  g105(.a(new_n157_), .b(x05), .c(x19), .O(new_n158_));
