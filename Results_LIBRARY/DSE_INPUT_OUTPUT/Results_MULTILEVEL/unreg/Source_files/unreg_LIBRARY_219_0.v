...
module FAU ( 
  ...
  nand3  g009(.a(new_n61_), .b(new_n60_), .c(x10), .O(new_n62_));
  ...
  nand3  g024(.a(new_n65_), .b(new_n60_), .c(x10), .O(new_n77_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n60_), .c(x10), .O(new_n98_));
  ...
  nand2  g069(.a(new_n114_), .b(new_n60_), .O(new_n122_));
  ...
  nand3  g080(.a(new_n125_), .b(new_n60_), .c(x10), .O(new_n133_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n60_), .c(x10), .O(new_n139_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n60_), .c(x10), .O(new_n147_));
  ...
  nand3  g101(.a(new_n142_), .b(new_n60_), .c(x10), .O(new_n154_));
  ...
  nand3  g108(.a(new_n150_), .b(new_n60_), .c(x10), .O(new_n161_));
