...
module FAU ( 
  ...
  nand3  g017(.a(x32), .b(new_n56_), .c(new_n60_), .O(new_n70_));
  ...
  nand3  g024(.a(x32), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g030(.a(x32), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  nand3  g052(.a(x32), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g073(.a(x32), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g080(.a(x32), .b(new_n122_), .c(new_n60_), .O(new_n133_));
  ...
  nand2  g093(.a(new_n62_), .b(new_n60_), .O(new_n146_));
  ...
  oai21  g100(.a(new_n142_), .b(new_n62_), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n149_), .b(x32), .c(new_n60_), .O(new_n160_));
