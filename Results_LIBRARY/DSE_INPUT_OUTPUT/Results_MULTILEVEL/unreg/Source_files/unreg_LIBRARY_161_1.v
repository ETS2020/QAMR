...
module FAU ( 
  ...
  nand4  g004(.a(new_n56_), .b(x19), .c(new_n53_), .d(x06), .O(new_n57_));
  ...
  aoi21  g028(.a(new_n80_), .b(new_n53_), .c(new_n62_), .O(new_n81_));
  nand2  g029(.a(new_n72_), .b(new_n58_), .O(new_n82_));
  oai21  g030(.a(new_n81_), .b(new_n58_), .c(new_n82_), .O(z03));
  nand2  g031(.a(new_n54_), .b(x07), .O(new_n84_));
  oai21  g032(.a(x25), .b(new_n54_), .c(new_n84_), .O(new_n85_));
  nand4  g033(.a(new_n85_), .b(x19), .c(new_n53_), .d(x06), .O(new_n86_));
  ...
  nand4  g038(.a(new_n90_), .b(x19), .c(new_n53_), .d(x06), .O(new_n91_));
  oai21  g039(.a(x25), .b(x19), .c(new_n91_), .O(z05));
  nand2  g040(.a(new_n54_), .b(x05), .O(new_n93_));
  oai21  g041(.a(x27), .b(new_n54_), .c(new_n93_), .O(new_n94_));
  nand4  g042(.a(new_n94_), .b(x19), .c(new_n53_), .d(x06), .O(new_n95_));
  ...
  oai21  g049(.a(new_n101_), .b(new_n62_), .c(x19), .O(new_n102_));
  ...
  nand4  g055(.a(new_n107_), .b(x19), .c(new_n53_), .d(x06), .O(new_n108_));
  ...
  nand4  g069(.a(new_n121_), .b(x19), .c(new_n53_), .d(x06), .O(new_n122_));
  nand2  g070(.a(new_n113_), .b(new_n58_), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(new_n122_), .O(z10));
  nand2  g072(.a(new_n54_), .b(x08), .O(new_n125_));
  nand2  g073(.a(new_n87_), .b(x18), .O(new_n126_));
  ...
  oai21  g091(.a(new_n143_), .b(new_n62_), .c(x19), .O(new_n144_));
  nand2  g092(.a(new_n133_), .b(new_n58_), .O(new_n145_));
  ...
  nand4  g096(.a(new_n148_), .b(x19), .c(new_n53_), .d(x06), .O(new_n149_));
  nand2  g097(.a(new_n141_), .b(new_n58_), .O(new_n150_));
  ...
  nand4  g101(.a(new_n153_), .b(x19), .c(new_n53_), .d(x06), .O(new_n154_));
