...
module FAU ( 
  ...
  nand2  g008(.a(new_n54_), .b(x02), .O(new_n61_));
  ...
  inv1   g014(.a(x20), .O(new_n67_));
  oai21  g015(.a(new_n56_), .b(new_n67_), .c(new_n66_), .O(new_n68_));
  ...
  oai21  g022(.a(new_n62_), .b(new_n67_), .c(new_n66_), .O(new_n75_));
  ...
  oai21  g028(.a(new_n71_), .b(new_n67_), .c(new_n66_), .O(new_n81_));
  ...
  nand3  g036(.a(new_n88_), .b(x20), .c(new_n66_), .O(new_n89_));
  ...
  nand3  g043(.a(new_n84_), .b(x20), .c(new_n66_), .O(new_n96_));
  ...
  nand3  g064(.a(new_n116_), .b(x20), .c(new_n66_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n112_), .b(x20), .c(new_n66_), .O(new_n124_));
  ...
  nand3  g078(.a(new_n120_), .b(x20), .c(new_n66_), .O(new_n131_));
  ...
  oai21  g084(.a(new_n127_), .b(new_n67_), .c(new_n66_), .O(new_n137_));
  ...
  nand3  g092(.a(new_n144_), .b(x20), .c(new_n66_), .O(new_n145_));
  ...
  nand3  g099(.a(new_n140_), .b(x20), .c(new_n66_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n148_), .b(x20), .c(new_n66_), .O(new_n159_));
  ...
  oai21  g112(.a(new_n155_), .b(new_n67_), .c(new_n66_), .O(new_n165_));
