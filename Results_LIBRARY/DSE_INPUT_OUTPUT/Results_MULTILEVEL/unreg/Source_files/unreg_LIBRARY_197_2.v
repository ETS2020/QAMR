...
module FAU ( 
  ...
  nand4  g037(.a(new_n89_), .b(x23), .c(x19), .d(new_n64_), .O(new_n90_));
  ...
  nand4  g042(.a(new_n94_), .b(x23), .c(x19), .d(new_n64_), .O(new_n95_));
  ...
  nand2  g066(.a(new_n107_), .b(new_n60_), .O(new_n119_));
  ...
  nand4  g070(.a(new_n122_), .b(x23), .c(x19), .d(new_n64_), .O(new_n123_));
  nand2  g071(.a(new_n115_), .b(new_n60_), .O(new_n124_));
  ...
  nand4  g082(.a(new_n134_), .b(x23), .c(x19), .d(new_n64_), .O(new_n135_));
