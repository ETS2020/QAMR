...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n58_, new_n60_, new_n62_,
    ...
    new_n84_, new_n85_, new_n87_, new_n89_, new_n91_, new_n93_, new_n94_,
    new_n95_, new_n97_;
  ...
  oai21  g19(.a(new_n69_), .b(new_n64_), .c(new_n71_), .O(z05));
  ...
  oai21  g27(.a(new_n77_), .b(new_n64_), .c(new_n79_), .O(z08));
  nand2  g28(.a(new_n53_), .b(x10), .O(new_n81_));
  oai22  g29(.a(new_n81_), .b(new_n56_), .c(x29), .d(x19), .O(z09));
  aoi21  g30(.a(new_n53_), .b(x09), .c(x18), .O(new_n83_));
  inv1   g31(.a(x30), .O(new_n84_));
  nand2  g32(.a(new_n84_), .b(new_n64_), .O(new_n85_));
  oai21  g33(.a(new_n83_), .b(new_n64_), .c(new_n85_), .O(z10));
