...
module FAU ( 
  ...
  nand3  g009(.a(new_n61_), .b(new_n60_), .c(x18), .O(new_n62_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n60_), .c(x18), .O(new_n118_));
  ...
  nand3  g076(.a(new_n128_), .b(x19), .c(x18), .O(new_n129_));
  nand2  g077(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(new_n53_), .O(new_n131_));
  oai21  g079(.a(new_n121_), .b(new_n54_), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n60_), .c(x18), .O(new_n146_));
