...
module FAU ( 
  ...
  oai21  g13(.a(x23), .b(x17), .c(x18), .O(new_n66_));
  nand2  g14(.a(new_n66_), .b(x19), .O(new_n67_));
  nand2  g15(.a(new_n63_), .b(new_n55_), .O(new_n68_));
  nand2  g16(.a(new_n68_), .b(new_n67_), .O(z02));
  inv1   g17(.a(x23), .O(new_n70_));
  nand2  g18(.a(new_n70_), .b(new_n55_), .O(new_n71_));
  nand4  g19(.a(x19), .b(x18), .c(new_n61_), .d(x16), .O(new_n72_));
  nand2  g20(.a(new_n72_), .b(new_n71_), .O(z03));
  oai21  g21(.a(x25), .b(x17), .c(x18), .O(new_n74_));
  ...
  nand2  g29(.a(new_n81_), .b(new_n55_), .O(new_n82_));
  nand2  g30(.a(new_n82_), .b(new_n80_), .O(z05));
  ...
  oai21  g35(.a(new_n87_), .b(new_n62_), .c(new_n85_), .O(z06));
  oai21  g36(.a(x20), .b(x17), .c(x18), .O(new_n89_));
  nand2  g37(.a(new_n89_), .b(x19), .O(new_n90_));
  nand2  g38(.a(new_n86_), .b(new_n55_), .O(new_n91_));
  nand2  g39(.a(new_n91_), .b(new_n90_), .O(z07));
  ...
  oai21  g44(.a(new_n96_), .b(new_n62_), .c(new_n94_), .O(z08));
  oai21  g45(.a(x30), .b(x17), .c(x18), .O(new_n98_));
  nand2  g46(.a(new_n98_), .b(x19), .O(new_n99_));
  nand2  g47(.a(new_n95_), .b(new_n55_), .O(new_n100_));
  ...
  oai21  g53(.a(new_n105_), .b(new_n62_), .c(new_n103_), .O(z10));
  nand2  g54(.a(new_n104_), .b(new_n55_), .O(new_n107_));
  nand2  g55(.a(new_n76_), .b(x19), .O(new_n108_));
  oai21  g56(.a(new_n108_), .b(new_n62_), .c(new_n107_), .O(z11));
  ...
  oai21  g61(.a(new_n113_), .b(new_n62_), .c(new_n111_), .O(z12));
  nand2  g62(.a(new_n112_), .b(new_n55_), .O(new_n115_));
  inv1   g63(.a(x34), .O(new_n116_));
  nand2  g64(.a(new_n116_), .b(x19), .O(new_n117_));
  oai21  g65(.a(new_n117_), .b(new_n62_), .c(new_n115_), .O(z13));
  nand2  g66(.a(new_n116_), .b(new_n55_), .O(new_n119_));
  inv1   g67(.a(x35), .O(new_n120_));
  nand2  g68(.a(new_n120_), .b(x19), .O(new_n121_));
  oai21  g69(.a(new_n121_), .b(new_n62_), .c(new_n119_), .O(z14));
  nand2  g70(.a(new_n120_), .b(new_n55_), .O(new_n123_));
  nand2  g71(.a(new_n93_), .b(x19), .O(new_n124_));
  oai21  g72(.a(new_n124_), .b(new_n62_), .c(new_n123_), .O(z15));
endmodule
