...
module FAU ( 
  ...
  oai21  g024(.a(new_n65_), .b(x00), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g044(.a(new_n85_), .b(x00), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n93_), .b(new_n60_), .c(new_n69_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n100_), .b(new_n60_), .c(new_n69_), .O(new_n110_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n60_), .c(new_n69_), .O(new_n118_));
