...
module FAU ( 
  ...
  oai22  g17(.a(new_n69_), .b(new_n61_), .c(x25), .d(x19), .O(z05));
  nand2  g18(.a(new_n54_), .b(x05), .O(new_n71_));
  oai22  g19(.a(new_n71_), .b(new_n61_), .c(x26), .d(x19), .O(z06));
  ...
  oai22  g37(.a(new_n89_), .b(new_n61_), .c(x32), .d(x19), .O(z12));
  aoi21  g38(.a(new_n54_), .b(x14), .c(x18), .O(new_n91_));
  inv1   g39(.a(x33), .O(new_n92_));
  nand2  g40(.a(new_n92_), .b(new_n53_), .O(new_n93_));
  oai21  g41(.a(new_n91_), .b(new_n53_), .c(new_n93_), .O(z13));
