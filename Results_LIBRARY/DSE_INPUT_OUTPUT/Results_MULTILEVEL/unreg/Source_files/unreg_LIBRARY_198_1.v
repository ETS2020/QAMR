...
module FAU ( 
  ...
  oai21  g066(.a(x31), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  oai21  g092(.a(new_n144_), .b(x31), .c(new_n60_), .O(new_n145_));
  ...
  oai21  g099(.a(new_n140_), .b(x31), .c(new_n60_), .O(new_n152_));
  ...
  oai21  g112(.a(new_n155_), .b(x31), .c(new_n60_), .O(new_n165_));
