...
module FAU ( 
  ...
  inv1   g009(.a(x24), .O(new_n62_));
  oai21  g010(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(new_n63_));
  ...
  oai21  g017(.a(new_n62_), .b(new_n56_), .c(new_n60_), .O(new_n70_));
  nand2  g018(.a(new_n70_), .b(new_n69_), .O(z01));
  ...
  oai21  g024(.a(new_n62_), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g030(.a(new_n62_), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g043(.a(new_n86_), .b(new_n62_), .c(new_n60_), .O(new_n96_));
  ...
  nand3  g050(.a(new_n92_), .b(x24), .c(new_n60_), .O(new_n103_));
  ...
  oai21  g056(.a(new_n99_), .b(new_n62_), .c(new_n60_), .O(new_n109_));
  ...
  oai21  g064(.a(new_n116_), .b(new_n62_), .c(new_n60_), .O(new_n117_));
  ...
  oai21  g071(.a(new_n112_), .b(new_n62_), .c(new_n60_), .O(new_n124_));
  ...
  nand3  g092(.a(new_n144_), .b(x24), .c(new_n60_), .O(new_n145_));
  ...
  oai21  g099(.a(new_n140_), .b(new_n62_), .c(new_n60_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n148_), .b(x24), .c(new_n60_), .O(new_n159_));
  ...
  oai21  g112(.a(new_n155_), .b(new_n62_), .c(new_n60_), .O(new_n165_));
