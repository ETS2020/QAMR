...
module FAU ( 
  ...
  nor2   g017(.a(new_n69_), .b(new_n63_), .O(new_n70_));
  ...
  aoi21  g026(.a(new_n78_), .b(new_n76_), .c(new_n63_), .O(z02));
  ...
  nand2  g031(.a(new_n73_), .b(new_n58_), .O(new_n84_));
  aoi21  g032(.a(new_n84_), .b(new_n83_), .c(new_n63_), .O(z03));
  ...
  nor2   g037(.a(new_n89_), .b(new_n63_), .O(new_n90_));
  ...
  nor2   g043(.a(new_n95_), .b(new_n63_), .O(new_n96_));
  nand2  g044(.a(new_n96_), .b(new_n94_), .O(z05));
  nand3  g045(.a(new_n62_), .b(new_n54_), .c(x05), .O(new_n98_));
  nand3  g046(.a(x33), .b(new_n60_), .c(x18), .O(new_n99_));
  ...
  nand2  g050(.a(new_n61_), .b(new_n60_), .O(new_n103_));
  nand3  g051(.a(new_n103_), .b(new_n102_), .c(new_n58_), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(new_n101_), .O(z06));
  nand3  g053(.a(new_n62_), .b(new_n54_), .c(x04), .O(new_n106_));
  nand3  g054(.a(new_n103_), .b(new_n59_), .c(x18), .O(new_n107_));
  nand2  g055(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g056(.a(new_n108_), .b(x19), .c(new_n53_), .O(new_n109_));
  nand3  g057(.a(x33), .b(new_n60_), .c(new_n58_), .O(new_n110_));
  ...
  nor2   g063(.a(new_n115_), .b(new_n63_), .O(new_n116_));
  ...
  aoi21  g078(.a(new_n130_), .b(new_n128_), .c(new_n63_), .O(z10));
  ...
  aoi21  g082(.a(new_n125_), .b(new_n58_), .c(new_n63_), .O(new_n135_));
  ...
  aoi22  g088(.a(new_n61_), .b(new_n60_), .c(new_n140_), .d(new_n58_), .O(new_n141_));
  ...
  nand4  g092(.a(new_n144_), .b(new_n62_), .c(x19), .d(new_n53_), .O(new_n145_));
  nand3  g093(.a(new_n61_), .b(x27), .c(new_n58_), .O(new_n146_));
  ...
  aoi21  g102(.a(new_n154_), .b(new_n152_), .c(new_n63_), .O(z14));
  ...
  aoi21  g106(.a(new_n149_), .b(new_n58_), .c(new_n63_), .O(new_n159_));
