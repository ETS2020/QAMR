...
module FAU ( 
  ...
  nand4  g31(.a(x19), .b(new_n63_), .c(new_n54_), .d(x09), .O(new_n84_));
  oai21  g32(.a(x30), .b(x19), .c(new_n84_), .O(z10));
  aoi21  g33(.a(new_n54_), .b(x08), .c(x18), .O(new_n86_));
  inv1   g34(.a(x31), .O(new_n87_));
  nand2  g35(.a(new_n87_), .b(new_n53_), .O(new_n88_));
  oai21  g36(.a(new_n86_), .b(new_n53_), .c(new_n88_), .O(z11));
