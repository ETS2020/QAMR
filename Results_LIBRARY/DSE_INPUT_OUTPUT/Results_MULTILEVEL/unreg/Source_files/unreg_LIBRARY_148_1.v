...
module FAU ( 
  ...
  nand2  g36(.a(new_n88_), .b(new_n55_), .O(new_n89_));
  ...
  nand4  g51(.a(new_n103_), .b(x19), .c(x18), .d(new_n61_), .O(new_n104_));
  nand2  g52(.a(new_n104_), .b(new_n102_), .O(z10));
  nand2  g53(.a(new_n103_), .b(new_n55_), .O(new_n106_));
  nand4  g54(.a(new_n74_), .b(x19), .c(x18), .d(new_n61_), .O(new_n107_));
  ...
  nand4  g64(.a(new_n116_), .b(x19), .c(x18), .d(new_n61_), .O(new_n117_));
  nand2  g65(.a(new_n117_), .b(new_n115_), .O(z13));
  nand2  g66(.a(new_n116_), .b(new_n55_), .O(new_n119_));
  inv1   g67(.a(x35), .O(new_n120_));
  nand4  g68(.a(new_n120_), .b(x19), .c(x18), .d(new_n61_), .O(new_n121_));
