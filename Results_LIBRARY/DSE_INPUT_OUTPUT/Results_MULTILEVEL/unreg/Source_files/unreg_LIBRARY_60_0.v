...
module FAU ( 
  ...
  nand3  g016(.a(x27), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  nand3  g023(.a(x27), .b(new_n65_), .c(new_n60_), .O(new_n76_));
  ...
  nand3  g029(.a(x27), .b(new_n72_), .c(new_n60_), .O(new_n82_));
  ...
  nand2  g057(.a(new_n90_), .b(new_n60_), .O(new_n110_));
  ...
  nand3  g065(.a(new_n117_), .b(x27), .c(new_n60_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n113_), .b(x27), .c(new_n60_), .O(new_n125_));
  ...
  nand3  g079(.a(new_n121_), .b(x27), .c(new_n60_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n128_), .b(new_n90_), .c(new_n60_), .O(new_n138_));
  ...
  nand3  g093(.a(new_n145_), .b(x27), .c(new_n60_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n141_), .b(x27), .c(new_n60_), .O(new_n153_));
  ...
  oai21  g107(.a(new_n149_), .b(new_n90_), .c(new_n60_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n156_), .b(x27), .c(new_n60_), .O(new_n166_));
