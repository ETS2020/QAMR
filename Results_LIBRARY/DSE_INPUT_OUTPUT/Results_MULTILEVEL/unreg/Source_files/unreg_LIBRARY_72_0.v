...
module FAU ( 
  ...
  nand3  g050(.a(new_n93_), .b(x25), .c(new_n60_), .O(new_n103_));
  ...
  oai21  g056(.a(new_n99_), .b(new_n76_), .c(new_n60_), .O(new_n109_));
  ...
  oai21  g071(.a(new_n112_), .b(new_n76_), .c(new_n60_), .O(new_n124_));
  ...
  oai21  g099(.a(new_n140_), .b(new_n76_), .c(new_n60_), .O(new_n152_));
