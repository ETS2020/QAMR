...
module FAU ( 
  ...
  oai22  g20(.a(new_n72_), .b(new_n60_), .c(x24), .d(x19), .O(z04));
  ...
  oai22  g27(.a(new_n79_), .b(new_n60_), .c(x26), .d(x19), .O(z06));
  nand2  g28(.a(new_n56_), .b(x19), .O(new_n81_));
  oai22  g29(.a(new_n81_), .b(new_n60_), .c(x27), .d(x19), .O(z07));
  inv1   g30(.a(x29), .O(new_n83_));
  nand2  g31(.a(new_n83_), .b(x19), .O(new_n84_));
  oai22  g32(.a(new_n84_), .b(new_n60_), .c(x28), .d(x19), .O(z08));
  inv1   g33(.a(x30), .O(new_n86_));
  nand2  g34(.a(new_n86_), .b(x19), .O(new_n87_));
  oai22  g35(.a(new_n87_), .b(new_n60_), .c(x29), .d(x19), .O(z09));
  inv1   g36(.a(x31), .O(new_n89_));
  aoi21  g37(.a(new_n89_), .b(new_n59_), .c(new_n67_), .O(new_n90_));
  nand2  g38(.a(new_n86_), .b(new_n55_), .O(new_n91_));
  oai21  g39(.a(new_n90_), .b(new_n55_), .c(new_n91_), .O(z10));
  oai21  g40(.a(x24), .b(x17), .c(x18), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(x19), .O(new_n94_));
  nand2  g42(.a(new_n89_), .b(new_n55_), .O(new_n95_));
  ...
  oai22  g51(.a(new_n103_), .b(new_n60_), .c(x33), .d(x19), .O(z13));
  inv1   g52(.a(x35), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(x19), .O(new_n106_));
  oai22  g54(.a(new_n106_), .b(new_n60_), .c(x34), .d(x19), .O(z14));
