...
module FAU ( 
  ...
  oai21  g017(.a(new_n56_), .b(x12), .c(new_n61_), .O(new_n70_));
  ...
  nand3  g024(.a(new_n66_), .b(new_n61_), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g038(.a(new_n90_), .b(x12), .c(new_n61_), .O(new_n91_));
  ...
  oai21  g052(.a(new_n94_), .b(x12), .c(new_n61_), .O(new_n105_));
  ...
  oai21  g058(.a(new_n101_), .b(x12), .c(new_n61_), .O(new_n111_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n61_), .c(new_n60_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n61_), .c(new_n60_), .O(new_n126_));
  ...
  oai21  g080(.a(new_n122_), .b(x12), .c(new_n61_), .O(new_n133_));
  ...
  oai21  g086(.a(new_n129_), .b(x12), .c(new_n61_), .O(new_n139_));
  ...
  oai21  g094(.a(new_n146_), .b(x12), .c(new_n61_), .O(new_n147_));
  ...
  oai21  g101(.a(new_n142_), .b(x12), .c(new_n61_), .O(new_n154_));
  ...
  oai21  g108(.a(new_n150_), .b(x12), .c(new_n61_), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n160_), .O(z14));
  oai21  g110(.a(x18), .b(x17), .c(x19), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(x12), .O(new_n164_));
  nand4  g112(.a(new_n118_), .b(x19), .c(x18), .d(new_n53_), .O(new_n165_));
  nand2  g113(.a(new_n157_), .b(new_n61_), .O(new_n166_));
  nand3  g114(.a(new_n166_), .b(new_n165_), .c(new_n164_), .O(z15));
endmodule
