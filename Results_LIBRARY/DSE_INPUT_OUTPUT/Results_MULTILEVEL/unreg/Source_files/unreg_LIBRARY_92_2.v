...
module FAU ( 
  ...
  oai21  g019(.a(x18), .b(x17), .c(x19), .O(new_n72_));
  nand2  g020(.a(new_n72_), .b(x01), .O(new_n73_));
  nand2  g021(.a(new_n66_), .b(new_n61_), .O(new_n74_));
  inv1   g022(.a(x23), .O(new_n75_));
  nand4  g023(.a(new_n75_), .b(x19), .c(x18), .d(new_n53_), .O(new_n76_));
  nand3  g024(.a(new_n76_), .b(new_n74_), .c(new_n73_), .O(z02));
  ...
  nand3  g029(.a(new_n75_), .b(new_n61_), .c(new_n60_), .O(new_n82_));
  ...
  nand3  g037(.a(new_n89_), .b(new_n61_), .c(new_n60_), .O(new_n90_));
  ...
  nand3  g044(.a(new_n85_), .b(new_n61_), .c(new_n60_), .O(new_n97_));
  ...
  oai21  g051(.a(new_n93_), .b(x01), .c(new_n61_), .O(new_n104_));
  ...
  oai21  g065(.a(new_n117_), .b(x01), .c(new_n61_), .O(new_n118_));
  ...
  oai21  g072(.a(new_n113_), .b(x01), .c(new_n61_), .O(new_n125_));
  ...
  oai21  g079(.a(new_n121_), .b(x01), .c(new_n61_), .O(new_n132_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n61_), .c(new_n60_), .O(new_n138_));
  ...
  oai21  g093(.a(new_n145_), .b(x01), .c(new_n61_), .O(new_n146_));
  ...
  oai21  g107(.a(new_n149_), .b(x01), .c(new_n61_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n156_), .b(x01), .c(new_n61_), .O(new_n166_));
