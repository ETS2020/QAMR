...
module FAU ( 
  ...
  nand2  g045(.a(new_n86_), .b(new_n60_), .O(new_n98_));
  ...
  aoi21  g056(.a(new_n108_), .b(new_n107_), .c(x17), .O(new_n109_));
  oai21  g057(.a(new_n109_), .b(new_n53_), .c(x19), .O(new_n110_));
  nand2  g058(.a(new_n101_), .b(new_n60_), .O(new_n111_));
  ...
  nand4  g070(.a(new_n122_), .b(x35), .c(x19), .d(new_n78_), .O(new_n123_));
  nand2  g071(.a(new_n114_), .b(new_n60_), .O(new_n124_));
  ...
  nand4  g083(.a(new_n135_), .b(x35), .c(x19), .d(new_n78_), .O(new_n136_));
  ...
  nand4  g096(.a(new_n148_), .b(x35), .c(x19), .d(new_n78_), .O(new_n149_));
  ...
  nand3  g104(.a(new_n156_), .b(x19), .c(new_n78_), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(x35), .O(z15));
endmodule
