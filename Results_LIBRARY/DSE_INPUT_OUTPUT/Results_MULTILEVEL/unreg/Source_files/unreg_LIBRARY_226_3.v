...
module FAU ( 
  ...
  oai21  g014(.a(new_n66_), .b(x12), .c(x19), .O(new_n67_));
  ...
  oai21  g032(.a(new_n84_), .b(x12), .c(x19), .O(new_n85_));
  ...
  oai21  g037(.a(x26), .b(new_n55_), .c(new_n89_), .O(new_n90_));
  nand4  g038(.a(new_n90_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n91_));
  ...
  oai21  g045(.a(new_n97_), .b(x12), .c(x19), .O(new_n98_));
  ...
  oai21  g052(.a(new_n104_), .b(x12), .c(x19), .O(new_n105_));
  ...
  nand4  g057(.a(new_n109_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n110_));
  ...
  nand4  g063(.a(new_n115_), .b(x19), .c(new_n54_), .d(new_n53_), .O(new_n116_));
  ...
  oai21  g071(.a(new_n123_), .b(x12), .c(x19), .O(new_n124_));
  ...
  oai21  g078(.a(new_n130_), .b(x12), .c(x19), .O(new_n131_));
  nand2  g079(.a(new_n121_), .b(new_n59_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n137_), .b(x12), .c(x19), .O(new_n138_));
  ...
  oai21  g093(.a(new_n145_), .b(x12), .c(x19), .O(new_n146_));
  nand2  g094(.a(new_n135_), .b(new_n59_), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n146_), .O(z13));
  nand2  g096(.a(new_n55_), .b(x13), .O(new_n149_));
  inv1   g097(.a(x35), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(x18), .O(new_n151_));
  aoi21  g099(.a(new_n151_), .b(new_n149_), .c(x17), .O(new_n152_));
  oai21  g100(.a(new_n152_), .b(x12), .c(x19), .O(new_n153_));
  nand2  g101(.a(new_n143_), .b(new_n59_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n153_), .O(z14));
  nand3  g103(.a(new_n111_), .b(x18), .c(new_n54_), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n53_), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(x19), .O(new_n158_));
  oai21  g106(.a(x35), .b(x19), .c(new_n158_), .O(z15));
endmodule
