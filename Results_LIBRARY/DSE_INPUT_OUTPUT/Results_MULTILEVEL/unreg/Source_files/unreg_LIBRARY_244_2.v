...
module FAU ( 
  ...
  nand4  g039(.a(new_n91_), .b(x34), .c(x19), .d(new_n71_), .O(new_n92_));
  ...
  nand4  g099(.a(new_n151_), .b(x34), .c(x19), .d(new_n71_), .O(new_n152_));
  nand2  g100(.a(new_n53_), .b(new_n60_), .O(new_n153_));
