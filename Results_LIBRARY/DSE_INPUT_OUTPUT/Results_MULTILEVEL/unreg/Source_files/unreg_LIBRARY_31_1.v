...
module FAU ( 
  ...
  nand4  g049(.a(new_n101_), .b(new_n60_), .c(x19), .d(new_n53_), .O(new_n102_));
  inv1   g050(.a(x32), .O(new_n103_));
  nand3  g051(.a(new_n103_), .b(new_n59_), .c(new_n69_), .O(new_n104_));
  ...
  aoi22  g056(.a(x32), .b(new_n59_), .c(new_n99_), .d(new_n69_), .O(new_n109_));
  ...
  oai21  g085(.a(new_n59_), .b(new_n69_), .c(x32), .O(new_n138_));
  nand2  g086(.a(new_n54_), .b(x15), .O(new_n139_));
  oai21  g087(.a(x33), .b(new_n54_), .c(new_n139_), .O(new_n140_));
  nand3  g088(.a(new_n140_), .b(new_n138_), .c(new_n53_), .O(new_n141_));
  nand2  g089(.a(new_n103_), .b(new_n69_), .O(new_n142_));
  nand2  g090(.a(new_n142_), .b(new_n141_), .O(z12));
  ...
  nand2  g097(.a(new_n149_), .b(new_n69_), .O(new_n150_));
  ...
  nand2  g104(.a(new_n145_), .b(new_n69_), .O(new_n157_));
  aoi21  g105(.a(new_n157_), .b(new_n156_), .c(new_n61_), .O(z14));
  nand2  g106(.a(new_n54_), .b(x12), .O(new_n159_));
  oai21  g107(.a(x28), .b(new_n54_), .c(new_n159_), .O(new_n160_));
  nand3  g108(.a(new_n160_), .b(x19), .c(new_n53_), .O(new_n161_));
  aoi21  g109(.a(new_n153_), .b(new_n69_), .c(new_n61_), .O(new_n162_));
