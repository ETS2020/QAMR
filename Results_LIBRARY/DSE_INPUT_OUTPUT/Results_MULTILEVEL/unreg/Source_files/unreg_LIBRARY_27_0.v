...
module FAU ( 
  ...
  nand2  g037(.a(new_n62_), .b(new_n60_), .O(new_n90_));
  ...
  nand3  g044(.a(new_n86_), .b(x24), .c(new_n60_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n93_), .b(x24), .c(new_n60_), .O(new_n104_));
  ...
  nand2  g082(.a(new_n62_), .b(x18), .O(new_n135_));
  ...
  nand3  g100(.a(new_n141_), .b(x24), .c(new_n60_), .O(new_n153_));
  ...
  nand3  g113(.a(new_n156_), .b(x24), .c(new_n60_), .O(new_n166_));
