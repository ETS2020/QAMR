...
module FAU ( 
  ...
  oai21  g024(.a(x24), .b(new_n66_), .c(new_n60_), .O(new_n77_));
  ...
  oai21  g030(.a(x24), .b(new_n73_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g043(.a(new_n95_), .b(x24), .c(new_n60_), .O(new_n96_));
  ...
  nand3  g056(.a(new_n99_), .b(new_n62_), .c(new_n60_), .O(new_n109_));
  ...
  oai21  g112(.a(new_n155_), .b(x24), .c(new_n60_), .O(new_n165_));
