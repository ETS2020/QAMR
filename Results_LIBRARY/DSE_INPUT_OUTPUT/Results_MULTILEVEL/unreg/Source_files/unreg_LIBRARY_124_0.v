...
module FAU ( 
  ...
  oai21  g024(.a(new_n65_), .b(new_n76_), .c(new_n60_), .O(new_n77_));
  ...
  nand3  g030(.a(new_n72_), .b(new_n60_), .c(x13), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n60_), .c(x13), .O(new_n91_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n60_), .c(x13), .O(new_n98_));
  ...
  nand3  g052(.a(new_n94_), .b(new_n60_), .c(x13), .O(new_n105_));
  ...
  oai21  g058(.a(new_n101_), .b(new_n76_), .c(new_n60_), .O(new_n111_));
  ...
  oai21  g080(.a(new_n122_), .b(new_n76_), .c(new_n60_), .O(new_n133_));
  ...
  nand3  g101(.a(new_n142_), .b(new_n60_), .c(x13), .O(new_n154_));
  ...
  oai21  g108(.a(new_n150_), .b(new_n76_), .c(new_n60_), .O(new_n161_));
  ...
  oai21  g114(.a(new_n157_), .b(new_n76_), .c(new_n60_), .O(new_n167_));
