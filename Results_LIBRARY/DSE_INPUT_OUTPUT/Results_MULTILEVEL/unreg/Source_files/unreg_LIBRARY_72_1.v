...
module FAU ( 
  ...
  oai21  g057(.a(new_n100_), .b(x25), .c(new_n60_), .O(new_n110_));
  ...
  oai21  g072(.a(new_n113_), .b(x25), .c(new_n60_), .O(new_n125_));
  ...
  oai21  g100(.a(new_n141_), .b(x25), .c(new_n60_), .O(new_n153_));
