...
module FAU ( 
  ...
  nand2  g20(.a(new_n53_), .b(x06), .O(new_n73_));
  oai22  g21(.a(new_n73_), .b(new_n56_), .c(x25), .d(x19), .O(z05));
  aoi21  g22(.a(new_n53_), .b(x05), .c(x18), .O(new_n75_));
  inv1   g23(.a(x26), .O(new_n76_));
  nand2  g24(.a(new_n76_), .b(new_n58_), .O(new_n77_));
  oai21  g25(.a(new_n75_), .b(new_n58_), .c(new_n77_), .O(z06));
  nand2  g26(.a(new_n53_), .b(x04), .O(new_n79_));
  oai22  g27(.a(new_n79_), .b(new_n56_), .c(x27), .d(x19), .O(z07));
  nand2  g28(.a(new_n53_), .b(x11), .O(new_n81_));
  oai22  g29(.a(new_n81_), .b(new_n56_), .c(x28), .d(x19), .O(z08));
  aoi21  g30(.a(new_n53_), .b(x10), .c(x18), .O(new_n83_));
  inv1   g31(.a(x29), .O(new_n84_));
  nand2  g32(.a(new_n84_), .b(new_n58_), .O(new_n85_));
  oai21  g33(.a(new_n83_), .b(new_n58_), .c(new_n85_), .O(z09));
  ...
  oai21  g45(.a(new_n95_), .b(new_n58_), .c(new_n97_), .O(z13));
