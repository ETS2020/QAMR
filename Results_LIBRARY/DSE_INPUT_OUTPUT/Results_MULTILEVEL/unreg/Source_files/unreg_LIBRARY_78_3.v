...
module FAU ( 
  ...
  nand4  g27(.a(x19), .b(new_n67_), .c(new_n54_), .d(x11), .O(new_n80_));
  ...
  nand4  g33(.a(x19), .b(new_n67_), .c(new_n54_), .d(x09), .O(new_n86_));
  oai21  g34(.a(x30), .b(x19), .c(new_n86_), .O(z10));
  nand4  g35(.a(x19), .b(new_n67_), .c(new_n54_), .d(x08), .O(new_n88_));
