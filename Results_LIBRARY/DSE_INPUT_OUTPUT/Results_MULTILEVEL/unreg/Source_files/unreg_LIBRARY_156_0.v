...
module FAU ( 
  ...
  nand3  g017(.a(new_n56_), .b(new_n61_), .c(x00), .O(new_n70_));
  ...
  nand3  g024(.a(new_n66_), .b(new_n61_), .c(x00), .O(new_n77_));
  ...
  oai21  g051(.a(new_n93_), .b(new_n60_), .c(new_n61_), .O(new_n104_));
  ...
  oai21  g057(.a(new_n100_), .b(new_n60_), .c(new_n61_), .O(new_n110_));
  ...
  nand3  g072(.a(new_n113_), .b(new_n61_), .c(x00), .O(new_n125_));
  ...
  nand3  g093(.a(new_n145_), .b(new_n61_), .c(x00), .O(new_n146_));
  ...
  nand3  g100(.a(new_n141_), .b(new_n61_), .c(x00), .O(new_n153_));
