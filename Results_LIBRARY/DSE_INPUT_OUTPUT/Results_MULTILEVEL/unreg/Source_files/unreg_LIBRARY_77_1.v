...
module FAU ( 
  ...
  oai21  g030(.a(x28), .b(new_n72_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g038(.a(x28), .b(new_n90_), .c(new_n60_), .O(new_n91_));
  ...
  nand3  g045(.a(new_n76_), .b(new_n86_), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g052(.a(x28), .b(new_n94_), .c(new_n60_), .O(new_n105_));
  ...
  nand3  g071(.a(new_n123_), .b(new_n76_), .c(new_n60_), .O(new_n124_));
  ...
  oai21  g078(.a(new_n119_), .b(x28), .c(new_n60_), .O(new_n131_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n76_), .c(new_n60_), .O(new_n137_));
  ...
  nand3  g092(.a(new_n144_), .b(new_n76_), .c(new_n60_), .O(new_n145_));
  ...
  nand3  g099(.a(new_n140_), .b(new_n76_), .c(new_n60_), .O(new_n152_));
