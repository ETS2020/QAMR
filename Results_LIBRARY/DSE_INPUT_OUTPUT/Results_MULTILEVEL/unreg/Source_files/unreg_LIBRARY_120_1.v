...
module FAU ( 
  ...
  oai21  g028(.a(new_n80_), .b(x22), .c(new_n60_), .O(new_n81_));
  ...
  nand3  g036(.a(new_n88_), .b(new_n62_), .c(new_n60_), .O(new_n89_));
  ...
  oai21  g050(.a(new_n92_), .b(x22), .c(new_n60_), .O(new_n103_));
  ...
  oai21  g064(.a(new_n116_), .b(x22), .c(new_n60_), .O(new_n117_));
