...
module FAU ( 
  ...
  nand4  g020(.a(new_n72_), .b(x19), .c(new_n53_), .d(x13), .O(new_n73_));
  ...
  nand4  g040(.a(new_n92_), .b(x19), .c(new_n53_), .d(x13), .O(new_n93_));
  nand2  g041(.a(new_n84_), .b(new_n58_), .O(new_n94_));
  ...
  oai21  g047(.a(new_n99_), .b(new_n62_), .c(x19), .O(new_n100_));
  ...
  nand4  g053(.a(new_n105_), .b(x19), .c(new_n53_), .d(x13), .O(new_n106_));
  nand2  g054(.a(new_n97_), .b(new_n58_), .O(new_n107_));
  ...
  nand2  g076(.a(new_n118_), .b(new_n58_), .O(new_n129_));
  nand2  g077(.a(new_n129_), .b(new_n128_), .O(z10));
  nand2  g078(.a(new_n54_), .b(x08), .O(new_n131_));
  oai21  g079(.a(x24), .b(new_n54_), .c(new_n131_), .O(new_n132_));
  nand4  g080(.a(new_n132_), .b(x19), .c(new_n53_), .d(x13), .O(new_n133_));
  nand2  g081(.a(new_n125_), .b(new_n58_), .O(new_n134_));
