...
module FAU ( 
  ...
  nand3  g080(.a(new_n122_), .b(new_n61_), .c(x10), .O(new_n133_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n61_), .c(x10), .O(new_n147_));
  ...
  nand3  g101(.a(new_n142_), .b(new_n61_), .c(x10), .O(new_n154_));
  ...
  nand3  g108(.a(new_n150_), .b(new_n61_), .c(x10), .O(new_n161_));
