...
module FAU ( 
  ...
  nand3  g009(.a(new_n61_), .b(new_n60_), .c(x09), .O(new_n62_));
  ...
  nand3  g030(.a(new_n73_), .b(new_n60_), .c(x09), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n60_), .c(x09), .O(new_n91_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n60_), .c(x09), .O(new_n98_));
  ...
  nand3  g052(.a(new_n94_), .b(new_n60_), .c(x09), .O(new_n105_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n60_), .c(x09), .O(new_n111_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n60_), .c(x09), .O(new_n126_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n60_), .c(x09), .O(new_n139_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n60_), .c(x09), .O(new_n147_));
  ...
  nand3  g108(.a(new_n150_), .b(new_n60_), .c(x09), .O(new_n161_));
  ...
  nand3  g114(.a(new_n157_), .b(new_n60_), .c(x09), .O(new_n167_));
