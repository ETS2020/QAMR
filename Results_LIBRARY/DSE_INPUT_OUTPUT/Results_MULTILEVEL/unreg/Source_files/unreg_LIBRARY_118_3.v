...
module FAU ( 
  ...
  nand2  g007(.a(x27), .b(x24), .O(new_n60_));
  ...
  aoi21  g016(.a(new_n68_), .b(new_n66_), .c(new_n61_), .O(z01));
  ...
  inv1   g033(.a(x27), .O(new_n86_));
  nand2  g034(.a(new_n86_), .b(x24), .O(new_n87_));
  aoi21  g035(.a(new_n87_), .b(new_n58_), .c(new_n61_), .O(new_n88_));
  nand2  g036(.a(new_n88_), .b(new_n85_), .O(z04));
  ...
  nand2  g054(.a(new_n86_), .b(new_n58_), .O(new_n107_));
  ...
  nor2   g059(.a(x28), .b(x19), .O(new_n112_));
  ...
  nor2   g065(.a(x29), .b(x19), .O(new_n118_));
  nor2   g066(.a(new_n118_), .b(new_n61_), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n117_), .O(z09));
  ...
  aoi21  g073(.a(new_n125_), .b(new_n123_), .c(new_n61_), .O(z10));
  oai21  g074(.a(x27), .b(x18), .c(x24), .O(new_n127_));
  ...
  nand3  g079(.a(new_n60_), .b(new_n131_), .c(new_n58_), .O(new_n132_));
  ...
  aoi21  g092(.a(new_n144_), .b(new_n142_), .c(new_n61_), .O(z13));
  ...
  aoi21  g098(.a(new_n150_), .b(new_n148_), .c(new_n61_), .O(z14));
  ...
  aoi21  g104(.a(new_n156_), .b(new_n154_), .c(new_n61_), .O(z15));
endmodule
