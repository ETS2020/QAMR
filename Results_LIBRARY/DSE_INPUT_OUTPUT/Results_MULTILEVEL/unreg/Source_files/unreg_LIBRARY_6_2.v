...
module FAU ( 
  ...
  nand2  g007(.a(new_n59_), .b(x21), .O(new_n60_));
  ...
  oai21  g012(.a(new_n59_), .b(new_n64_), .c(x21), .O(new_n65_));
  nand3  g013(.a(new_n65_), .b(new_n54_), .c(x02), .O(new_n66_));
  inv1   g014(.a(x22), .O(new_n67_));
  nand4  g015(.a(new_n60_), .b(new_n67_), .c(x19), .d(x18), .O(new_n68_));
  nand2  g016(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand2  g017(.a(new_n69_), .b(new_n53_), .O(new_n70_));
  inv1   g018(.a(x21), .O(new_n71_));
  nand2  g019(.a(new_n71_), .b(new_n64_), .O(new_n72_));
  ...
  nand2  g024(.a(new_n67_), .b(new_n64_), .O(new_n77_));
  aoi21  g025(.a(new_n77_), .b(new_n76_), .c(new_n61_), .O(z02));
  ...
  aoi21  g032(.a(new_n84_), .b(new_n82_), .c(new_n61_), .O(z03));
  ...
  nor2   g040(.a(x26), .b(x21), .O(new_n93_));
  aoi21  g041(.a(x26), .b(new_n54_), .c(new_n93_), .O(new_n94_));
  nand2  g042(.a(new_n93_), .b(x18), .O(new_n95_));
  oai21  g043(.a(new_n94_), .b(new_n92_), .c(new_n95_), .O(new_n96_));
  nand3  g044(.a(new_n96_), .b(x19), .c(new_n53_), .O(new_n97_));
  inv1   g045(.a(x25), .O(new_n98_));
  nand3  g046(.a(new_n60_), .b(new_n98_), .c(new_n64_), .O(new_n99_));
  nand2  g047(.a(new_n99_), .b(new_n97_), .O(z05));
  nand2  g048(.a(new_n54_), .b(x05), .O(new_n101_));
  oai21  g049(.a(x27), .b(new_n54_), .c(new_n101_), .O(new_n102_));
  nand4  g050(.a(new_n102_), .b(new_n60_), .c(x19), .d(new_n53_), .O(new_n103_));
  ...
  aoi22  g057(.a(new_n109_), .b(new_n64_), .c(new_n59_), .d(x21), .O(new_n110_));
  ...
  aoi21  g070(.a(new_n122_), .b(new_n120_), .c(new_n61_), .O(z09));
  ...
  nand2  g081(.a(new_n133_), .b(new_n64_), .O(new_n134_));
  aoi21  g082(.a(new_n134_), .b(new_n132_), .c(new_n61_), .O(z11));
  ...
  nand2  g087(.a(new_n139_), .b(new_n64_), .O(new_n140_));
  aoi21  g088(.a(new_n140_), .b(new_n138_), .c(new_n61_), .O(z12));
  ...
  nand2  g093(.a(new_n145_), .b(new_n64_), .O(new_n146_));
  ...
  nor2   g098(.a(x34), .b(x19), .O(new_n151_));
  ...
  aoi21  g106(.a(new_n158_), .b(new_n156_), .c(new_n61_), .O(z15));
endmodule
