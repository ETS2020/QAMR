...
module FAU ( 
  ...
  nand3  g024(.a(new_n66_), .b(new_n61_), .c(x14), .O(new_n77_));
  ...
  nand3  g045(.a(new_n86_), .b(new_n61_), .c(x14), .O(new_n98_));
  ...
  nand3  g052(.a(new_n94_), .b(new_n61_), .c(x14), .O(new_n105_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n61_), .c(x14), .O(new_n119_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n61_), .c(x14), .O(new_n139_));
  ...
  nand2  g093(.a(x32), .b(x14), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n61_), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n145_), .O(z12));
  nand3  g096(.a(x19), .b(new_n54_), .c(new_n53_), .O(new_n149_));
  nand2  g097(.a(new_n142_), .b(new_n61_), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(x14), .O(new_n152_));
  inv1   g100(.a(x34), .O(new_n153_));
  nand4  g101(.a(new_n153_), .b(x19), .c(x18), .d(new_n53_), .O(new_n154_));
  ...
  oai21  g108(.a(new_n153_), .b(new_n60_), .c(new_n61_), .O(new_n161_));
  ...
  nand3  g114(.a(new_n157_), .b(new_n61_), .c(x14), .O(new_n167_));
