...
module FAU ( 
  ...
  nand4  g030(.a(new_n82_), .b(x19), .c(new_n64_), .d(x10), .O(new_n83_));
  ...
  nand4  g051(.a(new_n103_), .b(x19), .c(new_n64_), .d(x10), .O(new_n104_));
  nand2  g052(.a(new_n96_), .b(new_n60_), .O(new_n105_));
  ...
  nand4  g056(.a(new_n108_), .b(x19), .c(new_n64_), .d(x10), .O(new_n109_));
  ...
  nand4  g061(.a(new_n113_), .b(x19), .c(new_n64_), .d(x10), .O(new_n114_));
  ...
  nand4  g065(.a(new_n117_), .b(x19), .c(new_n64_), .d(x10), .O(new_n118_));
  ...
  oai21  g070(.a(x24), .b(new_n54_), .c(new_n122_), .O(new_n123_));
  nand4  g071(.a(new_n123_), .b(x19), .c(new_n64_), .d(x10), .O(new_n124_));
