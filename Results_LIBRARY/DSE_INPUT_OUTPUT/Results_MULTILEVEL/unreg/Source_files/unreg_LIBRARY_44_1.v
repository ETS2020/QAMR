...
module FAU ( 
  ...
  aoi21  g030(.a(new_n82_), .b(new_n80_), .c(new_n55_), .O(z03));
  ...
  nand3  g055(.a(new_n54_), .b(new_n57_), .c(x11), .O(new_n108_));
  nor2   g056(.a(x34), .b(x29), .O(new_n109_));
  ...
  nand2  g061(.a(x34), .b(new_n53_), .O(new_n114_));
  nand3  g062(.a(new_n114_), .b(new_n113_), .c(new_n61_), .O(new_n115_));
  nand2  g063(.a(new_n115_), .b(new_n112_), .O(z08));
  nand3  g064(.a(new_n54_), .b(new_n57_), .c(x10), .O(new_n117_));
  inv1   g065(.a(x30), .O(new_n118_));
  nand3  g066(.a(new_n114_), .b(new_n118_), .c(x18), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand3  g068(.a(new_n120_), .b(x19), .c(new_n56_), .O(new_n121_));
  nand2  g069(.a(new_n109_), .b(new_n61_), .O(new_n122_));
  ...
  nand2  g074(.a(new_n118_), .b(new_n61_), .O(new_n127_));
  aoi21  g075(.a(new_n127_), .b(new_n126_), .c(new_n55_), .O(z10));
  ...
  aoi21  g090(.a(x29), .b(new_n57_), .c(new_n142_), .O(new_n143_));
  nand2  g091(.a(new_n142_), .b(x18), .O(new_n144_));
  oai21  g092(.a(new_n143_), .b(new_n141_), .c(new_n144_), .O(new_n145_));
  nand3  g093(.a(new_n145_), .b(x19), .c(new_n56_), .O(new_n146_));
  inv1   g094(.a(x33), .O(new_n147_));
  nand3  g095(.a(new_n54_), .b(new_n147_), .c(new_n61_), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n146_), .O(z13));
  nand2  g097(.a(new_n57_), .b(x13), .O(new_n150_));
  oai21  g098(.a(x35), .b(new_n57_), .c(new_n150_), .O(new_n151_));
  nand3  g099(.a(new_n151_), .b(x19), .c(new_n56_), .O(new_n152_));
  oai21  g100(.a(new_n142_), .b(new_n53_), .c(new_n61_), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(new_n152_), .c(new_n54_), .O(z14));
  nand2  g102(.a(new_n57_), .b(x12), .O(new_n155_));
  oai21  g103(.a(x28), .b(new_n57_), .c(new_n155_), .O(new_n156_));
  nand3  g104(.a(new_n156_), .b(x19), .c(new_n56_), .O(new_n157_));
  inv1   g105(.a(x35), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n61_), .O(new_n159_));
  aoi21  g107(.a(new_n159_), .b(new_n157_), .c(new_n55_), .O(z15));
endmodule
