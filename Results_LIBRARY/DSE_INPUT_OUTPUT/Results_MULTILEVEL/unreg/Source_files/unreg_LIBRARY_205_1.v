...
module FAU ( 
  ...
  nand4  g040(.a(new_n92_), .b(x19), .c(new_n90_), .d(x00), .O(new_n93_));
  nand2  g041(.a(new_n83_), .b(new_n60_), .O(new_n94_));
  ...
  nand4  g059(.a(new_n111_), .b(x19), .c(new_n90_), .d(x00), .O(new_n112_));
  ...
  nand2  g079(.a(new_n87_), .b(x18), .O(new_n132_));
  ...
  nand4  g086(.a(new_n138_), .b(x19), .c(new_n90_), .d(x00), .O(new_n139_));
  ...
  nand4  g092(.a(new_n144_), .b(x19), .c(new_n90_), .d(x00), .O(new_n145_));
  ...
  nand4  g098(.a(new_n150_), .b(x19), .c(new_n90_), .d(x00), .O(new_n151_));
