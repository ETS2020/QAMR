...
module FAU ( 
  ...
  nand4  g53(.a(new_n105_), .b(x19), .c(x18), .d(new_n66_), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n104_), .O(z10));
  nand2  g55(.a(new_n105_), .b(new_n55_), .O(new_n108_));
  nand4  g56(.a(new_n75_), .b(x19), .c(x18), .d(new_n66_), .O(new_n109_));
  ...
  nand2  g63(.a(new_n113_), .b(new_n55_), .O(new_n116_));
  ...
  nand2  g67(.a(new_n117_), .b(new_n55_), .O(new_n120_));
  inv1   g68(.a(x35), .O(new_n121_));
  nand4  g69(.a(new_n121_), .b(x19), .c(x18), .d(new_n66_), .O(new_n122_));
