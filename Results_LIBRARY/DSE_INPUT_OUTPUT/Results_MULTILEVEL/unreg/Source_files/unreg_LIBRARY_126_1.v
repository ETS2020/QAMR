...
module FAU ( 
  ...
  nand3  g066(.a(new_n82_), .b(new_n118_), .c(new_n60_), .O(new_n119_));
  ...
  nand3  g073(.a(new_n82_), .b(new_n114_), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g086(.a(new_n82_), .b(new_n129_), .c(new_n60_), .O(new_n139_));
  ...
  nand3  g094(.a(new_n82_), .b(new_n146_), .c(new_n60_), .O(new_n147_));
  ...
  nand3  g101(.a(new_n82_), .b(new_n142_), .c(new_n60_), .O(new_n154_));
