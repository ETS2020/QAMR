...
module FAU ( 
  ...
  nand4  g033(.a(new_n85_), .b(x33), .c(x19), .d(new_n53_), .O(new_n86_));
  ...
  nand4  g039(.a(new_n91_), .b(x33), .c(x19), .d(new_n53_), .O(new_n92_));
  ...
  nand4  g053(.a(new_n105_), .b(x33), .c(x19), .d(new_n53_), .O(new_n106_));
  ...
  nand4  g058(.a(new_n110_), .b(x33), .c(x19), .d(new_n53_), .O(new_n111_));
  ...
  nand4  g064(.a(new_n116_), .b(x33), .c(x19), .d(new_n53_), .O(new_n117_));
  ...
  nand2  g080(.a(new_n122_), .b(new_n58_), .O(new_n133_));
  ...
  nand4  g100(.a(new_n152_), .b(x33), .c(x19), .d(new_n53_), .O(new_n153_));
