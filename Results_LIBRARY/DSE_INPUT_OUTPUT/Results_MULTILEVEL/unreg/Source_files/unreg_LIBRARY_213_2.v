...
module FAU ( 
  ...
  nand4  g004(.a(new_n56_), .b(x27), .c(x19), .d(new_n53_), .O(new_n57_));
  ...
  nand4  g028(.a(new_n80_), .b(x27), .c(x19), .d(new_n53_), .O(new_n81_));
  ...
  nand4  g032(.a(new_n84_), .b(x27), .c(x19), .d(new_n53_), .O(new_n85_));
  ...
  aoi21  g045(.a(new_n97_), .b(x05), .c(new_n62_), .O(new_n98_));
  nand2  g046(.a(new_n90_), .b(new_n58_), .O(new_n99_));
  oai21  g047(.a(new_n98_), .b(new_n58_), .c(new_n99_), .O(z06));
  nand2  g048(.a(new_n54_), .b(x04), .O(new_n101_));
  oai21  g049(.a(x20), .b(new_n54_), .c(new_n101_), .O(new_n102_));
  nand4  g050(.a(new_n102_), .b(x27), .c(x19), .d(new_n53_), .O(new_n103_));
  nand2  g051(.a(new_n62_), .b(new_n58_), .O(new_n104_));
  ...
  oai21  g057(.a(new_n109_), .b(new_n62_), .c(x19), .O(new_n110_));
  ...
  oai21  g065(.a(new_n117_), .b(new_n62_), .c(x19), .O(new_n118_));
  ...
  nand4  g091(.a(new_n143_), .b(x27), .c(x19), .d(new_n53_), .O(new_n144_));
  ...
  oai21  g098(.a(new_n150_), .b(new_n62_), .c(x19), .O(new_n151_));
  ...
  oai21  g105(.a(new_n157_), .b(new_n62_), .c(x19), .O(new_n158_));
