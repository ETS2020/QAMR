...
module FAU ( 
  ...
  oai21  g009(.a(x29), .b(new_n61_), .c(new_n60_), .O(new_n62_));
  ...
  oai21  g016(.a(x29), .b(new_n56_), .c(new_n60_), .O(new_n69_));
  ...
  nand3  g030(.a(new_n76_), .b(new_n72_), .c(new_n60_), .O(new_n83_));
  ...
  oai21  g065(.a(x29), .b(new_n117_), .c(new_n60_), .O(new_n118_));
  ...
  oai21  g078(.a(new_n130_), .b(x29), .c(new_n60_), .O(new_n131_));
  ...
  nand3  g084(.a(new_n126_), .b(new_n76_), .c(new_n60_), .O(new_n137_));
  ...
  oai21  g092(.a(new_n144_), .b(x29), .c(new_n60_), .O(new_n145_));
  ...
  oai21  g099(.a(new_n140_), .b(x29), .c(new_n60_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n148_), .b(new_n76_), .c(new_n60_), .O(new_n159_));
