...
module FAU ( 
  ...
  nand4  g19(.a(x19), .b(new_n54_), .c(new_n53_), .d(x05), .O(new_n72_));
  oai21  g20(.a(x26), .b(x19), .c(new_n72_), .O(z06));
  aoi21  g21(.a(new_n53_), .b(x04), .c(x18), .O(new_n74_));
  inv1   g22(.a(x27), .O(new_n75_));
  nand2  g23(.a(new_n75_), .b(new_n63_), .O(new_n76_));
  oai21  g24(.a(new_n74_), .b(new_n63_), .c(new_n76_), .O(z07));
  ...
  oai21  g42(.a(new_n92_), .b(new_n63_), .c(new_n94_), .O(z13));
  aoi21  g43(.a(new_n53_), .b(x13), .c(x18), .O(new_n96_));
  inv1   g44(.a(x34), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n63_), .O(new_n98_));
  oai21  g46(.a(new_n96_), .b(new_n63_), .c(new_n98_), .O(z14));
