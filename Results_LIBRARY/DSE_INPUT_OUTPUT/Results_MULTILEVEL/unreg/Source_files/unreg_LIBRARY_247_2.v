...
module FAU ( 
  ...
  nand2  g070(.a(new_n114_), .b(new_n61_), .O(new_n123_));
  ...
  nand3  g079(.a(new_n124_), .b(new_n61_), .c(new_n60_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n128_), .b(x10), .c(new_n61_), .O(new_n138_));
  ...
  oai21  g100(.a(new_n141_), .b(x10), .c(new_n61_), .O(new_n153_));
