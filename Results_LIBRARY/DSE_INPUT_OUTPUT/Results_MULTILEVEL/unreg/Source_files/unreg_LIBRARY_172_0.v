...
module FAU ( 
  ...
  nand3  g009(.a(new_n61_), .b(new_n60_), .c(x06), .O(new_n62_));
  ...
  nand3  g016(.a(new_n56_), .b(new_n60_), .c(x06), .O(new_n69_));
  ...
  nand3  g030(.a(new_n72_), .b(new_n60_), .c(x06), .O(new_n83_));
  ...
  nand3  g038(.a(new_n90_), .b(new_n60_), .c(x06), .O(new_n91_));
  nand2  g039(.a(new_n91_), .b(new_n89_), .O(z04));
  nand3  g040(.a(x19), .b(new_n54_), .c(new_n53_), .O(new_n93_));
  nand2  g041(.a(new_n86_), .b(new_n60_), .O(new_n94_));
  nand2  g042(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g043(.a(new_n95_), .b(x06), .O(new_n96_));
  inv1   g044(.a(x26), .O(new_n97_));
  nand4  g045(.a(new_n97_), .b(x19), .c(x18), .d(new_n53_), .O(new_n98_));
  ...
  nand3  g052(.a(new_n97_), .b(new_n60_), .c(x06), .O(new_n105_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n60_), .c(x06), .O(new_n111_));
  ...
  nand3  g066(.a(new_n118_), .b(new_n60_), .c(x06), .O(new_n119_));
  ...
  nand3  g073(.a(new_n114_), .b(new_n60_), .c(x06), .O(new_n126_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n60_), .c(x06), .O(new_n139_));
  ...
  nand3  g094(.a(new_n146_), .b(new_n60_), .c(x06), .O(new_n147_));
  ...
  oai21  g101(.a(new_n142_), .b(new_n76_), .c(new_n60_), .O(new_n154_));
  ...
  nand3  g108(.a(new_n150_), .b(new_n60_), .c(x06), .O(new_n161_));
  ...
  nand3  g114(.a(new_n157_), .b(new_n60_), .c(x06), .O(new_n167_));
