...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x015), .O(z15));
  ...
  oai21  g227(.a(new_n383_), .b(new_n323_), .c(new_n159_), .O(z06));
  ...
  oai22  g242(.a(new_n388_), .b(new_n160_), .c(x120), .d(x096), .O(new_n400_));
  ...
  oai21  g259(.a(new_n416_), .b(new_n408_), .c(new_n177_), .O(new_n417_));
  ...
  oai21  g263(.a(new_n412_), .b(new_n168_), .c(new_n420_), .O(new_n421_));
  nand2  g264(.a(new_n421_), .b(new_n161_), .O(new_n422_));
  nand2  g265(.a(new_n410_), .b(new_n163_), .O(new_n423_));
  ...
  aoi21  g275(.a(new_n419_), .b(new_n171_), .c(new_n432_), .O(new_n433_));
  ...
  zero   g433(.O(z24));
  zero   g434(.O(z27));
  nor2   g435(.a(new_n157_), .b(x015), .O(z16));
  nor2   g436(.a(new_n157_), .b(x015), .O(z17));
  nor2   g437(.a(new_n157_), .b(x015), .O(z18));
  nor2   g438(.a(new_n157_), .b(x015), .O(z20));
  nor2   g439(.a(new_n157_), .b(x015), .O(z23));
  nor2   g440(.a(new_n157_), .b(x015), .O(z25));
  nor2   g441(.a(new_n157_), .b(x015), .O(z26));
endmodule
