// Benchmark "FAU" written by ABC on Tue Aug 18 02:19:18 2020
...
module FAU ( 
  ...
  wire new_n157_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n586_;
  inv1   g000(.a(x035), .O(new_n157_));
  nor2   g001(.a(x078), .b(new_n157_), .O(z18));
  ...
  nand3  g065(.a(new_n221_), .b(new_n157_), .c(new_n220_), .O(new_n222_));
  ...
  nand3  g071(.a(new_n221_), .b(x035), .c(new_n220_), .O(new_n228_));
  aoi21  g072(.a(new_n228_), .b(x075), .c(x011), .O(new_n229_));
  inv1   g073(.a(x051), .O(new_n230_));
  inv1   g074(.a(x075), .O(new_n231_));
  nand2  g075(.a(new_n231_), .b(new_n230_), .O(new_n232_));
  nand3  g076(.a(new_n232_), .b(new_n221_), .c(new_n220_), .O(new_n233_));
  nand3  g077(.a(new_n224_), .b(x051), .c(new_n223_), .O(new_n234_));
  aoi21  g078(.a(new_n234_), .b(new_n233_), .c(new_n157_), .O(new_n235_));
  oai21  g079(.a(new_n235_), .b(new_n229_), .c(x078), .O(new_n236_));
  nand2  g080(.a(new_n231_), .b(x011), .O(new_n237_));
  nand3  g081(.a(new_n237_), .b(new_n224_), .c(new_n223_), .O(new_n238_));
  inv1   g082(.a(x011), .O(new_n239_));
  aoi21  g083(.a(new_n231_), .b(new_n239_), .c(new_n230_), .O(new_n240_));
  nand2  g084(.a(new_n240_), .b(new_n238_), .O(new_n241_));
  nand2  g085(.a(new_n241_), .b(new_n157_), .O(new_n242_));
  nand3  g086(.a(new_n242_), .b(new_n236_), .c(new_n227_), .O(new_n243_));
  and2   g087(.a(new_n243_), .b(x043), .O(z03));
  ...
  nand2  g105(.a(new_n261_), .b(x044), .O(new_n262_));
  nand2  g106(.a(new_n262_), .b(new_n159_), .O(z04));
  ...
  nor3   g118(.a(new_n274_), .b(new_n273_), .c(x029), .O(new_n275_));
  oai21  g119(.a(new_n275_), .b(new_n272_), .c(x085), .O(new_n276_));
  ...
  aoi21  g127(.a(new_n283_), .b(x029), .c(new_n281_), .O(new_n284_));
  inv1   g128(.a(x101), .O(new_n285_));
  inv1   g129(.a(x125), .O(new_n286_));
  nor2   g130(.a(new_n286_), .b(new_n285_), .O(new_n287_));
  aoi21  g131(.a(new_n274_), .b(new_n272_), .c(new_n287_), .O(new_n288_));
  oai21  g132(.a(new_n288_), .b(new_n284_), .c(x069), .O(new_n289_));
  inv1   g133(.a(x109), .O(new_n290_));
  inv1   g134(.a(x117), .O(new_n291_));
  aoi21  g135(.a(new_n291_), .b(new_n290_), .c(x125), .O(new_n292_));
  nand3  g136(.a(new_n285_), .b(new_n273_), .c(x037), .O(new_n293_));
  ...
  oai21  g140(.a(x029), .b(new_n272_), .c(new_n283_), .O(new_n297_));
  nand2  g141(.a(new_n297_), .b(new_n273_), .O(new_n298_));
  inv1   g142(.a(x029), .O(new_n299_));
  inv1   g143(.a(new_n274_), .O(new_n300_));
  inv1   g144(.a(new_n287_), .O(new_n301_));
  inv1   g145(.a(x013), .O(new_n302_));
  oai21  g146(.a(new_n273_), .b(new_n302_), .c(new_n272_), .O(new_n303_));
  nand4  g147(.a(new_n303_), .b(new_n301_), .c(new_n300_), .d(new_n299_), .O(new_n304_));
  aoi21  g148(.a(new_n304_), .b(new_n298_), .c(new_n278_), .O(new_n305_));
  oai21  g149(.a(new_n305_), .b(new_n296_), .c(x077), .O(new_n306_));
  nand3  g150(.a(new_n266_), .b(new_n273_), .c(new_n272_), .O(new_n307_));
  nand3  g151(.a(new_n307_), .b(new_n306_), .c(new_n280_), .O(new_n308_));
  nand3  g152(.a(x085), .b(new_n299_), .c(x013), .O(new_n309_));
  oai21  g153(.a(new_n287_), .b(x005), .c(new_n309_), .O(new_n310_));
  nand2  g154(.a(new_n310_), .b(x069), .O(new_n311_));
  nand2  g155(.a(new_n297_), .b(x085), .O(new_n312_));
  aoi21  g156(.a(new_n312_), .b(new_n311_), .c(x037), .O(new_n313_));
  aoi22  g157(.a(new_n278_), .b(new_n267_), .c(new_n273_), .d(new_n272_), .O(new_n314_));
  nand2  g158(.a(x053), .b(new_n268_), .O(new_n315_));
  nand3  g159(.a(new_n315_), .b(new_n273_), .c(new_n272_), .O(new_n316_));
  oai21  g160(.a(new_n314_), .b(new_n302_), .c(new_n316_), .O(new_n317_));
  oai21  g161(.a(new_n317_), .b(new_n313_), .c(x077), .O(new_n318_));
  inv1   g162(.a(x053), .O(new_n319_));
  nand3  g163(.a(new_n315_), .b(new_n278_), .c(new_n267_), .O(new_n320_));
  nand2  g164(.a(new_n320_), .b(x013), .O(new_n321_));
  aoi22  g165(.a(new_n321_), .b(new_n266_), .c(new_n319_), .d(new_n268_), .O(new_n322_));
  nand2  g166(.a(new_n322_), .b(new_n318_), .O(new_n323_));
  aoi21  g167(.a(new_n308_), .b(x053), .c(new_n323_), .O(new_n324_));
  oai21  g168(.a(new_n324_), .b(new_n264_), .c(new_n159_), .O(z05));
  ...
  aoi21  g182(.a(new_n338_), .b(new_n333_), .c(new_n328_), .O(new_n339_));
  inv1   g183(.a(x086), .O(new_n340_));
  nor2   g184(.a(new_n340_), .b(x014), .O(new_n341_));
  oai21  g185(.a(new_n341_), .b(new_n339_), .c(new_n327_), .O(new_n342_));
  ...
  nor2   g196(.a(new_n352_), .b(x126), .O(new_n353_));
  nand3  g197(.a(new_n347_), .b(new_n335_), .c(x038), .O(new_n354_));
  nand2  g198(.a(new_n354_), .b(x086), .O(new_n355_));
  aoi21  g199(.a(new_n353_), .b(x022), .c(new_n355_), .O(new_n356_));
  aoi21  g200(.a(new_n356_), .b(new_n351_), .c(x006), .O(new_n357_));
  oai21  g201(.a(x030), .b(new_n334_), .c(new_n345_), .O(new_n358_));
  nand2  g202(.a(new_n358_), .b(new_n335_), .O(new_n359_));
  inv1   g203(.a(x030), .O(new_n360_));
  inv1   g204(.a(x062), .O(new_n361_));
  inv1   g205(.a(x094), .O(new_n362_));
  nand2  g206(.a(new_n362_), .b(new_n361_), .O(new_n363_));
  inv1   g207(.a(new_n349_), .O(new_n364_));
  inv1   g208(.a(x014), .O(new_n365_));
  oai21  g209(.a(new_n335_), .b(new_n365_), .c(new_n334_), .O(new_n366_));
  nand4  g210(.a(new_n366_), .b(new_n364_), .c(new_n363_), .d(new_n360_), .O(new_n367_));
  aoi21  g211(.a(new_n367_), .b(new_n359_), .c(new_n340_), .O(new_n368_));
  oai21  g212(.a(new_n368_), .b(new_n357_), .c(x078), .O(new_n369_));
  nand3  g213(.a(new_n328_), .b(new_n335_), .c(new_n334_), .O(new_n370_));
  nand3  g214(.a(new_n370_), .b(new_n369_), .c(new_n342_), .O(new_n371_));
  nand3  g215(.a(x086), .b(new_n360_), .c(x014), .O(new_n372_));
  oai21  g216(.a(new_n349_), .b(x006), .c(new_n372_), .O(new_n373_));
  nand2  g217(.a(new_n373_), .b(x070), .O(new_n374_));
  nand2  g218(.a(new_n358_), .b(x086), .O(new_n375_));
  aoi21  g219(.a(new_n375_), .b(new_n374_), .c(x038), .O(new_n376_));
  aoi22  g220(.a(new_n340_), .b(new_n329_), .c(new_n335_), .d(new_n334_), .O(new_n377_));
  nand2  g221(.a(x054), .b(new_n330_), .O(new_n378_));
  nand3  g222(.a(new_n378_), .b(new_n335_), .c(new_n334_), .O(new_n379_));
  oai21  g223(.a(new_n377_), .b(new_n365_), .c(new_n379_), .O(new_n380_));
  oai21  g224(.a(new_n380_), .b(new_n376_), .c(x078), .O(new_n381_));
  inv1   g225(.a(x054), .O(new_n382_));
  nand3  g226(.a(new_n378_), .b(new_n340_), .c(new_n329_), .O(new_n383_));
  nand2  g227(.a(new_n383_), .b(x014), .O(new_n384_));
  aoi22  g228(.a(new_n384_), .b(new_n328_), .c(new_n382_), .d(new_n330_), .O(new_n385_));
  nand2  g229(.a(new_n385_), .b(new_n381_), .O(new_n386_));
  aoi21  g230(.a(new_n371_), .b(x054), .c(new_n386_), .O(new_n387_));
  oai21  g231(.a(new_n387_), .b(new_n326_), .c(new_n159_), .O(z06));
  ...
  nand2  g289(.a(new_n446_), .b(new_n189_), .O(new_n447_));
  aoi22  g290(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n448_));
  nand3  g291(.a(new_n448_), .b(new_n447_), .c(new_n444_), .O(new_n449_));
  aoi21  g292(.a(new_n441_), .b(new_n188_), .c(new_n449_), .O(new_n450_));
  oai21  g293(.a(new_n450_), .b(x041), .c(new_n159_), .O(z09));
  ...
  oai21  g299(.a(new_n214_), .b(x034), .c(new_n456_), .O(new_n457_));
  ...
  aoi21  g305(.a(new_n454_), .b(new_n207_), .c(new_n462_), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(x042), .c(new_n159_), .O(z10));
  nand3  g307(.a(x067), .b(x035), .c(x019), .O(new_n465_));
  nand3  g308(.a(x083), .b(new_n157_), .c(x003), .O(new_n466_));
  nand2  g309(.a(new_n466_), .b(new_n465_), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n239_), .O(new_n468_));
  aoi22  g311(.a(x083), .b(x003), .c(x067), .d(x019), .O(new_n469_));
  nand2  g312(.a(x075), .b(new_n239_), .O(new_n470_));
  nand3  g313(.a(new_n470_), .b(x067), .c(x019), .O(new_n471_));
  oai21  g314(.a(new_n469_), .b(x051), .c(new_n471_), .O(new_n472_));
  nand2  g315(.a(new_n472_), .b(new_n157_), .O(new_n473_));
  nand3  g316(.a(new_n470_), .b(x083), .c(x003), .O(new_n474_));
  nand2  g317(.a(new_n474_), .b(new_n230_), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(x035), .O(new_n476_));
  nand2  g319(.a(x075), .b(x011), .O(new_n477_));
  nand4  g320(.a(new_n477_), .b(new_n476_), .c(new_n473_), .d(new_n468_), .O(new_n478_));
  inv1   g321(.a(new_n478_), .O(new_n479_));
  oai21  g322(.a(new_n479_), .b(x043), .c(new_n159_), .O(z11));
  nand2  g323(.a(x068), .b(x020), .O(new_n481_));
  nand3  g324(.a(x084), .b(new_n252_), .c(x004), .O(new_n482_));
  oai21  g325(.a(new_n481_), .b(new_n252_), .c(new_n482_), .O(new_n483_));
  nand3  g326(.a(x084), .b(x012), .c(x004), .O(new_n484_));
  oai21  g327(.a(new_n481_), .b(x012), .c(new_n484_), .O(new_n485_));
  oai21  g328(.a(new_n258_), .b(x036), .c(new_n485_), .O(new_n486_));
  nand2  g329(.a(x084), .b(x004), .O(new_n487_));
  aoi21  g330(.a(new_n487_), .b(new_n481_), .c(x076), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n252_), .O(new_n489_));
  aoi22  g332(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n490_));
  nand3  g333(.a(new_n490_), .b(new_n489_), .c(new_n486_), .O(new_n491_));
  aoi21  g334(.a(new_n483_), .b(new_n251_), .c(new_n491_), .O(new_n492_));
  oai21  g335(.a(new_n492_), .b(x044), .c(new_n159_), .O(z12));
  nand2  g336(.a(new_n291_), .b(new_n290_), .O(new_n494_));
  nand2  g337(.a(new_n273_), .b(new_n272_), .O(new_n495_));
  nand2  g338(.a(x069), .b(new_n268_), .O(new_n496_));
  aoi21  g339(.a(new_n496_), .b(new_n495_), .c(new_n267_), .O(new_n497_));
  nand3  g340(.a(new_n282_), .b(new_n273_), .c(x029), .O(new_n498_));
  aoi21  g341(.a(new_n498_), .b(new_n272_), .c(x085), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(new_n497_), .c(new_n266_), .O(new_n500_));
  oai21  g343(.a(x085), .b(new_n302_), .c(new_n500_), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n494_), .O(new_n502_));
  oai21  g345(.a(x037), .b(x013), .c(x021), .O(new_n503_));
  inv1   g346(.a(x061), .O(new_n504_));
  inv1   g347(.a(x093), .O(new_n505_));
  nand3  g348(.a(new_n505_), .b(new_n504_), .c(new_n299_), .O(new_n506_));
  nand2  g349(.a(new_n506_), .b(new_n503_), .O(new_n507_));
  oai22  g350(.a(new_n282_), .b(new_n272_), .c(x125), .d(x101), .O(new_n508_));
  nand2  g351(.a(new_n508_), .b(new_n507_), .O(new_n509_));
  nand2  g352(.a(new_n509_), .b(new_n273_), .O(new_n510_));
  nand3  g353(.a(new_n265_), .b(x125), .c(new_n272_), .O(new_n511_));
  nand3  g354(.a(x101), .b(x069), .c(new_n268_), .O(new_n512_));
  nand3  g355(.a(new_n512_), .b(new_n511_), .c(new_n278_), .O(new_n513_));
  inv1   g356(.a(new_n513_), .O(new_n514_));
  aoi21  g357(.a(new_n514_), .b(new_n510_), .c(new_n267_), .O(new_n515_));
  oai21  g358(.a(new_n299_), .b(x021), .c(new_n274_), .O(new_n516_));
  nand2  g359(.a(new_n516_), .b(x069), .O(new_n517_));
  nand2  g360(.a(new_n286_), .b(new_n285_), .O(new_n518_));
  oai21  g361(.a(x069), .b(x013), .c(x021), .O(new_n519_));
  nand4  g362(.a(new_n519_), .b(new_n518_), .c(new_n282_), .d(x029), .O(new_n520_));
  aoi21  g363(.a(new_n520_), .b(new_n517_), .c(x085), .O(new_n521_));
  oai21  g364(.a(new_n521_), .b(new_n515_), .c(new_n266_), .O(new_n522_));
  nand3  g365(.a(x077), .b(x069), .c(x021), .O(new_n523_));
  nand3  g366(.a(new_n523_), .b(new_n522_), .c(new_n502_), .O(new_n524_));
  nand2  g367(.a(new_n518_), .b(x005), .O(new_n525_));
  nand3  g368(.a(new_n278_), .b(x029), .c(new_n302_), .O(new_n526_));
  nand2  g369(.a(new_n526_), .b(new_n525_), .O(new_n527_));
  nand2  g370(.a(new_n527_), .b(new_n273_), .O(new_n528_));
  nand2  g371(.a(new_n516_), .b(new_n278_), .O(new_n529_));
  aoi21  g372(.a(new_n529_), .b(new_n528_), .c(new_n268_), .O(new_n530_));
  oai21  g373(.a(new_n278_), .b(new_n267_), .c(new_n269_), .O(new_n531_));
  nand2  g374(.a(new_n531_), .b(new_n302_), .O(new_n532_));
  nand2  g375(.a(new_n319_), .b(x037), .O(new_n533_));
  nand3  g376(.a(new_n533_), .b(x069), .c(x021), .O(new_n534_));
  nand2  g377(.a(new_n534_), .b(new_n532_), .O(new_n535_));
  oai21  g378(.a(new_n535_), .b(new_n530_), .c(new_n266_), .O(new_n536_));
  nand3  g379(.a(new_n533_), .b(x085), .c(x005), .O(new_n537_));
  nand2  g380(.a(new_n537_), .b(new_n302_), .O(new_n538_));
  aoi22  g381(.a(new_n538_), .b(x077), .c(x053), .d(x037), .O(new_n539_));
  nand2  g382(.a(new_n539_), .b(new_n536_), .O(new_n540_));
  aoi21  g383(.a(new_n524_), .b(new_n319_), .c(new_n540_), .O(new_n541_));
  nor3   g384(.a(new_n541_), .b(z18), .c(x045), .O(z13));
  nand2  g385(.a(new_n335_), .b(new_n334_), .O(new_n543_));
  nand2  g386(.a(x070), .b(new_n330_), .O(new_n544_));
  aoi21  g387(.a(new_n544_), .b(new_n543_), .c(new_n329_), .O(new_n545_));
  nand3  g388(.a(new_n344_), .b(new_n335_), .c(x030), .O(new_n546_));
  aoi21  g389(.a(new_n546_), .b(new_n334_), .c(x086), .O(new_n547_));
  oai21  g390(.a(new_n547_), .b(new_n545_), .c(new_n328_), .O(new_n548_));
  oai21  g391(.a(x086), .b(new_n365_), .c(new_n548_), .O(new_n549_));
  oai21  g392(.a(x118), .b(x110), .c(new_n549_), .O(new_n550_));
  oai21  g393(.a(x038), .b(x014), .c(x022), .O(new_n551_));
  oai21  g394(.a(new_n363_), .b(x030), .c(new_n551_), .O(new_n552_));
  nand2  g395(.a(new_n348_), .b(new_n347_), .O(new_n553_));
  oai21  g396(.a(new_n344_), .b(new_n334_), .c(new_n553_), .O(new_n554_));
  nand2  g397(.a(new_n554_), .b(new_n552_), .O(new_n555_));
  nand2  g398(.a(new_n555_), .b(new_n335_), .O(new_n556_));
  nand3  g399(.a(new_n327_), .b(x126), .c(new_n334_), .O(new_n557_));
  nand3  g400(.a(x102), .b(x070), .c(new_n330_), .O(new_n558_));
  nand3  g401(.a(new_n558_), .b(new_n557_), .c(new_n340_), .O(new_n559_));
  inv1   g402(.a(new_n559_), .O(new_n560_));
  aoi21  g403(.a(new_n560_), .b(new_n556_), .c(new_n329_), .O(new_n561_));
  oai21  g404(.a(new_n360_), .b(x022), .c(new_n336_), .O(new_n562_));
  nand2  g405(.a(new_n562_), .b(x070), .O(new_n563_));
  oai21  g406(.a(x070), .b(x014), .c(x022), .O(new_n564_));
  nand4  g407(.a(new_n564_), .b(new_n553_), .c(new_n344_), .d(x030), .O(new_n565_));
  aoi21  g408(.a(new_n565_), .b(new_n563_), .c(x086), .O(new_n566_));
  oai21  g409(.a(new_n566_), .b(new_n561_), .c(new_n328_), .O(new_n567_));
  nand3  g410(.a(x078), .b(x070), .c(x022), .O(new_n568_));
  nand3  g411(.a(new_n568_), .b(new_n567_), .c(new_n550_), .O(new_n569_));
  nand2  g412(.a(new_n553_), .b(x006), .O(new_n570_));
  nand3  g413(.a(new_n340_), .b(x030), .c(new_n365_), .O(new_n571_));
  nand2  g414(.a(new_n571_), .b(new_n570_), .O(new_n572_));
  nand2  g415(.a(new_n572_), .b(new_n335_), .O(new_n573_));
  nand2  g416(.a(new_n562_), .b(new_n340_), .O(new_n574_));
  aoi21  g417(.a(new_n574_), .b(new_n573_), .c(new_n330_), .O(new_n575_));
  oai21  g418(.a(new_n340_), .b(new_n329_), .c(new_n331_), .O(new_n576_));
  nand2  g419(.a(new_n576_), .b(new_n365_), .O(new_n577_));
  nand2  g420(.a(new_n382_), .b(x038), .O(new_n578_));
  nand3  g421(.a(new_n578_), .b(x070), .c(x022), .O(new_n579_));
  nand2  g422(.a(new_n579_), .b(new_n577_), .O(new_n580_));
  oai21  g423(.a(new_n580_), .b(new_n575_), .c(new_n328_), .O(new_n581_));
  nand3  g424(.a(new_n578_), .b(x086), .c(x006), .O(new_n582_));
  nand2  g425(.a(new_n582_), .b(new_n365_), .O(new_n583_));
  aoi22  g426(.a(new_n583_), .b(x078), .c(x054), .d(x038), .O(new_n584_));
  nand2  g427(.a(new_n584_), .b(new_n581_), .O(new_n585_));
  aoi21  g428(.a(new_n569_), .b(new_n382_), .c(new_n585_), .O(new_n586_));
  oai21  g429(.a(new_n586_), .b(x046), .c(new_n159_), .O(z14));
  zero   g430(.O(z07));
  zero   g431(.O(z15));
  zero   g432(.O(z16));
  zero   g433(.O(z17));
  ...
  zero   g435(.O(z22));
  zero   g436(.O(z25));
  nor2   g437(.a(x078), .b(new_n157_), .O(z19));
  nor2   g438(.a(x078), .b(new_n157_), .O(z20));
  nor2   g439(.a(x078), .b(new_n157_), .O(z23));
  nor2   g440(.a(x078), .b(new_n157_), .O(z24));
  nor2   g441(.a(x078), .b(new_n157_), .O(z26));
  nor2   g442(.a(x078), .b(new_n157_), .O(z27));
endmodule
