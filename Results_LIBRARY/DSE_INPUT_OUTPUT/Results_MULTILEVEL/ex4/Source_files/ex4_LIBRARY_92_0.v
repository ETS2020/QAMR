...
module FAU ( 
  ...
  nand2  g379(.a(new_n362_), .b(x038), .O(new_n537_));
  nand3  g380(.a(new_n537_), .b(x086), .c(x006), .O(new_n538_));
  aoi21  g381(.a(x054), .b(x038), .c(x014), .O(new_n539_));
  nand3  g382(.a(x070), .b(new_n362_), .c(x022), .O(new_n540_));
  nand3  g383(.a(new_n540_), .b(new_n539_), .c(x078), .O(new_n541_));
  inv1   g384(.a(new_n541_), .O(new_n542_));
  aoi21  g385(.a(new_n542_), .b(new_n538_), .c(x046), .O(z14));
  zero   g386(.O(z07));
  zero   g387(.O(z16));
  zero   g388(.O(z17));
  zero   g389(.O(z20));
