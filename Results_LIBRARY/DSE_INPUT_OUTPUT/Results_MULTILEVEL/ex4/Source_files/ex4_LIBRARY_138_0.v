// Benchmark "FAU" written by ABC on Tue Aug 18 02:18:58 2020
...
module FAU ( 
  ...
  nand3  g286(.a(new_n442_), .b(new_n179_), .c(new_n430_), .O(new_n443_));
  ...
  oai21  g300(.a(new_n456_), .b(x042), .c(new_n179_), .O(z10));
  ...
  nand3  g314(.a(new_n470_), .b(new_n179_), .c(new_n458_), .O(new_n471_));
  ...
  inv1   g378(.a(x046), .O(new_n535_));
  nand2  g379(.a(new_n361_), .b(x038), .O(new_n536_));
  nand3  g380(.a(new_n536_), .b(x086), .c(x006), .O(new_n537_));
  nand2  g381(.a(x054), .b(x038), .O(new_n538_));
  nand3  g382(.a(x070), .b(new_n361_), .c(x022), .O(new_n539_));
  nand4  g383(.a(new_n539_), .b(new_n538_), .c(new_n537_), .d(new_n333_), .O(new_n540_));
  nand3  g384(.a(new_n540_), .b(x078), .c(new_n535_), .O(new_n541_));
  inv1   g385(.a(new_n541_), .O(z14));
  zero   g386(.O(z16));
  zero   g387(.O(z18));
  zero   g388(.O(z19));
  zero   g389(.O(z20));
  zero   g390(.O(z22));
  zero   g391(.O(z25));
  nor2   g392(.a(x078), .b(x046), .O(z15));
  nor2   g393(.a(x078), .b(x046), .O(z17));
  nor2   g394(.a(x078), .b(x046), .O(z21));
  nor2   g395(.a(x078), .b(x046), .O(z23));
  nor2   g396(.a(x078), .b(x046), .O(z24));
  nor2   g397(.a(x078), .b(x046), .O(z26));
  nor2   g398(.a(x078), .b(x046), .O(z27));
endmodule
