...
module FAU ( 
  ...
  aoi21  g250(.a(new_n407_), .b(new_n401_), .c(x074), .O(new_n408_));
  nand2  g251(.a(new_n408_), .b(new_n209_), .O(new_n409_));
  aoi22  g252(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n410_));
  nand3  g253(.a(new_n410_), .b(new_n409_), .c(new_n406_), .O(new_n411_));
  aoi21  g254(.a(new_n403_), .b(new_n208_), .c(new_n411_), .O(new_n412_));
  oai21  g255(.a(new_n412_), .b(x042), .c(new_n181_), .O(z10));
  ...
  nand3  g269(.a(new_n426_), .b(new_n181_), .c(new_n414_), .O(new_n427_));
  ...
  oai21  g283(.a(new_n440_), .b(x044), .c(new_n181_), .O(z12));
