...
module FAU ( 
  ...
  oai22  g246(.a(new_n391_), .b(new_n161_), .c(x120), .d(x096), .O(new_n403_));
  ...
  oai21  g263(.a(new_n419_), .b(new_n411_), .c(new_n178_), .O(new_n420_));
  ...
  oai21  g267(.a(new_n415_), .b(new_n169_), .c(new_n423_), .O(new_n424_));
  nand2  g268(.a(new_n424_), .b(new_n162_), .O(new_n425_));
  nand2  g269(.a(new_n413_), .b(new_n164_), .O(new_n426_));
  ...
  aoi21  g279(.a(new_n422_), .b(new_n172_), .c(new_n435_), .O(new_n436_));
  ...
  nand3  g322(.a(new_n478_), .b(new_n160_), .c(new_n466_), .O(new_n479_));
  ...
  nand3  g337(.a(new_n493_), .b(new_n160_), .c(new_n481_), .O(new_n494_));
  ...
  oai21  g392(.a(new_n548_), .b(new_n546_), .c(new_n157_), .O(new_n549_));
  ...
  oai21  g413(.a(new_n569_), .b(new_n563_), .c(new_n157_), .O(new_n570_));
  ...
  oai21  g427(.a(new_n583_), .b(new_n578_), .c(new_n157_), .O(new_n584_));
  ...
  oai21  g433(.a(new_n589_), .b(x046), .c(new_n160_), .O(z14));
  zero   g434(.O(z17));
  zero   g435(.O(z18));
  zero   g436(.O(z20));
  zero   g437(.O(z21));
  ...
  nor2   g446(.a(new_n158_), .b(new_n157_), .O(z27));
endmodule
