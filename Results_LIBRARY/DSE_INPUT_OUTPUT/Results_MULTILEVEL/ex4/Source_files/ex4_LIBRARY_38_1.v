...
module FAU ( 
  ...
  nand2  g223(.a(x064), .b(new_n176_), .O(new_n380_));
  aoi21  g224(.a(new_n380_), .b(new_n162_), .c(new_n168_), .O(new_n381_));
  nand2  g225(.a(x088), .b(x056), .O(new_n382_));
  nand3  g226(.a(new_n382_), .b(new_n161_), .c(x024), .O(new_n383_));
  aoi21  g227(.a(new_n383_), .b(new_n160_), .c(x080), .O(new_n384_));
  oai21  g228(.a(new_n384_), .b(new_n381_), .c(new_n177_), .O(new_n385_));
  ...
  oai21  g239(.a(new_n382_), .b(new_n160_), .c(new_n395_), .O(new_n396_));
  ...
  oai21  g253(.a(new_n409_), .b(new_n404_), .c(new_n177_), .O(new_n410_));
  ...
  nand3  g257(.a(new_n163_), .b(x024), .c(new_n167_), .O(new_n414_));
  nand2  g258(.a(new_n414_), .b(new_n413_), .O(new_n415_));
  nand2  g259(.a(new_n415_), .b(new_n161_), .O(new_n416_));
  nand2  g260(.a(new_n405_), .b(new_n163_), .O(new_n417_));
  aoi21  g261(.a(new_n417_), .b(new_n416_), .c(new_n176_), .O(new_n418_));
  aoi22  g262(.a(x080), .b(x000), .c(x064), .d(x016), .O(new_n419_));
  nand3  g263(.a(new_n172_), .b(x064), .c(x016), .O(new_n420_));
  oai21  g264(.a(new_n419_), .b(x008), .c(new_n420_), .O(new_n421_));
  oai21  g265(.a(new_n421_), .b(new_n418_), .c(new_n177_), .O(new_n422_));
  nand3  g266(.a(new_n172_), .b(x080), .c(x000), .O(new_n423_));
  nand2  g267(.a(new_n423_), .b(new_n167_), .O(new_n424_));
  aoi22  g268(.a(new_n424_), .b(x072), .c(x048), .d(x032), .O(new_n425_));
  nand2  g269(.a(new_n425_), .b(new_n422_), .O(new_n426_));
  aoi21  g270(.a(new_n412_), .b(new_n171_), .c(new_n426_), .O(new_n427_));
  oai21  g271(.a(new_n427_), .b(x040), .c(new_n159_), .O(z08));
  ...
  oai21  g284(.a(new_n440_), .b(x041), .c(new_n159_), .O(z09));
  ...
  oai21  g374(.a(new_n530_), .b(x045), .c(new_n159_), .O(z13));
  ...
  zero   g421(.O(z26));
  zero   g422(.O(z27));
  nor2   g423(.a(new_n157_), .b(x046), .O(z17));
