...
module FAU ( 
  ...
  nor3   g227(.a(new_n383_), .b(z15), .c(new_n320_), .O(z06));
  ...
  nand3  g307(.a(x083), .b(new_n226_), .c(x003), .O(new_n465_));
  oai21  g308(.a(new_n464_), .b(new_n226_), .c(new_n465_), .O(new_n466_));
  nand2  g309(.a(new_n466_), .b(new_n225_), .O(new_n467_));
  nand3  g310(.a(x083), .b(x011), .c(x003), .O(new_n468_));
  oai21  g311(.a(new_n464_), .b(x011), .c(new_n468_), .O(new_n469_));
  oai21  g312(.a(new_n232_), .b(x035), .c(new_n469_), .O(new_n470_));
  nand2  g313(.a(x083), .b(x003), .O(new_n471_));
  aoi21  g314(.a(new_n471_), .b(new_n464_), .c(x075), .O(new_n472_));
  oai22  g315(.a(new_n233_), .b(new_n226_), .c(new_n232_), .d(new_n225_), .O(new_n473_));
  aoi21  g316(.a(new_n472_), .b(new_n226_), .c(new_n473_), .O(new_n474_));
  nand3  g317(.a(new_n474_), .b(new_n470_), .c(new_n467_), .O(new_n475_));
  nand3  g318(.a(new_n475_), .b(new_n158_), .c(new_n463_), .O(new_n476_));
  inv1   g319(.a(new_n476_), .O(z11));
  nand2  g320(.a(x068), .b(x020), .O(new_n478_));
  nand3  g321(.a(x084), .b(new_n245_), .c(x004), .O(new_n479_));
  oai21  g322(.a(new_n478_), .b(new_n245_), .c(new_n479_), .O(new_n480_));
  ...
  oai21  g377(.a(new_n534_), .b(x045), .c(new_n158_), .O(z13));
  ...
  zero   g434(.O(z26));
  zero   g435(.O(z27));
  nor2   g436(.a(x122), .b(x099), .O(z20));
  nor2   g437(.a(x122), .b(x099), .O(z21));
  nor2   g438(.a(x122), .b(x099), .O(z22));
  nor2   g439(.a(x122), .b(x099), .O(z24));
endmodule
