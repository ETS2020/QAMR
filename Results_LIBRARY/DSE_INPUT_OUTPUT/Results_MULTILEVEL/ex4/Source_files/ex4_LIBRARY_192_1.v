...
module FAU ( 
  ...
  aoi21  g394(.a(x030), .b(new_n329_), .c(new_n355_), .O(new_n551_));
  oai21  g395(.a(x070), .b(x014), .c(x022), .O(new_n552_));
  nand4  g396(.a(new_n552_), .b(new_n544_), .c(new_n339_), .d(x030), .O(new_n553_));
  oai21  g397(.a(new_n551_), .b(new_n330_), .c(new_n553_), .O(new_n554_));
  nand2  g398(.a(new_n554_), .b(new_n335_), .O(new_n555_));
  ...
  nand2  g404(.a(new_n560_), .b(new_n330_), .O(new_n561_));
  inv1   g405(.a(new_n551_), .O(new_n562_));
  nand2  g406(.a(new_n562_), .b(new_n335_), .O(new_n563_));
  nand3  g407(.a(new_n563_), .b(new_n561_), .c(new_n534_), .O(new_n564_));
  oai21  g408(.a(new_n335_), .b(new_n324_), .c(new_n326_), .O(new_n565_));
  ...
  nand3  g412(.a(new_n568_), .b(new_n566_), .c(new_n178_), .O(new_n569_));
