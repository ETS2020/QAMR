...
module FAU ( 
  ...
  nor3   g220(.a(new_n376_), .b(z07), .c(new_n314_), .O(z06));
  ...
  nand2  g360(.a(new_n343_), .b(new_n337_), .O(new_n517_));
  nand2  g361(.a(x070), .b(new_n318_), .O(new_n518_));
  aoi21  g362(.a(new_n518_), .b(new_n517_), .c(new_n317_), .O(new_n519_));
  nand2  g363(.a(x094), .b(x062), .O(new_n520_));
  nand3  g364(.a(new_n520_), .b(new_n343_), .c(x030), .O(new_n521_));
  aoi21  g365(.a(new_n521_), .b(new_n337_), .c(x086), .O(new_n522_));
  oai21  g366(.a(new_n522_), .b(new_n519_), .c(new_n316_), .O(new_n523_));
  oai21  g367(.a(x086), .b(new_n353_), .c(new_n523_), .O(new_n524_));
  oai21  g368(.a(x118), .b(x110), .c(new_n524_), .O(new_n525_));
  oai21  g369(.a(x038), .b(x014), .c(x022), .O(new_n526_));
  oai21  g370(.a(new_n325_), .b(x030), .c(new_n526_), .O(new_n527_));
  inv1   g371(.a(x126), .O(new_n528_));
  nand2  g372(.a(new_n528_), .b(new_n344_), .O(new_n529_));
  oai21  g373(.a(new_n520_), .b(new_n337_), .c(new_n529_), .O(new_n530_));
  nand2  g374(.a(new_n530_), .b(new_n527_), .O(new_n531_));
  nand2  g375(.a(new_n531_), .b(new_n343_), .O(new_n532_));
  nand3  g376(.a(new_n315_), .b(x126), .c(new_n337_), .O(new_n533_));
  nand3  g377(.a(x102), .b(x070), .c(new_n318_), .O(new_n534_));
  nand3  g378(.a(new_n534_), .b(new_n533_), .c(new_n330_), .O(new_n535_));
  inv1   g379(.a(new_n535_), .O(new_n536_));
  aoi21  g380(.a(new_n536_), .b(new_n532_), .c(new_n317_), .O(new_n537_));
  oai21  g381(.a(new_n322_), .b(x022), .c(new_n338_), .O(new_n538_));
  nand2  g382(.a(new_n538_), .b(x070), .O(new_n539_));
  oai21  g383(.a(x070), .b(x014), .c(x022), .O(new_n540_));
  nand4  g384(.a(new_n540_), .b(new_n529_), .c(new_n520_), .d(x030), .O(new_n541_));
  aoi21  g385(.a(new_n541_), .b(new_n539_), .c(x086), .O(new_n542_));
  oai21  g386(.a(new_n542_), .b(new_n537_), .c(new_n316_), .O(new_n543_));
  nand3  g387(.a(x078), .b(x070), .c(x022), .O(new_n544_));
  nand3  g388(.a(new_n544_), .b(new_n543_), .c(new_n525_), .O(new_n545_));
  nand2  g389(.a(new_n529_), .b(x006), .O(new_n546_));
  nand3  g390(.a(new_n330_), .b(x030), .c(new_n353_), .O(new_n547_));
  nand2  g391(.a(new_n547_), .b(new_n546_), .O(new_n548_));
  nand2  g392(.a(new_n548_), .b(new_n343_), .O(new_n549_));
  nand2  g393(.a(new_n538_), .b(new_n330_), .O(new_n550_));
  aoi21  g394(.a(new_n550_), .b(new_n549_), .c(new_n318_), .O(new_n551_));
  oai21  g395(.a(new_n330_), .b(new_n317_), .c(new_n319_), .O(new_n552_));
  nand2  g396(.a(new_n552_), .b(new_n353_), .O(new_n553_));
  nand2  g397(.a(new_n371_), .b(x038), .O(new_n554_));
  nand3  g398(.a(new_n554_), .b(x070), .c(x022), .O(new_n555_));
  nand2  g399(.a(new_n555_), .b(new_n553_), .O(new_n556_));
  oai21  g400(.a(new_n556_), .b(new_n551_), .c(new_n316_), .O(new_n557_));
  nand3  g401(.a(new_n554_), .b(x086), .c(x006), .O(new_n558_));
  nand2  g402(.a(new_n558_), .b(new_n353_), .O(new_n559_));
  aoi22  g403(.a(new_n559_), .b(x078), .c(x054), .d(x038), .O(new_n560_));
  nand2  g404(.a(new_n560_), .b(new_n557_), .O(new_n561_));
  aoi21  g405(.a(new_n545_), .b(new_n371_), .c(new_n561_), .O(new_n562_));
  oai21  g406(.a(new_n562_), .b(x046), .c(new_n159_), .O(z14));
  zero   g407(.O(z15));
  zero   g408(.O(z17));
  zero   g409(.O(z21));
  zero   g410(.O(z24));
  zero   g411(.O(z26));
  zero   g412(.O(z27));
  nor2   g413(.a(new_n157_), .b(x045), .O(z16));
  nor2   g414(.a(new_n157_), .b(x045), .O(z18));
  nor2   g415(.a(new_n157_), .b(x045), .O(z19));
  nor2   g416(.a(new_n157_), .b(x045), .O(z20));
  nor2   g417(.a(new_n157_), .b(x045), .O(z22));
  nor2   g418(.a(new_n157_), .b(x045), .O(z23));
  nor2   g419(.a(new_n157_), .b(x045), .O(z25));
endmodule
