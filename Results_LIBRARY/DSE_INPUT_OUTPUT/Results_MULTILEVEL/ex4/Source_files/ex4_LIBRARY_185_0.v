...
module FAU ( 
  ...
  oai22  g318(.a(new_n233_), .b(new_n226_), .c(new_n232_), .d(new_n225_), .O(new_n476_));
  aoi21  g319(.a(new_n475_), .b(new_n226_), .c(new_n476_), .O(new_n477_));
  ...
  nand2  g331(.a(new_n488_), .b(new_n245_), .O(new_n489_));
  aoi22  g332(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n490_));
  nand3  g333(.a(new_n490_), .b(new_n489_), .c(new_n486_), .O(new_n491_));
  aoi21  g334(.a(new_n483_), .b(new_n244_), .c(new_n491_), .O(new_n492_));
  oai21  g335(.a(new_n492_), .b(x044), .c(new_n158_), .O(z12));
