// Benchmark "FAU" written by ABC on Tue Aug 18 02:18:34 2020
...
module FAU ( 
  ...
  nand3  g144(.a(new_n259_), .b(new_n266_), .c(new_n265_), .O(new_n301_));
  ...
  aoi22  g159(.a(new_n315_), .b(new_n259_), .c(new_n313_), .d(new_n261_), .O(new_n316_));
  nand2  g160(.a(new_n316_), .b(new_n312_), .O(new_n317_));
  aoi21  g161(.a(new_n302_), .b(x053), .c(new_n317_), .O(new_n318_));
  oai21  g162(.a(new_n318_), .b(new_n257_), .c(new_n158_), .O(z05));
  ...
  oai21  g225(.a(new_n381_), .b(new_n320_), .c(new_n158_), .O(z06));
  nand2  g226(.a(x064), .b(new_n175_), .O(new_n384_));
  aoi21  g227(.a(new_n384_), .b(new_n161_), .c(new_n167_), .O(new_n385_));
  nand2  g228(.a(x088), .b(x056), .O(new_n386_));
  nand3  g229(.a(new_n386_), .b(new_n160_), .c(x024), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n159_), .c(x080), .O(new_n388_));
  oai21  g231(.a(new_n388_), .b(new_n385_), .c(new_n176_), .O(new_n389_));
  nand2  g232(.a(new_n389_), .b(new_n163_), .O(new_n390_));
  ...
  oai22  g239(.a(new_n386_), .b(new_n159_), .c(x120), .d(x096), .O(new_n397_));
  ...
  oai21  g248(.a(new_n393_), .b(x016), .c(new_n394_), .O(new_n406_));
  nand2  g249(.a(new_n406_), .b(x064), .O(new_n407_));
  or2    g250(.a(x120), .b(x096), .O(new_n408_));
  oai21  g251(.a(x064), .b(x008), .c(x016), .O(new_n409_));
  nand4  g252(.a(new_n409_), .b(new_n408_), .c(new_n386_), .d(x024), .O(new_n410_));
  aoi21  g253(.a(new_n410_), .b(new_n407_), .c(x080), .O(new_n411_));
  oai21  g254(.a(new_n411_), .b(new_n405_), .c(new_n176_), .O(new_n412_));
  nand3  g255(.a(x072), .b(x064), .c(x016), .O(new_n413_));
  nand3  g256(.a(new_n413_), .b(new_n412_), .c(new_n391_), .O(new_n414_));
  nand2  g257(.a(new_n408_), .b(x000), .O(new_n415_));
  nand3  g258(.a(new_n162_), .b(x024), .c(new_n166_), .O(new_n416_));
  nand2  g259(.a(new_n416_), .b(new_n415_), .O(new_n417_));
  nand2  g260(.a(new_n417_), .b(new_n160_), .O(new_n418_));
  nand2  g261(.a(new_n406_), .b(new_n162_), .O(new_n419_));
  aoi21  g262(.a(new_n419_), .b(new_n418_), .c(new_n175_), .O(new_n420_));
  aoi22  g263(.a(x080), .b(x000), .c(x064), .d(x016), .O(new_n421_));
  nand3  g264(.a(new_n171_), .b(x064), .c(x016), .O(new_n422_));
  oai21  g265(.a(new_n421_), .b(x008), .c(new_n422_), .O(new_n423_));
  oai21  g266(.a(new_n423_), .b(new_n420_), .c(new_n176_), .O(new_n424_));
  nand3  g267(.a(new_n171_), .b(x080), .c(x000), .O(new_n425_));
  nand2  g268(.a(new_n425_), .b(new_n166_), .O(new_n426_));
  aoi22  g269(.a(new_n426_), .b(x072), .c(x048), .d(x032), .O(new_n427_));
  nand2  g270(.a(new_n427_), .b(new_n424_), .O(new_n428_));
  aoi21  g271(.a(new_n414_), .b(new_n170_), .c(new_n428_), .O(new_n429_));
  oai21  g272(.a(new_n429_), .b(x040), .c(new_n158_), .O(z08));
  nand2  g273(.a(x065), .b(x017), .O(new_n431_));
  nand3  g274(.a(x081), .b(new_n188_), .c(x001), .O(new_n432_));
  oai21  g275(.a(new_n431_), .b(new_n188_), .c(new_n432_), .O(new_n433_));
  nand3  g276(.a(x081), .b(x009), .c(x001), .O(new_n434_));
  oai21  g277(.a(new_n431_), .b(x009), .c(new_n434_), .O(new_n435_));
  oai21  g278(.a(new_n194_), .b(x033), .c(new_n435_), .O(new_n436_));
  nand2  g279(.a(x081), .b(x001), .O(new_n437_));
  aoi21  g280(.a(new_n437_), .b(new_n431_), .c(x073), .O(new_n438_));
  nand2  g281(.a(new_n438_), .b(new_n188_), .O(new_n439_));
  aoi22  g282(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n440_));
  nand3  g283(.a(new_n440_), .b(new_n439_), .c(new_n436_), .O(new_n441_));
  aoi21  g284(.a(new_n433_), .b(new_n187_), .c(new_n441_), .O(new_n442_));
  oai21  g285(.a(new_n442_), .b(x041), .c(new_n158_), .O(z09));
  nand2  g286(.a(x066), .b(x018), .O(new_n444_));
  nand3  g287(.a(x082), .b(new_n207_), .c(x002), .O(new_n445_));
  oai21  g288(.a(new_n444_), .b(new_n207_), .c(new_n445_), .O(new_n446_));
  nand3  g289(.a(x082), .b(x010), .c(x002), .O(new_n447_));
  oai21  g290(.a(new_n444_), .b(x010), .c(new_n447_), .O(new_n448_));
  oai21  g291(.a(new_n213_), .b(x034), .c(new_n448_), .O(new_n449_));
  ...
  aoi21  g297(.a(new_n446_), .b(new_n206_), .c(new_n454_), .O(new_n455_));
  oai21  g298(.a(new_n455_), .b(x042), .c(new_n158_), .O(z10));
  nand2  g299(.a(x067), .b(x019), .O(new_n457_));
  nand3  g300(.a(x083), .b(new_n226_), .c(x003), .O(new_n458_));
  oai21  g301(.a(new_n457_), .b(new_n226_), .c(new_n458_), .O(new_n459_));
  nand3  g302(.a(x083), .b(x011), .c(x003), .O(new_n460_));
  oai21  g303(.a(new_n457_), .b(x011), .c(new_n460_), .O(new_n461_));
  oai21  g304(.a(new_n232_), .b(x035), .c(new_n461_), .O(new_n462_));
  nand2  g305(.a(x083), .b(x003), .O(new_n463_));
  aoi21  g306(.a(new_n463_), .b(new_n457_), .c(x075), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(new_n226_), .O(new_n465_));
  aoi22  g308(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(new_n465_), .c(new_n462_), .O(new_n467_));
  aoi21  g310(.a(new_n459_), .b(new_n225_), .c(new_n467_), .O(new_n468_));
  oai21  g311(.a(new_n468_), .b(x043), .c(new_n158_), .O(z11));
  inv1   g312(.a(x044), .O(new_n470_));
  nand2  g313(.a(x068), .b(x020), .O(new_n471_));
  nand3  g314(.a(x084), .b(new_n245_), .c(x004), .O(new_n472_));
  oai21  g315(.a(new_n471_), .b(new_n245_), .c(new_n472_), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n244_), .O(new_n474_));
  nand3  g317(.a(x084), .b(x012), .c(x004), .O(new_n475_));
  oai21  g318(.a(new_n471_), .b(x012), .c(new_n475_), .O(new_n476_));
  oai21  g319(.a(new_n251_), .b(x036), .c(new_n476_), .O(new_n477_));
  nand2  g320(.a(x084), .b(x004), .O(new_n478_));
  aoi21  g321(.a(new_n478_), .b(new_n471_), .c(x076), .O(new_n479_));
  oai22  g322(.a(new_n252_), .b(new_n245_), .c(new_n251_), .d(new_n244_), .O(new_n480_));
  aoi21  g323(.a(new_n479_), .b(new_n245_), .c(new_n480_), .O(new_n481_));
  nand3  g324(.a(new_n481_), .b(new_n477_), .c(new_n474_), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(new_n158_), .c(new_n470_), .O(new_n483_));
  inv1   g326(.a(new_n483_), .O(z12));
  nand2  g327(.a(new_n266_), .b(new_n265_), .O(new_n485_));
  nand2  g328(.a(x069), .b(new_n261_), .O(new_n486_));
  aoi21  g329(.a(new_n486_), .b(new_n485_), .c(new_n260_), .O(new_n487_));
  nand3  g330(.a(new_n275_), .b(new_n266_), .c(x029), .O(new_n488_));
  aoi21  g331(.a(new_n488_), .b(new_n265_), .c(x085), .O(new_n489_));
  oai21  g332(.a(new_n489_), .b(new_n487_), .c(new_n259_), .O(new_n490_));
  ...
  oai21  g336(.a(new_n294_), .b(x029), .c(new_n493_), .O(new_n494_));
  nand2  g337(.a(new_n279_), .b(new_n278_), .O(new_n495_));
  oai21  g338(.a(new_n275_), .b(new_n265_), .c(new_n495_), .O(new_n496_));
  nand2  g339(.a(new_n496_), .b(new_n494_), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(new_n266_), .O(new_n498_));
  nand3  g341(.a(new_n258_), .b(x125), .c(new_n265_), .O(new_n499_));
  nand3  g342(.a(x101), .b(x069), .c(new_n261_), .O(new_n500_));
  nand3  g343(.a(new_n500_), .b(new_n499_), .c(new_n271_), .O(new_n501_));
  inv1   g344(.a(new_n501_), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n498_), .c(new_n260_), .O(new_n503_));
  oai21  g346(.a(new_n291_), .b(x021), .c(new_n267_), .O(new_n504_));
  nand2  g347(.a(new_n504_), .b(x069), .O(new_n505_));
  oai21  g348(.a(x069), .b(x013), .c(x021), .O(new_n506_));
  nand4  g349(.a(new_n506_), .b(new_n495_), .c(new_n275_), .d(x029), .O(new_n507_));
  aoi21  g350(.a(new_n507_), .b(new_n505_), .c(x085), .O(new_n508_));
  oai21  g351(.a(new_n508_), .b(new_n503_), .c(new_n259_), .O(new_n509_));
  nand3  g352(.a(x077), .b(x069), .c(x021), .O(new_n510_));
  nand3  g353(.a(new_n510_), .b(new_n509_), .c(new_n492_), .O(new_n511_));
  nand2  g354(.a(new_n495_), .b(x005), .O(new_n512_));
  nand3  g355(.a(new_n271_), .b(x029), .c(new_n296_), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n512_), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n266_), .O(new_n515_));
  nand2  g358(.a(new_n504_), .b(new_n271_), .O(new_n516_));
  aoi21  g359(.a(new_n516_), .b(new_n515_), .c(new_n261_), .O(new_n517_));
  oai21  g360(.a(new_n271_), .b(new_n260_), .c(new_n262_), .O(new_n518_));
  nand2  g361(.a(new_n518_), .b(new_n296_), .O(new_n519_));
  nand2  g362(.a(new_n313_), .b(x037), .O(new_n520_));
  nand3  g363(.a(new_n520_), .b(x069), .c(x021), .O(new_n521_));
  nand2  g364(.a(new_n521_), .b(new_n519_), .O(new_n522_));
  oai21  g365(.a(new_n522_), .b(new_n517_), .c(new_n259_), .O(new_n523_));
  nand3  g366(.a(new_n520_), .b(x085), .c(x005), .O(new_n524_));
  nand2  g367(.a(new_n524_), .b(new_n296_), .O(new_n525_));
  aoi22  g368(.a(new_n525_), .b(x077), .c(x053), .d(x037), .O(new_n526_));
  nand2  g369(.a(new_n526_), .b(new_n523_), .O(new_n527_));
  aoi21  g370(.a(new_n511_), .b(new_n313_), .c(new_n527_), .O(new_n528_));
  oai21  g371(.a(new_n528_), .b(x045), .c(new_n158_), .O(z13));
  nand2  g372(.a(new_n329_), .b(new_n328_), .O(new_n530_));
  nand2  g373(.a(x070), .b(new_n324_), .O(new_n531_));
  aoi21  g374(.a(new_n531_), .b(new_n530_), .c(new_n323_), .O(new_n532_));
  nand3  g375(.a(new_n338_), .b(new_n329_), .c(x030), .O(new_n533_));
  aoi21  g376(.a(new_n533_), .b(new_n328_), .c(x086), .O(new_n534_));
  oai21  g377(.a(new_n534_), .b(new_n532_), .c(new_n322_), .O(new_n535_));
  nand2  g378(.a(new_n334_), .b(x014), .O(new_n536_));
  aoi21  g379(.a(new_n536_), .b(new_n535_), .c(new_n346_), .O(new_n537_));
  oai21  g380(.a(x038), .b(x014), .c(x022), .O(new_n538_));
  nand3  g381(.a(new_n356_), .b(new_n355_), .c(new_n354_), .O(new_n539_));
  nand2  g382(.a(new_n539_), .b(new_n538_), .O(new_n540_));
  oai22  g383(.a(new_n338_), .b(new_n328_), .c(x126), .d(x102), .O(new_n541_));
  aoi21  g384(.a(new_n541_), .b(new_n540_), .c(x070), .O(new_n542_));
  nand3  g385(.a(new_n321_), .b(x126), .c(new_n328_), .O(new_n543_));
  nand3  g386(.a(x102), .b(x070), .c(new_n324_), .O(new_n544_));
  nand3  g387(.a(new_n544_), .b(new_n543_), .c(new_n334_), .O(new_n545_));
  oai21  g388(.a(new_n545_), .b(new_n542_), .c(x006), .O(new_n546_));
  aoi21  g389(.a(x030), .b(new_n328_), .c(new_n357_), .O(new_n547_));
  nand2  g390(.a(new_n342_), .b(new_n341_), .O(new_n548_));
  oai21  g391(.a(x070), .b(x014), .c(x022), .O(new_n549_));
  nand4  g392(.a(new_n549_), .b(new_n548_), .c(new_n338_), .d(x030), .O(new_n550_));
  oai21  g393(.a(new_n547_), .b(new_n329_), .c(new_n550_), .O(new_n551_));
  nand2  g394(.a(new_n551_), .b(new_n334_), .O(new_n552_));
  aoi21  g395(.a(new_n552_), .b(new_n546_), .c(x078), .O(new_n553_));
  oai21  g396(.a(new_n553_), .b(new_n537_), .c(new_n376_), .O(new_n554_));
  nand2  g397(.a(new_n548_), .b(x006), .O(new_n555_));
  nand3  g398(.a(new_n334_), .b(x030), .c(new_n359_), .O(new_n556_));
  aoi21  g399(.a(new_n556_), .b(new_n555_), .c(x070), .O(new_n557_));
  nor2   g400(.a(new_n547_), .b(x086), .O(new_n558_));
  oai21  g401(.a(new_n558_), .b(new_n557_), .c(x038), .O(new_n559_));
  nand2  g402(.a(x086), .b(x006), .O(new_n560_));
  aoi21  g403(.a(new_n560_), .b(new_n325_), .c(x014), .O(new_n561_));
  aoi21  g404(.a(new_n376_), .b(x038), .c(new_n329_), .O(new_n562_));
  aoi21  g405(.a(new_n562_), .b(x022), .c(new_n561_), .O(new_n563_));
  nand2  g406(.a(new_n563_), .b(new_n559_), .O(new_n564_));
  nor2   g407(.a(new_n376_), .b(new_n324_), .O(new_n565_));
  aoi21  g408(.a(new_n564_), .b(new_n322_), .c(new_n565_), .O(new_n566_));
  nand2  g409(.a(new_n566_), .b(new_n554_), .O(new_n567_));
  nand2  g410(.a(new_n567_), .b(x087), .O(new_n568_));
  inv1   g411(.a(new_n565_), .O(new_n569_));
  nand2  g412(.a(new_n376_), .b(x038), .O(new_n570_));
  nand3  g413(.a(new_n570_), .b(x086), .c(x006), .O(new_n571_));
  nand3  g414(.a(x070), .b(new_n376_), .c(x022), .O(new_n572_));
  nand4  g415(.a(new_n572_), .b(new_n571_), .c(new_n569_), .d(new_n359_), .O(new_n573_));
  nand2  g416(.a(new_n573_), .b(x078), .O(new_n574_));
  aoi21  g417(.a(new_n574_), .b(new_n568_), .c(x046), .O(z14));
  zero   g418(.O(z07));
  zero   g419(.O(z16));
  zero   g420(.O(z20));
  zero   g421(.O(z21));
  ...
  zero   g423(.O(z24));
  zero   g424(.O(z26));
  nor2   g425(.a(x087), .b(x078), .O(z17));
  nor2   g426(.a(x087), .b(x078), .O(z18));
  nor2   g427(.a(x087), .b(x078), .O(z19));
  nor2   g428(.a(x087), .b(x078), .O(z22));
  nor2   g429(.a(x087), .b(x078), .O(z25));
  nor2   g430(.a(x087), .b(x078), .O(z27));
endmodule
