...
module FAU ( 
  ...
  nand3  g316(.a(new_n472_), .b(new_n179_), .c(new_n460_), .O(new_n473_));
  ...
  nand2  g378(.a(new_n361_), .b(x038), .O(new_n535_));
  nand3  g379(.a(new_n535_), .b(x086), .c(x006), .O(new_n536_));
  aoi21  g380(.a(x054), .b(x038), .c(x014), .O(new_n537_));
  nand3  g381(.a(x070), .b(new_n361_), .c(x022), .O(new_n538_));
  nand3  g382(.a(new_n538_), .b(new_n537_), .c(x078), .O(new_n539_));
  inv1   g383(.a(new_n539_), .O(new_n540_));
  aoi21  g384(.a(new_n540_), .b(new_n536_), .c(x046), .O(z14));
  zero   g385(.O(z15));
  zero   g386(.O(z17));
  zero   g387(.O(z19));
  zero   g388(.O(z20));
