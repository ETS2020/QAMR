...
module FAU ( 
  ...
  nand3  g308(.a(new_n464_), .b(new_n181_), .c(new_n452_), .O(new_n465_));
  ...
  oai21  g322(.a(new_n478_), .b(x043), .c(new_n181_), .O(z11));
  ...
  nand2  g338(.a(new_n288_), .b(new_n282_), .O(new_n495_));
  ...
  oai21  g364(.a(new_n520_), .b(new_n515_), .c(new_n261_), .O(new_n521_));
  ...
  nand3  g368(.a(new_n275_), .b(x029), .c(new_n298_), .O(new_n525_));
  nand2  g369(.a(new_n525_), .b(new_n524_), .O(new_n526_));
  nand2  g370(.a(new_n526_), .b(new_n288_), .O(new_n527_));
  nand2  g371(.a(new_n516_), .b(new_n275_), .O(new_n528_));
  aoi21  g372(.a(new_n528_), .b(new_n527_), .c(new_n263_), .O(new_n529_));
  oai21  g373(.a(new_n275_), .b(new_n262_), .c(new_n264_), .O(new_n530_));
  ...
  zero   g437(.O(z24));
  zero   g438(.O(z26));
  nor2   g439(.a(new_n179_), .b(new_n178_), .O(z18));
  nor2   g440(.a(new_n179_), .b(new_n178_), .O(z20));
  nor2   g441(.a(new_n179_), .b(new_n178_), .O(z21));
  nor2   g442(.a(new_n179_), .b(new_n178_), .O(z25));
