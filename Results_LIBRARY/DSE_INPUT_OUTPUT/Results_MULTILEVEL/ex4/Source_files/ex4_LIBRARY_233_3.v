// Benchmark "FAU" written by ABC on Tue Aug 18 02:20:03 2020
...
module FAU ( 
  ...
  oai21  g241(.a(new_n385_), .b(new_n157_), .c(new_n398_), .O(new_n399_));
  ...
  oai21  g255(.a(new_n412_), .b(new_n407_), .c(new_n174_), .O(new_n413_));
  ...
  nand2  g262(.a(new_n408_), .b(new_n160_), .O(new_n420_));
  ...
  oai21  g273(.a(new_n430_), .b(x040), .c(new_n181_), .O(z08));
  ...
  oai21  g286(.a(new_n443_), .b(x041), .c(new_n181_), .O(z09));
  inv1   g287(.a(x042), .O(new_n445_));
  nand2  g288(.a(x066), .b(x018), .O(new_n446_));
  nand3  g289(.a(x082), .b(new_n209_), .c(x002), .O(new_n447_));
  oai21  g290(.a(new_n446_), .b(new_n209_), .c(new_n447_), .O(new_n448_));
  ...
  oai22  g297(.a(new_n216_), .b(new_n209_), .c(new_n215_), .d(new_n208_), .O(new_n455_));
  aoi21  g298(.a(new_n454_), .b(new_n209_), .c(new_n455_), .O(new_n456_));
  nand3  g299(.a(new_n456_), .b(new_n452_), .c(new_n449_), .O(new_n457_));
  nand3  g300(.a(new_n457_), .b(new_n181_), .c(new_n445_), .O(new_n458_));
  inv1   g301(.a(new_n458_), .O(z10));
  inv1   g302(.a(x043), .O(new_n460_));
  nand2  g303(.a(x067), .b(x019), .O(new_n461_));
  nand3  g304(.a(x083), .b(new_n228_), .c(x003), .O(new_n462_));
  oai21  g305(.a(new_n461_), .b(new_n228_), .c(new_n462_), .O(new_n463_));
  ...
  oai21  g309(.a(new_n234_), .b(x035), .c(new_n466_), .O(new_n467_));
  nand2  g310(.a(x083), .b(x003), .O(new_n468_));
  aoi21  g311(.a(new_n468_), .b(new_n461_), .c(x075), .O(new_n469_));
  oai22  g312(.a(new_n235_), .b(new_n228_), .c(new_n234_), .d(new_n227_), .O(new_n470_));
  aoi21  g313(.a(new_n469_), .b(new_n228_), .c(new_n470_), .O(new_n471_));
  nand3  g314(.a(new_n471_), .b(new_n467_), .c(new_n464_), .O(new_n472_));
  nand3  g315(.a(new_n472_), .b(new_n181_), .c(new_n460_), .O(new_n473_));
  inv1   g316(.a(new_n473_), .O(z11));
  nand2  g317(.a(x068), .b(x020), .O(new_n475_));
  nand3  g318(.a(x084), .b(new_n247_), .c(x004), .O(new_n476_));
  oai21  g319(.a(new_n475_), .b(new_n247_), .c(new_n476_), .O(new_n477_));
  ...
  aoi21  g328(.a(new_n477_), .b(new_n246_), .c(new_n485_), .O(new_n486_));
  ...
  oai21  g387(.a(new_n356_), .b(x030), .c(new_n544_), .O(new_n545_));
  nand2  g388(.a(new_n342_), .b(new_n341_), .O(new_n546_));
  oai21  g389(.a(new_n338_), .b(new_n328_), .c(new_n546_), .O(new_n547_));
  aoi21  g390(.a(new_n547_), .b(new_n545_), .c(x070), .O(new_n548_));
  nand3  g391(.a(new_n322_), .b(x126), .c(new_n328_), .O(new_n549_));
  ...
  nand4  g398(.a(new_n555_), .b(new_n546_), .c(new_n338_), .d(x030), .O(new_n556_));
  inv1   g399(.a(new_n556_), .O(new_n557_));
  oai21  g400(.a(new_n557_), .b(new_n554_), .c(new_n334_), .O(new_n558_));
  nand3  g401(.a(new_n558_), .b(new_n552_), .c(new_n543_), .O(new_n559_));
  nand2  g402(.a(new_n559_), .b(new_n375_), .O(new_n560_));
  nand2  g403(.a(new_n546_), .b(x006), .O(new_n561_));
  nand3  g404(.a(new_n334_), .b(x030), .c(new_n358_), .O(new_n562_));
  aoi21  g405(.a(new_n562_), .b(new_n561_), .c(x070), .O(new_n563_));
  nand2  g406(.a(new_n553_), .b(new_n334_), .O(new_n564_));
  nand2  g407(.a(new_n564_), .b(new_n375_), .O(new_n565_));
  oai21  g408(.a(new_n565_), .b(new_n563_), .c(x038), .O(new_n566_));
  oai21  g409(.a(new_n334_), .b(new_n323_), .c(new_n325_), .O(new_n567_));
  nand2  g410(.a(new_n567_), .b(new_n358_), .O(new_n568_));
  nand2  g411(.a(new_n375_), .b(x038), .O(new_n569_));
  nand3  g412(.a(new_n569_), .b(x070), .c(x022), .O(new_n570_));
  nand4  g413(.a(new_n570_), .b(new_n568_), .c(new_n566_), .d(new_n560_), .O(new_n571_));
  nand2  g414(.a(new_n571_), .b(new_n178_), .O(new_n572_));
  nand3  g415(.a(new_n569_), .b(x086), .c(x006), .O(new_n573_));
  nand3  g416(.a(x070), .b(new_n375_), .c(x022), .O(new_n574_));
  nand3  g417(.a(new_n574_), .b(new_n573_), .c(new_n358_), .O(new_n575_));
  nand2  g418(.a(new_n575_), .b(x078), .O(new_n576_));
  oai21  g419(.a(new_n375_), .b(new_n324_), .c(new_n576_), .O(new_n577_));
  nand2  g420(.a(new_n577_), .b(new_n179_), .O(new_n578_));
  ...
  nor2   g430(.a(new_n179_), .b(new_n178_), .O(z18));
  nor2   g431(.a(new_n179_), .b(new_n178_), .O(z20));
  nor2   g432(.a(new_n179_), .b(new_n178_), .O(z21));
  nor2   g433(.a(new_n179_), .b(new_n178_), .O(z23));
