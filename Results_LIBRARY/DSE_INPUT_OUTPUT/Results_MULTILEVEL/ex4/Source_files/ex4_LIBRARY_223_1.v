...
module FAU ( 
  ...
  nand3  g205(.a(new_n157_), .b(new_n328_), .c(new_n327_), .O(new_n362_));
  ...
  aoi22  g220(.a(new_n376_), .b(new_n157_), .c(new_n374_), .d(new_n323_), .O(new_n377_));
  nand2  g221(.a(new_n377_), .b(new_n373_), .O(new_n378_));
  aoi21  g222(.a(new_n363_), .b(x054), .c(new_n378_), .O(new_n379_));
  oai21  g223(.a(new_n379_), .b(new_n320_), .c(new_n159_), .O(z06));
  ...
  nor3   g379(.a(new_n535_), .b(x078), .c(x045), .O(z13));
  ...
  nand2  g415(.a(new_n571_), .b(new_n157_), .O(new_n572_));
  ...
  nand2  g421(.a(new_n577_), .b(x045), .O(new_n578_));
  ...
  zero   g428(.O(z26));
  zero   g429(.O(z27));
  nor2   g430(.a(new_n157_), .b(x045), .O(z15));
  nor2   g431(.a(new_n157_), .b(x045), .O(z20));
  nor2   g432(.a(new_n157_), .b(x045), .O(z21));
  nor2   g433(.a(new_n157_), .b(x045), .O(z22));
  nor2   g434(.a(new_n157_), .b(x045), .O(z23));
  nor2   g435(.a(new_n157_), .b(x045), .O(z24));
endmodule
