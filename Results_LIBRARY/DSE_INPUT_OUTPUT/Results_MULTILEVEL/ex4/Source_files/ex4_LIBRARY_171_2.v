...
module FAU ( 
  ...
  oai21  g229(.a(new_n373_), .b(new_n160_), .c(new_n386_), .O(new_n387_));
  nand2  g230(.a(new_n387_), .b(new_n383_), .O(new_n388_));
  ...
  oai21  g238(.a(new_n380_), .b(x016), .c(new_n381_), .O(new_n396_));
  nand2  g239(.a(new_n396_), .b(x064), .O(new_n397_));
  oai21  g240(.a(x064), .b(x008), .c(x016), .O(new_n398_));
  nand4  g241(.a(new_n398_), .b(new_n386_), .c(new_n373_), .d(x024), .O(new_n399_));
  aoi21  g242(.a(new_n399_), .b(new_n397_), .c(x080), .O(new_n400_));
  oai21  g243(.a(new_n400_), .b(new_n395_), .c(new_n177_), .O(new_n401_));
  nand3  g244(.a(x072), .b(x064), .c(x016), .O(new_n402_));
  nand3  g245(.a(new_n402_), .b(new_n401_), .c(new_n378_), .O(new_n403_));
  nand2  g246(.a(new_n386_), .b(x000), .O(new_n404_));
  ...
  nand2  g250(.a(new_n396_), .b(new_n163_), .O(new_n408_));
  ...
  oai21  g261(.a(new_n418_), .b(x040), .c(new_n159_), .O(z08));
  ...
  nand3  g276(.a(x082), .b(new_n208_), .c(x002), .O(new_n434_));
  oai21  g277(.a(new_n433_), .b(new_n208_), .c(new_n434_), .O(new_n435_));
  ...
  nand2  g283(.a(new_n440_), .b(new_n208_), .O(new_n441_));
  aoi22  g284(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n442_));
  nand3  g285(.a(new_n442_), .b(new_n441_), .c(new_n438_), .O(new_n443_));
  aoi21  g286(.a(new_n435_), .b(new_n207_), .c(new_n443_), .O(new_n444_));
  oai21  g287(.a(new_n444_), .b(x042), .c(new_n159_), .O(z10));
  ...
  nand3  g301(.a(new_n458_), .b(new_n159_), .c(new_n446_), .O(new_n459_));
  ...
  zero   g414(.O(z22));
  zero   g415(.O(z26));
  nor2   g416(.a(x078), .b(new_n157_), .O(z20));
