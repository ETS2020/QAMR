...
module FAU ( 
  ...
  inv1   g239(.a(x042), .O(new_n396_));
  nand2  g240(.a(x066), .b(x018), .O(new_n397_));
  nand3  g241(.a(x082), .b(new_n209_), .c(x002), .O(new_n398_));
  oai21  g242(.a(new_n397_), .b(new_n209_), .c(new_n398_), .O(new_n399_));
  nand2  g243(.a(new_n399_), .b(new_n208_), .O(new_n400_));
  nand3  g244(.a(x082), .b(x010), .c(x002), .O(new_n401_));
  oai21  g245(.a(new_n397_), .b(x010), .c(new_n401_), .O(new_n402_));
  oai21  g246(.a(new_n215_), .b(x034), .c(new_n402_), .O(new_n403_));
  nand2  g247(.a(x082), .b(x002), .O(new_n404_));
  aoi21  g248(.a(new_n404_), .b(new_n397_), .c(x074), .O(new_n405_));
  oai22  g249(.a(new_n216_), .b(new_n209_), .c(new_n215_), .d(new_n208_), .O(new_n406_));
  aoi21  g250(.a(new_n405_), .b(new_n209_), .c(new_n406_), .O(new_n407_));
  nand3  g251(.a(new_n407_), .b(new_n403_), .c(new_n400_), .O(new_n408_));
  nand3  g252(.a(new_n408_), .b(new_n181_), .c(new_n396_), .O(new_n409_));
