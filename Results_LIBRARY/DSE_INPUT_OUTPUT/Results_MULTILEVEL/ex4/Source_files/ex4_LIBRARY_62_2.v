...
module FAU ( 
  ...
  nand2  g372(.a(x070), .b(new_n336_), .O(new_n530_));
  aoi21  g373(.a(new_n530_), .b(new_n364_), .c(new_n335_), .O(new_n531_));
  nand3  g374(.a(new_n338_), .b(new_n322_), .c(x030), .O(new_n532_));
  nor2   g375(.a(x022), .b(x014), .O(new_n533_));
  aoi21  g376(.a(new_n533_), .b(new_n532_), .c(x086), .O(new_n534_));
  oai21  g377(.a(new_n534_), .b(new_n531_), .c(new_n344_), .O(new_n535_));
  oai21  g378(.a(x038), .b(x014), .c(x022), .O(new_n536_));
  oai21  g379(.a(new_n328_), .b(x030), .c(new_n536_), .O(new_n537_));
  inv1   g380(.a(x102), .O(new_n538_));
  nand2  g381(.a(new_n343_), .b(new_n538_), .O(new_n539_));
  oai21  g382(.a(new_n338_), .b(new_n331_), .c(new_n539_), .O(new_n540_));
  aoi21  g383(.a(new_n540_), .b(new_n537_), .c(x070), .O(new_n541_));
  nand3  g384(.a(new_n320_), .b(x126), .c(new_n331_), .O(new_n542_));
  nand3  g385(.a(x102), .b(x070), .c(new_n336_), .O(new_n543_));
  nand3  g386(.a(new_n543_), .b(new_n542_), .c(new_n325_), .O(new_n544_));
  oai21  g387(.a(new_n544_), .b(new_n541_), .c(x006), .O(new_n545_));
  oai21  g388(.a(new_n326_), .b(x022), .c(new_n327_), .O(new_n546_));
  and2   g389(.a(new_n546_), .b(x070), .O(new_n547_));
  oai21  g390(.a(x070), .b(x014), .c(x022), .O(new_n548_));
  nand4  g391(.a(new_n548_), .b(new_n539_), .c(new_n338_), .d(x030), .O(new_n549_));
  inv1   g392(.a(new_n549_), .O(new_n550_));
  oai21  g393(.a(new_n550_), .b(new_n547_), .c(new_n325_), .O(new_n551_));
  nand3  g394(.a(new_n551_), .b(new_n545_), .c(new_n535_), .O(new_n552_));
  nand2  g395(.a(new_n539_), .b(x006), .O(new_n553_));
  nand3  g396(.a(new_n325_), .b(x030), .c(new_n330_), .O(new_n554_));
  aoi21  g397(.a(new_n554_), .b(new_n553_), .c(x070), .O(new_n555_));
  nand2  g398(.a(new_n546_), .b(new_n325_), .O(new_n556_));
  nand2  g399(.a(new_n556_), .b(new_n529_), .O(new_n557_));
  oai21  g400(.a(new_n557_), .b(new_n555_), .c(x038), .O(new_n558_));
  oai21  g401(.a(new_n325_), .b(new_n335_), .c(new_n321_), .O(new_n559_));
  ...
  nand3  g409(.a(new_n566_), .b(new_n565_), .c(new_n330_), .O(new_n567_));
  ...
  nor2   g418(.a(x078), .b(new_n178_), .O(z17));
  ...
  nor2   g423(.a(x078), .b(new_n178_), .O(z26));
