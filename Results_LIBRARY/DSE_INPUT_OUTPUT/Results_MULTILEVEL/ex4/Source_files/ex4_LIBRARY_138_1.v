...
module FAU ( 
  ...
  nand3  g377(.a(new_n340_), .b(new_n324_), .c(x030), .O(new_n534_));
  ...
  nand3  g387(.a(new_n322_), .b(x126), .c(new_n333_), .O(new_n544_));
  nand3  g388(.a(x102), .b(x070), .c(new_n338_), .O(new_n545_));
  nand3  g389(.a(new_n545_), .b(new_n544_), .c(new_n327_), .O(new_n546_));
  oai21  g390(.a(new_n546_), .b(new_n543_), .c(x006), .O(new_n547_));
  oai21  g391(.a(new_n328_), .b(x022), .c(new_n329_), .O(new_n548_));
  and2   g392(.a(new_n548_), .b(x070), .O(new_n549_));
  oai21  g393(.a(x070), .b(x014), .c(x022), .O(new_n550_));
  nand4  g394(.a(new_n550_), .b(new_n541_), .c(new_n340_), .d(x030), .O(new_n551_));
  inv1   g395(.a(new_n551_), .O(new_n552_));
  oai21  g396(.a(new_n552_), .b(new_n549_), .c(new_n327_), .O(new_n553_));
  nand3  g397(.a(new_n553_), .b(new_n547_), .c(new_n537_), .O(new_n554_));
  nand2  g398(.a(new_n541_), .b(x006), .O(new_n555_));
  nand3  g399(.a(new_n327_), .b(x030), .c(new_n332_), .O(new_n556_));
  aoi21  g400(.a(new_n556_), .b(new_n555_), .c(x070), .O(new_n557_));
  nand2  g401(.a(new_n548_), .b(new_n327_), .O(new_n558_));
  nand2  g402(.a(new_n558_), .b(new_n371_), .O(new_n559_));
  ...
  aoi21  g406(.a(new_n371_), .b(x038), .c(new_n324_), .O(new_n563_));
  aoi21  g407(.a(new_n563_), .b(x022), .c(new_n562_), .O(new_n564_));
  nand2  g408(.a(new_n564_), .b(new_n560_), .O(new_n565_));
  aoi21  g409(.a(new_n554_), .b(new_n371_), .c(new_n565_), .O(new_n566_));
  ...
  zero   g415(.O(z22));
  zero   g416(.O(z25));
  nor2   g417(.a(new_n178_), .b(x046), .O(z15));
  nor2   g418(.a(new_n178_), .b(x046), .O(z17));
  nor2   g419(.a(new_n178_), .b(x046), .O(z21));
