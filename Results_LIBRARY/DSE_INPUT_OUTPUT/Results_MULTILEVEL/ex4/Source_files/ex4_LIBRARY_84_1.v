...
module FAU ( 
  ...
  oai22  g240(.a(new_n387_), .b(new_n160_), .c(x120), .d(x096), .O(new_n398_));
  ...
  oai21  g255(.a(new_n412_), .b(new_n406_), .c(new_n177_), .O(new_n413_));
  ...
  nand2  g411(.a(new_n568_), .b(new_n157_), .O(new_n569_));
  ...
  zero   g424(.O(z24));
  zero   g425(.O(z26));
  nor2   g426(.a(new_n157_), .b(x078), .O(z17));
  nor2   g427(.a(new_n157_), .b(x078), .O(z18));
  nor2   g428(.a(new_n157_), .b(x078), .O(z19));
  nor2   g429(.a(new_n157_), .b(x078), .O(z22));
