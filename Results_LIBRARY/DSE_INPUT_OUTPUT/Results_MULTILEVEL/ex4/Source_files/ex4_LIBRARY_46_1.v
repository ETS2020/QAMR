...
module FAU ( 
  ...
  nor2   g022(.a(new_n178_), .b(x092), .O(z17));
  ...
  nor3   g424(.a(new_n581_), .b(z17), .c(x046), .O(z14));
  zero   g425(.O(z07));
  zero   g426(.O(z15));
  zero   g427(.O(z16));
  zero   g428(.O(z20));
  ...
  zero   g432(.O(z24));
  zero   g433(.O(z27));
  nor2   g434(.a(new_n178_), .b(x092), .O(z18));
  nor2   g435(.a(new_n178_), .b(x092), .O(z19));
  nor2   g436(.a(new_n178_), .b(x092), .O(z25));
  nor2   g437(.a(new_n178_), .b(x092), .O(z26));
endmodule
