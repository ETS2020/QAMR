...
module FAU ( 
  ...
  nand2  g378(.a(new_n325_), .b(new_n335_), .O(new_n536_));
  nand2  g379(.a(x070), .b(new_n340_), .O(new_n537_));
  aoi21  g380(.a(new_n537_), .b(new_n536_), .c(new_n339_), .O(new_n538_));
  nand3  g381(.a(new_n342_), .b(new_n325_), .c(x030), .O(new_n539_));
  aoi21  g382(.a(new_n539_), .b(new_n335_), .c(x086), .O(new_n540_));
  oai21  g383(.a(new_n540_), .b(new_n538_), .c(new_n535_), .O(new_n541_));
  oai21  g384(.a(x086), .b(new_n334_), .c(new_n541_), .O(new_n542_));
  nand2  g385(.a(new_n542_), .b(new_n348_), .O(new_n543_));
  oai21  g386(.a(x038), .b(x014), .c(x022), .O(new_n544_));
  oai21  g387(.a(new_n332_), .b(x030), .c(new_n544_), .O(new_n545_));
  inv1   g388(.a(x102), .O(new_n546_));
  nand2  g389(.a(new_n347_), .b(new_n546_), .O(new_n547_));
  oai21  g390(.a(new_n342_), .b(new_n335_), .c(new_n547_), .O(new_n548_));
  nand2  g391(.a(new_n548_), .b(new_n545_), .O(new_n549_));
  nand2  g392(.a(new_n549_), .b(new_n325_), .O(new_n550_));
  nand3  g393(.a(new_n323_), .b(x126), .c(new_n335_), .O(new_n551_));
  nand3  g394(.a(x102), .b(x070), .c(new_n340_), .O(new_n552_));
  nand3  g395(.a(new_n552_), .b(new_n551_), .c(new_n328_), .O(new_n553_));
  inv1   g396(.a(new_n553_), .O(new_n554_));
  aoi21  g397(.a(new_n554_), .b(new_n550_), .c(new_n339_), .O(new_n555_));
  inv1   g398(.a(new_n332_), .O(new_n556_));
  oai21  g399(.a(new_n329_), .b(x022), .c(new_n556_), .O(new_n557_));
  nand2  g400(.a(new_n557_), .b(x070), .O(new_n558_));
  oai21  g401(.a(x070), .b(x014), .c(x022), .O(new_n559_));
  nand4  g402(.a(new_n559_), .b(new_n547_), .c(new_n342_), .d(x030), .O(new_n560_));
  aoi21  g403(.a(new_n560_), .b(new_n558_), .c(x086), .O(new_n561_));
  oai21  g404(.a(new_n561_), .b(new_n555_), .c(new_n535_), .O(new_n562_));
  nand3  g405(.a(x078), .b(x070), .c(x022), .O(new_n563_));
  nand3  g406(.a(new_n563_), .b(new_n562_), .c(new_n543_), .O(new_n564_));
  nand2  g407(.a(new_n547_), .b(x006), .O(new_n565_));
  nand3  g408(.a(new_n328_), .b(x030), .c(new_n334_), .O(new_n566_));
  nand2  g409(.a(new_n566_), .b(new_n565_), .O(new_n567_));
  nand2  g410(.a(new_n567_), .b(new_n325_), .O(new_n568_));
  nand2  g411(.a(new_n557_), .b(new_n328_), .O(new_n569_));
  aoi21  g412(.a(new_n569_), .b(new_n568_), .c(new_n340_), .O(new_n570_));
  oai21  g413(.a(new_n328_), .b(new_n339_), .c(new_n324_), .O(new_n571_));
  nand2  g414(.a(new_n571_), .b(new_n334_), .O(new_n572_));
  ...
  oai21  g418(.a(new_n575_), .b(new_n570_), .c(new_n535_), .O(new_n576_));
  ...
  zero   g431(.O(z25));
  zero   g432(.O(z27));
  nor2   g433(.a(new_n178_), .b(x078), .O(z16));
  nor2   g434(.a(new_n178_), .b(x078), .O(z19));
