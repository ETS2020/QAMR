// Benchmark "FAU" written by ABC on Tue Aug 18 02:19:11 2020
...
module FAU ( 
  ...
  nor3   g164(.a(new_n320_), .b(z16), .c(new_n257_), .O(z05));
  ...
  nand3  g300(.a(new_n457_), .b(new_n158_), .c(new_n445_), .O(new_n458_));
  ...
  oai21  g329(.a(new_n486_), .b(x044), .c(new_n158_), .O(z12));
  ...
  nor3   g378(.a(new_n535_), .b(z16), .c(x045), .O(z13));
