...
module FAU ( 
  ...
  nand3  g284(.a(x082), .b(new_n207_), .c(x002), .O(new_n441_));
  oai21  g285(.a(new_n440_), .b(new_n207_), .c(new_n441_), .O(new_n442_));
  ...
  aoi21  g290(.a(new_n446_), .b(new_n440_), .c(x074), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(new_n207_), .O(new_n448_));
  aoi22  g292(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n449_));
  nand3  g293(.a(new_n449_), .b(new_n448_), .c(new_n445_), .O(new_n450_));
  aoi21  g294(.a(new_n442_), .b(new_n206_), .c(new_n450_), .O(new_n451_));
  oai21  g295(.a(new_n451_), .b(x042), .c(new_n158_), .O(z10));
  ...
  zero   g389(.O(z25));
  zero   g390(.O(z26));
  nor2   g391(.a(x078), .b(x046), .O(z15));
  nor2   g392(.a(x078), .b(x046), .O(z18));
  nor2   g393(.a(x078), .b(x046), .O(z20));
  nor2   g394(.a(x078), .b(x046), .O(z24));
