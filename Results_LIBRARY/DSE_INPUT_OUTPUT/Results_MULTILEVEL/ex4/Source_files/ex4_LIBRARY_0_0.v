...
module FAU ( 
  ...
  nand2  g308(.a(new_n465_), .b(new_n225_), .O(new_n466_));
  nand3  g309(.a(x083), .b(x011), .c(x003), .O(new_n467_));
  oai21  g310(.a(new_n463_), .b(x011), .c(new_n467_), .O(new_n468_));
  oai21  g311(.a(new_n232_), .b(x035), .c(new_n468_), .O(new_n469_));
  nand2  g312(.a(x083), .b(x003), .O(new_n470_));
  aoi21  g313(.a(new_n470_), .b(new_n463_), .c(x075), .O(new_n471_));
  oai22  g314(.a(new_n233_), .b(new_n226_), .c(new_n232_), .d(new_n225_), .O(new_n472_));
  aoi21  g315(.a(new_n471_), .b(new_n226_), .c(new_n472_), .O(new_n473_));
  ...
  aoi21  g330(.a(new_n479_), .b(new_n244_), .c(new_n487_), .O(new_n488_));
  ...
  nand2  g381(.a(new_n362_), .b(x038), .O(new_n539_));
  nand3  g382(.a(new_n539_), .b(x086), .c(x006), .O(new_n540_));
  aoi21  g383(.a(x054), .b(x038), .c(x014), .O(new_n541_));
  nand3  g384(.a(x070), .b(new_n362_), .c(x022), .O(new_n542_));
  nand3  g385(.a(new_n542_), .b(new_n541_), .c(x078), .O(new_n543_));
  inv1   g386(.a(new_n543_), .O(new_n544_));
  aoi21  g387(.a(new_n544_), .b(new_n540_), .c(x046), .O(z14));
  zero   g388(.O(z07));
  zero   g389(.O(z15));
  zero   g390(.O(z17));
  zero   g391(.O(z18));
