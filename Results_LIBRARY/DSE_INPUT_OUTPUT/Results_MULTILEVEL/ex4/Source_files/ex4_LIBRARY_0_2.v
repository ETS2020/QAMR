// Benchmark "FAU" written by ABC on Tue Aug 18 02:18:02 2020
...
module FAU ( 
  ...
  nand2  g218(.a(x064), .b(new_n176_), .O(new_n376_));
  aoi21  g219(.a(new_n376_), .b(new_n162_), .c(new_n168_), .O(new_n377_));
  nand2  g220(.a(x088), .b(x056), .O(new_n378_));
  nand3  g221(.a(new_n378_), .b(new_n161_), .c(x024), .O(new_n379_));
  aoi21  g222(.a(new_n379_), .b(new_n160_), .c(x080), .O(new_n380_));
  oai21  g223(.a(new_n380_), .b(new_n377_), .c(new_n177_), .O(new_n381_));
  nand2  g224(.a(new_n381_), .b(new_n164_), .O(new_n382_));
  oai21  g225(.a(x112), .b(x104), .c(new_n382_), .O(new_n383_));
  ...
  oai21  g234(.a(new_n378_), .b(new_n160_), .c(new_n391_), .O(new_n392_));
  ...
  nand3  g238(.a(new_n395_), .b(x120), .c(new_n160_), .O(new_n396_));
  nand3  g239(.a(x096), .b(x064), .c(new_n176_), .O(new_n397_));
  nand3  g240(.a(new_n397_), .b(new_n396_), .c(new_n163_), .O(new_n398_));
  inv1   g241(.a(new_n398_), .O(new_n399_));
  aoi21  g242(.a(new_n399_), .b(new_n394_), .c(new_n168_), .O(new_n400_));
  oai21  g243(.a(new_n385_), .b(x016), .c(new_n386_), .O(new_n401_));
  nand2  g244(.a(new_n401_), .b(x064), .O(new_n402_));
  oai21  g245(.a(x064), .b(x008), .c(x016), .O(new_n403_));
  nand4  g246(.a(new_n403_), .b(new_n391_), .c(new_n378_), .d(x024), .O(new_n404_));
  aoi21  g247(.a(new_n404_), .b(new_n402_), .c(x080), .O(new_n405_));
  oai21  g248(.a(new_n405_), .b(new_n400_), .c(new_n177_), .O(new_n406_));
  nand3  g249(.a(x072), .b(x064), .c(x016), .O(new_n407_));
  nand3  g250(.a(new_n407_), .b(new_n406_), .c(new_n383_), .O(new_n408_));
  nand2  g251(.a(new_n391_), .b(x000), .O(new_n409_));
  nand3  g252(.a(new_n163_), .b(x024), .c(new_n167_), .O(new_n410_));
  nand2  g253(.a(new_n410_), .b(new_n409_), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n161_), .O(new_n412_));
  nand2  g255(.a(new_n401_), .b(new_n163_), .O(new_n413_));
  aoi21  g256(.a(new_n413_), .b(new_n412_), .c(new_n176_), .O(new_n414_));
  aoi22  g257(.a(x080), .b(x000), .c(x064), .d(x016), .O(new_n415_));
  nand3  g258(.a(new_n172_), .b(x064), .c(x016), .O(new_n416_));
  oai21  g259(.a(new_n415_), .b(x008), .c(new_n416_), .O(new_n417_));
  oai21  g260(.a(new_n417_), .b(new_n414_), .c(new_n177_), .O(new_n418_));
  nand3  g261(.a(new_n172_), .b(x080), .c(x000), .O(new_n419_));
  nand2  g262(.a(new_n419_), .b(new_n167_), .O(new_n420_));
  aoi22  g263(.a(new_n420_), .b(x072), .c(x048), .d(x032), .O(new_n421_));
  nand2  g264(.a(new_n421_), .b(new_n418_), .O(new_n422_));
  aoi21  g265(.a(new_n408_), .b(new_n171_), .c(new_n422_), .O(new_n423_));
  oai21  g266(.a(new_n423_), .b(x040), .c(new_n159_), .O(z08));
  inv1   g267(.a(x041), .O(new_n425_));
  ...
  nand2  g271(.a(new_n428_), .b(new_n188_), .O(new_n429_));
  nand3  g272(.a(x081), .b(x009), .c(x001), .O(new_n430_));
  oai21  g273(.a(new_n426_), .b(x009), .c(new_n430_), .O(new_n431_));
  oai21  g274(.a(new_n195_), .b(x033), .c(new_n431_), .O(new_n432_));
  nand2  g275(.a(x081), .b(x001), .O(new_n433_));
  aoi21  g276(.a(new_n433_), .b(new_n426_), .c(x073), .O(new_n434_));
  oai22  g277(.a(new_n196_), .b(new_n189_), .c(new_n195_), .d(new_n188_), .O(new_n435_));
  aoi21  g278(.a(new_n434_), .b(new_n189_), .c(new_n435_), .O(new_n436_));
  nand3  g279(.a(new_n436_), .b(new_n432_), .c(new_n429_), .O(new_n437_));
  nand3  g280(.a(new_n437_), .b(new_n159_), .c(new_n425_), .O(new_n438_));
  inv1   g281(.a(new_n438_), .O(z09));
  ...
  nand3  g295(.a(new_n452_), .b(new_n159_), .c(new_n440_), .O(new_n453_));
  ...
  nand2  g320(.a(new_n477_), .b(new_n246_), .O(new_n478_));
  aoi22  g321(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n479_));
  nand3  g322(.a(new_n479_), .b(new_n478_), .c(new_n475_), .O(new_n480_));
  aoi21  g323(.a(new_n472_), .b(new_n245_), .c(new_n480_), .O(new_n481_));
  oai21  g324(.a(new_n481_), .b(x044), .c(new_n159_), .O(z12));
  nand2  g325(.a(new_n286_), .b(new_n285_), .O(new_n483_));
  nand2  g326(.a(new_n288_), .b(new_n281_), .O(new_n484_));
  ...
  nand3  g330(.a(new_n487_), .b(new_n288_), .c(x029), .O(new_n488_));
  aoi21  g331(.a(new_n488_), .b(new_n281_), .c(x085), .O(new_n489_));
  oai21  g332(.a(new_n489_), .b(new_n486_), .c(new_n260_), .O(new_n490_));
  oai21  g333(.a(x085), .b(new_n298_), .c(new_n490_), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(new_n483_), .O(new_n492_));
  oai21  g335(.a(x037), .b(x013), .c(x021), .O(new_n493_));
  nand3  g336(.a(new_n268_), .b(new_n267_), .c(new_n266_), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(new_n493_), .O(new_n495_));
  oai22  g338(.a(new_n487_), .b(new_n281_), .c(x125), .d(x101), .O(new_n496_));
  ...
  inv1   g348(.a(x125), .O(new_n506_));
  nand2  g349(.a(new_n506_), .b(new_n289_), .O(new_n507_));
  oai21  g350(.a(x069), .b(x013), .c(x021), .O(new_n508_));
  nand4  g351(.a(new_n508_), .b(new_n507_), .c(new_n487_), .d(x029), .O(new_n509_));
  aoi21  g352(.a(new_n509_), .b(new_n505_), .c(x085), .O(new_n510_));
  oai21  g353(.a(new_n510_), .b(new_n503_), .c(new_n260_), .O(new_n511_));
  nand3  g354(.a(x077), .b(x069), .c(x021), .O(new_n512_));
  nand3  g355(.a(new_n512_), .b(new_n511_), .c(new_n492_), .O(new_n513_));
  nand2  g356(.a(new_n507_), .b(x005), .O(new_n514_));
  nand3  g357(.a(new_n274_), .b(x029), .c(new_n298_), .O(new_n515_));
  nand2  g358(.a(new_n515_), .b(new_n514_), .O(new_n516_));
  nand2  g359(.a(new_n516_), .b(new_n288_), .O(new_n517_));
  nand2  g360(.a(new_n504_), .b(new_n274_), .O(new_n518_));
  aoi21  g361(.a(new_n518_), .b(new_n517_), .c(new_n262_), .O(new_n519_));
  oai21  g362(.a(new_n274_), .b(new_n261_), .c(new_n263_), .O(new_n520_));
  nand2  g363(.a(new_n520_), .b(new_n298_), .O(new_n521_));
  nand2  g364(.a(new_n316_), .b(x037), .O(new_n522_));
  ...
  aoi21  g372(.a(new_n513_), .b(new_n316_), .c(new_n529_), .O(new_n530_));
  nor3   g373(.a(new_n530_), .b(z16), .c(x045), .O(z13));
  inv1   g374(.a(x054), .O(new_n532_));
  nand2  g375(.a(x070), .b(new_n339_), .O(new_n533_));
  aoi21  g376(.a(new_n533_), .b(new_n367_), .c(new_n338_), .O(new_n534_));
  nand3  g377(.a(new_n341_), .b(new_n325_), .c(x030), .O(new_n535_));
  nor2   g378(.a(x022), .b(x014), .O(new_n536_));
  aoi21  g379(.a(new_n536_), .b(new_n535_), .c(x086), .O(new_n537_));
  oai21  g380(.a(new_n537_), .b(new_n534_), .c(new_n347_), .O(new_n538_));
  oai21  g381(.a(x038), .b(x014), .c(x022), .O(new_n539_));
  oai21  g382(.a(new_n331_), .b(x030), .c(new_n539_), .O(new_n540_));
  inv1   g383(.a(x102), .O(new_n541_));
  nand2  g384(.a(new_n346_), .b(new_n541_), .O(new_n542_));
  oai21  g385(.a(new_n341_), .b(new_n334_), .c(new_n542_), .O(new_n543_));
  aoi21  g386(.a(new_n543_), .b(new_n540_), .c(x070), .O(new_n544_));
  nand3  g387(.a(new_n323_), .b(x126), .c(new_n334_), .O(new_n545_));
  nand3  g388(.a(x102), .b(x070), .c(new_n339_), .O(new_n546_));
  nand3  g389(.a(new_n546_), .b(new_n545_), .c(new_n328_), .O(new_n547_));
  oai21  g390(.a(new_n547_), .b(new_n544_), .c(x006), .O(new_n548_));
  oai21  g391(.a(new_n329_), .b(x022), .c(new_n330_), .O(new_n549_));
  and2   g392(.a(new_n549_), .b(x070), .O(new_n550_));
  oai21  g393(.a(x070), .b(x014), .c(x022), .O(new_n551_));
  nand4  g394(.a(new_n551_), .b(new_n542_), .c(new_n341_), .d(x030), .O(new_n552_));
  inv1   g395(.a(new_n552_), .O(new_n553_));
  oai21  g396(.a(new_n553_), .b(new_n550_), .c(new_n328_), .O(new_n554_));
  nand3  g397(.a(new_n554_), .b(new_n548_), .c(new_n538_), .O(new_n555_));
  nand2  g398(.a(new_n542_), .b(x006), .O(new_n556_));
  nand3  g399(.a(new_n328_), .b(x030), .c(new_n333_), .O(new_n557_));
  aoi21  g400(.a(new_n557_), .b(new_n556_), .c(x070), .O(new_n558_));
  nand2  g401(.a(new_n549_), .b(new_n328_), .O(new_n559_));
  nand2  g402(.a(new_n559_), .b(new_n532_), .O(new_n560_));
  oai21  g403(.a(new_n560_), .b(new_n558_), .c(x038), .O(new_n561_));
  oai21  g404(.a(new_n328_), .b(new_n338_), .c(new_n324_), .O(new_n562_));
  nand2  g405(.a(new_n562_), .b(new_n333_), .O(new_n563_));
  nand2  g406(.a(new_n532_), .b(x038), .O(new_n564_));
  nand3  g407(.a(new_n564_), .b(x070), .c(x022), .O(new_n565_));
  nand4  g408(.a(new_n565_), .b(new_n563_), .c(new_n561_), .d(new_n157_), .O(new_n566_));
  aoi21  g409(.a(new_n555_), .b(new_n532_), .c(new_n566_), .O(new_n567_));
  nand3  g410(.a(new_n564_), .b(x086), .c(x006), .O(new_n568_));
  nand3  g411(.a(x070), .b(new_n532_), .c(x022), .O(new_n569_));
  nand3  g412(.a(new_n569_), .b(new_n568_), .c(new_n333_), .O(new_n570_));
  aoi22  g413(.a(new_n570_), .b(x078), .c(x054), .d(x038), .O(new_n571_));
  oai22  g414(.a(new_n571_), .b(x046), .c(new_n567_), .d(x078), .O(z14));
  zero   g415(.O(z07));
  zero   g416(.O(z15));
  zero   g417(.O(z17));
  zero   g418(.O(z18));
  ...
  zero   g425(.O(z26));
  zero   g426(.O(z27));
  nor2   g427(.a(x078), .b(new_n157_), .O(z19));
endmodule
