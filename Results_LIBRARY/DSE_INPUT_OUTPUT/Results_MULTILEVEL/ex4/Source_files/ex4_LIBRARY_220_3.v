...
module FAU ( 
  ...
  nor3   g165(.a(new_n321_), .b(z19), .c(new_n259_), .O(z05));
  ...
  oai21  g359(.a(new_n516_), .b(new_n511_), .c(new_n158_), .O(new_n517_));
  ...
  oai22  g374(.a(new_n531_), .b(new_n158_), .c(new_n328_), .d(new_n325_), .O(new_n532_));
  aoi21  g375(.a(new_n529_), .b(new_n158_), .c(new_n532_), .O(new_n533_));
  ...
  nor2   g389(.a(new_n158_), .b(new_n157_), .O(z25));
endmodule
