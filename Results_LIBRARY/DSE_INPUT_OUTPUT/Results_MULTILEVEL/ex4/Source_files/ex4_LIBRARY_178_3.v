...
module FAU ( 
  ...
  nor3   g166(.a(new_n322_), .b(z17), .c(new_n259_), .O(z05));
  ...
  nand2  g224(.a(new_n380_), .b(new_n179_), .O(new_n381_));
  ...
  nand3  g307(.a(new_n464_), .b(new_n181_), .c(new_n452_), .O(new_n465_));
  ...
  nor3   g385(.a(new_n542_), .b(z17), .c(x045), .O(z13));
  ...
  oai21  g391(.a(new_n548_), .b(new_n545_), .c(new_n353_), .O(new_n549_));
  ...
  nand2  g395(.a(new_n352_), .b(new_n552_), .O(new_n553_));
  oai21  g396(.a(new_n359_), .b(new_n343_), .c(new_n553_), .O(new_n554_));
  aoi21  g397(.a(new_n554_), .b(new_n551_), .c(x070), .O(new_n555_));
  nand3  g398(.a(new_n325_), .b(x126), .c(new_n343_), .O(new_n556_));
  ...
  nand4  g406(.a(new_n563_), .b(new_n553_), .c(new_n359_), .d(x030), .O(new_n564_));
  inv1   g407(.a(new_n564_), .O(new_n565_));
  oai21  g408(.a(new_n565_), .b(new_n562_), .c(new_n331_), .O(new_n566_));
  nand3  g409(.a(new_n566_), .b(new_n559_), .c(new_n549_), .O(new_n567_));
  nand2  g410(.a(new_n567_), .b(new_n368_), .O(new_n568_));
  ...
  nand2  g414(.a(new_n561_), .b(new_n331_), .O(new_n572_));
  nand2  g415(.a(new_n572_), .b(new_n368_), .O(new_n573_));
  ...
  nand3  g424(.a(x070), .b(new_n368_), .c(x022), .O(new_n582_));
  nand3  g425(.a(new_n582_), .b(new_n581_), .c(new_n339_), .O(new_n583_));
  nand2  g426(.a(new_n583_), .b(x078), .O(new_n584_));
  oai21  g427(.a(new_n368_), .b(new_n367_), .c(new_n584_), .O(new_n585_));
  nand2  g428(.a(new_n585_), .b(new_n179_), .O(new_n586_));
  ...
  nor2   g439(.a(new_n179_), .b(new_n178_), .O(z21));
  nor2   g440(.a(new_n179_), .b(new_n178_), .O(z24));
  nor2   g441(.a(new_n179_), .b(new_n178_), .O(z25));
