...
module FAU ( 
  ...
  aoi21  g181(.a(new_n337_), .b(new_n330_), .c(new_n157_), .O(new_n338_));
  ...
  nand3  g210(.a(new_n157_), .b(new_n352_), .c(new_n346_), .O(new_n367_));
  ...
  aoi22  g226(.a(new_n382_), .b(new_n157_), .c(new_n380_), .d(new_n327_), .O(new_n383_));
  ...
  nand3  g331(.a(new_n488_), .b(new_n160_), .c(new_n476_), .O(new_n489_));
  ...
  nand2  g427(.a(new_n584_), .b(new_n158_), .O(new_n585_));
