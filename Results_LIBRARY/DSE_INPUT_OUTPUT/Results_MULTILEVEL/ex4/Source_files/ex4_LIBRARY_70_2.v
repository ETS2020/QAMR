...
module FAU ( 
  ...
  nor3   g213(.a(new_n369_), .b(new_n322_), .c(new_n157_), .O(z06));
  ...
  oai22  g228(.a(new_n374_), .b(new_n160_), .c(x120), .d(x096), .O(new_n386_));
  ...
  oai21  g245(.a(new_n402_), .b(new_n394_), .c(new_n177_), .O(new_n403_));
  ...
  oai21  g249(.a(new_n398_), .b(new_n168_), .c(new_n406_), .O(new_n407_));
  nand2  g250(.a(new_n407_), .b(new_n161_), .O(new_n408_));
  nand2  g251(.a(new_n396_), .b(new_n163_), .O(new_n409_));
  ...
  aoi21  g261(.a(new_n405_), .b(new_n171_), .c(new_n418_), .O(new_n419_));
  nor3   g262(.a(new_n419_), .b(z15), .c(x040), .O(z08));
  ...
  nand2  g308(.a(new_n465_), .b(new_n245_), .O(new_n466_));
  nand3  g309(.a(x084), .b(x012), .c(x004), .O(new_n467_));
  oai21  g310(.a(new_n463_), .b(x012), .c(new_n467_), .O(new_n468_));
  oai21  g311(.a(new_n252_), .b(x036), .c(new_n468_), .O(new_n469_));
  nand2  g312(.a(x084), .b(x004), .O(new_n470_));
  aoi21  g313(.a(new_n470_), .b(new_n463_), .c(x076), .O(new_n471_));
  oai22  g314(.a(new_n253_), .b(new_n246_), .c(new_n252_), .d(new_n245_), .O(new_n472_));
  aoi21  g315(.a(new_n471_), .b(new_n246_), .c(new_n472_), .O(new_n473_));
  nand3  g316(.a(new_n473_), .b(new_n469_), .c(new_n466_), .O(new_n474_));
  nand3  g317(.a(new_n474_), .b(new_n159_), .c(new_n462_), .O(new_n475_));
  inv1   g318(.a(new_n475_), .O(z12));
  ...
  oai21  g365(.a(new_n522_), .b(x045), .c(new_n159_), .O(z13));
  ...
  nand4  g400(.a(new_n557_), .b(new_n555_), .c(new_n553_), .d(new_n157_), .O(new_n558_));
  ...
  zero   g413(.O(z25));
  zero   g414(.O(z26));
  nor2   g415(.a(x078), .b(new_n157_), .O(z18));
