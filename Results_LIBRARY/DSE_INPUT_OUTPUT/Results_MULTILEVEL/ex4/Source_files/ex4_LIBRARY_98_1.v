...
module FAU ( 
  ...
  aoi21  g301(.a(new_n450_), .b(new_n206_), .c(new_n458_), .O(new_n459_));
  ...
  nand2  g307(.a(new_n464_), .b(new_n225_), .O(new_n465_));
  ...
  oai22  g313(.a(new_n233_), .b(new_n226_), .c(new_n232_), .d(new_n225_), .O(new_n471_));
  aoi21  g314(.a(new_n470_), .b(new_n226_), .c(new_n471_), .O(new_n472_));
  ...
  inv1   g437(.a(new_n179_), .O(z18));
  inv1   g438(.a(new_n179_), .O(z21));
  inv1   g439(.a(new_n179_), .O(z25));
endmodule
