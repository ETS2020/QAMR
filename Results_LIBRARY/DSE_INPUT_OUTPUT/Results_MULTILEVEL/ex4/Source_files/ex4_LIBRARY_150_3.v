...
module FAU ( 
  ...
  oai21  g385(.a(new_n542_), .b(new_n540_), .c(new_n178_), .O(new_n543_));
  oai21  g386(.a(x086), .b(new_n338_), .c(new_n543_), .O(new_n544_));
  ...
  nand2  g391(.a(new_n351_), .b(new_n548_), .O(new_n549_));
  oai21  g392(.a(new_n358_), .b(new_n342_), .c(new_n549_), .O(new_n550_));
  nand2  g393(.a(new_n550_), .b(new_n547_), .O(new_n551_));
  nand2  g394(.a(new_n551_), .b(new_n327_), .O(new_n552_));
  nand3  g395(.a(new_n324_), .b(x126), .c(new_n342_), .O(new_n553_));
  nand3  g396(.a(x102), .b(x070), .c(new_n366_), .O(new_n554_));
  nand3  g397(.a(new_n554_), .b(new_n553_), .c(new_n330_), .O(new_n555_));
  inv1   g398(.a(new_n555_), .O(new_n556_));
  aoi21  g399(.a(new_n556_), .b(new_n552_), .c(new_n341_), .O(new_n557_));
  inv1   g400(.a(new_n334_), .O(new_n558_));
  ...
  nand4  g404(.a(new_n561_), .b(new_n549_), .c(new_n358_), .d(x030), .O(new_n562_));
  aoi21  g405(.a(new_n562_), .b(new_n560_), .c(x086), .O(new_n563_));
  oai21  g406(.a(new_n563_), .b(new_n557_), .c(new_n178_), .O(new_n564_));
  ...
  nand2  g412(.a(new_n569_), .b(new_n327_), .O(new_n570_));
  nand2  g413(.a(new_n559_), .b(new_n330_), .O(new_n571_));
  aoi21  g414(.a(new_n571_), .b(new_n570_), .c(new_n366_), .O(new_n572_));
  ...
  nand2  g422(.a(new_n579_), .b(new_n338_), .O(new_n580_));
  aoi22  g423(.a(new_n580_), .b(x078), .c(x054), .d(x038), .O(new_n581_));
  nand2  g424(.a(new_n581_), .b(new_n578_), .O(new_n582_));
  aoi21  g425(.a(new_n566_), .b(new_n367_), .c(new_n582_), .O(new_n583_));
