...
module FAU ( 
  ...
  nand3  g042(.a(new_n198_), .b(new_n195_), .c(new_n157_), .O(new_n199_));
  ...
  nand4  g285(.a(new_n442_), .b(x078), .c(x065), .d(x017), .O(new_n443_));
  ...
  zero   g429(.O(z25));
  zero   g430(.O(z26));
  nor2   g431(.a(x078), .b(new_n157_), .O(z16));
  nor2   g432(.a(x078), .b(new_n157_), .O(z20));
  nor2   g433(.a(x078), .b(new_n157_), .O(z21));
  nor2   g434(.a(x078), .b(new_n157_), .O(z23));
  nor2   g435(.a(x078), .b(new_n157_), .O(z24));
  nor2   g436(.a(x078), .b(new_n157_), .O(z27));
endmodule
