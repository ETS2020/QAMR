...
module FAU ( 
  ...
  oai21  g423(.a(new_n580_), .b(x046), .c(new_n179_), .O(z14));
  zero   g424(.O(z07));
  zero   g425(.O(z18));
  zero   g426(.O(z19));
  zero   g427(.O(z22));
  ...
  zero   g429(.O(z24));
  zero   g430(.O(z26));
  nor2   g431(.a(x113), .b(x078), .O(z16));
  nor2   g432(.a(x113), .b(x078), .O(z17));
  nor2   g433(.a(x113), .b(x078), .O(z20));
  nor2   g434(.a(x113), .b(x078), .O(z21));
  nor2   g435(.a(x113), .b(x078), .O(z25));
  nor2   g436(.a(x113), .b(x078), .O(z27));
endmodule
