...
module FAU ( 
  ...
  nand2  g379(.a(new_n359_), .b(x038), .O(new_n536_));
  nand3  g380(.a(new_n536_), .b(x086), .c(x006), .O(new_n537_));
  nand2  g381(.a(x054), .b(x038), .O(new_n538_));
  nand3  g382(.a(x070), .b(new_n359_), .c(x022), .O(new_n539_));
  nand4  g383(.a(new_n539_), .b(new_n538_), .c(new_n537_), .d(new_n331_), .O(new_n540_));
  ...
  zero   g393(.O(z26));
  zero   g394(.O(z27));
  nor2   g395(.a(x078), .b(x046), .O(z16));
  nor2   g396(.a(x078), .b(x046), .O(z18));
  nor2   g397(.a(x078), .b(x046), .O(z19));
  nor2   g398(.a(x078), .b(x046), .O(z22));
endmodule
