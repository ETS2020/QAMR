...
module FAU ( 
  ...
  nand2  g021(.a(x078), .b(x025), .O(new_n178_));
  ...
  nand2  g332(.a(new_n287_), .b(new_n280_), .O(new_n489_));
  ...
  aoi21  g337(.a(new_n493_), .b(new_n280_), .c(x085), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(new_n491_), .c(new_n259_), .O(new_n495_));
  ...
  oai22  g344(.a(new_n492_), .b(new_n280_), .c(x125), .d(x101), .O(new_n501_));
  ...
  oai21  g359(.a(new_n515_), .b(new_n508_), .c(new_n259_), .O(new_n516_));
  ...
  nand3  g363(.a(new_n273_), .b(x029), .c(new_n297_), .O(new_n520_));
  nand2  g364(.a(new_n520_), .b(new_n519_), .O(new_n521_));
  nand2  g365(.a(new_n521_), .b(new_n287_), .O(new_n522_));
  nand2  g366(.a(new_n509_), .b(new_n273_), .O(new_n523_));
  ...
  oai21  g385(.a(new_n541_), .b(new_n539_), .c(new_n324_), .O(new_n542_));
  ...
  nand3  g394(.a(new_n323_), .b(x126), .c(new_n330_), .O(new_n551_));
  ...
  oai21  g404(.a(new_n560_), .b(new_n555_), .c(new_n324_), .O(new_n561_));
  ...
  oai21  g418(.a(new_n574_), .b(new_n569_), .c(new_n324_), .O(new_n575_));
  ...
  oai21  g424(.a(new_n580_), .b(x046), .c(new_n178_), .O(z14));
  zero   g425(.O(z17));
  zero   g426(.O(z18));
  zero   g427(.O(z19));
  zero   g428(.O(z21));
  zero   g429(.O(z23));
  zero   g430(.O(z26));
  inv1   g431(.a(new_n178_), .O(z15));
  inv1   g432(.a(new_n178_), .O(z16));
  inv1   g433(.a(new_n178_), .O(z20));
  inv1   g434(.a(new_n178_), .O(z22));
  inv1   g435(.a(new_n178_), .O(z24));
  inv1   g436(.a(new_n178_), .O(z25));
  inv1   g437(.a(new_n178_), .O(z27));
endmodule
