...
module FAU ( 
  ...
  nor3   g270(.a(new_n427_), .b(z19), .c(x040), .O(z08));
  ...
  aoi21  g282(.a(new_n431_), .b(new_n187_), .c(new_n439_), .O(new_n440_));
  oai21  g283(.a(new_n440_), .b(x041), .c(new_n179_), .O(z09));
  ...
  oai21  g289(.a(new_n213_), .b(x034), .c(new_n446_), .O(new_n447_));
  ...
  aoi21  g295(.a(new_n444_), .b(new_n206_), .c(new_n452_), .O(new_n453_));
  oai21  g296(.a(new_n453_), .b(x042), .c(new_n179_), .O(z10));
  ...
  nand2  g301(.a(new_n458_), .b(new_n225_), .O(new_n459_));
  ...
  oai22  g307(.a(new_n233_), .b(new_n226_), .c(new_n232_), .d(new_n225_), .O(new_n465_));
  aoi21  g308(.a(new_n464_), .b(new_n226_), .c(new_n465_), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(new_n462_), .c(new_n459_), .O(new_n467_));
  nand3  g310(.a(new_n467_), .b(new_n179_), .c(new_n455_), .O(new_n468_));
  ...
  nor3   g373(.a(new_n530_), .b(z19), .c(x045), .O(z13));
  inv1   g374(.a(x046), .O(new_n532_));
  nand2  g375(.a(new_n359_), .b(x038), .O(new_n533_));
  nand3  g376(.a(new_n533_), .b(x086), .c(x006), .O(new_n534_));
  nand2  g377(.a(x054), .b(x038), .O(new_n535_));
  nand3  g378(.a(x070), .b(new_n359_), .c(x022), .O(new_n536_));
  nand4  g379(.a(new_n536_), .b(new_n535_), .c(new_n534_), .d(new_n331_), .O(new_n537_));
  nand3  g380(.a(new_n537_), .b(x078), .c(new_n532_), .O(new_n538_));
