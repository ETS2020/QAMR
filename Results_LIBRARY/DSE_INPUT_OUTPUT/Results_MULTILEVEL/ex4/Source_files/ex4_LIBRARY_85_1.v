...
module FAU ( 
  ...
  oai21  g224(.a(new_n380_), .b(new_n379_), .c(new_n178_), .O(new_n381_));
  ...
  oai21  g315(.a(new_n471_), .b(x043), .c(new_n180_), .O(z11));
  ...
  oai21  g340(.a(new_n295_), .b(x029), .c(new_n496_), .O(new_n497_));
  nand2  g341(.a(new_n280_), .b(new_n279_), .O(new_n498_));
  oai21  g342(.a(new_n276_), .b(new_n266_), .c(new_n498_), .O(new_n499_));
  ...
  nand4  g353(.a(new_n509_), .b(new_n498_), .c(new_n276_), .d(x029), .O(new_n510_));
  ...
  nand3  g359(.a(new_n272_), .b(x029), .c(new_n297_), .O(new_n516_));
  ...
  nand2  g365(.a(new_n521_), .b(new_n297_), .O(new_n522_));
  ...
  nand2  g417(.a(new_n573_), .b(new_n178_), .O(new_n574_));
  ...
  zero   g427(.O(z25));
  zero   g428(.O(z26));
  nor2   g429(.a(new_n178_), .b(x078), .O(z16));
  nor2   g430(.a(new_n178_), .b(x078), .O(z17));
  nor2   g431(.a(new_n178_), .b(x078), .O(z18));
  nor2   g432(.a(new_n178_), .b(x078), .O(z19));
  nor2   g433(.a(new_n178_), .b(x078), .O(z21));
  nor2   g434(.a(new_n178_), .b(x078), .O(z22));
  nor2   g435(.a(new_n178_), .b(x078), .O(z24));
  nor2   g436(.a(new_n178_), .b(x078), .O(z27));
endmodule
