...
module FAU ( 
  ...
  nor3   g225(.a(new_n382_), .b(z15), .c(x040), .O(z08));
  ...
  inv1   g340(.a(x030), .O(new_n498_));
  nor2   g341(.a(x094), .b(x062), .O(new_n499_));
  nand2  g342(.a(new_n499_), .b(new_n498_), .O(new_n500_));
  nor2   g343(.a(x126), .b(x102), .O(new_n501_));
  inv1   g344(.a(new_n501_), .O(new_n502_));
  nand3  g345(.a(x094), .b(x062), .c(x022), .O(new_n503_));
  aoi22  g346(.a(new_n503_), .b(new_n502_), .c(new_n500_), .d(new_n497_), .O(new_n504_));
  nand2  g347(.a(x118), .b(x110), .O(new_n505_));
  nand3  g348(.a(new_n505_), .b(x126), .c(new_n328_), .O(new_n506_));
  nand3  g349(.a(x102), .b(x070), .c(new_n323_), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n506_), .c(new_n322_), .O(new_n508_));
  inv1   g351(.a(new_n508_), .O(new_n509_));
  oai21  g352(.a(new_n504_), .b(x070), .c(new_n509_), .O(new_n510_));
  oai21  g353(.a(new_n498_), .b(x022), .c(new_n499_), .O(new_n511_));
  nand2  g354(.a(new_n511_), .b(x070), .O(new_n512_));
  oai21  g355(.a(x070), .b(x014), .c(x022), .O(new_n513_));
  nand4  g356(.a(new_n513_), .b(new_n502_), .c(new_n491_), .d(x030), .O(new_n514_));
  aoi21  g357(.a(new_n514_), .b(new_n512_), .c(x086), .O(new_n515_));
  aoi21  g358(.a(new_n510_), .b(x006), .c(new_n515_), .O(new_n516_));
  oai21  g359(.a(new_n516_), .b(x078), .c(new_n496_), .O(new_n517_));
  nand3  g360(.a(new_n322_), .b(x030), .c(new_n487_), .O(new_n518_));
  oai21  g361(.a(new_n501_), .b(new_n321_), .c(new_n518_), .O(new_n519_));
  nand2  g362(.a(new_n519_), .b(new_n329_), .O(new_n520_));
  nand2  g363(.a(new_n511_), .b(new_n322_), .O(new_n521_));
  aoi21  g364(.a(new_n521_), .b(new_n520_), .c(new_n323_), .O(new_n522_));
  aoi22  g365(.a(x086), .b(x006), .c(x070), .d(x022), .O(new_n523_));
  nand2  g366(.a(new_n326_), .b(x038), .O(new_n524_));
  nand3  g367(.a(new_n524_), .b(x070), .c(x022), .O(new_n525_));
  oai21  g368(.a(new_n523_), .b(x014), .c(new_n525_), .O(new_n526_));
  oai21  g369(.a(new_n526_), .b(new_n522_), .c(new_n179_), .O(new_n527_));
  oai21  g370(.a(new_n326_), .b(new_n323_), .c(new_n527_), .O(new_n528_));
  aoi21  g371(.a(new_n517_), .b(new_n326_), .c(new_n528_), .O(new_n529_));
  nand3  g372(.a(new_n524_), .b(x086), .c(x006), .O(new_n530_));
  aoi21  g373(.a(x054), .b(x038), .c(x014), .O(new_n531_));
  nand3  g374(.a(x070), .b(new_n326_), .c(x022), .O(new_n532_));
  nand4  g375(.a(new_n532_), .b(new_n531_), .c(new_n530_), .d(new_n178_), .O(new_n533_));
  nand2  g376(.a(new_n533_), .b(x078), .O(new_n534_));
  oai21  g377(.a(new_n529_), .b(x046), .c(new_n534_), .O(z14));
  zero   g378(.O(z07));
  zero   g379(.O(z16));
  zero   g380(.O(z17));
  zero   g381(.O(z18));
  ...
  zero   g385(.O(z23));
  zero   g386(.O(z24));
  nor2   g387(.a(new_n179_), .b(new_n178_), .O(z22));
