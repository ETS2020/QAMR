...
module FAU ( 
  ...
  nand2  g022(.a(x115), .b(new_n178_), .O(new_n179_));
  ...
  oai21  g226(.a(new_n382_), .b(new_n322_), .c(new_n179_), .O(z06));
  ...
  nand3  g302(.a(new_n458_), .b(new_n179_), .c(new_n446_), .O(new_n459_));
  ...
  oai21  g380(.a(new_n536_), .b(x045), .c(new_n179_), .O(z13));
  ...
  zero   g430(.O(z23));
  zero   g431(.O(z26));
  inv1   g432(.a(new_n179_), .O(z15));
  inv1   g433(.a(new_n179_), .O(z18));
  inv1   g434(.a(new_n179_), .O(z20));
  inv1   g435(.a(new_n179_), .O(z22));
  inv1   g436(.a(new_n179_), .O(z24));
  inv1   g437(.a(new_n179_), .O(z25));
  inv1   g438(.a(new_n179_), .O(z27));
endmodule
