...
module FAU ( 
  ...
  aoi21  g371(.a(new_n527_), .b(new_n363_), .c(new_n334_), .O(new_n528_));
  ...
  oai21  g375(.a(x086), .b(new_n329_), .c(new_n531_), .O(new_n532_));
  nand2  g376(.a(new_n532_), .b(new_n343_), .O(new_n533_));
  oai21  g377(.a(x038), .b(x014), .c(x022), .O(new_n534_));
  oai21  g378(.a(new_n327_), .b(x030), .c(new_n534_), .O(new_n535_));
  inv1   g379(.a(x102), .O(new_n536_));
  nand2  g380(.a(new_n342_), .b(new_n536_), .O(new_n537_));
  oai21  g381(.a(new_n337_), .b(new_n330_), .c(new_n537_), .O(new_n538_));
  nand2  g382(.a(new_n538_), .b(new_n535_), .O(new_n539_));
  nand3  g383(.a(new_n320_), .b(x126), .c(new_n330_), .O(new_n540_));
  nand3  g384(.a(x102), .b(x070), .c(new_n335_), .O(new_n541_));
  nand3  g385(.a(new_n541_), .b(new_n540_), .c(new_n325_), .O(new_n542_));
  aoi21  g386(.a(new_n539_), .b(new_n322_), .c(new_n542_), .O(new_n543_));
  nor2   g387(.a(new_n543_), .b(new_n334_), .O(new_n544_));
  aoi21  g388(.a(x030), .b(new_n330_), .c(new_n327_), .O(new_n545_));
  or2    g389(.a(new_n545_), .b(new_n322_), .O(new_n546_));
  oai21  g390(.a(x070), .b(x014), .c(x022), .O(new_n547_));
  nand4  g391(.a(new_n547_), .b(new_n537_), .c(new_n337_), .d(x030), .O(new_n548_));
  ...
  nand3  g398(.a(new_n325_), .b(x030), .c(new_n329_), .O(new_n555_));
  ...
  aoi21  g403(.a(new_n559_), .b(new_n321_), .c(x014), .O(new_n560_));
  aoi21  g404(.a(new_n525_), .b(x038), .c(new_n322_), .O(new_n561_));
  aoi21  g405(.a(new_n561_), .b(x022), .c(new_n560_), .O(new_n562_));
  nand2  g406(.a(new_n562_), .b(new_n558_), .O(new_n563_));
  aoi21  g407(.a(new_n525_), .b(x038), .c(new_n325_), .O(new_n564_));
  aoi21  g408(.a(new_n564_), .b(x006), .c(x014), .O(new_n565_));
  oai22  g409(.a(new_n565_), .b(new_n526_), .c(new_n525_), .d(new_n335_), .O(new_n566_));
  ...
  zero   g420(.O(z26));
  zero   g421(.O(z27));
  nor2   g422(.a(x078), .b(new_n178_), .O(z17));
