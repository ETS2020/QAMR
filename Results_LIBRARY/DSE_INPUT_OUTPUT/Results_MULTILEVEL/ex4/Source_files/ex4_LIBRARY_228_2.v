// Benchmark "FAU" written by ABC on Tue Aug 18 02:20:01 2020
...
module FAU ( 
  ...
  nand3  g174(.a(new_n330_), .b(x070), .c(new_n328_), .O(new_n331_));
  inv1   g175(.a(x014), .O(new_n332_));
  inv1   g176(.a(x022), .O(new_n333_));
  nor2   g177(.a(new_n333_), .b(new_n332_), .O(new_n334_));
  aoi21  g178(.a(new_n334_), .b(new_n331_), .c(new_n327_), .O(new_n335_));
  oai21  g179(.a(new_n335_), .b(new_n326_), .c(new_n322_), .O(new_n336_));
  ...
  oai21  g184(.a(new_n340_), .b(new_n328_), .c(new_n339_), .O(new_n341_));
  nand2  g185(.a(x126), .b(x102), .O(new_n342_));
  oai21  g186(.a(new_n330_), .b(x022), .c(new_n342_), .O(new_n343_));
  aoi21  g187(.a(new_n343_), .b(new_n341_), .c(new_n324_), .O(new_n344_));
  ...
  aoi21  g192(.a(new_n348_), .b(x038), .c(new_n327_), .O(new_n349_));
  nand2  g193(.a(new_n349_), .b(new_n347_), .O(new_n350_));
  oai21  g194(.a(new_n350_), .b(new_n344_), .c(new_n337_), .O(new_n351_));
  aoi21  g195(.a(new_n328_), .b(x022), .c(new_n340_), .O(new_n352_));
  oai21  g196(.a(new_n324_), .b(new_n332_), .c(new_n333_), .O(new_n353_));
  nand4  g197(.a(new_n353_), .b(new_n342_), .c(new_n330_), .d(new_n328_), .O(new_n354_));
  ...
  nand2  g202(.a(new_n342_), .b(new_n337_), .O(new_n359_));
  nand3  g203(.a(x086), .b(new_n328_), .c(x014), .O(new_n360_));
  nand2  g204(.a(new_n360_), .b(new_n359_), .O(new_n361_));
  nand2  g205(.a(new_n361_), .b(x070), .O(new_n362_));
  inv1   g206(.a(new_n352_), .O(new_n363_));
  nand2  g207(.a(new_n363_), .b(x086), .O(new_n364_));
  nand3  g208(.a(new_n364_), .b(new_n362_), .c(x054), .O(new_n365_));
  nand2  g209(.a(new_n324_), .b(new_n333_), .O(new_n366_));
  oai21  g210(.a(x086), .b(x006), .c(new_n366_), .O(new_n367_));
  nand2  g211(.a(new_n367_), .b(x014), .O(new_n368_));
  nand2  g212(.a(x054), .b(new_n338_), .O(new_n369_));
  nand3  g213(.a(new_n369_), .b(new_n324_), .c(new_n333_), .O(new_n370_));
  nand3  g214(.a(new_n370_), .b(new_n368_), .c(x078), .O(new_n371_));
  aoi21  g215(.a(new_n365_), .b(new_n338_), .c(new_n371_), .O(new_n372_));
  aoi21  g216(.a(new_n372_), .b(new_n358_), .c(new_n178_), .O(z06));
  nand2  g217(.a(x064), .b(new_n173_), .O(new_n374_));
  aoi21  g218(.a(new_n374_), .b(new_n159_), .c(new_n165_), .O(new_n375_));
  nand2  g219(.a(x088), .b(x056), .O(new_n376_));
  nand3  g220(.a(new_n376_), .b(new_n158_), .c(x024), .O(new_n377_));
  aoi21  g221(.a(new_n377_), .b(new_n157_), .c(x080), .O(new_n378_));
  oai21  g222(.a(new_n378_), .b(new_n375_), .c(new_n174_), .O(new_n379_));
  nand2  g223(.a(new_n379_), .b(new_n161_), .O(new_n380_));
  oai21  g224(.a(x112), .b(x104), .c(new_n380_), .O(new_n381_));
  ...
  nand2  g229(.a(new_n385_), .b(new_n382_), .O(new_n386_));
  inv1   g230(.a(x096), .O(new_n387_));
  inv1   g231(.a(x120), .O(new_n388_));
  nand2  g232(.a(new_n388_), .b(new_n387_), .O(new_n389_));
  oai21  g233(.a(new_n376_), .b(new_n157_), .c(new_n389_), .O(new_n390_));
  nand2  g234(.a(new_n390_), .b(new_n386_), .O(new_n391_));
  nand2  g235(.a(new_n391_), .b(new_n158_), .O(new_n392_));
  nand2  g236(.a(x112), .b(x104), .O(new_n393_));
  nand3  g237(.a(new_n393_), .b(x120), .c(new_n157_), .O(new_n394_));
  nand3  g238(.a(x096), .b(x064), .c(new_n173_), .O(new_n395_));
  nand3  g239(.a(new_n395_), .b(new_n394_), .c(new_n160_), .O(new_n396_));
  inv1   g240(.a(new_n396_), .O(new_n397_));
  aoi21  g241(.a(new_n397_), .b(new_n392_), .c(new_n165_), .O(new_n398_));
  oai21  g242(.a(new_n383_), .b(x016), .c(new_n384_), .O(new_n399_));
  nand2  g243(.a(new_n399_), .b(x064), .O(new_n400_));
  oai21  g244(.a(x064), .b(x008), .c(x016), .O(new_n401_));
  nand4  g245(.a(new_n401_), .b(new_n389_), .c(new_n376_), .d(x024), .O(new_n402_));
  aoi21  g246(.a(new_n402_), .b(new_n400_), .c(x080), .O(new_n403_));
  oai21  g247(.a(new_n403_), .b(new_n398_), .c(new_n174_), .O(new_n404_));
  nand3  g248(.a(x072), .b(x064), .c(x016), .O(new_n405_));
  nand3  g249(.a(new_n405_), .b(new_n404_), .c(new_n381_), .O(new_n406_));
  nand2  g250(.a(new_n389_), .b(x000), .O(new_n407_));
  nand3  g251(.a(new_n160_), .b(x024), .c(new_n164_), .O(new_n408_));
  nand2  g252(.a(new_n408_), .b(new_n407_), .O(new_n409_));
  nand2  g253(.a(new_n409_), .b(new_n158_), .O(new_n410_));
  nand2  g254(.a(new_n399_), .b(new_n160_), .O(new_n411_));
  aoi21  g255(.a(new_n411_), .b(new_n410_), .c(new_n173_), .O(new_n412_));
  aoi22  g256(.a(x080), .b(x000), .c(x064), .d(x016), .O(new_n413_));
  nand3  g257(.a(new_n169_), .b(x064), .c(x016), .O(new_n414_));
  oai21  g258(.a(new_n413_), .b(x008), .c(new_n414_), .O(new_n415_));
  oai21  g259(.a(new_n415_), .b(new_n412_), .c(new_n174_), .O(new_n416_));
  nand3  g260(.a(new_n169_), .b(x080), .c(x000), .O(new_n417_));
  nand2  g261(.a(new_n417_), .b(new_n164_), .O(new_n418_));
  aoi22  g262(.a(new_n418_), .b(x072), .c(x048), .d(x032), .O(new_n419_));
  nand2  g263(.a(new_n419_), .b(new_n416_), .O(new_n420_));
  aoi21  g264(.a(new_n406_), .b(new_n168_), .c(new_n420_), .O(new_n421_));
  oai21  g265(.a(new_n421_), .b(x040), .c(new_n180_), .O(z08));
  inv1   g266(.a(x041), .O(new_n423_));
  nand2  g267(.a(x065), .b(x017), .O(new_n424_));
  nand3  g268(.a(x081), .b(new_n189_), .c(x001), .O(new_n425_));
  oai21  g269(.a(new_n424_), .b(new_n189_), .c(new_n425_), .O(new_n426_));
  nand2  g270(.a(new_n426_), .b(new_n188_), .O(new_n427_));
  nand3  g271(.a(x081), .b(x009), .c(x001), .O(new_n428_));
  oai21  g272(.a(new_n424_), .b(x009), .c(new_n428_), .O(new_n429_));
  oai21  g273(.a(new_n195_), .b(x033), .c(new_n429_), .O(new_n430_));
  nand2  g274(.a(x081), .b(x001), .O(new_n431_));
  aoi21  g275(.a(new_n431_), .b(new_n424_), .c(x073), .O(new_n432_));
  oai22  g276(.a(new_n196_), .b(new_n189_), .c(new_n195_), .d(new_n188_), .O(new_n433_));
  aoi21  g277(.a(new_n432_), .b(new_n189_), .c(new_n433_), .O(new_n434_));
  nand3  g278(.a(new_n434_), .b(new_n430_), .c(new_n427_), .O(new_n435_));
  nand3  g279(.a(new_n435_), .b(new_n180_), .c(new_n423_), .O(new_n436_));
  inv1   g280(.a(new_n436_), .O(z09));
  ...
  nand3  g312(.a(x084), .b(new_n246_), .c(x004), .O(new_n469_));
  oai21  g313(.a(new_n468_), .b(new_n246_), .c(new_n469_), .O(new_n470_));
  nand3  g314(.a(x084), .b(x012), .c(x004), .O(new_n471_));
  oai21  g315(.a(new_n468_), .b(x012), .c(new_n471_), .O(new_n472_));
  oai21  g316(.a(new_n252_), .b(x036), .c(new_n472_), .O(new_n473_));
  nand2  g317(.a(x084), .b(x004), .O(new_n474_));
  aoi21  g318(.a(new_n474_), .b(new_n468_), .c(x076), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(new_n246_), .O(new_n476_));
  aoi22  g320(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n476_), .c(new_n473_), .O(new_n478_));
  aoi21  g322(.a(new_n470_), .b(new_n245_), .c(new_n478_), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(x044), .c(new_n180_), .O(z12));
  nand2  g324(.a(new_n287_), .b(new_n281_), .O(new_n481_));
  ...
  nand3  g328(.a(new_n484_), .b(new_n287_), .c(x029), .O(new_n485_));
  aoi21  g329(.a(new_n485_), .b(new_n281_), .c(x085), .O(new_n486_));
  oai21  g330(.a(new_n486_), .b(new_n483_), .c(new_n260_), .O(new_n487_));
  oai21  g331(.a(x085), .b(new_n297_), .c(new_n487_), .O(new_n488_));
  oai21  g332(.a(x117), .b(x109), .c(new_n488_), .O(new_n489_));
  oai21  g333(.a(x037), .b(x013), .c(x021), .O(new_n490_));
  oai21  g334(.a(new_n269_), .b(x029), .c(new_n490_), .O(new_n491_));
  inv1   g335(.a(x125), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(new_n288_), .O(new_n493_));
  oai21  g337(.a(new_n484_), .b(new_n281_), .c(new_n493_), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n491_), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n287_), .O(new_n496_));
  nand3  g340(.a(new_n259_), .b(x125), .c(new_n281_), .O(new_n497_));
  nand3  g341(.a(x101), .b(x069), .c(new_n262_), .O(new_n498_));
  nand3  g342(.a(new_n498_), .b(new_n497_), .c(new_n274_), .O(new_n499_));
  inv1   g343(.a(new_n499_), .O(new_n500_));
  aoi21  g344(.a(new_n500_), .b(new_n496_), .c(new_n261_), .O(new_n501_));
  oai21  g345(.a(new_n266_), .b(x021), .c(new_n282_), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(x069), .O(new_n503_));
  oai21  g347(.a(x069), .b(x013), .c(x021), .O(new_n504_));
  nand4  g348(.a(new_n504_), .b(new_n493_), .c(new_n484_), .d(x029), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n503_), .c(x085), .O(new_n506_));
  oai21  g350(.a(new_n506_), .b(new_n501_), .c(new_n260_), .O(new_n507_));
  nand3  g351(.a(x077), .b(x069), .c(x021), .O(new_n508_));
  nand3  g352(.a(new_n508_), .b(new_n507_), .c(new_n489_), .O(new_n509_));
  nand2  g353(.a(new_n493_), .b(x005), .O(new_n510_));
  nand3  g354(.a(new_n274_), .b(x029), .c(new_n297_), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n510_), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n287_), .O(new_n513_));
  nand2  g357(.a(new_n502_), .b(new_n274_), .O(new_n514_));
  aoi21  g358(.a(new_n514_), .b(new_n513_), .c(new_n262_), .O(new_n515_));
  oai21  g359(.a(new_n274_), .b(new_n261_), .c(new_n263_), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n297_), .O(new_n517_));
  nand2  g361(.a(new_n315_), .b(x037), .O(new_n518_));
  nand3  g362(.a(new_n518_), .b(x069), .c(x021), .O(new_n519_));
  nand2  g363(.a(new_n519_), .b(new_n517_), .O(new_n520_));
  oai21  g364(.a(new_n520_), .b(new_n515_), .c(new_n260_), .O(new_n521_));
  ...
  aoi21  g369(.a(new_n509_), .b(new_n315_), .c(new_n525_), .O(new_n526_));
  oai21  g370(.a(new_n526_), .b(x045), .c(new_n180_), .O(z13));
  inv1   g371(.a(x054), .O(new_n528_));
  nand2  g372(.a(x070), .b(new_n338_), .O(new_n529_));
  aoi21  g373(.a(new_n529_), .b(new_n366_), .c(new_n337_), .O(new_n530_));
  nand3  g374(.a(new_n340_), .b(new_n324_), .c(x030), .O(new_n531_));
  nor2   g375(.a(x022), .b(x014), .O(new_n532_));
  aoi21  g376(.a(new_n532_), .b(new_n531_), .c(x086), .O(new_n533_));
  oai21  g377(.a(new_n533_), .b(new_n530_), .c(new_n346_), .O(new_n534_));
  oai21  g378(.a(x038), .b(x014), .c(x022), .O(new_n535_));
  oai21  g379(.a(new_n330_), .b(x030), .c(new_n535_), .O(new_n536_));
  inv1   g380(.a(x102), .O(new_n537_));
  nand2  g381(.a(new_n345_), .b(new_n537_), .O(new_n538_));
  oai21  g382(.a(new_n340_), .b(new_n333_), .c(new_n538_), .O(new_n539_));
  aoi21  g383(.a(new_n539_), .b(new_n536_), .c(x070), .O(new_n540_));
  nand3  g384(.a(new_n322_), .b(x126), .c(new_n333_), .O(new_n541_));
  nand3  g385(.a(x102), .b(x070), .c(new_n338_), .O(new_n542_));
  nand3  g386(.a(new_n542_), .b(new_n541_), .c(new_n327_), .O(new_n543_));
  oai21  g387(.a(new_n543_), .b(new_n540_), .c(x006), .O(new_n544_));
  oai21  g388(.a(new_n328_), .b(x022), .c(new_n329_), .O(new_n545_));
  and2   g389(.a(new_n545_), .b(x070), .O(new_n546_));
  oai21  g390(.a(x070), .b(x014), .c(x022), .O(new_n547_));
  nand4  g391(.a(new_n547_), .b(new_n538_), .c(new_n340_), .d(x030), .O(new_n548_));
  inv1   g392(.a(new_n548_), .O(new_n549_));
  oai21  g393(.a(new_n549_), .b(new_n546_), .c(new_n327_), .O(new_n550_));
  nand3  g394(.a(new_n550_), .b(new_n544_), .c(new_n534_), .O(new_n551_));
  nand2  g395(.a(new_n538_), .b(x006), .O(new_n552_));
  nand3  g396(.a(new_n327_), .b(x030), .c(new_n332_), .O(new_n553_));
  aoi21  g397(.a(new_n553_), .b(new_n552_), .c(x070), .O(new_n554_));
  nand2  g398(.a(new_n545_), .b(new_n327_), .O(new_n555_));
  nand2  g399(.a(new_n555_), .b(new_n528_), .O(new_n556_));
  oai21  g400(.a(new_n556_), .b(new_n554_), .c(x038), .O(new_n557_));
  oai21  g401(.a(new_n327_), .b(new_n337_), .c(new_n323_), .O(new_n558_));
  nand2  g402(.a(new_n558_), .b(new_n332_), .O(new_n559_));
  nand2  g403(.a(new_n528_), .b(x038), .O(new_n560_));
  nand3  g404(.a(new_n560_), .b(x070), .c(x022), .O(new_n561_));
  nand4  g405(.a(new_n561_), .b(new_n559_), .c(new_n557_), .d(new_n178_), .O(new_n562_));
  aoi21  g406(.a(new_n551_), .b(new_n528_), .c(new_n562_), .O(new_n563_));
  nand3  g407(.a(new_n560_), .b(x086), .c(x006), .O(new_n564_));
  nand3  g408(.a(x070), .b(new_n528_), .c(x022), .O(new_n565_));
  nand3  g409(.a(new_n565_), .b(new_n564_), .c(new_n332_), .O(new_n566_));
  aoi22  g410(.a(new_n566_), .b(x078), .c(x054), .d(x038), .O(new_n567_));
  oai22  g411(.a(new_n567_), .b(x046), .c(new_n563_), .d(x078), .O(z14));
  zero   g412(.O(z15));
  zero   g413(.O(z17));
  zero   g414(.O(z19));
  zero   g415(.O(z20));
  ...
  zero   g417(.O(z22));
  zero   g418(.O(z27));
  nor2   g419(.a(x078), .b(new_n178_), .O(z16));
  nor2   g420(.a(x078), .b(new_n178_), .O(z18));
  nor2   g421(.a(x078), .b(new_n178_), .O(z23));
  nor2   g422(.a(x078), .b(new_n178_), .O(z24));
  nor2   g423(.a(x078), .b(new_n178_), .O(z25));
  nor2   g424(.a(x078), .b(new_n178_), .O(z26));
endmodule
