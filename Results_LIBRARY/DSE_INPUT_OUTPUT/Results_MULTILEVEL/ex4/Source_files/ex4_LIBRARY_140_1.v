...
module FAU ( 
  ...
  aoi21  g383(.a(new_n540_), .b(new_n329_), .c(x086), .O(new_n541_));
  oai21  g384(.a(new_n541_), .b(new_n539_), .c(new_n323_), .O(new_n542_));
  nand2  g385(.a(new_n335_), .b(x014), .O(new_n543_));
  aoi21  g386(.a(new_n543_), .b(new_n542_), .c(new_n347_), .O(new_n544_));
  oai21  g387(.a(x038), .b(x014), .c(x022), .O(new_n545_));
  nand3  g388(.a(new_n357_), .b(new_n356_), .c(new_n355_), .O(new_n546_));
  ...
  nand3  g392(.a(new_n322_), .b(x126), .c(new_n329_), .O(new_n550_));
  nand3  g393(.a(x102), .b(x070), .c(new_n325_), .O(new_n551_));
  nand3  g394(.a(new_n551_), .b(new_n550_), .c(new_n335_), .O(new_n552_));
  oai21  g395(.a(new_n552_), .b(new_n549_), .c(x006), .O(new_n553_));
  aoi21  g396(.a(x030), .b(new_n329_), .c(new_n358_), .O(new_n554_));
  ...
  oai21  g400(.a(new_n554_), .b(new_n330_), .c(new_n557_), .O(new_n558_));
  nand2  g401(.a(new_n558_), .b(new_n335_), .O(new_n559_));
  aoi21  g402(.a(new_n559_), .b(new_n553_), .c(x078), .O(new_n560_));
  oai21  g403(.a(new_n560_), .b(new_n544_), .c(new_n377_), .O(new_n561_));
  nand2  g404(.a(new_n555_), .b(x006), .O(new_n562_));
  nand3  g405(.a(new_n335_), .b(x030), .c(new_n360_), .O(new_n563_));
  ...
  aoi21  g410(.a(new_n567_), .b(new_n326_), .c(x014), .O(new_n568_));
  aoi21  g411(.a(new_n377_), .b(x038), .c(new_n330_), .O(new_n569_));
  ...
  nand3  g420(.a(x070), .b(new_n377_), .c(x022), .O(new_n578_));
  nand4  g421(.a(new_n578_), .b(new_n577_), .c(new_n573_), .d(new_n360_), .O(new_n579_));
