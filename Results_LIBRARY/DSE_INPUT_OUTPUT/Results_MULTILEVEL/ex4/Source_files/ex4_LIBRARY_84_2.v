...
module FAU ( 
  ...
  nand3  g209(.a(new_n157_), .b(new_n351_), .c(new_n345_), .O(new_n366_));
  ...
  aoi22  g225(.a(new_n381_), .b(new_n157_), .c(new_n379_), .d(new_n326_), .O(new_n382_));
  ...
  nand2  g426(.a(new_n583_), .b(x087), .O(new_n584_));
  ...
  zero   g433(.O(z24));
  zero   g434(.O(z26));
  nor2   g435(.a(x087), .b(new_n157_), .O(z17));
  nor2   g436(.a(x087), .b(new_n157_), .O(z18));
  nor2   g437(.a(x087), .b(new_n157_), .O(z19));
  nor2   g438(.a(x087), .b(new_n157_), .O(z22));
  nor2   g439(.a(x087), .b(new_n157_), .O(z25));
  nor2   g440(.a(x087), .b(new_n157_), .O(z27));
endmodule
