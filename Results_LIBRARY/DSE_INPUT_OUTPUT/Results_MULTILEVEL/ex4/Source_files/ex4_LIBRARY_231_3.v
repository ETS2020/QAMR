...
module FAU ( 
  ...
  inv1   g175(.a(new_n178_), .O(z07));
  nand2  g176(.a(x064), .b(new_n173_), .O(new_n333_));
  aoi21  g177(.a(new_n333_), .b(new_n159_), .c(new_n165_), .O(new_n334_));
  nand2  g178(.a(x088), .b(x056), .O(new_n335_));
  nand3  g179(.a(new_n335_), .b(new_n158_), .c(x024), .O(new_n336_));
  aoi21  g180(.a(new_n336_), .b(new_n157_), .c(x080), .O(new_n337_));
  oai21  g181(.a(new_n337_), .b(new_n334_), .c(new_n174_), .O(new_n338_));
  nand2  g182(.a(new_n338_), .b(new_n161_), .O(new_n339_));
  ...
  oai21  g192(.a(new_n335_), .b(new_n157_), .c(new_n348_), .O(new_n349_));
  ...
  oai21  g206(.a(new_n362_), .b(new_n357_), .c(new_n174_), .O(new_n363_));
  ...
  nand3  g210(.a(new_n160_), .b(x024), .c(new_n164_), .O(new_n367_));
  nand2  g211(.a(new_n367_), .b(new_n366_), .O(new_n368_));
  nand2  g212(.a(new_n368_), .b(new_n158_), .O(new_n369_));
  nand2  g213(.a(new_n358_), .b(new_n160_), .O(new_n370_));
  aoi21  g214(.a(new_n370_), .b(new_n369_), .c(new_n173_), .O(new_n371_));
  aoi22  g215(.a(x080), .b(x000), .c(x064), .d(x016), .O(new_n372_));
  nand3  g216(.a(new_n169_), .b(x064), .c(x016), .O(new_n373_));
  oai21  g217(.a(new_n372_), .b(x008), .c(new_n373_), .O(new_n374_));
  oai21  g218(.a(new_n374_), .b(new_n371_), .c(new_n174_), .O(new_n375_));
  nand3  g219(.a(new_n169_), .b(x080), .c(x000), .O(new_n376_));
  ...
  aoi21  g223(.a(new_n365_), .b(new_n168_), .c(new_n379_), .O(new_n380_));
  oai21  g224(.a(new_n380_), .b(x040), .c(new_n178_), .O(z08));
  ...
  oai21  g237(.a(new_n393_), .b(x041), .c(new_n178_), .O(z09));
  ...
  nand3  g251(.a(new_n407_), .b(new_n178_), .c(new_n395_), .O(new_n408_));
  ...
  nand3  g266(.a(new_n422_), .b(new_n178_), .c(new_n410_), .O(new_n423_));
  ...
  oai21  g280(.a(new_n436_), .b(x044), .c(new_n178_), .O(z12));
