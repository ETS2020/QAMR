...
module FAU ( 
  ...
  nor3   g165(.a(new_n321_), .b(z18), .c(new_n259_), .O(z05));
  ...
  nand3  g177(.a(new_n333_), .b(new_n158_), .c(x046), .O(new_n334_));
  ...
  oai21  g275(.a(new_n429_), .b(x012), .c(new_n432_), .O(new_n433_));
  oai21  g276(.a(new_n253_), .b(x036), .c(new_n433_), .O(new_n434_));
  nand2  g277(.a(x084), .b(x004), .O(new_n435_));
  aoi21  g278(.a(new_n435_), .b(new_n429_), .c(x076), .O(new_n436_));
  nand2  g279(.a(new_n436_), .b(new_n247_), .O(new_n437_));
  aoi22  g280(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n438_));
  nand3  g281(.a(new_n438_), .b(new_n437_), .c(new_n434_), .O(new_n439_));
  aoi21  g282(.a(new_n431_), .b(new_n246_), .c(new_n439_), .O(new_n440_));
  oai21  g283(.a(new_n440_), .b(x044), .c(new_n160_), .O(z12));
  ...
  oai21  g338(.a(new_n495_), .b(new_n492_), .c(new_n158_), .O(new_n496_));
  ...
  oai21  g371(.a(new_n528_), .b(new_n524_), .c(new_n158_), .O(new_n529_));
  ...
  nand4  g377(.a(new_n534_), .b(new_n533_), .c(new_n532_), .d(new_n157_), .O(new_n535_));
