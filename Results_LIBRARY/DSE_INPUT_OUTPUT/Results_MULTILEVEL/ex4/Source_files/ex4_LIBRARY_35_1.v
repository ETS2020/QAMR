...
module FAU ( 
  ...
  nand2  g001(.a(x119), .b(new_n157_), .O(new_n158_));
  ...
  nand3  g347(.a(new_n258_), .b(x125), .c(new_n264_), .O(new_n504_));
  ...
  zero   g432(.O(z26));
  zero   g433(.O(z27));
  inv1   g434(.a(new_n158_), .O(z16));
  inv1   g435(.a(new_n158_), .O(z20));
  inv1   g436(.a(new_n158_), .O(z21));
