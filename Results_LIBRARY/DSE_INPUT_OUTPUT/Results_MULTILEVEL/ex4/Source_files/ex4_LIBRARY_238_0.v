...
module FAU ( 
  ...
  oai21  g227(.a(new_n383_), .b(new_n322_), .c(new_n179_), .O(z06));
  ...
  oai22  g242(.a(new_n388_), .b(new_n157_), .c(x120), .d(x096), .O(new_n400_));
  ...
  oai21  g259(.a(new_n416_), .b(new_n408_), .c(new_n174_), .O(new_n417_));
  ...
  oai21  g263(.a(new_n412_), .b(new_n165_), .c(new_n420_), .O(new_n421_));
  nand2  g264(.a(new_n421_), .b(new_n158_), .O(new_n422_));
  nand2  g265(.a(new_n410_), .b(new_n160_), .O(new_n423_));
  ...
  aoi21  g275(.a(new_n419_), .b(new_n168_), .c(new_n432_), .O(new_n433_));
  nor3   g276(.a(new_n433_), .b(z17), .c(x040), .O(z08));
  nand2  g277(.a(x065), .b(x017), .O(new_n435_));
  nand3  g278(.a(x081), .b(new_n188_), .c(x001), .O(new_n436_));
  oai21  g279(.a(new_n435_), .b(new_n188_), .c(new_n436_), .O(new_n437_));
  ...
  aoi21  g288(.a(new_n437_), .b(new_n187_), .c(new_n445_), .O(new_n446_));
  ...
  oai21  g426(.a(new_n583_), .b(x046), .c(new_n179_), .O(z14));
  zero   g427(.O(z07));
  zero   g428(.O(z15));
  zero   g429(.O(z16));
  zero   g430(.O(z21));
  zero   g431(.O(z24));
  nor2   g432(.a(x113), .b(x090), .O(z18));
  nor2   g433(.a(x113), .b(x090), .O(z19));
  nor2   g434(.a(x113), .b(x090), .O(z20));
  nor2   g435(.a(x113), .b(x090), .O(z22));
  nor2   g436(.a(x113), .b(x090), .O(z23));
  nor2   g437(.a(x113), .b(x090), .O(z25));
  nor2   g438(.a(x113), .b(x090), .O(z26));
  nor2   g439(.a(x113), .b(x090), .O(z27));
endmodule
