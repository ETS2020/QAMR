...
module FAU ( 
  ...
  nor3   g163(.a(new_n319_), .b(z19), .c(new_n257_), .O(z05));
  ...
  oai21  g328(.a(new_n485_), .b(x044), .c(new_n158_), .O(z12));
  ...
  nand2  g377(.a(new_n361_), .b(x038), .O(new_n535_));
  nand3  g378(.a(new_n535_), .b(x086), .c(x006), .O(new_n536_));
  nand2  g379(.a(x054), .b(x038), .O(new_n537_));
  nand3  g380(.a(x070), .b(new_n361_), .c(x022), .O(new_n538_));
  nand4  g381(.a(new_n538_), .b(new_n537_), .c(new_n536_), .d(new_n333_), .O(new_n539_));
  nand3  g382(.a(new_n539_), .b(x078), .c(new_n534_), .O(new_n540_));
  inv1   g383(.a(new_n540_), .O(z14));
  zero   g384(.O(z07));
  zero   g385(.O(z15));
  zero   g386(.O(z16));
  zero   g387(.O(z17));
