...
module FAU ( 
  ...
  nor3   g163(.a(new_n319_), .b(z18), .c(new_n257_), .O(z05));
  ...
  oai21  g237(.a(new_n381_), .b(new_n159_), .c(new_n394_), .O(new_n395_));
  ...
  aoi21  g245(.a(new_n402_), .b(new_n397_), .c(new_n167_), .O(new_n403_));
  ...
  nand3  g311(.a(new_n468_), .b(new_n158_), .c(new_n456_), .O(new_n469_));
  ...
  oai21  g325(.a(new_n482_), .b(x044), .c(new_n158_), .O(z12));
