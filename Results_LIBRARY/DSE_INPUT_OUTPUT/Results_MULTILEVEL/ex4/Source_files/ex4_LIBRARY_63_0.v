...
module FAU ( 
  ...
  nand3  g286(.a(x082), .b(new_n207_), .c(x002), .O(new_n443_));
  oai21  g287(.a(new_n442_), .b(new_n207_), .c(new_n443_), .O(new_n444_));
  ...
  aoi21  g296(.a(new_n444_), .b(new_n206_), .c(new_n452_), .O(new_n453_));
