...
module FAU ( 
  ...
  oai21  g272(.a(new_n428_), .b(x040), .c(new_n180_), .O(z08));
  ...
  nand2  g327(.a(new_n286_), .b(new_n285_), .O(new_n484_));
  nand2  g328(.a(new_n288_), .b(new_n281_), .O(new_n485_));
  ...
  nand2  g351(.a(new_n507_), .b(new_n289_), .O(new_n508_));
  ...
  oai21  g355(.a(new_n511_), .b(new_n504_), .c(new_n260_), .O(new_n512_));
  ...
  nand2  g361(.a(new_n517_), .b(new_n288_), .O(new_n518_));
  nand2  g362(.a(new_n505_), .b(new_n274_), .O(new_n519_));
  ...
  nand2  g366(.a(new_n316_), .b(x037), .O(new_n523_));
  ...
  aoi21  g374(.a(new_n514_), .b(new_n316_), .c(new_n530_), .O(new_n531_));
  nor3   g375(.a(new_n531_), .b(z07), .c(x045), .O(z13));
  inv1   g376(.a(x054), .O(new_n533_));
  nand2  g377(.a(x070), .b(new_n326_), .O(new_n534_));
  aoi21  g378(.a(new_n534_), .b(new_n371_), .c(new_n325_), .O(new_n535_));
  nand3  g379(.a(new_n340_), .b(new_n331_), .c(x030), .O(new_n536_));
  ...
  oai21  g384(.a(new_n356_), .b(x030), .c(new_n540_), .O(new_n541_));
  ...
  oai21  g393(.a(new_n353_), .b(x022), .c(new_n332_), .O(new_n550_));
  ...
  nand3  g401(.a(new_n336_), .b(x030), .c(new_n358_), .O(new_n558_));
  aoi21  g402(.a(new_n558_), .b(new_n557_), .c(x070), .O(new_n559_));
  nand2  g403(.a(new_n550_), .b(new_n336_), .O(new_n560_));
  nand2  g404(.a(new_n560_), .b(new_n533_), .O(new_n561_));
  oai21  g405(.a(new_n561_), .b(new_n559_), .c(x038), .O(new_n562_));
  nand2  g406(.a(x086), .b(x006), .O(new_n563_));
  aoi21  g407(.a(new_n563_), .b(new_n327_), .c(x014), .O(new_n564_));
  aoi21  g408(.a(new_n533_), .b(x038), .c(new_n331_), .O(new_n565_));
  aoi21  g409(.a(new_n565_), .b(x022), .c(new_n564_), .O(new_n566_));
  nand2  g410(.a(new_n566_), .b(new_n562_), .O(new_n567_));
  aoi21  g411(.a(new_n556_), .b(new_n533_), .c(new_n567_), .O(new_n568_));
  nor3   g412(.a(new_n568_), .b(x078), .c(x046), .O(z14));
  zero   g413(.O(z15));
  zero   g414(.O(z16));
  zero   g415(.O(z17));
  zero   g416(.O(z20));
