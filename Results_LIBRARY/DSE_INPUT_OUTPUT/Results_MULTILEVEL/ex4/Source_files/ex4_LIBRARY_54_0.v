...
module FAU ( 
  ...
  nor2   g021(.a(x078), .b(x046), .O(z21));
  inv1   g022(.a(z21), .O(new_n179_));
  ...
  nand2  g382(.a(new_n539_), .b(x038), .O(new_n540_));
  nand3  g383(.a(new_n540_), .b(x086), .c(x006), .O(new_n541_));
  aoi21  g384(.a(x054), .b(x038), .c(x014), .O(new_n542_));
  nand3  g385(.a(x070), .b(new_n539_), .c(x022), .O(new_n543_));
  nand3  g386(.a(new_n543_), .b(new_n542_), .c(x078), .O(new_n544_));
  inv1   g387(.a(new_n544_), .O(new_n545_));
  aoi21  g388(.a(new_n545_), .b(new_n541_), .c(x046), .O(z14));
  zero   g389(.O(z07));
  zero   g390(.O(z15));
  zero   g391(.O(z16));
  zero   g392(.O(z17));
  ...
  zero   g396(.O(z22));
  zero   g397(.O(z26));
  nor2   g398(.a(x078), .b(x046), .O(z23));
  nor2   g399(.a(x078), .b(x046), .O(z24));
  nor2   g400(.a(x078), .b(x046), .O(z25));
  nor2   g401(.a(x078), .b(x046), .O(z27));
endmodule
