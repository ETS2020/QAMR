...
module FAU ( 
  ...
  nand2  g373(.a(x070), .b(new_n339_), .O(new_n530_));
  aoi21  g374(.a(new_n530_), .b(new_n367_), .c(new_n338_), .O(new_n531_));
  nand3  g375(.a(new_n341_), .b(new_n325_), .c(x030), .O(new_n532_));
  nor2   g376(.a(x022), .b(x014), .O(new_n533_));
  aoi21  g377(.a(new_n533_), .b(new_n532_), .c(x086), .O(new_n534_));
  oai21  g378(.a(new_n534_), .b(new_n531_), .c(new_n347_), .O(new_n535_));
  oai21  g379(.a(x038), .b(x014), .c(x022), .O(new_n536_));
  oai21  g380(.a(new_n331_), .b(x030), .c(new_n536_), .O(new_n537_));
  inv1   g381(.a(x102), .O(new_n538_));
  nand2  g382(.a(new_n346_), .b(new_n538_), .O(new_n539_));
  oai21  g383(.a(new_n341_), .b(new_n334_), .c(new_n539_), .O(new_n540_));
  aoi21  g384(.a(new_n540_), .b(new_n537_), .c(x070), .O(new_n541_));
  nand3  g385(.a(new_n323_), .b(x126), .c(new_n334_), .O(new_n542_));
  nand3  g386(.a(x102), .b(x070), .c(new_n339_), .O(new_n543_));
  nand3  g387(.a(new_n543_), .b(new_n542_), .c(new_n328_), .O(new_n544_));
  oai21  g388(.a(new_n544_), .b(new_n541_), .c(x006), .O(new_n545_));
  oai21  g389(.a(new_n329_), .b(x022), .c(new_n330_), .O(new_n546_));
  and2   g390(.a(new_n546_), .b(x070), .O(new_n547_));
  oai21  g391(.a(x070), .b(x014), .c(x022), .O(new_n548_));
  nand4  g392(.a(new_n548_), .b(new_n539_), .c(new_n341_), .d(x030), .O(new_n549_));
  inv1   g393(.a(new_n549_), .O(new_n550_));
  oai21  g394(.a(new_n550_), .b(new_n547_), .c(new_n328_), .O(new_n551_));
  nand3  g395(.a(new_n551_), .b(new_n545_), .c(new_n535_), .O(new_n552_));
  nand2  g396(.a(new_n539_), .b(x006), .O(new_n553_));
  nand3  g397(.a(new_n328_), .b(x030), .c(new_n333_), .O(new_n554_));
  aoi21  g398(.a(new_n554_), .b(new_n553_), .c(x070), .O(new_n555_));
  nand2  g399(.a(new_n546_), .b(new_n328_), .O(new_n556_));
  nand2  g400(.a(new_n556_), .b(new_n529_), .O(new_n557_));
  oai21  g401(.a(new_n557_), .b(new_n555_), .c(x038), .O(new_n558_));
  oai21  g402(.a(new_n328_), .b(new_n338_), .c(new_n324_), .O(new_n559_));
  nand2  g403(.a(new_n559_), .b(new_n333_), .O(new_n560_));
  nand2  g404(.a(new_n529_), .b(x038), .O(new_n561_));
  nand3  g405(.a(new_n561_), .b(x070), .c(x022), .O(new_n562_));
  nand4  g406(.a(new_n562_), .b(new_n560_), .c(new_n558_), .d(new_n178_), .O(new_n563_));
  aoi21  g407(.a(new_n552_), .b(new_n529_), .c(new_n563_), .O(new_n564_));
  nand3  g408(.a(new_n561_), .b(x086), .c(x006), .O(new_n565_));
  nand3  g409(.a(x070), .b(new_n529_), .c(x022), .O(new_n566_));
  nand3  g410(.a(new_n566_), .b(new_n565_), .c(new_n333_), .O(new_n567_));
  aoi22  g411(.a(new_n567_), .b(x078), .c(x054), .d(x038), .O(new_n568_));
  oai22  g412(.a(new_n568_), .b(x046), .c(new_n564_), .d(x078), .O(z14));
  zero   g413(.O(z15));
  zero   g414(.O(z16));
  zero   g415(.O(z17));
  zero   g416(.O(z21));
