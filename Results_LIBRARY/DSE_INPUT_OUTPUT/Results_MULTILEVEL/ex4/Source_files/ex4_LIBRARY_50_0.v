...
module FAU ( 
  ...
  oai22  g236(.a(new_n381_), .b(new_n159_), .c(x120), .d(x096), .O(new_n393_));
  ...
  nand3  g240(.a(new_n396_), .b(x120), .c(new_n159_), .O(new_n397_));
  nand3  g241(.a(x096), .b(x064), .c(new_n175_), .O(new_n398_));
  nand3  g242(.a(new_n398_), .b(new_n397_), .c(new_n162_), .O(new_n399_));
  inv1   g243(.a(new_n399_), .O(new_n400_));
  aoi21  g244(.a(new_n400_), .b(new_n395_), .c(new_n167_), .O(new_n401_));
  ...
  oai21  g253(.a(new_n409_), .b(new_n401_), .c(new_n176_), .O(new_n410_));
  ...
  oai21  g257(.a(new_n405_), .b(new_n167_), .c(new_n413_), .O(new_n414_));
  nand2  g258(.a(new_n414_), .b(new_n160_), .O(new_n415_));
  nand2  g259(.a(new_n403_), .b(new_n162_), .O(new_n416_));
  ...
  aoi21  g269(.a(new_n412_), .b(new_n170_), .c(new_n425_), .O(new_n426_));
