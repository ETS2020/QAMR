...
module FAU ( 
  ...
  nand2  g001(.a(new_n157_), .b(x023), .O(new_n158_));
  ...
  nand3  g395(.a(new_n320_), .b(x126), .c(new_n326_), .O(new_n553_));
  ...
  zero   g430(.O(z22));
  zero   g431(.O(z27));
  inv1   g432(.a(new_n158_), .O(z16));
  inv1   g433(.a(new_n158_), .O(z17));
  inv1   g434(.a(new_n158_), .O(z19));
  inv1   g435(.a(new_n158_), .O(z23));
  inv1   g436(.a(new_n158_), .O(z24));
  inv1   g437(.a(new_n158_), .O(z25));
  inv1   g438(.a(new_n158_), .O(z26));
endmodule
