...
module FAU ( 
  ...
  nand3  g306(.a(new_n462_), .b(new_n181_), .c(new_n450_), .O(new_n463_));
  ...
  aoi21  g386(.a(new_n542_), .b(new_n340_), .c(x086), .O(new_n543_));
  oai21  g387(.a(new_n543_), .b(new_n541_), .c(new_n178_), .O(new_n544_));
  oai21  g388(.a(x086), .b(new_n336_), .c(new_n544_), .O(new_n545_));
  ...
  nand4  g406(.a(new_n562_), .b(new_n550_), .c(new_n356_), .d(x030), .O(new_n563_));
  ...
  nand3  g412(.a(new_n328_), .b(x030), .c(new_n336_), .O(new_n569_));
  ...
  aoi21  g416(.a(new_n572_), .b(new_n571_), .c(new_n364_), .O(new_n573_));
  oai21  g417(.a(new_n328_), .b(new_n339_), .c(new_n324_), .O(new_n574_));
  nand2  g418(.a(new_n574_), .b(new_n336_), .O(new_n575_));
  nand2  g419(.a(new_n365_), .b(x038), .O(new_n576_));
  ...
  nand2  g424(.a(new_n580_), .b(new_n336_), .O(new_n581_));
  aoi22  g425(.a(new_n581_), .b(x078), .c(x054), .d(x038), .O(new_n582_));
  nand2  g426(.a(new_n582_), .b(new_n579_), .O(new_n583_));
  aoi21  g427(.a(new_n567_), .b(new_n365_), .c(new_n583_), .O(new_n584_));
  ...
  zero   g432(.O(z25));
  zero   g433(.O(z27));
  nor2   g434(.a(new_n179_), .b(new_n178_), .O(z18));
