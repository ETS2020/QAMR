...
module FAU ( 
  ...
  nand2  g290(.a(new_n447_), .b(new_n206_), .O(new_n448_));
  ...
  oai22  g296(.a(new_n214_), .b(new_n207_), .c(new_n213_), .d(new_n206_), .O(new_n454_));
  aoi21  g297(.a(new_n453_), .b(new_n207_), .c(new_n454_), .O(new_n455_));
  nand3  g298(.a(new_n455_), .b(new_n451_), .c(new_n448_), .O(new_n456_));
  nand3  g299(.a(new_n456_), .b(new_n179_), .c(new_n444_), .O(new_n457_));
