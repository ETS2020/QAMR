...
module FAU ( 
  ...
  nor2   g022(.a(x113), .b(new_n178_), .O(z15));
  ...
  oai21  g224(.a(new_n380_), .b(new_n320_), .c(new_n180_), .O(z06));
  ...
  nand3  g315(.a(new_n472_), .b(new_n180_), .c(new_n460_), .O(new_n473_));
  ...
  nand3  g393(.a(new_n321_), .b(x126), .c(new_n327_), .O(new_n551_));
  ...
  oai21  g403(.a(new_n560_), .b(new_n555_), .c(new_n178_), .O(new_n561_));
  ...
  oai21  g417(.a(new_n574_), .b(new_n569_), .c(new_n178_), .O(new_n575_));
  ...
  zero   g429(.O(z24));
  zero   g430(.O(z26));
  nor2   g431(.a(x113), .b(new_n178_), .O(z16));
  nor2   g432(.a(x113), .b(new_n178_), .O(z17));
  nor2   g433(.a(x113), .b(new_n178_), .O(z20));
  nor2   g434(.a(x113), .b(new_n178_), .O(z21));
  nor2   g435(.a(x113), .b(new_n178_), .O(z25));
  nor2   g436(.a(x113), .b(new_n178_), .O(z27));
endmodule
