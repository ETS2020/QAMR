...
module FAU ( 
  ...
  nand2  g329(.a(new_n285_), .b(new_n284_), .O(new_n486_));
  nand2  g330(.a(new_n287_), .b(new_n280_), .O(new_n487_));
  ...
  oai22  g342(.a(new_n490_), .b(new_n280_), .c(x125), .d(x101), .O(new_n499_));
  ...
  oai21  g357(.a(new_n513_), .b(new_n506_), .c(new_n259_), .O(new_n514_));
  ...
  nand3  g361(.a(new_n273_), .b(x029), .c(new_n297_), .O(new_n518_));
  nand2  g362(.a(new_n518_), .b(new_n517_), .O(new_n519_));
  nand2  g363(.a(new_n519_), .b(new_n287_), .O(new_n520_));
  nand2  g364(.a(new_n507_), .b(new_n273_), .O(new_n521_));
  ...
  nand2  g379(.a(new_n535_), .b(x038), .O(new_n536_));
  nand3  g380(.a(new_n536_), .b(x086), .c(x006), .O(new_n537_));
  nand2  g381(.a(x054), .b(x038), .O(new_n538_));
  nand3  g382(.a(x070), .b(new_n535_), .c(x022), .O(new_n539_));
  nand4  g383(.a(new_n539_), .b(new_n538_), .c(new_n537_), .d(new_n357_), .O(new_n540_));
  nand3  g384(.a(new_n540_), .b(x078), .c(new_n322_), .O(new_n541_));
