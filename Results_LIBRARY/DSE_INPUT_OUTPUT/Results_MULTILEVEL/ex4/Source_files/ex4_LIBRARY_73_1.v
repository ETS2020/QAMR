...
module FAU ( 
  ...
  oai21  g267(.a(new_n423_), .b(x040), .c(new_n180_), .O(z08));
  ...
  nand3  g281(.a(new_n437_), .b(new_n180_), .c(new_n425_), .O(new_n438_));
  ...
  oai21  g295(.a(new_n451_), .b(x042), .c(new_n180_), .O(z10));
