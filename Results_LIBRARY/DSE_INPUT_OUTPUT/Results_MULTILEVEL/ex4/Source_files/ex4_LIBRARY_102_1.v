...
module FAU ( 
  ...
  nand3  g328(.a(new_n485_), .b(new_n159_), .c(new_n473_), .O(new_n486_));
  ...
  oai21  g376(.a(new_n533_), .b(x045), .c(new_n159_), .O(z13));
  ...
  oai21  g394(.a(new_n352_), .b(x022), .c(new_n331_), .O(new_n552_));
  ...
  nand3  g400(.a(new_n557_), .b(new_n551_), .c(new_n541_), .O(new_n558_));
  ...
  nand2  g404(.a(new_n552_), .b(new_n335_), .O(new_n562_));
  nand2  g405(.a(new_n562_), .b(new_n535_), .O(new_n563_));
  oai21  g406(.a(new_n563_), .b(new_n561_), .c(x038), .O(new_n564_));
  nand2  g407(.a(x086), .b(x006), .O(new_n565_));
  aoi21  g408(.a(new_n565_), .b(new_n326_), .c(x014), .O(new_n566_));
  aoi21  g409(.a(new_n535_), .b(x038), .c(new_n330_), .O(new_n567_));
  aoi21  g410(.a(new_n567_), .b(x022), .c(new_n566_), .O(new_n568_));
  nand2  g411(.a(new_n568_), .b(new_n564_), .O(new_n569_));
  aoi21  g412(.a(new_n558_), .b(new_n535_), .c(new_n569_), .O(new_n570_));
  nor3   g413(.a(new_n570_), .b(x078), .c(x046), .O(z14));
  zero   g414(.O(z07));
  zero   g415(.O(z15));
  zero   g416(.O(z16));
  zero   g417(.O(z17));
