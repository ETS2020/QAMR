...
module FAU ( 
  ...
  oai21  g230(.a(new_n374_), .b(new_n157_), .c(new_n387_), .O(new_n388_));
  ...
  nand3  g234(.a(new_n391_), .b(x120), .c(new_n157_), .O(new_n392_));
  nand3  g235(.a(x096), .b(x064), .c(new_n173_), .O(new_n393_));
  nand3  g236(.a(new_n393_), .b(new_n392_), .c(new_n160_), .O(new_n394_));
  inv1   g237(.a(new_n394_), .O(new_n395_));
  aoi21  g238(.a(new_n395_), .b(new_n390_), .c(new_n165_), .O(new_n396_));
  ...
  oai21  g244(.a(new_n401_), .b(new_n396_), .c(new_n174_), .O(new_n402_));
  ...
  nand2  g251(.a(new_n397_), .b(new_n160_), .O(new_n409_));
  ...
  aoi21  g261(.a(new_n404_), .b(new_n168_), .c(new_n418_), .O(new_n419_));
  oai21  g262(.a(new_n419_), .b(x040), .c(new_n180_), .O(z08));
  ...
  nor3   g365(.a(new_n522_), .b(z15), .c(x045), .O(z13));
