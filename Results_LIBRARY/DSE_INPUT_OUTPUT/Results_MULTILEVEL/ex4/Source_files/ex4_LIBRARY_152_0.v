...
module FAU ( 
  ...
  nor3   g269(.a(new_n426_), .b(z16), .c(x040), .O(z08));
  ...
  oai21  g282(.a(new_n439_), .b(x041), .c(new_n179_), .O(z09));
  ...
  nand3  g296(.a(new_n453_), .b(new_n179_), .c(new_n441_), .O(new_n454_));
