...
module FAU ( 
  ...
  oai21  g221(.a(new_n370_), .b(new_n178_), .c(new_n377_), .O(z06));
  ...
  oai21  g283(.a(new_n439_), .b(x041), .c(new_n180_), .O(z09));
  ...
  nand2  g374(.a(x070), .b(new_n339_), .O(new_n531_));
  aoi21  g375(.a(new_n531_), .b(new_n364_), .c(new_n338_), .O(new_n532_));
  nand3  g376(.a(new_n341_), .b(new_n325_), .c(x030), .O(new_n533_));
  ...
  nand2  g383(.a(new_n346_), .b(new_n539_), .O(new_n540_));
  oai21  g384(.a(new_n341_), .b(new_n334_), .c(new_n540_), .O(new_n541_));
  aoi21  g385(.a(new_n541_), .b(new_n538_), .c(x070), .O(new_n542_));
  nand3  g386(.a(new_n323_), .b(x126), .c(new_n334_), .O(new_n543_));
  nand3  g387(.a(x102), .b(x070), .c(new_n339_), .O(new_n544_));
  nand3  g388(.a(new_n544_), .b(new_n543_), .c(new_n328_), .O(new_n545_));
  oai21  g389(.a(new_n545_), .b(new_n542_), .c(x006), .O(new_n546_));
  oai21  g390(.a(new_n329_), .b(x022), .c(new_n330_), .O(new_n547_));
  and2   g391(.a(new_n547_), .b(x070), .O(new_n548_));
  oai21  g392(.a(x070), .b(x014), .c(x022), .O(new_n549_));
  nand4  g393(.a(new_n549_), .b(new_n540_), .c(new_n341_), .d(x030), .O(new_n550_));
  inv1   g394(.a(new_n550_), .O(new_n551_));
  oai21  g395(.a(new_n551_), .b(new_n548_), .c(new_n328_), .O(new_n552_));
  nand3  g396(.a(new_n552_), .b(new_n546_), .c(new_n536_), .O(new_n553_));
  nand2  g397(.a(new_n540_), .b(x006), .O(new_n554_));
  nand3  g398(.a(new_n328_), .b(x030), .c(new_n333_), .O(new_n555_));
  aoi21  g399(.a(new_n555_), .b(new_n554_), .c(x070), .O(new_n556_));
  nand2  g400(.a(new_n547_), .b(new_n328_), .O(new_n557_));
  ...
  aoi21  g405(.a(new_n372_), .b(x038), .c(new_n325_), .O(new_n562_));
  aoi21  g406(.a(new_n562_), .b(x022), .c(new_n561_), .O(new_n563_));
  nand2  g407(.a(new_n563_), .b(new_n559_), .O(new_n564_));
  aoi21  g408(.a(new_n553_), .b(new_n372_), .c(new_n564_), .O(new_n565_));
  ...
  nor2   g418(.a(new_n178_), .b(x046), .O(z17));
  nor2   g419(.a(new_n178_), .b(x046), .O(z20));
  nor2   g420(.a(new_n178_), .b(x046), .O(z22));
