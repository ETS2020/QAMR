...
module FAU ( 
  ...
  oai21  g242(.a(new_n385_), .b(new_n159_), .c(new_n398_), .O(new_n399_));
  nand2  g243(.a(new_n399_), .b(new_n395_), .O(new_n400_));
  nand2  g244(.a(new_n400_), .b(new_n160_), .O(new_n401_));
  nand2  g245(.a(x112), .b(x104), .O(new_n402_));
  nand3  g246(.a(new_n402_), .b(x120), .c(new_n159_), .O(new_n403_));
  nand3  g247(.a(x096), .b(x064), .c(new_n175_), .O(new_n404_));
  nand3  g248(.a(new_n404_), .b(new_n403_), .c(new_n162_), .O(new_n405_));
  inv1   g249(.a(new_n405_), .O(new_n406_));
  aoi21  g250(.a(new_n406_), .b(new_n401_), .c(new_n167_), .O(new_n407_));
  oai21  g251(.a(new_n392_), .b(x016), .c(new_n393_), .O(new_n408_));
  nand2  g252(.a(new_n408_), .b(x064), .O(new_n409_));
  oai21  g253(.a(x064), .b(x008), .c(x016), .O(new_n410_));
  nand4  g254(.a(new_n410_), .b(new_n398_), .c(new_n385_), .d(x024), .O(new_n411_));
  aoi21  g255(.a(new_n411_), .b(new_n409_), .c(x080), .O(new_n412_));
  oai21  g256(.a(new_n412_), .b(new_n407_), .c(new_n176_), .O(new_n413_));
  nand3  g257(.a(x072), .b(x064), .c(x016), .O(new_n414_));
  nand3  g258(.a(new_n414_), .b(new_n413_), .c(new_n390_), .O(new_n415_));
  ...
  nand2  g263(.a(new_n408_), .b(new_n162_), .O(new_n420_));
  ...
  aoi21  g273(.a(new_n415_), .b(new_n170_), .c(new_n429_), .O(new_n430_));
  oai21  g274(.a(new_n430_), .b(x040), .c(new_n158_), .O(z08));
  ...
  oai21  g377(.a(new_n533_), .b(x045), .c(new_n158_), .O(z13));
