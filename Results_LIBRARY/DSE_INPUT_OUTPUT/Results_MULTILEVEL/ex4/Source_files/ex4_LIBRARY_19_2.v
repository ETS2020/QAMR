...
module FAU ( 
  ...
  inv1   g009(.a(x077), .O(new_n166_));
  oai21  g010(.a(new_n166_), .b(new_n165_), .c(x048), .O(new_n167_));
  nand2  g011(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  ...
  aoi22  g023(.a(new_n179_), .b(new_n169_), .c(new_n177_), .d(x077), .O(new_n180_));
  aoi21  g024(.a(new_n180_), .b(new_n168_), .c(new_n157_), .O(z00));
  nor2   g025(.a(x077), .b(new_n169_), .O(z17));
  ...
  aoi21  g117(.a(new_n273_), .b(new_n266_), .c(new_n166_), .O(new_n274_));
  ...
  nand3  g147(.a(new_n166_), .b(new_n291_), .c(new_n282_), .O(new_n304_));
  ...
  aoi22  g162(.a(new_n318_), .b(new_n166_), .c(new_n316_), .d(new_n263_), .O(new_n319_));
  ...
  nand3  g233(.a(x064), .b(new_n169_), .c(x016), .O(new_n391_));
  nand4  g234(.a(x080), .b(x077), .c(x048), .d(x000), .O(new_n392_));
  ...
  nand3  g239(.a(new_n396_), .b(x077), .c(x048), .O(new_n397_));
  ...
  oai21  g276(.a(new_n433_), .b(new_n417_), .c(new_n169_), .O(new_n434_));
  ...
  oai21  g342(.a(new_n499_), .b(new_n497_), .c(new_n166_), .O(new_n500_));
  ...
  oai21  g360(.a(new_n517_), .b(new_n512_), .c(new_n166_), .O(new_n518_));
  ...
  oai21  g374(.a(new_n531_), .b(new_n526_), .c(new_n166_), .O(new_n532_));
  ...
  zero   g434(.O(z24));
  zero   g435(.O(z26));
  nor2   g436(.a(x077), .b(new_n169_), .O(z25));
  nor2   g437(.a(x077), .b(new_n169_), .O(z27));
endmodule
