...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x046), .O(z17));
  ...
  nor3   g164(.a(new_n320_), .b(z17), .c(new_n258_), .O(z05));
  ...
  oai21  g239(.a(new_n383_), .b(new_n160_), .c(new_n396_), .O(new_n397_));
  ...
  nand3  g243(.a(new_n400_), .b(x120), .c(new_n160_), .O(new_n401_));
  nand3  g244(.a(x096), .b(x064), .c(new_n176_), .O(new_n402_));
  nand3  g245(.a(new_n402_), .b(new_n401_), .c(new_n163_), .O(new_n403_));
  inv1   g246(.a(new_n403_), .O(new_n404_));
  aoi21  g247(.a(new_n404_), .b(new_n399_), .c(new_n168_), .O(new_n405_));
  ...
  oai21  g253(.a(new_n410_), .b(new_n405_), .c(new_n177_), .O(new_n411_));
  ...
  nand2  g260(.a(new_n406_), .b(new_n163_), .O(new_n418_));
  ...
  aoi21  g270(.a(new_n413_), .b(new_n171_), .c(new_n427_), .O(new_n428_));
  oai21  g271(.a(new_n428_), .b(x040), .c(new_n159_), .O(z08));
  ...
  nand3  g286(.a(x082), .b(new_n208_), .c(x002), .O(new_n444_));
  oai21  g287(.a(new_n443_), .b(new_n208_), .c(new_n444_), .O(new_n445_));
  ...
  aoi21  g296(.a(new_n445_), .b(new_n207_), .c(new_n453_), .O(new_n454_));
  oai21  g297(.a(new_n454_), .b(x042), .c(new_n159_), .O(z10));
  ...
  zero   g418(.O(z22));
  zero   g419(.O(z26));
  nor2   g420(.a(new_n157_), .b(x046), .O(z20));
  nor2   g421(.a(new_n157_), .b(x046), .O(z23));
  nor2   g422(.a(new_n157_), .b(x046), .O(z24));
  nor2   g423(.a(new_n157_), .b(x046), .O(z25));
  nor2   g424(.a(new_n157_), .b(x046), .O(z27));
endmodule
