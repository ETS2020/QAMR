...
module FAU ( 
  ...
  nor2   g022(.a(new_n178_), .b(x012), .O(z07));
  ...
  nand3  g208(.a(new_n178_), .b(new_n330_), .c(new_n329_), .O(new_n365_));
  ...
  aoi22  g223(.a(new_n379_), .b(new_n178_), .c(new_n377_), .d(new_n325_), .O(new_n380_));
  nand2  g224(.a(new_n380_), .b(new_n376_), .O(new_n381_));
  aoi21  g225(.a(new_n366_), .b(x054), .c(new_n381_), .O(new_n382_));
  oai21  g226(.a(new_n382_), .b(new_n322_), .c(new_n180_), .O(z06));
  ...
  oai21  g275(.a(new_n431_), .b(x040), .c(new_n180_), .O(z08));
  ...
  aoi21  g287(.a(new_n435_), .b(new_n188_), .c(new_n443_), .O(new_n444_));
  ...
  nand4  g318(.a(x084), .b(new_n178_), .c(new_n246_), .d(x004), .O(new_n475_));
  oai21  g319(.a(new_n474_), .b(new_n246_), .c(new_n475_), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(new_n245_), .O(new_n477_));
  oai21  g321(.a(new_n241_), .b(new_n240_), .c(new_n252_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(x012), .O(new_n479_));
  oai21  g323(.a(new_n474_), .b(x012), .c(new_n252_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n178_), .O(new_n481_));
  aoi21  g325(.a(new_n481_), .b(new_n479_), .c(new_n245_), .O(new_n482_));
  nand3  g326(.a(new_n178_), .b(new_n253_), .c(new_n246_), .O(new_n483_));
  oai21  g327(.a(x052), .b(new_n246_), .c(new_n483_), .O(new_n484_));
  nand3  g328(.a(new_n484_), .b(x084), .c(x004), .O(new_n485_));
  aoi21  g329(.a(x076), .b(x052), .c(x078), .O(new_n486_));
  nand4  g330(.a(new_n486_), .b(x068), .c(x020), .d(new_n246_), .O(new_n487_));
  nand2  g331(.a(x076), .b(x012), .O(new_n488_));
  nand3  g332(.a(new_n488_), .b(new_n487_), .c(new_n485_), .O(new_n489_));
  nor2   g333(.a(new_n489_), .b(new_n482_), .O(new_n490_));
  ...
  zero   g432(.O(z25));
  zero   g433(.O(z27));
  nor2   g434(.a(new_n178_), .b(x012), .O(z15));
  nor2   g435(.a(new_n178_), .b(x012), .O(z16));
  nor2   g436(.a(new_n178_), .b(x012), .O(z19));
  nor2   g437(.a(new_n178_), .b(x012), .O(z23));
  nor2   g438(.a(new_n178_), .b(x012), .O(z24));
  nor2   g439(.a(new_n178_), .b(x012), .O(z26));
endmodule
