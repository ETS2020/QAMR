...
module FAU ( 
  ...
  oai21  g409(.a(new_n566_), .b(new_n560_), .c(new_n540_), .O(new_n567_));
  ...
  oai21  g423(.a(new_n580_), .b(new_n575_), .c(new_n540_), .O(new_n581_));
  ...
  nor2   g442(.a(x078), .b(new_n178_), .O(z27));
endmodule
