...
module FAU ( 
  ...
  nor2   g022(.a(x091), .b(new_n178_), .O(z07));
  ...
  aoi21  g154(.a(new_n310_), .b(new_n306_), .c(new_n259_), .O(new_n311_));
  aoi21  g155(.a(x053), .b(new_n261_), .c(x085), .O(new_n312_));
  nand2  g156(.a(new_n312_), .b(new_n260_), .O(new_n313_));
  aoi21  g157(.a(new_n313_), .b(x013), .c(x077), .O(new_n314_));
  oai21  g158(.a(x053), .b(x037), .c(x091), .O(new_n315_));
  nor3   g159(.a(new_n315_), .b(new_n314_), .c(new_n311_), .O(new_n316_));
  aoi21  g160(.a(new_n316_), .b(new_n301_), .c(new_n178_), .O(z05));
  ...
  oai21  g223(.a(new_n379_), .b(new_n318_), .c(new_n180_), .O(z06));
  ...
  aoi21  g331(.a(new_n487_), .b(new_n307_), .c(new_n260_), .O(new_n488_));
  ...
  oai21  g335(.a(x085), .b(new_n294_), .c(new_n491_), .O(new_n492_));
  oai21  g336(.a(x117), .b(x109), .c(new_n492_), .O(new_n493_));
  oai21  g337(.a(x037), .b(x013), .c(x021), .O(new_n494_));
  oai21  g338(.a(new_n292_), .b(x029), .c(new_n494_), .O(new_n495_));
  inv1   g339(.a(x125), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n282_), .O(new_n497_));
  ...
  oai21  g349(.a(new_n287_), .b(x021), .c(new_n267_), .O(new_n506_));
  ...
  nand3  g358(.a(new_n271_), .b(x029), .c(new_n294_), .O(new_n515_));
  ...
  nand2  g365(.a(new_n486_), .b(x037), .O(new_n522_));
  ...
  aoi21  g373(.a(new_n513_), .b(new_n486_), .c(new_n529_), .O(new_n530_));
  ...
  oai21  g419(.a(new_n575_), .b(x046), .c(new_n180_), .O(z14));
  zero   g420(.O(z15));
  zero   g421(.O(z17));
  zero   g422(.O(z19));
  zero   g423(.O(z21));
  ...
  zero   g426(.O(z25));
  zero   g427(.O(z26));
  nor2   g428(.a(x091), .b(new_n178_), .O(z16));
  nor2   g429(.a(x091), .b(new_n178_), .O(z18));
  nor2   g430(.a(x091), .b(new_n178_), .O(z20));
  nor2   g431(.a(x091), .b(new_n178_), .O(z22));
  nor2   g432(.a(x091), .b(new_n178_), .O(z27));
endmodule
