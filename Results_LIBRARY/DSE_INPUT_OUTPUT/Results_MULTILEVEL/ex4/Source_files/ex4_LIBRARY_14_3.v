...
module FAU ( 
  ...
  aoi22  g080(.a(new_n178_), .b(new_n230_), .c(new_n236_), .d(new_n229_), .O(new_n237_));
  nand4  g081(.a(new_n237_), .b(new_n235_), .c(new_n233_), .d(new_n228_), .O(new_n238_));
  ...
  nand3  g101(.a(new_n257_), .b(new_n181_), .c(x044), .O(new_n258_));
  ...
  oai21  g167(.a(new_n323_), .b(new_n260_), .c(new_n181_), .O(z05));
  ...
  aoi21  g182(.a(new_n338_), .b(new_n331_), .c(new_n179_), .O(new_n339_));
  ...
  nand3  g212(.a(new_n179_), .b(new_n354_), .c(new_n347_), .O(new_n369_));
  ...
  aoi22  g228(.a(new_n384_), .b(new_n179_), .c(new_n382_), .d(new_n328_), .O(new_n385_));
  nand2  g229(.a(new_n385_), .b(new_n381_), .O(new_n386_));
  aoi21  g230(.a(new_n370_), .b(x054), .c(new_n386_), .O(new_n387_));
  oai21  g231(.a(new_n387_), .b(new_n325_), .c(new_n181_), .O(z06));
  ...
  oai21  g280(.a(new_n436_), .b(x040), .c(new_n181_), .O(z08));
  ...
  oai22  g309(.a(new_n225_), .b(new_n224_), .c(new_n222_), .d(new_n221_), .O(new_n466_));
  nand2  g310(.a(new_n466_), .b(new_n230_), .O(new_n467_));
  nand2  g311(.a(x051), .b(new_n229_), .O(new_n468_));
  nand3  g312(.a(new_n468_), .b(x083), .c(x003), .O(new_n469_));
  nand3  g313(.a(x067), .b(new_n229_), .c(x019), .O(new_n470_));
  ...
  nand3  g317(.a(x083), .b(new_n229_), .c(x003), .O(new_n474_));
  nand3  g318(.a(new_n474_), .b(new_n473_), .c(new_n230_), .O(new_n475_));
  ...
  oai21  g336(.a(new_n492_), .b(x044), .c(new_n181_), .O(z12));
  ...
  oai21  g385(.a(new_n541_), .b(x045), .c(new_n181_), .O(z13));
  ...
  oai21  g393(.a(new_n549_), .b(new_n546_), .c(new_n179_), .O(new_n550_));
  ...
  nand3  g402(.a(new_n326_), .b(x126), .c(new_n347_), .O(new_n559_));
  ...
  oai21  g414(.a(new_n570_), .b(new_n563_), .c(new_n179_), .O(new_n571_));
  ...
  oai21  g428(.a(new_n584_), .b(new_n579_), .c(new_n179_), .O(new_n585_));
  ...
  oai21  g434(.a(new_n590_), .b(x046), .c(new_n181_), .O(z14));
  zero   g435(.O(z15));
  zero   g436(.O(z17));
  zero   g437(.O(z19));
  zero   g438(.O(z22));
  ...
  zero   g440(.O(z26));
  zero   g441(.O(z27));
  nor2   g442(.a(new_n179_), .b(new_n178_), .O(z16));
  nor2   g443(.a(new_n179_), .b(new_n178_), .O(z18));
  nor2   g444(.a(new_n179_), .b(new_n178_), .O(z20));
  nor2   g445(.a(new_n179_), .b(new_n178_), .O(z21));
  nor2   g446(.a(new_n179_), .b(new_n178_), .O(z24));
  nor2   g447(.a(new_n179_), .b(new_n178_), .O(z25));
endmodule
