...
module FAU ( 
  ...
  oai21  g238(.a(new_n382_), .b(new_n160_), .c(new_n395_), .O(new_n396_));
  ...
  nand3  g242(.a(new_n399_), .b(x120), .c(new_n160_), .O(new_n400_));
  nand3  g243(.a(x096), .b(x064), .c(new_n176_), .O(new_n401_));
  nand3  g244(.a(new_n401_), .b(new_n400_), .c(new_n163_), .O(new_n402_));
  inv1   g245(.a(new_n402_), .O(new_n403_));
  aoi21  g246(.a(new_n403_), .b(new_n398_), .c(new_n168_), .O(new_n404_));
  oai21  g247(.a(new_n389_), .b(x016), .c(new_n390_), .O(new_n405_));
  nand2  g248(.a(new_n405_), .b(x064), .O(new_n406_));
  oai21  g249(.a(x064), .b(x008), .c(x016), .O(new_n407_));
  nand4  g250(.a(new_n407_), .b(new_n395_), .c(new_n382_), .d(x024), .O(new_n408_));
  aoi21  g251(.a(new_n408_), .b(new_n406_), .c(x080), .O(new_n409_));
  oai21  g252(.a(new_n409_), .b(new_n404_), .c(new_n177_), .O(new_n410_));
  nand3  g253(.a(x072), .b(x064), .c(x016), .O(new_n411_));
  nand3  g254(.a(new_n411_), .b(new_n410_), .c(new_n387_), .O(new_n412_));
  ...
  nand2  g259(.a(new_n405_), .b(new_n163_), .O(new_n417_));
  ...
  aoi21  g269(.a(new_n412_), .b(new_n171_), .c(new_n426_), .O(new_n427_));
  ...
  zero   g417(.O(z24));
  zero   g418(.O(z25));
  nor2   g419(.a(new_n157_), .b(x046), .O(z16));
  nor2   g420(.a(new_n157_), .b(x046), .O(z18));
  nor2   g421(.a(new_n157_), .b(x046), .O(z20));
  nor2   g422(.a(new_n157_), .b(x046), .O(z23));
  nor2   g423(.a(new_n157_), .b(x046), .O(z26));
