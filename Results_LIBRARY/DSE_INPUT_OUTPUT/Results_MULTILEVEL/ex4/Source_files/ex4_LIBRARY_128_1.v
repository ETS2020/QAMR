...
module FAU ( 
  ...
  nor2   g022(.a(new_n178_), .b(x046), .O(z20));
  inv1   g023(.a(z20), .O(new_n180_));
  ...
  nor3   g164(.a(new_n320_), .b(z20), .c(new_n258_), .O(z05));
  ...
  oai21  g239(.a(new_n383_), .b(new_n157_), .c(new_n396_), .O(new_n397_));
  ...
  nand3  g243(.a(new_n400_), .b(x120), .c(new_n157_), .O(new_n401_));
  nand3  g244(.a(x096), .b(x064), .c(new_n173_), .O(new_n402_));
  nand3  g245(.a(new_n402_), .b(new_n401_), .c(new_n160_), .O(new_n403_));
  inv1   g246(.a(new_n403_), .O(new_n404_));
  aoi21  g247(.a(new_n404_), .b(new_n399_), .c(new_n165_), .O(new_n405_));
  oai21  g248(.a(new_n390_), .b(x016), .c(new_n391_), .O(new_n406_));
  nand2  g249(.a(new_n406_), .b(x064), .O(new_n407_));
  oai21  g250(.a(x064), .b(x008), .c(x016), .O(new_n408_));
  nand4  g251(.a(new_n408_), .b(new_n396_), .c(new_n383_), .d(x024), .O(new_n409_));
  aoi21  g252(.a(new_n409_), .b(new_n407_), .c(x080), .O(new_n410_));
  oai21  g253(.a(new_n410_), .b(new_n405_), .c(new_n174_), .O(new_n411_));
  nand3  g254(.a(x072), .b(x064), .c(x016), .O(new_n412_));
  nand3  g255(.a(new_n412_), .b(new_n411_), .c(new_n388_), .O(new_n413_));
  nand2  g256(.a(new_n396_), .b(x000), .O(new_n414_));
  ...
  nand2  g260(.a(new_n406_), .b(new_n160_), .O(new_n418_));
  ...
  aoi21  g270(.a(new_n413_), .b(new_n168_), .c(new_n427_), .O(new_n428_));
  oai21  g271(.a(new_n428_), .b(x040), .c(new_n180_), .O(z08));
  ...
  oai21  g299(.a(new_n456_), .b(x042), .c(new_n180_), .O(z10));
  ...
  oai21  g312(.a(new_n469_), .b(x043), .c(new_n180_), .O(z11));
  ...
  nand3  g326(.a(new_n483_), .b(new_n180_), .c(new_n471_), .O(new_n484_));
