...
module FAU ( 
  ...
  nand2  g220(.a(new_n376_), .b(x087), .O(new_n377_));
  ...
  aoi21  g387(.a(new_n543_), .b(new_n339_), .c(x086), .O(new_n544_));
  ...
  oai21  g395(.a(new_n355_), .b(new_n339_), .c(new_n551_), .O(new_n552_));
  nand2  g396(.a(new_n552_), .b(new_n549_), .O(new_n553_));
  nand2  g397(.a(new_n553_), .b(new_n324_), .O(new_n554_));
  nand3  g398(.a(new_n321_), .b(x126), .c(new_n339_), .O(new_n555_));
  nand3  g399(.a(x102), .b(x070), .c(new_n363_), .O(new_n556_));
  nand3  g400(.a(new_n556_), .b(new_n555_), .c(new_n327_), .O(new_n557_));
  inv1   g401(.a(new_n557_), .O(new_n558_));
  aoi21  g402(.a(new_n558_), .b(new_n554_), .c(new_n338_), .O(new_n559_));
  inv1   g403(.a(new_n331_), .O(new_n560_));
  oai21  g404(.a(new_n328_), .b(x022), .c(new_n560_), .O(new_n561_));
  nand2  g405(.a(new_n561_), .b(x070), .O(new_n562_));
  oai21  g406(.a(x070), .b(x014), .c(x022), .O(new_n563_));
  nand4  g407(.a(new_n563_), .b(new_n551_), .c(new_n355_), .d(x030), .O(new_n564_));
  ...
  nand3  g413(.a(new_n327_), .b(x030), .c(new_n335_), .O(new_n570_));
  nand2  g414(.a(new_n570_), .b(new_n569_), .O(new_n571_));
  nand2  g415(.a(new_n571_), .b(new_n324_), .O(new_n572_));
  nand2  g416(.a(new_n561_), .b(new_n327_), .O(new_n573_));
  aoi21  g417(.a(new_n573_), .b(new_n572_), .c(new_n363_), .O(new_n574_));
  oai21  g418(.a(new_n327_), .b(new_n338_), .c(new_n323_), .O(new_n575_));
  nand2  g419(.a(new_n575_), .b(new_n335_), .O(new_n576_));
  nand2  g420(.a(new_n364_), .b(x038), .O(new_n577_));
  ...
  aoi21  g428(.a(new_n568_), .b(new_n364_), .c(new_n584_), .O(new_n585_));
  ...
  zero   g434(.O(z24));
  zero   g435(.O(z25));
  nor2   g436(.a(x087), .b(new_n178_), .O(z15));
  nor2   g437(.a(x087), .b(new_n178_), .O(z17));
  nor2   g438(.a(x087), .b(new_n178_), .O(z20));
  nor2   g439(.a(x087), .b(new_n178_), .O(z21));
  nor2   g440(.a(x087), .b(new_n178_), .O(z23));
  nor2   g441(.a(x087), .b(new_n178_), .O(z26));
  nor2   g442(.a(x087), .b(new_n178_), .O(z27));
endmodule
