...
module FAU ( 
  ...
  oai22  g237(.a(new_n382_), .b(new_n159_), .c(x120), .d(x096), .O(new_n394_));
  ...
  oai21  g254(.a(new_n410_), .b(new_n402_), .c(new_n176_), .O(new_n411_));
  ...
  oai21  g258(.a(new_n406_), .b(new_n167_), .c(new_n414_), .O(new_n415_));
  nand2  g259(.a(new_n415_), .b(new_n160_), .O(new_n416_));
  nand2  g260(.a(new_n404_), .b(new_n162_), .O(new_n417_));
  ...
  aoi21  g270(.a(new_n413_), .b(new_n170_), .c(new_n426_), .O(new_n427_));
  ...
  oai21  g284(.a(new_n440_), .b(x041), .c(new_n158_), .O(z09));
  ...
  nand3  g298(.a(new_n454_), .b(new_n158_), .c(new_n442_), .O(new_n455_));
  ...
  oai21  g337(.a(new_n294_), .b(x029), .c(new_n493_), .O(new_n494_));
  ...
  oai21  g347(.a(new_n291_), .b(x021), .c(new_n267_), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(x069), .O(new_n505_));
  oai21  g349(.a(x069), .b(x013), .c(x021), .O(new_n506_));
  nand4  g350(.a(new_n506_), .b(new_n495_), .c(new_n275_), .d(x029), .O(new_n507_));
  ...
  nand3  g356(.a(new_n271_), .b(x029), .c(new_n296_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n512_), .O(new_n514_));
  nand2  g358(.a(new_n514_), .b(new_n266_), .O(new_n515_));
  nand2  g359(.a(new_n504_), .b(new_n271_), .O(new_n516_));
  ...
  nand2  g374(.a(new_n360_), .b(x038), .O(new_n531_));
  nand3  g375(.a(new_n531_), .b(x086), .c(x006), .O(new_n532_));
  nand2  g376(.a(x054), .b(x038), .O(new_n533_));
  nand3  g377(.a(x070), .b(new_n360_), .c(x022), .O(new_n534_));
  nand4  g378(.a(new_n534_), .b(new_n533_), .c(new_n532_), .d(new_n332_), .O(new_n535_));
  nand3  g379(.a(new_n535_), .b(x078), .c(new_n530_), .O(new_n536_));
  ...
  nor2   g389(.a(x078), .b(x046), .O(z21));
  nor2   g390(.a(x078), .b(x046), .O(z22));
