...
module FAU ( 
  ...
  oai21  g327(.a(new_n483_), .b(x044), .c(new_n179_), .O(z12));
  nand2  g328(.a(new_n285_), .b(new_n284_), .O(new_n485_));
  nand2  g329(.a(new_n287_), .b(new_n280_), .O(new_n486_));
  ...
  nand3  g333(.a(new_n489_), .b(new_n287_), .c(x029), .O(new_n490_));
  aoi21  g334(.a(new_n490_), .b(new_n280_), .c(x085), .O(new_n491_));
  oai21  g335(.a(new_n491_), .b(new_n488_), .c(new_n259_), .O(new_n492_));
  oai21  g336(.a(x085), .b(new_n297_), .c(new_n492_), .O(new_n493_));
  nand2  g337(.a(new_n493_), .b(new_n485_), .O(new_n494_));
  oai21  g338(.a(x037), .b(x013), .c(x021), .O(new_n495_));
  nand3  g339(.a(new_n267_), .b(new_n266_), .c(new_n265_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n495_), .O(new_n497_));
  oai22  g341(.a(new_n489_), .b(new_n280_), .c(x125), .d(x101), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(new_n497_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n287_), .O(new_n500_));
  nand3  g344(.a(new_n258_), .b(x125), .c(new_n280_), .O(new_n501_));
  nand3  g345(.a(x101), .b(x069), .c(new_n261_), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n501_), .c(new_n273_), .O(new_n503_));
  inv1   g347(.a(new_n503_), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n500_), .c(new_n260_), .O(new_n505_));
  oai21  g349(.a(new_n265_), .b(x021), .c(new_n281_), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(x069), .O(new_n507_));
  inv1   g351(.a(x125), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n288_), .O(new_n509_));
  oai21  g353(.a(x069), .b(x013), .c(x021), .O(new_n510_));
  nand4  g354(.a(new_n510_), .b(new_n509_), .c(new_n489_), .d(x029), .O(new_n511_));
  aoi21  g355(.a(new_n511_), .b(new_n507_), .c(x085), .O(new_n512_));
  oai21  g356(.a(new_n512_), .b(new_n505_), .c(new_n259_), .O(new_n513_));
  ...
  nand3  g360(.a(new_n273_), .b(x029), .c(new_n297_), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n516_), .O(new_n518_));
  nand2  g362(.a(new_n518_), .b(new_n287_), .O(new_n519_));
  nand2  g363(.a(new_n506_), .b(new_n273_), .O(new_n520_));
  ...
  nand2  g378(.a(new_n362_), .b(x038), .O(new_n535_));
  nand3  g379(.a(new_n535_), .b(x086), .c(x006), .O(new_n536_));
  nand2  g380(.a(x054), .b(x038), .O(new_n537_));
  nand3  g381(.a(x070), .b(new_n362_), .c(x022), .O(new_n538_));
  nand4  g382(.a(new_n538_), .b(new_n537_), .c(new_n536_), .d(new_n334_), .O(new_n539_));
  nand3  g383(.a(new_n539_), .b(x078), .c(new_n534_), .O(new_n540_));
  inv1   g384(.a(new_n540_), .O(z14));
  zero   g385(.O(z15));
  zero   g386(.O(z18));
  zero   g387(.O(z19));
  zero   g388(.O(z21));
  ...
  zero   g390(.O(z25));
  zero   g391(.O(z27));
  nor2   g392(.a(x078), .b(x046), .O(z16));
  nor2   g393(.a(x078), .b(x046), .O(z17));
  nor2   g394(.a(x078), .b(x046), .O(z20));
  nor2   g395(.a(x078), .b(x046), .O(z22));
