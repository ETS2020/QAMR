...
module FAU ( 
  ...
  oai21  g301(.a(new_n458_), .b(x042), .c(new_n157_), .O(z10));
  ...
  oai21  g314(.a(new_n471_), .b(x043), .c(new_n157_), .O(z11));
  ...
  nand3  g328(.a(new_n485_), .b(new_n157_), .c(new_n473_), .O(new_n486_));
  ...
  oai21  g423(.a(new_n580_), .b(x046), .c(new_n157_), .O(z14));
  zero   g424(.O(z07));
  zero   g425(.O(z16));
  zero   g426(.O(z17));
  zero   g427(.O(z22));
  ...
  zero   g429(.O(z25));
  zero   g430(.O(z27));
  inv1   g431(.a(new_n157_), .O(z18));
  inv1   g432(.a(new_n157_), .O(z19));
  inv1   g433(.a(new_n157_), .O(z20));
  inv1   g434(.a(new_n157_), .O(z21));
  inv1   g435(.a(new_n157_), .O(z24));
  inv1   g436(.a(new_n157_), .O(z26));
endmodule
