...
module FAU ( 
  ...
  nand2  g022(.a(x113), .b(new_n178_), .O(new_n179_));
  ...
  nand3  g205(.a(new_n178_), .b(new_n327_), .c(new_n326_), .O(new_n362_));
  ...
  aoi22  g220(.a(new_n376_), .b(new_n178_), .c(new_n374_), .d(new_n322_), .O(new_n377_));
  ...
  nand3  g393(.a(new_n320_), .b(x126), .c(new_n326_), .O(new_n551_));
  ...
  zero   g429(.O(z24));
  zero   g430(.O(z26));
  inv1   g431(.a(new_n179_), .O(z16));
  inv1   g432(.a(new_n179_), .O(z17));
  inv1   g433(.a(new_n179_), .O(z20));
  inv1   g434(.a(new_n179_), .O(z21));
  inv1   g435(.a(new_n179_), .O(z25));
  inv1   g436(.a(new_n179_), .O(z27));
endmodule
