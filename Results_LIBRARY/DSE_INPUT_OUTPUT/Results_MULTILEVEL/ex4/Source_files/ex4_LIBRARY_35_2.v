...
module FAU ( 
  ...
  oai21  g338(.a(new_n494_), .b(new_n492_), .c(new_n157_), .O(new_n495_));
  ...
  zero   g432(.O(z26));
  zero   g433(.O(z27));
  nor2   g434(.a(x119), .b(new_n157_), .O(z16));
  nor2   g435(.a(x119), .b(new_n157_), .O(z20));
  nor2   g436(.a(x119), .b(new_n157_), .O(z21));
  nor2   g437(.a(x119), .b(new_n157_), .O(z23));
  nor2   g438(.a(x119), .b(new_n157_), .O(z24));
  nor2   g439(.a(x119), .b(new_n157_), .O(z25));
endmodule
