...
module FAU ( 
  ...
  nand2  g335(.a(new_n346_), .b(new_n340_), .O(new_n492_));
  nand2  g336(.a(x070), .b(new_n321_), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n492_), .c(new_n320_), .O(new_n494_));
  nand2  g338(.a(x094), .b(x062), .O(new_n495_));
  nand3  g339(.a(new_n495_), .b(new_n346_), .c(x030), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n340_), .c(x086), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(new_n494_), .c(new_n319_), .O(new_n498_));
  oai21  g342(.a(x086), .b(new_n356_), .c(new_n498_), .O(new_n499_));
  oai21  g343(.a(x118), .b(x110), .c(new_n499_), .O(new_n500_));
  oai21  g344(.a(x038), .b(x014), .c(x022), .O(new_n501_));
  oai21  g345(.a(new_n328_), .b(x030), .c(new_n501_), .O(new_n502_));
  inv1   g346(.a(x126), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n347_), .O(new_n504_));
  oai21  g348(.a(new_n495_), .b(new_n340_), .c(new_n504_), .O(new_n505_));
  nand2  g349(.a(new_n505_), .b(new_n502_), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n346_), .O(new_n507_));
  nand3  g351(.a(new_n318_), .b(x126), .c(new_n340_), .O(new_n508_));
  nand3  g352(.a(x102), .b(x070), .c(new_n321_), .O(new_n509_));
  nand3  g353(.a(new_n509_), .b(new_n508_), .c(new_n333_), .O(new_n510_));
  inv1   g354(.a(new_n510_), .O(new_n511_));
  aoi21  g355(.a(new_n511_), .b(new_n507_), .c(new_n320_), .O(new_n512_));
  oai21  g356(.a(new_n325_), .b(x022), .c(new_n341_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(x070), .O(new_n514_));
  oai21  g358(.a(x070), .b(x014), .c(x022), .O(new_n515_));
  nand4  g359(.a(new_n515_), .b(new_n504_), .c(new_n495_), .d(x030), .O(new_n516_));
  aoi21  g360(.a(new_n516_), .b(new_n514_), .c(x086), .O(new_n517_));
  oai21  g361(.a(new_n517_), .b(new_n512_), .c(new_n319_), .O(new_n518_));
  nand3  g362(.a(x078), .b(x070), .c(x022), .O(new_n519_));
  nand3  g363(.a(new_n519_), .b(new_n518_), .c(new_n500_), .O(new_n520_));
  nand2  g364(.a(new_n504_), .b(x006), .O(new_n521_));
  nand3  g365(.a(new_n333_), .b(x030), .c(new_n356_), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n521_), .O(new_n523_));
  nand2  g367(.a(new_n523_), .b(new_n346_), .O(new_n524_));
  nand2  g368(.a(new_n513_), .b(new_n333_), .O(new_n525_));
  aoi21  g369(.a(new_n525_), .b(new_n524_), .c(new_n321_), .O(new_n526_));
  oai21  g370(.a(new_n333_), .b(new_n320_), .c(new_n322_), .O(new_n527_));
  nand2  g371(.a(new_n527_), .b(new_n356_), .O(new_n528_));
  nand2  g372(.a(new_n374_), .b(x038), .O(new_n529_));
  nand3  g373(.a(new_n529_), .b(x070), .c(x022), .O(new_n530_));
  nand2  g374(.a(new_n530_), .b(new_n528_), .O(new_n531_));
  oai21  g375(.a(new_n531_), .b(new_n526_), .c(new_n319_), .O(new_n532_));
  nand3  g376(.a(new_n529_), .b(x086), .c(x006), .O(new_n533_));
  nand2  g377(.a(new_n533_), .b(new_n356_), .O(new_n534_));
  aoi22  g378(.a(new_n534_), .b(x078), .c(x054), .d(x038), .O(new_n535_));
  nand2  g379(.a(new_n535_), .b(new_n532_), .O(new_n536_));
  aoi21  g380(.a(new_n520_), .b(new_n374_), .c(new_n536_), .O(new_n537_));
  oai21  g381(.a(new_n537_), .b(x046), .c(new_n158_), .O(z14));
  zero   g382(.O(z15));
  zero   g383(.O(z17));
  zero   g384(.O(z21));
  zero   g385(.O(z24));
