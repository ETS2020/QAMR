...
module FAU ( 
  ...
  nor2   g021(.a(x104), .b(new_n177_), .O(z07));
  ...
  oai21  g160(.a(new_n316_), .b(new_n257_), .c(new_n179_), .O(z05));
  ...
  aoi21  g165(.a(new_n321_), .b(new_n319_), .c(x006), .O(new_n322_));
  ...
  nand3  g170(.a(new_n326_), .b(x070), .c(new_n324_), .O(new_n327_));
  aoi21  g171(.a(new_n327_), .b(x022), .c(new_n323_), .O(new_n328_));
  oai21  g172(.a(new_n328_), .b(new_n322_), .c(x078), .O(new_n329_));
  inv1   g173(.a(x014), .O(new_n330_));
  nand2  g174(.a(x086), .b(new_n330_), .O(new_n331_));
  aoi22  g175(.a(new_n331_), .b(new_n329_), .c(x118), .d(x110), .O(new_n332_));
  inv1   g176(.a(x006), .O(new_n333_));
  inv1   g177(.a(x022), .O(new_n334_));
  inv1   g178(.a(x038), .O(new_n335_));
  oai21  g179(.a(new_n335_), .b(new_n330_), .c(new_n334_), .O(new_n336_));
  nand2  g180(.a(x094), .b(x062), .O(new_n337_));
  oai21  g181(.a(new_n337_), .b(new_n324_), .c(new_n336_), .O(new_n338_));
  nand2  g182(.a(x126), .b(x102), .O(new_n339_));
  oai21  g183(.a(new_n326_), .b(x022), .c(new_n339_), .O(new_n340_));
  aoi21  g184(.a(new_n340_), .b(new_n338_), .c(new_n320_), .O(new_n341_));
  ...
  aoi21  g189(.a(new_n345_), .b(x038), .c(new_n323_), .O(new_n346_));
  nand2  g190(.a(new_n346_), .b(new_n344_), .O(new_n347_));
  oai21  g191(.a(new_n347_), .b(new_n341_), .c(new_n333_), .O(new_n348_));
  aoi21  g192(.a(new_n324_), .b(x022), .c(new_n337_), .O(new_n349_));
  oai21  g193(.a(new_n320_), .b(new_n330_), .c(new_n334_), .O(new_n350_));
  nand4  g194(.a(new_n350_), .b(new_n339_), .c(new_n326_), .d(new_n324_), .O(new_n351_));
  oai21  g195(.a(new_n349_), .b(x070), .c(new_n351_), .O(new_n352_));
  nand2  g196(.a(new_n352_), .b(x086), .O(new_n353_));
  aoi21  g197(.a(new_n353_), .b(new_n348_), .c(new_n177_), .O(new_n354_));
  oai21  g198(.a(new_n354_), .b(new_n332_), .c(x054), .O(new_n355_));
  nand2  g199(.a(new_n339_), .b(new_n333_), .O(new_n356_));
  nand3  g200(.a(x086), .b(new_n324_), .c(x014), .O(new_n357_));
  aoi21  g201(.a(new_n357_), .b(new_n356_), .c(new_n320_), .O(new_n358_));
  nor2   g202(.a(new_n349_), .b(new_n323_), .O(new_n359_));
  oai21  g203(.a(new_n359_), .b(new_n358_), .c(new_n335_), .O(new_n360_));
  nand2  g204(.a(new_n320_), .b(new_n334_), .O(new_n361_));
  oai21  g205(.a(x086), .b(x006), .c(new_n361_), .O(new_n362_));
  aoi21  g206(.a(x054), .b(new_n335_), .c(x070), .O(new_n363_));
  aoi22  g207(.a(new_n363_), .b(new_n334_), .c(new_n362_), .d(x014), .O(new_n364_));
  nand2  g208(.a(new_n364_), .b(new_n360_), .O(new_n365_));
  nand2  g209(.a(new_n365_), .b(x078), .O(new_n366_));
  inv1   g210(.a(x054), .O(new_n367_));
  nand2  g211(.a(new_n367_), .b(new_n335_), .O(new_n368_));
  nand3  g212(.a(new_n368_), .b(new_n366_), .c(new_n355_), .O(new_n369_));
  nand2  g213(.a(new_n369_), .b(x104), .O(new_n370_));
  nand2  g214(.a(x054), .b(new_n335_), .O(new_n371_));
  nand3  g215(.a(new_n371_), .b(new_n323_), .c(new_n333_), .O(new_n372_));
  nand3  g216(.a(new_n320_), .b(x054), .c(new_n334_), .O(new_n373_));
  nand4  g217(.a(new_n373_), .b(new_n372_), .c(new_n368_), .d(x014), .O(new_n374_));
  nand2  g218(.a(new_n374_), .b(new_n177_), .O(new_n375_));
  aoi21  g219(.a(new_n375_), .b(new_n370_), .c(new_n318_), .O(z06));
  inv1   g220(.a(x040), .O(new_n377_));
  nand3  g221(.a(x064), .b(new_n172_), .c(x016), .O(new_n378_));
  nand3  g222(.a(x080), .b(x048), .c(x000), .O(new_n379_));
  nand3  g223(.a(new_n379_), .b(new_n378_), .c(new_n166_), .O(new_n380_));
  nand2  g224(.a(new_n380_), .b(x072), .O(new_n381_));
  inv1   g225(.a(x104), .O(new_n382_));
  ...
  oai21  g230(.a(new_n386_), .b(x024), .c(new_n383_), .O(new_n387_));
  oai21  g231(.a(x112), .b(x096), .c(new_n157_), .O(new_n388_));
  inv1   g232(.a(x096), .O(new_n389_));
  inv1   g233(.a(x120), .O(new_n390_));
  nand2  g234(.a(new_n390_), .b(new_n389_), .O(new_n391_));
  oai21  g235(.a(new_n385_), .b(new_n384_), .c(new_n391_), .O(new_n392_));
  nand4  g236(.a(new_n392_), .b(new_n388_), .c(new_n387_), .d(new_n382_), .O(new_n393_));
  nand2  g237(.a(new_n393_), .b(new_n158_), .O(new_n394_));
  oai21  g238(.a(x112), .b(x096), .c(x064), .O(new_n395_));
  aoi21  g239(.a(new_n395_), .b(new_n382_), .c(x032), .O(new_n396_));
  nand2  g240(.a(new_n382_), .b(new_n157_), .O(new_n397_));
  inv1   g241(.a(x112), .O(new_n398_));
  nand2  g242(.a(new_n398_), .b(x104), .O(new_n399_));
  aoi21  g243(.a(new_n399_), .b(new_n397_), .c(new_n390_), .O(new_n400_));
  nor3   g244(.a(new_n400_), .b(new_n396_), .c(x080), .O(new_n401_));
  aoi21  g245(.a(new_n401_), .b(new_n394_), .c(x072), .O(new_n402_));
  oai22  g246(.a(new_n382_), .b(new_n166_), .c(new_n161_), .d(x032), .O(new_n403_));
  oai21  g247(.a(new_n403_), .b(new_n402_), .c(x000), .O(new_n404_));
  nand2  g248(.a(new_n173_), .b(x016), .O(new_n405_));
  aoi22  g249(.a(new_n405_), .b(new_n166_), .c(new_n398_), .d(new_n382_), .O(new_n406_));
  aoi21  g250(.a(new_n382_), .b(x016), .c(new_n158_), .O(new_n407_));
  nor2   g251(.a(new_n385_), .b(new_n384_), .O(new_n408_));
  oai21  g252(.a(x064), .b(x008), .c(x016), .O(new_n409_));
  nand2  g253(.a(new_n409_), .b(new_n391_), .O(new_n410_));
  aoi21  g254(.a(x112), .b(new_n158_), .c(x104), .O(new_n411_));
  aoi21  g255(.a(new_n411_), .b(new_n410_), .c(new_n408_), .O(new_n412_));
  oai21  g256(.a(new_n412_), .b(new_n407_), .c(x024), .O(new_n413_));
  nand2  g257(.a(new_n386_), .b(x064), .O(new_n414_));
  aoi21  g258(.a(new_n414_), .b(new_n413_), .c(x072), .O(new_n415_));
  oai21  g259(.a(new_n415_), .b(new_n406_), .c(new_n161_), .O(new_n416_));
  nand2  g260(.a(x032), .b(x008), .O(new_n417_));
  nand3  g261(.a(new_n417_), .b(x064), .c(x016), .O(new_n418_));
  nand3  g262(.a(new_n418_), .b(new_n416_), .c(new_n404_), .O(new_n419_));
  nand2  g263(.a(new_n419_), .b(new_n172_), .O(new_n420_));
  nand3  g264(.a(new_n158_), .b(x032), .c(x024), .O(new_n421_));
  nand3  g265(.a(new_n382_), .b(new_n161_), .c(new_n173_), .O(new_n422_));
  oai21  g266(.a(new_n422_), .b(new_n421_), .c(new_n379_), .O(new_n423_));
  nand2  g267(.a(new_n423_), .b(new_n166_), .O(new_n424_));
  nand3  g268(.a(new_n391_), .b(new_n158_), .c(x000), .O(new_n425_));
  nand3  g269(.a(new_n382_), .b(x024), .c(new_n157_), .O(new_n426_));
  nand3  g270(.a(new_n426_), .b(new_n385_), .c(new_n384_), .O(new_n427_));
  nand2  g271(.a(new_n427_), .b(new_n161_), .O(new_n428_));
  aoi21  g272(.a(new_n428_), .b(new_n425_), .c(x072), .O(new_n429_));
  oai21  g273(.a(new_n429_), .b(x048), .c(x032), .O(new_n430_));
  nand4  g274(.a(new_n173_), .b(x064), .c(x048), .d(x016), .O(new_n431_));
  nand3  g275(.a(new_n431_), .b(new_n430_), .c(new_n424_), .O(new_n432_));
  inv1   g276(.a(new_n432_), .O(new_n433_));
  nand3  g277(.a(new_n433_), .b(new_n420_), .c(new_n381_), .O(new_n434_));
  nand2  g278(.a(new_n434_), .b(new_n377_), .O(new_n435_));
  nand2  g279(.a(new_n435_), .b(new_n179_), .O(z08));
  inv1   g280(.a(x041), .O(new_n437_));
  nand2  g281(.a(x065), .b(x017), .O(new_n438_));
  nand3  g282(.a(x081), .b(new_n188_), .c(x001), .O(new_n439_));
  oai21  g283(.a(new_n438_), .b(new_n188_), .c(new_n439_), .O(new_n440_));
  nand2  g284(.a(new_n440_), .b(new_n187_), .O(new_n441_));
  nand3  g285(.a(x081), .b(x009), .c(x001), .O(new_n442_));
  oai21  g286(.a(new_n438_), .b(x009), .c(new_n442_), .O(new_n443_));
  oai21  g287(.a(new_n194_), .b(x033), .c(new_n443_), .O(new_n444_));
  nand2  g288(.a(x081), .b(x001), .O(new_n445_));
  aoi21  g289(.a(new_n445_), .b(new_n438_), .c(x073), .O(new_n446_));
  oai22  g290(.a(new_n195_), .b(new_n188_), .c(new_n194_), .d(new_n187_), .O(new_n447_));
  aoi21  g291(.a(new_n446_), .b(new_n188_), .c(new_n447_), .O(new_n448_));
  nand3  g292(.a(new_n448_), .b(new_n444_), .c(new_n441_), .O(new_n449_));
  nand3  g293(.a(new_n449_), .b(new_n179_), .c(new_n437_), .O(new_n450_));
  inv1   g294(.a(new_n450_), .O(z09));
  nand2  g295(.a(x066), .b(x018), .O(new_n452_));
  nand3  g296(.a(x082), .b(new_n207_), .c(x002), .O(new_n453_));
  oai21  g297(.a(new_n452_), .b(new_n207_), .c(new_n453_), .O(new_n454_));
  nand3  g298(.a(x082), .b(x010), .c(x002), .O(new_n455_));
  oai21  g299(.a(new_n452_), .b(x010), .c(new_n455_), .O(new_n456_));
  oai21  g300(.a(new_n213_), .b(x034), .c(new_n456_), .O(new_n457_));
  nand2  g301(.a(x082), .b(x002), .O(new_n458_));
  aoi21  g302(.a(new_n458_), .b(new_n452_), .c(x074), .O(new_n459_));
  nand2  g303(.a(new_n459_), .b(new_n207_), .O(new_n460_));
  aoi22  g304(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n461_));
  nand3  g305(.a(new_n461_), .b(new_n460_), .c(new_n457_), .O(new_n462_));
  aoi21  g306(.a(new_n454_), .b(new_n206_), .c(new_n462_), .O(new_n463_));
  oai21  g307(.a(new_n463_), .b(x042), .c(new_n179_), .O(z10));
  inv1   g308(.a(x043), .O(new_n465_));
  nand2  g309(.a(x067), .b(x019), .O(new_n466_));
  nand3  g310(.a(x083), .b(new_n226_), .c(x003), .O(new_n467_));
  oai21  g311(.a(new_n466_), .b(new_n226_), .c(new_n467_), .O(new_n468_));
  nand2  g312(.a(new_n468_), .b(new_n225_), .O(new_n469_));
  nand3  g313(.a(x083), .b(x011), .c(x003), .O(new_n470_));
  oai21  g314(.a(new_n466_), .b(x011), .c(new_n470_), .O(new_n471_));
  oai21  g315(.a(new_n232_), .b(x035), .c(new_n471_), .O(new_n472_));
  nand2  g316(.a(x083), .b(x003), .O(new_n473_));
  aoi21  g317(.a(new_n473_), .b(new_n466_), .c(x075), .O(new_n474_));
  oai22  g318(.a(new_n233_), .b(new_n226_), .c(new_n232_), .d(new_n225_), .O(new_n475_));
  aoi21  g319(.a(new_n474_), .b(new_n226_), .c(new_n475_), .O(new_n476_));
  nand3  g320(.a(new_n476_), .b(new_n472_), .c(new_n469_), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n179_), .c(new_n465_), .O(new_n478_));
  inv1   g322(.a(new_n478_), .O(z11));
  inv1   g323(.a(x044), .O(new_n480_));
  nand2  g324(.a(x068), .b(x020), .O(new_n481_));
  nand3  g325(.a(x084), .b(new_n245_), .c(x004), .O(new_n482_));
  oai21  g326(.a(new_n481_), .b(new_n245_), .c(new_n482_), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(new_n244_), .O(new_n484_));
  nand3  g328(.a(x084), .b(x012), .c(x004), .O(new_n485_));
  oai21  g329(.a(new_n481_), .b(x012), .c(new_n485_), .O(new_n486_));
  oai21  g330(.a(new_n251_), .b(x036), .c(new_n486_), .O(new_n487_));
  nand2  g331(.a(x084), .b(x004), .O(new_n488_));
  aoi21  g332(.a(new_n488_), .b(new_n481_), .c(x076), .O(new_n489_));
  oai22  g333(.a(new_n252_), .b(new_n245_), .c(new_n251_), .d(new_n244_), .O(new_n490_));
  aoi21  g334(.a(new_n489_), .b(new_n245_), .c(new_n490_), .O(new_n491_));
  nand3  g335(.a(new_n491_), .b(new_n487_), .c(new_n484_), .O(new_n492_));
  nand3  g336(.a(new_n492_), .b(new_n179_), .c(new_n480_), .O(new_n493_));
  inv1   g337(.a(new_n493_), .O(z12));
  nand2  g338(.a(new_n266_), .b(new_n265_), .O(new_n495_));
  nand2  g339(.a(x069), .b(new_n261_), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n495_), .c(new_n260_), .O(new_n497_));
  nand3  g341(.a(new_n275_), .b(new_n266_), .c(x029), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n265_), .c(x085), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(new_n497_), .c(new_n259_), .O(new_n500_));
  oai21  g344(.a(x085), .b(new_n294_), .c(new_n500_), .O(new_n501_));
  oai21  g345(.a(x117), .b(x109), .c(new_n501_), .O(new_n502_));
  oai21  g346(.a(x037), .b(x013), .c(x021), .O(new_n503_));
  oai21  g347(.a(new_n292_), .b(x029), .c(new_n503_), .O(new_n504_));
  nand2  g348(.a(new_n279_), .b(new_n278_), .O(new_n505_));
  oai21  g349(.a(new_n275_), .b(new_n265_), .c(new_n505_), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n504_), .O(new_n507_));
  nand3  g351(.a(new_n258_), .b(x125), .c(new_n265_), .O(new_n508_));
  nand3  g352(.a(x101), .b(x069), .c(new_n261_), .O(new_n509_));
  nand3  g353(.a(new_n509_), .b(new_n508_), .c(new_n271_), .O(new_n510_));
  aoi21  g354(.a(new_n507_), .b(new_n266_), .c(new_n510_), .O(new_n511_));
  nor2   g355(.a(new_n511_), .b(new_n260_), .O(new_n512_));
  oai21  g356(.a(new_n291_), .b(x021), .c(new_n267_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(x069), .O(new_n514_));
  oai21  g358(.a(x069), .b(x013), .c(x021), .O(new_n515_));
  nand4  g359(.a(new_n515_), .b(new_n505_), .c(new_n275_), .d(x029), .O(new_n516_));
  aoi21  g360(.a(new_n516_), .b(new_n514_), .c(x085), .O(new_n517_));
  oai21  g361(.a(new_n517_), .b(new_n512_), .c(new_n259_), .O(new_n518_));
  nand3  g362(.a(x077), .b(x069), .c(x021), .O(new_n519_));
  nand3  g363(.a(new_n519_), .b(new_n518_), .c(new_n502_), .O(new_n520_));
  nand2  g364(.a(new_n505_), .b(x005), .O(new_n521_));
  nand3  g365(.a(new_n271_), .b(x029), .c(new_n294_), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n521_), .O(new_n523_));
  nand2  g367(.a(new_n523_), .b(new_n266_), .O(new_n524_));
  nand2  g368(.a(new_n513_), .b(new_n271_), .O(new_n525_));
  aoi21  g369(.a(new_n525_), .b(new_n524_), .c(new_n261_), .O(new_n526_));
  oai21  g370(.a(new_n271_), .b(new_n260_), .c(new_n262_), .O(new_n527_));
  nand2  g371(.a(new_n527_), .b(new_n294_), .O(new_n528_));
  nand2  g372(.a(new_n311_), .b(x037), .O(new_n529_));
  nand3  g373(.a(new_n529_), .b(x069), .c(x021), .O(new_n530_));
  nand2  g374(.a(new_n530_), .b(new_n528_), .O(new_n531_));
  oai21  g375(.a(new_n531_), .b(new_n526_), .c(new_n259_), .O(new_n532_));
  nand3  g376(.a(new_n529_), .b(x085), .c(x005), .O(new_n533_));
  nand2  g377(.a(new_n533_), .b(new_n294_), .O(new_n534_));
  aoi22  g378(.a(new_n534_), .b(x077), .c(x053), .d(x037), .O(new_n535_));
  nand2  g379(.a(new_n535_), .b(new_n532_), .O(new_n536_));
  aoi21  g380(.a(new_n520_), .b(new_n311_), .c(new_n536_), .O(new_n537_));
  oai21  g381(.a(new_n537_), .b(x045), .c(new_n179_), .O(z13));
  nand2  g382(.a(x070), .b(new_n335_), .O(new_n539_));
  aoi21  g383(.a(new_n539_), .b(new_n361_), .c(new_n333_), .O(new_n540_));
  nand3  g384(.a(new_n337_), .b(new_n320_), .c(x030), .O(new_n541_));
  aoi21  g385(.a(new_n541_), .b(new_n334_), .c(x086), .O(new_n542_));
  oai21  g386(.a(new_n542_), .b(new_n540_), .c(new_n177_), .O(new_n543_));
  oai21  g387(.a(x086), .b(new_n330_), .c(new_n543_), .O(new_n544_));
  nand2  g388(.a(new_n544_), .b(new_n343_), .O(new_n545_));
  oai21  g389(.a(x038), .b(x014), .c(x022), .O(new_n546_));
  oai21  g390(.a(new_n326_), .b(x030), .c(new_n546_), .O(new_n547_));
  inv1   g391(.a(x102), .O(new_n548_));
  nand2  g392(.a(new_n342_), .b(new_n548_), .O(new_n549_));
  oai21  g393(.a(new_n337_), .b(new_n334_), .c(new_n549_), .O(new_n550_));
  nand2  g394(.a(new_n550_), .b(new_n547_), .O(new_n551_));
  nand2  g395(.a(x118), .b(x110), .O(new_n552_));
  nand3  g396(.a(new_n552_), .b(x126), .c(new_n334_), .O(new_n553_));
  nand3  g397(.a(x102), .b(x070), .c(new_n335_), .O(new_n554_));
  nand3  g398(.a(new_n554_), .b(new_n553_), .c(new_n323_), .O(new_n555_));
  aoi21  g399(.a(new_n551_), .b(new_n320_), .c(new_n555_), .O(new_n556_));
  nor2   g400(.a(new_n556_), .b(new_n333_), .O(new_n557_));
  oai21  g401(.a(new_n324_), .b(x022), .c(new_n325_), .O(new_n558_));
  nand2  g402(.a(new_n558_), .b(x070), .O(new_n559_));
  oai21  g403(.a(x070), .b(x014), .c(x022), .O(new_n560_));
  nand4  g404(.a(new_n560_), .b(new_n549_), .c(new_n337_), .d(x030), .O(new_n561_));
  aoi21  g405(.a(new_n561_), .b(new_n559_), .c(x086), .O(new_n562_));
  oai21  g406(.a(new_n562_), .b(new_n557_), .c(new_n177_), .O(new_n563_));
  nand3  g407(.a(x078), .b(x070), .c(x022), .O(new_n564_));
  nand3  g408(.a(new_n564_), .b(new_n563_), .c(new_n545_), .O(new_n565_));
  nand2  g409(.a(new_n549_), .b(x006), .O(new_n566_));
  nand3  g410(.a(new_n323_), .b(x030), .c(new_n330_), .O(new_n567_));
  nand2  g411(.a(new_n567_), .b(new_n566_), .O(new_n568_));
  nand2  g412(.a(new_n568_), .b(new_n320_), .O(new_n569_));
  nand2  g413(.a(new_n558_), .b(new_n323_), .O(new_n570_));
  aoi21  g414(.a(new_n570_), .b(new_n569_), .c(new_n335_), .O(new_n571_));
  oai21  g415(.a(new_n323_), .b(new_n333_), .c(new_n319_), .O(new_n572_));
  nand2  g416(.a(new_n572_), .b(new_n330_), .O(new_n573_));
  nand2  g417(.a(new_n367_), .b(x038), .O(new_n574_));
  nand3  g418(.a(new_n574_), .b(x070), .c(x022), .O(new_n575_));
  nand2  g419(.a(new_n575_), .b(new_n573_), .O(new_n576_));
  oai21  g420(.a(new_n576_), .b(new_n571_), .c(new_n177_), .O(new_n577_));
  nand3  g421(.a(new_n574_), .b(x086), .c(x006), .O(new_n578_));
  nand2  g422(.a(new_n578_), .b(new_n330_), .O(new_n579_));
  aoi22  g423(.a(new_n579_), .b(x078), .c(x054), .d(x038), .O(new_n580_));
  nand2  g424(.a(new_n580_), .b(new_n577_), .O(new_n581_));
  aoi21  g425(.a(new_n565_), .b(new_n367_), .c(new_n581_), .O(new_n582_));
  oai21  g426(.a(new_n582_), .b(x046), .c(new_n179_), .O(z14));
  zero   g427(.O(z18));
  zero   g428(.O(z19));
  zero   g429(.O(z26));
  zero   g430(.O(z27));
  nor2   g431(.a(x104), .b(new_n177_), .O(z15));
  nor2   g432(.a(x104), .b(new_n177_), .O(z16));
  nor2   g433(.a(x104), .b(new_n177_), .O(z17));
  nor2   g434(.a(x104), .b(new_n177_), .O(z20));
  nor2   g435(.a(x104), .b(new_n177_), .O(z21));
  nor2   g436(.a(x104), .b(new_n177_), .O(z22));
  nor2   g437(.a(x104), .b(new_n177_), .O(z23));
  nor2   g438(.a(x104), .b(new_n177_), .O(z24));
  nor2   g439(.a(x104), .b(new_n177_), .O(z25));
endmodule
