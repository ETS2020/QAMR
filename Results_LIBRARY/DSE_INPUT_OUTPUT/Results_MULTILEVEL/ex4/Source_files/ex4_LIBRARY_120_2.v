...
module FAU ( 
  ...
  nand2  g213(.a(x064), .b(new_n173_), .O(new_n371_));
  aoi21  g214(.a(new_n371_), .b(new_n159_), .c(new_n165_), .O(new_n372_));
  nand2  g215(.a(x088), .b(x056), .O(new_n373_));
  nand3  g216(.a(new_n373_), .b(new_n158_), .c(x024), .O(new_n374_));
  aoi21  g217(.a(new_n374_), .b(new_n157_), .c(x080), .O(new_n375_));
  oai21  g218(.a(new_n375_), .b(new_n372_), .c(new_n174_), .O(new_n376_));
  ...
  oai22  g227(.a(new_n373_), .b(new_n157_), .c(x120), .d(x096), .O(new_n385_));
  ...
  oai21  g244(.a(new_n401_), .b(new_n393_), .c(new_n174_), .O(new_n402_));
  nand3  g245(.a(x072), .b(x064), .c(x016), .O(new_n403_));
  nand3  g246(.a(new_n403_), .b(new_n402_), .c(new_n378_), .O(new_n404_));
  nand3  g247(.a(new_n160_), .b(x024), .c(new_n164_), .O(new_n405_));
  oai21  g248(.a(new_n397_), .b(new_n165_), .c(new_n405_), .O(new_n406_));
  nand2  g249(.a(new_n406_), .b(new_n158_), .O(new_n407_));
  nand2  g250(.a(new_n395_), .b(new_n160_), .O(new_n408_));
  aoi21  g251(.a(new_n408_), .b(new_n407_), .c(new_n173_), .O(new_n409_));
  aoi22  g252(.a(x080), .b(x000), .c(x064), .d(x016), .O(new_n410_));
  nand3  g253(.a(new_n169_), .b(x064), .c(x016), .O(new_n411_));
  oai21  g254(.a(new_n410_), .b(x008), .c(new_n411_), .O(new_n412_));
  oai21  g255(.a(new_n412_), .b(new_n409_), .c(new_n174_), .O(new_n413_));
  nand3  g256(.a(new_n169_), .b(x080), .c(x000), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(new_n164_), .O(new_n415_));
  aoi22  g258(.a(new_n415_), .b(x072), .c(x048), .d(x032), .O(new_n416_));
  nand2  g259(.a(new_n416_), .b(new_n413_), .O(new_n417_));
  aoi21  g260(.a(new_n404_), .b(new_n168_), .c(new_n417_), .O(new_n418_));
  ...
  nand3  g275(.a(new_n432_), .b(new_n180_), .c(new_n420_), .O(new_n433_));
  ...
  oai21  g304(.a(new_n461_), .b(x043), .c(new_n180_), .O(z11));
  ...
  oai21  g317(.a(new_n474_), .b(x044), .c(new_n180_), .O(z12));
