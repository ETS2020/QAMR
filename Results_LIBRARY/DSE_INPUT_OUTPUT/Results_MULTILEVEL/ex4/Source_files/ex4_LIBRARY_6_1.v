// Benchmark "FAU" written by ABC on Tue Aug 18 02:18:04 2020
...
module FAU ( 
  ...
  zero   g418(.O(z24));
  zero   g419(.O(z27));
  nor2   g420(.a(new_n157_), .b(x046), .O(z15));
  nor2   g421(.a(new_n157_), .b(x046), .O(z16));
  nor2   g422(.a(new_n157_), .b(x046), .O(z17));
  nor2   g423(.a(new_n157_), .b(x046), .O(z21));
  nor2   g424(.a(new_n157_), .b(x046), .O(z23));
  nor2   g425(.a(new_n157_), .b(x046), .O(z25));
  nor2   g426(.a(new_n157_), .b(x046), .O(z26));
endmodule
