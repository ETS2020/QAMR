...
module FAU ( 
  ...
  oai21  g231(.a(new_n374_), .b(new_n157_), .c(new_n387_), .O(new_n388_));
  ...
  oai21  g263(.a(new_n419_), .b(x040), .c(new_n180_), .O(z08));
  ...
  aoi21  g369(.a(new_n525_), .b(new_n364_), .c(new_n335_), .O(new_n526_));
  nand3  g370(.a(new_n338_), .b(new_n322_), .c(x030), .O(new_n527_));
  nor2   g371(.a(x022), .b(x014), .O(new_n528_));
  aoi21  g372(.a(new_n528_), .b(new_n527_), .c(x086), .O(new_n529_));
  oai21  g373(.a(new_n529_), .b(new_n526_), .c(new_n344_), .O(new_n530_));
  ...
  nand3  g380(.a(new_n320_), .b(x126), .c(new_n331_), .O(new_n537_));
  ...
  oai21  g384(.a(new_n326_), .b(x022), .c(new_n327_), .O(new_n541_));
  and2   g385(.a(new_n541_), .b(x070), .O(new_n542_));
  oai21  g386(.a(x070), .b(x014), .c(x022), .O(new_n543_));
  nand4  g387(.a(new_n543_), .b(new_n534_), .c(new_n338_), .d(x030), .O(new_n544_));
  inv1   g388(.a(new_n544_), .O(new_n545_));
  oai21  g389(.a(new_n545_), .b(new_n542_), .c(new_n325_), .O(new_n546_));
  nand3  g390(.a(new_n546_), .b(new_n540_), .c(new_n530_), .O(new_n547_));
  nand2  g391(.a(new_n534_), .b(x006), .O(new_n548_));
  nand3  g392(.a(new_n325_), .b(x030), .c(new_n330_), .O(new_n549_));
  aoi21  g393(.a(new_n549_), .b(new_n548_), .c(x070), .O(new_n550_));
  nand2  g394(.a(new_n541_), .b(new_n325_), .O(new_n551_));
  nand2  g395(.a(new_n551_), .b(new_n524_), .O(new_n552_));
  oai21  g396(.a(new_n552_), .b(new_n550_), .c(x038), .O(new_n553_));
  oai21  g397(.a(new_n325_), .b(new_n335_), .c(new_n321_), .O(new_n554_));
  nand2  g398(.a(new_n554_), .b(new_n330_), .O(new_n555_));
  nand2  g399(.a(new_n524_), .b(x038), .O(new_n556_));
  nand3  g400(.a(new_n556_), .b(x070), .c(x022), .O(new_n557_));
  nand4  g401(.a(new_n557_), .b(new_n555_), .c(new_n553_), .d(new_n178_), .O(new_n558_));
  aoi21  g402(.a(new_n547_), .b(new_n524_), .c(new_n558_), .O(new_n559_));
  nand3  g403(.a(new_n556_), .b(x086), .c(x006), .O(new_n560_));
  nand3  g404(.a(x070), .b(new_n524_), .c(x022), .O(new_n561_));
  nand3  g405(.a(new_n561_), .b(new_n560_), .c(new_n330_), .O(new_n562_));
  aoi22  g406(.a(new_n562_), .b(x078), .c(x054), .d(x038), .O(new_n563_));
  oai22  g407(.a(new_n563_), .b(x046), .c(new_n559_), .d(x078), .O(z14));
  zero   g408(.O(z17));
  zero   g409(.O(z21));
  zero   g410(.O(z22));
  zero   g411(.O(z24));
  ...
  nor2   g417(.a(x078), .b(new_n178_), .O(z18));
