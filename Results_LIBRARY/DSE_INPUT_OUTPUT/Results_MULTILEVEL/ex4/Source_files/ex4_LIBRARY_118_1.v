...
module FAU ( 
  ...
  oai22  g279(.a(new_n196_), .b(new_n189_), .c(new_n195_), .d(new_n188_), .O(new_n437_));
  aoi21  g280(.a(new_n436_), .b(new_n189_), .c(new_n437_), .O(new_n438_));
  nand3  g281(.a(new_n438_), .b(new_n434_), .c(new_n431_), .O(new_n439_));
  nand3  g282(.a(new_n439_), .b(new_n180_), .c(new_n427_), .O(new_n440_));
  ...
  zero   g413(.O(z21));
  zero   g414(.O(z22));
  nor2   g415(.a(new_n178_), .b(x046), .O(z19));
  nor2   g416(.a(new_n178_), .b(x046), .O(z20));
  nor2   g417(.a(new_n178_), .b(x046), .O(z23));
  nor2   g418(.a(new_n178_), .b(x046), .O(z24));
  nor2   g419(.a(new_n178_), .b(x046), .O(z25));
