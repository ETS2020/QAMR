...
module FAU ( 
  ...
  nand3  g304(.a(new_n460_), .b(new_n180_), .c(new_n448_), .O(new_n461_));
  ...
  nand3  g319(.a(new_n475_), .b(new_n180_), .c(new_n463_), .O(new_n476_));
  ...
  nor2   g424(.a(x078), .b(new_n178_), .O(z18));
  nor2   g425(.a(x078), .b(new_n178_), .O(z19));
  nor2   g426(.a(x078), .b(new_n178_), .O(z22));
endmodule
