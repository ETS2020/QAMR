...
module FAU ( 
  ...
  nand2  g377(.a(new_n359_), .b(x038), .O(new_n534_));
  nand3  g378(.a(new_n534_), .b(x086), .c(x006), .O(new_n535_));
  nand2  g379(.a(x054), .b(x038), .O(new_n536_));
  nand3  g380(.a(x070), .b(new_n359_), .c(x022), .O(new_n537_));
  nand4  g381(.a(new_n537_), .b(new_n536_), .c(new_n535_), .d(new_n331_), .O(new_n538_));
