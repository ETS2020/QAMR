...
module FAU ( 
  ...
  oai21  g336(.a(new_n294_), .b(x029), .c(new_n492_), .O(new_n493_));
  nand2  g337(.a(new_n279_), .b(new_n278_), .O(new_n494_));
  oai21  g338(.a(new_n275_), .b(new_n265_), .c(new_n494_), .O(new_n495_));
  ...
  nand4  g349(.a(new_n505_), .b(new_n494_), .c(new_n275_), .d(x029), .O(new_n506_));
  ...
  nand3  g355(.a(new_n271_), .b(x029), .c(new_n296_), .O(new_n512_));
  ...
  oai21  g377(.a(new_n533_), .b(new_n531_), .c(new_n322_), .O(new_n534_));
  ...
  nand3  g386(.a(new_n321_), .b(x126), .c(new_n328_), .O(new_n543_));
  ...
  oai21  g396(.a(new_n552_), .b(new_n547_), .c(new_n322_), .O(new_n553_));
  ...
  oai21  g410(.a(new_n566_), .b(new_n561_), .c(new_n322_), .O(new_n567_));
  ...
  oai21  g416(.a(new_n572_), .b(x046), .c(new_n179_), .O(z14));
  zero   g417(.O(z15));
  zero   g418(.O(z17));
  zero   g419(.O(z21));
  zero   g420(.O(z23));
  zero   g421(.O(z26));
  nor2   g422(.a(x087), .b(x078), .O(z16));
  nor2   g423(.a(x087), .b(x078), .O(z18));
  nor2   g424(.a(x087), .b(x078), .O(z19));
  nor2   g425(.a(x087), .b(x078), .O(z20));
  nor2   g426(.a(x087), .b(x078), .O(z22));
  nor2   g427(.a(x087), .b(x078), .O(z24));
  nor2   g428(.a(x087), .b(x078), .O(z25));
  nor2   g429(.a(x087), .b(x078), .O(z27));
endmodule
