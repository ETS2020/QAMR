...
module FAU ( 
  ...
  oai21  g374(.a(new_n531_), .b(x045), .c(new_n158_), .O(z13));
  ...
  nand4  g380(.a(new_n537_), .b(new_n536_), .c(new_n535_), .d(new_n356_), .O(new_n538_));
  nand3  g381(.a(new_n538_), .b(x078), .c(new_n321_), .O(new_n539_));
  inv1   g382(.a(new_n539_), .O(z14));
  zero   g383(.O(z07));
  zero   g384(.O(z15));
  zero   g385(.O(z16));
  zero   g386(.O(z17));
