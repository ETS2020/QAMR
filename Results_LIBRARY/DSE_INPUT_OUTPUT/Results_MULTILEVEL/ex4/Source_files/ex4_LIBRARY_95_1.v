...
module FAU ( 
  ...
  aoi21  g114(.a(new_n270_), .b(new_n263_), .c(new_n157_), .O(new_n271_));
  inv1   g115(.a(x085), .O(new_n272_));
  nor2   g116(.a(new_n272_), .b(x013), .O(new_n273_));
  oai21  g117(.a(new_n273_), .b(new_n271_), .c(new_n258_), .O(new_n274_));
  ...
  nand3  g144(.a(new_n157_), .b(new_n286_), .c(new_n279_), .O(new_n301_));
  ...
  aoi22  g160(.a(new_n316_), .b(new_n157_), .c(new_n314_), .d(new_n260_), .O(new_n317_));
  ...
  oai21  g228(.a(new_n384_), .b(new_n321_), .c(new_n158_), .O(z06));
  ...
  nand3  g291(.a(new_n448_), .b(new_n158_), .c(new_n436_), .O(new_n449_));
  ...
  oai21  g333(.a(new_n490_), .b(x044), .c(new_n158_), .O(z12));
  ...
  oai21  g341(.a(new_n498_), .b(new_n495_), .c(new_n157_), .O(new_n499_));
  ...
  nand3  g350(.a(new_n258_), .b(x125), .c(new_n279_), .O(new_n508_));
  ...
  oai21  g362(.a(new_n519_), .b(new_n512_), .c(new_n157_), .O(new_n520_));
  ...
  oai21  g376(.a(new_n533_), .b(new_n528_), .c(new_n157_), .O(new_n534_));
  ...
  oai21  g431(.a(new_n588_), .b(x046), .c(new_n158_), .O(z14));
  inv1   g432(.a(new_n158_), .O(z15));
  zero   g433(.O(z07));
  zero   g434(.O(z16));
  zero   g435(.O(z17));
  zero   g436(.O(z19));
  ...
  zero   g439(.O(z25));
  zero   g440(.O(z27));
  inv1   g441(.a(new_n158_), .O(z18));
  inv1   g442(.a(new_n158_), .O(z21));
  inv1   g443(.a(new_n158_), .O(z22));
  inv1   g444(.a(new_n158_), .O(z24));
  inv1   g445(.a(new_n158_), .O(z26));
endmodule
