...
module FAU ( 
  ...
  nand2  g377(.a(x070), .b(new_n338_), .O(new_n535_));
  aoi21  g378(.a(new_n535_), .b(new_n363_), .c(new_n337_), .O(new_n536_));
  nand3  g379(.a(new_n340_), .b(new_n325_), .c(x030), .O(new_n537_));
  nor2   g380(.a(x022), .b(x014), .O(new_n538_));
  aoi21  g381(.a(new_n538_), .b(new_n537_), .c(x086), .O(new_n539_));
  oai21  g382(.a(new_n539_), .b(new_n536_), .c(new_n346_), .O(new_n540_));
  oai21  g383(.a(x038), .b(x014), .c(x022), .O(new_n541_));
  oai21  g384(.a(new_n330_), .b(x030), .c(new_n541_), .O(new_n542_));
  inv1   g385(.a(x102), .O(new_n543_));
  nand2  g386(.a(new_n345_), .b(new_n543_), .O(new_n544_));
  oai21  g387(.a(new_n340_), .b(new_n333_), .c(new_n544_), .O(new_n545_));
  aoi21  g388(.a(new_n545_), .b(new_n542_), .c(x070), .O(new_n546_));
  nand3  g389(.a(new_n323_), .b(x126), .c(new_n333_), .O(new_n547_));
  nand3  g390(.a(x102), .b(x070), .c(new_n338_), .O(new_n548_));
  nand3  g391(.a(new_n548_), .b(new_n547_), .c(new_n328_), .O(new_n549_));
  oai21  g392(.a(new_n549_), .b(new_n546_), .c(x006), .O(new_n550_));
  aoi21  g393(.a(x030), .b(new_n333_), .c(new_n330_), .O(new_n551_));
  oai21  g394(.a(x070), .b(x014), .c(x022), .O(new_n552_));
  nand4  g395(.a(new_n552_), .b(new_n544_), .c(new_n340_), .d(x030), .O(new_n553_));
  oai21  g396(.a(new_n551_), .b(new_n325_), .c(new_n553_), .O(new_n554_));
  nand2  g397(.a(new_n554_), .b(new_n328_), .O(new_n555_));
  nand3  g398(.a(new_n555_), .b(new_n550_), .c(new_n540_), .O(new_n556_));
  nand2  g399(.a(new_n556_), .b(new_n371_), .O(new_n557_));
  ...
  nand3  g406(.a(new_n563_), .b(new_n561_), .c(new_n371_), .O(new_n564_));
  oai21  g407(.a(new_n328_), .b(new_n337_), .c(new_n324_), .O(new_n565_));
  nand2  g408(.a(new_n565_), .b(new_n332_), .O(new_n566_));
  nand2  g409(.a(new_n371_), .b(x038), .O(new_n567_));
