...
module FAU ( 
  ...
  oai21  g361(.a(new_n517_), .b(new_n512_), .c(new_n158_), .O(new_n518_));
  ...
  oai22  g376(.a(new_n532_), .b(new_n158_), .c(new_n326_), .d(new_n323_), .O(new_n533_));
  aoi21  g377(.a(new_n530_), .b(new_n158_), .c(new_n533_), .O(new_n534_));
  ...
  nor2   g389(.a(new_n158_), .b(new_n157_), .O(z18));
  nor2   g390(.a(new_n158_), .b(new_n157_), .O(z19));
  nor2   g391(.a(new_n158_), .b(new_n157_), .O(z25));
endmodule
