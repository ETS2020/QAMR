...
module FAU ( 
  ...
  nor2   g022(.a(x108), .b(new_n178_), .O(z15));
  ...
  nand3  g312(.a(new_n469_), .b(new_n180_), .c(new_n457_), .O(new_n470_));
  ...
  nand2  g318(.a(new_n475_), .b(new_n245_), .O(new_n476_));
  ...
  oai22  g324(.a(new_n253_), .b(new_n246_), .c(new_n252_), .d(new_n245_), .O(new_n482_));
  aoi21  g325(.a(new_n481_), .b(new_n246_), .c(new_n482_), .O(new_n483_));
  nand3  g326(.a(new_n483_), .b(new_n479_), .c(new_n476_), .O(new_n484_));
  nand3  g327(.a(new_n484_), .b(new_n180_), .c(new_n472_), .O(new_n485_));
  ...
  nor3   g377(.a(new_n534_), .b(z15), .c(x045), .O(z13));
  ...
  nand2  g419(.a(new_n576_), .b(x108), .O(new_n577_));
  ...
  zero   g425(.O(z25));
  zero   g426(.O(z27));
  nor2   g427(.a(x108), .b(new_n178_), .O(z17));
  nor2   g428(.a(x108), .b(new_n178_), .O(z20));
  nor2   g429(.a(x108), .b(new_n178_), .O(z21));
  nor2   g430(.a(x108), .b(new_n178_), .O(z22));
  nor2   g431(.a(x108), .b(new_n178_), .O(z23));
  nor2   g432(.a(x108), .b(new_n178_), .O(z24));
  nor2   g433(.a(x108), .b(new_n178_), .O(z26));
endmodule
