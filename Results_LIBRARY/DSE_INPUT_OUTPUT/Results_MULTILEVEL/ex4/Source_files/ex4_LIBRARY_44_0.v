...
module FAU ( 
  ...
  oai21  g222(.a(new_n378_), .b(new_n377_), .c(x097), .O(new_n379_));
  ...
  oai21  g285(.a(new_n441_), .b(x041), .c(new_n158_), .O(z09));
  ...
  nand3  g299(.a(new_n455_), .b(new_n158_), .c(new_n443_), .O(new_n456_));
  ...
  nand2  g421(.a(new_n577_), .b(x097), .O(new_n578_));
  ...
  zero   g432(.O(z22));
  zero   g433(.O(z25));
  nor2   g434(.a(x097), .b(x078), .O(z15));
  nor2   g435(.a(x097), .b(x078), .O(z19));
  nor2   g436(.a(x097), .b(x078), .O(z20));
  nor2   g437(.a(x097), .b(x078), .O(z23));
  nor2   g438(.a(x097), .b(x078), .O(z24));
  nor2   g439(.a(x097), .b(x078), .O(z26));
  nor2   g440(.a(x097), .b(x078), .O(z27));
endmodule
