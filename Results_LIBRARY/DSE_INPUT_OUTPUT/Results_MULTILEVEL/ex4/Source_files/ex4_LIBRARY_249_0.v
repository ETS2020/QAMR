...
module FAU ( 
  ...
  oai21  g235(.a(new_n378_), .b(new_n159_), .c(new_n391_), .O(new_n392_));
  nand2  g236(.a(new_n392_), .b(new_n388_), .O(new_n393_));
  nand2  g237(.a(new_n393_), .b(new_n160_), .O(new_n394_));
  nand2  g238(.a(x112), .b(x104), .O(new_n395_));
  nand3  g239(.a(new_n395_), .b(x120), .c(new_n159_), .O(new_n396_));
  nand3  g240(.a(x096), .b(x064), .c(new_n175_), .O(new_n397_));
  nand3  g241(.a(new_n397_), .b(new_n396_), .c(new_n162_), .O(new_n398_));
  inv1   g242(.a(new_n398_), .O(new_n399_));
  aoi21  g243(.a(new_n399_), .b(new_n394_), .c(new_n167_), .O(new_n400_));
  ...
  oai21  g249(.a(new_n405_), .b(new_n400_), .c(new_n176_), .O(new_n406_));
  ...
  nand2  g256(.a(new_n401_), .b(new_n162_), .O(new_n413_));
  ...
  aoi21  g266(.a(new_n408_), .b(new_n170_), .c(new_n422_), .O(new_n423_));
  oai21  g267(.a(new_n423_), .b(x040), .c(new_n158_), .O(z08));
  ...
  oai21  g323(.a(new_n479_), .b(x044), .c(new_n158_), .O(z12));
