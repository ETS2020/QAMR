...
module FAU ( 
  ...
  nor3   g378(.a(new_n535_), .b(new_n321_), .c(x045), .O(z13));
  ...
  zero   g431(.O(z26));
  zero   g432(.O(z27));
  nor2   g433(.a(x078), .b(x045), .O(z19));
  nor2   g434(.a(x078), .b(x045), .O(z21));
  nor2   g435(.a(x078), .b(x045), .O(z22));
  nor2   g436(.a(x078), .b(x045), .O(z25));
endmodule
