...
module FAU ( 
  ...
  nand3  g177(.a(new_n333_), .b(new_n179_), .c(x046), .O(new_n334_));
  ...
  oai21  g270(.a(new_n426_), .b(x043), .c(new_n181_), .O(z11));
  ...
  oai21  g283(.a(new_n439_), .b(x044), .c(new_n181_), .O(z12));
  ...
  oai21  g330(.a(new_n486_), .b(x045), .c(new_n181_), .O(z13));
  ...
  oai21  g338(.a(new_n494_), .b(new_n491_), .c(new_n179_), .O(new_n495_));
  ...
  oai21  g371(.a(new_n527_), .b(new_n523_), .c(new_n179_), .O(new_n528_));
  ...
  nand4  g377(.a(new_n533_), .b(new_n532_), .c(new_n531_), .d(new_n178_), .O(new_n534_));
  ...
  zero   g382(.O(z26));
  zero   g383(.O(z27));
  nor2   g384(.a(new_n179_), .b(new_n178_), .O(z15));
  nor2   g385(.a(new_n179_), .b(new_n178_), .O(z16));
  ...
  nor2   g392(.a(new_n179_), .b(new_n178_), .O(z25));
endmodule
