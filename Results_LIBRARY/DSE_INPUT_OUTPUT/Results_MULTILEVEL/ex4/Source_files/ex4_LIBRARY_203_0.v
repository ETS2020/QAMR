// Benchmark "FAU" written by ABC on Tue Aug 18 02:19:25 2020
...
module FAU ( 
  ...
  nor3   g160(.a(new_n316_), .b(z07), .c(new_n257_), .O(z05));
  ...
  oai22  g178(.a(new_n334_), .b(new_n332_), .c(new_n320_), .d(new_n319_), .O(new_n335_));
  nor2   g179(.a(x022), .b(x014), .O(new_n336_));
  inv1   g180(.a(x094), .O(new_n337_));
  nand2  g181(.a(x062), .b(x030), .O(new_n338_));
  aoi21  g182(.a(new_n338_), .b(x038), .c(new_n337_), .O(new_n339_));
  and2   g183(.a(x126), .b(x102), .O(new_n340_));
  oai22  g184(.a(new_n340_), .b(new_n329_), .c(new_n339_), .d(new_n336_), .O(new_n341_));
  nand2  g185(.a(new_n341_), .b(x070), .O(new_n342_));
  inv1   g186(.a(x126), .O(new_n343_));
  nand2  g187(.a(new_n320_), .b(new_n319_), .O(new_n344_));
  nand3  g188(.a(new_n344_), .b(new_n343_), .c(x022), .O(new_n345_));
  oai21  g189(.a(x102), .b(new_n323_), .c(new_n345_), .O(new_n346_));
  aoi21  g190(.a(new_n346_), .b(new_n328_), .c(new_n333_), .O(new_n347_));
  ...
  nand4  g200(.a(new_n356_), .b(new_n354_), .c(new_n353_), .d(new_n349_), .O(new_n357_));
  aoi21  g201(.a(new_n357_), .b(new_n352_), .c(new_n333_), .O(new_n358_));
  oai21  g202(.a(new_n358_), .b(new_n348_), .c(x078), .O(new_n359_));
  nand3  g203(.a(new_n321_), .b(new_n328_), .c(new_n327_), .O(new_n360_));
  nand3  g204(.a(new_n360_), .b(new_n359_), .c(new_n335_), .O(new_n361_));
  nor2   g205(.a(x086), .b(new_n355_), .O(new_n362_));
  nand3  g206(.a(new_n337_), .b(x070), .c(new_n323_), .O(new_n363_));
  inv1   g207(.a(new_n363_), .O(new_n364_));
  oai21  g208(.a(new_n364_), .b(new_n362_), .c(new_n322_), .O(new_n365_));
  nor2   g209(.a(x070), .b(x022), .O(new_n366_));
  nand4  g210(.a(x086), .b(x070), .c(new_n323_), .d(new_n349_), .O(new_n367_));
  inv1   g211(.a(new_n367_), .O(new_n368_));
  oai21  g212(.a(new_n368_), .b(new_n366_), .c(x014), .O(new_n369_));
  nand2  g213(.a(x054), .b(new_n323_), .O(new_n370_));
  nand3  g214(.a(new_n370_), .b(new_n328_), .c(new_n327_), .O(new_n371_));
  nand3  g215(.a(new_n351_), .b(x086), .c(new_n323_), .O(new_n372_));
  nand4  g216(.a(new_n372_), .b(new_n371_), .c(new_n369_), .d(new_n365_), .O(new_n373_));
  nand2  g217(.a(new_n373_), .b(x078), .O(new_n374_));
  inv1   g218(.a(x054), .O(new_n375_));
  nand3  g219(.a(new_n370_), .b(new_n333_), .c(new_n322_), .O(new_n376_));
  ...
  aoi21  g223(.a(new_n361_), .b(x054), .c(new_n379_), .O(new_n380_));
  oai21  g224(.a(new_n380_), .b(new_n318_), .c(new_n179_), .O(z06));
  ...
  oai21  g239(.a(new_n384_), .b(new_n157_), .c(new_n395_), .O(new_n396_));
  nand2  g240(.a(new_n396_), .b(new_n394_), .O(new_n397_));
  ...
  oai21  g248(.a(new_n391_), .b(x016), .c(new_n392_), .O(new_n405_));
  nand2  g249(.a(new_n405_), .b(x064), .O(new_n406_));
  oai21  g250(.a(x064), .b(x008), .c(x016), .O(new_n407_));
  nand4  g251(.a(new_n407_), .b(new_n395_), .c(new_n384_), .d(x024), .O(new_n408_));
  aoi21  g252(.a(new_n408_), .b(new_n406_), .c(x080), .O(new_n409_));
  oai21  g253(.a(new_n409_), .b(new_n404_), .c(new_n174_), .O(new_n410_));
  nand3  g254(.a(x072), .b(x064), .c(x016), .O(new_n411_));
  nand3  g255(.a(new_n411_), .b(new_n410_), .c(new_n389_), .O(new_n412_));
  nand2  g256(.a(new_n395_), .b(x000), .O(new_n413_));
  nand3  g257(.a(new_n160_), .b(x024), .c(new_n164_), .O(new_n414_));
  nand2  g258(.a(new_n414_), .b(new_n413_), .O(new_n415_));
  nand2  g259(.a(new_n415_), .b(new_n158_), .O(new_n416_));
  nand2  g260(.a(new_n405_), .b(new_n160_), .O(new_n417_));
  aoi21  g261(.a(new_n417_), .b(new_n416_), .c(new_n173_), .O(new_n418_));
  aoi22  g262(.a(x080), .b(x000), .c(x064), .d(x016), .O(new_n419_));
  nand3  g263(.a(new_n169_), .b(x064), .c(x016), .O(new_n420_));
  oai21  g264(.a(new_n419_), .b(x008), .c(new_n420_), .O(new_n421_));
  oai21  g265(.a(new_n421_), .b(new_n418_), .c(new_n174_), .O(new_n422_));
  nand3  g266(.a(new_n169_), .b(x080), .c(x000), .O(new_n423_));
  nand2  g267(.a(new_n423_), .b(new_n164_), .O(new_n424_));
  aoi22  g268(.a(new_n424_), .b(x072), .c(x048), .d(x032), .O(new_n425_));
  nand2  g269(.a(new_n425_), .b(new_n422_), .O(new_n426_));
  aoi21  g270(.a(new_n412_), .b(new_n168_), .c(new_n426_), .O(new_n427_));
  nor3   g271(.a(new_n427_), .b(z07), .c(x040), .O(z08));
  ...
  oai21  g277(.a(new_n194_), .b(x033), .c(new_n433_), .O(new_n434_));
  nand2  g278(.a(x081), .b(x001), .O(new_n435_));
  aoi21  g279(.a(new_n435_), .b(new_n429_), .c(x073), .O(new_n436_));
  nand2  g280(.a(new_n436_), .b(new_n188_), .O(new_n437_));
  aoi22  g281(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n438_));
  nand3  g282(.a(new_n438_), .b(new_n437_), .c(new_n434_), .O(new_n439_));
  aoi21  g283(.a(new_n431_), .b(new_n187_), .c(new_n439_), .O(new_n440_));
  oai21  g284(.a(new_n440_), .b(x041), .c(new_n179_), .O(z09));
  inv1   g285(.a(x042), .O(new_n442_));
  ...
  nand2  g289(.a(new_n445_), .b(new_n206_), .O(new_n446_));
  nand3  g290(.a(x082), .b(x010), .c(x002), .O(new_n447_));
  oai21  g291(.a(new_n443_), .b(x010), .c(new_n447_), .O(new_n448_));
  oai21  g292(.a(new_n213_), .b(x034), .c(new_n448_), .O(new_n449_));
  nand2  g293(.a(x082), .b(x002), .O(new_n450_));
  aoi21  g294(.a(new_n450_), .b(new_n443_), .c(x074), .O(new_n451_));
  oai22  g295(.a(new_n214_), .b(new_n207_), .c(new_n213_), .d(new_n206_), .O(new_n452_));
  aoi21  g296(.a(new_n451_), .b(new_n207_), .c(new_n452_), .O(new_n453_));
  nand3  g297(.a(new_n453_), .b(new_n449_), .c(new_n446_), .O(new_n454_));
  nand3  g298(.a(new_n454_), .b(new_n179_), .c(new_n442_), .O(new_n455_));
  inv1   g299(.a(new_n455_), .O(z10));
  ...
  oai21  g305(.a(new_n232_), .b(x035), .c(new_n461_), .O(new_n462_));
  nand2  g306(.a(x083), .b(x003), .O(new_n463_));
  aoi21  g307(.a(new_n463_), .b(new_n457_), .c(x075), .O(new_n464_));
  nand2  g308(.a(new_n464_), .b(new_n226_), .O(new_n465_));
  aoi22  g309(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n466_));
  nand3  g310(.a(new_n466_), .b(new_n465_), .c(new_n462_), .O(new_n467_));
  aoi21  g311(.a(new_n459_), .b(new_n225_), .c(new_n467_), .O(new_n468_));
  oai21  g312(.a(new_n468_), .b(x043), .c(new_n179_), .O(z11));
  inv1   g313(.a(x044), .O(new_n470_));
  nand2  g314(.a(x068), .b(x020), .O(new_n471_));
  nand3  g315(.a(x084), .b(new_n245_), .c(x004), .O(new_n472_));
  oai21  g316(.a(new_n471_), .b(new_n245_), .c(new_n472_), .O(new_n473_));
  nand2  g317(.a(new_n473_), .b(new_n244_), .O(new_n474_));
  ...
  oai22  g323(.a(new_n252_), .b(new_n245_), .c(new_n251_), .d(new_n244_), .O(new_n480_));
  aoi21  g324(.a(new_n479_), .b(new_n245_), .c(new_n480_), .O(new_n481_));
  nand3  g325(.a(new_n481_), .b(new_n477_), .c(new_n474_), .O(new_n482_));
  nand3  g326(.a(new_n482_), .b(new_n179_), .c(new_n470_), .O(new_n483_));
  inv1   g327(.a(new_n483_), .O(z12));
  nand2  g328(.a(new_n266_), .b(new_n265_), .O(new_n485_));
  nand2  g329(.a(x069), .b(new_n261_), .O(new_n486_));
  aoi21  g330(.a(new_n486_), .b(new_n485_), .c(new_n260_), .O(new_n487_));
  nand3  g331(.a(new_n275_), .b(new_n266_), .c(x029), .O(new_n488_));
  aoi21  g332(.a(new_n488_), .b(new_n265_), .c(x085), .O(new_n489_));
  oai21  g333(.a(new_n489_), .b(new_n487_), .c(new_n259_), .O(new_n490_));
  oai21  g334(.a(x085), .b(new_n294_), .c(new_n490_), .O(new_n491_));
  oai21  g335(.a(x117), .b(x109), .c(new_n491_), .O(new_n492_));
  oai21  g336(.a(x037), .b(x013), .c(x021), .O(new_n493_));
  oai21  g337(.a(new_n292_), .b(x029), .c(new_n493_), .O(new_n494_));
  nand2  g338(.a(new_n279_), .b(new_n278_), .O(new_n495_));
  oai21  g339(.a(new_n275_), .b(new_n265_), .c(new_n495_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n494_), .O(new_n497_));
  nand3  g341(.a(new_n258_), .b(x125), .c(new_n265_), .O(new_n498_));
  nand3  g342(.a(x101), .b(x069), .c(new_n261_), .O(new_n499_));
  nand3  g343(.a(new_n499_), .b(new_n498_), .c(new_n271_), .O(new_n500_));
  aoi21  g344(.a(new_n497_), .b(new_n266_), .c(new_n500_), .O(new_n501_));
  nor2   g345(.a(new_n501_), .b(new_n260_), .O(new_n502_));
  oai21  g346(.a(new_n291_), .b(x021), .c(new_n267_), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(x069), .O(new_n504_));
  oai21  g348(.a(x069), .b(x013), .c(x021), .O(new_n505_));
  nand4  g349(.a(new_n505_), .b(new_n495_), .c(new_n275_), .d(x029), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(new_n504_), .c(x085), .O(new_n507_));
  oai21  g351(.a(new_n507_), .b(new_n502_), .c(new_n259_), .O(new_n508_));
  nand3  g352(.a(x077), .b(x069), .c(x021), .O(new_n509_));
  nand3  g353(.a(new_n509_), .b(new_n508_), .c(new_n492_), .O(new_n510_));
  nand2  g354(.a(new_n495_), .b(x005), .O(new_n511_));
  nand3  g355(.a(new_n271_), .b(x029), .c(new_n294_), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n511_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n266_), .O(new_n514_));
  nand2  g358(.a(new_n503_), .b(new_n271_), .O(new_n515_));
  aoi21  g359(.a(new_n515_), .b(new_n514_), .c(new_n261_), .O(new_n516_));
  oai21  g360(.a(new_n271_), .b(new_n260_), .c(new_n262_), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n294_), .O(new_n518_));
  nand2  g362(.a(new_n311_), .b(x037), .O(new_n519_));
  nand3  g363(.a(new_n519_), .b(x069), .c(x021), .O(new_n520_));
  nand2  g364(.a(new_n520_), .b(new_n518_), .O(new_n521_));
  oai21  g365(.a(new_n521_), .b(new_n516_), .c(new_n259_), .O(new_n522_));
  ...
  aoi21  g370(.a(new_n510_), .b(new_n311_), .c(new_n526_), .O(new_n527_));
  oai21  g371(.a(new_n527_), .b(x045), .c(new_n179_), .O(z13));
  oai21  g372(.a(new_n366_), .b(new_n364_), .c(x006), .O(new_n529_));
  inv1   g373(.a(x062), .O(new_n530_));
  nand2  g374(.a(x094), .b(new_n530_), .O(new_n531_));
  nand2  g375(.a(new_n337_), .b(new_n328_), .O(new_n532_));
  aoi21  g376(.a(new_n532_), .b(new_n531_), .c(new_n349_), .O(new_n533_));
  oai21  g377(.a(new_n533_), .b(x022), .c(new_n333_), .O(new_n534_));
  aoi21  g378(.a(new_n534_), .b(new_n529_), .c(x078), .O(new_n535_));
  oai21  g379(.a(new_n535_), .b(new_n362_), .c(new_n344_), .O(new_n536_));
  aoi21  g380(.a(new_n530_), .b(new_n349_), .c(x070), .O(new_n537_));
  oai22  g381(.a(new_n537_), .b(x094), .c(new_n327_), .d(new_n355_), .O(new_n538_));
  nand2  g382(.a(new_n532_), .b(new_n531_), .O(new_n539_));
  aoi21  g383(.a(x118), .b(x110), .c(x022), .O(new_n540_));
  oai21  g384(.a(new_n540_), .b(new_n539_), .c(x126), .O(new_n541_));
  inv1   g385(.a(new_n531_), .O(new_n542_));
  aoi21  g386(.a(x070), .b(x038), .c(x094), .O(new_n543_));
  oai21  g387(.a(new_n543_), .b(new_n542_), .c(x102), .O(new_n544_));
  nand4  g388(.a(new_n544_), .b(new_n541_), .c(new_n538_), .d(new_n333_), .O(new_n545_));
  nand2  g389(.a(new_n545_), .b(x006), .O(new_n546_));
  nor2   g390(.a(new_n329_), .b(new_n328_), .O(new_n547_));
  nor2   g391(.a(x126), .b(x102), .O(new_n548_));
  aoi21  g392(.a(x094), .b(x062), .c(x022), .O(new_n549_));
  aoi21  g393(.a(new_n539_), .b(new_n355_), .c(new_n549_), .O(new_n550_));
  nand2  g394(.a(x070), .b(new_n327_), .O(new_n551_));
  oai21  g395(.a(new_n550_), .b(new_n548_), .c(new_n551_), .O(new_n552_));
  aoi21  g396(.a(new_n552_), .b(x030), .c(new_n547_), .O(new_n553_));
  oai21  g397(.a(new_n553_), .b(x086), .c(new_n546_), .O(new_n554_));
  nand2  g398(.a(new_n554_), .b(new_n321_), .O(new_n555_));
  nand3  g399(.a(x078), .b(x070), .c(x022), .O(new_n556_));
  nand3  g400(.a(new_n556_), .b(new_n555_), .c(new_n536_), .O(new_n557_));
  nor2   g401(.a(new_n337_), .b(new_n323_), .O(new_n558_));
  oai21  g402(.a(new_n558_), .b(new_n334_), .c(x006), .O(new_n559_));
  nand4  g403(.a(new_n333_), .b(new_n328_), .c(x038), .d(x030), .O(new_n560_));
  nand2  g404(.a(new_n560_), .b(new_n324_), .O(new_n561_));
  nand2  g405(.a(new_n561_), .b(new_n355_), .O(new_n562_));
  nand2  g406(.a(new_n375_), .b(x038), .O(new_n563_));
  nand3  g407(.a(new_n563_), .b(x070), .c(x022), .O(new_n564_));
  oai21  g408(.a(new_n349_), .b(x022), .c(new_n329_), .O(new_n565_));
  nand3  g409(.a(new_n565_), .b(new_n333_), .c(x038), .O(new_n566_));
  nand4  g410(.a(new_n566_), .b(new_n564_), .c(new_n562_), .d(new_n559_), .O(new_n567_));
  nand2  g411(.a(new_n567_), .b(new_n321_), .O(new_n568_));
  nand3  g412(.a(new_n563_), .b(x086), .c(x006), .O(new_n569_));
  nand2  g413(.a(new_n569_), .b(new_n355_), .O(new_n570_));
  aoi22  g414(.a(new_n570_), .b(x078), .c(x054), .d(x038), .O(new_n571_));
  nand2  g415(.a(new_n571_), .b(new_n568_), .O(new_n572_));
  aoi21  g416(.a(new_n557_), .b(new_n375_), .c(new_n572_), .O(new_n573_));
  oai21  g417(.a(new_n573_), .b(x046), .c(new_n179_), .O(z14));
  zero   g418(.O(z15));
  zero   g419(.O(z16));
  zero   g420(.O(z17));
  zero   g421(.O(z19));
  ...
  zero   g424(.O(z26));
  zero   g425(.O(z27));
  nor2   g426(.a(x099), .b(x094), .O(z18));
  nor2   g427(.a(x099), .b(x094), .O(z20));
  nor2   g428(.a(x099), .b(x094), .O(z21));
  nor2   g429(.a(x099), .b(x094), .O(z23));
  nor2   g430(.a(x099), .b(x094), .O(z25));
endmodule
