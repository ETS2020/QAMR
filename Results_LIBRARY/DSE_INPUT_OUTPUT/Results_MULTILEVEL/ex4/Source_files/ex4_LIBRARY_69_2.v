...
module FAU ( 
  ...
  nand2  g371(.a(x070), .b(new_n341_), .O(new_n529_));
  aoi21  g372(.a(new_n529_), .b(new_n366_), .c(new_n340_), .O(new_n530_));
  nand3  g373(.a(new_n343_), .b(new_n326_), .c(x030), .O(new_n531_));
  aoi21  g374(.a(new_n531_), .b(new_n336_), .c(x086), .O(new_n532_));
  oai21  g375(.a(new_n532_), .b(new_n530_), .c(new_n323_), .O(new_n533_));
  oai21  g376(.a(x086), .b(new_n335_), .c(new_n533_), .O(new_n534_));
  nand2  g377(.a(new_n534_), .b(new_n349_), .O(new_n535_));
  oai21  g378(.a(x038), .b(x014), .c(x022), .O(new_n536_));
  oai21  g379(.a(new_n333_), .b(x030), .c(new_n536_), .O(new_n537_));
  inv1   g380(.a(x102), .O(new_n538_));
  nand2  g381(.a(new_n348_), .b(new_n538_), .O(new_n539_));
  oai21  g382(.a(new_n343_), .b(new_n336_), .c(new_n539_), .O(new_n540_));
  nand2  g383(.a(new_n540_), .b(new_n537_), .O(new_n541_));
  nand2  g384(.a(new_n541_), .b(new_n326_), .O(new_n542_));
  nand3  g385(.a(new_n324_), .b(x126), .c(new_n336_), .O(new_n543_));
  nand3  g386(.a(x102), .b(x070), .c(new_n341_), .O(new_n544_));
  nand3  g387(.a(new_n544_), .b(new_n543_), .c(new_n329_), .O(new_n545_));
  inv1   g388(.a(new_n545_), .O(new_n546_));
  aoi21  g389(.a(new_n546_), .b(new_n542_), .c(new_n340_), .O(new_n547_));
  nor2   g390(.a(new_n330_), .b(x022), .O(new_n548_));
  oai21  g391(.a(new_n548_), .b(new_n333_), .c(x070), .O(new_n549_));
  oai21  g392(.a(x070), .b(x014), .c(x022), .O(new_n550_));
  nand4  g393(.a(new_n550_), .b(new_n539_), .c(new_n343_), .d(x030), .O(new_n551_));
  aoi21  g394(.a(new_n551_), .b(new_n549_), .c(x086), .O(new_n552_));
  oai21  g395(.a(new_n552_), .b(new_n547_), .c(new_n323_), .O(new_n553_));
  nand3  g396(.a(x078), .b(x070), .c(x022), .O(new_n554_));
  nand3  g397(.a(new_n554_), .b(new_n553_), .c(new_n535_), .O(new_n555_));
  nand2  g398(.a(new_n555_), .b(new_n528_), .O(new_n556_));
  nand2  g399(.a(new_n539_), .b(x006), .O(new_n557_));
  nand3  g400(.a(new_n329_), .b(x030), .c(new_n335_), .O(new_n558_));
  aoi21  g401(.a(new_n558_), .b(new_n557_), .c(x070), .O(new_n559_));
  nor2   g402(.a(new_n548_), .b(new_n333_), .O(new_n560_));
  nor2   g403(.a(new_n560_), .b(x086), .O(new_n561_));
  oai21  g404(.a(new_n561_), .b(new_n559_), .c(x038), .O(new_n562_));
  nand2  g405(.a(x086), .b(x006), .O(new_n563_));
  aoi21  g406(.a(new_n563_), .b(new_n325_), .c(x014), .O(new_n564_));
  aoi21  g407(.a(new_n528_), .b(x038), .c(new_n326_), .O(new_n565_));
  aoi21  g408(.a(new_n565_), .b(x022), .c(new_n564_), .O(new_n566_));
  nand2  g409(.a(new_n566_), .b(new_n562_), .O(new_n567_));
  aoi21  g410(.a(new_n528_), .b(x038), .c(new_n329_), .O(new_n568_));
  aoi21  g411(.a(new_n568_), .b(x006), .c(x014), .O(new_n569_));
  oai22  g412(.a(new_n569_), .b(new_n323_), .c(new_n528_), .d(new_n341_), .O(new_n570_));
  aoi21  g413(.a(new_n567_), .b(new_n323_), .c(new_n570_), .O(new_n571_));
  aoi21  g414(.a(new_n571_), .b(new_n556_), .c(x046), .O(z14));
  zero   g415(.O(z07));
  zero   g416(.O(z15));
  zero   g417(.O(z16));
  zero   g418(.O(z20));
  ...
  zero   g421(.O(z24));
  zero   g422(.O(z25));
  nor2   g423(.a(x078), .b(new_n157_), .O(z18));
  nor2   g424(.a(x078), .b(new_n157_), .O(z19));
  nor2   g425(.a(x078), .b(new_n157_), .O(z23));
