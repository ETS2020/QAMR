...
module FAU ( 
  ...
  oai21  g225(.a(new_n381_), .b(new_n380_), .c(x027), .O(new_n382_));
  ...
  nand3  g304(.a(new_n460_), .b(new_n179_), .c(new_n448_), .O(new_n461_));
  ...
  oai21  g318(.a(new_n474_), .b(x043), .c(new_n179_), .O(z11));
  ...
  zero   g437(.O(z25));
  zero   g438(.O(z27));
  nor2   g439(.a(x078), .b(x027), .O(z15));
  nor2   g440(.a(x078), .b(x027), .O(z18));
  nor2   g441(.a(x078), .b(x027), .O(z21));
  nor2   g442(.a(x078), .b(x027), .O(z22));
  nor2   g443(.a(x078), .b(x027), .O(z26));
endmodule
