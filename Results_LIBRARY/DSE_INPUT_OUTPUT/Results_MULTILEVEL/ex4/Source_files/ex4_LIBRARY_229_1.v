...
module FAU ( 
  ...
  oai21  g311(.a(new_n467_), .b(x043), .c(new_n180_), .O(z11));
  ...
  oai21  g324(.a(new_n480_), .b(x044), .c(new_n180_), .O(z12));
  ...
  nand2  g375(.a(x070), .b(new_n326_), .O(new_n532_));
  aoi21  g376(.a(new_n532_), .b(new_n371_), .c(new_n325_), .O(new_n533_));
  nand3  g377(.a(new_n340_), .b(new_n331_), .c(x030), .O(new_n534_));
  nor2   g378(.a(x022), .b(x014), .O(new_n535_));
  aoi21  g379(.a(new_n535_), .b(new_n534_), .c(x086), .O(new_n536_));
  oai22  g380(.a(new_n536_), .b(new_n533_), .c(x118), .d(x110), .O(new_n537_));
  oai21  g381(.a(x038), .b(x014), .c(x022), .O(new_n538_));
  oai21  g382(.a(new_n356_), .b(x030), .c(new_n538_), .O(new_n539_));
  inv1   g383(.a(x126), .O(new_n540_));
  nand2  g384(.a(new_n540_), .b(new_n348_), .O(new_n541_));
  oai21  g385(.a(new_n340_), .b(new_n330_), .c(new_n541_), .O(new_n542_));
  aoi21  g386(.a(new_n542_), .b(new_n539_), .c(x070), .O(new_n543_));
  nand3  g387(.a(new_n324_), .b(x126), .c(new_n330_), .O(new_n544_));
  nand3  g388(.a(x102), .b(x070), .c(new_n326_), .O(new_n545_));
  nand3  g389(.a(new_n545_), .b(new_n544_), .c(new_n336_), .O(new_n546_));
  oai21  g390(.a(new_n546_), .b(new_n543_), .c(x006), .O(new_n547_));
  aoi21  g391(.a(x030), .b(new_n330_), .c(new_n356_), .O(new_n548_));
  oai21  g392(.a(x070), .b(x014), .c(x022), .O(new_n549_));
  nand4  g393(.a(new_n549_), .b(new_n541_), .c(new_n340_), .d(x030), .O(new_n550_));
  oai21  g394(.a(new_n548_), .b(new_n331_), .c(new_n550_), .O(new_n551_));
  nand2  g395(.a(new_n551_), .b(new_n336_), .O(new_n552_));
  nand3  g396(.a(new_n552_), .b(new_n547_), .c(new_n537_), .O(new_n553_));
  nand2  g397(.a(new_n553_), .b(new_n531_), .O(new_n554_));
  nand2  g398(.a(new_n541_), .b(x006), .O(new_n555_));
  nand3  g399(.a(new_n336_), .b(x030), .c(new_n358_), .O(new_n556_));
  nand2  g400(.a(new_n556_), .b(new_n555_), .O(new_n557_));
  nand2  g401(.a(new_n557_), .b(new_n331_), .O(new_n558_));
  inv1   g402(.a(new_n548_), .O(new_n559_));
  nand2  g403(.a(new_n559_), .b(new_n336_), .O(new_n560_));
  nand3  g404(.a(new_n560_), .b(new_n558_), .c(new_n531_), .O(new_n561_));
  oai21  g405(.a(new_n336_), .b(new_n325_), .c(new_n327_), .O(new_n562_));
  nand2  g406(.a(new_n562_), .b(new_n358_), .O(new_n563_));
  nand2  g407(.a(new_n531_), .b(x038), .O(new_n564_));
  nand3  g408(.a(new_n564_), .b(x070), .c(x022), .O(new_n565_));
  nand3  g409(.a(new_n565_), .b(new_n563_), .c(new_n178_), .O(new_n566_));
  aoi21  g410(.a(new_n561_), .b(x038), .c(new_n566_), .O(new_n567_));
  aoi21  g411(.a(new_n567_), .b(new_n554_), .c(x046), .O(z14));
  zero   g412(.O(z15));
  zero   g413(.O(z16));
  zero   g414(.O(z19));
  zero   g415(.O(z22));
