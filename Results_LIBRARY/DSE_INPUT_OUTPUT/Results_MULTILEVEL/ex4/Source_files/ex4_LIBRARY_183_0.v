...
module FAU ( 
  ...
  oai21  g238(.a(new_n382_), .b(new_n157_), .c(new_n395_), .O(new_n396_));
  ...
  oai21  g252(.a(new_n409_), .b(new_n404_), .c(new_n174_), .O(new_n410_));
  ...
  nand2  g259(.a(new_n405_), .b(new_n160_), .O(new_n417_));
  ...
  aoi21  g269(.a(new_n412_), .b(new_n168_), .c(new_n426_), .O(new_n427_));
  oai21  g270(.a(new_n427_), .b(x040), .c(new_n179_), .O(z08));
