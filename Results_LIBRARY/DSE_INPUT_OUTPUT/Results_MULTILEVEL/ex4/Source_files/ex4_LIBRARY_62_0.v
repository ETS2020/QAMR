...
module FAU ( 
  ...
  nand2  g378(.a(new_n359_), .b(x038), .O(new_n536_));
  nand3  g379(.a(new_n536_), .b(x086), .c(x006), .O(new_n537_));
  aoi21  g380(.a(x054), .b(x038), .c(x014), .O(new_n538_));
  nand3  g381(.a(x070), .b(new_n359_), .c(x022), .O(new_n539_));
  nand3  g382(.a(new_n539_), .b(new_n538_), .c(x078), .O(new_n540_));
  inv1   g383(.a(new_n540_), .O(new_n541_));
  aoi21  g384(.a(new_n541_), .b(new_n537_), .c(x046), .O(z14));
  zero   g385(.O(z07));
  zero   g386(.O(z19));
  zero   g387(.O(z20));
  zero   g388(.O(z21));
