...
module FAU ( 
  ...
  nand2  g021(.a(x113), .b(x090), .O(new_n178_));
  ...
  nand3  g292(.a(x082), .b(new_n206_), .c(x002), .O(new_n450_));
  oai21  g293(.a(new_n449_), .b(new_n206_), .c(new_n450_), .O(new_n451_));
  ...
  oai22  g300(.a(new_n213_), .b(new_n206_), .c(new_n212_), .d(new_n205_), .O(new_n458_));
  aoi21  g301(.a(new_n457_), .b(new_n206_), .c(new_n458_), .O(new_n459_));
  nand3  g302(.a(new_n459_), .b(new_n455_), .c(new_n452_), .O(new_n460_));
  nand3  g303(.a(new_n460_), .b(new_n178_), .c(new_n448_), .O(new_n461_));
  inv1   g304(.a(new_n461_), .O(z10));
  nand2  g305(.a(x067), .b(x019), .O(new_n463_));
  nand3  g306(.a(x083), .b(new_n225_), .c(x003), .O(new_n464_));
  oai21  g307(.a(new_n463_), .b(new_n225_), .c(new_n464_), .O(new_n465_));
  ...
  aoi21  g316(.a(new_n465_), .b(new_n224_), .c(new_n473_), .O(new_n474_));
  oai21  g317(.a(new_n474_), .b(x043), .c(new_n178_), .O(z11));
  ...
  zero   g430(.O(z21));
  zero   g431(.O(z24));
  inv1   g432(.a(new_n178_), .O(z18));
  inv1   g433(.a(new_n178_), .O(z19));
  inv1   g434(.a(new_n178_), .O(z20));
  inv1   g435(.a(new_n178_), .O(z22));
  inv1   g436(.a(new_n178_), .O(z23));
  inv1   g437(.a(new_n178_), .O(z25));
  inv1   g438(.a(new_n178_), .O(z26));
