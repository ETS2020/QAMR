...
module FAU ( 
  ...
  nand2  g270(.a(new_n427_), .b(new_n188_), .O(new_n428_));
  nand3  g271(.a(x081), .b(x009), .c(x001), .O(new_n429_));
  oai21  g272(.a(new_n425_), .b(x009), .c(new_n429_), .O(new_n430_));
  oai21  g273(.a(new_n195_), .b(x033), .c(new_n430_), .O(new_n431_));
  nand2  g274(.a(x081), .b(x001), .O(new_n432_));
  aoi21  g275(.a(new_n432_), .b(new_n425_), .c(x073), .O(new_n433_));
  oai22  g276(.a(new_n196_), .b(new_n189_), .c(new_n195_), .d(new_n188_), .O(new_n434_));
  aoi21  g277(.a(new_n433_), .b(new_n189_), .c(new_n434_), .O(new_n435_));
  nand3  g278(.a(new_n435_), .b(new_n431_), .c(new_n428_), .O(new_n436_));
  nand3  g279(.a(new_n436_), .b(new_n180_), .c(new_n424_), .O(new_n437_));
  inv1   g280(.a(new_n437_), .O(z09));
