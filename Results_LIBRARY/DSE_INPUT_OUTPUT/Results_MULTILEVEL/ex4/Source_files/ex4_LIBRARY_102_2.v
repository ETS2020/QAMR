...
module FAU ( 
  ...
  oai21  g366(.a(new_n523_), .b(x045), .c(new_n159_), .O(z13));
  inv1   g367(.a(x054), .O(new_n525_));
  nand2  g368(.a(x070), .b(new_n338_), .O(new_n526_));
  aoi21  g369(.a(new_n526_), .b(new_n363_), .c(new_n337_), .O(new_n527_));
  nand3  g370(.a(new_n340_), .b(new_n325_), .c(x030), .O(new_n528_));
  aoi21  g371(.a(new_n528_), .b(new_n333_), .c(x086), .O(new_n529_));
  oai21  g372(.a(new_n529_), .b(new_n527_), .c(new_n322_), .O(new_n530_));
  oai21  g373(.a(x086), .b(new_n332_), .c(new_n530_), .O(new_n531_));
  nand2  g374(.a(new_n531_), .b(new_n346_), .O(new_n532_));
  ...
  nand3  g381(.a(new_n323_), .b(x126), .c(new_n333_), .O(new_n539_));
  nand3  g382(.a(x102), .b(x070), .c(new_n338_), .O(new_n540_));
  nand3  g383(.a(new_n540_), .b(new_n539_), .c(new_n328_), .O(new_n541_));
  aoi21  g384(.a(new_n538_), .b(new_n325_), .c(new_n541_), .O(new_n542_));
  nor2   g385(.a(new_n542_), .b(new_n337_), .O(new_n543_));
  aoi21  g386(.a(x030), .b(new_n333_), .c(new_n330_), .O(new_n544_));
  or2    g387(.a(new_n544_), .b(new_n325_), .O(new_n545_));
  oai21  g388(.a(x070), .b(x014), .c(x022), .O(new_n546_));
  nand4  g389(.a(new_n546_), .b(new_n536_), .c(new_n340_), .d(x030), .O(new_n547_));
  aoi21  g390(.a(new_n547_), .b(new_n545_), .c(x086), .O(new_n548_));
  oai21  g391(.a(new_n548_), .b(new_n543_), .c(new_n322_), .O(new_n549_));
  nand3  g392(.a(x078), .b(x070), .c(x022), .O(new_n550_));
  nand3  g393(.a(new_n550_), .b(new_n549_), .c(new_n532_), .O(new_n551_));
  nand2  g394(.a(new_n551_), .b(new_n525_), .O(new_n552_));
  nand2  g395(.a(new_n536_), .b(x006), .O(new_n553_));
  nand3  g396(.a(new_n328_), .b(x030), .c(new_n332_), .O(new_n554_));
  ...
  aoi21  g401(.a(new_n558_), .b(new_n324_), .c(x014), .O(new_n559_));
  aoi21  g402(.a(new_n525_), .b(x038), .c(new_n325_), .O(new_n560_));
  aoi21  g403(.a(new_n560_), .b(x022), .c(new_n559_), .O(new_n561_));
  nand2  g404(.a(new_n561_), .b(new_n557_), .O(new_n562_));
  aoi21  g405(.a(new_n525_), .b(x038), .c(new_n328_), .O(new_n563_));
  aoi21  g406(.a(new_n563_), .b(x006), .c(x014), .O(new_n564_));
  oai22  g407(.a(new_n564_), .b(new_n322_), .c(new_n525_), .d(new_n338_), .O(new_n565_));
  aoi21  g408(.a(new_n562_), .b(new_n322_), .c(new_n565_), .O(new_n566_));
  ...
  nor2   g419(.a(x078), .b(new_n157_), .O(z23));
