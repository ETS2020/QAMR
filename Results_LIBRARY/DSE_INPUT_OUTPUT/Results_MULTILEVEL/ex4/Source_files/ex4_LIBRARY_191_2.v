...
module FAU ( 
  ...
  oai21  g227(.a(new_n370_), .b(new_n157_), .c(new_n383_), .O(new_n384_));
  ...
  oai21  g241(.a(new_n397_), .b(new_n392_), .c(new_n174_), .O(new_n398_));
  ...
  nand2  g248(.a(new_n393_), .b(new_n160_), .O(new_n405_));
  ...
  aoi21  g258(.a(new_n400_), .b(new_n168_), .c(new_n414_), .O(new_n415_));
  oai21  g259(.a(new_n415_), .b(x040), .c(new_n180_), .O(z08));
  ...
  nand3  g273(.a(new_n429_), .b(new_n180_), .c(new_n417_), .O(new_n430_));
  ...
  zero   g415(.O(z24));
  zero   g416(.O(z27));
  nor2   g417(.a(x078), .b(new_n178_), .O(z16));
  nor2   g418(.a(x078), .b(new_n178_), .O(z18));
  nor2   g419(.a(x078), .b(new_n178_), .O(z21));
  nor2   g420(.a(x078), .b(new_n178_), .O(z23));
  nor2   g421(.a(x078), .b(new_n178_), .O(z25));
  nor2   g422(.a(x078), .b(new_n178_), .O(z26));
endmodule
