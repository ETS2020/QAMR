...
module FAU ( 
  ...
  oai21  g316(.a(new_n232_), .b(x035), .c(new_n473_), .O(new_n474_));
  nand2  g317(.a(x083), .b(x003), .O(new_n475_));
  aoi21  g318(.a(new_n475_), .b(new_n468_), .c(x075), .O(new_n476_));
  oai22  g319(.a(new_n233_), .b(new_n226_), .c(new_n232_), .d(new_n225_), .O(new_n477_));
  aoi21  g320(.a(new_n476_), .b(new_n226_), .c(new_n477_), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n474_), .c(new_n471_), .O(new_n479_));
  nand3  g322(.a(new_n479_), .b(new_n158_), .c(new_n467_), .O(new_n480_));
  inv1   g323(.a(new_n480_), .O(z11));
  nand2  g324(.a(x068), .b(x020), .O(new_n482_));
  nand4  g325(.a(x084), .b(x078), .c(new_n245_), .d(x004), .O(new_n483_));
  oai21  g326(.a(new_n482_), .b(new_n245_), .c(new_n483_), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(new_n244_), .O(new_n485_));
  oai21  g328(.a(new_n240_), .b(new_n239_), .c(new_n251_), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(x012), .O(new_n487_));
  oai21  g330(.a(new_n482_), .b(x012), .c(new_n251_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(x078), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n487_), .c(new_n244_), .O(new_n490_));
  nand3  g333(.a(x078), .b(new_n252_), .c(new_n245_), .O(new_n491_));
  oai21  g334(.a(x052), .b(new_n245_), .c(new_n491_), .O(new_n492_));
  nand3  g335(.a(new_n492_), .b(x084), .c(x004), .O(new_n493_));
  aoi21  g336(.a(x076), .b(x052), .c(new_n324_), .O(new_n494_));
  nand4  g337(.a(new_n494_), .b(x068), .c(x020), .d(new_n245_), .O(new_n495_));
  ...
  oai21  g390(.a(new_n547_), .b(x045), .c(new_n158_), .O(z13));
  ...
  oai21  g439(.a(new_n596_), .b(x046), .c(new_n158_), .O(z14));
  zero   g440(.O(z07));
  zero   g441(.O(z15));
  zero   g442(.O(z19));
  zero   g443(.O(z20));
  ...
  zero   g445(.O(z25));
  zero   g446(.O(z27));
  nor2   g447(.a(x078), .b(x012), .O(z17));
  nor2   g448(.a(x078), .b(x012), .O(z18));
  nor2   g449(.a(x078), .b(x012), .O(z21));
  nor2   g450(.a(x078), .b(x012), .O(z23));
  nor2   g451(.a(x078), .b(x012), .O(z24));
  nor2   g452(.a(x078), .b(x012), .O(z26));
endmodule
