...
module FAU ( 
  ...
  oai21  g231(.a(new_n374_), .b(new_n160_), .c(new_n387_), .O(new_n388_));
  ...
  nand3  g235(.a(new_n391_), .b(x120), .c(new_n160_), .O(new_n392_));
  nand3  g236(.a(x096), .b(x064), .c(new_n176_), .O(new_n393_));
  nand3  g237(.a(new_n393_), .b(new_n392_), .c(new_n163_), .O(new_n394_));
  inv1   g238(.a(new_n394_), .O(new_n395_));
  aoi21  g239(.a(new_n395_), .b(new_n390_), .c(new_n168_), .O(new_n396_));
  oai21  g240(.a(new_n381_), .b(x016), .c(new_n382_), .O(new_n397_));
  nand2  g241(.a(new_n397_), .b(x064), .O(new_n398_));
  oai21  g242(.a(x064), .b(x008), .c(x016), .O(new_n399_));
  nand4  g243(.a(new_n399_), .b(new_n387_), .c(new_n374_), .d(x024), .O(new_n400_));
  aoi21  g244(.a(new_n400_), .b(new_n398_), .c(x080), .O(new_n401_));
  oai21  g245(.a(new_n401_), .b(new_n396_), .c(new_n177_), .O(new_n402_));
  nand3  g246(.a(x072), .b(x064), .c(x016), .O(new_n403_));
  nand3  g247(.a(new_n403_), .b(new_n402_), .c(new_n379_), .O(new_n404_));
  ...
  nand2  g252(.a(new_n397_), .b(new_n163_), .O(new_n409_));
  ...
  aoi21  g262(.a(new_n404_), .b(new_n171_), .c(new_n418_), .O(new_n419_));
  ...
  nor3   g368(.a(new_n524_), .b(z07), .c(x045), .O(z13));
  ...
  nor2   g419(.a(x078), .b(new_n157_), .O(z20));
  nor2   g420(.a(x078), .b(new_n157_), .O(z21));
  nor2   g421(.a(x078), .b(new_n157_), .O(z22));
  nor2   g422(.a(x078), .b(new_n157_), .O(z24));
endmodule
