...
module FAU ( 
  ...
  oai21  g370(.a(new_n526_), .b(x045), .c(new_n158_), .O(z13));
  inv1   g371(.a(x046), .O(new_n528_));
  nand2  g372(.a(new_n360_), .b(x038), .O(new_n529_));
  nand3  g373(.a(new_n529_), .b(x086), .c(x006), .O(new_n530_));
  nand2  g374(.a(x054), .b(x038), .O(new_n531_));
  nand3  g375(.a(x070), .b(new_n360_), .c(x022), .O(new_n532_));
  nand4  g376(.a(new_n532_), .b(new_n531_), .c(new_n530_), .d(new_n332_), .O(new_n533_));
  nand3  g377(.a(new_n533_), .b(x078), .c(new_n528_), .O(new_n534_));
  ...
  nor2   g388(.a(x078), .b(x046), .O(z22));
  nor2   g389(.a(x078), .b(x046), .O(z24));
  nor2   g390(.a(x078), .b(x046), .O(z25));
