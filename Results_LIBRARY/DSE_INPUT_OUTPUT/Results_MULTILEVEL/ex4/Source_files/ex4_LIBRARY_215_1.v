...
module FAU ( 
  ...
  nand2  g001(.a(x089), .b(new_n157_), .O(new_n158_));
  ...
  oai21  g224(.a(new_n380_), .b(new_n320_), .c(new_n158_), .O(z06));
  inv1   g225(.a(new_n158_), .O(z07));
  ...
  zero   g425(.O(z22));
  zero   g426(.O(z25));
  inv1   g427(.a(new_n158_), .O(z16));
  inv1   g428(.a(new_n158_), .O(z18));
  inv1   g429(.a(new_n158_), .O(z20));
  inv1   g430(.a(new_n158_), .O(z23));
  inv1   g431(.a(new_n158_), .O(z24));
  inv1   g432(.a(new_n158_), .O(z26));
  inv1   g433(.a(new_n158_), .O(z27));
endmodule
