...
module FAU ( 
  ...
  oai22  g303(.a(new_n216_), .b(new_n209_), .c(new_n215_), .d(new_n208_), .O(new_n460_));
  aoi21  g304(.a(new_n459_), .b(new_n209_), .c(new_n460_), .O(new_n461_));
  ...
  aoi21  g334(.a(new_n482_), .b(new_n246_), .c(new_n490_), .O(new_n491_));
  ...
  oai21  g382(.a(new_n538_), .b(x045), .c(new_n160_), .O(z13));
  ...
  nand2  g419(.a(new_n575_), .b(new_n157_), .O(new_n576_));
  ...
  nand2  g425(.a(new_n581_), .b(new_n158_), .O(new_n582_));
  ...
  zero   g430(.O(z20));
  zero   g431(.O(z21));
  nor2   g432(.a(new_n158_), .b(new_n157_), .O(z16));
  nor2   g433(.a(new_n158_), .b(new_n157_), .O(z19));
  nor2   g434(.a(new_n158_), .b(new_n157_), .O(z22));
  nor2   g435(.a(new_n158_), .b(new_n157_), .O(z23));
  nor2   g436(.a(new_n158_), .b(new_n157_), .O(z24));
  nor2   g437(.a(new_n158_), .b(new_n157_), .O(z25));
  nor2   g438(.a(new_n158_), .b(new_n157_), .O(z26));
  nor2   g439(.a(new_n158_), .b(new_n157_), .O(z27));
endmodule
