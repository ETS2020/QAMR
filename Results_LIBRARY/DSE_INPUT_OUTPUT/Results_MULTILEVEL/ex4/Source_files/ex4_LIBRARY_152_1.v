// Benchmark "FAU" written by ABC on Tue Aug 18 02:19:03 2020
...
module FAU ( 
  ...
  nor2   g022(.a(new_n178_), .b(x046), .O(z16));
  ...
  aoi21  g177(.a(new_n333_), .b(new_n328_), .c(new_n178_), .O(new_n334_));
  ...
  aoi22  g185(.a(new_n331_), .b(new_n329_), .c(x126), .d(x102), .O(new_n342_));
  oai21  g186(.a(new_n342_), .b(new_n341_), .c(x070), .O(new_n343_));
  inv1   g187(.a(x110), .O(new_n344_));
  inv1   g188(.a(x118), .O(new_n345_));
  aoi21  g189(.a(new_n345_), .b(new_n344_), .c(x126), .O(new_n346_));
  inv1   g190(.a(x102), .O(new_n347_));
  nand3  g191(.a(new_n347_), .b(new_n330_), .c(x038), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(x086), .O(new_n349_));
  aoi21  g193(.a(new_n346_), .b(x022), .c(new_n349_), .O(new_n350_));
  aoi21  g194(.a(new_n350_), .b(new_n343_), .c(x006), .O(new_n351_));
  inv1   g195(.a(x030), .O(new_n352_));
  aoi21  g196(.a(new_n352_), .b(x022), .c(new_n339_), .O(new_n353_));
  or2    g197(.a(new_n353_), .b(x070), .O(new_n354_));
  inv1   g198(.a(new_n331_), .O(new_n355_));
  nand2  g199(.a(x126), .b(x102), .O(new_n356_));
  inv1   g200(.a(x014), .O(new_n357_));
  oai21  g201(.a(new_n330_), .b(new_n357_), .c(new_n329_), .O(new_n358_));
  nand4  g202(.a(new_n358_), .b(new_n356_), .c(new_n355_), .d(new_n352_), .O(new_n359_));
  aoi21  g203(.a(new_n359_), .b(new_n354_), .c(new_n335_), .O(new_n360_));
  oai21  g204(.a(new_n360_), .b(new_n351_), .c(x078), .O(new_n361_));
  nand3  g205(.a(new_n178_), .b(new_n330_), .c(new_n329_), .O(new_n362_));
  nand3  g206(.a(new_n362_), .b(new_n361_), .c(new_n337_), .O(new_n363_));
  nand2  g207(.a(new_n363_), .b(x054), .O(new_n364_));
  nand2  g208(.a(new_n356_), .b(new_n324_), .O(new_n365_));
  nand3  g209(.a(x086), .b(new_n352_), .c(x014), .O(new_n366_));
  aoi21  g210(.a(new_n366_), .b(new_n365_), .c(new_n330_), .O(new_n367_));
  nor2   g211(.a(new_n353_), .b(new_n335_), .O(new_n368_));
  oai21  g212(.a(new_n368_), .b(new_n367_), .c(new_n325_), .O(new_n369_));
  nand2  g213(.a(new_n330_), .b(new_n329_), .O(new_n370_));
  oai21  g214(.a(x086), .b(x006), .c(new_n370_), .O(new_n371_));
  aoi21  g215(.a(x054), .b(new_n325_), .c(x070), .O(new_n372_));
  aoi22  g216(.a(new_n372_), .b(new_n329_), .c(new_n371_), .d(x014), .O(new_n373_));
  nand2  g217(.a(new_n373_), .b(new_n369_), .O(new_n374_));
  aoi21  g218(.a(x054), .b(new_n325_), .c(x086), .O(new_n375_));
  aoi21  g219(.a(new_n375_), .b(new_n324_), .c(new_n357_), .O(new_n376_));
  oai22  g220(.a(new_n376_), .b(x078), .c(x054), .d(x038), .O(new_n377_));
  aoi21  g221(.a(new_n374_), .b(x078), .c(new_n377_), .O(new_n378_));
  aoi21  g222(.a(new_n378_), .b(new_n364_), .c(new_n322_), .O(z06));
  nand2  g223(.a(x064), .b(new_n173_), .O(new_n381_));
  aoi21  g224(.a(new_n381_), .b(new_n159_), .c(new_n165_), .O(new_n382_));
  nand2  g225(.a(x088), .b(x056), .O(new_n383_));
  nand3  g226(.a(new_n383_), .b(new_n158_), .c(x024), .O(new_n384_));
  aoi21  g227(.a(new_n384_), .b(new_n157_), .c(x080), .O(new_n385_));
  oai21  g228(.a(new_n385_), .b(new_n382_), .c(new_n174_), .O(new_n386_));
  nand2  g229(.a(new_n386_), .b(new_n161_), .O(new_n387_));
  oai21  g230(.a(x112), .b(x104), .c(new_n387_), .O(new_n388_));
  ...
  nand3  g235(.a(new_n392_), .b(new_n391_), .c(new_n390_), .O(new_n393_));
  nand2  g236(.a(new_n393_), .b(new_n389_), .O(new_n394_));
  oai22  g237(.a(new_n383_), .b(new_n157_), .c(x120), .d(x096), .O(new_n395_));
  ...
  nor2   g246(.a(x088), .b(x056), .O(new_n404_));
  oai21  g247(.a(new_n390_), .b(x016), .c(new_n404_), .O(new_n405_));
  ...
  nand4  g252(.a(new_n409_), .b(new_n408_), .c(new_n383_), .d(x024), .O(new_n410_));
  aoi21  g253(.a(new_n410_), .b(new_n406_), .c(x080), .O(new_n411_));
  oai21  g254(.a(new_n411_), .b(new_n403_), .c(new_n174_), .O(new_n412_));
  nand3  g255(.a(x072), .b(x064), .c(x016), .O(new_n413_));
  nand3  g256(.a(new_n413_), .b(new_n412_), .c(new_n388_), .O(new_n414_));
  nand3  g257(.a(new_n160_), .b(x024), .c(new_n164_), .O(new_n415_));
  oai21  g258(.a(new_n407_), .b(new_n165_), .c(new_n415_), .O(new_n416_));
  nand2  g259(.a(new_n416_), .b(new_n158_), .O(new_n417_));
  nand2  g260(.a(new_n405_), .b(new_n160_), .O(new_n418_));
  aoi21  g261(.a(new_n418_), .b(new_n417_), .c(new_n173_), .O(new_n419_));
  aoi22  g262(.a(x080), .b(x000), .c(x064), .d(x016), .O(new_n420_));
  nand3  g263(.a(new_n169_), .b(x064), .c(x016), .O(new_n421_));
  oai21  g264(.a(new_n420_), .b(x008), .c(new_n421_), .O(new_n422_));
  oai21  g265(.a(new_n422_), .b(new_n419_), .c(new_n174_), .O(new_n423_));
  nand3  g266(.a(new_n169_), .b(x080), .c(x000), .O(new_n424_));
  nand2  g267(.a(new_n424_), .b(new_n164_), .O(new_n425_));
  aoi22  g268(.a(new_n425_), .b(x072), .c(x048), .d(x032), .O(new_n426_));
  nand2  g269(.a(new_n426_), .b(new_n423_), .O(new_n427_));
  aoi21  g270(.a(new_n414_), .b(new_n168_), .c(new_n427_), .O(new_n428_));
  nor3   g271(.a(new_n428_), .b(z16), .c(x040), .O(z08));
  ...
  oai21  g277(.a(new_n195_), .b(x033), .c(new_n434_), .O(new_n435_));
  nand2  g278(.a(x081), .b(x001), .O(new_n436_));
  aoi21  g279(.a(new_n436_), .b(new_n430_), .c(x073), .O(new_n437_));
  nand2  g280(.a(new_n437_), .b(new_n189_), .O(new_n438_));
  aoi22  g281(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n439_));
  nand3  g282(.a(new_n439_), .b(new_n438_), .c(new_n435_), .O(new_n440_));
  aoi21  g283(.a(new_n432_), .b(new_n188_), .c(new_n440_), .O(new_n441_));
  oai21  g284(.a(new_n441_), .b(x041), .c(new_n180_), .O(z09));
  inv1   g285(.a(x042), .O(new_n443_));
  ...
  nand2  g289(.a(new_n446_), .b(new_n207_), .O(new_n447_));
  nand3  g290(.a(x082), .b(x010), .c(x002), .O(new_n448_));
  oai21  g291(.a(new_n444_), .b(x010), .c(new_n448_), .O(new_n449_));
  oai21  g292(.a(new_n214_), .b(x034), .c(new_n449_), .O(new_n450_));
  nand2  g293(.a(x082), .b(x002), .O(new_n451_));
  aoi21  g294(.a(new_n451_), .b(new_n444_), .c(x074), .O(new_n452_));
  oai22  g295(.a(new_n215_), .b(new_n208_), .c(new_n214_), .d(new_n207_), .O(new_n453_));
  aoi21  g296(.a(new_n452_), .b(new_n208_), .c(new_n453_), .O(new_n454_));
  nand3  g297(.a(new_n454_), .b(new_n450_), .c(new_n447_), .O(new_n455_));
  nand3  g298(.a(new_n455_), .b(new_n180_), .c(new_n443_), .O(new_n456_));
  inv1   g299(.a(new_n456_), .O(z10));
  ...
  nand3  g313(.a(new_n470_), .b(new_n180_), .c(new_n458_), .O(new_n471_));
  ...
  oai21  g327(.a(new_n484_), .b(x044), .c(new_n180_), .O(z12));
  nand2  g328(.a(new_n287_), .b(new_n281_), .O(new_n486_));
  ...
  nand3  g332(.a(new_n489_), .b(new_n287_), .c(x029), .O(new_n490_));
  aoi21  g333(.a(new_n490_), .b(new_n281_), .c(x085), .O(new_n491_));
  oai21  g334(.a(new_n491_), .b(new_n488_), .c(new_n260_), .O(new_n492_));
  oai21  g335(.a(x085), .b(new_n297_), .c(new_n492_), .O(new_n493_));
  oai21  g336(.a(x117), .b(x109), .c(new_n493_), .O(new_n494_));
  oai21  g337(.a(x037), .b(x013), .c(x021), .O(new_n495_));
  oai21  g338(.a(new_n269_), .b(x029), .c(new_n495_), .O(new_n496_));
  inv1   g339(.a(x125), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(new_n288_), .O(new_n498_));
  oai21  g341(.a(new_n489_), .b(new_n281_), .c(new_n498_), .O(new_n499_));
  nand2  g342(.a(new_n499_), .b(new_n496_), .O(new_n500_));
  nand2  g343(.a(new_n500_), .b(new_n287_), .O(new_n501_));
  nand3  g344(.a(new_n259_), .b(x125), .c(new_n281_), .O(new_n502_));
  nand3  g345(.a(x101), .b(x069), .c(new_n262_), .O(new_n503_));
  nand3  g346(.a(new_n503_), .b(new_n502_), .c(new_n274_), .O(new_n504_));
  inv1   g347(.a(new_n504_), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n501_), .c(new_n261_), .O(new_n506_));
  oai21  g349(.a(new_n266_), .b(x021), .c(new_n282_), .O(new_n507_));
  nand2  g350(.a(new_n507_), .b(x069), .O(new_n508_));
  oai21  g351(.a(x069), .b(x013), .c(x021), .O(new_n509_));
  nand4  g352(.a(new_n509_), .b(new_n498_), .c(new_n489_), .d(x029), .O(new_n510_));
  ...
  nand3  g356(.a(new_n513_), .b(new_n512_), .c(new_n494_), .O(new_n514_));
  nand2  g357(.a(new_n498_), .b(x005), .O(new_n515_));
  nand3  g358(.a(new_n274_), .b(x029), .c(new_n297_), .O(new_n516_));
  nand2  g359(.a(new_n516_), .b(new_n515_), .O(new_n517_));
  nand2  g360(.a(new_n517_), .b(new_n287_), .O(new_n518_));
  nand2  g361(.a(new_n507_), .b(new_n274_), .O(new_n519_));
  aoi21  g362(.a(new_n519_), .b(new_n518_), .c(new_n262_), .O(new_n520_));
  oai21  g363(.a(new_n274_), .b(new_n261_), .c(new_n263_), .O(new_n521_));
  nand2  g364(.a(new_n521_), .b(new_n297_), .O(new_n522_));
  nand2  g365(.a(new_n315_), .b(x037), .O(new_n523_));
  ...
  nand2  g370(.a(new_n527_), .b(new_n297_), .O(new_n528_));
  aoi22  g371(.a(new_n528_), .b(x077), .c(x053), .d(x037), .O(new_n529_));
  nand2  g372(.a(new_n529_), .b(new_n526_), .O(new_n530_));
  aoi21  g373(.a(new_n514_), .b(new_n315_), .c(new_n530_), .O(new_n531_));
  oai21  g374(.a(new_n531_), .b(x045), .c(new_n180_), .O(z13));
  inv1   g375(.a(x054), .O(new_n533_));
  nand2  g376(.a(x070), .b(new_n325_), .O(new_n534_));
  aoi21  g377(.a(new_n534_), .b(new_n370_), .c(new_n324_), .O(new_n535_));
  nand3  g378(.a(new_n339_), .b(new_n330_), .c(x030), .O(new_n536_));
  nor2   g379(.a(x022), .b(x014), .O(new_n537_));
  aoi21  g380(.a(new_n537_), .b(new_n536_), .c(x086), .O(new_n538_));
  oai22  g381(.a(new_n538_), .b(new_n535_), .c(x118), .d(x110), .O(new_n539_));
  oai21  g382(.a(x038), .b(x014), .c(x022), .O(new_n540_));
  oai21  g383(.a(new_n355_), .b(x030), .c(new_n540_), .O(new_n541_));
  inv1   g384(.a(x126), .O(new_n542_));
  nand2  g385(.a(new_n542_), .b(new_n347_), .O(new_n543_));
  oai21  g386(.a(new_n339_), .b(new_n329_), .c(new_n543_), .O(new_n544_));
  aoi21  g387(.a(new_n544_), .b(new_n541_), .c(x070), .O(new_n545_));
  nand3  g388(.a(new_n323_), .b(x126), .c(new_n329_), .O(new_n546_));
  nand3  g389(.a(x102), .b(x070), .c(new_n325_), .O(new_n547_));
  nand3  g390(.a(new_n547_), .b(new_n546_), .c(new_n335_), .O(new_n548_));
  oai21  g391(.a(new_n548_), .b(new_n545_), .c(x006), .O(new_n549_));
  aoi21  g392(.a(x030), .b(new_n329_), .c(new_n355_), .O(new_n550_));
  oai21  g393(.a(x070), .b(x014), .c(x022), .O(new_n551_));
  nand4  g394(.a(new_n551_), .b(new_n543_), .c(new_n339_), .d(x030), .O(new_n552_));
  oai21  g395(.a(new_n550_), .b(new_n330_), .c(new_n552_), .O(new_n553_));
  nand2  g396(.a(new_n553_), .b(new_n335_), .O(new_n554_));
  nand3  g397(.a(new_n554_), .b(new_n549_), .c(new_n539_), .O(new_n555_));
  nand2  g398(.a(new_n555_), .b(new_n533_), .O(new_n556_));
  nand2  g399(.a(new_n543_), .b(x006), .O(new_n557_));
  nand3  g400(.a(new_n335_), .b(x030), .c(new_n357_), .O(new_n558_));
  nand2  g401(.a(new_n558_), .b(new_n557_), .O(new_n559_));
  nand2  g402(.a(new_n559_), .b(new_n330_), .O(new_n560_));
  inv1   g403(.a(new_n550_), .O(new_n561_));
  nand2  g404(.a(new_n561_), .b(new_n335_), .O(new_n562_));
  nand3  g405(.a(new_n562_), .b(new_n560_), .c(new_n533_), .O(new_n563_));
  oai21  g406(.a(new_n335_), .b(new_n324_), .c(new_n326_), .O(new_n564_));
  nand2  g407(.a(new_n564_), .b(new_n357_), .O(new_n565_));
  nand2  g408(.a(new_n533_), .b(x038), .O(new_n566_));
  nand3  g409(.a(new_n566_), .b(x070), .c(x022), .O(new_n567_));
  nand3  g410(.a(new_n567_), .b(new_n565_), .c(new_n178_), .O(new_n568_));
  aoi21  g411(.a(new_n563_), .b(x038), .c(new_n568_), .O(new_n569_));
  aoi21  g412(.a(new_n569_), .b(new_n556_), .c(x046), .O(z14));
  zero   g413(.O(z07));
  zero   g414(.O(z15));
  zero   g415(.O(z17));
  zero   g416(.O(z18));
  ...
  zero   g418(.O(z26));
  zero   g419(.O(z27));
  nor2   g420(.a(new_n178_), .b(x046), .O(z19));
  nor2   g421(.a(new_n178_), .b(x046), .O(z20));
  nor2   g422(.a(new_n178_), .b(x046), .O(z22));
  nor2   g423(.a(new_n178_), .b(x046), .O(z23));
  nor2   g424(.a(new_n178_), .b(x046), .O(z24));
  nor2   g425(.a(new_n178_), .b(x046), .O(z25));
endmodule
