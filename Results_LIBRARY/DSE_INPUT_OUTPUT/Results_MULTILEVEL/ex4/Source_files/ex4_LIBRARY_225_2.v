...
module FAU ( 
  ...
  nand2  g374(.a(x070), .b(new_n336_), .O(new_n531_));
  aoi21  g375(.a(new_n531_), .b(new_n364_), .c(new_n335_), .O(new_n532_));
  nand3  g376(.a(new_n338_), .b(new_n322_), .c(x030), .O(new_n533_));
  nor2   g377(.a(x022), .b(x014), .O(new_n534_));
  aoi21  g378(.a(new_n534_), .b(new_n533_), .c(x086), .O(new_n535_));
  oai21  g379(.a(new_n535_), .b(new_n532_), .c(new_n344_), .O(new_n536_));
  oai21  g380(.a(x038), .b(x014), .c(x022), .O(new_n537_));
  oai21  g381(.a(new_n328_), .b(x030), .c(new_n537_), .O(new_n538_));
  inv1   g382(.a(x102), .O(new_n539_));
  nand2  g383(.a(new_n343_), .b(new_n539_), .O(new_n540_));
  oai21  g384(.a(new_n338_), .b(new_n331_), .c(new_n540_), .O(new_n541_));
  aoi21  g385(.a(new_n541_), .b(new_n538_), .c(x070), .O(new_n542_));
  nand3  g386(.a(new_n320_), .b(x126), .c(new_n331_), .O(new_n543_));
  nand3  g387(.a(x102), .b(x070), .c(new_n336_), .O(new_n544_));
  nand3  g388(.a(new_n544_), .b(new_n543_), .c(new_n325_), .O(new_n545_));
  oai21  g389(.a(new_n545_), .b(new_n542_), .c(x006), .O(new_n546_));
  oai21  g390(.a(new_n326_), .b(x022), .c(new_n327_), .O(new_n547_));
  and2   g391(.a(new_n547_), .b(x070), .O(new_n548_));
  oai21  g392(.a(x070), .b(x014), .c(x022), .O(new_n549_));
  nand4  g393(.a(new_n549_), .b(new_n540_), .c(new_n338_), .d(x030), .O(new_n550_));
  inv1   g394(.a(new_n550_), .O(new_n551_));
  oai21  g395(.a(new_n551_), .b(new_n548_), .c(new_n325_), .O(new_n552_));
  nand3  g396(.a(new_n552_), .b(new_n546_), .c(new_n536_), .O(new_n553_));
  nand2  g397(.a(new_n540_), .b(x006), .O(new_n554_));
  nand3  g398(.a(new_n325_), .b(x030), .c(new_n330_), .O(new_n555_));
  aoi21  g399(.a(new_n555_), .b(new_n554_), .c(x070), .O(new_n556_));
  nand2  g400(.a(new_n547_), .b(new_n325_), .O(new_n557_));
  nand2  g401(.a(new_n557_), .b(new_n530_), .O(new_n558_));
  oai21  g402(.a(new_n558_), .b(new_n556_), .c(x038), .O(new_n559_));
  oai21  g403(.a(new_n325_), .b(new_n335_), .c(new_n321_), .O(new_n560_));
  nand2  g404(.a(new_n560_), .b(new_n330_), .O(new_n561_));
  nand2  g405(.a(new_n530_), .b(x038), .O(new_n562_));
  nand3  g406(.a(new_n562_), .b(x070), .c(x022), .O(new_n563_));
  nand4  g407(.a(new_n563_), .b(new_n561_), .c(new_n559_), .d(new_n157_), .O(new_n564_));
  aoi21  g408(.a(new_n553_), .b(new_n530_), .c(new_n564_), .O(new_n565_));
  nand3  g409(.a(new_n562_), .b(x086), .c(x006), .O(new_n566_));
  nand3  g410(.a(x070), .b(new_n530_), .c(x022), .O(new_n567_));
  nand3  g411(.a(new_n567_), .b(new_n566_), .c(new_n330_), .O(new_n568_));
  aoi22  g412(.a(new_n568_), .b(x078), .c(x054), .d(x038), .O(new_n569_));
  oai22  g413(.a(new_n569_), .b(x046), .c(new_n565_), .d(x078), .O(z14));
  zero   g414(.O(z16));
  zero   g415(.O(z17));
  zero   g416(.O(z18));
  zero   g417(.O(z19));
  ...
  zero   g420(.O(z23));
  zero   g421(.O(z27));
  nor2   g422(.a(x078), .b(new_n157_), .O(z15));
  nor2   g423(.a(x078), .b(new_n157_), .O(z22));
  nor2   g424(.a(x078), .b(new_n157_), .O(z24));
