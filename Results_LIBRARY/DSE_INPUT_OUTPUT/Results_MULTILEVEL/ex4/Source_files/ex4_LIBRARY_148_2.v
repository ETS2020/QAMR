...
module FAU ( 
  ...
  nand2  g022(.a(new_n178_), .b(x025), .O(new_n179_));
  ...
  zero   g429(.O(z23));
  zero   g430(.O(z26));
  inv1   g431(.a(new_n179_), .O(z15));
  inv1   g432(.a(new_n179_), .O(z16));
  inv1   g433(.a(new_n179_), .O(z20));
  inv1   g434(.a(new_n179_), .O(z22));
  inv1   g435(.a(new_n179_), .O(z24));
  inv1   g436(.a(new_n179_), .O(z25));
  inv1   g437(.a(new_n179_), .O(z27));
endmodule
