...
module FAU ( 
  ...
  nand2  g221(.a(x064), .b(new_n175_), .O(new_n379_));
  aoi21  g222(.a(new_n379_), .b(new_n161_), .c(new_n167_), .O(new_n380_));
  nand2  g223(.a(x088), .b(x056), .O(new_n381_));
  nand3  g224(.a(new_n381_), .b(new_n160_), .c(x024), .O(new_n382_));
  aoi21  g225(.a(new_n382_), .b(new_n159_), .c(x080), .O(new_n383_));
  oai21  g226(.a(new_n383_), .b(new_n380_), .c(new_n176_), .O(new_n384_));
  nand2  g227(.a(new_n384_), .b(new_n163_), .O(new_n385_));
  ...
  oai22  g235(.a(new_n381_), .b(new_n159_), .c(x120), .d(x096), .O(new_n393_));
  ...
  oai21  g252(.a(new_n409_), .b(new_n401_), .c(new_n176_), .O(new_n410_));
  ...
  oai21  g256(.a(new_n405_), .b(new_n167_), .c(new_n413_), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(new_n160_), .O(new_n415_));
  nand2  g258(.a(new_n403_), .b(new_n162_), .O(new_n416_));
  ...
  aoi21  g268(.a(new_n412_), .b(new_n170_), .c(new_n425_), .O(new_n426_));
  ...
  nand3  g324(.a(new_n481_), .b(new_n158_), .c(new_n469_), .O(new_n482_));
  ...
  oai21  g372(.a(new_n529_), .b(x045), .c(new_n158_), .O(z13));
