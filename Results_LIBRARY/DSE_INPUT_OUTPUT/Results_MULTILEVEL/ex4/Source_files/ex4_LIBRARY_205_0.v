...
module FAU ( 
  ...
  oai22  g233(.a(new_n378_), .b(new_n157_), .c(x120), .d(x096), .O(new_n390_));
  ...
  oai21  g250(.a(new_n406_), .b(new_n398_), .c(new_n174_), .O(new_n407_));
  ...
  oai21  g254(.a(new_n402_), .b(new_n165_), .c(new_n410_), .O(new_n411_));
  nand2  g255(.a(new_n411_), .b(new_n158_), .O(new_n412_));
  nand2  g256(.a(new_n400_), .b(new_n160_), .O(new_n413_));
  ...
  oai21  g310(.a(new_n466_), .b(x043), .c(new_n179_), .O(z11));
  ...
  zero   g387(.O(z26));
  zero   g388(.O(z27));
  nor2   g389(.a(x078), .b(x046), .O(z15));
  nor2   g390(.a(x078), .b(x046), .O(z16));
  nor2   g391(.a(x078), .b(x046), .O(z17));
  nor2   g392(.a(x078), .b(x046), .O(z19));
