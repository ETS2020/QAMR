...
module FAU ( 
  ...
  nand2  g380(.a(new_n537_), .b(x038), .O(new_n538_));
  nand3  g381(.a(new_n538_), .b(x086), .c(x006), .O(new_n539_));
  nand2  g382(.a(x054), .b(x038), .O(new_n540_));
  nand3  g383(.a(x070), .b(new_n537_), .c(x022), .O(new_n541_));
  nand4  g384(.a(new_n541_), .b(new_n540_), .c(new_n539_), .d(new_n360_), .O(new_n542_));
  nand3  g385(.a(new_n542_), .b(x078), .c(new_n322_), .O(new_n543_));
