...
module FAU ( 
  ...
  nand3  g315(.a(new_n471_), .b(new_n158_), .c(new_n459_), .O(new_n472_));
  ...
  nand3  g330(.a(new_n486_), .b(new_n158_), .c(new_n474_), .O(new_n487_));
  ...
  nand2  g381(.a(new_n362_), .b(x038), .O(new_n538_));
  nand3  g382(.a(new_n538_), .b(x086), .c(x006), .O(new_n539_));
  aoi21  g383(.a(x054), .b(x038), .c(x014), .O(new_n540_));
  nand3  g384(.a(x070), .b(new_n362_), .c(x022), .O(new_n541_));
  nand3  g385(.a(new_n541_), .b(new_n540_), .c(x078), .O(new_n542_));
  inv1   g386(.a(new_n542_), .O(new_n543_));
  aoi21  g387(.a(new_n543_), .b(new_n539_), .c(x046), .O(z14));
  zero   g388(.O(z16));
  zero   g389(.O(z21));
  zero   g390(.O(z23));
  zero   g391(.O(z26));
  ...
  nor2   g399(.a(x078), .b(x046), .O(z25));
  nor2   g400(.a(x078), .b(x046), .O(z27));
endmodule
