...
module FAU ( 
  ...
  oai21  g220(.a(new_n376_), .b(new_n316_), .c(new_n159_), .O(z06));
  ...
  nor3   g411(.a(new_n568_), .b(z15), .c(x046), .O(z14));
  zero   g412(.O(z07));
  zero   g413(.O(z16));
  zero   g414(.O(z17));
  zero   g415(.O(z18));
  ...
  zero   g420(.O(z26));
  zero   g421(.O(z27));
  nor2   g422(.a(new_n157_), .b(x045), .O(z19));
  nor2   g423(.a(new_n157_), .b(x045), .O(z20));
  nor2   g424(.a(new_n157_), .b(x045), .O(z24));
endmodule
