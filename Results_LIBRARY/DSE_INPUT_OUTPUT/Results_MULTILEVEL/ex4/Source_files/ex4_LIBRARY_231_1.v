...
module FAU ( 
  ...
  oai21  g392(.a(new_n350_), .b(x022), .c(new_n329_), .O(new_n549_));
  and2   g393(.a(new_n549_), .b(x070), .O(new_n550_));
  oai21  g394(.a(x070), .b(x014), .c(x022), .O(new_n551_));
  nand4  g395(.a(new_n551_), .b(new_n542_), .c(new_n337_), .d(x030), .O(new_n552_));
  inv1   g396(.a(new_n552_), .O(new_n553_));
  oai21  g397(.a(new_n553_), .b(new_n550_), .c(new_n333_), .O(new_n554_));
  ...
  nand2  g402(.a(new_n549_), .b(new_n333_), .O(new_n559_));
  ...
  aoi21  g406(.a(new_n562_), .b(new_n324_), .c(x014), .O(new_n563_));
  aoi21  g407(.a(new_n532_), .b(x038), .c(new_n328_), .O(new_n564_));
  ...
  nor2   g423(.a(new_n178_), .b(x046), .O(z22));
