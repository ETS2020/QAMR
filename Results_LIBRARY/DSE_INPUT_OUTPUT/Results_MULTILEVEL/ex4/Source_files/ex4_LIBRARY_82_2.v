...
module FAU ( 
  ...
  nor3   g148(.a(new_n304_), .b(new_n258_), .c(new_n157_), .O(z05));
  ...
  oai21  g210(.a(new_n366_), .b(new_n306_), .c(new_n159_), .O(z06));
  ...
  oai21  g227(.a(new_n371_), .b(new_n160_), .c(new_n384_), .O(new_n385_));
  ...
  oai21  g241(.a(new_n398_), .b(new_n393_), .c(new_n177_), .O(new_n399_));
  ...
  nand2  g248(.a(new_n394_), .b(new_n163_), .O(new_n406_));
  ...
  aoi21  g258(.a(new_n401_), .b(new_n171_), .c(new_n415_), .O(new_n416_));
  oai21  g259(.a(new_n416_), .b(x040), .c(new_n159_), .O(z08));
  ...
  nor3   g407(.a(new_n564_), .b(z15), .c(x046), .O(z14));
  zero   g408(.O(z07));
  zero   g409(.O(z16));
  zero   g410(.O(z17));
  zero   g411(.O(z18));
  ...
  nor2   g420(.a(x077), .b(new_n157_), .O(z24));
endmodule
