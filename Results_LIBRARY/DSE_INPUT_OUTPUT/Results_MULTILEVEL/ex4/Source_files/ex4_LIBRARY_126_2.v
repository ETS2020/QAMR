// Benchmark "FAU" written by ABC on Tue Aug 18 02:18:53 2020
...
module FAU ( 
  ...
  nor3   g214(.a(new_n370_), .b(new_n323_), .c(new_n178_), .O(z06));
  nand2  g215(.a(x064), .b(new_n173_), .O(new_n372_));
  aoi21  g216(.a(new_n372_), .b(new_n159_), .c(new_n165_), .O(new_n373_));
  nand2  g217(.a(x088), .b(x056), .O(new_n374_));
  nand3  g218(.a(new_n374_), .b(new_n158_), .c(x024), .O(new_n375_));
  aoi21  g219(.a(new_n375_), .b(new_n157_), .c(x080), .O(new_n376_));
  ...
  oai22  g229(.a(new_n374_), .b(new_n157_), .c(x120), .d(x096), .O(new_n386_));
  ...
  nand3  g233(.a(new_n389_), .b(x120), .c(new_n157_), .O(new_n390_));
  nand3  g234(.a(x096), .b(x064), .c(new_n173_), .O(new_n391_));
  nand3  g235(.a(new_n391_), .b(new_n390_), .c(new_n160_), .O(new_n392_));
  inv1   g236(.a(new_n392_), .O(new_n393_));
  aoi21  g237(.a(new_n393_), .b(new_n388_), .c(new_n165_), .O(new_n394_));
  ...
  oai21  g246(.a(new_n402_), .b(new_n394_), .c(new_n174_), .O(new_n403_));
  nand3  g247(.a(x072), .b(x064), .c(x016), .O(new_n404_));
  nand3  g248(.a(new_n404_), .b(new_n403_), .c(new_n379_), .O(new_n405_));
  nand3  g249(.a(new_n160_), .b(x024), .c(new_n164_), .O(new_n406_));
  oai21  g250(.a(new_n398_), .b(new_n165_), .c(new_n406_), .O(new_n407_));
  nand2  g251(.a(new_n407_), .b(new_n158_), .O(new_n408_));
  nand2  g252(.a(new_n396_), .b(new_n160_), .O(new_n409_));
  aoi21  g253(.a(new_n409_), .b(new_n408_), .c(new_n173_), .O(new_n410_));
  aoi22  g254(.a(x080), .b(x000), .c(x064), .d(x016), .O(new_n411_));
  nand3  g255(.a(new_n169_), .b(x064), .c(x016), .O(new_n412_));
  oai21  g256(.a(new_n411_), .b(x008), .c(new_n412_), .O(new_n413_));
  oai21  g257(.a(new_n413_), .b(new_n410_), .c(new_n174_), .O(new_n414_));
  nand3  g258(.a(new_n169_), .b(x080), .c(x000), .O(new_n415_));
  nand2  g259(.a(new_n415_), .b(new_n164_), .O(new_n416_));
  aoi22  g260(.a(new_n416_), .b(x072), .c(x048), .d(x032), .O(new_n417_));
  nand2  g261(.a(new_n417_), .b(new_n414_), .O(new_n418_));
  aoi21  g262(.a(new_n405_), .b(new_n168_), .c(new_n418_), .O(new_n419_));
  nor3   g263(.a(new_n419_), .b(z07), .c(x040), .O(z08));
  nand2  g264(.a(x065), .b(x017), .O(new_n421_));
  nand3  g265(.a(x081), .b(new_n189_), .c(x001), .O(new_n422_));
  oai21  g266(.a(new_n421_), .b(new_n189_), .c(new_n422_), .O(new_n423_));
  nand3  g267(.a(x081), .b(x009), .c(x001), .O(new_n424_));
  oai21  g268(.a(new_n421_), .b(x009), .c(new_n424_), .O(new_n425_));
  oai21  g269(.a(new_n195_), .b(x033), .c(new_n425_), .O(new_n426_));
  nand2  g270(.a(x081), .b(x001), .O(new_n427_));
  aoi21  g271(.a(new_n427_), .b(new_n421_), .c(x073), .O(new_n428_));
  nand2  g272(.a(new_n428_), .b(new_n189_), .O(new_n429_));
  aoi22  g273(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n430_));
  nand3  g274(.a(new_n430_), .b(new_n429_), .c(new_n426_), .O(new_n431_));
  aoi21  g275(.a(new_n423_), .b(new_n188_), .c(new_n431_), .O(new_n432_));
  oai21  g276(.a(new_n432_), .b(x041), .c(new_n180_), .O(z09));
  nand2  g277(.a(x066), .b(x018), .O(new_n434_));
  nand3  g278(.a(x082), .b(new_n208_), .c(x002), .O(new_n435_));
  oai21  g279(.a(new_n434_), .b(new_n208_), .c(new_n435_), .O(new_n436_));
  nand3  g280(.a(x082), .b(x010), .c(x002), .O(new_n437_));
  oai21  g281(.a(new_n434_), .b(x010), .c(new_n437_), .O(new_n438_));
  oai21  g282(.a(new_n214_), .b(x034), .c(new_n438_), .O(new_n439_));
  nand2  g283(.a(x082), .b(x002), .O(new_n440_));
  aoi21  g284(.a(new_n440_), .b(new_n434_), .c(x074), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(new_n208_), .O(new_n442_));
  aoi22  g286(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n443_));
  nand3  g287(.a(new_n443_), .b(new_n442_), .c(new_n439_), .O(new_n444_));
  aoi21  g288(.a(new_n436_), .b(new_n207_), .c(new_n444_), .O(new_n445_));
  oai21  g289(.a(new_n445_), .b(x042), .c(new_n180_), .O(z10));
  nand2  g290(.a(x067), .b(x019), .O(new_n447_));
  nand3  g291(.a(x083), .b(new_n227_), .c(x003), .O(new_n448_));
  oai21  g292(.a(new_n447_), .b(new_n227_), .c(new_n448_), .O(new_n449_));
  nand3  g293(.a(x083), .b(x011), .c(x003), .O(new_n450_));
  oai21  g294(.a(new_n447_), .b(x011), .c(new_n450_), .O(new_n451_));
  oai21  g295(.a(new_n233_), .b(x035), .c(new_n451_), .O(new_n452_));
  nand2  g296(.a(x083), .b(x003), .O(new_n453_));
  aoi21  g297(.a(new_n453_), .b(new_n447_), .c(x075), .O(new_n454_));
  nand2  g298(.a(new_n454_), .b(new_n227_), .O(new_n455_));
  aoi22  g299(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n456_));
  nand3  g300(.a(new_n456_), .b(new_n455_), .c(new_n452_), .O(new_n457_));
  aoi21  g301(.a(new_n449_), .b(new_n226_), .c(new_n457_), .O(new_n458_));
  oai21  g302(.a(new_n458_), .b(x043), .c(new_n180_), .O(z11));
  nand2  g303(.a(x068), .b(x020), .O(new_n460_));
  nand3  g304(.a(x084), .b(new_n246_), .c(x004), .O(new_n461_));
  oai21  g305(.a(new_n460_), .b(new_n246_), .c(new_n461_), .O(new_n462_));
  nand3  g306(.a(x084), .b(x012), .c(x004), .O(new_n463_));
  oai21  g307(.a(new_n460_), .b(x012), .c(new_n463_), .O(new_n464_));
  oai21  g308(.a(new_n252_), .b(x036), .c(new_n464_), .O(new_n465_));
  nand2  g309(.a(x084), .b(x004), .O(new_n466_));
  aoi21  g310(.a(new_n466_), .b(new_n460_), .c(x076), .O(new_n467_));
  nand2  g311(.a(new_n467_), .b(new_n246_), .O(new_n468_));
  aoi22  g312(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n469_));
  nand3  g313(.a(new_n469_), .b(new_n468_), .c(new_n465_), .O(new_n470_));
  aoi21  g314(.a(new_n462_), .b(new_n245_), .c(new_n470_), .O(new_n471_));
  oai21  g315(.a(new_n471_), .b(x044), .c(new_n180_), .O(z12));
  nand2  g316(.a(new_n286_), .b(new_n285_), .O(new_n473_));
  nand2  g317(.a(new_n288_), .b(new_n281_), .O(new_n474_));
  nand2  g318(.a(x069), .b(new_n262_), .O(new_n475_));
  aoi21  g319(.a(new_n475_), .b(new_n474_), .c(new_n261_), .O(new_n476_));
  nand2  g320(.a(x093), .b(x061), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n288_), .c(x029), .O(new_n478_));
  aoi21  g322(.a(new_n478_), .b(new_n281_), .c(x085), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(new_n476_), .c(new_n260_), .O(new_n480_));
  oai21  g324(.a(x085), .b(new_n298_), .c(new_n480_), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n473_), .O(new_n482_));
  oai21  g326(.a(x037), .b(x013), .c(x021), .O(new_n483_));
  nand3  g327(.a(new_n268_), .b(new_n267_), .c(new_n266_), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n483_), .O(new_n485_));
  oai22  g329(.a(new_n477_), .b(new_n281_), .c(x125), .d(x101), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(new_n485_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n288_), .O(new_n488_));
  nand3  g332(.a(new_n259_), .b(x125), .c(new_n281_), .O(new_n489_));
  nand3  g333(.a(x101), .b(x069), .c(new_n262_), .O(new_n490_));
  nand3  g334(.a(new_n490_), .b(new_n489_), .c(new_n274_), .O(new_n491_));
  inv1   g335(.a(new_n491_), .O(new_n492_));
  aoi21  g336(.a(new_n492_), .b(new_n488_), .c(new_n261_), .O(new_n493_));
  oai21  g337(.a(new_n266_), .b(x021), .c(new_n282_), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(x069), .O(new_n495_));
  inv1   g339(.a(x125), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n289_), .O(new_n497_));
  oai21  g341(.a(x069), .b(x013), .c(x021), .O(new_n498_));
  nand4  g342(.a(new_n498_), .b(new_n497_), .c(new_n477_), .d(x029), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n495_), .c(x085), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(new_n493_), .c(new_n260_), .O(new_n501_));
  nand3  g345(.a(x077), .b(x069), .c(x021), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n501_), .c(new_n482_), .O(new_n503_));
  nand2  g347(.a(new_n497_), .b(x005), .O(new_n504_));
  nand3  g348(.a(new_n274_), .b(x029), .c(new_n298_), .O(new_n505_));
  nand2  g349(.a(new_n505_), .b(new_n504_), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n288_), .O(new_n507_));
  nand2  g351(.a(new_n494_), .b(new_n274_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n507_), .c(new_n262_), .O(new_n509_));
  oai21  g353(.a(new_n274_), .b(new_n261_), .c(new_n263_), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n298_), .O(new_n511_));
  nand2  g355(.a(new_n316_), .b(x037), .O(new_n512_));
  nand3  g356(.a(new_n512_), .b(x069), .c(x021), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n511_), .O(new_n514_));
  oai21  g358(.a(new_n514_), .b(new_n509_), .c(new_n260_), .O(new_n515_));
  ...
  aoi21  g363(.a(new_n503_), .b(new_n316_), .c(new_n519_), .O(new_n520_));
  nor3   g364(.a(new_n520_), .b(z07), .c(x045), .O(z13));
  inv1   g365(.a(x054), .O(new_n522_));
  nand2  g366(.a(x070), .b(new_n340_), .O(new_n523_));
  aoi21  g367(.a(new_n523_), .b(new_n365_), .c(new_n339_), .O(new_n524_));
  nand3  g368(.a(new_n342_), .b(new_n326_), .c(x030), .O(new_n525_));
  nor2   g369(.a(x022), .b(x014), .O(new_n526_));
  aoi21  g370(.a(new_n526_), .b(new_n525_), .c(x086), .O(new_n527_));
  oai21  g371(.a(new_n527_), .b(new_n524_), .c(new_n348_), .O(new_n528_));
  oai21  g372(.a(x038), .b(x014), .c(x022), .O(new_n529_));
  oai21  g373(.a(new_n332_), .b(x030), .c(new_n529_), .O(new_n530_));
  inv1   g374(.a(x102), .O(new_n531_));
  nand2  g375(.a(new_n347_), .b(new_n531_), .O(new_n532_));
  oai21  g376(.a(new_n342_), .b(new_n335_), .c(new_n532_), .O(new_n533_));
  aoi21  g377(.a(new_n533_), .b(new_n530_), .c(x070), .O(new_n534_));
  nand3  g378(.a(new_n324_), .b(x126), .c(new_n335_), .O(new_n535_));
  nand3  g379(.a(x102), .b(x070), .c(new_n340_), .O(new_n536_));
  nand3  g380(.a(new_n536_), .b(new_n535_), .c(new_n329_), .O(new_n537_));
  oai21  g381(.a(new_n537_), .b(new_n534_), .c(x006), .O(new_n538_));
  oai21  g382(.a(new_n330_), .b(x022), .c(new_n331_), .O(new_n539_));
  and2   g383(.a(new_n539_), .b(x070), .O(new_n540_));
  oai21  g384(.a(x070), .b(x014), .c(x022), .O(new_n541_));
  nand4  g385(.a(new_n541_), .b(new_n532_), .c(new_n342_), .d(x030), .O(new_n542_));
  inv1   g386(.a(new_n542_), .O(new_n543_));
  oai21  g387(.a(new_n543_), .b(new_n540_), .c(new_n329_), .O(new_n544_));
  nand3  g388(.a(new_n544_), .b(new_n538_), .c(new_n528_), .O(new_n545_));
  nand2  g389(.a(new_n532_), .b(x006), .O(new_n546_));
  nand3  g390(.a(new_n329_), .b(x030), .c(new_n334_), .O(new_n547_));
  aoi21  g391(.a(new_n547_), .b(new_n546_), .c(x070), .O(new_n548_));
  nand2  g392(.a(new_n539_), .b(new_n329_), .O(new_n549_));
  nand2  g393(.a(new_n549_), .b(new_n522_), .O(new_n550_));
  oai21  g394(.a(new_n550_), .b(new_n548_), .c(x038), .O(new_n551_));
  oai21  g395(.a(new_n329_), .b(new_n339_), .c(new_n325_), .O(new_n552_));
  nand2  g396(.a(new_n552_), .b(new_n334_), .O(new_n553_));
  nand2  g397(.a(new_n522_), .b(x038), .O(new_n554_));
  nand3  g398(.a(new_n554_), .b(x070), .c(x022), .O(new_n555_));
  nand4  g399(.a(new_n555_), .b(new_n553_), .c(new_n551_), .d(new_n178_), .O(new_n556_));
  aoi21  g400(.a(new_n545_), .b(new_n522_), .c(new_n556_), .O(new_n557_));
  nand3  g401(.a(new_n554_), .b(x086), .c(x006), .O(new_n558_));
  nand3  g402(.a(x070), .b(new_n522_), .c(x022), .O(new_n559_));
  nand3  g403(.a(new_n559_), .b(new_n558_), .c(new_n334_), .O(new_n560_));
  aoi22  g404(.a(new_n560_), .b(x078), .c(x054), .d(x038), .O(new_n561_));
  oai22  g405(.a(new_n561_), .b(x046), .c(new_n557_), .d(x078), .O(z14));
  zero   g406(.O(z15));
  zero   g407(.O(z17));
  zero   g408(.O(z18));
  zero   g409(.O(z20));
  ...
  zero   g411(.O(z26));
  zero   g412(.O(z27));
  nor2   g413(.a(x078), .b(new_n178_), .O(z16));
  nor2   g414(.a(x078), .b(new_n178_), .O(z19));
  nor2   g415(.a(x078), .b(new_n178_), .O(z21));
  nor2   g416(.a(x078), .b(new_n178_), .O(z22));
  nor2   g417(.a(x078), .b(new_n178_), .O(z23));
  nor2   g418(.a(x078), .b(new_n178_), .O(z24));
endmodule
