...
module FAU ( 
  ...
  nor2   g001(.a(x105), .b(new_n157_), .O(z15));
  ...
  aoi21  g115(.a(new_n271_), .b(new_n264_), .c(new_n157_), .O(new_n272_));
  ...
  nand3  g145(.a(new_n157_), .b(new_n287_), .c(new_n280_), .O(new_n302_));
  ...
  aoi22  g161(.a(new_n317_), .b(new_n157_), .c(new_n315_), .d(new_n261_), .O(new_n318_));
  ...
  oai21  g342(.a(new_n499_), .b(new_n496_), .c(new_n157_), .O(new_n500_));
  ...
  nand3  g351(.a(new_n259_), .b(x125), .c(new_n280_), .O(new_n509_));
  ...
  oai21  g363(.a(new_n520_), .b(new_n513_), .c(new_n157_), .O(new_n521_));
  ...
  oai21  g377(.a(new_n534_), .b(new_n529_), .c(new_n157_), .O(new_n535_));
  ...
  oai21  g383(.a(new_n540_), .b(x045), .c(new_n159_), .O(z13));
  ...
  zero   g439(.O(z25));
  zero   g440(.O(z27));
  nor2   g441(.a(x105), .b(new_n157_), .O(z18));
  nor2   g442(.a(x105), .b(new_n157_), .O(z21));
  nor2   g443(.a(x105), .b(new_n157_), .O(z22));
  nor2   g444(.a(x105), .b(new_n157_), .O(z24));
  nor2   g445(.a(x105), .b(new_n157_), .O(z26));
endmodule
