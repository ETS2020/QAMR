...
module FAU ( 
  ...
  nand2  g278(.a(new_n434_), .b(new_n187_), .O(new_n435_));
  ...
  oai22  g284(.a(new_n195_), .b(new_n188_), .c(new_n194_), .d(new_n187_), .O(new_n441_));
  aoi21  g285(.a(new_n440_), .b(new_n188_), .c(new_n441_), .O(new_n442_));
  nand3  g286(.a(new_n442_), .b(new_n438_), .c(new_n435_), .O(new_n443_));
  nand3  g287(.a(new_n443_), .b(new_n158_), .c(new_n431_), .O(new_n444_));
  ...
  oai21  g301(.a(new_n457_), .b(x042), .c(new_n158_), .O(z10));
  ...
  nand2  g310(.a(new_n466_), .b(new_n226_), .O(new_n467_));
  aoi22  g311(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n468_));
  nand3  g312(.a(new_n468_), .b(new_n467_), .c(new_n464_), .O(new_n469_));
  aoi21  g313(.a(new_n461_), .b(new_n225_), .c(new_n469_), .O(new_n470_));
  oai21  g314(.a(new_n470_), .b(x043), .c(new_n158_), .O(z11));
  ...
  aoi21  g382(.a(x054), .b(x038), .c(x014), .O(new_n539_));
  nand3  g383(.a(x070), .b(new_n536_), .c(x022), .O(new_n540_));
  nand3  g384(.a(new_n540_), .b(new_n539_), .c(x078), .O(new_n541_));
  inv1   g385(.a(new_n541_), .O(new_n542_));
  aoi21  g386(.a(new_n542_), .b(new_n538_), .c(x046), .O(z14));
  zero   g387(.O(z16));
  zero   g388(.O(z17));
  zero   g389(.O(z20));
  zero   g390(.O(z23));
  zero   g391(.O(z25));
  zero   g392(.O(z26));
  nor2   g393(.a(x078), .b(x046), .O(z15));
  nor2   g394(.a(x078), .b(x046), .O(z18));
  nor2   g395(.a(x078), .b(x046), .O(z19));
  nor2   g396(.a(x078), .b(x046), .O(z21));
  nor2   g397(.a(x078), .b(x046), .O(z22));
  nor2   g398(.a(x078), .b(x046), .O(z24));
