...
module FAU ( 
  ...
  oai21  g281(.a(new_n437_), .b(x044), .c(new_n181_), .O(z12));
  ...
  oai21  g346(.a(new_n492_), .b(new_n328_), .c(new_n502_), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n501_), .O(new_n504_));
  nand2  g348(.a(x118), .b(x110), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(x126), .c(new_n328_), .O(new_n506_));
  nand3  g350(.a(x102), .b(x070), .c(new_n323_), .O(new_n507_));
  nand3  g351(.a(new_n507_), .b(new_n506_), .c(new_n322_), .O(new_n508_));
  aoi21  g352(.a(new_n504_), .b(new_n329_), .c(new_n508_), .O(new_n509_));
  nor2   g353(.a(new_n509_), .b(new_n321_), .O(new_n510_));
  aoi21  g354(.a(x030), .b(new_n328_), .c(new_n500_), .O(new_n511_));
  or2    g355(.a(new_n511_), .b(new_n329_), .O(new_n512_));
  ...
  nand2  g362(.a(new_n518_), .b(new_n326_), .O(new_n519_));
  nand2  g363(.a(new_n502_), .b(x006), .O(new_n520_));
  nand3  g364(.a(new_n322_), .b(x030), .c(new_n488_), .O(new_n521_));
  ...
  oai22  g368(.a(new_n322_), .b(new_n321_), .c(new_n329_), .d(new_n328_), .O(new_n525_));
  aoi21  g369(.a(new_n326_), .b(x038), .c(new_n329_), .O(new_n526_));
  aoi22  g370(.a(new_n526_), .b(x022), .c(new_n525_), .d(new_n488_), .O(new_n527_));
  nand2  g371(.a(new_n527_), .b(new_n524_), .O(new_n528_));
  aoi21  g372(.a(new_n326_), .b(x038), .c(new_n322_), .O(new_n529_));
  aoi21  g373(.a(new_n529_), .b(x006), .c(x014), .O(new_n530_));
  oai22  g374(.a(new_n530_), .b(new_n179_), .c(new_n326_), .d(new_n323_), .O(new_n531_));
  ...
  zero   g385(.O(z26));
  zero   g386(.O(z27));
  nor2   g387(.a(new_n179_), .b(new_n178_), .O(z17));
