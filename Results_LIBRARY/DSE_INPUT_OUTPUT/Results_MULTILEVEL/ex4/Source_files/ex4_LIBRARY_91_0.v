...
module FAU ( 
  ...
  nand2  g377(.a(new_n362_), .b(x038), .O(new_n534_));
  nand3  g378(.a(new_n534_), .b(x086), .c(x006), .O(new_n535_));
  aoi21  g379(.a(x054), .b(x038), .c(x014), .O(new_n536_));
  nand3  g380(.a(x070), .b(new_n362_), .c(x022), .O(new_n537_));
  nand3  g381(.a(new_n537_), .b(new_n536_), .c(x078), .O(new_n538_));
  inv1   g382(.a(new_n538_), .O(new_n539_));
  aoi21  g383(.a(new_n539_), .b(new_n535_), .c(x046), .O(z14));
  zero   g384(.O(z15));
  zero   g385(.O(z19));
  zero   g386(.O(z20));
  zero   g387(.O(z21));
  ...
  nor2   g391(.a(x078), .b(x046), .O(z17));
  nor2   g392(.a(x078), .b(x046), .O(z18));
  nor2   g393(.a(x078), .b(x046), .O(z22));
  nor2   g394(.a(x078), .b(x046), .O(z24));
  nor2   g395(.a(x078), .b(x046), .O(z25));
  nor2   g396(.a(x078), .b(x046), .O(z27));
endmodule
