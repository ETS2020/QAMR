...
module FAU ( 
  ...
  nor2   g000(.a(x077), .b(x045), .O(z20));
  inv1   g001(.a(z20), .O(new_n158_));
  ...
  nor3   g220(.a(new_n376_), .b(z20), .c(new_n314_), .O(z06));
  ...
  nand2  g327(.a(new_n484_), .b(x037), .O(new_n485_));
  nand3  g328(.a(new_n485_), .b(x085), .c(x005), .O(new_n486_));
  nand2  g329(.a(x053), .b(x037), .O(new_n487_));
  nand3  g330(.a(x069), .b(new_n484_), .c(x021), .O(new_n488_));
  nand4  g331(.a(new_n488_), .b(new_n487_), .c(new_n486_), .d(new_n292_), .O(new_n489_));
  nand3  g332(.a(new_n489_), .b(x077), .c(new_n257_), .O(new_n490_));
  inv1   g333(.a(new_n490_), .O(z13));
  nand2  g334(.a(new_n343_), .b(new_n337_), .O(new_n492_));
  nand2  g335(.a(x070), .b(new_n318_), .O(new_n493_));
  aoi21  g336(.a(new_n493_), .b(new_n492_), .c(new_n317_), .O(new_n494_));
  nand2  g337(.a(x094), .b(x062), .O(new_n495_));
  nand3  g338(.a(new_n495_), .b(new_n343_), .c(x030), .O(new_n496_));
  aoi21  g339(.a(new_n496_), .b(new_n337_), .c(x086), .O(new_n497_));
  oai21  g340(.a(new_n497_), .b(new_n494_), .c(new_n316_), .O(new_n498_));
  oai21  g341(.a(x086), .b(new_n353_), .c(new_n498_), .O(new_n499_));
  oai21  g342(.a(x118), .b(x110), .c(new_n499_), .O(new_n500_));
  oai21  g343(.a(x038), .b(x014), .c(x022), .O(new_n501_));
  oai21  g344(.a(new_n325_), .b(x030), .c(new_n501_), .O(new_n502_));
  inv1   g345(.a(x126), .O(new_n503_));
  nand2  g346(.a(new_n503_), .b(new_n344_), .O(new_n504_));
  oai21  g347(.a(new_n495_), .b(new_n337_), .c(new_n504_), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(new_n502_), .O(new_n506_));
  nand2  g349(.a(new_n506_), .b(new_n343_), .O(new_n507_));
  nand3  g350(.a(new_n315_), .b(x126), .c(new_n337_), .O(new_n508_));
  nand3  g351(.a(x102), .b(x070), .c(new_n318_), .O(new_n509_));
  nand3  g352(.a(new_n509_), .b(new_n508_), .c(new_n330_), .O(new_n510_));
  inv1   g353(.a(new_n510_), .O(new_n511_));
  aoi21  g354(.a(new_n511_), .b(new_n507_), .c(new_n317_), .O(new_n512_));
  oai21  g355(.a(new_n322_), .b(x022), .c(new_n338_), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(x070), .O(new_n514_));
  oai21  g357(.a(x070), .b(x014), .c(x022), .O(new_n515_));
  nand4  g358(.a(new_n515_), .b(new_n504_), .c(new_n495_), .d(x030), .O(new_n516_));
  aoi21  g359(.a(new_n516_), .b(new_n514_), .c(x086), .O(new_n517_));
  oai21  g360(.a(new_n517_), .b(new_n512_), .c(new_n316_), .O(new_n518_));
  ...
  nand3  g364(.a(new_n330_), .b(x030), .c(new_n353_), .O(new_n522_));
  nand2  g365(.a(new_n522_), .b(new_n521_), .O(new_n523_));
  nand2  g366(.a(new_n523_), .b(new_n343_), .O(new_n524_));
  nand2  g367(.a(new_n513_), .b(new_n330_), .O(new_n525_));
  aoi21  g368(.a(new_n525_), .b(new_n524_), .c(new_n318_), .O(new_n526_));
  oai21  g369(.a(new_n330_), .b(new_n317_), .c(new_n319_), .O(new_n527_));
  nand2  g370(.a(new_n527_), .b(new_n353_), .O(new_n528_));
  nand2  g371(.a(new_n371_), .b(x038), .O(new_n529_));
  ...
  nand2  g376(.a(new_n533_), .b(new_n353_), .O(new_n534_));
  aoi22  g377(.a(new_n534_), .b(x078), .c(x054), .d(x038), .O(new_n535_));
  nand2  g378(.a(new_n535_), .b(new_n532_), .O(new_n536_));
  aoi21  g379(.a(new_n520_), .b(new_n371_), .c(new_n536_), .O(new_n537_));
