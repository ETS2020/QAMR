...
module FAU ( 
  ...
  oai21  g238(.a(new_n382_), .b(new_n159_), .c(new_n395_), .O(new_n396_));
  ...
  oai21  g252(.a(new_n409_), .b(new_n404_), .c(new_n176_), .O(new_n410_));
  ...
  nand2  g259(.a(new_n405_), .b(new_n162_), .O(new_n417_));
  ...
  aoi21  g269(.a(new_n412_), .b(new_n170_), .c(new_n426_), .O(new_n427_));
  oai21  g270(.a(new_n427_), .b(x040), .c(new_n158_), .O(z08));
  ...
  oai21  g283(.a(new_n440_), .b(x041), .c(new_n158_), .O(z09));
  ...
  nand3  g297(.a(new_n454_), .b(new_n158_), .c(new_n442_), .O(new_n455_));
  ...
  nor3   g373(.a(new_n530_), .b(z17), .c(x045), .O(z13));
  ...
  nand4  g379(.a(new_n536_), .b(new_n535_), .c(new_n534_), .d(new_n357_), .O(new_n537_));
  nand3  g380(.a(new_n537_), .b(x078), .c(new_n322_), .O(new_n538_));
