...
module FAU ( 
  ...
  oai21  g294(.a(new_n446_), .b(x010), .c(new_n450_), .O(new_n451_));
  oai21  g295(.a(new_n213_), .b(x034), .c(new_n451_), .O(new_n452_));
  nand2  g296(.a(x082), .b(x002), .O(new_n453_));
  aoi21  g297(.a(new_n453_), .b(new_n446_), .c(x074), .O(new_n454_));
  oai22  g298(.a(new_n214_), .b(new_n207_), .c(new_n213_), .d(new_n206_), .O(new_n455_));
  aoi21  g299(.a(new_n454_), .b(new_n207_), .c(new_n455_), .O(new_n456_));
  nand3  g300(.a(new_n456_), .b(new_n452_), .c(new_n449_), .O(new_n457_));
  nand3  g301(.a(new_n457_), .b(new_n158_), .c(new_n445_), .O(new_n458_));
  inv1   g302(.a(new_n458_), .O(z10));
  ...
  oai21  g315(.a(new_n471_), .b(x043), .c(new_n158_), .O(z11));
  ...
  aoi21  g327(.a(new_n475_), .b(new_n244_), .c(new_n483_), .O(new_n484_));
  oai21  g328(.a(new_n484_), .b(x044), .c(new_n158_), .O(z12));
  ...
  nor2   g393(.a(x078), .b(x046), .O(z18));
  nor2   g394(.a(x078), .b(x046), .O(z21));
