...
module FAU ( 
  ...
  inv1   g379(.a(new_n346_), .O(new_n537_));
  inv1   g380(.a(x078), .O(new_n538_));
  nand2  g381(.a(new_n323_), .b(new_n333_), .O(new_n539_));
  nand2  g382(.a(x070), .b(new_n338_), .O(new_n540_));
  aoi21  g383(.a(new_n540_), .b(new_n539_), .c(new_n337_), .O(new_n541_));
  nand3  g384(.a(new_n340_), .b(new_n323_), .c(x030), .O(new_n542_));
  aoi21  g385(.a(new_n542_), .b(new_n333_), .c(x086), .O(new_n543_));
  oai21  g386(.a(new_n543_), .b(new_n541_), .c(new_n538_), .O(new_n544_));
  nand2  g387(.a(new_n326_), .b(x014), .O(new_n545_));
  aoi21  g388(.a(new_n545_), .b(new_n544_), .c(new_n537_), .O(new_n546_));
  oai21  g389(.a(x038), .b(x014), .c(x022), .O(new_n547_));
  nand3  g390(.a(new_n329_), .b(new_n328_), .c(new_n327_), .O(new_n548_));
  nand2  g391(.a(new_n548_), .b(new_n547_), .O(new_n549_));
  oai22  g392(.a(new_n340_), .b(new_n333_), .c(x126), .d(x102), .O(new_n550_));
  aoi21  g393(.a(new_n550_), .b(new_n549_), .c(x070), .O(new_n551_));
  nand3  g394(.a(new_n321_), .b(x126), .c(new_n333_), .O(new_n552_));
  nand3  g395(.a(x102), .b(x070), .c(new_n338_), .O(new_n553_));
  nand3  g396(.a(new_n553_), .b(new_n552_), .c(new_n326_), .O(new_n554_));
  oai21  g397(.a(new_n554_), .b(new_n551_), .c(x006), .O(new_n555_));
  aoi21  g398(.a(x030), .b(new_n333_), .c(new_n330_), .O(new_n556_));
  inv1   g399(.a(x102), .O(new_n557_));
  nand2  g400(.a(new_n345_), .b(new_n557_), .O(new_n558_));
  oai21  g401(.a(x070), .b(x014), .c(x022), .O(new_n559_));
  nand4  g402(.a(new_n559_), .b(new_n558_), .c(new_n340_), .d(x030), .O(new_n560_));
  oai21  g403(.a(new_n556_), .b(new_n323_), .c(new_n560_), .O(new_n561_));
  nand2  g404(.a(new_n561_), .b(new_n326_), .O(new_n562_));
  aoi21  g405(.a(new_n562_), .b(new_n555_), .c(x078), .O(new_n563_));
  oai21  g406(.a(new_n563_), .b(new_n546_), .c(new_n375_), .O(new_n564_));
  nand2  g407(.a(new_n558_), .b(x006), .O(new_n565_));
  nand3  g408(.a(new_n326_), .b(x030), .c(new_n332_), .O(new_n566_));
  aoi21  g409(.a(new_n566_), .b(new_n565_), .c(x070), .O(new_n567_));
  nor2   g410(.a(new_n556_), .b(x086), .O(new_n568_));
  oai21  g411(.a(new_n568_), .b(new_n567_), .c(x038), .O(new_n569_));
  nand2  g412(.a(x086), .b(x006), .O(new_n570_));
  aoi21  g413(.a(new_n570_), .b(new_n322_), .c(x014), .O(new_n571_));
  aoi21  g414(.a(new_n375_), .b(x038), .c(new_n323_), .O(new_n572_));
  aoi21  g415(.a(new_n572_), .b(x022), .c(new_n571_), .O(new_n573_));
  nand2  g416(.a(new_n573_), .b(new_n569_), .O(new_n574_));
  nand2  g417(.a(new_n574_), .b(new_n538_), .O(new_n575_));
  ...
  nand4  g424(.a(new_n581_), .b(new_n580_), .c(new_n576_), .d(new_n332_), .O(new_n582_));
