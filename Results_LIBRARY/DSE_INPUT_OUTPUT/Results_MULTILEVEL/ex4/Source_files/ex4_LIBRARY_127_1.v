...
module FAU ( 
  ...
  aoi21  g394(.a(x030), .b(new_n327_), .c(new_n353_), .O(new_n551_));
  oai21  g395(.a(x070), .b(x014), .c(x022), .O(new_n552_));
  nand4  g396(.a(new_n552_), .b(new_n544_), .c(new_n337_), .d(x030), .O(new_n553_));
  oai21  g397(.a(new_n551_), .b(new_n328_), .c(new_n553_), .O(new_n554_));
  nand2  g398(.a(new_n554_), .b(new_n333_), .O(new_n555_));
  nand3  g399(.a(new_n555_), .b(new_n550_), .c(new_n540_), .O(new_n556_));
  nand2  g400(.a(new_n556_), .b(new_n534_), .O(new_n557_));
  ...
  inv1   g405(.a(new_n551_), .O(new_n562_));
  nand2  g406(.a(new_n562_), .b(new_n333_), .O(new_n563_));
  nand3  g407(.a(new_n563_), .b(new_n561_), .c(new_n534_), .O(new_n564_));
  oai21  g408(.a(new_n333_), .b(new_n322_), .c(new_n324_), .O(new_n565_));
  nand2  g409(.a(new_n565_), .b(new_n355_), .O(new_n566_));
  nand2  g410(.a(new_n534_), .b(x038), .O(new_n567_));
  ...
  aoi21  g414(.a(new_n570_), .b(new_n557_), .c(x046), .O(z14));
  zero   g415(.O(z17));
  zero   g416(.O(z18));
  zero   g417(.O(z19));
  zero   g418(.O(z22));
