...
module FAU ( 
  ...
  aoi21  g310(.a(new_n458_), .b(new_n225_), .c(new_n466_), .O(new_n467_));
  ...
  nand2  g325(.a(new_n285_), .b(new_n284_), .O(new_n482_));
  nand2  g326(.a(new_n287_), .b(new_n280_), .O(new_n483_));
  ...
  nand3  g330(.a(new_n486_), .b(new_n287_), .c(x029), .O(new_n487_));
  ...
  oai21  g353(.a(new_n509_), .b(new_n502_), .c(new_n259_), .O(new_n510_));
  ...
  nand3  g357(.a(new_n273_), .b(x029), .c(new_n297_), .O(new_n514_));
  nand2  g358(.a(new_n514_), .b(new_n513_), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n287_), .O(new_n516_));
  nand2  g360(.a(new_n503_), .b(new_n273_), .O(new_n517_));
  ...
  nand2  g375(.a(new_n531_), .b(x038), .O(new_n532_));
  nand3  g376(.a(new_n532_), .b(x086), .c(x006), .O(new_n533_));
  nand2  g377(.a(x054), .b(x038), .O(new_n534_));
  nand3  g378(.a(x070), .b(new_n531_), .c(x022), .O(new_n535_));
  nand4  g379(.a(new_n535_), .b(new_n534_), .c(new_n533_), .d(new_n357_), .O(new_n536_));
  nand3  g380(.a(new_n536_), .b(x078), .c(new_n322_), .O(new_n537_));
