...
module FAU ( 
  ...
  oai21  g393(.a(new_n353_), .b(x022), .c(new_n332_), .O(new_n551_));
  and2   g394(.a(new_n551_), .b(x070), .O(new_n552_));
  oai21  g395(.a(x070), .b(x014), .c(x022), .O(new_n553_));
  nand4  g396(.a(new_n553_), .b(new_n544_), .c(new_n340_), .d(x030), .O(new_n554_));
  inv1   g397(.a(new_n554_), .O(new_n555_));
  oai21  g398(.a(new_n555_), .b(new_n552_), .c(new_n336_), .O(new_n556_));
  ...
  nand2  g403(.a(new_n551_), .b(new_n336_), .O(new_n561_));
  ...
  aoi21  g408(.a(new_n534_), .b(x038), .c(new_n331_), .O(new_n566_));
