...
module FAU ( 
  ...
  nand3  g062(.a(new_n218_), .b(new_n158_), .c(x042), .O(new_n219_));
  ...
  oai21  g166(.a(new_n322_), .b(new_n259_), .c(new_n160_), .O(z05));
  ...
  aoi21  g181(.a(new_n337_), .b(new_n330_), .c(new_n158_), .O(new_n338_));
  ...
  nand3  g210(.a(new_n158_), .b(new_n352_), .c(new_n346_), .O(new_n367_));
  ...
  aoi22  g226(.a(new_n382_), .b(new_n158_), .c(new_n380_), .d(new_n327_), .O(new_n383_));
  nand2  g227(.a(new_n383_), .b(new_n379_), .O(new_n384_));
  aoi21  g228(.a(new_n368_), .b(x054), .c(new_n384_), .O(new_n385_));
  oai21  g229(.a(new_n385_), .b(new_n324_), .c(new_n160_), .O(z06));
  ...
  oai21  g306(.a(new_n463_), .b(x042), .c(new_n160_), .O(z10));
  ...
  nand3  g320(.a(new_n477_), .b(new_n160_), .c(new_n465_), .O(new_n478_));
  ...
  oai21  g383(.a(new_n540_), .b(x045), .c(new_n160_), .O(z13));
