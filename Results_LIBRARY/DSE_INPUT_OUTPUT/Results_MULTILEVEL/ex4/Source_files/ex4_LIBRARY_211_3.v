// Benchmark "FAU" written by ABC on Tue Aug 18 02:19:30 2020
...
module FAU ( 
  ...
  nand4  g176(.a(new_n332_), .b(new_n329_), .c(new_n158_), .d(x014), .O(new_n333_));
  inv1   g177(.a(new_n333_), .O(new_n334_));
  aoi21  g178(.a(new_n334_), .b(new_n327_), .c(new_n157_), .O(z06));
  nand2  g179(.a(x064), .b(new_n177_), .O(new_n336_));
  aoi21  g180(.a(new_n336_), .b(new_n163_), .c(new_n169_), .O(new_n337_));
  nand2  g181(.a(x088), .b(x056), .O(new_n338_));
  nand3  g182(.a(new_n338_), .b(new_n162_), .c(x024), .O(new_n339_));
  aoi21  g183(.a(new_n339_), .b(new_n161_), .c(x080), .O(new_n340_));
  oai21  g184(.a(new_n340_), .b(new_n337_), .c(new_n178_), .O(new_n341_));
  nand2  g185(.a(new_n341_), .b(new_n165_), .O(new_n342_));
  oai21  g186(.a(x112), .b(x104), .c(new_n342_), .O(new_n343_));
  oai21  g187(.a(x032), .b(x008), .c(x016), .O(new_n344_));
  inv1   g188(.a(x024), .O(new_n345_));
  inv1   g189(.a(x056), .O(new_n346_));
  inv1   g190(.a(x088), .O(new_n347_));
  nand3  g191(.a(new_n347_), .b(new_n346_), .c(new_n345_), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(new_n344_), .O(new_n349_));
  oai22  g193(.a(new_n338_), .b(new_n161_), .c(x120), .d(x096), .O(new_n350_));
  nand2  g194(.a(new_n350_), .b(new_n349_), .O(new_n351_));
  nand2  g195(.a(new_n351_), .b(new_n162_), .O(new_n352_));
  nand2  g196(.a(x112), .b(x104), .O(new_n353_));
  nand3  g197(.a(new_n353_), .b(x120), .c(new_n161_), .O(new_n354_));
  nand3  g198(.a(x096), .b(x064), .c(new_n177_), .O(new_n355_));
  nand3  g199(.a(new_n355_), .b(new_n354_), .c(new_n164_), .O(new_n356_));
  inv1   g200(.a(new_n356_), .O(new_n357_));
  aoi21  g201(.a(new_n357_), .b(new_n352_), .c(new_n169_), .O(new_n358_));
  nor2   g202(.a(x088), .b(x056), .O(new_n359_));
  oai21  g203(.a(new_n345_), .b(x016), .c(new_n359_), .O(new_n360_));
  ...
  nand4  g208(.a(new_n364_), .b(new_n363_), .c(new_n338_), .d(x024), .O(new_n365_));
  aoi21  g209(.a(new_n365_), .b(new_n361_), .c(x080), .O(new_n366_));
  oai21  g210(.a(new_n366_), .b(new_n358_), .c(new_n178_), .O(new_n367_));
  nand3  g211(.a(x072), .b(x064), .c(x016), .O(new_n368_));
  nand3  g212(.a(new_n368_), .b(new_n367_), .c(new_n343_), .O(new_n369_));
  nand3  g213(.a(new_n164_), .b(x024), .c(new_n168_), .O(new_n370_));
  oai21  g214(.a(new_n362_), .b(new_n169_), .c(new_n370_), .O(new_n371_));
  nand2  g215(.a(new_n371_), .b(new_n162_), .O(new_n372_));
  nand2  g216(.a(new_n360_), .b(new_n164_), .O(new_n373_));
  aoi21  g217(.a(new_n373_), .b(new_n372_), .c(new_n177_), .O(new_n374_));
  aoi22  g218(.a(x080), .b(x000), .c(x064), .d(x016), .O(new_n375_));
  nand3  g219(.a(new_n173_), .b(x064), .c(x016), .O(new_n376_));
  oai21  g220(.a(new_n375_), .b(x008), .c(new_n376_), .O(new_n377_));
  oai21  g221(.a(new_n377_), .b(new_n374_), .c(new_n178_), .O(new_n378_));
  nand3  g222(.a(new_n173_), .b(x080), .c(x000), .O(new_n379_));
  nand2  g223(.a(new_n379_), .b(new_n168_), .O(new_n380_));
  aoi22  g224(.a(new_n380_), .b(x072), .c(x048), .d(x032), .O(new_n381_));
  nand2  g225(.a(new_n381_), .b(new_n378_), .O(new_n382_));
  aoi21  g226(.a(new_n369_), .b(new_n172_), .c(new_n382_), .O(new_n383_));
  nor3   g227(.a(new_n383_), .b(z07), .c(x040), .O(z08));
  inv1   g228(.a(x041), .O(new_n385_));
  nand2  g229(.a(x065), .b(x017), .O(new_n386_));
  nand3  g230(.a(x081), .b(new_n190_), .c(x001), .O(new_n387_));
  oai21  g231(.a(new_n386_), .b(new_n190_), .c(new_n387_), .O(new_n388_));
  nand2  g232(.a(new_n388_), .b(new_n189_), .O(new_n389_));
  nand3  g233(.a(x081), .b(x009), .c(x001), .O(new_n390_));
  oai21  g234(.a(new_n386_), .b(x009), .c(new_n390_), .O(new_n391_));
  oai21  g235(.a(new_n196_), .b(x033), .c(new_n391_), .O(new_n392_));
  nand2  g236(.a(x081), .b(x001), .O(new_n393_));
  aoi21  g237(.a(new_n393_), .b(new_n386_), .c(x073), .O(new_n394_));
  oai22  g238(.a(new_n197_), .b(new_n190_), .c(new_n196_), .d(new_n189_), .O(new_n395_));
  aoi21  g239(.a(new_n394_), .b(new_n190_), .c(new_n395_), .O(new_n396_));
  nand3  g240(.a(new_n396_), .b(new_n392_), .c(new_n389_), .O(new_n397_));
  nand3  g241(.a(new_n397_), .b(new_n160_), .c(new_n385_), .O(new_n398_));
  inv1   g242(.a(new_n398_), .O(z09));
  inv1   g243(.a(x042), .O(new_n400_));
  ...
  nand2  g247(.a(new_n403_), .b(new_n208_), .O(new_n404_));
  nand3  g248(.a(x082), .b(x010), .c(x002), .O(new_n405_));
  oai21  g249(.a(new_n401_), .b(x010), .c(new_n405_), .O(new_n406_));
  oai21  g250(.a(new_n215_), .b(x034), .c(new_n406_), .O(new_n407_));
  nand2  g251(.a(x082), .b(x002), .O(new_n408_));
  aoi21  g252(.a(new_n408_), .b(new_n401_), .c(x074), .O(new_n409_));
  oai22  g253(.a(new_n216_), .b(new_n209_), .c(new_n215_), .d(new_n208_), .O(new_n410_));
  aoi21  g254(.a(new_n409_), .b(new_n209_), .c(new_n410_), .O(new_n411_));
  nand3  g255(.a(new_n411_), .b(new_n407_), .c(new_n404_), .O(new_n412_));
  nand3  g256(.a(new_n412_), .b(new_n160_), .c(new_n400_), .O(new_n413_));
  ...
  nand3  g261(.a(x083), .b(x011), .c(x003), .O(new_n418_));
  oai21  g262(.a(new_n415_), .b(x011), .c(new_n418_), .O(new_n419_));
  oai21  g263(.a(new_n234_), .b(x035), .c(new_n419_), .O(new_n420_));
  nand2  g264(.a(x083), .b(x003), .O(new_n421_));
  aoi21  g265(.a(new_n421_), .b(new_n415_), .c(x075), .O(new_n422_));
  nand2  g266(.a(new_n422_), .b(new_n228_), .O(new_n423_));
  aoi22  g267(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n424_));
  nand3  g268(.a(new_n424_), .b(new_n423_), .c(new_n420_), .O(new_n425_));
  aoi21  g269(.a(new_n417_), .b(new_n227_), .c(new_n425_), .O(new_n426_));
  oai21  g270(.a(new_n426_), .b(x043), .c(new_n160_), .O(z11));
  nand2  g271(.a(x068), .b(x020), .O(new_n428_));
  nand3  g272(.a(x084), .b(new_n247_), .c(x004), .O(new_n429_));
  oai21  g273(.a(new_n428_), .b(new_n247_), .c(new_n429_), .O(new_n430_));
  nand3  g274(.a(x084), .b(x012), .c(x004), .O(new_n431_));
  oai21  g275(.a(new_n428_), .b(x012), .c(new_n431_), .O(new_n432_));
  oai21  g276(.a(new_n253_), .b(x036), .c(new_n432_), .O(new_n433_));
  nand2  g277(.a(x084), .b(x004), .O(new_n434_));
  aoi21  g278(.a(new_n434_), .b(new_n428_), .c(x076), .O(new_n435_));
  nand2  g279(.a(new_n435_), .b(new_n247_), .O(new_n436_));
  aoi22  g280(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n437_));
  nand3  g281(.a(new_n437_), .b(new_n436_), .c(new_n433_), .O(new_n438_));
  aoi21  g282(.a(new_n430_), .b(new_n246_), .c(new_n438_), .O(new_n439_));
  oai21  g283(.a(new_n439_), .b(x044), .c(new_n160_), .O(z12));
  nand2  g284(.a(new_n288_), .b(new_n282_), .O(new_n441_));
  nand2  g285(.a(x069), .b(new_n263_), .O(new_n442_));
  aoi21  g286(.a(new_n442_), .b(new_n441_), .c(new_n262_), .O(new_n443_));
  nand2  g287(.a(x093), .b(x061), .O(new_n444_));
  nand3  g288(.a(new_n444_), .b(new_n288_), .c(x029), .O(new_n445_));
  aoi21  g289(.a(new_n445_), .b(new_n282_), .c(x085), .O(new_n446_));
  oai21  g290(.a(new_n446_), .b(new_n443_), .c(new_n261_), .O(new_n447_));
  oai21  g291(.a(x085), .b(new_n298_), .c(new_n447_), .O(new_n448_));
  oai21  g292(.a(x117), .b(x109), .c(new_n448_), .O(new_n449_));
  oai21  g293(.a(x037), .b(x013), .c(x021), .O(new_n450_));
  oai21  g294(.a(new_n270_), .b(x029), .c(new_n450_), .O(new_n451_));
  inv1   g295(.a(x125), .O(new_n452_));
  nand2  g296(.a(new_n452_), .b(new_n289_), .O(new_n453_));
  oai21  g297(.a(new_n444_), .b(new_n282_), .c(new_n453_), .O(new_n454_));
  nand2  g298(.a(new_n454_), .b(new_n451_), .O(new_n455_));
  nand2  g299(.a(new_n455_), .b(new_n288_), .O(new_n456_));
  nand3  g300(.a(new_n260_), .b(x125), .c(new_n282_), .O(new_n457_));
  nand3  g301(.a(x101), .b(x069), .c(new_n263_), .O(new_n458_));
  nand3  g302(.a(new_n458_), .b(new_n457_), .c(new_n275_), .O(new_n459_));
  inv1   g303(.a(new_n459_), .O(new_n460_));
  aoi21  g304(.a(new_n460_), .b(new_n456_), .c(new_n262_), .O(new_n461_));
  oai21  g305(.a(new_n267_), .b(x021), .c(new_n283_), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(x069), .O(new_n463_));
  oai21  g307(.a(x069), .b(x013), .c(x021), .O(new_n464_));
  nand4  g308(.a(new_n464_), .b(new_n453_), .c(new_n444_), .d(x029), .O(new_n465_));
  aoi21  g309(.a(new_n465_), .b(new_n463_), .c(x085), .O(new_n466_));
  oai21  g310(.a(new_n466_), .b(new_n461_), .c(new_n261_), .O(new_n467_));
  nand3  g311(.a(x077), .b(x069), .c(x021), .O(new_n468_));
  nand3  g312(.a(new_n468_), .b(new_n467_), .c(new_n449_), .O(new_n469_));
  nand2  g313(.a(new_n453_), .b(x005), .O(new_n470_));
  nand3  g314(.a(new_n275_), .b(x029), .c(new_n298_), .O(new_n471_));
  nand2  g315(.a(new_n471_), .b(new_n470_), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n288_), .O(new_n473_));
  nand2  g317(.a(new_n462_), .b(new_n275_), .O(new_n474_));
  aoi21  g318(.a(new_n474_), .b(new_n473_), .c(new_n263_), .O(new_n475_));
  oai21  g319(.a(new_n275_), .b(new_n262_), .c(new_n264_), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(new_n298_), .O(new_n477_));
  nand2  g321(.a(new_n316_), .b(x037), .O(new_n478_));
  nand3  g322(.a(new_n478_), .b(x069), .c(x021), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(new_n477_), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(new_n475_), .c(new_n261_), .O(new_n481_));
  nand3  g325(.a(new_n478_), .b(x085), .c(x005), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n298_), .O(new_n483_));
  aoi22  g327(.a(new_n483_), .b(x077), .c(x053), .d(x037), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n481_), .O(new_n485_));
  aoi21  g329(.a(new_n469_), .b(new_n316_), .c(new_n485_), .O(new_n486_));
  oai21  g330(.a(new_n486_), .b(x045), .c(new_n160_), .O(z13));
  inv1   g331(.a(x014), .O(new_n488_));
  nand2  g332(.a(x070), .b(new_n325_), .O(new_n489_));
  nand2  g333(.a(new_n331_), .b(new_n330_), .O(new_n490_));
  aoi21  g334(.a(new_n490_), .b(new_n489_), .c(new_n323_), .O(new_n491_));
  nand2  g335(.a(x094), .b(x062), .O(new_n492_));
  nand3  g336(.a(new_n492_), .b(new_n331_), .c(x030), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n330_), .c(x086), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(new_n491_), .c(new_n158_), .O(new_n495_));
  oai21  g339(.a(x086), .b(new_n488_), .c(new_n495_), .O(new_n496_));
  oai21  g340(.a(x118), .b(x110), .c(new_n496_), .O(new_n497_));
  oai21  g341(.a(x038), .b(x014), .c(x022), .O(new_n498_));
  inv1   g342(.a(x030), .O(new_n499_));
  nor2   g343(.a(x094), .b(x062), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n499_), .O(new_n501_));
  nor2   g345(.a(x126), .b(x102), .O(new_n502_));
  inv1   g346(.a(new_n502_), .O(new_n503_));
  nand3  g347(.a(x094), .b(x062), .c(x022), .O(new_n504_));
  aoi22  g348(.a(new_n504_), .b(new_n503_), .c(new_n501_), .d(new_n498_), .O(new_n505_));
  nand2  g349(.a(x118), .b(x110), .O(new_n506_));
  nand3  g350(.a(new_n506_), .b(x126), .c(new_n330_), .O(new_n507_));
  nand3  g351(.a(x102), .b(x070), .c(new_n325_), .O(new_n508_));
  nand3  g352(.a(new_n508_), .b(new_n507_), .c(new_n324_), .O(new_n509_));
  inv1   g353(.a(new_n509_), .O(new_n510_));
  oai21  g354(.a(new_n505_), .b(x070), .c(new_n510_), .O(new_n511_));
  oai21  g355(.a(new_n499_), .b(x022), .c(new_n500_), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(x070), .O(new_n513_));
  oai21  g357(.a(x070), .b(x014), .c(x022), .O(new_n514_));
  nand4  g358(.a(new_n514_), .b(new_n503_), .c(new_n492_), .d(x030), .O(new_n515_));
  aoi21  g359(.a(new_n515_), .b(new_n513_), .c(x086), .O(new_n516_));
  aoi21  g360(.a(new_n511_), .b(x006), .c(new_n516_), .O(new_n517_));
  oai21  g361(.a(new_n517_), .b(x078), .c(new_n497_), .O(new_n518_));
  nand3  g362(.a(new_n324_), .b(x030), .c(new_n488_), .O(new_n519_));
  oai21  g363(.a(new_n502_), .b(new_n323_), .c(new_n519_), .O(new_n520_));
  nand2  g364(.a(new_n520_), .b(new_n331_), .O(new_n521_));
  nand2  g365(.a(new_n512_), .b(new_n324_), .O(new_n522_));
  aoi21  g366(.a(new_n522_), .b(new_n521_), .c(new_n325_), .O(new_n523_));
  aoi22  g367(.a(x086), .b(x006), .c(x070), .d(x022), .O(new_n524_));
  nand2  g368(.a(new_n328_), .b(x038), .O(new_n525_));
  nand3  g369(.a(new_n525_), .b(x070), .c(x022), .O(new_n526_));
  oai21  g370(.a(new_n524_), .b(x014), .c(new_n526_), .O(new_n527_));
  oai21  g371(.a(new_n527_), .b(new_n523_), .c(new_n158_), .O(new_n528_));
  oai21  g372(.a(new_n328_), .b(new_n325_), .c(new_n528_), .O(new_n529_));
  aoi21  g373(.a(new_n518_), .b(new_n328_), .c(new_n529_), .O(new_n530_));
  nand3  g374(.a(new_n525_), .b(x086), .c(x006), .O(new_n531_));
  aoi21  g375(.a(x054), .b(x038), .c(x014), .O(new_n532_));
  nand3  g376(.a(x070), .b(new_n328_), .c(x022), .O(new_n533_));
  nand4  g377(.a(new_n533_), .b(new_n532_), .c(new_n531_), .d(new_n157_), .O(new_n534_));
  nand2  g378(.a(new_n534_), .b(x078), .O(new_n535_));
  oai21  g379(.a(new_n530_), .b(x046), .c(new_n535_), .O(z14));
  zero   g380(.O(z16));
  zero   g381(.O(z19));
  zero   g382(.O(z20));
  zero   g383(.O(z22));
  ...
  zero   g386(.O(z26));
  zero   g387(.O(z27));
  nor2   g388(.a(new_n158_), .b(new_n157_), .O(z15));
  nor2   g389(.a(new_n158_), .b(new_n157_), .O(z17));
  nor2   g390(.a(new_n158_), .b(new_n157_), .O(z18));
  nor2   g391(.a(new_n158_), .b(new_n157_), .O(z21));
  nor2   g392(.a(new_n158_), .b(new_n157_), .O(z24));
endmodule
