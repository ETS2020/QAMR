...
module FAU ( 
  ...
  nor3   g225(.a(new_n382_), .b(z19), .c(x040), .O(z08));
  ...
  oai21  g238(.a(new_n395_), .b(x041), .c(new_n181_), .O(z09));
  ...
  oai21  g251(.a(new_n408_), .b(x042), .c(new_n181_), .O(z10));
  ...
  nand3  g265(.a(new_n422_), .b(new_n181_), .c(new_n410_), .O(new_n423_));
  ...
  nor3   g328(.a(new_n485_), .b(z19), .c(x045), .O(z13));
  ...
  nor2   g387(.a(new_n179_), .b(new_n178_), .O(z27));
endmodule
