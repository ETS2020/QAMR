...
module FAU ( 
  ...
  zero   g439(.O(z25));
  zero   g440(.O(z26));
  nor2   g441(.a(new_n157_), .b(x078), .O(z15));
  nor2   g442(.a(new_n157_), .b(x078), .O(z16));
  nor2   g443(.a(new_n157_), .b(x078), .O(z19));
  nor2   g444(.a(new_n157_), .b(x078), .O(z27));
endmodule
