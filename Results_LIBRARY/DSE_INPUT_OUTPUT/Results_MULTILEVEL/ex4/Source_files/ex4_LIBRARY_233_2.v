...
module FAU ( 
  ...
  nor2   g022(.a(x079), .b(new_n178_), .O(z15));
  ...
  nand2  g419(.a(new_n576_), .b(x079), .O(new_n577_));
  ...
  zero   g426(.O(z25));
  zero   g427(.O(z26));
  nor2   g428(.a(x079), .b(new_n178_), .O(z16));
  nor2   g429(.a(x079), .b(new_n178_), .O(z18));
  nor2   g430(.a(x079), .b(new_n178_), .O(z20));
  nor2   g431(.a(x079), .b(new_n178_), .O(z21));
  nor2   g432(.a(x079), .b(new_n178_), .O(z23));
  nor2   g433(.a(x079), .b(new_n178_), .O(z27));
endmodule
