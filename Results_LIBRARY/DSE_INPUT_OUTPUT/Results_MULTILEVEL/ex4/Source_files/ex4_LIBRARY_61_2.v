...
module FAU ( 
  ...
  nand3  g305(.a(new_n462_), .b(new_n159_), .c(new_n450_), .O(new_n463_));
  ...
  nand3  g320(.a(new_n477_), .b(new_n159_), .c(new_n465_), .O(new_n478_));
  ...
  zero   g420(.O(z24));
  zero   g421(.O(z25));
  nor2   g422(.a(x078), .b(new_n157_), .O(z16));
  nor2   g423(.a(x078), .b(new_n157_), .O(z18));
  nor2   g424(.a(x078), .b(new_n157_), .O(z20));
