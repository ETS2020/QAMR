...
module FAU ( 
  ...
  oai21  g164(.a(new_n320_), .b(new_n257_), .c(new_n179_), .O(z05));
  ...
  oai21  g229(.a(new_n385_), .b(new_n322_), .c(new_n179_), .O(z06));
  ...
  oai21  g278(.a(new_n434_), .b(x040), .c(new_n179_), .O(z08));
  ...
  oai21  g430(.a(new_n586_), .b(x046), .c(new_n179_), .O(z14));
  zero   g431(.O(z16));
  zero   g432(.O(z17));
  zero   g433(.O(z18));
  zero   g434(.O(z20));
  ...
  zero   g439(.O(z26));
  zero   g440(.O(z27));
  nor2   g441(.a(x078), .b(x077), .O(z15));
  nor2   g442(.a(x078), .b(x077), .O(z19));
  nor2   g443(.a(x078), .b(x077), .O(z24));
endmodule
