...
module FAU ( 
  ...
  nand2  g373(.a(x070), .b(new_n336_), .O(new_n530_));
  aoi21  g374(.a(new_n530_), .b(new_n361_), .c(new_n335_), .O(new_n531_));
  nand3  g375(.a(new_n338_), .b(new_n322_), .c(x030), .O(new_n532_));
  nor2   g376(.a(x022), .b(x014), .O(new_n533_));
  aoi21  g377(.a(new_n533_), .b(new_n532_), .c(x086), .O(new_n534_));
  oai21  g378(.a(new_n534_), .b(new_n531_), .c(new_n344_), .O(new_n535_));
  oai21  g379(.a(x038), .b(x014), .c(x022), .O(new_n536_));
  oai21  g380(.a(new_n328_), .b(x030), .c(new_n536_), .O(new_n537_));
  inv1   g381(.a(x102), .O(new_n538_));
  nand2  g382(.a(new_n343_), .b(new_n538_), .O(new_n539_));
  oai21  g383(.a(new_n338_), .b(new_n331_), .c(new_n539_), .O(new_n540_));
  aoi21  g384(.a(new_n540_), .b(new_n537_), .c(x070), .O(new_n541_));
  nand3  g385(.a(new_n320_), .b(x126), .c(new_n331_), .O(new_n542_));
  ...
  oai21  g389(.a(new_n326_), .b(x022), .c(new_n327_), .O(new_n546_));
  and2   g390(.a(new_n546_), .b(x070), .O(new_n547_));
  oai21  g391(.a(x070), .b(x014), .c(x022), .O(new_n548_));
  nand4  g392(.a(new_n548_), .b(new_n539_), .c(new_n338_), .d(x030), .O(new_n549_));
  ...
  nand3  g397(.a(new_n325_), .b(x030), .c(new_n330_), .O(new_n554_));
  aoi21  g398(.a(new_n554_), .b(new_n553_), .c(x070), .O(new_n555_));
  nand2  g399(.a(new_n546_), .b(new_n325_), .O(new_n556_));
  nand2  g400(.a(new_n556_), .b(new_n369_), .O(new_n557_));
  ...
  aoi21  g404(.a(new_n369_), .b(x038), .c(new_n322_), .O(new_n561_));
  aoi21  g405(.a(new_n561_), .b(x022), .c(new_n560_), .O(new_n562_));
  nand2  g406(.a(new_n562_), .b(new_n558_), .O(new_n563_));
  aoi21  g407(.a(new_n552_), .b(new_n369_), .c(new_n563_), .O(new_n564_));
  ...
  nor2   g421(.a(new_n178_), .b(x046), .O(z25));
endmodule
