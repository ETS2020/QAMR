...
module FAU ( 
  ...
  nor3   g163(.a(new_n319_), .b(z17), .c(new_n256_), .O(z05));
  ...
  oai21  g252(.a(new_n409_), .b(x042), .c(new_n157_), .O(z10));
  ...
  nand3  g266(.a(new_n423_), .b(new_n157_), .c(new_n411_), .O(new_n424_));
