...
module FAU ( 
  ...
  aoi21  g114(.a(new_n270_), .b(new_n265_), .c(new_n157_), .O(new_n271_));
  ...
  nand3  g144(.a(new_n157_), .b(new_n267_), .c(new_n266_), .O(new_n301_));
  ...
  aoi22  g159(.a(new_n315_), .b(new_n157_), .c(new_n313_), .d(new_n262_), .O(new_n316_));
  nand2  g160(.a(new_n316_), .b(new_n312_), .O(new_n317_));
  aoi21  g161(.a(new_n302_), .b(x053), .c(new_n317_), .O(new_n318_));
  oai21  g162(.a(new_n318_), .b(new_n259_), .c(new_n160_), .O(z05));
  inv1   g163(.a(x078), .O(new_n320_));
  inv1   g164(.a(x022), .O(new_n321_));
  inv1   g165(.a(x070), .O(new_n322_));
  nand3  g166(.a(new_n322_), .b(x054), .c(new_n321_), .O(new_n323_));
  inv1   g167(.a(x006), .O(new_n324_));
  inv1   g168(.a(x054), .O(new_n325_));
  inv1   g169(.a(x086), .O(new_n326_));
  nand3  g170(.a(new_n326_), .b(new_n325_), .c(new_n324_), .O(new_n327_));
  nand3  g171(.a(new_n327_), .b(new_n323_), .c(x014), .O(new_n328_));
  nand2  g172(.a(new_n328_), .b(new_n320_), .O(new_n329_));
  ...
  aoi22  g177(.a(new_n333_), .b(x030), .c(new_n330_), .d(new_n321_), .O(new_n334_));
  inv1   g178(.a(x102), .O(new_n335_));
  inv1   g179(.a(x118), .O(new_n336_));
  oai21  g180(.a(new_n336_), .b(new_n335_), .c(x022), .O(new_n337_));
  ...
  nand3  g185(.a(new_n341_), .b(new_n337_), .c(x110), .O(new_n342_));
  oai21  g186(.a(new_n342_), .b(new_n334_), .c(x070), .O(new_n343_));
  aoi21  g187(.a(x118), .b(x102), .c(x070), .O(new_n344_));
  oai21  g188(.a(new_n344_), .b(new_n158_), .c(x038), .O(new_n345_));
  inv1   g189(.a(x126), .O(new_n346_));
  nand2  g190(.a(x110), .b(x022), .O(new_n347_));
  nand2  g191(.a(x118), .b(new_n158_), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(new_n347_), .O(new_n349_));
  nand2  g193(.a(new_n349_), .b(new_n346_), .O(new_n350_));
  nand3  g194(.a(new_n350_), .b(new_n345_), .c(x086), .O(new_n351_));
  inv1   g195(.a(new_n351_), .O(new_n352_));
  aoi21  g196(.a(new_n352_), .b(new_n343_), .c(new_n320_), .O(new_n353_));
  inv1   g197(.a(x038), .O(new_n354_));
  oai22  g198(.a(x110), .b(x014), .c(x086), .d(new_n354_), .O(new_n355_));
  oai21  g199(.a(new_n355_), .b(new_n353_), .c(new_n324_), .O(new_n356_));
  nand2  g200(.a(x078), .b(new_n321_), .O(new_n357_));
  aoi22  g201(.a(new_n357_), .b(x014), .c(x118), .d(x110), .O(new_n358_));
  inv1   g202(.a(x030), .O(new_n359_));
  aoi21  g203(.a(x110), .b(new_n321_), .c(x070), .O(new_n360_));
  nand2  g204(.a(x070), .b(x014), .O(new_n361_));
  nand2  g205(.a(new_n361_), .b(new_n321_), .O(new_n362_));
  nand2  g206(.a(new_n362_), .b(new_n338_), .O(new_n363_));
  aoi21  g207(.a(new_n336_), .b(x070), .c(new_n158_), .O(new_n364_));
  aoi21  g208(.a(new_n364_), .b(new_n363_), .c(new_n339_), .O(new_n365_));
  oai21  g209(.a(new_n365_), .b(new_n360_), .c(new_n359_), .O(new_n366_));
  inv1   g210(.a(new_n333_), .O(new_n367_));
  nand2  g211(.a(new_n367_), .b(new_n322_), .O(new_n368_));
  aoi21  g212(.a(new_n368_), .b(new_n366_), .c(new_n320_), .O(new_n369_));
  oai21  g213(.a(new_n369_), .b(new_n358_), .c(x086), .O(new_n370_));
  nor2   g214(.a(x038), .b(x014), .O(new_n371_));
  inv1   g215(.a(new_n371_), .O(new_n372_));
  nand3  g216(.a(new_n372_), .b(new_n322_), .c(new_n321_), .O(new_n373_));
  nand3  g217(.a(new_n373_), .b(new_n370_), .c(new_n356_), .O(new_n374_));
  nand2  g218(.a(new_n374_), .b(x054), .O(new_n375_));
  nand3  g219(.a(x070), .b(new_n354_), .c(new_n359_), .O(new_n376_));
  nand3  g220(.a(x110), .b(x086), .c(x078), .O(new_n377_));
  oai21  g221(.a(new_n377_), .b(new_n376_), .c(new_n327_), .O(new_n378_));
  nand2  g222(.a(new_n378_), .b(x014), .O(new_n379_));
  nand3  g223(.a(new_n338_), .b(x070), .c(new_n324_), .O(new_n380_));
  inv1   g224(.a(new_n380_), .O(new_n381_));
  nand3  g225(.a(x110), .b(new_n359_), .c(x022), .O(new_n382_));
  nand3  g226(.a(new_n382_), .b(x094), .c(x062), .O(new_n383_));
  aoi21  g227(.a(new_n383_), .b(x086), .c(new_n381_), .O(new_n384_));
  oai21  g228(.a(new_n384_), .b(new_n320_), .c(x054), .O(new_n385_));
  nand2  g229(.a(new_n385_), .b(new_n354_), .O(new_n386_));
  nand4  g230(.a(x078), .b(new_n322_), .c(new_n325_), .d(new_n321_), .O(new_n387_));
  nand3  g231(.a(new_n387_), .b(new_n386_), .c(new_n379_), .O(new_n388_));
  inv1   g232(.a(new_n388_), .O(new_n389_));
  nand3  g233(.a(new_n389_), .b(new_n375_), .c(new_n329_), .O(new_n390_));
  nand2  g234(.a(new_n390_), .b(x046), .O(new_n391_));
  nand2  g235(.a(new_n391_), .b(new_n160_), .O(z06));
  ...
  or2    g249(.a(x120), .b(x096), .O(new_n406_));
  oai21  g250(.a(new_n395_), .b(new_n161_), .c(new_n406_), .O(new_n407_));
  nand2  g251(.a(new_n407_), .b(new_n405_), .O(new_n408_));
  nand2  g252(.a(x112), .b(x104), .O(new_n409_));
  nand3  g253(.a(new_n409_), .b(x120), .c(new_n161_), .O(new_n410_));
  nand3  g254(.a(x096), .b(x064), .c(new_n177_), .O(new_n411_));
  nand3  g255(.a(new_n411_), .b(new_n410_), .c(new_n164_), .O(new_n412_));
  aoi21  g256(.a(new_n408_), .b(new_n162_), .c(new_n412_), .O(new_n413_));
  nor2   g257(.a(new_n413_), .b(new_n169_), .O(new_n414_));
  oai21  g258(.a(new_n402_), .b(x016), .c(new_n403_), .O(new_n415_));
  nand2  g259(.a(new_n415_), .b(x064), .O(new_n416_));
  oai21  g260(.a(x064), .b(x008), .c(x016), .O(new_n417_));
  nand4  g261(.a(new_n417_), .b(new_n406_), .c(new_n395_), .d(x024), .O(new_n418_));
  aoi21  g262(.a(new_n418_), .b(new_n416_), .c(x080), .O(new_n419_));
  oai21  g263(.a(new_n419_), .b(new_n414_), .c(new_n178_), .O(new_n420_));
  nand3  g264(.a(x072), .b(x064), .c(x016), .O(new_n421_));
  nand3  g265(.a(new_n421_), .b(new_n420_), .c(new_n400_), .O(new_n422_));
  nand2  g266(.a(new_n406_), .b(x000), .O(new_n423_));
  nand3  g267(.a(new_n164_), .b(x024), .c(new_n168_), .O(new_n424_));
  nand2  g268(.a(new_n424_), .b(new_n423_), .O(new_n425_));
  nand2  g269(.a(new_n425_), .b(new_n162_), .O(new_n426_));
  nand2  g270(.a(new_n415_), .b(new_n164_), .O(new_n427_));
  aoi21  g271(.a(new_n427_), .b(new_n426_), .c(new_n177_), .O(new_n428_));
  aoi22  g272(.a(x080), .b(x000), .c(x064), .d(x016), .O(new_n429_));
  nand3  g273(.a(new_n173_), .b(x064), .c(x016), .O(new_n430_));
  oai21  g274(.a(new_n429_), .b(x008), .c(new_n430_), .O(new_n431_));
  oai21  g275(.a(new_n431_), .b(new_n428_), .c(new_n178_), .O(new_n432_));
  nand3  g276(.a(new_n173_), .b(x080), .c(x000), .O(new_n433_));
  nand2  g277(.a(new_n433_), .b(new_n168_), .O(new_n434_));
  aoi22  g278(.a(new_n434_), .b(x072), .c(x048), .d(x032), .O(new_n435_));
  nand2  g279(.a(new_n435_), .b(new_n432_), .O(new_n436_));
  aoi21  g280(.a(new_n422_), .b(new_n172_), .c(new_n436_), .O(new_n437_));
  oai21  g281(.a(new_n437_), .b(x040), .c(new_n160_), .O(z08));
  nand2  g282(.a(x065), .b(x017), .O(new_n439_));
  nand3  g283(.a(x081), .b(new_n190_), .c(x001), .O(new_n440_));
  oai21  g284(.a(new_n439_), .b(new_n190_), .c(new_n440_), .O(new_n441_));
  nand3  g285(.a(x081), .b(x009), .c(x001), .O(new_n442_));
  oai21  g286(.a(new_n439_), .b(x009), .c(new_n442_), .O(new_n443_));
  oai21  g287(.a(new_n196_), .b(x033), .c(new_n443_), .O(new_n444_));
  nand2  g288(.a(x081), .b(x001), .O(new_n445_));
  aoi21  g289(.a(new_n445_), .b(new_n439_), .c(x073), .O(new_n446_));
  nand2  g290(.a(new_n446_), .b(new_n190_), .O(new_n447_));
  aoi22  g291(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n448_));
  nand3  g292(.a(new_n448_), .b(new_n447_), .c(new_n444_), .O(new_n449_));
  aoi21  g293(.a(new_n441_), .b(new_n189_), .c(new_n449_), .O(new_n450_));
  oai21  g294(.a(new_n450_), .b(x041), .c(new_n160_), .O(z09));
  inv1   g295(.a(x042), .O(new_n452_));
  nand2  g296(.a(x066), .b(x018), .O(new_n453_));
  nand3  g297(.a(x082), .b(new_n209_), .c(x002), .O(new_n454_));
  oai21  g298(.a(new_n453_), .b(new_n209_), .c(new_n454_), .O(new_n455_));
  nand2  g299(.a(new_n455_), .b(new_n208_), .O(new_n456_));
  nand3  g300(.a(x082), .b(x010), .c(x002), .O(new_n457_));
  oai21  g301(.a(new_n453_), .b(x010), .c(new_n457_), .O(new_n458_));
  oai21  g302(.a(new_n215_), .b(x034), .c(new_n458_), .O(new_n459_));
  nand2  g303(.a(x082), .b(x002), .O(new_n460_));
  aoi21  g304(.a(new_n460_), .b(new_n453_), .c(x074), .O(new_n461_));
  oai22  g305(.a(new_n216_), .b(new_n209_), .c(new_n215_), .d(new_n208_), .O(new_n462_));
  aoi21  g306(.a(new_n461_), .b(new_n209_), .c(new_n462_), .O(new_n463_));
  nand3  g307(.a(new_n463_), .b(new_n459_), .c(new_n456_), .O(new_n464_));
  nand3  g308(.a(new_n464_), .b(new_n160_), .c(new_n452_), .O(new_n465_));
  inv1   g309(.a(new_n465_), .O(z10));
  nand2  g310(.a(x067), .b(x019), .O(new_n467_));
  nand3  g311(.a(x083), .b(new_n228_), .c(x003), .O(new_n468_));
  oai21  g312(.a(new_n467_), .b(new_n228_), .c(new_n468_), .O(new_n469_));
  nand3  g313(.a(x083), .b(x011), .c(x003), .O(new_n470_));
  oai21  g314(.a(new_n467_), .b(x011), .c(new_n470_), .O(new_n471_));
  oai21  g315(.a(new_n234_), .b(x035), .c(new_n471_), .O(new_n472_));
  nand2  g316(.a(x083), .b(x003), .O(new_n473_));
  aoi21  g317(.a(new_n473_), .b(new_n467_), .c(x075), .O(new_n474_));
  nand2  g318(.a(new_n474_), .b(new_n228_), .O(new_n475_));
  aoi22  g319(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n476_));
  nand3  g320(.a(new_n476_), .b(new_n475_), .c(new_n472_), .O(new_n477_));
  aoi21  g321(.a(new_n469_), .b(new_n227_), .c(new_n477_), .O(new_n478_));
  oai21  g322(.a(new_n478_), .b(x043), .c(new_n160_), .O(z11));
  inv1   g323(.a(x044), .O(new_n480_));
  nand2  g324(.a(x068), .b(x020), .O(new_n481_));
  nand3  g325(.a(x084), .b(new_n247_), .c(x004), .O(new_n482_));
  oai21  g326(.a(new_n481_), .b(new_n247_), .c(new_n482_), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(new_n246_), .O(new_n484_));
  nand3  g328(.a(x084), .b(x012), .c(x004), .O(new_n485_));
  oai21  g329(.a(new_n481_), .b(x012), .c(new_n485_), .O(new_n486_));
  oai21  g330(.a(new_n253_), .b(x036), .c(new_n486_), .O(new_n487_));
  nand2  g331(.a(x084), .b(x004), .O(new_n488_));
  aoi21  g332(.a(new_n488_), .b(new_n481_), .c(x076), .O(new_n489_));
  oai22  g333(.a(new_n254_), .b(new_n247_), .c(new_n253_), .d(new_n246_), .O(new_n490_));
  aoi21  g334(.a(new_n489_), .b(new_n247_), .c(new_n490_), .O(new_n491_));
  nand3  g335(.a(new_n491_), .b(new_n487_), .c(new_n484_), .O(new_n492_));
  nand3  g336(.a(new_n492_), .b(new_n160_), .c(new_n480_), .O(new_n493_));
  inv1   g337(.a(new_n493_), .O(z12));
  nand2  g338(.a(new_n267_), .b(new_n266_), .O(new_n495_));
  nand2  g339(.a(x069), .b(new_n262_), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n495_), .c(new_n261_), .O(new_n497_));
  nand3  g341(.a(new_n276_), .b(new_n267_), .c(x029), .O(new_n498_));
  nor2   g342(.a(x021), .b(x013), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n498_), .c(x085), .O(new_n500_));
  oai22  g344(.a(new_n500_), .b(new_n497_), .c(x117), .d(x109), .O(new_n501_));
  oai21  g345(.a(x037), .b(x013), .c(x021), .O(new_n502_));
  oai21  g346(.a(new_n294_), .b(x029), .c(new_n502_), .O(new_n503_));
  nand2  g347(.a(new_n280_), .b(new_n279_), .O(new_n504_));
  oai21  g348(.a(new_n276_), .b(new_n266_), .c(new_n504_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n503_), .c(x069), .O(new_n506_));
  nand3  g350(.a(new_n260_), .b(x125), .c(new_n266_), .O(new_n507_));
  ...
  and2   g355(.a(new_n511_), .b(x069), .O(new_n512_));
  oai21  g356(.a(x069), .b(x013), .c(x021), .O(new_n513_));
  nand4  g357(.a(new_n513_), .b(new_n504_), .c(new_n276_), .d(x029), .O(new_n514_));
  inv1   g358(.a(new_n514_), .O(new_n515_));
  oai21  g359(.a(new_n515_), .b(new_n512_), .c(new_n272_), .O(new_n516_));
  nand3  g360(.a(new_n516_), .b(new_n510_), .c(new_n501_), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n313_), .O(new_n518_));
  nand2  g362(.a(new_n504_), .b(x005), .O(new_n519_));
  nand3  g363(.a(new_n272_), .b(x029), .c(new_n296_), .O(new_n520_));
  aoi21  g364(.a(new_n520_), .b(new_n519_), .c(x069), .O(new_n521_));
  nand2  g365(.a(new_n511_), .b(new_n272_), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n313_), .O(new_n523_));
  oai21  g367(.a(new_n523_), .b(new_n521_), .c(x037), .O(new_n524_));
  ...
  nand4  g372(.a(new_n528_), .b(new_n526_), .c(new_n524_), .d(new_n518_), .O(new_n529_));
  nand2  g373(.a(new_n529_), .b(new_n157_), .O(new_n530_));
  nand3  g374(.a(new_n527_), .b(x085), .c(x005), .O(new_n531_));
  nand3  g375(.a(x069), .b(new_n313_), .c(x021), .O(new_n532_));
  nand3  g376(.a(new_n532_), .b(new_n531_), .c(new_n296_), .O(new_n533_));
  nand2  g377(.a(new_n533_), .b(x077), .O(new_n534_));
  oai21  g378(.a(new_n313_), .b(new_n262_), .c(new_n534_), .O(new_n535_));
  nand2  g379(.a(new_n535_), .b(new_n158_), .O(new_n536_));
  aoi21  g380(.a(new_n536_), .b(new_n530_), .c(x045), .O(z13));
  oai21  g381(.a(new_n158_), .b(x077), .c(new_n348_), .O(new_n538_));
  nand3  g382(.a(new_n367_), .b(new_n322_), .c(x030), .O(new_n539_));
  aoi21  g383(.a(new_n539_), .b(new_n321_), .c(x078), .O(new_n540_));
  oai21  g384(.a(new_n540_), .b(x014), .c(new_n538_), .O(new_n541_));
  nor2   g385(.a(z07), .b(new_n359_), .O(new_n542_));
  nor2   g386(.a(new_n339_), .b(x077), .O(new_n543_));
  oai21  g387(.a(new_n543_), .b(new_n542_), .c(new_n321_), .O(new_n544_));
  nand2  g388(.a(new_n340_), .b(new_n158_), .O(new_n545_));
  aoi21  g389(.a(new_n545_), .b(new_n544_), .c(new_n322_), .O(new_n546_));
  nand2  g390(.a(new_n346_), .b(new_n335_), .O(new_n547_));
  oai21  g391(.a(x070), .b(x014), .c(x022), .O(new_n548_));
  nand4  g392(.a(new_n548_), .b(new_n547_), .c(new_n367_), .d(new_n158_), .O(new_n549_));
  nor2   g393(.a(new_n549_), .b(new_n359_), .O(new_n550_));
  oai21  g394(.a(new_n550_), .b(new_n546_), .c(new_n320_), .O(new_n551_));
  aoi21  g395(.a(new_n551_), .b(new_n541_), .c(x086), .O(new_n552_));
  nand3  g396(.a(new_n160_), .b(x078), .c(x022), .O(new_n553_));
  nor2   g397(.a(x118), .b(x102), .O(new_n554_));
  nor3   g398(.a(new_n554_), .b(x110), .c(x038), .O(new_n555_));
  nand3  g399(.a(x126), .b(new_n336_), .c(new_n321_), .O(new_n556_));
  aoi21  g400(.a(new_n556_), .b(new_n326_), .c(x077), .O(new_n557_));
  oai21  g401(.a(new_n557_), .b(new_n555_), .c(new_n320_), .O(new_n558_));
  oai21  g402(.a(new_n558_), .b(new_n324_), .c(new_n553_), .O(new_n559_));
  nand2  g403(.a(new_n559_), .b(x070), .O(new_n560_));
  oai22  g404(.a(new_n371_), .b(new_n321_), .c(new_n340_), .d(x030), .O(new_n561_));
  oai21  g405(.a(x118), .b(x102), .c(new_n321_), .O(new_n562_));
  nand2  g406(.a(new_n547_), .b(new_n367_), .O(new_n563_));
  nand3  g407(.a(new_n563_), .b(new_n562_), .c(new_n561_), .O(new_n564_));
  oai21  g408(.a(new_n346_), .b(x022), .c(new_n326_), .O(new_n565_));
  aoi21  g409(.a(new_n564_), .b(new_n322_), .c(new_n565_), .O(new_n566_));
  oai21  g410(.a(x038), .b(x022), .c(x070), .O(new_n567_));
  nand3  g411(.a(new_n567_), .b(x110), .c(new_n157_), .O(new_n568_));
  oai21  g412(.a(new_n566_), .b(x110), .c(new_n568_), .O(new_n569_));
  nand3  g413(.a(new_n569_), .b(new_n320_), .c(x006), .O(new_n570_));
  nand2  g414(.a(new_n570_), .b(new_n560_), .O(new_n571_));
  oai21  g415(.a(new_n571_), .b(new_n552_), .c(new_n325_), .O(new_n572_));
  inv1   g416(.a(x014), .O(new_n573_));
  nand2  g417(.a(new_n325_), .b(x038), .O(new_n574_));
  nand3  g418(.a(new_n574_), .b(x086), .c(x006), .O(new_n575_));
  nand2  g419(.a(new_n575_), .b(new_n573_), .O(new_n576_));
  nand2  g420(.a(new_n576_), .b(x078), .O(new_n577_));
  nand3  g421(.a(new_n320_), .b(x070), .c(x022), .O(new_n578_));
  nand2  g422(.a(new_n578_), .b(new_n354_), .O(new_n579_));
  nand2  g423(.a(new_n579_), .b(x054), .O(new_n580_));
  aoi21  g424(.a(new_n580_), .b(new_n577_), .c(z07), .O(new_n581_));
  nand3  g425(.a(new_n330_), .b(x070), .c(x022), .O(new_n582_));
  nand4  g426(.a(new_n326_), .b(new_n322_), .c(x038), .d(x030), .O(new_n583_));
  oai21  g427(.a(new_n326_), .b(new_n324_), .c(new_n583_), .O(new_n584_));
  nand2  g428(.a(new_n584_), .b(new_n573_), .O(new_n585_));
  nand2  g429(.a(new_n547_), .b(new_n322_), .O(new_n586_));
  nor2   g430(.a(new_n586_), .b(new_n324_), .O(new_n587_));
  nand2  g431(.a(x030), .b(new_n321_), .O(new_n588_));
  aoi21  g432(.a(new_n588_), .b(new_n339_), .c(x086), .O(new_n589_));
  oai21  g433(.a(new_n589_), .b(new_n587_), .c(x038), .O(new_n590_));
  nand3  g434(.a(new_n590_), .b(new_n585_), .c(new_n582_), .O(new_n591_));
  nand4  g435(.a(new_n330_), .b(x086), .c(x070), .d(x022), .O(new_n592_));
  nand4  g436(.a(new_n340_), .b(new_n326_), .c(new_n322_), .d(x038), .O(new_n593_));
  aoi21  g437(.a(new_n593_), .b(new_n592_), .c(x077), .O(new_n594_));
  aoi21  g438(.a(new_n591_), .b(new_n158_), .c(new_n594_), .O(new_n595_));
  nor2   g439(.a(x014), .b(new_n324_), .O(new_n596_));
  nand4  g440(.a(new_n596_), .b(x086), .c(new_n157_), .d(x054), .O(new_n597_));
  oai21  g441(.a(new_n595_), .b(x078), .c(new_n597_), .O(new_n598_));
  nor2   g442(.a(new_n598_), .b(new_n581_), .O(new_n599_));
  aoi21  g443(.a(new_n599_), .b(new_n572_), .c(x046), .O(z14));
  zero   g444(.O(z15));
  zero   g445(.O(z16));
  zero   g446(.O(z19));
  zero   g447(.O(z20));
  ...
  zero   g450(.O(z25));
  zero   g451(.O(z26));
  nor2   g452(.a(new_n158_), .b(new_n157_), .O(z17));
  nor2   g453(.a(new_n158_), .b(new_n157_), .O(z18));
  nor2   g454(.a(new_n158_), .b(new_n157_), .O(z21));
  nor2   g455(.a(new_n158_), .b(new_n157_), .O(z23));
  nor2   g456(.a(new_n158_), .b(new_n157_), .O(z27));
endmodule
