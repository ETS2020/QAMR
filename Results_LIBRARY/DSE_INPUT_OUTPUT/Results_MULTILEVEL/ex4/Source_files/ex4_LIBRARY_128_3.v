...
module FAU ( 
  ...
  nor3   g163(.a(new_n319_), .b(z20), .c(new_n256_), .O(z05));
  ...
  oai21  g254(.a(new_n411_), .b(x042), .c(new_n178_), .O(z10));
  ...
  nand3  g281(.a(new_n438_), .b(new_n178_), .c(new_n426_), .O(new_n439_));
