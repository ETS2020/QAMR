...
module FAU ( 
  ...
  oai21  g187(.a(new_n343_), .b(new_n331_), .c(new_n342_), .O(new_n344_));
  ...
  inv1   g384(.a(x054), .O(new_n541_));
  nand3  g385(.a(x070), .b(new_n541_), .c(new_n323_), .O(new_n542_));
  nand2  g386(.a(new_n542_), .b(x078), .O(new_n543_));
  nand2  g387(.a(new_n543_), .b(x022), .O(new_n544_));
  inv1   g388(.a(x078), .O(new_n545_));
  nand3  g389(.a(x086), .b(x054), .c(x006), .O(new_n546_));
  aoi21  g390(.a(new_n546_), .b(new_n336_), .c(new_n545_), .O(new_n547_));
  oai21  g391(.a(new_n327_), .b(new_n341_), .c(x006), .O(new_n548_));
  nand3  g392(.a(new_n343_), .b(new_n330_), .c(x030), .O(new_n549_));
  aoi21  g393(.a(new_n549_), .b(new_n548_), .c(x078), .O(new_n550_));
  nor2   g394(.a(x086), .b(new_n336_), .O(new_n551_));
  oai21  g395(.a(new_n551_), .b(new_n550_), .c(new_n349_), .O(new_n552_));
  nor2   g396(.a(x038), .b(new_n340_), .O(new_n553_));
  nor2   g397(.a(x086), .b(new_n327_), .O(new_n554_));
  nand3  g398(.a(new_n333_), .b(new_n332_), .c(new_n331_), .O(new_n555_));
  oai21  g399(.a(new_n554_), .b(new_n553_), .c(new_n555_), .O(new_n556_));
  inv1   g400(.a(new_n549_), .O(new_n557_));
  oai22  g401(.a(new_n553_), .b(new_n557_), .c(x126), .d(x102), .O(new_n558_));
  aoi21  g402(.a(x118), .b(x110), .c(new_n348_), .O(new_n559_));
  inv1   g403(.a(x102), .O(new_n560_));
  oai21  g404(.a(new_n560_), .b(x070), .c(new_n330_), .O(new_n561_));
  oai21  g405(.a(new_n561_), .b(new_n559_), .c(x006), .O(new_n562_));
  nand3  g406(.a(new_n562_), .b(new_n558_), .c(new_n556_), .O(new_n563_));
  nand2  g407(.a(new_n563_), .b(new_n545_), .O(new_n564_));
  nand3  g408(.a(x086), .b(new_n341_), .c(x006), .O(new_n565_));
  nand3  g409(.a(new_n565_), .b(new_n564_), .c(new_n552_), .O(new_n566_));
  nand2  g410(.a(new_n566_), .b(new_n541_), .O(new_n567_));
  nand3  g411(.a(x086), .b(new_n336_), .c(x006), .O(new_n568_));
  aoi21  g412(.a(new_n568_), .b(new_n341_), .c(new_n541_), .O(new_n569_));
  nand3  g413(.a(new_n555_), .b(new_n330_), .c(new_n545_), .O(new_n570_));
  inv1   g414(.a(new_n570_), .O(new_n571_));
  aoi21  g415(.a(new_n571_), .b(x038), .c(new_n569_), .O(new_n572_));
  nand2  g416(.a(new_n572_), .b(new_n567_), .O(new_n573_));
  oai21  g417(.a(new_n573_), .b(new_n547_), .c(new_n323_), .O(new_n574_));
  nand2  g418(.a(new_n574_), .b(new_n544_), .O(z14));
  zero   g419(.O(z15));
  zero   g420(.O(z23));
  zero   g421(.O(z24));
  zero   g422(.O(z26));
  nor2   g423(.a(x078), .b(new_n157_), .O(z16));
  nor2   g424(.a(x078), .b(new_n157_), .O(z17));
  nor2   g425(.a(x078), .b(new_n157_), .O(z18));
  nor2   g426(.a(x078), .b(new_n157_), .O(z19));
  nor2   g427(.a(x078), .b(new_n157_), .O(z20));
  nor2   g428(.a(x078), .b(new_n157_), .O(z21));
  nor2   g429(.a(x078), .b(new_n157_), .O(z22));
  nor2   g430(.a(x078), .b(new_n157_), .O(z25));
  nor2   g431(.a(x078), .b(new_n157_), .O(z27));
endmodule
