...
module FAU ( 
  ...
  nor3   g224(.a(new_n380_), .b(z07), .c(new_n317_), .O(z06));
  ...
  nand2  g333(.a(new_n297_), .b(x037), .O(new_n490_));
  nand3  g334(.a(new_n490_), .b(x085), .c(x005), .O(new_n491_));
  nand2  g335(.a(x053), .b(x037), .O(new_n492_));
  nand3  g336(.a(x069), .b(new_n297_), .c(x021), .O(new_n493_));
  nand4  g337(.a(new_n493_), .b(new_n492_), .c(new_n491_), .d(new_n269_), .O(new_n494_));
  nand3  g338(.a(new_n494_), .b(x077), .c(new_n489_), .O(new_n495_));
  inv1   g339(.a(new_n495_), .O(z13));
  nand2  g340(.a(new_n345_), .b(new_n344_), .O(new_n497_));
  nand2  g341(.a(new_n347_), .b(new_n340_), .O(new_n498_));
  nand2  g342(.a(x070), .b(new_n321_), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n498_), .c(new_n320_), .O(new_n500_));
  nand2  g344(.a(x094), .b(x062), .O(new_n501_));
  nand3  g345(.a(new_n501_), .b(new_n347_), .c(x030), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n340_), .c(x086), .O(new_n503_));
  oai21  g347(.a(new_n503_), .b(new_n500_), .c(new_n319_), .O(new_n504_));
  oai21  g348(.a(x086), .b(new_n357_), .c(new_n504_), .O(new_n505_));
  nand2  g349(.a(new_n505_), .b(new_n497_), .O(new_n506_));
  oai21  g350(.a(x038), .b(x014), .c(x022), .O(new_n507_));
  nand3  g351(.a(new_n327_), .b(new_n326_), .c(new_n325_), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n507_), .O(new_n509_));
  oai22  g353(.a(new_n501_), .b(new_n340_), .c(x126), .d(x102), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n509_), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n347_), .O(new_n512_));
  nand3  g356(.a(new_n318_), .b(x126), .c(new_n340_), .O(new_n513_));
  nand3  g357(.a(x102), .b(x070), .c(new_n321_), .O(new_n514_));
  nand3  g358(.a(new_n514_), .b(new_n513_), .c(new_n333_), .O(new_n515_));
  inv1   g359(.a(new_n515_), .O(new_n516_));
  aoi21  g360(.a(new_n516_), .b(new_n512_), .c(new_n320_), .O(new_n517_));
  oai21  g361(.a(new_n325_), .b(x022), .c(new_n341_), .O(new_n518_));
  nand2  g362(.a(new_n518_), .b(x070), .O(new_n519_));
  inv1   g363(.a(x126), .O(new_n520_));
  nand2  g364(.a(new_n520_), .b(new_n348_), .O(new_n521_));
  oai21  g365(.a(x070), .b(x014), .c(x022), .O(new_n522_));
  nand4  g366(.a(new_n522_), .b(new_n521_), .c(new_n501_), .d(x030), .O(new_n523_));
  aoi21  g367(.a(new_n523_), .b(new_n519_), .c(x086), .O(new_n524_));
  oai21  g368(.a(new_n524_), .b(new_n517_), .c(new_n319_), .O(new_n525_));
  nand3  g369(.a(x078), .b(x070), .c(x022), .O(new_n526_));
  nand3  g370(.a(new_n526_), .b(new_n525_), .c(new_n506_), .O(new_n527_));
  nand2  g371(.a(new_n521_), .b(x006), .O(new_n528_));
  nand3  g372(.a(new_n333_), .b(x030), .c(new_n357_), .O(new_n529_));
  nand2  g373(.a(new_n529_), .b(new_n528_), .O(new_n530_));
  nand2  g374(.a(new_n530_), .b(new_n347_), .O(new_n531_));
  nand2  g375(.a(new_n518_), .b(new_n333_), .O(new_n532_));
  aoi21  g376(.a(new_n532_), .b(new_n531_), .c(new_n321_), .O(new_n533_));
  oai21  g377(.a(new_n333_), .b(new_n320_), .c(new_n322_), .O(new_n534_));
  nand2  g378(.a(new_n534_), .b(new_n357_), .O(new_n535_));
  nand2  g379(.a(new_n375_), .b(x038), .O(new_n536_));
  nand3  g380(.a(new_n536_), .b(x070), .c(x022), .O(new_n537_));
  nand2  g381(.a(new_n537_), .b(new_n535_), .O(new_n538_));
  oai21  g382(.a(new_n538_), .b(new_n533_), .c(new_n319_), .O(new_n539_));
  nand3  g383(.a(new_n536_), .b(x086), .c(x006), .O(new_n540_));
  nand2  g384(.a(new_n540_), .b(new_n357_), .O(new_n541_));
  aoi22  g385(.a(new_n541_), .b(x078), .c(x054), .d(x038), .O(new_n542_));
  nand2  g386(.a(new_n542_), .b(new_n539_), .O(new_n543_));
  aoi21  g387(.a(new_n527_), .b(new_n375_), .c(new_n543_), .O(new_n544_));
  nor3   g388(.a(new_n544_), .b(z07), .c(x046), .O(z14));
  zero   g389(.O(z15));
  zero   g390(.O(z21));
  zero   g391(.O(z22));
  zero   g392(.O(z23));
  zero   g393(.O(z24));
  zero   g394(.O(z25));
  nor2   g395(.a(x077), .b(x045), .O(z16));
  nor2   g396(.a(x077), .b(x045), .O(z17));
  nor2   g397(.a(x077), .b(x045), .O(z18));
  nor2   g398(.a(x077), .b(x045), .O(z19));
  nor2   g399(.a(x077), .b(x045), .O(z20));
