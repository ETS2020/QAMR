...
module FAU ( 
  ...
  nand2  g022(.a(x087), .b(new_n178_), .O(new_n179_));
  ...
  nand3  g206(.a(new_n178_), .b(new_n328_), .c(new_n327_), .O(new_n363_));
  ...
  aoi22  g221(.a(new_n377_), .b(new_n178_), .c(new_n375_), .d(new_n323_), .O(new_n378_));
  ...
  nand2  g372(.a(new_n328_), .b(new_n327_), .O(new_n529_));
  nand2  g373(.a(x070), .b(new_n323_), .O(new_n530_));
  aoi21  g374(.a(new_n530_), .b(new_n529_), .c(new_n322_), .O(new_n531_));
  nand3  g375(.a(new_n337_), .b(new_n328_), .c(x030), .O(new_n532_));
  aoi21  g376(.a(new_n532_), .b(new_n327_), .c(x086), .O(new_n533_));
  oai21  g377(.a(new_n533_), .b(new_n531_), .c(new_n178_), .O(new_n534_));
  oai21  g378(.a(x086), .b(new_n358_), .c(new_n534_), .O(new_n535_));
  oai21  g379(.a(x118), .b(x110), .c(new_n535_), .O(new_n536_));
  oai21  g380(.a(x038), .b(x014), .c(x022), .O(new_n537_));
  oai21  g381(.a(new_n356_), .b(x030), .c(new_n537_), .O(new_n538_));
  ...
  nand2  g385(.a(new_n541_), .b(new_n328_), .O(new_n542_));
  ...
  aoi21  g390(.a(new_n546_), .b(new_n542_), .c(new_n322_), .O(new_n547_));
  oai21  g391(.a(new_n353_), .b(x022), .c(new_n329_), .O(new_n548_));
  nand2  g392(.a(new_n548_), .b(x070), .O(new_n549_));
  oai21  g393(.a(x070), .b(x014), .c(x022), .O(new_n550_));
  nand4  g394(.a(new_n550_), .b(new_n539_), .c(new_n337_), .d(x030), .O(new_n551_));
  ...
  nand2  g403(.a(new_n548_), .b(new_n333_), .O(new_n560_));
  aoi21  g404(.a(new_n560_), .b(new_n559_), .c(new_n323_), .O(new_n561_));
  oai21  g405(.a(new_n333_), .b(new_n322_), .c(new_n324_), .O(new_n562_));
  nand2  g406(.a(new_n562_), .b(new_n358_), .O(new_n563_));
  nand2  g407(.a(new_n375_), .b(x038), .O(new_n564_));
  ...
  aoi21  g415(.a(new_n555_), .b(new_n375_), .c(new_n571_), .O(new_n572_));
  ...
  inv1   g423(.a(new_n179_), .O(z18));
  inv1   g424(.a(new_n179_), .O(z19));
  inv1   g425(.a(new_n179_), .O(z20));
  inv1   g426(.a(new_n179_), .O(z22));
  inv1   g427(.a(new_n179_), .O(z24));
  inv1   g428(.a(new_n179_), .O(z25));
  inv1   g429(.a(new_n179_), .O(z27));
endmodule
