...
module FAU ( 
  ...
  nand3  g329(.a(new_n485_), .b(new_n159_), .c(new_n473_), .O(new_n486_));
  ...
  zero   g422(.O(z25));
  zero   g423(.O(z26));
  nor2   g424(.a(new_n157_), .b(x046), .O(z15));
  nor2   g425(.a(new_n157_), .b(x046), .O(z16));
  nor2   g426(.a(new_n157_), .b(x046), .O(z18));
  nor2   g427(.a(new_n157_), .b(x046), .O(z19));
  nor2   g428(.a(new_n157_), .b(x046), .O(z23));
