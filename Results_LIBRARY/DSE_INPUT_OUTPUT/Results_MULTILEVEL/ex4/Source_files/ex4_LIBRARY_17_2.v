// Benchmark "FAU" written by ABC on Tue Aug 18 02:18:07 2020
...
module FAU ( 
  ...
  aoi21  g177(.a(new_n333_), .b(new_n332_), .c(x126), .O(new_n334_));
  nand3  g178(.a(new_n327_), .b(new_n315_), .c(x038), .O(new_n335_));
  nand2  g179(.a(new_n335_), .b(x086), .O(new_n336_));
  aoi21  g180(.a(new_n334_), .b(x022), .c(new_n336_), .O(new_n337_));
  aoi21  g181(.a(new_n337_), .b(new_n331_), .c(x006), .O(new_n338_));
  oai21  g182(.a(x030), .b(new_n314_), .c(new_n325_), .O(new_n339_));
  nand2  g183(.a(new_n339_), .b(new_n315_), .O(new_n340_));
  inv1   g184(.a(x030), .O(new_n341_));
  inv1   g185(.a(new_n316_), .O(new_n342_));
  inv1   g186(.a(new_n329_), .O(new_n343_));
  inv1   g187(.a(x014), .O(new_n344_));
  oai21  g188(.a(new_n315_), .b(new_n344_), .c(new_n314_), .O(new_n345_));
  nand4  g189(.a(new_n345_), .b(new_n343_), .c(new_n342_), .d(new_n341_), .O(new_n346_));
  aoi21  g190(.a(new_n346_), .b(new_n340_), .c(new_n320_), .O(new_n347_));
  oai21  g191(.a(new_n347_), .b(new_n338_), .c(x078), .O(new_n348_));
  nand3  g192(.a(new_n308_), .b(new_n315_), .c(new_n314_), .O(new_n349_));
  nand3  g193(.a(new_n349_), .b(new_n348_), .c(new_n322_), .O(new_n350_));
  nand3  g194(.a(x086), .b(new_n341_), .c(x014), .O(new_n351_));
  oai21  g195(.a(new_n329_), .b(x006), .c(new_n351_), .O(new_n352_));
  nand2  g196(.a(new_n352_), .b(x070), .O(new_n353_));
  nand2  g197(.a(new_n339_), .b(x086), .O(new_n354_));
  aoi21  g198(.a(new_n354_), .b(new_n353_), .c(x038), .O(new_n355_));
  aoi22  g199(.a(new_n320_), .b(new_n309_), .c(new_n315_), .d(new_n314_), .O(new_n356_));
  nand2  g200(.a(x054), .b(new_n310_), .O(new_n357_));
  nand3  g201(.a(new_n357_), .b(new_n315_), .c(new_n314_), .O(new_n358_));
  oai21  g202(.a(new_n356_), .b(new_n344_), .c(new_n358_), .O(new_n359_));
  oai21  g203(.a(new_n359_), .b(new_n355_), .c(x078), .O(new_n360_));
  inv1   g204(.a(x054), .O(new_n361_));
  nand3  g205(.a(new_n357_), .b(new_n320_), .c(new_n309_), .O(new_n362_));
  nand2  g206(.a(new_n362_), .b(x014), .O(new_n363_));
  aoi22  g207(.a(new_n363_), .b(new_n308_), .c(new_n361_), .d(new_n310_), .O(new_n364_));
  nand2  g208(.a(new_n364_), .b(new_n360_), .O(new_n365_));
  aoi21  g209(.a(new_n350_), .b(x054), .c(new_n365_), .O(new_n366_));
  oai21  g210(.a(new_n366_), .b(new_n306_), .c(new_n180_), .O(z06));
  ...
  oai21  g227(.a(new_n371_), .b(new_n157_), .c(new_n384_), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(new_n381_), .O(new_n386_));
  nand2  g229(.a(new_n386_), .b(new_n158_), .O(new_n387_));
  nand2  g230(.a(x112), .b(x104), .O(new_n388_));
  nand3  g231(.a(new_n388_), .b(x120), .c(new_n157_), .O(new_n389_));
  nand3  g232(.a(x096), .b(x064), .c(new_n173_), .O(new_n390_));
  nand3  g233(.a(new_n390_), .b(new_n389_), .c(new_n160_), .O(new_n391_));
  inv1   g234(.a(new_n391_), .O(new_n392_));
  aoi21  g235(.a(new_n392_), .b(new_n387_), .c(new_n165_), .O(new_n393_));
  oai21  g236(.a(new_n378_), .b(x016), .c(new_n379_), .O(new_n394_));
  nand2  g237(.a(new_n394_), .b(x064), .O(new_n395_));
  oai21  g238(.a(x064), .b(x008), .c(x016), .O(new_n396_));
  nand4  g239(.a(new_n396_), .b(new_n384_), .c(new_n371_), .d(x024), .O(new_n397_));
  aoi21  g240(.a(new_n397_), .b(new_n395_), .c(x080), .O(new_n398_));
  oai21  g241(.a(new_n398_), .b(new_n393_), .c(new_n174_), .O(new_n399_));
  nand3  g242(.a(x072), .b(x064), .c(x016), .O(new_n400_));
  nand3  g243(.a(new_n400_), .b(new_n399_), .c(new_n376_), .O(new_n401_));
  nand2  g244(.a(new_n384_), .b(x000), .O(new_n402_));
  ...
  nand2  g248(.a(new_n394_), .b(new_n160_), .O(new_n406_));
  ...
  aoi21  g258(.a(new_n401_), .b(new_n168_), .c(new_n415_), .O(new_n416_));
  oai21  g259(.a(new_n416_), .b(x040), .c(new_n180_), .O(z08));
  nand2  g260(.a(x065), .b(x017), .O(new_n418_));
  nand3  g261(.a(x081), .b(new_n189_), .c(x001), .O(new_n419_));
  oai21  g262(.a(new_n418_), .b(new_n189_), .c(new_n419_), .O(new_n420_));
  nand3  g263(.a(x081), .b(x009), .c(x001), .O(new_n421_));
  oai21  g264(.a(new_n418_), .b(x009), .c(new_n421_), .O(new_n422_));
  oai21  g265(.a(new_n195_), .b(x033), .c(new_n422_), .O(new_n423_));
  nand2  g266(.a(x081), .b(x001), .O(new_n424_));
  aoi21  g267(.a(new_n424_), .b(new_n418_), .c(x073), .O(new_n425_));
  nand2  g268(.a(new_n425_), .b(new_n189_), .O(new_n426_));
  aoi22  g269(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n427_));
  nand3  g270(.a(new_n427_), .b(new_n426_), .c(new_n423_), .O(new_n428_));
  aoi21  g271(.a(new_n420_), .b(new_n188_), .c(new_n428_), .O(new_n429_));
  oai21  g272(.a(new_n429_), .b(x041), .c(new_n180_), .O(z09));
  inv1   g273(.a(x042), .O(new_n431_));
  ...
  nand2  g277(.a(new_n434_), .b(new_n207_), .O(new_n435_));
  nand3  g278(.a(x082), .b(x010), .c(x002), .O(new_n436_));
  oai21  g279(.a(new_n432_), .b(x010), .c(new_n436_), .O(new_n437_));
  oai21  g280(.a(new_n214_), .b(x034), .c(new_n437_), .O(new_n438_));
  nand2  g281(.a(x082), .b(x002), .O(new_n439_));
  aoi21  g282(.a(new_n439_), .b(new_n432_), .c(x074), .O(new_n440_));
  oai22  g283(.a(new_n215_), .b(new_n208_), .c(new_n214_), .d(new_n207_), .O(new_n441_));
  aoi21  g284(.a(new_n440_), .b(new_n208_), .c(new_n441_), .O(new_n442_));
  nand3  g285(.a(new_n442_), .b(new_n438_), .c(new_n435_), .O(new_n443_));
  nand3  g286(.a(new_n443_), .b(new_n180_), .c(new_n431_), .O(new_n444_));
  inv1   g287(.a(new_n444_), .O(z10));
  inv1   g288(.a(x043), .O(new_n446_));
  ...
  nand2  g292(.a(new_n449_), .b(new_n226_), .O(new_n450_));
  nand3  g293(.a(x083), .b(x011), .c(x003), .O(new_n451_));
  oai21  g294(.a(new_n447_), .b(x011), .c(new_n451_), .O(new_n452_));
  oai21  g295(.a(new_n233_), .b(x035), .c(new_n452_), .O(new_n453_));
  nand2  g296(.a(x083), .b(x003), .O(new_n454_));
  aoi21  g297(.a(new_n454_), .b(new_n447_), .c(x075), .O(new_n455_));
  oai22  g298(.a(new_n234_), .b(new_n227_), .c(new_n233_), .d(new_n226_), .O(new_n456_));
  aoi21  g299(.a(new_n455_), .b(new_n227_), .c(new_n456_), .O(new_n457_));
  nand3  g300(.a(new_n457_), .b(new_n453_), .c(new_n450_), .O(new_n458_));
  nand3  g301(.a(new_n458_), .b(new_n180_), .c(new_n446_), .O(new_n459_));
  inv1   g302(.a(new_n459_), .O(z11));
  nand2  g303(.a(x068), .b(x020), .O(new_n461_));
  nand3  g304(.a(x084), .b(new_n246_), .c(x004), .O(new_n462_));
  oai21  g305(.a(new_n461_), .b(new_n246_), .c(new_n462_), .O(new_n463_));
  nand3  g306(.a(x084), .b(x012), .c(x004), .O(new_n464_));
  oai21  g307(.a(new_n461_), .b(x012), .c(new_n464_), .O(new_n465_));
  oai21  g308(.a(new_n252_), .b(x036), .c(new_n465_), .O(new_n466_));
  nand2  g309(.a(x084), .b(x004), .O(new_n467_));
  aoi21  g310(.a(new_n467_), .b(new_n461_), .c(x076), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n246_), .O(new_n469_));
  aoi22  g312(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n470_));
  nand3  g313(.a(new_n470_), .b(new_n469_), .c(new_n466_), .O(new_n471_));
  aoi21  g314(.a(new_n463_), .b(new_n245_), .c(new_n471_), .O(new_n472_));
  oai21  g315(.a(new_n472_), .b(x044), .c(new_n180_), .O(z12));
  inv1   g316(.a(x053), .O(new_n474_));
  nand2  g317(.a(x069), .b(new_n274_), .O(new_n475_));
  aoi21  g318(.a(new_n475_), .b(new_n299_), .c(new_n273_), .O(new_n476_));
  nand3  g319(.a(new_n276_), .b(new_n261_), .c(x029), .O(new_n477_));
  aoi21  g320(.a(new_n477_), .b(new_n269_), .c(x085), .O(new_n478_));
  oai21  g321(.a(new_n478_), .b(new_n476_), .c(new_n258_), .O(new_n479_));
  oai21  g322(.a(x085), .b(new_n268_), .c(new_n479_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n282_), .O(new_n481_));
  oai21  g324(.a(x037), .b(x013), .c(x021), .O(new_n482_));
  oai21  g325(.a(new_n266_), .b(x029), .c(new_n482_), .O(new_n483_));
  inv1   g326(.a(x101), .O(new_n484_));
  nand2  g327(.a(new_n281_), .b(new_n484_), .O(new_n485_));
  oai21  g328(.a(new_n276_), .b(new_n269_), .c(new_n485_), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(new_n483_), .O(new_n487_));
  nand3  g330(.a(new_n259_), .b(x125), .c(new_n269_), .O(new_n488_));
  nand3  g331(.a(x101), .b(x069), .c(new_n274_), .O(new_n489_));
  nand3  g332(.a(new_n489_), .b(new_n488_), .c(new_n264_), .O(new_n490_));
  aoi21  g333(.a(new_n487_), .b(new_n261_), .c(new_n490_), .O(new_n491_));
  nor2   g334(.a(new_n491_), .b(new_n273_), .O(new_n492_));
  aoi21  g335(.a(x029), .b(new_n269_), .c(new_n266_), .O(new_n493_));
  or2    g336(.a(new_n493_), .b(new_n261_), .O(new_n494_));
  oai21  g337(.a(x069), .b(x013), .c(x021), .O(new_n495_));
  nand4  g338(.a(new_n495_), .b(new_n485_), .c(new_n276_), .d(x029), .O(new_n496_));
  aoi21  g339(.a(new_n496_), .b(new_n494_), .c(x085), .O(new_n497_));
  oai21  g340(.a(new_n497_), .b(new_n492_), .c(new_n258_), .O(new_n498_));
  nand3  g341(.a(x077), .b(x069), .c(x021), .O(new_n499_));
  nand3  g342(.a(new_n499_), .b(new_n498_), .c(new_n481_), .O(new_n500_));
  nand2  g343(.a(new_n500_), .b(new_n474_), .O(new_n501_));
  nand2  g344(.a(new_n485_), .b(x005), .O(new_n502_));
  nand3  g345(.a(new_n264_), .b(x029), .c(new_n268_), .O(new_n503_));
  aoi21  g346(.a(new_n503_), .b(new_n502_), .c(x069), .O(new_n504_));
  nor2   g347(.a(new_n493_), .b(x085), .O(new_n505_));
  oai21  g348(.a(new_n505_), .b(new_n504_), .c(x037), .O(new_n506_));
  nand2  g349(.a(x085), .b(x005), .O(new_n507_));
  aoi21  g350(.a(new_n507_), .b(new_n260_), .c(x013), .O(new_n508_));
  aoi21  g351(.a(new_n474_), .b(x037), .c(new_n261_), .O(new_n509_));
  aoi21  g352(.a(new_n509_), .b(x021), .c(new_n508_), .O(new_n510_));
  nand2  g353(.a(new_n510_), .b(new_n506_), .O(new_n511_));
  aoi21  g354(.a(new_n474_), .b(x037), .c(new_n264_), .O(new_n512_));
  aoi21  g355(.a(new_n512_), .b(x005), .c(x013), .O(new_n513_));
  oai22  g356(.a(new_n513_), .b(new_n258_), .c(new_n474_), .d(new_n274_), .O(new_n514_));
  aoi21  g357(.a(new_n511_), .b(new_n258_), .c(new_n514_), .O(new_n515_));
  aoi21  g358(.a(new_n515_), .b(new_n501_), .c(x045), .O(z13));
  nand2  g359(.a(new_n333_), .b(new_n332_), .O(new_n517_));
  nand2  g360(.a(new_n315_), .b(new_n314_), .O(new_n518_));
  nand2  g361(.a(x070), .b(new_n310_), .O(new_n519_));
  aoi21  g362(.a(new_n519_), .b(new_n518_), .c(new_n309_), .O(new_n520_));
  nand3  g363(.a(new_n324_), .b(new_n315_), .c(x030), .O(new_n521_));
  aoi21  g364(.a(new_n521_), .b(new_n314_), .c(x086), .O(new_n522_));
  oai21  g365(.a(new_n522_), .b(new_n520_), .c(new_n308_), .O(new_n523_));
  oai21  g366(.a(x086), .b(new_n344_), .c(new_n523_), .O(new_n524_));
  nand2  g367(.a(new_n524_), .b(new_n517_), .O(new_n525_));
  oai21  g368(.a(x038), .b(x014), .c(x022), .O(new_n526_));
  inv1   g369(.a(x062), .O(new_n527_));
  inv1   g370(.a(x094), .O(new_n528_));
  nand3  g371(.a(new_n528_), .b(new_n527_), .c(new_n341_), .O(new_n529_));
  nand2  g372(.a(new_n529_), .b(new_n526_), .O(new_n530_));
  oai22  g373(.a(new_n324_), .b(new_n314_), .c(x126), .d(x102), .O(new_n531_));
  nand2  g374(.a(new_n531_), .b(new_n530_), .O(new_n532_));
  nand2  g375(.a(new_n532_), .b(new_n315_), .O(new_n533_));
  nand3  g376(.a(new_n307_), .b(x126), .c(new_n314_), .O(new_n534_));
  nand3  g377(.a(x102), .b(x070), .c(new_n310_), .O(new_n535_));
  nand3  g378(.a(new_n535_), .b(new_n534_), .c(new_n320_), .O(new_n536_));
  inv1   g379(.a(new_n536_), .O(new_n537_));
  aoi21  g380(.a(new_n537_), .b(new_n533_), .c(new_n309_), .O(new_n538_));
  oai21  g381(.a(new_n341_), .b(x022), .c(new_n316_), .O(new_n539_));
  nand2  g382(.a(new_n539_), .b(x070), .O(new_n540_));
  nand2  g383(.a(new_n328_), .b(new_n327_), .O(new_n541_));
  oai21  g384(.a(x070), .b(x014), .c(x022), .O(new_n542_));
  nand4  g385(.a(new_n542_), .b(new_n541_), .c(new_n324_), .d(x030), .O(new_n543_));
  aoi21  g386(.a(new_n543_), .b(new_n540_), .c(x086), .O(new_n544_));
  oai21  g387(.a(new_n544_), .b(new_n538_), .c(new_n308_), .O(new_n545_));
  nand3  g388(.a(x078), .b(x070), .c(x022), .O(new_n546_));
  nand3  g389(.a(new_n546_), .b(new_n545_), .c(new_n525_), .O(new_n547_));
  nand2  g390(.a(new_n541_), .b(x006), .O(new_n548_));
  nand3  g391(.a(new_n320_), .b(x030), .c(new_n344_), .O(new_n549_));
  nand2  g392(.a(new_n549_), .b(new_n548_), .O(new_n550_));
  nand2  g393(.a(new_n550_), .b(new_n315_), .O(new_n551_));
  nand2  g394(.a(new_n539_), .b(new_n320_), .O(new_n552_));
  aoi21  g395(.a(new_n552_), .b(new_n551_), .c(new_n310_), .O(new_n553_));
  oai21  g396(.a(new_n320_), .b(new_n309_), .c(new_n311_), .O(new_n554_));
  nand2  g397(.a(new_n554_), .b(new_n344_), .O(new_n555_));
  nand2  g398(.a(new_n361_), .b(x038), .O(new_n556_));
  nand3  g399(.a(new_n556_), .b(x070), .c(x022), .O(new_n557_));
  nand2  g400(.a(new_n557_), .b(new_n555_), .O(new_n558_));
  oai21  g401(.a(new_n558_), .b(new_n553_), .c(new_n308_), .O(new_n559_));
  nand3  g402(.a(new_n556_), .b(x086), .c(x006), .O(new_n560_));
  nand2  g403(.a(new_n560_), .b(new_n344_), .O(new_n561_));
  aoi22  g404(.a(new_n561_), .b(x078), .c(x054), .d(x038), .O(new_n562_));
  nand2  g405(.a(new_n562_), .b(new_n559_), .O(new_n563_));
  aoi21  g406(.a(new_n547_), .b(new_n361_), .c(new_n563_), .O(new_n564_));
  nor3   g407(.a(new_n564_), .b(z16), .c(x046), .O(z14));
  zero   g408(.O(z07));
  zero   g409(.O(z15));
  zero   g410(.O(z17));
  zero   g411(.O(z18));
  ...
  nor2   g415(.a(x077), .b(new_n178_), .O(z22));
  nor2   g416(.a(x077), .b(new_n178_), .O(z23));
  nor2   g417(.a(x077), .b(new_n178_), .O(z24));
  nor2   g418(.a(x077), .b(new_n178_), .O(z25));
  nor2   g419(.a(x077), .b(new_n178_), .O(z26));
  nor2   g420(.a(x077), .b(new_n178_), .O(z27));
endmodule
