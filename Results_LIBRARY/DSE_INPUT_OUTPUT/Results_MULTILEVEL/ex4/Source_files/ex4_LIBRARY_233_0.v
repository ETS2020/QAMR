...
module FAU ( 
  ...
  nand2  g417(.a(new_n574_), .b(x079), .O(new_n575_));
  ...
  zero   g429(.O(z25));
  zero   g430(.O(z26));
  nor2   g431(.a(x079), .b(x078), .O(z16));
  nor2   g432(.a(x079), .b(x078), .O(z18));
  nor2   g433(.a(x079), .b(x078), .O(z20));
  nor2   g434(.a(x079), .b(x078), .O(z21));
  nor2   g435(.a(x079), .b(x078), .O(z23));
  nor2   g436(.a(x079), .b(x078), .O(z27));
endmodule
