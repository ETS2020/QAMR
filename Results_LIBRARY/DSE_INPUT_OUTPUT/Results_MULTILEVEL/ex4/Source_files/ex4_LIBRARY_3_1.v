...
module FAU ( 
  ...
  oai21  g165(.a(new_n321_), .b(new_n258_), .c(new_n180_), .O(z05));
  ...
  aoi21  g180(.a(new_n336_), .b(new_n329_), .c(new_n178_), .O(new_n337_));
  ...
  nand3  g210(.a(new_n178_), .b(new_n352_), .c(new_n345_), .O(new_n367_));
  ...
  aoi22  g226(.a(new_n382_), .b(new_n178_), .c(new_n380_), .d(new_n326_), .O(new_n383_));
  nand2  g227(.a(new_n383_), .b(new_n379_), .O(new_n384_));
  aoi21  g228(.a(new_n368_), .b(x054), .c(new_n384_), .O(new_n385_));
  oai21  g229(.a(new_n385_), .b(new_n323_), .c(new_n180_), .O(z06));
  ...
  oai21  g389(.a(new_n545_), .b(new_n542_), .c(new_n178_), .O(new_n546_));
  ...
  nand3  g398(.a(new_n324_), .b(x126), .c(new_n345_), .O(new_n555_));
  ...
  oai21  g410(.a(new_n566_), .b(new_n559_), .c(new_n178_), .O(new_n567_));
  ...
  zero   g439(.O(z26));
  zero   g440(.O(z27));
  nor2   g441(.a(new_n178_), .b(x077), .O(z15));
  nor2   g442(.a(new_n178_), .b(x077), .O(z19));
  nor2   g443(.a(new_n178_), .b(x077), .O(z24));
endmodule
