...
module FAU ( 
  ...
  oai21  g384(.a(new_n540_), .b(new_n538_), .c(new_n321_), .O(new_n541_));
  ...
  nand3  g393(.a(new_n320_), .b(x126), .c(new_n327_), .O(new_n550_));
  ...
  oai21  g403(.a(new_n559_), .b(new_n554_), .c(new_n321_), .O(new_n560_));
  ...
  oai21  g417(.a(new_n573_), .b(new_n568_), .c(new_n321_), .O(new_n574_));
  ...
  zero   g427(.O(z23));
  zero   g428(.O(z25));
  nor2   g429(.a(x097), .b(x078), .O(z15));
  nor2   g430(.a(x097), .b(x078), .O(z16));
  nor2   g431(.a(x097), .b(x078), .O(z17));
  nor2   g432(.a(x097), .b(x078), .O(z18));
  nor2   g433(.a(x097), .b(x078), .O(z22));
  nor2   g434(.a(x097), .b(x078), .O(z24));
  nor2   g435(.a(x097), .b(x078), .O(z26));
  nor2   g436(.a(x097), .b(x078), .O(z27));
endmodule
