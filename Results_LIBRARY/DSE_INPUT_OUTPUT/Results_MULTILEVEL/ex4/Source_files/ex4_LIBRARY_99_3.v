...
module FAU ( 
  ...
  nand3  g240(.a(new_n397_), .b(new_n157_), .c(new_n385_), .O(new_n398_));
  ...
  aoi21  g249(.a(new_n406_), .b(new_n400_), .c(x074), .O(new_n407_));
  nand2  g250(.a(new_n407_), .b(new_n206_), .O(new_n408_));
  aoi22  g251(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n409_));
  nand3  g252(.a(new_n409_), .b(new_n408_), .c(new_n405_), .O(new_n410_));
  aoi21  g253(.a(new_n402_), .b(new_n205_), .c(new_n410_), .O(new_n411_));
  oai21  g254(.a(new_n411_), .b(x042), .c(new_n157_), .O(z10));
  nand2  g255(.a(x067), .b(x019), .O(new_n413_));
  nand3  g256(.a(x083), .b(new_n225_), .c(x003), .O(new_n414_));
  oai21  g257(.a(new_n413_), .b(new_n225_), .c(new_n414_), .O(new_n415_));
  nand3  g258(.a(x083), .b(x011), .c(x003), .O(new_n416_));
  oai21  g259(.a(new_n413_), .b(x011), .c(new_n416_), .O(new_n417_));
  oai21  g260(.a(new_n231_), .b(x035), .c(new_n417_), .O(new_n418_));
  nand2  g261(.a(x083), .b(x003), .O(new_n419_));
  aoi21  g262(.a(new_n419_), .b(new_n413_), .c(x075), .O(new_n420_));
  nand2  g263(.a(new_n420_), .b(new_n225_), .O(new_n421_));
  aoi22  g264(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n422_));
  nand3  g265(.a(new_n422_), .b(new_n421_), .c(new_n418_), .O(new_n423_));
  aoi21  g266(.a(new_n415_), .b(new_n224_), .c(new_n423_), .O(new_n424_));
  oai21  g267(.a(new_n424_), .b(x043), .c(new_n157_), .O(z11));
  inv1   g268(.a(x044), .O(new_n426_));
  nand2  g269(.a(x068), .b(x020), .O(new_n427_));
  nand3  g270(.a(x084), .b(new_n244_), .c(x004), .O(new_n428_));
  oai21  g271(.a(new_n427_), .b(new_n244_), .c(new_n428_), .O(new_n429_));
  nand2  g272(.a(new_n429_), .b(new_n243_), .O(new_n430_));
  nand3  g273(.a(x084), .b(x012), .c(x004), .O(new_n431_));
  oai21  g274(.a(new_n427_), .b(x012), .c(new_n431_), .O(new_n432_));
  oai21  g275(.a(new_n250_), .b(x036), .c(new_n432_), .O(new_n433_));
  nand2  g276(.a(x084), .b(x004), .O(new_n434_));
  aoi21  g277(.a(new_n434_), .b(new_n427_), .c(x076), .O(new_n435_));
  oai22  g278(.a(new_n251_), .b(new_n244_), .c(new_n250_), .d(new_n243_), .O(new_n436_));
  aoi21  g279(.a(new_n435_), .b(new_n244_), .c(new_n436_), .O(new_n437_));
  nand3  g280(.a(new_n437_), .b(new_n433_), .c(new_n430_), .O(new_n438_));
  nand3  g281(.a(new_n438_), .b(new_n157_), .c(new_n426_), .O(new_n439_));
  ...
  oai21  g329(.a(new_n486_), .b(x045), .c(new_n157_), .O(z13));
  ...
  zero   g381(.O(z22));
  zero   g382(.O(z27));
  inv1   g383(.a(new_n157_), .O(z20));
  inv1   g384(.a(new_n157_), .O(z21));
  inv1   g385(.a(new_n157_), .O(z23));
  inv1   g386(.a(new_n157_), .O(z24));
  inv1   g387(.a(new_n157_), .O(z25));
  inv1   g388(.a(new_n157_), .O(z26));
endmodule
