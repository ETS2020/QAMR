...
module FAU ( 
  ...
  nor3   g380(.a(new_n536_), .b(new_n321_), .c(x045), .O(z13));
  ...
  nand2  g419(.a(new_n575_), .b(x045), .O(new_n576_));
  ...
  zero   g431(.O(z26));
  zero   g432(.O(z27));
  nor2   g433(.a(x078), .b(x045), .O(z15));
  nor2   g434(.a(x078), .b(x045), .O(z20));
  nor2   g435(.a(x078), .b(x045), .O(z21));
  nor2   g436(.a(x078), .b(x045), .O(z22));
  nor2   g437(.a(x078), .b(x045), .O(z23));
  nor2   g438(.a(x078), .b(x045), .O(z24));
endmodule
