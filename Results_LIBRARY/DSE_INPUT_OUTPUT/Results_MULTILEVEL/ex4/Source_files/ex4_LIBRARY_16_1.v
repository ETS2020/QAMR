...
module FAU ( 
  ...
  oai21  g240(.a(new_n383_), .b(new_n160_), .c(new_n396_), .O(new_n397_));
  ...
  oai21  g254(.a(new_n410_), .b(new_n405_), .c(new_n177_), .O(new_n411_));
  ...
  nand2  g261(.a(new_n406_), .b(new_n163_), .O(new_n418_));
  ...
  aoi21  g271(.a(new_n413_), .b(new_n171_), .c(new_n427_), .O(new_n428_));
  ...
  nor2   g424(.a(new_n157_), .b(x046), .O(z19));
  nor2   g425(.a(new_n157_), .b(x046), .O(z20));
  nor2   g426(.a(new_n157_), .b(x046), .O(z21));
  nor2   g427(.a(new_n157_), .b(x046), .O(z22));
  nor2   g428(.a(new_n157_), .b(x046), .O(z24));
endmodule
