...
module FAU ( 
  ...
  nand3  g396(.a(new_n324_), .b(x126), .c(new_n330_), .O(new_n554_));
  ...
  oai21  g406(.a(new_n563_), .b(new_n558_), .c(new_n178_), .O(new_n564_));
  ...
  oai21  g420(.a(new_n577_), .b(new_n572_), .c(new_n178_), .O(new_n578_));
  ...
  zero   g434(.O(z26));
  zero   g435(.O(z27));
  nor2   g436(.a(x113), .b(new_n178_), .O(z17));
  nor2   g437(.a(x113), .b(new_n178_), .O(z18));
  nor2   g438(.a(x113), .b(new_n178_), .O(z21));
  nor2   g439(.a(x113), .b(new_n178_), .O(z25));
endmodule
