// Benchmark "FAU" written by ABC on Tue Aug 18 02:18:56 2020
...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x003), .O(z07));
  ...
  nor2   g200(.a(x030), .b(new_n340_), .O(new_n357_));
  oai21  g201(.a(new_n357_), .b(new_n356_), .c(new_n325_), .O(new_n358_));
  oai21  g202(.a(new_n325_), .b(new_n336_), .c(new_n340_), .O(new_n359_));
  nand4  g203(.a(new_n359_), .b(new_n345_), .c(new_n332_), .d(new_n329_), .O(new_n360_));
  nand2  g204(.a(new_n360_), .b(new_n358_), .O(new_n361_));
  nand2  g205(.a(new_n361_), .b(x086), .O(new_n362_));
  aoi21  g206(.a(new_n362_), .b(new_n355_), .c(new_n157_), .O(new_n363_));
  oai21  g207(.a(new_n363_), .b(new_n338_), .c(x054), .O(new_n364_));
  inv1   g208(.a(x038), .O(new_n365_));
  inv1   g209(.a(x054), .O(new_n366_));
  nand2  g210(.a(new_n345_), .b(new_n339_), .O(new_n367_));
  nand3  g211(.a(x086), .b(new_n329_), .c(x014), .O(new_n368_));
  aoi21  g212(.a(new_n368_), .b(new_n367_), .c(new_n325_), .O(new_n369_));
  aoi21  g213(.a(new_n329_), .b(x022), .c(new_n356_), .O(new_n370_));
  nor2   g214(.a(new_n370_), .b(new_n328_), .O(new_n371_));
  oai21  g215(.a(new_n371_), .b(new_n369_), .c(new_n365_), .O(new_n372_));
  nand2  g216(.a(new_n325_), .b(new_n340_), .O(new_n373_));
  oai21  g217(.a(x086), .b(x006), .c(new_n373_), .O(new_n374_));
  aoi21  g218(.a(x054), .b(new_n365_), .c(x070), .O(new_n375_));
  aoi22  g219(.a(new_n375_), .b(new_n340_), .c(new_n374_), .d(x014), .O(new_n376_));
  nand2  g220(.a(new_n376_), .b(new_n372_), .O(new_n377_));
  aoi22  g221(.a(new_n377_), .b(x078), .c(new_n366_), .d(new_n365_), .O(new_n378_));
  nand2  g222(.a(new_n378_), .b(new_n364_), .O(new_n379_));
  nand2  g223(.a(new_n379_), .b(x003), .O(new_n380_));
  nand2  g224(.a(new_n366_), .b(new_n365_), .O(new_n381_));
  nand2  g225(.a(x054), .b(new_n365_), .O(new_n382_));
  nand3  g226(.a(new_n382_), .b(new_n328_), .c(new_n339_), .O(new_n383_));
  nand3  g227(.a(new_n325_), .b(x054), .c(new_n340_), .O(new_n384_));
  nand4  g228(.a(new_n384_), .b(new_n383_), .c(new_n381_), .d(x014), .O(new_n385_));
  nand2  g229(.a(new_n385_), .b(new_n157_), .O(new_n386_));
  aoi21  g230(.a(new_n386_), .b(new_n380_), .c(new_n321_), .O(z06));
  nand2  g231(.a(x064), .b(new_n176_), .O(new_n388_));
  aoi21  g232(.a(new_n388_), .b(new_n162_), .c(new_n168_), .O(new_n389_));
  nand2  g233(.a(x088), .b(x056), .O(new_n390_));
  nand3  g234(.a(new_n390_), .b(new_n161_), .c(x024), .O(new_n391_));
  aoi21  g235(.a(new_n391_), .b(new_n160_), .c(x080), .O(new_n392_));
  oai21  g236(.a(new_n392_), .b(new_n389_), .c(new_n177_), .O(new_n393_));
  nand2  g237(.a(new_n393_), .b(new_n164_), .O(new_n394_));
  ...
  oai22  g244(.a(new_n390_), .b(new_n160_), .c(x120), .d(x096), .O(new_n401_));
  ...
  nand3  g248(.a(new_n404_), .b(x120), .c(new_n160_), .O(new_n405_));
  nand3  g249(.a(x096), .b(x064), .c(new_n176_), .O(new_n406_));
  nand3  g250(.a(new_n406_), .b(new_n405_), .c(new_n163_), .O(new_n407_));
  inv1   g251(.a(new_n407_), .O(new_n408_));
  aoi21  g252(.a(new_n408_), .b(new_n403_), .c(new_n168_), .O(new_n409_));
  oai21  g253(.a(new_n397_), .b(x016), .c(new_n398_), .O(new_n410_));
  nand2  g254(.a(new_n410_), .b(x064), .O(new_n411_));
  or2    g255(.a(x120), .b(x096), .O(new_n412_));
  oai21  g256(.a(x064), .b(x008), .c(x016), .O(new_n413_));
  nand4  g257(.a(new_n413_), .b(new_n412_), .c(new_n390_), .d(x024), .O(new_n414_));
  aoi21  g258(.a(new_n414_), .b(new_n411_), .c(x080), .O(new_n415_));
  oai21  g259(.a(new_n415_), .b(new_n409_), .c(new_n177_), .O(new_n416_));
  nand3  g260(.a(x072), .b(x064), .c(x016), .O(new_n417_));
  nand3  g261(.a(new_n417_), .b(new_n416_), .c(new_n395_), .O(new_n418_));
  nand2  g262(.a(new_n412_), .b(x000), .O(new_n419_));
  ...
  aoi21  g276(.a(new_n418_), .b(new_n171_), .c(new_n432_), .O(new_n433_));
  oai21  g277(.a(new_n433_), .b(x040), .c(new_n159_), .O(z08));
  inv1   g278(.a(x041), .O(new_n435_));
  ...
  oai21  g284(.a(new_n436_), .b(x009), .c(new_n440_), .O(new_n441_));
  oai21  g285(.a(new_n195_), .b(x033), .c(new_n441_), .O(new_n442_));
  nand2  g286(.a(x081), .b(x001), .O(new_n443_));
  aoi21  g287(.a(new_n443_), .b(new_n436_), .c(x073), .O(new_n444_));
  oai22  g288(.a(new_n196_), .b(new_n189_), .c(new_n195_), .d(new_n188_), .O(new_n445_));
  aoi21  g289(.a(new_n444_), .b(new_n189_), .c(new_n445_), .O(new_n446_));
  nand3  g290(.a(new_n446_), .b(new_n442_), .c(new_n439_), .O(new_n447_));
  nand3  g291(.a(new_n447_), .b(new_n159_), .c(new_n435_), .O(new_n448_));
  inv1   g292(.a(new_n448_), .O(z09));
  ...
  nand2  g301(.a(new_n457_), .b(new_n208_), .O(new_n458_));
  ...
  nand3  g306(.a(x067), .b(new_n226_), .c(x019), .O(new_n463_));
  aoi21  g307(.a(new_n463_), .b(new_n234_), .c(new_n227_), .O(new_n464_));
  nand2  g308(.a(x067), .b(x019), .O(new_n465_));
  oai21  g309(.a(new_n465_), .b(x011), .c(new_n233_), .O(new_n466_));
  nand2  g310(.a(new_n466_), .b(x035), .O(new_n467_));
  nand2  g311(.a(x075), .b(x051), .O(new_n468_));
  nand4  g312(.a(new_n468_), .b(x067), .c(x019), .d(new_n227_), .O(new_n469_));
  nand2  g313(.a(new_n469_), .b(new_n467_), .O(new_n470_));
  oai21  g314(.a(new_n470_), .b(new_n464_), .c(new_n159_), .O(new_n471_));
  oai21  g315(.a(new_n233_), .b(x035), .c(x011), .O(new_n472_));
  oai21  g316(.a(new_n234_), .b(new_n226_), .c(new_n227_), .O(new_n473_));
  nand2  g317(.a(new_n473_), .b(new_n472_), .O(new_n474_));
  nand3  g318(.a(new_n474_), .b(x083), .c(x003), .O(new_n475_));
  aoi21  g319(.a(new_n475_), .b(new_n471_), .c(x043), .O(z11));
  nand2  g320(.a(x068), .b(x020), .O(new_n477_));
  nand3  g321(.a(x084), .b(new_n246_), .c(x004), .O(new_n478_));
  oai21  g322(.a(new_n477_), .b(new_n246_), .c(new_n478_), .O(new_n479_));
  ...
  aoi21  g327(.a(new_n483_), .b(new_n477_), .c(x076), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n246_), .O(new_n485_));
  aoi22  g329(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n486_));
  nand3  g330(.a(new_n486_), .b(new_n485_), .c(new_n482_), .O(new_n487_));
  aoi21  g331(.a(new_n479_), .b(new_n245_), .c(new_n487_), .O(new_n488_));
  oai21  g332(.a(new_n488_), .b(x044), .c(new_n159_), .O(z12));
  ...
  oai21  g339(.a(x085), .b(new_n297_), .c(new_n495_), .O(new_n496_));
  oai21  g340(.a(x117), .b(x109), .c(new_n496_), .O(new_n497_));
  oai21  g341(.a(x037), .b(x013), .c(x021), .O(new_n498_));
  oai21  g342(.a(new_n295_), .b(x029), .c(new_n498_), .O(new_n499_));
  nand2  g343(.a(new_n280_), .b(new_n279_), .O(new_n500_));
  oai21  g344(.a(new_n276_), .b(new_n266_), .c(new_n500_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n499_), .O(new_n502_));
  ...
  oai21  g352(.a(new_n292_), .b(x021), .c(new_n268_), .O(new_n509_));
  nand2  g353(.a(new_n509_), .b(x069), .O(new_n510_));
  oai21  g354(.a(x069), .b(x013), .c(x021), .O(new_n511_));
  nand4  g355(.a(new_n511_), .b(new_n500_), .c(new_n276_), .d(x029), .O(new_n512_));
  ...
  nand3  g359(.a(new_n515_), .b(new_n514_), .c(new_n497_), .O(new_n516_));
  nand2  g360(.a(new_n500_), .b(x005), .O(new_n517_));
  nand3  g361(.a(new_n272_), .b(x029), .c(new_n297_), .O(new_n518_));
  nand2  g362(.a(new_n518_), .b(new_n517_), .O(new_n519_));
  nand2  g363(.a(new_n519_), .b(new_n267_), .O(new_n520_));
  nand2  g364(.a(new_n509_), .b(new_n272_), .O(new_n521_));
  aoi21  g365(.a(new_n521_), .b(new_n520_), .c(new_n262_), .O(new_n522_));
  oai21  g366(.a(new_n272_), .b(new_n261_), .c(new_n263_), .O(new_n523_));
  ...
  oai21  g377(.a(new_n533_), .b(x045), .c(new_n159_), .O(z13));
  nand2  g378(.a(x070), .b(new_n365_), .O(new_n535_));
  aoi21  g379(.a(new_n535_), .b(new_n373_), .c(new_n339_), .O(new_n536_));
  nand3  g380(.a(new_n356_), .b(new_n325_), .c(x030), .O(new_n537_));
  nor2   g381(.a(x022), .b(x014), .O(new_n538_));
  aoi21  g382(.a(new_n538_), .b(new_n537_), .c(x086), .O(new_n539_));
  oai21  g383(.a(new_n539_), .b(new_n536_), .c(new_n350_), .O(new_n540_));
  oai21  g384(.a(x038), .b(x014), .c(x022), .O(new_n541_));
  oai21  g385(.a(new_n332_), .b(x030), .c(new_n541_), .O(new_n542_));
  inv1   g386(.a(x102), .O(new_n543_));
  nand2  g387(.a(new_n349_), .b(new_n543_), .O(new_n544_));
  oai21  g388(.a(new_n356_), .b(new_n340_), .c(new_n544_), .O(new_n545_));
  aoi21  g389(.a(new_n545_), .b(new_n542_), .c(x070), .O(new_n546_));
  nand3  g390(.a(new_n322_), .b(x126), .c(new_n340_), .O(new_n547_));
  nand3  g391(.a(x102), .b(x070), .c(new_n365_), .O(new_n548_));
  nand3  g392(.a(new_n548_), .b(new_n547_), .c(new_n328_), .O(new_n549_));
  oai21  g393(.a(new_n549_), .b(new_n546_), .c(x006), .O(new_n550_));
  nor2   g394(.a(x094), .b(x062), .O(new_n551_));
  oai21  g395(.a(new_n329_), .b(x022), .c(new_n551_), .O(new_n552_));
  and2   g396(.a(new_n552_), .b(x070), .O(new_n553_));
  oai21  g397(.a(x070), .b(x014), .c(x022), .O(new_n554_));
  nand4  g398(.a(new_n554_), .b(new_n544_), .c(new_n356_), .d(x030), .O(new_n555_));
  inv1   g399(.a(new_n555_), .O(new_n556_));
  oai21  g400(.a(new_n556_), .b(new_n553_), .c(new_n328_), .O(new_n557_));
  nand3  g401(.a(new_n557_), .b(new_n550_), .c(new_n540_), .O(new_n558_));
  nand2  g402(.a(new_n558_), .b(new_n366_), .O(new_n559_));
  nand2  g403(.a(new_n544_), .b(x006), .O(new_n560_));
  nand3  g404(.a(new_n328_), .b(x030), .c(new_n336_), .O(new_n561_));
  aoi21  g405(.a(new_n561_), .b(new_n560_), .c(x070), .O(new_n562_));
  nand2  g406(.a(new_n552_), .b(new_n328_), .O(new_n563_));
  nand2  g407(.a(new_n563_), .b(new_n366_), .O(new_n564_));
  oai21  g408(.a(new_n564_), .b(new_n562_), .c(x038), .O(new_n565_));
  oai21  g409(.a(new_n328_), .b(new_n339_), .c(new_n324_), .O(new_n566_));
  nand2  g410(.a(new_n566_), .b(new_n336_), .O(new_n567_));
  nand2  g411(.a(new_n366_), .b(x038), .O(new_n568_));
  nand3  g412(.a(new_n568_), .b(x070), .c(x022), .O(new_n569_));
  nand4  g413(.a(new_n569_), .b(new_n567_), .c(new_n565_), .d(new_n559_), .O(new_n570_));
  nand2  g414(.a(new_n570_), .b(new_n157_), .O(new_n571_));
  nand3  g415(.a(new_n568_), .b(x086), .c(x006), .O(new_n572_));
  nand3  g416(.a(x070), .b(new_n366_), .c(x022), .O(new_n573_));
  nand3  g417(.a(new_n573_), .b(new_n572_), .c(new_n336_), .O(new_n574_));
  nand2  g418(.a(new_n574_), .b(x078), .O(new_n575_));
  oai21  g419(.a(new_n366_), .b(new_n365_), .c(new_n575_), .O(new_n576_));
  nand2  g420(.a(new_n576_), .b(x003), .O(new_n577_));
  aoi21  g421(.a(new_n577_), .b(new_n571_), .c(x046), .O(z14));
  zero   g422(.O(z16));
  zero   g423(.O(z17));
  zero   g424(.O(z20));
  zero   g425(.O(z21));
  zero   g426(.O(z26));
  zero   g427(.O(z27));
  nor2   g428(.a(new_n157_), .b(x003), .O(z15));
  nor2   g429(.a(new_n157_), .b(x003), .O(z18));
  nor2   g430(.a(new_n157_), .b(x003), .O(z19));
  nor2   g431(.a(new_n157_), .b(x003), .O(z22));
  nor2   g432(.a(new_n157_), .b(x003), .O(z23));
  nor2   g433(.a(new_n157_), .b(x003), .O(z24));
  nor2   g434(.a(new_n157_), .b(x003), .O(z25));
endmodule
