...
module FAU ( 
  ...
  nor2   g001(.a(x123), .b(new_n157_), .O(z07));
  ...
  nand2  g223(.a(new_n379_), .b(x123), .O(new_n380_));
  ...
  oai22  g245(.a(new_n390_), .b(new_n160_), .c(x120), .d(x096), .O(new_n402_));
  ...
  nand3  g249(.a(new_n405_), .b(x120), .c(new_n160_), .O(new_n406_));
  nand3  g250(.a(x096), .b(x064), .c(new_n176_), .O(new_n407_));
  nand3  g251(.a(new_n407_), .b(new_n406_), .c(new_n163_), .O(new_n408_));
  inv1   g252(.a(new_n408_), .O(new_n409_));
  aoi21  g253(.a(new_n409_), .b(new_n404_), .c(new_n168_), .O(new_n410_));
  ...
  oai21  g262(.a(new_n418_), .b(new_n410_), .c(new_n177_), .O(new_n419_));
  ...
  oai21  g266(.a(new_n414_), .b(new_n168_), .c(new_n422_), .O(new_n423_));
  nand2  g267(.a(new_n423_), .b(new_n161_), .O(new_n424_));
  nand2  g268(.a(new_n412_), .b(new_n163_), .O(new_n425_));
  ...
  aoi21  g278(.a(new_n421_), .b(new_n171_), .c(new_n434_), .O(new_n435_));
  ...
  nand3  g321(.a(new_n477_), .b(new_n159_), .c(new_n465_), .O(new_n478_));
  ...
  nand3  g336(.a(new_n492_), .b(new_n159_), .c(new_n480_), .O(new_n493_));
  ...
  oai21  g391(.a(new_n547_), .b(new_n545_), .c(new_n157_), .O(new_n548_));
  ...
  oai21  g412(.a(new_n568_), .b(new_n562_), .c(new_n157_), .O(new_n569_));
  ...
  zero   g440(.O(z25));
  zero   g441(.O(z26));
  nor2   g442(.a(x123), .b(new_n157_), .O(z15));
  nor2   g443(.a(x123), .b(new_n157_), .O(z16));
  nor2   g444(.a(x123), .b(new_n157_), .O(z19));
  nor2   g445(.a(x123), .b(new_n157_), .O(z27));
endmodule
