...
module FAU ( 
  ...
  nand3  g039(.a(new_n191_), .b(new_n190_), .c(x033), .O(new_n196_));
  nand2  g040(.a(new_n196_), .b(x009), .O(new_n197_));
  oai21  g041(.a(new_n186_), .b(x009), .c(new_n197_), .O(new_n198_));
  nand3  g042(.a(new_n198_), .b(new_n178_), .c(new_n195_), .O(new_n199_));
  aoi21  g043(.a(new_n199_), .b(new_n194_), .c(new_n182_), .O(z01));
  ...
  oai21  g276(.a(new_n190_), .b(x033), .c(x009), .O(new_n434_));
  oai21  g277(.a(new_n191_), .b(new_n186_), .c(new_n185_), .O(new_n435_));
  ...
  nand2  g282(.a(new_n439_), .b(new_n180_), .O(new_n440_));
  nand2  g283(.a(x073), .b(x049), .O(new_n441_));
  oai21  g284(.a(new_n441_), .b(x033), .c(new_n185_), .O(new_n442_));
  oai21  g285(.a(x033), .b(new_n185_), .c(new_n442_), .O(new_n443_));
  nand4  g286(.a(new_n443_), .b(x078), .c(x065), .d(x017), .O(new_n444_));
