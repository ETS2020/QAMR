...
module FAU ( 
  ...
  nand2  g330(.a(new_n287_), .b(new_n280_), .O(new_n488_));
  ...
  nand3  g340(.a(new_n267_), .b(new_n266_), .c(new_n265_), .O(new_n498_));
  nand2  g341(.a(new_n498_), .b(new_n497_), .O(new_n499_));
  oai22  g342(.a(new_n491_), .b(new_n280_), .c(x125), .d(x101), .O(new_n500_));
  ...
  oai21  g357(.a(new_n514_), .b(new_n507_), .c(new_n259_), .O(new_n515_));
  ...
  nand3  g361(.a(new_n273_), .b(x029), .c(new_n297_), .O(new_n519_));
  nand2  g362(.a(new_n519_), .b(new_n518_), .O(new_n520_));
  nand2  g363(.a(new_n520_), .b(new_n287_), .O(new_n521_));
  nand2  g364(.a(new_n508_), .b(new_n273_), .O(new_n522_));
  aoi21  g365(.a(new_n522_), .b(new_n521_), .c(new_n261_), .O(new_n523_));
  oai21  g366(.a(new_n273_), .b(new_n260_), .c(new_n262_), .O(new_n524_));
  ...
  nand2  g379(.a(new_n536_), .b(x038), .O(new_n537_));
  nand3  g380(.a(new_n537_), .b(x086), .c(x006), .O(new_n538_));
  nand2  g381(.a(x054), .b(x038), .O(new_n539_));
  nand3  g382(.a(x070), .b(new_n536_), .c(x022), .O(new_n540_));
  nand4  g383(.a(new_n540_), .b(new_n539_), .c(new_n538_), .d(new_n357_), .O(new_n541_));
  nand3  g384(.a(new_n541_), .b(x078), .c(new_n322_), .O(new_n542_));
  inv1   g385(.a(new_n542_), .O(z14));
  zero   g386(.O(z07));
  zero   g387(.O(z15));
  zero   g388(.O(z16));
  zero   g389(.O(z20));
