...
module FAU ( 
  ...
  nand3  g230(.a(new_n386_), .b(new_n385_), .c(new_n384_), .O(new_n387_));
  nand2  g231(.a(new_n387_), .b(new_n383_), .O(new_n388_));
  oai22  g232(.a(new_n377_), .b(new_n160_), .c(x120), .d(x096), .O(new_n389_));
  ...
  oai21  g242(.a(new_n384_), .b(x016), .c(new_n398_), .O(new_n399_));
  ...
  nand4  g247(.a(new_n403_), .b(new_n402_), .c(new_n377_), .d(x024), .O(new_n404_));
  aoi21  g248(.a(new_n404_), .b(new_n400_), .c(x080), .O(new_n405_));
  oai21  g249(.a(new_n405_), .b(new_n397_), .c(new_n177_), .O(new_n406_));
  nand3  g250(.a(x072), .b(x064), .c(x016), .O(new_n407_));
  nand3  g251(.a(new_n407_), .b(new_n406_), .c(new_n382_), .O(new_n408_));
  nand3  g252(.a(new_n163_), .b(x024), .c(new_n167_), .O(new_n409_));
  oai21  g253(.a(new_n401_), .b(new_n168_), .c(new_n409_), .O(new_n410_));
  nand2  g254(.a(new_n410_), .b(new_n161_), .O(new_n411_));
  nand2  g255(.a(new_n399_), .b(new_n163_), .O(new_n412_));
  ...
  aoi21  g265(.a(new_n408_), .b(new_n171_), .c(new_n421_), .O(new_n422_));
  ...
  oai21  g373(.a(new_n529_), .b(x045), .c(new_n159_), .O(z13));
  ...
  nor2   g425(.a(x078), .b(new_n157_), .O(z24));
  nor2   g426(.a(x078), .b(new_n157_), .O(z25));
  nor2   g427(.a(x078), .b(new_n157_), .O(z26));
endmodule
