...
module FAU ( 
  ...
  nand2  g000(.a(x078), .b(x015), .O(new_n157_));
  ...
  oai21  g227(.a(new_n383_), .b(new_n322_), .c(new_n157_), .O(z06));
  ...
  nand3  g294(.a(x082), .b(new_n206_), .c(x002), .O(new_n452_));
  oai21  g295(.a(new_n451_), .b(new_n206_), .c(new_n452_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n205_), .O(new_n454_));
  nand3  g297(.a(x082), .b(x010), .c(x002), .O(new_n455_));
  oai21  g298(.a(new_n451_), .b(x010), .c(new_n455_), .O(new_n456_));
  oai21  g299(.a(new_n212_), .b(x034), .c(new_n456_), .O(new_n457_));
  nand2  g300(.a(x082), .b(x002), .O(new_n458_));
  aoi21  g301(.a(new_n458_), .b(new_n451_), .c(x074), .O(new_n459_));
  oai22  g302(.a(new_n213_), .b(new_n206_), .c(new_n212_), .d(new_n205_), .O(new_n460_));
  aoi21  g303(.a(new_n459_), .b(new_n206_), .c(new_n460_), .O(new_n461_));
  nand3  g304(.a(new_n461_), .b(new_n457_), .c(new_n454_), .O(new_n462_));
  nand3  g305(.a(new_n462_), .b(new_n157_), .c(new_n450_), .O(new_n463_));
  ...
  oai21  g389(.a(new_n546_), .b(new_n544_), .c(new_n324_), .O(new_n547_));
  ...
  nand3  g398(.a(new_n323_), .b(x126), .c(new_n330_), .O(new_n556_));
  ...
  oai21  g408(.a(new_n565_), .b(new_n560_), .c(new_n324_), .O(new_n566_));
  ...
  oai21  g428(.a(new_n585_), .b(x046), .c(new_n157_), .O(z14));
  zero   g429(.O(z07));
  zero   g430(.O(z19));
  zero   g431(.O(z21));
  zero   g432(.O(z22));
  zero   g433(.O(z24));
  zero   g434(.O(z27));
  inv1   g435(.a(new_n157_), .O(z16));
  inv1   g436(.a(new_n157_), .O(z17));
  inv1   g437(.a(new_n157_), .O(z18));
  inv1   g438(.a(new_n157_), .O(z20));
  inv1   g439(.a(new_n157_), .O(z23));
  inv1   g440(.a(new_n157_), .O(z25));
  inv1   g441(.a(new_n157_), .O(z26));
endmodule
