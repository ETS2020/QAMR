...
module FAU ( 
  ...
  oai21  g375(.a(new_n531_), .b(x045), .c(new_n179_), .O(z13));
  inv1   g376(.a(x046), .O(new_n533_));
  nand2  g377(.a(new_n361_), .b(x038), .O(new_n534_));
  nand3  g378(.a(new_n534_), .b(x086), .c(x006), .O(new_n535_));
  nand2  g379(.a(x054), .b(x038), .O(new_n536_));
  nand3  g380(.a(x070), .b(new_n361_), .c(x022), .O(new_n537_));
  nand4  g381(.a(new_n537_), .b(new_n536_), .c(new_n535_), .d(new_n333_), .O(new_n538_));
  nand3  g382(.a(new_n538_), .b(x078), .c(new_n533_), .O(new_n539_));
  inv1   g383(.a(new_n539_), .O(z14));
  zero   g384(.O(z17));
  zero   g385(.O(z18));
  zero   g386(.O(z19));
  zero   g387(.O(z20));
