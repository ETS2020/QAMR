...
module FAU ( 
  ...
  aoi21  g09(.a(x10), .b(x09), .c(new_n30_), .O(new_n38_));
  ...
  nand2  g14(.a(new_n38_), .b(x01), .O(new_n43_));
  ...
  nand2  g18(.a(new_n38_), .b(x02), .O(new_n47_));
  ...
  nand2  g24(.a(new_n38_), .b(x03), .O(new_n53_));
  ...
  nand2  g33(.a(new_n38_), .b(x04), .O(new_n62_));
  nand2  g34(.a(new_n54_), .b(x15), .O(new_n63_));
  inv1   g35(.a(x15), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(x13), .O(new_n65_));
  ...
  aoi21  g49(.a(new_n77_), .b(new_n30_), .c(x10), .O(new_n78_));
  nand2  g50(.a(x08), .b(x05), .O(new_n79_));
  oai21  g51(.a(new_n78_), .b(new_n72_), .c(new_n79_), .O(z6));
  ...
  aoi21  g57(.a(new_n85_), .b(new_n30_), .c(x10), .O(new_n86_));
  nand2  g58(.a(x08), .b(x06), .O(new_n87_));
  oai21  g59(.a(new_n86_), .b(new_n72_), .c(new_n87_), .O(z7));
  nand2  g60(.a(new_n38_), .b(x07), .O(new_n89_));
  nand4  g61(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n54_), .c(x18), .O(new_n91_));
