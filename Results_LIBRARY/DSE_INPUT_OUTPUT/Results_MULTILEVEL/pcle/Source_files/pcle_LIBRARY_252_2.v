...
module FAU ( 
  ...
  oai21  g27(.a(new_n37_), .b(x03), .c(x08), .O(new_n56_));
  nand3  g28(.a(x13), .b(x12), .c(x11), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(x14), .O(new_n58_));
  nand2  g30(.a(new_n31_), .b(x13), .O(new_n59_));
  oai21  g31(.a(new_n59_), .b(new_n49_), .c(new_n58_), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(new_n37_), .c(x09), .O(new_n61_));
  ...
  oai22  g37(.a(new_n65_), .b(new_n49_), .c(new_n64_), .d(new_n32_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n67_));
  ...
  oai21  g57(.a(new_n37_), .b(x07), .c(x08), .O(new_n86_));
