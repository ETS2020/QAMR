...
module FAU ( 
  ...
  nor2   g39(.a(x15), .b(new_n53_), .O(new_n68_));
  aoi22  g40(.a(new_n68_), .b(new_n55_), .c(new_n61_), .d(x15), .O(new_n69_));
  nand2  g41(.a(x15), .b(new_n63_), .O(new_n70_));
  oai21  g42(.a(new_n69_), .b(new_n63_), .c(new_n70_), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n72_));
  aoi21  g44(.a(x08), .b(x04), .c(new_n48_), .O(new_n73_));
  ...
  aoi21  g52(.a(x08), .b(x05), .c(new_n48_), .O(new_n81_));
  ...
  aoi21  g60(.a(x08), .b(x06), .c(new_n48_), .O(new_n89_));
