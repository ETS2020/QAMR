...
module FAU ( 
  ...
  aoi21  g10(.a(new_n29_), .b(new_n37_), .c(new_n38_), .O(new_n39_));
  ...
  nand4  g18(.a(new_n46_), .b(new_n45_), .c(x09), .d(new_n37_), .O(new_n47_));
  ...
  oai21  g25(.a(new_n53_), .b(new_n38_), .c(new_n45_), .O(new_n54_));
  nand2  g26(.a(x08), .b(x02), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(new_n54_), .O(z3));
  nand2  g28(.a(new_n43_), .b(x03), .O(new_n57_));
  nand3  g29(.a(x13), .b(x12), .c(x11), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(x14), .O(new_n59_));
  nand2  g31(.a(new_n31_), .b(x13), .O(new_n60_));
  oai21  g32(.a(new_n60_), .b(new_n49_), .c(new_n59_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n45_), .c(x09), .d(new_n37_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n57_), .O(z4));
  nand2  g35(.a(new_n43_), .b(x04), .O(new_n64_));
  nand2  g36(.a(new_n58_), .b(x15), .O(new_n65_));
  nand4  g37(.a(new_n32_), .b(x13), .c(x12), .d(x11), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x14), .O(new_n68_));
  nand2  g40(.a(x15), .b(new_n31_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n45_), .c(x09), .d(new_n37_), .O(new_n71_));
  ...
  aoi21  g49(.a(new_n77_), .b(new_n37_), .c(new_n38_), .O(new_n78_));
  nand2  g50(.a(x08), .b(x05), .O(new_n79_));
  oai21  g51(.a(new_n78_), .b(x10), .c(new_n79_), .O(z6));
  nand2  g52(.a(new_n43_), .b(x06), .O(new_n81_));
  ...
  nand4  g58(.a(new_n86_), .b(new_n45_), .c(x09), .d(new_n37_), .O(new_n87_));
  ...
  nor2   g62(.a(new_n75_), .b(new_n32_), .O(new_n91_));
  nand4  g63(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n92_));
  inv1   g64(.a(new_n92_), .O(new_n93_));
  nor2   g65(.a(x18), .b(new_n84_), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(new_n93_), .c(new_n91_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n90_), .c(x08), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n38_), .c(new_n45_), .O(new_n97_));
