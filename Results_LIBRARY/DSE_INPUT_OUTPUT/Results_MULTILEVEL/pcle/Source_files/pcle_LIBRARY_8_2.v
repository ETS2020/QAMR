...
module FAU ( 
  ...
  aoi21  g12(.a(new_n40_), .b(x15), .c(new_n29_), .O(z0));
  nor2   g13(.a(x15), .b(new_n29_), .O(new_n42_));
  ...
  nand4  g61(.a(new_n36_), .b(new_n38_), .c(x17), .d(x16), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n32_), .c(x15), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(x14), .O(new_n92_));
  nand3  g64(.a(x17), .b(x16), .c(x14), .O(new_n93_));
  inv1   g65(.a(new_n93_), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n67_), .c(new_n38_), .O(new_n95_));
