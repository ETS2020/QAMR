...
module FAU ( 
  ...
  nand4  g24(.a(new_n52_), .b(new_n29_), .c(x09), .d(new_n47_), .O(new_n53_));
  ...
  oai21  g32(.a(new_n60_), .b(x10), .c(new_n47_), .O(new_n61_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n29_), .c(x09), .d(new_n47_), .O(new_n84_));
  ...
  aoi21  g63(.a(new_n91_), .b(new_n88_), .c(new_n56_), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(x10), .c(new_n47_), .O(new_n93_));
