...
module FAU ( 
  ...
  nand4  g31(.a(new_n34_), .b(x16), .c(new_n31_), .d(new_n38_), .O(new_n61_));
  oai21  g32(.a(new_n32_), .b(new_n60_), .c(new_n61_), .O(z6));
  ...
  nand2  g38(.a(x18), .b(x09), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(x08), .c(new_n31_), .O(new_n69_));
