...
module FAU ( 
  ...
  aoi21  g09(.a(x10), .b(x01), .c(new_n30_), .O(new_n38_));
  ...
  nand3  g15(.a(new_n43_), .b(x09), .c(new_n30_), .O(new_n44_));
  nand2  g16(.a(x08), .b(x01), .O(new_n45_));
  aoi21  g17(.a(new_n45_), .b(new_n44_), .c(x10), .O(z2));
  nand2  g18(.a(x10), .b(x01), .O(new_n47_));
  nand3  g19(.a(new_n47_), .b(x08), .c(x02), .O(new_n48_));
  ...
  nand2  g34(.a(new_n38_), .b(x04), .O(new_n63_));
  ...
  aoi22  g50(.a(x10), .b(x01), .c(x08), .d(x05), .O(new_n79_));
