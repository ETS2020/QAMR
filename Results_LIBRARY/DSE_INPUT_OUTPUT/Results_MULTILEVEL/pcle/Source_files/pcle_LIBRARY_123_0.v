...
module FAU ( 
  ...
  nand4  g35(.a(new_n63_), .b(x09), .c(new_n31_), .d(x01), .O(new_n64_));
  oai21  g36(.a(new_n41_), .b(new_n57_), .c(new_n64_), .O(z4));
  ...
  oai22  g52(.a(new_n80_), .b(new_n45_), .c(new_n41_), .d(new_n74_), .O(z6));
  ...
  oai22  g60(.a(new_n88_), .b(new_n45_), .c(new_n41_), .d(new_n82_), .O(z7));
  ...
  aoi21  g67(.a(new_n95_), .b(new_n31_), .c(new_n45_), .O(new_n96_));
