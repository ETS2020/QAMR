...
module FAU ( 
  ...
  nand4  g34(.a(new_n62_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n63_));
  ...
  nand4  g44(.a(new_n72_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n65_), .O(z5));
  oai21  g46(.a(new_n33_), .b(new_n31_), .c(x16), .O(new_n75_));
  ...
  nand4  g50(.a(new_n78_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n79_));
  aoi21  g51(.a(x08), .b(x05), .c(new_n54_), .O(new_n80_));
  ...
  nand4  g59(.a(new_n87_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n82_), .O(z7));
  nand2  g61(.a(new_n44_), .b(x07), .O(new_n90_));
  ...
  nor2   g65(.a(new_n60_), .b(new_n49_), .O(new_n94_));
