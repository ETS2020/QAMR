...
module FAU ( 
  ...
  nand3  g14(.a(new_n42_), .b(x09), .c(new_n30_), .O(new_n43_));
  ...
  nand3  g29(.a(new_n57_), .b(x09), .c(new_n30_), .O(new_n58_));
  nand2  g30(.a(x08), .b(x03), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n58_), .c(x10), .O(z4));
  ...
  oai21  g43(.a(new_n71_), .b(new_n54_), .c(x16), .O(new_n72_));
  ...
  oai21  g60(.a(new_n88_), .b(new_n52_), .c(x18), .O(new_n89_));
