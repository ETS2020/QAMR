...
module FAU ( 
  ...
  nor2   g04(.a(new_n31_), .b(x08), .O(new_n34_));
  ...
  nand3  g12(.a(new_n41_), .b(new_n36_), .c(new_n40_), .O(new_n42_));
  nand2  g13(.a(new_n42_), .b(new_n32_), .O(new_n43_));
  nand2  g14(.a(new_n43_), .b(x09), .O(new_n44_));
  nand2  g15(.a(x08), .b(x01), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(new_n44_), .O(z2));
  inv1   g17(.a(x02), .O(new_n47_));
  nand2  g18(.a(x12), .b(x11), .O(new_n48_));
  nand2  g19(.a(new_n48_), .b(x13), .O(new_n49_));
  inv1   g20(.a(x13), .O(new_n50_));
  nand3  g21(.a(new_n50_), .b(x12), .c(x11), .O(new_n51_));
  aoi21  g22(.a(new_n51_), .b(new_n49_), .c(x17), .O(new_n52_));
  nand4  g23(.a(new_n52_), .b(new_n36_), .c(x09), .d(new_n40_), .O(new_n53_));
  oai21  g24(.a(new_n33_), .b(new_n47_), .c(new_n53_), .O(z3));
  ...
  aoi21  g30(.a(new_n59_), .b(new_n56_), .c(x10), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n40_), .c(x17), .O(new_n61_));
  nand2  g32(.a(x08), .b(x03), .O(new_n62_));
  oai21  g33(.a(new_n61_), .b(new_n31_), .c(new_n62_), .O(z4));
  inv1   g34(.a(x04), .O(new_n64_));
  nand2  g35(.a(x14), .b(x13), .O(new_n65_));
  oai21  g36(.a(new_n65_), .b(new_n48_), .c(x15), .O(new_n66_));
  inv1   g37(.a(x15), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(x14), .c(x13), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(new_n48_), .c(new_n66_), .O(new_n69_));
  nand4  g40(.a(new_n69_), .b(new_n32_), .c(new_n36_), .d(x09), .O(new_n70_));
  oai22  g41(.a(new_n70_), .b(x08), .c(new_n33_), .d(new_n64_), .O(z5));
  nand3  g42(.a(x15), .b(x14), .c(x13), .O(new_n72_));
  oai21  g43(.a(new_n72_), .b(new_n48_), .c(x16), .O(new_n73_));
  inv1   g44(.a(new_n55_), .O(new_n74_));
  nor2   g45(.a(x16), .b(new_n67_), .O(new_n75_));
  nand3  g46(.a(new_n75_), .b(new_n74_), .c(x14), .O(new_n76_));
  aoi21  g47(.a(new_n76_), .b(new_n73_), .c(x10), .O(new_n77_));
  aoi21  g48(.a(new_n77_), .b(new_n40_), .c(x17), .O(new_n78_));
  nand2  g49(.a(x08), .b(x05), .O(new_n79_));
  oai21  g50(.a(new_n78_), .b(new_n31_), .c(new_n79_), .O(z6));
  inv1   g51(.a(x06), .O(new_n81_));
  nand3  g52(.a(new_n58_), .b(new_n34_), .c(new_n36_), .O(new_n82_));
  inv1   g53(.a(new_n65_), .O(new_n83_));
  nand4  g54(.a(new_n83_), .b(new_n32_), .c(x16), .d(x15), .O(new_n84_));
  oai22  g55(.a(new_n84_), .b(new_n82_), .c(new_n33_), .d(new_n81_), .O(z7));
  inv1   g56(.a(x07), .O(new_n86_));
  nand3  g57(.a(x18), .b(new_n32_), .c(new_n36_), .O(new_n87_));
  oai22  g58(.a(new_n87_), .b(new_n35_), .c(new_n33_), .d(new_n86_), .O(z8));
  zero   g59(.O(z0));
endmodule
