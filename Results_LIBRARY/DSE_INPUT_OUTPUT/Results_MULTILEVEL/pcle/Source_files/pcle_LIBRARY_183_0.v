...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n34_, new_n36_, new_n39_, new_n41_, new_n43_;
  ...
  nand2  g11(.a(x08), .b(x06), .O(new_n41_));
  oai21  g12(.a(x10), .b(x08), .c(new_n41_), .O(z7));
  nand2  g13(.a(x08), .b(x07), .O(new_n43_));
  oai21  g14(.a(x10), .b(x08), .c(new_n43_), .O(z8));
  zero   g15(.O(z0));
endmodule
