...
module FAU ( 
  ...
  oai21  g29(.a(new_n57_), .b(new_n41_), .c(new_n31_), .O(new_n58_));
  ...
  oai21  g45(.a(new_n46_), .b(new_n66_), .c(new_n73_), .O(z5));
  inv1   g46(.a(x05), .O(new_n75_));
  nand3  g47(.a(x15), .b(x14), .c(x13), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n68_), .c(x16), .O(new_n77_));
  ...
  oai21  g53(.a(new_n46_), .b(new_n75_), .c(new_n81_), .O(z6));
  nand3  g54(.a(new_n42_), .b(x12), .c(x11), .O(new_n83_));
  ...
  nor2   g59(.a(new_n78_), .b(new_n67_), .O(new_n88_));
  ...
  nand4  g69(.a(new_n88_), .b(new_n70_), .c(new_n29_), .d(x17), .O(new_n98_));
  nand2  g70(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n100_));
  oai21  g72(.a(new_n46_), .b(new_n95_), .c(new_n100_), .O(z8));
endmodule
