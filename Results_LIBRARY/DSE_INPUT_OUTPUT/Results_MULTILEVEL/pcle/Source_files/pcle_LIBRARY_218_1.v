...
module FAU ( 
  ...
  nor3   g05(.a(x17), .b(x11), .c(x10), .O(new_n35_));
  ...
  aoi21  g21(.a(new_n50_), .b(new_n39_), .c(x17), .O(new_n51_));
  ...
  nand4  g31(.a(new_n60_), .b(new_n38_), .c(x09), .d(new_n39_), .O(new_n61_));
  ...
  aoi21  g37(.a(new_n66_), .b(new_n64_), .c(new_n33_), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(new_n39_), .c(x17), .O(new_n68_));
  ...
  nand4  g47(.a(new_n76_), .b(new_n31_), .c(new_n38_), .d(x09), .O(new_n77_));
  oai22  g48(.a(new_n77_), .b(x08), .c(new_n32_), .d(new_n71_), .O(z6));
  nand2  g49(.a(new_n58_), .b(new_n34_), .O(new_n79_));
  nand4  g50(.a(x16), .b(x15), .c(x14), .d(x13), .O(new_n80_));
  oai21  g51(.a(new_n80_), .b(new_n79_), .c(new_n31_), .O(new_n81_));
  ...
  nand4  g56(.a(new_n34_), .b(x18), .c(new_n31_), .d(new_n38_), .O(new_n86_));
  oai21  g57(.a(new_n32_), .b(new_n85_), .c(new_n86_), .O(z8));
  zero   g58(.O(z0));
endmodule
