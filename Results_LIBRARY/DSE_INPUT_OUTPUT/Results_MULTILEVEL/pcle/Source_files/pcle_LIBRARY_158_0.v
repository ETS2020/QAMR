...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(new_n31_), .c(new_n30_), .O(new_n39_));
  nand2  g11(.a(new_n39_), .b(x00), .O(new_n40_));
  nor2   g12(.a(new_n38_), .b(x11), .O(new_n41_));
  ...
  nand4  g19(.a(new_n47_), .b(x12), .c(new_n31_), .d(x09), .O(new_n48_));
  oai21  g20(.a(new_n48_), .b(x08), .c(new_n46_), .O(z3));
  ...
  nand3  g25(.a(new_n53_), .b(x13), .c(x11), .O(new_n54_));
  aoi21  g26(.a(new_n54_), .b(new_n52_), .c(new_n38_), .O(new_n55_));
  nand4  g27(.a(new_n55_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n50_), .O(z4));
  nand2  g29(.a(new_n39_), .b(x04), .O(new_n58_));
  nand2  g30(.a(new_n51_), .b(x15), .O(new_n59_));
  ...
  nand2  g35(.a(x15), .b(new_n53_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n63_), .c(new_n38_), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n58_), .O(z5));
  inv1   g39(.a(x09), .O(new_n68_));
  nand2  g40(.a(x15), .b(x14), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(new_n51_), .c(x16), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  inv1   g43(.a(new_n51_), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(new_n71_), .c(x15), .d(x14), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n70_), .c(new_n68_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n30_), .c(new_n38_), .O(new_n75_));
  ...
  nand3  g51(.a(x14), .b(x13), .c(x11), .O(new_n80_));
  inv1   g52(.a(new_n80_), .O(new_n81_));
  nor2   g53(.a(x17), .b(new_n71_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(x15), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n79_), .c(new_n68_), .O(new_n84_));
  ...
  nand4  g62(.a(new_n81_), .b(new_n90_), .c(new_n29_), .d(x17), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n89_), .c(new_n68_), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n30_), .c(new_n38_), .O(new_n93_));
