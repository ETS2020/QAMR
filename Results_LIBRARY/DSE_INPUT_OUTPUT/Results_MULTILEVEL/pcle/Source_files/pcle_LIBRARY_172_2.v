...
module FAU ( 
  ...
  nand2  g26(.a(new_n39_), .b(x08), .O(new_n55_));
  ...
  oai21  g33(.a(new_n55_), .b(new_n54_), .c(new_n61_), .O(z4));
  nand3  g34(.a(x11), .b(x09), .c(new_n30_), .O(new_n63_));
  nand3  g35(.a(x14), .b(x13), .c(x12), .O(new_n64_));
  oai21  g36(.a(new_n64_), .b(new_n63_), .c(new_n31_), .O(new_n65_));
  ...
  oai21  g68(.a(new_n55_), .b(new_n90_), .c(new_n96_), .O(z8));
endmodule
