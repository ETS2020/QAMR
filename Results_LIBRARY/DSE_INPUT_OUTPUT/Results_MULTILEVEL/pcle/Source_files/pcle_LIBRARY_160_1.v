...
module FAU ( 
  ...
  nand2  g17(.a(x10), .b(new_n38_), .O(new_n46_));
  ...
  oai21  g21(.a(new_n47_), .b(new_n45_), .c(new_n49_), .O(z2));
  ...
  oai21  g27(.a(new_n47_), .b(new_n51_), .c(new_n55_), .O(z3));
  ...
  inv1   g35(.a(new_n46_), .O(new_n64_));
  ...
  oai22  g43(.a(new_n71_), .b(new_n59_), .c(new_n70_), .d(new_n68_), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n73_));
  oai21  g45(.a(new_n47_), .b(new_n67_), .c(new_n73_), .O(z5));
  ...
  oai21  g61(.a(new_n47_), .b(new_n83_), .c(new_n89_), .O(z7));
  ...
  nand4  g65(.a(new_n93_), .b(new_n70_), .c(new_n29_), .d(x17), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n96_));
  aoi21  g68(.a(x08), .b(x07), .c(new_n64_), .O(new_n97_));
