...
module FAU ( 
  ...
  aoi21  g29(.a(new_n57_), .b(new_n32_), .c(x04), .O(new_n58_));
  ...
  aoi21  g36(.a(new_n64_), .b(new_n32_), .c(x04), .O(new_n65_));
  nand2  g37(.a(x08), .b(x03), .O(new_n66_));
  oai21  g38(.a(new_n65_), .b(x10), .c(new_n66_), .O(z4));
  oai21  g39(.a(new_n33_), .b(x08), .c(x04), .O(new_n68_));
  ...
  nand2  g47(.a(new_n33_), .b(x04), .O(new_n76_));
  ...
  nor2   g59(.a(x17), .b(new_n80_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n87_), .c(x15), .d(x14), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n86_), .c(new_n52_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n32_), .c(x04), .O(new_n91_));
  ...
  aoi21  g69(.a(new_n97_), .b(new_n95_), .c(new_n52_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n32_), .c(x04), .O(new_n99_));
