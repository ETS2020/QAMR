...
module FAU ( 
  ...
  nand2  g10(.a(x10), .b(x06), .O(new_n39_));
  ...
  nand2  g35(.a(new_n63_), .b(new_n56_), .O(z4));
  nand2  g36(.a(new_n55_), .b(x04), .O(new_n65_));
  ...
  aoi21  g52(.a(x08), .b(x05), .c(new_n52_), .O(new_n81_));
  ...
  nand3  g59(.a(new_n87_), .b(x09), .c(new_n30_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n88_), .c(x10), .O(z7));
  nand2  g62(.a(x10), .b(x06), .O(new_n91_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(new_n97_));
