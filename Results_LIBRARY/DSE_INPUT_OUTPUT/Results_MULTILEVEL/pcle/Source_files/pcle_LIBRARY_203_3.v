...
module FAU ( 
  ...
  nand2  g02(.a(x05), .b(x00), .O(new_n31_));
  ...
  oai21  g09(.a(x08), .b(x05), .c(x00), .O(new_n38_));
  ...
  aoi21  g24(.a(x08), .b(x02), .c(new_n43_), .O(new_n53_));
  ...
  nand3  g36(.a(new_n49_), .b(x14), .c(x13), .O(new_n65_));
  ...
  oai21  g43(.a(x08), .b(x00), .c(x05), .O(new_n72_));
  nor2   g44(.a(new_n63_), .b(new_n57_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n49_), .c(x13), .O(new_n74_));
  ...
  nand3  g55(.a(new_n73_), .b(new_n83_), .c(x16), .O(new_n84_));
  ...
  aoi21  g59(.a(new_n87_), .b(new_n86_), .c(new_n43_), .O(z7));
  nand3  g60(.a(new_n73_), .b(x17), .c(x16), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n55_), .c(x18), .O(new_n90_));
  nor2   g62(.a(new_n76_), .b(new_n63_), .O(new_n91_));
  nor2   g63(.a(x18), .b(new_n83_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n91_), .c(new_n66_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n29_), .c(x09), .d(new_n39_), .O(new_n95_));
  aoi21  g67(.a(x08), .b(x07), .c(new_n43_), .O(new_n96_));
