...
module FAU ( 
  ...
  nand4  g38(.a(new_n39_), .b(x13), .c(x12), .d(x11), .O(new_n67_));
  oai21  g39(.a(new_n61_), .b(new_n39_), .c(new_n67_), .O(new_n68_));
  ...
  aoi22  g44(.a(x15), .b(new_n41_), .c(x08), .d(x04), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n72_), .O(z5));
  nand3  g46(.a(new_n31_), .b(x09), .c(new_n30_), .O(new_n75_));
  inv1   g47(.a(x16), .O(new_n76_));
  nand3  g48(.a(new_n61_), .b(new_n76_), .c(x14), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n75_), .c(x11), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(x15), .O(new_n79_));
  nand3  g51(.a(new_n61_), .b(x15), .c(x14), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(x16), .c(new_n31_), .O(new_n81_));
  ...
  nand3  g57(.a(new_n43_), .b(x12), .c(new_n31_), .O(new_n86_));
  inv1   g58(.a(x17), .O(new_n87_));
  and2   g59(.a(x14), .b(x13), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(x16), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n86_), .c(x11), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(x15), .O(new_n91_));
  nand3  g63(.a(x16), .b(x15), .c(x14), .O(new_n92_));
  inv1   g64(.a(new_n92_), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n61_), .c(new_n87_), .O(new_n94_));
  ...
  nand4  g69(.a(new_n88_), .b(new_n29_), .c(x17), .d(x16), .O(new_n98_));
  oai21  g70(.a(new_n98_), .b(new_n86_), .c(x11), .O(new_n99_));
  nand2  g71(.a(new_n99_), .b(x15), .O(new_n100_));
  nand2  g72(.a(new_n88_), .b(x12), .O(new_n101_));
  nand3  g73(.a(x17), .b(x16), .c(x15), .O(new_n102_));
  nor2   g74(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nor2   g75(.a(new_n103_), .b(new_n29_), .O(new_n104_));
