...
module FAU ( 
  ...
  aoi21  g26(.a(new_n41_), .b(x06), .c(new_n42_), .O(new_n55_));
  ...
  nand2  g35(.a(new_n31_), .b(x14), .O(new_n64_));
  nand4  g36(.a(new_n33_), .b(x13), .c(x12), .d(x11), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n64_), .c(new_n30_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n42_), .c(x06), .O(new_n67_));
  ...
  oai21  g47(.a(new_n75_), .b(x06), .c(new_n70_), .O(z5));
  ...
  nor2   g67(.a(new_n79_), .b(new_n34_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n72_), .c(new_n37_), .d(x17), .O(new_n97_));
