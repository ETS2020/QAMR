...
module FAU ( 
  ...
  nand4  g46(.a(new_n74_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n75_));
  nand2  g47(.a(new_n38_), .b(x05), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z6));
  oai21  g49(.a(new_n40_), .b(x06), .c(x08), .O(new_n78_));
  ...
  nand3  g55(.a(new_n83_), .b(new_n40_), .c(x09), .O(new_n84_));
