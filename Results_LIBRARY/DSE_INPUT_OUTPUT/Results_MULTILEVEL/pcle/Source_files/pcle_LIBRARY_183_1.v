...
module FAU ( 
  ...
  oai21  g36(.a(new_n64_), .b(new_n61_), .c(new_n62_), .O(new_n65_));
  ...
  oai21  g44(.a(new_n72_), .b(new_n61_), .c(x16), .O(new_n73_));
  ...
  aoi21  g65(.a(new_n93_), .b(new_n89_), .c(new_n52_), .O(new_n94_));
