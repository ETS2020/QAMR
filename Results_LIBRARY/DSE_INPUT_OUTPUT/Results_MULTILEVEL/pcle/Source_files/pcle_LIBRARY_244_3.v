...
module FAU ( 
  ...
  nand2  g39(.a(x15), .b(new_n35_), .O(new_n68_));
  ...
  nand2  g45(.a(new_n33_), .b(new_n29_), .O(new_n74_));
  nor2   g46(.a(new_n35_), .b(new_n34_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n30_), .c(x15), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n74_), .c(new_n73_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(x09), .c(new_n31_), .O(new_n78_));
  ...
  nor2   g63(.a(new_n30_), .b(new_n64_), .O(new_n92_));
  nor2   g64(.a(x18), .b(new_n84_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(new_n75_), .d(new_n33_), .O(new_n94_));
