...
module FAU ( 
  ...
  oai21  g26(.a(new_n54_), .b(x10), .c(new_n44_), .O(new_n55_));
  ...
  aoi21  g38(.a(new_n66_), .b(new_n65_), .c(new_n32_), .O(new_n67_));
  nor2   g39(.a(new_n33_), .b(x14), .O(new_n68_));
  ...
  aoi21  g50(.a(new_n78_), .b(x09), .c(x10), .O(new_n79_));
  ...
  nand3  g55(.a(new_n34_), .b(new_n35_), .c(x16), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n58_), .c(new_n83_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(x09), .c(x10), .O(new_n86_));
  ...
  nor2   g62(.a(new_n76_), .b(new_n33_), .O(new_n91_));
  nand4  g63(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n92_));
  inv1   g64(.a(new_n92_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n91_), .c(new_n36_), .d(x17), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n90_), .c(new_n49_), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(x10), .c(new_n44_), .O(new_n96_));
