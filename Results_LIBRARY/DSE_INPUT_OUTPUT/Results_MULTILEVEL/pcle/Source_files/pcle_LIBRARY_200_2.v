...
module FAU ( 
  ...
  oai21  g45(.a(new_n46_), .b(new_n67_), .c(new_n73_), .O(z5));
  ...
  nor2   g63(.a(new_n91_), .b(new_n68_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n52_), .c(new_n41_), .O(new_n93_));
  ...
  aoi21  g69(.a(new_n97_), .b(new_n61_), .c(new_n29_), .O(new_n98_));
