...
module FAU ( 
  ...
  nand2  g03(.a(new_n31_), .b(x00), .O(new_n32_));
  ...
  oai21  g10(.a(x08), .b(new_n31_), .c(x00), .O(new_n39_));
  ...
  nand4  g17(.a(new_n45_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n46_));
  nand2  g18(.a(x08), .b(x01), .O(new_n47_));
  aoi21  g19(.a(new_n47_), .b(new_n46_), .c(new_n44_), .O(z2));
  ...
  aoi21  g25(.a(x08), .b(x02), .c(new_n44_), .O(new_n54_));
  ...
  aoi21  g33(.a(x08), .b(x03), .c(new_n44_), .O(new_n62_));
  ...
  aoi21  g42(.a(x08), .b(x04), .c(new_n44_), .O(new_n71_));
  ...
  nand3  g52(.a(new_n80_), .b(new_n79_), .c(new_n39_), .O(z6));
  ...
  aoi21  g61(.a(new_n89_), .b(new_n88_), .c(new_n44_), .O(z7));
  ...
  aoi21  g68(.a(x08), .b(x07), .c(new_n44_), .O(new_n97_));
