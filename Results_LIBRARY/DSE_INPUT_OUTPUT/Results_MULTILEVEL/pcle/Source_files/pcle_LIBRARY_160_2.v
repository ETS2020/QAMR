...
module FAU ( 
  ...
  oai21  g16(.a(x10), .b(new_n31_), .c(x08), .O(new_n45_));
  xor2a  g17(.a(x12), .b(x11), .O(new_n46_));
  nand4  g18(.a(new_n46_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n47_));
  oai22  g19(.a(new_n47_), .b(x00), .c(new_n45_), .d(new_n44_), .O(z2));
  ...
  oai22  g42(.a(new_n70_), .b(x00), .c(new_n45_), .d(new_n63_), .O(z5));
  nand3  g43(.a(x15), .b(x14), .c(x13), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n65_), .c(x16), .O(new_n73_));
  inv1   g45(.a(x16), .O(new_n74_));
  inv1   g46(.a(new_n56_), .O(new_n75_));
  nand4  g47(.a(new_n75_), .b(new_n74_), .c(x15), .d(x14), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(new_n73_), .c(new_n55_), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n32_), .c(x00), .O(new_n78_));
  ...
  oai22  g59(.a(new_n87_), .b(x00), .c(new_n45_), .d(new_n81_), .O(z7));
  ...
  aoi21  g64(.a(new_n92_), .b(new_n90_), .c(new_n55_), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n32_), .c(x00), .O(new_n94_));
