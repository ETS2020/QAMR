...
module FAU ( 
  ...
  nand2  g29(.a(new_n33_), .b(x13), .O(new_n58_));
  oai21  g30(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  nand4  g31(.a(new_n59_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n60_));
  ...
  oai22  g36(.a(new_n64_), .b(new_n57_), .c(new_n63_), .d(new_n34_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n39_), .c(x10), .O(new_n66_));
  nand2  g38(.a(x08), .b(x04), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(new_n29_), .c(new_n67_), .O(z5));
  nand2  g40(.a(new_n43_), .b(x05), .O(new_n69_));
  nand3  g41(.a(x15), .b(x14), .c(x13), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n57_), .c(x16), .O(new_n71_));
  ...
  nand4  g46(.a(new_n74_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n75_));
  ...
  nor2   g58(.a(new_n72_), .b(new_n34_), .O(new_n87_));
  nor2   g59(.a(x18), .b(new_n79_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(new_n63_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n86_), .c(x08), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(x10), .c(x09), .O(new_n91_));
