...
module FAU ( 
  ...
  oai21  g13(.a(new_n37_), .b(x01), .c(x08), .O(new_n42_));
  xor2a  g14(.a(x12), .b(x11), .O(new_n43_));
  nand3  g15(.a(new_n43_), .b(new_n37_), .c(x09), .O(new_n44_));
  ...
  nand4  g22(.a(new_n50_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n51_));
  nor2   g23(.a(new_n37_), .b(new_n29_), .O(new_n52_));
  ...
  oai21  g29(.a(new_n57_), .b(new_n46_), .c(new_n56_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n59_));
  ...
  oai22  g37(.a(new_n65_), .b(new_n46_), .c(new_n64_), .d(new_n32_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n37_), .c(x09), .O(new_n67_));
  ...
  nand4  g53(.a(new_n81_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n82_));
  ...
  nor2   g58(.a(new_n72_), .b(new_n32_), .O(new_n87_));
  ...
  nand4  g62(.a(new_n90_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n91_));
  nand2  g63(.a(new_n52_), .b(x07), .O(new_n92_));
