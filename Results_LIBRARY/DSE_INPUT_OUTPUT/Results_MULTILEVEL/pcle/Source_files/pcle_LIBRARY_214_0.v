...
module FAU ( 
  ...
  nand3  g12(.a(x16), .b(new_n40_), .c(new_n31_), .O(new_n41_));
  oai21  g13(.a(new_n41_), .b(new_n38_), .c(new_n39_), .O(z1));
  xor2a  g14(.a(x12), .b(x11), .O(new_n43_));
  nand4  g15(.a(new_n43_), .b(x16), .c(new_n31_), .d(x09), .O(new_n44_));
  ...
  nand4  g21(.a(new_n49_), .b(x16), .c(new_n31_), .d(x09), .O(new_n50_));
  nand2  g22(.a(x08), .b(x02), .O(new_n51_));
  oai21  g23(.a(new_n50_), .b(x08), .c(new_n51_), .O(z3));
  inv1   g24(.a(x16), .O(new_n53_));
  ...
  nand3  g30(.a(new_n58_), .b(new_n56_), .c(x13), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n55_), .c(new_n53_), .O(new_n60_));
  ...
  aoi21  g40(.a(new_n68_), .b(x09), .c(new_n53_), .O(new_n69_));
  ...
  nand2  g45(.a(new_n73_), .b(new_n58_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(x16), .c(new_n31_), .d(x09), .O(new_n75_));
  nand2  g47(.a(x08), .b(x05), .O(new_n76_));
  oai21  g48(.a(new_n75_), .b(x08), .c(new_n76_), .O(z6));
  oai21  g49(.a(new_n72_), .b(new_n57_), .c(x17), .O(new_n78_));
