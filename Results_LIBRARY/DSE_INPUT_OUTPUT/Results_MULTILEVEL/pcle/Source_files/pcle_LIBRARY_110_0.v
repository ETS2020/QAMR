...
module FAU ( 
  ...
  nor2   g53(.a(x17), .b(new_n73_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(x15), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n79_), .c(new_n51_), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n30_), .c(new_n50_), .O(new_n85_));
  ...
  nor2   g61(.a(new_n73_), .b(new_n61_), .O(new_n90_));
  nand4  g62(.a(new_n81_), .b(new_n90_), .c(new_n29_), .d(x17), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n89_), .c(new_n51_), .O(new_n92_));
