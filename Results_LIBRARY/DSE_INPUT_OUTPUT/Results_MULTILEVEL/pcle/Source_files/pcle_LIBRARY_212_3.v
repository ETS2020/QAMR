...
module FAU ( 
  ...
  nand2  g25(.a(new_n38_), .b(x08), .O(new_n54_));
  ...
  aoi21  g52(.a(x08), .b(x05), .c(new_n51_), .O(new_n81_));
  ...
  aoi21  g60(.a(x08), .b(x06), .c(new_n51_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n88_), .O(z7));
  nand2  g62(.a(new_n55_), .b(x07), .O(new_n91_));
