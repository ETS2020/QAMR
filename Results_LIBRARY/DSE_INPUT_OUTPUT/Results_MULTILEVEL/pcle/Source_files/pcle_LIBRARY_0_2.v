// Benchmark "FAU" written by ABC on Fri Aug 14 01:56:44 2020
...
module FAU ( 
  ...
  oai21  g10(.a(x12), .b(new_n31_), .c(x08), .O(new_n39_));
  ...
  nand3  g14(.a(x12), .b(new_n40_), .c(new_n31_), .O(new_n43_));
  oai21  g15(.a(x12), .b(new_n40_), .c(new_n43_), .O(new_n44_));
  nand3  g16(.a(new_n44_), .b(x09), .c(new_n30_), .O(new_n45_));
  inv1   g17(.a(x12), .O(new_n46_));
  aoi22  g18(.a(new_n46_), .b(x10), .c(x08), .d(x01), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(new_n45_), .O(z2));
  inv1   g20(.a(x02), .O(new_n49_));
  inv1   g21(.a(x13), .O(new_n50_));
  nor2   g22(.a(new_n46_), .b(new_n40_), .O(new_n51_));
  nand3  g23(.a(new_n50_), .b(x12), .c(x11), .O(new_n52_));
  oai21  g24(.a(new_n51_), .b(new_n50_), .c(new_n52_), .O(new_n53_));
  nand4  g25(.a(new_n53_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n54_));
  oai21  g26(.a(new_n39_), .b(new_n49_), .c(new_n54_), .O(z3));
  nand2  g27(.a(x14), .b(x09), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(x08), .c(new_n31_), .O(new_n57_));
  ...
  nand3  g33(.a(new_n51_), .b(new_n61_), .c(x13), .O(new_n62_));
  ...
  nand3  g37(.a(new_n65_), .b(new_n64_), .c(new_n58_), .O(z4));
  inv1   g38(.a(x04), .O(new_n67_));
  inv1   g39(.a(x15), .O(new_n68_));
  inv1   g40(.a(new_n51_), .O(new_n69_));
  ...
  oai21  g46(.a(new_n39_), .b(new_n67_), .c(new_n74_), .O(z5));
  nand2  g47(.a(x16), .b(x09), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(x08), .c(new_n31_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n46_), .O(new_n78_));
  nand2  g50(.a(x15), .b(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n59_), .c(x16), .O(new_n80_));
  ...
  nand3  g58(.a(new_n86_), .b(new_n85_), .c(new_n78_), .O(z6));
  nand2  g59(.a(x17), .b(x09), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(x08), .c(new_n31_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n46_), .O(new_n90_));
  nand3  g62(.a(x16), .b(x15), .c(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n59_), .c(x17), .O(new_n92_));
  ...
  oai21  g72(.a(new_n100_), .b(new_n81_), .c(x18), .O(new_n101_));
  nor2   g73(.a(new_n82_), .b(new_n68_), .O(new_n102_));
  nand4  g74(.a(new_n102_), .b(new_n71_), .c(new_n29_), .d(x17), .O(new_n103_));
  nand2  g75(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand4  g76(.a(new_n104_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n105_));
  oai21  g77(.a(new_n39_), .b(new_n99_), .c(new_n105_), .O(z8));
endmodule
