...
module FAU ( 
  ...
  nand2  g09(.a(x10), .b(x04), .O(new_n38_));
  ...
  oai21  g34(.a(x10), .b(x08), .c(x04), .O(new_n63_));
  ...
  nand3  g42(.a(new_n38_), .b(x08), .c(x05), .O(new_n71_));
  ...
  aoi21  g64(.a(x08), .b(x07), .c(new_n51_), .O(new_n93_));
