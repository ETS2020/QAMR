...
module FAU ( 
  ...
  aoi21  g21(.a(new_n49_), .b(new_n31_), .c(x18), .O(new_n50_));
  ...
  aoi21  g29(.a(new_n57_), .b(new_n31_), .c(x18), .O(new_n58_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n29_), .c(new_n34_), .d(x09), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(x08), .c(new_n77_), .O(z7));
  nand4  g56(.a(x12), .b(x11), .c(x09), .d(new_n31_), .O(new_n85_));
  inv1   g57(.a(new_n85_), .O(new_n86_));
  nand3  g58(.a(x17), .b(x16), .c(x15), .O(new_n87_));
  nor2   g59(.a(new_n87_), .b(new_n62_), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n86_), .c(x18), .O(new_n89_));
  nand2  g61(.a(x08), .b(x07), .O(new_n90_));
  oai21  g62(.a(new_n89_), .b(x10), .c(new_n90_), .O(z8));
endmodule
