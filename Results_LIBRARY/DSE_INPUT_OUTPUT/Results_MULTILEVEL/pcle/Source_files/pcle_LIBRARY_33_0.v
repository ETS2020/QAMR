...
module FAU ( 
  ...
  aoi21  g59(.a(new_n87_), .b(new_n84_), .c(new_n50_), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n31_), .c(new_n46_), .O(new_n89_));
  ...
  oai21  g70(.a(new_n31_), .b(new_n46_), .c(new_n98_), .O(z8));
endmodule
