...
module FAU ( 
  ...
  nand3  g17(.a(new_n45_), .b(x08), .c(x00), .O(new_n46_));
  nand2  g18(.a(new_n29_), .b(new_n30_), .O(new_n47_));
  oai21  g19(.a(new_n47_), .b(new_n32_), .c(new_n46_), .O(z1));
  nand2  g20(.a(x08), .b(x01), .O(new_n49_));
  nand4  g21(.a(new_n33_), .b(x12), .c(new_n29_), .d(new_n30_), .O(new_n50_));
  nand3  g22(.a(new_n50_), .b(new_n49_), .c(new_n45_), .O(z2));
  ...
  nand3  g26(.a(new_n54_), .b(new_n53_), .c(new_n45_), .O(z3));
  ...
  nand3  g31(.a(new_n59_), .b(x14), .c(new_n30_), .O(new_n60_));
  inv1   g32(.a(new_n60_), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(x09), .c(new_n31_), .O(new_n62_));
  nand2  g34(.a(x08), .b(x03), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(new_n62_), .c(new_n58_), .O(z4));
  nand2  g36(.a(x15), .b(new_n30_), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n32_), .c(new_n29_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n44_), .O(new_n67_));
  xor2a  g39(.a(x15), .b(x14), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(x13), .c(x11), .O(new_n69_));
  nand2  g41(.a(x13), .b(x11), .O(new_n70_));
  inv1   g42(.a(new_n70_), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n37_), .c(new_n69_), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(new_n30_), .c(x09), .d(new_n31_), .O(new_n73_));
  nand2  g45(.a(x08), .b(x04), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n73_), .c(new_n67_), .O(z5));
  nand3  g47(.a(new_n45_), .b(x08), .c(x05), .O(new_n76_));
  ...
  oai21  g52(.a(new_n80_), .b(new_n70_), .c(new_n78_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(x12), .O(new_n82_));
  nand2  g54(.a(x16), .b(new_n29_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n30_), .c(x09), .d(new_n31_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n76_), .O(z6));
  nand3  g58(.a(new_n38_), .b(new_n39_), .c(x16), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n34_), .c(x12), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(x11), .O(new_n89_));
  nand3  g61(.a(x16), .b(x15), .c(x14), .O(new_n90_));
  inv1   g62(.a(new_n90_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n71_), .c(new_n39_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n30_), .c(x09), .d(new_n31_), .O(new_n93_));
  ...
  nor2   g73(.a(new_n101_), .b(new_n40_), .O(new_n102_));
