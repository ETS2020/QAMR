...
module FAU ( 
  ...
  aoi21  g15(.a(new_n43_), .b(x09), .c(x10), .O(new_n44_));
  nand2  g16(.a(x08), .b(x01), .O(new_n45_));
  oai21  g17(.a(new_n44_), .b(x08), .c(new_n45_), .O(z2));
  xnor2a g18(.a(x13), .b(x12), .O(new_n47_));
  nand2  g19(.a(x13), .b(new_n39_), .O(new_n48_));
  oai21  g20(.a(new_n47_), .b(new_n39_), .c(new_n48_), .O(new_n49_));
  aoi21  g21(.a(new_n49_), .b(x09), .c(x10), .O(new_n50_));
  nand2  g22(.a(x08), .b(x02), .O(new_n51_));
  oai21  g23(.a(new_n50_), .b(x08), .c(new_n51_), .O(z3));
  inv1   g24(.a(x08), .O(new_n53_));
  inv1   g25(.a(x09), .O(new_n54_));
  nand3  g26(.a(x13), .b(x12), .c(x11), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(x14), .O(new_n56_));
  nand4  g28(.a(new_n32_), .b(x13), .c(x12), .d(x11), .O(new_n57_));
  aoi21  g29(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(new_n58_));
  oai21  g30(.a(new_n58_), .b(x10), .c(new_n53_), .O(new_n59_));
  ...
  nand3  g36(.a(new_n33_), .b(x14), .c(x13), .O(new_n65_));
  oai22  g37(.a(new_n65_), .b(new_n62_), .c(new_n64_), .d(new_n33_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(x09), .c(x10), .O(new_n67_));
  nand2  g39(.a(x08), .b(x04), .O(new_n68_));
  oai21  g40(.a(new_n67_), .b(x08), .c(new_n68_), .O(z5));
  ...
  aoi21  g46(.a(new_n74_), .b(x09), .c(x10), .O(new_n75_));
  ...
  nand3  g52(.a(new_n34_), .b(new_n80_), .c(x16), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n55_), .c(new_n79_), .O(new_n82_));
  nand4  g54(.a(new_n82_), .b(new_n29_), .c(x09), .d(new_n53_), .O(new_n83_));
  ...
  nor2   g59(.a(new_n72_), .b(new_n33_), .O(new_n88_));
  nor2   g60(.a(x18), .b(new_n80_), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(new_n88_), .c(new_n64_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n87_), .c(new_n54_), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(x10), .c(new_n53_), .O(new_n92_));
