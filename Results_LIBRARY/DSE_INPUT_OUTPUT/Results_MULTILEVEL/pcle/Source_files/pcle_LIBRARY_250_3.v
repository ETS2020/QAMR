...
module FAU ( 
  ...
  aoi21  g09(.a(x15), .b(x10), .c(new_n30_), .O(new_n38_));
  ...
  nand2  g20(.a(new_n38_), .b(x02), .O(new_n49_));
  ...
  nand2  g26(.a(new_n38_), .b(x03), .O(new_n55_));
  ...
  nand3  g31(.a(new_n59_), .b(new_n56_), .c(x13), .O(new_n60_));
  oai21  g32(.a(new_n58_), .b(new_n56_), .c(new_n60_), .O(new_n61_));
  ...
  oai21  g38(.a(new_n58_), .b(new_n65_), .c(new_n66_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x14), .O(new_n68_));
  nand2  g40(.a(x15), .b(new_n56_), .O(new_n69_));
  ...
  aoi21  g51(.a(new_n79_), .b(new_n59_), .c(new_n74_), .O(new_n80_));
  ...
  nand2  g55(.a(new_n59_), .b(new_n42_), .O(new_n84_));
  inv1   g56(.a(x17), .O(new_n85_));
  and2   g57(.a(x14), .b(x13), .O(new_n86_));
  ...
  aoi21  g63(.a(new_n91_), .b(new_n58_), .c(new_n85_), .O(new_n92_));
  ...
  aoi21  g72(.a(new_n100_), .b(new_n58_), .c(new_n29_), .O(new_n101_));
