...
module FAU ( 
  ...
  oai21  g41(.a(new_n69_), .b(new_n30_), .c(new_n67_), .O(new_n70_));
  ...
  or2    g57(.a(new_n85_), .b(new_n60_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(x17), .c(new_n39_), .d(x09), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(x08), .c(new_n84_), .O(z7));
  oai21  g60(.a(new_n85_), .b(new_n60_), .c(x18), .O(new_n89_));
  inv1   g61(.a(x18), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai22  g63(.a(new_n91_), .b(new_n60_), .c(new_n89_), .d(new_n40_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(x09), .c(new_n29_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(x17), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n39_), .O(new_n95_));
