...
module FAU ( 
  ...
  aoi21  g34(.a(x08), .b(x03), .c(new_n40_), .O(new_n63_));
  ...
  nand4  g40(.a(new_n68_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n69_));
  aoi21  g41(.a(x08), .b(x04), .c(new_n40_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z5));
  nand3  g43(.a(new_n41_), .b(x08), .c(x05), .O(new_n72_));
  nand3  g44(.a(x15), .b(x14), .c(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n33_), .c(x16), .O(new_n74_));
  ...
  nand3  g50(.a(new_n41_), .b(x08), .c(x06), .O(new_n79_));
  ...
  nand4  g56(.a(new_n84_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n85_));
  ...
  nand4  g61(.a(new_n89_), .b(new_n88_), .c(x17), .d(x15), .O(new_n90_));
  ...
  nand4  g67(.a(new_n95_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n96_));
