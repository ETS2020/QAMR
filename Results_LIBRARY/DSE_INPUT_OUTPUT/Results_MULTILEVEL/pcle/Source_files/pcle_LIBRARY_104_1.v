...
module FAU ( 
  ...
  nand4  g25(.a(new_n53_), .b(new_n29_), .c(x09), .d(new_n48_), .O(new_n54_));
  ...
  nand4  g32(.a(new_n60_), .b(new_n29_), .c(x09), .d(new_n48_), .O(new_n61_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n29_), .c(x09), .d(new_n48_), .O(new_n83_));
  ...
  nor2   g59(.a(new_n73_), .b(new_n33_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n65_), .c(new_n36_), .d(x17), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n29_), .c(x09), .d(new_n48_), .O(new_n91_));
