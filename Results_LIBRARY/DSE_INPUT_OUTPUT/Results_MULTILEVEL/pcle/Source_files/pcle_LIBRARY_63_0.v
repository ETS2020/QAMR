...
module FAU ( 
  ...
  aoi21  g12(.a(new_n40_), .b(new_n29_), .c(new_n39_), .O(new_n41_));
  nand2  g13(.a(x08), .b(x00), .O(new_n42_));
  oai21  g14(.a(new_n41_), .b(x10), .c(new_n42_), .O(z1));
  xor2a  g15(.a(x12), .b(x11), .O(new_n44_));
  aoi21  g16(.a(new_n44_), .b(new_n29_), .c(new_n39_), .O(new_n45_));
  nand2  g17(.a(x08), .b(x01), .O(new_n46_));
  oai21  g18(.a(new_n45_), .b(x10), .c(new_n46_), .O(z2));
  oai21  g19(.a(x10), .b(x09), .c(x08), .O(new_n48_));
  inv1   g20(.a(new_n48_), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(x02), .O(new_n50_));
  inv1   g22(.a(x10), .O(new_n51_));
  ...
  nand4  g27(.a(new_n55_), .b(new_n51_), .c(x09), .d(new_n29_), .O(new_n56_));
  ...
  nand2  g32(.a(new_n33_), .b(x13), .O(new_n61_));
  oai21  g33(.a(new_n61_), .b(new_n52_), .c(new_n60_), .O(new_n62_));
  nand4  g34(.a(new_n62_), .b(new_n51_), .c(x09), .d(new_n29_), .O(new_n63_));
  ...
  oai22  g39(.a(new_n67_), .b(new_n52_), .c(new_n66_), .d(new_n34_), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n29_), .c(new_n39_), .O(new_n69_));
  nand2  g41(.a(x08), .b(x04), .O(new_n70_));
  oai21  g42(.a(new_n69_), .b(x10), .c(new_n70_), .O(z5));
  nand2  g43(.a(new_n49_), .b(x05), .O(new_n72_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n51_), .c(x09), .d(new_n29_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n72_), .O(z6));
  nand3  g51(.a(x16), .b(x15), .c(x14), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n59_), .c(x17), .O(new_n81_));
  inv1   g53(.a(x17), .O(new_n82_));
  nand4  g54(.a(new_n82_), .b(x16), .c(x15), .d(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n59_), .c(new_n81_), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n29_), .c(new_n39_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  oai21  g58(.a(new_n85_), .b(x10), .c(new_n86_), .O(z7));
  nand2  g59(.a(new_n49_), .b(x07), .O(new_n88_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n51_), .c(x09), .d(new_n29_), .O(new_n94_));
