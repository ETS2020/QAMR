...
module FAU ( 
  ...
  oai21  g33(.a(new_n38_), .b(x04), .c(x08), .O(new_n62_));
  nand2  g34(.a(new_n53_), .b(x15), .O(new_n63_));
  inv1   g35(.a(x15), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(x13), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n55_), .c(new_n63_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x14), .O(new_n67_));
  nand2  g39(.a(x15), .b(new_n56_), .O(new_n68_));
  ...
  oai21  g59(.a(new_n38_), .b(x07), .c(x08), .O(new_n88_));
  nand4  g60(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n53_), .c(x18), .O(new_n90_));
