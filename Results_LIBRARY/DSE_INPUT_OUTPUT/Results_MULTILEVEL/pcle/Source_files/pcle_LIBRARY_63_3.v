...
module FAU ( 
  ...
  nand4  g10(.a(new_n38_), .b(new_n34_), .c(x11), .d(new_n31_), .O(new_n39_));
  aoi21  g11(.a(new_n39_), .b(new_n30_), .c(new_n29_), .O(z0));
  inv1   g12(.a(x11), .O(new_n41_));
  aoi21  g13(.a(new_n41_), .b(new_n31_), .c(x10), .O(new_n42_));
  nand2  g14(.a(x08), .b(x00), .O(new_n43_));
  oai21  g15(.a(new_n42_), .b(new_n29_), .c(new_n43_), .O(z1));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  aoi21  g17(.a(new_n45_), .b(new_n31_), .c(x10), .O(new_n46_));
  nand2  g18(.a(x08), .b(x01), .O(new_n47_));
  oai21  g19(.a(new_n46_), .b(new_n29_), .c(new_n47_), .O(z2));
  aoi21  g20(.a(x10), .b(x09), .c(new_n31_), .O(new_n49_));
  ...
  nand4  g26(.a(new_n54_), .b(new_n30_), .c(x09), .d(new_n31_), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(new_n50_), .O(z3));
  nand2  g28(.a(new_n49_), .b(x03), .O(new_n57_));
  nand3  g29(.a(x13), .b(x12), .c(x11), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(x14), .O(new_n59_));
  nand2  g31(.a(new_n35_), .b(x13), .O(new_n60_));
  oai21  g32(.a(new_n60_), .b(new_n51_), .c(new_n59_), .O(new_n61_));
  ...
  nand3  g37(.a(new_n36_), .b(x14), .c(x13), .O(new_n66_));
  oai22  g38(.a(new_n66_), .b(new_n51_), .c(new_n65_), .d(new_n36_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n31_), .c(x10), .O(new_n68_));
  nand2  g40(.a(x08), .b(x04), .O(new_n69_));
  oai21  g41(.a(new_n68_), .b(new_n29_), .c(new_n69_), .O(z5));
  nand2  g42(.a(new_n49_), .b(x05), .O(new_n71_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n30_), .c(x09), .d(new_n31_), .O(new_n77_));
  ...
  aoi21  g55(.a(new_n83_), .b(new_n31_), .c(x10), .O(new_n84_));
