...
module FAU ( 
  ...
  aoi21  g08(.a(new_n36_), .b(x04), .c(x10), .O(z0));
  ...
  nand2  g19(.a(new_n47_), .b(x04), .O(new_n48_));
  nand2  g20(.a(new_n48_), .b(new_n38_), .O(new_n49_));
  nand2  g21(.a(x08), .b(x01), .O(new_n50_));
  nand2  g22(.a(new_n50_), .b(new_n49_), .O(z2));
  inv1   g23(.a(x04), .O(new_n52_));
  aoi21  g24(.a(new_n38_), .b(new_n52_), .c(new_n39_), .O(new_n53_));
  ...
  nand4  g31(.a(new_n59_), .b(x09), .c(new_n39_), .d(x04), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n54_), .O(z3));
  nand2  g33(.a(new_n53_), .b(x03), .O(new_n62_));
  ...
  nand4  g38(.a(new_n66_), .b(x09), .c(new_n39_), .d(x04), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n62_), .O(z4));
  nand3  g40(.a(new_n30_), .b(x15), .c(new_n39_), .O(new_n69_));
  inv1   g41(.a(x15), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(x13), .c(x12), .d(x11), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(x14), .O(new_n73_));
  nand2  g45(.a(x15), .b(new_n64_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n38_), .c(x09), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(new_n39_), .c(new_n52_), .O(z5));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n79_), .c(new_n29_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n39_), .c(new_n52_), .O(new_n84_));
  ...
  nand4  g60(.a(new_n32_), .b(new_n81_), .c(new_n33_), .d(x16), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n88_), .c(new_n29_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n39_), .c(new_n52_), .O(new_n91_));
  nand2  g63(.a(x08), .b(x06), .O(new_n92_));
  oai21  g64(.a(new_n91_), .b(x10), .c(new_n92_), .O(z7));
  nand2  g65(.a(new_n53_), .b(x07), .O(new_n94_));
  ...
  nand4  g71(.a(new_n99_), .b(new_n97_), .c(new_n34_), .d(x17), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n96_), .c(x10), .O(new_n101_));
  nand4  g73(.a(new_n101_), .b(x09), .c(new_n39_), .d(x04), .O(new_n102_));
