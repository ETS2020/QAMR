...
module FAU ( 
  ...
  nand2  g09(.a(x15), .b(x10), .O(new_n38_));
  ...
  oai21  g34(.a(new_n55_), .b(new_n54_), .c(new_n62_), .O(z4));
  inv1   g35(.a(x15), .O(new_n64_));
  nand4  g36(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n65_));
  inv1   g37(.a(new_n65_), .O(new_n66_));
  nand2  g38(.a(new_n59_), .b(new_n31_), .O(new_n67_));
  nand3  g39(.a(new_n64_), .b(x14), .c(x13), .O(new_n68_));
  oai22  g40(.a(new_n68_), .b(new_n67_), .c(new_n66_), .d(new_n64_), .O(new_n69_));
  ...
  nand3  g44(.a(x11), .b(x09), .c(new_n30_), .O(new_n73_));
  inv1   g45(.a(x16), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(x14), .c(x13), .d(x12), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n73_), .c(new_n31_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(x15), .O(new_n77_));
  nor2   g49(.a(new_n64_), .b(new_n58_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(x13), .O(new_n79_));
  inv1   g51(.a(new_n79_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n59_), .c(new_n74_), .O(new_n81_));
  ...
  oai21  g58(.a(new_n86_), .b(new_n56_), .c(x17), .O(new_n87_));
  nor2   g59(.a(x17), .b(new_n74_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n78_), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n56_), .c(new_n87_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n91_));
  oai21  g63(.a(new_n55_), .b(new_n85_), .c(new_n91_), .O(z7));
  inv1   g64(.a(x07), .O(new_n93_));
  nand4  g65(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n56_), .c(x18), .O(new_n95_));
  nor2   g67(.a(new_n74_), .b(new_n64_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n66_), .c(new_n29_), .d(x17), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n99_));
  oai21  g71(.a(new_n55_), .b(new_n93_), .c(new_n99_), .O(z8));
endmodule
