...
module FAU ( 
  ...
  oai21  g35(.a(new_n49_), .b(new_n57_), .c(new_n63_), .O(z4));
  nor2   g36(.a(x15), .b(new_n50_), .O(new_n65_));
  aoi22  g37(.a(new_n65_), .b(new_n52_), .c(new_n58_), .d(x15), .O(new_n66_));
  nand2  g38(.a(x15), .b(new_n60_), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(new_n60_), .c(new_n67_), .O(new_n68_));
  ...
  aoi21  g58(.a(x08), .b(x06), .c(new_n70_), .O(new_n87_));
  ...
  aoi21  g67(.a(x08), .b(x07), .c(new_n70_), .O(new_n96_));
