...
module FAU ( 
  ...
  aoi21  g14(.a(new_n42_), .b(x11), .c(new_n29_), .O(z0));
  inv1   g15(.a(x11), .O(new_n44_));
  aoi21  g16(.a(x12), .b(new_n44_), .c(new_n31_), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(x00), .O(new_n46_));
  nand3  g18(.a(new_n29_), .b(new_n44_), .c(new_n30_), .O(new_n47_));
  oai21  g19(.a(new_n47_), .b(new_n32_), .c(new_n46_), .O(z1));
  nand2  g20(.a(new_n45_), .b(x01), .O(new_n49_));
  nand3  g21(.a(new_n29_), .b(x11), .c(new_n30_), .O(new_n50_));
  ...
  aoi22  g25(.a(x12), .b(new_n44_), .c(x08), .d(x02), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n53_), .O(z3));
  nand3  g27(.a(new_n36_), .b(x13), .c(new_n30_), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(new_n32_), .c(x11), .O(new_n57_));
  ...
  nand4  g38(.a(new_n37_), .b(x14), .c(x13), .d(x12), .O(new_n67_));
  ...
  oai21  g48(.a(new_n76_), .b(new_n74_), .c(x11), .O(new_n77_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n34_), .c(x11), .O(new_n97_));
