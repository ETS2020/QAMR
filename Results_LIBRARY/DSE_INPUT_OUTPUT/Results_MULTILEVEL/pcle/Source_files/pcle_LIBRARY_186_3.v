...
module FAU ( 
  ...
  nand4  g37(.a(new_n36_), .b(x13), .c(x12), .d(x11), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x14), .O(new_n68_));
  nand2  g40(.a(x15), .b(new_n35_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n30_), .c(x09), .d(new_n31_), .O(new_n71_));
  ...
  aoi21  g49(.a(new_n77_), .b(new_n31_), .c(x10), .O(new_n78_));
  nand2  g50(.a(x08), .b(x05), .O(new_n79_));
  oai21  g51(.a(new_n78_), .b(new_n29_), .c(new_n79_), .O(z6));
  ...
  aoi21  g57(.a(new_n85_), .b(new_n31_), .c(x10), .O(new_n86_));
  ...
  nor2   g62(.a(new_n75_), .b(new_n36_), .O(new_n91_));
