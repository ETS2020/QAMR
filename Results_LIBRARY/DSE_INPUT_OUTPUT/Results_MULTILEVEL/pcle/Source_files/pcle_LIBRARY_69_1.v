...
module FAU ( 
  ...
  nand3  g07(.a(x17), .b(x15), .c(x14), .O(new_n36_));
  inv1   g08(.a(new_n36_), .O(new_n37_));
  nand3  g09(.a(new_n37_), .b(new_n35_), .c(new_n34_), .O(new_n38_));
  aoi21  g10(.a(new_n38_), .b(x16), .c(new_n29_), .O(z0));
  nor2   g11(.a(new_n29_), .b(x16), .O(new_n40_));
  inv1   g12(.a(new_n40_), .O(new_n41_));
  nand2  g13(.a(x08), .b(x00), .O(new_n42_));
  inv1   g14(.a(x11), .O(new_n43_));
  nand3  g15(.a(new_n32_), .b(new_n43_), .c(new_n30_), .O(new_n44_));
  ...
  aoi21  g21(.a(new_n49_), .b(new_n48_), .c(new_n40_), .O(z2));
  ...
  nand4  g25(.a(new_n53_), .b(new_n30_), .c(x09), .d(new_n46_), .O(new_n54_));
  nand2  g26(.a(x08), .b(x02), .O(new_n55_));
  aoi21  g27(.a(new_n55_), .b(new_n54_), .c(new_n40_), .O(z3));
  ...
  nand4  g34(.a(new_n62_), .b(new_n30_), .c(x09), .d(new_n46_), .O(new_n63_));
  nand2  g35(.a(x08), .b(x03), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n63_), .c(new_n40_), .O(z4));
  nand2  g37(.a(x14), .b(x13), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n59_), .c(x15), .O(new_n67_));
  inv1   g39(.a(x15), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(x14), .c(x13), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(new_n59_), .c(new_n67_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n30_), .c(x09), .d(new_n46_), .O(new_n71_));
  aoi21  g43(.a(x08), .b(x04), .c(new_n40_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(z5));
  inv1   g45(.a(x16), .O(new_n74_));
  nand3  g46(.a(new_n35_), .b(x15), .c(x14), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n33_), .c(new_n29_), .O(new_n76_));
  ...
  nor2   g51(.a(new_n79_), .b(new_n74_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n30_), .c(x09), .d(new_n46_), .O(new_n81_));
  nand2  g53(.a(x08), .b(x05), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(new_n77_), .O(z6));
  nand3  g55(.a(new_n32_), .b(x17), .c(new_n30_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n29_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n74_), .O(new_n86_));
  inv1   g58(.a(x17), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(x16), .c(x15), .d(x14), .O(new_n88_));
  oai22  g60(.a(new_n88_), .b(new_n57_), .c(new_n79_), .d(new_n87_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n30_), .c(x09), .d(new_n46_), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(new_n90_), .c(new_n86_), .O(z7));
  nand3  g64(.a(new_n41_), .b(x08), .c(x07), .O(new_n93_));
  oai21  g65(.a(new_n57_), .b(new_n36_), .c(x18), .O(new_n94_));
  nand4  g66(.a(new_n29_), .b(x17), .c(x15), .d(x14), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n57_), .c(new_n94_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(x16), .c(new_n30_), .d(x09), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(x08), .c(new_n93_), .O(z8));
endmodule
