...
module FAU ( 
  ...
  nor2   g24(.a(new_n31_), .b(x09), .O(new_n53_));
  ...
  nor2   g37(.a(x15), .b(new_n47_), .O(new_n66_));
  aoi22  g38(.a(new_n66_), .b(new_n49_), .c(new_n58_), .d(x15), .O(new_n67_));
  ...
  nand2  g59(.a(new_n56_), .b(x07), .O(new_n88_));
