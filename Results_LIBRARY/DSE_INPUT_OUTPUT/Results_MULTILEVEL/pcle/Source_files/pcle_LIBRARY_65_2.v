...
module FAU ( 
  ...
  nand2  g20(.a(new_n39_), .b(x08), .O(new_n49_));
  ...
  oai21  g27(.a(new_n49_), .b(new_n48_), .c(new_n55_), .O(z3));
  ...
  oai21  g44(.a(new_n49_), .b(new_n66_), .c(new_n72_), .O(z5));
  nand3  g45(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n50_), .c(x16), .O(new_n75_));
  ...
  aoi21  g51(.a(x08), .b(x05), .c(new_n63_), .O(new_n80_));
  ...
  nand4  g56(.a(new_n38_), .b(x16), .c(x15), .d(x14), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n57_), .c(new_n84_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n87_));
  oai21  g59(.a(new_n49_), .b(new_n82_), .c(new_n87_), .O(z7));
  nand2  g60(.a(x18), .b(x09), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x08), .c(new_n31_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n38_), .O(new_n91_));
  oai21  g63(.a(new_n83_), .b(new_n57_), .c(x18), .O(new_n92_));
  ...
  nand3  g68(.a(new_n96_), .b(new_n95_), .c(new_n91_), .O(z8));
endmodule
