...
module FAU ( 
  ...
  nand4  g37(.a(new_n65_), .b(x09), .c(new_n32_), .d(new_n31_), .O(new_n66_));
  oai21  g38(.a(new_n47_), .b(new_n60_), .c(new_n66_), .O(z4));
  ...
  oai22  g54(.a(new_n82_), .b(x06), .c(new_n47_), .d(new_n76_), .O(z6));
  oai21  g55(.a(new_n33_), .b(x08), .c(x06), .O(new_n84_));
  ...
  nor2   g66(.a(new_n79_), .b(new_n70_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n94_), .c(new_n29_), .d(x17), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n93_), .c(new_n51_), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n32_), .c(x06), .O(new_n98_));
