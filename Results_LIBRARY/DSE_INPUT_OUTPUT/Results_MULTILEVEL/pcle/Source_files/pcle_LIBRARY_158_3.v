...
module FAU ( 
  ...
  aoi21  g09(.a(x12), .b(x10), .c(new_n30_), .O(new_n38_));
  ...
  nor2   g31(.a(new_n50_), .b(new_n40_), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(new_n57_), .c(x13), .O(new_n61_));
  oai21  g33(.a(new_n59_), .b(new_n57_), .c(new_n61_), .O(new_n62_));
  nand4  g34(.a(new_n62_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n56_), .O(z4));
  nand2  g36(.a(new_n38_), .b(x04), .O(new_n65_));
  inv1   g37(.a(x15), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(x13), .c(x12), .d(x11), .O(new_n67_));
  oai21  g39(.a(new_n59_), .b(new_n66_), .c(new_n67_), .O(new_n68_));
  ...
  nand4  g47(.a(new_n75_), .b(x15), .c(x14), .d(x13), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n74_), .c(new_n31_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(x12), .O(new_n78_));
  nor2   g50(.a(new_n66_), .b(new_n57_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(x13), .O(new_n80_));
  inv1   g52(.a(new_n80_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n60_), .c(new_n75_), .O(new_n82_));
  nand4  g54(.a(new_n82_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n83_));
  nand2  g55(.a(x08), .b(x05), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n83_), .c(new_n78_), .O(z6));
  nand3  g57(.a(new_n42_), .b(x13), .c(x11), .O(new_n86_));
  inv1   g58(.a(x17), .O(new_n87_));
  nand3  g59(.a(new_n79_), .b(new_n87_), .c(x16), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n86_), .c(new_n31_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(x12), .O(new_n90_));
  nand3  g62(.a(x16), .b(x15), .c(x14), .O(new_n91_));
  inv1   g63(.a(new_n91_), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n59_), .c(new_n87_), .O(new_n93_));
  ...
  nand4  g68(.a(new_n79_), .b(new_n29_), .c(x17), .d(x16), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n86_), .c(new_n31_), .O(new_n98_));
  nand2  g70(.a(new_n98_), .b(x12), .O(new_n99_));
  nand4  g71(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n100_));
  inv1   g72(.a(new_n100_), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n59_), .c(new_n29_), .O(new_n102_));
