...
module FAU ( 
  ...
  nand4  g25(.a(new_n53_), .b(x17), .c(new_n42_), .d(x09), .O(new_n54_));
  oai22  g26(.a(new_n54_), .b(x08), .c(new_n41_), .d(new_n50_), .O(z3));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n29_), .c(new_n56_), .O(new_n63_));
  ...
  nand3  g39(.a(new_n32_), .b(x14), .c(x13), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n30_), .c(new_n67_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(x17), .c(new_n42_), .d(x09), .O(new_n70_));
  oai22  g42(.a(new_n70_), .b(x08), .c(new_n41_), .d(new_n66_), .O(z5));
  ...
  oai21  g47(.a(new_n75_), .b(new_n58_), .c(new_n74_), .O(new_n76_));
  nand4  g48(.a(new_n76_), .b(x17), .c(new_n42_), .d(x09), .O(new_n77_));
  oai22  g49(.a(new_n77_), .b(x08), .c(new_n41_), .d(new_n72_), .O(z6));
  inv1   g50(.a(x06), .O(new_n79_));
  inv1   g51(.a(new_n58_), .O(new_n80_));
  nand3  g52(.a(x16), .b(x15), .c(x14), .O(new_n81_));
  inv1   g53(.a(new_n81_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(x17), .c(new_n42_), .d(x09), .O(new_n84_));
  oai22  g56(.a(new_n84_), .b(x08), .c(new_n41_), .d(new_n79_), .O(z7));
  oai21  g57(.a(new_n81_), .b(new_n58_), .c(x18), .O(new_n86_));
  and2   g58(.a(x15), .b(x14), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n80_), .c(new_n34_), .d(x16), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n86_), .c(new_n57_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n29_), .c(new_n56_), .O(new_n90_));
  nand2  g62(.a(x08), .b(x07), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(x10), .c(new_n91_), .O(z8));
endmodule
