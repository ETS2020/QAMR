...
module FAU ( 
  ...
  oai21  g23(.a(new_n51_), .b(new_n46_), .c(new_n30_), .O(new_n52_));
  ...
  aoi21  g39(.a(new_n67_), .b(new_n31_), .c(new_n46_), .O(new_n68_));
  ...
  aoi21  g47(.a(new_n75_), .b(new_n31_), .c(new_n46_), .O(new_n76_));
  ...
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(x10), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n46_), .c(new_n30_), .O(new_n92_));
