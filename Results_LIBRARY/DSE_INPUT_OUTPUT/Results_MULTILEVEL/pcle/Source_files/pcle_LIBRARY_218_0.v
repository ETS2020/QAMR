...
module FAU ( 
  ...
  nand4  g54(.a(new_n82_), .b(x17), .c(new_n31_), .d(x09), .O(new_n83_));
  oai22  g55(.a(new_n83_), .b(x08), .c(new_n40_), .d(new_n77_), .O(z6));
  nand3  g56(.a(x16), .b(x15), .c(x14), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n61_), .c(x09), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(x08), .c(x17), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n31_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n88_), .O(z7));
  inv1   g62(.a(x07), .O(new_n91_));
  oai21  g63(.a(new_n85_), .b(new_n61_), .c(x18), .O(new_n92_));
  ...
  oai22  g67(.a(new_n95_), .b(x08), .c(new_n40_), .d(new_n91_), .O(z8));
endmodule
