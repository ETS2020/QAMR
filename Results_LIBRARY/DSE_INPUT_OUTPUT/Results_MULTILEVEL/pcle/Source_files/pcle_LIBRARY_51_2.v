...
module FAU ( 
  ...
  oai21  g59(.a(new_n87_), .b(new_n59_), .c(new_n84_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n89_));
  oai22  g61(.a(new_n89_), .b(x07), .c(new_n41_), .d(new_n82_), .O(z7));
  oai21  g62(.a(new_n33_), .b(x08), .c(x07), .O(new_n91_));
  nand3  g63(.a(new_n85_), .b(x17), .c(x16), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n59_), .c(x18), .O(new_n93_));
  inv1   g65(.a(new_n66_), .O(new_n94_));
  ...
  nand4  g69(.a(new_n97_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n98_));
