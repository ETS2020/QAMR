...
module FAU ( 
  ...
  aoi21  g14(.a(new_n42_), .b(new_n37_), .c(new_n38_), .O(new_n43_));
  ...
  oai21  g23(.a(new_n51_), .b(new_n38_), .c(new_n46_), .O(new_n52_));
  nand2  g24(.a(x08), .b(x02), .O(new_n53_));
  nand2  g25(.a(new_n53_), .b(new_n52_), .O(z3));
  oai21  g26(.a(x10), .b(x09), .c(x08), .O(new_n55_));
  ...
  oai21  g32(.a(new_n60_), .b(new_n47_), .c(new_n59_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n46_), .c(x09), .d(new_n37_), .O(new_n62_));
  ...
  nand4  g42(.a(new_n70_), .b(new_n46_), .c(x09), .d(new_n37_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n64_), .O(z5));
  nand2  g44(.a(new_n56_), .b(x05), .O(new_n73_));
  ...
  nand4  g50(.a(new_n78_), .b(new_n46_), .c(x09), .d(new_n37_), .O(new_n79_));
  ...
  aoi21  g57(.a(new_n85_), .b(new_n37_), .c(new_n38_), .O(new_n86_));
  ...
  nor2   g62(.a(new_n76_), .b(new_n32_), .O(new_n91_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n38_), .c(new_n46_), .O(new_n97_));
