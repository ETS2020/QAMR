...
module FAU ( 
  ...
  nand2  g18(.a(x13), .b(new_n29_), .O(new_n47_));
  oai21  g19(.a(new_n46_), .b(new_n29_), .c(new_n47_), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(new_n39_), .c(x09), .d(new_n38_), .O(new_n49_));
  ...
  nand4  g26(.a(new_n31_), .b(x13), .c(x12), .d(x11), .O(new_n55_));
  aoi21  g27(.a(new_n55_), .b(new_n54_), .c(x10), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(new_n52_), .c(new_n38_), .O(new_n57_));
  ...
  oai22  g35(.a(new_n63_), .b(new_n60_), .c(new_n62_), .d(new_n32_), .O(new_n64_));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n39_), .c(new_n52_), .O(new_n73_));
  nand2  g45(.a(x08), .b(x05), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(x08), .c(new_n74_), .O(z6));
  ...
  nand4  g60(.a(new_n88_), .b(new_n39_), .c(x09), .d(new_n38_), .O(new_n89_));
