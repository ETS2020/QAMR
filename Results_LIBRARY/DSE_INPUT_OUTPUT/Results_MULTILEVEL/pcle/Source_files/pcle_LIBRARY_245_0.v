...
module FAU ( 
  ...
  oai21  g32(.a(new_n39_), .b(new_n53_), .c(new_n60_), .O(z4));
  ...
  aoi21  g39(.a(new_n67_), .b(new_n30_), .c(new_n62_), .O(new_n68_));
  ...
  aoi21  g55(.a(new_n83_), .b(new_n30_), .c(new_n62_), .O(new_n84_));
