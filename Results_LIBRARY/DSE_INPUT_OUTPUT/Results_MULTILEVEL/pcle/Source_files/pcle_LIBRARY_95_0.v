// Benchmark "FAU" written by ABC on Fri Aug 14 01:57:17 2020
...
module FAU ( 
  ...
  oai21  g33(.a(x14), .b(x10), .c(x08), .O(new_n62_));
  nand3  g34(.a(x13), .b(x12), .c(x11), .O(new_n63_));
  nand4  g35(.a(new_n63_), .b(x14), .c(new_n39_), .d(x09), .O(new_n64_));
  oai22  g36(.a(new_n64_), .b(x08), .c(new_n62_), .d(new_n61_), .O(z4));
  nand3  g37(.a(new_n63_), .b(x15), .c(x14), .O(new_n66_));
  inv1   g38(.a(x15), .O(new_n67_));
  nand3  g39(.a(new_n31_), .b(new_n67_), .c(x13), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n66_), .c(new_n53_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n29_), .c(new_n52_), .O(new_n70_));
  ...
  nand3  g46(.a(new_n32_), .b(x15), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n30_), .c(new_n74_), .O(new_n76_));
  nand4  g48(.a(new_n76_), .b(x14), .c(new_n39_), .d(x09), .O(new_n77_));
  oai22  g49(.a(new_n77_), .b(x08), .c(new_n62_), .d(new_n73_), .O(z6));
  nand3  g50(.a(x16), .b(x15), .c(x13), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n30_), .c(x17), .O(new_n80_));
  inv1   g52(.a(new_n63_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n33_), .c(x16), .d(x15), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n80_), .c(new_n53_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n29_), .c(new_n52_), .O(new_n84_));
  ...
  and2   g60(.a(x16), .b(x15), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n81_), .c(new_n34_), .d(x17), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(new_n53_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n29_), .c(new_n52_), .O(new_n92_));
  nand2  g64(.a(x08), .b(x07), .O(new_n93_));
  oai21  g65(.a(new_n92_), .b(x10), .c(new_n93_), .O(z8));
endmodule
