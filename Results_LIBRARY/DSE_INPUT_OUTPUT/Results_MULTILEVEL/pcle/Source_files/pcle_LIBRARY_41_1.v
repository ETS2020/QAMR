...
module FAU ( 
  ...
  aoi21  g21(.a(new_n50_), .b(new_n30_), .c(x15), .O(new_n51_));
  ...
  aoi21  g29(.a(new_n58_), .b(new_n56_), .c(x15), .O(new_n59_));
  ...
  nand3  g33(.a(x14), .b(x13), .c(x12), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n62_), .c(new_n39_), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n31_), .O(new_n65_));
  nand2  g36(.a(x08), .b(x04), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(z5));
  nand2  g38(.a(x16), .b(x09), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(x08), .c(new_n39_), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n31_), .O(new_n70_));
  nand2  g41(.a(x08), .b(x05), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n70_), .O(z6));
  nand2  g43(.a(new_n32_), .b(x06), .O(new_n73_));
  nand4  g44(.a(new_n35_), .b(x17), .c(new_n39_), .d(new_n31_), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n73_), .O(z7));
  nand2  g46(.a(x18), .b(x09), .O(new_n76_));
