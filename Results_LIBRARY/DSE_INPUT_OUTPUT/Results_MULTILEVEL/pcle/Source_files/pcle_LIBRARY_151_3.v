...
module FAU ( 
  ...
  oai21  g36(.a(new_n40_), .b(new_n57_), .c(new_n64_), .O(z4));
  ...
  oai22  g41(.a(new_n69_), .b(new_n61_), .c(new_n68_), .d(new_n66_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n71_));
  aoi21  g43(.a(x08), .b(x04), .c(new_n54_), .O(new_n72_));
  ...
  nand3  g53(.a(new_n43_), .b(x12), .c(x11), .O(new_n82_));
  inv1   g54(.a(x17), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(x15), .c(x14), .d(x13), .O(new_n84_));
  ...
  aoi21  g61(.a(new_n89_), .b(new_n60_), .c(new_n83_), .O(new_n90_));
  ...
  nand4  g68(.a(new_n87_), .b(new_n68_), .c(new_n29_), .d(x17), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n99_));
  oai21  g71(.a(new_n40_), .b(new_n94_), .c(new_n99_), .O(z8));
endmodule
