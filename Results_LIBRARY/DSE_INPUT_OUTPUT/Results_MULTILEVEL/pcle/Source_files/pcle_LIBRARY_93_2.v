...
module FAU ( 
  ...
  oai21  g10(.a(x17), .b(new_n31_), .c(x08), .O(new_n39_));
  ...
  nor2   g16(.a(x17), .b(new_n31_), .O(new_n45_));
  ...
  nand2  g45(.a(new_n54_), .b(x05), .O(new_n74_));
  ...
  oai21  g50(.a(new_n78_), .b(new_n56_), .c(new_n76_), .O(new_n79_));
  ...
  nand2  g61(.a(new_n54_), .b(x07), .O(new_n90_));
  nand4  g62(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n56_), .c(x18), .O(new_n92_));
