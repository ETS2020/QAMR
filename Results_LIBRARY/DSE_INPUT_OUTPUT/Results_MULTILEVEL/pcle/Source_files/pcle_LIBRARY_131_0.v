...
module FAU ( 
  ...
  oai21  g10(.a(x12), .b(x10), .c(x08), .O(new_n39_));
  inv1   g11(.a(x12), .O(new_n40_));
  nor2   g12(.a(new_n40_), .b(x11), .O(new_n41_));
  ...
  oai21  g16(.a(new_n39_), .b(new_n44_), .c(new_n42_), .O(z2));
  ...
  aoi21  g29(.a(new_n57_), .b(new_n30_), .c(new_n40_), .O(new_n58_));
  ...
  nand3  g37(.a(new_n65_), .b(new_n64_), .c(x14), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n63_), .c(new_n40_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n68_));
  oai21  g40(.a(new_n39_), .b(new_n61_), .c(new_n68_), .O(z5));
  nand2  g41(.a(x15), .b(x14), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n53_), .c(x16), .O(new_n71_));
  inv1   g43(.a(x16), .O(new_n72_));
  nand4  g44(.a(new_n65_), .b(new_n72_), .c(x15), .d(x14), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n71_), .c(new_n52_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n30_), .c(new_n40_), .O(new_n75_));
  ...
  aoi21  g55(.a(new_n83_), .b(new_n30_), .c(new_n40_), .O(new_n84_));
  ...
  oai21  g60(.a(new_n88_), .b(new_n62_), .c(x18), .O(new_n89_));
  nand4  g61(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n62_), .c(new_n89_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(x12), .c(new_n31_), .d(x09), .O(new_n92_));
  oai22  g64(.a(new_n92_), .b(x08), .c(new_n39_), .d(new_n87_), .O(z8));
endmodule
