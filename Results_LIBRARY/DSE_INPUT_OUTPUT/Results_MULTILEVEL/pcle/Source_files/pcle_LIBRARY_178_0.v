...
module FAU ( 
  ...
  oai21  g10(.a(x17), .b(x09), .c(x08), .O(new_n39_));
  ...
  nor2   g16(.a(x17), .b(x09), .O(new_n45_));
  ...
  nand2  g30(.a(new_n55_), .b(x13), .O(new_n59_));
  oai22  g31(.a(new_n59_), .b(new_n58_), .c(new_n57_), .d(new_n55_), .O(new_n60_));
  nand4  g32(.a(new_n60_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n61_));
  oai21  g33(.a(new_n39_), .b(new_n54_), .c(new_n61_), .O(z4));
  ...
  nand4  g51(.a(x12), .b(x11), .c(new_n31_), .d(new_n30_), .O(new_n80_));
  nor2   g52(.a(new_n74_), .b(new_n63_), .O(new_n81_));
