...
module FAU ( 
  ...
  nand2  g09(.a(x17), .b(x10), .O(new_n38_));
  ...
  inv1   g35(.a(new_n38_), .O(new_n64_));
  ...
  oai21  g45(.a(new_n50_), .b(new_n67_), .c(new_n73_), .O(z5));
  ...
  oai21  g61(.a(new_n50_), .b(new_n83_), .c(new_n89_), .O(z7));
  nand2  g62(.a(new_n53_), .b(new_n41_), .O(new_n91_));
  inv1   g63(.a(new_n68_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n29_), .c(x16), .d(x15), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n91_), .c(new_n31_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(x17), .O(new_n95_));
  nand4  g67(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n96_));
  inv1   g68(.a(new_n96_), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n60_), .c(new_n29_), .O(new_n98_));
