...
module FAU ( 
  ...
  nand3  g16(.a(new_n44_), .b(new_n38_), .c(x09), .O(new_n45_));
  ...
  oai21  g29(.a(new_n57_), .b(new_n49_), .c(new_n56_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n38_), .c(x09), .d(new_n29_), .O(new_n59_));
  nor2   g31(.a(new_n38_), .b(new_n29_), .O(new_n60_));
  ...
  nand2  g41(.a(new_n60_), .b(x04), .O(new_n70_));
  ...
  nand2  g49(.a(new_n60_), .b(x05), .O(new_n78_));
  ...
  nand3  g54(.a(new_n34_), .b(new_n82_), .c(x16), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n55_), .c(new_n81_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n38_), .c(x09), .d(new_n29_), .O(new_n85_));
  nand2  g57(.a(new_n60_), .b(x06), .O(new_n86_));
  ...
  nor2   g62(.a(new_n32_), .b(new_n48_), .O(new_n91_));
  ...
  nand2  g67(.a(new_n60_), .b(x07), .O(new_n96_));
