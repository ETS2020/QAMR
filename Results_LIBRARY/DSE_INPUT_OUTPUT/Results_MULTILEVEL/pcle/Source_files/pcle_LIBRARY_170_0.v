...
module FAU ( 
  ...
  oai21  g35(.a(new_n63_), .b(new_n42_), .c(new_n53_), .O(new_n64_));
  ...
  aoi21  g50(.a(new_n78_), .b(new_n41_), .c(new_n42_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(x10), .c(new_n80_), .O(z6));
  nand2  g53(.a(new_n51_), .b(x06), .O(new_n82_));
  ...
  nand4  g59(.a(new_n87_), .b(new_n53_), .c(x09), .d(new_n41_), .O(new_n88_));
  ...
  nor2   g63(.a(new_n76_), .b(new_n35_), .O(new_n92_));
  ...
  oai21  g67(.a(new_n95_), .b(new_n42_), .c(new_n53_), .O(new_n96_));
