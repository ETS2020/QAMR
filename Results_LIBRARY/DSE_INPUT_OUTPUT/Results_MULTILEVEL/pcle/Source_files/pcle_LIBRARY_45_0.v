...
module FAU ( 
  ...
  nand4  g55(.a(x18), .b(new_n83_), .c(x16), .d(x15), .O(new_n84_));
  ...
  nand3  g59(.a(new_n31_), .b(x09), .c(new_n30_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(x18), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n83_), .O(new_n90_));
  oai21  g62(.a(new_n81_), .b(new_n56_), .c(x18), .O(new_n91_));
  nand4  g63(.a(new_n29_), .b(x16), .c(x15), .d(x14), .O(new_n92_));
  oai22  g64(.a(new_n92_), .b(new_n56_), .c(new_n91_), .d(new_n83_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n94_));
  nand2  g66(.a(x08), .b(x07), .O(new_n95_));
  nand3  g67(.a(new_n95_), .b(new_n94_), .c(new_n90_), .O(z8));
endmodule
