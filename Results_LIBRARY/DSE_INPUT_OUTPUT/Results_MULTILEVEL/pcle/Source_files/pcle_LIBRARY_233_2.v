...
module FAU ( 
  ...
  nor2   g15(.a(new_n31_), .b(new_n30_), .O(new_n44_));
  ...
  nand2  g41(.a(new_n44_), .b(x04), .O(new_n70_));
  ...
  oai21  g53(.a(new_n81_), .b(new_n53_), .c(x17), .O(new_n82_));
  ...
  nand2  g65(.a(new_n44_), .b(x07), .O(new_n94_));
