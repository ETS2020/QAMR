...
module FAU ( 
  ...
  aoi21  g22(.a(new_n50_), .b(x09), .c(x10), .O(new_n51_));
  nand2  g23(.a(x08), .b(x02), .O(new_n52_));
  oai21  g24(.a(new_n51_), .b(x08), .c(new_n52_), .O(z3));
  inv1   g25(.a(x08), .O(new_n54_));
  ...
  nand4  g31(.a(new_n59_), .b(new_n29_), .c(x09), .d(new_n54_), .O(new_n60_));
  ...
  nand4  g40(.a(new_n68_), .b(new_n29_), .c(x09), .d(new_n54_), .O(new_n69_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n29_), .c(x09), .d(new_n54_), .O(new_n77_));
  ...
  oai21  g54(.a(new_n82_), .b(new_n55_), .c(new_n81_), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(new_n29_), .c(x09), .d(new_n54_), .O(new_n84_));
  ...
  nand3  g62(.a(new_n90_), .b(new_n36_), .c(x17), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n89_), .c(new_n88_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n29_), .c(x09), .d(new_n54_), .O(new_n93_));
