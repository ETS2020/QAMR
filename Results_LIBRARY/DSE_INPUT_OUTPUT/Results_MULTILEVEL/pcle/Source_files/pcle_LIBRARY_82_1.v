...
module FAU ( 
  ...
  oai21  g27(.a(new_n55_), .b(x08), .c(new_n29_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n38_), .O(new_n57_));
  nand2  g29(.a(x08), .b(x04), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(new_n57_), .O(z5));
  inv1   g31(.a(x05), .O(new_n60_));
  nand4  g32(.a(new_n34_), .b(x16), .c(new_n29_), .d(new_n38_), .O(new_n61_));
  oai21  g33(.a(new_n32_), .b(new_n60_), .c(new_n61_), .O(z6));
  ...
  nand4  g40(.a(new_n34_), .b(x18), .c(new_n29_), .d(new_n38_), .O(new_n69_));
