// Benchmark "FAU" written by ABC on Fri Aug 14 01:57:39 2020
...
module FAU ( 
  ...
  nand4  g13(.a(new_n29_), .b(new_n39_), .c(x09), .d(new_n37_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n41_), .O(z1));
  xor2a  g15(.a(x12), .b(x11), .O(new_n44_));
  aoi21  g16(.a(new_n44_), .b(new_n37_), .c(new_n38_), .O(new_n45_));
  ...
  oai21  g24(.a(new_n52_), .b(new_n38_), .c(new_n39_), .O(new_n53_));
  ...
  nand4  g32(.a(new_n60_), .b(new_n39_), .c(x09), .d(new_n37_), .O(new_n61_));
  ...
  aoi21  g38(.a(new_n66_), .b(new_n37_), .c(new_n38_), .O(new_n67_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n39_), .c(x09), .d(new_n37_), .O(new_n76_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n39_), .c(x09), .d(new_n37_), .O(new_n84_));
  ...
  nand4  g64(.a(new_n92_), .b(new_n39_), .c(x09), .d(new_n37_), .O(new_n93_));
