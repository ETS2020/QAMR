...
module FAU ( 
  ...
  aoi21  g34(.a(new_n62_), .b(new_n30_), .c(new_n48_), .O(new_n63_));
  ...
  nand4  g43(.a(new_n71_), .b(x16), .c(new_n31_), .d(x09), .O(new_n72_));
  oai22  g44(.a(new_n72_), .b(x08), .c(new_n40_), .d(new_n66_), .O(z5));
  nand3  g45(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n50_), .c(x09), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(x08), .c(x16), .O(new_n76_));
  ...
  oai21  g52(.a(new_n74_), .b(new_n50_), .c(x17), .O(new_n81_));
  ...
  nand4  g56(.a(new_n84_), .b(x16), .c(new_n31_), .d(x09), .O(new_n85_));
  oai22  g57(.a(new_n85_), .b(x08), .c(new_n40_), .d(new_n80_), .O(z7));
  inv1   g58(.a(x07), .O(new_n87_));
  nand3  g59(.a(x17), .b(x15), .c(x14), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n58_), .c(x18), .O(new_n89_));
  nand4  g61(.a(new_n29_), .b(x17), .c(x15), .d(x14), .O(new_n90_));
