...
module FAU ( 
  ...
  nand4  g20(.a(new_n48_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n49_));
  ...
  oai22  g32(.a(new_n60_), .b(new_n33_), .c(new_n59_), .d(new_n57_), .O(new_n61_));
  ...
  aoi21  g41(.a(x08), .b(x04), .c(new_n41_), .O(new_n70_));
  ...
  aoi21  g49(.a(x08), .b(x05), .c(new_n41_), .O(new_n78_));
  ...
  nand4  g54(.a(new_n30_), .b(x16), .c(x15), .d(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n58_), .c(new_n82_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n85_));
