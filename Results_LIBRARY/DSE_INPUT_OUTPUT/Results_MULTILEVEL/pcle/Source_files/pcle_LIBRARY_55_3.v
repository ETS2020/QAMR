...
module FAU ( 
  ...
  nand2  g35(.a(x10), .b(x03), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(x08), .c(x04), .O(new_n65_));
  nand2  g37(.a(new_n55_), .b(x15), .O(new_n66_));
  inv1   g38(.a(x15), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x13), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n57_), .c(new_n66_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(x14), .O(new_n70_));
  nand2  g42(.a(x15), .b(new_n58_), .O(new_n71_));
  ...
  oai21  g69(.a(new_n40_), .b(new_n91_), .c(new_n97_), .O(z8));
endmodule
