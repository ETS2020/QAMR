...
module FAU ( 
  ...
  nand4  g42(.a(new_n70_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n71_));
  ...
  aoi21  g49(.a(new_n77_), .b(new_n39_), .c(new_n48_), .O(new_n78_));
  ...
  nand4  g58(.a(new_n86_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n87_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n48_), .c(new_n40_), .O(new_n97_));
