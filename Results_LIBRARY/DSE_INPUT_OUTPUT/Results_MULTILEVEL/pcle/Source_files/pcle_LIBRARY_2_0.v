...
module FAU ( 
  ...
  aoi21  g10(.a(new_n31_), .b(new_n38_), .c(new_n30_), .O(new_n39_));
  ...
  aoi21  g16(.a(new_n44_), .b(new_n30_), .c(new_n38_), .O(new_n45_));
  ...
  nand2  g35(.a(new_n39_), .b(x04), .O(new_n64_));
  nor2   g36(.a(x15), .b(new_n49_), .O(new_n65_));
  aoi22  g37(.a(new_n65_), .b(new_n51_), .c(new_n57_), .d(x15), .O(new_n66_));
  nand2  g38(.a(x15), .b(new_n59_), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(new_n59_), .c(new_n67_), .O(new_n68_));
  ...
  aoi21  g47(.a(new_n75_), .b(new_n30_), .c(new_n38_), .O(new_n76_));
  ...
  nand3  g63(.a(new_n91_), .b(x16), .c(x15), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n90_), .c(new_n89_), .O(new_n93_));
