...
module FAU ( 
  ...
  nand2  g13(.a(new_n41_), .b(x07), .O(new_n42_));
  ...
  oai21  g24(.a(x10), .b(x07), .c(x08), .O(new_n53_));
  ...
  nand4  g30(.a(new_n58_), .b(x09), .c(new_n39_), .d(x07), .O(new_n59_));
  oai21  g31(.a(new_n53_), .b(new_n52_), .c(new_n59_), .O(z3));
  inv1   g32(.a(x07), .O(new_n61_));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n39_), .c(new_n61_), .O(new_n66_));
  ...
  oai22  g47(.a(new_n75_), .b(new_n61_), .c(new_n53_), .d(new_n69_), .O(z5));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n39_), .c(new_n61_), .O(new_n83_));
  ...
  nand4  g59(.a(new_n32_), .b(new_n80_), .c(new_n33_), .d(x16), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n87_), .c(new_n29_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n39_), .c(new_n61_), .O(new_n90_));
  ...
  nand4  g67(.a(new_n95_), .b(new_n72_), .c(new_n34_), .d(x17), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand3  g69(.a(new_n97_), .b(new_n38_), .c(x09), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n39_), .c(new_n61_), .O(z8));
endmodule
