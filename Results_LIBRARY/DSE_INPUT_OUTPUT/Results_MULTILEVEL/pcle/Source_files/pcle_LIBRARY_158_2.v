...
module FAU ( 
  ...
  nor2   g29(.a(new_n38_), .b(new_n41_), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n55_), .c(x13), .O(new_n59_));
  oai21  g31(.a(new_n57_), .b(new_n55_), .c(new_n59_), .O(new_n60_));
  ...
  oai21  g37(.a(new_n57_), .b(new_n64_), .c(new_n65_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x14), .O(new_n67_));
  nand2  g39(.a(x15), .b(new_n55_), .O(new_n68_));
  ...
  oai21  g44(.a(new_n72_), .b(x08), .c(new_n31_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n38_), .O(new_n74_));
  nand2  g46(.a(x13), .b(x11), .O(new_n75_));
  ...
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(new_n74_), .O(z6));
  nand2  g55(.a(x17), .b(x09), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(x08), .c(new_n31_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n38_), .O(new_n86_));
  nand3  g58(.a(x16), .b(x15), .c(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n75_), .c(x17), .O(new_n88_));
  inv1   g60(.a(x17), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(x16), .c(x15), .d(x14), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n56_), .c(new_n88_), .O(new_n91_));
  ...
  oai21  g67(.a(new_n95_), .b(x08), .c(new_n31_), .O(new_n96_));
  ...
  nand3  g72(.a(new_n58_), .b(x14), .c(x13), .O(new_n101_));
