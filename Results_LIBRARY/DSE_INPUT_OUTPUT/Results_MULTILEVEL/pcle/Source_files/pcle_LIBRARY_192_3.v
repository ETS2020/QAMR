...
module FAU ( 
  ...
  aoi21  g14(.a(x10), .b(x09), .c(new_n30_), .O(new_n43_));
  ...
  nand2  g34(.a(new_n43_), .b(x04), .O(new_n63_));
  ...
  nand2  g44(.a(new_n43_), .b(x05), .O(new_n73_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n91_), .c(new_n29_), .d(x17), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n90_), .c(x08), .O(new_n95_));
