...
module FAU ( 
  ...
  and2   g06(.a(x14), .b(x13), .O(new_n35_));
  ...
  nand3  g16(.a(new_n32_), .b(new_n44_), .c(new_n29_), .O(new_n45_));
  ...
  nand4  g34(.a(new_n62_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n63_));
  ...
  nand4  g44(.a(new_n72_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n65_), .O(z5));
  nand3  g46(.a(x15), .b(x14), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n33_), .c(x16), .O(new_n76_));
  ...
  nand4  g51(.a(new_n79_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n80_));
  aoi21  g52(.a(x08), .b(x05), .c(new_n41_), .O(new_n81_));
