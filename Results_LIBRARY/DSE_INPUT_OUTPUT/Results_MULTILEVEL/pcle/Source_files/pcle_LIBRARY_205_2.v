...
module FAU ( 
  ...
  nand3  g22(.a(new_n50_), .b(x12), .c(new_n31_), .O(new_n51_));
  ...
  aoi21  g26(.a(x08), .b(x02), .c(new_n47_), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(new_n54_), .O(z3));
  inv1   g28(.a(x03), .O(new_n57_));
  nand2  g29(.a(new_n39_), .b(x08), .O(new_n58_));
  ...
  oai21  g35(.a(new_n63_), .b(new_n61_), .c(new_n60_), .O(new_n64_));
  ...
  oai21  g51(.a(new_n79_), .b(new_n61_), .c(x16), .O(new_n80_));
  ...
  oai21  g56(.a(new_n58_), .b(new_n78_), .c(new_n84_), .O(z6));
  ...
  oai21  g62(.a(new_n90_), .b(new_n59_), .c(new_n88_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n92_));
  oai21  g64(.a(new_n58_), .b(new_n86_), .c(new_n92_), .O(z7));
  ...
  oai21  g69(.a(new_n97_), .b(new_n70_), .c(x18), .O(new_n98_));
  ...
  nand3  g75(.a(new_n103_), .b(new_n102_), .c(new_n96_), .O(z8));
endmodule
