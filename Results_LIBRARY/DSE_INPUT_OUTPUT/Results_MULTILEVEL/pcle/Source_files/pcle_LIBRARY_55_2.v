...
module FAU ( 
  ...
  nand2  g38(.a(new_n33_), .b(x03), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(x08), .c(x04), .O(new_n68_));
  nand2  g40(.a(new_n60_), .b(x15), .O(new_n69_));
  inv1   g41(.a(x15), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(x13), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n52_), .c(new_n69_), .O(new_n72_));
  ...
  nand4  g47(.a(new_n75_), .b(x09), .c(new_n32_), .d(new_n31_), .O(new_n76_));
  ...
  inv1   g52(.a(new_n60_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n80_), .c(x15), .d(x14), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n79_), .c(new_n51_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n32_), .c(x03), .O(new_n84_));
  ...
  nor2   g60(.a(x17), .b(new_n80_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n81_), .c(x15), .d(x14), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(new_n51_), .O(new_n91_));
  ...
  oai21  g75(.a(new_n41_), .b(new_n95_), .c(new_n103_), .O(z8));
endmodule
