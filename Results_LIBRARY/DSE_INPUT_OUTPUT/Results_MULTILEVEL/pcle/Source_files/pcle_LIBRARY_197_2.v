...
module FAU ( 
  ...
  aoi22  g17(.a(new_n38_), .b(x10), .c(x08), .d(x01), .O(new_n46_));
  ...
  nand3  g22(.a(new_n38_), .b(x12), .c(x11), .O(new_n51_));
  ...
  nor2   g35(.a(x15), .b(new_n38_), .O(new_n64_));
  aoi22  g36(.a(new_n64_), .b(new_n50_), .c(new_n56_), .d(x15), .O(new_n65_));
  nand2  g37(.a(x15), .b(new_n58_), .O(new_n66_));
  oai21  g38(.a(new_n65_), .b(new_n58_), .c(new_n66_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n63_), .O(z5));
  nand2  g41(.a(x16), .b(x09), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(x08), .c(new_n31_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n38_), .O(new_n72_));
  ...
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(new_n72_), .O(z6));
  ...
  nand3  g65(.a(new_n93_), .b(x16), .c(x15), .O(new_n94_));
