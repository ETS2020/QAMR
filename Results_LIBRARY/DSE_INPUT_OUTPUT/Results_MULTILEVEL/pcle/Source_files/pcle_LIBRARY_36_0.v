...
module FAU ( 
  ...
  nand4  g52(.a(new_n80_), .b(x17), .c(new_n39_), .d(x09), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(x08), .c(new_n75_), .O(z6));
  nand2  g54(.a(new_n41_), .b(x06), .O(new_n83_));
  nand3  g55(.a(x16), .b(x15), .c(x14), .O(new_n84_));
  or2    g56(.a(new_n84_), .b(new_n59_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(x17), .c(new_n39_), .d(x09), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(x08), .c(new_n83_), .O(z7));
  nand2  g59(.a(new_n41_), .b(x07), .O(new_n88_));
  oai21  g60(.a(new_n84_), .b(new_n59_), .c(x18), .O(new_n89_));
  ...
  nand4  g64(.a(new_n92_), .b(x17), .c(new_n39_), .d(x09), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(x08), .c(new_n88_), .O(z8));
endmodule
