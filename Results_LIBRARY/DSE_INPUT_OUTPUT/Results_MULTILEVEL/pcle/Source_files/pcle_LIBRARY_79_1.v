...
module FAU ( 
  ...
  oai21  g25(.a(new_n30_), .b(new_n38_), .c(new_n53_), .O(z3));
  ...
  aoi21  g50(.a(x08), .b(x05), .c(new_n61_), .O(new_n79_));
  ...
  oai21  g59(.a(new_n65_), .b(new_n81_), .c(new_n87_), .O(z7));
  ...
  aoi21  g66(.a(x08), .b(x07), .c(new_n61_), .O(new_n95_));
