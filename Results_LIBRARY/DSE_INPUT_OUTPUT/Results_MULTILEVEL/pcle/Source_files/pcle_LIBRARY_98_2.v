...
module FAU ( 
  ...
  nor2   g12(.a(new_n40_), .b(new_n29_), .O(new_n41_));
  nand2  g13(.a(new_n41_), .b(x00), .O(new_n42_));
  inv1   g14(.a(x11), .O(new_n43_));
  nand4  g15(.a(new_n43_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n44_));
  ...
  nand2  g25(.a(new_n41_), .b(x02), .O(new_n54_));
  ...
  nand2  g33(.a(new_n41_), .b(x03), .O(new_n62_));
  ...
  oai21  g55(.a(new_n83_), .b(new_n56_), .c(new_n82_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n85_));
  ...
  nand4  g63(.a(new_n36_), .b(x17), .c(x16), .d(x15), .O(new_n92_));
