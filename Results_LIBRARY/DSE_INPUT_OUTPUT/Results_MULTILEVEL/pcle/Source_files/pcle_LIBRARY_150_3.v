...
module FAU ( 
  ...
  nand2  g26(.a(x09), .b(new_n30_), .O(new_n55_));
  ...
  nand3  g32(.a(new_n60_), .b(x14), .c(new_n31_), .O(new_n61_));
  ...
  nor2   g44(.a(new_n72_), .b(new_n67_), .O(new_n73_));
  ...
  nand2  g49(.a(x12), .b(x11), .O(new_n78_));
  ...
  oai21  g56(.a(new_n44_), .b(new_n77_), .c(new_n84_), .O(z6));
