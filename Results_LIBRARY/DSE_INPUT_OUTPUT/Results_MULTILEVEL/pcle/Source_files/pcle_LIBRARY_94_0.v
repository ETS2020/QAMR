...
module FAU ( 
  ...
  aoi21  g11(.a(new_n39_), .b(new_n31_), .c(new_n38_), .O(new_n40_));
  nand2  g12(.a(x08), .b(x00), .O(new_n41_));
  oai21  g13(.a(new_n40_), .b(x08), .c(new_n41_), .O(z1));
  xor2a  g14(.a(x12), .b(x11), .O(new_n43_));
  aoi21  g15(.a(new_n43_), .b(new_n31_), .c(new_n38_), .O(new_n44_));
  ...
  aoi21  g21(.a(new_n49_), .b(new_n31_), .c(new_n38_), .O(new_n50_));
  ...
  oai21  g36(.a(new_n64_), .b(new_n55_), .c(new_n62_), .O(new_n65_));
  ...
  aoi21  g48(.a(new_n76_), .b(new_n31_), .c(new_n38_), .O(new_n77_));
