...
module FAU ( 
  ...
  nand2  g38(.a(new_n48_), .b(x04), .O(new_n67_));
  ...
  nand4  g46(.a(new_n74_), .b(new_n29_), .c(x09), .d(new_n47_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n67_), .O(z5));
  oai21  g48(.a(new_n39_), .b(new_n34_), .c(x16), .O(new_n77_));
  nand3  g49(.a(new_n36_), .b(x15), .c(x14), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n60_), .c(new_n77_), .O(new_n79_));
  nand4  g51(.a(new_n79_), .b(new_n29_), .c(x09), .d(new_n47_), .O(new_n80_));
  ...
  nand4  g72(.a(new_n100_), .b(new_n29_), .c(x09), .d(new_n47_), .O(new_n101_));
