...
module FAU ( 
  ...
  oai22  g60(.a(new_n88_), .b(x01), .c(new_n41_), .d(new_n82_), .O(z7));
  nand4  g61(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n59_), .c(x18), .O(new_n91_));
  inv1   g63(.a(new_n66_), .O(new_n92_));
  nor2   g64(.a(new_n77_), .b(new_n68_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(new_n29_), .d(x17), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n91_), .c(new_n49_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n32_), .c(x01), .O(new_n96_));
