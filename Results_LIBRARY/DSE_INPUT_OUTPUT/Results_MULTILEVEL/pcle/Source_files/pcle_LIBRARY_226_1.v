...
module FAU ( 
  ...
  nand4  g12(.a(new_n31_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n41_));
  ...
  oai21  g28(.a(new_n56_), .b(x10), .c(new_n40_), .O(new_n57_));
  ...
  nand4  g36(.a(new_n64_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n65_));
  ...
  nor2   g57(.a(new_n70_), .b(new_n34_), .O(new_n86_));
  nor2   g58(.a(x18), .b(new_n78_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n62_), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n85_), .c(new_n30_), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x10), .c(new_n40_), .O(new_n90_));
