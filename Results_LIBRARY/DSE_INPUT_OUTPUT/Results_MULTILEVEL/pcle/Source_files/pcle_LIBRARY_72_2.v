...
module FAU ( 
  ...
  nand2  g01(.a(new_n29_), .b(x03), .O(new_n30_));
  nand2  g02(.a(x12), .b(x11), .O(new_n31_));
  nor4   g03(.a(new_n31_), .b(x10), .c(new_n29_), .d(x08), .O(new_n32_));
  ...
  aoi21  g12(.a(new_n29_), .b(x03), .c(new_n40_), .O(new_n41_));
  ...
  nand3  g33(.a(new_n61_), .b(new_n43_), .c(new_n40_), .O(new_n62_));
  nand2  g34(.a(x08), .b(x03), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n62_), .c(new_n29_), .O(z4));
  nand2  g36(.a(new_n29_), .b(x03), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(x08), .c(x04), .O(new_n66_));
  nand2  g38(.a(new_n57_), .b(x15), .O(new_n67_));
  ...
  nand4  g58(.a(new_n86_), .b(new_n43_), .c(x09), .d(new_n40_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n82_), .O(z7));
  nand2  g60(.a(new_n41_), .b(x07), .O(new_n89_));
  ...
  nor2   g64(.a(new_n33_), .b(new_n68_), .O(new_n93_));
  nand3  g65(.a(new_n93_), .b(new_n35_), .c(x17), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n92_), .c(new_n91_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n43_), .c(x09), .d(new_n40_), .O(new_n96_));
