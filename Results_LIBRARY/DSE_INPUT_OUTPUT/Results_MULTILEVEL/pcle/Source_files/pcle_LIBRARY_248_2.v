...
module FAU ( 
  ...
  nand3  g39(.a(new_n38_), .b(x14), .c(x13), .O(new_n68_));
  oai22  g40(.a(new_n68_), .b(new_n57_), .c(new_n67_), .d(new_n38_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n70_));
  oai21  g42(.a(new_n65_), .b(new_n64_), .c(new_n70_), .O(z5));
  ...
  oai21  g50(.a(new_n65_), .b(new_n72_), .c(new_n78_), .O(z6));
  ...
  oai21  g66(.a(new_n65_), .b(new_n88_), .c(new_n94_), .O(z8));
endmodule
