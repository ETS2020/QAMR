...
module FAU ( 
  ...
  nand3  g04(.a(new_n32_), .b(x09), .c(new_n30_), .O(new_n33_));
  nand3  g05(.a(x15), .b(x14), .c(x13), .O(new_n34_));
  inv1   g06(.a(new_n34_), .O(new_n35_));
  nand4  g07(.a(new_n35_), .b(x18), .c(x17), .d(x16), .O(new_n36_));
  oai22  g08(.a(new_n36_), .b(new_n33_), .c(x12), .d(new_n29_), .O(z0));
  inv1   g09(.a(x12), .O(new_n38_));
  aoi21  g10(.a(new_n38_), .b(x10), .c(new_n30_), .O(new_n39_));
  nand2  g11(.a(new_n39_), .b(x00), .O(new_n40_));
  inv1   g12(.a(x11), .O(new_n41_));
  nand4  g13(.a(new_n41_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n40_), .O(z1));
  nand2  g15(.a(new_n39_), .b(x01), .O(new_n44_));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  nand4  g17(.a(new_n45_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(new_n44_), .O(z2));
  nand2  g19(.a(new_n39_), .b(x02), .O(new_n48_));
  xnor2a g20(.a(x13), .b(x11), .O(new_n49_));
  nand2  g21(.a(x13), .b(new_n38_), .O(new_n50_));
  oai21  g22(.a(new_n49_), .b(new_n38_), .c(new_n50_), .O(new_n51_));
  nand4  g23(.a(new_n51_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n48_), .O(z3));
  nand2  g25(.a(new_n39_), .b(x03), .O(new_n54_));
  ...
  nand4  g31(.a(new_n59_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n54_), .O(z4));
  nand2  g33(.a(new_n39_), .b(x04), .O(new_n62_));
  nand2  g34(.a(new_n55_), .b(x15), .O(new_n63_));
  ...
  nand4  g41(.a(new_n69_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n62_), .O(z5));
  nand2  g43(.a(new_n39_), .b(x05), .O(new_n72_));
  oai21  g44(.a(new_n34_), .b(new_n31_), .c(x16), .O(new_n73_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n72_), .O(z6));
  nand2  g50(.a(x17), .b(x09), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(x08), .c(new_n29_), .O(new_n80_));
  ...
  oai21  g58(.a(new_n86_), .b(new_n55_), .c(new_n84_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(new_n88_), .c(new_n81_), .O(z7));
  nand2  g62(.a(new_n39_), .b(x07), .O(new_n91_));
  nand4  g63(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n55_), .c(x18), .O(new_n93_));
  nand4  g65(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n94_));
  inv1   g66(.a(new_n94_), .O(new_n95_));
  nor2   g67(.a(x18), .b(new_n85_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n95_), .c(x16), .d(x15), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(new_n93_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n99_));
