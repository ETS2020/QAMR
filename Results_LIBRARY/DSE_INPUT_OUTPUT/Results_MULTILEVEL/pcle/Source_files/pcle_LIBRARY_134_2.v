...
module FAU ( 
  ...
  nand4  g13(.a(new_n38_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n42_));
  ...
  nand3  g18(.a(new_n46_), .b(new_n45_), .c(new_n40_), .O(z2));
  xnor2a g19(.a(x13), .b(x12), .O(new_n48_));
  nand2  g20(.a(x13), .b(new_n38_), .O(new_n49_));
  oai21  g21(.a(new_n48_), .b(new_n38_), .c(new_n49_), .O(new_n50_));
  ...
  nand4  g26(.a(new_n54_), .b(x14), .c(new_n31_), .d(x09), .O(new_n55_));
  ...
  nand3  g43(.a(new_n62_), .b(new_n71_), .c(x15), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n70_), .c(x14), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(x11), .O(new_n74_));
  nand4  g46(.a(x15), .b(x13), .c(x12), .d(x11), .O(new_n75_));
  ...
  nand2  g52(.a(new_n58_), .b(x06), .O(new_n81_));
  nand2  g53(.a(x16), .b(x15), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n61_), .c(x17), .O(new_n83_));
  ...
  nand2  g63(.a(new_n58_), .b(x07), .O(new_n92_));
  ...
  oai21  g67(.a(new_n95_), .b(new_n54_), .c(new_n94_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(x14), .O(new_n97_));
