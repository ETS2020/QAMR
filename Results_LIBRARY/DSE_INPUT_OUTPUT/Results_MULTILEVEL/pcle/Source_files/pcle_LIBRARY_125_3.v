...
module FAU ( 
  ...
  nand2  g27(.a(x11), .b(new_n31_), .O(new_n56_));
  nand3  g28(.a(new_n39_), .b(x13), .c(x12), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(x09), .c(new_n30_), .O(new_n59_));
  aoi22  g31(.a(x14), .b(x10), .c(x08), .d(x03), .O(new_n60_));
  ...
  oai21  g41(.a(new_n40_), .b(new_n62_), .c(new_n69_), .O(z5));
  ...
  oai21  g57(.a(new_n40_), .b(new_n79_), .c(new_n85_), .O(z7));
