...
module FAU ( 
  ...
  oai22  g27(.a(new_n55_), .b(x07), .c(new_n42_), .d(new_n51_), .O(z3));
  ...
  oai22  g43(.a(new_n71_), .b(x07), .c(new_n42_), .d(new_n64_), .O(z5));
  ...
  oai22  g51(.a(new_n79_), .b(x07), .c(new_n42_), .d(new_n73_), .O(z6));
  nand3  g52(.a(x16), .b(x15), .c(x14), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n58_), .c(x17), .O(new_n82_));
  inv1   g54(.a(new_n58_), .O(new_n83_));
  nor2   g55(.a(new_n65_), .b(new_n30_), .O(new_n84_));
  ...
  aoi21  g59(.a(new_n87_), .b(new_n32_), .c(x07), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  oai21  g61(.a(new_n88_), .b(new_n41_), .c(new_n89_), .O(z7));
  oai21  g62(.a(x09), .b(x08), .c(x07), .O(new_n91_));
  nand3  g63(.a(new_n84_), .b(x17), .c(x16), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n58_), .c(x18), .O(new_n93_));
  nor2   g65(.a(new_n76_), .b(new_n65_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n68_), .c(new_n29_), .d(x17), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n97_));
