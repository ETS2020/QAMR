...
module FAU ( 
  ...
  nand4  g13(.a(new_n41_), .b(new_n38_), .c(new_n35_), .d(x15), .O(new_n42_));
  ...
  nand3  g20(.a(new_n48_), .b(new_n46_), .c(new_n45_), .O(z1));
  inv1   g21(.a(x01), .O(new_n50_));
  nand2  g22(.a(new_n45_), .b(x08), .O(new_n51_));
  xor2a  g23(.a(x12), .b(x11), .O(new_n52_));
  nand4  g24(.a(new_n52_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n53_));
  oai21  g25(.a(new_n51_), .b(new_n50_), .c(new_n53_), .O(z2));
  ...
  aoi21  g29(.a(x08), .b(x02), .c(new_n44_), .O(new_n58_));
  ...
  oai21  g37(.a(new_n51_), .b(new_n60_), .c(new_n65_), .O(z4));
  nand3  g38(.a(new_n45_), .b(x08), .c(x04), .O(new_n67_));
  ...
  nand2  g44(.a(x15), .b(new_n37_), .O(new_n73_));
  ...
  nand4  g57(.a(x13), .b(x12), .c(x11), .d(new_n29_), .O(new_n86_));
  nand4  g58(.a(new_n30_), .b(x16), .c(x15), .d(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(x09), .c(new_n31_), .O(new_n89_));
  aoi21  g61(.a(x08), .b(x06), .c(new_n44_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n89_), .O(z7));
  nand4  g63(.a(new_n38_), .b(new_n40_), .c(x16), .d(x15), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n34_), .c(new_n29_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(x17), .O(new_n94_));
  nand4  g66(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n95_));
  inv1   g67(.a(new_n95_), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n62_), .c(new_n40_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n98_));
  nand2  g70(.a(x08), .b(x07), .O(new_n99_));
  nand3  g71(.a(new_n99_), .b(new_n98_), .c(new_n94_), .O(z8));
endmodule
