...
module FAU ( 
  ...
  aoi21  g18(.a(new_n39_), .b(x02), .c(new_n40_), .O(new_n47_));
  ...
  oai21  g22(.a(new_n50_), .b(x02), .c(new_n48_), .O(z2));
  ...
  oai21  g53(.a(new_n81_), .b(x02), .c(new_n75_), .O(z6));
  ...
  aoi21  g59(.a(new_n87_), .b(new_n40_), .c(x02), .O(new_n88_));
  ...
  nand4  g69(.a(new_n97_), .b(x09), .c(new_n40_), .d(new_n29_), .O(new_n98_));
