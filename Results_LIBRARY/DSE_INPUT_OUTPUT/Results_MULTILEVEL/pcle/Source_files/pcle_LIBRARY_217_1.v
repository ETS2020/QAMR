...
module FAU ( 
  ...
  nand2  g23(.a(new_n44_), .b(x04), .O(new_n53_));
  nand4  g24(.a(new_n47_), .b(x15), .c(new_n31_), .d(new_n30_), .O(new_n54_));
  ...
  nand2  g36(.a(new_n44_), .b(x07), .O(new_n66_));
  nand4  g37(.a(new_n47_), .b(x18), .c(new_n31_), .d(new_n30_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n66_), .O(z8));
  zero   g39(.O(z0));
endmodule
