...
module FAU ( 
  ...
  aoi21  g41(.a(new_n69_), .b(x14), .c(new_n51_), .O(new_n70_));
  ...
  nand2  g45(.a(x14), .b(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n52_), .c(x16), .O(new_n75_));
  inv1   g47(.a(x16), .O(new_n76_));
  nand4  g48(.a(new_n64_), .b(new_n76_), .c(x14), .d(x13), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n75_), .c(new_n51_), .O(new_n78_));
  ...
  nand3  g57(.a(new_n85_), .b(x16), .c(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n61_), .c(new_n84_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(x15), .c(new_n31_), .d(x09), .O(new_n88_));
  oai22  g60(.a(new_n88_), .b(x08), .c(new_n40_), .d(new_n82_), .O(z7));
  nand3  g61(.a(x17), .b(x16), .c(x14), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n61_), .c(x18), .O(new_n91_));
  inv1   g63(.a(new_n61_), .O(new_n92_));
  and2   g64(.a(x16), .b(x14), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(new_n29_), .d(x17), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n91_), .c(new_n51_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n30_), .c(new_n50_), .O(new_n96_));
