...
module FAU ( 
  ...
  nand4  g58(.a(new_n86_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n87_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n51_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n90_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n96_));
  aoi21  g68(.a(x08), .b(x07), .c(new_n30_), .O(new_n97_));
