...
module FAU ( 
  ...
  nand3  g13(.a(new_n41_), .b(new_n30_), .c(new_n37_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n40_), .O(z1));
  xor2a  g15(.a(x12), .b(x11), .O(new_n44_));
  nand3  g16(.a(new_n44_), .b(x09), .c(new_n36_), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(x18), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(new_n37_), .O(new_n47_));
  ...
  aoi21  g26(.a(new_n54_), .b(new_n36_), .c(new_n38_), .O(new_n55_));
  ...
  aoi21  g33(.a(new_n61_), .b(new_n59_), .c(new_n29_), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n36_), .c(new_n38_), .O(new_n63_));
  nand2  g35(.a(x08), .b(x03), .O(new_n64_));
  oai21  g36(.a(new_n63_), .b(x10), .c(new_n64_), .O(z4));
  nand2  g37(.a(new_n39_), .b(x04), .O(new_n66_));
  oai21  g38(.a(new_n31_), .b(new_n50_), .c(x15), .O(new_n67_));
  ...
  nand4  g42(.a(new_n70_), .b(x18), .c(new_n37_), .d(x09), .O(new_n71_));
  ...
  nand4  g50(.a(new_n78_), .b(x18), .c(new_n37_), .d(x09), .O(new_n79_));
  ...
  nand4  g58(.a(new_n86_), .b(x18), .c(new_n37_), .d(x09), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(x08), .c(new_n81_), .O(z7));
  nand4  g60(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n58_), .c(x09), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(x08), .c(x18), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n37_), .O(new_n92_));
