...
module FAU ( 
  ...
  nand2  g24(.a(new_n39_), .b(x05), .O(new_n53_));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n62_), .c(new_n30_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n40_), .c(x05), .O(new_n67_));
  ...
  aoi21  g45(.a(new_n73_), .b(new_n71_), .c(new_n30_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n40_), .c(x05), .O(new_n75_));
  ...
  nand3  g55(.a(x10), .b(x08), .c(x05), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(x05), .c(new_n84_), .O(z6));
  ...
  aoi21  g62(.a(new_n90_), .b(new_n40_), .c(x05), .O(new_n91_));
  ...
  inv1   g67(.a(new_n70_), .O(new_n96_));
  nor2   g68(.a(new_n80_), .b(new_n72_), .O(new_n97_));
  nor2   g69(.a(x18), .b(new_n88_), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n95_), .c(new_n30_), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n40_), .c(x05), .O(new_n101_));
