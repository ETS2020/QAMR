...
module FAU ( 
  ...
  aoi21  g15(.a(new_n29_), .b(new_n31_), .c(new_n30_), .O(new_n44_));
  nand2  g16(.a(new_n44_), .b(x01), .O(new_n45_));
  xor2a  g17(.a(x12), .b(x11), .O(new_n46_));
  nand4  g18(.a(new_n46_), .b(x18), .c(new_n31_), .d(x09), .O(new_n47_));
  ...
  aoi21  g26(.a(new_n54_), .b(new_n30_), .c(new_n29_), .O(new_n55_));
  ...
  oai21  g39(.a(new_n67_), .b(new_n50_), .c(x15), .O(new_n68_));
  inv1   g40(.a(x15), .O(new_n69_));
  nand4  g41(.a(new_n61_), .b(new_n69_), .c(x14), .d(x13), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n68_), .c(new_n49_), .O(new_n71_));
  ...
  nand2  g46(.a(new_n44_), .b(x05), .O(new_n75_));
  ...
  nand4  g52(.a(new_n80_), .b(x18), .c(new_n31_), .d(x09), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(x08), .c(new_n75_), .O(z6));
  nand2  g54(.a(new_n44_), .b(x06), .O(new_n83_));
  nand3  g55(.a(x16), .b(x15), .c(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n58_), .c(x17), .O(new_n85_));
  inv1   g57(.a(x17), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(x16), .c(x15), .d(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n58_), .c(new_n85_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(x18), .c(new_n31_), .d(x09), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x08), .c(new_n83_), .O(z7));
  nand4  g62(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n58_), .c(x09), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(x08), .c(x18), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n31_), .O(new_n94_));
