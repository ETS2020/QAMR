...
module FAU ( 
  ...
  nand2  g09(.a(x10), .b(x02), .O(new_n38_));
  ...
  nand3  g18(.a(new_n46_), .b(new_n44_), .c(new_n38_), .O(z2));
  ...
  nand2  g37(.a(new_n38_), .b(x08), .O(new_n66_));
  ...
  oai22  g42(.a(new_n70_), .b(new_n48_), .c(new_n69_), .d(new_n67_), .O(new_n71_));
  ...
  aoi21  g51(.a(x08), .b(x05), .c(new_n62_), .O(new_n80_));
  ...
  oai21  g60(.a(new_n66_), .b(new_n82_), .c(new_n88_), .O(z7));
  ...
  aoi21  g67(.a(x08), .b(x07), .c(new_n62_), .O(new_n96_));
