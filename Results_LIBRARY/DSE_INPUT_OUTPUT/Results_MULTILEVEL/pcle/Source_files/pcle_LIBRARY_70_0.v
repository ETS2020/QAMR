...
module FAU ( 
  ...
  aoi21  g34(.a(new_n62_), .b(new_n31_), .c(new_n39_), .O(new_n63_));
  ...
  oai22  g44(.a(new_n72_), .b(new_n39_), .c(new_n50_), .d(new_n66_), .O(z5));
  ...
  aoi21  g50(.a(new_n78_), .b(new_n75_), .c(new_n58_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n31_), .c(new_n39_), .O(new_n80_));
  ...
  oai22  g61(.a(new_n89_), .b(new_n39_), .c(new_n50_), .d(new_n83_), .O(z7));
  ...
  aoi21  g66(.a(new_n94_), .b(new_n92_), .c(new_n58_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n31_), .c(new_n39_), .O(new_n96_));
