...
module FAU ( 
  ...
  aoi21  g13(.a(x13), .b(x10), .c(new_n31_), .O(new_n42_));
  ...
  aoi22  g20(.a(x13), .b(x10), .c(x08), .d(x01), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(new_n48_), .O(z2));
  nand2  g22(.a(new_n42_), .b(x02), .O(new_n51_));
  nand3  g23(.a(new_n30_), .b(x12), .c(x11), .O(new_n52_));
  oai21  g24(.a(new_n35_), .b(new_n30_), .c(new_n52_), .O(new_n53_));
  nand4  g25(.a(new_n53_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n51_), .O(z3));
  nand3  g27(.a(new_n36_), .b(x12), .c(x11), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(new_n32_), .c(new_n29_), .O(new_n57_));
  ...
  nand3  g36(.a(x11), .b(x09), .c(new_n31_), .O(new_n65_));
  nand3  g37(.a(new_n37_), .b(x14), .c(x12), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n65_), .c(new_n29_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x13), .O(new_n68_));
  nand4  g40(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n69_));
  inv1   g41(.a(new_n69_), .O(new_n70_));
  nor2   g42(.a(new_n70_), .b(new_n37_), .O(new_n71_));
  ...
  nand3  g54(.a(new_n35_), .b(x09), .c(new_n31_), .O(new_n83_));
  ...
  aoi21  g61(.a(new_n89_), .b(new_n60_), .c(new_n84_), .O(new_n90_));
  ...
  nand4  g72(.a(new_n100_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n101_));
