...
module FAU ( 
  ...
  nand4  g33(.a(new_n61_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n62_));
  ...
  aoi21  g39(.a(new_n67_), .b(new_n39_), .c(new_n48_), .O(new_n68_));
  ...
  aoi21  g55(.a(new_n83_), .b(new_n39_), .c(new_n48_), .O(new_n84_));
