...
module FAU ( 
  ...
  aoi21  g17(.a(x12), .b(new_n38_), .c(new_n30_), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(x01), .O(new_n47_));
  nand3  g19(.a(new_n39_), .b(x11), .c(new_n31_), .O(new_n48_));
  oai21  g20(.a(new_n48_), .b(new_n45_), .c(new_n47_), .O(z2));
  xor2a  g21(.a(x13), .b(x12), .O(new_n50_));
  nand4  g22(.a(new_n50_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n51_));
  aoi22  g23(.a(x12), .b(new_n38_), .c(x08), .d(x02), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n51_), .O(z3));
  inv1   g25(.a(x14), .O(new_n54_));
  nand3  g26(.a(new_n54_), .b(x13), .c(new_n31_), .O(new_n55_));
  oai21  g27(.a(new_n55_), .b(new_n45_), .c(x11), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(x12), .O(new_n57_));
  aoi21  g29(.a(x13), .b(x12), .c(new_n54_), .O(new_n58_));
  ...
  oai21  g38(.a(new_n66_), .b(new_n64_), .c(x11), .O(new_n67_));
  nand2  g39(.a(x15), .b(new_n39_), .O(new_n68_));
  ...
  nand2  g51(.a(x16), .b(new_n39_), .O(new_n80_));
  ...
  oai21  g59(.a(new_n87_), .b(new_n84_), .c(x11), .O(new_n88_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n84_), .c(x11), .O(new_n97_));
