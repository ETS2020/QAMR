...
module FAU ( 
  ...
  oai21  g30(.a(x10), .b(x00), .c(x08), .O(new_n59_));
  ...
  oai21  g37(.a(new_n59_), .b(new_n58_), .c(new_n65_), .O(z4));
  ...
  oai22  g53(.a(new_n81_), .b(new_n39_), .c(new_n59_), .d(new_n75_), .O(z6));
  ...
  oai22  g61(.a(new_n89_), .b(new_n39_), .c(new_n59_), .d(new_n83_), .O(z7));
  ...
  nand4  g69(.a(new_n97_), .b(x09), .c(new_n31_), .d(x00), .O(new_n98_));
  oai21  g70(.a(new_n59_), .b(new_n91_), .c(new_n98_), .O(z8));
endmodule
