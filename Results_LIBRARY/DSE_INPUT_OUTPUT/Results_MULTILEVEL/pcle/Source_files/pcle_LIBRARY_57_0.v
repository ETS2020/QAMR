...
module FAU ( 
  ...
  oai21  g40(.a(new_n68_), .b(new_n51_), .c(new_n66_), .O(new_n69_));
  ...
  nand4  g44(.a(new_n72_), .b(x09), .c(new_n31_), .d(x00), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n65_), .O(z5));
  nand2  g46(.a(new_n49_), .b(x05), .O(new_n75_));
  ...
  oai21  g53(.a(new_n81_), .b(new_n39_), .c(new_n75_), .O(z6));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n85_), .c(new_n83_), .O(new_n89_));
  ...
  aoi21  g70(.a(new_n98_), .b(new_n94_), .c(new_n83_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n31_), .c(new_n39_), .O(new_n100_));
