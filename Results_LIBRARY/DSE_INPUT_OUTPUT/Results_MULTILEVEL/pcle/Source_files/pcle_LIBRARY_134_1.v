...
module FAU ( 
  ...
  nor2   g18(.a(new_n39_), .b(x11), .O(new_n47_));
  ...
  nand4  g29(.a(new_n39_), .b(x13), .c(x12), .d(x11), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(new_n39_), .c(new_n58_), .O(new_n59_));
  ...
  nor2   g34(.a(new_n47_), .b(new_n30_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(x04), .O(new_n64_));
  inv1   g36(.a(x15), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(x13), .c(x12), .O(new_n66_));
  oai21  g38(.a(new_n57_), .b(new_n65_), .c(new_n66_), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(x14), .c(x11), .O(new_n68_));
  oai21  g40(.a(new_n65_), .b(x14), .c(new_n68_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n64_), .O(z5));
  inv1   g43(.a(x16), .O(new_n72_));
  nand3  g44(.a(new_n57_), .b(new_n72_), .c(x15), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n40_), .c(x11), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(x14), .O(new_n75_));
  nand3  g47(.a(new_n57_), .b(x15), .c(x14), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(x16), .c(new_n31_), .O(new_n77_));
  ...
  nand2  g53(.a(new_n63_), .b(x06), .O(new_n82_));
  nand2  g54(.a(x16), .b(x15), .O(new_n83_));
