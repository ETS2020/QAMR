...
module FAU ( 
  ...
  aoi21  g20(.a(new_n41_), .b(x04), .c(new_n42_), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(x01), .O(new_n50_));
  xor2a  g22(.a(x12), .b(x11), .O(new_n51_));
  nand4  g23(.a(new_n51_), .b(new_n41_), .c(x09), .d(new_n42_), .O(new_n52_));
  oai21  g24(.a(new_n52_), .b(x04), .c(new_n50_), .O(z2));
  nand2  g25(.a(new_n49_), .b(x02), .O(new_n54_));
  xnor2a g26(.a(x13), .b(x12), .O(new_n55_));
  nand2  g27(.a(x13), .b(new_n43_), .O(new_n56_));
  oai21  g28(.a(new_n55_), .b(new_n43_), .c(new_n56_), .O(new_n57_));
  nand4  g29(.a(new_n57_), .b(new_n41_), .c(x09), .d(new_n42_), .O(new_n58_));
  oai21  g30(.a(new_n58_), .b(x04), .c(new_n54_), .O(z3));
  nand2  g31(.a(new_n41_), .b(x04), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(x08), .c(x03), .O(new_n61_));
  nand2  g33(.a(new_n32_), .b(x14), .O(new_n62_));
  nand4  g34(.a(new_n34_), .b(x13), .c(x12), .d(x11), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n62_), .c(x10), .O(new_n64_));
  nand4  g36(.a(new_n64_), .b(x09), .c(new_n42_), .d(new_n29_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n61_), .O(z4));
  nand2  g38(.a(new_n32_), .b(x15), .O(new_n67_));
  nand4  g39(.a(new_n35_), .b(x13), .c(x12), .d(x11), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(x14), .O(new_n70_));
  nand2  g42(.a(x15), .b(new_n34_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n70_), .c(x10), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(x09), .c(new_n42_), .d(new_n29_), .O(new_n73_));
  nand3  g45(.a(x10), .b(x08), .c(x04), .O(new_n74_));
  ...
  nand4  g51(.a(new_n33_), .b(new_n79_), .c(x15), .d(x14), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n78_), .c(new_n30_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n42_), .c(x04), .O(new_n82_));
  nand2  g54(.a(x08), .b(x05), .O(new_n83_));
  oai21  g55(.a(new_n82_), .b(x10), .c(new_n83_), .O(z6));
  nand2  g56(.a(new_n49_), .b(x06), .O(new_n85_));
  nand3  g57(.a(x16), .b(x15), .c(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n32_), .c(x17), .O(new_n87_));
  inv1   g59(.a(x17), .O(new_n88_));
  nand3  g60(.a(new_n36_), .b(new_n88_), .c(x16), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n32_), .c(new_n87_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n41_), .c(x09), .d(new_n42_), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(x04), .c(new_n85_), .O(z7));
  nand4  g64(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n32_), .c(x18), .O(new_n94_));
  nor2   g66(.a(new_n79_), .b(new_n35_), .O(new_n95_));
  nand4  g67(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n96_));
  inv1   g68(.a(new_n96_), .O(new_n97_));
  nor2   g69(.a(x18), .b(new_n88_), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(new_n97_), .c(new_n95_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n94_), .c(new_n30_), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n42_), .c(x04), .O(new_n101_));
