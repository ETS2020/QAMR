...
module FAU ( 
  ...
  nand2  g16(.a(x13), .b(new_n44_), .O(new_n45_));
  oai22  g17(.a(new_n45_), .b(new_n40_), .c(new_n43_), .d(x10), .O(new_n46_));
  ...
  nand3  g23(.a(new_n51_), .b(x12), .c(new_n31_), .O(new_n52_));
  aoi21  g24(.a(new_n52_), .b(new_n45_), .c(new_n40_), .O(new_n53_));
  nor2   g25(.a(new_n51_), .b(x11), .O(new_n54_));
  oai21  g26(.a(new_n54_), .b(new_n53_), .c(x09), .O(new_n55_));
  aoi21  g27(.a(x08), .b(x02), .c(new_n48_), .O(new_n56_));
  oai21  g28(.a(new_n55_), .b(x08), .c(new_n56_), .O(z3));
  nand2  g29(.a(x09), .b(new_n30_), .O(new_n58_));
  inv1   g30(.a(x14), .O(new_n59_));
  nand3  g31(.a(new_n59_), .b(x12), .c(x11), .O(new_n60_));
  oai21  g32(.a(new_n60_), .b(new_n58_), .c(new_n31_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(x13), .O(new_n62_));
  nand3  g34(.a(x13), .b(x12), .c(x11), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(x14), .c(new_n31_), .O(new_n64_));
  ...
  nand2  g41(.a(new_n38_), .b(x08), .O(new_n70_));
  inv1   g42(.a(x15), .O(new_n71_));
  nand2  g43(.a(x12), .b(x11), .O(new_n72_));
  nand4  g44(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n73_));
  inv1   g45(.a(new_n73_), .O(new_n74_));
  nand3  g46(.a(new_n71_), .b(x14), .c(x13), .O(new_n75_));
  oai22  g47(.a(new_n75_), .b(new_n72_), .c(new_n74_), .d(new_n71_), .O(new_n76_));
  nand4  g48(.a(new_n76_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n77_));
  oai21  g49(.a(new_n70_), .b(new_n69_), .c(new_n77_), .O(z5));
  inv1   g50(.a(x05), .O(new_n79_));
  nand3  g51(.a(x15), .b(x14), .c(x13), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n72_), .c(x16), .O(new_n81_));
