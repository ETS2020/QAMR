...
module FAU ( 
  ...
  oai21  g12(.a(x17), .b(new_n40_), .c(x08), .O(new_n41_));
  inv1   g13(.a(x11), .O(new_n42_));
  nand3  g14(.a(x17), .b(new_n42_), .c(new_n31_), .O(new_n43_));
  oai22  g15(.a(new_n43_), .b(new_n39_), .c(new_n41_), .d(new_n38_), .O(z1));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  nand3  g17(.a(new_n45_), .b(new_n31_), .c(new_n30_), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(x17), .O(new_n47_));
  ...
  oai21  g30(.a(new_n41_), .b(new_n51_), .c(new_n58_), .O(z3));
  ...
  aoi21  g36(.a(new_n64_), .b(new_n30_), .c(new_n52_), .O(new_n65_));
  nand2  g37(.a(x08), .b(x03), .O(new_n66_));
  oai21  g38(.a(new_n65_), .b(new_n40_), .c(new_n66_), .O(z4));
  ...
  nand4  g45(.a(new_n73_), .b(x17), .c(new_n31_), .d(x09), .O(new_n74_));
  oai22  g46(.a(new_n74_), .b(x08), .c(new_n41_), .d(new_n68_), .O(z5));
  nand3  g47(.a(x15), .b(x14), .c(x13), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n53_), .c(x16), .O(new_n77_));
  inv1   g49(.a(new_n60_), .O(new_n78_));
  nor2   g50(.a(x16), .b(new_n71_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(x14), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n77_), .c(x10), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n30_), .c(new_n52_), .O(new_n82_));
  nand2  g54(.a(x08), .b(x05), .O(new_n83_));
  oai21  g55(.a(new_n82_), .b(new_n40_), .c(new_n83_), .O(z6));
  inv1   g56(.a(x06), .O(new_n85_));
  nand3  g57(.a(x16), .b(x15), .c(x14), .O(new_n86_));
  inv1   g58(.a(new_n86_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n78_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(x17), .c(new_n31_), .d(x09), .O(new_n89_));
  oai22  g61(.a(new_n89_), .b(x08), .c(new_n41_), .d(new_n85_), .O(z7));
  inv1   g62(.a(x07), .O(new_n91_));
  oai21  g63(.a(new_n86_), .b(new_n60_), .c(x18), .O(new_n92_));
  nand4  g64(.a(new_n29_), .b(x16), .c(x15), .d(x14), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n60_), .c(new_n92_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(x17), .c(new_n31_), .d(x09), .O(new_n95_));
  oai22  g67(.a(new_n95_), .b(x08), .c(new_n41_), .d(new_n91_), .O(z8));
endmodule
