...
module FAU ( 
  ...
  aoi21  g15(.a(x10), .b(x09), .c(new_n43_), .O(new_n44_));
  nand2  g16(.a(new_n44_), .b(x00), .O(new_n45_));
  nand4  g17(.a(new_n31_), .b(new_n30_), .c(x09), .d(new_n43_), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(new_n45_), .O(z1));
  xor2a  g19(.a(x12), .b(x11), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(new_n43_), .c(x10), .O(new_n49_));
  nand2  g21(.a(x08), .b(x01), .O(new_n50_));
  oai21  g22(.a(new_n49_), .b(new_n29_), .c(new_n50_), .O(z2));
  nand2  g23(.a(new_n44_), .b(x02), .O(new_n52_));
  ...
  nand3  g39(.a(new_n37_), .b(x14), .c(x13), .O(new_n68_));
  oai22  g40(.a(new_n68_), .b(new_n53_), .c(new_n67_), .d(new_n37_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n43_), .c(x10), .O(new_n70_));
  nand2  g42(.a(x08), .b(x04), .O(new_n71_));
  oai21  g43(.a(new_n70_), .b(new_n29_), .c(new_n71_), .O(z5));
  nand2  g44(.a(new_n44_), .b(x05), .O(new_n73_));
  nand3  g45(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n53_), .c(x16), .O(new_n75_));
  inv1   g47(.a(x16), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(x15), .c(x14), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n60_), .c(new_n75_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n30_), .c(x09), .d(new_n43_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n73_), .O(z6));
  nand2  g52(.a(new_n44_), .b(x06), .O(new_n81_));
  nand3  g53(.a(x16), .b(x15), .c(x14), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n60_), .c(x17), .O(new_n83_));
  inv1   g55(.a(x17), .O(new_n84_));
  nand3  g56(.a(new_n38_), .b(new_n84_), .c(x16), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n60_), .c(new_n83_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n30_), .c(x09), .d(new_n43_), .O(new_n87_));
  ...
  nor2   g62(.a(new_n76_), .b(new_n37_), .O(new_n91_));
  nor2   g63(.a(x18), .b(new_n84_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n91_), .c(new_n67_), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n90_), .c(x08), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(x10), .c(x09), .O(new_n95_));
