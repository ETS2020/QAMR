...
module FAU ( 
  ...
  nand2  g14(.a(new_n39_), .b(x02), .O(new_n43_));
  ...
  nand3  g29(.a(new_n57_), .b(new_n40_), .c(x09), .O(new_n58_));
  aoi21  g30(.a(new_n58_), .b(new_n39_), .c(new_n38_), .O(z3));
  nand2  g31(.a(new_n30_), .b(x14), .O(new_n60_));
  inv1   g32(.a(x14), .O(new_n61_));
  nand3  g33(.a(new_n55_), .b(new_n61_), .c(x13), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n60_), .c(new_n29_), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n39_), .c(new_n38_), .O(new_n64_));
  nand2  g36(.a(x08), .b(x03), .O(new_n65_));
  oai21  g37(.a(new_n64_), .b(x10), .c(new_n65_), .O(z4));
  nand2  g38(.a(new_n41_), .b(x04), .O(new_n67_));
  ...
  oai22  g43(.a(new_n71_), .b(new_n54_), .c(new_n70_), .d(new_n68_), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n38_), .c(new_n67_), .O(z5));
  nand2  g46(.a(new_n41_), .b(x05), .O(new_n75_));
  ...
  nand4  g52(.a(new_n80_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n38_), .c(new_n75_), .O(z6));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n30_), .c(x17), .O(new_n84_));
  inv1   g56(.a(new_n30_), .O(new_n85_));
  nand4  g57(.a(new_n32_), .b(new_n85_), .c(new_n33_), .d(x16), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n84_), .c(new_n29_), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n39_), .c(new_n38_), .O(new_n88_));
  ...
  nand4  g66(.a(new_n94_), .b(new_n70_), .c(new_n34_), .d(x17), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n93_), .c(x10), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(x09), .c(new_n39_), .d(x02), .O(new_n97_));
