...
module FAU ( 
  ...
  aoi21  g43(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n29_), .c(new_n54_), .O(new_n73_));
  ...
  inv1   g49(.a(new_n62_), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n33_), .c(x15), .d(x14), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n77_), .c(new_n69_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n29_), .c(new_n54_), .O(new_n81_));
  ...
  nand2  g58(.a(new_n86_), .b(new_n78_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(x17), .c(new_n39_), .d(x09), .O(new_n88_));
  oai22  g60(.a(new_n88_), .b(x08), .c(new_n53_), .d(new_n84_), .O(z7));
  inv1   g61(.a(x07), .O(new_n90_));
  oai21  g62(.a(new_n85_), .b(new_n62_), .c(x18), .O(new_n91_));
  nand4  g63(.a(new_n34_), .b(x16), .c(x15), .d(x14), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n62_), .c(new_n91_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(x17), .c(new_n39_), .d(x09), .O(new_n94_));
  oai22  g66(.a(new_n94_), .b(x08), .c(new_n53_), .d(new_n90_), .O(z8));
endmodule
