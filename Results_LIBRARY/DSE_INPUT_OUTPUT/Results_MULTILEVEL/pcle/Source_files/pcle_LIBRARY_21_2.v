...
module FAU ( 
  ...
  oai21  g17(.a(new_n33_), .b(x08), .c(x01), .O(new_n46_));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n32_), .c(x01), .O(new_n56_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n32_), .c(x01), .O(new_n64_));
  ...
  aoi21  g43(.a(new_n71_), .b(new_n32_), .c(x01), .O(new_n72_));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n32_), .c(x01), .O(new_n81_));
  ...
  nand4  g58(.a(new_n86_), .b(new_n78_), .c(x15), .d(x14), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n85_), .c(new_n50_), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n32_), .c(x01), .O(new_n89_));
  ...
  aoi21  g69(.a(new_n97_), .b(new_n32_), .c(x01), .O(new_n98_));
