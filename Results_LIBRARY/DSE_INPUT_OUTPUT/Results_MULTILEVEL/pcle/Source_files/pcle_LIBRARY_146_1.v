...
module FAU ( 
  ...
  oai21  g10(.a(new_n31_), .b(x09), .c(x08), .O(new_n39_));
  ...
  nand2  g35(.a(new_n55_), .b(x15), .O(new_n64_));
  inv1   g36(.a(x15), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(x13), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n57_), .c(new_n64_), .O(new_n67_));
  ...
  oai21  g45(.a(new_n73_), .b(new_n57_), .c(x16), .O(new_n74_));
  ...
  nor2   g50(.a(new_n31_), .b(x09), .O(new_n79_));
