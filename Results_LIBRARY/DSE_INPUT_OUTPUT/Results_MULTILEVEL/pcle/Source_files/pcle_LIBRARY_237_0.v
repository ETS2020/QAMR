...
module FAU ( 
  ...
  nand3  g21(.a(new_n49_), .b(x09), .c(new_n30_), .O(new_n50_));
  ...
  nand2  g27(.a(new_n49_), .b(x14), .O(new_n56_));
  ...
  nand2  g34(.a(new_n49_), .b(x15), .O(new_n63_));
  ...
  inv1   g47(.a(new_n49_), .O(new_n76_));
  ...
  nor2   g57(.a(x17), .b(new_n75_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n85_), .c(x15), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n83_), .c(new_n72_), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n30_), .c(new_n39_), .O(new_n89_));
  ...
  aoi21  g67(.a(new_n95_), .b(new_n93_), .c(new_n72_), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n30_), .c(new_n39_), .O(new_n97_));
