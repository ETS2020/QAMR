...
module FAU ( 
  ...
  nand2  g09(.a(new_n29_), .b(x16), .O(new_n38_));
  ...
  aoi21  g18(.a(new_n46_), .b(new_n45_), .c(new_n43_), .O(z2));
  ...
  aoi21  g25(.a(x08), .b(x02), .c(new_n43_), .O(new_n54_));
  ...
  aoi21  g49(.a(x08), .b(x05), .c(new_n43_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n77_), .O(z6));
  nand3  g51(.a(new_n38_), .b(x08), .c(x06), .O(new_n80_));
  oai21  g52(.a(new_n72_), .b(new_n48_), .c(x18), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(x16), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x17), .O(new_n83_));
  nor2   g55(.a(new_n29_), .b(x17), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n66_), .c(x16), .d(x15), .O(new_n85_));
  ...
  nand3  g60(.a(new_n38_), .b(x08), .c(x07), .O(new_n89_));
  nor2   g61(.a(new_n64_), .b(new_n56_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n58_), .c(x17), .d(x16), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(x18), .c(new_n31_), .d(x09), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(x08), .c(new_n89_), .O(z8));
endmodule
