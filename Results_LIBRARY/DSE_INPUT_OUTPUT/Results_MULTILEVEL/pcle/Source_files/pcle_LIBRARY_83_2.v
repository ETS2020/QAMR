...
module FAU ( 
  ...
  nor2   g27(.a(new_n38_), .b(new_n30_), .O(new_n56_));
  ...
  nand2  g37(.a(new_n56_), .b(x04), .O(new_n66_));
  inv1   g38(.a(new_n60_), .O(new_n67_));
  nor2   g39(.a(x15), .b(new_n50_), .O(new_n68_));
  aoi22  g40(.a(new_n68_), .b(new_n67_), .c(new_n58_), .d(x15), .O(new_n69_));
  nand2  g41(.a(x15), .b(new_n61_), .O(new_n70_));
  oai21  g42(.a(new_n69_), .b(new_n61_), .c(new_n70_), .O(new_n71_));
  ...
  oai21  g46(.a(new_n74_), .b(x08), .c(new_n31_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n50_), .O(new_n76_));
  ...
  nand3  g55(.a(new_n83_), .b(new_n82_), .c(new_n76_), .O(z6));
  nand2  g56(.a(new_n56_), .b(x06), .O(new_n85_));
  ...
  nand2  g66(.a(new_n94_), .b(new_n50_), .O(new_n95_));
  ...
  nand3  g70(.a(new_n67_), .b(x14), .c(x13), .O(new_n99_));
