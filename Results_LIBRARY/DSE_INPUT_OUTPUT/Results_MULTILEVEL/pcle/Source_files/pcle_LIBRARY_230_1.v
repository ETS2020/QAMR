...
module FAU ( 
  ...
  nand2  g27(.a(new_n39_), .b(x08), .O(new_n56_));
  ...
  oai22  g40(.a(new_n68_), .b(new_n59_), .c(new_n67_), .d(new_n65_), .O(new_n69_));
  ...
  oai21  g51(.a(new_n56_), .b(new_n73_), .c(new_n79_), .O(z6));
  ...
  oai21  g59(.a(new_n56_), .b(new_n81_), .c(new_n87_), .O(z7));
  oai21  g60(.a(x10), .b(x07), .c(x08), .O(new_n89_));
  ...
  nand3  g67(.a(new_n95_), .b(new_n89_), .c(new_n39_), .O(z8));
endmodule
