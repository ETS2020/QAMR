...
module FAU ( 
  ...
  nand2  g13(.a(new_n41_), .b(x01), .O(new_n42_));
  ...
  nand3  g19(.a(new_n47_), .b(new_n38_), .c(x09), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(new_n39_), .c(new_n46_), .O(z2));
  ...
  aoi21  g26(.a(new_n54_), .b(new_n39_), .c(new_n46_), .O(new_n55_));
  ...
  aoi21  g33(.a(new_n61_), .b(new_n58_), .c(new_n29_), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n39_), .c(new_n46_), .O(new_n63_));
  ...
  aoi21  g42(.a(new_n70_), .b(new_n39_), .c(new_n46_), .O(new_n71_));
  ...
  aoi21  g51(.a(new_n79_), .b(new_n39_), .c(new_n46_), .O(new_n80_));
  ...
  nand4  g56(.a(new_n32_), .b(new_n77_), .c(new_n33_), .d(x16), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n84_), .c(new_n29_), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n39_), .c(new_n46_), .O(new_n87_));
  nand2  g59(.a(x08), .b(x06), .O(new_n88_));
  oai21  g60(.a(new_n87_), .b(x10), .c(new_n88_), .O(z7));
  nand2  g61(.a(new_n38_), .b(new_n46_), .O(new_n90_));
  ...
  nand4  g69(.a(new_n97_), .b(x09), .c(new_n39_), .d(x01), .O(new_n98_));
