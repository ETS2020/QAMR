...
module FAU ( 
  ...
  nand3  g07(.a(x18), .b(x16), .c(x15), .O(new_n36_));
  nor2   g08(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  nand3  g09(.a(new_n37_), .b(new_n34_), .c(new_n32_), .O(new_n38_));
  aoi21  g10(.a(new_n38_), .b(new_n29_), .c(new_n30_), .O(z0));
  inv1   g11(.a(x08), .O(new_n40_));
  aoi21  g12(.a(x17), .b(x10), .c(new_n40_), .O(new_n41_));
  ...
  oai22  g31(.a(new_n59_), .b(new_n33_), .c(new_n58_), .d(new_n56_), .O(new_n60_));
  nand4  g32(.a(new_n60_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n61_));
  aoi22  g33(.a(x17), .b(x10), .c(x08), .d(x03), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n61_), .O(z4));
  nand2  g35(.a(new_n41_), .b(x04), .O(new_n64_));
  oai21  g36(.a(new_n35_), .b(new_n33_), .c(x15), .O(new_n65_));
  inv1   g37(.a(x15), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(x14), .c(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n33_), .c(new_n65_), .O(new_n68_));
  ...
  oai21  g44(.a(new_n72_), .b(new_n33_), .c(x16), .O(new_n73_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n77_));
  ...
  nand2  g56(.a(new_n84_), .b(new_n79_), .O(z7));
  nand2  g57(.a(new_n34_), .b(new_n32_), .O(new_n86_));
  inv1   g58(.a(x18), .O(new_n87_));
  and2   g59(.a(x14), .b(x13), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n87_), .c(x16), .d(x15), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n86_), .c(new_n29_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(x17), .O(new_n91_));
  nand4  g63(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n92_));
  inv1   g64(.a(new_n92_), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n58_), .c(new_n87_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n95_));
