...
module FAU ( 
  ...
  nand2  g44(.a(new_n53_), .b(x05), .O(new_n73_));
  nand3  g45(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n45_), .c(x16), .O(new_n75_));
  ...
  nand4  g50(.a(new_n78_), .b(new_n29_), .c(new_n34_), .d(x09), .O(new_n79_));
  ...
  nor2   g55(.a(new_n65_), .b(new_n57_), .O(new_n84_));
  nor2   g56(.a(x17), .b(new_n76_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n82_), .c(new_n44_), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n33_), .c(x18), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  oai21  g61(.a(new_n88_), .b(x10), .c(new_n89_), .O(z7));
  inv1   g62(.a(x07), .O(new_n91_));
  nand4  g63(.a(new_n58_), .b(new_n34_), .c(x09), .d(new_n33_), .O(new_n92_));
  inv1   g64(.a(new_n74_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n29_), .c(x17), .d(x16), .O(new_n94_));
  oai22  g66(.a(new_n94_), .b(new_n92_), .c(new_n32_), .d(new_n91_), .O(z8));
endmodule
