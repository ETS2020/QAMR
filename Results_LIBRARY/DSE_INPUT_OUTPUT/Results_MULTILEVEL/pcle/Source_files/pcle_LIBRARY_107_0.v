...
module FAU ( 
  ...
  aoi21  g27(.a(new_n55_), .b(new_n53_), .c(new_n39_), .O(new_n56_));
  ...
  aoi21  g45(.a(new_n73_), .b(new_n72_), .c(new_n39_), .O(new_n74_));
  ...
  oai21  g55(.a(new_n77_), .b(new_n52_), .c(x17), .O(new_n84_));
  ...
  nand4  g59(.a(new_n87_), .b(x16), .c(new_n31_), .d(x09), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(x08), .c(new_n83_), .O(z7));
  inv1   g61(.a(x09), .O(new_n90_));
  nand3  g62(.a(x17), .b(x15), .c(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n60_), .c(x18), .O(new_n92_));
  inv1   g64(.a(new_n60_), .O(new_n93_));
