...
module FAU ( 
  ...
  oai21  g13(.a(new_n41_), .b(x08), .c(x00), .O(new_n42_));
  inv1   g14(.a(x08), .O(new_n43_));
  inv1   g15(.a(x11), .O(new_n44_));
  nand4  g16(.a(new_n44_), .b(new_n41_), .c(x09), .d(new_n43_), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(new_n42_), .O(z1));
  aoi21  g18(.a(new_n41_), .b(x00), .c(new_n43_), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(x01), .O(new_n48_));
  xor2a  g20(.a(x12), .b(x11), .O(new_n49_));
  nand4  g21(.a(new_n49_), .b(new_n41_), .c(x09), .d(new_n43_), .O(new_n50_));
  oai21  g22(.a(new_n50_), .b(x00), .c(new_n48_), .O(z2));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n43_), .c(x00), .O(new_n57_));
  ...
  nand2  g37(.a(new_n47_), .b(x04), .O(new_n66_));
  ...
  nand4  g44(.a(new_n72_), .b(x09), .c(new_n43_), .d(new_n29_), .O(new_n73_));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n43_), .c(x00), .O(new_n81_));
  ...
  nand4  g60(.a(new_n88_), .b(new_n41_), .c(x09), .d(new_n43_), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x00), .c(new_n84_), .O(z7));
  ...
  nand4  g70(.a(new_n98_), .b(x09), .c(new_n43_), .d(new_n29_), .O(new_n99_));
