...
module FAU ( 
  ...
  aoi21  g33(.a(new_n61_), .b(new_n32_), .c(x07), .O(new_n62_));
  ...
  oai22  g44(.a(new_n72_), .b(x07), .c(new_n47_), .d(new_n65_), .O(z5));
