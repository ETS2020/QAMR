...
module FAU ( 
  ...
  aoi21  g21(.a(new_n49_), .b(new_n32_), .c(x15), .O(new_n50_));
  ...
  aoi21  g29(.a(new_n57_), .b(new_n55_), .c(x15), .O(new_n58_));
  ...
  nor2   g33(.a(new_n44_), .b(x08), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(x11), .c(new_n31_), .O(new_n63_));
  nand4  g35(.a(new_n29_), .b(x14), .c(x13), .d(x12), .O(new_n64_));
  oai21  g36(.a(new_n64_), .b(new_n63_), .c(new_n61_), .O(z5));
  nand2  g37(.a(new_n39_), .b(x05), .O(new_n66_));
  nand4  g38(.a(new_n62_), .b(x16), .c(new_n29_), .d(new_n31_), .O(new_n67_));
