...
module FAU ( 
  ...
  nand2  g28(.a(x11), .b(new_n29_), .O(new_n57_));
  nand3  g29(.a(new_n30_), .b(x13), .c(x12), .O(new_n58_));
  oai21  g30(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  nand3  g31(.a(new_n59_), .b(x09), .c(new_n31_), .O(new_n60_));
  aoi21  g32(.a(x08), .b(x03), .c(new_n40_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n60_), .O(z4));
  nand2  g34(.a(new_n41_), .b(x04), .O(new_n63_));
  nand4  g35(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n64_));
  inv1   g36(.a(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n35_), .b(x14), .c(x13), .O(new_n66_));
  oai22  g38(.a(new_n66_), .b(new_n32_), .c(new_n65_), .d(new_n35_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n63_), .O(z5));
  nand2  g41(.a(new_n41_), .b(x05), .O(new_n70_));
  ...
  nand2  g49(.a(new_n41_), .b(x06), .O(new_n78_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n84_));
  ...
  nor2   g60(.a(new_n73_), .b(new_n35_), .O(new_n89_));
