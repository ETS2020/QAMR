...
module FAU ( 
  ...
  nand3  g24(.a(new_n52_), .b(new_n51_), .c(new_n30_), .O(z3));
  ...
  oai21  g33(.a(new_n61_), .b(x08), .c(new_n40_), .O(new_n62_));
  ...
  nand4  g39(.a(new_n67_), .b(new_n40_), .c(x09), .d(new_n31_), .O(new_n68_));
  nand2  g40(.a(x08), .b(x04), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n68_), .c(new_n63_), .O(z5));
  ...
  oai21  g50(.a(new_n78_), .b(x08), .c(new_n40_), .O(new_n79_));
  ...
  oai21  g61(.a(new_n89_), .b(x08), .c(new_n40_), .O(new_n90_));
  ...
  nand4  g69(.a(new_n97_), .b(new_n40_), .c(x09), .d(new_n31_), .O(new_n98_));
