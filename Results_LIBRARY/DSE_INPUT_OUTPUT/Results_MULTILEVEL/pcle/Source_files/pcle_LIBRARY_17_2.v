...
module FAU ( 
  ...
  aoi21  g37(.a(new_n65_), .b(new_n40_), .c(x07), .O(new_n66_));
  ...
  oai22  g45(.a(new_n73_), .b(new_n55_), .c(new_n72_), .d(new_n70_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(new_n39_), .c(x09), .d(new_n40_), .O(new_n75_));
  oai22  g47(.a(new_n75_), .b(x07), .c(new_n54_), .d(new_n69_), .O(z5));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n40_), .c(x07), .O(new_n83_));
  nand2  g55(.a(x08), .b(x05), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(x10), .c(new_n84_), .O(z6));
  nand2  g57(.a(new_n39_), .b(x07), .O(new_n86_));
  ...
  nand4  g61(.a(new_n33_), .b(new_n80_), .c(new_n34_), .d(x16), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n89_), .c(new_n30_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n40_), .c(x07), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(x10), .c(new_n87_), .O(z7));
  ...
  nand4  g68(.a(new_n96_), .b(new_n72_), .c(new_n35_), .d(x17), .O(new_n97_));
