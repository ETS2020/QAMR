...
module FAU ( 
  ...
  aoi21  g40(.a(new_n68_), .b(new_n30_), .c(new_n43_), .O(new_n69_));
  ...
  aoi21  g48(.a(new_n76_), .b(new_n30_), .c(new_n43_), .O(new_n77_));
  ...
  aoi21  g56(.a(new_n84_), .b(new_n30_), .c(new_n43_), .O(new_n85_));
  ...
  oai21  g64(.a(new_n92_), .b(new_n43_), .c(new_n31_), .O(new_n93_));
