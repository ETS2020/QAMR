...
module FAU ( 
  ...
  aoi21  g09(.a(new_n37_), .b(x16), .c(new_n29_), .O(z0));
  nor2   g10(.a(x16), .b(new_n29_), .O(new_n39_));
  ...
  nand2  g28(.a(new_n29_), .b(x13), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n48_), .c(new_n56_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n59_));
  aoi21  g31(.a(x08), .b(x03), .c(new_n39_), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n59_), .O(z4));
  nor2   g33(.a(new_n39_), .b(new_n30_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(x04), .O(new_n63_));
  inv1   g35(.a(x15), .O(new_n64_));
  aoi21  g36(.a(new_n55_), .b(x16), .c(new_n29_), .O(new_n65_));
  nand3  g37(.a(x16), .b(new_n64_), .c(x14), .O(new_n66_));
  oai22  g38(.a(new_n66_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n63_), .O(z5));
  nand4  g41(.a(new_n49_), .b(x15), .c(x14), .d(x13), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(x16), .c(new_n41_), .d(x09), .O(new_n71_));
  aoi21  g43(.a(x08), .b(x05), .c(new_n39_), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(x08), .c(new_n72_), .O(z6));
  nand2  g45(.a(new_n62_), .b(x06), .O(new_n74_));
  nand2  g46(.a(x15), .b(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n48_), .c(x17), .O(new_n76_));
  ...
  nand2  g52(.a(x17), .b(new_n29_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand4  g54(.a(new_n82_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n74_), .O(z7));
  nand2  g56(.a(new_n62_), .b(x07), .O(new_n85_));
  nand3  g57(.a(x17), .b(x15), .c(x13), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n48_), .c(x18), .O(new_n87_));
  inv1   g59(.a(x18), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(x17), .c(x15), .d(x14), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n55_), .c(new_n87_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(x16), .O(new_n91_));
  nand2  g63(.a(x18), .b(new_n29_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n85_), .O(z8));
endmodule
