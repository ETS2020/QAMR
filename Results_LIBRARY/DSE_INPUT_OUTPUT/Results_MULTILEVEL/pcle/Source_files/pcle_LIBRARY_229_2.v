...
module FAU ( 
  ...
  inv1   g26(.a(new_n39_), .O(new_n55_));
  ...
  oai21  g34(.a(new_n62_), .b(new_n50_), .c(new_n60_), .O(new_n63_));
  nand4  g35(.a(new_n63_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n64_));
  oai21  g36(.a(new_n45_), .b(new_n58_), .c(new_n64_), .O(z4));
  nand3  g37(.a(new_n51_), .b(x14), .c(x13), .O(new_n66_));
  ...
  nand3  g45(.a(x11), .b(x09), .c(new_n30_), .O(new_n74_));
  nand2  g46(.a(x15), .b(x14), .O(new_n75_));
  inv1   g47(.a(new_n75_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(x13), .c(x12), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n74_), .c(new_n31_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n38_), .O(new_n79_));
  nor3   g51(.a(new_n75_), .b(new_n50_), .c(new_n49_), .O(new_n80_));
  nor2   g52(.a(new_n80_), .b(new_n38_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n82_));
  nand2  g54(.a(x08), .b(x05), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n82_), .c(new_n79_), .O(z6));
  nand2  g56(.a(x17), .b(x09), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(x08), .c(new_n31_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n38_), .O(new_n87_));
  inv1   g59(.a(x17), .O(new_n88_));
  nand3  g60(.a(new_n76_), .b(new_n88_), .c(x16), .O(new_n89_));
  oai22  g61(.a(new_n89_), .b(new_n59_), .c(new_n80_), .d(new_n88_), .O(new_n90_));
  ...
  oai21  g66(.a(new_n94_), .b(x08), .c(new_n31_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n38_), .O(new_n96_));
  nand3  g68(.a(x17), .b(x15), .c(x14), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n59_), .c(x18), .O(new_n98_));
  nand4  g70(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n99_));
  oai21  g71(.a(new_n99_), .b(new_n66_), .c(new_n98_), .O(new_n100_));
