...
module FAU ( 
  ...
  nand4  g19(.a(new_n47_), .b(new_n39_), .c(x09), .d(new_n40_), .O(new_n48_));
  nand3  g20(.a(x10), .b(x08), .c(x01), .O(new_n49_));
  oai21  g21(.a(new_n48_), .b(x01), .c(new_n49_), .O(z2));
  inv1   g22(.a(x02), .O(new_n51_));
  oai21  g23(.a(new_n40_), .b(new_n51_), .c(x10), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(x01), .O(new_n53_));
  ...
  nand3  g31(.a(x08), .b(x02), .c(new_n29_), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(new_n59_), .c(new_n53_), .O(z3));
  nand2  g33(.a(new_n31_), .b(x14), .O(new_n62_));
  inv1   g34(.a(x14), .O(new_n63_));
  nand3  g35(.a(new_n56_), .b(new_n63_), .c(x13), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n62_), .c(new_n30_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n40_), .c(x01), .O(new_n66_));
  ...
  nand4  g43(.a(new_n56_), .b(new_n71_), .c(x14), .d(x13), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n70_), .c(new_n30_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n40_), .c(x01), .O(new_n74_));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n40_), .c(x01), .O(new_n83_));
  ...
  nand4  g59(.a(new_n33_), .b(new_n80_), .c(new_n34_), .d(x16), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n87_), .c(new_n30_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n40_), .c(x01), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(x10), .c(new_n91_), .O(z7));
  nand2  g64(.a(new_n39_), .b(x01), .O(new_n93_));
  nand3  g65(.a(new_n93_), .b(x08), .c(x07), .O(new_n94_));
  ...
  nand4  g70(.a(new_n98_), .b(new_n97_), .c(new_n35_), .d(x17), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n96_), .c(x10), .O(new_n100_));
  nand4  g72(.a(new_n100_), .b(x09), .c(new_n40_), .d(new_n29_), .O(new_n101_));
