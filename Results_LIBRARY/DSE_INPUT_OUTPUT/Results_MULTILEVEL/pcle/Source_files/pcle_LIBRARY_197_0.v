...
module FAU ( 
  ...
  aoi21  g11(.a(new_n39_), .b(new_n31_), .c(new_n30_), .O(new_n40_));
  nand2  g12(.a(new_n40_), .b(x00), .O(new_n41_));
  inv1   g13(.a(x11), .O(new_n42_));
  nand3  g14(.a(x13), .b(new_n42_), .c(new_n31_), .O(new_n43_));
  oai21  g15(.a(new_n43_), .b(new_n38_), .c(new_n41_), .O(z1));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  nand3  g17(.a(new_n45_), .b(x09), .c(new_n30_), .O(new_n46_));
  ...
  nand4  g24(.a(new_n52_), .b(x13), .c(new_n31_), .d(x09), .O(new_n53_));
  oai21  g25(.a(new_n53_), .b(x08), .c(new_n51_), .O(z3));
  nand2  g26(.a(new_n40_), .b(x03), .O(new_n55_));
  nand2  g27(.a(new_n52_), .b(x14), .O(new_n56_));
  inv1   g28(.a(x14), .O(new_n57_));
  nand3  g29(.a(new_n57_), .b(x12), .c(x11), .O(new_n58_));
  aoi21  g30(.a(new_n58_), .b(new_n56_), .c(new_n39_), .O(new_n59_));
  ...
  nand2  g34(.a(new_n52_), .b(x15), .O(new_n63_));
  ...
  aoi21  g40(.a(new_n68_), .b(new_n67_), .c(new_n39_), .O(new_n69_));
  ...
  inv1   g47(.a(new_n52_), .O(new_n76_));
  nand4  g48(.a(new_n76_), .b(new_n75_), .c(x15), .d(x14), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n74_), .c(new_n72_), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n30_), .c(new_n39_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(x10), .c(new_n80_), .O(z6));
  nand2  g53(.a(new_n40_), .b(x06), .O(new_n82_));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n52_), .c(x17), .O(new_n84_));
  nand3  g56(.a(x14), .b(x12), .c(x11), .O(new_n85_));
  ...
  nand4  g60(.a(new_n88_), .b(x13), .c(new_n31_), .d(x09), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x08), .c(new_n82_), .O(z7));
  nand2  g62(.a(new_n40_), .b(x07), .O(new_n91_));
  nand3  g63(.a(x17), .b(x16), .c(x15), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n85_), .c(x18), .O(new_n93_));
  nand4  g65(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n85_), .c(new_n93_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(x13), .c(new_n31_), .d(x09), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(x08), .c(new_n91_), .O(z8));
endmodule
