...
module FAU ( 
  ...
  nand4  g04(.a(new_n32_), .b(x09), .c(new_n31_), .d(x02), .O(new_n33_));
  ...
  oai22  g46(.a(new_n74_), .b(new_n51_), .c(new_n68_), .d(new_n67_), .O(z5));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n77_), .c(new_n59_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n31_), .c(new_n51_), .O(new_n82_));
  ...
  oai22  g63(.a(new_n91_), .b(new_n51_), .c(new_n68_), .d(new_n85_), .O(z7));
  ...
  aoi21  g68(.a(new_n96_), .b(new_n94_), .c(new_n59_), .O(new_n97_));
