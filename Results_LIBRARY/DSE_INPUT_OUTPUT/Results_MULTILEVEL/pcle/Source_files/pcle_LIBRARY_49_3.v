...
module FAU ( 
  ...
  nand4  g29(.a(new_n57_), .b(new_n30_), .c(x09), .d(new_n29_), .O(new_n58_));
  ...
  oai21  g41(.a(new_n34_), .b(new_n31_), .c(x16), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(x15), .c(x14), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n53_), .c(new_n70_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(x09), .c(new_n29_), .O(new_n74_));
  nand2  g46(.a(x08), .b(x05), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n74_), .c(x10), .O(z6));
  oai21  g48(.a(x10), .b(x06), .c(x08), .O(new_n77_));
  nand3  g49(.a(x16), .b(x15), .c(x14), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n53_), .c(x17), .O(new_n79_));
