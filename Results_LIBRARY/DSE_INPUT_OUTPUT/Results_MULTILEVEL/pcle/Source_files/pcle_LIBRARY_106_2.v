...
module FAU ( 
  ...
  aoi21  g25(.a(new_n53_), .b(new_n52_), .c(new_n40_), .O(z3));
  ...
  inv1   g35(.a(new_n40_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(x08), .c(x04), .O(new_n65_));
  nand4  g37(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(x18), .c(x15), .O(new_n67_));
  nand3  g39(.a(new_n29_), .b(x14), .c(x13), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n58_), .c(new_n67_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n65_), .O(z5));
  nand3  g43(.a(new_n34_), .b(new_n35_), .c(x14), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n32_), .c(x18), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(x15), .O(new_n74_));
  nand3  g46(.a(x15), .b(x14), .c(x13), .O(new_n75_));
  nor2   g47(.a(new_n75_), .b(new_n58_), .O(new_n76_));
  nor2   g48(.a(new_n76_), .b(new_n35_), .O(new_n77_));
  ...
  nand4  g52(.a(new_n34_), .b(new_n36_), .c(x16), .d(x14), .O(new_n81_));
  ...
  aoi21  g57(.a(new_n85_), .b(new_n57_), .c(new_n36_), .O(new_n86_));
  ...
  nand3  g61(.a(new_n64_), .b(x08), .c(x07), .O(new_n90_));
  nand4  g62(.a(new_n57_), .b(new_n37_), .c(x15), .d(x14), .O(new_n91_));
