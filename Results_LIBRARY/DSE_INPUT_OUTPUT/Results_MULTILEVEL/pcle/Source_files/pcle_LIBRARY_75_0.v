...
module FAU ( 
  ...
  nand2  g21(.a(x13), .b(new_n29_), .O(new_n50_));
  oai21  g22(.a(new_n49_), .b(new_n29_), .c(new_n50_), .O(new_n51_));
  nand4  g23(.a(new_n51_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n52_));
  ...
  oai21  g30(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  nand4  g31(.a(new_n59_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n54_), .O(z4));
  nand2  g33(.a(new_n43_), .b(x04), .O(new_n62_));
  nand2  g34(.a(new_n55_), .b(x15), .O(new_n63_));
  nand4  g35(.a(new_n32_), .b(x13), .c(x12), .d(x11), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(x14), .O(new_n66_));
  nand2  g38(.a(x15), .b(new_n31_), .O(new_n67_));
  ...
  nand2  g42(.a(new_n43_), .b(x05), .O(new_n71_));
  nand3  g43(.a(x15), .b(x14), .c(x13), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n57_), .c(x16), .O(new_n73_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n71_), .O(z6));
  inv1   g50(.a(x09), .O(new_n79_));
  ...
  aoi21  g56(.a(new_n84_), .b(new_n39_), .c(new_n79_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  oai21  g58(.a(new_n85_), .b(x10), .c(new_n86_), .O(z7));
  nand2  g59(.a(new_n43_), .b(x07), .O(new_n88_));
  ...
  nand3  g64(.a(new_n92_), .b(x16), .c(x15), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n91_), .c(new_n90_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n95_));
