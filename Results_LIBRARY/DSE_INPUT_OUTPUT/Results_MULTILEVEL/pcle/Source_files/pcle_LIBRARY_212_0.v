...
module FAU ( 
  ...
  oai21  g31(.a(x18), .b(x10), .c(x08), .O(new_n60_));
  ...
  oai21  g38(.a(new_n60_), .b(new_n59_), .c(new_n66_), .O(z4));
  inv1   g39(.a(x04), .O(new_n68_));
  nand2  g40(.a(x14), .b(x13), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(new_n51_), .c(x15), .O(new_n70_));
  ...
  nand4  g45(.a(new_n73_), .b(x18), .c(new_n31_), .d(x09), .O(new_n74_));
  oai22  g46(.a(new_n74_), .b(x08), .c(new_n60_), .d(new_n68_), .O(z5));
  nand3  g47(.a(x15), .b(x14), .c(x13), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n51_), .c(x16), .O(new_n77_));
  inv1   g49(.a(new_n61_), .O(new_n78_));
  nor2   g50(.a(x16), .b(new_n71_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(x14), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n77_), .c(new_n50_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n30_), .c(new_n29_), .O(new_n82_));
  ...
  nand4  g61(.a(new_n89_), .b(x18), .c(x09), .d(new_n30_), .O(new_n90_));
  ...
  nor2   g67(.a(new_n71_), .b(new_n63_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n78_), .c(x17), .d(x16), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(x18), .c(new_n31_), .d(x09), .O(new_n98_));
  oai22  g70(.a(new_n98_), .b(x08), .c(new_n60_), .d(new_n95_), .O(z8));
endmodule
