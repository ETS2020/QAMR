...
module FAU ( 
  ...
  nor2   g09(.a(x09), .b(x07), .O(new_n38_));
  ...
  aoi21  g58(.a(x08), .b(x06), .c(new_n38_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n86_), .O(z7));
  inv1   g60(.a(new_n38_), .O(new_n89_));
  inv1   g61(.a(x09), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(x07), .c(x08), .O(new_n91_));
  ...
  nand3  g69(.a(new_n97_), .b(new_n91_), .c(new_n89_), .O(z8));
endmodule
