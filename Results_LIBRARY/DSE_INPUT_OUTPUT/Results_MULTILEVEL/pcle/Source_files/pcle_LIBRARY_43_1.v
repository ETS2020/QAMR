...
module FAU ( 
  ...
  nand2  g10(.a(x18), .b(new_n38_), .O(new_n39_));
  ...
  aoi21  g28(.a(x08), .b(x02), .c(new_n46_), .O(new_n57_));
  ...
  aoi21  g36(.a(x08), .b(x03), .c(new_n46_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n64_), .O(z4));
  nand2  g38(.a(x14), .b(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n52_), .c(x15), .O(new_n68_));
  ...
  aoi21  g44(.a(x08), .b(x04), .c(new_n46_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n72_), .O(z5));
  nand3  g46(.a(new_n42_), .b(x11), .c(new_n31_), .O(new_n75_));
  nor2   g47(.a(new_n69_), .b(new_n61_), .O(new_n76_));
  ...
  aoi21  g53(.a(new_n81_), .b(new_n53_), .c(new_n38_), .O(new_n82_));
  ...
  aoi21  g59(.a(new_n81_), .b(new_n53_), .c(new_n87_), .O(new_n88_));
  ...
  nand3  g63(.a(new_n29_), .b(x17), .c(new_n38_), .O(new_n92_));
  ...
  nand3  g70(.a(new_n76_), .b(new_n29_), .c(x17), .O(new_n99_));
  oai21  g71(.a(new_n99_), .b(new_n59_), .c(new_n98_), .O(new_n100_));
  nand4  g72(.a(new_n100_), .b(x16), .c(new_n31_), .d(x09), .O(new_n101_));
  oai21  g73(.a(new_n101_), .b(x08), .c(new_n96_), .O(z8));
endmodule
