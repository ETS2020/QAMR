...
module FAU ( 
  ...
  aoi21  g35(.a(x08), .b(x03), .c(new_n54_), .O(new_n64_));
  ...
  aoi21  g45(.a(x08), .b(x04), .c(new_n54_), .O(new_n74_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n67_), .c(new_n66_), .d(new_n43_), .O(new_n94_));
