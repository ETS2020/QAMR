...
module FAU ( 
  ...
  nand2  g11(.a(new_n31_), .b(x07), .O(new_n40_));
  oai21  g12(.a(x10), .b(x07), .c(x08), .O(new_n41_));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n31_), .c(new_n46_), .O(new_n56_));
  ...
  nand4  g36(.a(new_n64_), .b(x09), .c(new_n31_), .d(x07), .O(new_n65_));
  ...
  nand4  g41(.a(new_n62_), .b(new_n69_), .c(x14), .d(x13), .O(new_n70_));
  ...
  oai22  g53(.a(new_n81_), .b(new_n46_), .c(new_n41_), .d(new_n75_), .O(z6));
  ...
  oai22  g61(.a(new_n89_), .b(new_n46_), .c(new_n41_), .d(new_n83_), .O(z7));
  oai21  g62(.a(new_n32_), .b(x07), .c(x08), .O(new_n91_));
  ...
  aoi21  g68(.a(new_n96_), .b(new_n93_), .c(new_n50_), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n46_), .c(new_n32_), .O(new_n98_));
