...
module FAU ( 
  ...
  aoi21  g13(.a(new_n41_), .b(new_n32_), .c(new_n39_), .O(new_n42_));
  oai22  g14(.a(new_n42_), .b(new_n40_), .c(new_n31_), .d(new_n39_), .O(z1));
  xor2a  g15(.a(x12), .b(x11), .O(new_n44_));
  nand3  g16(.a(new_n44_), .b(new_n32_), .c(new_n31_), .O(new_n45_));
  ...
  oai21  g22(.a(new_n40_), .b(x00), .c(x08), .O(new_n51_));
  ...
  nand4  g28(.a(new_n56_), .b(x09), .c(new_n31_), .d(x00), .O(new_n57_));
  ...
  nand4  g36(.a(new_n64_), .b(x09), .c(new_n31_), .d(x00), .O(new_n65_));
  ...
  aoi21  g42(.a(new_n70_), .b(new_n68_), .c(x10), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n31_), .c(new_n39_), .O(new_n72_));
  nand2  g44(.a(x08), .b(x04), .O(new_n73_));
  oai21  g45(.a(new_n72_), .b(new_n40_), .c(new_n73_), .O(z5));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n31_), .c(new_n39_), .O(new_n81_));
  nand2  g53(.a(x08), .b(x05), .O(new_n82_));
  oai21  g54(.a(new_n81_), .b(new_n40_), .c(new_n82_), .O(z6));
  ...
  aoi21  g59(.a(new_n87_), .b(new_n85_), .c(x10), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n31_), .c(new_n39_), .O(new_n89_));
  nand2  g61(.a(x08), .b(x06), .O(new_n90_));
  oai21  g62(.a(new_n89_), .b(new_n40_), .c(new_n90_), .O(z7));
  ...
  aoi21  g69(.a(new_n97_), .b(new_n31_), .c(new_n39_), .O(new_n98_));
  nand2  g70(.a(x08), .b(x07), .O(new_n99_));
  oai21  g71(.a(new_n98_), .b(new_n40_), .c(new_n99_), .O(z8));
endmodule
