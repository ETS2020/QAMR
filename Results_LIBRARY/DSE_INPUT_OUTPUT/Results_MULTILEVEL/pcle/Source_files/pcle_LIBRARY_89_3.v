...
module FAU ( 
  ...
  aoi21  g26(.a(x10), .b(x09), .c(new_n39_), .O(new_n55_));
  ...
  nand2  g39(.a(x15), .b(new_n33_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n63_), .O(z5));
  nand2  g43(.a(new_n55_), .b(x05), .O(new_n72_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n78_));
  ...
  aoi21  g56(.a(new_n84_), .b(new_n39_), .c(x10), .O(new_n85_));
