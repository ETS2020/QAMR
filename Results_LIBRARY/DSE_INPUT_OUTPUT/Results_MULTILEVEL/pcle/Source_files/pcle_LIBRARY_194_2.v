...
module FAU ( 
  ...
  nand2  g08(.a(x10), .b(x08), .O(new_n37_));
  inv1   g09(.a(new_n37_), .O(new_n38_));
  nand2  g10(.a(new_n38_), .b(x00), .O(new_n39_));
  inv1   g11(.a(x10), .O(new_n40_));
  inv1   g12(.a(x11), .O(new_n41_));
  nand4  g13(.a(new_n41_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n39_), .O(z1));
  oai21  g15(.a(new_n40_), .b(x01), .c(x08), .O(new_n44_));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  nand3  g17(.a(new_n45_), .b(new_n40_), .c(x09), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(new_n44_), .O(z2));
  oai21  g19(.a(new_n40_), .b(x02), .c(x08), .O(new_n48_));
  ...
  nand3  g25(.a(new_n53_), .b(new_n40_), .c(x09), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n48_), .O(z3));
  oai21  g27(.a(new_n40_), .b(x03), .c(x08), .O(new_n56_));
  ...
  nand3  g32(.a(new_n60_), .b(new_n40_), .c(x09), .O(new_n61_));
  ...
  nand4  g38(.a(new_n66_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n67_));
  nand2  g39(.a(new_n38_), .b(x04), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z5));
  oai21  g41(.a(new_n40_), .b(x05), .c(x08), .O(new_n70_));
  ...
  nand3  g47(.a(new_n75_), .b(new_n40_), .c(x09), .O(new_n76_));
  ...
  nand3  g64(.a(new_n92_), .b(new_n40_), .c(x09), .O(new_n93_));
