...
module FAU ( 
  ...
  nand2  g06(.a(x08), .b(x02), .O(new_n36_));
  nand2  g07(.a(new_n36_), .b(new_n31_), .O(z3));
  inv1   g08(.a(x03), .O(new_n38_));
  inv1   g09(.a(x09), .O(new_n39_));
  oai21  g10(.a(x10), .b(new_n39_), .c(x08), .O(new_n40_));
  nor2   g11(.a(new_n40_), .b(new_n38_), .O(z4));
  inv1   g12(.a(x04), .O(new_n42_));
  nor2   g13(.a(new_n40_), .b(new_n42_), .O(z5));
  nand2  g14(.a(x08), .b(x05), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(new_n31_), .O(z6));
  inv1   g16(.a(x06), .O(new_n46_));
  nor2   g17(.a(new_n40_), .b(new_n46_), .O(z7));
