...
module FAU ( 
  ...
  aoi21  g28(.a(new_n56_), .b(new_n31_), .c(new_n46_), .O(new_n57_));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n61_), .c(new_n51_), .O(new_n63_));
  ...
  oai22  g45(.a(new_n73_), .b(new_n46_), .c(new_n47_), .d(new_n67_), .O(z5));
  ...
  aoi21  g51(.a(new_n79_), .b(new_n76_), .c(new_n51_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n31_), .c(new_n46_), .O(new_n81_));
  ...
  nor2   g57(.a(new_n68_), .b(new_n30_), .O(new_n86_));
  nor2   g58(.a(x17), .b(new_n77_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n78_), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n85_), .c(new_n51_), .O(new_n89_));
  ...
  oai21  g65(.a(new_n93_), .b(new_n60_), .c(x18), .O(new_n94_));
  nor2   g66(.a(new_n77_), .b(new_n68_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n70_), .c(new_n29_), .d(x17), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand3  g69(.a(new_n97_), .b(new_n32_), .c(x09), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n31_), .c(new_n46_), .O(z8));
endmodule
