...
module FAU ( 
  ...
  nand4  g14(.a(new_n42_), .b(x09), .c(new_n31_), .d(x07), .O(new_n43_));
  ...
  oai21  g26(.a(new_n54_), .b(new_n39_), .c(new_n49_), .O(z3));
  ...
  nand4  g32(.a(new_n60_), .b(x09), .c(new_n31_), .d(x07), .O(new_n61_));
  ...
  oai21  g39(.a(new_n67_), .b(new_n64_), .c(new_n65_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(x14), .O(new_n69_));
  nand2  g41(.a(x15), .b(new_n30_), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n69_), .c(x10), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(x09), .c(new_n31_), .d(x07), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n63_), .O(z5));
  nand2  g45(.a(new_n40_), .b(x05), .O(new_n74_));
  nand3  g46(.a(x15), .b(x14), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n64_), .c(x16), .O(new_n76_));
  ...
  inv1   g56(.a(new_n57_), .O(new_n85_));
  ...
  oai21  g70(.a(new_n98_), .b(new_n39_), .c(x09), .O(new_n99_));
  oai21  g71(.a(new_n31_), .b(new_n39_), .c(new_n99_), .O(z8));
endmodule
