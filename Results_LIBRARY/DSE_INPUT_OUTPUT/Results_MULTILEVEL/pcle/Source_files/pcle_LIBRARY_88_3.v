...
module FAU ( 
  ...
  oai21  g36(.a(new_n64_), .b(new_n57_), .c(x15), .O(new_n65_));
  ...
  nor2   g53(.a(new_n66_), .b(new_n58_), .O(new_n82_));
  nor2   g54(.a(x17), .b(new_n75_), .O(new_n83_));
  ...
  nand4  g62(.a(x13), .b(x12), .c(x11), .d(new_n31_), .O(new_n91_));
  nand4  g63(.a(new_n82_), .b(new_n29_), .c(x17), .d(x16), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
  nand3  g65(.a(new_n93_), .b(x09), .c(new_n30_), .O(new_n94_));
  aoi21  g66(.a(x08), .b(x07), .c(new_n52_), .O(new_n95_));
