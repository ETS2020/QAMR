...
module FAU ( 
  ...
  oai21  g26(.a(new_n39_), .b(new_n48_), .c(new_n54_), .O(z3));
  ...
  aoi21  g33(.a(x08), .b(x03), .c(new_n45_), .O(new_n62_));
  ...
  nor2   g62(.a(new_n74_), .b(new_n65_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n67_), .c(new_n29_), .d(x17), .O(new_n92_));
