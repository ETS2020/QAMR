...
module FAU ( 
  ...
  nand2  g11(.a(new_n39_), .b(x17), .O(new_n40_));
  ...
  nand3  g18(.a(x17), .b(x12), .c(new_n38_), .O(new_n47_));
  oai21  g19(.a(x12), .b(new_n38_), .c(new_n47_), .O(new_n48_));
  ...
  aoi22  g26(.a(new_n44_), .b(new_n38_), .c(x08), .d(x02), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(new_n54_), .O(z3));
  nand4  g28(.a(x14), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(x17), .O(new_n58_));
  ...
  nand3  g38(.a(new_n66_), .b(new_n65_), .c(new_n59_), .O(z4));
  nand2  g39(.a(new_n45_), .b(x04), .O(new_n68_));
  nand2  g40(.a(new_n60_), .b(x15), .O(new_n69_));
  inv1   g41(.a(x15), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(x13), .c(x12), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n69_), .c(new_n62_), .O(new_n72_));
  nor2   g44(.a(new_n70_), .b(x14), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n72_), .c(x11), .O(new_n74_));
  nand3  g46(.a(x17), .b(x15), .c(new_n38_), .O(new_n75_));
  ...
  nand3  g57(.a(x17), .b(x16), .c(new_n38_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n79_), .O(z6));
  nand2  g61(.a(new_n45_), .b(x06), .O(new_n90_));
  nand3  g62(.a(x13), .b(x12), .c(x11), .O(new_n91_));
  nand3  g63(.a(x16), .b(x15), .c(x14), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n91_), .c(x17), .O(new_n93_));
  nand4  g65(.a(new_n44_), .b(x16), .c(x15), .d(x14), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n91_), .c(new_n93_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n90_), .O(z7));
  nand2  g69(.a(new_n45_), .b(x07), .O(new_n98_));
  nand2  g70(.a(x18), .b(new_n38_), .O(new_n99_));
  nand4  g71(.a(new_n29_), .b(x16), .c(x15), .d(x14), .O(new_n100_));
  oai21  g72(.a(new_n100_), .b(new_n91_), .c(new_n99_), .O(new_n101_));
  nand2  g73(.a(new_n101_), .b(x17), .O(new_n102_));
  ...
  nand3  g77(.a(new_n105_), .b(x18), .c(x11), .O(new_n106_));
  nand2  g78(.a(new_n106_), .b(new_n102_), .O(new_n107_));
  nand4  g79(.a(new_n107_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n108_));
  nand2  g80(.a(new_n108_), .b(new_n98_), .O(z8));
endmodule
