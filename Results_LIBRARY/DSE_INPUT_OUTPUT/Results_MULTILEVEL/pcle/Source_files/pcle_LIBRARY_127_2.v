...
module FAU ( 
  ...
  nor2   g18(.a(new_n40_), .b(new_n29_), .O(new_n47_));
  ...
  nand4  g24(.a(new_n52_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n53_));
  nand2  g25(.a(new_n47_), .b(x02), .O(new_n54_));
  ...
  nand4  g32(.a(new_n60_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n61_));
  nand2  g33(.a(new_n47_), .b(x03), .O(new_n62_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n78_));
  nand2  g50(.a(new_n47_), .b(x05), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(z6));
  oai21  g52(.a(new_n40_), .b(x06), .c(x08), .O(new_n81_));
  ...
  nand3  g57(.a(new_n85_), .b(new_n40_), .c(x09), .O(new_n86_));
  ...
  nor2   g62(.a(new_n75_), .b(new_n33_), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(new_n36_), .c(x17), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n90_), .c(new_n89_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n40_), .c(x09), .d(new_n29_), .O(new_n94_));
