...
module FAU ( 
  ...
  nand2  g36(.a(new_n39_), .b(x08), .O(new_n65_));
  ...
  oai21  g43(.a(new_n65_), .b(new_n64_), .c(new_n71_), .O(z5));
  ...
  aoi21  g50(.a(x08), .b(x05), .c(new_n52_), .O(new_n79_));
  ...
  oai21  g67(.a(new_n65_), .b(new_n89_), .c(new_n95_), .O(z8));
endmodule
