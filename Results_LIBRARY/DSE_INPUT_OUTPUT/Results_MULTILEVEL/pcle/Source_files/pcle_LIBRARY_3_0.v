...
module FAU ( 
  ...
  nand2  g37(.a(new_n44_), .b(x04), .O(new_n66_));
  ...
  nor2   g58(.a(new_n69_), .b(new_n60_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(x16), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n58_), .c(new_n85_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(x18), .c(new_n31_), .d(x09), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(x08), .c(new_n83_), .O(z7));
  nand2  g63(.a(new_n44_), .b(x07), .O(new_n92_));
  nand4  g64(.a(new_n87_), .b(new_n76_), .c(x17), .d(x16), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(x18), .c(new_n31_), .d(x09), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(x08), .c(new_n92_), .O(z8));
endmodule
