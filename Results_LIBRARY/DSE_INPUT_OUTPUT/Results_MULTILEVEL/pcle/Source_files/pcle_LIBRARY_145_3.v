...
module FAU ( 
  ...
  nand3  g14(.a(new_n38_), .b(x08), .c(x01), .O(new_n43_));
  ...
  inv1   g24(.a(new_n38_), .O(new_n53_));
  ...
  nor2   g35(.a(x15), .b(new_n47_), .O(new_n64_));
  aoi22  g36(.a(new_n64_), .b(new_n49_), .c(new_n57_), .d(x15), .O(new_n65_));
  nand2  g37(.a(x15), .b(new_n59_), .O(new_n66_));
  oai21  g38(.a(new_n65_), .b(new_n59_), .c(new_n66_), .O(new_n67_));
  ...
  aoi21  g48(.a(x08), .b(x05), .c(new_n53_), .O(new_n77_));
  ...
  aoi21  g56(.a(x08), .b(x06), .c(new_n53_), .O(new_n85_));
