...
module FAU ( 
  ...
  nand4  g24(.a(new_n30_), .b(x13), .c(new_n42_), .d(x09), .O(new_n53_));
  oai22  g25(.a(new_n53_), .b(x08), .c(new_n41_), .d(new_n52_), .O(z3));
  ...
  aoi21  g31(.a(new_n59_), .b(new_n57_), .c(new_n56_), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n29_), .c(new_n55_), .O(new_n61_));
  nand2  g33(.a(x08), .b(x03), .O(new_n62_));
  oai21  g34(.a(new_n61_), .b(x10), .c(new_n62_), .O(z4));
  nand2  g35(.a(new_n30_), .b(x15), .O(new_n64_));
  inv1   g36(.a(x15), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(x12), .c(x11), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n64_), .c(new_n58_), .O(new_n67_));
  nor2   g39(.a(new_n65_), .b(x14), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n67_), .c(x09), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(x08), .c(x13), .O(new_n70_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n33_), .c(x16), .d(x15), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n81_), .c(new_n56_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n29_), .c(new_n55_), .O(new_n86_));
  ...
  oai21  g62(.a(new_n90_), .b(new_n82_), .c(x18), .O(new_n91_));
  nand4  g63(.a(new_n34_), .b(x17), .c(x16), .d(x15), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n82_), .c(new_n91_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(x13), .c(new_n42_), .d(x09), .O(new_n94_));
  oai22  g66(.a(new_n94_), .b(x08), .c(new_n41_), .d(new_n89_), .O(z8));
endmodule
