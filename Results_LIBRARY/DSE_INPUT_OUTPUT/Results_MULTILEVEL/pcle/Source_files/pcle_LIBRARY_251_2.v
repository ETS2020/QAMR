...
module FAU ( 
  ...
  nand4  g10(.a(new_n38_), .b(new_n34_), .c(x09), .d(new_n32_), .O(new_n39_));
  ...
  oai21  g24(.a(new_n51_), .b(new_n35_), .c(new_n52_), .O(new_n53_));
  ...
  nand4  g43(.a(new_n71_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n64_), .O(z5));
  nand2  g45(.a(x16), .b(x09), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(x08), .c(new_n29_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n35_), .O(new_n76_));
  oai21  g48(.a(new_n36_), .b(new_n33_), .c(x16), .O(new_n77_));
  inv1   g49(.a(x16), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(x15), .c(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n57_), .c(new_n77_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n81_));
  nand2  g53(.a(x08), .b(x05), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(new_n76_), .O(z6));
  ...
  nand4  g61(.a(new_n89_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n90_));
  ...
  nor2   g66(.a(new_n78_), .b(new_n66_), .O(new_n95_));
  nor2   g67(.a(new_n59_), .b(new_n35_), .O(new_n96_));
