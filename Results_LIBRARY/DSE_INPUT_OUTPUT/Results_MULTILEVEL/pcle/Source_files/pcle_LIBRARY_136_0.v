...
module FAU ( 
  ...
  nand4  g27(.a(new_n55_), .b(x14), .c(new_n31_), .d(x09), .O(new_n56_));
  oai22  g28(.a(new_n56_), .b(x08), .c(new_n40_), .d(new_n54_), .O(z4));
  inv1   g29(.a(x04), .O(new_n58_));
  inv1   g30(.a(x14), .O(new_n59_));
  nand2  g31(.a(new_n55_), .b(x15), .O(new_n60_));
  inv1   g32(.a(x15), .O(new_n61_));
  nand2  g33(.a(x12), .b(x11), .O(new_n62_));
  inv1   g34(.a(new_n62_), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(new_n61_), .c(x13), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n60_), .c(new_n59_), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n66_));
  oai21  g38(.a(new_n40_), .b(new_n58_), .c(new_n66_), .O(z5));
  inv1   g39(.a(x09), .O(new_n68_));
  nand2  g40(.a(x15), .b(x13), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(new_n62_), .c(x16), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  nand4  g43(.a(new_n63_), .b(new_n71_), .c(x15), .d(x13), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n70_), .c(new_n68_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n30_), .c(new_n59_), .O(new_n74_));
  nand2  g46(.a(x08), .b(x05), .O(new_n75_));
  oai21  g47(.a(new_n74_), .b(x10), .c(new_n75_), .O(z6));
  nand3  g48(.a(x16), .b(x15), .c(x13), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n62_), .c(x17), .O(new_n78_));
  inv1   g50(.a(new_n55_), .O(new_n79_));
  nor2   g51(.a(x17), .b(new_n71_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n79_), .c(x15), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n78_), .c(new_n68_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n30_), .c(new_n59_), .O(new_n83_));
  ...
  aoi21  g61(.a(new_n89_), .b(new_n87_), .c(new_n68_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n30_), .c(new_n59_), .O(new_n91_));
