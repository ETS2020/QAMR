...
module FAU ( 
  ...
  nand4  g10(.a(new_n38_), .b(new_n35_), .c(new_n34_), .d(x16), .O(new_n39_));
  aoi21  g11(.a(new_n39_), .b(new_n29_), .c(new_n30_), .O(z0));
  nand2  g12(.a(x15), .b(x10), .O(new_n41_));
  nand3  g13(.a(new_n41_), .b(x08), .c(x00), .O(new_n42_));
  ...
  nand3  g20(.a(new_n48_), .b(new_n47_), .c(new_n41_), .O(z2));
  ...
  nand3  g31(.a(new_n32_), .b(new_n57_), .c(x13), .O(new_n60_));
  ...
  nand3  g36(.a(new_n41_), .b(x08), .c(x04), .O(new_n65_));
  nand2  g37(.a(new_n58_), .b(x15), .O(new_n66_));
  nand4  g38(.a(new_n30_), .b(x13), .c(x12), .d(x11), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(x14), .O(new_n69_));
  nand2  g41(.a(x15), .b(new_n57_), .O(new_n70_));
  ...
  nand3  g45(.a(x11), .b(x09), .c(new_n31_), .O(new_n74_));
  inv1   g46(.a(x16), .O(new_n75_));
  nand4  g47(.a(new_n75_), .b(x14), .c(x13), .d(x12), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n74_), .c(new_n29_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(x15), .O(new_n78_));
  nand3  g50(.a(x15), .b(x14), .c(x13), .O(new_n79_));
  inv1   g51(.a(new_n79_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n32_), .c(new_n75_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n82_));
  nand2  g54(.a(x08), .b(x05), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n82_), .c(new_n78_), .O(z6));
  nand3  g56(.a(new_n35_), .b(new_n36_), .c(x16), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n33_), .c(new_n29_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(x15), .O(new_n87_));
  nand3  g59(.a(x16), .b(x15), .c(x14), .O(new_n88_));
  inv1   g60(.a(new_n88_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n59_), .c(new_n36_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n91_));
  nand2  g63(.a(x08), .b(x06), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n91_), .c(new_n87_), .O(z7));
  nand4  g65(.a(new_n35_), .b(new_n37_), .c(x17), .d(x16), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n33_), .c(new_n29_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(x15), .O(new_n96_));
  nand4  g68(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n97_));
  inv1   g69(.a(new_n97_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n59_), .c(new_n37_), .O(new_n99_));
