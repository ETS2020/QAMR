...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    ...
    new_n92_, new_n93_, new_n95_, new_n96_, new_n97_;
  ...
  aoi21  g10(.a(new_n29_), .b(new_n31_), .c(new_n30_), .O(new_n39_));
  nand2  g11(.a(new_n39_), .b(x00), .O(new_n40_));
  inv1   g12(.a(x11), .O(new_n41_));
  nand3  g13(.a(x18), .b(new_n41_), .c(new_n31_), .O(new_n42_));
  oai21  g14(.a(new_n42_), .b(new_n38_), .c(new_n40_), .O(z1));
  ...
  nand2  g21(.a(new_n39_), .b(x02), .O(new_n50_));
  ...
  nand2  g29(.a(new_n39_), .b(x03), .O(new_n58_));
  ...
  inv1   g50(.a(new_n59_), .O(new_n79_));
  nor2   g51(.a(x16), .b(new_n68_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n79_), .c(x14), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n78_), .c(new_n76_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n30_), .c(new_n29_), .O(new_n83_));
  nand2  g55(.a(x08), .b(x05), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(x10), .c(new_n84_), .O(z6));
  nand2  g57(.a(new_n39_), .b(x06), .O(new_n86_));
  nand3  g58(.a(x16), .b(x15), .c(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n59_), .c(x17), .O(new_n88_));
  inv1   g60(.a(x17), .O(new_n89_));
  nor2   g61(.a(new_n68_), .b(new_n61_), .O(new_n90_));
  nand3  g62(.a(new_n90_), .b(new_n89_), .c(x16), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n59_), .c(new_n88_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(x18), .c(new_n31_), .d(x09), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(x08), .c(new_n86_), .O(z7));
  nand2  g66(.a(new_n39_), .b(x07), .O(new_n95_));
  nand4  g67(.a(new_n90_), .b(new_n79_), .c(x17), .d(x16), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(x18), .c(new_n31_), .d(x09), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(x08), .c(new_n95_), .O(z8));
endmodule
