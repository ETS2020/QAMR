...
module FAU ( 
  ...
  nand3  g25(.a(new_n39_), .b(x08), .c(x03), .O(new_n54_));
  ...
  oai21  g37(.a(new_n65_), .b(new_n57_), .c(new_n63_), .O(new_n66_));
  ...
  aoi21  g42(.a(x08), .b(x04), .c(new_n38_), .O(new_n71_));
  ...
  aoi21  g66(.a(x08), .b(x07), .c(new_n38_), .O(new_n95_));
