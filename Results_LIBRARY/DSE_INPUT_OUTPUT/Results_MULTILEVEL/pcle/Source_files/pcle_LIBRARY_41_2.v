...
module FAU ( 
  ...
  nand3  g25(.a(new_n53_), .b(new_n52_), .c(new_n40_), .O(z3));
  ...
  oai21  g33(.a(new_n41_), .b(new_n55_), .c(new_n61_), .O(z4));
  ...
  nor2   g40(.a(new_n68_), .b(new_n39_), .O(new_n69_));
  ...
  oai21  g67(.a(new_n95_), .b(new_n67_), .c(new_n94_), .O(new_n96_));
