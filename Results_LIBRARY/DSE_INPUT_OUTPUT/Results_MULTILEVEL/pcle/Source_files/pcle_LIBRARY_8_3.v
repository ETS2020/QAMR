...
module FAU ( 
  ...
  aoi21  g15(.a(new_n43_), .b(new_n42_), .c(z0), .O(z2));
  ...
  nand3  g31(.a(new_n32_), .b(x08), .c(x04), .O(new_n60_));
  nand2  g32(.a(x15), .b(new_n29_), .O(new_n61_));
  nand3  g33(.a(new_n30_), .b(x14), .c(x13), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n45_), .c(new_n61_), .O(new_n63_));
  nand4  g35(.a(new_n63_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n60_), .O(z5));
  nand2  g37(.a(x08), .b(x05), .O(new_n66_));
  nand3  g38(.a(new_n35_), .b(x16), .c(new_n40_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n66_), .c(z0), .O(z6));
  nand2  g40(.a(x08), .b(x06), .O(new_n69_));
  nand3  g41(.a(new_n35_), .b(x17), .c(new_n40_), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n69_), .c(new_n32_), .O(z7));
  nand2  g43(.a(x08), .b(x07), .O(new_n72_));
  nand3  g44(.a(new_n35_), .b(x18), .c(new_n40_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n72_), .c(new_n32_), .O(z8));
endmodule
