...
module FAU ( 
  ...
  nor2   g10(.a(new_n38_), .b(new_n31_), .O(new_n39_));
  ...
  oai21  g43(.a(new_n71_), .b(new_n60_), .c(new_n69_), .O(new_n72_));
  ...
  nand3  g55(.a(new_n40_), .b(x08), .c(x06), .O(new_n84_));
  nand3  g56(.a(x16), .b(x15), .c(x14), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n58_), .c(x17), .O(new_n86_));
  nand4  g58(.a(new_n38_), .b(x16), .c(x15), .d(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n58_), .c(new_n86_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n84_), .O(z7));
  nand2  g62(.a(new_n66_), .b(new_n44_), .O(new_n91_));
  nand4  g63(.a(new_n67_), .b(new_n29_), .c(x16), .d(x15), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n91_), .c(new_n31_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(x17), .O(new_n94_));
  nand4  g66(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n95_));
  inv1   g67(.a(new_n95_), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n59_), .c(new_n29_), .O(new_n97_));
