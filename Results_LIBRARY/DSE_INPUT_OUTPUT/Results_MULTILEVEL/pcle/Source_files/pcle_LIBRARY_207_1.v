...
module FAU ( 
  ...
  nand4  g21(.a(new_n49_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n50_));
  ...
  oai22  g35(.a(new_n63_), .b(new_n55_), .c(new_n62_), .d(new_n34_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(x09), .c(x10), .O(new_n65_));
  nand2  g37(.a(x08), .b(x04), .O(new_n66_));
  oai21  g38(.a(new_n65_), .b(x08), .c(new_n66_), .O(z5));
  nand3  g39(.a(x15), .b(x14), .c(x13), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n55_), .c(x16), .O(new_n69_));
