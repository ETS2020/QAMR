...
module FAU ( 
  ...
  nor2   g09(.a(x15), .b(x14), .O(new_n38_));
  ...
  nand3  g47(.a(new_n41_), .b(x16), .c(new_n31_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(x15), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n59_), .O(new_n78_));
  nand2  g50(.a(x15), .b(x13), .O(new_n79_));
  ...
  nand2  g58(.a(new_n57_), .b(x06), .O(new_n87_));
  nand2  g59(.a(x17), .b(new_n59_), .O(new_n88_));
  ...
  nand4  g64(.a(new_n51_), .b(x16), .c(x15), .d(x13), .O(new_n93_));
  nand3  g65(.a(new_n93_), .b(x17), .c(x14), .O(new_n94_));
  ...
  nand2  g69(.a(new_n57_), .b(x07), .O(new_n98_));
  nand2  g70(.a(x18), .b(new_n59_), .O(new_n99_));
  nand4  g71(.a(new_n29_), .b(x17), .c(x16), .d(x14), .O(new_n100_));
  oai21  g72(.a(new_n100_), .b(new_n60_), .c(new_n99_), .O(new_n101_));
  nand2  g73(.a(new_n101_), .b(x15), .O(new_n102_));
  nand4  g74(.a(new_n61_), .b(x17), .c(x16), .d(x15), .O(new_n103_));
  nand3  g75(.a(new_n103_), .b(x18), .c(x14), .O(new_n104_));
