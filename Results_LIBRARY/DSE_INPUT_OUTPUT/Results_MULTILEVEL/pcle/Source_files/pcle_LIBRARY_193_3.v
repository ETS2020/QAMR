...
module FAU ( 
  ...
  oai21  g37(.a(new_n65_), .b(new_n49_), .c(x15), .O(new_n66_));
  ...
  nor2   g55(.a(new_n67_), .b(new_n59_), .O(new_n84_));
  nor2   g56(.a(x17), .b(new_n76_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n57_), .c(new_n83_), .O(new_n87_));
  ...
  nand4  g64(.a(new_n84_), .b(new_n29_), .c(x17), .d(x16), .O(new_n93_));
