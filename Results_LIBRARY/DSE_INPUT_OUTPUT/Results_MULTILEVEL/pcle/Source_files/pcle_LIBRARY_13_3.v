...
module FAU ( 
  ...
  oai21  g24(.a(new_n44_), .b(new_n48_), .c(new_n52_), .O(z3));
  ...
  nand3  g33(.a(new_n61_), .b(new_n60_), .c(new_n38_), .O(z4));
  ...
  oai21  g41(.a(new_n44_), .b(new_n63_), .c(new_n69_), .O(z5));
  ...
  oai21  g49(.a(new_n44_), .b(new_n71_), .c(new_n77_), .O(z6));
  ...
  oai21  g57(.a(new_n44_), .b(new_n79_), .c(new_n85_), .O(z7));
