...
module FAU ( 
  ...
  nor2   g09(.a(x18), .b(x16), .O(new_n38_));
  ...
  aoi21  g20(.a(new_n48_), .b(new_n47_), .c(new_n38_), .O(z2));
  ...
  aoi21  g35(.a(x08), .b(x03), .c(new_n38_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n63_), .O(z4));
  inv1   g37(.a(x15), .O(new_n66_));
  nand3  g38(.a(new_n52_), .b(x14), .c(x13), .O(new_n67_));
  ...
  aoi21  g43(.a(x08), .b(x04), .c(new_n38_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(z5));
  inv1   g45(.a(x16), .O(new_n74_));
  nand3  g46(.a(new_n42_), .b(x11), .c(new_n31_), .O(new_n75_));
  nor2   g47(.a(new_n66_), .b(new_n60_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(x13), .c(x12), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n75_), .c(x18), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n74_), .O(new_n79_));
  nand3  g51(.a(x15), .b(x14), .c(x13), .O(new_n80_));
  inv1   g52(.a(new_n80_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n52_), .c(new_n74_), .O(new_n82_));
  ...
  nand3  g57(.a(new_n39_), .b(x08), .c(x06), .O(new_n86_));
  inv1   g58(.a(x17), .O(new_n87_));
  aoi21  g59(.a(new_n81_), .b(new_n52_), .c(new_n87_), .O(new_n88_));
  nand3  g60(.a(new_n87_), .b(x15), .c(x14), .O(new_n89_));
  nor2   g61(.a(new_n89_), .b(new_n58_), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n88_), .c(x16), .O(new_n91_));
  nand3  g63(.a(x18), .b(x17), .c(new_n74_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n86_), .O(z7));
  nand3  g67(.a(new_n39_), .b(x08), .c(x07), .O(new_n96_));
  nand3  g68(.a(new_n76_), .b(x17), .c(x16), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n58_), .c(x18), .O(new_n98_));
  nor2   g70(.a(new_n74_), .b(new_n66_), .O(new_n99_));
  nor2   g71(.a(x18), .b(new_n87_), .O(new_n100_));
  nand3  g72(.a(new_n100_), .b(new_n99_), .c(new_n68_), .O(new_n101_));
