...
module FAU ( 
  ...
  nand3  g11(.a(new_n29_), .b(x08), .c(x00), .O(new_n40_));
  ...
  aoi21  g50(.a(x08), .b(x05), .c(new_n53_), .O(new_n79_));
  ...
  nand4  g62(.a(new_n35_), .b(x17), .c(x16), .d(x15), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n90_), .c(new_n89_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n93_));
  aoi21  g65(.a(x08), .b(x07), .c(new_n53_), .O(new_n94_));
