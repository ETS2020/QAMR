...
module FAU ( 
  ...
  oai21  g37(.a(new_n65_), .b(new_n38_), .c(new_n40_), .O(new_n66_));
  oai21  g38(.a(new_n39_), .b(new_n38_), .c(new_n66_), .O(z4));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n39_), .c(new_n38_), .O(new_n73_));
  ...
  oai21  g54(.a(new_n82_), .b(new_n38_), .c(new_n76_), .O(z6));
  ...
  nor2   g67(.a(new_n79_), .b(new_n70_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n95_), .c(new_n34_), .d(x17), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n94_), .c(x10), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(x09), .c(new_n39_), .d(x03), .O(new_n99_));
