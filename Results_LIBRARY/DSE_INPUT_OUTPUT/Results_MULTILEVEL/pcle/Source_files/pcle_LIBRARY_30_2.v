...
module FAU ( 
  ...
  oai21  g47(.a(new_n38_), .b(new_n33_), .c(x16), .O(new_n76_));
  nand3  g48(.a(new_n35_), .b(x15), .c(x14), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n58_), .c(new_n76_), .O(new_n78_));
  ...
  nand2  g59(.a(new_n42_), .b(x07), .O(new_n88_));
  ...
  nor2   g63(.a(new_n35_), .b(new_n67_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n37_), .c(x17), .O(new_n93_));
