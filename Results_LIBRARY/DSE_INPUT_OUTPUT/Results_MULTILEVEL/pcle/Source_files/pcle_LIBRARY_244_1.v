...
module FAU ( 
  ...
  nor3   g08(.a(x16), .b(x11), .c(x10), .O(new_n37_));
  ...
  nand2  g18(.a(new_n33_), .b(x02), .O(new_n47_));
  ...
  nand4  g40(.a(new_n68_), .b(new_n40_), .c(new_n29_), .d(x09), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(x08), .c(new_n63_), .O(z5));
  nand3  g42(.a(x11), .b(x09), .c(new_n32_), .O(new_n71_));
  nand4  g43(.a(x15), .b(x14), .c(x13), .d(x12), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n71_), .c(new_n40_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n29_), .O(new_n74_));
  nand2  g46(.a(x08), .b(x05), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n74_), .O(z6));
  nand2  g48(.a(new_n33_), .b(x06), .O(new_n77_));
  nand4  g49(.a(new_n36_), .b(x17), .c(new_n40_), .d(new_n29_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n77_), .O(z7));
  nand2  g51(.a(new_n33_), .b(x07), .O(new_n80_));
  nand4  g52(.a(new_n36_), .b(x18), .c(new_n40_), .d(new_n29_), .O(new_n81_));
