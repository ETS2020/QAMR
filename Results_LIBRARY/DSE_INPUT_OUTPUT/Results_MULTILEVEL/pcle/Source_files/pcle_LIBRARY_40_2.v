...
module FAU ( 
  ...
  oai21  g10(.a(x11), .b(new_n31_), .c(x08), .O(new_n39_));
  ...
  oai21  g17(.a(new_n39_), .b(new_n43_), .c(new_n45_), .O(z2));
  ...
  aoi22  g23(.a(new_n40_), .b(x10), .c(x08), .d(x02), .O(new_n52_));
  ...
  nand2  g34(.a(x15), .b(x09), .O(new_n63_));
  oai21  g35(.a(new_n63_), .b(x08), .c(new_n31_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n40_), .O(new_n65_));
  ...
  oai21  g52(.a(new_n39_), .b(new_n74_), .c(new_n80_), .O(z6));
  ...
  nand2  g56(.a(x13), .b(x12), .O(new_n85_));
  ...
  nand3  g64(.a(new_n92_), .b(new_n91_), .c(new_n84_), .O(z7));
  inv1   g65(.a(x07), .O(new_n94_));
  nand4  g66(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n55_), .c(x18), .O(new_n96_));
  ...
  oai21  g72(.a(new_n39_), .b(new_n94_), .c(new_n100_), .O(z8));
endmodule
