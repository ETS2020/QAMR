...
module FAU ( 
  ...
  nor2   g23(.a(new_n31_), .b(new_n30_), .O(new_n52_));
  ...
  nor2   g34(.a(x15), .b(new_n46_), .O(new_n63_));
  aoi22  g35(.a(new_n63_), .b(new_n48_), .c(new_n56_), .d(x15), .O(new_n64_));
  nand2  g36(.a(x15), .b(new_n55_), .O(new_n65_));
  oai21  g37(.a(new_n64_), .b(new_n55_), .c(new_n65_), .O(new_n66_));
  ...
  nor2   g50(.a(new_n72_), .b(new_n78_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n57_), .c(x14), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(x17), .O(new_n81_));
  nor2   g53(.a(new_n78_), .b(new_n55_), .O(new_n82_));
  nor2   g54(.a(x17), .b(new_n72_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n82_), .c(new_n57_), .O(new_n84_));
  ...
  nand3  g61(.a(new_n82_), .b(x17), .c(x16), .O(new_n90_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n79_), .c(new_n29_), .d(x17), .O(new_n94_));
