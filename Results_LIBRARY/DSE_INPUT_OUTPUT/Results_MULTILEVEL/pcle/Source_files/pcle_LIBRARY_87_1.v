...
module FAU ( 
  ...
  nor2   g09(.a(new_n31_), .b(x09), .O(new_n38_));
  ...
  nor2   g25(.a(new_n38_), .b(new_n30_), .O(new_n54_));
  ...
  nand2  g34(.a(new_n62_), .b(new_n55_), .O(z4));
  nand2  g35(.a(new_n54_), .b(x04), .O(new_n64_));
  nand2  g36(.a(new_n56_), .b(x15), .O(new_n65_));
  ...
  oai21  g46(.a(new_n74_), .b(new_n58_), .c(x16), .O(new_n75_));
  ...
  aoi21  g51(.a(x08), .b(x05), .c(new_n38_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n79_), .O(z6));
  nand2  g53(.a(new_n54_), .b(x06), .O(new_n82_));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n56_), .c(x17), .O(new_n84_));
  ...
  aoi21  g67(.a(x08), .b(x07), .c(new_n38_), .O(new_n96_));
