...
module FAU ( 
  ...
  nand3  g13(.a(x13), .b(new_n41_), .c(new_n31_), .O(new_n42_));
  oai22  g14(.a(new_n42_), .b(new_n39_), .c(new_n40_), .d(new_n38_), .O(z1));
  xor2a  g15(.a(x12), .b(x11), .O(new_n44_));
  nand4  g16(.a(new_n44_), .b(x13), .c(x09), .d(new_n30_), .O(new_n45_));
  ...
  nand4  g23(.a(new_n51_), .b(x13), .c(new_n31_), .d(x09), .O(new_n52_));
  oai22  g24(.a(new_n52_), .b(x08), .c(new_n40_), .d(new_n50_), .O(z3));
  ...
  aoi21  g31(.a(new_n59_), .b(new_n30_), .c(new_n54_), .O(new_n60_));
  nand2  g32(.a(x08), .b(x03), .O(new_n61_));
  oai21  g33(.a(new_n60_), .b(x10), .c(new_n61_), .O(z4));
  nand2  g34(.a(new_n51_), .b(x15), .O(new_n63_));
  ...
  oai21  g53(.a(new_n81_), .b(new_n51_), .c(x17), .O(new_n82_));
  nand3  g54(.a(x14), .b(x12), .c(x11), .O(new_n83_));
  inv1   g55(.a(new_n83_), .O(new_n84_));
  nor2   g56(.a(x17), .b(new_n76_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n84_), .c(x15), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n82_), .c(new_n55_), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n30_), .c(new_n54_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  oai21  g61(.a(new_n88_), .b(x10), .c(new_n89_), .O(z7));
  nand3  g62(.a(x17), .b(x16), .c(x15), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n83_), .c(x18), .O(new_n92_));
  nor2   g64(.a(new_n76_), .b(new_n64_), .O(new_n93_));
  nand4  g65(.a(new_n84_), .b(new_n93_), .c(new_n29_), .d(x17), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n92_), .c(new_n55_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n30_), .c(new_n54_), .O(new_n96_));
