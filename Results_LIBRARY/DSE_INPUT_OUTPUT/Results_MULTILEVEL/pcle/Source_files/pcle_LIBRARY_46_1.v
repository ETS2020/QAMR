...
module FAU ( 
  ...
  nor2   g09(.a(new_n29_), .b(x09), .O(new_n38_));
  nand2  g10(.a(x08), .b(x00), .O(new_n39_));
  inv1   g11(.a(x08), .O(new_n40_));
  inv1   g12(.a(x10), .O(new_n41_));
  inv1   g13(.a(x11), .O(new_n42_));
  nand4  g14(.a(new_n42_), .b(new_n41_), .c(x09), .d(new_n40_), .O(new_n43_));
  nand2  g15(.a(new_n43_), .b(new_n39_), .O(new_n44_));
  or2    g16(.a(new_n44_), .b(new_n38_), .O(z1));
  xor2a  g17(.a(x12), .b(x11), .O(new_n46_));
  nand4  g18(.a(new_n46_), .b(new_n41_), .c(x09), .d(new_n40_), .O(new_n47_));
  ...
  nand4  g24(.a(new_n52_), .b(new_n41_), .c(x09), .d(new_n40_), .O(new_n53_));
  ...
  nand4  g32(.a(new_n60_), .b(new_n41_), .c(x09), .d(new_n40_), .O(new_n61_));
  aoi21  g33(.a(x08), .b(x03), .c(new_n38_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n61_), .O(z4));
  nor2   g35(.a(new_n38_), .b(new_n40_), .O(new_n64_));
  ...
  oai22  g41(.a(new_n69_), .b(new_n31_), .c(new_n68_), .d(new_n66_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n41_), .c(x09), .d(new_n40_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n65_), .O(z5));
  nand2  g44(.a(new_n64_), .b(x05), .O(new_n73_));
  nand3  g45(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n31_), .c(x16), .O(new_n75_));
  ...
  nand4  g50(.a(new_n78_), .b(new_n41_), .c(x09), .d(new_n40_), .O(new_n79_));
  ...
  nand4  g54(.a(x13), .b(x12), .c(x11), .d(x09), .O(new_n83_));
  nand4  g55(.a(new_n29_), .b(x16), .c(x15), .d(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n41_), .c(new_n40_), .O(new_n86_));
  aoi21  g58(.a(x08), .b(x06), .c(new_n38_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n86_), .O(z7));
  nand2  g60(.a(new_n64_), .b(x07), .O(new_n89_));
  ...
  nor2   g64(.a(x18), .b(new_n29_), .O(new_n93_));
  nand3  g65(.a(new_n93_), .b(new_n92_), .c(new_n68_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n91_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n41_), .c(x09), .d(new_n40_), .O(new_n96_));
