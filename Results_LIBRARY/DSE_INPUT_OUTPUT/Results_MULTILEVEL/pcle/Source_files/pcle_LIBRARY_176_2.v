...
module FAU ( 
  ...
  nand2  g37(.a(new_n42_), .b(x04), .O(new_n66_));
  nand2  g38(.a(new_n58_), .b(x15), .O(new_n67_));
  ...
  nand2  g43(.a(x15), .b(new_n57_), .O(new_n72_));
  ...
  nor2   g66(.a(new_n57_), .b(new_n51_), .O(new_n95_));
  nor2   g67(.a(x18), .b(new_n86_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n36_), .O(new_n97_));
