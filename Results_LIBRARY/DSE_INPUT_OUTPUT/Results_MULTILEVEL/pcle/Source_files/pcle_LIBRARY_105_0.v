...
module FAU ( 
  ...
  nand4  g32(.a(new_n60_), .b(new_n45_), .c(x09), .d(new_n37_), .O(new_n61_));
  ...
  oai22  g37(.a(new_n65_), .b(new_n58_), .c(new_n64_), .d(new_n32_), .O(new_n66_));
  ...
  oai21  g43(.a(new_n71_), .b(new_n58_), .c(x16), .O(new_n72_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n45_), .c(x09), .d(new_n37_), .O(new_n76_));
  ...
  nor2   g59(.a(new_n73_), .b(new_n32_), .O(new_n88_));
  ...
  oai21  g63(.a(new_n91_), .b(new_n38_), .c(new_n45_), .O(new_n92_));
