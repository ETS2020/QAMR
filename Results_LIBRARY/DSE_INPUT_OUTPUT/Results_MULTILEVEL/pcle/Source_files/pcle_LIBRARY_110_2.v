...
module FAU ( 
  ...
  nand2  g45(.a(x15), .b(new_n57_), .O(new_n74_));
  ...
  nand2  g53(.a(new_n59_), .b(x11), .O(new_n82_));
  ...
  oai21  g63(.a(new_n91_), .b(new_n58_), .c(x17), .O(new_n92_));
  inv1   g64(.a(x17), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(x16), .c(x15), .d(x14), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n82_), .c(new_n92_), .O(new_n95_));
  ...
  nand2  g72(.a(new_n100_), .b(new_n41_), .O(new_n101_));
  nand3  g73(.a(x14), .b(x13), .c(x12), .O(new_n102_));
