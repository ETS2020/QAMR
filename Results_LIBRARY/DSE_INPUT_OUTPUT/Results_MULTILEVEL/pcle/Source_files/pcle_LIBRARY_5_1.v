...
module FAU ( 
  ...
  oai21  g21(.a(new_n34_), .b(new_n48_), .c(new_n49_), .O(new_n50_));
  ...
  nand3  g25(.a(new_n31_), .b(x08), .c(x03), .O(new_n54_));
  ...
  oai21  g43(.a(new_n36_), .b(new_n33_), .c(x16), .O(new_n72_));
  ...
  nor2   g61(.a(new_n57_), .b(new_n48_), .O(new_n90_));
  nor2   g62(.a(x18), .b(new_n81_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n34_), .O(new_n92_));
