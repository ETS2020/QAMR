...
module FAU ( 
  ...
  aoi22  g16(.a(x13), .b(x10), .c(x08), .d(x01), .O(new_n45_));
  ...
  nand2  g25(.a(new_n38_), .b(x03), .O(new_n54_));
  ...
  oai21  g36(.a(new_n57_), .b(new_n63_), .c(new_n64_), .O(new_n65_));
  ...
  nand3  g42(.a(x11), .b(x09), .c(new_n30_), .O(new_n71_));
  inv1   g43(.a(x16), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(x15), .c(x14), .d(x12), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n71_), .c(new_n31_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(x13), .O(new_n75_));
  nor2   g47(.a(new_n63_), .b(new_n55_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(x13), .O(new_n77_));
  inv1   g49(.a(new_n77_), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n49_), .c(new_n72_), .O(new_n79_));
  ...
  nand2  g54(.a(new_n38_), .b(x06), .O(new_n83_));
  nor2   g55(.a(new_n72_), .b(new_n63_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n57_), .c(x14), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(x17), .O(new_n86_));
  nor2   g58(.a(x17), .b(new_n72_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n76_), .c(new_n57_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n83_), .O(z7));
  nand2  g63(.a(new_n38_), .b(x07), .O(new_n92_));
  nand4  g64(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n56_), .c(x18), .O(new_n94_));
  nand3  g66(.a(new_n49_), .b(x14), .c(x13), .O(new_n95_));
  nand3  g67(.a(new_n84_), .b(new_n29_), .c(x17), .O(new_n96_));
