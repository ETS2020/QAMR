...
module FAU ( 
  ...
  oai21  g18(.a(x17), .b(x10), .c(x08), .O(new_n47_));
  xor2a  g19(.a(x12), .b(x11), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(x17), .c(new_n39_), .d(x09), .O(new_n49_));
  oai22  g21(.a(new_n49_), .b(x08), .c(new_n47_), .d(new_n46_), .O(z2));
  inv1   g22(.a(x17), .O(new_n51_));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n29_), .c(new_n51_), .O(new_n57_));
  ...
  aoi21  g36(.a(new_n64_), .b(new_n62_), .c(new_n51_), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n66_));
  oai21  g38(.a(new_n47_), .b(new_n60_), .c(new_n66_), .O(z4));
  inv1   g39(.a(x04), .O(new_n68_));
  oai21  g40(.a(new_n35_), .b(new_n30_), .c(x15), .O(new_n69_));
  nand3  g41(.a(new_n32_), .b(x14), .c(x13), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n30_), .c(new_n69_), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(x17), .c(new_n39_), .d(x09), .O(new_n72_));
  oai22  g44(.a(new_n72_), .b(x08), .c(new_n47_), .d(new_n68_), .O(z5));
  nand3  g45(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n30_), .c(x16), .O(new_n75_));
  inv1   g47(.a(new_n61_), .O(new_n76_));
  nand4  g48(.a(new_n76_), .b(new_n33_), .c(x15), .d(x14), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n75_), .c(new_n52_), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n29_), .c(new_n51_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(x10), .c(new_n80_), .O(z6));
  nand3  g53(.a(x16), .b(x15), .c(x14), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n61_), .c(x09), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(x08), .c(x17), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n39_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n85_), .O(z7));
  oai21  g59(.a(new_n82_), .b(new_n61_), .c(x18), .O(new_n88_));
  and2   g60(.a(x15), .b(x14), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n76_), .c(new_n34_), .d(x16), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(new_n52_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n29_), .c(new_n51_), .O(new_n92_));
