...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n32_, new_n34_, new_n36_, new_n38_, new_n39_,
  ...
  oai21  g11(.a(x10), .b(new_n39_), .c(x08), .O(new_n40_));
  nor2   g12(.a(new_n40_), .b(new_n38_), .O(z4));
  inv1   g13(.a(x04), .O(new_n42_));
  nor2   g14(.a(new_n40_), .b(new_n42_), .O(z5));
  inv1   g15(.a(x05), .O(new_n44_));
  nor2   g16(.a(new_n40_), .b(new_n44_), .O(z6));
