...
module FAU ( 
  ...
  nand3  g32(.a(new_n54_), .b(new_n36_), .c(x13), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n60_), .c(x08), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(x10), .c(x09), .O(new_n63_));
  ...
  oai22  g41(.a(new_n69_), .b(new_n53_), .c(new_n68_), .d(new_n37_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n30_), .c(x09), .d(new_n43_), .O(new_n71_));
