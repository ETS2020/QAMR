...
module FAU ( 
  ...
  nor2   g20(.a(new_n40_), .b(new_n42_), .O(new_n49_));
  inv1   g21(.a(new_n49_), .O(new_n50_));
  nand3  g22(.a(new_n50_), .b(x13), .c(new_n31_), .O(new_n51_));
  ...
  aoi22  g27(.a(x12), .b(x10), .c(x08), .d(x02), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n55_), .O(z3));
  inv1   g29(.a(x14), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(x13), .c(x11), .O(new_n59_));
  oai21  g31(.a(new_n59_), .b(new_n39_), .c(new_n31_), .O(new_n60_));
  ...
  oai22  g44(.a(new_n72_), .b(new_n50_), .c(new_n71_), .d(new_n69_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n74_));
  oai21  g46(.a(new_n41_), .b(new_n68_), .c(new_n74_), .O(z5));
  ...
  nor2   g52(.a(new_n69_), .b(new_n58_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(x13), .O(new_n82_));
  inv1   g54(.a(new_n82_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n49_), .c(new_n77_), .O(new_n84_));
  ...
  aoi21  g67(.a(new_n95_), .b(new_n63_), .c(new_n89_), .O(new_n96_));
  ...
  oai21  g73(.a(new_n101_), .b(new_n62_), .c(x18), .O(new_n102_));
