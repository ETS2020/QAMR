...
module FAU ( 
  ...
  nand2  g13(.a(new_n40_), .b(new_n31_), .O(new_n42_));
  oai22  g14(.a(new_n42_), .b(new_n39_), .c(new_n41_), .d(new_n38_), .O(z1));
  inv1   g15(.a(x01), .O(new_n44_));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  nand4  g17(.a(new_n45_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n46_));
  oai21  g18(.a(new_n41_), .b(new_n44_), .c(new_n46_), .O(z2));
  ...
  oai21  g54(.a(new_n41_), .b(new_n75_), .c(new_n82_), .O(z6));
  nand4  g55(.a(x13), .b(x12), .c(x09), .d(new_n30_), .O(new_n84_));
  inv1   g56(.a(x17), .O(new_n85_));
  nor2   g57(.a(new_n65_), .b(new_n54_), .O(new_n86_));
