...
module FAU ( 
  ...
  nand4  g19(.a(new_n47_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n48_));
  ...
  nand4  g25(.a(new_n53_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n54_));
  ...
  oai22  g32(.a(new_n60_), .b(new_n34_), .c(new_n59_), .d(new_n57_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n62_));
  aoi21  g34(.a(x08), .b(x03), .c(new_n30_), .O(new_n63_));
  ...
  nand4  g42(.a(new_n70_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n71_));
  ...
  aoi21  g67(.a(new_n95_), .b(new_n59_), .c(new_n88_), .O(new_n96_));
