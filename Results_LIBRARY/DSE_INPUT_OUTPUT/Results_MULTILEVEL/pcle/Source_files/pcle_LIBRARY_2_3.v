...
module FAU ( 
  ...
  nand2  g19(.a(new_n38_), .b(x02), .O(new_n48_));
  ...
  oai21  g49(.a(new_n76_), .b(new_n43_), .c(new_n77_), .O(z6));
  nand2  g50(.a(new_n38_), .b(x06), .O(new_n79_));
  ...
  nand2  g58(.a(new_n38_), .b(x07), .O(new_n87_));
