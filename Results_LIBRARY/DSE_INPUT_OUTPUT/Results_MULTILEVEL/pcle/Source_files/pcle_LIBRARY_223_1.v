...
module FAU ( 
  ...
  nand2  g18(.a(x13), .b(new_n31_), .O(new_n47_));
  oai21  g19(.a(new_n46_), .b(new_n31_), .c(new_n47_), .O(new_n48_));
  ...
  nand2  g27(.a(new_n33_), .b(x13), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(new_n55_), .c(new_n54_), .O(new_n57_));
  nand4  g29(.a(new_n57_), .b(new_n29_), .c(x09), .d(new_n52_), .O(new_n58_));
  ...
  nand4  g38(.a(new_n66_), .b(new_n29_), .c(x09), .d(new_n52_), .O(new_n67_));
  ...
  nand4  g46(.a(new_n74_), .b(new_n29_), .c(x09), .d(new_n52_), .O(new_n75_));
  ...
  aoi21  g64(.a(new_n92_), .b(new_n87_), .c(new_n30_), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(x10), .c(new_n52_), .O(new_n94_));
