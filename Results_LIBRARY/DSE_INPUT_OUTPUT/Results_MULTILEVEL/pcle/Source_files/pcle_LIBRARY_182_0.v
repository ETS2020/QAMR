...
module FAU ( 
  ...
  nand4  g06(.a(new_n34_), .b(new_n30_), .c(x11), .d(new_n29_), .O(new_n35_));
  ...
  aoi21  g14(.a(new_n37_), .b(new_n42_), .c(new_n29_), .O(new_n43_));
  nand2  g15(.a(new_n43_), .b(x01), .O(new_n44_));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  nand4  g17(.a(new_n45_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n46_));
  ...
  oai21  g24(.a(new_n52_), .b(new_n42_), .c(new_n37_), .O(new_n53_));
  ...
  nand4  g29(.a(new_n31_), .b(x13), .c(x12), .d(x11), .O(new_n58_));
  aoi21  g30(.a(new_n58_), .b(new_n57_), .c(x08), .O(new_n59_));
  oai21  g31(.a(new_n59_), .b(new_n42_), .c(new_n37_), .O(new_n60_));
  ...
  nand3  g36(.a(new_n32_), .b(x14), .c(x13), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n48_), .c(new_n64_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n29_), .c(new_n42_), .O(new_n67_));
  nand2  g39(.a(x08), .b(x04), .O(new_n68_));
  oai21  g40(.a(new_n67_), .b(x10), .c(new_n68_), .O(z5));
  nand2  g41(.a(new_n43_), .b(x05), .O(new_n70_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n76_));
  ...
  nand4  g64(.a(new_n92_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n93_));
