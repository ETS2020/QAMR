...
module FAU ( 
  ...
  aoi21  g16(.a(x13), .b(new_n38_), .c(new_n30_), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(x01), .O(new_n46_));
  nand3  g18(.a(new_n39_), .b(x12), .c(new_n38_), .O(new_n47_));
  ...
  nand4  g24(.a(new_n52_), .b(x11), .c(new_n31_), .d(x09), .O(new_n53_));
  ...
  oai21  g31(.a(new_n56_), .b(x13), .c(new_n59_), .O(new_n60_));
  nand4  g32(.a(new_n60_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n55_), .O(z4));
  nand3  g34(.a(x15), .b(new_n56_), .c(x11), .O(new_n63_));
  oai21  g35(.a(x15), .b(new_n56_), .c(new_n63_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(x13), .c(x12), .O(new_n65_));
  ...
  aoi22  g41(.a(x13), .b(new_n38_), .c(x08), .d(x04), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z5));
  nand2  g43(.a(new_n45_), .b(x05), .O(new_n72_));
  ...
  oai21  g48(.a(new_n76_), .b(new_n66_), .c(new_n75_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(x11), .O(new_n78_));
  oai21  g50(.a(new_n73_), .b(x13), .c(new_n78_), .O(new_n79_));
  nand4  g51(.a(new_n79_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n72_), .O(z6));
  nand4  g53(.a(x12), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n82_));
  inv1   g54(.a(x17), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(x16), .c(x15), .d(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n82_), .c(x11), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(x13), .O(new_n86_));
  nand3  g58(.a(x16), .b(x15), .c(x14), .O(new_n87_));
  nor2   g59(.a(new_n87_), .b(new_n66_), .O(new_n88_));
