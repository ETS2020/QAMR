...
module FAU ( 
  ...
  oai22  g08(.a(new_n36_), .b(new_n33_), .c(x16), .d(new_n29_), .O(z0));
  ...
  nand3  g45(.a(new_n38_), .b(x15), .c(x14), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n55_), .c(new_n73_), .O(new_n75_));
  nand4  g47(.a(new_n75_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n76_));
  ...
  nand2  g57(.a(x18), .b(x09), .O(new_n86_));
  ...
  nand4  g66(.a(new_n94_), .b(new_n29_), .c(x09), .d(new_n30_), .O(new_n95_));
  nand2  g67(.a(x08), .b(x07), .O(new_n96_));
  nand3  g68(.a(new_n96_), .b(new_n95_), .c(new_n88_), .O(z8));
endmodule
