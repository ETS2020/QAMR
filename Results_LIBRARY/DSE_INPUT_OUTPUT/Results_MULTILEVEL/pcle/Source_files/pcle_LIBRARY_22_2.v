...
module FAU ( 
  ...
  oai21  g11(.a(x13), .b(new_n31_), .c(x08), .O(new_n40_));
  ...
  nand3  g23(.a(new_n46_), .b(x12), .c(x11), .O(new_n52_));
  oai21  g24(.a(new_n51_), .b(new_n46_), .c(new_n52_), .O(new_n53_));
  ...
  oai21  g32(.a(new_n51_), .b(new_n59_), .c(new_n60_), .O(new_n61_));
  ...
  oai21  g37(.a(new_n65_), .b(new_n39_), .c(new_n31_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n46_), .O(new_n67_));
  nand2  g39(.a(new_n50_), .b(x15), .O(new_n68_));
  ...
  nand2  g44(.a(x15), .b(new_n59_), .O(new_n73_));
  ...
  nand3  g48(.a(new_n76_), .b(new_n75_), .c(new_n67_), .O(z5));
  inv1   g49(.a(x05), .O(new_n78_));
  nand3  g50(.a(x15), .b(x14), .c(x13), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n50_), .c(x16), .O(new_n80_));
  ...
  oai21  g57(.a(new_n40_), .b(new_n78_), .c(new_n85_), .O(z6));
  nand2  g58(.a(x17), .b(x09), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(x08), .c(new_n31_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n46_), .O(new_n89_));
  nand3  g61(.a(x16), .b(x15), .c(x14), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n50_), .c(x17), .O(new_n91_));
  ...
  nand2  g71(.a(new_n99_), .b(new_n46_), .O(new_n100_));
  nand3  g72(.a(x14), .b(x12), .c(x11), .O(new_n101_));
  nand3  g73(.a(x17), .b(x16), .c(x15), .O(new_n102_));
  oai21  g74(.a(new_n102_), .b(new_n101_), .c(x18), .O(new_n103_));
  nand3  g75(.a(new_n51_), .b(x14), .c(x13), .O(new_n104_));
  nand4  g76(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n105_));
  oai21  g77(.a(new_n105_), .b(new_n104_), .c(new_n103_), .O(new_n106_));
  nand4  g78(.a(new_n106_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n107_));
  nand2  g79(.a(x08), .b(x07), .O(new_n108_));
  nand3  g80(.a(new_n108_), .b(new_n107_), .c(new_n100_), .O(z8));
endmodule
