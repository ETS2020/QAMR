...
module FAU ( 
  ...
  oai21  g32(.a(new_n60_), .b(new_n51_), .c(new_n58_), .O(new_n61_));
  ...
  nand3  g37(.a(new_n52_), .b(x14), .c(x13), .O(new_n66_));
  ...
  nand2  g50(.a(new_n78_), .b(new_n39_), .O(new_n79_));
  nor3   g51(.a(new_n75_), .b(new_n51_), .c(new_n50_), .O(new_n80_));
  ...
  nand2  g67(.a(new_n95_), .b(new_n39_), .O(new_n96_));
  nand3  g68(.a(x17), .b(x15), .c(x14), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n57_), .c(x18), .O(new_n98_));
