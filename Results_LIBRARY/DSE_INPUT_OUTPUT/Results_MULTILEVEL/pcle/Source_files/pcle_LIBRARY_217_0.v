// Benchmark "FAU" written by ABC on Fri Aug 14 01:58:00 2020
...
module FAU ( 
  ...
  aoi21  g18(.a(new_n46_), .b(new_n31_), .c(new_n30_), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(x02), .O(new_n48_));
  xor2a  g20(.a(x13), .b(x11), .O(new_n49_));
  nand4  g21(.a(new_n49_), .b(x12), .c(new_n31_), .d(x09), .O(new_n50_));
  oai21  g22(.a(new_n50_), .b(x08), .c(new_n48_), .O(z3));
  nand2  g23(.a(new_n47_), .b(x03), .O(new_n52_));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n54_), .c(new_n46_), .O(new_n57_));
  nand4  g29(.a(new_n57_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(new_n52_), .O(z4));
  nand2  g31(.a(new_n47_), .b(x04), .O(new_n60_));
  nand2  g32(.a(new_n53_), .b(x15), .O(new_n61_));
  ...
  nand2  g37(.a(x15), .b(new_n55_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n65_), .c(new_n46_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n60_), .O(z5));
  inv1   g41(.a(x09), .O(new_n70_));
  nand2  g42(.a(x15), .b(x14), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n53_), .c(x16), .O(new_n72_));
  inv1   g44(.a(x16), .O(new_n73_));
  inv1   g45(.a(new_n53_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(new_n73_), .c(x15), .d(x14), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n72_), .c(new_n70_), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(new_n30_), .c(new_n46_), .O(new_n77_));
  nand2  g49(.a(x08), .b(x05), .O(new_n78_));
  oai21  g50(.a(new_n77_), .b(x10), .c(new_n78_), .O(z6));
  nand3  g51(.a(x16), .b(x15), .c(x14), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n53_), .c(x17), .O(new_n81_));
  nand3  g53(.a(x14), .b(x13), .c(x11), .O(new_n82_));
  inv1   g54(.a(new_n82_), .O(new_n83_));
  nor2   g55(.a(x17), .b(new_n73_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n83_), .c(x15), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n81_), .c(new_n70_), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n30_), .c(new_n46_), .O(new_n87_));
  nand2  g59(.a(x08), .b(x06), .O(new_n88_));
  oai21  g60(.a(new_n87_), .b(x10), .c(new_n88_), .O(z7));
  nand2  g61(.a(new_n47_), .b(x07), .O(new_n90_));
  ...
  oai21  g65(.a(new_n93_), .b(new_n82_), .c(new_n92_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(x12), .c(new_n31_), .d(x09), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(x08), .c(new_n90_), .O(z8));
endmodule
