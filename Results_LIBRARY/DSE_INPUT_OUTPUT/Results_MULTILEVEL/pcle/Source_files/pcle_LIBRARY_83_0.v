...
module FAU ( 
  ...
  aoi21  g28(.a(new_n56_), .b(new_n31_), .c(new_n30_), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(x03), .O(new_n58_));
  nand2  g30(.a(new_n50_), .b(x14), .O(new_n59_));
  inv1   g31(.a(x14), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(x12), .c(x11), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n59_), .c(new_n56_), .O(new_n62_));
  ...
  nand2  g37(.a(new_n50_), .b(x15), .O(new_n66_));
  ...
  aoi21  g43(.a(new_n71_), .b(new_n70_), .c(new_n56_), .O(new_n72_));
  ...
  aoi21  g53(.a(new_n81_), .b(new_n30_), .c(new_n56_), .O(new_n82_));
  ...
  oai21  g58(.a(new_n86_), .b(new_n50_), .c(x17), .O(new_n87_));
  nand3  g59(.a(x14), .b(x12), .c(x11), .O(new_n88_));
  ...
  nand4  g63(.a(new_n91_), .b(x13), .c(new_n31_), .d(x09), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(x08), .c(new_n85_), .O(z7));
  nand3  g65(.a(x17), .b(x16), .c(x15), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n88_), .c(x18), .O(new_n95_));
  and2   g67(.a(x16), .b(x15), .O(new_n96_));
  inv1   g68(.a(new_n88_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n96_), .c(new_n29_), .d(x17), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n95_), .c(new_n75_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n30_), .c(new_n56_), .O(new_n100_));
