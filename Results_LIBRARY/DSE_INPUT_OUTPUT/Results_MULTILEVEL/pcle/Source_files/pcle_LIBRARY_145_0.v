...
module FAU ( 
  ...
  oai21  g35(.a(new_n63_), .b(new_n45_), .c(new_n32_), .O(new_n64_));
  oai21  g36(.a(new_n31_), .b(new_n45_), .c(new_n64_), .O(z4));
  ...
  oai21  g42(.a(new_n70_), .b(new_n69_), .c(x09), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(x08), .c(x03), .O(new_n72_));
  ...
  aoi21  g52(.a(new_n80_), .b(new_n77_), .c(new_n51_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n31_), .c(new_n45_), .O(new_n82_));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n86_), .c(new_n51_), .O(new_n89_));
  ...
  nor2   g66(.a(new_n78_), .b(new_n67_), .O(new_n95_));
  nand4  g67(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n96_));
  inv1   g68(.a(new_n96_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n95_), .c(new_n29_), .d(x17), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n94_), .c(new_n51_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n31_), .c(new_n45_), .O(new_n100_));
