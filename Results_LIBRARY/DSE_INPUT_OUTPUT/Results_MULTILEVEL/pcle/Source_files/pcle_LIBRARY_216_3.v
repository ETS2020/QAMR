...
module FAU ( 
  ...
  nand4  g13(.a(new_n41_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n42_));
  oai21  g14(.a(new_n39_), .b(new_n38_), .c(new_n42_), .O(z1));
  xor2a  g15(.a(x12), .b(x11), .O(new_n44_));
  nand4  g16(.a(new_n44_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n45_));
  nand2  g17(.a(x08), .b(x01), .O(new_n46_));
  nand3  g18(.a(new_n46_), .b(new_n45_), .c(new_n29_), .O(z2));
  ...
  nand4  g24(.a(new_n52_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n53_));
  oai21  g25(.a(new_n39_), .b(new_n48_), .c(new_n53_), .O(z3));
  ...
  nand3  g31(.a(new_n59_), .b(x09), .c(new_n30_), .O(new_n60_));
  nand2  g32(.a(x08), .b(x03), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n60_), .c(x10), .O(z4));
  nand2  g34(.a(x10), .b(x03), .O(new_n63_));
  ...
  nand4  g43(.a(new_n71_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n72_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n78_));
  ...
  nand4  g58(.a(new_n86_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n87_));
  ...
  nor2   g64(.a(new_n57_), .b(new_n49_), .O(new_n93_));
  ...
  nand4  g68(.a(new_n96_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n97_));
  aoi21  g69(.a(x08), .b(x07), .c(new_n79_), .O(new_n98_));
