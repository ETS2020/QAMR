...
module FAU ( 
  ...
  nand2  g16(.a(new_n38_), .b(x08), .O(new_n45_));
  ...
  nand4  g25(.a(new_n51_), .b(x12), .c(x11), .d(new_n31_), .O(new_n54_));
  oai21  g26(.a(new_n53_), .b(new_n51_), .c(new_n54_), .O(new_n55_));
  nand3  g27(.a(new_n55_), .b(x09), .c(new_n30_), .O(new_n56_));
  nand2  g28(.a(x08), .b(x02), .O(new_n57_));
  nand3  g29(.a(new_n57_), .b(new_n56_), .c(new_n38_), .O(z3));
  nand2  g30(.a(new_n46_), .b(x03), .O(new_n59_));
  ...
  oai22  g35(.a(new_n63_), .b(new_n52_), .c(new_n62_), .d(new_n60_), .O(new_n64_));
  ...
  nor2   g39(.a(x15), .b(new_n51_), .O(new_n68_));
  aoi22  g40(.a(new_n68_), .b(new_n53_), .c(new_n61_), .d(x15), .O(new_n69_));
  ...
  nand4  g65(.a(new_n84_), .b(new_n29_), .c(x17), .d(x16), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n82_), .c(new_n31_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(x13), .O(new_n96_));
  nand3  g68(.a(new_n84_), .b(x17), .c(x16), .O(new_n97_));
