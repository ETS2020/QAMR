...
module FAU ( 
  ...
  nand4  g17(.a(new_n45_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n46_));
  nand2  g18(.a(x08), .b(x01), .O(new_n47_));
  nand3  g19(.a(new_n47_), .b(new_n46_), .c(new_n29_), .O(z2));
  ...
  oai22  g40(.a(new_n68_), .b(new_n31_), .c(new_n67_), .d(new_n65_), .O(new_n69_));
  ...
  nand4  g55(.a(new_n83_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n84_));
  aoi21  g56(.a(x08), .b(x06), .c(new_n38_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n84_), .O(z7));
  oai21  g58(.a(x10), .b(x08), .c(x07), .O(new_n87_));
