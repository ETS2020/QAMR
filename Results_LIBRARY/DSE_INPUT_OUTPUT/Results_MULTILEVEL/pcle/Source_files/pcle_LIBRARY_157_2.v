...
module FAU ( 
  ...
  nand4  g15(.a(new_n43_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n44_));
  nand2  g16(.a(new_n37_), .b(x01), .O(new_n45_));
  ...
  nand4  g21(.a(new_n49_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n50_));
  nand2  g22(.a(new_n37_), .b(x02), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(new_n50_), .O(z3));
  oai21  g24(.a(new_n39_), .b(x03), .c(x08), .O(new_n53_));
  ...
  nand3  g31(.a(new_n59_), .b(new_n39_), .c(x09), .O(new_n60_));
  ...
  nand3  g39(.a(new_n67_), .b(new_n39_), .c(x09), .O(new_n68_));
  ...
  nand2  g47(.a(new_n37_), .b(x05), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z6));
  oai21  g49(.a(new_n39_), .b(x06), .c(x08), .O(new_n78_));
  ...
  nand3  g55(.a(new_n83_), .b(new_n39_), .c(x09), .O(new_n84_));
  ...
  nand2  g64(.a(new_n37_), .b(x07), .O(new_n93_));
