...
module FAU ( 
  ...
  aoi21  g37(.a(new_n65_), .b(new_n62_), .c(new_n50_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n67_));
  oai21  g39(.a(new_n40_), .b(new_n60_), .c(new_n67_), .O(z4));
  ...
  aoi21  g45(.a(new_n73_), .b(new_n30_), .c(new_n50_), .O(new_n74_));
  ...
  nand2  g51(.a(new_n79_), .b(new_n64_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(x16), .c(new_n31_), .d(x09), .O(new_n81_));
  oai22  g53(.a(new_n81_), .b(x08), .c(new_n40_), .d(new_n77_), .O(z6));
  oai21  g54(.a(new_n78_), .b(new_n52_), .c(x17), .O(new_n83_));
  inv1   g55(.a(new_n61_), .O(new_n84_));
  nor2   g56(.a(x17), .b(new_n71_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n84_), .c(x14), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n83_), .c(new_n51_), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n30_), .c(new_n50_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x06), .O(new_n89_));
  oai21  g61(.a(new_n88_), .b(x10), .c(new_n89_), .O(z7));
  inv1   g62(.a(x07), .O(new_n91_));
  nand3  g63(.a(x17), .b(x15), .c(x14), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n61_), .c(x18), .O(new_n93_));
  nand4  g65(.a(new_n29_), .b(x17), .c(x15), .d(x14), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n61_), .c(new_n93_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(x16), .c(new_n31_), .d(x09), .O(new_n96_));
  oai22  g68(.a(new_n96_), .b(x08), .c(new_n40_), .d(new_n91_), .O(z8));
endmodule
