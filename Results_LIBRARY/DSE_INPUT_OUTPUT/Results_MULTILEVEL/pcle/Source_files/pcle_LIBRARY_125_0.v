...
module FAU ( 
  ...
  nand4  g17(.a(new_n45_), .b(x14), .c(new_n31_), .d(x09), .O(new_n46_));
  ...
  nand4  g23(.a(new_n51_), .b(x14), .c(new_n31_), .d(x09), .O(new_n52_));
  oai22  g24(.a(new_n52_), .b(x08), .c(new_n40_), .d(new_n48_), .O(z3));
  nand3  g25(.a(x13), .b(x12), .c(x11), .O(new_n54_));
  nand3  g26(.a(new_n54_), .b(x09), .c(new_n30_), .O(new_n55_));
  ...
  oai21  g38(.a(new_n40_), .b(new_n60_), .c(new_n66_), .O(z5));
  inv1   g39(.a(x05), .O(new_n68_));
  nand2  g40(.a(x12), .b(x11), .O(new_n69_));
  nand2  g41(.a(x15), .b(x13), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n69_), .c(x16), .O(new_n71_));
  inv1   g43(.a(x16), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(x15), .c(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n69_), .c(new_n71_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(x14), .c(new_n31_), .d(x09), .O(new_n75_));
  oai22  g47(.a(new_n75_), .b(x08), .c(new_n40_), .d(new_n68_), .O(z6));
  inv1   g48(.a(x06), .O(new_n77_));
  nand3  g49(.a(x16), .b(x15), .c(x13), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n69_), .c(x17), .O(new_n79_));
  ...
  oai22  g55(.a(new_n83_), .b(x08), .c(new_n40_), .d(new_n77_), .O(z7));
  ...
  oai21  g60(.a(new_n88_), .b(new_n54_), .c(new_n87_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(x14), .c(new_n31_), .d(x09), .O(new_n90_));
  oai22  g62(.a(new_n90_), .b(x08), .c(new_n40_), .d(new_n85_), .O(z8));
endmodule
