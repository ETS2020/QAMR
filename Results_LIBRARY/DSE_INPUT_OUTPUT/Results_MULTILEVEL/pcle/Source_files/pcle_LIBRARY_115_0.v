...
module FAU ( 
  ...
  nand4  g33(.a(new_n61_), .b(x09), .c(new_n41_), .d(x03), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n56_), .O(z3));
  nand2  g35(.a(new_n33_), .b(x13), .O(new_n64_));
  oai22  g36(.a(new_n64_), .b(new_n57_), .c(new_n32_), .d(new_n33_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n40_), .c(x09), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n41_), .c(new_n54_), .O(z4));
  nand2  g39(.a(new_n55_), .b(x04), .O(new_n68_));
  nand2  g40(.a(new_n31_), .b(x15), .O(new_n69_));
  nand4  g41(.a(new_n34_), .b(x13), .c(x12), .d(x11), .O(new_n70_));
  ...
  nand4  g46(.a(new_n74_), .b(x09), .c(new_n41_), .d(x03), .O(new_n75_));
  ...
  nand4  g51(.a(new_n32_), .b(new_n79_), .c(x15), .d(x14), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n78_), .c(new_n29_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n41_), .c(new_n54_), .O(new_n82_));
  nand2  g54(.a(x08), .b(x05), .O(new_n83_));
  oai21  g55(.a(new_n82_), .b(x10), .c(new_n83_), .O(z6));
  nand2  g56(.a(new_n55_), .b(x06), .O(new_n85_));
  ...
  oai21  g61(.a(new_n89_), .b(new_n31_), .c(new_n87_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n40_), .c(x09), .d(new_n41_), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n54_), .c(new_n85_), .O(z7));
  nand4  g64(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n31_), .c(x18), .O(new_n94_));
  nor2   g66(.a(new_n79_), .b(new_n34_), .O(new_n95_));
  ...
  aoi21  g72(.a(new_n100_), .b(new_n41_), .c(new_n54_), .O(new_n101_));
