...
module FAU ( 
  ...
  nand4  g10(.a(new_n38_), .b(new_n35_), .c(x09), .d(new_n33_), .O(new_n39_));
  nand2  g11(.a(new_n39_), .b(new_n32_), .O(z0));
  nand2  g12(.a(x08), .b(x00), .O(new_n41_));
  inv1   g13(.a(x11), .O(new_n42_));
  nand4  g14(.a(new_n42_), .b(new_n30_), .c(x09), .d(new_n33_), .O(new_n43_));
  nand3  g15(.a(new_n43_), .b(new_n41_), .c(new_n32_), .O(z1));
  xor2a  g16(.a(x12), .b(x11), .O(new_n45_));
  nand3  g17(.a(new_n45_), .b(x09), .c(new_n33_), .O(new_n46_));
  nand2  g18(.a(x08), .b(x01), .O(new_n47_));
  aoi21  g19(.a(new_n47_), .b(new_n46_), .c(x10), .O(z2));
  inv1   g20(.a(x02), .O(new_n49_));
  oai21  g21(.a(new_n33_), .b(new_n49_), .c(new_n30_), .O(new_n50_));
  ...
  nand4  g27(.a(new_n55_), .b(new_n30_), .c(x09), .d(new_n33_), .O(new_n56_));
  ...
  oai21  g34(.a(new_n62_), .b(new_n34_), .c(new_n60_), .O(new_n63_));
  nand4  g35(.a(new_n63_), .b(new_n30_), .c(x09), .d(new_n33_), .O(new_n64_));
  aoi21  g36(.a(x08), .b(x03), .c(new_n31_), .O(new_n65_));
  ...
  oai22  g42(.a(new_n70_), .b(new_n34_), .c(new_n69_), .d(new_n67_), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n30_), .c(x09), .d(new_n33_), .O(new_n72_));
  aoi21  g44(.a(x08), .b(x04), .c(new_n31_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n72_), .O(z5));
  oai21  g46(.a(new_n36_), .b(new_n34_), .c(x16), .O(new_n75_));
  ...
  nand4  g50(.a(new_n78_), .b(new_n30_), .c(x09), .d(new_n33_), .O(new_n79_));
  aoi21  g51(.a(x08), .b(x05), .c(new_n31_), .O(new_n80_));
  ...
  oai21  g57(.a(new_n85_), .b(new_n59_), .c(new_n83_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n30_), .c(x09), .d(new_n33_), .O(new_n87_));
  aoi21  g59(.a(x08), .b(x06), .c(new_n31_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n87_), .O(z7));
  nand3  g61(.a(new_n32_), .b(x08), .c(x07), .O(new_n90_));
  nand4  g62(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n59_), .c(x18), .O(new_n92_));
  nor2   g64(.a(new_n76_), .b(new_n67_), .O(new_n93_));
  nor2   g65(.a(x18), .b(new_n84_), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(new_n93_), .c(new_n69_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n92_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n30_), .c(x09), .d(new_n33_), .O(new_n97_));
