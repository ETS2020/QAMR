...
module FAU ( 
  ...
  nand2  g13(.a(new_n41_), .b(x16), .O(new_n42_));
  ...
  oai21  g47(.a(x16), .b(x10), .c(x08), .O(new_n76_));
  nand3  g48(.a(x15), .b(x14), .c(x13), .O(new_n77_));
  inv1   g49(.a(new_n77_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n31_), .O(new_n79_));
  nand4  g51(.a(new_n79_), .b(x16), .c(new_n39_), .d(x09), .O(new_n80_));
  oai22  g52(.a(new_n80_), .b(x08), .c(new_n76_), .d(new_n75_), .O(z6));
  inv1   g53(.a(x06), .O(new_n82_));
  oai21  g54(.a(new_n77_), .b(new_n30_), .c(x17), .O(new_n83_));
  nand3  g55(.a(new_n33_), .b(x15), .c(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n61_), .c(new_n83_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(x16), .c(new_n39_), .d(x09), .O(new_n86_));
  oai22  g58(.a(new_n86_), .b(x08), .c(new_n76_), .d(new_n82_), .O(z7));
  nand3  g59(.a(x17), .b(x15), .c(x14), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n61_), .c(x18), .O(new_n89_));
  inv1   g61(.a(new_n61_), .O(new_n90_));
  and2   g62(.a(x15), .b(x14), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n90_), .c(new_n34_), .d(x17), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n89_), .c(new_n53_), .O(new_n93_));
