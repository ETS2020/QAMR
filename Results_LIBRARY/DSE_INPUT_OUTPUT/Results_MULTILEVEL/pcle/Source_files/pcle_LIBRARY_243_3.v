...
module FAU ( 
  ...
  nand3  g18(.a(new_n46_), .b(new_n44_), .c(new_n29_), .O(z2));
  ...
  nand2  g26(.a(new_n29_), .b(x08), .O(new_n55_));
  ...
  nand2  g36(.a(new_n56_), .b(x04), .O(new_n65_));
  ...
  nand2  g46(.a(new_n56_), .b(x05), .O(new_n75_));
  ...
  nand2  g53(.a(new_n56_), .b(x06), .O(new_n82_));
  ...
  nor2   g64(.a(new_n60_), .b(new_n48_), .O(new_n93_));
  nor2   g65(.a(x18), .b(new_n85_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n49_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n91_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n97_));
  nand2  g69(.a(x08), .b(x07), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(new_n97_), .c(new_n29_), .O(z8));
endmodule
