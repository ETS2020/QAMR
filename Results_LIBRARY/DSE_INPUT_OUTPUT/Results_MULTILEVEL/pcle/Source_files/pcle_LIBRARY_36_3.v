...
module FAU ( 
  ...
  aoi22  g18(.a(x17), .b(x10), .c(x08), .d(x01), .O(new_n47_));
  ...
  nand2  g38(.a(x15), .b(new_n35_), .O(new_n67_));
  ...
  nor2   g60(.a(new_n35_), .b(new_n34_), .O(new_n89_));
  nor2   g61(.a(new_n74_), .b(new_n63_), .O(new_n90_));
  nor2   g62(.a(x18), .b(new_n30_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n33_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n88_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n86_), .O(z8));
endmodule
