...
module FAU ( 
  ...
  oai21  g35(.a(new_n31_), .b(new_n38_), .c(x08), .O(new_n64_));
  ...
  oai22  g40(.a(new_n68_), .b(new_n47_), .c(new_n67_), .d(new_n65_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n70_));
  oai21  g42(.a(new_n64_), .b(new_n63_), .c(new_n70_), .O(z5));
  ...
  oai21  g66(.a(new_n64_), .b(new_n88_), .c(new_n94_), .O(z8));
endmodule
