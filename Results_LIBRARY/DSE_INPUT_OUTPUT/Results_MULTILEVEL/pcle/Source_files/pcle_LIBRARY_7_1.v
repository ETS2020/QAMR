...
module FAU ( 
  ...
  nand4  g64(.a(new_n92_), .b(new_n90_), .c(new_n29_), .d(x17), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n89_), .c(new_n87_), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(x10), .c(new_n30_), .O(new_n95_));
