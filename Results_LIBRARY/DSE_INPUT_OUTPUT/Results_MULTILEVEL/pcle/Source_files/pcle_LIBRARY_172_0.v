...
module FAU ( 
  ...
  oai21  g32(.a(x15), .b(x10), .c(x08), .O(new_n61_));
  ...
  aoi21  g38(.a(new_n66_), .b(new_n63_), .c(new_n50_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n68_));
  oai21  g40(.a(new_n61_), .b(new_n60_), .c(new_n68_), .O(z4));
  nand2  g41(.a(new_n62_), .b(x15), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(x14), .c(new_n51_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n30_), .c(new_n50_), .O(new_n72_));
  ...
  nand4  g49(.a(new_n65_), .b(new_n77_), .c(x14), .d(x13), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n76_), .c(new_n51_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n30_), .c(new_n50_), .O(new_n80_));
  ...
  oai21  g59(.a(new_n87_), .b(new_n62_), .c(new_n85_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(x15), .c(new_n31_), .d(x09), .O(new_n89_));
  oai22  g61(.a(new_n89_), .b(x08), .c(new_n61_), .d(new_n83_), .O(z7));
  inv1   g62(.a(x07), .O(new_n91_));
  nand3  g63(.a(x17), .b(x16), .c(x14), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n62_), .c(x18), .O(new_n93_));
  nand4  g65(.a(new_n29_), .b(x17), .c(x16), .d(x14), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n62_), .c(new_n93_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(x15), .c(new_n31_), .d(x09), .O(new_n96_));
  oai22  g68(.a(new_n96_), .b(x08), .c(new_n61_), .d(new_n91_), .O(z8));
endmodule
