// Benchmark "FAU" written by ABC on Fri Aug 14 01:57:01 2020
...
module FAU ( 
  ...
  oai21  g09(.a(x10), .b(x08), .c(x00), .O(new_n38_));
  ...
  nand2  g16(.a(x10), .b(x00), .O(new_n45_));
  nand3  g17(.a(new_n45_), .b(new_n44_), .c(new_n43_), .O(z2));
  nand2  g18(.a(new_n45_), .b(x08), .O(new_n47_));
  ...
  nand2  g27(.a(new_n55_), .b(new_n49_), .O(z3));
  nand2  g28(.a(new_n48_), .b(x03), .O(new_n57_));
  ...
  nand2  g36(.a(new_n48_), .b(x04), .O(new_n65_));
  nor2   g37(.a(x15), .b(new_n50_), .O(new_n66_));
  aoi22  g38(.a(new_n66_), .b(new_n52_), .c(new_n58_), .d(x15), .O(new_n67_));
  nand2  g39(.a(x15), .b(new_n60_), .O(new_n68_));
  oai21  g40(.a(new_n67_), .b(new_n60_), .c(new_n68_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n65_), .O(z5));
  nand2  g43(.a(new_n48_), .b(x05), .O(new_n72_));
  ...
  inv1   g57(.a(new_n45_), .O(new_n86_));
  aoi21  g58(.a(x08), .b(x06), .c(new_n86_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n85_), .O(z7));
  ...
  aoi21  g67(.a(x08), .b(x07), .c(new_n86_), .O(new_n96_));
