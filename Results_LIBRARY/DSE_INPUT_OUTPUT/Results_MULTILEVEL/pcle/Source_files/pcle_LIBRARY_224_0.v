...
module FAU ( 
  ...
  nand2  g18(.a(new_n46_), .b(x18), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(new_n38_), .O(new_n48_));
  aoi21  g20(.a(x18), .b(new_n38_), .c(x12), .O(new_n49_));
  ...
  nand3  g42(.a(x18), .b(x14), .c(new_n38_), .O(new_n71_));
  ...
  nand2  g71(.a(new_n99_), .b(x18), .O(new_n100_));
  ...
  nand4  g82(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n111_));
  oai21  g83(.a(new_n111_), .b(new_n92_), .c(x18), .O(new_n112_));
  nor2   g84(.a(new_n93_), .b(new_n78_), .O(new_n113_));
  nand4  g85(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n114_));
  inv1   g86(.a(new_n114_), .O(new_n115_));
  nand4  g87(.a(new_n115_), .b(new_n113_), .c(new_n29_), .d(x17), .O(new_n116_));
  nand2  g88(.a(new_n116_), .b(new_n112_), .O(new_n117_));
  nand4  g89(.a(new_n117_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n118_));
  nand2  g90(.a(new_n118_), .b(new_n110_), .O(z8));
endmodule
