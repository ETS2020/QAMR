...
module FAU ( 
  ...
  oai21  g29(.a(new_n57_), .b(new_n48_), .c(new_n55_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n59_));
  nor2   g31(.a(x09), .b(new_n30_), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(x03), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n59_), .O(z4));
  nor2   g34(.a(x15), .b(new_n47_), .O(new_n63_));
  aoi22  g35(.a(new_n63_), .b(new_n49_), .c(new_n54_), .d(x15), .O(new_n64_));
  nand2  g36(.a(x15), .b(new_n56_), .O(new_n65_));
  oai21  g37(.a(new_n64_), .b(new_n56_), .c(new_n65_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n67_));
  nand2  g39(.a(new_n60_), .b(x04), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z5));
  oai21  g41(.a(x09), .b(x05), .c(x08), .O(new_n70_));
  ...
  nand2  g55(.a(new_n60_), .b(x06), .O(new_n84_));
  ...
  nand2  g64(.a(new_n60_), .b(x07), .O(new_n93_));
