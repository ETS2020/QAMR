...
module FAU ( 
  ...
  nand2  g10(.a(new_n31_), .b(x03), .O(new_n39_));
  ...
  nand2  g19(.a(new_n47_), .b(x03), .O(new_n48_));
  ...
  oai22  g35(.a(new_n63_), .b(new_n53_), .c(new_n62_), .d(new_n30_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n32_), .c(x09), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n31_), .c(new_n40_), .O(z4));
  ...
  nand4  g46(.a(new_n74_), .b(x09), .c(new_n31_), .d(x03), .O(new_n75_));
  ...
  nand4  g51(.a(new_n62_), .b(new_n79_), .c(x15), .d(x14), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n78_), .c(new_n52_), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n31_), .c(new_n40_), .O(new_n82_));
  ...
  nand4  g59(.a(new_n87_), .b(new_n62_), .c(x15), .d(x14), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n86_), .c(new_n52_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n31_), .c(new_n40_), .O(new_n90_));
  ...
  nor2   g67(.a(new_n79_), .b(new_n69_), .O(new_n96_));
