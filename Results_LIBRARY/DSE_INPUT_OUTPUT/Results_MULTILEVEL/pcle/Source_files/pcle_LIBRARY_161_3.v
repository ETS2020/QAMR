...
module FAU ( 
  ...
  aoi21  g26(.a(x10), .b(x09), .c(new_n30_), .O(new_n55_));
  ...
  oai21  g39(.a(new_n67_), .b(new_n47_), .c(new_n65_), .O(new_n68_));
  ...
  oai21  g46(.a(new_n74_), .b(new_n47_), .c(x16), .O(new_n75_));
  ...
  aoi21  g50(.a(new_n78_), .b(new_n30_), .c(x10), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(new_n38_), .c(new_n80_), .O(z6));
  ...
  aoi21  g58(.a(new_n86_), .b(new_n30_), .c(x10), .O(new_n87_));
  nand2  g59(.a(x08), .b(x06), .O(new_n88_));
  oai21  g60(.a(new_n87_), .b(new_n38_), .c(new_n88_), .O(z7));
  ...
  nand4  g66(.a(new_n94_), .b(new_n92_), .c(new_n29_), .d(x17), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n91_), .c(x08), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(x10), .c(x09), .O(new_n97_));
