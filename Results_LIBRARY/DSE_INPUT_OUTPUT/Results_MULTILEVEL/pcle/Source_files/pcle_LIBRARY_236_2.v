...
module FAU ( 
  ...
  nand2  g43(.a(new_n71_), .b(new_n63_), .O(new_n72_));
  inv1   g44(.a(x16), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(x15), .c(x14), .O(new_n74_));
  oai22  g46(.a(new_n74_), .b(new_n54_), .c(new_n65_), .d(new_n73_), .O(new_n75_));
  ...
  nand2  g52(.a(new_n80_), .b(new_n63_), .O(new_n81_));
  nand3  g53(.a(x16), .b(x14), .c(x13), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n33_), .c(x17), .O(new_n83_));
  ...
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(new_n81_), .O(z7));
  nand2  g61(.a(x18), .b(x09), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(x08), .c(new_n29_), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n63_), .O(new_n92_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n64_), .c(new_n94_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n98_));
  nand2  g70(.a(x08), .b(x07), .O(new_n99_));
  nand3  g71(.a(new_n99_), .b(new_n98_), .c(new_n92_), .O(z8));
endmodule
