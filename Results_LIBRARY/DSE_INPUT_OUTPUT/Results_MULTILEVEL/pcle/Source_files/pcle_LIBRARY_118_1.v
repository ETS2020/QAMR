...
module FAU ( 
  ...
  nand4  g07(.a(new_n35_), .b(new_n34_), .c(x09), .d(new_n31_), .O(new_n36_));
  nand2  g08(.a(new_n36_), .b(new_n33_), .O(z1));
  xor2a  g09(.a(x12), .b(x11), .O(new_n38_));
  nand3  g10(.a(new_n38_), .b(x09), .c(new_n31_), .O(new_n39_));
  ...
  aoi21  g21(.a(new_n49_), .b(new_n31_), .c(x17), .O(new_n50_));
  nand2  g22(.a(x08), .b(x02), .O(new_n51_));
  oai21  g23(.a(new_n50_), .b(x10), .c(new_n51_), .O(z3));
  nand2  g24(.a(new_n32_), .b(x03), .O(new_n53_));
  ...
  aoi21  g29(.a(new_n57_), .b(new_n55_), .c(x17), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n34_), .c(x09), .d(new_n31_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n53_), .O(z4));
  nand2  g32(.a(new_n32_), .b(x04), .O(new_n61_));
  ...
  nand4  g38(.a(new_n66_), .b(new_n29_), .c(new_n34_), .d(x09), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(x08), .c(new_n61_), .O(z5));
  nand2  g40(.a(new_n32_), .b(x05), .O(new_n69_));
  ...
  nand4  g46(.a(new_n74_), .b(new_n29_), .c(new_n34_), .d(x09), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(x08), .c(new_n69_), .O(z6));
  nand2  g48(.a(new_n32_), .b(x06), .O(new_n77_));
  nor2   g49(.a(new_n45_), .b(x10), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(x09), .c(new_n31_), .O(new_n79_));
  inv1   g51(.a(new_n62_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n29_), .c(x16), .d(x15), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n79_), .c(new_n77_), .O(z7));
  nand2  g54(.a(x18), .b(x09), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(x08), .c(new_n29_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n34_), .O(new_n85_));
