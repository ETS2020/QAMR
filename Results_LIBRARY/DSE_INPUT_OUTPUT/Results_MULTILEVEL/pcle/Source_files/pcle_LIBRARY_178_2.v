...
module FAU ( 
  ...
  oai21  g11(.a(x17), .b(new_n39_), .c(x08), .O(new_n40_));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n30_), .c(new_n41_), .O(new_n56_));
  nand2  g28(.a(x08), .b(x02), .O(new_n57_));
  oai21  g29(.a(new_n56_), .b(new_n39_), .c(new_n57_), .O(z3));
  ...
  aoi21  g36(.a(new_n64_), .b(new_n61_), .c(new_n41_), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n66_));
  oai21  g38(.a(new_n40_), .b(new_n59_), .c(new_n66_), .O(z4));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n30_), .c(new_n41_), .O(new_n73_));
  ...
  nand4  g53(.a(new_n81_), .b(x17), .c(new_n31_), .d(x09), .O(new_n82_));
  oai22  g54(.a(new_n82_), .b(x08), .c(new_n40_), .d(new_n76_), .O(z6));
  nand3  g55(.a(x16), .b(x15), .c(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n60_), .c(new_n31_), .O(new_n85_));
  ...
  oai21  g62(.a(new_n84_), .b(new_n60_), .c(x18), .O(new_n91_));
  nand4  g63(.a(new_n29_), .b(x16), .c(x15), .d(x14), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n60_), .c(new_n91_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(x17), .c(new_n31_), .d(x09), .O(new_n94_));
  oai22  g66(.a(new_n94_), .b(x08), .c(new_n40_), .d(new_n90_), .O(z8));
endmodule
