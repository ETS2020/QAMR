...
module FAU ( 
  ...
  nor2   g16(.a(x16), .b(new_n31_), .O(new_n45_));
  ...
  aoi21  g41(.a(x08), .b(x04), .c(new_n45_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z5));
  nand2  g43(.a(new_n54_), .b(x05), .O(new_n72_));
  inv1   g44(.a(x16), .O(new_n73_));
  nand3  g45(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  nor2   g46(.a(new_n74_), .b(new_n58_), .O(new_n75_));
  nand3  g47(.a(new_n73_), .b(x15), .c(x14), .O(new_n76_));
  oai22  g48(.a(new_n76_), .b(new_n56_), .c(new_n75_), .d(new_n73_), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n72_), .O(z6));
  nand2  g51(.a(x17), .b(x09), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(x08), .c(new_n31_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n73_), .O(new_n82_));
  inv1   g54(.a(x17), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(x16), .c(x15), .d(x14), .O(new_n84_));
  oai22  g56(.a(new_n84_), .b(new_n56_), .c(new_n75_), .d(new_n83_), .O(new_n85_));
