...
module FAU ( 
  ...
  oai21  g11(.a(new_n39_), .b(new_n31_), .c(x08), .O(new_n40_));
  inv1   g12(.a(x09), .O(new_n41_));
  nor2   g13(.a(new_n41_), .b(x08), .O(new_n42_));
  nand3  g14(.a(new_n42_), .b(new_n39_), .c(new_n31_), .O(new_n43_));
  ...
  oai21  g19(.a(new_n40_), .b(new_n45_), .c(new_n47_), .O(z2));
  ...
  aoi22  g26(.a(x11), .b(x10), .c(x08), .d(x02), .O(new_n55_));
  ...
  oai22  g33(.a(new_n61_), .b(new_n49_), .c(new_n60_), .d(new_n58_), .O(new_n62_));
  ...
  nor2   g43(.a(new_n71_), .b(new_n66_), .O(new_n72_));
