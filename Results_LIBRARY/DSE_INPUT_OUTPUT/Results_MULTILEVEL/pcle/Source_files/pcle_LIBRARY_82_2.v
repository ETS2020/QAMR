...
module FAU ( 
  ...
  nand2  g13(.a(new_n30_), .b(x08), .O(new_n42_));
  nor2   g14(.a(x11), .b(x10), .O(new_n43_));
  nand2  g15(.a(new_n43_), .b(new_n33_), .O(new_n44_));
  oai21  g16(.a(new_n42_), .b(new_n41_), .c(new_n44_), .O(z1));
  ...
  nand3  g21(.a(new_n49_), .b(new_n48_), .c(new_n30_), .O(z2));
  inv1   g22(.a(x02), .O(new_n51_));
  nand3  g23(.a(new_n29_), .b(x12), .c(x11), .O(new_n52_));
  oai21  g24(.a(new_n35_), .b(new_n29_), .c(new_n52_), .O(new_n53_));
  nand4  g25(.a(new_n53_), .b(new_n31_), .c(x09), .d(new_n46_), .O(new_n54_));
  oai21  g26(.a(new_n42_), .b(new_n51_), .c(new_n54_), .O(z3));
  ...
  nand2  g41(.a(new_n34_), .b(x15), .O(new_n70_));
  ...
  nand4  g47(.a(new_n75_), .b(new_n31_), .c(x09), .d(new_n46_), .O(new_n76_));
  nand2  g48(.a(x08), .b(x04), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n76_), .c(new_n69_), .O(z5));
  inv1   g50(.a(x05), .O(new_n79_));
  oai21  g51(.a(new_n36_), .b(new_n34_), .c(x16), .O(new_n80_));
  ...
  oai21  g57(.a(new_n42_), .b(new_n79_), .c(new_n85_), .O(z6));
  ...
  oai21  g62(.a(new_n90_), .b(new_n34_), .c(x17), .O(new_n91_));
  inv1   g63(.a(x17), .O(new_n92_));
  nand3  g64(.a(new_n66_), .b(new_n92_), .c(x16), .O(new_n93_));
  ...
  oai21  g71(.a(new_n99_), .b(new_n81_), .c(x18), .O(new_n100_));
  nor2   g72(.a(new_n82_), .b(new_n65_), .O(new_n101_));
  nor2   g73(.a(new_n59_), .b(new_n29_), .O(new_n102_));
  nor2   g74(.a(x18), .b(new_n92_), .O(new_n103_));
  nand4  g75(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n35_), .O(new_n104_));
  nand2  g76(.a(new_n104_), .b(new_n100_), .O(new_n105_));
  nand4  g77(.a(new_n105_), .b(new_n31_), .c(x09), .d(new_n46_), .O(new_n106_));
  oai21  g78(.a(new_n42_), .b(new_n98_), .c(new_n106_), .O(z8));
endmodule
