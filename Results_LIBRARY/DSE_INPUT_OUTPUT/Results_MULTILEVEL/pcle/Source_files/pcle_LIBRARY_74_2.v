...
module FAU ( 
  ...
  oai22  g21(.a(new_n49_), .b(x07), .c(new_n47_), .d(new_n46_), .O(z2));
  inv1   g22(.a(x02), .O(new_n51_));
  xnor2a g23(.a(x13), .b(x12), .O(new_n52_));
  nand2  g24(.a(x13), .b(new_n40_), .O(new_n53_));
  oai21  g25(.a(new_n52_), .b(new_n40_), .c(new_n53_), .O(new_n54_));
  nand4  g26(.a(new_n54_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n55_));
  oai22  g27(.a(new_n55_), .b(x07), .c(new_n47_), .d(new_n51_), .O(z3));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n32_), .c(x07), .O(new_n64_));
  ...
  aoi21  g43(.a(new_n71_), .b(new_n32_), .c(x07), .O(new_n72_));
  ...
  oai22  g53(.a(new_n81_), .b(x07), .c(new_n47_), .d(new_n75_), .O(z6));
  nand2  g54(.a(new_n33_), .b(x07), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(x08), .c(x06), .O(new_n84_));
  nand3  g56(.a(x16), .b(x15), .c(x14), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n58_), .c(x17), .O(new_n86_));
  inv1   g58(.a(new_n58_), .O(new_n87_));
  nor2   g59(.a(x17), .b(new_n78_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n87_), .c(x15), .d(x14), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n86_), .c(new_n57_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n32_), .c(x07), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(x10), .c(new_n84_), .O(z7));
  ...
  nand3  g71(.a(x10), .b(x08), .c(x07), .O(new_n100_));
