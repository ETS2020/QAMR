...
module FAU ( 
  ...
  aoi21  g26(.a(new_n54_), .b(new_n53_), .c(new_n38_), .O(z3));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n61_), .c(new_n38_), .O(z4));
  ...
  nand3  g51(.a(new_n39_), .b(x08), .c(x06), .O(new_n80_));
  inv1   g52(.a(x17), .O(new_n81_));
  nand2  g53(.a(x16), .b(x15), .O(new_n82_));
  nor3   g54(.a(new_n82_), .b(new_n56_), .c(new_n58_), .O(new_n83_));
  inv1   g55(.a(new_n82_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n29_), .c(new_n81_), .O(new_n85_));
  oai22  g57(.a(new_n85_), .b(new_n64_), .c(new_n83_), .d(new_n81_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n80_), .O(z7));
  nand3  g60(.a(new_n84_), .b(new_n29_), .c(x17), .O(new_n89_));
  oai22  g61(.a(new_n89_), .b(new_n64_), .c(new_n83_), .d(new_n29_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n91_));
  aoi21  g63(.a(x08), .b(x07), .c(new_n38_), .O(new_n92_));
