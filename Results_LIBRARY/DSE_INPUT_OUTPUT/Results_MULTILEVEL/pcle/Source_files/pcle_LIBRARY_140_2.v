...
module FAU ( 
  ...
  nand4  g11(.a(new_n39_), .b(new_n36_), .c(new_n34_), .d(new_n29_), .O(new_n40_));
  ...
  oai21  g24(.a(new_n36_), .b(new_n51_), .c(new_n52_), .O(new_n53_));
  ...
  oai21  g30(.a(new_n58_), .b(new_n33_), .c(new_n29_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand3  g32(.a(new_n58_), .b(x14), .c(new_n29_), .O(new_n61_));
  ...
  nand2  g39(.a(new_n67_), .b(new_n57_), .O(new_n68_));
  nand2  g40(.a(new_n58_), .b(x15), .O(new_n69_));
  inv1   g41(.a(x15), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(x13), .c(x12), .d(x11), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n69_), .c(new_n57_), .O(new_n72_));
  ...
  oai21  g48(.a(new_n37_), .b(new_n35_), .c(x16), .O(new_n77_));
  ...
  nor2   g71(.a(x18), .b(new_n88_), .O(new_n100_));
  nand3  g72(.a(new_n100_), .b(new_n99_), .c(new_n97_), .O(new_n101_));
  nand2  g73(.a(new_n101_), .b(new_n96_), .O(new_n102_));
