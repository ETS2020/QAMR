...
module FAU ( 
  ...
  oai21  g30(.a(new_n58_), .b(x10), .c(new_n40_), .O(new_n59_));
  ...
  nand4  g38(.a(new_n66_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n67_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n83_));
  ...
  oai21  g63(.a(new_n91_), .b(x10), .c(new_n40_), .O(new_n92_));
