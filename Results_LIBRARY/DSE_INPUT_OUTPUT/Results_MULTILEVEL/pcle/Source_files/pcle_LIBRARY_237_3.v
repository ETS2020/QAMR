...
module FAU ( 
  ...
  aoi21  g09(.a(x13), .b(x10), .c(new_n30_), .O(new_n38_));
  ...
  nand2  g35(.a(new_n38_), .b(x04), .O(new_n64_));
  inv1   g36(.a(x15), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(x13), .c(x12), .d(x11), .O(new_n66_));
  oai21  g38(.a(new_n59_), .b(new_n65_), .c(new_n66_), .O(new_n67_));
  ...
  nand4  g46(.a(new_n74_), .b(x15), .c(x14), .d(x12), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n73_), .c(new_n31_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(x13), .O(new_n77_));
  nor2   g49(.a(new_n65_), .b(new_n57_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(x13), .O(new_n79_));
  inv1   g51(.a(new_n79_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n50_), .c(new_n74_), .O(new_n81_));
  ...
  nand2  g56(.a(new_n50_), .b(new_n41_), .O(new_n85_));
  ...
  aoi21  g63(.a(new_n91_), .b(new_n59_), .c(new_n86_), .O(new_n92_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n85_), .c(new_n31_), .O(new_n97_));
