...
module FAU ( 
  ...
  oai21  g10(.a(x10), .b(x04), .c(x08), .O(new_n39_));
  ...
  nand4  g37(.a(new_n65_), .b(x09), .c(new_n40_), .d(x04), .O(new_n66_));
  oai21  g38(.a(new_n39_), .b(new_n61_), .c(new_n66_), .O(z4));
  nand3  g39(.a(new_n31_), .b(x15), .c(new_n40_), .O(new_n68_));
  ...
  nand3  g46(.a(new_n74_), .b(new_n42_), .c(x09), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n40_), .c(new_n52_), .O(z5));
  ...
  aoi21  g53(.a(new_n81_), .b(new_n40_), .c(new_n52_), .O(new_n82_));
  ...
  aoi21  g61(.a(new_n89_), .b(new_n40_), .c(new_n52_), .O(new_n90_));
  ...
  aoi21  g72(.a(new_n100_), .b(new_n40_), .c(new_n52_), .O(new_n101_));
