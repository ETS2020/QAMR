...
module FAU ( 
  ...
  inv1   g66(.a(new_n69_), .O(new_n95_));
  nor2   g67(.a(new_n80_), .b(new_n71_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n95_), .c(new_n29_), .d(x17), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n94_), .c(x10), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(x09), .c(new_n31_), .d(x06), .O(new_n99_));
  oai21  g71(.a(new_n41_), .b(new_n92_), .c(new_n99_), .O(z8));
endmodule
