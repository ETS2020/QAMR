...
module FAU ( 
  ...
  aoi21  g29(.a(new_n58_), .b(new_n54_), .c(new_n45_), .O(new_n59_));
  ...
  aoi21  g37(.a(new_n66_), .b(new_n64_), .c(new_n45_), .O(new_n67_));
  ...
  aoi21  g46(.a(new_n75_), .b(new_n72_), .c(new_n45_), .O(new_n76_));
  ...
  nand2  g50(.a(x17), .b(new_n30_), .O(new_n80_));
  nand3  g51(.a(new_n80_), .b(x08), .c(x06), .O(new_n81_));
  nand4  g52(.a(new_n57_), .b(new_n30_), .c(x09), .d(new_n32_), .O(new_n82_));
