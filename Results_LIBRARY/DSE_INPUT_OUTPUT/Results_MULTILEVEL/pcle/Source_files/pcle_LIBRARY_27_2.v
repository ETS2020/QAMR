...
module FAU ( 
  ...
  nor2   g14(.a(x08), .b(x07), .O(new_n43_));
  ...
  oai22  g20(.a(new_n48_), .b(x07), .c(new_n41_), .d(new_n46_), .O(z2));
  ...
  oai22  g26(.a(new_n54_), .b(x07), .c(new_n41_), .d(new_n50_), .O(z3));
  ...
  aoi21  g33(.a(new_n61_), .b(new_n58_), .c(x10), .O(new_n62_));
  nand4  g34(.a(new_n62_), .b(x09), .c(new_n32_), .d(new_n31_), .O(new_n63_));
  oai21  g35(.a(new_n41_), .b(new_n56_), .c(new_n63_), .O(z4));
  ...
  aoi21  g50(.a(new_n78_), .b(new_n75_), .c(new_n65_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n32_), .c(x07), .O(new_n80_));
  ...
  oai21  g62(.a(new_n90_), .b(x07), .c(new_n84_), .O(z7));
  nand4  g63(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n57_), .c(x18), .O(new_n93_));
  inv1   g65(.a(new_n66_), .O(new_n94_));
  nor2   g66(.a(new_n76_), .b(new_n68_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n94_), .c(new_n29_), .d(x17), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n93_), .c(x10), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(x09), .c(new_n32_), .d(new_n31_), .O(new_n98_));
  nand3  g70(.a(x10), .b(x08), .c(x07), .O(new_n99_));
