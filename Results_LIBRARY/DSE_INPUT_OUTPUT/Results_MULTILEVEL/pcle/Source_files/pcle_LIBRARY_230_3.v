...
module FAU ( 
  ...
  aoi21  g41(.a(x08), .b(x04), .c(new_n51_), .O(new_n70_));
  ...
  oai21  g50(.a(new_n55_), .b(new_n72_), .c(new_n78_), .O(z6));
  ...
  oai21  g58(.a(new_n55_), .b(new_n80_), .c(new_n86_), .O(z7));
  oai21  g59(.a(x10), .b(x08), .c(x07), .O(new_n88_));
