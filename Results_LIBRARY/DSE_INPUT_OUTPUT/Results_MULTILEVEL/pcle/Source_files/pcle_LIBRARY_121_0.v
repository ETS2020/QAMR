...
module FAU ( 
  ...
  nand2  g44(.a(x15), .b(new_n33_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n72_), .c(new_n51_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(new_n38_), .c(x09), .d(new_n29_), .O(new_n75_));
  ...
  nor2   g51(.a(x16), .b(new_n69_), .O(new_n80_));
  ...
  nand2  g57(.a(new_n59_), .b(x06), .O(new_n86_));
  ...
  nand4  g63(.a(new_n91_), .b(x18), .c(new_n38_), .d(x09), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(x08), .c(new_n86_), .O(z7));
  nand4  g65(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n61_), .c(x09), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(x08), .c(x18), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n38_), .O(new_n97_));
