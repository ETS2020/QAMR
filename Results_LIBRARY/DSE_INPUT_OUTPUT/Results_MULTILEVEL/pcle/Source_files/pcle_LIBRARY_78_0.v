...
module FAU ( 
  ...
  nand4  g47(.a(new_n31_), .b(new_n32_), .c(x15), .d(x14), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(new_n75_), .c(new_n58_), .O(new_n77_));
  ...
  aoi21  g56(.a(new_n84_), .b(new_n82_), .c(new_n58_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n29_), .c(new_n57_), .O(new_n86_));
  ...
  nand4  g65(.a(new_n93_), .b(x13), .c(new_n39_), .d(x09), .O(new_n94_));
  oai22  g66(.a(new_n94_), .b(x08), .c(new_n67_), .d(new_n89_), .O(z8));
endmodule
