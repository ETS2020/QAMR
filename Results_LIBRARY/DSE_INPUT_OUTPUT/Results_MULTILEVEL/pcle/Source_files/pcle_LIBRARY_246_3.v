...
module FAU ( 
  ...
  nand2  g09(.a(x10), .b(x07), .O(new_n38_));
  ...
  oai21  g43(.a(new_n44_), .b(new_n65_), .c(new_n71_), .O(z5));
  ...
  nand2  g52(.a(x10), .b(x07), .O(new_n81_));
  ...
  nand3  g60(.a(new_n88_), .b(new_n82_), .c(new_n38_), .O(z7));
  ...
  aoi21  g68(.a(new_n96_), .b(new_n95_), .c(x10), .O(z8));
endmodule
