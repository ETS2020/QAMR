...
module FAU ( 
  ...
  oai21  g25(.a(new_n41_), .b(new_n49_), .c(new_n53_), .O(z3));
  ...
  oai21  g32(.a(new_n60_), .b(new_n58_), .c(new_n57_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n62_));
  oai21  g34(.a(new_n41_), .b(new_n55_), .c(new_n62_), .O(z4));
  ...
  oai22  g39(.a(new_n67_), .b(new_n58_), .c(new_n66_), .d(new_n64_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n69_));
  inv1   g41(.a(new_n40_), .O(new_n70_));
  aoi21  g42(.a(x08), .b(x04), .c(new_n70_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n69_), .O(z5));
  nand3  g44(.a(x15), .b(x14), .c(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n58_), .c(x16), .O(new_n74_));
  ...
  aoi21  g50(.a(x08), .b(x05), .c(new_n70_), .O(new_n79_));
  ...
  oai21  g59(.a(new_n41_), .b(new_n81_), .c(new_n87_), .O(z7));
  nand4  g60(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n56_), .c(x18), .O(new_n90_));
  nor2   g62(.a(new_n75_), .b(new_n64_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n66_), .c(new_n29_), .d(x17), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n94_));
  oai21  g66(.a(new_n30_), .b(new_n39_), .c(new_n94_), .O(z8));
endmodule
