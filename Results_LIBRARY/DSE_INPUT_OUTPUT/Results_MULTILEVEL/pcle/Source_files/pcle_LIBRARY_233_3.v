...
module FAU ( 
  ...
  oai21  g47(.a(new_n75_), .b(new_n52_), .c(new_n73_), .O(new_n76_));
  ...
  oai21  g59(.a(new_n87_), .b(new_n52_), .c(x18), .O(new_n88_));
  ...
  nand3  g63(.a(new_n91_), .b(x09), .c(new_n30_), .O(new_n92_));
  nand2  g64(.a(x08), .b(x07), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n92_), .c(x10), .O(z8));
endmodule
