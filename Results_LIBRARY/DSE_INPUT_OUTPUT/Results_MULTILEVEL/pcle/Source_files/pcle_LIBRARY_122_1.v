...
module FAU ( 
  ...
  aoi21  g31(.a(new_n59_), .b(new_n56_), .c(x17), .O(new_n60_));
  nand4  g32(.a(new_n60_), .b(new_n31_), .c(x09), .d(new_n32_), .O(new_n61_));
  oai21  g33(.a(new_n46_), .b(new_n54_), .c(new_n61_), .O(z4));
  ...
  aoi21  g39(.a(new_n67_), .b(new_n65_), .c(new_n63_), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n32_), .c(x17), .O(new_n69_));
  ...
  aoi21  g48(.a(new_n76_), .b(new_n73_), .c(new_n63_), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n32_), .c(x17), .O(new_n78_));
  nand2  g50(.a(x08), .b(x05), .O(new_n79_));
  oai21  g51(.a(new_n78_), .b(x10), .c(new_n79_), .O(z6));
  inv1   g52(.a(x06), .O(new_n81_));
  nor2   g53(.a(new_n63_), .b(x08), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n58_), .c(new_n31_), .O(new_n83_));
  inv1   g55(.a(new_n64_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n29_), .c(x16), .d(x15), .O(new_n85_));
  oai22  g57(.a(new_n85_), .b(new_n83_), .c(new_n46_), .d(new_n81_), .O(z7));
  inv1   g58(.a(x07), .O(new_n87_));
  nand4  g59(.a(new_n82_), .b(x18), .c(new_n29_), .d(new_n31_), .O(new_n88_));
  oai21  g60(.a(new_n46_), .b(new_n87_), .c(new_n88_), .O(z8));
endmodule
