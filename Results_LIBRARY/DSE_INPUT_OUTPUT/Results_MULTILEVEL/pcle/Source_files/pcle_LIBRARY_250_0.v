...
module FAU ( 
  ...
  nand4  g23(.a(new_n51_), .b(x15), .c(new_n31_), .d(x09), .O(new_n52_));
  ...
  nand3  g32(.a(new_n60_), .b(new_n58_), .c(x13), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n57_), .c(new_n55_), .O(new_n62_));
  nand4  g34(.a(new_n62_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n63_));
  oai21  g35(.a(new_n40_), .b(new_n54_), .c(new_n63_), .O(z4));
  inv1   g36(.a(x04), .O(new_n65_));
  inv1   g37(.a(new_n56_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x14), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(x15), .c(new_n31_), .d(x09), .O(new_n68_));
  oai22  g40(.a(new_n68_), .b(x08), .c(new_n40_), .d(new_n65_), .O(z5));
  ...
  nand4  g45(.a(new_n60_), .b(new_n73_), .c(x14), .d(x13), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n72_), .c(new_n70_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n30_), .c(new_n55_), .O(new_n76_));
  nand2  g48(.a(x08), .b(x05), .O(new_n77_));
  oai21  g49(.a(new_n76_), .b(x10), .c(new_n77_), .O(z6));
  nand3  g50(.a(x16), .b(x14), .c(x13), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n59_), .c(x17), .O(new_n80_));
  nor2   g52(.a(x17), .b(new_n73_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n66_), .c(x14), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n80_), .c(new_n70_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n30_), .c(new_n55_), .O(new_n84_));
  ...
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(new_n70_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n30_), .c(new_n55_), .O(new_n92_));
