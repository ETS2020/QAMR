...
module FAU ( 
  ...
  aoi21  g20(.a(new_n48_), .b(new_n47_), .c(new_n40_), .O(z2));
  ...
  aoi21  g26(.a(new_n54_), .b(new_n53_), .c(new_n40_), .O(z3));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n62_), .c(new_n40_), .O(z4));
  nand2  g36(.a(x14), .b(x13), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n59_), .c(x15), .O(new_n66_));
  nand3  g38(.a(new_n35_), .b(x14), .c(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n59_), .c(new_n66_), .O(new_n68_));
  ...
  oai21  g44(.a(new_n72_), .b(new_n59_), .c(x16), .O(new_n73_));
  ...
  aoi21  g48(.a(x08), .b(x05), .c(new_n40_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(z6));
  nand4  g50(.a(new_n34_), .b(new_n36_), .c(x15), .d(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n32_), .c(x18), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(x16), .O(new_n81_));
  nand3  g53(.a(x16), .b(x15), .c(x14), .O(new_n82_));
  inv1   g54(.a(new_n82_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n58_), .c(new_n36_), .O(new_n84_));
  ...
  nor2   g60(.a(new_n35_), .b(new_n56_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n58_), .c(x17), .d(x16), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(x18), .c(new_n31_), .d(x09), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(x08), .c(new_n88_), .O(z8));
endmodule
