...
module FAU ( 
  ...
  nand2  g20(.a(x13), .b(new_n31_), .O(new_n49_));
  oai21  g21(.a(new_n48_), .b(new_n31_), .c(new_n49_), .O(new_n50_));
  nand4  g22(.a(new_n50_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n51_));
  nand2  g23(.a(new_n39_), .b(x02), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n51_), .O(z3));
  oai21  g25(.a(x09), .b(x03), .c(x08), .O(new_n54_));
  ...
  nand3  g31(.a(new_n59_), .b(new_n41_), .c(x09), .O(new_n60_));
  ...
  nand4  g37(.a(new_n65_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n66_));
  nand2  g38(.a(new_n39_), .b(x04), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n66_), .O(z5));
  oai21  g40(.a(x09), .b(x05), .c(x08), .O(new_n69_));
  ...
  nand3  g46(.a(new_n74_), .b(new_n41_), .c(x09), .O(new_n75_));
  ...
  nand4  g53(.a(new_n81_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n82_));
  ...
  nand4  g62(.a(new_n90_), .b(new_n41_), .c(x09), .d(new_n29_), .O(new_n91_));
