...
module FAU ( 
  ...
  nand2  g21(.a(x13), .b(new_n31_), .O(new_n50_));
  oai21  g22(.a(new_n49_), .b(new_n31_), .c(new_n50_), .O(new_n51_));
  nand4  g23(.a(new_n51_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n48_), .O(z3));
  nand3  g25(.a(x13), .b(x12), .c(x11), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(x14), .O(new_n55_));
  nand4  g27(.a(new_n33_), .b(x13), .c(x12), .d(x11), .O(new_n56_));
  aoi21  g28(.a(new_n56_), .b(new_n55_), .c(x08), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(x10), .c(x09), .O(new_n58_));
  nand2  g30(.a(x08), .b(x03), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n58_), .O(z4));
  nand2  g32(.a(new_n43_), .b(x04), .O(new_n61_));
  ...
  oai22  g37(.a(new_n65_), .b(new_n62_), .c(new_n64_), .d(new_n34_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n61_), .O(z5));
  nand3  g40(.a(x15), .b(x14), .c(x13), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(new_n62_), .c(x16), .O(new_n70_));
  ...
  aoi21  g45(.a(new_n73_), .b(new_n39_), .c(x10), .O(new_n74_));
  nand2  g46(.a(x08), .b(x05), .O(new_n75_));
  oai21  g47(.a(new_n74_), .b(new_n29_), .c(new_n75_), .O(z6));
  ...
  aoi21  g53(.a(new_n81_), .b(new_n39_), .c(x10), .O(new_n82_));
  nand2  g54(.a(x08), .b(x06), .O(new_n83_));
  oai21  g55(.a(new_n82_), .b(new_n29_), .c(new_n83_), .O(z7));
  ...
  nand4  g60(.a(new_n88_), .b(new_n64_), .c(x16), .d(x15), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n30_), .c(x09), .d(new_n39_), .O(new_n91_));
