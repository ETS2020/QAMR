...
module FAU ( 
  ...
  nand3  g25(.a(new_n53_), .b(new_n52_), .c(new_n39_), .O(z3));
  ...
  nand2  g38(.a(new_n39_), .b(x08), .O(new_n67_));
  ...
  oai22  g43(.a(new_n71_), .b(new_n58_), .c(new_n70_), .d(new_n68_), .O(new_n72_));
  nand4  g44(.a(new_n72_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n73_));
  oai21  g45(.a(new_n67_), .b(new_n66_), .c(new_n73_), .O(z5));
  inv1   g46(.a(x05), .O(new_n75_));
  nand3  g47(.a(x15), .b(x14), .c(x13), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n58_), .c(x16), .O(new_n77_));
  ...
  oai21  g54(.a(new_n67_), .b(new_n75_), .c(new_n82_), .O(z6));
  ...
  oai21  g62(.a(new_n67_), .b(new_n84_), .c(new_n90_), .O(z7));
  ...
  oai21  g70(.a(new_n67_), .b(new_n92_), .c(new_n98_), .O(z8));
endmodule
