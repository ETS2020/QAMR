...
module FAU ( 
  ...
  nand3  g21(.a(new_n49_), .b(x08), .c(x01), .O(new_n50_));
  xor2a  g22(.a(x12), .b(x11), .O(new_n51_));
  nand4  g23(.a(new_n51_), .b(new_n41_), .c(x09), .d(new_n42_), .O(new_n52_));
  oai21  g24(.a(new_n52_), .b(x02), .c(new_n50_), .O(z2));
  xnor2a g25(.a(x13), .b(x12), .O(new_n54_));
  nand2  g26(.a(x13), .b(new_n43_), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(new_n43_), .c(new_n55_), .O(new_n56_));
  nand4  g28(.a(new_n56_), .b(new_n41_), .c(x09), .d(new_n42_), .O(new_n57_));
  nand3  g29(.a(x10), .b(x08), .c(x02), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(x02), .c(new_n58_), .O(z3));
  nand2  g31(.a(new_n32_), .b(x14), .O(new_n60_));
  nand2  g32(.a(x12), .b(x11), .O(new_n61_));
  inv1   g33(.a(new_n61_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n34_), .c(x13), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n60_), .c(new_n30_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n42_), .c(x02), .O(new_n65_));
  ...
  nand4  g41(.a(new_n62_), .b(new_n35_), .c(x14), .d(x13), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n69_), .c(new_n30_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n42_), .c(x02), .O(new_n72_));
  ...
  nand4  g49(.a(new_n33_), .b(new_n77_), .c(x15), .d(x14), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n76_), .c(new_n30_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n42_), .c(x02), .O(new_n80_));
  nand2  g52(.a(x08), .b(x05), .O(new_n81_));
  oai21  g53(.a(new_n80_), .b(x10), .c(new_n81_), .O(z6));
  nand2  g54(.a(new_n41_), .b(x02), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(x08), .c(x06), .O(new_n84_));
  nand3  g56(.a(x16), .b(x15), .c(x14), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n32_), .c(x17), .O(new_n86_));
  inv1   g58(.a(x17), .O(new_n87_));
  nand3  g59(.a(new_n36_), .b(new_n87_), .c(x16), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n32_), .c(new_n86_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n41_), .c(x09), .d(new_n42_), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(x02), .c(new_n84_), .O(z7));
  ...
  nand3  g68(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n93_), .c(new_n30_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n42_), .c(x02), .O(new_n99_));
