...
module FAU ( 
  ...
  oai21  g18(.a(x14), .b(x10), .c(x08), .O(new_n47_));
  xor2a  g19(.a(x12), .b(x11), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(x14), .c(new_n39_), .d(x09), .O(new_n49_));
  ...
  nand3  g32(.a(new_n60_), .b(x09), .c(new_n29_), .O(new_n61_));
  ...
  aoi21  g40(.a(new_n68_), .b(new_n66_), .c(new_n52_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n29_), .c(new_n51_), .O(new_n70_));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n80_), .c(new_n52_), .O(new_n83_));
  ...
  oai21  g60(.a(new_n88_), .b(new_n60_), .c(x18), .O(new_n89_));
  nand4  g61(.a(new_n34_), .b(x17), .c(x16), .d(x15), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n60_), .c(new_n89_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(x14), .c(new_n39_), .d(x09), .O(new_n92_));
  oai22  g64(.a(new_n92_), .b(x08), .c(new_n47_), .d(new_n87_), .O(z8));
endmodule
