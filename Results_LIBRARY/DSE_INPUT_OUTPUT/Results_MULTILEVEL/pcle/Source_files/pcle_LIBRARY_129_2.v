...
module FAU ( 
  ...
  aoi21  g13(.a(new_n41_), .b(x05), .c(new_n40_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(x00), .O(new_n43_));
  nor2   g15(.a(x11), .b(x10), .O(new_n44_));
  nand4  g16(.a(new_n44_), .b(x09), .c(new_n40_), .d(new_n29_), .O(new_n45_));
  ...
  nand4  g30(.a(new_n58_), .b(x09), .c(new_n40_), .d(new_n29_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n53_), .O(z3));
  nand2  g32(.a(new_n42_), .b(x03), .O(new_n61_));
  ...
  nand4  g41(.a(new_n63_), .b(new_n34_), .c(x14), .d(x13), .O(new_n70_));
  ...
  oai21  g46(.a(new_n41_), .b(x08), .c(x05), .O(new_n75_));
  ...
  nand4  g52(.a(new_n80_), .b(new_n41_), .c(x09), .d(new_n40_), .O(new_n81_));
  ...
  nor2   g65(.a(new_n78_), .b(new_n34_), .O(new_n94_));
  nor2   g66(.a(x18), .b(new_n86_), .O(new_n95_));
  nand3  g67(.a(new_n95_), .b(new_n94_), .c(new_n93_), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n92_), .c(new_n30_), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n40_), .c(x05), .O(new_n98_));
