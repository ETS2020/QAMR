...
module FAU ( 
  ...
  inv1   g18(.a(x05), .O(new_n47_));
  oai21  g19(.a(x10), .b(x05), .c(x08), .O(new_n48_));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n39_), .c(new_n47_), .O(new_n57_));
  ...
  nand4  g37(.a(new_n65_), .b(x09), .c(new_n39_), .d(x05), .O(new_n66_));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n39_), .c(new_n47_), .O(new_n73_));
  ...
  aoi21  g52(.a(new_n80_), .b(x09), .c(new_n47_), .O(new_n81_));
  oai22  g53(.a(new_n81_), .b(x10), .c(new_n39_), .d(new_n47_), .O(z6));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n31_), .c(x17), .O(new_n84_));
  inv1   g56(.a(x17), .O(new_n85_));
  nand4  g57(.a(new_n33_), .b(new_n32_), .c(new_n85_), .d(x16), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n84_), .c(new_n29_), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n39_), .c(new_n47_), .O(new_n88_));
  ...
  inv1   g64(.a(new_n68_), .O(new_n93_));
  nor2   g65(.a(new_n78_), .b(new_n70_), .O(new_n94_));
