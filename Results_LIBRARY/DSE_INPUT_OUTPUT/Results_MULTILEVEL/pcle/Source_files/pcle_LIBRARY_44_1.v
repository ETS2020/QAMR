...
module FAU ( 
  ...
  oai21  g18(.a(new_n30_), .b(new_n39_), .c(new_n46_), .O(z2));
  ...
  inv1   g25(.a(new_n40_), .O(new_n54_));
  ...
  oai21  g43(.a(new_n41_), .b(new_n65_), .c(new_n71_), .O(z5));
  ...
  aoi21  g50(.a(x08), .b(x05), .c(new_n54_), .O(new_n79_));
  ...
  aoi21  g58(.a(x08), .b(x06), .c(new_n54_), .O(new_n87_));
  ...
  nor2   g63(.a(new_n75_), .b(new_n66_), .O(new_n92_));
  ...
  oai21  g67(.a(new_n41_), .b(new_n89_), .c(new_n95_), .O(z8));
endmodule
