...
module FAU ( 
  ...
  aoi21  g35(.a(new_n63_), .b(new_n62_), .c(new_n39_), .O(z4));
  nand2  g36(.a(x14), .b(x13), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n50_), .c(x15), .O(new_n66_));
  ...
  nand3  g52(.a(new_n40_), .b(x08), .c(x06), .O(new_n81_));
  nand3  g53(.a(x16), .b(x15), .c(x14), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n58_), .c(x18), .O(new_n83_));
  nor2   g55(.a(new_n67_), .b(new_n57_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n38_), .c(x16), .O(new_n85_));
  oai22  g57(.a(new_n85_), .b(new_n58_), .c(new_n83_), .d(new_n38_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n81_), .O(z7));
  nand4  g60(.a(new_n84_), .b(new_n59_), .c(x17), .d(x16), .O(new_n89_));
