...
module FAU ( 
  ...
  nand4  g34(.a(new_n62_), .b(new_n30_), .c(x09), .d(new_n33_), .O(new_n63_));
  ...
  oai22  g40(.a(new_n68_), .b(new_n34_), .c(new_n67_), .d(new_n65_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n30_), .c(x09), .d(new_n33_), .O(new_n70_));
  aoi21  g42(.a(x08), .b(x04), .c(new_n31_), .O(new_n71_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n30_), .c(x09), .d(new_n33_), .O(new_n78_));
  ...
  nand3  g56(.a(new_n84_), .b(x09), .c(new_n33_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n85_), .c(x10), .O(z7));
  inv1   g59(.a(x07), .O(new_n88_));
  oai21  g60(.a(new_n33_), .b(new_n88_), .c(new_n30_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(x06), .O(new_n90_));
  ...
  nand3  g66(.a(new_n94_), .b(new_n93_), .c(new_n67_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(new_n92_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n30_), .c(x09), .d(new_n33_), .O(new_n97_));
  nand3  g69(.a(x08), .b(x07), .c(new_n29_), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(new_n97_), .c(new_n90_), .O(z8));
endmodule
