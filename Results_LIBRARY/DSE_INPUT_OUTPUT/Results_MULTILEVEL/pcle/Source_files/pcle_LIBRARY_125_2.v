...
module FAU ( 
  ...
  aoi21  g11(.a(new_n39_), .b(x10), .c(new_n30_), .O(new_n40_));
  nand2  g12(.a(new_n40_), .b(x00), .O(new_n41_));
  inv1   g13(.a(x11), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n31_), .O(new_n43_));
  oai21  g15(.a(new_n43_), .b(new_n38_), .c(new_n41_), .O(z1));
  ...
  oai21  g27(.a(new_n55_), .b(new_n38_), .c(new_n31_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n39_), .O(new_n57_));
  and2   g29(.a(new_n55_), .b(x14), .O(new_n58_));
  ...
  nand2  g33(.a(new_n40_), .b(x04), .O(new_n62_));
  nand2  g34(.a(new_n55_), .b(x15), .O(new_n63_));
  nand2  g35(.a(x12), .b(x11), .O(new_n64_));
  inv1   g36(.a(x15), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(x13), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x14), .O(new_n68_));
  nand2  g40(.a(x15), .b(new_n39_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n62_), .O(z5));
  nand2  g44(.a(new_n40_), .b(x05), .O(new_n73_));
  nand3  g45(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n64_), .c(x16), .O(new_n75_));
  ...
  nand2  g52(.a(new_n40_), .b(x06), .O(new_n81_));
  ...
  nand2  g60(.a(new_n40_), .b(x07), .O(new_n89_));
