...
module FAU ( 
  ...
  nand4  g21(.a(new_n49_), .b(new_n42_), .c(x09), .d(new_n41_), .O(new_n50_));
  oai21  g22(.a(new_n50_), .b(x07), .c(new_n48_), .O(z2));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n41_), .c(x07), .O(new_n57_));
  nand2  g29(.a(x08), .b(x02), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(x10), .c(new_n58_), .O(z3));
  nand2  g31(.a(new_n43_), .b(x03), .O(new_n60_));
  ...
  nand4  g35(.a(new_n63_), .b(x09), .c(new_n41_), .d(new_n29_), .O(new_n64_));
  ...
  oai22  g41(.a(new_n69_), .b(new_n52_), .c(new_n68_), .d(new_n34_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n42_), .c(x09), .d(new_n41_), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(x07), .c(new_n66_), .O(z5));
  ...
  aoi21  g49(.a(new_n77_), .b(new_n74_), .c(new_n30_), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n41_), .c(x07), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(x10), .c(new_n80_), .O(z6));
  nand2  g53(.a(new_n43_), .b(x06), .O(new_n82_));
  ...
  oai21  g57(.a(new_n85_), .b(new_n31_), .c(new_n84_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n42_), .c(x09), .d(new_n41_), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(x07), .c(new_n82_), .O(z7));
  oai21  g60(.a(new_n42_), .b(x08), .c(x07), .O(new_n89_));
  nand4  g61(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n31_), .c(x18), .O(new_n91_));
  nor2   g63(.a(new_n75_), .b(new_n34_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n68_), .c(new_n37_), .d(x17), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n42_), .c(x09), .d(new_n41_), .O(new_n95_));
