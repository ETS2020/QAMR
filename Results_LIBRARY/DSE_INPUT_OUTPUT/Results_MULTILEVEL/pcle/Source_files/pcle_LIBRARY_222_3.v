...
module FAU ( 
  ...
  aoi21  g13(.a(x16), .b(x10), .c(new_n31_), .O(new_n42_));
  ...
  oai22  g33(.a(new_n61_), .b(new_n32_), .c(new_n60_), .d(new_n58_), .O(new_n62_));
  ...
  nand3  g49(.a(new_n30_), .b(x15), .c(x14), .O(new_n78_));
  ...
  nand4  g56(.a(new_n37_), .b(x16), .c(x15), .d(x14), .O(new_n85_));
  ...
  nand4  g60(.a(new_n36_), .b(new_n38_), .c(x17), .d(x15), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n34_), .c(new_n29_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(x16), .O(new_n91_));
  nand4  g63(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n92_));
  inv1   g64(.a(new_n92_), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n60_), .c(new_n38_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n95_));
