...
module FAU ( 
  ...
  nand3  g12(.a(x13), .b(new_n31_), .c(new_n35_), .O(new_n42_));
  oai22  g13(.a(new_n42_), .b(new_n34_), .c(new_n32_), .d(new_n41_), .O(z3));
  nand2  g14(.a(x14), .b(x09), .O(new_n44_));
  oai21  g15(.a(new_n44_), .b(x08), .c(new_n31_), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(new_n35_), .O(new_n46_));
  ...
  nand2  g32(.a(x18), .b(x09), .O(new_n62_));
