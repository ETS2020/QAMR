...
module FAU ( 
  ...
  oai21  g28(.a(new_n55_), .b(new_n32_), .c(new_n56_), .O(new_n57_));
  ...
  nand3  g33(.a(new_n55_), .b(new_n34_), .c(x13), .O(new_n62_));
  ...
  nand3  g41(.a(new_n35_), .b(x14), .c(x13), .O(new_n70_));
  oai22  g42(.a(new_n70_), .b(new_n54_), .c(new_n69_), .d(new_n35_), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n44_), .c(x09), .d(new_n43_), .O(new_n72_));
  ...
  oai21  g58(.a(new_n86_), .b(new_n60_), .c(new_n84_), .O(new_n87_));
