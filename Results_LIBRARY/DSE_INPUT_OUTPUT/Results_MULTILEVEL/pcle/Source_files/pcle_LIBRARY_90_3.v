...
module FAU ( 
  ...
  nor2   g58(.a(new_n65_), .b(new_n54_), .O(new_n87_));
  nor2   g59(.a(x17), .b(new_n79_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(new_n59_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n86_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n91_));
  oai21  g63(.a(new_n41_), .b(new_n84_), .c(new_n91_), .O(z7));
  nand4  g64(.a(x13), .b(x12), .c(x09), .d(new_n30_), .O(new_n93_));
  nand4  g65(.a(new_n87_), .b(new_n29_), .c(x17), .d(x16), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n93_), .c(new_n31_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(x11), .O(new_n96_));
  nand4  g68(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n97_));
  inv1   g69(.a(new_n97_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n59_), .c(new_n29_), .O(new_n99_));
