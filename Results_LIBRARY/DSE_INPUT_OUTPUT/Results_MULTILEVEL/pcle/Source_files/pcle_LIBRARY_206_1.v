...
module FAU ( 
  ...
  aoi21  g10(.a(x10), .b(new_n38_), .c(new_n30_), .O(new_n39_));
  ...
  oai21  g17(.a(new_n30_), .b(new_n38_), .c(new_n45_), .O(z2));
  nand2  g18(.a(new_n39_), .b(x02), .O(new_n47_));
  ...
  aoi22  g49(.a(x10), .b(new_n38_), .c(x08), .d(x05), .O(new_n78_));
