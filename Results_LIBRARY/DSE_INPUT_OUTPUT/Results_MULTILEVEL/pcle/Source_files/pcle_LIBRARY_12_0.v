...
module FAU ( 
  ...
  nand4  g29(.a(new_n57_), .b(new_n53_), .c(x09), .d(new_n41_), .O(new_n58_));
  ...
  nand4  g36(.a(new_n64_), .b(new_n53_), .c(x09), .d(new_n41_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n60_), .O(z4));
  nand2  g38(.a(new_n51_), .b(x04), .O(new_n67_));
  ...
  nand4  g45(.a(new_n73_), .b(new_n53_), .c(x09), .d(new_n41_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n67_), .O(z5));
  nand2  g47(.a(new_n51_), .b(x05), .O(new_n76_));
  ...
  nand4  g53(.a(new_n81_), .b(new_n53_), .c(x09), .d(new_n41_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n76_), .O(z6));
  nand2  g55(.a(new_n51_), .b(x06), .O(new_n84_));
  ...
  nand4  g61(.a(new_n89_), .b(new_n53_), .c(x09), .d(new_n41_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n84_), .O(z7));
  nand2  g63(.a(new_n51_), .b(x07), .O(new_n92_));
  ...
  nor2   g67(.a(new_n34_), .b(new_n32_), .O(new_n96_));
  nor2   g68(.a(x18), .b(new_n87_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n55_), .O(new_n98_));
  nand2  g70(.a(new_n98_), .b(new_n94_), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(new_n53_), .c(x09), .d(new_n41_), .O(new_n100_));
