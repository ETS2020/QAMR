...
module FAU ( 
  ...
  nor2   g09(.a(x17), .b(new_n31_), .O(new_n38_));
  ...
  aoi21  g23(.a(x08), .b(x02), .c(new_n38_), .O(new_n52_));
  ...
  aoi21  g32(.a(x08), .b(x03), .c(new_n38_), .O(new_n61_));
  ...
  oai21  g38(.a(new_n66_), .b(new_n56_), .c(new_n64_), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n68_));
  aoi21  g40(.a(x08), .b(x04), .c(new_n38_), .O(new_n69_));
  ...
  aoi21  g48(.a(x08), .b(x05), .c(new_n38_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(z6));
  nand3  g50(.a(new_n39_), .b(x08), .c(x06), .O(new_n79_));
  ...
  oai21  g59(.a(new_n87_), .b(x08), .c(new_n31_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n82_), .O(new_n89_));
  oai21  g61(.a(new_n80_), .b(new_n54_), .c(x18), .O(new_n90_));
  nand4  g62(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n63_), .c(new_n90_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n93_));
  nand2  g65(.a(x08), .b(x07), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(new_n93_), .c(new_n89_), .O(z8));
endmodule
