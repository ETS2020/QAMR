...
module FAU ( 
  ...
  oai21  g31(.a(new_n59_), .b(new_n43_), .c(new_n40_), .O(new_n60_));
  ...
  aoi21  g38(.a(new_n66_), .b(new_n39_), .c(new_n43_), .O(new_n67_));
  ...
  aoi21  g46(.a(new_n74_), .b(new_n39_), .c(new_n43_), .O(new_n75_));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n39_), .c(new_n43_), .O(new_n83_));
  nand2  g55(.a(x08), .b(x06), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(x10), .c(new_n84_), .O(z7));
  inv1   g57(.a(new_n38_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(x07), .O(new_n87_));
