...
module FAU ( 
  ...
  aoi21  g20(.a(new_n49_), .b(new_n47_), .c(new_n34_), .O(new_n50_));
  aoi21  g21(.a(new_n50_), .b(new_n30_), .c(x17), .O(new_n51_));
  ...
  nand2  g32(.a(new_n61_), .b(new_n54_), .O(z4));
  nand2  g33(.a(new_n32_), .b(x04), .O(new_n63_));
  nand2  g34(.a(new_n55_), .b(x15), .O(new_n64_));
  ...
  nand2  g39(.a(x15), .b(new_n57_), .O(new_n69_));
  aoi21  g40(.a(new_n69_), .b(new_n68_), .c(x17), .O(new_n70_));
  nand4  g41(.a(new_n70_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n63_), .O(z5));
  nand2  g43(.a(new_n32_), .b(x05), .O(new_n73_));
  nand3  g44(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  oai21  g45(.a(new_n74_), .b(new_n46_), .c(x16), .O(new_n75_));
  inv1   g46(.a(x16), .O(new_n76_));
  nand3  g47(.a(new_n76_), .b(x15), .c(x14), .O(new_n77_));
  oai21  g48(.a(new_n77_), .b(new_n55_), .c(new_n75_), .O(new_n78_));
  nand4  g49(.a(new_n78_), .b(new_n39_), .c(new_n31_), .d(x09), .O(new_n79_));
  oai21  g50(.a(new_n79_), .b(x08), .c(new_n73_), .O(z6));
  nand2  g51(.a(new_n32_), .b(x06), .O(new_n81_));
  nand3  g52(.a(new_n58_), .b(new_n35_), .c(new_n31_), .O(new_n82_));
  nor2   g53(.a(new_n57_), .b(new_n48_), .O(new_n83_));
  nand4  g54(.a(new_n83_), .b(new_n39_), .c(x16), .d(x15), .O(new_n84_));
  oai21  g55(.a(new_n84_), .b(new_n82_), .c(new_n81_), .O(z7));
  nand2  g56(.a(new_n32_), .b(x07), .O(new_n86_));
  nand4  g57(.a(new_n35_), .b(x18), .c(new_n39_), .d(new_n31_), .O(new_n87_));
