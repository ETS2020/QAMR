...
module FAU ( 
  ...
  aoi22  g40(.a(new_n68_), .b(new_n54_), .c(new_n60_), .d(x15), .O(new_n69_));
  nand2  g41(.a(x15), .b(new_n62_), .O(new_n70_));
  oai21  g42(.a(new_n69_), .b(new_n62_), .c(new_n70_), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n67_), .O(z5));
  nand2  g45(.a(new_n50_), .b(x05), .O(new_n74_));
  ...
  aoi21  g59(.a(x08), .b(x06), .c(new_n47_), .O(new_n88_));
  ...
  aoi21  g68(.a(x08), .b(x07), .c(new_n47_), .O(new_n97_));
