...
module FAU ( 
  ...
  oai21  g16(.a(x13), .b(x10), .c(x08), .O(new_n45_));
  xor2a  g17(.a(x12), .b(x11), .O(new_n46_));
  nand4  g18(.a(new_n46_), .b(x13), .c(new_n31_), .d(x09), .O(new_n47_));
  oai22  g19(.a(new_n47_), .b(x08), .c(new_n45_), .d(new_n44_), .O(z2));
  inv1   g20(.a(x02), .O(new_n49_));
  nand2  g21(.a(x12), .b(x11), .O(new_n50_));
  nand4  g22(.a(new_n50_), .b(x13), .c(new_n31_), .d(x09), .O(new_n51_));
  ...
  nand4  g38(.a(new_n66_), .b(x14), .c(x12), .d(x11), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n65_), .c(new_n53_), .O(new_n68_));
  ...
  nand4  g48(.a(new_n76_), .b(x13), .c(new_n31_), .d(x09), .O(new_n77_));
  ...
  inv1   g52(.a(new_n64_), .O(new_n81_));
  nor2   g53(.a(x17), .b(new_n74_), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n81_), .c(x15), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n80_), .c(new_n54_), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n30_), .c(new_n53_), .O(new_n85_));
  ...
  oai21  g61(.a(new_n89_), .b(new_n64_), .c(x18), .O(new_n90_));
  nand4  g62(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n64_), .c(new_n90_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(x13), .c(new_n31_), .d(x09), .O(new_n93_));
  oai22  g65(.a(new_n93_), .b(x08), .c(new_n45_), .d(new_n88_), .O(z8));
endmodule
