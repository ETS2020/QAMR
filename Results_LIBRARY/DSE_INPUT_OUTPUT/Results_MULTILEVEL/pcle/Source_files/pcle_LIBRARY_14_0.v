...
module FAU ( 
  ...
  aoi21  g27(.a(new_n55_), .b(new_n37_), .c(new_n50_), .O(new_n56_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n37_), .c(new_n50_), .O(new_n64_));
  nand2  g36(.a(x08), .b(x03), .O(new_n65_));
  oai21  g37(.a(new_n64_), .b(x10), .c(new_n65_), .O(z4));
  aoi21  g38(.a(new_n50_), .b(new_n36_), .c(new_n37_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x04), .O(new_n68_));
  oai21  g40(.a(new_n31_), .b(new_n51_), .c(x15), .O(new_n69_));
  ...
  nand4  g44(.a(new_n72_), .b(x18), .c(new_n36_), .d(x09), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(x08), .c(new_n68_), .O(z5));
  ...
  nand4  g52(.a(new_n80_), .b(x18), .c(new_n36_), .d(x09), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(x08), .c(new_n75_), .O(z6));
  nand2  g54(.a(new_n67_), .b(x06), .O(new_n83_));
  ...
  nand4  g60(.a(new_n88_), .b(x18), .c(new_n36_), .d(x09), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x08), .c(new_n83_), .O(z7));
  nand4  g62(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n59_), .c(x09), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(x08), .c(x18), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n36_), .O(new_n94_));
