...
module FAU ( 
  ...
  oai21  g11(.a(x14), .b(new_n39_), .c(x08), .O(new_n40_));
  ...
  aoi21  g29(.a(x08), .b(x03), .c(new_n47_), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(x08), .c(new_n58_), .O(z4));
  nand3  g31(.a(new_n31_), .b(x09), .c(new_n30_), .O(new_n60_));
  inv1   g32(.a(x15), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(x13), .c(x12), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n60_), .c(x14), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(x11), .O(new_n64_));
  inv1   g36(.a(new_n56_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(x14), .c(new_n61_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n67_));
  nand2  g39(.a(x08), .b(x04), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n67_), .c(new_n64_), .O(z5));
  inv1   g41(.a(new_n40_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(x05), .O(new_n71_));
  inv1   g43(.a(x16), .O(new_n72_));
  nand3  g44(.a(x15), .b(x13), .c(x12), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(x16), .O(new_n74_));
  nand2  g46(.a(x12), .b(x11), .O(new_n75_));
  nand3  g47(.a(new_n72_), .b(x15), .c(x13), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(x14), .O(new_n78_));
  oai21  g50(.a(new_n72_), .b(x11), .c(new_n78_), .O(new_n79_));
  nand4  g51(.a(new_n79_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n71_), .O(z6));
  nand3  g53(.a(new_n42_), .b(x12), .c(new_n31_), .O(new_n82_));
  inv1   g54(.a(x17), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(x16), .c(x15), .d(x13), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n82_), .c(x14), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(x11), .O(new_n86_));
  nand3  g58(.a(x16), .b(x15), .c(x13), .O(new_n87_));
  nor2   g59(.a(new_n87_), .b(new_n75_), .O(new_n88_));
  ...
  nand2  g64(.a(new_n70_), .b(x07), .O(new_n93_));
  nand2  g65(.a(x13), .b(x12), .O(new_n94_));
  nand3  g66(.a(x17), .b(x16), .c(x15), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n94_), .c(x18), .O(new_n96_));
  nand4  g68(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n56_), .c(new_n96_), .O(new_n98_));
