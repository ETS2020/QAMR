...
module FAU ( 
  ...
  aoi21  g39(.a(new_n67_), .b(new_n37_), .c(new_n38_), .O(new_n68_));
  ...
  aoi21  g47(.a(new_n75_), .b(new_n37_), .c(new_n38_), .O(new_n76_));
  ...
  aoi21  g55(.a(new_n83_), .b(new_n37_), .c(new_n38_), .O(new_n84_));
  ...
  aoi21  g63(.a(new_n91_), .b(new_n88_), .c(x08), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n38_), .c(new_n45_), .O(new_n93_));
