...
module FAU ( 
  ...
  nor2   g13(.a(new_n30_), .b(new_n41_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(x00), .O(new_n43_));
  inv1   g15(.a(x11), .O(new_n44_));
  nand3  g16(.a(new_n33_), .b(new_n44_), .c(new_n29_), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(new_n43_), .O(z1));
  nand2  g18(.a(new_n42_), .b(x01), .O(new_n47_));
  xor2a  g19(.a(x12), .b(x11), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n49_));
  ...
  nand4  g26(.a(new_n54_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n55_));
  ...
  oai22  g33(.a(new_n61_), .b(new_n34_), .c(new_n60_), .d(new_n58_), .O(new_n62_));
  nand4  g34(.a(new_n62_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n57_), .O(z4));
  nand2  g36(.a(x14), .b(x13), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n34_), .c(x15), .O(new_n66_));
  inv1   g38(.a(x15), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(x14), .c(x13), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n34_), .c(new_n66_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n70_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n73_), .O(z6));
  nand2  g51(.a(new_n42_), .b(x06), .O(new_n80_));
  ...
  nand4  g57(.a(new_n85_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n80_), .O(z7));
  inv1   g59(.a(x18), .O(new_n88_));
  nand3  g60(.a(x17), .b(x16), .c(x15), .O(new_n89_));
  nor2   g61(.a(new_n89_), .b(new_n65_), .O(new_n90_));
  ...
  aoi21  g67(.a(new_n95_), .b(new_n60_), .c(new_n88_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n97_));
