...
module FAU ( 
  ...
  nand2  g10(.a(x17), .b(x10), .O(new_n39_));
  ...
  oai21  g34(.a(new_n40_), .b(new_n55_), .c(new_n62_), .O(z4));
  ...
  aoi21  g41(.a(x08), .b(x04), .c(new_n52_), .O(new_n70_));
  ...
  oai21  g50(.a(new_n40_), .b(new_n72_), .c(new_n78_), .O(z6));
  nand3  g51(.a(x16), .b(x15), .c(x14), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n56_), .c(x17), .O(new_n81_));
  nand4  g53(.a(x13), .b(x12), .c(x11), .d(new_n31_), .O(new_n82_));
  ...
  aoi21  g58(.a(x08), .b(x06), .c(new_n52_), .O(new_n87_));
  ...
  nor2   g63(.a(new_n75_), .b(new_n64_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n66_), .c(new_n29_), .d(x17), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n95_));
  oai21  g67(.a(new_n40_), .b(new_n89_), .c(new_n95_), .O(z8));
endmodule
