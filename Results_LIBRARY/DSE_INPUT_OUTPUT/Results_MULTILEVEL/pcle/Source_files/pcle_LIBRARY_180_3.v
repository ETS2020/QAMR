...
module FAU ( 
  ...
  oai21  g19(.a(x09), .b(x02), .c(x08), .O(new_n48_));
  ...
  nand3  g25(.a(new_n53_), .b(new_n31_), .c(x09), .O(new_n54_));
  ...
  oai21  g43(.a(x09), .b(x05), .c(x08), .O(new_n72_));
  ...
  nand3  g49(.a(new_n77_), .b(new_n31_), .c(x09), .O(new_n78_));
  ...
  nor2   g54(.a(new_n65_), .b(new_n59_), .O(new_n83_));
  nor2   g55(.a(x17), .b(new_n75_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n57_), .c(new_n82_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n87_));
  oai21  g59(.a(new_n40_), .b(new_n80_), .c(new_n87_), .O(z7));
  oai21  g60(.a(x09), .b(x07), .c(x08), .O(new_n89_));
  nand3  g61(.a(new_n83_), .b(x17), .c(x16), .O(new_n90_));
