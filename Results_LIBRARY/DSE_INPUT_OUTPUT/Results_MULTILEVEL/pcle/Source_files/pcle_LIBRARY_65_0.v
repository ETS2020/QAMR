...
module FAU ( 
  ...
  nand2  g17(.a(new_n45_), .b(x17), .O(new_n46_));
  ...
  oai21  g22(.a(x17), .b(x10), .c(x08), .O(new_n51_));
  ...
  oai21  g30(.a(new_n51_), .b(new_n50_), .c(new_n58_), .O(z3));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n30_), .c(new_n52_), .O(new_n66_));
  ...
  nand2  g60(.a(new_n88_), .b(new_n79_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(x17), .c(new_n31_), .d(x09), .O(new_n90_));
  oai22  g62(.a(new_n90_), .b(x08), .c(new_n51_), .d(new_n86_), .O(z7));
  oai21  g63(.a(new_n87_), .b(new_n61_), .c(x18), .O(new_n92_));
  and2   g64(.a(x15), .b(x14), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n79_), .c(new_n29_), .d(x16), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n92_), .c(new_n60_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n30_), .c(new_n52_), .O(new_n96_));
