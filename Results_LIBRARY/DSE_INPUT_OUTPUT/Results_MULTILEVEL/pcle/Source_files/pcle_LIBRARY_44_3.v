...
module FAU ( 
  ...
  oai21  g20(.a(new_n30_), .b(new_n48_), .c(new_n31_), .O(new_n49_));
  ...
  inv1   g28(.a(x01), .O(new_n57_));
  nand3  g29(.a(x08), .b(x02), .c(new_n57_), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n56_), .c(new_n50_), .O(z3));
  ...
  oai21  g35(.a(new_n63_), .b(new_n51_), .c(new_n61_), .O(new_n64_));
  nand4  g36(.a(new_n64_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n65_));
  inv1   g37(.a(new_n39_), .O(new_n66_));
  aoi21  g38(.a(x08), .b(x03), .c(new_n66_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n65_), .O(z4));
  ...
  oai22  g45(.a(new_n73_), .b(new_n51_), .c(new_n72_), .d(new_n70_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n75_));
  oai21  g47(.a(new_n40_), .b(new_n69_), .c(new_n75_), .O(z5));
  ...
  aoi21  g54(.a(x08), .b(x05), .c(new_n66_), .O(new_n83_));
  ...
  aoi21  g62(.a(x08), .b(x06), .c(new_n66_), .O(new_n91_));
  ...
  nand4  g68(.a(new_n96_), .b(new_n72_), .c(new_n29_), .d(x17), .O(new_n97_));
