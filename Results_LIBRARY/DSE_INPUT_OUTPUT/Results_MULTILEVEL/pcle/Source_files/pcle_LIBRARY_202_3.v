...
module FAU ( 
  ...
  oai22  g39(.a(new_n67_), .b(new_n50_), .c(new_n66_), .d(new_n64_), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n30_), .c(x10), .O(new_n69_));
  nand2  g41(.a(x08), .b(x04), .O(new_n70_));
  oai21  g42(.a(new_n69_), .b(new_n39_), .c(new_n70_), .O(z5));
  ...
  oai21  g50(.a(new_n77_), .b(new_n39_), .c(new_n78_), .O(z6));
  ...
  oai21  g58(.a(new_n85_), .b(new_n39_), .c(new_n86_), .O(z7));
