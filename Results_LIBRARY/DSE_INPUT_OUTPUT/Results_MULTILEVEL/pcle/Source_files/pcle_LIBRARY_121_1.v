...
module FAU ( 
  ...
  oai21  g37(.a(new_n65_), .b(new_n46_), .c(x15), .O(new_n66_));
  ...
  oai22  g42(.a(new_n70_), .b(x08), .c(new_n55_), .d(new_n64_), .O(z5));
  ...
  aoi21  g48(.a(new_n76_), .b(new_n73_), .c(new_n45_), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n32_), .c(x18), .O(new_n78_));
  ...
  nand4  g58(.a(new_n86_), .b(new_n29_), .c(new_n31_), .d(x09), .O(new_n87_));
  oai22  g59(.a(new_n87_), .b(x08), .c(new_n55_), .d(new_n81_), .O(z7));
  nand3  g60(.a(new_n59_), .b(x09), .c(new_n32_), .O(new_n89_));
  inv1   g61(.a(new_n89_), .O(new_n90_));
  nor4   g62(.a(new_n65_), .b(new_n84_), .c(new_n74_), .d(new_n67_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n90_), .c(x18), .O(new_n92_));
