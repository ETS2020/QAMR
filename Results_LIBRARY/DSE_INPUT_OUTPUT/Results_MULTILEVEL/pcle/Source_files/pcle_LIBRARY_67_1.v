...
module FAU ( 
  ...
  nand2  g18(.a(x13), .b(new_n38_), .O(new_n47_));
  oai21  g19(.a(new_n46_), .b(new_n38_), .c(new_n47_), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(x09), .c(x10), .O(new_n49_));
  nand2  g21(.a(x08), .b(x02), .O(new_n50_));
  oai21  g22(.a(new_n49_), .b(x08), .c(new_n50_), .O(z3));
  ...
  oai21  g29(.a(new_n57_), .b(x10), .c(new_n30_), .O(new_n58_));
  ...
  oai22  g37(.a(new_n65_), .b(new_n62_), .c(new_n64_), .d(new_n61_), .O(new_n66_));
  ...
  nor2   g59(.a(new_n72_), .b(new_n61_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n64_), .c(new_n29_), .d(x17), .O(new_n89_));
