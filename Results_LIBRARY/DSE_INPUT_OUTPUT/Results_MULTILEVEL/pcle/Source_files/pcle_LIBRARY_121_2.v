...
module FAU ( 
  ...
  nand4  g26(.a(new_n54_), .b(new_n29_), .c(x09), .d(new_n47_), .O(new_n55_));
  aoi21  g27(.a(x08), .b(x02), .c(new_n30_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n55_), .O(z3));
  nor2   g29(.a(new_n30_), .b(new_n47_), .O(new_n58_));
  ...
  oai22  g35(.a(new_n63_), .b(new_n34_), .c(new_n62_), .d(new_n60_), .O(new_n64_));
  ...
  nand2  g44(.a(x15), .b(new_n60_), .O(new_n73_));
  ...
  oai21  g50(.a(new_n78_), .b(new_n61_), .c(new_n77_), .O(new_n79_));
  ...
  aoi21  g69(.a(new_n97_), .b(new_n62_), .c(new_n38_), .O(new_n98_));
