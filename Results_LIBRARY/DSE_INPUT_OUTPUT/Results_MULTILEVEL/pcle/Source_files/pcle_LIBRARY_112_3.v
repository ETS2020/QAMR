...
module FAU ( 
  ...
  nand2  g00(.a(x10), .b(x05), .O(new_n29_));
  ...
  nand3  g14(.a(new_n29_), .b(x08), .c(x01), .O(new_n43_));
  ...
  nand3  g20(.a(new_n47_), .b(x12), .c(x11), .O(new_n49_));
  ...
  nand3  g26(.a(new_n29_), .b(x08), .c(x03), .O(new_n55_));
  ...
  nand4  g41(.a(new_n69_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n70_));
  aoi21  g42(.a(x08), .b(x04), .c(new_n52_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n70_), .O(z5));
  oai21  g44(.a(x10), .b(x08), .c(x05), .O(new_n73_));
  oai21  g45(.a(new_n33_), .b(new_n31_), .c(x16), .O(new_n74_));
  ...
  nand4  g49(.a(new_n77_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n78_));
  ...
  aoi21  g57(.a(x08), .b(x06), .c(new_n52_), .O(new_n86_));
  ...
  nor2   g62(.a(new_n58_), .b(new_n47_), .O(new_n91_));
  nor2   g63(.a(x18), .b(new_n82_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n48_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n89_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n95_));
