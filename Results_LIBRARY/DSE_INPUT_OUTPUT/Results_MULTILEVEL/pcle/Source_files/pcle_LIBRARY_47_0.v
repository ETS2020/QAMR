...
module FAU ( 
  ...
  aoi21  g44(.a(new_n72_), .b(new_n31_), .c(new_n46_), .O(new_n73_));
  ...
  oai22  g54(.a(new_n82_), .b(new_n46_), .c(new_n47_), .d(new_n76_), .O(z6));
  ...
  aoi21  g60(.a(new_n88_), .b(x09), .c(new_n46_), .O(new_n89_));
  oai22  g61(.a(new_n89_), .b(x10), .c(new_n31_), .d(new_n46_), .O(z7));
