...
module FAU ( 
  ...
  aoi21  g48(.a(new_n76_), .b(new_n30_), .c(new_n38_), .O(new_n77_));
  ...
  oai21  g58(.a(new_n48_), .b(new_n80_), .c(new_n86_), .O(z7));
  ...
  oai21  g64(.a(new_n92_), .b(new_n38_), .c(new_n31_), .O(new_n93_));
