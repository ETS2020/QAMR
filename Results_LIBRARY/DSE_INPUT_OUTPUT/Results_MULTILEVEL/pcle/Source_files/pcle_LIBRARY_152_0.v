...
module FAU ( 
  ...
  oai22  g26(.a(new_n54_), .b(new_n46_), .c(new_n41_), .d(new_n50_), .O(z3));
  ...
  aoi21  g32(.a(new_n60_), .b(new_n31_), .c(new_n46_), .O(new_n61_));
  ...
  oai22  g43(.a(new_n71_), .b(new_n46_), .c(new_n41_), .d(new_n64_), .O(z5));
  nand3  g44(.a(x15), .b(x14), .c(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n66_), .c(x16), .O(new_n74_));
  ...
  aoi21  g49(.a(new_n77_), .b(x09), .c(new_n46_), .O(new_n78_));
  oai22  g50(.a(new_n78_), .b(x10), .c(new_n31_), .d(new_n46_), .O(z6));
  ...
  oai22  g58(.a(new_n86_), .b(new_n46_), .c(new_n41_), .d(new_n80_), .O(z7));
  ...
  nand4  g62(.a(new_n90_), .b(new_n68_), .c(new_n29_), .d(x17), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n89_), .c(new_n56_), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n31_), .c(new_n46_), .O(new_n93_));
