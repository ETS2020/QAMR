...
module FAU ( 
  ...
  nand2  g19(.a(x13), .b(new_n31_), .O(new_n48_));
  oai21  g20(.a(new_n47_), .b(new_n31_), .c(new_n48_), .O(new_n49_));
  nand4  g21(.a(new_n49_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n50_));
  ...
  nand4  g26(.a(new_n33_), .b(x13), .c(x12), .d(x11), .O(new_n55_));
  aoi21  g27(.a(new_n55_), .b(new_n54_), .c(new_n30_), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(x10), .c(new_n42_), .O(new_n57_));
  ...
  nand3  g34(.a(new_n34_), .b(x14), .c(x13), .O(new_n63_));
  oai22  g35(.a(new_n63_), .b(new_n60_), .c(new_n62_), .d(new_n34_), .O(new_n64_));
  nand4  g36(.a(new_n64_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n65_));
  nand2  g37(.a(x08), .b(x04), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n65_), .O(z5));
  nand3  g39(.a(x15), .b(x14), .c(x13), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n60_), .c(x16), .O(new_n69_));
  ...
  nand4  g44(.a(new_n72_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n73_));
  ...
  aoi21  g52(.a(new_n80_), .b(x09), .c(x10), .O(new_n81_));
  nand2  g53(.a(x08), .b(x06), .O(new_n82_));
  oai21  g54(.a(new_n81_), .b(x08), .c(new_n82_), .O(z7));
  ...
  nand4  g58(.a(new_n86_), .b(new_n62_), .c(x16), .d(x15), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n29_), .c(x09), .d(new_n42_), .O(new_n89_));
