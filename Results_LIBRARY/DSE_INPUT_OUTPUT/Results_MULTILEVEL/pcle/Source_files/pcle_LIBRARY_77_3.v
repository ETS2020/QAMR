...
module FAU ( 
  ...
  nand3  g20(.a(new_n48_), .b(new_n46_), .c(new_n29_), .O(z2));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n54_), .c(x10), .O(z3));
  ...
  nand2  g36(.a(new_n39_), .b(x04), .O(new_n65_));
  ...
  nand4  g42(.a(new_n70_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n71_));
  ...
  nand4  g66(.a(new_n94_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n95_));
