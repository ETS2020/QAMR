...
module FAU ( 
  ...
  aoi21  g37(.a(new_n65_), .b(new_n63_), .c(new_n52_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n42_), .c(x09), .d(new_n29_), .O(new_n67_));
  oai21  g39(.a(new_n41_), .b(new_n61_), .c(new_n67_), .O(z4));
  ...
  nand4  g51(.a(new_n79_), .b(x18), .c(new_n42_), .d(x09), .O(new_n80_));
  oai22  g52(.a(new_n80_), .b(x08), .c(new_n41_), .d(new_n75_), .O(z6));
  nand3  g53(.a(x16), .b(x15), .c(x14), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n62_), .c(x17), .O(new_n83_));
  nand4  g55(.a(new_n34_), .b(x16), .c(x15), .d(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n62_), .c(new_n83_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(x18), .c(x09), .d(new_n29_), .O(new_n86_));
  ...
  nor2   g64(.a(new_n32_), .b(new_n64_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(x17), .d(x16), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(x18), .c(new_n42_), .d(x09), .O(new_n95_));
