...
module FAU ( 
  ...
  nand2  g19(.a(new_n29_), .b(x08), .O(new_n48_));
  ...
  nand4  g24(.a(new_n52_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n53_));
  oai21  g25(.a(new_n48_), .b(new_n47_), .c(new_n53_), .O(z3));
  nand2  g26(.a(x10), .b(x04), .O(new_n55_));
  ...
  nand4  g33(.a(new_n61_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n62_));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n71_), .c(x10), .O(z5));
  ...
  nand4  g58(.a(new_n86_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n87_));
  ...
  nor2   g65(.a(new_n59_), .b(new_n49_), .O(new_n94_));
  nor2   g66(.a(x18), .b(new_n84_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n50_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n92_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n98_));
  oai21  g70(.a(new_n48_), .b(new_n90_), .c(new_n98_), .O(z8));
endmodule
