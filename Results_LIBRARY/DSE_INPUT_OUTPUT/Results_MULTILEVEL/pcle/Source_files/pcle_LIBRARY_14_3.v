...
module FAU ( 
  ...
  nor2   g34(.a(new_n39_), .b(new_n31_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(x04), .O(new_n64_));
  oai21  g36(.a(new_n34_), .b(new_n32_), .c(x15), .O(new_n65_));
  ...
  nand2  g42(.a(new_n63_), .b(x05), .O(new_n71_));
  ...
  nand3  g55(.a(new_n83_), .b(new_n82_), .c(x16), .O(new_n84_));
  ...
  nand4  g61(.a(x13), .b(x12), .c(x11), .d(new_n29_), .O(new_n90_));
  nand4  g62(.a(new_n83_), .b(new_n30_), .c(x17), .d(x16), .O(new_n91_));
