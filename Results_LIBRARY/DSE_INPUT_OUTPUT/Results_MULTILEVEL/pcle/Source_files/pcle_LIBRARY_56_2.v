...
module FAU ( 
  ...
  nor2   g17(.a(x08), .b(x02), .O(new_n46_));
  nand4  g18(.a(new_n46_), .b(new_n45_), .c(new_n42_), .d(x09), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(new_n44_), .O(z1));
  nand2  g20(.a(new_n42_), .b(x02), .O(new_n49_));
  nand3  g21(.a(new_n49_), .b(x08), .c(x01), .O(new_n50_));
  xor2a  g22(.a(x12), .b(x11), .O(new_n51_));
  nand4  g23(.a(new_n51_), .b(new_n42_), .c(x09), .d(new_n41_), .O(new_n52_));
  ...
  nand4  g28(.a(new_n56_), .b(new_n42_), .c(x09), .d(new_n41_), .O(new_n57_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n41_), .c(x02), .O(new_n64_));
  ...
  aoi21  g42(.a(new_n70_), .b(new_n41_), .c(x02), .O(new_n71_));
  nand2  g43(.a(x08), .b(x04), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(x10), .c(new_n72_), .O(z5));
  nand2  g45(.a(new_n43_), .b(x05), .O(new_n74_));
  ...
  nand4  g52(.a(new_n80_), .b(new_n42_), .c(x09), .d(new_n41_), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(x02), .c(new_n74_), .O(z6));
  ...
  nand3  g57(.a(new_n35_), .b(new_n36_), .c(x16), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n31_), .c(new_n85_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n42_), .c(x09), .d(new_n41_), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(x02), .c(new_n83_), .O(z7));
  nand2  g61(.a(new_n43_), .b(x07), .O(new_n90_));
