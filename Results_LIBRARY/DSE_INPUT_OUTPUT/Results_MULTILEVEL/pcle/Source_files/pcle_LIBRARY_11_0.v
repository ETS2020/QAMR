...
module FAU ( 
  ...
  nand3  g26(.a(x13), .b(new_n54_), .c(new_n41_), .O(new_n55_));
  inv1   g27(.a(new_n55_), .O(new_n56_));
  nor2   g28(.a(x13), .b(new_n54_), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n56_), .c(x11), .O(new_n58_));
  nand2  g30(.a(x13), .b(new_n42_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(new_n40_), .c(x09), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n41_), .c(new_n48_), .O(z3));
  nand2  g34(.a(new_n31_), .b(x14), .O(new_n63_));
  nand2  g35(.a(x12), .b(x11), .O(new_n64_));
  inv1   g36(.a(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n33_), .c(x13), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n63_), .c(new_n29_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n41_), .c(new_n48_), .O(new_n68_));
  ...
  aoi21  g71(.a(new_n99_), .b(new_n95_), .c(new_n29_), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n41_), .c(new_n48_), .O(new_n101_));
