...
module FAU ( 
  ...
  nand2  g17(.a(new_n33_), .b(x02), .O(new_n46_));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n79_), .c(new_n61_), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(new_n32_), .c(x02), .O(new_n84_));
  ...
  oai21  g60(.a(new_n88_), .b(new_n62_), .c(x17), .O(new_n89_));
  inv1   g61(.a(x17), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n62_), .c(new_n89_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n93_));
  oai22  g65(.a(new_n93_), .b(x02), .c(new_n70_), .d(new_n87_), .O(z7));
  ...
  nand4  g69(.a(new_n97_), .b(new_n73_), .c(new_n29_), .d(x17), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n96_), .c(new_n61_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n32_), .c(x02), .O(new_n100_));
