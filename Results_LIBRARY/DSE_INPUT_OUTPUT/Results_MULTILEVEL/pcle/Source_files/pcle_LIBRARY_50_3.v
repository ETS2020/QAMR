...
module FAU ( 
  ...
  oai21  g30(.a(new_n58_), .b(x10), .c(x09), .O(new_n59_));
  ...
  oai21  g41(.a(new_n68_), .b(new_n38_), .c(new_n69_), .O(z5));
  nand3  g42(.a(x15), .b(x14), .c(x13), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n63_), .c(x16), .O(new_n72_));
  ...
  aoi21  g47(.a(new_n75_), .b(new_n30_), .c(x10), .O(new_n76_));
  nand2  g48(.a(x08), .b(x05), .O(new_n77_));
  oai21  g49(.a(new_n76_), .b(new_n38_), .c(new_n77_), .O(z6));
  ...
  nor2   g61(.a(new_n73_), .b(new_n62_), .O(new_n90_));
  ...
  oai21  g65(.a(new_n44_), .b(new_n87_), .c(new_n93_), .O(z8));
endmodule
