...
module FAU ( 
  ...
  oai22  g30(.a(new_n58_), .b(new_n49_), .c(new_n57_), .d(new_n55_), .O(new_n59_));
  ...
  aoi22  g35(.a(new_n63_), .b(new_n50_), .c(new_n56_), .d(x15), .O(new_n64_));
  ...
  nand2  g58(.a(new_n38_), .b(x06), .O(new_n87_));
