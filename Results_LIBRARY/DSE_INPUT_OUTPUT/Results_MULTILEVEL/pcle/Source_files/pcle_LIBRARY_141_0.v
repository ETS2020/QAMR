...
module FAU ( 
  ...
  aoi21  g36(.a(new_n64_), .b(new_n61_), .c(new_n51_), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n30_), .c(new_n50_), .O(new_n66_));
  ...
  nor2   g51(.a(x16), .b(new_n71_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n79_), .c(x14), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n78_), .c(new_n51_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n30_), .c(new_n50_), .O(new_n83_));
  nand2  g55(.a(x08), .b(x05), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(x10), .c(new_n84_), .O(z6));
  nand2  g57(.a(new_n50_), .b(new_n31_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(x08), .c(x06), .O(new_n87_));
  nand3  g59(.a(x16), .b(x15), .c(x14), .O(new_n88_));
  inv1   g60(.a(new_n88_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n79_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(x17), .c(new_n31_), .d(x09), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(x08), .c(new_n87_), .O(z7));
  oai21  g64(.a(new_n88_), .b(new_n60_), .c(x18), .O(new_n93_));
  nand4  g65(.a(new_n29_), .b(x16), .c(x15), .d(x14), .O(new_n94_));
  oai22  g66(.a(new_n94_), .b(new_n60_), .c(new_n93_), .d(new_n50_), .O(new_n95_));
  nand3  g67(.a(new_n95_), .b(x09), .c(new_n30_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(x17), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(new_n31_), .O(new_n98_));
