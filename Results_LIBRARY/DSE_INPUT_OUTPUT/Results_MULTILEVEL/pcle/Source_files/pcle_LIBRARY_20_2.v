...
module FAU ( 
  ...
  nand3  g21(.a(new_n49_), .b(x13), .c(new_n29_), .O(new_n50_));
  ...
  nand2  g28(.a(x14), .b(x09), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(x08), .c(new_n29_), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(new_n51_), .O(new_n59_));
  nand2  g31(.a(new_n33_), .b(x14), .O(new_n60_));
  ...
  nand3  g37(.a(new_n65_), .b(new_n64_), .c(new_n59_), .O(z4));
  ...
  oai22  g43(.a(new_n71_), .b(new_n33_), .c(new_n70_), .d(new_n68_), .O(new_n72_));
  ...
  nand2  g56(.a(new_n84_), .b(new_n51_), .O(new_n85_));
  nand3  g57(.a(x16), .b(x15), .c(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n33_), .c(x17), .O(new_n87_));
  ...
  nor2   g68(.a(new_n78_), .b(new_n68_), .O(new_n97_));
  nor2   g69(.a(x18), .b(new_n88_), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(new_n97_), .c(new_n70_), .O(new_n99_));
  nand2  g71(.a(new_n99_), .b(new_n96_), .O(new_n100_));
  nand4  g72(.a(new_n100_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n101_));
