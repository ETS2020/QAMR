...
module FAU ( 
  ...
  aoi22  g38(.a(new_n66_), .b(new_n52_), .c(new_n57_), .d(x15), .O(new_n67_));
  nand2  g39(.a(x15), .b(new_n59_), .O(new_n68_));
  oai21  g40(.a(new_n67_), .b(new_n59_), .c(new_n68_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n70_));
  aoi21  g42(.a(x08), .b(x04), .c(new_n63_), .O(new_n71_));
  ...
  aoi21  g50(.a(x08), .b(x05), .c(new_n63_), .O(new_n79_));
