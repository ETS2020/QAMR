...
module FAU ( 
  ...
  oai21  g34(.a(new_n56_), .b(new_n55_), .c(new_n62_), .O(z4));
  ...
  oai21  g58(.a(new_n56_), .b(new_n80_), .c(new_n86_), .O(z7));
  ...
  oai21  g66(.a(new_n56_), .b(new_n88_), .c(new_n94_), .O(z8));
endmodule
