...
module FAU ( 
  ...
  oai21  g11(.a(new_n39_), .b(x11), .c(x08), .O(new_n40_));
  nor2   g12(.a(x14), .b(x11), .O(new_n41_));
  ...
  nor2   g17(.a(new_n39_), .b(x11), .O(new_n46_));
  ...
  inv1   g22(.a(x11), .O(new_n51_));
  xnor2a g23(.a(x13), .b(x12), .O(new_n52_));
  nand3  g24(.a(new_n39_), .b(x13), .c(new_n51_), .O(new_n53_));
  ...
  nand3  g31(.a(new_n39_), .b(x13), .c(x12), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n59_), .c(new_n51_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n57_), .O(z4));
  inv1   g35(.a(x15), .O(new_n64_));
  nand3  g36(.a(new_n58_), .b(x15), .c(x11), .O(new_n65_));
  nand3  g37(.a(new_n64_), .b(x13), .c(x12), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x14), .O(new_n68_));
  oai21  g40(.a(new_n64_), .b(x14), .c(new_n68_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n70_));
  aoi21  g42(.a(x08), .b(x04), .c(new_n46_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n70_), .O(z5));
  nand2  g44(.a(new_n49_), .b(x05), .O(new_n73_));
  ...
  oai21  g51(.a(new_n74_), .b(x14), .c(new_n79_), .O(new_n80_));
  ...
  nand2  g62(.a(x17), .b(new_n39_), .O(new_n91_));
