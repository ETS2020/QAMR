...
module FAU ( 
  ...
  oai21  g33(.a(new_n39_), .b(new_n55_), .c(new_n61_), .O(z4));
  ...
  nor2   g53(.a(new_n64_), .b(new_n58_), .O(new_n82_));
  nor2   g54(.a(x17), .b(new_n74_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n56_), .c(new_n81_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n31_), .c(x09), .O(new_n86_));
