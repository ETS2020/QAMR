...
module FAU ( 
  ...
  nand4  g56(.a(x13), .b(x12), .c(x11), .d(new_n29_), .O(new_n85_));
  nand4  g57(.a(new_n30_), .b(x16), .c(x15), .d(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n85_), .c(new_n84_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(x09), .c(new_n31_), .O(new_n88_));
  aoi21  g60(.a(x08), .b(x06), .c(new_n42_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n88_), .O(z7));
  nand4  g62(.a(new_n36_), .b(new_n38_), .c(x16), .d(x15), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n34_), .c(new_n29_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(x17), .O(new_n93_));
  nand4  g65(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n94_));
  inv1   g66(.a(new_n94_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n61_), .c(new_n38_), .O(new_n96_));
