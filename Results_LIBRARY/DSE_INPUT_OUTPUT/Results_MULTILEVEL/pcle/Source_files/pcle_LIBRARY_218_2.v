...
module FAU ( 
  ...
  nand2  g11(.a(new_n39_), .b(x10), .O(new_n40_));
  ...
  oai21  g17(.a(new_n41_), .b(new_n38_), .c(new_n45_), .O(z1));
  ...
  nand2  g34(.a(new_n59_), .b(x13), .O(new_n63_));
  ...
  oai21  g37(.a(new_n41_), .b(new_n58_), .c(new_n65_), .O(z4));
  ...
  oai21  g53(.a(new_n41_), .b(new_n75_), .c(new_n81_), .O(z6));
  nand3  g54(.a(new_n44_), .b(x12), .c(x11), .O(new_n83_));
  nor2   g55(.a(new_n78_), .b(new_n67_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(x14), .c(x13), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n83_), .c(new_n31_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n39_), .O(new_n87_));
  nand2  g59(.a(new_n84_), .b(x14), .O(new_n88_));
  inv1   g60(.a(new_n88_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n61_), .c(new_n39_), .O(new_n90_));
  ...
  nand4  g68(.a(new_n84_), .b(new_n69_), .c(new_n29_), .d(x17), .O(new_n97_));
  nand2  g69(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n99_));
  oai21  g71(.a(new_n41_), .b(new_n94_), .c(new_n99_), .O(z8));
endmodule
