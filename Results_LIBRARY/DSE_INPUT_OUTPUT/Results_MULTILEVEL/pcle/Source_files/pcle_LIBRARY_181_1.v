...
module FAU ( 
  ...
  aoi21  g16(.a(x17), .b(new_n38_), .c(new_n30_), .O(new_n45_));
  ...
  aoi22  g26(.a(x17), .b(new_n38_), .c(x08), .d(x02), .O(new_n55_));
  ...
  nand3  g46(.a(new_n39_), .b(x15), .c(new_n38_), .O(new_n75_));
  ...
  nand3  g57(.a(new_n39_), .b(x16), .c(new_n38_), .O(new_n86_));
  ...
  oai21  g63(.a(new_n91_), .b(new_n60_), .c(x17), .O(new_n92_));
  nand3  g64(.a(x14), .b(x13), .c(x12), .O(new_n93_));
  nand3  g65(.a(new_n39_), .b(x16), .c(x15), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(x11), .c(new_n31_), .d(x09), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(x08), .c(new_n90_), .O(z7));
  nand2  g69(.a(new_n45_), .b(x07), .O(new_n98_));
  oai21  g70(.a(new_n91_), .b(new_n60_), .c(x18), .O(new_n99_));
  nand4  g71(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n100_));
  oai21  g72(.a(new_n100_), .b(new_n93_), .c(new_n99_), .O(new_n101_));
  nand2  g73(.a(new_n101_), .b(x11), .O(new_n102_));
  nand2  g74(.a(x18), .b(new_n39_), .O(new_n103_));
