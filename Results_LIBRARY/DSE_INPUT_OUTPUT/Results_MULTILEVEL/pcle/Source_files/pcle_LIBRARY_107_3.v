...
module FAU ( 
  ...
  nand2  g10(.a(new_n38_), .b(x08), .O(new_n39_));
  ...
  nand2  g17(.a(new_n45_), .b(new_n41_), .O(z1));
  ...
  nand3  g21(.a(new_n49_), .b(new_n48_), .c(new_n38_), .O(z2));
  ...
  nand2  g30(.a(new_n40_), .b(x03), .O(new_n59_));
  inv1   g31(.a(x14), .O(new_n60_));
  nand3  g32(.a(x13), .b(x12), .c(x11), .O(new_n61_));
  inv1   g33(.a(new_n61_), .O(new_n62_));
  nand2  g34(.a(new_n60_), .b(x13), .O(new_n63_));
  oai22  g35(.a(new_n63_), .b(new_n53_), .c(new_n62_), .d(new_n60_), .O(new_n64_));
  ...
  nor2   g39(.a(x15), .b(new_n52_), .O(new_n68_));
  aoi22  g40(.a(new_n68_), .b(new_n54_), .c(new_n61_), .d(x15), .O(new_n69_));
  nand2  g41(.a(x15), .b(new_n60_), .O(new_n70_));
  oai21  g42(.a(new_n69_), .b(new_n60_), .c(new_n70_), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n67_), .O(z5));
  and2   g45(.a(x15), .b(x14), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n54_), .c(x13), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(x16), .O(new_n76_));
  nand2  g48(.a(new_n54_), .b(new_n31_), .O(new_n77_));
  inv1   g49(.a(x16), .O(new_n78_));
  nor2   g50(.a(new_n60_), .b(new_n52_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n78_), .c(x15), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n77_), .c(new_n76_), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(x09), .c(new_n30_), .O(new_n82_));
  nand2  g54(.a(x08), .b(x05), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n82_), .c(new_n38_), .O(z6));
  ...
  nand3  g60(.a(new_n74_), .b(new_n88_), .c(x16), .O(new_n89_));
  ...
  nand2  g64(.a(new_n54_), .b(new_n43_), .O(new_n93_));
  nand4  g65(.a(new_n79_), .b(new_n29_), .c(x17), .d(x15), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n93_), .c(new_n31_), .O(new_n95_));
  nand2  g67(.a(new_n95_), .b(x16), .O(new_n96_));
  nand3  g68(.a(new_n74_), .b(x17), .c(x16), .O(new_n97_));
  inv1   g69(.a(new_n97_), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n62_), .c(new_n29_), .O(new_n99_));
