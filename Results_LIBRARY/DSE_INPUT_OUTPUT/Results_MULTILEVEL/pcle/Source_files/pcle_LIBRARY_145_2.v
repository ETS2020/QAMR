...
module FAU ( 
  ...
  nand2  g17(.a(new_n33_), .b(x03), .O(new_n46_));
  ...
  oai21  g31(.a(new_n33_), .b(x08), .c(x03), .O(new_n60_));
  nand3  g32(.a(x13), .b(x12), .c(x11), .O(new_n61_));
  inv1   g33(.a(new_n61_), .O(new_n62_));
  nand2  g34(.a(new_n30_), .b(x13), .O(new_n63_));
  oai22  g35(.a(new_n63_), .b(new_n52_), .c(new_n62_), .d(new_n30_), .O(new_n64_));
  ...
  nor2   g40(.a(x15), .b(new_n30_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(x13), .c(x12), .d(x11), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n68_), .c(new_n51_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n32_), .c(x03), .O(new_n72_));
  ...
  nand4  g49(.a(new_n62_), .b(new_n77_), .c(x15), .d(x14), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n76_), .c(new_n51_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n32_), .c(x03), .O(new_n80_));
  ...
  nand4  g57(.a(new_n85_), .b(new_n62_), .c(x15), .d(x14), .O(new_n86_));
  ...
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n29_), .d(x17), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n92_), .c(new_n51_), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n32_), .c(x03), .O(new_n97_));
