...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(x07), .c(new_n30_), .O(new_n39_));
  nand2  g11(.a(new_n39_), .b(x00), .O(new_n40_));
  inv1   g12(.a(x11), .O(new_n41_));
  nor2   g13(.a(new_n38_), .b(x08), .O(new_n42_));
  nand3  g14(.a(new_n42_), .b(new_n41_), .c(new_n31_), .O(new_n43_));
  ...
  aoi22  g59(.a(new_n38_), .b(x07), .c(x08), .d(x06), .O(new_n88_));
  ...
  oai21  g68(.a(new_n42_), .b(new_n90_), .c(new_n96_), .O(z8));
endmodule
