...
module FAU ( 
  ...
  nand2  g38(.a(new_n45_), .b(x03), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(x08), .c(x04), .O(new_n68_));
  nand2  g40(.a(new_n32_), .b(x15), .O(new_n69_));
  ...
  nand2  g45(.a(x15), .b(new_n61_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n73_), .c(x10), .O(new_n75_));
  nand4  g47(.a(new_n75_), .b(x09), .c(new_n41_), .d(new_n29_), .O(new_n76_));
  ...
  aoi21  g54(.a(new_n82_), .b(new_n41_), .c(x03), .O(new_n83_));
  ...
  aoi21  g62(.a(new_n90_), .b(new_n41_), .c(x03), .O(new_n91_));
  ...
  nor2   g67(.a(new_n80_), .b(new_n70_), .O(new_n96_));
  ...
  aoi21  g73(.a(new_n101_), .b(new_n41_), .c(x03), .O(new_n102_));
