...
module FAU ( 
  ...
  nand2  g18(.a(new_n39_), .b(x00), .O(new_n47_));
  nand3  g19(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(z2));
  inv1   g20(.a(x02), .O(new_n49_));
  nand2  g21(.a(new_n47_), .b(x08), .O(new_n50_));
  ...
  nor2   g37(.a(x15), .b(new_n51_), .O(new_n66_));
  aoi22  g38(.a(new_n66_), .b(new_n53_), .c(new_n59_), .d(x15), .O(new_n67_));
  nand2  g39(.a(x15), .b(new_n61_), .O(new_n68_));
  oai21  g40(.a(new_n67_), .b(new_n61_), .c(new_n68_), .O(new_n69_));
  ...
  aoi21  g59(.a(x08), .b(x06), .c(new_n71_), .O(new_n88_));
  ...
  aoi21  g68(.a(x08), .b(x07), .c(new_n71_), .O(new_n97_));
