...
module FAU ( 
  ...
  oai21  g16(.a(new_n33_), .b(x08), .c(x01), .O(new_n45_));
  ...
  aoi21  g26(.a(new_n54_), .b(new_n32_), .c(x01), .O(new_n55_));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n32_), .c(x01), .O(new_n63_));
  ...
  aoi21  g42(.a(new_n70_), .b(new_n32_), .c(x01), .O(new_n71_));
  ...
  oai22  g52(.a(new_n80_), .b(x01), .c(new_n41_), .d(new_n74_), .O(z6));
  ...
  nand4  g57(.a(new_n85_), .b(new_n84_), .c(x15), .d(x14), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n83_), .c(new_n49_), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n32_), .c(x01), .O(new_n88_));
  ...
  oai21  g70(.a(new_n41_), .b(new_n91_), .c(new_n98_), .O(z8));
endmodule
