...
module FAU ( 
  ...
  oai21  g43(.a(x10), .b(x05), .c(x08), .O(new_n72_));
  oai21  g44(.a(new_n36_), .b(new_n31_), .c(x16), .O(new_n73_));
  nand3  g45(.a(new_n33_), .b(x15), .c(x14), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n55_), .c(new_n73_), .O(new_n75_));
  ...
  oai21  g52(.a(new_n80_), .b(new_n55_), .c(new_n79_), .O(new_n81_));
