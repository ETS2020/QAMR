...
module FAU ( 
  ...
  nand2  g12(.a(new_n40_), .b(x04), .O(new_n41_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n62_), .c(new_n52_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n31_), .c(new_n51_), .O(new_n65_));
  ...
  aoi21  g44(.a(new_n72_), .b(x09), .c(new_n51_), .O(new_n73_));
  oai22  g45(.a(new_n73_), .b(x10), .c(new_n31_), .d(new_n51_), .O(z5));
  nand2  g46(.a(new_n32_), .b(new_n51_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(x08), .c(x05), .O(new_n76_));
  ...
  nand4  g53(.a(new_n81_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n51_), .c(new_n76_), .O(z6));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n85_), .c(new_n52_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n31_), .c(new_n51_), .O(new_n90_));
  ...
  aoi21  g68(.a(new_n96_), .b(new_n94_), .c(new_n52_), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n31_), .c(new_n51_), .O(new_n98_));
