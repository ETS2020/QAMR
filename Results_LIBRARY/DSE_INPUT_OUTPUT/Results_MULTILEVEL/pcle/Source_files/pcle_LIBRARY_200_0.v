...
module FAU ( 
  ...
  oai21  g16(.a(x18), .b(x10), .c(x08), .O(new_n45_));
  ...
  aoi21  g33(.a(new_n61_), .b(new_n59_), .c(new_n49_), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n30_), .c(new_n29_), .O(new_n63_));
  ...
  oai21  g42(.a(new_n70_), .b(new_n50_), .c(new_n68_), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(x18), .c(new_n31_), .d(x09), .O(new_n72_));
  oai22  g44(.a(new_n72_), .b(x08), .c(new_n45_), .d(new_n66_), .O(z5));
  ...
  nand4  g51(.a(new_n79_), .b(x18), .c(new_n31_), .d(x09), .O(new_n80_));
  oai22  g52(.a(new_n80_), .b(x08), .c(new_n45_), .d(new_n74_), .O(z6));
  nand3  g53(.a(x16), .b(x15), .c(x14), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n58_), .c(x17), .O(new_n83_));
  inv1   g55(.a(new_n58_), .O(new_n84_));
  nor2   g56(.a(new_n69_), .b(new_n60_), .O(new_n85_));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n30_), .c(new_n29_), .O(new_n89_));
  nand2  g61(.a(x08), .b(x06), .O(new_n90_));
  oai21  g62(.a(new_n89_), .b(x10), .c(new_n90_), .O(z7));
  nand2  g63(.a(new_n83_), .b(x17), .O(new_n92_));
