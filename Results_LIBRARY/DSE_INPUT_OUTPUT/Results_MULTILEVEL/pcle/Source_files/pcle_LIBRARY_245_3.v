...
module FAU ( 
  ...
  oai21  g11(.a(new_n31_), .b(new_n39_), .c(x08), .O(new_n40_));
  ...
  oai21  g33(.a(new_n40_), .b(new_n54_), .c(new_n61_), .O(z4));
  ...
  oai22  g38(.a(new_n66_), .b(new_n57_), .c(new_n65_), .d(new_n63_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n30_), .c(x10), .O(new_n68_));
  nand2  g40(.a(x08), .b(x04), .O(new_n69_));
  oai21  g41(.a(new_n68_), .b(new_n39_), .c(new_n69_), .O(z5));
  ...
  oai21  g49(.a(new_n40_), .b(new_n71_), .c(new_n77_), .O(z6));
