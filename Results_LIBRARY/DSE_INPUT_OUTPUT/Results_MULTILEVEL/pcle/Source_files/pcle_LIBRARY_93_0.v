...
module FAU ( 
  ...
  aoi21  g28(.a(new_n56_), .b(new_n30_), .c(new_n39_), .O(new_n57_));
  ...
  nand2  g45(.a(x15), .b(new_n63_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n73_), .c(new_n39_), .O(new_n75_));
  ...
  oai21  g51(.a(new_n79_), .b(new_n52_), .c(x16), .O(new_n80_));
  ...
  nand4  g55(.a(new_n83_), .b(x17), .c(new_n31_), .d(x09), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(x08), .c(new_n78_), .O(z6));
  nand2  g57(.a(new_n40_), .b(x06), .O(new_n86_));
  nand3  g58(.a(x16), .b(x15), .c(x14), .O(new_n87_));
  or2    g59(.a(new_n87_), .b(new_n61_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(x17), .c(new_n31_), .d(x09), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(x08), .c(new_n86_), .O(z7));
  ...
  oai21  g65(.a(new_n93_), .b(new_n61_), .c(new_n92_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(x17), .c(new_n31_), .d(x09), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(x08), .c(new_n91_), .O(z8));
endmodule
