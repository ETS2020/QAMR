...
module FAU ( 
  ...
  nand4  g18(.a(new_n46_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n47_));
  ...
  nand4  g34(.a(new_n62_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n63_));
  ...
  nand4  g44(.a(new_n72_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n73_));
  ...
  nand4  g50(.a(new_n78_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n79_));
  ...
  nand4  g59(.a(new_n87_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n82_), .O(z7));
  oai21  g61(.a(x10), .b(x08), .c(x07), .O(new_n90_));
  ...
  nand4  g69(.a(new_n97_), .b(new_n40_), .c(x09), .d(new_n30_), .O(new_n98_));
