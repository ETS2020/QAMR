...
module FAU ( 
  ...
  oai21  g23(.a(new_n39_), .b(new_n47_), .c(new_n51_), .O(z3));
  ...
  aoi21  g29(.a(new_n57_), .b(new_n55_), .c(x08), .O(new_n58_));
  oai21  g30(.a(new_n58_), .b(new_n53_), .c(new_n31_), .O(new_n59_));
  ...
  oai21  g41(.a(new_n39_), .b(new_n62_), .c(new_n69_), .O(z5));
  inv1   g42(.a(x05), .O(new_n71_));
  nand3  g43(.a(x15), .b(x14), .c(x13), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n64_), .c(x16), .O(new_n73_));
  ...
  oai21  g57(.a(new_n39_), .b(new_n79_), .c(new_n85_), .O(z7));
  nand4  g58(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n54_), .c(x18), .O(new_n88_));
  nor2   g60(.a(new_n74_), .b(new_n63_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n66_), .c(new_n29_), .d(x17), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(x08), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n53_), .c(new_n31_), .O(new_n92_));
