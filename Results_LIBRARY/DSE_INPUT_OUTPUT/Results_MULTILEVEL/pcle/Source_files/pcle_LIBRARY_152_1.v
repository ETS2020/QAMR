...
module FAU ( 
  ...
  inv1   g33(.a(new_n40_), .O(new_n62_));
  ...
  oai22  g41(.a(new_n69_), .b(new_n57_), .c(new_n68_), .d(new_n66_), .O(new_n70_));
  ...
  nand3  g51(.a(new_n79_), .b(new_n73_), .c(new_n40_), .O(z6));
  ...
  nor2   g62(.a(new_n76_), .b(new_n66_), .O(new_n91_));
