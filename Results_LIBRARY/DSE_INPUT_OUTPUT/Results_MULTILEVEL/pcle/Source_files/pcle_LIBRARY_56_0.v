...
module FAU ( 
  ...
  oai21  g12(.a(x10), .b(x02), .c(x08), .O(new_n41_));
  ...
  nand4  g23(.a(new_n51_), .b(new_n44_), .c(x09), .d(new_n42_), .O(new_n52_));
  oai21  g24(.a(new_n52_), .b(new_n48_), .c(new_n50_), .O(z2));
  inv1   g25(.a(x12), .O(new_n54_));
  nand3  g26(.a(x13), .b(new_n54_), .c(new_n42_), .O(new_n55_));
  ...
  nand2  g31(.a(x13), .b(new_n45_), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n44_), .c(x09), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n42_), .c(new_n48_), .O(z3));
  ...
  aoi21  g39(.a(new_n67_), .b(new_n42_), .c(new_n48_), .O(new_n68_));
  ...
  nand4  g44(.a(new_n65_), .b(new_n33_), .c(x14), .d(x13), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n72_), .c(new_n29_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n42_), .c(new_n48_), .O(new_n75_));
  nand2  g47(.a(x08), .b(x04), .O(new_n76_));
  oai21  g48(.a(new_n75_), .b(x10), .c(new_n76_), .O(z5));
  nand2  g49(.a(new_n49_), .b(x05), .O(new_n78_));
  nand2  g50(.a(x12), .b(x11), .O(new_n79_));
  nand3  g51(.a(x15), .b(x14), .c(x13), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n79_), .c(x16), .O(new_n81_));
  inv1   g53(.a(x16), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n30_), .c(new_n81_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n44_), .c(x09), .d(new_n42_), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n48_), .c(new_n78_), .O(z6));
  nand2  g58(.a(new_n49_), .b(x06), .O(new_n87_));
  ...
  nand4  g63(.a(new_n91_), .b(new_n44_), .c(x09), .d(new_n42_), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n48_), .c(new_n87_), .O(z7));
  ...
  inv1   g68(.a(new_n71_), .O(new_n97_));
  nor2   g69(.a(new_n82_), .b(new_n33_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n97_), .c(new_n36_), .d(x17), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n96_), .c(x10), .O(new_n100_));
  nand4  g72(.a(new_n100_), .b(x09), .c(new_n42_), .d(x02), .O(new_n101_));
