...
module FAU ( 
  ...
  nor3   g08(.a(x17), .b(x11), .c(x10), .O(new_n37_));
  ...
  aoi21  g23(.a(new_n51_), .b(new_n49_), .c(x17), .O(new_n52_));
  ...
  aoi21  g42(.a(new_n70_), .b(new_n69_), .c(x17), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n64_), .O(z5));
  nand2  g45(.a(new_n33_), .b(x05), .O(new_n74_));
  nand3  g46(.a(x15), .b(x14), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n48_), .c(x16), .O(new_n76_));
  ...
  nand4  g51(.a(new_n79_), .b(new_n40_), .c(new_n29_), .d(x09), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(x08), .c(new_n74_), .O(z6));
  nand2  g53(.a(new_n33_), .b(x06), .O(new_n82_));
  nand3  g54(.a(new_n59_), .b(new_n36_), .c(new_n29_), .O(new_n83_));
  nor2   g55(.a(new_n58_), .b(new_n50_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n40_), .c(x16), .d(x15), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n83_), .c(new_n82_), .O(z7));
  nand2  g58(.a(new_n33_), .b(x07), .O(new_n87_));
  nand4  g59(.a(new_n36_), .b(x18), .c(new_n40_), .d(new_n29_), .O(new_n88_));
