...
module FAU ( 
  ...
  oai22  g46(.a(new_n74_), .b(new_n51_), .c(new_n41_), .d(new_n68_), .O(z5));
  ...
  oai22  g63(.a(new_n91_), .b(new_n51_), .c(new_n41_), .d(new_n84_), .O(z7));
  nand3  g64(.a(new_n87_), .b(x17), .c(x16), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n61_), .c(x18), .O(new_n94_));
  nor2   g66(.a(new_n79_), .b(new_n69_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n71_), .c(new_n29_), .d(x17), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand3  g69(.a(new_n97_), .b(new_n32_), .c(x09), .O(new_n98_));
  aoi21  g70(.a(new_n98_), .b(new_n31_), .c(new_n51_), .O(z8));
endmodule
