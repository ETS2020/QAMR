...
module FAU ( 
  ...
  nand4  g06(.a(new_n34_), .b(new_n29_), .c(x09), .d(new_n32_), .O(new_n35_));
  ...
  nand2  g51(.a(new_n40_), .b(x06), .O(new_n80_));
  ...
  nor2   g62(.a(new_n58_), .b(new_n50_), .O(new_n91_));
  nor2   g63(.a(x18), .b(new_n83_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n34_), .O(new_n93_));
