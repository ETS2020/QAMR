...
module FAU ( 
  ...
  oai21  g28(.a(x10), .b(x03), .c(x08), .O(new_n57_));
  ...
  nand3  g35(.a(new_n63_), .b(new_n57_), .c(new_n40_), .O(z4));
  ...
  oai21  g51(.a(new_n41_), .b(new_n73_), .c(new_n79_), .O(z6));
  ...
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n40_), .O(z7));
