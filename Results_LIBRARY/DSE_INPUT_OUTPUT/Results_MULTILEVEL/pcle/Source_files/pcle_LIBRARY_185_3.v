...
module FAU ( 
  ...
  oai21  g11(.a(x09), .b(x08), .c(x00), .O(new_n40_));
  ...
  nand3  g16(.a(new_n44_), .b(new_n33_), .c(new_n32_), .O(new_n45_));
  ...
  oai21  g23(.a(new_n51_), .b(new_n31_), .c(x08), .O(new_n52_));
  ...
  oai21  g30(.a(new_n52_), .b(new_n50_), .c(new_n58_), .O(z3));
  ...
  oai21  g38(.a(new_n52_), .b(new_n60_), .c(new_n66_), .O(z4));
  ...
  aoi21  g43(.a(new_n71_), .b(new_n69_), .c(x10), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n32_), .c(x00), .O(new_n73_));
  nand2  g45(.a(x08), .b(x04), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(new_n51_), .c(new_n74_), .O(z5));
  ...
  aoi21  g53(.a(new_n81_), .b(new_n32_), .c(x00), .O(new_n82_));
  nand2  g54(.a(x08), .b(x05), .O(new_n83_));
  oai21  g55(.a(new_n82_), .b(new_n51_), .c(new_n83_), .O(z6));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n86_), .c(x10), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n32_), .c(x00), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(new_n51_), .c(new_n91_), .O(z7));
