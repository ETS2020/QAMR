...
module FAU ( 
  ...
  oai21  g33(.a(x10), .b(x07), .c(x08), .O(new_n62_));
  nand3  g34(.a(x13), .b(x12), .c(x11), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(x14), .O(new_n64_));
  inv1   g36(.a(new_n53_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n30_), .c(x13), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n64_), .c(x10), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(x09), .c(new_n31_), .d(x07), .O(new_n68_));
  oai21  g40(.a(new_n62_), .b(new_n61_), .c(new_n68_), .O(z4));
  nand4  g41(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(x15), .O(new_n71_));
  inv1   g43(.a(x15), .O(new_n72_));
  nand4  g44(.a(new_n65_), .b(new_n72_), .c(x14), .d(x13), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n71_), .c(new_n52_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n31_), .c(new_n51_), .O(new_n75_));
  ...
  oai21  g54(.a(new_n82_), .b(new_n63_), .c(new_n80_), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n84_));
  oai22  g56(.a(new_n84_), .b(new_n51_), .c(new_n62_), .d(new_n78_), .O(z6));
  ...
  oai21  g62(.a(new_n90_), .b(new_n63_), .c(new_n88_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n92_));
  oai22  g64(.a(new_n92_), .b(new_n51_), .c(new_n62_), .d(new_n86_), .O(z7));
  oai21  g65(.a(new_n32_), .b(x07), .c(x08), .O(new_n94_));
  nand4  g66(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n63_), .c(x18), .O(new_n96_));
  inv1   g68(.a(new_n70_), .O(new_n97_));
  nor2   g69(.a(new_n81_), .b(new_n72_), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(new_n97_), .c(new_n29_), .d(x17), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n96_), .c(new_n52_), .O(new_n100_));
  oai21  g72(.a(new_n100_), .b(new_n51_), .c(new_n32_), .O(new_n101_));
