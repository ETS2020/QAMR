...
module FAU ( 
  ...
  oai21  g26(.a(new_n54_), .b(x10), .c(new_n41_), .O(new_n55_));
  ...
  oai21  g32(.a(new_n60_), .b(new_n50_), .c(new_n59_), .O(new_n61_));
  ...
  nand2  g40(.a(x15), .b(new_n32_), .O(new_n69_));
  ...
  nor2   g63(.a(new_n76_), .b(new_n33_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n36_), .c(x17), .O(new_n93_));
