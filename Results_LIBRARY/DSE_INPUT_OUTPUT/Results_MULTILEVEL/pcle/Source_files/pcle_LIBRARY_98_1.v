...
module FAU ( 
  ...
  nand2  g28(.a(new_n32_), .b(x13), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n59_));
  ...
  nand4  g39(.a(new_n67_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n68_));
  ...
  aoi21  g66(.a(new_n94_), .b(new_n89_), .c(new_n87_), .O(new_n95_));
