...
module FAU ( 
  ...
  aoi21  g21(.a(new_n33_), .b(x00), .c(new_n32_), .O(new_n50_));
  ...
  nand2  g30(.a(new_n50_), .b(x03), .O(new_n59_));
  ...
  nand2  g37(.a(new_n50_), .b(x04), .O(new_n66_));
  ...
  nand2  g43(.a(x15), .b(new_n30_), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n71_), .c(x10), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(x09), .c(new_n32_), .d(new_n31_), .O(new_n74_));
  ...
  oai21  g54(.a(new_n82_), .b(x00), .c(new_n76_), .O(z6));
  ...
  aoi21  g61(.a(new_n89_), .b(new_n86_), .c(new_n84_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n32_), .c(x00), .O(new_n91_));
  ...
  nor2   g67(.a(new_n79_), .b(new_n68_), .O(new_n96_));
  ...
  aoi21  g71(.a(new_n99_), .b(new_n95_), .c(new_n84_), .O(new_n100_));
  aoi21  g72(.a(new_n100_), .b(new_n32_), .c(x00), .O(new_n101_));
