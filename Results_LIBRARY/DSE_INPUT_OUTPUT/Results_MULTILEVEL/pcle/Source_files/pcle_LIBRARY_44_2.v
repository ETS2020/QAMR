...
module FAU ( 
  ...
  nand4  g17(.a(new_n45_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n46_));
  nand3  g18(.a(x10), .b(x08), .c(x01), .O(new_n47_));
  oai21  g19(.a(new_n46_), .b(x01), .c(new_n47_), .O(z2));
  inv1   g20(.a(x02), .O(new_n49_));
  oai21  g21(.a(new_n32_), .b(new_n49_), .c(x10), .O(new_n50_));
  ...
  nand4  g28(.a(new_n56_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n57_));
  nand3  g29(.a(x08), .b(x02), .c(new_n31_), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n57_), .c(new_n51_), .O(z3));
  inv1   g31(.a(x09), .O(new_n60_));
  nand3  g32(.a(x13), .b(x12), .c(x11), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(x14), .O(new_n62_));
  nand3  g34(.a(new_n54_), .b(new_n30_), .c(x13), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n62_), .c(new_n60_), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n32_), .c(x01), .O(new_n65_));
  ...
  nand4  g59(.a(new_n87_), .b(new_n79_), .c(x15), .d(x14), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n86_), .c(new_n60_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n32_), .c(x01), .O(new_n90_));
  ...
  oai21  g66(.a(new_n94_), .b(new_n61_), .c(x18), .O(new_n95_));
  nor2   g67(.a(new_n78_), .b(new_n69_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n71_), .c(new_n29_), .d(x17), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n95_), .c(x10), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(x09), .c(new_n32_), .d(new_n31_), .O(new_n99_));
  oai21  g71(.a(new_n41_), .b(new_n93_), .c(new_n99_), .O(z8));
endmodule
