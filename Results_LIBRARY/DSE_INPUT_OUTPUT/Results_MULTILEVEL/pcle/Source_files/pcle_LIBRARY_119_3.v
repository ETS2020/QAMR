...
module FAU ( 
  ...
  nand4  g03(.a(x13), .b(x11), .c(x09), .d(new_n31_), .O(new_n32_));
  ...
  aoi21  g13(.a(x12), .b(x10), .c(new_n31_), .O(new_n42_));
  ...
  nand2  g24(.a(x13), .b(new_n30_), .O(new_n53_));
  oai21  g25(.a(new_n52_), .b(new_n30_), .c(new_n53_), .O(new_n54_));
  ...
  oai22  g33(.a(new_n61_), .b(new_n60_), .c(new_n59_), .d(new_n34_), .O(new_n62_));
  ...
  nand4  g38(.a(new_n35_), .b(x13), .c(x12), .d(x11), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(x14), .O(new_n69_));
  nand2  g41(.a(x15), .b(new_n34_), .O(new_n70_));
  ...
  nand2  g45(.a(new_n42_), .b(x05), .O(new_n74_));
  nand3  g46(.a(x15), .b(x14), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n60_), .c(x16), .O(new_n76_));
  ...
  nand4  g51(.a(new_n79_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n74_), .O(z6));
  nand3  g53(.a(new_n36_), .b(new_n37_), .c(x16), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n32_), .c(new_n29_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(x12), .O(new_n84_));
  nand3  g56(.a(x16), .b(x15), .c(x14), .O(new_n85_));
  inv1   g57(.a(new_n85_), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n59_), .c(new_n37_), .O(new_n87_));
  ...
  nand3  g67(.a(new_n95_), .b(new_n38_), .c(x17), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n94_), .c(new_n93_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n98_));
