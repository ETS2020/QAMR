...
module FAU ( 
  ...
  nand2  g36(.a(new_n49_), .b(x04), .O(new_n65_));
  ...
  nand4  g43(.a(new_n71_), .b(new_n51_), .c(x09), .d(new_n29_), .O(new_n72_));
  ...
  aoi21  g50(.a(new_n78_), .b(new_n29_), .c(new_n39_), .O(new_n79_));
  ...
  aoi21  g58(.a(new_n86_), .b(new_n29_), .c(new_n39_), .O(new_n87_));
  ...
  nor2   g63(.a(new_n76_), .b(new_n34_), .O(new_n92_));
  ...
  aoi21  g68(.a(new_n96_), .b(new_n91_), .c(x08), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n39_), .c(new_n51_), .O(new_n98_));
