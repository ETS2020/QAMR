...
module FAU ( 
  ...
  nor3   g07(.a(x15), .b(x11), .c(x10), .O(new_n36_));
  nand2  g08(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  nand2  g09(.a(new_n37_), .b(new_n33_), .O(z1));
  nand2  g10(.a(new_n32_), .b(x01), .O(new_n39_));
  inv1   g11(.a(x10), .O(new_n40_));
  xor2a  g12(.a(x12), .b(x11), .O(new_n41_));
  nand4  g13(.a(new_n41_), .b(new_n29_), .c(new_n40_), .d(x09), .O(new_n42_));
  oai21  g14(.a(new_n42_), .b(x08), .c(new_n39_), .O(z2));
  ...
  aoi21  g19(.a(new_n47_), .b(new_n45_), .c(new_n34_), .O(new_n48_));
  aoi21  g20(.a(new_n48_), .b(new_n31_), .c(x15), .O(new_n49_));
  ...
  nand4  g29(.a(new_n57_), .b(new_n40_), .c(x09), .d(new_n31_), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(new_n52_), .O(z4));
  nand2  g31(.a(new_n32_), .b(x04), .O(new_n60_));
  nand3  g32(.a(new_n35_), .b(x11), .c(new_n40_), .O(new_n61_));
  nand4  g33(.a(new_n29_), .b(x14), .c(x13), .d(x12), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(z5));
  nand2  g35(.a(x16), .b(x09), .O(new_n64_));
  oai21  g36(.a(new_n64_), .b(x08), .c(new_n29_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n40_), .O(new_n66_));
  nand2  g38(.a(x08), .b(x05), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n66_), .O(z6));
  nand2  g40(.a(x17), .b(x09), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(x08), .c(new_n29_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n40_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x06), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(z7));
  nand2  g45(.a(new_n32_), .b(x07), .O(new_n74_));
  nand4  g46(.a(new_n35_), .b(x18), .c(new_n29_), .d(new_n40_), .O(new_n75_));
