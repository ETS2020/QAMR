...
module FAU ( 
  ...
  oai22  g40(.a(new_n68_), .b(new_n58_), .c(new_n67_), .d(new_n65_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n70_));
  aoi21  g42(.a(x08), .b(x04), .c(new_n53_), .O(new_n71_));
  ...
  oai21  g58(.a(new_n30_), .b(new_n39_), .c(new_n86_), .O(z7));
  ...
  oai21  g66(.a(new_n41_), .b(new_n88_), .c(new_n94_), .O(z8));
endmodule
