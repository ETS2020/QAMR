...
module FAU ( 
  ...
  aoi21  g29(.a(new_n57_), .b(new_n55_), .c(new_n45_), .O(new_n58_));
  aoi21  g30(.a(new_n58_), .b(new_n32_), .c(x18), .O(new_n59_));
  nand2  g31(.a(x08), .b(x03), .O(new_n60_));
  oai21  g32(.a(new_n59_), .b(x10), .c(new_n60_), .O(z4));
  nor2   g33(.a(z0), .b(new_n32_), .O(new_n62_));
  ...
  oai21  g39(.a(new_n67_), .b(new_n46_), .c(new_n65_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n29_), .c(new_n31_), .d(x09), .O(new_n69_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n29_), .c(new_n31_), .d(x09), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(x08), .c(new_n71_), .O(z6));
  nand2  g50(.a(new_n62_), .b(x06), .O(new_n79_));
  ...
  nand4  g56(.a(new_n84_), .b(new_n29_), .c(new_n31_), .d(x09), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(x08), .c(new_n79_), .O(z7));
  nand4  g58(.a(x12), .b(x11), .c(x09), .d(new_n32_), .O(new_n87_));
  inv1   g59(.a(new_n87_), .O(new_n88_));
  nand3  g60(.a(x17), .b(x16), .c(x15), .O(new_n89_));
  nor2   g61(.a(new_n89_), .b(new_n64_), .O(new_n90_));
  aoi21  g62(.a(new_n90_), .b(new_n88_), .c(x18), .O(new_n91_));
