...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(x01), .c(x10), .O(z0));
  ...
  nand3  g21(.a(new_n49_), .b(new_n40_), .c(x09), .O(new_n50_));
  aoi21  g22(.a(new_n50_), .b(new_n41_), .c(new_n48_), .O(z2));
  aoi21  g23(.a(new_n40_), .b(new_n48_), .c(new_n41_), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(x02), .O(new_n53_));
  xnor2a g25(.a(x13), .b(x12), .O(new_n54_));
  nand2  g26(.a(x13), .b(new_n42_), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(new_n42_), .c(new_n55_), .O(new_n56_));
  nand4  g28(.a(new_n56_), .b(new_n40_), .c(x09), .d(new_n41_), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n48_), .c(new_n53_), .O(z3));
  nand2  g30(.a(new_n30_), .b(x14), .O(new_n59_));
  nand2  g31(.a(x12), .b(x11), .O(new_n60_));
  inv1   g32(.a(new_n60_), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n32_), .c(x13), .O(new_n62_));
  aoi21  g34(.a(new_n62_), .b(new_n59_), .c(new_n29_), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n41_), .c(new_n48_), .O(new_n64_));
  ...
  nand4  g40(.a(new_n61_), .b(new_n33_), .c(x14), .d(x13), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n68_), .c(new_n29_), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n41_), .c(new_n48_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x04), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(x10), .c(new_n72_), .O(z5));
  nand3  g45(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n60_), .c(x16), .O(new_n75_));
  inv1   g47(.a(x16), .O(new_n76_));
  inv1   g48(.a(new_n30_), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(new_n76_), .c(x15), .d(x14), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n75_), .c(new_n29_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n41_), .c(new_n48_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x05), .O(new_n81_));
  oai21  g53(.a(new_n80_), .b(x10), .c(new_n81_), .O(z6));
  nand2  g54(.a(new_n52_), .b(x06), .O(new_n83_));
  ...
  oai21  g58(.a(new_n86_), .b(new_n30_), .c(new_n85_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n40_), .c(x09), .d(new_n41_), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n48_), .c(new_n83_), .O(z7));
  nand2  g61(.a(new_n52_), .b(x07), .O(new_n90_));
  ...
  nor2   g65(.a(new_n76_), .b(new_n33_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n93_), .c(new_n36_), .d(x17), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n92_), .c(x10), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(x09), .c(new_n41_), .d(x01), .O(new_n97_));
