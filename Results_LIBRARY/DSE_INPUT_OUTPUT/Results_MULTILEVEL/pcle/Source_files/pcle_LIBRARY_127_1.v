...
module FAU ( 
  ...
  nand2  g17(.a(x13), .b(new_n36_), .O(new_n46_));
  oai21  g18(.a(new_n45_), .b(new_n36_), .c(new_n46_), .O(new_n47_));
  ...
  nand4  g28(.a(new_n56_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n57_));
  ...
  nand4  g46(.a(new_n74_), .b(new_n29_), .c(x09), .d(new_n40_), .O(new_n75_));
