...
module FAU ( 
  ...
  inv1   g09(.a(new_n29_), .O(new_n38_));
  nor2   g10(.a(new_n38_), .b(new_n30_), .O(new_n39_));
  ...
  nand2  g16(.a(x10), .b(x02), .O(new_n45_));
  nand3  g17(.a(new_n45_), .b(x08), .c(x01), .O(new_n46_));
  ...
  nand3  g24(.a(new_n52_), .b(x09), .c(new_n30_), .O(new_n53_));
  nand2  g25(.a(x08), .b(x02), .O(new_n54_));
  aoi21  g26(.a(new_n54_), .b(new_n53_), .c(x10), .O(z3));
  ...
  aoi21  g33(.a(x08), .b(x03), .c(new_n38_), .O(new_n62_));
  ...
  nand4  g40(.a(new_n68_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n69_));
  aoi21  g41(.a(x08), .b(x04), .c(new_n38_), .O(new_n70_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n72_), .O(z6));
  nand2  g50(.a(new_n39_), .b(x06), .O(new_n79_));
  ...
  nand4  g56(.a(new_n84_), .b(new_n41_), .c(x09), .d(new_n30_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n79_), .O(z7));
  nand2  g58(.a(new_n39_), .b(x07), .O(new_n87_));
