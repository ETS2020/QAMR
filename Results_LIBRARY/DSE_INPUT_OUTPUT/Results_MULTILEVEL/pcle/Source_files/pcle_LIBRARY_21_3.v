...
module FAU ( 
  ...
  nand2  g09(.a(x10), .b(x01), .O(new_n38_));
  ...
  oai21  g14(.a(x10), .b(x08), .c(x01), .O(new_n43_));
  ...
  nand2  g19(.a(x13), .b(new_n40_), .O(new_n48_));
  oai21  g20(.a(new_n47_), .b(new_n40_), .c(new_n48_), .O(new_n49_));
  nand4  g21(.a(new_n49_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n50_));
  inv1   g22(.a(new_n38_), .O(new_n51_));
  aoi21  g23(.a(x08), .b(x02), .c(new_n51_), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n50_), .O(z3));
  ...
  aoi21  g32(.a(x08), .b(x03), .c(new_n51_), .O(new_n61_));
  ...
  aoi21  g42(.a(x08), .b(x04), .c(new_n51_), .O(new_n71_));
  ...
  aoi21  g50(.a(x08), .b(x05), .c(new_n51_), .O(new_n79_));
  ...
  aoi21  g58(.a(x08), .b(x06), .c(new_n51_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n86_), .O(z7));
  nand4  g60(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n54_), .c(x18), .O(new_n90_));
  ...
  aoi21  g66(.a(x08), .b(x07), .c(new_n51_), .O(new_n95_));
