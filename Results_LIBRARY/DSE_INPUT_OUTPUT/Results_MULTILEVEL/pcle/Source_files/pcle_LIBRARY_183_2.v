...
module FAU ( 
  ...
  nand3  g39(.a(x10), .b(x08), .c(x04), .O(new_n68_));
  ...
  nor2   g52(.a(new_n62_), .b(new_n57_), .O(new_n81_));
  ...
  oai21  g58(.a(new_n31_), .b(x07), .c(x08), .O(new_n87_));
  nand3  g59(.a(new_n81_), .b(x17), .c(x16), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n55_), .c(x18), .O(new_n89_));
  nor2   g61(.a(new_n73_), .b(new_n62_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n64_), .c(new_n29_), .d(x17), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n31_), .c(x09), .O(new_n93_));
