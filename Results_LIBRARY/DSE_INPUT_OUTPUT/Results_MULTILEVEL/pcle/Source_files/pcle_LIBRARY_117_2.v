...
module FAU ( 
  ...
  nor2   g09(.a(x13), .b(new_n31_), .O(new_n38_));
  ...
  nor2   g15(.a(new_n38_), .b(new_n30_), .O(new_n44_));
  ...
  nand3  g21(.a(new_n49_), .b(x13), .c(new_n31_), .O(new_n50_));
  inv1   g22(.a(x13), .O(new_n51_));
  nand3  g23(.a(new_n51_), .b(x12), .c(x11), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  nand3  g25(.a(new_n53_), .b(x09), .c(new_n30_), .O(new_n54_));
  aoi21  g26(.a(x08), .b(x02), .c(new_n38_), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(new_n54_), .O(z3));
  nand2  g28(.a(new_n44_), .b(x03), .O(new_n57_));
  ...
  nand2  g36(.a(new_n44_), .b(x04), .O(new_n65_));
  inv1   g37(.a(new_n49_), .O(new_n66_));
  nor2   g38(.a(x15), .b(new_n51_), .O(new_n67_));
  aoi22  g39(.a(new_n67_), .b(new_n66_), .c(new_n58_), .d(x15), .O(new_n68_));
  nand2  g40(.a(x15), .b(new_n60_), .O(new_n69_));
  oai21  g41(.a(new_n68_), .b(new_n60_), .c(new_n69_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n65_), .O(z5));
  nand2  g44(.a(new_n44_), .b(x05), .O(new_n73_));
  ...
  nand2  g54(.a(new_n82_), .b(new_n51_), .O(new_n83_));
  ...
  nand3  g62(.a(new_n90_), .b(new_n89_), .c(new_n83_), .O(z7));
  nand2  g63(.a(x18), .b(x09), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(x08), .c(new_n31_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n51_), .O(new_n94_));
  nand3  g66(.a(x14), .b(x12), .c(x11), .O(new_n95_));
  nand3  g67(.a(x17), .b(x16), .c(x15), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n95_), .c(x18), .O(new_n97_));
  nand3  g69(.a(new_n66_), .b(x14), .c(x13), .O(new_n98_));
