...
module FAU ( 
  ...
  oai21  g30(.a(new_n58_), .b(new_n46_), .c(new_n57_), .O(new_n59_));
  ...
  oai22  g36(.a(new_n64_), .b(new_n46_), .c(new_n63_), .d(new_n32_), .O(new_n65_));
  ...
  oai21  g44(.a(new_n72_), .b(new_n56_), .c(new_n70_), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(new_n37_), .c(x09), .d(new_n29_), .O(new_n74_));
  nand2  g46(.a(new_n52_), .b(x05), .O(new_n75_));
  ...
  nor2   g59(.a(new_n71_), .b(new_n32_), .O(new_n88_));
  nor2   g60(.a(x18), .b(new_n80_), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(new_n88_), .c(new_n63_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n87_), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(new_n37_), .c(x09), .O(new_n92_));
