...
module FAU ( 
  ...
  nor2   g10(.a(new_n38_), .b(x15), .O(new_n39_));
  ...
  nand3  g48(.a(new_n66_), .b(x08), .c(x05), .O(new_n77_));
  nand4  g49(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(x16), .O(new_n79_));
  inv1   g51(.a(x16), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(x14), .c(x13), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n50_), .c(new_n79_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x15), .O(new_n83_));
  nand3  g55(.a(new_n38_), .b(x16), .c(new_n69_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n77_), .O(z6));
  nand3  g59(.a(x16), .b(x14), .c(x13), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n50_), .c(x17), .O(new_n89_));
  nand4  g61(.a(new_n38_), .b(x16), .c(x15), .d(x14), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n59_), .c(new_n89_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n92_));
  aoi21  g64(.a(x08), .b(x06), .c(new_n39_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n92_), .O(z7));
  nand3  g66(.a(new_n43_), .b(x11), .c(new_n31_), .O(new_n95_));
  nor2   g67(.a(x18), .b(new_n80_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(x14), .c(x13), .d(x12), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n95_), .c(x15), .O(new_n98_));
  nand2  g70(.a(new_n98_), .b(x17), .O(new_n99_));
  nand3  g71(.a(x17), .b(x16), .c(x14), .O(new_n100_));
  inv1   g72(.a(new_n100_), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n60_), .c(new_n29_), .O(new_n102_));
