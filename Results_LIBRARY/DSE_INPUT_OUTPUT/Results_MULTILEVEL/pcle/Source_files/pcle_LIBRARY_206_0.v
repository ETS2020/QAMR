...
module FAU ( 
  ...
  nand2  g10(.a(new_n31_), .b(x01), .O(new_n39_));
  ...
  aoi21  g19(.a(new_n47_), .b(new_n31_), .c(new_n40_), .O(z2));
  ...
  oai21  g25(.a(new_n53_), .b(new_n40_), .c(new_n49_), .O(z3));
  ...
  aoi21  g30(.a(new_n58_), .b(new_n57_), .c(x10), .O(new_n59_));
  nand4  g31(.a(new_n59_), .b(x09), .c(new_n31_), .d(x01), .O(new_n60_));
  ...
  oai21  g38(.a(new_n66_), .b(new_n63_), .c(new_n64_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x14), .O(new_n68_));
  nand2  g40(.a(x15), .b(new_n30_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n68_), .c(x10), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(x09), .c(new_n31_), .d(x01), .O(new_n71_));
  ...
  inv1   g48(.a(new_n56_), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(new_n76_), .c(x15), .d(x14), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n75_), .c(new_n73_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n31_), .c(new_n40_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x05), .O(new_n81_));
  oai21  g53(.a(new_n80_), .b(x10), .c(new_n81_), .O(z6));
  nand2  g54(.a(new_n41_), .b(x06), .O(new_n83_));
  ...
  oai21  g61(.a(new_n89_), .b(new_n40_), .c(new_n83_), .O(z7));
  ...
  nor2   g65(.a(new_n76_), .b(new_n65_), .O(new_n94_));
  nand4  g66(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n95_));
  inv1   g67(.a(new_n95_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n94_), .c(new_n29_), .d(x17), .O(new_n97_));
