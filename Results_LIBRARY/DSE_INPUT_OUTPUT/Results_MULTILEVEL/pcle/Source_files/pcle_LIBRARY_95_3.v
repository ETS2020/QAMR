...
module FAU ( 
  ...
  and2   g06(.a(x15), .b(x13), .O(new_n35_));
  ...
  nand3  g21(.a(new_n49_), .b(new_n48_), .c(new_n41_), .O(z2));
  ...
  nand4  g25(.a(new_n53_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n54_));
  ...
  nand2  g31(.a(new_n30_), .b(x13), .O(new_n60_));
  oai22  g32(.a(new_n60_), .b(new_n33_), .c(new_n59_), .d(new_n30_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n57_), .O(z4));
  oai21  g35(.a(new_n58_), .b(new_n30_), .c(x15), .O(new_n64_));
  inv1   g36(.a(x15), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(x14), .c(x13), .O(new_n66_));
  oai22  g38(.a(new_n66_), .b(new_n33_), .c(new_n64_), .d(x10), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(x09), .c(new_n46_), .O(new_n68_));
  aoi21  g40(.a(x08), .b(x04), .c(new_n40_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n68_), .O(z5));
  nand3  g42(.a(new_n41_), .b(x08), .c(x05), .O(new_n71_));
  ...
  nand4  g48(.a(new_n76_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n71_), .O(z6));
  nand2  g50(.a(new_n34_), .b(new_n32_), .O(new_n79_));
  inv1   g51(.a(x17), .O(new_n80_));
  nand3  g52(.a(new_n35_), .b(new_n80_), .c(x16), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n79_), .c(new_n29_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x14), .O(new_n83_));
  nand3  g55(.a(x16), .b(x15), .c(x14), .O(new_n84_));
  inv1   g56(.a(new_n84_), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n59_), .c(new_n80_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n87_));
  nand2  g59(.a(x08), .b(x06), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(new_n83_), .O(z7));
  inv1   g61(.a(x18), .O(new_n90_));
  nand4  g62(.a(new_n35_), .b(new_n90_), .c(x17), .d(x16), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n79_), .c(new_n29_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(x14), .O(new_n93_));
  nand4  g65(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n94_));
  inv1   g66(.a(new_n94_), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n59_), .c(new_n90_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n29_), .c(x09), .d(new_n46_), .O(new_n97_));
