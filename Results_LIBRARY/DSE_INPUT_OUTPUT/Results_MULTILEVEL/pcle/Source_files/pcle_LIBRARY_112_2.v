...
module FAU ( 
  ...
  oai21  g19(.a(x10), .b(new_n29_), .c(x08), .O(new_n48_));
  xor2a  g20(.a(x12), .b(x11), .O(new_n49_));
  nand4  g21(.a(new_n49_), .b(new_n39_), .c(x09), .d(new_n40_), .O(new_n50_));
  oai22  g22(.a(new_n50_), .b(x05), .c(new_n48_), .d(new_n47_), .O(z2));
  ...
  aoi21  g28(.a(new_n56_), .b(new_n40_), .c(x05), .O(new_n57_));
  nand2  g29(.a(x08), .b(x02), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(x10), .c(new_n58_), .O(z3));
  inv1   g31(.a(x03), .O(new_n60_));
  nand2  g32(.a(new_n32_), .b(x14), .O(new_n61_));
  inv1   g33(.a(x14), .O(new_n62_));
  inv1   g34(.a(new_n52_), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(new_n62_), .c(x13), .O(new_n64_));
  aoi21  g36(.a(new_n64_), .b(new_n61_), .c(x10), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(x09), .c(new_n40_), .d(new_n29_), .O(new_n66_));
  oai21  g38(.a(new_n48_), .b(new_n60_), .c(new_n66_), .O(z4));
  ...
  oai21  g47(.a(new_n39_), .b(x08), .c(x05), .O(new_n76_));
  ...
  oai21  g52(.a(new_n80_), .b(new_n32_), .c(new_n78_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n39_), .c(x09), .d(new_n40_), .O(new_n82_));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n40_), .c(x05), .O(new_n89_));
  ...
  aoi21  g70(.a(new_n98_), .b(new_n40_), .c(x05), .O(new_n99_));
