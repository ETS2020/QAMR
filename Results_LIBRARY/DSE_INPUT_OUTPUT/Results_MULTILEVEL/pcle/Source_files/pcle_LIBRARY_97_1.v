...
module FAU ( 
  ...
  aoi21  g31(.a(new_n59_), .b(new_n56_), .c(x18), .O(new_n60_));
  nand4  g32(.a(new_n60_), .b(new_n34_), .c(x09), .d(new_n33_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n54_), .O(z4));
  nand2  g34(.a(new_n53_), .b(x04), .O(new_n63_));
  ...
  nand2  g40(.a(x15), .b(new_n57_), .O(new_n69_));
  aoi21  g41(.a(new_n69_), .b(new_n68_), .c(x18), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n34_), .c(x09), .d(new_n33_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n63_), .O(z5));
  nand3  g44(.a(x15), .b(x14), .c(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n45_), .c(x16), .O(new_n74_));
  inv1   g46(.a(new_n55_), .O(new_n75_));
  nor2   g47(.a(x16), .b(new_n65_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(new_n75_), .c(x14), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n74_), .c(new_n44_), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n33_), .c(x18), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(x10), .c(new_n80_), .O(z6));
  nand2  g53(.a(new_n53_), .b(x06), .O(new_n82_));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n55_), .c(x17), .O(new_n84_));
  ...
  nand4  g59(.a(new_n87_), .b(new_n29_), .c(new_n34_), .d(x09), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(x08), .c(new_n82_), .O(z7));
  inv1   g61(.a(x07), .O(new_n90_));
  nand4  g62(.a(new_n58_), .b(new_n34_), .c(x09), .d(new_n33_), .O(new_n91_));
  inv1   g63(.a(new_n73_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n29_), .c(x17), .d(x16), .O(new_n93_));
  oai22  g65(.a(new_n93_), .b(new_n91_), .c(new_n32_), .d(new_n90_), .O(z8));
endmodule
