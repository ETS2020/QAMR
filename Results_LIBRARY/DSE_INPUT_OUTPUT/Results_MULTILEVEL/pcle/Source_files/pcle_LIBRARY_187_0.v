...
module FAU ( 
  ...
  aoi21  g32(.a(new_n60_), .b(new_n58_), .c(new_n57_), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n30_), .c(new_n56_), .O(new_n62_));
  nand2  g34(.a(x08), .b(x03), .O(new_n63_));
  oai21  g35(.a(new_n62_), .b(x10), .c(new_n63_), .O(z4));
  inv1   g36(.a(x04), .O(new_n65_));
  oai21  g37(.a(x13), .b(x10), .c(x08), .O(new_n66_));
  nand3  g38(.a(x14), .b(x12), .c(x11), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(x15), .O(new_n68_));
  inv1   g40(.a(x15), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(x14), .c(x12), .d(x11), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n68_), .c(new_n56_), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n72_));
  oai21  g44(.a(new_n66_), .b(new_n65_), .c(new_n72_), .O(z5));
  ...
  nand4  g51(.a(new_n79_), .b(x13), .c(new_n31_), .d(x09), .O(new_n80_));
  oai22  g52(.a(new_n80_), .b(x08), .c(new_n66_), .d(new_n74_), .O(z6));
  inv1   g53(.a(x06), .O(new_n82_));
  nand3  g54(.a(x16), .b(x15), .c(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n50_), .c(x17), .O(new_n84_));
  inv1   g56(.a(x17), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(x16), .c(x15), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n67_), .c(new_n84_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(x13), .c(new_n31_), .d(x09), .O(new_n88_));
  oai22  g60(.a(new_n88_), .b(x08), .c(new_n66_), .d(new_n82_), .O(z7));
  inv1   g61(.a(x07), .O(new_n90_));
  nand3  g62(.a(x17), .b(x16), .c(x15), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n67_), .c(x18), .O(new_n92_));
  nand4  g64(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n67_), .c(new_n92_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(x13), .c(new_n31_), .d(x09), .O(new_n95_));
  oai22  g67(.a(new_n95_), .b(x08), .c(new_n66_), .d(new_n90_), .O(z8));
endmodule
