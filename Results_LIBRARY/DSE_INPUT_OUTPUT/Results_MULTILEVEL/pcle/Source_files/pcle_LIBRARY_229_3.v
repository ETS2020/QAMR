...
module FAU ( 
  ...
  oai22  g35(.a(new_n63_), .b(new_n51_), .c(new_n62_), .d(new_n60_), .O(new_n64_));
  nand4  g36(.a(new_n64_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n65_));
  oai21  g37(.a(new_n46_), .b(new_n59_), .c(new_n65_), .O(z4));
  nor2   g38(.a(x15), .b(new_n50_), .O(new_n67_));
  aoi22  g39(.a(new_n67_), .b(new_n52_), .c(new_n61_), .d(x15), .O(new_n68_));
  ...
  aoi21  g43(.a(x08), .b(x04), .c(new_n56_), .O(new_n72_));
  ...
  nand2  g47(.a(new_n52_), .b(new_n31_), .O(new_n76_));
  inv1   g48(.a(x16), .O(new_n77_));
  nor2   g49(.a(new_n60_), .b(new_n50_), .O(new_n78_));
  ...
  aoi21  g53(.a(x08), .b(x05), .c(new_n56_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n81_), .O(z6));
  nand2  g55(.a(new_n52_), .b(new_n41_), .O(new_n84_));
  ...
  aoi21  g62(.a(new_n90_), .b(new_n62_), .c(new_n85_), .O(new_n91_));
  ...
  aoi21  g71(.a(new_n99_), .b(new_n62_), .c(new_n29_), .O(new_n100_));
