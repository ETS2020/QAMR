...
module FAU ( 
  ...
  aoi21  g10(.a(x13), .b(x10), .c(new_n31_), .O(new_n39_));
  ...
  nand4  g16(.a(new_n44_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n45_));
  aoi22  g17(.a(x13), .b(x10), .c(x08), .d(x01), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(new_n45_), .O(z2));
  nand2  g19(.a(new_n39_), .b(x02), .O(new_n48_));
  nand3  g20(.a(new_n30_), .b(x12), .c(x11), .O(new_n49_));
  oai21  g21(.a(new_n32_), .b(new_n30_), .c(new_n49_), .O(new_n50_));
  nand4  g22(.a(new_n50_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(new_n48_), .O(z3));
  nand2  g24(.a(new_n39_), .b(x03), .O(new_n53_));
  nand3  g25(.a(x13), .b(x12), .c(x11), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(x14), .O(new_n55_));
  nand3  g27(.a(new_n32_), .b(new_n33_), .c(x13), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nand4  g29(.a(new_n57_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(new_n53_), .O(z4));
  nand2  g31(.a(new_n39_), .b(x04), .O(new_n60_));
  nand2  g32(.a(new_n54_), .b(x15), .O(new_n61_));
  nand4  g33(.a(new_n34_), .b(x13), .c(x12), .d(x11), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(x14), .O(new_n64_));
  nand2  g36(.a(x15), .b(new_n33_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n29_), .c(x09), .d(new_n31_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n60_), .O(z5));
  nand3  g40(.a(x11), .b(x09), .c(new_n31_), .O(new_n69_));
  inv1   g41(.a(x16), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(x15), .c(x14), .d(x12), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n69_), .c(new_n29_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(x13), .O(new_n73_));
  nand3  g45(.a(x15), .b(x14), .c(x13), .O(new_n74_));
  inv1   g46(.a(new_n74_), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n32_), .c(new_n70_), .O(new_n76_));
  ...
  nand2  g51(.a(new_n39_), .b(x06), .O(new_n80_));
  ...
  nor2   g62(.a(new_n70_), .b(new_n34_), .O(new_n91_));
  nor2   g63(.a(new_n33_), .b(new_n30_), .O(new_n92_));
  nor2   g64(.a(x18), .b(new_n83_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n32_), .O(new_n94_));
