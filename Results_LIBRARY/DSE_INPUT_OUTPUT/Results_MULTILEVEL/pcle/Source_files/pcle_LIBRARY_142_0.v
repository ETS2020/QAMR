...
module FAU ( 
  ...
  nand4  g19(.a(new_n47_), .b(x13), .c(new_n42_), .d(x09), .O(new_n48_));
  oai22  g20(.a(new_n48_), .b(x08), .c(new_n41_), .d(new_n46_), .O(z2));
  inv1   g21(.a(x02), .O(new_n50_));
  nand2  g22(.a(x12), .b(x11), .O(new_n51_));
  nand4  g23(.a(new_n51_), .b(x13), .c(new_n42_), .d(x09), .O(new_n52_));
  oai22  g24(.a(new_n52_), .b(x08), .c(new_n41_), .d(new_n50_), .O(z3));
  ...
  aoi21  g30(.a(new_n58_), .b(new_n56_), .c(new_n55_), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n29_), .c(new_n54_), .O(new_n60_));
  nand2  g32(.a(x08), .b(x03), .O(new_n61_));
  oai21  g33(.a(new_n60_), .b(x10), .c(new_n61_), .O(z4));
  nand2  g34(.a(new_n30_), .b(x15), .O(new_n63_));
  inv1   g35(.a(x15), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(x12), .c(x11), .O(new_n65_));
  aoi21  g37(.a(new_n65_), .b(new_n63_), .c(new_n57_), .O(new_n66_));
  nor2   g38(.a(new_n64_), .b(x14), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n66_), .c(x09), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(x08), .c(x13), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n42_), .O(new_n70_));
  nand2  g42(.a(x08), .b(x04), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n70_), .O(z5));
  inv1   g44(.a(x05), .O(new_n73_));
  oai21  g45(.a(new_n35_), .b(new_n30_), .c(x16), .O(new_n74_));
  nand3  g46(.a(new_n32_), .b(x15), .c(x14), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n30_), .c(new_n74_), .O(new_n76_));
  nand4  g48(.a(new_n76_), .b(x13), .c(new_n42_), .d(x09), .O(new_n77_));
  oai22  g49(.a(new_n77_), .b(x08), .c(new_n41_), .d(new_n73_), .O(z6));
  inv1   g50(.a(x06), .O(new_n79_));
  nand3  g51(.a(x16), .b(x15), .c(x14), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n30_), .c(x17), .O(new_n81_));
  nand3  g53(.a(x14), .b(x12), .c(x11), .O(new_n82_));
  nand3  g54(.a(new_n33_), .b(x16), .c(x15), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(x13), .c(new_n42_), .d(x09), .O(new_n85_));
  oai22  g57(.a(new_n85_), .b(x08), .c(new_n41_), .d(new_n79_), .O(z7));
  nand3  g58(.a(x17), .b(x16), .c(x15), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n82_), .c(x18), .O(new_n88_));
  nor2   g60(.a(new_n32_), .b(new_n64_), .O(new_n89_));
  inv1   g61(.a(new_n82_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n89_), .c(new_n34_), .d(x17), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n88_), .c(new_n55_), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n29_), .c(new_n54_), .O(new_n93_));
