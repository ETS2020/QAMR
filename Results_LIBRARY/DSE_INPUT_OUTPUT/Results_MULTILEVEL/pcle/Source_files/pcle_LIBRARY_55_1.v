...
module FAU ( 
  ...
  oai21  g10(.a(new_n31_), .b(x03), .c(x08), .O(new_n39_));
  ...
  nor2   g16(.a(new_n31_), .b(x03), .O(new_n45_));
  ...
  nand2  g36(.a(new_n54_), .b(x15), .O(new_n65_));
  inv1   g37(.a(x15), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n56_), .c(new_n65_), .O(new_n68_));
