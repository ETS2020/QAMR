...
module FAU ( 
  ...
  oai21  g24(.a(x12), .b(x10), .c(x08), .O(new_n53_));
  ...
  oai21  g32(.a(new_n53_), .b(new_n52_), .c(new_n60_), .O(z4));
  ...
  nand4  g37(.a(new_n65_), .b(x14), .c(x13), .d(x11), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n64_), .c(new_n62_), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n30_), .c(new_n54_), .O(new_n68_));
  ...
  nand4  g48(.a(new_n76_), .b(x12), .c(new_n31_), .d(x09), .O(new_n77_));
  oai22  g49(.a(new_n77_), .b(x08), .c(new_n53_), .d(new_n71_), .O(z6));
  ...
  oai21  g55(.a(new_n83_), .b(new_n63_), .c(new_n81_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(x12), .c(new_n31_), .d(x09), .O(new_n85_));
  oai22  g57(.a(new_n85_), .b(x08), .c(new_n53_), .d(new_n79_), .O(z7));
  ...
  aoi21  g63(.a(new_n91_), .b(new_n88_), .c(new_n62_), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n30_), .c(new_n54_), .O(new_n93_));
