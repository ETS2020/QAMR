...
module FAU ( 
  ...
  nor2   g16(.a(new_n42_), .b(x11), .O(new_n45_));
  nand3  g17(.a(new_n45_), .b(new_n30_), .c(new_n41_), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(new_n44_), .O(z1));
  nand2  g19(.a(new_n43_), .b(x01), .O(new_n48_));
  nand2  g20(.a(new_n48_), .b(new_n46_), .O(z2));
  nand2  g21(.a(new_n43_), .b(x02), .O(new_n50_));
  xor2a  g22(.a(x13), .b(x11), .O(new_n51_));
  nand4  g23(.a(new_n51_), .b(x12), .c(new_n41_), .d(x09), .O(new_n52_));
  ...
  aoi21  g29(.a(new_n57_), .b(new_n55_), .c(new_n42_), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(new_n41_), .c(x09), .d(new_n40_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n54_), .O(z4));
  nand2  g32(.a(new_n43_), .b(x04), .O(new_n61_));
  nand2  g33(.a(new_n31_), .b(x15), .O(new_n62_));
  ...
  aoi21  g39(.a(new_n67_), .b(new_n66_), .c(new_n42_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n41_), .c(x09), .d(new_n40_), .O(new_n69_));
  ...
  oai21  g45(.a(new_n73_), .b(new_n31_), .c(new_n72_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(x12), .c(new_n41_), .d(x09), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(x08), .c(new_n71_), .O(z6));
  ...
  nand4  g52(.a(new_n80_), .b(new_n34_), .c(x16), .d(x15), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n78_), .c(new_n29_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n40_), .c(new_n42_), .O(new_n83_));
  ...
  oai21  g61(.a(new_n89_), .b(new_n79_), .c(new_n88_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(x12), .c(new_n41_), .d(x09), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(x08), .c(new_n86_), .O(z8));
endmodule
