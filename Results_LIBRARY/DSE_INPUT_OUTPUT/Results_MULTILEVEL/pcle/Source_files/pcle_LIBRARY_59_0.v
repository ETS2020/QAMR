...
module FAU ( 
  ...
  aoi21  g18(.a(new_n38_), .b(new_n46_), .c(new_n39_), .O(new_n47_));
  ...
  oai21  g22(.a(new_n50_), .b(new_n46_), .c(new_n48_), .O(z2));
  oai21  g23(.a(new_n38_), .b(x02), .c(x08), .O(new_n52_));
  ...
  oai21  g29(.a(new_n57_), .b(new_n46_), .c(new_n38_), .O(new_n58_));
  ...
  aoi21  g36(.a(new_n64_), .b(new_n39_), .c(new_n46_), .O(new_n65_));
  ...
  aoi21  g44(.a(new_n72_), .b(new_n39_), .c(new_n46_), .O(new_n73_));
  nand2  g45(.a(x08), .b(x04), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(x10), .c(new_n74_), .O(z5));
  nand2  g47(.a(new_n47_), .b(x05), .O(new_n76_));
  ...
  nand4  g53(.a(new_n81_), .b(new_n38_), .c(x09), .d(new_n39_), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n46_), .c(new_n76_), .O(z6));
  ...
  aoi21  g60(.a(new_n88_), .b(new_n39_), .c(new_n46_), .O(new_n89_));
  nand2  g61(.a(x08), .b(x06), .O(new_n90_));
  oai21  g62(.a(new_n89_), .b(x10), .c(new_n90_), .O(z7));
  nand2  g63(.a(new_n47_), .b(x07), .O(new_n92_));
  ...
  nand4  g70(.a(new_n98_), .b(x09), .c(new_n39_), .d(x02), .O(new_n99_));
