...
module FAU ( 
  ...
  nor2   g09(.a(x12), .b(new_n31_), .O(new_n38_));
  ...
  nand3  g15(.a(x12), .b(new_n41_), .c(new_n31_), .O(new_n44_));
  oai21  g16(.a(x12), .b(new_n41_), .c(new_n44_), .O(new_n45_));
  ...
  nand3  g33(.a(new_n53_), .b(new_n59_), .c(x13), .O(new_n62_));
  ...
  nand2  g37(.a(new_n49_), .b(x04), .O(new_n66_));
  inv1   g38(.a(x15), .O(new_n67_));
  nand4  g39(.a(new_n67_), .b(x13), .c(x12), .d(x11), .O(new_n68_));
  oai21  g40(.a(new_n61_), .b(new_n67_), .c(new_n68_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(x14), .O(new_n70_));
  nand2  g42(.a(x15), .b(new_n59_), .O(new_n71_));
  ...
  oai21  g51(.a(new_n79_), .b(new_n78_), .c(x16), .O(new_n80_));
  ...
  nand2  g60(.a(new_n88_), .b(new_n52_), .O(new_n89_));
  nand3  g61(.a(x16), .b(x15), .c(x14), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n78_), .c(x17), .O(new_n91_));
  ...
  nand2  g69(.a(new_n49_), .b(x07), .O(new_n98_));
  nand4  g70(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n99_));
  oai21  g71(.a(new_n99_), .b(new_n60_), .c(x18), .O(new_n100_));
  nor2   g72(.a(new_n81_), .b(new_n67_), .O(new_n101_));
  nor2   g73(.a(new_n59_), .b(new_n51_), .O(new_n102_));
  nor2   g74(.a(x18), .b(new_n92_), .O(new_n103_));
  nand4  g75(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n53_), .O(new_n104_));
