...
module FAU ( 
  ...
  aoi21  g17(.a(new_n45_), .b(new_n40_), .c(new_n41_), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(x01), .O(new_n47_));
  xor2a  g19(.a(x12), .b(x11), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(new_n45_), .c(x09), .d(new_n41_), .O(new_n49_));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n41_), .c(new_n40_), .O(new_n56_));
  ...
  nand4  g34(.a(new_n62_), .b(x09), .c(new_n41_), .d(x00), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n59_), .O(z4));
  nand2  g36(.a(new_n46_), .b(x04), .O(new_n65_));
  ...
  nand4  g43(.a(new_n71_), .b(x09), .c(new_n41_), .d(x00), .O(new_n72_));
  ...
  aoi21  g51(.a(new_n79_), .b(new_n41_), .c(new_n40_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x05), .O(new_n81_));
  oai21  g53(.a(new_n80_), .b(x10), .c(new_n81_), .O(z6));
  nand2  g54(.a(new_n46_), .b(x06), .O(new_n83_));
  ...
  nand4  g59(.a(new_n87_), .b(new_n45_), .c(x09), .d(new_n41_), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n40_), .c(new_n83_), .O(z7));
  nand2  g61(.a(new_n46_), .b(x07), .O(new_n90_));
  nand4  g62(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n30_), .c(x18), .O(new_n92_));
  nor2   g64(.a(new_n76_), .b(new_n33_), .O(new_n93_));
  nand4  g65(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n94_));
  inv1   g66(.a(new_n94_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n93_), .c(new_n36_), .d(x17), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n92_), .c(x10), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(x09), .c(new_n41_), .d(x00), .O(new_n98_));
