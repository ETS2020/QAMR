...
module FAU ( 
  ...
  nand4  g23(.a(new_n51_), .b(new_n29_), .c(x09), .d(new_n47_), .O(new_n52_));
  ...
  oai21  g31(.a(new_n59_), .b(x10), .c(new_n47_), .O(new_n60_));
  ...
  nand4  g38(.a(new_n66_), .b(new_n29_), .c(x09), .d(new_n47_), .O(new_n67_));
  ...
  aoi21  g62(.a(new_n90_), .b(new_n87_), .c(new_n55_), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(x10), .c(new_n47_), .O(new_n92_));
