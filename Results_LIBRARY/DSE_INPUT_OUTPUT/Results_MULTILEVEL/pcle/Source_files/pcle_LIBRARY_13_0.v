...
module FAU ( 
  ...
  nand4  g04(.a(new_n32_), .b(x09), .c(new_n31_), .d(x07), .O(new_n33_));
  ...
  oai21  g18(.a(x10), .b(x07), .c(x08), .O(new_n47_));
  ...
  nand2  g24(.a(x13), .b(new_n39_), .O(new_n53_));
  oai21  g25(.a(new_n52_), .b(new_n39_), .c(new_n53_), .O(new_n54_));
  nand4  g26(.a(new_n54_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n55_));
  oai22  g27(.a(new_n55_), .b(new_n46_), .c(new_n47_), .d(new_n51_), .O(z3));
  ...
  aoi21  g32(.a(new_n60_), .b(new_n59_), .c(new_n57_), .O(new_n61_));
  aoi21  g33(.a(new_n61_), .b(new_n31_), .c(new_n46_), .O(new_n62_));
  ...
  nand2  g38(.a(x12), .b(x11), .O(new_n67_));
  nand4  g39(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n68_));
  inv1   g40(.a(new_n68_), .O(new_n69_));
  nand3  g41(.a(new_n66_), .b(x14), .c(x13), .O(new_n70_));
  oai22  g42(.a(new_n70_), .b(new_n67_), .c(new_n69_), .d(new_n66_), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n72_));
  oai22  g44(.a(new_n72_), .b(new_n46_), .c(new_n47_), .d(new_n65_), .O(z5));
  inv1   g45(.a(x05), .O(new_n74_));
  nand3  g46(.a(x15), .b(x14), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n67_), .c(x16), .O(new_n76_));
  ...
  nand4  g51(.a(new_n79_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n80_));
  oai22  g52(.a(new_n80_), .b(new_n46_), .c(new_n47_), .d(new_n74_), .O(z6));
  ...
  oai21  g58(.a(new_n86_), .b(new_n58_), .c(new_n84_), .O(new_n87_));
  nand4  g59(.a(new_n87_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n88_));
  oai22  g60(.a(new_n88_), .b(new_n46_), .c(new_n47_), .d(new_n82_), .O(z7));
  oai21  g61(.a(new_n32_), .b(x07), .c(x08), .O(new_n90_));
  nand4  g62(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n58_), .c(x18), .O(new_n92_));
  nor2   g64(.a(new_n77_), .b(new_n66_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n69_), .c(new_n29_), .d(x17), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n92_), .c(new_n57_), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n46_), .c(new_n32_), .O(new_n96_));
