...
module FAU ( 
  ...
  nand2  g13(.a(new_n41_), .b(x15), .O(new_n42_));
  ...
  oai21  g18(.a(x15), .b(x10), .c(x08), .O(new_n47_));
  xor2a  g19(.a(x12), .b(x11), .O(new_n48_));
  nand4  g20(.a(new_n48_), .b(x15), .c(new_n39_), .d(x09), .O(new_n49_));
  ...
  inv1   g40(.a(new_n61_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(x14), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(x15), .c(new_n39_), .d(x09), .O(new_n71_));
  oai22  g43(.a(new_n71_), .b(x08), .c(new_n47_), .d(new_n68_), .O(z5));
  inv1   g44(.a(x05), .O(new_n73_));
  oai21  g45(.a(new_n35_), .b(new_n30_), .c(x16), .O(new_n74_));
  nand3  g46(.a(new_n32_), .b(x14), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n30_), .c(new_n74_), .O(new_n76_));
  nand4  g48(.a(new_n76_), .b(x15), .c(new_n39_), .d(x09), .O(new_n77_));
  oai22  g49(.a(new_n77_), .b(x08), .c(new_n47_), .d(new_n73_), .O(z6));
  nand3  g50(.a(x16), .b(x14), .c(x13), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n30_), .c(x17), .O(new_n80_));
  nand4  g52(.a(new_n69_), .b(new_n33_), .c(x16), .d(x14), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n80_), .c(new_n52_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n29_), .c(new_n51_), .O(new_n83_));
  ...
  and2   g59(.a(x16), .b(x14), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n69_), .c(new_n34_), .d(x17), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n87_), .c(new_n52_), .O(new_n90_));
