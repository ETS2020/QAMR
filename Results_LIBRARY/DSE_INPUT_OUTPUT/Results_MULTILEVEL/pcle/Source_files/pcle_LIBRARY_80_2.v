...
module FAU ( 
  ...
  oai21  g14(.a(new_n38_), .b(x01), .c(x08), .O(new_n43_));
  ...
  oai21  g18(.a(new_n38_), .b(x02), .c(x08), .O(new_n47_));
  ...
  oai21  g29(.a(new_n57_), .b(new_n55_), .c(new_n54_), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n31_), .c(new_n30_), .O(new_n59_));
  nand2  g31(.a(x08), .b(x03), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n59_), .c(new_n38_), .O(z4));
  nand2  g33(.a(new_n53_), .b(x15), .O(new_n62_));
  ...
  nand3  g40(.a(new_n68_), .b(new_n31_), .c(new_n30_), .O(new_n69_));
  nand2  g41(.a(x08), .b(x04), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n69_), .c(new_n38_), .O(z5));
  oai21  g43(.a(new_n38_), .b(x05), .c(x08), .O(new_n72_));
  nand3  g44(.a(x15), .b(x14), .c(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n55_), .c(x16), .O(new_n74_));
  inv1   g46(.a(x16), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(x15), .c(x14), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n53_), .c(new_n74_), .O(new_n77_));
  ...
  oai21  g55(.a(new_n83_), .b(new_n53_), .c(new_n81_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(new_n31_), .c(new_n30_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n85_), .c(new_n38_), .O(z7));
  ...
  nand4  g62(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n91_));
  ...
  aoi21  g66(.a(new_n94_), .b(new_n93_), .c(new_n38_), .O(z8));
endmodule
