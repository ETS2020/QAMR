...
module FAU ( 
  ...
  nor2   g38(.a(new_n59_), .b(new_n50_), .O(new_n67_));
  ...
  aoi21  g45(.a(x08), .b(x04), .c(new_n56_), .O(new_n74_));
  ...
  oai21  g62(.a(new_n46_), .b(new_n84_), .c(new_n90_), .O(z7));
  nand3  g63(.a(x17), .b(x16), .c(x15), .O(new_n92_));
  inv1   g64(.a(new_n92_), .O(new_n93_));
  nand4  g65(.a(new_n93_), .b(new_n67_), .c(new_n52_), .d(new_n41_), .O(new_n94_));
