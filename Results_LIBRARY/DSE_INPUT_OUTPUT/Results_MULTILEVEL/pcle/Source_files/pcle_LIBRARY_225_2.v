...
module FAU ( 
  ...
  aoi21  g28(.a(new_n56_), .b(new_n42_), .c(x04), .O(new_n57_));
  ...
  nand4  g37(.a(new_n65_), .b(x09), .c(new_n42_), .d(new_n29_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n61_), .O(z4));
  nand2  g39(.a(new_n32_), .b(x15), .O(new_n68_));
  ...
  nand4  g46(.a(new_n74_), .b(x09), .c(new_n42_), .d(new_n29_), .O(new_n75_));
  nand3  g47(.a(x10), .b(x08), .c(x04), .O(new_n76_));
  ...
  nand4  g52(.a(new_n33_), .b(new_n80_), .c(x15), .d(x14), .O(new_n81_));
  ...
  nand4  g60(.a(new_n34_), .b(new_n33_), .c(new_n88_), .d(x16), .O(new_n89_));
  ...
  nor2   g67(.a(new_n80_), .b(new_n69_), .O(new_n96_));
  ...
  aoi21  g72(.a(new_n100_), .b(new_n95_), .c(new_n30_), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n42_), .c(x04), .O(new_n102_));
