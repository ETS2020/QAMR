...
module FAU ( 
  ...
  nand2  g22(.a(new_n50_), .b(new_n46_), .O(z3));
  oai21  g23(.a(x10), .b(x03), .c(x08), .O(new_n52_));
  ...
  nand2  g37(.a(x15), .b(new_n56_), .O(new_n66_));
  ...
  aoi21  g41(.a(new_n69_), .b(new_n68_), .c(x10), .O(z5));
  oai21  g42(.a(x10), .b(x05), .c(x08), .O(new_n71_));
  ...
  oai21  g47(.a(new_n75_), .b(new_n53_), .c(new_n73_), .O(new_n76_));
  ...
  oai21  g54(.a(new_n82_), .b(new_n53_), .c(new_n80_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(x09), .c(new_n30_), .O(new_n84_));
  nand2  g56(.a(x08), .b(x06), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n84_), .c(x10), .O(z7));
  oai21  g58(.a(x10), .b(x07), .c(x08), .O(new_n87_));
