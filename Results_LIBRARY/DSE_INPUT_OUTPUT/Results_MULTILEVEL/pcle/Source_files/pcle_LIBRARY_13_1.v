...
module FAU ( 
  ...
  nand3  g34(.a(new_n62_), .b(new_n61_), .c(new_n39_), .O(z4));
  ...
  oai22  g40(.a(new_n68_), .b(new_n57_), .c(new_n67_), .d(new_n65_), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n70_));
  oai21  g42(.a(new_n45_), .b(new_n64_), .c(new_n70_), .O(z5));
  ...
  oai21  g50(.a(new_n45_), .b(new_n72_), .c(new_n78_), .O(z6));
  ...
  oai21  g58(.a(new_n45_), .b(new_n80_), .c(new_n86_), .O(z7));
  oai21  g59(.a(x10), .b(x07), .c(x08), .O(new_n88_));
  ...
  nand3  g66(.a(new_n94_), .b(new_n88_), .c(new_n39_), .O(z8));
endmodule
