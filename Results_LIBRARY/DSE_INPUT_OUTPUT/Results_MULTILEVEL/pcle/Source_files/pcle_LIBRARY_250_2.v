...
module FAU ( 
  ...
  nand2  g36(.a(new_n38_), .b(x13), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n57_), .c(new_n64_), .O(new_n66_));
  ...
  nand3  g53(.a(new_n81_), .b(new_n80_), .c(new_n74_), .O(z6));
  ...
  nand3  g57(.a(x16), .b(x14), .c(x13), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n57_), .c(x17), .O(new_n87_));
  ...
  nand3  g68(.a(x17), .b(x16), .c(x14), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n55_), .c(x18), .O(new_n98_));
  nand4  g70(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n99_));
  oai21  g71(.a(new_n99_), .b(new_n75_), .c(new_n98_), .O(new_n100_));
