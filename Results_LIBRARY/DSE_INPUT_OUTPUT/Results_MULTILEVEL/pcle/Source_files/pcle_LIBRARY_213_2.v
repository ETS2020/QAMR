...
module FAU ( 
  ...
  nand4  g42(.a(new_n56_), .b(new_n70_), .c(x14), .d(x13), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n69_), .c(new_n30_), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n40_), .c(x02), .O(new_n73_));
  nand2  g45(.a(x08), .b(x04), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(x10), .c(new_n74_), .O(z5));
  aoi21  g47(.a(new_n39_), .b(x02), .c(new_n40_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(x05), .O(new_n77_));
  ...
  nand4  g54(.a(new_n82_), .b(new_n39_), .c(x09), .d(new_n40_), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(x02), .c(new_n77_), .O(z6));
  nand3  g56(.a(x16), .b(x15), .c(x14), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n31_), .c(x17), .O(new_n86_));
  inv1   g58(.a(new_n31_), .O(new_n87_));
  nand4  g59(.a(new_n33_), .b(new_n87_), .c(new_n34_), .d(x16), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n86_), .c(new_n30_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n40_), .c(x02), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(x10), .c(new_n91_), .O(z7));
  nand2  g64(.a(new_n76_), .b(x07), .O(new_n93_));
  ...
  nand4  g69(.a(new_n97_), .b(new_n96_), .c(new_n35_), .d(x17), .O(new_n98_));
