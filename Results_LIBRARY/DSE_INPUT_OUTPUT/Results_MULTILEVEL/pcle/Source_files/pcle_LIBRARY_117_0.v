...
module FAU ( 
  ...
  nand4  g19(.a(new_n47_), .b(x13), .c(new_n31_), .d(x09), .O(new_n48_));
  ...
  nand4  g50(.a(new_n78_), .b(x13), .c(new_n31_), .d(x09), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(x08), .c(new_n73_), .O(z6));
  inv1   g52(.a(x09), .O(new_n81_));
  nand3  g53(.a(x16), .b(x15), .c(x14), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n50_), .c(x17), .O(new_n83_));
  nand3  g55(.a(x14), .b(x12), .c(x11), .O(new_n84_));
  inv1   g56(.a(new_n84_), .O(new_n85_));
  nor2   g57(.a(x17), .b(new_n76_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n85_), .c(x15), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n83_), .c(new_n81_), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n30_), .c(new_n44_), .O(new_n89_));
  nand2  g61(.a(x08), .b(x06), .O(new_n90_));
  oai21  g62(.a(new_n89_), .b(x10), .c(new_n90_), .O(z7));
  nand3  g63(.a(x17), .b(x16), .c(x15), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n84_), .c(x18), .O(new_n93_));
  and2   g65(.a(x16), .b(x15), .O(new_n94_));
  nand4  g66(.a(new_n85_), .b(new_n94_), .c(new_n29_), .d(x17), .O(new_n95_));
  aoi21  g67(.a(new_n95_), .b(new_n93_), .c(new_n81_), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n30_), .c(new_n44_), .O(new_n97_));
