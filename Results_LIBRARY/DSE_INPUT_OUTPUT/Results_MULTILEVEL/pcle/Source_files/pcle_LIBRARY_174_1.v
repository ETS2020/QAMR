...
module FAU ( 
  ...
  oai21  g27(.a(new_n38_), .b(x14), .c(x08), .O(new_n56_));
  ...
  nand3  g33(.a(new_n38_), .b(new_n61_), .c(x13), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n49_), .c(new_n60_), .O(new_n63_));
  ...
  nand3  g38(.a(new_n50_), .b(new_n38_), .c(x13), .O(new_n67_));
  aoi21  g39(.a(new_n67_), .b(new_n66_), .c(new_n61_), .O(new_n68_));
  ...
  nand3  g43(.a(new_n31_), .b(x09), .c(new_n30_), .O(new_n72_));
  inv1   g44(.a(x16), .O(new_n73_));
  nand3  g45(.a(new_n50_), .b(new_n73_), .c(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n72_), .c(x14), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(x15), .O(new_n76_));
  nand3  g48(.a(new_n50_), .b(x15), .c(x13), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(x16), .c(new_n31_), .O(new_n78_));
  inv1   g50(.a(new_n78_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(x09), .c(new_n30_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x05), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n80_), .c(new_n76_), .O(z6));
  nand2  g54(.a(new_n57_), .b(x06), .O(new_n83_));
  nand2  g55(.a(x16), .b(x13), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n49_), .c(x17), .O(new_n85_));
  ...
  nand2  g60(.a(new_n88_), .b(x14), .O(new_n89_));
  nand2  g61(.a(x17), .b(new_n38_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand4  g63(.a(new_n91_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n92_));
  nand2  g64(.a(new_n92_), .b(new_n83_), .O(z7));
  nand2  g65(.a(new_n57_), .b(x07), .O(new_n94_));
  nand3  g66(.a(x17), .b(x16), .c(x13), .O(new_n95_));
  oai21  g67(.a(new_n95_), .b(new_n49_), .c(x18), .O(new_n96_));
  nand4  g68(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n59_), .c(new_n96_), .O(new_n98_));
  nand2  g70(.a(new_n98_), .b(x14), .O(new_n99_));
  nand2  g71(.a(x18), .b(new_n38_), .O(new_n100_));
