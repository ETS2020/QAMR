...
module FAU ( 
  ...
  nand2  g16(.a(x09), .b(new_n30_), .O(new_n45_));
  oai21  g17(.a(x12), .b(x10), .c(x08), .O(new_n46_));
  nand3  g18(.a(x12), .b(new_n38_), .c(new_n31_), .O(new_n47_));
  oai22  g19(.a(new_n47_), .b(new_n45_), .c(new_n46_), .d(new_n44_), .O(z2));
  inv1   g20(.a(x02), .O(new_n49_));
  xor2a  g21(.a(x13), .b(x11), .O(new_n50_));
  nand4  g22(.a(new_n50_), .b(x12), .c(new_n31_), .d(x09), .O(new_n51_));
  oai22  g23(.a(new_n51_), .b(x08), .c(new_n46_), .d(new_n49_), .O(z3));
  ...
  nand3  g36(.a(new_n64_), .b(x13), .c(x11), .O(new_n65_));
  ...
  oai21  g40(.a(new_n68_), .b(x08), .c(x12), .O(new_n69_));
  ...
  oai21  g46(.a(new_n74_), .b(new_n55_), .c(x16), .O(new_n75_));
  ...
  nand4  g50(.a(new_n78_), .b(x12), .c(new_n31_), .d(x09), .O(new_n79_));
  oai22  g51(.a(new_n79_), .b(x08), .c(new_n46_), .d(new_n73_), .O(z6));
  ...
  nand4  g59(.a(new_n87_), .b(x12), .c(new_n31_), .d(x09), .O(new_n88_));
  oai22  g60(.a(new_n88_), .b(x08), .c(new_n46_), .d(new_n81_), .O(z7));
  ...
  oai21  g65(.a(new_n93_), .b(new_n84_), .c(new_n92_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(x12), .c(new_n31_), .d(x09), .O(new_n95_));
  oai22  g67(.a(new_n95_), .b(x08), .c(new_n46_), .d(new_n90_), .O(z8));
endmodule
