...
module FAU ( 
  ...
  oai21  g45(.a(new_n73_), .b(new_n53_), .c(x16), .O(new_n74_));
  ...
  aoi21  g49(.a(new_n77_), .b(new_n43_), .c(x10), .O(new_n78_));
  nand2  g50(.a(x08), .b(x05), .O(new_n79_));
  oai21  g51(.a(new_n78_), .b(new_n29_), .c(new_n79_), .O(z6));
  nand2  g52(.a(new_n51_), .b(x06), .O(new_n81_));
  ...
  nor2   g62(.a(new_n75_), .b(new_n37_), .O(new_n91_));
