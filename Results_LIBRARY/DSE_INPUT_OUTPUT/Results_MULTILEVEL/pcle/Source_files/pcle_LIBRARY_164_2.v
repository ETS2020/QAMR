...
module FAU ( 
  ...
  aoi21  g12(.a(new_n40_), .b(x07), .c(new_n39_), .O(new_n41_));
  ...
  oai21  g20(.a(new_n48_), .b(x07), .c(new_n46_), .O(z2));
  ...
  aoi21  g25(.a(new_n53_), .b(new_n51_), .c(new_n30_), .O(new_n54_));
  aoi21  g26(.a(new_n54_), .b(new_n39_), .c(x07), .O(new_n55_));
  nand2  g27(.a(x08), .b(x02), .O(new_n56_));
  oai21  g28(.a(new_n55_), .b(x10), .c(new_n56_), .O(z3));
  nand2  g29(.a(new_n31_), .b(x14), .O(new_n58_));
  nand4  g30(.a(new_n33_), .b(x13), .c(x12), .d(x11), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n58_), .c(new_n30_), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n39_), .c(x07), .O(new_n61_));
  ...
  oai22  g39(.a(new_n67_), .b(new_n50_), .c(new_n66_), .d(new_n34_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(x07), .c(new_n64_), .O(z5));
  ...
  oai21  g47(.a(new_n75_), .b(new_n31_), .c(new_n73_), .O(new_n76_));
  nand4  g48(.a(new_n76_), .b(new_n40_), .c(x09), .d(new_n39_), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(x07), .c(new_n71_), .O(z6));
  ...
  oai21  g57(.a(new_n85_), .b(x07), .c(new_n79_), .O(z7));
  oai21  g58(.a(new_n40_), .b(x08), .c(x07), .O(new_n87_));
  nand4  g59(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n31_), .c(x18), .O(new_n89_));
