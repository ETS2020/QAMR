...
module FAU ( 
  ...
  oai22  g42(.a(new_n70_), .b(new_n50_), .c(new_n69_), .d(new_n67_), .O(new_n71_));
  ...
  nor2   g46(.a(new_n67_), .b(new_n60_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(x13), .c(x12), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n74_), .c(new_n31_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n39_), .O(new_n78_));
  nand2  g50(.a(new_n75_), .b(x13), .O(new_n79_));
  inv1   g51(.a(new_n79_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n51_), .c(new_n39_), .O(new_n81_));
