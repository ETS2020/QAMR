...
module FAU ( 
  ...
  nand2  g33(.a(x10), .b(x03), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(x08), .c(x04), .O(new_n63_));
  nand2  g35(.a(new_n54_), .b(x15), .O(new_n64_));
  ...
  nor2   g63(.a(new_n56_), .b(new_n48_), .O(new_n92_));
  ...
  nand4  g67(.a(new_n95_), .b(new_n39_), .c(x09), .d(new_n30_), .O(new_n96_));
  aoi21  g68(.a(x08), .b(x07), .c(new_n78_), .O(new_n97_));
