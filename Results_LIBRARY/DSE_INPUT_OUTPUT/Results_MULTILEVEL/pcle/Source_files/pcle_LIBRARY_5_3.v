...
module FAU ( 
  ...
  aoi21  g14(.a(x10), .b(x09), .c(new_n39_), .O(new_n43_));
  ...
  nand2  g27(.a(new_n43_), .b(x03), .O(new_n56_));
  ...
  oai21  g45(.a(new_n73_), .b(new_n57_), .c(new_n71_), .O(new_n74_));
  ...
  oai21  g50(.a(new_n78_), .b(new_n57_), .c(x17), .O(new_n79_));
  ...
  aoi21  g62(.a(new_n90_), .b(new_n87_), .c(x08), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(x10), .c(x09), .O(new_n92_));
