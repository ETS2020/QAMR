...
module FAU ( 
  ...
  nor2   g22(.a(new_n50_), .b(x08), .O(new_n51_));
  nand2  g23(.a(x13), .b(x12), .O(new_n52_));
  inv1   g24(.a(new_n52_), .O(new_n53_));
  nand3  g25(.a(new_n53_), .b(new_n51_), .c(new_n31_), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(x12), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(new_n38_), .O(new_n56_));
  inv1   g28(.a(x13), .O(new_n57_));
  nand3  g29(.a(new_n57_), .b(x12), .c(x11), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(x12), .c(new_n58_), .O(new_n59_));
  nand4  g31(.a(new_n59_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n60_));
  nand2  g32(.a(x08), .b(x02), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n60_), .c(new_n56_), .O(z3));
  nand3  g34(.a(new_n51_), .b(x14), .c(new_n31_), .O(new_n63_));
  ...
  oai21  g39(.a(new_n53_), .b(new_n66_), .c(new_n67_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n69_));
  nand2  g41(.a(x08), .b(x03), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n69_), .c(new_n65_), .O(z4));
  nand2  g43(.a(new_n45_), .b(x04), .O(new_n72_));
  inv1   g44(.a(x15), .O(new_n73_));
  nand4  g45(.a(new_n73_), .b(x14), .c(x13), .d(x11), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(x11), .c(new_n74_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(x12), .O(new_n76_));
  nand2  g48(.a(new_n53_), .b(x14), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(x15), .c(x11), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nand4  g51(.a(new_n79_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n72_), .O(z5));
  nand2  g53(.a(new_n45_), .b(x05), .O(new_n82_));
  nand2  g54(.a(x16), .b(new_n44_), .O(new_n83_));
  ...
  nand2  g58(.a(new_n86_), .b(x11), .O(new_n87_));
  nand4  g59(.a(x15), .b(x14), .c(x13), .d(x11), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(x16), .c(x12), .O(new_n89_));
  ...
  nand3  g64(.a(new_n51_), .b(x17), .c(new_n31_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(x12), .O(new_n94_));
  nand2  g66(.a(new_n94_), .b(new_n38_), .O(new_n95_));
  nand3  g67(.a(x16), .b(x15), .c(x14), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n52_), .c(x17), .O(new_n97_));
  nand2  g69(.a(new_n53_), .b(x11), .O(new_n98_));
  inv1   g70(.a(x17), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(x16), .c(x15), .d(x14), .O(new_n100_));
  ...
  nand3  g76(.a(new_n51_), .b(x18), .c(new_n31_), .O(new_n105_));
  nand2  g77(.a(new_n105_), .b(x12), .O(new_n106_));
  nand2  g78(.a(new_n106_), .b(new_n38_), .O(new_n107_));
  ...
  nand4  g82(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n111_));
  nand4  g83(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n112_));
  oai21  g84(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nand4  g85(.a(new_n113_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n114_));
  nand2  g86(.a(x08), .b(x07), .O(new_n115_));
  nand3  g87(.a(new_n115_), .b(new_n114_), .c(new_n107_), .O(z8));
endmodule
