...
module FAU ( 
  ...
  aoi21  g28(.a(new_n56_), .b(new_n32_), .c(x07), .O(new_n57_));
  ...
  oai22  g45(.a(new_n73_), .b(x07), .c(new_n41_), .d(new_n67_), .O(z5));
  ...
  oai22  g53(.a(new_n81_), .b(x07), .c(new_n41_), .d(new_n75_), .O(z6));
  ...
  nand3  g69(.a(x10), .b(x08), .c(x07), .O(new_n98_));
