...
module FAU ( 
  ...
  aoi21  g26(.a(new_n40_), .b(new_n54_), .c(new_n41_), .O(new_n55_));
  ...
  nand4  g33(.a(new_n61_), .b(x09), .c(new_n41_), .d(x06), .O(new_n62_));
  ...
  aoi21  g37(.a(new_n65_), .b(new_n64_), .c(new_n29_), .O(new_n66_));
  aoi21  g38(.a(new_n66_), .b(new_n41_), .c(new_n54_), .O(new_n67_));
  nand2  g39(.a(x08), .b(x03), .O(new_n68_));
  oai21  g40(.a(new_n67_), .b(x10), .c(new_n68_), .O(z4));
  nand2  g41(.a(new_n55_), .b(x04), .O(new_n70_));
  nand4  g42(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n71_));
  inv1   g43(.a(new_n71_), .O(new_n72_));
  nand3  g44(.a(new_n33_), .b(x14), .c(x13), .O(new_n73_));
  oai22  g45(.a(new_n73_), .b(new_n57_), .c(new_n72_), .d(new_n33_), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(new_n40_), .c(x09), .d(new_n41_), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n54_), .c(new_n70_), .O(z5));
  nand3  g48(.a(x15), .b(x14), .c(x13), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n57_), .c(x16), .O(new_n78_));
  inv1   g50(.a(x16), .O(new_n79_));
  inv1   g51(.a(new_n30_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n79_), .c(x15), .d(x14), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n78_), .c(new_n29_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n41_), .c(new_n54_), .O(new_n83_));
  ...
  aoi21  g61(.a(new_n89_), .b(x09), .c(new_n54_), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(x10), .c(new_n91_), .O(z7));
  nand2  g64(.a(new_n55_), .b(x07), .O(new_n93_));
  nand4  g65(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n30_), .c(x18), .O(new_n95_));
  nor2   g67(.a(new_n79_), .b(new_n33_), .O(new_n96_));
  nand4  g68(.a(new_n96_), .b(new_n72_), .c(new_n36_), .d(x17), .O(new_n97_));
  aoi21  g69(.a(new_n97_), .b(new_n95_), .c(x10), .O(new_n98_));
  nand4  g70(.a(new_n98_), .b(x09), .c(new_n41_), .d(x06), .O(new_n99_));
