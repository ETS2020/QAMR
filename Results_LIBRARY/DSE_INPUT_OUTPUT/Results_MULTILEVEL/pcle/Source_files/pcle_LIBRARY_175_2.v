...
module FAU ( 
  ...
  aoi21  g11(.a(new_n33_), .b(x06), .c(new_n32_), .O(new_n40_));
  ...
  nand2  g31(.a(new_n40_), .b(x03), .O(new_n60_));
  ...
  nand2  g38(.a(new_n40_), .b(x04), .O(new_n67_));
  ...
  nand2  g44(.a(x15), .b(new_n30_), .O(new_n73_));
  aoi21  g45(.a(new_n73_), .b(new_n72_), .c(x10), .O(new_n74_));
  nand4  g46(.a(new_n74_), .b(x09), .c(new_n32_), .d(new_n31_), .O(new_n75_));
  ...
  inv1   g51(.a(new_n61_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n79_), .c(x15), .d(x14), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n78_), .c(new_n51_), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n32_), .c(x06), .O(new_n83_));
  nand2  g55(.a(x08), .b(x05), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(x10), .c(new_n84_), .O(z6));
  nand3  g57(.a(x16), .b(x15), .c(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n61_), .c(x17), .O(new_n87_));
  inv1   g59(.a(x17), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(x16), .c(x15), .d(x14), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n61_), .c(new_n87_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n91_));
  nand3  g63(.a(x10), .b(x08), .c(x06), .O(new_n92_));
  oai21  g64(.a(new_n91_), .b(x06), .c(new_n92_), .O(z7));
  nand2  g65(.a(new_n33_), .b(x06), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(x08), .c(x07), .O(new_n95_));
  nand4  g67(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n61_), .c(x18), .O(new_n97_));
  nor2   g69(.a(new_n79_), .b(new_n69_), .O(new_n98_));
  nand4  g70(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n99_));
  inv1   g71(.a(new_n99_), .O(new_n100_));
  nand4  g72(.a(new_n100_), .b(new_n98_), .c(new_n29_), .d(x17), .O(new_n101_));
  aoi21  g73(.a(new_n101_), .b(new_n97_), .c(x10), .O(new_n102_));
  nand4  g74(.a(new_n102_), .b(x09), .c(new_n32_), .d(new_n31_), .O(new_n103_));
  nand2  g75(.a(new_n103_), .b(new_n95_), .O(z8));
endmodule
