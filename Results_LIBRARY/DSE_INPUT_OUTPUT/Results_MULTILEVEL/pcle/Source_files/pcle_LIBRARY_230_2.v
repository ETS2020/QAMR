...
module FAU ( 
  ...
  oai21  g33(.a(x10), .b(new_n31_), .c(x08), .O(new_n62_));
  ...
  nand4  g39(.a(new_n67_), .b(x09), .c(new_n32_), .d(new_n31_), .O(new_n68_));
  ...
  aoi21  g46(.a(new_n74_), .b(new_n32_), .c(x07), .O(new_n75_));
