...
module FAU ( 
  ...
  aoi21  g22(.a(new_n50_), .b(new_n48_), .c(x08), .O(new_n51_));
  oai21  g23(.a(new_n51_), .b(x10), .c(x09), .O(new_n52_));
  nand2  g24(.a(x08), .b(x02), .O(new_n53_));
  nand2  g25(.a(new_n53_), .b(new_n52_), .O(z3));
  nand2  g26(.a(x10), .b(x09), .O(new_n55_));
  nand3  g27(.a(new_n55_), .b(x08), .c(x03), .O(new_n56_));
  ...
  oai21  g32(.a(new_n60_), .b(new_n47_), .c(new_n58_), .O(new_n61_));
