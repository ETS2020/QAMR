...
module FAU ( 
  ...
  oai21  g11(.a(x16), .b(new_n39_), .c(x08), .O(new_n40_));
  ...
  nor2   g18(.a(x16), .b(new_n39_), .O(new_n47_));
  ...
  aoi21  g30(.a(new_n58_), .b(x16), .c(new_n39_), .O(new_n59_));
  nand2  g31(.a(x12), .b(x11), .O(new_n60_));
  nand3  g32(.a(x16), .b(new_n57_), .c(x13), .O(new_n61_));
  ...
  oai21  g40(.a(new_n68_), .b(new_n65_), .c(x16), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(x11), .O(new_n70_));
  inv1   g42(.a(new_n60_), .O(new_n71_));
  and2   g43(.a(x14), .b(x13), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n71_), .c(new_n66_), .O(new_n73_));
  ...
  nand2  g50(.a(new_n78_), .b(new_n71_), .O(new_n79_));
  nand4  g51(.a(new_n79_), .b(x16), .c(new_n31_), .d(x09), .O(new_n80_));
  aoi21  g52(.a(x08), .b(x05), .c(new_n47_), .O(new_n81_));
  oai21  g53(.a(new_n80_), .b(x08), .c(new_n81_), .O(z6));
  nand3  g54(.a(new_n42_), .b(x12), .c(new_n31_), .O(new_n83_));
  inv1   g55(.a(x17), .O(new_n84_));
  nand3  g56(.a(new_n72_), .b(new_n84_), .c(x15), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n83_), .c(x16), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(x11), .O(new_n87_));
  aoi21  g59(.a(new_n78_), .b(new_n71_), .c(new_n84_), .O(new_n88_));
  ...
  nand4  g63(.a(new_n72_), .b(new_n29_), .c(x17), .d(x15), .O(new_n92_));
  oai21  g64(.a(new_n92_), .b(new_n83_), .c(x16), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(x11), .O(new_n94_));
  nand2  g66(.a(new_n67_), .b(x11), .O(new_n95_));
  nand3  g67(.a(x17), .b(x15), .c(x14), .O(new_n96_));
  nor2   g68(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nor2   g69(.a(new_n97_), .b(new_n29_), .O(new_n98_));
