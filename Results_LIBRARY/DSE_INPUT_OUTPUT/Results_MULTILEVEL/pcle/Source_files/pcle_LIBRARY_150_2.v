...
module FAU ( 
  ...
  oai21  g34(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(new_n63_));
  nand4  g35(.a(new_n63_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n64_));
  nand2  g36(.a(x08), .b(x03), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n64_), .c(new_n57_), .O(z4));
  inv1   g38(.a(x15), .O(new_n67_));
  nor2   g39(.a(new_n67_), .b(new_n61_), .O(new_n68_));
  ...
  nand2  g43(.a(new_n58_), .b(x15), .O(new_n72_));
  nand2  g44(.a(new_n67_), .b(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n60_), .c(new_n72_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(x14), .O(new_n75_));
  nand2  g47(.a(x15), .b(new_n61_), .O(new_n76_));
  ...
  oai21  g54(.a(new_n82_), .b(new_n60_), .c(x16), .O(new_n83_));
  ...
  oai21  g68(.a(new_n45_), .b(new_n90_), .c(new_n96_), .O(z7));
  inv1   g69(.a(x07), .O(new_n98_));
  nand4  g70(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n99_));
  oai21  g71(.a(new_n99_), .b(new_n84_), .c(x18), .O(new_n100_));
  nand4  g72(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n101_));
  nand4  g73(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n102_));
  oai21  g74(.a(new_n102_), .b(new_n101_), .c(new_n100_), .O(new_n103_));
  nand4  g75(.a(new_n103_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n104_));
  oai21  g76(.a(new_n45_), .b(new_n98_), .c(new_n104_), .O(z8));
endmodule
