...
module FAU ( 
  ...
  nand3  g05(.a(new_n20_), .b(x6), .c(x3), .O(new_n21_));
  aoi21  g06(.a(new_n21_), .b(new_n19_), .c(new_n16_), .O(z0));
  inv1   g07(.a(x5), .O(new_n23_));
  aoi21  g08(.a(new_n23_), .b(new_n18_), .c(new_n16_), .O(new_n24_));
  inv1   g09(.a(x6), .O(new_n25_));
  oai21  g10(.a(new_n25_), .b(x3), .c(new_n17_), .O(new_n26_));
  aoi22  g11(.a(new_n26_), .b(new_n16_), .c(new_n24_), .d(new_n17_), .O(new_n27_));
  nand3  g12(.a(new_n16_), .b(new_n17_), .c(x0), .O(new_n28_));
  ...
  aoi21  g18(.a(new_n33_), .b(new_n18_), .c(new_n17_), .O(new_n34_));
  nand3  g19(.a(new_n23_), .b(new_n18_), .c(x2), .O(new_n35_));
  ...
  nand4  g25(.a(new_n40_), .b(new_n16_), .c(x1), .d(new_n32_), .O(new_n41_));
  nand2  g26(.a(x5), .b(new_n32_), .O(new_n42_));
  ...
  nor2   g30(.a(x7), .b(new_n25_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n20_), .c(new_n16_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n45_), .O(z3));
  nand2  g33(.a(x3), .b(new_n16_), .O(new_n49_));
  nand2  g34(.a(new_n18_), .b(x2), .O(new_n50_));
  oai21  g35(.a(new_n49_), .b(new_n32_), .c(new_n50_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n17_), .O(new_n52_));
  oai21  g37(.a(new_n16_), .b(x0), .c(x6), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(x3), .O(new_n54_));
  nand3  g39(.a(x6), .b(x3), .c(new_n17_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n16_), .c(new_n32_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n54_), .c(new_n52_), .O(z4));
  aoi21  g42(.a(new_n50_), .b(new_n49_), .c(new_n32_), .O(new_n58_));
  ...
  nand2  g46(.a(new_n50_), .b(x1), .O(new_n62_));
  ...
  nand2  g50(.a(new_n65_), .b(new_n32_), .O(new_n66_));
  nand2  g51(.a(new_n25_), .b(x3), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n66_), .c(new_n61_), .O(z5));
  inv1   g53(.a(new_n35_), .O(new_n69_));
  oai21  g54(.a(new_n58_), .b(new_n69_), .c(new_n17_), .O(new_n70_));
  oai21  g55(.a(x4), .b(x2), .c(new_n18_), .O(new_n71_));
  nand3  g56(.a(new_n71_), .b(x1), .c(new_n32_), .O(new_n72_));
