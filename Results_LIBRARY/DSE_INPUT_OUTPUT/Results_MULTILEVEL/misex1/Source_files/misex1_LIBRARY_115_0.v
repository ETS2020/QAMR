...
module FAU ( 
  ...
  nand3  g29(.a(x5), .b(x2), .c(new_n17_), .O(new_n45_));
  oai21  g30(.a(new_n44_), .b(new_n17_), .c(new_n45_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n19_), .O(new_n47_));
  nor2   g32(.a(new_n40_), .b(new_n20_), .O(new_n48_));
  nor2   g33(.a(x3), .b(x2), .O(new_n49_));
  aoi21  g34(.a(new_n48_), .b(new_n17_), .c(new_n49_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n47_), .O(z5));
  xor2a  g36(.a(x3), .b(x2), .O(new_n52_));
  aoi22  g37(.a(new_n52_), .b(x0), .c(new_n30_), .d(x2), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(x1), .c(new_n18_), .O(z6));
endmodule
