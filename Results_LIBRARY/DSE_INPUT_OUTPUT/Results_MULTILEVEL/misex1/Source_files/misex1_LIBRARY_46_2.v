...
module FAU ( 
  ...
  oai21  g11(.a(new_n20_), .b(new_n17_), .c(new_n19_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n16_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n26_), .O(z1));
  oai21  g14(.a(new_n20_), .b(x0), .c(x2), .O(new_n30_));
  ...
  nand3  g21(.a(new_n36_), .b(new_n35_), .c(new_n31_), .O(z2));
  ...
  nand3  g28(.a(new_n43_), .b(new_n42_), .c(new_n28_), .O(z4));
  ...
  aoi21  g33(.a(new_n48_), .b(new_n24_), .c(x0), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n47_), .c(new_n19_), .O(new_n50_));
  nand3  g35(.a(x3), .b(x2), .c(new_n17_), .O(new_n51_));
