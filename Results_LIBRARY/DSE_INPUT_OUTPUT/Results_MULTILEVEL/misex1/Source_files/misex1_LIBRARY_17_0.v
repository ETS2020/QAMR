...
module FAU ( 
  ...
  nand2  g13(.a(new_n23_), .b(new_n19_), .O(new_n29_));
  ...
  nand2  g30(.a(new_n37_), .b(new_n17_), .O(new_n46_));
  oai21  g31(.a(new_n45_), .b(x1), .c(new_n46_), .O(z5));
  aoi22  g32(.a(new_n44_), .b(x0), .c(new_n23_), .d(x2), .O(new_n48_));
  nand4  g33(.a(x3), .b(x2), .c(x1), .d(new_n17_), .O(new_n49_));
