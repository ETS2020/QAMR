...
module FAU ( 
  ...
  nand3  g14(.a(new_n29_), .b(new_n17_), .c(new_n20_), .O(new_n30_));
  oai21  g15(.a(new_n17_), .b(new_n20_), .c(new_n30_), .O(new_n31_));
  ...
  nand3  g23(.a(new_n38_), .b(x1), .c(new_n20_), .O(new_n39_));
  ...
  nand3  g34(.a(new_n49_), .b(new_n22_), .c(new_n20_), .O(new_n50_));
  oai21  g35(.a(new_n48_), .b(x1), .c(new_n50_), .O(z4));
  nand2  g36(.a(new_n46_), .b(x0), .O(new_n52_));
  nand3  g37(.a(new_n34_), .b(x2), .c(new_n20_), .O(new_n53_));
  ...
  aoi22  g43(.a(new_n46_), .b(x0), .c(new_n23_), .d(x2), .O(new_n59_));
