...
module FAU ( 
  ...
  aoi21  g29(.a(new_n21_), .b(x2), .c(new_n19_), .O(new_n45_));
  nand3  g30(.a(x6), .b(new_n21_), .c(new_n20_), .O(new_n46_));
  inv1   g31(.a(new_n46_), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n45_), .c(new_n16_), .O(new_n48_));
  oai21  g33(.a(new_n22_), .b(x1), .c(new_n21_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(x2), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n48_), .c(new_n41_), .O(z5));
  oai21  g36(.a(x4), .b(x2), .c(new_n21_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(x1), .c(new_n16_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n41_), .c(new_n38_), .O(z6));
endmodule
