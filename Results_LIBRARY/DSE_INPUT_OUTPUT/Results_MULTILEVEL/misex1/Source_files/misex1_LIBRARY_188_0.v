...
module FAU ( 
  ...
  oai21  g25(.a(new_n40_), .b(x1), .c(new_n34_), .O(z5));
  aoi22  g26(.a(new_n35_), .b(x0), .c(new_n27_), .d(x2), .O(new_n42_));
  nand4  g27(.a(x3), .b(x2), .c(x1), .d(new_n17_), .O(new_n43_));
  oai21  g28(.a(new_n42_), .b(x1), .c(new_n43_), .O(z6));
endmodule
