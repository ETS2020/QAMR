...
module FAU ( 
  ...
  nand3  g21(.a(new_n36_), .b(new_n23_), .c(new_n19_), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(new_n31_), .c(x0), .O(z2));
  oai21  g23(.a(x4), .b(x3), .c(x7), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n20_), .c(x1), .O(new_n40_));
  nand3  g25(.a(new_n21_), .b(x2), .c(new_n19_), .O(new_n41_));
  ...
  aoi21  g29(.a(new_n44_), .b(new_n43_), .c(x0), .O(z4));
  oai21  g30(.a(x3), .b(new_n20_), .c(x1), .O(new_n46_));
  nand2  g31(.a(x3), .b(x2), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n46_), .c(new_n24_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n16_), .O(new_n49_));
  oai21  g34(.a(new_n32_), .b(new_n20_), .c(new_n16_), .O(new_n50_));
  ...
  aoi21  g39(.a(new_n21_), .b(x2), .c(x0), .O(new_n55_));
  oai22  g40(.a(new_n55_), .b(x1), .c(new_n54_), .d(x0), .O(z6));
endmodule
