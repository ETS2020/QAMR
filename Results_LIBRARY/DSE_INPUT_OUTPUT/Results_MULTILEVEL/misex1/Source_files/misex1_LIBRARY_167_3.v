...
module FAU ( 
  ...
  aoi21  g44(.a(new_n53_), .b(new_n52_), .c(new_n17_), .O(new_n60_));
  nand3  g45(.a(x5), .b(new_n20_), .c(x2), .O(new_n61_));
  ...
  nand3  g53(.a(new_n68_), .b(new_n63_), .c(new_n16_), .O(z5));
  nand3  g54(.a(new_n29_), .b(new_n20_), .c(x2), .O(new_n70_));
