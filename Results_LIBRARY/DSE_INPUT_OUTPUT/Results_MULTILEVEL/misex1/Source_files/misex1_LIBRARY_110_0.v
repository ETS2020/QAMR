...
module FAU ( 
  ...
  nand2  g30(.a(new_n39_), .b(x0), .O(new_n46_));
  nand3  g31(.a(x5), .b(x2), .c(new_n17_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n18_), .O(new_n49_));
  inv1   g34(.a(new_n39_), .O(new_n50_));
  aoi21  g35(.a(new_n19_), .b(x2), .c(new_n18_), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n50_), .c(new_n17_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n49_), .c(new_n44_), .O(z5));
  oai21  g38(.a(x5), .b(x3), .c(new_n46_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n18_), .O(new_n55_));
  aoi22  g40(.a(new_n51_), .b(new_n17_), .c(new_n19_), .d(new_n16_), .O(new_n56_));
