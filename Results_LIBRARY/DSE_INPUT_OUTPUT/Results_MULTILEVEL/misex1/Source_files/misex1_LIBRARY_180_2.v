...
module FAU ( 
  ...
  aoi21  g33(.a(new_n48_), .b(new_n28_), .c(new_n19_), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n16_), .c(new_n47_), .O(z3));
  nand2  g35(.a(x3), .b(new_n16_), .O(new_n51_));
  nand3  g36(.a(x4), .b(new_n23_), .c(x2), .O(new_n52_));
  oai21  g37(.a(new_n51_), .b(new_n17_), .c(new_n52_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n28_), .O(new_n54_));
  aoi21  g39(.a(x3), .b(new_n28_), .c(x2), .O(new_n55_));
  nand3  g40(.a(x4), .b(x3), .c(x2), .O(new_n56_));
  inv1   g41(.a(new_n56_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n55_), .c(new_n17_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n54_), .O(z4));
  aoi21  g44(.a(new_n52_), .b(new_n51_), .c(new_n17_), .O(new_n60_));
  nand4  g45(.a(x5), .b(x4), .c(x2), .d(new_n17_), .O(new_n61_));
  inv1   g46(.a(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n60_), .c(new_n28_), .O(new_n63_));
  oai21  g48(.a(new_n57_), .b(new_n30_), .c(new_n17_), .O(new_n64_));
  ...
  nand2  g52(.a(new_n67_), .b(new_n28_), .O(new_n68_));
  oai21  g53(.a(x4), .b(x2), .c(new_n23_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(x1), .c(new_n17_), .O(new_n70_));
  nand2  g55(.a(new_n19_), .b(x2), .O(new_n71_));
  nand3  g56(.a(new_n71_), .b(new_n70_), .c(new_n68_), .O(z6));
endmodule
