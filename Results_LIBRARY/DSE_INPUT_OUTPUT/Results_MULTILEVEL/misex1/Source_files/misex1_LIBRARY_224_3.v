...
module FAU ( 
  ...
  aoi21  g32(.a(new_n20_), .b(x2), .c(new_n23_), .O(new_n48_));
  nand3  g33(.a(x6), .b(new_n20_), .c(new_n17_), .O(new_n49_));
  inv1   g34(.a(new_n49_), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(new_n48_), .c(new_n16_), .O(new_n51_));
  oai21  g36(.a(new_n27_), .b(x1), .c(new_n20_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(x2), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n51_), .c(new_n22_), .O(z5));
