...
module FAU ( 
  ...
  oai21  g28(.a(new_n16_), .b(x0), .c(x1), .O(new_n44_));
  nand3  g29(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n45_));
  inv1   g30(.a(new_n45_), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n28_), .c(x0), .O(new_n47_));
  aoi21  g32(.a(new_n20_), .b(x1), .c(x0), .O(new_n48_));
  nor3   g33(.a(x5), .b(x3), .c(x1), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n48_), .c(x2), .O(new_n50_));
  nand3  g35(.a(new_n20_), .b(new_n16_), .c(new_n17_), .O(new_n51_));
  ...
  oai21  g43(.a(new_n23_), .b(x1), .c(new_n20_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(x2), .c(new_n17_), .O(new_n60_));
  nand4  g45(.a(new_n60_), .b(new_n58_), .c(new_n56_), .d(new_n31_), .O(z5));
