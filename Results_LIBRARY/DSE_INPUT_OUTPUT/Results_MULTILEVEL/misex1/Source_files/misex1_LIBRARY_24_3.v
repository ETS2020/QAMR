...
module FAU ( 
  ...
  aoi21  g16(.a(new_n31_), .b(new_n29_), .c(x0), .O(new_n32_));
  ...
  nor3   g20(.a(x5), .b(x3), .c(x0), .O(new_n36_));
  oai21  g21(.a(new_n36_), .b(x1), .c(x2), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n35_), .O(z2));
  oai21  g23(.a(x4), .b(x3), .c(x7), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n20_), .c(x2), .O(new_n40_));
  nand2  g25(.a(x5), .b(new_n20_), .O(new_n41_));
  ...
  oai21  g29(.a(x5), .b(x3), .c(x0), .O(new_n45_));
  aoi22  g30(.a(new_n45_), .b(x2), .c(new_n44_), .d(x0), .O(new_n46_));
  ...
  nor2   g37(.a(new_n21_), .b(x0), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n52_), .c(new_n16_), .O(new_n54_));
  nand2  g39(.a(new_n24_), .b(new_n20_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n54_), .O(z5));
  oai21  g41(.a(new_n50_), .b(x1), .c(new_n51_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(x0), .O(new_n58_));
  inv1   g43(.a(x4), .O(new_n59_));
  nor2   g44(.a(new_n59_), .b(x3), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(x0), .c(new_n26_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(x1), .O(new_n62_));
  inv1   g47(.a(x5), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n17_), .c(x2), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n62_), .c(new_n58_), .O(z6));
endmodule
