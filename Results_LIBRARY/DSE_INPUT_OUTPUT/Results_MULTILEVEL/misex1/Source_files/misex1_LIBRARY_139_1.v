...
module FAU ( 
  ...
  nor2   g12(.a(x6), .b(new_n20_), .O(new_n28_));
  nand4  g13(.a(new_n28_), .b(new_n16_), .c(new_n19_), .d(x0), .O(new_n29_));
  ...
  nand3  g23(.a(new_n38_), .b(new_n24_), .c(new_n16_), .O(new_n39_));
  nor2   g24(.a(new_n20_), .b(new_n16_), .O(new_n40_));
  inv1   g25(.a(new_n40_), .O(new_n41_));
  aoi21  g26(.a(new_n41_), .b(new_n39_), .c(new_n19_), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(new_n36_), .c(new_n17_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n29_), .O(z2));
  nand2  g29(.a(new_n38_), .b(x7), .O(new_n45_));
  ...
  nand2  g36(.a(new_n24_), .b(x3), .O(new_n52_));
  nand2  g37(.a(new_n20_), .b(x2), .O(new_n53_));
  nand2  g38(.a(new_n16_), .b(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n52_), .c(new_n53_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n19_), .O(new_n56_));
  aoi21  g41(.a(x3), .b(new_n19_), .c(x6), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n16_), .c(new_n40_), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(x0), .c(new_n56_), .O(z4));
  nand3  g44(.a(new_n24_), .b(x3), .c(new_n16_), .O(new_n60_));
  aoi21  g45(.a(new_n53_), .b(new_n60_), .c(new_n17_), .O(new_n61_));
  nor3   g46(.a(new_n32_), .b(new_n16_), .c(x0), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n61_), .c(new_n19_), .O(new_n63_));
  aoi21  g48(.a(new_n52_), .b(x2), .c(new_n19_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n40_), .c(new_n17_), .O(new_n65_));
  nor2   g50(.a(new_n24_), .b(x2), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n65_), .c(new_n63_), .O(z5));
  nand3  g53(.a(new_n32_), .b(new_n20_), .c(x2), .O(new_n69_));
  inv1   g54(.a(new_n69_), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n61_), .c(new_n19_), .O(new_n71_));
  nand3  g56(.a(new_n24_), .b(new_n37_), .c(new_n16_), .O(new_n72_));
