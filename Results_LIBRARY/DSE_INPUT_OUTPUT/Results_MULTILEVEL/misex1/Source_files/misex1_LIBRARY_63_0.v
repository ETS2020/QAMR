...
module FAU ( 
  ...
  nand3  g20(.a(new_n22_), .b(new_n20_), .c(x0), .O(new_n36_));
  ...
  oai21  g25(.a(new_n17_), .b(new_n16_), .c(x3), .O(new_n41_));
  nand2  g26(.a(x4), .b(x1), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n21_), .c(new_n16_), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n41_), .c(new_n23_), .O(z6));
  oai21  g29(.a(new_n22_), .b(x0), .c(new_n39_), .O(z5));
endmodule
