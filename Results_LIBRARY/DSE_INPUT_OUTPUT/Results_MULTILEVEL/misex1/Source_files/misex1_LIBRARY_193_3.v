...
module FAU ( 
  ...
  aoi21  g07(.a(new_n22_), .b(x2), .c(new_n21_), .O(new_n23_));
  nand3  g08(.a(x5), .b(x2), .c(new_n21_), .O(new_n24_));
  nand3  g09(.a(x6), .b(new_n22_), .c(new_n16_), .O(new_n25_));
  ...
  aoi21  g15(.a(new_n30_), .b(new_n22_), .c(new_n21_), .O(new_n31_));
  inv1   g16(.a(x5), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(x2), .O(new_n33_));
  inv1   g18(.a(x6), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n22_), .c(new_n16_), .O(new_n35_));
  ...
  nand4  g26(.a(new_n41_), .b(new_n22_), .c(x2), .d(new_n21_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n40_), .O(z3));
  nand2  g28(.a(x3), .b(new_n21_), .O(new_n44_));
  xor2a  g29(.a(new_n44_), .b(new_n17_), .O(new_n45_));
  nand3  g30(.a(new_n22_), .b(x2), .c(new_n21_), .O(new_n46_));
  oai21  g31(.a(new_n45_), .b(x2), .c(new_n46_), .O(z4));
  nor2   g32(.a(new_n32_), .b(new_n16_), .O(new_n48_));
  aoi21  g33(.a(new_n22_), .b(new_n16_), .c(new_n17_), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n48_), .c(new_n21_), .O(new_n50_));
  inv1   g35(.a(new_n25_), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n23_), .c(new_n17_), .O(new_n52_));
  nand2  g37(.a(x3), .b(x2), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n52_), .c(new_n50_), .O(z5));
  inv1   g39(.a(new_n33_), .O(new_n55_));
  oai21  g40(.a(new_n49_), .b(new_n55_), .c(new_n21_), .O(new_n56_));
  oai21  g41(.a(x4), .b(x2), .c(new_n22_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(x1), .c(new_n17_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n56_), .c(new_n53_), .O(z6));
endmodule
