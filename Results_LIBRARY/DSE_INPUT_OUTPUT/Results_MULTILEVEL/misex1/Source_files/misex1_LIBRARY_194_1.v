...
module FAU ( 
  ...
  nand3  g16(.a(new_n26_), .b(x3), .c(new_n16_), .O(new_n32_));
  inv1   g17(.a(new_n32_), .O(new_n33_));
  nand3  g18(.a(new_n33_), .b(new_n19_), .c(x0), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n31_), .O(z1));
  oai21  g20(.a(new_n26_), .b(x2), .c(x3), .O(new_n36_));
  nor2   g21(.a(new_n36_), .b(new_n19_), .O(new_n37_));
  ...
  aoi21  g42(.a(new_n50_), .b(new_n32_), .c(new_n17_), .O(new_n58_));
  nor3   g43(.a(new_n23_), .b(new_n16_), .c(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n58_), .c(new_n19_), .O(new_n60_));
  nand2  g45(.a(new_n26_), .b(x1), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n27_), .c(x2), .O(new_n62_));
