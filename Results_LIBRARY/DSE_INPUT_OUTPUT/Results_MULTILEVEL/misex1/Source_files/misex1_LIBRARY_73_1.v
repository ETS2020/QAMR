...
module FAU ( 
  ...
  oai21  g25(.a(x3), .b(x2), .c(new_n40_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n17_), .O(new_n42_));
  nand4  g27(.a(x3), .b(new_n16_), .c(new_n20_), .d(x0), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n42_), .O(z4));
  nand3  g29(.a(x6), .b(new_n26_), .c(new_n16_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n40_), .c(new_n30_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n17_), .O(new_n47_));
  oai21  g32(.a(new_n26_), .b(new_n17_), .c(new_n16_), .O(new_n48_));
  ...
  oai21  g37(.a(new_n52_), .b(x0), .c(new_n49_), .O(z6));
endmodule
