...
module FAU ( 
  ...
  nand4  g40(.a(x5), .b(x3), .c(new_n16_), .d(x0), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n19_), .O(new_n58_));
  inv1   g43(.a(new_n42_), .O(new_n59_));
  aoi21  g44(.a(x3), .b(new_n19_), .c(new_n25_), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n16_), .c(new_n59_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(x0), .c(new_n58_), .O(z4));
  aoi21  g47(.a(new_n55_), .b(new_n34_), .c(new_n17_), .O(new_n63_));
  nor3   g48(.a(new_n25_), .b(new_n16_), .c(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n63_), .c(new_n19_), .O(new_n65_));
  nand2  g50(.a(new_n55_), .b(x1), .O(new_n66_));
  nand3  g51(.a(x6), .b(new_n20_), .c(new_n16_), .O(new_n67_));
  aoi21  g52(.a(new_n67_), .b(new_n66_), .c(new_n25_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n59_), .c(new_n17_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n65_), .O(z5));
  nand3  g55(.a(new_n25_), .b(new_n20_), .c(x2), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n63_), .c(new_n19_), .O(new_n73_));
  inv1   g58(.a(x4), .O(new_n74_));
  nand3  g59(.a(x5), .b(new_n74_), .c(new_n16_), .O(new_n75_));
  oai21  g60(.a(new_n23_), .b(new_n20_), .c(new_n75_), .O(new_n76_));
