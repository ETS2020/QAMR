...
module FAU ( 
  ...
  nand2  g24(.a(new_n28_), .b(new_n25_), .O(new_n40_));
  ...
  nand4  g29(.a(new_n44_), .b(new_n23_), .c(x2), .d(new_n16_), .O(new_n45_));
  inv1   g30(.a(x4), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n25_), .c(x1), .d(new_n32_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n45_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n17_), .O(new_n49_));
  nor2   g34(.a(x7), .b(x4), .O(new_n50_));
  nand4  g35(.a(new_n50_), .b(new_n25_), .c(x1), .d(new_n32_), .O(new_n51_));
  ...
  nand2  g44(.a(new_n22_), .b(x4), .O(new_n60_));
  nand4  g45(.a(new_n60_), .b(new_n25_), .c(x1), .d(new_n32_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n59_), .O(z4));
  xnor2a g47(.a(x3), .b(x2), .O(new_n63_));
  nor2   g48(.a(new_n63_), .b(new_n32_), .O(new_n64_));
  nor3   g49(.a(new_n26_), .b(new_n25_), .c(x0), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n64_), .c(new_n16_), .O(new_n66_));
  nand2  g51(.a(new_n57_), .b(x1), .O(new_n67_));
  nand3  g52(.a(x6), .b(new_n17_), .c(new_n25_), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(new_n67_), .c(new_n53_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n32_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n66_), .c(new_n31_), .O(z5));
  nand3  g56(.a(new_n26_), .b(new_n17_), .c(x2), .O(new_n72_));
  oai21  g57(.a(new_n63_), .b(new_n32_), .c(new_n72_), .O(new_n73_));
  aoi21  g58(.a(new_n73_), .b(new_n16_), .c(new_n18_), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(new_n31_), .c(new_n47_), .O(z6));
endmodule
