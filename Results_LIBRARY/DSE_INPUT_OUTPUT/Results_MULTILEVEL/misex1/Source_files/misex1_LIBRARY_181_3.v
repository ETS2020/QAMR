...
module FAU ( 
  ...
  aoi21  g19(.a(new_n34_), .b(new_n33_), .c(new_n25_), .O(new_n35_));
  ...
  aoi21  g27(.a(new_n24_), .b(x2), .c(new_n23_), .O(new_n43_));
  nand2  g28(.a(new_n23_), .b(new_n28_), .O(new_n44_));
  ...
  nand3  g36(.a(new_n51_), .b(new_n49_), .c(new_n26_), .O(z3));
  nand2  g37(.a(x3), .b(new_n28_), .O(new_n53_));
  ...
  nand2  g50(.a(x5), .b(new_n18_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n19_), .c(new_n28_), .O(new_n67_));
  ...
  nand3  g55(.a(new_n70_), .b(new_n65_), .c(new_n26_), .O(z5));
  nand2  g56(.a(new_n61_), .b(x0), .O(new_n72_));
  nand3  g57(.a(new_n29_), .b(new_n19_), .c(x2), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g59(.a(new_n74_), .b(new_n18_), .O(new_n75_));
  aoi21  g60(.a(new_n75_), .b(new_n64_), .c(new_n25_), .O(z6));
endmodule
