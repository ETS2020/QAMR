...
module FAU ( 
  ...
  nand3  g25(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(z4));
  oai21  g27(.a(new_n19_), .b(new_n17_), .c(new_n16_), .O(new_n43_));
  oai21  g28(.a(new_n23_), .b(x1), .c(new_n20_), .O(new_n44_));
  ...
  nand2  g34(.a(new_n49_), .b(new_n37_), .O(z6));
endmodule
