...
module FAU ( 
  ...
  oai21  g26(.a(x7), .b(new_n40_), .c(new_n41_), .O(new_n42_));
  ...
  oai21  g35(.a(new_n16_), .b(x0), .c(x4), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(x3), .O(new_n52_));
  nand3  g37(.a(x4), .b(x3), .c(new_n17_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n16_), .c(new_n20_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n52_), .c(new_n50_), .O(z4));
  aoi21  g40(.a(new_n48_), .b(new_n47_), .c(new_n20_), .O(new_n56_));
  nand3  g41(.a(x5), .b(new_n18_), .c(x2), .O(new_n57_));
  inv1   g42(.a(new_n57_), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n56_), .c(new_n17_), .O(new_n59_));
  nand2  g44(.a(new_n48_), .b(x1), .O(new_n60_));
  nand3  g45(.a(x6), .b(new_n18_), .c(new_n16_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n60_), .c(new_n32_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n20_), .O(new_n63_));
  nand2  g48(.a(new_n40_), .b(x3), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n63_), .c(new_n59_), .O(z5));
  nand3  g50(.a(new_n23_), .b(new_n18_), .c(x2), .O(new_n66_));
