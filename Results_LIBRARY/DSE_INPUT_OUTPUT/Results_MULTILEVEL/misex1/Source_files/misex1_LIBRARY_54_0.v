...
module FAU ( 
  ...
  nand3  g29(.a(new_n17_), .b(new_n23_), .c(x0), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n44_), .c(new_n42_), .O(z5));
  aoi22  g31(.a(new_n29_), .b(new_n16_), .c(x3), .d(x1), .O(new_n47_));
  oai21  g32(.a(new_n37_), .b(new_n16_), .c(new_n23_), .O(new_n48_));
  oai21  g33(.a(new_n47_), .b(x0), .c(new_n48_), .O(z6));
endmodule
