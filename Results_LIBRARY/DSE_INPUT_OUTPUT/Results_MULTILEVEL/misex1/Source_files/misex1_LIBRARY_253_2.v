...
module FAU ( 
  ...
  nor2   g23(.a(new_n16_), .b(x2), .O(new_n39_));
  ...
  oai21  g30(.a(new_n16_), .b(new_n23_), .c(new_n19_), .O(new_n46_));
  nand3  g31(.a(new_n16_), .b(x2), .c(new_n19_), .O(new_n47_));
  inv1   g32(.a(new_n47_), .O(new_n48_));
  aoi21  g33(.a(new_n46_), .b(new_n25_), .c(new_n48_), .O(new_n49_));
  oai21  g34(.a(new_n45_), .b(x0), .c(new_n49_), .O(z4));
  oai21  g35(.a(new_n48_), .b(new_n39_), .c(x0), .O(new_n51_));
  aoi21  g36(.a(x5), .b(new_n19_), .c(x3), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n25_), .c(new_n26_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n23_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n51_), .c(new_n18_), .O(z5));
  nand4  g40(.a(new_n31_), .b(new_n16_), .c(x2), .d(new_n19_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n51_), .c(new_n18_), .O(z6));
endmodule
