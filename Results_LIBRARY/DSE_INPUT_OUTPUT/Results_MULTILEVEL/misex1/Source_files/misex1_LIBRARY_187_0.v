...
module FAU ( 
  ...
  aoi21  g11(.a(x6), .b(new_n26_), .c(x1), .O(new_n27_));
  oai22  g12(.a(new_n27_), .b(x2), .c(new_n25_), .d(x1), .O(new_n28_));
  nand3  g13(.a(new_n28_), .b(x7), .c(new_n16_), .O(new_n29_));
  nand4  g14(.a(x3), .b(new_n21_), .c(new_n17_), .d(x0), .O(new_n30_));
  ...
  nand3  g24(.a(new_n39_), .b(new_n26_), .c(new_n17_), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n34_), .c(x7), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n16_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n30_), .O(z2));
  nand4  g28(.a(new_n32_), .b(new_n26_), .c(new_n21_), .d(x1), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(x7), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n16_), .O(new_n46_));
  nand2  g31(.a(x5), .b(new_n16_), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(new_n26_), .c(x2), .d(new_n17_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n46_), .O(z3));
  nand2  g34(.a(new_n26_), .b(x2), .O(new_n50_));
  nand2  g35(.a(x3), .b(new_n21_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n50_), .c(new_n16_), .O(new_n52_));
  nand2  g37(.a(x7), .b(x2), .O(new_n53_));
  nor2   g38(.a(new_n53_), .b(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n52_), .c(new_n17_), .O(new_n55_));
  oai21  g40(.a(new_n26_), .b(x1), .c(new_n21_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n18_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(x7), .c(new_n16_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n55_), .O(z4));
  nand4  g44(.a(x7), .b(x5), .c(x2), .d(new_n16_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n52_), .c(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n50_), .b(x1), .O(new_n63_));
  nand3  g48(.a(x6), .b(new_n26_), .c(new_n21_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n63_), .c(new_n18_), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(x7), .c(new_n16_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n62_), .O(z5));
  nand3  g52(.a(new_n22_), .b(x7), .c(new_n35_), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n52_), .c(new_n17_), .O(new_n70_));
  oai21  g55(.a(x4), .b(x2), .c(new_n26_), .O(new_n71_));
  nand4  g56(.a(new_n71_), .b(x7), .c(x1), .d(new_n16_), .O(new_n72_));
