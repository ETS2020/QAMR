...
module FAU ( 
  ...
  nand3  g43(.a(new_n23_), .b(new_n24_), .c(x2), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n34_), .c(new_n17_), .O(new_n60_));
  nand4  g45(.a(new_n23_), .b(x5), .c(x2), .d(new_n17_), .O(new_n61_));
  inv1   g46(.a(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n60_), .c(new_n22_), .O(new_n63_));
  nand3  g48(.a(new_n23_), .b(x3), .c(x2), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n30_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n17_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n63_), .O(z5));
  nand2  g52(.a(x7), .b(x2), .O(new_n68_));
  aoi21  g53(.a(new_n51_), .b(new_n34_), .c(new_n17_), .O(new_n69_));
  nand3  g54(.a(new_n25_), .b(new_n24_), .c(x2), .O(new_n70_));
  ...
  nand3  g59(.a(new_n74_), .b(new_n72_), .c(new_n68_), .O(z6));
endmodule
