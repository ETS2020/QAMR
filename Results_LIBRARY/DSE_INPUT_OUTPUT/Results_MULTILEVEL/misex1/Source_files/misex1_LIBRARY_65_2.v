...
module FAU ( 
  ...
  oai21  g23(.a(new_n19_), .b(new_n16_), .c(x0), .O(new_n39_));
  oai21  g24(.a(x4), .b(x3), .c(x7), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n16_), .c(x1), .O(new_n41_));
  nand4  g26(.a(new_n24_), .b(new_n23_), .c(x2), .d(new_n22_), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n41_), .c(new_n39_), .O(z3));
  ...
  oai21  g32(.a(x3), .b(x1), .c(x2), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(x0), .O(new_n49_));
  oai21  g34(.a(new_n23_), .b(x0), .c(x2), .O(new_n50_));
  ...
  nand4  g39(.a(new_n54_), .b(new_n53_), .c(new_n51_), .d(new_n49_), .O(z5));
  oai21  g40(.a(x4), .b(x2), .c(new_n23_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(x1), .c(new_n17_), .O(new_n57_));
  nand2  g42(.a(x5), .b(new_n17_), .O(new_n58_));
  nand4  g43(.a(new_n58_), .b(new_n23_), .c(x2), .d(new_n22_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n57_), .O(z6));
endmodule
