...
module FAU ( 
  ...
  nand2  g11(.a(new_n26_), .b(new_n22_), .O(z0));
  inv1   g12(.a(x2), .O(new_n28_));
  inv1   g13(.a(x5), .O(new_n29_));
  aoi21  g14(.a(new_n29_), .b(new_n19_), .c(new_n28_), .O(new_n30_));
  oai21  g15(.a(new_n23_), .b(x3), .c(new_n18_), .O(new_n31_));
  aoi22  g16(.a(new_n31_), .b(new_n28_), .c(new_n30_), .d(new_n18_), .O(new_n32_));
  nor2   g17(.a(x1), .b(new_n16_), .O(new_n33_));
  nand2  g18(.a(x3), .b(new_n28_), .O(new_n34_));
  inv1   g19(.a(new_n34_), .O(new_n35_));
  aoi21  g20(.a(new_n35_), .b(new_n33_), .c(new_n25_), .O(new_n36_));
  ...
  nand2  g25(.a(new_n23_), .b(new_n28_), .O(new_n41_));
  ...
  nand3  g33(.a(new_n48_), .b(new_n46_), .c(new_n26_), .O(z3));
  nand2  g34(.a(new_n19_), .b(x2), .O(new_n50_));
  oai21  g35(.a(new_n34_), .b(new_n16_), .c(new_n50_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n18_), .O(new_n52_));
  aoi21  g37(.a(x3), .b(new_n18_), .c(x2), .O(new_n53_));
  nor2   g38(.a(new_n19_), .b(new_n28_), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n53_), .c(new_n16_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n52_), .c(new_n26_), .O(z4));
  ...
  nand3  g49(.a(new_n24_), .b(x6), .c(new_n19_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n28_), .c(new_n16_), .O(new_n67_));
  oai21  g52(.a(new_n62_), .b(new_n25_), .c(new_n67_), .O(z5));
  nand3  g53(.a(new_n29_), .b(new_n19_), .c(x2), .O(new_n69_));
  oai21  g54(.a(new_n57_), .b(new_n16_), .c(new_n69_), .O(new_n70_));
  ...
  aoi21  g58(.a(new_n73_), .b(new_n71_), .c(new_n25_), .O(z6));
endmodule
