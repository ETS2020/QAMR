...
module FAU ( 
  ...
  nor2   g28(.a(new_n21_), .b(new_n20_), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(new_n43_), .c(new_n16_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n42_), .O(z4));
  oai21  g31(.a(new_n21_), .b(x1), .c(new_n20_), .O(new_n47_));
  ...
  oai21  g37(.a(new_n22_), .b(x1), .c(new_n21_), .O(new_n53_));
  ...
  nand2  g42(.a(new_n57_), .b(new_n38_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n16_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n27_), .O(z6));
endmodule
