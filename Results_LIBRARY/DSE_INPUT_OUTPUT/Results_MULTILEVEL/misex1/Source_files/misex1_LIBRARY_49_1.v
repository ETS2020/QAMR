...
module FAU ( 
  ...
  aoi21  g18(.a(new_n33_), .b(x3), .c(x4), .O(new_n34_));
  oai22  g19(.a(new_n34_), .b(x2), .c(new_n32_), .d(x0), .O(z1));
  oai21  g20(.a(new_n23_), .b(x2), .c(x3), .O(new_n36_));
  nor2   g21(.a(new_n36_), .b(new_n18_), .O(new_n37_));
  inv1   g22(.a(x5), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(x2), .O(new_n39_));
  nand3  g24(.a(new_n30_), .b(new_n23_), .c(new_n27_), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n39_), .c(x3), .O(new_n41_));
  aoi21  g26(.a(new_n41_), .b(new_n18_), .c(new_n37_), .O(new_n42_));
  nand4  g27(.a(new_n33_), .b(new_n23_), .c(x3), .d(new_n27_), .O(new_n43_));
  ...
  nor3   g45(.a(new_n38_), .b(new_n27_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n60_), .c(new_n18_), .O(new_n62_));
  aoi21  g47(.a(new_n19_), .b(x2), .c(new_n18_), .O(new_n63_));
  nand3  g48(.a(x6), .b(new_n19_), .c(new_n27_), .O(new_n64_));
  oai21  g49(.a(new_n19_), .b(new_n27_), .c(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n63_), .c(new_n16_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n62_), .c(new_n25_), .O(z5));
  aoi21  g52(.a(new_n28_), .b(x2), .c(new_n60_), .O(new_n68_));
  aoi21  g53(.a(new_n63_), .b(new_n16_), .c(new_n24_), .O(new_n69_));
