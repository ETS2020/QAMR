...
module FAU ( 
  ...
  nand4  g11(.a(x3), .b(new_n23_), .c(new_n16_), .d(x0), .O(new_n27_));
  ...
  nand3  g22(.a(new_n37_), .b(x1), .c(new_n20_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n35_), .c(new_n33_), .O(z2));
  nand2  g24(.a(new_n37_), .b(x7), .O(new_n40_));
  nand4  g25(.a(new_n40_), .b(new_n23_), .c(x1), .d(new_n20_), .O(new_n41_));
