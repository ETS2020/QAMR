...
module FAU ( 
  ...
  oai21  g21(.a(x3), .b(new_n22_), .c(new_n36_), .O(z3));
  ...
  nand3  g30(.a(x6), .b(new_n27_), .c(new_n22_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n45_), .c(new_n44_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n16_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n33_), .O(z5));
  oai21  g34(.a(x4), .b(x2), .c(new_n27_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(x1), .c(new_n16_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n33_), .O(z6));
endmodule
