...
module FAU ( 
  ...
  oai21  g09(.a(new_n24_), .b(new_n17_), .c(new_n22_), .O(new_n25_));
  ...
  nand2  g16(.a(x6), .b(x2), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n31_), .c(new_n26_), .O(z1));
  nand2  g18(.a(x4), .b(new_n16_), .O(new_n34_));
  aoi21  g19(.a(new_n34_), .b(new_n28_), .c(new_n23_), .O(new_n35_));
  ...
  aoi21  g25(.a(new_n40_), .b(new_n23_), .c(new_n35_), .O(new_n41_));
  ...
  aoi21  g34(.a(new_n49_), .b(new_n23_), .c(x6), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(new_n16_), .c(new_n48_), .O(z3));
  nand2  g36(.a(new_n28_), .b(x2), .O(new_n52_));
  oai21  g37(.a(new_n43_), .b(new_n17_), .c(new_n52_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n23_), .O(new_n54_));
  oai21  g39(.a(new_n28_), .b(x0), .c(new_n38_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(x2), .O(new_n56_));
  nand3  g41(.a(new_n24_), .b(new_n16_), .c(new_n17_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(z4));
  aoi21  g43(.a(new_n52_), .b(new_n43_), .c(new_n17_), .O(new_n59_));
  nor3   g44(.a(new_n36_), .b(new_n16_), .c(x0), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n59_), .c(new_n23_), .O(new_n61_));
  aoi21  g46(.a(new_n28_), .b(x2), .c(new_n23_), .O(new_n62_));
  oai21  g47(.a(new_n28_), .b(new_n16_), .c(new_n29_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n62_), .c(new_n17_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n61_), .c(new_n32_), .O(z5));
  nand3  g50(.a(new_n36_), .b(new_n28_), .c(x2), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n59_), .c(new_n23_), .O(new_n68_));
  oai21  g53(.a(x4), .b(x2), .c(new_n28_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(x1), .c(new_n17_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n68_), .c(new_n32_), .O(z6));
endmodule
