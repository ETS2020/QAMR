...
module FAU ( 
  ...
  or2    g13(.a(new_n28_), .b(new_n19_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n27_), .O(z1));
  nand3  g15(.a(x3), .b(new_n18_), .c(x0), .O(new_n31_));
  inv1   g16(.a(new_n31_), .O(new_n32_));
  nor3   g17(.a(x6), .b(x3), .c(x0), .O(new_n33_));
  oai21  g18(.a(new_n33_), .b(new_n32_), .c(new_n24_), .O(new_n34_));
  ...
  nand2  g24(.a(x5), .b(new_n16_), .O(new_n40_));
  nand4  g25(.a(new_n40_), .b(new_n20_), .c(x2), .d(new_n18_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n17_), .O(z3));
  nand2  g27(.a(new_n28_), .b(new_n21_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(x0), .O(new_n44_));
  aoi22  g29(.a(new_n28_), .b(new_n16_), .c(new_n35_), .d(x2), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n44_), .c(x1), .O(z4));
  ...
  nand3  g34(.a(new_n43_), .b(new_n18_), .c(x0), .O(new_n50_));
