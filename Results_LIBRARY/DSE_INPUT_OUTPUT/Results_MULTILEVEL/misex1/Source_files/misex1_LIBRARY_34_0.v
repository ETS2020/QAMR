...
module FAU ( 
  ...
  nand4  g18(.a(new_n33_), .b(new_n18_), .c(x2), .d(new_n17_), .O(new_n34_));
  ...
  aoi21  g27(.a(new_n40_), .b(x0), .c(new_n42_), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(x1), .c(new_n38_), .O(z5));
  nor2   g29(.a(x5), .b(x3), .O(new_n45_));
  aoi22  g30(.a(new_n40_), .b(x0), .c(new_n45_), .d(x2), .O(new_n46_));
  nand4  g31(.a(x3), .b(x2), .c(x1), .d(new_n16_), .O(new_n47_));
