...
module FAU ( 
  ...
  nor2   g19(.a(x3), .b(new_n34_), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n16_), .c(x0), .O(new_n36_));
  oai21  g21(.a(new_n33_), .b(x0), .c(new_n36_), .O(z3));
  xor2a  g22(.a(x3), .b(x2), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n16_), .c(x0), .O(new_n39_));
  nand2  g24(.a(x3), .b(new_n16_), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n34_), .c(new_n20_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n39_), .O(z4));
  nand3  g27(.a(x3), .b(new_n34_), .c(x0), .O(new_n43_));
  inv1   g28(.a(new_n43_), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(new_n35_), .c(new_n16_), .O(new_n45_));
  nand3  g30(.a(new_n21_), .b(new_n34_), .c(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n20_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n45_), .O(z5));
  aoi21  g33(.a(x4), .b(new_n17_), .c(new_n16_), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(x2), .c(new_n20_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n45_), .O(z6));
endmodule
