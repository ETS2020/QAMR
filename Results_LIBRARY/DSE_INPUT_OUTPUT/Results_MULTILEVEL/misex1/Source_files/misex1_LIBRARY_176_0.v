...
module FAU ( 
  ...
  aoi22  g13(.a(new_n28_), .b(new_n16_), .c(new_n26_), .d(new_n19_), .O(new_n29_));
  nor2   g14(.a(x1), .b(new_n17_), .O(new_n30_));
  aoi21  g15(.a(new_n30_), .b(x3), .c(new_n25_), .O(new_n31_));
  oai22  g16(.a(new_n31_), .b(x2), .c(new_n29_), .d(x0), .O(z1));
  nand2  g17(.a(new_n25_), .b(x2), .O(new_n33_));
  nand3  g18(.a(new_n27_), .b(x5), .c(new_n16_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n33_), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n20_), .c(new_n19_), .O(new_n36_));
  oai21  g21(.a(x4), .b(x3), .c(x5), .O(new_n37_));
  ...
  nor2   g27(.a(new_n25_), .b(new_n20_), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n30_), .c(new_n16_), .O(new_n44_));
  ...
  nand3  g38(.a(new_n43_), .b(new_n16_), .c(x0), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n19_), .O(new_n56_));
  inv1   g41(.a(new_n38_), .O(new_n57_));
  aoi21  g42(.a(x3), .b(new_n19_), .c(new_n25_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n16_), .c(new_n57_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(x0), .c(new_n56_), .O(z4));
  nand3  g45(.a(x5), .b(x3), .c(new_n16_), .O(new_n61_));
  aoi21  g46(.a(new_n53_), .b(new_n61_), .c(new_n17_), .O(new_n62_));
  nor3   g47(.a(new_n25_), .b(new_n16_), .c(x0), .O(new_n63_));
  ...
  aoi21  g51(.a(new_n66_), .b(new_n65_), .c(new_n25_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n57_), .c(new_n17_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n64_), .O(z5));
  nand3  g54(.a(new_n25_), .b(new_n20_), .c(x2), .O(new_n70_));
  ...
  oai21  g59(.a(new_n23_), .b(new_n20_), .c(new_n74_), .O(new_n75_));
