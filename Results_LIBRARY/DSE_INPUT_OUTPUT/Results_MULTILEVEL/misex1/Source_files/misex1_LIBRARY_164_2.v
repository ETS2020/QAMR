...
module FAU ( 
  ...
  nand3  g19(.a(new_n28_), .b(new_n19_), .c(new_n18_), .O(new_n35_));
  ...
  nand2  g39(.a(new_n45_), .b(new_n25_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n18_), .O(new_n56_));
  nand3  g41(.a(x5), .b(x3), .c(x2), .O(new_n57_));
  inv1   g42(.a(new_n57_), .O(new_n58_));
  aoi21  g43(.a(new_n29_), .b(new_n24_), .c(new_n58_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(x0), .c(new_n56_), .O(z5));
  nand2  g45(.a(x3), .b(new_n24_), .O(new_n61_));
  nand2  g46(.a(new_n47_), .b(new_n61_), .O(new_n62_));
  ...
  nand3  g50(.a(new_n65_), .b(new_n63_), .c(new_n32_), .O(z6));
endmodule
