...
module FAU ( 
  ...
  nand4  g16(.a(new_n24_), .b(new_n17_), .c(x2), .d(new_n23_), .O(new_n32_));
  ...
  oai21  g26(.a(new_n24_), .b(x1), .c(new_n17_), .O(new_n42_));
  ...
  oai21  g34(.a(new_n49_), .b(new_n16_), .c(new_n23_), .O(new_n50_));
