...
module FAU ( 
  ...
  nand2  g17(.a(x4), .b(new_n32_), .O(new_n33_));
  ...
  nand4  g28(.a(new_n43_), .b(new_n32_), .c(x1), .d(new_n17_), .O(new_n44_));
  aoi21  g29(.a(new_n20_), .b(new_n19_), .c(x5), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n32_), .c(new_n44_), .O(z3));
  ...
  oai21  g40(.a(new_n20_), .b(x2), .c(new_n48_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n19_), .c(x0), .O(new_n57_));
  oai21  g42(.a(new_n53_), .b(new_n28_), .c(new_n17_), .O(new_n58_));
  ...
  nand2  g47(.a(new_n62_), .b(new_n47_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n19_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n61_), .c(new_n30_), .O(z6));
endmodule
