...
module FAU ( 
  ...
  nand3  g18(.a(new_n33_), .b(new_n31_), .c(new_n17_), .O(new_n34_));
  nand2  g19(.a(x7), .b(x2), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n34_), .c(new_n30_), .O(z1));
  nand2  g21(.a(new_n32_), .b(new_n31_), .O(new_n37_));
  inv1   g22(.a(x5), .O(new_n38_));
  nand3  g23(.a(new_n16_), .b(new_n38_), .c(x2), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n37_), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n20_), .c(new_n19_), .O(new_n41_));
  inv1   g26(.a(x4), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n20_), .c(x2), .O(new_n43_));
  nor2   g28(.a(x7), .b(new_n20_), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(new_n43_), .c(x1), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n41_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n17_), .O(new_n47_));
  nand3  g32(.a(new_n27_), .b(new_n19_), .c(x0), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n47_), .O(z2));
  oai21  g34(.a(x4), .b(x3), .c(x7), .O(new_n50_));
  nand4  g35(.a(new_n50_), .b(new_n31_), .c(x1), .d(new_n17_), .O(new_n51_));
  aoi21  g36(.a(x5), .b(new_n17_), .c(x7), .O(new_n52_));
  nand4  g37(.a(new_n52_), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n51_), .O(z3));
  nor2   g39(.a(x3), .b(new_n31_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n29_), .c(new_n19_), .O(new_n56_));
  oai21  g41(.a(new_n20_), .b(x0), .c(new_n16_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(x2), .O(new_n58_));
  nand2  g43(.a(x3), .b(new_n19_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n31_), .c(new_n17_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n58_), .c(new_n56_), .O(z4));
  nand2  g46(.a(x3), .b(new_n31_), .O(new_n62_));
  nand3  g47(.a(new_n16_), .b(new_n20_), .c(x2), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n62_), .c(new_n17_), .O(new_n64_));
  nand3  g49(.a(new_n55_), .b(new_n16_), .c(x5), .O(new_n65_));
  inv1   g50(.a(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n64_), .c(new_n19_), .O(new_n67_));
  nand2  g52(.a(new_n16_), .b(x3), .O(new_n68_));
  aoi21  g53(.a(new_n68_), .b(x2), .c(new_n19_), .O(new_n69_));
  nand3  g54(.a(x6), .b(new_n20_), .c(new_n31_), .O(new_n70_));
  oai21  g55(.a(new_n68_), .b(new_n31_), .c(new_n70_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n69_), .c(new_n17_), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n67_), .O(z5));
  nand3  g58(.a(new_n55_), .b(new_n16_), .c(new_n38_), .O(new_n74_));
  inv1   g59(.a(new_n74_), .O(new_n75_));
  oai21  g60(.a(new_n75_), .b(new_n64_), .c(new_n19_), .O(new_n76_));
  oai21  g61(.a(new_n42_), .b(x3), .c(new_n31_), .O(new_n77_));
  nand2  g62(.a(new_n77_), .b(new_n68_), .O(new_n78_));
