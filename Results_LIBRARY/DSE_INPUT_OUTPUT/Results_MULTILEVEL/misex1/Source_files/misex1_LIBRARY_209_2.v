...
module FAU ( 
  ...
  nand4  g10(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n17_), .O(new_n26_));
  nand2  g11(.a(x6), .b(new_n23_), .O(new_n27_));
  nand3  g12(.a(new_n27_), .b(new_n22_), .c(new_n17_), .O(new_n28_));
  ...
  aoi21  g28(.a(x3), .b(new_n17_), .c(new_n19_), .O(new_n44_));
  nand2  g29(.a(x3), .b(new_n22_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n16_), .c(new_n17_), .O(new_n46_));
  oai21  g31(.a(new_n44_), .b(new_n16_), .c(new_n46_), .O(z4));
  ...
  nand4  g38(.a(new_n23_), .b(x2), .c(new_n22_), .d(x0), .O(new_n54_));
