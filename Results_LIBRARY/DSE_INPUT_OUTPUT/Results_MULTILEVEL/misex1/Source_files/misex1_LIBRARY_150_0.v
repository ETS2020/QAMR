...
module FAU ( 
  ...
  nand2  g25(.a(new_n24_), .b(new_n27_), .O(new_n41_));
  ...
  aoi21  g31(.a(new_n46_), .b(new_n44_), .c(new_n28_), .O(new_n47_));
  oai21  g32(.a(new_n43_), .b(x0), .c(new_n47_), .O(z2));
  ...
  aoi21  g45(.a(x5), .b(x1), .c(x6), .O(new_n61_));
  nand2  g46(.a(x5), .b(new_n18_), .O(new_n62_));
  oai21  g47(.a(new_n61_), .b(new_n19_), .c(new_n62_), .O(new_n63_));
  nand2  g48(.a(x6), .b(x0), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n23_), .c(x3), .O(new_n65_));
  aoi22  g50(.a(new_n65_), .b(new_n18_), .c(new_n63_), .d(new_n16_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n27_), .c(new_n34_), .O(z5));
  aoi21  g52(.a(new_n54_), .b(new_n45_), .c(new_n16_), .O(new_n68_));
  ...
  oai21  g56(.a(new_n25_), .b(new_n27_), .c(x3), .O(new_n72_));
  ...
  nand3  g61(.a(new_n76_), .b(new_n71_), .c(new_n25_), .O(z6));
endmodule
