...
module FAU ( 
  ...
  nor2   g25(.a(new_n20_), .b(new_n16_), .O(new_n41_));
  ...
  nand2  g30(.a(new_n36_), .b(x7), .O(new_n46_));
  ...
  oai21  g42(.a(new_n57_), .b(new_n41_), .c(new_n17_), .O(new_n58_));
  nor2   g43(.a(new_n23_), .b(x2), .O(new_n59_));
  inv1   g44(.a(new_n59_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n58_), .c(new_n56_), .O(z4));
  aoi21  g46(.a(new_n54_), .b(new_n31_), .c(new_n17_), .O(new_n62_));
  nor3   g47(.a(new_n23_), .b(new_n16_), .c(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n62_), .c(new_n19_), .O(new_n64_));
  inv1   g49(.a(new_n28_), .O(new_n65_));
  oai21  g50(.a(new_n41_), .b(new_n65_), .c(new_n17_), .O(new_n66_));
  ...
  nand2  g55(.a(new_n35_), .b(new_n16_), .O(new_n71_));
  aoi21  g56(.a(new_n71_), .b(new_n20_), .c(new_n19_), .O(new_n72_));
  aoi21  g57(.a(new_n72_), .b(new_n17_), .c(new_n59_), .O(new_n73_));
