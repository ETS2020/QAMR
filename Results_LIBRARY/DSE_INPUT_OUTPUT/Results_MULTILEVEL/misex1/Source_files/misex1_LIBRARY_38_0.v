...
module FAU ( 
  ...
  nor2   g33(.a(x7), .b(new_n24_), .O(new_n49_));
  ...
  inv1   g40(.a(new_n39_), .O(new_n56_));
  ...
  nand4  g55(.a(new_n25_), .b(x3), .c(x1), .d(new_n16_), .O(new_n71_));
