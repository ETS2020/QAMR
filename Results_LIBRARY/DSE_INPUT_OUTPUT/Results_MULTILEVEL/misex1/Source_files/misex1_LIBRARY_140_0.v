...
module FAU ( 
  ...
  nand3  g08(.a(x6), .b(x5), .c(new_n23_), .O(new_n24_));
  aoi21  g09(.a(new_n24_), .b(new_n22_), .c(x1), .O(new_n25_));
  nand3  g10(.a(x5), .b(new_n16_), .c(x1), .O(new_n26_));
  ...
  nand2  g30(.a(new_n45_), .b(x5), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n16_), .O(new_n47_));
  oai21  g32(.a(new_n16_), .b(new_n17_), .c(x5), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n23_), .c(new_n29_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n47_), .O(z3));
  nor2   g35(.a(new_n23_), .b(x0), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n19_), .c(x2), .O(new_n52_));
  aoi21  g37(.a(x3), .b(new_n29_), .c(x0), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n41_), .c(new_n16_), .O(new_n54_));
  nor2   g39(.a(x5), .b(x3), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n29_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n54_), .c(new_n52_), .O(z4));
  nand2  g42(.a(new_n23_), .b(x2), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n31_), .c(new_n17_), .O(new_n59_));
  inv1   g44(.a(x5), .O(new_n60_));
  nor3   g45(.a(new_n60_), .b(new_n16_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n29_), .O(new_n62_));
  oai21  g47(.a(x3), .b(new_n16_), .c(x1), .O(new_n63_));
  nand3  g48(.a(x6), .b(new_n23_), .c(new_n16_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n63_), .c(new_n60_), .O(new_n65_));
  nor2   g50(.a(new_n23_), .b(new_n16_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n65_), .c(new_n17_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n62_), .O(z5));
  nand2  g53(.a(new_n55_), .b(x2), .O(new_n69_));
  inv1   g54(.a(new_n69_), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n59_), .c(new_n29_), .O(new_n71_));
  oai21  g56(.a(x5), .b(x2), .c(x3), .O(new_n72_));
  inv1   g57(.a(x4), .O(new_n73_));
  nand3  g58(.a(x5), .b(new_n73_), .c(new_n16_), .O(new_n74_));
  nand2  g59(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  nand3  g60(.a(new_n75_), .b(x1), .c(new_n17_), .O(new_n76_));
  nand2  g61(.a(new_n76_), .b(new_n71_), .O(z6));
endmodule
