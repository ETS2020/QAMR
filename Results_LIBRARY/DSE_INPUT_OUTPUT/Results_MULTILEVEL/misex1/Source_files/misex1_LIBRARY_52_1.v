...
module FAU ( 
  ...
  oai21  g08(.a(new_n23_), .b(x0), .c(new_n20_), .O(new_n24_));
  ...
  nand3  g18(.a(x4), .b(new_n16_), .c(x1), .O(new_n34_));
  ...
  aoi21  g26(.a(new_n41_), .b(x2), .c(x3), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(x1), .c(new_n40_), .O(z3));
  oai21  g28(.a(new_n19_), .b(new_n17_), .c(x3), .O(new_n44_));
  oai21  g29(.a(new_n16_), .b(new_n19_), .c(new_n17_), .O(new_n45_));
  nand2  g30(.a(x2), .b(new_n19_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n45_), .c(new_n44_), .O(z4));
  aoi21  g32(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n48_));
  nor2   g33(.a(new_n26_), .b(x2), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n48_), .c(new_n17_), .O(new_n50_));
  oai21  g35(.a(x3), .b(new_n17_), .c(new_n30_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(x2), .c(x3), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(x1), .c(new_n50_), .O(z5));
  oai21  g38(.a(x4), .b(x2), .c(new_n20_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(x1), .c(new_n17_), .O(new_n55_));
  nand4  g40(.a(new_n41_), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n56_));
