...
module FAU ( 
  ...
  nand3  g14(.a(new_n29_), .b(new_n25_), .c(new_n21_), .O(z1));
  aoi21  g15(.a(x4), .b(new_n22_), .c(x3), .O(new_n31_));
  nand4  g16(.a(new_n23_), .b(new_n26_), .c(new_n22_), .d(new_n19_), .O(new_n32_));
  oai21  g17(.a(new_n31_), .b(new_n19_), .c(new_n32_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n16_), .O(new_n34_));
  nand4  g19(.a(new_n27_), .b(new_n26_), .c(x2), .d(new_n19_), .O(new_n35_));
  ...
  nand2  g24(.a(new_n20_), .b(new_n16_), .O(new_n40_));
  oai21  g25(.a(x3), .b(new_n19_), .c(x2), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n40_), .c(new_n21_), .O(z4));
  oai21  g27(.a(new_n26_), .b(x1), .c(new_n22_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(x0), .O(new_n44_));
  aoi21  g29(.a(new_n26_), .b(x2), .c(new_n19_), .O(new_n45_));
  nand3  g30(.a(x6), .b(new_n26_), .c(new_n22_), .O(new_n46_));
  ...
  nand4  g40(.a(x3), .b(new_n22_), .c(new_n19_), .d(x0), .O(new_n56_));
