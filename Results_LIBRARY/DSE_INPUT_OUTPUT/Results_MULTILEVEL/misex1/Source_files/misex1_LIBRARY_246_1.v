...
module FAU ( 
  ...
  nand3  g21(.a(new_n26_), .b(new_n27_), .c(new_n16_), .O(new_n37_));
  ...
  nand4  g38(.a(new_n26_), .b(x3), .c(new_n16_), .d(x0), .O(new_n54_));
  ...
  oai21  g50(.a(new_n65_), .b(new_n44_), .c(new_n17_), .O(new_n66_));
  ...
  oai21  g55(.a(new_n26_), .b(x2), .c(x3), .O(new_n71_));
  nand3  g56(.a(new_n26_), .b(new_n41_), .c(new_n16_), .O(new_n72_));
