...
module FAU ( 
  ...
  nand2  g40(.a(x3), .b(new_n27_), .O(new_n56_));
  ...
  aoi21  g44(.a(x3), .b(new_n19_), .c(x2), .O(new_n60_));
  nor2   g45(.a(new_n20_), .b(new_n27_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n60_), .c(new_n17_), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n59_), .c(new_n25_), .O(z4));
  aoi21  g48(.a(new_n57_), .b(new_n56_), .c(new_n17_), .O(new_n64_));
  inv1   g49(.a(x5), .O(new_n65_));
  nor3   g50(.a(new_n65_), .b(new_n27_), .c(x0), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n64_), .c(new_n19_), .O(new_n67_));
  inv1   g52(.a(new_n61_), .O(new_n68_));
  nand2  g53(.a(new_n57_), .b(x1), .O(new_n69_));
  nand3  g54(.a(x6), .b(new_n20_), .c(new_n27_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(new_n71_));
  nand2  g56(.a(new_n71_), .b(new_n17_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(new_n67_), .c(new_n16_), .O(z5));
  nand3  g58(.a(new_n65_), .b(new_n20_), .c(x2), .O(new_n74_));
  ...
  nand3  g63(.a(new_n78_), .b(new_n76_), .c(new_n16_), .O(z6));
endmodule
