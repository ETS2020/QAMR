...
module FAU ( 
  ...
  aoi21  g21(.a(new_n36_), .b(new_n35_), .c(x3), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(new_n19_), .c(new_n34_), .O(new_n38_));
  oai21  g23(.a(new_n38_), .b(x0), .c(new_n31_), .O(z2));
  nand2  g24(.a(x5), .b(new_n17_), .O(new_n40_));
  nand4  g25(.a(new_n40_), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n41_));
  aoi21  g26(.a(x1), .b(new_n17_), .c(x7), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(x2), .c(new_n41_), .O(z3));
  nand2  g28(.a(new_n20_), .b(x2), .O(new_n44_));
  nand4  g29(.a(new_n28_), .b(x3), .c(new_n16_), .d(x0), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n19_), .O(new_n47_));
  aoi21  g32(.a(x3), .b(new_n19_), .c(x7), .O(new_n48_));
  nor2   g33(.a(new_n20_), .b(new_n16_), .O(new_n49_));
  aoi21  g34(.a(new_n48_), .b(new_n16_), .c(new_n49_), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(x0), .c(new_n47_), .O(z4));
  nand3  g36(.a(new_n28_), .b(x3), .c(new_n16_), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n44_), .c(new_n17_), .O(new_n53_));
  nor3   g38(.a(new_n23_), .b(new_n16_), .c(x0), .O(new_n54_));
  ...
  aoi21  g42(.a(new_n57_), .b(new_n56_), .c(x7), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n49_), .c(new_n17_), .O(new_n59_));
  ...
  nand3  g50(.a(new_n28_), .b(new_n65_), .c(new_n16_), .O(new_n66_));
