...
module FAU ( 
  ...
  nand4  g39(.a(x7), .b(x3), .c(new_n16_), .d(x0), .O(new_n55_));
  ...
  nor2   g44(.a(new_n20_), .b(new_n16_), .O(new_n60_));
  aoi21  g45(.a(new_n59_), .b(new_n16_), .c(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(x0), .c(new_n57_), .O(z4));
  aoi21  g47(.a(new_n54_), .b(new_n34_), .c(new_n17_), .O(new_n63_));
  ...
  aoi21  g52(.a(new_n67_), .b(new_n66_), .c(new_n58_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n60_), .c(new_n17_), .O(new_n69_));
  ...
  oai21  g58(.a(new_n23_), .b(new_n20_), .c(new_n50_), .O(new_n74_));
