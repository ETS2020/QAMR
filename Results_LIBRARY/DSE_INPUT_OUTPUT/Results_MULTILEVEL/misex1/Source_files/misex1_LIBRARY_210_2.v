...
module FAU ( 
  ...
  oai21  g30(.a(new_n45_), .b(new_n19_), .c(x2), .O(new_n46_));
  ...
  oai21  g34(.a(new_n19_), .b(new_n16_), .c(x0), .O(new_n50_));
  oai21  g35(.a(new_n45_), .b(new_n16_), .c(x1), .O(new_n51_));
  ...
  nand4  g39(.a(new_n54_), .b(new_n53_), .c(new_n51_), .d(new_n50_), .O(z5));
  aoi21  g40(.a(x4), .b(new_n23_), .c(x2), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n45_), .c(x1), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n50_), .c(new_n43_), .O(z6));
endmodule
