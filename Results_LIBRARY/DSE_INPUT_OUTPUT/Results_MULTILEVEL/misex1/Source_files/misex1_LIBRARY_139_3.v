...
module FAU ( 
  ...
  aoi21  g28(.a(x5), .b(new_n24_), .c(x3), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n18_), .c(x6), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n28_), .c(new_n43_), .O(z3));
  nand2  g31(.a(x3), .b(new_n28_), .O(new_n47_));
  nand3  g32(.a(new_n16_), .b(new_n19_), .c(x2), .O(new_n48_));
  ...
  oai21  g47(.a(new_n16_), .b(x3), .c(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n61_), .c(new_n24_), .O(new_n64_));
  nand2  g49(.a(x6), .b(x2), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n64_), .c(new_n59_), .O(z5));
  aoi21  g51(.a(new_n48_), .b(new_n47_), .c(new_n24_), .O(new_n67_));
  nand4  g52(.a(new_n16_), .b(new_n25_), .c(new_n19_), .d(x2), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n67_), .c(new_n18_), .O(new_n70_));
  inv1   g55(.a(x4), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(x3), .c(new_n28_), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n60_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(x1), .c(new_n24_), .O(new_n74_));
