...
module FAU ( 
  ...
  aoi21  g20(.a(new_n35_), .b(new_n17_), .c(new_n18_), .O(new_n36_));
  aoi21  g21(.a(x5), .b(new_n17_), .c(x3), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n18_), .O(new_n38_));
  oai21  g23(.a(new_n36_), .b(x2), .c(new_n38_), .O(z3));
  oai21  g24(.a(x3), .b(new_n16_), .c(new_n17_), .O(new_n40_));
  oai21  g25(.a(new_n19_), .b(new_n16_), .c(new_n18_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(z4));
  oai21  g27(.a(new_n18_), .b(new_n17_), .c(new_n16_), .O(new_n43_));
  oai21  g28(.a(new_n24_), .b(x1), .c(new_n19_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n17_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n43_), .c(new_n22_), .O(z5));
  nor2   g31(.a(x4), .b(x2), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n20_), .c(new_n17_), .O(new_n48_));
  oai21  g33(.a(new_n37_), .b(new_n16_), .c(new_n18_), .O(new_n49_));
