...
module FAU ( 
  ...
  nand4  g27(.a(new_n42_), .b(new_n23_), .c(new_n16_), .d(x1), .O(new_n43_));
  ...
  aoi21  g40(.a(new_n47_), .b(new_n31_), .c(new_n17_), .O(new_n56_));
  nor2   g41(.a(new_n34_), .b(x0), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n56_), .c(new_n19_), .O(new_n58_));
  nand3  g43(.a(new_n47_), .b(new_n23_), .c(x1), .O(new_n59_));
  ...
  nand3  g48(.a(new_n63_), .b(new_n20_), .c(x2), .O(new_n64_));
