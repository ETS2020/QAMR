...
module FAU ( 
  ...
  nand3  g29(.a(new_n44_), .b(new_n43_), .c(new_n36_), .O(z4));
  inv1   g30(.a(new_n21_), .O(new_n46_));
  oai21  g31(.a(new_n23_), .b(x1), .c(new_n20_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n17_), .c(new_n46_), .O(new_n48_));
  nand4  g33(.a(new_n27_), .b(new_n20_), .c(new_n16_), .d(new_n17_), .O(new_n49_));
  oai21  g34(.a(new_n48_), .b(new_n16_), .c(new_n49_), .O(z5));
  inv1   g35(.a(x4), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n20_), .c(new_n16_), .O(new_n52_));
  oai21  g37(.a(new_n20_), .b(new_n16_), .c(new_n52_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(x1), .c(new_n17_), .O(new_n54_));
  nand4  g39(.a(new_n40_), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n54_), .O(z6));
endmodule
