...
module FAU ( 
  ...
  oai21  g27(.a(x5), .b(x3), .c(x0), .O(new_n43_));
  aoi22  g28(.a(new_n43_), .b(x2), .c(new_n42_), .d(x0), .O(new_n44_));
  nand2  g29(.a(x3), .b(new_n16_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n17_), .c(new_n28_), .O(new_n46_));
  oai21  g31(.a(new_n44_), .b(x1), .c(new_n46_), .O(z4));
  nand3  g32(.a(x3), .b(new_n17_), .c(new_n16_), .O(new_n48_));
  oai21  g33(.a(x3), .b(new_n17_), .c(new_n48_), .O(new_n49_));
  ...
  aoi21  g40(.a(x4), .b(new_n18_), .c(x0), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x2), .c(x1), .O(new_n57_));
  nand2  g42(.a(new_n32_), .b(x2), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n57_), .c(new_n50_), .O(z6));
endmodule
