...
module FAU ( 
  ...
  oai21  g10(.a(new_n24_), .b(new_n16_), .c(new_n25_), .O(new_n26_));
  ...
  nand3  g19(.a(new_n24_), .b(x2), .c(new_n17_), .O(new_n35_));
  inv1   g20(.a(new_n35_), .O(new_n36_));
  aoi21  g21(.a(new_n34_), .b(new_n21_), .c(new_n36_), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(x0), .c(new_n30_), .O(z2));
  oai21  g23(.a(x4), .b(x3), .c(x7), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n16_), .c(new_n20_), .O(new_n40_));
  ...
  aoi21  g32(.a(new_n47_), .b(new_n46_), .c(new_n20_), .O(new_n48_));
  ...
  aoi21  g37(.a(new_n18_), .b(x2), .c(x0), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(x6), .c(x1), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n52_), .O(z4));
  aoi21  g40(.a(new_n26_), .b(new_n20_), .c(new_n48_), .O(new_n56_));
  nand4  g41(.a(new_n47_), .b(new_n21_), .c(x1), .d(new_n20_), .O(new_n57_));
  oai21  g42(.a(new_n56_), .b(x1), .c(new_n57_), .O(z5));
  inv1   g43(.a(new_n50_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n48_), .c(new_n17_), .O(new_n60_));
  nor2   g45(.a(x4), .b(x2), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(x3), .c(new_n20_), .O(new_n62_));
