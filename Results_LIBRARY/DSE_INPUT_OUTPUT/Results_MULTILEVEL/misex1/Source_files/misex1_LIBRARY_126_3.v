...
module FAU ( 
  ...
  aoi21  g32(.a(new_n47_), .b(new_n22_), .c(x6), .O(new_n48_));
  ...
  nand2  g42(.a(x6), .b(x2), .O(new_n58_));
  ...
  oai21  g50(.a(new_n23_), .b(x3), .c(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n64_), .c(new_n17_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n62_), .c(new_n58_), .O(z5));
  aoi21  g53(.a(new_n50_), .b(new_n33_), .c(new_n17_), .O(new_n69_));
  nand4  g54(.a(new_n23_), .b(new_n25_), .c(new_n24_), .d(x2), .O(new_n70_));
