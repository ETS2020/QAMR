...
module FAU ( 
  ...
  nand3  g07(.a(new_n22_), .b(new_n21_), .c(new_n16_), .O(new_n23_));
  nand2  g08(.a(new_n23_), .b(new_n20_), .O(new_n24_));
  nand4  g09(.a(x3), .b(new_n21_), .c(new_n16_), .d(x0), .O(new_n25_));
  nand2  g10(.a(new_n25_), .b(new_n24_), .O(z1));
  oai21  g11(.a(x4), .b(x3), .c(x1), .O(new_n27_));
  inv1   g12(.a(x6), .O(new_n28_));
  nand3  g13(.a(new_n28_), .b(new_n17_), .c(new_n16_), .O(new_n29_));
  nand3  g14(.a(new_n29_), .b(new_n27_), .c(new_n21_), .O(new_n30_));
