...
module FAU ( 
  ...
  nand4  g17(.a(new_n24_), .b(new_n17_), .c(x2), .d(new_n23_), .O(new_n33_));
  ...
  oai21  g24(.a(new_n27_), .b(new_n20_), .c(new_n19_), .O(new_n40_));
  nand3  g25(.a(new_n17_), .b(x2), .c(new_n23_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(z4));
  oai21  g27(.a(new_n23_), .b(new_n19_), .c(new_n16_), .O(new_n43_));
  oai21  g28(.a(new_n24_), .b(x1), .c(new_n17_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n19_), .O(new_n45_));
  nand3  g30(.a(new_n17_), .b(new_n23_), .c(x0), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n45_), .c(new_n43_), .O(z5));
  nor2   g32(.a(new_n17_), .b(new_n23_), .O(new_n48_));
  nor2   g33(.a(x4), .b(x2), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n48_), .c(new_n19_), .O(new_n50_));
  aoi21  g35(.a(x5), .b(new_n19_), .c(x3), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n16_), .c(new_n23_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n50_), .O(z6));
endmodule
