...
module FAU ( 
  ...
  nand2  g16(.a(new_n29_), .b(x2), .O(new_n32_));
  ...
  oai21  g21(.a(x5), .b(new_n25_), .c(x6), .O(new_n37_));
  ...
  nor2   g27(.a(x1), .b(new_n16_), .O(new_n43_));
  aoi22  g28(.a(new_n43_), .b(new_n42_), .c(new_n29_), .d(x2), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n40_), .O(z2));
  oai21  g30(.a(x4), .b(x3), .c(x7), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n25_), .c(x1), .d(new_n16_), .O(new_n47_));
  aoi21  g32(.a(x5), .b(new_n16_), .c(new_n29_), .O(new_n48_));
  nand4  g33(.a(new_n48_), .b(new_n19_), .c(x2), .d(new_n18_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n47_), .O(z3));
  nand3  g35(.a(x6), .b(new_n19_), .c(x2), .O(new_n51_));
