...
module FAU ( 
  ...
  nand3  g11(.a(new_n26_), .b(x3), .c(new_n24_), .O(new_n27_));
  ...
  nand2  g18(.a(x4), .b(new_n28_), .O(new_n34_));
  aoi21  g19(.a(new_n34_), .b(new_n33_), .c(new_n24_), .O(new_n35_));
  oai21  g20(.a(new_n29_), .b(x2), .c(new_n33_), .O(new_n36_));
  ...
  nand4  g28(.a(new_n43_), .b(new_n28_), .c(x1), .d(new_n17_), .O(new_n44_));
  ...
  nand3  g38(.a(new_n53_), .b(new_n28_), .c(new_n17_), .O(new_n54_));
  ...
  nand3  g45(.a(x6), .b(new_n33_), .c(new_n28_), .O(new_n61_));
  oai21  g46(.a(new_n59_), .b(new_n28_), .c(new_n61_), .O(new_n62_));
  ...
  oai21  g52(.a(new_n67_), .b(x3), .c(new_n28_), .O(new_n68_));
