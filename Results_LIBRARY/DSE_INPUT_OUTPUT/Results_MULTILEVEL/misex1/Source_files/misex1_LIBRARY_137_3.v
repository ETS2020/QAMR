...
module FAU ( 
  ...
  aoi21  g22(.a(new_n37_), .b(new_n22_), .c(new_n17_), .O(new_n38_));
  ...
  oai21  g41(.a(x7), .b(new_n17_), .c(x3), .O(new_n57_));
  nand3  g42(.a(new_n21_), .b(x3), .c(x2), .O(new_n58_));
  ...
  aoi21  g46(.a(new_n53_), .b(new_n33_), .c(new_n20_), .O(new_n62_));
  ...
  aoi21  g51(.a(new_n66_), .b(new_n22_), .c(new_n17_), .O(new_n67_));
  nand2  g52(.a(x3), .b(x2), .O(new_n68_));
  oai21  g53(.a(new_n28_), .b(x2), .c(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n67_), .c(new_n20_), .O(new_n70_));
  nand2  g55(.a(x7), .b(x3), .O(new_n71_));
  nand3  g56(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(z5));
  nand3  g57(.a(new_n39_), .b(new_n18_), .c(x2), .O(new_n73_));
  inv1   g58(.a(new_n73_), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(new_n62_), .c(new_n17_), .O(new_n75_));
  oai21  g60(.a(new_n47_), .b(x2), .c(new_n22_), .O(new_n76_));
