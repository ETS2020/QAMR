...
module FAU ( 
  ...
  oai21  g22(.a(new_n23_), .b(x2), .c(x3), .O(new_n38_));
  nor2   g23(.a(new_n38_), .b(new_n19_), .O(new_n39_));
  nand2  g24(.a(new_n26_), .b(x2), .O(new_n40_));
  nand3  g25(.a(new_n29_), .b(new_n23_), .c(new_n16_), .O(new_n41_));
  aoi21  g26(.a(new_n41_), .b(new_n40_), .c(x3), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n19_), .c(new_n39_), .O(new_n43_));
  ...
  nand4  g37(.a(new_n23_), .b(x3), .c(new_n16_), .d(x0), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n19_), .O(new_n55_));
  aoi21  g40(.a(x3), .b(new_n19_), .c(x4), .O(new_n56_));
  ...
  aoi21  g44(.a(new_n52_), .b(new_n34_), .c(new_n17_), .O(new_n60_));
  nor3   g45(.a(new_n26_), .b(new_n16_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n60_), .c(new_n19_), .O(new_n62_));
  inv1   g47(.a(new_n31_), .O(new_n63_));
  oai21  g48(.a(new_n57_), .b(new_n63_), .c(new_n17_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n62_), .O(z5));
  nand3  g50(.a(new_n26_), .b(new_n20_), .c(x2), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n60_), .c(new_n19_), .O(new_n68_));
  aoi21  g53(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n69_));
  aoi21  g54(.a(new_n69_), .b(new_n17_), .c(new_n24_), .O(new_n70_));
