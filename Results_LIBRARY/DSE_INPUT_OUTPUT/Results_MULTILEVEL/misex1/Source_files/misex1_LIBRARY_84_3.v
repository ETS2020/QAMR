...
module FAU ( 
  ...
  aoi21  g32(.a(x5), .b(new_n17_), .c(x6), .O(new_n48_));
  nand4  g33(.a(new_n48_), .b(new_n27_), .c(x2), .d(new_n22_), .O(new_n49_));
  ...
  nand2  g43(.a(new_n27_), .b(x2), .O(new_n59_));
  ...
  aoi21  g47(.a(new_n27_), .b(x2), .c(new_n22_), .O(new_n63_));
  oai21  g48(.a(new_n27_), .b(new_n16_), .c(new_n28_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n63_), .c(new_n17_), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n62_), .c(new_n31_), .O(z5));
  nand3  g51(.a(new_n35_), .b(new_n27_), .c(x2), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n60_), .c(new_n22_), .O(new_n69_));
  oai21  g54(.a(x4), .b(x2), .c(new_n27_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(x1), .c(new_n17_), .O(new_n71_));
  nand3  g56(.a(new_n71_), .b(new_n69_), .c(new_n31_), .O(z6));
endmodule
