...
module FAU ( 
  ...
  aoi21  g20(.a(new_n21_), .b(x2), .c(new_n20_), .O(new_n36_));
  nor2   g21(.a(x3), .b(x2), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(new_n36_), .c(new_n17_), .O(new_n38_));
  nand4  g23(.a(x3), .b(new_n16_), .c(new_n20_), .d(x0), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n38_), .O(z4));
  nand2  g25(.a(x3), .b(x2), .O(new_n41_));
  nand3  g26(.a(x6), .b(new_n21_), .c(new_n16_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(new_n36_), .c(new_n17_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n26_), .O(z5));
  inv1   g30(.a(new_n41_), .O(new_n46_));
  oai21  g31(.a(x4), .b(x2), .c(new_n21_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(x1), .c(new_n46_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(x0), .c(new_n26_), .O(z6));
endmodule
