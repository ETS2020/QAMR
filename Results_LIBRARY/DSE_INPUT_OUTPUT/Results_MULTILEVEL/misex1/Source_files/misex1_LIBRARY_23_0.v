...
module FAU ( 
  ...
  nand3  g17(.a(new_n25_), .b(x5), .c(new_n16_), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n32_), .c(x3), .O(new_n34_));
  oai21  g19(.a(x5), .b(x2), .c(x3), .O(new_n35_));
  nand3  g20(.a(x5), .b(x4), .c(new_n16_), .O(new_n36_));
  ...
  nand4  g33(.a(x5), .b(x3), .c(new_n16_), .d(x0), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n19_), .O(new_n51_));
  aoi21  g36(.a(x3), .b(new_n19_), .c(new_n23_), .O(new_n52_));
  ...
  nand3  g44(.a(new_n26_), .b(x5), .c(new_n16_), .O(new_n60_));
  ...
  oai22  g50(.a(new_n65_), .b(new_n17_), .c(x5), .d(x3), .O(new_n66_));
  ...
  nand3  g54(.a(new_n69_), .b(new_n67_), .c(new_n64_), .O(z6));
endmodule
