...
module FAU ( 
  ...
  aoi21  g13(.a(new_n17_), .b(new_n23_), .c(new_n28_), .O(new_n29_));
  inv1   g14(.a(x6), .O(new_n30_));
  oai21  g15(.a(new_n30_), .b(x3), .c(new_n22_), .O(new_n31_));
  aoi22  g16(.a(new_n31_), .b(new_n28_), .c(new_n29_), .d(new_n22_), .O(new_n32_));
  nor2   g17(.a(x1), .b(new_n20_), .O(new_n33_));
  nand2  g18(.a(x3), .b(new_n28_), .O(new_n34_));
  inv1   g19(.a(new_n34_), .O(new_n35_));
  aoi21  g20(.a(new_n35_), .b(new_n33_), .c(new_n18_), .O(new_n36_));
  oai21  g21(.a(new_n32_), .b(x0), .c(new_n36_), .O(z1));
  nand3  g22(.a(new_n28_), .b(new_n22_), .c(x0), .O(new_n38_));
  oai21  g23(.a(new_n22_), .b(x0), .c(new_n38_), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n19_), .c(x3), .O(new_n40_));
  nand3  g25(.a(new_n17_), .b(x4), .c(x1), .O(new_n41_));
  nand4  g26(.a(new_n30_), .b(new_n16_), .c(new_n23_), .d(new_n22_), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n41_), .c(x2), .O(new_n43_));
  nand2  g28(.a(x6), .b(new_n28_), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n17_), .c(new_n23_), .d(new_n22_), .O(new_n45_));
  inv1   g30(.a(new_n45_), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n43_), .c(new_n20_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n40_), .O(z2));
  oai21  g33(.a(x4), .b(x3), .c(x7), .O(new_n49_));
  nand4  g34(.a(new_n49_), .b(new_n28_), .c(x1), .d(new_n20_), .O(new_n50_));
  nand2  g35(.a(x5), .b(new_n20_), .O(new_n51_));
  nand4  g36(.a(new_n51_), .b(new_n23_), .c(x2), .d(new_n22_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n50_), .c(new_n19_), .O(z3));
  nand2  g38(.a(new_n23_), .b(x2), .O(new_n54_));
  oai21  g39(.a(new_n34_), .b(new_n20_), .c(new_n54_), .O(new_n55_));
  ...
  aoi21  g44(.a(new_n59_), .b(new_n56_), .c(new_n18_), .O(z4));
  aoi21  g45(.a(new_n54_), .b(new_n34_), .c(new_n20_), .O(new_n61_));
  nand3  g46(.a(x5), .b(new_n23_), .c(x2), .O(new_n62_));
  inv1   g47(.a(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n61_), .c(new_n22_), .O(new_n64_));
  inv1   g49(.a(new_n58_), .O(new_n65_));
  nand2  g50(.a(new_n54_), .b(x1), .O(new_n66_));
  nand3  g51(.a(x6), .b(new_n23_), .c(new_n28_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n20_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n64_), .c(new_n19_), .O(z5));
  nand3  g55(.a(new_n17_), .b(new_n23_), .c(x2), .O(new_n71_));
  ...
  nand3  g60(.a(new_n75_), .b(new_n73_), .c(new_n19_), .O(z6));
endmodule
