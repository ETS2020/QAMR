...
module FAU ( 
  ...
  nand2  g54(.a(new_n33_), .b(new_n16_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n20_), .c(new_n19_), .O(new_n71_));
  aoi21  g56(.a(new_n71_), .b(new_n17_), .c(new_n57_), .O(new_n72_));
