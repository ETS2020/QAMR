...
module FAU ( 
  ...
  aoi21  g22(.a(new_n37_), .b(new_n19_), .c(new_n33_), .O(new_n38_));
  ...
  oai21  g29(.a(new_n16_), .b(x0), .c(x1), .O(new_n45_));
  nand2  g30(.a(new_n20_), .b(x2), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(x1), .c(new_n28_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(x0), .O(new_n48_));
  aoi21  g33(.a(new_n20_), .b(x1), .c(x0), .O(new_n49_));
  nor3   g34(.a(x5), .b(x3), .c(x1), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(new_n49_), .c(x2), .O(new_n51_));
  nand3  g36(.a(new_n20_), .b(new_n16_), .c(new_n17_), .O(new_n52_));
  nand4  g37(.a(new_n52_), .b(new_n51_), .c(new_n48_), .d(new_n45_), .O(z4));
  nand3  g38(.a(x2), .b(new_n19_), .c(x0), .O(new_n54_));
  nand3  g39(.a(x6), .b(new_n16_), .c(new_n17_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n20_), .O(new_n57_));
  oai21  g42(.a(new_n29_), .b(x1), .c(x0), .O(new_n58_));
  oai21  g43(.a(new_n20_), .b(x0), .c(x2), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(x1), .O(new_n60_));
  oai21  g45(.a(new_n34_), .b(x1), .c(new_n20_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(x2), .c(new_n17_), .O(new_n62_));
  nand4  g47(.a(new_n62_), .b(new_n60_), .c(new_n58_), .d(new_n57_), .O(z5));
  nand2  g48(.a(new_n46_), .b(new_n28_), .O(new_n64_));
  aoi22  g49(.a(new_n64_), .b(x0), .c(new_n23_), .d(x2), .O(new_n65_));
