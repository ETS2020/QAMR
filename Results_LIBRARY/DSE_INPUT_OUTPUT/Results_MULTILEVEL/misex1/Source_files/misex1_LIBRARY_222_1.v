...
module FAU ( 
  ...
  nand2  g27(.a(new_n22_), .b(new_n17_), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n16_), .c(new_n21_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n40_), .O(z5));
  nand2  g30(.a(x4), .b(new_n18_), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n16_), .c(x1), .d(new_n21_), .O(new_n47_));
