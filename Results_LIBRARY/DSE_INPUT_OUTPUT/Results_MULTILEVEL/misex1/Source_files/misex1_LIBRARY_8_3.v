...
module FAU ( 
  ...
  oai21  g39(.a(new_n30_), .b(x3), .c(new_n16_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n17_), .c(new_n21_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n54_), .O(z5));
  aoi22  g42(.a(new_n48_), .b(x0), .c(new_n23_), .d(x2), .O(new_n58_));
  nand2  g43(.a(x4), .b(new_n18_), .O(new_n59_));
  nand4  g44(.a(new_n59_), .b(new_n17_), .c(x1), .d(new_n21_), .O(new_n60_));
