...
module FAU ( 
  ...
  oai21  g13(.a(x4), .b(x3), .c(x7), .O(new_n29_));
  nand4  g14(.a(new_n29_), .b(new_n16_), .c(x1), .d(new_n17_), .O(new_n30_));
  nor2   g15(.a(x3), .b(new_n16_), .O(new_n31_));
  nand3  g16(.a(new_n31_), .b(new_n19_), .c(x0), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n30_), .O(z3));
  xor2a  g18(.a(x3), .b(x2), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n19_), .O(new_n35_));
  oai21  g20(.a(new_n31_), .b(x0), .c(new_n35_), .O(z4));
  oai21  g21(.a(new_n34_), .b(new_n17_), .c(new_n19_), .O(new_n37_));
  oai21  g22(.a(new_n20_), .b(new_n19_), .c(x2), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n17_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n37_), .O(z5));
  nand3  g25(.a(new_n34_), .b(new_n19_), .c(x0), .O(new_n41_));
