...
module FAU ( 
  ...
  nand2  g30(.a(new_n45_), .b(new_n32_), .O(z2));
  ...
  oai21  g35(.a(new_n16_), .b(new_n17_), .c(x5), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n23_), .c(new_n29_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n50_), .O(z3));
  nor2   g38(.a(new_n23_), .b(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n19_), .c(x2), .O(new_n55_));
  oai21  g40(.a(new_n23_), .b(x1), .c(new_n17_), .O(new_n56_));
  nand3  g41(.a(x3), .b(new_n29_), .c(x0), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(x5), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n16_), .O(new_n59_));
  nor2   g44(.a(x5), .b(x3), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n29_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n59_), .c(new_n55_), .O(z4));
  nand2  g47(.a(new_n23_), .b(x2), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n31_), .c(new_n17_), .O(new_n64_));
  nor3   g49(.a(new_n34_), .b(new_n16_), .c(x0), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n64_), .c(new_n29_), .O(new_n66_));
  oai21  g51(.a(new_n36_), .b(x3), .c(new_n29_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(x5), .c(new_n16_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n41_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n17_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n66_), .O(z5));
  oai21  g56(.a(new_n64_), .b(new_n60_), .c(new_n29_), .O(new_n72_));
  inv1   g57(.a(x4), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n16_), .O(new_n74_));
  aoi21  g59(.a(new_n74_), .b(new_n23_), .c(new_n29_), .O(new_n75_));
  aoi22  g60(.a(new_n75_), .b(new_n17_), .c(new_n34_), .d(new_n16_), .O(new_n76_));
