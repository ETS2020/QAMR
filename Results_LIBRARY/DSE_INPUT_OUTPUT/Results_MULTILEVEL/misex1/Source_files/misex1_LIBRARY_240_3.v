...
module FAU ( 
  ...
  nand4  g07(.a(x5), .b(new_n17_), .c(x2), .d(new_n20_), .O(new_n23_));
  ...
  oai21  g21(.a(x1), .b(new_n20_), .c(new_n21_), .O(new_n37_));
  ...
  aoi21  g36(.a(new_n51_), .b(new_n22_), .c(new_n20_), .O(new_n52_));
  nand3  g37(.a(x5), .b(new_n17_), .c(x2), .O(new_n53_));
  inv1   g38(.a(new_n53_), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n52_), .c(new_n16_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n28_), .O(z5));
  xor2a  g41(.a(x3), .b(x2), .O(new_n57_));
  nor2   g42(.a(x5), .b(x3), .O(new_n58_));
  aoi22  g43(.a(new_n58_), .b(x2), .c(new_n57_), .d(x0), .O(new_n59_));
