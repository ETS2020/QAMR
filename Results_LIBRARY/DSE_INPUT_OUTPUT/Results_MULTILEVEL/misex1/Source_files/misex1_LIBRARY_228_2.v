...
module FAU ( 
  ...
  nand4  g26(.a(new_n33_), .b(new_n24_), .c(x2), .d(new_n16_), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n41_), .c(x0), .O(z3));
  oai21  g28(.a(x3), .b(new_n16_), .c(x2), .O(new_n44_));
  oai21  g29(.a(new_n24_), .b(x1), .c(new_n23_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n44_), .c(x0), .O(z4));
  oai21  g31(.a(x3), .b(new_n23_), .c(x1), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n25_), .c(new_n20_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n18_), .O(new_n49_));
  oai21  g34(.a(new_n33_), .b(new_n23_), .c(new_n18_), .O(new_n50_));
  ...
  aoi21  g39(.a(new_n54_), .b(new_n42_), .c(x0), .O(z6));
endmodule
