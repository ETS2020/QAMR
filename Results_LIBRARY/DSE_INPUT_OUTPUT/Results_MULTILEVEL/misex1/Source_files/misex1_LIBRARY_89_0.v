...
module FAU ( 
  ...
  aoi21  g21(.a(x5), .b(new_n19_), .c(x3), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n23_), .O(new_n38_));
  oai21  g23(.a(new_n36_), .b(x2), .c(new_n38_), .O(z3));
  oai21  g24(.a(x3), .b(new_n16_), .c(new_n19_), .O(new_n40_));
  oai21  g25(.a(new_n20_), .b(x1), .c(new_n40_), .O(z4));
  oai21  g26(.a(new_n23_), .b(new_n19_), .c(new_n16_), .O(new_n42_));
  oai21  g27(.a(new_n24_), .b(x1), .c(new_n17_), .O(new_n43_));
  ...
  nand3  g33(.a(new_n37_), .b(x2), .c(new_n23_), .O(new_n49_));
