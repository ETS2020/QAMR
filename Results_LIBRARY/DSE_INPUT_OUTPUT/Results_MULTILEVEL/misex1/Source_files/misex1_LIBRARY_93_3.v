...
module FAU ( 
  ...
  oai21  g35(.a(new_n50_), .b(new_n32_), .c(new_n48_), .O(z3));
  ...
  aoi21  g46(.a(new_n61_), .b(new_n52_), .c(new_n17_), .O(new_n62_));
  nor3   g47(.a(new_n25_), .b(new_n32_), .c(x0), .O(new_n63_));
  ...
  nand3  g56(.a(new_n25_), .b(new_n20_), .c(x2), .O(new_n72_));
  ...
  nand3  g61(.a(new_n76_), .b(new_n74_), .c(new_n70_), .O(z6));
endmodule
