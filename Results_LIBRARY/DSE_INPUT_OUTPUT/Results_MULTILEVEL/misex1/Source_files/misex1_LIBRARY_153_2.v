...
module FAU ( 
  ...
  nand3  g21(.a(new_n36_), .b(new_n23_), .c(new_n17_), .O(new_n37_));
  nand4  g22(.a(x3), .b(new_n16_), .c(new_n31_), .d(x0), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n37_), .c(new_n30_), .O(z2));
  nand2  g24(.a(x5), .b(new_n17_), .O(new_n40_));
  nand4  g25(.a(new_n40_), .b(new_n23_), .c(x2), .d(new_n31_), .O(new_n41_));
  ...
  oai21  g30(.a(x3), .b(new_n16_), .c(new_n27_), .O(new_n46_));
  ...
  nand2  g37(.a(new_n43_), .b(new_n24_), .O(new_n53_));
  nor2   g38(.a(x2), .b(new_n31_), .O(new_n54_));
  aoi21  g39(.a(new_n53_), .b(new_n17_), .c(new_n54_), .O(new_n55_));
  ...
  nand3  g44(.a(new_n44_), .b(x1), .c(new_n17_), .O(new_n60_));
