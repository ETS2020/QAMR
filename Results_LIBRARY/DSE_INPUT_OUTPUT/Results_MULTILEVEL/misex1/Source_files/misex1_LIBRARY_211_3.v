...
module FAU ( 
  ...
  oai21  g05(.a(x2), .b(new_n20_), .c(x1), .O(new_n21_));
  inv1   g06(.a(x2), .O(new_n22_));
  nor2   g07(.a(x5), .b(x3), .O(new_n23_));
  nand3  g08(.a(x6), .b(new_n17_), .c(new_n22_), .O(new_n24_));
  ...
  nand3  g12(.a(new_n27_), .b(new_n26_), .c(new_n21_), .O(z1));
  ...
  oai21  g26(.a(new_n17_), .b(new_n20_), .c(x2), .O(new_n42_));
  nand3  g27(.a(x3), .b(new_n22_), .c(x0), .O(new_n43_));
  ...
  nand3  g41(.a(new_n56_), .b(new_n22_), .c(new_n20_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n55_), .O(z5));
  aoi22  g43(.a(new_n49_), .b(x0), .c(new_n23_), .d(x2), .O(new_n59_));
  nand2  g44(.a(x4), .b(new_n17_), .O(new_n60_));
  nand4  g45(.a(new_n60_), .b(new_n22_), .c(x1), .d(new_n20_), .O(new_n61_));
