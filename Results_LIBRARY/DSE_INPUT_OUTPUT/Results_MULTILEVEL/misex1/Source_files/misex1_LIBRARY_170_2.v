...
module FAU ( 
  ...
  aoi21  g46(.a(x3), .b(new_n21_), .c(x2), .O(new_n62_));
  nor2   g47(.a(new_n22_), .b(new_n28_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n62_), .c(new_n19_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n61_), .c(new_n18_), .O(z4));
  nand2  g50(.a(x3), .b(new_n28_), .O(new_n66_));
  aoi21  g51(.a(new_n59_), .b(new_n66_), .c(new_n19_), .O(new_n67_));
  nand2  g52(.a(x5), .b(x2), .O(new_n68_));
  nor2   g53(.a(new_n68_), .b(x0), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n67_), .c(new_n21_), .O(new_n70_));
  inv1   g55(.a(new_n63_), .O(new_n71_));
  nor2   g56(.a(x4), .b(x2), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(x3), .c(x1), .O(new_n73_));
  nand2  g58(.a(new_n34_), .b(new_n16_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(new_n22_), .c(new_n28_), .O(new_n75_));
  nand3  g60(.a(new_n75_), .b(new_n73_), .c(new_n71_), .O(new_n76_));
  nand2  g61(.a(new_n76_), .b(new_n19_), .O(new_n77_));
  nand3  g62(.a(new_n77_), .b(new_n70_), .c(new_n18_), .O(z5));
  nand2  g63(.a(new_n38_), .b(x2), .O(new_n79_));
  inv1   g64(.a(new_n79_), .O(new_n80_));
  oai21  g65(.a(new_n80_), .b(new_n67_), .c(new_n21_), .O(new_n81_));
  or2    g66(.a(new_n73_), .b(x0), .O(new_n82_));
  nand3  g67(.a(new_n82_), .b(new_n81_), .c(new_n18_), .O(z6));
endmodule
