...
module FAU ( 
  ...
  oai21  g22(.a(x4), .b(x3), .c(x6), .O(new_n38_));
  ...
  and2   g37(.a(new_n39_), .b(new_n27_), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(x0), .c(new_n52_), .O(z4));
  aoi21  g39(.a(new_n50_), .b(new_n31_), .c(new_n17_), .O(new_n55_));
  ...
  oai21  g55(.a(new_n63_), .b(new_n20_), .c(new_n70_), .O(new_n71_));
