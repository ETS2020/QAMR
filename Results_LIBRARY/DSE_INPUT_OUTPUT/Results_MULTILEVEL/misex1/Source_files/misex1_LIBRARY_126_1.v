...
module FAU ( 
  ...
  nand3  g16(.a(new_n27_), .b(x3), .c(new_n23_), .O(new_n32_));
  ...
  nand3  g23(.a(x3), .b(new_n18_), .c(x0), .O(new_n39_));
  ...
  nand2  g34(.a(new_n27_), .b(x3), .O(new_n50_));
  nand2  g35(.a(new_n19_), .b(x2), .O(new_n51_));
  nand2  g36(.a(new_n23_), .b(x0), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n50_), .c(new_n51_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n18_), .O(new_n54_));
  aoi21  g39(.a(x3), .b(new_n18_), .c(x6), .O(new_n55_));
  ...
  aoi21  g43(.a(new_n51_), .b(new_n32_), .c(new_n16_), .O(new_n59_));
  nor2   g44(.a(new_n35_), .b(x0), .O(new_n60_));
  ...
  nand3  g48(.a(new_n63_), .b(new_n61_), .c(new_n24_), .O(z5));
  inv1   g49(.a(x5), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n19_), .c(x2), .O(new_n66_));
  ...
  nand3  g55(.a(new_n27_), .b(new_n70_), .c(new_n23_), .O(new_n71_));
