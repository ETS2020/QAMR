...
module FAU ( 
  ...
  nand3  g24(.a(new_n29_), .b(new_n19_), .c(x0), .O(new_n40_));
  oai21  g25(.a(new_n39_), .b(x0), .c(new_n40_), .O(z2));
  nand2  g26(.a(x5), .b(new_n23_), .O(new_n42_));
  nand4  g27(.a(new_n42_), .b(new_n16_), .c(x2), .d(new_n19_), .O(new_n43_));
  oai21  g28(.a(x2), .b(new_n19_), .c(new_n43_), .O(z3));
  nor2   g29(.a(new_n16_), .b(new_n25_), .O(new_n45_));
  nor2   g30(.a(x3), .b(x1), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n45_), .c(new_n23_), .O(new_n47_));
  nand2  g32(.a(new_n30_), .b(new_n21_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n19_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n47_), .O(z4));
  nand2  g35(.a(x3), .b(new_n25_), .O(new_n51_));
  oai21  g36(.a(new_n21_), .b(x1), .c(new_n51_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(x0), .O(new_n53_));
  aoi21  g38(.a(x5), .b(new_n19_), .c(x3), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n25_), .c(new_n26_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n23_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n53_), .c(new_n18_), .O(z5));
  nand4  g42(.a(new_n32_), .b(new_n16_), .c(x2), .d(new_n19_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n53_), .c(new_n18_), .O(z6));
endmodule
