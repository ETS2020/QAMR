...
module FAU ( 
  ...
  nand2  g26(.a(new_n41_), .b(x7), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(x3), .O(new_n43_));
  oai21  g28(.a(new_n40_), .b(x0), .c(new_n43_), .O(z2));
  nor2   g29(.a(x7), .b(new_n18_), .O(new_n45_));
  inv1   g30(.a(new_n45_), .O(new_n46_));
  oai21  g31(.a(x4), .b(x3), .c(x7), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(new_n16_), .c(x1), .d(new_n20_), .O(new_n48_));
  nand2  g33(.a(x5), .b(new_n20_), .O(new_n49_));
  nand4  g34(.a(new_n49_), .b(new_n18_), .c(x2), .d(new_n17_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n48_), .c(new_n46_), .O(z3));
  ...
  nand3  g43(.a(new_n58_), .b(new_n55_), .c(new_n46_), .O(z4));
  nand2  g44(.a(new_n22_), .b(new_n16_), .O(new_n60_));
  aoi21  g45(.a(new_n53_), .b(new_n60_), .c(new_n20_), .O(new_n61_));
  ...
  nand2  g51(.a(new_n22_), .b(x2), .O(new_n67_));
  oai21  g52(.a(new_n26_), .b(x2), .c(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n66_), .c(new_n20_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n64_), .O(z5));
  nand3  g55(.a(new_n35_), .b(new_n18_), .c(x2), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n61_), .c(new_n17_), .O(new_n73_));
  inv1   g58(.a(x4), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(new_n18_), .c(new_n16_), .O(new_n75_));
  aoi21  g60(.a(new_n75_), .b(new_n21_), .c(new_n17_), .O(new_n76_));
  aoi21  g61(.a(new_n76_), .b(new_n20_), .c(new_n45_), .O(new_n77_));
