...
module FAU ( 
  ...
  oai21  g12(.a(new_n19_), .b(x3), .c(new_n23_), .O(new_n28_));
  ...
  nand3  g21(.a(new_n36_), .b(new_n32_), .c(new_n23_), .O(new_n37_));
  ...
  aoi22  g27(.a(new_n42_), .b(new_n41_), .c(new_n19_), .d(x2), .O(new_n43_));
  ...
  aoi21  g42(.a(new_n50_), .b(new_n40_), .c(new_n17_), .O(new_n58_));
  nand4  g43(.a(x6), .b(x5), .c(x2), .d(new_n17_), .O(new_n59_));
  inv1   g44(.a(new_n59_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n58_), .c(new_n23_), .O(new_n61_));
  nand2  g46(.a(x6), .b(x3), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(x2), .c(new_n23_), .O(new_n63_));
  xor2a  g48(.a(x3), .b(x2), .O(new_n64_));
  nor2   g49(.a(new_n64_), .b(new_n19_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n63_), .c(new_n17_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n61_), .O(z5));
  inv1   g52(.a(x5), .O(new_n68_));
  nand4  g53(.a(x6), .b(new_n68_), .c(new_n32_), .d(x2), .O(new_n69_));
  inv1   g54(.a(new_n69_), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n58_), .c(new_n23_), .O(new_n71_));
  oai21  g56(.a(new_n33_), .b(x3), .c(new_n16_), .O(new_n72_));
