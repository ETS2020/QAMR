...
module FAU ( 
  ...
  oai21  g20(.a(new_n33_), .b(new_n24_), .c(new_n35_), .O(z1));
  ...
  nand2  g27(.a(new_n23_), .b(new_n28_), .O(new_n43_));
  ...
  nand2  g36(.a(x3), .b(new_n28_), .O(new_n52_));
  ...
  nor2   g41(.a(new_n19_), .b(new_n28_), .O(new_n57_));
  ...
  nand3  g54(.a(new_n61_), .b(new_n19_), .c(x2), .O(new_n70_));
  inv1   g55(.a(new_n70_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n60_), .c(new_n18_), .O(new_n72_));
