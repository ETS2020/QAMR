...
module FAU ( 
  ...
  nand3  g31(.a(x7), .b(new_n46_), .c(new_n26_), .O(new_n47_));
  ...
  nand2  g36(.a(new_n26_), .b(x0), .O(new_n52_));
  ...
  aoi21  g41(.a(x3), .b(new_n18_), .c(new_n56_), .O(new_n57_));
  nand2  g42(.a(x3), .b(x2), .O(new_n58_));
  inv1   g43(.a(new_n58_), .O(new_n59_));
  aoi21  g44(.a(new_n57_), .b(new_n26_), .c(new_n59_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(x0), .c(new_n55_), .O(z4));
  nand3  g46(.a(x7), .b(x3), .c(new_n26_), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n51_), .c(new_n16_), .O(new_n63_));
  nor3   g48(.a(new_n27_), .b(new_n26_), .c(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n63_), .c(new_n18_), .O(new_n65_));
  aoi21  g50(.a(new_n53_), .b(x2), .c(new_n18_), .O(new_n66_));
  oai21  g51(.a(new_n29_), .b(x2), .c(new_n58_), .O(new_n67_));
  ...
  oai21  g56(.a(new_n71_), .b(new_n63_), .c(new_n18_), .O(new_n72_));
  oai21  g57(.a(new_n23_), .b(new_n19_), .c(new_n47_), .O(new_n73_));
