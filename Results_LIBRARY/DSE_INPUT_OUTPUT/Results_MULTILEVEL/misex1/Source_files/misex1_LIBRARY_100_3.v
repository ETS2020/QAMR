...
module FAU ( 
  ...
  oai21  g31(.a(new_n31_), .b(x1), .c(new_n28_), .O(new_n47_));
  ...
  nand2  g36(.a(new_n51_), .b(new_n26_), .O(z5));
  oai21  g37(.a(new_n28_), .b(x1), .c(new_n20_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(x0), .O(new_n54_));
  oai21  g39(.a(x4), .b(x2), .c(new_n28_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(x1), .c(new_n16_), .O(new_n56_));
  nand3  g41(.a(new_n21_), .b(x2), .c(new_n19_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(z6));
endmodule
