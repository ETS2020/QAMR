...
module FAU ( 
  ...
  aoi21  g14(.a(new_n29_), .b(new_n26_), .c(x1), .O(z1));
  ...
  aoi21  g22(.a(new_n35_), .b(new_n19_), .c(new_n37_), .O(new_n38_));
  nand3  g23(.a(new_n28_), .b(new_n19_), .c(x0), .O(new_n39_));
  ...
  oai21  g27(.a(x2), .b(new_n19_), .c(new_n42_), .O(z3));
  nor2   g28(.a(new_n20_), .b(new_n16_), .O(new_n44_));
  nor2   g29(.a(x3), .b(x2), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n44_), .c(new_n17_), .O(new_n46_));
  oai21  g31(.a(new_n20_), .b(new_n17_), .c(new_n19_), .O(new_n47_));
  ...
  aoi21  g36(.a(new_n51_), .b(new_n27_), .c(new_n17_), .O(new_n52_));
  nor3   g37(.a(new_n31_), .b(new_n16_), .c(x0), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n52_), .c(new_n19_), .O(new_n54_));
  oai21  g39(.a(new_n20_), .b(new_n16_), .c(new_n24_), .O(new_n55_));
  aoi22  g40(.a(new_n55_), .b(new_n17_), .c(new_n16_), .d(x1), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n54_), .O(z5));
  aoi21  g42(.a(new_n23_), .b(x2), .c(new_n52_), .O(new_n58_));
