...
module FAU ( 
  ...
  nand2  g54(.a(x7), .b(x2), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n69_), .c(new_n64_), .O(z5));
  aoi21  g56(.a(new_n53_), .b(new_n52_), .c(new_n17_), .O(new_n72_));
  nand4  g57(.a(new_n16_), .b(new_n25_), .c(new_n20_), .d(x2), .O(new_n73_));
  inv1   g58(.a(new_n73_), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(new_n72_), .c(new_n19_), .O(new_n75_));
  oai21  g60(.a(new_n40_), .b(x3), .c(new_n32_), .O(new_n76_));
