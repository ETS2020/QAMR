...
module FAU ( 
  ...
  aoi21  g22(.a(x5), .b(new_n19_), .c(x3), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(x2), .c(new_n23_), .O(new_n39_));
  oai21  g24(.a(new_n37_), .b(x2), .c(new_n39_), .O(z3));
  oai21  g25(.a(new_n27_), .b(new_n20_), .c(new_n19_), .O(new_n41_));
  nand3  g26(.a(new_n17_), .b(x2), .c(new_n23_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n41_), .O(z4));
  oai21  g28(.a(new_n23_), .b(new_n19_), .c(new_n16_), .O(new_n44_));
  oai21  g29(.a(new_n24_), .b(x1), .c(new_n17_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n19_), .O(new_n46_));
  nand3  g31(.a(new_n17_), .b(new_n23_), .c(x0), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n46_), .c(new_n44_), .O(z5));
  aoi22  g33(.a(new_n30_), .b(new_n16_), .c(x3), .d(x1), .O(new_n49_));
  oai21  g34(.a(new_n38_), .b(new_n16_), .c(new_n23_), .O(new_n50_));
  oai21  g35(.a(new_n49_), .b(x0), .c(new_n50_), .O(z6));
endmodule
