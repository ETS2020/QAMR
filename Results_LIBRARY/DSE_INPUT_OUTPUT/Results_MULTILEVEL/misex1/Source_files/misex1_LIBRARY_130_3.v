...
module FAU ( 
  ...
  nand4  g21(.a(new_n36_), .b(new_n20_), .c(new_n19_), .d(new_n17_), .O(new_n37_));
  inv1   g22(.a(x4), .O(new_n38_));
  oai21  g23(.a(new_n38_), .b(x2), .c(new_n20_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(x1), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n37_), .c(new_n25_), .O(z2));
  ...
  nand3  g44(.a(new_n59_), .b(new_n51_), .c(new_n27_), .O(new_n60_));
  ...
  aoi22  g49(.a(new_n64_), .b(x0), .c(new_n63_), .d(x2), .O(new_n65_));
