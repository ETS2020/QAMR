...
module FAU ( 
  ...
  nand2  g54(.a(x6), .b(new_n20_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n19_), .c(x2), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n69_), .c(new_n17_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(new_n67_), .c(new_n16_), .O(z5));
  inv1   g58(.a(new_n16_), .O(new_n74_));
  nand3  g59(.a(new_n40_), .b(new_n20_), .c(x2), .O(new_n75_));
  oai21  g60(.a(new_n65_), .b(new_n17_), .c(new_n75_), .O(new_n76_));
  aoi21  g61(.a(new_n76_), .b(new_n19_), .c(new_n64_), .O(new_n77_));
  nand4  g62(.a(new_n34_), .b(new_n26_), .c(x1), .d(new_n17_), .O(new_n78_));
  oai21  g63(.a(new_n77_), .b(new_n74_), .c(new_n78_), .O(z6));
endmodule
