...
module FAU ( 
  ...
  oai21  g45(.a(x2), .b(x1), .c(x3), .O(new_n61_));
  nor2   g46(.a(new_n61_), .b(x0), .O(new_n62_));
  aoi21  g47(.a(new_n60_), .b(new_n18_), .c(new_n62_), .O(new_n63_));
  inv1   g48(.a(x4), .O(new_n64_));
  aoi21  g49(.a(x6), .b(new_n64_), .c(new_n23_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n18_), .c(new_n30_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n27_), .c(new_n16_), .O(new_n67_));
  oai21  g52(.a(new_n63_), .b(new_n24_), .c(new_n67_), .O(z5));
  nand3  g53(.a(new_n28_), .b(new_n19_), .c(x2), .O(new_n69_));
  oai21  g54(.a(new_n58_), .b(new_n16_), .c(new_n69_), .O(new_n70_));
  ...
  aoi21  g58(.a(new_n73_), .b(new_n71_), .c(new_n24_), .O(z6));
endmodule
