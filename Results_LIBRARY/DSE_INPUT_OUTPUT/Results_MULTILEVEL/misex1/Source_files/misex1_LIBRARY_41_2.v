...
module FAU ( 
  ...
  nand2  g31(.a(new_n24_), .b(x2), .O(new_n47_));
  oai21  g32(.a(new_n46_), .b(new_n17_), .c(new_n47_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n27_), .O(new_n49_));
  oai21  g34(.a(new_n24_), .b(x0), .c(x6), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(x2), .O(new_n51_));
  nand2  g36(.a(x3), .b(new_n27_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n16_), .c(new_n17_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n51_), .c(new_n49_), .O(z4));
  nand3  g39(.a(x6), .b(new_n24_), .c(x2), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n46_), .c(new_n17_), .O(new_n56_));
  nand4  g41(.a(x6), .b(x5), .c(new_n24_), .d(x2), .O(new_n57_));
  inv1   g42(.a(new_n57_), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n56_), .c(new_n27_), .O(new_n59_));
  nand2  g44(.a(x6), .b(x3), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(x2), .c(new_n27_), .O(new_n61_));
  nand2  g46(.a(x3), .b(x2), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n25_), .c(new_n19_), .O(new_n63_));
  ...
  oai21  g53(.a(new_n68_), .b(new_n56_), .c(new_n27_), .O(new_n69_));
