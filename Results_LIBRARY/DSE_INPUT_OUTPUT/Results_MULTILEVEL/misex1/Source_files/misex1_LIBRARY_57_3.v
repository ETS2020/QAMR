...
module FAU ( 
  ...
  oai21  g11(.a(new_n19_), .b(x0), .c(new_n26_), .O(new_n27_));
  ...
  nand2  g23(.a(new_n16_), .b(new_n25_), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n38_), .c(x3), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n19_), .c(new_n36_), .O(new_n41_));
  ...
  aoi21  g33(.a(x5), .b(new_n17_), .c(x6), .O(new_n49_));
  ...
  nand3  g40(.a(new_n16_), .b(x3), .c(x2), .O(new_n56_));
  inv1   g41(.a(new_n56_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n55_), .c(new_n17_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n54_), .O(z4));
  aoi21  g44(.a(new_n52_), .b(new_n43_), .c(new_n17_), .O(new_n60_));
  nand4  g45(.a(new_n16_), .b(x5), .c(x2), .d(new_n17_), .O(new_n61_));
