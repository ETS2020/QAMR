...
module FAU ( 
  ...
  nand2  g26(.a(new_n41_), .b(x5), .O(new_n42_));
  ...
  nand2  g31(.a(new_n46_), .b(x5), .O(new_n47_));
  ...
  nand4  g37(.a(x5), .b(x3), .c(new_n16_), .d(x0), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n19_), .O(new_n55_));
  aoi21  g40(.a(x3), .b(new_n19_), .c(new_n23_), .O(new_n56_));
  ...
  aoi21  g49(.a(new_n64_), .b(new_n63_), .c(new_n23_), .O(new_n65_));
  ...
  oai21  g55(.a(x5), .b(x2), .c(x3), .O(new_n71_));
  inv1   g56(.a(x4), .O(new_n72_));
  nand3  g57(.a(x5), .b(new_n72_), .c(new_n16_), .O(new_n73_));
