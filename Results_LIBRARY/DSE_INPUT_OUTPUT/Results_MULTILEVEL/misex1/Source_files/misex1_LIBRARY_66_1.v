...
module FAU ( 
  ...
  nand3  g11(.a(new_n23_), .b(new_n16_), .c(x1), .O(new_n27_));
  oai21  g12(.a(new_n26_), .b(x1), .c(new_n27_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n17_), .O(new_n29_));
  nand3  g14(.a(new_n23_), .b(x3), .c(new_n16_), .O(new_n30_));
  ...
  nand3  g26(.a(new_n41_), .b(new_n23_), .c(new_n16_), .O(new_n42_));
  ...
  nand4  g33(.a(new_n48_), .b(new_n23_), .c(new_n16_), .d(x1), .O(new_n49_));
  ...
  aoi21  g41(.a(x3), .b(new_n19_), .c(x6), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n16_), .c(new_n43_), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(x0), .c(new_n56_), .O(z4));
  aoi21  g44(.a(new_n53_), .b(new_n30_), .c(new_n17_), .O(new_n60_));
  nor3   g45(.a(new_n35_), .b(new_n16_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n60_), .c(new_n19_), .O(new_n62_));
  nand3  g47(.a(new_n53_), .b(new_n23_), .c(x1), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n44_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n17_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n62_), .O(z5));
  nand3  g51(.a(new_n35_), .b(new_n20_), .c(x2), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n60_), .c(new_n19_), .O(new_n69_));
  nand3  g54(.a(new_n23_), .b(new_n40_), .c(new_n16_), .O(new_n70_));
  oai21  g55(.a(new_n24_), .b(new_n20_), .c(new_n70_), .O(new_n71_));
