...
module FAU ( 
  ...
  aoi21  g22(.a(new_n37_), .b(new_n32_), .c(x0), .O(z2));
  oai21  g23(.a(x4), .b(x3), .c(x7), .O(new_n39_));
  nand4  g24(.a(new_n39_), .b(new_n18_), .c(x1), .d(new_n16_), .O(new_n40_));
  nand2  g25(.a(x5), .b(new_n16_), .O(new_n41_));
  nand4  g26(.a(new_n41_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n40_), .O(z3));
  oai21  g28(.a(new_n18_), .b(new_n17_), .c(new_n19_), .O(new_n44_));
  oai21  g29(.a(x1), .b(x0), .c(new_n18_), .O(new_n45_));
  nand3  g30(.a(x3), .b(x2), .c(new_n16_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n45_), .c(new_n44_), .O(z4));
  oai21  g32(.a(x3), .b(x1), .c(x2), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(x0), .O(new_n49_));
  oai21  g34(.a(new_n19_), .b(x0), .c(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(x1), .O(new_n51_));
  oai21  g36(.a(new_n23_), .b(x1), .c(new_n19_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(x2), .c(new_n16_), .O(new_n53_));
  nand3  g38(.a(x6), .b(new_n19_), .c(new_n18_), .O(new_n54_));
