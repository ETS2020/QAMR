...
module FAU ( 
  ...
  oai21  g09(.a(new_n21_), .b(new_n20_), .c(new_n16_), .O(new_n25_));
  nand3  g10(.a(x3), .b(new_n21_), .c(new_n20_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n25_), .O(z1));
  aoi21  g12(.a(x3), .b(new_n21_), .c(new_n16_), .O(new_n28_));
  aoi21  g13(.a(x4), .b(new_n21_), .c(x3), .O(new_n29_));
  oai22  g14(.a(new_n29_), .b(x0), .c(new_n28_), .d(x1), .O(z2));
  oai21  g15(.a(x4), .b(x3), .c(x7), .O(new_n31_));
  nand4  g16(.a(new_n31_), .b(new_n21_), .c(x1), .d(new_n16_), .O(new_n32_));
  nand3  g17(.a(new_n22_), .b(new_n20_), .c(x0), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n32_), .O(z3));
  xor2a  g19(.a(x3), .b(x2), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n20_), .O(new_n36_));
  oai21  g21(.a(new_n22_), .b(x0), .c(new_n36_), .O(z4));
  oai21  g22(.a(new_n35_), .b(new_n16_), .c(new_n20_), .O(new_n38_));
  inv1   g23(.a(x3), .O(new_n39_));
  oai21  g24(.a(new_n39_), .b(new_n20_), .c(x2), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n16_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n38_), .O(z5));
  nand3  g27(.a(new_n35_), .b(new_n20_), .c(x0), .O(new_n43_));
  oai21  g28(.a(x4), .b(x2), .c(new_n39_), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(x1), .c(new_n16_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n43_), .O(z6));
endmodule
