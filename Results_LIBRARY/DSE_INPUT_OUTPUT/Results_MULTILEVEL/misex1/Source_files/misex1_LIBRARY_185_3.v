...
module FAU ( 
  ...
  aoi21  g23(.a(new_n38_), .b(new_n19_), .c(new_n33_), .O(new_n39_));
  nand3  g24(.a(new_n24_), .b(new_n19_), .c(x0), .O(new_n40_));
  ...
  oai21  g32(.a(new_n23_), .b(new_n17_), .c(new_n47_), .O(new_n48_));
  ...
  aoi21  g39(.a(new_n47_), .b(new_n23_), .c(new_n17_), .O(new_n55_));
  nor3   g40(.a(new_n34_), .b(new_n16_), .c(x0), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n55_), .c(new_n19_), .O(new_n57_));
  nand2  g42(.a(new_n51_), .b(new_n27_), .O(new_n58_));
  aoi21  g43(.a(new_n47_), .b(x1), .c(new_n58_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(x0), .c(new_n57_), .O(z5));
  nor2   g45(.a(x5), .b(x3), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(x2), .c(new_n55_), .O(new_n62_));
