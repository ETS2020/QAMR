...
module FAU ( 
  ...
  nand2  g27(.a(x5), .b(new_n19_), .O(new_n43_));
  nand4  g28(.a(new_n43_), .b(new_n23_), .c(x2), .d(new_n22_), .O(new_n44_));
  ...
  oai21  g35(.a(x3), .b(x1), .c(x2), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(x0), .O(new_n52_));
  oai21  g37(.a(new_n46_), .b(new_n16_), .c(x1), .O(new_n53_));
  oai21  g38(.a(new_n24_), .b(x1), .c(new_n23_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(x2), .c(new_n19_), .O(new_n55_));
  nand3  g40(.a(x6), .b(new_n23_), .c(new_n16_), .O(new_n56_));
  nand4  g41(.a(new_n56_), .b(new_n55_), .c(new_n53_), .d(new_n52_), .O(z5));
  oai21  g42(.a(x4), .b(x2), .c(new_n23_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(x1), .c(new_n19_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n44_), .O(z6));
endmodule
