...
module FAU ( 
  ...
  nand3  g15(.a(new_n30_), .b(new_n26_), .c(new_n23_), .O(new_n31_));
  ...
  nand3  g23(.a(new_n38_), .b(new_n23_), .c(x1), .O(new_n39_));
  nand2  g24(.a(x6), .b(new_n23_), .O(new_n40_));
  ...
  nor2   g36(.a(new_n26_), .b(x0), .O(new_n52_));
  nor2   g37(.a(new_n52_), .b(x3), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(x2), .c(new_n18_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n51_), .O(z3));
  nand2  g40(.a(new_n19_), .b(x2), .O(new_n56_));
  nand3  g41(.a(new_n34_), .b(new_n23_), .c(x0), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n18_), .O(new_n59_));
  aoi21  g44(.a(x3), .b(new_n18_), .c(x5), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n23_), .c(new_n43_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(x0), .c(new_n59_), .O(z4));
  nand2  g47(.a(x3), .b(new_n23_), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n56_), .c(new_n16_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n52_), .c(new_n18_), .O(new_n65_));
  inv1   g50(.a(new_n43_), .O(new_n66_));
  nand2  g51(.a(new_n56_), .b(x1), .O(new_n67_));
  ...
  nand3  g55(.a(new_n70_), .b(new_n65_), .c(new_n24_), .O(z5));
  ...
  nand3  g61(.a(new_n76_), .b(new_n74_), .c(new_n24_), .O(z6));
endmodule
