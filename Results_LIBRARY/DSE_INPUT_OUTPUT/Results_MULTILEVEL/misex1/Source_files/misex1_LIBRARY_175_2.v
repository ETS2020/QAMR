...
module FAU ( 
  ...
  nand3  g25(.a(new_n40_), .b(new_n21_), .c(x1), .O(new_n41_));
  nand3  g26(.a(new_n22_), .b(x2), .c(new_n16_), .O(new_n42_));
  ...
  oai21  g31(.a(new_n24_), .b(x1), .c(new_n21_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n46_), .c(x0), .O(z4));
  oai21  g33(.a(x3), .b(new_n21_), .c(x1), .O(new_n49_));
  inv1   g34(.a(new_n25_), .O(new_n50_));
  oai21  g35(.a(new_n33_), .b(x1), .c(new_n24_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(x2), .c(new_n50_), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n49_), .c(x0), .O(z5));
  nor2   g38(.a(x4), .b(x2), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(x3), .c(x1), .O(new_n55_));
  aoi21  g40(.a(new_n22_), .b(x2), .c(x0), .O(new_n56_));
  oai22  g41(.a(new_n56_), .b(x1), .c(new_n55_), .d(x0), .O(z6));
endmodule
