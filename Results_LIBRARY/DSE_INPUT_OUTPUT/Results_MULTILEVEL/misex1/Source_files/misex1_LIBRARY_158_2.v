...
module FAU ( 
  ...
  nand2  g41(.a(new_n21_), .b(new_n28_), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n56_), .c(x0), .O(new_n58_));
  nand3  g43(.a(x3), .b(new_n28_), .c(x0), .O(new_n59_));
  ...
  nand2  g47(.a(new_n16_), .b(x6), .O(new_n63_));
  nand4  g48(.a(new_n63_), .b(new_n28_), .c(x1), .d(new_n18_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n62_), .O(z4));
  nand2  g50(.a(x3), .b(new_n28_), .O(new_n66_));
  aoi21  g51(.a(new_n60_), .b(new_n66_), .c(new_n18_), .O(new_n67_));
  inv1   g52(.a(x5), .O(new_n68_));
  nor3   g53(.a(new_n68_), .b(new_n28_), .c(x0), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n67_), .c(new_n20_), .O(new_n70_));
  nand2  g55(.a(new_n60_), .b(x1), .O(new_n71_));
  nand3  g56(.a(x6), .b(new_n21_), .c(new_n28_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(new_n71_), .c(new_n56_), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n18_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(new_n70_), .c(new_n17_), .O(z5));
  nand3  g60(.a(new_n68_), .b(new_n21_), .c(x2), .O(new_n76_));
  inv1   g61(.a(new_n76_), .O(new_n77_));
  oai21  g62(.a(new_n77_), .b(new_n67_), .c(new_n20_), .O(new_n78_));
  oai21  g63(.a(x4), .b(x2), .c(new_n21_), .O(new_n79_));
  nand3  g64(.a(new_n79_), .b(x1), .c(new_n18_), .O(new_n80_));
  nand3  g65(.a(new_n80_), .b(new_n78_), .c(new_n17_), .O(z6));
endmodule
