...
module FAU ( 
  ...
  nand4  g16(.a(x3), .b(new_n26_), .c(new_n18_), .d(x0), .O(new_n32_));
  inv1   g17(.a(new_n32_), .O(new_n33_));
  nor2   g18(.a(new_n33_), .b(new_n23_), .O(new_n34_));
  ...
  oai21  g22(.a(new_n36_), .b(new_n18_), .c(new_n37_), .O(new_n38_));
  aoi21  g23(.a(new_n38_), .b(new_n16_), .c(new_n33_), .O(new_n39_));
  nor3   g24(.a(x2), .b(x1), .c(x0), .O(new_n40_));
  nand4  g25(.a(new_n40_), .b(x7), .c(new_n29_), .d(new_n19_), .O(new_n41_));
  oai21  g26(.a(new_n39_), .b(new_n23_), .c(new_n41_), .O(z2));
  oai21  g27(.a(x4), .b(x3), .c(x7), .O(new_n43_));
  nand4  g28(.a(new_n43_), .b(new_n26_), .c(x1), .d(new_n16_), .O(new_n44_));
  nand2  g29(.a(x5), .b(new_n16_), .O(new_n45_));
  nand4  g30(.a(new_n45_), .b(new_n19_), .c(x2), .d(new_n18_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n44_), .c(new_n24_), .O(z3));
  ...
  nor2   g36(.a(new_n19_), .b(new_n26_), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n51_), .c(new_n16_), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(new_n50_), .c(new_n23_), .O(z4));
  ...
  aoi21  g44(.a(x5), .b(new_n18_), .c(x3), .O(new_n60_));
  nand3  g45(.a(x7), .b(new_n29_), .c(new_n18_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n19_), .c(new_n26_), .O(new_n62_));
  oai21  g47(.a(new_n60_), .b(new_n26_), .c(new_n62_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n16_), .O(new_n64_));
  nand4  g49(.a(new_n64_), .b(new_n59_), .c(new_n57_), .d(new_n24_), .O(z5));
  nand2  g50(.a(new_n27_), .b(x2), .O(new_n66_));
  oai21  g51(.a(new_n55_), .b(new_n16_), .c(new_n66_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n18_), .O(new_n68_));
  aoi21  g53(.a(new_n68_), .b(new_n59_), .c(new_n23_), .O(z6));
endmodule
