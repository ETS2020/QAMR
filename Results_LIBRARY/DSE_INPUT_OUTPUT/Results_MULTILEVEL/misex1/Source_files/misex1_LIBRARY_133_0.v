...
module FAU ( 
  ...
  nor2   g10(.a(new_n25_), .b(new_n20_), .O(new_n26_));
  ...
  nand2  g19(.a(x2), .b(new_n19_), .O(new_n35_));
  inv1   g20(.a(x5), .O(new_n36_));
  nand3  g21(.a(x6), .b(new_n36_), .c(new_n20_), .O(new_n37_));
  nor2   g22(.a(new_n37_), .b(new_n35_), .O(new_n38_));
  oai21  g23(.a(new_n38_), .b(new_n34_), .c(new_n17_), .O(new_n39_));
  nand4  g24(.a(new_n26_), .b(new_n16_), .c(new_n19_), .d(x0), .O(new_n40_));
  ...
  aoi21  g29(.a(new_n44_), .b(x2), .c(new_n25_), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(x1), .c(new_n43_), .O(z3));
  nor2   g31(.a(new_n20_), .b(x0), .O(new_n47_));
  ...
  oai21  g48(.a(new_n61_), .b(new_n25_), .c(new_n63_), .O(z5));
  aoi21  g49(.a(new_n23_), .b(x2), .c(new_n25_), .O(new_n65_));
  oai21  g50(.a(new_n56_), .b(new_n17_), .c(new_n65_), .O(new_n66_));
