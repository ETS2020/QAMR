...
module FAU ( 
  ...
  aoi21  g23(.a(new_n38_), .b(new_n23_), .c(new_n34_), .O(new_n39_));
  ...
  nand3  g44(.a(new_n59_), .b(new_n29_), .c(x0), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  nor3   g46(.a(new_n35_), .b(new_n16_), .c(x0), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n61_), .c(new_n23_), .O(new_n63_));
  ...
  nand3  g54(.a(new_n24_), .b(x2), .c(new_n17_), .O(new_n70_));
