...
module FAU ( 
  ...
  nand3  g16(.a(new_n31_), .b(x4), .c(new_n23_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n29_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n16_), .O(new_n34_));
  nand2  g19(.a(new_n18_), .b(x0), .O(new_n35_));
  nand3  g20(.a(x4), .b(x3), .c(new_n23_), .O(new_n36_));
  or2    g21(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n34_), .O(z1));
  nand2  g23(.a(x3), .b(x2), .O(new_n39_));
  nand2  g24(.a(x4), .b(new_n23_), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n39_), .c(new_n18_), .O(new_n41_));
  nand3  g26(.a(new_n27_), .b(x2), .c(new_n18_), .O(new_n42_));
  nand3  g27(.a(new_n30_), .b(x4), .c(new_n23_), .O(new_n43_));
  aoi21  g28(.a(new_n43_), .b(new_n42_), .c(x3), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(new_n41_), .c(new_n16_), .O(new_n45_));
  ...
  aoi21  g46(.a(new_n55_), .b(new_n36_), .c(new_n16_), .O(new_n62_));
  nor3   g47(.a(new_n27_), .b(new_n23_), .c(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n62_), .c(new_n18_), .O(new_n64_));
  oai21  g49(.a(x3), .b(new_n23_), .c(x1), .O(new_n65_));
  nand3  g50(.a(x6), .b(new_n19_), .c(new_n23_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n65_), .c(new_n24_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n58_), .c(new_n16_), .O(new_n68_));
  ...
  nand4  g57(.a(new_n25_), .b(x3), .c(x1), .d(new_n16_), .O(new_n73_));
