...
module FAU ( 
  ...
  oai21  g25(.a(new_n17_), .b(x0), .c(new_n40_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n20_), .O(new_n42_));
  nor2   g27(.a(new_n26_), .b(new_n17_), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(new_n21_), .c(new_n16_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n42_), .O(z4));
  aoi21  g30(.a(new_n26_), .b(x2), .c(new_n20_), .O(new_n46_));
  nand3  g31(.a(x6), .b(new_n26_), .c(new_n17_), .O(new_n47_));
  inv1   g32(.a(new_n47_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n46_), .c(new_n16_), .O(new_n49_));
  oai21  g34(.a(new_n27_), .b(x1), .c(new_n26_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(x2), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n49_), .c(new_n22_), .O(z5));
  oai21  g37(.a(x4), .b(x2), .c(new_n26_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(x1), .c(new_n16_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n35_), .c(new_n22_), .O(z6));
endmodule
