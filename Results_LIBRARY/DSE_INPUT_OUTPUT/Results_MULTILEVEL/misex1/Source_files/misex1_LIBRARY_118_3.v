...
module FAU ( 
  ...
  aoi21  g30(.a(new_n28_), .b(x2), .c(new_n19_), .O(new_n46_));
  nand3  g31(.a(x6), .b(new_n28_), .c(new_n20_), .O(new_n47_));
  inv1   g32(.a(new_n47_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n46_), .c(new_n16_), .O(new_n49_));
  oai21  g34(.a(new_n31_), .b(x1), .c(new_n28_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(x2), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n49_), .c(new_n42_), .O(z5));
  oai21  g37(.a(x4), .b(x2), .c(new_n28_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(x1), .c(new_n16_), .O(new_n54_));
  nand3  g39(.a(new_n21_), .b(x2), .c(new_n19_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n54_), .c(new_n42_), .O(z6));
endmodule
