...
module FAU ( 
  ...
  oai21  g16(.a(new_n31_), .b(x3), .c(new_n19_), .O(new_n32_));
  ...
  nand2  g20(.a(new_n31_), .b(new_n30_), .O(new_n36_));
  inv1   g21(.a(x5), .O(new_n37_));
  nand3  g22(.a(new_n16_), .b(new_n37_), .c(x2), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n36_), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n20_), .c(new_n19_), .O(new_n40_));
  inv1   g25(.a(x4), .O(new_n41_));
  aoi21  g26(.a(new_n41_), .b(new_n20_), .c(x2), .O(new_n42_));
  nor2   g27(.a(x7), .b(new_n20_), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(new_n42_), .c(x1), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n40_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n17_), .O(new_n46_));
  nand3  g31(.a(new_n26_), .b(new_n19_), .c(x0), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n46_), .O(z2));
  oai21  g33(.a(x4), .b(x3), .c(x7), .O(new_n49_));
  nand4  g34(.a(new_n49_), .b(new_n30_), .c(x1), .d(new_n17_), .O(new_n50_));
  aoi21  g35(.a(x5), .b(new_n17_), .c(x7), .O(new_n51_));
  ...
  nand2  g42(.a(new_n43_), .b(x2), .O(new_n58_));
  ...
  oai21  g48(.a(new_n62_), .b(new_n17_), .c(new_n63_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n19_), .O(new_n65_));
  nand2  g50(.a(new_n16_), .b(x3), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(x2), .c(new_n19_), .O(new_n67_));
  nand3  g52(.a(x6), .b(new_n20_), .c(new_n30_), .O(new_n68_));
  oai21  g53(.a(new_n20_), .b(new_n30_), .c(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n67_), .c(new_n17_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n65_), .c(new_n34_), .O(z5));
  nand2  g56(.a(x3), .b(new_n30_), .O(new_n72_));
  aoi21  g57(.a(new_n54_), .b(new_n72_), .c(new_n17_), .O(new_n73_));
  nand4  g58(.a(new_n16_), .b(new_n37_), .c(new_n20_), .d(x2), .O(new_n74_));
  inv1   g59(.a(new_n74_), .O(new_n75_));
  oai21  g60(.a(new_n75_), .b(new_n73_), .c(new_n19_), .O(new_n76_));
  oai21  g61(.a(new_n41_), .b(x3), .c(new_n30_), .O(new_n77_));
  nand2  g62(.a(new_n77_), .b(new_n66_), .O(new_n78_));
