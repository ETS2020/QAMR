...
module FAU ( 
  ...
  nor2   g28(.a(x4), .b(new_n16_), .O(new_n44_));
  aoi21  g29(.a(new_n35_), .b(new_n33_), .c(new_n44_), .O(new_n45_));
  ...
  aoi21  g50(.a(new_n65_), .b(x2), .c(new_n23_), .O(new_n66_));
  ...
  nand3  g54(.a(new_n69_), .b(new_n64_), .c(new_n61_), .O(z5));
  nand3  g55(.a(x4), .b(new_n24_), .c(x2), .O(new_n71_));
  aoi21  g56(.a(new_n71_), .b(new_n34_), .c(new_n17_), .O(new_n72_));
  nand4  g57(.a(new_n25_), .b(x4), .c(new_n24_), .d(x2), .O(new_n73_));
  inv1   g58(.a(new_n73_), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(new_n72_), .c(new_n23_), .O(new_n75_));
  oai21  g60(.a(new_n19_), .b(x3), .c(new_n16_), .O(new_n76_));
