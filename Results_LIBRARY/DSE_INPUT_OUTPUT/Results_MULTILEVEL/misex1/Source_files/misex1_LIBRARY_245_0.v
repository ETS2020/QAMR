...
module FAU ( 
  ...
  aoi21  g20(.a(new_n19_), .b(x2), .c(new_n23_), .O(new_n36_));
  nand3  g21(.a(new_n26_), .b(x2), .c(new_n23_), .O(new_n37_));
  inv1   g22(.a(x6), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n16_), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n37_), .c(x3), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n36_), .c(new_n17_), .O(new_n41_));
  nand2  g26(.a(x3), .b(new_n16_), .O(new_n42_));
  inv1   g27(.a(new_n42_), .O(new_n43_));
  aoi21  g28(.a(new_n43_), .b(new_n20_), .c(new_n33_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n41_), .O(z2));
  nor2   g30(.a(new_n33_), .b(x7), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n16_), .c(x1), .d(new_n17_), .O(new_n47_));
  inv1   g32(.a(x4), .O(new_n48_));
  aoi21  g33(.a(x5), .b(new_n17_), .c(new_n48_), .O(new_n49_));
  nand4  g34(.a(new_n49_), .b(new_n19_), .c(x2), .d(new_n23_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n47_), .O(z3));
  inv1   g36(.a(new_n33_), .O(new_n52_));
  nand2  g37(.a(new_n19_), .b(x2), .O(new_n53_));
  oai21  g38(.a(new_n42_), .b(new_n17_), .c(new_n53_), .O(new_n54_));
  ...
  nand3  g44(.a(new_n59_), .b(new_n55_), .c(new_n52_), .O(z4));
  aoi21  g45(.a(new_n42_), .b(new_n53_), .c(new_n17_), .O(new_n61_));
  nand3  g46(.a(x5), .b(new_n19_), .c(x2), .O(new_n62_));
  inv1   g47(.a(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n61_), .c(new_n23_), .O(new_n64_));
  oai21  g49(.a(new_n31_), .b(x2), .c(new_n57_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n36_), .c(new_n17_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n64_), .c(new_n52_), .O(z5));
  nand3  g52(.a(new_n26_), .b(new_n19_), .c(x2), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n61_), .c(new_n23_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n52_), .c(new_n18_), .O(z6));
endmodule
