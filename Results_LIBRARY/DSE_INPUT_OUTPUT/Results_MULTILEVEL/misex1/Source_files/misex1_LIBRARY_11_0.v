...
module FAU ( 
  ...
  inv1   g19(.a(new_n21_), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(new_n20_), .c(new_n16_), .O(new_n36_));
  ...
  nand2  g24(.a(new_n39_), .b(new_n25_), .O(z5));
  oai21  g25(.a(x4), .b(x2), .c(new_n27_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(x1), .c(new_n16_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n25_), .O(z6));
endmodule
