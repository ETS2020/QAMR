...
module FAU ( 
  ...
  nand2  g14(.a(x6), .b(new_n26_), .O(new_n30_));
  ...
  aoi21  g20(.a(new_n35_), .b(new_n26_), .c(new_n22_), .O(new_n36_));
  nand2  g21(.a(new_n27_), .b(x2), .O(new_n37_));
  ...
  nand4  g34(.a(new_n49_), .b(new_n26_), .c(x2), .d(new_n22_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n48_), .O(z3));
  nand3  g36(.a(new_n38_), .b(new_n26_), .c(x2), .O(new_n52_));
  ...
  nand3  g40(.a(new_n38_), .b(x3), .c(x2), .O(new_n56_));
