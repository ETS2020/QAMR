...
module FAU ( 
  ...
  oai21  g20(.a(x3), .b(new_n16_), .c(x1), .O(new_n36_));
  oai21  g21(.a(x3), .b(x2), .c(new_n36_), .O(new_n37_));
  ...
  nand3  g26(.a(new_n41_), .b(new_n40_), .c(new_n36_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n17_), .O(new_n43_));
  oai21  g28(.a(new_n27_), .b(new_n17_), .c(new_n16_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n20_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n43_), .O(z5));
  oai21  g31(.a(x4), .b(x2), .c(new_n27_), .O(new_n47_));
  aoi22  g32(.a(new_n47_), .b(x1), .c(x3), .d(x2), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(x0), .c(new_n45_), .O(z6));
endmodule
