...
module FAU ( 
  ...
  aoi21  g23(.a(new_n38_), .b(new_n24_), .c(new_n23_), .O(new_n39_));
  ...
  aoi21  g27(.a(new_n42_), .b(new_n23_), .c(new_n39_), .O(new_n43_));
  aoi22  g28(.a(new_n35_), .b(new_n33_), .c(new_n19_), .d(x2), .O(new_n44_));
  ...
  aoi21  g32(.a(x5), .b(new_n17_), .c(new_n19_), .O(new_n48_));
  nand4  g33(.a(new_n48_), .b(new_n24_), .c(x2), .d(new_n23_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n47_), .O(z3));
  nand3  g35(.a(x4), .b(new_n24_), .c(x2), .O(new_n51_));
  ...
  oai22  g52(.a(new_n67_), .b(new_n17_), .c(new_n26_), .d(new_n16_), .O(new_n68_));
  ...
  nand3  g56(.a(new_n71_), .b(new_n69_), .c(new_n66_), .O(z6));
endmodule
