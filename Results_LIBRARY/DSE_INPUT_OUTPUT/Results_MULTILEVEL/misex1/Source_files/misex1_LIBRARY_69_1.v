...
module FAU ( 
  ...
  nand4  g34(.a(new_n23_), .b(new_n16_), .c(x1), .d(new_n17_), .O(new_n50_));
  ...
  aoi21  g49(.a(new_n64_), .b(new_n63_), .c(x7), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n57_), .c(new_n17_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n62_), .O(z5));
  nand3  g52(.a(new_n26_), .b(new_n20_), .c(x2), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n60_), .c(new_n19_), .O(new_n70_));
  inv1   g55(.a(x4), .O(new_n71_));
  nand3  g56(.a(new_n23_), .b(new_n71_), .c(new_n16_), .O(new_n72_));
  oai21  g57(.a(new_n24_), .b(new_n20_), .c(new_n72_), .O(new_n73_));
