...
module FAU ( 
  ...
  nand2  g19(.a(new_n26_), .b(new_n18_), .O(new_n35_));
  ...
  nand4  g24(.a(new_n39_), .b(new_n18_), .c(x1), .d(new_n17_), .O(new_n40_));
  nand2  g25(.a(x5), .b(new_n17_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(x2), .c(new_n20_), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n40_), .c(x3), .O(z3));
  xor2a  g28(.a(x3), .b(x2), .O(new_n44_));
  oai22  g29(.a(new_n44_), .b(x0), .c(new_n22_), .d(x1), .O(z4));
  oai21  g30(.a(x3), .b(new_n17_), .c(new_n41_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(x2), .c(new_n20_), .O(new_n47_));
  aoi21  g32(.a(x2), .b(x0), .c(new_n16_), .O(new_n48_));
  aoi21  g33(.a(new_n27_), .b(new_n17_), .c(new_n48_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n47_), .O(z5));
  oai21  g35(.a(x4), .b(x2), .c(new_n16_), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(x1), .c(new_n17_), .O(new_n52_));
  nand4  g37(.a(new_n41_), .b(new_n16_), .c(x2), .d(new_n20_), .O(new_n53_));
