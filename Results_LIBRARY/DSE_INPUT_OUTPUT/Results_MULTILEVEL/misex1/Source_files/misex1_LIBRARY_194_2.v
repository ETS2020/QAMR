...
module FAU ( 
  ...
  nand4  g10(.a(new_n25_), .b(x4), .c(x2), .d(new_n18_), .O(new_n26_));
  ...
  nand3  g17(.a(new_n24_), .b(x4), .c(x2), .O(new_n33_));
  ...
  aoi21  g32(.a(x5), .b(new_n16_), .c(new_n47_), .O(new_n48_));
  ...
  oai21  g39(.a(new_n19_), .b(x0), .c(x4), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(x2), .O(new_n56_));
  nand2  g41(.a(x3), .b(new_n18_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n30_), .c(new_n16_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n56_), .c(new_n54_), .O(z4));
  aoi21  g44(.a(new_n52_), .b(new_n51_), .c(new_n16_), .O(new_n60_));
  nor3   g45(.a(new_n24_), .b(new_n30_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n60_), .c(new_n18_), .O(new_n62_));
  aoi21  g47(.a(new_n39_), .b(x2), .c(new_n18_), .O(new_n63_));
  nand3  g48(.a(x6), .b(new_n19_), .c(new_n30_), .O(new_n64_));
  oai21  g49(.a(new_n19_), .b(new_n30_), .c(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n63_), .c(new_n16_), .O(new_n66_));
  nand2  g51(.a(new_n47_), .b(x2), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n66_), .c(new_n62_), .O(z5));
  nand3  g53(.a(x4), .b(new_n19_), .c(x2), .O(new_n69_));
  aoi21  g54(.a(new_n69_), .b(new_n51_), .c(new_n16_), .O(new_n70_));
  nand4  g55(.a(new_n24_), .b(x4), .c(new_n19_), .d(x2), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n70_), .c(new_n18_), .O(new_n73_));
  oai21  g58(.a(new_n47_), .b(x3), .c(new_n30_), .O(new_n74_));
  nand2  g59(.a(new_n74_), .b(new_n39_), .O(new_n75_));
