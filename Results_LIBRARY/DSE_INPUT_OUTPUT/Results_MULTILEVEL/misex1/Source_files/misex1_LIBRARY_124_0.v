...
module FAU ( 
  ...
  oai21  g06(.a(x4), .b(x2), .c(new_n21_), .O(z0));
  ...
  nand3  g14(.a(new_n29_), .b(x4), .c(new_n27_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n26_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n23_), .O(new_n32_));
  nand2  g17(.a(new_n16_), .b(x0), .O(new_n33_));
  nand3  g18(.a(x4), .b(x3), .c(new_n27_), .O(new_n34_));
  or2    g19(.a(new_n34_), .b(new_n33_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n32_), .O(z1));
  aoi21  g21(.a(new_n17_), .b(x2), .c(new_n16_), .O(new_n37_));
  inv1   g22(.a(x5), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(x2), .c(new_n16_), .O(new_n39_));
  nand2  g24(.a(new_n28_), .b(new_n27_), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n39_), .c(x3), .O(new_n41_));
  oai21  g26(.a(new_n41_), .b(new_n37_), .c(new_n23_), .O(new_n42_));
  oai21  g27(.a(new_n33_), .b(new_n17_), .c(x4), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n27_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n42_), .O(z2));
  nand2  g30(.a(x5), .b(new_n23_), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n17_), .c(x2), .d(new_n16_), .O(new_n47_));
  inv1   g32(.a(x4), .O(new_n48_));
  nor2   g33(.a(x7), .b(new_n48_), .O(new_n49_));
  nand4  g34(.a(new_n49_), .b(new_n27_), .c(x1), .d(new_n23_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n47_), .O(z3));
  nand2  g36(.a(new_n17_), .b(x2), .O(new_n52_));
  nand4  g37(.a(x4), .b(x3), .c(new_n27_), .d(x0), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n16_), .O(new_n55_));
  aoi21  g40(.a(x3), .b(new_n16_), .c(new_n48_), .O(new_n56_));
  nor2   g41(.a(new_n17_), .b(new_n27_), .O(new_n57_));
  aoi21  g42(.a(new_n56_), .b(new_n27_), .c(new_n57_), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(x0), .c(new_n55_), .O(z4));
  aoi21  g44(.a(new_n52_), .b(new_n34_), .c(new_n23_), .O(new_n60_));
  ...
  nand2  g48(.a(new_n63_), .b(new_n30_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n23_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n62_), .O(z5));
  nand2  g51(.a(x3), .b(new_n27_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n52_), .O(new_n68_));
  aoi22  g53(.a(new_n68_), .b(x0), .c(new_n24_), .d(x2), .O(new_n69_));
  aoi21  g54(.a(new_n48_), .b(new_n27_), .c(new_n18_), .O(new_n70_));
