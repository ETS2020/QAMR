...
module FAU ( 
  ...
  nand4  g14(.a(new_n21_), .b(new_n20_), .c(x3), .d(new_n16_), .O(new_n30_));
  oai21  g15(.a(new_n29_), .b(x0), .c(new_n30_), .O(z1));
  nand2  g16(.a(x4), .b(new_n16_), .O(new_n32_));
  aoi21  g17(.a(new_n32_), .b(new_n19_), .c(new_n24_), .O(new_n33_));
  ...
  aoi21  g22(.a(new_n37_), .b(new_n24_), .c(new_n33_), .O(new_n38_));
  oai21  g23(.a(new_n38_), .b(x0), .c(new_n30_), .O(z2));
  nor2   g24(.a(new_n16_), .b(x1), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n19_), .c(x4), .O(new_n41_));
  oai21  g26(.a(x4), .b(x3), .c(x7), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n16_), .c(x1), .O(new_n43_));
  nand3  g28(.a(new_n25_), .b(x2), .c(new_n24_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n17_), .O(new_n46_));
  oai21  g31(.a(new_n41_), .b(new_n17_), .c(new_n46_), .O(z3));
  xor2a  g32(.a(x3), .b(x2), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n20_), .c(x0), .O(new_n49_));
  inv1   g34(.a(new_n49_), .O(new_n50_));
  nor2   g35(.a(new_n16_), .b(x0), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n50_), .c(new_n24_), .O(new_n52_));
  aoi21  g37(.a(x3), .b(new_n24_), .c(x2), .O(new_n53_));
  ...
  nor3   g41(.a(new_n34_), .b(new_n16_), .c(x0), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n50_), .c(new_n24_), .O(new_n58_));
  inv1   g43(.a(new_n54_), .O(new_n59_));
  ...
  nand2  g49(.a(new_n51_), .b(new_n25_), .O(new_n65_));
