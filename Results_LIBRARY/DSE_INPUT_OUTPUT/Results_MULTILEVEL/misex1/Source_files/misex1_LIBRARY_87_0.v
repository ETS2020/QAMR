...
module FAU ( 
  ...
  aoi22  g20(.a(new_n35_), .b(new_n33_), .c(new_n17_), .d(new_n16_), .O(new_n36_));
  ...
  nand2  g25(.a(new_n17_), .b(new_n27_), .O(new_n41_));
  ...
  nand4  g30(.a(new_n45_), .b(new_n22_), .c(x2), .d(new_n21_), .O(new_n46_));
  ...
  nor2   g35(.a(x2), .b(new_n21_), .O(new_n51_));
  nor2   g36(.a(new_n17_), .b(x4), .O(new_n52_));
  nand4  g37(.a(new_n52_), .b(new_n51_), .c(new_n22_), .d(new_n19_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n50_), .O(z3));
  nand2  g39(.a(new_n22_), .b(x2), .O(new_n55_));
  oai21  g40(.a(new_n34_), .b(new_n19_), .c(new_n55_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n21_), .O(new_n57_));
  aoi21  g42(.a(x3), .b(new_n21_), .c(x2), .O(new_n58_));
  nor2   g43(.a(new_n22_), .b(new_n27_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n58_), .c(new_n19_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n57_), .c(new_n18_), .O(z4));
  aoi21  g46(.a(new_n55_), .b(new_n34_), .c(new_n19_), .O(new_n62_));
  nor3   g47(.a(new_n28_), .b(new_n27_), .c(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n62_), .c(new_n21_), .O(new_n64_));
  aoi21  g49(.a(new_n27_), .b(new_n21_), .c(new_n22_), .O(new_n65_));
  nand2  g50(.a(x6), .b(x4), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(x1), .O(new_n67_));
  aoi21  g52(.a(new_n67_), .b(new_n30_), .c(x2), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n65_), .c(new_n19_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n64_), .c(new_n18_), .O(z5));
  nand3  g55(.a(new_n28_), .b(new_n22_), .c(x2), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n62_), .c(new_n21_), .O(new_n73_));
