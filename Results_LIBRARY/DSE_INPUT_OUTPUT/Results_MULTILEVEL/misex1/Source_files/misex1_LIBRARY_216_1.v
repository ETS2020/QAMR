...
module FAU ( 
  ...
  nand2  g32(.a(new_n47_), .b(new_n34_), .O(new_n48_));
  ...
  aoi21  g45(.a(new_n54_), .b(new_n42_), .c(new_n16_), .O(new_n61_));
  nor3   g46(.a(new_n26_), .b(new_n23_), .c(x0), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n61_), .c(new_n18_), .O(new_n63_));
  nand2  g48(.a(new_n34_), .b(x1), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n28_), .c(x2), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n58_), .c(new_n16_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n63_), .c(new_n24_), .O(z5));
  ...
  inv1   g55(.a(new_n58_), .O(new_n71_));
  oai21  g56(.a(x4), .b(x2), .c(new_n71_), .O(new_n72_));
