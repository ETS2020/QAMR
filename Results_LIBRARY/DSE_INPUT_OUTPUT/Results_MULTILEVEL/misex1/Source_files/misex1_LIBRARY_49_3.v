...
module FAU ( 
  ...
  nand2  g16(.a(x4), .b(x2), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n31_), .c(new_n28_), .O(z1));
  inv1   g18(.a(x4), .O(new_n34_));
  inv1   g19(.a(x5), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n34_), .c(x2), .O(new_n36_));
  nand2  g21(.a(new_n29_), .b(new_n16_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n24_), .c(new_n22_), .O(new_n39_));
  aoi21  g24(.a(new_n34_), .b(new_n24_), .c(x2), .O(new_n40_));
  nor2   g25(.a(x4), .b(new_n24_), .O(new_n41_));
  oai21  g26(.a(new_n41_), .b(new_n40_), .c(x1), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n39_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n17_), .O(new_n44_));
  nand3  g29(.a(new_n25_), .b(new_n22_), .c(x0), .O(new_n45_));
  ...
  aoi21  g34(.a(new_n49_), .b(new_n22_), .c(x4), .O(new_n50_));
  ...
  oai21  g39(.a(new_n24_), .b(x0), .c(new_n34_), .O(new_n55_));
  ...
  aoi21  g45(.a(new_n52_), .b(new_n60_), .c(new_n17_), .O(new_n61_));
  nor3   g46(.a(new_n35_), .b(new_n16_), .c(x0), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n61_), .c(new_n22_), .O(new_n63_));
  nand2  g48(.a(new_n52_), .b(x1), .O(new_n64_));
  ...
  nand3  g53(.a(new_n68_), .b(new_n63_), .c(new_n32_), .O(z5));
  nand3  g54(.a(new_n35_), .b(new_n24_), .c(x2), .O(new_n70_));
  inv1   g55(.a(new_n70_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n61_), .c(new_n22_), .O(new_n72_));
  oai21  g57(.a(x4), .b(x2), .c(new_n24_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(x1), .c(new_n17_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(new_n72_), .c(new_n32_), .O(z6));
endmodule
