...
module FAU ( 
  ...
  oai21  g14(.a(new_n16_), .b(x3), .c(new_n21_), .O(new_n30_));
  aoi22  g15(.a(new_n30_), .b(new_n27_), .c(new_n29_), .d(new_n21_), .O(new_n31_));
  nor2   g16(.a(x1), .b(new_n19_), .O(new_n32_));
  nor2   g17(.a(new_n22_), .b(x2), .O(new_n33_));
  ...
  aoi21  g26(.a(x7), .b(x2), .c(new_n16_), .O(new_n42_));
  nand2  g27(.a(new_n16_), .b(new_n27_), .O(new_n43_));
  oai21  g28(.a(new_n42_), .b(x5), .c(new_n43_), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n22_), .c(new_n21_), .d(new_n19_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n41_), .O(z2));
  oai21  g31(.a(x4), .b(x3), .c(x7), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(new_n27_), .c(x1), .d(new_n19_), .O(new_n48_));
  nand2  g33(.a(x5), .b(new_n19_), .O(new_n49_));
  nand4  g34(.a(new_n49_), .b(new_n22_), .c(x2), .d(new_n21_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n48_), .c(new_n18_), .O(z3));
  nand2  g36(.a(new_n33_), .b(x0), .O(new_n52_));
  nand2  g37(.a(new_n22_), .b(x2), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n21_), .O(new_n55_));
  aoi21  g40(.a(x3), .b(new_n21_), .c(x2), .O(new_n56_));
  nor2   g41(.a(new_n22_), .b(new_n27_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n56_), .c(new_n19_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n55_), .c(new_n18_), .O(z4));
  xor2a  g44(.a(x3), .b(x2), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n21_), .c(x0), .O(new_n61_));
  oai21  g46(.a(x4), .b(x2), .c(new_n22_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(x1), .c(new_n19_), .O(new_n63_));
  and2   g48(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  nand2  g49(.a(x5), .b(new_n21_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n22_), .c(new_n27_), .O(new_n66_));
  ...
  nand3  g56(.a(new_n28_), .b(new_n22_), .c(x2), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n21_), .O(new_n74_));
  aoi21  g59(.a(new_n74_), .b(new_n63_), .c(new_n17_), .O(z6));
endmodule
