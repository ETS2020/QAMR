...
module FAU ( 
  ...
  nand3  g33(.a(new_n23_), .b(new_n24_), .c(x2), .O(new_n49_));
  oai21  g34(.a(new_n48_), .b(new_n17_), .c(new_n49_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n22_), .O(new_n51_));
  aoi21  g36(.a(x3), .b(new_n22_), .c(x2), .O(new_n52_));
  nand3  g37(.a(new_n23_), .b(x3), .c(x2), .O(new_n53_));
  ...
  nand4  g42(.a(x5), .b(new_n23_), .c(x2), .d(new_n17_), .O(new_n58_));
  inv1   g43(.a(new_n58_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n57_), .c(new_n22_), .O(new_n60_));
  oai21  g45(.a(new_n54_), .b(new_n30_), .c(new_n17_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n60_), .O(z5));
  xnor2a g47(.a(x3), .b(x2), .O(new_n63_));
  oai22  g48(.a(new_n63_), .b(new_n17_), .c(new_n26_), .d(new_n16_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n22_), .O(new_n65_));
  oai21  g50(.a(x4), .b(x2), .c(new_n24_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(x1), .c(new_n17_), .O(new_n67_));
  nand2  g52(.a(x4), .b(x2), .O(new_n68_));
