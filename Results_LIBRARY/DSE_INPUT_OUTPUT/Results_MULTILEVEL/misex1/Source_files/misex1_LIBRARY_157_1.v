...
module FAU ( 
  ...
  oai21  g21(.a(new_n36_), .b(new_n21_), .c(new_n34_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n17_), .O(new_n38_));
  oai21  g23(.a(new_n36_), .b(x1), .c(new_n21_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n38_), .O(z4));
  nand2  g25(.a(new_n36_), .b(new_n34_), .O(new_n41_));
  ...
  nand2  g29(.a(x4), .b(new_n18_), .O(new_n45_));
  nand4  g30(.a(new_n45_), .b(new_n16_), .c(x1), .d(new_n21_), .O(new_n46_));
