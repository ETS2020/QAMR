...
module FAU ( 
  ...
  oai21  g22(.a(x3), .b(new_n16_), .c(x1), .O(new_n38_));
  oai21  g23(.a(x3), .b(x2), .c(new_n38_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n17_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n33_), .O(z4));
  nand2  g26(.a(x3), .b(x2), .O(new_n42_));
  nand3  g27(.a(x6), .b(new_n21_), .c(new_n16_), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n42_), .c(new_n38_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n17_), .O(new_n45_));
  oai21  g30(.a(new_n21_), .b(new_n17_), .c(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n20_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n45_), .O(z5));
  oai21  g33(.a(x4), .b(x2), .c(new_n21_), .O(new_n49_));
  aoi22  g34(.a(new_n49_), .b(x1), .c(x3), .d(x2), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(x0), .c(new_n47_), .O(z6));
endmodule
