...
module FAU ( 
  ...
  oai21  g28(.a(new_n20_), .b(new_n17_), .c(new_n19_), .O(new_n44_));
  ...
  oai21  g32(.a(new_n43_), .b(x0), .c(new_n47_), .O(z4));
  oai21  g33(.a(new_n46_), .b(new_n37_), .c(x0), .O(new_n49_));
  oai21  g34(.a(new_n20_), .b(x0), .c(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(x1), .O(new_n51_));
  aoi21  g36(.a(x5), .b(new_n19_), .c(x3), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n16_), .c(new_n24_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n17_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n51_), .c(new_n49_), .O(z5));
  nand4  g40(.a(new_n29_), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n51_), .c(new_n49_), .O(z6));
endmodule
