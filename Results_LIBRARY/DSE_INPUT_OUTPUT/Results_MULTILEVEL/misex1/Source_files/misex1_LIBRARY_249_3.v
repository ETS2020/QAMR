...
module FAU ( 
  ...
  aoi21  g22(.a(new_n37_), .b(new_n18_), .c(new_n17_), .O(new_n38_));
  ...
  nand3  g29(.a(new_n16_), .b(new_n17_), .c(x0), .O(new_n45_));
  ...
  nand3  g35(.a(new_n16_), .b(x1), .c(new_n20_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n21_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(x3), .O(new_n53_));
  nand2  g38(.a(x7), .b(x4), .O(new_n54_));
  nand4  g39(.a(new_n54_), .b(new_n16_), .c(x1), .d(new_n20_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n53_), .c(new_n50_), .O(z3));
  nand3  g41(.a(x3), .b(new_n16_), .c(x0), .O(new_n57_));
  ...
  aoi21  g46(.a(new_n54_), .b(x1), .c(new_n18_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(x2), .c(new_n61_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n20_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n60_), .c(new_n26_), .O(z4));
  aoi21  g50(.a(new_n58_), .b(new_n33_), .c(new_n20_), .O(new_n66_));
  ...
  nand3  g56(.a(x6), .b(new_n18_), .c(new_n16_), .O(new_n72_));
  oai21  g57(.a(new_n22_), .b(new_n16_), .c(new_n72_), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(new_n71_), .c(new_n20_), .O(new_n74_));
  nand2  g59(.a(new_n74_), .b(new_n69_), .O(z5));
  nand3  g60(.a(new_n39_), .b(new_n18_), .c(x2), .O(new_n76_));
  inv1   g61(.a(new_n76_), .O(new_n77_));
  oai21  g62(.a(new_n77_), .b(new_n66_), .c(new_n17_), .O(new_n78_));
  inv1   g63(.a(x4), .O(new_n79_));
  nand3  g64(.a(new_n79_), .b(new_n18_), .c(new_n16_), .O(new_n80_));
  nand2  g65(.a(new_n80_), .b(new_n22_), .O(new_n81_));
  nand3  g66(.a(new_n81_), .b(x1), .c(new_n20_), .O(new_n82_));
  nand3  g67(.a(new_n82_), .b(new_n78_), .c(new_n26_), .O(z6));
endmodule
