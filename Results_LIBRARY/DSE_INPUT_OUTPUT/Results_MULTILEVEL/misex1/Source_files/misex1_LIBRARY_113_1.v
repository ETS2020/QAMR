...
module FAU ( 
  ...
  nand3  g34(.a(x3), .b(new_n26_), .c(x0), .O(new_n50_));
  oai21  g35(.a(x3), .b(new_n26_), .c(new_n50_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n20_), .O(new_n52_));
  aoi21  g37(.a(x3), .b(new_n20_), .c(x2), .O(new_n53_));
  nor2   g38(.a(new_n21_), .b(new_n26_), .O(new_n54_));
  ...
  nand3  g42(.a(new_n57_), .b(new_n20_), .c(x0), .O(new_n58_));
  oai21  g43(.a(x4), .b(x2), .c(new_n21_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(x1), .c(new_n18_), .O(new_n60_));
  nand2  g45(.a(new_n30_), .b(new_n20_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n21_), .c(new_n26_), .O(new_n62_));
  nand3  g47(.a(new_n30_), .b(new_n16_), .c(new_n21_), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(x2), .c(new_n20_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n18_), .O(new_n66_));
  nand4  g51(.a(new_n66_), .b(new_n60_), .c(new_n58_), .d(new_n17_), .O(z5));
  nand2  g52(.a(new_n60_), .b(new_n58_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n17_), .O(new_n69_));
  nand2  g54(.a(x2), .b(new_n20_), .O(new_n70_));
  or2    g55(.a(new_n70_), .b(new_n63_), .O(new_n71_));
