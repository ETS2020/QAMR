...
module FAU ( 
  ...
  nand3  g13(.a(new_n23_), .b(new_n18_), .c(new_n16_), .O(new_n29_));
  ...
  aoi21  g23(.a(new_n38_), .b(new_n37_), .c(x2), .O(new_n39_));
  nand2  g24(.a(x5), .b(new_n37_), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n18_), .c(x2), .O(new_n41_));
  oai21  g26(.a(new_n39_), .b(new_n16_), .c(new_n41_), .O(z3));
  nand2  g27(.a(x3), .b(new_n17_), .O(new_n43_));
  nand2  g28(.a(new_n18_), .b(x2), .O(new_n44_));
  oai21  g29(.a(new_n43_), .b(x1), .c(new_n44_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(x0), .O(new_n46_));
  oai21  g31(.a(x2), .b(new_n37_), .c(x1), .O(new_n47_));
  nor2   g32(.a(x5), .b(x3), .O(new_n48_));
  aoi22  g33(.a(new_n43_), .b(new_n37_), .c(new_n48_), .d(x2), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n47_), .c(new_n46_), .O(z4));
  xor2a  g35(.a(x3), .b(x2), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n16_), .c(x0), .O(new_n52_));
  nand3  g37(.a(x6), .b(new_n18_), .c(new_n17_), .O(new_n53_));
  inv1   g38(.a(new_n53_), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n22_), .c(new_n37_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n52_), .c(new_n47_), .O(z5));
  aoi22  g41(.a(new_n51_), .b(x0), .c(new_n48_), .d(x2), .O(new_n57_));
  nand2  g42(.a(x4), .b(new_n18_), .O(new_n58_));
  nand4  g43(.a(new_n58_), .b(new_n17_), .c(x1), .d(new_n37_), .O(new_n59_));
