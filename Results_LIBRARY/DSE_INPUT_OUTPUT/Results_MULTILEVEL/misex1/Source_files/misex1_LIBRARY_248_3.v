...
module FAU ( 
  ...
  aoi21  g29(.a(new_n26_), .b(x0), .c(new_n16_), .O(new_n45_));
  aoi21  g30(.a(x3), .b(new_n26_), .c(x0), .O(new_n46_));
  ...
  nand3  g36(.a(new_n51_), .b(x2), .c(new_n20_), .O(new_n52_));
  ...
  nand4  g42(.a(new_n57_), .b(new_n26_), .c(x1), .d(new_n20_), .O(new_n58_));
  oai21  g43(.a(new_n44_), .b(x1), .c(new_n58_), .O(z6));
endmodule
