...
module FAU ( 
  ...
  aoi21  g09(.a(new_n24_), .b(new_n16_), .c(x1), .O(new_n25_));
  ...
  nand2  g21(.a(new_n26_), .b(new_n18_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n16_), .c(new_n20_), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n34_), .c(x0), .O(z2));
  nand2  g25(.a(x7), .b(x4), .O(new_n41_));
  nand4  g26(.a(new_n41_), .b(new_n18_), .c(x1), .d(new_n17_), .O(new_n42_));
  ...
  oai21  g32(.a(new_n35_), .b(x1), .c(new_n16_), .O(new_n48_));
  ...
  nand2  g36(.a(new_n26_), .b(new_n20_), .O(new_n52_));
  nand4  g37(.a(new_n52_), .b(new_n16_), .c(new_n18_), .d(new_n17_), .O(new_n53_));
  oai21  g38(.a(new_n51_), .b(new_n18_), .c(new_n53_), .O(z5));
  ...
  nand4  g43(.a(new_n43_), .b(new_n16_), .c(x2), .d(new_n20_), .O(new_n59_));
