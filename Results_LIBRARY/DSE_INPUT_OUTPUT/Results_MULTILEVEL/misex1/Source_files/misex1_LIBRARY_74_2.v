...
module FAU ( 
  ...
  nand2  g22(.a(new_n28_), .b(new_n16_), .O(new_n38_));
  aoi21  g23(.a(new_n38_), .b(new_n37_), .c(x3), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n23_), .c(new_n35_), .O(new_n40_));
  nand2  g25(.a(x3), .b(new_n16_), .O(new_n41_));
  inv1   g26(.a(new_n41_), .O(new_n42_));
  nor2   g27(.a(x1), .b(new_n17_), .O(new_n43_));
  aoi22  g28(.a(new_n43_), .b(new_n42_), .c(new_n19_), .d(x2), .O(new_n44_));
  ...
  nand4  g33(.a(new_n48_), .b(new_n33_), .c(x2), .d(new_n23_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n47_), .O(z3));
  nand2  g35(.a(new_n33_), .b(x2), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n25_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n23_), .O(new_n53_));
  oai21  g38(.a(new_n33_), .b(x0), .c(x4), .O(new_n54_));
  ...
  aoi21  g43(.a(new_n51_), .b(new_n41_), .c(new_n17_), .O(new_n59_));
  nor3   g44(.a(new_n36_), .b(new_n16_), .c(x0), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n59_), .c(new_n23_), .O(new_n61_));
  nand2  g46(.a(x4), .b(x3), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(x2), .c(new_n23_), .O(new_n63_));
  nand3  g48(.a(x6), .b(new_n33_), .c(new_n16_), .O(new_n64_));
  oai21  g49(.a(new_n33_), .b(new_n16_), .c(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n63_), .c(new_n17_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n61_), .c(new_n31_), .O(z5));
  nand3  g52(.a(x4), .b(new_n33_), .c(x2), .O(new_n68_));
  aoi21  g53(.a(new_n68_), .b(new_n41_), .c(new_n17_), .O(new_n69_));
  nand4  g54(.a(new_n36_), .b(x4), .c(new_n33_), .d(x2), .O(new_n70_));
  inv1   g55(.a(new_n70_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n69_), .c(new_n23_), .O(new_n72_));
  oai21  g57(.a(new_n19_), .b(x3), .c(new_n16_), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n62_), .O(new_n74_));
