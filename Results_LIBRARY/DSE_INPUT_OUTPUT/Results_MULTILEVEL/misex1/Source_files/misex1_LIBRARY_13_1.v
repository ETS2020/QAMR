...
module FAU ( 
  ...
  oai21  g32(.a(new_n46_), .b(x0), .c(new_n47_), .O(z4));
  inv1   g33(.a(new_n21_), .O(new_n49_));
  oai21  g34(.a(new_n23_), .b(x1), .c(new_n20_), .O(new_n50_));
  aoi21  g35(.a(new_n50_), .b(new_n17_), .c(new_n49_), .O(new_n51_));
  nand4  g36(.a(new_n27_), .b(new_n20_), .c(new_n16_), .d(new_n17_), .O(new_n52_));
  oai21  g37(.a(new_n51_), .b(new_n16_), .c(new_n52_), .O(z5));
