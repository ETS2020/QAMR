...
module FAU ( 
  ...
  nand3  g21(.a(new_n27_), .b(x2), .c(new_n18_), .O(new_n37_));
  nand2  g22(.a(new_n29_), .b(new_n23_), .O(new_n38_));
  ...
  nor2   g28(.a(x7), .b(new_n24_), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n23_), .c(x1), .d(new_n16_), .O(new_n45_));
  ...
  nor2   g36(.a(new_n19_), .b(new_n23_), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n51_), .c(new_n16_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n50_), .c(new_n25_), .O(z4));
  nand3  g39(.a(x4), .b(x3), .c(new_n23_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n47_), .c(new_n16_), .O(new_n56_));
  nor3   g41(.a(new_n27_), .b(new_n23_), .c(x0), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n56_), .c(new_n18_), .O(new_n58_));
  nand2  g43(.a(x4), .b(x3), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(x2), .c(new_n18_), .O(new_n60_));
  nand3  g45(.a(x6), .b(new_n19_), .c(new_n23_), .O(new_n61_));
  oai21  g46(.a(new_n19_), .b(new_n23_), .c(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n60_), .c(new_n16_), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n58_), .c(new_n25_), .O(z5));
  nand3  g49(.a(new_n27_), .b(new_n19_), .c(x2), .O(new_n65_));
  inv1   g50(.a(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n56_), .c(new_n18_), .O(new_n67_));
  nand4  g52(.a(new_n25_), .b(x3), .c(x1), .d(new_n16_), .O(new_n68_));
