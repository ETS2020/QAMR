...
module FAU ( 
  ...
  aoi21  g22(.a(x3), .b(x0), .c(x2), .O(new_n38_));
  aoi21  g23(.a(x3), .b(new_n20_), .c(x2), .O(new_n39_));
  nor2   g24(.a(new_n21_), .b(new_n16_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n39_), .c(new_n17_), .O(new_n41_));
  oai21  g26(.a(new_n38_), .b(x1), .c(new_n41_), .O(z4));
  aoi21  g27(.a(new_n21_), .b(x2), .c(new_n20_), .O(new_n43_));
  nand3  g28(.a(x6), .b(new_n21_), .c(new_n16_), .O(new_n44_));
  inv1   g29(.a(new_n44_), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n43_), .c(new_n17_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n26_), .O(z5));
  oai21  g32(.a(x4), .b(x2), .c(new_n21_), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(x1), .c(new_n17_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n33_), .O(z6));
endmodule
