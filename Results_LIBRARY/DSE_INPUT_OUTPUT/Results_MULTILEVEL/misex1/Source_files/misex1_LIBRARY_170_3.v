...
module FAU ( 
  ...
  nand2  g51(.a(x3), .b(new_n26_), .O(new_n67_));
  aoi21  g52(.a(new_n60_), .b(new_n67_), .c(new_n17_), .O(new_n68_));
  nor3   g53(.a(new_n41_), .b(new_n26_), .c(x0), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n68_), .c(new_n19_), .O(new_n70_));
  inv1   g55(.a(new_n64_), .O(new_n71_));
  nand2  g56(.a(new_n60_), .b(x1), .O(new_n72_));
  nand3  g57(.a(x6), .b(new_n20_), .c(new_n26_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n74_));
  nand2  g59(.a(new_n74_), .b(new_n17_), .O(new_n75_));
  nand3  g60(.a(new_n75_), .b(new_n70_), .c(new_n16_), .O(z5));
  nand3  g61(.a(new_n41_), .b(new_n20_), .c(x2), .O(new_n77_));
  inv1   g62(.a(new_n77_), .O(new_n78_));
  oai21  g63(.a(new_n78_), .b(new_n68_), .c(new_n19_), .O(new_n79_));
  oai21  g64(.a(x4), .b(x2), .c(new_n20_), .O(new_n80_));
  nand3  g65(.a(new_n80_), .b(x1), .c(new_n17_), .O(new_n81_));
  nand3  g66(.a(new_n81_), .b(new_n79_), .c(new_n16_), .O(z6));
endmodule
