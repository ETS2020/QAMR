...
module FAU ( 
  ...
  aoi21  g48(.a(new_n39_), .b(x2), .c(new_n18_), .O(new_n64_));
  nand3  g49(.a(x6), .b(new_n19_), .c(new_n30_), .O(new_n65_));
  oai21  g50(.a(new_n19_), .b(new_n30_), .c(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n64_), .c(new_n16_), .O(new_n67_));
  nand2  g52(.a(new_n47_), .b(x2), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(new_n67_), .c(new_n63_), .O(z5));
  aoi21  g54(.a(new_n52_), .b(new_n51_), .c(new_n16_), .O(new_n70_));
  nand4  g55(.a(x7), .b(new_n24_), .c(new_n19_), .d(x2), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n70_), .c(new_n18_), .O(new_n73_));
  inv1   g58(.a(x4), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(x3), .c(new_n30_), .O(new_n75_));
  nand2  g60(.a(new_n75_), .b(new_n39_), .O(new_n76_));
