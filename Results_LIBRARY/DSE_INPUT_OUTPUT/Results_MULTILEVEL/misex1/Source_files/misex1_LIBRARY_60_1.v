...
module FAU ( 
  ...
  nor3   g11(.a(new_n26_), .b(new_n25_), .c(x0), .O(new_n27_));
  ...
  nand3  g16(.a(new_n25_), .b(x1), .c(new_n20_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n31_), .O(z1));
  aoi21  g18(.a(x4), .b(new_n25_), .c(x3), .O(new_n34_));
  nand2  g19(.a(x5), .b(x2), .O(new_n35_));
  nand4  g20(.a(new_n35_), .b(new_n28_), .c(new_n16_), .d(new_n24_), .O(new_n36_));
  oai21  g21(.a(new_n34_), .b(new_n24_), .c(new_n36_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n20_), .O(new_n38_));
  nor2   g23(.a(x1), .b(new_n20_), .O(new_n39_));
  nand4  g24(.a(new_n39_), .b(new_n28_), .c(x3), .d(new_n25_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n38_), .O(z2));
  oai21  g26(.a(x4), .b(x3), .c(x7), .O(new_n42_));
  nand4  g27(.a(new_n42_), .b(new_n25_), .c(x1), .d(new_n20_), .O(new_n43_));
  aoi21  g28(.a(x5), .b(new_n20_), .c(x6), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n16_), .c(x2), .d(new_n24_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n43_), .O(z3));
  nand2  g31(.a(new_n16_), .b(new_n25_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n22_), .O(new_n48_));
  aoi22  g33(.a(new_n48_), .b(new_n28_), .c(new_n17_), .d(x1), .O(new_n49_));
  nand2  g34(.a(new_n29_), .b(new_n17_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n28_), .c(new_n24_), .O(new_n51_));
  ...
  nor2   g40(.a(new_n22_), .b(x0), .O(new_n56_));
  aoi21  g41(.a(new_n55_), .b(new_n24_), .c(new_n56_), .O(new_n57_));
  nand3  g42(.a(new_n17_), .b(x1), .c(new_n20_), .O(new_n58_));
  oai21  g43(.a(new_n57_), .b(x6), .c(new_n58_), .O(z5));
  aoi21  g44(.a(new_n26_), .b(x2), .c(x6), .O(new_n60_));
  oai21  g45(.a(new_n53_), .b(new_n20_), .c(new_n60_), .O(new_n61_));
