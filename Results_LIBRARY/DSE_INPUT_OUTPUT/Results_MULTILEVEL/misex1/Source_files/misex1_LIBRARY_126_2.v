...
module FAU ( 
  ...
  aoi21  g28(.a(new_n43_), .b(new_n27_), .c(new_n19_), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(new_n16_), .c(new_n42_), .O(z3));
  ...
  nand3  g45(.a(x6), .b(new_n24_), .c(new_n16_), .O(new_n61_));
  oai21  g46(.a(new_n24_), .b(new_n16_), .c(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n60_), .c(new_n17_), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n58_), .c(new_n39_), .O(z5));
  aoi21  g49(.a(new_n47_), .b(new_n46_), .c(new_n17_), .O(new_n65_));
  inv1   g50(.a(x5), .O(new_n66_));
  nand4  g51(.a(x6), .b(new_n66_), .c(new_n24_), .d(x2), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n65_), .c(new_n27_), .O(new_n69_));
  oai21  g54(.a(new_n32_), .b(x3), .c(new_n16_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n59_), .O(new_n71_));
