...
module FAU ( 
  ...
  nand4  g10(.a(x5), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n26_));
  ...
  aoi21  g20(.a(new_n35_), .b(new_n30_), .c(x0), .O(z2));
  ...
  aoi21  g26(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n42_));
