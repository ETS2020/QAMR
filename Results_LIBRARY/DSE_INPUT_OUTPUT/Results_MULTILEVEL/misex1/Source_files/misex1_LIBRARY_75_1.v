...
module FAU ( 
  ...
  nand3  g17(.a(new_n26_), .b(x3), .c(new_n16_), .O(new_n33_));
  ...
  oai21  g26(.a(new_n32_), .b(new_n20_), .c(new_n26_), .O(new_n42_));
  ...
  nand4  g31(.a(new_n26_), .b(new_n16_), .c(x1), .d(new_n17_), .O(new_n47_));
  ...
  nand3  g51(.a(new_n66_), .b(new_n61_), .c(new_n57_), .O(z5));
  ...
  nand3  g57(.a(new_n26_), .b(new_n72_), .c(new_n16_), .O(new_n73_));
