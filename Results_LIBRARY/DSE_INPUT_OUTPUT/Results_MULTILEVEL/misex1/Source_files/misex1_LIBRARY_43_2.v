...
module FAU ( 
  ...
  aoi21  g10(.a(new_n25_), .b(new_n18_), .c(new_n16_), .O(new_n26_));
  ...
  nand3  g14(.a(new_n16_), .b(new_n17_), .c(x0), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(x7), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(x3), .O(new_n32_));
  oai21  g17(.a(new_n29_), .b(x0), .c(new_n32_), .O(z1));
  nand3  g18(.a(x4), .b(new_n18_), .c(new_n16_), .O(new_n34_));
  aoi21  g19(.a(new_n34_), .b(new_n21_), .c(new_n17_), .O(new_n35_));
  ...
  aoi21  g23(.a(new_n38_), .b(new_n17_), .c(new_n35_), .O(new_n39_));
  nand4  g24(.a(new_n22_), .b(new_n16_), .c(new_n17_), .d(x0), .O(new_n40_));
  oai21  g25(.a(new_n39_), .b(x0), .c(new_n40_), .O(z2));
  inv1   g26(.a(x4), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n18_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(x7), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n16_), .c(x1), .d(new_n20_), .O(new_n45_));
  nand2  g30(.a(x5), .b(new_n20_), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n18_), .c(x2), .d(new_n17_), .O(new_n47_));
  inv1   g32(.a(x7), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(x3), .O(new_n49_));
  ...
  nor2   g40(.a(new_n18_), .b(new_n16_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n55_), .c(new_n20_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n54_), .c(new_n49_), .O(z4));
  nand3  g43(.a(x7), .b(x3), .c(new_n16_), .O(new_n59_));
  aoi21  g44(.a(new_n52_), .b(new_n59_), .c(new_n20_), .O(new_n60_));
