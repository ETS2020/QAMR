...
module FAU ( 
  ...
  nand3  g13(.a(new_n28_), .b(new_n26_), .c(x1), .O(new_n29_));
  nor2   g14(.a(x6), .b(x3), .O(new_n30_));
  aoi21  g15(.a(new_n30_), .b(new_n16_), .c(x2), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n29_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n20_), .O(new_n33_));
  nand4  g18(.a(x3), .b(new_n26_), .c(new_n16_), .d(x0), .O(new_n34_));
  ...
  oai22  g23(.a(new_n38_), .b(x1), .c(new_n37_), .d(x0), .O(z3));
  nand2  g24(.a(x3), .b(new_n26_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n20_), .c(new_n38_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n16_), .O(new_n42_));
  oai21  g27(.a(new_n40_), .b(x1), .c(new_n20_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n42_), .O(z4));
  nand3  g29(.a(new_n21_), .b(new_n26_), .c(new_n16_), .O(new_n45_));
  ...
  nand2  g34(.a(new_n49_), .b(new_n42_), .O(z6));
endmodule
