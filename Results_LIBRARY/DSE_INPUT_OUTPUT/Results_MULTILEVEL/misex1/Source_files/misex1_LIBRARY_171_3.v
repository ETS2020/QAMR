...
module FAU ( 
  ...
  oai21  g26(.a(new_n18_), .b(new_n21_), .c(x2), .O(new_n42_));
  ...
  nand3  g35(.a(new_n50_), .b(new_n26_), .c(new_n22_), .O(z5));
  aoi22  g36(.a(new_n49_), .b(x0), .c(new_n23_), .d(x2), .O(new_n52_));
  nand2  g37(.a(x4), .b(new_n18_), .O(new_n53_));
  nand4  g38(.a(new_n53_), .b(new_n17_), .c(x1), .d(new_n21_), .O(new_n54_));
