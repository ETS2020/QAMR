...
module FAU ( 
  ...
  aoi21  g23(.a(new_n38_), .b(x1), .c(x2), .O(new_n39_));
  nand2  g24(.a(new_n18_), .b(x2), .O(new_n40_));
  oai22  g25(.a(new_n40_), .b(new_n34_), .c(new_n39_), .d(x0), .O(z3));
  ...
  nand3  g31(.a(new_n23_), .b(new_n16_), .c(new_n21_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n43_), .O(z5));
  nand2  g33(.a(x4), .b(new_n18_), .O(new_n49_));
  nand4  g34(.a(new_n49_), .b(new_n16_), .c(x1), .d(new_n21_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n43_), .O(z6));
endmodule
