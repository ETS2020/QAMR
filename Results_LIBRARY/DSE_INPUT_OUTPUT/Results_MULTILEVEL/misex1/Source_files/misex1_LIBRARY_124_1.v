...
module FAU ( 
  ...
  nand3  g23(.a(new_n23_), .b(new_n18_), .c(x0), .O(new_n39_));
  ...
  nand3  g29(.a(new_n44_), .b(new_n41_), .c(new_n24_), .O(z2));
  ...
  nand4  g36(.a(new_n29_), .b(x3), .c(new_n23_), .d(x0), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n18_), .O(new_n54_));
  aoi21  g39(.a(x3), .b(new_n18_), .c(x4), .O(new_n55_));
  ...
  aoi21  g43(.a(new_n51_), .b(new_n35_), .c(new_n16_), .O(new_n59_));
  ...
  nand2  g53(.a(new_n19_), .b(x2), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(x1), .c(new_n16_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n68_), .c(new_n24_), .O(z6));
endmodule
