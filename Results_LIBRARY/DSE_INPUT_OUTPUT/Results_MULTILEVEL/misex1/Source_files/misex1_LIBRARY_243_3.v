...
module FAU ( 
  ...
  oai21  g32(.a(x3), .b(new_n19_), .c(x1), .O(new_n48_));
  oai21  g33(.a(new_n27_), .b(x1), .c(new_n20_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(x2), .O(new_n50_));
  nand3  g35(.a(x6), .b(new_n20_), .c(new_n19_), .O(new_n51_));
