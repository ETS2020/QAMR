...
module FAU ( 
  ...
  nand2  g19(.a(new_n25_), .b(new_n16_), .O(new_n35_));
  ...
  aoi21  g47(.a(new_n62_), .b(new_n61_), .c(new_n52_), .O(new_n63_));
  ...
  nand3  g53(.a(x7), .b(new_n41_), .c(new_n16_), .O(new_n69_));
  oai21  g54(.a(new_n45_), .b(new_n20_), .c(new_n69_), .O(new_n70_));
