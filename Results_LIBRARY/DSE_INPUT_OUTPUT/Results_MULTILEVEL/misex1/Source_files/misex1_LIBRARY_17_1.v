...
module FAU ( 
  ...
  nand3  g26(.a(new_n41_), .b(new_n33_), .c(new_n20_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n40_), .O(z4));
  nand3  g28(.a(new_n21_), .b(new_n33_), .c(new_n16_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n20_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n40_), .O(z5));
  nand2  g31(.a(x4), .b(new_n17_), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(new_n33_), .c(x1), .d(new_n20_), .O(new_n48_));
