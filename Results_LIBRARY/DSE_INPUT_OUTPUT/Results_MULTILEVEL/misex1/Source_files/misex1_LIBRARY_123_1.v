...
module FAU ( 
  ...
  nand4  g28(.a(new_n43_), .b(new_n27_), .c(new_n16_), .d(x1), .O(new_n44_));
  ...
  nand4  g33(.a(new_n27_), .b(x3), .c(new_n16_), .d(x0), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n19_), .O(new_n51_));
  aoi21  g36(.a(x3), .b(new_n19_), .c(x6), .O(new_n52_));
  ...
  nand3  g47(.a(new_n23_), .b(new_n20_), .c(x2), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n56_), .c(new_n19_), .O(new_n65_));
  inv1   g50(.a(x4), .O(new_n66_));
  nand3  g51(.a(new_n27_), .b(new_n66_), .c(new_n16_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n35_), .O(new_n68_));
