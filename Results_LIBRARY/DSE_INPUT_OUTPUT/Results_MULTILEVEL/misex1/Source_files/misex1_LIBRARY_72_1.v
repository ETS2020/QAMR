...
module FAU ( 
  ...
  oai22  g22(.a(new_n37_), .b(new_n25_), .c(new_n36_), .d(x0), .O(z3));
  nand2  g23(.a(new_n37_), .b(new_n26_), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n17_), .c(x0), .O(new_n40_));
  nand2  g25(.a(x3), .b(new_n17_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n16_), .c(new_n21_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n40_), .O(z4));
  nand2  g28(.a(new_n22_), .b(new_n17_), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n16_), .c(new_n21_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n40_), .O(z5));
  nand2  g31(.a(x4), .b(new_n18_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(x1), .c(x2), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(x0), .c(new_n40_), .O(z6));
endmodule
