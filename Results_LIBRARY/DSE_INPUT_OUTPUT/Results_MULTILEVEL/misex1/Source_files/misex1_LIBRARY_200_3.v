...
module FAU ( 
  ...
  aoi21  g35(.a(new_n50_), .b(new_n22_), .c(x7), .O(new_n51_));
  ...
  oai21  g40(.a(new_n24_), .b(x0), .c(new_n36_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(x2), .O(new_n57_));
  nand2  g42(.a(x3), .b(new_n22_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n16_), .c(new_n17_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n57_), .c(new_n55_), .O(z4));
  nand2  g45(.a(x3), .b(new_n16_), .O(new_n61_));
  aoi21  g46(.a(new_n53_), .b(new_n61_), .c(new_n17_), .O(new_n62_));
  nor3   g47(.a(new_n35_), .b(new_n16_), .c(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n62_), .c(new_n22_), .O(new_n64_));
  nand2  g49(.a(new_n53_), .b(x1), .O(new_n65_));
  nand2  g50(.a(x3), .b(x2), .O(new_n66_));
  nand3  g51(.a(x6), .b(new_n24_), .c(new_n16_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n17_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n64_), .c(new_n32_), .O(z5));
  nand3  g55(.a(new_n35_), .b(new_n24_), .c(x2), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n62_), .c(new_n22_), .O(new_n73_));
  oai21  g58(.a(x4), .b(x2), .c(new_n24_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(x1), .c(new_n17_), .O(new_n75_));
  nand3  g60(.a(new_n75_), .b(new_n73_), .c(new_n32_), .O(z6));
endmodule
