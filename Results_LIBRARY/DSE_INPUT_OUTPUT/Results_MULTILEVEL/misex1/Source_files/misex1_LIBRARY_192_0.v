...
module FAU ( 
  ...
  nand3  g05(.a(new_n20_), .b(x5), .c(new_n19_), .O(new_n21_));
  aoi21  g06(.a(new_n21_), .b(new_n18_), .c(new_n16_), .O(z0));
  inv1   g07(.a(x1), .O(new_n23_));
  nor2   g08(.a(new_n23_), .b(x0), .O(new_n24_));
  nand3  g09(.a(x3), .b(new_n23_), .c(x0), .O(new_n25_));
  ...
  nand3  g14(.a(new_n29_), .b(new_n23_), .c(new_n17_), .O(new_n30_));
  inv1   g15(.a(x5), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n19_), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n30_), .c(new_n27_), .O(z1));
  nand3  g18(.a(x5), .b(x4), .c(new_n16_), .O(new_n34_));
  aoi21  g19(.a(new_n34_), .b(new_n19_), .c(new_n23_), .O(new_n35_));
  nand2  g20(.a(new_n16_), .b(new_n23_), .O(new_n36_));
  nand3  g21(.a(new_n28_), .b(x5), .c(new_n19_), .O(new_n37_));
  nor2   g22(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  oai21  g23(.a(new_n38_), .b(new_n35_), .c(new_n17_), .O(new_n39_));
  nand3  g24(.a(new_n20_), .b(x3), .c(new_n16_), .O(new_n40_));
  ...
  nand4  g28(.a(new_n19_), .b(x2), .c(new_n23_), .d(x0), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(x5), .O(new_n46_));
  inv1   g31(.a(x7), .O(new_n47_));
  nand4  g32(.a(new_n24_), .b(new_n47_), .c(x3), .d(new_n16_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n46_), .O(z3));
  nand3  g34(.a(new_n47_), .b(x5), .c(new_n16_), .O(new_n50_));
  aoi21  g35(.a(new_n50_), .b(new_n19_), .c(new_n23_), .O(new_n51_));
  nand2  g36(.a(x3), .b(x2), .O(new_n52_));
  nand3  g37(.a(x5), .b(new_n19_), .c(new_n16_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n51_), .c(new_n17_), .O(new_n55_));
  nand2  g40(.a(x3), .b(new_n16_), .O(new_n56_));
  nand3  g41(.a(x5), .b(new_n19_), .c(x2), .O(new_n57_));
  ...
  nand2  g45(.a(x5), .b(new_n16_), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n19_), .c(new_n23_), .O(new_n62_));
  nand4  g47(.a(x6), .b(x5), .c(new_n19_), .d(new_n16_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n52_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n62_), .c(new_n17_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n59_), .O(z5));
  nand2  g51(.a(new_n57_), .b(new_n56_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n23_), .c(x0), .O(new_n68_));
  inv1   g53(.a(x4), .O(new_n69_));
  nand3  g54(.a(x5), .b(new_n69_), .c(new_n16_), .O(new_n70_));
