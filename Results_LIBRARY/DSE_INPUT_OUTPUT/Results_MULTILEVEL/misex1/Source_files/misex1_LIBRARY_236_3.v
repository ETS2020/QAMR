...
module FAU ( 
  ...
  oai21  g09(.a(new_n24_), .b(x7), .c(x1), .O(new_n25_));
  ...
  nand2  g30(.a(new_n45_), .b(new_n25_), .O(z3));
  ...
  oai21  g41(.a(new_n56_), .b(new_n49_), .c(new_n17_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n54_), .O(z5));
  inv1   g43(.a(new_n51_), .O(new_n59_));
