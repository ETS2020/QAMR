...
module FAU ( 
  ...
  oai21  g14(.a(new_n23_), .b(x3), .c(new_n18_), .O(new_n30_));
  aoi22  g15(.a(new_n30_), .b(new_n27_), .c(new_n29_), .d(new_n18_), .O(new_n31_));
  ...
  nand2  g20(.a(new_n33_), .b(new_n32_), .O(new_n36_));
  ...
  aoi21  g26(.a(x7), .b(x2), .c(new_n23_), .O(new_n42_));
  nand2  g27(.a(new_n23_), .b(new_n27_), .O(new_n43_));
  oai21  g28(.a(new_n42_), .b(x5), .c(new_n43_), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n19_), .c(new_n18_), .d(new_n16_), .O(new_n45_));
  ...
  nand3  g35(.a(new_n50_), .b(new_n48_), .c(new_n25_), .O(z3));
  nand2  g36(.a(x3), .b(new_n27_), .O(new_n52_));
  ...
  aoi21  g43(.a(new_n58_), .b(new_n55_), .c(new_n24_), .O(z4));
  ...
  and2   g48(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  nand2  g49(.a(x5), .b(new_n18_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n19_), .c(new_n27_), .O(new_n66_));
  nor2   g51(.a(x6), .b(x1), .O(new_n67_));
  nor3   g52(.a(new_n67_), .b(x3), .c(x2), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n66_), .c(new_n16_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n64_), .c(new_n25_), .O(z5));
  nand2  g55(.a(new_n60_), .b(x0), .O(new_n71_));
  nand3  g56(.a(new_n28_), .b(new_n19_), .c(x2), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n18_), .O(new_n74_));
  aoi21  g59(.a(new_n74_), .b(new_n63_), .c(new_n24_), .O(z6));
endmodule
