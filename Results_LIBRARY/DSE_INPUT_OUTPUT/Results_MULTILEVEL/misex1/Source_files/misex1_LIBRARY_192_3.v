...
module FAU ( 
  ...
  aoi21  g10(.a(new_n21_), .b(new_n18_), .c(new_n16_), .O(new_n26_));
  ...
  aoi21  g19(.a(new_n34_), .b(new_n22_), .c(new_n17_), .O(new_n35_));
  ...
  aoi21  g24(.a(new_n39_), .b(new_n17_), .c(new_n35_), .O(new_n40_));
  ...
  nand4  g31(.a(new_n46_), .b(new_n16_), .c(x1), .d(new_n45_), .O(new_n47_));
  nand2  g32(.a(x5), .b(new_n45_), .O(new_n48_));
  ...
  nor3   g36(.a(x7), .b(x5), .c(x2), .O(new_n52_));
  ...
  oai21  g41(.a(new_n56_), .b(new_n22_), .c(new_n55_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n17_), .O(new_n58_));
  oai21  g43(.a(x5), .b(new_n17_), .c(x3), .O(new_n59_));
  nand3  g44(.a(new_n21_), .b(x3), .c(x2), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  aoi21  g46(.a(new_n59_), .b(new_n16_), .c(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(x0), .c(new_n58_), .O(z4));
  aoi21  g48(.a(new_n55_), .b(new_n41_), .c(new_n45_), .O(new_n64_));
  ...
  nand2  g52(.a(new_n18_), .b(new_n16_), .O(new_n68_));
  aoi21  g53(.a(new_n68_), .b(new_n22_), .c(new_n17_), .O(new_n69_));
  oai21  g54(.a(new_n27_), .b(x2), .c(new_n60_), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n69_), .c(new_n45_), .O(new_n71_));
  nand2  g56(.a(new_n71_), .b(new_n67_), .O(z5));
  nand3  g57(.a(new_n21_), .b(new_n18_), .c(x2), .O(new_n73_));
  inv1   g58(.a(new_n73_), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(new_n64_), .c(new_n17_), .O(new_n75_));
  inv1   g60(.a(x4), .O(new_n76_));
  nand3  g61(.a(new_n76_), .b(new_n18_), .c(new_n16_), .O(new_n77_));
  nand2  g62(.a(new_n77_), .b(new_n22_), .O(new_n78_));
  nand3  g63(.a(new_n78_), .b(x1), .c(new_n45_), .O(new_n79_));
