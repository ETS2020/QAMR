...
module FAU ( 
  ...
  nand3  g14(.a(new_n29_), .b(new_n25_), .c(new_n22_), .O(z1));
  aoi21  g15(.a(x4), .b(new_n17_), .c(x3), .O(new_n31_));
  nand4  g16(.a(new_n23_), .b(new_n26_), .c(new_n17_), .d(new_n20_), .O(new_n32_));
  oai21  g17(.a(new_n31_), .b(new_n20_), .c(new_n32_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n16_), .O(new_n34_));
  nand4  g19(.a(new_n27_), .b(new_n26_), .c(x2), .d(new_n20_), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n34_), .c(new_n22_), .O(z2));
  oai21  g21(.a(x4), .b(x3), .c(x7), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n17_), .c(x1), .O(new_n38_));
  aoi21  g23(.a(new_n38_), .b(new_n35_), .c(x0), .O(z3));
  nand2  g24(.a(new_n21_), .b(new_n16_), .O(new_n40_));
  oai21  g25(.a(x3), .b(new_n20_), .c(x2), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n40_), .c(new_n22_), .O(z4));
  oai21  g27(.a(new_n26_), .b(x1), .c(new_n17_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(x0), .O(new_n44_));
  aoi21  g29(.a(new_n26_), .b(x2), .c(new_n20_), .O(new_n45_));
  nand3  g30(.a(x6), .b(new_n26_), .c(new_n17_), .O(new_n46_));
  inv1   g31(.a(new_n46_), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n45_), .c(new_n16_), .O(new_n48_));
  oai21  g33(.a(new_n27_), .b(x1), .c(new_n26_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(x2), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n48_), .c(new_n44_), .O(z5));
  nor2   g36(.a(x4), .b(x2), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(x3), .c(x1), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n35_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n16_), .O(new_n55_));
  nand4  g40(.a(x3), .b(new_n17_), .c(new_n20_), .d(x0), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n55_), .O(z6));
endmodule
