...
module FAU ( 
  ...
  oai21  g28(.a(new_n26_), .b(new_n21_), .c(new_n37_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n17_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n24_), .O(z5));
  aoi21  g31(.a(x4), .b(new_n18_), .c(new_n17_), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(x2), .c(new_n21_), .O(new_n48_));
