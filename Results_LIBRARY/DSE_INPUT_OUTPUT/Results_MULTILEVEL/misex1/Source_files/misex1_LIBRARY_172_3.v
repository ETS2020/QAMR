...
module FAU ( 
  ...
  nand3  g29(.a(x3), .b(new_n17_), .c(x0), .O(new_n45_));
  oai21  g30(.a(new_n17_), .b(x0), .c(new_n45_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n20_), .O(new_n47_));
  oai21  g32(.a(new_n21_), .b(x1), .c(new_n17_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n37_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n16_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n47_), .O(z4));
  nand2  g36(.a(new_n48_), .b(x0), .O(new_n52_));
  ...
  nand3  g43(.a(new_n58_), .b(new_n56_), .c(new_n52_), .O(z5));
  oai21  g44(.a(x4), .b(x2), .c(new_n21_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(x1), .c(new_n16_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n52_), .c(new_n43_), .O(z6));
endmodule
