...
module FAU ( 
  ...
  nand4  g30(.a(new_n31_), .b(new_n23_), .c(x1), .d(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n45_), .O(z3));
  nand2  g32(.a(new_n19_), .b(x2), .O(new_n48_));
  nand2  g33(.a(new_n23_), .b(x0), .O(new_n49_));
  nand2  g34(.a(new_n31_), .b(x3), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n18_), .O(new_n52_));
  aoi21  g37(.a(x3), .b(new_n18_), .c(x7), .O(new_n53_));
  nand2  g38(.a(x3), .b(x2), .O(new_n54_));
  inv1   g39(.a(new_n54_), .O(new_n55_));
  aoi21  g40(.a(new_n53_), .b(new_n23_), .c(new_n55_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x0), .c(new_n52_), .O(z4));
  nand3  g42(.a(new_n31_), .b(x3), .c(new_n23_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n48_), .c(new_n16_), .O(new_n59_));
  nor3   g44(.a(new_n26_), .b(new_n23_), .c(x0), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n59_), .c(new_n18_), .O(new_n61_));
  aoi21  g46(.a(new_n50_), .b(x2), .c(new_n18_), .O(new_n62_));
  oai21  g47(.a(new_n28_), .b(x2), .c(new_n54_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n62_), .c(new_n16_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n61_), .c(new_n24_), .O(z5));
  ...
  nand2  g53(.a(new_n24_), .b(x3), .O(new_n69_));
  inv1   g54(.a(x4), .O(new_n70_));
  nand3  g55(.a(new_n31_), .b(new_n70_), .c(new_n23_), .O(new_n71_));
  nand2  g56(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(x1), .c(new_n16_), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n68_), .O(z6));
endmodule
