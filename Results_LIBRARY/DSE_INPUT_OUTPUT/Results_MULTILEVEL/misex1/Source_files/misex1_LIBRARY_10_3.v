...
module FAU ( 
  ...
  oai21  g08(.a(new_n22_), .b(x0), .c(new_n23_), .O(new_n24_));
  ...
  nand2  g15(.a(x6), .b(x2), .O(new_n31_));
  nand3  g16(.a(new_n31_), .b(new_n30_), .c(new_n25_), .O(z1));
  nand2  g17(.a(x4), .b(new_n16_), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n27_), .c(new_n22_), .O(new_n34_));
  ...
  aoi21  g24(.a(new_n39_), .b(new_n22_), .c(new_n34_), .O(new_n40_));
  nor2   g25(.a(x1), .b(new_n17_), .O(new_n41_));
  nand2  g26(.a(x3), .b(new_n16_), .O(new_n42_));
  inv1   g27(.a(new_n42_), .O(new_n43_));
  aoi22  g28(.a(new_n43_), .b(new_n41_), .c(x6), .d(x2), .O(new_n44_));
