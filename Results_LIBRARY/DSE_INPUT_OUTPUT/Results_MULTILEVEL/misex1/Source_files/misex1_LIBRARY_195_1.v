...
module FAU ( 
  ...
  nand2  g13(.a(new_n23_), .b(x1), .O(new_n29_));
  ...
  aoi21  g21(.a(x4), .b(new_n23_), .c(x3), .O(new_n37_));
  ...
  nand4  g28(.a(new_n43_), .b(new_n32_), .c(new_n23_), .d(x1), .O(new_n44_));
  nand2  g29(.a(x5), .b(new_n16_), .O(new_n45_));
  nand4  g30(.a(new_n45_), .b(new_n19_), .c(x2), .d(new_n18_), .O(new_n46_));
  oai21  g31(.a(new_n44_), .b(x0), .c(new_n46_), .O(z3));
  nand2  g32(.a(new_n19_), .b(x2), .O(new_n48_));
  nand4  g33(.a(new_n32_), .b(x3), .c(new_n23_), .d(x0), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n18_), .O(new_n51_));
  aoi21  g36(.a(x3), .b(new_n18_), .c(x6), .O(new_n52_));
  nand2  g37(.a(x3), .b(x2), .O(new_n53_));
  inv1   g38(.a(new_n53_), .O(new_n54_));
  aoi21  g39(.a(new_n52_), .b(new_n23_), .c(new_n54_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(x0), .c(new_n51_), .O(z4));
  nand3  g41(.a(new_n32_), .b(x3), .c(new_n23_), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n48_), .c(new_n16_), .O(new_n58_));
  nor2   g43(.a(new_n38_), .b(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n58_), .c(new_n18_), .O(new_n60_));
  nand3  g45(.a(new_n48_), .b(new_n32_), .c(x1), .O(new_n61_));
  ...
  oai22  g50(.a(new_n65_), .b(new_n16_), .c(new_n27_), .d(new_n23_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n18_), .O(new_n67_));
  nand2  g52(.a(x1), .b(new_n16_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(x4), .c(new_n32_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n23_), .O(new_n70_));
  nand4  g55(.a(new_n24_), .b(x3), .c(x1), .d(new_n16_), .O(new_n71_));
