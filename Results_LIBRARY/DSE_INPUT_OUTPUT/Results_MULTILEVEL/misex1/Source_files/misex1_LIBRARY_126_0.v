...
module FAU ( 
  ...
  nand3  g19(.a(x6), .b(x3), .c(new_n29_), .O(new_n35_));
  ...
  nor2   g24(.a(new_n29_), .b(x1), .O(new_n40_));
  aoi22  g25(.a(new_n40_), .b(new_n37_), .c(new_n39_), .d(x1), .O(new_n41_));
  oai21  g26(.a(new_n30_), .b(new_n16_), .c(x6), .O(new_n42_));
  ...
  nand3  g47(.a(new_n62_), .b(x6), .c(x1), .O(new_n63_));
  ...
  oai21  g54(.a(new_n69_), .b(new_n59_), .c(new_n18_), .O(new_n70_));
  nand3  g55(.a(x6), .b(new_n38_), .c(new_n29_), .O(new_n71_));
  oai21  g56(.a(new_n23_), .b(new_n19_), .c(new_n71_), .O(new_n72_));
