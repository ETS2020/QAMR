...
module FAU ( 
  ...
  nand3  g34(.a(x6), .b(x1), .c(new_n20_), .O(new_n50_));
  oai21  g35(.a(new_n26_), .b(new_n20_), .c(new_n50_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n16_), .O(new_n52_));
  nand2  g37(.a(new_n18_), .b(x2), .O(new_n53_));
  oai21  g38(.a(new_n31_), .b(x0), .c(new_n53_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n17_), .O(new_n55_));
  nand4  g40(.a(x6), .b(x3), .c(x2), .d(new_n20_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n55_), .c(new_n52_), .O(z4));
  aoi21  g42(.a(new_n53_), .b(new_n30_), .c(new_n20_), .O(new_n58_));
  nor3   g43(.a(new_n23_), .b(new_n16_), .c(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n58_), .c(new_n17_), .O(new_n60_));
  nand2  g45(.a(new_n53_), .b(x1), .O(new_n61_));
  ...
  nand2  g50(.a(new_n38_), .b(x1), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n65_), .c(new_n60_), .O(z5));
  nand3  g52(.a(new_n23_), .b(new_n18_), .c(x2), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n58_), .c(new_n17_), .O(new_n70_));
  nor2   g55(.a(x4), .b(x2), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(x3), .c(new_n20_), .O(new_n72_));
