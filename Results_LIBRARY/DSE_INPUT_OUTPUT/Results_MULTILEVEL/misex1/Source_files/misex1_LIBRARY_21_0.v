...
module FAU ( 
  ...
  nand4  g19(.a(x3), .b(new_n16_), .c(new_n19_), .d(x0), .O(new_n35_));
  ...
  nor2   g23(.a(x7), .b(new_n20_), .O(new_n39_));
  ...
  oai21  g27(.a(x2), .b(new_n19_), .c(new_n42_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n17_), .O(new_n44_));
  oai21  g29(.a(x2), .b(new_n17_), .c(x3), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n19_), .O(new_n46_));
  nand2  g31(.a(new_n20_), .b(new_n16_), .O(new_n47_));
  ...
  aoi21  g36(.a(new_n49_), .b(x0), .c(new_n51_), .O(new_n52_));
  nand2  g37(.a(new_n16_), .b(new_n19_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(x3), .c(new_n17_), .O(new_n54_));
  oai21  g39(.a(new_n52_), .b(x1), .c(new_n54_), .O(z5));
  aoi22  g40(.a(new_n49_), .b(x0), .c(new_n31_), .d(x2), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x1), .c(new_n18_), .O(z6));
endmodule
