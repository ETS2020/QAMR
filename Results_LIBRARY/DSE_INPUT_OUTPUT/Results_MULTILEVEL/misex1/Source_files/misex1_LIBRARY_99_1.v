...
module FAU ( 
  ...
  nor2   g19(.a(x1), .b(new_n16_), .O(new_n35_));
  nand4  g20(.a(new_n35_), .b(new_n29_), .c(x3), .d(new_n23_), .O(new_n36_));
  ...
  nand4  g34(.a(new_n29_), .b(new_n23_), .c(x1), .d(new_n16_), .O(new_n50_));
  ...
  aoi21  g40(.a(new_n29_), .b(x1), .c(new_n19_), .O(new_n56_));
  nand2  g41(.a(x3), .b(x2), .O(new_n57_));
  oai21  g42(.a(new_n56_), .b(x2), .c(new_n57_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n16_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n55_), .c(new_n24_), .O(z4));
  aoi21  g45(.a(new_n53_), .b(new_n52_), .c(new_n16_), .O(new_n61_));
  ...
  nand3  g49(.a(x6), .b(new_n19_), .c(new_n23_), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n64_), .c(new_n57_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n16_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n63_), .c(new_n24_), .O(z5));
  nand3  g53(.a(new_n26_), .b(new_n19_), .c(x2), .O(new_n69_));
  inv1   g54(.a(new_n69_), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n61_), .c(new_n18_), .O(new_n71_));
  oai21  g56(.a(x4), .b(x2), .c(new_n19_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(x1), .c(new_n16_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(new_n71_), .c(new_n24_), .O(z6));
endmodule
