...
module FAU ( 
  ...
  nand3  g14(.a(new_n23_), .b(new_n17_), .c(new_n16_), .O(new_n30_));
  ...
  aoi21  g22(.a(new_n37_), .b(new_n28_), .c(x2), .O(new_n38_));
  nand2  g23(.a(x5), .b(new_n28_), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n17_), .c(x2), .O(new_n40_));
  oai21  g25(.a(new_n38_), .b(new_n16_), .c(new_n40_), .O(z3));
  nand2  g26(.a(x3), .b(new_n20_), .O(new_n42_));
  nand2  g27(.a(new_n17_), .b(x2), .O(new_n43_));
  oai21  g28(.a(new_n42_), .b(x1), .c(new_n43_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(x0), .O(new_n45_));
  oai21  g30(.a(x2), .b(new_n28_), .c(x1), .O(new_n46_));
  aoi22  g31(.a(new_n42_), .b(new_n28_), .c(new_n32_), .d(x2), .O(new_n47_));
  ...
  nand3  g35(.a(x6), .b(new_n17_), .c(new_n20_), .O(new_n51_));
  inv1   g36(.a(new_n51_), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n22_), .c(new_n28_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n50_), .c(new_n46_), .O(z5));
  aoi22  g39(.a(new_n49_), .b(x0), .c(new_n32_), .d(x2), .O(new_n55_));
  nand2  g40(.a(x4), .b(new_n17_), .O(new_n56_));
  nand4  g41(.a(new_n56_), .b(new_n20_), .c(x1), .d(new_n28_), .O(new_n57_));
