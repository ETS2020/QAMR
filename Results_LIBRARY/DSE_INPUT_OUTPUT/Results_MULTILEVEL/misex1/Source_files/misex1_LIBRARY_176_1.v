...
module FAU ( 
  ...
  nand4  g12(.a(new_n23_), .b(x3), .c(new_n16_), .d(x0), .O(new_n28_));
  ...
  nand2  g37(.a(x5), .b(new_n17_), .O(new_n53_));
  nand4  g38(.a(new_n53_), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n54_));
  ...
  nand3  g57(.a(new_n23_), .b(new_n35_), .c(new_n16_), .O(new_n73_));
