...
module FAU ( 
  ...
  nand2  g32(.a(x7), .b(new_n16_), .O(new_n48_));
  ...
  inv1   g45(.a(new_n54_), .O(new_n61_));
  nand2  g46(.a(new_n50_), .b(x1), .O(new_n62_));
  nand3  g47(.a(x6), .b(new_n20_), .c(new_n16_), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n62_), .c(x7), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n61_), .c(new_n17_), .O(new_n65_));
  ...
  nand2  g56(.a(new_n71_), .b(new_n36_), .O(new_n72_));
