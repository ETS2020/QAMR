...
module FAU ( 
  ...
  oai21  g04(.a(new_n19_), .b(new_n17_), .c(x6), .O(new_n20_));
  ...
  aoi21  g12(.a(x3), .b(new_n16_), .c(x2), .O(new_n28_));
  ...
  nand2  g21(.a(x2), .b(new_n16_), .O(new_n37_));
  nand3  g22(.a(x6), .b(new_n24_), .c(new_n18_), .O(new_n38_));
  nor2   g23(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  oai21  g24(.a(new_n39_), .b(new_n36_), .c(new_n17_), .O(new_n40_));
  nand2  g25(.a(new_n16_), .b(x0), .O(new_n41_));
  nand3  g26(.a(x6), .b(x3), .c(new_n30_), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(new_n41_), .c(new_n40_), .O(z2));
  oai21  g28(.a(x4), .b(x3), .c(x7), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n30_), .c(x1), .d(new_n17_), .O(new_n45_));
  inv1   g30(.a(x6), .O(new_n46_));
  aoi21  g31(.a(x5), .b(new_n17_), .c(new_n46_), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(new_n18_), .c(x2), .d(new_n16_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n45_), .O(z3));
  xor2a  g34(.a(x3), .b(x2), .O(new_n50_));
  nor2   g35(.a(new_n50_), .b(new_n46_), .O(new_n51_));
  aoi21  g36(.a(new_n19_), .b(x1), .c(new_n51_), .O(new_n52_));
  nand2  g37(.a(new_n31_), .b(new_n19_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(x6), .c(new_n16_), .O(new_n54_));
  ...
  nor2   g43(.a(new_n50_), .b(x0), .O(new_n59_));
  aoi21  g44(.a(new_n58_), .b(new_n16_), .c(new_n59_), .O(new_n60_));
  nand3  g45(.a(new_n19_), .b(x1), .c(new_n17_), .O(new_n61_));
  oai21  g46(.a(new_n60_), .b(new_n46_), .c(new_n61_), .O(z5));
  aoi21  g47(.a(new_n42_), .b(new_n19_), .c(new_n17_), .O(new_n63_));
  oai21  g48(.a(new_n25_), .b(new_n30_), .c(x6), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n63_), .c(new_n16_), .O(new_n65_));
