...
module FAU ( 
  ...
  nand4  g10(.a(x5), .b(new_n25_), .c(x2), .d(new_n21_), .O(new_n26_));
  aoi21  g11(.a(new_n26_), .b(new_n24_), .c(x0), .O(z1));
  inv1   g12(.a(x5), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(x2), .O(new_n29_));
  nand2  g14(.a(new_n22_), .b(new_n20_), .O(new_n30_));
  aoi21  g15(.a(new_n30_), .b(new_n29_), .c(x1), .O(new_n31_));
  nand3  g16(.a(x4), .b(new_n20_), .c(x1), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n25_), .O(new_n33_));
  oai21  g18(.a(new_n33_), .b(new_n31_), .c(new_n17_), .O(new_n34_));
  nand2  g19(.a(x3), .b(new_n21_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n34_), .O(z2));
  oai21  g21(.a(x4), .b(x3), .c(x7), .O(new_n37_));
  nand4  g22(.a(new_n37_), .b(new_n20_), .c(x1), .d(new_n17_), .O(new_n38_));
  nand2  g23(.a(x5), .b(new_n17_), .O(new_n39_));
  nand4  g24(.a(new_n39_), .b(new_n25_), .c(x2), .d(new_n21_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n38_), .O(z3));
  aoi21  g26(.a(new_n25_), .b(x2), .c(new_n21_), .O(new_n42_));
  nor2   g27(.a(x3), .b(x2), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(new_n42_), .c(new_n17_), .O(new_n44_));
  nand3  g29(.a(new_n25_), .b(x2), .c(new_n21_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n44_), .O(z4));
  nand3  g31(.a(x6), .b(new_n25_), .c(new_n20_), .O(new_n47_));
  inv1   g32(.a(new_n47_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n42_), .c(new_n17_), .O(new_n49_));
  nand2  g34(.a(new_n28_), .b(new_n17_), .O(new_n50_));
  nand4  g35(.a(new_n50_), .b(new_n25_), .c(x2), .d(new_n21_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n49_), .O(z5));
  oai21  g37(.a(x4), .b(x2), .c(new_n25_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(x1), .c(new_n17_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n40_), .O(z6));
endmodule
