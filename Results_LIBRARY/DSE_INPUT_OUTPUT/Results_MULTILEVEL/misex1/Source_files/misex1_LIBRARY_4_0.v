...
module FAU ( 
  ...
  oai21  g24(.a(new_n35_), .b(x0), .c(new_n39_), .O(z4));
  oai21  g25(.a(new_n38_), .b(new_n17_), .c(new_n18_), .O(new_n41_));
  oai21  g26(.a(new_n20_), .b(new_n16_), .c(new_n17_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n41_), .O(z5));
  nand3  g28(.a(new_n38_), .b(new_n18_), .c(x0), .O(new_n44_));
