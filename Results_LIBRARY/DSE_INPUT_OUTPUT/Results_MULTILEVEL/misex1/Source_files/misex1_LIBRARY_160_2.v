...
module FAU ( 
  ...
  oai21  g21(.a(new_n36_), .b(x0), .c(new_n21_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n33_), .O(z2));
  oai21  g23(.a(x4), .b(x3), .c(x7), .O(new_n39_));
  nand4  g24(.a(new_n39_), .b(new_n26_), .c(x1), .d(new_n16_), .O(new_n40_));
  oai21  g25(.a(new_n24_), .b(new_n26_), .c(new_n16_), .O(new_n41_));
  ...
  oai21  g32(.a(x3), .b(new_n26_), .c(x1), .O(new_n48_));
  ...
  oai21  g36(.a(new_n23_), .b(new_n26_), .c(new_n16_), .O(new_n52_));
  ...
  nand2  g41(.a(new_n56_), .b(new_n42_), .O(z6));
endmodule
