...
module FAU ( 
  ...
  aoi21  g14(.a(new_n29_), .b(new_n19_), .c(x0), .O(new_n30_));
  oai21  g15(.a(new_n30_), .b(x5), .c(new_n16_), .O(new_n31_));
  ...
  nand3  g24(.a(x3), .b(new_n19_), .c(x0), .O(new_n40_));
  ...
  inv1   g38(.a(new_n24_), .O(new_n54_));
  aoi21  g39(.a(x3), .b(new_n19_), .c(x2), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n54_), .c(new_n17_), .O(new_n56_));
  nand2  g41(.a(x5), .b(new_n16_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(new_n53_), .O(z4));
  nand3  g43(.a(new_n23_), .b(x3), .c(new_n16_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n51_), .c(new_n17_), .O(new_n60_));
  ...
  nand2  g55(.a(new_n57_), .b(x3), .O(new_n71_));
