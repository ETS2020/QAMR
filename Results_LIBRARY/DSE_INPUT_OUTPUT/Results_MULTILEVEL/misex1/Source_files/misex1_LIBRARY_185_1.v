...
module FAU ( 
  ...
  aoi21  g26(.a(new_n26_), .b(x0), .c(new_n41_), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n40_), .c(x1), .O(z4));
  oai21  g28(.a(new_n41_), .b(new_n26_), .c(x0), .O(new_n44_));
  nand2  g29(.a(new_n23_), .b(new_n21_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n20_), .O(new_n46_));
  aoi21  g31(.a(new_n46_), .b(new_n44_), .c(x1), .O(z5));
  nand3  g32(.a(new_n29_), .b(new_n17_), .c(x2), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n44_), .c(x1), .O(z6));
endmodule
