...
module FAU ( 
  ...
  oai21  g25(.a(new_n35_), .b(new_n16_), .c(new_n20_), .O(new_n41_));
  oai21  g26(.a(new_n37_), .b(new_n20_), .c(x2), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n16_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n41_), .O(z5));
  oai21  g29(.a(x4), .b(x2), .c(new_n37_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(x1), .c(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n36_), .O(z6));
endmodule
