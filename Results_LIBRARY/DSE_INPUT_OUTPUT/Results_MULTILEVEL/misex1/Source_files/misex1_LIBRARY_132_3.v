...
module FAU ( 
  ...
  nand2  g20(.a(new_n35_), .b(new_n27_), .O(new_n36_));
  ...
  nand3  g42(.a(new_n57_), .b(new_n25_), .c(new_n17_), .O(new_n58_));
  ...
  oai21  g48(.a(new_n63_), .b(new_n31_), .c(new_n17_), .O(new_n64_));
  ...
  oai21  g52(.a(x3), .b(new_n25_), .c(new_n51_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n19_), .O(new_n69_));
  nand2  g54(.a(x5), .b(x2), .O(new_n70_));
