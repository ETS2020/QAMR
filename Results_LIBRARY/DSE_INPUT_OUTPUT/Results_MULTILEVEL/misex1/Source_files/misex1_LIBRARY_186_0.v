...
module FAU ( 
  ...
  nor3   g12(.a(x5), .b(x3), .c(x0), .O(new_n28_));
  oai21  g13(.a(new_n28_), .b(new_n16_), .c(new_n19_), .O(new_n29_));
  ...
  nand2  g21(.a(x5), .b(new_n17_), .O(new_n37_));
  nand4  g22(.a(new_n37_), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n38_));
  ...
  nand3  g32(.a(new_n47_), .b(new_n46_), .c(new_n23_), .O(z5));
