...
module FAU ( 
  ...
  nand3  g14(.a(new_n29_), .b(new_n26_), .c(new_n21_), .O(new_n30_));
  ...
  nand3  g25(.a(new_n40_), .b(new_n36_), .c(new_n21_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n20_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n32_), .O(z2));
  oai21  g28(.a(x7), .b(x5), .c(new_n20_), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n18_), .c(x2), .d(new_n17_), .O(new_n45_));
  nand4  g30(.a(new_n21_), .b(new_n16_), .c(x1), .d(new_n20_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n45_), .O(z3));
  nand2  g32(.a(x3), .b(new_n16_), .O(new_n48_));
  nand2  g33(.a(new_n18_), .b(x2), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n48_), .c(new_n20_), .O(new_n50_));
  nand3  g35(.a(new_n21_), .b(new_n24_), .c(new_n18_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(x0), .c(new_n16_), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n50_), .c(new_n17_), .O(new_n53_));
  nand2  g38(.a(new_n21_), .b(x1), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(x3), .c(x2), .O(new_n55_));
  nand2  g40(.a(x3), .b(x2), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n21_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n55_), .c(new_n20_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n53_), .O(z4));
  nand4  g44(.a(new_n21_), .b(x5), .c(x2), .d(new_n20_), .O(new_n60_));
  ...
  nand3  g48(.a(new_n63_), .b(new_n21_), .c(new_n20_), .O(new_n64_));
  ...
  nand2  g56(.a(new_n71_), .b(new_n20_), .O(new_n72_));
