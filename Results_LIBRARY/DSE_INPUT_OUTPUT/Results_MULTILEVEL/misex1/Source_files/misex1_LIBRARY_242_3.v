...
module FAU ( 
  ...
  nand4  g33(.a(new_n48_), .b(new_n23_), .c(x2), .d(new_n18_), .O(new_n49_));
  ...
  nand4  g38(.a(new_n33_), .b(new_n27_), .c(x1), .d(new_n16_), .O(new_n54_));
  ...
  nor2   g44(.a(new_n19_), .b(new_n27_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n59_), .c(new_n16_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n58_), .c(new_n23_), .O(z4));
  ...
  nand2  g52(.a(x5), .b(new_n18_), .O(new_n68_));
  aoi21  g53(.a(new_n68_), .b(new_n19_), .c(new_n27_), .O(new_n69_));
  nor2   g54(.a(x6), .b(x1), .O(new_n70_));
  nor3   g55(.a(new_n70_), .b(x3), .c(x2), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n69_), .c(new_n16_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(new_n67_), .c(new_n23_), .O(z5));
