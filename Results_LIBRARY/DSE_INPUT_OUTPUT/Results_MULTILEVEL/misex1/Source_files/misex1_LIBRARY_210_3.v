...
module FAU ( 
  ...
  nand3  g25(.a(x3), .b(new_n20_), .c(x0), .O(new_n41_));
  oai21  g26(.a(new_n20_), .b(x0), .c(new_n41_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n19_), .O(new_n43_));
  oai21  g28(.a(new_n28_), .b(x1), .c(new_n20_), .O(new_n44_));
  oai21  g29(.a(new_n28_), .b(new_n20_), .c(new_n44_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n43_), .O(z4));
  nand2  g32(.a(new_n44_), .b(x0), .O(new_n48_));
  aoi21  g33(.a(new_n28_), .b(x2), .c(new_n19_), .O(new_n49_));
  nand3  g34(.a(x6), .b(new_n28_), .c(new_n20_), .O(new_n50_));
  inv1   g35(.a(new_n50_), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n49_), .c(new_n16_), .O(new_n52_));
  oai21  g37(.a(new_n31_), .b(x1), .c(new_n28_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(x2), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n52_), .c(new_n48_), .O(z5));
  oai21  g40(.a(x4), .b(x2), .c(new_n28_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(x1), .c(new_n16_), .O(new_n57_));
  nand3  g42(.a(new_n21_), .b(x2), .c(new_n19_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n57_), .c(new_n48_), .O(z6));
endmodule
