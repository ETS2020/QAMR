...
module FAU ( 
  ...
  nand4  g18(.a(new_n33_), .b(new_n16_), .c(x1), .d(new_n21_), .O(new_n34_));
  nor2   g19(.a(x3), .b(new_n16_), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n17_), .c(x0), .O(new_n36_));
  ...
  oai21  g29(.a(new_n44_), .b(new_n35_), .c(new_n17_), .O(new_n45_));
  nand3  g30(.a(new_n22_), .b(new_n16_), .c(new_n17_), .O(new_n46_));
