...
module FAU ( 
  ...
  oai21  g22(.a(new_n19_), .b(new_n16_), .c(x0), .O(new_n38_));
  oai21  g23(.a(x4), .b(x3), .c(x7), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n16_), .c(x1), .O(new_n40_));
  nand4  g25(.a(new_n24_), .b(new_n23_), .c(x2), .d(new_n22_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n40_), .c(new_n38_), .O(z3));
  oai21  g27(.a(new_n16_), .b(new_n22_), .c(new_n23_), .O(new_n43_));
  ...
  oai21  g32(.a(new_n24_), .b(x1), .c(new_n23_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(x2), .O(new_n49_));
  nand3  g34(.a(x6), .b(new_n23_), .c(new_n16_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n49_), .c(new_n47_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n17_), .O(new_n52_));
  nand4  g37(.a(new_n23_), .b(x2), .c(new_n22_), .d(x0), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(z5));
  oai21  g39(.a(x3), .b(x1), .c(x2), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(x0), .O(new_n56_));
  oai21  g41(.a(x4), .b(x2), .c(new_n23_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(x1), .c(new_n17_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n56_), .c(new_n41_), .O(z6));
endmodule
