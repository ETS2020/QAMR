...
module FAU ( 
  ...
  nor2   g31(.a(new_n23_), .b(x2), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n42_), .c(new_n17_), .O(new_n48_));
  oai21  g33(.a(x3), .b(new_n17_), .c(new_n31_), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(x2), .c(x3), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(x1), .c(new_n48_), .O(z5));
  oai21  g36(.a(x4), .b(x2), .c(new_n20_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(x1), .c(new_n17_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n40_), .O(z6));
endmodule
