...
module FAU ( 
  ...
  nand3  g24(.a(x7), .b(new_n30_), .c(new_n29_), .O(new_n40_));
  ...
  nand4  g37(.a(new_n52_), .b(new_n29_), .c(x1), .d(new_n16_), .O(new_n53_));
  ...
  nand4  g42(.a(x7), .b(x3), .c(new_n29_), .d(x0), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n18_), .O(new_n60_));
  inv1   g45(.a(new_n44_), .O(new_n61_));
  inv1   g46(.a(x7), .O(new_n62_));
  aoi21  g47(.a(x3), .b(new_n18_), .c(new_n62_), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n29_), .c(new_n61_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(x0), .c(new_n60_), .O(z4));
  aoi21  g50(.a(new_n57_), .b(new_n36_), .c(new_n16_), .O(new_n66_));
  nor3   g51(.a(new_n26_), .b(new_n29_), .c(x0), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n66_), .c(new_n18_), .O(new_n68_));
  nand2  g53(.a(new_n57_), .b(x1), .O(new_n69_));
  nand3  g54(.a(x6), .b(new_n19_), .c(new_n29_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n69_), .c(new_n62_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n61_), .c(new_n16_), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n68_), .O(z5));
  nand3  g58(.a(new_n26_), .b(new_n19_), .c(x2), .O(new_n74_));
  inv1   g59(.a(new_n74_), .O(new_n75_));
  oai21  g60(.a(new_n75_), .b(new_n66_), .c(new_n18_), .O(new_n76_));
  nand3  g61(.a(x7), .b(new_n52_), .c(new_n29_), .O(new_n77_));
  oai21  g62(.a(new_n23_), .b(new_n19_), .c(new_n77_), .O(new_n78_));
