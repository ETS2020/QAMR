...
module FAU ( 
  ...
  oai21  g12(.a(x1), .b(new_n17_), .c(x3), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n16_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n27_), .O(z1));
  aoi21  g15(.a(new_n19_), .b(x2), .c(new_n18_), .O(new_n31_));
  nor3   g16(.a(x5), .b(x3), .c(x1), .O(new_n32_));
  oai21  g17(.a(new_n32_), .b(new_n31_), .c(new_n17_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n29_), .O(z2));
  nand2  g19(.a(x5), .b(new_n17_), .O(new_n35_));
  nand4  g20(.a(new_n35_), .b(new_n19_), .c(x2), .d(new_n18_), .O(new_n36_));
  nor2   g21(.a(x7), .b(new_n19_), .O(new_n37_));
  nand4  g22(.a(new_n37_), .b(new_n16_), .c(x1), .d(new_n17_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n36_), .O(z3));
  oai21  g24(.a(new_n19_), .b(new_n16_), .c(new_n25_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n17_), .O(new_n41_));
  oai21  g26(.a(x2), .b(new_n17_), .c(x3), .O(new_n42_));
  nor2   g27(.a(x3), .b(x2), .O(new_n43_));
  aoi21  g28(.a(new_n42_), .b(new_n18_), .c(new_n43_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n41_), .O(z4));
  xor2a  g30(.a(x3), .b(x2), .O(new_n46_));
  nand2  g31(.a(x5), .b(x2), .O(new_n47_));
  nor2   g32(.a(new_n47_), .b(x0), .O(new_n48_));
  aoi21  g33(.a(new_n46_), .b(x0), .c(new_n48_), .O(new_n49_));
  nand2  g34(.a(new_n16_), .b(new_n18_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(x3), .c(new_n17_), .O(new_n51_));
  oai21  g36(.a(new_n49_), .b(x1), .c(new_n51_), .O(z5));
  nor2   g37(.a(x5), .b(x3), .O(new_n53_));
  aoi21  g38(.a(new_n46_), .b(x0), .c(new_n53_), .O(new_n54_));
  aoi21  g39(.a(new_n20_), .b(new_n17_), .c(new_n43_), .O(new_n55_));
