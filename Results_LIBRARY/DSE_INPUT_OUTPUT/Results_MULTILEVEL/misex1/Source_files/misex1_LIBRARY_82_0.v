...
module FAU ( 
  ...
  aoi21  g26(.a(x5), .b(new_n17_), .c(new_n41_), .O(new_n42_));
  nand4  g27(.a(new_n42_), .b(new_n19_), .c(x2), .d(new_n26_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n40_), .O(z3));
  aoi21  g29(.a(new_n19_), .b(x2), .c(new_n26_), .O(new_n45_));
  nand2  g30(.a(x3), .b(x2), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n24_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(x6), .c(new_n45_), .O(new_n48_));
  nand3  g33(.a(x3), .b(new_n16_), .c(x0), .O(new_n49_));
  oai21  g34(.a(x3), .b(new_n16_), .c(new_n49_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(x6), .c(new_n26_), .O(new_n51_));
  oai21  g36(.a(new_n48_), .b(x0), .c(new_n51_), .O(z4));
  xor2a  g37(.a(x3), .b(x2), .O(new_n53_));
  nand2  g38(.a(x5), .b(x2), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(x0), .c(x6), .O(new_n55_));
  aoi21  g40(.a(new_n53_), .b(x0), .c(new_n55_), .O(new_n56_));
  oai21  g41(.a(new_n47_), .b(new_n45_), .c(new_n17_), .O(new_n57_));
  oai21  g42(.a(new_n56_), .b(x1), .c(new_n57_), .O(z5));
  nand2  g43(.a(new_n53_), .b(x0), .O(new_n59_));
  nor2   g44(.a(x5), .b(x3), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(x2), .c(new_n41_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n26_), .O(new_n63_));
  oai21  g48(.a(x4), .b(x2), .c(new_n19_), .O(new_n64_));
