...
module FAU ( 
  ...
  nand4  g35(.a(new_n50_), .b(new_n25_), .c(x2), .d(new_n23_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n49_), .O(z3));
  nand3  g37(.a(x7), .b(new_n25_), .c(x2), .O(new_n53_));
  ...
  nand2  g46(.a(new_n25_), .b(x2), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n61_), .c(new_n17_), .O(new_n63_));
  nor3   g48(.a(new_n36_), .b(new_n16_), .c(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n63_), .c(new_n23_), .O(new_n65_));
  ...
  nand3  g55(.a(new_n70_), .b(new_n65_), .c(new_n33_), .O(z5));
  nand3  g56(.a(new_n36_), .b(new_n25_), .c(x2), .O(new_n72_));
  inv1   g57(.a(new_n72_), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(new_n63_), .c(new_n23_), .O(new_n74_));
