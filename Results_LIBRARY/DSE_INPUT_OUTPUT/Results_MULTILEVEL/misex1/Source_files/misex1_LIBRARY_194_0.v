...
module FAU ( 
  ...
  nand3  g15(.a(x4), .b(x3), .c(new_n16_), .O(new_n31_));
  ...
  nand3  g22(.a(new_n23_), .b(x2), .c(new_n19_), .O(new_n38_));
  nand3  g23(.a(new_n26_), .b(x4), .c(new_n16_), .O(new_n39_));
  ...
  nor2   g30(.a(x7), .b(new_n45_), .O(new_n46_));
