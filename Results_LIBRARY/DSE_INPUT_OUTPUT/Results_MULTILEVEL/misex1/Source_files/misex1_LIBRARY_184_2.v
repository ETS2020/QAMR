...
module FAU ( 
  ...
  nand3  g24(.a(new_n39_), .b(new_n26_), .c(x1), .O(new_n40_));
  nand4  g25(.a(new_n23_), .b(new_n22_), .c(x2), .d(new_n21_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n40_), .c(new_n17_), .O(z3));
  oai21  g27(.a(new_n26_), .b(new_n21_), .c(new_n22_), .O(new_n43_));
  oai21  g28(.a(x1), .b(x0), .c(new_n26_), .O(new_n44_));
  nand3  g29(.a(x3), .b(x2), .c(new_n18_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n44_), .c(new_n43_), .O(z4));
  oai21  g31(.a(x3), .b(x1), .c(x2), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(x0), .O(new_n48_));
  oai21  g33(.a(new_n22_), .b(x0), .c(x2), .O(new_n49_));
  ...
  oai21  g39(.a(x4), .b(x2), .c(new_n22_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(x1), .c(new_n18_), .O(new_n56_));
  nand2  g41(.a(x5), .b(new_n18_), .O(new_n57_));
  nand4  g42(.a(new_n57_), .b(new_n22_), .c(x2), .d(new_n21_), .O(new_n58_));
