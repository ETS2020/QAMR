...
module FAU ( 
  ...
  nor2   g28(.a(new_n23_), .b(x0), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(new_n19_), .c(x2), .O(new_n45_));
  ...
  oai21  g33(.a(new_n19_), .b(new_n16_), .c(x0), .O(new_n49_));
  oai21  g34(.a(new_n44_), .b(new_n16_), .c(x1), .O(new_n50_));
  ...
  nand4  g38(.a(new_n53_), .b(new_n52_), .c(new_n50_), .d(new_n49_), .O(z5));
  aoi21  g39(.a(x4), .b(new_n23_), .c(x2), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n44_), .c(x1), .O(new_n56_));
  nand4  g41(.a(new_n24_), .b(new_n23_), .c(x2), .d(new_n22_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(new_n49_), .O(z6));
endmodule
