...
module FAU ( 
  ...
  nand3  g08(.a(x3), .b(new_n19_), .c(x0), .O(new_n24_));
  ...
  nand3  g13(.a(x4), .b(new_n16_), .c(x1), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n20_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n17_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n28_), .O(z2));
  nor2   g17(.a(x3), .b(new_n16_), .O(new_n33_));
  oai21  g18(.a(new_n33_), .b(new_n17_), .c(new_n19_), .O(new_n34_));
  ...
  nand3  g25(.a(new_n38_), .b(x1), .c(new_n17_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(z4));
  nand2  g27(.a(new_n39_), .b(new_n19_), .O(new_n43_));
  nand2  g28(.a(new_n38_), .b(new_n17_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n43_), .O(z5));
  oai21  g30(.a(x2), .b(x1), .c(x0), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(x3), .O(new_n47_));
  nand2  g32(.a(x4), .b(x1), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n16_), .c(new_n17_), .O(new_n49_));
  nand2  g34(.a(new_n33_), .b(new_n19_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n49_), .c(new_n47_), .O(z6));
endmodule
