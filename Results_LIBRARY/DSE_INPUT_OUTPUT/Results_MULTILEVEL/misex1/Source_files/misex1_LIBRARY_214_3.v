...
module FAU ( 
  ...
  oai21  g10(.a(new_n25_), .b(x0), .c(new_n23_), .O(new_n26_));
  nand3  g11(.a(new_n26_), .b(x3), .c(new_n22_), .O(new_n27_));
  ...
  nand4  g27(.a(x3), .b(new_n16_), .c(new_n22_), .d(x0), .O(new_n43_));
  ...
  aoi21  g31(.a(new_n32_), .b(new_n22_), .c(x5), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n16_), .c(new_n46_), .O(z3));
  nand2  g33(.a(x3), .b(new_n16_), .O(new_n49_));
  nand3  g34(.a(new_n24_), .b(new_n32_), .c(x2), .O(new_n50_));
  oai21  g35(.a(new_n49_), .b(new_n17_), .c(new_n50_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n22_), .O(new_n52_));
  aoi21  g37(.a(x3), .b(new_n22_), .c(x2), .O(new_n53_));
  ...
  nand3  g43(.a(new_n58_), .b(new_n22_), .c(x0), .O(new_n59_));
  nand2  g44(.a(new_n24_), .b(x3), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(x2), .c(new_n22_), .O(new_n61_));
  nand3  g46(.a(x6), .b(new_n32_), .c(new_n16_), .O(new_n62_));
  ...
  oai21  g50(.a(new_n36_), .b(x3), .c(new_n16_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n60_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(x1), .c(new_n17_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n52_), .O(z6));
endmodule
