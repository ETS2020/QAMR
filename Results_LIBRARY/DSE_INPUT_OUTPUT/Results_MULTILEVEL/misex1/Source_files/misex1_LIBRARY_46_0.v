...
module FAU ( 
  ...
  oai21  g24(.a(new_n20_), .b(new_n16_), .c(new_n19_), .O(new_n40_));
  oai21  g25(.a(new_n39_), .b(x0), .c(new_n40_), .O(z4));
  aoi21  g26(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n42_));
  oai21  g27(.a(new_n24_), .b(x1), .c(new_n20_), .O(new_n43_));
  aoi21  g28(.a(new_n43_), .b(x2), .c(new_n42_), .O(new_n44_));
  nand3  g29(.a(new_n39_), .b(new_n19_), .c(x0), .O(new_n45_));
  ...
  oai21  g35(.a(new_n50_), .b(new_n16_), .c(new_n19_), .O(new_n51_));
