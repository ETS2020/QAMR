...
module FAU ( 
  ...
  oai21  g26(.a(x2), .b(x0), .c(new_n19_), .O(new_n42_));
  ...
  nand2  g31(.a(new_n46_), .b(new_n42_), .O(z4));
  oai21  g32(.a(x3), .b(new_n21_), .c(x1), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n44_), .c(new_n23_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n16_), .O(new_n50_));
  oai21  g35(.a(new_n31_), .b(new_n21_), .c(new_n16_), .O(new_n51_));
  ...
  aoi21  g40(.a(new_n55_), .b(new_n40_), .c(x0), .O(z6));
endmodule
