...
module FAU ( 
  ...
  oai21  g11(.a(x1), .b(new_n22_), .c(x3), .O(new_n27_));
  ...
  nand2  g22(.a(x5), .b(new_n22_), .O(new_n38_));
  nand4  g23(.a(new_n38_), .b(new_n37_), .c(x2), .d(new_n16_), .O(new_n39_));
  nor2   g24(.a(x7), .b(new_n37_), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n19_), .c(new_n17_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n39_), .O(z3));
  nor2   g27(.a(x2), .b(x1), .O(new_n43_));
  xor2a  g28(.a(new_n43_), .b(x0), .O(new_n44_));
  nand3  g29(.a(new_n37_), .b(x2), .c(new_n16_), .O(new_n45_));
  oai21  g30(.a(new_n44_), .b(new_n37_), .c(new_n45_), .O(z4));
  ...
  nor2   g35(.a(new_n43_), .b(new_n37_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n22_), .O(new_n52_));
  oai21  g37(.a(new_n50_), .b(x1), .c(new_n52_), .O(z5));
  aoi21  g38(.a(new_n47_), .b(x0), .c(new_n31_), .O(new_n54_));
  nor2   g39(.a(new_n30_), .b(x0), .O(new_n55_));
  aoi21  g40(.a(new_n37_), .b(new_n17_), .c(new_n55_), .O(new_n56_));
