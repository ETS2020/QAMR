...
module FAU ( 
  ...
  nand2  g31(.a(new_n46_), .b(new_n29_), .O(new_n47_));
  ...
  nand2  g35(.a(x1), .b(new_n16_), .O(new_n51_));
  ...
  nand2  g40(.a(new_n55_), .b(new_n24_), .O(z3));
  ...
  nor2   g46(.a(new_n19_), .b(new_n29_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n61_), .c(new_n16_), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n60_), .c(new_n24_), .O(z4));
  aoi21  g49(.a(new_n58_), .b(new_n36_), .c(new_n16_), .O(new_n65_));
  nor3   g50(.a(new_n26_), .b(new_n29_), .c(x0), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n65_), .c(new_n18_), .O(new_n67_));
  inv1   g52(.a(new_n62_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n32_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n16_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n67_), .O(z5));
  nand3  g56(.a(new_n26_), .b(new_n19_), .c(x2), .O(new_n72_));
  inv1   g57(.a(new_n72_), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(new_n65_), .c(new_n18_), .O(new_n74_));
  aoi21  g59(.a(new_n53_), .b(new_n19_), .c(new_n18_), .O(new_n75_));
  aoi21  g60(.a(new_n75_), .b(new_n16_), .c(new_n23_), .O(new_n76_));
