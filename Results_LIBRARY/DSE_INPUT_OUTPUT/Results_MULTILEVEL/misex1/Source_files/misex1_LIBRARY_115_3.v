...
module FAU ( 
  ...
  nand4  g21(.a(x3), .b(new_n21_), .c(new_n16_), .d(x0), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n36_), .O(z2));
  oai21  g23(.a(x4), .b(x3), .c(x7), .O(new_n39_));
  nand4  g24(.a(new_n39_), .b(new_n21_), .c(x1), .d(new_n20_), .O(new_n40_));
  ...
  xor2a  g29(.a(new_n44_), .b(new_n20_), .O(new_n45_));
  nand2  g30(.a(new_n17_), .b(x2), .O(new_n46_));
  oai22  g31(.a(new_n46_), .b(x1), .c(new_n45_), .d(x2), .O(z4));
  aoi21  g32(.a(new_n46_), .b(new_n22_), .c(new_n20_), .O(new_n48_));
  and2   g33(.a(x5), .b(x2), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n48_), .c(new_n16_), .O(new_n50_));
  nand2  g35(.a(x3), .b(x2), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n50_), .c(new_n28_), .O(z5));
  xor2a  g37(.a(x3), .b(x2), .O(new_n53_));
  aoi22  g38(.a(new_n53_), .b(x0), .c(new_n33_), .d(x2), .O(new_n54_));
  nand2  g39(.a(x4), .b(new_n17_), .O(new_n55_));
  nand4  g40(.a(new_n55_), .b(new_n21_), .c(x1), .d(new_n20_), .O(new_n56_));
