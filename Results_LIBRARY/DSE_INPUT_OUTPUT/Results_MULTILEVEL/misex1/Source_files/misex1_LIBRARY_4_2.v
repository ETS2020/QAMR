...
module FAU ( 
  ...
  oai21  g19(.a(new_n34_), .b(x0), .c(new_n19_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n31_), .O(z2));
  oai21  g21(.a(x4), .b(x3), .c(x7), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n24_), .c(x1), .O(new_n38_));
  nand4  g23(.a(new_n21_), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n38_), .c(x0), .O(z3));
  oai21  g25(.a(x2), .b(x0), .c(new_n19_), .O(new_n41_));
  aoi21  g26(.a(x3), .b(new_n19_), .c(x2), .O(new_n42_));
  ...
  nand3  g32(.a(x6), .b(new_n20_), .c(new_n24_), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n47_), .c(new_n43_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n16_), .O(new_n50_));
  oai21  g35(.a(new_n21_), .b(new_n24_), .c(new_n16_), .O(new_n51_));
  ...
  aoi21  g40(.a(new_n55_), .b(new_n39_), .c(x0), .O(z6));
endmodule
