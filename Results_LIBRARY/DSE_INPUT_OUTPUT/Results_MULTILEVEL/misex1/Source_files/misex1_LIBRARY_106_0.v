...
module FAU ( 
  ...
  oai22  g19(.a(new_n34_), .b(new_n33_), .c(new_n32_), .d(new_n23_), .O(z1));
  aoi21  g20(.a(x4), .b(new_n27_), .c(x3), .O(new_n36_));
  nor2   g21(.a(x5), .b(x3), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(x2), .c(new_n18_), .O(new_n38_));
  oai21  g23(.a(new_n36_), .b(new_n18_), .c(new_n38_), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n16_), .c(new_n31_), .O(new_n40_));
  ...
  nand4  g30(.a(new_n45_), .b(new_n27_), .c(x1), .d(new_n16_), .O(new_n46_));
  ...
  nand2  g34(.a(x3), .b(new_n27_), .O(new_n50_));
  ...
  aoi21  g41(.a(new_n56_), .b(new_n53_), .c(new_n23_), .O(z4));
