...
module FAU ( 
  ...
  oai21  g19(.a(new_n24_), .b(x1), .c(new_n34_), .O(z3));
  aoi21  g20(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n36_));
  nor2   g21(.a(x3), .b(x2), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(new_n36_), .c(new_n16_), .O(new_n38_));
  nand4  g23(.a(x3), .b(new_n24_), .c(new_n19_), .d(x0), .O(new_n39_));
  ...
  oai21  g29(.a(x4), .b(x2), .c(new_n20_), .O(new_n45_));
