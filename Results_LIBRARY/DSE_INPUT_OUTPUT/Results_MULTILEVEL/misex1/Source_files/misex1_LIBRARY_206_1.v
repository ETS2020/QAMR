...
module FAU ( 
  ...
  oai21  g19(.a(new_n25_), .b(x1), .c(new_n34_), .O(z3));
  ...
  aoi21  g28(.a(x3), .b(x0), .c(x2), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(x1), .c(new_n43_), .O(z5));
  oai21  g30(.a(x4), .b(x2), .c(new_n27_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(x1), .c(new_n16_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n31_), .O(z6));
endmodule
