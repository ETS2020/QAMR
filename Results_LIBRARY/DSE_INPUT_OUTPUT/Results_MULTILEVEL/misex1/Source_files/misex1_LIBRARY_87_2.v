...
module FAU ( 
  ...
  nor2   g29(.a(new_n20_), .b(x0), .O(new_n45_));
  ...
  nand4  g35(.a(new_n45_), .b(new_n50_), .c(new_n21_), .d(new_n26_), .O(new_n51_));
  ...
  aoi21  g44(.a(new_n53_), .b(new_n32_), .c(new_n18_), .O(new_n60_));
  ...
  nand2  g50(.a(new_n16_), .b(new_n50_), .O(new_n66_));
  ...
  nand3  g54(.a(new_n69_), .b(new_n62_), .c(new_n17_), .O(z5));
  nand3  g55(.a(new_n27_), .b(new_n21_), .c(x2), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n60_), .c(new_n20_), .O(new_n73_));
  or2    g58(.a(new_n65_), .b(x0), .O(new_n74_));
