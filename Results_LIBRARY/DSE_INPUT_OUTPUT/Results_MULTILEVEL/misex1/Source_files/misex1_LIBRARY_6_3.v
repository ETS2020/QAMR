...
module FAU ( 
  ...
  nand3  g14(.a(new_n16_), .b(new_n27_), .c(x1), .O(new_n30_));
  inv1   g15(.a(new_n30_), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(new_n29_), .c(new_n25_), .O(new_n32_));
  nand2  g17(.a(x3), .b(new_n27_), .O(new_n33_));
  ...
  nand3  g28(.a(new_n43_), .b(new_n22_), .c(new_n20_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n38_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n25_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n34_), .O(z2));
  nand2  g32(.a(x5), .b(new_n25_), .O(new_n48_));
  nand4  g33(.a(new_n48_), .b(new_n22_), .c(x2), .d(new_n20_), .O(new_n49_));
  nand4  g34(.a(new_n16_), .b(new_n27_), .c(x1), .d(new_n25_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n49_), .O(z3));
  aoi21  g36(.a(new_n33_), .b(new_n23_), .c(new_n25_), .O(new_n52_));
  nand2  g37(.a(new_n33_), .b(new_n25_), .O(new_n53_));
  nand3  g38(.a(new_n39_), .b(new_n22_), .c(x2), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n52_), .c(new_n20_), .O(new_n56_));
  nand2  g41(.a(new_n30_), .b(new_n17_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n25_), .O(new_n58_));
  nand2  g43(.a(x7), .b(x1), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n58_), .c(new_n56_), .O(z4));
  nor3   g45(.a(new_n39_), .b(new_n27_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n52_), .c(new_n20_), .O(new_n62_));
  nand2  g47(.a(new_n23_), .b(x1), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n28_), .c(new_n17_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n25_), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n62_), .c(new_n59_), .O(z5));
  inv1   g51(.a(new_n54_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n52_), .c(new_n20_), .O(new_n68_));
  nor2   g53(.a(x4), .b(x2), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(x3), .c(new_n25_), .O(new_n70_));
