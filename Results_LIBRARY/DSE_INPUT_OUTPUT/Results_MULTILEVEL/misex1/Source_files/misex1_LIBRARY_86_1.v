...
module FAU ( 
  ...
  nand3  g14(.a(new_n29_), .b(new_n24_), .c(new_n26_), .O(new_n30_));
  oai21  g15(.a(x7), .b(new_n19_), .c(new_n23_), .O(new_n31_));
  ...
  aoi21  g19(.a(new_n34_), .b(new_n19_), .c(new_n18_), .O(new_n35_));
  ...
  aoi21  g24(.a(new_n39_), .b(new_n18_), .c(new_n35_), .O(new_n40_));
  nor2   g25(.a(x1), .b(new_n16_), .O(new_n41_));
  nand2  g26(.a(x3), .b(new_n26_), .O(new_n42_));
  inv1   g27(.a(new_n42_), .O(new_n43_));
  aoi22  g28(.a(new_n43_), .b(new_n41_), .c(x7), .d(new_n23_), .O(new_n44_));
  oai21  g29(.a(new_n40_), .b(x0), .c(new_n44_), .O(z2));
  oai21  g30(.a(x4), .b(x3), .c(x7), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n26_), .c(x1), .d(new_n16_), .O(new_n47_));
  ...
  oai21  g36(.a(new_n42_), .b(new_n16_), .c(new_n51_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n18_), .O(new_n53_));
  aoi21  g38(.a(x3), .b(new_n18_), .c(x2), .O(new_n54_));
  nor2   g39(.a(new_n19_), .b(new_n26_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n54_), .c(new_n16_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n53_), .c(new_n24_), .O(z4));
  aoi21  g42(.a(new_n51_), .b(new_n42_), .c(new_n16_), .O(new_n58_));
