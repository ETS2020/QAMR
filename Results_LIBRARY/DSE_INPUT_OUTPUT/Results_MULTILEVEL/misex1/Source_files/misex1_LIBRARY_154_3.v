...
module FAU ( 
  ...
  aoi21  g07(.a(new_n22_), .b(new_n21_), .c(new_n17_), .O(new_n23_));
  inv1   g08(.a(x6), .O(new_n24_));
  oai21  g09(.a(new_n24_), .b(x3), .c(new_n20_), .O(new_n25_));
  aoi22  g10(.a(new_n25_), .b(new_n17_), .c(new_n23_), .d(new_n20_), .O(new_n26_));
  nand4  g11(.a(x3), .b(new_n17_), .c(new_n20_), .d(x0), .O(new_n27_));
  oai21  g12(.a(new_n26_), .b(x0), .c(new_n27_), .O(z1));
  nand2  g13(.a(x4), .b(new_n17_), .O(new_n29_));
  aoi21  g14(.a(new_n29_), .b(new_n21_), .c(new_n20_), .O(new_n30_));
  nand2  g15(.a(new_n22_), .b(x2), .O(new_n31_));
  nand2  g16(.a(new_n24_), .b(new_n17_), .O(new_n32_));
  aoi21  g17(.a(new_n32_), .b(new_n31_), .c(x3), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n20_), .c(new_n30_), .O(new_n34_));
  oai21  g19(.a(new_n34_), .b(x0), .c(new_n27_), .O(z2));
  oai21  g20(.a(x4), .b(x3), .c(x7), .O(new_n36_));
  nand3  g21(.a(new_n36_), .b(new_n17_), .c(x1), .O(new_n37_));
  nand4  g22(.a(new_n22_), .b(new_n21_), .c(x2), .d(new_n20_), .O(new_n38_));
  ...
  oai21  g27(.a(x3), .b(new_n20_), .c(x2), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n42_), .c(new_n41_), .O(z4));
  oai21  g29(.a(new_n21_), .b(x1), .c(new_n17_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(x0), .O(new_n46_));
  aoi21  g31(.a(new_n21_), .b(x2), .c(new_n20_), .O(new_n47_));
  nand3  g32(.a(x6), .b(new_n21_), .c(new_n17_), .O(new_n48_));
