...
module FAU ( 
  ...
  oai21  g09(.a(x4), .b(new_n18_), .c(x1), .O(new_n25_));
  ...
  aoi21  g19(.a(new_n34_), .b(new_n33_), .c(new_n17_), .O(new_n35_));
  ...
  nand3  g36(.a(new_n51_), .b(new_n49_), .c(new_n47_), .O(z3));
  ...
  aoi21  g42(.a(x3), .b(new_n17_), .c(x2), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n57_), .c(new_n20_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n56_), .c(new_n47_), .O(z4));
  nand2  g45(.a(new_n22_), .b(new_n16_), .O(new_n61_));
  aoi21  g46(.a(new_n54_), .b(new_n61_), .c(new_n20_), .O(new_n62_));
  ...
  nand2  g50(.a(new_n18_), .b(new_n16_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n21_), .c(new_n17_), .O(new_n67_));
  nand2  g52(.a(new_n22_), .b(x2), .O(new_n68_));
  oai21  g53(.a(new_n26_), .b(x2), .c(new_n68_), .O(new_n69_));
  ...
  nand3  g59(.a(new_n46_), .b(new_n18_), .c(new_n16_), .O(new_n75_));
