...
module FAU ( 
  ...
  nand4  g41(.a(new_n51_), .b(x6), .c(x1), .d(new_n20_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n56_), .O(z4));
  nor3   g43(.a(new_n34_), .b(new_n16_), .c(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n52_), .c(new_n17_), .O(new_n60_));
  nand2  g45(.a(new_n51_), .b(x1), .O(new_n61_));
  nand2  g46(.a(x3), .b(x2), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n61_), .c(new_n26_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n20_), .O(new_n64_));
  nand2  g49(.a(new_n36_), .b(x1), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n64_), .c(new_n60_), .O(z5));
