...
module FAU ( 
  ...
  nor2   g29(.a(new_n24_), .b(new_n19_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n32_), .c(new_n23_), .O(new_n46_));
  ...
  aoi21  g46(.a(new_n61_), .b(new_n53_), .c(new_n16_), .O(new_n62_));
