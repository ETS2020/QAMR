...
module FAU ( 
  ...
  nand3  g14(.a(new_n29_), .b(new_n18_), .c(new_n21_), .O(new_n30_));
  oai21  g15(.a(new_n18_), .b(new_n21_), .c(new_n30_), .O(new_n31_));
  ...
  nand3  g24(.a(new_n39_), .b(new_n36_), .c(new_n32_), .O(z2));
  oai21  g25(.a(x4), .b(x3), .c(x7), .O(new_n41_));
  aoi21  g26(.a(new_n41_), .b(new_n21_), .c(x2), .O(new_n42_));
  nand2  g27(.a(x5), .b(new_n21_), .O(new_n43_));
  nand4  g28(.a(new_n43_), .b(new_n18_), .c(x2), .d(new_n16_), .O(new_n44_));
  ...
  nand2  g36(.a(new_n46_), .b(x0), .O(new_n52_));
  nand3  g37(.a(new_n34_), .b(x2), .c(new_n21_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n16_), .O(new_n55_));
  oai21  g40(.a(new_n29_), .b(x3), .c(new_n16_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n17_), .c(new_n21_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n55_), .O(z5));
  nand3  g43(.a(x3), .b(new_n17_), .c(new_n16_), .O(new_n59_));
  oai21  g44(.a(x3), .b(new_n17_), .c(new_n59_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(x0), .O(new_n61_));
  nor2   g46(.a(new_n37_), .b(x3), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(x0), .c(new_n17_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(x1), .O(new_n64_));
  nand2  g49(.a(new_n23_), .b(x2), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n64_), .c(new_n61_), .O(z6));
endmodule
