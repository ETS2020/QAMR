...
module FAU ( 
  ...
  aoi21  g19(.a(new_n34_), .b(x1), .c(x2), .O(new_n35_));
  nand3  g20(.a(new_n18_), .b(new_n16_), .c(x2), .O(new_n36_));
  oai21  g21(.a(new_n35_), .b(x0), .c(new_n36_), .O(z3));
  xor2a  g22(.a(x3), .b(x2), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n21_), .c(x0), .O(new_n39_));
  nand2  g24(.a(x3), .b(new_n21_), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n22_), .c(new_n17_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n39_), .O(z4));
  nand2  g27(.a(new_n39_), .b(new_n25_), .O(z5));
  nand2  g28(.a(x4), .b(new_n16_), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n22_), .c(x1), .d(new_n17_), .O(new_n45_));
