...
module FAU ( 
  ...
  nand2  g07(.a(x7), .b(x5), .O(new_n23_));
  nand2  g08(.a(new_n23_), .b(new_n22_), .O(z0));
  inv1   g09(.a(x2), .O(new_n25_));
  aoi21  g10(.a(x6), .b(new_n19_), .c(x1), .O(new_n26_));
  ...
  nand2  g21(.a(new_n30_), .b(x2), .O(new_n37_));
  ...
  aoi22  g29(.a(new_n44_), .b(new_n42_), .c(x7), .d(x5), .O(new_n45_));
  oai21  g30(.a(new_n41_), .b(x0), .c(new_n45_), .O(z2));
  oai21  g31(.a(x4), .b(x3), .c(x7), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(new_n25_), .c(x1), .d(new_n16_), .O(new_n48_));
  ...
  nor2   g40(.a(new_n19_), .b(new_n25_), .O(new_n56_));
  ...
  nand3  g49(.a(x6), .b(new_n19_), .c(new_n25_), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n64_), .c(new_n63_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n16_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n62_), .c(new_n23_), .O(z5));
  nand3  g53(.a(new_n30_), .b(new_n19_), .c(x2), .O(new_n69_));
  ...
  nand3  g58(.a(new_n73_), .b(new_n71_), .c(new_n23_), .O(z6));
endmodule
