...
module FAU ( 
  ...
  aoi22  g18(.a(new_n33_), .b(new_n31_), .c(x6), .d(x4), .O(new_n34_));
  ...
  aoi21  g25(.a(new_n40_), .b(new_n19_), .c(new_n37_), .O(new_n41_));
  ...
  aoi21  g44(.a(new_n53_), .b(new_n32_), .c(new_n17_), .O(new_n60_));
  nor3   g45(.a(new_n26_), .b(new_n25_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n60_), .c(new_n19_), .O(new_n62_));
  inv1   g47(.a(new_n57_), .O(new_n63_));
  nand2  g48(.a(new_n53_), .b(x1), .O(new_n64_));
  nand3  g49(.a(x6), .b(new_n20_), .c(new_n25_), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n64_), .c(new_n63_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n17_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n62_), .c(new_n16_), .O(z5));
  nand3  g53(.a(new_n26_), .b(new_n20_), .c(x2), .O(new_n69_));
  ...
  nand3  g58(.a(new_n73_), .b(new_n71_), .c(new_n16_), .O(z6));
endmodule
