...
module FAU ( 
  ...
  nand3  g20(.a(new_n35_), .b(x1), .c(new_n17_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n34_), .O(z4));
  oai21  g22(.a(x4), .b(x2), .c(new_n20_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(x1), .c(new_n17_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n34_), .O(z6));
  nand2  g25(.a(new_n36_), .b(new_n34_), .O(z5));
endmodule
