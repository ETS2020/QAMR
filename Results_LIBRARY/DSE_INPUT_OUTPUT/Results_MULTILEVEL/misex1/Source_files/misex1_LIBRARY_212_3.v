...
module FAU ( 
  ...
  oai21  g11(.a(new_n23_), .b(x0), .c(new_n26_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n22_), .O(new_n28_));
  inv1   g13(.a(x6), .O(new_n29_));
  oai21  g14(.a(new_n29_), .b(x3), .c(new_n22_), .O(new_n30_));
  nand3  g15(.a(new_n30_), .b(new_n16_), .c(new_n17_), .O(new_n31_));
  nand2  g16(.a(x7), .b(x2), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n31_), .c(new_n28_), .O(z1));
  nand2  g18(.a(new_n29_), .b(new_n16_), .O(new_n34_));
  ...
  nand3  g23(.a(new_n38_), .b(new_n24_), .c(new_n22_), .O(new_n39_));
  inv1   g24(.a(x4), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n24_), .c(x2), .O(new_n41_));
  nor2   g26(.a(x7), .b(new_n24_), .O(new_n42_));
  ...
  nand3  g30(.a(new_n25_), .b(new_n22_), .c(x0), .O(new_n46_));
  ...
  aoi21  g34(.a(x5), .b(new_n17_), .c(x7), .O(new_n50_));
  nand4  g35(.a(new_n50_), .b(new_n24_), .c(x2), .d(new_n22_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n49_), .O(z3));
  nand3  g37(.a(new_n36_), .b(new_n24_), .c(x2), .O(new_n53_));
  ...
  nand2  g45(.a(x3), .b(new_n16_), .O(new_n61_));
  nand2  g46(.a(new_n24_), .b(x2), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n61_), .c(new_n17_), .O(new_n63_));
  nor3   g48(.a(new_n35_), .b(new_n16_), .c(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n63_), .c(new_n22_), .O(new_n65_));
  nand2  g50(.a(new_n62_), .b(x1), .O(new_n66_));
  nand2  g51(.a(x3), .b(x2), .O(new_n67_));
  nand3  g52(.a(x6), .b(new_n24_), .c(new_n16_), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n17_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n65_), .c(new_n32_), .O(z5));
  nand3  g56(.a(new_n35_), .b(new_n24_), .c(x2), .O(new_n72_));
  inv1   g57(.a(new_n72_), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(new_n63_), .c(new_n22_), .O(new_n74_));
  oai21  g59(.a(x4), .b(x2), .c(new_n24_), .O(new_n75_));
  nand3  g60(.a(new_n75_), .b(x1), .c(new_n17_), .O(new_n76_));
  nand3  g61(.a(new_n76_), .b(new_n74_), .c(new_n32_), .O(z6));
endmodule
