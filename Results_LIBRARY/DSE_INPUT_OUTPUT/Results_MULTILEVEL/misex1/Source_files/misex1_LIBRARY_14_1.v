...
module FAU ( 
  ...
  nand4  g30(.a(new_n31_), .b(new_n35_), .c(x3), .d(new_n23_), .O(new_n46_));
  ...
  nand4  g34(.a(new_n35_), .b(new_n23_), .c(x1), .d(new_n16_), .O(new_n50_));
  ...
  aoi21  g40(.a(new_n35_), .b(x1), .c(new_n19_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x2), .c(new_n43_), .O(new_n57_));
  ...
  nand3  g49(.a(new_n64_), .b(new_n63_), .c(new_n43_), .O(new_n65_));
