...
module FAU ( 
  ...
  nor2   g19(.a(x3), .b(new_n32_), .O(new_n35_));
  ...
  nand3  g25(.a(new_n40_), .b(new_n32_), .c(new_n20_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n39_), .O(z4));
  nand3  g27(.a(x3), .b(new_n32_), .c(x0), .O(new_n43_));
  inv1   g28(.a(new_n43_), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(new_n35_), .c(new_n16_), .O(new_n45_));
  nand3  g30(.a(new_n21_), .b(new_n32_), .c(new_n16_), .O(new_n46_));
