...
module FAU ( 
  ...
  nand2  g14(.a(new_n29_), .b(x6), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n16_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n28_), .O(z1));
  inv1   g17(.a(x4), .O(new_n33_));
  oai21  g18(.a(new_n33_), .b(x2), .c(new_n20_), .O(new_n34_));
  nor2   g19(.a(new_n16_), .b(x1), .O(new_n35_));
  aoi22  g20(.a(new_n35_), .b(new_n26_), .c(new_n34_), .d(x1), .O(new_n36_));
  ...
  nand4  g30(.a(x6), .b(x3), .c(new_n16_), .d(x0), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n19_), .O(new_n48_));
  inv1   g33(.a(x6), .O(new_n49_));
  aoi21  g34(.a(x3), .b(new_n19_), .c(new_n49_), .O(new_n50_));
  nor2   g35(.a(new_n20_), .b(new_n16_), .O(new_n51_));
  aoi21  g36(.a(new_n50_), .b(new_n16_), .c(new_n51_), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(x0), .c(new_n48_), .O(z4));
  nand3  g38(.a(x6), .b(x3), .c(new_n16_), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n45_), .c(new_n17_), .O(new_n55_));
  ...
  aoi21  g46(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n51_), .c(new_n17_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n58_), .O(z5));
  nand2  g49(.a(new_n26_), .b(x2), .O(new_n65_));
  inv1   g50(.a(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n55_), .c(new_n19_), .O(new_n67_));
  nand3  g52(.a(x6), .b(new_n33_), .c(new_n16_), .O(new_n68_));
