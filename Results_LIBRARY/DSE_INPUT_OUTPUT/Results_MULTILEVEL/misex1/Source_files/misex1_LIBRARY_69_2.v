...
module FAU ( 
  ...
  nand3  g39(.a(x7), .b(x3), .c(x2), .O(new_n55_));
  ...
  nand4  g44(.a(x7), .b(x5), .c(x2), .d(new_n17_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n23_), .O(new_n62_));
  nand2  g47(.a(x7), .b(x3), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(x2), .c(new_n23_), .O(new_n64_));
  ...
  oai21  g55(.a(new_n70_), .b(new_n59_), .c(new_n23_), .O(new_n71_));
