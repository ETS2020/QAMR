...
module FAU ( 
  ...
  nand3  g19(.a(new_n25_), .b(new_n16_), .c(x2), .O(new_n35_));
  ...
  aoi21  g24(.a(new_n16_), .b(new_n20_), .c(x2), .O(new_n40_));
  nor2   g25(.a(x4), .b(new_n20_), .O(new_n41_));
  ...
  nand4  g31(.a(new_n46_), .b(new_n32_), .c(x1), .d(new_n17_), .O(new_n47_));
  ...
  nand2  g35(.a(x3), .b(new_n32_), .O(new_n51_));
  ...
  oai21  g50(.a(new_n29_), .b(x2), .c(new_n65_), .O(new_n66_));
  ...
  aoi21  g55(.a(new_n70_), .b(new_n51_), .c(new_n17_), .O(new_n71_));
  nand4  g56(.a(new_n25_), .b(new_n16_), .c(new_n20_), .d(x2), .O(new_n72_));
  inv1   g57(.a(new_n72_), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(new_n71_), .c(new_n19_), .O(new_n74_));
  oai21  g59(.a(new_n16_), .b(x3), .c(new_n32_), .O(new_n75_));
  nand2  g60(.a(new_n75_), .b(new_n63_), .O(new_n76_));
