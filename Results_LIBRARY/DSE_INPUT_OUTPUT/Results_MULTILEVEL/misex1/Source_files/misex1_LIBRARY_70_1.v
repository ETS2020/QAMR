...
module FAU ( 
  ...
  nand4  g10(.a(x3), .b(new_n22_), .c(new_n16_), .d(x0), .O(new_n26_));
  ...
  aoi22  g25(.a(new_n40_), .b(x0), .c(new_n32_), .d(x2), .O(new_n41_));
  nand3  g26(.a(x3), .b(new_n22_), .c(new_n16_), .O(new_n42_));
