...
module FAU ( 
  ...
  nand3  g03(.a(new_n18_), .b(x1), .c(new_n16_), .O(new_n19_));
  ...
  oai21  g12(.a(new_n27_), .b(new_n24_), .c(new_n21_), .O(new_n28_));
  nand3  g13(.a(new_n22_), .b(x1), .c(new_n16_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n28_), .O(z1));
  inv1   g15(.a(x4), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(x2), .c(new_n25_), .O(new_n32_));
  ...
  nand3  g23(.a(new_n38_), .b(new_n25_), .c(new_n21_), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n33_), .c(x0), .O(z2));
  oai21  g25(.a(x4), .b(x3), .c(x7), .O(new_n41_));
  nand4  g26(.a(new_n41_), .b(new_n22_), .c(x1), .d(new_n16_), .O(new_n42_));
  aoi21  g27(.a(new_n23_), .b(x2), .c(x0), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(x1), .c(new_n42_), .O(z3));
  oai21  g29(.a(x2), .b(x0), .c(new_n21_), .O(new_n45_));
  aoi21  g30(.a(x3), .b(new_n21_), .c(x2), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n18_), .c(new_n16_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n45_), .O(z4));
  oai21  g33(.a(x3), .b(new_n22_), .c(x1), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n26_), .c(new_n17_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n16_), .O(new_n51_));
  oai21  g36(.a(new_n34_), .b(new_n22_), .c(new_n16_), .O(new_n52_));
  ...
  nand3  g41(.a(new_n23_), .b(x2), .c(new_n21_), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n56_), .c(x0), .O(z6));
endmodule
