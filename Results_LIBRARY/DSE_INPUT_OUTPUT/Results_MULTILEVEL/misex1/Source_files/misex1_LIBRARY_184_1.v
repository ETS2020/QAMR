...
module FAU ( 
  ...
  oai22  g20(.a(new_n35_), .b(x1), .c(new_n34_), .d(x0), .O(z3));
  nand2  g21(.a(x3), .b(new_n16_), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(new_n21_), .c(new_n35_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n17_), .O(new_n39_));
  oai21  g24(.a(new_n37_), .b(x1), .c(new_n21_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n39_), .O(z4));
  nand2  g26(.a(new_n37_), .b(new_n35_), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n17_), .c(x0), .O(new_n43_));
  nand3  g28(.a(new_n22_), .b(new_n16_), .c(new_n17_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n21_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n43_), .O(z5));
  nand2  g31(.a(x4), .b(new_n18_), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(new_n16_), .c(x1), .d(new_n21_), .O(new_n48_));
