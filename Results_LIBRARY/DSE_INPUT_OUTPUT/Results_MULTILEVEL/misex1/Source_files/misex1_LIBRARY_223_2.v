...
module FAU ( 
  ...
  nand3  g22(.a(new_n37_), .b(new_n35_), .c(new_n18_), .O(new_n38_));
  ...
  nand3  g27(.a(new_n42_), .b(new_n32_), .c(new_n17_), .O(z3));
  oai21  g28(.a(new_n26_), .b(new_n21_), .c(new_n22_), .O(new_n44_));
  oai21  g29(.a(x1), .b(x0), .c(new_n26_), .O(new_n45_));
  nand3  g30(.a(x3), .b(x2), .c(new_n18_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n45_), .c(new_n44_), .O(z4));
  nor2   g32(.a(new_n22_), .b(x0), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n26_), .c(x1), .O(new_n49_));
  ...
  nand3  g40(.a(new_n55_), .b(new_n32_), .c(new_n17_), .O(z6));
endmodule
