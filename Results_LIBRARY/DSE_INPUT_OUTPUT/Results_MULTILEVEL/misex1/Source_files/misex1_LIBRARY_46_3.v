...
module FAU ( 
  ...
  nand3  g15(.a(new_n30_), .b(new_n17_), .c(new_n23_), .O(new_n31_));
  oai21  g16(.a(new_n17_), .b(new_n23_), .c(new_n31_), .O(new_n32_));
  ...
  nand4  g27(.a(new_n42_), .b(new_n20_), .c(x1), .d(new_n23_), .O(new_n43_));
  ...
  nand2  g33(.a(x3), .b(new_n20_), .O(new_n49_));
  ...
  nand3  g41(.a(new_n56_), .b(new_n20_), .c(new_n23_), .O(new_n57_));
  ...
  oai21  g48(.a(new_n63_), .b(x0), .c(new_n20_), .O(new_n64_));
