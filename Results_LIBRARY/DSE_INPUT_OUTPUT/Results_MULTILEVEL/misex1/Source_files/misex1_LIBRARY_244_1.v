...
module FAU ( 
  ...
  aoi22  g41(.a(new_n56_), .b(new_n53_), .c(x6), .d(new_n16_), .O(z4));
  xor2a  g42(.a(x3), .b(x2), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n20_), .c(x0), .O(new_n59_));
  nand3  g44(.a(new_n51_), .b(x1), .c(new_n18_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n30_), .b(x3), .O(new_n63_));
  nand2  g48(.a(x5), .b(new_n20_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n63_), .c(new_n26_), .O(new_n65_));
  nand4  g50(.a(x6), .b(x5), .c(new_n21_), .d(new_n26_), .O(new_n66_));
  ...
  nand2  g56(.a(new_n71_), .b(new_n59_), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n17_), .O(new_n73_));
  nor2   g58(.a(x6), .b(x5), .O(new_n74_));
  nand4  g59(.a(new_n74_), .b(new_n21_), .c(x2), .d(new_n20_), .O(new_n75_));
