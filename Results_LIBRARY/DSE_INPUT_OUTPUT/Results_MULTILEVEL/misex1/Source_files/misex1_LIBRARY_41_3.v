...
module FAU ( 
  ...
  aoi21  g04(.a(new_n19_), .b(x0), .c(x6), .O(new_n20_));
  ...
  oai21  g12(.a(new_n23_), .b(x3), .c(new_n22_), .O(new_n28_));
  ...
  aoi21  g22(.a(new_n37_), .b(new_n24_), .c(new_n22_), .O(new_n38_));
  nand2  g23(.a(new_n25_), .b(x2), .O(new_n39_));
  nand2  g24(.a(new_n23_), .b(new_n16_), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n39_), .c(x3), .O(new_n41_));
  aoi21  g26(.a(new_n41_), .b(new_n22_), .c(new_n38_), .O(new_n42_));
  aoi22  g27(.a(new_n34_), .b(new_n32_), .c(x6), .d(x2), .O(new_n43_));
  ...
  aoi21  g31(.a(x5), .b(new_n17_), .c(x6), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(new_n24_), .c(x2), .d(new_n22_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n46_), .O(z3));
  nand2  g34(.a(new_n24_), .b(x2), .O(new_n50_));
  oai21  g35(.a(new_n33_), .b(new_n17_), .c(new_n50_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n22_), .O(new_n52_));
  oai21  g37(.a(new_n24_), .b(x0), .c(new_n23_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(x2), .O(new_n54_));
  nand2  g39(.a(x3), .b(new_n22_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n16_), .c(new_n17_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n54_), .c(new_n52_), .O(z4));
  nand3  g42(.a(new_n23_), .b(new_n24_), .c(x2), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n33_), .c(new_n17_), .O(new_n59_));
  nand4  g44(.a(new_n23_), .b(x5), .c(new_n24_), .d(x2), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n22_), .O(new_n62_));
  nand2  g47(.a(new_n23_), .b(x3), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(x2), .c(new_n22_), .O(new_n64_));
  nand3  g49(.a(x6), .b(new_n24_), .c(new_n16_), .O(new_n65_));
  oai21  g50(.a(new_n63_), .b(new_n16_), .c(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n64_), .c(new_n17_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n62_), .O(z5));
  nand4  g53(.a(new_n23_), .b(new_n25_), .c(new_n24_), .d(x2), .O(new_n69_));
  inv1   g54(.a(new_n69_), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n59_), .c(new_n22_), .O(new_n71_));
