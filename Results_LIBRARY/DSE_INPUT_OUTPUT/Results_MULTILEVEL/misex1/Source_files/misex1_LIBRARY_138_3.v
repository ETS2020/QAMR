...
module FAU ( 
  ...
  oai21  g12(.a(new_n27_), .b(new_n17_), .c(new_n26_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n25_), .O(new_n29_));
  oai21  g14(.a(x5), .b(x3), .c(x2), .O(new_n30_));
  oai22  g15(.a(new_n30_), .b(x1), .c(new_n16_), .d(x3), .O(new_n31_));
  ...
  nand3  g41(.a(new_n27_), .b(new_n25_), .c(new_n17_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(z4));
  nand3  g43(.a(new_n16_), .b(new_n20_), .c(x2), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n43_), .c(new_n17_), .O(new_n60_));
  nand4  g45(.a(new_n16_), .b(x5), .c(new_n20_), .d(x2), .O(new_n61_));
  ...
  oai21  g51(.a(new_n64_), .b(new_n25_), .c(new_n66_), .O(new_n67_));
