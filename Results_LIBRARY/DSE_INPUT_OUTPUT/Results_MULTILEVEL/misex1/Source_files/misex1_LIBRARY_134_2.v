...
module FAU ( 
  ...
  oai21  g26(.a(new_n41_), .b(x1), .c(new_n40_), .O(z3));
  oai21  g27(.a(x2), .b(x0), .c(new_n19_), .O(new_n43_));
  aoi21  g28(.a(x3), .b(new_n19_), .c(x2), .O(new_n44_));
  nor2   g29(.a(new_n23_), .b(new_n20_), .O(new_n45_));
  ...
  oai21  g34(.a(new_n32_), .b(x1), .c(new_n23_), .O(new_n50_));
  ...
  nand3  g39(.a(new_n21_), .b(x2), .c(new_n19_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n54_), .c(x0), .O(z6));
endmodule
