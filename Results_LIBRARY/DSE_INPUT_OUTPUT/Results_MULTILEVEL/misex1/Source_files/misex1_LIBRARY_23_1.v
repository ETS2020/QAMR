...
module FAU ( 
  ...
  aoi21  g15(.a(new_n30_), .b(new_n17_), .c(x5), .O(new_n31_));
  ...
  aoi21  g22(.a(new_n37_), .b(new_n35_), .c(x5), .O(new_n38_));
  ...
  nand3  g28(.a(new_n23_), .b(x3), .c(new_n16_), .O(new_n44_));
  or2    g29(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  ...
  oai21  g34(.a(new_n47_), .b(x1), .c(new_n49_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n23_), .O(new_n51_));
  oai21  g36(.a(new_n47_), .b(new_n43_), .c(new_n51_), .O(z3));
  nand4  g37(.a(new_n23_), .b(x3), .c(new_n16_), .d(x0), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n47_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n19_), .O(new_n55_));
  aoi21  g40(.a(x3), .b(new_n19_), .c(x5), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n16_), .c(new_n39_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(x0), .c(new_n55_), .O(z4));
  aoi21  g43(.a(new_n47_), .b(new_n44_), .c(new_n17_), .O(new_n59_));
  nor3   g44(.a(new_n23_), .b(new_n16_), .c(x0), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n59_), .c(new_n19_), .O(new_n61_));
  nand3  g46(.a(new_n30_), .b(new_n23_), .c(new_n16_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n24_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n17_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n61_), .O(z5));
  nand2  g50(.a(x3), .b(new_n16_), .O(new_n66_));
  aoi21  g51(.a(new_n47_), .b(new_n66_), .c(new_n17_), .O(new_n67_));
  ...
  nand2  g57(.a(x5), .b(new_n16_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(new_n72_), .c(new_n70_), .O(z6));
endmodule
