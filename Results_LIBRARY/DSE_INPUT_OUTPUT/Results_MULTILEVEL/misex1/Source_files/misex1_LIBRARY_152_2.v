...
module FAU ( 
  ...
  nor3   g44(.a(new_n59_), .b(new_n16_), .c(x0), .O(new_n60_));
  ...
  nand3  g51(.a(new_n66_), .b(new_n61_), .c(new_n30_), .O(z5));
  nand3  g52(.a(new_n59_), .b(new_n32_), .c(x2), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n58_), .c(new_n23_), .O(new_n70_));
  oai21  g55(.a(x4), .b(x2), .c(new_n32_), .O(new_n71_));
  nand3  g56(.a(new_n71_), .b(x1), .c(new_n17_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(new_n70_), .c(new_n30_), .O(z6));
endmodule
