...
module FAU ( 
  ...
  oai21  g35(.a(x3), .b(new_n25_), .c(new_n26_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n18_), .O(new_n52_));
  oai21  g37(.a(new_n19_), .b(x0), .c(x6), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(x2), .O(new_n54_));
  nand2  g39(.a(x3), .b(new_n18_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n25_), .c(new_n16_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n54_), .c(new_n52_), .O(z4));
  nand3  g42(.a(x6), .b(new_n19_), .c(x2), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n41_), .c(new_n16_), .O(new_n59_));
  nand4  g44(.a(x6), .b(x5), .c(new_n19_), .d(x2), .O(new_n60_));
