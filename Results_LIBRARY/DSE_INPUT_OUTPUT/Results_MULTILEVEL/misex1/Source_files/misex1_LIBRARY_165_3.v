...
module FAU ( 
  ...
  nor2   g24(.a(new_n17_), .b(x0), .O(new_n40_));
  nor2   g25(.a(new_n26_), .b(x2), .O(new_n41_));
  ...
  oai21  g29(.a(new_n42_), .b(x1), .c(new_n44_), .O(z4));
  oai21  g30(.a(new_n26_), .b(x1), .c(new_n17_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(x0), .O(new_n47_));
  aoi21  g32(.a(new_n26_), .b(x2), .c(new_n20_), .O(new_n48_));
  nand3  g33(.a(x6), .b(new_n26_), .c(new_n17_), .O(new_n49_));
  inv1   g34(.a(new_n49_), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(new_n48_), .c(new_n16_), .O(new_n51_));
  oai21  g36(.a(new_n27_), .b(x1), .c(new_n26_), .O(new_n52_));
  ...
  nand2  g41(.a(new_n56_), .b(new_n35_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n16_), .O(new_n58_));
  nand3  g43(.a(new_n41_), .b(new_n20_), .c(x0), .O(new_n59_));
