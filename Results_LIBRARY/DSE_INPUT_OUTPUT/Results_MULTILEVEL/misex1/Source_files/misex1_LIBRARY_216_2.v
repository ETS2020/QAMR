...
module FAU ( 
  ...
  nand3  g25(.a(new_n40_), .b(new_n25_), .c(new_n23_), .O(new_n41_));
  nor2   g26(.a(x4), .b(x3), .O(new_n42_));
  nand2  g27(.a(x4), .b(x3), .O(new_n43_));
  ...
  nand3  g32(.a(new_n26_), .b(new_n23_), .c(x0), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n47_), .O(z2));
  oai22  g34(.a(x7), .b(x2), .c(x4), .d(x3), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(x1), .c(new_n17_), .O(new_n51_));
  aoi21  g36(.a(x5), .b(new_n17_), .c(x3), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n23_), .c(new_n19_), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n16_), .c(new_n51_), .O(z3));
  oai21  g39(.a(new_n42_), .b(new_n16_), .c(x1), .O(new_n55_));
  nand2  g40(.a(new_n25_), .b(new_n16_), .O(new_n56_));
  nand2  g41(.a(x3), .b(x2), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(new_n58_));
  ...
  nand3  g47(.a(new_n62_), .b(new_n59_), .c(new_n34_), .O(z4));
  nand2  g48(.a(x3), .b(new_n16_), .O(new_n64_));
  aoi21  g49(.a(new_n60_), .b(new_n64_), .c(new_n17_), .O(new_n65_));
  nor3   g50(.a(new_n36_), .b(new_n16_), .c(x0), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n65_), .c(new_n23_), .O(new_n67_));
  aoi21  g52(.a(new_n43_), .b(x2), .c(new_n23_), .O(new_n68_));
  oai21  g53(.a(new_n30_), .b(x2), .c(new_n57_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n68_), .c(new_n17_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n67_), .c(new_n34_), .O(z5));
  nand3  g56(.a(x4), .b(new_n25_), .c(x2), .O(new_n72_));
  aoi21  g57(.a(new_n72_), .b(new_n64_), .c(new_n17_), .O(new_n73_));
  nand4  g58(.a(new_n36_), .b(x4), .c(new_n25_), .d(x2), .O(new_n74_));
  inv1   g59(.a(new_n74_), .O(new_n75_));
  oai21  g60(.a(new_n75_), .b(new_n73_), .c(new_n23_), .O(new_n76_));
  oai21  g61(.a(new_n19_), .b(x3), .c(new_n16_), .O(new_n77_));
