...
module FAU ( 
  ...
  nand2  g18(.a(new_n26_), .b(new_n25_), .O(new_n34_));
  ...
  nand4  g24(.a(new_n22_), .b(new_n21_), .c(x2), .d(new_n16_), .O(new_n40_));
  ...
  oai21  g29(.a(new_n21_), .b(x1), .c(new_n25_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n44_), .c(x0), .O(z4));
  oai21  g31(.a(x3), .b(new_n25_), .c(x1), .O(new_n47_));
  oai21  g32(.a(new_n22_), .b(x1), .c(new_n21_), .O(new_n48_));
  nand3  g33(.a(x6), .b(new_n21_), .c(new_n25_), .O(new_n49_));
  inv1   g34(.a(new_n49_), .O(new_n50_));
  aoi21  g35(.a(new_n48_), .b(x2), .c(new_n50_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n47_), .c(x0), .O(z5));
