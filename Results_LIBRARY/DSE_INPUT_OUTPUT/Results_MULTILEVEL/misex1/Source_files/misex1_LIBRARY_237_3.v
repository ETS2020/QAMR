...
module FAU ( 
  ...
  oai21  g22(.a(new_n37_), .b(x0), .c(new_n16_), .O(new_n38_));
  ...
  nand3  g37(.a(new_n37_), .b(x2), .c(new_n21_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n16_), .O(new_n55_));
  nand2  g40(.a(new_n25_), .b(new_n21_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n55_), .O(z5));
  nor2   g42(.a(x5), .b(x3), .O(new_n58_));
  aoi22  g43(.a(new_n46_), .b(x0), .c(new_n58_), .d(x2), .O(new_n59_));
  nand2  g44(.a(x4), .b(new_n18_), .O(new_n60_));
  nand4  g45(.a(new_n60_), .b(new_n17_), .c(x1), .d(new_n21_), .O(new_n61_));
