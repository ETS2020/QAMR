...
module FAU ( 
  ...
  nand2  g18(.a(x4), .b(x2), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n33_), .c(new_n29_), .O(z1));
  inv1   g20(.a(x5), .O(new_n36_));
  nand3  g21(.a(new_n36_), .b(new_n16_), .c(x2), .O(new_n37_));
  nand2  g22(.a(new_n31_), .b(new_n30_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n20_), .c(new_n19_), .O(new_n40_));
  aoi21  g25(.a(new_n16_), .b(new_n20_), .c(x2), .O(new_n41_));
  ...
  nand4  g33(.a(new_n48_), .b(new_n30_), .c(x1), .d(new_n17_), .O(new_n49_));
  aoi21  g34(.a(x5), .b(new_n17_), .c(x4), .O(new_n50_));
  ...
  nand3  g51(.a(x6), .b(new_n20_), .c(new_n30_), .O(new_n67_));
  oai21  g52(.a(new_n20_), .b(new_n30_), .c(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n66_), .c(new_n17_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n64_), .c(new_n34_), .O(z5));
  nand2  g55(.a(x3), .b(new_n30_), .O(new_n71_));
  aoi21  g56(.a(new_n53_), .b(new_n71_), .c(new_n17_), .O(new_n72_));
  nand4  g57(.a(new_n36_), .b(new_n16_), .c(new_n20_), .d(x2), .O(new_n73_));
  inv1   g58(.a(new_n73_), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(new_n72_), .c(new_n19_), .O(new_n75_));
  oai21  g60(.a(new_n16_), .b(x3), .c(new_n30_), .O(new_n76_));
