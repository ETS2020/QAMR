...
module FAU ( 
  ...
  aoi21  g41(.a(new_n49_), .b(new_n40_), .c(new_n17_), .O(new_n57_));
  nor3   g42(.a(new_n23_), .b(new_n16_), .c(x0), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n57_), .c(new_n19_), .O(new_n59_));
  inv1   g44(.a(new_n54_), .O(new_n60_));
  nand3  g45(.a(new_n26_), .b(x7), .c(new_n16_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n17_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n59_), .O(z5));
  nand2  g49(.a(new_n45_), .b(new_n16_), .O(new_n65_));
  xnor2a g50(.a(x3), .b(x2), .O(new_n66_));
  nand3  g51(.a(new_n23_), .b(new_n20_), .c(x2), .O(new_n67_));
  oai21  g52(.a(new_n66_), .b(new_n17_), .c(new_n67_), .O(new_n68_));
  ...
  nand3  g56(.a(new_n71_), .b(new_n69_), .c(new_n65_), .O(z6));
endmodule
