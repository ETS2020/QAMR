...
module FAU ( 
  ...
  nand3  g14(.a(x6), .b(new_n21_), .c(new_n18_), .O(new_n30_));
  inv1   g15(.a(new_n30_), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(new_n29_), .c(new_n26_), .O(new_n32_));
  inv1   g17(.a(x5), .O(new_n33_));
  nand2  g18(.a(x6), .b(x3), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n33_), .O(new_n35_));
  nand4  g20(.a(new_n35_), .b(x2), .c(new_n20_), .d(new_n18_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n32_), .O(z1));
  inv1   g22(.a(x4), .O(new_n38_));
  oai21  g23(.a(new_n38_), .b(x2), .c(new_n21_), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(x1), .c(new_n18_), .O(new_n40_));
  nand4  g25(.a(x3), .b(new_n26_), .c(new_n20_), .d(x0), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n17_), .O(new_n43_));
  inv1   g28(.a(x6), .O(new_n44_));
  nor2   g29(.a(new_n44_), .b(x5), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(x2), .O(new_n46_));
  nand3  g31(.a(new_n44_), .b(x5), .c(new_n26_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand4  g33(.a(new_n48_), .b(new_n21_), .c(new_n20_), .d(new_n18_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n43_), .O(z2));
  oai21  g35(.a(x4), .b(x3), .c(x7), .O(new_n51_));
  nand4  g36(.a(new_n51_), .b(new_n26_), .c(x1), .d(new_n18_), .O(new_n52_));
  nand2  g37(.a(x5), .b(new_n18_), .O(new_n53_));
  nand4  g38(.a(new_n53_), .b(new_n21_), .c(x2), .d(new_n20_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n52_), .c(new_n17_), .O(z3));
  nand3  g40(.a(x3), .b(new_n26_), .c(x0), .O(new_n56_));
  oai21  g41(.a(x3), .b(new_n26_), .c(new_n56_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n20_), .O(new_n58_));
  aoi21  g43(.a(x3), .b(new_n20_), .c(x2), .O(new_n59_));
  nor2   g44(.a(new_n21_), .b(new_n26_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n59_), .c(new_n18_), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n58_), .c(new_n16_), .O(z4));
  xor2a  g47(.a(x3), .b(x2), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n20_), .c(x0), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n19_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n17_), .O(new_n66_));
  nand2  g51(.a(x6), .b(new_n21_), .O(new_n67_));
  aoi21  g52(.a(x6), .b(new_n38_), .c(x5), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n20_), .c(new_n67_), .O(new_n69_));
  nand2  g54(.a(x5), .b(new_n20_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n34_), .c(new_n26_), .O(new_n71_));
  aoi21  g56(.a(new_n69_), .b(new_n26_), .c(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(x0), .c(new_n66_), .O(z5));
  oai21  g58(.a(x4), .b(x2), .c(new_n21_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(x1), .c(new_n18_), .O(new_n75_));
  nand2  g60(.a(new_n75_), .b(new_n64_), .O(new_n76_));
  nand2  g61(.a(new_n76_), .b(new_n17_), .O(new_n77_));
  nand4  g62(.a(new_n45_), .b(new_n21_), .c(x2), .d(new_n20_), .O(new_n78_));
  nand2  g63(.a(new_n78_), .b(new_n77_), .O(z6));
endmodule
