...
module FAU ( 
  ...
  aoi21  g12(.a(new_n27_), .b(new_n26_), .c(x2), .O(z1));
  nor2   g13(.a(new_n19_), .b(x2), .O(new_n29_));
  oai21  g14(.a(new_n29_), .b(new_n16_), .c(new_n22_), .O(new_n30_));
  nand3  g15(.a(x4), .b(new_n18_), .c(x1), .O(new_n31_));
  ...
  nand4  g20(.a(new_n35_), .b(new_n18_), .c(x1), .d(new_n16_), .O(new_n36_));
  nand3  g21(.a(new_n23_), .b(new_n22_), .c(x0), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n36_), .O(z3));
  oai21  g23(.a(x3), .b(new_n18_), .c(new_n16_), .O(new_n39_));
  oai21  g24(.a(new_n29_), .b(new_n23_), .c(new_n22_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n39_), .O(z4));
  oai21  g26(.a(new_n17_), .b(new_n16_), .c(x3), .O(new_n42_));
  nand2  g27(.a(x4), .b(x1), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n18_), .c(new_n16_), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n42_), .c(new_n24_), .O(z6));
  nand2  g30(.a(new_n40_), .b(new_n39_), .O(z5));
endmodule
