...
module FAU ( 
  ...
  nand3  g31(.a(new_n22_), .b(new_n16_), .c(new_n17_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n21_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n43_), .O(z5));
  nand2  g34(.a(x4), .b(new_n18_), .O(new_n50_));
  nand4  g35(.a(new_n50_), .b(new_n16_), .c(x1), .d(new_n21_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n43_), .O(z6));
endmodule
