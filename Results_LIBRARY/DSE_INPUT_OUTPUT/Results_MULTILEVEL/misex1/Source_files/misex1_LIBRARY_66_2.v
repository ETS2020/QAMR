...
module FAU ( 
  ...
  aoi22  g11(.a(new_n26_), .b(x6), .c(new_n16_), .d(x1), .O(new_n27_));
  ...
  nand3  g19(.a(new_n34_), .b(new_n24_), .c(new_n28_), .O(new_n35_));
  ...
  nand4  g42(.a(x6), .b(x5), .c(x2), .d(new_n17_), .O(new_n58_));
  inv1   g43(.a(new_n58_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n57_), .c(new_n28_), .O(new_n60_));
  aoi21  g45(.a(new_n37_), .b(x2), .c(new_n28_), .O(new_n61_));
  ...
  nand4  g50(.a(x6), .b(new_n31_), .c(new_n24_), .d(x2), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n57_), .c(new_n28_), .O(new_n68_));
