...
module FAU ( 
  ...
  oai21  g28(.a(x3), .b(new_n20_), .c(x2), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n43_), .c(new_n42_), .O(z4));
  oai21  g30(.a(new_n28_), .b(x1), .c(new_n17_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(x0), .O(new_n47_));
  aoi21  g32(.a(new_n28_), .b(x2), .c(new_n20_), .O(new_n48_));
  nand3  g33(.a(x6), .b(new_n28_), .c(new_n17_), .O(new_n49_));
  ...
  nand3  g41(.a(new_n21_), .b(x2), .c(new_n20_), .O(new_n57_));
