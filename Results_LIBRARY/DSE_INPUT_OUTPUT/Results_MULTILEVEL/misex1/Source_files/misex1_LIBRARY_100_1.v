...
module FAU ( 
  ...
  aoi21  g16(.a(new_n31_), .b(x1), .c(x2), .O(new_n32_));
  nand2  g17(.a(new_n17_), .b(x2), .O(new_n33_));
  oai22  g18(.a(new_n33_), .b(x1), .c(new_n32_), .d(x0), .O(z3));
  inv1   g19(.a(x2), .O(new_n35_));
  nand2  g20(.a(x3), .b(new_n35_), .O(new_n36_));
  oai21  g21(.a(new_n36_), .b(new_n20_), .c(new_n33_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n16_), .O(new_n38_));
  oai21  g23(.a(new_n36_), .b(x1), .c(new_n20_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n38_), .O(z4));
  nand2  g25(.a(new_n36_), .b(new_n33_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n16_), .c(x0), .O(new_n42_));
  nand3  g27(.a(new_n22_), .b(new_n35_), .c(new_n20_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n42_), .O(z5));
  nand2  g29(.a(x4), .b(new_n17_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(x1), .c(x2), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(x0), .c(new_n42_), .O(z6));
endmodule
