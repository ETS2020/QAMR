...
module FAU ( 
  ...
  nand2  g31(.a(new_n21_), .b(new_n19_), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n46_), .c(new_n30_), .O(z4));
  ...
  nor2   g37(.a(x2), .b(new_n19_), .O(new_n53_));
  nand2  g38(.a(new_n43_), .b(new_n26_), .O(new_n54_));
  ...
  nand3  g44(.a(new_n44_), .b(x1), .c(new_n24_), .O(new_n60_));
