...
module FAU ( 
  ...
  nand2  g18(.a(new_n26_), .b(new_n18_), .O(new_n34_));
  ...
  nand4  g23(.a(new_n38_), .b(new_n18_), .c(x1), .d(new_n16_), .O(new_n39_));
  nand2  g24(.a(x5), .b(new_n16_), .O(new_n40_));
  nand4  g25(.a(new_n40_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n39_), .O(z3));
  oai21  g27(.a(new_n18_), .b(new_n17_), .c(new_n19_), .O(new_n43_));
  oai21  g28(.a(x1), .b(x0), .c(new_n18_), .O(new_n44_));
  ...
  oai21  g33(.a(new_n19_), .b(x0), .c(x2), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(x1), .O(new_n50_));
  oai21  g35(.a(new_n23_), .b(x1), .c(new_n19_), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(x2), .c(new_n16_), .O(new_n52_));
  nand3  g37(.a(x6), .b(new_n19_), .c(new_n18_), .O(new_n53_));
  nand4  g38(.a(new_n53_), .b(new_n52_), .c(new_n50_), .d(new_n48_), .O(z5));
  oai21  g39(.a(x4), .b(x2), .c(new_n19_), .O(new_n55_));
