...
module FAU ( 
  ...
  oai21  g28(.a(new_n17_), .b(x0), .c(new_n43_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n23_), .O(new_n45_));
  oai21  g30(.a(new_n20_), .b(x1), .c(new_n17_), .O(new_n46_));
  oai21  g31(.a(new_n20_), .b(new_n17_), .c(new_n46_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n16_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n45_), .O(z4));
  nand2  g34(.a(new_n46_), .b(x0), .O(new_n50_));
  aoi21  g35(.a(new_n20_), .b(x2), .c(new_n23_), .O(new_n51_));
  nand3  g36(.a(x6), .b(new_n20_), .c(new_n17_), .O(new_n52_));
  inv1   g37(.a(new_n52_), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n51_), .c(new_n16_), .O(new_n54_));
  oai21  g39(.a(new_n27_), .b(x1), .c(new_n20_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(x2), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n54_), .c(new_n50_), .O(z5));
  oai21  g42(.a(x4), .b(x2), .c(new_n20_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(x1), .c(new_n16_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n50_), .c(new_n41_), .O(z6));
endmodule
