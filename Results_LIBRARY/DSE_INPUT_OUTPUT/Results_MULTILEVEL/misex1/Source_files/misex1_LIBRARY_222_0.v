...
module FAU ( 
  ...
  aoi21  g09(.a(x3), .b(new_n20_), .c(new_n16_), .O(new_n25_));
  inv1   g10(.a(x3), .O(new_n26_));
  inv1   g11(.a(x5), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n26_), .O(new_n28_));
  nand3  g13(.a(new_n28_), .b(new_n20_), .c(new_n16_), .O(new_n29_));
  oai21  g14(.a(new_n25_), .b(x2), .c(new_n29_), .O(z1));
  oai21  g15(.a(new_n28_), .b(x1), .c(new_n17_), .O(new_n31_));
  nand3  g16(.a(new_n31_), .b(x2), .c(new_n16_), .O(new_n32_));
  nand4  g17(.a(x3), .b(new_n21_), .c(new_n20_), .d(x0), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n32_), .O(z2));
  nand2  g19(.a(x5), .b(new_n16_), .O(new_n35_));
  nand4  g20(.a(new_n35_), .b(new_n26_), .c(x2), .d(new_n20_), .O(new_n36_));
  inv1   g21(.a(new_n36_), .O(z3));
  xor2a  g22(.a(x3), .b(x2), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n20_), .O(new_n39_));
  oai21  g24(.a(new_n22_), .b(x0), .c(new_n39_), .O(z4));
