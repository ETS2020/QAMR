...
module FAU ( 
  ...
  oai21  g24(.a(x2), .b(new_n23_), .c(new_n21_), .O(new_n40_));
  ...
  oai21  g30(.a(new_n25_), .b(x1), .c(new_n17_), .O(new_n46_));
  ...
  nand2  g36(.a(x2), .b(x0), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(x5), .c(x3), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n16_), .c(new_n23_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n51_), .O(z6));
endmodule
