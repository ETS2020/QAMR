...
module FAU ( 
  ...
  nand2  g09(.a(new_n16_), .b(new_n24_), .O(new_n25_));
  oai21  g10(.a(new_n25_), .b(new_n19_), .c(new_n20_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(x0), .O(new_n27_));
  inv1   g12(.a(x5), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n19_), .O(new_n29_));
  nand3  g14(.a(new_n29_), .b(x2), .c(new_n24_), .O(new_n30_));
  oai21  g15(.a(x2), .b(new_n24_), .c(new_n30_), .O(new_n31_));
  ...
  aoi21  g20(.a(new_n35_), .b(new_n19_), .c(new_n24_), .O(new_n36_));
  nand2  g21(.a(new_n28_), .b(x2), .O(new_n37_));
  nand2  g22(.a(new_n20_), .b(new_n16_), .O(new_n38_));
  aoi21  g23(.a(new_n38_), .b(new_n37_), .c(x3), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n24_), .c(new_n36_), .O(new_n40_));
  nand4  g25(.a(new_n21_), .b(new_n20_), .c(x3), .d(new_n16_), .O(new_n41_));
  ...
  oai21  g30(.a(new_n45_), .b(new_n29_), .c(new_n44_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n17_), .O(new_n47_));
  nand4  g32(.a(new_n21_), .b(new_n20_), .c(new_n19_), .d(x2), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n47_), .O(z3));
  xor2a  g34(.a(x3), .b(x2), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n20_), .c(x0), .O(new_n51_));
  oai21  g36(.a(new_n16_), .b(x0), .c(new_n51_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n24_), .O(new_n53_));
  aoi21  g38(.a(x3), .b(new_n24_), .c(x2), .O(new_n54_));
  ...
  aoi21  g43(.a(x5), .b(new_n24_), .c(x3), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n16_), .c(new_n58_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n17_), .O(new_n61_));
  xnor2a g46(.a(x3), .b(x2), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(x1), .c(new_n20_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(x0), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n61_), .c(new_n33_), .O(z5));
  oai21  g50(.a(x4), .b(x2), .c(new_n19_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(x1), .c(new_n17_), .O(new_n67_));
  oai22  g52(.a(new_n62_), .b(new_n17_), .c(new_n29_), .d(new_n16_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n24_), .O(new_n69_));
  nand2  g54(.a(x6), .b(x0), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n69_), .c(new_n67_), .O(z6));
endmodule
