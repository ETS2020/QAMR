...
module FAU ( 
  ...
  oai21  g28(.a(new_n18_), .b(new_n21_), .c(x2), .O(new_n44_));
  oai21  g29(.a(new_n43_), .b(new_n21_), .c(new_n44_), .O(new_n45_));
  ...
  aoi21  g35(.a(new_n50_), .b(new_n43_), .c(new_n21_), .O(new_n51_));
  nor2   g36(.a(new_n22_), .b(x0), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n51_), .c(new_n16_), .O(new_n53_));
  nand2  g38(.a(new_n25_), .b(new_n21_), .O(new_n54_));
