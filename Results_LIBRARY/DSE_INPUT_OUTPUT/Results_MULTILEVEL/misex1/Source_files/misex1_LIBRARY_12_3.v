...
module FAU ( 
  ...
  oai21  g38(.a(x7), .b(new_n17_), .c(x3), .O(new_n54_));
  nand3  g39(.a(new_n21_), .b(x3), .c(x2), .O(new_n55_));
  ...
  nand3  g43(.a(new_n21_), .b(x3), .c(new_n16_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n50_), .c(new_n20_), .O(new_n60_));
  ...
  aoi21  g49(.a(new_n64_), .b(new_n49_), .c(new_n17_), .O(new_n65_));
  oai21  g50(.a(new_n26_), .b(x2), .c(new_n55_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n65_), .c(new_n20_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n63_), .O(z5));
  nand3  g53(.a(new_n24_), .b(new_n18_), .c(x2), .O(new_n69_));
  inv1   g54(.a(new_n69_), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n60_), .c(new_n17_), .O(new_n71_));
  inv1   g56(.a(x4), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(new_n18_), .c(new_n16_), .O(new_n73_));
  aoi21  g58(.a(new_n73_), .b(new_n49_), .c(new_n17_), .O(new_n74_));
  aoi22  g59(.a(new_n74_), .b(new_n20_), .c(x7), .d(x3), .O(new_n75_));
