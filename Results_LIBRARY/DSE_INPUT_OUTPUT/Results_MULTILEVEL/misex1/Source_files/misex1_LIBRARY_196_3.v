...
module FAU ( 
  ...
  nor2   g27(.a(new_n32_), .b(x2), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n22_), .c(x0), .O(new_n44_));
  ...
  aoi21  g32(.a(new_n32_), .b(new_n22_), .c(x5), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n16_), .c(new_n47_), .O(z3));
  nand2  g34(.a(new_n43_), .b(x0), .O(new_n50_));
  nand3  g35(.a(new_n24_), .b(new_n32_), .c(x2), .O(new_n51_));
  ...
  nand2  g39(.a(new_n39_), .b(x2), .O(new_n55_));
  ...
  or2    g44(.a(new_n59_), .b(new_n43_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n22_), .c(x0), .O(new_n61_));
  nor2   g46(.a(new_n59_), .b(new_n22_), .O(new_n62_));
  nand3  g47(.a(x6), .b(new_n32_), .c(new_n16_), .O(new_n63_));
  oai21  g48(.a(new_n32_), .b(new_n16_), .c(new_n63_), .O(new_n64_));
  ...
  oai21  g52(.a(x4), .b(x2), .c(new_n32_), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(x1), .c(new_n17_), .O(new_n69_));
  inv1   g54(.a(new_n50_), .O(new_n70_));
  oai21  g55(.a(new_n59_), .b(new_n70_), .c(new_n22_), .O(new_n71_));
