...
module FAU ( 
  ...
  oai21  g25(.a(new_n17_), .b(x2), .c(new_n20_), .O(new_n41_));
  nor2   g26(.a(x3), .b(new_n22_), .O(new_n42_));
  aoi21  g27(.a(new_n26_), .b(x0), .c(new_n42_), .O(new_n43_));
  aoi21  g28(.a(new_n43_), .b(new_n41_), .c(x1), .O(z4));
  oai21  g29(.a(new_n42_), .b(new_n26_), .c(x0), .O(new_n45_));
  nand2  g30(.a(new_n23_), .b(new_n21_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n20_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n45_), .c(x1), .O(z5));
  aoi21  g33(.a(new_n45_), .b(new_n34_), .c(x1), .O(z6));
endmodule
