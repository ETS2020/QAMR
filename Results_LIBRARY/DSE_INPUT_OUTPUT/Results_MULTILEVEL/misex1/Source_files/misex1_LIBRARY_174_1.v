...
module FAU ( 
  ...
  nand3  g21(.a(new_n26_), .b(new_n36_), .c(new_n16_), .O(new_n37_));
  ...
  nand3  g27(.a(new_n42_), .b(new_n26_), .c(new_n16_), .O(new_n43_));
  nor2   g28(.a(new_n20_), .b(new_n16_), .O(new_n44_));
  inv1   g29(.a(new_n44_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n43_), .c(new_n19_), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n40_), .c(new_n17_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n33_), .O(z2));
  nand2  g33(.a(x5), .b(new_n17_), .O(new_n49_));
  nand4  g34(.a(new_n49_), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n50_));
  nand4  g35(.a(new_n26_), .b(new_n16_), .c(x1), .d(new_n17_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n50_), .O(z3));
  nand2  g37(.a(new_n20_), .b(x2), .O(new_n53_));
  nand3  g38(.a(new_n32_), .b(new_n16_), .c(x0), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n19_), .O(new_n56_));
  aoi21  g41(.a(x3), .b(new_n19_), .c(x7), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n16_), .c(new_n44_), .O(new_n58_));
  ...
  inv1   g48(.a(new_n32_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(x2), .c(new_n19_), .O(new_n65_));
  oai21  g50(.a(new_n27_), .b(x2), .c(new_n45_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n65_), .c(new_n17_), .O(new_n67_));
  nor2   g52(.a(new_n26_), .b(x2), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n67_), .c(new_n63_), .O(z5));
  nand3  g55(.a(new_n23_), .b(new_n20_), .c(x2), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n61_), .c(new_n19_), .O(new_n73_));
  nand3  g58(.a(new_n26_), .b(new_n41_), .c(new_n16_), .O(new_n74_));
  oai21  g59(.a(new_n68_), .b(new_n20_), .c(new_n74_), .O(new_n75_));
