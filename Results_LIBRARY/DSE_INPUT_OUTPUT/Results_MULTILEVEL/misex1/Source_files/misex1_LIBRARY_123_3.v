...
module FAU ( 
  ...
  oai21  g10(.a(new_n18_), .b(x0), .c(new_n25_), .O(new_n26_));
  ...
  oai21  g24(.a(new_n39_), .b(new_n37_), .c(new_n28_), .O(new_n40_));
  nand4  g25(.a(x3), .b(new_n24_), .c(new_n18_), .d(x0), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(z2));
  oai21  g27(.a(x4), .b(x3), .c(x7), .O(new_n43_));
  nand4  g28(.a(new_n43_), .b(new_n24_), .c(x1), .d(new_n28_), .O(new_n44_));
  aoi21  g29(.a(x5), .b(new_n28_), .c(x6), .O(new_n45_));
  nand4  g30(.a(new_n45_), .b(new_n19_), .c(x2), .d(new_n18_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n44_), .O(z3));
  nand2  g32(.a(x3), .b(new_n24_), .O(new_n48_));
  nand3  g33(.a(new_n16_), .b(new_n19_), .c(x2), .O(new_n49_));
  ...
  nand3  g37(.a(new_n16_), .b(x3), .c(x2), .O(new_n53_));
  inv1   g38(.a(new_n53_), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n52_), .c(new_n28_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n51_), .O(z4));
  aoi21  g41(.a(new_n49_), .b(new_n48_), .c(new_n28_), .O(new_n57_));
  nand4  g42(.a(new_n16_), .b(x5), .c(x2), .d(new_n28_), .O(new_n58_));
  ...
  oai21  g47(.a(new_n30_), .b(x2), .c(new_n53_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n62_), .c(new_n28_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n60_), .O(z5));
  inv1   g50(.a(x5), .O(new_n66_));
  nand4  g51(.a(new_n16_), .b(new_n66_), .c(new_n19_), .d(x2), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n57_), .c(new_n18_), .O(new_n69_));
  inv1   g54(.a(x4), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(x3), .c(new_n24_), .O(new_n71_));
  nand2  g56(.a(new_n71_), .b(new_n61_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(x1), .c(new_n28_), .O(new_n73_));
