...
module FAU ( 
  ...
  xnor2a g09(.a(x2), .b(x0), .O(new_n25_));
  ...
  oai21  g38(.a(new_n51_), .b(x3), .c(x1), .O(new_n54_));
  ...
  oai21  g44(.a(new_n43_), .b(new_n17_), .c(new_n59_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n23_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n58_), .O(z4));
  aoi21  g47(.a(new_n59_), .b(new_n43_), .c(new_n17_), .O(new_n63_));
  nand4  g48(.a(new_n27_), .b(x5), .c(new_n24_), .d(x2), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n63_), .c(new_n23_), .O(new_n66_));
  nand4  g51(.a(new_n27_), .b(x6), .c(new_n24_), .d(new_n16_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n55_), .c(new_n54_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n17_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n66_), .O(z5));
  nand2  g55(.a(new_n24_), .b(x2), .O(new_n71_));
  aoi21  g56(.a(new_n71_), .b(new_n43_), .c(new_n17_), .O(new_n72_));
  nand3  g57(.a(new_n26_), .b(new_n24_), .c(x2), .O(new_n73_));
  inv1   g58(.a(new_n73_), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(new_n72_), .c(new_n23_), .O(new_n75_));
  oai21  g60(.a(x4), .b(x2), .c(new_n24_), .O(new_n76_));
  nand3  g61(.a(new_n76_), .b(x1), .c(new_n17_), .O(new_n77_));
  nand3  g62(.a(new_n77_), .b(new_n75_), .c(new_n35_), .O(z6));
endmodule
