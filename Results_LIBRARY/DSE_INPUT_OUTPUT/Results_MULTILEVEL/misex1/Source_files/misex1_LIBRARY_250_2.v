...
module FAU ( 
  ...
  aoi21  g10(.a(new_n16_), .b(new_n20_), .c(new_n25_), .O(new_n26_));
  inv1   g11(.a(x6), .O(new_n27_));
  oai21  g12(.a(new_n27_), .b(x3), .c(new_n19_), .O(new_n28_));
  aoi22  g13(.a(new_n28_), .b(new_n25_), .c(new_n26_), .d(new_n19_), .O(new_n29_));
  ...
  nand4  g19(.a(new_n27_), .b(new_n20_), .c(new_n25_), .d(new_n19_), .O(new_n35_));
  ...
  nand4  g23(.a(x5), .b(x4), .c(new_n25_), .d(x1), .O(new_n39_));
  ...
  nand2  g31(.a(x5), .b(new_n38_), .O(new_n47_));
  ...
  aoi21  g41(.a(new_n56_), .b(new_n53_), .c(new_n30_), .O(z4));
  ...
  nand3  g52(.a(new_n16_), .b(new_n20_), .c(x2), .O(new_n68_));
