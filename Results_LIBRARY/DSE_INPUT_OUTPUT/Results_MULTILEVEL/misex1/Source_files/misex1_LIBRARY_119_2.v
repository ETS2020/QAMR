...
module FAU ( 
  ...
  nand2  g18(.a(new_n24_), .b(x2), .O(new_n34_));
  nand2  g19(.a(new_n27_), .b(new_n16_), .O(new_n35_));
  ...
  oai21  g23(.a(x3), .b(x1), .c(x2), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(x0), .O(new_n40_));
  oai21  g25(.a(x4), .b(x3), .c(x7), .O(new_n41_));
  nand4  g26(.a(new_n41_), .b(new_n16_), .c(x1), .d(new_n19_), .O(new_n42_));
  nand4  g27(.a(new_n24_), .b(new_n23_), .c(x2), .d(new_n22_), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n42_), .c(new_n40_), .O(z3));
  nor2   g29(.a(new_n23_), .b(x0), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n17_), .c(x2), .O(new_n46_));
  nand2  g31(.a(x3), .b(new_n22_), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n16_), .c(new_n19_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n46_), .O(z4));
  oai21  g34(.a(new_n45_), .b(new_n16_), .c(x1), .O(new_n50_));
  oai21  g35(.a(new_n24_), .b(x1), .c(new_n23_), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(x2), .c(new_n19_), .O(new_n52_));
  nand3  g37(.a(x6), .b(new_n23_), .c(new_n16_), .O(new_n53_));
  nand4  g38(.a(new_n53_), .b(new_n52_), .c(new_n50_), .d(new_n40_), .O(z5));
  oai21  g39(.a(x4), .b(x2), .c(new_n23_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(x1), .c(new_n19_), .O(new_n56_));
  nand2  g41(.a(x5), .b(new_n19_), .O(new_n57_));
  nand4  g42(.a(new_n57_), .b(new_n23_), .c(x2), .d(new_n22_), .O(new_n58_));
