...
module FAU ( 
  ...
  aoi21  g14(.a(new_n29_), .b(new_n27_), .c(x1), .O(new_n30_));
  nand3  g15(.a(new_n16_), .b(new_n28_), .c(x1), .O(new_n31_));
  inv1   g16(.a(new_n31_), .O(new_n32_));
  oai21  g17(.a(new_n32_), .b(new_n30_), .c(new_n26_), .O(new_n33_));
  nand4  g18(.a(x3), .b(new_n28_), .c(new_n20_), .d(x0), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n33_), .O(z1));
  nand3  g20(.a(new_n28_), .b(new_n20_), .c(x0), .O(new_n36_));
  ...
  nand4  g28(.a(new_n43_), .b(new_n21_), .c(new_n20_), .d(new_n26_), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n41_), .c(new_n38_), .O(z2));
  oai21  g30(.a(x4), .b(x3), .c(x7), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n16_), .c(new_n28_), .d(x1), .O(new_n47_));
  ...
  nand3  g36(.a(new_n16_), .b(x1), .c(new_n26_), .O(new_n52_));
  ...
  nand4  g41(.a(new_n16_), .b(x3), .c(x2), .d(new_n26_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(z4));
  nand2  g43(.a(x3), .b(new_n28_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n22_), .c(new_n26_), .O(new_n60_));
  ...
  nand2  g51(.a(x6), .b(x1), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n66_), .c(new_n63_), .O(z5));
  nand3  g53(.a(new_n61_), .b(new_n21_), .c(x2), .O(new_n69_));
