...
module FAU ( 
  ...
  nand2  g13(.a(x3), .b(x0), .O(new_n29_));
  inv1   g14(.a(x6), .O(new_n30_));
  nand3  g15(.a(new_n30_), .b(new_n18_), .c(new_n21_), .O(new_n31_));
  ...
  nand3  g22(.a(new_n37_), .b(x1), .c(new_n21_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n35_), .c(new_n33_), .O(z2));
  ...
  oai21  g28(.a(new_n41_), .b(new_n16_), .c(new_n43_), .O(z3));
  nand3  g29(.a(x3), .b(new_n17_), .c(new_n16_), .O(new_n45_));
  ...
  nand2  g34(.a(x3), .b(new_n17_), .O(new_n50_));
  aoi22  g35(.a(new_n50_), .b(new_n21_), .c(new_n49_), .d(x2), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n48_), .c(new_n22_), .O(z4));
  xor2a  g37(.a(x3), .b(x2), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n16_), .c(x0), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n26_), .c(new_n22_), .O(z5));
  aoi22  g40(.a(new_n53_), .b(x0), .c(new_n49_), .d(x2), .O(new_n56_));
  nand2  g41(.a(x4), .b(new_n18_), .O(new_n57_));
  nand4  g42(.a(new_n57_), .b(new_n17_), .c(x1), .d(new_n21_), .O(new_n58_));
