...
module FAU ( 
  ...
  oai22  g24(.a(new_n39_), .b(x0), .c(new_n20_), .d(x1), .O(z4));
  aoi21  g25(.a(new_n17_), .b(x2), .c(new_n23_), .O(new_n41_));
  oai21  g26(.a(new_n25_), .b(x1), .c(new_n17_), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(x2), .c(new_n41_), .O(new_n43_));
  nand3  g28(.a(new_n39_), .b(new_n23_), .c(x0), .O(new_n44_));
  ...
  nand3  g32(.a(new_n36_), .b(x2), .c(new_n23_), .O(new_n48_));
