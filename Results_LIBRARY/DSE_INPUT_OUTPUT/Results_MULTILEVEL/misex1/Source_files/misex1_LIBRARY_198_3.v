...
module FAU ( 
  ...
  nand4  g23(.a(new_n38_), .b(new_n17_), .c(x1), .d(new_n37_), .O(new_n39_));
  ...
  aoi22  g29(.a(new_n44_), .b(x0), .c(new_n43_), .d(x2), .O(new_n45_));
  aoi21  g30(.a(new_n17_), .b(x0), .c(new_n16_), .O(new_n46_));
  aoi21  g31(.a(x3), .b(new_n17_), .c(x0), .O(new_n47_));
  nor2   g32(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  oai21  g33(.a(new_n45_), .b(x1), .c(new_n48_), .O(z4));
  inv1   g34(.a(new_n46_), .O(new_n50_));
  nand3  g35(.a(new_n44_), .b(new_n16_), .c(x0), .O(new_n51_));
  nand3  g36(.a(x6), .b(new_n18_), .c(new_n17_), .O(new_n52_));
  inv1   g37(.a(new_n52_), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n22_), .c(new_n37_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n51_), .c(new_n50_), .O(z5));
  nand2  g40(.a(x4), .b(new_n18_), .O(new_n56_));
  nand4  g41(.a(new_n56_), .b(new_n17_), .c(x1), .d(new_n37_), .O(new_n57_));
  oai21  g42(.a(new_n45_), .b(x1), .c(new_n57_), .O(z6));
endmodule
