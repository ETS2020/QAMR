...
module FAU ( 
  ...
  nand3  g18(.a(new_n25_), .b(x5), .c(new_n16_), .O(new_n34_));
  aoi21  g19(.a(new_n34_), .b(new_n33_), .c(x3), .O(new_n35_));
  oai21  g20(.a(x5), .b(x2), .c(x3), .O(new_n36_));
  nand3  g21(.a(x5), .b(x4), .c(new_n16_), .O(new_n37_));
  ...
  nand3  g25(.a(x5), .b(x3), .c(new_n16_), .O(new_n41_));
  or2    g26(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  oai21  g27(.a(new_n39_), .b(x0), .c(new_n42_), .O(z2));
  oai21  g28(.a(x4), .b(x3), .c(x7), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(x5), .c(new_n16_), .d(x1), .O(new_n45_));
