...
module FAU ( 
  ...
  aoi21  g16(.a(new_n31_), .b(new_n20_), .c(new_n19_), .O(new_n32_));
  ...
  aoi21  g22(.a(new_n37_), .b(new_n19_), .c(new_n32_), .O(new_n38_));
  nand3  g23(.a(new_n23_), .b(new_n19_), .c(x0), .O(new_n39_));
  ...
  nand3  g38(.a(x6), .b(new_n16_), .c(new_n17_), .O(new_n54_));
  oai21  g39(.a(new_n16_), .b(new_n17_), .c(new_n54_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n20_), .O(new_n56_));
  oai21  g41(.a(new_n23_), .b(x1), .c(x0), .O(new_n57_));
  oai21  g42(.a(new_n33_), .b(x1), .c(new_n20_), .O(new_n58_));
  ...
  oai21  g46(.a(x5), .b(x1), .c(new_n17_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n20_), .c(x2), .O(new_n63_));
