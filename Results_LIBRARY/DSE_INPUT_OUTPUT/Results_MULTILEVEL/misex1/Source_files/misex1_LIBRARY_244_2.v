...
module FAU ( 
  ...
  aoi22  g14(.a(new_n29_), .b(new_n18_), .c(new_n27_), .d(new_n17_), .O(new_n30_));
  ...
  nand3  g36(.a(x3), .b(new_n39_), .c(x0), .O(new_n52_));
  oai21  g37(.a(x3), .b(new_n39_), .c(new_n52_), .O(new_n53_));
  ...
  aoi21  g42(.a(new_n57_), .b(new_n54_), .c(new_n51_), .O(z4));
  xor2a  g43(.a(x3), .b(x2), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n20_), .c(x0), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n19_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n17_), .O(new_n62_));
  aoi21  g47(.a(x6), .b(new_n36_), .c(new_n31_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n20_), .c(new_n28_), .O(new_n64_));
  nand3  g49(.a(x6), .b(x5), .c(new_n20_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n32_), .c(new_n39_), .O(new_n66_));
  aoi21  g51(.a(new_n64_), .b(new_n39_), .c(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(x0), .c(new_n62_), .O(z5));
  oai21  g53(.a(new_n16_), .b(new_n18_), .c(x5), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n21_), .c(x2), .O(new_n70_));
  nand4  g55(.a(new_n17_), .b(x3), .c(new_n39_), .d(x0), .O(new_n71_));
  ...
  nand4  g59(.a(new_n74_), .b(new_n17_), .c(x1), .d(new_n18_), .O(new_n75_));
