...
module FAU ( 
  ...
  nand3  g15(.a(new_n30_), .b(new_n25_), .c(new_n27_), .O(new_n31_));
  oai21  g16(.a(new_n24_), .b(new_n19_), .c(new_n23_), .O(new_n32_));
  nand4  g17(.a(new_n32_), .b(x2), .c(new_n18_), .d(new_n16_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n31_), .O(z1));
  nand2  g19(.a(x4), .b(new_n27_), .O(new_n35_));
  ...
  aoi21  g25(.a(new_n40_), .b(new_n18_), .c(new_n36_), .O(new_n41_));
  nor2   g26(.a(x1), .b(new_n16_), .O(new_n42_));
  nand2  g27(.a(x3), .b(new_n27_), .O(new_n43_));
  inv1   g28(.a(new_n43_), .O(new_n44_));
  aoi22  g29(.a(new_n44_), .b(new_n42_), .c(new_n24_), .d(new_n23_), .O(new_n45_));
  ...
  oai21  g37(.a(new_n43_), .b(new_n16_), .c(new_n52_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n18_), .O(new_n54_));
  aoi21  g39(.a(x3), .b(new_n18_), .c(x2), .O(new_n55_));
  nor2   g40(.a(new_n19_), .b(new_n27_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n55_), .c(new_n16_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n54_), .c(new_n25_), .O(z4));
  aoi21  g43(.a(new_n52_), .b(new_n43_), .c(new_n16_), .O(new_n59_));
  ...
  inv1   g47(.a(new_n56_), .O(new_n63_));
  nand2  g48(.a(new_n52_), .b(x1), .O(new_n64_));
  nand3  g49(.a(x6), .b(new_n19_), .c(new_n27_), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n64_), .c(new_n63_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n16_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n62_), .c(new_n25_), .O(z5));
  nand3  g53(.a(new_n23_), .b(new_n19_), .c(x2), .O(new_n69_));
