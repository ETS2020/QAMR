...
module FAU ( 
  ...
  nand3  g35(.a(x7), .b(new_n33_), .c(x2), .O(new_n51_));
  ...
  nand3  g49(.a(x6), .b(new_n33_), .c(new_n16_), .O(new_n65_));
  oai21  g50(.a(new_n33_), .b(new_n16_), .c(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n64_), .c(new_n17_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n62_), .c(new_n31_), .O(z5));
  aoi21  g53(.a(new_n51_), .b(new_n41_), .c(new_n17_), .O(new_n69_));
  nand4  g54(.a(x7), .b(new_n36_), .c(new_n33_), .d(x2), .O(new_n70_));
