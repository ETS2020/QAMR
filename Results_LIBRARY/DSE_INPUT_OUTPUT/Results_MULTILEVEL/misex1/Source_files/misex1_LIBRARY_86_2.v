...
module FAU ( 
  ...
  aoi22  g30(.a(new_n45_), .b(new_n43_), .c(new_n23_), .d(x5), .O(new_n46_));
  oai21  g31(.a(new_n42_), .b(x0), .c(new_n46_), .O(z2));
  oai21  g32(.a(x4), .b(x3), .c(x7), .O(new_n48_));
  nand4  g33(.a(new_n48_), .b(new_n26_), .c(x1), .d(new_n16_), .O(new_n49_));
  ...
  oai21  g38(.a(new_n44_), .b(new_n16_), .c(new_n53_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n18_), .O(new_n55_));
  aoi21  g40(.a(x3), .b(new_n18_), .c(x2), .O(new_n56_));
  nor2   g41(.a(new_n19_), .b(new_n26_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n56_), .c(new_n16_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n55_), .c(new_n24_), .O(z4));
  aoi21  g44(.a(new_n53_), .b(new_n44_), .c(new_n16_), .O(new_n60_));
  nand3  g45(.a(x5), .b(new_n19_), .c(x2), .O(new_n61_));
  ...
  nand3  g53(.a(new_n68_), .b(new_n63_), .c(new_n24_), .O(z5));
  nand3  g54(.a(new_n37_), .b(new_n19_), .c(x2), .O(new_n70_));
