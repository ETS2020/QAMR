...
module FAU ( 
  ...
  nand3  g21(.a(new_n36_), .b(new_n22_), .c(new_n21_), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(new_n33_), .c(x0), .O(z2));
  oai21  g23(.a(x4), .b(x3), .c(x7), .O(new_n39_));
  nand4  g24(.a(new_n39_), .b(new_n26_), .c(x1), .d(new_n18_), .O(new_n40_));
  ...
  nor2   g28(.a(new_n22_), .b(x0), .O(new_n44_));
  aoi21  g29(.a(new_n22_), .b(new_n21_), .c(new_n44_), .O(new_n45_));
  nand2  g30(.a(x3), .b(new_n21_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(new_n26_), .c(new_n18_), .O(new_n47_));
  oai21  g32(.a(new_n45_), .b(new_n26_), .c(new_n47_), .O(z4));
  oai21  g33(.a(new_n44_), .b(new_n26_), .c(x1), .O(new_n49_));
  oai21  g34(.a(new_n23_), .b(x1), .c(new_n22_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(x2), .c(new_n18_), .O(new_n51_));
  nand3  g36(.a(x6), .b(new_n22_), .c(new_n26_), .O(new_n52_));
  nand4  g37(.a(new_n52_), .b(new_n51_), .c(new_n49_), .d(new_n17_), .O(z5));
  aoi21  g38(.a(x4), .b(new_n22_), .c(x2), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n44_), .c(x1), .O(new_n55_));
  nand4  g40(.a(new_n23_), .b(new_n22_), .c(x2), .d(new_n21_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n55_), .c(new_n17_), .O(z6));
endmodule
