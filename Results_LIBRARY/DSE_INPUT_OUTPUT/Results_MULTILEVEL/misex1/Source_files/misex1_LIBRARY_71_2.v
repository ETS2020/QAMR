...
module FAU ( 
  ...
  oai21  g13(.a(new_n16_), .b(new_n24_), .c(new_n19_), .O(new_n29_));
  ...
  nand3  g22(.a(x3), .b(new_n20_), .c(x0), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n37_), .c(new_n18_), .O(z2));
  nand2  g24(.a(x5), .b(new_n24_), .O(new_n40_));
  nand4  g25(.a(new_n40_), .b(new_n16_), .c(x2), .d(new_n19_), .O(new_n41_));
  inv1   g26(.a(new_n41_), .O(z3));
  nand2  g27(.a(x3), .b(x2), .O(new_n43_));
  oai21  g28(.a(x3), .b(x1), .c(new_n43_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n24_), .O(new_n45_));
  inv1   g30(.a(new_n38_), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n21_), .c(new_n19_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n45_), .O(z4));
  xnor2a g33(.a(x3), .b(x2), .O(new_n49_));
  nand3  g34(.a(x5), .b(x2), .c(new_n24_), .O(new_n50_));
  oai21  g35(.a(new_n49_), .b(new_n24_), .c(new_n50_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n19_), .O(new_n52_));
  nand2  g37(.a(new_n43_), .b(new_n26_), .O(new_n53_));
  nor2   g38(.a(x2), .b(new_n19_), .O(new_n54_));
  aoi21  g39(.a(new_n53_), .b(new_n24_), .c(new_n54_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n52_), .O(z5));
  nor2   g41(.a(x5), .b(x3), .O(new_n57_));
  xor2a  g42(.a(x3), .b(x2), .O(new_n58_));
  aoi22  g43(.a(new_n58_), .b(x0), .c(new_n57_), .d(x2), .O(new_n59_));
  nand4  g44(.a(x3), .b(x2), .c(x1), .d(new_n24_), .O(new_n60_));
