...
module FAU ( 
  ...
  nand3  g10(.a(x3), .b(x2), .c(new_n25_), .O(new_n26_));
  inv1   g11(.a(x2), .O(new_n27_));
  nand3  g12(.a(x6), .b(new_n16_), .c(new_n27_), .O(new_n28_));
  aoi21  g13(.a(new_n28_), .b(new_n26_), .c(x0), .O(new_n29_));
  nand4  g14(.a(x3), .b(new_n27_), .c(new_n25_), .d(x0), .O(new_n30_));
  inv1   g15(.a(new_n30_), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(new_n29_), .c(new_n24_), .O(new_n32_));
  nand3  g17(.a(new_n27_), .b(x1), .c(new_n20_), .O(new_n33_));
  ...
  oai21  g24(.a(new_n39_), .b(new_n36_), .c(new_n20_), .O(new_n40_));
  ...
  nand4  g30(.a(new_n45_), .b(new_n27_), .c(x1), .d(new_n20_), .O(new_n46_));
  oai21  g31(.a(new_n18_), .b(x5), .c(new_n25_), .O(new_n47_));
  ...
  nand2  g40(.a(x5), .b(new_n25_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n55_), .c(new_n51_), .O(z4));
  nand2  g42(.a(x3), .b(new_n27_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n17_), .c(new_n20_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(x5), .c(new_n25_), .O(new_n60_));
  nand2  g45(.a(new_n17_), .b(x1), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n28_), .c(new_n22_), .O(new_n62_));
  ...
  nand3  g51(.a(new_n41_), .b(new_n17_), .c(new_n24_), .O(new_n67_));
