...
module FAU ( 
  ...
  oai21  g23(.a(new_n36_), .b(new_n17_), .c(new_n38_), .O(z4));
  oai21  g24(.a(new_n32_), .b(x0), .c(new_n36_), .O(z5));
  oai21  g25(.a(x2), .b(x1), .c(x0), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(x3), .O(new_n42_));
  nand2  g27(.a(x4), .b(x1), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n16_), .c(new_n17_), .O(new_n44_));
  nand2  g29(.a(new_n32_), .b(new_n19_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n44_), .c(new_n42_), .O(z6));
endmodule
