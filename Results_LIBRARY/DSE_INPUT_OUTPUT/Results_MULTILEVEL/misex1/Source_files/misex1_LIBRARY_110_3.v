...
module FAU ( 
  ...
  oai21  g21(.a(x1), .b(new_n22_), .c(new_n20_), .O(new_n37_));
  ...
  nand3  g30(.a(new_n45_), .b(new_n20_), .c(new_n22_), .O(new_n46_));
  oai21  g31(.a(new_n17_), .b(new_n22_), .c(new_n20_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n16_), .O(new_n48_));
  nand2  g33(.a(x3), .b(x2), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n48_), .c(new_n46_), .O(z4));
  aoi21  g35(.a(new_n17_), .b(new_n20_), .c(new_n22_), .O(new_n51_));
  nor2   g36(.a(new_n33_), .b(new_n20_), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n51_), .c(new_n16_), .O(new_n53_));
  aoi21  g38(.a(new_n17_), .b(x2), .c(new_n16_), .O(new_n54_));
  nand3  g39(.a(x6), .b(new_n17_), .c(new_n20_), .O(new_n55_));
  inv1   g40(.a(new_n55_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n54_), .c(new_n22_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n53_), .c(new_n49_), .O(z5));
  nor2   g43(.a(x5), .b(new_n20_), .O(new_n59_));
  oai21  g44(.a(new_n51_), .b(new_n59_), .c(new_n16_), .O(new_n60_));
  oai21  g45(.a(x4), .b(x2), .c(new_n17_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(x1), .c(new_n22_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n60_), .c(new_n49_), .O(z6));
endmodule
