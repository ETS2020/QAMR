...
module FAU ( 
  ...
  nand2  g48(.a(new_n23_), .b(x3), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(x2), .c(new_n22_), .O(new_n65_));
  ...
  oai21  g56(.a(new_n71_), .b(new_n60_), .c(new_n22_), .O(new_n72_));
  oai21  g57(.a(new_n39_), .b(x3), .c(new_n16_), .O(new_n73_));
