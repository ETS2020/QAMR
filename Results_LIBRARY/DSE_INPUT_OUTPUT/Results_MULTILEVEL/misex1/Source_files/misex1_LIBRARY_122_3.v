...
module FAU ( 
  ...
  nand2  g30(.a(new_n26_), .b(x0), .O(new_n46_));
  aoi22  g31(.a(new_n46_), .b(x1), .c(new_n45_), .d(new_n20_), .O(new_n47_));
  oai21  g32(.a(new_n44_), .b(x1), .c(new_n47_), .O(z4));
  nand2  g33(.a(new_n17_), .b(x2), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n45_), .c(new_n20_), .O(new_n50_));
  nor2   g35(.a(new_n21_), .b(x0), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n50_), .c(new_n16_), .O(new_n52_));
  nand2  g37(.a(new_n24_), .b(new_n20_), .O(new_n53_));
