...
module FAU ( 
  ...
  oai21  g40(.a(new_n25_), .b(x0), .c(x7), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(x2), .O(new_n57_));
  nand2  g42(.a(x3), .b(new_n23_), .O(new_n58_));
  ...
  nand3  g55(.a(new_n36_), .b(new_n25_), .c(x2), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n62_), .c(new_n23_), .O(new_n73_));
  oai21  g58(.a(x4), .b(x2), .c(new_n25_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(x1), .c(new_n17_), .O(new_n75_));
  nand3  g60(.a(new_n75_), .b(new_n73_), .c(new_n33_), .O(z6));
endmodule
