...
module FAU ( 
  ...
  nand2  g20(.a(new_n30_), .b(new_n29_), .O(new_n36_));
  inv1   g21(.a(x5), .O(new_n37_));
  nand3  g22(.a(x7), .b(new_n37_), .c(x2), .O(new_n38_));
  ...
  nand2  g26(.a(x7), .b(x3), .O(new_n42_));
  ...
  nand3  g38(.a(x7), .b(new_n19_), .c(x2), .O(new_n54_));
  ...
  nand3  g42(.a(x7), .b(x3), .c(x2), .O(new_n58_));
  ...
  nand4  g57(.a(x7), .b(new_n37_), .c(new_n19_), .d(x2), .O(new_n73_));
  inv1   g58(.a(new_n73_), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(new_n72_), .c(new_n18_), .O(new_n75_));
  inv1   g60(.a(x4), .O(new_n76_));
  oai21  g61(.a(new_n76_), .b(x3), .c(new_n29_), .O(new_n77_));
  nand2  g62(.a(new_n77_), .b(new_n42_), .O(new_n78_));
