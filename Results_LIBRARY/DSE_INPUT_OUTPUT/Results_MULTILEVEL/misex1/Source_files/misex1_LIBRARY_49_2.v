...
module FAU ( 
  ...
  nand3  g31(.a(new_n26_), .b(new_n23_), .c(x0), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n46_), .O(z2));
  oai22  g33(.a(x7), .b(x2), .c(x4), .d(x3), .O(new_n49_));
  ...
  oai21  g38(.a(new_n41_), .b(new_n16_), .c(x1), .O(new_n54_));
  ...
  nand2  g43(.a(new_n58_), .b(new_n27_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n23_), .c(new_n32_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n57_), .O(z4));
  nand2  g46(.a(x3), .b(new_n16_), .O(new_n62_));
  aoi21  g47(.a(new_n58_), .b(new_n62_), .c(new_n17_), .O(new_n63_));
  nor3   g48(.a(new_n35_), .b(new_n16_), .c(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n63_), .c(new_n23_), .O(new_n65_));
  oai21  g50(.a(new_n25_), .b(x0), .c(x4), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(x2), .O(new_n67_));
  aoi21  g52(.a(x4), .b(new_n25_), .c(new_n23_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n31_), .c(new_n17_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n67_), .c(new_n65_), .O(z5));
  nor2   g55(.a(x5), .b(x3), .O(new_n71_));
  aoi21  g56(.a(new_n71_), .b(x2), .c(new_n63_), .O(new_n72_));
  aoi21  g57(.a(new_n68_), .b(new_n17_), .c(new_n32_), .O(new_n73_));
