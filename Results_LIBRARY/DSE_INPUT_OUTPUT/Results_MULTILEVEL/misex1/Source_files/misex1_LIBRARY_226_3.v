...
module FAU ( 
  ...
  nand4  g33(.a(new_n48_), .b(new_n25_), .c(x1), .d(new_n32_), .O(new_n49_));
  nand2  g34(.a(x5), .b(new_n32_), .O(new_n50_));
  ...
  nand2  g38(.a(new_n53_), .b(new_n41_), .O(new_n54_));
  ...
  oai21  g43(.a(new_n58_), .b(new_n56_), .c(new_n32_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n55_), .c(new_n31_), .O(z4));
  inv1   g45(.a(new_n34_), .O(new_n61_));
  aoi21  g46(.a(new_n53_), .b(new_n61_), .c(new_n32_), .O(new_n62_));
  nor3   g47(.a(new_n26_), .b(new_n25_), .c(x0), .O(new_n63_));
  ...
  aoi21  g52(.a(new_n67_), .b(new_n32_), .c(new_n31_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n64_), .O(z5));
  nand3  g54(.a(new_n26_), .b(new_n18_), .c(x2), .O(new_n70_));
  inv1   g55(.a(new_n70_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n62_), .c(new_n17_), .O(new_n72_));
  oai21  g57(.a(x4), .b(x2), .c(new_n18_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(x1), .c(new_n32_), .O(new_n74_));
