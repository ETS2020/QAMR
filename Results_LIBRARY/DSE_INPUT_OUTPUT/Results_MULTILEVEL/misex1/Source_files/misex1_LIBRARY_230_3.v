...
module FAU ( 
  ...
  nand4  g25(.a(new_n40_), .b(new_n17_), .c(x1), .d(new_n21_), .O(new_n41_));
  ...
  nand3  g30(.a(x3), .b(new_n17_), .c(x0), .O(new_n46_));
  ...
  nand3  g40(.a(new_n55_), .b(new_n26_), .c(new_n22_), .O(z5));
  aoi21  g41(.a(x4), .b(new_n18_), .c(x0), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(x2), .c(x1), .O(new_n58_));
  inv1   g43(.a(x5), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n18_), .c(x2), .O(new_n60_));
