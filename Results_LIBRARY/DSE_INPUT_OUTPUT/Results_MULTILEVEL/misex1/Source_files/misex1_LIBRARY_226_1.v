...
module FAU ( 
  ...
  nor2   g18(.a(new_n33_), .b(new_n17_), .O(new_n34_));
  ...
  oai21  g25(.a(x7), .b(x1), .c(new_n40_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n29_), .c(new_n21_), .O(new_n42_));
  ...
  nand2  g31(.a(x5), .b(new_n39_), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(new_n21_), .c(x2), .d(new_n20_), .O(new_n48_));
  nand4  g33(.a(new_n16_), .b(new_n26_), .c(x1), .d(new_n39_), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n48_), .c(new_n18_), .O(z3));
  nand2  g35(.a(x3), .b(new_n26_), .O(new_n51_));
  nand2  g36(.a(new_n21_), .b(x2), .O(new_n52_));
  oai21  g37(.a(new_n51_), .b(new_n39_), .c(new_n52_), .O(new_n53_));
  ...
  aoi21  g42(.a(new_n57_), .b(new_n54_), .c(new_n17_), .O(z4));
  aoi21  g43(.a(new_n52_), .b(new_n51_), .c(new_n39_), .O(new_n59_));
  ...
  nand2  g51(.a(new_n66_), .b(new_n39_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n62_), .c(new_n18_), .O(z5));
  nand2  g53(.a(new_n27_), .b(x2), .O(new_n69_));
  inv1   g54(.a(new_n69_), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n59_), .c(new_n20_), .O(new_n71_));
  oai21  g56(.a(x4), .b(x2), .c(new_n21_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(x1), .c(new_n39_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(new_n71_), .c(new_n18_), .O(z6));
endmodule
