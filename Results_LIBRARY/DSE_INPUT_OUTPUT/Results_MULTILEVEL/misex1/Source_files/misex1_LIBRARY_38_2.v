...
module FAU ( 
  ...
  aoi21  g31(.a(x5), .b(new_n17_), .c(new_n19_), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(new_n24_), .c(x2), .d(new_n23_), .O(new_n48_));
  ...
  oai21  g37(.a(new_n50_), .b(new_n17_), .c(new_n52_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n23_), .O(new_n54_));
  oai21  g39(.a(new_n24_), .b(x0), .c(x4), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(x2), .O(new_n56_));
  nand2  g41(.a(x3), .b(new_n23_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n16_), .c(new_n17_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n56_), .c(new_n54_), .O(z4));
  nand3  g44(.a(x4), .b(new_n24_), .c(x2), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n50_), .c(new_n17_), .O(new_n61_));
  nand3  g46(.a(new_n51_), .b(x5), .c(x4), .O(new_n62_));
  ...
  nand3  g54(.a(new_n51_), .b(new_n25_), .c(x4), .O(new_n70_));
  inv1   g55(.a(new_n70_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n61_), .c(new_n23_), .O(new_n72_));
