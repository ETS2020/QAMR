...
module FAU ( 
  ...
  nand2  g26(.a(new_n30_), .b(new_n23_), .O(new_n42_));
  ...
  aoi21  g35(.a(x1), .b(new_n16_), .c(x7), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(x2), .c(new_n50_), .O(z3));
  ...
  nand3  g59(.a(new_n74_), .b(new_n70_), .c(new_n24_), .O(z6));
endmodule
