...
module FAU ( 
  ...
  nand3  g13(.a(new_n28_), .b(new_n26_), .c(new_n16_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n25_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n17_), .O(new_n31_));
  nor2   g16(.a(x7), .b(new_n20_), .O(new_n32_));
  nand4  g17(.a(new_n32_), .b(new_n16_), .c(new_n19_), .d(x0), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n31_), .O(z1));
  nand2  g19(.a(new_n23_), .b(x2), .O(new_n35_));
  nand3  g20(.a(new_n26_), .b(new_n27_), .c(new_n16_), .O(new_n36_));
  ...
  nand3  g26(.a(new_n41_), .b(new_n26_), .c(new_n16_), .O(new_n42_));
  ...
  oai21  g30(.a(new_n45_), .b(new_n39_), .c(new_n17_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n33_), .O(z2));
  nand2  g32(.a(x5), .b(new_n17_), .O(new_n48_));
  nand4  g33(.a(new_n48_), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n49_));
  aoi21  g34(.a(x1), .b(new_n17_), .c(x7), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(x2), .c(new_n49_), .O(z3));
  nand2  g36(.a(new_n20_), .b(x2), .O(new_n52_));
  nand3  g37(.a(new_n32_), .b(new_n16_), .c(x0), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n19_), .O(new_n55_));
  aoi21  g40(.a(x3), .b(new_n19_), .c(x7), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n16_), .c(new_n43_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(x0), .c(new_n55_), .O(z4));
  nand2  g43(.a(x3), .b(new_n16_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n52_), .c(new_n17_), .O(new_n60_));
  nor3   g45(.a(new_n23_), .b(new_n16_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n60_), .c(new_n19_), .O(new_n62_));
  nand2  g47(.a(new_n52_), .b(x1), .O(new_n63_));
  nand3  g48(.a(x6), .b(new_n20_), .c(new_n16_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n63_), .c(new_n44_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n17_), .O(new_n66_));
  nand2  g51(.a(x7), .b(new_n16_), .O(new_n67_));
  ...
  oai21  g55(.a(new_n70_), .b(new_n60_), .c(new_n19_), .O(new_n71_));
  oai21  g56(.a(x4), .b(x2), .c(new_n20_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(x1), .c(new_n17_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(new_n71_), .c(new_n67_), .O(z6));
endmodule
