...
module FAU ( 
  ...
  nand4  g28(.a(new_n27_), .b(x3), .c(new_n16_), .d(x0), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n19_), .O(new_n46_));
  aoi21  g31(.a(x3), .b(new_n19_), .c(x6), .O(new_n47_));
  nand2  g32(.a(x3), .b(x2), .O(new_n48_));
  inv1   g33(.a(new_n48_), .O(new_n49_));
  aoi21  g34(.a(new_n47_), .b(new_n16_), .c(new_n49_), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(x0), .c(new_n46_), .O(z4));
  nand3  g36(.a(new_n27_), .b(x3), .c(new_n16_), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n43_), .c(new_n17_), .O(new_n53_));
  nor2   g38(.a(new_n33_), .b(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n53_), .c(new_n19_), .O(new_n55_));
  nand3  g40(.a(new_n43_), .b(new_n27_), .c(x1), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n48_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n17_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n55_), .O(z5));
  nand3  g44(.a(new_n23_), .b(new_n20_), .c(x2), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n53_), .c(new_n19_), .O(new_n62_));
  oai21  g47(.a(new_n27_), .b(x2), .c(x3), .O(new_n63_));
  inv1   g48(.a(x4), .O(new_n64_));
  nand3  g49(.a(new_n27_), .b(new_n64_), .c(new_n16_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(x1), .c(new_n17_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n62_), .O(z6));
endmodule
