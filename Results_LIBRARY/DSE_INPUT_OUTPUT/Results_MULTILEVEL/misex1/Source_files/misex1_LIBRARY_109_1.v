...
module FAU ( 
  ...
  nand4  g17(.a(x3), .b(new_n32_), .c(new_n20_), .d(x0), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n31_), .c(new_n17_), .O(z1));
  inv1   g19(.a(new_n33_), .O(new_n35_));
  inv1   g20(.a(x5), .O(new_n36_));
  nand4  g21(.a(new_n36_), .b(new_n21_), .c(x2), .d(new_n20_), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(new_n19_), .c(x0), .O(new_n38_));
  oai21  g23(.a(new_n38_), .b(new_n35_), .c(new_n18_), .O(new_n39_));
  inv1   g24(.a(x6), .O(new_n40_));
  inv1   g25(.a(x4), .O(new_n41_));
  oai21  g26(.a(x7), .b(x1), .c(new_n41_), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n40_), .c(new_n21_), .O(new_n43_));
  ...
  nand4  g34(.a(new_n16_), .b(new_n32_), .c(x1), .d(new_n26_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n49_), .c(new_n18_), .O(z3));
  ...
  nor2   g41(.a(new_n21_), .b(new_n32_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n56_), .c(new_n26_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n55_), .c(new_n17_), .O(z4));
  nand2  g44(.a(new_n50_), .b(new_n16_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n41_), .O(new_n61_));
  nand3  g46(.a(new_n53_), .b(x4), .c(x1), .O(new_n62_));
  oai21  g47(.a(new_n36_), .b(x1), .c(new_n21_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(x2), .O(new_n64_));
  nand3  g49(.a(x6), .b(new_n21_), .c(new_n32_), .O(new_n65_));
  ...
  nor2   g53(.a(new_n68_), .b(new_n17_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n20_), .c(x0), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n67_), .c(new_n61_), .O(z5));
  nand3  g56(.a(new_n36_), .b(new_n21_), .c(x2), .O(new_n72_));
  oai21  g57(.a(new_n68_), .b(new_n26_), .c(new_n72_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(new_n18_), .c(new_n20_), .O(new_n74_));
  aoi21  g59(.a(new_n16_), .b(x2), .c(x4), .O(new_n75_));
  nand3  g60(.a(new_n16_), .b(new_n41_), .c(new_n32_), .O(new_n76_));
  oai21  g61(.a(new_n75_), .b(new_n21_), .c(new_n76_), .O(new_n77_));
