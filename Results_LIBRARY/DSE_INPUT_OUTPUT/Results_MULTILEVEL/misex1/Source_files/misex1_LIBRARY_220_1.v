...
module FAU ( 
  ...
  nand3  g37(.a(x3), .b(new_n23_), .c(x0), .O(new_n53_));
  ...
  nand3  g44(.a(new_n59_), .b(new_n56_), .c(new_n24_), .O(z4));
  aoi21  g45(.a(new_n54_), .b(new_n35_), .c(new_n16_), .O(new_n61_));
  nor3   g46(.a(new_n26_), .b(new_n23_), .c(x0), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n61_), .c(new_n18_), .O(new_n63_));
  inv1   g48(.a(new_n58_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n32_), .O(new_n65_));
  ...
  oai21  g55(.a(x4), .b(x2), .c(new_n64_), .O(new_n71_));
