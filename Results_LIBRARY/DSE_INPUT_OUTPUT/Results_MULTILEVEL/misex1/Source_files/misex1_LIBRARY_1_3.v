...
module FAU ( 
  ...
  nand2  g30(.a(x3), .b(new_n17_), .O(new_n46_));
  nand2  g31(.a(new_n18_), .b(x2), .O(new_n47_));
  oai21  g32(.a(new_n46_), .b(x1), .c(new_n47_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(x0), .O(new_n49_));
  nand2  g34(.a(new_n46_), .b(new_n21_), .O(new_n50_));
  nand2  g35(.a(new_n23_), .b(x2), .O(new_n51_));
  nand4  g36(.a(new_n51_), .b(new_n50_), .c(new_n49_), .d(new_n22_), .O(z4));
  xor2a  g37(.a(x3), .b(x2), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(x0), .O(new_n54_));
  nand3  g39(.a(new_n34_), .b(x2), .c(new_n21_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n16_), .O(new_n57_));
  oai21  g42(.a(new_n29_), .b(x3), .c(new_n16_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n17_), .c(new_n21_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n57_), .O(z5));
  nor2   g45(.a(new_n37_), .b(x3), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(x0), .c(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(x1), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n51_), .c(new_n49_), .O(z6));
endmodule
