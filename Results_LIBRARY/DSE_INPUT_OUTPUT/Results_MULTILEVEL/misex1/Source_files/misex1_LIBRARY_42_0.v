...
module FAU ( 
  ...
  oai21  g04(.a(new_n19_), .b(new_n17_), .c(x4), .O(new_n20_));
  ...
  nand3  g15(.a(x3), .b(new_n25_), .c(x0), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(x4), .O(new_n32_));
  ...
  aoi21  g25(.a(new_n40_), .b(new_n16_), .c(new_n36_), .O(new_n41_));
  oai21  g26(.a(new_n41_), .b(x0), .c(new_n33_), .O(z2));
  oai21  g27(.a(x4), .b(x3), .c(x7), .O(new_n43_));
  nand4  g28(.a(new_n43_), .b(new_n25_), .c(x1), .d(new_n17_), .O(new_n44_));
  inv1   g29(.a(x4), .O(new_n45_));
  aoi21  g30(.a(x5), .b(new_n17_), .c(new_n45_), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n18_), .c(x2), .d(new_n16_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n44_), .O(z3));
  nand2  g33(.a(new_n18_), .b(new_n25_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n23_), .O(new_n50_));
  aoi22  g35(.a(new_n50_), .b(x4), .c(new_n19_), .d(x1), .O(new_n51_));
  nand2  g36(.a(new_n31_), .b(new_n19_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(x4), .c(new_n16_), .O(new_n53_));
  oai21  g38(.a(new_n51_), .b(x0), .c(new_n53_), .O(z4));
  xor2a  g39(.a(x3), .b(x2), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(x0), .O(new_n56_));
  nand3  g41(.a(x5), .b(x2), .c(new_n17_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(x4), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n16_), .O(new_n59_));
  nand2  g44(.a(new_n19_), .b(x1), .O(new_n60_));
  oai21  g45(.a(new_n28_), .b(x3), .c(x4), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n25_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n60_), .c(new_n23_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n17_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n59_), .O(z5));
  aoi21  g50(.a(new_n26_), .b(x2), .c(new_n45_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n56_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n16_), .O(new_n68_));
  aoi22  g53(.a(new_n45_), .b(new_n25_), .c(x3), .d(x1), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(x0), .c(new_n68_), .O(z6));
endmodule
