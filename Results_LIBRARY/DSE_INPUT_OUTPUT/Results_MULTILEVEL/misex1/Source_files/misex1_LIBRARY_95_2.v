...
module FAU ( 
  ...
  oai21  g23(.a(x2), .b(new_n19_), .c(new_n38_), .O(z3));
  ...
  aoi21  g31(.a(new_n46_), .b(new_n21_), .c(new_n23_), .O(new_n47_));
  ...
  nand2  g35(.a(new_n40_), .b(new_n23_), .O(new_n51_));
  ...
  oai21  g40(.a(new_n16_), .b(x0), .c(x2), .O(new_n56_));
