...
module FAU ( 
  ...
  aoi21  g46(.a(new_n54_), .b(new_n35_), .c(new_n16_), .O(new_n62_));
  nor3   g47(.a(new_n26_), .b(new_n23_), .c(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n62_), .c(new_n18_), .O(new_n64_));
  nand2  g49(.a(x6), .b(new_n19_), .O(new_n65_));
  nand2  g50(.a(new_n29_), .b(x1), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n65_), .c(x2), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n59_), .c(new_n16_), .O(new_n68_));
  ...
  oai21  g57(.a(x4), .b(x2), .c(new_n58_), .O(new_n73_));
