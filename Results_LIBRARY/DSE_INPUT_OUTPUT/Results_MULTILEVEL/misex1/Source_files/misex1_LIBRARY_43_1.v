...
module FAU ( 
  ...
  nand2  g23(.a(new_n26_), .b(new_n16_), .O(new_n39_));
  ...
  aoi21  g31(.a(x5), .b(new_n17_), .c(new_n16_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n19_), .c(x7), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(x3), .c(new_n46_), .O(z3));
  nor2   g34(.a(x7), .b(x2), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(x3), .c(x1), .O(new_n51_));
  nand2  g36(.a(x3), .b(x2), .O(new_n52_));
  nand2  g37(.a(new_n20_), .b(new_n16_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n54_));
  ...
  aoi21  g43(.a(new_n58_), .b(new_n19_), .c(new_n32_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n55_), .O(z4));
  nand3  g45(.a(new_n21_), .b(new_n20_), .c(x2), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n56_), .c(new_n17_), .O(new_n62_));
  nor2   g47(.a(x3), .b(new_n16_), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n21_), .c(x5), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n62_), .c(new_n19_), .O(new_n66_));
  nand4  g51(.a(new_n21_), .b(x6), .c(new_n20_), .d(new_n16_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n52_), .c(new_n51_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n17_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n66_), .O(z5));
  nand3  g55(.a(new_n63_), .b(new_n21_), .c(new_n24_), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n62_), .c(new_n19_), .O(new_n73_));
  inv1   g58(.a(x4), .O(new_n74_));
  nand3  g59(.a(new_n21_), .b(new_n74_), .c(new_n16_), .O(new_n75_));
