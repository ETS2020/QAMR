...
module FAU ( 
  ...
  oai21  g22(.a(new_n20_), .b(new_n16_), .c(new_n26_), .O(new_n38_));
  ...
  nand3  g30(.a(new_n40_), .b(new_n19_), .c(x0), .O(new_n46_));
  ...
  nand2  g34(.a(x2), .b(x0), .O(new_n50_));
  aoi21  g35(.a(new_n50_), .b(x5), .c(x3), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n16_), .c(new_n19_), .O(new_n52_));
