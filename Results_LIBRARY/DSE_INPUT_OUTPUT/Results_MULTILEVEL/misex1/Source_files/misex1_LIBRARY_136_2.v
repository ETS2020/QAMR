...
module FAU ( 
  ...
  aoi22  g30(.a(new_n45_), .b(new_n44_), .c(new_n32_), .d(x2), .O(new_n46_));
  oai21  g31(.a(new_n42_), .b(x0), .c(new_n46_), .O(z2));
  oai21  g32(.a(x4), .b(x3), .c(x7), .O(new_n48_));
  nand4  g33(.a(new_n48_), .b(new_n25_), .c(x1), .d(new_n16_), .O(new_n49_));
  aoi21  g34(.a(x5), .b(new_n16_), .c(x3), .O(new_n50_));
  aoi21  g35(.a(new_n50_), .b(new_n18_), .c(new_n32_), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n25_), .c(new_n49_), .O(z3));
  ...
  aoi21  g45(.a(new_n53_), .b(new_n43_), .c(new_n16_), .O(new_n61_));
  nand4  g46(.a(x7), .b(x5), .c(x2), .d(new_n16_), .O(new_n62_));
  inv1   g47(.a(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n61_), .c(new_n18_), .O(new_n64_));
  nand2  g49(.a(x7), .b(x3), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(x2), .c(new_n18_), .O(new_n66_));
  oai21  g51(.a(new_n29_), .b(x2), .c(new_n57_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n66_), .c(new_n16_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n64_), .O(z5));
  nand4  g54(.a(x7), .b(new_n37_), .c(new_n19_), .d(x2), .O(new_n70_));
  inv1   g55(.a(new_n70_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n61_), .c(new_n18_), .O(new_n72_));
  inv1   g57(.a(x4), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(x3), .c(new_n25_), .O(new_n74_));
