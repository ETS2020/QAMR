...
module FAU ( 
  ...
  oai21  g48(.a(new_n41_), .b(new_n63_), .c(new_n17_), .O(new_n64_));
  ...
  nand2  g53(.a(new_n35_), .b(new_n16_), .O(new_n69_));
  aoi21  g54(.a(new_n69_), .b(new_n20_), .c(new_n19_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n17_), .c(new_n57_), .O(new_n71_));
