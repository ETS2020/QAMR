...
module FAU ( 
  ...
  nand3  g34(.a(new_n23_), .b(new_n24_), .c(x2), .O(new_n50_));
  ...
  nand3  g38(.a(new_n23_), .b(x3), .c(x2), .O(new_n54_));
  inv1   g39(.a(new_n54_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n53_), .c(new_n17_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n52_), .O(z4));
  aoi21  g42(.a(new_n50_), .b(new_n33_), .c(new_n17_), .O(new_n58_));
  nand4  g43(.a(new_n23_), .b(x5), .c(x2), .d(new_n17_), .O(new_n59_));
  inv1   g44(.a(new_n59_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n58_), .c(new_n22_), .O(new_n61_));
  nand2  g46(.a(new_n23_), .b(x3), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(x2), .c(new_n22_), .O(new_n63_));
  nand3  g48(.a(x6), .b(new_n24_), .c(new_n16_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n54_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n63_), .c(new_n17_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n61_), .O(z5));
  nand4  g52(.a(new_n23_), .b(new_n25_), .c(new_n24_), .d(x2), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n58_), .c(new_n22_), .O(new_n70_));
