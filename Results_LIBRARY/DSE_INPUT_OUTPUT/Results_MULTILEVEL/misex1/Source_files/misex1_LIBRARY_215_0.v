...
module FAU ( 
  ...
  aoi21  g21(.a(new_n31_), .b(x0), .c(new_n22_), .O(new_n37_));
  nand3  g22(.a(x3), .b(x2), .c(new_n16_), .O(new_n38_));
  oai21  g23(.a(new_n37_), .b(x1), .c(new_n38_), .O(z4));
  inv1   g24(.a(x5), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(x1), .c(new_n18_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n16_), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n26_), .c(new_n23_), .O(z5));
  aoi21  g28(.a(new_n34_), .b(x2), .c(new_n31_), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(x1), .c(new_n20_), .O(z6));
endmodule
