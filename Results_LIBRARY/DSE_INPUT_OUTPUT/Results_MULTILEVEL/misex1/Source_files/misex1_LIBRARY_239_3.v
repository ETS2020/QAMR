...
module FAU ( 
  ...
  nand2  g25(.a(new_n20_), .b(new_n16_), .O(new_n41_));
  oai21  g26(.a(x3), .b(new_n19_), .c(x2), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n41_), .c(new_n21_), .O(z4));
  oai21  g28(.a(x3), .b(new_n22_), .c(x1), .O(new_n44_));
  inv1   g29(.a(x5), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(x1), .c(new_n31_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(x2), .O(new_n47_));
  nand3  g32(.a(x6), .b(new_n31_), .c(new_n22_), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n47_), .c(new_n44_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n16_), .O(new_n50_));
  nand4  g35(.a(x3), .b(new_n22_), .c(new_n19_), .d(x0), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n50_), .O(z5));
  nor2   g37(.a(x4), .b(x2), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(x3), .c(x1), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n35_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n16_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n51_), .O(z6));
endmodule
