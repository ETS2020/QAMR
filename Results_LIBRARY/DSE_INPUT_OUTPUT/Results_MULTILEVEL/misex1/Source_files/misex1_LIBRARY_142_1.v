...
module FAU ( 
  ...
  nand3  g17(.a(new_n16_), .b(new_n19_), .c(x0), .O(new_n33_));
  oai21  g18(.a(new_n19_), .b(x0), .c(new_n33_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(x3), .O(new_n35_));
  nand2  g20(.a(new_n23_), .b(x2), .O(new_n36_));
  oai21  g21(.a(x6), .b(x2), .c(new_n36_), .O(new_n37_));
  nand4  g22(.a(new_n37_), .b(new_n20_), .c(new_n19_), .d(new_n17_), .O(new_n38_));
  nand2  g23(.a(x4), .b(new_n16_), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n38_), .c(new_n35_), .O(z2));
  nand2  g25(.a(x7), .b(x3), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(x1), .c(new_n17_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n28_), .O(new_n43_));
