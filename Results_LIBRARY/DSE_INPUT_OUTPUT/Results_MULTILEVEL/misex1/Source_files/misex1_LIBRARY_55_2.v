...
module FAU ( 
  ...
  oai21  g11(.a(new_n26_), .b(x3), .c(new_n21_), .O(new_n27_));
  ...
  nand3  g17(.a(new_n32_), .b(x1), .c(new_n16_), .O(new_n33_));
  inv1   g18(.a(x5), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(x2), .O(new_n35_));
  nand2  g20(.a(new_n26_), .b(new_n22_), .O(new_n36_));
  ...
  nand3  g25(.a(new_n40_), .b(new_n22_), .c(x1), .O(new_n41_));
  nand3  g26(.a(new_n23_), .b(x2), .c(new_n21_), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n41_), .c(x0), .O(z3));
  oai21  g28(.a(x2), .b(x0), .c(new_n21_), .O(new_n44_));
  aoi21  g29(.a(x3), .b(new_n21_), .c(x2), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n18_), .c(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n44_), .O(z4));
  oai21  g32(.a(x3), .b(new_n22_), .c(x1), .O(new_n48_));
  nand3  g33(.a(x6), .b(new_n30_), .c(new_n22_), .O(new_n49_));
  ...
  aoi21  g41(.a(new_n23_), .b(x2), .c(x0), .O(new_n57_));
  oai22  g42(.a(new_n57_), .b(x1), .c(new_n56_), .d(x0), .O(z6));
endmodule
