...
module FAU ( 
  ...
  nand4  g23(.a(new_n38_), .b(new_n17_), .c(x1), .d(new_n21_), .O(new_n39_));
  ...
  aoi22  g28(.a(new_n43_), .b(x0), .c(new_n33_), .d(x2), .O(new_n44_));
  nand2  g29(.a(x3), .b(new_n17_), .O(new_n45_));
  nand2  g30(.a(new_n17_), .b(x0), .O(new_n46_));
  aoi22  g31(.a(new_n46_), .b(x1), .c(new_n45_), .d(new_n21_), .O(new_n47_));
  oai21  g32(.a(new_n44_), .b(x1), .c(new_n47_), .O(z4));
  nand2  g33(.a(new_n18_), .b(x2), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n45_), .c(new_n21_), .O(new_n50_));
  nor2   g35(.a(new_n22_), .b(x0), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n50_), .c(new_n16_), .O(new_n52_));
  nand2  g37(.a(new_n25_), .b(new_n21_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(z5));
  nand2  g39(.a(new_n33_), .b(x2), .O(new_n55_));
  oai21  g40(.a(new_n45_), .b(x1), .c(new_n49_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(x0), .O(new_n57_));
  inv1   g42(.a(x4), .O(new_n58_));
  nor2   g43(.a(new_n58_), .b(x3), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(x0), .c(new_n17_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(x1), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n57_), .c(new_n55_), .O(z6));
endmodule
