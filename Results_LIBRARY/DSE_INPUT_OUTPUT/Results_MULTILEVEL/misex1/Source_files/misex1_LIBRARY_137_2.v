...
module FAU ( 
  ...
  oai21  g09(.a(x7), .b(new_n18_), .c(x1), .O(new_n25_));
  ...
  nand3  g17(.a(x4), .b(new_n18_), .c(new_n16_), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n21_), .c(new_n17_), .O(new_n34_));
  ...
  aoi21  g24(.a(new_n39_), .b(new_n17_), .c(new_n34_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(x0), .c(new_n31_), .O(z2));
  nand2  g26(.a(x7), .b(x4), .O(new_n42_));
  nand4  g27(.a(new_n42_), .b(new_n16_), .c(x1), .d(new_n20_), .O(new_n43_));
  ...
  nand2  g32(.a(new_n16_), .b(x0), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n21_), .c(new_n47_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n17_), .O(new_n50_));
  nand2  g35(.a(x7), .b(x1), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(x3), .c(x2), .O(new_n52_));
  ...
  nand3  g41(.a(x7), .b(x3), .c(new_n16_), .O(new_n57_));
  aoi21  g42(.a(new_n47_), .b(new_n57_), .c(new_n20_), .O(new_n58_));
  ...
  aoi21  g47(.a(new_n62_), .b(new_n21_), .c(new_n17_), .O(new_n63_));
  nand2  g48(.a(x3), .b(x2), .O(new_n64_));
  oai21  g49(.a(new_n26_), .b(x2), .c(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n63_), .c(new_n20_), .O(new_n66_));
  inv1   g51(.a(x7), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(x3), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(new_n66_), .c(new_n61_), .O(z5));
  nand3  g54(.a(new_n35_), .b(new_n18_), .c(x2), .O(new_n70_));
  inv1   g55(.a(new_n70_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n58_), .c(new_n17_), .O(new_n72_));
  inv1   g57(.a(x4), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(new_n18_), .c(new_n16_), .O(new_n74_));
  nand2  g59(.a(new_n74_), .b(new_n21_), .O(new_n75_));
  nand3  g60(.a(new_n75_), .b(x1), .c(new_n20_), .O(new_n76_));
