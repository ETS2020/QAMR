...
module FAU ( 
  ...
  nand3  g31(.a(new_n46_), .b(new_n24_), .c(new_n16_), .O(new_n47_));
  ...
  aoi21  g35(.a(new_n50_), .b(new_n23_), .c(new_n19_), .O(new_n51_));
  ...
  oai21  g42(.a(new_n34_), .b(new_n17_), .c(new_n57_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n23_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n56_), .c(new_n53_), .O(z4));
  nand3  g45(.a(x7), .b(new_n24_), .c(x2), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n34_), .c(new_n17_), .O(new_n62_));
  nand4  g47(.a(x7), .b(x5), .c(x2), .d(new_n17_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n62_), .c(new_n23_), .O(new_n65_));
  nand3  g50(.a(x7), .b(x3), .c(x2), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n30_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n17_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n65_), .O(z5));
  aoi21  g54(.a(new_n57_), .b(new_n34_), .c(new_n17_), .O(new_n70_));
  nand3  g55(.a(new_n25_), .b(new_n24_), .c(x2), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n70_), .c(new_n23_), .O(new_n73_));
