...
module FAU ( 
  ...
  nand3  g34(.a(new_n49_), .b(new_n47_), .c(new_n44_), .O(z4));
  nand3  g35(.a(x6), .b(x3), .c(new_n16_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n42_), .c(new_n17_), .O(new_n52_));
  ...
  nand2  g43(.a(new_n20_), .b(new_n16_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n58_), .c(new_n56_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n46_), .c(new_n17_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n55_), .O(z5));
  nand2  g47(.a(new_n24_), .b(x2), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n52_), .c(new_n19_), .O(new_n65_));
  nand3  g50(.a(x6), .b(new_n31_), .c(new_n16_), .O(new_n66_));
  oai21  g51(.a(new_n48_), .b(new_n20_), .c(new_n66_), .O(new_n67_));
