...
module FAU ( 
  ...
  aoi21  g08(.a(x6), .b(new_n18_), .c(x1), .O(new_n24_));
  oai22  g09(.a(new_n24_), .b(x2), .c(new_n23_), .d(x1), .O(new_n25_));
  nand3  g10(.a(new_n25_), .b(x4), .c(new_n20_), .O(new_n26_));
  nand4  g11(.a(x3), .b(new_n16_), .c(new_n17_), .d(x0), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n26_), .O(z1));
  aoi21  g13(.a(new_n18_), .b(x2), .c(new_n17_), .O(new_n29_));
  ...
  oai21  g19(.a(new_n34_), .b(new_n29_), .c(x4), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(x0), .c(new_n27_), .O(z2));
  inv1   g21(.a(x4), .O(new_n37_));
  nor2   g22(.a(x7), .b(x2), .O(new_n38_));
  aoi21  g23(.a(new_n38_), .b(x1), .c(new_n37_), .O(new_n39_));
  ...
  nor3   g30(.a(new_n37_), .b(new_n16_), .c(x0), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n45_), .c(new_n17_), .O(new_n47_));
  oai21  g32(.a(new_n18_), .b(x1), .c(new_n16_), .O(new_n48_));
  nand2  g33(.a(x3), .b(x2), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(x4), .c(new_n20_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n47_), .O(z4));
  nand4  g37(.a(x5), .b(x4), .c(x2), .d(new_n20_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n44_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n17_), .O(new_n55_));
  inv1   g40(.a(new_n29_), .O(new_n56_));
  nand3  g41(.a(x6), .b(new_n18_), .c(new_n16_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n49_), .c(new_n56_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(x4), .c(new_n20_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n55_), .O(z5));
  nand2  g45(.a(new_n18_), .b(x2), .O(new_n61_));
  nand2  g46(.a(new_n30_), .b(x4), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n61_), .c(new_n44_), .O(new_n63_));
