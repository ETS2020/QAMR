...
module FAU ( 
  ...
  oai21  g07(.a(x2), .b(x0), .c(x6), .O(new_n23_));
  ...
  nand3  g17(.a(new_n32_), .b(x6), .c(x1), .O(new_n33_));
  ...
  nand2  g37(.a(new_n50_), .b(new_n20_), .O(new_n53_));
  nand3  g38(.a(new_n34_), .b(new_n18_), .c(x2), .O(new_n54_));
  ...
  oai21  g42(.a(new_n57_), .b(x0), .c(x6), .O(new_n58_));
  ...
  oai21  g48(.a(new_n57_), .b(new_n17_), .c(new_n63_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(x6), .c(new_n20_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n62_), .O(z5));
  inv1   g51(.a(new_n54_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n52_), .c(new_n17_), .O(new_n68_));
  nor2   g53(.a(x4), .b(x2), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(x3), .c(new_n20_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(x6), .O(new_n71_));
