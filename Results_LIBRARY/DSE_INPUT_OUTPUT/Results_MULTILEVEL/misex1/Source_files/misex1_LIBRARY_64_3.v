...
module FAU ( 
  ...
  oai21  g29(.a(x3), .b(new_n20_), .c(x1), .O(new_n45_));
  ...
  nand2  g35(.a(new_n50_), .b(new_n27_), .O(z5));
  nor2   g36(.a(x4), .b(x2), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(x3), .c(x1), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n38_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n16_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n27_), .O(z6));
endmodule
