...
module FAU ( 
  ...
  nand3  g14(.a(x5), .b(x3), .c(new_n16_), .O(new_n30_));
  ...
  nor2   g42(.a(x5), .b(x2), .O(new_n58_));
  inv1   g43(.a(new_n58_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n57_), .c(new_n54_), .O(z4));
  aoi21  g45(.a(new_n52_), .b(new_n30_), .c(new_n17_), .O(new_n61_));
  nor3   g46(.a(new_n33_), .b(new_n16_), .c(x0), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n61_), .c(new_n19_), .O(new_n63_));
  oai21  g48(.a(new_n35_), .b(x3), .c(new_n19_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(x5), .c(new_n16_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n40_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n17_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n63_), .O(z5));
  nor2   g53(.a(x5), .b(x3), .O(new_n69_));
  oai21  g54(.a(new_n61_), .b(new_n69_), .c(new_n19_), .O(new_n70_));
  inv1   g55(.a(x4), .O(new_n71_));
  nand2  g56(.a(new_n71_), .b(new_n16_), .O(new_n72_));
  aoi21  g57(.a(new_n72_), .b(new_n20_), .c(new_n19_), .O(new_n73_));
  aoi21  g58(.a(new_n73_), .b(new_n17_), .c(new_n58_), .O(new_n74_));
