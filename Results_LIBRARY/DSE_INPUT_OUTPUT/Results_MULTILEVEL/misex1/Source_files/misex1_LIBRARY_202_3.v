...
module FAU ( 
  ...
  oai21  g43(.a(new_n58_), .b(new_n57_), .c(new_n22_), .O(new_n59_));
  aoi21  g44(.a(new_n24_), .b(x2), .c(new_n22_), .O(new_n60_));
  nand2  g45(.a(x3), .b(x2), .O(new_n61_));
  oai21  g46(.a(new_n23_), .b(x3), .c(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n60_), .c(new_n17_), .O(new_n63_));
  nand2  g48(.a(x6), .b(x2), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n63_), .c(new_n59_), .O(z5));
  nand3  g50(.a(new_n25_), .b(new_n24_), .c(x2), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n57_), .c(new_n22_), .O(new_n68_));
  oai21  g53(.a(x4), .b(x2), .c(new_n24_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(x1), .c(new_n17_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n68_), .c(new_n64_), .O(z6));
endmodule
