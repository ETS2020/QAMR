...
module FAU ( 
  ...
  inv1   g11(.a(new_n25_), .O(new_n27_));
  ...
  oai21  g20(.a(new_n34_), .b(new_n27_), .c(new_n35_), .O(z1));
  nand3  g21(.a(new_n25_), .b(x3), .c(x0), .O(new_n37_));
  nand3  g22(.a(new_n24_), .b(new_n19_), .c(new_n16_), .O(new_n38_));
  ...
  aoi21  g27(.a(new_n39_), .b(new_n29_), .c(new_n42_), .O(new_n43_));
  nand2  g28(.a(x4), .b(new_n29_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n19_), .c(new_n18_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n16_), .c(new_n27_), .O(new_n46_));
  oai21  g31(.a(new_n43_), .b(x1), .c(new_n46_), .O(z2));
  ...
  nand3  g35(.a(new_n50_), .b(new_n19_), .c(x2), .O(new_n51_));
  or2    g36(.a(new_n51_), .b(x1), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n49_), .c(new_n25_), .O(z3));
  ...
  nor2   g42(.a(new_n19_), .b(new_n29_), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n57_), .c(new_n16_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n56_), .c(new_n25_), .O(z4));
  aoi21  g45(.a(x5), .b(new_n18_), .c(x3), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(x0), .c(new_n20_), .O(new_n62_));
  nand3  g47(.a(new_n29_), .b(x1), .c(new_n16_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  aoi21  g49(.a(new_n62_), .b(x2), .c(new_n64_), .O(new_n65_));
  aoi21  g50(.a(new_n24_), .b(new_n23_), .c(new_n19_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n18_), .c(x0), .O(new_n67_));
  nand3  g52(.a(x6), .b(new_n19_), .c(new_n16_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n29_), .O(new_n70_));
  oai21  g55(.a(new_n65_), .b(new_n27_), .c(new_n70_), .O(z5));
  nand3  g56(.a(new_n66_), .b(new_n29_), .c(x0), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n51_), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n18_), .O(new_n74_));
  oai21  g59(.a(new_n25_), .b(new_n29_), .c(x3), .O(new_n75_));
