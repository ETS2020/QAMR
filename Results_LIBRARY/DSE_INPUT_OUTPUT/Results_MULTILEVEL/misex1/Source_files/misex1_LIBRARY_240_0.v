...
module FAU ( 
  ...
  oai21  g24(.a(x2), .b(new_n18_), .c(new_n39_), .O(new_n40_));
  ...
  nand2  g28(.a(new_n19_), .b(new_n16_), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n43_), .c(new_n41_), .O(z4));
  ...
  aoi22  g38(.a(new_n46_), .b(x0), .c(new_n53_), .d(x2), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(x1), .c(new_n21_), .O(z6));
endmodule
