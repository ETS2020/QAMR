...
module FAU ( 
  ...
  nor2   g16(.a(new_n31_), .b(new_n20_), .O(new_n32_));
  ...
  nand3  g39(.a(new_n32_), .b(new_n16_), .c(x0), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n19_), .O(new_n57_));
  inv1   g42(.a(new_n40_), .O(new_n58_));
  aoi21  g43(.a(x3), .b(new_n19_), .c(new_n31_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n16_), .c(new_n58_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(x0), .c(new_n57_), .O(z4));
  nand2  g46(.a(x3), .b(new_n16_), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n54_), .c(new_n17_), .O(new_n63_));
  ...
  nand3  g52(.a(new_n67_), .b(new_n66_), .c(new_n40_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n17_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n65_), .c(new_n52_), .O(z5));
  ...
  nand3  g60(.a(new_n75_), .b(new_n73_), .c(new_n52_), .O(z6));
endmodule
