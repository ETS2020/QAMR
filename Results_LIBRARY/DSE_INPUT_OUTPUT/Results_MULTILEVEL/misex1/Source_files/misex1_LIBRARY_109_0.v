...
module FAU ( 
  ...
  nand3  g27(.a(new_n42_), .b(new_n39_), .c(new_n20_), .O(new_n43_));
  ...
  nor2   g42(.a(new_n20_), .b(new_n31_), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n57_), .c(new_n25_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n56_), .c(new_n16_), .O(z4));
  ...
  oai21  g49(.a(new_n35_), .b(x1), .c(new_n20_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(x2), .O(new_n66_));
  nand3  g51(.a(x6), .b(new_n20_), .c(new_n31_), .O(new_n67_));
  ...
  nand3  g58(.a(new_n35_), .b(new_n20_), .c(x2), .O(new_n74_));
