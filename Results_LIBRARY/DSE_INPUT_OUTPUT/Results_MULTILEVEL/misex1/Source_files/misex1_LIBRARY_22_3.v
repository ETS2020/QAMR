...
module FAU ( 
  ...
  aoi22  g28(.a(new_n35_), .b(new_n33_), .c(x4), .d(x2), .O(new_n44_));
  ...
  aoi21  g33(.a(new_n48_), .b(new_n22_), .c(x4), .O(new_n49_));
  ...
  oai21  g50(.a(new_n24_), .b(new_n16_), .c(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n64_), .c(new_n17_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n62_), .c(new_n59_), .O(z5));
  nand3  g53(.a(new_n23_), .b(new_n24_), .c(x2), .O(new_n69_));
  aoi21  g54(.a(new_n69_), .b(new_n34_), .c(new_n17_), .O(new_n70_));
  nand4  g55(.a(new_n25_), .b(new_n23_), .c(new_n24_), .d(x2), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n70_), .c(new_n22_), .O(new_n73_));
  oai21  g58(.a(new_n23_), .b(x3), .c(new_n16_), .O(new_n74_));
