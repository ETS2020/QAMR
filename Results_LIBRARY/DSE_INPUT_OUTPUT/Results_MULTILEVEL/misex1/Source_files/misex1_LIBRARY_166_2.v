...
module FAU ( 
  ...
  oai21  g08(.a(new_n18_), .b(x1), .c(x6), .O(new_n24_));
  ...
  nand3  g15(.a(new_n30_), .b(x6), .c(x1), .O(new_n31_));
  ...
  nand3  g26(.a(new_n41_), .b(new_n16_), .c(new_n20_), .O(new_n42_));
  ...
  nand2  g35(.a(new_n48_), .b(new_n20_), .O(new_n51_));
  ...
  inv1   g39(.a(new_n49_), .O(new_n55_));
  ...
  oai21  g46(.a(new_n55_), .b(new_n17_), .c(new_n61_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(x6), .c(new_n20_), .O(new_n63_));
  ...
  nand2  g53(.a(new_n68_), .b(x6), .O(new_n69_));
