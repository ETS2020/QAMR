...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n22_, new_n23_,
    new_n24_, new_n26_, new_n27_, new_n29_, new_n31_, new_n33_;
  ...
  nand3  g17(.a(new_n26_), .b(new_n31_), .c(x0), .O(z5));
  oai21  g18(.a(new_n19_), .b(x0), .c(new_n16_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x2), .O(z6));
  nand3  g20(.a(new_n31_), .b(x1), .c(x0), .O(z7));
  nand3  g21(.a(new_n29_), .b(x3), .c(new_n20_), .O(z8));
