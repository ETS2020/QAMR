...
module FAU ( 
  ...
  nand3  g16(.a(new_n26_), .b(new_n30_), .c(x0), .O(z5));
  oai21  g17(.a(new_n17_), .b(x0), .c(new_n16_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x2), .O(z6));
  nand3  g19(.a(new_n30_), .b(x1), .c(x0), .O(z7));
  oai21  g20(.a(new_n17_), .b(x2), .c(x3), .O(z8));
  oai21  g21(.a(new_n20_), .b(x2), .c(x3), .O(z9));
endmodule
