...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n29_, new_n30_, new_n31_, new_n33_, new_n35_;
  ...
  oai21  g18(.a(new_n19_), .b(new_n15_), .c(new_n20_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x1), .O(z7));
  nor2   g20(.a(x2), .b(x0), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(x1), .c(x3), .O(z8));
  nand4  g22(.a(x3), .b(new_n19_), .c(new_n16_), .d(x0), .O(z9));
endmodule
