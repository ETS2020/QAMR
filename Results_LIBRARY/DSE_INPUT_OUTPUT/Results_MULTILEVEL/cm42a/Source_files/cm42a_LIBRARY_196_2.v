...
module FAU ( 
  ...
  nand3  g13(.a(x3), .b(new_n24_), .c(new_n18_), .O(new_n31_));
  nand2  g14(.a(new_n31_), .b(new_n19_), .O(new_n32_));
  nand2  g15(.a(x3), .b(x1), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(new_n32_), .O(z8));
  nand3  g17(.a(x3), .b(new_n24_), .c(x0), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n19_), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n33_), .O(z9));
  one    g20(.O(z3));
  one    g21(.O(z6));
  one    g22(.O(z7));
endmodule
