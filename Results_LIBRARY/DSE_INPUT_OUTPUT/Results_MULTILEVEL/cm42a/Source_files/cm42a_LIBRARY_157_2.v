...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n19_, new_n20_, new_n23_, new_n27_, new_n29_;
  ...
  nor2   g09(.a(x3), .b(new_n19_), .O(new_n27_));
  inv1   g10(.a(new_n27_), .O(z7));
  xor2a  g11(.a(x3), .b(x0), .O(new_n29_));
  oai21  g12(.a(new_n27_), .b(new_n16_), .c(new_n29_), .O(z8));
