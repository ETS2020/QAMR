...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n20_, new_n21_, new_n23_, new_n24_,
    new_n26_, new_n27_, new_n30_, new_n34_, new_n35_;
  ...
  oai21  g15(.a(new_n26_), .b(new_n20_), .c(new_n18_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(z6));
  nand4  g17(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g18(.a(x2), .b(x1), .c(x0), .O(new_n34_));
  oai21  g19(.a(new_n20_), .b(new_n15_), .c(new_n18_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n34_), .O(z9));
  one    g21(.O(z8));
endmodule
