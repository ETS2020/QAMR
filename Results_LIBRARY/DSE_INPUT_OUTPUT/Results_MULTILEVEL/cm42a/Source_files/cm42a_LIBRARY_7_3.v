...
module FAU ( 
  ...
  oai21  g13(.a(x1), .b(new_n24_), .c(new_n16_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x2), .O(z5));
  oai21  g15(.a(new_n20_), .b(x0), .c(new_n16_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x2), .O(z6));
  nand4  g17(.a(new_n16_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g18(.a(x3), .b(new_n19_), .c(new_n20_), .d(new_n24_), .O(z8));
