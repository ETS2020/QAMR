...
module FAU ( 
  ...
  oai21  g12(.a(new_n24_), .b(new_n20_), .c(new_n26_), .O(z5));
  nand3  g13(.a(new_n24_), .b(x1), .c(x0), .O(z7));
  inv1   g14(.a(x3), .O(new_n30_));
  nor2   g15(.a(new_n30_), .b(x2), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(x1), .c(new_n15_), .O(z8));
  oai21  g17(.a(new_n31_), .b(new_n20_), .c(new_n26_), .O(z9));
  one    g18(.O(z6));
endmodule
