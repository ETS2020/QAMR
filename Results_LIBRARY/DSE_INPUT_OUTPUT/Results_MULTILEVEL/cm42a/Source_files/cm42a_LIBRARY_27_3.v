...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n25_, new_n27_,
    new_n31_;
  ...
  oai21  g11(.a(x3), .b(new_n17_), .c(new_n15_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(x1), .O(z6));
  nand4  g13(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  oai21  g14(.a(new_n18_), .b(x2), .c(new_n16_), .O(new_n31_));
