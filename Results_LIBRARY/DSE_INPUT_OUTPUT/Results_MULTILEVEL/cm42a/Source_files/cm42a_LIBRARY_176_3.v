...
module FAU ( 
  ...
  nand4  g19(.a(new_n19_), .b(x2), .c(new_n28_), .d(x0), .O(z5));
  nand2  g20(.a(z9), .b(new_n24_), .O(new_n35_));
  oai21  g21(.a(x3), .b(new_n28_), .c(new_n17_), .O(new_n36_));
  nand3  g22(.a(new_n36_), .b(new_n35_), .c(new_n20_), .O(z6));
  nand4  g23(.a(new_n19_), .b(x2), .c(x1), .d(x0), .O(z7));
