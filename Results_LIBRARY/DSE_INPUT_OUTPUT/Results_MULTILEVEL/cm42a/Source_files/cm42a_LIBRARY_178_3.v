...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_, new_n24_,
    new_n25_, new_n26_, new_n28_, new_n29_, new_n32_, new_n33_, new_n34_,
    new_n37_;
  ...
  nand4  g16(.a(new_n19_), .b(x2), .c(new_n28_), .d(new_n17_), .O(z4));
  ...
  oai21  g22(.a(new_n24_), .b(new_n28_), .c(new_n19_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x0), .O(z7));
  oai21  g24(.a(new_n22_), .b(x0), .c(x3), .O(z8));
endmodule
