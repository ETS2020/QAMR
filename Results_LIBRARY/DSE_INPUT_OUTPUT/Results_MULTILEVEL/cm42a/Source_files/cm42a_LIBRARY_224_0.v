...
module FAU ( 
  ...
  wire new_n17_, new_n18_, new_n19_, new_n21_, new_n24_, new_n25_, new_n27_,
    new_n28_, new_n29_;
  ...
  nand4  g05(.a(new_n21_), .b(new_n18_), .c(x1), .d(x0), .O(z3));
  oai21  g06(.a(new_n19_), .b(new_n18_), .c(new_n17_), .O(z4));
  inv1   g07(.a(x0), .O(new_n24_));
  oai21  g08(.a(x3), .b(new_n24_), .c(x2), .O(new_n25_));
  nand2  g09(.a(new_n25_), .b(new_n17_), .O(z5));
  nand3  g10(.a(new_n21_), .b(x2), .c(new_n24_), .O(new_n27_));
  nand2  g11(.a(new_n27_), .b(x1), .O(new_n28_));
  nand2  g12(.a(x2), .b(new_n17_), .O(new_n29_));
