...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n22_, new_n26_, new_n27_,
    new_n28_;
  ...
  nand4  g08(.a(new_n15_), .b(x2), .c(new_n18_), .d(new_n22_), .O(z4));
  nand4  g09(.a(new_n15_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
  nand3  g10(.a(x3), .b(new_n19_), .c(new_n22_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n18_), .O(new_n27_));
  nand2  g12(.a(x3), .b(x1), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n27_), .O(z8));
  nand4  g14(.a(x3), .b(new_n19_), .c(new_n18_), .d(x0), .O(z9));
  one    g15(.O(z7));
