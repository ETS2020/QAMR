...
module FAU ( 
  ...
  nor2   g10(.a(x1), .b(x0), .O(new_n25_));
  oai21  g11(.a(new_n25_), .b(x3), .c(x2), .O(z4));
  inv1   g12(.a(new_n17_), .O(new_n27_));
  nand3  g13(.a(new_n27_), .b(new_n19_), .c(x0), .O(z5));
  nand3  g14(.a(new_n27_), .b(x1), .c(new_n22_), .O(z6));
  nand3  g15(.a(new_n27_), .b(x1), .c(x0), .O(z7));
  oai21  g16(.a(new_n25_), .b(x2), .c(x3), .O(z8));
  nand4  g17(.a(x3), .b(new_n20_), .c(new_n19_), .d(x0), .O(z9));
endmodule
