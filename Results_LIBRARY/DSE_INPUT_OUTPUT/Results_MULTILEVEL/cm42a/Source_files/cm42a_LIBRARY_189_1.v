...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n22_, new_n23_,
    new_n25_, new_n27_, new_n28_, new_n31_, new_n32_, new_n34_, new_n35_;
  ...
  oai21  g14(.a(new_n27_), .b(new_n15_), .c(new_n28_), .O(z4));
  nand4  g15(.a(new_n19_), .b(x2), .c(new_n22_), .d(x0), .O(z5));
  nand3  g16(.a(new_n19_), .b(x1), .c(new_n18_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x2), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n28_), .O(z6));
  nand3  g19(.a(new_n19_), .b(x1), .c(x0), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x2), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n28_), .O(z7));
  nand2  g22(.a(x3), .b(new_n15_), .O(z8));
  one    g23(.O(z9));
endmodule
