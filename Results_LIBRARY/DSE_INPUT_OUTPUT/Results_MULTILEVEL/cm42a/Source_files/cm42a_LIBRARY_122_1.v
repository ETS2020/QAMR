...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n22_, new_n23_,
    new_n25_, new_n26_, new_n28_, new_n32_, new_n33_;
  ...
  nand2  g17(.a(z8), .b(new_n17_), .O(new_n32_));
  oai21  g18(.a(x3), .b(x0), .c(x1), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n32_), .c(new_n22_), .O(z6));
