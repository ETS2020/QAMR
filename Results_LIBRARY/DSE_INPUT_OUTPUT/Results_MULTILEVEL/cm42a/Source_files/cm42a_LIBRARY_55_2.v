...
module FAU ( 
  ...
  oai21  g12(.a(new_n25_), .b(new_n20_), .c(new_n19_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n15_), .O(z6));
  xor2a  g14(.a(x3), .b(x0), .O(new_n31_));
  oai21  g15(.a(new_n23_), .b(new_n16_), .c(new_n31_), .O(z8));
  oai21  g16(.a(new_n16_), .b(new_n15_), .c(x0), .O(z9));
  one    g17(.O(z1));
  one    g18(.O(z7));
  inv1   g19(.a(new_n23_), .O(z5));
endmodule
