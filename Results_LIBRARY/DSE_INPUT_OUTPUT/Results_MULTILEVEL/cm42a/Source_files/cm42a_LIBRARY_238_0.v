...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n21_, new_n23_, new_n24_, new_n26_,
    new_n27_, new_n28_, new_n30_, new_n31_, new_n35_, new_n36_;
  ...
  nand3  g10(.a(new_n18_), .b(x2), .c(new_n16_), .O(new_n27_));
  ...
  oai21  g17(.a(new_n18_), .b(x1), .c(x0), .O(new_n35_));
  oai21  g18(.a(new_n16_), .b(new_n23_), .c(x2), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n35_), .O(z9));
  one    g20(.O(z0));
  one    g21(.O(z2));
  one    g22(.O(z8));
endmodule
