...
module FAU ( 
  ...
  nand3  g09(.a(new_n23_), .b(new_n15_), .c(new_n20_), .O(z4));
  nand3  g10(.a(new_n23_), .b(new_n15_), .c(x0), .O(z5));
  inv1   g11(.a(x3), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(x2), .c(new_n20_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x1), .O(new_n28_));
  nand2  g14(.a(x2), .b(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n28_), .O(z6));
  nand3  g16(.a(new_n26_), .b(x2), .c(x0), .O(new_n31_));
