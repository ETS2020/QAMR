...
module FAU ( 
  ...
  nand2  g10(.a(new_n18_), .b(new_n17_), .O(new_n25_));
  ...
  nand3  g14(.a(new_n18_), .b(x1), .c(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x2), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n25_), .O(z6));
  nand3  g17(.a(new_n18_), .b(x1), .c(x0), .O(new_n32_));
