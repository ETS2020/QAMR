...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n21_, new_n22_, new_n29_, new_n30_,
    new_n31_;
  ...
  nand2  g09(.a(new_n22_), .b(x2), .O(z6));
  nand4  g10(.a(x3), .b(new_n21_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand3  g11(.a(x3), .b(new_n16_), .c(x0), .O(new_n29_));
