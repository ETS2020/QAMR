...
module FAU ( 
  ...
  inv1   g16(.a(new_n17_), .O(new_n31_));
  nand3  g17(.a(new_n31_), .b(new_n20_), .c(x0), .O(z5));
  nand3  g18(.a(new_n31_), .b(x1), .c(new_n24_), .O(z6));
  nand3  g19(.a(new_n31_), .b(x1), .c(x0), .O(z7));
  nand3  g20(.a(new_n29_), .b(x3), .c(new_n19_), .O(z8));
  nand4  g21(.a(x3), .b(new_n19_), .c(new_n20_), .d(x0), .O(z9));
endmodule
