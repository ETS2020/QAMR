...
module FAU ( 
  ...
  nand4  g12(.a(new_n16_), .b(x2), .c(new_n22_), .d(new_n15_), .O(z4));
  nand2  g13(.a(new_n16_), .b(new_n15_), .O(new_n28_));
  oai21  g14(.a(new_n16_), .b(x0), .c(new_n25_), .O(new_n29_));
  oai21  g15(.a(x3), .b(x1), .c(x0), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n29_), .c(new_n28_), .O(z5));
  oai21  g17(.a(x1), .b(x0), .c(x2), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n16_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n15_), .O(z6));
  nand4  g20(.a(new_n16_), .b(x2), .c(x1), .d(x0), .O(z7));
  inv1   g21(.a(new_n19_), .O(z8));
  nand3  g22(.a(new_n17_), .b(x3), .c(x0), .O(z9));
endmodule
