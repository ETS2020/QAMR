...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n23_, new_n24_,
    new_n25_, new_n29_, new_n32_, new_n34_;
  ...
  oai21  g14(.a(new_n20_), .b(new_n16_), .c(x2), .O(z7));
  oai21  g15(.a(new_n18_), .b(x0), .c(new_n17_), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n16_), .O(z8));
  oai21  g17(.a(new_n18_), .b(new_n15_), .c(new_n17_), .O(new_n34_));
