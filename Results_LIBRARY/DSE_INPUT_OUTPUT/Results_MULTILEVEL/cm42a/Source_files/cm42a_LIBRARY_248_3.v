...
module FAU ( 
  ...
  oai21  g12(.a(x1), .b(new_n15_), .c(new_n18_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x2), .O(z5));
  oai21  g14(.a(new_n16_), .b(x0), .c(new_n18_), .O(new_n29_));
  ...
  oai21  g18(.a(x1), .b(new_n15_), .c(new_n17_), .O(new_n33_));
