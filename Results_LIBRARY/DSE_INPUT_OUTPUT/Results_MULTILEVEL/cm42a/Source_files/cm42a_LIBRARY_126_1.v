...
module FAU ( 
  ...
  nand3  g13(.a(new_n19_), .b(new_n22_), .c(x0), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x2), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n27_), .O(z5));
  nand4  g16(.a(new_n19_), .b(x2), .c(x1), .d(new_n18_), .O(z6));
  nand3  g17(.a(new_n19_), .b(x1), .c(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x2), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n27_), .O(z7));
  one    g20(.O(z8));
  one    g21(.O(z9));
endmodule
