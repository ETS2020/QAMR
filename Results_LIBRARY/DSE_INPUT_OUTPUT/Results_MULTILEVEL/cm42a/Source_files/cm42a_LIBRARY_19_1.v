...
module FAU ( 
  ...
  nand3  g13(.a(new_n27_), .b(new_n20_), .c(new_n15_), .O(z4));
  nand3  g14(.a(new_n27_), .b(new_n20_), .c(x0), .O(z5));
  oai21  g15(.a(new_n26_), .b(new_n20_), .c(new_n18_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(z6));
  nand3  g17(.a(new_n27_), .b(x1), .c(x0), .O(z7));
  nand4  g18(.a(x3), .b(new_n26_), .c(new_n20_), .d(x0), .O(z9));
  one    g19(.O(z8));
endmodule
