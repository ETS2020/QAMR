...
module FAU ( 
  ...
  nand4  g07(.a(new_n16_), .b(new_n20_), .c(x1), .d(x0), .O(z3));
  nand2  g08(.a(x3), .b(new_n15_), .O(new_n23_));
  oai22  g09(.a(new_n16_), .b(new_n15_), .c(new_n20_), .d(x1), .O(new_n24_));
  nand2  g10(.a(new_n16_), .b(x0), .O(new_n25_));
  nand3  g11(.a(new_n25_), .b(new_n24_), .c(new_n23_), .O(z4));
  inv1   g12(.a(x1), .O(new_n27_));
  nand4  g13(.a(new_n16_), .b(x2), .c(new_n27_), .d(x0), .O(z5));
  nand3  g14(.a(new_n16_), .b(x2), .c(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n25_), .O(z6));
  oai21  g17(.a(new_n20_), .b(new_n27_), .c(new_n16_), .O(new_n32_));
