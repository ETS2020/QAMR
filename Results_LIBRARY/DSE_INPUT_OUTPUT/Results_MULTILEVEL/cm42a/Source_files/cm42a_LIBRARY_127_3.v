...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n31_, new_n32_, new_n34_, new_n35_;
  ...
  oai21  g12(.a(new_n24_), .b(x1), .c(x2), .O(z4));
  nand4  g13(.a(new_n18_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand2  g14(.a(x2), .b(x1), .O(z6));
  nand3  g15(.a(x3), .b(new_n17_), .c(new_n15_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n16_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n22_), .O(z8));
  nand3  g18(.a(x3), .b(new_n17_), .c(x0), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n16_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n22_), .O(z9));
  one    g21(.O(z7));
endmodule
