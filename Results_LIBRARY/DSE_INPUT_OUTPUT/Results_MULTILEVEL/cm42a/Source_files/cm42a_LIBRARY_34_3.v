...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_, new_n24_,
    new_n27_, new_n28_, new_n29_, new_n31_, new_n32_, new_n33_, new_n36_;
  ...
  nand4  g11(.a(new_n19_), .b(new_n24_), .c(x1), .d(x0), .O(z3));
  inv1   g12(.a(x1), .O(new_n27_));
  nand3  g13(.a(new_n19_), .b(x2), .c(new_n27_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n17_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n20_), .O(z4));
  nand2  g16(.a(x1), .b(x0), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x2), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n19_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x0), .O(z5));
  nand4  g20(.a(new_n19_), .b(x2), .c(x1), .d(new_n17_), .O(z6));
  oai21  g21(.a(new_n24_), .b(new_n27_), .c(new_n19_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x0), .O(z7));
  nand3  g23(.a(new_n22_), .b(x3), .c(new_n17_), .O(z8));
endmodule
