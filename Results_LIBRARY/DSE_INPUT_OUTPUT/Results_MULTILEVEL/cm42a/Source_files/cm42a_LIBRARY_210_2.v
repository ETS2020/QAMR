...
module FAU ( 
  ...
  oai21  g08(.a(new_n24_), .b(x1), .c(new_n19_), .O(new_n25_));
  nand2  g09(.a(new_n25_), .b(new_n15_), .O(z4));
  oai21  g10(.a(new_n24_), .b(new_n20_), .c(new_n19_), .O(new_n28_));
  nand2  g11(.a(new_n28_), .b(new_n15_), .O(z6));
  nand2  g12(.a(new_n15_), .b(x0), .O(z7));
