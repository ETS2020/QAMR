...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n20_, new_n21_, new_n22_, new_n23_,
    new_n24_, new_n26_, new_n29_, new_n30_, new_n31_, new_n34_, new_n35_;
  ...
  nand4  g13(.a(new_n21_), .b(x2), .c(new_n16_), .d(new_n15_), .O(z4));
  ...
  nand2  g19(.a(z9), .b(new_n20_), .O(new_n34_));
  oai21  g20(.a(x3), .b(new_n16_), .c(new_n15_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n34_), .c(new_n24_), .O(z6));
  nand4  g22(.a(new_n21_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g23(.a(x3), .b(new_n20_), .c(new_n16_), .d(new_n15_), .O(z8));
endmodule
