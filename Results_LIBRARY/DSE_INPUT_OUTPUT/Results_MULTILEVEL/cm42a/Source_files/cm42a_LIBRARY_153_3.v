...
module FAU ( 
  ...
  nand4  g20(.a(new_n16_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g21(.a(new_n20_), .b(new_n25_), .c(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x0), .O(z7));
  oai21  g23(.a(new_n17_), .b(x0), .c(x3), .O(z8));
  nand2  g24(.a(x3), .b(x0), .O(z9));
endmodule
