...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_, new_n24_,
    new_n25_, new_n26_, new_n29_, new_n30_, new_n31_, new_n34_, new_n35_,
    new_n37_;
  ...
  nand3  g15(.a(new_n19_), .b(x2), .c(new_n29_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n17_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n20_), .O(z4));
  nand4  g18(.a(new_n19_), .b(x2), .c(new_n29_), .d(x0), .O(z5));
  nand2  g19(.a(z9), .b(new_n24_), .O(new_n34_));
  oai21  g20(.a(x3), .b(new_n29_), .c(new_n17_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n34_), .c(new_n20_), .O(z6));
  oai21  g22(.a(new_n24_), .b(new_n29_), .c(new_n19_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x0), .O(z7));
  nand3  g24(.a(new_n22_), .b(x3), .c(new_n17_), .O(z8));
endmodule
