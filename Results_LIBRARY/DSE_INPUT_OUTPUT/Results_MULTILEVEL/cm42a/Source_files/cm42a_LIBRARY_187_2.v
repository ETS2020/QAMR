...
module FAU ( 
  ...
  oai21  g10(.a(new_n19_), .b(new_n25_), .c(new_n18_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n15_), .O(z5));
  nand4  g12(.a(x3), .b(new_n19_), .c(new_n18_), .d(new_n25_), .O(z8));
  nand3  g13(.a(x3), .b(new_n19_), .c(x0), .O(new_n30_));
  nand2  g14(.a(new_n30_), .b(new_n18_), .O(new_n31_));
