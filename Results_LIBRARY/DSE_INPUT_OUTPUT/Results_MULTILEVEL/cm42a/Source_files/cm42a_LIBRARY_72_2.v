...
module FAU ( 
  ...
  nand2  g09(.a(new_n18_), .b(x1), .O(z7));
  nand3  g10(.a(x3), .b(new_n17_), .c(new_n15_), .O(new_n28_));
  nand2  g11(.a(new_n28_), .b(new_n16_), .O(new_n29_));
  nand2  g12(.a(x3), .b(x1), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(new_n29_), .O(z8));
