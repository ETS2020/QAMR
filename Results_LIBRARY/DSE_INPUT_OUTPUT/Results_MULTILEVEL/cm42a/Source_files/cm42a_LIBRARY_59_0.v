...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n20_, new_n22_, new_n23_, new_n27_;
  ...
  nand4  g11(.a(x3), .b(new_n16_), .c(new_n27_), .d(new_n22_), .O(z8));
  nand4  g12(.a(x3), .b(new_n16_), .c(new_n27_), .d(x0), .O(z9));
  one    g13(.O(z0));
  one    g14(.O(z2));
