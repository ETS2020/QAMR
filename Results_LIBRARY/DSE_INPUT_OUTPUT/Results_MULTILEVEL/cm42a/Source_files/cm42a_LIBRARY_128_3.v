...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_;
  ...
  nor2   g11(.a(x2), .b(new_n24_), .O(new_n26_));
  oai21  g12(.a(new_n26_), .b(x3), .c(x1), .O(z3));
  nand3  g13(.a(new_n16_), .b(x2), .c(new_n24_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n19_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n17_), .O(z4));
  oai21  g16(.a(new_n16_), .b(new_n19_), .c(new_n20_), .O(new_n31_));
  oai21  g17(.a(x3), .b(new_n24_), .c(new_n19_), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n31_), .c(new_n17_), .O(z5));
  nand4  g19(.a(new_n16_), .b(x2), .c(x1), .d(new_n24_), .O(z6));
  nand4  g20(.a(new_n16_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g21(.a(x3), .b(new_n20_), .c(new_n19_), .d(new_n24_), .O(z8));
  oai21  g22(.a(new_n26_), .b(x1), .c(x3), .O(z9));
endmodule
