...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n24_, new_n28_, new_n30_,
    new_n31_;
  ...
  oai21  g08(.a(x3), .b(new_n17_), .c(x0), .O(new_n24_));
  nand3  g09(.a(new_n24_), .b(new_n16_), .c(x0), .O(z5));
  nand2  g10(.a(new_n24_), .b(x1), .O(z7));
  oai21  g11(.a(new_n18_), .b(x2), .c(new_n16_), .O(new_n28_));
  nand2  g12(.a(new_n28_), .b(new_n15_), .O(z8));
  oai22  g13(.a(new_n18_), .b(x2), .c(new_n16_), .d(x0), .O(new_n30_));
