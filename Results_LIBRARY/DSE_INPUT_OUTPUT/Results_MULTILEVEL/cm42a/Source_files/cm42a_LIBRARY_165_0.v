...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n20_, new_n22_, new_n25_, new_n27_;
  ...
  nand4  g11(.a(x3), .b(new_n20_), .c(new_n15_), .d(new_n25_), .O(z8));
  oai21  g12(.a(x2), .b(new_n25_), .c(x3), .O(new_n27_));
