...
module FAU ( 
  ...
  oai21  g11(.a(new_n25_), .b(x1), .c(new_n15_), .O(z4));
  nand3  g12(.a(new_n25_), .b(new_n16_), .c(x0), .O(z5));
  nand2  g13(.a(x1), .b(new_n15_), .O(z6));
  oai21  g14(.a(new_n25_), .b(new_n15_), .c(x1), .O(z7));
  inv1   g15(.a(x3), .O(new_n30_));
  nor2   g16(.a(new_n30_), .b(x2), .O(new_n31_));
  nand3  g17(.a(new_n31_), .b(new_n16_), .c(new_n15_), .O(z8));
  oai21  g18(.a(new_n31_), .b(new_n19_), .c(new_n20_), .O(z9));
endmodule
