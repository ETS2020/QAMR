...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n20_, new_n21_, new_n26_, new_n27_,
    new_n28_;
  ...
  oai22  g12(.a(x3), .b(x0), .c(x2), .d(x1), .O(new_n27_));
  nand2  g13(.a(x3), .b(new_n15_), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n27_), .c(new_n26_), .O(z9));
