...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n21_, new_n22_, new_n23_, new_n24_,
    new_n25_, new_n28_, new_n31_, new_n32_, new_n33_, new_n36_;
  ...
  nand3  g13(.a(new_n28_), .b(new_n17_), .c(x0), .O(z5));
  oai21  g14(.a(new_n28_), .b(new_n17_), .c(new_n16_), .O(z6));
  nand3  g15(.a(new_n22_), .b(x2), .c(x0), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(x1), .O(new_n32_));
  nand2  g17(.a(new_n17_), .b(x0), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n32_), .O(z7));
  nor2   g19(.a(new_n22_), .b(x2), .O(new_n36_));
  oai21  g20(.a(new_n36_), .b(new_n16_), .c(new_n17_), .O(z9));
  one    g21(.O(z0));
  one    g22(.O(z8));
endmodule
