...
module FAU ( 
  ...
  nand2  g06(.a(new_n18_), .b(new_n15_), .O(new_n21_));
  ...
  nand3  g14(.a(new_n16_), .b(x2), .c(x1), .O(z6));
  nand4  g15(.a(new_n19_), .b(x2), .c(x1), .d(x0), .O(z7));
  inv1   g16(.a(x0), .O(new_n31_));
  nand4  g17(.a(x3), .b(new_n18_), .c(new_n15_), .d(new_n31_), .O(z8));
  oai21  g18(.a(new_n19_), .b(new_n31_), .c(new_n18_), .O(new_n33_));
