...
module FAU ( 
  ...
  oai21  g04(.a(new_n19_), .b(new_n16_), .c(new_n17_), .O(z4));
  ...
  nand2  g10(.a(new_n25_), .b(new_n17_), .O(z6));
  oai21  g11(.a(new_n24_), .b(new_n21_), .c(x2), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n17_), .O(z7));
  nand3  g13(.a(new_n19_), .b(x3), .c(new_n16_), .O(z8));
  nand4  g14(.a(x3), .b(new_n16_), .c(new_n24_), .d(x0), .O(z9));
  one    g15(.O(z0));
  nand2  g16(.a(new_n17_), .b(new_n16_), .O(z2));
