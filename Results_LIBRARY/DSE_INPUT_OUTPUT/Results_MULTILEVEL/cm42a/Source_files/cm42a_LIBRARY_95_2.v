...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n23_, new_n24_, new_n25_,
    new_n26_, new_n28_, new_n29_, new_n30_, new_n35_;
  ...
  nand3  g10(.a(new_n19_), .b(x2), .c(new_n24_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n18_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n23_), .O(z4));
  oai21  g13(.a(x3), .b(x1), .c(x2), .O(new_n28_));
  nand3  g14(.a(new_n19_), .b(x2), .c(x0), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n18_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n28_), .O(z5));
  nand4  g17(.a(new_n19_), .b(x2), .c(x1), .d(new_n24_), .O(z6));
  nand4  g18(.a(new_n19_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g19(.a(x3), .b(new_n15_), .c(new_n18_), .d(new_n24_), .O(z8));
  oai21  g20(.a(new_n19_), .b(new_n24_), .c(new_n18_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n15_), .O(z9));
endmodule
