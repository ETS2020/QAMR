...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n20_, new_n26_;
  ...
  oai21  g09(.a(x2), .b(x0), .c(x3), .O(new_n26_));
  nand2  g10(.a(new_n26_), .b(new_n16_), .O(z8));
  nand4  g11(.a(x3), .b(new_n20_), .c(new_n16_), .d(x0), .O(z9));
  one    g12(.O(z0));
  one    g13(.O(z5));
  nand2  g14(.a(new_n17_), .b(new_n16_), .O(z4));
endmodule
