...
module FAU ( 
  ...
  nand3  g09(.a(new_n23_), .b(new_n18_), .c(x1), .O(z3));
  nand2  g10(.a(new_n18_), .b(x1), .O(new_n25_));
  nand3  g11(.a(new_n18_), .b(x2), .c(new_n15_), .O(new_n26_));
  ...
  oai21  g21(.a(new_n23_), .b(x1), .c(x3), .O(z9));
endmodule
