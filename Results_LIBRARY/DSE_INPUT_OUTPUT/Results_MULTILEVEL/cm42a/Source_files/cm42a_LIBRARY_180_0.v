...
module FAU ( 
  ...
  wire new_n17_, new_n18_, new_n20_, new_n22_, new_n24_, new_n28_, new_n29_;
  ...
  nand2  g08(.a(new_n24_), .b(new_n18_), .O(z6));
  nand4  g09(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g10(.a(new_n20_), .b(new_n18_), .c(new_n17_), .O(z8));
  inv1   g11(.a(x0), .O(new_n28_));
  oai21  g12(.a(x1), .b(new_n28_), .c(x3), .O(new_n29_));
