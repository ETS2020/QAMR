...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n26_, new_n30_, new_n33_;
  ...
  nand4  g14(.a(new_n16_), .b(x2), .c(new_n20_), .d(new_n24_), .O(z4));
  oai21  g15(.a(x1), .b(new_n24_), .c(new_n16_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x2), .O(z5));
  nand4  g17(.a(new_n16_), .b(x2), .c(x1), .d(new_n24_), .O(z6));
  oai21  g18(.a(new_n20_), .b(new_n24_), .c(new_n16_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x2), .O(z7));
  nand4  g20(.a(x3), .b(new_n19_), .c(new_n20_), .d(new_n24_), .O(z8));
