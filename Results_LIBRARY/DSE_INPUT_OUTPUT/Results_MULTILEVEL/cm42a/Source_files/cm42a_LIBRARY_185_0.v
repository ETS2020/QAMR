...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n21_, new_n23_, new_n26_;
  ...
  oai21  g10(.a(x2), .b(x1), .c(x3), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n19_), .O(z8));
  nand4  g12(.a(x3), .b(new_n21_), .c(new_n23_), .d(x0), .O(z9));
  one    g13(.O(z0));
  nand2  g14(.a(new_n16_), .b(new_n19_), .O(z4));
