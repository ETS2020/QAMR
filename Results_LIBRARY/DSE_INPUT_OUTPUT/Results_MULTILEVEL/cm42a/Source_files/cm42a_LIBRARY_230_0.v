...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n21_, new_n24_, new_n29_, new_n30_,
    new_n31_;
  ...
  nand2  g11(.a(new_n17_), .b(x0), .O(new_n29_));
  oai22  g12(.a(x3), .b(x0), .c(x2), .d(x1), .O(new_n30_));
  nand2  g13(.a(x3), .b(new_n16_), .O(new_n31_));
  nand3  g14(.a(new_n31_), .b(new_n30_), .c(new_n29_), .O(z9));
  one    g15(.O(z0));
  one    g16(.O(z4));
  one    g17(.O(z6));
endmodule
