...
module FAU ( 
  ...
  nor3   g10(.a(x3), .b(x1), .c(x0), .O(new_n25_));
  oai21  g11(.a(new_n25_), .b(new_n15_), .c(new_n24_), .O(z4));
  nand4  g12(.a(new_n19_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
  inv1   g13(.a(x0), .O(new_n28_));
  nand3  g14(.a(new_n19_), .b(x1), .c(new_n28_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x2), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n24_), .O(z6));
