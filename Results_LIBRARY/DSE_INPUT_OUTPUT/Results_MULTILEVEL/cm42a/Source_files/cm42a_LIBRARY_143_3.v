...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n20_, new_n22_, new_n23_, new_n26_;
  ...
  nand4  g10(.a(new_n16_), .b(x2), .c(new_n22_), .d(new_n15_), .O(z4));
  oai21  g11(.a(new_n20_), .b(x1), .c(new_n16_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x0), .O(z5));
  nand4  g13(.a(new_n16_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g14(.a(new_n16_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g15(.a(new_n17_), .b(x0), .c(x3), .O(z8));
  one    g16(.O(z9));
endmodule
