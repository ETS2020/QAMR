...
module FAU ( 
  ...
  oai21  g09(.a(new_n16_), .b(new_n15_), .c(new_n21_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n20_), .O(z3));
  inv1   g11(.a(new_n17_), .O(new_n26_));
  nor3   g12(.a(x3), .b(x1), .c(x0), .O(new_n27_));
  oai21  g13(.a(new_n27_), .b(new_n20_), .c(new_n26_), .O(z4));
  nand3  g14(.a(new_n21_), .b(new_n16_), .c(x0), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x2), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n26_), .O(z5));
  nand3  g17(.a(new_n21_), .b(x1), .c(new_n15_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x2), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n26_), .O(z6));
  nand4  g20(.a(new_n21_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g21(.a(x3), .b(new_n20_), .O(z8));
  one    g22(.O(z9));
endmodule
