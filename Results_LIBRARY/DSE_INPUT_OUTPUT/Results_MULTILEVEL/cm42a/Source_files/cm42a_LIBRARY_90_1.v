...
module FAU ( 
  ...
  nor2   g16(.a(new_n26_), .b(x2), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n18_), .c(new_n15_), .O(z8));
  nor2   g18(.a(new_n18_), .b(x0), .O(new_n34_));
  xor2a  g19(.a(x1), .b(x0), .O(new_n35_));
  oai21  g20(.a(new_n32_), .b(new_n34_), .c(new_n35_), .O(z9));
  one    g21(.O(z2));
endmodule
