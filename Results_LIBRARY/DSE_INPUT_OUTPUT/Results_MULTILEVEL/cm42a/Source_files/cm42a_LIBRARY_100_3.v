...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n20_, new_n21_, new_n22_, new_n23_,
    new_n24_, new_n28_, new_n29_, new_n30_, new_n33_;
  ...
  oai21  g18(.a(new_n20_), .b(new_n16_), .c(new_n21_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x0), .O(z7));
  nand4  g20(.a(x3), .b(new_n20_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand2  g21(.a(x3), .b(x0), .O(z9));
endmodule
