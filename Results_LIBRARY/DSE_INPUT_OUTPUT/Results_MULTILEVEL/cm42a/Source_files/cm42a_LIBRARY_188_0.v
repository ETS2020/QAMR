...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n21_, new_n24_, new_n27_, new_n29_;
  ...
  nand4  g11(.a(x3), .b(new_n21_), .c(new_n16_), .d(new_n27_), .O(z8));
  oai21  g12(.a(x2), .b(new_n27_), .c(x3), .O(new_n29_));
  nand2  g13(.a(new_n29_), .b(new_n16_), .O(z9));
  one    g14(.O(z0));
  one    g15(.O(z4));
