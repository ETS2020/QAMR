...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n21_, new_n22_, new_n23_,
    new_n24_, new_n26_, new_n27_, new_n30_, new_n32_;
  ...
  oai21  g17(.a(new_n19_), .b(x0), .c(new_n16_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x2), .O(z6));
  nand4  g19(.a(new_n16_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g20(.a(new_n17_), .b(x2), .c(x3), .O(z8));
  nand4  g21(.a(x3), .b(new_n15_), .c(new_n19_), .d(x0), .O(z9));
endmodule
