...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n21_, new_n22_, new_n25_, new_n27_,
  ...
  nand2  g11(.a(x3), .b(new_n15_), .O(z8));
  nand2  g12(.a(z8), .b(new_n21_), .O(new_n27_));
  oai21  g13(.a(x3), .b(x1), .c(x0), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n27_), .c(new_n25_), .O(z5));
  nand4  g15(.a(new_n22_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand3  g16(.a(new_n22_), .b(x2), .c(x1), .O(new_n31_));
