...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n20_, new_n22_, new_n23_, new_n24_,
    new_n26_, new_n29_, new_n30_, new_n33_, new_n34_;
  ...
  nand2  g13(.a(x3), .b(new_n15_), .O(z8));
  nand2  g14(.a(z8), .b(new_n20_), .O(new_n29_));
  oai21  g15(.a(x3), .b(x1), .c(x0), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n29_), .c(new_n24_), .O(z5));
  ...
  nand3  g21(.a(new_n16_), .b(x3), .c(x0), .O(z9));
endmodule
