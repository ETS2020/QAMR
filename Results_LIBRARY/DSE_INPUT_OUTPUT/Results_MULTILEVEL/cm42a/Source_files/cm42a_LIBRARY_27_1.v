...
module FAU ( 
  ...
  nand3  g10(.a(new_n18_), .b(x2), .c(new_n16_), .O(new_n25_));
  ...
  nand2  g17(.a(x3), .b(new_n17_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(z2), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n31_), .c(new_n24_), .O(z9));
endmodule
