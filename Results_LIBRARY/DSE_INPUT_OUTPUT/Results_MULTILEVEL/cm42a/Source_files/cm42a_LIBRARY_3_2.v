...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n26_, new_n28_,
    new_n30_, new_n32_;
  ...
  oai21  g12(.a(x3), .b(new_n15_), .c(x2), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(x1), .O(z7));
  oai21  g14(.a(new_n18_), .b(x0), .c(new_n16_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n17_), .O(z8));
  oai21  g16(.a(new_n18_), .b(new_n15_), .c(new_n16_), .O(new_n32_));
