...
module FAU ( 
  ...
  oai21  g09(.a(new_n16_), .b(new_n15_), .c(new_n17_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n18_), .O(z3));
  nand2  g11(.a(new_n18_), .b(x2), .O(z4));
  nand3  g12(.a(x3), .b(new_n16_), .c(new_n15_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n17_), .O(new_n28_));
  nand2  g14(.a(x3), .b(x2), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n28_), .O(z8));
  nand3  g16(.a(x3), .b(new_n16_), .c(x0), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n17_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n29_), .O(z9));
  nand2  g19(.a(new_n18_), .b(x2), .O(z5));
  nand2  g20(.a(new_n18_), .b(x2), .O(z6));
  nand2  g21(.a(new_n18_), .b(x2), .O(z7));
endmodule
