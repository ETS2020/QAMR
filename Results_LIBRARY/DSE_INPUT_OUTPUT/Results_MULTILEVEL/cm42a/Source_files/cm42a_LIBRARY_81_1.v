...
module FAU ( 
  ...
  nand3  g09(.a(new_n19_), .b(new_n18_), .c(x0), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(x1), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n21_), .O(z3));
  inv1   g12(.a(x0), .O(new_n27_));
  nor2   g13(.a(x3), .b(new_n18_), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n15_), .c(new_n27_), .O(z4));
  nand3  g15(.a(new_n28_), .b(new_n15_), .c(x0), .O(z5));
  nand3  g16(.a(new_n19_), .b(x2), .c(new_n27_), .O(new_n31_));
