...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n24_, new_n28_,
    new_n29_, new_n30_;
  ...
  nor2   g09(.a(x3), .b(new_n17_), .O(new_n24_));
  nand3  g10(.a(new_n24_), .b(new_n16_), .c(new_n15_), .O(z4));
  nand3  g11(.a(new_n24_), .b(new_n16_), .c(x0), .O(z5));
  nand3  g12(.a(new_n24_), .b(x1), .c(new_n15_), .O(z6));
  nand2  g13(.a(new_n18_), .b(new_n16_), .O(new_n28_));
