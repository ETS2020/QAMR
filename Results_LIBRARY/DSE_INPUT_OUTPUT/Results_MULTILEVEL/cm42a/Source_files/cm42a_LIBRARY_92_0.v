...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n19_, new_n21_, new_n22_, new_n26_;
  ...
  nand4  g11(.a(x3), .b(new_n15_), .c(new_n26_), .d(new_n21_), .O(z8));
  nand4  g12(.a(x3), .b(new_n15_), .c(new_n26_), .d(x0), .O(z9));
  one    g13(.O(z2));
