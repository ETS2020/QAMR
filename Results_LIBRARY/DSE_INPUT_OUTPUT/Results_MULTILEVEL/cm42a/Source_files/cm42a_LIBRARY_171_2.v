...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n23_, new_n28_, new_n29_,
    new_n30_;
  ...
  oai21  g07(.a(new_n17_), .b(x0), .c(new_n16_), .O(new_n23_));
  nand2  g08(.a(new_n23_), .b(new_n18_), .O(z4));
