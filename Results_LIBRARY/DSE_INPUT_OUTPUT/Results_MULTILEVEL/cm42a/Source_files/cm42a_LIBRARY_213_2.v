...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n19_, new_n22_, new_n23_, new_n25_, new_n26_,
  ...
  oai21  g06(.a(new_n16_), .b(new_n15_), .c(x0), .O(z3));
  inv1   g07(.a(x2), .O(new_n22_));
  nor2   g08(.a(x3), .b(new_n22_), .O(new_n23_));
  oai21  g09(.a(new_n23_), .b(x0), .c(new_n15_), .O(z4));
  ...
  oai21  g15(.a(new_n23_), .b(new_n15_), .c(x0), .O(z7));
  oai21  g16(.a(new_n25_), .b(x2), .c(new_n19_), .O(new_n31_));
