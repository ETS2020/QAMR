...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n22_, new_n23_,
    new_n24_, new_n28_, new_n29_, new_n32_;
  ...
  oai21  g12(.a(new_n17_), .b(x3), .c(x2), .O(z4));
  inv1   g13(.a(x1), .O(new_n28_));
  inv1   g14(.a(new_n24_), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n28_), .c(x0), .O(z5));
  nand3  g16(.a(new_n29_), .b(x1), .c(new_n19_), .O(z6));
  oai21  g17(.a(new_n28_), .b(new_n19_), .c(new_n16_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x2), .O(z7));
  oai21  g19(.a(new_n17_), .b(x2), .c(x3), .O(z8));
  oai21  g20(.a(new_n20_), .b(x2), .c(x3), .O(z9));
endmodule
