...
module FAU ( 
  ...
  nor2   g10(.a(x3), .b(new_n23_), .O(new_n25_));
  nand3  g11(.a(new_n25_), .b(new_n20_), .c(new_n15_), .O(z4));
  nand3  g12(.a(new_n25_), .b(new_n20_), .c(x0), .O(z5));
  nand3  g13(.a(new_n25_), .b(x1), .c(new_n15_), .O(z6));
  nand3  g14(.a(new_n18_), .b(x2), .c(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x0), .O(new_n30_));
  oai21  g16(.a(new_n20_), .b(new_n15_), .c(new_n18_), .O(new_n31_));
