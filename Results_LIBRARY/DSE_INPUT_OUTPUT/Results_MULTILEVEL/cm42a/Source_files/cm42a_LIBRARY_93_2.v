...
module FAU ( 
  ...
  nand2  g07(.a(new_n22_), .b(new_n15_), .O(new_n23_));
  nand2  g08(.a(x1), .b(x0), .O(new_n24_));
  nand2  g09(.a(new_n24_), .b(new_n23_), .O(z2));
  oai21  g10(.a(new_n17_), .b(new_n16_), .c(x0), .O(z3));
  nand4  g11(.a(new_n21_), .b(x2), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g12(.a(new_n21_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g13(.a(new_n21_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g14(.a(x3), .b(new_n20_), .c(new_n16_), .d(new_n15_), .O(z8));
