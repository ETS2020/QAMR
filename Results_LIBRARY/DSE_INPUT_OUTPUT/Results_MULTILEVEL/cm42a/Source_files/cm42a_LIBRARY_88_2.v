...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n23_, new_n27_, new_n29_,
    new_n30_, new_n31_;
  ...
  oai21  g06(.a(new_n19_), .b(x0), .c(new_n18_), .O(new_n23_));
  nand2  g07(.a(new_n23_), .b(new_n15_), .O(z4));
  nand4  g08(.a(new_n15_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
