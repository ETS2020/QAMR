...
module FAU ( 
  ...
  oai21  g13(.a(x1), .b(new_n22_), .c(new_n16_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x2), .O(z5));
  nand4  g15(.a(new_n16_), .b(x2), .c(x1), .d(new_n22_), .O(z6));
  oai21  g16(.a(new_n19_), .b(new_n22_), .c(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x2), .O(z7));
  nand4  g18(.a(x3), .b(new_n20_), .c(new_n19_), .d(new_n22_), .O(z8));
  nand4  g19(.a(x3), .b(new_n20_), .c(new_n19_), .d(x0), .O(z9));
endmodule
