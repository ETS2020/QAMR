...
module FAU ( 
  ...
  oai21  g14(.a(x2), .b(new_n28_), .c(new_n19_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x0), .O(z3));
  nand3  g16(.a(new_n19_), .b(x2), .c(new_n28_), .O(new_n31_));
  ...
  nand2  g23(.a(z9), .b(new_n24_), .O(new_n38_));
  oai21  g24(.a(x3), .b(new_n28_), .c(new_n17_), .O(new_n39_));
  nand3  g25(.a(new_n39_), .b(new_n38_), .c(new_n20_), .O(z6));
  nand4  g26(.a(new_n19_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g27(.a(new_n22_), .b(x0), .c(x3), .O(z8));
endmodule
