...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_, new_n24_,
    new_n27_, new_n28_, new_n29_, new_n31_, new_n34_;
  ...
  nand3  g17(.a(new_n31_), .b(new_n27_), .c(x0), .O(z5));
  nand3  g18(.a(new_n31_), .b(x1), .c(new_n17_), .O(z6));
  oai21  g19(.a(new_n24_), .b(new_n27_), .c(new_n19_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x0), .O(z7));
  oai21  g21(.a(new_n22_), .b(x0), .c(x3), .O(z8));
endmodule
