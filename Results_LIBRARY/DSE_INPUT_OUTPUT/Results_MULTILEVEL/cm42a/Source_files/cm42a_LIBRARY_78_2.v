...
module FAU ( 
  ...
  nand3  g16(.a(new_n29_), .b(x1), .c(new_n24_), .O(z6));
  oai21  g17(.a(new_n20_), .b(new_n15_), .c(x0), .O(z7));
  nand4  g18(.a(x3), .b(new_n15_), .c(new_n19_), .d(new_n24_), .O(z8));
  nand2  g19(.a(new_n15_), .b(x0), .O(z9));
endmodule
