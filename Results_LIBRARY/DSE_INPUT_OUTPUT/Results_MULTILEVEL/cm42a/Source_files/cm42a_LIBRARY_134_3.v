...
module FAU ( 
  ...
  nand4  g14(.a(new_n21_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g15(.a(new_n20_), .b(new_n16_), .c(new_n21_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x0), .O(z7));
  nor2   g17(.a(x2), .b(x1), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(x0), .c(x3), .O(z8));
