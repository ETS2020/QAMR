...
module FAU ( 
  ...
  nand4  g09(.a(new_n19_), .b(new_n23_), .c(x1), .d(new_n22_), .O(z2));
  inv1   g10(.a(x1), .O(new_n25_));
  oai21  g11(.a(x2), .b(new_n25_), .c(new_n19_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x0), .O(z3));
  oai21  g13(.a(new_n23_), .b(x1), .c(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n17_), .O(z4));
  oai21  g15(.a(new_n23_), .b(x1), .c(new_n19_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x0), .O(z5));
  nand4  g17(.a(new_n19_), .b(x2), .c(x1), .d(new_n22_), .O(z6));
  oai21  g18(.a(new_n23_), .b(new_n25_), .c(new_n19_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x0), .O(z7));
  oai21  g20(.a(new_n20_), .b(x0), .c(x3), .O(z8));
  one    g21(.O(z9));
endmodule
