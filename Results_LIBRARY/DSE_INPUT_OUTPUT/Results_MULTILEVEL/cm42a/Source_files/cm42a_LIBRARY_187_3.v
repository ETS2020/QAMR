...
module FAU ( 
  ...
  nand3  g11(.a(new_n25_), .b(new_n16_), .c(x1), .O(z3));
  ...
  oai21  g16(.a(x3), .b(new_n24_), .c(new_n19_), .O(new_n31_));
  ...
  nand4  g23(.a(x3), .b(new_n20_), .c(new_n19_), .d(new_n24_), .O(z8));
  oai21  g24(.a(new_n25_), .b(x1), .c(x3), .O(z9));
endmodule
