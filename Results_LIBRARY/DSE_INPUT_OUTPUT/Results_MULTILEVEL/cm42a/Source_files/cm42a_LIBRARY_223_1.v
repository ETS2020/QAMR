...
module FAU ( 
  ...
  nand2  g11(.a(new_n18_), .b(new_n17_), .O(new_n26_));
  nor3   g12(.a(x3), .b(x1), .c(x0), .O(new_n27_));
  oai21  g13(.a(new_n27_), .b(new_n17_), .c(new_n26_), .O(z4));
  nand3  g14(.a(new_n18_), .b(new_n16_), .c(x0), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x2), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n26_), .O(z5));
  nand3  g17(.a(new_n18_), .b(x1), .c(new_n15_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x2), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n26_), .O(z6));
  nand3  g20(.a(new_n18_), .b(x1), .c(x0), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x2), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n26_), .O(z7));
  nand2  g23(.a(x3), .b(new_n17_), .O(z8));
  nand2  g24(.a(x3), .b(new_n17_), .O(z9));
endmodule
