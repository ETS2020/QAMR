...
module FAU ( 
  ...
  oai21  g10(.a(new_n25_), .b(x1), .c(new_n15_), .O(z4));
  ...
  nand2  g15(.a(new_n30_), .b(new_n27_), .O(z5));
  nand2  g16(.a(x1), .b(new_n15_), .O(z6));
  oai21  g17(.a(new_n25_), .b(new_n15_), .c(x1), .O(z7));
  oai21  g18(.a(new_n28_), .b(x2), .c(new_n18_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n15_), .O(z8));
  nand4  g20(.a(x3), .b(new_n24_), .c(new_n18_), .d(x0), .O(z9));
  one    g21(.O(z2));
endmodule
