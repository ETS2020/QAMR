...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n23_, new_n25_, new_n26_, new_n30_;
  ...
  oai21  g10(.a(x3), .b(new_n25_), .c(x1), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n15_), .O(z6));
  nand3  g12(.a(new_n26_), .b(x1), .c(x0), .O(z7));
  nor2   g13(.a(new_n23_), .b(x2), .O(new_n30_));
  oai21  g14(.a(new_n30_), .b(new_n15_), .c(new_n16_), .O(z9));
  one    g15(.O(z4));
  one    g16(.O(z8));
endmodule
