...
module FAU ( 
  ...
  nand3  g13(.a(new_n16_), .b(x2), .c(x1), .O(z6));
  oai21  g14(.a(new_n19_), .b(new_n15_), .c(x2), .O(z7));
  nand4  g15(.a(x3), .b(new_n22_), .c(new_n15_), .d(new_n18_), .O(z8));
  oai21  g16(.a(new_n25_), .b(new_n18_), .c(new_n22_), .O(new_n32_));
