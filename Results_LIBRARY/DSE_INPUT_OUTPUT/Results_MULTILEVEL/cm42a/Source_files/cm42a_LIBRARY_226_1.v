...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n20_, new_n26_, new_n27_;
  ...
  oai21  g09(.a(new_n16_), .b(new_n15_), .c(x2), .O(z5));
  nand2  g10(.a(x2), .b(new_n15_), .O(z6));
  inv1   g11(.a(x1), .O(new_n26_));
  oai21  g12(.a(x3), .b(new_n26_), .c(x0), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x2), .O(z7));
  nand4  g14(.a(x3), .b(new_n18_), .c(new_n26_), .d(new_n15_), .O(z8));
  nand4  g15(.a(x3), .b(new_n18_), .c(new_n26_), .d(x0), .O(z9));
endmodule
