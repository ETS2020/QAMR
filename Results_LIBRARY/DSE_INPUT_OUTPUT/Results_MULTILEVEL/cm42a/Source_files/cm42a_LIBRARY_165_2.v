...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n24_, new_n25_,
    new_n27_, new_n31_, new_n32_, new_n33_;
  ...
  oai21  g11(.a(new_n24_), .b(new_n18_), .c(new_n19_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n15_), .O(z5));
  nand4  g13(.a(x3), .b(new_n24_), .c(new_n19_), .d(new_n18_), .O(z8));
  nand3  g14(.a(x3), .b(new_n24_), .c(x0), .O(new_n31_));
