...
module FAU ( 
  ...
  oai21  g09(.a(new_n21_), .b(x1), .c(x2), .O(z4));
  oai21  g10(.a(x3), .b(new_n15_), .c(new_n16_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x2), .O(z5));
  nand2  g12(.a(x2), .b(x1), .O(z6));
  nor2   g13(.a(new_n18_), .b(x2), .O(new_n29_));
  nand3  g14(.a(new_n29_), .b(new_n16_), .c(new_n15_), .O(z8));
  nand3  g15(.a(new_n29_), .b(new_n16_), .c(x0), .O(z9));
  one    g16(.O(z7));
endmodule
