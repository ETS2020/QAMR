...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_, new_n24_,
    new_n25_, new_n26_, new_n28_, new_n29_, new_n33_, new_n34_, new_n36_;
  ...
  nand4  g17(.a(new_n19_), .b(x2), .c(new_n28_), .d(x0), .O(z5));
  nand2  g18(.a(z9), .b(new_n24_), .O(new_n33_));
  oai21  g19(.a(x3), .b(new_n28_), .c(new_n17_), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(new_n33_), .c(new_n20_), .O(z6));
  oai21  g21(.a(new_n24_), .b(new_n28_), .c(new_n19_), .O(new_n36_));
