...
module FAU ( 
  ...
  oai21  g13(.a(new_n23_), .b(x1), .c(new_n18_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n15_), .O(z4));
  nand2  g15(.a(x3), .b(new_n15_), .O(z8));
  nand2  g16(.a(z8), .b(new_n23_), .O(new_n31_));
  oai21  g17(.a(x3), .b(x1), .c(x0), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n31_), .c(new_n26_), .O(z5));
  nand4  g19(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g20(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g21(.a(new_n16_), .b(new_n15_), .c(x3), .O(z9));
endmodule
