...
module FAU ( 
  ...
  oai21  g06(.a(new_n20_), .b(x2), .c(new_n16_), .O(z1));
  ...
  oai21  g15(.a(new_n20_), .b(new_n16_), .c(x2), .O(z7));
  nor2   g16(.a(new_n18_), .b(x2), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n16_), .c(new_n15_), .O(z8));
  nand3  g18(.a(new_n32_), .b(new_n16_), .c(x0), .O(z9));
  one    g19(.O(z4));
endmodule
