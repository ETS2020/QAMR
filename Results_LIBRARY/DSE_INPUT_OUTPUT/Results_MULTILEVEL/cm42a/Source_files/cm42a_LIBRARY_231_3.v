...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n22_, new_n23_,
    new_n24_, new_n26_, new_n27_, new_n30_, new_n32_, new_n36_;
  ...
  nand4  g14(.a(new_n16_), .b(x2), .c(new_n19_), .d(new_n22_), .O(z4));
  inv1   g15(.a(new_n17_), .O(new_n30_));
  ...
  nand4  g20(.a(x3), .b(new_n20_), .c(new_n19_), .d(new_n22_), .O(z8));
  oai21  g21(.a(x1), .b(new_n22_), .c(new_n20_), .O(new_n36_));
