...
module FAU ( 
  ...
  xnor2a g10(.a(x3), .b(x0), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n24_), .O(z4));
  inv1   g12(.a(x3), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand4  g14(.a(new_n27_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g15(.a(new_n22_), .b(new_n16_), .c(new_n27_), .O(new_n30_));
