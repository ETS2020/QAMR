...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n24_, new_n27_, new_n28_,
  ...
  oai21  g08(.a(new_n17_), .b(new_n15_), .c(new_n16_), .O(new_n24_));
  nand2  g09(.a(new_n24_), .b(new_n18_), .O(z5));
  ...
  one    g17(.O(z2));
  one    g18(.O(z6));
  nand2  g19(.a(new_n18_), .b(x1), .O(z7));
endmodule
