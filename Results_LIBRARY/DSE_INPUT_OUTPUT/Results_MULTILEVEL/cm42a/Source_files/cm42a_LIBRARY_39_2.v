...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n23_, new_n24_, new_n25_,
    new_n26_, new_n27_, new_n29_, new_n30_, new_n31_, new_n33_, new_n37_;
  ...
  oai21  g13(.a(x3), .b(x1), .c(x2), .O(new_n29_));
  nand3  g14(.a(new_n25_), .b(x2), .c(x0), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n24_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n29_), .O(z5));
  aoi21  g17(.a(x1), .b(x0), .c(x3), .O(new_n33_));
  oai21  g18(.a(new_n33_), .b(new_n15_), .c(x1), .O(z6));
  oai21  g19(.a(new_n19_), .b(new_n15_), .c(x1), .O(z7));
  nand4  g20(.a(x3), .b(new_n15_), .c(new_n24_), .d(new_n18_), .O(z8));
  oai21  g21(.a(new_n25_), .b(new_n18_), .c(new_n24_), .O(new_n37_));
