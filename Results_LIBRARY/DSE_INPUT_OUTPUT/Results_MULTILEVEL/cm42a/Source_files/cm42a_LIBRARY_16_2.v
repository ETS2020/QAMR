...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n24_, new_n28_, new_n29_,
    new_n30_;
  ...
  oai21  g07(.a(new_n17_), .b(new_n15_), .c(new_n16_), .O(new_n24_));
  nand2  g08(.a(new_n24_), .b(new_n18_), .O(z5));
  nand2  g09(.a(new_n18_), .b(x1), .O(z6));
  nand4  g10(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand3  g11(.a(x3), .b(new_n17_), .c(x0), .O(new_n28_));
  nand2  g12(.a(new_n28_), .b(new_n16_), .O(new_n29_));
  nand2  g13(.a(x3), .b(x1), .O(new_n30_));
  nand2  g14(.a(new_n30_), .b(new_n29_), .O(z9));
  one    g15(.O(z2));
  one    g16(.O(z3));
