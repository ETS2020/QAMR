...
module FAU ( 
  ...
  nor2   g13(.a(x3), .b(new_n20_), .O(new_n29_));
  nand3  g14(.a(new_n29_), .b(x1), .c(new_n19_), .O(z6));
  oai21  g15(.a(new_n29_), .b(new_n15_), .c(x0), .O(z7));
  nand4  g16(.a(x3), .b(new_n20_), .c(new_n15_), .d(new_n19_), .O(z8));
