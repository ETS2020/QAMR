...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n21_, new_n22_, new_n23_, new_n26_,
    new_n27_, new_n30_, new_n31_, new_n32_, new_n35_;
  ...
  nand3  g14(.a(new_n30_), .b(x2), .c(x0), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(x1), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n21_), .O(z7));
  nor2   g17(.a(new_n30_), .b(x2), .O(new_n35_));
  oai21  g18(.a(new_n35_), .b(new_n19_), .c(new_n16_), .O(z9));
  one    g19(.O(z0));
  one    g20(.O(z4));
  one    g21(.O(z8));
endmodule
