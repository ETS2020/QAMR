...
module FAU ( 
  ...
  oai21  g10(.a(new_n17_), .b(x0), .c(new_n18_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n16_), .O(z4));
  nand4  g12(.a(new_n18_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nor2   g13(.a(x3), .b(new_n17_), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(x1), .c(new_n15_), .O(z6));
  nand3  g15(.a(new_n28_), .b(x1), .c(x0), .O(z7));
  nand2  g16(.a(x3), .b(new_n16_), .O(z8));
  one    g17(.O(z9));
endmodule
