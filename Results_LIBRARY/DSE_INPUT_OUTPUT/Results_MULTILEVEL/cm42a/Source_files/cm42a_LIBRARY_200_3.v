...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n23_, new_n26_,
    new_n27_, new_n28_, new_n32_, new_n34_;
  ...
  oai21  g11(.a(x3), .b(x1), .c(new_n26_), .O(new_n27_));
  oai21  g12(.a(new_n20_), .b(x0), .c(new_n19_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n27_), .O(z4));
  nand4  g14(.a(new_n21_), .b(x2), .c(new_n19_), .d(x0), .O(z5));
  nand4  g15(.a(new_n21_), .b(x2), .c(x1), .d(new_n26_), .O(z6));
  oai21  g16(.a(new_n21_), .b(x2), .c(z7), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n17_), .O(z8));
  oai21  g18(.a(new_n21_), .b(x2), .c(new_n19_), .O(new_n34_));
