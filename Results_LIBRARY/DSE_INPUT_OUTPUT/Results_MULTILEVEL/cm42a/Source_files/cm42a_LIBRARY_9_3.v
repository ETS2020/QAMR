...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n22_, new_n24_,
    new_n25_, new_n27_, new_n29_, new_n31_, new_n35_;
  ...
  nand3  g13(.a(new_n27_), .b(new_n16_), .c(x2), .O(z4));
  inv1   g14(.a(new_n17_), .O(new_n29_));
  nand3  g15(.a(new_n24_), .b(new_n29_), .c(x0), .O(z5));
  oai21  g16(.a(new_n19_), .b(x0), .c(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x2), .O(z6));
  nand3  g18(.a(new_n29_), .b(x1), .c(x0), .O(z7));
  oai21  g19(.a(new_n27_), .b(x2), .c(x3), .O(z8));
