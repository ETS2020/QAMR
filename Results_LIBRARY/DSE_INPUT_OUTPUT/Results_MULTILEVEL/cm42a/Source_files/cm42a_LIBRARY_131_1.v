...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n22_, new_n23_,
    new_n25_, new_n26_, new_n27_, new_n30_, new_n32_, new_n33_;
  ...
  nand3  g11(.a(new_n19_), .b(new_n25_), .c(x0), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x1), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n23_), .O(z3));
  nand4  g14(.a(new_n19_), .b(x2), .c(new_n15_), .d(new_n18_), .O(z4));
  oai21  g15(.a(new_n25_), .b(new_n18_), .c(new_n19_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(z5));
  nand3  g17(.a(new_n19_), .b(x2), .c(new_n18_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x1), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n23_), .O(z6));
