...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n21_, new_n22_, new_n23_, new_n24_,
    new_n25_, new_n28_, new_n30_, new_n31_;
  ...
  nand2  g10(.a(new_n22_), .b(new_n16_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n24_), .O(z3));
  nand4  g12(.a(new_n22_), .b(x2), .c(new_n16_), .d(new_n15_), .O(z4));
  oai21  g13(.a(new_n21_), .b(new_n15_), .c(new_n22_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n16_), .O(z5));
  nand3  g15(.a(new_n22_), .b(x2), .c(new_n15_), .O(new_n30_));
