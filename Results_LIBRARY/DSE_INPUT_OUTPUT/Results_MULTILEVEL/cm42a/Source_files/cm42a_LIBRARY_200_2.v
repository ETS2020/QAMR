...
module FAU ( 
  ...
  nand3  g10(.a(new_n16_), .b(x1), .c(x0), .O(z3));
  nor2   g11(.a(x3), .b(new_n20_), .O(new_n27_));
  oai21  g12(.a(new_n27_), .b(x0), .c(new_n15_), .O(z4));
  nand3  g13(.a(new_n27_), .b(x1), .c(new_n19_), .O(z6));
  oai21  g14(.a(new_n27_), .b(new_n15_), .c(x0), .O(z7));
  oai21  g15(.a(new_n21_), .b(x2), .c(new_n19_), .O(new_n32_));
