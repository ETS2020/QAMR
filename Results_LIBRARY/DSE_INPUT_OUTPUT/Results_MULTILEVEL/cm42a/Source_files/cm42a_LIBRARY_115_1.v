...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n20_, new_n21_, new_n22_, new_n24_,
    new_n26_, new_n27_, new_n31_, new_n32_;
  ...
  nand4  g14(.a(new_n21_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand4  g15(.a(new_n21_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand3  g16(.a(new_n21_), .b(x1), .c(x0), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x2), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n26_), .O(z7));
  nand2  g19(.a(x3), .b(new_n20_), .O(z8));
  nand2  g20(.a(x3), .b(new_n20_), .O(z9));
endmodule
