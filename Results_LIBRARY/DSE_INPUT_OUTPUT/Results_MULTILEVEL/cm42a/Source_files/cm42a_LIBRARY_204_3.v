...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n26_, new_n27_, new_n34_, new_n35_;
  ...
  oai21  g13(.a(new_n27_), .b(x2), .c(x1), .O(z3));
  oai21  g14(.a(new_n24_), .b(x1), .c(x2), .O(z4));
  oai21  g15(.a(new_n27_), .b(x1), .c(x2), .O(z5));
  nand4  g16(.a(x3), .b(new_n16_), .c(new_n19_), .d(new_n26_), .O(z8));
  nand3  g17(.a(x3), .b(new_n16_), .c(x0), .O(new_n34_));
  nand2  g18(.a(new_n34_), .b(new_n19_), .O(new_n35_));
  nand2  g19(.a(new_n35_), .b(new_n17_), .O(z9));
  one    g20(.O(z6));
  one    g21(.O(z7));
endmodule
