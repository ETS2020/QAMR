...
module FAU ( 
  ...
  oai21  g10(.a(new_n16_), .b(new_n15_), .c(x2), .O(z5));
  nand4  g11(.a(new_n22_), .b(x2), .c(x1), .d(x0), .O(z7));
  nor2   g12(.a(new_n22_), .b(x1), .O(new_n29_));
  oai21  g13(.a(new_n29_), .b(x2), .c(new_n15_), .O(z8));
  oai21  g14(.a(new_n29_), .b(new_n19_), .c(new_n20_), .O(z9));
  one    g15(.O(z4));
  one    g16(.O(z6));
endmodule
