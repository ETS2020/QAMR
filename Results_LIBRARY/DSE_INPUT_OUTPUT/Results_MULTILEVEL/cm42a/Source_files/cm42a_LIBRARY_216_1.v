...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n22_, new_n23_,
    new_n25_, new_n27_, new_n30_, new_n32_, new_n33_, new_n34_;
  ...
  oai21  g15(.a(new_n25_), .b(new_n22_), .c(new_n16_), .O(new_n30_));
  ...
  nand4  g21(.a(x3), .b(new_n25_), .c(new_n22_), .d(x0), .O(z9));
  one    g22(.O(z8));
endmodule
