...
module FAU ( 
  ...
  nand3  g14(.a(new_n24_), .b(x2), .c(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n28_), .O(z5));
  nand2  g17(.a(x1), .b(new_n15_), .O(z6));
  nand3  g18(.a(new_n26_), .b(x1), .c(x0), .O(z7));
  nor2   g19(.a(new_n24_), .b(x2), .O(new_n34_));
  oai21  g20(.a(new_n34_), .b(x1), .c(new_n15_), .O(z8));
