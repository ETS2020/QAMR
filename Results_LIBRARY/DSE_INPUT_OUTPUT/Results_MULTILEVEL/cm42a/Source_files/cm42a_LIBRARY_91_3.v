...
module FAU ( 
  ...
  oai21  g10(.a(x3), .b(new_n15_), .c(new_n17_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x1), .O(z3));
  nor2   g12(.a(x3), .b(x0), .O(new_n27_));
  oai21  g13(.a(new_n27_), .b(x1), .c(x2), .O(z4));
  nand4  g14(.a(new_n18_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nor2   g15(.a(new_n18_), .b(x2), .O(new_n32_));
  nand3  g16(.a(new_n32_), .b(new_n16_), .c(new_n15_), .O(z8));
  nand3  g17(.a(new_n32_), .b(new_n16_), .c(x0), .O(z9));
  one    g18(.O(z6));
  one    g19(.O(z7));
endmodule
