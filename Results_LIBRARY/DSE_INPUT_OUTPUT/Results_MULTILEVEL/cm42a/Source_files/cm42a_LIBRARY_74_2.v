...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n22_, new_n25_,
    new_n26_, new_n27_, new_n28_, new_n31_, new_n32_, new_n33_, new_n36_;
  ...
  oai21  g15(.a(x3), .b(x0), .c(x2), .O(new_n31_));
  nand3  g16(.a(new_n18_), .b(x2), .c(x1), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n15_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n31_), .O(z6));
  oai21  g19(.a(new_n21_), .b(new_n17_), .c(x0), .O(z7));
  oai21  g20(.a(new_n18_), .b(x1), .c(new_n15_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n17_), .O(z8));
  one    g22(.O(z3));
  nand2  g23(.a(new_n17_), .b(x0), .O(z9));
endmodule
