...
module FAU ( 
  ...
  wire new_n17_, new_n18_, new_n19_, new_n21_, new_n22_, new_n25_, new_n27_,
    new_n28_, new_n29_;
  ...
  oai21  g05(.a(x3), .b(new_n21_), .c(x1), .O(new_n22_));
  nand2  g06(.a(new_n22_), .b(new_n18_), .O(z3));
  oai21  g07(.a(new_n19_), .b(new_n18_), .c(new_n17_), .O(z4));
  inv1   g08(.a(x3), .O(new_n25_));
  nand4  g09(.a(new_n25_), .b(x2), .c(new_n17_), .d(x0), .O(z5));
  nand2  g10(.a(x2), .b(new_n17_), .O(new_n27_));
  nand3  g11(.a(new_n25_), .b(x2), .c(new_n21_), .O(new_n28_));
  nand2  g12(.a(new_n28_), .b(x1), .O(new_n29_));
  nand2  g13(.a(new_n29_), .b(new_n27_), .O(z6));
  nand4  g14(.a(new_n25_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g15(.a(new_n18_), .b(new_n17_), .O(z8));
  one    g16(.O(z0));
  one    g17(.O(z1));
  nand2  g18(.a(new_n18_), .b(new_n17_), .O(z9));
endmodule
