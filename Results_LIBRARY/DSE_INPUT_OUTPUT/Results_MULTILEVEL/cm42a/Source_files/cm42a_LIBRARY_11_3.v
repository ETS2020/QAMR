...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n22_, new_n23_, new_n24_, new_n25_,
    new_n27_, new_n28_, new_n32_, new_n33_, new_n35_;
  ...
  nand3  g19(.a(new_n33_), .b(new_n22_), .c(new_n32_), .O(z8));
  oai21  g20(.a(new_n23_), .b(x2), .c(new_n16_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x0), .O(z9));
endmodule
