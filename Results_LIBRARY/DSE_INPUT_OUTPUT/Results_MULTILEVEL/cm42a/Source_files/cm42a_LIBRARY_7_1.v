...
module FAU ( 
  ...
  nand4  g11(.a(new_n19_), .b(x2), .c(new_n25_), .d(new_n18_), .O(z4));
  inv1   g12(.a(new_n22_), .O(new_n27_));
  nand3  g13(.a(new_n19_), .b(new_n25_), .c(x0), .O(new_n28_));
  ...
  nand2  g18(.a(new_n32_), .b(new_n27_), .O(z6));
