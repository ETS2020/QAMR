...
module FAU ( 
  ...
  nand2  g11(.a(new_n25_), .b(new_n23_), .O(z4));
  nand4  g12(.a(new_n18_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  aoi21  g13(.a(x1), .b(x0), .c(x3), .O(new_n28_));
  oai21  g14(.a(new_n28_), .b(new_n17_), .c(x1), .O(z6));
  nand4  g15(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g16(.a(new_n18_), .b(x0), .c(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n17_), .O(z8));
  oai21  g18(.a(new_n18_), .b(new_n15_), .c(new_n16_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n17_), .O(z9));
endmodule
