...
module FAU ( 
  ...
  nand2  g08(.a(new_n15_), .b(x1), .O(z3));
  inv1   g09(.a(x3), .O(new_n24_));
  nand4  g10(.a(new_n24_), .b(x2), .c(new_n19_), .d(new_n18_), .O(z4));
  nand4  g11(.a(new_n24_), .b(x2), .c(new_n19_), .d(x0), .O(z5));
  aoi21  g12(.a(x1), .b(x0), .c(x3), .O(new_n27_));
  oai21  g13(.a(new_n27_), .b(new_n15_), .c(x1), .O(z6));
  oai21  g14(.a(x3), .b(new_n18_), .c(x2), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x1), .O(z7));
  nand4  g16(.a(x3), .b(new_n15_), .c(new_n19_), .d(new_n18_), .O(z8));
  oai21  g17(.a(new_n24_), .b(new_n18_), .c(new_n19_), .O(new_n32_));
