...
module FAU ( 
  ...
  oai21  g25(.a(new_n47_), .b(new_n32_), .c(new_n24_), .O(z10));
  nand4  g26(.a(new_n23_), .b(new_n31_), .c(x1), .d(new_n42_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n28_), .O(z11));
  nand4  g28(.a(x3), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n28_), .O(z12));
  nand3  g30(.a(x4), .b(new_n31_), .c(new_n42_), .O(new_n53_));
  aoi21  g31(.a(new_n53_), .b(x3), .c(x1), .O(z14));
  zero   g32(.O(z05));
  zero   g33(.O(z15));
  inv1   g34(.a(new_n24_), .O(z13));
endmodule
