...
module FAU ( 
  ...
  oai21  g35(.a(new_n56_), .b(new_n55_), .c(new_n43_), .O(z13));
  oai21  g36(.a(new_n55_), .b(new_n49_), .c(new_n43_), .O(z14));
  oai21  g37(.a(new_n55_), .b(new_n51_), .c(new_n43_), .O(z15));
endmodule
