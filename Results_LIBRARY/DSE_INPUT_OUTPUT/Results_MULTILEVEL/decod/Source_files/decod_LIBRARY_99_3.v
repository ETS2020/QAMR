...
module FAU ( 
  ...
  nand4  g21(.a(new_n30_), .b(new_n33_), .c(x1), .d(new_n25_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n29_), .O(z11));
  nand2  g23(.a(new_n26_), .b(new_n25_), .O(new_n46_));
  oai21  g24(.a(new_n46_), .b(new_n27_), .c(new_n22_), .O(z12));
  nand4  g25(.a(new_n30_), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n48_));
