...
module FAU ( 
  ...
  nand3  g27(.a(x4), .b(new_n28_), .c(new_n31_), .O(new_n50_));
  oai21  g28(.a(new_n50_), .b(new_n49_), .c(new_n27_), .O(z11));
  aoi21  g29(.a(new_n43_), .b(new_n28_), .c(x1), .O(z13));
  nand4  g30(.a(new_n28_), .b(new_n31_), .c(new_n26_), .d(new_n42_), .O(new_n54_));
