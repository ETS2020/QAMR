...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n37_, new_n39_, new_n42_, new_n47_;
  ...
  nor2   g18(.a(new_n39_), .b(new_n31_), .O(z09));
  oai21  g19(.a(new_n37_), .b(new_n29_), .c(new_n35_), .O(z10));
  nand4  g20(.a(new_n25_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n31_), .O(z11));
  ...
  nand3  g25(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n22_), .c(x1), .O(z15));
