...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n46_,
    new_n48_, new_n51_;
  ...
  nand4  g22(.a(x3), .b(x2), .c(new_n30_), .d(new_n33_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n23_), .O(z12));
  nand3  g24(.a(x4), .b(new_n22_), .c(x2), .O(new_n48_));
  aoi21  g25(.a(new_n48_), .b(new_n30_), .c(x0), .O(z13));
  aoi21  g26(.a(new_n40_), .b(new_n30_), .c(x0), .O(z14));
  nand4  g27(.a(new_n22_), .b(new_n27_), .c(new_n30_), .d(new_n33_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n23_), .O(z15));
  zero   g29(.O(z10));
  zero   g30(.O(z11));
  inv1   g31(.a(new_n34_), .O(z09));
endmodule
