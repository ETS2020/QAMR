...
module FAU ( 
  ...
  nand4  g19(.a(new_n32_), .b(new_n35_), .c(x1), .d(new_n27_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n31_), .O(z11));
  nand2  g21(.a(new_n28_), .b(new_n27_), .O(new_n46_));
  oai21  g22(.a(new_n46_), .b(new_n29_), .c(new_n22_), .O(z12));
  nand4  g23(.a(new_n32_), .b(x2), .c(new_n28_), .d(new_n27_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n31_), .O(z13));
  nand4  g25(.a(x3), .b(new_n35_), .c(new_n28_), .d(new_n27_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n31_), .O(z14));
  nand3  g27(.a(x4), .b(new_n32_), .c(new_n35_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n46_), .c(new_n22_), .O(z15));
  zero   g29(.O(z01));
  zero   g30(.O(z02));
  zero   g31(.O(z03));
endmodule
