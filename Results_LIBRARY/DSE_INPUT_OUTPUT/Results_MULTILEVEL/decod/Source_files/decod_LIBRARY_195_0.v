...
module FAU ( 
  ...
  nand4  g12(.a(new_n29_), .b(new_n27_), .c(x1), .d(x0), .O(new_n34_));
  ...
  oai21  g22(.a(new_n45_), .b(new_n30_), .c(new_n28_), .O(z09));
  ...
  nand4  g27(.a(x3), .b(x2), .c(new_n26_), .d(new_n42_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n22_), .O(z12));
