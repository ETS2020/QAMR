...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n33_, new_n34_, new_n36_, new_n38_, new_n41_, new_n43_, new_n44_,
  ...
  nand4  g11(.a(x3), .b(new_n25_), .c(new_n33_), .d(x0), .O(new_n34_));
  nor2   g12(.a(new_n34_), .b(new_n24_), .O(z06));
  nand3  g13(.a(x4), .b(new_n29_), .c(new_n33_), .O(new_n36_));
  aoi21  g14(.a(new_n36_), .b(new_n25_), .c(new_n28_), .O(z07));
  nand3  g15(.a(x4), .b(x3), .c(x1), .O(new_n38_));
  aoi21  g16(.a(new_n38_), .b(new_n28_), .c(new_n25_), .O(z08));
  aoi21  g17(.a(new_n30_), .b(new_n28_), .c(new_n25_), .O(z09));
  nand4  g18(.a(x3), .b(new_n25_), .c(x1), .d(new_n28_), .O(new_n41_));
  nor2   g19(.a(new_n41_), .b(new_n24_), .O(z10));
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n33_), .d(new_n28_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n24_), .O(z12));
  aoi21  g25(.a(new_n36_), .b(new_n28_), .c(new_n25_), .O(z13));
  nand4  g26(.a(x3), .b(new_n25_), .c(new_n33_), .d(new_n28_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n24_), .O(z14));
  nand2  g28(.a(new_n33_), .b(new_n28_), .O(new_n51_));
  oai21  g29(.a(new_n51_), .b(new_n44_), .c(new_n22_), .O(z15));
  zero   g30(.O(z05));
