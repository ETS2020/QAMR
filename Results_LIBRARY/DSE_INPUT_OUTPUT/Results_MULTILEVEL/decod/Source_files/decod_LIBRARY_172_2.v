...
module FAU ( 
  ...
  nand4  g23(.a(new_n25_), .b(new_n22_), .c(x1), .d(new_n41_), .O(new_n46_));
  ...
  nand4  g27(.a(x3), .b(new_n22_), .c(new_n34_), .d(new_n41_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n31_), .O(z14));
  nand4  g29(.a(new_n25_), .b(new_n22_), .c(new_n34_), .d(new_n41_), .O(new_n53_));
