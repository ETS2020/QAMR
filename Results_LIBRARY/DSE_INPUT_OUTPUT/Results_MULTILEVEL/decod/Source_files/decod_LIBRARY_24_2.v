...
module FAU ( 
  ...
  oai21  g20(.a(new_n42_), .b(new_n29_), .c(new_n35_), .O(z10));
  nand4  g21(.a(new_n25_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n44_));
  ...
  nand4  g27(.a(new_n25_), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n50_));
