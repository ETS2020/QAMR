...
module FAU ( 
  ...
  aoi21  g24(.a(new_n27_), .b(new_n25_), .c(x0), .O(z13));
  aoi21  g25(.a(new_n41_), .b(new_n25_), .c(x0), .O(z14));
  nand4  g26(.a(new_n26_), .b(new_n29_), .c(new_n25_), .d(new_n34_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n22_), .O(z15));
  inv1   g28(.a(new_n35_), .O(z09));
  inv1   g29(.a(new_n35_), .O(z10));
