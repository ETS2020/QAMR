...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n37_, new_n40_, new_n41_, new_n43_, new_n46_,
  ...
  nand4  g20(.a(x3), .b(new_n28_), .c(x1), .d(new_n40_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n32_), .O(z10));
  nand2  g22(.a(new_n22_), .b(new_n40_), .O(new_n46_));
  nand3  g23(.a(x4), .b(x3), .c(x2), .O(new_n47_));
  oai21  g24(.a(new_n47_), .b(new_n46_), .c(new_n26_), .O(z12));
  nand4  g25(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n40_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n32_), .O(z13));
  oai21  g27(.a(new_n46_), .b(new_n37_), .c(new_n26_), .O(z14));
  nand3  g28(.a(x4), .b(new_n28_), .c(new_n40_), .O(new_n52_));
