...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n38_, new_n39_, new_n41_, new_n43_, new_n45_,
  ...
  aoi21  g15(.a(new_n29_), .b(new_n24_), .c(new_n25_), .O(z09));
  inv1   g16(.a(x4), .O(new_n38_));
  nand4  g17(.a(x3), .b(new_n25_), .c(x1), .d(new_n24_), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n38_), .O(z10));
  nand4  g19(.a(new_n28_), .b(new_n25_), .c(x1), .d(new_n24_), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n38_), .O(z11));
  nand4  g21(.a(x3), .b(x2), .c(new_n31_), .d(new_n24_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n38_), .O(z12));
  nand4  g23(.a(new_n28_), .b(x2), .c(new_n31_), .d(new_n24_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n38_), .O(z13));
  nand2  g25(.a(new_n31_), .b(new_n24_), .O(new_n47_));
  nand3  g26(.a(x4), .b(x3), .c(new_n25_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n47_), .c(new_n22_), .O(z14));
  nand3  g28(.a(x4), .b(new_n28_), .c(new_n25_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n47_), .c(new_n22_), .O(z15));
