...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n38_, new_n40_, new_n45_, new_n47_,
    new_n49_;
  ...
  oai21  g20(.a(new_n38_), .b(new_n32_), .c(new_n35_), .O(z11));
  aoi21  g21(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand4  g22(.a(new_n31_), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n25_), .O(z13));
  nand4  g24(.a(x3), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n25_), .O(z14));
  nand4  g26(.a(new_n31_), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n25_), .O(z15));
  zero   g28(.O(z05));
