...
module FAU ( 
  ...
  wire new_n24_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n36_, new_n37_, new_n41_, new_n43_, new_n45_, new_n47_,
    new_n50_;
  ...
  oai21  g22(.a(new_n45_), .b(new_n28_), .c(new_n24_), .O(z12));
  nand4  g23(.a(new_n30_), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n36_), .O(z13));
  oai21  g25(.a(new_n45_), .b(new_n34_), .c(new_n24_), .O(z14));
  nand4  g26(.a(new_n30_), .b(new_n33_), .c(new_n27_), .d(new_n26_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n36_), .O(z15));
  zero   g28(.O(z00));
  zero   g29(.O(z01));
