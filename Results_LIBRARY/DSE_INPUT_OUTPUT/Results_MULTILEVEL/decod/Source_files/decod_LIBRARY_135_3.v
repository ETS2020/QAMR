...
module FAU ( 
  ...
  nand3  g21(.a(x4), .b(new_n30_), .c(new_n34_), .O(new_n45_));
  aoi21  g22(.a(new_n45_), .b(new_n33_), .c(new_n27_), .O(z11));
  ...
  nand4  g28(.a(x3), .b(new_n34_), .c(new_n27_), .d(new_n33_), .O(new_n52_));
