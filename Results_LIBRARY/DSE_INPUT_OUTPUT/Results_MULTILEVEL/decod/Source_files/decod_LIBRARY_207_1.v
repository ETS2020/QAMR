...
module FAU ( 
  ...
  nand4  g15(.a(new_n25_), .b(x2), .c(x1), .d(new_n35_), .O(new_n38_));
  nor2   g16(.a(new_n38_), .b(new_n22_), .O(z09));
  nand3  g17(.a(x3), .b(new_n30_), .c(new_n35_), .O(new_n41_));
  aoi21  g18(.a(new_n41_), .b(x2), .c(new_n22_), .O(z12));
  nand3  g19(.a(new_n25_), .b(new_n30_), .c(new_n35_), .O(new_n43_));
