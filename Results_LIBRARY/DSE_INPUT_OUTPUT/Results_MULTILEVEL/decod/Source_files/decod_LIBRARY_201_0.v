...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n34_, new_n36_, new_n39_, new_n41_, new_n42_,
  ...
  nand4  g24(.a(x3), .b(new_n30_), .c(x1), .d(new_n41_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n33_), .O(z10));
  nand4  g26(.a(new_n23_), .b(new_n30_), .c(x1), .d(new_n41_), .O(new_n48_));
