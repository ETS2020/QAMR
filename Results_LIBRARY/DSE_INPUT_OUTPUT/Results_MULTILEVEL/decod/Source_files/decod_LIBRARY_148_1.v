...
module FAU ( 
  ...
  nand3  g14(.a(new_n25_), .b(x1), .c(new_n37_), .O(new_n40_));
  aoi21  g15(.a(new_n40_), .b(x2), .c(new_n22_), .O(z09));
  nand3  g16(.a(x3), .b(new_n30_), .c(new_n37_), .O(new_n44_));
  aoi21  g17(.a(new_n44_), .b(x2), .c(new_n22_), .O(z12));
  nand3  g18(.a(new_n25_), .b(new_n30_), .c(new_n37_), .O(new_n46_));
  aoi21  g19(.a(new_n46_), .b(x2), .c(new_n22_), .O(z13));
  nor2   g20(.a(new_n22_), .b(x2), .O(z14));
  zero   g21(.O(z02));
  zero   g22(.O(z03));
  zero   g23(.O(z06));
  zero   g24(.O(z07));
