...
module FAU ( 
  ...
  aoi21  g18(.a(new_n39_), .b(x4), .c(x3), .O(z07));
  ...
  nand3  g26(.a(new_n27_), .b(x1), .c(new_n41_), .O(new_n48_));
  ...
  nand3  g30(.a(x2), .b(new_n32_), .c(new_n41_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(x3), .O(z13));
  nand2  g32(.a(new_n32_), .b(new_n41_), .O(new_n54_));
  nand2  g33(.a(new_n23_), .b(new_n22_), .O(new_n55_));
  nand3  g34(.a(x4), .b(x3), .c(new_n27_), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n54_), .c(new_n55_), .O(z14));
