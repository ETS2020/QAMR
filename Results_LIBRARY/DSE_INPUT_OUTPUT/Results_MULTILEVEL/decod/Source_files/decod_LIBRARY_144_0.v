...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n32_,
    ...
    new_n46_, new_n47_, new_n49_, new_n51_, new_n54_;
  ...
  nor2   g17(.a(new_n40_), .b(new_n22_), .O(z08));
  inv1   g18(.a(x3), .O(new_n42_));
  nand4  g19(.a(new_n42_), .b(x2), .c(x1), .d(new_n39_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n22_), .O(z09));
  nand2  g21(.a(x1), .b(new_n39_), .O(new_n45_));
  nand2  g22(.a(new_n42_), .b(new_n32_), .O(new_n46_));
  nand3  g23(.a(x4), .b(x3), .c(new_n27_), .O(new_n47_));
  oai21  g24(.a(new_n47_), .b(new_n45_), .c(new_n46_), .O(z10));
  nand4  g25(.a(new_n42_), .b(new_n27_), .c(x1), .d(new_n39_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n22_), .O(z11));
  nand4  g27(.a(x3), .b(x2), .c(new_n32_), .d(new_n39_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n22_), .O(z12));
  nand4  g29(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n39_), .O(new_n54_));
