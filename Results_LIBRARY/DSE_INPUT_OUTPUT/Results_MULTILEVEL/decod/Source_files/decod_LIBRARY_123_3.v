...
module FAU ( 
  ...
  aoi21  g23(.a(new_n46_), .b(new_n26_), .c(new_n32_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n32_), .d(new_n43_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n25_), .O(z12));
  nand4  g26(.a(new_n29_), .b(x2), .c(new_n32_), .d(new_n43_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n25_), .O(z13));
  nand4  g28(.a(x3), .b(new_n26_), .c(new_n32_), .d(new_n43_), .O(new_n52_));
