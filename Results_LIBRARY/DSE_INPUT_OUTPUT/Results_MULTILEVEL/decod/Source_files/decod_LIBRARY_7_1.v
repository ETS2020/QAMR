...
module FAU ( 
  ...
  oai21  g27(.a(new_n49_), .b(new_n34_), .c(new_n33_), .O(z11));
  nand3  g28(.a(x4), .b(x3), .c(new_n42_), .O(new_n52_));
  aoi21  g29(.a(new_n52_), .b(new_n25_), .c(x1), .O(z14));
  nand4  g30(.a(new_n26_), .b(new_n25_), .c(new_n32_), .d(new_n42_), .O(new_n54_));
