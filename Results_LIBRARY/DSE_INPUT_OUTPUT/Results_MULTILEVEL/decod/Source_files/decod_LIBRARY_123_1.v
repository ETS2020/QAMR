...
module FAU ( 
  ...
  nand4  g14(.a(x3), .b(new_n22_), .c(new_n34_), .d(x0), .O(new_n37_));
  ...
  oai21  g25(.a(new_n47_), .b(new_n46_), .c(new_n35_), .O(z10));
  nand3  g26(.a(x4), .b(new_n30_), .c(new_n22_), .O(new_n49_));
  oai21  g27(.a(new_n49_), .b(new_n46_), .c(new_n35_), .O(z11));
  nand4  g28(.a(x3), .b(new_n22_), .c(new_n34_), .d(new_n41_), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(new_n25_), .O(z14));
  nand4  g30(.a(new_n30_), .b(new_n22_), .c(new_n34_), .d(new_n41_), .O(new_n55_));
