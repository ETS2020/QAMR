...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n33_, new_n34_, new_n37_, new_n41_, new_n42_, new_n45_,
    new_n47_, new_n50_;
  ...
  aoi21  g14(.a(new_n31_), .b(x2), .c(x1), .O(z04));
  ...
  nand4  g24(.a(new_n28_), .b(new_n23_), .c(x1), .d(new_n41_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n33_), .O(z11));
  aoi21  g26(.a(new_n45_), .b(x2), .c(x1), .O(z12));
  nand4  g27(.a(new_n28_), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n33_), .O(z13));
  zero   g29(.O(z07));
  zero   g30(.O(z14));
  zero   g31(.O(z15));
endmodule
