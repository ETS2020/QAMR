...
module FAU ( 
  ...
  nand4  g15(.a(new_n28_), .b(x2), .c(new_n26_), .d(x0), .O(new_n37_));
  ...
  aoi21  g29(.a(new_n52_), .b(new_n28_), .c(x1), .O(z13));
  nand3  g30(.a(x4), .b(new_n31_), .c(new_n42_), .O(new_n54_));
  aoi21  g31(.a(new_n54_), .b(new_n28_), .c(x1), .O(z15));
  zero   g32(.O(z06));
  zero   g33(.O(z12));
