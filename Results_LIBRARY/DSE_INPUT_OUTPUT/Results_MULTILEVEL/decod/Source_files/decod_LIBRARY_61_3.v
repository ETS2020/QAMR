...
module FAU ( 
  ...
  nand4  g11(.a(new_n27_), .b(new_n30_), .c(new_n22_), .d(x0), .O(new_n33_));
  nor2   g12(.a(new_n33_), .b(new_n23_), .O(z07));
  inv1   g13(.a(x0), .O(new_n37_));
  nand4  g14(.a(x3), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n38_));
  nor2   g15(.a(new_n38_), .b(new_n23_), .O(z12));
  nand3  g16(.a(new_n27_), .b(x2), .c(new_n37_), .O(new_n40_));
  aoi21  g17(.a(new_n40_), .b(new_n22_), .c(new_n23_), .O(z13));
  nand4  g18(.a(x3), .b(new_n30_), .c(new_n22_), .d(new_n37_), .O(new_n42_));
