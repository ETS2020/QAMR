...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n37_, new_n38_, new_n46_, new_n48_,
    new_n50_;
  ...
  oai21  g18(.a(new_n35_), .b(new_n29_), .c(new_n34_), .O(z06));
  oai21  g19(.a(new_n35_), .b(new_n31_), .c(new_n34_), .O(z07));
  inv1   g20(.a(new_n34_), .O(z10));
  aoi21  g21(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  nand4  g22(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n33_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n37_), .O(z13));
  nand4  g24(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n33_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n37_), .O(z14));
  nand4  g26(.a(new_n25_), .b(new_n28_), .c(new_n22_), .d(new_n33_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n37_), .O(z15));
  zero   g28(.O(z08));
  zero   g29(.O(z09));
