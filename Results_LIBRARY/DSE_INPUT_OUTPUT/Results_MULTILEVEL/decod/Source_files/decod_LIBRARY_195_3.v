...
module FAU ( 
  ...
  nand4  g07(.a(new_n29_), .b(new_n24_), .c(x1), .d(x0), .O(new_n30_));
  nor2   g08(.a(new_n30_), .b(new_n28_), .O(z03));
  nand4  g09(.a(x3), .b(x2), .c(new_n23_), .d(x0), .O(new_n32_));
  nor2   g10(.a(new_n32_), .b(new_n28_), .O(z04));
  nand4  g11(.a(new_n29_), .b(x2), .c(new_n23_), .d(x0), .O(new_n34_));
  nor2   g12(.a(new_n34_), .b(new_n28_), .O(z05));
  nand4  g13(.a(x3), .b(new_n24_), .c(new_n23_), .d(x0), .O(new_n36_));
  nor2   g14(.a(new_n36_), .b(new_n28_), .O(z06));
  nand4  g15(.a(new_n29_), .b(new_n24_), .c(new_n23_), .d(x0), .O(new_n38_));
  ...
  nand4  g22(.a(x3), .b(x2), .c(new_n23_), .d(new_n41_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n28_), .O(z12));
  nand4  g24(.a(new_n29_), .b(x2), .c(new_n23_), .d(new_n41_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n28_), .O(z13));
  nand4  g26(.a(x3), .b(new_n24_), .c(new_n23_), .d(new_n41_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n28_), .O(z14));
  nand4  g28(.a(new_n29_), .b(new_n24_), .c(new_n23_), .d(new_n41_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n28_), .O(z15));
  zero   g30(.O(z00));
  zero   g31(.O(z08));
  nor2   g32(.a(new_n24_), .b(new_n23_), .O(z09));
endmodule
