...
module FAU ( 
  ...
  nand3  g33(.a(x4), .b(new_n31_), .c(x2), .O(new_n55_));
  oai21  g34(.a(new_n55_), .b(new_n53_), .c(new_n34_), .O(z13));
  oai21  g35(.a(new_n53_), .b(new_n40_), .c(new_n34_), .O(z14));
  nand3  g36(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n53_), .c(new_n34_), .O(z15));
endmodule
