...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n36_, new_n38_, new_n41_, new_n47_,
    new_n50_;
  ...
  aoi21  g22(.a(new_n36_), .b(new_n27_), .c(x0), .O(z12));
  nand4  g23(.a(new_n22_), .b(x2), .c(new_n27_), .d(new_n33_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n23_), .O(z13));
  aoi21  g25(.a(new_n29_), .b(new_n27_), .c(x0), .O(z14));
  nand4  g26(.a(new_n22_), .b(new_n28_), .c(new_n27_), .d(new_n33_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z15));
  zero   g28(.O(z10));
  zero   g29(.O(z11));
  inv1   g30(.a(new_n34_), .O(z09));
endmodule
