...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n29_, new_n30_, new_n31_,
    ...
    new_n47_, new_n49_, new_n50_, new_n53_;
  ...
  nand4  g12(.a(new_n24_), .b(x2), .c(new_n23_), .d(x0), .O(new_n35_));
  ...
  nand4  g16(.a(new_n24_), .b(new_n30_), .c(new_n23_), .d(x0), .O(new_n39_));
  nor2   g17(.a(new_n39_), .b(new_n29_), .O(z07));
  inv1   g18(.a(x0), .O(new_n41_));
  nand4  g19(.a(new_n24_), .b(x2), .c(x1), .d(new_n41_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n29_), .O(z09));
  ...
  oai21  g27(.a(new_n50_), .b(new_n49_), .c(new_n27_), .O(z13));
  aoi21  g28(.a(new_n45_), .b(new_n23_), .c(new_n24_), .O(z14));
  nand4  g29(.a(new_n24_), .b(new_n30_), .c(new_n23_), .d(new_n41_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n29_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z10));
