...
module FAU ( 
  ...
  oai21  g21(.a(new_n36_), .b(new_n32_), .c(new_n38_), .O(z07));
  inv1   g22(.a(new_n38_), .O(z10));
  aoi21  g23(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  nand4  g24(.a(new_n31_), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n25_), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n37_), .O(new_n50_));
