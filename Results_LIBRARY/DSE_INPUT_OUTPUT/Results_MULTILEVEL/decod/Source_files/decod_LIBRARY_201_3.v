...
module FAU ( 
  ...
  nand4  g22(.a(new_n25_), .b(new_n29_), .c(x1), .d(new_n42_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n28_), .O(z11));
  aoi21  g24(.a(new_n43_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand4  g25(.a(new_n25_), .b(x2), .c(new_n24_), .d(new_n42_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n28_), .O(z13));
  nand3  g27(.a(x4), .b(new_n29_), .c(new_n42_), .O(new_n51_));
  aoi21  g28(.a(new_n51_), .b(new_n24_), .c(new_n25_), .O(z14));
  nand2  g29(.a(new_n24_), .b(new_n42_), .O(new_n53_));
  oai21  g30(.a(new_n53_), .b(new_n39_), .c(new_n22_), .O(z15));
  zero   g31(.O(z08));
  zero   g32(.O(z10));
