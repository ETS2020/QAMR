...
module FAU ( 
  ...
  nand4  g12(.a(new_n22_), .b(x2), .c(new_n30_), .d(x0), .O(new_n34_));
  nor2   g13(.a(new_n34_), .b(new_n23_), .O(z05));
  ...
  aoi21  g20(.a(new_n41_), .b(x2), .c(new_n30_), .O(z08));
  nand4  g21(.a(new_n22_), .b(x2), .c(x1), .d(new_n40_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n23_), .O(z09));
  nand2  g23(.a(new_n30_), .b(new_n40_), .O(new_n46_));
  oai21  g24(.a(new_n46_), .b(new_n32_), .c(new_n28_), .O(z12));
