...
module FAU ( 
  ...
  nand4  g24(.a(new_n22_), .b(new_n30_), .c(x1), .d(new_n41_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n23_), .O(z11));
  nand4  g26(.a(x3), .b(x2), .c(new_n28_), .d(new_n41_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z12));
  inv1   g28(.a(new_n29_), .O(z13));
  nand4  g29(.a(x3), .b(new_n30_), .c(new_n28_), .d(new_n41_), .O(new_n53_));
