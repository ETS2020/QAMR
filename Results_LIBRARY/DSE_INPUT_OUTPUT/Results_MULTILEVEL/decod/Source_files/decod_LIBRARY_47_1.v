...
module FAU ( 
  ...
  nand3  g10(.a(new_n26_), .b(new_n29_), .c(x0), .O(new_n33_));
  ...
  nand4  g15(.a(x3), .b(new_n26_), .c(x1), .d(new_n36_), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n22_), .O(z10));
  nand4  g17(.a(x3), .b(x2), .c(new_n29_), .d(new_n36_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n22_), .O(z12));
  nand4  g19(.a(x3), .b(new_n26_), .c(new_n29_), .d(new_n36_), .O(new_n43_));
