...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n30_,
    ...
    new_n44_, new_n45_, new_n47_, new_n51_, new_n53_, new_n55_, new_n57_;
  ...
  oai21  g28(.a(new_n44_), .b(new_n33_), .c(new_n29_), .O(z11));
  ...
  nand3  g35(.a(new_n22_), .b(new_n30_), .c(new_n43_), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(x4), .c(x1), .O(z15));
endmodule
