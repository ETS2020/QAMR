...
module FAU ( 
  ...
  aoi21  g15(.a(new_n38_), .b(new_n23_), .c(new_n24_), .O(z12));
  nand3  g16(.a(new_n29_), .b(x2), .c(new_n37_), .O(new_n40_));
  aoi21  g17(.a(new_n40_), .b(new_n23_), .c(new_n24_), .O(z13));
  nand3  g18(.a(x3), .b(new_n32_), .c(new_n37_), .O(new_n42_));
  aoi21  g19(.a(new_n42_), .b(new_n23_), .c(new_n24_), .O(z14));
  nand3  g20(.a(new_n29_), .b(new_n32_), .c(new_n37_), .O(new_n44_));
  aoi21  g21(.a(new_n44_), .b(new_n23_), .c(new_n24_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z03));
  nor2   g24(.a(new_n24_), .b(new_n23_), .O(z02));
  nor2   g25(.a(new_n24_), .b(new_n23_), .O(z08));
  nor2   g26(.a(new_n24_), .b(new_n23_), .O(z09));
