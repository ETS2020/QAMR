...
module FAU ( 
  ...
  oai21  g16(.a(new_n37_), .b(new_n36_), .c(new_n29_), .O(z08));
  nand3  g17(.a(x4), .b(new_n25_), .c(x2), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n36_), .c(new_n29_), .O(z09));
  inv1   g19(.a(x4), .O(new_n41_));
  nand4  g20(.a(x3), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n41_), .O(z10));
  nand4  g22(.a(new_n25_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n41_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n31_), .d(new_n22_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n41_), .O(z12));
  nand4  g26(.a(new_n25_), .b(x2), .c(new_n31_), .d(new_n22_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n41_), .O(z13));
  aoi21  g28(.a(new_n32_), .b(new_n22_), .c(x2), .O(z14));
  aoi21  g29(.a(new_n34_), .b(new_n22_), .c(x2), .O(z15));
