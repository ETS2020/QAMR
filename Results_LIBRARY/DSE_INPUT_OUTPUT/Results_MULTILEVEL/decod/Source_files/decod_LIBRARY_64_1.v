...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n31_, new_n33_, new_n35_, new_n36_, new_n38_, new_n40_, new_n44_,
    new_n45_, new_n47_;
  ...
  oai21  g20(.a(new_n40_), .b(new_n33_), .c(new_n29_), .O(z07));
  inv1   g21(.a(new_n29_), .O(z08));
  inv1   g22(.a(x4), .O(new_n44_));
  nand4  g23(.a(x3), .b(new_n22_), .c(x1), .d(new_n28_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n44_), .O(z10));
  nand4  g25(.a(new_n25_), .b(new_n22_), .c(x1), .d(new_n28_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n44_), .O(z11));
  aoi21  g27(.a(new_n36_), .b(new_n22_), .c(x0), .O(z14));
  aoi21  g28(.a(new_n38_), .b(new_n22_), .c(x0), .O(z15));
  zero   g29(.O(z12));
  zero   g30(.O(z13));
