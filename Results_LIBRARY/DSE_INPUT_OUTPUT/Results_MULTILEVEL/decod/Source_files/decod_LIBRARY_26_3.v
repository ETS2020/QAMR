...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    ...
    new_n44_, new_n46_, new_n49_, new_n50_, new_n52_;
  ...
  nand3  g17(.a(x4), .b(new_n28_), .c(new_n25_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n38_), .c(new_n22_), .O(z07));
  inv1   g19(.a(x0), .O(new_n41_));
  nand4  g20(.a(x3), .b(new_n25_), .c(x1), .d(new_n41_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n24_), .O(z10));
  nand3  g22(.a(x4), .b(new_n28_), .c(new_n41_), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n25_), .c(new_n31_), .O(z11));
  nand3  g24(.a(x4), .b(x3), .c(new_n41_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n31_), .c(new_n25_), .O(z12));
  aoi21  g26(.a(new_n44_), .b(new_n31_), .c(new_n25_), .O(z13));
  nand2  g27(.a(new_n31_), .b(new_n41_), .O(new_n49_));
  nand3  g28(.a(x4), .b(x3), .c(new_n25_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n49_), .c(new_n22_), .O(z14));
  nand4  g30(.a(new_n28_), .b(new_n25_), .c(new_n31_), .d(new_n41_), .O(new_n52_));
