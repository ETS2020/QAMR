...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n38_, new_n40_, new_n43_, new_n45_,
    new_n48_, new_n50_;
  ...
  nor2   g16(.a(new_n38_), .b(new_n31_), .O(z08));
  nand2  g17(.a(x1), .b(new_n22_), .O(new_n40_));
  oai21  g18(.a(new_n40_), .b(new_n26_), .c(new_n35_), .O(z09));
  oai21  g19(.a(new_n40_), .b(new_n29_), .c(new_n35_), .O(z10));
  nand4  g20(.a(new_n25_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n31_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n31_), .O(z12));
  aoi21  g24(.a(new_n26_), .b(new_n22_), .c(x1), .O(z13));
  nand4  g25(.a(x3), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n31_), .O(z14));
  nand3  g27(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n50_));
