...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n26_, new_n28_, new_n29_, new_n32_, new_n33_,
    new_n35_, new_n39_, new_n40_, new_n42_, new_n46_, new_n48_;
  ...
  nand3  g18(.a(x3), .b(new_n32_), .c(new_n39_), .O(new_n46_));
  aoi21  g19(.a(new_n46_), .b(new_n23_), .c(new_n24_), .O(z14));
  nand3  g20(.a(new_n28_), .b(new_n32_), .c(new_n39_), .O(new_n48_));
  ...
  zero   g26(.O(z12));
  zero   g27(.O(z13));
  nor2   g28(.a(new_n24_), .b(new_n23_), .O(z05));
endmodule
