...
module FAU ( 
  ...
  nand4  g24(.a(x3), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n25_), .O(z12));
  nand4  g26(.a(new_n31_), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n25_), .O(z13));
  aoi21  g28(.a(new_n45_), .b(new_n22_), .c(x1), .O(z14));
  nand4  g29(.a(new_n31_), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n54_));
