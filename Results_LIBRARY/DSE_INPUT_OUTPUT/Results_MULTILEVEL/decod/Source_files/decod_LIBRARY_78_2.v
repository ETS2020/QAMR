...
module FAU ( 
  ...
  oai21  g22(.a(new_n45_), .b(new_n31_), .c(new_n36_), .O(z11));
  aoi21  g23(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand4  g24(.a(new_n25_), .b(x2), .c(new_n35_), .d(new_n22_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n38_), .O(z13));
  aoi21  g26(.a(new_n29_), .b(new_n22_), .c(x1), .O(z14));
  aoi21  g27(.a(new_n31_), .b(new_n22_), .c(x1), .O(z15));
  zero   g28(.O(z04));
  zero   g29(.O(z05));
