...
module FAU ( 
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n25_), .d(new_n41_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n22_), .O(z12));
  nand4  g25(.a(new_n26_), .b(x2), .c(new_n25_), .d(new_n41_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n22_), .O(z13));
  nand4  g27(.a(x3), .b(new_n30_), .c(new_n25_), .d(new_n41_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n22_), .O(z14));
  nand3  g29(.a(x4), .b(new_n26_), .c(new_n41_), .O(new_n53_));
  aoi21  g30(.a(new_n53_), .b(new_n25_), .c(x2), .O(z15));
  zero   g31(.O(z02));
  zero   g32(.O(z11));
  inv1   g33(.a(new_n31_), .O(z10));
endmodule
