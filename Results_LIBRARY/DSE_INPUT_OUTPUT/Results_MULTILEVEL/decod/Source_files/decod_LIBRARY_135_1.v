...
module FAU ( 
  ...
  inv1   g23(.a(new_n40_), .O(z11));
  aoi21  g24(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  nand3  g25(.a(x4), .b(new_n31_), .c(x2), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n22_), .c(x0), .O(z13));
  nand4  g27(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n39_), .O(new_n52_));
