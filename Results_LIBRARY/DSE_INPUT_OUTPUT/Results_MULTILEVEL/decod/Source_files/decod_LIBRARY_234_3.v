...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_, new_n35_, new_n37_, new_n39_, new_n42_, new_n44_,
  ...
  nand3  g17(.a(x4), .b(new_n28_), .c(x2), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(new_n31_), .c(new_n25_), .O(z09));
  aoi21  g19(.a(new_n33_), .b(new_n31_), .c(new_n25_), .O(z10));
  nand4  g20(.a(new_n28_), .b(new_n32_), .c(x1), .d(new_n31_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n24_), .O(z11));
  nand2  g22(.a(new_n25_), .b(new_n31_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n37_), .c(new_n22_), .O(z12));
  nand4  g24(.a(new_n28_), .b(x2), .c(new_n25_), .d(new_n31_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n24_), .O(z13));
  nand4  g26(.a(x3), .b(new_n32_), .c(new_n25_), .d(new_n31_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n24_), .O(z14));
  nand3  g28(.a(x4), .b(new_n28_), .c(new_n32_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n44_), .c(new_n22_), .O(z15));
