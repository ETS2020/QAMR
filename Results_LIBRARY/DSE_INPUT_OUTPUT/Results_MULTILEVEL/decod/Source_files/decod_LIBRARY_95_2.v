...
module FAU ( 
  ...
  nand3  g19(.a(x4), .b(x3), .c(new_n29_), .O(new_n44_));
  oai21  g20(.a(new_n44_), .b(new_n40_), .c(new_n36_), .O(z10));
  ...
  nand4  g25(.a(x3), .b(new_n29_), .c(new_n35_), .d(new_n22_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n28_), .O(z14));
  nand4  g27(.a(new_n25_), .b(new_n29_), .c(new_n35_), .d(new_n22_), .O(new_n52_));
