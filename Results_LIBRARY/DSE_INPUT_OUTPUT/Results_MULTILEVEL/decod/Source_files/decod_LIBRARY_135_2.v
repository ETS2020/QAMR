...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n36_, new_n37_, new_n40_, new_n42_, new_n44_, new_n46_,
    new_n49_, new_n51_;
  ...
  oai21  g22(.a(new_n46_), .b(new_n32_), .c(new_n37_), .O(z11));
  aoi21  g23(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand3  g24(.a(x4), .b(new_n31_), .c(x2), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n22_), .c(x1), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n36_), .d(new_n22_), .O(new_n51_));
