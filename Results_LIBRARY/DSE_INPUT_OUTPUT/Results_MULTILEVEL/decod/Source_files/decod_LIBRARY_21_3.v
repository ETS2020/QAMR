...
module FAU ( 
  ...
  nand4  g15(.a(x3), .b(x2), .c(x1), .d(new_n36_), .O(new_n39_));
  ...
  oai21  g25(.a(new_n46_), .b(new_n41_), .c(new_n23_), .O(z13));
  nand3  g26(.a(x4), .b(x3), .c(new_n33_), .O(new_n50_));
  oai21  g27(.a(new_n50_), .b(new_n46_), .c(new_n23_), .O(z14));
