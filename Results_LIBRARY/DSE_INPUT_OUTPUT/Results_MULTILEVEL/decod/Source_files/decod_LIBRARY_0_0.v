...
module FAU ( 
  ...
  nand3  g20(.a(x4), .b(x2), .c(new_n39_), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(x1), .c(x3), .O(z09));
  nand2  g22(.a(x1), .b(new_n39_), .O(new_n44_));
  nand3  g23(.a(x4), .b(x3), .c(new_n27_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n44_), .c(new_n35_), .O(z10));
  nand4  g25(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n39_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n23_), .O(z11));
  nand4  g27(.a(x3), .b(x2), .c(new_n34_), .d(new_n39_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n23_), .O(z12));
  nand3  g29(.a(x4), .b(new_n27_), .c(new_n39_), .O(new_n52_));
