...
module FAU ( 
  ...
  nand3  g17(.a(x3), .b(new_n27_), .c(x0), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(x4), .c(x1), .O(z06));
  nand4  g19(.a(new_n22_), .b(new_n27_), .c(new_n31_), .d(x0), .O(new_n41_));
  ...
  oai21  g24(.a(new_n45_), .b(new_n44_), .c(new_n32_), .O(z08));
  nand3  g25(.a(x4), .b(new_n22_), .c(x2), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n44_), .c(new_n32_), .O(z09));
  nand3  g27(.a(x4), .b(x3), .c(new_n27_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n44_), .c(new_n32_), .O(z10));
  nand4  g29(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n43_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n23_), .O(z11));
  nand4  g31(.a(x3), .b(x2), .c(new_n31_), .d(new_n43_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n23_), .O(z12));
  nand3  g33(.a(new_n22_), .b(x2), .c(new_n43_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(x4), .c(x1), .O(z13));
  nand3  g35(.a(x3), .b(new_n27_), .c(new_n43_), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(x4), .c(x1), .O(z14));
  nand4  g37(.a(new_n22_), .b(new_n27_), .c(new_n31_), .d(new_n43_), .O(new_n59_));
