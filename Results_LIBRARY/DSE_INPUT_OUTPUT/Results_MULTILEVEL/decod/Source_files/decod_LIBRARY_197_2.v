...
module FAU ( 
  ...
  nand2  g10(.a(new_n23_), .b(x1), .O(new_n32_));
  ...
  oai21  g20(.a(new_n41_), .b(new_n34_), .c(new_n32_), .O(z07));
  ...
  aoi21  g25(.a(new_n46_), .b(x4), .c(new_n33_), .O(z09));
  ...
  aoi21  g29(.a(new_n50_), .b(x4), .c(new_n33_), .O(z11));
