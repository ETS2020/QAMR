...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n32_,
    new_n33_, new_n37_, new_n39_, new_n40_, new_n41_, new_n43_, new_n45_,
  ...
  nand3  g08(.a(x4), .b(new_n22_), .c(x0), .O(new_n30_));
  ...
  aoi21  g13(.a(new_n30_), .b(x2), .c(x1), .O(z05));
  nand2  g14(.a(new_n27_), .b(new_n32_), .O(new_n37_));
  inv1   g15(.a(new_n37_), .O(z07));
  inv1   g16(.a(x0), .O(new_n39_));
  nand2  g17(.a(x1), .b(new_n39_), .O(new_n40_));
  nand3  g18(.a(x4), .b(x3), .c(x2), .O(new_n41_));
  oai21  g19(.a(new_n41_), .b(new_n40_), .c(new_n37_), .O(z08));
  nand4  g20(.a(new_n22_), .b(x2), .c(x1), .d(new_n39_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n23_), .O(z09));
  nand4  g22(.a(x3), .b(new_n27_), .c(x1), .d(new_n39_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n23_), .O(z10));
  nand3  g24(.a(x4), .b(new_n22_), .c(new_n39_), .O(new_n47_));
  aoi21  g25(.a(new_n47_), .b(x1), .c(x2), .O(z11));
  nand4  g26(.a(x3), .b(x2), .c(new_n32_), .d(new_n39_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n23_), .O(z12));
  nand4  g28(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n39_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n23_), .O(z13));
  zero   g30(.O(z06));
  zero   g31(.O(z14));
  inv1   g32(.a(new_n37_), .O(z15));
endmodule
