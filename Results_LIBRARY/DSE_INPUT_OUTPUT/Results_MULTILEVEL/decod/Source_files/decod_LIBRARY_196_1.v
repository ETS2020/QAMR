...
module FAU ( 
  ...
  nand4  g20(.a(new_n30_), .b(x2), .c(x1), .d(new_n39_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n25_), .O(z09));
  nand2  g22(.a(x1), .b(new_n39_), .O(new_n44_));
  nand3  g23(.a(x4), .b(x3), .c(new_n22_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n44_), .c(new_n34_), .O(z10));
  nand4  g25(.a(new_n30_), .b(new_n22_), .c(x1), .d(new_n39_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n25_), .O(z11));
  nand3  g27(.a(x4), .b(x3), .c(new_n39_), .O(new_n50_));
  aoi21  g28(.a(new_n50_), .b(new_n22_), .c(x1), .O(z14));
  nand4  g29(.a(new_n30_), .b(new_n22_), .c(new_n33_), .d(new_n39_), .O(new_n52_));
