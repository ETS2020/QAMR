...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n33_, new_n36_, new_n38_, new_n40_, new_n41_, new_n43_,
  ...
  nand4  g14(.a(x3), .b(new_n29_), .c(new_n22_), .d(x0), .O(new_n36_));
  nor2   g15(.a(new_n36_), .b(new_n28_), .O(z06));
  nand4  g16(.a(new_n25_), .b(new_n29_), .c(new_n22_), .d(x0), .O(new_n38_));
  ...
  nand4  g21(.a(x3), .b(new_n29_), .c(x1), .d(new_n40_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n28_), .O(z10));
  nand2  g23(.a(new_n22_), .b(new_n40_), .O(new_n46_));
  oai21  g24(.a(new_n46_), .b(new_n33_), .c(new_n26_), .O(z12));
  aoi21  g25(.a(new_n41_), .b(new_n22_), .c(x3), .O(z13));
  nand3  g26(.a(x4), .b(x3), .c(new_n29_), .O(new_n49_));
  oai21  g27(.a(new_n49_), .b(new_n46_), .c(new_n26_), .O(z14));
  nand3  g28(.a(x4), .b(new_n29_), .c(new_n40_), .O(new_n51_));
  aoi21  g29(.a(new_n51_), .b(new_n22_), .c(x3), .O(z15));
  zero   g30(.O(z11));
