...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n37_, new_n39_, new_n41_, new_n43_, new_n45_, new_n46_,
  ...
  nand4  g22(.a(x3), .b(x2), .c(new_n45_), .d(new_n22_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n28_), .O(z12));
  nand4  g24(.a(new_n25_), .b(x2), .c(new_n45_), .d(new_n22_), .O(new_n48_));
  ...
  zero   g30(.O(z04));
  zero   g31(.O(z07));
  nor2   g32(.a(x1), .b(new_n22_), .O(z06));
endmodule
