...
module FAU ( 
  ...
  aoi21  g21(.a(new_n43_), .b(new_n26_), .c(new_n32_), .O(z10));
  ...
  nand4  g28(.a(x3), .b(new_n26_), .c(new_n32_), .d(new_n42_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n25_), .O(z14));
  nand4  g30(.a(new_n29_), .b(new_n26_), .c(new_n32_), .d(new_n42_), .O(new_n53_));
