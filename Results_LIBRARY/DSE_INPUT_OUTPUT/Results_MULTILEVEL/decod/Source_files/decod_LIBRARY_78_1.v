...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n38_, new_n39_, new_n40_, new_n48_;
  ...
  oai21  g20(.a(new_n38_), .b(new_n31_), .c(new_n40_), .O(z07));
  inv1   g21(.a(new_n40_), .O(z11));
  aoi21  g22(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  nand4  g23(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n39_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n33_), .O(z13));
  aoi21  g25(.a(new_n29_), .b(new_n22_), .c(x0), .O(z14));
  aoi21  g26(.a(new_n31_), .b(new_n22_), .c(x0), .O(z15));
  zero   g27(.O(z08));
  zero   g28(.O(z09));
  zero   g29(.O(z10));
endmodule
