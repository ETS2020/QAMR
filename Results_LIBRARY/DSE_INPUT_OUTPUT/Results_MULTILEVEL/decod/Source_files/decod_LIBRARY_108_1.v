...
module FAU ( 
  ...
  nand4  g14(.a(x3), .b(new_n25_), .c(new_n32_), .d(x0), .O(new_n38_));
  nor2   g15(.a(new_n38_), .b(new_n22_), .O(z06));
  nand4  g16(.a(new_n26_), .b(new_n25_), .c(new_n32_), .d(x0), .O(new_n40_));
  ...
  oai21  g26(.a(new_n49_), .b(new_n34_), .c(new_n33_), .O(z11));
  inv1   g27(.a(new_n33_), .O(z12));
  nand4  g28(.a(x3), .b(new_n25_), .c(new_n32_), .d(new_n42_), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(new_n22_), .O(z14));
  nand3  g30(.a(x4), .b(new_n26_), .c(new_n42_), .O(new_n55_));
  aoi21  g31(.a(new_n55_), .b(new_n25_), .c(x1), .O(z15));
  zero   g32(.O(z04));
  zero   g33(.O(z05));
  zero   g34(.O(z13));
endmodule
