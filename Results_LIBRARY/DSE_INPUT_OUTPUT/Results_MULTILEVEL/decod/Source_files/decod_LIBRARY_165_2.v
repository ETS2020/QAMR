...
module FAU ( 
  ...
  nand2  g10(.a(new_n22_), .b(x2), .O(new_n32_));
  ...
  nand3  g19(.a(x4), .b(x3), .c(new_n25_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n40_), .c(new_n32_), .O(z06));
  nand4  g21(.a(new_n26_), .b(new_n25_), .c(new_n35_), .d(x0), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n22_), .O(z07));
  inv1   g23(.a(x0), .O(new_n45_));
  nand3  g24(.a(x3), .b(x1), .c(new_n45_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(x4), .c(new_n25_), .O(z08));
  nand3  g26(.a(new_n26_), .b(x1), .c(new_n45_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x4), .c(new_n25_), .O(z09));
  nand4  g28(.a(x3), .b(new_n25_), .c(x1), .d(new_n45_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n22_), .O(z10));
  nand4  g30(.a(new_n26_), .b(new_n25_), .c(x1), .d(new_n45_), .O(new_n52_));
  ...
  nand4  g34(.a(new_n26_), .b(x2), .c(new_n35_), .d(new_n45_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n22_), .O(z13));
  nand4  g36(.a(x3), .b(new_n25_), .c(new_n35_), .d(new_n45_), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n22_), .O(z14));
  nand2  g38(.a(new_n35_), .b(new_n45_), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n33_), .c(new_n32_), .O(z15));
endmodule
