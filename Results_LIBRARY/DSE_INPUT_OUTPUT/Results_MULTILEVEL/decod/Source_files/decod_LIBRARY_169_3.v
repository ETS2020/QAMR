...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n26_, new_n28_, new_n29_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n44_, new_n45_,
  ...
  nand4  g13(.a(new_n29_), .b(new_n30_), .c(new_n34_), .d(x0), .O(new_n37_));
  ...
  aoi21  g19(.a(new_n31_), .b(new_n28_), .c(new_n29_), .O(z10));
  nand2  g20(.a(x1), .b(new_n28_), .O(new_n44_));
  nand3  g21(.a(x4), .b(new_n29_), .c(new_n30_), .O(new_n45_));
  oai21  g22(.a(new_n45_), .b(new_n44_), .c(new_n26_), .O(z11));
  ...
  aoi21  g27(.a(new_n50_), .b(new_n28_), .c(new_n29_), .O(z14));
  nand2  g28(.a(new_n34_), .b(new_n28_), .O(new_n52_));
  oai21  g29(.a(new_n52_), .b(new_n45_), .c(new_n26_), .O(z15));
  zero   g30(.O(z00));
  zero   g31(.O(z04));
