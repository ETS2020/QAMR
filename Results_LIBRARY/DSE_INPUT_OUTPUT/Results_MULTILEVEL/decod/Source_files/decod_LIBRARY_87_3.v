...
module FAU ( 
  ...
  nand4  g15(.a(x3), .b(new_n28_), .c(new_n24_), .d(x0), .O(new_n37_));
  nor2   g16(.a(new_n37_), .b(new_n31_), .O(z06));
  nand4  g17(.a(new_n25_), .b(new_n28_), .c(new_n24_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n31_), .O(z07));
  inv1   g19(.a(x0), .O(new_n42_));
  nand4  g20(.a(new_n25_), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n31_), .O(z09));
  ...
  nor2   g25(.a(new_n47_), .b(new_n31_), .O(z12));
  nand4  g26(.a(new_n25_), .b(x2), .c(new_n24_), .d(new_n42_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n31_), .O(z13));
  aoi21  g28(.a(new_n45_), .b(new_n24_), .c(new_n25_), .O(z14));
  nand2  g29(.a(new_n24_), .b(new_n42_), .O(new_n52_));
