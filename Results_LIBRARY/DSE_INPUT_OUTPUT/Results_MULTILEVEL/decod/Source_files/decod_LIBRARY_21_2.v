...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_, new_n47_,
    new_n50_;
  ...
  oai21  g18(.a(new_n42_), .b(new_n27_), .c(new_n38_), .O(z09));
  nand4  g19(.a(x3), .b(new_n29_), .c(x1), .d(new_n25_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n22_), .O(z10));
  oai21  g21(.a(new_n42_), .b(new_n32_), .c(new_n38_), .O(z11));
  nand3  g22(.a(x4), .b(x3), .c(x2), .O(new_n47_));
  aoi21  g23(.a(new_n47_), .b(new_n25_), .c(x1), .O(z12));
  aoi21  g24(.a(new_n27_), .b(new_n25_), .c(x1), .O(z13));
  nand3  g25(.a(x4), .b(x3), .c(new_n29_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n25_), .c(x1), .O(z14));
