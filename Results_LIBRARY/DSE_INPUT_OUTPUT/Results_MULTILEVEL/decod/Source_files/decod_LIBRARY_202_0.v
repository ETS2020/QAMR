...
module FAU ( 
  ...
  nand4  g25(.a(new_n31_), .b(new_n28_), .c(x1), .d(new_n41_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n25_), .O(z11));
  nand4  g27(.a(x3), .b(x2), .c(new_n34_), .d(new_n41_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n25_), .O(z12));
  nand3  g29(.a(x4), .b(new_n28_), .c(new_n41_), .O(new_n53_));
  aoi21  g30(.a(new_n53_), .b(x3), .c(x1), .O(z14));
  zero   g31(.O(z07));
  zero   g32(.O(z13));
  zero   g33(.O(z15));
endmodule
