...
module FAU ( 
  ...
  nand4  g16(.a(new_n32_), .b(x2), .c(new_n34_), .d(x0), .O(new_n38_));
  ...
  nand4  g20(.a(new_n32_), .b(new_n27_), .c(new_n34_), .d(x0), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n22_), .O(z07));
  inv1   g22(.a(x0), .O(new_n44_));
  nand2  g23(.a(x1), .b(new_n44_), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n36_), .c(new_n33_), .O(z08));
  ...
  nand3  g29(.a(new_n27_), .b(x1), .c(new_n44_), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(x4), .c(x3), .O(z11));
  nand2  g31(.a(new_n34_), .b(new_n44_), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n36_), .c(new_n33_), .O(z12));
  nand3  g33(.a(x2), .b(new_n34_), .c(new_n44_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(x4), .c(x3), .O(z13));
  nand3  g35(.a(x4), .b(x3), .c(new_n27_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n53_), .c(new_n33_), .O(z14));
  nand3  g37(.a(new_n27_), .b(new_n34_), .c(new_n44_), .O(new_n59_));
