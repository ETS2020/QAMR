...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n24_, new_n25_, new_n28_, new_n30_, new_n31_, new_n33_, new_n34_,
  ...
  nand4  g06(.a(new_n30_), .b(x2), .c(new_n24_), .d(x0), .O(new_n31_));
  nor2   g07(.a(new_n31_), .b(new_n25_), .O(z05));
  inv1   g08(.a(x2), .O(new_n33_));
  nand4  g09(.a(x3), .b(new_n33_), .c(new_n24_), .d(x0), .O(new_n34_));
  ...
  nand4  g16(.a(new_n30_), .b(x2), .c(new_n24_), .d(new_n38_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n25_), .O(z13));
  nand4  g18(.a(x3), .b(new_n33_), .c(new_n24_), .d(new_n38_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n25_), .O(z14));
  nand4  g20(.a(new_n30_), .b(new_n33_), .c(new_n24_), .d(new_n38_), .O(new_n45_));
