...
module FAU ( 
  ...
  nand3  g09(.a(new_n30_), .b(new_n27_), .c(x0), .O(new_n31_));
  ...
  nand4  g15(.a(new_n30_), .b(x2), .c(x1), .d(new_n37_), .O(new_n40_));
  nor2   g16(.a(new_n40_), .b(new_n22_), .O(z09));
  nand3  g17(.a(x3), .b(new_n27_), .c(new_n37_), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(x1), .c(new_n22_), .O(z10));
  nand4  g19(.a(new_n30_), .b(new_n27_), .c(x1), .d(new_n37_), .O(new_n44_));
