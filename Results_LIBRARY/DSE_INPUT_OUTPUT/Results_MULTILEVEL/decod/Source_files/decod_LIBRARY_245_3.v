...
module FAU ( 
  ...
  nand4  g17(.a(new_n30_), .b(x2), .c(x1), .d(new_n36_), .O(new_n41_));
  ...
  oai21  g26(.a(new_n46_), .b(new_n43_), .c(new_n24_), .O(z14));
  nand4  g27(.a(new_n30_), .b(new_n33_), .c(new_n27_), .d(new_n36_), .O(new_n51_));
