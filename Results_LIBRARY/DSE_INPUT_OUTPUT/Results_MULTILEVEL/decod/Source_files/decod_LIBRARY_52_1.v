...
module FAU ( 
  ...
  nand3  g15(.a(new_n30_), .b(x2), .c(new_n37_), .O(new_n40_));
  aoi21  g16(.a(new_n40_), .b(x1), .c(new_n22_), .O(z09));
  nand4  g17(.a(x3), .b(new_n27_), .c(x1), .d(new_n37_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n22_), .O(z10));
  nand3  g19(.a(new_n30_), .b(new_n27_), .c(new_n37_), .O(new_n44_));
