...
module FAU ( 
  ...
  nand2  g19(.a(x1), .b(new_n25_), .O(new_n42_));
  nand3  g20(.a(x4), .b(x3), .c(new_n29_), .O(new_n43_));
  oai21  g21(.a(new_n43_), .b(new_n42_), .c(new_n35_), .O(z10));
  nand3  g22(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n45_));
  oai21  g23(.a(new_n45_), .b(new_n42_), .c(new_n35_), .O(z11));
  nand3  g24(.a(x4), .b(x3), .c(x2), .O(new_n47_));
  aoi21  g25(.a(new_n47_), .b(new_n25_), .c(x1), .O(z12));
  nand4  g26(.a(new_n26_), .b(x2), .c(new_n34_), .d(new_n25_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n22_), .O(z13));
  nand4  g28(.a(x3), .b(new_n29_), .c(new_n34_), .d(new_n25_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n22_), .O(z14));
  nand4  g30(.a(new_n26_), .b(new_n29_), .c(new_n34_), .d(new_n25_), .O(new_n53_));
