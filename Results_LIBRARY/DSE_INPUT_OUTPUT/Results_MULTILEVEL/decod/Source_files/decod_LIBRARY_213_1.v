...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_, new_n33_, new_n37_, new_n39_, new_n41_, new_n42_, new_n44_,
  ...
  nand4  g14(.a(x3), .b(new_n27_), .c(new_n31_), .d(x0), .O(new_n37_));
  nor2   g15(.a(new_n37_), .b(new_n23_), .O(z06));
  nand3  g16(.a(x4), .b(new_n22_), .c(x0), .O(new_n39_));
  aoi21  g17(.a(new_n39_), .b(new_n27_), .c(x1), .O(z07));
  inv1   g18(.a(x0), .O(new_n41_));
  nand3  g19(.a(x4), .b(x3), .c(new_n41_), .O(new_n42_));
  aoi21  g20(.a(new_n42_), .b(x1), .c(new_n27_), .O(z08));
  ...
  nand4  g27(.a(x3), .b(new_n27_), .c(new_n31_), .d(new_n41_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n23_), .O(z14));
  nand3  g29(.a(x4), .b(new_n22_), .c(new_n41_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n27_), .c(x1), .O(z15));
  zero   g31(.O(z04));
  zero   g32(.O(z12));
  zero   g33(.O(z13));
endmodule
