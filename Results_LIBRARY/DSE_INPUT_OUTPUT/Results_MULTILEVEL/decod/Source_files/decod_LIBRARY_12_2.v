...
module FAU ( 
  ...
  oai21  g21(.a(new_n44_), .b(new_n41_), .c(new_n35_), .O(z10));
  oai21  g22(.a(new_n41_), .b(new_n32_), .c(new_n35_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n25_), .O(z12));
  nand4  g25(.a(new_n31_), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n25_), .O(z13));
  nand4  g27(.a(x3), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n51_));
