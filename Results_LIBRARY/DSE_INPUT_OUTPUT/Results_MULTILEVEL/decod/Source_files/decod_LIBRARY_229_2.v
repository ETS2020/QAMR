...
module FAU ( 
  ...
  nand4  g28(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n43_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n23_), .O(z11));
  nand2  g30(.a(new_n27_), .b(new_n43_), .O(new_n52_));
  nand3  g31(.a(x4), .b(x3), .c(x2), .O(new_n53_));
  oai21  g32(.a(new_n53_), .b(new_n52_), .c(new_n36_), .O(z12));
  nand4  g33(.a(new_n22_), .b(x2), .c(new_n27_), .d(new_n43_), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n23_), .O(z13));
  nand4  g35(.a(x3), .b(new_n28_), .c(new_n27_), .d(new_n43_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n23_), .O(z14));
  nand4  g37(.a(new_n22_), .b(new_n28_), .c(new_n27_), .d(new_n43_), .O(new_n59_));
