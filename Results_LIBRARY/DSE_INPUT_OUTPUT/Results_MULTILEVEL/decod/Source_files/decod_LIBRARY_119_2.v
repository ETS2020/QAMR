...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n49_;
  ...
  nand3  g19(.a(x4), .b(x3), .c(new_n28_), .O(new_n42_));
  oai21  g20(.a(new_n42_), .b(new_n38_), .c(new_n36_), .O(z10));
  nand4  g21(.a(new_n31_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n25_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n35_), .d(new_n22_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n25_), .O(z12));
  aoi21  g25(.a(new_n40_), .b(new_n22_), .c(x1), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n35_), .d(new_n22_), .O(new_n49_));
