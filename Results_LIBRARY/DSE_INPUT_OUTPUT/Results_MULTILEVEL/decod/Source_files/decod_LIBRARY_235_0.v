...
module FAU ( 
  ...
  aoi21  g11(.a(new_n32_), .b(x4), .c(x3), .O(z03));
  inv1   g12(.a(x1), .O(new_n34_));
  nand4  g13(.a(x3), .b(x2), .c(new_n34_), .d(x0), .O(new_n35_));
  nor2   g14(.a(new_n35_), .b(new_n23_), .O(z04));
  nand3  g15(.a(x2), .b(new_n34_), .c(x0), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(x4), .c(x3), .O(z05));
  nand2  g17(.a(new_n34_), .b(x0), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n30_), .c(new_n28_), .O(z06));
  nand3  g19(.a(new_n29_), .b(new_n34_), .c(x0), .O(new_n41_));
  ...
  nand3  g25(.a(x2), .b(x1), .c(new_n43_), .O(new_n47_));
  ...
  nand2  g30(.a(new_n34_), .b(new_n43_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n45_), .c(new_n28_), .O(z12));
  nand4  g32(.a(new_n22_), .b(x2), .c(new_n34_), .d(new_n43_), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n23_), .O(z13));
  nand4  g34(.a(x3), .b(new_n29_), .c(new_n34_), .d(new_n43_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n23_), .O(z14));
  nand3  g36(.a(new_n29_), .b(new_n34_), .c(new_n43_), .O(new_n58_));
