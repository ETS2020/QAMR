...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n45_,
    new_n47_, new_n50_;
  ...
  nand4  g22(.a(x3), .b(x2), .c(new_n30_), .d(new_n33_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n23_), .O(z12));
  nand4  g24(.a(new_n22_), .b(x2), .c(new_n30_), .d(new_n33_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n23_), .O(z13));
  aoi21  g26(.a(new_n40_), .b(new_n30_), .c(x0), .O(z14));
  nand4  g27(.a(new_n22_), .b(new_n27_), .c(new_n30_), .d(new_n33_), .O(new_n50_));
