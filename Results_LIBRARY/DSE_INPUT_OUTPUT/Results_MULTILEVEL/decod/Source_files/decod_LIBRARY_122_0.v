...
module FAU ( 
  ...
  nand2  g19(.a(new_n23_), .b(new_n32_), .O(new_n41_));
  ...
  nand4  g26(.a(x3), .b(new_n27_), .c(x1), .d(new_n42_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n23_), .O(z10));
  nand3  g28(.a(x4), .b(new_n22_), .c(new_n27_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n43_), .c(new_n41_), .O(z11));
  nand3  g30(.a(x3), .b(x2), .c(new_n42_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(x1), .O(z12));
  nand4  g32(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n42_), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n23_), .O(z13));
  nand4  g34(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n42_), .O(new_n56_));
