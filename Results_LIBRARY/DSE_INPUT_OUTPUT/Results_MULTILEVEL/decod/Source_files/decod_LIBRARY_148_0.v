...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    ...
    new_n44_, new_n45_, new_n48_, new_n50_, new_n52_, new_n55_, new_n57_;
  ...
  nand4  g09(.a(x3), .b(new_n22_), .c(x1), .d(x0), .O(new_n31_));
  ...
  oai21  g17(.a(new_n38_), .b(new_n29_), .c(new_n24_), .O(z05));
  nand4  g18(.a(x3), .b(new_n22_), .c(new_n35_), .d(x0), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n23_), .O(z06));
  nand4  g20(.a(new_n28_), .b(new_n22_), .c(new_n35_), .d(x0), .O(new_n42_));
  ...
  oai21  g25(.a(new_n45_), .b(new_n29_), .c(new_n24_), .O(z09));
  nand4  g26(.a(x3), .b(new_n22_), .c(x1), .d(new_n44_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n23_), .O(z10));
  nand4  g28(.a(new_n28_), .b(new_n22_), .c(x1), .d(new_n44_), .O(new_n50_));
  ...
  oai21  g32(.a(new_n52_), .b(new_n29_), .c(new_n24_), .O(z13));
  nand3  g33(.a(x3), .b(new_n35_), .c(new_n44_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(x4), .c(x2), .O(z14));
  nand4  g35(.a(new_n28_), .b(new_n22_), .c(new_n35_), .d(new_n44_), .O(new_n57_));
