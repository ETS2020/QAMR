...
module FAU ( 
  ...
  nand4  g17(.a(new_n25_), .b(x2), .c(x1), .d(new_n28_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n22_), .O(z09));
  nand2  g19(.a(x1), .b(new_n28_), .O(new_n43_));
  nand3  g20(.a(x4), .b(x3), .c(new_n29_), .O(new_n44_));
  oai21  g21(.a(new_n44_), .b(new_n43_), .c(new_n26_), .O(z10));
  nand4  g22(.a(new_n25_), .b(new_n29_), .c(x1), .d(new_n28_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n22_), .O(z11));
  nand2  g24(.a(new_n33_), .b(new_n28_), .O(new_n48_));
  nand3  g25(.a(x4), .b(x3), .c(x2), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n48_), .c(new_n26_), .O(z12));
  nand4  g27(.a(new_n25_), .b(x2), .c(new_n33_), .d(new_n28_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n22_), .O(z13));
  oai21  g29(.a(new_n48_), .b(new_n44_), .c(new_n26_), .O(z14));
  aoi21  g30(.a(new_n36_), .b(new_n28_), .c(x3), .O(z15));
  zero   g31(.O(z03));
  zero   g32(.O(z07));
