...
module FAU ( 
  ...
  oai21  g20(.a(new_n43_), .b(new_n38_), .c(new_n33_), .O(z10));
  ...
  nand4  g26(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n37_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z14));
  nand4  g28(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n37_), .O(new_n52_));
