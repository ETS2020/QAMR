...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    ...
    new_n42_, new_n45_, new_n47_, new_n49_, new_n51_, new_n53_, new_n55_,
    new_n57_, new_n59_;
  ...
  oai21  g21(.a(new_n42_), .b(new_n41_), .c(new_n27_), .O(z06));
  oai21  g22(.a(new_n41_), .b(new_n34_), .c(new_n27_), .O(z07));
