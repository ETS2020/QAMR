...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_, new_n34_, new_n37_, new_n40_, new_n42_, new_n43_,
  ...
  nand4  g17(.a(new_n22_), .b(new_n28_), .c(new_n32_), .d(x0), .O(new_n40_));
  ...
  nand3  g24(.a(x4), .b(new_n28_), .c(new_n42_), .O(new_n47_));
  aoi21  g25(.a(new_n47_), .b(x1), .c(new_n22_), .O(z10));
  nand4  g26(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n42_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n25_), .O(z11));
  nand3  g28(.a(x4), .b(x2), .c(new_n42_), .O(new_n51_));
  aoi21  g29(.a(new_n51_), .b(new_n22_), .c(x1), .O(z13));
  aoi21  g30(.a(new_n47_), .b(new_n22_), .c(x1), .O(z15));
  zero   g31(.O(z04));
  inv1   g32(.a(new_n33_), .O(z12));
