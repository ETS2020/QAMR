...
module FAU ( 
  ...
  oai21  g25(.a(new_n48_), .b(new_n47_), .c(new_n24_), .O(z12));
  nand3  g26(.a(x4), .b(new_n30_), .c(x2), .O(new_n50_));
  oai21  g27(.a(new_n50_), .b(new_n47_), .c(new_n24_), .O(z13));
  nand4  g28(.a(x3), .b(new_n33_), .c(new_n27_), .d(new_n38_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n26_), .O(z14));
  nand3  g30(.a(x4), .b(new_n30_), .c(new_n33_), .O(new_n54_));
  oai21  g31(.a(new_n54_), .b(new_n47_), .c(new_n24_), .O(z15));
  zero   g32(.O(z00));
  zero   g33(.O(z01));
  inv1   g34(.a(new_n24_), .O(z03));
endmodule
