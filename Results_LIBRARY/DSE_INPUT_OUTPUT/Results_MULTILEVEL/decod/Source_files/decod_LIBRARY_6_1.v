...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n35_, new_n36_, new_n39_, new_n41_, new_n47_,
    new_n49_;
  ...
  nand4  g17(.a(x3), .b(new_n29_), .c(new_n22_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n28_), .O(z06));
  nand4  g19(.a(new_n25_), .b(new_n29_), .c(new_n22_), .d(x0), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n28_), .O(z07));
  inv1   g21(.a(new_n35_), .O(z08));
  aoi21  g22(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  aoi21  g23(.a(new_n26_), .b(new_n22_), .c(x0), .O(z13));
  nand4  g24(.a(x3), .b(new_n29_), .c(new_n22_), .d(new_n34_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n28_), .O(z14));
  nand3  g26(.a(x4), .b(new_n25_), .c(new_n29_), .O(new_n49_));
  aoi21  g27(.a(new_n49_), .b(new_n22_), .c(x0), .O(z15));
  zero   g28(.O(z11));
  inv1   g29(.a(new_n35_), .O(z09));
