...
module FAU ( 
  ...
  wire new_n23_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_, new_n33_,
    new_n35_, new_n36_, new_n38_, new_n41_, new_n44_, new_n46_, new_n48_,
    new_n50_;
  ...
  aoi21  g18(.a(new_n36_), .b(new_n27_), .c(new_n28_), .O(z10));
  nand3  g19(.a(x4), .b(new_n32_), .c(new_n35_), .O(new_n44_));
  aoi21  g20(.a(new_n44_), .b(new_n27_), .c(new_n28_), .O(z11));
  ...
  oai21  g26(.a(new_n50_), .b(new_n36_), .c(new_n23_), .O(z14));
  oai21  g27(.a(new_n50_), .b(new_n44_), .c(new_n23_), .O(z15));
  zero   g28(.O(z00));
  zero   g29(.O(z02));
  zero   g30(.O(z03));
endmodule
