...
module FAU ( 
  ...
  nand3  g15(.a(x4), .b(new_n31_), .c(x0), .O(new_n38_));
  ...
  nand4  g20(.a(new_n23_), .b(x2), .c(x1), .d(new_n41_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n30_), .O(z09));
  nand3  g22(.a(x4), .b(x3), .c(new_n31_), .O(new_n46_));
  oai21  g23(.a(new_n46_), .b(new_n42_), .c(new_n24_), .O(z10));
  nand4  g24(.a(new_n23_), .b(new_n31_), .c(x1), .d(new_n41_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n30_), .O(z11));
  nand3  g26(.a(x4), .b(x2), .c(new_n41_), .O(new_n50_));
  aoi21  g27(.a(new_n50_), .b(x3), .c(x1), .O(z12));
  nand4  g28(.a(x3), .b(new_n31_), .c(new_n22_), .d(new_n41_), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(new_n30_), .O(z14));
