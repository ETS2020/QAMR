...
module FAU ( 
  ...
  nand3  g21(.a(x4), .b(new_n25_), .c(new_n29_), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n38_), .c(new_n40_), .O(z07));
  inv1   g23(.a(new_n40_), .O(z08));
  aoi21  g24(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  aoi21  g25(.a(new_n26_), .b(new_n22_), .c(x0), .O(z13));
  aoi21  g26(.a(new_n41_), .b(new_n22_), .c(x0), .O(z14));
  nand4  g27(.a(new_n25_), .b(new_n29_), .c(new_n22_), .d(new_n39_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n28_), .O(z15));
  zero   g29(.O(z09));
