...
module FAU ( 
  ...
  nand4  g26(.a(x3), .b(new_n30_), .c(x1), .d(new_n43_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n22_), .O(z10));
  oai21  g28(.a(new_n46_), .b(new_n33_), .c(new_n26_), .O(z11));
  nand4  g29(.a(x3), .b(x2), .c(new_n35_), .d(new_n43_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n22_), .O(z12));
  nand4  g31(.a(new_n27_), .b(x2), .c(new_n35_), .d(new_n43_), .O(new_n53_));
  ...
  oai21  g36(.a(new_n57_), .b(new_n33_), .c(new_n26_), .O(z15));
endmodule
