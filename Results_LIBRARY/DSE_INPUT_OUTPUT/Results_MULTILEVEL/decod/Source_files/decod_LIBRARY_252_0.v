...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n31_, new_n32_,
    new_n34_, new_n38_, new_n39_, new_n41_, new_n43_, new_n46_, new_n48_,
    new_n50_;
  ...
  nand3  g11(.a(x4), .b(new_n31_), .c(x0), .O(new_n34_));
  aoi21  g12(.a(new_n34_), .b(x2), .c(x3), .O(z05));
  aoi21  g13(.a(new_n34_), .b(x3), .c(x2), .O(z06));
  inv1   g14(.a(x0), .O(new_n38_));
  nand4  g15(.a(x3), .b(x2), .c(x1), .d(new_n38_), .O(new_n39_));
  nor2   g16(.a(new_n39_), .b(new_n23_), .O(z08));
  nand4  g17(.a(new_n22_), .b(x2), .c(x1), .d(new_n38_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n23_), .O(z09));
  nand3  g19(.a(x4), .b(x1), .c(new_n38_), .O(new_n43_));
  aoi21  g20(.a(new_n43_), .b(x3), .c(x2), .O(z10));
  nand4  g21(.a(x3), .b(x2), .c(new_n31_), .d(new_n38_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n23_), .O(z12));
  nand4  g23(.a(new_n22_), .b(x2), .c(new_n31_), .d(new_n38_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n23_), .O(z13));
  nand4  g25(.a(x3), .b(new_n27_), .c(new_n31_), .d(new_n38_), .O(new_n50_));
