...
module FAU ( 
  ...
  nand4  g24(.a(x3), .b(new_n31_), .c(x1), .d(new_n42_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n28_), .O(z10));
  ...
  nand4  g30(.a(x3), .b(new_n31_), .c(new_n22_), .d(new_n42_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n28_), .O(z14));
  zero   g32(.O(z07));
