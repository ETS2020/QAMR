...
module FAU ( 
  ...
  aoi21  g25(.a(new_n46_), .b(x4), .c(new_n30_), .O(z09));
  ...
  oai21  g33(.a(new_n54_), .b(new_n37_), .c(new_n33_), .O(z13));
  oai21  g34(.a(new_n54_), .b(new_n39_), .c(new_n33_), .O(z14));
  nand4  g35(.a(new_n22_), .b(new_n27_), .c(new_n30_), .d(new_n43_), .O(new_n57_));
