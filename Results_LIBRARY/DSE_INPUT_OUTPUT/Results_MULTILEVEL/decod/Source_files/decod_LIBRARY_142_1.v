...
module FAU ( 
  ...
  nand3  g15(.a(new_n26_), .b(x1), .c(new_n36_), .O(new_n39_));
  aoi21  g16(.a(new_n39_), .b(x3), .c(new_n22_), .O(z10));
  nand3  g17(.a(x2), .b(new_n30_), .c(new_n36_), .O(new_n41_));
  aoi21  g18(.a(new_n41_), .b(x3), .c(new_n22_), .O(z12));
  nand4  g19(.a(x3), .b(new_n26_), .c(new_n30_), .d(new_n36_), .O(new_n43_));
