...
module FAU ( 
  ...
  nand4  g21(.a(new_n30_), .b(new_n34_), .c(x1), .d(new_n33_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n26_), .O(z11));
  nand2  g23(.a(new_n27_), .b(new_n33_), .O(new_n47_));
  oai21  g24(.a(new_n47_), .b(new_n39_), .c(new_n23_), .O(z12));
  nand3  g25(.a(x4), .b(new_n30_), .c(x2), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n47_), .c(new_n23_), .O(z13));
  oai21  g27(.a(new_n47_), .b(new_n35_), .c(new_n23_), .O(z14));
  nand4  g28(.a(new_n30_), .b(new_n34_), .c(new_n27_), .d(new_n33_), .O(new_n52_));
