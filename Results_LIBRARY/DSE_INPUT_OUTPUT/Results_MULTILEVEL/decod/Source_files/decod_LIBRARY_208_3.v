...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n38_, new_n41_, new_n44_, new_n45_,
    new_n48_, new_n50_;
  ...
  aoi21  g20(.a(new_n36_), .b(new_n29_), .c(new_n26_), .O(z11));
  nand2  g21(.a(new_n26_), .b(new_n29_), .O(new_n44_));
  nand3  g22(.a(x4), .b(x3), .c(x2), .O(new_n45_));
  oai21  g23(.a(new_n45_), .b(new_n44_), .c(new_n22_), .O(z12));
  oai21  g24(.a(new_n44_), .b(new_n31_), .c(new_n22_), .O(z13));
  nand3  g25(.a(x4), .b(x3), .c(new_n33_), .O(new_n48_));
  oai21  g26(.a(new_n48_), .b(new_n44_), .c(new_n22_), .O(z14));
  nand4  g27(.a(new_n30_), .b(new_n33_), .c(new_n26_), .d(new_n29_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n25_), .O(z15));
  zero   g29(.O(z02));
