...
module FAU ( 
  ...
  nand4  g16(.a(new_n30_), .b(new_n26_), .c(new_n29_), .d(x0), .O(new_n39_));
  nor2   g17(.a(new_n39_), .b(new_n25_), .O(z07));
  inv1   g18(.a(x0), .O(new_n43_));
  nand4  g19(.a(x3), .b(new_n26_), .c(x1), .d(new_n43_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n25_), .O(z10));
  nand3  g21(.a(x4), .b(new_n30_), .c(new_n43_), .O(new_n46_));
  aoi21  g22(.a(new_n46_), .b(new_n26_), .c(new_n29_), .O(z11));
  nand3  g23(.a(x4), .b(x3), .c(new_n43_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n29_), .c(new_n26_), .O(z12));
  nand4  g25(.a(new_n30_), .b(x2), .c(new_n29_), .d(new_n43_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n25_), .O(z13));
  nand4  g27(.a(x3), .b(new_n26_), .c(new_n29_), .d(new_n43_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n25_), .O(z14));
  nand2  g29(.a(new_n29_), .b(new_n43_), .O(new_n54_));
  nand3  g30(.a(x4), .b(new_n30_), .c(new_n26_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n54_), .c(new_n23_), .O(z15));
  zero   g32(.O(z00));
  zero   g33(.O(z08));
  zero   g34(.O(z09));
endmodule
