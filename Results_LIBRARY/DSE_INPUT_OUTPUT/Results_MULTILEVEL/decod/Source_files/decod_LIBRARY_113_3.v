...
module FAU ( 
  ...
  wire new_n24_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n37_, new_n39_, new_n42_, new_n45_, new_n47_;
  ...
  oai21  g24(.a(new_n47_), .b(new_n32_), .c(new_n24_), .O(z13));
  oai21  g25(.a(new_n47_), .b(new_n35_), .c(new_n24_), .O(z14));
  oai21  g26(.a(new_n47_), .b(new_n37_), .c(new_n24_), .O(z15));
  zero   g27(.O(z00));
  zero   g28(.O(z01));
  inv1   g29(.a(new_n24_), .O(z03));
endmodule
