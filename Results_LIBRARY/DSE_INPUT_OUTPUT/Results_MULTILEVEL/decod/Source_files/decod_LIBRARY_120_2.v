...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n36_, new_n37_, new_n39_, new_n40_, new_n44_, new_n47_,
    new_n49_;
  ...
  oai21  g18(.a(new_n39_), .b(new_n27_), .c(new_n37_), .O(z09));
  oai21  g19(.a(new_n39_), .b(new_n30_), .c(new_n37_), .O(z10));
  nand4  g20(.a(new_n26_), .b(new_n29_), .c(x1), .d(new_n25_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n22_), .O(z11));
  aoi21  g22(.a(new_n40_), .b(new_n25_), .c(x1), .O(z12));
  nand4  g23(.a(new_n26_), .b(x2), .c(new_n36_), .d(new_n25_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n22_), .O(z13));
  nand4  g25(.a(x3), .b(new_n29_), .c(new_n36_), .d(new_n25_), .O(new_n49_));
