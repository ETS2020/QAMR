...
module FAU ( 
  ...
  nand3  g16(.a(x4), .b(new_n28_), .c(new_n29_), .O(new_n40_));
  oai21  g17(.a(new_n40_), .b(new_n35_), .c(new_n34_), .O(z07));
  inv1   g18(.a(x0), .O(new_n43_));
  nand3  g19(.a(x4), .b(x2), .c(new_n43_), .O(new_n44_));
  aoi21  g20(.a(new_n44_), .b(new_n28_), .c(new_n27_), .O(z09));
  ...
  nand4  g26(.a(new_n28_), .b(x2), .c(new_n27_), .d(new_n43_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n23_), .O(z13));
  nand3  g28(.a(x4), .b(new_n29_), .c(new_n43_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n27_), .c(new_n28_), .O(z14));
  nand2  g30(.a(new_n27_), .b(new_n43_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n40_), .c(new_n34_), .O(z15));
  zero   g32(.O(z00));
  zero   g33(.O(z02));
  zero   g34(.O(z08));
endmodule
