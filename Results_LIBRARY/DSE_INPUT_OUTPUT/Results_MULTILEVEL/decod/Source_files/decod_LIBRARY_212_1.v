...
module FAU ( 
  ...
  aoi21  g17(.a(new_n31_), .b(new_n22_), .c(x1), .O(z07));
  ...
  nor2   g24(.a(new_n45_), .b(new_n36_), .O(z10));
  nand2  g25(.a(x1), .b(new_n40_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n33_), .c(new_n26_), .O(z11));
  aoi21  g27(.a(new_n41_), .b(new_n22_), .c(x1), .O(z13));
  nand4  g28(.a(new_n22_), .b(new_n30_), .c(new_n25_), .d(new_n40_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n36_), .O(z15));
