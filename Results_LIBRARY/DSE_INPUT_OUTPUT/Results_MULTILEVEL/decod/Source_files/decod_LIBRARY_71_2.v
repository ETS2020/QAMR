...
module FAU ( 
  ...
  oai21  g21(.a(new_n44_), .b(new_n39_), .c(new_n35_), .O(z10));
  nand3  g22(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n46_));
  oai21  g23(.a(new_n46_), .b(new_n39_), .c(new_n35_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n34_), .d(new_n25_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n22_), .O(z12));
  nand4  g26(.a(new_n26_), .b(x2), .c(new_n34_), .d(new_n25_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n22_), .O(z13));
  aoi21  g28(.a(new_n44_), .b(new_n25_), .c(x1), .O(z14));
  aoi21  g29(.a(new_n46_), .b(new_n25_), .c(x1), .O(z15));
  zero   g30(.O(z05));
  zero   g31(.O(z07));
