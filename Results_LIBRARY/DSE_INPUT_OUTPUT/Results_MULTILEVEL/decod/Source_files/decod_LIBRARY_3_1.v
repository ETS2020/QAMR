...
module FAU ( 
  ...
  nand3  g24(.a(x4), .b(new_n22_), .c(x2), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n34_), .c(x0), .O(z13));
  nand3  g26(.a(x4), .b(x3), .c(new_n27_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n34_), .c(x0), .O(z14));
