...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n35_, new_n36_, new_n38_, new_n40_, new_n41_, new_n43_, new_n44_,
  ...
  nand3  g21(.a(x4), .b(new_n22_), .c(x2), .O(new_n44_));
  oai21  g22(.a(new_n44_), .b(new_n43_), .c(new_n36_), .O(z09));
  nand4  g23(.a(x3), .b(new_n28_), .c(x1), .d(new_n40_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n25_), .O(z10));
  nand4  g25(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n40_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n25_), .O(z11));
  nand4  g27(.a(new_n22_), .b(x2), .c(new_n35_), .d(new_n40_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n25_), .O(z13));
  nand4  g29(.a(new_n22_), .b(new_n28_), .c(new_n35_), .d(new_n40_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n25_), .O(z15));
  zero   g31(.O(z04));
  zero   g32(.O(z12));
  inv1   g33(.a(new_n36_), .O(z14));
endmodule
