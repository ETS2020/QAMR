...
module FAU ( 
  ...
  aoi21  g14(.a(new_n35_), .b(new_n25_), .c(new_n28_), .O(z07));
  ...
  aoi21  g19(.a(new_n33_), .b(new_n28_), .c(new_n25_), .O(z10));
  nand4  g20(.a(new_n29_), .b(new_n32_), .c(x1), .d(new_n28_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n24_), .O(z11));
  nand2  g22(.a(new_n25_), .b(new_n28_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n37_), .c(new_n22_), .O(z12));
  nand4  g24(.a(new_n29_), .b(x2), .c(new_n25_), .d(new_n28_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n24_), .O(z13));
  oai21  g26(.a(new_n44_), .b(new_n33_), .c(new_n22_), .O(z14));
  oai21  g27(.a(new_n44_), .b(new_n35_), .c(new_n22_), .O(z15));
