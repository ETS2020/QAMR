...
module FAU ( 
  ...
  nand4  g17(.a(x3), .b(new_n31_), .c(new_n28_), .d(x0), .O(new_n39_));
  ...
  oai21  g22(.a(new_n44_), .b(new_n43_), .c(new_n30_), .O(z08));
  nand4  g23(.a(new_n29_), .b(x2), .c(x1), .d(new_n42_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n22_), .O(z09));
  oai21  g25(.a(new_n43_), .b(new_n32_), .c(new_n30_), .O(z10));
  ...
  aoi21  g30(.a(new_n49_), .b(x3), .c(x1), .O(z14));
  zero   g31(.O(z07));
  zero   g32(.O(z13));
