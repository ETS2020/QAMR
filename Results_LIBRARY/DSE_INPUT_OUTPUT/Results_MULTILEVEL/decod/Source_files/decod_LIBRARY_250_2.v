...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n30_, new_n31_, new_n32_,
    ...
    new_n45_, new_n49_, new_n52_, new_n54_;
  ...
  nand3  g11(.a(x4), .b(new_n25_), .c(x2), .O(new_n35_));
  oai21  g12(.a(new_n35_), .b(new_n32_), .c(new_n31_), .O(z05));
  ...
  nor2   g17(.a(new_n40_), .b(new_n37_), .O(z07));
  inv1   g18(.a(x0), .O(new_n42_));
  nand4  g19(.a(x3), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n37_), .O(z08));
  nand4  g21(.a(new_n25_), .b(x2), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n37_), .O(z09));
  nand2  g23(.a(new_n22_), .b(new_n42_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n33_), .c(new_n31_), .O(z12));
  oai21  g25(.a(new_n49_), .b(new_n35_), .c(new_n31_), .O(z13));
  nand3  g26(.a(x4), .b(x3), .c(new_n42_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n22_), .c(x2), .O(z14));
  nand4  g28(.a(new_n25_), .b(new_n30_), .c(new_n22_), .d(new_n42_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(new_n37_), .O(z15));
  zero   g30(.O(z02));
  zero   g31(.O(z03));
  zero   g32(.O(z10));
  zero   g33(.O(z11));
