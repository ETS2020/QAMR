...
module FAU ( 
  ...
  nor2   g20(.a(new_n43_), .b(new_n31_), .O(z08));
  nand4  g21(.a(new_n28_), .b(x2), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n31_), .O(z09));
  nand4  g23(.a(x3), .b(new_n23_), .c(x1), .d(new_n42_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n31_), .O(z10));
  nand4  g25(.a(new_n28_), .b(new_n23_), .c(x1), .d(new_n42_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n31_), .O(z11));
  nand3  g27(.a(x4), .b(x3), .c(new_n42_), .O(new_n51_));
  aoi21  g28(.a(new_n51_), .b(x2), .c(x1), .O(z12));
  nand4  g29(.a(new_n28_), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n31_), .O(z13));
  zero   g31(.O(z06));
  zero   g32(.O(z07));
  zero   g33(.O(z14));
  zero   g34(.O(z15));
