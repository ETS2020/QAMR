...
module FAU ( 
  ...
  nand4  g17(.a(new_n28_), .b(new_n27_), .c(new_n31_), .d(x0), .O(new_n39_));
  ...
  nand2  g26(.a(new_n31_), .b(new_n41_), .O(new_n49_));
  oai21  g27(.a(new_n49_), .b(new_n35_), .c(new_n22_), .O(z13));
  nand4  g28(.a(x3), .b(new_n27_), .c(new_n31_), .d(new_n41_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n24_), .O(z14));
  nand3  g30(.a(x4), .b(new_n28_), .c(new_n27_), .O(new_n53_));
  oai21  g31(.a(new_n53_), .b(new_n49_), .c(new_n22_), .O(z15));
  zero   g32(.O(z10));
