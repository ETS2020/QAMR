...
module FAU ( 
  ...
  wire new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n35_, new_n36_, new_n38_, new_n41_, new_n43_, new_n45_,
  ...
  nand4  g13(.a(new_n29_), .b(new_n32_), .c(new_n26_), .d(x0), .O(new_n36_));
  nor2   g14(.a(new_n36_), .b(new_n35_), .O(z07));
  nand4  g15(.a(x3), .b(x2), .c(x1), .d(new_n25_), .O(new_n38_));
  nor2   g16(.a(new_n38_), .b(new_n35_), .O(z08));
  aoi21  g17(.a(new_n30_), .b(new_n25_), .c(new_n26_), .O(z09));
  nand4  g18(.a(x3), .b(new_n32_), .c(x1), .d(new_n25_), .O(new_n41_));
  nor2   g19(.a(new_n41_), .b(new_n35_), .O(z10));
  nand4  g20(.a(new_n29_), .b(new_n32_), .c(x1), .d(new_n25_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n35_), .O(z11));
  nand2  g22(.a(new_n26_), .b(new_n25_), .O(new_n45_));
  oai21  g23(.a(new_n45_), .b(new_n27_), .c(new_n23_), .O(z12));
  nand4  g24(.a(new_n29_), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n35_), .O(z13));
  nand4  g26(.a(x3), .b(new_n32_), .c(new_n26_), .d(new_n25_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n35_), .O(z14));
  nand4  g28(.a(new_n29_), .b(new_n32_), .c(new_n26_), .d(new_n25_), .O(new_n51_));
