...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    ...
    new_n45_, new_n48_, new_n50_, new_n52_, new_n53_;
  ...
  nand4  g15(.a(x3), .b(new_n26_), .c(new_n32_), .d(x0), .O(new_n38_));
  nor2   g16(.a(new_n38_), .b(new_n22_), .O(z06));
  nand3  g17(.a(x4), .b(new_n26_), .c(x0), .O(new_n40_));
  ...
  aoi21  g23(.a(new_n45_), .b(x3), .c(new_n32_), .O(z10));
  ...
  oai21  g30(.a(new_n53_), .b(new_n52_), .c(new_n30_), .O(z14));
  aoi21  g31(.a(new_n45_), .b(new_n32_), .c(x3), .O(z15));
  zero   g32(.O(z01));
  zero   g33(.O(z11));
  inv1   g34(.a(new_n30_), .O(z09));
endmodule
