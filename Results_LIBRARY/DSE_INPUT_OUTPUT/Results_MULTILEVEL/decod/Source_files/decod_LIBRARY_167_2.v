...
module FAU ( 
  ...
  nand2  g12(.a(new_n33_), .b(x1), .O(new_n34_));
  ...
  oai21  g33(.a(new_n53_), .b(new_n38_), .c(new_n34_), .O(z13));
  nand4  g34(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n44_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n33_), .O(z14));
  nand4  g36(.a(new_n25_), .b(new_n28_), .c(new_n22_), .d(new_n44_), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n33_), .O(z15));
endmodule
