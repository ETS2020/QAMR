...
module FAU ( 
  ...
  wire new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n34_, new_n36_, new_n38_, new_n40_, new_n44_, new_n46_,
    new_n48_, new_n50_;
  ...
  aoi21  g12(.a(new_n34_), .b(new_n26_), .c(new_n32_), .O(z06));
  nand3  g13(.a(x4), .b(new_n29_), .c(new_n33_), .O(new_n36_));
  aoi21  g14(.a(new_n36_), .b(new_n26_), .c(new_n32_), .O(z07));
  nand3  g15(.a(x4), .b(x3), .c(x2), .O(new_n38_));
  aoi21  g16(.a(new_n38_), .b(new_n32_), .c(new_n26_), .O(z08));
  nand4  g17(.a(new_n29_), .b(x2), .c(x1), .d(new_n32_), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n25_), .O(z09));
  aoi21  g19(.a(new_n34_), .b(new_n32_), .c(new_n26_), .O(z10));
  aoi21  g20(.a(new_n36_), .b(new_n32_), .c(new_n26_), .O(z11));
  nand4  g21(.a(x3), .b(x2), .c(new_n26_), .d(new_n32_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n25_), .O(z12));
  nand4  g23(.a(new_n29_), .b(x2), .c(new_n26_), .d(new_n32_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n25_), .O(z13));
  nand2  g25(.a(new_n26_), .b(new_n32_), .O(new_n48_));
  oai21  g26(.a(new_n48_), .b(new_n34_), .c(new_n23_), .O(z14));
  nand4  g27(.a(new_n29_), .b(new_n33_), .c(new_n26_), .d(new_n32_), .O(new_n50_));
