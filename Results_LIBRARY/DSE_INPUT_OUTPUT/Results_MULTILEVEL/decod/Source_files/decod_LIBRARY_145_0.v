...
module FAU ( 
  ...
  nand4  g20(.a(new_n33_), .b(new_n30_), .c(new_n36_), .d(x0), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n23_), .O(z07));
  nand3  g22(.a(x3), .b(x2), .c(x1), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(x4), .c(x0), .O(z08));
  nand3  g24(.a(new_n33_), .b(x2), .c(x1), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(x4), .c(x0), .O(z09));
  nand4  g26(.a(x3), .b(new_n30_), .c(x1), .d(new_n22_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n23_), .O(z10));
  nand3  g28(.a(new_n33_), .b(new_n30_), .c(x1), .O(new_n50_));
  ...
  nand4  g34(.a(x3), .b(new_n30_), .c(new_n36_), .d(new_n22_), .O(new_n56_));
