...
module FAU ( 
  ...
  nand4  g19(.a(x3), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n25_), .O(z10));
  nand3  g21(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n37_), .c(new_n35_), .O(z11));
  aoi21  g23(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  aoi21  g24(.a(new_n39_), .b(new_n22_), .c(x1), .O(z13));
  nand4  g25(.a(x3), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n47_));
