...
module FAU ( 
  ...
  nand4  g17(.a(new_n22_), .b(x2), .c(x1), .d(new_n30_), .O(new_n42_));
  ...
  aoi21  g23(.a(new_n40_), .b(new_n30_), .c(x1), .O(z12));
  ...
  aoi21  g27(.a(new_n51_), .b(new_n30_), .c(x1), .O(z14));
  aoi21  g28(.a(new_n31_), .b(new_n30_), .c(x1), .O(z15));
  zero   g29(.O(z04));
  zero   g30(.O(z05));
  zero   g31(.O(z06));
endmodule
