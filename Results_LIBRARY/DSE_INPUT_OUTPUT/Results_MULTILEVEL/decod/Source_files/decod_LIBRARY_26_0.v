...
module FAU ( 
  ...
  oai21  g22(.a(new_n43_), .b(new_n29_), .c(new_n24_), .O(z09));
  nand4  g23(.a(x3), .b(new_n23_), .c(x1), .d(new_n42_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n31_), .O(z10));
  nand3  g25(.a(x4), .b(new_n28_), .c(new_n42_), .O(new_n48_));
  aoi21  g26(.a(new_n48_), .b(x1), .c(x2), .O(z11));
  nand3  g27(.a(x4), .b(x3), .c(new_n42_), .O(new_n50_));
