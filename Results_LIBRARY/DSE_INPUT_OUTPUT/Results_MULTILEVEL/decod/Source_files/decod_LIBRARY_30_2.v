...
module FAU ( 
  ...
  nand3  g13(.a(x4), .b(new_n28_), .c(new_n33_), .O(new_n36_));
  ...
  nand3  g20(.a(x4), .b(x3), .c(new_n28_), .O(new_n43_));
  oai21  g21(.a(new_n43_), .b(new_n42_), .c(new_n26_), .O(z10));
  nand4  g22(.a(new_n25_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n32_), .O(z11));
  nand2  g24(.a(new_n33_), .b(new_n22_), .O(new_n47_));
  nand3  g25(.a(x4), .b(x3), .c(x2), .O(new_n48_));
  oai21  g26(.a(new_n48_), .b(new_n47_), .c(new_n26_), .O(z12));
  nand4  g27(.a(new_n25_), .b(x2), .c(new_n33_), .d(new_n22_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n32_), .O(z13));
  oai21  g29(.a(new_n47_), .b(new_n43_), .c(new_n26_), .O(z14));
  nand4  g30(.a(new_n25_), .b(new_n28_), .c(new_n33_), .d(new_n22_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n32_), .O(z15));
  zero   g32(.O(z03));
  inv1   g33(.a(new_n26_), .O(z05));
  inv1   g34(.a(new_n26_), .O(z07));
endmodule
