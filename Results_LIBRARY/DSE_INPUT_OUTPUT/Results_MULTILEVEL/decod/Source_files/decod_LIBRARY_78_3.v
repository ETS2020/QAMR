...
module FAU ( 
  ...
  wire new_n22_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n33_, new_n35_, new_n37_, new_n39_, new_n41_, new_n44_,
    new_n45_, new_n47_;
  ...
  aoi21  g14(.a(new_n35_), .b(new_n25_), .c(new_n31_), .O(z07));
  nand4  g15(.a(x3), .b(x2), .c(x1), .d(new_n31_), .O(new_n37_));
  ...
  aoi21  g21(.a(new_n35_), .b(new_n31_), .c(new_n25_), .O(z11));
  nand2  g22(.a(new_n25_), .b(new_n31_), .O(new_n44_));
  nand3  g23(.a(x4), .b(x3), .c(x2), .O(new_n45_));
  oai21  g24(.a(new_n45_), .b(new_n44_), .c(new_n22_), .O(z12));
  nand4  g25(.a(new_n28_), .b(x2), .c(new_n25_), .d(new_n31_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n24_), .O(z13));
  oai21  g27(.a(new_n44_), .b(new_n33_), .c(new_n22_), .O(z14));
  oai21  g28(.a(new_n44_), .b(new_n35_), .c(new_n22_), .O(z15));
