...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    ...
    new_n43_, new_n47_, new_n49_, new_n52_;
  ...
  nand4  g21(.a(new_n26_), .b(new_n29_), .c(new_n25_), .d(x0), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n22_), .O(z07));
  inv1   g23(.a(new_n35_), .O(z08));
  nand4  g24(.a(x3), .b(x2), .c(new_n25_), .d(new_n34_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n22_), .O(z12));
  nand4  g26(.a(new_n26_), .b(x2), .c(new_n25_), .d(new_n34_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n22_), .O(z13));
  aoi21  g28(.a(new_n41_), .b(new_n25_), .c(x0), .O(z14));
  nand3  g29(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n52_));
  aoi21  g30(.a(new_n52_), .b(new_n25_), .c(x0), .O(z15));
  zero   g31(.O(z09));
  inv1   g32(.a(new_n35_), .O(z10));
  inv1   g33(.a(new_n35_), .O(z11));
endmodule
