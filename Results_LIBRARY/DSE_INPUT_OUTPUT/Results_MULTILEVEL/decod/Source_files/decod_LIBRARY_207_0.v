...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    ...
    new_n44_, new_n46_, new_n48_, new_n50_, new_n52_, new_n55_, new_n57_;
  ...
  nand3  g19(.a(new_n28_), .b(new_n35_), .c(x0), .O(new_n41_));
  ...
  nand4  g26(.a(x3), .b(new_n22_), .c(x1), .d(new_n43_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n23_), .O(z10));
  nand3  g28(.a(new_n28_), .b(x1), .c(new_n43_), .O(new_n50_));
  ...
  nand3  g33(.a(x3), .b(new_n35_), .c(new_n43_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(x4), .c(x2), .O(z14));
  nand3  g35(.a(new_n28_), .b(new_n35_), .c(new_n43_), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(x4), .c(x2), .O(z15));
endmodule
