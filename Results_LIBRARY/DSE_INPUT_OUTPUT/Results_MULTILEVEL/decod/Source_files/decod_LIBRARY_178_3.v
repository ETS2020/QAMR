...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n35_, new_n37_, new_n38_, new_n40_, new_n43_, new_n44_,
  ...
  aoi21  g25(.a(new_n48_), .b(new_n29_), .c(new_n26_), .O(z12));
  nand3  g26(.a(x4), .b(new_n30_), .c(new_n43_), .O(new_n50_));
  aoi21  g27(.a(new_n50_), .b(new_n29_), .c(new_n26_), .O(z13));
  nand2  g28(.a(new_n29_), .b(new_n43_), .O(new_n52_));
  oai21  g29(.a(new_n52_), .b(new_n38_), .c(new_n22_), .O(z14));
  nand4  g30(.a(new_n30_), .b(new_n26_), .c(new_n29_), .d(new_n43_), .O(new_n54_));
