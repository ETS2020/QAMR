...
module FAU ( 
  ...
  oai21  g17(.a(new_n40_), .b(new_n39_), .c(new_n30_), .O(z08));
  nand3  g18(.a(x4), .b(new_n25_), .c(x2), .O(new_n42_));
  oai21  g19(.a(new_n42_), .b(new_n39_), .c(new_n30_), .O(z09));
  nand4  g20(.a(x3), .b(new_n29_), .c(x1), .d(new_n22_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n35_), .O(z10));
  aoi21  g22(.a(new_n26_), .b(new_n22_), .c(x2), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n32_), .d(new_n22_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n35_), .O(z12));
  nand2  g25(.a(new_n32_), .b(new_n22_), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n42_), .c(new_n30_), .O(z13));
  nand4  g27(.a(x3), .b(new_n29_), .c(new_n32_), .d(new_n22_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n35_), .O(z14));
  nand3  g29(.a(x4), .b(new_n25_), .c(new_n32_), .O(new_n53_));
