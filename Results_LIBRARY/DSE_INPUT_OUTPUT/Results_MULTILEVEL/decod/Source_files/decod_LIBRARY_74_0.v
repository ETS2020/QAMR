...
module FAU ( 
  ...
  nand3  g25(.a(x4), .b(new_n30_), .c(new_n41_), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x1), .c(x3), .O(z11));
  nand4  g27(.a(x3), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n33_), .O(z12));
  nand4  g29(.a(x3), .b(new_n30_), .c(new_n22_), .d(new_n41_), .O(new_n52_));
  nor2   g30(.a(new_n52_), .b(new_n33_), .O(z14));
  zero   g31(.O(z13));
