...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n38_, new_n43_, new_n45_;
  ...
  nand4  g20(.a(x3), .b(x2), .c(new_n26_), .d(new_n29_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n25_), .O(z12));
  nand2  g22(.a(new_n26_), .b(new_n29_), .O(new_n45_));
  oai21  g23(.a(new_n45_), .b(new_n31_), .c(new_n22_), .O(z13));
  oai21  g24(.a(new_n45_), .b(new_n34_), .c(new_n22_), .O(z14));
  oai21  g25(.a(new_n45_), .b(new_n36_), .c(new_n22_), .O(z15));
  zero   g26(.O(z01));
