...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n43_, new_n44_, new_n47_;
  ...
  oai21  g17(.a(new_n35_), .b(new_n31_), .c(new_n34_), .O(z07));
  inv1   g18(.a(new_n34_), .O(z08));
  aoi21  g19(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  inv1   g20(.a(x4), .O(new_n43_));
  nand4  g21(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n33_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n43_), .O(z13));
  aoi21  g23(.a(new_n29_), .b(new_n22_), .c(x0), .O(z14));
  nand4  g24(.a(new_n25_), .b(new_n28_), .c(new_n22_), .d(new_n33_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n43_), .O(z15));
  zero   g26(.O(z09));
  inv1   g27(.a(new_n34_), .O(z10));
  inv1   g28(.a(new_n34_), .O(z11));
endmodule
