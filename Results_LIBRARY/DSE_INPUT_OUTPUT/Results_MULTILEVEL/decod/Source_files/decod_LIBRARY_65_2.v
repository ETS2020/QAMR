...
module FAU ( 
  ...
  nor2   g18(.a(new_n39_), .b(new_n22_), .O(z06));
  ...
  nand4  g27(.a(x3), .b(new_n29_), .c(x1), .d(new_n25_), .O(new_n49_));
  ...
  nand4  g33(.a(new_n26_), .b(x2), .c(new_n34_), .d(new_n25_), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n22_), .O(z13));
  nand2  g35(.a(new_n34_), .b(new_n25_), .O(new_n57_));
  nand3  g36(.a(x4), .b(x3), .c(new_n29_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n57_), .c(new_n43_), .O(z14));
  nand3  g38(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n60_));
  oai21  g39(.a(new_n60_), .b(new_n57_), .c(new_n43_), .O(z15));
endmodule
