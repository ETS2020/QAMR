...
module FAU ( 
  ...
  nand3  g20(.a(x4), .b(new_n35_), .c(new_n41_), .O(new_n44_));
  ...
  nand3  g26(.a(x4), .b(new_n35_), .c(x2), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n50_), .c(new_n31_), .O(z13));
  nand3  g28(.a(x4), .b(x3), .c(new_n41_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n22_), .c(x2), .O(z14));
  nand4  g30(.a(new_n35_), .b(new_n30_), .c(new_n22_), .d(new_n41_), .O(new_n55_));
