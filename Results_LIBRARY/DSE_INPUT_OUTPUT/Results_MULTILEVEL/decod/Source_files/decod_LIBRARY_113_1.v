...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n35_, new_n36_, new_n37_, new_n38_, new_n45_;
  ...
  oai21  g17(.a(new_n38_), .b(new_n35_), .c(new_n37_), .O(z05));
  oai21  g18(.a(new_n35_), .b(new_n29_), .c(new_n37_), .O(z06));
  oai21  g19(.a(new_n35_), .b(new_n31_), .c(new_n37_), .O(z07));
  inv1   g20(.a(new_n37_), .O(z09));
  nand4  g21(.a(x3), .b(x2), .c(new_n27_), .d(new_n36_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n23_), .O(z12));
  aoi21  g23(.a(new_n38_), .b(new_n27_), .c(x0), .O(z13));
  aoi21  g24(.a(new_n29_), .b(new_n27_), .c(x0), .O(z14));
  aoi21  g25(.a(new_n31_), .b(new_n27_), .c(x0), .O(z15));
  zero   g26(.O(z08));
  zero   g27(.O(z10));
  inv1   g28(.a(new_n37_), .O(z11));
endmodule
