...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n32_, new_n34_, new_n36_, new_n37_, new_n43_, new_n46_;
  ...
  aoi21  g20(.a(new_n26_), .b(x1), .c(x0), .O(z08));
  nand4  g21(.a(new_n28_), .b(x2), .c(x1), .d(new_n22_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n36_), .O(z09));
  aoi21  g23(.a(new_n32_), .b(x1), .c(x0), .O(z10));
  nand4  g24(.a(new_n28_), .b(new_n31_), .c(x1), .d(new_n22_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n36_), .O(z11));
  inv1   g26(.a(new_n24_), .O(z12));
  zero   g27(.O(z13));
  inv1   g28(.a(new_n24_), .O(z14));
