...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n32_,
    new_n34_, new_n36_, new_n37_, new_n39_, new_n41_, new_n42_, new_n44_,
    new_n45_, new_n46_, new_n48_, new_n50_, new_n52_, new_n54_, new_n56_,
    new_n58_;
  ...
  nand3  g17(.a(new_n22_), .b(new_n27_), .c(x0), .O(new_n39_));
  aoi21  g18(.a(new_n39_), .b(x4), .c(x1), .O(z07));
  ...
  nand2  g23(.a(new_n23_), .b(new_n36_), .O(new_n45_));
  nand3  g24(.a(x4), .b(new_n22_), .c(x2), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n44_), .c(new_n45_), .O(z09));
  nand4  g26(.a(x3), .b(new_n27_), .c(x1), .d(new_n41_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n23_), .O(z10));
  nand3  g28(.a(x4), .b(new_n22_), .c(new_n27_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n44_), .c(new_n45_), .O(z11));
  nand4  g30(.a(x3), .b(x2), .c(new_n36_), .d(new_n41_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n23_), .O(z12));
  nand3  g32(.a(new_n22_), .b(x2), .c(new_n41_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(x1), .O(z13));
  nand4  g34(.a(x3), .b(new_n27_), .c(new_n36_), .d(new_n41_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n23_), .O(z14));
  nand4  g36(.a(new_n22_), .b(new_n27_), .c(new_n36_), .d(new_n41_), .O(new_n58_));
