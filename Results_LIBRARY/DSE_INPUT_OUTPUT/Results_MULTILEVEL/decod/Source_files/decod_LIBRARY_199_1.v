...
module FAU ( 
  ...
  oai21  g21(.a(new_n42_), .b(new_n38_), .c(new_n40_), .O(z07));
  inv1   g22(.a(new_n40_), .O(z08));
  nand3  g23(.a(x4), .b(x3), .c(x2), .O(new_n47_));
  aoi21  g24(.a(new_n47_), .b(new_n25_), .c(x0), .O(z12));
  nand4  g25(.a(new_n26_), .b(x2), .c(new_n25_), .d(new_n39_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n22_), .O(z13));
  aoi21  g27(.a(new_n30_), .b(new_n25_), .c(x0), .O(z14));
  aoi21  g28(.a(new_n42_), .b(new_n25_), .c(x0), .O(z15));
  zero   g29(.O(z09));
  zero   g30(.O(z10));
