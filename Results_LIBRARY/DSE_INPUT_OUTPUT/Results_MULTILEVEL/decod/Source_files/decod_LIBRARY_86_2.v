...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n36_, new_n37_, new_n40_, new_n42_, new_n43_, new_n46_,
  ...
  oai21  g20(.a(new_n42_), .b(new_n29_), .c(new_n37_), .O(z10));
  nand3  g21(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n46_));
  oai21  g22(.a(new_n46_), .b(new_n42_), .c(new_n37_), .O(z11));
  aoi21  g23(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand4  g24(.a(new_n31_), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n49_));
  ...
  nand4  g28(.a(new_n31_), .b(new_n28_), .c(new_n36_), .d(new_n22_), .O(new_n53_));
