...
module FAU ( 
  ...
  nand4  g18(.a(x3), .b(new_n33_), .c(x1), .d(new_n25_), .O(new_n41_));
  ...
  oai21  g26(.a(new_n45_), .b(new_n34_), .c(new_n22_), .O(z14));
  nand4  g27(.a(new_n30_), .b(new_n33_), .c(new_n26_), .d(new_n25_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n29_), .O(z15));
  zero   g29(.O(z02));
