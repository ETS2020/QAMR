...
module FAU ( 
  ...
  nand4  g22(.a(x3), .b(x2), .c(x1), .d(new_n31_), .O(new_n44_));
  ...
  nand4  g26(.a(x3), .b(new_n27_), .c(x1), .d(new_n31_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n23_), .O(z10));
  nand4  g28(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n31_), .O(new_n50_));
