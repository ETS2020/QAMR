...
module FAU ( 
  ...
  nor2   g26(.a(new_n51_), .b(new_n37_), .O(z13));
  nand4  g27(.a(x3), .b(new_n30_), .c(new_n22_), .d(new_n42_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(new_n37_), .O(z14));
  nand4  g29(.a(new_n25_), .b(new_n30_), .c(new_n22_), .d(new_n42_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(new_n37_), .O(z15));
  zero   g31(.O(z02));
  zero   g32(.O(z03));
  zero   g33(.O(z10));
  zero   g34(.O(z11));
