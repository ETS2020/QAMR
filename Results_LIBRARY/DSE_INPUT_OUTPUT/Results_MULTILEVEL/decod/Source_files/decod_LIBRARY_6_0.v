...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n32_, new_n33_, new_n35_, new_n39_, new_n41_, new_n45_,
    new_n47_;
  ...
  nand4  g17(.a(x3), .b(new_n32_), .c(new_n23_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n31_), .O(z06));
  nand4  g19(.a(new_n28_), .b(new_n32_), .c(new_n23_), .d(x0), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n31_), .O(z07));
  aoi21  g21(.a(new_n26_), .b(x1), .c(x0), .O(z08));
  aoi21  g22(.a(new_n29_), .b(x1), .c(x0), .O(z09));
  nand3  g23(.a(x4), .b(x3), .c(new_n32_), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(x1), .c(x0), .O(z10));
  nand4  g25(.a(new_n28_), .b(new_n32_), .c(x1), .d(new_n22_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n31_), .O(z11));
