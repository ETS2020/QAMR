...
module FAU ( 
  ...
  oai21  g34(.a(new_n54_), .b(new_n29_), .c(new_n27_), .O(z13));
  nand4  g35(.a(x3), .b(new_n26_), .c(new_n35_), .d(new_n44_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n22_), .O(z14));
  nand3  g37(.a(new_n28_), .b(new_n35_), .c(new_n44_), .O(new_n59_));
