...
module FAU ( 
  ...
  nor2   g22(.a(new_n44_), .b(new_n30_), .O(z09));
  nand3  g23(.a(x4), .b(x3), .c(new_n31_), .O(new_n46_));
  oai21  g24(.a(new_n46_), .b(new_n42_), .c(new_n24_), .O(z10));
  ...
  nand3  g29(.a(x4), .b(new_n31_), .c(new_n41_), .O(new_n53_));
