...
module FAU ( 
  ...
  nand3  g20(.a(x4), .b(x3), .c(new_n43_), .O(new_n44_));
  aoi21  g21(.a(new_n44_), .b(new_n26_), .c(new_n32_), .O(z10));
  nand4  g22(.a(new_n29_), .b(new_n26_), .c(x1), .d(new_n43_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n25_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n32_), .d(new_n43_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n25_), .O(z12));
  nand3  g26(.a(x4), .b(new_n29_), .c(new_n43_), .O(new_n50_));
  aoi21  g27(.a(new_n50_), .b(new_n32_), .c(new_n26_), .O(z13));
  nand2  g28(.a(new_n32_), .b(new_n43_), .O(new_n52_));
  oai21  g29(.a(new_n52_), .b(new_n38_), .c(new_n22_), .O(z14));
  nand4  g30(.a(new_n29_), .b(new_n26_), .c(new_n32_), .d(new_n43_), .O(new_n54_));
