...
module FAU ( 
  ...
  nand4  g22(.a(new_n29_), .b(new_n28_), .c(x1), .d(new_n43_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n24_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n32_), .d(new_n43_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n24_), .O(z12));
  nand4  g26(.a(new_n29_), .b(x2), .c(new_n32_), .d(new_n43_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n24_), .O(z13));
  nand3  g28(.a(x4), .b(new_n28_), .c(new_n43_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n32_), .c(new_n29_), .O(z14));
  nand4  g30(.a(new_n29_), .b(new_n28_), .c(new_n32_), .d(new_n43_), .O(new_n55_));
  nor2   g31(.a(new_n55_), .b(new_n24_), .O(z15));
  zero   g32(.O(z02));
  zero   g33(.O(z08));
  zero   g34(.O(z10));
endmodule
