...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n35_, new_n37_, new_n39_, new_n45_, new_n47_, new_n50_,
    new_n51_;
  ...
  nand3  g20(.a(x4), .b(x3), .c(x2), .O(new_n45_));
  aoi21  g21(.a(new_n45_), .b(new_n27_), .c(x0), .O(z12));
  nand3  g22(.a(x4), .b(new_n22_), .c(x2), .O(new_n47_));
  aoi21  g23(.a(new_n47_), .b(new_n27_), .c(x0), .O(z13));
  aoi21  g24(.a(new_n29_), .b(new_n27_), .c(x0), .O(z14));
  inv1   g25(.a(x0), .O(new_n50_));
  nand4  g26(.a(new_n22_), .b(new_n28_), .c(new_n27_), .d(new_n50_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n23_), .O(z15));
  zero   g28(.O(z08));
  zero   g29(.O(z10));
  zero   g30(.O(z11));
endmodule
