...
module FAU ( 
  ...
  nand4  g10(.a(new_n23_), .b(new_n28_), .c(new_n32_), .d(x0), .O(new_n36_));
  ...
  nand4  g18(.a(new_n23_), .b(x2), .c(new_n32_), .d(new_n39_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n24_), .O(z13));
  nand4  g20(.a(new_n23_), .b(new_n28_), .c(new_n32_), .d(new_n39_), .O(new_n46_));
