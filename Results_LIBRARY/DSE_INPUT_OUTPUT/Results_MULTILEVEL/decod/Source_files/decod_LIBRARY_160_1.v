...
module FAU ( 
  ...
  nand4  g10(.a(x3), .b(new_n26_), .c(new_n30_), .d(x0), .O(new_n33_));
  ...
  nand3  g15(.a(new_n26_), .b(x1), .c(new_n36_), .O(new_n40_));
  aoi21  g16(.a(new_n40_), .b(x3), .c(new_n22_), .O(z10));
  nand3  g17(.a(x2), .b(new_n30_), .c(new_n36_), .O(new_n42_));
  ...
  zero   g24(.O(z13));
  zero   g25(.O(z15));
  nor2   g26(.a(new_n22_), .b(x3), .O(z05));
