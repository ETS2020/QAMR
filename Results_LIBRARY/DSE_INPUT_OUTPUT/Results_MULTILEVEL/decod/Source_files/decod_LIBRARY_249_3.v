...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n28_, new_n29_, new_n32_, new_n33_,
    new_n35_, new_n38_, new_n39_, new_n42_, new_n45_, new_n47_;
  inv1   g00(.a(x3), .O(new_n22_));
  inv1   g01(.a(x4), .O(new_n23_));
  nor2   g02(.a(new_n23_), .b(new_n22_), .O(z00));
  nand3  g03(.a(x2), .b(x1), .c(x0), .O(new_n25_));
  nor3   g04(.a(new_n25_), .b(new_n23_), .c(x3), .O(z01));
  ...
  aoi21  g10(.a(new_n33_), .b(new_n22_), .c(new_n23_), .O(z05));
  nand4  g11(.a(new_n22_), .b(new_n28_), .c(new_n32_), .d(x0), .O(new_n35_));
  nor2   g12(.a(new_n35_), .b(new_n23_), .O(z07));
  inv1   g13(.a(x0), .O(new_n38_));
  nand4  g14(.a(new_n22_), .b(x2), .c(x1), .d(new_n38_), .O(new_n39_));
  nor2   g15(.a(new_n39_), .b(new_n23_), .O(z09));
  nand3  g16(.a(new_n28_), .b(x1), .c(new_n38_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(new_n22_), .c(new_n23_), .O(z11));
  nand4  g18(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n38_), .O(new_n45_));
  nor2   g19(.a(new_n45_), .b(new_n23_), .O(z13));
  nand4  g20(.a(new_n22_), .b(new_n28_), .c(new_n32_), .d(new_n38_), .O(new_n47_));
  ...
  nor2   g28(.a(new_n23_), .b(new_n22_), .O(z14));
endmodule
