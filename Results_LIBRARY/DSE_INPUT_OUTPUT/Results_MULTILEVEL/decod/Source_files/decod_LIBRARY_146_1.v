...
module FAU ( 
  ...
  aoi21  g28(.a(new_n51_), .b(new_n25_), .c(x0), .O(z14));
  nand3  g29(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n53_));
  aoi21  g30(.a(new_n53_), .b(new_n25_), .c(x0), .O(z15));
  zero   g31(.O(z08));
  zero   g32(.O(z10));
  inv1   g33(.a(new_n38_), .O(z11));
endmodule
