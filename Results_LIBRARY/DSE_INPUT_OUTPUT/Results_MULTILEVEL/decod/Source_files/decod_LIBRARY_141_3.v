...
module FAU ( 
  ...
  nand4  g11(.a(new_n25_), .b(x2), .c(new_n24_), .d(x0), .O(new_n34_));
  nor2   g12(.a(new_n34_), .b(new_n29_), .O(z05));
  nand3  g13(.a(x4), .b(new_n30_), .c(x0), .O(new_n36_));
  aoi21  g14(.a(new_n36_), .b(new_n24_), .c(new_n25_), .O(z06));
  nand4  g15(.a(new_n25_), .b(new_n30_), .c(new_n24_), .d(x0), .O(new_n38_));
  nor2   g16(.a(new_n38_), .b(new_n29_), .O(z07));
  inv1   g17(.a(x0), .O(new_n40_));
  nand4  g18(.a(new_n25_), .b(x2), .c(x1), .d(new_n40_), .O(new_n41_));
  nor2   g19(.a(new_n41_), .b(new_n29_), .O(z09));
  nand4  g20(.a(new_n25_), .b(new_n30_), .c(x1), .d(new_n40_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n29_), .O(z11));
  nand3  g22(.a(x4), .b(x2), .c(new_n40_), .O(new_n45_));
  aoi21  g23(.a(new_n45_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand4  g24(.a(new_n25_), .b(x2), .c(new_n24_), .d(new_n40_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n29_), .O(z13));
  nand4  g26(.a(x3), .b(new_n30_), .c(new_n24_), .d(new_n40_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n29_), .O(z14));
  nand2  g28(.a(new_n24_), .b(new_n40_), .O(new_n51_));
  nand3  g29(.a(x4), .b(new_n25_), .c(new_n30_), .O(new_n52_));
