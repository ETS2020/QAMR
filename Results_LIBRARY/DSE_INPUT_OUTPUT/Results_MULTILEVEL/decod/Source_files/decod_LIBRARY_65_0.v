...
module FAU ( 
  ...
  nand4  g20(.a(x3), .b(new_n31_), .c(new_n36_), .d(x0), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n22_), .O(z06));
  nand4  g22(.a(new_n28_), .b(new_n31_), .c(new_n36_), .d(x0), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n22_), .O(z07));
  ...
  nand4  g28(.a(x3), .b(new_n31_), .c(x1), .d(new_n26_), .O(new_n50_));
  ...
  nand4  g34(.a(new_n28_), .b(x2), .c(new_n36_), .d(new_n26_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n22_), .O(z13));
  nand3  g36(.a(x3), .b(new_n31_), .c(new_n36_), .O(new_n58_));
  aoi21  g37(.a(new_n58_), .b(x4), .c(x0), .O(z14));
