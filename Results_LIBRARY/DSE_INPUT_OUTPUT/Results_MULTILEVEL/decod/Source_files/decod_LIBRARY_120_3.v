...
module FAU ( 
  ...
  aoi21  g18(.a(new_n40_), .b(new_n32_), .c(new_n26_), .O(z09));
  aoi21  g19(.a(new_n34_), .b(new_n32_), .c(new_n26_), .O(z10));
  nand4  g20(.a(new_n29_), .b(new_n33_), .c(x1), .d(new_n32_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n25_), .O(z11));
  nand2  g22(.a(new_n26_), .b(new_n32_), .O(new_n45_));
  oai21  g23(.a(new_n45_), .b(new_n38_), .c(new_n23_), .O(z12));
  nand4  g24(.a(new_n29_), .b(x2), .c(new_n26_), .d(new_n32_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n25_), .O(z13));
  nand4  g26(.a(x3), .b(new_n33_), .c(new_n26_), .d(new_n32_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n25_), .O(z14));
  oai21  g28(.a(new_n45_), .b(new_n36_), .c(new_n23_), .O(z15));
  zero   g29(.O(z00));
