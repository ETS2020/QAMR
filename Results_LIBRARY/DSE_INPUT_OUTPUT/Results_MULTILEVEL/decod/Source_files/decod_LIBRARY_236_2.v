...
module FAU ( 
  ...
  nand3  g15(.a(new_n26_), .b(x2), .c(new_n34_), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(x4), .c(new_n25_), .O(z05));
  ...
  nand2  g31(.a(new_n34_), .b(new_n25_), .O(new_n53_));
  ...
  oai21  g36(.a(new_n53_), .b(new_n51_), .c(new_n43_), .O(z15));
endmodule
