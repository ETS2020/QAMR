...
module FAU ( 
  ...
  wire new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_, new_n32_,
    new_n35_, new_n37_, new_n38_, new_n39_, new_n43_, new_n44_, new_n46_,
  ...
  nand4  g08(.a(x3), .b(x2), .c(new_n28_), .d(x0), .O(new_n32_));
  nor2   g09(.a(new_n32_), .b(new_n24_), .O(z04));
  aoi21  g10(.a(new_n30_), .b(new_n28_), .c(new_n25_), .O(z05));
  nand4  g11(.a(x3), .b(new_n25_), .c(new_n28_), .d(x0), .O(new_n35_));
  nor2   g12(.a(new_n35_), .b(new_n24_), .O(z06));
  nand2  g13(.a(new_n28_), .b(x0), .O(new_n37_));
  nand2  g14(.a(x2), .b(x1), .O(new_n38_));
  ...
  nand4  g19(.a(x3), .b(new_n25_), .c(x1), .d(new_n43_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n24_), .O(z10));
  nand3  g21(.a(x4), .b(new_n29_), .c(new_n43_), .O(new_n46_));
  aoi21  g22(.a(new_n46_), .b(new_n25_), .c(new_n28_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n28_), .d(new_n43_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n24_), .O(z12));
  nand4  g25(.a(new_n29_), .b(x2), .c(new_n28_), .d(new_n43_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n24_), .O(z13));
  nand4  g27(.a(x3), .b(new_n25_), .c(new_n28_), .d(new_n43_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n24_), .O(z14));
  nand2  g29(.a(new_n28_), .b(new_n43_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n39_), .c(new_n38_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z01));
  zero   g33(.O(z09));
endmodule
