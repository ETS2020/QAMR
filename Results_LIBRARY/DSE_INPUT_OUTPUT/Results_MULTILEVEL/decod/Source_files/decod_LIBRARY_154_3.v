...
module FAU ( 
  ...
  wire new_n22_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_,
    new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n45_, new_n47_,
    new_n50_;
  ...
  aoi21  g14(.a(new_n37_), .b(new_n27_), .c(new_n33_), .O(z07));
  nand3  g15(.a(x4), .b(x3), .c(x2), .O(new_n39_));
  aoi21  g16(.a(new_n39_), .b(new_n33_), .c(new_n27_), .O(z08));
  nand4  g17(.a(new_n30_), .b(x2), .c(x1), .d(new_n33_), .O(new_n41_));
  nor2   g18(.a(new_n41_), .b(new_n26_), .O(z09));
  aoi21  g19(.a(new_n35_), .b(new_n33_), .c(new_n27_), .O(z10));
  aoi21  g20(.a(new_n37_), .b(new_n33_), .c(new_n27_), .O(z11));
  nand2  g21(.a(new_n27_), .b(new_n33_), .O(new_n45_));
  oai21  g22(.a(new_n45_), .b(new_n39_), .c(new_n22_), .O(z12));
  nand3  g23(.a(x4), .b(new_n30_), .c(x2), .O(new_n47_));
  oai21  g24(.a(new_n47_), .b(new_n45_), .c(new_n22_), .O(z13));
  oai21  g25(.a(new_n45_), .b(new_n35_), .c(new_n22_), .O(z14));
  nand4  g26(.a(new_n30_), .b(new_n34_), .c(new_n27_), .d(new_n33_), .O(new_n50_));
