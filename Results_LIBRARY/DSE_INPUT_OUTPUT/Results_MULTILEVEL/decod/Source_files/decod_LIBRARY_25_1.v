...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_, new_n33_, new_n36_, new_n40_, new_n41_, new_n43_, new_n44_,
    new_n46_, new_n50_, new_n52_;
  ...
  inv1   g15(.a(new_n32_), .O(z06));
  aoi21  g16(.a(new_n28_), .b(new_n22_), .c(x1), .O(z07));
  ...
  oai21  g22(.a(new_n44_), .b(new_n43_), .c(new_n32_), .O(z09));
  nand4  g23(.a(x3), .b(new_n27_), .c(x1), .d(new_n40_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n23_), .O(z10));
  oai21  g25(.a(new_n43_), .b(new_n33_), .c(new_n32_), .O(z11));
  nand4  g26(.a(new_n22_), .b(x2), .c(new_n31_), .d(new_n40_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z13));
  nand3  g28(.a(x4), .b(new_n27_), .c(new_n40_), .O(new_n52_));
  aoi21  g29(.a(new_n52_), .b(new_n22_), .c(x1), .O(z15));
  zero   g30(.O(z04));
  zero   g31(.O(z12));
  inv1   g32(.a(new_n32_), .O(z14));
endmodule
