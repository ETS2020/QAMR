...
module FAU ( 
  ...
  aoi21  g23(.a(new_n44_), .b(x4), .c(new_n33_), .O(z08));
  ...
  aoi21  g27(.a(new_n48_), .b(x4), .c(new_n33_), .O(z10));
  ...
  nand2  g36(.a(new_n33_), .b(new_n43_), .O(new_n58_));
  nand3  g37(.a(x4), .b(new_n22_), .c(new_n27_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n58_), .c(new_n32_), .O(z15));
endmodule
