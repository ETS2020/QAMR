...
module FAU ( 
  ...
  nand3  g15(.a(x3), .b(new_n27_), .c(x0), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(x4), .c(x1), .O(z06));
  ...
  nand2  g23(.a(new_n23_), .b(new_n32_), .O(new_n45_));
  ...
  nand3  g36(.a(new_n22_), .b(new_n27_), .c(new_n41_), .O(new_n58_));
