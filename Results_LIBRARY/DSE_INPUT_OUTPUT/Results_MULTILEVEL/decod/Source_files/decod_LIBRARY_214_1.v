...
module FAU ( 
  ...
  inv1   g23(.a(new_n38_), .O(z10));
  nand4  g24(.a(x3), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n25_), .O(z12));
  aoi21  g26(.a(new_n39_), .b(new_n22_), .c(x0), .O(z13));
  nand3  g27(.a(x4), .b(x3), .c(new_n28_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n22_), .c(x0), .O(z14));
