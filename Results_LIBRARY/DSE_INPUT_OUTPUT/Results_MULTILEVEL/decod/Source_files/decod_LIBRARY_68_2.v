...
module FAU ( 
  ...
  nand4  g16(.a(new_n26_), .b(new_n22_), .c(new_n33_), .d(x0), .O(new_n39_));
  ...
  oai21  g22(.a(new_n44_), .b(new_n29_), .c(new_n27_), .O(z10));
  nand4  g23(.a(new_n26_), .b(new_n22_), .c(x1), .d(new_n41_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n32_), .O(z11));
  nand3  g25(.a(x4), .b(new_n33_), .c(new_n41_), .O(new_n48_));
  aoi21  g26(.a(new_n48_), .b(x3), .c(new_n22_), .O(z12));
  nand4  g27(.a(x3), .b(new_n22_), .c(new_n33_), .d(new_n41_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n32_), .O(z14));
  nand4  g29(.a(new_n26_), .b(new_n22_), .c(new_n33_), .d(new_n41_), .O(new_n52_));
