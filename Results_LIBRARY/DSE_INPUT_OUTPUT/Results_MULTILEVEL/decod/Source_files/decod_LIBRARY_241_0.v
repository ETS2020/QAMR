...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    ...
    new_n44_, new_n45_, new_n46_, new_n49_, new_n51_, new_n53_, new_n55_,
    new_n57_, new_n59_;
  ...
  nand4  g20(.a(new_n28_), .b(new_n31_), .c(new_n26_), .d(x0), .O(new_n42_));
  ...
  nand4  g31(.a(x3), .b(x2), .c(new_n26_), .d(new_n44_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n22_), .O(z12));
  nand3  g33(.a(new_n28_), .b(x2), .c(new_n44_), .O(new_n55_));
  aoi21  g34(.a(new_n55_), .b(x4), .c(x1), .O(z13));
  nand4  g35(.a(x3), .b(new_n31_), .c(new_n26_), .d(new_n44_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n22_), .O(z14));
  nand4  g37(.a(new_n28_), .b(new_n31_), .c(new_n26_), .d(new_n44_), .O(new_n59_));
