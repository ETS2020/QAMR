...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n35_, new_n37_, new_n39_, new_n40_, new_n41_, new_n46_,
    new_n48_, new_n50_;
  ...
  nand4  g11(.a(x3), .b(x2), .c(new_n30_), .d(x0), .O(new_n33_));
  nor2   g12(.a(new_n33_), .b(new_n23_), .O(z04));
  nand4  g13(.a(new_n22_), .b(x2), .c(new_n30_), .d(x0), .O(new_n35_));
  nor2   g14(.a(new_n35_), .b(new_n23_), .O(z05));
  nand4  g15(.a(x3), .b(new_n27_), .c(new_n30_), .d(x0), .O(new_n37_));
  nor2   g16(.a(new_n37_), .b(new_n23_), .O(z06));
  nand2  g17(.a(new_n30_), .b(x0), .O(new_n39_));
  inv1   g18(.a(x0), .O(new_n40_));
  nand2  g19(.a(x1), .b(new_n40_), .O(new_n41_));
  oai21  g20(.a(new_n39_), .b(new_n31_), .c(new_n41_), .O(z07));
  inv1   g21(.a(new_n41_), .O(z09));
  nand3  g22(.a(x4), .b(x3), .c(x2), .O(new_n46_));
  aoi21  g23(.a(new_n46_), .b(new_n30_), .c(x0), .O(z12));
  nand4  g24(.a(new_n22_), .b(x2), .c(new_n30_), .d(new_n40_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n23_), .O(z13));
  nand4  g26(.a(x3), .b(new_n27_), .c(new_n30_), .d(new_n40_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z14));
  aoi21  g28(.a(new_n31_), .b(new_n30_), .c(x0), .O(z15));
  zero   g29(.O(z08));
  zero   g30(.O(z11));
  inv1   g31(.a(new_n41_), .O(z10));
endmodule
