...
module FAU ( 
  ...
  aoi21  g16(.a(new_n40_), .b(new_n37_), .c(new_n28_), .O(z08));
  nand4  g17(.a(new_n31_), .b(x2), .c(x1), .d(new_n37_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n27_), .O(z09));
  nand4  g19(.a(x3), .b(new_n34_), .c(x1), .d(new_n37_), .O(new_n44_));
  ...
  oai21  g24(.a(new_n48_), .b(new_n40_), .c(new_n25_), .O(z12));
  nand4  g25(.a(new_n31_), .b(x2), .c(new_n28_), .d(new_n37_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n27_), .O(z13));
  nand3  g27(.a(x4), .b(x3), .c(new_n34_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n48_), .c(new_n25_), .O(z14));
  oai21  g29(.a(new_n48_), .b(new_n38_), .c(new_n25_), .O(z15));
  zero   g30(.O(z00));
  zero   g31(.O(z01));
  zero   g32(.O(z02));
endmodule
