...
module FAU ( 
  ...
  nand3  g25(.a(new_n28_), .b(x2), .c(x1), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x4), .c(x0), .O(z09));
  nand3  g27(.a(x3), .b(new_n31_), .c(x1), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(x4), .c(x0), .O(z10));
  nand3  g29(.a(new_n28_), .b(new_n31_), .c(x1), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(x4), .c(x0), .O(z11));
  nand3  g31(.a(x3), .b(x2), .c(new_n36_), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(x4), .c(x0), .O(z12));
  nand4  g33(.a(new_n28_), .b(x2), .c(new_n36_), .d(new_n26_), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n22_), .O(z13));
  nand3  g35(.a(x3), .b(new_n31_), .c(new_n36_), .O(new_n57_));
  aoi21  g36(.a(new_n57_), .b(x4), .c(x0), .O(z14));
  nand3  g37(.a(new_n28_), .b(new_n31_), .c(new_n36_), .O(new_n59_));
