...
module FAU ( 
  ...
  oai21  g19(.a(new_n40_), .b(new_n35_), .c(new_n37_), .O(z06));
  nand4  g20(.a(new_n22_), .b(new_n27_), .c(new_n30_), .d(x0), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n23_), .O(z07));
  inv1   g22(.a(new_n37_), .O(z08));
  nand4  g23(.a(x3), .b(x2), .c(new_n30_), .d(new_n36_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n23_), .O(z12));
  aoi21  g25(.a(new_n38_), .b(new_n30_), .c(x0), .O(z13));
  aoi21  g26(.a(new_n40_), .b(new_n30_), .c(x0), .O(z14));
  nand4  g27(.a(new_n22_), .b(new_n27_), .c(new_n30_), .d(new_n36_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n23_), .O(z15));
  zero   g29(.O(z09));
  inv1   g30(.a(new_n37_), .O(z10));
  inv1   g31(.a(new_n37_), .O(z11));
endmodule
