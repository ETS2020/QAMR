...
module FAU ( 
  ...
  nand4  g17(.a(x3), .b(new_n30_), .c(new_n22_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n35_), .O(z06));
  ...
  nor2   g23(.a(new_n45_), .b(new_n35_), .O(z09));
  ...
  nor2   g29(.a(new_n51_), .b(new_n35_), .O(z12));
