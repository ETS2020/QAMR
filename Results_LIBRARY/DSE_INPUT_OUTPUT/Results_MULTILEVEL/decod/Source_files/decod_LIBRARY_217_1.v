...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n35_, new_n37_, new_n39_, new_n45_, new_n47_, new_n49_,
    new_n50_;
  ...
  aoi21  g20(.a(new_n45_), .b(new_n27_), .c(x0), .O(z12));
  nand3  g21(.a(x4), .b(new_n22_), .c(x2), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n27_), .c(x0), .O(z13));
  inv1   g23(.a(x0), .O(new_n49_));
  nand4  g24(.a(x3), .b(new_n28_), .c(new_n27_), .d(new_n49_), .O(new_n50_));
