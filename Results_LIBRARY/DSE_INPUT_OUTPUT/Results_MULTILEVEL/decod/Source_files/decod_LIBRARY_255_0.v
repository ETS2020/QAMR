...
module FAU ( 
  ...
  nand4  g20(.a(new_n34_), .b(x2), .c(x1), .d(new_n39_), .O(new_n43_));
  ...
  nand4  g24(.a(new_n34_), .b(new_n27_), .c(x1), .d(new_n39_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n22_), .O(z11));
  nand4  g26(.a(x3), .b(x2), .c(new_n33_), .d(new_n39_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n22_), .O(z12));
  nand3  g28(.a(x4), .b(new_n27_), .c(new_n39_), .O(new_n52_));
