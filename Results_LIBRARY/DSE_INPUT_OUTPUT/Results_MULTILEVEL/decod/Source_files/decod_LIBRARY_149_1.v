...
module FAU ( 
  ...
  nand4  g16(.a(new_n22_), .b(new_n27_), .c(new_n31_), .d(x0), .O(new_n38_));
  ...
  nand3  g23(.a(x4), .b(new_n27_), .c(new_n40_), .O(new_n45_));
  ...
  nand4  g27(.a(new_n22_), .b(x2), .c(new_n31_), .d(new_n40_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n23_), .O(z13));
  aoi21  g29(.a(new_n45_), .b(new_n22_), .c(x1), .O(z15));
  zero   g30(.O(z12));
  zero   g31(.O(z14));
  inv1   g32(.a(new_n32_), .O(z06));
endmodule
