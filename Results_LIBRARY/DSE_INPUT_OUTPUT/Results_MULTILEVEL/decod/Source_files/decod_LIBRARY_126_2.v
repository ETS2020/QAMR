...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n40_, new_n42_, new_n45_, new_n48_;
  ...
  oai21  g16(.a(new_n40_), .b(new_n23_), .c(new_n35_), .O(z08));
  nand3  g17(.a(x4), .b(new_n31_), .c(x2), .O(new_n42_));
  oai21  g18(.a(new_n42_), .b(new_n40_), .c(new_n35_), .O(z09));
  oai21  g19(.a(new_n40_), .b(new_n29_), .c(new_n35_), .O(z10));
  nand4  g20(.a(new_n31_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n25_), .O(z11));
  aoi21  g22(.a(new_n23_), .b(new_n22_), .c(x1), .O(z12));
  nand4  g23(.a(new_n31_), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n25_), .O(z13));
