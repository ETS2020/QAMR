...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n35_, new_n37_, new_n39_, new_n40_, new_n41_, new_n47_,
    new_n49_, new_n51_;
  ...
  aoi21  g23(.a(new_n47_), .b(new_n30_), .c(x0), .O(z12));
  nand4  g24(.a(new_n22_), .b(x2), .c(new_n30_), .d(new_n40_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n23_), .O(z13));
  nand3  g26(.a(x4), .b(x3), .c(new_n27_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n30_), .c(x0), .O(z14));
