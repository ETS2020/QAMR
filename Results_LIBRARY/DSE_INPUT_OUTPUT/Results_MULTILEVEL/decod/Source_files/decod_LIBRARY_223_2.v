...
module FAU ( 
  ...
  oai21  g20(.a(new_n44_), .b(new_n29_), .c(new_n37_), .O(z10));
  ...
  nand4  g25(.a(new_n25_), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n39_), .O(z13));
  nand4  g27(.a(x3), .b(new_n28_), .c(new_n36_), .d(new_n22_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n39_), .O(z14));
  nand4  g29(.a(new_n25_), .b(new_n28_), .c(new_n36_), .d(new_n22_), .O(new_n54_));
