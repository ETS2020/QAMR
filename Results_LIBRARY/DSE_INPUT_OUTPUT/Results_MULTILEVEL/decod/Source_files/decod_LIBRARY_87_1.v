...
module FAU ( 
  ...
  oai21  g25(.a(new_n48_), .b(new_n33_), .c(new_n26_), .O(z11));
  nand4  g26(.a(new_n22_), .b(x2), .c(new_n25_), .d(new_n41_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n38_), .O(z13));
