...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n36_, new_n38_, new_n41_, new_n46_,
    new_n49_, new_n51_;
  ...
  inv1   g21(.a(new_n34_), .O(z09));
  nand4  g22(.a(x3), .b(x2), .c(new_n27_), .d(new_n33_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n23_), .O(z12));
  aoi21  g24(.a(new_n38_), .b(new_n27_), .c(x0), .O(z13));
  nand4  g25(.a(x3), .b(new_n28_), .c(new_n27_), .d(new_n33_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n23_), .O(z14));
  nand3  g27(.a(x4), .b(new_n22_), .c(new_n28_), .O(new_n51_));
  aoi21  g28(.a(new_n51_), .b(new_n27_), .c(x0), .O(z15));
  zero   g29(.O(z08));
  zero   g30(.O(z11));
  inv1   g31(.a(new_n34_), .O(z10));
endmodule
