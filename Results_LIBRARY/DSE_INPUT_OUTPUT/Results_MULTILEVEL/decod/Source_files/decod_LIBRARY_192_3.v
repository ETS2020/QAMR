...
module FAU ( 
  ...
  nand4  g17(.a(new_n29_), .b(new_n30_), .c(new_n28_), .d(x0), .O(new_n40_));
  ...
  nand4  g22(.a(new_n29_), .b(new_n30_), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n23_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n28_), .d(new_n42_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n23_), .O(z12));
  nand2  g26(.a(new_n28_), .b(new_n42_), .O(new_n49_));
  oai21  g27(.a(new_n49_), .b(new_n36_), .c(new_n26_), .O(z13));
  nand3  g28(.a(x4), .b(new_n30_), .c(new_n42_), .O(new_n51_));
  aoi21  g29(.a(new_n51_), .b(new_n28_), .c(new_n29_), .O(z14));
  nand3  g30(.a(x4), .b(new_n29_), .c(new_n30_), .O(new_n53_));
  oai21  g31(.a(new_n53_), .b(new_n49_), .c(new_n26_), .O(z15));
  zero   g32(.O(z00));
