...
module FAU ( 
  ...
  nand3  g11(.a(x3), .b(x2), .c(new_n36_), .O(new_n37_));
  aoi21  g12(.a(new_n37_), .b(x1), .c(new_n23_), .O(z08));
  nand3  g13(.a(new_n22_), .b(x2), .c(new_n36_), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(x1), .c(new_n23_), .O(z09));
  nand4  g15(.a(x3), .b(new_n27_), .c(x1), .d(new_n36_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(new_n23_), .O(z10));
  nand3  g17(.a(new_n22_), .b(new_n27_), .c(new_n36_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(x1), .c(new_n23_), .O(z11));
  nor2   g19(.a(new_n23_), .b(x1), .O(z12));
  zero   g20(.O(z04));
  zero   g21(.O(z05));
  zero   g22(.O(z06));
  zero   g23(.O(z07));
