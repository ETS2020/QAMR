...
module FAU ( 
  ...
  nor2   g19(.a(new_n41_), .b(new_n33_), .O(z08));
  nand2  g20(.a(x1), .b(new_n40_), .O(new_n43_));
  oai21  g21(.a(new_n43_), .b(new_n28_), .c(new_n26_), .O(z09));
  nand4  g22(.a(x3), .b(new_n30_), .c(x1), .d(new_n40_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n33_), .O(z10));
  nand4  g24(.a(new_n22_), .b(new_n30_), .c(x1), .d(new_n40_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n33_), .O(z11));
  nand4  g26(.a(new_n22_), .b(x2), .c(new_n25_), .d(new_n40_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n33_), .O(z13));
  nand3  g28(.a(x4), .b(new_n30_), .c(new_n40_), .O(new_n51_));
