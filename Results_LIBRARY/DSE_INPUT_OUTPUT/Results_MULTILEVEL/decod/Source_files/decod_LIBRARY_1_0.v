...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n32_, new_n34_, new_n35_, new_n39_, new_n41_, new_n45_,
    new_n47_;
  ...
  aoi21  g16(.a(new_n29_), .b(x0), .c(x1), .O(z05));
  nand4  g17(.a(x3), .b(new_n31_), .c(new_n23_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n34_), .O(z06));
  ...
  nand4  g23(.a(x3), .b(new_n31_), .c(x1), .d(new_n22_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n34_), .O(z10));
