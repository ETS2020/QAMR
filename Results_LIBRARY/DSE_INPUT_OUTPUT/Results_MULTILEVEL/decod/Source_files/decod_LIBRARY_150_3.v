...
module FAU ( 
  ...
  nand3  g13(.a(x4), .b(new_n28_), .c(x2), .O(new_n35_));
  oai21  g14(.a(new_n35_), .b(new_n34_), .c(new_n22_), .O(z05));
  nand3  g15(.a(x4), .b(new_n27_), .c(x0), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(new_n31_), .c(new_n28_), .O(z06));
  ...
  nand3  g22(.a(x4), .b(new_n27_), .c(new_n42_), .O(new_n45_));
  aoi21  g23(.a(new_n45_), .b(new_n28_), .c(new_n31_), .O(z11));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n31_), .c(new_n28_), .O(z14));
  nand4  g29(.a(new_n28_), .b(new_n27_), .c(new_n31_), .d(new_n42_), .O(new_n52_));
