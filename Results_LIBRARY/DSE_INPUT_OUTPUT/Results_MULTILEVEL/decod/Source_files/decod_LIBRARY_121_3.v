...
module FAU ( 
  ...
  nand4  g21(.a(new_n31_), .b(new_n34_), .c(x1), .d(new_n30_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n26_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n27_), .d(new_n30_), .O(new_n47_));
  ...
  nand2  g27(.a(new_n27_), .b(new_n30_), .O(new_n51_));
