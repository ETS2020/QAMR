...
module FAU ( 
  ...
  inv1   g08(.a(x4), .O(new_n32_));
  nand4  g09(.a(new_n28_), .b(x2), .c(new_n24_), .d(x0), .O(new_n33_));
  ...
  nand3  g21(.a(x4), .b(new_n28_), .c(new_n43_), .O(new_n46_));
  aoi21  g22(.a(new_n46_), .b(new_n25_), .c(new_n24_), .O(z11));
  nand3  g23(.a(x4), .b(x3), .c(new_n43_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand4  g25(.a(new_n28_), .b(x2), .c(new_n24_), .d(new_n43_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n32_), .O(z13));
  nand4  g27(.a(x3), .b(new_n25_), .c(new_n24_), .d(new_n43_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n32_), .O(z14));
  nand4  g29(.a(new_n28_), .b(new_n25_), .c(new_n24_), .d(new_n43_), .O(new_n54_));
