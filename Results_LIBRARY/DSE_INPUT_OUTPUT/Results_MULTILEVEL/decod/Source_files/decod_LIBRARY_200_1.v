...
module FAU ( 
  ...
  nand4  g16(.a(x3), .b(x2), .c(new_n29_), .d(new_n35_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n23_), .O(z12));
  nand4  g18(.a(new_n22_), .b(x2), .c(new_n29_), .d(new_n35_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n23_), .O(z13));
  zero   g20(.O(z02));
  zero   g21(.O(z07));
  zero   g22(.O(z10));
  zero   g23(.O(z15));
  nor2   g24(.a(new_n23_), .b(x2), .O(z06));
