...
module FAU ( 
  ...
  nand4  g14(.a(x3), .b(x2), .c(x1), .d(new_n27_), .O(new_n39_));
  nor2   g15(.a(new_n39_), .b(new_n23_), .O(z08));
  nand4  g16(.a(new_n22_), .b(x2), .c(x1), .d(new_n27_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n23_), .O(z09));
  nand2  g18(.a(x1), .b(new_n27_), .O(new_n43_));
  oai21  g19(.a(new_n43_), .b(new_n29_), .c(new_n37_), .O(z10));
  nand4  g20(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n27_), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n23_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n36_), .d(new_n27_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n23_), .O(z12));
  nand3  g24(.a(x4), .b(new_n22_), .c(x2), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n27_), .c(x1), .O(z13));
  aoi21  g26(.a(new_n29_), .b(new_n27_), .c(x1), .O(z14));
  nand3  g27(.a(x4), .b(new_n22_), .c(new_n28_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n27_), .c(x1), .O(z15));
  zero   g29(.O(z04));
  zero   g30(.O(z05));
  zero   g31(.O(z06));
endmodule
