...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n36_, new_n40_;
  ...
  oai21  g17(.a(new_n36_), .b(new_n29_), .c(new_n35_), .O(z06));
  nand3  g18(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n40_));
  oai21  g19(.a(new_n40_), .b(new_n36_), .c(new_n35_), .O(z07));
  inv1   g20(.a(new_n35_), .O(z08));
  aoi21  g21(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  aoi21  g22(.a(new_n26_), .b(new_n22_), .c(x0), .O(z13));
  aoi21  g23(.a(new_n29_), .b(new_n22_), .c(x0), .O(z14));
  aoi21  g24(.a(new_n40_), .b(new_n22_), .c(x0), .O(z15));
  zero   g25(.O(z09));
  zero   g26(.O(z11));
  inv1   g27(.a(new_n35_), .O(z10));
endmodule
