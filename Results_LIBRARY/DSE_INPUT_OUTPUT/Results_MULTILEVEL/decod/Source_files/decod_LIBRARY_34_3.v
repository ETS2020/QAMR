...
module FAU ( 
  ...
  nand3  g12(.a(x4), .b(new_n24_), .c(x2), .O(new_n36_));
  oai21  g13(.a(new_n36_), .b(new_n34_), .c(new_n35_), .O(z05));
  aoi21  g14(.a(new_n29_), .b(new_n23_), .c(new_n24_), .O(z06));
  nand3  g15(.a(x4), .b(new_n24_), .c(new_n28_), .O(new_n39_));
  oai21  g16(.a(new_n39_), .b(new_n34_), .c(new_n35_), .O(z07));
  inv1   g17(.a(x0), .O(new_n42_));
  nand4  g18(.a(new_n24_), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n31_), .O(z09));
  inv1   g20(.a(new_n35_), .O(z10));
  nand3  g21(.a(x4), .b(new_n28_), .c(new_n42_), .O(new_n46_));
  aoi21  g22(.a(new_n46_), .b(new_n24_), .c(new_n23_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n23_), .d(new_n42_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n31_), .O(z12));
  nand4  g25(.a(new_n24_), .b(x2), .c(new_n23_), .d(new_n42_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n31_), .O(z13));
  nand4  g27(.a(x3), .b(new_n28_), .c(new_n23_), .d(new_n42_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n31_), .O(z14));
  nand2  g29(.a(new_n23_), .b(new_n42_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n39_), .c(new_n35_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z02));
  zero   g33(.O(z08));
endmodule
