...
module FAU ( 
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n32_), .O(z12));
  nand4  g25(.a(new_n29_), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n32_), .O(z13));
  nand4  g27(.a(x3), .b(new_n33_), .c(new_n26_), .d(new_n25_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n32_), .O(z14));
  nand2  g29(.a(new_n26_), .b(new_n25_), .O(new_n52_));
  oai21  g30(.a(new_n52_), .b(new_n36_), .c(new_n22_), .O(z15));
  zero   g31(.O(z01));
