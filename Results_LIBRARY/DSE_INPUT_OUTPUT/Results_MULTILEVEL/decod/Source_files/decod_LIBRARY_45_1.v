...
module FAU ( 
  ...
  nand4  g21(.a(new_n28_), .b(x2), .c(x1), .d(new_n40_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n22_), .O(z09));
  nand4  g23(.a(x3), .b(new_n31_), .c(x1), .d(new_n40_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n22_), .O(z10));
  nand2  g25(.a(x1), .b(new_n40_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n34_), .c(new_n27_), .O(z11));
  nand4  g27(.a(new_n28_), .b(x2), .c(new_n26_), .d(new_n40_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n22_), .O(z13));
  nand3  g29(.a(x4), .b(new_n31_), .c(new_n40_), .O(new_n52_));
  aoi21  g30(.a(new_n52_), .b(new_n28_), .c(x1), .O(z15));
  zero   g31(.O(z12));
