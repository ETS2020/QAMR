...
module FAU ( 
  ...
  wire new_n22_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n35_, new_n38_, new_n39_, new_n42_, new_n44_;
  ...
  aoi21  g13(.a(new_n35_), .b(new_n26_), .c(new_n25_), .O(z07));
  ...
  nor2   g17(.a(new_n39_), .b(new_n38_), .O(z09));
  aoi21  g18(.a(new_n33_), .b(new_n25_), .c(new_n26_), .O(z10));
  nand4  g19(.a(new_n29_), .b(new_n32_), .c(x1), .d(new_n25_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n38_), .O(z11));
  nand2  g21(.a(new_n26_), .b(new_n25_), .O(new_n44_));
  oai21  g22(.a(new_n44_), .b(new_n27_), .c(new_n22_), .O(z12));
  oai21  g23(.a(new_n44_), .b(new_n30_), .c(new_n22_), .O(z13));
  oai21  g24(.a(new_n44_), .b(new_n33_), .c(new_n22_), .O(z14));
  oai21  g25(.a(new_n44_), .b(new_n35_), .c(new_n22_), .O(z15));
  zero   g26(.O(z03));
