...
module FAU ( 
  ...
  nand3  g20(.a(x4), .b(new_n25_), .c(new_n22_), .O(new_n42_));
  oai21  g21(.a(new_n42_), .b(new_n40_), .c(new_n29_), .O(z07));
  ...
  oai21  g30(.a(new_n51_), .b(new_n42_), .c(new_n29_), .O(z11));
  nand3  g31(.a(x3), .b(new_n35_), .c(new_n44_), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(x4), .c(new_n22_), .O(z12));
  nand3  g33(.a(new_n25_), .b(new_n35_), .c(new_n44_), .O(new_n55_));
  ...
  oai21  g37(.a(new_n57_), .b(new_n42_), .c(new_n29_), .O(z15));
endmodule
