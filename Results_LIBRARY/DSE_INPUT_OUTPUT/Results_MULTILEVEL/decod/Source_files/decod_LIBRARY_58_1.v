...
module FAU ( 
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n22_), .d(new_n33_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n37_), .O(z12));
  nand4  g25(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n33_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n37_), .O(z13));
  aoi21  g27(.a(new_n29_), .b(new_n22_), .c(x0), .O(z14));
  aoi21  g28(.a(new_n31_), .b(new_n22_), .c(x0), .O(z15));
  zero   g29(.O(z08));
  zero   g30(.O(z09));
  inv1   g31(.a(new_n34_), .O(z11));
endmodule
