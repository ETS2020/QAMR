...
module FAU ( 
  ...
  nand3  g20(.a(new_n27_), .b(new_n33_), .c(x0), .O(new_n42_));
  ...
  nand2  g31(.a(new_n33_), .b(new_n44_), .O(new_n53_));
  nand3  g32(.a(x4), .b(x3), .c(x2), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n53_), .c(new_n39_), .O(z12));
  nand3  g34(.a(x2), .b(new_n33_), .c(new_n44_), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(x4), .c(x3), .O(z13));
  nand4  g36(.a(x3), .b(new_n27_), .c(new_n33_), .d(new_n44_), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n22_), .O(z14));
  nand4  g38(.a(new_n30_), .b(new_n27_), .c(new_n33_), .d(new_n44_), .O(new_n60_));
