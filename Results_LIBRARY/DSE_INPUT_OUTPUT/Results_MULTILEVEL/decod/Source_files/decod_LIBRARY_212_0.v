...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n30_,
    new_n31_, new_n33_, new_n39_, new_n40_, new_n42_, new_n43_, new_n45_,
    new_n47_, new_n49_;
  ...
  nand4  g20(.a(new_n23_), .b(x2), .c(x1), .d(new_n39_), .O(new_n43_));
  nor2   g21(.a(new_n43_), .b(new_n42_), .O(z09));
  nand4  g22(.a(x3), .b(new_n30_), .c(x1), .d(new_n39_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n42_), .O(z10));
  nand3  g24(.a(x4), .b(new_n30_), .c(new_n39_), .O(new_n47_));
  aoi21  g25(.a(new_n47_), .b(x1), .c(x3), .O(z11));
  nand3  g26(.a(x4), .b(x2), .c(new_n39_), .O(new_n49_));
  aoi21  g27(.a(new_n49_), .b(x3), .c(x1), .O(z12));
  aoi21  g28(.a(new_n47_), .b(x3), .c(x1), .O(z14));
  zero   g29(.O(z05));
  zero   g30(.O(z15));
