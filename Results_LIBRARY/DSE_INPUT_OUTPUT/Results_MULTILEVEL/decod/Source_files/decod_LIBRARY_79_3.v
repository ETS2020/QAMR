...
module FAU ( 
  ...
  wire new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n36_, new_n37_, new_n39_, new_n42_, new_n43_, new_n45_,
  ...
  nand2  g13(.a(new_n29_), .b(x0), .O(new_n36_));
  nand3  g14(.a(x4), .b(x3), .c(new_n26_), .O(new_n37_));
  oai21  g15(.a(new_n37_), .b(new_n36_), .c(new_n23_), .O(z06));
  nand3  g16(.a(x4), .b(new_n30_), .c(new_n26_), .O(new_n39_));
  oai21  g17(.a(new_n39_), .b(new_n36_), .c(new_n23_), .O(z07));
  inv1   g18(.a(x0), .O(new_n42_));
  nand3  g19(.a(x4), .b(x3), .c(new_n42_), .O(new_n43_));
  aoi21  g20(.a(new_n43_), .b(new_n26_), .c(new_n29_), .O(z10));
  nand4  g21(.a(new_n30_), .b(new_n26_), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n25_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n29_), .d(new_n42_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n25_), .O(z12));
  nand4  g25(.a(new_n30_), .b(x2), .c(new_n29_), .d(new_n42_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n25_), .O(z13));
  nand4  g27(.a(x3), .b(new_n26_), .c(new_n29_), .d(new_n42_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n25_), .O(z14));
  nand2  g29(.a(new_n29_), .b(new_n42_), .O(new_n53_));
  oai21  g30(.a(new_n53_), .b(new_n39_), .c(new_n23_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z09));
  inv1   g33(.a(new_n23_), .O(z08));
endmodule
