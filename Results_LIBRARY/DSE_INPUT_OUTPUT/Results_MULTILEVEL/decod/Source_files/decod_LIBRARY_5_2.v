...
module FAU ( 
  ...
  nand4  g33(.a(new_n26_), .b(x2), .c(new_n25_), .d(new_n44_), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n22_), .O(z13));
  nand2  g35(.a(new_n25_), .b(new_n44_), .O(new_n57_));
  oai21  g36(.a(new_n57_), .b(new_n40_), .c(new_n39_), .O(z14));
  nand4  g37(.a(new_n26_), .b(new_n29_), .c(new_n25_), .d(new_n44_), .O(new_n59_));
