...
module FAU ( 
  ...
  nand4  g09(.a(new_n27_), .b(new_n29_), .c(x1), .d(x0), .O(new_n32_));
  ...
  aoi21  g17(.a(new_n35_), .b(new_n29_), .c(x3), .O(z07));
  ...
  oai21  g22(.a(new_n44_), .b(new_n30_), .c(new_n28_), .O(z10));
  nand3  g23(.a(x4), .b(x1), .c(new_n41_), .O(new_n46_));
  aoi21  g24(.a(new_n46_), .b(new_n29_), .c(x3), .O(z11));
  ...
  oai21  g28(.a(new_n51_), .b(new_n30_), .c(new_n28_), .O(z14));
  nand4  g29(.a(new_n27_), .b(new_n29_), .c(new_n34_), .d(new_n41_), .O(new_n53_));
