...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n32_,
    ...
    new_n46_, new_n48_, new_n49_, new_n50_, new_n52_, new_n54_, new_n55_,
    new_n57_;
  ...
  nand3  g24(.a(new_n27_), .b(x1), .c(new_n41_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(x4), .c(new_n22_), .O(z10));
  nand2  g26(.a(x1), .b(new_n41_), .O(new_n48_));
  nand2  g27(.a(new_n23_), .b(x3), .O(new_n49_));
  nand3  g28(.a(x4), .b(new_n22_), .c(new_n27_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n48_), .c(new_n49_), .O(z11));
  ...
  oai21  g34(.a(new_n55_), .b(new_n54_), .c(new_n49_), .O(z13));
  nand4  g35(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n41_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n23_), .O(z14));
  oai21  g37(.a(new_n54_), .b(new_n50_), .c(new_n49_), .O(z15));
endmodule
