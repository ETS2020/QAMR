...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n36_, new_n37_, new_n38_, new_n41_, new_n47_,
    new_n49_, new_n51_;
  ...
  oai21  g20(.a(new_n41_), .b(new_n36_), .c(new_n38_), .O(z07));
  inv1   g21(.a(new_n38_), .O(z08));
  aoi21  g22(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  nand4  g23(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n31_), .O(z13));
  nand4  g25(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n37_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n31_), .O(z14));
  nand4  g27(.a(new_n25_), .b(new_n28_), .c(new_n22_), .d(new_n37_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n31_), .O(z15));
  zero   g29(.O(z09));
  zero   g30(.O(z11));
  inv1   g31(.a(new_n38_), .O(z10));
endmodule
