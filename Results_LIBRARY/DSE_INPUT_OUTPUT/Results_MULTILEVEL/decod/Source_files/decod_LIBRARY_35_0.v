...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n32_, new_n33_, new_n34_, new_n36_, new_n38_, new_n40_, new_n43_,
  ...
  nand4  g14(.a(x3), .b(x2), .c(new_n32_), .d(x0), .O(new_n36_));
