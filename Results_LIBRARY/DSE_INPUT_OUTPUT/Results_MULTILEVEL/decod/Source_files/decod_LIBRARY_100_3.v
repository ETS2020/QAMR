...
module FAU ( 
  ...
  nand4  g06(.a(new_n28_), .b(x2), .c(new_n23_), .d(x0), .O(new_n29_));
  nor2   g07(.a(new_n29_), .b(new_n24_), .O(z05));
  inv1   g08(.a(x2), .O(new_n31_));
  nand4  g09(.a(x3), .b(new_n31_), .c(new_n23_), .d(x0), .O(new_n32_));
  nor2   g10(.a(new_n32_), .b(new_n24_), .O(z06));
  ...
  nand4  g16(.a(new_n28_), .b(x2), .c(new_n23_), .d(new_n38_), .O(new_n41_));
  ...
  nand4  g20(.a(new_n28_), .b(new_n31_), .c(new_n23_), .d(new_n38_), .O(new_n45_));
