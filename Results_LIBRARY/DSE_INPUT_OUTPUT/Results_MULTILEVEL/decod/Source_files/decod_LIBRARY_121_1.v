...
module FAU ( 
  ...
  nand4  g22(.a(x3), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n28_), .O(z12));
  nand4  g24(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(new_n28_), .O(z13));
  aoi21  g26(.a(new_n40_), .b(new_n22_), .c(x0), .O(z14));
  nand3  g27(.a(x4), .b(new_n25_), .c(new_n29_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n22_), .c(x0), .O(z15));
  zero   g29(.O(z08));
  zero   g30(.O(z09));
  zero   g31(.O(z10));
  zero   g32(.O(z11));
