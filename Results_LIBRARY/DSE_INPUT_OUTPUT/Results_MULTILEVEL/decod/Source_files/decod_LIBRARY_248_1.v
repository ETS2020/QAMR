...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n38_, new_n40_, new_n43_, new_n44_;
  ...
  nand4  g22(.a(x3), .b(new_n22_), .c(x1), .d(new_n43_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n28_), .O(z10));
  aoi21  g24(.a(new_n26_), .b(new_n22_), .c(x0), .O(z11));
  aoi21  g25(.a(new_n34_), .b(new_n22_), .c(x0), .O(z14));
  aoi21  g26(.a(new_n36_), .b(new_n22_), .c(x0), .O(z15));
  zero   g27(.O(z12));
  nor2   g28(.a(new_n22_), .b(x0), .O(z09));
  nor2   g29(.a(new_n22_), .b(x0), .O(z13));
endmodule
