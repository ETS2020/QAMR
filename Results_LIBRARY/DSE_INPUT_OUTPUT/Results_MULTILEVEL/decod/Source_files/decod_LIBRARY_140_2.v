...
module FAU ( 
  ...
  oai21  g32(.a(new_n53_), .b(new_n36_), .c(new_n34_), .O(z12));
  nand4  g33(.a(new_n31_), .b(x2), .c(new_n22_), .d(new_n44_), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n25_), .O(z13));
  oai21  g35(.a(new_n53_), .b(new_n40_), .c(new_n34_), .O(z14));
  nand4  g36(.a(new_n31_), .b(new_n28_), .c(new_n22_), .d(new_n44_), .O(new_n58_));
