...
module FAU ( 
  ...
  nand4  g13(.a(new_n28_), .b(new_n31_), .c(new_n25_), .d(x0), .O(new_n35_));
  nor2   g14(.a(new_n35_), .b(new_n34_), .O(z07));
  aoi21  g15(.a(new_n26_), .b(new_n24_), .c(new_n25_), .O(z08));
  nand4  g16(.a(new_n28_), .b(x2), .c(x1), .d(new_n24_), .O(new_n38_));
  nor2   g17(.a(new_n38_), .b(new_n34_), .O(z09));
  nand4  g18(.a(x3), .b(new_n31_), .c(x1), .d(new_n24_), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n34_), .O(z10));
  nand4  g20(.a(new_n28_), .b(new_n31_), .c(x1), .d(new_n24_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n34_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n25_), .d(new_n24_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n34_), .O(z12));
  nand2  g24(.a(new_n25_), .b(new_n24_), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n29_), .c(new_n22_), .O(z13));
  oai21  g26(.a(new_n46_), .b(new_n32_), .c(new_n22_), .O(z14));
  nand4  g27(.a(new_n28_), .b(new_n31_), .c(new_n25_), .d(new_n24_), .O(new_n49_));
