...
module FAU ( 
  ...
  oai21  g15(.a(new_n37_), .b(new_n23_), .c(new_n34_), .O(z08));
  inv1   g16(.a(x4), .O(new_n39_));
  nand4  g17(.a(new_n25_), .b(x2), .c(x1), .d(new_n22_), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n39_), .O(z09));
  nand4  g19(.a(x3), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n42_));
  nor2   g20(.a(new_n42_), .b(new_n39_), .O(z10));
  nand4  g21(.a(new_n25_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n39_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n33_), .d(new_n22_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n39_), .O(z12));
  aoi21  g25(.a(new_n26_), .b(new_n22_), .c(x1), .O(z13));
  aoi21  g26(.a(new_n29_), .b(new_n22_), .c(x1), .O(z14));
  nand4  g27(.a(new_n25_), .b(new_n28_), .c(new_n33_), .d(new_n22_), .O(new_n50_));
