...
module FAU ( 
  ...
  nand4  g26(.a(new_n22_), .b(new_n31_), .c(x1), .d(new_n41_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n30_), .O(z11));
  nand4  g28(.a(new_n22_), .b(x2), .c(new_n25_), .d(new_n41_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n30_), .O(z13));
