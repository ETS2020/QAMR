...
module FAU ( 
  ...
  nand4  g14(.a(x3), .b(x2), .c(x1), .d(new_n35_), .O(new_n36_));
  nor2   g15(.a(new_n36_), .b(new_n23_), .O(z08));
  nand2  g16(.a(x1), .b(new_n35_), .O(new_n38_));
  nand3  g17(.a(x4), .b(new_n22_), .c(x2), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n38_), .c(new_n33_), .O(z09));
  nand3  g19(.a(x4), .b(x3), .c(new_n27_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n38_), .c(new_n33_), .O(z10));
  nand4  g21(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n35_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n23_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n32_), .d(new_n35_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n23_), .O(z12));
  aoi21  g25(.a(new_n39_), .b(new_n35_), .c(x1), .O(z13));
  nand4  g26(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n35_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n23_), .O(z14));
  nand3  g28(.a(x4), .b(new_n22_), .c(new_n27_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n35_), .c(x1), .O(z15));
  inv1   g30(.a(new_n33_), .O(z05));
  inv1   g31(.a(new_n33_), .O(z06));
