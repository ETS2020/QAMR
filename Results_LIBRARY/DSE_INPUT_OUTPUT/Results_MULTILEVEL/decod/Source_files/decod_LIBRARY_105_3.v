...
module FAU ( 
  ...
  nand2  g26(.a(new_n32_), .b(new_n42_), .O(new_n49_));
  nand3  g27(.a(x4), .b(new_n29_), .c(x2), .O(new_n50_));
  oai21  g28(.a(new_n50_), .b(new_n49_), .c(new_n26_), .O(z13));
  nand4  g29(.a(x3), .b(new_n28_), .c(new_n32_), .d(new_n42_), .O(new_n52_));
  nor2   g30(.a(new_n52_), .b(new_n23_), .O(z14));
  oai21  g31(.a(new_n49_), .b(new_n40_), .c(new_n26_), .O(z15));
  zero   g32(.O(z00));
