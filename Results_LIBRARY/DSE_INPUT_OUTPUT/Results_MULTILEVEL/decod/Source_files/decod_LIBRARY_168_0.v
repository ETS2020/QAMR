...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n32_, new_n34_, new_n41_, new_n42_;
  ...
  aoi21  g16(.a(new_n32_), .b(x0), .c(x1), .O(z06));
  aoi21  g17(.a(new_n34_), .b(x0), .c(x1), .O(z07));
  aoi21  g18(.a(new_n26_), .b(x1), .c(x0), .O(z08));
  inv1   g19(.a(x4), .O(new_n41_));
  nand4  g20(.a(new_n28_), .b(x2), .c(x1), .d(new_n22_), .O(new_n42_));
  nor2   g21(.a(new_n42_), .b(new_n41_), .O(z09));
  aoi21  g22(.a(new_n32_), .b(x1), .c(x0), .O(z10));
