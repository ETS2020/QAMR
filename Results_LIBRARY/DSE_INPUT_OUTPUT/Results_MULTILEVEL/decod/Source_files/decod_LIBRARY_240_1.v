...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    ...
    new_n43_, new_n47_, new_n49_, new_n54_;
  ...
  nand2  g20(.a(x2), .b(new_n41_), .O(new_n42_));
  nand3  g21(.a(x4), .b(new_n25_), .c(new_n22_), .O(new_n43_));
  oai21  g22(.a(new_n43_), .b(new_n40_), .c(new_n42_), .O(z07));
  nand4  g23(.a(x3), .b(new_n22_), .c(x1), .d(new_n41_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n28_), .O(z10));
  nand4  g25(.a(new_n25_), .b(new_n22_), .c(x1), .d(new_n41_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n28_), .O(z11));
  inv1   g27(.a(new_n42_), .O(z12));
  aoi21  g28(.a(new_n34_), .b(new_n22_), .c(x0), .O(z14));
  nand4  g29(.a(new_n25_), .b(new_n22_), .c(new_n33_), .d(new_n41_), .O(new_n54_));
