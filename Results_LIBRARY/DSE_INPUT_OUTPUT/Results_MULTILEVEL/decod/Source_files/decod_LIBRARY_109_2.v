...
module FAU ( 
  ...
  nand4  g17(.a(x3), .b(new_n27_), .c(new_n34_), .d(x0), .O(new_n39_));
  ...
  nand3  g24(.a(new_n22_), .b(x1), .c(new_n43_), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(x4), .c(new_n27_), .O(z09));
  nand2  g26(.a(x1), .b(new_n43_), .O(new_n48_));
  nand3  g27(.a(x4), .b(x3), .c(new_n27_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n48_), .c(new_n31_), .O(z10));
  oai21  g29(.a(new_n48_), .b(new_n32_), .c(new_n31_), .O(z11));
  nand3  g30(.a(x3), .b(new_n34_), .c(new_n43_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(new_n27_), .O(z12));
  nand3  g32(.a(new_n22_), .b(new_n34_), .c(new_n43_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(new_n27_), .O(z13));
  nand2  g34(.a(new_n34_), .b(new_n43_), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n49_), .c(new_n31_), .O(z14));
  nand4  g36(.a(new_n22_), .b(new_n27_), .c(new_n34_), .d(new_n43_), .O(new_n58_));
