...
module FAU ( 
  ...
  aoi21  g21(.a(new_n44_), .b(new_n33_), .c(new_n27_), .O(z11));
  nand2  g22(.a(new_n27_), .b(new_n33_), .O(new_n46_));
  nand3  g23(.a(x4), .b(x3), .c(x2), .O(new_n47_));
  oai21  g24(.a(new_n47_), .b(new_n46_), .c(new_n22_), .O(z12));
  nand4  g25(.a(new_n30_), .b(x2), .c(new_n27_), .d(new_n33_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n26_), .O(z13));
  nand4  g27(.a(x3), .b(new_n34_), .c(new_n27_), .d(new_n33_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n26_), .O(z14));
  nand4  g29(.a(new_n30_), .b(new_n34_), .c(new_n27_), .d(new_n33_), .O(new_n53_));
