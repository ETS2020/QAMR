...
module FAU ( 
  ...
  inv1   g22(.a(new_n41_), .O(z10));
  nand4  g23(.a(x3), .b(x2), .c(new_n27_), .d(new_n40_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n23_), .O(z12));
  nand3  g25(.a(x4), .b(new_n22_), .c(x2), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n27_), .c(x0), .O(z13));
  aoi21  g27(.a(new_n29_), .b(new_n27_), .c(x0), .O(z14));
  aoi21  g28(.a(new_n42_), .b(new_n27_), .c(x0), .O(z15));
  zero   g29(.O(z08));
  zero   g30(.O(z09));
  zero   g31(.O(z11));
endmodule
