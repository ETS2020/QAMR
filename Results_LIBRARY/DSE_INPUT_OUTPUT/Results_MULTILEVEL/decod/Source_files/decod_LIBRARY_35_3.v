...
module FAU ( 
  ...
  aoi21  g18(.a(new_n42_), .b(new_n37_), .c(new_n28_), .O(z09));
  ...
  nand2  g23(.a(new_n28_), .b(new_n37_), .O(new_n48_));
  nand3  g24(.a(x4), .b(x3), .c(x2), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n48_), .c(new_n25_), .O(z12));
  nand4  g26(.a(new_n31_), .b(x2), .c(new_n28_), .d(new_n37_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n27_), .O(z13));
  nand4  g28(.a(x3), .b(new_n34_), .c(new_n28_), .d(new_n37_), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(new_n27_), .O(z14));
  oai21  g30(.a(new_n48_), .b(new_n38_), .c(new_n25_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z01));
  zero   g33(.O(z02));
endmodule
