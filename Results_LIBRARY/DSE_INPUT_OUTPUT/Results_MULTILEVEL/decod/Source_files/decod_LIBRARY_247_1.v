...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n36_, new_n38_, new_n41_, new_n44_,
  ...
  nand4  g22(.a(x3), .b(x2), .c(new_n22_), .d(new_n34_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n25_), .O(z12));
  nand4  g24(.a(new_n31_), .b(x2), .c(new_n22_), .d(new_n34_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n25_), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n34_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n25_), .O(z14));
  nand4  g28(.a(new_n31_), .b(new_n28_), .c(new_n22_), .d(new_n34_), .O(new_n50_));
