...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n39_, new_n40_, new_n42_, new_n44_, new_n46_;
  inv1   g00(.a(x1), .O(new_n22_));
  inv1   g01(.a(x4), .O(new_n23_));
  nor2   g02(.a(new_n23_), .b(new_n22_), .O(z00));
  nand3  g03(.a(x3), .b(x2), .c(x0), .O(new_n25_));
  aoi21  g04(.a(new_n25_), .b(new_n22_), .c(new_n23_), .O(z04));
  ...
  nand3  g16(.a(new_n27_), .b(x2), .c(new_n39_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(new_n22_), .c(new_n23_), .O(z13));
  nand4  g18(.a(x3), .b(new_n30_), .c(new_n22_), .d(new_n39_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n23_), .O(z14));
  nand4  g20(.a(new_n27_), .b(new_n30_), .c(new_n22_), .d(new_n39_), .O(new_n46_));
  ...
  nor2   g28(.a(new_n23_), .b(new_n22_), .O(z03));
endmodule
