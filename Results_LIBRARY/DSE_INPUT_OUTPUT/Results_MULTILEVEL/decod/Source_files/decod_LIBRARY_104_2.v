...
module FAU ( 
  ...
  nand3  g29(.a(x4), .b(new_n27_), .c(new_n30_), .O(new_n51_));
  oai21  g30(.a(new_n51_), .b(new_n47_), .c(new_n26_), .O(z11));
  nand3  g31(.a(x2), .b(new_n35_), .c(new_n44_), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(x4), .c(new_n27_), .O(z12));
  nand4  g33(.a(new_n27_), .b(x2), .c(new_n35_), .d(new_n44_), .O(new_n55_));
