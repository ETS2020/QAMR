...
module FAU ( 
  ...
  nand4  g21(.a(new_n23_), .b(x2), .c(x1), .d(new_n41_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n28_), .O(z09));
  ...
  nand4  g29(.a(x3), .b(new_n31_), .c(new_n22_), .d(new_n41_), .O(new_n52_));
  nor2   g30(.a(new_n52_), .b(new_n28_), .O(z14));
  zero   g31(.O(z05));
