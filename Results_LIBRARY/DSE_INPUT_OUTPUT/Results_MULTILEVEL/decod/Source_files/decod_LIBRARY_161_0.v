...
module FAU ( 
  ...
  nand4  g17(.a(x3), .b(new_n29_), .c(new_n34_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n23_), .O(z06));
  nand4  g19(.a(new_n22_), .b(new_n29_), .c(new_n34_), .d(x0), .O(new_n41_));
  ...
  oai21  g24(.a(new_n45_), .b(new_n44_), .c(new_n28_), .O(z08));
  nand4  g25(.a(new_n22_), .b(x2), .c(x1), .d(new_n43_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n23_), .O(z09));
  oai21  g27(.a(new_n44_), .b(new_n30_), .c(new_n28_), .O(z10));
  nand3  g28(.a(new_n29_), .b(x1), .c(new_n43_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(x4), .c(x3), .O(z11));
  nand4  g30(.a(x3), .b(x2), .c(new_n34_), .d(new_n43_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n23_), .O(z12));
  nand3  g32(.a(x2), .b(new_n34_), .c(new_n43_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(x3), .O(z13));
  nand2  g34(.a(new_n34_), .b(new_n43_), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n30_), .c(new_n28_), .O(z14));
  nand4  g36(.a(new_n22_), .b(new_n29_), .c(new_n34_), .d(new_n43_), .O(new_n58_));
