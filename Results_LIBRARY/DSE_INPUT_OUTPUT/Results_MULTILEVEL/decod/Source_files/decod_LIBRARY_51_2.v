...
module FAU ( 
  ...
  nand4  g16(.a(new_n25_), .b(x2), .c(new_n35_), .d(x0), .O(new_n38_));
  ...
  oai21  g29(.a(new_n50_), .b(new_n33_), .c(new_n29_), .O(z11));
  nand3  g30(.a(x3), .b(new_n35_), .c(new_n43_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(new_n22_), .O(z12));
  nand3  g32(.a(new_n25_), .b(new_n35_), .c(new_n43_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(new_n22_), .O(z13));
  nand4  g34(.a(x3), .b(new_n22_), .c(new_n35_), .d(new_n43_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n28_), .O(z14));
  nand4  g36(.a(new_n25_), .b(new_n22_), .c(new_n35_), .d(new_n43_), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n28_), .O(z15));
endmodule
