...
module FAU ( 
  ...
  nand4  g19(.a(x3), .b(new_n34_), .c(x1), .d(new_n33_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n26_), .O(z10));
  aoi21  g21(.a(new_n37_), .b(new_n33_), .c(new_n27_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n27_), .d(new_n33_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n26_), .O(z12));
  nand4  g24(.a(new_n30_), .b(x2), .c(new_n27_), .d(new_n33_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n26_), .O(z13));
  nand2  g26(.a(new_n27_), .b(new_n33_), .O(new_n50_));
  oai21  g27(.a(new_n50_), .b(new_n35_), .c(new_n22_), .O(z14));
  oai21  g28(.a(new_n50_), .b(new_n37_), .c(new_n22_), .O(z15));
  zero   g29(.O(z01));
  zero   g30(.O(z02));
