...
module FAU ( 
  ...
  nand4  g18(.a(x3), .b(new_n30_), .c(new_n22_), .d(x0), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n23_), .O(z06));
  nand3  g20(.a(new_n33_), .b(new_n30_), .c(x0), .O(new_n42_));
  ...
  nand4  g36(.a(new_n33_), .b(new_n30_), .c(new_n22_), .d(new_n44_), .O(new_n58_));
