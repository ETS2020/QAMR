...
module FAU ( 
  ...
  nand4  g09(.a(x3), .b(new_n25_), .c(new_n33_), .d(x0), .O(new_n34_));
  nor2   g10(.a(new_n34_), .b(new_n24_), .O(z06));
  nand3  g11(.a(new_n28_), .b(new_n33_), .c(x0), .O(new_n36_));
  aoi21  g12(.a(new_n36_), .b(new_n25_), .c(new_n24_), .O(z07));
  inv1   g13(.a(x0), .O(new_n39_));
  nand3  g14(.a(x3), .b(x1), .c(new_n39_), .O(new_n40_));
  aoi21  g15(.a(new_n40_), .b(new_n25_), .c(new_n24_), .O(z10));
  nand3  g16(.a(new_n28_), .b(x1), .c(new_n39_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(new_n25_), .c(new_n24_), .O(z11));
  nand3  g18(.a(x3), .b(new_n33_), .c(new_n39_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n25_), .c(new_n24_), .O(z14));
  nand4  g20(.a(new_n28_), .b(new_n25_), .c(new_n33_), .d(new_n39_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n24_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z01));
  zero   g24(.O(z05));
  zero   g25(.O(z08));
  nor2   g26(.a(new_n24_), .b(new_n25_), .O(z09));
  nor2   g27(.a(new_n24_), .b(new_n25_), .O(z12));
