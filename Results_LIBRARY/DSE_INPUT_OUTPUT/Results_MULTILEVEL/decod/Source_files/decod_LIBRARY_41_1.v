...
module FAU ( 
  ...
  nand4  g26(.a(x3), .b(new_n22_), .c(new_n34_), .d(new_n39_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n28_), .O(z14));
  nand4  g28(.a(new_n25_), .b(new_n22_), .c(new_n34_), .d(new_n39_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n28_), .O(z15));
  zero   g30(.O(z13));
  nor2   g31(.a(new_n22_), .b(x1), .O(z05));
  nor2   g32(.a(new_n22_), .b(x1), .O(z12));
endmodule
