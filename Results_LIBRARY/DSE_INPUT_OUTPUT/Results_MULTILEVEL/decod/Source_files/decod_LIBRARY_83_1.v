...
module FAU ( 
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n28_), .O(z12));
  aoi21  g25(.a(new_n26_), .b(new_n22_), .c(x0), .O(z13));
  nand4  g26(.a(x3), .b(new_n29_), .c(new_n22_), .d(new_n37_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n28_), .O(z14));
  nand4  g28(.a(new_n25_), .b(new_n29_), .c(new_n22_), .d(new_n37_), .O(new_n53_));
