...
module FAU ( 
  ...
  nand4  g14(.a(new_n28_), .b(x2), .c(x1), .d(new_n38_), .O(new_n39_));
  nor2   g15(.a(new_n39_), .b(new_n23_), .O(z09));
  nand4  g16(.a(new_n28_), .b(new_n27_), .c(x1), .d(new_n38_), .O(new_n41_));
  ...
  nand3  g20(.a(new_n27_), .b(new_n32_), .c(new_n38_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n28_), .c(new_n23_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z02));
  zero   g24(.O(z04));
  zero   g25(.O(z12));
  nor2   g26(.a(new_n23_), .b(new_n28_), .O(z08));
  nor2   g27(.a(new_n23_), .b(new_n28_), .O(z10));
