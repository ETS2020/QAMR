...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n27_, new_n28_, new_n31_, new_n32_,
    new_n34_, new_n36_, new_n37_, new_n40_, new_n43_, new_n46_;
  ...
  nand4  g09(.a(new_n22_), .b(x2), .c(new_n31_), .d(x0), .O(new_n32_));
  nor2   g10(.a(new_n32_), .b(new_n23_), .O(z05));
  nand4  g11(.a(new_n22_), .b(new_n27_), .c(new_n31_), .d(x0), .O(new_n34_));
  nor2   g12(.a(new_n34_), .b(new_n23_), .O(z07));
  inv1   g13(.a(x0), .O(new_n36_));
  nand3  g14(.a(x2), .b(x1), .c(new_n36_), .O(new_n37_));
  aoi21  g15(.a(new_n37_), .b(new_n22_), .c(new_n23_), .O(z09));
  nand3  g16(.a(new_n27_), .b(x1), .c(new_n36_), .O(new_n40_));
  aoi21  g17(.a(new_n40_), .b(new_n22_), .c(new_n23_), .O(z11));
  nand3  g18(.a(x2), .b(new_n31_), .c(new_n36_), .O(new_n43_));
  aoi21  g19(.a(new_n43_), .b(new_n22_), .c(new_n23_), .O(z13));
  nand4  g20(.a(new_n22_), .b(new_n27_), .c(new_n31_), .d(new_n36_), .O(new_n46_));
