...
module FAU ( 
  ...
  nand2  g23(.a(new_n22_), .b(new_n40_), .O(new_n45_));
  nand3  g24(.a(x4), .b(x3), .c(x2), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n45_), .c(new_n26_), .O(z12));
  nand4  g26(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n40_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n28_), .O(z13));
  oai21  g28(.a(new_n45_), .b(new_n36_), .c(new_n26_), .O(z14));
  nand4  g29(.a(new_n25_), .b(new_n29_), .c(new_n22_), .d(new_n40_), .O(new_n51_));
