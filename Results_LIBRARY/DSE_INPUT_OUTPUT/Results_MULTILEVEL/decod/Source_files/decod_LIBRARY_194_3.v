...
module FAU ( 
  ...
  nand4  g11(.a(new_n22_), .b(new_n28_), .c(new_n32_), .d(x0), .O(new_n36_));
  ...
  nand4  g16(.a(new_n22_), .b(new_n28_), .c(x1), .d(new_n38_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n23_), .O(z11));
  nand4  g18(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n38_), .O(new_n44_));
