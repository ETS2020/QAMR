...
module FAU ( 
  ...
  nand3  g10(.a(new_n31_), .b(new_n28_), .c(x1), .O(new_n32_));
  ...
  nand3  g15(.a(new_n31_), .b(x2), .c(new_n34_), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(x4), .c(new_n22_), .O(z05));
  nand4  g17(.a(x3), .b(new_n28_), .c(new_n34_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n25_), .O(z06));
  nand3  g19(.a(new_n31_), .b(new_n28_), .c(new_n34_), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(x4), .c(new_n22_), .O(z07));
  nand4  g21(.a(x3), .b(x2), .c(x1), .d(new_n22_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n25_), .O(z08));
  nand4  g23(.a(new_n31_), .b(x2), .c(x1), .d(new_n22_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n25_), .O(z09));
  nand2  g25(.a(x1), .b(new_n22_), .O(new_n47_));
  nand2  g26(.a(new_n25_), .b(x0), .O(new_n48_));
  nand3  g27(.a(x4), .b(x3), .c(new_n28_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n47_), .c(new_n48_), .O(z10));
  nand4  g29(.a(new_n31_), .b(new_n28_), .c(x1), .d(new_n22_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n25_), .O(z11));
  nand4  g31(.a(x3), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n25_), .O(z12));
  nand2  g33(.a(new_n34_), .b(new_n22_), .O(new_n55_));
  nand3  g34(.a(x4), .b(new_n31_), .c(x2), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n55_), .c(new_n48_), .O(z13));
  oai21  g36(.a(new_n55_), .b(new_n49_), .c(new_n48_), .O(z14));
  nand3  g37(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n59_));
  oai21  g38(.a(new_n59_), .b(new_n55_), .c(new_n48_), .O(z15));
endmodule
