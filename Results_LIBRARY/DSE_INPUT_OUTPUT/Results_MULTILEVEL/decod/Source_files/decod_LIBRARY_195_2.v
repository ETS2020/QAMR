...
module FAU ( 
  ...
  nand4  g24(.a(new_n26_), .b(x2), .c(new_n25_), .d(new_n40_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n22_), .O(z13));
  nand4  g26(.a(x3), .b(new_n35_), .c(new_n25_), .d(new_n40_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n22_), .O(z14));
  nand4  g28(.a(new_n26_), .b(new_n35_), .c(new_n25_), .d(new_n40_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n22_), .O(z15));
  zero   g30(.O(z03));
  nor2   g31(.a(x2), .b(new_n25_), .O(z10));
  nor2   g32(.a(x2), .b(new_n25_), .O(z11));
endmodule
