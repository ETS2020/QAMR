...
module FAU ( 
  ...
  nand2  g22(.a(x1), .b(new_n41_), .O(new_n46_));
  nand3  g23(.a(x4), .b(x3), .c(new_n31_), .O(new_n47_));
  oai21  g24(.a(new_n47_), .b(new_n46_), .c(new_n24_), .O(z10));
  nand4  g25(.a(new_n23_), .b(new_n31_), .c(x1), .d(new_n41_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n28_), .O(z11));
  nand3  g27(.a(x4), .b(x2), .c(new_n41_), .O(new_n51_));
  aoi21  g28(.a(new_n51_), .b(x3), .c(x1), .O(z12));
  inv1   g29(.a(new_n24_), .O(z13));
  nand3  g30(.a(x4), .b(new_n31_), .c(new_n41_), .O(new_n54_));
