...
module FAU ( 
  ...
  nand4  g17(.a(x3), .b(new_n27_), .c(new_n31_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n23_), .O(z06));
  nand3  g19(.a(new_n22_), .b(new_n27_), .c(x0), .O(new_n41_));
  ...
  oai21  g29(.a(new_n44_), .b(new_n33_), .c(new_n32_), .O(z11));
  nand4  g30(.a(x3), .b(x2), .c(new_n31_), .d(new_n43_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n23_), .O(z12));
  nand3  g32(.a(new_n22_), .b(x2), .c(new_n43_), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(x4), .c(x1), .O(z13));
  nand3  g34(.a(x3), .b(new_n27_), .c(new_n43_), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(x4), .c(x1), .O(z14));
  nand4  g36(.a(new_n22_), .b(new_n27_), .c(new_n31_), .d(new_n43_), .O(new_n58_));
