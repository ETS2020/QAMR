...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n34_, new_n35_, new_n37_, new_n39_, new_n42_, new_n43_,
  ...
  nor2   g13(.a(new_n35_), .b(new_n28_), .O(z04));
  nand3  g14(.a(x4), .b(new_n34_), .c(x0), .O(new_n37_));
  aoi21  g15(.a(new_n37_), .b(x2), .c(x3), .O(z05));
  nand4  g16(.a(x3), .b(new_n22_), .c(new_n34_), .d(x0), .O(new_n39_));
  nor2   g17(.a(new_n39_), .b(new_n28_), .O(z06));
  ...
  nand2  g25(.a(new_n34_), .b(new_n42_), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n26_), .c(new_n24_), .O(z12));
  nand3  g27(.a(x4), .b(new_n34_), .c(new_n42_), .O(new_n51_));
