...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n28_, new_n29_, new_n30_, new_n33_,
    ...
    new_n48_, new_n50_, new_n53_, new_n54_;
  ...
  nand4  g13(.a(x3), .b(new_n29_), .c(new_n23_), .d(x0), .O(new_n37_));
  ...
  nor2   g19(.a(new_n43_), .b(new_n28_), .O(z09));
  inv1   g20(.a(new_n33_), .O(z10));
  ...
  nand2  g28(.a(new_n23_), .b(new_n42_), .O(new_n53_));
  nand3  g29(.a(x4), .b(new_n24_), .c(new_n29_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n53_), .c(new_n33_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z02));
  zero   g33(.O(z08));
endmodule
