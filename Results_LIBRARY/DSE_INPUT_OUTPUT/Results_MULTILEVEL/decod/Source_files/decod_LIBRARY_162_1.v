...
module FAU ( 
  ...
  nand4  g09(.a(new_n25_), .b(x2), .c(new_n30_), .d(x0), .O(new_n33_));
  nor2   g10(.a(new_n33_), .b(new_n22_), .O(z05));
  nor2   g11(.a(new_n22_), .b(x2), .O(z06));
  ...
  nand3  g17(.a(x3), .b(new_n30_), .c(new_n37_), .O(new_n43_));
