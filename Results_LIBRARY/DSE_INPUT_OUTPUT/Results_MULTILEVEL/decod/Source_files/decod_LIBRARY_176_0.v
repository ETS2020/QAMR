...
module FAU ( 
  ...
  nand3  g16(.a(x4), .b(new_n32_), .c(x2), .O(new_n38_));
  oai21  g17(.a(new_n38_), .b(new_n36_), .c(new_n24_), .O(z05));
  ...
  nand3  g29(.a(new_n32_), .b(x1), .c(new_n44_), .O(new_n51_));
  ...
  oai21  g33(.a(new_n53_), .b(new_n38_), .c(new_n24_), .O(z13));
  nand4  g34(.a(x3), .b(new_n22_), .c(new_n35_), .d(new_n44_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n23_), .O(z14));
  nand3  g36(.a(new_n32_), .b(new_n35_), .c(new_n44_), .O(new_n58_));
