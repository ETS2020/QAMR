...
module FAU ( 
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n22_), .d(new_n34_), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n25_), .O(z12));
  nand4  g25(.a(new_n31_), .b(x2), .c(new_n22_), .d(new_n34_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n25_), .O(z13));
  nand4  g27(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n34_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n25_), .O(z14));
  aoi21  g29(.a(new_n32_), .b(new_n22_), .c(x0), .O(z15));
  zero   g30(.O(z08));
