...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n37_, new_n39_, new_n42_, new_n44_,
  ...
  oai21  g16(.a(new_n37_), .b(new_n23_), .c(new_n35_), .O(z08));
  nand3  g17(.a(x4), .b(new_n31_), .c(x2), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n37_), .c(new_n35_), .O(z09));
  oai21  g19(.a(new_n37_), .b(new_n29_), .c(new_n35_), .O(z10));
  nand3  g20(.a(x4), .b(new_n31_), .c(new_n28_), .O(new_n42_));
  oai21  g21(.a(new_n42_), .b(new_n37_), .c(new_n35_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n25_), .O(z12));
  nand4  g24(.a(new_n31_), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n25_), .O(z13));
  nand4  g26(.a(x3), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n25_), .O(z14));
  nand4  g28(.a(new_n31_), .b(new_n28_), .c(new_n34_), .d(new_n22_), .O(new_n50_));
