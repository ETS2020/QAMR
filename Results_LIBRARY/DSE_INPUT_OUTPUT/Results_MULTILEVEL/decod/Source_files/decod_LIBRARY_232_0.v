...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    ...
    new_n43_, new_n45_, new_n47_, new_n51_, new_n53_;
  ...
  oai21  g18(.a(new_n39_), .b(new_n29_), .c(new_n24_), .O(z05));
  nand4  g19(.a(x3), .b(new_n23_), .c(new_n36_), .d(x0), .O(new_n41_));
  nor2   g20(.a(new_n41_), .b(new_n31_), .O(z06));
  nand4  g21(.a(new_n28_), .b(new_n23_), .c(new_n36_), .d(x0), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n31_), .O(z07));
  nand3  g23(.a(x4), .b(x3), .c(x1), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(x2), .c(x0), .O(z08));
  nand3  g25(.a(x4), .b(new_n28_), .c(x1), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(x2), .c(x0), .O(z09));
  nand4  g27(.a(x3), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n31_), .O(z12));
  nand4  g29(.a(new_n28_), .b(x2), .c(new_n36_), .d(new_n22_), .O(new_n53_));
