...
module FAU ( 
  ...
  nand3  g13(.a(x2), .b(new_n32_), .c(x0), .O(new_n35_));
  aoi21  g14(.a(new_n35_), .b(x4), .c(x3), .O(z05));
  nand2  g15(.a(new_n32_), .b(x0), .O(new_n37_));
  nand2  g16(.a(new_n23_), .b(new_n22_), .O(new_n38_));
  nand3  g17(.a(x4), .b(x3), .c(new_n27_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n37_), .c(new_n38_), .O(z06));
  ...
  oai21  g24(.a(new_n45_), .b(new_n44_), .c(new_n38_), .O(z08));
  nand4  g25(.a(new_n22_), .b(x2), .c(x1), .d(new_n43_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n23_), .O(z09));
  oai21  g27(.a(new_n44_), .b(new_n39_), .c(new_n38_), .O(z10));
  ...
  oai21  g35(.a(new_n56_), .b(new_n39_), .c(new_n38_), .O(z14));
  nand3  g36(.a(new_n27_), .b(new_n32_), .c(new_n43_), .O(new_n58_));
