...
module FAU ( 
  ...
  nand3  g19(.a(x4), .b(x3), .c(new_n35_), .O(new_n44_));
  aoi21  g20(.a(new_n44_), .b(new_n27_), .c(new_n28_), .O(z10));
  nand4  g21(.a(new_n32_), .b(new_n35_), .c(x1), .d(new_n27_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n31_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n28_), .d(new_n27_), .O(new_n48_));
  ...
  nand2  g27(.a(new_n28_), .b(new_n27_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n44_), .c(new_n22_), .O(z14));
