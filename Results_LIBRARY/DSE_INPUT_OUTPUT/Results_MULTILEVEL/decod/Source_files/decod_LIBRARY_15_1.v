...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n47_,
    new_n49_, new_n51_;
  ...
  nand4  g21(.a(x3), .b(x2), .c(new_n22_), .d(new_n34_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n25_), .O(z12));
  nand4  g23(.a(new_n31_), .b(x2), .c(new_n22_), .d(new_n34_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n25_), .O(z13));
  nand4  g25(.a(x3), .b(new_n28_), .c(new_n22_), .d(new_n34_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(new_n25_), .O(z14));
