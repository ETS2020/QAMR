...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n36_, new_n37_, new_n39_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n49_;
  ...
  nand4  g20(.a(x3), .b(new_n29_), .c(x1), .d(new_n25_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n22_), .O(z10));
  nand3  g22(.a(x4), .b(new_n26_), .c(new_n29_), .O(new_n46_));
  oai21  g23(.a(new_n46_), .b(new_n39_), .c(new_n37_), .O(z11));
  aoi21  g24(.a(new_n40_), .b(new_n25_), .c(x1), .O(z12));
  nand4  g25(.a(new_n26_), .b(x2), .c(new_n36_), .d(new_n25_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n22_), .O(z13));
  aoi21  g27(.a(new_n30_), .b(new_n25_), .c(x1), .O(z14));
