...
module FAU ( 
  ...
  aoi21  g21(.a(new_n42_), .b(x4), .c(new_n32_), .O(z08));
  nand3  g22(.a(new_n22_), .b(x2), .c(new_n41_), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(x4), .c(new_n32_), .O(z09));
  nand4  g24(.a(x3), .b(new_n27_), .c(x1), .d(new_n41_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n23_), .O(z10));
  nand3  g26(.a(new_n22_), .b(new_n27_), .c(new_n41_), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(x4), .c(new_n32_), .O(z11));
  nand2  g28(.a(new_n23_), .b(x1), .O(new_n50_));
  ...
  nand4  g34(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n41_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n23_), .O(z14));
  nand3  g36(.a(x4), .b(new_n22_), .c(new_n27_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n51_), .c(new_n50_), .O(z15));
endmodule
