...
module FAU ( 
  ...
  nand3  g17(.a(x4), .b(new_n25_), .c(new_n29_), .O(new_n39_));
  oai21  g18(.a(new_n39_), .b(new_n34_), .c(new_n22_), .O(z07));
  inv1   g19(.a(x0), .O(new_n41_));
  nand4  g20(.a(new_n25_), .b(x2), .c(x1), .d(new_n41_), .O(new_n42_));
  ...
  nand4  g24(.a(x3), .b(x2), .c(new_n24_), .d(new_n41_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n28_), .O(z12));
  nand4  g26(.a(new_n25_), .b(x2), .c(new_n24_), .d(new_n41_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n28_), .O(z13));
  nand4  g28(.a(x3), .b(new_n29_), .c(new_n24_), .d(new_n41_), .O(new_n50_));
  nor2   g29(.a(new_n50_), .b(new_n28_), .O(z14));
  nand2  g30(.a(new_n24_), .b(new_n41_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n39_), .c(new_n22_), .O(z15));
