...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n40_, new_n42_, new_n44_, new_n45_,
    new_n48_, new_n50_;
  ...
  nand4  g17(.a(new_n31_), .b(x2), .c(x1), .d(new_n22_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n25_), .O(z09));
  nand2  g19(.a(x1), .b(new_n22_), .O(new_n44_));
  nand3  g20(.a(x4), .b(x3), .c(new_n28_), .O(new_n45_));
  oai21  g21(.a(new_n45_), .b(new_n44_), .c(new_n35_), .O(z10));
  oai21  g22(.a(new_n44_), .b(new_n32_), .c(new_n35_), .O(z11));
  nand4  g23(.a(x3), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n25_), .O(z12));
  nand4  g25(.a(new_n31_), .b(x2), .c(new_n34_), .d(new_n22_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n25_), .O(z13));
  aoi21  g27(.a(new_n45_), .b(new_n22_), .c(x1), .O(z14));
