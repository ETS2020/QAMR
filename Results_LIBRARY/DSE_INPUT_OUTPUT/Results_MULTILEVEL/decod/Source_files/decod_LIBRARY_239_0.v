...
module FAU ( 
  ...
  nand4  g17(.a(x3), .b(new_n31_), .c(new_n22_), .d(x0), .O(new_n39_));
  ...
  oai21  g25(.a(new_n46_), .b(new_n42_), .c(new_n24_), .O(z10));
  ...
  nor2   g29(.a(new_n50_), .b(new_n30_), .O(z12));
  aoi21  g30(.a(new_n48_), .b(x3), .c(x1), .O(z14));
  zero   g31(.O(z15));
  inv1   g32(.a(new_n24_), .O(z07));
  inv1   g33(.a(new_n24_), .O(z13));
endmodule
