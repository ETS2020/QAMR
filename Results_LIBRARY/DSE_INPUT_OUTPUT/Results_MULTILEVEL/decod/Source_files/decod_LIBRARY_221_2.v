...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n38_, new_n39_, new_n41_, new_n43_, new_n46_,
    new_n48_, new_n51_;
  ...
  nand2  g14(.a(x1), .b(new_n30_), .O(new_n38_));
  nand3  g15(.a(x4), .b(x3), .c(x2), .O(new_n39_));
  oai21  g16(.a(new_n39_), .b(new_n38_), .c(new_n35_), .O(z08));
  nand4  g17(.a(new_n22_), .b(x2), .c(x1), .d(new_n30_), .O(new_n41_));
  ...
  oai21  g21(.a(new_n38_), .b(new_n31_), .c(new_n35_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n34_), .d(new_n30_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n23_), .O(z12));
  nand3  g24(.a(x4), .b(new_n22_), .c(x2), .O(new_n48_));
  aoi21  g25(.a(new_n48_), .b(new_n30_), .c(x1), .O(z13));
  aoi21  g26(.a(new_n43_), .b(new_n30_), .c(x1), .O(z14));
  nand4  g27(.a(new_n22_), .b(new_n27_), .c(new_n34_), .d(new_n30_), .O(new_n51_));
