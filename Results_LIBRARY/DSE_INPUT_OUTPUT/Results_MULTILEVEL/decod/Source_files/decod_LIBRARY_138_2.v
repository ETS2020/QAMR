...
module FAU ( 
  ...
  oai21  g20(.a(new_n44_), .b(new_n42_), .c(new_n36_), .O(z10));
  ...
  aoi21  g24(.a(new_n48_), .b(new_n25_), .c(x1), .O(z12));
  ...
  nand4  g29(.a(new_n26_), .b(new_n29_), .c(new_n35_), .d(new_n25_), .O(new_n54_));
