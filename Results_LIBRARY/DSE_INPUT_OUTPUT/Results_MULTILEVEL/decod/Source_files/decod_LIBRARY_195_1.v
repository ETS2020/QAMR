...
module FAU ( 
  ...
  nand3  g25(.a(x4), .b(new_n26_), .c(new_n25_), .O(new_n49_));
  oai21  g26(.a(new_n49_), .b(new_n47_), .c(new_n31_), .O(z11));
  nand4  g27(.a(x3), .b(new_n25_), .c(new_n30_), .d(new_n42_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(new_n22_), .O(z14));
  nand4  g29(.a(new_n26_), .b(new_n25_), .c(new_n30_), .d(new_n42_), .O(new_n55_));
