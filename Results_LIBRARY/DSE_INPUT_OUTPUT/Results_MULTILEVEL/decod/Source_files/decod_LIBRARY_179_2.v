...
module FAU ( 
  ...
  nand2  g14(.a(new_n23_), .b(x1), .O(new_n36_));
  ...
  oai21  g18(.a(new_n39_), .b(new_n35_), .c(new_n36_), .O(z06));
  nand3  g19(.a(x4), .b(new_n22_), .c(new_n27_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n35_), .c(new_n36_), .O(z07));
  ...
  aoi21  g25(.a(new_n46_), .b(x4), .c(new_n32_), .O(z09));
  nand4  g26(.a(x3), .b(new_n27_), .c(x1), .d(new_n43_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n23_), .O(z10));
  nand3  g28(.a(new_n22_), .b(new_n27_), .c(new_n43_), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(x4), .c(new_n32_), .O(z11));
  ...
  nand2  g34(.a(new_n32_), .b(new_n43_), .O(new_n56_));
  oai21  g35(.a(new_n56_), .b(new_n39_), .c(new_n36_), .O(z14));
  oai21  g36(.a(new_n56_), .b(new_n41_), .c(new_n36_), .O(z15));
endmodule
