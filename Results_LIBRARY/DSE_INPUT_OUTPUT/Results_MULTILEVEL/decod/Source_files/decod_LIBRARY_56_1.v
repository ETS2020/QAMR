...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    ...
    new_n44_, new_n46_, new_n48_, new_n49_, new_n52_;
  ...
  nand3  g27(.a(x4), .b(new_n28_), .c(new_n31_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n48_), .c(new_n27_), .O(z11));
  aoi21  g29(.a(new_n42_), .b(new_n28_), .c(x1), .O(z13));
  nand3  g30(.a(x4), .b(new_n31_), .c(new_n41_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(new_n28_), .c(x1), .O(z15));
