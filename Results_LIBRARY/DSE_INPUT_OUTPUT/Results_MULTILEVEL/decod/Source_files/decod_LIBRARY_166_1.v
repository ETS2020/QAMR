...
module FAU ( 
  ...
  nand3  g15(.a(x4), .b(new_n28_), .c(x0), .O(new_n39_));
  aoi21  g16(.a(new_n39_), .b(new_n22_), .c(x1), .O(z07));
  ...
  oai21  g22(.a(new_n45_), .b(new_n44_), .c(new_n33_), .O(z09));
  nand3  g23(.a(x4), .b(new_n28_), .c(new_n41_), .O(new_n47_));
  aoi21  g24(.a(new_n47_), .b(x1), .c(new_n22_), .O(z10));
  oai21  g25(.a(new_n44_), .b(new_n34_), .c(new_n33_), .O(z11));
  inv1   g26(.a(new_n33_), .O(z12));
