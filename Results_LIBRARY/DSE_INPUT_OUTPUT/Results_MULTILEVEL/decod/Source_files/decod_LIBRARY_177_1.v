...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n37_, new_n38_, new_n46_;
  ...
  oai21  g19(.a(new_n36_), .b(new_n31_), .c(new_n38_), .O(z07));
  inv1   g20(.a(new_n38_), .O(z08));
  aoi21  g21(.a(new_n23_), .b(new_n22_), .c(x0), .O(z12));
  nand4  g22(.a(new_n25_), .b(x2), .c(new_n22_), .d(new_n37_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n33_), .O(z13));
  aoi21  g24(.a(new_n29_), .b(new_n22_), .c(x0), .O(z14));
  aoi21  g25(.a(new_n31_), .b(new_n22_), .c(x0), .O(z15));
  zero   g26(.O(z09));
  zero   g27(.O(z11));
  inv1   g28(.a(new_n38_), .O(z10));
endmodule
