...
module FAU ( 
  ...
  nand2  g15(.a(new_n33_), .b(x1), .O(new_n37_));
  ...
  nor2   g24(.a(new_n45_), .b(new_n33_), .O(z08));
  ...
  nor2   g30(.a(new_n51_), .b(new_n33_), .O(z11));
  nand4  g31(.a(x3), .b(x2), .c(new_n22_), .d(new_n44_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n33_), .O(z12));
  ...
  oai21  g36(.a(new_n57_), .b(new_n55_), .c(new_n37_), .O(z14));
  nand4  g37(.a(new_n25_), .b(new_n28_), .c(new_n22_), .d(new_n44_), .O(new_n59_));
  nor2   g38(.a(new_n59_), .b(new_n33_), .O(z15));
endmodule
