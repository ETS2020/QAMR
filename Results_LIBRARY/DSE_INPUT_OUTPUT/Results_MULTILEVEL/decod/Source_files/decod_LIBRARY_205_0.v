...
module FAU ( 
  ...
  nand4  g32(.a(x3), .b(x2), .c(new_n26_), .d(new_n44_), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n22_), .O(z12));
  nand3  g34(.a(new_n28_), .b(x2), .c(new_n44_), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(x4), .c(x1), .O(z13));
  nand4  g36(.a(x3), .b(new_n31_), .c(new_n26_), .d(new_n44_), .O(new_n58_));
  nor2   g37(.a(new_n58_), .b(new_n22_), .O(z14));
  nand4  g38(.a(new_n28_), .b(new_n31_), .c(new_n26_), .d(new_n44_), .O(new_n60_));
