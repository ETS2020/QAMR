...
module FAU ( 
  ...
  aoi21  g17(.a(new_n31_), .b(new_n26_), .c(new_n27_), .O(z09));
  nand3  g18(.a(x4), .b(x3), .c(new_n34_), .O(new_n42_));
  aoi21  g19(.a(new_n42_), .b(new_n26_), .c(new_n27_), .O(z10));
  nand3  g20(.a(x4), .b(new_n30_), .c(new_n34_), .O(new_n44_));
  aoi21  g21(.a(new_n44_), .b(new_n26_), .c(new_n27_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n33_), .O(z12));
  nand4  g24(.a(new_n30_), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n33_), .O(z13));
  ...
  oai21  g29(.a(new_n52_), .b(new_n44_), .c(new_n22_), .O(z15));
  zero   g30(.O(z01));
  zero   g31(.O(z02));
