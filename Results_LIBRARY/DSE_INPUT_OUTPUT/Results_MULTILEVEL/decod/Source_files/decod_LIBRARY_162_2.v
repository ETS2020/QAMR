...
module FAU ( 
  ...
  nand4  g14(.a(new_n26_), .b(x2), .c(new_n33_), .d(x0), .O(new_n36_));
  nor2   g15(.a(new_n36_), .b(new_n22_), .O(z05));
  nand2  g16(.a(new_n33_), .b(x0), .O(new_n38_));
  nand2  g17(.a(new_n22_), .b(x2), .O(new_n39_));
  nand3  g18(.a(x4), .b(x3), .c(new_n25_), .O(new_n40_));
  oai21  g19(.a(new_n40_), .b(new_n38_), .c(new_n39_), .O(z06));
  nand4  g20(.a(new_n26_), .b(new_n25_), .c(new_n33_), .d(x0), .O(new_n42_));
  ...
  oai21  g28(.a(new_n49_), .b(new_n40_), .c(new_n39_), .O(z10));
  nand4  g29(.a(new_n26_), .b(new_n25_), .c(x1), .d(new_n44_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n22_), .O(z11));
  nand3  g31(.a(x3), .b(new_n33_), .c(new_n44_), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(x4), .c(new_n25_), .O(z12));
  nand4  g33(.a(new_n26_), .b(x2), .c(new_n33_), .d(new_n44_), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n22_), .O(z13));
  nand4  g35(.a(x3), .b(new_n25_), .c(new_n33_), .d(new_n44_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n22_), .O(z14));
  nand4  g37(.a(new_n26_), .b(new_n25_), .c(new_n33_), .d(new_n44_), .O(new_n59_));
