...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n30_,
    ...
    new_n43_, new_n44_, new_n47_, new_n49_, new_n52_;
  ...
  nand3  g22(.a(x4), .b(new_n22_), .c(new_n30_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n43_), .c(new_n26_), .O(z07));
  inv1   g24(.a(new_n26_), .O(z08));
  nand4  g25(.a(new_n22_), .b(x2), .c(x1), .d(new_n25_), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n33_), .O(z09));
  nand4  g27(.a(new_n22_), .b(new_n30_), .c(x1), .d(new_n25_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n33_), .O(z11));
  nand4  g29(.a(new_n22_), .b(x2), .c(new_n36_), .d(new_n25_), .O(new_n52_));
  nor2   g30(.a(new_n52_), .b(new_n33_), .O(z13));
  aoi21  g31(.a(new_n41_), .b(new_n22_), .c(x0), .O(z15));
  zero   g32(.O(z12));
