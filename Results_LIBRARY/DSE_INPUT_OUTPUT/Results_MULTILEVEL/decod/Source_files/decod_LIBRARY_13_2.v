...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n35_, new_n36_, new_n39_, new_n40_, new_n43_, new_n45_,
  ...
  oai21  g17(.a(new_n40_), .b(new_n39_), .c(new_n36_), .O(z08));
  oai21  g18(.a(new_n39_), .b(new_n27_), .c(new_n36_), .O(z09));
  ...
  nand4  g28(.a(new_n26_), .b(new_n29_), .c(new_n35_), .d(new_n25_), .O(new_n52_));
