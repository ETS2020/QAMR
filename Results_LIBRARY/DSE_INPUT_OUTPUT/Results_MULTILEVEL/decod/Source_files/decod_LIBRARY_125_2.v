...
module FAU ( 
  ...
  nand4  g26(.a(x3), .b(new_n28_), .c(x1), .d(new_n43_), .O(new_n48_));
  ...
  oai21  g35(.a(new_n52_), .b(new_n39_), .c(new_n36_), .O(z14));
  nand4  g36(.a(new_n22_), .b(new_n28_), .c(new_n27_), .d(new_n43_), .O(new_n58_));
