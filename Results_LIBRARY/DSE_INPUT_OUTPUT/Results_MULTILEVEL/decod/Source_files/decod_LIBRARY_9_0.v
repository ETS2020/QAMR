...
module FAU ( 
  ...
  nand4  g24(.a(x3), .b(new_n30_), .c(x1), .d(new_n41_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n23_), .O(z10));
  nand4  g26(.a(new_n22_), .b(new_n30_), .c(x1), .d(new_n41_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n23_), .O(z11));
  nand4  g28(.a(x3), .b(x2), .c(new_n28_), .d(new_n41_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n23_), .O(z12));
  nand3  g30(.a(x4), .b(new_n30_), .c(new_n41_), .O(new_n54_));
  aoi21  g31(.a(new_n54_), .b(x3), .c(x1), .O(z14));
  zero   g32(.O(z07));
  zero   g33(.O(z13));
  inv1   g34(.a(new_n29_), .O(z15));
endmodule
