...
module FAU ( 
  ...
  nand3  g03(.a(x3), .b(x2), .c(x1), .O(new_n28_));
  aoi21  g04(.a(new_n28_), .b(new_n22_), .c(new_n23_), .O(z08));
  inv1   g05(.a(x3), .O(new_n30_));
  nand3  g06(.a(new_n30_), .b(x2), .c(x1), .O(new_n31_));
  aoi21  g07(.a(new_n31_), .b(new_n22_), .c(new_n23_), .O(z09));
  ...
  aoi21  g12(.a(new_n36_), .b(new_n22_), .c(new_n23_), .O(z11));
  inv1   g13(.a(x1), .O(new_n38_));
  nand4  g14(.a(x3), .b(x2), .c(new_n38_), .d(new_n22_), .O(new_n39_));
  ...
  nand4  g20(.a(new_n30_), .b(new_n33_), .c(new_n38_), .d(new_n22_), .O(new_n45_));
  ...
  nor2   g27(.a(new_n23_), .b(new_n22_), .O(z05));
