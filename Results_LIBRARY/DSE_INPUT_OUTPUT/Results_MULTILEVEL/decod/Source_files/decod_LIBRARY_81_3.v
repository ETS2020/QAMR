...
module FAU ( 
  ...
  aoi21  g17(.a(new_n30_), .b(new_n25_), .c(new_n26_), .O(z09));
  nand3  g18(.a(x4), .b(x3), .c(new_n33_), .O(new_n41_));
  aoi21  g19(.a(new_n41_), .b(new_n25_), .c(new_n26_), .O(z10));
  nand4  g20(.a(new_n29_), .b(new_n33_), .c(x1), .d(new_n25_), .O(new_n43_));
  ...
  oai21  g25(.a(new_n47_), .b(new_n30_), .c(new_n22_), .O(z13));
  nand4  g26(.a(x3), .b(new_n33_), .c(new_n26_), .d(new_n25_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n32_), .O(z14));
  oai21  g28(.a(new_n47_), .b(new_n36_), .c(new_n22_), .O(z15));
  zero   g29(.O(z03));
