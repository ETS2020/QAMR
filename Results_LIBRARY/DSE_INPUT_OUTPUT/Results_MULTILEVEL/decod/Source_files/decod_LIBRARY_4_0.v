...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n28_, new_n29_,
    new_n31_, new_n33_, new_n34_, new_n37_, new_n41_, new_n42_, new_n44_,
  ...
  nor2   g19(.a(new_n42_), .b(new_n33_), .O(z08));
  nand4  g20(.a(new_n28_), .b(x2), .c(x1), .d(new_n41_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n33_), .O(z09));
  nand4  g22(.a(x3), .b(new_n23_), .c(x1), .d(new_n41_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n33_), .O(z10));
  nand4  g24(.a(new_n28_), .b(new_n23_), .c(x1), .d(new_n41_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n33_), .O(z11));
  nand4  g26(.a(x3), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n33_), .O(z12));
  nand4  g28(.a(new_n28_), .b(x2), .c(new_n22_), .d(new_n41_), .O(new_n52_));
