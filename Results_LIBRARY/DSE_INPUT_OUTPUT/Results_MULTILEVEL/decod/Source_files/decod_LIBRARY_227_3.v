...
module FAU ( 
  ...
  wire new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n37_, new_n40_, new_n44_, new_n48_;
  ...
  nand3  g16(.a(x4), .b(new_n31_), .c(x2), .O(new_n40_));
  aoi21  g17(.a(new_n40_), .b(new_n26_), .c(new_n27_), .O(z09));
  ...
  oai21  g22(.a(new_n44_), .b(new_n40_), .c(new_n23_), .O(z13));
  oai21  g23(.a(new_n44_), .b(new_n35_), .c(new_n23_), .O(z14));
  nand4  g24(.a(new_n31_), .b(new_n34_), .c(new_n27_), .d(new_n26_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n30_), .O(z15));
  zero   g26(.O(z00));
  zero   g27(.O(z02));
  inv1   g28(.a(new_n23_), .O(z03));
endmodule
