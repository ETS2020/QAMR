...
module FAU ( 
  ...
  nand4  g26(.a(new_n30_), .b(x2), .c(new_n26_), .d(new_n29_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n25_), .O(z13));
  nand4  g28(.a(x3), .b(new_n33_), .c(new_n26_), .d(new_n29_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n25_), .O(z14));
  oai21  g30(.a(new_n46_), .b(new_n36_), .c(new_n22_), .O(z15));
  zero   g31(.O(z03));
