...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n36_, new_n37_, new_n39_, new_n40_, new_n42_, new_n46_,
    new_n48_, new_n51_;
  ...
  oai21  g17(.a(new_n40_), .b(new_n39_), .c(new_n37_), .O(z08));
  nand4  g18(.a(new_n26_), .b(x2), .c(x1), .d(new_n25_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n22_), .O(z09));
  oai21  g20(.a(new_n39_), .b(new_n30_), .c(new_n37_), .O(z10));
  oai21  g21(.a(new_n39_), .b(new_n32_), .c(new_n37_), .O(z11));
  nand4  g22(.a(x3), .b(x2), .c(new_n36_), .d(new_n25_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n22_), .O(z12));
  nand4  g24(.a(new_n26_), .b(x2), .c(new_n36_), .d(new_n25_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n22_), .O(z13));
  aoi21  g26(.a(new_n30_), .b(new_n25_), .c(x1), .O(z14));
  nand4  g27(.a(new_n26_), .b(new_n29_), .c(new_n36_), .d(new_n25_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n22_), .O(z15));
  zero   g29(.O(z04));
  zero   g30(.O(z05));
