...
module FAU ( 
  ...
  nand3  g15(.a(new_n25_), .b(x2), .c(new_n37_), .O(new_n40_));
  aoi21  g16(.a(new_n40_), .b(x1), .c(new_n22_), .O(z09));
  nand3  g17(.a(x3), .b(new_n28_), .c(new_n37_), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(x1), .c(new_n22_), .O(z10));
  nand3  g19(.a(new_n25_), .b(new_n28_), .c(new_n37_), .O(new_n44_));
  aoi21  g20(.a(new_n44_), .b(x1), .c(new_n22_), .O(z11));
  zero   g21(.O(z04));
  zero   g22(.O(z06));
  zero   g23(.O(z07));
  nor2   g24(.a(new_n22_), .b(x1), .O(z12));
