...
module FAU ( 
  ...
  nand4  g15(.a(x3), .b(new_n27_), .c(new_n31_), .d(x0), .O(new_n37_));
  ...
  nand3  g22(.a(x4), .b(new_n27_), .c(new_n41_), .O(new_n45_));
  aoi21  g23(.a(new_n45_), .b(new_n28_), .c(new_n31_), .O(z11));
  aoi21  g24(.a(new_n42_), .b(new_n31_), .c(new_n28_), .O(z12));
  nand2  g25(.a(new_n31_), .b(new_n41_), .O(new_n48_));
  oai21  g26(.a(new_n48_), .b(new_n35_), .c(new_n22_), .O(z13));
  aoi21  g27(.a(new_n45_), .b(new_n31_), .c(new_n28_), .O(z14));
  oai21  g28(.a(new_n48_), .b(new_n39_), .c(new_n22_), .O(z15));
  zero   g29(.O(z10));
