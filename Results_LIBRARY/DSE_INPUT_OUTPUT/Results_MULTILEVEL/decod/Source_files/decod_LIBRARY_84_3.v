...
module FAU ( 
  ...
  aoi21  g21(.a(new_n36_), .b(new_n29_), .c(new_n26_), .O(z11));
  nand2  g22(.a(new_n26_), .b(new_n29_), .O(new_n45_));
  nand3  g23(.a(x4), .b(x3), .c(x2), .O(new_n46_));
  oai21  g24(.a(new_n46_), .b(new_n45_), .c(new_n22_), .O(z12));
  nand4  g25(.a(new_n30_), .b(x2), .c(new_n26_), .d(new_n29_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n25_), .O(z13));
  nand4  g27(.a(x3), .b(new_n33_), .c(new_n26_), .d(new_n29_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n25_), .O(z14));
  nand4  g29(.a(new_n30_), .b(new_n33_), .c(new_n26_), .d(new_n29_), .O(new_n52_));
