...
module FAU ( 
  ...
  wire new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n36_, new_n37_, new_n39_, new_n43_, new_n44_, new_n46_,
  ...
  nand2  g27(.a(new_n29_), .b(new_n43_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n37_), .c(new_n23_), .O(z14));
  nand4  g29(.a(new_n30_), .b(new_n26_), .c(new_n29_), .d(new_n43_), .O(new_n54_));
