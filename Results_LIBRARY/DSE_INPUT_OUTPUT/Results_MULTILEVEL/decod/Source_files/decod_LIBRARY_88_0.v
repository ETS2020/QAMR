...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    ...
    new_n44_, new_n45_, new_n46_, new_n50_, new_n52_, new_n54_, new_n56_,
    new_n58_;
  ...
  oai21  g27(.a(new_n45_), .b(new_n32_), .c(new_n27_), .O(z10));
  nand3  g28(.a(x4), .b(new_n28_), .c(new_n31_), .O(new_n50_));
  oai21  g29(.a(new_n50_), .b(new_n45_), .c(new_n27_), .O(z11));
