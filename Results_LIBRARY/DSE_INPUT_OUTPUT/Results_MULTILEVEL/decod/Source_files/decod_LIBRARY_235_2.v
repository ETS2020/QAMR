...
module FAU ( 
  ...
  aoi21  g07(.a(new_n28_), .b(x4), .c(new_n22_), .O(z02));
  nand2  g08(.a(x1), .b(x0), .O(new_n30_));
  nand2  g09(.a(new_n23_), .b(x3), .O(new_n31_));
  ...
  oai21  g17(.a(new_n38_), .b(new_n37_), .c(new_n31_), .O(z05));
  nand3  g18(.a(new_n27_), .b(new_n34_), .c(x0), .O(new_n40_));
  aoi21  g19(.a(new_n40_), .b(x4), .c(new_n22_), .O(z06));
  oai21  g20(.a(new_n37_), .b(new_n32_), .c(new_n31_), .O(z07));
  ...
  oai21  g25(.a(new_n46_), .b(new_n38_), .c(new_n31_), .O(z09));
  ...
  nand3  g30(.a(x2), .b(new_n34_), .c(new_n43_), .O(new_n52_));
  aoi21  g31(.a(new_n52_), .b(x4), .c(new_n22_), .O(z12));
  nand4  g32(.a(new_n22_), .b(x2), .c(new_n34_), .d(new_n43_), .O(new_n54_));
  nor2   g33(.a(new_n54_), .b(new_n23_), .O(z13));
  nand4  g34(.a(x3), .b(new_n27_), .c(new_n34_), .d(new_n43_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n23_), .O(z14));
  nand2  g36(.a(new_n34_), .b(new_n43_), .O(new_n58_));
  oai21  g37(.a(new_n58_), .b(new_n32_), .c(new_n31_), .O(z15));
endmodule
