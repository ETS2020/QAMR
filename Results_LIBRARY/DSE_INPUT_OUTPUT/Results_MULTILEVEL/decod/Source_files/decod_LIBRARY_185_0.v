...
module FAU ( 
  ...
  nand2  g25(.a(new_n23_), .b(new_n22_), .O(new_n47_));
  nand3  g26(.a(x4), .b(x3), .c(new_n27_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n46_), .c(new_n47_), .O(z10));
  nand3  g28(.a(new_n27_), .b(x1), .c(new_n41_), .O(new_n50_));
  ...
  nand3  g32(.a(x2), .b(new_n32_), .c(new_n41_), .O(new_n54_));
  ...
  nand3  g36(.a(new_n27_), .b(new_n32_), .c(new_n41_), .O(new_n58_));
