...
module FAU ( 
  ...
  nand4  g14(.a(x3), .b(new_n33_), .c(new_n22_), .d(x0), .O(new_n38_));
  nor2   g15(.a(new_n38_), .b(new_n25_), .O(z06));
  nand3  g16(.a(x4), .b(new_n35_), .c(x0), .O(new_n40_));
  aoi21  g17(.a(new_n40_), .b(new_n22_), .c(x2), .O(z07));
  inv1   g18(.a(x0), .O(new_n42_));
  nand4  g19(.a(x3), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g20(.a(new_n43_), .b(new_n25_), .O(z08));
  nand3  g21(.a(x4), .b(new_n35_), .c(new_n42_), .O(new_n45_));
  aoi21  g22(.a(new_n45_), .b(x2), .c(new_n22_), .O(z09));
  inv1   g23(.a(new_n34_), .O(z10));
  nand4  g24(.a(x3), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n25_), .O(z12));
  nand4  g26(.a(new_n35_), .b(x2), .c(new_n22_), .d(new_n42_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n25_), .O(z13));
  nand4  g28(.a(x3), .b(new_n33_), .c(new_n22_), .d(new_n42_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n25_), .O(z14));
  nand4  g30(.a(new_n35_), .b(new_n33_), .c(new_n22_), .d(new_n42_), .O(new_n54_));
  nor2   g31(.a(new_n54_), .b(new_n25_), .O(z15));
  zero   g32(.O(z02));
  zero   g33(.O(z03));
  inv1   g34(.a(new_n34_), .O(z11));
endmodule
