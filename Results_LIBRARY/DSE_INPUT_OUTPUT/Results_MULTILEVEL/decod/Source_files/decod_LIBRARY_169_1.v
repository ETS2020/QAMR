...
module FAU ( 
  ...
  inv1   g23(.a(new_n32_), .O(z08));
  nand4  g24(.a(new_n22_), .b(x2), .c(x1), .d(new_n31_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n23_), .O(z09));
  aoi21  g26(.a(new_n28_), .b(new_n22_), .c(x0), .O(z11));
  nand4  g27(.a(new_n22_), .b(x2), .c(new_n35_), .d(new_n31_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n23_), .O(z13));
  aoi21  g29(.a(new_n41_), .b(new_n22_), .c(x0), .O(z15));
  inv1   g30(.a(new_n32_), .O(z10));
