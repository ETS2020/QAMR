...
module FAU ( 
  ...
  oai21  g24(.a(new_n46_), .b(new_n45_), .c(new_n34_), .O(z10));
  nand4  g25(.a(new_n30_), .b(new_n22_), .c(x1), .d(new_n40_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n25_), .O(z11));
  nand3  g27(.a(x4), .b(x3), .c(new_n40_), .O(new_n51_));
  aoi21  g28(.a(new_n51_), .b(new_n22_), .c(x1), .O(z14));
  nand4  g29(.a(new_n30_), .b(new_n22_), .c(new_n33_), .d(new_n40_), .O(new_n53_));
  nor2   g30(.a(new_n53_), .b(new_n25_), .O(z15));
  zero   g31(.O(z05));
  zero   g32(.O(z12));
  inv1   g33(.a(new_n34_), .O(z13));
endmodule
