...
module FAU ( 
  ...
  nand4  g13(.a(new_n22_), .b(x2), .c(new_n34_), .d(x0), .O(new_n35_));
  nor2   g14(.a(new_n35_), .b(new_n23_), .O(z05));
  nand3  g15(.a(x4), .b(x3), .c(new_n27_), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(x0), .c(x1), .O(z06));
  nand4  g17(.a(new_n22_), .b(new_n27_), .c(new_n34_), .d(x0), .O(new_n39_));
  nor2   g18(.a(new_n39_), .b(new_n23_), .O(z07));
  aoi21  g19(.a(new_n32_), .b(x1), .c(x0), .O(z08));
  inv1   g20(.a(x0), .O(new_n42_));
  nand4  g21(.a(new_n22_), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  nor2   g22(.a(new_n43_), .b(new_n23_), .O(z09));
  aoi21  g23(.a(new_n37_), .b(x1), .c(x0), .O(z10));
  nand4  g24(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n42_), .O(new_n46_));
  nor2   g25(.a(new_n46_), .b(new_n23_), .O(z11));
  nor2   g26(.a(x1), .b(x0), .O(z12));
  zero   g27(.O(z14));
  zero   g28(.O(z15));
  nor2   g29(.a(x1), .b(x0), .O(z13));
endmodule
