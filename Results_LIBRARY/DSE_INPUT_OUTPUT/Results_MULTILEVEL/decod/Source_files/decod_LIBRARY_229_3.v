...
module FAU ( 
  ...
  nand4  g03(.a(x3), .b(x2), .c(new_n24_), .d(x0), .O(new_n27_));
  nor2   g04(.a(new_n27_), .b(new_n25_), .O(z04));
  ...
  aoi21  g15(.a(new_n40_), .b(new_n24_), .c(new_n25_), .O(z12));
  nand4  g16(.a(new_n29_), .b(x2), .c(new_n24_), .d(new_n39_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(new_n25_), .O(z13));
  nand4  g18(.a(x3), .b(new_n32_), .c(new_n24_), .d(new_n39_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n25_), .O(z14));
  ...
  nor2   g28(.a(new_n25_), .b(new_n24_), .O(z10));
endmodule
