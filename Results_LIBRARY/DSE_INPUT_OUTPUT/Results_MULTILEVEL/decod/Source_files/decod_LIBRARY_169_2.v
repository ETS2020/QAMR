...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n36_, new_n39_, new_n40_, new_n42_, new_n44_,
    new_n47_, new_n49_;
  ...
  nand2  g15(.a(x1), .b(new_n26_), .O(new_n39_));
  nand3  g16(.a(x4), .b(x3), .c(x2), .O(new_n40_));
  oai21  g17(.a(new_n40_), .b(new_n39_), .c(new_n31_), .O(z08));
  nand4  g18(.a(new_n30_), .b(x2), .c(x1), .d(new_n26_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n22_), .O(z09));
  nand3  g20(.a(x4), .b(x3), .c(new_n27_), .O(new_n44_));
  oai21  g21(.a(new_n44_), .b(new_n39_), .c(new_n31_), .O(z10));
  aoi21  g22(.a(new_n28_), .b(new_n26_), .c(x3), .O(z11));
  nand2  g23(.a(new_n33_), .b(new_n26_), .O(new_n47_));
  oai21  g24(.a(new_n47_), .b(new_n40_), .c(new_n31_), .O(z12));
  nand4  g25(.a(new_n30_), .b(x2), .c(new_n33_), .d(new_n26_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n22_), .O(z13));
  oai21  g27(.a(new_n47_), .b(new_n44_), .c(new_n31_), .O(z14));
  aoi21  g28(.a(new_n36_), .b(new_n26_), .c(x3), .O(z15));
  zero   g29(.O(z01));
  zero   g30(.O(z07));
