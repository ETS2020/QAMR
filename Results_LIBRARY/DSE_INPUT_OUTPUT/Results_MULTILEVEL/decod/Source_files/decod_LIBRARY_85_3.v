...
module FAU ( 
  ...
  nor2   g10(.a(new_n23_), .b(new_n28_), .O(z06));
  nand4  g11(.a(new_n28_), .b(new_n27_), .c(new_n32_), .d(x0), .O(new_n36_));
  nor2   g12(.a(new_n36_), .b(new_n23_), .O(z07));
  inv1   g13(.a(x0), .O(new_n38_));
  nand3  g14(.a(x2), .b(x1), .c(new_n38_), .O(new_n39_));
  aoi21  g15(.a(new_n39_), .b(new_n28_), .c(new_n23_), .O(z09));
  nand3  g16(.a(new_n27_), .b(x1), .c(new_n38_), .O(new_n41_));
  aoi21  g17(.a(new_n41_), .b(new_n28_), .c(new_n23_), .O(z11));
  nand4  g18(.a(new_n28_), .b(x2), .c(new_n32_), .d(new_n38_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n23_), .O(z13));
  nand3  g20(.a(new_n27_), .b(new_n32_), .c(new_n38_), .O(new_n47_));
  aoi21  g21(.a(new_n47_), .b(new_n28_), .c(new_n23_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z02));
  zero   g24(.O(z04));
  zero   g25(.O(z12));
  zero   g26(.O(z14));
  nor2   g27(.a(new_n23_), .b(new_n28_), .O(z08));
  nor2   g28(.a(new_n23_), .b(new_n28_), .O(z10));
endmodule
