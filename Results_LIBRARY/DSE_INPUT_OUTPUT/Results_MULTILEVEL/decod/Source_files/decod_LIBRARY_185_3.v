...
module FAU ( 
  ...
  nor2   g09(.a(new_n33_), .b(new_n23_), .O(z05));
  nand4  g10(.a(new_n28_), .b(new_n27_), .c(new_n32_), .d(x0), .O(new_n36_));
  nor2   g11(.a(new_n36_), .b(new_n23_), .O(z07));
  inv1   g12(.a(x0), .O(new_n39_));
  nand4  g13(.a(new_n28_), .b(x2), .c(x1), .d(new_n39_), .O(new_n40_));
  nor2   g14(.a(new_n40_), .b(new_n23_), .O(z09));
  nor2   g15(.a(new_n23_), .b(new_n28_), .O(z10));
  ...
  aoi21  g19(.a(new_n46_), .b(new_n28_), .c(new_n23_), .O(z13));
