...
module FAU ( 
  ...
  oai21  g29(.a(new_n50_), .b(new_n41_), .c(new_n36_), .O(z11));
  nand4  g30(.a(x3), .b(x2), .c(new_n32_), .d(new_n43_), .O(new_n52_));
  nor2   g31(.a(new_n52_), .b(new_n23_), .O(z12));
  nand2  g32(.a(new_n32_), .b(new_n43_), .O(new_n54_));
  oai21  g33(.a(new_n54_), .b(new_n37_), .c(new_n36_), .O(z13));
  nand3  g34(.a(new_n27_), .b(new_n32_), .c(new_n43_), .O(new_n56_));
  aoi21  g35(.a(new_n56_), .b(x4), .c(new_n22_), .O(z14));
  oai21  g36(.a(new_n54_), .b(new_n41_), .c(new_n36_), .O(z15));
endmodule
