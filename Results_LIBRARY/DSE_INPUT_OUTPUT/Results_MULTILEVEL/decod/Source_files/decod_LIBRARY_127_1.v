...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n34_, new_n35_, new_n38_, new_n40_, new_n42_;
  ...
  nand4  g15(.a(x3), .b(new_n26_), .c(x1), .d(new_n34_), .O(new_n38_));
  nor2   g16(.a(new_n38_), .b(new_n22_), .O(z10));
  nand4  g17(.a(x3), .b(x2), .c(new_n29_), .d(new_n34_), .O(new_n40_));
  nor2   g18(.a(new_n40_), .b(new_n22_), .O(z12));
  nand3  g19(.a(new_n26_), .b(new_n29_), .c(new_n34_), .O(new_n42_));
  aoi21  g20(.a(new_n42_), .b(x3), .c(new_n22_), .O(z14));
  zero   g21(.O(z09));
  zero   g22(.O(z15));
  nor2   g23(.a(new_n22_), .b(x3), .O(z03));
