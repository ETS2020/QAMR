...
module FAU ( 
  ...
  nand4  g28(.a(new_n26_), .b(new_n25_), .c(x1), .d(new_n43_), .O(new_n50_));
  ...
  nand4  g34(.a(x3), .b(new_n25_), .c(new_n35_), .d(new_n43_), .O(new_n56_));
  nor2   g35(.a(new_n56_), .b(new_n22_), .O(z14));
  nand4  g36(.a(new_n26_), .b(new_n25_), .c(new_n35_), .d(new_n43_), .O(new_n58_));
