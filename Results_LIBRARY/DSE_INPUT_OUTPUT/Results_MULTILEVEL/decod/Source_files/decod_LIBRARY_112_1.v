...
module FAU ( 
  ...
  aoi21  g12(.a(new_n33_), .b(x0), .c(new_n23_), .O(z04));
  ...
  nor2   g19(.a(new_n23_), .b(x0), .O(z08));
  zero   g20(.O(z09));
  zero   g21(.O(z15));
  nor2   g22(.a(new_n23_), .b(x0), .O(z10));
  nor2   g23(.a(new_n23_), .b(x0), .O(z11));
  nor2   g24(.a(new_n23_), .b(x0), .O(z12));
  nor2   g25(.a(new_n23_), .b(x0), .O(z13));
  nor2   g26(.a(new_n23_), .b(x0), .O(z14));
endmodule
