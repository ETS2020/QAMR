...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n61_, new_n62_, new_n63_, new_n65_, new_n69_, new_n70_, new_n71_,
  ...
  aoi21  g23(.a(new_n56_), .b(new_n45_), .c(new_n44_), .O(z07));
  ...
  nand4  g32(.a(new_n76_), .b(new_n52_), .c(x17), .d(new_n69_), .O(new_n77_));
  nor2   g33(.a(new_n77_), .b(new_n53_), .O(z08));
  nand2  g34(.a(new_n53_), .b(x18), .O(new_n79_));
  ...
  oai21  g39(.a(new_n83_), .b(new_n79_), .c(new_n44_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(x01), .O(new_n85_));
  nor2   g41(.a(new_n56_), .b(x01), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n44_), .O(new_n87_));
  inv1   g43(.a(x13), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(x12), .O(new_n89_));
  nor3   g45(.a(new_n89_), .b(new_n87_), .c(x11), .O(new_n90_));
  nor3   g46(.a(x16), .b(x15), .c(x14), .O(new_n91_));
  nand3  g47(.a(new_n82_), .b(new_n81_), .c(x20), .O(new_n92_));
  inv1   g48(.a(new_n92_), .O(new_n93_));
  nand3  g49(.a(new_n93_), .b(new_n91_), .c(new_n90_), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n85_), .O(z09));
  nand3  g51(.a(x22), .b(x21), .c(new_n80_), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n79_), .c(new_n44_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(x01), .O(new_n98_));
  nand2  g54(.a(x16), .b(x15), .O(new_n99_));
  nor3   g55(.a(new_n99_), .b(new_n92_), .c(x14), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n90_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n98_), .O(z10));
  nand3  g58(.a(new_n82_), .b(x21), .c(new_n80_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n79_), .c(new_n44_), .O(new_n104_));
  ...
  nand4  g64(.a(new_n108_), .b(new_n93_), .c(new_n90_), .d(new_n106_), .O(new_n109_));
  ...
  nand3  g73(.a(x19), .b(new_n56_), .c(new_n45_), .O(new_n118_));
  oai21  g74(.a(new_n86_), .b(new_n44_), .c(new_n118_), .O(z15));
