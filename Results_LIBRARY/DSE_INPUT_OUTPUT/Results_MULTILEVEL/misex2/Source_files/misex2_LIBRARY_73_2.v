...
module FAU ( 
  ...
  aoi21  g31(.a(new_n74_), .b(x01), .c(new_n73_), .O(z06));
  ...
  nand4  g38(.a(new_n81_), .b(x02), .c(new_n59_), .d(new_n73_), .O(new_n82_));
  ...
  oai21  g52(.a(new_n95_), .b(new_n89_), .c(new_n73_), .O(new_n96_));
  nand2  g53(.a(new_n96_), .b(new_n59_), .O(new_n97_));
  nor2   g54(.a(new_n45_), .b(new_n59_), .O(new_n98_));
  nor2   g55(.a(x20), .b(x19), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n98_), .c(new_n92_), .d(new_n73_), .O(new_n100_));
  ...
  nor2   g63(.a(new_n60_), .b(x01), .O(new_n107_));
  ...
  nand3  g70(.a(new_n113_), .b(new_n98_), .c(new_n64_), .O(new_n114_));
  ...
  nand3  g74(.a(new_n117_), .b(new_n103_), .c(new_n73_), .O(new_n118_));
  inv1   g75(.a(new_n118_), .O(z11));
  inv1   g76(.a(x24), .O(new_n120_));
  aoi21  g77(.a(x10), .b(x02), .c(new_n73_), .O(new_n121_));
  oai21  g78(.a(x19), .b(x02), .c(x23), .O(new_n122_));
  nand3  g79(.a(new_n64_), .b(x17), .c(new_n60_), .O(new_n123_));
  aoi21  g80(.a(new_n123_), .b(new_n122_), .c(x01), .O(new_n124_));
  oai21  g81(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n125_));
  oai22  g82(.a(new_n125_), .b(new_n46_), .c(x01), .d(new_n73_), .O(z12));
  ...
  nand4  g89(.a(x19), .b(new_n60_), .c(new_n59_), .d(new_n73_), .O(new_n133_));
  nand2  g90(.a(new_n133_), .b(new_n132_), .O(z15));
  nor2   g91(.a(new_n59_), .b(x00), .O(z16));
  aoi21  g92(.a(new_n60_), .b(new_n73_), .c(x01), .O(z17));
endmodule
