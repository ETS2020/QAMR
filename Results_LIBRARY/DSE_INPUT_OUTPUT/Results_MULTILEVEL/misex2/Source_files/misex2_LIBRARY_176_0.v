...
module FAU ( 
  ...
  nand4  g023(.a(new_n66_), .b(new_n58_), .c(x18), .d(new_n51_), .O(new_n67_));
  ...
  oai21  g032(.a(new_n75_), .b(new_n68_), .c(new_n46_), .O(z04));
  ...
  nand3  g036(.a(x11), .b(x10), .c(new_n48_), .O(new_n80_));
  oai21  g037(.a(new_n80_), .b(new_n68_), .c(new_n46_), .O(z06));
  nand3  g038(.a(new_n70_), .b(new_n74_), .c(x11), .O(new_n82_));
  ...
  nor2   g059(.a(new_n57_), .b(new_n55_), .O(new_n103_));
  nand3  g060(.a(new_n103_), .b(new_n45_), .c(new_n58_), .O(new_n104_));
  ...
  nand3  g064(.a(new_n58_), .b(x18), .c(x01), .O(new_n108_));
  nand3  g065(.a(x22), .b(x21), .c(new_n45_), .O(new_n109_));
  nor2   g066(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g067(.a(x02), .b(new_n55_), .O(new_n111_));
  ...
  nand4  g077(.a(new_n97_), .b(new_n112_), .c(x12), .d(new_n73_), .O(new_n121_));
  nand4  g078(.a(new_n103_), .b(x21), .c(new_n45_), .d(new_n58_), .O(new_n122_));
  ...
  nand3  g088(.a(new_n58_), .b(x17), .c(new_n47_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n55_), .c(new_n94_), .O(new_n134_));
  ...
  nand3  g095(.a(new_n52_), .b(new_n51_), .c(new_n56_), .O(new_n139_));
  oai21  g096(.a(new_n139_), .b(new_n50_), .c(new_n46_), .O(z14));
  inv1   g097(.a(new_n46_), .O(new_n141_));
  oai21  g098(.a(x10), .b(new_n55_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n47_), .c(new_n55_), .O(new_n144_));
  aoi21  g101(.a(new_n144_), .b(new_n143_), .c(new_n141_), .O(z15));
  nor3   g102(.a(new_n141_), .b(new_n55_), .c(x00), .O(z16));
  oai21  g103(.a(new_n111_), .b(x00), .c(new_n46_), .O(z17));
endmodule
