...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n53_,
    ...
    new_n74_, new_n76_, new_n78_, new_n79_, new_n83_, new_n84_;
  ...
  nand3  g14(.a(x11), .b(x10), .c(new_n47_), .O(new_n58_));
  oai21  g15(.a(new_n58_), .b(new_n57_), .c(new_n53_), .O(z06));
  inv1   g16(.a(x00), .O(z16));
  nor2   g17(.a(x02), .b(z16), .O(new_n61_));
  nand3  g18(.a(new_n47_), .b(x02), .c(x00), .O(new_n62_));
  nand3  g19(.a(new_n46_), .b(x11), .c(x10), .O(new_n63_));
  ...
  nand4  g29(.a(new_n71_), .b(x22), .c(x21), .d(new_n66_), .O(new_n74_));
  inv1   g30(.a(new_n74_), .O(z10));
  nand4  g31(.a(new_n71_), .b(new_n68_), .c(x21), .d(new_n66_), .O(new_n76_));
  inv1   g32(.a(new_n76_), .O(z11));
  aoi21  g33(.a(x10), .b(x02), .c(x24), .O(new_n78_));
  nand4  g34(.a(new_n78_), .b(x09), .c(x01), .d(x00), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n53_), .O(z12));
