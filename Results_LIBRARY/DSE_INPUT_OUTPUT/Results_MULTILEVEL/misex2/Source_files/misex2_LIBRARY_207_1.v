...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n49_, new_n50_, new_n51_,
    ...
    new_n128_, new_n130_, new_n132_, new_n134_, new_n137_;
  ...
  nand4  g17(.a(x18), .b(new_n49_), .c(new_n53_), .d(new_n51_), .O(new_n61_));
  ...
  nand2  g24(.a(x19), .b(new_n52_), .O(new_n68_));
  ...
  oai21  g34(.a(new_n77_), .b(new_n64_), .c(new_n68_), .O(z06));
  nand2  g35(.a(new_n76_), .b(x01), .O(new_n79_));
  nand3  g36(.a(new_n70_), .b(x11), .c(x10), .O(new_n80_));
  oai22  g37(.a(new_n80_), .b(new_n79_), .c(x19), .d(x01), .O(new_n81_));
  nand3  g38(.a(new_n81_), .b(x02), .c(x00), .O(new_n82_));
  inv1   g39(.a(new_n82_), .O(z07));
  inv1   g40(.a(x21), .O(new_n85_));
  inv1   g41(.a(x22), .O(new_n86_));
  nand4  g42(.a(x12), .b(new_n69_), .c(x02), .d(new_n52_), .O(new_n87_));
  ...
  nand3  g49(.a(new_n93_), .b(new_n92_), .c(new_n44_), .O(new_n94_));
  oai21  g50(.a(new_n91_), .b(new_n87_), .c(new_n94_), .O(new_n95_));
  nand4  g51(.a(new_n95_), .b(new_n86_), .c(new_n85_), .d(new_n51_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n68_), .O(z09));
  nand3  g53(.a(new_n44_), .b(x18), .c(x01), .O(new_n98_));
  nand3  g54(.a(x22), .b(x21), .c(new_n92_), .O(new_n99_));
  nor2   g55(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g56(.a(x02), .b(new_n52_), .O(new_n101_));
  ...
  oai21  g65(.a(new_n109_), .b(x00), .c(new_n68_), .O(z10));
  nor2   g66(.a(new_n53_), .b(x01), .O(new_n111_));
  nor2   g67(.a(x13), .b(new_n70_), .O(new_n112_));
  nand3  g68(.a(new_n112_), .b(new_n111_), .c(new_n69_), .O(new_n113_));
  nand4  g69(.a(new_n93_), .b(x21), .c(new_n92_), .d(new_n44_), .O(new_n114_));
  ...
  nand3  g74(.a(new_n118_), .b(new_n86_), .c(new_n51_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n68_), .O(z11));
  ...
  oai21  g80(.a(new_n49_), .b(x02), .c(new_n124_), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(new_n52_), .c(new_n51_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n121_), .c(x09), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n68_), .O(z12));
  nand3  g85(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n130_));
  nor3   g86(.a(new_n130_), .b(x19), .c(new_n49_), .O(z13));
  nand3  g87(.a(new_n46_), .b(new_n45_), .c(new_n58_), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g89(.a(new_n58_), .b(x01), .c(new_n53_), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n51_), .c(new_n68_), .O(z15));
  oai21  g91(.a(new_n52_), .b(x00), .c(new_n68_), .O(z16));
  nand2  g92(.a(x02), .b(new_n51_), .O(new_n137_));
  aoi21  g93(.a(new_n137_), .b(new_n44_), .c(x01), .O(z17));
  zero   g94(.O(z08));
endmodule
