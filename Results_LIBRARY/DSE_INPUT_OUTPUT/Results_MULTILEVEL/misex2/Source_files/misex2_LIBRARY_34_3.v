...
module FAU ( 
  ...
  nand3  g23(.a(x02), .b(new_n62_), .c(x00), .O(new_n68_));
  inv1   g24(.a(new_n68_), .O(z07));
  inv1   g25(.a(x03), .O(new_n70_));
  nor2   g26(.a(new_n46_), .b(x01), .O(new_n71_));
  inv1   g27(.a(x04), .O(new_n72_));
  nor2   g28(.a(x05), .b(new_n72_), .O(new_n73_));
  nand4  g29(.a(new_n73_), .b(new_n71_), .c(new_n70_), .d(new_n61_), .O(new_n74_));
  nor3   g30(.a(x08), .b(x07), .c(x06), .O(new_n75_));
  nand4  g31(.a(new_n75_), .b(x19), .c(new_n45_), .d(x17), .O(new_n76_));
  oai21  g32(.a(new_n76_), .b(new_n74_), .c(new_n53_), .O(z08));
  inv1   g33(.a(x21), .O(new_n78_));
  inv1   g34(.a(x22), .O(new_n79_));
  inv1   g35(.a(x11), .O(new_n80_));
  nand4  g36(.a(x12), .b(new_n80_), .c(x02), .d(new_n62_), .O(new_n81_));
  inv1   g37(.a(x15), .O(new_n82_));
  inv1   g38(.a(x16), .O(new_n83_));
  nor2   g39(.a(x14), .b(x13), .O(new_n84_));
  nand4  g40(.a(new_n84_), .b(x20), .c(new_n83_), .d(new_n82_), .O(new_n85_));
  inv1   g41(.a(x20), .O(new_n86_));
  and2   g42(.a(x18), .b(x01), .O(new_n87_));
  nand3  g43(.a(new_n87_), .b(new_n86_), .c(new_n55_), .O(new_n88_));
  oai21  g44(.a(new_n85_), .b(new_n81_), .c(new_n88_), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n79_), .c(new_n78_), .d(new_n61_), .O(new_n90_));
  inv1   g46(.a(new_n90_), .O(z09));
  nor3   g47(.a(new_n79_), .b(new_n78_), .c(x20), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n55_), .c(x18), .d(x01), .O(new_n93_));
  inv1   g49(.a(x13), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(x12), .c(new_n80_), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(new_n96_));
  nor3   g52(.a(new_n83_), .b(new_n82_), .c(x14), .O(new_n97_));
  nand3  g53(.a(new_n79_), .b(new_n78_), .c(x20), .O(new_n98_));
  inv1   g54(.a(new_n98_), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n97_), .c(new_n96_), .d(new_n71_), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(new_n93_), .c(x00), .O(z10));
  inv1   g57(.a(x12), .O(new_n102_));
  nor2   g58(.a(x13), .b(new_n102_), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n71_), .c(new_n80_), .O(new_n104_));
  nand4  g60(.a(new_n87_), .b(x21), .c(new_n86_), .d(new_n55_), .O(new_n105_));
  nor2   g61(.a(new_n82_), .b(x14), .O(new_n106_));
  nor2   g62(.a(x21), .b(new_n86_), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(new_n106_), .c(new_n83_), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n104_), .c(new_n105_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n79_), .c(new_n61_), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(z11));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n112_));
  nand3  g68(.a(new_n55_), .b(x17), .c(new_n46_), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n112_), .c(x24), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(x09), .c(new_n62_), .O(new_n115_));
  nor2   g71(.a(new_n115_), .b(x00), .O(z12));
  nand3  g72(.a(new_n48_), .b(x17), .c(new_n46_), .O(new_n117_));
  nor2   g73(.a(new_n117_), .b(x19), .O(z13));
  nand4  g74(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n119_));
  nor2   g75(.a(new_n119_), .b(x19), .O(z14));
  nor2   g76(.a(x19), .b(x00), .O(new_n121_));
  nor3   g77(.a(new_n121_), .b(x02), .c(x01), .O(z15));
  nand2  g78(.a(new_n48_), .b(x02), .O(new_n123_));
  inv1   g79(.a(new_n123_), .O(z17));
  zero   g80(.O(z05));
  inv1   g81(.a(new_n53_), .O(z06));
  buf    g82(.a(x01), .O(z16));
endmodule
