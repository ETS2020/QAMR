...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n143_, new_n144_, new_n146_, new_n147_;
  ...
  nand4  g013(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(x10), .O(new_n57_));
  inv1   g014(.a(new_n57_), .O(new_n58_));
  nand4  g015(.a(new_n58_), .b(x09), .c(new_n50_), .d(new_n48_), .O(new_n59_));
  aoi21  g016(.a(new_n59_), .b(new_n56_), .c(x01), .O(z01));
  nand3  g017(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n61_));
  nor3   g018(.a(new_n61_), .b(x10), .c(new_n51_), .O(new_n62_));
  nand4  g019(.a(new_n62_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n63_));
  nor2   g020(.a(new_n63_), .b(x24), .O(z02));
  nand2  g021(.a(new_n50_), .b(new_n48_), .O(new_n65_));
  nand3  g022(.a(new_n46_), .b(x18), .c(new_n44_), .O(new_n66_));
  oai21  g023(.a(new_n66_), .b(new_n65_), .c(new_n56_), .O(new_n67_));
  nand2  g024(.a(new_n67_), .b(new_n49_), .O(new_n68_));
  nand3  g025(.a(x02), .b(x01), .c(x00), .O(new_n69_));
  nand4  g026(.a(x12), .b(x11), .c(x10), .d(new_n51_), .O(new_n70_));
  ...
  nand4  g031(.a(new_n74_), .b(new_n72_), .c(x10), .d(new_n51_), .O(new_n75_));
  nor2   g032(.a(new_n75_), .b(x12), .O(z04));
  nand2  g033(.a(x01), .b(x00), .O(new_n77_));
  nand2  g034(.a(x24), .b(new_n49_), .O(new_n78_));
  ...
  oai21  g038(.a(new_n81_), .b(new_n69_), .c(new_n78_), .O(z06));
  nand2  g039(.a(new_n51_), .b(x01), .O(new_n83_));
  inv1   g040(.a(x12), .O(new_n84_));
  nand3  g041(.a(new_n84_), .b(x11), .c(x10), .O(new_n85_));
  oai22  g042(.a(new_n85_), .b(new_n83_), .c(x24), .d(x01), .O(new_n86_));
  ...
  nor2   g050(.a(new_n46_), .b(x18), .O(new_n94_));
  nand4  g051(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(x17), .O(new_n95_));
  aoi21  g052(.a(new_n95_), .b(new_n56_), .c(x01), .O(z08));
  inv1   g053(.a(x21), .O(new_n97_));
  inv1   g054(.a(x22), .O(new_n98_));
  nand4  g055(.a(x12), .b(new_n72_), .c(x02), .d(new_n49_), .O(new_n99_));
  ...
  nand3  g062(.a(new_n105_), .b(new_n104_), .c(new_n46_), .O(new_n106_));
  oai21  g063(.a(new_n103_), .b(new_n99_), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n98_), .c(new_n97_), .d(new_n48_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n78_), .O(z09));
  nand3  g066(.a(new_n46_), .b(x18), .c(x01), .O(new_n110_));
  nand3  g067(.a(x22), .b(x21), .c(new_n104_), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g069(.a(x02), .b(new_n49_), .O(new_n113_));
  ...
  nor2   g079(.a(new_n50_), .b(x01), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n114_), .c(x12), .d(new_n72_), .O(new_n124_));
  nand4  g081(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n46_), .O(new_n125_));
  nor2   g082(.a(x16), .b(new_n100_), .O(new_n126_));
  nor2   g083(.a(x24), .b(x21), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(new_n126_), .c(x20), .d(new_n117_), .O(new_n128_));
  oai21  g085(.a(new_n128_), .b(new_n124_), .c(new_n125_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(new_n98_), .c(new_n48_), .O(new_n130_));
  ...
  nand3  g095(.a(new_n138_), .b(new_n56_), .c(x09), .O(new_n139_));
  inv1   g096(.a(new_n139_), .O(z12));
  nand4  g097(.a(new_n46_), .b(x17), .c(new_n50_), .d(new_n48_), .O(new_n141_));
  aoi21  g098(.a(new_n141_), .b(new_n56_), .c(x01), .O(z13));
  nor2   g099(.a(new_n52_), .b(x10), .O(new_n143_));
  nand4  g100(.a(new_n143_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n144_));
  nor2   g101(.a(new_n144_), .b(x24), .O(z14));
  aoi21  g102(.a(new_n47_), .b(x01), .c(new_n50_), .O(new_n146_));
  aoi21  g103(.a(x19), .b(new_n50_), .c(x24), .O(new_n147_));
  oai22  g104(.a(new_n147_), .b(x01), .c(new_n146_), .d(new_n48_), .O(z15));
  oai21  g105(.a(new_n49_), .b(x00), .c(new_n78_), .O(z16));
  aoi21  g106(.a(new_n89_), .b(new_n56_), .c(x01), .O(z17));
endmodule
