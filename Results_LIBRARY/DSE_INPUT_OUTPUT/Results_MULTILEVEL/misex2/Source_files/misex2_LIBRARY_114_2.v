...
module FAU ( 
  ...
  aoi21  g031(.a(new_n74_), .b(x05), .c(new_n47_), .O(z04));
  nand4  g032(.a(x05), .b(x02), .c(x01), .d(x00), .O(new_n76_));
  nor3   g033(.a(new_n76_), .b(new_n61_), .c(new_n49_), .O(z05));
  nor2   g034(.a(new_n48_), .b(new_n46_), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x11), .c(x10), .d(new_n49_), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(x05), .c(new_n47_), .O(z06));
  nand2  g037(.a(new_n49_), .b(x05), .O(new_n81_));
  ...
  nand4  g045(.a(new_n88_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n89_));
  inv1   g046(.a(new_n89_), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n87_), .c(new_n44_), .d(x04), .O(new_n91_));
  ...
  nand3  g064(.a(x18), .b(x05), .c(x01), .O(new_n108_));
  ...
  nand3  g074(.a(new_n117_), .b(new_n109_), .c(new_n53_), .O(new_n118_));
  ...
  nand3  g083(.a(new_n53_), .b(x17), .c(new_n48_), .O(new_n127_));
  ...
  nand2  g088(.a(new_n131_), .b(new_n45_), .O(z12));
  nand2  g089(.a(new_n56_), .b(x17), .O(new_n133_));
  nor2   g090(.a(new_n133_), .b(x19), .O(z13));
  nand2  g091(.a(new_n56_), .b(new_n49_), .O(new_n135_));
  inv1   g092(.a(new_n135_), .O(new_n136_));
  nand4  g093(.a(new_n136_), .b(new_n52_), .c(new_n51_), .d(new_n61_), .O(new_n137_));
  ...
  nand3  g099(.a(x05), .b(x01), .c(new_n46_), .O(new_n143_));
  inv1   g100(.a(new_n143_), .O(z16));
  nand2  g101(.a(new_n97_), .b(new_n46_), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(new_n45_), .O(z17));
endmodule
