...
module FAU ( 
  ...
  nor3   g030(.a(new_n73_), .b(new_n57_), .c(new_n47_), .O(z05));
  ...
  aoi21  g034(.a(new_n77_), .b(x06), .c(new_n67_), .O(z06));
  ...
  nand4  g043(.a(new_n86_), .b(x02), .c(new_n67_), .d(new_n75_), .O(new_n87_));
  inv1   g044(.a(new_n87_), .O(new_n88_));
  nand4  g045(.a(new_n88_), .b(new_n44_), .c(new_n85_), .d(x04), .O(new_n89_));
  ...
  nand4  g060(.a(new_n103_), .b(new_n94_), .c(new_n93_), .d(new_n75_), .O(new_n104_));
  ...
  nand3  g077(.a(x21), .b(new_n107_), .c(new_n52_), .O(new_n121_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n94_), .c(new_n75_), .O(new_n125_));
  inv1   g082(.a(new_n125_), .O(z11));
  nand2  g083(.a(x10), .b(x02), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(x06), .c(x01), .d(x00), .O(new_n128_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n67_), .c(new_n75_), .O(new_n132_));
  ...
  aoi22  g098(.a(new_n45_), .b(x00), .c(x19), .d(new_n67_), .O(new_n142_));
  nand4  g099(.a(new_n57_), .b(x06), .c(x01), .d(x00), .O(new_n143_));
  oai21  g100(.a(new_n142_), .b(x02), .c(new_n143_), .O(z15));
  nand3  g101(.a(x06), .b(x01), .c(new_n75_), .O(new_n145_));
