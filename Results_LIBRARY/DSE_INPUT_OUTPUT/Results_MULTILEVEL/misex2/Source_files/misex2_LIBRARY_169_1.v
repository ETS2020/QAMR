...
module FAU ( 
  ...
  nand4  g50(.a(new_n67_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n94_));
  ...
  nand3  g56(.a(new_n93_), .b(new_n92_), .c(x12), .O(new_n100_));
  nor3   g57(.a(new_n100_), .b(x11), .c(new_n45_), .O(new_n101_));
  inv1   g58(.a(x22), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n91_), .c(x20), .O(new_n103_));
  ...
  nand4  g63(.a(new_n104_), .b(new_n101_), .c(new_n90_), .d(x15), .O(new_n107_));
  ...
  nand3  g70(.a(new_n113_), .b(new_n44_), .c(new_n52_), .O(new_n114_));
  ...
  nand4  g75(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n52_), .O(new_n119_));
  inv1   g76(.a(new_n119_), .O(new_n120_));
  nand4  g77(.a(new_n120_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n121_));
  nor2   g78(.a(new_n121_), .b(x19), .O(z14));
  oai21  g79(.a(new_n57_), .b(new_n52_), .c(x01), .O(new_n123_));
  oai21  g80(.a(x19), .b(x00), .c(new_n45_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n123_), .O(z15));
  nand3  g82(.a(x02), .b(new_n44_), .c(new_n52_), .O(new_n127_));
