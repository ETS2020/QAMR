...
module FAU ( 
  ...
  nand4  g49(.a(new_n92_), .b(x02), .c(new_n44_), .d(new_n60_), .O(new_n93_));
  ...
  nand3  g59(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n103_));
  nor3   g60(.a(new_n103_), .b(x11), .c(new_n45_), .O(new_n104_));
  nor2   g61(.a(x16), .b(new_n99_), .O(new_n105_));
  nor2   g62(.a(x22), .b(x21), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(x20), .O(new_n107_));
  ...
  nand3  g84(.a(x02), .b(new_n44_), .c(new_n60_), .O(new_n128_));
