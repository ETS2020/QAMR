...
module FAU ( 
  ...
  nor4   g35(.a(new_n66_), .b(new_n72_), .c(new_n58_), .d(x09), .O(z06));
  ...
  nor2   g44(.a(new_n53_), .b(x01), .O(new_n88_));
  ...
  nor3   g59(.a(new_n80_), .b(new_n53_), .c(x01), .O(new_n103_));
  ...
  nand4  g68(.a(new_n96_), .b(x21), .c(new_n95_), .d(new_n62_), .O(new_n112_));
  ...
  nand3  g73(.a(new_n116_), .b(new_n87_), .c(new_n51_), .O(new_n117_));
  inv1   g74(.a(new_n117_), .O(z11));
  inv1   g75(.a(x24), .O(new_n119_));
  aoi21  g76(.a(x10), .b(x02), .c(new_n52_), .O(new_n120_));
  ...
  nand4  g81(.a(new_n124_), .b(x07), .c(new_n52_), .d(new_n51_), .O(new_n125_));
  ...
  aoi21  g86(.a(new_n129_), .b(x07), .c(x01), .O(z13));
  nand4  g87(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n131_));
  aoi21  g88(.a(new_n131_), .b(x07), .c(x01), .O(z14));
  aoi21  g89(.a(x07), .b(new_n53_), .c(new_n120_), .O(new_n133_));
  nand4  g90(.a(x19), .b(x07), .c(new_n53_), .d(new_n52_), .O(new_n134_));
  oai21  g91(.a(new_n133_), .b(new_n51_), .c(new_n134_), .O(z15));
  nor2   g92(.a(new_n52_), .b(x00), .O(z16));
  nand4  g93(.a(x07), .b(x02), .c(new_n52_), .d(new_n51_), .O(new_n137_));
