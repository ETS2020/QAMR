...
module FAU ( 
  ...
  nand4  g31(.a(new_n63_), .b(x11), .c(x10), .d(new_n46_), .O(new_n75_));
  ...
  nand4  g46(.a(new_n62_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n90_));
  ...
  nand4  g70(.a(new_n47_), .b(new_n52_), .c(new_n46_), .d(new_n45_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g72(.a(new_n52_), .b(new_n55_), .c(x01), .O(new_n116_));
