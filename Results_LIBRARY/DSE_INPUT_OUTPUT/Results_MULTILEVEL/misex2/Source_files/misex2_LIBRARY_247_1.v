...
module FAU ( 
  ...
  nand4  g049(.a(new_n92_), .b(new_n49_), .c(x17), .d(new_n84_), .O(new_n93_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n96_), .c(new_n95_), .d(new_n87_), .O(new_n107_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n96_), .c(new_n87_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n44_), .c(new_n87_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand4  g092(.a(new_n135_), .b(new_n52_), .c(new_n128_), .d(x09), .O(new_n136_));
  inv1   g093(.a(new_n136_), .O(z12));
  inv1   g094(.a(new_n57_), .O(new_n138_));
  ...
  nand4  g104(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n87_), .O(new_n148_));
