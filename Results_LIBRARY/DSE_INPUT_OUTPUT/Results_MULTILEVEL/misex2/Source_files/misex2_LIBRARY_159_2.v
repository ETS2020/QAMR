...
module FAU ( 
  ...
  nand2  g61(.a(x02), .b(new_n60_), .O(new_n105_));
  nor4   g62(.a(new_n105_), .b(x13), .c(new_n68_), .d(x11), .O(new_n106_));
  ...
  nand2  g81(.a(new_n52_), .b(x17), .O(new_n125_));
  nor2   g82(.a(new_n125_), .b(x19), .O(z13));
  nand2  g83(.a(new_n52_), .b(new_n46_), .O(new_n127_));
  ...
  nand4  g87(.a(x19), .b(new_n45_), .c(new_n60_), .d(new_n44_), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(new_n117_), .O(z15));
