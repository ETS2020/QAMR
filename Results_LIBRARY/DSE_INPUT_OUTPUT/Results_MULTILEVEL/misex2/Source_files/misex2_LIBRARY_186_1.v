...
module FAU ( 
  ...
  nand2  g001(.a(x16), .b(new_n44_), .O(new_n45_));
  ...
  inv1   g016(.a(x16), .O(new_n60_));
  nor2   g017(.a(new_n60_), .b(x05), .O(new_n61_));
  ...
  inv1   g043(.a(new_n48_), .O(new_n87_));
  ...
  aoi21  g050(.a(new_n93_), .b(new_n60_), .c(x05), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nor2   g053(.a(new_n46_), .b(x01), .O(new_n97_));
  nand3  g054(.a(new_n97_), .b(x12), .c(new_n70_), .O(new_n98_));
  inv1   g055(.a(x15), .O(new_n99_));
  nor2   g056(.a(x14), .b(x13), .O(new_n100_));
  nand4  g057(.a(new_n100_), .b(x20), .c(new_n60_), .d(new_n99_), .O(new_n101_));
  inv1   g058(.a(x20), .O(new_n102_));
  nor2   g059(.a(new_n51_), .b(new_n79_), .O(new_n103_));
  nand3  g060(.a(new_n103_), .b(new_n102_), .c(new_n52_), .O(new_n104_));
  oai21  g061(.a(new_n101_), .b(new_n98_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n69_), .O(new_n106_));
  ...
  nand2  g067(.a(x02), .b(new_n79_), .O(new_n111_));
  ...
  nand4  g077(.a(new_n97_), .b(new_n112_), .c(x12), .d(new_n70_), .O(new_n121_));
  nand4  g078(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n52_), .O(new_n122_));
  nor2   g079(.a(new_n99_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n95_), .c(x20), .d(new_n60_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n121_), .c(new_n122_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n96_), .c(new_n69_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n79_), .c(new_n69_), .O(new_n134_));
  ...
  oai21  g094(.a(new_n132_), .b(new_n87_), .c(new_n45_), .O(z13));
