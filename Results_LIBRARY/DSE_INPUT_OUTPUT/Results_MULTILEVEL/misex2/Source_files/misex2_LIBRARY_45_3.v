...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n116_, new_n117_, new_n119_, new_n121_, new_n123_, new_n126_;
  ...
  nand4  g17(.a(new_n48_), .b(x18), .c(new_n44_), .d(new_n46_), .O(new_n61_));
  nor2   g18(.a(new_n61_), .b(x19), .O(z03));
  inv1   g19(.a(new_n53_), .O(z05));
  inv1   g20(.a(x01), .O(new_n65_));
  nand3  g21(.a(x02), .b(new_n65_), .c(x00), .O(new_n66_));
  inv1   g22(.a(new_n66_), .O(z07));
  inv1   g23(.a(x00), .O(new_n68_));
  nor2   g24(.a(new_n46_), .b(x01), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  inv1   g26(.a(x03), .O(new_n71_));
  inv1   g27(.a(x05), .O(new_n72_));
  nand3  g28(.a(new_n72_), .b(x04), .c(new_n71_), .O(new_n73_));
  nor2   g29(.a(new_n73_), .b(new_n70_), .O(new_n74_));
  nor3   g30(.a(x08), .b(x07), .c(x06), .O(new_n75_));
  nand3  g31(.a(x19), .b(new_n45_), .c(x17), .O(new_n76_));
  inv1   g32(.a(new_n76_), .O(new_n77_));
  nand3  g33(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(new_n53_), .O(z08));
  nand2  g35(.a(new_n55_), .b(x18), .O(new_n80_));
  ...
  oai21  g40(.a(new_n84_), .b(new_n80_), .c(new_n68_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(x01), .O(new_n86_));
  inv1   g42(.a(x11), .O(new_n87_));
  inv1   g43(.a(x12), .O(new_n88_));
  nor2   g44(.a(x13), .b(new_n88_), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  ...
  oai21  g53(.a(new_n97_), .b(new_n80_), .c(new_n68_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(x01), .O(new_n99_));
  inv1   g55(.a(x15), .O(new_n100_));
  inv1   g56(.a(x16), .O(new_n101_));
  nor3   g57(.a(new_n101_), .b(new_n100_), .c(x14), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n94_), .c(new_n91_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n99_), .O(z10));
  and2   g60(.a(x18), .b(x01), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(x21), .c(new_n81_), .d(new_n55_), .O(new_n106_));
  nand3  g62(.a(new_n89_), .b(new_n69_), .c(new_n87_), .O(new_n107_));
  nor2   g63(.a(new_n100_), .b(x14), .O(new_n108_));
  nor2   g64(.a(x21), .b(new_n81_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n108_), .c(new_n101_), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n107_), .c(new_n106_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n83_), .c(new_n68_), .O(new_n112_));
  inv1   g68(.a(new_n112_), .O(z11));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g70(.a(new_n55_), .b(x17), .c(new_n46_), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n114_), .c(x24), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(x09), .c(new_n65_), .d(new_n68_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n53_), .O(z12));
  inv1   g74(.a(new_n48_), .O(new_n119_));
  oai21  g75(.a(new_n115_), .b(new_n119_), .c(new_n53_), .O(z13));
  nand3  g76(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n59_), .c(new_n53_), .O(z14));
  nor2   g78(.a(x19), .b(x00), .O(new_n123_));
  nor3   g79(.a(new_n123_), .b(x02), .c(x01), .O(z15));
  nor2   g80(.a(new_n65_), .b(x00), .O(z16));
  nand2  g81(.a(new_n48_), .b(x02), .O(new_n126_));
