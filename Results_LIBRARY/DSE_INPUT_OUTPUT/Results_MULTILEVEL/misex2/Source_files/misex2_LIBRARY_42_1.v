...
module FAU ( 
  ...
  nand3  g022(.a(new_n65_), .b(x18), .c(new_n45_), .O(new_n66_));
  oai21  g023(.a(new_n66_), .b(new_n64_), .c(new_n44_), .O(new_n67_));
  nand2  g024(.a(new_n67_), .b(new_n54_), .O(new_n68_));
  nand3  g025(.a(new_n52_), .b(x02), .c(x00), .O(new_n69_));
  nand3  g026(.a(x12), .b(x11), .c(x10), .O(new_n70_));
  oai21  g027(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(z03));
  nand3  g028(.a(x02), .b(x01), .c(x00), .O(new_n72_));
  inv1   g029(.a(new_n72_), .O(new_n73_));
  nand4  g030(.a(new_n73_), .b(new_n44_), .c(x10), .d(new_n52_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x12), .O(z04));
  nand2  g032(.a(x01), .b(x00), .O(new_n76_));
  nand2  g033(.a(x11), .b(new_n54_), .O(new_n77_));
  nand3  g034(.a(x10), .b(x09), .c(x02), .O(new_n78_));
  oai21  g035(.a(new_n78_), .b(new_n76_), .c(new_n77_), .O(z05));
  nand4  g036(.a(x10), .b(new_n52_), .c(x02), .d(x00), .O(new_n80_));
  aoi21  g037(.a(new_n80_), .b(x01), .c(new_n44_), .O(z06));
  inv1   g038(.a(x12), .O(new_n82_));
  nand4  g039(.a(new_n82_), .b(x11), .c(x10), .d(new_n52_), .O(new_n83_));
  nand2  g040(.a(new_n83_), .b(x01), .O(new_n84_));
  nand3  g041(.a(new_n84_), .b(x02), .c(x00), .O(new_n85_));
  nand2  g042(.a(new_n85_), .b(new_n77_), .O(z07));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n54_), .d(new_n53_), .O(new_n92_));
  ...
  nand4  g052(.a(new_n95_), .b(new_n50_), .c(x17), .d(new_n44_), .O(new_n96_));
  ...
  nand3  g057(.a(new_n100_), .b(x12), .c(new_n44_), .O(new_n101_));
  ...
  nor3   g071(.a(new_n114_), .b(new_n55_), .c(x01), .O(new_n115_));
  ...
  nand4  g076(.a(new_n107_), .b(x21), .c(new_n106_), .d(new_n65_), .O(new_n120_));
  nor2   g077(.a(x13), .b(new_n82_), .O(new_n121_));
  nand2  g078(.a(new_n121_), .b(new_n100_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n99_), .c(new_n53_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n77_), .O(z11));
  nand2  g084(.a(x10), .b(x02), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(x01), .c(x00), .O(new_n129_));
  oai21  g086(.a(x19), .b(x02), .c(x23), .O(new_n130_));
  nand3  g087(.a(new_n65_), .b(x17), .c(new_n55_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n54_), .c(new_n53_), .O(new_n133_));
  ...
  nor4   g093(.a(new_n56_), .b(x19), .c(new_n45_), .d(x11), .O(z13));
  nand4  g094(.a(new_n47_), .b(new_n46_), .c(new_n45_), .d(new_n51_), .O(new_n138_));
  aoi21  g095(.a(new_n138_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g096(.a(new_n51_), .b(x01), .c(new_n55_), .O(new_n140_));
  aoi21  g097(.a(x19), .b(new_n55_), .c(x11), .O(new_n141_));
  oai22  g098(.a(new_n141_), .b(x01), .c(new_n140_), .d(new_n53_), .O(z15));
  nor2   g099(.a(new_n54_), .b(x00), .O(z16));
  nand4  g100(.a(new_n44_), .b(x02), .c(new_n54_), .d(new_n53_), .O(new_n144_));
