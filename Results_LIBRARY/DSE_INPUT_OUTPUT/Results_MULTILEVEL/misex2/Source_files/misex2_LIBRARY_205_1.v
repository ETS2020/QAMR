...
module FAU ( 
  ...
  nand4  g33(.a(new_n76_), .b(x11), .c(x10), .d(new_n64_), .O(new_n77_));
  ...
  nand4  g60(.a(new_n101_), .b(new_n97_), .c(x16), .d(x15), .O(new_n104_));
  aoi21  g61(.a(new_n104_), .b(new_n47_), .c(x00), .O(z10));
  inv1   g62(.a(x11), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n95_), .c(new_n94_), .d(x12), .O(new_n109_));
  nor2   g66(.a(new_n109_), .b(new_n92_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n98_), .c(x20), .d(new_n93_), .O(new_n111_));
  ...
  nand3  g72(.a(new_n61_), .b(x17), .c(new_n48_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n115_), .c(x00), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n114_), .c(new_n113_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n64_), .c(new_n80_), .O(z12));
  nor3   g76(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g77(.a(new_n54_), .b(new_n57_), .c(new_n64_), .d(new_n48_), .O(new_n121_));
  ...
  nand3  g82(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n127_));
