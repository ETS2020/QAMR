...
module FAU ( 
  ...
  nand4  g66(.a(new_n109_), .b(new_n91_), .c(x20), .d(x16), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(x22), .O(z10));
  nand4  g68(.a(new_n99_), .b(x21), .c(new_n98_), .d(new_n51_), .O(new_n112_));
  nand4  g69(.a(new_n92_), .b(new_n104_), .c(x12), .d(new_n74_), .O(new_n113_));
  nor2   g70(.a(new_n94_), .b(x14), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n91_), .c(x20), .d(new_n95_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n113_), .c(new_n112_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n59_), .c(new_n67_), .O(new_n117_));
  inv1   g74(.a(new_n117_), .O(z11));
  nand2  g75(.a(x10), .b(x02), .O(new_n119_));
  nand4  g76(.a(new_n119_), .b(new_n59_), .c(x01), .d(x00), .O(new_n120_));
  ...
  oai21  g86(.a(new_n57_), .b(new_n48_), .c(new_n44_), .O(z14));
  aoi22  g87(.a(new_n44_), .b(x00), .c(x19), .d(new_n68_), .O(new_n131_));
  nand3  g88(.a(new_n69_), .b(new_n59_), .c(new_n56_), .O(new_n132_));
  oai21  g89(.a(new_n131_), .b(x02), .c(new_n132_), .O(z15));
  aoi21  g90(.a(new_n59_), .b(x00), .c(new_n68_), .O(z16));
  nand2  g91(.a(new_n92_), .b(new_n67_), .O(new_n135_));
  nand2  g92(.a(new_n135_), .b(new_n44_), .O(z17));
endmodule
