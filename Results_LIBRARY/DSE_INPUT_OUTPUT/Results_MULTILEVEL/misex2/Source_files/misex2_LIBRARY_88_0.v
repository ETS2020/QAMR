...
module FAU ( 
  ...
  nand4  g62(.a(new_n105_), .b(new_n95_), .c(new_n94_), .d(x04), .O(new_n106_));
  ...
  nor2   g66(.a(x13), .b(new_n71_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n96_), .c(new_n70_), .O(new_n111_));
  ...
  nand3  g71(.a(new_n114_), .b(x04), .c(new_n46_), .O(new_n115_));
  inv1   g72(.a(new_n115_), .O(z10));
  nand4  g73(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n62_), .O(new_n117_));
  ...
  nand2  g77(.a(new_n120_), .b(new_n95_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(x04), .c(x00), .O(z11));
  ...
  nand4  g88(.a(new_n62_), .b(x17), .c(new_n48_), .d(new_n47_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(x04), .c(x00), .O(z13));
  nand4  g90(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n134_));
  nor2   g91(.a(new_n134_), .b(x19), .O(z14));
  oai21  g92(.a(x10), .b(new_n47_), .c(x02), .O(new_n136_));
  nand2  g93(.a(new_n136_), .b(x00), .O(new_n137_));
  nand3  g94(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n138_));
  nand3  g95(.a(new_n138_), .b(new_n137_), .c(new_n69_), .O(z15));
  nand3  g96(.a(x04), .b(x01), .c(new_n46_), .O(new_n140_));
