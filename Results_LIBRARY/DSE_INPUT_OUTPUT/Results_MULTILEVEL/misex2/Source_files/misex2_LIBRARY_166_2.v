...
module FAU ( 
  ...
  nand3  g027(.a(new_n70_), .b(x10), .c(new_n47_), .O(new_n71_));
  nor4   g028(.a(new_n71_), .b(new_n44_), .c(x12), .d(x11), .O(z04));
  nor4   g029(.a(new_n69_), .b(new_n44_), .c(new_n57_), .d(new_n47_), .O(z05));
  inv1   g030(.a(x11), .O(new_n74_));
  nor3   g031(.a(new_n71_), .b(new_n44_), .c(new_n74_), .O(z06));
  nand2  g032(.a(x10), .b(new_n47_), .O(new_n76_));
  inv1   g033(.a(x12), .O(new_n77_));
  nand3  g034(.a(x13), .b(new_n77_), .c(x11), .O(new_n78_));
  ...
  nand4  g048(.a(new_n91_), .b(new_n51_), .c(x17), .d(new_n82_), .O(new_n92_));
  nor2   g049(.a(new_n92_), .b(new_n52_), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nor2   g052(.a(new_n46_), .b(x01), .O(new_n96_));
  nand3  g053(.a(new_n96_), .b(x12), .c(new_n74_), .O(new_n97_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n95_), .c(new_n94_), .d(new_n85_), .O(new_n105_));
  ...
  nor3   g068(.a(new_n111_), .b(x11), .c(new_n46_), .O(new_n112_));
  nand3  g069(.a(new_n95_), .b(new_n94_), .c(x20), .O(new_n113_));
  nor3   g070(.a(new_n113_), .b(new_n99_), .c(new_n98_), .O(new_n114_));
  aoi21  g071(.a(new_n114_), .b(new_n112_), .c(new_n110_), .O(new_n115_));
  oai21  g072(.a(new_n115_), .b(x00), .c(new_n45_), .O(z10));
  nand3  g073(.a(x18), .b(x13), .c(x01), .O(new_n117_));
  nand3  g074(.a(x21), .b(new_n108_), .c(new_n52_), .O(new_n118_));
  nand4  g075(.a(new_n96_), .b(new_n44_), .c(x12), .d(new_n74_), .O(new_n119_));
  nor2   g076(.a(new_n98_), .b(x14), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n94_), .c(x20), .d(new_n99_), .O(new_n121_));
  oai22  g078(.a(new_n121_), .b(new_n119_), .c(new_n118_), .d(new_n117_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n95_), .c(new_n85_), .O(new_n123_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n86_), .c(new_n85_), .O(new_n130_));
  ...
  oai21  g096(.a(x10), .b(new_n86_), .c(x02), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(x00), .O(new_n141_));
  nand3  g098(.a(x19), .b(new_n46_), .c(new_n86_), .O(new_n142_));
  nand3  g099(.a(new_n142_), .b(new_n141_), .c(new_n45_), .O(z15));
  aoi21  g100(.a(x13), .b(x00), .c(new_n86_), .O(z16));
