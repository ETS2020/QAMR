...
module FAU ( 
  ...
  nand4  g53(.a(new_n96_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n97_));
  ...
  nor3   g64(.a(new_n107_), .b(x11), .c(new_n48_), .O(new_n108_));
  ...
  aoi21  g68(.a(new_n111_), .b(new_n47_), .c(x00), .O(z11));
  ...
  oai21  g75(.a(new_n118_), .b(new_n49_), .c(new_n80_), .O(z12));
  aoi21  g76(.a(new_n116_), .b(new_n47_), .c(x00), .O(z13));
  nand4  g77(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n121_));
  nor2   g78(.a(new_n121_), .b(x19), .O(z14));
  aoi21  g79(.a(new_n57_), .b(x01), .c(new_n48_), .O(new_n123_));
