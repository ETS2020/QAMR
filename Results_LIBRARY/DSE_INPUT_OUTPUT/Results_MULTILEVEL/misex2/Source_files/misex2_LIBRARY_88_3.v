...
module FAU ( 
  ...
  nand2  g09(.a(x04), .b(x00), .O(new_n53_));
  ...
  nand4  g27(.a(new_n70_), .b(new_n69_), .c(x10), .d(x01), .O(new_n71_));
  aoi21  g28(.a(new_n71_), .b(new_n65_), .c(new_n61_), .O(z04));
  nand4  g29(.a(new_n65_), .b(x02), .c(x01), .d(x00), .O(new_n73_));
  ...
  nand3  g53(.a(new_n96_), .b(x12), .c(new_n77_), .O(new_n97_));
  ...
  nor2   g59(.a(new_n45_), .b(new_n62_), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(new_n102_), .c(new_n55_), .O(new_n104_));
  oai21  g61(.a(new_n101_), .b(new_n97_), .c(new_n104_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n95_), .c(new_n94_), .d(new_n61_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(z09));
  nor3   g64(.a(new_n95_), .b(new_n94_), .c(x20), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n55_), .c(x18), .d(x01), .O(new_n109_));
  nor2   g66(.a(x13), .b(new_n79_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n96_), .c(new_n77_), .O(new_n111_));
  ...
  nand4  g72(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n55_), .O(new_n116_));
  nor2   g73(.a(new_n98_), .b(x14), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n94_), .c(x20), .d(new_n99_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n111_), .c(new_n116_), .O(new_n119_));
  ...
  nand3  g81(.a(new_n55_), .b(x17), .c(new_n46_), .O(new_n125_));
  ...
  oai21  g88(.a(new_n125_), .b(new_n131_), .c(new_n53_), .O(z13));
  nand4  g89(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n133_));
  nor2   g90(.a(new_n133_), .b(x19), .O(z14));
  aoi21  g91(.a(x19), .b(new_n62_), .c(x00), .O(new_n135_));
  aoi21  g92(.a(new_n58_), .b(x01), .c(x04), .O(new_n136_));
  oai22  g93(.a(new_n136_), .b(new_n61_), .c(new_n135_), .d(x02), .O(z15));
  nor2   g94(.a(new_n62_), .b(x00), .O(z16));
