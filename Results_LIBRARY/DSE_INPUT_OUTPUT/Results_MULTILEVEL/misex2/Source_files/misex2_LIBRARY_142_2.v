...
module FAU ( 
  ...
  aoi21  g032(.a(new_n75_), .b(x08), .c(new_n71_), .O(z04));
  nand4  g033(.a(x08), .b(x02), .c(x01), .d(x00), .O(new_n77_));
  nor3   g034(.a(new_n77_), .b(new_n59_), .c(new_n47_), .O(z05));
  inv1   g035(.a(new_n77_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(x11), .c(x10), .d(new_n47_), .O(new_n80_));
  inv1   g037(.a(new_n80_), .O(z06));
  nand2  g038(.a(new_n47_), .b(x08), .O(new_n82_));
  ...
  aoi21  g051(.a(new_n94_), .b(new_n71_), .c(x08), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n72_), .c(x02), .d(new_n71_), .O(new_n98_));
  ...
  nand4  g060(.a(new_n103_), .b(x18), .c(x08), .d(x01), .O(new_n104_));
  ...
  nand2  g067(.a(x02), .b(new_n71_), .O(new_n111_));
  ...
  nand3  g077(.a(new_n120_), .b(new_n119_), .c(new_n72_), .O(new_n121_));
  inv1   g078(.a(x20), .O(new_n122_));
  and2   g079(.a(x18), .b(x01), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(x21), .c(new_n122_), .d(new_n56_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n97_), .c(new_n87_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n54_), .O(z11));
  inv1   g087(.a(x24), .O(new_n131_));
  nand2  g088(.a(x10), .b(x02), .O(new_n132_));
  nand4  g089(.a(new_n132_), .b(x08), .c(x01), .d(x00), .O(new_n133_));
  ...
  nand3  g093(.a(new_n136_), .b(new_n71_), .c(new_n87_), .O(new_n137_));
  ...
  aoi22  g101(.a(new_n54_), .b(x00), .c(x19), .d(new_n71_), .O(new_n145_));
  nand4  g102(.a(new_n59_), .b(x08), .c(x01), .d(x00), .O(new_n146_));
  oai21  g103(.a(new_n145_), .b(x02), .c(new_n146_), .O(z15));
  nand3  g104(.a(x08), .b(x01), .c(new_n87_), .O(new_n148_));
  inv1   g105(.a(new_n148_), .O(z16));
  oai21  g106(.a(new_n111_), .b(x00), .c(new_n54_), .O(z17));
endmodule
