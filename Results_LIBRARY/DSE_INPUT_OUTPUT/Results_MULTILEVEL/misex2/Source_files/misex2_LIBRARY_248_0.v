...
module FAU ( 
  ...
  nand3  g20(.a(new_n48_), .b(x02), .c(x00), .O(new_n65_));
  nand3  g21(.a(new_n52_), .b(x11), .c(x10), .O(new_n66_));
  ...
  nor2   g37(.a(new_n82_), .b(new_n62_), .O(z12));
  inv1   g38(.a(x10), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(x01), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(x02), .c(new_n62_), .O(z15));
