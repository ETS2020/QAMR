...
module FAU ( 
  ...
  nand4  g30(.a(new_n70_), .b(new_n73_), .c(x11), .d(x10), .O(new_n74_));
  ...
  nor2   g52(.a(new_n77_), .b(new_n55_), .O(new_n96_));
  nand3  g53(.a(new_n96_), .b(new_n95_), .c(new_n58_), .O(new_n97_));
  ...
  nand4  g58(.a(new_n101_), .b(new_n58_), .c(x18), .d(x01), .O(new_n102_));
  nor2   g59(.a(x13), .b(new_n73_), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(new_n89_), .c(new_n63_), .O(new_n104_));
  ...
  nand4  g65(.a(new_n96_), .b(x21), .c(new_n95_), .d(new_n58_), .O(new_n109_));
  ...
  nand3  g79(.a(new_n122_), .b(x17), .c(new_n45_), .O(new_n123_));
  nor2   g80(.a(new_n123_), .b(x19), .O(z13));
  nand3  g81(.a(new_n122_), .b(new_n46_), .c(new_n45_), .O(new_n125_));
  inv1   g82(.a(new_n125_), .O(new_n126_));
  nand4  g83(.a(new_n126_), .b(new_n77_), .c(new_n57_), .d(new_n52_), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(x19), .O(z14));
  nand2  g85(.a(x10), .b(x02), .O(new_n129_));
  nand3  g86(.a(new_n129_), .b(x01), .c(x00), .O(new_n130_));
  nand3  g87(.a(new_n122_), .b(x19), .c(new_n45_), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(new_n130_), .O(z15));
  xor2a  g89(.a(x01), .b(x00), .O(z16));
  nand2  g90(.a(new_n122_), .b(x02), .O(new_n134_));
