...
module FAU ( 
  ...
  aoi21  g004(.a(new_n47_), .b(x23), .c(x01), .O(z00));
  inv1   g005(.a(x23), .O(new_n49_));
  ...
  nor2   g015(.a(new_n58_), .b(new_n49_), .O(z01));
  nor2   g016(.a(new_n56_), .b(x10), .O(new_n60_));
  nand4  g017(.a(new_n60_), .b(new_n51_), .c(new_n50_), .d(new_n44_), .O(new_n61_));
  nor2   g018(.a(new_n61_), .b(new_n49_), .O(z02));
  nand3  g019(.a(new_n55_), .b(new_n54_), .c(new_n53_), .O(new_n63_));
  nand4  g020(.a(x23), .b(new_n51_), .c(x18), .d(new_n44_), .O(new_n64_));
  ...
  nand2  g025(.a(new_n49_), .b(new_n54_), .O(new_n69_));
  ...
  aoi21  g048(.a(new_n91_), .b(x23), .c(x01), .O(z08));
  ...
  aoi21  g085(.a(x10), .b(x02), .c(new_n54_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(x00), .O(new_n130_));
  nand3  g087(.a(new_n51_), .b(new_n44_), .c(new_n55_), .O(new_n131_));
  nand4  g088(.a(new_n131_), .b(x23), .c(new_n54_), .d(new_n53_), .O(new_n132_));
  aoi21  g089(.a(new_n132_), .b(new_n130_), .c(x24), .O(new_n133_));
  ...
  aoi21  g093(.a(new_n136_), .b(x23), .c(x01), .O(z13));
  nand4  g094(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n52_), .O(new_n138_));
  aoi21  g095(.a(new_n138_), .b(x23), .c(x01), .O(z14));
  aoi21  g096(.a(x23), .b(new_n55_), .c(new_n129_), .O(new_n140_));
  nand4  g097(.a(x23), .b(x19), .c(new_n55_), .d(new_n54_), .O(new_n141_));
  oai21  g098(.a(new_n140_), .b(new_n53_), .c(new_n141_), .O(z15));
  nor2   g099(.a(new_n54_), .b(x00), .O(z16));
  aoi21  g100(.a(new_n84_), .b(x23), .c(x01), .O(z17));
endmodule
