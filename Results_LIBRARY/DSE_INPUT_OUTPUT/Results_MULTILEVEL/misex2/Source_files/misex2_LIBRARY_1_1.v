...
module FAU ( 
  ...
  nand2  g25(.a(x13), .b(new_n49_), .O(new_n69_));
  ...
  nor4   g32(.a(new_n66_), .b(new_n70_), .c(new_n47_), .d(x09), .O(z06));
  nand2  g33(.a(new_n51_), .b(x01), .O(new_n77_));
  nand3  g34(.a(new_n71_), .b(x11), .c(x10), .O(new_n78_));
  oai22  g35(.a(new_n78_), .b(new_n77_), .c(x13), .d(x01), .O(new_n79_));
  ...
  nand4  g72(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n64_), .O(new_n116_));
  nor2   g73(.a(new_n98_), .b(x14), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n93_), .c(x20), .d(new_n99_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n96_), .c(new_n116_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n94_), .c(new_n48_), .O(new_n120_));
  ...
  nand3  g81(.a(new_n64_), .b(x17), .c(new_n50_), .O(new_n125_));
  ...
  nand4  g87(.a(new_n64_), .b(x17), .c(new_n50_), .d(new_n48_), .O(new_n131_));
  ...
  aoi21  g92(.a(new_n44_), .b(new_n50_), .c(new_n122_), .O(new_n136_));
