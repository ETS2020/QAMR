...
module FAU ( 
  ...
  nand3  g053(.a(new_n85_), .b(x12), .c(new_n72_), .O(new_n97_));
  ...
  nor2   g058(.a(new_n56_), .b(new_n47_), .O(new_n102_));
  nand3  g059(.a(new_n102_), .b(new_n44_), .c(new_n57_), .O(new_n103_));
  ...
  nand3  g064(.a(x22), .b(x21), .c(new_n44_), .O(new_n108_));
  ...
  nand4  g076(.a(new_n85_), .b(new_n111_), .c(x12), .d(new_n72_), .O(new_n120_));
  nand4  g077(.a(new_n102_), .b(x21), .c(new_n44_), .d(new_n57_), .O(new_n121_));
  ...
  nand2  g093(.a(new_n47_), .b(new_n46_), .O(new_n137_));
  oai21  g094(.a(new_n131_), .b(new_n137_), .c(new_n45_), .O(z13));
  nand3  g095(.a(new_n52_), .b(new_n51_), .c(new_n55_), .O(new_n139_));
  oai21  g096(.a(new_n139_), .b(new_n50_), .c(new_n45_), .O(z14));
  ...
  nor3   g102(.a(new_n141_), .b(new_n47_), .c(x00), .O(z16));
  nand2  g103(.a(new_n86_), .b(new_n45_), .O(z17));
endmodule
