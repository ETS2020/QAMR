...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n143_, new_n145_, new_n146_, new_n147_, new_n149_;
  nand2  g000(.a(x24), .b(x01), .O(new_n44_));
  ...
  nor2   g032(.a(new_n47_), .b(new_n45_), .O(new_n76_));
  nand3  g033(.a(new_n76_), .b(x10), .c(x09), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(new_n63_), .c(new_n46_), .O(z05));
  nand4  g035(.a(new_n76_), .b(x11), .c(x10), .d(new_n48_), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(new_n63_), .c(new_n46_), .O(z06));
  nand2  g037(.a(x10), .b(new_n48_), .O(new_n81_));
  nand3  g038(.a(new_n63_), .b(new_n72_), .c(x11), .O(new_n82_));
  ...
  nand3  g054(.a(new_n86_), .b(x12), .c(new_n71_), .O(new_n98_));
  ...
  nor2   g059(.a(new_n51_), .b(new_n46_), .O(new_n103_));
  nor3   g060(.a(x24), .b(x20), .c(x19), .O(new_n104_));
  ...
  nand3  g065(.a(new_n52_), .b(x18), .c(x01), .O(new_n109_));
  inv1   g066(.a(x20), .O(new_n110_));
  nand3  g067(.a(x22), .b(x21), .c(new_n110_), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g069(.a(x02), .b(new_n46_), .O(new_n113_));
  ...
  oai21  g078(.a(new_n121_), .b(x00), .c(new_n44_), .O(z10));
  nand4  g079(.a(new_n86_), .b(new_n114_), .c(x12), .d(new_n71_), .O(new_n123_));
  nand4  g080(.a(new_n103_), .b(x21), .c(new_n110_), .d(new_n52_), .O(new_n124_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n97_), .c(new_n45_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(new_n44_), .O(z11));
  nand2  g086(.a(x10), .b(x02), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(x01), .c(x00), .O(new_n131_));
  oai21  g088(.a(x19), .b(x02), .c(x23), .O(new_n132_));
  nand3  g089(.a(new_n52_), .b(x17), .c(new_n47_), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand4  g091(.a(new_n134_), .b(new_n63_), .c(new_n46_), .d(new_n45_), .O(new_n135_));
  ...
  nand2  g095(.a(new_n55_), .b(x17), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x19), .O(z13));
  nand2  g097(.a(new_n55_), .b(new_n48_), .O(new_n141_));
  inv1   g098(.a(new_n141_), .O(new_n142_));
  nand4  g099(.a(new_n142_), .b(new_n51_), .c(new_n50_), .d(new_n60_), .O(new_n143_));
  nor2   g100(.a(new_n143_), .b(x19), .O(z14));
  oai21  g101(.a(x10), .b(new_n46_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n47_), .c(new_n46_), .O(new_n147_));
  nand3  g104(.a(new_n147_), .b(new_n146_), .c(new_n44_), .O(z15));
  nand3  g105(.a(new_n63_), .b(x01), .c(new_n45_), .O(new_n149_));
  inv1   g106(.a(new_n149_), .O(z16));
  nand2  g107(.a(new_n87_), .b(new_n44_), .O(z17));
endmodule
