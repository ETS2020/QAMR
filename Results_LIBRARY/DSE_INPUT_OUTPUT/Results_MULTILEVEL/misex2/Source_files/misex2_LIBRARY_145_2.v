...
module FAU ( 
  ...
  inv1   g036(.a(new_n52_), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(new_n71_), .O(new_n81_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n52_), .c(new_n97_), .d(new_n96_), .O(new_n107_));
  ...
  nand2  g071(.a(new_n114_), .b(new_n89_), .O(new_n115_));
  ...
  nand4  g086(.a(new_n129_), .b(new_n52_), .c(x01), .d(x00), .O(new_n130_));
  nor2   g087(.a(x19), .b(x06), .O(new_n131_));
  aoi21  g088(.a(new_n131_), .b(new_n45_), .c(x23), .O(new_n132_));
  oai21  g089(.a(x19), .b(x02), .c(x23), .O(new_n133_));
  oai21  g090(.a(new_n132_), .b(new_n48_), .c(new_n133_), .O(new_n134_));
  nand3  g091(.a(new_n134_), .b(new_n44_), .c(new_n70_), .O(new_n135_));
  ...
  inv1   g095(.a(new_n57_), .O(new_n139_));
  nand3  g096(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n140_));
  oai21  g097(.a(new_n140_), .b(new_n139_), .c(new_n52_), .O(z13));
  nand3  g098(.a(new_n57_), .b(new_n46_), .c(new_n45_), .O(new_n142_));
  oai21  g099(.a(new_n142_), .b(new_n61_), .c(new_n52_), .O(z14));
  ...
  aoi21  g103(.a(new_n146_), .b(new_n145_), .c(new_n80_), .O(z15));
  oai21  g104(.a(new_n44_), .b(x00), .c(new_n52_), .O(z16));
  nand4  g105(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n70_), .O(new_n149_));
