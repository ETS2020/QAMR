...
module FAU ( 
  ...
  nand4  g59(.a(new_n65_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n103_));
  ...
  nand3  g70(.a(new_n60_), .b(x17), .c(new_n45_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n113_), .c(x00), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n112_), .c(new_n111_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n46_), .c(new_n79_), .O(z12));
  aoi21  g74(.a(new_n114_), .b(new_n44_), .c(x00), .O(z13));
