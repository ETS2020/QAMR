...
module FAU ( 
  ...
  nand4  g38(.a(new_n81_), .b(x02), .c(new_n52_), .d(new_n44_), .O(new_n82_));
  ...
  nand2  g53(.a(new_n96_), .b(new_n52_), .O(new_n97_));
  nor3   g54(.a(new_n51_), .b(new_n52_), .c(x00), .O(new_n98_));
  ...
  nand2  g61(.a(x02), .b(new_n52_), .O(new_n105_));
  nor4   g62(.a(new_n105_), .b(x13), .c(new_n69_), .d(x11), .O(new_n106_));
  nor3   g63(.a(new_n91_), .b(new_n90_), .c(x14), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n106_), .c(new_n94_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n104_), .c(x00), .O(z10));
  nand3  g66(.a(new_n94_), .b(new_n91_), .c(x15), .O(new_n110_));
  oai21  g67(.a(new_n110_), .b(new_n89_), .c(new_n44_), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(new_n52_), .O(new_n112_));
  inv1   g69(.a(x22), .O(new_n113_));
  nand4  g70(.a(new_n99_), .b(new_n98_), .c(new_n113_), .d(x21), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n112_), .O(z11));
  inv1   g72(.a(x24), .O(new_n116_));
  aoi21  g73(.a(x10), .b(x02), .c(new_n44_), .O(new_n117_));
  ...
  oai22  g78(.a(new_n121_), .b(new_n46_), .c(x01), .d(new_n44_), .O(z12));
  aoi21  g79(.a(new_n119_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g80(.a(new_n46_), .b(new_n45_), .c(new_n52_), .d(new_n44_), .O(new_n124_));
  inv1   g81(.a(new_n124_), .O(new_n125_));
  nand4  g82(.a(new_n125_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n126_));
  nor2   g83(.a(new_n126_), .b(x19), .O(z14));
  inv1   g84(.a(new_n117_), .O(new_n128_));
  aoi21  g85(.a(x19), .b(new_n45_), .c(x00), .O(new_n129_));
  oai21  g86(.a(new_n129_), .b(x01), .c(new_n128_), .O(z15));
  nor2   g87(.a(new_n52_), .b(x00), .O(z16));
  nand3  g88(.a(x02), .b(new_n52_), .c(new_n44_), .O(new_n132_));
