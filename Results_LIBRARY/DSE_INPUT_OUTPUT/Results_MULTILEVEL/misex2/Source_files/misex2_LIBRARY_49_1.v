...
module FAU ( 
  ...
  nand4  g50(.a(new_n65_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n94_));
  ...
  nor2   g59(.a(new_n90_), .b(new_n102_), .O(new_n103_));
  ...
  nor2   g63(.a(new_n96_), .b(new_n102_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n91_), .c(x20), .d(new_n90_), .O(new_n108_));
  ...
  nand3  g71(.a(new_n114_), .b(new_n44_), .c(new_n52_), .O(new_n115_));
  ...
  nand4  g76(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n52_), .O(new_n120_));
  ...
  oai21  g80(.a(new_n57_), .b(new_n52_), .c(x01), .O(new_n124_));
