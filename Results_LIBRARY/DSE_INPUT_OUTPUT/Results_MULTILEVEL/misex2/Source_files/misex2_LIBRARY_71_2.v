...
module FAU ( 
  ...
  nor2   g30(.a(x09), .b(new_n48_), .O(new_n74_));
  ...
  nand3  g34(.a(new_n77_), .b(new_n74_), .c(x10), .O(new_n78_));
  ...
  oai21  g50(.a(new_n93_), .b(new_n89_), .c(new_n46_), .O(new_n94_));
  ...
  nand4  g67(.a(new_n92_), .b(x20), .c(new_n91_), .d(x15), .O(new_n111_));
  ...
  nand4  g71(.a(new_n97_), .b(new_n96_), .c(new_n114_), .d(x21), .O(new_n115_));
  ...
  nand3  g77(.a(new_n63_), .b(x17), .c(new_n48_), .O(new_n121_));
