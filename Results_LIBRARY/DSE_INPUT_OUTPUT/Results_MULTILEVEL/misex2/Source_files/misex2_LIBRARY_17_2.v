...
module FAU ( 
  ...
  nand3  g23(.a(new_n66_), .b(x03), .c(x02), .O(new_n67_));
  ...
  aoi21  g29(.a(new_n72_), .b(x03), .c(new_n63_), .O(z04));
  nand3  g30(.a(new_n66_), .b(x03), .c(x02), .O(new_n74_));
  nor3   g31(.a(new_n74_), .b(new_n59_), .c(new_n47_), .O(z05));
  ...
  nand4  g43(.a(new_n53_), .b(x02), .c(new_n63_), .d(new_n62_), .O(new_n87_));
  ...
  nor2   g58(.a(new_n45_), .b(new_n63_), .O(new_n102_));
  inv1   g59(.a(x20), .O(new_n103_));
  nand2  g60(.a(new_n103_), .b(new_n56_), .O(new_n104_));
  ...
  nand4  g64(.a(new_n107_), .b(new_n94_), .c(new_n93_), .d(new_n62_), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(new_n54_), .O(z09));
  nand3  g66(.a(x18), .b(x03), .c(x01), .O(new_n110_));
  inv1   g67(.a(new_n110_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n105_), .c(x22), .d(x21), .O(new_n112_));
  nor2   g69(.a(x13), .b(new_n79_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n96_), .c(new_n95_), .O(new_n114_));
  nor3   g71(.a(new_n99_), .b(new_n98_), .c(x14), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n94_), .c(new_n93_), .d(x20), .O(new_n116_));
  or2    g73(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n112_), .c(x00), .O(z10));
  nand4  g75(.a(new_n102_), .b(x21), .c(new_n103_), .d(new_n56_), .O(new_n119_));
  ...
  nand3  g79(.a(new_n122_), .b(new_n94_), .c(new_n62_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n54_), .O(z11));
  ...
  oai21  g91(.a(new_n128_), .b(new_n134_), .c(new_n54_), .O(z13));
  nand3  g92(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n136_));
  oai21  g93(.a(new_n136_), .b(new_n60_), .c(new_n54_), .O(z14));
  aoi22  g94(.a(new_n54_), .b(x00), .c(x19), .d(new_n63_), .O(new_n138_));
  nand3  g95(.a(new_n66_), .b(new_n59_), .c(x03), .O(new_n139_));
  oai21  g96(.a(new_n138_), .b(x02), .c(new_n139_), .O(z15));
  aoi21  g97(.a(x03), .b(x00), .c(new_n63_), .O(z16));
  nand2  g98(.a(new_n96_), .b(new_n62_), .O(new_n142_));
  nand2  g99(.a(new_n142_), .b(new_n54_), .O(z17));
endmodule
