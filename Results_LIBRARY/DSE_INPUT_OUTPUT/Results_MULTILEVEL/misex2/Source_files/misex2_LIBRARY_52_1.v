...
module FAU ( 
  ...
  nand4  g44(.a(new_n87_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n88_));
  ...
  nand4  g54(.a(new_n70_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n98_));
  ...
  aoi21  g67(.a(x10), .b(x02), .c(new_n56_), .O(new_n111_));
  ...
  oai22  g72(.a(new_n115_), .b(new_n46_), .c(new_n56_), .d(x00), .O(z12));
  nand2  g73(.a(new_n47_), .b(x17), .O(new_n117_));
  nor2   g74(.a(new_n117_), .b(x19), .O(z13));
  nand4  g75(.a(new_n59_), .b(new_n58_), .c(new_n46_), .d(new_n57_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n56_), .c(x00), .O(z14));
