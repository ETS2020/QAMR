...
module FAU ( 
  ...
  aoi21  g030(.a(new_n73_), .b(x07), .c(new_n69_), .O(z04));
  inv1   g031(.a(x00), .O(new_n75_));
  nor2   g032(.a(new_n46_), .b(new_n75_), .O(new_n76_));
  nand3  g033(.a(new_n76_), .b(x10), .c(x09), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(x07), .c(new_n69_), .O(z05));
  nand4  g035(.a(new_n76_), .b(x11), .c(x10), .d(new_n47_), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(x07), .c(new_n69_), .O(z06));
  nand2  g037(.a(new_n47_), .b(x07), .O(new_n81_));
  ...
  nand2  g042(.a(x02), .b(new_n75_), .O(new_n86_));
  ...
  aoi21  g049(.a(new_n92_), .b(new_n69_), .c(x07), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n70_), .c(x02), .d(new_n69_), .O(new_n96_));
  ...
  nand4  g058(.a(new_n101_), .b(new_n56_), .c(x18), .d(x01), .O(new_n102_));
  oai21  g059(.a(new_n100_), .b(new_n96_), .c(new_n102_), .O(new_n103_));
  nand4  g060(.a(new_n103_), .b(new_n95_), .c(new_n94_), .d(new_n75_), .O(new_n104_));
  nand2  g061(.a(new_n104_), .b(new_n54_), .O(z09));
  nand3  g062(.a(new_n56_), .b(x18), .c(x01), .O(new_n106_));
  nand3  g063(.a(x22), .b(x21), .c(new_n101_), .O(new_n107_));
  nor2   g064(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g065(.a(x02), .b(new_n69_), .O(new_n109_));
  ...
  nand3  g078(.a(x18), .b(x07), .c(x01), .O(new_n122_));
  inv1   g079(.a(new_n122_), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(x21), .c(new_n101_), .d(new_n56_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n95_), .c(new_n75_), .O(new_n129_));
  inv1   g086(.a(new_n129_), .O(z11));
  inv1   g087(.a(x24), .O(new_n131_));
  nand2  g088(.a(x10), .b(x02), .O(new_n132_));
  nand4  g089(.a(new_n132_), .b(x07), .c(x01), .d(x00), .O(new_n133_));
  ...
  nand3  g093(.a(new_n136_), .b(new_n69_), .c(new_n75_), .O(new_n137_));
  ...
  oai21  g098(.a(new_n135_), .b(new_n141_), .c(new_n54_), .O(z13));
  nand3  g099(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n143_));
  oai21  g100(.a(new_n143_), .b(new_n60_), .c(new_n54_), .O(z14));
  oai21  g101(.a(x10), .b(new_n69_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n46_), .c(new_n69_), .O(new_n147_));
  nand3  g104(.a(new_n147_), .b(new_n146_), .c(new_n54_), .O(z15));
  aoi21  g105(.a(x07), .b(x00), .c(new_n69_), .O(z16));
  oai21  g106(.a(new_n109_), .b(x00), .c(new_n54_), .O(z17));
endmodule
