...
module FAU ( 
  ...
  nand2  g007(.a(x24), .b(x08), .O(new_n51_));
  ...
  nand3  g015(.a(new_n58_), .b(new_n48_), .c(x10), .O(new_n59_));
  oai21  g016(.a(new_n59_), .b(new_n57_), .c(new_n51_), .O(z01));
  nor2   g017(.a(new_n52_), .b(x10), .O(new_n61_));
  nand4  g018(.a(new_n61_), .b(x09), .c(new_n45_), .d(new_n44_), .O(new_n62_));
  nor2   g019(.a(new_n62_), .b(x00), .O(z02));
  inv1   g020(.a(new_n51_), .O(new_n64_));
  ...
  nand4  g032(.a(new_n51_), .b(new_n75_), .c(new_n74_), .d(x10), .O(new_n76_));
  ...
  oai21  g038(.a(new_n81_), .b(new_n80_), .c(new_n51_), .O(z05));
  nand4  g039(.a(new_n51_), .b(x11), .c(x10), .d(new_n46_), .O(new_n83_));
  inv1   g040(.a(new_n83_), .O(new_n84_));
  nand4  g041(.a(new_n84_), .b(x02), .c(x01), .d(x00), .O(new_n85_));
  inv1   g042(.a(new_n85_), .O(z06));
  nand3  g043(.a(new_n67_), .b(new_n75_), .c(x11), .O(new_n87_));
  nand2  g044(.a(new_n87_), .b(x01), .O(new_n88_));
  nand3  g045(.a(new_n88_), .b(x02), .c(x00), .O(new_n89_));
  nand2  g046(.a(new_n89_), .b(new_n51_), .O(z07));
  nor2   g047(.a(new_n45_), .b(x01), .O(new_n91_));
  nand2  g048(.a(new_n91_), .b(new_n73_), .O(new_n92_));
  ...
  nor2   g054(.a(new_n50_), .b(x18), .O(new_n98_));
  nand4  g055(.a(new_n98_), .b(new_n97_), .c(new_n96_), .d(x17), .O(new_n99_));
  nand2  g056(.a(new_n99_), .b(new_n51_), .O(z08));
  inv1   g057(.a(x21), .O(new_n101_));
  inv1   g058(.a(x22), .O(new_n102_));
  nand4  g059(.a(x12), .b(new_n74_), .c(x02), .d(new_n44_), .O(new_n103_));
  ...
  nand4  g068(.a(new_n111_), .b(new_n102_), .c(new_n101_), .d(new_n73_), .O(new_n112_));
  nand2  g069(.a(new_n112_), .b(new_n51_), .O(z09));
  nor2   g070(.a(new_n102_), .b(new_n101_), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n70_), .c(new_n108_), .d(x01), .O(new_n115_));
  nor2   g072(.a(x13), .b(new_n75_), .O(new_n116_));
  nand3  g073(.a(new_n116_), .b(new_n91_), .c(new_n74_), .O(new_n117_));
  ...
  nand3  g079(.a(new_n122_), .b(new_n51_), .c(new_n73_), .O(new_n123_));
  ...
  nand4  g086(.a(new_n129_), .b(new_n51_), .c(new_n102_), .d(new_n73_), .O(new_n130_));
  ...
  nand3  g094(.a(new_n137_), .b(new_n44_), .c(new_n73_), .O(new_n138_));
  ...
  inv1   g098(.a(new_n56_), .O(new_n142_));
  oai21  g099(.a(new_n136_), .b(new_n142_), .c(new_n51_), .O(z13));
  nor2   g100(.a(x09), .b(x02), .O(new_n144_));
  nor2   g101(.a(x17), .b(x10), .O(new_n145_));
  nand4  g102(.a(new_n145_), .b(new_n144_), .c(new_n58_), .d(new_n56_), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(new_n51_), .O(z14));
  ...
  aoi21  g107(.a(new_n150_), .b(new_n149_), .c(new_n64_), .O(z15));
  nand3  g108(.a(new_n51_), .b(x01), .c(new_n73_), .O(new_n152_));
  inv1   g109(.a(new_n152_), .O(z16));
  nand2  g110(.a(new_n92_), .b(new_n51_), .O(z17));
endmodule
