...
module FAU ( 
  ...
  aoi21  g33(.a(new_n76_), .b(x00), .c(new_n60_), .O(z06));
  nand4  g34(.a(new_n68_), .b(x11), .c(x10), .d(new_n46_), .O(new_n78_));
  ...
  nor3   g59(.a(new_n102_), .b(x11), .c(new_n61_), .O(new_n103_));
  inv1   g60(.a(x22), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(new_n93_), .c(x20), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n103_), .c(x16), .d(x15), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n60_), .c(x00), .O(z10));
  nand4  g65(.a(new_n106_), .b(new_n103_), .c(new_n92_), .d(x15), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n60_), .c(x00), .O(z11));
  ...
  nand4  g77(.a(new_n120_), .b(new_n62_), .c(new_n45_), .d(new_n44_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n60_), .c(x00), .O(z14));
  aoi21  g79(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n59_), .c(new_n124_), .O(z15));
  aoi21  g82(.a(new_n61_), .b(new_n60_), .c(x00), .O(z17));
  zero   g83(.O(z16));
endmodule
