...
module FAU ( 
  ...
  nor3   g28(.a(new_n68_), .b(new_n57_), .c(new_n64_), .O(z05));
  nand4  g29(.a(x11), .b(x10), .c(new_n64_), .d(x02), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(x00), .c(new_n47_), .O(z06));
  inv1   g31(.a(x12), .O(new_n75_));
  nand4  g32(.a(new_n75_), .b(x11), .c(x10), .d(new_n64_), .O(new_n76_));
  nand2  g33(.a(new_n76_), .b(x01), .O(new_n77_));
  nand3  g34(.a(new_n77_), .b(x02), .c(x00), .O(new_n78_));
  oai21  g35(.a(new_n47_), .b(x00), .c(new_n78_), .O(z07));
  ...
  nand4  g46(.a(new_n67_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n90_));
  ...
  nand3  g52(.a(new_n89_), .b(new_n88_), .c(x12), .O(new_n96_));
  nor3   g53(.a(new_n96_), .b(x11), .c(new_n48_), .O(new_n97_));
  inv1   g54(.a(x15), .O(new_n98_));
  nor2   g55(.a(new_n86_), .b(new_n98_), .O(new_n99_));
  nor2   g56(.a(x22), .b(x21), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n99_), .c(new_n97_), .d(x20), .O(new_n101_));
  aoi21  g58(.a(new_n101_), .b(new_n47_), .c(x00), .O(z10));
  nor2   g59(.a(new_n92_), .b(new_n98_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n87_), .c(x20), .d(new_n86_), .O(new_n104_));
  ...
  nand4  g72(.a(new_n54_), .b(new_n57_), .c(new_n64_), .d(new_n48_), .O(new_n116_));
