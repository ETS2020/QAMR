...
module FAU ( 
  ...
  or2    g14(.a(new_n57_), .b(new_n55_), .O(new_n58_));
  ...
  nand3  g18(.a(new_n45_), .b(new_n44_), .c(new_n56_), .O(new_n62_));
  ...
  nand4  g42(.a(new_n85_), .b(x02), .c(new_n44_), .d(new_n56_), .O(new_n86_));
  ...
  nand4  g52(.a(new_n68_), .b(x02), .c(new_n44_), .d(new_n56_), .O(new_n96_));
  ...
  nand3  g67(.a(new_n63_), .b(x17), .c(new_n45_), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n44_), .c(new_n56_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n109_), .c(x24), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(x09), .O(new_n115_));
  inv1   g72(.a(new_n115_), .O(z12));
  nor3   g73(.a(new_n57_), .b(x19), .c(new_n53_), .O(z13));
  nand4  g74(.a(new_n48_), .b(new_n46_), .c(new_n55_), .d(new_n45_), .O(new_n118_));
  ...
  oai21  g78(.a(new_n120_), .b(new_n56_), .c(new_n121_), .O(z15));
