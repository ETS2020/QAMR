...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n61_, new_n63_, new_n64_, new_n65_, new_n67_, new_n72_,
  ...
  nand4  g34(.a(new_n79_), .b(new_n53_), .c(x17), .d(new_n72_), .O(new_n80_));
  nor2   g35(.a(new_n80_), .b(new_n54_), .O(z08));
  inv1   g36(.a(x21), .O(new_n82_));
  inv1   g37(.a(x22), .O(new_n83_));
  inv1   g38(.a(x11), .O(new_n84_));
  nor2   g39(.a(new_n48_), .b(x01), .O(new_n85_));
  ...
  nor2   g46(.a(new_n53_), .b(new_n45_), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n91_), .c(new_n54_), .O(new_n93_));
  ...
  nand4  g52(.a(new_n97_), .b(new_n54_), .c(x18), .d(x01), .O(new_n98_));
  ...
  nand4  g59(.a(new_n92_), .b(x21), .c(new_n91_), .d(new_n54_), .O(new_n105_));
  ...
  nand3  g66(.a(new_n54_), .b(x17), .c(new_n48_), .O(new_n112_));
  ...
  oai21  g70(.a(new_n112_), .b(new_n57_), .c(new_n47_), .O(z13));
  nand2  g71(.a(new_n58_), .b(new_n49_), .O(new_n117_));
  inv1   g72(.a(new_n117_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n53_), .c(new_n52_), .d(new_n64_), .O(new_n119_));
  nor2   g74(.a(new_n119_), .b(x19), .O(z14));
  nand3  g75(.a(x19), .b(new_n48_), .c(new_n45_), .O(new_n121_));
  oai21  g76(.a(new_n85_), .b(new_n44_), .c(new_n121_), .O(z15));
  nor2   g77(.a(new_n45_), .b(x00), .O(z16));
  nand2  g78(.a(new_n85_), .b(new_n44_), .O(new_n124_));
