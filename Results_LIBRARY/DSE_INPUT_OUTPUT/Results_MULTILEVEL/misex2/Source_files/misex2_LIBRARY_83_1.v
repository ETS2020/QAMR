...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n68_, new_n70_, new_n71_, new_n72_, new_n75_, new_n76_, new_n78_,
  ...
  inv1   g31(.a(new_n72_), .O(new_n75_));
  ...
  nor2   g39(.a(x03), .b(new_n57_), .O(new_n83_));
  ...
  aoi21  g44(.a(new_n87_), .b(new_n56_), .c(x00), .O(z08));
  ...
  nor3   g50(.a(new_n93_), .b(x11), .c(new_n57_), .O(new_n94_));
  ...
  nand4  g55(.a(new_n98_), .b(new_n94_), .c(new_n90_), .d(new_n89_), .O(new_n99_));
  aoi21  g56(.a(new_n99_), .b(new_n56_), .c(x00), .O(z09));
  inv1   g57(.a(x11), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n92_), .c(new_n91_), .d(x12), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(new_n89_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n95_), .c(x20), .d(x16), .O(new_n106_));
  nor2   g63(.a(new_n106_), .b(x22), .O(z10));
  nand4  g64(.a(new_n98_), .b(new_n94_), .c(new_n90_), .d(x15), .O(new_n108_));
  ...
  aoi21  g82(.a(new_n57_), .b(new_n56_), .c(x00), .O(z17));
  zero   g83(.O(z16));
endmodule
