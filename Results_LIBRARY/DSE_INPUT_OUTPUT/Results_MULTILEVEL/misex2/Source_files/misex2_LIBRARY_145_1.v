...
module FAU ( 
  ...
  inv1   g044(.a(x23), .O(new_n88_));
  inv1   g045(.a(new_n57_), .O(new_n89_));
  ...
  aoi21  g052(.a(new_n95_), .b(new_n88_), .c(x06), .O(z08));
  ...
  nand4  g065(.a(new_n108_), .b(new_n52_), .c(new_n98_), .d(new_n97_), .O(new_n109_));
  ...
  nand4  g080(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n50_), .O(new_n124_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n98_), .c(new_n70_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(new_n52_), .O(z11));
  inv1   g086(.a(x24), .O(new_n130_));
  nand2  g087(.a(x10), .b(x02), .O(new_n131_));
  nand4  g088(.a(new_n131_), .b(new_n52_), .c(x01), .d(x00), .O(new_n132_));
  nand2  g089(.a(x23), .b(x06), .O(new_n133_));
  nand3  g090(.a(new_n88_), .b(new_n50_), .c(new_n45_), .O(new_n134_));
  aoi21  g091(.a(new_n134_), .b(new_n133_), .c(new_n48_), .O(new_n135_));
  oai21  g092(.a(x19), .b(x02), .c(x23), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(new_n51_), .O(new_n137_));
  oai21  g094(.a(new_n137_), .b(new_n135_), .c(new_n44_), .O(new_n138_));
  ...
  nand3  g098(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n142_));
  oai21  g099(.a(new_n142_), .b(new_n89_), .c(new_n52_), .O(z13));
  nand3  g100(.a(new_n57_), .b(new_n46_), .c(new_n45_), .O(new_n144_));
  oai21  g101(.a(new_n144_), .b(new_n61_), .c(new_n52_), .O(z14));
  ...
  aoi21  g105(.a(new_n148_), .b(new_n147_), .c(new_n80_), .O(z15));
  oai21  g106(.a(new_n44_), .b(x00), .c(new_n52_), .O(z16));
  nand4  g107(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n70_), .O(new_n151_));
