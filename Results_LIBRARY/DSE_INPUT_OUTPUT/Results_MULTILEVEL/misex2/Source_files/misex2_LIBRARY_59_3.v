...
module FAU ( 
  ...
  aoi21  g033(.a(new_n76_), .b(new_n62_), .c(new_n70_), .O(z05));
  ...
  nor2   g037(.a(new_n80_), .b(x15), .O(z06));
  nand4  g038(.a(new_n72_), .b(x11), .c(x10), .d(new_n46_), .O(new_n82_));
  ...
  nand4  g047(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n86_), .O(new_n91_));
  ...
  nand4  g053(.a(x12), .b(new_n71_), .c(x02), .d(new_n70_), .O(new_n97_));
  inv1   g054(.a(x16), .O(new_n98_));
  nor2   g055(.a(x14), .b(x13), .O(new_n99_));
  nand4  g056(.a(new_n99_), .b(x20), .c(new_n98_), .d(new_n62_), .O(new_n100_));
  ...
  nand4  g060(.a(new_n103_), .b(new_n96_), .c(new_n95_), .d(new_n86_), .O(new_n104_));
  nand2  g061(.a(new_n104_), .b(new_n44_), .O(z09));
  nor2   g062(.a(new_n50_), .b(x15), .O(new_n106_));
  nor2   g063(.a(new_n96_), .b(new_n95_), .O(new_n107_));
  ...
  nor3   g068(.a(new_n98_), .b(new_n62_), .c(x14), .O(new_n112_));
  nand3  g069(.a(new_n96_), .b(new_n95_), .c(x20), .O(new_n113_));
  inv1   g070(.a(new_n113_), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n112_), .c(new_n111_), .d(new_n88_), .O(new_n115_));
  aoi21  g072(.a(new_n115_), .b(new_n108_), .c(x00), .O(z10));
  nand4  g073(.a(new_n88_), .b(new_n109_), .c(x12), .d(new_n71_), .O(new_n117_));
  nor2   g074(.a(new_n95_), .b(x20), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(new_n106_), .c(new_n51_), .d(x01), .O(new_n119_));
  nor2   g076(.a(new_n62_), .b(x14), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n95_), .c(x20), .d(new_n98_), .O(new_n121_));
  oai21  g078(.a(new_n121_), .b(new_n117_), .c(new_n119_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n96_), .c(new_n86_), .O(new_n123_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n70_), .c(new_n86_), .O(new_n131_));
  ...
  nand2  g091(.a(new_n54_), .b(x17), .O(new_n135_));
  nor2   g092(.a(new_n135_), .b(x19), .O(z13));
  nand4  g093(.a(new_n54_), .b(new_n49_), .c(new_n59_), .d(new_n46_), .O(new_n137_));
  nor3   g094(.a(new_n137_), .b(x19), .c(x18), .O(z14));
  aoi22  g095(.a(new_n44_), .b(x00), .c(x19), .d(new_n70_), .O(new_n139_));
  nand4  g096(.a(new_n62_), .b(new_n59_), .c(x01), .d(x00), .O(new_n140_));
  oai21  g097(.a(new_n139_), .b(x02), .c(new_n140_), .O(z15));
  aoi21  g098(.a(new_n62_), .b(x00), .c(new_n70_), .O(z16));
