...
module FAU ( 
  ...
  oai21  g035(.a(new_n78_), .b(new_n66_), .c(new_n53_), .O(z06));
  ...
  nand2  g039(.a(new_n82_), .b(new_n53_), .O(z07));
  inv1   g040(.a(new_n60_), .O(new_n84_));
  ...
  aoi21  g047(.a(new_n90_), .b(x14), .c(x08), .O(z08));
  ...
  nand3  g070(.a(x16), .b(x15), .c(new_n52_), .O(new_n114_));
  ...
  nand4  g075(.a(new_n95_), .b(new_n111_), .c(x12), .d(new_n71_), .O(new_n119_));
  ...
  oai21  g092(.a(new_n130_), .b(new_n84_), .c(new_n53_), .O(z13));
  nand3  g093(.a(new_n60_), .b(new_n46_), .c(new_n45_), .O(new_n137_));
  oai21  g094(.a(new_n137_), .b(new_n62_), .c(new_n53_), .O(z14));
  ...
  inv1   g099(.a(new_n53_), .O(new_n143_));
  nor3   g100(.a(new_n143_), .b(new_n44_), .c(x00), .O(z16));
  nor4   g101(.a(new_n143_), .b(new_n45_), .c(x01), .d(x00), .O(z17));
endmodule
