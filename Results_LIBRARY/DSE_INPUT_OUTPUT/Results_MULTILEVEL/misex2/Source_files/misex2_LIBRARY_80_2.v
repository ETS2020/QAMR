...
module FAU ( 
  ...
  nor2   g28(.a(x09), .b(new_n48_), .O(new_n72_));
  nand3  g29(.a(new_n72_), .b(x11), .c(x10), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(x01), .c(new_n46_), .O(z06));
  inv1   g31(.a(x12), .O(new_n75_));
  nand4  g32(.a(new_n72_), .b(new_n75_), .c(x11), .d(x10), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x01), .c(new_n46_), .O(z07));
  ...
  aoi21  g41(.a(new_n84_), .b(new_n46_), .c(x01), .O(z08));
  inv1   g42(.a(x21), .O(new_n86_));
  inv1   g43(.a(x22), .O(new_n87_));
  nand4  g44(.a(x12), .b(new_n66_), .c(x02), .d(new_n47_), .O(new_n88_));
  ...
  nand4  g53(.a(new_n96_), .b(new_n87_), .c(new_n86_), .d(new_n46_), .O(new_n97_));
  inv1   g54(.a(new_n97_), .O(z09));
  nand4  g55(.a(new_n91_), .b(x12), .c(new_n66_), .d(x02), .O(new_n99_));
  nor2   g56(.a(x22), .b(x21), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(x20), .c(x16), .d(x15), .O(new_n101_));
  oai21  g58(.a(new_n101_), .b(new_n99_), .c(new_n46_), .O(new_n102_));
  nand2  g59(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nor2   g60(.a(new_n87_), .b(new_n86_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n94_), .c(new_n93_), .d(new_n46_), .O(new_n105_));
  nand2  g62(.a(new_n105_), .b(new_n103_), .O(z10));
  inv1   g63(.a(x20), .O(new_n107_));
  nand4  g64(.a(new_n93_), .b(x21), .c(new_n107_), .d(new_n61_), .O(new_n108_));
  nor2   g65(.a(new_n48_), .b(x01), .O(new_n109_));
  nor2   g66(.a(x13), .b(new_n75_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n109_), .c(new_n66_), .O(new_n111_));
  nor2   g68(.a(new_n89_), .b(x14), .O(new_n112_));
  nor2   g69(.a(x21), .b(new_n107_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n112_), .c(new_n90_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n111_), .c(new_n108_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n87_), .c(new_n46_), .O(new_n116_));
  ...
  nand3  g80(.a(new_n123_), .b(new_n47_), .c(new_n46_), .O(new_n124_));
  ...
  nand3  g84(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n128_));
  nor3   g85(.a(new_n128_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g86(.a(new_n54_), .b(new_n57_), .c(new_n49_), .d(new_n48_), .O(new_n130_));
  aoi21  g87(.a(new_n130_), .b(new_n46_), .c(x01), .O(z14));
  nand4  g88(.a(x19), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n132_));
  nand2  g89(.a(new_n132_), .b(new_n120_), .O(z15));
  xor2a  g90(.a(x01), .b(x00), .O(z16));
  aoi21  g91(.a(new_n48_), .b(new_n46_), .c(x01), .O(z17));
endmodule
