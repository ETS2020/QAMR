...
module FAU ( 
  ...
  aoi21  g29(.a(new_n72_), .b(x00), .c(new_n56_), .O(z05));
  nand4  g30(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(x00), .c(new_n56_), .O(z06));
  ...
  aoi21  g42(.a(new_n85_), .b(new_n56_), .c(x00), .O(z08));
  ...
  nor3   g48(.a(new_n91_), .b(x11), .c(new_n57_), .O(new_n92_));
  ...
  aoi21  g54(.a(new_n97_), .b(new_n56_), .c(x00), .O(z09));
  inv1   g55(.a(x11), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n100_));
  ...
  nand4  g62(.a(new_n96_), .b(new_n92_), .c(new_n88_), .d(x15), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n56_), .c(x00), .O(z11));
  ...
  nor2   g80(.a(new_n56_), .b(x00), .O(z16));
  nand3  g81(.a(x02), .b(new_n56_), .c(new_n62_), .O(new_n125_));
