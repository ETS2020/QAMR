...
module FAU ( 
  ...
  inv1   g23(.a(new_n45_), .O(z04));
  nand3  g24(.a(x02), .b(x01), .c(x00), .O(new_n68_));
  nor4   g25(.a(new_n68_), .b(new_n44_), .c(new_n57_), .d(new_n47_), .O(z05));
  inv1   g26(.a(new_n68_), .O(new_n70_));
  nand4  g27(.a(new_n70_), .b(x11), .c(x10), .d(new_n47_), .O(new_n71_));
  inv1   g28(.a(new_n71_), .O(z06));
  inv1   g29(.a(x12), .O(new_n73_));
  nand3  g30(.a(new_n73_), .b(x10), .c(new_n47_), .O(new_n74_));
  ...
  nand2  g35(.a(new_n78_), .b(new_n60_), .O(new_n79_));
  inv1   g36(.a(x03), .O(new_n80_));
  inv1   g37(.a(x05), .O(new_n81_));
  nand3  g38(.a(new_n81_), .b(x04), .c(new_n80_), .O(new_n82_));
  nor2   g39(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  nor3   g40(.a(x08), .b(x07), .c(x06), .O(new_n84_));
  nor2   g41(.a(new_n52_), .b(x18), .O(new_n85_));
  nand4  g42(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(x17), .O(new_n86_));
  nand2  g43(.a(new_n86_), .b(new_n45_), .O(z08));
  inv1   g44(.a(x21), .O(new_n88_));
  inv1   g45(.a(x22), .O(new_n89_));
  inv1   g46(.a(x13), .O(new_n90_));
  nand4  g47(.a(new_n90_), .b(x12), .c(new_n44_), .d(x02), .O(new_n91_));
  ...
  nand4  g55(.a(new_n98_), .b(new_n89_), .c(new_n88_), .d(new_n60_), .O(new_n99_));
  nand2  g56(.a(new_n99_), .b(new_n45_), .O(z09));
  nand3  g57(.a(new_n52_), .b(x18), .c(x01), .O(new_n101_));
  nand3  g58(.a(x22), .b(x21), .c(new_n96_), .O(new_n102_));
  nor2   g59(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g60(.a(new_n44_), .b(x02), .O(new_n104_));
  ...
  nand3  g68(.a(x18), .b(x11), .c(x01), .O(new_n112_));
  inv1   g69(.a(new_n112_), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(x21), .c(new_n96_), .d(new_n52_), .O(new_n114_));
  nor2   g71(.a(x13), .b(new_n73_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n78_), .c(new_n44_), .O(new_n116_));
  nor2   g73(.a(new_n93_), .b(x14), .O(new_n117_));
  nor2   g74(.a(x21), .b(new_n96_), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(new_n117_), .c(new_n94_), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n116_), .c(new_n114_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n89_), .c(new_n60_), .O(new_n121_));
  ...
  nand3  g83(.a(new_n52_), .b(x17), .c(new_n46_), .O(new_n127_));
  nand2  g84(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand3  g85(.a(new_n128_), .b(new_n61_), .c(new_n60_), .O(new_n129_));
  ...
  oai21  g90(.a(new_n127_), .b(new_n133_), .c(new_n45_), .O(z13));
  ...
  aoi22  g95(.a(new_n45_), .b(x00), .c(x19), .d(new_n61_), .O(new_n139_));
  nand4  g96(.a(x11), .b(new_n57_), .c(x01), .d(x00), .O(new_n140_));
  oai21  g97(.a(new_n139_), .b(x02), .c(new_n140_), .O(z15));
  aoi21  g98(.a(x11), .b(x00), .c(new_n61_), .O(z16));
  nand2  g99(.a(new_n79_), .b(new_n45_), .O(z17));
endmodule
