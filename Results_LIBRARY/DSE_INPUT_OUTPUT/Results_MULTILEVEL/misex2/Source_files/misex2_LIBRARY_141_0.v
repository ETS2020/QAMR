...
module FAU ( 
  ...
  nand4  g19(.a(new_n62_), .b(x12), .c(x10), .d(new_n46_), .O(new_n63_));
  ...
  nand4  g26(.a(new_n69_), .b(new_n60_), .c(x10), .d(new_n46_), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(x12), .O(z04));
  nor3   g28(.a(new_n68_), .b(new_n57_), .c(new_n46_), .O(z05));
  inv1   g29(.a(x01), .O(new_n73_));
  nand2  g30(.a(new_n60_), .b(new_n73_), .O(new_n74_));
  nand3  g31(.a(x11), .b(x10), .c(new_n46_), .O(new_n75_));
  oai21  g32(.a(new_n75_), .b(new_n61_), .c(new_n74_), .O(z06));
  ...
  nand3  g46(.a(x18), .b(x01), .c(new_n44_), .O(new_n90_));
  inv1   g47(.a(x20), .O(new_n91_));
  inv1   g48(.a(x21), .O(new_n92_));
  inv1   g49(.a(x22), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n64_), .O(new_n94_));
  oai21  g51(.a(new_n94_), .b(new_n90_), .c(new_n74_), .O(z09));
  nand4  g52(.a(x22), .b(x21), .c(new_n91_), .d(new_n64_), .O(new_n96_));
  oai21  g53(.a(new_n96_), .b(new_n90_), .c(new_n74_), .O(z10));
  nand4  g54(.a(new_n64_), .b(x18), .c(x01), .d(new_n44_), .O(new_n98_));
  inv1   g55(.a(new_n98_), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n93_), .c(x21), .d(new_n91_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(z11));
  inv1   g58(.a(x24), .O(new_n102_));
  aoi21  g59(.a(x10), .b(x02), .c(new_n73_), .O(new_n103_));
  nand2  g60(.a(new_n103_), .b(x00), .O(new_n104_));
  oai21  g61(.a(x19), .b(x02), .c(x23), .O(new_n105_));
  nand3  g62(.a(new_n64_), .b(x17), .c(new_n45_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(x11), .c(new_n73_), .d(new_n44_), .O(new_n108_));
  ...
  nand4  g68(.a(new_n64_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(x11), .c(x01), .O(z13));
  nand4  g70(.a(new_n46_), .b(new_n45_), .c(new_n73_), .d(new_n44_), .O(new_n114_));
  inv1   g71(.a(new_n114_), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n47_), .c(x11), .d(new_n57_), .O(new_n116_));
  nor3   g73(.a(new_n116_), .b(x19), .c(x18), .O(z14));
  aoi21  g74(.a(x11), .b(new_n45_), .c(new_n103_), .O(new_n118_));
  nand4  g75(.a(x19), .b(x11), .c(new_n45_), .d(new_n73_), .O(new_n119_));
  oai21  g76(.a(new_n118_), .b(new_n44_), .c(new_n119_), .O(z15));
  oai21  g77(.a(new_n73_), .b(x00), .c(new_n74_), .O(z16));
  aoi21  g78(.a(new_n82_), .b(x11), .c(x01), .O(z17));
endmodule
