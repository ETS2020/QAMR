...
module FAU ( 
  ...
  inv1   g19(.a(new_n53_), .O(z06));
  inv1   g20(.a(x00), .O(new_n66_));
  inv1   g21(.a(x01), .O(new_n67_));
  aoi21  g22(.a(new_n46_), .b(new_n67_), .c(new_n66_), .O(z07));
  ...
  nand4  g33(.a(new_n78_), .b(new_n76_), .c(new_n75_), .d(new_n71_), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n53_), .O(z08));
  inv1   g35(.a(x21), .O(new_n81_));
  inv1   g36(.a(x22), .O(new_n82_));
  inv1   g37(.a(x11), .O(new_n83_));
  nand4  g38(.a(x12), .b(new_n83_), .c(x02), .d(new_n67_), .O(new_n84_));
  ...
  nand3  g45(.a(new_n90_), .b(new_n89_), .c(new_n55_), .O(new_n91_));
  oai21  g46(.a(new_n88_), .b(new_n84_), .c(new_n91_), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n82_), .c(new_n81_), .d(new_n66_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z09));
  nand2  g49(.a(new_n55_), .b(x18), .O(new_n95_));
  nand3  g50(.a(x22), .b(x21), .c(new_n89_), .O(new_n96_));
  oai21  g51(.a(new_n96_), .b(new_n95_), .c(new_n66_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(x01), .O(new_n98_));
  inv1   g53(.a(x12), .O(new_n99_));
  nor2   g54(.a(x13), .b(new_n99_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n83_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(new_n102_));
  nor3   g57(.a(new_n86_), .b(new_n85_), .c(x14), .O(new_n103_));
  nand3  g58(.a(new_n82_), .b(new_n81_), .c(x20), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(new_n71_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n98_), .O(z10));
  nand4  g62(.a(new_n90_), .b(x21), .c(new_n89_), .d(new_n55_), .O(new_n108_));
  nand3  g63(.a(new_n100_), .b(new_n69_), .c(new_n83_), .O(new_n109_));
  nor2   g64(.a(new_n85_), .b(x14), .O(new_n110_));
  nor2   g65(.a(x21), .b(new_n89_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n86_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n82_), .c(new_n66_), .O(new_n114_));
  inv1   g69(.a(new_n114_), .O(z11));
  oai21  g70(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g71(.a(new_n55_), .b(x17), .c(new_n46_), .O(new_n117_));
  ...
  nor3   g75(.a(new_n61_), .b(x19), .c(new_n44_), .O(z13));
  nand3  g76(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n59_), .c(new_n53_), .O(z14));
  nor2   g78(.a(x19), .b(x00), .O(new_n124_));
  nor3   g79(.a(new_n124_), .b(x02), .c(x01), .O(z15));
  nand2  g80(.a(new_n70_), .b(new_n53_), .O(z17));
  zero   g81(.O(z04));
  zero   g82(.O(z05));
  buf    g83(.a(x01), .O(z16));
endmodule
