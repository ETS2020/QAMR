...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n123_, new_n124_, new_n125_, new_n128_, new_n130_, new_n133_;
  ...
  aoi21  g27(.a(new_n70_), .b(x01), .c(new_n57_), .O(z04));
  nand3  g28(.a(x10), .b(x09), .c(x02), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x01), .c(new_n57_), .O(z05));
  inv1   g30(.a(x11), .O(new_n74_));
  nor4   g31(.a(new_n66_), .b(new_n74_), .c(new_n58_), .d(x09), .O(z06));
  ...
  nand4  g40(.a(new_n83_), .b(x02), .c(new_n62_), .d(new_n57_), .O(new_n84_));
  ...
  nand4  g48(.a(x12), .b(new_n74_), .c(x02), .d(new_n62_), .O(new_n92_));
  ...
  nand4  g57(.a(new_n100_), .b(new_n91_), .c(new_n90_), .d(new_n57_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(z09));
  nand4  g59(.a(new_n95_), .b(x12), .c(new_n74_), .d(x02), .O(new_n103_));
  nand3  g60(.a(new_n91_), .b(new_n90_), .c(x20), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(x16), .c(x15), .O(new_n106_));
  oai21  g63(.a(new_n106_), .b(new_n103_), .c(new_n57_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n62_), .O(new_n108_));
  ...
  oai21  g70(.a(new_n113_), .b(new_n103_), .c(new_n57_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n62_), .O(new_n115_));
  nand4  g72(.a(new_n110_), .b(new_n109_), .c(new_n91_), .d(x21), .O(new_n116_));
  ...
  nand3  g77(.a(new_n64_), .b(x17), .c(new_n46_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n62_), .c(new_n57_), .O(new_n123_));
  ...
  nand4  g84(.a(new_n59_), .b(new_n58_), .c(new_n47_), .d(new_n46_), .O(new_n128_));
  aoi21  g85(.a(new_n128_), .b(new_n57_), .c(x01), .O(z14));
  nand3  g86(.a(new_n48_), .b(x19), .c(new_n46_), .O(new_n130_));
  nand2  g87(.a(new_n130_), .b(new_n119_), .O(z15));
