...
module FAU ( 
  ...
  nor2   g033(.a(new_n76_), .b(new_n58_), .O(z05));
  ...
  nand4  g054(.a(new_n97_), .b(x12), .c(new_n72_), .d(new_n44_), .O(new_n98_));
  ...
  nor2   g060(.a(new_n86_), .b(new_n61_), .O(new_n104_));
  nand3  g061(.a(new_n104_), .b(new_n103_), .c(new_n63_), .O(new_n105_));
  oai21  g062(.a(new_n102_), .b(new_n98_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n96_), .c(new_n95_), .d(new_n45_), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(z09));
  nand3  g065(.a(new_n63_), .b(x18), .c(x01), .O(new_n109_));
  ...
  nor3   g070(.a(new_n113_), .b(new_n46_), .c(x01), .O(new_n114_));
  ...
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n71_), .O(z10));
  nand4  g076(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n63_), .O(new_n120_));
  nor2   g077(.a(new_n99_), .b(x14), .O(new_n121_));
  nor2   g078(.a(x21), .b(new_n103_), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n121_), .c(new_n100_), .d(new_n112_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n98_), .c(new_n120_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n96_), .c(new_n45_), .O(new_n125_));
  ...
  nand4  g088(.a(new_n131_), .b(new_n44_), .c(new_n61_), .d(new_n45_), .O(new_n132_));
  ...
  nand4  g094(.a(new_n44_), .b(new_n46_), .c(new_n61_), .d(new_n45_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x09), .O(new_n139_));
  nand4  g096(.a(new_n139_), .b(new_n86_), .c(new_n48_), .d(new_n58_), .O(new_n140_));
  ...
  nor2   g101(.a(new_n61_), .b(x00), .O(z16));
  nand4  g102(.a(new_n44_), .b(x02), .c(new_n61_), .d(new_n45_), .O(new_n146_));
