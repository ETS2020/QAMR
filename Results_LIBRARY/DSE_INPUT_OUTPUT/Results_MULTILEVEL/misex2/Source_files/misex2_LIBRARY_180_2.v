...
module FAU ( 
  ...
  nand3  g025(.a(new_n68_), .b(x01), .c(x00), .O(new_n69_));
  nand4  g026(.a(x13), .b(x12), .c(x11), .d(x10), .O(new_n70_));
  ...
  nand2  g049(.a(new_n92_), .b(new_n58_), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  inv1   g052(.a(x11), .O(new_n96_));
  nand4  g053(.a(x12), .b(new_n96_), .c(x02), .d(new_n65_), .O(new_n97_));
  ...
  nand4  g059(.a(new_n102_), .b(x18), .c(x13), .d(x01), .O(new_n103_));
  oai21  g060(.a(new_n101_), .b(new_n97_), .c(new_n103_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n95_), .c(new_n94_), .d(new_n64_), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(z09));
  nand3  g063(.a(new_n61_), .b(x18), .c(x01), .O(new_n107_));
  inv1   g064(.a(x20), .O(new_n108_));
  nand3  g065(.a(x22), .b(x21), .c(new_n108_), .O(new_n109_));
  nor2   g066(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g067(.a(new_n96_), .b(x02), .O(new_n111_));
  nand2  g068(.a(new_n100_), .b(x12), .O(new_n112_));
  ...
  oai21  g074(.a(new_n117_), .b(x00), .c(new_n58_), .O(z10));
  and2   g075(.a(x18), .b(x01), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(x21), .c(new_n108_), .d(new_n61_), .O(new_n120_));
  nand4  g077(.a(new_n57_), .b(x12), .c(new_n96_), .d(x02), .O(new_n121_));
  nor2   g078(.a(new_n98_), .b(x14), .O(new_n122_));
  nor2   g079(.a(x21), .b(new_n108_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n122_), .c(new_n99_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n95_), .c(new_n64_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n58_), .O(z11));
  ...
  nand3  g088(.a(new_n61_), .b(x17), .c(new_n46_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n65_), .c(new_n64_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n128_), .c(x09), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n58_), .O(z12));
  inv1   g094(.a(new_n48_), .O(new_n138_));
  oai21  g095(.a(new_n132_), .b(new_n138_), .c(new_n58_), .O(z13));
  nand3  g096(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n140_));
  oai21  g097(.a(new_n140_), .b(new_n62_), .c(new_n58_), .O(z14));
  oai21  g098(.a(x10), .b(new_n65_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n46_), .c(new_n65_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n58_), .O(z15));
  nand3  g102(.a(x13), .b(x01), .c(new_n64_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand2  g104(.a(new_n86_), .b(new_n58_), .O(z17));
endmodule
