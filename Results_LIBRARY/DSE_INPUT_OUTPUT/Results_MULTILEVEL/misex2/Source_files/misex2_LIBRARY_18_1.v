...
module FAU ( 
  ...
  nand3  g021(.a(new_n54_), .b(x18), .c(new_n44_), .O(new_n65_));
  ...
  nor3   g034(.a(new_n77_), .b(new_n59_), .c(new_n60_), .O(z05));
  inv1   g035(.a(new_n77_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(x11), .c(x10), .d(new_n60_), .O(new_n80_));
  inv1   g037(.a(new_n80_), .O(z06));
  nand3  g038(.a(new_n69_), .b(new_n74_), .c(x11), .O(new_n82_));
  nand2  g039(.a(new_n82_), .b(x01), .O(new_n83_));
  nand3  g040(.a(new_n83_), .b(x02), .c(x00), .O(new_n84_));
  nand2  g041(.a(new_n84_), .b(new_n72_), .O(z07));
  ...
  nor2   g046(.a(x08), .b(x06), .O(new_n90_));
  nor2   g047(.a(new_n54_), .b(x18), .O(new_n91_));
  ...
  nor2   g053(.a(new_n74_), .b(x11), .O(new_n97_));
  nand3  g054(.a(new_n97_), .b(new_n96_), .c(new_n49_), .O(new_n98_));
  ...
  nand3  g061(.a(new_n104_), .b(new_n103_), .c(new_n54_), .O(new_n105_));
  oai21  g062(.a(new_n102_), .b(new_n98_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n95_), .c(new_n94_), .d(new_n46_), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(z09));
  nor3   g065(.a(new_n95_), .b(new_n94_), .c(x20), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n54_), .c(x18), .d(x01), .O(new_n110_));
  ...
  nand4  g075(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n54_), .O(new_n119_));
  nor2   g076(.a(new_n99_), .b(x14), .O(new_n120_));
  nor2   g077(.a(x21), .b(new_n103_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n120_), .c(new_n100_), .d(new_n112_), .O(new_n122_));
  ...
  nand4  g092(.a(new_n54_), .b(x17), .c(new_n48_), .d(new_n46_), .O(new_n136_));
  aoi21  g093(.a(new_n136_), .b(new_n49_), .c(x01), .O(z13));
  ...
  aoi21  g097(.a(x19), .b(new_n48_), .c(x07), .O(new_n141_));
  oai22  g098(.a(new_n141_), .b(x01), .c(new_n140_), .d(new_n46_), .O(z15));
  nor2   g099(.a(new_n47_), .b(x00), .O(z16));
  aoi21  g100(.a(new_n86_), .b(new_n49_), .c(x01), .O(z17));
endmodule
