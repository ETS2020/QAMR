...
module FAU ( 
  ...
  nor2   g28(.a(new_n71_), .b(new_n46_), .O(z05));
  nand4  g29(.a(x11), .b(x10), .c(new_n53_), .d(x02), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(x00), .c(new_n44_), .O(z06));
  inv1   g31(.a(x12), .O(new_n75_));
  nand3  g32(.a(new_n47_), .b(new_n75_), .c(x11), .O(new_n76_));
  nand2  g33(.a(new_n76_), .b(x01), .O(new_n77_));
  nand3  g34(.a(new_n77_), .b(x02), .c(x00), .O(new_n78_));
  nand2  g35(.a(x01), .b(new_n54_), .O(new_n79_));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n44_), .d(new_n54_), .O(new_n85_));
  ...
  nand3  g64(.a(new_n63_), .b(x17), .c(new_n45_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n107_), .c(x00), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n106_), .c(new_n105_), .O(new_n110_));
  oai21  g67(.a(new_n110_), .b(new_n53_), .c(new_n79_), .O(z12));
  nor3   g68(.a(new_n55_), .b(x19), .c(new_n51_), .O(z13));
  nand4  g69(.a(new_n48_), .b(new_n46_), .c(new_n53_), .d(new_n45_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g71(.a(new_n46_), .b(new_n54_), .c(x01), .O(new_n115_));
  oai21  g72(.a(x19), .b(x00), .c(new_n45_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n115_), .O(z15));
  nand3  g74(.a(x02), .b(new_n44_), .c(new_n54_), .O(new_n119_));
