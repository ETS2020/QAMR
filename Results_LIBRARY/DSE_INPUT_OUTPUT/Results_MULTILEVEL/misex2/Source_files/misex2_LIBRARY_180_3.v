...
module FAU ( 
  ...
  nand2  g013(.a(x13), .b(x01), .O(new_n57_));
  ...
  nor2   g023(.a(x09), .b(new_n46_), .O(new_n67_));
  nand3  g024(.a(new_n67_), .b(x01), .c(x00), .O(new_n68_));
  inv1   g025(.a(x12), .O(new_n69_));
  nor2   g026(.a(x13), .b(new_n69_), .O(new_n70_));
  nand3  g027(.a(new_n70_), .b(x11), .c(x10), .O(new_n71_));
  oai22  g028(.a(new_n71_), .b(new_n68_), .c(new_n66_), .d(new_n65_), .O(z03));
  inv1   g029(.a(x13), .O(new_n73_));
  nor2   g030(.a(x12), .b(x11), .O(new_n74_));
  nand4  g031(.a(new_n74_), .b(new_n67_), .c(x10), .d(x00), .O(new_n75_));
  aoi21  g032(.a(new_n75_), .b(new_n73_), .c(new_n64_), .O(z04));
  nand3  g033(.a(x02), .b(x01), .c(x00), .O(new_n77_));
  nor4   g034(.a(new_n77_), .b(x13), .c(new_n59_), .d(new_n47_), .O(z05));
  inv1   g035(.a(new_n77_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(x11), .c(x10), .d(new_n47_), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(x13), .O(z06));
  nand2  g038(.a(x10), .b(new_n47_), .O(new_n82_));
  nand3  g039(.a(new_n73_), .b(new_n69_), .c(x11), .O(new_n83_));
  ...
  nand2  g044(.a(new_n87_), .b(new_n63_), .O(new_n88_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n60_), .c(x18), .d(x01), .O(new_n106_));
  oai21  g063(.a(new_n104_), .b(new_n100_), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n98_), .c(new_n97_), .d(new_n73_), .O(new_n108_));
  nor2   g065(.a(new_n108_), .b(x00), .O(z09));
  nand3  g066(.a(new_n60_), .b(x18), .c(x01), .O(new_n110_));
  nand3  g067(.a(x22), .b(x21), .c(new_n105_), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g069(.a(x02), .b(new_n64_), .O(new_n113_));
  nand3  g070(.a(new_n73_), .b(x12), .c(new_n99_), .O(new_n114_));
  nor2   g071(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand3  g072(.a(x16), .b(x15), .c(new_n101_), .O(new_n116_));
  ...
  nand3  g077(.a(new_n87_), .b(new_n70_), .c(new_n99_), .O(new_n121_));
  and2   g078(.a(x18), .b(x01), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(x21), .c(new_n105_), .d(new_n60_), .O(new_n123_));
  nor2   g080(.a(new_n102_), .b(x14), .O(new_n124_));
  nor2   g081(.a(x21), .b(new_n105_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n124_), .c(new_n103_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n121_), .c(new_n123_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n98_), .c(new_n63_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(new_n57_), .O(z11));
  ...
  nand3  g090(.a(new_n60_), .b(x17), .c(new_n46_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n64_), .c(new_n63_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand3  g094(.a(new_n137_), .b(new_n130_), .c(x09), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n57_), .O(z12));
  inv1   g096(.a(new_n48_), .O(new_n140_));
  oai21  g097(.a(new_n134_), .b(new_n140_), .c(new_n57_), .O(z13));
  nand3  g098(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n142_));
  oai21  g099(.a(new_n142_), .b(new_n61_), .c(new_n57_), .O(z14));
  oai21  g100(.a(x10), .b(new_n64_), .c(x02), .O(new_n144_));
  nand2  g101(.a(new_n144_), .b(x00), .O(new_n145_));
  nand3  g102(.a(x19), .b(new_n46_), .c(new_n64_), .O(new_n146_));
  nand3  g103(.a(new_n146_), .b(new_n145_), .c(new_n57_), .O(z15));
  nand3  g104(.a(new_n73_), .b(x01), .c(new_n63_), .O(new_n148_));
  inv1   g105(.a(new_n148_), .O(z16));
  nand2  g106(.a(new_n88_), .b(new_n57_), .O(z17));
endmodule
