...
module FAU ( 
  ...
  nor2   g23(.a(x09), .b(new_n57_), .O(new_n67_));
  ...
  nor2   g32(.a(new_n75_), .b(new_n58_), .O(z05));
  nand3  g33(.a(new_n67_), .b(x11), .c(x10), .O(new_n77_));
  aoi21  g34(.a(new_n77_), .b(x00), .c(new_n56_), .O(z06));
  nand4  g35(.a(new_n69_), .b(x11), .c(x10), .d(new_n46_), .O(new_n79_));
  ...
  nand4  g49(.a(new_n68_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n93_));
  ...
  nor3   g56(.a(new_n99_), .b(x11), .c(new_n57_), .O(new_n100_));
  inv1   g57(.a(x22), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n90_), .c(x20), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n100_), .c(x16), .d(x15), .O(new_n104_));
  aoi21  g61(.a(new_n104_), .b(new_n56_), .c(x00), .O(z10));
  nand4  g62(.a(new_n103_), .b(new_n100_), .c(new_n89_), .d(x15), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n56_), .c(x00), .O(z11));
  inv1   g64(.a(x24), .O(new_n108_));
  aoi21  g65(.a(x10), .b(x02), .c(new_n56_), .O(new_n109_));
  ...
  oai22  g70(.a(new_n113_), .b(new_n46_), .c(new_n56_), .d(x00), .O(z12));
  nand2  g71(.a(new_n47_), .b(x17), .O(new_n115_));
  nor2   g72(.a(new_n115_), .b(x19), .O(z13));
  nand4  g73(.a(new_n59_), .b(new_n58_), .c(new_n46_), .d(new_n57_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n56_), .c(x00), .O(z14));
  aoi21  g75(.a(new_n58_), .b(x01), .c(new_n57_), .O(new_n119_));
  nand3  g76(.a(x19), .b(new_n57_), .c(new_n56_), .O(new_n120_));
  oai21  g77(.a(new_n119_), .b(new_n62_), .c(new_n120_), .O(z15));
  nor2   g78(.a(new_n56_), .b(x00), .O(z16));
  nand3  g79(.a(x02), .b(new_n56_), .c(new_n62_), .O(new_n123_));
