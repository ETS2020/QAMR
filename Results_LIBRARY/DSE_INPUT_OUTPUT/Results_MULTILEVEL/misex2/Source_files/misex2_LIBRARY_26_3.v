...
module FAU ( 
  ...
  nand4  g21(.a(new_n48_), .b(x18), .c(new_n51_), .d(new_n56_), .O(new_n65_));
  ...
  nor2   g45(.a(new_n52_), .b(new_n45_), .O(new_n90_));
  nand3  g46(.a(new_n90_), .b(new_n89_), .c(new_n53_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n53_), .c(x18), .d(x01), .O(new_n96_));
  ...
  nand4  g58(.a(new_n90_), .b(x21), .c(new_n89_), .d(new_n53_), .O(new_n103_));
  ...
  nand3  g65(.a(new_n53_), .b(x17), .c(new_n56_), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n109_), .c(x24), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(x09), .c(new_n45_), .O(new_n112_));
  nor2   g68(.a(new_n112_), .b(x00), .O(z12));
  inv1   g69(.a(new_n48_), .O(new_n114_));
  oai21  g70(.a(new_n110_), .b(new_n114_), .c(new_n47_), .O(z13));
  oai21  g71(.a(new_n63_), .b(new_n50_), .c(new_n47_), .O(z14));
  nand3  g72(.a(x19), .b(new_n56_), .c(new_n45_), .O(new_n117_));
  oai21  g73(.a(new_n83_), .b(new_n44_), .c(new_n117_), .O(z15));
  nand2  g74(.a(new_n83_), .b(new_n44_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n47_), .O(z17));
  zero   g76(.O(z06));
  nor2   g77(.a(new_n45_), .b(new_n44_), .O(z05));
  buf    g78(.a(x01), .O(z16));
endmodule
