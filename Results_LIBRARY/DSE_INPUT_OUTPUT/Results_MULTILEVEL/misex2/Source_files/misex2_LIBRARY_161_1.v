...
module FAU ( 
  ...
  nand3  g55(.a(new_n98_), .b(new_n95_), .c(new_n91_), .O(new_n99_));
  aoi21  g56(.a(new_n99_), .b(new_n47_), .c(x00), .O(z10));
  inv1   g57(.a(x15), .O(new_n101_));
  nor2   g58(.a(x16), .b(new_n101_), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n95_), .c(new_n91_), .O(new_n103_));
  aoi21  g60(.a(new_n103_), .b(new_n47_), .c(x00), .O(z11));
  ...
  nand3  g65(.a(new_n63_), .b(x17), .c(new_n48_), .O(new_n109_));
  ...
  aoi21  g71(.a(new_n109_), .b(new_n47_), .c(x00), .O(z13));
  nand4  g72(.a(new_n59_), .b(new_n58_), .c(new_n49_), .d(new_n48_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n47_), .c(x00), .O(z14));
  aoi21  g74(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n118_));
