...
module FAU ( 
  ...
  nor2   g39(.a(new_n56_), .b(x00), .O(z16));
  inv1   g40(.a(z16), .O(new_n84_));
  ...
  nand4  g56(.a(new_n70_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n100_));
  ...
  nand3  g66(.a(new_n99_), .b(new_n98_), .c(x12), .O(new_n110_));
  nor3   g67(.a(new_n110_), .b(x11), .c(new_n57_), .O(new_n111_));
  nor2   g68(.a(x16), .b(new_n106_), .O(new_n112_));
  nor2   g69(.a(x22), .b(x21), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(x20), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n56_), .c(x00), .O(z11));
  inv1   g72(.a(x24), .O(new_n116_));
  aoi21  g73(.a(x10), .b(x02), .c(new_n56_), .O(new_n117_));
  oai21  g74(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g75(.a(new_n63_), .b(x17), .c(new_n57_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n118_), .c(x00), .O(new_n120_));
  oai21  g77(.a(new_n120_), .b(new_n117_), .c(new_n116_), .O(new_n121_));
  oai21  g78(.a(new_n121_), .b(new_n46_), .c(new_n84_), .O(z12));
  nand2  g79(.a(new_n47_), .b(x17), .O(new_n123_));
  nor2   g80(.a(new_n123_), .b(x19), .O(z13));
  nand4  g81(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n125_));
  ...
  nand3  g86(.a(x02), .b(new_n56_), .c(new_n62_), .O(new_n130_));
