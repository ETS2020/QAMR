...
module FAU ( 
  ...
  aoi21  g29(.a(new_n72_), .b(x01), .c(new_n59_), .O(z04));
  nand3  g30(.a(x10), .b(x09), .c(x02), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(x01), .c(new_n59_), .O(z05));
  ...
  nor2   g45(.a(new_n88_), .b(new_n66_), .O(z08));
  ...
  nand4  g66(.a(new_n109_), .b(new_n66_), .c(x18), .d(x01), .O(new_n110_));
  nor2   g67(.a(x13), .b(new_n71_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n70_), .c(x02), .d(new_n60_), .O(new_n112_));
  ...
  nand3  g77(.a(new_n66_), .b(x17), .c(new_n61_), .O(new_n121_));
  ...
  nand3  g88(.a(new_n131_), .b(x19), .c(new_n61_), .O(new_n132_));
  nand2  g89(.a(new_n132_), .b(new_n130_), .O(z15));
  xor2a  g90(.a(x01), .b(x00), .O(z16));
  nand2  g91(.a(new_n131_), .b(x02), .O(new_n135_));
