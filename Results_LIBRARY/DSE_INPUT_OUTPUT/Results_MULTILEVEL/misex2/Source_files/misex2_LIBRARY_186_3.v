...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n144_, new_n147_;
  nand2  g000(.a(x16), .b(x05), .O(new_n44_));
  ...
  aoi21  g022(.a(new_n65_), .b(new_n63_), .c(new_n59_), .O(z03));
  ...
  nand3  g037(.a(new_n62_), .b(new_n69_), .c(x11), .O(new_n81_));
  ...
  nand4  g045(.a(new_n88_), .b(new_n86_), .c(new_n85_), .d(new_n67_), .O(new_n89_));
  ...
  nand3  g051(.a(new_n86_), .b(x12), .c(new_n68_), .O(new_n95_));
  ...
  nand2  g065(.a(x02), .b(new_n74_), .O(new_n109_));
  ...
  nand4  g075(.a(new_n86_), .b(new_n110_), .c(x12), .d(new_n68_), .O(new_n119_));
  nand4  g076(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n51_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n94_), .c(new_n67_), .O(new_n124_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n74_), .c(new_n67_), .O(new_n132_));
  ...
  nand4  g094(.a(new_n44_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x10), .O(new_n139_));
  nand4  g096(.a(new_n139_), .b(new_n46_), .c(new_n45_), .d(new_n74_), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x00), .O(z14));
  oai21  g098(.a(x10), .b(new_n74_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n45_), .c(new_n74_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n44_), .O(z15));
  oai21  g102(.a(new_n74_), .b(x00), .c(new_n44_), .O(z16));
  nand4  g103(.a(new_n44_), .b(x02), .c(new_n74_), .d(new_n67_), .O(new_n147_));
