...
module FAU ( 
  ...
  nand2  g008(.a(x14), .b(new_n51_), .O(new_n52_));
  ...
  inv1   g039(.a(x14), .O(new_n83_));
  inv1   g040(.a(new_n59_), .O(new_n84_));
  inv1   g041(.a(x03), .O(new_n85_));
  nand3  g042(.a(x04), .b(new_n85_), .c(x02), .O(new_n86_));
  nor2   g043(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nor3   g044(.a(x07), .b(x06), .c(x05), .O(new_n88_));
  nor2   g045(.a(new_n50_), .b(x18), .O(new_n89_));
  nand4  g046(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(x17), .O(new_n90_));
  aoi21  g047(.a(new_n90_), .b(new_n83_), .c(x08), .O(z08));
  ...
  nand4  g061(.a(new_n104_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n105_));
  ...
  nand3  g070(.a(x16), .b(x15), .c(new_n83_), .O(new_n114_));
  ...
  nand4  g075(.a(new_n95_), .b(new_n111_), .c(x12), .d(new_n70_), .O(new_n119_));
  nand4  g076(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n50_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n94_), .c(new_n92_), .O(new_n124_));
  nand2  g081(.a(new_n124_), .b(new_n52_), .O(z11));
  ...
  nand3  g088(.a(new_n131_), .b(new_n44_), .c(new_n92_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n126_), .c(x09), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n52_), .O(z12));
  oai21  g092(.a(new_n130_), .b(new_n84_), .c(new_n52_), .O(z13));
  nand3  g093(.a(new_n59_), .b(new_n46_), .c(new_n45_), .O(new_n137_));
  oai21  g094(.a(new_n137_), .b(new_n61_), .c(new_n52_), .O(z14));
  ...
  nand2  g099(.a(new_n52_), .b(x01), .O(new_n143_));
  nor2   g100(.a(new_n143_), .b(x00), .O(z16));
  nand4  g101(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n92_), .O(new_n145_));
