...
module FAU ( 
  ...
  aoi21  g28(.a(new_n71_), .b(x01), .c(new_n46_), .O(z06));
  ...
  nand4  g40(.a(new_n83_), .b(new_n81_), .c(new_n80_), .d(new_n77_), .O(new_n84_));
  aoi21  g41(.a(new_n84_), .b(new_n46_), .c(x01), .O(z08));
  inv1   g42(.a(x11), .O(new_n86_));
  nor2   g43(.a(x14), .b(x13), .O(new_n87_));
  nand4  g44(.a(new_n87_), .b(x12), .c(new_n86_), .d(x02), .O(new_n88_));
  ...
  oai21  g49(.a(new_n92_), .b(new_n88_), .c(new_n46_), .O(new_n93_));
  ...
  oai21  g56(.a(new_n99_), .b(new_n88_), .c(new_n46_), .O(new_n100_));
  ...
  nand4  g63(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n61_), .O(new_n107_));
  nor2   g64(.a(new_n48_), .b(x01), .O(new_n108_));
  inv1   g65(.a(x12), .O(new_n109_));
  nor2   g66(.a(x13), .b(new_n109_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n108_), .c(new_n86_), .O(new_n111_));
  nor2   g68(.a(new_n89_), .b(x14), .O(new_n112_));
  nor2   g69(.a(x21), .b(new_n105_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n112_), .c(new_n90_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n111_), .c(new_n107_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n104_), .c(new_n46_), .O(new_n116_));
  inv1   g73(.a(new_n116_), .O(z11));
  inv1   g74(.a(x24), .O(new_n118_));
  aoi21  g75(.a(x10), .b(x02), .c(new_n46_), .O(new_n119_));
  oai21  g76(.a(x19), .b(x02), .c(x23), .O(new_n120_));
  nand3  g77(.a(new_n61_), .b(x17), .c(new_n48_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n120_), .c(x01), .O(new_n122_));
  oai21  g79(.a(new_n122_), .b(new_n119_), .c(new_n118_), .O(new_n123_));
  nand2  g80(.a(new_n47_), .b(x00), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n49_), .c(new_n124_), .O(z12));
  aoi21  g82(.a(new_n121_), .b(new_n46_), .c(x01), .O(z13));
  nand4  g83(.a(new_n54_), .b(new_n57_), .c(new_n49_), .d(new_n48_), .O(new_n127_));
  aoi21  g84(.a(new_n127_), .b(new_n46_), .c(x01), .O(z14));
  nand2  g85(.a(x19), .b(new_n48_), .O(new_n129_));
  aoi21  g86(.a(new_n129_), .b(new_n46_), .c(x01), .O(new_n130_));
  or2    g87(.a(new_n130_), .b(new_n119_), .O(z15));
  nor2   g88(.a(new_n47_), .b(x00), .O(z16));
  aoi21  g89(.a(new_n48_), .b(new_n46_), .c(x01), .O(z17));
endmodule
