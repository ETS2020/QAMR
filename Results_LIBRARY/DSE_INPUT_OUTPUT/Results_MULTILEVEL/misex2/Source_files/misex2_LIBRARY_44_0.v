...
module FAU ( 
  ...
  oai22  g13(.a(new_n58_), .b(new_n57_), .c(x01), .d(x00), .O(z06));
  ...
  nand3  g18(.a(new_n48_), .b(x11), .c(x10), .O(new_n64_));
  oai21  g19(.a(new_n64_), .b(new_n63_), .c(new_n62_), .O(z07));
  inv1   g20(.a(x20), .O(new_n66_));
  inv1   g21(.a(x21), .O(new_n67_));
  inv1   g22(.a(x22), .O(new_n68_));
  inv1   g23(.a(x19), .O(new_n69_));
  nand4  g24(.a(new_n69_), .b(x18), .c(x01), .d(new_n60_), .O(new_n70_));
  ...
  nand4  g30(.a(new_n75_), .b(x22), .c(x21), .d(new_n66_), .O(new_n76_));
  aoi21  g31(.a(new_n76_), .b(x01), .c(x00), .O(z10));
  nand4  g32(.a(new_n75_), .b(new_n68_), .c(x21), .d(new_n66_), .O(new_n78_));
  ...
  aoi21  g38(.a(new_n83_), .b(x02), .c(new_n60_), .O(z15));
