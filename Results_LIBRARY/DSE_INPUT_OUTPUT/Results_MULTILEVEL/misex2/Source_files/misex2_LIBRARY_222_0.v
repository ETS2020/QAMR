...
module FAU ( 
  ...
  nand4  g13(.a(new_n56_), .b(new_n45_), .c(new_n44_), .d(x14), .O(new_n57_));
  nor2   g14(.a(new_n57_), .b(x19), .O(z01));
  nor2   g15(.a(new_n55_), .b(x10), .O(new_n59_));
  nand4  g16(.a(new_n59_), .b(new_n45_), .c(new_n44_), .d(x14), .O(new_n60_));
  ...
  nor4   g36(.a(new_n67_), .b(new_n73_), .c(new_n46_), .d(x09), .O(z06));
  nand2  g37(.a(new_n50_), .b(x01), .O(new_n81_));
  nand3  g38(.a(new_n74_), .b(x11), .c(x10), .O(new_n82_));
  oai22  g39(.a(new_n82_), .b(new_n81_), .c(new_n71_), .d(x01), .O(new_n83_));
  nand3  g40(.a(new_n83_), .b(x02), .c(x00), .O(new_n84_));
  inv1   g41(.a(new_n84_), .O(z07));
  nand2  g42(.a(x02), .b(new_n47_), .O(new_n86_));
  ...
  nand4  g59(.a(x22), .b(x21), .c(new_n102_), .d(new_n63_), .O(new_n103_));
  oai21  g60(.a(new_n103_), .b(new_n101_), .c(new_n72_), .O(z10));
  nand3  g61(.a(new_n98_), .b(new_n95_), .c(x21), .O(new_n105_));
  ...
  nand3  g67(.a(new_n63_), .b(x17), .c(new_n49_), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(x14), .c(new_n48_), .d(new_n47_), .O(new_n113_));
  ...
  nand4  g73(.a(new_n63_), .b(x17), .c(new_n49_), .d(new_n47_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(x14), .c(x01), .O(z13));
  nor2   g75(.a(new_n51_), .b(x10), .O(new_n119_));
  nand4  g76(.a(new_n119_), .b(new_n45_), .c(new_n44_), .d(x14), .O(new_n120_));
  nor2   g77(.a(new_n120_), .b(x19), .O(z14));
  aoi21  g78(.a(new_n46_), .b(x01), .c(new_n49_), .O(new_n122_));
  aoi21  g79(.a(x19), .b(new_n49_), .c(new_n71_), .O(new_n123_));
  oai22  g80(.a(new_n123_), .b(x01), .c(new_n122_), .d(new_n47_), .O(z15));
  aoi21  g81(.a(new_n86_), .b(x14), .c(x01), .O(z17));
endmodule
