...
module FAU ( 
  ...
  nand4  g28(.a(new_n71_), .b(x10), .c(new_n46_), .d(new_n65_), .O(new_n72_));
  nor3   g29(.a(new_n72_), .b(x12), .c(x11), .O(z04));
  nand4  g30(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(new_n65_), .c(new_n62_), .O(z05));
  ...
  nand4  g44(.a(new_n87_), .b(new_n84_), .c(new_n65_), .d(x04), .O(new_n88_));
  ...
  nand3  g51(.a(new_n94_), .b(x12), .c(new_n76_), .O(new_n95_));
  ...
  nand4  g59(.a(new_n102_), .b(new_n93_), .c(new_n92_), .d(new_n61_), .O(new_n103_));
  nand2  g60(.a(new_n103_), .b(new_n44_), .O(z09));
  nand3  g61(.a(x18), .b(new_n65_), .c(x01), .O(new_n105_));
  ...
  nand3  g65(.a(new_n108_), .b(new_n94_), .c(new_n76_), .O(new_n109_));
  ...
  nand3  g71(.a(new_n114_), .b(new_n106_), .c(new_n51_), .O(new_n115_));
  ...
  nand3  g75(.a(new_n118_), .b(new_n93_), .c(new_n61_), .O(new_n119_));
  ...
  nand3  g80(.a(new_n51_), .b(x17), .c(new_n45_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand3  g82(.a(new_n125_), .b(new_n62_), .c(new_n61_), .O(new_n126_));
  ...
  nand4  g90(.a(new_n133_), .b(new_n50_), .c(new_n49_), .d(new_n58_), .O(new_n134_));
  nor2   g91(.a(new_n134_), .b(x19), .O(z14));
  aoi22  g92(.a(new_n44_), .b(x00), .c(x19), .d(new_n62_), .O(new_n136_));
  nand3  g93(.a(new_n66_), .b(new_n58_), .c(new_n65_), .O(new_n137_));
  oai21  g94(.a(new_n136_), .b(x02), .c(new_n137_), .O(z15));
  nand3  g95(.a(new_n65_), .b(x01), .c(new_n61_), .O(new_n139_));
  inv1   g96(.a(new_n139_), .O(z16));
  nand2  g97(.a(new_n94_), .b(new_n61_), .O(new_n141_));
