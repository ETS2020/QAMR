...
module FAU ( 
  ...
  nand3  g13(.a(x11), .b(x10), .c(new_n58_), .O(new_n59_));
  oai21  g14(.a(new_n59_), .b(new_n48_), .c(new_n47_), .O(z06));
  inv1   g15(.a(x12), .O(new_n61_));
  nand4  g16(.a(new_n61_), .b(x11), .c(x10), .d(new_n58_), .O(new_n62_));
  ...
  nand4  g29(.a(new_n67_), .b(new_n74_), .c(x21), .d(new_n71_), .O(new_n75_));
  aoi21  g30(.a(new_n75_), .b(x01), .c(x00), .O(z11));
  aoi21  g31(.a(x10), .b(x02), .c(x24), .O(new_n77_));
  nand4  g32(.a(new_n77_), .b(x09), .c(x01), .d(x00), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(new_n47_), .O(z12));
  inv1   g34(.a(x00), .O(new_n80_));
  nand2  g35(.a(new_n49_), .b(x01), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(x02), .c(new_n80_), .O(z15));
  inv1   g37(.a(x01), .O(new_n83_));
  nor2   g38(.a(new_n83_), .b(x00), .O(z16));
  zero   g39(.O(z00));
  zero   g40(.O(z02));
  zero   g41(.O(z17));
