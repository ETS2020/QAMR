...
module FAU ( 
  ...
  nand4  g76(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n55_), .O(new_n120_));
  inv1   g77(.a(new_n120_), .O(new_n121_));
  nand4  g78(.a(new_n121_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n122_));
  nor2   g79(.a(new_n122_), .b(x19), .O(z14));
  aoi21  g80(.a(new_n52_), .b(x01), .c(new_n45_), .O(new_n124_));
  nand3  g81(.a(x19), .b(new_n45_), .c(new_n44_), .O(new_n125_));
  oai21  g82(.a(new_n124_), .b(new_n55_), .c(new_n125_), .O(z15));
