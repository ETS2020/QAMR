...
module FAU ( 
  ...
  wire new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n54_, new_n55_,
    ...
    new_n75_, new_n77_, new_n79_, new_n81_, new_n82_, new_n86_, new_n87_;
  ...
  nand4  g30(.a(new_n74_), .b(x22), .c(x21), .d(new_n68_), .O(new_n77_));
  inv1   g31(.a(new_n77_), .O(z10));
  nand4  g32(.a(new_n74_), .b(new_n70_), .c(x21), .d(new_n68_), .O(new_n79_));
  ...
  aoi21  g38(.a(new_n50_), .b(x01), .c(new_n86_), .O(new_n87_));
  oai21  g39(.a(new_n87_), .b(z16), .c(new_n48_), .O(z15));
  zero   g40(.O(z00));
  zero   g41(.O(z01));
  zero   g42(.O(z02));
  zero   g43(.O(z13));
