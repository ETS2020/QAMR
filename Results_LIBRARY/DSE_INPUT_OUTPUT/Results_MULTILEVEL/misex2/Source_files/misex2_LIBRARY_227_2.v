...
module FAU ( 
  ...
  nand3  g038(.a(x11), .b(x10), .c(new_n46_), .O(new_n82_));
  oai21  g039(.a(new_n82_), .b(new_n66_), .c(new_n52_), .O(z06));
  nand3  g040(.a(new_n68_), .b(new_n73_), .c(x11), .O(new_n84_));
  ...
  aoi21  g063(.a(new_n106_), .b(new_n88_), .c(x22), .O(z09));
  nor2   g064(.a(new_n51_), .b(new_n96_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n64_), .c(new_n102_), .d(x01), .O(new_n109_));
  nand3  g066(.a(new_n88_), .b(x02), .c(new_n44_), .O(new_n110_));
  nor2   g067(.a(x13), .b(new_n73_), .O(new_n111_));
  nand2  g068(.a(new_n111_), .b(new_n72_), .O(new_n112_));
  ...
  nand3  g073(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(new_n117_));
  aoi21  g074(.a(new_n117_), .b(new_n109_), .c(x00), .O(z10));
  nand4  g075(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n50_), .O(new_n119_));
  nand3  g076(.a(new_n111_), .b(new_n89_), .c(new_n72_), .O(new_n120_));
  ...
  oai21  g080(.a(new_n123_), .b(new_n120_), .c(new_n119_), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n51_), .c(new_n88_), .d(new_n71_), .O(new_n125_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n44_), .c(new_n71_), .O(new_n133_));
  ...
  inv1   g093(.a(new_n59_), .O(new_n137_));
  ...
  nor3   g101(.a(new_n78_), .b(new_n44_), .c(x00), .O(z16));
  nand4  g102(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n71_), .O(new_n146_));
