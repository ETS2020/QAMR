...
module FAU ( 
  ...
  nor2   g35(.a(x12), .b(new_n78_), .O(new_n79_));
  nand3  g36(.a(new_n79_), .b(new_n61_), .c(x10), .O(new_n80_));
  aoi21  g37(.a(new_n80_), .b(x01), .c(new_n53_), .O(z07));
  inv1   g38(.a(x08), .O(new_n82_));
  inv1   g39(.a(x05), .O(new_n83_));
  inv1   g40(.a(x06), .O(new_n84_));
  inv1   g41(.a(x03), .O(new_n85_));
  nand4  g42(.a(new_n85_), .b(x02), .c(new_n60_), .d(new_n53_), .O(new_n86_));
  ...
  nand4  g60(.a(new_n103_), .b(new_n93_), .c(new_n92_), .d(new_n53_), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(z09));
  nor3   g62(.a(new_n93_), .b(new_n92_), .c(x20), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n65_), .c(x18), .d(x01), .O(new_n107_));
  inv1   g64(.a(x13), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(x12), .c(new_n78_), .O(new_n109_));
  ...
  nand4  g72(.a(new_n98_), .b(x12), .c(new_n78_), .d(x02), .O(new_n116_));
  nand3  g73(.a(new_n113_), .b(new_n97_), .c(x15), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n116_), .c(new_n53_), .O(new_n118_));
  ...
  aoi21  g81(.a(x10), .b(x02), .c(new_n53_), .O(new_n125_));
  oai21  g82(.a(x19), .b(x02), .c(x23), .O(new_n126_));
  nand3  g83(.a(new_n65_), .b(x17), .c(new_n46_), .O(new_n127_));
  aoi21  g84(.a(new_n127_), .b(new_n126_), .c(x01), .O(new_n128_));
  oai21  g85(.a(new_n128_), .b(new_n125_), .c(new_n124_), .O(new_n129_));
  oai22  g86(.a(new_n129_), .b(new_n47_), .c(x01), .d(new_n53_), .O(z12));
  aoi21  g87(.a(new_n127_), .b(new_n53_), .c(x01), .O(z13));
  nand4  g88(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n132_));
  nor2   g89(.a(new_n132_), .b(x19), .O(z14));
  nand2  g90(.a(x10), .b(x02), .O(new_n134_));
  nand3  g91(.a(new_n134_), .b(x01), .c(x00), .O(new_n135_));
  nand3  g92(.a(new_n48_), .b(x19), .c(new_n46_), .O(new_n136_));
  nand2  g93(.a(new_n136_), .b(new_n135_), .O(z15));
  nor2   g94(.a(new_n60_), .b(x00), .O(z16));
