...
module FAU ( 
  ...
  nand4  g20(.a(new_n63_), .b(x18), .c(new_n44_), .d(x14), .O(new_n64_));
  ...
  nor4   g33(.a(new_n65_), .b(new_n70_), .c(new_n46_), .d(x09), .O(z06));
  nand2  g34(.a(new_n50_), .b(x01), .O(new_n78_));
  nand3  g35(.a(new_n71_), .b(x11), .c(x10), .O(new_n79_));
  oai22  g36(.a(new_n79_), .b(new_n78_), .c(new_n68_), .d(x01), .O(new_n80_));
  ...
  nand4  g48(.a(new_n91_), .b(new_n45_), .c(x17), .d(x14), .O(new_n92_));
  ...
  nand4  g54(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n63_), .O(new_n98_));
  oai21  g55(.a(new_n98_), .b(new_n94_), .c(new_n69_), .O(z09));
  nand4  g56(.a(x22), .b(x21), .c(new_n95_), .d(new_n63_), .O(new_n100_));
  oai21  g57(.a(new_n100_), .b(new_n94_), .c(new_n69_), .O(z10));
  nor2   g58(.a(new_n48_), .b(x00), .O(z16));
  ...
  nand3  g66(.a(new_n63_), .b(x17), .c(new_n49_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(x14), .c(new_n48_), .d(new_n47_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n108_), .c(x24), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(x09), .O(new_n114_));
  inv1   g71(.a(new_n114_), .O(z12));
  nand4  g72(.a(new_n63_), .b(x17), .c(new_n49_), .d(new_n47_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(x14), .c(x01), .O(z13));
  nor2   g74(.a(new_n51_), .b(x10), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n45_), .c(new_n44_), .d(x14), .O(new_n119_));
  nor2   g76(.a(new_n119_), .b(x19), .O(z14));
  aoi21  g77(.a(new_n46_), .b(x01), .c(new_n49_), .O(new_n121_));
  aoi21  g78(.a(x19), .b(new_n49_), .c(new_n68_), .O(new_n122_));
  oai22  g79(.a(new_n122_), .b(x01), .c(new_n121_), .d(new_n47_), .O(z15));
  nand4  g80(.a(x14), .b(x02), .c(new_n48_), .d(new_n47_), .O(new_n124_));
