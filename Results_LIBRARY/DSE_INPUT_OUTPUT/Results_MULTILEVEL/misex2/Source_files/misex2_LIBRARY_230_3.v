...
module FAU ( 
  ...
  nand4  g29(.a(new_n72_), .b(x10), .c(new_n46_), .d(x02), .O(new_n73_));
  nor4   g30(.a(new_n73_), .b(x22), .c(x12), .d(x11), .O(z04));
  nand4  g31(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(new_n62_), .c(new_n71_), .O(z05));
  inv1   g33(.a(x11), .O(new_n77_));
  nor3   g34(.a(new_n73_), .b(x22), .c(new_n77_), .O(z06));
  ...
  nor2   g41(.a(new_n45_), .b(x01), .O(new_n85_));
  inv1   g42(.a(x04), .O(new_n86_));
  nor2   g43(.a(x05), .b(new_n86_), .O(new_n87_));
  nand4  g44(.a(new_n87_), .b(new_n85_), .c(new_n84_), .d(new_n70_), .O(new_n88_));
  nor3   g45(.a(x08), .b(x07), .c(x06), .O(new_n89_));
  nand4  g46(.a(new_n89_), .b(x19), .c(new_n50_), .d(x17), .O(new_n90_));
  oai21  g47(.a(new_n90_), .b(new_n88_), .c(new_n44_), .O(z08));
  inv1   g48(.a(x21), .O(new_n92_));
  nand3  g49(.a(new_n85_), .b(x12), .c(new_n77_), .O(new_n93_));
  ...
  nor2   g55(.a(new_n50_), .b(new_n71_), .O(new_n99_));
  nand3  g56(.a(new_n99_), .b(new_n98_), .c(new_n51_), .O(new_n100_));
  oai21  g57(.a(new_n97_), .b(new_n93_), .c(new_n100_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n62_), .c(new_n92_), .d(new_n70_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(z09));
  inv1   g60(.a(x13), .O(new_n104_));
  inv1   g61(.a(x14), .O(new_n105_));
  nand4  g62(.a(new_n77_), .b(x02), .c(new_n71_), .d(new_n70_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n105_), .c(new_n104_), .d(x12), .O(new_n108_));
  nor2   g65(.a(new_n108_), .b(new_n94_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n92_), .c(x20), .d(x16), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(x22), .O(z10));
  nand4  g68(.a(new_n99_), .b(x21), .c(new_n98_), .d(new_n51_), .O(new_n112_));
  nand4  g69(.a(new_n85_), .b(new_n104_), .c(x12), .d(new_n77_), .O(new_n113_));
  nor2   g70(.a(new_n94_), .b(x14), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n92_), .c(x20), .d(new_n95_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n113_), .c(new_n112_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n62_), .c(new_n70_), .O(new_n117_));
  ...
  nand3  g80(.a(new_n123_), .b(new_n71_), .c(new_n70_), .O(new_n124_));
  ...
  nand2  g84(.a(new_n57_), .b(x17), .O(new_n128_));
  nor2   g85(.a(new_n128_), .b(x19), .O(z13));
  nand2  g86(.a(new_n57_), .b(new_n46_), .O(new_n130_));
  ...
  oai21  g90(.a(x10), .b(new_n71_), .c(x02), .O(new_n134_));
  nand2  g91(.a(new_n134_), .b(x00), .O(new_n135_));
  nand3  g92(.a(x19), .b(new_n45_), .c(new_n71_), .O(new_n136_));
  nand3  g93(.a(new_n136_), .b(new_n135_), .c(new_n44_), .O(z15));
  nand3  g94(.a(new_n62_), .b(x01), .c(new_n70_), .O(new_n138_));
