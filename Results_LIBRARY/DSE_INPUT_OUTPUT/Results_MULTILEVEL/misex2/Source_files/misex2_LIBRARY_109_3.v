...
module FAU ( 
  ...
  inv1   g24(.a(new_n61_), .O(z05));
  nand3  g25(.a(x02), .b(new_n47_), .c(x00), .O(new_n70_));
  inv1   g26(.a(new_n70_), .O(z07));
  nand3  g27(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n72_));
  ...
  nor2   g33(.a(new_n63_), .b(x18), .O(new_n78_));
  nand4  g34(.a(new_n78_), .b(new_n77_), .c(new_n76_), .d(x17), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n61_), .O(z08));
  ...
  oai21  g40(.a(new_n84_), .b(new_n64_), .c(new_n46_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(x01), .O(new_n86_));
  inv1   g42(.a(x11), .O(new_n87_));
  inv1   g43(.a(x13), .O(new_n88_));
  nand3  g44(.a(new_n88_), .b(x12), .c(new_n87_), .O(new_n89_));
  nor2   g45(.a(new_n89_), .b(new_n72_), .O(new_n90_));
  nor3   g46(.a(x16), .b(x15), .c(x14), .O(new_n91_));
  nand3  g47(.a(new_n83_), .b(new_n82_), .c(x20), .O(new_n92_));
  inv1   g48(.a(new_n92_), .O(new_n93_));
  nand3  g49(.a(new_n93_), .b(new_n91_), .c(new_n90_), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n86_), .O(z09));
  nor2   g51(.a(new_n83_), .b(new_n82_), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n65_), .c(new_n81_), .d(x01), .O(new_n97_));
  nor2   g53(.a(new_n48_), .b(x01), .O(new_n98_));
  inv1   g54(.a(new_n89_), .O(new_n99_));
  nand2  g55(.a(x16), .b(x15), .O(new_n100_));
  nor2   g56(.a(new_n100_), .b(x14), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n93_), .c(new_n99_), .d(new_n98_), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n97_), .c(x00), .O(z10));
  nand3  g59(.a(new_n83_), .b(x21), .c(new_n81_), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n64_), .c(new_n46_), .O(new_n105_));
  ...
  nand4  g65(.a(new_n109_), .b(new_n93_), .c(new_n90_), .d(new_n107_), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(new_n106_), .O(z11));
  inv1   g67(.a(x24), .O(new_n112_));
  oai21  g68(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g69(.a(new_n63_), .b(x17), .c(new_n48_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(new_n112_), .c(x09), .d(new_n47_), .O(new_n116_));
  nor2   g72(.a(new_n116_), .b(x00), .O(z12));
  nor2   g73(.a(x01), .b(x00), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(x17), .c(new_n48_), .O(new_n119_));
  nor2   g75(.a(new_n119_), .b(x19), .O(z13));
  nand3  g76(.a(new_n118_), .b(new_n49_), .c(new_n48_), .O(new_n121_));
  nand4  g77(.a(new_n63_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(new_n121_), .c(new_n61_), .O(z14));
  nand3  g79(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n124_));
  oai21  g80(.a(new_n98_), .b(new_n46_), .c(new_n124_), .O(z15));
  nand2  g81(.a(new_n72_), .b(new_n61_), .O(z17));
  zero   g82(.O(z04));
