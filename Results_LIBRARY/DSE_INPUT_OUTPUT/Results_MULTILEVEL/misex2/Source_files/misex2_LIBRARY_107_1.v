...
module FAU ( 
  ...
  nor3   g45(.a(new_n88_), .b(x11), .c(new_n48_), .O(new_n89_));
  ...
  nand4  g50(.a(new_n93_), .b(new_n89_), .c(new_n85_), .d(new_n84_), .O(new_n94_));
  aoi21  g51(.a(new_n94_), .b(new_n47_), .c(x00), .O(z09));
  nand4  g52(.a(new_n93_), .b(new_n89_), .c(x16), .d(x15), .O(new_n96_));
  aoi21  g53(.a(new_n96_), .b(new_n47_), .c(x00), .O(z10));
  inv1   g54(.a(x11), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n87_), .c(new_n86_), .d(x12), .O(new_n101_));
  nor2   g58(.a(new_n101_), .b(new_n84_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n90_), .c(x20), .d(new_n85_), .O(new_n103_));
  ...
  nand3  g64(.a(new_n61_), .b(x17), .c(new_n48_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n107_), .c(x00), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n106_), .c(new_n105_), .O(new_n110_));
  oai22  g67(.a(new_n110_), .b(new_n49_), .c(new_n47_), .d(x00), .O(z12));
  aoi21  g68(.a(new_n108_), .b(new_n47_), .c(x00), .O(z13));
  nand4  g69(.a(new_n54_), .b(new_n57_), .c(new_n49_), .d(new_n48_), .O(new_n113_));
  ...
  aoi21  g74(.a(new_n48_), .b(new_n47_), .c(x00), .O(z17));
  zero   g75(.O(z16));
endmodule
