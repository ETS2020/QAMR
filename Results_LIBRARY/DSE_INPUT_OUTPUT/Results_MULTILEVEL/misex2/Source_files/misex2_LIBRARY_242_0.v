...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_,
    ...
    new_n75_, new_n76_, new_n78_, new_n79_, new_n83_, new_n84_, new_n85_;
  ...
  oai22  g19(.a(new_n63_), .b(new_n62_), .c(new_n61_), .d(x01), .O(z07));
  ...
  nand3  g27(.a(new_n71_), .b(new_n66_), .c(new_n70_), .O(new_n72_));
  aoi21  g28(.a(new_n72_), .b(x01), .c(x00), .O(z10));
  inv1   g29(.a(x21), .O(new_n74_));
  nor2   g30(.a(x22), .b(new_n74_), .O(new_n75_));
  nand3  g31(.a(new_n75_), .b(new_n66_), .c(new_n70_), .O(new_n76_));
  aoi21  g32(.a(new_n76_), .b(x01), .c(x00), .O(z11));
  aoi21  g33(.a(x10), .b(x02), .c(x24), .O(new_n78_));
  nand4  g34(.a(new_n78_), .b(x09), .c(x01), .d(x00), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n55_), .O(z12));
  inv1   g36(.a(x02), .O(new_n83_));
  inv1   g37(.a(x10), .O(new_n84_));
  aoi21  g38(.a(new_n84_), .b(x01), .c(new_n83_), .O(new_n85_));
  oai21  g39(.a(new_n85_), .b(z16), .c(new_n55_), .O(z15));
  zero   g40(.O(z00));
  zero   g41(.O(z13));
  zero   g42(.O(z14));
