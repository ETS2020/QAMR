...
module FAU ( 
  ...
  nand2  g027(.a(x03), .b(new_n53_), .O(new_n71_));
  ...
  nand4  g037(.a(new_n80_), .b(x11), .c(x10), .d(new_n51_), .O(new_n81_));
  ...
  nand4  g046(.a(new_n44_), .b(x02), .c(new_n53_), .d(new_n52_), .O(new_n90_));
  ...
  nor2   g054(.a(new_n54_), .b(x01), .O(new_n98_));
  nor2   g055(.a(new_n73_), .b(x11), .O(new_n99_));
  ...
  nor2   g062(.a(new_n50_), .b(new_n53_), .O(new_n106_));
  nand3  g063(.a(new_n106_), .b(new_n105_), .c(new_n63_), .O(new_n107_));
  oai21  g064(.a(new_n104_), .b(new_n100_), .c(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n97_), .c(new_n96_), .d(new_n52_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n71_), .O(z09));
  ...
  nor3   g072(.a(new_n115_), .b(new_n54_), .c(x01), .O(new_n116_));
  ...
  aoi21  g077(.a(new_n120_), .b(new_n116_), .c(new_n113_), .O(new_n121_));
  oai21  g078(.a(new_n121_), .b(x00), .c(new_n71_), .O(z10));
  nand4  g079(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n63_), .O(new_n123_));
  nand3  g080(.a(x15), .b(new_n117_), .c(new_n114_), .O(new_n124_));
  nand3  g081(.a(new_n96_), .b(x20), .c(new_n102_), .O(new_n125_));
  nor2   g082(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n99_), .c(new_n98_), .d(new_n44_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n97_), .c(new_n52_), .O(new_n129_));
  ...
  nand3  g090(.a(new_n63_), .b(x17), .c(new_n54_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n53_), .c(new_n52_), .O(new_n136_));
  ...
  nor3   g096(.a(new_n55_), .b(x19), .c(new_n45_), .O(z13));
  nor2   g097(.a(new_n55_), .b(x09), .O(new_n141_));
  nand4  g098(.a(new_n141_), .b(new_n50_), .c(new_n45_), .d(new_n59_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x19), .O(z14));
  aoi21  g100(.a(new_n59_), .b(x01), .c(new_n54_), .O(new_n144_));
  aoi21  g101(.a(x19), .b(new_n54_), .c(x03), .O(new_n145_));
  oai22  g102(.a(new_n145_), .b(x01), .c(new_n144_), .d(new_n52_), .O(z15));
  oai21  g103(.a(new_n53_), .b(x00), .c(new_n71_), .O(z16));
  nand2  g104(.a(x02), .b(new_n52_), .O(new_n148_));
