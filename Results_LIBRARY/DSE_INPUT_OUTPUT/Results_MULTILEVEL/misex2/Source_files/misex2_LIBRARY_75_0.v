...
module FAU ( 
  ...
  nor2   g09(.a(new_n48_), .b(new_n52_), .O(new_n53_));
  ...
  nand4  g26(.a(new_n69_), .b(new_n67_), .c(x10), .d(new_n52_), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(x12), .O(z04));
  nor3   g28(.a(new_n68_), .b(new_n56_), .c(new_n52_), .O(z05));
  nor2   g29(.a(x05), .b(x02), .O(new_n73_));
  inv1   g30(.a(new_n73_), .O(new_n74_));
  nand3  g31(.a(x11), .b(x10), .c(new_n52_), .O(new_n75_));
  oai21  g32(.a(new_n75_), .b(new_n64_), .c(new_n74_), .O(z06));
  inv1   g33(.a(x12), .O(new_n77_));
  nand4  g34(.a(new_n77_), .b(x11), .c(x10), .d(new_n52_), .O(new_n78_));
  ...
  nor2   g40(.a(x06), .b(new_n83_), .O(new_n84_));
  nand3  g41(.a(x19), .b(new_n45_), .c(x17), .O(new_n85_));
  nor3   g42(.a(new_n85_), .b(x08), .c(x07), .O(new_n86_));
  nand4  g43(.a(new_n86_), .b(new_n84_), .c(new_n47_), .d(new_n82_), .O(new_n87_));
  aoi21  g44(.a(new_n87_), .b(x02), .c(x05), .O(z08));
  inv1   g45(.a(x21), .O(new_n89_));
  inv1   g46(.a(x22), .O(new_n90_));
  nor2   g47(.a(new_n46_), .b(x01), .O(new_n91_));
  ...
  nand4  g56(.a(new_n99_), .b(new_n90_), .c(new_n89_), .d(new_n59_), .O(new_n100_));
  nand2  g57(.a(new_n100_), .b(new_n74_), .O(z09));
  nor4   g58(.a(new_n73_), .b(new_n90_), .c(new_n89_), .d(x20), .O(new_n102_));
  ...
  nor3   g68(.a(new_n73_), .b(new_n89_), .c(x20), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n62_), .c(x18), .d(x01), .O(new_n113_));
  nand3  g70(.a(new_n89_), .b(x20), .c(new_n94_), .O(new_n114_));
  nor3   g71(.a(new_n114_), .b(new_n93_), .c(x14), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n106_), .c(new_n91_), .O(new_n116_));
  ...
  nand2  g77(.a(x05), .b(new_n46_), .O(new_n121_));
  oai21  g78(.a(x10), .b(new_n46_), .c(new_n121_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(x01), .c(x00), .O(new_n123_));
  inv1   g80(.a(x05), .O(new_n124_));
  nand3  g81(.a(new_n62_), .b(x17), .c(new_n46_), .O(new_n125_));
  nand2  g82(.a(x23), .b(x19), .O(new_n126_));
  aoi21  g83(.a(new_n126_), .b(new_n125_), .c(new_n124_), .O(new_n127_));
  and2   g84(.a(x23), .b(x02), .O(new_n128_));
  oai21  g85(.a(new_n128_), .b(new_n127_), .c(new_n60_), .O(new_n129_));
  oai21  g86(.a(new_n129_), .b(x00), .c(new_n123_), .O(new_n130_));
  nand3  g87(.a(new_n130_), .b(new_n120_), .c(x09), .O(new_n131_));
  inv1   g88(.a(new_n131_), .O(z12));
  nor3   g89(.a(new_n48_), .b(x19), .c(new_n44_), .O(z13));
  nor3   g90(.a(x09), .b(x01), .c(x00), .O(new_n134_));
  nor2   g91(.a(x19), .b(x18), .O(new_n135_));
  nand4  g92(.a(new_n135_), .b(new_n134_), .c(new_n44_), .d(new_n56_), .O(new_n136_));
  aoi21  g93(.a(new_n136_), .b(x05), .c(x02), .O(z14));
  aoi21  g94(.a(new_n56_), .b(x01), .c(new_n46_), .O(new_n138_));
  aoi21  g95(.a(x19), .b(new_n60_), .c(new_n124_), .O(new_n139_));
  oai22  g96(.a(new_n139_), .b(x02), .c(new_n138_), .d(new_n59_), .O(z15));
  nor3   g97(.a(new_n73_), .b(new_n60_), .c(x00), .O(z16));
