...
module FAU ( 
  ...
  nand3  g25(.a(x02), .b(new_n62_), .c(x00), .O(new_n70_));
  ...
  nand4  g53(.a(new_n97_), .b(new_n65_), .c(new_n92_), .d(x01), .O(new_n98_));
  ...
  oai21  g63(.a(new_n107_), .b(new_n64_), .c(new_n61_), .O(new_n108_));
  ...
  nand4  g76(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n121_));
