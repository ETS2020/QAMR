...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n52_,
    ...
    new_n131_, new_n132_, new_n133_, new_n135_;
  ...
  nand3  g12(.a(new_n55_), .b(x09), .c(new_n45_), .O(new_n56_));
  ...
  nand4  g23(.a(new_n66_), .b(new_n65_), .c(x18), .d(new_n53_), .O(new_n67_));
  ...
  nor2   g53(.a(new_n54_), .b(new_n60_), .O(new_n97_));
  ...
  nand4  g61(.a(new_n95_), .b(x12), .c(new_n69_), .d(x02), .O(new_n105_));
  ...
  nand4  g69(.a(new_n97_), .b(x21), .c(new_n98_), .d(new_n65_), .O(new_n113_));
  nor2   g70(.a(x13), .b(new_n70_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n91_), .c(new_n69_), .O(new_n115_));
  ...
  aoi21  g86(.a(new_n124_), .b(new_n44_), .c(x01), .O(z13));
  nand3  g87(.a(new_n55_), .b(new_n46_), .c(new_n45_), .O(new_n131_));
  inv1   g88(.a(new_n131_), .O(new_n132_));
  nand4  g89(.a(new_n132_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n133_));
  nor2   g90(.a(new_n133_), .b(x19), .O(z14));
  nand3  g91(.a(new_n55_), .b(x19), .c(new_n45_), .O(new_n135_));
  nand2  g92(.a(new_n135_), .b(new_n122_), .O(z15));
  xor2a  g93(.a(x01), .b(x00), .O(z16));
  aoi21  g94(.a(new_n45_), .b(new_n44_), .c(x01), .O(z17));
endmodule
