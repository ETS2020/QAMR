...
module FAU ( 
  ...
  inv1   g61(.a(x11), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n94_), .c(new_n93_), .d(x12), .O(new_n108_));
  nor2   g65(.a(new_n108_), .b(new_n91_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n97_), .c(x20), .d(new_n92_), .O(new_n110_));
  ...
  aoi21  g83(.a(new_n48_), .b(new_n47_), .c(x00), .O(z17));
  zero   g84(.O(z16));
endmodule
