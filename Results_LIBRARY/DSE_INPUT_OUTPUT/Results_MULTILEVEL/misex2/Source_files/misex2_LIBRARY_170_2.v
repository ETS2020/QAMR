...
module FAU ( 
  ...
  nand4  g46(.a(new_n89_), .b(x12), .c(new_n66_), .d(x02), .O(new_n90_));
  ...
  nor3   g54(.a(new_n54_), .b(new_n55_), .c(x00), .O(new_n98_));
  ...
  nand2  g66(.a(new_n109_), .b(new_n55_), .O(new_n110_));
  ...
  nand3  g75(.a(new_n118_), .b(new_n55_), .c(new_n44_), .O(new_n119_));
  ...
  nand4  g80(.a(new_n46_), .b(new_n45_), .c(new_n55_), .d(new_n44_), .O(new_n124_));
  inv1   g81(.a(new_n124_), .O(new_n125_));
  nand4  g82(.a(new_n125_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n126_));
  nor2   g83(.a(new_n126_), .b(x19), .O(z14));
  aoi21  g84(.a(x19), .b(new_n45_), .c(x00), .O(new_n128_));
  nand2  g85(.a(new_n114_), .b(x00), .O(new_n129_));
