...
module FAU ( 
  ...
  nand2  g007(.a(x15), .b(x04), .O(new_n51_));
  ...
  nand4  g057(.a(new_n100_), .b(x20), .c(new_n99_), .d(new_n84_), .O(new_n101_));
  oai21  g058(.a(new_n101_), .b(new_n98_), .c(new_n97_), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(new_n95_), .c(new_n94_), .d(new_n93_), .O(new_n103_));
  inv1   g060(.a(new_n103_), .O(z09));
  inv1   g061(.a(x20), .O(new_n105_));
  nand4  g062(.a(new_n51_), .b(x22), .c(x21), .d(new_n105_), .O(new_n106_));
  inv1   g063(.a(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n50_), .c(x18), .d(x01), .O(new_n108_));
  nand3  g065(.a(new_n83_), .b(x02), .c(new_n44_), .O(new_n109_));
  ...
  nor3   g069(.a(new_n99_), .b(new_n84_), .c(x14), .O(new_n113_));
  ...
  nand4  g073(.a(new_n51_), .b(x21), .c(new_n105_), .d(new_n50_), .O(new_n117_));
  inv1   g074(.a(new_n117_), .O(new_n118_));
  nand3  g075(.a(new_n118_), .b(x18), .c(x01), .O(new_n119_));
  nand2  g076(.a(x02), .b(new_n44_), .O(new_n120_));
  nand3  g077(.a(x12), .b(new_n70_), .c(new_n83_), .O(new_n121_));
  nor2   g078(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  inv1   g079(.a(x14), .O(new_n123_));
  nand3  g080(.a(x15), .b(new_n123_), .c(new_n110_), .O(new_n124_));
  nand3  g081(.a(new_n94_), .b(x20), .c(new_n99_), .O(new_n125_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n95_), .c(new_n93_), .O(new_n129_));
  ...
  nand3  g093(.a(new_n136_), .b(new_n44_), .c(new_n93_), .O(new_n137_));
  ...
  nor2   g097(.a(new_n62_), .b(x19), .O(new_n141_));
  nand4  g098(.a(new_n141_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x00), .O(z13));
  nand3  g100(.a(new_n58_), .b(new_n46_), .c(new_n45_), .O(new_n144_));
  oai21  g101(.a(new_n144_), .b(new_n60_), .c(new_n51_), .O(z14));
  ...
  oai21  g106(.a(new_n44_), .b(x00), .c(new_n51_), .O(z16));
  oai21  g107(.a(new_n120_), .b(x00), .c(new_n51_), .O(z17));
endmodule
