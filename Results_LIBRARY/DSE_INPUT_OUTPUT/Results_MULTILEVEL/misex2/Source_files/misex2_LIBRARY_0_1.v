...
module FAU ( 
  ...
  aoi21  g29(.a(new_n72_), .b(x00), .c(new_n60_), .O(z05));
  ...
  nand2  g37(.a(x01), .b(new_n59_), .O(new_n81_));
  ...
  nand4  g50(.a(new_n93_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n94_));
  ...
  nor3   g57(.a(new_n100_), .b(x11), .c(new_n61_), .O(new_n101_));
  ...
  aoi21  g62(.a(new_n105_), .b(new_n60_), .c(x00), .O(z10));
  nand4  g63(.a(new_n104_), .b(new_n101_), .c(new_n89_), .d(x15), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n60_), .c(x00), .O(z11));
  ...
  oai21  g71(.a(new_n114_), .b(new_n46_), .c(new_n81_), .O(z12));
