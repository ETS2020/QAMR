...
module FAU ( 
  ...
  nand4  g40(.a(new_n83_), .b(x02), .c(new_n52_), .d(new_n44_), .O(new_n84_));
  ...
  oai21  g54(.a(new_n97_), .b(new_n91_), .c(new_n44_), .O(new_n98_));
  nand2  g55(.a(new_n98_), .b(new_n52_), .O(new_n99_));
  nor2   g56(.a(new_n51_), .b(new_n52_), .O(new_n100_));
  nor2   g57(.a(x20), .b(x19), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n100_), .c(new_n94_), .d(new_n44_), .O(new_n102_));
  nand2  g59(.a(new_n102_), .b(new_n99_), .O(z09));
  inv1   g60(.a(x21), .O(new_n104_));
  inv1   g61(.a(x22), .O(new_n105_));
  nor3   g62(.a(new_n105_), .b(new_n104_), .c(x20), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n65_), .c(x18), .d(x01), .O(new_n107_));
  inv1   g64(.a(x13), .O(new_n108_));
  nor2   g65(.a(new_n45_), .b(x01), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n108_), .c(x12), .d(new_n69_), .O(new_n110_));
  ...
  nor2   g71(.a(new_n104_), .b(x20), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n100_), .c(new_n65_), .O(new_n116_));
  nor2   g73(.a(new_n92_), .b(x14), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n104_), .c(x20), .d(new_n93_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n110_), .c(new_n116_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n105_), .c(new_n44_), .O(new_n120_));
  ...
  oai22  g84(.a(new_n127_), .b(new_n46_), .c(x01), .d(new_n44_), .O(z12));
  nor3   g85(.a(new_n53_), .b(x19), .c(new_n50_), .O(z13));
  nand4  g86(.a(new_n47_), .b(new_n58_), .c(new_n46_), .d(new_n45_), .O(new_n130_));
  aoi21  g87(.a(new_n130_), .b(new_n44_), .c(x01), .O(z14));
  inv1   g88(.a(new_n123_), .O(new_n132_));
  aoi21  g89(.a(x19), .b(new_n45_), .c(x00), .O(new_n133_));
