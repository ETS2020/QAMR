...
module FAU ( 
  ...
  nor2   g033(.a(new_n76_), .b(new_n53_), .O(z04));
  ...
  aoi21  g038(.a(new_n81_), .b(x24), .c(new_n78_), .O(z05));
  nand4  g039(.a(new_n80_), .b(x11), .c(x10), .d(new_n47_), .O(new_n83_));
  aoi21  g040(.a(new_n83_), .b(x24), .c(new_n78_), .O(z06));
  nand2  g041(.a(x10), .b(new_n47_), .O(new_n85_));
  nand3  g042(.a(x24), .b(new_n73_), .c(x11), .O(new_n86_));
  ...
  nor2   g053(.a(new_n56_), .b(x18), .O(new_n97_));
  nand4  g054(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(x17), .O(new_n98_));
  nand2  g055(.a(new_n98_), .b(new_n54_), .O(z08));
  ...
  nand4  g064(.a(new_n107_), .b(new_n56_), .c(x18), .d(x01), .O(new_n108_));
  ...
  nand3  g068(.a(new_n56_), .b(x18), .c(x01), .O(new_n112_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n90_), .c(new_n72_), .O(new_n126_));
  nor2   g083(.a(new_n103_), .b(x14), .O(new_n127_));
  nor2   g084(.a(x21), .b(new_n107_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n127_), .c(new_n104_), .O(new_n129_));
  nand2  g086(.a(x24), .b(x21), .O(new_n130_));
  nor2   g087(.a(new_n130_), .b(x20), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n69_), .c(x01), .O(new_n132_));
  oai21  g089(.a(new_n129_), .b(new_n126_), .c(new_n132_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n101_), .c(new_n79_), .O(new_n134_));
  ...
  nand4  g095(.a(new_n138_), .b(new_n53_), .c(x09), .d(new_n78_), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x00), .O(z12));
  inv1   g097(.a(new_n48_), .O(new_n141_));
  oai21  g098(.a(new_n137_), .b(new_n141_), .c(new_n54_), .O(z13));
  nand4  g099(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n143_));
  nor2   g100(.a(new_n143_), .b(x19), .O(z14));
  oai21  g101(.a(x10), .b(new_n78_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n46_), .c(new_n78_), .O(new_n147_));
  nand3  g104(.a(new_n147_), .b(new_n146_), .c(new_n54_), .O(z15));
  aoi21  g105(.a(x24), .b(x00), .c(new_n78_), .O(z16));
  nand2  g106(.a(new_n91_), .b(new_n54_), .O(z17));
endmodule
