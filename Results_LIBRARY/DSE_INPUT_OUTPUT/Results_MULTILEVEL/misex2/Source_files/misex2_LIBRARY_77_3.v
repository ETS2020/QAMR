...
module FAU ( 
  ...
  aoi21  g033(.a(new_n76_), .b(new_n63_), .c(new_n72_), .O(z04));
  nand4  g034(.a(new_n63_), .b(x02), .c(x01), .d(x00), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n47_), .O(new_n79_));
  nand2  g036(.a(new_n79_), .b(x10), .O(new_n80_));
  inv1   g037(.a(new_n80_), .O(z05));
  nor4   g038(.a(new_n78_), .b(new_n73_), .c(new_n58_), .d(x09), .O(z06));
  ...
  oai21  g051(.a(new_n94_), .b(new_n92_), .c(new_n53_), .O(z08));
  ...
  nor2   g064(.a(new_n45_), .b(x08), .O(new_n108_));
  nor2   g065(.a(new_n97_), .b(new_n96_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n108_), .c(new_n103_), .d(x01), .O(new_n110_));
  ...
  nand4  g075(.a(new_n89_), .b(new_n111_), .c(x12), .d(new_n73_), .O(new_n119_));
  nor2   g076(.a(new_n96_), .b(x20), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n108_), .c(new_n68_), .d(x01), .O(new_n121_));
  nor2   g078(.a(new_n99_), .b(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n96_), .c(x20), .d(new_n100_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n119_), .c(new_n121_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n97_), .c(new_n87_), .O(new_n125_));
  ...
  nand3  g087(.a(new_n68_), .b(x17), .c(new_n46_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n72_), .c(new_n87_), .O(new_n133_));
  ...
  nand3  g093(.a(new_n48_), .b(x17), .c(new_n46_), .O(new_n137_));
  nor2   g094(.a(new_n137_), .b(x19), .O(z13));
  nor2   g095(.a(x09), .b(x02), .O(new_n139_));
  nor2   g096(.a(x17), .b(x10), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(new_n139_), .c(new_n55_), .d(new_n48_), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(new_n53_), .O(z14));
  oai21  g099(.a(x10), .b(new_n72_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n46_), .c(new_n72_), .O(new_n145_));
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n53_), .O(z15));
  nand3  g103(.a(new_n63_), .b(x01), .c(new_n87_), .O(new_n147_));
  inv1   g104(.a(new_n147_), .O(z16));
  nand2  g105(.a(new_n48_), .b(x02), .O(new_n149_));
