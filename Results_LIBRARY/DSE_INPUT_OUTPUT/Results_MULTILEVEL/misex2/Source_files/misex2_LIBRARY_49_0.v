...
module FAU ( 
  ...
  nand3  g14(.a(x11), .b(x10), .c(new_n59_), .O(new_n60_));
  oai21  g15(.a(new_n60_), .b(new_n48_), .c(new_n47_), .O(z06));
  inv1   g16(.a(x12), .O(new_n62_));
  nand4  g17(.a(new_n62_), .b(x11), .c(x10), .d(new_n59_), .O(new_n63_));
  ...
  aoi21  g39(.a(new_n49_), .b(x01), .c(new_n86_), .O(new_n87_));
  oai21  g40(.a(new_n87_), .b(z16), .c(new_n47_), .O(z15));
  zero   g41(.O(z01));
  zero   g42(.O(z02));
  zero   g43(.O(z08));
  zero   g44(.O(z14));
