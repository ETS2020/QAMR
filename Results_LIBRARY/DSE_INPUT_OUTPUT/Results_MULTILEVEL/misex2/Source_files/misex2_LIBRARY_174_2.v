...
module FAU ( 
  ...
  nor2   g55(.a(new_n54_), .b(new_n60_), .O(new_n99_));
  ...
  nor2   g62(.a(x13), .b(new_n77_), .O(new_n106_));
  ...
  nand3  g72(.a(new_n115_), .b(new_n91_), .c(new_n44_), .O(new_n116_));
  ...
  nand3  g83(.a(new_n55_), .b(x17), .c(new_n45_), .O(new_n127_));
  ...
  nand3  g87(.a(new_n55_), .b(x19), .c(new_n45_), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(new_n119_), .O(z15));
  nor2   g89(.a(new_n60_), .b(x00), .O(z16));
  aoi21  g90(.a(new_n45_), .b(new_n44_), .c(x01), .O(z17));
endmodule
