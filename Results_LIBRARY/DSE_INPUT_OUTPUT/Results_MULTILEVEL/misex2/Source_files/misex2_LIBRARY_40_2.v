...
module FAU ( 
  ...
  nand4  g69(.a(new_n94_), .b(x12), .c(new_n68_), .d(x02), .O(new_n113_));
  nand4  g70(.a(new_n108_), .b(x20), .c(new_n93_), .d(x15), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n113_), .c(new_n44_), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n52_), .O(new_n116_));
  nor3   g73(.a(new_n51_), .b(new_n52_), .c(x00), .O(new_n117_));
  ...
  nand2  g87(.a(x10), .b(x02), .O(new_n131_));
  nand3  g88(.a(new_n131_), .b(x01), .c(x00), .O(new_n132_));
