...
module FAU ( 
  ...
  oai22  g65(.a(new_n108_), .b(new_n49_), .c(new_n47_), .d(x00), .O(z12));
  aoi21  g66(.a(new_n106_), .b(new_n47_), .c(x00), .O(z13));
  nand4  g67(.a(new_n54_), .b(new_n57_), .c(new_n49_), .d(new_n48_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n47_), .c(x00), .O(z14));
  oai21  g69(.a(new_n57_), .b(new_n46_), .c(x01), .O(new_n113_));
  oai21  g70(.a(x19), .b(x00), .c(new_n48_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n113_), .O(z15));
  aoi21  g72(.a(new_n48_), .b(new_n47_), .c(x00), .O(z17));
  zero   g73(.O(z16));
endmodule
