...
module FAU ( 
  ...
  nor3   g26(.a(new_n69_), .b(x09), .c(new_n50_), .O(new_n70_));
  ...
  nand3  g32(.a(new_n70_), .b(x11), .c(x10), .O(new_n76_));
  inv1   g33(.a(new_n76_), .O(z06));
  nand2  g34(.a(x11), .b(x10), .O(new_n78_));
  ...
  nand2  g38(.a(x02), .b(new_n48_), .O(new_n82_));
  ...
  nand3  g46(.a(x18), .b(x01), .c(new_n48_), .O(new_n90_));
  ...
  oai21  g51(.a(new_n94_), .b(new_n90_), .c(new_n73_), .O(z09));
  nand4  g52(.a(x22), .b(x21), .c(new_n91_), .d(new_n64_), .O(new_n96_));
  oai21  g53(.a(new_n96_), .b(new_n90_), .c(new_n73_), .O(z10));
  nand4  g54(.a(new_n64_), .b(x18), .c(x01), .d(new_n48_), .O(new_n98_));
  ...
  nand3  g62(.a(new_n64_), .b(x17), .c(new_n50_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n44_), .c(new_n49_), .d(new_n48_), .O(new_n108_));
  ...
  nand4  g68(.a(new_n64_), .b(x17), .c(new_n50_), .d(new_n48_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n44_), .c(x01), .O(z13));
  nor2   g70(.a(new_n52_), .b(x10), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n115_));
  nor2   g72(.a(new_n115_), .b(x19), .O(z14));
  aoi21  g73(.a(new_n44_), .b(new_n50_), .c(new_n103_), .O(new_n117_));
  nand4  g74(.a(x19), .b(new_n44_), .c(new_n50_), .d(new_n49_), .O(new_n118_));
  oai21  g75(.a(new_n117_), .b(new_n48_), .c(new_n118_), .O(z15));
  oai21  g76(.a(new_n49_), .b(x00), .c(new_n73_), .O(z16));
  aoi21  g77(.a(new_n82_), .b(new_n44_), .c(x01), .O(z17));
endmodule
