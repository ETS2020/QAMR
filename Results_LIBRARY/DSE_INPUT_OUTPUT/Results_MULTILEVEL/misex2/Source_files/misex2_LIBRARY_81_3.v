...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n60_, new_n66_, new_n67_, new_n69_, new_n70_, new_n71_, new_n72_,
  ...
  nand3  g20(.a(x02), .b(new_n66_), .c(x00), .O(new_n67_));
  ...
  nand4  g28(.a(new_n74_), .b(x02), .c(new_n66_), .d(new_n73_), .O(new_n75_));
  ...
  nand4  g32(.a(new_n78_), .b(new_n45_), .c(x17), .d(new_n70_), .O(new_n79_));
  nor2   g33(.a(new_n79_), .b(new_n69_), .O(z08));
  inv1   g34(.a(x21), .O(new_n81_));
  inv1   g35(.a(x22), .O(new_n82_));
  inv1   g36(.a(x11), .O(new_n83_));
  nor2   g37(.a(new_n47_), .b(x01), .O(new_n84_));
  ...
  nor2   g44(.a(new_n45_), .b(new_n66_), .O(new_n91_));
  nand3  g45(.a(new_n91_), .b(new_n90_), .c(new_n69_), .O(new_n92_));
  oai21  g46(.a(new_n89_), .b(new_n85_), .c(new_n92_), .O(new_n93_));
  nand4  g47(.a(new_n93_), .b(new_n82_), .c(new_n81_), .d(new_n73_), .O(new_n94_));
  inv1   g48(.a(new_n94_), .O(z09));
  nor3   g49(.a(new_n82_), .b(new_n81_), .c(x20), .O(new_n96_));
  nand4  g50(.a(new_n96_), .b(new_n69_), .c(x18), .d(x01), .O(new_n97_));
  ...
  nand4  g57(.a(new_n91_), .b(x21), .c(new_n90_), .d(new_n69_), .O(new_n104_));
  ...
  nand3  g64(.a(new_n69_), .b(x17), .c(new_n47_), .O(new_n111_));
  aoi21  g65(.a(new_n111_), .b(new_n110_), .c(x24), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(x09), .c(new_n66_), .d(new_n73_), .O(new_n113_));
  nand2  g67(.a(x01), .b(x00), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n113_), .O(z12));
  nor3   g69(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand3  g70(.a(new_n48_), .b(new_n46_), .c(new_n47_), .O(new_n117_));
  nand4  g71(.a(new_n69_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n118_));
  oai21  g72(.a(new_n118_), .b(new_n117_), .c(new_n114_), .O(z14));
  nand3  g73(.a(x19), .b(new_n47_), .c(new_n66_), .O(new_n120_));
  oai21  g74(.a(new_n84_), .b(new_n73_), .c(new_n120_), .O(z15));
  nor2   g75(.a(new_n66_), .b(x00), .O(z16));
  nand2  g76(.a(new_n48_), .b(x02), .O(new_n123_));
