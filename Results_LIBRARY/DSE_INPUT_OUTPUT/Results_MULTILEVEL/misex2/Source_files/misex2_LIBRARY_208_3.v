...
module FAU ( 
  ...
  nand3  g18(.a(new_n45_), .b(new_n48_), .c(new_n47_), .O(new_n62_));
  nand3  g19(.a(new_n54_), .b(x18), .c(new_n52_), .O(new_n63_));
  inv1   g20(.a(x05), .O(new_n64_));
  nor2   g21(.a(new_n48_), .b(new_n47_), .O(new_n65_));
  nand3  g22(.a(new_n65_), .b(new_n64_), .c(x02), .O(new_n66_));
  nand4  g23(.a(x12), .b(x11), .c(x10), .d(new_n46_), .O(new_n67_));
  oai22  g24(.a(new_n67_), .b(new_n66_), .c(new_n63_), .d(new_n62_), .O(z03));
  nand2  g25(.a(new_n65_), .b(x02), .O(new_n69_));
  inv1   g26(.a(new_n69_), .O(new_n70_));
  nand4  g27(.a(new_n70_), .b(x10), .c(new_n46_), .d(new_n64_), .O(new_n71_));
  nor3   g28(.a(new_n71_), .b(x12), .c(x11), .O(z04));
  nand4  g29(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(new_n64_), .c(new_n48_), .O(z05));
  inv1   g31(.a(x11), .O(new_n75_));
  nor2   g32(.a(new_n71_), .b(new_n75_), .O(z06));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n48_), .d(new_n47_), .O(new_n85_));
  inv1   g42(.a(new_n85_), .O(new_n86_));
  nand4  g43(.a(new_n86_), .b(new_n83_), .c(new_n64_), .d(x04), .O(new_n87_));
  nor2   g44(.a(new_n87_), .b(x07), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(new_n53_), .c(x17), .d(new_n82_), .O(new_n89_));
  nor2   g46(.a(new_n89_), .b(new_n54_), .O(z08));
  ...
  nand4  g56(.a(new_n99_), .b(x18), .c(new_n64_), .d(x01), .O(new_n100_));
  oai21  g57(.a(new_n98_), .b(new_n94_), .c(new_n100_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n92_), .c(new_n91_), .d(new_n47_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(z09));
  nor2   g60(.a(new_n53_), .b(x05), .O(new_n104_));
  nor2   g61(.a(new_n92_), .b(new_n91_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n104_), .c(new_n99_), .d(x01), .O(new_n106_));
  nor2   g63(.a(x13), .b(new_n77_), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n93_), .c(new_n75_), .O(new_n108_));
  ...
  nor2   g69(.a(new_n91_), .b(x20), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n54_), .c(x18), .d(x01), .O(new_n114_));
  ...
  nand3  g74(.a(new_n117_), .b(new_n92_), .c(new_n47_), .O(new_n118_));
  ...
  nand3  g79(.a(new_n54_), .b(x17), .c(new_n45_), .O(new_n123_));
  ...
  nor4   g85(.a(new_n49_), .b(x19), .c(new_n52_), .d(x02), .O(z13));
  oai21  g86(.a(new_n60_), .b(new_n51_), .c(new_n44_), .O(z14));
  aoi22  g87(.a(new_n44_), .b(x00), .c(x19), .d(new_n48_), .O(new_n131_));
  nand3  g88(.a(new_n65_), .b(new_n59_), .c(new_n64_), .O(new_n132_));
  oai21  g89(.a(new_n131_), .b(x02), .c(new_n132_), .O(z15));
  aoi21  g90(.a(new_n64_), .b(x00), .c(new_n48_), .O(z16));
  nand2  g91(.a(new_n50_), .b(x02), .O(new_n135_));
