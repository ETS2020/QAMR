...
module FAU ( 
  ...
  nand4  g038(.a(new_n73_), .b(x11), .c(x10), .d(new_n47_), .O(new_n82_));
  ...
  nand4  g061(.a(new_n104_), .b(x18), .c(new_n63_), .d(x01), .O(new_n105_));
  oai21  g062(.a(new_n103_), .b(new_n99_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n98_), .c(new_n97_), .d(new_n86_), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(z09));
  nor2   g065(.a(new_n45_), .b(x07), .O(new_n109_));
  ...
  nand4  g076(.a(new_n87_), .b(new_n112_), .c(x12), .d(new_n72_), .O(new_n120_));
  nor2   g077(.a(new_n97_), .b(x20), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n109_), .c(new_n55_), .d(x01), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n98_), .c(new_n86_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n71_), .c(new_n86_), .O(new_n134_));
  ...
  nand3  g100(.a(x19), .b(new_n46_), .c(new_n71_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n53_), .O(z15));
  nand3  g102(.a(new_n63_), .b(x01), .c(new_n86_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand2  g104(.a(new_n88_), .b(new_n53_), .O(z17));
endmodule
