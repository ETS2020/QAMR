...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n116_, new_n119_, new_n121_, new_n122_, new_n125_;
  ...
  aoi21  g28(.a(new_n71_), .b(x00), .c(new_n47_), .O(z06));
  ...
  oai21  g33(.a(new_n47_), .b(x00), .c(new_n76_), .O(z07));
  ...
  nand4  g49(.a(new_n92_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n93_));
  inv1   g50(.a(new_n93_), .O(new_n94_));
  nand4  g51(.a(new_n94_), .b(new_n91_), .c(new_n90_), .d(x12), .O(new_n95_));
  nor2   g52(.a(new_n95_), .b(x15), .O(new_n96_));
  nand4  g53(.a(new_n96_), .b(new_n89_), .c(x20), .d(new_n88_), .O(new_n97_));
  nor2   g54(.a(new_n97_), .b(x22), .O(z09));
  nand3  g55(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n99_));
  nor3   g56(.a(new_n99_), .b(x11), .c(new_n48_), .O(new_n100_));
  inv1   g57(.a(x15), .O(new_n101_));
  nor2   g58(.a(new_n88_), .b(new_n101_), .O(new_n102_));
  nor2   g59(.a(x22), .b(x21), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n102_), .c(new_n100_), .d(x20), .O(new_n104_));
  aoi21  g61(.a(new_n104_), .b(new_n47_), .c(x00), .O(z10));
  nor2   g62(.a(new_n95_), .b(new_n101_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n89_), .c(x20), .d(new_n88_), .O(new_n107_));
  ...
  nand3  g68(.a(new_n61_), .b(x17), .c(new_n48_), .O(new_n112_));
  ...
  aoi21  g74(.a(new_n112_), .b(new_n47_), .c(x00), .O(z13));
  nand4  g75(.a(new_n54_), .b(new_n57_), .c(new_n49_), .d(new_n48_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n47_), .c(x00), .O(z14));
