...
module FAU ( 
  ...
  nor3   g51(.a(new_n94_), .b(x11), .c(new_n48_), .O(new_n95_));
  ...
  aoi21  g57(.a(new_n100_), .b(new_n47_), .c(x00), .O(z09));
  inv1   g58(.a(x11), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n93_), .c(new_n92_), .d(x12), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(new_n90_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n96_), .c(x20), .d(x16), .O(new_n107_));
  nor2   g64(.a(new_n107_), .b(x22), .O(z10));
  nand4  g65(.a(new_n99_), .b(new_n95_), .c(new_n91_), .d(x15), .O(new_n109_));
  ...
  aoi21  g76(.a(new_n114_), .b(new_n47_), .c(x00), .O(z13));
  nand4  g77(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n121_));
  nor2   g78(.a(new_n121_), .b(x19), .O(z14));
  aoi21  g79(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n46_), .c(new_n124_), .O(z15));
