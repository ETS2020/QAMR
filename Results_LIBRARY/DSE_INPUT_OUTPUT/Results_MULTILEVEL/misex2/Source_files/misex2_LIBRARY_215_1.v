...
module FAU ( 
  ...
  nand4  g33(.a(new_n67_), .b(x11), .c(x10), .d(new_n46_), .O(new_n77_));
  ...
  nand4  g53(.a(new_n66_), .b(x02), .c(new_n44_), .d(new_n60_), .O(new_n97_));
  ...
  nand3  g65(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n109_));
  ...
  nand2  g69(.a(new_n52_), .b(x17), .O(new_n113_));
  nor2   g70(.a(new_n113_), .b(x19), .O(z13));
  nand2  g71(.a(new_n52_), .b(new_n46_), .O(new_n115_));
  inv1   g72(.a(new_n115_), .O(new_n116_));
  nand4  g73(.a(new_n116_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n117_));
