...
module FAU ( 
  ...
  nand3  g59(.a(new_n95_), .b(new_n94_), .c(x12), .O(new_n103_));
  nor3   g60(.a(new_n103_), .b(x11), .c(new_n48_), .O(new_n104_));
  inv1   g61(.a(x22), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n93_), .c(x20), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n104_), .c(x16), .d(x15), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n47_), .c(x00), .O(z10));
  nand4  g66(.a(new_n107_), .b(new_n104_), .c(new_n92_), .d(x15), .O(new_n110_));
