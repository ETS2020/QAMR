...
module FAU ( 
  ...
  nand4  g15(.a(new_n47_), .b(new_n58_), .c(x09), .d(new_n45_), .O(new_n59_));
  ...
  nand4  g57(.a(new_n66_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n101_));
