...
module FAU ( 
  ...
  aoi21  g031(.a(new_n74_), .b(x24), .c(new_n47_), .O(z04));
  nor2   g032(.a(new_n48_), .b(new_n46_), .O(new_n76_));
  nand3  g033(.a(new_n76_), .b(x10), .c(x09), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(x24), .c(new_n47_), .O(z05));
  nand4  g035(.a(new_n76_), .b(x11), .c(x10), .d(new_n49_), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(x24), .c(new_n47_), .O(z06));
  nand2  g037(.a(x10), .b(new_n49_), .O(new_n81_));
  nand3  g038(.a(x24), .b(new_n72_), .c(x11), .O(new_n82_));
  ...
  nand3  g061(.a(x24), .b(new_n104_), .c(new_n53_), .O(new_n105_));
  oai22  g062(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(new_n98_), .O(new_n106_));
  ...
  nand3  g079(.a(new_n122_), .b(new_n86_), .c(new_n71_), .O(new_n123_));
  inv1   g080(.a(new_n103_), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(x21), .c(new_n104_), .d(new_n53_), .O(new_n125_));
  ...
  nand3  g091(.a(new_n134_), .b(x09), .c(new_n46_), .O(new_n135_));
  aoi21  g092(.a(new_n135_), .b(new_n47_), .c(x24), .O(z12));
  ...
  nand3  g103(.a(x24), .b(x01), .c(new_n46_), .O(new_n147_));
  inv1   g104(.a(new_n147_), .O(z16));
  nand2  g105(.a(new_n87_), .b(new_n45_), .O(z17));
endmodule
