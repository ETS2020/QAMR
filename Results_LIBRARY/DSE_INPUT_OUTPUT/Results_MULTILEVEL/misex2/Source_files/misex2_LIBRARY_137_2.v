...
module FAU ( 
  ...
  nand4  g45(.a(x12), .b(new_n88_), .c(x02), .d(new_n55_), .O(new_n89_));
  ...
  nand4  g53(.a(new_n96_), .b(new_n87_), .c(new_n86_), .d(new_n44_), .O(new_n97_));
  ...
  nand3  g58(.a(new_n101_), .b(x12), .c(new_n88_), .O(new_n102_));
  nor3   g59(.a(new_n102_), .b(new_n45_), .c(x01), .O(new_n103_));
  ...
  nand3  g64(.a(new_n107_), .b(new_n104_), .c(new_n103_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n100_), .c(x00), .O(z10));
  nand4  g66(.a(new_n92_), .b(x12), .c(new_n88_), .d(x02), .O(new_n110_));
  nand4  g67(.a(new_n105_), .b(x20), .c(new_n91_), .d(x15), .O(new_n111_));
  oai21  g68(.a(new_n111_), .b(new_n110_), .c(new_n44_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n55_), .O(new_n113_));
  nor3   g70(.a(new_n54_), .b(new_n55_), .c(x00), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n94_), .c(new_n87_), .d(x21), .O(new_n115_));
  ...
  nand2  g87(.a(new_n118_), .b(x00), .O(new_n131_));
  oai21  g88(.a(new_n130_), .b(x01), .c(new_n131_), .O(z15));
  nor2   g89(.a(new_n55_), .b(x00), .O(z16));
