...
module FAU ( 
  ...
  nor3   g50(.a(new_n93_), .b(x11), .c(new_n61_), .O(new_n94_));
  ...
  aoi21  g56(.a(new_n99_), .b(new_n60_), .c(x00), .O(z09));
  nand4  g57(.a(new_n69_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n101_));
  ...
  oai21  g79(.a(new_n56_), .b(new_n59_), .c(x01), .O(new_n123_));
  oai21  g80(.a(x19), .b(x00), .c(new_n61_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n123_), .O(z15));
  nor2   g82(.a(new_n60_), .b(x00), .O(z16));
  aoi21  g83(.a(new_n61_), .b(new_n60_), .c(x00), .O(z17));
endmodule
