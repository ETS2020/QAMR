...
module FAU ( 
  ...
  inv1   g27(.a(new_n67_), .O(new_n71_));
  nand2  g28(.a(new_n71_), .b(x11), .O(new_n72_));
  inv1   g29(.a(new_n72_), .O(z06));
  inv1   g30(.a(x11), .O(new_n74_));
  nor2   g31(.a(x12), .b(new_n74_), .O(new_n75_));
  nand3  g32(.a(new_n75_), .b(new_n56_), .c(x10), .O(new_n76_));
  ...
  nand4  g47(.a(x12), .b(new_n74_), .c(x02), .d(new_n55_), .O(new_n91_));
  ...
  nand4  g58(.a(new_n94_), .b(x12), .c(new_n74_), .d(x02), .O(new_n102_));
  ...
  nand3  g78(.a(new_n121_), .b(new_n55_), .c(new_n44_), .O(new_n122_));
