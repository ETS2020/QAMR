...
module FAU ( 
  ...
  nand4  g030(.a(new_n52_), .b(new_n73_), .c(new_n72_), .d(x10), .O(new_n74_));
  ...
  nor2   g036(.a(new_n79_), .b(new_n71_), .O(z05));
  nand3  g037(.a(x11), .b(x10), .c(new_n46_), .O(new_n81_));
  oai21  g038(.a(new_n81_), .b(new_n64_), .c(new_n52_), .O(z06));
  nand3  g039(.a(new_n66_), .b(new_n73_), .c(x11), .O(new_n83_));
  nand2  g040(.a(new_n83_), .b(x01), .O(new_n84_));
  nand3  g041(.a(new_n84_), .b(x02), .c(x00), .O(new_n85_));
  nand2  g042(.a(new_n85_), .b(new_n52_), .O(z07));
  nand3  g043(.a(x02), .b(new_n44_), .c(new_n71_), .O(new_n87_));
  ...
  nand4  g053(.a(x12), .b(new_n72_), .c(x02), .d(new_n44_), .O(new_n97_));
  ...
  nand3  g062(.a(new_n105_), .b(new_n96_), .c(new_n71_), .O(new_n106_));
  aoi21  g063(.a(new_n106_), .b(new_n95_), .c(x22), .O(z09));
  ...
  nand3  g068(.a(new_n98_), .b(x12), .c(new_n72_), .O(new_n112_));
  nor2   g069(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand2  g070(.a(x16), .b(x15), .O(new_n114_));
  nand3  g071(.a(new_n51_), .b(new_n96_), .c(x20), .O(new_n115_));
  ...
  nand4  g075(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n50_), .O(new_n119_));
  nor2   g076(.a(new_n99_), .b(x14), .O(new_n120_));
  nor2   g077(.a(x21), .b(new_n102_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n120_), .c(new_n100_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n97_), .c(new_n119_), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n51_), .c(new_n95_), .d(new_n71_), .O(new_n124_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n44_), .c(new_n71_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand4  g090(.a(new_n133_), .b(new_n52_), .c(new_n126_), .d(x09), .O(new_n134_));
  inv1   g091(.a(new_n134_), .O(z12));
  nor2   g092(.a(new_n63_), .b(x19), .O(new_n136_));
  nand4  g093(.a(new_n136_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n137_));
  ...
  nand2  g102(.a(new_n87_), .b(new_n52_), .O(z17));
endmodule
