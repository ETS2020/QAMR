...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n69_, new_n70_, new_n71_, new_n73_, new_n75_, new_n76_, new_n79_,
  ...
  nand4  g05(.a(x06), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n49_));
  ...
  aoi21  g18(.a(new_n61_), .b(x06), .c(x01), .O(z02));
  nand3  g19(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n63_));
  nand4  g20(.a(new_n58_), .b(x18), .c(new_n44_), .d(x06), .O(new_n64_));
  ...
  nand4  g52(.a(new_n95_), .b(new_n87_), .c(new_n86_), .d(new_n46_), .O(new_n96_));
  nand2  g53(.a(new_n96_), .b(new_n75_), .O(z09));
  nand3  g54(.a(new_n58_), .b(x18), .c(x01), .O(new_n98_));
  nand3  g55(.a(x22), .b(x21), .c(new_n93_), .O(new_n99_));
  nor2   g56(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g57(.a(x02), .b(new_n47_), .O(new_n101_));
  ...
  nand3  g62(.a(x16), .b(x15), .c(new_n105_), .O(new_n106_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(x20), .O(new_n107_));
  nor2   g64(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n104_), .c(new_n100_), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(x00), .c(new_n75_), .O(z10));
  nor2   g67(.a(new_n45_), .b(new_n47_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(x21), .c(new_n93_), .d(new_n58_), .O(new_n112_));
  inv1   g69(.a(new_n101_), .O(new_n113_));
  nand3  g70(.a(x12), .b(new_n68_), .c(x06), .O(new_n114_));
  inv1   g71(.a(new_n114_), .O(new_n115_));
  nand3  g72(.a(x15), .b(new_n105_), .c(new_n102_), .O(new_n116_));
  ...
  nand3  g78(.a(new_n121_), .b(new_n87_), .c(new_n46_), .O(new_n122_));
  ...
  nand3  g84(.a(new_n58_), .b(x17), .c(new_n48_), .O(new_n128_));
  ...
  nor3   g90(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  ...
  aoi21  g94(.a(x19), .b(new_n48_), .c(new_n79_), .O(new_n138_));
  ...
  aoi21  g98(.a(new_n141_), .b(x06), .c(x01), .O(z17));
endmodule
