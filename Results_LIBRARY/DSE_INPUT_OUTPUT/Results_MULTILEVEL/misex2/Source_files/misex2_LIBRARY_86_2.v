...
module FAU ( 
  ...
  nor4   g31(.a(new_n74_), .b(new_n68_), .c(new_n57_), .d(x09), .O(z06));
  ...
  nand4  g46(.a(x12), .b(new_n68_), .c(x02), .d(new_n52_), .O(new_n90_));
  ...
  nand4  g57(.a(new_n93_), .b(x12), .c(new_n68_), .d(x02), .O(new_n101_));
  ...
  nand2  g61(.a(new_n104_), .b(new_n52_), .O(new_n105_));
  ...
  nand4  g66(.a(new_n95_), .b(x21), .c(new_n109_), .d(new_n64_), .O(new_n110_));
  nor2   g67(.a(new_n45_), .b(x01), .O(new_n111_));
  nor2   g68(.a(x13), .b(new_n69_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n111_), .c(new_n68_), .O(new_n113_));
  ...
  aoi21  g77(.a(x10), .b(x02), .c(new_n44_), .O(new_n121_));
  oai21  g78(.a(x19), .b(x02), .c(x23), .O(new_n122_));
  nand3  g79(.a(new_n64_), .b(x17), .c(new_n45_), .O(new_n123_));
  ...
  oai21  g83(.a(new_n125_), .b(new_n46_), .c(new_n126_), .O(z12));
  aoi21  g84(.a(new_n123_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g85(.a(new_n46_), .b(new_n45_), .c(new_n52_), .d(new_n44_), .O(new_n129_));
  ...
  nand4  g91(.a(x19), .b(new_n45_), .c(new_n52_), .d(new_n44_), .O(new_n135_));
  nand2  g92(.a(new_n135_), .b(new_n134_), .O(z15));
  nand2  g93(.a(x01), .b(new_n44_), .O(new_n137_));
  nand2  g94(.a(new_n137_), .b(new_n126_), .O(z16));
