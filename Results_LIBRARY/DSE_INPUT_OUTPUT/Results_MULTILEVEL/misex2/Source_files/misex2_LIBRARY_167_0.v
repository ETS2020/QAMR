...
module FAU ( 
  ...
  nand4  g009(.a(new_n52_), .b(new_n45_), .c(new_n44_), .d(x13), .O(new_n53_));
  nor2   g010(.a(new_n53_), .b(x19), .O(z00));
  inv1   g011(.a(x13), .O(new_n55_));
  nand2  g012(.a(new_n55_), .b(new_n50_), .O(new_n56_));
  ...
  nand4  g017(.a(new_n58_), .b(new_n45_), .c(new_n44_), .d(new_n46_), .O(new_n61_));
  ...
  oai21  g021(.a(new_n64_), .b(new_n63_), .c(x13), .O(new_n65_));
  nand2  g022(.a(new_n65_), .b(new_n50_), .O(new_n66_));
  nor3   g023(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  nand4  g024(.a(new_n67_), .b(new_n58_), .c(x18), .d(new_n44_), .O(new_n68_));
  ...
  aoi21  g030(.a(new_n73_), .b(x13), .c(x09), .O(z04));
  nor2   g031(.a(new_n48_), .b(new_n47_), .O(new_n75_));
  ...
  aoi21  g036(.a(new_n79_), .b(x13), .c(x09), .O(z06));
  inv1   g037(.a(new_n56_), .O(new_n81_));
  nand2  g038(.a(x10), .b(new_n50_), .O(new_n82_));
  nand3  g039(.a(x13), .b(new_n71_), .c(x11), .O(new_n83_));
  oai22  g040(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(x01), .O(new_n84_));
  ...
  nand4  g048(.a(new_n56_), .b(x19), .c(new_n45_), .d(x17), .O(new_n92_));
  ...
  nand4  g052(.a(new_n95_), .b(new_n87_), .c(x02), .d(new_n48_), .O(new_n96_));
  nor2   g053(.a(new_n96_), .b(x00), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  nor2   g056(.a(new_n49_), .b(x01), .O(new_n100_));
  ...
  nor2   g063(.a(new_n45_), .b(new_n48_), .O(new_n107_));
  ...
  nand4  g070(.a(new_n100_), .b(new_n55_), .c(x12), .d(new_n70_), .O(new_n114_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n99_), .c(new_n47_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n58_), .b(x17), .c(new_n49_), .O(new_n129_));
  ...
  oai21  g101(.a(new_n48_), .b(x00), .c(new_n56_), .O(z16));
  nand2  g102(.a(new_n100_), .b(new_n47_), .O(new_n146_));
