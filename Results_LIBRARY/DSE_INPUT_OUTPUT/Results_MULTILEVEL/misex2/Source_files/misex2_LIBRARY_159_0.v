...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_, new_n54_,
    ...
    new_n84_, new_n85_, new_n89_, new_n90_;
  ...
  oai21  g16(.a(new_n61_), .b(new_n54_), .c(new_n53_), .O(z06));
  inv1   g17(.a(x00), .O(new_n63_));
  inv1   g18(.a(x01), .O(new_n64_));
  oai21  g19(.a(x02), .b(new_n63_), .c(new_n64_), .O(new_n65_));
  nand3  g20(.a(new_n48_), .b(x02), .c(x00), .O(new_n66_));
  nand3  g21(.a(new_n47_), .b(x11), .c(x10), .O(new_n67_));
  ...
  nand4  g30(.a(new_n76_), .b(x18), .c(x01), .d(new_n63_), .O(new_n77_));
  inv1   g31(.a(new_n77_), .O(new_n78_));
  nand4  g32(.a(new_n78_), .b(x22), .c(x21), .d(new_n75_), .O(new_n79_));
  inv1   g33(.a(new_n79_), .O(z10));
  inv1   g34(.a(x22), .O(new_n81_));
  nand4  g35(.a(new_n71_), .b(new_n81_), .c(x21), .d(new_n75_), .O(new_n82_));
  aoi21  g36(.a(new_n82_), .b(x01), .c(x00), .O(z11));
  aoi21  g37(.a(x10), .b(x02), .c(x24), .O(new_n84_));
  nand3  g38(.a(new_n84_), .b(x09), .c(x01), .O(new_n85_));
  nor2   g39(.a(new_n85_), .b(new_n63_), .O(z12));
  inv1   g40(.a(x10), .O(new_n89_));
  nand2  g41(.a(new_n89_), .b(x01), .O(new_n90_));
  aoi21  g42(.a(new_n90_), .b(x02), .c(new_n63_), .O(z15));
  nor2   g43(.a(new_n64_), .b(x00), .O(z16));
  zero   g44(.O(z01));
  zero   g45(.O(z02));
  zero   g46(.O(z08));
  zero   g47(.O(z13));
