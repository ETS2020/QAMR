...
module FAU ( 
  ...
  nand4  g24(.a(new_n69_), .b(x18), .c(x01), .d(new_n68_), .O(new_n70_));
  inv1   g25(.a(new_n70_), .O(new_n71_));
  nand4  g26(.a(new_n71_), .b(new_n67_), .c(new_n66_), .d(new_n65_), .O(new_n72_));
  inv1   g27(.a(new_n72_), .O(z09));
  inv1   g28(.a(x18), .O(new_n74_));
  nor2   g29(.a(x19), .b(new_n74_), .O(new_n75_));
  nand4  g30(.a(new_n75_), .b(x22), .c(x21), .d(new_n65_), .O(new_n76_));
  aoi21  g31(.a(new_n76_), .b(x01), .c(x00), .O(z10));
  nand4  g32(.a(new_n75_), .b(new_n67_), .c(x21), .d(new_n65_), .O(new_n78_));
  aoi21  g33(.a(new_n78_), .b(x01), .c(x00), .O(z11));
  aoi21  g34(.a(x10), .b(x02), .c(x24), .O(new_n80_));
  nand3  g35(.a(new_n80_), .b(x09), .c(x01), .O(new_n81_));
  nor2   g36(.a(new_n81_), .b(new_n68_), .O(z12));
  inv1   g37(.a(x02), .O(new_n83_));
  aoi21  g38(.a(new_n58_), .b(x01), .c(new_n83_), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(new_n68_), .c(new_n53_), .O(z15));
