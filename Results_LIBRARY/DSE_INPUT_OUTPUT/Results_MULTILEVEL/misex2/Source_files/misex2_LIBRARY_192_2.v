...
module FAU ( 
  ...
  oai21  g26(.a(new_n66_), .b(new_n57_), .c(new_n69_), .O(z03));
  ...
  nor3   g31(.a(new_n74_), .b(new_n58_), .c(new_n47_), .O(z05));
  ...
  aoi21  g45(.a(new_n88_), .b(new_n57_), .c(x01), .O(z08));
  ...
  nand4  g59(.a(new_n96_), .b(x12), .c(new_n92_), .d(x02), .O(new_n103_));
  nor2   g60(.a(x22), .b(x21), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(x20), .c(x16), .d(x15), .O(new_n105_));
  oai21  g62(.a(new_n105_), .b(new_n103_), .c(new_n57_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n62_), .O(new_n107_));
  nor3   g64(.a(new_n45_), .b(new_n62_), .c(x00), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n98_), .c(x22), .d(x21), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n107_), .O(z10));
  nand4  g67(.a(new_n104_), .b(x20), .c(new_n95_), .d(x15), .O(new_n111_));
  oai21  g68(.a(new_n111_), .b(new_n103_), .c(new_n57_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n62_), .O(new_n113_));
  nand4  g70(.a(new_n108_), .b(new_n98_), .c(new_n91_), .d(x21), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n113_), .O(z11));
  inv1   g72(.a(x24), .O(new_n116_));
  aoi21  g73(.a(x10), .b(x02), .c(new_n57_), .O(new_n117_));
  oai21  g74(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g75(.a(new_n67_), .b(x17), .c(new_n46_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n118_), .c(x01), .O(new_n120_));
  oai21  g77(.a(new_n120_), .b(new_n117_), .c(new_n116_), .O(new_n121_));
  nand2  g78(.a(new_n62_), .b(x00), .O(new_n122_));
  oai21  g79(.a(new_n121_), .b(new_n47_), .c(new_n122_), .O(z12));
  nand3  g80(.a(new_n48_), .b(x17), .c(new_n46_), .O(new_n124_));
  nor2   g81(.a(new_n124_), .b(x19), .O(z13));
  nand4  g82(.a(new_n59_), .b(new_n58_), .c(new_n47_), .d(new_n46_), .O(new_n126_));
  aoi21  g83(.a(new_n126_), .b(new_n57_), .c(x01), .O(z14));
  ...
  nand2  g88(.a(x01), .b(new_n57_), .O(new_n132_));
