...
module FAU ( 
  ...
  nand4  g16(.a(new_n59_), .b(new_n48_), .c(new_n44_), .d(new_n56_), .O(new_n60_));
  nor2   g17(.a(new_n60_), .b(x19), .O(z02));
  nand3  g18(.a(new_n46_), .b(new_n57_), .c(new_n45_), .O(new_n62_));
  nand3  g19(.a(new_n49_), .b(x18), .c(new_n44_), .O(new_n63_));
  ...
  nor3   g25(.a(new_n68_), .b(x09), .c(new_n46_), .O(new_n69_));
  nand3  g26(.a(new_n69_), .b(new_n67_), .c(x10), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(x12), .O(z04));
  nand2  g28(.a(x17), .b(new_n57_), .O(new_n72_));
  nand3  g29(.a(x10), .b(x09), .c(x02), .O(new_n73_));
  oai21  g30(.a(new_n73_), .b(new_n68_), .c(new_n72_), .O(z05));
  nand3  g31(.a(new_n69_), .b(x11), .c(x10), .O(new_n75_));
  ...
  nor2   g40(.a(new_n46_), .b(x01), .O(new_n85_));
  ...
  nor2   g47(.a(new_n48_), .b(new_n57_), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(new_n91_), .c(new_n49_), .O(new_n93_));
  oai21  g49(.a(new_n90_), .b(new_n87_), .c(new_n93_), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(new_n84_), .c(new_n83_), .d(new_n45_), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(z09));
  nor3   g52(.a(new_n84_), .b(new_n83_), .c(x20), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(new_n49_), .c(x18), .d(x01), .O(new_n98_));
  nand3  g54(.a(new_n67_), .b(x02), .c(new_n57_), .O(new_n99_));
  ...
  nand4  g62(.a(new_n92_), .b(x21), .c(new_n91_), .d(new_n49_), .O(new_n107_));
  ...
  nand3  g69(.a(new_n113_), .b(new_n84_), .c(new_n45_), .O(new_n114_));
  ...
  aoi21  g75(.a(new_n49_), .b(new_n46_), .c(new_n119_), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n44_), .c(new_n57_), .d(new_n45_), .O(new_n121_));
  ...
  nand4  g80(.a(new_n47_), .b(new_n46_), .c(new_n57_), .d(new_n45_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n48_), .c(new_n44_), .d(new_n56_), .O(new_n128_));
  nor2   g83(.a(new_n128_), .b(x19), .O(z14));
  aoi21  g84(.a(new_n56_), .b(x01), .c(new_n46_), .O(new_n130_));
  aoi21  g85(.a(x19), .b(new_n46_), .c(x17), .O(new_n131_));
  oai22  g86(.a(new_n131_), .b(x01), .c(new_n130_), .d(new_n45_), .O(z15));
