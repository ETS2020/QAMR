...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n61_, new_n62_, new_n64_, new_n65_, new_n69_, new_n71_, new_n72_,
  ...
  nand4  g06(.a(new_n49_), .b(new_n48_), .c(new_n45_), .d(new_n44_), .O(new_n50_));
  ...
  nand4  g18(.a(new_n58_), .b(new_n52_), .c(new_n51_), .d(new_n61_), .O(new_n62_));
  ...
  nand3  g23(.a(x02), .b(new_n45_), .c(x00), .O(new_n69_));
  ...
  nand2  g35(.a(new_n53_), .b(x18), .O(new_n81_));
  ...
  nand3  g42(.a(x02), .b(new_n45_), .c(new_n44_), .O(new_n88_));
  ...
  oai21  g53(.a(new_n98_), .b(new_n81_), .c(new_n44_), .O(new_n99_));
  ...
  nor2   g60(.a(new_n52_), .b(new_n45_), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(x21), .c(new_n82_), .d(new_n53_), .O(new_n107_));
  inv1   g62(.a(new_n91_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(x02), .c(new_n45_), .O(new_n109_));
  nor2   g64(.a(new_n101_), .b(x14), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n83_), .c(x20), .d(new_n102_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n109_), .c(new_n107_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n84_), .c(new_n44_), .O(new_n113_));
  inv1   g68(.a(new_n113_), .O(z11));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n115_));
  nand3  g70(.a(new_n53_), .b(x17), .c(new_n48_), .O(new_n116_));
  ...
  nand2  g74(.a(new_n56_), .b(x17), .O(new_n120_));
  nor2   g75(.a(new_n120_), .b(x19), .O(z13));
  nand2  g76(.a(new_n56_), .b(new_n49_), .O(new_n122_));
  inv1   g77(.a(new_n122_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n52_), .c(new_n51_), .d(new_n61_), .O(new_n124_));
  nor2   g79(.a(new_n124_), .b(x19), .O(z14));
  nor2   g80(.a(x19), .b(x00), .O(new_n126_));
  nor3   g81(.a(new_n126_), .b(x02), .c(x01), .O(z15));
  nand2  g82(.a(new_n88_), .b(new_n47_), .O(z17));
  zero   g83(.O(z04));
  zero   g84(.O(z05));
  buf    g85(.a(x01), .O(z16));
endmodule
