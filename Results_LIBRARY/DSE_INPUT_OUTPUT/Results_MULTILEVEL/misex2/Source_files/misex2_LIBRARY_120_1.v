...
module FAU ( 
  ...
  nand2  g027(.a(x05), .b(new_n63_), .O(new_n71_));
  ...
  oai22  g038(.a(new_n81_), .b(new_n80_), .c(x05), .d(x01), .O(new_n82_));
  ...
  nand4  g051(.a(x12), .b(new_n72_), .c(x02), .d(new_n63_), .O(new_n95_));
  ...
  nand3  g058(.a(new_n101_), .b(new_n100_), .c(new_n65_), .O(new_n102_));
  oai21  g059(.a(new_n99_), .b(new_n95_), .c(new_n102_), .O(new_n103_));
  nand4  g060(.a(new_n103_), .b(new_n94_), .c(new_n93_), .d(new_n52_), .O(new_n104_));
  nand2  g061(.a(new_n104_), .b(new_n71_), .O(z09));
  nand3  g062(.a(new_n65_), .b(x18), .c(x01), .O(new_n106_));
  nand3  g063(.a(x22), .b(x21), .c(new_n100_), .O(new_n107_));
  nor2   g064(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g065(.a(x02), .b(new_n63_), .O(new_n109_));
  ...
  nand4  g075(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n65_), .O(new_n119_));
  inv1   g076(.a(new_n109_), .O(new_n120_));
  nand3  g077(.a(x12), .b(new_n72_), .c(new_n44_), .O(new_n121_));
  inv1   g078(.a(new_n121_), .O(new_n122_));
  nand3  g079(.a(x15), .b(new_n113_), .c(new_n110_), .O(new_n123_));
  inv1   g080(.a(new_n123_), .O(new_n124_));
  nand3  g081(.a(new_n93_), .b(x20), .c(new_n97_), .O(new_n125_));
  inv1   g082(.a(new_n125_), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n124_), .c(new_n122_), .d(new_n120_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n119_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n94_), .c(new_n52_), .O(new_n129_));
  ...
  nand3  g091(.a(new_n65_), .b(x17), .c(new_n53_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n63_), .c(new_n52_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand3  g095(.a(new_n138_), .b(new_n131_), .c(x09), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(new_n71_), .O(z12));
  nand4  g097(.a(new_n65_), .b(x17), .c(new_n53_), .d(new_n52_), .O(new_n141_));
  aoi21  g098(.a(new_n141_), .b(new_n44_), .c(x01), .O(z13));
  nand2  g099(.a(new_n60_), .b(new_n45_), .O(new_n143_));
  aoi21  g100(.a(new_n143_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g101(.a(new_n58_), .b(x01), .c(new_n53_), .O(new_n145_));
  aoi21  g102(.a(x19), .b(new_n53_), .c(x05), .O(new_n146_));
  oai22  g103(.a(new_n146_), .b(x01), .c(new_n145_), .d(new_n52_), .O(z15));
  oai21  g104(.a(new_n63_), .b(x00), .c(new_n71_), .O(z16));
  aoi21  g105(.a(new_n85_), .b(new_n44_), .c(x01), .O(z17));
endmodule
