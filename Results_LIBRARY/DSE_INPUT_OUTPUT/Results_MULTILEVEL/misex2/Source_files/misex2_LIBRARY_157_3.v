...
module FAU ( 
  ...
  oai21  g017(.a(new_n60_), .b(new_n59_), .c(new_n44_), .O(new_n61_));
  ...
  aoi21  g028(.a(new_n71_), .b(new_n44_), .c(new_n67_), .O(z04));
  nand4  g029(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n73_));
  nor3   g030(.a(new_n73_), .b(x17), .c(new_n56_), .O(z05));
  ...
  aoi21  g035(.a(new_n78_), .b(new_n44_), .c(new_n67_), .O(z06));
  ...
  nand2  g039(.a(x17), .b(x01), .O(new_n83_));
  ...
  nand4  g060(.a(new_n103_), .b(x18), .c(new_n44_), .d(x01), .O(new_n104_));
  ...
  nand3  g064(.a(x18), .b(new_n44_), .c(x01), .O(new_n108_));
  ...
  nand3  g083(.a(new_n63_), .b(x17), .c(new_n76_), .O(new_n127_));
  oai21  g084(.a(new_n126_), .b(x01), .c(new_n127_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(new_n75_), .O(new_n129_));
  aoi21  g086(.a(new_n129_), .b(new_n125_), .c(x24), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(x09), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n83_), .O(z12));
  nand2  g089(.a(new_n47_), .b(x17), .O(new_n133_));
  nor2   g090(.a(new_n133_), .b(x19), .O(z13));
  nand4  g091(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n135_));
  nor2   g092(.a(new_n135_), .b(x19), .O(z14));
  oai21  g093(.a(x10), .b(new_n67_), .c(x02), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(x00), .O(new_n138_));
  nand3  g095(.a(x19), .b(new_n76_), .c(new_n67_), .O(new_n139_));
  nand3  g096(.a(new_n139_), .b(new_n138_), .c(new_n83_), .O(z15));
  nand3  g097(.a(new_n44_), .b(x01), .c(new_n75_), .O(new_n141_));
  inv1   g098(.a(new_n141_), .O(z16));
  nand2  g099(.a(new_n97_), .b(new_n75_), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(new_n83_), .O(z17));
endmodule
