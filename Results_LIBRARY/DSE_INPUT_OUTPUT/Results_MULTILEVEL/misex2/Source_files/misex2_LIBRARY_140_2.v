...
module FAU ( 
  ...
  nor2   g35(.a(x03), .b(new_n46_), .O(new_n79_));
  ...
  oai21  g49(.a(new_n92_), .b(new_n88_), .c(new_n53_), .O(new_n93_));
  nand2  g50(.a(new_n93_), .b(new_n60_), .O(new_n94_));
  nor3   g51(.a(new_n45_), .b(new_n60_), .c(x00), .O(new_n95_));
  ...
  oai21  g56(.a(new_n99_), .b(new_n88_), .c(new_n53_), .O(new_n100_));
  nand2  g57(.a(new_n100_), .b(new_n60_), .O(new_n101_));
  ...
  nand4  g63(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n65_), .O(new_n107_));
  nor2   g64(.a(new_n46_), .b(x01), .O(new_n108_));
  nor2   g65(.a(x13), .b(new_n70_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n108_), .c(new_n69_), .O(new_n110_));
  ...
  nand3  g71(.a(new_n114_), .b(new_n104_), .c(new_n53_), .O(new_n115_));
  ...
  nand3  g77(.a(new_n65_), .b(x17), .c(new_n46_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n60_), .c(new_n53_), .O(new_n123_));
  ...
  nand4  g85(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n129_));
