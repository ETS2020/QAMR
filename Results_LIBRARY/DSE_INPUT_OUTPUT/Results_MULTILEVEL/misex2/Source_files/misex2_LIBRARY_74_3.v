...
module FAU ( 
  ...
  nand2  g007(.a(x21), .b(x14), .O(new_n51_));
  ...
  nor2   g025(.a(x19), .b(new_n49_), .O(new_n69_));
  nand3  g026(.a(new_n69_), .b(new_n68_), .c(new_n48_), .O(new_n70_));
  aoi21  g027(.a(new_n70_), .b(new_n67_), .c(new_n63_), .O(z03));
  inv1   g028(.a(x11), .O(new_n72_));
  inv1   g029(.a(x12), .O(new_n73_));
  nand3  g030(.a(new_n66_), .b(new_n73_), .c(new_n72_), .O(new_n74_));
  oai21  g031(.a(new_n74_), .b(new_n64_), .c(new_n51_), .O(z04));
  ...
  nand4  g047(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n56_), .O(new_n91_));
  ...
  nand3  g053(.a(new_n88_), .b(x12), .c(new_n72_), .O(new_n97_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n56_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n51_), .O(z09));
  inv1   g064(.a(x14), .O(new_n108_));
  nor2   g065(.a(new_n96_), .b(new_n95_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n69_), .c(new_n102_), .d(x01), .O(new_n110_));
  nor2   g067(.a(x13), .b(new_n73_), .O(new_n111_));
  nand3  g068(.a(new_n111_), .b(new_n88_), .c(new_n72_), .O(new_n112_));
  ...
  nand3  g072(.a(new_n115_), .b(new_n108_), .c(new_n56_), .O(new_n116_));
  inv1   g073(.a(new_n116_), .O(z10));
  nand4  g074(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n50_), .O(new_n118_));
  nor2   g075(.a(new_n98_), .b(x14), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(new_n95_), .c(x20), .d(new_n99_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(new_n112_), .c(new_n118_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n96_), .c(new_n56_), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n51_), .O(z11));
  ...
  nand3  g086(.a(new_n129_), .b(new_n44_), .c(new_n56_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  nand4  g088(.a(new_n131_), .b(new_n51_), .c(new_n124_), .d(x09), .O(new_n132_));
  inv1   g089(.a(new_n132_), .O(z12));
  nand2  g090(.a(new_n44_), .b(new_n56_), .O(new_n134_));
  oai21  g091(.a(new_n128_), .b(new_n134_), .c(new_n51_), .O(z13));
  nand4  g092(.a(new_n60_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n136_));
  ...
  oai21  g098(.a(new_n44_), .b(x00), .c(new_n51_), .O(z16));
  nand4  g099(.a(new_n51_), .b(x02), .c(new_n44_), .d(new_n56_), .O(new_n143_));
