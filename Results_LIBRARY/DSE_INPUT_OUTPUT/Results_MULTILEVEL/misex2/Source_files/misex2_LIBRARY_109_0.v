...
module FAU ( 
  ...
  nand3  g13(.a(x11), .b(x10), .c(new_n50_), .O(new_n60_));
  oai21  g14(.a(new_n60_), .b(new_n49_), .c(new_n48_), .O(z06));
  inv1   g15(.a(x12), .O(new_n62_));
  nand4  g16(.a(new_n62_), .b(x11), .c(x10), .d(new_n50_), .O(new_n63_));
  ...
  nand4  g30(.a(new_n76_), .b(x22), .c(x21), .d(new_n72_), .O(new_n77_));
  inv1   g31(.a(new_n77_), .O(z10));
  inv1   g32(.a(x22), .O(new_n79_));
  nand4  g33(.a(new_n68_), .b(new_n79_), .c(x21), .d(new_n72_), .O(new_n80_));
  ...
  oai21  g41(.a(new_n88_), .b(z16), .c(new_n48_), .O(z15));
  zero   g42(.O(z00));
  zero   g43(.O(z01));
  zero   g44(.O(z02));
  zero   g45(.O(z13));
