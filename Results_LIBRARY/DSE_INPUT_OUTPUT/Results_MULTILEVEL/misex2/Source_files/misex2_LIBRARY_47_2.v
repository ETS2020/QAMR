...
module FAU ( 
  ...
  nor3   g034(.a(new_n77_), .b(new_n57_), .c(new_n60_), .O(z05));
  ...
  nand4  g059(.a(new_n102_), .b(x20), .c(new_n57_), .d(new_n101_), .O(new_n103_));
  nor2   g060(.a(x20), .b(x19), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(x18), .c(x16), .d(x01), .O(new_n105_));
  oai21  g062(.a(new_n103_), .b(new_n100_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n99_), .c(new_n98_), .d(new_n79_), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(z09));
  nand3  g065(.a(new_n61_), .b(x18), .c(x01), .O(new_n109_));
  ...
  oai21  g076(.a(new_n119_), .b(x00), .c(new_n58_), .O(z10));
  nor2   g077(.a(new_n45_), .b(new_n71_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(x21), .c(new_n110_), .d(new_n61_), .O(new_n122_));
  nand4  g079(.a(new_n113_), .b(x12), .c(new_n72_), .d(x02), .O(new_n123_));
  nor2   g080(.a(new_n101_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n98_), .c(x20), .d(new_n57_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n123_), .c(new_n122_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n99_), .c(new_n79_), .O(new_n127_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n71_), .c(new_n79_), .O(new_n134_));
  ...
  aoi22  g098(.a(new_n58_), .b(x00), .c(x19), .d(new_n71_), .O(new_n142_));
  nand4  g099(.a(x16), .b(new_n60_), .c(x01), .d(x00), .O(new_n143_));
  oai21  g100(.a(new_n142_), .b(x02), .c(new_n143_), .O(z15));
  nand3  g101(.a(x16), .b(x01), .c(new_n79_), .O(new_n145_));
