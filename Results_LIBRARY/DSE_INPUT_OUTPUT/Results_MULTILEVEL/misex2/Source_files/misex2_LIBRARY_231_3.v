...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n62_, new_n63_, new_n64_, new_n65_, new_n66_, new_n69_, new_n71_,
  ...
  nand3  g24(.a(x02), .b(new_n60_), .c(x00), .O(new_n69_));
  ...
  nor2   g39(.a(new_n63_), .b(x01), .O(new_n84_));
  ...
  nand2  g51(.a(new_n65_), .b(x18), .O(new_n96_));
  nand3  g52(.a(x22), .b(x21), .c(new_n90_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n96_), .c(new_n59_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(x01), .O(new_n99_));
  nand2  g55(.a(new_n84_), .b(new_n59_), .O(new_n100_));
  inv1   g56(.a(x13), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(x12), .c(new_n83_), .O(new_n102_));
  nor2   g58(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nor3   g59(.a(new_n87_), .b(new_n86_), .c(x14), .O(new_n104_));
  nor2   g60(.a(x22), .b(x21), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(x20), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n99_), .O(z10));
  nand4  g63(.a(new_n91_), .b(x21), .c(new_n90_), .d(new_n65_), .O(new_n108_));
  inv1   g64(.a(new_n102_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n84_), .O(new_n110_));
  nor2   g66(.a(new_n86_), .b(x14), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n81_), .c(x20), .d(new_n87_), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n110_), .c(new_n108_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n82_), .c(new_n59_), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(z11));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g72(.a(new_n65_), .b(x17), .c(new_n63_), .O(new_n117_));
  aoi21  g73(.a(new_n117_), .b(new_n116_), .c(x24), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(x09), .c(new_n60_), .O(new_n119_));
  nor2   g75(.a(new_n119_), .b(x00), .O(z12));
  nand2  g76(.a(new_n47_), .b(x17), .O(new_n121_));
  nor2   g77(.a(new_n121_), .b(x19), .O(z13));
  nand4  g78(.a(new_n46_), .b(new_n63_), .c(new_n60_), .d(new_n59_), .O(new_n123_));
  nand4  g79(.a(new_n65_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n123_), .c(new_n62_), .O(z14));
  nor2   g81(.a(x19), .b(x00), .O(new_n126_));
  nor3   g82(.a(new_n126_), .b(x02), .c(x01), .O(z15));
  nor2   g83(.a(new_n60_), .b(x00), .O(z16));
  nand2  g84(.a(new_n100_), .b(new_n62_), .O(z17));
  zero   g85(.O(z06));
  nor2   g86(.a(new_n60_), .b(new_n59_), .O(z05));
endmodule
