...
module FAU ( 
  ...
  nand3  g16(.a(new_n57_), .b(new_n44_), .c(new_n46_), .O(new_n60_));
  ...
  oai21  g23(.a(new_n66_), .b(new_n64_), .c(x16), .O(new_n67_));
  nand2  g24(.a(new_n67_), .b(new_n48_), .O(new_n68_));
  nand3  g25(.a(x02), .b(x01), .c(x00), .O(new_n69_));
  nor2   g26(.a(new_n46_), .b(x09), .O(new_n70_));
  nand3  g27(.a(new_n70_), .b(x12), .c(x11), .O(new_n71_));
  oai21  g28(.a(new_n71_), .b(new_n69_), .c(new_n68_), .O(z03));
  inv1   g29(.a(x16), .O(new_n73_));
  nand2  g30(.a(new_n73_), .b(new_n48_), .O(new_n74_));
  inv1   g31(.a(x11), .O(new_n75_));
  inv1   g32(.a(x12), .O(new_n76_));
  nand3  g33(.a(new_n70_), .b(new_n76_), .c(new_n75_), .O(new_n77_));
  oai21  g34(.a(new_n77_), .b(new_n69_), .c(new_n74_), .O(z04));
  nand2  g35(.a(x01), .b(x00), .O(new_n79_));
  nand3  g36(.a(x10), .b(x09), .c(x02), .O(new_n80_));
  oai21  g37(.a(new_n80_), .b(new_n79_), .c(new_n74_), .O(z05));
  nand3  g38(.a(x11), .b(x10), .c(new_n50_), .O(new_n82_));
  oai21  g39(.a(new_n82_), .b(new_n69_), .c(new_n74_), .O(z06));
  nand3  g40(.a(new_n70_), .b(new_n76_), .c(x11), .O(new_n84_));
  ...
  nand3  g49(.a(x19), .b(new_n45_), .c(x17), .O(new_n93_));
  inv1   g50(.a(new_n93_), .O(new_n94_));
  nand3  g51(.a(new_n94_), .b(new_n92_), .c(new_n91_), .O(new_n95_));
  aoi21  g52(.a(new_n95_), .b(x16), .c(x01), .O(z08));
  nand3  g53(.a(x18), .b(x01), .c(new_n47_), .O(new_n97_));
  inv1   g54(.a(x20), .O(new_n98_));
  inv1   g55(.a(x21), .O(new_n99_));
  inv1   g56(.a(x22), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n65_), .O(new_n101_));
  oai21  g58(.a(new_n101_), .b(new_n97_), .c(new_n74_), .O(z09));
  nor3   g59(.a(new_n100_), .b(new_n99_), .c(x20), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n65_), .c(x18), .d(x01), .O(new_n104_));
  inv1   g61(.a(x13), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(x12), .c(new_n75_), .O(new_n106_));
  nor3   g63(.a(new_n106_), .b(new_n49_), .c(x01), .O(new_n107_));
  nand2  g64(.a(x16), .b(x15), .O(new_n108_));
  nand3  g65(.a(new_n100_), .b(new_n99_), .c(x20), .O(new_n109_));
  nor3   g66(.a(new_n109_), .b(new_n108_), .c(x14), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n104_), .c(x00), .O(z10));
  nand4  g69(.a(new_n100_), .b(x21), .c(new_n98_), .d(new_n65_), .O(new_n113_));
  oai21  g70(.a(new_n113_), .b(new_n97_), .c(new_n74_), .O(z11));
  inv1   g71(.a(x24), .O(new_n115_));
  aoi21  g72(.a(x10), .b(x02), .c(new_n48_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(x00), .O(new_n117_));
  oai21  g74(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g75(.a(new_n65_), .b(x17), .c(new_n49_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n48_), .c(new_n47_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n117_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n115_), .c(x09), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n74_), .O(z12));
  nand3  g81(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n125_));
  nor4   g82(.a(new_n125_), .b(x19), .c(new_n44_), .d(new_n73_), .O(z13));
  nand4  g83(.a(new_n61_), .b(new_n50_), .c(new_n49_), .d(new_n47_), .O(new_n127_));
  aoi21  g84(.a(new_n127_), .b(x16), .c(x01), .O(z14));
  aoi21  g85(.a(x16), .b(new_n49_), .c(new_n116_), .O(new_n129_));
  nand4  g86(.a(x19), .b(x16), .c(new_n49_), .d(new_n48_), .O(new_n130_));
  oai21  g87(.a(new_n129_), .b(new_n47_), .c(new_n130_), .O(z15));
  oai21  g88(.a(new_n48_), .b(x00), .c(new_n74_), .O(z16));
