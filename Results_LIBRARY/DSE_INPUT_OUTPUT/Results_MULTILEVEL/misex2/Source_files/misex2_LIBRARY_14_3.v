...
module FAU ( 
  ...
  nand2  g012(.a(x06), .b(x01), .O(new_n56_));
  ...
  nand4  g029(.a(new_n72_), .b(x10), .c(new_n46_), .d(new_n67_), .O(new_n73_));
  ...
  nand2  g035(.a(new_n46_), .b(new_n67_), .O(new_n79_));
  ...
  nor2   g041(.a(new_n59_), .b(x01), .O(new_n85_));
  nand2  g042(.a(new_n85_), .b(new_n57_), .O(new_n86_));
  ...
  nand2  g050(.a(new_n93_), .b(new_n56_), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nand4  g053(.a(x12), .b(new_n77_), .c(x02), .d(new_n58_), .O(new_n97_));
  ...
  nand4  g059(.a(new_n102_), .b(new_n62_), .c(x18), .d(x01), .O(new_n103_));
  ...
  nand2  g062(.a(new_n105_), .b(new_n56_), .O(z09));
  ...
  nand2  g066(.a(x02), .b(new_n58_), .O(new_n110_));
  ...
  nand4  g076(.a(new_n85_), .b(new_n111_), .c(x12), .d(new_n77_), .O(new_n120_));
  nor2   g077(.a(new_n45_), .b(x06), .O(new_n121_));
  nor2   g078(.a(new_n95_), .b(x20), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n121_), .c(new_n62_), .d(x01), .O(new_n123_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n96_), .c(new_n57_), .O(new_n127_));
  ...
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n56_), .O(z15));
  nand3  g103(.a(new_n67_), .b(x01), .c(new_n57_), .O(new_n147_));
  inv1   g104(.a(new_n147_), .O(z16));
  nand2  g105(.a(new_n86_), .b(new_n56_), .O(z17));
endmodule
