...
module FAU ( 
  ...
  nand3  g26(.a(new_n69_), .b(x10), .c(new_n47_), .O(new_n70_));
  nor3   g27(.a(new_n70_), .b(x12), .c(x11), .O(z04));
  nor3   g28(.a(new_n68_), .b(new_n57_), .c(new_n47_), .O(z05));
  ...
  nand4  g48(.a(x12), .b(new_n76_), .c(x02), .d(new_n61_), .O(new_n92_));
  ...
  nand4  g59(.a(new_n95_), .b(x12), .c(new_n76_), .d(x02), .O(new_n103_));
  ...
  oai21  g63(.a(new_n106_), .b(new_n103_), .c(new_n60_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n61_), .O(new_n108_));
  ...
  oai21  g70(.a(new_n113_), .b(new_n103_), .c(new_n60_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n61_), .O(new_n115_));
  ...
  nand3  g77(.a(new_n63_), .b(x17), .c(new_n46_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n61_), .c(new_n60_), .O(new_n123_));
  aoi21  g80(.a(new_n123_), .b(new_n119_), .c(x24), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(x09), .O(new_n125_));
  inv1   g82(.a(new_n125_), .O(z12));
  aoi21  g83(.a(new_n121_), .b(new_n60_), .c(x01), .O(z13));
  nor3   g84(.a(x10), .b(x09), .c(x02), .O(new_n128_));
  nand4  g85(.a(new_n128_), .b(new_n63_), .c(new_n45_), .d(new_n44_), .O(new_n129_));
  aoi21  g86(.a(new_n129_), .b(new_n60_), .c(x01), .O(z14));
  nand3  g87(.a(new_n48_), .b(x19), .c(new_n46_), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(new_n119_), .O(z15));
  nor2   g89(.a(new_n61_), .b(x00), .O(z16));
  aoi21  g90(.a(new_n46_), .b(new_n60_), .c(x01), .O(z17));
endmodule
