...
module FAU ( 
  ...
  aoi21  g04(.a(new_n47_), .b(x16), .c(x01), .O(z00));
  ...
  nand4  g12(.a(new_n55_), .b(new_n49_), .c(new_n44_), .d(x16), .O(new_n56_));
  nor2   g13(.a(new_n56_), .b(x19), .O(z01));
  nor2   g14(.a(new_n54_), .b(x10), .O(new_n58_));
  nand4  g15(.a(new_n58_), .b(new_n49_), .c(new_n44_), .d(x16), .O(new_n59_));
  ...
  oai21  g20(.a(new_n63_), .b(new_n61_), .c(x16), .O(new_n64_));
  ...
  nor3   g34(.a(new_n77_), .b(new_n50_), .c(new_n76_), .O(z05));
  inv1   g35(.a(new_n77_), .O(new_n79_));
  nand4  g36(.a(new_n79_), .b(x11), .c(x10), .d(new_n76_), .O(new_n80_));
  inv1   g37(.a(new_n80_), .O(z06));
  nand3  g38(.a(new_n67_), .b(new_n73_), .c(x11), .O(new_n82_));
  ...
  nor2   g47(.a(new_n62_), .b(x18), .O(new_n91_));
  nand4  g48(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(x17), .O(new_n92_));
  aoi21  g49(.a(new_n92_), .b(x16), .c(x01), .O(z08));
  nand3  g50(.a(x18), .b(x01), .c(new_n51_), .O(new_n94_));
  inv1   g51(.a(x20), .O(new_n95_));
  inv1   g52(.a(x21), .O(new_n96_));
  inv1   g53(.a(x22), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n62_), .O(new_n98_));
  oai21  g55(.a(new_n98_), .b(new_n94_), .c(new_n71_), .O(z09));
  nand3  g56(.a(new_n62_), .b(x18), .c(x01), .O(new_n100_));
  nand3  g57(.a(x22), .b(x21), .c(new_n95_), .O(new_n101_));
  nor2   g58(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g59(.a(x02), .b(new_n52_), .O(new_n103_));
  inv1   g60(.a(x13), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(x12), .c(new_n72_), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  inv1   g63(.a(x14), .O(new_n107_));
  nand2  g64(.a(x15), .b(new_n107_), .O(new_n108_));
  nand3  g65(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n109_));
  nor2   g66(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n106_), .c(new_n102_), .O(new_n111_));
  oai21  g68(.a(new_n111_), .b(x00), .c(new_n71_), .O(z10));
  nand4  g69(.a(new_n97_), .b(x21), .c(new_n95_), .d(new_n62_), .O(new_n113_));
  oai21  g70(.a(new_n113_), .b(new_n94_), .c(new_n71_), .O(z11));
  ...
  nand3  g75(.a(new_n62_), .b(x17), .c(new_n53_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand4  g77(.a(new_n120_), .b(x16), .c(new_n52_), .d(new_n51_), .O(new_n121_));
  ...
  nand4  g81(.a(new_n62_), .b(x17), .c(new_n53_), .d(new_n51_), .O(new_n125_));
  aoi21  g82(.a(new_n125_), .b(x16), .c(x01), .O(z13));
  nand3  g83(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n127_));
  nor3   g84(.a(new_n127_), .b(x10), .c(x09), .O(new_n128_));
  nand4  g85(.a(new_n128_), .b(new_n49_), .c(new_n44_), .d(x16), .O(new_n129_));
  nor2   g86(.a(new_n129_), .b(x19), .O(z14));
  aoi21  g87(.a(new_n50_), .b(x01), .c(new_n53_), .O(new_n131_));
  aoi21  g88(.a(x19), .b(new_n53_), .c(new_n70_), .O(new_n132_));
  oai22  g89(.a(new_n132_), .b(x01), .c(new_n131_), .d(new_n51_), .O(z15));
  nor2   g90(.a(new_n52_), .b(x00), .O(z16));
  aoi21  g91(.a(new_n86_), .b(x16), .c(x01), .O(z17));
endmodule
