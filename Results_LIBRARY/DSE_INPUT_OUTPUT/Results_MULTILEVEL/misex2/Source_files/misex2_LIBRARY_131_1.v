...
module FAU ( 
  ...
  oai21  g34(.a(new_n47_), .b(x00), .c(new_n77_), .O(z07));
  ...
  nand4  g58(.a(new_n101_), .b(new_n90_), .c(new_n89_), .d(x12), .O(new_n102_));
  nor2   g59(.a(new_n102_), .b(new_n98_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n97_), .c(x20), .d(x16), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(x22), .O(z10));
  inv1   g62(.a(x16), .O(new_n106_));
  nand4  g63(.a(new_n103_), .b(new_n97_), .c(x20), .d(new_n106_), .O(new_n107_));
  ...
  nor3   g74(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
