...
module FAU ( 
  ...
  nand4  g12(.a(x09), .b(new_n45_), .c(new_n55_), .d(new_n44_), .O(new_n56_));
  ...
  nand3  g16(.a(new_n45_), .b(new_n55_), .c(new_n44_), .O(new_n60_));
  inv1   g17(.a(x19), .O(new_n61_));
  nand3  g18(.a(new_n61_), .b(x18), .c(new_n53_), .O(new_n62_));
  ...
  nor2   g24(.a(x09), .b(new_n45_), .O(new_n68_));
  ...
  nand4  g31(.a(new_n74_), .b(x11), .c(x10), .d(new_n46_), .O(new_n75_));
  inv1   g32(.a(new_n75_), .O(z06));
  nand4  g33(.a(new_n68_), .b(new_n67_), .c(x11), .d(x10), .O(new_n77_));
  ...
  nand4  g39(.a(new_n82_), .b(x02), .c(new_n55_), .d(new_n44_), .O(new_n83_));
  ...
  nor2   g44(.a(new_n87_), .b(new_n61_), .O(z08));
  ...
  nor2   g53(.a(new_n54_), .b(new_n55_), .O(new_n97_));
  inv1   g54(.a(x20), .O(new_n98_));
  nand2  g55(.a(new_n98_), .b(new_n61_), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(new_n100_));
  nand2  g57(.a(new_n100_), .b(new_n97_), .O(new_n101_));
  oai21  g58(.a(new_n96_), .b(new_n92_), .c(new_n101_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n90_), .c(new_n89_), .d(new_n44_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(z09));
  nand4  g61(.a(new_n95_), .b(x12), .c(new_n66_), .d(x02), .O(new_n105_));
  nor2   g62(.a(x22), .b(x21), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(x20), .c(x16), .d(x15), .O(new_n107_));
  oai21  g64(.a(new_n107_), .b(new_n105_), .c(new_n44_), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(new_n55_), .O(new_n109_));
  nor2   g66(.a(new_n90_), .b(new_n89_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n100_), .c(new_n97_), .d(new_n44_), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(new_n109_), .O(z10));
  nand4  g69(.a(new_n97_), .b(x21), .c(new_n98_), .d(new_n61_), .O(new_n113_));
  nor2   g70(.a(x13), .b(new_n67_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n91_), .c(new_n66_), .O(new_n115_));
  nor2   g72(.a(new_n93_), .b(x14), .O(new_n116_));
  nand4  g73(.a(new_n116_), .b(new_n89_), .c(x20), .d(new_n94_), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n115_), .c(new_n113_), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(new_n90_), .c(new_n44_), .O(new_n119_));
  ...
  nand3  g80(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n124_));
  ...
  aoi21  g84(.a(new_n124_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g85(.a(new_n47_), .b(new_n52_), .c(new_n46_), .d(new_n45_), .O(new_n129_));
  aoi21  g86(.a(new_n129_), .b(new_n44_), .c(x01), .O(z14));
  inv1   g87(.a(new_n122_), .O(new_n131_));
  aoi21  g88(.a(x19), .b(new_n45_), .c(x00), .O(new_n132_));
  oai21  g89(.a(new_n132_), .b(x01), .c(new_n131_), .O(z15));
  nor2   g90(.a(new_n55_), .b(x00), .O(z16));
  nand3  g91(.a(x02), .b(new_n55_), .c(new_n44_), .O(new_n135_));
