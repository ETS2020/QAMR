...
module FAU ( 
  ...
  nand4  g024(.a(new_n67_), .b(new_n64_), .c(new_n46_), .d(new_n45_), .O(new_n68_));
  nand2  g025(.a(new_n68_), .b(new_n63_), .O(z03));
  ...
  nor2   g031(.a(new_n74_), .b(new_n64_), .O(z04));
  nor4   g032(.a(new_n72_), .b(new_n64_), .c(new_n57_), .d(new_n47_), .O(z05));
  nor2   g033(.a(new_n46_), .b(new_n45_), .O(new_n77_));
  ...
  nor2   g048(.a(new_n65_), .b(x18), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(x17), .O(new_n93_));
  nand2  g050(.a(new_n93_), .b(new_n85_), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nand3  g053(.a(new_n86_), .b(x12), .c(new_n70_), .O(new_n97_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n96_), .c(new_n95_), .d(new_n45_), .O(new_n105_));
  nand2  g062(.a(new_n105_), .b(new_n85_), .O(z09));
  nand3  g063(.a(x22), .b(x21), .c(new_n102_), .O(new_n107_));
  nor3   g064(.a(new_n107_), .b(new_n66_), .c(new_n44_), .O(new_n108_));
  inv1   g065(.a(x13), .O(new_n109_));
  nand3  g066(.a(new_n109_), .b(x12), .c(new_n70_), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(new_n111_));
  nand2  g068(.a(new_n111_), .b(new_n86_), .O(new_n112_));
  ...
  nand3  g076(.a(x21), .b(new_n102_), .c(new_n65_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n96_), .c(new_n45_), .O(new_n124_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n44_), .c(new_n45_), .O(new_n133_));
  ...
  nand2  g093(.a(new_n44_), .b(new_n45_), .O(new_n137_));
  nand3  g094(.a(new_n65_), .b(x17), .c(new_n46_), .O(new_n138_));
  oai21  g095(.a(new_n138_), .b(new_n137_), .c(new_n85_), .O(z13));
  nor2   g096(.a(new_n137_), .b(x02), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(new_n64_), .c(new_n57_), .d(new_n47_), .O(new_n141_));
  nor3   g098(.a(new_n141_), .b(x19), .c(x18), .O(z14));
  oai21  g099(.a(x10), .b(new_n44_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n46_), .c(new_n44_), .O(new_n145_));
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n85_), .O(z15));
  aoi21  g103(.a(x17), .b(x00), .c(new_n44_), .O(z16));
  nand2  g104(.a(new_n87_), .b(new_n85_), .O(z17));
endmodule
