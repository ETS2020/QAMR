...
module FAU ( 
  ...
  oai21  g21(.a(new_n64_), .b(new_n63_), .c(x07), .O(new_n65_));
  ...
  nor3   g34(.a(new_n77_), .b(new_n58_), .c(new_n59_), .O(z05));
  inv1   g35(.a(new_n77_), .O(new_n79_));
  nand4  g36(.a(new_n79_), .b(x11), .c(x10), .d(new_n59_), .O(new_n80_));
  inv1   g37(.a(new_n80_), .O(z06));
  nand3  g38(.a(new_n68_), .b(new_n74_), .c(x11), .O(new_n82_));
  nand2  g39(.a(new_n82_), .b(x01), .O(new_n83_));
  nand3  g40(.a(new_n83_), .b(x02), .c(x00), .O(new_n84_));
  nand2  g41(.a(new_n84_), .b(new_n72_), .O(z07));
  ...
  nand3  g46(.a(new_n89_), .b(new_n88_), .c(x07), .O(new_n90_));
  ...
  inv1   g59(.a(x07), .O(new_n103_));
  nor3   g60(.a(new_n103_), .b(new_n48_), .c(x01), .O(new_n104_));
  inv1   g61(.a(x13), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(x12), .c(new_n73_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nor3   g64(.a(new_n92_), .b(new_n91_), .c(x14), .O(new_n108_));
  nand3  g65(.a(new_n87_), .b(new_n86_), .c(x20), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n108_), .c(new_n107_), .d(new_n104_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n102_), .c(x00), .O(z10));
  nand4  g69(.a(new_n96_), .b(x21), .c(new_n95_), .d(new_n53_), .O(new_n113_));
  nor2   g70(.a(new_n91_), .b(x14), .O(new_n114_));
  nor2   g71(.a(x21), .b(new_n95_), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n114_), .c(new_n92_), .d(new_n105_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n90_), .c(new_n113_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n87_), .c(new_n46_), .O(new_n118_));
  ...
  nand3  g80(.a(new_n53_), .b(x17), .c(new_n48_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand3  g82(.a(new_n125_), .b(new_n47_), .c(new_n46_), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(new_n122_), .O(new_n127_));
  nand3  g84(.a(new_n127_), .b(new_n120_), .c(x09), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(new_n72_), .O(z12));
  nand4  g86(.a(new_n53_), .b(x17), .c(new_n48_), .d(new_n46_), .O(new_n130_));
  aoi21  g87(.a(new_n130_), .b(x07), .c(x01), .O(z13));
  nand4  g88(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n132_));
  nor2   g89(.a(new_n132_), .b(x19), .O(z14));
  aoi21  g90(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n134_));
  aoi21  g91(.a(x19), .b(new_n48_), .c(new_n103_), .O(new_n135_));
  oai22  g92(.a(new_n135_), .b(x01), .c(new_n134_), .d(new_n46_), .O(z15));
  nor2   g93(.a(new_n47_), .b(x00), .O(z16));
  nand2  g94(.a(x02), .b(new_n46_), .O(new_n138_));
  aoi21  g95(.a(new_n138_), .b(x07), .c(x01), .O(z17));
endmodule
