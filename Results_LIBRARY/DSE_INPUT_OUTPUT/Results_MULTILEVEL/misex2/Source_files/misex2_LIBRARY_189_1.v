...
module FAU ( 
  ...
  nand2  g021(.a(x21), .b(new_n64_), .O(new_n65_));
  ...
  nor2   g026(.a(new_n64_), .b(x09), .O(new_n70_));
  ...
  nand3  g054(.a(new_n87_), .b(x12), .c(new_n73_), .O(new_n98_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n97_), .c(new_n58_), .d(new_n46_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n65_), .O(z09));
  nand3  g064(.a(x18), .b(x10), .c(x01), .O(new_n108_));
  ...
  nand3  g071(.a(new_n97_), .b(new_n58_), .c(x20), .O(new_n115_));
  inv1   g072(.a(new_n115_), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(new_n114_), .c(new_n113_), .d(new_n87_), .O(new_n117_));
  aoi21  g074(.a(new_n117_), .b(new_n110_), .c(x00), .O(z10));
  nand4  g075(.a(new_n87_), .b(new_n111_), .c(x12), .d(new_n73_), .O(new_n119_));
  nor2   g076(.a(new_n58_), .b(x20), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n109_), .c(new_n63_), .O(new_n121_));
  nor2   g078(.a(new_n99_), .b(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n58_), .c(x20), .d(new_n100_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n119_), .c(new_n121_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n97_), .c(new_n46_), .O(new_n125_));
  inv1   g082(.a(new_n125_), .O(z11));
  inv1   g083(.a(x24), .O(new_n127_));
  nand2  g084(.a(x10), .b(new_n48_), .O(new_n128_));
  nand2  g085(.a(new_n58_), .b(new_n64_), .O(new_n129_));
  ...
  nand4  g091(.a(new_n134_), .b(new_n65_), .c(new_n47_), .d(new_n46_), .O(new_n135_));
  ...
  nand2  g099(.a(x01), .b(x00), .O(new_n143_));
  nor2   g100(.a(x21), .b(x01), .O(new_n144_));
  oai21  g101(.a(new_n144_), .b(x10), .c(x00), .O(new_n145_));
  nand3  g102(.a(new_n65_), .b(x19), .c(new_n47_), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(new_n48_), .O(new_n148_));
  oai21  g105(.a(new_n129_), .b(new_n143_), .c(new_n148_), .O(z15));
  nor3   g106(.a(new_n81_), .b(new_n47_), .c(x00), .O(z16));
  nand2  g107(.a(new_n88_), .b(new_n65_), .O(z17));
endmodule
