...
module FAU ( 
  ...
  inv1   g021(.a(x08), .O(new_n65_));
  nor2   g022(.a(x24), .b(new_n65_), .O(new_n66_));
  ...
  nand4  g034(.a(new_n52_), .b(new_n77_), .c(new_n76_), .d(x10), .O(new_n78_));
  ...
  oai21  g040(.a(new_n83_), .b(new_n82_), .c(new_n52_), .O(z05));
  nor2   g041(.a(new_n66_), .b(new_n76_), .O(new_n85_));
  nand4  g042(.a(new_n85_), .b(x10), .c(new_n46_), .d(x02), .O(new_n86_));
  nor3   g043(.a(new_n86_), .b(new_n44_), .c(new_n75_), .O(z06));
  ...
  nand2  g047(.a(new_n90_), .b(new_n52_), .O(z07));
  nor2   g048(.a(new_n45_), .b(x01), .O(new_n92_));
  nand2  g049(.a(new_n92_), .b(new_n75_), .O(new_n93_));
  ...
  nor2   g055(.a(new_n50_), .b(x18), .O(new_n99_));
  nand4  g056(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(x17), .O(new_n100_));
  nand2  g057(.a(new_n100_), .b(new_n52_), .O(z08));
  inv1   g058(.a(x21), .O(new_n102_));
  inv1   g059(.a(x22), .O(new_n103_));
  nand3  g060(.a(new_n92_), .b(x12), .c(new_n76_), .O(new_n104_));
  ...
  and2   g066(.a(x18), .b(x01), .O(new_n110_));
  nand3  g067(.a(new_n110_), .b(new_n109_), .c(new_n50_), .O(new_n111_));
  oai21  g068(.a(new_n108_), .b(new_n104_), .c(new_n111_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n103_), .c(new_n102_), .d(new_n75_), .O(new_n113_));
  nand2  g070(.a(new_n113_), .b(new_n52_), .O(z09));
  nor2   g071(.a(new_n103_), .b(new_n102_), .O(new_n115_));
  nand4  g072(.a(new_n115_), .b(new_n72_), .c(new_n109_), .d(x01), .O(new_n116_));
  nor2   g073(.a(x13), .b(new_n77_), .O(new_n117_));
  nand3  g074(.a(new_n117_), .b(new_n92_), .c(new_n76_), .O(new_n118_));
  inv1   g075(.a(x14), .O(new_n119_));
  nor2   g076(.a(new_n106_), .b(new_n105_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n52_), .c(new_n75_), .O(new_n124_));
  inv1   g081(.a(new_n124_), .O(z10));
  nand4  g082(.a(new_n110_), .b(x21), .c(new_n109_), .d(new_n50_), .O(new_n126_));
  nor2   g083(.a(new_n105_), .b(x14), .O(new_n127_));
  nor2   g084(.a(x21), .b(new_n109_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n127_), .c(new_n106_), .O(new_n129_));
  oai21  g086(.a(new_n129_), .b(new_n118_), .c(new_n126_), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(new_n52_), .c(new_n103_), .d(new_n75_), .O(new_n131_));
  ...
  nand3  g094(.a(new_n137_), .b(new_n44_), .c(new_n75_), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand4  g096(.a(new_n139_), .b(new_n51_), .c(x09), .d(new_n65_), .O(new_n140_));
  inv1   g097(.a(new_n140_), .O(z12));
  inv1   g098(.a(new_n57_), .O(new_n142_));
  ...
  nand2  g103(.a(new_n146_), .b(new_n52_), .O(z14));
  ...
  aoi21  g107(.a(new_n150_), .b(new_n149_), .c(new_n66_), .O(z15));
  nor3   g108(.a(new_n66_), .b(new_n44_), .c(x00), .O(z16));
  nand2  g109(.a(new_n93_), .b(new_n52_), .O(z17));
endmodule
