...
module FAU ( 
  ...
  nor2   g020(.a(x20), .b(x13), .O(new_n64_));
  ...
  nor2   g033(.a(new_n76_), .b(new_n60_), .O(z04));
  nand2  g034(.a(x01), .b(x00), .O(new_n78_));
  nand3  g035(.a(x10), .b(x09), .c(x02), .O(new_n79_));
  oai21  g036(.a(new_n79_), .b(new_n78_), .c(new_n53_), .O(z05));
  nor3   g037(.a(new_n64_), .b(new_n72_), .c(new_n47_), .O(new_n81_));
  ...
  nand4  g048(.a(new_n91_), .b(new_n89_), .c(new_n88_), .d(new_n60_), .O(new_n92_));
  ...
  nand3  g054(.a(new_n89_), .b(x12), .c(new_n72_), .O(new_n98_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n60_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n53_), .O(z09));
  nand3  g064(.a(x18), .b(x13), .c(x01), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n103_), .c(x22), .d(x21), .O(new_n110_));
  nand3  g067(.a(new_n51_), .b(x12), .c(new_n72_), .O(new_n111_));
  ...
  nand4  g072(.a(new_n115_), .b(new_n113_), .c(new_n112_), .d(new_n89_), .O(new_n116_));
  aoi21  g073(.a(new_n116_), .b(new_n110_), .c(x00), .O(z10));
  nand2  g074(.a(x18), .b(x01), .O(new_n118_));
  nand3  g075(.a(x21), .b(new_n52_), .c(new_n50_), .O(new_n119_));
  nand4  g076(.a(new_n101_), .b(new_n96_), .c(new_n100_), .d(x15), .O(new_n120_));
  oai22  g077(.a(new_n120_), .b(new_n98_), .c(new_n119_), .d(new_n118_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n97_), .c(new_n60_), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n53_), .O(z11));
  ...
  nand3  g086(.a(new_n129_), .b(new_n44_), .c(new_n60_), .O(new_n130_));
  ...
  nand2  g090(.a(new_n44_), .b(new_n60_), .O(new_n134_));
  ...
  aoi21  g098(.a(new_n141_), .b(new_n140_), .c(new_n64_), .O(z15));
  oai21  g099(.a(new_n44_), .b(x00), .c(new_n53_), .O(z16));
