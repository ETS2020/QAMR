...
module FAU ( 
  ...
  nor3   g28(.a(new_n71_), .b(new_n52_), .c(new_n46_), .O(z05));
  ...
  nand2  g52(.a(new_n95_), .b(new_n55_), .O(new_n96_));
  nor3   g53(.a(new_n54_), .b(new_n55_), .c(x00), .O(new_n97_));
  ...
  nand3  g74(.a(new_n117_), .b(new_n55_), .c(new_n44_), .O(new_n118_));
