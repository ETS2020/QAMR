...
module FAU ( 
  ...
  nand2  g26(.a(x13), .b(new_n49_), .O(new_n70_));
  inv1   g27(.a(x11), .O(new_n71_));
  inv1   g28(.a(x12), .O(new_n72_));
  nand4  g29(.a(new_n72_), .b(new_n71_), .c(x10), .d(new_n51_), .O(new_n73_));
  oai21  g30(.a(new_n73_), .b(new_n67_), .c(new_n70_), .O(z04));
  nand4  g31(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n75_));
  nor2   g32(.a(new_n75_), .b(new_n47_), .O(z05));
  nor4   g33(.a(new_n67_), .b(new_n71_), .c(new_n47_), .d(x09), .O(z06));
  nand2  g34(.a(new_n51_), .b(x01), .O(new_n78_));
  nand3  g35(.a(new_n72_), .b(x11), .c(x10), .O(new_n79_));
  oai22  g36(.a(new_n79_), .b(new_n78_), .c(x13), .d(x01), .O(new_n80_));
  ...
  nor2   g45(.a(new_n60_), .b(x18), .O(new_n89_));
  ...
  nand4  g50(.a(x12), .b(new_n71_), .c(x02), .d(new_n49_), .O(new_n94_));
  ...
  nand3  g66(.a(new_n109_), .b(x12), .c(new_n71_), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g68(.a(x16), .b(x15), .O(new_n112_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(x20), .O(new_n113_));
  nor2   g70(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n111_), .c(new_n107_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(x00), .c(new_n70_), .O(z10));
  nand4  g73(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n60_), .O(new_n117_));
  nor2   g74(.a(new_n95_), .b(x14), .O(new_n118_));
  nor2   g75(.a(x21), .b(new_n99_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n118_), .c(new_n96_), .O(new_n120_));
  oai21  g77(.a(new_n120_), .b(new_n94_), .c(new_n117_), .O(new_n121_));
  nand3  g78(.a(new_n121_), .b(new_n93_), .c(new_n48_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n70_), .O(z11));
