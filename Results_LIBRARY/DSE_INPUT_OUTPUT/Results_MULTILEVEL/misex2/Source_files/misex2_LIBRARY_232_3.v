...
module FAU ( 
  ...
  aoi21  g28(.a(new_n60_), .b(new_n57_), .c(new_n56_), .O(z07));
  inv1   g29(.a(x08), .O(new_n74_));
  inv1   g30(.a(x05), .O(new_n75_));
  inv1   g31(.a(x06), .O(new_n76_));
  inv1   g32(.a(x03), .O(new_n77_));
  nand4  g33(.a(new_n77_), .b(x02), .c(new_n57_), .d(new_n56_), .O(new_n78_));
  ...
  nor2   g42(.a(new_n60_), .b(x01), .O(new_n87_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n85_), .c(new_n84_), .d(new_n56_), .O(new_n96_));
  inv1   g52(.a(new_n96_), .O(z09));
  nor2   g53(.a(new_n85_), .b(new_n84_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n69_), .c(new_n93_), .d(x01), .O(new_n99_));
  ...
  oai21  g64(.a(new_n108_), .b(new_n68_), .c(new_n56_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(x01), .O(new_n110_));
  nor4   g66(.a(new_n104_), .b(x16), .c(new_n89_), .d(x14), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n102_), .c(new_n87_), .d(new_n56_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n110_), .O(z11));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g70(.a(new_n64_), .b(x17), .c(new_n60_), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n114_), .c(x24), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(x09), .c(new_n57_), .d(new_n56_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n59_), .O(z12));
  nand2  g74(.a(new_n47_), .b(x17), .O(new_n119_));
  nor2   g75(.a(new_n119_), .b(x19), .O(z13));
  nand4  g76(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n63_), .O(new_n121_));
  nor2   g77(.a(new_n121_), .b(x19), .O(z14));
  nor2   g78(.a(x19), .b(x00), .O(new_n123_));
  nor3   g79(.a(new_n123_), .b(x02), .c(x01), .O(z15));
  nand2  g80(.a(new_n61_), .b(x02), .O(new_n125_));
  inv1   g81(.a(new_n125_), .O(z17));
  zero   g82(.O(z04));
  nor2   g83(.a(new_n57_), .b(new_n56_), .O(z06));
  buf    g84(.a(x01), .O(z16));
endmodule
