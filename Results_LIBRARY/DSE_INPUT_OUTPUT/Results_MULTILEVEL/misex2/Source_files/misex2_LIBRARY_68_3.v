...
module FAU ( 
  ...
  nand4  g17(.a(new_n47_), .b(x18), .c(new_n49_), .d(new_n45_), .O(new_n61_));
  ...
  nor2   g24(.a(new_n45_), .b(x01), .O(new_n69_));
  ...
  nand4  g61(.a(new_n105_), .b(x21), .c(new_n81_), .d(new_n51_), .O(new_n106_));
  ...
  nand3  g70(.a(new_n51_), .b(x17), .c(new_n45_), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n114_), .c(x24), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(x09), .c(new_n65_), .O(new_n117_));
  nor2   g73(.a(new_n117_), .b(x00), .O(z12));
  inv1   g74(.a(new_n47_), .O(new_n119_));
  oai21  g75(.a(new_n115_), .b(new_n119_), .c(new_n44_), .O(z13));
  nand3  g76(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(new_n121_));
  inv1   g77(.a(new_n121_), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n50_), .c(new_n49_), .d(new_n58_), .O(new_n123_));
  nor2   g79(.a(new_n123_), .b(x19), .O(z14));
  nor2   g80(.a(x19), .b(x00), .O(new_n125_));
  nor3   g81(.a(new_n125_), .b(x02), .c(x01), .O(z15));
  nor2   g82(.a(new_n65_), .b(x00), .O(z16));
  nand2  g83(.a(new_n47_), .b(x02), .O(new_n128_));
