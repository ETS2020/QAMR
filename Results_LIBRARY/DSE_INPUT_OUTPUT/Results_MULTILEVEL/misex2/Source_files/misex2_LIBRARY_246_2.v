...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n136_, new_n139_, new_n140_, new_n142_, new_n144_;
  ...
  nor2   g020(.a(new_n61_), .b(new_n60_), .O(new_n64_));
  nand3  g021(.a(new_n64_), .b(x07), .c(x02), .O(new_n65_));
  ...
  aoi21  g027(.a(new_n70_), .b(x07), .c(new_n61_), .O(z04));
  nand4  g028(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(x07), .c(new_n61_), .O(z05));
  nand3  g030(.a(new_n64_), .b(x07), .c(x02), .O(new_n74_));
  inv1   g031(.a(new_n74_), .O(new_n75_));
  nand4  g032(.a(new_n75_), .b(x11), .c(x10), .d(new_n47_), .O(new_n76_));
  inv1   g033(.a(new_n76_), .O(z06));
  nand2  g034(.a(new_n47_), .b(x07), .O(new_n78_));
  ...
  nand4  g059(.a(new_n102_), .b(new_n93_), .c(new_n92_), .d(new_n60_), .O(new_n103_));
  nand2  g060(.a(new_n103_), .b(new_n45_), .O(z09));
  nand3  g061(.a(x18), .b(x07), .c(x01), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n100_), .c(x22), .d(x21), .O(new_n107_));
  nor2   g064(.a(new_n46_), .b(x01), .O(new_n108_));
  nor2   g065(.a(x13), .b(new_n79_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n94_), .O(new_n110_));
  ...
  nand4  g071(.a(new_n114_), .b(new_n112_), .c(new_n111_), .d(new_n108_), .O(new_n115_));
  aoi21  g072(.a(new_n115_), .b(new_n107_), .c(x00), .O(z10));
  nand3  g073(.a(new_n109_), .b(new_n108_), .c(new_n94_), .O(new_n117_));
  inv1   g074(.a(x20), .O(new_n118_));
  nand4  g075(.a(new_n106_), .b(x21), .c(new_n118_), .d(new_n52_), .O(new_n119_));
  nor2   g076(.a(new_n96_), .b(x14), .O(new_n120_));
  nor2   g077(.a(x21), .b(new_n118_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n120_), .c(new_n97_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n117_), .c(new_n119_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n93_), .c(new_n60_), .O(new_n124_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n61_), .c(new_n60_), .O(new_n132_));
  ...
  aoi22  g095(.a(new_n45_), .b(x00), .c(x19), .d(new_n61_), .O(new_n139_));
  nand3  g096(.a(new_n64_), .b(new_n57_), .c(x07), .O(new_n140_));
  oai21  g097(.a(new_n139_), .b(x02), .c(new_n140_), .O(z15));
  nand3  g098(.a(x07), .b(x01), .c(new_n60_), .O(new_n142_));
