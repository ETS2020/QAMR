...
module FAU ( 
  ...
  nand2  g013(.a(x18), .b(x05), .O(new_n57_));
  ...
  inv1   g019(.a(new_n48_), .O(new_n63_));
  nor4   g020(.a(new_n63_), .b(x19), .c(x17), .d(x02), .O(new_n64_));
  oai21  g021(.a(new_n64_), .b(x05), .c(x18), .O(new_n65_));
  nand3  g022(.a(x02), .b(x01), .c(x00), .O(new_n66_));
  nor2   g023(.a(new_n59_), .b(x09), .O(new_n67_));
  ...
  oai21  g029(.a(new_n72_), .b(new_n66_), .c(new_n57_), .O(z04));
  nand2  g030(.a(x01), .b(x00), .O(new_n74_));
  nand3  g031(.a(x10), .b(x09), .c(x02), .O(new_n75_));
  oai21  g032(.a(new_n75_), .b(new_n74_), .c(new_n57_), .O(z05));
  nand4  g033(.a(new_n57_), .b(x11), .c(x10), .d(new_n47_), .O(new_n77_));
  inv1   g034(.a(new_n77_), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x02), .c(x01), .d(x00), .O(new_n79_));
  inv1   g036(.a(new_n79_), .O(z06));
  nand3  g037(.a(new_n67_), .b(new_n71_), .c(x11), .O(new_n81_));
  ...
  nand3  g044(.a(new_n48_), .b(new_n87_), .c(x02), .O(new_n88_));
  inv1   g045(.a(new_n88_), .O(new_n89_));
  nand3  g046(.a(new_n89_), .b(new_n86_), .c(x04), .O(new_n90_));
  nor3   g047(.a(new_n90_), .b(x07), .c(x06), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(new_n45_), .c(x17), .d(new_n85_), .O(new_n92_));
  nor2   g049(.a(new_n92_), .b(new_n60_), .O(z08));
  ...
  nand4  g055(.a(new_n57_), .b(x20), .c(new_n98_), .d(new_n97_), .O(new_n99_));
  ...
  nand4  g059(.a(new_n102_), .b(x18), .c(new_n86_), .d(x01), .O(new_n103_));
  oai21  g060(.a(new_n101_), .b(x01), .c(new_n103_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n96_), .c(new_n95_), .d(new_n94_), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(z09));
  inv1   g063(.a(x01), .O(new_n107_));
  inv1   g064(.a(x13), .O(new_n108_));
  inv1   g065(.a(x14), .O(new_n109_));
  nand4  g066(.a(new_n57_), .b(new_n96_), .c(new_n95_), .d(x20), .O(new_n110_));
  nor2   g067(.a(new_n110_), .b(new_n98_), .O(new_n111_));
  nand4  g068(.a(new_n111_), .b(x15), .c(new_n109_), .d(new_n108_), .O(new_n112_));
  nor2   g069(.a(new_n112_), .b(new_n71_), .O(new_n113_));
  nand4  g070(.a(new_n113_), .b(new_n70_), .c(x02), .d(new_n107_), .O(new_n114_));
  nor2   g071(.a(new_n45_), .b(x05), .O(new_n115_));
  nor2   g072(.a(new_n96_), .b(new_n95_), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(new_n115_), .c(new_n102_), .d(x01), .O(new_n117_));
  aoi21  g074(.a(new_n117_), .b(new_n114_), .c(x00), .O(z10));
  nor2   g075(.a(new_n95_), .b(x20), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(new_n60_), .c(x18), .d(x01), .O(new_n120_));
  nor2   g077(.a(new_n46_), .b(x01), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n108_), .c(x12), .d(new_n70_), .O(new_n122_));
  nor2   g079(.a(new_n97_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n95_), .c(x20), .d(new_n98_), .O(new_n124_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n107_), .c(new_n94_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand4  g092(.a(new_n135_), .b(new_n57_), .c(new_n128_), .d(x09), .O(new_n136_));
  inv1   g093(.a(new_n136_), .O(z12));
  oai21  g094(.a(new_n132_), .b(new_n63_), .c(new_n57_), .O(z13));
  nand4  g095(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x19), .O(z14));
  oai21  g097(.a(x10), .b(new_n107_), .c(x02), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(x00), .O(new_n142_));
  nand3  g099(.a(x19), .b(new_n46_), .c(new_n107_), .O(new_n143_));
  nand3  g100(.a(new_n143_), .b(new_n142_), .c(new_n57_), .O(z15));
  oai21  g101(.a(new_n107_), .b(x00), .c(new_n57_), .O(z16));
  nand2  g102(.a(new_n121_), .b(new_n94_), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(new_n57_), .O(z17));
endmodule
