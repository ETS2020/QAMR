...
module FAU ( 
  ...
  nor2   g23(.a(new_n55_), .b(new_n44_), .O(new_n67_));
  ...
  nor4   g30(.a(new_n73_), .b(new_n72_), .c(new_n52_), .d(x09), .O(z06));
  nor3   g31(.a(new_n68_), .b(x12), .c(new_n72_), .O(z07));
  ...
  nand4  g43(.a(x12), .b(new_n72_), .c(x02), .d(new_n55_), .O(new_n87_));
  ...
  nand4  g51(.a(new_n94_), .b(new_n86_), .c(new_n85_), .d(new_n44_), .O(new_n95_));
  inv1   g52(.a(new_n95_), .O(z09));
  nand4  g53(.a(new_n90_), .b(x12), .c(new_n72_), .d(x02), .O(new_n97_));
  nor2   g54(.a(x22), .b(x21), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(x20), .c(x16), .d(x15), .O(new_n99_));
  oai21  g56(.a(new_n99_), .b(new_n97_), .c(new_n44_), .O(new_n100_));
  nand2  g57(.a(new_n100_), .b(new_n55_), .O(new_n101_));
  nor3   g58(.a(new_n54_), .b(new_n55_), .c(x00), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n92_), .c(x22), .d(x21), .O(new_n103_));
  nand2  g60(.a(new_n103_), .b(new_n101_), .O(z10));
  nand4  g61(.a(new_n98_), .b(x20), .c(new_n89_), .d(x15), .O(new_n105_));
  oai21  g62(.a(new_n105_), .b(new_n97_), .c(new_n44_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n55_), .O(new_n107_));
  nand4  g64(.a(new_n102_), .b(new_n92_), .c(new_n86_), .d(x21), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(new_n107_), .O(z11));
  inv1   g66(.a(x24), .O(new_n110_));
  aoi21  g67(.a(x10), .b(x02), .c(new_n44_), .O(new_n111_));
  oai21  g68(.a(x19), .b(x02), .c(x23), .O(new_n112_));
  nand3  g69(.a(new_n63_), .b(x17), .c(new_n45_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n112_), .c(x01), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n111_), .c(new_n110_), .O(new_n115_));
  nand2  g72(.a(new_n55_), .b(x00), .O(new_n116_));
  oai21  g73(.a(new_n115_), .b(new_n46_), .c(new_n116_), .O(z12));
  aoi21  g74(.a(new_n113_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g75(.a(new_n46_), .b(new_n45_), .c(new_n55_), .d(new_n44_), .O(new_n119_));
  inv1   g76(.a(new_n119_), .O(new_n120_));
  nand4  g77(.a(new_n120_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n121_));
  nor2   g78(.a(new_n121_), .b(x19), .O(z14));
  nand2  g79(.a(x19), .b(new_n45_), .O(new_n123_));
  aoi21  g80(.a(new_n123_), .b(new_n44_), .c(x01), .O(new_n124_));
  or2    g81(.a(new_n124_), .b(new_n111_), .O(z15));
  nor2   g82(.a(new_n55_), .b(x00), .O(z16));
  nand3  g83(.a(x02), .b(new_n55_), .c(new_n44_), .O(new_n127_));
