...
module FAU ( 
  ...
  nand4  g13(.a(new_n56_), .b(new_n45_), .c(new_n44_), .d(x13), .O(new_n57_));
  ...
  aoi21  g19(.a(new_n62_), .b(x13), .c(x01), .O(z02));
  nand3  g20(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n64_));
  nand4  g21(.a(new_n59_), .b(x18), .c(new_n44_), .d(x13), .O(new_n65_));
  ...
  nand2  g26(.a(new_n69_), .b(new_n48_), .O(new_n70_));
  ...
  nor2   g32(.a(new_n75_), .b(new_n46_), .O(z05));
  nor4   g33(.a(new_n66_), .b(new_n71_), .c(new_n46_), .d(x09), .O(z06));
  nand2  g34(.a(new_n50_), .b(x01), .O(new_n78_));
  nand3  g35(.a(new_n72_), .b(x11), .c(x10), .O(new_n79_));
  oai22  g36(.a(new_n79_), .b(new_n78_), .c(new_n69_), .d(x01), .O(new_n80_));
  ...
  nor2   g45(.a(new_n59_), .b(x18), .O(new_n89_));
  nand4  g46(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(x17), .O(new_n90_));
  aoi21  g47(.a(new_n90_), .b(x13), .c(x01), .O(z08));
  inv1   g48(.a(x20), .O(new_n92_));
  inv1   g49(.a(x21), .O(new_n93_));
  inv1   g50(.a(x22), .O(new_n94_));
  nor2   g51(.a(new_n48_), .b(x00), .O(z16));
  nand3  g52(.a(z16), .b(new_n59_), .c(x18), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n98_));
  inv1   g55(.a(new_n98_), .O(z09));
  nand3  g56(.a(x18), .b(x01), .c(new_n47_), .O(new_n100_));
  nand4  g57(.a(x22), .b(x21), .c(new_n92_), .d(new_n59_), .O(new_n101_));
  oai21  g58(.a(new_n101_), .b(new_n100_), .c(new_n70_), .O(z10));
  nand4  g59(.a(new_n94_), .b(x21), .c(new_n92_), .d(new_n59_), .O(new_n103_));
  oai21  g60(.a(new_n103_), .b(new_n100_), .c(new_n70_), .O(z11));
  ...
  nand3  g65(.a(new_n59_), .b(x17), .c(new_n49_), .O(new_n109_));
  ...
  nand2  g70(.a(new_n113_), .b(new_n70_), .O(z12));
  nand4  g71(.a(new_n59_), .b(x17), .c(new_n49_), .d(new_n47_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(x13), .c(x01), .O(z13));
  nand4  g73(.a(new_n61_), .b(new_n50_), .c(new_n49_), .d(new_n47_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(x13), .c(x01), .O(z14));
  aoi21  g75(.a(new_n46_), .b(x01), .c(new_n49_), .O(new_n119_));
  aoi21  g76(.a(x19), .b(new_n49_), .c(new_n69_), .O(new_n120_));
  oai22  g77(.a(new_n120_), .b(x01), .c(new_n119_), .d(new_n47_), .O(z15));
  aoi21  g78(.a(new_n83_), .b(x13), .c(x01), .O(z17));
endmodule
