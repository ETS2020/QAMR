...
module FAU ( 
  ...
  nor2   g007(.a(x23), .b(x06), .O(new_n51_));
  ...
  nor3   g036(.a(new_n51_), .b(new_n71_), .c(new_n47_), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(new_n46_), .c(x02), .d(x01), .O(new_n81_));
  nor2   g038(.a(new_n81_), .b(new_n70_), .O(z06));
  ...
  inv1   g043(.a(new_n57_), .O(new_n87_));
  ...
  aoi21  g050(.a(new_n93_), .b(x23), .c(x06), .O(z08));
  ...
  nand4  g063(.a(new_n106_), .b(new_n52_), .c(new_n96_), .d(new_n95_), .O(new_n107_));
  ...
  nand3  g088(.a(new_n50_), .b(x06), .c(new_n45_), .O(new_n132_));
  aoi21  g089(.a(new_n132_), .b(new_n131_), .c(new_n48_), .O(new_n133_));
  aoi21  g090(.a(new_n50_), .b(new_n45_), .c(new_n131_), .O(new_n134_));
  oai21  g091(.a(new_n134_), .b(new_n133_), .c(new_n44_), .O(new_n135_));
  ...
  oai21  g096(.a(new_n139_), .b(new_n87_), .c(new_n52_), .O(z13));
  ...
  nor4   g104(.a(new_n51_), .b(new_n45_), .c(x01), .d(x00), .O(z17));
endmodule
