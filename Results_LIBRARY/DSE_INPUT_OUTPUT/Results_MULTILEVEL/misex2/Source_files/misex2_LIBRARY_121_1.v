...
module FAU ( 
  ...
  nand4  g020(.a(new_n52_), .b(new_n50_), .c(x18), .d(new_n48_), .O(new_n64_));
  inv1   g021(.a(new_n64_), .O(new_n65_));
  nand4  g022(.a(new_n65_), .b(new_n45_), .c(new_n44_), .d(new_n63_), .O(new_n66_));
  ...
  nor3   g029(.a(new_n72_), .b(new_n47_), .c(x09), .O(new_n73_));
  nand3  g030(.a(new_n73_), .b(new_n71_), .c(new_n51_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x24), .O(z04));
  inv1   g032(.a(new_n52_), .O(new_n76_));
  nor2   g033(.a(new_n76_), .b(new_n47_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x09), .c(x02), .d(x01), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n63_), .O(z05));
  nand2  g036(.a(new_n73_), .b(x11), .O(new_n80_));
  inv1   g037(.a(new_n80_), .O(z06));
  nand3  g038(.a(new_n68_), .b(new_n71_), .c(x11), .O(new_n82_));
  ...
  nand4  g046(.a(new_n89_), .b(new_n87_), .c(new_n86_), .d(new_n63_), .O(new_n90_));
  ...
  nand3  g052(.a(new_n87_), .b(x12), .c(new_n51_), .O(new_n96_));
  ...
  nand3  g066(.a(new_n51_), .b(x02), .c(new_n44_), .O(new_n110_));
  nand2  g067(.a(new_n99_), .b(x12), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nor2   g069(.a(new_n101_), .b(new_n98_), .O(new_n113_));
  nor3   g070(.a(x24), .b(x22), .c(x21), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(x15), .O(new_n115_));
  aoi21  g072(.a(new_n115_), .b(new_n109_), .c(x00), .O(z10));
  nand4  g073(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n50_), .O(new_n117_));
  nor2   g074(.a(x13), .b(new_n71_), .O(new_n118_));
  nand3  g075(.a(new_n118_), .b(new_n87_), .c(new_n51_), .O(new_n119_));
  nor2   g076(.a(new_n97_), .b(x14), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n94_), .c(x20), .d(new_n98_), .O(new_n121_));
  oai21  g078(.a(new_n121_), .b(new_n119_), .c(new_n117_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n95_), .c(new_n63_), .O(new_n123_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n44_), .c(new_n63_), .O(new_n131_));
  ...
  nor2   g091(.a(new_n76_), .b(x19), .O(new_n135_));
  nand4  g092(.a(new_n135_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(x00), .O(z13));
  nand3  g094(.a(new_n59_), .b(new_n46_), .c(new_n45_), .O(new_n138_));
  oai21  g095(.a(new_n138_), .b(new_n61_), .c(new_n52_), .O(z14));
  ...
  aoi21  g099(.a(new_n142_), .b(new_n141_), .c(new_n76_), .O(z15));
  nor3   g100(.a(new_n76_), .b(new_n44_), .c(x00), .O(z16));
  nand4  g101(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n63_), .O(new_n145_));
