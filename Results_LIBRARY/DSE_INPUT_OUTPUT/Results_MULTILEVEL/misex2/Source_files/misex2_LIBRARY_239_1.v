...
module FAU ( 
  ...
  nand3  g67(.a(new_n110_), .b(new_n44_), .c(new_n52_), .O(new_n111_));
  ...
  nand4  g72(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n52_), .O(new_n116_));
  inv1   g73(.a(new_n116_), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n118_));
  nor2   g75(.a(new_n118_), .b(x19), .O(z14));
  aoi21  g76(.a(new_n57_), .b(x01), .c(new_n45_), .O(new_n120_));
  nand3  g77(.a(x19), .b(new_n45_), .c(new_n44_), .O(new_n121_));
  oai21  g78(.a(new_n120_), .b(new_n52_), .c(new_n121_), .O(z15));
  nor2   g79(.a(new_n44_), .b(x00), .O(z16));
  nand3  g80(.a(x02), .b(new_n44_), .c(new_n52_), .O(new_n124_));
