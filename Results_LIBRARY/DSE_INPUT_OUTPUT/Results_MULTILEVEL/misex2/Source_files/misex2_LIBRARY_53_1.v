...
module FAU ( 
  ...
  nand3  g012(.a(x09), .b(new_n50_), .c(new_n48_), .O(new_n56_));
  inv1   g013(.a(new_n56_), .O(new_n57_));
  nor2   g014(.a(x19), .b(x18), .O(new_n58_));
  nand4  g015(.a(new_n58_), .b(new_n57_), .c(new_n45_), .d(x10), .O(new_n59_));
  aoi21  g016(.a(new_n59_), .b(new_n44_), .c(x01), .O(z01));
  nand4  g017(.a(new_n58_), .b(new_n57_), .c(new_n45_), .d(new_n47_), .O(new_n61_));
  ...
  nand2  g023(.a(new_n66_), .b(new_n49_), .O(new_n67_));
  ...
  nand2  g028(.a(x14), .b(new_n49_), .O(new_n72_));
  inv1   g029(.a(x11), .O(new_n73_));
  inv1   g030(.a(x12), .O(new_n74_));
  nand3  g031(.a(new_n69_), .b(new_n74_), .c(new_n73_), .O(new_n75_));
  oai21  g032(.a(new_n75_), .b(new_n68_), .c(new_n72_), .O(z04));
  nand4  g033(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n47_), .O(z05));
  nor4   g035(.a(new_n68_), .b(new_n73_), .c(new_n47_), .d(x09), .O(z06));
  nand2  g036(.a(new_n51_), .b(x01), .O(new_n80_));
  nand3  g037(.a(new_n74_), .b(x11), .c(x10), .O(new_n81_));
  oai22  g038(.a(new_n81_), .b(new_n80_), .c(x14), .d(x01), .O(new_n82_));
  nand3  g039(.a(new_n82_), .b(x02), .c(x00), .O(new_n83_));
  inv1   g040(.a(new_n83_), .O(z07));
  nand2  g041(.a(x02), .b(new_n48_), .O(new_n85_));
  ...
  nand4  g052(.a(x12), .b(new_n73_), .c(x02), .d(new_n49_), .O(new_n96_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n95_), .c(new_n94_), .d(new_n48_), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(z09));
  nor3   g063(.a(new_n95_), .b(new_n94_), .c(x20), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n64_), .c(x18), .d(x01), .O(new_n108_));
  nor2   g065(.a(new_n50_), .b(x01), .O(new_n109_));
  nor2   g066(.a(x13), .b(new_n74_), .O(new_n110_));
  nand2  g067(.a(new_n110_), .b(new_n73_), .O(new_n111_));
  ...
  nand3  g074(.a(new_n110_), .b(new_n109_), .c(new_n73_), .O(new_n118_));
  nand4  g075(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n64_), .O(new_n119_));
  nor2   g076(.a(new_n97_), .b(x14), .O(new_n120_));
  nor2   g077(.a(x21), .b(new_n101_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n120_), .c(new_n98_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n118_), .c(new_n119_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n95_), .c(new_n48_), .O(new_n124_));
  ...
  nand3  g086(.a(new_n64_), .b(x17), .c(new_n50_), .O(new_n130_));
  ...
  nand2  g091(.a(new_n134_), .b(new_n72_), .O(z12));
  nand3  g092(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n136_));
  nor4   g093(.a(new_n136_), .b(x19), .c(new_n45_), .d(x14), .O(z13));
  ...
  aoi21  g097(.a(new_n47_), .b(x01), .c(new_n50_), .O(new_n141_));
  aoi21  g098(.a(x19), .b(new_n50_), .c(x14), .O(new_n142_));
  oai22  g099(.a(new_n142_), .b(x01), .c(new_n141_), .d(new_n48_), .O(z15));
  nor2   g100(.a(new_n49_), .b(x00), .O(z16));
  aoi21  g101(.a(new_n85_), .b(new_n44_), .c(x01), .O(z17));
endmodule
