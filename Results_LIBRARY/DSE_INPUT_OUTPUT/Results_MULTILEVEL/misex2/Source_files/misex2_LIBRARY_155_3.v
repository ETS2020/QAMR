...
module FAU ( 
  ...
  aoi21  g033(.a(new_n76_), .b(new_n63_), .c(new_n46_), .O(z05));
  nand3  g034(.a(x02), .b(x01), .c(x00), .O(new_n78_));
  inv1   g035(.a(new_n78_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(x10), .c(new_n48_), .d(new_n63_), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(new_n71_), .O(z06));
  nand4  g038(.a(new_n72_), .b(x11), .c(x10), .d(new_n48_), .O(new_n82_));
  ...
  nand4  g045(.a(new_n63_), .b(x02), .c(new_n46_), .d(new_n45_), .O(new_n89_));
  ...
  nand4  g049(.a(new_n92_), .b(new_n51_), .c(x17), .d(new_n86_), .O(new_n93_));
  nor2   g050(.a(new_n93_), .b(new_n52_), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nor2   g053(.a(new_n47_), .b(x01), .O(new_n97_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n45_), .O(new_n106_));
  ...
  nor2   g077(.a(new_n51_), .b(x03), .O(new_n121_));
  nor2   g078(.a(new_n95_), .b(x20), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n121_), .c(new_n52_), .d(x01), .O(new_n123_));
  nor2   g080(.a(new_n99_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n95_), .c(x20), .d(new_n100_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n114_), .c(new_n123_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n96_), .c(new_n45_), .O(new_n127_));
  ...
  nand3  g088(.a(new_n52_), .b(x17), .c(new_n47_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n46_), .c(new_n45_), .O(new_n134_));
  ...
  nand2  g094(.a(new_n55_), .b(x17), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x19), .O(z13));
  nand2  g096(.a(new_n55_), .b(new_n48_), .O(new_n140_));
  ...
  aoi21  g104(.a(new_n63_), .b(x00), .c(new_n46_), .O(z16));
  nand2  g105(.a(new_n97_), .b(new_n45_), .O(new_n149_));
