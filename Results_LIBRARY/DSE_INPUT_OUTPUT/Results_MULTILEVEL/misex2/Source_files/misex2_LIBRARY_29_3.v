...
module FAU ( 
  ...
  inv1   g026(.a(x10), .O(new_n70_));
  nor2   g027(.a(new_n70_), .b(x09), .O(new_n71_));
  nand3  g028(.a(new_n71_), .b(x12), .c(x11), .O(new_n72_));
  oai21  g029(.a(new_n72_), .b(new_n69_), .c(new_n68_), .O(z03));
  inv1   g030(.a(x11), .O(new_n74_));
  nand3  g031(.a(new_n71_), .b(new_n55_), .c(new_n74_), .O(new_n75_));
  oai21  g032(.a(new_n75_), .b(new_n69_), .c(new_n63_), .O(z04));
  nand4  g033(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n77_));
  nor3   g034(.a(new_n77_), .b(x12), .c(new_n70_), .O(z05));
  nand3  g035(.a(x11), .b(x10), .c(new_n54_), .O(new_n79_));
  oai21  g036(.a(new_n79_), .b(new_n69_), .c(new_n63_), .O(z06));
  nand3  g037(.a(new_n71_), .b(new_n55_), .c(x11), .O(new_n81_));
  ...
  nor2   g055(.a(new_n64_), .b(x20), .O(new_n99_));
  nand4  g056(.a(new_n99_), .b(new_n98_), .c(x18), .d(x01), .O(new_n100_));
  nand2  g057(.a(x02), .b(new_n47_), .O(new_n101_));
  inv1   g058(.a(new_n101_), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(x12), .c(new_n74_), .d(new_n54_), .O(new_n103_));
  ...
  nand3  g067(.a(new_n98_), .b(x18), .c(x01), .O(new_n111_));
  nor4   g068(.a(new_n111_), .b(new_n97_), .c(new_n96_), .d(x20), .O(new_n112_));
  nor4   g069(.a(new_n101_), .b(x13), .c(new_n55_), .d(x11), .O(new_n113_));
  nand3  g070(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n114_));
  nor4   g071(.a(new_n114_), .b(new_n105_), .c(new_n104_), .d(x14), .O(new_n115_));
  aoi21  g072(.a(new_n115_), .b(new_n113_), .c(new_n112_), .O(new_n116_));
  oai21  g073(.a(new_n116_), .b(x00), .c(new_n63_), .O(z10));
  inv1   g074(.a(x20), .O(new_n118_));
  nand4  g075(.a(new_n63_), .b(x21), .c(new_n118_), .d(new_n98_), .O(new_n119_));
  inv1   g076(.a(new_n119_), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(x18), .c(x01), .O(new_n121_));
  inv1   g078(.a(x13), .O(new_n122_));
  nor2   g079(.a(new_n104_), .b(x14), .O(new_n123_));
  nor2   g080(.a(x21), .b(new_n118_), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n123_), .c(new_n105_), .d(new_n122_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n103_), .c(new_n121_), .O(new_n126_));
  ...
  nand3  g088(.a(new_n98_), .b(x17), .c(new_n48_), .O(new_n132_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n55_), .c(x09), .O(new_n136_));
  inv1   g093(.a(new_n136_), .O(z12));
  nand4  g094(.a(new_n65_), .b(x17), .c(new_n48_), .d(new_n47_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x00), .O(z13));
  nand4  g096(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n70_), .O(new_n140_));
  ...
  nand3  g102(.a(new_n63_), .b(x01), .c(new_n46_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  oai21  g104(.a(new_n101_), .b(x00), .c(new_n63_), .O(z17));
endmodule
