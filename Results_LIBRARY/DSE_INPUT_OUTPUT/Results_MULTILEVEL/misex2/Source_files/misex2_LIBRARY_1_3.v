...
module FAU ( 
  ...
  nand2  g009(.a(x13), .b(x01), .O(new_n53_));
  ...
  nor2   g021(.a(new_n62_), .b(new_n61_), .O(new_n65_));
  nor2   g022(.a(x09), .b(new_n46_), .O(new_n66_));
  nand2  g023(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  inv1   g024(.a(x12), .O(new_n68_));
  nor2   g025(.a(x13), .b(new_n68_), .O(new_n69_));
  nand3  g026(.a(new_n69_), .b(x11), .c(x10), .O(new_n70_));
  oai22  g027(.a(new_n70_), .b(new_n67_), .c(new_n64_), .d(new_n63_), .O(z03));
  inv1   g028(.a(x13), .O(new_n72_));
  nor2   g029(.a(x12), .b(x11), .O(new_n73_));
  nand4  g030(.a(new_n73_), .b(new_n66_), .c(x10), .d(x00), .O(new_n74_));
  aoi21  g031(.a(new_n74_), .b(new_n72_), .c(new_n62_), .O(z04));
  nand2  g032(.a(new_n65_), .b(x02), .O(new_n76_));
  nor4   g033(.a(new_n76_), .b(x13), .c(new_n58_), .d(new_n47_), .O(z05));
  inv1   g034(.a(new_n76_), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x11), .c(x10), .d(new_n47_), .O(new_n79_));
  nor2   g036(.a(new_n79_), .b(x13), .O(z06));
  nand2  g037(.a(x10), .b(new_n47_), .O(new_n81_));
  nand3  g038(.a(new_n72_), .b(new_n68_), .c(x11), .O(new_n82_));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n62_), .d(new_n61_), .O(new_n90_));
  ...
  nand4  g050(.a(new_n93_), .b(new_n45_), .c(x17), .d(new_n86_), .O(new_n94_));
  nor2   g051(.a(new_n94_), .b(new_n55_), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  inv1   g054(.a(x11), .O(new_n98_));
  nor2   g055(.a(new_n46_), .b(x01), .O(new_n99_));
  nand3  g056(.a(new_n99_), .b(x12), .c(new_n98_), .O(new_n100_));
  ...
  nor2   g062(.a(new_n45_), .b(new_n62_), .O(new_n106_));
  nand3  g063(.a(new_n106_), .b(new_n105_), .c(new_n55_), .O(new_n107_));
  oai21  g064(.a(new_n104_), .b(new_n100_), .c(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n97_), .c(new_n96_), .d(new_n61_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n53_), .O(z09));
  nand3  g067(.a(new_n55_), .b(x18), .c(x01), .O(new_n111_));
  nand3  g068(.a(x22), .b(x21), .c(new_n105_), .O(new_n112_));
  nor2   g069(.a(x14), .b(new_n68_), .O(new_n113_));
  nand3  g070(.a(new_n113_), .b(new_n99_), .c(new_n98_), .O(new_n114_));
  nor2   g071(.a(x22), .b(x21), .O(new_n115_));
  nand4  g072(.a(new_n115_), .b(x20), .c(x16), .d(x15), .O(new_n116_));
  oai22  g073(.a(new_n116_), .b(new_n114_), .c(new_n112_), .d(new_n111_), .O(new_n117_));
  nand3  g074(.a(new_n117_), .b(new_n72_), .c(new_n61_), .O(new_n118_));
  inv1   g075(.a(new_n118_), .O(z10));
  nand4  g076(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n55_), .O(new_n120_));
  nand3  g077(.a(new_n99_), .b(new_n69_), .c(new_n98_), .O(new_n121_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n97_), .c(new_n61_), .O(new_n125_));
  nand2  g082(.a(new_n125_), .b(new_n53_), .O(z11));
  nand2  g083(.a(x10), .b(x02), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(new_n72_), .c(x01), .d(x00), .O(new_n128_));
  oai21  g085(.a(x19), .b(x02), .c(x23), .O(new_n129_));
  nand3  g086(.a(new_n55_), .b(x17), .c(new_n46_), .O(new_n130_));
  ...
  oai21  g093(.a(new_n130_), .b(new_n136_), .c(new_n53_), .O(z13));
  nand4  g094(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x19), .O(z14));
  aoi22  g096(.a(new_n53_), .b(x00), .c(x19), .d(new_n62_), .O(new_n140_));
  nand3  g097(.a(new_n65_), .b(new_n72_), .c(new_n58_), .O(new_n141_));
  oai21  g098(.a(new_n140_), .b(x02), .c(new_n141_), .O(z15));
  nand3  g099(.a(new_n72_), .b(x01), .c(new_n61_), .O(new_n143_));
