...
module FAU ( 
  ...
  aoi21  g033(.a(new_n76_), .b(new_n61_), .c(new_n70_), .O(z05));
  nand3  g034(.a(x02), .b(x01), .c(x00), .O(new_n78_));
  inv1   g035(.a(new_n78_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(x10), .c(new_n46_), .d(new_n61_), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(new_n71_), .O(z06));
  nand2  g038(.a(new_n46_), .b(new_n61_), .O(new_n82_));
  ...
  nand4  g050(.a(new_n93_), .b(x19), .c(new_n53_), .d(x17), .O(new_n94_));
  ...
  nor2   g064(.a(new_n53_), .b(x07), .O(new_n108_));
  ...
  nand4  g075(.a(new_n89_), .b(new_n111_), .c(x12), .d(new_n71_), .O(new_n119_));
  nor2   g076(.a(new_n96_), .b(x20), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n108_), .c(new_n66_), .d(x01), .O(new_n121_));
  ...
  nand3  g087(.a(new_n66_), .b(x17), .c(new_n45_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n70_), .c(new_n87_), .O(new_n133_));
  ...
  nand3  g095(.a(new_n50_), .b(new_n49_), .c(new_n58_), .O(new_n139_));
  oai21  g096(.a(new_n139_), .b(new_n48_), .c(new_n44_), .O(z14));
  aoi22  g097(.a(new_n44_), .b(x00), .c(x19), .d(new_n70_), .O(new_n141_));
  nand4  g098(.a(new_n58_), .b(new_n61_), .c(x01), .d(x00), .O(new_n142_));
  oai21  g099(.a(new_n141_), .b(x02), .c(new_n142_), .O(z15));
  nand3  g100(.a(new_n61_), .b(x01), .c(new_n87_), .O(new_n144_));
