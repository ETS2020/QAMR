...
module FAU ( 
  ...
  nand3  g017(.a(new_n49_), .b(x02), .c(x00), .O(new_n61_));
  nand3  g018(.a(x12), .b(x11), .c(x10), .O(new_n62_));
  oai21  g019(.a(new_n62_), .b(new_n61_), .c(x14), .O(new_n63_));
  ...
  aoi21  g029(.a(new_n72_), .b(x14), .c(new_n47_), .O(z04));
  nand4  g030(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n74_));
  aoi21  g031(.a(new_n74_), .b(x14), .c(new_n47_), .O(z05));
  inv1   g032(.a(x14), .O(new_n76_));
  ...
  nand2  g037(.a(x10), .b(new_n49_), .O(new_n81_));
  nand3  g038(.a(x14), .b(new_n70_), .c(x11), .O(new_n82_));
  oai21  g039(.a(new_n82_), .b(new_n81_), .c(x01), .O(new_n83_));
  nand3  g040(.a(new_n83_), .b(x02), .c(x00), .O(new_n84_));
  inv1   g041(.a(new_n84_), .O(z07));
  nand2  g042(.a(new_n76_), .b(x01), .O(new_n86_));
  ...
  nand2  g052(.a(new_n95_), .b(new_n86_), .O(z08));
  inv1   g053(.a(x21), .O(new_n97_));
  inv1   g054(.a(x22), .O(new_n98_));
  nand4  g055(.a(x12), .b(new_n69_), .c(x02), .d(new_n47_), .O(new_n99_));
  ...
  nand4  g061(.a(new_n104_), .b(x18), .c(x14), .d(x01), .O(new_n105_));
  ...
  nand2  g069(.a(new_n69_), .b(x02), .O(new_n113_));
  nand2  g070(.a(new_n102_), .b(x12), .O(new_n114_));
  ...
  oai21  g076(.a(new_n119_), .b(x00), .c(new_n86_), .O(z10));
  nand3  g077(.a(x18), .b(x14), .c(x01), .O(new_n121_));
  inv1   g078(.a(new_n121_), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(x21), .c(new_n110_), .d(new_n65_), .O(new_n123_));
  nor2   g080(.a(x13), .b(new_n70_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n87_), .c(new_n69_), .O(new_n125_));
  nor2   g082(.a(new_n100_), .b(x14), .O(new_n126_));
  nor2   g083(.a(x21), .b(new_n110_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n126_), .c(new_n101_), .O(new_n128_));
  oai21  g085(.a(new_n128_), .b(new_n125_), .c(new_n123_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(new_n98_), .c(new_n46_), .O(new_n130_));
  inv1   g087(.a(new_n130_), .O(z11));
  inv1   g088(.a(x24), .O(new_n132_));
  nand2  g089(.a(x10), .b(x02), .O(new_n133_));
  nand4  g090(.a(new_n133_), .b(x14), .c(x01), .d(x00), .O(new_n134_));
  oai21  g091(.a(x19), .b(x02), .c(x23), .O(new_n135_));
  nand3  g092(.a(new_n65_), .b(x17), .c(new_n48_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand3  g094(.a(new_n137_), .b(new_n47_), .c(new_n46_), .O(new_n138_));
  ...
  nand2  g098(.a(new_n47_), .b(new_n46_), .O(new_n142_));
  oai21  g099(.a(new_n136_), .b(new_n142_), .c(new_n86_), .O(z13));
  nand4  g100(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n144_));
  ...
  nand3  g105(.a(new_n148_), .b(new_n147_), .c(new_n86_), .O(z15));
  nand3  g106(.a(x14), .b(x01), .c(new_n46_), .O(new_n150_));
  inv1   g107(.a(new_n150_), .O(z16));
  nand2  g108(.a(new_n88_), .b(new_n86_), .O(z17));
endmodule
