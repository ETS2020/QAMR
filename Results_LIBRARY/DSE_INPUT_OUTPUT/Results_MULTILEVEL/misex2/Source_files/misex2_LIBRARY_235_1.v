...
module FAU ( 
  ...
  aoi21  g016(.a(new_n59_), .b(new_n56_), .c(x17), .O(z01));
  nand4  g017(.a(new_n58_), .b(new_n57_), .c(new_n47_), .d(x09), .O(new_n61_));
  aoi21  g018(.a(new_n61_), .b(new_n56_), .c(x17), .O(z02));
  nand2  g019(.a(x21), .b(new_n44_), .O(new_n63_));
  ...
  nor2   g023(.a(x21), .b(x19), .O(new_n67_));
  ...
  nand4  g029(.a(new_n72_), .b(new_n71_), .c(x10), .d(new_n51_), .O(new_n73_));
  oai21  g030(.a(new_n73_), .b(new_n70_), .c(new_n63_), .O(z04));
  inv1   g031(.a(new_n63_), .O(new_n75_));
  nor2   g032(.a(new_n75_), .b(new_n47_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(x09), .c(x02), .d(x01), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n48_), .O(z05));
  nand3  g035(.a(x11), .b(x10), .c(new_n51_), .O(new_n79_));
  oai21  g036(.a(new_n79_), .b(new_n70_), .c(new_n63_), .O(z06));
  nand4  g037(.a(new_n72_), .b(x11), .c(x10), .d(new_n51_), .O(new_n81_));
  nand2  g038(.a(new_n81_), .b(x01), .O(new_n82_));
  nand3  g039(.a(new_n82_), .b(x02), .c(x00), .O(new_n83_));
  nand2  g040(.a(new_n83_), .b(new_n63_), .O(z07));
  inv1   g041(.a(x03), .O(new_n85_));
  nor2   g042(.a(new_n50_), .b(x01), .O(new_n86_));
  inv1   g043(.a(x04), .O(new_n87_));
  nor2   g044(.a(x05), .b(new_n87_), .O(new_n88_));
  nand4  g045(.a(new_n88_), .b(new_n86_), .c(new_n85_), .d(new_n48_), .O(new_n89_));
  nor3   g046(.a(x08), .b(x07), .c(x06), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(x19), .c(new_n45_), .d(x17), .O(new_n91_));
  oai21  g048(.a(new_n91_), .b(new_n89_), .c(new_n63_), .O(z08));
  inv1   g049(.a(x22), .O(new_n93_));
  nand3  g050(.a(new_n86_), .b(x12), .c(new_n71_), .O(new_n94_));
  ...
  nor2   g055(.a(new_n45_), .b(new_n49_), .O(new_n99_));
  ...
  nand4  g059(.a(new_n102_), .b(new_n93_), .c(new_n56_), .d(new_n48_), .O(new_n103_));
  nand2  g060(.a(new_n103_), .b(new_n63_), .O(z09));
  ...
  nand3  g068(.a(new_n93_), .b(new_n56_), .c(x20), .O(new_n112_));
  ...
  nor2   g073(.a(new_n56_), .b(x20), .O(new_n117_));
  nand3  g074(.a(new_n117_), .b(new_n99_), .c(new_n46_), .O(new_n118_));
  nor2   g075(.a(new_n95_), .b(x14), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(new_n56_), .c(x20), .d(new_n96_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(new_n116_), .c(new_n118_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n93_), .c(new_n48_), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n63_), .O(z11));
  ...
  nand2  g085(.a(new_n46_), .b(new_n50_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(x23), .c(new_n56_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  ...
  nand2  g092(.a(new_n49_), .b(new_n48_), .O(new_n136_));
  nand3  g093(.a(new_n46_), .b(x17), .c(new_n50_), .O(new_n137_));
  oai21  g094(.a(new_n137_), .b(new_n136_), .c(new_n63_), .O(z13));
  ...
  oai21  g098(.a(x10), .b(new_n49_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n50_), .c(new_n49_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n63_), .O(z15));
  nor3   g102(.a(new_n75_), .b(new_n49_), .c(x00), .O(z16));
  nand4  g103(.a(new_n63_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n147_));
