...
module FAU ( 
  ...
  nand4  g47(.a(new_n65_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n91_));
  inv1   g48(.a(new_n91_), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n90_), .c(new_n89_), .d(x12), .O(new_n93_));
  nor2   g50(.a(new_n93_), .b(x15), .O(new_n94_));
  nand4  g51(.a(new_n94_), .b(new_n88_), .c(x20), .d(new_n87_), .O(new_n95_));
  nor2   g52(.a(new_n95_), .b(x22), .O(z09));
  inv1   g53(.a(x15), .O(new_n97_));
  nor2   g54(.a(new_n93_), .b(new_n97_), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n88_), .c(x20), .d(x16), .O(new_n99_));
  nor2   g56(.a(new_n99_), .b(x22), .O(z10));
  nand4  g57(.a(new_n98_), .b(new_n88_), .c(x20), .d(new_n87_), .O(new_n101_));
  ...
  nand3  g62(.a(new_n60_), .b(x17), .c(new_n48_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n47_), .c(new_n46_), .O(new_n108_));
  ...
  nand4  g69(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n113_));
  nor2   g70(.a(new_n113_), .b(x19), .O(z14));
  aoi21  g71(.a(new_n57_), .b(x01), .c(new_n48_), .O(new_n115_));
  nand3  g72(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n116_));
  oai21  g73(.a(new_n115_), .b(new_n46_), .c(new_n116_), .O(z15));
  nor2   g74(.a(new_n47_), .b(x00), .O(z16));
  nand3  g75(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n119_));
