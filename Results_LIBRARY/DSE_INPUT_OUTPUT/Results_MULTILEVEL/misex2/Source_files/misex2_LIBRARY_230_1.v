...
module FAU ( 
  ...
  nand4  g016(.a(new_n59_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n60_));
  nor2   g017(.a(new_n60_), .b(x22), .O(z02));
  ...
  nor4   g029(.a(new_n72_), .b(new_n67_), .c(x09), .d(new_n46_), .O(new_n73_));
  nand2  g030(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x12), .O(z04));
  nand2  g032(.a(x22), .b(new_n57_), .O(new_n76_));
  ...
  nand2  g042(.a(x02), .b(new_n45_), .O(new_n86_));
  ...
  nand4  g052(.a(x12), .b(new_n71_), .c(x02), .d(new_n57_), .O(new_n96_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n44_), .c(new_n95_), .d(new_n45_), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(z09));
  nor3   g063(.a(new_n44_), .b(new_n95_), .c(x20), .O(new_n107_));
  ...
  nand2  g067(.a(new_n110_), .b(new_n71_), .O(new_n111_));
  inv1   g068(.a(new_n111_), .O(new_n112_));
  nor3   g069(.a(new_n98_), .b(new_n97_), .c(x14), .O(new_n113_));
  nand3  g070(.a(new_n44_), .b(new_n95_), .c(x20), .O(new_n114_));
  ...
  nand3  g074(.a(new_n110_), .b(new_n109_), .c(new_n71_), .O(new_n118_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n44_), .c(new_n45_), .O(new_n124_));
  ...
  nor4   g092(.a(new_n58_), .b(x22), .c(x19), .d(new_n48_), .O(z13));
  nor3   g093(.a(new_n58_), .b(x10), .c(x09), .O(new_n137_));
  nand4  g094(.a(new_n137_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x22), .O(z14));
  aoi21  g096(.a(new_n67_), .b(x01), .c(new_n46_), .O(new_n140_));
  aoi21  g097(.a(x19), .b(new_n46_), .c(x22), .O(new_n141_));
  oai22  g098(.a(new_n141_), .b(x01), .c(new_n140_), .d(new_n45_), .O(z15));
  nor2   g099(.a(new_n57_), .b(x00), .O(z16));
  nand4  g100(.a(new_n44_), .b(x02), .c(new_n57_), .d(new_n45_), .O(new_n144_));
