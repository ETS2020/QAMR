...
module FAU ( 
  ...
  nor2   g000(.a(x24), .b(x08), .O(new_n44_));
  ...
  nor2   g017(.a(x19), .b(new_n51_), .O(new_n61_));
  nand3  g018(.a(new_n61_), .b(new_n60_), .c(new_n50_), .O(new_n62_));
  ...
  nand3  g023(.a(new_n66_), .b(new_n62_), .c(new_n45_), .O(z03));
  ...
  nor2   g031(.a(new_n44_), .b(new_n57_), .O(new_n75_));
  ...
  oai21  g035(.a(new_n78_), .b(new_n63_), .c(new_n45_), .O(z06));
  nand3  g036(.a(new_n65_), .b(new_n70_), .c(x11), .O(new_n80_));
  nand2  g037(.a(new_n80_), .b(x01), .O(new_n81_));
  nand3  g038(.a(new_n81_), .b(x02), .c(x00), .O(new_n82_));
  nand2  g039(.a(new_n82_), .b(new_n45_), .O(z07));
  inv1   g040(.a(x24), .O(new_n84_));
  ...
  nand4  g047(.a(new_n90_), .b(x02), .c(new_n89_), .d(new_n68_), .O(new_n91_));
  ...
  nor2   g052(.a(new_n95_), .b(new_n84_), .O(z08));
  ...
  nand3  g074(.a(new_n117_), .b(new_n45_), .c(new_n68_), .O(new_n118_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n98_), .c(new_n68_), .O(new_n124_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n89_), .c(new_n68_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n127_), .O(new_n132_));
  nand4  g089(.a(new_n132_), .b(new_n84_), .c(x09), .d(x08), .O(new_n133_));
  inv1   g090(.a(new_n133_), .O(z12));
  nor2   g091(.a(new_n44_), .b(x19), .O(new_n135_));
  nand4  g092(.a(new_n135_), .b(x17), .c(new_n46_), .d(new_n89_), .O(new_n136_));
  ...
  nand3  g097(.a(x19), .b(new_n46_), .c(new_n89_), .O(new_n141_));
  nand3  g098(.a(new_n141_), .b(new_n140_), .c(new_n45_), .O(z15));
  nor3   g099(.a(new_n44_), .b(new_n89_), .c(x00), .O(z16));
  nand2  g100(.a(new_n99_), .b(new_n68_), .O(new_n144_));
