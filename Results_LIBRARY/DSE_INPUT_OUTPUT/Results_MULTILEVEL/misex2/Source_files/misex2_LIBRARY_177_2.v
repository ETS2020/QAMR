...
module FAU ( 
  ...
  oai21  g020(.a(new_n63_), .b(new_n62_), .c(x07), .O(new_n64_));
  nand2  g021(.a(new_n64_), .b(x01), .O(new_n65_));
  inv1   g022(.a(x19), .O(new_n66_));
  nor3   g023(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  nand4  g024(.a(new_n67_), .b(new_n66_), .c(x18), .d(new_n50_), .O(new_n68_));
  ...
  aoi21  g031(.a(new_n74_), .b(x07), .c(new_n70_), .O(z04));
  nand4  g032(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(x07), .c(new_n70_), .O(z05));
  nand4  g034(.a(x07), .b(x02), .c(x01), .d(x00), .O(new_n78_));
  inv1   g035(.a(new_n78_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(x11), .c(x10), .d(new_n47_), .O(new_n80_));
  inv1   g037(.a(new_n80_), .O(z06));
  nand2  g038(.a(new_n47_), .b(x07), .O(new_n82_));
  ...
  nand3  g048(.a(x19), .b(new_n54_), .c(x17), .O(new_n92_));
  nor3   g049(.a(new_n92_), .b(x08), .c(x06), .O(new_n93_));
  nand2  g050(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  aoi21  g051(.a(new_n94_), .b(new_n70_), .c(x07), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n71_), .c(x02), .d(new_n70_), .O(new_n98_));
  ...
  nand4  g060(.a(new_n103_), .b(x18), .c(x07), .d(x01), .O(new_n104_));
  ...
  nand3  g064(.a(x18), .b(x07), .c(x01), .O(new_n108_));
  ...
  nand3  g077(.a(new_n120_), .b(new_n111_), .c(new_n71_), .O(new_n121_));
  inv1   g078(.a(x20), .O(new_n122_));
  nand4  g079(.a(new_n109_), .b(x21), .c(new_n122_), .d(new_n66_), .O(new_n123_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n70_), .c(new_n87_), .O(new_n136_));
  ...
  nand3  g098(.a(new_n51_), .b(new_n50_), .c(new_n59_), .O(new_n142_));
  oai21  g099(.a(new_n142_), .b(new_n49_), .c(new_n45_), .O(z14));
  aoi22  g100(.a(new_n45_), .b(x00), .c(x19), .d(new_n70_), .O(new_n144_));
  nand4  g101(.a(new_n59_), .b(x07), .c(x01), .d(x00), .O(new_n145_));
  oai21  g102(.a(new_n144_), .b(x02), .c(new_n145_), .O(z15));
  nand3  g103(.a(x07), .b(x01), .c(new_n87_), .O(new_n147_));
