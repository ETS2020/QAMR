...
module FAU ( 
  ...
  aoi21  g29(.a(new_n72_), .b(x01), .c(new_n46_), .O(z05));
  ...
  nand4  g54(.a(new_n97_), .b(new_n88_), .c(new_n87_), .d(new_n46_), .O(new_n98_));
  inv1   g55(.a(new_n98_), .O(z09));
  nor3   g56(.a(new_n88_), .b(new_n87_), .c(x20), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n64_), .c(x18), .d(x01), .O(new_n101_));
  nor2   g58(.a(new_n48_), .b(x01), .O(new_n102_));
  ...
  nand3  g68(.a(new_n111_), .b(new_n102_), .c(new_n68_), .O(new_n112_));
  nand4  g69(.a(new_n95_), .b(x21), .c(new_n94_), .d(new_n64_), .O(new_n113_));
  nor2   g70(.a(new_n90_), .b(x14), .O(new_n114_));
  nor2   g71(.a(x21), .b(new_n94_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n114_), .c(new_n91_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n112_), .c(new_n113_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n88_), .c(new_n46_), .O(new_n118_));
  inv1   g75(.a(new_n118_), .O(z11));
  inv1   g76(.a(x24), .O(new_n120_));
  aoi21  g77(.a(x10), .b(x02), .c(new_n46_), .O(new_n121_));
  oai21  g78(.a(x19), .b(x02), .c(x23), .O(new_n122_));
  nand3  g79(.a(new_n64_), .b(x17), .c(new_n48_), .O(new_n123_));
  aoi21  g80(.a(new_n123_), .b(new_n122_), .c(x01), .O(new_n124_));
  oai21  g81(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n125_));
  nand2  g82(.a(new_n47_), .b(x00), .O(new_n126_));
  oai21  g83(.a(new_n125_), .b(new_n49_), .c(new_n126_), .O(z12));
  ...
  nand2  g88(.a(x19), .b(new_n48_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(new_n46_), .c(x01), .O(new_n133_));
  or2    g90(.a(new_n133_), .b(new_n121_), .O(z15));
  nand2  g91(.a(x01), .b(new_n46_), .O(new_n135_));
