...
module FAU ( 
  ...
  nand4  g029(.a(new_n72_), .b(new_n70_), .c(x10), .d(new_n53_), .O(new_n73_));
  nor2   g030(.a(new_n73_), .b(x12), .O(z04));
  nand2  g031(.a(x01), .b(x00), .O(new_n75_));
  nor2   g032(.a(x03), .b(x01), .O(z08));
  inv1   g033(.a(z08), .O(new_n77_));
  nand3  g034(.a(x10), .b(x09), .c(x02), .O(new_n78_));
  oai21  g035(.a(new_n78_), .b(new_n75_), .c(new_n77_), .O(z05));
  nand3  g036(.a(x11), .b(x10), .c(new_n53_), .O(new_n80_));
  oai21  g037(.a(new_n80_), .b(new_n67_), .c(new_n77_), .O(z06));
  ...
  nand4  g047(.a(x12), .b(new_n70_), .c(x02), .d(new_n47_), .O(new_n91_));
  ...
  nand4  g053(.a(new_n96_), .b(new_n58_), .c(x18), .d(x01), .O(new_n97_));
  oai21  g054(.a(new_n95_), .b(new_n91_), .c(new_n97_), .O(new_n98_));
  nand4  g055(.a(new_n98_), .b(new_n90_), .c(new_n89_), .d(new_n46_), .O(new_n99_));
  nand2  g056(.a(new_n99_), .b(new_n77_), .O(z09));
  nand3  g057(.a(new_n58_), .b(x18), .c(x01), .O(new_n101_));
  ...
  nand3  g062(.a(new_n105_), .b(x12), .c(new_n70_), .O(new_n106_));
  ...
  oai21  g069(.a(new_n112_), .b(x00), .c(new_n77_), .O(z10));
  nor2   g070(.a(new_n45_), .b(new_n47_), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(x21), .c(new_n96_), .d(new_n58_), .O(new_n115_));
  inv1   g072(.a(new_n104_), .O(new_n116_));
  nand3  g073(.a(x12), .b(new_n70_), .c(x03), .O(new_n117_));
  ...
  nand3  g087(.a(new_n58_), .b(x17), .c(new_n48_), .O(new_n131_));
  ...
  nor3   g093(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g094(.a(new_n60_), .b(new_n53_), .c(new_n48_), .d(new_n46_), .O(new_n138_));
  aoi21  g095(.a(new_n138_), .b(x03), .c(x01), .O(z14));
  aoi21  g096(.a(new_n57_), .b(x01), .c(new_n48_), .O(new_n140_));
  aoi21  g097(.a(x19), .b(new_n48_), .c(new_n82_), .O(new_n141_));
  oai22  g098(.a(new_n141_), .b(x01), .c(new_n140_), .d(new_n46_), .O(z15));
  oai21  g099(.a(new_n47_), .b(x00), .c(new_n77_), .O(z16));
  nand2  g100(.a(x02), .b(new_n46_), .O(new_n144_));
  aoi21  g101(.a(new_n144_), .b(x03), .c(x01), .O(z17));
endmodule
