...
module FAU ( 
  ...
  nand4  g11(.a(new_n46_), .b(new_n45_), .c(new_n54_), .d(x09), .O(new_n55_));
  nor3   g12(.a(new_n55_), .b(x19), .c(x18), .O(z02));
  inv1   g13(.a(x01), .O(new_n57_));
  nor2   g14(.a(x09), .b(new_n50_), .O(new_n58_));
  ...
  nand4  g20(.a(new_n63_), .b(new_n62_), .c(x18), .d(new_n45_), .O(new_n64_));
  oai21  g21(.a(new_n61_), .b(new_n49_), .c(new_n64_), .O(z03));
  inv1   g22(.a(x11), .O(new_n66_));
  nand3  g23(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  nor3   g24(.a(new_n67_), .b(new_n54_), .c(x09), .O(new_n68_));
  nand2  g25(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nor2   g26(.a(new_n69_), .b(x12), .O(z04));
  nand3  g27(.a(x10), .b(x09), .c(x02), .O(new_n71_));
  aoi21  g28(.a(new_n71_), .b(x01), .c(new_n49_), .O(z05));
  nand2  g29(.a(new_n68_), .b(x11), .O(new_n73_));
  inv1   g30(.a(new_n73_), .O(z06));
  inv1   g31(.a(x12), .O(new_n75_));
  nand4  g32(.a(new_n58_), .b(new_n75_), .c(x11), .d(x10), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x01), .c(new_n49_), .O(z07));
  nor2   g34(.a(x03), .b(new_n50_), .O(new_n78_));
  ...
  nand3  g41(.a(new_n84_), .b(new_n81_), .c(new_n78_), .O(new_n85_));
  aoi21  g42(.a(new_n85_), .b(new_n49_), .c(x01), .O(z08));
  ...
  oai21  g49(.a(new_n92_), .b(new_n88_), .c(new_n49_), .O(new_n93_));
  nand2  g50(.a(new_n93_), .b(new_n57_), .O(new_n94_));
  nor3   g51(.a(new_n82_), .b(new_n57_), .c(x00), .O(new_n95_));
  ...
  oai21  g56(.a(new_n99_), .b(new_n88_), .c(new_n49_), .O(new_n100_));
  nand2  g57(.a(new_n100_), .b(new_n57_), .O(new_n101_));
  ...
  nor2   g64(.a(new_n50_), .b(x01), .O(new_n108_));
  ...
  nand3  g71(.a(new_n114_), .b(new_n104_), .c(new_n49_), .O(new_n115_));
  ...
  nand3  g77(.a(new_n62_), .b(x17), .c(new_n50_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n57_), .c(new_n49_), .O(new_n123_));
  ...
  nand2  g83(.a(new_n46_), .b(x17), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(x19), .O(z13));
  nand4  g85(.a(new_n51_), .b(new_n54_), .c(new_n44_), .d(new_n50_), .O(new_n129_));
  aoi21  g86(.a(new_n129_), .b(new_n49_), .c(x01), .O(z14));
  nor2   g87(.a(x01), .b(x00), .O(new_n131_));
  nand3  g88(.a(new_n131_), .b(x19), .c(new_n50_), .O(new_n132_));
