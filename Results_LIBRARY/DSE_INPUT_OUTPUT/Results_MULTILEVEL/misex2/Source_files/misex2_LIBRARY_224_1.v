...
module FAU ( 
  ...
  nor3   g29(.a(new_n68_), .b(new_n72_), .c(new_n47_), .O(z05));
  nor4   g30(.a(new_n64_), .b(new_n67_), .c(new_n72_), .d(x09), .O(z06));
  nand2  g31(.a(new_n47_), .b(x01), .O(new_n75_));
  inv1   g32(.a(x12), .O(new_n76_));
  nand3  g33(.a(new_n76_), .b(x11), .c(x10), .O(new_n77_));
  oai22  g34(.a(new_n77_), .b(new_n75_), .c(x15), .d(x01), .O(new_n78_));
  ...
  nand4  g42(.a(new_n85_), .b(x02), .c(new_n57_), .d(new_n45_), .O(new_n86_));
  ...
  nand4  g46(.a(new_n89_), .b(new_n49_), .c(x17), .d(new_n44_), .O(new_n90_));
  nor2   g47(.a(new_n90_), .b(new_n50_), .O(z08));
  inv1   g48(.a(x21), .O(new_n92_));
  inv1   g49(.a(x22), .O(new_n93_));
  nand4  g50(.a(x12), .b(new_n67_), .c(x02), .d(new_n57_), .O(new_n94_));
  inv1   g51(.a(x16), .O(new_n95_));
  nor2   g52(.a(x14), .b(x13), .O(new_n96_));
  nand3  g53(.a(new_n96_), .b(x20), .c(new_n95_), .O(new_n97_));
  inv1   g54(.a(x20), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n50_), .c(x18), .d(x01), .O(new_n99_));
  oai21  g56(.a(new_n97_), .b(new_n94_), .c(new_n99_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n93_), .c(new_n92_), .d(new_n45_), .O(new_n101_));
  oai21  g58(.a(new_n44_), .b(x01), .c(new_n101_), .O(z09));
  nor2   g59(.a(new_n57_), .b(x00), .O(z16));
  nand3  g60(.a(z16), .b(new_n50_), .c(x18), .O(new_n104_));
  nor3   g61(.a(new_n104_), .b(new_n92_), .c(x20), .O(new_n105_));
  nand2  g62(.a(new_n105_), .b(x22), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(z10));
  nand2  g64(.a(new_n105_), .b(new_n93_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(z11));
  aoi21  g66(.a(x10), .b(x02), .c(new_n57_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(x00), .O(new_n111_));
  oai21  g68(.a(x19), .b(x02), .c(x23), .O(new_n112_));
  nand3  g69(.a(new_n50_), .b(x17), .c(new_n46_), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n44_), .c(new_n57_), .d(new_n45_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n111_), .c(x24), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(x09), .O(new_n117_));
  inv1   g74(.a(new_n117_), .O(z12));
  nand4  g75(.a(new_n50_), .b(x17), .c(new_n46_), .d(new_n45_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n44_), .c(x01), .O(z13));
  nor3   g77(.a(new_n58_), .b(x10), .c(x09), .O(new_n121_));
  nand4  g78(.a(new_n121_), .b(new_n49_), .c(new_n48_), .d(new_n44_), .O(new_n122_));
  nor2   g79(.a(new_n122_), .b(x19), .O(z14));
  aoi21  g80(.a(new_n44_), .b(new_n46_), .c(new_n110_), .O(new_n124_));
  nand4  g81(.a(x19), .b(new_n44_), .c(new_n46_), .d(new_n57_), .O(new_n125_));
  oai21  g82(.a(new_n124_), .b(new_n45_), .c(new_n125_), .O(z15));
  nand4  g83(.a(new_n44_), .b(x02), .c(new_n57_), .d(new_n45_), .O(new_n127_));
