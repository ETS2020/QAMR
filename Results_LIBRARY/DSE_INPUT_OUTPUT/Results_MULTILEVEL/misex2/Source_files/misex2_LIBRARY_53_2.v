...
module FAU ( 
  ...
  oai21  g021(.a(new_n64_), .b(new_n63_), .c(x14), .O(new_n65_));
  ...
  aoi21  g030(.a(new_n73_), .b(x14), .c(new_n47_), .O(z04));
  nand3  g031(.a(x02), .b(x01), .c(x00), .O(new_n75_));
  nor4   g032(.a(new_n75_), .b(new_n54_), .c(new_n60_), .d(new_n49_), .O(z05));
  inv1   g033(.a(new_n75_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x11), .c(x10), .d(new_n49_), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n54_), .O(z06));
  nand2  g036(.a(x10), .b(new_n49_), .O(new_n80_));
  nand3  g037(.a(x14), .b(new_n71_), .c(x11), .O(new_n81_));
  ...
  nand2  g050(.a(new_n93_), .b(new_n55_), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nand4  g053(.a(x12), .b(new_n70_), .c(x02), .d(new_n47_), .O(new_n97_));
  ...
  nand4  g059(.a(new_n102_), .b(x18), .c(x14), .d(x01), .O(new_n103_));
  ...
  nand2  g067(.a(new_n110_), .b(new_n70_), .O(new_n111_));
  ...
  nand4  g072(.a(new_n115_), .b(new_n113_), .c(new_n112_), .d(new_n85_), .O(new_n116_));
  aoi21  g073(.a(new_n116_), .b(new_n109_), .c(x00), .O(z10));
  nand3  g074(.a(new_n110_), .b(new_n85_), .c(new_n70_), .O(new_n118_));
  inv1   g075(.a(x20), .O(new_n119_));
  nand4  g076(.a(new_n108_), .b(x21), .c(new_n119_), .d(new_n57_), .O(new_n120_));
  nor2   g077(.a(new_n98_), .b(x14), .O(new_n121_));
  nor2   g078(.a(x21), .b(new_n119_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n121_), .c(new_n99_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n118_), .c(new_n120_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n96_), .c(new_n46_), .O(new_n125_));
  ...
  nand2  g092(.a(new_n135_), .b(new_n55_), .O(z12));
  ...
  nand3  g101(.a(x14), .b(x01), .c(new_n46_), .O(new_n145_));
  inv1   g102(.a(new_n145_), .O(z16));
  nand2  g103(.a(new_n86_), .b(new_n55_), .O(z17));
endmodule
