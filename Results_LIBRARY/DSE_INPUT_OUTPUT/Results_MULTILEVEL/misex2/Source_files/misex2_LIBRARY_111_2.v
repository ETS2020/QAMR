...
module FAU ( 
  ...
  nor2   g037(.a(new_n62_), .b(new_n72_), .O(new_n81_));
  nand4  g038(.a(new_n81_), .b(x10), .c(new_n46_), .d(x02), .O(new_n82_));
  nor3   g039(.a(new_n82_), .b(new_n44_), .c(new_n71_), .O(z06));
  nand3  g040(.a(new_n65_), .b(new_n73_), .c(x11), .O(new_n84_));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n44_), .d(new_n71_), .O(new_n92_));
  ...
  nor2   g053(.a(new_n96_), .b(new_n50_), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  nand4  g055(.a(x12), .b(new_n72_), .c(x02), .d(new_n44_), .O(new_n99_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n51_), .c(new_n98_), .d(new_n88_), .O(new_n108_));
  nor2   g065(.a(new_n108_), .b(x00), .O(z09));
  nor2   g066(.a(new_n51_), .b(new_n98_), .O(new_n110_));
  nand4  g067(.a(new_n110_), .b(new_n68_), .c(new_n104_), .d(x01), .O(new_n111_));
  inv1   g068(.a(x13), .O(new_n112_));
  nand3  g069(.a(new_n112_), .b(x12), .c(new_n72_), .O(new_n113_));
  nor4   g070(.a(new_n113_), .b(x08), .c(new_n45_), .d(x01), .O(new_n114_));
  ...
  nand3  g077(.a(new_n120_), .b(x02), .c(new_n44_), .O(new_n121_));
  nor2   g078(.a(new_n100_), .b(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n98_), .c(x20), .d(new_n101_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n121_), .c(new_n119_), .O(new_n124_));
  nand2  g081(.a(new_n124_), .b(new_n71_), .O(new_n125_));
  aoi21  g082(.a(new_n125_), .b(new_n88_), .c(x22), .O(z11));
  ...
  nor2   g092(.a(new_n62_), .b(x19), .O(new_n136_));
  nand4  g093(.a(new_n136_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n137_));
  nor2   g094(.a(new_n137_), .b(x00), .O(z13));
  nand4  g095(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n71_), .O(new_n139_));
  nand4  g096(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n140_));
  oai21  g097(.a(new_n140_), .b(new_n139_), .c(new_n52_), .O(z14));
  ...
  aoi21  g101(.a(new_n144_), .b(new_n143_), .c(new_n62_), .O(z15));
  oai21  g102(.a(new_n44_), .b(x00), .c(new_n52_), .O(z16));
  nand4  g103(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n71_), .O(new_n147_));
