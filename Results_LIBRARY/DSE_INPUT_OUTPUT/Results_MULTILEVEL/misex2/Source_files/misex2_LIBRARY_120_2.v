...
module FAU ( 
  ...
  nand4  g020(.a(x05), .b(x02), .c(x01), .d(x00), .O(new_n64_));
  nand4  g021(.a(x12), .b(x11), .c(x10), .d(new_n47_), .O(new_n65_));
  oai22  g022(.a(new_n65_), .b(new_n64_), .c(new_n63_), .d(new_n62_), .O(z03));
  ...
  aoi21  g026(.a(new_n69_), .b(x05), .c(new_n61_), .O(z04));
  nand4  g027(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n71_));
  aoi21  g028(.a(new_n71_), .b(x05), .c(new_n61_), .O(z05));
  nand4  g029(.a(x05), .b(x02), .c(x01), .d(x00), .O(new_n73_));
  inv1   g030(.a(new_n73_), .O(new_n74_));
  nand4  g031(.a(new_n74_), .b(x11), .c(x10), .d(new_n47_), .O(new_n75_));
  inv1   g032(.a(new_n75_), .O(z06));
  nand2  g033(.a(new_n47_), .b(x05), .O(new_n77_));
  ...
  nand2  g039(.a(x02), .b(new_n60_), .O(new_n83_));
  inv1   g040(.a(x06), .O(new_n84_));
  nand2  g041(.a(new_n84_), .b(x04), .O(new_n85_));
  nor3   g042(.a(new_n85_), .b(new_n83_), .c(x03), .O(new_n86_));
  nand3  g043(.a(x19), .b(new_n51_), .c(x17), .O(new_n87_));
  nor3   g044(.a(new_n87_), .b(x08), .c(x07), .O(new_n88_));
  nand2  g045(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  aoi21  g046(.a(new_n89_), .b(new_n61_), .c(x05), .O(z08));
  inv1   g047(.a(x21), .O(new_n91_));
  inv1   g048(.a(x22), .O(new_n92_));
  inv1   g049(.a(x11), .O(new_n93_));
  nand4  g050(.a(x12), .b(new_n93_), .c(x02), .d(new_n61_), .O(new_n94_));
  ...
  nand4  g058(.a(new_n101_), .b(new_n92_), .c(new_n91_), .d(new_n60_), .O(new_n102_));
  nand2  g059(.a(new_n102_), .b(new_n45_), .O(z09));
  nand3  g060(.a(new_n52_), .b(x18), .c(x01), .O(new_n104_));
  nand3  g061(.a(x22), .b(x21), .c(new_n99_), .O(new_n105_));
  nor2   g062(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand2  g063(.a(x02), .b(new_n61_), .O(new_n107_));
  inv1   g064(.a(x13), .O(new_n108_));
  nand3  g065(.a(new_n108_), .b(x12), .c(new_n93_), .O(new_n109_));
  ...
  nor2   g074(.a(x13), .b(new_n78_), .O(new_n118_));
  nand3  g075(.a(new_n118_), .b(new_n117_), .c(new_n93_), .O(new_n119_));
  nand3  g076(.a(x18), .b(x05), .c(x01), .O(new_n120_));
  inv1   g077(.a(new_n120_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(x21), .c(new_n99_), .d(new_n52_), .O(new_n122_));
  nor2   g079(.a(new_n95_), .b(x14), .O(new_n123_));
  nor2   g080(.a(x21), .b(new_n99_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n123_), .c(new_n96_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n119_), .c(new_n122_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n92_), .c(new_n60_), .O(new_n127_));
  ...
  oai21  g097(.a(new_n58_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g098(.a(x10), .b(new_n61_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n46_), .c(new_n61_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n45_), .O(z15));
  aoi21  g102(.a(x05), .b(x00), .c(new_n61_), .O(z16));
  oai21  g103(.a(new_n107_), .b(x00), .c(new_n45_), .O(z17));
endmodule
