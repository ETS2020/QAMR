...
module FAU ( 
  ...
  aoi21  g28(.a(new_n71_), .b(x01), .c(new_n46_), .O(z04));
  nand3  g29(.a(x02), .b(x01), .c(x00), .O(new_n73_));
  nor3   g30(.a(new_n73_), .b(new_n58_), .c(new_n49_), .O(z05));
  nand3  g31(.a(x02), .b(x01), .c(x00), .O(new_n75_));
  nor4   g32(.a(new_n75_), .b(new_n69_), .c(new_n58_), .d(x09), .O(z06));
  ...
  nand4  g47(.a(x12), .b(new_n69_), .c(x02), .d(new_n47_), .O(new_n91_));
  ...
  nand4  g56(.a(new_n99_), .b(new_n90_), .c(new_n89_), .d(new_n46_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(z09));
  nor3   g58(.a(new_n90_), .b(new_n89_), .c(x20), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n65_), .c(x18), .d(x01), .O(new_n103_));
  nor2   g60(.a(new_n48_), .b(x01), .O(new_n104_));
  inv1   g61(.a(x13), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(x12), .c(new_n69_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nor3   g64(.a(new_n93_), .b(new_n92_), .c(x14), .O(new_n108_));
  nand3  g65(.a(new_n90_), .b(new_n89_), .c(x20), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n108_), .c(new_n107_), .d(new_n104_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n103_), .c(x00), .O(z10));
  nor2   g69(.a(x13), .b(new_n70_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n104_), .c(new_n69_), .O(new_n114_));
  nand4  g71(.a(new_n97_), .b(x21), .c(new_n96_), .d(new_n65_), .O(new_n115_));
  nor2   g72(.a(new_n92_), .b(x14), .O(new_n116_));
  nor2   g73(.a(x21), .b(new_n96_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n116_), .c(new_n93_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n114_), .c(new_n115_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n90_), .c(new_n46_), .O(new_n120_));
  ...
  nand3  g81(.a(new_n65_), .b(x17), .c(new_n48_), .O(new_n125_));
  ...
  nand3  g86(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n130_));
  nor3   g87(.a(new_n130_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g88(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n132_));
  nor2   g89(.a(new_n132_), .b(x19), .O(z14));
  nand2  g90(.a(x19), .b(new_n48_), .O(new_n134_));
  aoi21  g91(.a(new_n134_), .b(new_n46_), .c(x01), .O(new_n135_));
  or2    g92(.a(new_n135_), .b(new_n123_), .O(z15));
  nand2  g93(.a(x01), .b(new_n46_), .O(new_n137_));
  nand2  g94(.a(new_n137_), .b(new_n128_), .O(z16));
