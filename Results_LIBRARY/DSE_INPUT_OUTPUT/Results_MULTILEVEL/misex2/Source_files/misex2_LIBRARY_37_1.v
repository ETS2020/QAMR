...
module FAU ( 
  ...
  nand2  g37(.a(x01), .b(new_n55_), .O(new_n81_));
  ...
  nand4  g43(.a(new_n86_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n87_));
  ...
  nand4  g47(.a(new_n90_), .b(new_n54_), .c(x17), .d(new_n83_), .O(new_n91_));
  ...
  nand4  g53(.a(new_n76_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n97_));
  ...
  nand3  g59(.a(new_n96_), .b(new_n95_), .c(x12), .O(new_n103_));
  nor3   g60(.a(new_n103_), .b(x11), .c(new_n45_), .O(new_n104_));
  inv1   g61(.a(x15), .O(new_n105_));
  nor2   g62(.a(new_n93_), .b(new_n105_), .O(new_n106_));
  ...
  nor2   g66(.a(new_n99_), .b(new_n105_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n94_), .c(x20), .d(new_n93_), .O(new_n111_));
  ...
  oai21  g75(.a(new_n118_), .b(new_n66_), .c(new_n81_), .O(z12));
  aoi21  g76(.a(new_n116_), .b(new_n44_), .c(x00), .O(z13));
  nand4  g77(.a(new_n48_), .b(new_n46_), .c(new_n66_), .d(new_n45_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g79(.a(new_n46_), .b(new_n55_), .c(x01), .O(new_n123_));
  oai21  g80(.a(x19), .b(x00), .c(new_n45_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n123_), .O(z15));
  nand3  g82(.a(x02), .b(new_n44_), .c(new_n55_), .O(new_n127_));
