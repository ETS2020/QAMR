...
module FAU ( 
  ...
  nor3   g27(.a(new_n67_), .b(new_n57_), .c(new_n46_), .O(z05));
  nor2   g28(.a(x09), .b(new_n45_), .O(new_n72_));
  nand3  g29(.a(new_n72_), .b(x11), .c(x10), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(x01), .c(new_n44_), .O(z06));
  nor2   g31(.a(x12), .b(new_n66_), .O(new_n75_));
  nand3  g32(.a(new_n75_), .b(new_n72_), .c(x10), .O(new_n76_));
  ...
  nand3  g40(.a(new_n83_), .b(new_n81_), .c(new_n78_), .O(new_n84_));
  aoi21  g41(.a(new_n84_), .b(new_n44_), .c(x01), .O(z08));
  inv1   g42(.a(x21), .O(new_n86_));
  inv1   g43(.a(x22), .O(new_n87_));
  nand4  g44(.a(x12), .b(new_n66_), .c(x02), .d(new_n52_), .O(new_n88_));
  ...
  nand4  g52(.a(new_n95_), .b(new_n87_), .c(new_n86_), .d(new_n44_), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(z09));
  nand4  g54(.a(new_n91_), .b(x12), .c(new_n66_), .d(x02), .O(new_n98_));
  ...
  nand2  g58(.a(new_n101_), .b(new_n52_), .O(new_n102_));
  nor3   g59(.a(new_n51_), .b(new_n52_), .c(x00), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n93_), .c(x22), .d(x21), .O(new_n104_));
  nand2  g61(.a(new_n104_), .b(new_n102_), .O(z10));
  nand4  g62(.a(new_n99_), .b(x20), .c(new_n90_), .d(x15), .O(new_n106_));
  oai21  g63(.a(new_n106_), .b(new_n98_), .c(new_n44_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n52_), .O(new_n108_));
  nand4  g65(.a(new_n103_), .b(new_n93_), .c(new_n87_), .d(x21), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n108_), .O(z11));
  ...
  nand3  g73(.a(new_n116_), .b(new_n52_), .c(new_n44_), .O(new_n117_));
  ...
  aoi21  g77(.a(new_n115_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g78(.a(new_n47_), .b(new_n57_), .c(new_n46_), .d(new_n45_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n44_), .c(x01), .O(z14));
  nand4  g80(.a(x19), .b(new_n45_), .c(new_n52_), .d(new_n44_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n113_), .O(z15));
  nor2   g82(.a(new_n52_), .b(x00), .O(z16));
  aoi21  g83(.a(new_n45_), .b(new_n44_), .c(x01), .O(z17));
endmodule
