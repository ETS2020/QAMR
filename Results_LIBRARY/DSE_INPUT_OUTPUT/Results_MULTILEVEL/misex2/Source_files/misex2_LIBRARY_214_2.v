...
module FAU ( 
  ...
  nor3   g28(.a(new_n71_), .b(new_n57_), .c(new_n49_), .O(z05));
  inv1   g29(.a(x11), .O(new_n73_));
  nor4   g30(.a(new_n65_), .b(new_n73_), .c(new_n57_), .d(x09), .O(z06));
  ...
  nand4  g44(.a(x12), .b(new_n73_), .c(x02), .d(new_n47_), .O(new_n88_));
  ...
  nand4  g54(.a(new_n91_), .b(x12), .c(new_n73_), .d(x02), .O(new_n98_));
  nor2   g55(.a(x22), .b(x21), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(x20), .c(x16), .d(x15), .O(new_n100_));
  oai21  g57(.a(new_n100_), .b(new_n98_), .c(new_n46_), .O(new_n101_));
  nand2  g58(.a(new_n101_), .b(new_n47_), .O(new_n102_));
  nor3   g59(.a(new_n45_), .b(new_n47_), .c(x00), .O(new_n103_));
  ...
  oai21  g63(.a(new_n106_), .b(new_n98_), .c(new_n46_), .O(new_n107_));
  ...
  nand3  g71(.a(new_n63_), .b(x17), .c(new_n48_), .O(new_n115_));
  ...
  aoi21  g80(.a(x19), .b(new_n48_), .c(x00), .O(new_n124_));
  nand2  g81(.a(new_n112_), .b(x00), .O(new_n125_));
  oai21  g82(.a(new_n124_), .b(x01), .c(new_n125_), .O(z15));
