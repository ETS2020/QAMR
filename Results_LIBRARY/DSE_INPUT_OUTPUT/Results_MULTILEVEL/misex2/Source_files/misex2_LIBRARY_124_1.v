...
module FAU ( 
  ...
  aoi21  g27(.a(new_n70_), .b(x00), .c(new_n52_), .O(z04));
  ...
  aoi21  g31(.a(new_n74_), .b(x00), .c(new_n52_), .O(z06));
  ...
  nor2   g36(.a(new_n52_), .b(x00), .O(z16));
  ...
  nand4  g43(.a(new_n86_), .b(x02), .c(new_n52_), .d(new_n62_), .O(new_n87_));
  ...
  nor3   g54(.a(new_n97_), .b(x11), .c(new_n53_), .O(new_n98_));
  ...
  aoi21  g60(.a(new_n103_), .b(new_n52_), .c(x00), .O(z09));
  nand4  g61(.a(new_n102_), .b(new_n98_), .c(x16), .d(x15), .O(new_n105_));
  aoi21  g62(.a(new_n105_), .b(new_n52_), .c(x00), .O(z10));
  inv1   g63(.a(x11), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(x02), .c(new_n52_), .d(new_n62_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n96_), .c(new_n95_), .d(x12), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(new_n93_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n99_), .c(x20), .d(new_n94_), .O(new_n112_));
  nor2   g69(.a(new_n112_), .b(x22), .O(z11));
  inv1   g70(.a(x24), .O(new_n114_));
  aoi21  g71(.a(x10), .b(x02), .c(new_n52_), .O(new_n115_));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g73(.a(new_n64_), .b(x17), .c(new_n53_), .O(new_n117_));
  ...
  nand4  g79(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n123_));
  nor2   g80(.a(new_n123_), .b(x19), .O(z14));
  aoi21  g81(.a(new_n57_), .b(x01), .c(new_n53_), .O(new_n125_));
  nand3  g82(.a(x19), .b(new_n53_), .c(new_n52_), .O(new_n126_));
  oai21  g83(.a(new_n125_), .b(new_n62_), .c(new_n126_), .O(z15));
  aoi21  g84(.a(new_n53_), .b(new_n52_), .c(x00), .O(z17));
endmodule
