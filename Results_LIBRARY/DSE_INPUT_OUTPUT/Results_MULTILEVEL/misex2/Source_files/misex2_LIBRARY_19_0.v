...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_, new_n54_,
    ...
    new_n74_, new_n76_, new_n78_, new_n80_, new_n81_, new_n83_;
  ...
  nand4  g11(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n57_));
  ...
  nand4  g25(.a(new_n71_), .b(x18), .c(x01), .d(new_n61_), .O(new_n72_));
  ...
  nand4  g31(.a(new_n73_), .b(new_n70_), .c(x21), .d(new_n68_), .O(new_n78_));
  ...
  nand2  g36(.a(new_n56_), .b(x01), .O(new_n83_));
  aoi21  g37(.a(new_n83_), .b(x02), .c(new_n61_), .O(z15));
  nor2   g38(.a(new_n62_), .b(x00), .O(z16));
  zero   g39(.O(z01));
  zero   g40(.O(z02));
  zero   g41(.O(z08));
  zero   g42(.O(z17));
