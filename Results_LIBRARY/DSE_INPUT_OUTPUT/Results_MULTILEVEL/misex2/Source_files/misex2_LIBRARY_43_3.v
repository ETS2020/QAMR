...
module FAU ( 
  ...
  nand2  g009(.a(x03), .b(x01), .O(new_n53_));
  ...
  nor2   g030(.a(new_n73_), .b(x03), .O(new_n74_));
  ...
  aoi21  g037(.a(new_n80_), .b(new_n63_), .c(new_n77_), .O(z05));
  nand4  g038(.a(new_n79_), .b(x11), .c(x10), .d(new_n47_), .O(new_n82_));
  aoi21  g039(.a(new_n82_), .b(new_n63_), .c(new_n77_), .O(z06));
  ...
  nand4  g048(.a(new_n91_), .b(new_n89_), .c(new_n63_), .d(new_n78_), .O(new_n92_));
  ...
  nand4  g054(.a(x12), .b(new_n72_), .c(x02), .d(new_n77_), .O(new_n98_));
  ...
  nand4  g060(.a(new_n103_), .b(new_n68_), .c(x18), .d(x01), .O(new_n104_));
  oai21  g061(.a(new_n102_), .b(new_n98_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n78_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n53_), .O(z09));
  nand3  g064(.a(new_n68_), .b(x18), .c(x01), .O(new_n108_));
  nand3  g065(.a(x22), .b(x21), .c(new_n103_), .O(new_n109_));
  nor2   g066(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g067(.a(x02), .b(new_n77_), .O(new_n111_));
  ...
  nand4  g077(.a(new_n89_), .b(new_n112_), .c(x12), .d(new_n72_), .O(new_n121_));
  nor2   g078(.a(new_n45_), .b(x03), .O(new_n122_));
  nor2   g079(.a(new_n96_), .b(x20), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n122_), .c(new_n68_), .d(x01), .O(new_n124_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n97_), .c(new_n78_), .O(new_n128_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n77_), .c(new_n78_), .O(new_n136_));
  ...
  nand4  g100(.a(new_n143_), .b(new_n142_), .c(new_n55_), .d(new_n48_), .O(new_n144_));
  nand2  g101(.a(new_n144_), .b(new_n53_), .O(z14));
  aoi22  g102(.a(new_n53_), .b(x00), .c(x19), .d(new_n77_), .O(new_n146_));
  nand4  g103(.a(new_n58_), .b(new_n63_), .c(x01), .d(x00), .O(new_n147_));
  oai21  g104(.a(new_n146_), .b(x02), .c(new_n147_), .O(z15));
  aoi21  g105(.a(new_n63_), .b(x00), .c(new_n77_), .O(z16));
