...
module FAU ( 
  ...
  nand4  g74(.a(new_n66_), .b(new_n45_), .c(new_n44_), .d(new_n53_), .O(new_n118_));
  inv1   g75(.a(new_n118_), .O(new_n119_));
  nand4  g76(.a(new_n119_), .b(new_n52_), .c(new_n51_), .d(new_n46_), .O(new_n120_));
  nor2   g77(.a(new_n120_), .b(x19), .O(z14));
  oai21  g78(.a(new_n46_), .b(new_n53_), .c(x01), .O(new_n122_));
