...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_, new_n54_,
    ...
    new_n75_, new_n77_, new_n79_, new_n80_, new_n82_, new_n83_, new_n86_,
    new_n87_, new_n88_;
  ...
  nand4  g26(.a(new_n72_), .b(x18), .c(x01), .d(z16), .O(new_n73_));
  ...
  nor2   g32(.a(x22), .b(new_n70_), .O(new_n79_));
  nand4  g33(.a(new_n79_), .b(new_n69_), .c(new_n72_), .d(x18), .O(new_n80_));
  ...
  oai21  g41(.a(new_n88_), .b(z16), .c(new_n47_), .O(z15));
  zero   g42(.O(z00));
  zero   g43(.O(z01));
  zero   g44(.O(z08));
  zero   g45(.O(z14));
