...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n140_;
  nand2  g00(.a(x24), .b(x08), .O(new_n44_));
  ...
  nor3   g15(.a(x02), .b(x01), .c(x00), .O(new_n59_));
  nor2   g16(.a(x19), .b(new_n50_), .O(new_n60_));
  nand3  g17(.a(new_n60_), .b(new_n59_), .c(new_n49_), .O(new_n61_));
  nand3  g18(.a(x02), .b(x01), .c(x00), .O(new_n62_));
  inv1   g19(.a(new_n62_), .O(new_n63_));
  nor2   g20(.a(new_n56_), .b(x09), .O(new_n64_));
  nand4  g21(.a(new_n64_), .b(new_n63_), .c(x12), .d(x11), .O(new_n65_));
  nand3  g22(.a(new_n65_), .b(new_n61_), .c(new_n44_), .O(z03));
  inv1   g23(.a(x00), .O(new_n67_));
  inv1   g24(.a(x11), .O(new_n68_));
  inv1   g25(.a(x12), .O(new_n69_));
  nand4  g26(.a(new_n44_), .b(new_n69_), .c(new_n68_), .d(x10), .O(new_n70_));
  inv1   g27(.a(new_n70_), .O(new_n71_));
  nand4  g28(.a(new_n71_), .b(new_n46_), .c(x02), .d(x01), .O(new_n72_));
  nor2   g29(.a(new_n72_), .b(new_n67_), .O(z04));
  inv1   g30(.a(x01), .O(new_n74_));
  nand4  g31(.a(new_n44_), .b(x10), .c(x09), .d(x02), .O(new_n75_));
  nor3   g32(.a(new_n75_), .b(new_n74_), .c(new_n67_), .O(z05));
  nand3  g33(.a(x11), .b(x10), .c(new_n46_), .O(new_n77_));
  oai21  g34(.a(new_n77_), .b(new_n62_), .c(new_n44_), .O(z06));
  nand3  g35(.a(new_n64_), .b(new_n69_), .c(x11), .O(new_n79_));
  ...
  nand4  g43(.a(new_n86_), .b(x02), .c(new_n74_), .d(new_n67_), .O(new_n87_));
  ...
  nand4  g47(.a(new_n90_), .b(new_n50_), .c(x17), .d(new_n83_), .O(new_n91_));
  ...
  nor2   g58(.a(new_n50_), .b(new_n74_), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n101_), .c(new_n51_), .O(new_n103_));
  oai21  g60(.a(new_n100_), .b(new_n96_), .c(new_n103_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n94_), .c(new_n93_), .d(new_n67_), .O(new_n105_));
  nand2  g62(.a(new_n105_), .b(new_n44_), .O(z09));
  nor2   g63(.a(new_n94_), .b(new_n93_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n60_), .c(new_n101_), .d(x01), .O(new_n108_));
  nor2   g65(.a(x13), .b(new_n69_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n95_), .c(new_n68_), .O(new_n110_));
  ...
  nand3  g70(.a(new_n113_), .b(new_n44_), .c(new_n67_), .O(new_n114_));
  inv1   g71(.a(new_n114_), .O(z10));
  nand4  g72(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n51_), .O(new_n116_));
  nor2   g73(.a(new_n97_), .b(x14), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n93_), .c(x20), .d(new_n98_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n110_), .c(new_n116_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n94_), .c(new_n67_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n44_), .O(z11));
  nand2  g78(.a(x10), .b(x02), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(x01), .c(x00), .O(new_n123_));
  oai21  g80(.a(x19), .b(x02), .c(x23), .O(new_n124_));
  nand3  g81(.a(new_n51_), .b(x17), .c(new_n45_), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand3  g83(.a(new_n126_), .b(new_n74_), .c(new_n67_), .O(new_n127_));
  aoi21  g84(.a(new_n127_), .b(new_n123_), .c(x24), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(x09), .O(new_n129_));
  inv1   g86(.a(new_n129_), .O(z12));
  nand3  g87(.a(new_n44_), .b(new_n51_), .c(x17), .O(new_n131_));
  nor4   g88(.a(new_n131_), .b(x02), .c(x01), .d(x00), .O(z13));
  oai21  g89(.a(new_n57_), .b(new_n48_), .c(new_n44_), .O(z14));
  oai21  g90(.a(x10), .b(new_n74_), .c(x02), .O(new_n134_));
  nand2  g91(.a(new_n134_), .b(x00), .O(new_n135_));
  nand3  g92(.a(x19), .b(new_n45_), .c(new_n74_), .O(new_n136_));
  nand3  g93(.a(new_n136_), .b(new_n135_), .c(new_n44_), .O(z15));
  nand3  g94(.a(new_n44_), .b(x01), .c(new_n67_), .O(new_n138_));
  inv1   g95(.a(new_n138_), .O(z16));
  nand2  g96(.a(new_n95_), .b(new_n67_), .O(new_n140_));
  nand2  g97(.a(new_n140_), .b(new_n44_), .O(z17));
endmodule
