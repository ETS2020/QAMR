...
module FAU ( 
  ...
  aoi21  g36(.a(new_n79_), .b(x01), .c(new_n53_), .O(z07));
  inv1   g37(.a(x08), .O(new_n81_));
  inv1   g38(.a(x05), .O(new_n82_));
  inv1   g39(.a(x06), .O(new_n83_));
  inv1   g40(.a(x03), .O(new_n84_));
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n60_), .d(new_n53_), .O(new_n85_));
  ...
  nand3  g73(.a(new_n116_), .b(new_n92_), .c(new_n53_), .O(new_n117_));
  ...
  nand3  g78(.a(new_n65_), .b(x17), .c(new_n46_), .O(new_n122_));
  ...
  aoi21  g84(.a(new_n122_), .b(new_n53_), .c(x01), .O(z13));
  nand4  g85(.a(new_n54_), .b(new_n57_), .c(new_n47_), .d(new_n46_), .O(new_n129_));
  ...
  aoi21  g90(.a(new_n46_), .b(new_n53_), .c(x01), .O(z17));
endmodule
