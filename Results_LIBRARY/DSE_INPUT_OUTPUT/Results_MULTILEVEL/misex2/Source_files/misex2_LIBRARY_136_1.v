...
module FAU ( 
  ...
  nor2   g033(.a(new_n65_), .b(new_n55_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x09), .c(x02), .d(x01), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n46_), .O(z05));
  nand3  g036(.a(x11), .b(x10), .c(new_n49_), .O(new_n80_));
  oai21  g037(.a(new_n80_), .b(new_n66_), .c(new_n45_), .O(z06));
  nand3  g038(.a(new_n68_), .b(new_n74_), .c(x11), .O(new_n82_));
  ...
  oai21  g049(.a(new_n92_), .b(new_n90_), .c(new_n45_), .O(z08));
  inv1   g050(.a(x22), .O(new_n94_));
  nand3  g051(.a(new_n87_), .b(x12), .c(new_n73_), .O(new_n95_));
  ...
  nand4  g059(.a(new_n102_), .b(new_n94_), .c(new_n44_), .d(new_n46_), .O(new_n103_));
  inv1   g060(.a(new_n103_), .O(z09));
  nand3  g061(.a(new_n57_), .b(x18), .c(x01), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(x22), .c(x21), .d(new_n100_), .O(new_n107_));
  nand2  g064(.a(x02), .b(new_n47_), .O(new_n108_));
  ...
  nand2  g073(.a(x15), .b(new_n116_), .O(new_n117_));
  nand3  g074(.a(new_n44_), .b(x20), .c(new_n97_), .O(new_n118_));
  nor2   g075(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g076(.a(new_n94_), .b(x21), .c(new_n100_), .O(new_n120_));
  nor2   g077(.a(new_n120_), .b(new_n105_), .O(new_n121_));
  aoi21  g078(.a(new_n119_), .b(new_n111_), .c(new_n121_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(x00), .c(new_n45_), .O(z11));
  ...
  nand3  g084(.a(new_n57_), .b(x17), .c(new_n48_), .O(new_n128_));
  ...
  nand3  g092(.a(new_n52_), .b(new_n51_), .c(new_n55_), .O(new_n136_));
  oai21  g093(.a(new_n136_), .b(new_n50_), .c(new_n45_), .O(z14));
  ...
  nor3   g098(.a(new_n65_), .b(new_n47_), .c(x00), .O(z16));
