...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_,
    ...
    new_n74_, new_n75_, new_n78_, new_n79_, new_n82_;
  ...
  nand4  g30(.a(new_n67_), .b(new_n74_), .c(x21), .d(new_n71_), .O(new_n75_));
  aoi21  g31(.a(new_n75_), .b(x01), .c(x00), .O(z11));
  ...
  nand2  g36(.a(new_n48_), .b(x01), .O(new_n82_));
