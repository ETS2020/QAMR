...
module FAU ( 
  ...
  inv1   g16(.a(new_n50_), .O(new_n60_));
  nor2   g17(.a(new_n60_), .b(x02), .O(new_n61_));
  nand2  g18(.a(new_n61_), .b(x09), .O(new_n62_));
  inv1   g19(.a(new_n62_), .O(new_n63_));
  nand4  g20(.a(new_n63_), .b(new_n53_), .c(new_n52_), .d(new_n59_), .O(new_n64_));
  nor2   g21(.a(new_n64_), .b(x19), .O(z02));
  nand3  g22(.a(new_n61_), .b(x18), .c(new_n52_), .O(new_n66_));
  ...
  nand2  g35(.a(new_n54_), .b(x18), .O(new_n80_));
  ...
  nor2   g42(.a(new_n48_), .b(x01), .O(new_n87_));
  ...
  nand3  g68(.a(new_n54_), .b(x17), .c(new_n48_), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n112_), .c(x24), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(x09), .c(new_n45_), .O(new_n115_));
  nor2   g71(.a(new_n115_), .b(x00), .O(z12));
  oai21  g72(.a(new_n113_), .b(new_n60_), .c(new_n47_), .O(z13));
  nand2  g73(.a(new_n61_), .b(new_n49_), .O(new_n118_));
  inv1   g74(.a(new_n118_), .O(new_n119_));
  nand4  g75(.a(new_n119_), .b(new_n53_), .c(new_n52_), .d(new_n59_), .O(new_n120_));
  nor2   g76(.a(new_n120_), .b(x19), .O(z14));
  nand3  g77(.a(x19), .b(new_n48_), .c(new_n45_), .O(new_n122_));
  oai21  g78(.a(new_n87_), .b(new_n44_), .c(new_n122_), .O(z15));
  nand2  g79(.a(new_n50_), .b(x02), .O(new_n124_));
