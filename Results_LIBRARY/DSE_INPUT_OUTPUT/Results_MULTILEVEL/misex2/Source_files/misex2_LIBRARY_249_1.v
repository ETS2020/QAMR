...
module FAU ( 
  ...
  nor3   g12(.a(new_n51_), .b(new_n47_), .c(new_n55_), .O(new_n56_));
  nand4  g13(.a(new_n56_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n57_));
  nor2   g14(.a(new_n57_), .b(x19), .O(z01));
  inv1   g15(.a(x19), .O(new_n59_));
  nand4  g16(.a(new_n59_), .b(new_n46_), .c(new_n45_), .d(new_n47_), .O(new_n60_));
  inv1   g17(.a(new_n60_), .O(new_n61_));
  nand4  g18(.a(new_n61_), .b(x09), .c(new_n50_), .d(new_n48_), .O(new_n62_));
  aoi21  g19(.a(new_n62_), .b(new_n44_), .c(x01), .O(z02));
  nand3  g20(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n64_));
  nand4  g21(.a(new_n59_), .b(x18), .c(new_n45_), .d(new_n44_), .O(new_n65_));
  ...
  nand2  g25(.a(x11), .b(new_n49_), .O(new_n69_));
  inv1   g26(.a(x12), .O(new_n70_));
  nand4  g27(.a(new_n70_), .b(new_n44_), .c(x10), .d(new_n55_), .O(new_n71_));
  oai21  g28(.a(new_n71_), .b(new_n66_), .c(new_n69_), .O(z04));
  nand4  g29(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n73_));
  nor2   g30(.a(new_n73_), .b(new_n47_), .O(z05));
  nor4   g31(.a(new_n66_), .b(new_n44_), .c(new_n47_), .d(x09), .O(z06));
  nand2  g32(.a(new_n55_), .b(x01), .O(new_n76_));
  nand3  g33(.a(new_n70_), .b(x11), .c(x10), .O(new_n77_));
  oai22  g34(.a(new_n77_), .b(new_n76_), .c(x11), .d(x01), .O(new_n78_));
  ...
  nand4  g46(.a(new_n89_), .b(new_n46_), .c(x17), .d(new_n44_), .O(new_n90_));
  nor2   g47(.a(new_n90_), .b(new_n59_), .O(z08));
  inv1   g48(.a(x21), .O(new_n92_));
  inv1   g49(.a(x22), .O(new_n93_));
  nand2  g50(.a(x02), .b(new_n49_), .O(new_n94_));
  inv1   g51(.a(new_n94_), .O(new_n95_));
  nor2   g52(.a(x13), .b(new_n70_), .O(new_n96_));
  ...
  nor2   g59(.a(new_n46_), .b(new_n49_), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(new_n102_), .c(new_n59_), .O(new_n104_));
  oai21  g61(.a(new_n101_), .b(new_n97_), .c(new_n104_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n93_), .c(new_n92_), .d(new_n48_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n69_), .O(z09));
  nand3  g64(.a(new_n59_), .b(x18), .c(x01), .O(new_n108_));
  nor4   g65(.a(new_n108_), .b(new_n93_), .c(new_n92_), .d(x20), .O(new_n109_));
  nor4   g66(.a(new_n94_), .b(x14), .c(x13), .d(new_n70_), .O(new_n110_));
  nand3  g67(.a(new_n93_), .b(new_n92_), .c(x20), .O(new_n111_));
  nor3   g68(.a(new_n111_), .b(new_n100_), .c(new_n99_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n110_), .c(new_n109_), .O(new_n113_));
  oai21  g70(.a(new_n113_), .b(x00), .c(new_n69_), .O(z10));
  nand4  g71(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n59_), .O(new_n115_));
  nand3  g72(.a(new_n96_), .b(new_n95_), .c(new_n44_), .O(new_n116_));
  nor2   g73(.a(new_n99_), .b(x14), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n92_), .c(x20), .d(new_n100_), .O(new_n118_));
  ...
  aoi21  g78(.a(x10), .b(x02), .c(new_n49_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(x00), .O(new_n123_));
  oai21  g80(.a(x19), .b(x02), .c(x23), .O(new_n124_));
  nand3  g81(.a(new_n59_), .b(x17), .c(new_n50_), .O(new_n125_));
  ...
  nand2  g86(.a(new_n129_), .b(new_n69_), .O(z12));
  nor4   g87(.a(new_n51_), .b(x19), .c(new_n45_), .d(x11), .O(z13));
  nand4  g88(.a(new_n61_), .b(new_n55_), .c(new_n50_), .d(new_n48_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g90(.a(new_n44_), .b(new_n50_), .c(new_n122_), .O(new_n134_));
  nand4  g91(.a(x19), .b(new_n44_), .c(new_n50_), .d(new_n49_), .O(new_n135_));
  oai21  g92(.a(new_n134_), .b(new_n48_), .c(new_n135_), .O(z15));
  oai21  g93(.a(new_n49_), .b(x00), .c(new_n69_), .O(z16));
  nand4  g94(.a(new_n44_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n138_));
