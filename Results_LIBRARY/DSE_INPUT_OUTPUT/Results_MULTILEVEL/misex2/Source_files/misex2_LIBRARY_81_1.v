...
module FAU ( 
  ...
  nand4  g52(.a(new_n95_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n96_));
  ...
  oai22  g70(.a(new_n113_), .b(new_n46_), .c(new_n60_), .d(x00), .O(z12));
  nand2  g71(.a(new_n47_), .b(x17), .O(new_n115_));
  nor2   g72(.a(new_n115_), .b(x19), .O(z13));
  nor3   g73(.a(x10), .b(x09), .c(x02), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n63_), .c(new_n45_), .d(new_n44_), .O(new_n118_));
  aoi21  g75(.a(new_n118_), .b(new_n60_), .c(x00), .O(z14));
  oai21  g76(.a(new_n56_), .b(new_n59_), .c(x01), .O(new_n120_));
  oai21  g77(.a(x19), .b(x00), .c(new_n61_), .O(new_n121_));
