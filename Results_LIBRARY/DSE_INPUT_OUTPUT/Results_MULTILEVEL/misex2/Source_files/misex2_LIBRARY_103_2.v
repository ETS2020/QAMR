...
module FAU ( 
  ...
  nor2   g026(.a(new_n69_), .b(new_n59_), .O(new_n70_));
  nand3  g027(.a(new_n70_), .b(x15), .c(x12), .O(new_n71_));
  oai22  g028(.a(new_n71_), .b(new_n68_), .c(new_n66_), .d(new_n64_), .O(z03));
  inv1   g029(.a(x12), .O(new_n73_));
  nand3  g030(.a(x02), .b(x01), .c(x00), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x09), .O(new_n75_));
  nand4  g032(.a(new_n75_), .b(new_n73_), .c(new_n69_), .d(x10), .O(new_n76_));
  nor2   g033(.a(new_n76_), .b(new_n53_), .O(z04));
  nor4   g034(.a(new_n74_), .b(new_n53_), .c(new_n59_), .d(new_n47_), .O(z05));
  nand4  g035(.a(new_n70_), .b(new_n47_), .c(x02), .d(x00), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(x15), .c(new_n63_), .O(z06));
  nand2  g037(.a(x10), .b(new_n47_), .O(new_n81_));
  nand3  g038(.a(x15), .b(new_n73_), .c(x11), .O(new_n82_));
  ...
  nand4  g058(.a(x20), .b(new_n101_), .c(new_n53_), .d(new_n100_), .O(new_n102_));
  ...
  nand3  g067(.a(new_n110_), .b(new_n65_), .c(x01), .O(new_n111_));
  nor2   g068(.a(x13), .b(new_n73_), .O(new_n112_));
  nand3  g069(.a(new_n112_), .b(new_n86_), .c(new_n69_), .O(new_n113_));
  ...
  nand3  g073(.a(new_n116_), .b(x15), .c(new_n62_), .O(new_n117_));
  inv1   g074(.a(new_n117_), .O(z10));
  nand3  g075(.a(x21), .b(new_n104_), .c(new_n56_), .O(new_n119_));
  nand4  g076(.a(x12), .b(new_n69_), .c(x02), .d(new_n63_), .O(new_n120_));
  ...
  nand4  g080(.a(new_n123_), .b(new_n97_), .c(x15), .d(new_n62_), .O(new_n124_));
  ...
  aoi22  g096(.a(new_n54_), .b(x00), .c(x19), .d(new_n63_), .O(new_n140_));
  nand3  g097(.a(new_n67_), .b(x15), .c(new_n59_), .O(new_n141_));
  oai21  g098(.a(new_n140_), .b(x02), .c(new_n141_), .O(z15));
  aoi21  g099(.a(x15), .b(x00), .c(new_n63_), .O(z16));
