...
module FAU ( 
  ...
  nand3  g008(.a(new_n51_), .b(new_n44_), .c(x10), .O(new_n52_));
  oai21  g009(.a(new_n52_), .b(new_n50_), .c(new_n46_), .O(z00));
  inv1   g010(.a(x18), .O(new_n54_));
  nand3  g011(.a(new_n49_), .b(x09), .c(new_n47_), .O(new_n55_));
  inv1   g012(.a(new_n55_), .O(new_n56_));
  nand4  g013(.a(new_n56_), .b(new_n54_), .c(new_n44_), .d(x10), .O(new_n57_));
  nor2   g014(.a(new_n57_), .b(x19), .O(z01));
  inv1   g015(.a(x10), .O(new_n59_));
  nand4  g016(.a(new_n56_), .b(new_n54_), .c(new_n44_), .d(new_n59_), .O(new_n60_));
  nor2   g017(.a(new_n60_), .b(x19), .O(z02));
  nand4  g018(.a(new_n46_), .b(x12), .c(x11), .d(x10), .O(new_n62_));
  nor2   g019(.a(new_n62_), .b(x09), .O(new_n63_));
  ...
  nand4  g028(.a(new_n71_), .b(new_n70_), .c(x10), .d(new_n48_), .O(new_n72_));
  oai21  g029(.a(new_n72_), .b(new_n69_), .c(new_n46_), .O(z04));
  inv1   g030(.a(x00), .O(new_n74_));
  nor2   g031(.a(new_n45_), .b(new_n59_), .O(new_n75_));
  ...
  oai21  g035(.a(new_n78_), .b(new_n69_), .c(new_n46_), .O(z06));
  nand4  g036(.a(new_n71_), .b(x11), .c(x10), .d(new_n48_), .O(new_n80_));
  ...
  nand3  g045(.a(x19), .b(new_n54_), .c(new_n88_), .O(new_n89_));
  inv1   g046(.a(new_n89_), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n87_), .c(new_n86_), .d(new_n49_), .O(new_n91_));
  aoi21  g048(.a(new_n91_), .b(x13), .c(new_n44_), .O(z08));
  ...
  nor2   g059(.a(new_n54_), .b(new_n102_), .O(new_n103_));
  nand3  g060(.a(new_n103_), .b(new_n101_), .c(new_n65_), .O(new_n104_));
  oai21  g061(.a(new_n100_), .b(new_n96_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n94_), .c(new_n93_), .d(new_n74_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n46_), .O(z09));
  nand4  g064(.a(new_n46_), .b(x22), .c(x21), .d(new_n101_), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n65_), .c(x18), .d(x01), .O(new_n110_));
  nand3  g067(.a(new_n70_), .b(x02), .c(new_n102_), .O(new_n111_));
  inv1   g068(.a(new_n111_), .O(new_n112_));
  nand3  g069(.a(new_n44_), .b(x16), .c(x15), .O(new_n113_));
  nand3  g070(.a(new_n94_), .b(new_n93_), .c(x20), .O(new_n114_));
  nor2   g071(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand4  g072(.a(new_n115_), .b(new_n112_), .c(new_n99_), .d(x12), .O(new_n116_));
  aoi21  g073(.a(new_n116_), .b(new_n110_), .c(x00), .O(z10));
  nand4  g074(.a(new_n103_), .b(x21), .c(new_n101_), .d(new_n65_), .O(new_n118_));
  nor2   g075(.a(x13), .b(new_n71_), .O(new_n119_));
  nand3  g076(.a(new_n119_), .b(new_n95_), .c(new_n70_), .O(new_n120_));
  nor2   g077(.a(new_n97_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n93_), .c(x20), .d(new_n98_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n120_), .c(new_n118_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n94_), .c(new_n74_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n49_), .b(x23), .c(x02), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n46_), .O(new_n131_));
  inv1   g088(.a(x23), .O(new_n132_));
  oai21  g089(.a(x19), .b(x02), .c(new_n132_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(x17), .c(x13), .O(new_n134_));
  nand3  g091(.a(x23), .b(x19), .c(new_n44_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n102_), .c(new_n74_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n131_), .O(new_n138_));
  nand3  g095(.a(new_n138_), .b(new_n126_), .c(x09), .O(new_n139_));
  inv1   g096(.a(new_n139_), .O(z12));
  nand4  g097(.a(new_n49_), .b(x17), .c(x13), .d(new_n47_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x19), .O(z13));
  nand3  g099(.a(new_n51_), .b(new_n44_), .c(new_n59_), .O(new_n143_));
  oai21  g100(.a(new_n143_), .b(new_n50_), .c(new_n46_), .O(z14));
  oai21  g101(.a(x10), .b(new_n102_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n47_), .c(new_n102_), .O(new_n147_));
  aoi21  g104(.a(new_n147_), .b(new_n146_), .c(new_n45_), .O(z15));
  nor3   g105(.a(new_n45_), .b(new_n102_), .c(x00), .O(z16));
  nand2  g106(.a(new_n95_), .b(new_n74_), .O(new_n150_));
  nand2  g107(.a(new_n150_), .b(new_n46_), .O(z17));
endmodule
