...
module FAU ( 
  ...
  nor2   g54(.a(new_n51_), .b(new_n52_), .O(new_n98_));
  inv1   g55(.a(x20), .O(new_n99_));
  nand2  g56(.a(new_n99_), .b(new_n64_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(new_n101_));
  nand2  g58(.a(new_n101_), .b(new_n98_), .O(new_n102_));
  oai21  g59(.a(new_n97_), .b(new_n93_), .c(new_n102_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n90_), .c(new_n89_), .d(new_n44_), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(z09));
  nand4  g62(.a(new_n96_), .b(x12), .c(new_n91_), .d(x02), .O(new_n106_));
  nor2   g63(.a(x22), .b(x21), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(x20), .c(x16), .d(x15), .O(new_n108_));
  oai21  g65(.a(new_n108_), .b(new_n106_), .c(new_n44_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n52_), .O(new_n110_));
  nor2   g67(.a(new_n90_), .b(new_n89_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n101_), .c(new_n98_), .d(new_n44_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n110_), .O(z10));
  nand4  g70(.a(new_n98_), .b(x21), .c(new_n99_), .d(new_n64_), .O(new_n114_));
  inv1   g71(.a(x13), .O(new_n115_));
  nand4  g72(.a(new_n92_), .b(new_n115_), .c(x12), .d(new_n91_), .O(new_n116_));
  nor2   g73(.a(new_n94_), .b(x14), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n89_), .c(x20), .d(new_n95_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n116_), .c(new_n114_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n90_), .c(new_n44_), .O(new_n120_));
  ...
  nand4  g88(.a(new_n46_), .b(new_n45_), .c(new_n52_), .d(new_n44_), .O(new_n132_));
  inv1   g89(.a(new_n132_), .O(new_n133_));
  nand4  g90(.a(new_n133_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n134_));
  nor2   g91(.a(new_n134_), .b(x19), .O(z14));
  aoi21  g92(.a(x19), .b(new_n45_), .c(x00), .O(new_n136_));
  nand2  g93(.a(new_n122_), .b(x00), .O(new_n137_));
  oai21  g94(.a(new_n136_), .b(x01), .c(new_n137_), .O(z15));
  xor2a  g95(.a(x01), .b(x00), .O(z16));
  aoi21  g96(.a(new_n45_), .b(new_n44_), .c(x01), .O(z17));
endmodule
