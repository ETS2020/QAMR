...
module FAU ( 
  ...
  nor2   g40(.a(x03), .b(new_n53_), .O(new_n84_));
  ...
  aoi21  g45(.a(new_n88_), .b(new_n52_), .c(x00), .O(z08));
  ...
  nor3   g51(.a(new_n94_), .b(x11), .c(new_n53_), .O(new_n95_));
  ...
  aoi21  g57(.a(new_n100_), .b(new_n52_), .c(x00), .O(z09));
  nand4  g58(.a(new_n99_), .b(new_n95_), .c(x16), .d(x15), .O(new_n102_));
  aoi21  g59(.a(new_n102_), .b(new_n52_), .c(x00), .O(z10));
  inv1   g60(.a(x11), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(x02), .c(new_n52_), .d(new_n62_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n93_), .c(new_n92_), .d(x12), .O(new_n107_));
  nor2   g64(.a(new_n107_), .b(new_n90_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n96_), .c(x20), .d(new_n91_), .O(new_n109_));
  ...
  nand3  g70(.a(new_n63_), .b(x17), .c(new_n53_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n52_), .c(new_n62_), .O(new_n116_));
  ...
  nand4  g78(.a(new_n54_), .b(new_n57_), .c(new_n46_), .d(new_n53_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n52_), .c(x00), .O(z14));
  aoi21  g80(.a(new_n57_), .b(x01), .c(new_n53_), .O(new_n124_));
  nand3  g81(.a(x19), .b(new_n53_), .c(new_n52_), .O(new_n125_));
  oai21  g82(.a(new_n124_), .b(new_n62_), .c(new_n125_), .O(z15));
  nand3  g83(.a(x02), .b(new_n52_), .c(new_n62_), .O(new_n128_));
