...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n136_, new_n138_, new_n140_, new_n142_, new_n144_;
  ...
  nor2   g011(.a(new_n47_), .b(x02), .O(new_n55_));
  nand2  g012(.a(new_n55_), .b(new_n48_), .O(new_n56_));
  nor2   g013(.a(x19), .b(x18), .O(new_n57_));
  nand3  g014(.a(new_n57_), .b(new_n44_), .c(x10), .O(new_n58_));
  oai21  g015(.a(new_n58_), .b(new_n56_), .c(new_n54_), .O(z01));
  inv1   g016(.a(x01), .O(new_n60_));
  inv1   g017(.a(x00), .O(new_n61_));
  nand4  g018(.a(new_n57_), .b(new_n55_), .c(new_n44_), .d(new_n61_), .O(new_n62_));
  aoi21  g019(.a(new_n62_), .b(new_n60_), .c(x10), .O(z02));
  nand3  g020(.a(new_n46_), .b(new_n60_), .c(new_n61_), .O(new_n64_));
  ...
  nand4  g027(.a(new_n70_), .b(new_n47_), .c(x02), .d(x00), .O(new_n71_));
  aoi21  g028(.a(new_n71_), .b(x10), .c(new_n60_), .O(z04));
  nand3  g029(.a(x09), .b(x02), .c(x00), .O(new_n73_));
  aoi21  g030(.a(new_n73_), .b(x10), .c(new_n60_), .O(z05));
  nand4  g031(.a(x11), .b(new_n47_), .c(x02), .d(x00), .O(new_n75_));
  aoi21  g032(.a(new_n75_), .b(x10), .c(new_n60_), .O(z06));
  ...
  nand4  g042(.a(new_n85_), .b(x02), .c(new_n60_), .d(new_n61_), .O(new_n86_));
  ...
  nand4  g046(.a(new_n89_), .b(new_n45_), .c(x17), .d(new_n82_), .O(new_n90_));
  nor2   g047(.a(new_n90_), .b(new_n65_), .O(z08));
  inv1   g048(.a(x21), .O(new_n92_));
  inv1   g049(.a(x22), .O(new_n93_));
  inv1   g050(.a(x11), .O(new_n94_));
  nor2   g051(.a(new_n46_), .b(x01), .O(new_n95_));
  ...
  nand4  g060(.a(new_n103_), .b(new_n93_), .c(new_n92_), .d(new_n61_), .O(new_n104_));
  ...
  nand3  g067(.a(new_n110_), .b(x12), .c(new_n94_), .O(new_n111_));
  ...
  nand3  g072(.a(new_n93_), .b(new_n92_), .c(x20), .O(new_n116_));
  ...
  nand3  g076(.a(x18), .b(x10), .c(x01), .O(new_n120_));
  nand3  g077(.a(x21), .b(new_n107_), .c(new_n65_), .O(new_n121_));
  nor2   g078(.a(new_n97_), .b(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n92_), .c(x20), .d(new_n98_), .O(new_n123_));
  oai22  g080(.a(new_n123_), .b(new_n113_), .c(new_n121_), .d(new_n120_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n93_), .c(new_n61_), .O(new_n125_));
  inv1   g082(.a(new_n125_), .O(z11));
  inv1   g083(.a(x24), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(x09), .c(new_n46_), .d(x00), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(x10), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(x01), .O(new_n130_));
  oai21  g087(.a(x19), .b(x02), .c(x23), .O(new_n131_));
  nand3  g088(.a(new_n65_), .b(x17), .c(new_n46_), .O(new_n132_));
  aoi21  g089(.a(new_n132_), .b(new_n131_), .c(x24), .O(new_n133_));
  nand4  g090(.a(new_n133_), .b(x09), .c(new_n60_), .d(new_n61_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n130_), .O(z12));
  nand3  g092(.a(new_n48_), .b(x17), .c(new_n46_), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(x19), .O(z13));
  nand4  g094(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n53_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x19), .O(z14));
  aoi21  g096(.a(x19), .b(new_n60_), .c(x00), .O(new_n140_));
  oai21  g097(.a(new_n140_), .b(x02), .c(new_n54_), .O(z15));
  nand3  g098(.a(x10), .b(x01), .c(new_n61_), .O(new_n142_));
