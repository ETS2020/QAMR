...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_,
    ...
    new_n72_, new_n74_, new_n76_, new_n77_, new_n79_, new_n80_, new_n82_,
    new_n83_, new_n85_;
  ...
  nor2   g31(.a(x22), .b(new_n66_), .O(new_n76_));
  nand4  g32(.a(new_n76_), .b(new_n65_), .c(new_n69_), .d(x18), .O(new_n77_));
  aoi21  g33(.a(new_n77_), .b(x01), .c(x00), .O(z11));
  aoi21  g34(.a(x10), .b(x02), .c(x24), .O(new_n79_));
  nand3  g35(.a(new_n79_), .b(x09), .c(x01), .O(new_n80_));
  nor2   g36(.a(new_n80_), .b(new_n68_), .O(z12));
  inv1   g37(.a(x02), .O(new_n82_));
  aoi21  g38(.a(new_n48_), .b(x01), .c(new_n82_), .O(new_n83_));
