...
module FAU ( 
  ...
  nand3  g25(.a(new_n68_), .b(x10), .c(new_n64_), .O(new_n69_));
  ...
  nand4  g34(.a(new_n77_), .b(x10), .c(new_n64_), .d(x02), .O(new_n78_));
  ...
  nor2   g45(.a(new_n88_), .b(new_n61_), .O(z08));
  ...
  oai21  g52(.a(new_n95_), .b(new_n91_), .c(new_n46_), .O(new_n96_));
  ...
  oai21  g59(.a(new_n102_), .b(new_n91_), .c(new_n46_), .O(new_n103_));
  ...
  nand4  g66(.a(new_n109_), .b(new_n61_), .c(x18), .d(x01), .O(new_n110_));
  ...
  nand3  g73(.a(new_n116_), .b(new_n107_), .c(new_n46_), .O(new_n117_));
  inv1   g74(.a(new_n117_), .O(z11));
  inv1   g75(.a(x24), .O(new_n119_));
  aoi21  g76(.a(x10), .b(x02), .c(new_n46_), .O(new_n120_));
  oai21  g77(.a(x19), .b(x02), .c(x23), .O(new_n121_));
  nand3  g78(.a(new_n61_), .b(x17), .c(new_n48_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n121_), .c(x01), .O(new_n123_));
  oai21  g80(.a(new_n123_), .b(new_n120_), .c(new_n119_), .O(new_n124_));
  oai22  g81(.a(new_n124_), .b(new_n64_), .c(x01), .d(new_n46_), .O(z12));
  nor3   g82(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g83(.a(new_n54_), .b(new_n57_), .c(new_n64_), .d(new_n48_), .O(new_n127_));
  aoi21  g84(.a(new_n127_), .b(new_n46_), .c(x01), .O(z14));
  inv1   g85(.a(new_n120_), .O(new_n129_));
  aoi21  g86(.a(x19), .b(new_n48_), .c(x00), .O(new_n130_));
  oai21  g87(.a(new_n130_), .b(x01), .c(new_n129_), .O(z15));
  nor2   g88(.a(new_n47_), .b(x00), .O(z16));
  nand3  g89(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n133_));
