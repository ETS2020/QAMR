...
module FAU ( 
  ...
  nand3  g34(.a(new_n63_), .b(x11), .c(x10), .O(new_n78_));
  aoi21  g35(.a(new_n78_), .b(x01), .c(new_n56_), .O(z06));
  nor2   g36(.a(x12), .b(new_n71_), .O(new_n80_));
  nand3  g37(.a(new_n80_), .b(new_n63_), .c(x10), .O(new_n81_));
  ...
  nand4  g73(.a(new_n99_), .b(x12), .c(new_n71_), .d(x02), .O(new_n117_));
  ...
  nand4  g90(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n134_));
  nor2   g91(.a(new_n134_), .b(x19), .O(z14));
  nand2  g92(.a(x10), .b(x02), .O(new_n136_));
  nand3  g93(.a(new_n136_), .b(x01), .c(x00), .O(new_n137_));
  nor2   g94(.a(x01), .b(x00), .O(new_n138_));
  nand3  g95(.a(new_n138_), .b(x19), .c(new_n57_), .O(new_n139_));
  nand2  g96(.a(new_n139_), .b(new_n137_), .O(z15));
