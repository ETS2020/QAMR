...
module FAU ( 
  ...
  nand2  g007(.a(x23), .b(x06), .O(new_n51_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n51_), .c(new_n96_), .d(new_n95_), .O(new_n106_));
  ...
  nand2  g070(.a(new_n113_), .b(new_n88_), .O(new_n114_));
  ...
  nand4  g085(.a(new_n128_), .b(new_n51_), .c(x01), .d(x00), .O(new_n129_));
  inv1   g086(.a(x06), .O(new_n130_));
  nand2  g087(.a(x23), .b(new_n130_), .O(new_n131_));
  inv1   g088(.a(x23), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n50_), .c(new_n45_), .O(new_n133_));
  aoi21  g090(.a(new_n133_), .b(new_n131_), .c(new_n48_), .O(new_n134_));
  oai21  g091(.a(x19), .b(x02), .c(x23), .O(new_n135_));
  nor2   g092(.a(new_n135_), .b(x06), .O(new_n136_));
  oai21  g093(.a(new_n136_), .b(new_n134_), .c(new_n44_), .O(new_n137_));
  oai21  g094(.a(new_n137_), .b(x00), .c(new_n129_), .O(new_n138_));
  nand3  g095(.a(new_n138_), .b(new_n127_), .c(x09), .O(new_n139_));
  inv1   g096(.a(new_n139_), .O(z12));
  inv1   g097(.a(new_n56_), .O(new_n141_));
  nand3  g098(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n142_));
  oai21  g099(.a(new_n142_), .b(new_n141_), .c(new_n51_), .O(z13));
  nand3  g100(.a(new_n56_), .b(new_n46_), .c(new_n45_), .O(new_n144_));
  oai21  g101(.a(new_n144_), .b(new_n60_), .c(new_n51_), .O(z14));
  inv1   g102(.a(new_n51_), .O(new_n146_));
  ...
  aoi21  g106(.a(new_n149_), .b(new_n148_), .c(new_n146_), .O(z15));
  oai21  g107(.a(new_n44_), .b(x00), .c(new_n51_), .O(z16));
  nand4  g108(.a(new_n51_), .b(x02), .c(new_n44_), .d(new_n69_), .O(new_n152_));
