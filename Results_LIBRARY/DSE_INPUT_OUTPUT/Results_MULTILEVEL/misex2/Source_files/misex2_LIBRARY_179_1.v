...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n110_, new_n113_, new_n114_, new_n116_, new_n117_, new_n120_;
  ...
  nand4  g57(.a(new_n100_), .b(new_n89_), .c(x20), .d(x16), .O(new_n101_));
  nor2   g58(.a(new_n101_), .b(x22), .O(z10));
  nand4  g59(.a(new_n100_), .b(new_n89_), .c(x20), .d(new_n88_), .O(new_n103_));
  ...
  nand3  g64(.a(new_n62_), .b(x17), .c(new_n48_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n107_), .c(x00), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n106_), .c(new_n105_), .O(new_n110_));
  oai21  g67(.a(new_n110_), .b(new_n49_), .c(new_n80_), .O(z12));
  aoi21  g68(.a(new_n108_), .b(new_n47_), .c(x00), .O(z13));
  nor3   g69(.a(x10), .b(x09), .c(x02), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n62_), .c(new_n45_), .d(new_n44_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n47_), .c(x00), .O(z14));
  aoi21  g72(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n116_));
