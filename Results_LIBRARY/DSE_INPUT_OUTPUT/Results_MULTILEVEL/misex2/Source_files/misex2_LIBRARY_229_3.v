...
module FAU ( 
  ...
  aoi21  g24(.a(new_n55_), .b(new_n45_), .c(new_n44_), .O(z07));
  ...
  nand4  g33(.a(new_n77_), .b(new_n59_), .c(x17), .d(new_n70_), .O(new_n78_));
  nor2   g34(.a(new_n78_), .b(new_n65_), .O(z08));
  nand2  g35(.a(new_n65_), .b(x18), .O(new_n80_));
  ...
  nand3  g68(.a(new_n65_), .b(x17), .c(new_n55_), .O(new_n113_));
  ...
  oai21  g73(.a(new_n113_), .b(new_n117_), .c(new_n47_), .O(z13));
  ...
  oai21  g77(.a(new_n87_), .b(new_n44_), .c(new_n121_), .O(z15));
  nand2  g78(.a(new_n88_), .b(new_n47_), .O(z17));
  zero   g79(.O(z06));
