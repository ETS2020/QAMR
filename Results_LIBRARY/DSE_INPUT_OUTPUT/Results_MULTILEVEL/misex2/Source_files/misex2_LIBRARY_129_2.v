...
module FAU ( 
  ...
  oai21  g020(.a(new_n63_), .b(new_n62_), .c(x14), .O(new_n64_));
  ...
  nor2   g030(.a(new_n73_), .b(new_n44_), .O(z04));
  nor4   g031(.a(new_n71_), .b(new_n44_), .c(new_n57_), .d(new_n47_), .O(z05));
  ...
  aoi21  g036(.a(new_n79_), .b(x14), .c(new_n76_), .O(z06));
  ...
  nand2  g043(.a(new_n86_), .b(new_n77_), .O(new_n87_));
  ...
  nand4  g058(.a(x20), .b(new_n101_), .c(new_n100_), .d(new_n44_), .O(new_n102_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n77_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n45_), .O(z09));
  nand3  g064(.a(x18), .b(x14), .c(x01), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n103_), .c(x22), .d(x21), .O(new_n110_));
  nor2   g067(.a(x13), .b(new_n70_), .O(new_n111_));
  nand2  g068(.a(new_n111_), .b(new_n69_), .O(new_n112_));
  ...
  nand3  g075(.a(new_n111_), .b(new_n86_), .c(new_n69_), .O(new_n119_));
  inv1   g076(.a(x20), .O(new_n120_));
  nand4  g077(.a(new_n109_), .b(x21), .c(new_n120_), .d(new_n52_), .O(new_n121_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n97_), .c(new_n77_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n76_), .c(new_n77_), .O(new_n134_));
  ...
  oai21  g100(.a(x10), .b(new_n76_), .c(x02), .O(new_n144_));
  nand2  g101(.a(new_n144_), .b(x00), .O(new_n145_));
  nand3  g102(.a(x19), .b(new_n46_), .c(new_n76_), .O(new_n146_));
  nand3  g103(.a(new_n146_), .b(new_n145_), .c(new_n45_), .O(z15));
  aoi21  g104(.a(x14), .b(x00), .c(new_n76_), .O(z16));
