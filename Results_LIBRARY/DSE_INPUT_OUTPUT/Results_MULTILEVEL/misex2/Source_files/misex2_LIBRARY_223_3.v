...
module FAU ( 
  ...
  oai22  g026(.a(new_n69_), .b(new_n67_), .c(new_n65_), .d(new_n64_), .O(z03));
  nor2   g027(.a(x12), .b(x11), .O(new_n71_));
  nand4  g028(.a(new_n71_), .b(new_n66_), .c(x10), .d(x00), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(new_n68_), .c(new_n63_), .O(z04));
  nor2   g030(.a(new_n45_), .b(new_n62_), .O(new_n74_));
  nand3  g031(.a(new_n74_), .b(x10), .c(x09), .O(new_n75_));
  aoi21  g032(.a(new_n75_), .b(new_n68_), .c(new_n63_), .O(z05));
  nand4  g033(.a(new_n74_), .b(x11), .c(x10), .d(new_n46_), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(new_n68_), .c(new_n63_), .O(z06));
  nand2  g035(.a(x10), .b(new_n46_), .O(new_n79_));
  inv1   g036(.a(x12), .O(new_n80_));
  nand3  g037(.a(new_n68_), .b(new_n80_), .c(x11), .O(new_n81_));
  ...
  nand4  g049(.a(new_n92_), .b(new_n50_), .c(x17), .d(new_n85_), .O(new_n93_));
  ...
  nor2   g061(.a(new_n50_), .b(new_n63_), .O(new_n105_));
  nand3  g062(.a(new_n105_), .b(new_n104_), .c(new_n51_), .O(new_n106_));
  oai21  g063(.a(new_n103_), .b(new_n99_), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n96_), .c(new_n95_), .d(new_n68_), .O(new_n108_));
  nor2   g065(.a(new_n108_), .b(x00), .O(z09));
  nand3  g066(.a(new_n51_), .b(x18), .c(x01), .O(new_n110_));
  nand3  g067(.a(x22), .b(x21), .c(new_n104_), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand3  g069(.a(new_n101_), .b(new_n100_), .c(x12), .O(new_n113_));
  nor3   g070(.a(new_n113_), .b(x11), .c(new_n45_), .O(new_n114_));
  nand3  g071(.a(new_n96_), .b(new_n95_), .c(x20), .O(new_n115_));
  nor3   g072(.a(new_n115_), .b(new_n68_), .c(new_n102_), .O(new_n116_));
  aoi21  g073(.a(new_n116_), .b(new_n114_), .c(new_n112_), .O(new_n117_));
  oai21  g074(.a(new_n117_), .b(x00), .c(new_n44_), .O(z10));
  nand4  g075(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n51_), .O(new_n119_));
  nand4  g076(.a(new_n98_), .b(new_n100_), .c(x12), .d(new_n97_), .O(new_n120_));
  nor2   g077(.a(new_n102_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n95_), .c(x20), .d(new_n68_), .O(new_n122_));
  ...
  oai21  g092(.a(new_n129_), .b(new_n135_), .c(new_n44_), .O(z13));
  oai21  g093(.a(new_n60_), .b(new_n48_), .c(new_n44_), .O(z14));
  oai21  g094(.a(x10), .b(new_n63_), .c(x02), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(x00), .O(new_n139_));
  nand3  g096(.a(x19), .b(new_n45_), .c(new_n63_), .O(new_n140_));
  nand3  g097(.a(new_n140_), .b(new_n139_), .c(new_n44_), .O(z15));
  aoi21  g098(.a(new_n68_), .b(x00), .c(new_n63_), .O(z16));
  nand2  g099(.a(new_n98_), .b(new_n62_), .O(new_n143_));
