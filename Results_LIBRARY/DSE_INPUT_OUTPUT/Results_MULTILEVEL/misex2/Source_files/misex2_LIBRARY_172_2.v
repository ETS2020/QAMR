...
module FAU ( 
  ...
  nand4  g34(.a(new_n61_), .b(new_n77_), .c(x11), .d(x10), .O(new_n78_));
  ...
  oai21  g51(.a(new_n94_), .b(new_n90_), .c(new_n53_), .O(new_n95_));
  nand2  g52(.a(new_n95_), .b(new_n60_), .O(new_n96_));
  and2   g53(.a(x18), .b(x01), .O(new_n97_));
  nor2   g54(.a(x20), .b(x19), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n97_), .c(new_n93_), .d(new_n53_), .O(new_n99_));
  ...
  nand3  g64(.a(new_n107_), .b(x12), .c(new_n69_), .O(new_n108_));
  ...
  nor2   g70(.a(x13), .b(new_n77_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n106_), .c(new_n69_), .O(new_n115_));
  inv1   g72(.a(x20), .O(new_n116_));
  nand4  g73(.a(new_n97_), .b(x21), .c(new_n116_), .d(new_n65_), .O(new_n117_));
  ...
  nand3  g78(.a(new_n121_), .b(new_n113_), .c(new_n53_), .O(new_n122_));
  ...
  nand2  g86(.a(new_n60_), .b(x00), .O(new_n130_));
  oai21  g87(.a(new_n129_), .b(new_n47_), .c(new_n130_), .O(z12));
  nand3  g88(.a(new_n48_), .b(x17), .c(new_n46_), .O(new_n132_));
  nor2   g89(.a(new_n132_), .b(x19), .O(z13));
  nand4  g90(.a(new_n54_), .b(new_n57_), .c(new_n47_), .d(new_n46_), .O(new_n134_));
  aoi21  g91(.a(new_n134_), .b(new_n53_), .c(x01), .O(z14));
  ...
  nand2  g96(.a(x01), .b(new_n53_), .O(new_n140_));
  nand2  g97(.a(new_n140_), .b(new_n130_), .O(z16));
