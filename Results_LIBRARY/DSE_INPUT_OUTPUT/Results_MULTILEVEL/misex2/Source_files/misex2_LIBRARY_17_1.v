...
module FAU ( 
  ...
  nand3  g16(.a(new_n56_), .b(new_n44_), .c(new_n59_), .O(new_n60_));
  ...
  nand2  g27(.a(x03), .b(new_n47_), .O(new_n71_));
  ...
  nor3   g34(.a(new_n77_), .b(new_n59_), .c(new_n76_), .O(z05));
  ...
  nand4  g45(.a(new_n49_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n89_));
  inv1   g46(.a(new_n89_), .O(new_n90_));
  nand4  g47(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(x04), .O(new_n91_));
  nor2   g48(.a(new_n91_), .b(x07), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n45_), .c(x17), .d(new_n86_), .O(new_n93_));
  nor2   g50(.a(new_n93_), .b(new_n65_), .O(z08));
  inv1   g51(.a(x21), .O(new_n95_));
  inv1   g52(.a(x22), .O(new_n96_));
  nand4  g53(.a(x12), .b(new_n72_), .c(x02), .d(new_n47_), .O(new_n97_));
  ...
  nand4  g62(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n46_), .O(new_n106_));
  ...
  nor4   g68(.a(new_n111_), .b(x03), .c(new_n48_), .d(x01), .O(new_n112_));
  ...
  nand3  g75(.a(new_n118_), .b(x02), .c(new_n47_), .O(new_n119_));
  ...
  nand3  g79(.a(new_n122_), .b(new_n96_), .c(new_n46_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n71_), .O(z11));
  ...
  nand3  g84(.a(new_n65_), .b(x17), .c(new_n48_), .O(new_n128_));
  ...
  nand4  g90(.a(new_n65_), .b(x17), .c(new_n48_), .d(new_n46_), .O(new_n134_));
  aoi21  g91(.a(new_n134_), .b(new_n49_), .c(x01), .O(z13));
  nand4  g92(.a(new_n61_), .b(new_n76_), .c(new_n48_), .d(new_n46_), .O(new_n136_));
  aoi21  g93(.a(new_n136_), .b(new_n49_), .c(x01), .O(z14));
  aoi21  g94(.a(new_n49_), .b(new_n48_), .c(new_n125_), .O(new_n138_));
  nand4  g95(.a(x19), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n139_));
  oai21  g96(.a(new_n138_), .b(new_n46_), .c(new_n139_), .O(z15));
  oai21  g97(.a(new_n47_), .b(x00), .c(new_n71_), .O(z16));
