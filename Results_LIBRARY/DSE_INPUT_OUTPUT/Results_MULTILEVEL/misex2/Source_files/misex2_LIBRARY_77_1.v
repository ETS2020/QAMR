...
module FAU ( 
  ...
  nand2  g029(.a(x08), .b(new_n47_), .O(new_n73_));
  ...
  nor3   g035(.a(new_n78_), .b(new_n56_), .c(new_n54_), .O(z05));
  ...
  nand2  g043(.a(x02), .b(new_n46_), .O(new_n87_));
  ...
  nand3  g054(.a(new_n97_), .b(x12), .c(new_n74_), .O(new_n98_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n96_), .c(new_n95_), .d(new_n46_), .O(new_n107_));
  ...
  nand3  g067(.a(new_n49_), .b(x02), .c(new_n47_), .O(new_n111_));
  inv1   g068(.a(x13), .O(new_n112_));
  nand3  g069(.a(new_n112_), .b(x12), .c(new_n74_), .O(new_n113_));
  ...
  nand4  g075(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n65_), .O(new_n119_));
  nand3  g076(.a(x12), .b(new_n74_), .c(new_n49_), .O(new_n120_));
  inv1   g077(.a(new_n120_), .O(new_n121_));
  inv1   g078(.a(x14), .O(new_n122_));
  nand3  g079(.a(x15), .b(new_n122_), .c(new_n112_), .O(new_n123_));
  inv1   g080(.a(new_n123_), .O(new_n124_));
  nand3  g081(.a(new_n95_), .b(x20), .c(new_n100_), .O(new_n125_));
  inv1   g082(.a(new_n125_), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n124_), .c(new_n121_), .d(new_n97_), .O(new_n127_));
  ...
  nand3  g091(.a(new_n65_), .b(x17), .c(new_n48_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand4  g093(.a(new_n136_), .b(new_n49_), .c(new_n47_), .d(new_n46_), .O(new_n137_));
  ...
  nor3   g097(.a(new_n50_), .b(x19), .c(new_n44_), .O(z13));
  nor3   g098(.a(x09), .b(x02), .c(x00), .O(new_n142_));
  nand4  g099(.a(new_n142_), .b(new_n58_), .c(new_n44_), .d(new_n56_), .O(new_n143_));
  aoi21  g100(.a(new_n143_), .b(new_n49_), .c(x01), .O(z14));
  aoi21  g101(.a(new_n56_), .b(x01), .c(new_n48_), .O(new_n145_));
  aoi21  g102(.a(x19), .b(new_n48_), .c(x08), .O(new_n146_));
  oai22  g103(.a(new_n146_), .b(x01), .c(new_n145_), .d(new_n46_), .O(z15));
  nor2   g104(.a(new_n47_), .b(x00), .O(z16));
  nand4  g105(.a(new_n49_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n149_));
