...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n131_, new_n133_, new_n134_, new_n136_;
  ...
  nand4  g21(.a(new_n64_), .b(new_n51_), .c(x18), .d(new_n49_), .O(new_n65_));
  ...
  aoi21  g29(.a(new_n72_), .b(new_n59_), .c(new_n68_), .O(z05));
  inv1   g30(.a(x11), .O(new_n74_));
  nor3   g31(.a(new_n70_), .b(x21), .c(new_n74_), .O(z06));
  ...
  nand3  g53(.a(new_n96_), .b(x02), .c(new_n68_), .O(new_n97_));
  inv1   g54(.a(x16), .O(new_n98_));
  nor2   g55(.a(x15), .b(x14), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n59_), .c(x20), .d(new_n98_), .O(new_n100_));
  oai21  g57(.a(new_n100_), .b(new_n97_), .c(new_n93_), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n91_), .c(new_n67_), .O(new_n102_));
  nand2  g59(.a(new_n102_), .b(new_n44_), .O(z09));
  nand3  g60(.a(x02), .b(new_n68_), .c(new_n67_), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(new_n95_), .O(new_n105_));
  inv1   g62(.a(x15), .O(new_n106_));
  nor3   g63(.a(new_n98_), .b(new_n106_), .c(x14), .O(new_n107_));
  ...
  nand4  g68(.a(new_n74_), .b(x02), .c(new_n68_), .d(new_n67_), .O(new_n112_));
  inv1   g69(.a(new_n112_), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n111_), .c(new_n94_), .d(x12), .O(new_n114_));
  nor2   g71(.a(new_n114_), .b(new_n106_), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n59_), .c(x20), .d(new_n98_), .O(new_n116_));
  nor2   g73(.a(new_n116_), .b(x22), .O(z11));
  nand2  g74(.a(x10), .b(x02), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n59_), .c(x01), .d(x00), .O(new_n119_));
  ...
  nand3  g79(.a(new_n122_), .b(new_n68_), .c(new_n67_), .O(new_n123_));
  ...
  aoi22  g89(.a(new_n44_), .b(x00), .c(x19), .d(new_n68_), .O(new_n133_));
  nand3  g90(.a(new_n69_), .b(new_n59_), .c(new_n56_), .O(new_n134_));
  oai21  g91(.a(new_n133_), .b(x02), .c(new_n134_), .O(z15));
  nand3  g92(.a(new_n59_), .b(x01), .c(new_n67_), .O(new_n136_));
  inv1   g93(.a(new_n136_), .O(z16));
  nand2  g94(.a(new_n104_), .b(new_n44_), .O(z17));
endmodule
