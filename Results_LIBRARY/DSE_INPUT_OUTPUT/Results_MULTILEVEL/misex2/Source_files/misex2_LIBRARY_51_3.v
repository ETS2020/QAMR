...
module FAU ( 
  ...
  nand2  g010(.a(x06), .b(x01), .O(new_n54_));
  nand4  g011(.a(x09), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n55_));
  ...
  nand2  g038(.a(new_n81_), .b(new_n54_), .O(z07));
  nor2   g039(.a(new_n48_), .b(x01), .O(new_n83_));
  nand2  g040(.a(new_n83_), .b(new_n46_), .O(new_n84_));
  ...
  nor2   g046(.a(new_n56_), .b(x18), .O(new_n90_));
  ...
  nand4  g051(.a(x12), .b(new_n76_), .c(x02), .d(new_n47_), .O(new_n95_));
  ...
  nand4  g057(.a(new_n100_), .b(x18), .c(new_n62_), .d(x01), .O(new_n101_));
  oai21  g058(.a(new_n99_), .b(new_n95_), .c(new_n101_), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(new_n94_), .c(new_n93_), .d(new_n46_), .O(new_n103_));
  inv1   g060(.a(new_n103_), .O(z09));
  nor2   g061(.a(new_n45_), .b(x06), .O(new_n105_));
  ...
  nand3  g065(.a(new_n108_), .b(x12), .c(new_n76_), .O(new_n109_));
  ...
  nand4  g070(.a(new_n113_), .b(new_n111_), .c(new_n110_), .d(new_n83_), .O(new_n114_));
  aoi21  g071(.a(new_n114_), .b(new_n107_), .c(x00), .O(z10));
  nor2   g072(.a(x13), .b(new_n78_), .O(new_n116_));
  nand3  g073(.a(new_n116_), .b(new_n83_), .c(new_n76_), .O(new_n117_));
  inv1   g074(.a(x20), .O(new_n118_));
  and2   g075(.a(x18), .b(x01), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(x21), .c(new_n118_), .d(new_n56_), .O(new_n120_));
  ...
  nand2  g082(.a(new_n125_), .b(new_n54_), .O(z11));
  inv1   g083(.a(x24), .O(new_n127_));
  nand2  g084(.a(x10), .b(x02), .O(new_n128_));
  nand4  g085(.a(new_n128_), .b(new_n62_), .c(x01), .d(x00), .O(new_n129_));
  oai21  g086(.a(x19), .b(x02), .c(x23), .O(new_n130_));
  nand3  g087(.a(new_n56_), .b(x17), .c(new_n48_), .O(new_n131_));
  ...
  nand4  g095(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x19), .O(z14));
  aoi22  g097(.a(new_n54_), .b(x00), .c(x19), .d(new_n47_), .O(new_n141_));
  nand4  g098(.a(new_n59_), .b(new_n62_), .c(x01), .d(x00), .O(new_n142_));
  oai21  g099(.a(new_n141_), .b(x02), .c(new_n142_), .O(z15));
  aoi21  g100(.a(new_n62_), .b(x00), .c(new_n47_), .O(z16));
  nand2  g101(.a(new_n84_), .b(new_n54_), .O(z17));
endmodule
