...
module FAU ( 
  ...
  inv1   g026(.a(new_n60_), .O(new_n70_));
  nand4  g027(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(x10), .O(new_n71_));
  aoi21  g028(.a(new_n71_), .b(new_n59_), .c(new_n67_), .O(z04));
  nand4  g029(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n73_));
  aoi21  g030(.a(new_n73_), .b(new_n59_), .c(new_n67_), .O(z05));
  nand3  g031(.a(x02), .b(x01), .c(x00), .O(new_n75_));
  inv1   g032(.a(new_n75_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(x10), .c(new_n46_), .d(new_n59_), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n68_), .O(z06));
  nand2  g035(.a(new_n46_), .b(new_n59_), .O(new_n79_));
  ...
  nand4  g046(.a(new_n89_), .b(new_n59_), .c(new_n85_), .d(x04), .O(new_n90_));
  nor2   g047(.a(new_n90_), .b(x07), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(new_n50_), .c(x17), .d(new_n84_), .O(new_n92_));
  ...
  nand3  g053(.a(new_n96_), .b(x12), .c(new_n68_), .O(new_n97_));
  ...
  nand4  g059(.a(new_n102_), .b(new_n51_), .c(x18), .d(x01), .O(new_n103_));
  ...
  nand3  g067(.a(new_n110_), .b(x12), .c(new_n68_), .O(new_n111_));
  ...
  nor2   g076(.a(new_n50_), .b(x06), .O(new_n120_));
  nor2   g077(.a(new_n94_), .b(x20), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n120_), .c(new_n51_), .d(x01), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n95_), .c(new_n86_), .O(new_n126_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n67_), .c(new_n86_), .O(new_n133_));
  ...
  nand3  g093(.a(new_n47_), .b(x17), .c(new_n45_), .O(new_n137_));
  ...
  oai21  g099(.a(x10), .b(new_n67_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n45_), .c(new_n67_), .O(new_n145_));
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n44_), .O(z15));
  nand3  g103(.a(new_n59_), .b(x01), .c(new_n86_), .O(new_n147_));
  inv1   g104(.a(new_n147_), .O(z16));
  nand2  g105(.a(new_n96_), .b(new_n86_), .O(new_n149_));
