...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n123_, new_n126_, new_n128_, new_n131_;
  ...
  inv1   g30(.a(new_n71_), .O(new_n74_));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n60_), .d(new_n44_), .O(new_n85_));
  ...
  nor3   g56(.a(new_n51_), .b(new_n60_), .c(x00), .O(new_n100_));
  ...
  nand2  g68(.a(new_n111_), .b(new_n60_), .O(new_n112_));
  ...
  nand4  g82(.a(new_n47_), .b(new_n57_), .c(new_n46_), .d(new_n45_), .O(new_n126_));
  aoi21  g83(.a(new_n126_), .b(new_n44_), .c(x01), .O(z14));
  nand3  g84(.a(new_n52_), .b(x19), .c(new_n45_), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(new_n117_), .O(z15));
