...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n115_, new_n116_, new_n118_, new_n120_, new_n122_, new_n125_;
  ...
  nor2   g24(.a(new_n46_), .b(x01), .O(new_n68_));
  nand2  g25(.a(new_n68_), .b(new_n61_), .O(new_n69_));
  inv1   g26(.a(x03), .O(new_n70_));
  inv1   g27(.a(x05), .O(new_n71_));
  nand3  g28(.a(new_n71_), .b(x04), .c(new_n70_), .O(new_n72_));
  nor2   g29(.a(new_n72_), .b(new_n69_), .O(new_n73_));
  nor3   g30(.a(x08), .b(x07), .c(x06), .O(new_n74_));
  nand3  g31(.a(x19), .b(new_n45_), .c(x17), .O(new_n75_));
  inv1   g32(.a(new_n75_), .O(new_n76_));
  nand3  g33(.a(new_n76_), .b(new_n74_), .c(new_n73_), .O(new_n77_));
  nand2  g34(.a(new_n77_), .b(new_n53_), .O(z08));
  nand2  g35(.a(new_n55_), .b(x18), .O(new_n79_));
  ...
  oai21  g40(.a(new_n83_), .b(new_n79_), .c(new_n61_), .O(new_n84_));
  nand2  g41(.a(new_n84_), .b(x01), .O(new_n85_));
  inv1   g42(.a(x11), .O(new_n86_));
  inv1   g43(.a(x12), .O(new_n87_));
  nor2   g44(.a(x13), .b(new_n87_), .O(new_n88_));
  nand2  g45(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nor2   g46(.a(new_n89_), .b(new_n69_), .O(new_n90_));
  nor3   g47(.a(x16), .b(x15), .c(x14), .O(new_n91_));
  nand3  g48(.a(new_n82_), .b(new_n81_), .c(x20), .O(new_n92_));
  inv1   g49(.a(new_n92_), .O(new_n93_));
  nand3  g50(.a(new_n93_), .b(new_n91_), .c(new_n90_), .O(new_n94_));
  nand2  g51(.a(new_n94_), .b(new_n85_), .O(z09));
  nand3  g52(.a(x22), .b(x21), .c(new_n80_), .O(new_n96_));
  oai21  g53(.a(new_n96_), .b(new_n79_), .c(new_n61_), .O(new_n97_));
  ...
  nand3  g58(.a(new_n101_), .b(new_n93_), .c(new_n90_), .O(new_n102_));
  nand2  g59(.a(new_n102_), .b(new_n98_), .O(z10));
  and2   g60(.a(x18), .b(x01), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(x21), .c(new_n80_), .d(new_n55_), .O(new_n105_));
  nand3  g62(.a(new_n88_), .b(new_n68_), .c(new_n86_), .O(new_n106_));
  nor2   g63(.a(new_n99_), .b(x14), .O(new_n107_));
  nor2   g64(.a(x21), .b(new_n80_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n107_), .c(new_n100_), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n106_), .c(new_n105_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n82_), .c(new_n61_), .O(new_n111_));
  ...
  nand3  g72(.a(new_n115_), .b(x09), .c(new_n62_), .O(new_n116_));
  nor2   g73(.a(new_n116_), .b(x00), .O(z12));
  nand3  g74(.a(new_n48_), .b(x17), .c(new_n46_), .O(new_n118_));
  nor2   g75(.a(new_n118_), .b(x19), .O(z13));
  nand4  g76(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n120_));
  ...
  nand2  g81(.a(new_n48_), .b(x02), .O(new_n125_));
  inv1   g82(.a(new_n125_), .O(z17));
  inv1   g83(.a(new_n53_), .O(z05));
  inv1   g84(.a(new_n53_), .O(z06));
endmodule
