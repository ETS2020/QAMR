...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n76_, new_n78_, new_n80_, new_n82_, new_n83_, new_n84_, new_n85_,
  ...
  or2    g08(.a(new_n51_), .b(x09), .O(new_n52_));
  ...
  nor3   g13(.a(new_n51_), .b(new_n47_), .c(new_n56_), .O(new_n57_));
  ...
  nand3  g36(.a(x11), .b(x10), .c(new_n56_), .O(new_n80_));
  oai21  g37(.a(new_n80_), .b(new_n69_), .c(new_n73_), .O(z06));
  nand2  g38(.a(new_n56_), .b(x01), .O(new_n82_));
  nand3  g39(.a(new_n75_), .b(x11), .c(x10), .O(new_n83_));
  oai22  g40(.a(new_n83_), .b(new_n82_), .c(x16), .d(x01), .O(new_n84_));
  nand3  g41(.a(new_n84_), .b(x02), .c(x00), .O(new_n85_));
  inv1   g42(.a(new_n85_), .O(z07));
  inv1   g43(.a(x05), .O(new_n87_));
  inv1   g44(.a(x06), .O(new_n88_));
  inv1   g45(.a(x07), .O(new_n89_));
  inv1   g46(.a(x04), .O(new_n90_));
  inv1   g47(.a(x03), .O(new_n91_));
  nand4  g48(.a(new_n91_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n92_));
  nor2   g49(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(new_n89_), .c(new_n88_), .d(new_n87_), .O(new_n94_));
  nor2   g51(.a(new_n94_), .b(x08), .O(new_n95_));
  nand4  g52(.a(new_n95_), .b(new_n46_), .c(x17), .d(new_n44_), .O(new_n96_));
  nor2   g53(.a(new_n96_), .b(new_n60_), .O(z08));
  inv1   g54(.a(x21), .O(new_n98_));
  inv1   g55(.a(x22), .O(new_n99_));
  nand4  g56(.a(x12), .b(new_n74_), .c(x02), .d(new_n49_), .O(new_n100_));
  inv1   g57(.a(x15), .O(new_n101_));
  nor2   g58(.a(x14), .b(x13), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(x20), .c(new_n44_), .d(new_n101_), .O(new_n103_));
  inv1   g60(.a(x20), .O(new_n104_));
  nand2  g61(.a(x18), .b(x01), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n104_), .c(new_n60_), .O(new_n107_));
  oai21  g64(.a(new_n103_), .b(new_n100_), .c(new_n107_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n99_), .c(new_n98_), .d(new_n48_), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(z09));
  nand2  g67(.a(new_n106_), .b(new_n48_), .O(new_n111_));
  nand4  g68(.a(x22), .b(x21), .c(new_n104_), .d(new_n60_), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n111_), .c(new_n73_), .O(z10));
  nand3  g70(.a(x21), .b(new_n104_), .c(new_n60_), .O(new_n114_));
  nand4  g71(.a(new_n102_), .b(new_n98_), .c(x20), .d(x15), .O(new_n115_));
  oai22  g72(.a(new_n115_), .b(new_n100_), .c(new_n114_), .d(new_n105_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n99_), .c(new_n48_), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n73_), .O(z11));
  ...
  nand3  g78(.a(new_n60_), .b(x17), .c(new_n50_), .O(new_n122_));
  ...
  nand4  g84(.a(new_n60_), .b(x17), .c(new_n50_), .d(new_n48_), .O(new_n128_));
  aoi21  g85(.a(new_n128_), .b(new_n44_), .c(x01), .O(z13));
  nor2   g86(.a(new_n52_), .b(x10), .O(new_n130_));
  nand4  g87(.a(new_n130_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n131_));
  nor2   g88(.a(new_n131_), .b(x19), .O(z14));
  aoi21  g89(.a(new_n44_), .b(new_n50_), .c(new_n119_), .O(new_n133_));
  nand4  g90(.a(x19), .b(new_n44_), .c(new_n50_), .d(new_n49_), .O(new_n134_));
  oai21  g91(.a(new_n133_), .b(new_n48_), .c(new_n134_), .O(z15));
  nor2   g92(.a(new_n49_), .b(x00), .O(z16));
  nand4  g93(.a(new_n44_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n137_));
