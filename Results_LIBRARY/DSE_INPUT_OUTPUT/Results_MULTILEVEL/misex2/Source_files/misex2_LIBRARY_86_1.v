...
module FAU ( 
  ...
  nand4  g33(.a(new_n66_), .b(x11), .c(x10), .d(new_n46_), .O(new_n77_));
  ...
  nand4  g47(.a(new_n65_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n91_));
  ...
  nand3  g53(.a(new_n90_), .b(new_n89_), .c(x12), .O(new_n97_));
  nor3   g54(.a(new_n97_), .b(x11), .c(new_n45_), .O(new_n98_));
  inv1   g55(.a(x15), .O(new_n99_));
  nor2   g56(.a(new_n87_), .b(new_n99_), .O(new_n100_));
  nor2   g57(.a(x22), .b(x21), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n100_), .c(new_n98_), .d(x20), .O(new_n102_));
  aoi21  g59(.a(new_n102_), .b(new_n44_), .c(x00), .O(z10));
  nor2   g60(.a(new_n93_), .b(new_n99_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n88_), .c(x20), .d(new_n87_), .O(new_n105_));
  ...
  nand4  g71(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n52_), .O(new_n115_));
