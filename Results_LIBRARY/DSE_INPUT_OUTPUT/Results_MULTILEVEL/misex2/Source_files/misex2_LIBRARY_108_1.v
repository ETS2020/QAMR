...
module FAU ( 
  ...
  inv1   g010(.a(new_n48_), .O(new_n54_));
  nor4   g011(.a(new_n54_), .b(new_n47_), .c(new_n53_), .d(x02), .O(new_n55_));
  ...
  nand4  g020(.a(new_n63_), .b(new_n46_), .c(new_n59_), .d(new_n58_), .O(new_n64_));
  aoi21  g021(.a(new_n64_), .b(x06), .c(new_n47_), .O(z02));
  nand2  g022(.a(x09), .b(new_n53_), .O(new_n66_));
  nand4  g023(.a(new_n66_), .b(new_n61_), .c(x18), .d(new_n44_), .O(new_n67_));
  inv1   g024(.a(new_n67_), .O(new_n68_));
  nand4  g025(.a(new_n68_), .b(new_n46_), .c(new_n59_), .d(new_n58_), .O(new_n69_));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n59_), .d(new_n58_), .O(new_n92_));
  nor2   g049(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  nand4  g050(.a(new_n93_), .b(new_n89_), .c(new_n53_), .d(new_n88_), .O(new_n94_));
  nor2   g051(.a(new_n94_), .b(x08), .O(new_n95_));
  nand4  g052(.a(new_n95_), .b(new_n45_), .c(x17), .d(new_n47_), .O(new_n96_));
  nor2   g053(.a(new_n96_), .b(new_n61_), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  nand2  g056(.a(x02), .b(new_n59_), .O(new_n100_));
  inv1   g057(.a(new_n100_), .O(new_n101_));
  nand3  g058(.a(new_n101_), .b(x12), .c(new_n74_), .O(new_n102_));
  ...
  oai21  g077(.a(new_n120_), .b(x00), .c(new_n66_), .O(z10));
  nand4  g078(.a(new_n108_), .b(x21), .c(new_n107_), .d(new_n61_), .O(new_n122_));
  ...
  nand4  g082(.a(new_n125_), .b(new_n66_), .c(new_n99_), .d(new_n58_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n59_), .c(new_n58_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n128_), .O(new_n136_));
  aoi21  g093(.a(new_n136_), .b(x06), .c(new_n47_), .O(z12));
  oai21  g094(.a(new_n132_), .b(new_n54_), .c(new_n66_), .O(z13));
  nand3  g095(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n139_));
  oai21  g096(.a(new_n139_), .b(new_n62_), .c(new_n66_), .O(z14));
  oai21  g097(.a(x10), .b(new_n59_), .c(x02), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(x00), .O(new_n142_));
  nand3  g099(.a(x19), .b(new_n46_), .c(new_n59_), .O(new_n143_));
  nand3  g100(.a(new_n143_), .b(new_n142_), .c(new_n66_), .O(z15));
  oai21  g101(.a(new_n59_), .b(x00), .c(new_n66_), .O(z16));
  nand4  g102(.a(new_n66_), .b(x02), .c(new_n59_), .d(new_n58_), .O(new_n146_));
