...
module FAU ( 
  ...
  nor3   g028(.a(new_n71_), .b(new_n59_), .c(x09), .O(new_n72_));
  ...
  aoi21  g033(.a(new_n76_), .b(x06), .c(new_n75_), .O(z05));
  nand2  g034(.a(new_n72_), .b(x11), .O(new_n78_));
  ...
  nand4  g045(.a(new_n88_), .b(x02), .c(new_n75_), .d(new_n87_), .O(new_n89_));
  inv1   g046(.a(new_n89_), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n44_), .c(new_n86_), .d(x04), .O(new_n91_));
  nor2   g048(.a(new_n91_), .b(x07), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(new_n54_), .c(x17), .d(new_n85_), .O(new_n93_));
  nor2   g050(.a(new_n93_), .b(new_n66_), .O(z08));
  ...
  nor2   g059(.a(new_n54_), .b(new_n75_), .O(new_n103_));
  inv1   g060(.a(x20), .O(new_n104_));
  nand2  g061(.a(new_n104_), .b(new_n66_), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n103_), .O(new_n107_));
  oai21  g064(.a(new_n102_), .b(new_n98_), .c(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n96_), .c(new_n95_), .d(new_n87_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n45_), .O(z09));
  nand3  g067(.a(x18), .b(x06), .c(x01), .O(new_n111_));
  inv1   g068(.a(new_n111_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n106_), .c(x22), .d(x21), .O(new_n113_));
  nor2   g070(.a(x13), .b(new_n80_), .O(new_n114_));
  nand3  g071(.a(new_n114_), .b(new_n97_), .c(new_n70_), .O(new_n115_));
  nor3   g072(.a(new_n100_), .b(new_n99_), .c(x14), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(new_n96_), .c(new_n95_), .d(x20), .O(new_n117_));
  or2    g074(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  aoi21  g075(.a(new_n118_), .b(new_n113_), .c(x00), .O(z10));
  nand4  g076(.a(new_n103_), .b(x21), .c(new_n104_), .d(new_n66_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n96_), .c(new_n87_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n66_), .b(x17), .c(new_n46_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(new_n75_), .c(new_n87_), .O(new_n131_));
  ...
  oai21  g092(.a(new_n129_), .b(new_n135_), .c(new_n45_), .O(z13));
  nand3  g093(.a(new_n51_), .b(new_n50_), .c(new_n59_), .O(new_n137_));
  oai21  g094(.a(new_n137_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g095(.a(x10), .b(new_n75_), .c(x02), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(x00), .O(new_n140_));
  nand3  g097(.a(x19), .b(new_n46_), .c(new_n75_), .O(new_n141_));
  nand3  g098(.a(new_n141_), .b(new_n140_), .c(new_n45_), .O(z15));
  aoi21  g099(.a(x06), .b(x00), .c(new_n75_), .O(z16));
  nand2  g100(.a(new_n97_), .b(new_n87_), .O(new_n144_));
