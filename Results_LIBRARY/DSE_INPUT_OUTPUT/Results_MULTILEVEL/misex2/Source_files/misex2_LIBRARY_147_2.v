...
module FAU ( 
  ...
  nand2  g001(.a(new_n44_), .b(x14), .O(new_n45_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n102_), .c(x12), .d(new_n73_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n101_), .O(new_n108_));
  ...
  nand3  g070(.a(new_n113_), .b(new_n102_), .c(new_n73_), .O(new_n114_));
  inv1   g071(.a(new_n114_), .O(new_n115_));
  nand3  g072(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n116_));
  nor4   g073(.a(new_n116_), .b(new_n104_), .c(new_n103_), .d(x14), .O(new_n117_));
  aoi21  g074(.a(new_n117_), .b(new_n115_), .c(new_n112_), .O(new_n118_));
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n45_), .O(z10));
  nor3   g076(.a(new_n57_), .b(new_n98_), .c(x20), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n53_), .c(x18), .O(new_n121_));
  nor2   g078(.a(new_n103_), .b(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n98_), .c(x20), .d(new_n104_), .O(new_n123_));
  oai22  g080(.a(new_n123_), .b(new_n114_), .c(new_n121_), .d(new_n47_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n99_), .c(new_n46_), .O(new_n125_));
  ...
  nand4  g092(.a(new_n58_), .b(x17), .c(new_n48_), .d(new_n47_), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(x00), .O(z13));
  nand4  g094(.a(new_n63_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n138_));
  ...
  nor3   g100(.a(new_n57_), .b(new_n47_), .c(x00), .O(z16));
  nand4  g101(.a(new_n45_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n145_));
