...
module FAU ( 
  ...
  oai21  g018(.a(new_n61_), .b(new_n60_), .c(x06), .O(new_n62_));
  ...
  aoi21  g028(.a(new_n71_), .b(x06), .c(new_n67_), .O(z04));
  nand4  g029(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n73_));
  aoi21  g030(.a(new_n73_), .b(x06), .c(new_n67_), .O(z05));
  ...
  nand2  g035(.a(new_n47_), .b(x06), .O(new_n79_));
  ...
  nand4  g046(.a(new_n89_), .b(new_n44_), .c(new_n85_), .d(x04), .O(new_n90_));
  nor2   g047(.a(new_n90_), .b(x07), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(new_n51_), .c(x17), .d(new_n84_), .O(new_n92_));
  ...
  nand4  g059(.a(new_n102_), .b(new_n52_), .c(x18), .d(x01), .O(new_n103_));
  ...
  nand3  g076(.a(x18), .b(x06), .c(x01), .O(new_n120_));
  nand3  g077(.a(x21), .b(new_n102_), .c(new_n52_), .O(new_n121_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n95_), .c(new_n86_), .O(new_n125_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n67_), .c(new_n86_), .O(new_n132_));
  ...
  nand4  g096(.a(new_n139_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x19), .O(z14));
  oai21  g098(.a(x10), .b(new_n67_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n46_), .c(new_n67_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n45_), .O(z15));
  nand3  g102(.a(x06), .b(x01), .c(new_n86_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand2  g104(.a(new_n96_), .b(new_n86_), .O(new_n148_));
