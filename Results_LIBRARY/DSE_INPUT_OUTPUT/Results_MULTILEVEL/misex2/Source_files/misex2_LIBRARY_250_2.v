...
module FAU ( 
  ...
  aoi21  g30(.a(new_n73_), .b(x01), .c(new_n59_), .O(z05));
  nand3  g31(.a(new_n62_), .b(x11), .c(x10), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x01), .c(new_n59_), .O(z06));
  ...
  nand4  g50(.a(x12), .b(new_n93_), .c(x02), .d(new_n60_), .O(new_n94_));
  ...
  nand4  g61(.a(new_n97_), .b(x12), .c(new_n93_), .d(x02), .O(new_n105_));
  nand3  g62(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(x16), .c(x15), .O(new_n108_));
  oai21  g65(.a(new_n108_), .b(new_n105_), .c(new_n59_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n60_), .O(new_n110_));
  inv1   g67(.a(new_n101_), .O(new_n111_));
  nor2   g68(.a(new_n99_), .b(x00), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n111_), .c(x22), .d(x21), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n110_), .O(z10));
  nand3  g71(.a(new_n107_), .b(new_n96_), .c(x15), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n105_), .c(new_n59_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n60_), .O(new_n117_));
  nand4  g74(.a(new_n112_), .b(new_n111_), .c(new_n92_), .d(x21), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(z11));
  inv1   g76(.a(x24), .O(new_n120_));
  aoi21  g77(.a(x10), .b(x02), .c(new_n59_), .O(new_n121_));
  oai21  g78(.a(x19), .b(x02), .c(x23), .O(new_n122_));
  nand3  g79(.a(new_n66_), .b(x17), .c(new_n61_), .O(new_n123_));
  aoi21  g80(.a(new_n123_), .b(new_n122_), .c(x01), .O(new_n124_));
  oai21  g81(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n125_));
  oai22  g82(.a(new_n125_), .b(new_n46_), .c(x01), .d(new_n59_), .O(z12));
  nand2  g83(.a(new_n47_), .b(x17), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(x19), .O(z13));
  nor3   g85(.a(x10), .b(x09), .c(x02), .O(new_n129_));
  nand4  g86(.a(new_n129_), .b(new_n66_), .c(new_n45_), .d(new_n44_), .O(new_n130_));
  aoi21  g87(.a(new_n130_), .b(new_n59_), .c(x01), .O(z14));
  nand2  g88(.a(x10), .b(x02), .O(new_n132_));
  nand3  g89(.a(new_n132_), .b(x01), .c(x00), .O(new_n133_));
  nand4  g90(.a(x19), .b(new_n61_), .c(new_n60_), .d(new_n59_), .O(new_n134_));
  nand2  g91(.a(new_n134_), .b(new_n133_), .O(z15));
  nor2   g92(.a(new_n60_), .b(x00), .O(z16));
  aoi21  g93(.a(new_n61_), .b(new_n59_), .c(x01), .O(z17));
endmodule
