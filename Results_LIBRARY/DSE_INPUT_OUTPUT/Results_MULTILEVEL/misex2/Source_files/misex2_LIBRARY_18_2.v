...
module FAU ( 
  ...
  oai21  g022(.a(new_n65_), .b(new_n64_), .c(x07), .O(new_n66_));
  ...
  aoi21  g032(.a(new_n75_), .b(x07), .c(new_n71_), .O(z04));
  nand4  g033(.a(x07), .b(x02), .c(x01), .d(x00), .O(new_n77_));
  ...
  aoi21  g050(.a(new_n93_), .b(new_n71_), .c(x07), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nand4  g053(.a(x12), .b(new_n72_), .c(x02), .d(new_n71_), .O(new_n97_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n96_), .c(new_n95_), .d(new_n86_), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(z09));
  nand3  g063(.a(x18), .b(x07), .c(x01), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n102_), .c(x22), .d(x21), .O(new_n109_));
  nor2   g066(.a(new_n46_), .b(x01), .O(new_n110_));
  ...
  nand3  g075(.a(new_n111_), .b(new_n110_), .c(new_n72_), .O(new_n119_));
  inv1   g076(.a(x20), .O(new_n120_));
  nand4  g077(.a(new_n108_), .b(x21), .c(new_n120_), .d(new_n56_), .O(new_n121_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n96_), .c(new_n86_), .O(new_n126_));
  ...
  oai21  g095(.a(new_n132_), .b(new_n138_), .c(new_n54_), .O(z13));
  ...
  nand3  g102(.a(x07), .b(x01), .c(new_n86_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand2  g104(.a(new_n110_), .b(new_n86_), .O(new_n148_));
  nand2  g105(.a(new_n148_), .b(new_n54_), .O(z17));
endmodule
