...
module FAU ( 
  ...
  nor2   g37(.a(x03), .b(new_n61_), .O(new_n81_));
  ...
  aoi21  g42(.a(new_n85_), .b(new_n60_), .c(x00), .O(z08));
  ...
  nand4  g48(.a(new_n91_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n92_));
  ...
  nor2   g55(.a(new_n94_), .b(new_n98_), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n88_), .c(x20), .d(x16), .O(new_n100_));
  nor2   g57(.a(new_n100_), .b(x22), .O(z10));
  nand3  g58(.a(new_n90_), .b(new_n89_), .c(x12), .O(new_n102_));
  nor3   g59(.a(new_n102_), .b(x11), .c(new_n61_), .O(new_n103_));
  nor2   g60(.a(x16), .b(new_n98_), .O(new_n104_));
  nor2   g61(.a(x22), .b(x21), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(x20), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n60_), .c(x00), .O(z11));
