...
module FAU ( 
  ...
  nand3  g22(.a(new_n46_), .b(x02), .c(x01), .O(new_n66_));
  ...
  nor3   g30(.a(new_n70_), .b(new_n56_), .c(new_n46_), .O(z05));
  nand4  g31(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x00), .c(new_n60_), .O(z06));
  ...
  nor3   g51(.a(new_n94_), .b(x11), .c(new_n61_), .O(new_n95_));
  ...
  aoi21  g55(.a(new_n98_), .b(new_n60_), .c(x00), .O(z09));
  inv1   g56(.a(x21), .O(new_n100_));
  inv1   g57(.a(x15), .O(new_n101_));
  nand4  g58(.a(new_n69_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n102_));
  ...
  nand4  g62(.a(new_n105_), .b(new_n100_), .c(x20), .d(x16), .O(new_n106_));
  nor2   g63(.a(new_n106_), .b(x22), .O(z10));
  inv1   g64(.a(x16), .O(new_n108_));
  nand4  g65(.a(new_n105_), .b(new_n100_), .c(x20), .d(new_n108_), .O(new_n109_));
  nor2   g66(.a(new_n109_), .b(x22), .O(z11));
  inv1   g67(.a(x24), .O(new_n111_));
  aoi21  g68(.a(x10), .b(x02), .c(new_n60_), .O(new_n112_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g70(.a(new_n62_), .b(x17), .c(new_n61_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n113_), .c(x00), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n112_), .c(new_n111_), .O(new_n116_));
  oai22  g73(.a(new_n116_), .b(new_n46_), .c(new_n60_), .d(x00), .O(z12));
  ...
  aoi21  g81(.a(new_n61_), .b(new_n60_), .c(x00), .O(z17));
  zero   g82(.O(z16));
endmodule
