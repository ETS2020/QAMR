...
module FAU ( 
  ...
  nand4  g021(.a(new_n59_), .b(x18), .c(new_n44_), .d(new_n49_), .O(new_n65_));
  ...
  nor2   g046(.a(new_n59_), .b(x18), .O(new_n90_));
  ...
  nand4  g057(.a(new_n100_), .b(new_n59_), .c(x18), .d(x01), .O(new_n101_));
  ...
  nand2  g060(.a(new_n103_), .b(new_n75_), .O(z09));
  nand3  g061(.a(new_n59_), .b(x18), .c(x01), .O(new_n105_));
  ...
  oai21  g073(.a(new_n116_), .b(x00), .c(new_n75_), .O(z10));
  nor2   g074(.a(new_n45_), .b(new_n47_), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(x21), .c(new_n100_), .d(new_n59_), .O(new_n119_));
  inv1   g076(.a(new_n108_), .O(new_n120_));
  nand3  g077(.a(x12), .b(new_n69_), .c(new_n49_), .O(new_n121_));
  inv1   g078(.a(new_n121_), .O(new_n122_));
  nand3  g079(.a(x15), .b(new_n112_), .c(new_n109_), .O(new_n123_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n94_), .c(new_n46_), .O(new_n129_));
  ...
  nand3  g091(.a(new_n59_), .b(x17), .c(new_n48_), .O(new_n135_));
  ...
  aoi21  g101(.a(x19), .b(new_n48_), .c(x06), .O(new_n145_));
