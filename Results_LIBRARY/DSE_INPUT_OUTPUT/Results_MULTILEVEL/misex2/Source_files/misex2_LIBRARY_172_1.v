...
module FAU ( 
  ...
  nand3  g21(.a(new_n64_), .b(x02), .c(x01), .O(new_n65_));
  nand3  g22(.a(x12), .b(x11), .c(x10), .O(new_n66_));
  oai21  g23(.a(new_n66_), .b(new_n65_), .c(new_n63_), .O(z03));
  inv1   g24(.a(x11), .O(new_n68_));
  nand3  g25(.a(x02), .b(x01), .c(x00), .O(new_n69_));
  inv1   g26(.a(new_n69_), .O(new_n70_));
  nand4  g27(.a(new_n70_), .b(new_n68_), .c(x10), .d(new_n64_), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(x12), .O(z04));
  nor3   g29(.a(new_n69_), .b(new_n57_), .c(new_n64_), .O(z05));
  ...
  oai21  g70(.a(new_n113_), .b(new_n64_), .c(new_n81_), .O(z12));
  ...
  nand3  g77(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n121_));
