...
module FAU ( 
  ...
  nand2  g006(.a(x05), .b(x03), .O(new_n50_));
  ...
  nand4  g018(.a(new_n61_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n62_));
  oai21  g019(.a(new_n62_), .b(new_n60_), .c(new_n50_), .O(z02));
  ...
  nand4  g051(.a(new_n94_), .b(new_n49_), .c(x17), .d(new_n87_), .O(new_n95_));
  ...
  nand4  g065(.a(new_n108_), .b(new_n98_), .c(new_n97_), .d(new_n59_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n50_), .O(z09));
  nor2   g067(.a(new_n98_), .b(new_n97_), .O(new_n111_));
  nand4  g068(.a(new_n111_), .b(new_n65_), .c(new_n105_), .d(x01), .O(new_n112_));
  ...
  nand3  g074(.a(new_n117_), .b(new_n50_), .c(new_n59_), .O(new_n118_));
  inv1   g075(.a(new_n118_), .O(z10));
  nand4  g076(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n61_), .O(new_n120_));
  ...
  nand4  g080(.a(new_n123_), .b(new_n50_), .c(new_n98_), .d(new_n59_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n129_));
  ...
  nand4  g091(.a(new_n52_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n135_));
  ...
  aoi21  g099(.a(new_n142_), .b(new_n141_), .c(new_n51_), .O(z15));
  oai21  g100(.a(new_n44_), .b(x00), .c(new_n50_), .O(z16));
  nand2  g101(.a(new_n99_), .b(new_n59_), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(new_n50_), .O(z17));
endmodule
