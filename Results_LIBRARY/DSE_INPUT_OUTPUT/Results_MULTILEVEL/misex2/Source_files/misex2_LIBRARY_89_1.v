...
module FAU ( 
  ...
  nand3  g20(.a(new_n53_), .b(new_n63_), .c(new_n52_), .O(new_n64_));
  inv1   g21(.a(x19), .O(new_n65_));
  nand4  g22(.a(new_n65_), .b(x18), .c(new_n46_), .d(new_n44_), .O(new_n66_));
  ...
  nand2  g39(.a(x02), .b(new_n52_), .O(new_n83_));
  ...
  nand4  g50(.a(new_n65_), .b(x18), .c(x01), .d(new_n52_), .O(new_n94_));
  inv1   g51(.a(new_n94_), .O(new_n95_));
  nand4  g52(.a(new_n95_), .b(new_n93_), .c(new_n92_), .d(new_n91_), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(z09));
  nand4  g54(.a(new_n95_), .b(x22), .c(x21), .d(new_n91_), .O(new_n98_));
  inv1   g55(.a(new_n98_), .O(z10));
  nand2  g56(.a(x12), .b(new_n63_), .O(new_n100_));
  nand3  g57(.a(x18), .b(x01), .c(new_n52_), .O(new_n101_));
  nand4  g58(.a(new_n93_), .b(x21), .c(new_n91_), .d(new_n65_), .O(new_n102_));
  oai21  g59(.a(new_n102_), .b(new_n101_), .c(new_n100_), .O(z11));
  ...
  nand4  g66(.a(new_n109_), .b(new_n44_), .c(new_n63_), .d(new_n52_), .O(new_n110_));
  ...
  nand4  g70(.a(new_n65_), .b(x17), .c(new_n53_), .d(new_n52_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n44_), .c(x01), .O(z13));
  nand2  g72(.a(new_n60_), .b(new_n45_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g74(.a(new_n58_), .b(x01), .c(new_n53_), .O(new_n118_));
  aoi21  g75(.a(x19), .b(new_n53_), .c(x12), .O(new_n119_));
  oai22  g76(.a(new_n119_), .b(x01), .c(new_n118_), .d(new_n52_), .O(z15));
  oai21  g77(.a(new_n63_), .b(x00), .c(new_n100_), .O(z16));
  nand4  g78(.a(new_n44_), .b(x02), .c(new_n63_), .d(new_n52_), .O(new_n122_));
