...
module FAU ( 
  ...
  nand2  g008(.a(new_n51_), .b(x01), .O(new_n52_));
  ...
  nand4  g015(.a(new_n58_), .b(new_n57_), .c(new_n45_), .d(new_n56_), .O(new_n59_));
  oai21  g016(.a(new_n59_), .b(new_n55_), .c(new_n52_), .O(z02));
  nand3  g017(.a(new_n44_), .b(x02), .c(x00), .O(new_n61_));
  nand3  g018(.a(x12), .b(x11), .c(x10), .O(new_n62_));
  oai21  g019(.a(new_n62_), .b(new_n61_), .c(x03), .O(new_n63_));
  nand2  g020(.a(new_n63_), .b(x01), .O(new_n64_));
  nor3   g021(.a(x02), .b(x01), .c(x00), .O(new_n65_));
  nand4  g022(.a(new_n65_), .b(new_n58_), .c(x18), .d(new_n45_), .O(new_n66_));
  ...
  nor2   g031(.a(new_n53_), .b(new_n74_), .O(new_n75_));
  nand3  g032(.a(new_n75_), .b(x10), .c(x09), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(x03), .c(new_n73_), .O(z05));
  nand4  g034(.a(new_n75_), .b(x11), .c(x10), .d(new_n44_), .O(new_n78_));
  aoi21  g035(.a(new_n78_), .b(x03), .c(new_n73_), .O(z06));
  nand2  g036(.a(new_n44_), .b(x03), .O(new_n80_));
  ...
  nor2   g042(.a(new_n53_), .b(x00), .O(new_n86_));
  nor2   g043(.a(x06), .b(x05), .O(new_n87_));
  nand2  g044(.a(new_n87_), .b(x04), .O(new_n88_));
  inv1   g045(.a(new_n88_), .O(new_n89_));
  nand3  g046(.a(x19), .b(new_n57_), .c(x17), .O(new_n90_));
  nor3   g047(.a(new_n90_), .b(x08), .c(x07), .O(new_n91_));
  nand3  g048(.a(new_n91_), .b(new_n89_), .c(new_n86_), .O(new_n92_));
  aoi21  g049(.a(new_n92_), .b(new_n73_), .c(x03), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n68_), .c(x02), .d(new_n73_), .O(new_n96_));
  ...
  nand2  g061(.a(new_n104_), .b(new_n52_), .O(z09));
  nand3  g062(.a(new_n58_), .b(x18), .c(x01), .O(new_n106_));
  nand3  g063(.a(x22), .b(x21), .c(new_n101_), .O(new_n107_));
  nor2   g064(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g065(.a(x02), .b(new_n73_), .O(new_n109_));
  ...
  nor2   g075(.a(new_n53_), .b(x01), .O(new_n119_));
  nor2   g076(.a(x13), .b(new_n81_), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n119_), .c(new_n68_), .O(new_n121_));
  nand3  g078(.a(x18), .b(x03), .c(x01), .O(new_n122_));
  inv1   g079(.a(new_n122_), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(x21), .c(new_n101_), .d(new_n58_), .O(new_n124_));
  nor2   g081(.a(new_n97_), .b(x14), .O(new_n125_));
  nor2   g082(.a(x21), .b(new_n101_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n125_), .c(new_n98_), .O(new_n127_));
  oai21  g084(.a(new_n127_), .b(new_n121_), .c(new_n124_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n95_), .c(new_n74_), .O(new_n129_));
  ...
  nand3  g091(.a(new_n58_), .b(x17), .c(new_n53_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n73_), .c(new_n74_), .O(new_n137_));
  ...
  nand2  g097(.a(new_n46_), .b(x17), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x19), .O(z13));
  nand3  g099(.a(new_n54_), .b(new_n44_), .c(new_n53_), .O(new_n143_));
  oai21  g100(.a(new_n143_), .b(new_n59_), .c(new_n52_), .O(z14));
  oai21  g101(.a(x10), .b(new_n73_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n53_), .c(new_n73_), .O(new_n147_));
  nand3  g104(.a(new_n147_), .b(new_n146_), .c(new_n52_), .O(z15));
  aoi21  g105(.a(x03), .b(x00), .c(new_n73_), .O(z16));
  oai21  g106(.a(new_n109_), .b(x00), .c(new_n52_), .O(z17));
endmodule
