...
module FAU ( 
  ...
  nand4  g11(.a(x09), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n55_));
  nor2   g12(.a(new_n55_), .b(new_n51_), .O(new_n56_));
  nand4  g13(.a(new_n56_), .b(new_n50_), .c(new_n45_), .d(new_n44_), .O(new_n57_));
  nor2   g14(.a(new_n57_), .b(x19), .O(z01));
  nor2   g15(.a(new_n55_), .b(x10), .O(new_n59_));
  nand4  g16(.a(new_n59_), .b(new_n50_), .c(new_n45_), .d(new_n44_), .O(new_n60_));
  ...
  inv1   g35(.a(x09), .O(new_n79_));
  nand3  g36(.a(x02), .b(x01), .c(x00), .O(new_n80_));
  inv1   g37(.a(new_n80_), .O(new_n81_));
  nand4  g38(.a(new_n81_), .b(x11), .c(x10), .d(new_n79_), .O(new_n82_));
  inv1   g39(.a(new_n82_), .O(z06));
  nand3  g40(.a(new_n68_), .b(new_n73_), .c(x11), .O(new_n84_));
  nand2  g41(.a(new_n84_), .b(x01), .O(new_n85_));
  nand3  g42(.a(new_n85_), .b(x02), .c(x00), .O(new_n86_));
  nand2  g43(.a(new_n86_), .b(new_n71_), .O(z07));
  nand2  g44(.a(x02), .b(new_n52_), .O(new_n88_));
  ...
  nand3  g49(.a(x19), .b(new_n50_), .c(x17), .O(new_n93_));
  ...
  nand4  g55(.a(x12), .b(new_n72_), .c(x02), .d(new_n53_), .O(new_n99_));
  ...
  oai21  g61(.a(new_n102_), .b(new_n99_), .c(new_n104_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n98_), .c(new_n97_), .d(new_n52_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n71_), .O(z09));
  nand4  g64(.a(new_n63_), .b(x18), .c(x01), .d(new_n52_), .O(new_n108_));
  nor3   g65(.a(new_n108_), .b(new_n97_), .c(x20), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(x22), .O(new_n110_));
  inv1   g67(.a(new_n110_), .O(z10));
  nand2  g68(.a(new_n109_), .b(new_n98_), .O(new_n112_));
  ...
  nand3  g74(.a(new_n63_), .b(x17), .c(new_n54_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n53_), .c(new_n52_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n116_), .O(new_n121_));
  nand3  g78(.a(new_n121_), .b(new_n114_), .c(x09), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n71_), .O(z12));
  nand3  g80(.a(new_n54_), .b(new_n53_), .c(new_n52_), .O(new_n124_));
  nor4   g81(.a(new_n124_), .b(x19), .c(new_n45_), .d(x15), .O(z13));
  nand4  g82(.a(new_n79_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n126_));
  nor2   g83(.a(new_n126_), .b(x10), .O(new_n127_));
  nand4  g84(.a(new_n127_), .b(new_n50_), .c(new_n45_), .d(new_n44_), .O(new_n128_));
  nor2   g85(.a(new_n128_), .b(x19), .O(z14));
  aoi21  g86(.a(new_n44_), .b(new_n54_), .c(new_n115_), .O(new_n130_));
  nand4  g87(.a(x19), .b(new_n44_), .c(new_n54_), .d(new_n53_), .O(new_n131_));
  oai21  g88(.a(new_n130_), .b(new_n52_), .c(new_n131_), .O(z15));
  oai21  g89(.a(new_n53_), .b(x00), .c(new_n71_), .O(z16));
  nand4  g90(.a(new_n44_), .b(x02), .c(new_n53_), .d(new_n52_), .O(new_n134_));
