...
module FAU ( 
  ...
  nor4   g33(.a(new_n76_), .b(new_n70_), .c(new_n57_), .d(x09), .O(z06));
  ...
  nand4  g48(.a(x12), .b(new_n70_), .c(x02), .d(new_n61_), .O(new_n92_));
  ...
  oai21  g62(.a(new_n105_), .b(new_n103_), .c(new_n60_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n61_), .O(new_n107_));
  nor2   g64(.a(new_n91_), .b(new_n90_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n98_), .c(new_n97_), .d(new_n60_), .O(new_n109_));
  ...
  nor2   g69(.a(new_n46_), .b(x01), .O(new_n113_));
  ...
  nand3  g76(.a(new_n119_), .b(new_n91_), .c(new_n60_), .O(new_n120_));
  ...
  nand3  g81(.a(new_n66_), .b(x17), .c(new_n46_), .O(new_n125_));
  aoi21  g82(.a(new_n125_), .b(new_n124_), .c(x01), .O(new_n126_));
  oai21  g83(.a(new_n126_), .b(new_n123_), .c(new_n122_), .O(new_n127_));
  nand2  g84(.a(new_n61_), .b(x00), .O(new_n128_));
  oai21  g85(.a(new_n127_), .b(new_n47_), .c(new_n128_), .O(z12));
  nand3  g86(.a(new_n48_), .b(x17), .c(new_n46_), .O(new_n130_));
  ...
  nor2   g94(.a(new_n61_), .b(x00), .O(z16));
