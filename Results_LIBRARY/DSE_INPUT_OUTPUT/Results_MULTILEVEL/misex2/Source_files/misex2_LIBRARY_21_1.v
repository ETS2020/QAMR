...
module FAU ( 
  ...
  aoi21  g51(.a(new_n94_), .b(new_n47_), .c(x00), .O(z09));
  inv1   g52(.a(x21), .O(new_n96_));
  inv1   g53(.a(x15), .O(new_n97_));
  inv1   g54(.a(x11), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n99_));
  ...
  nand3  g67(.a(new_n63_), .b(x17), .c(new_n48_), .O(new_n111_));
  ...
  nand4  g74(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n118_));
  ...
  nand3  g80(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n124_));
