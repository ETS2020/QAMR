...
module FAU ( 
  ...
  nor2   g22(.a(new_n58_), .b(x09), .O(new_n66_));
  ...
  oai21  g33(.a(new_n76_), .b(new_n65_), .c(new_n69_), .O(z06));
  nand3  g34(.a(new_n66_), .b(new_n71_), .c(x11), .O(new_n78_));
  ...
  nor2   g40(.a(new_n48_), .b(x01), .O(new_n85_));
  nor2   g41(.a(x13), .b(new_n71_), .O(new_n86_));
  nand3  g42(.a(new_n86_), .b(new_n85_), .c(new_n70_), .O(new_n87_));
  ...
  nor2   g47(.a(new_n45_), .b(new_n47_), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(new_n91_), .c(new_n61_), .O(new_n93_));
  oai21  g49(.a(new_n90_), .b(new_n87_), .c(new_n93_), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(new_n84_), .c(new_n83_), .d(new_n46_), .O(new_n95_));
  ...
  nand3  g54(.a(new_n70_), .b(x02), .c(new_n47_), .O(new_n99_));
  ...
  nand4  g62(.a(new_n92_), .b(x21), .c(new_n91_), .d(new_n61_), .O(new_n107_));
  ...
  nand3  g69(.a(new_n113_), .b(new_n84_), .c(new_n46_), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(z11));
  nand2  g71(.a(x10), .b(x02), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(x01), .c(x00), .O(new_n117_));
  nand2  g73(.a(new_n61_), .b(new_n48_), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(x23), .c(new_n47_), .d(new_n46_), .O(new_n119_));
  aoi21  g75(.a(new_n119_), .b(new_n117_), .c(x24), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(x09), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n69_), .O(z12));
  nand4  g78(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n124_));
  nor2   g79(.a(new_n124_), .b(x19), .O(z14));
  aoi21  g80(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n126_));
  aoi21  g81(.a(x19), .b(new_n48_), .c(x17), .O(new_n127_));
  oai22  g82(.a(new_n127_), .b(x01), .c(new_n126_), .d(new_n46_), .O(z15));
  nor2   g83(.a(new_n47_), .b(x00), .O(z16));
  nand2  g84(.a(x02), .b(new_n46_), .O(new_n130_));
  aoi21  g85(.a(new_n130_), .b(new_n44_), .c(x01), .O(z17));
  zero   g86(.O(z08));
  zero   g87(.O(z13));
endmodule
