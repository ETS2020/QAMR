...
module FAU ( 
  ...
  aoi21  g030(.a(new_n73_), .b(new_n61_), .c(new_n47_), .O(z04));
  nand4  g031(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n75_));
  aoi21  g032(.a(new_n75_), .b(new_n61_), .c(new_n47_), .O(z05));
  ...
  nor2   g036(.a(new_n79_), .b(x14), .O(z06));
  nand2  g037(.a(x10), .b(new_n49_), .O(new_n81_));
  nand3  g038(.a(new_n61_), .b(new_n71_), .c(x11), .O(new_n82_));
  oai21  g039(.a(new_n82_), .b(new_n81_), .c(x01), .O(new_n83_));
  nand3  g040(.a(new_n83_), .b(x02), .c(x00), .O(new_n84_));
  inv1   g041(.a(new_n84_), .O(z07));
  nand2  g042(.a(x14), .b(x01), .O(new_n86_));
  nand3  g043(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n87_));
  ...
  nor2   g048(.a(new_n66_), .b(x18), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(x17), .O(new_n93_));
  nand2  g050(.a(new_n93_), .b(new_n86_), .O(z08));
  ...
  nand4  g061(.a(new_n104_), .b(new_n96_), .c(new_n95_), .d(new_n61_), .O(new_n105_));
  ...
  nand3  g067(.a(new_n98_), .b(x12), .c(new_n70_), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand3  g069(.a(x16), .b(x15), .c(new_n61_), .O(new_n113_));
  ...
  oai21  g073(.a(new_n116_), .b(x00), .c(new_n86_), .O(z10));
  and2   g074(.a(x18), .b(x01), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(x21), .c(new_n102_), .d(new_n66_), .O(new_n119_));
  nor2   g076(.a(new_n99_), .b(x13), .O(new_n120_));
  ...
  nand4  g080(.a(new_n123_), .b(new_n96_), .c(new_n61_), .d(new_n46_), .O(new_n124_));
  inv1   g081(.a(new_n124_), .O(z11));
  inv1   g082(.a(x24), .O(new_n126_));
  nand2  g083(.a(x10), .b(x02), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(new_n61_), .c(x01), .d(x00), .O(new_n128_));
  oai21  g085(.a(x19), .b(x02), .c(x23), .O(new_n129_));
  nand3  g086(.a(new_n66_), .b(x17), .c(new_n48_), .O(new_n130_));
  ...
  oai21  g093(.a(new_n130_), .b(new_n136_), .c(new_n86_), .O(z13));
  ...
  nand3  g099(.a(new_n142_), .b(new_n141_), .c(new_n86_), .O(z15));
  nand3  g100(.a(new_n61_), .b(x01), .c(new_n46_), .O(new_n144_));
  inv1   g101(.a(new_n144_), .O(z16));
  nand2  g102(.a(new_n87_), .b(new_n86_), .O(z17));
endmodule
