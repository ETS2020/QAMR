...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n77_, new_n78_, new_n81_, new_n82_, new_n83_, new_n84_, new_n86_,
  ...
  nand4  g017(.a(new_n60_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n61_));
  ...
  oai21  g035(.a(new_n78_), .b(new_n77_), .c(new_n72_), .O(z05));
  nor4   g036(.a(new_n68_), .b(new_n73_), .c(new_n47_), .d(x09), .O(z06));
  nand2  g037(.a(new_n51_), .b(x01), .O(new_n81_));
  nand3  g038(.a(new_n74_), .b(x11), .c(x10), .O(new_n82_));
  oai22  g039(.a(new_n82_), .b(new_n81_), .c(x14), .d(x01), .O(new_n83_));
  ...
  nor2   g052(.a(new_n50_), .b(x01), .O(new_n96_));
  nand3  g053(.a(new_n96_), .b(x12), .c(new_n73_), .O(new_n97_));
  ...
  nand2  g067(.a(x02), .b(new_n49_), .O(new_n111_));
  ...
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n72_), .O(z10));
  nand4  g076(.a(new_n96_), .b(new_n112_), .c(x12), .d(new_n73_), .O(new_n120_));
  nand4  g077(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n64_), .O(new_n121_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n95_), .c(new_n48_), .O(new_n125_));
  ...
  nand3  g087(.a(new_n64_), .b(x17), .c(new_n50_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand4  g089(.a(new_n132_), .b(new_n44_), .c(new_n49_), .d(new_n48_), .O(new_n133_));
  ...
  nand4  g093(.a(new_n64_), .b(x17), .c(new_n50_), .d(new_n48_), .O(new_n137_));
  ...
  aoi21  g098(.a(new_n47_), .b(x01), .c(new_n50_), .O(new_n142_));
  aoi21  g099(.a(x19), .b(new_n50_), .c(x14), .O(new_n143_));
  oai22  g100(.a(new_n143_), .b(x01), .c(new_n142_), .d(new_n48_), .O(z15));
  nor2   g101(.a(new_n49_), .b(x00), .O(z16));
  aoi21  g102(.a(new_n86_), .b(new_n44_), .c(x01), .O(z17));
endmodule
