...
module FAU ( 
  ...
  nor2   g19(.a(new_n62_), .b(new_n59_), .O(new_n63_));
  nand4  g20(.a(new_n63_), .b(new_n46_), .c(x02), .d(x00), .O(new_n64_));
  aoi21  g21(.a(new_n64_), .b(x12), .c(new_n48_), .O(z06));
  inv1   g22(.a(x02), .O(new_n66_));
  nand3  g23(.a(new_n66_), .b(new_n48_), .c(new_n47_), .O(new_n67_));
  inv1   g24(.a(x19), .O(new_n68_));
  nand2  g25(.a(new_n68_), .b(x18), .O(new_n69_));
  nor3   g26(.a(new_n69_), .b(new_n67_), .c(x17), .O(new_n70_));
  or2    g27(.a(new_n70_), .b(z06), .O(z03));
  ...
  nor3   g32(.a(new_n75_), .b(new_n72_), .c(new_n59_), .O(z05));
  nand3  g33(.a(x02), .b(new_n48_), .c(x00), .O(new_n77_));
  ...
  nand4  g39(.a(new_n82_), .b(x02), .c(new_n48_), .d(new_n47_), .O(new_n83_));
  ...
  nor2   g44(.a(new_n87_), .b(new_n68_), .O(z08));
  inv1   g45(.a(x21), .O(new_n89_));
  inv1   g46(.a(x22), .O(new_n90_));
  nor2   g47(.a(new_n66_), .b(x01), .O(new_n91_));
  ...
  nand3  g55(.a(new_n98_), .b(new_n97_), .c(new_n68_), .O(new_n99_));
  ...
  aoi21  g69(.a(new_n112_), .b(new_n109_), .c(new_n104_), .O(new_n113_));
  oai21  g70(.a(new_n113_), .b(x00), .c(new_n73_), .O(z10));
  nand4  g71(.a(new_n98_), .b(x21), .c(new_n97_), .d(new_n68_), .O(new_n115_));
  nor2   g72(.a(new_n93_), .b(x14), .O(new_n116_));
  nand4  g73(.a(new_n116_), .b(new_n89_), .c(x20), .d(new_n94_), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n108_), .c(new_n115_), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(new_n90_), .c(new_n47_), .O(new_n119_));
  ...
  nand3  g80(.a(new_n68_), .b(x17), .c(new_n66_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand3  g82(.a(new_n125_), .b(new_n48_), .c(new_n47_), .O(new_n126_));
  aoi21  g83(.a(new_n126_), .b(new_n122_), .c(x24), .O(new_n127_));
  nand2  g84(.a(new_n127_), .b(x09), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(new_n73_), .O(z12));
  oai21  g86(.a(new_n124_), .b(new_n49_), .c(new_n73_), .O(z13));
  nand4  g87(.a(new_n52_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n131_));
  nor2   g88(.a(new_n131_), .b(x19), .O(z14));
  aoi22  g89(.a(new_n73_), .b(x00), .c(x19), .d(new_n48_), .O(new_n133_));
  nand4  g90(.a(x12), .b(new_n59_), .c(x01), .d(x00), .O(new_n134_));
  oai21  g91(.a(new_n133_), .b(x02), .c(new_n134_), .O(z15));
  aoi21  g92(.a(x12), .b(x00), .c(new_n48_), .O(z16));
  nand2  g93(.a(new_n91_), .b(new_n47_), .O(new_n137_));
  nand2  g94(.a(new_n137_), .b(new_n73_), .O(z17));
endmodule
