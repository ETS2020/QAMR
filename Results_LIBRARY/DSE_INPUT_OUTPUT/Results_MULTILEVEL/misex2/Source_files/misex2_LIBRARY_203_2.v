...
module FAU ( 
  ...
  oai21  g020(.a(new_n63_), .b(new_n62_), .c(x16), .O(new_n64_));
  ...
  aoi21  g031(.a(new_n74_), .b(x16), .c(new_n70_), .O(z04));
  inv1   g032(.a(x00), .O(new_n76_));
  nor2   g033(.a(new_n46_), .b(new_n76_), .O(new_n77_));
  nand3  g034(.a(new_n77_), .b(x10), .c(x09), .O(new_n78_));
  aoi21  g035(.a(new_n78_), .b(x16), .c(new_n70_), .O(z05));
  nand4  g036(.a(new_n77_), .b(x11), .c(x10), .d(new_n47_), .O(new_n80_));
  aoi21  g037(.a(new_n80_), .b(x16), .c(new_n70_), .O(z06));
  ...
  nand2  g043(.a(new_n86_), .b(new_n76_), .O(new_n87_));
  ...
  nor2   g049(.a(new_n56_), .b(x18), .O(new_n93_));
  nand4  g050(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(x17), .O(new_n94_));
  nand2  g051(.a(new_n94_), .b(new_n54_), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  inv1   g054(.a(x13), .O(new_n98_));
  nand4  g055(.a(new_n98_), .b(x12), .c(new_n71_), .d(x02), .O(new_n99_));
  inv1   g056(.a(x14), .O(new_n100_));
  inv1   g057(.a(x15), .O(new_n101_));
  nand4  g058(.a(x20), .b(new_n53_), .c(new_n101_), .d(new_n100_), .O(new_n102_));
  inv1   g059(.a(x20), .O(new_n103_));
  and2   g060(.a(x18), .b(x01), .O(new_n104_));
  nand3  g061(.a(new_n104_), .b(new_n103_), .c(new_n56_), .O(new_n105_));
  oai21  g062(.a(new_n102_), .b(new_n99_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n97_), .c(new_n96_), .d(new_n76_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n54_), .O(z09));
  nand2  g065(.a(x22), .b(x21), .O(new_n109_));
  nor2   g066(.a(new_n109_), .b(x20), .O(new_n110_));
  nand3  g067(.a(new_n110_), .b(new_n67_), .c(x01), .O(new_n111_));
  nor2   g068(.a(x13), .b(new_n72_), .O(new_n112_));
  nand3  g069(.a(new_n112_), .b(new_n86_), .c(new_n71_), .O(new_n113_));
  nor2   g070(.a(new_n101_), .b(x14), .O(new_n114_));
  ...
  nand3  g074(.a(new_n117_), .b(x16), .c(new_n76_), .O(new_n118_));
  inv1   g075(.a(new_n118_), .O(z10));
  nand4  g076(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n56_), .O(new_n120_));
  nor2   g077(.a(x21), .b(new_n103_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n114_), .c(new_n53_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n99_), .c(new_n120_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n97_), .c(new_n76_), .O(new_n124_));
  ...
  nand3  g086(.a(new_n56_), .b(x17), .c(new_n46_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n70_), .c(new_n76_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n126_), .c(x09), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n54_), .O(z12));
  nand3  g092(.a(new_n48_), .b(x17), .c(new_n46_), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(x19), .O(z13));
  nand3  g094(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n138_));
  oai21  g095(.a(new_n138_), .b(new_n60_), .c(new_n54_), .O(z14));
  aoi22  g096(.a(new_n54_), .b(x00), .c(x19), .d(new_n70_), .O(new_n140_));
  nand4  g097(.a(x16), .b(new_n59_), .c(x01), .d(x00), .O(new_n141_));
  oai21  g098(.a(new_n140_), .b(x02), .c(new_n141_), .O(z15));
  aoi21  g099(.a(x16), .b(x00), .c(new_n70_), .O(z16));
