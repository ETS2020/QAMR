...
module FAU ( 
  ...
  nand4  g37(.a(new_n80_), .b(x02), .c(new_n52_), .d(new_n44_), .O(new_n81_));
  ...
  nand4  g41(.a(new_n84_), .b(new_n51_), .c(x17), .d(new_n77_), .O(new_n85_));
  nor2   g42(.a(new_n85_), .b(new_n61_), .O(z08));
  inv1   g43(.a(x21), .O(new_n87_));
  inv1   g44(.a(x22), .O(new_n88_));
  nor2   g45(.a(new_n45_), .b(x01), .O(new_n89_));
  nand3  g46(.a(new_n89_), .b(x12), .c(new_n71_), .O(new_n90_));
  ...
  nor2   g52(.a(new_n51_), .b(new_n52_), .O(new_n96_));
  nand3  g53(.a(new_n96_), .b(new_n95_), .c(new_n61_), .O(new_n97_));
  ...
  nand4  g58(.a(new_n101_), .b(new_n61_), .c(x18), .d(x01), .O(new_n102_));
  inv1   g59(.a(x13), .O(new_n103_));
  nand4  g60(.a(new_n89_), .b(new_n103_), .c(x12), .d(new_n71_), .O(new_n104_));
  ...
  nand4  g65(.a(new_n96_), .b(x21), .c(new_n95_), .d(new_n61_), .O(new_n109_));
  ...
  nand3  g69(.a(new_n112_), .b(new_n88_), .c(new_n44_), .O(new_n113_));
  ...
  nand3  g74(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n52_), .c(new_n44_), .O(new_n120_));
  ...
  nand4  g81(.a(new_n47_), .b(new_n57_), .c(new_n46_), .d(new_n45_), .O(new_n125_));
  aoi21  g82(.a(new_n125_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g83(.a(x19), .b(new_n45_), .c(x00), .O(new_n127_));
  nand2  g84(.a(new_n115_), .b(x00), .O(new_n128_));
  oai21  g85(.a(new_n127_), .b(x01), .c(new_n128_), .O(z15));
  xor2a  g86(.a(x01), .b(x00), .O(z16));
