...
module FAU ( 
  ...
  aoi21  g37(.a(new_n80_), .b(x01), .c(new_n44_), .O(z07));
  inv1   g38(.a(x08), .O(new_n82_));
  inv1   g39(.a(x05), .O(new_n83_));
  inv1   g40(.a(x06), .O(new_n84_));
  inv1   g41(.a(x03), .O(new_n85_));
  nand4  g42(.a(new_n85_), .b(x02), .c(new_n52_), .d(new_n44_), .O(new_n86_));
  ...
  nand4  g62(.a(new_n105_), .b(new_n93_), .c(new_n92_), .d(new_n44_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(z09));
  nand4  g64(.a(new_n98_), .b(x12), .c(new_n78_), .d(x02), .O(new_n108_));
  nor2   g65(.a(x22), .b(x21), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(x20), .c(x16), .d(x15), .O(new_n110_));
  oai21  g67(.a(new_n110_), .b(new_n108_), .c(new_n44_), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(new_n52_), .O(new_n112_));
  nor2   g69(.a(new_n93_), .b(new_n92_), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n103_), .c(new_n100_), .d(new_n44_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n112_), .O(z10));
  nand4  g72(.a(new_n100_), .b(x21), .c(new_n101_), .d(new_n65_), .O(new_n116_));
  inv1   g73(.a(x13), .O(new_n117_));
  nand4  g74(.a(new_n94_), .b(new_n117_), .c(x12), .d(new_n78_), .O(new_n118_));
  ...
  nand3  g78(.a(new_n121_), .b(new_n93_), .c(new_n44_), .O(new_n122_));
  inv1   g79(.a(new_n122_), .O(z11));
  inv1   g80(.a(x24), .O(new_n124_));
  aoi21  g81(.a(x10), .b(x02), .c(new_n44_), .O(new_n125_));
  oai21  g82(.a(x19), .b(x02), .c(x23), .O(new_n126_));
  nand3  g83(.a(new_n65_), .b(x17), .c(new_n45_), .O(new_n127_));
  aoi21  g84(.a(new_n127_), .b(new_n126_), .c(x01), .O(new_n128_));
  oai21  g85(.a(new_n128_), .b(new_n125_), .c(new_n124_), .O(new_n129_));
  oai22  g86(.a(new_n129_), .b(new_n46_), .c(x01), .d(new_n44_), .O(z12));
  nor3   g87(.a(new_n53_), .b(x19), .c(new_n50_), .O(z13));
  nand4  g88(.a(new_n47_), .b(new_n58_), .c(new_n46_), .d(new_n45_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(new_n44_), .c(x01), .O(z14));
  inv1   g90(.a(new_n125_), .O(new_n134_));
  aoi21  g91(.a(x19), .b(new_n45_), .c(x00), .O(new_n135_));
  oai21  g92(.a(new_n135_), .b(x01), .c(new_n134_), .O(z15));
