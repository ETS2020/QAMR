...
module FAU ( 
  ...
  nor2   g32(.a(x09), .b(new_n45_), .O(new_n76_));
  nand4  g33(.a(new_n76_), .b(new_n75_), .c(x11), .d(x10), .O(new_n77_));
  ...
  nand3  g72(.a(new_n115_), .b(new_n90_), .c(new_n44_), .O(new_n116_));
  ...
  nand4  g84(.a(new_n46_), .b(new_n45_), .c(new_n52_), .d(new_n44_), .O(new_n128_));
  ...
  nor2   g91(.a(new_n52_), .b(x00), .O(z16));
