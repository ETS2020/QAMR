...
module FAU ( 
  ...
  nand4  g25(.a(new_n68_), .b(x10), .c(new_n67_), .d(x02), .O(new_n69_));
  ...
  nand4  g29(.a(x11), .b(x10), .c(new_n67_), .d(x02), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(x00), .c(new_n44_), .O(z06));
  ...
  nand4  g59(.a(new_n75_), .b(x02), .c(new_n44_), .d(new_n60_), .O(new_n103_));
  ...
  aoi21  g85(.a(new_n45_), .b(new_n44_), .c(x00), .O(z17));
  zero   g86(.O(z16));
endmodule
