...
module FAU ( 
  ...
  nand4  g08(.a(new_n47_), .b(new_n44_), .c(x10), .d(x09), .O(new_n52_));
  nor3   g09(.a(new_n52_), .b(x19), .c(x18), .O(z01));
  inv1   g10(.a(x00), .O(new_n54_));
  inv1   g11(.a(x02), .O(new_n55_));
  inv1   g12(.a(x10), .O(new_n56_));
  nor3   g13(.a(x19), .b(x18), .c(x17), .O(new_n57_));
  nand4  g14(.a(new_n57_), .b(new_n56_), .c(x09), .d(new_n55_), .O(new_n58_));
  aoi21  g15(.a(new_n58_), .b(new_n54_), .c(x01), .O(z02));
  inv1   g16(.a(x01), .O(new_n60_));
  nand3  g17(.a(new_n55_), .b(new_n60_), .c(new_n54_), .O(new_n61_));
  ...
  nor2   g25(.a(x09), .b(new_n55_), .O(new_n69_));
  nand4  g26(.a(new_n69_), .b(new_n68_), .c(new_n67_), .d(x10), .O(new_n70_));
  aoi21  g27(.a(new_n70_), .b(x01), .c(new_n54_), .O(z04));
  nand3  g28(.a(x10), .b(x09), .c(x02), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x01), .c(new_n54_), .O(z05));
  nand3  g30(.a(new_n69_), .b(x11), .c(x10), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(x01), .c(new_n54_), .O(z06));
  nand4  g32(.a(new_n69_), .b(new_n68_), .c(x11), .d(x10), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x01), .c(new_n54_), .O(z07));
  nor2   g34(.a(x03), .b(new_n55_), .O(new_n78_));
  ...
  aoi21  g41(.a(new_n84_), .b(new_n54_), .c(x01), .O(z08));
  nor2   g42(.a(x14), .b(x13), .O(new_n86_));
  nand4  g43(.a(new_n86_), .b(x12), .c(new_n67_), .d(x02), .O(new_n87_));
  ...
  oai21  g48(.a(new_n91_), .b(new_n87_), .c(new_n54_), .O(new_n92_));
  ...
  nor3   g61(.a(new_n104_), .b(new_n55_), .c(x01), .O(new_n105_));
  nor3   g62(.a(new_n89_), .b(new_n88_), .c(x14), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n105_), .c(new_n102_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n100_), .c(x00), .O(z10));
  nand4  g65(.a(new_n90_), .b(x20), .c(new_n89_), .d(x15), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n87_), .c(new_n54_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n60_), .O(new_n111_));
  inv1   g68(.a(x22), .O(new_n112_));
  nand4  g69(.a(new_n95_), .b(new_n94_), .c(new_n112_), .d(x21), .O(new_n113_));
  ...
  nand3  g75(.a(new_n62_), .b(x17), .c(new_n55_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n60_), .c(new_n54_), .O(new_n121_));
  ...
  nand3  g86(.a(new_n129_), .b(x19), .c(new_n55_), .O(new_n130_));
