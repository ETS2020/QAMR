...
module FAU ( 
  ...
  aoi21  g09(.a(new_n52_), .b(new_n44_), .c(x17), .O(z00));
  ...
  nand4  g17(.a(new_n60_), .b(new_n48_), .c(new_n57_), .d(new_n56_), .O(new_n61_));
  nor2   g18(.a(new_n61_), .b(x19), .O(z02));
  nand3  g19(.a(new_n46_), .b(new_n44_), .c(new_n45_), .O(new_n63_));
  nand3  g20(.a(new_n49_), .b(x18), .c(new_n57_), .O(new_n64_));
  nor2   g21(.a(new_n44_), .b(new_n45_), .O(new_n65_));
  nand3  g22(.a(new_n65_), .b(new_n47_), .c(x02), .O(new_n66_));
  nand4  g23(.a(x17), .b(x12), .c(x11), .d(x10), .O(new_n67_));
  oai22  g24(.a(new_n67_), .b(new_n66_), .c(new_n64_), .d(new_n63_), .O(z03));
  nand4  g25(.a(new_n65_), .b(x10), .c(new_n47_), .d(x02), .O(new_n69_));
  nor4   g26(.a(new_n69_), .b(new_n57_), .c(x12), .d(x11), .O(z04));
  nand4  g27(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n71_));
  aoi21  g28(.a(new_n71_), .b(x17), .c(new_n44_), .O(z05));
  inv1   g29(.a(x11), .O(new_n73_));
  nor3   g30(.a(new_n69_), .b(new_n57_), .c(new_n73_), .O(z06));
  ...
  nand2  g35(.a(new_n57_), .b(x01), .O(new_n79_));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n44_), .d(new_n45_), .O(new_n85_));
  ...
  nand4  g45(.a(new_n88_), .b(new_n48_), .c(x17), .d(new_n81_), .O(new_n89_));
  nor2   g46(.a(new_n89_), .b(new_n49_), .O(z08));
  ...
  nand4  g56(.a(new_n99_), .b(x18), .c(x17), .d(x01), .O(new_n100_));
  oai21  g57(.a(new_n98_), .b(new_n94_), .c(new_n100_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n92_), .c(new_n91_), .d(new_n45_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(z09));
  nand3  g60(.a(x18), .b(x17), .c(x01), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n99_), .c(x22), .d(x21), .O(new_n106_));
  nor2   g63(.a(x13), .b(new_n75_), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n93_), .c(new_n73_), .O(new_n108_));
  ...
  nand3  g70(.a(new_n113_), .b(new_n105_), .c(new_n49_), .O(new_n114_));
  ...
  nand3  g74(.a(new_n117_), .b(new_n92_), .c(new_n45_), .O(new_n118_));
  ...
  nand3  g80(.a(new_n123_), .b(new_n44_), .c(new_n45_), .O(new_n124_));
  aoi21  g81(.a(new_n124_), .b(new_n122_), .c(new_n57_), .O(new_n125_));
  inv1   g82(.a(x23), .O(new_n126_));
  nor4   g83(.a(new_n123_), .b(new_n126_), .c(x01), .d(x00), .O(new_n127_));
  oai21  g84(.a(new_n127_), .b(new_n125_), .c(new_n120_), .O(new_n128_));
  nor2   g85(.a(new_n128_), .b(new_n47_), .O(z12));
  nand2  g86(.a(new_n58_), .b(x17), .O(new_n130_));
  nor2   g87(.a(new_n130_), .b(x19), .O(z13));
  nand2  g88(.a(new_n58_), .b(new_n47_), .O(new_n132_));
  inv1   g89(.a(new_n132_), .O(new_n133_));
  nand4  g90(.a(new_n133_), .b(new_n48_), .c(new_n57_), .d(new_n56_), .O(new_n134_));
  nor2   g91(.a(new_n134_), .b(x19), .O(z14));
  oai21  g92(.a(x10), .b(new_n44_), .c(x02), .O(new_n136_));
  nand2  g93(.a(new_n136_), .b(x00), .O(new_n137_));
  nand3  g94(.a(x19), .b(new_n46_), .c(new_n44_), .O(new_n138_));
  nand3  g95(.a(new_n138_), .b(new_n137_), .c(new_n79_), .O(z15));
  nand3  g96(.a(x17), .b(x01), .c(new_n45_), .O(new_n140_));
  inv1   g97(.a(new_n140_), .O(z16));
  nand2  g98(.a(new_n93_), .b(new_n45_), .O(new_n142_));
  nand2  g99(.a(new_n142_), .b(new_n79_), .O(z17));
endmodule
