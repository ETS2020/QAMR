...
module FAU ( 
  ...
  nand2  g007(.a(x22), .b(x13), .O(new_n51_));
  ...
  nor3   g034(.a(new_n77_), .b(new_n44_), .c(new_n70_), .O(z05));
  nand3  g035(.a(x11), .b(x10), .c(new_n46_), .O(new_n79_));
  oai21  g036(.a(new_n79_), .b(new_n63_), .c(new_n51_), .O(z06));
  nand3  g037(.a(new_n65_), .b(new_n72_), .c(x11), .O(new_n81_));
  ...
  nand2  g042(.a(new_n85_), .b(new_n70_), .O(new_n86_));
  ...
  nand3  g053(.a(new_n85_), .b(x12), .c(new_n71_), .O(new_n97_));
  ...
  nand4  g077(.a(new_n85_), .b(new_n112_), .c(x12), .d(new_n71_), .O(new_n121_));
  ...
  nand3  g097(.a(new_n58_), .b(new_n46_), .c(new_n45_), .O(new_n141_));
