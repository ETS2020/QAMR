...
module FAU ( 
  ...
  nor3   g14(.a(x18), .b(x17), .c(x10), .O(new_n58_));
  nand4  g15(.a(new_n58_), .b(x09), .c(new_n48_), .d(new_n46_), .O(new_n59_));
  aoi21  g16(.a(new_n59_), .b(new_n47_), .c(x19), .O(z02));
  ...
  nand4  g20(.a(new_n49_), .b(x02), .c(x01), .d(x00), .O(new_n64_));
  inv1   g21(.a(x10), .O(new_n65_));
  inv1   g22(.a(x11), .O(new_n66_));
  nor2   g23(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g24(.a(new_n67_), .b(x19), .c(x12), .O(new_n68_));
  oai22  g25(.a(new_n68_), .b(new_n64_), .c(new_n63_), .d(new_n61_), .O(z03));
  inv1   g26(.a(x12), .O(new_n70_));
  nand3  g27(.a(x02), .b(x01), .c(x00), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(x09), .O(new_n72_));
  nand4  g29(.a(new_n72_), .b(new_n70_), .c(new_n66_), .d(x10), .O(new_n73_));
  nor2   g30(.a(new_n73_), .b(new_n62_), .O(z04));
  nor4   g31(.a(new_n71_), .b(new_n62_), .c(new_n65_), .d(new_n49_), .O(z05));
  nand4  g32(.a(new_n67_), .b(new_n49_), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x19), .c(new_n47_), .O(z06));
  nand2  g34(.a(x10), .b(new_n49_), .O(new_n78_));
  nand3  g35(.a(x19), .b(new_n70_), .c(x11), .O(new_n79_));
  ...
  nand3  g41(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n85_));
  ...
  nor4   g47(.a(new_n85_), .b(x13), .c(new_n70_), .d(x11), .O(new_n91_));
  ...
  nand2  g54(.a(new_n97_), .b(new_n83_), .O(z09));
  inv1   g55(.a(x15), .O(new_n99_));
  inv1   g56(.a(x13), .O(new_n100_));
  inv1   g57(.a(x14), .O(new_n101_));
  nand4  g58(.a(new_n66_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n101_), .c(new_n100_), .d(x12), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(new_n99_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n93_), .c(x20), .d(x16), .O(new_n106_));
  nor2   g63(.a(new_n106_), .b(x22), .O(z10));
  nor2   g64(.a(x16), .b(new_n99_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n96_), .c(new_n91_), .d(new_n101_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n83_), .O(z11));
  nand2  g67(.a(x10), .b(x02), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(x01), .c(x00), .O(new_n112_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g70(.a(new_n62_), .b(x17), .c(new_n48_), .O(new_n114_));
  oai21  g71(.a(new_n113_), .b(x01), .c(new_n114_), .O(new_n115_));
  ...
  nand3  g76(.a(x17), .b(new_n48_), .c(new_n46_), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n47_), .c(x19), .O(z13));
  nand4  g78(.a(new_n58_), .b(new_n49_), .c(new_n48_), .d(new_n46_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n47_), .c(x19), .O(z14));
  oai21  g80(.a(x10), .b(new_n47_), .c(x02), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(x00), .O(new_n125_));
  nand3  g82(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n126_));
  nand3  g83(.a(new_n126_), .b(new_n125_), .c(new_n83_), .O(z15));
  nand3  g84(.a(x19), .b(x01), .c(new_n46_), .O(new_n128_));
  inv1   g85(.a(new_n128_), .O(z16));
  nand2  g86(.a(new_n85_), .b(new_n83_), .O(z17));
endmodule
