...
module FAU ( 
  ...
  aoi21  g028(.a(new_n71_), .b(x17), .c(new_n67_), .O(z04));
  nand4  g029(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n73_));
  nor3   g030(.a(new_n73_), .b(new_n44_), .c(new_n56_), .O(z05));
  inv1   g031(.a(x00), .O(new_n75_));
  inv1   g032(.a(x02), .O(new_n76_));
  nor2   g033(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x11), .c(x10), .d(new_n46_), .O(new_n78_));
  aoi21  g035(.a(new_n78_), .b(x17), .c(new_n67_), .O(z06));
  ...
  nand2  g039(.a(new_n44_), .b(x01), .O(new_n83_));
  ...
  nand4  g045(.a(new_n88_), .b(x02), .c(new_n67_), .d(new_n75_), .O(new_n89_));
  ...
  nor2   g053(.a(new_n76_), .b(x01), .O(new_n97_));
  nand3  g054(.a(new_n97_), .b(x12), .c(new_n68_), .O(new_n98_));
  ...
  nand4  g060(.a(new_n103_), .b(x18), .c(x17), .d(x01), .O(new_n104_));
  ...
  nand3  g064(.a(x18), .b(x17), .c(x01), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n103_), .c(x22), .d(x21), .O(new_n110_));
  nor2   g067(.a(x13), .b(new_n69_), .O(new_n111_));
  nand3  g068(.a(new_n111_), .b(new_n97_), .c(new_n68_), .O(new_n112_));
  ...
  nand3  g074(.a(new_n117_), .b(new_n109_), .c(new_n63_), .O(new_n118_));
  ...
  nand3  g078(.a(new_n121_), .b(new_n96_), .c(new_n75_), .O(new_n122_));
  ...
  oai21  g095(.a(x10), .b(new_n67_), .c(x02), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(x00), .O(new_n140_));
  nand3  g097(.a(x19), .b(new_n76_), .c(new_n67_), .O(new_n141_));
  nand3  g098(.a(new_n141_), .b(new_n140_), .c(new_n83_), .O(z15));
  nand3  g099(.a(x17), .b(x01), .c(new_n75_), .O(new_n143_));
  inv1   g100(.a(new_n143_), .O(z16));
  nand2  g101(.a(new_n97_), .b(new_n75_), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(new_n83_), .O(z17));
endmodule
