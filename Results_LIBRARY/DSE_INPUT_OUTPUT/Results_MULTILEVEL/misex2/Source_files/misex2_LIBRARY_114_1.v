...
module FAU ( 
  ...
  nand2  g018(.a(new_n54_), .b(new_n52_), .O(new_n62_));
  ...
  nand2  g022(.a(new_n65_), .b(new_n53_), .O(new_n66_));
  ...
  nand2  g027(.a(x05), .b(new_n53_), .O(new_n71_));
  ...
  nor2   g033(.a(new_n76_), .b(new_n59_), .O(z05));
  nand3  g034(.a(x11), .b(x10), .c(new_n51_), .O(new_n78_));
  oai21  g035(.a(new_n78_), .b(new_n67_), .c(new_n71_), .O(z06));
  ...
  nand4  g044(.a(new_n87_), .b(x02), .c(new_n53_), .d(new_n52_), .O(new_n88_));
  inv1   g045(.a(new_n88_), .O(new_n89_));
  nand4  g046(.a(new_n89_), .b(new_n86_), .c(new_n44_), .d(x04), .O(new_n90_));
  nor2   g047(.a(new_n90_), .b(x07), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(new_n50_), .c(x17), .d(new_n85_), .O(new_n92_));
  nor2   g049(.a(new_n92_), .b(new_n63_), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nor2   g052(.a(new_n54_), .b(x01), .O(new_n96_));
  nor2   g053(.a(new_n73_), .b(x11), .O(new_n97_));
  ...
  nor2   g060(.a(new_n50_), .b(new_n53_), .O(new_n104_));
  nand3  g061(.a(new_n104_), .b(new_n103_), .c(new_n63_), .O(new_n105_));
  oai21  g062(.a(new_n102_), .b(new_n98_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n95_), .c(new_n94_), .d(new_n52_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n71_), .O(z09));
  nor3   g065(.a(new_n95_), .b(new_n94_), .c(x20), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n63_), .c(x18), .d(x01), .O(new_n110_));
  nand3  g067(.a(new_n44_), .b(x02), .c(new_n53_), .O(new_n111_));
  nor4   g068(.a(new_n111_), .b(x13), .c(new_n73_), .d(x11), .O(new_n112_));
  ...
  nand4  g073(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n63_), .O(new_n117_));
  inv1   g074(.a(x14), .O(new_n118_));
  nand2  g075(.a(x15), .b(new_n118_), .O(new_n119_));
  nand3  g076(.a(new_n94_), .b(x20), .c(new_n100_), .O(new_n120_));
  nor3   g077(.a(new_n120_), .b(new_n119_), .c(x13), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n97_), .c(new_n96_), .d(new_n44_), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n117_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n95_), .c(new_n52_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n63_), .b(x17), .c(new_n54_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(new_n53_), .c(new_n52_), .O(new_n131_));
  ...
  nor3   g091(.a(new_n55_), .b(x19), .c(new_n45_), .O(z13));
  nor2   g092(.a(new_n55_), .b(x09), .O(new_n136_));
  nand4  g093(.a(new_n136_), .b(new_n50_), .c(new_n45_), .d(new_n59_), .O(new_n137_));
  nor2   g094(.a(new_n137_), .b(x19), .O(z14));
  aoi21  g095(.a(new_n59_), .b(x01), .c(new_n54_), .O(new_n139_));
  aoi21  g096(.a(x19), .b(new_n54_), .c(x05), .O(new_n140_));
  oai22  g097(.a(new_n140_), .b(x01), .c(new_n139_), .d(new_n52_), .O(z15));
  nor2   g098(.a(new_n53_), .b(x00), .O(z16));
