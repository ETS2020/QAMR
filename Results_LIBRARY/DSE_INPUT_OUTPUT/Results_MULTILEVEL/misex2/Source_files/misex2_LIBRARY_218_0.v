...
module FAU ( 
  ...
  nand4  g15(.a(new_n48_), .b(x11), .c(x10), .d(new_n49_), .O(new_n61_));
  ...
  nand4  g29(.a(new_n74_), .b(x22), .c(x21), .d(new_n70_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(z10));
  inv1   g31(.a(x22), .O(new_n77_));
  nand4  g32(.a(new_n66_), .b(new_n77_), .c(x21), .d(new_n70_), .O(new_n78_));
  ...
  aoi21  g38(.a(new_n55_), .b(x01), .c(new_n83_), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(z16), .c(new_n57_), .O(z15));
  zero   g40(.O(z01));
  zero   g41(.O(z02));
