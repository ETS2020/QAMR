...
module FAU ( 
  ...
  nor3   g27(.a(new_n70_), .b(new_n46_), .c(new_n66_), .O(z05));
  inv1   g28(.a(new_n70_), .O(new_n72_));
  nand4  g29(.a(new_n72_), .b(x11), .c(x10), .d(new_n66_), .O(new_n73_));
  ...
  nand3  g63(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n44_), .c(new_n55_), .O(new_n109_));
  ...
  nand4  g70(.a(new_n48_), .b(new_n46_), .c(new_n66_), .d(new_n45_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g72(.a(new_n46_), .b(new_n55_), .c(x01), .O(new_n116_));
