...
module FAU ( 
  ...
  nand2  g008(.a(new_n51_), .b(x04), .O(new_n52_));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n44_), .d(new_n88_), .O(new_n90_));
  ...
  nand2  g054(.a(x02), .b(new_n44_), .O(new_n98_));
  ...
  nand3  g062(.a(new_n105_), .b(new_n51_), .c(new_n50_), .O(new_n106_));
  oai21  g063(.a(new_n104_), .b(new_n100_), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n97_), .c(new_n96_), .d(new_n88_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n52_), .O(z09));
  nand3  g066(.a(new_n50_), .b(x18), .c(x01), .O(new_n110_));
  nor4   g067(.a(new_n110_), .b(new_n97_), .c(new_n96_), .d(x20), .O(new_n111_));
  nor2   g068(.a(x13), .b(new_n72_), .O(new_n112_));
  nand3  g069(.a(new_n112_), .b(new_n99_), .c(new_n71_), .O(new_n113_));
  ...
  nand4  g075(.a(new_n105_), .b(x21), .c(new_n51_), .d(new_n50_), .O(new_n119_));
  nor2   g076(.a(new_n101_), .b(x14), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n96_), .c(x20), .d(new_n102_), .O(new_n121_));
  oai21  g078(.a(new_n121_), .b(new_n113_), .c(new_n119_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n97_), .c(new_n88_), .O(new_n123_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n44_), .c(new_n88_), .O(new_n131_));
  ...
  inv1   g091(.a(new_n57_), .O(new_n135_));
  ...
  aoi21  g099(.a(new_n142_), .b(new_n141_), .c(new_n63_), .O(z15));
  oai21  g100(.a(new_n44_), .b(x00), .c(new_n52_), .O(z16));
  nand4  g101(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n88_), .O(new_n145_));
