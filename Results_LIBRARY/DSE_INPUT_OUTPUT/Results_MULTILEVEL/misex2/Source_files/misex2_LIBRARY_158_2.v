...
module FAU ( 
  ...
  nand3  g09(.a(new_n45_), .b(new_n52_), .c(new_n44_), .O(new_n53_));
  ...
  nand3  g17(.a(new_n45_), .b(new_n52_), .c(new_n44_), .O(new_n61_));
  ...
  nand3  g30(.a(new_n69_), .b(x11), .c(x10), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(x01), .c(new_n44_), .O(z06));
  nand4  g32(.a(new_n69_), .b(new_n68_), .c(x11), .d(x10), .O(new_n76_));
  ...
  nand4  g45(.a(new_n88_), .b(x12), .c(new_n67_), .d(x02), .O(new_n89_));
  ...
  oai21  g51(.a(new_n94_), .b(new_n89_), .c(new_n44_), .O(new_n95_));
  nand2  g52(.a(new_n95_), .b(new_n52_), .O(new_n96_));
  nor3   g53(.a(new_n51_), .b(new_n52_), .c(x00), .O(new_n97_));
  ...
  oai21  g58(.a(new_n101_), .b(new_n89_), .c(new_n44_), .O(new_n102_));
  nand2  g59(.a(new_n102_), .b(new_n52_), .O(new_n103_));
  ...
  oai21  g64(.a(new_n107_), .b(new_n89_), .c(new_n44_), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(new_n52_), .O(new_n109_));
  ...
  nand3  g72(.a(new_n62_), .b(x17), .c(new_n45_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n115_), .c(x01), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n114_), .c(new_n113_), .O(new_n118_));
  oai22  g75(.a(new_n118_), .b(new_n46_), .c(x01), .d(new_n44_), .O(z12));
  nor3   g76(.a(new_n53_), .b(x19), .c(new_n50_), .O(z13));
  nand4  g77(.a(new_n47_), .b(new_n58_), .c(new_n46_), .d(new_n45_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n44_), .c(x01), .O(z14));
  inv1   g79(.a(new_n114_), .O(new_n123_));
  aoi21  g80(.a(x19), .b(new_n45_), .c(x00), .O(new_n124_));
  oai21  g81(.a(new_n124_), .b(x01), .c(new_n123_), .O(z15));
  nor2   g82(.a(new_n52_), .b(x00), .O(z16));
  nand3  g83(.a(x02), .b(new_n52_), .c(new_n44_), .O(new_n127_));
