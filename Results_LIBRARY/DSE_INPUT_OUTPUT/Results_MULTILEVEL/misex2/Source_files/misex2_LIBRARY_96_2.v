...
module FAU ( 
  ...
  oai21  g60(.a(new_n98_), .b(new_n94_), .c(new_n103_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n91_), .c(new_n90_), .d(new_n44_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(z09));
  nand4  g63(.a(new_n97_), .b(x12), .c(new_n92_), .d(x02), .O(new_n107_));
  nor2   g64(.a(x22), .b(x21), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(x20), .c(x16), .d(x15), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n107_), .c(new_n44_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n60_), .O(new_n111_));
  nor2   g68(.a(new_n91_), .b(new_n90_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n102_), .c(new_n99_), .d(new_n44_), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n111_), .O(z10));
  nand4  g71(.a(new_n99_), .b(x21), .c(new_n100_), .d(new_n65_), .O(new_n115_));
  inv1   g72(.a(x13), .O(new_n116_));
  nand4  g73(.a(new_n93_), .b(new_n116_), .c(x12), .d(new_n92_), .O(new_n117_));
  nor2   g74(.a(new_n95_), .b(x14), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n90_), .c(x20), .d(new_n96_), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n117_), .c(new_n115_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n91_), .c(new_n44_), .O(new_n121_));
  ...
  nand3  g82(.a(new_n65_), .b(x17), .c(new_n45_), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand3  g84(.a(new_n127_), .b(new_n60_), .c(new_n44_), .O(new_n128_));
  aoi21  g85(.a(new_n128_), .b(new_n124_), .c(x24), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x09), .O(new_n130_));
  inv1   g87(.a(new_n130_), .O(z12));
  aoi21  g88(.a(new_n126_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g89(.a(new_n47_), .b(new_n52_), .c(new_n46_), .d(new_n45_), .O(new_n133_));
