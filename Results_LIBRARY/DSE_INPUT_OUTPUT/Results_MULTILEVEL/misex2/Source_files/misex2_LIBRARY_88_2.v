...
module FAU ( 
  ...
  nand3  g21(.a(new_n56_), .b(x18), .c(new_n44_), .O(new_n65_));
  nand4  g22(.a(x04), .b(x02), .c(x01), .d(x00), .O(new_n66_));
  ...
  aoi21  g28(.a(new_n71_), .b(x04), .c(new_n62_), .O(z04));
  nand4  g29(.a(x04), .b(x02), .c(x01), .d(x00), .O(new_n73_));
  nor3   g30(.a(new_n73_), .b(new_n59_), .c(new_n47_), .O(z05));
  ...
  nand4  g37(.a(new_n80_), .b(x04), .c(x02), .d(x00), .O(new_n81_));
  ...
  nand4  g43(.a(new_n86_), .b(x02), .c(new_n63_), .d(new_n62_), .O(new_n87_));
  ...
  nor2   g48(.a(new_n91_), .b(new_n56_), .O(z08));
  ...
  nor2   g59(.a(new_n45_), .b(new_n63_), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(new_n102_), .c(new_n56_), .O(new_n104_));
  oai21  g61(.a(new_n101_), .b(new_n97_), .c(new_n104_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n94_), .c(new_n93_), .d(new_n62_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(z09));
  nor3   g64(.a(new_n94_), .b(new_n93_), .c(x20), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n56_), .c(x18), .d(x01), .O(new_n109_));
  nor2   g66(.a(x13), .b(new_n78_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n96_), .c(new_n95_), .O(new_n111_));
  nor3   g68(.a(new_n99_), .b(new_n98_), .c(x14), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n94_), .c(new_n93_), .d(x20), .O(new_n113_));
  or2    g70(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n109_), .c(x00), .O(z10));
  nand4  g72(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n56_), .O(new_n116_));
  ...
  nand3  g76(.a(new_n119_), .b(new_n94_), .c(new_n62_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n54_), .O(z11));
  ...
  nand4  g89(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n133_));
  nor2   g90(.a(new_n133_), .b(x19), .O(z14));
  aoi21  g91(.a(x19), .b(new_n63_), .c(x00), .O(new_n135_));
  aoi21  g92(.a(new_n59_), .b(x01), .c(new_n53_), .O(new_n136_));
  oai22  g93(.a(new_n136_), .b(new_n62_), .c(new_n135_), .d(x02), .O(z15));
  nor2   g94(.a(new_n63_), .b(x00), .O(z16));
