...
module FAU ( 
  ...
  nand3  g26(.a(new_n69_), .b(x10), .c(new_n64_), .O(new_n70_));
  ...
  nand4  g34(.a(new_n77_), .b(x11), .c(x10), .d(new_n64_), .O(new_n78_));
  ...
  nand4  g63(.a(new_n106_), .b(new_n100_), .c(x20), .d(x16), .O(new_n107_));
  nor2   g64(.a(new_n107_), .b(x22), .O(z10));
  inv1   g65(.a(x16), .O(new_n109_));
  nand4  g66(.a(new_n106_), .b(new_n100_), .c(x20), .d(new_n109_), .O(new_n110_));
  ...
  nor3   g77(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g78(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n122_));
  nor2   g79(.a(new_n122_), .b(x19), .O(z14));
  oai21  g80(.a(new_n57_), .b(new_n46_), .c(x01), .O(new_n124_));
  oai21  g81(.a(x19), .b(x00), .c(new_n48_), .O(new_n125_));
