...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n69_, new_n70_, new_n73_, new_n74_, new_n76_, new_n77_, new_n79_,
  ...
  nor3   g28(.a(new_n68_), .b(new_n57_), .c(new_n46_), .O(z05));
  nor2   g29(.a(x09), .b(new_n45_), .O(new_n73_));
  nand3  g30(.a(new_n73_), .b(x11), .c(x10), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(x01), .c(new_n44_), .O(z06));
  nor2   g32(.a(x12), .b(new_n67_), .O(new_n76_));
  nand3  g33(.a(new_n76_), .b(new_n73_), .c(x10), .O(new_n77_));
  ...
  nor2   g44(.a(new_n87_), .b(new_n62_), .O(z08));
  nor2   g45(.a(x14), .b(x13), .O(new_n89_));
  nand4  g46(.a(new_n89_), .b(x12), .c(new_n67_), .d(x02), .O(new_n90_));
  ...
  nand3  g52(.a(new_n95_), .b(new_n92_), .c(new_n91_), .O(new_n96_));
  oai21  g53(.a(new_n96_), .b(new_n90_), .c(new_n44_), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(new_n60_), .O(new_n98_));
  nor3   g55(.a(new_n51_), .b(new_n60_), .c(x00), .O(new_n99_));
  nor2   g56(.a(x20), .b(x19), .O(new_n100_));
  nand3  g57(.a(new_n100_), .b(new_n99_), .c(new_n93_), .O(new_n101_));
  nand2  g58(.a(new_n101_), .b(new_n98_), .O(z09));
  nand2  g59(.a(x22), .b(x21), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(x20), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n62_), .c(x18), .d(x01), .O(new_n105_));
  inv1   g62(.a(x13), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(x12), .c(new_n67_), .O(new_n107_));
  nor3   g64(.a(new_n107_), .b(new_n45_), .c(x01), .O(new_n108_));
  nor3   g65(.a(new_n92_), .b(new_n91_), .c(x14), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n108_), .c(new_n95_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n105_), .c(x00), .O(z10));
  nand3  g68(.a(new_n95_), .b(new_n92_), .c(x15), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n90_), .c(new_n44_), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n60_), .O(new_n114_));
  inv1   g71(.a(x22), .O(new_n115_));
  nand4  g72(.a(new_n100_), .b(new_n99_), .c(new_n115_), .d(x21), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n114_), .O(z11));
  nand2  g74(.a(x10), .b(x02), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(x01), .c(x00), .O(new_n119_));
  oai21  g76(.a(x19), .b(x02), .c(x23), .O(new_n120_));
  nand3  g77(.a(new_n62_), .b(x17), .c(new_n45_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n60_), .c(new_n44_), .O(new_n123_));
  aoi21  g80(.a(new_n123_), .b(new_n119_), .c(x24), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(x09), .O(new_n125_));
  inv1   g82(.a(new_n125_), .O(z12));
  nand2  g83(.a(new_n52_), .b(x17), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(x19), .O(z13));
  nand2  g85(.a(new_n52_), .b(new_n46_), .O(new_n129_));
  inv1   g86(.a(new_n129_), .O(new_n130_));
  nand4  g87(.a(new_n130_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n131_));
  nor2   g88(.a(new_n131_), .b(x19), .O(z14));
  nand4  g89(.a(x19), .b(new_n45_), .c(new_n60_), .d(new_n44_), .O(new_n133_));
  nand2  g90(.a(new_n133_), .b(new_n119_), .O(z15));
  xor2a  g91(.a(x01), .b(x00), .O(z16));
