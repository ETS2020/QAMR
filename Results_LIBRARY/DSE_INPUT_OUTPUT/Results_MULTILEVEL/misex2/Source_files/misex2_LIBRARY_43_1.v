...
module FAU ( 
  ...
  nand4  g032(.a(new_n75_), .b(new_n73_), .c(x10), .d(new_n54_), .O(new_n76_));
  nor2   g033(.a(new_n76_), .b(x12), .O(z04));
  nand2  g034(.a(x01), .b(x00), .O(new_n78_));
  nand2  g035(.a(x03), .b(new_n47_), .O(new_n79_));
  nand3  g036(.a(x10), .b(x09), .c(x02), .O(new_n80_));
  oai21  g037(.a(new_n80_), .b(new_n78_), .c(new_n79_), .O(z05));
  nand3  g038(.a(x11), .b(x10), .c(new_n54_), .O(new_n82_));
  oai21  g039(.a(new_n82_), .b(new_n69_), .c(new_n79_), .O(z06));
  nor2   g040(.a(x12), .b(new_n73_), .O(new_n84_));
  nand2  g041(.a(new_n84_), .b(new_n70_), .O(new_n85_));
  nand2  g042(.a(new_n85_), .b(x01), .O(new_n86_));
  nand3  g043(.a(new_n86_), .b(x02), .c(x00), .O(new_n87_));
  nand2  g044(.a(new_n87_), .b(new_n79_), .O(z07));
  nor2   g045(.a(new_n48_), .b(x00), .O(new_n89_));
  ...
  nand4  g055(.a(x12), .b(new_n73_), .c(x02), .d(new_n47_), .O(new_n99_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n65_), .c(x18), .d(x01), .O(new_n105_));
  ...
  nand2  g064(.a(new_n107_), .b(new_n79_), .O(z09));
  ...
  nand2  g068(.a(x02), .b(new_n47_), .O(new_n112_));
  ...
  nor2   g078(.a(new_n45_), .b(new_n47_), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(x21), .c(new_n104_), .d(new_n65_), .O(new_n123_));
  inv1   g080(.a(new_n112_), .O(new_n124_));
  nand3  g081(.a(x12), .b(new_n73_), .c(new_n49_), .O(new_n125_));
  inv1   g082(.a(new_n125_), .O(new_n126_));
  nand3  g083(.a(x15), .b(new_n116_), .c(new_n113_), .O(new_n127_));
  inv1   g084(.a(new_n127_), .O(new_n128_));
  nand3  g085(.a(new_n97_), .b(x20), .c(new_n101_), .O(new_n129_));
  inv1   g086(.a(new_n129_), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(new_n128_), .c(new_n126_), .d(new_n124_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n123_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n98_), .c(new_n46_), .O(new_n133_));
  inv1   g090(.a(new_n133_), .O(z11));
  inv1   g091(.a(x24), .O(new_n135_));
  aoi21  g092(.a(x10), .b(x02), .c(new_n47_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(x00), .O(new_n137_));
  oai21  g094(.a(x19), .b(x02), .c(x23), .O(new_n138_));
  nand3  g095(.a(new_n65_), .b(x17), .c(new_n48_), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand3  g097(.a(new_n140_), .b(new_n47_), .c(new_n46_), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(new_n137_), .O(new_n142_));
  nand3  g099(.a(new_n142_), .b(new_n135_), .c(x09), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(new_n79_), .O(z12));
  nand4  g101(.a(new_n65_), .b(x17), .c(new_n48_), .d(new_n46_), .O(new_n145_));
  aoi21  g102(.a(new_n145_), .b(new_n49_), .c(x01), .O(z13));
  nor3   g103(.a(x09), .b(x02), .c(x00), .O(new_n147_));
  nand4  g104(.a(new_n147_), .b(new_n58_), .c(new_n44_), .d(new_n56_), .O(new_n148_));
  aoi21  g105(.a(new_n148_), .b(new_n49_), .c(x01), .O(z14));
  aoi21  g106(.a(new_n49_), .b(new_n48_), .c(new_n136_), .O(new_n150_));
  nand4  g107(.a(x19), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n151_));
  oai21  g108(.a(new_n150_), .b(new_n46_), .c(new_n151_), .O(z15));
  oai21  g109(.a(new_n47_), .b(x00), .c(new_n79_), .O(z16));
  nand4  g110(.a(new_n49_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n154_));
