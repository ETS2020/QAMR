...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_, new_n55_,
    ...
    new_n75_, new_n77_, new_n79_, new_n80_, new_n83_;
  ...
  oai21  g13(.a(x02), .b(new_n58_), .c(new_n59_), .O(new_n60_));
  nand3  g14(.a(new_n48_), .b(x02), .c(x00), .O(new_n61_));
  nand3  g15(.a(new_n47_), .b(x11), .c(x10), .O(new_n62_));
  oai21  g16(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(z07));
  inv1   g17(.a(x20), .O(new_n65_));
  inv1   g18(.a(x21), .O(new_n66_));
  inv1   g19(.a(x22), .O(new_n67_));
  inv1   g20(.a(x19), .O(new_n68_));
  nand4  g21(.a(new_n68_), .b(x18), .c(x01), .d(new_n58_), .O(new_n69_));
  inv1   g22(.a(new_n69_), .O(new_n70_));
  nand4  g23(.a(new_n70_), .b(new_n67_), .c(new_n66_), .d(new_n65_), .O(new_n71_));
  inv1   g24(.a(new_n71_), .O(z09));
  inv1   g25(.a(x18), .O(new_n73_));
  nor2   g26(.a(x19), .b(new_n73_), .O(new_n74_));
  nand4  g27(.a(new_n74_), .b(x22), .c(x21), .d(new_n65_), .O(new_n75_));
  aoi21  g28(.a(new_n75_), .b(x01), .c(x00), .O(z10));
  nand4  g29(.a(new_n74_), .b(new_n67_), .c(x21), .d(new_n65_), .O(new_n77_));
  aoi21  g30(.a(new_n77_), .b(x01), .c(x00), .O(z11));
  aoi21  g31(.a(x10), .b(x02), .c(x24), .O(new_n79_));
  nand3  g32(.a(new_n79_), .b(x09), .c(x01), .O(new_n80_));
  nor2   g33(.a(new_n80_), .b(new_n58_), .O(z12));
  nor2   g34(.a(x01), .b(x00), .O(z13));
  nand2  g35(.a(new_n55_), .b(x01), .O(new_n83_));
  aoi21  g36(.a(new_n83_), .b(x02), .c(new_n58_), .O(z15));
  nor2   g37(.a(new_n59_), .b(x00), .O(z16));
  zero   g38(.O(z00));
  zero   g39(.O(z01));
  zero   g40(.O(z02));
  zero   g41(.O(z08));
