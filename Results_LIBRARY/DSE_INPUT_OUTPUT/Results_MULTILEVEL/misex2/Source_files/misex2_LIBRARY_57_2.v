...
module FAU ( 
  ...
  nor2   g27(.a(x09), .b(new_n46_), .O(new_n71_));
  nand4  g28(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(x10), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x01), .c(new_n57_), .O(z04));
  ...
  aoi21  g33(.a(new_n76_), .b(x01), .c(new_n57_), .O(z06));
  nand4  g34(.a(new_n71_), .b(new_n70_), .c(x11), .d(x10), .O(new_n78_));
  aoi21  g35(.a(new_n78_), .b(x01), .c(new_n57_), .O(z07));
  ...
  oai21  g54(.a(new_n97_), .b(new_n91_), .c(new_n57_), .O(new_n98_));
  nand2  g55(.a(new_n98_), .b(new_n62_), .O(new_n99_));
  nor3   g56(.a(new_n45_), .b(new_n62_), .c(x00), .O(new_n100_));
  nor2   g57(.a(x20), .b(x19), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n100_), .c(new_n94_), .O(new_n102_));
  nand2  g59(.a(new_n102_), .b(new_n99_), .O(z09));
  ...
  nand2  g63(.a(x02), .b(new_n62_), .O(new_n107_));
  nor4   g64(.a(new_n107_), .b(x13), .c(new_n70_), .d(x11), .O(new_n108_));
  nor3   g65(.a(new_n93_), .b(new_n92_), .c(x14), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n108_), .c(new_n96_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n106_), .c(x00), .O(z10));
  nand3  g68(.a(new_n96_), .b(new_n93_), .c(x15), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n91_), .c(new_n57_), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n62_), .O(new_n114_));
  inv1   g71(.a(x22), .O(new_n115_));
  nand4  g72(.a(new_n101_), .b(new_n100_), .c(new_n115_), .d(x21), .O(new_n116_));
  ...
  nand4  g84(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n128_));
