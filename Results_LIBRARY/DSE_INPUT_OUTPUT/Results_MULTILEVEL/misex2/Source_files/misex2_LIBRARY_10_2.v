...
module FAU ( 
  ...
  aoi21  g030(.a(new_n73_), .b(x16), .c(new_n69_), .O(z04));
  nand3  g031(.a(x02), .b(x01), .c(x00), .O(new_n75_));
  nor4   g032(.a(new_n75_), .b(new_n44_), .c(new_n59_), .d(new_n47_), .O(z05));
  ...
  nand4  g052(.a(new_n95_), .b(x12), .c(new_n70_), .d(x02), .O(new_n96_));
  inv1   g053(.a(x14), .O(new_n97_));
  inv1   g054(.a(x15), .O(new_n98_));
  nand4  g055(.a(x20), .b(new_n44_), .c(new_n98_), .d(new_n97_), .O(new_n99_));
  ...
  nand3  g066(.a(new_n95_), .b(x12), .c(new_n70_), .O(new_n110_));
  ...
  nand4  g073(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n52_), .O(new_n117_));
  nor2   g074(.a(new_n98_), .b(x14), .O(new_n118_));
  nor2   g075(.a(x21), .b(new_n100_), .O(new_n119_));
  nand3  g076(.a(new_n119_), .b(new_n118_), .c(new_n44_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(new_n96_), .c(new_n117_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n94_), .c(new_n84_), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n45_), .O(z11));
  inv1   g080(.a(x24), .O(new_n124_));
  nand2  g081(.a(x10), .b(x02), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(x16), .c(x01), .d(x00), .O(new_n126_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n69_), .c(new_n84_), .O(new_n130_));
  ...
  nand4  g094(.a(new_n137_), .b(new_n51_), .c(new_n50_), .d(new_n59_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x19), .O(z14));
  oai21  g096(.a(x10), .b(new_n69_), .c(x02), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(x00), .O(new_n141_));
  nand3  g098(.a(x19), .b(new_n46_), .c(new_n69_), .O(new_n142_));
  nand3  g099(.a(new_n142_), .b(new_n141_), .c(new_n45_), .O(z15));
  nand3  g100(.a(x16), .b(x01), .c(new_n84_), .O(new_n144_));
  inv1   g101(.a(new_n144_), .O(z16));
  nand2  g102(.a(new_n85_), .b(new_n45_), .O(z17));
endmodule
