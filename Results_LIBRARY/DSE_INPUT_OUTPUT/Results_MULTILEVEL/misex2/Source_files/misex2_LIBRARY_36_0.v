...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    new_n55_, new_n56_, new_n58_, new_n61_, new_n62_, new_n63_, new_n66_,
    new_n67_, new_n68_, new_n69_, new_n70_, new_n71_, new_n72_, new_n74_,
    new_n75_, new_n77_, new_n79_, new_n80_, new_n83_, new_n84_;
  ...
  nand3  g18(.a(new_n52_), .b(x11), .c(x10), .O(new_n63_));
  ...
  nand4  g24(.a(new_n69_), .b(x18), .c(x01), .d(z16), .O(new_n70_));
  inv1   g25(.a(new_n70_), .O(new_n71_));
  nand4  g26(.a(new_n71_), .b(new_n68_), .c(new_n67_), .d(new_n66_), .O(new_n72_));
  inv1   g27(.a(new_n72_), .O(z09));
  nor2   g28(.a(new_n68_), .b(new_n67_), .O(new_n74_));
  nand4  g29(.a(new_n74_), .b(new_n66_), .c(new_n69_), .d(x18), .O(new_n75_));
  aoi21  g30(.a(new_n75_), .b(x01), .c(x00), .O(z10));
  nand4  g31(.a(new_n71_), .b(new_n68_), .c(x21), .d(new_n66_), .O(new_n77_));
