...
module FAU ( 
  ...
  nand4  g30(.a(new_n76_), .b(x22), .c(x21), .d(new_n73_), .O(new_n77_));
  inv1   g31(.a(new_n77_), .O(z10));
  inv1   g32(.a(x22), .O(new_n79_));
  nand4  g33(.a(new_n69_), .b(new_n79_), .c(x21), .d(new_n73_), .O(new_n80_));
  ...
  nand2  g38(.a(new_n58_), .b(x01), .O(new_n86_));
