...
module FAU ( 
  ...
  nand4  g24(.a(x13), .b(x12), .c(x11), .d(x10), .O(new_n68_));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n63_), .d(new_n62_), .O(new_n85_));
  ...
  nand4  g56(.a(new_n99_), .b(x18), .c(x13), .d(x01), .O(new_n100_));
  oai21  g57(.a(new_n98_), .b(new_n94_), .c(new_n100_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n92_), .c(new_n91_), .d(new_n62_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(z09));
  nand3  g60(.a(x18), .b(x13), .c(x01), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n99_), .c(x22), .d(x21), .O(new_n106_));
  nand4  g63(.a(new_n93_), .b(new_n44_), .c(x12), .d(new_n74_), .O(new_n107_));
  nor3   g64(.a(new_n96_), .b(new_n95_), .c(x14), .O(new_n108_));
  ...
  nor2   g68(.a(new_n91_), .b(x20), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n105_), .c(new_n52_), .O(new_n113_));
  ...
  nand3  g73(.a(new_n116_), .b(new_n92_), .c(new_n62_), .O(new_n117_));
  ...
  aoi22  g90(.a(new_n45_), .b(x00), .c(x19), .d(new_n63_), .O(new_n134_));
  nand3  g91(.a(new_n66_), .b(x13), .c(new_n57_), .O(new_n135_));
  oai21  g92(.a(new_n134_), .b(x02), .c(new_n135_), .O(z15));
  aoi21  g93(.a(x13), .b(x00), .c(new_n63_), .O(z16));
  nand2  g94(.a(new_n93_), .b(new_n62_), .O(new_n138_));
