...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_, new_n54_,
    new_n55_, new_n56_, new_n58_, new_n60_, new_n62_, new_n63_, new_n64_,
  ...
  nand4  g29(.a(new_n68_), .b(new_n75_), .c(x21), .d(new_n72_), .O(new_n76_));
  aoi21  g30(.a(new_n76_), .b(x01), .c(x00), .O(z11));
  aoi21  g31(.a(x10), .b(x02), .c(x24), .O(new_n78_));
  nand4  g32(.a(new_n78_), .b(x09), .c(x01), .d(x00), .O(new_n79_));
  nand2  g33(.a(new_n79_), .b(new_n53_), .O(z12));
  inv1   g34(.a(x00), .O(new_n82_));
  inv1   g35(.a(x02), .O(new_n83_));
  aoi21  g36(.a(new_n58_), .b(x01), .c(new_n83_), .O(new_n84_));
  oai21  g37(.a(new_n84_), .b(new_n82_), .c(new_n53_), .O(z15));
