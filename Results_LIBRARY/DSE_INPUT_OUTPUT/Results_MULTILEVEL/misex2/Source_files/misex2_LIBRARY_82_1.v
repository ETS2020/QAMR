...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n69_, new_n72_, new_n74_, new_n77_, new_n78_, new_n79_, new_n80_,
  ...
  nand2  g32(.a(x02), .b(new_n52_), .O(new_n77_));
  nand3  g33(.a(x18), .b(x01), .c(new_n45_), .O(new_n78_));
  nor2   g34(.a(x20), .b(x19), .O(new_n79_));
  nor2   g35(.a(x22), .b(x21), .O(new_n80_));
  nand2  g36(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  oai21  g37(.a(new_n81_), .b(new_n78_), .c(new_n77_), .O(z09));
  nand3  g38(.a(new_n79_), .b(x22), .c(x21), .O(new_n83_));
  oai21  g39(.a(new_n83_), .b(new_n78_), .c(new_n77_), .O(z10));
  inv1   g40(.a(x22), .O(new_n85_));
  nand3  g41(.a(new_n79_), .b(new_n85_), .c(x21), .O(new_n86_));
  oai21  g42(.a(new_n86_), .b(new_n78_), .c(new_n77_), .O(z11));
  ...
  oai21  g47(.a(x19), .b(new_n50_), .c(new_n91_), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n44_), .c(new_n52_), .d(new_n45_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(new_n88_), .c(x09), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(z12));
  nand3  g52(.a(new_n60_), .b(x17), .c(new_n45_), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g54(.a(new_n47_), .b(new_n57_), .c(new_n46_), .d(new_n45_), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(new_n44_), .c(x01), .O(z14));
  nand2  g56(.a(new_n89_), .b(x00), .O(new_n101_));
  oai21  g57(.a(x19), .b(x02), .c(new_n52_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n101_), .O(z15));
  oai21  g59(.a(new_n52_), .b(x00), .c(new_n77_), .O(z16));
  zero   g60(.O(z08));
  zero   g61(.O(z17));
endmodule
