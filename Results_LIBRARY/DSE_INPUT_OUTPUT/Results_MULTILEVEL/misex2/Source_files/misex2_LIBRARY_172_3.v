...
module FAU ( 
  ...
  nand2  g21(.a(new_n64_), .b(new_n44_), .O(new_n65_));
  oai21  g22(.a(new_n65_), .b(new_n63_), .c(new_n53_), .O(z03));
  inv1   g23(.a(new_n53_), .O(z06));
  aoi21  g24(.a(new_n46_), .b(new_n62_), .c(new_n61_), .O(z07));
  ...
  nand4  g54(.a(new_n99_), .b(new_n64_), .c(new_n84_), .d(x01), .O(new_n100_));
  ...
  nand4  g64(.a(new_n109_), .b(x21), .c(new_n84_), .d(new_n55_), .O(new_n110_));
  nor2   g65(.a(new_n101_), .b(x14), .O(new_n111_));
  nor2   g66(.a(x21), .b(new_n84_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n102_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n108_), .c(new_n110_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n86_), .c(new_n61_), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(z11));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n55_), .b(x17), .c(new_n46_), .O(new_n118_));
  aoi21  g73(.a(new_n118_), .b(new_n117_), .c(x24), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(x09), .c(new_n62_), .d(new_n61_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n53_), .O(z12));
  ...
  oai21  g79(.a(new_n124_), .b(new_n59_), .c(new_n53_), .O(z14));
  nor2   g80(.a(x19), .b(x00), .O(new_n126_));
  nor3   g81(.a(new_n126_), .b(x02), .c(x01), .O(z15));
  nand2  g82(.a(new_n48_), .b(x02), .O(new_n128_));
