...
module FAU ( 
  ...
  nand4  g61(.a(new_n106_), .b(x21), .c(new_n82_), .d(new_n55_), .O(new_n107_));
  nand3  g62(.a(new_n90_), .b(new_n70_), .c(new_n88_), .O(new_n108_));
  nor2   g63(.a(new_n101_), .b(x14), .O(new_n109_));
  nor2   g64(.a(x21), .b(new_n82_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n102_), .O(new_n111_));
  oai21  g66(.a(new_n111_), .b(new_n108_), .c(new_n107_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n84_), .c(new_n69_), .O(new_n113_));
  inv1   g68(.a(new_n113_), .O(z11));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n115_));
  nand3  g70(.a(new_n55_), .b(x17), .c(new_n46_), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(new_n115_), .c(x24), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(x09), .c(new_n66_), .d(new_n69_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n53_), .O(z12));
  nor3   g74(.a(new_n61_), .b(x19), .c(new_n44_), .O(z13));
  nand3  g75(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n59_), .c(new_n53_), .O(z14));
  nor2   g77(.a(x19), .b(x00), .O(new_n123_));
  nor3   g78(.a(new_n123_), .b(x02), .c(x01), .O(z15));
  nor2   g79(.a(new_n66_), .b(x00), .O(z16));
  nand2  g80(.a(new_n71_), .b(new_n53_), .O(z17));
  zero   g81(.O(z04));
  zero   g82(.O(z06));
endmodule
