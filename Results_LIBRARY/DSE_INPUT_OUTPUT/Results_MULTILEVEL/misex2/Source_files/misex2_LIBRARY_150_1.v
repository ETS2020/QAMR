...
module FAU ( 
  ...
  inv1   g021(.a(x24), .O(new_n65_));
  nor2   g022(.a(new_n65_), .b(x08), .O(new_n66_));
  ...
  inv1   g048(.a(new_n57_), .O(new_n92_));
  ...
  aoi21  g055(.a(new_n98_), .b(new_n65_), .c(x08), .O(z08));
  ...
  nand2  g069(.a(new_n112_), .b(new_n52_), .O(z09));
  ...
  nand3  g079(.a(new_n122_), .b(new_n52_), .c(new_n75_), .O(new_n123_));
  ...
  nand4  g086(.a(new_n129_), .b(new_n52_), .c(new_n101_), .d(new_n75_), .O(new_n130_));
  ...
  nand3  g095(.a(new_n138_), .b(new_n65_), .c(x09), .O(new_n139_));
  inv1   g096(.a(new_n139_), .O(z12));
  oai21  g097(.a(new_n135_), .b(new_n92_), .c(new_n52_), .O(z13));
  ...
  nand2  g101(.a(new_n144_), .b(new_n52_), .O(z14));
  ...
  nand2  g108(.a(new_n151_), .b(new_n52_), .O(z17));
endmodule
