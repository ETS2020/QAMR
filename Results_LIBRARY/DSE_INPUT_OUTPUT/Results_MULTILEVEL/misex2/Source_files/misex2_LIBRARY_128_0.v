...
module FAU ( 
  ...
  nand3  g011(.a(x09), .b(new_n49_), .c(new_n47_), .O(new_n55_));
  ...
  nand3  g016(.a(new_n57_), .b(new_n44_), .c(new_n46_), .O(new_n60_));
  inv1   g017(.a(new_n60_), .O(new_n61_));
  nand2  g018(.a(new_n61_), .b(new_n56_), .O(new_n62_));
  aoi21  g019(.a(new_n62_), .b(x12), .c(x01), .O(z02));
  nand2  g020(.a(new_n49_), .b(new_n47_), .O(new_n64_));
  inv1   g021(.a(x19), .O(new_n65_));
  nand3  g022(.a(new_n65_), .b(x18), .c(new_n44_), .O(new_n66_));
  oai21  g023(.a(new_n66_), .b(new_n64_), .c(x12), .O(new_n67_));
  nand2  g024(.a(new_n67_), .b(new_n48_), .O(new_n68_));
  nand3  g025(.a(x02), .b(x01), .c(x00), .O(new_n69_));
  nand4  g026(.a(x12), .b(x11), .c(x10), .d(new_n50_), .O(new_n70_));
  oai21  g027(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(z03));
  inv1   g028(.a(x11), .O(new_n72_));
  nor2   g029(.a(new_n49_), .b(new_n47_), .O(new_n73_));
  nand4  g030(.a(new_n73_), .b(new_n72_), .c(x10), .d(new_n50_), .O(new_n74_));
  aoi21  g031(.a(new_n74_), .b(x01), .c(x12), .O(z04));
  inv1   g032(.a(x12), .O(new_n76_));
  nand2  g033(.a(new_n76_), .b(new_n48_), .O(new_n77_));
  nand2  g034(.a(x01), .b(x00), .O(new_n78_));
  nand3  g035(.a(x10), .b(x09), .c(x02), .O(new_n79_));
  oai21  g036(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(z05));
  nor4   g037(.a(new_n69_), .b(new_n72_), .c(new_n46_), .d(x09), .O(z06));
  nand2  g038(.a(new_n50_), .b(x01), .O(new_n82_));
  nand3  g039(.a(new_n76_), .b(x11), .c(x10), .O(new_n83_));
  oai22  g040(.a(new_n83_), .b(new_n82_), .c(new_n76_), .d(x01), .O(new_n84_));
  nand3  g041(.a(new_n84_), .b(x02), .c(x00), .O(new_n85_));
  inv1   g042(.a(new_n85_), .O(z07));
  nand2  g043(.a(x02), .b(new_n47_), .O(new_n87_));
  ...
  nand3  g050(.a(new_n93_), .b(new_n91_), .c(new_n90_), .O(new_n94_));
  aoi21  g051(.a(new_n94_), .b(x12), .c(x01), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n72_), .c(x02), .d(new_n48_), .O(new_n98_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n97_), .c(new_n96_), .d(new_n47_), .O(new_n107_));
  ...
  nand2  g068(.a(x02), .b(new_n48_), .O(new_n112_));
  nand2  g069(.a(new_n101_), .b(new_n72_), .O(new_n113_));
  ...
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n77_), .O(z10));
  nand4  g076(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n65_), .O(new_n120_));
  nor2   g077(.a(new_n49_), .b(x01), .O(new_n121_));
  nor2   g078(.a(x13), .b(new_n76_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n121_), .c(new_n72_), .O(new_n123_));
  nor2   g080(.a(new_n99_), .b(x14), .O(new_n124_));
  nor2   g081(.a(x21), .b(new_n103_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n124_), .c(new_n100_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n123_), .c(new_n120_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n97_), .c(new_n47_), .O(new_n128_));
  inv1   g085(.a(new_n128_), .O(z11));
  inv1   g086(.a(x24), .O(new_n130_));
  aoi21  g087(.a(x10), .b(x02), .c(new_n48_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(x00), .O(new_n132_));
  oai21  g089(.a(x19), .b(x02), .c(x23), .O(new_n133_));
  nand3  g090(.a(new_n65_), .b(x17), .c(new_n49_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n48_), .c(new_n47_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand3  g094(.a(new_n137_), .b(new_n130_), .c(x09), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n77_), .O(z12));
  nand4  g096(.a(new_n65_), .b(x17), .c(new_n49_), .d(new_n47_), .O(new_n140_));
  aoi21  g097(.a(new_n140_), .b(x12), .c(x01), .O(z13));
  nand4  g098(.a(new_n61_), .b(new_n50_), .c(new_n49_), .d(new_n47_), .O(new_n142_));
  aoi21  g099(.a(new_n142_), .b(x12), .c(x01), .O(z14));
  aoi21  g100(.a(x12), .b(new_n49_), .c(new_n131_), .O(new_n144_));
  nand4  g101(.a(x19), .b(x12), .c(new_n49_), .d(new_n48_), .O(new_n145_));
  oai21  g102(.a(new_n144_), .b(new_n47_), .c(new_n145_), .O(z15));
  oai21  g103(.a(new_n48_), .b(x00), .c(new_n77_), .O(z16));
  nand4  g104(.a(x12), .b(x02), .c(new_n48_), .d(new_n47_), .O(new_n148_));
