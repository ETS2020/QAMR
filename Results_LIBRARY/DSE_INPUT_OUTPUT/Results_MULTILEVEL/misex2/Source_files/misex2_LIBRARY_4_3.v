...
module FAU ( 
  ...
  nand4  g41(.a(x12), .b(new_n85_), .c(x02), .d(new_n59_), .O(new_n86_));
  ...
  nand4  g47(.a(new_n91_), .b(new_n65_), .c(x18), .d(x01), .O(new_n92_));
  oai21  g48(.a(new_n90_), .b(new_n86_), .c(new_n92_), .O(new_n93_));
  nand4  g49(.a(new_n93_), .b(new_n84_), .c(new_n83_), .d(new_n58_), .O(new_n94_));
  inv1   g50(.a(new_n94_), .O(z09));
  nand2  g51(.a(new_n65_), .b(x18), .O(new_n96_));
  nand3  g52(.a(x22), .b(x21), .c(new_n91_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n96_), .c(new_n58_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(x01), .O(new_n99_));
  inv1   g55(.a(x12), .O(new_n100_));
  nand3  g56(.a(x02), .b(new_n59_), .c(new_n58_), .O(new_n101_));
  nor4   g57(.a(new_n101_), .b(x13), .c(new_n100_), .d(x11), .O(new_n102_));
  nor3   g58(.a(new_n88_), .b(new_n87_), .c(x14), .O(new_n103_));
  ...
  nand3  g63(.a(new_n84_), .b(x21), .c(new_n91_), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n96_), .c(new_n58_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(x01), .O(new_n110_));
  inv1   g66(.a(x14), .O(new_n111_));
  nor2   g67(.a(x16), .b(new_n87_), .O(new_n112_));
  ...
  nand3  g73(.a(new_n117_), .b(x09), .c(new_n59_), .O(new_n118_));
  nor2   g74(.a(new_n118_), .b(x00), .O(z12));
  oai21  g75(.a(new_n116_), .b(new_n48_), .c(new_n61_), .O(z13));
  nand3  g76(.a(new_n47_), .b(new_n46_), .c(new_n62_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n66_), .c(new_n61_), .O(z14));
