...
module FAU ( 
  ...
  nand2  g009(.a(x16), .b(x01), .O(new_n53_));
  ...
  nand4  g045(.a(new_n88_), .b(new_n86_), .c(new_n85_), .d(new_n75_), .O(new_n89_));
  ...
  nand4  g054(.a(new_n97_), .b(x20), .c(new_n61_), .d(new_n96_), .O(new_n98_));
  and2   g055(.a(x18), .b(x01), .O(new_n99_));
  nor2   g056(.a(x20), .b(x19), .O(new_n100_));
  nand2  g057(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  oai21  g058(.a(new_n98_), .b(new_n95_), .c(new_n101_), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(new_n94_), .c(new_n93_), .d(new_n75_), .O(new_n103_));
  nand2  g060(.a(new_n103_), .b(new_n53_), .O(z09));
  nor2   g061(.a(new_n45_), .b(x16), .O(new_n105_));
  ...
  nor3   g067(.a(new_n61_), .b(new_n96_), .c(x14), .O(new_n111_));
  ...
  nand3  g072(.a(new_n108_), .b(new_n86_), .c(new_n70_), .O(new_n116_));
  inv1   g073(.a(x20), .O(new_n117_));
  nand4  g074(.a(new_n99_), .b(x21), .c(new_n117_), .d(new_n55_), .O(new_n118_));
  nor2   g075(.a(new_n96_), .b(x14), .O(new_n119_));
  nor2   g076(.a(x21), .b(new_n117_), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n119_), .c(new_n61_), .O(new_n121_));
  oai21  g078(.a(new_n121_), .b(new_n116_), .c(new_n118_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n94_), .c(new_n75_), .O(new_n123_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n69_), .c(new_n75_), .O(new_n131_));
  ...
  oai21  g094(.a(new_n137_), .b(new_n59_), .c(new_n53_), .O(z14));
  aoi22  g095(.a(new_n53_), .b(x00), .c(x19), .d(new_n69_), .O(new_n139_));
  nand4  g096(.a(new_n61_), .b(new_n58_), .c(x01), .d(x00), .O(new_n140_));
  oai21  g097(.a(new_n139_), .b(x02), .c(new_n140_), .O(z15));
  aoi21  g098(.a(new_n61_), .b(x00), .c(new_n69_), .O(z16));
