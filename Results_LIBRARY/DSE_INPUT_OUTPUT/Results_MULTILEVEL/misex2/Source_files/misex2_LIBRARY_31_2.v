...
module FAU ( 
  ...
  nor2   g24(.a(x09), .b(new_n48_), .O(new_n68_));
  ...
  nand3  g29(.a(new_n68_), .b(x11), .c(x10), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(x01), .c(new_n46_), .O(z06));
  nand4  g31(.a(new_n68_), .b(new_n67_), .c(x11), .d(x10), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x01), .c(new_n46_), .O(z07));
  ...
  nand4  g57(.a(new_n100_), .b(new_n88_), .c(new_n87_), .d(new_n46_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(z09));
  nand4  g59(.a(new_n93_), .b(x12), .c(new_n66_), .d(x02), .O(new_n103_));
  ...
  nor2   g64(.a(new_n88_), .b(new_n87_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n98_), .c(new_n95_), .d(new_n46_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n107_), .O(z10));
  nand4  g67(.a(new_n95_), .b(x21), .c(new_n96_), .d(new_n61_), .O(new_n111_));
  nor2   g68(.a(x13), .b(new_n67_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n89_), .c(new_n66_), .O(new_n113_));
  nor2   g70(.a(new_n91_), .b(x14), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n87_), .c(x20), .d(new_n92_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n113_), .c(new_n111_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n88_), .c(new_n46_), .O(new_n117_));
  ...
  aoi21  g84(.a(new_n122_), .b(new_n46_), .c(x01), .O(z13));
  nand4  g85(.a(new_n54_), .b(new_n57_), .c(new_n49_), .d(new_n48_), .O(new_n129_));
