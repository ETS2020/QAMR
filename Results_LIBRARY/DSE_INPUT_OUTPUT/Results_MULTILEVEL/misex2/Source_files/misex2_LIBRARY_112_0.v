...
module FAU ( 
  ...
  nor2   g031(.a(x18), .b(x12), .O(new_n75_));
  inv1   g032(.a(new_n75_), .O(new_n76_));
  nand3  g033(.a(x10), .b(x09), .c(x02), .O(new_n77_));
  oai21  g034(.a(new_n77_), .b(new_n71_), .c(new_n76_), .O(z05));
  nor3   g035(.a(new_n75_), .b(new_n69_), .c(new_n46_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(new_n54_), .c(x02), .d(x01), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(new_n47_), .O(z06));
  nand4  g038(.a(new_n70_), .b(x11), .c(x10), .d(new_n54_), .O(new_n82_));
  ...
  nor3   g067(.a(new_n98_), .b(new_n97_), .c(x20), .O(new_n111_));
  nand4  g068(.a(new_n111_), .b(new_n64_), .c(x18), .d(x01), .O(new_n112_));
  nor2   g069(.a(x13), .b(new_n70_), .O(new_n113_));
  nand3  g070(.a(new_n113_), .b(new_n99_), .c(new_n69_), .O(new_n114_));
  ...
  nand3  g085(.a(new_n64_), .b(x17), .c(new_n49_), .O(new_n129_));
  ...
  nand4  g089(.a(new_n132_), .b(new_n76_), .c(new_n125_), .d(x09), .O(new_n133_));
  inv1   g090(.a(new_n133_), .O(z12));
  nor2   g091(.a(new_n75_), .b(x19), .O(new_n135_));
  nand4  g092(.a(new_n135_), .b(x17), .c(new_n49_), .d(new_n48_), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(x00), .O(z13));
  nor2   g094(.a(x19), .b(x17), .O(new_n138_));
  nand4  g095(.a(new_n138_), .b(new_n62_), .c(new_n46_), .d(new_n54_), .O(new_n139_));
  aoi21  g096(.a(new_n139_), .b(x12), .c(x18), .O(z14));
  ...
  nand3  g100(.a(new_n143_), .b(new_n142_), .c(new_n76_), .O(z15));
  oai21  g101(.a(new_n48_), .b(x00), .c(new_n76_), .O(z16));
  nor4   g102(.a(new_n75_), .b(new_n49_), .c(x01), .d(x00), .O(z17));
endmodule
