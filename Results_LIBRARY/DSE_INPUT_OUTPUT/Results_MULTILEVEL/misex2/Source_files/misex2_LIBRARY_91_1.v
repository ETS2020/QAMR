...
module FAU ( 
  ...
  inv1   g30(.a(new_n70_), .O(new_n74_));
  nand2  g31(.a(new_n74_), .b(x11), .O(new_n75_));
  ...
  nand2  g37(.a(x01), .b(new_n52_), .O(new_n81_));
  ...
  nand4  g54(.a(new_n97_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n101_), .b(new_n94_), .c(x20), .d(new_n93_), .O(new_n102_));
  nor2   g59(.a(new_n102_), .b(x22), .O(z09));
  nand3  g60(.a(new_n96_), .b(new_n95_), .c(x12), .O(new_n104_));
  nor3   g61(.a(new_n104_), .b(x11), .c(new_n45_), .O(new_n105_));
  inv1   g62(.a(x15), .O(new_n106_));
  nor2   g63(.a(new_n93_), .b(new_n106_), .O(new_n107_));
  nor2   g64(.a(x22), .b(x21), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n107_), .c(new_n105_), .d(x20), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n44_), .c(x00), .O(z10));
  nor2   g67(.a(new_n100_), .b(new_n106_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n94_), .c(x20), .d(new_n93_), .O(new_n112_));
  ...
  nand3  g73(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n116_), .c(x00), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n115_), .c(new_n114_), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n46_), .c(new_n81_), .O(z12));
  nor3   g77(.a(new_n53_), .b(x19), .c(new_n50_), .O(z13));
  nand4  g78(.a(new_n47_), .b(new_n58_), .c(new_n46_), .d(new_n45_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g80(.a(new_n58_), .b(new_n52_), .c(x01), .O(new_n124_));
  oai21  g81(.a(x19), .b(x00), .c(new_n45_), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(new_n124_), .O(z15));
  nand3  g83(.a(x02), .b(new_n44_), .c(new_n52_), .O(new_n128_));
