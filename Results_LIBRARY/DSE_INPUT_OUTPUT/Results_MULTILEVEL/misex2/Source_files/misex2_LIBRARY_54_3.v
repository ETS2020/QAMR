...
module FAU ( 
  ...
  nand2  g009(.a(x14), .b(x01), .O(new_n53_));
  ...
  nor2   g034(.a(new_n77_), .b(x14), .O(z06));
  ...
  nand4  g045(.a(new_n88_), .b(x02), .c(new_n62_), .d(new_n61_), .O(new_n89_));
  ...
  nand4  g054(.a(x12), .b(new_n97_), .c(x02), .d(new_n62_), .O(new_n98_));
  ...
  nor2   g060(.a(new_n45_), .b(new_n62_), .O(new_n104_));
  ...
  nand3  g071(.a(x16), .b(x15), .c(new_n67_), .O(new_n115_));
  ...
  nand4  g076(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n55_), .O(new_n120_));
  nor2   g077(.a(new_n99_), .b(x13), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n95_), .c(x20), .d(new_n100_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n98_), .c(new_n120_), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n96_), .c(new_n67_), .d(new_n61_), .O(new_n124_));
  inv1   g081(.a(new_n124_), .O(z11));
  nand2  g082(.a(x10), .b(x02), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n67_), .c(x01), .d(x00), .O(new_n127_));
  oai21  g084(.a(x19), .b(x02), .c(x23), .O(new_n128_));
  nand3  g085(.a(new_n55_), .b(x17), .c(new_n46_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(new_n62_), .c(new_n61_), .O(new_n131_));
