...
module FAU ( 
  ...
  nand4  g34(.a(new_n60_), .b(new_n69_), .c(x11), .d(x10), .O(new_n78_));
  ...
  nand4  g40(.a(new_n83_), .b(x02), .c(new_n55_), .d(new_n44_), .O(new_n84_));
  ...
  nand4  g44(.a(new_n87_), .b(new_n54_), .c(x17), .d(new_n80_), .O(new_n88_));
  ...
  oai21  g53(.a(new_n96_), .b(new_n91_), .c(new_n44_), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(new_n55_), .O(new_n98_));
  nor3   g55(.a(new_n54_), .b(new_n55_), .c(x00), .O(new_n99_));
  ...
  nand3  g59(.a(new_n95_), .b(x16), .c(x15), .O(new_n103_));
  oai21  g60(.a(new_n103_), .b(new_n91_), .c(new_n44_), .O(new_n104_));
  nand2  g61(.a(new_n104_), .b(new_n55_), .O(new_n105_));
  nand4  g62(.a(new_n100_), .b(new_n99_), .c(x22), .d(x21), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n105_), .O(z10));
  inv1   g64(.a(x16), .O(new_n108_));
  nand3  g65(.a(new_n95_), .b(new_n108_), .c(x15), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n91_), .c(new_n44_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n55_), .O(new_n111_));
  inv1   g68(.a(x22), .O(new_n112_));
  nand4  g69(.a(new_n100_), .b(new_n99_), .c(new_n112_), .d(x21), .O(new_n113_));
  ...
  nand3  g74(.a(new_n64_), .b(x17), .c(new_n45_), .O(new_n118_));
  ...
  nand4  g81(.a(new_n47_), .b(new_n52_), .c(new_n46_), .d(new_n45_), .O(new_n125_));
