...
module FAU ( 
  ...
  nor4   g029(.a(new_n69_), .b(x17), .c(new_n59_), .d(new_n46_), .O(z05));
  inv1   g030(.a(x11), .O(new_n74_));
  nor3   g031(.a(new_n71_), .b(x17), .c(new_n74_), .O(z06));
  nand2  g032(.a(x10), .b(new_n46_), .O(new_n76_));
  inv1   g033(.a(x12), .O(new_n77_));
  nand3  g034(.a(new_n49_), .b(new_n77_), .c(x11), .O(new_n78_));
  ...
  nor2   g076(.a(new_n50_), .b(x17), .O(new_n120_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n95_), .c(new_n85_), .O(new_n126_));
  inv1   g083(.a(new_n126_), .O(z11));
  inv1   g084(.a(x24), .O(new_n128_));
  nand2  g085(.a(x10), .b(x02), .O(new_n129_));
  nand4  g086(.a(new_n129_), .b(new_n49_), .c(x01), .d(x00), .O(new_n130_));
  ...
  nand3  g091(.a(new_n134_), .b(new_n86_), .c(new_n85_), .O(new_n135_));
  ...
  nand2  g095(.a(new_n132_), .b(new_n85_), .O(new_n139_));
  aoi21  g096(.a(new_n139_), .b(new_n86_), .c(new_n49_), .O(z13));
  oai21  g097(.a(new_n60_), .b(new_n48_), .c(new_n44_), .O(z14));
  nand2  g098(.a(new_n49_), .b(new_n59_), .O(new_n142_));
  nand2  g099(.a(x01), .b(x00), .O(new_n143_));
  aoi22  g100(.a(new_n44_), .b(x00), .c(x19), .d(new_n86_), .O(new_n144_));
  oai22  g101(.a(new_n144_), .b(x02), .c(new_n143_), .d(new_n142_), .O(z15));
  nand3  g102(.a(new_n49_), .b(x01), .c(new_n85_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand2  g104(.a(new_n96_), .b(new_n85_), .O(new_n148_));
