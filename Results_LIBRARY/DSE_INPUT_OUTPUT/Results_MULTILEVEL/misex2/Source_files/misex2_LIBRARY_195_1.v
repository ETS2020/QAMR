...
module FAU ( 
  ...
  nand3  g18(.a(new_n54_), .b(new_n53_), .c(new_n52_), .O(new_n62_));
  inv1   g19(.a(x19), .O(new_n63_));
  nand4  g20(.a(new_n63_), .b(x18), .c(new_n45_), .d(new_n44_), .O(new_n64_));
  nand3  g21(.a(x02), .b(x01), .c(x00), .O(new_n65_));
  nand4  g22(.a(x12), .b(x11), .c(x10), .d(new_n51_), .O(new_n66_));
  oai22  g23(.a(new_n66_), .b(new_n65_), .c(new_n64_), .d(new_n62_), .O(z03));
  inv1   g24(.a(x11), .O(new_n68_));
  nand2  g25(.a(x01), .b(x00), .O(new_n69_));
  nor4   g26(.a(new_n69_), .b(new_n59_), .c(x09), .d(new_n54_), .O(new_n70_));
  nand2  g27(.a(new_n70_), .b(new_n68_), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(x12), .O(z04));
  nand2  g29(.a(x05), .b(new_n53_), .O(new_n73_));
  nand3  g30(.a(x10), .b(x09), .c(x02), .O(new_n74_));
  oai21  g31(.a(new_n74_), .b(new_n69_), .c(new_n73_), .O(z05));
  nand2  g32(.a(new_n70_), .b(x11), .O(new_n76_));
  inv1   g33(.a(new_n76_), .O(z06));
  inv1   g34(.a(x12), .O(new_n78_));
  nand4  g35(.a(new_n78_), .b(x11), .c(x10), .d(new_n51_), .O(new_n79_));
  ...
  nand4  g42(.a(new_n85_), .b(x02), .c(new_n53_), .d(new_n52_), .O(new_n86_));
  ...
  nand4  g46(.a(new_n89_), .b(new_n50_), .c(x17), .d(new_n83_), .O(new_n90_));
  nor2   g47(.a(new_n90_), .b(new_n63_), .O(z08));
  inv1   g48(.a(x21), .O(new_n92_));
  inv1   g49(.a(x22), .O(new_n93_));
  nor2   g50(.a(new_n54_), .b(x01), .O(new_n94_));
  ...
  nor2   g58(.a(new_n50_), .b(new_n53_), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n101_), .c(new_n63_), .O(new_n103_));
  oai21  g60(.a(new_n100_), .b(new_n96_), .c(new_n103_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n93_), .c(new_n92_), .d(new_n52_), .O(new_n105_));
  nand2  g62(.a(new_n105_), .b(new_n73_), .O(z09));
  nor3   g63(.a(new_n93_), .b(new_n92_), .c(x20), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n63_), .c(x18), .d(x01), .O(new_n108_));
  nand3  g65(.a(new_n44_), .b(x02), .c(new_n53_), .O(new_n109_));
  ...
  nand4  g71(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n63_), .O(new_n115_));
  ...
  nand4  g76(.a(new_n119_), .b(new_n95_), .c(new_n94_), .d(new_n44_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n115_), .O(new_n121_));
  nand3  g78(.a(new_n121_), .b(new_n93_), .c(new_n52_), .O(new_n122_));
  ...
  nand3  g83(.a(new_n63_), .b(x17), .c(new_n54_), .O(new_n127_));
  nand2  g84(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand3  g85(.a(new_n128_), .b(new_n53_), .c(new_n52_), .O(new_n129_));
  aoi21  g86(.a(new_n129_), .b(new_n125_), .c(x24), .O(new_n130_));
  nand2  g87(.a(new_n130_), .b(x09), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(new_n73_), .O(z12));
  nand4  g89(.a(new_n63_), .b(x17), .c(new_n54_), .d(new_n52_), .O(new_n133_));
  aoi21  g90(.a(new_n133_), .b(new_n44_), .c(x01), .O(z13));
  nor2   g91(.a(new_n55_), .b(x09), .O(new_n135_));
  nand4  g92(.a(new_n135_), .b(new_n50_), .c(new_n45_), .d(new_n59_), .O(new_n136_));
  nor2   g93(.a(new_n136_), .b(x19), .O(z14));
  aoi21  g94(.a(new_n44_), .b(new_n54_), .c(new_n124_), .O(new_n138_));
  nand4  g95(.a(x19), .b(new_n44_), .c(new_n54_), .d(new_n53_), .O(new_n139_));
  oai21  g96(.a(new_n138_), .b(new_n52_), .c(new_n139_), .O(z15));
  nor2   g97(.a(new_n53_), .b(x00), .O(z16));
