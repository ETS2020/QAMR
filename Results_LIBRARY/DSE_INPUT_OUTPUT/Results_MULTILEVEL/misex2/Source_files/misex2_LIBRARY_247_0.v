...
module FAU ( 
  ...
  nor2   g007(.a(x20), .b(x04), .O(new_n51_));
  ...
  oai21  g034(.a(new_n77_), .b(new_n63_), .c(new_n52_), .O(z06));
  nand3  g035(.a(new_n65_), .b(new_n71_), .c(x11), .O(new_n79_));
  nand2  g036(.a(new_n79_), .b(x01), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(new_n52_), .c(x02), .d(x00), .O(new_n81_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n95_), .c(new_n94_), .d(new_n86_), .O(new_n106_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n44_), .c(new_n86_), .O(new_n133_));
  ...
  nor2   g095(.a(new_n53_), .b(x10), .O(new_n139_));
  ...
  aoi21  g101(.a(new_n144_), .b(new_n143_), .c(new_n51_), .O(z15));
  oai21  g102(.a(new_n44_), .b(x00), .c(new_n52_), .O(z16));
  nor4   g103(.a(new_n51_), .b(new_n45_), .c(x01), .d(x00), .O(z17));
endmodule
