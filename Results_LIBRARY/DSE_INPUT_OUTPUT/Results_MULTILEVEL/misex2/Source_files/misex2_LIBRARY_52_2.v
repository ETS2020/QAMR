...
module FAU ( 
  ...
  nor2   g26(.a(new_n62_), .b(new_n56_), .O(new_n70_));
  ...
  aoi21  g30(.a(new_n73_), .b(x01), .c(new_n56_), .O(z05));
  nand4  g31(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x01), .c(new_n56_), .O(z06));
  inv1   g33(.a(x11), .O(new_n77_));
  nor3   g34(.a(new_n71_), .b(x12), .c(new_n77_), .O(z07));
  inv1   g35(.a(x08), .O(new_n79_));
  inv1   g36(.a(x05), .O(new_n80_));
  inv1   g37(.a(x06), .O(new_n81_));
  inv1   g38(.a(x03), .O(new_n82_));
  nand4  g39(.a(new_n82_), .b(x02), .c(new_n62_), .d(new_n56_), .O(new_n83_));
  ...
  nor2   g54(.a(new_n45_), .b(new_n62_), .O(new_n98_));
  nand3  g55(.a(new_n98_), .b(new_n97_), .c(new_n66_), .O(new_n99_));
  oai21  g56(.a(new_n96_), .b(new_n92_), .c(new_n99_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n90_), .c(new_n89_), .d(new_n56_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(z09));
  nor3   g59(.a(new_n90_), .b(new_n89_), .c(x20), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n66_), .c(x18), .d(x01), .O(new_n104_));
  inv1   g61(.a(x13), .O(new_n105_));
  nand4  g62(.a(new_n91_), .b(new_n105_), .c(x12), .d(new_n77_), .O(new_n106_));
  ...
  nand4  g67(.a(new_n98_), .b(x21), .c(new_n97_), .d(new_n66_), .O(new_n111_));
  ...
  nand3  g71(.a(new_n114_), .b(new_n90_), .c(new_n56_), .O(new_n115_));
  ...
  oai22  g79(.a(new_n122_), .b(new_n46_), .c(x01), .d(new_n56_), .O(z12));
  nand2  g80(.a(new_n47_), .b(x17), .O(new_n124_));
  nor2   g81(.a(new_n124_), .b(x19), .O(z13));
  nand4  g82(.a(new_n59_), .b(new_n58_), .c(new_n46_), .d(new_n57_), .O(new_n126_));
  aoi21  g83(.a(new_n126_), .b(new_n56_), .c(x01), .O(z14));
  nand2  g84(.a(x10), .b(x02), .O(new_n128_));
  nand3  g85(.a(new_n128_), .b(x01), .c(x00), .O(new_n129_));
  nor2   g86(.a(x01), .b(x00), .O(new_n130_));
  nand3  g87(.a(new_n130_), .b(x19), .c(new_n57_), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(new_n129_), .O(z15));
  xor2a  g89(.a(x01), .b(x00), .O(z16));
  nand2  g90(.a(new_n130_), .b(x02), .O(new_n134_));
