...
module FAU ( 
  ...
  nand4  g30(.a(x11), .b(x10), .c(new_n66_), .d(x02), .O(new_n74_));
  ...
  nand4  g57(.a(new_n67_), .b(x02), .c(new_n44_), .d(new_n53_), .O(new_n101_));
  ...
  nand3  g68(.a(new_n111_), .b(new_n44_), .c(new_n53_), .O(new_n112_));
  ...
  nand4  g73(.a(new_n66_), .b(new_n45_), .c(new_n44_), .d(new_n53_), .O(new_n117_));
  inv1   g74(.a(new_n117_), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n52_), .c(new_n51_), .d(new_n46_), .O(new_n119_));
  ...
  oai21  g79(.a(new_n121_), .b(new_n53_), .c(new_n122_), .O(z15));
  nand3  g80(.a(x02), .b(new_n44_), .c(new_n53_), .O(new_n125_));
