...
module FAU ( 
  ...
  nand2  g013(.a(x22), .b(x01), .O(new_n57_));
  ...
  nand4  g030(.a(new_n73_), .b(new_n68_), .c(x10), .d(x00), .O(new_n74_));
  aoi21  g031(.a(new_n74_), .b(new_n70_), .c(new_n64_), .O(z04));
  nand4  g032(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(new_n70_), .c(new_n64_), .O(z05));
  nand2  g034(.a(new_n67_), .b(x02), .O(new_n78_));
  inv1   g035(.a(new_n78_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(x11), .c(x10), .d(new_n47_), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(x22), .O(z06));
  ...
  nand4  g047(.a(new_n90_), .b(x02), .c(new_n64_), .d(new_n63_), .O(new_n91_));
  ...
  nor2   g052(.a(new_n95_), .b(new_n60_), .O(z08));
  ...
  nor2   g062(.a(new_n45_), .b(new_n64_), .O(new_n106_));
  nand3  g063(.a(new_n106_), .b(new_n105_), .c(new_n60_), .O(new_n107_));
  oai21  g064(.a(new_n104_), .b(new_n100_), .c(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n70_), .c(new_n97_), .d(new_n63_), .O(new_n109_));
  inv1   g066(.a(new_n109_), .O(z09));
  inv1   g067(.a(x13), .O(new_n111_));
  inv1   g068(.a(x14), .O(new_n112_));
  nand4  g069(.a(new_n98_), .b(x02), .c(new_n64_), .d(new_n63_), .O(new_n113_));
  inv1   g070(.a(new_n113_), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n112_), .c(new_n111_), .d(x12), .O(new_n115_));
  nor2   g072(.a(new_n115_), .b(new_n101_), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(new_n97_), .c(x20), .d(x16), .O(new_n117_));
  nor2   g074(.a(new_n117_), .b(x22), .O(z10));
  nand4  g075(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n60_), .O(new_n119_));
  nand4  g076(.a(new_n99_), .b(new_n111_), .c(x12), .d(new_n98_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n70_), .c(new_n63_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n60_), .b(x17), .c(new_n46_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(new_n64_), .c(new_n63_), .O(new_n131_));
  aoi21  g088(.a(new_n131_), .b(new_n127_), .c(x24), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(x09), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n57_), .O(z12));
  inv1   g091(.a(new_n48_), .O(new_n135_));
  oai21  g092(.a(new_n129_), .b(new_n135_), .c(new_n57_), .O(z13));
  nand3  g093(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n137_));
  oai21  g094(.a(new_n137_), .b(new_n61_), .c(new_n57_), .O(z14));
  aoi22  g095(.a(new_n57_), .b(x00), .c(x19), .d(new_n64_), .O(new_n139_));
  nand3  g096(.a(new_n67_), .b(new_n70_), .c(new_n59_), .O(new_n140_));
  oai21  g097(.a(new_n139_), .b(x02), .c(new_n140_), .O(z15));
  nand3  g098(.a(new_n70_), .b(x01), .c(new_n63_), .O(new_n142_));
  inv1   g099(.a(new_n142_), .O(z16));
  nand2  g100(.a(new_n99_), .b(new_n63_), .O(new_n144_));
