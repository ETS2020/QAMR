...
module FAU ( 
  ...
  aoi21  g12(.a(new_n55_), .b(new_n52_), .c(x01), .O(z01));
  ...
  nand3  g19(.a(new_n53_), .b(new_n62_), .c(new_n52_), .O(new_n63_));
  ...
  nor2   g27(.a(x09), .b(new_n53_), .O(new_n71_));
  ...
  nand3  g32(.a(new_n71_), .b(x11), .c(x10), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x01), .c(new_n52_), .O(z06));
  nand4  g34(.a(new_n71_), .b(new_n70_), .c(x11), .d(x10), .O(new_n78_));
  aoi21  g35(.a(new_n78_), .b(x01), .c(new_n52_), .O(z07));
  inv1   g36(.a(x08), .O(new_n80_));
  inv1   g37(.a(x05), .O(new_n81_));
  inv1   g38(.a(x06), .O(new_n82_));
  inv1   g39(.a(x03), .O(new_n83_));
  nand4  g40(.a(new_n83_), .b(x02), .c(new_n62_), .d(new_n52_), .O(new_n84_));
  ...
  nor2   g45(.a(new_n88_), .b(new_n64_), .O(z08));
  ...
  oai21  g52(.a(new_n95_), .b(new_n91_), .c(new_n52_), .O(new_n96_));
  nand2  g53(.a(new_n96_), .b(new_n62_), .O(new_n97_));
  nor3   g54(.a(new_n45_), .b(new_n62_), .c(x00), .O(new_n98_));
  ...
  oai21  g59(.a(new_n102_), .b(new_n91_), .c(new_n52_), .O(new_n103_));
  nand2  g60(.a(new_n103_), .b(new_n62_), .O(new_n104_));
  ...
  nand4  g66(.a(new_n109_), .b(new_n64_), .c(x18), .d(x01), .O(new_n110_));
  nor2   g67(.a(x13), .b(new_n70_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n69_), .c(x02), .d(new_n62_), .O(new_n112_));
  ...
  nand3  g72(.a(new_n115_), .b(new_n107_), .c(new_n52_), .O(new_n116_));
  inv1   g73(.a(new_n116_), .O(z11));
  inv1   g74(.a(x24), .O(new_n118_));
  aoi21  g75(.a(x10), .b(x02), .c(new_n52_), .O(new_n119_));
  oai21  g76(.a(x19), .b(x02), .c(x23), .O(new_n120_));
  nand3  g77(.a(new_n64_), .b(x17), .c(new_n53_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n120_), .c(x01), .O(new_n122_));
  oai21  g79(.a(new_n122_), .b(new_n119_), .c(new_n118_), .O(new_n123_));
  oai22  g80(.a(new_n123_), .b(new_n46_), .c(x01), .d(new_n52_), .O(z12));
  nand2  g81(.a(new_n47_), .b(x17), .O(new_n125_));
  nor2   g82(.a(new_n125_), .b(x19), .O(z13));
  nand4  g83(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(x19), .O(z14));
  nand2  g85(.a(x10), .b(x02), .O(new_n129_));
  nand3  g86(.a(new_n129_), .b(x01), .c(x00), .O(new_n130_));
  nand4  g87(.a(x19), .b(new_n53_), .c(new_n62_), .d(new_n52_), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(new_n130_), .O(z15));
  xor2a  g89(.a(x01), .b(x00), .O(z16));
  aoi21  g90(.a(new_n53_), .b(new_n52_), .c(x01), .O(z17));
endmodule
