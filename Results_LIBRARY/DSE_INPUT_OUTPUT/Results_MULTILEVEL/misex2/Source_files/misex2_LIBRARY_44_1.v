...
module FAU ( 
  ...
  nand4  g26(.a(new_n69_), .b(new_n67_), .c(x10), .d(new_n66_), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(x12), .O(z04));
  nor3   g28(.a(new_n68_), .b(new_n46_), .c(new_n66_), .O(z05));
  nand4  g29(.a(x11), .b(x10), .c(new_n66_), .d(x02), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(x00), .c(new_n44_), .O(z06));
  nor2   g31(.a(x12), .b(new_n67_), .O(new_n75_));
  nand2  g32(.a(new_n75_), .b(new_n47_), .O(new_n76_));
  ...
  nand3  g38(.a(x19), .b(new_n52_), .c(x17), .O(new_n82_));
  ...
  nand4  g46(.a(new_n67_), .b(x02), .c(new_n44_), .d(new_n53_), .O(new_n90_));
  ...
  nor3   g53(.a(new_n96_), .b(x11), .c(new_n45_), .O(new_n97_));
  inv1   g54(.a(x22), .O(new_n98_));
  nand3  g55(.a(new_n98_), .b(new_n87_), .c(x20), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n97_), .c(x16), .d(x15), .O(new_n101_));
  aoi21  g58(.a(new_n101_), .b(new_n44_), .c(x00), .O(z10));
  nand4  g59(.a(new_n100_), .b(new_n97_), .c(new_n86_), .d(x15), .O(new_n103_));
  ...
  nand3  g66(.a(new_n109_), .b(new_n44_), .c(new_n53_), .O(new_n110_));
  ...
  nand4  g71(.a(new_n48_), .b(new_n46_), .c(new_n66_), .d(new_n45_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n44_), .c(x00), .O(z14));
  aoi21  g73(.a(new_n46_), .b(x01), .c(new_n45_), .O(new_n117_));
