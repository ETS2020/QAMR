...
module FAU ( 
  ...
  nand3  g24(.a(new_n67_), .b(x10), .c(new_n49_), .O(new_n68_));
  nor3   g25(.a(new_n68_), .b(x12), .c(x11), .O(z04));
  nor3   g26(.a(new_n66_), .b(new_n57_), .c(new_n49_), .O(z05));
  inv1   g27(.a(x11), .O(new_n71_));
  nor4   g28(.a(new_n63_), .b(new_n71_), .c(new_n57_), .d(x09), .O(z06));
  nor3   g29(.a(new_n68_), .b(x12), .c(new_n71_), .O(z07));
  nand2  g30(.a(x02), .b(new_n47_), .O(new_n75_));
  nand3  g31(.a(x18), .b(x01), .c(new_n46_), .O(new_n76_));
  nor2   g32(.a(x20), .b(x19), .O(new_n77_));
  nor2   g33(.a(x22), .b(x21), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  oai21  g35(.a(new_n79_), .b(new_n76_), .c(new_n75_), .O(z09));
  nand3  g36(.a(new_n77_), .b(x22), .c(x21), .O(new_n81_));
  oai21  g37(.a(new_n81_), .b(new_n76_), .c(new_n75_), .O(z10));
  inv1   g38(.a(x22), .O(new_n83_));
  nand3  g39(.a(new_n77_), .b(new_n83_), .c(x21), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n76_), .c(new_n75_), .O(z11));
  inv1   g41(.a(x24), .O(new_n86_));
  nand2  g42(.a(x10), .b(x02), .O(new_n87_));
  nand3  g43(.a(new_n87_), .b(x01), .c(x00), .O(new_n88_));
  nand2  g44(.a(x23), .b(x19), .O(new_n89_));
  oai21  g45(.a(x19), .b(new_n44_), .c(new_n89_), .O(new_n90_));
  nand3  g46(.a(new_n90_), .b(new_n47_), .c(new_n46_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(new_n86_), .c(x09), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n75_), .O(z12));
  nand3  g50(.a(new_n61_), .b(x17), .c(new_n46_), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n48_), .c(x01), .O(z13));
  nand4  g52(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n97_));
  nor2   g53(.a(new_n97_), .b(x19), .O(z14));
  nand2  g54(.a(new_n87_), .b(x00), .O(new_n99_));
  oai21  g55(.a(x19), .b(x02), .c(new_n47_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n99_), .O(z15));
  oai21  g57(.a(new_n47_), .b(x00), .c(new_n75_), .O(z16));
  inv1   g58(.a(new_n75_), .O(z17));
  zero   g59(.O(z08));
endmodule
