...
module FAU ( 
  ...
  nand4  g14(.a(new_n57_), .b(x09), .c(new_n49_), .d(new_n47_), .O(new_n58_));
  aoi21  g15(.a(new_n58_), .b(x16), .c(x01), .O(z01));
  nand4  g16(.a(x09), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n60_));
  nor2   g17(.a(new_n60_), .b(x10), .O(new_n61_));
  nand4  g18(.a(new_n61_), .b(new_n45_), .c(new_n44_), .d(x16), .O(new_n62_));
  nor2   g19(.a(new_n62_), .b(x19), .O(z02));
  nand2  g20(.a(new_n49_), .b(new_n47_), .O(new_n64_));
  nand3  g21(.a(new_n55_), .b(x18), .c(new_n44_), .O(new_n65_));
  ...
  nand3  g37(.a(x11), .b(x10), .c(new_n50_), .O(new_n81_));
  oai21  g38(.a(new_n81_), .b(new_n68_), .c(new_n73_), .O(z06));
  nand3  g39(.a(new_n69_), .b(new_n75_), .c(x11), .O(new_n83_));
  nand2  g40(.a(new_n83_), .b(x01), .O(new_n84_));
  nand3  g41(.a(new_n84_), .b(x02), .c(x00), .O(new_n85_));
  nand2  g42(.a(new_n85_), .b(new_n73_), .O(z07));
  nand2  g43(.a(x02), .b(new_n47_), .O(new_n87_));
  ...
  nor2   g49(.a(new_n55_), .b(x18), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(x17), .O(new_n94_));
  aoi21  g51(.a(new_n94_), .b(x16), .c(x01), .O(z08));
  nand3  g52(.a(x18), .b(x01), .c(new_n47_), .O(new_n96_));
  inv1   g53(.a(x20), .O(new_n97_));
  inv1   g54(.a(x21), .O(new_n98_));
  inv1   g55(.a(x22), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n55_), .O(new_n100_));
  oai21  g57(.a(new_n100_), .b(new_n96_), .c(new_n73_), .O(z09));
  nand3  g58(.a(new_n55_), .b(x18), .c(x01), .O(new_n102_));
  nand3  g59(.a(x22), .b(x21), .c(new_n97_), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g61(.a(x02), .b(new_n48_), .O(new_n105_));
  inv1   g62(.a(x13), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(x12), .c(new_n74_), .O(new_n107_));
  nor2   g64(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  inv1   g65(.a(x14), .O(new_n109_));
  nand2  g66(.a(x15), .b(new_n109_), .O(new_n110_));
  nand3  g67(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n111_));
  nor2   g68(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n108_), .c(new_n104_), .O(new_n113_));
  oai21  g70(.a(new_n113_), .b(x00), .c(new_n73_), .O(z10));
  nand4  g71(.a(new_n55_), .b(x18), .c(x01), .d(new_n47_), .O(new_n115_));
  inv1   g72(.a(new_n115_), .O(new_n116_));
  nand4  g73(.a(new_n116_), .b(new_n99_), .c(x21), .d(new_n97_), .O(new_n117_));
  ...
  nand3  g79(.a(new_n55_), .b(x17), .c(new_n49_), .O(new_n123_));
  ...
  nand4  g85(.a(new_n55_), .b(x17), .c(new_n49_), .d(new_n47_), .O(new_n129_));
  aoi21  g86(.a(new_n129_), .b(x16), .c(x01), .O(z13));
  nor2   g87(.a(new_n51_), .b(x10), .O(new_n131_));
  nand4  g88(.a(new_n131_), .b(new_n45_), .c(new_n44_), .d(x16), .O(new_n132_));
  nor2   g89(.a(new_n132_), .b(x19), .O(z14));
  aoi21  g90(.a(new_n46_), .b(x01), .c(new_n49_), .O(new_n134_));
  aoi21  g91(.a(x19), .b(new_n49_), .c(new_n72_), .O(new_n135_));
  oai22  g92(.a(new_n135_), .b(x01), .c(new_n134_), .d(new_n47_), .O(z15));
  oai21  g93(.a(new_n48_), .b(x00), .c(new_n73_), .O(z16));
  aoi21  g94(.a(new_n87_), .b(x16), .c(x01), .O(z17));
endmodule
