...
module FAU ( 
  ...
  nor4   g032(.a(new_n75_), .b(x16), .c(new_n58_), .d(new_n46_), .O(z05));
  inv1   g033(.a(new_n75_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x11), .c(x10), .d(new_n46_), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(x16), .O(z06));
  nand4  g036(.a(new_n71_), .b(x11), .c(x10), .d(new_n46_), .O(new_n80_));
  ...
  nand4  g053(.a(x12), .b(new_n70_), .c(x02), .d(new_n69_), .O(new_n97_));
  inv1   g054(.a(x15), .O(new_n98_));
  nor2   g055(.a(x14), .b(x13), .O(new_n99_));
  nand4  g056(.a(new_n99_), .b(x20), .c(new_n61_), .d(new_n98_), .O(new_n100_));
  ...
  nand2  g066(.a(new_n70_), .b(x02), .O(new_n110_));
  ...
  nand4  g074(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n51_), .O(new_n118_));
  nor2   g075(.a(x13), .b(new_n71_), .O(new_n119_));
  nand3  g076(.a(new_n119_), .b(new_n85_), .c(new_n70_), .O(new_n120_));
  nor2   g077(.a(new_n98_), .b(x14), .O(new_n121_));
  nor2   g078(.a(x21), .b(new_n101_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n121_), .c(new_n61_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n120_), .c(new_n118_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n96_), .c(new_n84_), .O(new_n125_));
  nand2  g082(.a(new_n125_), .b(new_n44_), .O(z11));
  inv1   g083(.a(x24), .O(new_n127_));
  nand2  g084(.a(x10), .b(x02), .O(new_n128_));
  nand4  g085(.a(new_n128_), .b(new_n61_), .c(x01), .d(x00), .O(new_n129_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n69_), .c(new_n84_), .O(new_n133_));
  ...
  nand4  g097(.a(new_n140_), .b(new_n50_), .c(new_n49_), .d(new_n58_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x19), .O(z14));
  oai21  g099(.a(x10), .b(new_n69_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n45_), .c(new_n69_), .O(new_n145_));
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n44_), .O(z15));
  nand3  g103(.a(new_n61_), .b(x01), .c(new_n84_), .O(new_n147_));
  inv1   g104(.a(new_n147_), .O(z16));
  nand2  g105(.a(new_n86_), .b(new_n44_), .O(z17));
endmodule
