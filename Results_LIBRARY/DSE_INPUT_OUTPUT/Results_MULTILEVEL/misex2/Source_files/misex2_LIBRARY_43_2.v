...
module FAU ( 
  ...
  nand4  g029(.a(x03), .b(x02), .c(x01), .d(x00), .O(new_n73_));
  ...
  nor2   g035(.a(new_n46_), .b(new_n78_), .O(new_n79_));
  nand3  g036(.a(new_n79_), .b(x10), .c(x09), .O(new_n80_));
  aoi21  g037(.a(new_n80_), .b(x03), .c(new_n77_), .O(z05));
  nand4  g038(.a(new_n79_), .b(x11), .c(x10), .d(new_n47_), .O(new_n82_));
  aoi21  g039(.a(new_n82_), .b(x03), .c(new_n77_), .O(z06));
  inv1   g040(.a(x12), .O(new_n84_));
  nand4  g041(.a(new_n84_), .b(x11), .c(x10), .d(new_n47_), .O(new_n85_));
  nand2  g042(.a(new_n85_), .b(x01), .O(new_n86_));
  nand3  g043(.a(new_n86_), .b(x02), .c(x00), .O(new_n87_));
  nand2  g044(.a(new_n87_), .b(new_n54_), .O(z07));
  nor2   g045(.a(new_n46_), .b(x00), .O(new_n89_));
  nor2   g046(.a(x06), .b(x05), .O(new_n90_));
  nand2  g047(.a(new_n90_), .b(x04), .O(new_n91_));
  inv1   g048(.a(new_n91_), .O(new_n92_));
  nand3  g049(.a(x19), .b(new_n45_), .c(x17), .O(new_n93_));
  nor3   g050(.a(new_n93_), .b(x08), .c(x07), .O(new_n94_));
  nand3  g051(.a(new_n94_), .b(new_n92_), .c(new_n89_), .O(new_n95_));
  aoi21  g052(.a(new_n95_), .b(new_n77_), .c(x03), .O(z08));
  inv1   g053(.a(x21), .O(new_n97_));
  inv1   g054(.a(x22), .O(new_n98_));
  nand4  g055(.a(x12), .b(new_n72_), .c(x02), .d(new_n77_), .O(new_n99_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n68_), .c(x18), .d(x01), .O(new_n105_));
  oai21  g062(.a(new_n103_), .b(new_n99_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n98_), .c(new_n97_), .d(new_n78_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n54_), .O(z09));
  nand3  g065(.a(new_n68_), .b(x18), .c(x01), .O(new_n109_));
  nand3  g066(.a(x22), .b(x21), .c(new_n104_), .O(new_n110_));
  nor2   g067(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g068(.a(x02), .b(new_n77_), .O(new_n112_));
  ...
  nor2   g079(.a(x13), .b(new_n84_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n122_), .c(new_n72_), .O(new_n124_));
  nand3  g081(.a(x18), .b(x03), .c(x01), .O(new_n125_));
  inv1   g082(.a(new_n125_), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(x21), .c(new_n104_), .d(new_n68_), .O(new_n127_));
  nor2   g084(.a(new_n100_), .b(x14), .O(new_n128_));
  nor2   g085(.a(x21), .b(new_n104_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(new_n128_), .c(new_n101_), .O(new_n130_));
  oai21  g087(.a(new_n130_), .b(new_n124_), .c(new_n127_), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n98_), .c(new_n78_), .O(new_n132_));
  ...
  nand3  g094(.a(new_n68_), .b(x17), .c(new_n46_), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand3  g096(.a(new_n139_), .b(new_n77_), .c(new_n78_), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nand3  g098(.a(new_n141_), .b(new_n134_), .c(x09), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(new_n54_), .O(z12));
  inv1   g100(.a(new_n48_), .O(new_n144_));
  oai21  g101(.a(new_n138_), .b(new_n144_), .c(new_n54_), .O(z13));
  nor2   g102(.a(x09), .b(x02), .O(new_n146_));
  nor2   g103(.a(x17), .b(x10), .O(new_n147_));
  nand4  g104(.a(new_n147_), .b(new_n146_), .c(new_n56_), .d(new_n48_), .O(new_n148_));
  nand2  g105(.a(new_n148_), .b(new_n54_), .O(z14));
  aoi22  g106(.a(new_n54_), .b(x00), .c(x19), .d(new_n77_), .O(new_n150_));
  nand4  g107(.a(new_n59_), .b(x03), .c(x01), .d(x00), .O(new_n151_));
  oai21  g108(.a(new_n150_), .b(x02), .c(new_n151_), .O(z15));
  aoi21  g109(.a(x03), .b(x00), .c(new_n77_), .O(z16));
  nand2  g110(.a(new_n48_), .b(x02), .O(new_n154_));
