...
module FAU ( 
  ...
  nand3  g036(.a(x11), .b(x10), .c(new_n46_), .O(new_n80_));
  oai21  g037(.a(new_n80_), .b(new_n64_), .c(new_n52_), .O(z06));
  nand3  g038(.a(new_n66_), .b(new_n72_), .c(x11), .O(new_n82_));
  ...
  nand4  g055(.a(x20), .b(new_n98_), .c(new_n97_), .d(new_n51_), .O(new_n99_));
  ...
  nand4  g060(.a(new_n103_), .b(new_n95_), .c(new_n94_), .d(new_n57_), .O(new_n104_));
  ...
  nand3  g066(.a(new_n51_), .b(x12), .c(new_n71_), .O(new_n110_));
  ...
  aoi21  g071(.a(new_n114_), .b(new_n111_), .c(new_n108_), .O(new_n115_));
  oai21  g072(.a(new_n115_), .b(x00), .c(new_n52_), .O(z10));
  nand4  g073(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n50_), .O(new_n117_));
  nor2   g074(.a(new_n97_), .b(x13), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(new_n94_), .c(x20), .d(new_n98_), .O(new_n119_));
  oai21  g076(.a(new_n119_), .b(new_n96_), .c(new_n117_), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n95_), .c(new_n57_), .O(new_n121_));
  nand2  g078(.a(new_n121_), .b(new_n52_), .O(z11));
  ...
  nand3  g085(.a(new_n128_), .b(new_n44_), .c(new_n57_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n125_), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(new_n52_), .c(new_n123_), .d(x09), .O(new_n131_));
  inv1   g088(.a(new_n131_), .O(z12));
  nand2  g089(.a(new_n44_), .b(new_n57_), .O(new_n133_));
  oai21  g090(.a(new_n127_), .b(new_n133_), .c(new_n52_), .O(z13));
  nor2   g091(.a(new_n53_), .b(x10), .O(new_n135_));
  nand4  g092(.a(new_n135_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n136_));
  ...
  aoi21  g097(.a(new_n140_), .b(new_n139_), .c(new_n63_), .O(z15));
