...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n115_, new_n117_, new_n119_, new_n120_, new_n122_;
  ...
  nand3  g24(.a(x02), .b(new_n60_), .c(x00), .O(new_n68_));
  ...
  nand4  g30(.a(new_n73_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n74_));
  ...
  nand4  g34(.a(new_n77_), .b(new_n45_), .c(x17), .d(new_n70_), .O(new_n78_));
  nor2   g35(.a(new_n78_), .b(new_n65_), .O(z08));
  inv1   g36(.a(x21), .O(new_n80_));
  inv1   g37(.a(x22), .O(new_n81_));
  inv1   g38(.a(x11), .O(new_n82_));
  nand4  g39(.a(x12), .b(new_n82_), .c(x02), .d(new_n60_), .O(new_n83_));
  ...
  nand4  g47(.a(new_n90_), .b(new_n81_), .c(new_n80_), .d(new_n59_), .O(new_n91_));
  inv1   g48(.a(new_n91_), .O(z09));
  nand2  g49(.a(new_n65_), .b(x18), .O(new_n93_));
  nand3  g50(.a(x22), .b(x21), .c(new_n88_), .O(new_n94_));
  oai21  g51(.a(new_n94_), .b(new_n93_), .c(new_n59_), .O(new_n95_));
  nand2  g52(.a(new_n95_), .b(x01), .O(new_n96_));
  inv1   g53(.a(x12), .O(new_n97_));
  nand3  g54(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n98_));
  nor4   g55(.a(new_n98_), .b(x13), .c(new_n97_), .d(x11), .O(new_n99_));
  nor3   g56(.a(new_n85_), .b(new_n84_), .c(x14), .O(new_n100_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(x20), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n100_), .c(new_n99_), .O(new_n103_));
  nand2  g60(.a(new_n103_), .b(new_n96_), .O(z10));
  nand3  g61(.a(new_n81_), .b(x21), .c(new_n88_), .O(new_n105_));
  oai21  g62(.a(new_n105_), .b(new_n93_), .c(new_n59_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(x01), .O(new_n107_));
  inv1   g64(.a(x14), .O(new_n108_));
  nor2   g65(.a(x16), .b(new_n84_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n102_), .c(new_n99_), .d(new_n108_), .O(new_n110_));
  ...
  nand4  g75(.a(new_n46_), .b(new_n63_), .c(new_n60_), .d(new_n59_), .O(new_n119_));
  nand4  g76(.a(new_n65_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n120_));
  oai21  g77(.a(new_n120_), .b(new_n119_), .c(new_n62_), .O(z14));
  nor2   g78(.a(x19), .b(x00), .O(new_n122_));
  nor3   g79(.a(new_n122_), .b(x02), .c(x01), .O(z15));
  nor2   g80(.a(new_n60_), .b(x00), .O(z16));
  nand2  g81(.a(new_n98_), .b(new_n62_), .O(z17));
  nor2   g82(.a(new_n60_), .b(new_n59_), .O(z05));
  nor2   g83(.a(new_n60_), .b(new_n59_), .O(z06));
endmodule
