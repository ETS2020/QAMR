...
module FAU ( 
  ...
  nand3  g24(.a(x02), .b(new_n55_), .c(x00), .O(new_n68_));
  inv1   g25(.a(new_n68_), .O(z07));
  nand3  g26(.a(x02), .b(new_n55_), .c(new_n54_), .O(new_n70_));
  inv1   g27(.a(x03), .O(new_n71_));
  inv1   g28(.a(x05), .O(new_n72_));
  nand3  g29(.a(new_n72_), .b(x04), .c(new_n71_), .O(new_n73_));
  nor2   g30(.a(new_n73_), .b(new_n70_), .O(new_n74_));
  nor3   g31(.a(x08), .b(x07), .c(x06), .O(new_n75_));
  nor2   g32(.a(new_n51_), .b(x18), .O(new_n76_));
  nand4  g33(.a(new_n76_), .b(new_n75_), .c(new_n74_), .d(x17), .O(new_n77_));
  nand2  g34(.a(new_n77_), .b(new_n44_), .O(z08));
  nand2  g35(.a(new_n51_), .b(x18), .O(new_n79_));
  ...
  oai21  g40(.a(new_n83_), .b(new_n79_), .c(new_n54_), .O(new_n84_));
  ...
  nor2   g45(.a(new_n88_), .b(new_n70_), .O(new_n89_));
  ...
  oai21  g52(.a(new_n95_), .b(new_n79_), .c(new_n54_), .O(new_n96_));
  ...
  nand2  g57(.a(new_n100_), .b(new_n97_), .O(z10));
  nand3  g58(.a(new_n82_), .b(x21), .c(new_n80_), .O(new_n102_));
  oai21  g59(.a(new_n102_), .b(new_n79_), .c(new_n54_), .O(new_n103_));
  ...
  nand4  g64(.a(new_n107_), .b(new_n92_), .c(new_n89_), .d(new_n105_), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(new_n104_), .O(z11));
  inv1   g66(.a(x24), .O(new_n110_));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n111_));
  nand3  g68(.a(new_n51_), .b(x17), .c(new_n45_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n110_), .c(x09), .d(new_n55_), .O(new_n114_));
  nor2   g71(.a(new_n114_), .b(x00), .O(z12));
  inv1   g72(.a(new_n47_), .O(new_n116_));
  oai21  g73(.a(new_n112_), .b(new_n116_), .c(new_n44_), .O(z13));
  nand4  g74(.a(new_n46_), .b(new_n45_), .c(new_n55_), .d(new_n54_), .O(new_n118_));
  inv1   g75(.a(new_n118_), .O(new_n119_));
  nand4  g76(.a(new_n119_), .b(new_n50_), .c(new_n49_), .d(new_n61_), .O(new_n120_));
  nor2   g77(.a(new_n120_), .b(x19), .O(z14));
  nor2   g78(.a(x19), .b(x00), .O(new_n122_));
  nor3   g79(.a(new_n122_), .b(x02), .c(x01), .O(z15));
  nand2  g80(.a(new_n47_), .b(x02), .O(new_n124_));
