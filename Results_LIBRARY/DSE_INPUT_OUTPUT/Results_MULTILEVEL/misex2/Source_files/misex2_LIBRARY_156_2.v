...
module FAU ( 
  ...
  nand4  g025(.a(new_n68_), .b(new_n56_), .c(x18), .d(new_n44_), .O(new_n69_));
  ...
  nor2   g034(.a(new_n46_), .b(new_n77_), .O(new_n78_));
  nand3  g035(.a(new_n78_), .b(x10), .c(x09), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(x16), .c(new_n71_), .O(z05));
  nand4  g037(.a(new_n78_), .b(x11), .c(x10), .d(new_n47_), .O(new_n81_));
  ...
  nand2  g044(.a(new_n87_), .b(new_n77_), .O(new_n88_));
  ...
  nand4  g056(.a(new_n99_), .b(x12), .c(new_n72_), .d(x02), .O(new_n100_));
  inv1   g057(.a(x14), .O(new_n101_));
  inv1   g058(.a(x15), .O(new_n102_));
  nand4  g059(.a(x20), .b(new_n53_), .c(new_n102_), .d(new_n101_), .O(new_n103_));
  inv1   g060(.a(x20), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n56_), .c(x18), .d(x01), .O(new_n105_));
  oai21  g062(.a(new_n103_), .b(new_n100_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n98_), .c(new_n97_), .d(new_n77_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n54_), .O(z09));
  nand3  g065(.a(new_n56_), .b(x18), .c(x01), .O(new_n109_));
  nand3  g066(.a(x22), .b(x21), .c(new_n104_), .O(new_n110_));
  nor2   g067(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g068(.a(x02), .b(new_n71_), .O(new_n112_));
  nand3  g069(.a(new_n99_), .b(x12), .c(new_n72_), .O(new_n113_));
  nor2   g070(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand3  g071(.a(x16), .b(x15), .c(new_n101_), .O(new_n115_));
  ...
  nor2   g076(.a(x13), .b(new_n73_), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n87_), .c(new_n72_), .O(new_n121_));
  nand3  g078(.a(x18), .b(x16), .c(x01), .O(new_n122_));
  inv1   g079(.a(new_n122_), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(x21), .c(new_n104_), .d(new_n56_), .O(new_n124_));
  nor2   g081(.a(new_n102_), .b(x14), .O(new_n125_));
  nor2   g082(.a(x21), .b(new_n104_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n125_), .c(new_n53_), .O(new_n127_));
  ...
  nand3  g093(.a(new_n136_), .b(new_n71_), .c(new_n77_), .O(new_n137_));
  ...
  oai21  g101(.a(x10), .b(new_n71_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n46_), .c(new_n71_), .O(new_n147_));
  nand3  g104(.a(new_n147_), .b(new_n146_), .c(new_n54_), .O(z15));
  aoi21  g105(.a(x16), .b(x00), .c(new_n71_), .O(z16));
  nand2  g106(.a(new_n88_), .b(new_n54_), .O(z17));
endmodule
