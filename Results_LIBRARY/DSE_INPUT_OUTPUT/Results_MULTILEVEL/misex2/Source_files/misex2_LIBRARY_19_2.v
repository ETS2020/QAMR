...
module FAU ( 
  ...
  nor2   g61(.a(x13), .b(new_n70_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n91_), .c(new_n69_), .O(new_n106_));
  ...
  nand4  g67(.a(new_n98_), .b(x21), .c(new_n97_), .d(new_n65_), .O(new_n111_));
  ...
  nand3  g76(.a(new_n65_), .b(x17), .c(new_n45_), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n119_), .c(x01), .O(new_n121_));
  oai21  g78(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(new_n122_));
  oai22  g79(.a(new_n122_), .b(new_n46_), .c(x01), .d(new_n44_), .O(z12));
  aoi21  g80(.a(new_n120_), .b(new_n44_), .c(x01), .O(z13));
  ...
  nand2  g88(.a(new_n52_), .b(x02), .O(new_n132_));
