...
module FAU ( 
  ...
  nand4  g26(.a(new_n67_), .b(x18), .c(x01), .d(new_n61_), .O(new_n72_));
  ...
  nand2  g35(.a(new_n80_), .b(new_n47_), .O(z12));
  inv1   g36(.a(x02), .O(new_n82_));
  inv1   g37(.a(x10), .O(new_n83_));
  aoi21  g38(.a(new_n83_), .b(x01), .c(new_n82_), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(new_n61_), .c(new_n47_), .O(z15));
