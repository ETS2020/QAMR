...
module FAU ( 
  ...
  nand4  g17(.a(new_n58_), .b(new_n57_), .c(new_n45_), .d(new_n47_), .O(new_n61_));
  ...
  nand2  g25(.a(x14), .b(new_n49_), .O(new_n69_));
  ...
  nor4   g33(.a(new_n66_), .b(new_n70_), .c(new_n47_), .d(x09), .O(z06));
  nand2  g34(.a(new_n51_), .b(x01), .O(new_n78_));
  nand3  g35(.a(new_n71_), .b(x11), .c(x10), .O(new_n79_));
  oai22  g36(.a(new_n79_), .b(new_n78_), .c(x14), .d(x01), .O(new_n80_));
  ...
  nand4  g48(.a(new_n91_), .b(new_n46_), .c(x17), .d(new_n44_), .O(new_n92_));
  ...
  nand3  g60(.a(new_n103_), .b(new_n102_), .c(new_n64_), .O(new_n104_));
  oai21  g61(.a(new_n101_), .b(new_n97_), .c(new_n104_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n95_), .c(new_n94_), .d(new_n48_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n69_), .O(z09));
  nand3  g64(.a(new_n64_), .b(x18), .c(x01), .O(new_n108_));
  nor4   g65(.a(new_n108_), .b(new_n95_), .c(new_n94_), .d(x20), .O(new_n109_));
  nand3  g66(.a(new_n98_), .b(x12), .c(new_n70_), .O(new_n110_));
  nor3   g67(.a(new_n110_), .b(new_n50_), .c(x01), .O(new_n111_));
  nand3  g68(.a(new_n95_), .b(new_n94_), .c(x20), .O(new_n112_));
  nor3   g69(.a(new_n112_), .b(new_n100_), .c(new_n99_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n111_), .c(new_n109_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(x00), .c(new_n69_), .O(z10));
  inv1   g72(.a(new_n111_), .O(new_n116_));
  nand4  g73(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n64_), .O(new_n117_));
  nor2   g74(.a(new_n99_), .b(x14), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n94_), .c(x20), .d(new_n100_), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n116_), .c(new_n117_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n95_), .c(new_n48_), .O(new_n121_));
  ...
  nand3  g82(.a(new_n64_), .b(x17), .c(new_n50_), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand4  g84(.a(new_n127_), .b(new_n44_), .c(new_n49_), .d(new_n48_), .O(new_n128_));
  aoi21  g85(.a(new_n128_), .b(new_n124_), .c(x24), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(x09), .O(new_n130_));
  inv1   g87(.a(new_n130_), .O(z12));
  nand4  g88(.a(new_n64_), .b(x17), .c(new_n50_), .d(new_n48_), .O(new_n132_));
  ...
  aoi21  g93(.a(new_n47_), .b(x01), .c(new_n50_), .O(new_n137_));
  aoi21  g94(.a(x19), .b(new_n50_), .c(x14), .O(new_n138_));
  oai22  g95(.a(new_n138_), .b(x01), .c(new_n137_), .d(new_n48_), .O(z15));
  nor2   g96(.a(new_n49_), .b(x00), .O(z16));
  nand4  g97(.a(new_n44_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n141_));
