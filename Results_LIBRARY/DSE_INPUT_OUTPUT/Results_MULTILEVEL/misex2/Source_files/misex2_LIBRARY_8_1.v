...
module FAU ( 
  ...
  nor2   g013(.a(x17), .b(new_n47_), .O(new_n57_));
  nor2   g014(.a(x19), .b(x18), .O(new_n58_));
  nand4  g015(.a(new_n58_), .b(new_n57_), .c(new_n56_), .d(new_n49_), .O(new_n59_));
  aoi21  g016(.a(new_n59_), .b(new_n44_), .c(x00), .O(z01));
  nor3   g017(.a(new_n51_), .b(x10), .c(new_n55_), .O(new_n61_));
  nand4  g018(.a(new_n61_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n62_));
  nor2   g019(.a(new_n62_), .b(x19), .O(z02));
  nand2  g020(.a(new_n50_), .b(new_n49_), .O(new_n64_));
  ...
  nand3  g025(.a(new_n55_), .b(x02), .c(x01), .O(new_n69_));
  ...
  nand4  g030(.a(new_n73_), .b(new_n44_), .c(x10), .d(new_n55_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x12), .O(z04));
  nand2  g032(.a(x01), .b(x00), .O(new_n76_));
  nand2  g033(.a(x11), .b(new_n48_), .O(new_n77_));
  nand3  g034(.a(x10), .b(x09), .c(x02), .O(new_n78_));
  oai21  g035(.a(new_n78_), .b(new_n76_), .c(new_n77_), .O(z05));
  nand4  g036(.a(x10), .b(new_n55_), .c(x02), .d(x01), .O(new_n80_));
  aoi21  g037(.a(new_n80_), .b(x00), .c(new_n44_), .O(z06));
  inv1   g038(.a(x12), .O(new_n82_));
  nand4  g039(.a(new_n82_), .b(x11), .c(x10), .d(new_n55_), .O(new_n83_));
  oai21  g040(.a(x01), .b(new_n48_), .c(new_n83_), .O(new_n84_));
  ...
  nor2   g064(.a(new_n46_), .b(new_n49_), .O(new_n108_));
  nand3  g065(.a(new_n108_), .b(new_n107_), .c(new_n65_), .O(new_n109_));
  oai21  g066(.a(new_n106_), .b(new_n102_), .c(new_n109_), .O(new_n110_));
  nand4  g067(.a(new_n110_), .b(new_n99_), .c(new_n98_), .d(new_n44_), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(x00), .O(z09));
  nand3  g069(.a(new_n65_), .b(x18), .c(x01), .O(new_n113_));
  nand3  g070(.a(x22), .b(x21), .c(new_n107_), .O(new_n114_));
  nand4  g071(.a(new_n101_), .b(new_n103_), .c(new_n100_), .d(x12), .O(new_n115_));
  nor2   g072(.a(x22), .b(x21), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(x20), .c(x16), .d(x15), .O(new_n117_));
  oai22  g074(.a(new_n117_), .b(new_n115_), .c(new_n114_), .d(new_n113_), .O(new_n118_));
  nand3  g075(.a(new_n118_), .b(new_n44_), .c(new_n48_), .O(new_n119_));
  inv1   g076(.a(new_n119_), .O(z10));
  nand4  g077(.a(new_n108_), .b(x21), .c(new_n107_), .d(new_n65_), .O(new_n121_));
  nor2   g078(.a(new_n104_), .b(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n98_), .c(x20), .d(new_n105_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n102_), .c(new_n121_), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n99_), .c(new_n44_), .d(new_n48_), .O(new_n125_));
  ...
  nand3  g086(.a(new_n65_), .b(x17), .c(new_n50_), .O(new_n130_));
  ...
  nand4  g092(.a(new_n65_), .b(x17), .c(new_n50_), .d(new_n49_), .O(new_n136_));
  aoi21  g093(.a(new_n136_), .b(new_n44_), .c(x00), .O(z13));
  nor3   g094(.a(x09), .b(x02), .c(x01), .O(new_n138_));
  nand4  g095(.a(new_n138_), .b(new_n58_), .c(new_n45_), .d(new_n47_), .O(new_n139_));
  aoi21  g096(.a(new_n139_), .b(new_n44_), .c(x00), .O(z14));
  ...
  nand3  g100(.a(new_n143_), .b(new_n142_), .c(new_n77_), .O(z15));
  nand3  g101(.a(new_n44_), .b(x01), .c(new_n48_), .O(new_n145_));
  inv1   g102(.a(new_n145_), .O(z16));
  inv1   g103(.a(new_n101_), .O(new_n147_));
  aoi21  g104(.a(new_n147_), .b(new_n44_), .c(x00), .O(z17));
endmodule
