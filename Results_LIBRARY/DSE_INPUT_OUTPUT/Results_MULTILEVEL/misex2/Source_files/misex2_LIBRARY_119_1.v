...
module FAU ( 
  ...
  nand2  g044(.a(new_n87_), .b(new_n71_), .O(new_n88_));
  ...
  nand3  g054(.a(new_n87_), .b(x12), .c(new_n72_), .O(new_n98_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n50_), .O(new_n106_));
  oai21  g063(.a(new_n102_), .b(new_n98_), .c(new_n106_), .O(new_n107_));
  nand3  g064(.a(new_n107_), .b(new_n97_), .c(new_n71_), .O(new_n108_));
  ...
  nand3  g073(.a(new_n50_), .b(x18), .c(x01), .O(new_n117_));
  nand3  g074(.a(x22), .b(x21), .c(new_n103_), .O(new_n118_));
  nor2   g075(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  aoi21  g076(.a(new_n116_), .b(new_n112_), .c(new_n119_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(x00), .c(new_n52_), .O(z10));
  inv1   g078(.a(new_n111_), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n87_), .O(new_n123_));
  nand4  g080(.a(new_n105_), .b(x21), .c(new_n103_), .d(new_n50_), .O(new_n124_));
  nor2   g081(.a(new_n99_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n97_), .c(x20), .d(new_n100_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n123_), .c(new_n124_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n104_), .c(new_n71_), .O(new_n128_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n44_), .c(new_n71_), .O(new_n136_));
  ...
  nor2   g096(.a(new_n63_), .b(x19), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x00), .O(z13));
  nand3  g099(.a(new_n59_), .b(new_n46_), .c(new_n45_), .O(new_n143_));
  oai21  g100(.a(new_n143_), .b(new_n61_), .c(new_n52_), .O(z14));
  ...
  nand2  g106(.a(new_n88_), .b(new_n52_), .O(z17));
endmodule
