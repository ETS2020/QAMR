...
module FAU ( 
  ...
  nor2   g011(.a(new_n50_), .b(new_n54_), .O(new_n55_));
  ...
  nand4  g018(.a(new_n61_), .b(x09), .c(new_n48_), .d(new_n46_), .O(new_n62_));
  aoi21  g019(.a(new_n62_), .b(new_n49_), .c(x01), .O(z02));
  nand2  g020(.a(new_n48_), .b(new_n46_), .O(new_n64_));
  nand3  g021(.a(new_n59_), .b(x18), .c(new_n44_), .O(new_n65_));
  oai21  g022(.a(new_n65_), .b(new_n64_), .c(new_n49_), .O(new_n66_));
  ...
  oai21  g026(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(z03));
  ...
  nand2  g033(.a(x03), .b(new_n47_), .O(new_n77_));
  nand3  g034(.a(x10), .b(x09), .c(x02), .O(new_n78_));
  oai21  g035(.a(new_n78_), .b(new_n76_), .c(new_n77_), .O(z05));
  nand3  g036(.a(x11), .b(x10), .c(new_n54_), .O(new_n80_));
  oai21  g037(.a(new_n80_), .b(new_n68_), .c(new_n77_), .O(z06));
  nand2  g038(.a(new_n54_), .b(x01), .O(new_n82_));
  inv1   g039(.a(x12), .O(new_n83_));
  nand3  g040(.a(new_n83_), .b(x11), .c(x10), .O(new_n84_));
  oai22  g041(.a(new_n84_), .b(new_n82_), .c(x03), .d(x01), .O(new_n85_));
  nand3  g042(.a(new_n85_), .b(x02), .c(x00), .O(new_n86_));
  inv1   g043(.a(new_n86_), .O(z07));
  nand2  g044(.a(x02), .b(new_n46_), .O(new_n88_));
  nor2   g045(.a(x06), .b(x05), .O(new_n89_));
  nand2  g046(.a(new_n89_), .b(x04), .O(new_n90_));
  nor2   g047(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nor2   g048(.a(x08), .b(x07), .O(new_n92_));
  nor2   g049(.a(new_n59_), .b(x18), .O(new_n93_));
  nand4  g050(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(x17), .O(new_n94_));
  aoi21  g051(.a(new_n94_), .b(new_n49_), .c(x01), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n71_), .c(x02), .d(new_n47_), .O(new_n98_));
  ...
  nand4  g060(.a(new_n103_), .b(new_n59_), .c(x18), .d(x01), .O(new_n104_));
  oai21  g061(.a(new_n102_), .b(new_n98_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n46_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n77_), .O(z09));
  nand3  g064(.a(new_n59_), .b(x18), .c(x01), .O(new_n108_));
  nand3  g065(.a(x22), .b(x21), .c(new_n103_), .O(new_n109_));
  nor2   g066(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g067(.a(x02), .b(new_n47_), .O(new_n111_));
  ...
  oai21  g076(.a(new_n119_), .b(x00), .c(new_n77_), .O(z10));
  nor2   g077(.a(new_n45_), .b(new_n47_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(x21), .c(new_n103_), .d(new_n59_), .O(new_n122_));
  inv1   g079(.a(new_n111_), .O(new_n123_));
  nand3  g080(.a(x12), .b(new_n71_), .c(new_n49_), .O(new_n124_));
  inv1   g081(.a(new_n124_), .O(new_n125_));
  nand3  g082(.a(x15), .b(new_n115_), .c(new_n112_), .O(new_n126_));
  inv1   g083(.a(new_n126_), .O(new_n127_));
  nand3  g084(.a(new_n96_), .b(x20), .c(new_n100_), .O(new_n128_));
  inv1   g085(.a(new_n128_), .O(new_n129_));
  nand4  g086(.a(new_n129_), .b(new_n127_), .c(new_n125_), .d(new_n123_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n122_), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n97_), .c(new_n46_), .O(new_n132_));
  ...
  nand3  g094(.a(new_n59_), .b(x17), .c(new_n48_), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand3  g096(.a(new_n139_), .b(new_n47_), .c(new_n46_), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nand3  g098(.a(new_n141_), .b(new_n134_), .c(x09), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(new_n77_), .O(z12));
  nor3   g100(.a(new_n50_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g101(.a(new_n61_), .b(new_n54_), .c(new_n48_), .d(new_n46_), .O(new_n145_));
  aoi21  g102(.a(new_n145_), .b(new_n49_), .c(x01), .O(z14));
  aoi21  g103(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n147_));
  aoi21  g104(.a(x19), .b(new_n48_), .c(x03), .O(new_n148_));
  oai22  g105(.a(new_n148_), .b(x01), .c(new_n147_), .d(new_n46_), .O(z15));
  oai21  g106(.a(new_n47_), .b(x00), .c(new_n77_), .O(z16));
  aoi21  g107(.a(new_n88_), .b(new_n49_), .c(x01), .O(z17));
endmodule
