// Benchmark "FAU" written by ABC on Fri Aug 14 02:10:56 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n136_, new_n138_, new_n139_, new_n141_, new_n142_;
  ...
  nand4  g021(.a(new_n64_), .b(x11), .c(x10), .d(new_n50_), .O(new_n65_));
  inv1   g022(.a(x19), .O(new_n66_));
  nor3   g023(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  nand4  g024(.a(new_n67_), .b(new_n66_), .c(x18), .d(new_n44_), .O(new_n68_));
  ...
  nand4  g029(.a(new_n72_), .b(new_n70_), .c(x10), .d(new_n50_), .O(new_n73_));
  nor2   g030(.a(new_n73_), .b(x12), .O(z04));
  nand2  g031(.a(x01), .b(x00), .O(new_n75_));
  nand2  g032(.a(new_n62_), .b(new_n48_), .O(new_n76_));
  nand3  g033(.a(x10), .b(x09), .c(x02), .O(new_n77_));
  oai21  g034(.a(new_n77_), .b(new_n75_), .c(new_n76_), .O(z05));
  inv1   g035(.a(new_n65_), .O(z06));
  nand2  g036(.a(new_n50_), .b(x01), .O(new_n80_));
  nand3  g037(.a(new_n62_), .b(x11), .c(x10), .O(new_n81_));
  oai22  g038(.a(new_n81_), .b(new_n80_), .c(new_n62_), .d(x01), .O(new_n82_));
  nand3  g039(.a(new_n82_), .b(x02), .c(x00), .O(new_n83_));
  inv1   g040(.a(new_n83_), .O(z07));
  nand2  g041(.a(x02), .b(new_n47_), .O(new_n85_));
  ...
  nor2   g046(.a(new_n66_), .b(x18), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(x17), .O(new_n91_));
  aoi21  g048(.a(new_n91_), .b(x12), .c(x01), .O(z08));
  inv1   g049(.a(x21), .O(new_n93_));
  inv1   g050(.a(x22), .O(new_n94_));
  inv1   g051(.a(x13), .O(new_n95_));
  nor2   g052(.a(new_n49_), .b(x01), .O(new_n96_));
  nand3  g053(.a(new_n96_), .b(new_n95_), .c(new_n70_), .O(new_n97_));
  inv1   g054(.a(x14), .O(new_n98_));
  inv1   g055(.a(x15), .O(new_n99_));
  inv1   g056(.a(x16), .O(new_n100_));
  nand4  g057(.a(x20), .b(new_n100_), .c(new_n99_), .d(new_n98_), .O(new_n101_));
  inv1   g058(.a(x20), .O(new_n102_));
  nor2   g059(.a(new_n45_), .b(new_n48_), .O(new_n103_));
  nand3  g060(.a(new_n103_), .b(new_n102_), .c(new_n66_), .O(new_n104_));
  oai21  g061(.a(new_n101_), .b(new_n97_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n94_), .c(new_n93_), .d(new_n47_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n76_), .O(z09));
  nand3  g064(.a(new_n66_), .b(x18), .c(x01), .O(new_n108_));
  nand3  g065(.a(x22), .b(x21), .c(new_n102_), .O(new_n109_));
  nor2   g066(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g067(.a(x02), .b(new_n48_), .O(new_n111_));
  nand3  g068(.a(new_n98_), .b(new_n95_), .c(new_n70_), .O(new_n112_));
  ...
  nand4  g075(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n66_), .O(new_n119_));
  nand4  g076(.a(new_n96_), .b(new_n95_), .c(x12), .d(new_n70_), .O(new_n120_));
  nor2   g077(.a(new_n99_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n93_), .c(x20), .d(new_n100_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n120_), .c(new_n119_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n94_), .c(new_n47_), .O(new_n124_));
  inv1   g081(.a(new_n124_), .O(z11));
  inv1   g082(.a(x24), .O(new_n126_));
  aoi21  g083(.a(x10), .b(x02), .c(new_n48_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(x00), .O(new_n128_));
  oai21  g085(.a(x19), .b(x02), .c(x23), .O(new_n129_));
  nand3  g086(.a(new_n66_), .b(x17), .c(new_n49_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand4  g088(.a(new_n131_), .b(x12), .c(new_n48_), .d(new_n47_), .O(new_n132_));
  ...
  nand4  g092(.a(new_n66_), .b(x17), .c(new_n49_), .d(new_n47_), .O(new_n136_));
  aoi21  g093(.a(new_n136_), .b(x12), .c(x01), .O(z13));
  nor2   g094(.a(new_n51_), .b(x10), .O(new_n138_));
  nand4  g095(.a(new_n138_), .b(new_n45_), .c(new_n44_), .d(x12), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x19), .O(z14));
  aoi21  g097(.a(x12), .b(new_n49_), .c(new_n127_), .O(new_n141_));
  nand4  g098(.a(x19), .b(x12), .c(new_n49_), .d(new_n48_), .O(new_n142_));
  oai21  g099(.a(new_n141_), .b(new_n47_), .c(new_n142_), .O(z15));
  oai21  g100(.a(new_n48_), .b(x00), .c(new_n76_), .O(z16));
  aoi21  g101(.a(new_n85_), .b(x12), .c(x01), .O(z17));
endmodule
