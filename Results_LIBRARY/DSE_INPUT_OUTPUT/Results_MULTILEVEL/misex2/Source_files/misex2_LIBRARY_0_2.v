...
module FAU ( 
  ...
  aoi21  g35(.a(new_n78_), .b(x01), .c(new_n60_), .O(z07));
  ...
  aoi21  g44(.a(new_n87_), .b(new_n60_), .c(x01), .O(z08));
  inv1   g45(.a(x21), .O(new_n89_));
  inv1   g46(.a(x22), .O(new_n90_));
  nand4  g47(.a(x12), .b(new_n68_), .c(x02), .d(new_n61_), .O(new_n91_));
  ...
  nand4  g55(.a(new_n98_), .b(new_n90_), .c(new_n89_), .d(new_n60_), .O(new_n99_));
  ...
  oai21  g60(.a(new_n103_), .b(new_n101_), .c(new_n60_), .O(new_n104_));
  nand2  g61(.a(new_n104_), .b(new_n61_), .O(new_n105_));
  nor3   g62(.a(new_n45_), .b(new_n61_), .c(x00), .O(new_n106_));
  ...
  oai21  g66(.a(new_n109_), .b(new_n101_), .c(new_n60_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n61_), .O(new_n111_));
