...
module FAU ( 
  ...
  nand4  g63(.a(new_n106_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n107_));
  ...
  oai22  g75(.a(new_n118_), .b(new_n46_), .c(new_n44_), .d(x00), .O(z12));
  ...
  aoi21  g79(.a(new_n58_), .b(x01), .c(new_n45_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n45_), .c(new_n44_), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n52_), .c(new_n124_), .O(z15));
