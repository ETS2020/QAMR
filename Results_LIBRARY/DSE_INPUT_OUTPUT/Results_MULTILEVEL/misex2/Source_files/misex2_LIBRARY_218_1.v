...
module FAU ( 
  ...
  nand4  g54(.a(new_n67_), .b(x02), .c(new_n44_), .d(new_n53_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n101_), .b(new_n92_), .c(x20), .d(x16), .O(new_n102_));
  nor2   g59(.a(new_n102_), .b(x22), .O(z10));
  nand4  g60(.a(new_n95_), .b(new_n91_), .c(new_n87_), .d(x15), .O(new_n104_));
  ...
  nand3  g67(.a(new_n110_), .b(new_n44_), .c(new_n53_), .O(new_n111_));
  ...
  nand4  g72(.a(new_n48_), .b(new_n46_), .c(new_n66_), .d(new_n45_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g74(.a(new_n46_), .b(new_n53_), .c(x01), .O(new_n118_));
