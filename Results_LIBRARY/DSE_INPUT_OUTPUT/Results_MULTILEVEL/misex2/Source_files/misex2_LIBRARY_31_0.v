...
module FAU ( 
  ...
  nand3  g20(.a(new_n47_), .b(x02), .c(x00), .O(new_n65_));
  nand3  g21(.a(new_n46_), .b(x11), .c(x10), .O(new_n66_));
  oai21  g22(.a(new_n66_), .b(new_n65_), .c(new_n64_), .O(z07));
  inv1   g23(.a(x20), .O(new_n69_));
  inv1   g24(.a(x21), .O(new_n70_));
  inv1   g25(.a(x22), .O(new_n71_));
  inv1   g26(.a(x19), .O(new_n72_));
  nand4  g27(.a(new_n72_), .b(x18), .c(x01), .d(new_n62_), .O(new_n73_));
  inv1   g28(.a(new_n73_), .O(new_n74_));
  nand4  g29(.a(new_n74_), .b(new_n71_), .c(new_n70_), .d(new_n69_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(z09));
  nor2   g31(.a(new_n71_), .b(new_n70_), .O(new_n77_));
  nand4  g32(.a(new_n77_), .b(new_n69_), .c(new_n72_), .d(x18), .O(new_n78_));
  aoi21  g33(.a(new_n78_), .b(x01), .c(x00), .O(z10));
  nand4  g34(.a(new_n74_), .b(new_n71_), .c(x21), .d(new_n69_), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(z11));
  aoi21  g36(.a(x10), .b(x02), .c(x24), .O(new_n82_));
  nand3  g37(.a(new_n82_), .b(x09), .c(x01), .O(new_n83_));
  nor2   g38(.a(new_n83_), .b(new_n62_), .O(z12));
  inv1   g39(.a(x02), .O(new_n85_));
  inv1   g40(.a(x10), .O(new_n86_));
  aoi21  g41(.a(new_n86_), .b(x01), .c(new_n85_), .O(new_n87_));
  oai21  g42(.a(new_n87_), .b(new_n62_), .c(new_n52_), .O(z15));
