...
module FAU ( 
  ...
  oai21  g25(.a(new_n68_), .b(new_n64_), .c(new_n62_), .O(z03));
  nand3  g26(.a(x02), .b(new_n60_), .c(x00), .O(new_n72_));
  ...
  nand4  g32(.a(new_n77_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n78_));
  ...
  oai21  g42(.a(new_n87_), .b(new_n66_), .c(new_n59_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(x01), .O(new_n89_));
  nor2   g44(.a(new_n63_), .b(x01), .O(new_n90_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n67_), .c(new_n84_), .d(x01), .O(new_n103_));
  ...
  nor2   g64(.a(new_n45_), .b(new_n60_), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(x21), .c(new_n84_), .d(new_n65_), .O(new_n111_));
  ...
  nand3  g69(.a(new_n114_), .b(new_n86_), .c(new_n59_), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(z11));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n65_), .b(x17), .c(new_n63_), .O(new_n118_));
  aoi21  g73(.a(new_n118_), .b(new_n117_), .c(x24), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(x09), .c(new_n60_), .d(new_n59_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n62_), .O(z12));
  nand2  g76(.a(new_n47_), .b(x17), .O(new_n122_));
  nor2   g77(.a(new_n122_), .b(x19), .O(z13));
  nand4  g78(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n124_));
  ...
  nand2  g83(.a(new_n91_), .b(new_n62_), .O(z17));
  zero   g84(.O(z04));
  zero   g85(.O(z05));
endmodule
