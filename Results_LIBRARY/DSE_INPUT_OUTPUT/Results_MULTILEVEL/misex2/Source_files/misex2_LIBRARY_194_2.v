...
module FAU ( 
  ...
  nand4  g022(.a(x04), .b(x02), .c(x01), .d(x00), .O(new_n66_));
  ...
  nor2   g030(.a(new_n46_), .b(new_n62_), .O(new_n74_));
  nand3  g031(.a(new_n74_), .b(x10), .c(x09), .O(new_n75_));
  aoi21  g032(.a(new_n75_), .b(x04), .c(new_n63_), .O(z05));
  nand4  g033(.a(new_n74_), .b(x11), .c(x10), .d(new_n47_), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(x04), .c(new_n63_), .O(z06));
  ...
  nand4  g044(.a(new_n87_), .b(x02), .c(new_n63_), .d(new_n62_), .O(new_n88_));
  ...
  nand3  g076(.a(x18), .b(x04), .c(x01), .O(new_n120_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n95_), .c(new_n62_), .O(new_n125_));
  inv1   g082(.a(new_n125_), .O(z11));
  nand2  g083(.a(x10), .b(x02), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(x04), .c(x01), .d(x00), .O(new_n128_));
  ...
  nand3  g100(.a(x19), .b(new_n46_), .c(new_n63_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n45_), .O(z15));
  aoi21  g102(.a(x04), .b(x00), .c(new_n63_), .O(z16));
  nand2  g103(.a(new_n96_), .b(new_n62_), .O(new_n147_));
