...
module FAU ( 
  ...
  and2   g55(.a(x16), .b(x15), .O(new_n99_));
  ...
  nor2   g59(.a(x16), .b(new_n102_), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(new_n96_), .c(new_n92_), .O(new_n104_));
  ...
  nand3  g68(.a(new_n111_), .b(new_n44_), .c(new_n60_), .O(new_n112_));
  ...
  nand2  g72(.a(new_n52_), .b(x17), .O(new_n116_));
  nor2   g73(.a(new_n116_), .b(x19), .O(z13));
  nand2  g74(.a(new_n52_), .b(new_n46_), .O(new_n118_));
  inv1   g75(.a(new_n118_), .O(new_n119_));
  nand4  g76(.a(new_n119_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n120_));
