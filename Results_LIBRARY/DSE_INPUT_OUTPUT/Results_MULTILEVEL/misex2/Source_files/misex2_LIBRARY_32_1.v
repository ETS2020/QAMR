...
module FAU ( 
  ...
  nand4  g36(.a(new_n68_), .b(x11), .c(x10), .d(new_n49_), .O(new_n80_));
  nand2  g37(.a(new_n80_), .b(x01), .O(new_n81_));
  nand3  g38(.a(new_n81_), .b(x02), .c(x00), .O(new_n82_));
  oai21  g39(.a(new_n47_), .b(x00), .c(new_n82_), .O(z07));
  ...
  nand4  g54(.a(new_n67_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n98_));
  ...
  aoi21  g79(.a(new_n117_), .b(new_n47_), .c(x00), .O(z13));
  nand4  g80(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n124_));
  nor2   g81(.a(new_n124_), .b(x19), .O(z14));
  oai21  g82(.a(new_n58_), .b(new_n46_), .c(x01), .O(new_n126_));
  oai21  g83(.a(x19), .b(x00), .c(new_n48_), .O(new_n127_));
  nand2  g84(.a(new_n127_), .b(new_n126_), .O(z15));
  nor2   g85(.a(new_n47_), .b(x00), .O(z16));
  nand3  g86(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n130_));
