...
module FAU ( 
  ...
  inv1   g020(.a(new_n48_), .O(new_n64_));
  nor4   g021(.a(new_n64_), .b(x19), .c(x17), .d(x02), .O(new_n65_));
  oai21  g022(.a(new_n65_), .b(new_n57_), .c(x18), .O(new_n66_));
  ...
  oai21  g030(.a(new_n73_), .b(new_n67_), .c(new_n58_), .O(z04));
  nand2  g031(.a(x01), .b(x00), .O(new_n75_));
  nand3  g032(.a(x10), .b(x09), .c(x02), .O(new_n76_));
  oai21  g033(.a(new_n76_), .b(new_n75_), .c(new_n58_), .O(z05));
  inv1   g034(.a(x00), .O(new_n78_));
  inv1   g035(.a(x01), .O(new_n79_));
  aoi21  g036(.a(x18), .b(new_n57_), .c(new_n71_), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(x10), .c(new_n47_), .d(x02), .O(new_n81_));
  nor3   g038(.a(new_n81_), .b(new_n79_), .c(new_n78_), .O(z06));
  ...
  nand2  g042(.a(new_n85_), .b(new_n58_), .O(z07));
  inv1   g043(.a(x08), .O(new_n87_));
  inv1   g044(.a(x03), .O(new_n88_));
  nand3  g045(.a(new_n48_), .b(new_n88_), .c(x02), .O(new_n89_));
  inv1   g046(.a(new_n89_), .O(new_n90_));
  nand3  g047(.a(new_n90_), .b(new_n57_), .c(x04), .O(new_n91_));
  nor3   g048(.a(new_n91_), .b(x07), .c(x06), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(new_n45_), .c(x17), .d(new_n87_), .O(new_n93_));
  nor2   g050(.a(new_n93_), .b(new_n61_), .O(z08));
  ...
  aoi21  g057(.a(x18), .b(new_n57_), .c(new_n100_), .O(new_n101_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n96_), .c(new_n95_), .d(new_n78_), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(z09));
  inv1   g066(.a(x13), .O(new_n110_));
  nand4  g067(.a(new_n58_), .b(new_n96_), .c(new_n95_), .d(x20), .O(new_n111_));
  ...
  nand4  g071(.a(new_n114_), .b(new_n71_), .c(x02), .d(new_n79_), .O(new_n115_));
  nand3  g072(.a(x18), .b(x05), .c(x01), .O(new_n116_));
  inv1   g073(.a(new_n116_), .O(new_n117_));
  nand4  g074(.a(new_n117_), .b(new_n105_), .c(x22), .d(x21), .O(new_n118_));
  aoi21  g075(.a(new_n118_), .b(new_n115_), .c(x00), .O(z10));
  nor2   g076(.a(new_n45_), .b(new_n79_), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(x21), .c(new_n100_), .d(new_n61_), .O(new_n121_));
  nor2   g078(.a(new_n46_), .b(x01), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n110_), .c(x12), .d(new_n71_), .O(new_n123_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n96_), .c(new_n78_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n58_), .O(z11));
  ...
  nand3  g089(.a(new_n61_), .b(x17), .c(new_n46_), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand3  g091(.a(new_n134_), .b(new_n79_), .c(new_n78_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  nand4  g093(.a(new_n136_), .b(new_n58_), .c(new_n129_), .d(x09), .O(new_n137_));
  inv1   g094(.a(new_n137_), .O(z12));
  oai21  g095(.a(new_n133_), .b(new_n64_), .c(new_n58_), .O(z13));
  nand4  g096(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n60_), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x19), .O(z14));
  oai21  g098(.a(x10), .b(new_n79_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n46_), .c(new_n79_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n58_), .O(z15));
  oai21  g102(.a(new_n79_), .b(x00), .c(new_n58_), .O(z16));
  nand2  g103(.a(new_n122_), .b(new_n78_), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(new_n58_), .O(z17));
endmodule
