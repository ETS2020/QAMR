...
module FAU ( 
  ...
  nand2  g006(.a(x22), .b(x08), .O(new_n50_));
  ...
  nand4  g029(.a(new_n50_), .b(new_n72_), .c(new_n71_), .d(x10), .O(new_n73_));
  ...
  oai21  g035(.a(new_n78_), .b(new_n77_), .c(new_n50_), .O(z05));
  nand4  g036(.a(new_n50_), .b(x11), .c(x10), .d(new_n46_), .O(new_n80_));
  ...
  nand4  g042(.a(new_n85_), .b(new_n50_), .c(x02), .d(x00), .O(new_n86_));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n44_), .d(new_n70_), .O(new_n92_));
  ...
  nand4  g052(.a(new_n95_), .b(new_n49_), .c(x17), .d(new_n88_), .O(new_n96_));
  nor2   g053(.a(new_n96_), .b(new_n66_), .O(z08));
  ...
  nand4  g068(.a(new_n111_), .b(new_n99_), .c(new_n98_), .d(new_n70_), .O(new_n112_));
  inv1   g069(.a(new_n112_), .O(z09));
  nor2   g070(.a(new_n49_), .b(x08), .O(new_n114_));
  nor2   g071(.a(new_n99_), .b(new_n98_), .O(new_n115_));
  nand4  g072(.a(new_n115_), .b(new_n114_), .c(new_n109_), .d(x01), .O(new_n116_));
  ...
  nand4  g076(.a(new_n119_), .b(new_n99_), .c(new_n98_), .d(x20), .O(new_n120_));
  ...
  nand4  g081(.a(new_n124_), .b(new_n98_), .c(x20), .d(new_n103_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n118_), .c(new_n123_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n99_), .c(new_n70_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n50_), .O(z11));
  ...
  nand2  g093(.a(new_n136_), .b(new_n50_), .O(z12));
  ...
  oai21  g098(.a(new_n141_), .b(new_n140_), .c(new_n50_), .O(z14));
  ...
  oai21  g103(.a(new_n44_), .b(x00), .c(new_n50_), .O(z16));
  nand4  g104(.a(new_n50_), .b(x02), .c(new_n44_), .d(new_n70_), .O(new_n148_));
