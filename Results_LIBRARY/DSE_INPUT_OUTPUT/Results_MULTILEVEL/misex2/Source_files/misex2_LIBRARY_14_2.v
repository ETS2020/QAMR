...
module FAU ( 
  ...
  nand3  g022(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(new_n66_));
  nand3  g023(.a(new_n63_), .b(x18), .c(new_n44_), .O(new_n67_));
  nand4  g024(.a(x06), .b(x02), .c(x01), .d(x00), .O(new_n68_));
  ...
  nand4  g028(.a(x06), .b(x02), .c(x01), .d(x00), .O(new_n72_));
  nor3   g029(.a(new_n72_), .b(new_n62_), .c(x09), .O(new_n73_));
  nand2  g030(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x12), .O(z04));
  nand4  g032(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(x06), .c(new_n59_), .O(z05));
  nand2  g034(.a(new_n73_), .b(x11), .O(new_n78_));
  inv1   g035(.a(new_n78_), .O(z06));
  nand2  g036(.a(new_n46_), .b(x06), .O(new_n80_));
  ...
  nand2  g042(.a(x02), .b(new_n58_), .O(new_n86_));
  ...
  aoi21  g049(.a(new_n92_), .b(new_n59_), .c(x06), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n71_), .c(x02), .d(new_n59_), .O(new_n96_));
  ...
  nand4  g060(.a(new_n103_), .b(new_n95_), .c(new_n94_), .d(new_n58_), .O(new_n104_));
  nand2  g061(.a(new_n104_), .b(new_n57_), .O(z09));
  ...
  nand2  g065(.a(x02), .b(new_n59_), .O(new_n109_));
  ...
  nor2   g075(.a(new_n60_), .b(x01), .O(new_n119_));
  nor2   g076(.a(x13), .b(new_n81_), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n119_), .c(new_n71_), .O(new_n121_));
  nand3  g078(.a(x18), .b(x06), .c(x01), .O(new_n122_));
  inv1   g079(.a(new_n122_), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(x21), .c(new_n101_), .d(new_n63_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n95_), .c(new_n58_), .O(new_n129_));
  ...
  nand3  g091(.a(new_n63_), .b(x17), .c(new_n60_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n59_), .c(new_n58_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand3  g095(.a(new_n138_), .b(new_n131_), .c(x09), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(new_n57_), .O(z12));
  nand2  g097(.a(new_n47_), .b(x17), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x19), .O(z13));
  nand4  g099(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n62_), .O(new_n143_));
  nor2   g100(.a(new_n143_), .b(x19), .O(z14));
  oai21  g101(.a(x10), .b(new_n59_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n60_), .c(new_n59_), .O(new_n147_));
  nand3  g104(.a(new_n147_), .b(new_n146_), .c(new_n57_), .O(z15));
  nand3  g105(.a(x06), .b(x01), .c(new_n58_), .O(new_n149_));
  inv1   g106(.a(new_n149_), .O(z16));
  oai21  g107(.a(new_n109_), .b(x00), .c(new_n57_), .O(z17));
endmodule
