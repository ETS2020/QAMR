...
module FAU ( 
  ...
  nand2  g008(.a(new_n51_), .b(x03), .O(new_n52_));
  ...
  nand4  g045(.a(new_n88_), .b(x02), .c(new_n44_), .d(new_n59_), .O(new_n89_));
  inv1   g046(.a(new_n89_), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n87_), .c(new_n51_), .d(x04), .O(new_n91_));
