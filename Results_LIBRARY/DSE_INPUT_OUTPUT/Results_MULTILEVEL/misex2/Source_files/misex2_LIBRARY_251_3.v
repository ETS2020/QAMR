...
module FAU ( 
  ...
  nand2  g009(.a(x17), .b(x15), .O(new_n53_));
  ...
  oai21  g029(.a(new_n72_), .b(new_n65_), .c(new_n53_), .O(z04));
  inv1   g030(.a(x00), .O(new_n74_));
  inv1   g031(.a(x01), .O(new_n75_));
  nand4  g032(.a(new_n53_), .b(x10), .c(x09), .d(x02), .O(new_n76_));
  nor3   g033(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(z05));
  nand4  g034(.a(new_n53_), .b(x11), .c(x10), .d(new_n47_), .O(new_n78_));
  ...
  nand3  g048(.a(x19), .b(new_n45_), .c(new_n91_), .O(new_n92_));
  inv1   g049(.a(new_n92_), .O(new_n93_));
  nand4  g050(.a(new_n93_), .b(new_n90_), .c(new_n89_), .d(new_n48_), .O(new_n94_));
  aoi21  g051(.a(new_n94_), .b(new_n86_), .c(new_n44_), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  inv1   g054(.a(x20), .O(new_n98_));
  nand4  g055(.a(new_n53_), .b(new_n98_), .c(new_n55_), .d(x18), .O(new_n99_));
  nand4  g056(.a(x12), .b(new_n70_), .c(x02), .d(new_n75_), .O(new_n100_));
  inv1   g057(.a(x16), .O(new_n101_));
  nor2   g058(.a(x14), .b(x13), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(x20), .c(new_n101_), .d(new_n86_), .O(new_n103_));
  oai22  g060(.a(new_n103_), .b(new_n100_), .c(new_n99_), .d(new_n75_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n97_), .c(new_n96_), .d(new_n74_), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(z09));
  nand4  g063(.a(new_n53_), .b(x22), .c(x21), .d(new_n98_), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n55_), .c(x18), .d(x01), .O(new_n109_));
  nand3  g066(.a(new_n70_), .b(x02), .c(new_n75_), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(new_n111_));
  nand3  g068(.a(new_n44_), .b(x16), .c(x15), .O(new_n112_));
  nand3  g069(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n113_));
  nor2   g070(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n111_), .c(new_n102_), .d(x12), .O(new_n115_));
  aoi21  g072(.a(new_n115_), .b(new_n109_), .c(x00), .O(z10));
  and2   g073(.a(x18), .b(x01), .O(new_n117_));
  nand4  g074(.a(new_n117_), .b(x21), .c(new_n98_), .d(new_n55_), .O(new_n118_));
  nor2   g075(.a(new_n46_), .b(x01), .O(new_n119_));
  nor2   g076(.a(x13), .b(new_n71_), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n119_), .c(new_n70_), .O(new_n121_));
  nor2   g078(.a(new_n86_), .b(x14), .O(new_n122_));
  nor2   g079(.a(x21), .b(new_n98_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n122_), .c(new_n101_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n121_), .c(new_n118_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n97_), .c(new_n74_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n75_), .c(new_n74_), .O(new_n134_));
  ...
  nand3  g094(.a(new_n48_), .b(new_n55_), .c(new_n46_), .O(new_n138_));
  aoi21  g095(.a(new_n138_), .b(new_n86_), .c(new_n44_), .O(z13));
  nand4  g096(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x19), .O(z14));
  inv1   g098(.a(new_n53_), .O(new_n142_));
  oai21  g099(.a(x10), .b(new_n75_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n46_), .c(new_n75_), .O(new_n145_));
  aoi21  g102(.a(new_n145_), .b(new_n144_), .c(new_n142_), .O(z15));
  nand3  g103(.a(new_n53_), .b(x01), .c(new_n74_), .O(new_n147_));
  inv1   g104(.a(new_n147_), .O(z16));
  nand4  g105(.a(new_n53_), .b(x02), .c(new_n75_), .d(new_n74_), .O(new_n149_));
