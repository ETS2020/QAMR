...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n116_, new_n118_, new_n120_, new_n122_, new_n123_, new_n125_;
  ...
  nor3   g24(.a(new_n67_), .b(new_n57_), .c(x09), .O(new_n68_));
  ...
  nand2  g29(.a(new_n68_), .b(x11), .O(new_n73_));
  ...
  aoi21  g42(.a(new_n85_), .b(new_n46_), .c(x01), .O(z08));
  ...
  oai21  g48(.a(new_n91_), .b(new_n88_), .c(new_n46_), .O(new_n92_));
  nand2  g49(.a(new_n92_), .b(new_n47_), .O(new_n93_));
  nor3   g50(.a(new_n45_), .b(new_n47_), .c(x00), .O(new_n94_));
  ...
  oai21  g55(.a(new_n98_), .b(new_n88_), .c(new_n46_), .O(new_n99_));
  nand2  g56(.a(new_n99_), .b(new_n47_), .O(new_n100_));
  ...
  oai21  g61(.a(new_n104_), .b(new_n88_), .c(new_n46_), .O(new_n105_));
  nand2  g62(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  ...
  aoi21  g67(.a(x10), .b(x02), .c(new_n46_), .O(new_n111_));
  ...
  nand2  g72(.a(new_n47_), .b(x00), .O(new_n116_));
  oai21  g73(.a(new_n115_), .b(new_n49_), .c(new_n116_), .O(z12));
  nand3  g74(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n118_));
  nor3   g75(.a(new_n118_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g76(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n120_));
  nor2   g77(.a(new_n120_), .b(x19), .O(z14));
  nand2  g78(.a(x19), .b(new_n48_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n46_), .c(x01), .O(new_n123_));
  or2    g80(.a(new_n123_), .b(new_n111_), .O(z15));
  nand2  g81(.a(x01), .b(new_n46_), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(new_n116_), .O(z16));
