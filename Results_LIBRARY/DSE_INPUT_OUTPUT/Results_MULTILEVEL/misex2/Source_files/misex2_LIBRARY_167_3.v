...
module FAU ( 
  ...
  nand4  g012(.a(new_n55_), .b(new_n54_), .c(new_n44_), .d(x10), .O(new_n56_));
  ...
  nand2  g017(.a(new_n60_), .b(new_n54_), .O(new_n61_));
  aoi21  g018(.a(new_n61_), .b(new_n53_), .c(new_n47_), .O(z02));
  nand2  g019(.a(x13), .b(x09), .O(new_n63_));
  ...
  aoi21  g032(.a(new_n75_), .b(new_n53_), .c(new_n47_), .O(z05));
  nand3  g033(.a(x11), .b(x10), .c(new_n47_), .O(new_n77_));
  oai21  g034(.a(new_n77_), .b(new_n66_), .c(new_n63_), .O(z06));
  inv1   g035(.a(x01), .O(new_n79_));
  nand2  g036(.a(new_n63_), .b(new_n79_), .O(new_n80_));
  nand3  g037(.a(new_n68_), .b(new_n72_), .c(x11), .O(new_n81_));
  nand2  g038(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  ...
  nand3  g064(.a(new_n107_), .b(new_n106_), .c(new_n64_), .O(new_n108_));
  oai21  g065(.a(new_n105_), .b(new_n101_), .c(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n98_), .c(new_n97_), .d(new_n96_), .O(new_n110_));
  nand2  g067(.a(new_n110_), .b(new_n63_), .O(z09));
  nand3  g068(.a(new_n64_), .b(x18), .c(x01), .O(new_n112_));
  nor4   g069(.a(new_n112_), .b(new_n98_), .c(new_n97_), .d(x20), .O(new_n113_));
  nand4  g070(.a(new_n100_), .b(new_n53_), .c(x12), .d(new_n71_), .O(new_n114_));
  ...
  nand4  g076(.a(new_n107_), .b(x21), .c(new_n106_), .d(new_n64_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n98_), .c(new_n96_), .O(new_n124_));
  nand2  g081(.a(new_n124_), .b(new_n63_), .O(z11));
  ...
  nand3  g086(.a(new_n64_), .b(x17), .c(new_n46_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n79_), .c(new_n96_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n126_), .O(new_n134_));
  aoi21  g091(.a(new_n134_), .b(new_n53_), .c(new_n47_), .O(z12));
  nand3  g092(.a(new_n63_), .b(new_n64_), .c(x17), .O(new_n136_));
  nor4   g093(.a(new_n136_), .b(x02), .c(x01), .d(x00), .O(z13));
  nand3  g094(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n138_));
  oai21  g095(.a(new_n138_), .b(new_n59_), .c(new_n63_), .O(z14));
  ...
  oai21  g100(.a(new_n79_), .b(x00), .c(new_n63_), .O(z16));
  oai21  g101(.a(new_n99_), .b(x00), .c(new_n63_), .O(z17));
endmodule
