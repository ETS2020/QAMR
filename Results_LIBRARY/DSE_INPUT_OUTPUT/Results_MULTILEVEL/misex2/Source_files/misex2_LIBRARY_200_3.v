...
module FAU ( 
  ...
  nand4  g026(.a(new_n69_), .b(new_n56_), .c(x18), .d(new_n49_), .O(new_n70_));
  ...
  nor3   g034(.a(new_n77_), .b(new_n53_), .c(new_n76_), .O(z05));
  ...
  nand4  g047(.a(new_n90_), .b(x02), .c(new_n53_), .d(new_n76_), .O(new_n91_));
  ...
  nand4  g051(.a(new_n94_), .b(new_n55_), .c(x17), .d(new_n87_), .O(new_n95_));
  nor2   g052(.a(new_n95_), .b(new_n56_), .O(z08));
  inv1   g053(.a(x21), .O(new_n97_));
  inv1   g054(.a(x22), .O(new_n98_));
  inv1   g055(.a(x20), .O(new_n99_));
  nand4  g056(.a(new_n44_), .b(new_n99_), .c(new_n56_), .d(x18), .O(new_n100_));
  nand4  g057(.a(x12), .b(new_n72_), .c(x02), .d(new_n53_), .O(new_n101_));
  ...
  oai22  g062(.a(new_n105_), .b(new_n101_), .c(new_n100_), .d(new_n53_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n98_), .c(new_n97_), .d(new_n76_), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(z09));
  nand4  g065(.a(new_n44_), .b(x22), .c(x21), .d(new_n99_), .O(new_n109_));
  inv1   g066(.a(new_n109_), .O(new_n110_));
  nand4  g067(.a(new_n110_), .b(new_n56_), .c(x18), .d(x01), .O(new_n111_));
  inv1   g068(.a(x13), .O(new_n112_));
  nand3  g069(.a(new_n112_), .b(x12), .c(new_n72_), .O(new_n113_));
  nor4   g070(.a(new_n113_), .b(x07), .c(new_n45_), .d(x01), .O(new_n114_));
  nor3   g071(.a(new_n103_), .b(new_n102_), .c(x14), .O(new_n115_));
  ...
  nor2   g075(.a(new_n55_), .b(new_n53_), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(x21), .c(new_n99_), .d(new_n56_), .O(new_n120_));
  inv1   g077(.a(new_n113_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(x02), .c(new_n53_), .O(new_n122_));
  nor2   g079(.a(new_n102_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n97_), .c(x20), .d(new_n103_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n122_), .c(new_n120_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n98_), .c(new_n76_), .O(new_n126_));
  ...
  nand3  g087(.a(new_n56_), .b(x17), .c(new_n45_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n53_), .c(new_n76_), .O(new_n133_));
  ...
  nand3  g095(.a(new_n50_), .b(new_n49_), .c(new_n54_), .O(new_n139_));
  oai21  g096(.a(new_n139_), .b(new_n48_), .c(new_n44_), .O(z14));
  oai21  g097(.a(x10), .b(new_n53_), .c(x02), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(x00), .O(new_n142_));
  nand3  g099(.a(x19), .b(new_n45_), .c(new_n53_), .O(new_n143_));
  aoi21  g100(.a(new_n143_), .b(new_n142_), .c(new_n64_), .O(z15));
  oai21  g101(.a(new_n53_), .b(x00), .c(new_n44_), .O(z16));
  nand4  g102(.a(new_n44_), .b(x02), .c(new_n53_), .d(new_n76_), .O(new_n146_));
