...
module FAU ( 
  ...
  nor2   g030(.a(new_n46_), .b(new_n63_), .O(new_n74_));
  nand3  g031(.a(new_n74_), .b(x10), .c(x09), .O(new_n75_));
  aoi21  g032(.a(new_n75_), .b(x16), .c(new_n64_), .O(z05));
  nand4  g033(.a(new_n74_), .b(x11), .c(x10), .d(new_n47_), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(x16), .c(new_n64_), .O(z06));
  nand2  g035(.a(x10), .b(new_n47_), .O(new_n79_));
  inv1   g036(.a(x12), .O(new_n80_));
  nand3  g037(.a(x16), .b(new_n80_), .c(x11), .O(new_n81_));
  ...
  nand4  g045(.a(new_n88_), .b(x02), .c(new_n64_), .d(new_n63_), .O(new_n89_));
  ...
  nand4  g049(.a(new_n92_), .b(new_n51_), .c(x17), .d(new_n85_), .O(new_n93_));
  nor2   g050(.a(new_n93_), .b(new_n52_), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  inv1   g053(.a(x11), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n97_), .c(x02), .d(new_n64_), .O(new_n98_));
  ...
  nand2  g067(.a(x02), .b(new_n64_), .O(new_n111_));
  ...
  nor2   g076(.a(new_n51_), .b(new_n64_), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(x21), .c(new_n108_), .d(new_n52_), .O(new_n121_));
  nand4  g078(.a(new_n112_), .b(x12), .c(new_n97_), .d(x02), .O(new_n122_));
  nor2   g079(.a(new_n99_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n95_), .c(x20), .d(new_n44_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n122_), .c(new_n121_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n96_), .c(new_n63_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n45_), .O(z11));
  nand2  g084(.a(x10), .b(x02), .O(new_n128_));
  nand4  g085(.a(new_n128_), .b(x16), .c(x01), .d(x00), .O(new_n129_));
  ...
  oai21  g095(.a(new_n61_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g096(.a(x10), .b(new_n64_), .c(x02), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(x00), .O(new_n141_));
  nand3  g098(.a(x19), .b(new_n46_), .c(new_n64_), .O(new_n142_));
  nand3  g099(.a(new_n142_), .b(new_n141_), .c(new_n45_), .O(z15));
  aoi21  g100(.a(x16), .b(x00), .c(new_n64_), .O(z16));
  oai21  g101(.a(new_n111_), .b(x00), .c(new_n45_), .O(z17));
endmodule
