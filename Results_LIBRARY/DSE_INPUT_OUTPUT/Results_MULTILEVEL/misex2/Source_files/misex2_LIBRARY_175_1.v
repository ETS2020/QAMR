...
module FAU ( 
  ...
  nor2   g20(.a(new_n44_), .b(new_n55_), .O(new_n64_));
  nand4  g21(.a(new_n64_), .b(x10), .c(new_n63_), .d(x02), .O(new_n65_));
  nor3   g22(.a(new_n65_), .b(x12), .c(x11), .O(z04));
  nand3  g23(.a(x10), .b(x09), .c(x02), .O(new_n67_));
  aoi21  g24(.a(new_n67_), .b(x00), .c(new_n44_), .O(z05));
  nand4  g25(.a(x11), .b(x10), .c(new_n63_), .d(x02), .O(new_n69_));
  aoi21  g26(.a(new_n69_), .b(x00), .c(new_n44_), .O(z06));
  inv1   g27(.a(x12), .O(new_n71_));
  nand3  g28(.a(new_n47_), .b(new_n71_), .c(x11), .O(new_n72_));
  nand2  g29(.a(new_n72_), .b(x01), .O(new_n73_));
  nand3  g30(.a(new_n73_), .b(x02), .c(x00), .O(new_n74_));
  nand2  g31(.a(x01), .b(new_n55_), .O(new_n75_));
  nand2  g32(.a(new_n75_), .b(new_n74_), .O(z07));
  ...
  nand4  g38(.a(new_n81_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n82_));
  ...
  nand4  g42(.a(new_n85_), .b(new_n78_), .c(x17), .d(new_n77_), .O(new_n86_));
  nor2   g43(.a(new_n86_), .b(new_n58_), .O(z08));
  ...
  nor3   g49(.a(new_n92_), .b(x16), .c(x15), .O(new_n93_));
  nand2  g50(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  aoi21  g51(.a(new_n94_), .b(new_n44_), .c(x00), .O(z09));
  inv1   g52(.a(new_n92_), .O(new_n96_));
  nand4  g53(.a(new_n96_), .b(new_n90_), .c(x16), .d(x15), .O(new_n97_));
  aoi21  g54(.a(new_n97_), .b(new_n44_), .c(x00), .O(z10));
  inv1   g55(.a(x16), .O(new_n99_));
  nand4  g56(.a(new_n96_), .b(new_n90_), .c(new_n99_), .d(x15), .O(new_n100_));
  aoi21  g57(.a(new_n100_), .b(new_n44_), .c(x00), .O(z11));
  inv1   g58(.a(x24), .O(new_n102_));
  aoi21  g59(.a(x10), .b(x02), .c(new_n44_), .O(new_n103_));
  oai21  g60(.a(x19), .b(x02), .c(x23), .O(new_n104_));
  nand3  g61(.a(new_n58_), .b(x17), .c(new_n45_), .O(new_n105_));
  aoi21  g62(.a(new_n105_), .b(new_n104_), .c(x00), .O(new_n106_));
  oai21  g63(.a(new_n106_), .b(new_n103_), .c(new_n102_), .O(new_n107_));
  oai21  g64(.a(new_n107_), .b(new_n63_), .c(new_n75_), .O(z12));
  nand3  g65(.a(new_n45_), .b(new_n44_), .c(new_n55_), .O(new_n109_));
  nor3   g66(.a(new_n109_), .b(x19), .c(new_n57_), .O(z13));
  or2    g67(.a(new_n109_), .b(x09), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n78_), .c(new_n57_), .d(new_n46_), .O(new_n113_));
  nor2   g70(.a(new_n113_), .b(x19), .O(z14));
  aoi21  g71(.a(new_n46_), .b(x01), .c(new_n45_), .O(new_n115_));
  nand3  g72(.a(x19), .b(new_n45_), .c(new_n44_), .O(new_n116_));
  oai21  g73(.a(new_n115_), .b(new_n55_), .c(new_n116_), .O(z15));
