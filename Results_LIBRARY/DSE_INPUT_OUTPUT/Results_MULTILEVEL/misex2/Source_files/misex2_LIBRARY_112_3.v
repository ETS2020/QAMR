...
module FAU ( 
  ...
  nand4  g021(.a(new_n64_), .b(x18), .c(new_n44_), .d(new_n63_), .O(new_n65_));
  nor2   g022(.a(new_n61_), .b(new_n60_), .O(new_n66_));
  nand3  g023(.a(new_n66_), .b(new_n47_), .c(x02), .O(new_n67_));
  nand4  g024(.a(new_n45_), .b(x12), .c(x11), .d(x10), .O(new_n68_));
  oai22  g025(.a(new_n68_), .b(new_n67_), .c(new_n65_), .d(new_n62_), .O(z03));
  inv1   g026(.a(x11), .O(new_n70_));
  nand2  g027(.a(new_n66_), .b(x02), .O(new_n71_));
  inv1   g028(.a(new_n71_), .O(new_n72_));
  nand4  g029(.a(new_n72_), .b(new_n70_), .c(x10), .d(new_n47_), .O(new_n73_));
  nor2   g030(.a(new_n73_), .b(x12), .O(z04));
  inv1   g031(.a(new_n66_), .O(new_n75_));
  nand2  g032(.a(x18), .b(x12), .O(new_n76_));
  ...
  nand4  g057(.a(new_n100_), .b(new_n99_), .c(x12), .d(new_n70_), .O(new_n101_));
  inv1   g058(.a(x16), .O(new_n102_));
  nor2   g059(.a(x15), .b(x14), .O(new_n103_));
  nand4  g060(.a(new_n103_), .b(x20), .c(new_n45_), .d(new_n102_), .O(new_n104_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n98_), .c(new_n97_), .d(new_n60_), .O(new_n108_));
  ...
  nand3  g069(.a(new_n70_), .b(x02), .c(new_n61_), .O(new_n113_));
  nor4   g070(.a(new_n113_), .b(x14), .c(x13), .d(new_n63_), .O(new_n114_));
  inv1   g071(.a(x20), .O(new_n115_));
  nand3  g072(.a(new_n45_), .b(x16), .c(x15), .O(new_n116_));
  nor4   g073(.a(new_n116_), .b(x22), .c(x21), .d(new_n115_), .O(new_n117_));
  nand2  g074(.a(new_n117_), .b(new_n114_), .O(new_n118_));
  aoi21  g075(.a(new_n118_), .b(new_n112_), .c(x00), .O(z10));
  nand3  g076(.a(x21), .b(new_n115_), .c(new_n64_), .O(new_n120_));
  inv1   g077(.a(x14), .O(new_n121_));
  inv1   g078(.a(x15), .O(new_n122_));
  nor2   g079(.a(x16), .b(new_n122_), .O(new_n123_));
  nor2   g080(.a(x21), .b(new_n115_), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n123_), .c(new_n45_), .d(new_n121_), .O(new_n125_));
  oai22  g082(.a(new_n125_), .b(new_n101_), .c(new_n120_), .d(new_n110_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n98_), .c(new_n60_), .O(new_n127_));
  ...
  nand3  g091(.a(new_n134_), .b(new_n61_), .c(new_n60_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  nand4  g093(.a(new_n136_), .b(new_n76_), .c(new_n129_), .d(x09), .O(new_n137_));
  inv1   g094(.a(new_n137_), .O(z12));
  nand3  g095(.a(new_n76_), .b(new_n64_), .c(x17), .O(new_n139_));
  nor4   g096(.a(new_n139_), .b(x02), .c(x01), .d(x00), .O(z13));
  nand3  g097(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n141_));
  nand4  g098(.a(new_n64_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n142_));
  oai21  g099(.a(new_n142_), .b(new_n141_), .c(new_n76_), .O(z14));
  ...
  oai21  g104(.a(new_n61_), .b(x00), .c(new_n76_), .O(z16));
  nand4  g105(.a(new_n76_), .b(x02), .c(new_n61_), .d(new_n60_), .O(new_n149_));
