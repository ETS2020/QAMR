...
module FAU ( 
  ...
  nor4   g29(.a(new_n64_), .b(new_n72_), .c(new_n57_), .d(x09), .O(z06));
  ...
  nand4  g68(.a(new_n94_), .b(x12), .c(new_n72_), .d(x02), .O(new_n112_));
  ...
  oai22  g82(.a(new_n125_), .b(new_n46_), .c(x01), .d(new_n44_), .O(z12));
  ...
  nand3  g89(.a(new_n52_), .b(x19), .c(new_n45_), .O(new_n133_));
  nand2  g90(.a(new_n133_), .b(new_n132_), .O(z15));
  xor2a  g91(.a(x01), .b(x00), .O(z16));
  nand2  g92(.a(new_n52_), .b(x02), .O(new_n136_));
