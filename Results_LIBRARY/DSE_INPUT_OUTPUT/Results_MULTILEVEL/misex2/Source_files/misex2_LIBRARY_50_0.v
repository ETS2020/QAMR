...
module FAU ( 
  ...
  aoi21  g016(.a(new_n59_), .b(x24), .c(x01), .O(z01));
  nand3  g017(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n61_));
  nor3   g018(.a(new_n61_), .b(x10), .c(new_n52_), .O(new_n62_));
  ...
  nor2   g050(.a(new_n47_), .b(x18), .O(new_n94_));
  nand4  g051(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(x17), .O(new_n95_));
  aoi21  g052(.a(new_n95_), .b(x24), .c(x01), .O(z08));
  inv1   g053(.a(x21), .O(new_n97_));
  inv1   g054(.a(x22), .O(new_n98_));
  nand4  g055(.a(x12), .b(new_n72_), .c(x02), .d(new_n50_), .O(new_n99_));
  ...
  nand3  g062(.a(new_n105_), .b(new_n104_), .c(new_n47_), .O(new_n106_));
  oai21  g063(.a(new_n103_), .b(new_n99_), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n98_), .c(new_n97_), .d(new_n49_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n78_), .O(z09));
  nand3  g066(.a(new_n47_), .b(x18), .c(x01), .O(new_n110_));
  nand3  g067(.a(x22), .b(x21), .c(new_n104_), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g069(.a(x02), .b(new_n50_), .O(new_n113_));
  ...
  nor2   g079(.a(new_n51_), .b(x01), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n114_), .c(x12), .d(new_n72_), .O(new_n124_));
  nand4  g081(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n47_), .O(new_n125_));
  nor2   g082(.a(x16), .b(new_n100_), .O(new_n126_));
  nor2   g083(.a(new_n44_), .b(x21), .O(new_n127_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n98_), .c(new_n49_), .O(new_n130_));
  inv1   g087(.a(new_n130_), .O(z11));
  nand2  g088(.a(x10), .b(x02), .O(new_n132_));
  nand4  g089(.a(new_n132_), .b(new_n44_), .c(x09), .d(x01), .O(new_n133_));
  nor2   g090(.a(new_n133_), .b(new_n49_), .O(z12));
  nand4  g091(.a(new_n47_), .b(x17), .c(new_n51_), .d(new_n49_), .O(new_n135_));
  aoi21  g092(.a(new_n135_), .b(x24), .c(x01), .O(z13));
  ...
  oai21  g099(.a(new_n50_), .b(x00), .c(new_n78_), .O(z16));
  aoi21  g100(.a(new_n89_), .b(x24), .c(x01), .O(z17));
endmodule
