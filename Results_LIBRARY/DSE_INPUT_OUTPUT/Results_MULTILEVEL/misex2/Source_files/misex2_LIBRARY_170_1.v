...
module FAU ( 
  ...
  nand4  g14(.a(new_n57_), .b(new_n54_), .c(new_n53_), .d(new_n46_), .O(new_n58_));
  nor2   g15(.a(new_n58_), .b(x19), .O(z02));
  nand3  g16(.a(new_n45_), .b(new_n44_), .c(new_n55_), .O(new_n60_));
  ...
  nor2   g23(.a(new_n44_), .b(new_n55_), .O(new_n67_));
  ...
  nand4  g28(.a(x11), .b(x10), .c(new_n66_), .d(x02), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x00), .c(new_n44_), .O(z06));
  inv1   g30(.a(x12), .O(new_n74_));
  nand3  g31(.a(new_n47_), .b(new_n74_), .c(x11), .O(new_n75_));
  nand2  g32(.a(new_n75_), .b(x01), .O(new_n76_));
  nand3  g33(.a(new_n76_), .b(x02), .c(x00), .O(new_n77_));
  oai21  g34(.a(new_n44_), .b(x00), .c(new_n77_), .O(z07));
  inv1   g35(.a(x08), .O(new_n79_));
  inv1   g36(.a(x05), .O(new_n80_));
  inv1   g37(.a(x06), .O(new_n81_));
  inv1   g38(.a(x03), .O(new_n82_));
  nand4  g39(.a(new_n82_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n83_));
  ...
  nand2  g46(.a(new_n89_), .b(x12), .O(new_n90_));
  nor3   g47(.a(new_n90_), .b(x11), .c(new_n45_), .O(new_n91_));
  ...
  nand3  g62(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n44_), .c(new_n55_), .O(new_n108_));
  ...
  nand4  g69(.a(new_n66_), .b(new_n45_), .c(new_n44_), .d(new_n55_), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n54_), .c(new_n53_), .d(new_n46_), .O(new_n115_));
  nor2   g72(.a(new_n115_), .b(x19), .O(z14));
  oai21  g73(.a(new_n46_), .b(new_n55_), .c(x01), .O(new_n117_));
  oai21  g74(.a(x19), .b(x00), .c(new_n45_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(z15));
  nor2   g76(.a(new_n44_), .b(x00), .O(z16));
  nand3  g77(.a(x02), .b(new_n44_), .c(new_n55_), .O(new_n121_));
