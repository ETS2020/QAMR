...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n122_, new_n125_, new_n127_, new_n128_, new_n129_, new_n132_;
  ...
  nor2   g23(.a(new_n60_), .b(new_n53_), .O(new_n67_));
  nand4  g24(.a(new_n67_), .b(x10), .c(new_n47_), .d(x02), .O(new_n68_));
  nor3   g25(.a(new_n68_), .b(x12), .c(x11), .O(z04));
  nand3  g26(.a(x10), .b(x09), .c(x02), .O(new_n70_));
  aoi21  g27(.a(new_n70_), .b(x01), .c(new_n53_), .O(z05));
  nand4  g28(.a(x11), .b(x10), .c(new_n47_), .d(x02), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x01), .c(new_n53_), .O(z06));
  inv1   g30(.a(x11), .O(new_n74_));
  nor3   g31(.a(new_n68_), .b(x12), .c(new_n74_), .O(z07));
  nor2   g32(.a(x03), .b(new_n46_), .O(new_n76_));
  ...
  aoi21  g40(.a(new_n83_), .b(new_n53_), .c(x01), .O(z08));
  nor2   g41(.a(x14), .b(x13), .O(new_n85_));
  nand4  g42(.a(new_n85_), .b(x12), .c(new_n74_), .d(x02), .O(new_n86_));
  ...
  oai21  g47(.a(new_n90_), .b(new_n86_), .c(new_n53_), .O(new_n91_));
  nand2  g48(.a(new_n91_), .b(new_n60_), .O(new_n92_));
  nor3   g49(.a(new_n45_), .b(new_n60_), .c(x00), .O(new_n93_));
  nor2   g50(.a(x20), .b(x19), .O(new_n94_));
  nand3  g51(.a(new_n94_), .b(new_n93_), .c(new_n89_), .O(new_n95_));
  nand2  g52(.a(new_n95_), .b(new_n92_), .O(z09));
  nand4  g53(.a(new_n89_), .b(x20), .c(x16), .d(x15), .O(new_n97_));
  oai21  g54(.a(new_n97_), .b(new_n86_), .c(new_n53_), .O(new_n98_));
  nand2  g55(.a(new_n98_), .b(new_n60_), .O(new_n99_));
  nand4  g56(.a(new_n94_), .b(new_n93_), .c(x22), .d(x21), .O(new_n100_));
  nand2  g57(.a(new_n100_), .b(new_n99_), .O(z10));
  inv1   g58(.a(x22), .O(new_n102_));
  inv1   g59(.a(x20), .O(new_n103_));
  and2   g60(.a(x18), .b(x01), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n62_), .O(new_n105_));
  nor2   g62(.a(new_n46_), .b(x01), .O(new_n106_));
  inv1   g63(.a(x12), .O(new_n107_));
  nor2   g64(.a(x13), .b(new_n107_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n106_), .c(new_n74_), .O(new_n109_));
  nor2   g66(.a(new_n87_), .b(x14), .O(new_n110_));
  nor2   g67(.a(x21), .b(new_n103_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n110_), .c(new_n88_), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n109_), .c(new_n105_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n102_), .c(new_n53_), .O(new_n114_));
  inv1   g71(.a(new_n114_), .O(z11));
  inv1   g72(.a(x24), .O(new_n116_));
  aoi21  g73(.a(x10), .b(x02), .c(new_n53_), .O(new_n117_));
  oai21  g74(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g75(.a(new_n62_), .b(x17), .c(new_n46_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n118_), .c(x01), .O(new_n120_));
  oai21  g77(.a(new_n120_), .b(new_n117_), .c(new_n116_), .O(new_n121_));
  nand2  g78(.a(new_n60_), .b(x00), .O(new_n122_));
  oai21  g79(.a(new_n121_), .b(new_n47_), .c(new_n122_), .O(z12));
  aoi21  g80(.a(new_n119_), .b(new_n53_), .c(x01), .O(z13));
  nand4  g81(.a(new_n54_), .b(new_n57_), .c(new_n47_), .d(new_n46_), .O(new_n125_));
  aoi21  g82(.a(new_n125_), .b(new_n53_), .c(x01), .O(z14));
  nand2  g83(.a(x10), .b(x02), .O(new_n127_));
  nand3  g84(.a(new_n127_), .b(x01), .c(x00), .O(new_n128_));
  nand3  g85(.a(new_n48_), .b(x19), .c(new_n46_), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(new_n128_), .O(z15));
  nor2   g87(.a(new_n60_), .b(x00), .O(z16));
  nand2  g88(.a(new_n48_), .b(x02), .O(new_n132_));
