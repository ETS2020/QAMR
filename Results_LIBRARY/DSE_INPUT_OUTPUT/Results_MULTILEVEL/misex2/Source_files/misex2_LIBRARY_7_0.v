...
module FAU ( 
  ...
  nor2   g020(.a(x15), .b(x04), .O(new_n64_));
  ...
  oai21  g031(.a(new_n74_), .b(new_n65_), .c(new_n53_), .O(z04));
  nand2  g032(.a(x01), .b(x00), .O(new_n76_));
  nand3  g033(.a(x10), .b(x09), .c(x02), .O(new_n77_));
  oai21  g034(.a(new_n77_), .b(new_n76_), .c(new_n53_), .O(z05));
  nand3  g035(.a(x11), .b(x10), .c(new_n46_), .O(new_n79_));
  oai21  g036(.a(new_n79_), .b(new_n65_), .c(new_n53_), .O(z06));
  nand3  g037(.a(new_n67_), .b(new_n73_), .c(x11), .O(new_n81_));
  ...
  nand2  g043(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  ...
  nor2   g054(.a(new_n64_), .b(x20), .O(new_n98_));
  nand4  g055(.a(new_n98_), .b(new_n50_), .c(x18), .d(x01), .O(new_n99_));
  nand3  g056(.a(x12), .b(new_n72_), .c(x04), .O(new_n100_));
  inv1   g057(.a(new_n100_), .O(new_n101_));
  nor2   g058(.a(x14), .b(x13), .O(new_n102_));
  inv1   g059(.a(x16), .O(new_n103_));
  nand3  g060(.a(x20), .b(new_n103_), .c(new_n52_), .O(new_n104_));
  inv1   g061(.a(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n102_), .c(new_n101_), .d(new_n86_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n99_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n97_), .c(new_n96_), .d(new_n85_), .O(new_n108_));
  ...
  nor3   g072(.a(new_n103_), .b(new_n52_), .c(x14), .O(new_n116_));
  nand3  g073(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n117_));
  inv1   g074(.a(new_n117_), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(new_n116_), .c(new_n115_), .d(new_n86_), .O(new_n119_));
  aoi21  g076(.a(new_n119_), .b(new_n112_), .c(x00), .O(z10));
  oai21  g077(.a(x15), .b(x04), .c(x21), .O(new_n121_));
  nor2   g078(.a(new_n121_), .b(x20), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n50_), .c(x18), .d(x01), .O(new_n123_));
  nor2   g080(.a(new_n52_), .b(x14), .O(new_n124_));
  nand3  g081(.a(new_n96_), .b(x20), .c(new_n103_), .O(new_n125_));
  inv1   g082(.a(new_n125_), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n124_), .c(new_n115_), .d(new_n86_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n97_), .c(new_n85_), .O(new_n129_));
  ...
  nand3  g093(.a(new_n136_), .b(new_n44_), .c(new_n85_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand4  g095(.a(new_n138_), .b(new_n53_), .c(new_n131_), .d(x09), .O(new_n139_));
  inv1   g096(.a(new_n139_), .O(z12));
  nor2   g097(.a(new_n64_), .b(x19), .O(new_n141_));
  nand4  g098(.a(new_n141_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x00), .O(z13));
  nand3  g100(.a(new_n60_), .b(new_n46_), .c(new_n45_), .O(new_n144_));
  oai21  g101(.a(new_n144_), .b(new_n62_), .c(new_n53_), .O(z14));
  ...
  oai21  g106(.a(new_n44_), .b(x00), .c(new_n53_), .O(z16));
  nand2  g107(.a(new_n87_), .b(new_n53_), .O(z17));
endmodule
