...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n110_, new_n112_, new_n114_, new_n116_, new_n117_, new_n120_;
  ...
  aoi21  g62(.a(x10), .b(x02), .c(new_n60_), .O(new_n106_));
  oai21  g63(.a(x19), .b(x02), .c(x23), .O(new_n107_));
  nand3  g64(.a(new_n62_), .b(x17), .c(new_n61_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n107_), .c(x00), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n106_), .c(new_n105_), .O(new_n110_));
  oai22  g67(.a(new_n110_), .b(new_n46_), .c(new_n60_), .d(x00), .O(z12));
  nand2  g68(.a(new_n47_), .b(x17), .O(new_n112_));
  nor2   g69(.a(new_n112_), .b(x19), .O(z13));
  nand4  g70(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n114_));
  nor2   g71(.a(new_n114_), .b(x19), .O(z14));
  oai21  g72(.a(new_n56_), .b(new_n59_), .c(x01), .O(new_n116_));
  oai21  g73(.a(x19), .b(x00), .c(new_n61_), .O(new_n117_));
