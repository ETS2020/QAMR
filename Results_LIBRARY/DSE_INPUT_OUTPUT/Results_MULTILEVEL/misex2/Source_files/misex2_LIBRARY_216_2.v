...
module FAU ( 
  ...
  nand4  g011(.a(new_n54_), .b(new_n45_), .c(new_n50_), .d(x10), .O(new_n55_));
  nor2   g012(.a(new_n55_), .b(x19), .O(z01));
  inv1   g013(.a(x00), .O(new_n57_));
  nor3   g014(.a(x19), .b(x18), .c(x10), .O(new_n58_));
  nand4  g015(.a(new_n58_), .b(x09), .c(new_n51_), .d(new_n57_), .O(new_n59_));
  ...
  nand2  g022(.a(new_n46_), .b(x18), .O(new_n66_));
  inv1   g023(.a(new_n66_), .O(new_n67_));
  nand4  g024(.a(new_n67_), .b(new_n50_), .c(new_n51_), .d(new_n57_), .O(new_n68_));
  nand2  g025(.a(new_n68_), .b(new_n65_), .O(z03));
  nand3  g026(.a(x02), .b(x01), .c(x00), .O(new_n70_));
  inv1   g027(.a(new_n70_), .O(new_n71_));
  nand3  g028(.a(new_n71_), .b(x10), .c(new_n61_), .O(new_n72_));
  nor4   g029(.a(new_n72_), .b(new_n50_), .c(x12), .d(x11), .O(z04));
  inv1   g030(.a(x10), .O(new_n74_));
  nor4   g031(.a(new_n70_), .b(new_n50_), .c(new_n74_), .d(new_n61_), .O(z05));
  inv1   g032(.a(x11), .O(new_n76_));
  nor3   g033(.a(new_n72_), .b(new_n50_), .c(new_n76_), .O(z06));
  nand2  g034(.a(x10), .b(new_n61_), .O(new_n78_));
  inv1   g035(.a(x12), .O(new_n79_));
  nand3  g036(.a(x17), .b(new_n79_), .c(x11), .O(new_n80_));
  ...
  nand4  g044(.a(new_n87_), .b(x02), .c(new_n44_), .d(new_n57_), .O(new_n88_));
  ...
  nor2   g049(.a(new_n92_), .b(new_n46_), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nor2   g052(.a(new_n51_), .b(x01), .O(new_n96_));
  nand3  g053(.a(new_n96_), .b(x12), .c(new_n76_), .O(new_n97_));
  ...
  nand4  g059(.a(new_n102_), .b(new_n46_), .c(x18), .d(x01), .O(new_n103_));
  oai21  g060(.a(new_n101_), .b(new_n97_), .c(new_n103_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n95_), .c(new_n94_), .d(new_n57_), .O(new_n105_));
  nand2  g062(.a(new_n50_), .b(x01), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n105_), .O(z09));
  nand3  g064(.a(x22), .b(x21), .c(new_n102_), .O(new_n108_));
  nor3   g065(.a(new_n108_), .b(new_n66_), .c(new_n44_), .O(new_n109_));
  inv1   g066(.a(x13), .O(new_n110_));
  nand3  g067(.a(new_n110_), .b(x12), .c(new_n76_), .O(new_n111_));
  ...
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n106_), .O(z10));
  nand3  g076(.a(x18), .b(x17), .c(x01), .O(new_n120_));
  nand3  g077(.a(x21), .b(new_n102_), .c(new_n46_), .O(new_n121_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n95_), .c(new_n57_), .O(new_n125_));
  ...
  nand2  g087(.a(new_n130_), .b(new_n52_), .O(new_n131_));
  aoi21  g088(.a(new_n131_), .b(new_n129_), .c(new_n50_), .O(new_n132_));
  inv1   g089(.a(x23), .O(new_n133_));
  nor4   g090(.a(new_n130_), .b(new_n133_), .c(x01), .d(x00), .O(new_n134_));
  oai21  g091(.a(new_n134_), .b(new_n132_), .c(new_n127_), .O(new_n135_));
  nor2   g092(.a(new_n135_), .b(new_n61_), .O(z12));
  inv1   g093(.a(new_n52_), .O(new_n137_));
  nand3  g094(.a(new_n46_), .b(x17), .c(new_n51_), .O(new_n138_));
  oai21  g095(.a(new_n138_), .b(new_n137_), .c(new_n106_), .O(z13));
  nand2  g096(.a(new_n58_), .b(new_n47_), .O(new_n140_));
  aoi21  g097(.a(new_n140_), .b(new_n44_), .c(x17), .O(z14));
  aoi22  g098(.a(new_n106_), .b(x00), .c(x19), .d(new_n44_), .O(new_n142_));
  nand4  g099(.a(x17), .b(new_n74_), .c(x01), .d(x00), .O(new_n143_));
  oai21  g100(.a(new_n142_), .b(x02), .c(new_n143_), .O(z15));
  nand3  g101(.a(x17), .b(x01), .c(new_n57_), .O(new_n145_));
  inv1   g102(.a(new_n145_), .O(z16));
  nand2  g103(.a(new_n96_), .b(new_n57_), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(new_n106_), .O(z17));
endmodule
