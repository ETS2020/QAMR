...
module FAU ( 
  ...
  nand4  g028(.a(x05), .b(x02), .c(x01), .d(x00), .O(new_n72_));
  ...
  aoi21  g036(.a(new_n79_), .b(x05), .c(new_n76_), .O(z05));
  nand4  g037(.a(new_n78_), .b(x11), .c(x10), .d(new_n47_), .O(new_n81_));
  aoi21  g038(.a(new_n81_), .b(x05), .c(new_n76_), .O(z06));
  inv1   g039(.a(x12), .O(new_n83_));
  nand4  g040(.a(new_n83_), .b(x11), .c(x10), .d(new_n47_), .O(new_n84_));
  ...
  nand4  g047(.a(new_n90_), .b(x02), .c(new_n76_), .d(new_n77_), .O(new_n91_));
  ...
  nand2  g065(.a(new_n108_), .b(new_n58_), .O(z09));
  ...
  nand3  g076(.a(new_n119_), .b(new_n111_), .c(new_n61_), .O(new_n120_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n76_), .c(new_n77_), .O(new_n131_));
  ...
  nand4  g093(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n60_), .O(new_n137_));
  nor2   g094(.a(new_n137_), .b(x19), .O(z14));
  oai21  g095(.a(x10), .b(new_n76_), .c(x02), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(x00), .O(new_n140_));
  nand3  g097(.a(x19), .b(new_n46_), .c(new_n76_), .O(new_n141_));
  nand3  g098(.a(new_n141_), .b(new_n140_), .c(new_n58_), .O(z15));
  nand3  g099(.a(x05), .b(x01), .c(new_n77_), .O(new_n143_));
