...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n49_, new_n50_, new_n51_,
    ...
    new_n103_, new_n105_, new_n106_, new_n107_, new_n109_, new_n111_,
    new_n112_, new_n113_, new_n114_, new_n115_, new_n116_, new_n117_,
    new_n118_, new_n121_, new_n123_, new_n124_, new_n126_;
  ...
  aoi21  g04(.a(new_n47_), .b(x11), .c(x01), .O(z00));
  ...
  nand2  g19(.a(new_n54_), .b(new_n52_), .O(new_n63_));
  inv1   g20(.a(x19), .O(new_n64_));
  nand3  g21(.a(new_n64_), .b(x18), .c(new_n44_), .O(new_n65_));
  oai21  g22(.a(new_n65_), .b(new_n63_), .c(x11), .O(new_n66_));
  nand2  g23(.a(new_n66_), .b(new_n53_), .O(new_n67_));
  nand3  g24(.a(x02), .b(x01), .c(x00), .O(new_n68_));
  nor2   g25(.a(new_n50_), .b(x09), .O(new_n69_));
  ...
  nand4  g31(.a(new_n74_), .b(new_n72_), .c(x10), .d(new_n51_), .O(new_n75_));
  nor2   g32(.a(new_n75_), .b(x12), .O(z04));
  nand2  g33(.a(x01), .b(x00), .O(new_n77_));
  nand2  g34(.a(new_n72_), .b(new_n53_), .O(new_n78_));
  nand3  g35(.a(x10), .b(x09), .c(x02), .O(new_n79_));
  oai21  g36(.a(new_n79_), .b(new_n77_), .c(new_n78_), .O(z05));
  nand3  g37(.a(x11), .b(x10), .c(new_n51_), .O(new_n81_));
  oai21  g38(.a(new_n81_), .b(new_n68_), .c(new_n78_), .O(z06));
  nor2   g39(.a(x12), .b(new_n72_), .O(new_n83_));
  nand2  g40(.a(new_n83_), .b(new_n69_), .O(new_n84_));
  nand2  g41(.a(new_n84_), .b(x01), .O(new_n85_));
  nand3  g42(.a(new_n85_), .b(x02), .c(x00), .O(new_n86_));
  nand2  g43(.a(new_n86_), .b(new_n78_), .O(z07));
  ...
  nand4  g49(.a(new_n92_), .b(x02), .c(new_n53_), .d(new_n52_), .O(new_n93_));
  ...
  nand4  g53(.a(new_n96_), .b(new_n49_), .c(x17), .d(x11), .O(new_n97_));
  nor2   g54(.a(new_n97_), .b(new_n64_), .O(z08));
  inv1   g55(.a(x22), .O(new_n99_));
  nor2   g56(.a(new_n53_), .b(x00), .O(z16));
  nand3  g57(.a(z16), .b(new_n64_), .c(x18), .O(new_n101_));
  nor3   g58(.a(new_n101_), .b(x21), .c(x20), .O(new_n102_));
  nand2  g59(.a(new_n102_), .b(new_n99_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(z09));
  nand3  g61(.a(x18), .b(x01), .c(new_n52_), .O(new_n105_));
  inv1   g62(.a(x20), .O(new_n106_));
  nand4  g63(.a(x22), .b(x21), .c(new_n106_), .d(new_n64_), .O(new_n107_));
  oai21  g64(.a(new_n107_), .b(new_n105_), .c(new_n78_), .O(z10));
  nand4  g65(.a(new_n99_), .b(x21), .c(new_n106_), .d(new_n64_), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n105_), .c(new_n78_), .O(z11));
  nand2  g67(.a(x10), .b(x02), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(x01), .c(x00), .O(new_n112_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g70(.a(new_n64_), .b(x17), .c(new_n54_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n53_), .c(new_n52_), .O(new_n116_));
  ...
  nor4   g76(.a(new_n55_), .b(x19), .c(new_n44_), .d(new_n72_), .O(z13));
  nand4  g77(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n50_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(x11), .c(x01), .O(z14));
  aoi21  g79(.a(new_n50_), .b(x01), .c(new_n54_), .O(new_n123_));
  aoi21  g80(.a(x19), .b(new_n54_), .c(new_n72_), .O(new_n124_));
  oai22  g81(.a(new_n124_), .b(x01), .c(new_n123_), .d(new_n52_), .O(z15));
  nand4  g82(.a(x11), .b(x02), .c(new_n53_), .d(new_n52_), .O(new_n126_));
