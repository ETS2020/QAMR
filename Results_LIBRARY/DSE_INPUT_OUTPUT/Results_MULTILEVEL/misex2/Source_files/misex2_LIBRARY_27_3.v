...
module FAU ( 
  ...
  nand4  g031(.a(new_n74_), .b(x10), .c(x09), .d(new_n59_), .O(new_n75_));
  inv1   g032(.a(new_n75_), .O(z05));
  inv1   g033(.a(x00), .O(new_n77_));
  nor2   g034(.a(new_n45_), .b(new_n77_), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x11), .c(x10), .d(new_n46_), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(new_n59_), .c(new_n67_), .O(z06));
  nand2  g037(.a(new_n46_), .b(new_n59_), .O(new_n81_));
  nand3  g038(.a(new_n69_), .b(x11), .c(x10), .O(new_n82_));
  ...
  nand4  g045(.a(new_n88_), .b(x02), .c(new_n67_), .d(new_n77_), .O(new_n89_));
  inv1   g046(.a(new_n89_), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n59_), .c(new_n87_), .d(x04), .O(new_n91_));
  ...
  nand4  g060(.a(new_n103_), .b(x18), .c(new_n59_), .d(x01), .O(new_n104_));
  oai21  g061(.a(new_n102_), .b(new_n98_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n77_), .O(new_n106_));
  inv1   g063(.a(new_n106_), .O(z09));
  nand3  g064(.a(new_n51_), .b(x18), .c(x01), .O(new_n108_));
  nand2  g065(.a(x22), .b(x21), .O(new_n109_));
  nor3   g066(.a(new_n109_), .b(new_n108_), .c(x20), .O(new_n110_));
  ...
  nor2   g077(.a(new_n50_), .b(x06), .O(new_n121_));
  nor2   g078(.a(new_n95_), .b(x20), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n121_), .c(new_n51_), .d(x01), .O(new_n123_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n96_), .c(new_n77_), .O(new_n127_));
  inv1   g084(.a(new_n127_), .O(z11));
  nand2  g085(.a(x10), .b(x02), .O(new_n129_));
  nand4  g086(.a(new_n129_), .b(new_n59_), .c(x01), .d(x00), .O(new_n130_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n67_), .c(new_n77_), .O(new_n134_));
  ...
  nand3  g103(.a(new_n59_), .b(x01), .c(new_n77_), .O(new_n147_));
