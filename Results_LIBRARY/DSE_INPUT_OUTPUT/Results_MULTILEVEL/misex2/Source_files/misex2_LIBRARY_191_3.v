...
module FAU ( 
  ...
  nand2  g009(.a(x03), .b(x00), .O(new_n53_));
  ...
  aoi21  g031(.a(new_n74_), .b(new_n68_), .c(new_n63_), .O(z04));
  nand4  g032(.a(new_n68_), .b(x02), .c(x01), .d(x00), .O(new_n76_));
  inv1   g033(.a(new_n76_), .O(new_n77_));
  nand3  g034(.a(new_n77_), .b(x10), .c(x09), .O(new_n78_));
  inv1   g035(.a(new_n78_), .O(z05));
  inv1   g036(.a(x11), .O(new_n80_));
  nor4   g037(.a(new_n76_), .b(new_n80_), .c(new_n58_), .d(x09), .O(z06));
  inv1   g038(.a(x12), .O(new_n82_));
  nand4  g039(.a(new_n82_), .b(x11), .c(x10), .d(new_n47_), .O(new_n83_));
  nand2  g040(.a(new_n83_), .b(x01), .O(new_n84_));
  nand2  g041(.a(new_n84_), .b(x02), .O(new_n85_));
  aoi21  g042(.a(new_n85_), .b(new_n68_), .c(new_n63_), .O(z07));
  inv1   g043(.a(x08), .O(new_n87_));
  inv1   g044(.a(x05), .O(new_n88_));
  inv1   g045(.a(x06), .O(new_n89_));
  nand4  g046(.a(new_n68_), .b(x02), .c(new_n64_), .d(new_n63_), .O(new_n90_));
  ...
  nand4  g074(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n66_), .O(new_n118_));
  nor2   g075(.a(new_n100_), .b(x14), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(new_n96_), .c(x20), .d(new_n101_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(new_n113_), .c(new_n118_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n97_), .c(new_n63_), .O(new_n122_));
  inv1   g079(.a(new_n122_), .O(z11));
  nand2  g080(.a(x10), .b(x02), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n68_), .c(x01), .d(x00), .O(new_n125_));
  oai21  g082(.a(x19), .b(x02), .c(x23), .O(new_n126_));
  nand3  g083(.a(new_n66_), .b(x17), .c(new_n46_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n64_), .c(new_n63_), .O(new_n129_));
  ...
  oai21  g090(.a(new_n127_), .b(new_n133_), .c(new_n53_), .O(z13));
  nor2   g091(.a(x09), .b(x02), .O(new_n135_));
  nor2   g092(.a(x17), .b(x10), .O(new_n136_));
  nand4  g093(.a(new_n136_), .b(new_n135_), .c(new_n55_), .d(new_n48_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n53_), .O(z14));
  aoi21  g095(.a(x19), .b(new_n64_), .c(x00), .O(new_n139_));
  aoi21  g096(.a(new_n58_), .b(x01), .c(x03), .O(new_n140_));
  oai22  g097(.a(new_n140_), .b(new_n63_), .c(new_n139_), .d(x02), .O(z15));
  oai21  g098(.a(new_n64_), .b(x00), .c(new_n53_), .O(z16));
  nand2  g099(.a(new_n98_), .b(new_n63_), .O(new_n143_));
