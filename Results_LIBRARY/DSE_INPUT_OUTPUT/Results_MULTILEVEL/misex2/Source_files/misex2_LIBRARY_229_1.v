...
module FAU ( 
  ...
  nand4  g46(.a(new_n89_), .b(new_n54_), .c(x17), .d(new_n82_), .O(new_n90_));
  nor2   g47(.a(new_n90_), .b(new_n60_), .O(z08));
  nand2  g48(.a(new_n65_), .b(x02), .O(new_n92_));
  nor4   g49(.a(new_n92_), .b(x14), .c(x13), .d(new_n66_), .O(new_n93_));
  nor2   g50(.a(x22), .b(x21), .O(new_n94_));
  nand2  g51(.a(new_n94_), .b(x20), .O(new_n95_));
  nor3   g52(.a(new_n95_), .b(x16), .c(x15), .O(new_n96_));
  nand2  g53(.a(new_n96_), .b(new_n93_), .O(new_n97_));
  aoi21  g54(.a(new_n97_), .b(new_n44_), .c(x00), .O(z09));
  inv1   g55(.a(new_n95_), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n93_), .c(x16), .d(x15), .O(new_n100_));
  aoi21  g57(.a(new_n100_), .b(new_n44_), .c(x00), .O(z10));
  inv1   g58(.a(x16), .O(new_n102_));
  nand4  g59(.a(new_n99_), .b(new_n93_), .c(new_n102_), .d(x15), .O(new_n103_));
  ...
  nand3  g66(.a(new_n109_), .b(new_n44_), .c(new_n55_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n106_), .c(x24), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(x09), .O(new_n112_));
  inv1   g69(.a(new_n112_), .O(z12));
  aoi21  g70(.a(new_n108_), .b(new_n44_), .c(x00), .O(z13));
  nand4  g71(.a(new_n47_), .b(new_n52_), .c(new_n46_), .d(new_n45_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g73(.a(new_n52_), .b(new_n55_), .c(x01), .O(new_n117_));
  oai21  g74(.a(x19), .b(x00), .c(new_n45_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(z15));
  nor2   g76(.a(new_n44_), .b(x00), .O(z16));
  aoi21  g77(.a(new_n45_), .b(new_n44_), .c(x00), .O(z17));
endmodule
