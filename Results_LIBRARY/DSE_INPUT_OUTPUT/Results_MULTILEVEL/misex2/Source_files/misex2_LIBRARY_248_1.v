...
module FAU ( 
  ...
  nand4  g34(.a(new_n66_), .b(x11), .c(x10), .d(new_n49_), .O(new_n78_));
  ...
  nand4  g52(.a(new_n65_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n96_));
  ...
  nand3  g67(.a(new_n60_), .b(x17), .c(new_n48_), .O(new_n111_));
  ...
  nand4  g74(.a(new_n54_), .b(new_n57_), .c(new_n49_), .d(new_n48_), .O(new_n118_));
  aoi21  g75(.a(new_n118_), .b(new_n47_), .c(x00), .O(z14));
  aoi21  g76(.a(new_n57_), .b(x01), .c(new_n48_), .O(new_n120_));
