...
module FAU ( 
  ...
  nor2   g25(.a(new_n48_), .b(x01), .O(new_n71_));
  ...
  nand2  g36(.a(new_n81_), .b(new_n61_), .O(z08));
  inv1   g37(.a(x21), .O(new_n83_));
  inv1   g38(.a(x22), .O(new_n84_));
  inv1   g39(.a(x11), .O(new_n85_));
  nand4  g40(.a(x12), .b(new_n85_), .c(x02), .d(new_n47_), .O(new_n86_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n84_), .c(new_n83_), .d(new_n46_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z09));
  nand2  g51(.a(new_n63_), .b(x18), .O(new_n97_));
  nand3  g52(.a(x22), .b(x21), .c(new_n91_), .O(new_n98_));
  oai21  g53(.a(new_n98_), .b(new_n97_), .c(new_n46_), .O(new_n99_));
  ...
  nand4  g64(.a(new_n92_), .b(x21), .c(new_n91_), .d(new_n63_), .O(new_n110_));
  ...
  nand3  g70(.a(new_n115_), .b(new_n84_), .c(new_n46_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(z11));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g73(.a(new_n63_), .b(x17), .c(new_n48_), .O(new_n119_));
  aoi21  g74(.a(new_n119_), .b(new_n118_), .c(x24), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(x09), .c(new_n47_), .d(new_n46_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n61_), .O(z12));
  nand3  g77(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n123_));
  nor3   g78(.a(new_n123_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g79(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n125_));
  ...
  nand3  g84(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n130_));
