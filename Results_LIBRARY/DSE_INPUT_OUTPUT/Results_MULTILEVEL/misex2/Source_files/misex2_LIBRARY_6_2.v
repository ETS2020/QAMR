...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n128_, new_n129_, new_n132_, new_n134_, new_n135_, new_n137_;
  ...
  nor3   g29(.a(new_n72_), .b(new_n57_), .c(new_n46_), .O(z05));
  ...
  nand4  g42(.a(new_n85_), .b(new_n83_), .c(new_n82_), .d(new_n79_), .O(new_n86_));
  aoi21  g43(.a(new_n86_), .b(new_n44_), .c(x01), .O(z08));
  nor2   g44(.a(x14), .b(x13), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(x12), .c(new_n68_), .d(x02), .O(new_n89_));
  ...
  oai21  g50(.a(new_n93_), .b(new_n89_), .c(new_n44_), .O(new_n94_));
  nand2  g51(.a(new_n94_), .b(new_n52_), .O(new_n95_));
  and2   g52(.a(x18), .b(x01), .O(new_n96_));
  nor2   g53(.a(x20), .b(x19), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(new_n96_), .c(new_n92_), .d(new_n44_), .O(new_n98_));
  nand2  g55(.a(new_n98_), .b(new_n95_), .O(z09));
  nand2  g56(.a(x22), .b(x21), .O(new_n100_));
  nor2   g57(.a(new_n100_), .b(x20), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n64_), .c(x18), .d(x01), .O(new_n102_));
  nand2  g59(.a(new_n92_), .b(x20), .O(new_n103_));
  ...
  nand4  g66(.a(new_n109_), .b(new_n108_), .c(new_n105_), .d(new_n104_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n102_), .c(x00), .O(z10));
  inv1   g68(.a(x22), .O(new_n112_));
  nor2   g69(.a(x13), .b(new_n69_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n105_), .c(new_n68_), .O(new_n114_));
  inv1   g71(.a(x20), .O(new_n115_));
  nand4  g72(.a(new_n96_), .b(x21), .c(new_n115_), .d(new_n64_), .O(new_n116_));
  nor2   g73(.a(new_n90_), .b(x14), .O(new_n117_));
  nor2   g74(.a(x21), .b(new_n115_), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(new_n117_), .c(new_n91_), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n114_), .c(new_n116_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n112_), .c(new_n44_), .O(new_n121_));
  inv1   g78(.a(new_n121_), .O(z11));
  inv1   g79(.a(x24), .O(new_n123_));
  aoi21  g80(.a(x10), .b(x02), .c(new_n44_), .O(new_n124_));
  oai21  g81(.a(x19), .b(x02), .c(x23), .O(new_n125_));
  nand3  g82(.a(new_n64_), .b(x17), .c(new_n45_), .O(new_n126_));
  aoi21  g83(.a(new_n126_), .b(new_n125_), .c(x01), .O(new_n127_));
  oai21  g84(.a(new_n127_), .b(new_n124_), .c(new_n123_), .O(new_n128_));
  nand2  g85(.a(new_n52_), .b(x00), .O(new_n129_));
  oai21  g86(.a(new_n128_), .b(new_n46_), .c(new_n129_), .O(z12));
  aoi21  g87(.a(new_n126_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g88(.a(new_n47_), .b(new_n57_), .c(new_n46_), .d(new_n45_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(new_n44_), .c(x01), .O(z14));
  nand2  g90(.a(x19), .b(new_n45_), .O(new_n134_));
  aoi21  g91(.a(new_n134_), .b(new_n44_), .c(x01), .O(new_n135_));
  or2    g92(.a(new_n135_), .b(new_n124_), .O(z15));
  nand2  g93(.a(x01), .b(new_n44_), .O(new_n137_));
  nand2  g94(.a(new_n137_), .b(new_n129_), .O(z16));
  aoi21  g95(.a(new_n45_), .b(new_n44_), .c(x01), .O(z17));
endmodule
