...
module FAU ( 
  ...
  nand4  g50(.a(new_n93_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n94_));
  ...
  nand3  g56(.a(new_n92_), .b(new_n91_), .c(x12), .O(new_n100_));
  nor3   g57(.a(new_n100_), .b(x11), .c(new_n45_), .O(new_n101_));
  inv1   g58(.a(x22), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n90_), .c(x20), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n101_), .c(x16), .d(x15), .O(new_n105_));
  aoi21  g62(.a(new_n105_), .b(new_n44_), .c(x00), .O(z10));
  nand4  g63(.a(new_n104_), .b(new_n101_), .c(new_n89_), .d(x15), .O(new_n107_));
  ...
  nand3  g68(.a(new_n57_), .b(x17), .c(new_n45_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n44_), .c(new_n55_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n110_), .c(x24), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(x09), .O(new_n116_));
  inv1   g73(.a(new_n116_), .O(z12));
  aoi21  g74(.a(new_n112_), .b(new_n44_), .c(x00), .O(z13));
  nand4  g75(.a(new_n47_), .b(new_n52_), .c(new_n46_), .d(new_n45_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g77(.a(new_n52_), .b(new_n55_), .c(x01), .O(new_n121_));
  oai21  g78(.a(x19), .b(x00), .c(new_n45_), .O(new_n122_));
