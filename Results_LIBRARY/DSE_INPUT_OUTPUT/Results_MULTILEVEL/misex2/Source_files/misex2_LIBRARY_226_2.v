...
module FAU ( 
  ...
  aoi21  g25(.a(new_n68_), .b(x01), .c(new_n53_), .O(z04));
  ...
  nand4  g63(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n62_), .O(new_n107_));
  ...
  nand3  g72(.a(new_n115_), .b(new_n104_), .c(new_n53_), .O(new_n116_));
