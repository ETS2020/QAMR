...
module FAU ( 
  ...
  nor2   g37(.a(new_n44_), .b(x00), .O(z16));
  inv1   g38(.a(z16), .O(new_n82_));
  ...
  oai21  g72(.a(new_n115_), .b(new_n46_), .c(new_n82_), .O(z12));
  aoi21  g73(.a(new_n113_), .b(new_n44_), .c(x00), .O(z13));
  nand4  g74(.a(new_n47_), .b(new_n57_), .c(new_n46_), .d(new_n45_), .O(new_n118_));
