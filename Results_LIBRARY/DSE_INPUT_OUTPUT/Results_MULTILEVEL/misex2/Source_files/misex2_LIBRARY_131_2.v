...
module FAU ( 
  ...
  nor2   g25(.a(x09), .b(new_n48_), .O(new_n69_));
  ...
  oai21  g52(.a(new_n95_), .b(new_n89_), .c(new_n46_), .O(new_n96_));
  nand2  g53(.a(new_n96_), .b(new_n47_), .O(new_n97_));
  nor2   g54(.a(new_n45_), .b(new_n47_), .O(new_n98_));
  nor2   g55(.a(x20), .b(x19), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n98_), .c(new_n92_), .d(new_n46_), .O(new_n100_));
  ...
  nor2   g62(.a(x13), .b(new_n68_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n67_), .c(x02), .d(new_n47_), .O(new_n107_));
  nor3   g64(.a(new_n91_), .b(new_n90_), .c(x14), .O(new_n108_));
  ...
  nor2   g68(.a(new_n102_), .b(x20), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n98_), .c(new_n61_), .O(new_n113_));
  nor2   g70(.a(new_n90_), .b(x14), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n102_), .c(x20), .d(new_n91_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n107_), .c(new_n113_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n103_), .c(new_n46_), .O(new_n117_));
  ...
  nor3   g84(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g85(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n129_));
  nor2   g86(.a(new_n129_), .b(x19), .O(z14));
  aoi21  g87(.a(x19), .b(new_n48_), .c(x00), .O(new_n131_));
  nand2  g88(.a(new_n119_), .b(x00), .O(new_n132_));
