...
module FAU ( 
  ...
  nand3  g32(.a(new_n63_), .b(x11), .c(x10), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x01), .c(new_n53_), .O(z06));
  ...
  oai21  g59(.a(new_n102_), .b(new_n92_), .c(new_n53_), .O(new_n103_));
  ...
  nand4  g64(.a(new_n94_), .b(x20), .c(new_n107_), .d(x15), .O(new_n108_));
  oai21  g65(.a(new_n108_), .b(new_n92_), .c(new_n53_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n62_), .O(new_n110_));
  ...
  aoi21  g71(.a(x10), .b(x02), .c(new_n53_), .O(new_n115_));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g73(.a(new_n67_), .b(x17), .c(new_n46_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n116_), .c(x01), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n115_), .c(new_n114_), .O(new_n119_));
  nand2  g76(.a(new_n62_), .b(x00), .O(new_n120_));
  oai21  g77(.a(new_n119_), .b(new_n47_), .c(new_n120_), .O(z12));
  aoi21  g78(.a(new_n117_), .b(new_n53_), .c(x01), .O(z13));
  nand4  g79(.a(new_n54_), .b(new_n57_), .c(new_n47_), .d(new_n46_), .O(new_n123_));
  aoi21  g80(.a(new_n123_), .b(new_n53_), .c(x01), .O(z14));
  ...
  nor2   g85(.a(new_n62_), .b(x00), .O(z16));
