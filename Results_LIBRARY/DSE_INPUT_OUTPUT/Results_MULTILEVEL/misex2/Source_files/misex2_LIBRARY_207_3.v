...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n135_, new_n137_, new_n139_, new_n141_, new_n144_;
  ...
  nand4  g023(.a(new_n66_), .b(new_n61_), .c(x18), .d(new_n49_), .O(new_n67_));
  ...
  nor2   g032(.a(new_n45_), .b(new_n75_), .O(new_n76_));
  nand3  g033(.a(new_n76_), .b(x10), .c(x09), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(new_n61_), .c(new_n69_), .O(z05));
  nand4  g035(.a(new_n76_), .b(x11), .c(x10), .d(new_n46_), .O(new_n79_));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n69_), .d(new_n75_), .O(new_n90_));
  ...
  nand4  g050(.a(new_n93_), .b(new_n53_), .c(x17), .d(new_n86_), .O(new_n94_));
  nor2   g051(.a(new_n94_), .b(new_n61_), .O(z08));
  ...
  nand4  g063(.a(new_n106_), .b(new_n97_), .c(new_n96_), .d(new_n75_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n44_), .O(z09));
  nand3  g065(.a(x22), .b(x21), .c(new_n104_), .O(new_n109_));
  nor3   g066(.a(new_n109_), .b(new_n53_), .c(new_n69_), .O(new_n110_));
  inv1   g067(.a(x13), .O(new_n111_));
  nand3  g068(.a(new_n111_), .b(x12), .c(new_n70_), .O(new_n112_));
  inv1   g069(.a(new_n112_), .O(new_n113_));
  nand2  g070(.a(new_n113_), .b(new_n98_), .O(new_n114_));
  ...
  nand4  g077(.a(x21), .b(new_n104_), .c(x18), .d(x01), .O(new_n121_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n97_), .c(new_n75_), .O(new_n125_));
  ...
  aoi21  g087(.a(new_n130_), .b(new_n129_), .c(x01), .O(new_n131_));
  and2   g088(.a(x23), .b(x19), .O(new_n132_));
  oai21  g089(.a(new_n132_), .b(new_n131_), .c(new_n75_), .O(new_n133_));
  ...
  oai22  g098(.a(new_n141_), .b(new_n75_), .c(new_n98_), .d(new_n61_), .O(z15));
  aoi21  g099(.a(new_n61_), .b(x00), .c(new_n69_), .O(z16));
  nand2  g100(.a(new_n98_), .b(new_n75_), .O(new_n144_));
