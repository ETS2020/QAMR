...
module FAU ( 
  ...
  nand4  g18(.a(new_n49_), .b(x18), .c(new_n47_), .d(x13), .O(new_n62_));
  ...
  nor3   g27(.a(new_n66_), .b(new_n70_), .c(new_n46_), .O(z05));
  ...
  nand4  g43(.a(new_n86_), .b(x02), .c(new_n56_), .d(new_n44_), .O(new_n87_));
  ...
  nand4  g47(.a(new_n90_), .b(new_n48_), .c(x17), .d(x13), .O(new_n91_));
  nor2   g48(.a(new_n91_), .b(new_n49_), .O(z08));
  inv1   g49(.a(x22), .O(new_n93_));
  inv1   g50(.a(x20), .O(new_n94_));
  nor2   g51(.a(new_n56_), .b(x00), .O(new_n95_));
  nand4  g52(.a(new_n95_), .b(new_n94_), .c(new_n49_), .d(x18), .O(new_n96_));
  nor2   g53(.a(new_n96_), .b(x21), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(new_n93_), .O(new_n98_));
  ...
  nand2  g60(.a(new_n101_), .b(new_n93_), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(z11));
  aoi21  g62(.a(x10), .b(x02), .c(new_n56_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(x00), .O(new_n107_));
  oai21  g64(.a(x19), .b(x02), .c(x23), .O(new_n108_));
  nand3  g65(.a(new_n49_), .b(x17), .c(new_n45_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n56_), .c(new_n44_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n107_), .c(x24), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(x09), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n80_), .O(z12));
  nand4  g71(.a(new_n49_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(x13), .c(x01), .O(z13));
  nor3   g73(.a(new_n57_), .b(x10), .c(x09), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n48_), .c(new_n47_), .d(x13), .O(new_n118_));
  nor2   g75(.a(new_n118_), .b(x19), .O(z14));
  aoi21  g76(.a(x13), .b(new_n45_), .c(new_n106_), .O(new_n120_));
  nand4  g77(.a(x19), .b(x13), .c(new_n45_), .d(new_n56_), .O(new_n121_));
  oai21  g78(.a(new_n120_), .b(new_n44_), .c(new_n121_), .O(z15));
  oai21  g79(.a(new_n56_), .b(x00), .c(new_n80_), .O(z16));
  nand2  g80(.a(x02), .b(new_n44_), .O(new_n124_));
  aoi21  g81(.a(new_n124_), .b(x13), .c(x01), .O(z17));
endmodule
