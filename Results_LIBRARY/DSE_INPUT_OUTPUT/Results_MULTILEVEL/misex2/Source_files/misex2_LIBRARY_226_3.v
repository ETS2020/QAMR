...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n115_, new_n116_, new_n119_, new_n121_, new_n123_;
  ...
  nand2  g17(.a(new_n48_), .b(new_n46_), .O(new_n61_));
  ...
  oai21  g40(.a(new_n83_), .b(new_n79_), .c(new_n67_), .O(new_n84_));
  ...
  oai21  g53(.a(new_n96_), .b(new_n79_), .c(new_n67_), .O(new_n97_));
  ...
  nand3  g67(.a(new_n110_), .b(new_n82_), .c(new_n67_), .O(new_n111_));
  ...
  nand3  g72(.a(new_n115_), .b(x09), .c(new_n64_), .O(new_n116_));
  nor2   g73(.a(new_n116_), .b(x00), .O(z12));
  nor3   g74(.a(new_n61_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g75(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n119_));
  nor2   g76(.a(new_n119_), .b(x19), .O(z14));
  nor2   g77(.a(x19), .b(x00), .O(new_n121_));
  nor3   g78(.a(new_n121_), .b(x02), .c(x01), .O(z15));
  nand2  g79(.a(new_n48_), .b(x02), .O(new_n123_));
  inv1   g80(.a(new_n123_), .O(z17));
  inv1   g81(.a(new_n53_), .O(z05));
  inv1   g82(.a(new_n53_), .O(z06));
  buf    g83(.a(x01), .O(z16));
endmodule
