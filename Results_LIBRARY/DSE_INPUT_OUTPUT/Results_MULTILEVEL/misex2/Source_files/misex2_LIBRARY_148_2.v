...
module FAU ( 
  ...
  nor2   g19(.a(x09), .b(new_n53_), .O(new_n63_));
  ...
  nand4  g36(.a(new_n63_), .b(new_n72_), .c(x11), .d(x10), .O(new_n80_));
  aoi21  g37(.a(new_n80_), .b(x01), .c(new_n52_), .O(z07));
  inv1   g38(.a(x08), .O(new_n82_));
  inv1   g39(.a(x05), .O(new_n83_));
  inv1   g40(.a(x06), .O(new_n84_));
  inv1   g41(.a(x03), .O(new_n85_));
  nand4  g42(.a(new_n85_), .b(x02), .c(new_n62_), .d(new_n52_), .O(new_n86_));
  ...
  nand4  g50(.a(x12), .b(new_n71_), .c(x02), .d(new_n62_), .O(new_n94_));
  ...
  nand2  g57(.a(new_n100_), .b(new_n67_), .O(new_n101_));
  ...
  nand4  g61(.a(new_n97_), .b(x12), .c(new_n71_), .d(x02), .O(new_n105_));
  nand3  g62(.a(new_n93_), .b(new_n92_), .c(x20), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(x16), .c(x15), .O(new_n108_));
  oai21  g65(.a(new_n108_), .b(new_n105_), .c(new_n52_), .O(new_n109_));
  ...
  oai21  g72(.a(new_n115_), .b(new_n105_), .c(new_n52_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n62_), .O(new_n117_));
  nand4  g74(.a(new_n112_), .b(new_n111_), .c(new_n93_), .d(x21), .O(new_n118_));
  ...
  nand3  g79(.a(new_n67_), .b(x17), .c(new_n53_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand3  g81(.a(new_n124_), .b(new_n62_), .c(new_n52_), .O(new_n125_));
  ...
  nand4  g87(.a(new_n54_), .b(new_n57_), .c(new_n46_), .d(new_n53_), .O(new_n131_));
  aoi21  g88(.a(new_n131_), .b(new_n52_), .c(x01), .O(z14));
  nor2   g89(.a(x01), .b(x00), .O(new_n133_));
  nand3  g90(.a(new_n133_), .b(x19), .c(new_n53_), .O(new_n134_));
