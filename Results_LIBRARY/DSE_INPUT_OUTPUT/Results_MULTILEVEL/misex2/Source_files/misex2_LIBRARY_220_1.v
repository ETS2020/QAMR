...
module FAU ( 
  ...
  nand4  g64(.a(new_n67_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n108_));
  ...
  oai21  g76(.a(new_n119_), .b(new_n46_), .c(new_n82_), .O(z12));
  nand2  g77(.a(new_n47_), .b(x17), .O(new_n121_));
  nor2   g78(.a(new_n121_), .b(x19), .O(z13));
  nand4  g79(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n123_));
  nor2   g80(.a(new_n123_), .b(x19), .O(z14));
  aoi21  g81(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n125_));
  nand3  g82(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n126_));
  oai21  g83(.a(new_n125_), .b(new_n59_), .c(new_n126_), .O(z15));
  nand3  g84(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n128_));
