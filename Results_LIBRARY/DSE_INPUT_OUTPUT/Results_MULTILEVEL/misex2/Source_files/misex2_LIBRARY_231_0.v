...
module FAU ( 
  ...
  wire new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n54_, new_n55_,
    ...
    new_n85_, new_n86_, new_n89_, new_n91_;
  ...
  nand3  g14(.a(x02), .b(x01), .c(x00), .O(new_n61_));
  inv1   g15(.a(new_n61_), .O(new_n62_));
  nand4  g16(.a(new_n62_), .b(x11), .c(x10), .d(new_n60_), .O(new_n63_));
  inv1   g17(.a(new_n63_), .O(z06));
  inv1   g18(.a(x12), .O(new_n65_));
  nand4  g19(.a(new_n65_), .b(x11), .c(x10), .d(new_n60_), .O(new_n66_));
  nand2  g20(.a(new_n66_), .b(x01), .O(new_n67_));
  ...
  inv1   g26(.a(x00), .O(new_n74_));
  inv1   g27(.a(x19), .O(new_n75_));
  nand4  g28(.a(new_n75_), .b(x18), .c(x01), .d(new_n74_), .O(new_n76_));
  inv1   g29(.a(new_n76_), .O(new_n77_));
  nand4  g30(.a(new_n77_), .b(new_n73_), .c(new_n72_), .d(new_n71_), .O(new_n78_));
  inv1   g31(.a(new_n78_), .O(z09));
  nor2   g32(.a(new_n73_), .b(new_n72_), .O(new_n80_));
  nand4  g33(.a(new_n80_), .b(new_n71_), .c(new_n75_), .d(x18), .O(new_n81_));
  aoi21  g34(.a(new_n81_), .b(x01), .c(x00), .O(z10));
  nand4  g35(.a(new_n77_), .b(new_n73_), .c(x21), .d(new_n71_), .O(new_n83_));
  inv1   g36(.a(new_n83_), .O(z11));
  aoi21  g37(.a(x10), .b(x02), .c(x24), .O(new_n85_));
  nand3  g38(.a(new_n85_), .b(x09), .c(x01), .O(new_n86_));
  nor2   g39(.a(new_n86_), .b(new_n74_), .O(z12));
  nand2  g40(.a(new_n50_), .b(x01), .O(new_n89_));
  aoi21  g41(.a(new_n89_), .b(x02), .c(new_n74_), .O(z15));
  inv1   g42(.a(x01), .O(new_n91_));
