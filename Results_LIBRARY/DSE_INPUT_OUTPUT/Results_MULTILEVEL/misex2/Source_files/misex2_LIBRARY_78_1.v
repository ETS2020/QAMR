...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n117_, new_n120_, new_n121_, new_n123_, new_n124_;
  ...
  nand3  g57(.a(new_n93_), .b(new_n92_), .c(x12), .O(new_n101_));
  nor3   g58(.a(new_n101_), .b(x11), .c(new_n48_), .O(new_n102_));
  inv1   g59(.a(x22), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(new_n91_), .c(x20), .O(new_n104_));
  ...
  nand4  g64(.a(new_n105_), .b(new_n102_), .c(new_n90_), .d(x15), .O(new_n108_));
