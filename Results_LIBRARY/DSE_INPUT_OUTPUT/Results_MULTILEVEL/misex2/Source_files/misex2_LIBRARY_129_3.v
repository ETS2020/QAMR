...
module FAU ( 
  ...
  nor2   g023(.a(x19), .b(new_n50_), .O(new_n67_));
  ...
  nor4   g032(.a(new_n72_), .b(x14), .c(new_n56_), .d(new_n46_), .O(z05));
  inv1   g033(.a(x01), .O(new_n77_));
  inv1   g034(.a(x00), .O(new_n78_));
  nor2   g035(.a(new_n45_), .b(new_n78_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(x11), .c(x10), .d(new_n46_), .O(new_n80_));
  aoi21  g037(.a(new_n80_), .b(new_n61_), .c(new_n77_), .O(z06));
  nand2  g038(.a(x10), .b(new_n46_), .O(new_n82_));
  nand3  g039(.a(new_n61_), .b(new_n71_), .c(x11), .O(new_n83_));
  ...
  nand4  g047(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n78_), .O(new_n91_));
  nor3   g048(.a(x08), .b(x07), .c(x06), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(x19), .c(new_n50_), .d(x17), .O(new_n93_));
  oai21  g050(.a(new_n93_), .b(new_n91_), .c(new_n44_), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nand4  g053(.a(x12), .b(new_n70_), .c(x02), .d(new_n77_), .O(new_n97_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n78_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n44_), .O(z09));
  nor2   g064(.a(new_n96_), .b(new_n95_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n67_), .c(new_n102_), .d(x01), .O(new_n109_));
  nor2   g066(.a(x13), .b(new_n71_), .O(new_n110_));
  nand3  g067(.a(new_n110_), .b(new_n88_), .c(new_n70_), .O(new_n111_));
  nor2   g068(.a(x22), .b(x21), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(x20), .c(x16), .d(x15), .O(new_n113_));
  oai21  g070(.a(new_n113_), .b(new_n111_), .c(new_n109_), .O(new_n114_));
  nand3  g071(.a(new_n114_), .b(new_n61_), .c(new_n78_), .O(new_n115_));
  inv1   g072(.a(new_n115_), .O(z10));
  nand4  g073(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n51_), .O(new_n117_));
  nor2   g074(.a(new_n98_), .b(x13), .O(new_n118_));
  nor2   g075(.a(x21), .b(new_n102_), .O(new_n119_));
  nand3  g076(.a(new_n119_), .b(new_n118_), .c(new_n99_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(new_n97_), .c(new_n117_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n96_), .c(new_n61_), .d(new_n78_), .O(new_n122_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n77_), .c(new_n78_), .O(new_n130_));
  ...
  oai21  g096(.a(x10), .b(new_n77_), .c(x02), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(x00), .O(new_n141_));
  nand3  g098(.a(x19), .b(new_n45_), .c(new_n77_), .O(new_n142_));
  nand3  g099(.a(new_n142_), .b(new_n141_), .c(new_n44_), .O(z15));
  aoi21  g100(.a(new_n61_), .b(x00), .c(new_n77_), .O(z16));
  nand2  g101(.a(new_n47_), .b(x02), .O(new_n145_));
