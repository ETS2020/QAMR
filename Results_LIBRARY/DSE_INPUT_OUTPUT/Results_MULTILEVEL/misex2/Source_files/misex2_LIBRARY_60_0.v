...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_, new_n54_,
    ...
    new_n75_, new_n77_, new_n78_, new_n80_, new_n81_, new_n85_, new_n86_;
  ...
  nand4  g29(.a(new_n72_), .b(x22), .c(x21), .d(new_n67_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(z10));
  nor2   g31(.a(x22), .b(new_n68_), .O(new_n77_));
  nand4  g32(.a(new_n77_), .b(new_n67_), .c(new_n70_), .d(x18), .O(new_n78_));
  aoi21  g33(.a(new_n78_), .b(x01), .c(x00), .O(z11));
  aoi21  g34(.a(x10), .b(x02), .c(x24), .O(new_n80_));
  nand3  g35(.a(new_n80_), .b(x09), .c(x01), .O(new_n81_));
  nor2   g36(.a(new_n81_), .b(z16), .O(z12));
