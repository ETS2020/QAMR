...
module FAU ( 
  ...
  nor4   g31(.a(new_n74_), .b(new_n73_), .c(new_n57_), .d(x09), .O(z06));
  nor3   g32(.a(new_n69_), .b(x12), .c(new_n73_), .O(z07));
  inv1   g33(.a(x08), .O(new_n77_));
  inv1   g34(.a(x05), .O(new_n78_));
  inv1   g35(.a(x06), .O(new_n79_));
  inv1   g36(.a(x03), .O(new_n80_));
  nand4  g37(.a(new_n80_), .b(x02), .c(new_n60_), .d(new_n44_), .O(new_n81_));
  ...
  nand4  g44(.a(new_n87_), .b(x12), .c(new_n73_), .d(x02), .O(new_n88_));
  ...
  nor3   g51(.a(new_n51_), .b(new_n60_), .c(x00), .O(new_n95_));
  ...
  nand4  g66(.a(new_n109_), .b(new_n108_), .c(x12), .d(new_n73_), .O(new_n110_));
  ...
  nand3  g70(.a(new_n113_), .b(new_n104_), .c(new_n44_), .O(new_n114_));
  ...
  nand3  g79(.a(new_n52_), .b(x17), .c(new_n45_), .O(new_n123_));
