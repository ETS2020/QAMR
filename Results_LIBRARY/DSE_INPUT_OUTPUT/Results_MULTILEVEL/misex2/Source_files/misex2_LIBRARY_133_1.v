...
module FAU ( 
  ...
  nand3  g26(.a(new_n69_), .b(x10), .c(new_n53_), .O(new_n70_));
  nor3   g27(.a(new_n70_), .b(x12), .c(x11), .O(z04));
  nor3   g28(.a(new_n68_), .b(new_n46_), .c(new_n53_), .O(z05));
  ...
  nand4  g49(.a(new_n76_), .b(x02), .c(new_n44_), .d(new_n54_), .O(new_n93_));
  ...
  nand3  g59(.a(new_n92_), .b(new_n91_), .c(x12), .O(new_n103_));
