...
module FAU ( 
  ...
  nand4  g029(.a(new_n72_), .b(x10), .c(new_n47_), .d(x02), .O(new_n73_));
  nor3   g030(.a(new_n73_), .b(x12), .c(x11), .O(z04));
  nand2  g031(.a(x21), .b(new_n61_), .O(new_n75_));
  nand3  g032(.a(x10), .b(x09), .c(x02), .O(new_n76_));
  oai21  g033(.a(new_n76_), .b(new_n71_), .c(new_n75_), .O(z05));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n61_), .d(new_n45_), .O(new_n92_));
  ...
  nand4  g052(.a(new_n95_), .b(x19), .c(new_n86_), .d(x17), .O(new_n96_));
  nor2   g053(.a(new_n96_), .b(x21), .O(z08));
  inv1   g054(.a(x22), .O(new_n98_));
  inv1   g055(.a(x11), .O(new_n99_));
  nand2  g056(.a(x02), .b(new_n61_), .O(new_n100_));
  inv1   g057(.a(new_n100_), .O(new_n101_));
  nand3  g058(.a(new_n101_), .b(x12), .c(new_n99_), .O(new_n102_));
  ...
  nor2   g064(.a(new_n86_), .b(new_n61_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n44_), .c(new_n107_), .d(new_n63_), .O(new_n109_));
  oai21  g066(.a(new_n106_), .b(new_n102_), .c(new_n109_), .O(new_n110_));
  nand3  g067(.a(new_n110_), .b(new_n98_), .c(new_n45_), .O(new_n111_));
  nand2  g068(.a(new_n111_), .b(new_n75_), .O(z09));
  nand3  g069(.a(x22), .b(x21), .c(new_n107_), .O(new_n113_));
  nor3   g070(.a(new_n113_), .b(x19), .c(new_n86_), .O(new_n114_));
  nor2   g071(.a(x13), .b(new_n81_), .O(new_n115_));
  nand2  g072(.a(new_n115_), .b(new_n99_), .O(new_n116_));
  nor2   g073(.a(new_n116_), .b(new_n100_), .O(new_n117_));
  nand3  g074(.a(new_n98_), .b(x20), .c(x16), .O(new_n118_));
  nor3   g075(.a(new_n118_), .b(new_n103_), .c(x14), .O(new_n119_));
  aoi21  g076(.a(new_n119_), .b(new_n117_), .c(new_n114_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(x00), .c(new_n75_), .O(z10));
  inv1   g078(.a(new_n117_), .O(new_n122_));
  nand4  g079(.a(new_n108_), .b(x21), .c(new_n107_), .d(new_n63_), .O(new_n123_));
  nor2   g080(.a(new_n103_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n44_), .c(x20), .d(new_n104_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n122_), .c(new_n123_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n98_), .c(new_n45_), .O(new_n127_));
  inv1   g084(.a(new_n127_), .O(z11));
  aoi21  g085(.a(x10), .b(x02), .c(new_n61_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(x00), .O(new_n130_));
  oai21  g087(.a(x19), .b(x02), .c(x23), .O(new_n131_));
  nand3  g088(.a(new_n63_), .b(x17), .c(new_n46_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand4  g090(.a(new_n133_), .b(new_n44_), .c(new_n61_), .d(new_n45_), .O(new_n134_));
  aoi21  g091(.a(new_n134_), .b(new_n130_), .c(x24), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(x09), .O(new_n136_));
  inv1   g093(.a(new_n136_), .O(z12));
  nand4  g094(.a(new_n63_), .b(x17), .c(new_n46_), .d(new_n45_), .O(new_n138_));
  aoi21  g095(.a(new_n138_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g096(.a(new_n47_), .b(new_n46_), .c(new_n61_), .d(new_n45_), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x10), .O(new_n141_));
  nand4  g098(.a(new_n141_), .b(new_n63_), .c(new_n86_), .d(new_n48_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x21), .O(z14));
  aoi21  g100(.a(new_n44_), .b(new_n46_), .c(new_n129_), .O(new_n144_));
  nand4  g101(.a(new_n44_), .b(x19), .c(new_n46_), .d(new_n61_), .O(new_n145_));
  oai21  g102(.a(new_n144_), .b(new_n45_), .c(new_n145_), .O(z15));
