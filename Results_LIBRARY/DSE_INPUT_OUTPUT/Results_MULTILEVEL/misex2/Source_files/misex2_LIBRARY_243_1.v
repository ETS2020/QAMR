...
module FAU ( 
  ...
  nand3  g20(.a(new_n49_), .b(x02), .c(x01), .O(new_n64_));
  ...
  nand4  g47(.a(new_n67_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n91_));
  ...
  nand3  g57(.a(new_n90_), .b(new_n89_), .c(x12), .O(new_n101_));
  nor3   g58(.a(new_n101_), .b(x11), .c(new_n48_), .O(new_n102_));
  nor2   g59(.a(x16), .b(new_n97_), .O(new_n103_));
  ...
  oai22  g69(.a(new_n112_), .b(new_n49_), .c(new_n47_), .d(x00), .O(z12));
  ...
  aoi21  g73(.a(new_n57_), .b(x01), .c(new_n48_), .O(new_n117_));
  nand3  g74(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n118_));
  oai21  g75(.a(new_n117_), .b(new_n46_), .c(new_n118_), .O(z15));
  nand3  g76(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n121_));
