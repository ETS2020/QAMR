...
module FAU ( 
  ...
  inv1   g078(.a(new_n52_), .O(new_n96_));
  nand3  g079(.a(new_n19_), .b(x2), .c(new_n35_), .O(new_n97_));
  oai21  g080(.a(new_n19_), .b(new_n35_), .c(new_n97_), .O(new_n98_));
  nand2  g081(.a(new_n98_), .b(x0), .O(new_n99_));
  nand2  g082(.a(z8), .b(new_n44_), .O(new_n100_));
  nand2  g083(.a(new_n39_), .b(new_n23_), .O(new_n101_));
  nand3  g084(.a(new_n101_), .b(new_n87_), .c(new_n100_), .O(new_n102_));
  nand2  g085(.a(new_n102_), .b(x1), .O(new_n103_));
  nand3  g086(.a(new_n19_), .b(x3), .c(x2), .O(new_n104_));
  oai21  g087(.a(new_n19_), .b(x2), .c(new_n104_), .O(new_n105_));
  nand2  g088(.a(new_n105_), .b(new_n35_), .O(new_n106_));
  nand4  g089(.a(new_n106_), .b(new_n103_), .c(new_n99_), .d(new_n96_), .O(z4));
  nand2  g090(.a(x3), .b(new_n44_), .O(new_n108_));
  nand3  g091(.a(new_n19_), .b(z8), .c(x2), .O(new_n109_));
  ...
  nand3  g100(.a(new_n117_), .b(new_n116_), .c(new_n96_), .O(z6));
  nand2  g101(.a(new_n109_), .b(new_n108_), .O(z7));
  nand2  g102(.a(new_n20_), .b(x3), .O(new_n120_));
  nand2  g103(.a(new_n120_), .b(x6), .O(new_n121_));
  oai21  g104(.a(new_n82_), .b(new_n35_), .c(new_n23_), .O(new_n122_));
