...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n100_, new_n102_, new_n103_, new_n105_;
  ...
  nand2  g77(.a(x3), .b(new_n49_), .O(new_n95_));
  nand2  g78(.a(new_n47_), .b(x2), .O(new_n96_));
  ...
  oai21  g82(.a(new_n99_), .b(new_n66_), .c(x0), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(new_n98_), .c(new_n92_), .O(z5));
  nand2  g84(.a(new_n95_), .b(x1), .O(new_n102_));
  nand3  g85(.a(x3), .b(new_n49_), .c(new_n22_), .O(new_n103_));
  aoi21  g86(.a(new_n103_), .b(new_n102_), .c(new_n92_), .O(z6));
  inv1   g87(.a(new_n92_), .O(new_n105_));
  nand3  g88(.a(new_n96_), .b(new_n95_), .c(new_n105_), .O(z7));
  nand2  g89(.a(new_n105_), .b(x3), .O(z8));
  aoi21  g90(.a(x6), .b(new_n19_), .c(new_n18_), .O(z9));
endmodule
