...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n94_, new_n96_, new_n99_, new_n100_;
  ...
  aoi21  g74(.a(new_n91_), .b(new_n88_), .c(new_n39_), .O(z5));
  nand2  g75(.a(new_n85_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n31_), .c(new_n26_), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n93_), .c(new_n39_), .O(z6));
  inv1   g78(.a(new_n39_), .O(new_n96_));
  nand3  g79(.a(new_n86_), .b(new_n85_), .c(new_n96_), .O(z7));
  nand2  g80(.a(new_n96_), .b(x3), .O(z8));
