...
module FAU ( 
  ...
  nand4  g25(.a(new_n42_), .b(x3), .c(x2), .d(new_n34_), .O(new_n43_));
  ...
  nand3  g34(.a(new_n51_), .b(new_n26_), .c(new_n34_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x4), .O(new_n54_));
  nor2   g37(.a(x5), .b(x2), .O(new_n55_));
  oai21  g38(.a(new_n55_), .b(new_n45_), .c(new_n22_), .O(new_n56_));
  oai21  g39(.a(x5), .b(x0), .c(new_n56_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(x6), .c(new_n21_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n54_), .c(new_n47_), .O(z2));
  nand2  g42(.a(new_n23_), .b(new_n26_), .O(new_n60_));
  nand3  g43(.a(x6), .b(x3), .c(x2), .O(new_n61_));
  inv1   g44(.a(new_n61_), .O(new_n62_));
  aoi21  g45(.a(new_n60_), .b(x1), .c(new_n62_), .O(new_n63_));
  nand3  g46(.a(new_n23_), .b(x5), .c(new_n22_), .O(new_n64_));
  oai21  g47(.a(new_n63_), .b(x5), .c(new_n64_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n34_), .O(new_n66_));
  nand3  g49(.a(new_n18_), .b(new_n48_), .c(x0), .O(new_n67_));
  nand2  g50(.a(new_n26_), .b(x5), .O(new_n68_));
  aoi21  g51(.a(new_n68_), .b(new_n67_), .c(x1), .O(new_n69_));
  aoi21  g52(.a(new_n60_), .b(new_n31_), .c(new_n18_), .O(new_n70_));
  nor2   g53(.a(x6), .b(new_n34_), .O(new_n71_));
  nor3   g54(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n66_), .O(z3));
  inv1   g56(.a(new_n71_), .O(new_n74_));
  xor2a  g57(.a(x6), .b(x1), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(new_n48_), .O(new_n76_));
  inv1   g59(.a(x3), .O(new_n77_));
  nand3  g60(.a(x6), .b(new_n77_), .c(new_n34_), .O(new_n78_));
  nand3  g61(.a(new_n26_), .b(x3), .c(x2), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n22_), .O(new_n81_));
  oai21  g64(.a(x3), .b(x2), .c(x0), .O(new_n82_));
  nand2  g65(.a(new_n26_), .b(new_n77_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n82_), .c(new_n61_), .O(new_n84_));
  ...
  nand2  g74(.a(new_n23_), .b(x6), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n91_), .c(x0), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n90_), .O(z5));
  nand2  g77(.a(new_n87_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n48_), .c(new_n22_), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n95_), .c(new_n74_), .O(z6));
  aoi21  g80(.a(new_n88_), .b(new_n87_), .c(new_n71_), .O(z7));
  nor2   g81(.a(new_n71_), .b(x3), .O(z8));
  oai21  g82(.a(new_n28_), .b(new_n21_), .c(new_n74_), .O(z9));
endmodule
