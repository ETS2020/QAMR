...
module FAU ( 
  ...
  nand2  g51(.a(new_n21_), .b(new_n20_), .O(new_n69_));
  aoi21  g52(.a(new_n69_), .b(x6), .c(new_n42_), .O(new_n70_));
  aoi21  g53(.a(new_n68_), .b(new_n42_), .c(new_n70_), .O(new_n71_));
  nand3  g54(.a(new_n35_), .b(new_n46_), .c(new_n48_), .O(new_n72_));
  aoi21  g55(.a(new_n72_), .b(new_n42_), .c(new_n20_), .O(new_n73_));
  aoi21  g56(.a(new_n42_), .b(new_n48_), .c(new_n35_), .O(new_n74_));
  oai22  g57(.a(new_n74_), .b(x1), .c(new_n42_), .d(new_n48_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n73_), .c(x0), .O(new_n76_));
  oai21  g59(.a(new_n71_), .b(x0), .c(new_n76_), .O(z3));
  oai21  g60(.a(new_n30_), .b(x5), .c(x0), .O(new_n78_));
  ...
  nand2  g66(.a(x5), .b(new_n48_), .O(new_n84_));
  nand2  g67(.a(new_n35_), .b(x2), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n84_), .c(new_n19_), .O(new_n86_));
  aoi21  g69(.a(new_n46_), .b(new_n19_), .c(new_n48_), .O(new_n87_));
