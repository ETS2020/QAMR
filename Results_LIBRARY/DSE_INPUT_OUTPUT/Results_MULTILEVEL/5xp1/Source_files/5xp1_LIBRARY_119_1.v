...
module FAU ( 
  ...
  nand4  g42(.a(new_n21_), .b(new_n18_), .c(x3), .d(new_n20_), .O(new_n60_));
  ...
  nand2  g47(.a(new_n33_), .b(x1), .O(new_n65_));
  ...
  nand2  g54(.a(new_n49_), .b(new_n27_), .O(new_n72_));
  ...
  nor2   g67(.a(new_n21_), .b(x5), .O(new_n85_));
  ...
  oai21  g73(.a(new_n90_), .b(new_n39_), .c(x0), .O(new_n91_));
  ...
  nand3  g79(.a(new_n87_), .b(new_n86_), .c(new_n93_), .O(z7));
