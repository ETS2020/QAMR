...
module FAU ( 
  ...
  nor2   g80(.a(new_n30_), .b(new_n18_), .O(new_n98_));
  nand2  g81(.a(x3), .b(new_n46_), .O(new_n99_));
  nand2  g82(.a(new_n90_), .b(x2), .O(new_n100_));
  ...
  aoi21  g88(.a(new_n105_), .b(new_n102_), .c(new_n98_), .O(z5));
  inv1   g89(.a(new_n98_), .O(new_n107_));
  nand2  g90(.a(new_n99_), .b(x1), .O(new_n108_));
  nand3  g91(.a(x3), .b(new_n46_), .c(new_n20_), .O(new_n109_));
  nand3  g92(.a(new_n109_), .b(new_n108_), .c(new_n107_), .O(z6));
  nand3  g93(.a(new_n100_), .b(new_n99_), .c(new_n107_), .O(z7));
  nand2  g94(.a(new_n107_), .b(x3), .O(z8));
  nand2  g95(.a(new_n22_), .b(x5), .O(new_n113_));
  aoi21  g96(.a(new_n113_), .b(new_n30_), .c(new_n18_), .O(z9));
endmodule
