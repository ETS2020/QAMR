...
module FAU ( 
  ...
  aoi21  g78(.a(new_n95_), .b(new_n92_), .c(new_n27_), .O(z5));
  nand2  g79(.a(new_n89_), .b(x1), .O(new_n97_));
  nand3  g80(.a(x3), .b(new_n53_), .c(new_n39_), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(new_n97_), .c(new_n27_), .O(z6));
  nand3  g82(.a(new_n90_), .b(new_n89_), .c(new_n44_), .O(z7));
  nor2   g83(.a(new_n27_), .b(x3), .O(z8));
  nand3  g84(.a(new_n21_), .b(x5), .c(x4), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n44_), .O(z9));
endmodule
