...
module FAU ( 
  ...
  aoi21  g43(.a(new_n59_), .b(new_n51_), .c(new_n60_), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n55_), .c(new_n48_), .O(z2));
  ...
  aoi21  g81(.a(new_n98_), .b(new_n96_), .c(new_n60_), .O(z5));
  nand2  g82(.a(new_n93_), .b(x1), .O(new_n100_));
  nand3  g83(.a(x3), .b(new_n30_), .c(new_n23_), .O(new_n101_));
  aoi21  g84(.a(new_n101_), .b(new_n100_), .c(new_n60_), .O(z6));
  aoi21  g85(.a(new_n94_), .b(new_n93_), .c(new_n60_), .O(z7));
  nor2   g86(.a(new_n60_), .b(x3), .O(z8));
