...
module FAU ( 
  ...
  nand2  g73(.a(new_n19_), .b(x2), .O(new_n91_));
  nand2  g74(.a(x6), .b(x3), .O(z8));
  oai21  g75(.a(z8), .b(new_n83_), .c(new_n91_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n23_), .O(new_n94_));
  nor2   g77(.a(x3), .b(x2), .O(new_n95_));
  aoi21  g78(.a(new_n60_), .b(x1), .c(new_n40_), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(x3), .c(new_n95_), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(new_n23_), .c(new_n94_), .O(z5));
  oai21  g81(.a(new_n88_), .b(new_n40_), .c(x3), .O(new_n99_));
  oai21  g82(.a(z8), .b(x2), .c(x1), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n99_), .O(z6));
  oai21  g84(.a(z8), .b(x2), .c(new_n91_), .O(z7));
  oai21  g85(.a(x3), .b(new_n23_), .c(new_n40_), .O(new_n103_));
