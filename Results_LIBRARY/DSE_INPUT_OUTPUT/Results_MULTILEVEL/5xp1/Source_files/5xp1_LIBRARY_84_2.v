...
module FAU ( 
  ...
  inv1   g69(.a(new_n22_), .O(new_n87_));
  ...
  aoi21  g75(.a(new_n92_), .b(new_n91_), .c(new_n82_), .O(z6));
  aoi21  g76(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(z7));
  nor2   g77(.a(new_n82_), .b(x3), .O(z8));
  nand3  g78(.a(x6), .b(x5), .c(x4), .O(new_n96_));
