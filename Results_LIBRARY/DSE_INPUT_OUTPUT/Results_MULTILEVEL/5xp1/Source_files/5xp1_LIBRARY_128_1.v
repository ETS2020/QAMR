...
module FAU ( 
  ...
  nor2   g053(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  oai21  g054(.a(new_n71_), .b(new_n58_), .c(x4), .O(new_n72_));
  ...
  nand3  g059(.a(new_n76_), .b(new_n74_), .c(new_n64_), .O(z2));
  nand2  g060(.a(z8), .b(new_n45_), .O(new_n78_));
  nand3  g061(.a(new_n78_), .b(x5), .c(x0), .O(new_n79_));
  nand2  g062(.a(new_n30_), .b(new_n29_), .O(new_n80_));
  ...
  oai21  g066(.a(new_n70_), .b(new_n58_), .c(x2), .O(new_n84_));
  nand2  g067(.a(new_n84_), .b(x3), .O(new_n85_));
  nand2  g068(.a(new_n85_), .b(x6), .O(new_n86_));
  nand2  g069(.a(x5), .b(new_n19_), .O(new_n87_));
  nand2  g070(.a(new_n66_), .b(x0), .O(new_n88_));
  aoi21  g071(.a(new_n88_), .b(new_n87_), .c(x3), .O(new_n89_));
  nand2  g072(.a(x6), .b(x2), .O(new_n90_));
  nand2  g073(.a(new_n20_), .b(x0), .O(new_n91_));
  nand2  g074(.a(new_n91_), .b(new_n87_), .O(new_n92_));
  nand3  g075(.a(new_n92_), .b(new_n90_), .c(new_n37_), .O(new_n93_));
  nand4  g076(.a(new_n29_), .b(x5), .c(new_n45_), .d(new_n19_), .O(new_n94_));
  ...
  nand3  g080(.a(x6), .b(x3), .c(x1), .O(new_n98_));
  nand3  g081(.a(new_n29_), .b(x2), .c(new_n37_), .O(new_n99_));
  nand2  g082(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(x0), .O(new_n101_));
  nand2  g084(.a(new_n30_), .b(new_n19_), .O(new_n102_));
  aoi21  g085(.a(new_n102_), .b(new_n78_), .c(x6), .O(new_n103_));
  ...
  xor2a  g089(.a(x6), .b(x2), .O(new_n107_));
  nand3  g090(.a(new_n107_), .b(x3), .c(new_n37_), .O(new_n108_));
  nand3  g091(.a(new_n108_), .b(new_n106_), .c(new_n101_), .O(z4));
  nand2  g092(.a(x3), .b(new_n45_), .O(new_n110_));
  nor2   g093(.a(x6), .b(x3), .O(new_n111_));
  inv1   g094(.a(new_n111_), .O(new_n112_));
  oai22  g095(.a(new_n112_), .b(new_n45_), .c(new_n110_), .d(new_n37_), .O(new_n113_));
  nand2  g096(.a(new_n113_), .b(new_n19_), .O(new_n114_));
  aoi21  g097(.a(new_n45_), .b(x1), .c(z8), .O(new_n115_));
  nor2   g098(.a(new_n112_), .b(x2), .O(new_n116_));
  oai21  g099(.a(new_n116_), .b(new_n115_), .c(x0), .O(new_n117_));
  nand2  g100(.a(new_n117_), .b(new_n114_), .O(z5));
  oai21  g101(.a(new_n111_), .b(new_n31_), .c(x1), .O(new_n119_));
  oai21  g102(.a(new_n110_), .b(x1), .c(new_n119_), .O(z6));
  nand2  g103(.a(z8), .b(x2), .O(new_n121_));
  oai21  g104(.a(new_n111_), .b(x2), .c(new_n121_), .O(z7));
  aoi21  g105(.a(x5), .b(x4), .c(z8), .O(new_n123_));
