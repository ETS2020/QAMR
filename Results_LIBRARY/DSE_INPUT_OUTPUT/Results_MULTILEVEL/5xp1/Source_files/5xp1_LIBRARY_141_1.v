...
module FAU ( 
  ...
  aoi21  g61(.a(new_n44_), .b(new_n24_), .c(new_n19_), .O(new_n79_));
  nand2  g62(.a(new_n24_), .b(new_n18_), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(new_n34_), .c(x6), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n79_), .c(x1), .O(new_n82_));
  nor2   g65(.a(x3), .b(x0), .O(new_n83_));
  nor3   g66(.a(new_n83_), .b(x6), .c(new_n32_), .O(new_n84_));
  nor2   g67(.a(new_n83_), .b(new_n32_), .O(new_n85_));
  nor2   g68(.a(new_n85_), .b(new_n19_), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n84_), .c(new_n23_), .O(new_n87_));
  nor2   g70(.a(new_n19_), .b(x5), .O(new_n88_));
  inv1   g71(.a(new_n88_), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n87_), .c(new_n82_), .O(z4));
  nand2  g73(.a(x3), .b(new_n32_), .O(new_n91_));
  nand2  g74(.a(new_n33_), .b(x2), .O(new_n92_));
  oai21  g75(.a(new_n91_), .b(new_n23_), .c(new_n92_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n18_), .O(new_n94_));
  aoi21  g77(.a(x3), .b(x1), .c(x2), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n40_), .c(x0), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n94_), .c(new_n89_), .O(z5));
  nand2  g80(.a(new_n91_), .b(x1), .O(new_n98_));
  nand3  g81(.a(x3), .b(new_n32_), .c(new_n23_), .O(new_n99_));
  ...
  nand3  g85(.a(new_n20_), .b(new_n19_), .c(new_n18_), .O(new_n103_));
