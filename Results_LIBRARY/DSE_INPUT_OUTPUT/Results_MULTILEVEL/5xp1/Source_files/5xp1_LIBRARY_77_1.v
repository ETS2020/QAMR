...
module FAU ( 
  ...
  oai21  g82(.a(new_n99_), .b(new_n98_), .c(new_n21_), .O(new_n100_));
  aoi21  g83(.a(x3), .b(x1), .c(x2), .O(new_n101_));
  oai21  g84(.a(new_n101_), .b(new_n77_), .c(x0), .O(new_n102_));
  nand2  g85(.a(x6), .b(new_n18_), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n102_), .c(new_n100_), .O(z5));
  aoi21  g87(.a(new_n20_), .b(new_n29_), .c(x2), .O(new_n105_));
  nand4  g88(.a(new_n20_), .b(x3), .c(new_n18_), .d(new_n28_), .O(new_n106_));
  oai21  g89(.a(new_n105_), .b(new_n28_), .c(new_n106_), .O(z6));
  or2    g90(.a(new_n105_), .b(new_n99_), .O(z7));
  aoi21  g91(.a(x6), .b(new_n18_), .c(x3), .O(z8));
  aoi21  g92(.a(x5), .b(x4), .c(new_n18_), .O(new_n110_));
  nand2  g93(.a(new_n40_), .b(new_n21_), .O(new_n111_));
  nand3  g94(.a(new_n111_), .b(x5), .c(x4), .O(new_n112_));
  oai21  g95(.a(new_n110_), .b(new_n20_), .c(new_n112_), .O(z9));
endmodule
