...
module FAU ( 
  ...
  aoi21  g010(.a(new_n24_), .b(z8), .c(new_n27_), .O(new_n28_));
  ...
  nand2  g033(.a(new_n50_), .b(new_n32_), .O(new_n51_));
  oai21  g034(.a(x5), .b(x3), .c(x0), .O(new_n52_));
  aoi21  g035(.a(x5), .b(x3), .c(x0), .O(new_n53_));
  aoi21  g036(.a(new_n52_), .b(new_n40_), .c(new_n53_), .O(new_n54_));
  aoi21  g037(.a(new_n54_), .b(new_n51_), .c(new_n33_), .O(new_n55_));
  ...
  oai21  g043(.a(new_n60_), .b(new_n55_), .c(new_n22_), .O(new_n61_));
  aoi21  g044(.a(x5), .b(x1), .c(x0), .O(new_n62_));
  nor3   g045(.a(x5), .b(x2), .c(x1), .O(new_n63_));
  oai21  g046(.a(new_n63_), .b(new_n62_), .c(new_n33_), .O(new_n64_));
  ...
  nand3  g052(.a(new_n69_), .b(x6), .c(z8), .O(new_n70_));
  nand2  g053(.a(new_n70_), .b(new_n61_), .O(z2));
  oai21  g054(.a(x3), .b(x2), .c(x1), .O(new_n72_));
  nand3  g055(.a(new_n72_), .b(new_n18_), .c(x0), .O(new_n73_));
  nand3  g056(.a(new_n35_), .b(x5), .c(new_n21_), .O(new_n74_));
  nand2  g057(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g058(.a(new_n75_), .b(new_n22_), .O(new_n76_));
  nand2  g059(.a(new_n65_), .b(x0), .O(new_n77_));
  oai21  g060(.a(new_n18_), .b(x0), .c(new_n77_), .O(new_n78_));
  nand2  g061(.a(new_n78_), .b(new_n32_), .O(new_n79_));
  nand2  g062(.a(new_n35_), .b(new_n22_), .O(new_n80_));
  nand3  g063(.a(new_n80_), .b(new_n18_), .c(new_n21_), .O(new_n81_));
  nand3  g064(.a(new_n22_), .b(z8), .c(new_n40_), .O(new_n82_));
  ...
  nand2  g069(.a(new_n86_), .b(z8), .O(new_n87_));
  nand2  g070(.a(new_n87_), .b(x6), .O(new_n88_));
  nand4  g071(.a(new_n88_), .b(new_n85_), .c(new_n79_), .d(new_n76_), .O(z3));
  nor2   g072(.a(new_n22_), .b(x3), .O(new_n90_));
  nand2  g073(.a(new_n90_), .b(x1), .O(new_n91_));
  nand2  g074(.a(new_n22_), .b(new_n32_), .O(new_n92_));
  aoi21  g075(.a(new_n92_), .b(new_n91_), .c(new_n21_), .O(new_n93_));
  nor2   g076(.a(x6), .b(z8), .O(new_n94_));
  nand2  g077(.a(new_n94_), .b(new_n32_), .O(new_n95_));
  ...
  nand3  g082(.a(new_n99_), .b(new_n98_), .c(z8), .O(new_n100_));
  nand4  g083(.a(new_n22_), .b(new_n40_), .c(x1), .d(new_n21_), .O(new_n101_));
  ...
  oai21  g087(.a(x2), .b(new_n32_), .c(new_n22_), .O(new_n105_));
  nand3  g088(.a(new_n105_), .b(x3), .c(new_n21_), .O(new_n106_));
  nand2  g089(.a(new_n94_), .b(x1), .O(new_n107_));
  nand3  g090(.a(new_n107_), .b(new_n40_), .c(x0), .O(new_n108_));
  nand3  g091(.a(new_n108_), .b(new_n106_), .c(new_n104_), .O(z5));
  aoi21  g092(.a(new_n22_), .b(x2), .c(z8), .O(new_n110_));
  nand3  g093(.a(new_n94_), .b(new_n40_), .c(new_n32_), .O(new_n111_));
  oai21  g094(.a(new_n110_), .b(new_n32_), .c(new_n111_), .O(z6));
  nand2  g095(.a(x3), .b(new_n40_), .O(new_n113_));
  oai21  g096(.a(new_n94_), .b(new_n40_), .c(new_n113_), .O(z7));
  nand3  g097(.a(x3), .b(x2), .c(x1), .O(new_n115_));
  aoi21  g098(.a(new_n115_), .b(new_n21_), .c(x6), .O(new_n116_));
  oai21  g099(.a(new_n116_), .b(new_n90_), .c(x5), .O(new_n117_));
