...
module FAU ( 
  ...
  nand3  g56(.a(new_n73_), .b(x6), .c(new_n32_), .O(new_n74_));
  ...
  nand3  g64(.a(new_n81_), .b(x6), .c(new_n32_), .O(new_n82_));
  ...
  oai21  g70(.a(new_n86_), .b(new_n28_), .c(new_n87_), .O(new_n88_));
  ...
  aoi21  g84(.a(new_n101_), .b(new_n20_), .c(new_n32_), .O(z9));
endmodule
