...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n106_, new_n107_, new_n108_, new_n110_, new_n112_, new_n115_,
  ...
  oai21  g036(.a(new_n18_), .b(new_n21_), .c(new_n32_), .O(new_n54_));
  oai21  g037(.a(x5), .b(x3), .c(x0), .O(new_n55_));
  aoi21  g038(.a(x5), .b(x3), .c(x0), .O(new_n56_));
  aoi21  g039(.a(new_n55_), .b(new_n19_), .c(new_n56_), .O(new_n57_));
  aoi21  g040(.a(new_n57_), .b(new_n54_), .c(x6), .O(new_n58_));
  oai21  g041(.a(new_n58_), .b(new_n53_), .c(x4), .O(new_n59_));
  nor2   g042(.a(x5), .b(x1), .O(new_n60_));
  aoi21  g043(.a(x5), .b(x1), .c(x0), .O(new_n61_));
  oai21  g044(.a(new_n61_), .b(new_n60_), .c(x6), .O(new_n62_));
  nand2  g045(.a(new_n22_), .b(x3), .O(new_n63_));
  ...
  nand3  g050(.a(new_n22_), .b(x5), .c(x0), .O(new_n68_));
  nand3  g051(.a(new_n68_), .b(new_n67_), .c(new_n62_), .O(new_n69_));
  nand2  g052(.a(new_n69_), .b(new_n33_), .O(new_n70_));
  nor2   g053(.a(new_n22_), .b(new_n19_), .O(new_n71_));
  inv1   g054(.a(new_n71_), .O(new_n72_));
  nand3  g055(.a(new_n72_), .b(new_n70_), .c(new_n59_), .O(z2));
  nand2  g056(.a(x5), .b(new_n21_), .O(new_n74_));
  nand2  g057(.a(new_n18_), .b(x0), .O(new_n75_));
  nand2  g058(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g059(.a(new_n76_), .b(new_n32_), .O(new_n77_));
  nand3  g060(.a(new_n18_), .b(new_n44_), .c(x0), .O(new_n78_));
  nand2  g061(.a(new_n78_), .b(new_n74_), .O(new_n79_));
  nand3  g062(.a(new_n79_), .b(new_n22_), .c(new_n19_), .O(new_n80_));
  nand2  g063(.a(new_n35_), .b(new_n22_), .O(new_n81_));
  nand3  g064(.a(new_n81_), .b(new_n18_), .c(new_n21_), .O(new_n82_));
  nand3  g065(.a(new_n22_), .b(new_n44_), .c(new_n19_), .O(new_n83_));
  ...
  nand3  g069(.a(x5), .b(new_n44_), .c(new_n21_), .O(new_n87_));
  nand2  g070(.a(new_n87_), .b(new_n22_), .O(new_n88_));
  nand2  g071(.a(new_n88_), .b(x2), .O(new_n89_));
  nand4  g072(.a(new_n89_), .b(new_n86_), .c(new_n80_), .d(new_n77_), .O(z3));
  ...
  nand2  g078(.a(new_n44_), .b(new_n19_), .O(new_n96_));
  aoi21  g079(.a(new_n96_), .b(new_n95_), .c(new_n32_), .O(new_n97_));
  ...
  nand3  g083(.a(new_n100_), .b(new_n99_), .c(new_n94_), .O(z4));
  ...
  aoi21  g092(.a(new_n103_), .b(new_n32_), .c(new_n71_), .O(new_n110_));
  oai21  g093(.a(new_n103_), .b(new_n32_), .c(new_n110_), .O(z6));
  nand2  g094(.a(new_n63_), .b(x2), .O(new_n112_));
  nand2  g095(.a(new_n112_), .b(new_n102_), .O(z7));
  nor2   g096(.a(new_n71_), .b(x3), .O(z8));
