...
module FAU ( 
  ...
  aoi21  g63(.a(new_n35_), .b(new_n25_), .c(new_n18_), .O(new_n81_));
  nor2   g64(.a(x3), .b(new_n33_), .O(new_n82_));
  nor3   g65(.a(new_n82_), .b(x6), .c(x1), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n81_), .c(x0), .O(new_n84_));
  nor2   g67(.a(new_n34_), .b(x2), .O(new_n85_));
  nor2   g68(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  nand3  g69(.a(new_n20_), .b(new_n34_), .c(x2), .O(new_n87_));
  oai21  g70(.a(new_n86_), .b(new_n18_), .c(new_n87_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n21_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n84_), .O(z5));
  oai21  g73(.a(new_n85_), .b(x6), .c(new_n18_), .O(new_n91_));
  oai21  g74(.a(new_n85_), .b(new_n18_), .c(new_n91_), .O(z6));
  oai21  g75(.a(new_n20_), .b(x1), .c(new_n86_), .O(z7));
  oai21  g76(.a(new_n20_), .b(x1), .c(x3), .O(z8));
  aoi21  g77(.a(x5), .b(x4), .c(new_n18_), .O(new_n95_));
  nand2  g78(.a(new_n39_), .b(new_n21_), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(x5), .c(x4), .O(new_n97_));
  oai21  g80(.a(new_n95_), .b(new_n20_), .c(new_n97_), .O(z9));
endmodule
