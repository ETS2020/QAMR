...
module FAU ( 
  ...
  nand2  g66(.a(new_n43_), .b(x5), .O(new_n84_));
  ...
  nand3  g74(.a(new_n91_), .b(new_n89_), .c(new_n84_), .O(z5));
  nand2  g75(.a(new_n86_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n28_), .c(new_n20_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n93_), .c(new_n84_), .O(z6));
  nand3  g78(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(z7));
  nand2  g79(.a(new_n84_), .b(x3), .O(z8));
