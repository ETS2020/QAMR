...
module FAU ( 
  ...
  nor2   g52(.a(new_n29_), .b(x0), .O(new_n70_));
  nand4  g53(.a(new_n29_), .b(new_n33_), .c(x1), .d(x0), .O(new_n71_));
  inv1   g54(.a(new_n71_), .O(new_n72_));
  oai21  g55(.a(new_n72_), .b(new_n70_), .c(new_n34_), .O(new_n73_));
  nand3  g56(.a(new_n29_), .b(new_n40_), .c(x0), .O(new_n74_));
  inv1   g57(.a(new_n74_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n70_), .c(new_n33_), .O(new_n76_));
  xor2a  g59(.a(x5), .b(x0), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n23_), .c(new_n40_), .O(new_n78_));
  nand3  g61(.a(new_n29_), .b(x3), .c(new_n19_), .O(new_n79_));
  aoi22  g62(.a(new_n79_), .b(new_n50_), .c(new_n23_), .d(new_n40_), .O(new_n80_));
  nand3  g63(.a(x5), .b(x3), .c(x0), .O(new_n81_));
  aoi21  g64(.a(new_n81_), .b(new_n23_), .c(new_n40_), .O(new_n82_));
  aoi21  g65(.a(new_n80_), .b(x2), .c(new_n82_), .O(new_n83_));
  nand4  g66(.a(new_n83_), .b(new_n78_), .c(new_n76_), .d(new_n73_), .O(z3));
  nor2   g67(.a(x3), .b(x0), .O(new_n85_));
  inv1   g68(.a(new_n85_), .O(new_n86_));
  nand4  g69(.a(new_n86_), .b(new_n23_), .c(x2), .d(new_n40_), .O(new_n87_));
  nand3  g70(.a(new_n35_), .b(new_n21_), .c(new_n23_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(x1), .O(new_n89_));
  oai21  g72(.a(new_n85_), .b(new_n33_), .c(x6), .O(new_n90_));
  ...
  nand3  g86(.a(new_n101_), .b(new_n97_), .c(new_n92_), .O(z7));
  nand2  g87(.a(new_n92_), .b(x3), .O(z8));
