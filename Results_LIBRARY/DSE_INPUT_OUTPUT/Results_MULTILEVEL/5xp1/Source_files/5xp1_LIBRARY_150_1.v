...
module FAU ( 
  ...
  nand2  g55(.a(new_n49_), .b(new_n61_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(x6), .c(x4), .O(new_n74_));
  nor2   g57(.a(x3), .b(x2), .O(new_n75_));
  aoi21  g58(.a(new_n61_), .b(new_n20_), .c(new_n75_), .O(new_n76_));
  oai21  g59(.a(new_n76_), .b(x6), .c(new_n74_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(x1), .O(new_n78_));
  nand2  g61(.a(new_n67_), .b(new_n20_), .O(new_n79_));
  ...
  nand2  g68(.a(x3), .b(new_n43_), .O(new_n86_));
  nand2  g69(.a(new_n67_), .b(x2), .O(new_n87_));
  oai21  g70(.a(new_n86_), .b(new_n40_), .c(new_n87_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n20_), .O(new_n89_));
  inv1   g72(.a(new_n61_), .O(new_n90_));
  ...
  nand3  g77(.a(x3), .b(new_n43_), .c(new_n40_), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n94_), .c(new_n26_), .O(z6));
  nand3  g79(.a(new_n87_), .b(new_n86_), .c(new_n27_), .O(z7));
  nor2   g80(.a(new_n26_), .b(x3), .O(z8));
  aoi21  g81(.a(new_n22_), .b(new_n20_), .c(new_n29_), .O(new_n99_));
