...
module FAU ( 
  ...
  aoi21  g68(.a(new_n85_), .b(new_n30_), .c(new_n24_), .O(new_n86_));
  ...
  nand3  g75(.a(new_n92_), .b(new_n90_), .c(new_n44_), .O(z4));
  ...
  nand2  g80(.a(new_n87_), .b(x6), .O(new_n98_));
  ...
  nor2   g85(.a(new_n39_), .b(new_n30_), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(new_n102_), .c(x1), .O(new_n104_));
  oai21  g87(.a(new_n94_), .b(x1), .c(new_n104_), .O(z6));
  nand2  g88(.a(new_n85_), .b(x2), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n94_), .O(z7));
  nand2  g90(.a(new_n44_), .b(x3), .O(z8));
  oai21  g91(.a(x6), .b(x0), .c(x5), .O(new_n109_));
  oai21  g92(.a(new_n109_), .b(new_n18_), .c(new_n44_), .O(z9));
endmodule
