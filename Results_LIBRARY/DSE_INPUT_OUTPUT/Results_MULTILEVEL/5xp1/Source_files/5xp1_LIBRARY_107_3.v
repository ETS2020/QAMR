...
module FAU ( 
  ...
  nand2  g58(.a(new_n70_), .b(new_n20_), .O(new_n76_));
  nand2  g59(.a(new_n23_), .b(new_n40_), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n76_), .c(x0), .O(new_n78_));
  nand4  g61(.a(new_n23_), .b(x3), .c(x1), .d(x0), .O(new_n79_));
  inv1   g62(.a(new_n79_), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n78_), .c(x5), .O(new_n81_));
  oai21  g64(.a(new_n23_), .b(new_n33_), .c(new_n40_), .O(new_n82_));
  nand3  g65(.a(new_n23_), .b(new_n34_), .c(new_n33_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(new_n29_), .c(x0), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n81_), .c(new_n75_), .O(z3));
  ...
  nand3  g86(.a(new_n23_), .b(x3), .c(new_n33_), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(x1), .O(new_n105_));
  oai21  g88(.a(new_n94_), .b(x1), .c(new_n105_), .O(z6));
  inv1   g89(.a(new_n70_), .O(new_n107_));
  aoi21  g90(.a(new_n95_), .b(new_n94_), .c(new_n107_), .O(z7));
  nor2   g91(.a(new_n107_), .b(x3), .O(z8));
  nor2   g92(.a(new_n23_), .b(x1), .O(new_n110_));
  aoi21  g93(.a(new_n37_), .b(new_n19_), .c(x6), .O(new_n111_));
  oai21  g94(.a(new_n111_), .b(new_n110_), .c(x5), .O(new_n112_));
  nor2   g95(.a(new_n112_), .b(new_n18_), .O(z9));
endmodule
