...
module FAU ( 
  ...
  aoi21  g53(.a(new_n41_), .b(new_n57_), .c(new_n20_), .O(new_n71_));
  nand2  g54(.a(new_n37_), .b(new_n34_), .O(new_n72_));
  nand2  g55(.a(new_n57_), .b(new_n19_), .O(new_n73_));
  aoi21  g56(.a(new_n73_), .b(new_n72_), .c(x6), .O(new_n74_));
  oai21  g57(.a(new_n74_), .b(new_n71_), .c(x1), .O(new_n75_));
  nor2   g58(.a(x3), .b(x0), .O(new_n76_));
  nor3   g59(.a(new_n76_), .b(x6), .c(new_n34_), .O(new_n77_));
  nand2  g60(.a(new_n37_), .b(new_n19_), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(x2), .c(new_n20_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n77_), .c(new_n31_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n75_), .c(new_n69_), .O(z4));
  nand2  g64(.a(x3), .b(new_n34_), .O(new_n82_));
  nand2  g65(.a(new_n37_), .b(x2), .O(new_n83_));
  oai21  g66(.a(new_n82_), .b(new_n31_), .c(new_n83_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n19_), .O(new_n85_));
  inv1   g68(.a(new_n57_), .O(new_n86_));
  aoi21  g69(.a(x3), .b(x1), .c(x2), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n86_), .c(x0), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n85_), .c(new_n68_), .O(z5));
  nand2  g72(.a(new_n82_), .b(x1), .O(new_n90_));
  nand3  g73(.a(x3), .b(new_n34_), .c(new_n31_), .O(new_n91_));
  aoi21  g74(.a(new_n91_), .b(new_n90_), .c(new_n68_), .O(z6));
  nand3  g75(.a(new_n83_), .b(new_n82_), .c(new_n69_), .O(z7));
  nand2  g76(.a(new_n69_), .b(x3), .O(z8));
