...
module FAU ( 
  ...
  aoi21  g45(.a(new_n62_), .b(new_n61_), .c(new_n22_), .O(new_n63_));
  nor2   g46(.a(x5), .b(x2), .O(new_n64_));
  aoi21  g47(.a(x3), .b(x2), .c(x0), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n64_), .c(new_n23_), .O(new_n66_));
  ...
  nand2  g52(.a(new_n24_), .b(new_n19_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(x1), .O(new_n71_));
  nand3  g54(.a(x6), .b(x3), .c(x2), .O(new_n72_));
  aoi21  g55(.a(new_n72_), .b(new_n71_), .c(x5), .O(new_n73_));
  aoi21  g56(.a(x6), .b(x2), .c(x1), .O(new_n74_));
  nor2   g57(.a(x6), .b(x2), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n74_), .c(x3), .O(new_n76_));
  inv1   g59(.a(x3), .O(z8));
  nand3  g60(.a(x6), .b(z8), .c(new_n23_), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n76_), .c(new_n29_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n73_), .c(new_n18_), .O(new_n80_));
  oai21  g63(.a(new_n30_), .b(new_n23_), .c(new_n35_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(x5), .O(new_n82_));
  nand2  g65(.a(x6), .b(new_n40_), .O(new_n83_));
  oai21  g66(.a(x6), .b(z8), .c(new_n83_), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(new_n29_), .c(new_n23_), .O(new_n85_));
  ...
  aoi21  g72(.a(new_n89_), .b(new_n24_), .c(new_n23_), .O(new_n90_));
  nand2  g73(.a(z8), .b(new_n18_), .O(new_n91_));
  aoi21  g74(.a(new_n91_), .b(x2), .c(x1), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n90_), .c(x6), .O(new_n93_));
  nand3  g76(.a(new_n40_), .b(x1), .c(new_n18_), .O(new_n94_));
  oai21  g77(.a(new_n40_), .b(x1), .c(new_n94_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n19_), .c(x3), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n93_), .O(z4));
  nand2  g80(.a(x3), .b(new_n40_), .O(new_n98_));
  ...
  aoi21  g85(.a(new_n40_), .b(x1), .c(z8), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(new_n102_), .c(x0), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n101_), .c(new_n33_), .O(z5));
  nand2  g88(.a(new_n98_), .b(x1), .O(new_n106_));
  nand3  g89(.a(x3), .b(new_n40_), .c(new_n23_), .O(new_n107_));
  nand3  g90(.a(new_n107_), .b(new_n106_), .c(new_n33_), .O(z6));
  nand3  g91(.a(x6), .b(z8), .c(x2), .O(new_n109_));
  nand2  g92(.a(new_n109_), .b(new_n98_), .O(z7));
  nand3  g93(.a(new_n20_), .b(new_n19_), .c(new_n18_), .O(new_n111_));
  nand3  g94(.a(new_n111_), .b(x5), .c(x4), .O(new_n112_));
  nand2  g95(.a(new_n112_), .b(new_n33_), .O(z9));
endmodule
