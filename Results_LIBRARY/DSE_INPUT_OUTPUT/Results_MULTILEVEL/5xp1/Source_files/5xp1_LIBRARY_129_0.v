...
module FAU ( 
  ...
  nand2  g13(.a(new_n25_), .b(new_n18_), .O(new_n31_));
  nand3  g14(.a(new_n31_), .b(new_n30_), .c(new_n28_), .O(z0));
  nand2  g15(.a(x3), .b(x2), .O(new_n33_));
  nand3  g16(.a(x6), .b(new_n22_), .c(new_n18_), .O(new_n34_));
  nand3  g17(.a(new_n25_), .b(x4), .c(x1), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(new_n33_), .c(new_n19_), .O(new_n37_));
  nand3  g20(.a(new_n25_), .b(new_n22_), .c(x1), .O(new_n38_));
  ...
  aoi21  g27(.a(new_n44_), .b(new_n25_), .c(new_n18_), .O(new_n45_));
  ...
  and2   g37(.a(new_n54_), .b(x6), .O(new_n55_));
  ...
  aoi21  g42(.a(new_n59_), .b(new_n57_), .c(x6), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n55_), .c(x4), .O(new_n61_));
  nand2  g44(.a(new_n59_), .b(x2), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n56_), .c(x6), .O(new_n63_));
  nor2   g46(.a(x5), .b(x2), .O(new_n64_));
  oai21  g47(.a(new_n64_), .b(new_n26_), .c(new_n18_), .O(new_n65_));
  nand3  g48(.a(x6), .b(new_n29_), .c(new_n19_), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  oai21  g50(.a(new_n67_), .b(new_n63_), .c(new_n22_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n61_), .c(new_n31_), .O(z2));
  xor2a  g52(.a(x6), .b(x1), .O(new_n70_));
  nand3  g53(.a(new_n70_), .b(new_n33_), .c(new_n19_), .O(new_n71_));
  inv1   g54(.a(new_n71_), .O(new_n72_));
  nand2  g55(.a(new_n31_), .b(x2), .O(new_n73_));
  ...
  nand2  g59(.a(x6), .b(new_n18_), .O(new_n77_));
  inv1   g60(.a(x3), .O(new_n78_));
  nand3  g61(.a(new_n25_), .b(new_n78_), .c(x1), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n77_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n41_), .c(x0), .O(new_n81_));
  nand3  g64(.a(x6), .b(x3), .c(x2), .O(new_n82_));
  oai21  g65(.a(new_n20_), .b(new_n18_), .c(new_n82_), .O(new_n83_));
  ...
  nand2  g69(.a(new_n86_), .b(new_n76_), .O(z3));
  nand2  g70(.a(new_n78_), .b(new_n41_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(x0), .O(new_n89_));
  aoi21  g72(.a(new_n89_), .b(new_n33_), .c(new_n25_), .O(new_n90_));
  nand2  g73(.a(new_n33_), .b(new_n19_), .O(new_n91_));
  aoi21  g74(.a(new_n88_), .b(new_n91_), .c(x6), .O(new_n92_));
  ...
  aoi21  g79(.a(new_n88_), .b(new_n33_), .c(new_n18_), .O(new_n97_));
  nor2   g80(.a(x3), .b(new_n41_), .O(new_n98_));
  nor3   g81(.a(new_n98_), .b(new_n25_), .c(x1), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(new_n97_), .c(x0), .O(new_n100_));
  nor2   g83(.a(new_n78_), .b(x2), .O(new_n101_));
  nor2   g84(.a(new_n101_), .b(new_n98_), .O(new_n102_));
  nand3  g85(.a(x6), .b(new_n78_), .c(x2), .O(new_n103_));
  ...
  oai21  g89(.a(new_n101_), .b(new_n25_), .c(new_n18_), .O(new_n107_));
  oai21  g90(.a(new_n101_), .b(new_n18_), .c(new_n107_), .O(z6));
  nand2  g91(.a(new_n102_), .b(new_n31_), .O(z7));
