...
module FAU ( 
  ...
  nand4  g46(.a(x6), .b(new_n29_), .c(x2), .d(new_n18_), .O(new_n64_));
  ...
  oai21  g57(.a(new_n23_), .b(x0), .c(new_n74_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(x6), .c(new_n29_), .O(new_n76_));
  ...
  nor3   g69(.a(new_n86_), .b(x6), .c(new_n78_), .O(new_n87_));
  nor2   g70(.a(new_n86_), .b(new_n78_), .O(new_n88_));
  nor2   g71(.a(new_n88_), .b(new_n19_), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n87_), .c(new_n23_), .O(new_n90_));
  nand2  g73(.a(new_n19_), .b(new_n29_), .O(new_n91_));
  ...
  nand3  g83(.a(x3), .b(new_n78_), .c(new_n23_), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n100_), .c(new_n91_), .O(z6));
  nand3  g85(.a(new_n94_), .b(new_n93_), .c(new_n91_), .O(z7));
  nand2  g86(.a(new_n91_), .b(x3), .O(z8));
  nand3  g87(.a(new_n49_), .b(x5), .c(x4), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(new_n91_), .O(z9));
endmodule
