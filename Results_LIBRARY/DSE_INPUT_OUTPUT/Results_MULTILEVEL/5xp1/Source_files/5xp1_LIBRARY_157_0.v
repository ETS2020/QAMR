...
module FAU ( 
  ...
  nand4  g20(.a(new_n20_), .b(new_n19_), .c(x5), .d(new_n18_), .O(new_n38_));
  inv1   g21(.a(new_n38_), .O(new_n39_));
  aoi21  g22(.a(new_n37_), .b(new_n29_), .c(new_n39_), .O(new_n40_));
  nand3  g23(.a(new_n26_), .b(x5), .c(new_n32_), .O(new_n41_));
  oai21  g24(.a(new_n40_), .b(new_n32_), .c(new_n41_), .O(z1));
  nor2   g25(.a(new_n19_), .b(new_n32_), .O(new_n43_));
  nor2   g26(.a(x6), .b(x4), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n43_), .c(x0), .O(new_n45_));
  nand4  g28(.a(new_n24_), .b(new_n32_), .c(new_n23_), .d(new_n18_), .O(new_n46_));
  inv1   g29(.a(new_n46_), .O(new_n47_));
  aoi21  g30(.a(new_n24_), .b(new_n23_), .c(new_n32_), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(new_n47_), .c(x6), .O(new_n49_));
  nand4  g32(.a(new_n44_), .b(x3), .c(x2), .d(x1), .O(new_n50_));
  ...
  aoi21  g41(.a(new_n57_), .b(new_n33_), .c(new_n58_), .O(new_n59_));
  aoi21  g42(.a(new_n59_), .b(new_n56_), .c(x6), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n54_), .c(x4), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n52_), .O(z2));
  nand2  g45(.a(new_n19_), .b(new_n23_), .O(new_n63_));
  nand3  g46(.a(new_n29_), .b(x3), .c(new_n18_), .O(new_n64_));
  ...
  nand3  g50(.a(x6), .b(new_n29_), .c(new_n18_), .O(new_n68_));
  oai21  g51(.a(new_n67_), .b(new_n18_), .c(new_n68_), .O(new_n69_));
  nand2  g52(.a(new_n69_), .b(x1), .O(new_n70_));
  nor2   g53(.a(new_n19_), .b(new_n33_), .O(new_n71_));
  xnor2a g54(.a(x5), .b(x0), .O(new_n72_));
  nand3  g55(.a(x5), .b(new_n34_), .c(new_n18_), .O(new_n73_));
  oai21  g56(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n23_), .O(new_n75_));
  nand3  g58(.a(new_n24_), .b(x5), .c(new_n18_), .O(new_n76_));
  nand4  g59(.a(new_n29_), .b(new_n34_), .c(new_n33_), .d(x0), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nor2   g61(.a(x5), .b(x4), .O(new_n79_));
  aoi21  g62(.a(new_n78_), .b(new_n19_), .c(new_n79_), .O(new_n80_));
  nand4  g63(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n66_), .O(z3));
  nand2  g64(.a(new_n35_), .b(x0), .O(new_n82_));
  aoi21  g65(.a(new_n82_), .b(new_n24_), .c(new_n19_), .O(new_n83_));
  nand2  g66(.a(new_n24_), .b(new_n18_), .O(new_n84_));
  aoi21  g67(.a(new_n84_), .b(new_n35_), .c(x6), .O(new_n85_));
  ...
  aoi21  g74(.a(new_n91_), .b(new_n86_), .c(new_n79_), .O(z4));
  ...
  inv1   g79(.a(new_n24_), .O(new_n97_));
  aoi21  g80(.a(x3), .b(x1), .c(x2), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n97_), .c(x0), .O(new_n99_));
  aoi21  g82(.a(new_n99_), .b(new_n96_), .c(new_n79_), .O(z5));
  nand2  g83(.a(new_n93_), .b(x1), .O(new_n101_));
  nand3  g84(.a(x3), .b(new_n33_), .c(new_n23_), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(new_n101_), .c(new_n79_), .O(z6));
  inv1   g86(.a(new_n79_), .O(new_n104_));
  nand3  g87(.a(new_n94_), .b(new_n93_), .c(new_n104_), .O(z7));
  nand2  g88(.a(new_n104_), .b(x3), .O(z8));
  nand2  g89(.a(new_n21_), .b(new_n18_), .O(new_n107_));
