...
module FAU ( 
  ...
  nand2  g089(.a(x3), .b(new_n44_), .O(new_n107_));
  inv1   g090(.a(new_n107_), .O(new_n108_));
  nand2  g091(.a(new_n19_), .b(z8), .O(new_n109_));
  inv1   g092(.a(new_n109_), .O(new_n110_));
  aoi22  g093(.a(new_n110_), .b(x2), .c(new_n108_), .d(x1), .O(new_n111_));
  aoi21  g094(.a(new_n44_), .b(x1), .c(z8), .O(new_n112_));
  nor2   g095(.a(new_n109_), .b(x2), .O(new_n113_));
  oai21  g096(.a(new_n113_), .b(new_n112_), .c(x0), .O(new_n114_));
  oai21  g097(.a(new_n111_), .b(x0), .c(new_n114_), .O(z5));
  aoi21  g098(.a(new_n108_), .b(new_n35_), .c(new_n52_), .O(new_n116_));
  oai21  g099(.a(new_n108_), .b(new_n35_), .c(new_n116_), .O(z6));
  nand2  g100(.a(z8), .b(x2), .O(new_n118_));
  oai21  g101(.a(new_n110_), .b(x2), .c(new_n118_), .O(z7));
  oai22  g102(.a(new_n24_), .b(z8), .c(x6), .d(new_n23_), .O(new_n120_));
