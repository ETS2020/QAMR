...
module FAU ( 
  ...
  nand3  g52(.a(new_n34_), .b(x5), .c(new_n19_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(new_n20_), .O(new_n72_));
  nand3  g55(.a(new_n25_), .b(new_n39_), .c(x0), .O(new_n73_));
  oai21  g56(.a(new_n25_), .b(x0), .c(new_n73_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n31_), .O(new_n75_));
  nand2  g58(.a(new_n34_), .b(new_n20_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n25_), .c(new_n19_), .O(new_n77_));
  nand3  g60(.a(new_n20_), .b(new_n26_), .c(new_n39_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(x5), .c(x0), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n77_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x1), .O(new_n81_));
  nand3  g64(.a(x5), .b(x2), .c(x0), .O(new_n82_));
  ...
  nor2   g68(.a(new_n20_), .b(x3), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(x1), .O(new_n87_));
  nand2  g70(.a(new_n20_), .b(new_n31_), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n87_), .c(new_n19_), .O(new_n89_));
  nor2   g72(.a(x6), .b(new_n26_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n31_), .O(new_n91_));
  inv1   g74(.a(new_n91_), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n89_), .c(x2), .O(new_n93_));
  xor2a  g76(.a(x6), .b(x1), .O(new_n94_));
  nand2  g77(.a(x2), .b(x0), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n94_), .c(new_n26_), .O(new_n96_));
  nand4  g79(.a(new_n20_), .b(new_n39_), .c(x1), .d(new_n19_), .O(new_n97_));
  nand3  g80(.a(new_n97_), .b(new_n96_), .c(new_n93_), .O(z4));
  xnor2a g81(.a(x3), .b(x0), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(x2), .O(new_n100_));
  oai21  g83(.a(x2), .b(new_n31_), .c(new_n20_), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(x3), .c(new_n19_), .O(new_n102_));
  nand2  g85(.a(new_n90_), .b(x1), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n39_), .c(x0), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n102_), .c(new_n100_), .O(z5));
  aoi21  g88(.a(new_n20_), .b(x2), .c(new_n26_), .O(new_n106_));
  nand3  g89(.a(new_n90_), .b(new_n39_), .c(new_n31_), .O(new_n107_));
  oai21  g90(.a(new_n106_), .b(new_n31_), .c(new_n107_), .O(z6));
  nand2  g91(.a(x3), .b(new_n39_), .O(new_n109_));
  oai21  g92(.a(new_n90_), .b(new_n39_), .c(new_n109_), .O(z7));
  inv1   g93(.a(new_n90_), .O(z8));
  aoi21  g94(.a(new_n21_), .b(new_n19_), .c(x6), .O(new_n112_));
  oai21  g95(.a(new_n112_), .b(new_n86_), .c(x5), .O(new_n113_));
