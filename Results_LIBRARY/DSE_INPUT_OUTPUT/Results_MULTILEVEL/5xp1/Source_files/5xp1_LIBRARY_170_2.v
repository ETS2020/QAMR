...
module FAU ( 
  ...
  nand3  g51(.a(new_n23_), .b(x5), .c(new_n22_), .O(new_n69_));
  inv1   g52(.a(new_n69_), .O(new_n70_));
  aoi21  g53(.a(new_n68_), .b(new_n18_), .c(new_n70_), .O(new_n71_));
  oai21  g54(.a(x5), .b(x2), .c(x6), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n22_), .O(new_n73_));
  oai21  g56(.a(x2), .b(x1), .c(x5), .O(new_n74_));
  nand3  g57(.a(new_n20_), .b(new_n47_), .c(new_n31_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n74_), .c(new_n73_), .O(new_n76_));
  nor2   g59(.a(x6), .b(new_n18_), .O(new_n77_));
  aoi21  g60(.a(new_n76_), .b(x0), .c(new_n77_), .O(new_n78_));
  oai21  g61(.a(new_n71_), .b(x0), .c(new_n78_), .O(z3));
  nand2  g62(.a(new_n47_), .b(new_n31_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x0), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n23_), .O(new_n82_));
  nand2  g65(.a(new_n23_), .b(new_n21_), .O(new_n83_));
  aoi21  g66(.a(new_n83_), .b(new_n80_), .c(x6), .O(new_n84_));
  aoi22  g67(.a(new_n84_), .b(new_n18_), .c(new_n82_), .d(x6), .O(new_n85_));
  nor2   g68(.a(x3), .b(x0), .O(new_n86_));
  nor2   g69(.a(new_n86_), .b(x6), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n18_), .c(x2), .O(new_n88_));
  oai21  g71(.a(new_n86_), .b(new_n31_), .c(x6), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n22_), .O(new_n91_));
  oai21  g74(.a(new_n85_), .b(new_n22_), .c(new_n91_), .O(z4));
  inv1   g75(.a(new_n77_), .O(new_n93_));
  nand2  g76(.a(x3), .b(new_n31_), .O(new_n94_));
  nand2  g77(.a(new_n47_), .b(x2), .O(new_n95_));
  oai21  g78(.a(new_n94_), .b(new_n22_), .c(new_n95_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n21_), .O(new_n97_));
  aoi21  g80(.a(x3), .b(x1), .c(x2), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n65_), .c(x0), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(new_n97_), .c(new_n93_), .O(z5));
  nand2  g83(.a(new_n94_), .b(x1), .O(new_n101_));
  nand3  g84(.a(x3), .b(new_n31_), .c(new_n22_), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(new_n101_), .c(new_n77_), .O(z6));
  aoi21  g86(.a(new_n95_), .b(new_n94_), .c(new_n77_), .O(z7));
  nor2   g87(.a(new_n77_), .b(x3), .O(z8));
  nand3  g88(.a(x6), .b(x5), .c(x4), .O(new_n106_));
