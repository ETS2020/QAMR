...
module FAU ( 
  ...
  nor2   g72(.a(x6), .b(new_n18_), .O(new_n90_));
  nand2  g73(.a(x3), .b(new_n31_), .O(new_n91_));
  nand2  g74(.a(new_n47_), .b(x2), .O(new_n92_));
  oai21  g75(.a(new_n91_), .b(new_n22_), .c(new_n92_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n21_), .O(new_n94_));
  aoi21  g77(.a(x3), .b(x1), .c(x2), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n65_), .c(x0), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n94_), .c(new_n90_), .O(z5));
  nand2  g80(.a(new_n91_), .b(x1), .O(new_n98_));
  nand3  g81(.a(x3), .b(new_n31_), .c(new_n22_), .O(new_n99_));
  aoi21  g82(.a(new_n99_), .b(new_n98_), .c(new_n90_), .O(z6));
  inv1   g83(.a(new_n90_), .O(new_n101_));
  nand3  g84(.a(new_n92_), .b(new_n91_), .c(new_n101_), .O(z7));
  nor2   g85(.a(new_n90_), .b(x3), .O(z8));
  aoi21  g86(.a(x6), .b(new_n19_), .c(new_n18_), .O(z9));
endmodule
