...
module FAU ( 
  ...
  aoi21  g88(.a(new_n105_), .b(new_n103_), .c(new_n84_), .O(z5));
  nand2  g89(.a(new_n100_), .b(x1), .O(new_n107_));
  nand3  g90(.a(x3), .b(new_n51_), .c(new_n25_), .O(new_n108_));
  nand3  g91(.a(new_n108_), .b(new_n107_), .c(new_n85_), .O(z6));
  nand3  g92(.a(new_n101_), .b(new_n100_), .c(new_n85_), .O(z7));
  nor2   g93(.a(new_n84_), .b(x3), .O(z8));
