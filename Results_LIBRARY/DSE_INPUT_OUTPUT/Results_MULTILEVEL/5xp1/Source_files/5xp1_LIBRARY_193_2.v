...
module FAU ( 
  ...
  oai21  g66(.a(new_n68_), .b(new_n24_), .c(new_n30_), .O(new_n84_));
  oai21  g67(.a(new_n68_), .b(new_n33_), .c(new_n84_), .O(new_n85_));
  ...
  nand3  g75(.a(x6), .b(new_n68_), .c(x2), .O(new_n93_));
  ...
  nand3  g79(.a(x6), .b(x3), .c(x2), .O(new_n97_));
  ...
  nor2   g87(.a(new_n89_), .b(x3), .O(z8));
  oai21  g88(.a(new_n22_), .b(new_n18_), .c(new_n90_), .O(z9));
endmodule
