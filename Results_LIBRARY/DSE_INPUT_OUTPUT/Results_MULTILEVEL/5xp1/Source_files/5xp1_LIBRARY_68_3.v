...
module FAU ( 
  ...
  nand3  g49(.a(new_n19_), .b(x3), .c(new_n27_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(new_n59_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n66_), .c(x2), .O(new_n69_));
  oai21  g52(.a(x6), .b(x3), .c(x5), .O(new_n70_));
  nand2  g53(.a(new_n40_), .b(new_n27_), .O(new_n71_));
  oai21  g54(.a(new_n70_), .b(new_n27_), .c(new_n71_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(x1), .O(new_n73_));
  oai21  g56(.a(new_n20_), .b(new_n23_), .c(new_n24_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n66_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(x5), .c(new_n27_), .O(new_n76_));
  oai21  g59(.a(new_n20_), .b(new_n61_), .c(new_n23_), .O(new_n77_));
  inv1   g60(.a(x3), .O(new_n78_));
  nand3  g61(.a(new_n20_), .b(new_n78_), .c(new_n61_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n77_), .c(x5), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(x4), .c(x0), .O(new_n81_));
  nand4  g64(.a(new_n81_), .b(new_n76_), .c(new_n73_), .d(new_n69_), .O(z3));
  aoi21  g65(.a(new_n55_), .b(new_n24_), .c(new_n20_), .O(new_n83_));
  nand2  g66(.a(new_n78_), .b(new_n61_), .O(new_n84_));
  nand2  g67(.a(new_n24_), .b(new_n27_), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n84_), .c(x6), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n83_), .c(x1), .O(new_n87_));
  nand3  g70(.a(new_n20_), .b(x2), .c(new_n23_), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n18_), .c(new_n27_), .O(new_n89_));
  aoi21  g72(.a(new_n78_), .b(new_n27_), .c(new_n61_), .O(new_n90_));
  nand3  g73(.a(new_n20_), .b(x3), .c(x2), .O(new_n91_));
  oai21  g74(.a(new_n90_), .b(new_n20_), .c(new_n91_), .O(new_n92_));
  aoi21  g75(.a(new_n92_), .b(new_n23_), .c(new_n89_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n87_), .O(z4));
  nand2  g77(.a(x3), .b(new_n61_), .O(new_n95_));
  nand2  g78(.a(new_n78_), .b(x2), .O(new_n96_));
  ...
  nand2  g82(.a(new_n24_), .b(new_n18_), .O(new_n100_));
  ...
  nand3  g86(.a(x3), .b(new_n61_), .c(new_n23_), .O(new_n104_));
  nor2   g87(.a(new_n18_), .b(new_n27_), .O(new_n105_));
  inv1   g88(.a(new_n105_), .O(new_n106_));
  nand3  g89(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(z6));
  aoi21  g90(.a(new_n96_), .b(new_n95_), .c(new_n105_), .O(z7));
  nand2  g91(.a(new_n106_), .b(x3), .O(z8));
  nand4  g92(.a(new_n39_), .b(x5), .c(x4), .d(new_n27_), .O(new_n110_));
