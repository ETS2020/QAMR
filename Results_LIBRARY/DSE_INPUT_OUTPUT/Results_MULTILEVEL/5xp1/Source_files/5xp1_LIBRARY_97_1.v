...
module FAU ( 
  ...
  aoi21  g32(.a(new_n48_), .b(new_n33_), .c(new_n49_), .O(new_n50_));
  ...
  nand4  g45(.a(new_n19_), .b(new_n30_), .c(x3), .d(new_n18_), .O(new_n63_));
  ...
  aoi21  g54(.a(new_n71_), .b(new_n26_), .c(new_n30_), .O(new_n72_));
  aoi21  g55(.a(new_n70_), .b(new_n19_), .c(new_n72_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n67_), .O(z3));
  inv1   g57(.a(new_n43_), .O(new_n75_));
  aoi21  g58(.a(new_n52_), .b(new_n25_), .c(new_n19_), .O(new_n76_));
  ...
  nor3   g63(.a(new_n80_), .b(x6), .c(new_n33_), .O(new_n81_));
  nor2   g64(.a(new_n80_), .b(new_n33_), .O(new_n82_));
  nor2   g65(.a(new_n82_), .b(new_n19_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n81_), .c(new_n24_), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(new_n79_), .c(new_n75_), .O(z4));
  nand2  g68(.a(x3), .b(new_n33_), .O(new_n86_));
  ...
  nand3  g75(.a(new_n92_), .b(new_n89_), .c(new_n75_), .O(z5));
  nand2  g76(.a(new_n86_), .b(x1), .O(new_n94_));
  nand3  g77(.a(x3), .b(new_n33_), .c(new_n24_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n94_), .c(new_n75_), .O(z6));
  aoi21  g79(.a(new_n87_), .b(new_n86_), .c(new_n43_), .O(z7));
  nor2   g80(.a(new_n43_), .b(x3), .O(z8));
  nand2  g81(.a(new_n21_), .b(new_n18_), .O(new_n99_));
