...
module FAU ( 
  ...
  nor2   g70(.a(x6), .b(x3), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n18_), .c(new_n23_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n36_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(x1), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n87_), .c(new_n85_), .O(z4));
  nand3  g75(.a(x3), .b(new_n18_), .c(x1), .O(new_n93_));
  inv1   g76(.a(new_n93_), .O(new_n94_));
  nor2   g77(.a(x3), .b(new_n18_), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n94_), .c(new_n23_), .O(new_n96_));
  inv1   g79(.a(new_n72_), .O(new_n97_));
  ...
  aoi21  g84(.a(x3), .b(new_n27_), .c(x6), .O(new_n102_));
  ...
  inv1   g88(.a(new_n95_), .O(new_n106_));
  oai21  g89(.a(new_n88_), .b(x2), .c(new_n106_), .O(z7));
  aoi21  g90(.a(x6), .b(new_n18_), .c(x3), .O(z8));
  nand2  g91(.a(new_n20_), .b(x2), .O(new_n109_));
  nand2  g92(.a(new_n109_), .b(x6), .O(new_n110_));
  oai21  g93(.a(new_n72_), .b(new_n27_), .c(new_n23_), .O(new_n111_));
