...
module FAU ( 
  ...
  nand2  g11(.a(new_n19_), .b(new_n23_), .O(new_n29_));
  ...
  nand3  g27(.a(new_n44_), .b(new_n38_), .c(new_n29_), .O(z1));
  ...
  nand2  g56(.a(x6), .b(new_n23_), .O(new_n74_));
  inv1   g57(.a(x3), .O(new_n75_));
  nand3  g58(.a(new_n19_), .b(new_n75_), .c(x1), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n51_), .c(x0), .O(new_n78_));
  aoi21  g61(.a(new_n20_), .b(new_n19_), .c(new_n23_), .O(new_n79_));
  nand3  g62(.a(x6), .b(x3), .c(x2), .O(new_n80_));
  inv1   g63(.a(new_n80_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n79_), .c(new_n18_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n78_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n28_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n73_), .O(z3));
  nand2  g68(.a(new_n75_), .b(new_n51_), .O(new_n86_));
  ...
  aoi21  g72(.a(new_n86_), .b(new_n89_), .c(x6), .O(new_n90_));
  ...
  nand2  g77(.a(x3), .b(new_n51_), .O(new_n95_));
  nand2  g78(.a(new_n75_), .b(x2), .O(new_n96_));
  ...
  aoi21  g87(.a(x3), .b(new_n51_), .c(new_n19_), .O(new_n105_));
  oai21  g88(.a(new_n105_), .b(x1), .c(new_n104_), .O(z6));
  aoi21  g89(.a(new_n96_), .b(new_n95_), .c(new_n30_), .O(z7));
  nand2  g90(.a(new_n29_), .b(x3), .O(z8));
  oai21  g91(.a(new_n61_), .b(new_n23_), .c(new_n19_), .O(new_n109_));
