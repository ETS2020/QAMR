...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n100_, new_n101_, new_n103_, new_n105_, new_n108_, new_n109_;
  ...
  nand3  g63(.a(new_n76_), .b(new_n80_), .c(new_n19_), .O(new_n81_));
  and2   g64(.a(new_n81_), .b(new_n30_), .O(new_n82_));
  nand4  g65(.a(new_n82_), .b(new_n79_), .c(new_n73_), .d(new_n70_), .O(z3));
  nand2  g66(.a(new_n80_), .b(new_n33_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(x0), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n21_), .c(new_n20_), .O(new_n86_));
  nand2  g69(.a(new_n21_), .b(new_n19_), .O(new_n87_));
  aoi21  g70(.a(new_n84_), .b(new_n87_), .c(x6), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n86_), .c(x1), .O(new_n89_));
  oai21  g72(.a(x3), .b(x0), .c(x2), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(x6), .c(new_n18_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n89_), .O(z4));
  aoi21  g75(.a(new_n84_), .b(new_n21_), .c(new_n18_), .O(new_n93_));
  nor2   g76(.a(x3), .b(new_n33_), .O(new_n94_));
  nor3   g77(.a(new_n94_), .b(new_n20_), .c(x1), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n93_), .c(x0), .O(new_n96_));
  nor2   g79(.a(new_n80_), .b(x2), .O(new_n97_));
  nor2   g80(.a(new_n97_), .b(new_n94_), .O(new_n98_));
  nand3  g81(.a(x6), .b(new_n80_), .c(x2), .O(new_n99_));
  ...
  nand4  g85(.a(x6), .b(x3), .c(new_n33_), .d(new_n18_), .O(new_n103_));
  oai21  g86(.a(new_n97_), .b(new_n18_), .c(new_n103_), .O(z6));
  inv1   g87(.a(new_n30_), .O(new_n105_));
  nor2   g88(.a(new_n98_), .b(new_n105_), .O(z7));
