...
module FAU ( 
  ...
  aoi21  g59(.a(new_n76_), .b(new_n21_), .c(new_n36_), .O(new_n77_));
  ...
  nor2   g66(.a(new_n83_), .b(new_n36_), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n82_), .c(new_n20_), .O(new_n85_));
  nor2   g68(.a(x6), .b(new_n43_), .O(new_n86_));
  inv1   g69(.a(new_n86_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n85_), .c(new_n80_), .O(z4));
  nand2  g71(.a(x3), .b(new_n30_), .O(new_n89_));
  nand2  g72(.a(new_n31_), .b(x2), .O(new_n90_));
  oai21  g73(.a(new_n89_), .b(new_n20_), .c(new_n90_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n19_), .O(new_n92_));
  aoi21  g75(.a(x3), .b(x1), .c(x2), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n64_), .c(x0), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n92_), .c(new_n87_), .O(z5));
  nand2  g78(.a(new_n89_), .b(x1), .O(new_n96_));
  nand3  g79(.a(x3), .b(new_n30_), .c(new_n20_), .O(new_n97_));
  aoi21  g80(.a(new_n97_), .b(new_n96_), .c(new_n86_), .O(z6));
  aoi21  g81(.a(new_n90_), .b(new_n89_), .c(new_n86_), .O(z7));
  nand2  g82(.a(new_n87_), .b(x3), .O(z8));
