...
module FAU ( 
  ...
  wire new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_,
    ...
    new_n108_, new_n109_, new_n111_, new_n113_, new_n114_;
  inv1   g00(.a(x3), .O(z8));
  ...
  nand3  g62(.a(x6), .b(z8), .c(new_n40_), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(new_n79_), .c(new_n29_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n76_), .c(new_n19_), .O(new_n82_));
  oai21  g65(.a(new_n30_), .b(new_n40_), .c(new_n36_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(x5), .O(new_n84_));
  nand2  g67(.a(new_n20_), .b(x3), .O(new_n85_));
  oai21  g68(.a(new_n20_), .b(x2), .c(new_n85_), .O(new_n86_));
  ...
  aoi21  g74(.a(new_n91_), .b(new_n72_), .c(new_n20_), .O(new_n92_));
  nand2  g75(.a(new_n67_), .b(new_n19_), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(x3), .c(x6), .O(new_n94_));
  oai21  g77(.a(new_n94_), .b(new_n92_), .c(x1), .O(new_n95_));
  aoi21  g78(.a(new_n20_), .b(x3), .c(x2), .O(new_n96_));
  oai22  g79(.a(x6), .b(new_n67_), .c(x3), .d(x0), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(new_n96_), .c(new_n40_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n95_), .O(z4));
  nand2  g82(.a(x3), .b(new_n67_), .O(new_n100_));
  nand2  g83(.a(z8), .b(x2), .O(new_n101_));
  oai21  g84(.a(new_n100_), .b(new_n40_), .c(new_n101_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n19_), .O(new_n103_));
  nor2   g86(.a(x3), .b(x2), .O(new_n104_));
  aoi21  g87(.a(new_n67_), .b(x1), .c(z8), .O(new_n105_));
  oai21  g88(.a(new_n105_), .b(new_n104_), .c(x0), .O(new_n106_));
  nand3  g89(.a(new_n106_), .b(new_n103_), .c(new_n31_), .O(z5));
  nand2  g90(.a(new_n100_), .b(x1), .O(new_n108_));
  nand3  g91(.a(x3), .b(new_n67_), .c(new_n40_), .O(new_n109_));
  nand3  g92(.a(new_n109_), .b(new_n108_), .c(new_n31_), .O(z6));
  nand3  g93(.a(x6), .b(z8), .c(x2), .O(new_n111_));
  ...
  nand2  g97(.a(new_n114_), .b(new_n31_), .O(z9));
endmodule
