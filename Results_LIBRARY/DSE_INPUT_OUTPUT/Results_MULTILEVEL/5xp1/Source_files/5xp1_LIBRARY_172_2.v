...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n85_, new_n89_,
    new_n90_;
  ...
  nand2  g19(.a(new_n20_), .b(new_n23_), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(x1), .O(new_n38_));
  nor2   g21(.a(x5), .b(x2), .O(new_n39_));
  ...
  nand3  g27(.a(new_n44_), .b(new_n42_), .c(new_n38_), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(x4), .O(new_n46_));
  aoi21  g29(.a(x3), .b(x2), .c(x0), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(new_n39_), .c(new_n19_), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(new_n37_), .c(new_n31_), .O(new_n49_));
  nand3  g32(.a(new_n31_), .b(x5), .c(x0), .O(new_n50_));
  inv1   g33(.a(new_n50_), .O(new_n51_));
  oai21  g34(.a(new_n51_), .b(new_n49_), .c(new_n18_), .O(new_n52_));
  nor2   g35(.a(x6), .b(new_n19_), .O(new_n53_));
  inv1   g36(.a(new_n53_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n52_), .c(new_n46_), .O(z2));
  nand2  g38(.a(new_n43_), .b(new_n37_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(x1), .O(new_n57_));
  nand3  g40(.a(new_n20_), .b(x3), .c(new_n23_), .O(new_n58_));
  ...
  nor2   g46(.a(new_n20_), .b(x3), .O(new_n64_));
  ...
  nor2   g54(.a(new_n68_), .b(new_n19_), .O(new_n72_));
  aoi22  g55(.a(new_n72_), .b(x0), .c(new_n71_), .d(new_n19_), .O(new_n73_));
  oai21  g56(.a(new_n73_), .b(new_n31_), .c(new_n70_), .O(z4));
  ...
  oai21  g62(.a(x2), .b(new_n23_), .c(new_n19_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n31_), .O(new_n81_));
  oai21  g64(.a(new_n72_), .b(x2), .c(new_n24_), .O(new_n82_));
  ...
  aoi21  g69(.a(new_n77_), .b(new_n76_), .c(new_n53_), .O(z7));
  nor2   g70(.a(new_n53_), .b(x3), .O(z8));
  oai21  g71(.a(x1), .b(new_n23_), .c(new_n31_), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(x5), .c(x4), .O(new_n90_));
