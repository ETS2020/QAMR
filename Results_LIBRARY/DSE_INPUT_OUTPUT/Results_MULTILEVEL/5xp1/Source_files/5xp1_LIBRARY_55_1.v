...
module FAU ( 
  ...
  nand4  g18(.a(new_n35_), .b(new_n30_), .c(x1), .d(x0), .O(new_n36_));
  nand3  g19(.a(new_n20_), .b(x5), .c(new_n18_), .O(new_n37_));
  aoi21  g20(.a(new_n37_), .b(new_n36_), .c(new_n23_), .O(new_n38_));
  nor2   g21(.a(new_n30_), .b(x4), .O(new_n39_));
  oai21  g22(.a(new_n39_), .b(new_n38_), .c(new_n19_), .O(new_n40_));
  nand4  g23(.a(new_n25_), .b(x5), .c(new_n23_), .d(new_n24_), .O(new_n41_));
  ...
  aoi22  g32(.a(new_n49_), .b(new_n18_), .c(new_n48_), .d(new_n33_), .O(new_n50_));
  aoi21  g33(.a(new_n50_), .b(new_n47_), .c(new_n23_), .O(new_n51_));
  ...
  nand4  g40(.a(new_n25_), .b(new_n23_), .c(new_n24_), .d(new_n18_), .O(new_n58_));
  nand2  g41(.a(new_n26_), .b(x4), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(x6), .c(x5), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n57_), .O(z2));
  nand3  g45(.a(new_n30_), .b(x3), .c(new_n18_), .O(new_n63_));
  aoi21  g46(.a(new_n63_), .b(new_n46_), .c(new_n33_), .O(new_n64_));
  aoi21  g47(.a(new_n49_), .b(new_n19_), .c(new_n18_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n64_), .c(x1), .O(new_n66_));
  oai21  g49(.a(new_n33_), .b(new_n18_), .c(x5), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(x6), .O(new_n68_));
  nand2  g51(.a(new_n35_), .b(x1), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n30_), .c(x0), .O(new_n70_));
  oai21  g53(.a(new_n19_), .b(new_n24_), .c(new_n25_), .O(new_n71_));
  nand2  g54(.a(new_n19_), .b(new_n24_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(x5), .c(new_n18_), .O(new_n74_));
  nand4  g57(.a(new_n74_), .b(new_n70_), .c(new_n68_), .d(new_n66_), .O(z3));
  nand2  g58(.a(new_n52_), .b(new_n25_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(x6), .c(x5), .O(new_n77_));
  nor2   g60(.a(x3), .b(x2), .O(new_n78_));
  aoi21  g61(.a(new_n25_), .b(new_n18_), .c(new_n78_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(x6), .c(new_n77_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x1), .O(new_n81_));
  nand2  g64(.a(new_n34_), .b(new_n18_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n19_), .c(x2), .O(new_n83_));
  nand2  g66(.a(new_n82_), .b(x2), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(x6), .c(x5), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n24_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n81_), .O(z4));
  inv1   g71(.a(new_n43_), .O(new_n89_));
  ...
  inv1   g76(.a(new_n25_), .O(new_n94_));
  aoi21  g77(.a(x3), .b(x1), .c(x2), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n94_), .c(x0), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n93_), .c(new_n89_), .O(z5));
  nand2  g80(.a(new_n90_), .b(x1), .O(new_n98_));
  nand3  g81(.a(x3), .b(new_n33_), .c(new_n24_), .O(new_n99_));
  aoi21  g82(.a(new_n99_), .b(new_n98_), .c(new_n43_), .O(z6));
  nand3  g83(.a(new_n91_), .b(new_n90_), .c(new_n89_), .O(z7));
  nor2   g84(.a(new_n43_), .b(x3), .O(z8));
  nand2  g85(.a(new_n21_), .b(new_n18_), .O(new_n103_));
