...
module FAU ( 
  ...
  oai21  g31(.a(new_n48_), .b(new_n47_), .c(new_n36_), .O(new_n49_));
  nand2  g32(.a(new_n20_), .b(new_n23_), .O(new_n50_));
  ...
  nand4  g36(.a(new_n28_), .b(new_n18_), .c(x1), .d(x0), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(x3), .O(new_n56_));
  nand2  g39(.a(x4), .b(x2), .O(new_n57_));
  nand3  g40(.a(new_n28_), .b(x5), .c(new_n18_), .O(new_n58_));
  aoi21  g41(.a(new_n58_), .b(new_n57_), .c(new_n23_), .O(new_n59_));
  nand2  g42(.a(x3), .b(x1), .O(new_n60_));
  aoi21  g43(.a(new_n60_), .b(new_n20_), .c(new_n23_), .O(new_n61_));
  oai21  g44(.a(new_n61_), .b(new_n18_), .c(new_n19_), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n28_), .c(new_n59_), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(new_n56_), .c(new_n52_), .O(z2));
  oai21  g47(.a(x2), .b(x1), .c(x0), .O(new_n65_));
  inv1   g48(.a(x3), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n36_), .c(new_n23_), .O(new_n67_));
  aoi21  g50(.a(new_n67_), .b(new_n65_), .c(new_n20_), .O(new_n68_));
  nor3   g51(.a(new_n24_), .b(x5), .c(x0), .O(new_n69_));
  oai21  g52(.a(new_n69_), .b(new_n68_), .c(x6), .O(new_n70_));
  oai21  g53(.a(new_n28_), .b(new_n36_), .c(new_n23_), .O(new_n71_));
  ...
  oai21  g59(.a(new_n76_), .b(new_n73_), .c(new_n19_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n70_), .O(z3));
  nor2   g61(.a(new_n28_), .b(new_n66_), .O(new_n79_));
  nor2   g62(.a(new_n79_), .b(x2), .O(new_n80_));
  nor2   g63(.a(new_n80_), .b(new_n23_), .O(new_n81_));
  oai21  g64(.a(new_n66_), .b(new_n23_), .c(new_n28_), .O(new_n82_));
  oai21  g65(.a(new_n66_), .b(new_n19_), .c(new_n82_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n81_), .c(x1), .O(new_n84_));
  oai21  g67(.a(x3), .b(x0), .c(x2), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(x6), .c(new_n36_), .O(new_n86_));
  nand2  g69(.a(new_n28_), .b(x2), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(z4));
  nand2  g71(.a(x3), .b(new_n19_), .O(new_n89_));
  nand3  g72(.a(x6), .b(new_n66_), .c(x2), .O(new_n90_));
  ...
  nand3  g81(.a(x3), .b(new_n19_), .c(new_n36_), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(new_n98_), .c(new_n87_), .O(z6));
  oai21  g83(.a(new_n79_), .b(new_n19_), .c(new_n89_), .O(z7));
  nand2  g84(.a(new_n87_), .b(x3), .O(z8));
  oai21  g85(.a(x2), .b(new_n23_), .c(new_n28_), .O(new_n103_));
