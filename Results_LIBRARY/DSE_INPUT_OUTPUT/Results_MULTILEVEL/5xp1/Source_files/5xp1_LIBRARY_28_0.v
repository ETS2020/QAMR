...
module FAU ( 
  ...
  oai21  g54(.a(new_n33_), .b(z8), .c(new_n34_), .O(new_n72_));
  ...
  oai21  g59(.a(new_n33_), .b(new_n34_), .c(new_n76_), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n72_), .c(new_n28_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n75_), .c(new_n19_), .O(new_n79_));
  nand3  g62(.a(new_n36_), .b(new_n28_), .c(new_n34_), .O(new_n80_));
  aoi21  g63(.a(x6), .b(x2), .c(x1), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n28_), .c(new_n80_), .O(new_n82_));
  aoi21  g65(.a(new_n82_), .b(x0), .c(new_n29_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n79_), .O(z3));
  nand2  g67(.a(x3), .b(x2), .O(new_n85_));
  oai21  g68(.a(x3), .b(x2), .c(x0), .O(new_n86_));
  aoi21  g69(.a(new_n86_), .b(new_n85_), .c(new_n33_), .O(new_n87_));
  nand2  g70(.a(new_n76_), .b(new_n19_), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(x3), .c(x6), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n87_), .c(x1), .O(new_n90_));
  aoi21  g73(.a(new_n33_), .b(x3), .c(x2), .O(new_n91_));
  oai22  g74(.a(x6), .b(new_n76_), .c(x3), .d(x0), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n91_), .c(new_n34_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n90_), .O(z4));
  nand3  g77(.a(new_n76_), .b(x1), .c(new_n19_), .O(new_n95_));
  oai21  g78(.a(new_n76_), .b(new_n19_), .c(new_n95_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(x3), .O(new_n97_));
  aoi21  g80(.a(x6), .b(new_n76_), .c(x0), .O(new_n98_));
  nor2   g81(.a(x2), .b(new_n19_), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(new_n98_), .c(z8), .O(new_n100_));
  nor2   g83(.a(x6), .b(new_n76_), .O(new_n101_));
  nor2   g84(.a(x2), .b(x1), .O(new_n102_));
  oai21  g85(.a(new_n102_), .b(new_n101_), .c(x0), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n100_), .c(new_n97_), .O(z5));
  inv1   g87(.a(new_n85_), .O(new_n105_));
  nor2   g88(.a(new_n33_), .b(x3), .O(new_n106_));
  oai21  g89(.a(new_n106_), .b(new_n105_), .c(x1), .O(new_n107_));
  nand2  g90(.a(x3), .b(new_n76_), .O(new_n108_));
  oai21  g91(.a(new_n108_), .b(x1), .c(new_n107_), .O(z6));
  nand2  g92(.a(new_n106_), .b(x2), .O(new_n110_));
  nand2  g93(.a(new_n110_), .b(new_n108_), .O(z7));
  nand2  g94(.a(new_n20_), .b(new_n19_), .O(new_n112_));
  nand3  g95(.a(new_n112_), .b(x5), .c(x4), .O(new_n113_));
  nand2  g96(.a(new_n113_), .b(new_n30_), .O(z9));
endmodule
