...
module FAU ( 
  ...
  oai21  g34(.a(x6), .b(new_n36_), .c(new_n51_), .O(new_n52_));
  ...
  nand2  g47(.a(new_n64_), .b(new_n36_), .O(new_n65_));
  ...
  nand2  g56(.a(new_n45_), .b(new_n59_), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(x6), .c(x4), .O(new_n75_));
  nor2   g58(.a(x3), .b(x2), .O(new_n76_));
  aoi21  g59(.a(new_n59_), .b(new_n19_), .c(new_n76_), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(x6), .c(new_n75_), .O(new_n78_));
  ...
  nand2  g68(.a(new_n85_), .b(new_n36_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n79_), .O(z4));
  nor2   g70(.a(new_n20_), .b(x4), .O(new_n88_));
  nand2  g71(.a(x3), .b(new_n39_), .O(new_n89_));
  nand2  g72(.a(new_n80_), .b(x2), .O(new_n90_));
  oai21  g73(.a(new_n89_), .b(new_n36_), .c(new_n90_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n19_), .O(new_n92_));
  inv1   g75(.a(new_n59_), .O(new_n93_));
  aoi21  g76(.a(x3), .b(x1), .c(x2), .O(new_n94_));
  oai21  g77(.a(new_n94_), .b(new_n93_), .c(x0), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n92_), .c(new_n88_), .O(z5));
  nand2  g79(.a(new_n89_), .b(x1), .O(new_n97_));
  nand3  g80(.a(x3), .b(new_n39_), .c(new_n36_), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(new_n97_), .c(new_n88_), .O(z6));
  inv1   g82(.a(new_n88_), .O(new_n100_));
  nand3  g83(.a(new_n90_), .b(new_n89_), .c(new_n100_), .O(z7));
  nand2  g84(.a(new_n100_), .b(x3), .O(z8));
