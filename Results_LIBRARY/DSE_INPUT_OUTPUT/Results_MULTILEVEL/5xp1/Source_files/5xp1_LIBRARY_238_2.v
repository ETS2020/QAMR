...
module FAU ( 
  ...
  nor2   g51(.a(new_n63_), .b(new_n36_), .O(new_n69_));
  nand2  g52(.a(new_n69_), .b(x0), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(new_n68_), .c(new_n20_), .O(new_n71_));
  ...
  nand2  g58(.a(new_n75_), .b(new_n67_), .O(z3));
  ...
  oai21  g63(.a(new_n63_), .b(new_n19_), .c(new_n80_), .O(new_n81_));
  ...
  nor2   g67(.a(x6), .b(new_n19_), .O(new_n85_));
  inv1   g68(.a(new_n85_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n84_), .c(new_n82_), .O(z4));
  nand2  g70(.a(x3), .b(new_n19_), .O(new_n88_));
  nand2  g71(.a(new_n63_), .b(x2), .O(new_n89_));
  oai21  g72(.a(new_n88_), .b(new_n36_), .c(new_n89_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n23_), .O(new_n91_));
  aoi21  g74(.a(new_n79_), .b(x6), .c(new_n19_), .O(new_n92_));
  nor2   g75(.a(new_n69_), .b(x2), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(x0), .c(new_n92_), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n91_), .O(z5));
  nor2   g78(.a(x3), .b(x2), .O(new_n96_));
  oai21  g79(.a(new_n96_), .b(new_n31_), .c(x1), .O(new_n97_));
  oai21  g80(.a(new_n88_), .b(x1), .c(new_n97_), .O(z6));
  nand2  g81(.a(new_n77_), .b(x2), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n88_), .O(z7));
  nor2   g83(.a(new_n85_), .b(x3), .O(z8));
  oai21  g84(.a(x6), .b(x0), .c(x5), .O(new_n102_));
  oai21  g85(.a(new_n102_), .b(new_n18_), .c(new_n86_), .O(z9));
endmodule
