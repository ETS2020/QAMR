...
module FAU ( 
  ...
  nand2  g68(.a(new_n37_), .b(x2), .O(new_n86_));
  oai21  g69(.a(new_n85_), .b(new_n31_), .c(new_n86_), .O(new_n87_));
  ...
  aoi21  g74(.a(new_n91_), .b(new_n88_), .c(new_n68_), .O(z5));
  nand2  g75(.a(new_n85_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n34_), .c(new_n31_), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n93_), .c(new_n68_), .O(z6));
  nand3  g78(.a(new_n86_), .b(new_n85_), .c(new_n69_), .O(z7));
  nand2  g79(.a(new_n69_), .b(x3), .O(z8));
  nand3  g80(.a(new_n21_), .b(new_n20_), .c(new_n19_), .O(new_n98_));
