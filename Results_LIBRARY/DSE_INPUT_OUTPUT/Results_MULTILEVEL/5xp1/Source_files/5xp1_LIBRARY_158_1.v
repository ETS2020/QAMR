...
module FAU ( 
  ...
  nand4  g48(.a(new_n21_), .b(new_n18_), .c(x3), .d(new_n20_), .O(new_n66_));
  ...
  nand2  g53(.a(new_n33_), .b(x1), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n18_), .c(x0), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n35_), .O(new_n73_));
  nand3  g56(.a(x6), .b(x2), .c(x0), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n28_), .c(new_n18_), .O(new_n75_));
  aoi21  g58(.a(new_n73_), .b(new_n21_), .c(new_n75_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n70_), .O(z3));
  aoi21  g60(.a(new_n43_), .b(new_n27_), .c(new_n21_), .O(new_n78_));
  nand2  g61(.a(new_n27_), .b(new_n20_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n33_), .c(x6), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n78_), .c(x1), .O(new_n81_));
  nor2   g64(.a(x3), .b(x0), .O(new_n82_));
  nor3   g65(.a(new_n82_), .b(x6), .c(new_n31_), .O(new_n83_));
  nor2   g66(.a(new_n82_), .b(new_n31_), .O(new_n84_));
  nor2   g67(.a(new_n84_), .b(new_n21_), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n83_), .c(new_n26_), .O(new_n86_));
  nor2   g69(.a(new_n21_), .b(x5), .O(new_n87_));
  inv1   g70(.a(new_n87_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n86_), .c(new_n81_), .O(z4));
  nand2  g72(.a(x3), .b(new_n31_), .O(new_n90_));
  nand2  g73(.a(new_n32_), .b(x2), .O(new_n91_));
  oai21  g74(.a(new_n90_), .b(new_n26_), .c(new_n91_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n20_), .O(new_n93_));
  aoi21  g76(.a(x3), .b(x1), .c(x2), .O(new_n94_));
  oai21  g77(.a(new_n94_), .b(new_n39_), .c(x0), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n93_), .c(new_n88_), .O(z5));
  nand2  g79(.a(new_n90_), .b(x1), .O(new_n97_));
  nand3  g80(.a(x3), .b(new_n31_), .c(new_n26_), .O(new_n98_));
  ...
  nand2  g84(.a(new_n23_), .b(new_n20_), .O(new_n102_));
