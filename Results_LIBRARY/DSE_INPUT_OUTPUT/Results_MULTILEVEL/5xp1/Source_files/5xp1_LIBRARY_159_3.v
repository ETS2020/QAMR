...
module FAU ( 
  ...
  nand3  g75(.a(x6), .b(new_n36_), .c(new_n37_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n92_), .c(new_n88_), .O(z4));
  nor2   g77(.a(new_n41_), .b(x2), .O(new_n95_));
  nor2   g78(.a(x3), .b(new_n36_), .O(new_n96_));
  ...
  inv1   g84(.a(new_n42_), .O(new_n102_));
  aoi21  g85(.a(new_n20_), .b(x2), .c(new_n102_), .O(new_n103_));
  nand2  g86(.a(new_n95_), .b(new_n37_), .O(new_n104_));
  oai21  g87(.a(new_n103_), .b(new_n37_), .c(new_n104_), .O(z6));
  oai21  g88(.a(x6), .b(new_n41_), .c(x2), .O(new_n106_));
  oai21  g89(.a(new_n41_), .b(x2), .c(new_n106_), .O(z7));
  nand2  g90(.a(new_n27_), .b(x3), .O(z8));
  nand4  g91(.a(x5), .b(x4), .c(x3), .d(x1), .O(new_n109_));
