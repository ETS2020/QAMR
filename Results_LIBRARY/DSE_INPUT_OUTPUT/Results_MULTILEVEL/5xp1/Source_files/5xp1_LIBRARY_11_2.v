...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n93_, new_n94_, new_n95_, new_n96_, new_n98_, new_n100_, new_n103_;
  ...
  nand3  g63(.a(x6), .b(new_n19_), .c(new_n24_), .O(new_n81_));
  ...
  aoi21  g69(.a(new_n30_), .b(new_n19_), .c(new_n23_), .O(new_n87_));
  ...
  nand3  g77(.a(x6), .b(x3), .c(x1), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n60_), .c(x0), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n94_), .c(new_n92_), .O(z5));
  aoi21  g80(.a(new_n60_), .b(new_n24_), .c(new_n40_), .O(new_n98_));
  nand2  g81(.a(x6), .b(x3), .O(z8));
  nor2   g82(.a(z8), .b(x2), .O(new_n100_));
  oai22  g83(.a(new_n100_), .b(new_n24_), .c(new_n98_), .d(new_n19_), .O(z6));
  or2    g84(.a(new_n100_), .b(new_n65_), .O(z7));
