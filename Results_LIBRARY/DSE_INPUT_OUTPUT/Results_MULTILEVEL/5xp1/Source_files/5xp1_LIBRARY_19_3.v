...
module FAU ( 
  ...
  oai21  g57(.a(new_n74_), .b(new_n19_), .c(new_n65_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(x6), .c(new_n32_), .O(new_n76_));
  ...
  nand2  g82(.a(new_n56_), .b(x3), .O(z8));
