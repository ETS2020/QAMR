...
module FAU ( 
  ...
  xnor2a g59(.a(x6), .b(x1), .O(new_n77_));
  nor2   g60(.a(new_n77_), .b(x0), .O(new_n78_));
  nand3  g61(.a(x2), .b(new_n28_), .c(x0), .O(new_n79_));
  nand2  g62(.a(new_n58_), .b(x1), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(new_n79_), .c(x6), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n78_), .c(new_n19_), .O(new_n82_));
  nand2  g65(.a(x3), .b(x2), .O(new_n83_));
  oai21  g66(.a(x3), .b(x2), .c(x0), .O(new_n84_));
  aoi21  g67(.a(new_n84_), .b(new_n83_), .c(new_n28_), .O(new_n85_));
  nor2   g68(.a(x2), .b(x1), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n85_), .c(x6), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n82_), .O(z4));
  nand2  g71(.a(new_n19_), .b(x2), .O(new_n89_));
  nand2  g72(.a(x6), .b(x3), .O(z8));
  oai21  g73(.a(z8), .b(new_n80_), .c(new_n89_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n23_), .O(new_n92_));
  nor2   g75(.a(x3), .b(x2), .O(new_n93_));
  aoi21  g76(.a(new_n58_), .b(x1), .c(new_n29_), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(x3), .c(new_n93_), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n23_), .c(new_n92_), .O(z5));
  oai21  g79(.a(new_n86_), .b(new_n29_), .c(x3), .O(new_n97_));
  oai21  g80(.a(z8), .b(x2), .c(x1), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n97_), .O(z6));
  oai21  g82(.a(z8), .b(x2), .c(new_n89_), .O(z7));
