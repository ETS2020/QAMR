...
module FAU ( 
  ...
  aoi21  g58(.a(new_n75_), .b(new_n29_), .c(new_n18_), .O(new_n76_));
  aoi21  g59(.a(new_n74_), .b(new_n21_), .c(new_n76_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n71_), .O(z3));
  aoi21  g61(.a(new_n44_), .b(new_n28_), .c(new_n21_), .O(new_n79_));
  nand2  g62(.a(new_n28_), .b(new_n20_), .O(new_n80_));
  ...
  oai21  g69(.a(new_n86_), .b(new_n84_), .c(new_n27_), .O(new_n87_));
  nor2   g70(.a(new_n21_), .b(x5), .O(new_n88_));
  ...
  nand3  g81(.a(x3), .b(new_n32_), .c(new_n27_), .O(new_n99_));
  ...
  aoi21  g85(.a(new_n22_), .b(new_n20_), .c(new_n18_), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(x6), .c(x4), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n89_), .O(z9));
endmodule
