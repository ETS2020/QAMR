...
module FAU ( 
  ...
  nand2  g56(.a(new_n31_), .b(new_n30_), .O(new_n74_));
  ...
  oai21  g65(.a(new_n80_), .b(new_n30_), .c(x6), .O(new_n83_));
  ...
  inv1   g76(.a(new_n71_), .O(new_n94_));
  nand2  g77(.a(new_n87_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n30_), .c(new_n20_), .O(new_n96_));
