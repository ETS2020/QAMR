...
module FAU ( 
  ...
  oai21  g54(.a(new_n20_), .b(new_n18_), .c(new_n40_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(x2), .O(new_n73_));
  oai21  g56(.a(x6), .b(new_n18_), .c(x1), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n73_), .c(x5), .O(new_n75_));
  oai21  g58(.a(new_n20_), .b(new_n40_), .c(new_n67_), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n72_), .c(new_n29_), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(new_n75_), .c(new_n19_), .O(new_n78_));
  nand3  g61(.a(new_n36_), .b(new_n29_), .c(new_n40_), .O(new_n79_));
  aoi21  g62(.a(x6), .b(x2), .c(x1), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n29_), .c(new_n79_), .O(new_n81_));
  aoi21  g64(.a(new_n81_), .b(x0), .c(new_n30_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n78_), .O(z3));
  oai21  g66(.a(x3), .b(x2), .c(x0), .O(new_n84_));
  nand2  g67(.a(x3), .b(x2), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n84_), .c(new_n20_), .O(new_n86_));
  nand2  g69(.a(new_n67_), .b(new_n19_), .O(new_n87_));
  aoi21  g70(.a(new_n87_), .b(x3), .c(x6), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n86_), .c(x1), .O(new_n89_));
  aoi21  g72(.a(new_n20_), .b(x3), .c(x2), .O(new_n90_));
  oai22  g73(.a(x6), .b(new_n67_), .c(x3), .d(x0), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n90_), .c(new_n40_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n89_), .O(z4));
  nand3  g76(.a(new_n67_), .b(x1), .c(new_n19_), .O(new_n94_));
  oai21  g77(.a(new_n67_), .b(new_n19_), .c(new_n94_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(x3), .O(new_n96_));
  aoi21  g79(.a(x6), .b(new_n67_), .c(x0), .O(new_n97_));
  nor2   g80(.a(x2), .b(new_n19_), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n97_), .c(new_n18_), .O(new_n99_));
  nor2   g82(.a(x6), .b(new_n67_), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(new_n65_), .c(x0), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n99_), .c(new_n96_), .O(z5));
  inv1   g85(.a(new_n85_), .O(new_n103_));
  nor2   g86(.a(new_n20_), .b(x3), .O(z8));
  oai21  g87(.a(z8), .b(new_n103_), .c(x1), .O(new_n105_));
  nand3  g88(.a(x3), .b(new_n67_), .c(new_n40_), .O(new_n106_));
