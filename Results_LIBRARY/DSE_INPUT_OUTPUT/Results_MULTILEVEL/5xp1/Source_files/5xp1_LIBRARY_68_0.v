...
module FAU ( 
  ...
  nand3  g47(.a(new_n20_), .b(x3), .c(new_n18_), .O(new_n65_));
  ...
  nand3  g51(.a(x6), .b(new_n20_), .c(new_n18_), .O(new_n69_));
  ...
  nand4  g62(.a(new_n20_), .b(new_n74_), .c(new_n31_), .d(x0), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nor2   g64(.a(x4), .b(x0), .O(new_n82_));
  aoi21  g65(.a(new_n81_), .b(new_n21_), .c(new_n82_), .O(new_n83_));
  nand4  g66(.a(new_n83_), .b(new_n77_), .c(new_n71_), .d(new_n67_), .O(z3));
  nand2  g67(.a(new_n74_), .b(new_n31_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(x0), .O(new_n86_));
  aoi21  g69(.a(new_n86_), .b(new_n78_), .c(new_n21_), .O(new_n87_));
  nand2  g70(.a(new_n78_), .b(new_n18_), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n85_), .c(x6), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n87_), .c(x1), .O(new_n90_));
  nand3  g73(.a(x6), .b(new_n74_), .c(new_n30_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(x4), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n18_), .O(new_n93_));
  nand2  g76(.a(new_n74_), .b(new_n18_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n21_), .c(x2), .O(new_n95_));
  oai21  g78(.a(new_n21_), .b(x2), .c(new_n95_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n30_), .O(new_n97_));
  nand3  g80(.a(new_n97_), .b(new_n93_), .c(new_n90_), .O(z4));
  inv1   g81(.a(new_n82_), .O(new_n99_));
  nand2  g82(.a(x3), .b(x0), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n94_), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(x2), .O(new_n102_));
  nand2  g85(.a(x3), .b(x1), .O(new_n103_));
  xor2a  g86(.a(new_n103_), .b(new_n18_), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n31_), .O(new_n105_));
  nand3  g88(.a(new_n105_), .b(new_n102_), .c(new_n99_), .O(z5));
  ...
  nand3  g92(.a(new_n109_), .b(new_n108_), .c(new_n99_), .O(z6));
  nand2  g93(.a(new_n74_), .b(x2), .O(new_n111_));
  aoi21  g94(.a(new_n111_), .b(new_n107_), .c(new_n82_), .O(z7));
  nand2  g95(.a(new_n99_), .b(x3), .O(z8));
