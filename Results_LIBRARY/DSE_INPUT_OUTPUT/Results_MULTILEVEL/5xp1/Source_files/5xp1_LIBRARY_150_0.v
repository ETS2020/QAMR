...
module FAU ( 
  ...
  aoi21  g074(.a(new_n91_), .b(new_n45_), .c(new_n33_), .O(new_n92_));
  inv1   g075(.a(new_n67_), .O(new_n93_));
  nand2  g076(.a(new_n82_), .b(new_n40_), .O(new_n94_));
  aoi21  g077(.a(new_n94_), .b(new_n93_), .c(x6), .O(new_n95_));
  aoi21  g078(.a(new_n95_), .b(x4), .c(new_n92_), .O(new_n96_));
  nand2  g079(.a(new_n82_), .b(new_n31_), .O(new_n97_));
  nand4  g080(.a(new_n97_), .b(new_n33_), .c(x4), .d(x2), .O(new_n98_));
  inv1   g081(.a(new_n98_), .O(new_n99_));
  aoi21  g082(.a(new_n97_), .b(x2), .c(new_n33_), .O(new_n100_));
  oai21  g083(.a(new_n100_), .b(new_n99_), .c(new_n28_), .O(new_n101_));
  oai21  g084(.a(new_n96_), .b(new_n28_), .c(new_n101_), .O(z4));
  nand2  g085(.a(x3), .b(new_n40_), .O(new_n103_));
  nand2  g086(.a(new_n82_), .b(x2), .O(new_n104_));
  ...
  nand3  g093(.a(new_n110_), .b(new_n108_), .c(new_n106_), .O(z5));
  nand2  g094(.a(new_n103_), .b(x1), .O(new_n112_));
  nand3  g095(.a(x3), .b(new_n40_), .c(new_n28_), .O(new_n113_));
  aoi21  g096(.a(new_n113_), .b(new_n112_), .c(new_n109_), .O(z6));
  nand3  g097(.a(new_n110_), .b(new_n104_), .c(new_n103_), .O(z7));
  nor2   g098(.a(new_n109_), .b(x3), .O(z8));
  nand3  g099(.a(new_n34_), .b(new_n33_), .c(new_n31_), .O(new_n117_));
  nand3  g100(.a(new_n117_), .b(x5), .c(x4), .O(new_n118_));
  nand2  g101(.a(new_n118_), .b(new_n110_), .O(z9));
endmodule
