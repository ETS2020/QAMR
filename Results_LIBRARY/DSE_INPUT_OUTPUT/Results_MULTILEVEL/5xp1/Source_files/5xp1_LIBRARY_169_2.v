...
module FAU ( 
  ...
  aoi21  g57(.a(new_n42_), .b(new_n22_), .c(new_n18_), .O(new_n75_));
  ...
  nor3   g62(.a(new_n79_), .b(x6), .c(new_n36_), .O(new_n80_));
  nor2   g63(.a(new_n79_), .b(new_n36_), .O(new_n81_));
  nor2   g64(.a(new_n81_), .b(new_n18_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n80_), .c(new_n21_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n78_), .c(new_n34_), .O(z4));
  nand2  g67(.a(x3), .b(new_n36_), .O(new_n85_));
  nand2  g68(.a(new_n40_), .b(x2), .O(new_n86_));
  ...
  nand3  g74(.a(new_n91_), .b(new_n88_), .c(new_n34_), .O(z5));
  nand2  g75(.a(new_n85_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n36_), .c(new_n21_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n93_), .c(new_n34_), .O(z6));
  nand3  g78(.a(new_n86_), .b(new_n85_), .c(new_n34_), .O(z7));
  nand2  g79(.a(new_n34_), .b(x3), .O(z8));
