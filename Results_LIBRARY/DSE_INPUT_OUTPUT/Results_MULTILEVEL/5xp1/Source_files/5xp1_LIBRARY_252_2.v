...
module FAU ( 
  ...
  nor2   g30(.a(x3), .b(new_n34_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n30_), .c(new_n18_), .O(new_n49_));
  aoi21  g32(.a(new_n49_), .b(new_n37_), .c(new_n25_), .O(new_n50_));
  oai21  g33(.a(x5), .b(x2), .c(x6), .O(new_n51_));
  nand4  g34(.a(new_n30_), .b(x5), .c(new_n18_), .d(z8), .O(new_n52_));
  ...
  oai21  g46(.a(new_n63_), .b(new_n59_), .c(x6), .O(new_n64_));
  oai21  g47(.a(new_n34_), .b(new_n25_), .c(new_n29_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x0), .O(new_n66_));
  nand4  g49(.a(new_n66_), .b(new_n30_), .c(x4), .d(z8), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n64_), .c(new_n54_), .O(z2));
  inv1   g51(.a(new_n35_), .O(new_n69_));
  oai21  g52(.a(new_n48_), .b(x6), .c(x1), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(new_n69_), .c(new_n29_), .O(new_n71_));
  ...
  nand3  g60(.a(new_n61_), .b(x6), .c(new_n29_), .O(new_n78_));
  ...
  nand3  g66(.a(x2), .b(new_n25_), .c(x0), .O(new_n84_));
  nand2  g67(.a(new_n34_), .b(x1), .O(new_n85_));
  ...
  aoi21  g71(.a(new_n88_), .b(new_n60_), .c(new_n25_), .O(new_n89_));
  ...
  nand3  g80(.a(new_n97_), .b(new_n34_), .c(x0), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n96_), .c(new_n94_), .O(z5));
  oai21  g82(.a(new_n90_), .b(new_n30_), .c(x3), .O(new_n100_));
  ...
  oai22  g88(.a(new_n22_), .b(new_n18_), .c(x6), .d(z8), .O(z9));
endmodule
