...
module FAU ( 
  ...
  nand2  g70(.a(x6), .b(new_n29_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n87_), .c(new_n82_), .O(z4));
  nand2  g72(.a(x3), .b(new_n32_), .O(new_n90_));
  nand2  g73(.a(new_n33_), .b(x2), .O(new_n91_));
  ...
  oai21  g77(.a(new_n94_), .b(new_n40_), .c(x0), .O(new_n95_));
  ...
  nand3  g82(.a(new_n91_), .b(new_n90_), .c(new_n88_), .O(z7));
  nand2  g83(.a(new_n88_), .b(x3), .O(z8));
  nand3  g84(.a(new_n20_), .b(new_n19_), .c(new_n18_), .O(new_n102_));
