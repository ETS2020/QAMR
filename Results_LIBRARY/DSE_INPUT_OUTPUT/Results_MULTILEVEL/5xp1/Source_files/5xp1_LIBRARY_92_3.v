...
module FAU ( 
  ...
  nand3  g78(.a(new_n95_), .b(new_n94_), .c(z8), .O(new_n96_));
  ...
  oai21  g89(.a(new_n106_), .b(x6), .c(x3), .O(new_n107_));
  nand2  g90(.a(new_n90_), .b(new_n39_), .O(new_n108_));
  nand2  g91(.a(new_n108_), .b(x1), .O(new_n109_));
  nand2  g92(.a(new_n109_), .b(new_n107_), .O(z6));
  oai21  g93(.a(x3), .b(new_n39_), .c(new_n108_), .O(z7));
