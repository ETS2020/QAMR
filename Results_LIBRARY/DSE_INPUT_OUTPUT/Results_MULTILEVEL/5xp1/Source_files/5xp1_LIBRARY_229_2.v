...
module FAU ( 
  ...
  aoi21  g17(.a(new_n24_), .b(x6), .c(new_n34_), .O(new_n35_));
  oai21  g18(.a(new_n35_), .b(new_n33_), .c(new_n28_), .O(new_n36_));
  and2   g19(.a(new_n20_), .b(new_n19_), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(x5), .c(x4), .d(new_n18_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n36_), .O(z1));
  inv1   g22(.a(new_n23_), .O(new_n40_));
  nand3  g23(.a(x6), .b(new_n28_), .c(new_n22_), .O(new_n41_));
  nand2  g24(.a(new_n19_), .b(x4), .O(new_n42_));
  aoi21  g25(.a(new_n42_), .b(new_n41_), .c(new_n40_), .O(new_n43_));
  oai22  g26(.a(new_n42_), .b(x1), .c(new_n19_), .d(x5), .O(new_n44_));
  ...
  nand3  g34(.a(new_n51_), .b(new_n19_), .c(new_n28_), .O(new_n52_));
  inv1   g35(.a(new_n25_), .O(new_n53_));
  inv1   g36(.a(x2), .O(new_n54_));
  nand3  g37(.a(x6), .b(new_n54_), .c(new_n22_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n28_), .c(x5), .O(new_n56_));
  aoi21  g39(.a(new_n53_), .b(x4), .c(new_n56_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n52_), .c(new_n45_), .O(z2));
  nand2  g41(.a(new_n19_), .b(new_n22_), .O(new_n59_));
  nor2   g42(.a(x5), .b(x4), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(x3), .c(new_n18_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n50_), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n59_), .c(x2), .O(new_n63_));
  oai21  g46(.a(x6), .b(x3), .c(x5), .O(new_n64_));
  nand4  g47(.a(x6), .b(new_n34_), .c(new_n28_), .d(new_n18_), .O(new_n65_));
  oai21  g48(.a(new_n64_), .b(new_n18_), .c(new_n65_), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(x1), .O(new_n67_));
  and2   g50(.a(x6), .b(x2), .O(new_n68_));
  nand2  g51(.a(x5), .b(new_n18_), .O(new_n69_));
  nand3  g52(.a(new_n34_), .b(new_n28_), .c(x0), .O(new_n70_));
  ...
  oai21  g57(.a(new_n74_), .b(new_n71_), .c(new_n22_), .O(new_n75_));
  nand3  g58(.a(new_n23_), .b(x5), .c(new_n18_), .O(new_n76_));
  nand2  g59(.a(new_n54_), .b(x0), .O(new_n77_));
  nand2  g60(.a(new_n60_), .b(new_n72_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n77_), .c(new_n76_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n19_), .O(new_n80_));
  nand4  g63(.a(new_n80_), .b(new_n75_), .c(new_n67_), .d(new_n63_), .O(z3));
  aoi21  g64(.a(new_n46_), .b(new_n23_), .c(new_n19_), .O(new_n82_));
  nand2  g65(.a(new_n72_), .b(new_n54_), .O(new_n83_));
  nand2  g66(.a(new_n23_), .b(new_n18_), .O(new_n84_));
  ...
  nor3   g70(.a(new_n87_), .b(x6), .c(new_n54_), .O(new_n88_));
  inv1   g71(.a(new_n87_), .O(new_n89_));
  aoi21  g72(.a(new_n89_), .b(x2), .c(new_n19_), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n88_), .c(new_n22_), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n86_), .c(new_n30_), .O(z4));
  nand2  g75(.a(x3), .b(new_n54_), .O(new_n93_));
  nand2  g76(.a(new_n72_), .b(x2), .O(new_n94_));
  ...
  oai21  g80(.a(new_n97_), .b(new_n40_), .c(x0), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n96_), .c(new_n30_), .O(z5));
  nand2  g82(.a(new_n93_), .b(x1), .O(new_n100_));
  nand3  g83(.a(x3), .b(new_n54_), .c(new_n22_), .O(new_n101_));
  aoi21  g84(.a(new_n101_), .b(new_n100_), .c(new_n29_), .O(z6));
  nand3  g85(.a(new_n94_), .b(new_n93_), .c(new_n30_), .O(z7));
  nor2   g86(.a(new_n29_), .b(x3), .O(z8));
  nand2  g87(.a(new_n37_), .b(new_n18_), .O(new_n105_));
