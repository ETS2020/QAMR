...
module FAU ( 
  ...
  nand2  g49(.a(new_n56_), .b(new_n30_), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(x5), .c(x0), .O(new_n68_));
  nand3  g51(.a(new_n20_), .b(x3), .c(x2), .O(new_n69_));
  ...
  aoi21  g58(.a(new_n75_), .b(new_n20_), .c(new_n25_), .O(new_n76_));
  aoi21  g59(.a(new_n72_), .b(x1), .c(new_n76_), .O(new_n77_));
  nand4  g60(.a(new_n77_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(z3));
  aoi21  g61(.a(new_n44_), .b(new_n73_), .c(new_n25_), .O(new_n79_));
  ...
  nor3   g66(.a(new_n83_), .b(x6), .c(new_n30_), .O(new_n84_));
  nor2   g67(.a(new_n83_), .b(new_n30_), .O(new_n85_));
  nor2   g68(.a(new_n85_), .b(new_n25_), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n84_), .c(new_n29_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n82_), .c(new_n27_), .O(z4));
  nand2  g71(.a(x3), .b(new_n30_), .O(new_n89_));
  nand2  g72(.a(new_n56_), .b(x2), .O(new_n90_));
  oai21  g73(.a(new_n89_), .b(new_n29_), .c(new_n90_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n19_), .O(new_n92_));
  aoi21  g75(.a(x3), .b(x1), .c(x2), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n74_), .c(x0), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n92_), .c(new_n27_), .O(z5));
  nand2  g78(.a(new_n89_), .b(x1), .O(new_n96_));
  nand3  g79(.a(x3), .b(new_n30_), .c(new_n29_), .O(new_n97_));
  aoi21  g80(.a(new_n97_), .b(new_n96_), .c(new_n26_), .O(z6));
  nand3  g81(.a(new_n90_), .b(new_n89_), .c(new_n27_), .O(z7));
  nand2  g82(.a(new_n27_), .b(x3), .O(z8));
  nand2  g83(.a(new_n21_), .b(new_n19_), .O(new_n101_));
  nand4  g84(.a(new_n101_), .b(new_n25_), .c(x5), .d(x4), .O(new_n102_));
