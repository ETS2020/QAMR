...
module FAU ( 
  ...
  oai21  g84(.a(new_n101_), .b(new_n93_), .c(x0), .O(new_n102_));
  nand2  g85(.a(x6), .b(new_n18_), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n102_), .c(new_n100_), .O(z5));
  aoi21  g87(.a(x3), .b(new_n43_), .c(x6), .O(new_n105_));
  nand3  g88(.a(new_n29_), .b(x3), .c(new_n18_), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(x1), .O(new_n107_));
  oai21  g90(.a(new_n105_), .b(x2), .c(new_n107_), .O(z6));
  oai21  g91(.a(x3), .b(new_n18_), .c(new_n106_), .O(z7));
  nand2  g92(.a(new_n103_), .b(x3), .O(z8));
