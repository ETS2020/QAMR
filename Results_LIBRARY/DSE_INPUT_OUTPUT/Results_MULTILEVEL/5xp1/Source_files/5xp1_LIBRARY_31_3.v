...
module FAU ( 
  ...
  nand2  g023(.a(x6), .b(new_n40_), .O(new_n41_));
  ...
  nand3  g029(.a(x6), .b(x4), .c(new_n40_), .O(new_n47_));
  ...
  nand2  g035(.a(new_n32_), .b(new_n40_), .O(new_n53_));
  ...
  oai21  g044(.a(x6), .b(new_n39_), .c(new_n40_), .O(new_n62_));
  ...
  nand4  g061(.a(new_n25_), .b(new_n40_), .c(new_n39_), .d(x0), .O(new_n79_));
  ...
  nand2  g067(.a(new_n39_), .b(new_n29_), .O(new_n85_));
  nand3  g068(.a(new_n85_), .b(x6), .c(x5), .O(new_n86_));
  nand3  g069(.a(new_n25_), .b(new_n39_), .c(new_n29_), .O(new_n87_));
  aoi21  g070(.a(new_n87_), .b(new_n86_), .c(new_n19_), .O(new_n88_));
  oai21  g071(.a(new_n88_), .b(new_n84_), .c(new_n40_), .O(new_n89_));
  nand2  g072(.a(new_n89_), .b(new_n81_), .O(z3));
  nand3  g073(.a(x6), .b(new_n40_), .c(x1), .O(new_n91_));
  nand2  g074(.a(new_n20_), .b(new_n29_), .O(new_n92_));
  aoi21  g075(.a(new_n92_), .b(new_n91_), .c(new_n19_), .O(new_n93_));
  nor2   g076(.a(x6), .b(new_n40_), .O(new_n94_));
  nand2  g077(.a(new_n94_), .b(new_n29_), .O(new_n95_));
  inv1   g078(.a(new_n95_), .O(new_n96_));
  oai21  g079(.a(new_n96_), .b(new_n93_), .c(x2), .O(new_n97_));
  xor2a  g080(.a(x6), .b(x1), .O(new_n98_));
  nand2  g081(.a(x2), .b(x0), .O(new_n99_));
  nand3  g082(.a(new_n99_), .b(new_n98_), .c(new_n40_), .O(new_n100_));
  nand4  g083(.a(new_n20_), .b(new_n39_), .c(x1), .d(new_n19_), .O(new_n101_));
  ...
  oai21  g087(.a(x2), .b(new_n29_), .c(new_n20_), .O(new_n105_));
  nand3  g088(.a(new_n105_), .b(x3), .c(new_n19_), .O(new_n106_));
  nand2  g089(.a(new_n94_), .b(x1), .O(new_n107_));
  nand3  g090(.a(new_n107_), .b(new_n39_), .c(x0), .O(new_n108_));
  nand3  g091(.a(new_n108_), .b(new_n106_), .c(new_n104_), .O(z5));
  nand2  g092(.a(new_n85_), .b(new_n20_), .O(new_n110_));
  nand2  g093(.a(new_n110_), .b(x3), .O(new_n111_));
  inv1   g094(.a(new_n94_), .O(z8));
  oai21  g095(.a(z8), .b(x2), .c(x1), .O(new_n113_));
  nand2  g096(.a(new_n113_), .b(new_n111_), .O(z6));
  nand2  g097(.a(x3), .b(new_n39_), .O(new_n115_));
  oai21  g098(.a(new_n94_), .b(new_n39_), .c(new_n115_), .O(z7));
  nand4  g099(.a(x5), .b(x4), .c(x2), .d(x1), .O(new_n117_));
  nand2  g100(.a(new_n117_), .b(new_n20_), .O(new_n118_));
  nand2  g101(.a(new_n118_), .b(x3), .O(new_n119_));
  nand2  g102(.a(new_n20_), .b(new_n19_), .O(new_n120_));
