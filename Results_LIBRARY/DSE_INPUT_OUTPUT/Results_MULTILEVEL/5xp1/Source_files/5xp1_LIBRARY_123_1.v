...
module FAU ( 
  ...
  nor2   g090(.a(x6), .b(x3), .O(new_n108_));
  inv1   g091(.a(new_n108_), .O(new_n109_));
  oai22  g092(.a(new_n109_), .b(new_n44_), .c(new_n107_), .d(new_n35_), .O(new_n110_));
  ...
  oai21  g099(.a(new_n108_), .b(new_n116_), .c(x1), .O(new_n117_));
  oai21  g100(.a(new_n107_), .b(x1), .c(new_n117_), .O(z6));
  nand2  g101(.a(z8), .b(x2), .O(new_n119_));
  oai21  g102(.a(new_n108_), .b(x2), .c(new_n119_), .O(z7));
  oai22  g103(.a(new_n24_), .b(z8), .c(x6), .d(new_n23_), .O(new_n121_));
