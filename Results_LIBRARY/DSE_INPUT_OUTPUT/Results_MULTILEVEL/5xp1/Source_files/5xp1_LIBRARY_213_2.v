...
module FAU ( 
  ...
  aoi22  g59(.a(new_n76_), .b(new_n56_), .c(new_n74_), .d(x6), .O(new_n77_));
  nor2   g60(.a(x3), .b(x0), .O(new_n78_));
  nor2   g61(.a(new_n78_), .b(x6), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n56_), .c(x2), .O(new_n80_));
  oai21  g63(.a(new_n78_), .b(new_n30_), .c(x6), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n20_), .O(new_n83_));
  oai21  g66(.a(new_n77_), .b(new_n20_), .c(new_n83_), .O(z4));
  nor2   g67(.a(x6), .b(new_n56_), .O(new_n85_));
  ...
  aoi21  g74(.a(new_n91_), .b(new_n89_), .c(new_n85_), .O(z5));
  nand2  g75(.a(new_n86_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n30_), .c(new_n20_), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n93_), .c(new_n85_), .O(z6));
  inv1   g78(.a(new_n85_), .O(new_n96_));
  nand3  g79(.a(new_n87_), .b(new_n86_), .c(new_n96_), .O(z7));
  nor2   g80(.a(new_n85_), .b(x3), .O(z8));
