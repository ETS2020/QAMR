...
module FAU ( 
  ...
  nand3  g84(.a(x3), .b(new_n78_), .c(new_n25_), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(new_n101_), .c(new_n93_), .O(z6));
  inv1   g86(.a(new_n93_), .O(new_n104_));
  nand3  g87(.a(new_n95_), .b(new_n94_), .c(new_n104_), .O(z7));
  nor2   g88(.a(new_n93_), .b(x3), .O(z8));
  nand3  g89(.a(new_n49_), .b(x5), .c(x4), .O(new_n107_));
  nand2  g90(.a(new_n107_), .b(new_n104_), .O(z9));
endmodule
