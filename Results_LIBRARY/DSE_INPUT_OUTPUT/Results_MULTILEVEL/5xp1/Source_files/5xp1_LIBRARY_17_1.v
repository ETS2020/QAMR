...
module FAU ( 
  ...
  inv1   g77(.a(new_n42_), .O(new_n95_));
  nand2  g78(.a(x3), .b(new_n32_), .O(new_n96_));
  nand2  g79(.a(new_n33_), .b(x2), .O(new_n97_));
  oai21  g80(.a(new_n96_), .b(new_n23_), .c(new_n97_), .O(new_n98_));
  ...
  nand3  g85(.a(new_n102_), .b(new_n99_), .c(new_n95_), .O(z5));
  ...
  nand3  g89(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(z7));
  nand2  g90(.a(new_n95_), .b(x3), .O(z8));
  aoi21  g91(.a(new_n20_), .b(new_n18_), .c(new_n29_), .O(new_n109_));
  oai21  g92(.a(new_n109_), .b(x6), .c(x4), .O(new_n110_));
  nand2  g93(.a(new_n110_), .b(new_n95_), .O(z9));
endmodule
