...
module FAU ( 
  ...
  nand2  g24(.a(new_n25_), .b(new_n20_), .O(new_n42_));
  nor2   g25(.a(x5), .b(x2), .O(new_n43_));
  aoi21  g26(.a(x3), .b(x2), .c(x0), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n43_), .c(new_n21_), .O(new_n45_));
  ...
  oai21  g40(.a(x4), .b(new_n21_), .c(new_n18_), .O(new_n58_));
  nand3  g41(.a(new_n25_), .b(x3), .c(new_n20_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n54_), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n58_), .c(x2), .O(new_n61_));
  oai21  g44(.a(x4), .b(new_n49_), .c(new_n18_), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(x1), .c(x0), .O(new_n63_));
  inv1   g46(.a(new_n63_), .O(new_n64_));
  nor2   g47(.a(new_n18_), .b(x1), .O(new_n65_));
  nor2   g48(.a(x6), .b(x4), .O(new_n66_));
  oai21  g49(.a(new_n66_), .b(new_n65_), .c(new_n22_), .O(new_n67_));
  nand2  g50(.a(new_n66_), .b(new_n21_), .O(new_n68_));
  aoi21  g51(.a(new_n68_), .b(new_n67_), .c(x0), .O(new_n69_));
  oai21  g52(.a(new_n69_), .b(new_n64_), .c(x5), .O(new_n70_));
  nand2  g53(.a(new_n18_), .b(new_n19_), .O(new_n71_));
  ...
  nand3  g59(.a(x6), .b(x1), .c(new_n20_), .O(new_n77_));
  ...
  aoi21  g63(.a(new_n51_), .b(new_n22_), .c(new_n18_), .O(new_n81_));
  inv1   g64(.a(new_n44_), .O(new_n82_));
  aoi21  g65(.a(new_n50_), .b(new_n82_), .c(x6), .O(new_n83_));
  aoi21  g66(.a(new_n83_), .b(new_n19_), .c(new_n81_), .O(new_n84_));
  nor2   g67(.a(x3), .b(x0), .O(new_n85_));
  nor2   g68(.a(new_n85_), .b(x6), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n19_), .c(x2), .O(new_n87_));
  ...
  oai21  g73(.a(new_n84_), .b(new_n21_), .c(new_n90_), .O(z4));
  ...
  inv1   g78(.a(new_n22_), .O(new_n96_));
  aoi21  g79(.a(x3), .b(x1), .c(x2), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(new_n96_), .c(x0), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(new_n95_), .c(new_n34_), .O(z5));
  nand2  g82(.a(new_n92_), .b(x1), .O(new_n100_));
  nand3  g83(.a(x3), .b(new_n48_), .c(new_n21_), .O(new_n101_));
