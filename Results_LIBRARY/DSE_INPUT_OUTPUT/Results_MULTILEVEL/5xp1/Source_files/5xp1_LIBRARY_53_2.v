...
module FAU ( 
  ...
  wire new_n18_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_,
    ...
    new_n102_, new_n104_, new_n106_, new_n107_;
  ...
  oai21  g47(.a(x3), .b(new_n60_), .c(new_n40_), .O(new_n65_));
  ...
  nand3  g63(.a(x6), .b(z8), .c(new_n24_), .O(new_n81_));
  oai21  g64(.a(x6), .b(new_n24_), .c(new_n81_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n23_), .O(new_n83_));
  nand3  g66(.a(new_n40_), .b(x2), .c(x0), .O(new_n84_));
  inv1   g67(.a(new_n84_), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n68_), .c(new_n24_), .O(new_n86_));
  aoi21  g69(.a(new_n30_), .b(z8), .c(new_n23_), .O(new_n87_));
  oai21  g70(.a(x6), .b(x2), .c(new_n25_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n87_), .c(x1), .O(new_n89_));
  nand4  g72(.a(new_n89_), .b(new_n86_), .c(new_n83_), .d(new_n41_), .O(z4));
  xnor2a g73(.a(x3), .b(x0), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(x2), .O(new_n92_));
  oai21  g75(.a(x2), .b(new_n24_), .c(x6), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(x3), .c(new_n23_), .O(new_n94_));
  ...
  nand3  g81(.a(new_n98_), .b(new_n94_), .c(new_n92_), .O(z5));
  nand2  g82(.a(new_n30_), .b(x3), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(x1), .O(new_n101_));
  nand3  g84(.a(new_n96_), .b(new_n60_), .c(new_n24_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n101_), .O(z6));
  nand2  g86(.a(x3), .b(new_n60_), .O(new_n104_));
  oai21  g87(.a(new_n96_), .b(new_n60_), .c(new_n104_), .O(z7));
  oai21  g88(.a(x3), .b(new_n23_), .c(new_n40_), .O(new_n106_));
