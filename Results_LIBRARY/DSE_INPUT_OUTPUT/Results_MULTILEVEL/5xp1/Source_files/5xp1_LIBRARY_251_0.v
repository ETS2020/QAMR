...
module FAU ( 
  ...
  aoi21  g70(.a(new_n87_), .b(new_n21_), .c(new_n20_), .O(new_n88_));
  nor2   g71(.a(x3), .b(x2), .O(new_n89_));
  nor2   g72(.a(new_n89_), .b(new_n26_), .O(new_n90_));
  ...
  nand2  g79(.a(new_n53_), .b(x2), .O(new_n97_));
  oai21  g80(.a(new_n96_), .b(new_n18_), .c(new_n97_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n19_), .O(new_n99_));
  oai21  g82(.a(x2), .b(new_n19_), .c(x6), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n18_), .O(new_n101_));
  oai21  g84(.a(new_n89_), .b(new_n33_), .c(x0), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n101_), .c(new_n99_), .O(z5));
  nand2  g86(.a(new_n96_), .b(x1), .O(new_n104_));
  nand4  g87(.a(x6), .b(x3), .c(new_n41_), .d(new_n18_), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(new_n104_), .O(z6));
  nand3  g89(.a(new_n97_), .b(new_n96_), .c(new_n83_), .O(z7));
  nor2   g90(.a(new_n30_), .b(x3), .O(z8));
  oai21  g91(.a(new_n26_), .b(new_n18_), .c(new_n20_), .O(new_n109_));
