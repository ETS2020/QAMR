...
module FAU ( 
  ...
  nor2   g64(.a(new_n19_), .b(x5), .O(new_n82_));
  ...
  oai21  g72(.a(new_n89_), .b(new_n40_), .c(x0), .O(new_n90_));
  aoi21  g73(.a(new_n90_), .b(new_n88_), .c(new_n82_), .O(z5));
  nand2  g74(.a(new_n85_), .b(x1), .O(new_n92_));
  nand3  g75(.a(x3), .b(new_n32_), .c(new_n23_), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(new_n92_), .c(new_n82_), .O(z6));
  aoi21  g77(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(z7));
  nor2   g78(.a(new_n82_), .b(x3), .O(z8));
  aoi21  g79(.a(new_n20_), .b(new_n18_), .c(new_n29_), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(x6), .c(x4), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n83_), .O(z9));
endmodule
