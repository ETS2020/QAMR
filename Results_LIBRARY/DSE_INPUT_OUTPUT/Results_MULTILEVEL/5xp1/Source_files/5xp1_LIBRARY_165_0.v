...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n100_, new_n102_, new_n103_, new_n104_, new_n108_;
  ...
  aoi21  g68(.a(new_n85_), .b(x5), .c(new_n83_), .O(new_n86_));
  nor2   g69(.a(x3), .b(x0), .O(new_n87_));
  nor2   g70(.a(new_n87_), .b(x6), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(x5), .c(x2), .O(new_n89_));
  oai21  g72(.a(new_n87_), .b(new_n79_), .c(x6), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n23_), .O(new_n92_));
  oai21  g75(.a(new_n86_), .b(new_n23_), .c(new_n92_), .O(z4));
  nor2   g76(.a(x6), .b(x5), .O(new_n94_));
  ...
  aoi21  g83(.a(new_n100_), .b(new_n98_), .c(new_n94_), .O(z5));
  inv1   g84(.a(new_n94_), .O(new_n102_));
  nand2  g85(.a(new_n95_), .b(x1), .O(new_n103_));
  nand3  g86(.a(x3), .b(new_n79_), .c(new_n23_), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n103_), .c(new_n102_), .O(z6));
  aoi21  g88(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(z7));
  nor2   g89(.a(new_n94_), .b(x3), .O(z8));
  nand3  g90(.a(new_n49_), .b(x5), .c(x4), .O(new_n108_));
  nand2  g91(.a(new_n108_), .b(new_n102_), .O(z9));
endmodule
