...
module FAU ( 
  ...
  nand3  g76(.a(x6), .b(new_n79_), .c(x2), .O(new_n94_));
  ...
  nand3  g80(.a(x6), .b(x3), .c(x2), .O(new_n98_));
  ...
  oai21  g85(.a(new_n102_), .b(new_n34_), .c(x1), .O(new_n103_));
  oai21  g86(.a(new_n93_), .b(x1), .c(new_n103_), .O(z6));
  nand2  g87(.a(new_n94_), .b(new_n93_), .O(z7));
  oai21  g88(.a(x6), .b(new_n33_), .c(x3), .O(z8));
  oai21  g89(.a(x2), .b(new_n24_), .c(new_n30_), .O(new_n107_));
