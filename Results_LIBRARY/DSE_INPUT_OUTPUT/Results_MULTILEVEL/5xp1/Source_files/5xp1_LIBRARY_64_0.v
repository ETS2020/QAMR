...
module FAU ( 
  ...
  nand2  g77(.a(x3), .b(new_n83_), .O(new_n95_));
  ...
  nand3  g85(.a(x3), .b(new_n83_), .c(new_n23_), .O(new_n103_));
  aoi21  g86(.a(new_n103_), .b(new_n102_), .c(new_n94_), .O(z6));
  aoi21  g87(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(z7));
  nor2   g88(.a(new_n94_), .b(x3), .O(z8));
  inv1   g89(.a(new_n94_), .O(new_n107_));
  nand3  g90(.a(new_n51_), .b(x5), .c(x4), .O(new_n108_));
  nand2  g91(.a(new_n108_), .b(new_n107_), .O(z9));
endmodule
