...
module FAU ( 
  ...
  oai21  g52(.a(x3), .b(new_n34_), .c(new_n30_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(x1), .O(new_n71_));
  aoi21  g54(.a(new_n71_), .b(new_n69_), .c(new_n29_), .O(new_n72_));
  nor2   g55(.a(new_n30_), .b(x2), .O(new_n73_));
  oai21  g56(.a(new_n42_), .b(new_n73_), .c(new_n25_), .O(new_n74_));
  nand2  g57(.a(new_n42_), .b(new_n34_), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(new_n74_), .c(x5), .O(new_n76_));
  oai21  g59(.a(new_n76_), .b(new_n72_), .c(x0), .O(new_n77_));
  aoi21  g60(.a(new_n40_), .b(new_n25_), .c(new_n42_), .O(new_n78_));
  nand2  g61(.a(x3), .b(x2), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n25_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(x6), .c(new_n29_), .O(new_n81_));
  oai21  g64(.a(new_n78_), .b(new_n29_), .c(new_n81_), .O(new_n82_));
  ...
  nand3  g70(.a(new_n30_), .b(x2), .c(x0), .O(new_n88_));
  inv1   g71(.a(new_n88_), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n73_), .c(new_n25_), .O(new_n90_));
  aoi21  g73(.a(new_n69_), .b(z8), .c(new_n24_), .O(new_n91_));
  oai21  g74(.a(x6), .b(x2), .c(new_n79_), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n91_), .c(x1), .O(new_n93_));
  nand2  g76(.a(new_n30_), .b(x3), .O(new_n94_));
  nand4  g77(.a(new_n94_), .b(new_n93_), .c(new_n90_), .d(new_n87_), .O(z4));
  nand2  g78(.a(new_n34_), .b(x1), .O(new_n96_));
  nand2  g79(.a(x6), .b(x3), .O(new_n97_));
  oai22  g80(.a(new_n97_), .b(new_n96_), .c(x3), .d(new_n34_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n24_), .O(new_n99_));
  aoi21  g82(.a(new_n34_), .b(x1), .c(new_n30_), .O(new_n100_));
  nor2   g83(.a(x3), .b(x2), .O(new_n101_));
  aoi21  g84(.a(new_n100_), .b(x3), .c(new_n101_), .O(new_n102_));
  oai21  g85(.a(new_n102_), .b(new_n24_), .c(new_n99_), .O(z5));
  aoi21  g86(.a(new_n34_), .b(new_n25_), .c(new_n30_), .O(new_n104_));
  oai21  g87(.a(new_n97_), .b(x2), .c(x1), .O(new_n105_));
  oai21  g88(.a(new_n104_), .b(z8), .c(new_n105_), .O(z6));
  nand2  g89(.a(new_n97_), .b(x2), .O(new_n107_));
  oai21  g90(.a(z8), .b(x2), .c(new_n107_), .O(z7));
  oai21  g91(.a(new_n22_), .b(new_n18_), .c(new_n94_), .O(z9));
endmodule
