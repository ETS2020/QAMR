...
module FAU ( 
  ...
  nand2  g77(.a(new_n46_), .b(x2), .O(new_n95_));
  ...
  oai21  g81(.a(new_n98_), .b(new_n64_), .c(x0), .O(new_n99_));
  aoi21  g82(.a(new_n99_), .b(new_n97_), .c(new_n91_), .O(z5));
  nand2  g83(.a(new_n94_), .b(x1), .O(new_n101_));
  nand3  g84(.a(x3), .b(new_n28_), .c(new_n20_), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(new_n101_), .c(new_n91_), .O(z6));
  aoi21  g86(.a(new_n95_), .b(new_n94_), .c(new_n91_), .O(z7));
  nor2   g87(.a(new_n91_), .b(x3), .O(z8));
