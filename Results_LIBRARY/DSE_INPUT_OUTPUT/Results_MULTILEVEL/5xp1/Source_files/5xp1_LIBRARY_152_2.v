...
module FAU ( 
  ...
  nand2  g52(.a(new_n65_), .b(new_n69_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(x0), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n24_), .c(x6), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(x1), .O(new_n73_));
  nand3  g56(.a(new_n66_), .b(new_n31_), .c(x2), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(new_n73_), .c(new_n68_), .O(z4));
  nand2  g58(.a(new_n31_), .b(x1), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n65_), .c(x2), .O(new_n77_));
  nand4  g60(.a(x6), .b(x3), .c(new_n69_), .d(x1), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n23_), .O(new_n80_));
  aoi21  g63(.a(new_n65_), .b(x2), .c(x1), .O(new_n81_));
  aoi21  g64(.a(new_n70_), .b(new_n24_), .c(new_n31_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n81_), .c(x0), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n80_), .O(z5));
  nand2  g67(.a(x3), .b(new_n69_), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(x6), .c(x1), .O(new_n86_));
  oai21  g69(.a(new_n85_), .b(x1), .c(new_n86_), .O(z6));
  nand2  g70(.a(new_n65_), .b(x2), .O(new_n88_));
  nand3  g71(.a(new_n85_), .b(new_n88_), .c(new_n76_), .O(z7));
  nand2  g72(.a(new_n76_), .b(x3), .O(z8));
  oai21  g73(.a(x6), .b(x0), .c(x5), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n18_), .c(new_n76_), .O(z9));
endmodule
