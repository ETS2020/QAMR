...
module FAU ( 
  ...
  nand3  g45(.a(new_n29_), .b(x3), .c(new_n18_), .O(new_n63_));
  aoi21  g46(.a(new_n63_), .b(new_n45_), .c(new_n32_), .O(new_n64_));
  aoi21  g47(.a(new_n48_), .b(new_n19_), .c(new_n18_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n64_), .c(x1), .O(new_n66_));
  aoi21  g49(.a(new_n34_), .b(x1), .c(x5), .O(new_n67_));
  nor2   g50(.a(new_n19_), .b(new_n32_), .O(new_n68_));
  oai21  g51(.a(new_n68_), .b(new_n67_), .c(x0), .O(new_n69_));
  inv1   g52(.a(new_n24_), .O(new_n70_));
  nand2  g53(.a(x6), .b(new_n23_), .O(new_n71_));
  nand2  g54(.a(new_n19_), .b(x5), .O(new_n72_));
  aoi21  g55(.a(new_n72_), .b(new_n71_), .c(new_n70_), .O(new_n73_));
  nand3  g56(.a(new_n19_), .b(x5), .c(new_n23_), .O(new_n74_));
  inv1   g57(.a(new_n74_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n73_), .c(new_n18_), .O(new_n76_));
  nand4  g59(.a(new_n76_), .b(new_n69_), .c(new_n66_), .d(new_n62_), .O(z3));
  aoi21  g60(.a(new_n51_), .b(new_n24_), .c(new_n19_), .O(new_n78_));
  nand2  g61(.a(new_n24_), .b(new_n18_), .O(new_n79_));
  ...
  oai21  g68(.a(new_n85_), .b(new_n83_), .c(new_n23_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n81_), .c(new_n62_), .O(z4));
  nand2  g70(.a(x3), .b(new_n32_), .O(new_n88_));
  nand2  g71(.a(new_n33_), .b(x2), .O(new_n89_));
  oai21  g72(.a(new_n88_), .b(new_n23_), .c(new_n89_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n18_), .O(new_n91_));
  aoi21  g74(.a(x3), .b(x1), .c(x2), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n70_), .c(x0), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(new_n91_), .c(new_n42_), .O(z5));
  nand2  g77(.a(new_n88_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n32_), .c(new_n23_), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n95_), .c(new_n42_), .O(z6));
  nand3  g80(.a(new_n89_), .b(new_n88_), .c(new_n62_), .O(z7));
  nor2   g81(.a(new_n42_), .b(x3), .O(z8));
  aoi21  g82(.a(new_n20_), .b(new_n18_), .c(new_n29_), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(x6), .c(x4), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(new_n62_), .O(z9));
endmodule
