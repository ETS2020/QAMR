...
module FAU ( 
  ...
  oai22  g13(.a(new_n30_), .b(new_n27_), .c(new_n29_), .d(new_n28_), .O(new_n31_));
  aoi22  g14(.a(new_n31_), .b(x0), .c(x6), .d(x4), .O(new_n32_));
  inv1   g15(.a(x6), .O(new_n33_));
  oai21  g16(.a(new_n22_), .b(x0), .c(x4), .O(new_n34_));
  ...
  nand3  g21(.a(new_n38_), .b(new_n33_), .c(x0), .O(new_n39_));
  nand3  g22(.a(x5), .b(x3), .c(x2), .O(new_n40_));
  aoi21  g23(.a(new_n40_), .b(new_n39_), .c(new_n27_), .O(new_n41_));
  nor2   g24(.a(x2), .b(x1), .O(new_n42_));
  oai21  g25(.a(new_n42_), .b(new_n19_), .c(x6), .O(new_n43_));
  ...
  nor3   g29(.a(new_n42_), .b(new_n33_), .c(new_n19_), .O(new_n47_));
  nand2  g30(.a(new_n44_), .b(new_n27_), .O(new_n48_));
  oai21  g31(.a(x5), .b(x3), .c(x0), .O(new_n49_));
  aoi21  g32(.a(x5), .b(x3), .c(x0), .O(new_n50_));
  aoi21  g33(.a(new_n49_), .b(new_n28_), .c(new_n50_), .O(new_n51_));
  aoi21  g34(.a(new_n51_), .b(new_n48_), .c(x6), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n47_), .c(x4), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n46_), .c(new_n25_), .O(z2));
  inv1   g37(.a(x3), .O(new_n55_));
  nor2   g38(.a(new_n20_), .b(x0), .O(new_n56_));
  nand4  g39(.a(new_n33_), .b(new_n20_), .c(new_n28_), .d(x0), .O(new_n57_));
  inv1   g40(.a(new_n57_), .O(new_n58_));
  oai21  g41(.a(new_n58_), .b(new_n56_), .c(new_n55_), .O(new_n59_));
  nand3  g42(.a(new_n20_), .b(new_n27_), .c(x0), .O(new_n60_));
  inv1   g43(.a(new_n60_), .O(new_n61_));
  oai21  g44(.a(new_n61_), .b(new_n56_), .c(new_n28_), .O(new_n62_));
  nand3  g45(.a(new_n33_), .b(new_n20_), .c(x0), .O(new_n63_));
  inv1   g46(.a(new_n63_), .O(new_n64_));
  oai21  g47(.a(new_n64_), .b(new_n56_), .c(new_n27_), .O(new_n65_));
  nand3  g48(.a(new_n38_), .b(x5), .c(x0), .O(new_n66_));
  nand3  g49(.a(new_n20_), .b(x3), .c(x2), .O(new_n67_));
  ...
  aoi21  g56(.a(new_n73_), .b(new_n20_), .c(new_n33_), .O(new_n74_));
  aoi21  g57(.a(new_n70_), .b(x1), .c(new_n74_), .O(new_n75_));
  nand4  g58(.a(new_n75_), .b(new_n65_), .c(new_n62_), .d(new_n59_), .O(z3));
  oai21  g59(.a(new_n37_), .b(new_n19_), .c(new_n71_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(x6), .c(new_n20_), .O(new_n78_));
  aoi21  g61(.a(new_n71_), .b(new_n19_), .c(new_n37_), .O(new_n79_));
  ...
  nand3  g65(.a(new_n82_), .b(new_n33_), .c(x2), .O(new_n83_));
  nand2  g66(.a(new_n82_), .b(x2), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(x6), .c(new_n20_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n27_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n81_), .O(z4));
  nand2  g71(.a(x3), .b(new_n28_), .O(new_n89_));
  nand2  g72(.a(new_n55_), .b(x2), .O(new_n90_));
  oai21  g73(.a(new_n89_), .b(new_n27_), .c(new_n90_), .O(new_n91_));
  ...
  nand3  g77(.a(new_n94_), .b(new_n92_), .c(new_n25_), .O(z5));
  nand2  g78(.a(new_n89_), .b(x1), .O(new_n96_));
  nand3  g79(.a(x3), .b(new_n28_), .c(new_n27_), .O(new_n97_));
  nand3  g80(.a(new_n97_), .b(new_n96_), .c(new_n25_), .O(z6));
  nand3  g81(.a(new_n90_), .b(new_n89_), .c(new_n25_), .O(z7));
  nand2  g82(.a(new_n25_), .b(x3), .O(z8));
  nand2  g83(.a(new_n21_), .b(new_n19_), .O(new_n101_));
  nand4  g84(.a(new_n101_), .b(new_n33_), .c(x5), .d(x4), .O(new_n102_));
