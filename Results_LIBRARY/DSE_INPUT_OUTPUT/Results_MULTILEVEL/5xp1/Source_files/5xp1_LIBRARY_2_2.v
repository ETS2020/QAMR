...
module FAU ( 
  ...
  inv1   g64(.a(x3), .O(z8));
  nand3  g65(.a(x6), .b(z8), .c(new_n25_), .O(new_n83_));
  oai21  g66(.a(x6), .b(new_n25_), .c(new_n83_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n24_), .O(new_n85_));
  nand3  g68(.a(new_n39_), .b(x2), .c(x0), .O(new_n86_));
  oai21  g69(.a(new_n39_), .b(x2), .c(new_n86_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n25_), .O(new_n88_));
  aoi21  g71(.a(new_n31_), .b(z8), .c(new_n24_), .O(new_n89_));
  nand2  g72(.a(new_n71_), .b(new_n37_), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n89_), .c(x1), .O(new_n91_));
  nand4  g74(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n44_), .O(z4));
  ...
  nand3  g80(.a(new_n97_), .b(new_n63_), .c(x0), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n96_), .c(new_n94_), .O(z5));
  aoi21  g82(.a(new_n63_), .b(new_n25_), .c(new_n39_), .O(new_n100_));
