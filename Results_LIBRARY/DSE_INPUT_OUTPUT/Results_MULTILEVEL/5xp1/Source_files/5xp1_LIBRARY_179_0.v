...
module FAU ( 
  ...
  aoi22  g83(.a(new_n100_), .b(x1), .c(new_n78_), .d(x2), .O(new_n101_));
  aoi21  g84(.a(new_n40_), .b(x1), .c(z8), .O(new_n102_));
  nand2  g85(.a(new_n78_), .b(new_n40_), .O(new_n103_));
  inv1   g86(.a(new_n103_), .O(new_n104_));
  oai21  g87(.a(new_n104_), .b(new_n102_), .c(x0), .O(new_n105_));
  oai21  g88(.a(new_n101_), .b(x0), .c(new_n105_), .O(z5));
  aoi21  g89(.a(new_n100_), .b(new_n23_), .c(new_n30_), .O(new_n107_));
  oai21  g90(.a(new_n100_), .b(new_n23_), .c(new_n107_), .O(z6));
  nand2  g91(.a(z8), .b(x2), .O(new_n109_));
  oai21  g92(.a(new_n78_), .b(x2), .c(new_n109_), .O(z7));
  aoi21  g93(.a(x2), .b(x1), .c(x0), .O(new_n111_));
  oai21  g94(.a(new_n111_), .b(z8), .c(new_n19_), .O(new_n112_));
