...
module FAU ( 
  ...
  nand3  g56(.a(new_n73_), .b(new_n37_), .c(x6), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(x1), .O(new_n75_));
  nand3  g58(.a(new_n70_), .b(new_n24_), .c(x2), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n75_), .c(new_n72_), .O(z4));
  nand2  g60(.a(x3), .b(new_n30_), .O(new_n78_));
  nand2  g61(.a(new_n65_), .b(x2), .O(new_n79_));
  ...
  inv1   g66(.a(new_n37_), .O(new_n84_));
  aoi21  g67(.a(x3), .b(x1), .c(x2), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n84_), .c(x0), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n83_), .c(new_n81_), .O(z5));
  nand3  g70(.a(new_n78_), .b(x6), .c(x1), .O(new_n88_));
  oai21  g71(.a(new_n78_), .b(x1), .c(new_n88_), .O(z6));
  aoi22  g72(.a(new_n79_), .b(new_n78_), .c(new_n24_), .d(x1), .O(z7));
  nand2  g73(.a(new_n56_), .b(x3), .O(z8));
  oai21  g74(.a(new_n21_), .b(new_n23_), .c(new_n56_), .O(z9));
endmodule
