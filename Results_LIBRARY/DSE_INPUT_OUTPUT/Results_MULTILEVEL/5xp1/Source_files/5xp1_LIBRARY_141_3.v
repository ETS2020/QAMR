...
module FAU ( 
  ...
  nand2  g53(.a(new_n35_), .b(x0), .O(new_n71_));
  aoi21  g54(.a(new_n71_), .b(new_n62_), .c(new_n20_), .O(new_n72_));
  nand2  g55(.a(new_n62_), .b(new_n19_), .O(new_n73_));
  aoi21  g56(.a(new_n73_), .b(new_n35_), .c(x6), .O(new_n74_));
  oai21  g57(.a(new_n74_), .b(new_n72_), .c(x1), .O(new_n75_));
  nor2   g58(.a(x3), .b(x0), .O(new_n76_));
  nor3   g59(.a(new_n76_), .b(x6), .c(new_n25_), .O(new_n77_));
  nor2   g60(.a(new_n76_), .b(new_n25_), .O(new_n78_));
  nor2   g61(.a(new_n78_), .b(new_n20_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n77_), .c(new_n24_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n75_), .c(new_n53_), .O(z4));
  nand2  g64(.a(x3), .b(new_n25_), .O(new_n82_));
  ...
  inv1   g68(.a(new_n62_), .O(new_n86_));
  aoi21  g69(.a(x3), .b(x1), .c(x2), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n86_), .c(x0), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n85_), .c(new_n53_), .O(z5));
  nand2  g72(.a(new_n82_), .b(x1), .O(new_n90_));
  nand3  g73(.a(x3), .b(new_n25_), .c(new_n24_), .O(new_n91_));
  aoi21  g74(.a(new_n91_), .b(new_n90_), .c(new_n52_), .O(z6));
  aoi21  g75(.a(new_n83_), .b(new_n82_), .c(new_n52_), .O(z7));
  nand2  g76(.a(new_n53_), .b(x3), .O(z8));
  nand4  g77(.a(new_n56_), .b(new_n20_), .c(x5), .d(x4), .O(new_n95_));
