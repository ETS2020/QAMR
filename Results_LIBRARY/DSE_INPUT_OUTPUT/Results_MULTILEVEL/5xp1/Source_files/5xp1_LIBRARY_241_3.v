...
module FAU ( 
  ...
  nand4  g39(.a(new_n25_), .b(new_n20_), .c(new_n30_), .d(x0), .O(new_n57_));
  inv1   g40(.a(new_n57_), .O(new_n58_));
  oai21  g41(.a(new_n58_), .b(new_n56_), .c(new_n38_), .O(new_n59_));
  nand3  g42(.a(new_n20_), .b(new_n29_), .c(x0), .O(new_n60_));
  inv1   g43(.a(new_n60_), .O(new_n61_));
  oai21  g44(.a(new_n61_), .b(new_n56_), .c(new_n30_), .O(new_n62_));
  nand3  g45(.a(new_n25_), .b(new_n20_), .c(x0), .O(new_n63_));
  inv1   g46(.a(new_n63_), .O(new_n64_));
  oai21  g47(.a(new_n64_), .b(new_n56_), .c(new_n29_), .O(new_n65_));
  nand3  g48(.a(new_n39_), .b(x5), .c(x0), .O(new_n66_));
  ...
  aoi21  g56(.a(new_n73_), .b(new_n20_), .c(new_n25_), .O(new_n74_));
  ...
  aoi21  g60(.a(new_n77_), .b(new_n71_), .c(new_n25_), .O(new_n78_));
  nand2  g61(.a(new_n71_), .b(new_n19_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n39_), .c(x6), .O(new_n80_));
  ...
  nor2   g67(.a(new_n84_), .b(new_n25_), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n83_), .c(new_n29_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n81_), .c(new_n27_), .O(z4));
  nand2  g70(.a(x3), .b(new_n30_), .O(new_n88_));
  nand2  g71(.a(new_n38_), .b(x2), .O(new_n89_));
  oai21  g72(.a(new_n88_), .b(new_n29_), .c(new_n89_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n19_), .O(new_n91_));
  aoi21  g74(.a(x3), .b(x1), .c(x2), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n72_), .c(x0), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(new_n91_), .c(new_n26_), .O(z5));
  nand2  g77(.a(new_n88_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n30_), .c(new_n29_), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n95_), .c(new_n26_), .O(z6));
  nand3  g80(.a(new_n89_), .b(new_n88_), .c(new_n27_), .O(z7));
  nand2  g81(.a(new_n27_), .b(x3), .O(z8));
  oai21  g82(.a(new_n22_), .b(x0), .c(x4), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(new_n25_), .c(new_n20_), .O(z9));
endmodule
