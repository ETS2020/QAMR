...
module FAU ( 
  ...
  aoi21  g92(.a(new_n109_), .b(new_n108_), .c(new_n45_), .O(z6));
  aoi21  g93(.a(new_n102_), .b(new_n101_), .c(new_n45_), .O(z7));
  nor2   g94(.a(new_n45_), .b(x3), .O(z8));
  nand2  g95(.a(new_n22_), .b(new_n18_), .O(new_n113_));
  nand4  g96(.a(new_n113_), .b(new_n19_), .c(x5), .d(x4), .O(new_n114_));
