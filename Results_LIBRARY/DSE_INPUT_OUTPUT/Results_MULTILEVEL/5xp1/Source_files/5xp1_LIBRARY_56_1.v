...
module FAU ( 
  ...
  oai21  g30(.a(new_n47_), .b(new_n39_), .c(x4), .O(new_n48_));
  ...
  nand3  g35(.a(new_n52_), .b(new_n21_), .c(new_n29_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n48_), .O(z2));
  nand2  g37(.a(new_n21_), .b(new_n40_), .O(new_n55_));
  nand3  g38(.a(new_n18_), .b(x3), .c(new_n20_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n41_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n55_), .c(x2), .O(new_n58_));
  oai21  g41(.a(x6), .b(x3), .c(x1), .O(new_n59_));
  nor2   g42(.a(new_n59_), .b(new_n20_), .O(new_n60_));
  nand2  g43(.a(x3), .b(x2), .O(new_n61_));
  nand2  g44(.a(x6), .b(x1), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  aoi21  g46(.a(new_n63_), .b(new_n55_), .c(x0), .O(new_n64_));
  oai21  g47(.a(new_n64_), .b(new_n60_), .c(x5), .O(new_n65_));
  oai21  g48(.a(new_n21_), .b(new_n43_), .c(new_n40_), .O(new_n66_));
  inv1   g49(.a(x3), .O(new_n67_));
  nand3  g50(.a(new_n21_), .b(new_n67_), .c(new_n43_), .O(new_n68_));
  aoi21  g51(.a(new_n68_), .b(new_n66_), .c(new_n20_), .O(new_n69_));
  nor2   g52(.a(new_n62_), .b(x0), .O(new_n70_));
  oai21  g53(.a(new_n70_), .b(new_n69_), .c(new_n18_), .O(new_n71_));
  nand4  g54(.a(new_n71_), .b(new_n65_), .c(new_n58_), .d(new_n27_), .O(z3));
  aoi21  g55(.a(new_n49_), .b(new_n61_), .c(new_n21_), .O(new_n73_));
  nand2  g56(.a(new_n67_), .b(new_n43_), .O(new_n74_));
  ...
  nor3   g61(.a(new_n78_), .b(x6), .c(new_n43_), .O(new_n79_));
  nor2   g62(.a(new_n78_), .b(new_n43_), .O(new_n80_));
  nor2   g63(.a(new_n80_), .b(new_n21_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n79_), .c(new_n40_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n77_), .c(new_n27_), .O(z4));
  nand2  g66(.a(x3), .b(new_n43_), .O(new_n84_));
  nand2  g67(.a(new_n67_), .b(x2), .O(new_n85_));
  oai21  g68(.a(new_n84_), .b(new_n40_), .c(new_n85_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n20_), .O(new_n87_));
  inv1   g70(.a(new_n61_), .O(new_n88_));
  aoi21  g71(.a(x3), .b(x1), .c(x2), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n88_), .c(x0), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n87_), .c(new_n27_), .O(z5));
  nand2  g74(.a(new_n84_), .b(x1), .O(new_n92_));
  nand3  g75(.a(x3), .b(new_n43_), .c(new_n40_), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(new_n92_), .c(new_n26_), .O(z6));
  nand3  g77(.a(new_n85_), .b(new_n84_), .c(new_n27_), .O(z7));
  nor2   g78(.a(new_n26_), .b(x3), .O(z8));
  aoi21  g79(.a(new_n22_), .b(new_n20_), .c(new_n29_), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(x6), .c(x5), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n27_), .O(z9));
endmodule
