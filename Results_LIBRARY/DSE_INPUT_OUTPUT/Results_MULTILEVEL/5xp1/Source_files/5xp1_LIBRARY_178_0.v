...
module FAU ( 
  ...
  nand2  g26(.a(new_n23_), .b(z8), .O(new_n44_));
  ...
  oai21  g54(.a(new_n20_), .b(z8), .c(new_n40_), .O(new_n72_));
  ...
  nand3  g86(.a(x3), .b(new_n67_), .c(new_n40_), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n103_), .c(new_n31_), .O(z6));
  nand2  g88(.a(new_n95_), .b(new_n94_), .O(z7));
  aoi21  g89(.a(x2), .b(x1), .c(x0), .O(new_n107_));
  oai21  g90(.a(new_n107_), .b(z8), .c(new_n20_), .O(new_n108_));
