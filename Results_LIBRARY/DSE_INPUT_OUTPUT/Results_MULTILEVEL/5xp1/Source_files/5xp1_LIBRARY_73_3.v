...
module FAU ( 
  ...
  nand2  g32(.a(new_n24_), .b(new_n28_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(x4), .c(x0), .O(new_n51_));
  aoi21  g34(.a(new_n24_), .b(new_n28_), .c(new_n19_), .O(new_n52_));
  ...
  aoi21  g55(.a(new_n44_), .b(new_n65_), .c(new_n20_), .O(new_n73_));
  nand2  g56(.a(new_n65_), .b(new_n19_), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n57_), .c(x6), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n73_), .c(x1), .O(new_n76_));
  nor2   g59(.a(x3), .b(x0), .O(new_n77_));
  nor3   g60(.a(new_n77_), .b(x6), .c(new_n24_), .O(new_n78_));
  nor2   g61(.a(new_n77_), .b(new_n24_), .O(new_n79_));
  nor2   g62(.a(new_n79_), .b(new_n20_), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n78_), .c(new_n28_), .O(new_n81_));
  nand2  g64(.a(x6), .b(x5), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n81_), .c(new_n76_), .O(z4));
  nand2  g66(.a(x3), .b(new_n24_), .O(new_n84_));
  nand2  g67(.a(new_n56_), .b(x2), .O(new_n85_));
  oai21  g68(.a(new_n84_), .b(new_n28_), .c(new_n85_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n19_), .O(new_n87_));
  inv1   g70(.a(new_n65_), .O(new_n88_));
  ...
  nand3  g75(.a(x3), .b(new_n24_), .c(new_n28_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n92_), .c(new_n82_), .O(z6));
  nand3  g77(.a(new_n85_), .b(new_n84_), .c(new_n82_), .O(z7));
  nand2  g78(.a(new_n82_), .b(x3), .O(z8));
  nand2  g79(.a(new_n59_), .b(x4), .O(new_n97_));
  aoi21  g80(.a(new_n97_), .b(new_n20_), .c(new_n32_), .O(z9));
endmodule
