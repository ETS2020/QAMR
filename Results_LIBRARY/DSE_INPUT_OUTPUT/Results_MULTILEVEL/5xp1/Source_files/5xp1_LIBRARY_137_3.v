...
module FAU ( 
  ...
  nand2  g63(.a(new_n51_), .b(new_n21_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(x6), .c(new_n18_), .O(new_n82_));
  nor2   g65(.a(x3), .b(x2), .O(new_n83_));
  oai21  g66(.a(new_n57_), .b(new_n83_), .c(new_n30_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(x1), .O(new_n86_));
  nand2  g69(.a(new_n34_), .b(new_n19_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n30_), .c(x2), .O(new_n88_));
  nand2  g71(.a(new_n87_), .b(x2), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(x6), .c(new_n18_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n20_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n86_), .O(z4));
  nand2  g76(.a(x3), .b(new_n46_), .O(new_n94_));
  ...
  nand3  g83(.a(new_n100_), .b(new_n97_), .c(new_n79_), .O(z5));
  nand2  g84(.a(new_n94_), .b(x1), .O(new_n102_));
  nand3  g85(.a(x3), .b(new_n46_), .c(new_n20_), .O(new_n103_));
  aoi21  g86(.a(new_n103_), .b(new_n102_), .c(new_n78_), .O(z6));
  nand3  g87(.a(new_n95_), .b(new_n94_), .c(new_n79_), .O(z7));
  nand2  g88(.a(new_n79_), .b(x3), .O(z8));
  nand2  g89(.a(new_n22_), .b(x5), .O(new_n107_));
  aoi21  g90(.a(new_n107_), .b(new_n30_), .c(new_n18_), .O(z9));
endmodule
