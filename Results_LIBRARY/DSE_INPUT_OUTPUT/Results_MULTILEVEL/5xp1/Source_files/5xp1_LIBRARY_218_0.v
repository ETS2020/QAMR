...
module FAU ( 
  ...
  oai21  g79(.a(x3), .b(new_n18_), .c(new_n96_), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n19_), .O(new_n98_));
  inv1   g81(.a(new_n21_), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(x2), .c(new_n39_), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(x0), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n98_), .c(new_n95_), .O(z5));
  aoi21  g85(.a(x3), .b(new_n33_), .c(new_n20_), .O(new_n103_));
  nand2  g86(.a(x6), .b(x3), .O(new_n104_));
  oai21  g87(.a(new_n104_), .b(x2), .c(x1), .O(new_n105_));
  oai21  g88(.a(new_n103_), .b(x2), .c(new_n105_), .O(z6));
  oai21  g89(.a(new_n20_), .b(x3), .c(new_n18_), .O(new_n107_));
  oai21  g90(.a(x3), .b(new_n18_), .c(new_n107_), .O(z7));
  nand2  g91(.a(new_n95_), .b(x3), .O(z8));
  nand3  g92(.a(new_n21_), .b(new_n20_), .c(new_n19_), .O(new_n110_));
  nand3  g93(.a(new_n110_), .b(x5), .c(x4), .O(new_n111_));
  nand2  g94(.a(new_n111_), .b(new_n95_), .O(z9));
endmodule
