...
module FAU ( 
  ...
  nor2   g38(.a(x6), .b(new_n29_), .O(new_n56_));
  inv1   g39(.a(new_n56_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n55_), .c(new_n50_), .O(z2));
  nand3  g41(.a(new_n31_), .b(x5), .c(x0), .O(new_n59_));
  nand2  g42(.a(new_n37_), .b(new_n29_), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n18_), .c(new_n35_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(x6), .O(new_n63_));
  nor2   g46(.a(new_n24_), .b(new_n30_), .O(new_n64_));
  xnor2a g47(.a(x5), .b(x0), .O(new_n65_));
  inv1   g48(.a(x3), .O(new_n66_));
  nand3  g49(.a(x5), .b(new_n66_), .c(new_n35_), .O(new_n67_));
  ...
  nand2  g54(.a(new_n66_), .b(new_n35_), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(new_n71_), .c(x2), .O(new_n73_));
  nand2  g56(.a(new_n72_), .b(x2), .O(new_n74_));
  nor2   g57(.a(new_n66_), .b(new_n29_), .O(new_n75_));
  aoi22  g58(.a(new_n75_), .b(x0), .c(new_n74_), .d(new_n29_), .O(new_n76_));
  oai21  g59(.a(new_n76_), .b(new_n24_), .c(new_n73_), .O(z4));
  nand2  g60(.a(x3), .b(new_n30_), .O(new_n78_));
  nand2  g61(.a(new_n66_), .b(x2), .O(new_n79_));
  oai21  g62(.a(new_n78_), .b(new_n29_), .c(new_n79_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n35_), .O(new_n81_));
  oai21  g64(.a(x2), .b(new_n35_), .c(new_n29_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n24_), .O(new_n83_));
  oai21  g66(.a(new_n75_), .b(x2), .c(new_n37_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(x0), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n83_), .c(new_n81_), .O(z5));
  nand3  g69(.a(new_n78_), .b(x6), .c(x1), .O(new_n87_));
  oai21  g70(.a(new_n78_), .b(x1), .c(new_n87_), .O(z6));
  aoi21  g71(.a(new_n79_), .b(new_n78_), .c(new_n56_), .O(z7));
  nand2  g72(.a(new_n57_), .b(x3), .O(z8));
  oai21  g73(.a(x1), .b(new_n35_), .c(new_n24_), .O(new_n91_));
