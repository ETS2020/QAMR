...
module FAU ( 
  ...
  nand2  g65(.a(new_n44_), .b(x5), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n82_), .c(new_n77_), .O(z4));
  nand2  g67(.a(x3), .b(new_n30_), .O(new_n85_));
  ...
  oai21  g72(.a(new_n89_), .b(new_n61_), .c(x0), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n88_), .c(new_n83_), .O(z5));
  nand2  g74(.a(new_n85_), .b(x1), .O(new_n92_));
  nand3  g75(.a(x3), .b(new_n30_), .c(new_n20_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n92_), .c(new_n83_), .O(z6));
  nand3  g77(.a(new_n86_), .b(new_n85_), .c(new_n83_), .O(z7));
  nand2  g78(.a(new_n83_), .b(x3), .O(z8));
  aoi21  g79(.a(x6), .b(new_n18_), .c(new_n56_), .O(z9));
endmodule
