...
module FAU ( 
  ...
  nand3  g84(.a(x3), .b(new_n78_), .c(new_n23_), .O(new_n102_));
  ...
  nand3  g88(.a(new_n49_), .b(x5), .c(x4), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n92_), .O(z9));
endmodule
