...
module FAU ( 
  ...
  nand3  g75(.a(new_n83_), .b(new_n82_), .c(new_n70_), .O(z7));
  nor2   g76(.a(new_n69_), .b(x3), .O(z8));
  aoi21  g77(.a(new_n21_), .b(new_n19_), .c(new_n18_), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(x6), .c(x5), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n70_), .O(z9));
endmodule
