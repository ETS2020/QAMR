...
module FAU ( 
  ...
  nand2  g58(.a(new_n23_), .b(new_n44_), .O(new_n76_));
  ...
  nand2  g63(.a(new_n37_), .b(new_n44_), .O(new_n81_));
  ...
  aoi21  g68(.a(new_n35_), .b(new_n21_), .c(new_n44_), .O(new_n86_));
  ...
  nand3  g84(.a(new_n23_), .b(x3), .c(new_n33_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(x1), .O(new_n103_));
  oai21  g86(.a(new_n92_), .b(x1), .c(new_n103_), .O(z6));
  aoi21  g87(.a(new_n93_), .b(new_n92_), .c(new_n30_), .O(z7));
