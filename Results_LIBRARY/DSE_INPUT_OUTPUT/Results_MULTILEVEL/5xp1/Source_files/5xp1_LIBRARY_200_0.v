...
module FAU ( 
  ...
  aoi21  g83(.a(new_n100_), .b(new_n99_), .c(new_n62_), .O(z6));
  nand3  g84(.a(new_n93_), .b(new_n92_), .c(new_n63_), .O(z7));
  nor2   g85(.a(new_n62_), .b(x3), .O(z8));
  nand3  g86(.a(new_n52_), .b(x5), .c(x4), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n63_), .O(z9));
endmodule
