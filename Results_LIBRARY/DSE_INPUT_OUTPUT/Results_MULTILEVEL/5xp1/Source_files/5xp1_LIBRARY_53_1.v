...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n112_, new_n113_, new_n116_, new_n117_, new_n119_, new_n121_,
    new_n122_, new_n123_;
  ...
  oai21  g072(.a(new_n89_), .b(new_n37_), .c(new_n86_), .O(new_n90_));
  ...
  nand3  g077(.a(new_n29_), .b(x2), .c(new_n37_), .O(new_n95_));
  oai21  g078(.a(new_n29_), .b(new_n37_), .c(new_n95_), .O(new_n96_));
  nand2  g079(.a(new_n96_), .b(x0), .O(new_n97_));
  nand2  g080(.a(new_n18_), .b(new_n45_), .O(new_n98_));
  oai21  g081(.a(new_n89_), .b(new_n18_), .c(new_n19_), .O(new_n99_));
  nand3  g082(.a(new_n99_), .b(new_n86_), .c(new_n98_), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(x1), .O(new_n101_));
  nand3  g084(.a(new_n29_), .b(x3), .c(x2), .O(new_n102_));
  oai21  g085(.a(new_n29_), .b(x2), .c(new_n102_), .O(new_n103_));
  aoi21  g086(.a(new_n103_), .b(new_n37_), .c(new_n52_), .O(new_n104_));
  nand3  g087(.a(new_n104_), .b(new_n101_), .c(new_n97_), .O(z4));
  nand3  g088(.a(new_n45_), .b(x1), .c(new_n19_), .O(new_n106_));
  oai21  g089(.a(new_n45_), .b(new_n19_), .c(new_n106_), .O(new_n107_));
  nand2  g090(.a(new_n107_), .b(x3), .O(new_n108_));
  nor2   g091(.a(new_n89_), .b(x0), .O(new_n109_));
  nor2   g092(.a(x2), .b(new_n19_), .O(new_n110_));
  oai21  g093(.a(new_n110_), .b(new_n109_), .c(new_n18_), .O(new_n111_));
  inv1   g094(.a(new_n86_), .O(new_n112_));
  oai21  g095(.a(new_n112_), .b(new_n68_), .c(x0), .O(new_n113_));
  nand3  g096(.a(new_n113_), .b(new_n111_), .c(new_n108_), .O(z5));
  nor2   g097(.a(x6), .b(x3), .O(z8));
  oai21  g098(.a(z8), .b(new_n31_), .c(x1), .O(new_n116_));
  nand3  g099(.a(x3), .b(new_n45_), .c(new_n37_), .O(new_n117_));
  nand2  g100(.a(new_n117_), .b(new_n116_), .O(z6));
  nand2  g101(.a(new_n18_), .b(x2), .O(new_n119_));
  oai21  g102(.a(z8), .b(x2), .c(new_n119_), .O(z7));
  aoi21  g103(.a(x2), .b(x1), .c(x6), .O(new_n121_));
  oai22  g104(.a(new_n121_), .b(new_n18_), .c(x6), .d(new_n19_), .O(new_n122_));
