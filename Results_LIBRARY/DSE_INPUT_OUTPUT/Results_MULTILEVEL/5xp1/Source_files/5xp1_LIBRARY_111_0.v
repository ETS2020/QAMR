...
module FAU ( 
  ...
  nand3  g46(.a(new_n51_), .b(x3), .c(new_n19_), .O(new_n64_));
  oai21  g47(.a(new_n51_), .b(new_n19_), .c(new_n64_), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(new_n53_), .c(x2), .O(new_n66_));
  oai21  g49(.a(x6), .b(x3), .c(x5), .O(new_n67_));
  nand3  g50(.a(x6), .b(new_n51_), .c(new_n19_), .O(new_n68_));
  oai21  g51(.a(new_n67_), .b(new_n19_), .c(new_n68_), .O(new_n69_));
  nand2  g52(.a(new_n69_), .b(x1), .O(new_n70_));
  nor2   g53(.a(new_n20_), .b(new_n30_), .O(new_n71_));
  xnor2a g54(.a(x5), .b(x0), .O(new_n72_));
  nand3  g55(.a(x5), .b(new_n57_), .c(new_n19_), .O(new_n73_));
  oai21  g56(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n23_), .O(new_n75_));
  nand3  g58(.a(new_n24_), .b(x5), .c(new_n19_), .O(new_n76_));
  nand4  g59(.a(new_n51_), .b(new_n57_), .c(new_n30_), .d(x0), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n76_), .c(x4), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n20_), .O(new_n79_));
  nand4  g62(.a(new_n79_), .b(new_n75_), .c(new_n70_), .d(new_n66_), .O(z3));
  nand2  g63(.a(new_n57_), .b(new_n30_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(x0), .O(new_n82_));
  aoi21  g65(.a(new_n82_), .b(new_n24_), .c(new_n20_), .O(new_n83_));
  nand2  g66(.a(new_n24_), .b(new_n19_), .O(new_n84_));
  ...
  nor3   g70(.a(new_n87_), .b(x6), .c(new_n30_), .O(new_n88_));
  nor2   g71(.a(new_n87_), .b(new_n30_), .O(new_n89_));
  nor2   g72(.a(new_n89_), .b(new_n20_), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n88_), .c(new_n23_), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n86_), .c(new_n62_), .O(z4));
  ...
  aoi21  g81(.a(new_n98_), .b(new_n96_), .c(new_n61_), .O(z5));
  nand2  g82(.a(new_n93_), .b(x1), .O(new_n100_));
  nand3  g83(.a(x3), .b(new_n30_), .c(new_n23_), .O(new_n101_));
  aoi21  g84(.a(new_n101_), .b(new_n100_), .c(new_n61_), .O(z6));
  aoi21  g85(.a(new_n94_), .b(new_n93_), .c(new_n61_), .O(z7));
  nor2   g86(.a(new_n61_), .b(x3), .O(z8));
