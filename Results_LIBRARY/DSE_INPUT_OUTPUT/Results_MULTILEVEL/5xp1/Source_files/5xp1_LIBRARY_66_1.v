...
module FAU ( 
  ...
  nand2  g72(.a(new_n37_), .b(x2), .O(new_n90_));
  ...
  nand3  g80(.a(x3), .b(new_n34_), .c(new_n31_), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(new_n97_), .c(new_n88_), .O(z6));
  aoi21  g82(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(z7));
  nor2   g83(.a(new_n88_), .b(x3), .O(z8));
  nand3  g84(.a(new_n21_), .b(new_n20_), .c(new_n19_), .O(new_n102_));
