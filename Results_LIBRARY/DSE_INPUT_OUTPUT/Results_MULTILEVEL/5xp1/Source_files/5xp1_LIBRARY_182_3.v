...
module FAU ( 
  ...
  nand3  g68(.a(x6), .b(z8), .c(x1), .O(new_n86_));
  nand2  g69(.a(new_n20_), .b(new_n31_), .O(new_n87_));
  aoi21  g70(.a(new_n87_), .b(new_n86_), .c(new_n19_), .O(new_n88_));
  nor2   g71(.a(x6), .b(z8), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n31_), .O(new_n90_));
  inv1   g73(.a(new_n90_), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n88_), .c(x2), .O(new_n92_));
  xor2a  g75(.a(x6), .b(x1), .O(new_n93_));
  nand2  g76(.a(x2), .b(x0), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n93_), .c(z8), .O(new_n95_));
  nand4  g78(.a(new_n20_), .b(new_n39_), .c(x1), .d(new_n19_), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n95_), .c(new_n92_), .O(z4));
  xnor2a g80(.a(x3), .b(x0), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(x2), .O(new_n99_));
  oai21  g82(.a(x2), .b(new_n31_), .c(new_n20_), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(x3), .c(new_n19_), .O(new_n101_));
  nand2  g84(.a(new_n89_), .b(x1), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n39_), .c(x0), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n101_), .c(new_n99_), .O(z5));
  aoi21  g87(.a(new_n20_), .b(x2), .c(z8), .O(new_n105_));
  nand3  g88(.a(new_n89_), .b(new_n39_), .c(new_n31_), .O(new_n106_));
  oai21  g89(.a(new_n105_), .b(new_n31_), .c(new_n106_), .O(z6));
  nand2  g90(.a(x3), .b(new_n39_), .O(new_n108_));
  oai21  g91(.a(new_n89_), .b(new_n39_), .c(new_n108_), .O(z7));
