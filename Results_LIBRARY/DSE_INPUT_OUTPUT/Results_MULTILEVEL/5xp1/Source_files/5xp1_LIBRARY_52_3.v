...
module FAU ( 
  ...
  nand2  g70(.a(new_n54_), .b(new_n20_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(x6), .c(new_n24_), .O(new_n89_));
  nor2   g72(.a(x3), .b(x2), .O(new_n90_));
  oai21  g73(.a(new_n60_), .b(new_n90_), .c(new_n19_), .O(new_n91_));
  aoi21  g74(.a(new_n91_), .b(new_n89_), .c(new_n25_), .O(new_n92_));
  inv1   g75(.a(x3), .O(new_n93_));
  ...
  aoi21  g80(.a(new_n97_), .b(new_n95_), .c(x1), .O(new_n98_));
  or2    g81(.a(new_n98_), .b(new_n92_), .O(z4));
  nand2  g82(.a(x3), .b(new_n33_), .O(new_n100_));
  nand2  g83(.a(new_n93_), .b(x2), .O(new_n101_));
  oai21  g84(.a(new_n100_), .b(new_n25_), .c(new_n101_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n18_), .O(new_n103_));
  aoi21  g86(.a(x3), .b(x1), .c(x2), .O(new_n104_));
  oai21  g87(.a(new_n104_), .b(new_n21_), .c(x0), .O(new_n105_));
  nand3  g88(.a(new_n105_), .b(new_n103_), .c(new_n46_), .O(z5));
  nand2  g89(.a(new_n100_), .b(x1), .O(new_n107_));
  nand3  g90(.a(x3), .b(new_n33_), .c(new_n25_), .O(new_n108_));
  aoi21  g91(.a(new_n108_), .b(new_n107_), .c(new_n45_), .O(z6));
  aoi21  g92(.a(new_n101_), .b(new_n100_), .c(new_n45_), .O(z7));
  nor2   g93(.a(new_n45_), .b(x3), .O(z8));
  nand2  g94(.a(new_n22_), .b(new_n18_), .O(new_n112_));
  nand4  g95(.a(new_n112_), .b(new_n19_), .c(x5), .d(x4), .O(new_n113_));
