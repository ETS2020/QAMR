...
module FAU ( 
  ...
  nand2  g71(.a(new_n49_), .b(x2), .O(new_n89_));
  ...
  oai21  g75(.a(new_n92_), .b(new_n62_), .c(x0), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(new_n91_), .c(new_n87_), .O(z5));
  nand2  g77(.a(new_n88_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n31_), .c(new_n22_), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n95_), .c(new_n87_), .O(z6));
  inv1   g80(.a(new_n87_), .O(new_n98_));
