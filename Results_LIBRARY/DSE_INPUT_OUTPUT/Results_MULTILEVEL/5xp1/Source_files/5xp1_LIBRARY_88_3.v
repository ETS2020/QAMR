...
module FAU ( 
  ...
  oai21  g26(.a(new_n43_), .b(new_n19_), .c(new_n41_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(new_n28_), .O(new_n45_));
  oai21  g28(.a(new_n38_), .b(new_n28_), .c(new_n45_), .O(z1));
  inv1   g29(.a(new_n29_), .O(new_n47_));
  ...
  oai21  g43(.a(new_n60_), .b(new_n48_), .c(x6), .O(new_n61_));
  aoi21  g44(.a(new_n20_), .b(x3), .c(x2), .O(new_n62_));
  ...
  nand3  g49(.a(new_n66_), .b(new_n65_), .c(new_n61_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(new_n32_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n59_), .c(new_n47_), .O(z2));
  nand3  g52(.a(new_n28_), .b(x3), .c(new_n19_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(new_n53_), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(x2), .c(x1), .O(new_n72_));
  nand2  g55(.a(new_n42_), .b(x1), .O(new_n73_));
  ...
  nand2  g60(.a(x5), .b(new_n39_), .O(new_n78_));
  nand3  g61(.a(x6), .b(new_n28_), .c(x1), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n78_), .c(x0), .O(new_n80_));
  nand2  g63(.a(new_n20_), .b(new_n22_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(x5), .c(x1), .O(new_n82_));
  aoi21  g65(.a(new_n82_), .b(new_n49_), .c(new_n19_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n80_), .c(new_n21_), .O(new_n84_));
  ...
  oai21  g70(.a(new_n23_), .b(x0), .c(new_n42_), .O(new_n88_));
  ...
  nor2   g76(.a(x3), .b(new_n21_), .O(new_n94_));
  aoi21  g77(.a(new_n93_), .b(x1), .c(new_n94_), .O(new_n95_));
  oai21  g78(.a(new_n22_), .b(new_n19_), .c(new_n20_), .O(new_n96_));
  ...
  aoi21  g82(.a(new_n93_), .b(new_n39_), .c(new_n29_), .O(new_n100_));
  oai21  g83(.a(new_n93_), .b(new_n39_), .c(new_n100_), .O(z6));
  oai21  g84(.a(new_n81_), .b(new_n21_), .c(new_n92_), .O(z7));
  nand2  g85(.a(new_n47_), .b(x3), .O(z8));
  aoi21  g86(.a(new_n24_), .b(new_n19_), .c(x6), .O(new_n104_));
  nor2   g87(.a(new_n20_), .b(x2), .O(new_n105_));
  oai21  g88(.a(new_n105_), .b(new_n104_), .c(x5), .O(new_n106_));
  nor2   g89(.a(new_n106_), .b(new_n32_), .O(z9));
endmodule
