...
module FAU ( 
  ...
  oai21  g21(.a(new_n38_), .b(new_n18_), .c(new_n26_), .O(new_n39_));
  nand4  g22(.a(new_n39_), .b(x6), .c(new_n19_), .d(new_n27_), .O(new_n40_));
  ...
  nand3  g34(.a(x6), .b(new_n26_), .c(new_n38_), .O(new_n52_));
  aoi22  g35(.a(new_n52_), .b(new_n51_), .c(x5), .d(x0), .O(new_n53_));
  nand2  g36(.a(x5), .b(x3), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n26_), .c(new_n18_), .O(new_n55_));
  nand3  g38(.a(x4), .b(x2), .c(x0), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(new_n55_), .c(new_n20_), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n53_), .c(new_n27_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n50_), .O(z2));
  nand3  g42(.a(x5), .b(x1), .c(x0), .O(new_n60_));
  nand2  g43(.a(new_n27_), .b(new_n18_), .O(new_n61_));
  nand3  g44(.a(x6), .b(new_n19_), .c(x2), .O(new_n62_));
  oai21  g45(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(x3), .O(new_n64_));
  oai21  g47(.a(x6), .b(x2), .c(x1), .O(new_n65_));
  nand2  g48(.a(x6), .b(x2), .O(new_n66_));
  aoi21  g49(.a(new_n66_), .b(new_n65_), .c(new_n18_), .O(new_n67_));
  oai21  g50(.a(new_n20_), .b(new_n27_), .c(new_n22_), .O(new_n68_));
  ...
  nand4  g54(.a(new_n66_), .b(new_n19_), .c(new_n27_), .d(x0), .O(new_n72_));
  ...
  aoi21  g61(.a(new_n75_), .b(x6), .c(new_n78_), .O(new_n79_));
  nor2   g62(.a(x3), .b(x0), .O(new_n80_));
  nor3   g63(.a(new_n80_), .b(x6), .c(new_n38_), .O(new_n81_));
  nor2   g64(.a(new_n80_), .b(new_n38_), .O(new_n82_));
  nor2   g65(.a(new_n82_), .b(new_n20_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n81_), .c(new_n27_), .O(new_n84_));
  oai21  g67(.a(new_n79_), .b(new_n27_), .c(new_n84_), .O(z4));
  aoi21  g68(.a(new_n19_), .b(x1), .c(x3), .O(z8));
  nand2  g69(.a(z8), .b(x2), .O(new_n87_));
  nand2  g70(.a(new_n38_), .b(x1), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n54_), .c(new_n87_), .O(new_n89_));
  ...
  nand2  g80(.a(x3), .b(new_n38_), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(x1), .c(new_n97_), .O(z6));
  nand2  g82(.a(new_n19_), .b(x1), .O(new_n100_));
  nand2  g83(.a(new_n91_), .b(x2), .O(new_n101_));
  nand3  g84(.a(new_n98_), .b(new_n101_), .c(new_n100_), .O(z7));
  nand2  g85(.a(new_n31_), .b(x1), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n20_), .c(new_n18_), .O(new_n104_));
