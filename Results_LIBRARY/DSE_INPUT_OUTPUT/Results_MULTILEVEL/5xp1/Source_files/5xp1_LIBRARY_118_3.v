...
module FAU ( 
  ...
  nor2   g50(.a(new_n67_), .b(new_n20_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(x0), .O(new_n69_));
  nand3  g52(.a(new_n20_), .b(x3), .c(x2), .O(new_n70_));
  ...
  aoi21  g59(.a(new_n76_), .b(new_n20_), .c(new_n25_), .O(new_n77_));
  ...
  nand3  g63(.a(new_n80_), .b(x6), .c(new_n20_), .O(new_n81_));
  ...
  nand3  g68(.a(new_n85_), .b(new_n25_), .c(x2), .O(new_n86_));
  nand2  g69(.a(new_n85_), .b(x2), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(x6), .c(new_n20_), .O(new_n88_));
  ...
  nand3  g80(.a(new_n97_), .b(new_n95_), .c(new_n27_), .O(z5));
  nand2  g81(.a(new_n92_), .b(x1), .O(new_n99_));
  nand3  g82(.a(x3), .b(new_n30_), .c(new_n29_), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(new_n99_), .c(new_n26_), .O(z6));
  aoi21  g84(.a(new_n93_), .b(new_n92_), .c(new_n26_), .O(z7));
  nand2  g85(.a(new_n27_), .b(x3), .O(z8));
  nand2  g86(.a(new_n21_), .b(new_n19_), .O(new_n104_));
  nand4  g87(.a(new_n104_), .b(new_n25_), .c(x5), .d(x4), .O(new_n105_));
