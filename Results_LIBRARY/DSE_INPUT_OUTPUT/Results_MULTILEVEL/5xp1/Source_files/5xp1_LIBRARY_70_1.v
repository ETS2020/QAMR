...
module FAU ( 
  ...
  nor2   g75(.a(new_n21_), .b(x5), .O(new_n93_));
  nand2  g76(.a(x3), .b(new_n31_), .O(new_n94_));
  nand2  g77(.a(new_n32_), .b(x2), .O(new_n95_));
  ...
  nand2  g89(.a(new_n23_), .b(new_n20_), .O(new_n107_));
