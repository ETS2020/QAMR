...
module FAU ( 
  ...
  nand3  g15(.a(new_n32_), .b(new_n30_), .c(x4), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(new_n29_), .O(z0));
  inv1   g17(.a(x2), .O(new_n35_));
  aoi21  g18(.a(new_n23_), .b(x1), .c(new_n35_), .O(new_n36_));
  nand2  g19(.a(x4), .b(x3), .O(new_n37_));
  aoi21  g20(.a(new_n37_), .b(new_n20_), .c(new_n18_), .O(new_n38_));
  ...
  oai21  g25(.a(x4), .b(x1), .c(x6), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n21_), .c(new_n19_), .O(new_n44_));
  oai21  g27(.a(x6), .b(x4), .c(new_n44_), .O(new_n45_));
  aoi21  g28(.a(new_n45_), .b(x5), .c(new_n31_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n42_), .O(z1));
  inv1   g30(.a(new_n21_), .O(new_n48_));
  nand3  g31(.a(x6), .b(new_n23_), .c(new_n18_), .O(new_n49_));
  nand3  g32(.a(new_n20_), .b(x4), .c(x1), .O(new_n50_));
  aoi21  g33(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n51_));
  aoi21  g34(.a(new_n50_), .b(new_n24_), .c(x5), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n51_), .c(new_n19_), .O(new_n53_));
  inv1   g36(.a(x3), .O(new_n54_));
  nand4  g37(.a(new_n20_), .b(x4), .c(new_n54_), .d(x1), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n49_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n30_), .c(new_n35_), .O(new_n57_));
  aoi21  g40(.a(x5), .b(x3), .c(x0), .O(new_n58_));
  oai21  g41(.a(x5), .b(x3), .c(x0), .O(new_n59_));
  oai21  g42(.a(new_n58_), .b(new_n35_), .c(new_n59_), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n20_), .c(new_n23_), .O(new_n61_));
  nand2  g44(.a(new_n30_), .b(new_n19_), .O(new_n62_));
  ...
  nand3  g53(.a(new_n30_), .b(x3), .c(new_n19_), .O(new_n71_));
  oai21  g54(.a(new_n30_), .b(new_n19_), .c(new_n71_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(x2), .O(new_n73_));
  oai21  g56(.a(x6), .b(x3), .c(x5), .O(new_n74_));
  nand3  g57(.a(x6), .b(new_n30_), .c(new_n19_), .O(new_n75_));
  ...
  nand3  g61(.a(new_n78_), .b(new_n30_), .c(x0), .O(new_n79_));
  aoi21  g62(.a(x6), .b(x1), .c(new_n30_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n19_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n35_), .O(new_n83_));
  nand3  g66(.a(new_n80_), .b(new_n54_), .c(new_n19_), .O(new_n84_));
  and2   g67(.a(new_n84_), .b(new_n32_), .O(new_n85_));
  nand4  g68(.a(new_n85_), .b(new_n83_), .c(new_n77_), .d(new_n73_), .O(z3));
  nand2  g69(.a(new_n54_), .b(new_n35_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(x0), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n21_), .c(new_n20_), .O(new_n89_));
  aoi21  g72(.a(new_n87_), .b(new_n26_), .c(x6), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n89_), .c(x1), .O(new_n91_));
  oai21  g74(.a(x3), .b(x0), .c(x2), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(x6), .c(new_n18_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n91_), .O(z4));
  nand2  g77(.a(x3), .b(new_n35_), .O(new_n95_));
  nand2  g78(.a(new_n54_), .b(x2), .O(new_n96_));
  ...
  nand2  g83(.a(new_n87_), .b(new_n21_), .O(new_n101_));
