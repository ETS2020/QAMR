...
module FAU ( 
  ...
  inv1   g52(.a(new_n23_), .O(new_n70_));
  ...
  nor2   g59(.a(new_n36_), .b(x3), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n22_), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n76_), .c(new_n28_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n73_), .c(new_n18_), .O(new_n80_));
  oai21  g63(.a(new_n29_), .b(new_n22_), .c(new_n34_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(x5), .O(new_n82_));
  inv1   g65(.a(x3), .O(z8));
  nand2  g66(.a(x6), .b(new_n40_), .O(new_n84_));
  oai21  g67(.a(x6), .b(z8), .c(new_n84_), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n28_), .c(new_n22_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n82_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(x0), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n80_), .O(z3));
  oai21  g72(.a(x3), .b(x2), .c(x0), .O(new_n90_));
  aoi21  g73(.a(new_n90_), .b(new_n23_), .c(new_n36_), .O(new_n91_));
  nand2  g74(.a(new_n40_), .b(new_n18_), .O(new_n92_));
  aoi21  g75(.a(new_n92_), .b(x3), .c(x6), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n91_), .c(x1), .O(new_n94_));
  aoi21  g77(.a(new_n36_), .b(x3), .c(x2), .O(new_n95_));
  oai22  g78(.a(x6), .b(new_n40_), .c(x3), .d(x0), .O(new_n96_));
  oai21  g79(.a(new_n96_), .b(new_n95_), .c(new_n22_), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n94_), .O(z4));
  nand3  g81(.a(new_n40_), .b(x1), .c(new_n18_), .O(new_n99_));
  oai21  g82(.a(new_n40_), .b(new_n18_), .c(new_n99_), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(x3), .O(new_n101_));
  aoi21  g84(.a(x6), .b(new_n40_), .c(x0), .O(new_n102_));
  nor2   g85(.a(x2), .b(new_n18_), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(new_n102_), .c(z8), .O(new_n104_));
  nor2   g87(.a(x6), .b(new_n40_), .O(new_n105_));
  ...
  oai21  g91(.a(new_n77_), .b(new_n70_), .c(x1), .O(new_n109_));
  nand2  g92(.a(x3), .b(new_n40_), .O(new_n110_));
  oai21  g93(.a(new_n110_), .b(x1), .c(new_n109_), .O(z6));
  nand2  g94(.a(new_n77_), .b(x2), .O(new_n112_));
  ...
  nand2  g98(.a(new_n115_), .b(new_n32_), .O(z9));
endmodule
