...
module FAU ( 
  ...
  aoi21  g24(.a(new_n40_), .b(new_n30_), .c(new_n41_), .O(new_n42_));
  ...
  oai21  g31(.a(new_n48_), .b(new_n43_), .c(new_n25_), .O(new_n49_));
  nand2  g32(.a(new_n30_), .b(new_n29_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(x4), .c(x0), .O(new_n51_));
  aoi21  g34(.a(new_n30_), .b(new_n29_), .c(new_n19_), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(x4), .c(new_n51_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(x6), .c(new_n20_), .O(new_n54_));
  ...
  nand3  g75(.a(new_n92_), .b(new_n89_), .c(new_n27_), .O(z5));
  nand2  g76(.a(new_n86_), .b(x1), .O(new_n94_));
  nand3  g77(.a(x3), .b(new_n30_), .c(new_n29_), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n94_), .c(new_n26_), .O(z6));
  nand3  g79(.a(new_n87_), .b(new_n86_), .c(new_n27_), .O(z7));
  nand2  g80(.a(new_n27_), .b(x3), .O(z8));
  nand2  g81(.a(new_n59_), .b(x4), .O(new_n99_));
  aoi21  g82(.a(new_n99_), .b(new_n25_), .c(new_n20_), .O(z9));
endmodule
