...
module FAU ( 
  ...
  nand4  g48(.a(new_n18_), .b(new_n61_), .c(new_n58_), .d(x0), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n65_), .c(new_n21_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(new_n19_), .O(new_n68_));
  nand4  g51(.a(new_n68_), .b(new_n64_), .c(new_n57_), .d(new_n53_), .O(z3));
  aoi21  g52(.a(new_n40_), .b(new_n24_), .c(new_n19_), .O(new_n70_));
  nand2  g53(.a(new_n24_), .b(new_n22_), .O(new_n71_));
  nand2  g54(.a(new_n61_), .b(new_n58_), .O(new_n72_));
  aoi21  g55(.a(new_n72_), .b(new_n71_), .c(x6), .O(new_n73_));
  aoi21  g56(.a(new_n73_), .b(new_n21_), .c(new_n70_), .O(new_n74_));
  nand2  g57(.a(new_n61_), .b(new_n22_), .O(new_n75_));
  nand4  g58(.a(new_n75_), .b(new_n19_), .c(new_n21_), .d(x2), .O(new_n76_));
  ...
  oai21  g63(.a(new_n74_), .b(new_n23_), .c(new_n80_), .O(z4));
  nor2   g64(.a(x6), .b(new_n21_), .O(new_n82_));
  nand2  g65(.a(x3), .b(new_n58_), .O(new_n83_));
  nand2  g66(.a(new_n61_), .b(x2), .O(new_n84_));
  ...
  aoi21  g72(.a(new_n89_), .b(new_n86_), .c(new_n82_), .O(z5));
  inv1   g73(.a(new_n82_), .O(new_n91_));
  nand2  g74(.a(new_n83_), .b(x1), .O(new_n92_));
  nand3  g75(.a(x3), .b(new_n58_), .c(new_n23_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(z6));
  aoi21  g77(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(z7));
  nand2  g78(.a(new_n91_), .b(x3), .O(z8));
  aoi21  g79(.a(x6), .b(new_n18_), .c(new_n21_), .O(z9));
endmodule
