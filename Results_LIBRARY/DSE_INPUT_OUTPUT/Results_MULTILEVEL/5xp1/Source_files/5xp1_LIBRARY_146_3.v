...
module FAU ( 
  ...
  nand3  g62(.a(new_n79_), .b(new_n78_), .c(new_n73_), .O(z4));
  ...
  nand3  g74(.a(new_n82_), .b(new_n81_), .c(new_n79_), .O(z7));
  nand2  g75(.a(new_n79_), .b(x3), .O(z8));
  nand2  g76(.a(new_n56_), .b(x4), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n20_), .c(new_n46_), .O(z9));
endmodule
