...
module FAU ( 
  ...
  nand4  g39(.a(new_n24_), .b(new_n22_), .c(new_n23_), .d(new_n18_), .O(new_n57_));
  nand2  g40(.a(new_n25_), .b(x4), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(x6), .c(x5), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n56_), .O(z2));
  nand4  g44(.a(new_n19_), .b(new_n29_), .c(x3), .d(new_n18_), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n45_), .c(new_n32_), .O(new_n63_));
  oai21  g46(.a(x6), .b(x3), .c(x5), .O(new_n64_));
  nor2   g47(.a(new_n64_), .b(new_n18_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n63_), .c(x1), .O(new_n66_));
  nand2  g49(.a(new_n34_), .b(x1), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n29_), .c(x0), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(new_n36_), .O(new_n69_));
  nand3  g52(.a(x6), .b(x2), .c(x0), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(new_n25_), .c(new_n29_), .O(new_n71_));
  aoi21  g54(.a(new_n69_), .b(new_n19_), .c(new_n71_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n66_), .O(z3));
  inv1   g56(.a(new_n42_), .O(new_n74_));
  aoi21  g57(.a(new_n51_), .b(new_n24_), .c(new_n19_), .O(new_n75_));
  nand2  g58(.a(new_n24_), .b(new_n18_), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n34_), .c(x6), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(new_n75_), .c(x1), .O(new_n78_));
  nor2   g61(.a(x3), .b(x0), .O(new_n79_));
  nor3   g62(.a(new_n79_), .b(x6), .c(new_n32_), .O(new_n80_));
  nor2   g63(.a(new_n79_), .b(new_n32_), .O(new_n81_));
  nor2   g64(.a(new_n81_), .b(new_n19_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n80_), .c(new_n23_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n78_), .c(new_n74_), .O(z4));
  nand2  g67(.a(x3), .b(new_n32_), .O(new_n85_));
  nand2  g68(.a(new_n33_), .b(x2), .O(new_n86_));
  oai21  g69(.a(new_n85_), .b(new_n23_), .c(new_n86_), .O(new_n87_));
  ...
  nand3  g74(.a(new_n91_), .b(new_n88_), .c(new_n74_), .O(z5));
  nand2  g75(.a(new_n85_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n32_), .c(new_n23_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n93_), .c(new_n74_), .O(z6));
  nand3  g78(.a(new_n86_), .b(new_n85_), .c(new_n74_), .O(z7));
  nand2  g79(.a(new_n74_), .b(x3), .O(z8));
  aoi21  g80(.a(new_n20_), .b(new_n18_), .c(new_n29_), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(x6), .c(x4), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n74_), .O(z9));
endmodule
