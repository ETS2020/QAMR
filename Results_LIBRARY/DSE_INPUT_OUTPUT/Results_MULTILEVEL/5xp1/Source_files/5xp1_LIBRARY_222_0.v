...
module FAU ( 
  ...
  nand4  g12(.a(new_n25_), .b(x5), .c(new_n19_), .d(new_n24_), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(x6), .O(new_n31_));
  nand2  g14(.a(new_n31_), .b(new_n29_), .O(new_n32_));
  inv1   g15(.a(x2), .O(new_n33_));
  nand2  g16(.a(x4), .b(x1), .O(new_n34_));
  aoi21  g17(.a(new_n34_), .b(new_n18_), .c(new_n33_), .O(new_n35_));
  nand2  g18(.a(x4), .b(x3), .O(new_n36_));
  aoi21  g19(.a(new_n36_), .b(new_n18_), .c(new_n24_), .O(new_n37_));
  oai21  g20(.a(new_n37_), .b(new_n35_), .c(x0), .O(new_n38_));
  oai21  g21(.a(new_n18_), .b(new_n19_), .c(new_n38_), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(new_n21_), .O(new_n40_));
  nor2   g23(.a(x6), .b(new_n21_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n19_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n40_), .c(new_n32_), .O(z1));
  nand4  g26(.a(x6), .b(x5), .c(x4), .d(x2), .O(new_n44_));
  nand3  g27(.a(new_n18_), .b(new_n19_), .c(x1), .O(new_n45_));
  ...
  nand4  g50(.a(new_n67_), .b(new_n59_), .c(new_n50_), .d(new_n47_), .O(z2));
  nand3  g51(.a(new_n21_), .b(x2), .c(new_n29_), .O(new_n69_));
  oai21  g52(.a(new_n52_), .b(new_n29_), .c(new_n69_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(x3), .O(new_n71_));
  nand3  g54(.a(new_n25_), .b(new_n24_), .c(new_n29_), .O(new_n72_));
  ...
  aoi21  g62(.a(new_n33_), .b(x0), .c(new_n18_), .O(new_n80_));
  nand3  g63(.a(new_n18_), .b(new_n54_), .c(new_n33_), .O(new_n81_));
  oai21  g64(.a(new_n80_), .b(x1), .c(new_n81_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n21_), .O(new_n83_));
  nand4  g66(.a(new_n83_), .b(new_n79_), .c(new_n77_), .d(new_n71_), .O(z3));
  nand2  g67(.a(new_n55_), .b(x0), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n25_), .c(new_n18_), .O(new_n86_));
  aoi21  g69(.a(new_n55_), .b(x0), .c(x6), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n86_), .c(x1), .O(new_n88_));
  inv1   g71(.a(new_n60_), .O(new_n89_));
  xor2a  g72(.a(x6), .b(x2), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n89_), .c(new_n24_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n88_), .O(z4));
  xor2a  g75(.a(x3), .b(x0), .O(new_n93_));
  nand2  g76(.a(x3), .b(x1), .O(new_n94_));
  xor2a  g77(.a(new_n94_), .b(new_n29_), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n33_), .c(new_n66_), .O(new_n96_));
  oai21  g79(.a(new_n93_), .b(new_n33_), .c(new_n96_), .O(z5));
  inv1   g80(.a(new_n66_), .O(new_n98_));
  nand2  g81(.a(x3), .b(new_n33_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(x1), .O(new_n100_));
  nand3  g83(.a(x3), .b(new_n33_), .c(new_n24_), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n100_), .c(new_n98_), .O(z6));
  nand2  g85(.a(new_n54_), .b(x2), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n99_), .c(new_n98_), .O(z7));
  nor2   g87(.a(new_n66_), .b(x3), .O(z8));
  oai21  g88(.a(new_n21_), .b(new_n19_), .c(new_n98_), .O(z9));
endmodule
