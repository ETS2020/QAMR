...
module FAU ( 
  ...
  nand2  g71(.a(new_n80_), .b(x2), .O(new_n89_));
  ...
  nand3  g81(.a(x3), .b(new_n39_), .c(new_n36_), .O(new_n99_));
  aoi21  g82(.a(new_n99_), .b(new_n98_), .c(new_n95_), .O(z6));
  aoi21  g83(.a(new_n89_), .b(new_n88_), .c(new_n95_), .O(z7));
  nand2  g84(.a(new_n96_), .b(x3), .O(z8));
  aoi21  g85(.a(new_n21_), .b(new_n19_), .c(new_n18_), .O(new_n103_));
