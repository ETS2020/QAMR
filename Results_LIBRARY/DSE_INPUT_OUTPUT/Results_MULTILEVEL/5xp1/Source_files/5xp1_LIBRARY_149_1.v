...
module FAU ( 
  ...
  nand3  g042(.a(new_n59_), .b(x6), .c(x3), .O(new_n60_));
  inv1   g043(.a(new_n60_), .O(new_n61_));
  inv1   g044(.a(x1), .O(new_n62_));
  nand2  g045(.a(new_n58_), .b(new_n62_), .O(new_n63_));
  oai21  g046(.a(x5), .b(x3), .c(x0), .O(new_n64_));
  aoi21  g047(.a(x5), .b(x3), .c(x0), .O(new_n65_));
  aoi21  g048(.a(new_n64_), .b(new_n35_), .c(new_n65_), .O(new_n66_));
  aoi21  g049(.a(new_n66_), .b(new_n63_), .c(x6), .O(new_n67_));
  oai21  g050(.a(new_n67_), .b(new_n61_), .c(x4), .O(new_n68_));
  nor2   g051(.a(x5), .b(x2), .O(new_n69_));
  aoi22  g052(.a(new_n69_), .b(new_n62_), .c(new_n26_), .d(new_n19_), .O(new_n70_));
  oai21  g053(.a(new_n20_), .b(new_n35_), .c(new_n19_), .O(new_n71_));
  ...
  nor3   g057(.a(new_n74_), .b(x6), .c(new_n19_), .O(new_n75_));
  aoi21  g058(.a(new_n73_), .b(x3), .c(new_n75_), .O(new_n76_));
  oai21  g059(.a(new_n76_), .b(x4), .c(new_n68_), .O(z2));
  nand2  g060(.a(z8), .b(new_n35_), .O(new_n78_));
  nand3  g061(.a(new_n78_), .b(x5), .c(x0), .O(new_n79_));
  nand2  g062(.a(new_n39_), .b(new_n29_), .O(new_n80_));
  ...
  inv1   g066(.a(new_n58_), .O(new_n84_));
  oai21  g067(.a(new_n84_), .b(new_n57_), .c(x2), .O(new_n85_));
  nand2  g068(.a(new_n85_), .b(x3), .O(new_n86_));
  nand2  g069(.a(new_n86_), .b(x6), .O(new_n87_));
  nand2  g070(.a(x5), .b(new_n19_), .O(new_n88_));
  nand2  g071(.a(new_n69_), .b(x0), .O(new_n89_));
  aoi21  g072(.a(new_n89_), .b(new_n88_), .c(x3), .O(new_n90_));
  nand2  g073(.a(x6), .b(x2), .O(new_n91_));
  nand2  g074(.a(new_n20_), .b(x0), .O(new_n92_));
  nand2  g075(.a(new_n92_), .b(new_n88_), .O(new_n93_));
  nand3  g076(.a(new_n93_), .b(new_n91_), .c(new_n62_), .O(new_n94_));
  nand4  g077(.a(new_n29_), .b(x5), .c(new_n35_), .d(new_n19_), .O(new_n95_));
  ...
  nand3  g081(.a(new_n29_), .b(x2), .c(new_n62_), .O(new_n99_));
  oai21  g082(.a(new_n29_), .b(new_n62_), .c(new_n99_), .O(new_n100_));
  ...
  nand3  g088(.a(new_n29_), .b(x3), .c(x2), .O(new_n106_));
  oai21  g089(.a(new_n29_), .b(x2), .c(new_n106_), .O(new_n107_));
  nand2  g090(.a(new_n107_), .b(new_n62_), .O(new_n108_));
  nor2   g091(.a(new_n29_), .b(x3), .O(new_n109_));
  inv1   g092(.a(new_n109_), .O(new_n110_));
  nand4  g093(.a(new_n110_), .b(new_n108_), .c(new_n105_), .d(new_n101_), .O(z4));
  nand2  g094(.a(x3), .b(new_n35_), .O(new_n112_));
  nand2  g095(.a(z8), .b(x2), .O(new_n113_));
  oai21  g096(.a(new_n112_), .b(new_n62_), .c(new_n113_), .O(new_n114_));
  nand2  g097(.a(new_n114_), .b(new_n19_), .O(new_n115_));
  inv1   g098(.a(new_n78_), .O(new_n116_));
  aoi21  g099(.a(new_n35_), .b(x1), .c(z8), .O(new_n117_));
  oai21  g100(.a(new_n117_), .b(new_n116_), .c(x0), .O(new_n118_));
  nand3  g101(.a(new_n118_), .b(new_n115_), .c(new_n110_), .O(z5));
  nand2  g102(.a(new_n112_), .b(x1), .O(new_n120_));
  nand3  g103(.a(x3), .b(new_n35_), .c(new_n62_), .O(new_n121_));
  nand3  g104(.a(new_n121_), .b(new_n120_), .c(new_n110_), .O(z6));
  nand3  g105(.a(new_n29_), .b(z8), .c(x2), .O(new_n123_));
  nand2  g106(.a(new_n123_), .b(new_n112_), .O(z7));
  aoi21  g107(.a(x2), .b(x1), .c(x6), .O(new_n125_));
  oai22  g108(.a(new_n125_), .b(z8), .c(x6), .d(new_n19_), .O(new_n126_));
