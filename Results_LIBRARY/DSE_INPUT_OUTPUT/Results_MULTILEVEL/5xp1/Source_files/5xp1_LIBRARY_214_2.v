...
module FAU ( 
  ...
  nor2   g71(.a(x6), .b(new_n21_), .O(new_n89_));
  nand2  g72(.a(x3), .b(new_n45_), .O(new_n90_));
  nand2  g73(.a(new_n46_), .b(x2), .O(new_n91_));
  oai21  g74(.a(new_n90_), .b(new_n23_), .c(new_n91_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n22_), .O(new_n93_));
  inv1   g76(.a(new_n24_), .O(new_n94_));
  aoi21  g77(.a(x3), .b(x1), .c(x2), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n94_), .c(x0), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n93_), .c(new_n89_), .O(z5));
  inv1   g80(.a(new_n89_), .O(new_n98_));
  nand2  g81(.a(new_n90_), .b(x1), .O(new_n99_));
  nand3  g82(.a(x3), .b(new_n45_), .c(new_n23_), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(new_n99_), .c(new_n98_), .O(z6));
  nand3  g84(.a(new_n91_), .b(new_n90_), .c(new_n98_), .O(z7));
  nand2  g85(.a(new_n98_), .b(x3), .O(z8));
  aoi21  g86(.a(x6), .b(new_n18_), .c(new_n21_), .O(z9));
endmodule
