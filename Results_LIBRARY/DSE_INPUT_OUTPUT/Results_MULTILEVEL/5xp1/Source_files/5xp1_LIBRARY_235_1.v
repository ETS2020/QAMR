...
module FAU ( 
  ...
  nand2  g20(.a(new_n28_), .b(x6), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(x5), .c(new_n25_), .O(new_n39_));
  ...
  inv1   g56(.a(new_n27_), .O(new_n74_));
  nand2  g57(.a(x6), .b(new_n26_), .O(new_n75_));
  nand2  g58(.a(new_n21_), .b(x5), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  nand3  g60(.a(new_n21_), .b(x5), .c(new_n26_), .O(new_n78_));
  inv1   g61(.a(new_n78_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n77_), .c(new_n20_), .O(new_n80_));
  nand4  g63(.a(new_n80_), .b(new_n73_), .c(new_n70_), .d(new_n41_), .O(z3));
  aoi21  g64(.a(new_n43_), .b(new_n27_), .c(new_n21_), .O(new_n82_));
  nand2  g65(.a(new_n27_), .b(new_n20_), .O(new_n83_));
  aoi21  g66(.a(new_n83_), .b(new_n33_), .c(x6), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n82_), .c(x1), .O(new_n85_));
  nor2   g68(.a(x3), .b(x0), .O(new_n86_));
  nor3   g69(.a(new_n86_), .b(x6), .c(new_n31_), .O(new_n87_));
  nor2   g70(.a(new_n86_), .b(new_n31_), .O(new_n88_));
  nor2   g71(.a(new_n88_), .b(new_n21_), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n87_), .c(new_n26_), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n85_), .c(new_n41_), .O(z4));
  nand2  g74(.a(x3), .b(new_n31_), .O(new_n92_));
  nand2  g75(.a(new_n32_), .b(x2), .O(new_n93_));
  oai21  g76(.a(new_n92_), .b(new_n26_), .c(new_n93_), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n20_), .O(new_n95_));
  aoi21  g78(.a(x3), .b(x1), .c(x2), .O(new_n96_));
  oai21  g79(.a(new_n96_), .b(new_n74_), .c(x0), .O(new_n97_));
  nand3  g80(.a(new_n97_), .b(new_n95_), .c(new_n41_), .O(z5));
  nand2  g81(.a(new_n92_), .b(x1), .O(new_n99_));
  nand3  g82(.a(x3), .b(new_n31_), .c(new_n26_), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(new_n99_), .c(new_n40_), .O(z6));
  nand3  g84(.a(new_n93_), .b(new_n92_), .c(new_n41_), .O(z7));
  nor2   g85(.a(new_n40_), .b(x3), .O(z8));
  nand2  g86(.a(new_n23_), .b(new_n20_), .O(new_n104_));
