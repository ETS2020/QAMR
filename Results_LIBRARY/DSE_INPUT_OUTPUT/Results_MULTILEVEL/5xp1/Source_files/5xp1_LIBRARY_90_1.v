...
module FAU ( 
  ...
  nand2  g68(.a(x3), .b(new_n32_), .O(new_n86_));
  nand2  g69(.a(new_n33_), .b(x2), .O(new_n87_));
  oai21  g70(.a(new_n86_), .b(new_n27_), .c(new_n87_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n20_), .O(new_n89_));
  aoi21  g72(.a(x3), .b(x1), .c(x2), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n40_), .c(x0), .O(new_n91_));
  nor2   g74(.a(new_n21_), .b(x5), .O(new_n92_));
  inv1   g75(.a(new_n92_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n91_), .c(new_n89_), .O(z5));
  nand2  g77(.a(new_n86_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n32_), .c(new_n27_), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n95_), .c(new_n92_), .O(z6));
  nand3  g80(.a(new_n93_), .b(new_n87_), .c(new_n86_), .O(z7));
  nand2  g81(.a(new_n93_), .b(x3), .O(z8));
  aoi21  g82(.a(new_n22_), .b(new_n20_), .c(new_n18_), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(x6), .c(x4), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(new_n93_), .O(z9));
endmodule
