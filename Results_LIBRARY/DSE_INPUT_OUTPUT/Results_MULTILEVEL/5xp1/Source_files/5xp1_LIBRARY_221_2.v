...
module FAU ( 
  ...
  nand3  g22(.a(new_n39_), .b(new_n18_), .c(new_n28_), .O(new_n40_));
  nand3  g23(.a(new_n29_), .b(x4), .c(new_n19_), .O(new_n41_));
  aoi21  g24(.a(new_n41_), .b(new_n40_), .c(x0), .O(new_n42_));
  nor3   g25(.a(x6), .b(x4), .c(x3), .O(new_n43_));
  oai21  g26(.a(new_n43_), .b(new_n42_), .c(x5), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(new_n37_), .O(z1));
  nand4  g28(.a(new_n29_), .b(new_n18_), .c(new_n19_), .d(x2), .O(new_n46_));
  aoi21  g29(.a(new_n46_), .b(new_n35_), .c(new_n28_), .O(new_n47_));
  oai21  g30(.a(x5), .b(x2), .c(x6), .O(new_n48_));
  nand4  g31(.a(new_n29_), .b(x5), .c(new_n18_), .d(new_n19_), .O(new_n49_));
  ...
  oai21  g36(.a(new_n53_), .b(new_n52_), .c(new_n28_), .O(new_n54_));
  nand2  g37(.a(new_n20_), .b(new_n23_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n54_), .c(x4), .O(new_n56_));
  nor3   g39(.a(new_n24_), .b(new_n20_), .c(new_n18_), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n56_), .c(x6), .O(new_n58_));
  oai21  g41(.a(new_n32_), .b(new_n28_), .c(new_n20_), .O(new_n59_));
  ...
  nand2  g45(.a(new_n19_), .b(x2), .O(new_n63_));
  aoi21  g46(.a(new_n63_), .b(new_n29_), .c(new_n28_), .O(new_n64_));
  oai21  g47(.a(new_n64_), .b(new_n33_), .c(x5), .O(new_n65_));
  nand2  g48(.a(new_n29_), .b(new_n19_), .O(new_n66_));
  aoi21  g49(.a(new_n66_), .b(new_n38_), .c(x1), .O(new_n67_));
  nor2   g50(.a(new_n66_), .b(x2), .O(new_n68_));
  oai21  g51(.a(new_n68_), .b(new_n67_), .c(new_n20_), .O(new_n69_));
  nand2  g52(.a(new_n69_), .b(new_n65_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(x0), .O(new_n71_));
  inv1   g54(.a(new_n66_), .O(new_n72_));
  aoi21  g55(.a(new_n39_), .b(new_n28_), .c(new_n72_), .O(new_n73_));
  nor2   g56(.a(new_n24_), .b(new_n29_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n20_), .O(new_n75_));
  oai21  g58(.a(new_n73_), .b(new_n20_), .c(new_n75_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n23_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n71_), .O(z3));
  xnor2a g61(.a(x6), .b(x1), .O(new_n79_));
  nor2   g62(.a(new_n79_), .b(x0), .O(new_n80_));
  nand3  g63(.a(x2), .b(new_n28_), .c(x0), .O(new_n81_));
  nand2  g64(.a(new_n32_), .b(x1), .O(new_n82_));
  ...
  aoi21  g69(.a(new_n86_), .b(new_n85_), .c(new_n28_), .O(new_n87_));
  ...
  oai21  g74(.a(z8), .b(new_n82_), .c(new_n63_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n23_), .O(new_n93_));
  nor2   g76(.a(x3), .b(x2), .O(new_n94_));
  aoi21  g77(.a(new_n32_), .b(x1), .c(new_n29_), .O(new_n95_));
  ...
  oai21  g81(.a(new_n33_), .b(new_n19_), .c(x1), .O(new_n99_));
  oai21  g82(.a(z8), .b(new_n98_), .c(new_n99_), .O(z6));
  nand2  g83(.a(z8), .b(x2), .O(new_n101_));
  oai21  g84(.a(new_n19_), .b(x2), .c(new_n101_), .O(z7));
  oai21  g85(.a(x6), .b(x0), .c(x5), .O(new_n103_));
  oai22  g86(.a(new_n103_), .b(new_n18_), .c(x6), .d(new_n19_), .O(z9));
endmodule
