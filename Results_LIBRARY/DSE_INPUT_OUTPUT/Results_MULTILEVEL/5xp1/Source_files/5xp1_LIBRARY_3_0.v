...
module FAU ( 
  ...
  nand3  g50(.a(new_n67_), .b(new_n60_), .c(new_n30_), .O(z2));
  ...
  aoi21  g59(.a(x6), .b(x1), .c(new_n29_), .O(new_n77_));
  ...
  nand3  g64(.a(new_n77_), .b(new_n81_), .c(new_n19_), .O(new_n82_));
  and2   g65(.a(new_n82_), .b(new_n30_), .O(new_n83_));
  nand4  g66(.a(new_n83_), .b(new_n80_), .c(new_n74_), .d(new_n71_), .O(z3));
  nand2  g67(.a(new_n81_), .b(new_n40_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(x0), .O(new_n86_));
  aoi21  g69(.a(new_n86_), .b(new_n21_), .c(new_n20_), .O(new_n87_));
  nand2  g70(.a(new_n21_), .b(new_n19_), .O(new_n88_));
  aoi21  g71(.a(new_n85_), .b(new_n88_), .c(x6), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n87_), .c(x1), .O(new_n90_));
  oai21  g73(.a(x3), .b(x0), .c(x2), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(x6), .c(new_n18_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n90_), .O(z4));
  nand2  g76(.a(x3), .b(new_n40_), .O(new_n94_));
  nand2  g77(.a(new_n81_), .b(x2), .O(new_n95_));
  oai21  g78(.a(new_n94_), .b(new_n18_), .c(new_n95_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n19_), .O(new_n97_));
  oai21  g80(.a(x2), .b(new_n19_), .c(x6), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n18_), .O(new_n99_));
  nand2  g82(.a(new_n85_), .b(new_n21_), .O(new_n100_));
  ...
  nand4  g86(.a(x6), .b(x3), .c(new_n40_), .d(new_n18_), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n103_), .O(z6));
  nand3  g88(.a(new_n95_), .b(new_n94_), .c(new_n30_), .O(z7));
  nand2  g89(.a(new_n30_), .b(x3), .O(z8));
  oai21  g90(.a(new_n26_), .b(new_n18_), .c(new_n20_), .O(new_n108_));
