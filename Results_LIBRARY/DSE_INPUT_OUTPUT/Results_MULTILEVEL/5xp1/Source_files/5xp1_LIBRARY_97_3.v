...
module FAU ( 
  ...
  nor2   g64(.a(new_n20_), .b(new_n32_), .O(new_n82_));
  inv1   g65(.a(new_n82_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n81_), .c(new_n76_), .O(z4));
  nand2  g67(.a(x3), .b(new_n24_), .O(new_n85_));
  nand2  g68(.a(new_n56_), .b(x2), .O(new_n86_));
  oai21  g69(.a(new_n85_), .b(new_n28_), .c(new_n86_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n19_), .O(new_n88_));
  inv1   g71(.a(new_n65_), .O(new_n89_));
  ...
  nand3  g76(.a(x3), .b(new_n24_), .c(new_n28_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n93_), .c(new_n83_), .O(z6));
  aoi21  g78(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(z7));
  nor2   g79(.a(new_n82_), .b(x3), .O(z8));
  nand4  g80(.a(new_n59_), .b(new_n20_), .c(x5), .d(x4), .O(new_n98_));
