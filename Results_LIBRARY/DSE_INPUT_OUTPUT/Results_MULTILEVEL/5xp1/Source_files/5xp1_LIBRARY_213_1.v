...
module FAU ( 
  ...
  nand4  g44(.a(new_n19_), .b(new_n30_), .c(x3), .d(new_n18_), .O(new_n62_));
  ...
  nand2  g49(.a(new_n35_), .b(x1), .O(new_n67_));
  ...
  nand2  g68(.a(new_n85_), .b(new_n79_), .O(z4));
  nor2   g69(.a(new_n19_), .b(x5), .O(new_n87_));
  ...
  nor2   g82(.a(new_n87_), .b(x3), .O(z8));
  nand2  g83(.a(new_n21_), .b(new_n18_), .O(new_n101_));
