...
module FAU ( 
  ...
  oai21  g49(.a(new_n66_), .b(new_n29_), .c(new_n19_), .O(new_n67_));
  ...
  oai21  g55(.a(new_n20_), .b(new_n18_), .c(new_n34_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(x2), .O(new_n74_));
  oai21  g57(.a(x6), .b(new_n18_), .c(x1), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(new_n74_), .c(x5), .O(new_n76_));
  oai21  g59(.a(new_n20_), .b(new_n34_), .c(new_n68_), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n73_), .c(new_n29_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n76_), .c(new_n19_), .O(new_n79_));
  ...
  nand2  g70(.a(new_n18_), .b(new_n19_), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(x2), .c(x1), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n87_), .c(x6), .O(new_n90_));
  nand3  g73(.a(new_n68_), .b(x1), .c(new_n19_), .O(new_n91_));
  oai21  g74(.a(new_n68_), .b(x1), .c(new_n91_), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n20_), .c(x3), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n90_), .O(z4));
  oai21  g77(.a(new_n68_), .b(new_n19_), .c(new_n91_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(x3), .O(new_n96_));
  aoi21  g79(.a(x6), .b(new_n68_), .c(x0), .O(new_n97_));
  nor2   g80(.a(x2), .b(new_n19_), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n97_), .c(new_n18_), .O(new_n99_));
  nor2   g82(.a(x6), .b(new_n68_), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(new_n66_), .c(x0), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n99_), .c(new_n96_), .O(z5));
  inv1   g85(.a(new_n86_), .O(new_n103_));
  nor2   g86(.a(new_n20_), .b(x3), .O(z8));
  oai21  g87(.a(z8), .b(new_n103_), .c(x1), .O(new_n105_));
  nand3  g88(.a(x3), .b(new_n68_), .c(new_n34_), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n105_), .O(z6));
  nand2  g90(.a(new_n18_), .b(x2), .O(new_n108_));
  oai21  g91(.a(z8), .b(x2), .c(new_n108_), .O(z7));
  aoi21  g92(.a(x2), .b(x1), .c(x0), .O(new_n110_));
  oai21  g93(.a(new_n110_), .b(new_n18_), .c(new_n20_), .O(new_n111_));
  nand3  g94(.a(new_n111_), .b(x5), .c(x4), .O(new_n112_));
  nand2  g95(.a(new_n112_), .b(new_n31_), .O(z9));
endmodule
