...
module FAU ( 
  ...
  oai21  g47(.a(new_n64_), .b(x6), .c(x1), .O(new_n65_));
  nand3  g48(.a(x6), .b(x3), .c(x2), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g50(.a(new_n21_), .b(new_n20_), .O(new_n68_));
  aoi21  g51(.a(new_n68_), .b(x6), .c(new_n42_), .O(new_n69_));
  aoi21  g52(.a(new_n67_), .b(new_n42_), .c(new_n69_), .O(new_n70_));
  nand3  g53(.a(new_n35_), .b(new_n46_), .c(new_n28_), .O(new_n71_));
  aoi21  g54(.a(new_n71_), .b(new_n42_), .c(new_n20_), .O(new_n72_));
  aoi21  g55(.a(new_n42_), .b(new_n28_), .c(new_n35_), .O(new_n73_));
  oai22  g56(.a(new_n73_), .b(x1), .c(new_n42_), .d(new_n28_), .O(new_n74_));
  oai21  g57(.a(new_n74_), .b(new_n72_), .c(x0), .O(new_n75_));
  oai21  g58(.a(new_n70_), .b(x0), .c(new_n75_), .O(z3));
  nor2   g59(.a(x3), .b(x2), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(x5), .c(x0), .O(new_n78_));
  nand2  g61(.a(new_n21_), .b(new_n19_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n78_), .c(x6), .O(new_n80_));
  oai21  g63(.a(x3), .b(x2), .c(x0), .O(new_n81_));
  aoi21  g64(.a(new_n81_), .b(new_n21_), .c(new_n35_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n80_), .c(x1), .O(new_n83_));
  nand2  g66(.a(x5), .b(new_n28_), .O(new_n84_));
  nand2  g67(.a(new_n35_), .b(x2), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n84_), .c(new_n19_), .O(new_n86_));
  aoi21  g69(.a(new_n46_), .b(new_n19_), .c(new_n28_), .O(new_n87_));
  nand3  g70(.a(new_n35_), .b(x3), .c(x2), .O(new_n88_));
  oai21  g71(.a(new_n87_), .b(new_n35_), .c(new_n88_), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n86_), .c(new_n20_), .O(new_n90_));
  nor2   g73(.a(x6), .b(new_n42_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n19_), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n90_), .c(new_n83_), .O(z4));
  inv1   g76(.a(new_n91_), .O(new_n94_));
  nand2  g77(.a(x3), .b(new_n28_), .O(new_n95_));
  nand2  g78(.a(new_n46_), .b(x2), .O(new_n96_));
  ...
  oai21  g82(.a(new_n99_), .b(new_n64_), .c(x0), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(new_n98_), .c(new_n94_), .O(z5));
  nand2  g84(.a(new_n95_), .b(x1), .O(new_n102_));
  nand3  g85(.a(x3), .b(new_n28_), .c(new_n20_), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n102_), .c(new_n94_), .O(z6));
  nand3  g87(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(z7));
  nor2   g88(.a(new_n91_), .b(x3), .O(z8));
  aoi21  g89(.a(x6), .b(new_n18_), .c(new_n42_), .O(z9));
endmodule
