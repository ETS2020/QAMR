...
module FAU ( 
  ...
  aoi21  g66(.a(new_n83_), .b(new_n24_), .c(new_n19_), .O(new_n84_));
  nand2  g67(.a(new_n40_), .b(new_n18_), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(x3), .c(x6), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n84_), .c(x1), .O(new_n87_));
  aoi21  g70(.a(new_n19_), .b(x3), .c(x2), .O(new_n88_));
  oai22  g71(.a(x6), .b(new_n40_), .c(x3), .d(x0), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n88_), .c(new_n23_), .O(new_n90_));
  ...
  aoi21  g87(.a(x2), .b(x1), .c(x0), .O(new_n105_));
  oai21  g88(.a(new_n105_), .b(new_n49_), .c(new_n19_), .O(new_n106_));
