...
module FAU ( 
  ...
  nand2  g055(.a(x5), .b(new_n21_), .O(new_n73_));
  nand2  g056(.a(new_n18_), .b(x0), .O(new_n74_));
  nand2  g057(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g058(.a(new_n75_), .b(new_n32_), .O(new_n76_));
  nand3  g059(.a(new_n18_), .b(new_n44_), .c(x0), .O(new_n77_));
  nand2  g060(.a(new_n77_), .b(new_n73_), .O(new_n78_));
  nand3  g061(.a(new_n78_), .b(new_n22_), .c(new_n19_), .O(new_n79_));
  nand2  g062(.a(new_n35_), .b(new_n22_), .O(new_n80_));
  nand3  g063(.a(new_n80_), .b(new_n18_), .c(new_n21_), .O(new_n81_));
  nand3  g064(.a(new_n22_), .b(new_n44_), .c(new_n19_), .O(new_n82_));
  ...
  nand3  g068(.a(x5), .b(new_n44_), .c(new_n21_), .O(new_n86_));
  ...
  nand3  g072(.a(x6), .b(x3), .c(new_n19_), .O(new_n90_));
  nand3  g073(.a(new_n22_), .b(x2), .c(new_n32_), .O(new_n91_));
  nand2  g074(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g075(.a(new_n92_), .b(x0), .O(new_n93_));
  nor2   g076(.a(x3), .b(x2), .O(new_n94_));
  aoi21  g077(.a(new_n35_), .b(new_n21_), .c(new_n94_), .O(new_n95_));
  nor2   g078(.a(new_n95_), .b(new_n32_), .O(new_n96_));
  nor2   g079(.a(new_n35_), .b(x1), .O(new_n97_));
  oai21  g080(.a(new_n97_), .b(new_n96_), .c(new_n22_), .O(new_n98_));
  nor2   g081(.a(new_n22_), .b(x2), .O(new_n99_));
  nand2  g082(.a(new_n99_), .b(new_n32_), .O(new_n100_));
  nand3  g083(.a(new_n100_), .b(new_n98_), .c(new_n93_), .O(z4));
  nand2  g084(.a(x3), .b(new_n19_), .O(new_n102_));
  nand3  g085(.a(new_n22_), .b(new_n44_), .c(x2), .O(new_n103_));
  oai21  g086(.a(new_n102_), .b(new_n32_), .c(new_n103_), .O(new_n104_));
  nand2  g087(.a(new_n104_), .b(new_n21_), .O(new_n105_));
  oai21  g088(.a(new_n44_), .b(new_n32_), .c(new_n19_), .O(new_n106_));
  oai21  g089(.a(new_n63_), .b(new_n19_), .c(new_n106_), .O(new_n107_));
  nand2  g090(.a(new_n107_), .b(x0), .O(new_n108_));
  nand2  g091(.a(new_n108_), .b(new_n105_), .O(z5));
  aoi21  g092(.a(new_n22_), .b(x2), .c(new_n94_), .O(new_n110_));
  nand3  g093(.a(x3), .b(new_n19_), .c(new_n32_), .O(new_n111_));
  oai21  g094(.a(new_n110_), .b(new_n32_), .c(new_n111_), .O(z6));
  nand2  g095(.a(new_n103_), .b(new_n102_), .O(z7));
  aoi21  g096(.a(x6), .b(x2), .c(x3), .O(z8));
  nand3  g097(.a(x3), .b(x2), .c(x1), .O(new_n115_));
  aoi21  g098(.a(new_n115_), .b(new_n21_), .c(x6), .O(new_n116_));
  oai21  g099(.a(new_n116_), .b(new_n99_), .c(x5), .O(new_n117_));
