...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n102_, new_n104_, new_n106_, new_n107_, new_n108_;
  ...
  oai21  g33(.a(new_n50_), .b(new_n19_), .c(z8), .O(new_n51_));
  ...
  oai21  g53(.a(new_n19_), .b(z8), .c(new_n23_), .O(new_n71_));
  ...
  oai21  g78(.a(new_n95_), .b(new_n94_), .c(z8), .O(new_n96_));
  ...
  oai21  g82(.a(new_n19_), .b(x3), .c(new_n24_), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(x1), .O(new_n101_));
  nand3  g84(.a(x3), .b(new_n40_), .c(new_n23_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n101_), .O(z6));
  oai21  g86(.a(new_n19_), .b(x3), .c(new_n40_), .O(new_n104_));
  oai21  g87(.a(x3), .b(new_n40_), .c(new_n104_), .O(z7));
  aoi21  g88(.a(x2), .b(x1), .c(x0), .O(new_n106_));
  oai21  g89(.a(new_n106_), .b(z8), .c(new_n19_), .O(new_n107_));
