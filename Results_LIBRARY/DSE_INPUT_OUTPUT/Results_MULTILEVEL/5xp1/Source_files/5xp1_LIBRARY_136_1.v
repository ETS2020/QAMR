...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n101_, new_n102_, new_n106_, new_n107_, new_n108_;
  ...
  oai21  g23(.a(x5), .b(x3), .c(x0), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n29_), .O(new_n42_));
  oai21  g25(.a(new_n18_), .b(new_n30_), .c(new_n20_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n42_), .c(new_n40_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n21_), .c(x4), .O(new_n45_));
  ...
  nand2  g52(.a(new_n69_), .b(new_n38_), .O(new_n70_));
  ...
  nand2  g61(.a(new_n46_), .b(new_n64_), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(x6), .c(x4), .O(new_n80_));
  nor2   g63(.a(x3), .b(x2), .O(new_n81_));
  aoi21  g64(.a(x3), .b(x2), .c(x0), .O(new_n82_));
  ...
  nand2  g68(.a(new_n30_), .b(new_n20_), .O(new_n86_));
  ...
  nand2  g73(.a(new_n90_), .b(new_n38_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n85_), .O(z4));
  nand2  g75(.a(x3), .b(new_n29_), .O(new_n93_));
  nand2  g76(.a(new_n30_), .b(x2), .O(new_n94_));
  oai21  g77(.a(new_n93_), .b(new_n38_), .c(new_n94_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n20_), .O(new_n96_));
  inv1   g79(.a(new_n64_), .O(new_n97_));
  aoi21  g80(.a(x3), .b(x1), .c(x2), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n97_), .c(x0), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(new_n96_), .c(new_n27_), .O(z5));
  nand2  g83(.a(new_n93_), .b(x1), .O(new_n101_));
  nand3  g84(.a(x3), .b(new_n29_), .c(new_n38_), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n101_), .c(new_n27_), .O(z6));
  aoi21  g86(.a(new_n94_), .b(new_n93_), .c(new_n26_), .O(z7));
  nand2  g87(.a(new_n27_), .b(x3), .O(z8));
  inv1   g88(.a(x4), .O(new_n106_));
  aoi21  g89(.a(new_n22_), .b(new_n20_), .c(new_n106_), .O(new_n107_));
