...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n112_, new_n113_, new_n114_, new_n116_, new_n117_, new_n121_,
    new_n122_;
  ...
  oai21  g062(.a(new_n18_), .b(new_n44_), .c(new_n19_), .O(new_n80_));
  nand3  g063(.a(new_n80_), .b(new_n32_), .c(new_n23_), .O(new_n81_));
  nand2  g064(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand2  g065(.a(new_n82_), .b(x1), .O(new_n83_));
  oai21  g066(.a(new_n69_), .b(new_n58_), .c(x2), .O(new_n84_));
  nand2  g067(.a(new_n84_), .b(x3), .O(new_n85_));
  nand2  g068(.a(new_n85_), .b(x6), .O(new_n86_));
  nand2  g069(.a(x5), .b(new_n23_), .O(new_n87_));
  nand2  g070(.a(new_n66_), .b(x0), .O(new_n88_));
  aoi21  g071(.a(new_n88_), .b(new_n87_), .c(x3), .O(new_n89_));
  nand2  g072(.a(x6), .b(x2), .O(new_n90_));
  nand2  g073(.a(new_n32_), .b(x0), .O(new_n91_));
  nand2  g074(.a(new_n91_), .b(new_n87_), .O(new_n92_));
  nand3  g075(.a(new_n92_), .b(new_n90_), .c(new_n35_), .O(new_n93_));
  nand4  g076(.a(new_n19_), .b(x5), .c(new_n44_), .d(new_n23_), .O(new_n94_));
  nand2  g077(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nor2   g078(.a(new_n95_), .b(new_n89_), .O(new_n96_));
  nand3  g079(.a(new_n96_), .b(new_n86_), .c(new_n83_), .O(z3));
  inv1   g080(.a(new_n52_), .O(new_n98_));
  nand3  g081(.a(new_n19_), .b(x2), .c(new_n35_), .O(new_n99_));
  oai21  g082(.a(new_n19_), .b(new_n35_), .c(new_n99_), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(x0), .O(new_n101_));
  nand2  g084(.a(new_n39_), .b(new_n23_), .O(new_n102_));
  nand3  g085(.a(new_n102_), .b(new_n90_), .c(new_n78_), .O(new_n103_));
  nand2  g086(.a(new_n103_), .b(x1), .O(new_n104_));
  nand3  g087(.a(new_n19_), .b(x3), .c(x2), .O(new_n105_));
  oai21  g088(.a(new_n19_), .b(x2), .c(new_n105_), .O(new_n106_));
  nand2  g089(.a(new_n106_), .b(new_n35_), .O(new_n107_));
  nand4  g090(.a(new_n107_), .b(new_n104_), .c(new_n101_), .d(new_n98_), .O(z4));
  nand2  g091(.a(x3), .b(new_n44_), .O(new_n109_));
  nand2  g092(.a(new_n18_), .b(x2), .O(new_n110_));
  oai21  g093(.a(new_n109_), .b(new_n35_), .c(new_n110_), .O(new_n111_));
  nand2  g094(.a(new_n111_), .b(new_n23_), .O(new_n112_));
  aoi21  g095(.a(new_n44_), .b(x1), .c(new_n18_), .O(new_n113_));
  oai21  g096(.a(new_n113_), .b(new_n77_), .c(x0), .O(new_n114_));
  nand3  g097(.a(new_n114_), .b(new_n112_), .c(new_n98_), .O(z5));
  nand2  g098(.a(new_n109_), .b(x1), .O(new_n116_));
  nand3  g099(.a(x3), .b(new_n44_), .c(new_n35_), .O(new_n117_));
  nand3  g100(.a(new_n117_), .b(new_n116_), .c(new_n98_), .O(z6));
  nor2   g101(.a(x6), .b(x3), .O(z8));
  oai21  g102(.a(z8), .b(x2), .c(new_n110_), .O(z7));
  oai22  g103(.a(new_n24_), .b(new_n18_), .c(x6), .d(new_n23_), .O(new_n121_));
