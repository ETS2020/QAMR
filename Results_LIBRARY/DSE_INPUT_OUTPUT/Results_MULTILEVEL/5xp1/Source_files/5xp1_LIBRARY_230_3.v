...
module FAU ( 
  ...
  nand3  g57(.a(x3), .b(x2), .c(x1), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(x5), .c(new_n21_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n74_), .c(new_n72_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n22_), .O(new_n78_));
  nand2  g61(.a(x5), .b(new_n39_), .O(new_n79_));
  nand3  g62(.a(x6), .b(new_n18_), .c(x1), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(new_n79_), .c(x0), .O(new_n81_));
  nand2  g64(.a(new_n22_), .b(new_n43_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(x5), .c(x1), .O(new_n83_));
  aoi21  g66(.a(new_n83_), .b(new_n62_), .c(new_n21_), .O(new_n84_));
  ...
  nand2  g78(.a(new_n95_), .b(new_n39_), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n94_), .c(new_n90_), .O(z4));
  nand2  g80(.a(x3), .b(new_n19_), .O(new_n98_));
  nand3  g81(.a(new_n22_), .b(new_n43_), .c(x2), .O(new_n99_));
  oai21  g82(.a(new_n98_), .b(new_n39_), .c(new_n99_), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n21_), .O(new_n101_));
  oai21  g84(.a(new_n43_), .b(new_n39_), .c(new_n19_), .O(new_n102_));
  nand3  g85(.a(new_n22_), .b(x3), .c(x2), .O(new_n103_));
  ...
  nand2  g91(.a(x6), .b(x2), .O(new_n109_));
  nand3  g92(.a(new_n109_), .b(new_n108_), .c(new_n107_), .O(z6));
  nand2  g93(.a(new_n99_), .b(new_n98_), .O(z7));
  nand2  g94(.a(new_n109_), .b(x3), .O(z8));
  aoi21  g95(.a(new_n75_), .b(new_n21_), .c(x6), .O(new_n113_));
  oai21  g96(.a(new_n113_), .b(new_n95_), .c(x5), .O(new_n114_));
  nor2   g97(.a(new_n114_), .b(new_n40_), .O(z9));
endmodule
