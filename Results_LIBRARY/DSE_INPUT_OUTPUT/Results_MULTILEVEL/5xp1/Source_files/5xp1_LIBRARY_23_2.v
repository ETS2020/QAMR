...
module FAU ( 
  ...
  nor3   g68(.a(new_n85_), .b(x6), .c(new_n48_), .O(new_n86_));
  nor2   g69(.a(new_n85_), .b(new_n48_), .O(new_n87_));
  nor2   g70(.a(new_n87_), .b(new_n18_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n86_), .c(new_n21_), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n84_), .c(new_n35_), .O(z4));
  nand2  g73(.a(x3), .b(new_n48_), .O(new_n91_));
  nand2  g74(.a(new_n49_), .b(x2), .O(new_n92_));
  ...
  nand3  g80(.a(new_n97_), .b(new_n94_), .c(new_n35_), .O(z5));
  nand2  g81(.a(new_n91_), .b(x1), .O(new_n99_));
  nand3  g82(.a(x3), .b(new_n48_), .c(new_n21_), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(new_n99_), .c(new_n34_), .O(z6));
  nand3  g84(.a(new_n92_), .b(new_n91_), .c(new_n35_), .O(z7));
  nand2  g85(.a(new_n35_), .b(x3), .O(z8));
  aoi21  g86(.a(x6), .b(new_n25_), .c(new_n19_), .O(z9));
endmodule
