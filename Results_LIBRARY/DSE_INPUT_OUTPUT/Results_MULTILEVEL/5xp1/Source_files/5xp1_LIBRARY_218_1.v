...
module FAU ( 
  ...
  nor2   g59(.a(new_n29_), .b(new_n18_), .O(new_n77_));
  nor2   g60(.a(new_n77_), .b(new_n19_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n21_), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n76_), .c(new_n72_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n20_), .O(new_n81_));
  nand3  g64(.a(new_n19_), .b(x3), .c(new_n21_), .O(new_n82_));
  aoi22  g65(.a(new_n82_), .b(new_n52_), .c(new_n20_), .d(new_n28_), .O(new_n83_));
  ...
  nand2  g72(.a(new_n29_), .b(new_n21_), .O(new_n90_));
  nor2   g73(.a(new_n20_), .b(x3), .O(new_n91_));
  aoi22  g74(.a(new_n91_), .b(new_n45_), .c(new_n90_), .d(new_n89_), .O(new_n92_));
  nand2  g75(.a(new_n29_), .b(new_n18_), .O(new_n93_));
  oai21  g76(.a(new_n77_), .b(x0), .c(new_n93_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n20_), .c(x1), .O(new_n95_));
  oai21  g78(.a(new_n92_), .b(new_n18_), .c(new_n95_), .O(z4));
  ...
  oai21  g83(.a(new_n100_), .b(new_n77_), .c(x0), .O(new_n101_));
  nand2  g84(.a(x6), .b(new_n18_), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n101_), .c(new_n99_), .O(z5));
  aoi21  g86(.a(x3), .b(new_n28_), .c(x6), .O(new_n104_));
  nand3  g87(.a(new_n20_), .b(x3), .c(new_n18_), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(x1), .O(new_n106_));
  oai21  g89(.a(new_n104_), .b(x2), .c(new_n106_), .O(z6));
  oai21  g90(.a(x6), .b(x3), .c(new_n18_), .O(new_n108_));
  oai21  g91(.a(x3), .b(new_n18_), .c(new_n108_), .O(z7));
  nand2  g92(.a(new_n102_), .b(x3), .O(z8));
  aoi21  g93(.a(x5), .b(x4), .c(new_n18_), .O(new_n111_));
  nand2  g94(.a(new_n40_), .b(new_n21_), .O(new_n112_));
  nand3  g95(.a(new_n112_), .b(x5), .c(x4), .O(new_n113_));
  oai21  g96(.a(new_n111_), .b(new_n20_), .c(new_n113_), .O(z9));
endmodule
