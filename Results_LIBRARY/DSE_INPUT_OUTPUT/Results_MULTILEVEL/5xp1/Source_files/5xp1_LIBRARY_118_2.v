...
module FAU ( 
  ...
  nand2  g57(.a(new_n34_), .b(new_n33_), .O(new_n75_));
  ...
  oai21  g66(.a(new_n81_), .b(new_n33_), .c(x6), .O(new_n84_));
  ...
  inv1   g70(.a(new_n72_), .O(new_n88_));
  nand2  g71(.a(x3), .b(new_n33_), .O(new_n89_));
  nand2  g72(.a(new_n34_), .b(x2), .O(new_n90_));
  oai21  g73(.a(new_n89_), .b(new_n22_), .c(new_n90_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n21_), .O(new_n92_));
  aoi21  g75(.a(x3), .b(x1), .c(x2), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n63_), .c(x0), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n92_), .c(new_n88_), .O(z5));
  nand2  g78(.a(new_n89_), .b(x1), .O(new_n96_));
  nand3  g79(.a(x3), .b(new_n33_), .c(new_n22_), .O(new_n97_));
  aoi21  g80(.a(new_n97_), .b(new_n96_), .c(new_n72_), .O(z6));
  aoi21  g81(.a(new_n90_), .b(new_n89_), .c(new_n72_), .O(z7));
