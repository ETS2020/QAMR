...
module FAU ( 
  ...
  aoi22  g77(.a(new_n86_), .b(new_n85_), .c(x6), .d(new_n64_), .O(z7));
  aoi21  g78(.a(x6), .b(new_n64_), .c(x3), .O(z8));
  oai21  g79(.a(new_n25_), .b(x6), .c(x1), .O(new_n98_));
  oai21  g80(.a(x6), .b(new_n23_), .c(new_n98_), .O(new_n99_));
  nand3  g81(.a(new_n99_), .b(x5), .c(x4), .O(new_n100_));
  inv1   g82(.a(new_n100_), .O(z9));
endmodule
