...
module FAU ( 
  ...
  aoi21  g67(.a(new_n84_), .b(new_n33_), .c(new_n24_), .O(new_n85_));
  ...
  nor2   g78(.a(x3), .b(new_n33_), .O(new_n96_));
  aoi21  g79(.a(new_n95_), .b(x1), .c(new_n96_), .O(new_n97_));
  nand2  g80(.a(new_n86_), .b(x6), .O(new_n98_));
  ...
  nand2  g85(.a(new_n95_), .b(new_n25_), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n102_), .c(new_n92_), .O(z6));
