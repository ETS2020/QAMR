...
module FAU ( 
  ...
  oai21  g53(.a(new_n31_), .b(new_n20_), .c(x5), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(x6), .O(new_n72_));
  nand2  g55(.a(new_n33_), .b(x1), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n18_), .c(x0), .O(new_n74_));
  oai21  g57(.a(new_n21_), .b(new_n26_), .c(new_n27_), .O(new_n75_));
  nand2  g58(.a(new_n21_), .b(new_n26_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(x5), .c(new_n20_), .O(new_n78_));
  nand4  g61(.a(new_n78_), .b(new_n74_), .c(new_n72_), .d(new_n70_), .O(z3));
  nand2  g62(.a(new_n43_), .b(new_n27_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(x6), .c(x5), .O(new_n81_));
  nor2   g64(.a(x3), .b(x2), .O(new_n82_));
  aoi21  g65(.a(new_n27_), .b(new_n20_), .c(new_n82_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(x6), .c(new_n81_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(x1), .O(new_n85_));
  nand2  g68(.a(new_n32_), .b(new_n20_), .O(new_n86_));
  ...
  nand3  g82(.a(new_n99_), .b(new_n98_), .c(new_n96_), .O(z5));
  nand2  g83(.a(new_n93_), .b(x1), .O(new_n101_));
  nand3  g84(.a(x3), .b(new_n31_), .c(new_n26_), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n101_), .c(new_n99_), .O(z6));
  nand3  g86(.a(new_n99_), .b(new_n94_), .c(new_n93_), .O(z7));
  nand2  g87(.a(new_n99_), .b(x3), .O(z8));
