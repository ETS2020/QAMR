...
module FAU ( 
  ...
  inv1   g08(.a(x3), .O(z8));
  nor2   g09(.a(new_n20_), .b(z8), .O(new_n27_));
  ...
  nand3  g32(.a(new_n20_), .b(x4), .c(z8), .O(new_n50_));
  ...
  oai21  g41(.a(x6), .b(new_n39_), .c(z8), .O(new_n59_));
  ...
  nand4  g57(.a(new_n25_), .b(z8), .c(new_n39_), .d(x0), .O(new_n75_));
  ...
  oai21  g68(.a(new_n85_), .b(new_n81_), .c(z8), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n78_), .O(z3));
  xor2a  g70(.a(x6), .b(x1), .O(new_n88_));
  oai22  g71(.a(new_n88_), .b(new_n19_), .c(z8), .d(x1), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(x2), .O(new_n90_));
  nand3  g73(.a(new_n20_), .b(z8), .c(x1), .O(new_n91_));
  ...
  nand2  g78(.a(new_n39_), .b(x1), .O(new_n96_));
  nand2  g79(.a(new_n20_), .b(x3), .O(new_n97_));
  oai22  g80(.a(new_n97_), .b(new_n96_), .c(x3), .d(new_n39_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n19_), .O(new_n99_));
  nor2   g82(.a(x3), .b(x2), .O(new_n100_));
  aoi21  g83(.a(new_n39_), .b(x1), .c(x6), .O(new_n101_));
  aoi21  g84(.a(new_n101_), .b(x3), .c(new_n100_), .O(new_n102_));
  oai21  g85(.a(new_n102_), .b(new_n19_), .c(new_n99_), .O(z5));
  aoi21  g86(.a(new_n20_), .b(x2), .c(z8), .O(new_n104_));
  oai22  g87(.a(new_n104_), .b(new_n31_), .c(new_n97_), .d(new_n82_), .O(z6));
  nand2  g88(.a(new_n97_), .b(x2), .O(new_n106_));
  oai21  g89(.a(z8), .b(x2), .c(new_n106_), .O(z7));
  nand4  g90(.a(x5), .b(x4), .c(x2), .d(x1), .O(new_n108_));
