...
module FAU ( 
  ...
  nand2  g060(.a(new_n18_), .b(new_n45_), .O(new_n78_));
  ...
  oai21  g081(.a(new_n29_), .b(new_n37_), .c(new_n98_), .O(new_n99_));
  nand2  g082(.a(new_n99_), .b(x0), .O(new_n100_));
  oai21  g083(.a(x6), .b(x2), .c(x3), .O(new_n101_));
  ...
  oai21  g088(.a(new_n29_), .b(x2), .c(new_n105_), .O(new_n106_));
  aoi21  g089(.a(new_n106_), .b(new_n37_), .c(new_n52_), .O(new_n107_));
  ...
  oai21  g098(.a(new_n115_), .b(new_n69_), .c(x0), .O(new_n116_));
  ...
  aoi21  g106(.a(x5), .b(x4), .c(new_n18_), .O(new_n124_));
  nand2  g107(.a(new_n32_), .b(new_n19_), .O(new_n125_));
  nand3  g108(.a(new_n125_), .b(x5), .c(x4), .O(new_n126_));
  oai21  g109(.a(new_n124_), .b(new_n29_), .c(new_n126_), .O(z9));
endmodule
