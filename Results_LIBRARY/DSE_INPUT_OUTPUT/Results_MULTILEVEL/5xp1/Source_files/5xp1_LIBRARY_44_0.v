...
module FAU ( 
  ...
  oai21  g33(.a(new_n50_), .b(new_n20_), .c(new_n18_), .O(new_n51_));
  ...
  nand2  g63(.a(z8), .b(new_n33_), .O(new_n81_));
  ...
  nand2  g76(.a(new_n67_), .b(new_n19_), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(x3), .c(x6), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n93_), .c(x1), .O(new_n96_));
  aoi21  g79(.a(new_n20_), .b(x3), .c(x2), .O(new_n97_));
  oai22  g80(.a(x6), .b(new_n67_), .c(x3), .d(x0), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n97_), .c(new_n33_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n96_), .O(z4));
  nand2  g83(.a(x3), .b(new_n67_), .O(new_n101_));
  inv1   g84(.a(new_n101_), .O(new_n102_));
  aoi22  g85(.a(new_n102_), .b(x1), .c(z8), .d(x2), .O(new_n103_));
  aoi21  g86(.a(new_n67_), .b(x1), .c(new_n18_), .O(new_n104_));
  nand2  g87(.a(z8), .b(new_n67_), .O(new_n105_));
  inv1   g88(.a(new_n105_), .O(new_n106_));
  oai21  g89(.a(new_n106_), .b(new_n104_), .c(x0), .O(new_n107_));
  oai21  g90(.a(new_n103_), .b(x0), .c(new_n107_), .O(z5));
  aoi21  g91(.a(new_n102_), .b(new_n33_), .c(new_n30_), .O(new_n109_));
  oai21  g92(.a(new_n102_), .b(new_n33_), .c(new_n109_), .O(z6));
  nand2  g93(.a(new_n18_), .b(x2), .O(new_n111_));
  oai21  g94(.a(z8), .b(x2), .c(new_n111_), .O(z7));
  inv1   g95(.a(new_n30_), .O(new_n113_));
  ...
  nand2  g99(.a(new_n116_), .b(new_n113_), .O(z9));
endmodule
