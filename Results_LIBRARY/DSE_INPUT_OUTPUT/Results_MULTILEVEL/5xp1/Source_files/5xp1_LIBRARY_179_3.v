...
module FAU ( 
  ...
  nand3  g67(.a(new_n25_), .b(new_n39_), .c(new_n31_), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n84_), .c(new_n19_), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n81_), .c(new_n26_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n78_), .O(z3));
  xor2a  g71(.a(x6), .b(x1), .O(new_n89_));
  oai22  g72(.a(new_n89_), .b(new_n19_), .c(new_n26_), .d(x1), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(x2), .O(new_n91_));
  nand3  g74(.a(new_n20_), .b(new_n26_), .c(x1), .O(new_n92_));
  oai21  g75(.a(new_n20_), .b(x1), .c(new_n92_), .O(new_n93_));
  oai21  g76(.a(new_n39_), .b(new_n19_), .c(new_n93_), .O(new_n94_));
  nand4  g77(.a(new_n20_), .b(new_n39_), .c(x1), .d(new_n19_), .O(new_n95_));
  nand4  g78(.a(new_n95_), .b(new_n94_), .c(new_n91_), .d(new_n30_), .O(z4));
  nand2  g79(.a(new_n39_), .b(x1), .O(new_n97_));
  nand2  g80(.a(new_n20_), .b(x3), .O(z8));
  oai22  g81(.a(z8), .b(new_n97_), .c(x3), .d(new_n39_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n19_), .O(new_n100_));
  nor2   g83(.a(x3), .b(x2), .O(new_n101_));
  aoi21  g84(.a(new_n39_), .b(x1), .c(x6), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(x3), .c(new_n101_), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(new_n19_), .c(new_n100_), .O(z5));
  oai21  g87(.a(new_n82_), .b(x6), .c(x3), .O(new_n105_));
  oai21  g88(.a(z8), .b(x2), .c(x1), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n105_), .O(z6));
  nand2  g90(.a(z8), .b(x2), .O(new_n108_));
  oai21  g91(.a(new_n26_), .b(x2), .c(new_n108_), .O(z7));
  aoi21  g92(.a(new_n21_), .b(new_n19_), .c(x6), .O(new_n110_));
  nor2   g93(.a(new_n20_), .b(x3), .O(new_n111_));
  oai21  g94(.a(new_n111_), .b(new_n110_), .c(x5), .O(new_n112_));
  nor2   g95(.a(new_n112_), .b(new_n32_), .O(z9));
endmodule
