...
module FAU ( 
  ...
  aoi21  g16(.a(new_n32_), .b(x5), .c(new_n33_), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n30_), .O(z1));
  inv1   g18(.a(x2), .O(new_n36_));
  aoi22  g19(.a(new_n22_), .b(new_n20_), .c(new_n25_), .d(new_n36_), .O(new_n37_));
  oai22  g20(.a(new_n37_), .b(x1), .c(x5), .d(x0), .O(new_n38_));
  ...
  aoi21  g27(.a(new_n25_), .b(new_n20_), .c(new_n19_), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n44_), .c(x1), .O(new_n46_));
  oai21  g29(.a(x5), .b(x2), .c(x0), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n43_), .c(x6), .O(new_n48_));
  nor2   g31(.a(x6), .b(new_n25_), .O(new_n49_));
  aoi22  g32(.a(new_n49_), .b(x0), .c(new_n48_), .d(x4), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n46_), .c(new_n39_), .O(z2));
  oai21  g34(.a(x4), .b(new_n21_), .c(new_n18_), .O(new_n52_));
  nand3  g35(.a(new_n25_), .b(x3), .c(new_n20_), .O(new_n53_));
  oai21  g36(.a(new_n25_), .b(new_n20_), .c(new_n53_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n52_), .c(x2), .O(new_n55_));
  oai21  g38(.a(x4), .b(new_n40_), .c(new_n18_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(x1), .c(x0), .O(new_n57_));
  inv1   g40(.a(new_n57_), .O(new_n58_));
  nor2   g41(.a(new_n18_), .b(x1), .O(new_n59_));
  nor2   g42(.a(x6), .b(x4), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n59_), .c(new_n22_), .O(new_n61_));
  nand2  g44(.a(new_n60_), .b(new_n21_), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n61_), .c(x0), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n58_), .c(x5), .O(new_n64_));
  nand2  g47(.a(new_n18_), .b(new_n19_), .O(new_n65_));
  nand2  g48(.a(x6), .b(new_n36_), .O(new_n66_));
  aoi21  g49(.a(new_n66_), .b(new_n65_), .c(x1), .O(new_n67_));
  nand3  g50(.a(new_n60_), .b(new_n40_), .c(new_n36_), .O(new_n68_));
  inv1   g51(.a(new_n68_), .O(new_n69_));
  oai21  g52(.a(new_n69_), .b(new_n67_), .c(x0), .O(new_n70_));
  nand3  g53(.a(x6), .b(x1), .c(new_n20_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n25_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n64_), .c(new_n55_), .O(z3));
  nand2  g57(.a(new_n42_), .b(new_n22_), .O(new_n75_));
  nand2  g58(.a(new_n22_), .b(new_n20_), .O(new_n76_));
  aoi21  g59(.a(new_n41_), .b(new_n76_), .c(x6), .O(new_n77_));
  aoi22  g60(.a(new_n77_), .b(new_n19_), .c(new_n75_), .d(x6), .O(new_n78_));
  nor2   g61(.a(x3), .b(x0), .O(new_n79_));
  nor2   g62(.a(new_n79_), .b(x6), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n19_), .c(x2), .O(new_n81_));
  oai21  g64(.a(new_n79_), .b(new_n36_), .c(x6), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n21_), .O(new_n84_));
  oai21  g67(.a(new_n78_), .b(new_n21_), .c(new_n84_), .O(z4));
  nand2  g68(.a(x3), .b(new_n36_), .O(new_n86_));
  nand2  g69(.a(new_n40_), .b(x2), .O(new_n87_));
  ...
  aoi21  g75(.a(new_n92_), .b(new_n89_), .c(new_n33_), .O(z5));
  nand2  g76(.a(new_n86_), .b(x1), .O(new_n94_));
  nand3  g77(.a(x3), .b(new_n36_), .c(new_n21_), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n94_), .c(new_n33_), .O(z6));
  aoi21  g79(.a(new_n87_), .b(new_n86_), .c(new_n33_), .O(z7));
  nor2   g80(.a(new_n33_), .b(x3), .O(z8));
