...
module FAU ( 
  ...
  nand2  g58(.a(new_n43_), .b(new_n22_), .O(new_n76_));
  nand2  g59(.a(new_n22_), .b(new_n20_), .O(new_n77_));
  aoi21  g60(.a(new_n42_), .b(new_n77_), .c(x6), .O(new_n78_));
  aoi22  g61(.a(new_n78_), .b(new_n19_), .c(new_n76_), .d(x6), .O(new_n79_));
  ...
  oai21  g68(.a(new_n79_), .b(new_n21_), .c(new_n85_), .O(z4));
  ...
  nand3  g78(.a(x3), .b(new_n37_), .c(new_n21_), .O(new_n96_));
