...
module FAU ( 
  ...
  aoi21  g86(.a(x6), .b(new_n73_), .c(x2), .O(new_n104_));
  nand4  g87(.a(x6), .b(x3), .c(new_n18_), .d(new_n33_), .O(new_n105_));
  oai21  g88(.a(new_n104_), .b(new_n33_), .c(new_n105_), .O(z6));
  or2    g89(.a(new_n104_), .b(new_n98_), .O(z7));
