...
module FAU ( 
  ...
  nand3  g37(.a(new_n54_), .b(new_n18_), .c(new_n19_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n47_), .O(z2));
  nand2  g39(.a(new_n18_), .b(new_n21_), .O(new_n57_));
  nand3  g40(.a(new_n25_), .b(x3), .c(new_n20_), .O(new_n58_));
  ...
  nand3  g44(.a(x6), .b(new_n25_), .c(new_n20_), .O(new_n62_));
  oai21  g45(.a(new_n61_), .b(new_n20_), .c(new_n62_), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(x1), .O(new_n64_));
  nor2   g47(.a(new_n18_), .b(new_n49_), .O(new_n65_));
  xnor2a g48(.a(x5), .b(x0), .O(new_n66_));
  nand3  g49(.a(x5), .b(new_n50_), .c(new_n20_), .O(new_n67_));
  ...
  nand4  g53(.a(new_n25_), .b(new_n50_), .c(new_n49_), .d(x0), .O(new_n71_));
  ...
  aoi21  g59(.a(new_n76_), .b(new_n22_), .c(new_n18_), .O(new_n77_));
  ...
  oai21  g67(.a(new_n84_), .b(new_n82_), .c(new_n21_), .O(new_n85_));
  ...
  inv1   g73(.a(new_n22_), .O(new_n91_));
  ...
  nand3  g78(.a(x3), .b(new_n49_), .c(new_n21_), .O(new_n96_));
  ...
  aoi21  g82(.a(x6), .b(new_n25_), .c(new_n19_), .O(z9));
endmodule
