...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n100_, new_n102_, new_n103_, new_n104_, new_n106_, new_n109_,
  ...
  nand2  g86(.a(x3), .b(new_n33_), .O(new_n104_));
  oai21  g87(.a(new_n104_), .b(x1), .c(new_n103_), .O(z6));
  inv1   g88(.a(new_n70_), .O(new_n106_));
  aoi21  g89(.a(new_n104_), .b(new_n98_), .c(new_n106_), .O(z7));
  nor2   g90(.a(new_n106_), .b(x3), .O(z8));
  nand2  g91(.a(x5), .b(x4), .O(new_n109_));
  oai21  g92(.a(new_n109_), .b(new_n20_), .c(new_n23_), .O(new_n110_));
  nand2  g93(.a(new_n110_), .b(x1), .O(new_n111_));
  nand2  g94(.a(new_n23_), .b(new_n19_), .O(new_n112_));
