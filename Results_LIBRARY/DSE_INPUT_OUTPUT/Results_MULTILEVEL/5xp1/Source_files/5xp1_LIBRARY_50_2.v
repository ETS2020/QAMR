...
module FAU ( 
  ...
  aoi21  g58(.a(new_n43_), .b(new_n24_), .c(new_n19_), .O(new_n76_));
  ...
  nor2   g65(.a(new_n82_), .b(new_n19_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n81_), .c(new_n23_), .O(new_n84_));
  ...
  nand3  g75(.a(new_n92_), .b(new_n89_), .c(new_n35_), .O(z5));
  nand2  g76(.a(new_n86_), .b(x1), .O(new_n94_));
  nand3  g77(.a(x3), .b(new_n37_), .c(new_n23_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n94_), .c(new_n35_), .O(z6));
  nand3  g79(.a(new_n87_), .b(new_n86_), .c(new_n35_), .O(z7));
  nor2   g80(.a(new_n34_), .b(x3), .O(z8));
  aoi21  g81(.a(x6), .b(new_n18_), .c(new_n21_), .O(z9));
endmodule
