...
module FAU ( 
  ...
  oai21  g88(.a(new_n105_), .b(new_n65_), .c(x0), .O(new_n106_));
  nand3  g89(.a(new_n106_), .b(new_n104_), .c(new_n101_), .O(z5));
  oai21  g90(.a(new_n78_), .b(new_n71_), .c(x1), .O(new_n108_));
  nand3  g91(.a(x3), .b(new_n40_), .c(new_n23_), .O(new_n109_));
  nand2  g92(.a(new_n109_), .b(new_n108_), .O(z6));
  nand2  g93(.a(z8), .b(x2), .O(new_n111_));
  oai21  g94(.a(new_n78_), .b(x2), .c(new_n111_), .O(z7));
  aoi21  g95(.a(x2), .b(x1), .c(x0), .O(new_n113_));
  oai21  g96(.a(new_n113_), .b(z8), .c(new_n19_), .O(new_n114_));
