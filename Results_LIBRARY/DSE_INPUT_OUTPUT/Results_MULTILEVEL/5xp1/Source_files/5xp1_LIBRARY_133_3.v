...
module FAU ( 
  ...
  aoi21  g68(.a(new_n45_), .b(new_n35_), .c(new_n22_), .O(new_n86_));
  nand2  g69(.a(new_n59_), .b(new_n30_), .O(new_n87_));
  nand2  g70(.a(new_n35_), .b(new_n18_), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n87_), .c(x6), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n86_), .c(x1), .O(new_n90_));
  nor2   g73(.a(x3), .b(x0), .O(new_n91_));
  nor3   g74(.a(new_n91_), .b(x6), .c(new_n30_), .O(new_n92_));
  nor2   g75(.a(new_n91_), .b(new_n30_), .O(new_n93_));
  nor2   g76(.a(new_n93_), .b(new_n22_), .O(new_n94_));
  oai21  g77(.a(new_n94_), .b(new_n92_), .c(new_n29_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n90_), .c(new_n43_), .O(z4));
  nand2  g79(.a(x3), .b(new_n30_), .O(new_n97_));
  nand2  g80(.a(new_n59_), .b(x2), .O(new_n98_));
  oai21  g81(.a(new_n97_), .b(new_n29_), .c(new_n98_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n18_), .O(new_n100_));
  aoi21  g83(.a(x3), .b(x1), .c(x2), .O(new_n101_));
  oai21  g84(.a(new_n101_), .b(new_n52_), .c(x0), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n100_), .c(new_n43_), .O(z5));
  nand2  g86(.a(new_n97_), .b(x1), .O(new_n104_));
  nand3  g87(.a(x3), .b(new_n30_), .c(new_n29_), .O(new_n105_));
  aoi21  g88(.a(new_n105_), .b(new_n104_), .c(new_n42_), .O(z6));
  nand3  g89(.a(new_n98_), .b(new_n97_), .c(new_n43_), .O(z7));
  nand2  g90(.a(new_n43_), .b(x3), .O(z8));
  nand2  g91(.a(new_n19_), .b(new_n18_), .O(new_n109_));
  nand4  g92(.a(new_n109_), .b(new_n22_), .c(x5), .d(x4), .O(new_n110_));
