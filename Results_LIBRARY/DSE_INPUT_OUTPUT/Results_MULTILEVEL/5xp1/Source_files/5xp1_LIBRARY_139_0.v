...
module FAU ( 
  ...
  oai21  g75(.a(new_n90_), .b(new_n57_), .c(x6), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n24_), .O(new_n95_));
  oai21  g78(.a(new_n89_), .b(new_n24_), .c(new_n95_), .O(z4));
  nand2  g79(.a(x3), .b(new_n57_), .O(new_n97_));
  ...
  aoi21  g85(.a(new_n102_), .b(new_n100_), .c(new_n43_), .O(z5));
  nand2  g86(.a(new_n97_), .b(x1), .O(new_n104_));
  nand3  g87(.a(x3), .b(new_n57_), .c(new_n24_), .O(new_n105_));
  nand3  g88(.a(new_n105_), .b(new_n104_), .c(new_n44_), .O(z6));
  nand3  g89(.a(new_n98_), .b(new_n97_), .c(new_n44_), .O(z7));
  nor2   g90(.a(new_n43_), .b(x3), .O(z8));
  nand2  g91(.a(new_n22_), .b(new_n19_), .O(new_n109_));
  nand3  g92(.a(new_n109_), .b(x5), .c(x4), .O(new_n110_));
  nand2  g93(.a(new_n110_), .b(new_n44_), .O(z9));
endmodule
