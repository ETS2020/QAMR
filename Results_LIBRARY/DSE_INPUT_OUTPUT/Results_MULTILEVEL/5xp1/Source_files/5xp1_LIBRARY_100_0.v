...
module FAU ( 
  ...
  oai21  g57(.a(new_n25_), .b(x0), .c(x6), .O(new_n75_));
  nor2   g58(.a(new_n35_), .b(x6), .O(new_n76_));
  aoi22  g59(.a(new_n76_), .b(new_n21_), .c(new_n75_), .d(new_n18_), .O(new_n77_));
  ...
  oai21  g79(.a(new_n95_), .b(new_n25_), .c(new_n96_), .O(new_n97_));
  ...
  nand3  g85(.a(x3), .b(new_n79_), .c(new_n25_), .O(new_n103_));
  aoi21  g86(.a(new_n103_), .b(new_n102_), .c(new_n92_), .O(z6));
  nand3  g87(.a(new_n96_), .b(new_n95_), .c(new_n93_), .O(z7));
