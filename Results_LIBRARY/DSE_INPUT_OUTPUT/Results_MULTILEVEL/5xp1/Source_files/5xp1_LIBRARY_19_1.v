...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n101_, new_n102_, new_n103_, new_n107_, new_n108_;
  ...
  nand4  g50(.a(new_n19_), .b(new_n29_), .c(x3), .d(new_n18_), .O(new_n68_));
  ...
  nand2  g55(.a(new_n34_), .b(x1), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n29_), .c(x0), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n36_), .O(new_n75_));
  nand3  g58(.a(x6), .b(x2), .c(x0), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n25_), .c(new_n29_), .O(new_n77_));
  aoi21  g60(.a(new_n75_), .b(new_n19_), .c(new_n77_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n72_), .O(z3));
  nand2  g62(.a(new_n45_), .b(new_n24_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(x6), .c(x5), .O(new_n81_));
  nor2   g64(.a(x3), .b(x2), .O(new_n82_));
  aoi21  g65(.a(new_n24_), .b(new_n18_), .c(new_n82_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(x6), .c(new_n81_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(x1), .O(new_n85_));
  nand2  g68(.a(new_n33_), .b(new_n18_), .O(new_n86_));
  ...
  aoi21  g82(.a(new_n99_), .b(new_n96_), .c(new_n42_), .O(z5));
  inv1   g83(.a(new_n42_), .O(new_n101_));
  ...
  nand3  g87(.a(new_n94_), .b(new_n93_), .c(new_n101_), .O(z7));
