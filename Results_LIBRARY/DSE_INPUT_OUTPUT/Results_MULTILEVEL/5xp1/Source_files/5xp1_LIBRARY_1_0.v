...
module FAU ( 
  ...
  nand4  g23(.a(new_n21_), .b(new_n20_), .c(x4), .d(x2), .O(new_n41_));
  inv1   g24(.a(x1), .O(new_n42_));
  nand2  g25(.a(x3), .b(x2), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n23_), .c(new_n42_), .O(new_n44_));
  aoi21  g27(.a(new_n44_), .b(new_n41_), .c(x0), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n33_), .c(x5), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n40_), .c(new_n30_), .O(z1));
  inv1   g30(.a(x3), .O(new_n48_));
  oai21  g31(.a(new_n29_), .b(new_n48_), .c(new_n19_), .O(new_n49_));
  oai22  g32(.a(new_n38_), .b(new_n18_), .c(new_n34_), .d(new_n42_), .O(new_n50_));
  ...
  aoi21  g39(.a(new_n56_), .b(new_n49_), .c(x6), .O(new_n57_));
  ...
  nand3  g46(.a(new_n20_), .b(x5), .c(x0), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n62_), .c(new_n23_), .O(new_n66_));
  nand4  g49(.a(new_n66_), .b(new_n58_), .c(new_n51_), .d(new_n30_), .O(z2));
  xnor2a g50(.a(x6), .b(x2), .O(new_n68_));
  xnor2a g51(.a(x5), .b(x0), .O(new_n69_));
  nand4  g52(.a(x5), .b(new_n48_), .c(x2), .d(new_n19_), .O(new_n70_));
  ...
  aoi22  g56(.a(new_n73_), .b(new_n55_), .c(new_n20_), .d(new_n42_), .O(new_n74_));
  nand4  g57(.a(new_n20_), .b(x5), .c(new_n48_), .d(new_n19_), .O(new_n75_));
  inv1   g58(.a(new_n75_), .O(new_n76_));
  oai21  g59(.a(new_n76_), .b(new_n74_), .c(x2), .O(new_n77_));
  nand2  g60(.a(new_n29_), .b(new_n19_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n55_), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(x6), .c(x1), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n77_), .c(new_n72_), .O(z3));
  nand3  g64(.a(new_n20_), .b(x2), .c(x1), .O(new_n82_));
  oai21  g65(.a(new_n20_), .b(x1), .c(new_n82_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n48_), .c(new_n19_), .O(new_n84_));
  nand2  g67(.a(new_n48_), .b(new_n19_), .O(new_n85_));
  xnor2a g68(.a(x6), .b(x1), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n85_), .c(x2), .O(new_n87_));
  oai22  g70(.a(new_n21_), .b(new_n19_), .c(x2), .d(x1), .O(new_n88_));
  ...
  oai21  g78(.a(new_n95_), .b(x2), .c(new_n43_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(x0), .O(new_n97_));
  nand3  g80(.a(new_n97_), .b(new_n94_), .c(new_n30_), .O(z5));
  aoi21  g81(.a(x3), .b(new_n42_), .c(new_n20_), .O(new_n99_));
  nor3   g82(.a(new_n20_), .b(new_n48_), .c(x2), .O(new_n100_));
  oai22  g83(.a(new_n100_), .b(new_n42_), .c(new_n99_), .d(x2), .O(z6));
  or2    g84(.a(new_n100_), .b(new_n93_), .O(z7));
  nand2  g85(.a(new_n30_), .b(x3), .O(z8));
  nand3  g86(.a(new_n21_), .b(new_n20_), .c(new_n19_), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(x5), .c(x4), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(new_n30_), .O(z9));
endmodule
