...
module FAU ( 
  ...
  nand2  g24(.a(new_n30_), .b(new_n18_), .O(new_n42_));
  ...
  nand3  g34(.a(new_n51_), .b(new_n30_), .c(new_n18_), .O(new_n52_));
  inv1   g35(.a(new_n21_), .O(new_n53_));
  nand2  g36(.a(x6), .b(new_n20_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(new_n18_), .c(new_n53_), .O(new_n55_));
  oai21  g38(.a(new_n23_), .b(new_n20_), .c(x4), .O(new_n56_));
  oai21  g39(.a(new_n30_), .b(x5), .c(new_n56_), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n55_), .c(new_n19_), .O(new_n58_));
  inv1   g41(.a(x2), .O(new_n59_));
  aoi21  g42(.a(x6), .b(new_n59_), .c(x4), .O(new_n60_));
  inv1   g43(.a(x3), .O(new_n61_));
  nand3  g44(.a(x4), .b(new_n61_), .c(new_n59_), .O(new_n62_));
  oai21  g45(.a(new_n60_), .b(x1), .c(new_n62_), .O(new_n63_));
  nor2   g46(.a(new_n30_), .b(new_n18_), .O(new_n64_));
  aoi21  g47(.a(new_n63_), .b(new_n23_), .c(new_n64_), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(new_n58_), .c(new_n52_), .O(z2));
  inv1   g49(.a(new_n64_), .O(new_n67_));
  inv1   g50(.a(new_n40_), .O(new_n68_));
  nand3  g51(.a(new_n23_), .b(x3), .c(new_n19_), .O(new_n69_));
  ...
  nor2   g55(.a(new_n72_), .b(new_n19_), .O(new_n73_));
  ...
  oai21  g60(.a(new_n30_), .b(new_n59_), .c(new_n20_), .O(new_n78_));
  nand3  g61(.a(new_n30_), .b(new_n61_), .c(new_n59_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n78_), .c(new_n19_), .O(new_n80_));
  nor2   g63(.a(new_n74_), .b(x0), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n80_), .c(new_n23_), .O(new_n82_));
  nand4  g65(.a(new_n82_), .b(new_n77_), .c(new_n71_), .d(new_n67_), .O(z3));
  nand2  g66(.a(new_n46_), .b(new_n21_), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(x6), .c(new_n18_), .O(new_n85_));
  nor2   g68(.a(x3), .b(x2), .O(new_n86_));
  aoi21  g69(.a(x3), .b(x2), .c(x0), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n86_), .c(new_n30_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(x1), .O(new_n90_));
  nand2  g73(.a(new_n61_), .b(new_n19_), .O(new_n91_));
  ...
  nand2  g79(.a(new_n96_), .b(new_n90_), .O(z4));
  nand2  g80(.a(x3), .b(new_n59_), .O(new_n98_));
  nand2  g81(.a(new_n61_), .b(x2), .O(new_n99_));
  ...
  oai21  g85(.a(new_n102_), .b(new_n53_), .c(x0), .O(new_n103_));
  aoi21  g86(.a(new_n103_), .b(new_n101_), .c(new_n64_), .O(z5));
  nand2  g87(.a(new_n98_), .b(x1), .O(new_n105_));
  nand3  g88(.a(x3), .b(new_n59_), .c(new_n20_), .O(new_n106_));
  nand3  g89(.a(new_n106_), .b(new_n105_), .c(new_n67_), .O(z6));
  aoi21  g90(.a(new_n99_), .b(new_n98_), .c(new_n64_), .O(z7));
  nand2  g91(.a(new_n67_), .b(x3), .O(z8));
  nand2  g92(.a(new_n22_), .b(x5), .O(new_n110_));
  aoi21  g93(.a(new_n110_), .b(new_n30_), .c(new_n18_), .O(z9));
endmodule
