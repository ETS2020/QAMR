...
module FAU ( 
  ...
  nand3  g34(.a(new_n23_), .b(new_n51_), .c(new_n19_), .O(new_n52_));
  ...
  oai22  g56(.a(new_n73_), .b(new_n47_), .c(new_n71_), .d(x1), .O(new_n74_));
  xnor2a g57(.a(x5), .b(x0), .O(new_n75_));
  nand3  g58(.a(x5), .b(new_n51_), .c(new_n19_), .O(new_n76_));
  oai21  g59(.a(new_n75_), .b(new_n71_), .c(new_n76_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n34_), .O(new_n78_));
  nand2  g61(.a(new_n20_), .b(x2), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n29_), .c(x1), .O(new_n80_));
  nand3  g63(.a(new_n20_), .b(x5), .c(new_n51_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n19_), .O(new_n83_));
  nand4  g66(.a(new_n83_), .b(new_n78_), .c(new_n74_), .d(new_n31_), .O(z3));
  nand2  g67(.a(x6), .b(new_n34_), .O(new_n85_));
  oai21  g68(.a(new_n79_), .b(new_n34_), .c(new_n85_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n51_), .c(new_n19_), .O(new_n87_));
  nand2  g70(.a(new_n51_), .b(new_n19_), .O(new_n88_));
  xnor2a g71(.a(x6), .b(x1), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n88_), .c(x2), .O(new_n90_));
  nor2   g73(.a(x2), .b(x1), .O(new_n91_));
  nand3  g74(.a(x3), .b(x1), .c(x0), .O(new_n92_));
  ...
  aoi21  g84(.a(new_n101_), .b(new_n40_), .c(new_n19_), .O(new_n102_));
  or2    g85(.a(new_n102_), .b(new_n99_), .O(z5));
  inv1   g86(.a(new_n91_), .O(new_n104_));
  nand2  g87(.a(x6), .b(x3), .O(new_n105_));
  aoi21  g88(.a(x6), .b(new_n51_), .c(x2), .O(new_n106_));
  oai22  g89(.a(new_n106_), .b(new_n34_), .c(new_n105_), .d(new_n104_), .O(z6));
  oai21  g90(.a(new_n105_), .b(x2), .c(new_n97_), .O(z7));
  nor2   g91(.a(new_n30_), .b(x3), .O(z8));
  nand3  g92(.a(new_n21_), .b(new_n20_), .c(new_n19_), .O(new_n110_));
  nand3  g93(.a(new_n110_), .b(x5), .c(x4), .O(new_n111_));
  nand2  g94(.a(new_n111_), .b(new_n31_), .O(z9));
endmodule
