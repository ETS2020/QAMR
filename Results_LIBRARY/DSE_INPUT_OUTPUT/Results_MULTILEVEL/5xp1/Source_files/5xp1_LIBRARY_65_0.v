...
module FAU ( 
  ...
  oai21  g75(.a(new_n21_), .b(new_n19_), .c(new_n92_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(x6), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n90_), .c(new_n87_), .O(z4));
  nor2   g78(.a(x3), .b(new_n18_), .O(new_n96_));
  inv1   g79(.a(new_n96_), .O(new_n97_));
  nand4  g80(.a(x6), .b(x3), .c(new_n18_), .d(x1), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(new_n97_), .c(x0), .O(new_n99_));
  nand2  g82(.a(x3), .b(x1), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(x6), .c(new_n18_), .O(new_n101_));
  aoi21  g84(.a(new_n101_), .b(new_n39_), .c(new_n19_), .O(new_n102_));
  or2    g85(.a(new_n102_), .b(new_n99_), .O(z5));
  nand2  g86(.a(x6), .b(x3), .O(new_n104_));
  aoi21  g87(.a(x6), .b(new_n50_), .c(x2), .O(new_n105_));
  oai22  g88(.a(new_n105_), .b(new_n33_), .c(new_n104_), .d(new_n92_), .O(z6));
  oai21  g89(.a(new_n104_), .b(x2), .c(new_n97_), .O(z7));
  nand2  g90(.a(new_n70_), .b(x3), .O(z8));
  inv1   g91(.a(new_n21_), .O(new_n109_));
  oai21  g92(.a(new_n109_), .b(x0), .c(x2), .O(new_n110_));
