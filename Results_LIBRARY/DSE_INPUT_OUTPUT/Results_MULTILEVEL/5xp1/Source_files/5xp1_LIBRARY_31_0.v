...
module FAU ( 
  ...
  nand3  g25(.a(x6), .b(new_n23_), .c(z8), .O(new_n43_));
  ...
  oai21  g33(.a(new_n50_), .b(new_n20_), .c(z8), .O(new_n51_));
  ...
  nand3  g50(.a(new_n29_), .b(new_n67_), .c(new_n33_), .O(new_n68_));
  ...
  nor2   g62(.a(new_n20_), .b(x3), .O(new_n80_));
  ...
  oai21  g66(.a(new_n30_), .b(new_n33_), .c(new_n35_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(x5), .O(new_n85_));
  nand2  g68(.a(x6), .b(new_n67_), .O(new_n86_));
  ...
  aoi21  g75(.a(new_n92_), .b(new_n72_), .c(new_n33_), .O(new_n93_));
  ...
  nand2  g84(.a(x3), .b(new_n67_), .O(new_n102_));
  ...
  aoi21  g89(.a(new_n67_), .b(x1), .c(z8), .O(new_n107_));
  ...
  nand3  g93(.a(x3), .b(new_n67_), .c(new_n33_), .O(new_n111_));
  nand3  g94(.a(new_n111_), .b(new_n110_), .c(new_n101_), .O(z6));
  oai21  g95(.a(new_n80_), .b(x2), .c(new_n103_), .O(z7));
