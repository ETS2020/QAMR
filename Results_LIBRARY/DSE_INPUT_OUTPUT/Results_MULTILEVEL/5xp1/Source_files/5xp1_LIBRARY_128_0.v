...
module FAU ( 
  ...
  nor2   g20(.a(new_n33_), .b(new_n22_), .O(new_n38_));
  oai21  g21(.a(new_n38_), .b(new_n37_), .c(new_n28_), .O(new_n39_));
  ...
  nand2  g26(.a(new_n22_), .b(z8), .O(new_n44_));
  ...
  nand3  g31(.a(new_n48_), .b(new_n39_), .c(new_n30_), .O(z1));
  oai21  g32(.a(new_n41_), .b(x0), .c(x6), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(z8), .O(new_n51_));
  ...
  oai21  g41(.a(new_n58_), .b(new_n57_), .c(new_n33_), .O(new_n59_));
  ...
  nand3  g50(.a(new_n28_), .b(new_n67_), .c(new_n40_), .O(new_n68_));
  aoi21  g51(.a(new_n68_), .b(new_n66_), .c(new_n33_), .O(new_n69_));
  oai21  g52(.a(new_n69_), .b(new_n64_), .c(new_n22_), .O(new_n70_));
  nand3  g53(.a(new_n70_), .b(new_n61_), .c(new_n51_), .O(z2));
  oai21  g54(.a(new_n33_), .b(z8), .c(new_n40_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(x2), .O(new_n73_));
  oai21  g56(.a(x6), .b(z8), .c(x1), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n73_), .c(x5), .O(new_n75_));
  oai21  g58(.a(new_n33_), .b(new_n40_), .c(new_n67_), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n72_), .c(new_n28_), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(new_n75_), .c(new_n19_), .O(new_n78_));
  nand3  g61(.a(new_n36_), .b(new_n28_), .c(new_n40_), .O(new_n79_));
  ...
  aoi21  g68(.a(new_n85_), .b(new_n84_), .c(new_n40_), .O(new_n86_));
  ...
  nand3  g72(.a(new_n67_), .b(x1), .c(new_n19_), .O(new_n90_));
  oai21  g73(.a(new_n67_), .b(x1), .c(new_n90_), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n33_), .c(x3), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n89_), .O(z4));
  nand2  g76(.a(x3), .b(new_n67_), .O(new_n94_));
  nor2   g77(.a(new_n33_), .b(x3), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(x2), .O(new_n96_));
  oai21  g79(.a(new_n94_), .b(new_n40_), .c(new_n96_), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n19_), .O(new_n98_));
  aoi21  g81(.a(new_n67_), .b(x1), .c(z8), .O(new_n99_));
  nand2  g82(.a(new_n95_), .b(new_n67_), .O(new_n100_));
  inv1   g83(.a(new_n100_), .O(new_n101_));
  oai21  g84(.a(new_n101_), .b(new_n99_), .c(x0), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n98_), .O(z5));
  inv1   g86(.a(new_n85_), .O(new_n104_));
  oai21  g87(.a(new_n95_), .b(new_n104_), .c(x1), .O(new_n105_));
  oai21  g88(.a(new_n94_), .b(x1), .c(new_n105_), .O(z6));
  nand2  g89(.a(z8), .b(x2), .O(new_n107_));
  oai21  g90(.a(new_n95_), .b(x2), .c(new_n107_), .O(z7));
  nand2  g91(.a(new_n20_), .b(new_n19_), .O(new_n109_));
  nand3  g92(.a(new_n109_), .b(x5), .c(x4), .O(new_n110_));
  nand2  g93(.a(new_n110_), .b(new_n30_), .O(z9));
endmodule
