...
module FAU ( 
  ...
  nand2  g53(.a(new_n66_), .b(new_n70_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(x0), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(new_n24_), .c(x6), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(x1), .O(new_n74_));
  nand3  g57(.a(new_n67_), .b(new_n28_), .c(x2), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n74_), .c(new_n69_), .O(z4));
  nand3  g59(.a(new_n36_), .b(new_n66_), .c(x2), .O(new_n77_));
  nand4  g60(.a(x6), .b(x3), .c(new_n70_), .d(x1), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n23_), .O(new_n80_));
  aoi21  g63(.a(new_n66_), .b(x2), .c(x1), .O(new_n81_));
  aoi21  g64(.a(new_n71_), .b(new_n24_), .c(new_n28_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n81_), .c(x0), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n80_), .O(z5));
  nand2  g67(.a(x3), .b(new_n70_), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(x6), .c(x1), .O(new_n86_));
  oai21  g69(.a(new_n85_), .b(x1), .c(new_n86_), .O(z6));
  inv1   g70(.a(new_n36_), .O(new_n88_));
  nand2  g71(.a(new_n66_), .b(x2), .O(new_n89_));
  aoi21  g72(.a(new_n85_), .b(new_n89_), .c(new_n88_), .O(z7));
