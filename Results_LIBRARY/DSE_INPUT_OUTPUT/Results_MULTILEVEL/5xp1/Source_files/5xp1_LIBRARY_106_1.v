...
module FAU ( 
  ...
  nand4  g14(.a(new_n22_), .b(new_n21_), .c(x5), .d(new_n20_), .O(new_n32_));
  inv1   g15(.a(new_n32_), .O(new_n33_));
  aoi21  g16(.a(new_n31_), .b(new_n18_), .c(new_n33_), .O(new_n34_));
  nand3  g17(.a(new_n21_), .b(x5), .c(new_n29_), .O(new_n35_));
  oai21  g18(.a(new_n34_), .b(new_n29_), .c(new_n35_), .O(z1));
  ...
  oai21  g26(.a(new_n18_), .b(new_n43_), .c(new_n20_), .O(new_n44_));
  ...
  nand2  g39(.a(new_n21_), .b(new_n37_), .O(new_n57_));
  ...
  nand2  g51(.a(new_n68_), .b(new_n37_), .O(new_n69_));
  nand3  g52(.a(new_n21_), .b(new_n43_), .c(new_n40_), .O(new_n70_));
  ...
  nand2  g57(.a(new_n47_), .b(new_n63_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(x6), .c(x4), .O(new_n76_));
  nor2   g59(.a(x3), .b(x2), .O(new_n77_));
  aoi21  g60(.a(x3), .b(x2), .c(x0), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n77_), .c(new_n21_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x1), .O(new_n81_));
  nand2  g64(.a(new_n43_), .b(new_n20_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n21_), .c(x2), .O(new_n83_));
  oai21  g66(.a(x3), .b(x0), .c(x2), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(x6), .c(x4), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n37_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n81_), .O(z4));
  nand2  g71(.a(x3), .b(new_n40_), .O(new_n89_));
  nand2  g72(.a(new_n43_), .b(x2), .O(new_n90_));
  oai21  g73(.a(new_n89_), .b(new_n37_), .c(new_n90_), .O(new_n91_));
  ...
  nand3  g80(.a(x3), .b(new_n40_), .c(new_n37_), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(new_n97_), .c(new_n26_), .O(z6));
  nand3  g82(.a(new_n90_), .b(new_n89_), .c(new_n27_), .O(z7));
  nor2   g83(.a(new_n26_), .b(x3), .O(z8));
