...
module FAU ( 
  ...
  nand2  g53(.a(new_n39_), .b(new_n63_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(x1), .O(new_n72_));
  aoi21  g55(.a(new_n72_), .b(new_n31_), .c(new_n29_), .O(new_n73_));
  nand2  g56(.a(new_n31_), .b(new_n25_), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n71_), .c(x5), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n73_), .c(x0), .O(new_n76_));
  aoi21  g59(.a(new_n37_), .b(new_n25_), .c(new_n39_), .O(new_n77_));
  nand3  g60(.a(x6), .b(new_n29_), .c(x1), .O(new_n78_));
  oai21  g61(.a(new_n77_), .b(new_n29_), .c(new_n78_), .O(new_n79_));
  ...
  nand3  g67(.a(x2), .b(new_n25_), .c(x0), .O(new_n85_));
  nand2  g68(.a(new_n63_), .b(x1), .O(new_n86_));
  aoi21  g69(.a(new_n86_), .b(new_n85_), .c(x6), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n84_), .c(z8), .O(new_n88_));
  oai21  g71(.a(x3), .b(x2), .c(x0), .O(new_n89_));
  aoi21  g72(.a(new_n89_), .b(new_n37_), .c(new_n25_), .O(new_n90_));
  nor2   g73(.a(x2), .b(x1), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n90_), .c(x6), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n88_), .O(z4));
  xnor2a g76(.a(x3), .b(x0), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(x2), .O(new_n95_));
  nand2  g78(.a(new_n86_), .b(x6), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(x3), .c(new_n24_), .O(new_n97_));
  nand3  g80(.a(x6), .b(x3), .c(x1), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n63_), .c(x0), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(new_n97_), .c(new_n95_), .O(z5));
  inv1   g83(.a(new_n91_), .O(new_n101_));
  nand2  g84(.a(x6), .b(x3), .O(new_n102_));
  aoi21  g85(.a(x6), .b(x2), .c(z8), .O(new_n103_));
  oai22  g86(.a(new_n103_), .b(new_n25_), .c(new_n102_), .d(new_n101_), .O(z6));
  nand2  g87(.a(new_n102_), .b(x2), .O(new_n105_));
  oai21  g88(.a(z8), .b(x2), .c(new_n105_), .O(z7));
  oai21  g89(.a(x6), .b(x0), .c(x5), .O(new_n107_));
  oai21  g90(.a(new_n107_), .b(new_n18_), .c(new_n44_), .O(z9));
endmodule
