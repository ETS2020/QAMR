...
module FAU ( 
  ...
  oai21  g33(.a(new_n50_), .b(new_n36_), .c(z8), .O(new_n51_));
  ...
  oai21  g41(.a(new_n58_), .b(new_n57_), .c(new_n36_), .O(new_n59_));
  ...
  nand3  g49(.a(new_n28_), .b(new_n40_), .c(new_n22_), .O(new_n67_));
  ...
  nand2  g53(.a(new_n23_), .b(new_n36_), .O(new_n71_));
  ...
  nor2   g60(.a(new_n36_), .b(x3), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n22_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n77_), .c(new_n28_), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n74_), .c(new_n18_), .O(new_n81_));
  oai21  g64(.a(new_n29_), .b(new_n22_), .c(new_n34_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(x5), .O(new_n83_));
  nand2  g66(.a(new_n36_), .b(x3), .O(new_n84_));
  oai21  g67(.a(new_n36_), .b(x2), .c(new_n84_), .O(new_n85_));
  ...
  nand2  g71(.a(new_n88_), .b(new_n81_), .O(z3));
  ...
  nand2  g81(.a(x3), .b(new_n40_), .O(new_n99_));
  nand2  g82(.a(new_n78_), .b(x2), .O(new_n100_));
  oai21  g83(.a(new_n99_), .b(new_n22_), .c(new_n100_), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(new_n18_), .O(new_n102_));
  aoi21  g85(.a(new_n40_), .b(x1), .c(z8), .O(new_n103_));
  nand2  g86(.a(new_n78_), .b(new_n40_), .O(new_n104_));
  inv1   g87(.a(new_n104_), .O(new_n105_));
  oai21  g88(.a(new_n105_), .b(new_n103_), .c(x0), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n102_), .O(z5));
  nand2  g90(.a(new_n99_), .b(x1), .O(new_n108_));
  nand3  g91(.a(x3), .b(new_n40_), .c(new_n22_), .O(new_n109_));
  nand3  g92(.a(new_n109_), .b(new_n108_), .c(new_n32_), .O(z6));
