...
module FAU ( 
  ...
  inv1   g23(.a(new_n25_), .O(new_n41_));
  nor2   g24(.a(new_n41_), .b(new_n30_), .O(new_n42_));
  nand4  g25(.a(new_n42_), .b(new_n23_), .c(new_n24_), .d(new_n18_), .O(new_n43_));
  ...
  aoi22  g31(.a(new_n48_), .b(new_n18_), .c(new_n47_), .d(new_n33_), .O(new_n49_));
  aoi21  g32(.a(new_n49_), .b(new_n46_), .c(new_n23_), .O(new_n50_));
  ...
  oai21  g38(.a(new_n55_), .b(new_n50_), .c(new_n19_), .O(new_n56_));
  nand4  g39(.a(new_n25_), .b(new_n23_), .c(new_n24_), .d(new_n18_), .O(new_n57_));
  ...
  nand3  g44(.a(new_n30_), .b(x3), .c(new_n18_), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n45_), .c(new_n33_), .O(new_n63_));
  aoi21  g46(.a(new_n48_), .b(new_n19_), .c(new_n18_), .O(new_n64_));
  oai21  g47(.a(new_n64_), .b(new_n63_), .c(x1), .O(new_n65_));
  aoi21  g48(.a(new_n35_), .b(x1), .c(x5), .O(new_n66_));
  nor2   g49(.a(new_n19_), .b(new_n33_), .O(new_n67_));
  oai21  g50(.a(new_n67_), .b(new_n66_), .c(x0), .O(new_n68_));
  nand2  g51(.a(x6), .b(new_n24_), .O(new_n69_));
  nand2  g52(.a(new_n19_), .b(x5), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(new_n69_), .c(new_n41_), .O(new_n71_));
  nand3  g54(.a(new_n19_), .b(x5), .c(new_n24_), .O(new_n72_));
  inv1   g55(.a(new_n72_), .O(new_n73_));
  oai21  g56(.a(new_n73_), .b(new_n71_), .c(new_n18_), .O(new_n74_));
  nor2   g57(.a(new_n19_), .b(x5), .O(new_n75_));
  inv1   g58(.a(new_n75_), .O(new_n76_));
  nand4  g59(.a(new_n76_), .b(new_n74_), .c(new_n68_), .d(new_n65_), .O(z3));
  aoi21  g60(.a(new_n51_), .b(new_n25_), .c(new_n19_), .O(new_n78_));
  nand2  g61(.a(new_n25_), .b(new_n18_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n35_), .c(x6), .O(new_n80_));
  ...
  nor2   g67(.a(new_n84_), .b(new_n19_), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n83_), .c(new_n24_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n81_), .c(new_n76_), .O(z4));
  ...
  oai21  g75(.a(new_n92_), .b(new_n41_), .c(x0), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n91_), .c(new_n76_), .O(z5));
  nand2  g77(.a(new_n88_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n33_), .c(new_n24_), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n95_), .c(new_n75_), .O(z6));
  aoi21  g80(.a(new_n89_), .b(new_n88_), .c(new_n75_), .O(z7));
  nand2  g81(.a(new_n76_), .b(x3), .O(z8));
  nand2  g82(.a(new_n21_), .b(new_n18_), .O(new_n100_));
