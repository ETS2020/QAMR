...
module FAU ( 
  ...
  aoi21  g10(.a(new_n18_), .b(new_n24_), .c(new_n20_), .O(new_n28_));
  nor2   g11(.a(x6), .b(x4), .O(new_n29_));
  nor2   g12(.a(new_n29_), .b(x3), .O(new_n30_));
  oai21  g13(.a(new_n28_), .b(x0), .c(new_n30_), .O(new_n31_));
  ...
  oai21  g22(.a(new_n39_), .b(x5), .c(new_n32_), .O(z1));
  nand3  g23(.a(new_n20_), .b(new_n18_), .c(x1), .O(new_n41_));
  ...
  oai21  g29(.a(new_n38_), .b(new_n29_), .c(x5), .O(new_n47_));
  ...
  oai21  g41(.a(new_n37_), .b(new_n24_), .c(new_n54_), .O(new_n59_));
  ...
  nand2  g47(.a(new_n63_), .b(new_n24_), .O(new_n65_));
  nand3  g48(.a(new_n20_), .b(new_n54_), .c(new_n33_), .O(new_n66_));
  aoi21  g49(.a(new_n66_), .b(new_n65_), .c(x5), .O(new_n67_));
  oai21  g50(.a(new_n67_), .b(new_n64_), .c(x0), .O(new_n68_));
  nand2  g51(.a(x3), .b(x2), .O(new_n69_));
  nand2  g52(.a(x6), .b(new_n19_), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(new_n69_), .c(new_n24_), .O(new_n71_));
  oai21  g54(.a(new_n20_), .b(new_n24_), .c(x5), .O(new_n72_));
  nand3  g55(.a(x6), .b(x3), .c(x2), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  oai21  g57(.a(new_n74_), .b(new_n71_), .c(new_n23_), .O(new_n75_));
  nand2  g58(.a(x5), .b(x3), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n75_), .c(new_n68_), .O(z3));
  nand2  g60(.a(new_n55_), .b(x0), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n69_), .c(new_n20_), .O(new_n79_));
  nand2  g62(.a(new_n69_), .b(new_n23_), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(new_n55_), .c(x6), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n79_), .c(x1), .O(new_n82_));
  nor3   g65(.a(new_n21_), .b(x6), .c(new_n33_), .O(new_n83_));
  nor2   g66(.a(new_n21_), .b(new_n33_), .O(new_n84_));
  nor2   g67(.a(new_n84_), .b(new_n20_), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n83_), .c(new_n24_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n82_), .c(new_n76_), .O(z4));
  nand4  g70(.a(new_n19_), .b(x3), .c(new_n33_), .d(x1), .O(new_n88_));
  oai21  g71(.a(x3), .b(new_n33_), .c(new_n88_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n23_), .O(new_n90_));
  inv1   g73(.a(new_n55_), .O(new_n91_));
  aoi21  g74(.a(new_n33_), .b(x1), .c(x5), .O(new_n92_));
  aoi21  g75(.a(new_n92_), .b(x3), .c(new_n91_), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n23_), .c(new_n90_), .O(z5));
  nor2   g77(.a(x2), .b(x1), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(x5), .c(x3), .O(new_n96_));
  nand3  g79(.a(new_n19_), .b(x3), .c(new_n33_), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(x1), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n96_), .O(z6));
  oai21  g82(.a(x3), .b(new_n33_), .c(new_n97_), .O(z7));
  oai21  g83(.a(x6), .b(x0), .c(x4), .O(new_n101_));
  nand2  g84(.a(new_n19_), .b(x3), .O(z8));
  aoi21  g85(.a(new_n101_), .b(new_n54_), .c(new_n19_), .O(z9));
endmodule
