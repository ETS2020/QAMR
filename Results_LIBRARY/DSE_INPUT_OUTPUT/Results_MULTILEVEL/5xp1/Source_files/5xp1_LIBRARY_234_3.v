...
module FAU ( 
  ...
  nor2   g54(.a(new_n29_), .b(x0), .O(new_n72_));
  nand4  g55(.a(new_n29_), .b(new_n33_), .c(x1), .d(x0), .O(new_n73_));
  inv1   g56(.a(new_n73_), .O(new_n74_));
  oai21  g57(.a(new_n74_), .b(new_n72_), .c(new_n34_), .O(new_n75_));
  nand3  g58(.a(new_n29_), .b(new_n40_), .c(x0), .O(new_n76_));
  inv1   g59(.a(new_n76_), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(new_n72_), .c(new_n33_), .O(new_n78_));
  xor2a  g61(.a(x5), .b(x0), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n23_), .c(new_n40_), .O(new_n80_));
  nand3  g63(.a(new_n29_), .b(x3), .c(new_n19_), .O(new_n81_));
  aoi22  g64(.a(new_n81_), .b(new_n49_), .c(new_n23_), .d(new_n40_), .O(new_n82_));
  oai21  g65(.a(new_n59_), .b(new_n19_), .c(new_n23_), .O(new_n83_));
  aoi22  g66(.a(new_n83_), .b(x1), .c(new_n82_), .d(x2), .O(new_n84_));
  nand4  g67(.a(new_n84_), .b(new_n80_), .c(new_n78_), .d(new_n75_), .O(z3));
  nor2   g68(.a(x3), .b(x0), .O(new_n86_));
  nor2   g69(.a(new_n86_), .b(x6), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(x2), .c(new_n40_), .O(new_n88_));
  ...
  nand3  g75(.a(new_n70_), .b(new_n34_), .c(x2), .O(new_n93_));
  ...
  inv1   g86(.a(new_n70_), .O(new_n104_));
  aoi21  g87(.a(new_n101_), .b(new_n97_), .c(new_n104_), .O(z7));
  nor2   g88(.a(new_n104_), .b(x3), .O(z8));
  nand2  g89(.a(x5), .b(x4), .O(new_n107_));
  oai21  g90(.a(new_n107_), .b(new_n20_), .c(new_n23_), .O(new_n108_));
