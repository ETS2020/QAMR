...
module FAU ( 
  ...
  nor2   g78(.a(new_n85_), .b(new_n95_), .O(new_n96_));
  nor2   g79(.a(new_n96_), .b(new_n18_), .O(new_n97_));
  nor2   g80(.a(x3), .b(new_n34_), .O(new_n98_));
  nor3   g81(.a(new_n98_), .b(new_n20_), .c(x1), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(new_n97_), .c(x0), .O(new_n100_));
  nor2   g83(.a(new_n81_), .b(x2), .O(new_n101_));
  nor2   g84(.a(new_n101_), .b(new_n98_), .O(new_n102_));
  nand3  g85(.a(x6), .b(new_n81_), .c(x2), .O(new_n103_));
