...
module FAU ( 
  ...
  oai21  g33(.a(new_n37_), .b(new_n43_), .c(new_n20_), .O(new_n51_));
  nand2  g34(.a(new_n34_), .b(new_n30_), .O(new_n52_));
  nand2  g35(.a(new_n43_), .b(new_n24_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n19_), .O(new_n55_));
  inv1   g38(.a(x2), .O(new_n56_));
  aoi21  g39(.a(new_n18_), .b(new_n56_), .c(new_n43_), .O(new_n57_));
  inv1   g40(.a(x3), .O(new_n58_));
  nand3  g41(.a(new_n43_), .b(new_n58_), .c(new_n56_), .O(new_n59_));
  oai21  g42(.a(new_n57_), .b(x1), .c(new_n59_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n30_), .O(new_n61_));
  nand4  g44(.a(new_n61_), .b(new_n55_), .c(new_n50_), .d(new_n44_), .O(z2));
  oai21  g45(.a(new_n18_), .b(new_n24_), .c(new_n43_), .O(new_n63_));
  nand3  g46(.a(new_n30_), .b(x3), .c(new_n19_), .O(new_n64_));
  oai21  g47(.a(new_n30_), .b(new_n19_), .c(new_n64_), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(new_n63_), .c(x2), .O(new_n66_));
  aoi21  g49(.a(x4), .b(x3), .c(x6), .O(new_n67_));
  nor3   g50(.a(new_n67_), .b(new_n24_), .c(new_n19_), .O(new_n68_));
  nor2   g51(.a(new_n43_), .b(x1), .O(new_n69_));
  oai21  g52(.a(new_n69_), .b(new_n38_), .c(new_n20_), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(new_n40_), .c(x0), .O(new_n71_));
  oai21  g54(.a(new_n71_), .b(new_n68_), .c(x5), .O(new_n72_));
  nand2  g55(.a(new_n43_), .b(x4), .O(new_n73_));
  nand2  g56(.a(x6), .b(new_n56_), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n73_), .c(x1), .O(new_n75_));
  nand4  g58(.a(new_n43_), .b(x4), .c(new_n58_), .d(new_n56_), .O(new_n76_));
  ...
  nand3  g64(.a(new_n81_), .b(new_n72_), .c(new_n66_), .O(z3));
  nand2  g65(.a(new_n58_), .b(new_n56_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(x0), .O(new_n84_));
  aoi21  g67(.a(new_n84_), .b(new_n20_), .c(new_n43_), .O(new_n85_));
  ...
  nor3   g72(.a(new_n89_), .b(x6), .c(new_n56_), .O(new_n90_));
  nor2   g73(.a(new_n89_), .b(new_n56_), .O(new_n91_));
  nor2   g74(.a(new_n91_), .b(new_n43_), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n90_), .c(new_n24_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n88_), .c(new_n44_), .O(z4));
  nand2  g77(.a(x3), .b(new_n56_), .O(new_n95_));
  ...
  nand3  g83(.a(new_n100_), .b(new_n98_), .c(new_n44_), .O(z5));
  nand2  g84(.a(new_n95_), .b(x1), .O(new_n102_));
  nand3  g85(.a(x3), .b(new_n56_), .c(new_n24_), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n102_), .c(new_n44_), .O(z6));
  nand3  g87(.a(new_n96_), .b(new_n95_), .c(new_n44_), .O(z7));
