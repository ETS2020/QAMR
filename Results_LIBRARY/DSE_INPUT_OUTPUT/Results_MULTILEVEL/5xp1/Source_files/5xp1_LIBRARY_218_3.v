...
module FAU ( 
  ...
  nor2   g43(.a(new_n25_), .b(new_n37_), .O(new_n61_));
  ...
  oai21  g47(.a(new_n62_), .b(new_n38_), .c(new_n64_), .O(new_n65_));
  ...
  nand2  g53(.a(new_n42_), .b(x1), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n25_), .c(x0), .O(new_n72_));
  nand3  g55(.a(new_n21_), .b(x5), .c(new_n19_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n72_), .c(new_n70_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n20_), .O(new_n75_));
  nand2  g58(.a(x5), .b(new_n37_), .O(new_n76_));
  nand3  g59(.a(x6), .b(new_n25_), .c(x1), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n76_), .c(x0), .O(new_n78_));
  nand2  g61(.a(new_n20_), .b(new_n41_), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(x5), .c(x1), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(new_n60_), .c(new_n19_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n78_), .c(new_n26_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n75_), .O(z3));
  nand3  g66(.a(x6), .b(x3), .c(new_n26_), .O(new_n84_));
  nand3  g67(.a(new_n20_), .b(x2), .c(new_n37_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(x0), .O(new_n87_));
  nand2  g70(.a(new_n32_), .b(new_n19_), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n42_), .c(new_n37_), .O(new_n89_));
  nor2   g72(.a(new_n32_), .b(x1), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n89_), .c(new_n20_), .O(new_n91_));
  nand3  g74(.a(x6), .b(new_n26_), .c(new_n37_), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n91_), .c(new_n87_), .O(z4));
  nand2  g76(.a(x3), .b(new_n26_), .O(new_n94_));
  inv1   g77(.a(new_n94_), .O(new_n95_));
  nor2   g78(.a(x3), .b(new_n26_), .O(new_n96_));
  aoi21  g79(.a(new_n95_), .b(x1), .c(new_n96_), .O(new_n97_));
  oai21  g80(.a(new_n41_), .b(new_n19_), .c(new_n20_), .O(new_n98_));
  aoi21  g81(.a(x3), .b(x1), .c(x2), .O(new_n99_));
  aoi22  g82(.a(new_n99_), .b(x0), .c(new_n98_), .d(x2), .O(new_n100_));
  oai21  g83(.a(new_n97_), .b(x0), .c(new_n100_), .O(z5));
  aoi21  g84(.a(new_n95_), .b(new_n37_), .c(new_n27_), .O(new_n102_));
  oai21  g85(.a(new_n95_), .b(new_n37_), .c(new_n102_), .O(z6));
  oai21  g86(.a(x6), .b(new_n41_), .c(x2), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n94_), .O(z7));
  oai21  g88(.a(new_n20_), .b(new_n26_), .c(x3), .O(z8));
