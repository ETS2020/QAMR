...
module FAU ( 
  ...
  aoi21  g14(.a(new_n31_), .b(x1), .c(x2), .O(new_n32_));
  ...
  oai21  g29(.a(new_n46_), .b(new_n45_), .c(new_n24_), .O(new_n47_));
  ...
  nand4  g34(.a(new_n29_), .b(new_n18_), .c(x1), .d(x0), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x3), .O(new_n54_));
  nand2  g37(.a(x4), .b(x2), .O(new_n55_));
  nor2   g38(.a(x6), .b(new_n20_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n18_), .O(new_n57_));
  aoi21  g40(.a(new_n57_), .b(new_n55_), .c(new_n23_), .O(new_n58_));
  aoi21  g41(.a(x3), .b(x1), .c(x5), .O(new_n59_));
  oai21  g42(.a(new_n59_), .b(new_n23_), .c(x4), .O(new_n60_));
  aoi21  g43(.a(new_n60_), .b(new_n19_), .c(x6), .O(new_n61_));
  nor2   g44(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n54_), .c(new_n50_), .O(z2));
  nand3  g46(.a(new_n25_), .b(x5), .c(new_n23_), .O(new_n64_));
  nand2  g47(.a(new_n46_), .b(x0), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n24_), .O(new_n67_));
  nand3  g50(.a(new_n20_), .b(x2), .c(new_n23_), .O(new_n68_));
  oai21  g51(.a(new_n43_), .b(new_n23_), .c(new_n68_), .O(new_n69_));
  nand2  g52(.a(new_n69_), .b(x3), .O(new_n70_));
  nand3  g53(.a(x6), .b(new_n20_), .c(x1), .O(new_n71_));
  inv1   g54(.a(new_n71_), .O(new_n72_));
  oai21  g55(.a(new_n72_), .b(new_n56_), .c(new_n23_), .O(new_n73_));
  nand2  g56(.a(x5), .b(x0), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(x6), .c(new_n19_), .O(new_n75_));
  nand3  g58(.a(x6), .b(x5), .c(x1), .O(new_n76_));
  inv1   g59(.a(x3), .O(new_n77_));
  nand3  g60(.a(new_n29_), .b(new_n20_), .c(new_n77_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(x0), .c(new_n75_), .O(new_n80_));
  nand4  g63(.a(new_n80_), .b(new_n73_), .c(new_n70_), .d(new_n67_), .O(z3));
  oai21  g64(.a(x3), .b(x2), .c(x0), .O(new_n82_));
  aoi21  g65(.a(new_n82_), .b(new_n25_), .c(new_n29_), .O(new_n83_));
  nand2  g66(.a(x3), .b(x0), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(new_n29_), .c(new_n19_), .O(new_n85_));
  ...
  nand2  g73(.a(x3), .b(new_n19_), .O(new_n91_));
  nand3  g74(.a(x6), .b(new_n77_), .c(x2), .O(new_n92_));
  ...
  nand3  g78(.a(x6), .b(x3), .c(x2), .O(new_n96_));
  ...
  nor2   g83(.a(new_n29_), .b(new_n19_), .O(new_n101_));
  oai21  g84(.a(new_n101_), .b(new_n100_), .c(x1), .O(new_n102_));
  oai21  g85(.a(new_n91_), .b(x1), .c(new_n102_), .O(z6));
  nand2  g86(.a(new_n92_), .b(new_n91_), .O(z7));
  nor2   g87(.a(new_n39_), .b(x3), .O(z8));
  oai21  g88(.a(x2), .b(new_n23_), .c(new_n29_), .O(new_n106_));
