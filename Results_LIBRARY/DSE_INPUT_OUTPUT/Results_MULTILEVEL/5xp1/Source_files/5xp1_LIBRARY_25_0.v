...
module FAU ( 
  ...
  nand2  g53(.a(new_n24_), .b(new_n19_), .O(new_n71_));
  ...
  nor2   g60(.a(new_n19_), .b(x3), .O(new_n78_));
  ...
  aoi21  g73(.a(new_n90_), .b(new_n24_), .c(new_n23_), .O(new_n91_));
  nand2  g74(.a(z8), .b(new_n18_), .O(new_n92_));
  aoi21  g75(.a(new_n92_), .b(x2), .c(x1), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n91_), .c(x6), .O(new_n94_));
  nand3  g77(.a(new_n40_), .b(x1), .c(new_n18_), .O(new_n95_));
  oai21  g78(.a(new_n40_), .b(x1), .c(new_n95_), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n19_), .c(x3), .O(new_n97_));
  ...
  nand3  g91(.a(x3), .b(new_n40_), .c(new_n23_), .O(new_n109_));
  nand3  g92(.a(new_n109_), .b(new_n108_), .c(new_n33_), .O(z6));
  nand2  g93(.a(new_n100_), .b(new_n99_), .O(z7));
  aoi21  g94(.a(x2), .b(x1), .c(x0), .O(new_n112_));
  oai21  g95(.a(new_n112_), .b(z8), .c(new_n19_), .O(new_n113_));
