...
module FAU ( 
  ...
  nand2  g28(.a(new_n31_), .b(x0), .O(new_n46_));
  ...
  aoi21  g63(.a(new_n80_), .b(new_n31_), .c(x6), .O(new_n81_));
  ...
  oai21  g69(.a(new_n86_), .b(new_n84_), .c(new_n38_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n82_), .c(new_n27_), .O(z4));
  nand2  g71(.a(x3), .b(new_n29_), .O(new_n89_));
  nand2  g72(.a(new_n30_), .b(x2), .O(new_n90_));
  oai21  g73(.a(new_n89_), .b(new_n38_), .c(new_n90_), .O(new_n91_));
  ...
  nand3  g78(.a(new_n95_), .b(new_n92_), .c(new_n27_), .O(z5));
  nand2  g79(.a(new_n89_), .b(x1), .O(new_n97_));
  nand3  g80(.a(x3), .b(new_n29_), .c(new_n38_), .O(new_n98_));
  ...
  inv1   g84(.a(x4), .O(new_n102_));
  aoi21  g85(.a(new_n22_), .b(new_n20_), .c(new_n102_), .O(new_n103_));
