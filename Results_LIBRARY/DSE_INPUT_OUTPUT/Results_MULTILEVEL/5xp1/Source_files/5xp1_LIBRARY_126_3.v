...
module FAU ( 
  ...
  nand4  g26(.a(new_n20_), .b(x5), .c(new_n18_), .d(new_n19_), .O(new_n44_));
  nand4  g27(.a(x6), .b(new_n29_), .c(x2), .d(x0), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  nor2   g29(.a(x6), .b(new_n29_), .O(new_n47_));
  aoi22  g30(.a(new_n47_), .b(new_n18_), .c(new_n46_), .d(new_n40_), .O(new_n48_));
  ...
  aoi21  g36(.a(new_n52_), .b(new_n33_), .c(new_n53_), .O(new_n54_));
  ...
  nand3  g50(.a(new_n67_), .b(x6), .c(new_n40_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(new_n61_), .O(z2));
  nand2  g52(.a(new_n23_), .b(new_n40_), .O(new_n70_));
  ...
  oai21  g56(.a(new_n23_), .b(new_n40_), .c(new_n20_), .O(new_n74_));
  ...
  nand2  g61(.a(new_n33_), .b(x0), .O(new_n79_));
  nand3  g62(.a(new_n23_), .b(new_n29_), .c(new_n34_), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n79_), .c(new_n23_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(x1), .O(new_n82_));
  nand2  g65(.a(x6), .b(x2), .O(new_n83_));
  nand4  g66(.a(new_n83_), .b(new_n29_), .c(new_n40_), .d(x0), .O(new_n84_));
  nand4  g67(.a(new_n84_), .b(new_n82_), .c(new_n78_), .d(new_n73_), .O(z3));
  aoi21  g68(.a(new_n35_), .b(new_n21_), .c(new_n40_), .O(new_n86_));
  oai21  g69(.a(x3), .b(x0), .c(x2), .O(new_n87_));
  nor2   g70(.a(new_n87_), .b(x1), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n86_), .c(new_n23_), .O(new_n89_));
  nand3  g72(.a(new_n87_), .b(x6), .c(new_n40_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n89_), .O(z4));
  nand2  g74(.a(x6), .b(x1), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n34_), .c(x2), .O(new_n93_));
  ...
  aoi22  g81(.a(new_n98_), .b(new_n23_), .c(new_n97_), .d(new_n40_), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(new_n19_), .c(new_n96_), .O(z5));
  nand3  g83(.a(new_n23_), .b(x3), .c(new_n33_), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(x1), .O(new_n102_));
  nand2  g85(.a(x3), .b(new_n33_), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(x1), .c(new_n102_), .O(z6));
  inv1   g87(.a(new_n92_), .O(new_n105_));
  aoi21  g88(.a(new_n103_), .b(new_n97_), .c(new_n105_), .O(z7));
  nand2  g89(.a(new_n92_), .b(x3), .O(z8));
  nor2   g90(.a(new_n23_), .b(x1), .O(new_n108_));
  aoi21  g91(.a(new_n37_), .b(new_n19_), .c(x6), .O(new_n109_));
  oai21  g92(.a(new_n109_), .b(new_n108_), .c(x5), .O(new_n110_));
  nor2   g93(.a(new_n110_), .b(new_n18_), .O(z9));
endmodule
