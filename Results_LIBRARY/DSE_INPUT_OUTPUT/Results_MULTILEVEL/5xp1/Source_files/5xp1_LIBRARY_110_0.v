...
module FAU ( 
  ...
  aoi22  g079(.a(new_n96_), .b(x4), .c(new_n94_), .d(x6), .O(new_n97_));
  nor2   g080(.a(x3), .b(x0), .O(new_n98_));
  nor2   g081(.a(new_n98_), .b(x6), .O(new_n99_));
  nand3  g082(.a(new_n99_), .b(x4), .c(x2), .O(new_n100_));
  oai21  g083(.a(new_n98_), .b(new_n40_), .c(x6), .O(new_n101_));
  nand2  g084(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g085(.a(new_n102_), .b(new_n28_), .O(new_n103_));
  oai21  g086(.a(new_n97_), .b(new_n28_), .c(new_n103_), .O(z4));
  nand2  g087(.a(x3), .b(new_n40_), .O(new_n105_));
  nand2  g088(.a(new_n67_), .b(x2), .O(new_n106_));
  ...
  nand3  g093(.a(new_n110_), .b(new_n108_), .c(new_n72_), .O(z5));
  nand2  g094(.a(new_n105_), .b(x1), .O(new_n112_));
  nand3  g095(.a(x3), .b(new_n40_), .c(new_n28_), .O(new_n113_));
  nand3  g096(.a(new_n113_), .b(new_n112_), .c(new_n72_), .O(z6));
  aoi21  g097(.a(new_n106_), .b(new_n105_), .c(new_n71_), .O(z7));
  nand2  g098(.a(new_n72_), .b(x3), .O(z8));
  nand2  g099(.a(new_n35_), .b(new_n31_), .O(new_n117_));
  nand3  g100(.a(new_n117_), .b(x5), .c(x4), .O(new_n118_));
  nand2  g101(.a(new_n118_), .b(new_n72_), .O(z9));
endmodule
