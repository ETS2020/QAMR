...
module FAU ( 
  ...
  oai21  g32(.a(new_n37_), .b(new_n20_), .c(new_n24_), .O(new_n50_));
  oai21  g33(.a(new_n20_), .b(new_n18_), .c(new_n30_), .O(new_n51_));
  nand2  g34(.a(new_n20_), .b(new_n23_), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n51_), .c(new_n50_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n19_), .O(new_n54_));
  inv1   g37(.a(x2), .O(new_n55_));
  aoi21  g38(.a(new_n18_), .b(new_n55_), .c(new_n20_), .O(new_n56_));
  inv1   g39(.a(x3), .O(new_n57_));
  nand3  g40(.a(new_n20_), .b(new_n57_), .c(new_n55_), .O(new_n58_));
  ...
  oai21  g45(.a(new_n30_), .b(new_n19_), .c(new_n62_), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(new_n52_), .c(x2), .O(new_n64_));
  ...
  nor2   g51(.a(new_n20_), .b(new_n55_), .O(new_n69_));
  xnor2a g52(.a(x5), .b(x0), .O(new_n70_));
  nand3  g53(.a(x5), .b(new_n57_), .c(new_n19_), .O(new_n71_));
  oai21  g54(.a(new_n70_), .b(new_n69_), .c(new_n71_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n23_), .O(new_n73_));
  nand3  g56(.a(new_n24_), .b(x5), .c(new_n19_), .O(new_n74_));
  nand4  g57(.a(new_n30_), .b(new_n57_), .c(new_n55_), .d(x0), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n74_), .c(x4), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n20_), .O(new_n77_));
  nand4  g60(.a(new_n77_), .b(new_n73_), .c(new_n68_), .d(new_n64_), .O(z3));
  oai21  g61(.a(x3), .b(x2), .c(x0), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n24_), .c(new_n20_), .O(new_n80_));
  nand2  g63(.a(new_n57_), .b(new_n55_), .O(new_n81_));
  nand2  g64(.a(new_n24_), .b(new_n19_), .O(new_n82_));
  aoi21  g65(.a(new_n82_), .b(new_n81_), .c(x6), .O(new_n83_));
  aoi21  g66(.a(new_n83_), .b(x4), .c(new_n80_), .O(new_n84_));
  nand2  g67(.a(new_n57_), .b(new_n19_), .O(new_n85_));
  nand4  g68(.a(new_n85_), .b(new_n20_), .c(x4), .d(x2), .O(new_n86_));
  nor2   g69(.a(x3), .b(x0), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n55_), .c(x6), .O(new_n88_));
  ...
  nand2  g74(.a(x3), .b(new_n55_), .O(new_n92_));
  nand2  g75(.a(new_n57_), .b(x2), .O(new_n93_));
  ...
  nand3  g82(.a(x3), .b(new_n55_), .c(new_n23_), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(new_n99_), .c(new_n42_), .O(z6));
  nand3  g84(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z7));
  nand2  g85(.a(new_n43_), .b(x3), .O(z8));
