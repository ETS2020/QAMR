...
module FAU ( 
  ...
  aoi22  g30(.a(new_n47_), .b(new_n18_), .c(new_n46_), .d(new_n32_), .O(new_n48_));
  ...
  aoi21  g45(.a(new_n47_), .b(new_n19_), .c(new_n18_), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n62_), .c(x1), .O(new_n64_));
  oai21  g47(.a(new_n32_), .b(new_n18_), .c(x5), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x6), .O(new_n66_));
  nand2  g49(.a(new_n34_), .b(x1), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n29_), .c(x0), .O(new_n68_));
  oai21  g51(.a(new_n19_), .b(new_n23_), .c(new_n24_), .O(new_n69_));
  nand2  g52(.a(new_n19_), .b(new_n23_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(x5), .c(new_n18_), .O(new_n72_));
  nand4  g55(.a(new_n72_), .b(new_n68_), .c(new_n66_), .d(new_n64_), .O(z3));
  nand2  g56(.a(new_n50_), .b(new_n24_), .O(new_n74_));
  ...
  oai21  g75(.a(new_n92_), .b(new_n40_), .c(x0), .O(new_n93_));
  ...
  aoi21  g81(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(z7));
  ...
  nand2  g85(.a(new_n102_), .b(new_n95_), .O(z9));
endmodule
