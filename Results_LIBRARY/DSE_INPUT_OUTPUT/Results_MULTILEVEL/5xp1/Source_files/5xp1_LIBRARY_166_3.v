...
module FAU ( 
  ...
  nor2   g68(.a(new_n20_), .b(new_n19_), .O(new_n86_));
  nand2  g69(.a(x3), .b(new_n27_), .O(new_n87_));
  nand2  g70(.a(new_n56_), .b(x2), .O(new_n88_));
  oai21  g71(.a(new_n87_), .b(new_n30_), .c(new_n88_), .O(new_n89_));
  ...
  nand3  g78(.a(x3), .b(new_n27_), .c(new_n30_), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n95_), .c(new_n86_), .O(z6));
  inv1   g80(.a(new_n86_), .O(new_n98_));
  nand3  g81(.a(new_n88_), .b(new_n87_), .c(new_n98_), .O(z7));
