...
module FAU ( 
  ...
  nand2  g65(.a(new_n74_), .b(new_n52_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(x0), .O(new_n84_));
  aoi21  g67(.a(new_n84_), .b(new_n24_), .c(new_n20_), .O(new_n85_));
  ...
  nor3   g72(.a(new_n89_), .b(x6), .c(new_n52_), .O(new_n90_));
  nor2   g73(.a(new_n89_), .b(new_n52_), .O(new_n91_));
  nor2   g74(.a(new_n91_), .b(new_n20_), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n90_), .c(new_n23_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n88_), .c(new_n43_), .O(z4));
  nand2  g77(.a(x3), .b(new_n52_), .O(new_n95_));
  nand2  g78(.a(new_n74_), .b(x2), .O(new_n96_));
  ...
  aoi21  g83(.a(new_n100_), .b(new_n98_), .c(new_n42_), .O(z5));
  nand2  g84(.a(new_n95_), .b(x1), .O(new_n102_));
  nand3  g85(.a(x3), .b(new_n52_), .c(new_n23_), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n102_), .c(new_n43_), .O(z6));
  nand3  g87(.a(new_n96_), .b(new_n95_), .c(new_n43_), .O(z7));
  ...
  nand2  g91(.a(new_n108_), .b(new_n43_), .O(z9));
endmodule
