...
module FAU ( 
  ...
  nor2   g53(.a(new_n23_), .b(new_n40_), .O(new_n71_));
  inv1   g54(.a(new_n71_), .O(new_n72_));
  nand4  g55(.a(new_n72_), .b(new_n70_), .c(new_n63_), .d(new_n54_), .O(z2));
  nand2  g56(.a(new_n23_), .b(new_n40_), .O(new_n74_));
  nand3  g57(.a(new_n29_), .b(x3), .c(new_n19_), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(new_n50_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n74_), .c(x2), .O(new_n77_));
  oai21  g60(.a(new_n23_), .b(new_n40_), .c(new_n20_), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n74_), .c(x0), .O(new_n79_));
  nand3  g62(.a(x3), .b(x1), .c(x0), .O(new_n80_));
  inv1   g63(.a(new_n80_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n79_), .c(x5), .O(new_n82_));
  nand2  g65(.a(new_n33_), .b(x0), .O(new_n83_));
  nand3  g66(.a(new_n23_), .b(new_n29_), .c(new_n34_), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n83_), .c(new_n23_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(x1), .O(new_n86_));
  nand2  g69(.a(x6), .b(x2), .O(new_n87_));
  nand4  g70(.a(new_n87_), .b(new_n29_), .c(new_n40_), .d(x0), .O(new_n88_));
  nand4  g71(.a(new_n88_), .b(new_n86_), .c(new_n82_), .d(new_n77_), .O(z3));
  aoi21  g72(.a(new_n35_), .b(new_n21_), .c(new_n40_), .O(new_n90_));
  ...
  nand3  g76(.a(new_n91_), .b(x6), .c(new_n40_), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n93_), .O(z4));
  nand2  g78(.a(x3), .b(new_n33_), .O(new_n96_));
  nand2  g79(.a(new_n34_), .b(x2), .O(new_n97_));
  oai21  g80(.a(new_n96_), .b(new_n40_), .c(new_n97_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n19_), .O(new_n99_));
  nand2  g82(.a(new_n83_), .b(new_n40_), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(x6), .O(new_n101_));
  inv1   g84(.a(new_n20_), .O(new_n102_));
  ...
  nand3  g88(.a(new_n96_), .b(new_n23_), .c(x1), .O(new_n106_));
  oai21  g89(.a(new_n96_), .b(x1), .c(new_n106_), .O(z6));
  aoi21  g90(.a(new_n97_), .b(new_n96_), .c(new_n71_), .O(z7));
  nor2   g91(.a(new_n71_), .b(x3), .O(z8));
