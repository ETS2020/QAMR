...
module FAU ( 
  ...
  oai21  g77(.a(new_n94_), .b(new_n18_), .c(new_n21_), .O(new_n95_));
  oai21  g78(.a(x3), .b(x2), .c(new_n95_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(x1), .O(new_n97_));
  nand3  g80(.a(new_n97_), .b(new_n93_), .c(new_n91_), .O(z4));
  nor2   g81(.a(x3), .b(new_n18_), .O(new_n99_));
  inv1   g82(.a(new_n99_), .O(new_n100_));
  nor2   g83(.a(x6), .b(new_n29_), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n18_), .c(x1), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(new_n100_), .c(x0), .O(new_n103_));
  nand2  g86(.a(x3), .b(x1), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n20_), .c(new_n18_), .O(new_n105_));
  aoi21  g88(.a(new_n105_), .b(new_n77_), .c(new_n21_), .O(new_n106_));
  or2    g89(.a(new_n106_), .b(new_n103_), .O(z5));
  oai21  g90(.a(new_n94_), .b(x2), .c(x1), .O(new_n108_));
  nand3  g91(.a(new_n101_), .b(new_n18_), .c(new_n28_), .O(new_n109_));
  nand2  g92(.a(new_n109_), .b(new_n108_), .O(z6));
  nand2  g93(.a(new_n101_), .b(new_n18_), .O(new_n111_));
  nand2  g94(.a(new_n111_), .b(new_n100_), .O(z7));
  aoi21  g95(.a(x6), .b(new_n18_), .c(x3), .O(z8));
  aoi21  g96(.a(x5), .b(x4), .c(new_n18_), .O(new_n114_));
  nand2  g97(.a(new_n40_), .b(new_n21_), .O(new_n115_));
  nand3  g98(.a(new_n115_), .b(x5), .c(x4), .O(new_n116_));
  oai21  g99(.a(new_n114_), .b(new_n20_), .c(new_n116_), .O(z9));
endmodule
