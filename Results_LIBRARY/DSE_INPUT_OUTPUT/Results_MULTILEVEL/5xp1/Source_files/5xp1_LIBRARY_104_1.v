...
module FAU ( 
  ...
  oai21  g21(.a(new_n24_), .b(new_n27_), .c(new_n19_), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(new_n38_), .c(new_n36_), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(new_n20_), .c(x4), .O(new_n41_));
  nand2  g24(.a(new_n28_), .b(x0), .O(new_n42_));
  nand3  g25(.a(x5), .b(x3), .c(x2), .O(new_n43_));
  aoi21  g26(.a(new_n43_), .b(new_n42_), .c(x4), .O(new_n44_));
  aoi21  g27(.a(new_n24_), .b(new_n19_), .c(new_n20_), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n44_), .c(x1), .O(new_n46_));
  oai21  g29(.a(x5), .b(x2), .c(x0), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n43_), .c(x4), .O(new_n48_));
  nor2   g31(.a(new_n24_), .b(x4), .O(new_n49_));
  aoi22  g32(.a(new_n49_), .b(x0), .c(new_n48_), .d(x6), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n46_), .c(new_n41_), .O(z2));
  ...
  nand3  g39(.a(new_n24_), .b(new_n26_), .c(new_n34_), .O(new_n57_));
  nand3  g40(.a(x6), .b(x5), .c(x1), .O(new_n58_));
  aoi21  g41(.a(new_n58_), .b(new_n57_), .c(new_n19_), .O(new_n59_));
  nand2  g42(.a(x3), .b(x2), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(x5), .c(new_n34_), .O(new_n61_));
  nand3  g44(.a(x6), .b(new_n24_), .c(x1), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n61_), .c(x0), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n59_), .c(x4), .O(new_n64_));
  xor2a  g47(.a(x5), .b(x0), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n34_), .O(new_n66_));
  nand3  g49(.a(x5), .b(x3), .c(x1), .O(new_n67_));
  inv1   g50(.a(new_n67_), .O(new_n68_));
  nor3   g51(.a(x5), .b(x3), .c(x2), .O(new_n69_));
  oai21  g52(.a(new_n69_), .b(new_n68_), .c(x0), .O(new_n70_));
  nand3  g53(.a(new_n60_), .b(x5), .c(new_n19_), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n70_), .c(new_n66_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n20_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n64_), .c(new_n56_), .O(z3));
  aoi21  g57(.a(new_n42_), .b(new_n60_), .c(new_n20_), .O(new_n75_));
  nand2  g58(.a(new_n60_), .b(new_n19_), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n28_), .c(x6), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(new_n75_), .c(x1), .O(new_n78_));
  nor2   g61(.a(x3), .b(x0), .O(new_n79_));
  nor3   g62(.a(new_n79_), .b(x6), .c(new_n26_), .O(new_n80_));
  nor2   g63(.a(new_n79_), .b(new_n26_), .O(new_n81_));
  nor2   g64(.a(new_n81_), .b(new_n20_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n80_), .c(new_n34_), .O(new_n83_));
  nor2   g66(.a(new_n20_), .b(x4), .O(new_n84_));
  ...
  oai21  g71(.a(new_n87_), .b(new_n34_), .c(new_n88_), .O(new_n89_));
  ...
  nand3  g76(.a(new_n93_), .b(new_n90_), .c(new_n85_), .O(z5));
  nand2  g77(.a(new_n87_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n26_), .c(new_n34_), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n95_), .c(new_n85_), .O(z6));
  nand3  g80(.a(new_n88_), .b(new_n87_), .c(new_n85_), .O(z7));
  nor2   g81(.a(new_n84_), .b(x3), .O(z8));
  aoi21  g82(.a(new_n21_), .b(new_n19_), .c(new_n18_), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(x6), .c(x5), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(new_n85_), .O(z9));
endmodule
