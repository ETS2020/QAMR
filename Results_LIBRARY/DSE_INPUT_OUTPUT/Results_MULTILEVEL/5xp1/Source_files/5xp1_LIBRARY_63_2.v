...
module FAU ( 
  ...
  aoi22  g62(.a(new_n79_), .b(new_n43_), .c(new_n77_), .d(x6), .O(new_n80_));
  nor2   g63(.a(x3), .b(x0), .O(new_n81_));
  nor2   g64(.a(new_n81_), .b(x6), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n43_), .c(x2), .O(new_n83_));
  oai21  g66(.a(new_n81_), .b(new_n30_), .c(x6), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n20_), .O(new_n86_));
  oai21  g69(.a(new_n80_), .b(new_n20_), .c(new_n86_), .O(z4));
  nand2  g70(.a(x3), .b(new_n30_), .O(new_n88_));
  nand2  g71(.a(new_n31_), .b(x2), .O(new_n89_));
  ...
  oai21  g75(.a(new_n92_), .b(new_n64_), .c(x0), .O(new_n93_));
  nor2   g76(.a(x6), .b(new_n43_), .O(new_n94_));
  inv1   g77(.a(new_n94_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n93_), .c(new_n91_), .O(z5));
  nand2  g79(.a(new_n88_), .b(x1), .O(new_n97_));
  nand3  g80(.a(x3), .b(new_n30_), .c(new_n20_), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n97_), .c(new_n95_), .O(z6));
  aoi21  g82(.a(new_n89_), .b(new_n88_), .c(new_n94_), .O(z7));
  nor2   g83(.a(new_n94_), .b(x3), .O(z8));
  aoi21  g84(.a(x6), .b(new_n18_), .c(new_n43_), .O(z9));
endmodule
