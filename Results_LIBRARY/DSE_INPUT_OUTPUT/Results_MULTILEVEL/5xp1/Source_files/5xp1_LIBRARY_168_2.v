...
module FAU ( 
  ...
  aoi22  g20(.a(new_n24_), .b(new_n22_), .c(new_n18_), .d(new_n37_), .O(new_n38_));
  oai22  g21(.a(new_n38_), .b(x1), .c(x5), .d(x0), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(x6), .c(new_n21_), .O(new_n40_));
  ...
  aoi21  g28(.a(new_n18_), .b(new_n22_), .c(new_n21_), .O(new_n46_));
  ...
  nor2   g32(.a(x6), .b(new_n18_), .O(new_n50_));
  aoi22  g33(.a(new_n50_), .b(x0), .c(new_n49_), .d(x4), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n47_), .c(new_n40_), .O(z2));
  oai21  g35(.a(x4), .b(new_n23_), .c(new_n19_), .O(new_n53_));
  nand3  g36(.a(new_n18_), .b(x3), .c(new_n22_), .O(new_n54_));
  oai21  g37(.a(new_n18_), .b(new_n22_), .c(new_n54_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n53_), .c(x2), .O(new_n56_));
  oai21  g39(.a(x4), .b(new_n41_), .c(new_n19_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(x1), .c(x0), .O(new_n58_));
  inv1   g41(.a(new_n58_), .O(new_n59_));
  nor2   g42(.a(new_n19_), .b(x1), .O(new_n60_));
  ...
  nand2  g48(.a(new_n19_), .b(new_n21_), .O(new_n66_));
  ...
  nand3  g54(.a(x6), .b(x1), .c(new_n22_), .O(new_n72_));
  ...
  nand2  g58(.a(new_n43_), .b(new_n24_), .O(new_n76_));
  nand2  g59(.a(new_n24_), .b(new_n22_), .O(new_n77_));
  aoi21  g60(.a(new_n42_), .b(new_n77_), .c(x6), .O(new_n78_));
  aoi22  g61(.a(new_n78_), .b(new_n21_), .c(new_n76_), .d(x6), .O(new_n79_));
  nor2   g62(.a(x3), .b(x0), .O(new_n80_));
  nor2   g63(.a(new_n80_), .b(x6), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n21_), .c(x2), .O(new_n82_));
  oai21  g65(.a(new_n80_), .b(new_n37_), .c(x6), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n23_), .O(new_n85_));
  oai21  g68(.a(new_n79_), .b(new_n23_), .c(new_n85_), .O(z4));
  nand2  g69(.a(x3), .b(new_n37_), .O(new_n87_));
  nand2  g70(.a(new_n41_), .b(x2), .O(new_n88_));
  ...
  aoi21  g76(.a(new_n93_), .b(new_n90_), .c(new_n34_), .O(z5));
  nand2  g77(.a(new_n87_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n37_), .c(new_n23_), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n95_), .c(new_n35_), .O(z6));
  nand3  g80(.a(new_n88_), .b(new_n87_), .c(new_n35_), .O(z7));
