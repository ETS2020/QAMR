...
module FAU ( 
  ...
  nand4  g52(.a(x5), .b(new_n46_), .c(x2), .d(new_n19_), .O(new_n70_));
  oai21  g53(.a(new_n69_), .b(new_n68_), .c(new_n70_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(new_n33_), .O(new_n72_));
  nor2   g55(.a(x6), .b(x1), .O(new_n73_));
  nand3  g56(.a(new_n29_), .b(x3), .c(new_n19_), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n55_), .c(new_n73_), .O(new_n75_));
  nand4  g58(.a(new_n20_), .b(x5), .c(new_n46_), .d(new_n19_), .O(new_n76_));
  inv1   g59(.a(new_n76_), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(new_n75_), .c(x2), .O(new_n78_));
  nand2  g61(.a(new_n29_), .b(new_n19_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n55_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(x6), .c(x1), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n78_), .c(new_n72_), .O(z3));
  xor2a  g65(.a(x6), .b(x1), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n46_), .c(new_n19_), .O(new_n84_));
  nand3  g67(.a(x6), .b(x2), .c(x1), .O(new_n85_));
  inv1   g68(.a(new_n85_), .O(new_n86_));
  oai22  g69(.a(new_n86_), .b(new_n73_), .c(x3), .d(x0), .O(new_n87_));
  aoi21  g70(.a(x6), .b(x1), .c(x2), .O(new_n88_));
  nor2   g71(.a(new_n33_), .b(new_n19_), .O(new_n89_));
  nand2  g72(.a(x6), .b(x3), .O(new_n90_));
  inv1   g73(.a(new_n90_), .O(new_n91_));
  aoi21  g74(.a(new_n91_), .b(new_n89_), .c(new_n88_), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n87_), .c(new_n84_), .O(z4));
  ...
  oai21  g81(.a(new_n98_), .b(x2), .c(new_n38_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(x0), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(new_n97_), .c(new_n45_), .O(z5));
  aoi21  g84(.a(x3), .b(new_n33_), .c(new_n20_), .O(new_n102_));
  nor2   g85(.a(new_n90_), .b(x2), .O(new_n103_));
  oai22  g86(.a(new_n103_), .b(new_n33_), .c(new_n102_), .d(x2), .O(z6));
  or2    g87(.a(new_n103_), .b(new_n96_), .O(z7));
  nand2  g88(.a(new_n45_), .b(x3), .O(z8));
  oai21  g89(.a(new_n98_), .b(x0), .c(x2), .O(new_n107_));
