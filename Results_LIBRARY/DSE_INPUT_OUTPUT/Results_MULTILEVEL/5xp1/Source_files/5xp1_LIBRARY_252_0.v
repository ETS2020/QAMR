...
module FAU ( 
  ...
  oai21  g20(.a(new_n20_), .b(new_n23_), .c(new_n37_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n29_), .O(new_n39_));
  nand3  g22(.a(x6), .b(new_n23_), .c(new_n33_), .O(new_n40_));
  nand3  g23(.a(new_n20_), .b(x4), .c(x3), .O(new_n41_));
  aoi21  g24(.a(new_n41_), .b(new_n40_), .c(x2), .O(new_n42_));
  nand3  g25(.a(x6), .b(new_n23_), .c(new_n18_), .O(new_n43_));
  aoi21  g26(.a(new_n43_), .b(new_n41_), .c(x1), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n42_), .c(new_n19_), .O(new_n45_));
  nand3  g28(.a(new_n20_), .b(new_n23_), .c(x3), .O(new_n46_));
  ...
  nand2  g62(.a(z8), .b(new_n33_), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(new_n78_), .c(new_n29_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n75_), .c(new_n19_), .O(new_n82_));
  oai21  g65(.a(new_n30_), .b(new_n33_), .c(new_n35_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(x5), .O(new_n84_));
  inv1   g67(.a(x2), .O(new_n85_));
  nand2  g68(.a(x6), .b(new_n85_), .O(new_n86_));
  oai21  g69(.a(x6), .b(new_n18_), .c(new_n86_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n29_), .c(new_n33_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n84_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(x0), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n82_), .O(z3));
  oai21  g74(.a(x3), .b(x2), .c(x0), .O(new_n92_));
  aoi21  g75(.a(new_n92_), .b(new_n71_), .c(new_n33_), .O(new_n93_));
  ...
  nand3  g79(.a(new_n85_), .b(x1), .c(new_n19_), .O(new_n97_));
  oai21  g80(.a(new_n85_), .b(x1), .c(new_n97_), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n20_), .c(x3), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n96_), .O(z4));
  inv1   g83(.a(new_n30_), .O(new_n101_));
  nand2  g84(.a(x3), .b(new_n85_), .O(new_n102_));
  nand2  g85(.a(new_n18_), .b(x2), .O(new_n103_));
  oai21  g86(.a(new_n102_), .b(new_n33_), .c(new_n103_), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n19_), .O(new_n105_));
  nor2   g88(.a(x3), .b(x2), .O(new_n106_));
  aoi21  g89(.a(new_n85_), .b(x1), .c(new_n18_), .O(new_n107_));
  oai21  g90(.a(new_n107_), .b(new_n106_), .c(x0), .O(new_n108_));
  nand3  g91(.a(new_n108_), .b(new_n105_), .c(new_n101_), .O(z5));
  nand2  g92(.a(new_n102_), .b(x1), .O(new_n110_));
  nand3  g93(.a(x3), .b(new_n85_), .c(new_n33_), .O(new_n111_));
