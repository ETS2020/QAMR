...
module FAU ( 
  ...
  nand2  g50(.a(new_n19_), .b(new_n25_), .O(new_n68_));
  ...
  nor2   g55(.a(new_n72_), .b(new_n18_), .O(new_n73_));
  nand2  g56(.a(x6), .b(x1), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n20_), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(new_n68_), .c(x0), .O(new_n76_));
  oai21  g59(.a(new_n76_), .b(new_n73_), .c(x5), .O(new_n77_));
  oai21  g60(.a(new_n19_), .b(new_n51_), .c(new_n25_), .O(new_n78_));
  inv1   g61(.a(x3), .O(new_n79_));
  nand3  g62(.a(new_n19_), .b(new_n79_), .c(new_n51_), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(new_n78_), .c(new_n18_), .O(new_n81_));
  nor2   g64(.a(new_n74_), .b(x0), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n81_), .c(new_n30_), .O(new_n83_));
  nor2   g66(.a(new_n19_), .b(new_n24_), .O(new_n84_));
  inv1   g67(.a(new_n84_), .O(new_n85_));
  nand4  g68(.a(new_n85_), .b(new_n83_), .c(new_n77_), .d(new_n71_), .O(z3));
  aoi21  g69(.a(new_n56_), .b(new_n20_), .c(new_n19_), .O(new_n87_));
  aoi21  g70(.a(new_n79_), .b(new_n51_), .c(new_n62_), .O(new_n88_));
  nor2   g71(.a(new_n88_), .b(x6), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n87_), .c(x1), .O(new_n90_));
  nor2   g73(.a(x3), .b(x0), .O(new_n91_));
  nor3   g74(.a(new_n91_), .b(x6), .c(new_n51_), .O(new_n92_));
  nor2   g75(.a(new_n91_), .b(new_n51_), .O(new_n93_));
  nor2   g76(.a(new_n93_), .b(new_n19_), .O(new_n94_));
  oai21  g77(.a(new_n94_), .b(new_n92_), .c(new_n25_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n90_), .c(new_n85_), .O(z4));
  nand2  g79(.a(x3), .b(new_n51_), .O(new_n97_));
  nand2  g80(.a(new_n79_), .b(x2), .O(new_n98_));
  ...
  aoi21  g85(.a(new_n102_), .b(new_n100_), .c(new_n84_), .O(z5));
  nand2  g86(.a(new_n97_), .b(x1), .O(new_n104_));
  nand3  g87(.a(x3), .b(new_n51_), .c(new_n25_), .O(new_n105_));
  aoi21  g88(.a(new_n105_), .b(new_n104_), .c(new_n84_), .O(z6));
  nand3  g89(.a(new_n98_), .b(new_n97_), .c(new_n85_), .O(z7));
  nand2  g90(.a(new_n85_), .b(x3), .O(z8));
  nand2  g91(.a(new_n22_), .b(new_n18_), .O(new_n109_));
  nand4  g92(.a(new_n109_), .b(new_n19_), .c(x5), .d(x4), .O(new_n110_));
