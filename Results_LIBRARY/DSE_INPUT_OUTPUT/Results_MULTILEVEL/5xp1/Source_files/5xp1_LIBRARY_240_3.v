...
module FAU ( 
  ...
  nand3  g18(.a(new_n35_), .b(new_n18_), .c(x0), .O(new_n36_));
  ...
  oai21  g22(.a(new_n39_), .b(new_n19_), .c(x4), .O(new_n40_));
  nand2  g23(.a(x5), .b(x0), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  oai21  g25(.a(new_n42_), .b(new_n38_), .c(new_n33_), .O(new_n43_));
  oai21  g26(.a(x2), .b(x1), .c(x4), .O(new_n44_));
  ...
  oai21  g34(.a(new_n51_), .b(new_n45_), .c(x6), .O(new_n52_));
  nor2   g35(.a(new_n49_), .b(new_n18_), .O(z9));
  inv1   g36(.a(z9), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n52_), .c(new_n43_), .O(z2));
  nand2  g38(.a(new_n33_), .b(new_n20_), .O(new_n56_));
  nand3  g39(.a(new_n49_), .b(x3), .c(new_n19_), .O(new_n57_));
  ...
  nand3  g43(.a(new_n21_), .b(new_n33_), .c(new_n19_), .O(new_n61_));
  aoi21  g44(.a(new_n61_), .b(new_n60_), .c(new_n20_), .O(new_n62_));
  oai21  g45(.a(new_n33_), .b(new_n20_), .c(x4), .O(new_n63_));
  nand3  g46(.a(x6), .b(x3), .c(x2), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n20_), .c(new_n19_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  oai21  g49(.a(new_n66_), .b(new_n62_), .c(x5), .O(new_n67_));
  nand2  g50(.a(x5), .b(new_n18_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(x6), .c(new_n19_), .O(new_n69_));
  nor2   g52(.a(x6), .b(x5), .O(new_n70_));
  nand4  g53(.a(new_n70_), .b(new_n34_), .c(new_n27_), .d(x0), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(x1), .O(new_n73_));
  nand2  g56(.a(x6), .b(x2), .O(new_n74_));
  nand4  g57(.a(new_n74_), .b(new_n49_), .c(new_n20_), .d(x0), .O(new_n75_));
  nand4  g58(.a(new_n75_), .b(new_n73_), .c(new_n67_), .d(new_n59_), .O(z3));
  nand2  g59(.a(new_n35_), .b(x0), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n21_), .c(new_n33_), .O(new_n78_));
  inv1   g61(.a(new_n46_), .O(new_n79_));
  ...
  nor3   g65(.a(new_n82_), .b(x6), .c(new_n27_), .O(new_n83_));
  nor2   g66(.a(new_n82_), .b(new_n27_), .O(new_n84_));
  nor2   g67(.a(new_n84_), .b(new_n33_), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n83_), .c(new_n20_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n81_), .c(new_n54_), .O(z4));
  nand2  g70(.a(x3), .b(new_n27_), .O(new_n88_));
  ...
  nand3  g77(.a(new_n94_), .b(new_n91_), .c(new_n54_), .O(z5));
  nand2  g78(.a(new_n88_), .b(x1), .O(new_n96_));
  nand3  g79(.a(x3), .b(new_n27_), .c(new_n20_), .O(new_n97_));
  aoi21  g80(.a(new_n97_), .b(new_n96_), .c(z9), .O(z6));
  nand3  g81(.a(new_n89_), .b(new_n88_), .c(new_n54_), .O(z7));
  nand2  g82(.a(new_n54_), .b(x3), .O(z8));
endmodule
