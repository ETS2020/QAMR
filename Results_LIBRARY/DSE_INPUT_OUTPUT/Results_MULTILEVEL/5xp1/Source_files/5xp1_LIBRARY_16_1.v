...
module FAU ( 
  ...
  aoi21  g21(.a(new_n30_), .b(x6), .c(new_n18_), .O(new_n39_));
  ...
  aoi21  g29(.a(new_n45_), .b(new_n33_), .c(new_n46_), .O(new_n47_));
  aoi21  g30(.a(new_n47_), .b(new_n44_), .c(new_n28_), .O(new_n48_));
  ...
  nand4  g37(.a(new_n22_), .b(new_n28_), .c(new_n29_), .d(new_n20_), .O(new_n55_));
  nand2  g38(.a(new_n30_), .b(x4), .O(new_n56_));
  ...
  aoi21  g43(.a(new_n60_), .b(new_n43_), .c(new_n33_), .O(new_n61_));
  ...
  inv1   g68(.a(new_n40_), .O(new_n86_));
  nand2  g69(.a(x3), .b(new_n33_), .O(new_n87_));
  nand2  g70(.a(new_n34_), .b(x2), .O(new_n88_));
  oai21  g71(.a(new_n87_), .b(new_n29_), .c(new_n88_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n20_), .O(new_n90_));
  aoi21  g73(.a(x3), .b(x1), .c(x2), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n23_), .c(x0), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n90_), .c(new_n86_), .O(z5));
  nand2  g76(.a(new_n87_), .b(x1), .O(new_n94_));
  nand3  g77(.a(x3), .b(new_n33_), .c(new_n29_), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n94_), .c(new_n40_), .O(z6));
  nand3  g79(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(z7));
  nor2   g80(.a(new_n40_), .b(x3), .O(z8));
  aoi21  g81(.a(new_n24_), .b(new_n20_), .c(new_n18_), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(x6), .c(x4), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n86_), .O(z9));
endmodule
