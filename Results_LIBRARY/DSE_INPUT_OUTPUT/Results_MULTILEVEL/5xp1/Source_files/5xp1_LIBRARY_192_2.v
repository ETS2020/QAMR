...
module FAU ( 
  ...
  nand3  g53(.a(new_n70_), .b(new_n24_), .c(x6), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(x1), .O(new_n72_));
  nand3  g55(.a(new_n67_), .b(new_n28_), .c(x2), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(new_n72_), .c(new_n69_), .O(z4));
  inv1   g57(.a(x2), .O(new_n75_));
  nand2  g58(.a(x3), .b(new_n75_), .O(new_n76_));
  nand2  g59(.a(new_n66_), .b(x2), .O(new_n77_));
  ...
  inv1   g64(.a(new_n24_), .O(new_n82_));
  aoi21  g65(.a(x3), .b(x1), .c(x2), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n82_), .c(x0), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(new_n81_), .c(new_n79_), .O(z5));
  nand3  g68(.a(new_n76_), .b(x6), .c(x1), .O(new_n86_));
  oai21  g69(.a(new_n76_), .b(x1), .c(new_n86_), .O(z6));
  nand3  g70(.a(new_n77_), .b(new_n76_), .c(new_n36_), .O(z7));
  aoi21  g71(.a(new_n28_), .b(x1), .c(x3), .O(z8));
  oai21  g72(.a(x6), .b(x0), .c(x5), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n18_), .c(new_n36_), .O(z9));
endmodule
