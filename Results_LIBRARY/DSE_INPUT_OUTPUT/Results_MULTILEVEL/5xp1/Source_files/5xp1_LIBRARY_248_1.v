...
module FAU ( 
  ...
  oai21  g082(.a(new_n46_), .b(new_n61_), .c(new_n99_), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(x0), .O(new_n101_));
  nand2  g084(.a(new_n39_), .b(new_n21_), .O(new_n102_));
  ...
  nand3  g104(.a(x3), .b(new_n35_), .c(new_n61_), .O(new_n122_));
  nand2  g105(.a(new_n122_), .b(new_n121_), .O(z6));
  nand2  g106(.a(z8), .b(x2), .O(new_n124_));
  oai21  g107(.a(new_n120_), .b(x2), .c(new_n124_), .O(z7));
