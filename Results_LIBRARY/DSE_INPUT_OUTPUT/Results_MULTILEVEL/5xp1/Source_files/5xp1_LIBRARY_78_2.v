...
module FAU ( 
  ...
  nand3  g35(.a(new_n52_), .b(new_n18_), .c(new_n19_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n47_), .O(z2));
  nand2  g37(.a(new_n18_), .b(new_n21_), .O(new_n55_));
  nand3  g38(.a(new_n25_), .b(x3), .c(new_n20_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n51_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n55_), .c(x2), .O(new_n58_));
  oai21  g41(.a(x6), .b(x3), .c(x5), .O(new_n59_));
  nand3  g42(.a(x6), .b(new_n25_), .c(new_n20_), .O(new_n60_));
  oai21  g43(.a(new_n59_), .b(new_n20_), .c(new_n60_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(x1), .O(new_n62_));
  inv1   g45(.a(x2), .O(new_n63_));
  nor2   g46(.a(new_n18_), .b(new_n63_), .O(new_n64_));
  xnor2a g47(.a(x5), .b(x0), .O(new_n65_));
  inv1   g48(.a(x3), .O(new_n66_));
  nand3  g49(.a(x5), .b(new_n66_), .c(new_n20_), .O(new_n67_));
  oai21  g50(.a(new_n65_), .b(new_n64_), .c(new_n67_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(new_n21_), .O(new_n69_));
  nand3  g52(.a(new_n22_), .b(x5), .c(new_n20_), .O(new_n70_));
  nand4  g53(.a(new_n25_), .b(new_n66_), .c(new_n63_), .d(x0), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n70_), .c(new_n19_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n18_), .O(new_n73_));
  nand4  g56(.a(new_n73_), .b(new_n69_), .c(new_n62_), .d(new_n58_), .O(z3));
  aoi21  g57(.a(new_n48_), .b(new_n22_), .c(new_n18_), .O(new_n75_));
  inv1   g58(.a(new_n44_), .O(new_n76_));
  nand2  g59(.a(new_n66_), .b(new_n63_), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n76_), .c(x6), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n19_), .c(new_n75_), .O(new_n79_));
  nand2  g62(.a(new_n66_), .b(new_n20_), .O(new_n80_));
  nand4  g63(.a(new_n80_), .b(new_n18_), .c(new_n19_), .d(x2), .O(new_n81_));
  inv1   g64(.a(new_n81_), .O(new_n82_));
  aoi21  g65(.a(new_n80_), .b(x2), .c(new_n18_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n82_), .c(new_n21_), .O(new_n84_));
  oai21  g67(.a(new_n79_), .b(new_n21_), .c(new_n84_), .O(z4));
  nand2  g68(.a(x3), .b(new_n63_), .O(new_n86_));
  nand2  g69(.a(new_n66_), .b(x2), .O(new_n87_));
  ...
  nand3  g77(.a(x3), .b(new_n63_), .c(new_n21_), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n94_), .c(new_n34_), .O(z6));
  aoi21  g79(.a(new_n87_), .b(new_n86_), .c(new_n34_), .O(z7));
  nand2  g80(.a(new_n35_), .b(x3), .O(z8));
