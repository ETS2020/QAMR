...
module FAU ( 
  ...
  nand2  g75(.a(new_n19_), .b(new_n29_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n92_), .c(new_n87_), .O(z4));
  nand2  g77(.a(x3), .b(new_n80_), .O(new_n95_));
  ...
  nand3  g85(.a(x3), .b(new_n80_), .c(new_n23_), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n102_), .c(new_n93_), .O(z6));
  nand3  g87(.a(new_n96_), .b(new_n95_), .c(new_n93_), .O(z7));
  nand2  g88(.a(new_n93_), .b(x3), .O(z8));
  nand3  g89(.a(new_n51_), .b(x5), .c(x4), .O(new_n107_));
  nand2  g90(.a(new_n107_), .b(new_n93_), .O(z9));
endmodule
