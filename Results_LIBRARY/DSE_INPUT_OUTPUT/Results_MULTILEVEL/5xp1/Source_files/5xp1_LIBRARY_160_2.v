...
module FAU ( 
  ...
  aoi22  g52(.a(new_n69_), .b(new_n22_), .c(new_n67_), .d(new_n18_), .O(new_n70_));
  oai21  g53(.a(x5), .b(x2), .c(x6), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(new_n22_), .O(new_n72_));
  oai21  g55(.a(x2), .b(x1), .c(x5), .O(new_n73_));
  nand3  g56(.a(new_n20_), .b(new_n47_), .c(new_n31_), .O(new_n74_));
  ...
  nand2  g61(.a(new_n47_), .b(new_n31_), .O(new_n79_));
  ...
  oai21  g70(.a(new_n85_), .b(new_n31_), .c(x6), .O(new_n88_));
  ...
  nand2  g75(.a(new_n47_), .b(x2), .O(new_n93_));
  ...
  oai21  g79(.a(new_n96_), .b(new_n68_), .c(x0), .O(new_n97_));
  ...
  aoi21  g83(.a(new_n100_), .b(new_n99_), .c(new_n76_), .O(z6));
  aoi21  g84(.a(new_n93_), .b(new_n92_), .c(new_n76_), .O(z7));
  nor2   g85(.a(new_n76_), .b(x3), .O(z8));
