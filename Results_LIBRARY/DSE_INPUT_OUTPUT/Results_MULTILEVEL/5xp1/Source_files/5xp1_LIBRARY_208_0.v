...
module FAU ( 
  ...
  nand2  g45(.a(new_n19_), .b(new_n18_), .O(new_n63_));
  nand4  g46(.a(new_n63_), .b(new_n62_), .c(new_n55_), .d(new_n49_), .O(z2));
  nand3  g47(.a(new_n18_), .b(x2), .c(new_n21_), .O(new_n65_));
  oai21  g48(.a(new_n51_), .b(new_n21_), .c(new_n65_), .O(new_n66_));
  ...
  oai21  g56(.a(new_n58_), .b(new_n21_), .c(new_n73_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  oai21  g58(.a(new_n25_), .b(x0), .c(x6), .O(new_n76_));
  nor2   g59(.a(new_n35_), .b(x6), .O(new_n77_));
  ...
  nand3  g84(.a(new_n101_), .b(new_n100_), .c(new_n63_), .O(z6));
  nand3  g85(.a(new_n94_), .b(new_n93_), .c(new_n63_), .O(z7));
  nand2  g86(.a(new_n63_), .b(x3), .O(z8));
