...
module FAU ( 
  ...
  oai21  g016(.a(new_n28_), .b(new_n18_), .c(new_n33_), .O(z0));
  inv1   g017(.a(x2), .O(new_n35_));
  nand3  g018(.a(new_n22_), .b(x3), .c(new_n35_), .O(new_n36_));
  nand2  g019(.a(new_n29_), .b(x4), .O(new_n37_));
  ...
  oai21  g024(.a(new_n41_), .b(new_n38_), .c(new_n19_), .O(new_n42_));
  nand2  g025(.a(new_n29_), .b(new_n22_), .O(new_n43_));
  nand2  g026(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  nand2  g027(.a(new_n44_), .b(x5), .O(new_n45_));
  nand2  g028(.a(x6), .b(x3), .O(new_n46_));
  nand3  g029(.a(new_n29_), .b(x4), .c(x1), .O(new_n47_));
  ...
  aoi21  g033(.a(new_n50_), .b(new_n49_), .c(new_n19_), .O(new_n51_));
  nand3  g034(.a(x6), .b(x4), .c(x3), .O(new_n52_));
  inv1   g035(.a(new_n52_), .O(new_n53_));
  oai21  g036(.a(new_n53_), .b(new_n51_), .c(new_n20_), .O(new_n54_));
  ...
  oai21  g041(.a(new_n20_), .b(new_n35_), .c(new_n19_), .O(new_n59_));
  aoi21  g042(.a(new_n59_), .b(new_n58_), .c(new_n22_), .O(new_n60_));
  ...
  oai21  g048(.a(new_n65_), .b(new_n60_), .c(new_n29_), .O(new_n66_));
  nand2  g049(.a(new_n26_), .b(new_n19_), .O(new_n67_));
  nand3  g050(.a(new_n20_), .b(new_n35_), .c(new_n56_), .O(new_n68_));
  aoi21  g051(.a(new_n68_), .b(new_n67_), .c(x4), .O(new_n69_));
  oai22  g052(.a(x5), .b(x0), .c(x2), .d(x1), .O(new_n70_));
  nand2  g053(.a(new_n70_), .b(new_n57_), .O(new_n71_));
  ...
  nand3  g065(.a(new_n39_), .b(x5), .c(new_n19_), .O(new_n83_));
  ...
  oai21  g073(.a(new_n90_), .b(new_n56_), .c(new_n87_), .O(new_n91_));
  nand3  g074(.a(new_n91_), .b(new_n20_), .c(new_n19_), .O(new_n92_));
  ...
  nand3  g078(.a(new_n29_), .b(x2), .c(new_n56_), .O(new_n96_));
  oai21  g079(.a(new_n29_), .b(new_n56_), .c(new_n96_), .O(new_n97_));
  nand2  g080(.a(new_n97_), .b(x0), .O(new_n98_));
  oai21  g081(.a(new_n90_), .b(new_n18_), .c(new_n19_), .O(new_n99_));
  nor2   g082(.a(x3), .b(x2), .O(new_n100_));
  aoi21  g083(.a(x6), .b(x2), .c(new_n100_), .O(new_n101_));
  nand2  g084(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand2  g085(.a(new_n102_), .b(x1), .O(new_n103_));
  nand3  g086(.a(new_n29_), .b(x3), .c(x2), .O(new_n104_));
  oai21  g087(.a(new_n29_), .b(x2), .c(new_n104_), .O(new_n105_));
  nor2   g088(.a(new_n29_), .b(x3), .O(new_n106_));
  aoi21  g089(.a(new_n105_), .b(new_n56_), .c(new_n106_), .O(new_n107_));
  nand3  g090(.a(new_n107_), .b(new_n103_), .c(new_n98_), .O(z4));
  inv1   g091(.a(new_n106_), .O(new_n109_));
  nand2  g092(.a(x3), .b(new_n35_), .O(new_n110_));
  nand2  g093(.a(new_n18_), .b(x2), .O(new_n111_));
  oai21  g094(.a(new_n110_), .b(new_n56_), .c(new_n111_), .O(new_n112_));
  nand2  g095(.a(new_n112_), .b(new_n19_), .O(new_n113_));
  aoi21  g096(.a(new_n35_), .b(x1), .c(new_n18_), .O(new_n114_));
  oai21  g097(.a(new_n114_), .b(new_n100_), .c(x0), .O(new_n115_));
  nand3  g098(.a(new_n115_), .b(new_n113_), .c(new_n109_), .O(z5));
  nand2  g099(.a(new_n110_), .b(x1), .O(new_n117_));
  nand3  g100(.a(x3), .b(new_n35_), .c(new_n56_), .O(new_n118_));
  nand3  g101(.a(new_n118_), .b(new_n117_), .c(new_n109_), .O(z6));
  nor2   g102(.a(x6), .b(x3), .O(z8));
  oai21  g103(.a(z8), .b(x2), .c(new_n111_), .O(z7));
  aoi21  g104(.a(x5), .b(x4), .c(new_n18_), .O(new_n122_));
  nand2  g105(.a(new_n30_), .b(new_n19_), .O(new_n123_));
  nand3  g106(.a(new_n123_), .b(x5), .c(x4), .O(new_n124_));
  oai21  g107(.a(new_n122_), .b(new_n29_), .c(new_n124_), .O(z9));
endmodule
