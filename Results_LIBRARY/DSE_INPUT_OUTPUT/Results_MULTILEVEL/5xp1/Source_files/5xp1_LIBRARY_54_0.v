...
module FAU ( 
  ...
  aoi21  g64(.a(new_n81_), .b(new_n24_), .c(new_n20_), .O(new_n82_));
  nand2  g65(.a(new_n57_), .b(new_n30_), .O(new_n83_));
  nand2  g66(.a(new_n24_), .b(new_n19_), .O(new_n84_));
  aoi21  g67(.a(new_n84_), .b(new_n83_), .c(x6), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(x4), .c(new_n82_), .O(new_n86_));
  nand2  g69(.a(new_n57_), .b(new_n19_), .O(new_n87_));
  nand4  g70(.a(new_n87_), .b(new_n20_), .c(x4), .d(x2), .O(new_n88_));
  nor2   g71(.a(x3), .b(x0), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n30_), .c(x6), .O(new_n90_));
  ...
  nand2  g77(.a(new_n57_), .b(x2), .O(new_n95_));
  ...
  aoi21  g82(.a(new_n99_), .b(new_n97_), .c(new_n61_), .O(z5));
  nand2  g83(.a(new_n94_), .b(x1), .O(new_n101_));
  nand3  g84(.a(x3), .b(new_n30_), .c(new_n23_), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n101_), .c(new_n62_), .O(z6));
  nand3  g86(.a(new_n95_), .b(new_n94_), .c(new_n62_), .O(z7));
  nand2  g87(.a(new_n62_), .b(x3), .O(z8));
  nand3  g88(.a(new_n21_), .b(new_n20_), .c(new_n19_), .O(new_n106_));
  nand3  g89(.a(new_n106_), .b(x5), .c(x4), .O(new_n107_));
  nand2  g90(.a(new_n107_), .b(new_n62_), .O(z9));
endmodule
