...
module FAU ( 
  ...
  nand4  g53(.a(new_n70_), .b(new_n69_), .c(new_n62_), .d(new_n53_), .O(z2));
  nand2  g54(.a(new_n23_), .b(new_n40_), .O(new_n72_));
  ...
  oai21  g58(.a(new_n23_), .b(new_n40_), .c(new_n20_), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n72_), .c(x0), .O(new_n77_));
  nand3  g60(.a(x3), .b(x1), .c(x0), .O(new_n78_));
  inv1   g61(.a(new_n78_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n77_), .c(x5), .O(new_n80_));
  nand2  g63(.a(new_n33_), .b(x0), .O(new_n81_));
  nand3  g64(.a(new_n23_), .b(new_n29_), .c(new_n34_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n81_), .c(new_n23_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(x1), .O(new_n84_));
  nand2  g67(.a(x6), .b(x2), .O(new_n85_));
  nand4  g68(.a(new_n85_), .b(new_n29_), .c(new_n40_), .d(x0), .O(new_n86_));
  nand4  g69(.a(new_n86_), .b(new_n84_), .c(new_n80_), .d(new_n75_), .O(z3));
  aoi21  g70(.a(new_n35_), .b(new_n21_), .c(new_n40_), .O(new_n88_));
  ...
  nand3  g74(.a(new_n89_), .b(x6), .c(new_n40_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n91_), .O(z4));
  nand3  g76(.a(new_n70_), .b(new_n34_), .c(x2), .O(new_n94_));
  nand4  g77(.a(new_n23_), .b(x3), .c(new_n33_), .d(x1), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n19_), .O(new_n97_));
  nand2  g80(.a(new_n34_), .b(x2), .O(new_n98_));
  nand2  g81(.a(new_n35_), .b(new_n20_), .O(new_n99_));
  aoi22  g82(.a(new_n99_), .b(new_n23_), .c(new_n98_), .d(new_n40_), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(new_n19_), .c(new_n97_), .O(z5));
  nand2  g84(.a(x3), .b(new_n33_), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n23_), .c(x1), .O(new_n103_));
  oai21  g86(.a(new_n102_), .b(x1), .c(new_n103_), .O(z6));
  inv1   g87(.a(new_n70_), .O(new_n105_));
  aoi21  g88(.a(new_n102_), .b(new_n98_), .c(new_n105_), .O(z7));
  nor2   g89(.a(new_n105_), .b(x3), .O(z8));
