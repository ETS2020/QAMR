...
module FAU ( 
  ...
  nor2   g60(.a(new_n19_), .b(x3), .O(z8));
  nand2  g61(.a(z8), .b(new_n23_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n77_), .c(new_n29_), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n74_), .c(new_n18_), .O(new_n81_));
  oai21  g64(.a(new_n30_), .b(new_n23_), .c(new_n35_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(x5), .O(new_n83_));
  nand2  g66(.a(new_n19_), .b(x3), .O(new_n84_));
  oai21  g67(.a(new_n19_), .b(x2), .c(new_n84_), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n29_), .c(new_n23_), .O(new_n86_));
  ...
  aoi21  g73(.a(new_n90_), .b(new_n24_), .c(new_n19_), .O(new_n91_));
  ...
  aoi21  g77(.a(new_n19_), .b(x3), .c(x2), .O(new_n95_));
  oai22  g78(.a(x6), .b(new_n40_), .c(x3), .d(x0), .O(new_n96_));
  oai21  g79(.a(new_n96_), .b(new_n95_), .c(new_n23_), .O(new_n97_));
  ...
  aoi21  g85(.a(new_n40_), .b(x1), .c(new_n49_), .O(new_n103_));
  nand2  g86(.a(z8), .b(new_n40_), .O(new_n104_));
  inv1   g87(.a(new_n104_), .O(new_n105_));
  oai21  g88(.a(new_n105_), .b(new_n103_), .c(x0), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n102_), .O(z5));
  oai21  g90(.a(z8), .b(new_n71_), .c(x1), .O(new_n108_));
  oai21  g91(.a(new_n99_), .b(x1), .c(new_n108_), .O(z6));
  nand2  g92(.a(new_n49_), .b(x2), .O(new_n110_));
  oai21  g93(.a(z8), .b(x2), .c(new_n110_), .O(z7));
  aoi21  g94(.a(x2), .b(x1), .c(x0), .O(new_n112_));
  oai21  g95(.a(new_n112_), .b(new_n49_), .c(new_n19_), .O(new_n113_));
  nand3  g96(.a(new_n113_), .b(x5), .c(x4), .O(new_n114_));
  nand2  g97(.a(new_n114_), .b(new_n33_), .O(z9));
endmodule
