...
module FAU ( 
  ...
  nand4  g40(.a(new_n25_), .b(new_n20_), .c(new_n30_), .d(x0), .O(new_n58_));
  inv1   g41(.a(new_n58_), .O(new_n59_));
  oai21  g42(.a(new_n59_), .b(new_n57_), .c(new_n56_), .O(new_n60_));
  nand3  g43(.a(new_n20_), .b(new_n29_), .c(x0), .O(new_n61_));
  inv1   g44(.a(new_n61_), .O(new_n62_));
  oai21  g45(.a(new_n62_), .b(new_n57_), .c(new_n30_), .O(new_n63_));
  nand3  g46(.a(new_n25_), .b(new_n20_), .c(x0), .O(new_n64_));
  inv1   g47(.a(new_n64_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n57_), .c(new_n29_), .O(new_n66_));
  nand3  g49(.a(new_n39_), .b(x5), .c(x0), .O(new_n67_));
  nand3  g50(.a(new_n20_), .b(x3), .c(x2), .O(new_n68_));
  ...
  aoi21  g57(.a(new_n74_), .b(new_n20_), .c(new_n25_), .O(new_n75_));
  aoi21  g58(.a(new_n71_), .b(x1), .c(new_n75_), .O(new_n76_));
  nand4  g59(.a(new_n76_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(z3));
  oai21  g60(.a(new_n38_), .b(new_n19_), .c(new_n72_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(x6), .c(new_n20_), .O(new_n79_));
  aoi21  g62(.a(new_n72_), .b(new_n19_), .c(new_n38_), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(x6), .c(new_n79_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(x1), .O(new_n82_));
  nand2  g65(.a(new_n56_), .b(new_n19_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n25_), .c(x2), .O(new_n84_));
  nand2  g67(.a(new_n83_), .b(x2), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(x6), .c(new_n20_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n29_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n82_), .O(z4));
  nand2  g72(.a(x3), .b(new_n30_), .O(new_n90_));
  nand2  g73(.a(new_n56_), .b(x2), .O(new_n91_));
  ...
  oai21  g77(.a(new_n94_), .b(new_n73_), .c(x0), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n93_), .c(new_n26_), .O(z5));
  nand2  g79(.a(new_n90_), .b(x1), .O(new_n97_));
  nand3  g80(.a(x3), .b(new_n30_), .c(new_n29_), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n97_), .c(new_n27_), .O(z6));
  nand3  g82(.a(new_n91_), .b(new_n90_), .c(new_n27_), .O(z7));
  nand2  g83(.a(new_n27_), .b(x3), .O(z8));
  nand2  g84(.a(new_n21_), .b(new_n19_), .O(new_n102_));
  nand4  g85(.a(new_n102_), .b(new_n25_), .c(x5), .d(x4), .O(new_n103_));
