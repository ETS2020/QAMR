...
module FAU ( 
  ...
  nand4  g19(.a(new_n36_), .b(new_n19_), .c(x1), .d(x0), .O(new_n37_));
  nand3  g20(.a(new_n26_), .b(x5), .c(new_n18_), .O(new_n38_));
  aoi21  g21(.a(new_n38_), .b(new_n37_), .c(x6), .O(new_n39_));
  nand3  g22(.a(x6), .b(new_n19_), .c(new_n18_), .O(new_n40_));
  inv1   g23(.a(new_n40_), .O(new_n41_));
  oai21  g24(.a(new_n41_), .b(new_n39_), .c(x4), .O(new_n42_));
  oai21  g25(.a(new_n23_), .b(x0), .c(x6), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(x5), .c(new_n20_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(new_n42_), .O(z1));
  ...
  aoi21  g32(.a(new_n48_), .b(new_n34_), .c(new_n49_), .O(new_n50_));
  aoi21  g33(.a(new_n50_), .b(new_n47_), .c(new_n20_), .O(new_n51_));
  ...
  oai21  g39(.a(new_n56_), .b(new_n51_), .c(new_n25_), .O(new_n57_));
  nand2  g40(.a(new_n23_), .b(x5), .O(new_n58_));
  xor2a  g41(.a(new_n58_), .b(x4), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(x6), .c(new_n18_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n57_), .O(z2));
  nand2  g44(.a(new_n36_), .b(x5), .O(new_n62_));
  nor2   g45(.a(new_n62_), .b(new_n18_), .O(new_n63_));
  nand3  g46(.a(x3), .b(x2), .c(new_n18_), .O(new_n64_));
  aoi21  g47(.a(new_n64_), .b(new_n25_), .c(x5), .O(new_n65_));
  ...
  nand2  g52(.a(new_n36_), .b(x1), .O(new_n70_));
  nand3  g53(.a(new_n70_), .b(new_n19_), .c(x0), .O(new_n71_));
  oai21  g54(.a(new_n25_), .b(new_n21_), .c(new_n22_), .O(new_n72_));
  nand2  g55(.a(new_n25_), .b(new_n21_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(x5), .c(new_n18_), .O(new_n75_));
  nand4  g58(.a(new_n75_), .b(new_n71_), .c(new_n69_), .d(new_n66_), .O(z3));
  oai21  g59(.a(new_n34_), .b(x1), .c(new_n25_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(x0), .O(new_n78_));
  nand3  g61(.a(new_n25_), .b(x1), .c(new_n18_), .O(new_n79_));
  oai21  g62(.a(new_n25_), .b(x1), .c(new_n79_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n22_), .O(new_n81_));
  nand3  g64(.a(x6), .b(x3), .c(x2), .O(new_n82_));
  inv1   g65(.a(new_n82_), .O(new_n83_));
  nor3   g66(.a(x6), .b(x3), .c(x2), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n83_), .c(x1), .O(new_n85_));
  nand4  g68(.a(new_n25_), .b(x3), .c(x2), .d(new_n21_), .O(new_n86_));
  nand4  g69(.a(new_n86_), .b(new_n85_), .c(new_n81_), .d(new_n78_), .O(z4));
  nand2  g70(.a(x3), .b(new_n34_), .O(new_n88_));
  nand2  g71(.a(new_n35_), .b(x2), .O(new_n89_));
  ...
  nand2  g75(.a(new_n22_), .b(new_n25_), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n92_), .c(x0), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n91_), .O(z5));
  nor2   g78(.a(new_n25_), .b(new_n18_), .O(new_n96_));
  nand2  g79(.a(new_n88_), .b(x1), .O(new_n97_));
  nand3  g80(.a(x3), .b(new_n34_), .c(new_n21_), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(z6));
  inv1   g82(.a(new_n96_), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(new_n89_), .c(new_n88_), .O(z7));
  nand2  g84(.a(new_n100_), .b(x3), .O(z8));
  aoi21  g85(.a(new_n26_), .b(new_n25_), .c(x0), .O(new_n103_));
  nor2   g86(.a(x6), .b(new_n18_), .O(new_n104_));
  oai21  g87(.a(new_n104_), .b(new_n103_), .c(x5), .O(new_n105_));
  nor2   g88(.a(new_n105_), .b(new_n20_), .O(z9));
endmodule
