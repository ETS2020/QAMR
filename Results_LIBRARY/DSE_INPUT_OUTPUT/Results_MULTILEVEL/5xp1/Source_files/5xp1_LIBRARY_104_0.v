...
module FAU ( 
  ...
  nand3  g84(.a(new_n101_), .b(new_n99_), .c(new_n44_), .O(z5));
  nand2  g85(.a(new_n96_), .b(x1), .O(new_n103_));
  nand3  g86(.a(x3), .b(new_n57_), .c(new_n24_), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n103_), .c(new_n44_), .O(z6));
  nand3  g88(.a(new_n97_), .b(new_n96_), .c(new_n44_), .O(z7));
  nor2   g89(.a(new_n43_), .b(x3), .O(z8));
