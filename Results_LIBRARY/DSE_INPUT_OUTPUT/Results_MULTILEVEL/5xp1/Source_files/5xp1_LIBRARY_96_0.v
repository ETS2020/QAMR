...
module FAU ( 
  ...
  aoi21  g23(.a(new_n39_), .b(new_n18_), .c(new_n40_), .O(new_n41_));
  oai21  g24(.a(new_n41_), .b(new_n29_), .c(new_n34_), .O(z1));
  ...
  nand3  g58(.a(new_n57_), .b(new_n23_), .c(x0), .O(new_n76_));
  ...
  nand2  g65(.a(new_n24_), .b(new_n18_), .O(new_n83_));
