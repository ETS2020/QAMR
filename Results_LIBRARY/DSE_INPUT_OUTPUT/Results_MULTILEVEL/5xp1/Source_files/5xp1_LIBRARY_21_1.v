...
module FAU ( 
  ...
  nand3  g49(.a(new_n29_), .b(x3), .c(new_n18_), .O(new_n67_));
  aoi21  g50(.a(new_n67_), .b(new_n48_), .c(new_n32_), .O(new_n68_));
  nand2  g51(.a(x5), .b(x3), .O(new_n69_));
  aoi21  g52(.a(new_n69_), .b(new_n19_), .c(new_n18_), .O(new_n70_));
  oai21  g53(.a(new_n70_), .b(new_n68_), .c(x1), .O(new_n71_));
  oai21  g54(.a(new_n32_), .b(new_n18_), .c(x5), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(x6), .O(new_n73_));
  nand2  g56(.a(new_n34_), .b(x1), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(new_n29_), .c(x0), .O(new_n75_));
  oai21  g58(.a(new_n19_), .b(new_n23_), .c(new_n24_), .O(new_n76_));
  nand2  g59(.a(new_n19_), .b(new_n23_), .O(new_n77_));
  ...
  nand2  g63(.a(new_n44_), .b(new_n24_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(x6), .c(x5), .O(new_n82_));
  nor2   g65(.a(x3), .b(x2), .O(new_n83_));
  aoi21  g66(.a(new_n24_), .b(new_n18_), .c(new_n83_), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(x6), .c(new_n82_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(x1), .O(new_n86_));
  nand2  g69(.a(new_n33_), .b(new_n18_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n19_), .c(x2), .O(new_n88_));
  ...
  nor2   g76(.a(new_n19_), .b(x5), .O(new_n94_));
  ...
  oai21  g82(.a(new_n99_), .b(new_n40_), .c(x0), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(new_n98_), .c(new_n94_), .O(z5));
  inv1   g84(.a(new_n94_), .O(new_n102_));
  nand2  g85(.a(new_n95_), .b(x1), .O(new_n103_));
  nand3  g86(.a(x3), .b(new_n32_), .c(new_n23_), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n103_), .c(new_n102_), .O(z6));
  nand3  g88(.a(new_n96_), .b(new_n95_), .c(new_n102_), .O(z7));
  nor2   g89(.a(new_n94_), .b(x3), .O(z8));
  nand3  g90(.a(new_n20_), .b(new_n19_), .c(new_n18_), .O(new_n108_));
