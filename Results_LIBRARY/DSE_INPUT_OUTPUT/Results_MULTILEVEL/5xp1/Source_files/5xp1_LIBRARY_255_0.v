...
module FAU ( 
  ...
  nand2  g81(.a(x3), .b(new_n42_), .O(new_n99_));
  nand2  g82(.a(new_n79_), .b(x2), .O(new_n100_));
  oai21  g83(.a(new_n99_), .b(new_n18_), .c(new_n100_), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(new_n19_), .O(new_n102_));
  oai21  g85(.a(x2), .b(new_n19_), .c(x6), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(new_n18_), .O(new_n104_));
  inv1   g87(.a(new_n34_), .O(new_n105_));
  oai21  g88(.a(new_n89_), .b(new_n105_), .c(x0), .O(new_n106_));
  nand3  g89(.a(new_n106_), .b(new_n104_), .c(new_n102_), .O(z5));
  nand2  g90(.a(new_n99_), .b(x1), .O(new_n108_));
  nand4  g91(.a(x6), .b(x3), .c(new_n42_), .d(new_n18_), .O(new_n109_));
  nand2  g92(.a(new_n109_), .b(new_n108_), .O(z6));
  aoi21  g93(.a(new_n100_), .b(new_n99_), .c(new_n31_), .O(z7));
  nand2  g94(.a(new_n30_), .b(x3), .O(z8));
  nand2  g95(.a(new_n20_), .b(new_n19_), .O(new_n113_));
  nand3  g96(.a(new_n113_), .b(x5), .c(x4), .O(new_n114_));
  nand2  g97(.a(new_n114_), .b(new_n30_), .O(z9));
endmodule
