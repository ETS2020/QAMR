...
module FAU ( 
  ...
  nand3  g75(.a(new_n20_), .b(new_n41_), .c(x2), .O(new_n93_));
  oai21  g76(.a(new_n92_), .b(new_n37_), .c(new_n93_), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n19_), .O(new_n95_));
  oai21  g78(.a(new_n41_), .b(new_n37_), .c(new_n26_), .O(new_n96_));
  nand2  g79(.a(new_n20_), .b(x3), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(new_n26_), .c(new_n96_), .O(new_n98_));
  ...
  nand3  g85(.a(x3), .b(new_n26_), .c(new_n37_), .O(new_n103_));
  oai21  g86(.a(new_n102_), .b(new_n37_), .c(new_n103_), .O(z6));
  nand2  g87(.a(new_n97_), .b(x2), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(new_n92_), .O(z7));
  ...
  nor2   g93(.a(new_n110_), .b(new_n38_), .O(z9));
endmodule
