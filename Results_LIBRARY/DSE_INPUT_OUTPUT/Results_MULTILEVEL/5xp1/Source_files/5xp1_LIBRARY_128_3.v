...
module FAU ( 
  ...
  nand3  g27(.a(x6), .b(x4), .c(new_n19_), .O(new_n45_));
  ...
  oai21  g42(.a(x6), .b(new_n40_), .c(new_n19_), .O(new_n60_));
  ...
  nand3  g56(.a(new_n18_), .b(new_n40_), .c(x0), .O(new_n74_));
  ...
  nand3  g61(.a(new_n21_), .b(new_n19_), .c(new_n40_), .O(new_n79_));
  ...
  nand3  g69(.a(x6), .b(new_n19_), .c(x1), .O(new_n87_));
  nand2  g70(.a(new_n21_), .b(new_n32_), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n87_), .c(new_n24_), .O(new_n89_));
  nor2   g72(.a(x6), .b(new_n19_), .O(new_n90_));
  ...
  nand3  g78(.a(new_n95_), .b(new_n94_), .c(new_n19_), .O(new_n96_));
  nand4  g79(.a(new_n21_), .b(new_n40_), .c(x1), .d(new_n24_), .O(new_n97_));
  nand3  g80(.a(new_n97_), .b(new_n96_), .c(new_n93_), .O(z4));
  nand3  g81(.a(new_n90_), .b(new_n40_), .c(x1), .O(new_n99_));
  oai21  g82(.a(x3), .b(new_n40_), .c(new_n99_), .O(new_n100_));
  ...
  aoi21  g88(.a(new_n21_), .b(x2), .c(new_n19_), .O(new_n106_));
  nand3  g89(.a(new_n90_), .b(new_n40_), .c(new_n32_), .O(new_n107_));
  oai21  g90(.a(new_n106_), .b(new_n32_), .c(new_n107_), .O(z6));
  nand2  g91(.a(x3), .b(new_n40_), .O(new_n109_));
  oai21  g92(.a(new_n90_), .b(new_n40_), .c(new_n109_), .O(z7));
  inv1   g93(.a(new_n90_), .O(z8));
  nand2  g94(.a(x5), .b(x4), .O(new_n112_));
  oai21  g95(.a(new_n112_), .b(new_n25_), .c(new_n21_), .O(new_n113_));
  nand2  g96(.a(new_n113_), .b(x3), .O(new_n114_));
  nand2  g97(.a(new_n21_), .b(new_n24_), .O(new_n115_));
