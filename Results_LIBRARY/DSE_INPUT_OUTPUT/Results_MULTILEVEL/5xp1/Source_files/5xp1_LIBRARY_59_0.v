...
module FAU ( 
  ...
  aoi21  g80(.a(new_n97_), .b(new_n38_), .c(new_n19_), .O(new_n98_));
  or2    g81(.a(new_n98_), .b(new_n95_), .O(z5));
  aoi21  g82(.a(x6), .b(new_n45_), .c(x2), .O(new_n100_));
  nand3  g83(.a(new_n89_), .b(new_n18_), .c(new_n33_), .O(new_n101_));
  oai21  g84(.a(new_n100_), .b(new_n33_), .c(new_n101_), .O(z6));
  inv1   g85(.a(new_n100_), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(new_n93_), .O(z7));
  nand2  g87(.a(new_n30_), .b(x3), .O(z8));
  aoi21  g88(.a(x3), .b(x1), .c(x0), .O(new_n106_));
