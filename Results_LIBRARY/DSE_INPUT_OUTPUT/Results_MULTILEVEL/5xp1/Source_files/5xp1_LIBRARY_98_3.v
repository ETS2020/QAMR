...
module FAU ( 
  ...
  nand3  g16(.a(new_n33_), .b(x4), .c(x1), .O(new_n34_));
  ...
  nor3   g47(.a(new_n32_), .b(new_n28_), .c(new_n22_), .O(new_n65_));
  nand3  g48(.a(x3), .b(x2), .c(new_n22_), .O(new_n66_));
  aoi21  g49(.a(new_n66_), .b(new_n23_), .c(x5), .O(new_n67_));
  oai21  g50(.a(new_n67_), .b(new_n65_), .c(x1), .O(new_n68_));
  nand3  g51(.a(new_n28_), .b(x3), .c(x2), .O(new_n69_));
  nand2  g52(.a(new_n69_), .b(new_n22_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(x6), .O(new_n71_));
  oai21  g54(.a(x3), .b(x2), .c(x1), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(new_n28_), .c(x0), .O(new_n73_));
  oai21  g56(.a(new_n23_), .b(new_n18_), .c(new_n19_), .O(new_n74_));
  nand2  g57(.a(new_n23_), .b(new_n18_), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(x5), .c(new_n22_), .O(new_n77_));
  nand4  g60(.a(new_n77_), .b(new_n73_), .c(new_n71_), .d(new_n68_), .O(z3));
  inv1   g61(.a(x3), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n22_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n23_), .c(new_n18_), .O(new_n81_));
  nand4  g64(.a(x6), .b(x3), .c(x1), .d(new_n22_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(x2), .O(new_n84_));
  xor2a  g67(.a(x6), .b(x1), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n19_), .c(new_n22_), .O(new_n86_));
  nand4  g69(.a(new_n23_), .b(new_n79_), .c(new_n57_), .d(x1), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(z4));
  nand2  g71(.a(x3), .b(new_n57_), .O(new_n89_));
  nand2  g72(.a(new_n79_), .b(x2), .O(new_n90_));
  ...
  nand2  g76(.a(new_n19_), .b(new_n23_), .O(new_n94_));
  oai21  g77(.a(new_n94_), .b(new_n93_), .c(x0), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n92_), .O(z5));
  nand2  g79(.a(new_n89_), .b(x1), .O(new_n97_));
  nand3  g80(.a(x3), .b(new_n57_), .c(new_n18_), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(new_n97_), .c(new_n29_), .O(z6));
  nand3  g82(.a(new_n90_), .b(new_n89_), .c(new_n46_), .O(z7));
  nor2   g83(.a(new_n29_), .b(x3), .O(z8));
  aoi21  g84(.a(x5), .b(x4), .c(x6), .O(new_n102_));
  nand2  g85(.a(new_n24_), .b(new_n23_), .O(new_n103_));
