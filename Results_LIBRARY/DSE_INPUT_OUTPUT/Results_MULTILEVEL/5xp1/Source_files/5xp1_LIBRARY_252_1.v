...
module FAU ( 
  ...
  aoi21  g067(.a(new_n78_), .b(new_n61_), .c(new_n84_), .O(new_n85_));
  nand3  g068(.a(new_n78_), .b(new_n35_), .c(new_n61_), .O(new_n86_));
  nand2  g069(.a(x6), .b(x2), .O(new_n87_));
  nand2  g070(.a(new_n87_), .b(new_n61_), .O(new_n88_));
  ...
  nand3  g078(.a(new_n20_), .b(x2), .c(new_n61_), .O(new_n96_));
  oai21  g079(.a(new_n46_), .b(new_n61_), .c(new_n96_), .O(new_n97_));
  nand2  g080(.a(new_n97_), .b(x0), .O(new_n98_));
  nand2  g081(.a(new_n39_), .b(new_n21_), .O(new_n99_));
  nand2  g082(.a(new_n18_), .b(new_n35_), .O(new_n100_));
