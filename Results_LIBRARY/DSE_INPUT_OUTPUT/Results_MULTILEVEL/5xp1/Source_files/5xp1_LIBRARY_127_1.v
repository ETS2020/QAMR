...
module FAU ( 
  ...
  oai21  g77(.a(new_n94_), .b(new_n18_), .c(new_n19_), .O(new_n95_));
  ...
  nand4  g83(.a(new_n29_), .b(x3), .c(new_n18_), .d(x1), .O(new_n101_));
  aoi21  g84(.a(new_n101_), .b(new_n100_), .c(x0), .O(new_n102_));
  aoi21  g85(.a(x3), .b(x1), .c(x6), .O(new_n103_));
  ...
  aoi21  g89(.a(x3), .b(new_n43_), .c(x6), .O(new_n107_));
  nand3  g90(.a(new_n29_), .b(x3), .c(new_n18_), .O(new_n108_));
  nand2  g91(.a(new_n108_), .b(x1), .O(new_n109_));
  oai21  g92(.a(new_n107_), .b(x2), .c(new_n109_), .O(z6));
  oai21  g93(.a(new_n94_), .b(x2), .c(new_n100_), .O(z7));
  oai21  g94(.a(new_n29_), .b(x2), .c(x3), .O(z8));
  oai22  g95(.a(new_n103_), .b(new_n18_), .c(x6), .d(new_n19_), .O(new_n113_));
