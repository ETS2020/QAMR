...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n101_, new_n104_, new_n106_, new_n107_, new_n108_;
  ...
  aoi21  g79(.a(new_n40_), .b(x1), .c(new_n49_), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(new_n96_), .c(x0), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n95_), .c(new_n33_), .O(z5));
  nand2  g82(.a(new_n92_), .b(x1), .O(new_n100_));
  nand3  g83(.a(x3), .b(new_n40_), .c(new_n23_), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n100_), .c(new_n33_), .O(z6));
  nor2   g85(.a(new_n19_), .b(x3), .O(z8));
  nand2  g86(.a(z8), .b(x2), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n92_), .O(z7));
  aoi21  g88(.a(x2), .b(x1), .c(x0), .O(new_n106_));
  oai21  g89(.a(new_n106_), .b(new_n49_), .c(new_n19_), .O(new_n107_));
