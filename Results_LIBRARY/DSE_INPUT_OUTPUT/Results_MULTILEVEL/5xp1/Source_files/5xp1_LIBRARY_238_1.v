...
module FAU ( 
  ...
  nand2  g34(.a(new_n51_), .b(new_n43_), .O(new_n52_));
  ...
  aoi21  g38(.a(new_n55_), .b(new_n52_), .c(new_n22_), .O(new_n56_));
  ...
  oai21  g44(.a(new_n61_), .b(new_n56_), .c(new_n29_), .O(new_n62_));
  nand3  g45(.a(new_n26_), .b(new_n22_), .c(new_n19_), .O(new_n63_));
  nand2  g46(.a(new_n26_), .b(new_n19_), .O(new_n64_));
  ...
  nand3  g58(.a(new_n75_), .b(x5), .c(new_n19_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n74_), .c(new_n70_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n29_), .O(new_n78_));
  nand3  g61(.a(new_n20_), .b(x3), .c(new_n19_), .O(new_n79_));
  aoi22  g62(.a(new_n79_), .b(new_n51_), .c(new_n29_), .d(new_n43_), .O(new_n80_));
  nand3  g63(.a(x5), .b(new_n35_), .c(new_n43_), .O(new_n81_));
  nand3  g64(.a(x6), .b(new_n20_), .c(x1), .O(new_n82_));
  ...
  nand3  g68(.a(new_n29_), .b(x2), .c(new_n43_), .O(new_n86_));
  oai21  g69(.a(new_n29_), .b(new_n43_), .c(new_n86_), .O(new_n87_));
  oai21  g70(.a(x3), .b(x0), .c(new_n87_), .O(new_n88_));
  nor3   g71(.a(x3), .b(x1), .c(x0), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n18_), .c(x6), .O(new_n90_));
  aoi21  g73(.a(new_n29_), .b(new_n35_), .c(new_n18_), .O(new_n91_));
  oai22  g74(.a(new_n91_), .b(x0), .c(x3), .d(x2), .O(new_n92_));
  ...
  inv1   g81(.a(new_n75_), .O(new_n99_));
  ...
  aoi21  g86(.a(new_n29_), .b(new_n35_), .c(x2), .O(new_n104_));
  nand4  g87(.a(new_n29_), .b(x3), .c(new_n18_), .d(new_n43_), .O(new_n105_));
  oai21  g88(.a(new_n104_), .b(new_n43_), .c(new_n105_), .O(z6));
  or2    g89(.a(new_n104_), .b(new_n97_), .O(z7));
  aoi21  g90(.a(x6), .b(new_n18_), .c(x3), .O(z8));
  aoi21  g91(.a(x5), .b(x4), .c(new_n18_), .O(new_n109_));
  nand2  g92(.a(new_n30_), .b(new_n19_), .O(new_n110_));
  nand3  g93(.a(new_n110_), .b(x5), .c(x4), .O(new_n111_));
  oai21  g94(.a(new_n109_), .b(new_n29_), .c(new_n111_), .O(z9));
endmodule
