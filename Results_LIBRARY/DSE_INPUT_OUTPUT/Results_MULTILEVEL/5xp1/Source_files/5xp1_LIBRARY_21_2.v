...
module FAU ( 
  ...
  nand3  g17(.a(x5), .b(x4), .c(x2), .O(new_n35_));
  inv1   g18(.a(x6), .O(new_n36_));
  nand4  g19(.a(new_n36_), .b(new_n18_), .c(x1), .d(x0), .O(new_n37_));
  ...
  nand3  g45(.a(new_n62_), .b(new_n46_), .c(new_n39_), .O(z2));
  inv1   g46(.a(new_n21_), .O(new_n64_));
  nor2   g47(.a(new_n64_), .b(new_n43_), .O(new_n65_));
  ...
  aoi22  g65(.a(new_n82_), .b(new_n43_), .c(new_n80_), .d(x6), .O(new_n83_));
  nor2   g66(.a(x3), .b(x0), .O(new_n84_));
  nor2   g67(.a(new_n84_), .b(x6), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n43_), .c(x2), .O(new_n86_));
  oai21  g69(.a(new_n84_), .b(new_n30_), .c(x6), .O(new_n87_));
  ...
  oai21  g78(.a(new_n95_), .b(new_n64_), .c(x0), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n94_), .c(new_n75_), .O(z5));
  inv1   g80(.a(new_n75_), .O(new_n98_));
  nand2  g81(.a(new_n91_), .b(x1), .O(new_n99_));
  nand3  g82(.a(x3), .b(new_n30_), .c(new_n20_), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(new_n99_), .c(new_n98_), .O(z6));
  nand3  g84(.a(new_n92_), .b(new_n91_), .c(new_n98_), .O(z7));
  nor2   g85(.a(new_n75_), .b(x3), .O(z8));
