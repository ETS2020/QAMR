...
module FAU ( 
  ...
  aoi21  g68(.a(new_n85_), .b(new_n20_), .c(new_n19_), .O(new_n86_));
  ...
  nor3   g73(.a(new_n90_), .b(x6), .c(new_n55_), .O(new_n91_));
  nor2   g74(.a(new_n90_), .b(new_n55_), .O(new_n92_));
  nor2   g75(.a(new_n92_), .b(new_n19_), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n91_), .c(new_n41_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n89_), .c(new_n46_), .O(z4));
  nand2  g78(.a(x3), .b(new_n55_), .O(new_n96_));
  nand2  g79(.a(new_n57_), .b(x2), .O(new_n97_));
  oai21  g80(.a(new_n96_), .b(new_n41_), .c(new_n97_), .O(new_n98_));
  ...
  nand3  g84(.a(new_n101_), .b(new_n99_), .c(new_n46_), .O(z5));
  nand2  g85(.a(new_n96_), .b(x1), .O(new_n103_));
  nand3  g86(.a(x3), .b(new_n55_), .c(new_n41_), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n103_), .c(new_n46_), .O(z6));
  aoi21  g88(.a(new_n97_), .b(new_n96_), .c(new_n29_), .O(z7));
  nand2  g89(.a(new_n46_), .b(x3), .O(z8));
