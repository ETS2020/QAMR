...
module FAU ( 
  ...
  aoi21  g80(.a(new_n97_), .b(new_n95_), .c(new_n55_), .O(z5));
  nand2  g81(.a(new_n92_), .b(x1), .O(new_n99_));
  nand3  g82(.a(x3), .b(new_n24_), .c(new_n28_), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(new_n99_), .c(new_n56_), .O(z6));
  aoi21  g84(.a(new_n93_), .b(new_n92_), .c(new_n55_), .O(z7));
  nor2   g85(.a(new_n55_), .b(x3), .O(z8));
