...
module FAU ( 
  ...
  oai21  g26(.a(x5), .b(x2), .c(x6), .O(new_n44_));
  nor2   g27(.a(new_n44_), .b(new_n18_), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n43_), .c(x0), .O(new_n46_));
  nand4  g29(.a(x6), .b(new_n18_), .c(new_n20_), .d(new_n19_), .O(new_n47_));
  nand3  g30(.a(new_n37_), .b(x4), .c(new_n30_), .O(new_n48_));
  ...
  nand4  g40(.a(new_n36_), .b(new_n57_), .c(new_n56_), .d(x4), .O(new_n58_));
  inv1   g41(.a(new_n58_), .O(new_n59_));
  aoi21  g42(.a(new_n55_), .b(x6), .c(new_n59_), .O(new_n60_));
  nand4  g43(.a(new_n60_), .b(new_n50_), .c(new_n46_), .d(new_n40_), .O(z2));
  inv1   g44(.a(new_n21_), .O(new_n62_));
  nor2   g45(.a(new_n62_), .b(new_n56_), .O(new_n63_));
  oai21  g46(.a(new_n62_), .b(x6), .c(x1), .O(new_n64_));
  nand3  g47(.a(x6), .b(x3), .c(x2), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  aoi22  g49(.a(new_n66_), .b(new_n56_), .c(new_n63_), .d(new_n20_), .O(new_n67_));
  nand2  g50(.a(new_n44_), .b(new_n20_), .O(new_n68_));
  nand3  g51(.a(new_n57_), .b(new_n31_), .c(new_n30_), .O(new_n69_));
  ...
  nand2  g57(.a(new_n31_), .b(new_n30_), .O(new_n75_));
  ...
  nor3   g64(.a(new_n81_), .b(x6), .c(new_n30_), .O(new_n82_));
  ...
  nand2  g70(.a(new_n31_), .b(x2), .O(new_n88_));
  ...
  nand3  g75(.a(new_n92_), .b(new_n90_), .c(new_n74_), .O(z5));
  nand2  g76(.a(new_n87_), .b(x1), .O(new_n94_));
  nand3  g77(.a(x3), .b(new_n30_), .c(new_n20_), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n94_), .c(new_n71_), .O(z6));
  aoi21  g79(.a(new_n88_), .b(new_n87_), .c(new_n71_), .O(z7));
