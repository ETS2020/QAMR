...
module FAU ( 
  ...
  nand2  g67(.a(new_n40_), .b(new_n19_), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(x3), .c(x6), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n84_), .c(x1), .O(new_n87_));
  aoi21  g70(.a(new_n20_), .b(x3), .c(x2), .O(new_n88_));
  oai22  g71(.a(x6), .b(new_n40_), .c(x3), .d(x0), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n88_), .c(new_n43_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n87_), .O(z4));
  nand2  g74(.a(x3), .b(new_n40_), .O(new_n92_));
  nor2   g75(.a(new_n20_), .b(x3), .O(z8));
  ...
  aoi21  g79(.a(new_n40_), .b(x1), .c(new_n18_), .O(new_n97_));
  nand2  g80(.a(z8), .b(new_n40_), .O(new_n98_));
  inv1   g81(.a(new_n98_), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(new_n97_), .c(x0), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n96_), .O(z5));
  oai21  g84(.a(new_n20_), .b(x3), .c(new_n82_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(x1), .O(new_n103_));
  oai21  g86(.a(new_n92_), .b(x1), .c(new_n103_), .O(z6));
  nand2  g87(.a(new_n94_), .b(new_n92_), .O(z7));
  aoi21  g88(.a(x2), .b(x1), .c(x0), .O(new_n106_));
  oai21  g89(.a(new_n106_), .b(new_n18_), .c(new_n20_), .O(new_n107_));
  nand3  g90(.a(new_n107_), .b(x5), .c(x4), .O(new_n108_));
  nand2  g91(.a(new_n108_), .b(new_n31_), .O(z9));
endmodule
