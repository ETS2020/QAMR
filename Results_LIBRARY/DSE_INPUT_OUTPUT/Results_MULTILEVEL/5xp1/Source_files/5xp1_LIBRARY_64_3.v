...
module FAU ( 
  ...
  nor2   g68(.a(new_n20_), .b(new_n32_), .O(new_n86_));
  nand2  g69(.a(x3), .b(new_n24_), .O(new_n87_));
  nand2  g70(.a(new_n56_), .b(x2), .O(new_n88_));
  oai21  g71(.a(new_n87_), .b(new_n28_), .c(new_n88_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n19_), .O(new_n90_));
  inv1   g73(.a(new_n65_), .O(new_n91_));
  aoi21  g74(.a(x3), .b(x1), .c(x2), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n91_), .c(x0), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(new_n90_), .c(new_n86_), .O(z5));
  nand2  g77(.a(new_n87_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n24_), .c(new_n28_), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n95_), .c(new_n86_), .O(z6));
  aoi21  g80(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(z7));
  nor2   g81(.a(new_n86_), .b(x3), .O(z8));
  nand2  g82(.a(new_n59_), .b(x4), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(new_n20_), .c(new_n32_), .O(z9));
endmodule
