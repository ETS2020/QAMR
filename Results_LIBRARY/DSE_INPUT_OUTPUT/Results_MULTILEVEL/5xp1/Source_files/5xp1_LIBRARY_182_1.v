...
module FAU ( 
  ...
  aoi21  g036(.a(new_n52_), .b(new_n32_), .c(new_n53_), .O(new_n54_));
  nand2  g037(.a(new_n54_), .b(new_n44_), .O(z1));
  aoi21  g038(.a(x5), .b(x0), .c(x1), .O(new_n56_));
  aoi21  g039(.a(x5), .b(x2), .c(x0), .O(new_n57_));
  oai21  g040(.a(new_n57_), .b(new_n56_), .c(x4), .O(new_n58_));
  nor2   g041(.a(new_n32_), .b(new_n23_), .O(new_n59_));
  oai21  g042(.a(x3), .b(x2), .c(x0), .O(new_n60_));
  nand3  g043(.a(x5), .b(x3), .c(x2), .O(new_n61_));
  aoi21  g044(.a(new_n61_), .b(new_n60_), .c(new_n47_), .O(new_n62_));
  oai21  g045(.a(new_n62_), .b(new_n59_), .c(new_n26_), .O(new_n63_));
  nand2  g046(.a(new_n63_), .b(new_n58_), .O(new_n64_));
  nand2  g047(.a(new_n64_), .b(new_n19_), .O(new_n65_));
  oai21  g048(.a(new_n27_), .b(new_n32_), .c(new_n23_), .O(new_n66_));
  ...
  nor2   g053(.a(new_n70_), .b(new_n27_), .O(new_n71_));
  oai21  g054(.a(new_n71_), .b(new_n59_), .c(x4), .O(new_n72_));
  ...
  nand3  g059(.a(new_n76_), .b(new_n74_), .c(new_n65_), .O(z2));
  nand2  g060(.a(new_n18_), .b(new_n35_), .O(new_n78_));
  ...
  nand3  g076(.a(new_n93_), .b(new_n91_), .c(new_n47_), .O(new_n94_));
  nand4  g077(.a(new_n19_), .b(x5), .c(new_n35_), .d(new_n23_), .O(new_n95_));
  ...
  nand3  g082(.a(new_n19_), .b(x2), .c(new_n47_), .O(new_n100_));
  ...
  nand3  g091(.a(new_n108_), .b(x3), .c(new_n47_), .O(new_n109_));
  nand3  g092(.a(new_n109_), .b(new_n107_), .c(new_n102_), .O(z4));
  nand3  g093(.a(new_n35_), .b(x1), .c(new_n23_), .O(new_n111_));
  oai21  g094(.a(new_n35_), .b(new_n23_), .c(new_n111_), .O(new_n112_));
  nand2  g095(.a(new_n112_), .b(x3), .O(new_n113_));
  aoi21  g096(.a(new_n19_), .b(new_n35_), .c(x0), .O(new_n114_));
  nor2   g097(.a(x2), .b(new_n23_), .O(new_n115_));
  oai21  g098(.a(new_n115_), .b(new_n114_), .c(new_n18_), .O(new_n116_));
  inv1   g099(.a(new_n91_), .O(new_n117_));
  oai21  g100(.a(new_n117_), .b(new_n27_), .c(x0), .O(new_n118_));
  nand3  g101(.a(new_n118_), .b(new_n116_), .c(new_n113_), .O(z5));
  inv1   g102(.a(new_n80_), .O(new_n120_));
  nor2   g103(.a(x6), .b(x3), .O(z8));
  oai21  g104(.a(z8), .b(new_n120_), .c(x1), .O(new_n122_));
  nand3  g105(.a(x3), .b(new_n35_), .c(new_n47_), .O(new_n123_));
  nand2  g106(.a(new_n123_), .b(new_n122_), .O(z6));
  nand2  g107(.a(new_n18_), .b(x2), .O(new_n125_));
  oai21  g108(.a(z8), .b(x2), .c(new_n125_), .O(z7));
  nand2  g109(.a(new_n20_), .b(x3), .O(new_n127_));
  nand2  g110(.a(new_n127_), .b(x6), .O(new_n128_));
  oai21  g111(.a(new_n80_), .b(new_n47_), .c(new_n23_), .O(new_n129_));
