...
module FAU ( 
  ...
  oai21  g19(.a(new_n25_), .b(x0), .c(new_n36_), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(x4), .O(new_n38_));
  nand2  g21(.a(new_n30_), .b(x6), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(x5), .c(new_n28_), .O(new_n40_));
  nor2   g23(.a(new_n21_), .b(x5), .O(new_n41_));
  inv1   g24(.a(new_n41_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n40_), .c(new_n38_), .O(z1));
  ...
  nand3  g32(.a(new_n24_), .b(x4), .c(new_n20_), .O(new_n50_));
  inv1   g33(.a(new_n50_), .O(new_n51_));
  oai21  g34(.a(new_n51_), .b(new_n49_), .c(new_n21_), .O(new_n52_));
  nand3  g35(.a(new_n18_), .b(x4), .c(new_n34_), .O(new_n53_));
  nand4  g36(.a(x6), .b(new_n28_), .c(new_n29_), .d(new_n20_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n33_), .O(new_n56_));
  nand2  g39(.a(new_n18_), .b(x4), .O(new_n57_));
  nand4  g40(.a(x6), .b(new_n28_), .c(new_n34_), .d(new_n29_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n20_), .O(new_n60_));
  oai21  g43(.a(new_n28_), .b(x1), .c(new_n21_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n18_), .O(new_n62_));
  nand3  g45(.a(new_n30_), .b(x6), .c(x4), .O(new_n63_));
  ...
  nand4  g49(.a(new_n21_), .b(new_n18_), .c(x3), .d(new_n20_), .O(new_n67_));
  aoi21  g50(.a(new_n67_), .b(new_n48_), .c(new_n33_), .O(new_n68_));
  oai21  g51(.a(x6), .b(x3), .c(x5), .O(new_n69_));
  nor2   g52(.a(new_n69_), .b(new_n20_), .O(new_n70_));
  oai21  g53(.a(new_n70_), .b(new_n68_), .c(x1), .O(new_n71_));
  nand2  g54(.a(new_n35_), .b(x1), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(new_n18_), .c(x0), .O(new_n73_));
  nand3  g56(.a(new_n24_), .b(x5), .c(new_n20_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g58(.a(x6), .b(x2), .c(x0), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n30_), .c(new_n18_), .O(new_n77_));
  aoi21  g60(.a(new_n75_), .b(new_n21_), .c(new_n77_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n71_), .O(z3));
  nand2  g62(.a(new_n44_), .b(new_n22_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(x6), .c(x5), .O(new_n81_));
  nor2   g64(.a(x3), .b(x2), .O(new_n82_));
  aoi21  g65(.a(new_n22_), .b(new_n20_), .c(new_n82_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(x6), .c(new_n81_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(x1), .O(new_n85_));
  nand2  g68(.a(new_n34_), .b(new_n20_), .O(new_n86_));
  ...
  oai21  g80(.a(new_n97_), .b(new_n23_), .c(x0), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(new_n96_), .c(new_n41_), .O(z5));
  nand2  g82(.a(new_n93_), .b(x1), .O(new_n100_));
  nand3  g83(.a(x3), .b(new_n33_), .c(new_n29_), .O(new_n101_));
  aoi21  g84(.a(new_n101_), .b(new_n100_), .c(new_n41_), .O(z6));
  nand3  g85(.a(new_n94_), .b(new_n93_), .c(new_n42_), .O(z7));
  nor2   g86(.a(new_n41_), .b(x3), .O(z8));
  aoi21  g87(.a(new_n24_), .b(new_n20_), .c(new_n18_), .O(new_n105_));
  oai21  g88(.a(new_n105_), .b(x6), .c(x4), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n42_), .O(z9));
endmodule
