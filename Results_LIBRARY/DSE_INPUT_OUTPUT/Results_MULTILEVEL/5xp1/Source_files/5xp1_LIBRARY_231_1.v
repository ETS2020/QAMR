...
module FAU ( 
  ...
  aoi21  g80(.a(new_n97_), .b(new_n96_), .c(new_n85_), .O(z6));
  aoi21  g81(.a(new_n89_), .b(new_n88_), .c(new_n85_), .O(z7));
  nor2   g82(.a(new_n85_), .b(x3), .O(z8));
  aoi21  g83(.a(new_n21_), .b(new_n19_), .c(new_n18_), .O(new_n101_));
  oai21  g84(.a(new_n101_), .b(x6), .c(x5), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n86_), .O(z9));
endmodule
