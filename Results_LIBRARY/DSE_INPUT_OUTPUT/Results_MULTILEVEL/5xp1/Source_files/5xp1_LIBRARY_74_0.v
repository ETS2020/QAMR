...
module FAU ( 
  ...
  nand4  g47(.a(x6), .b(new_n29_), .c(x2), .d(new_n18_), .O(new_n65_));
  ...
  oai21  g53(.a(new_n19_), .b(new_n23_), .c(new_n24_), .O(new_n71_));
  nand2  g54(.a(new_n19_), .b(new_n23_), .O(new_n72_));
  aoi21  g55(.a(new_n72_), .b(new_n71_), .c(x0), .O(new_n73_));
  oai21  g56(.a(new_n73_), .b(new_n70_), .c(x5), .O(new_n74_));
  nand3  g57(.a(new_n57_), .b(new_n23_), .c(x0), .O(new_n75_));
  oai21  g58(.a(new_n23_), .b(x0), .c(new_n75_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(x6), .c(new_n29_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n74_), .c(new_n67_), .O(z3));
  nand2  g61(.a(new_n43_), .b(new_n57_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(x0), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(new_n24_), .c(new_n19_), .O(new_n81_));
  nand2  g64(.a(new_n24_), .b(new_n18_), .O(new_n82_));
  ...
  nor3   g68(.a(new_n85_), .b(x6), .c(new_n57_), .O(new_n86_));
  nor2   g69(.a(new_n85_), .b(new_n57_), .O(new_n87_));
  nor2   g70(.a(new_n87_), .b(new_n19_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n86_), .c(new_n23_), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n84_), .c(new_n63_), .O(z4));
  nand2  g73(.a(x3), .b(new_n57_), .O(new_n91_));
  nand2  g74(.a(new_n43_), .b(x2), .O(new_n92_));
  ...
  nand3  g79(.a(new_n96_), .b(new_n94_), .c(new_n63_), .O(z5));
  nand2  g80(.a(new_n91_), .b(x1), .O(new_n98_));
  nand3  g81(.a(x3), .b(new_n57_), .c(new_n23_), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(new_n98_), .c(new_n63_), .O(z6));
  nand3  g83(.a(new_n92_), .b(new_n91_), .c(new_n63_), .O(z7));
  nand2  g84(.a(new_n63_), .b(x3), .O(z8));
  nand3  g85(.a(new_n53_), .b(x5), .c(x4), .O(new_n103_));
