...
module FAU ( 
  ...
  nand2  g51(.a(new_n23_), .b(new_n22_), .O(new_n69_));
  aoi21  g52(.a(new_n69_), .b(x6), .c(new_n18_), .O(new_n70_));
  aoi21  g53(.a(new_n68_), .b(new_n18_), .c(new_n70_), .O(new_n71_));
  nand3  g54(.a(new_n20_), .b(new_n47_), .c(new_n31_), .O(new_n72_));
  aoi21  g55(.a(new_n72_), .b(new_n18_), .c(new_n22_), .O(new_n73_));
  aoi21  g56(.a(new_n18_), .b(new_n31_), .c(new_n20_), .O(new_n74_));
  oai22  g57(.a(new_n74_), .b(x1), .c(new_n18_), .d(new_n31_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n73_), .c(x0), .O(new_n76_));
  oai21  g59(.a(new_n71_), .b(x0), .c(new_n76_), .O(z3));
  nor2   g60(.a(x3), .b(x2), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(x5), .c(x0), .O(new_n79_));
  ...
  nand2  g67(.a(x5), .b(new_n31_), .O(new_n85_));
  nand2  g68(.a(new_n20_), .b(x2), .O(new_n86_));
  aoi21  g69(.a(new_n86_), .b(new_n85_), .c(new_n21_), .O(new_n87_));
  aoi21  g70(.a(new_n47_), .b(new_n21_), .c(new_n31_), .O(new_n88_));
  ...
  nand2  g78(.a(x3), .b(new_n31_), .O(new_n96_));
  ...
  nand3  g86(.a(x3), .b(new_n31_), .c(new_n22_), .O(new_n104_));
  aoi21  g87(.a(new_n104_), .b(new_n103_), .c(new_n92_), .O(z6));
