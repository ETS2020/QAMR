...
module FAU ( 
  ...
  nand3  g17(.a(new_n34_), .b(new_n33_), .c(new_n30_), .O(z1));
  oai21  g18(.a(x5), .b(x0), .c(x1), .O(new_n36_));
  ...
  and2   g22(.a(new_n39_), .b(x4), .O(new_n40_));
  nand2  g23(.a(new_n25_), .b(new_n20_), .O(new_n41_));
  nor2   g24(.a(x5), .b(x2), .O(new_n42_));
  aoi21  g25(.a(x3), .b(x2), .c(x0), .O(new_n43_));
  oai21  g26(.a(new_n43_), .b(new_n42_), .c(new_n21_), .O(new_n44_));
  aoi21  g27(.a(new_n44_), .b(new_n41_), .c(x4), .O(new_n45_));
  ...
  oai21  g39(.a(x4), .b(new_n21_), .c(new_n18_), .O(new_n57_));
  ...
  oai21  g43(.a(x4), .b(new_n48_), .c(new_n18_), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(x1), .c(x0), .O(new_n62_));
  inv1   g45(.a(new_n62_), .O(new_n63_));
  nor2   g46(.a(new_n18_), .b(x1), .O(new_n64_));
  ...
  oai21  g51(.a(new_n68_), .b(new_n63_), .c(x5), .O(new_n69_));
  nand2  g52(.a(new_n18_), .b(new_n19_), .O(new_n70_));
  nand2  g53(.a(x6), .b(new_n47_), .O(new_n71_));
  aoi21  g54(.a(new_n71_), .b(new_n70_), .c(x1), .O(new_n72_));
  nand3  g55(.a(new_n65_), .b(new_n48_), .c(new_n47_), .O(new_n73_));
  inv1   g56(.a(new_n73_), .O(new_n74_));
  oai21  g57(.a(new_n74_), .b(new_n72_), .c(x0), .O(new_n75_));
  nand3  g58(.a(x6), .b(x1), .c(new_n20_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n25_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n69_), .c(new_n60_), .O(z3));
  aoi21  g62(.a(new_n50_), .b(new_n22_), .c(new_n18_), .O(new_n80_));
  inv1   g63(.a(new_n43_), .O(new_n81_));
  aoi21  g64(.a(new_n49_), .b(new_n81_), .c(x6), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n80_), .c(x1), .O(new_n83_));
  nor2   g66(.a(x3), .b(x0), .O(new_n84_));
  nor3   g67(.a(new_n84_), .b(x6), .c(new_n47_), .O(new_n85_));
  nor2   g68(.a(new_n84_), .b(new_n47_), .O(new_n86_));
  nor2   g69(.a(new_n86_), .b(new_n18_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n85_), .c(new_n21_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n83_), .c(new_n34_), .O(z4));
  nand2  g72(.a(x3), .b(new_n47_), .O(new_n90_));
  nand2  g73(.a(new_n48_), .b(x2), .O(new_n91_));
  ...
  nand3  g79(.a(new_n96_), .b(new_n93_), .c(new_n34_), .O(z5));
  nand2  g80(.a(new_n90_), .b(x1), .O(new_n98_));
  nand3  g81(.a(x3), .b(new_n47_), .c(new_n21_), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(new_n98_), .c(new_n34_), .O(z6));
  nand3  g83(.a(new_n91_), .b(new_n90_), .c(new_n34_), .O(z7));
