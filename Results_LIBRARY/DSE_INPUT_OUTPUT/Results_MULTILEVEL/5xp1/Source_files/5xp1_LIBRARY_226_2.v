...
module FAU ( 
  ...
  nor2   g24(.a(x6), .b(new_n30_), .O(new_n42_));
  ...
  nand3  g44(.a(new_n61_), .b(new_n56_), .c(new_n30_), .O(new_n62_));
  ...
  oai21  g53(.a(new_n56_), .b(new_n25_), .c(new_n24_), .O(new_n71_));
  ...
  oai21  g59(.a(new_n76_), .b(new_n73_), .c(new_n30_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n70_), .O(z3));
  nand2  g61(.a(x6), .b(x3), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n30_), .c(new_n24_), .O(new_n80_));
  oai21  g63(.a(new_n65_), .b(new_n24_), .c(new_n56_), .O(new_n81_));
  ...
  nand3  g70(.a(x6), .b(new_n65_), .c(x2), .O(new_n88_));
  oai21  g71(.a(new_n87_), .b(new_n25_), .c(new_n88_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n24_), .O(new_n90_));
  aoi21  g73(.a(x3), .b(x1), .c(x2), .O(new_n91_));
  inv1   g74(.a(new_n79_), .O(new_n92_));
  ...
  nor2   g80(.a(new_n56_), .b(new_n30_), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n97_), .c(x1), .O(new_n99_));
  oai21  g82(.a(new_n87_), .b(x1), .c(new_n99_), .O(z6));
  oai21  g83(.a(new_n92_), .b(new_n30_), .c(new_n87_), .O(z7));
  nor2   g84(.a(new_n42_), .b(x3), .O(z8));
  oai21  g85(.a(x2), .b(new_n24_), .c(new_n56_), .O(new_n103_));
