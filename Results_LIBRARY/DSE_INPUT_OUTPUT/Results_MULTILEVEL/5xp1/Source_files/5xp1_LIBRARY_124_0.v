...
module FAU ( 
  ...
  oai21  g34(.a(new_n51_), .b(new_n20_), .c(z8), .O(new_n52_));
  ...
  oai21  g55(.a(new_n20_), .b(z8), .c(new_n34_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(x2), .O(new_n74_));
  oai21  g57(.a(x6), .b(z8), .c(x1), .O(new_n75_));
  ...
  aoi21  g69(.a(new_n86_), .b(new_n85_), .c(new_n20_), .O(new_n87_));
  nand2  g70(.a(new_n68_), .b(new_n19_), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(x3), .c(x6), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n87_), .c(x1), .O(new_n90_));
  aoi21  g73(.a(new_n20_), .b(x3), .c(x2), .O(new_n91_));
  oai22  g74(.a(x6), .b(new_n68_), .c(x3), .d(x0), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n91_), .c(new_n34_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n90_), .O(z4));
  nand2  g77(.a(x3), .b(new_n68_), .O(new_n95_));
  ...
  aoi21  g82(.a(new_n68_), .b(x1), .c(z8), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(new_n99_), .c(x0), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n98_), .c(new_n31_), .O(z5));
  nand2  g85(.a(new_n95_), .b(x1), .O(new_n103_));
  nand3  g86(.a(x3), .b(new_n68_), .c(new_n34_), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n103_), .c(new_n31_), .O(z6));
  nand3  g88(.a(x6), .b(z8), .c(x2), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n95_), .O(z7));
  nand3  g90(.a(new_n21_), .b(new_n20_), .c(new_n19_), .O(new_n108_));
  nand3  g91(.a(new_n108_), .b(x5), .c(x4), .O(new_n109_));
  nand2  g92(.a(new_n109_), .b(new_n31_), .O(z9));
endmodule
