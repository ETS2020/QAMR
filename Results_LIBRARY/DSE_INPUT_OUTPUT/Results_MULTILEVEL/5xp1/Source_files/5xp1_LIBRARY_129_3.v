...
module FAU ( 
  ...
  aoi21  g68(.a(new_n34_), .b(new_n21_), .c(new_n38_), .O(new_n86_));
  ...
  nand3  g72(.a(new_n87_), .b(x6), .c(new_n38_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n89_), .O(z4));
  nand3  g74(.a(new_n30_), .b(new_n33_), .c(x2), .O(new_n92_));
  nand3  g75(.a(new_n77_), .b(new_n32_), .c(x1), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n19_), .O(new_n95_));
  nand2  g78(.a(new_n33_), .b(x2), .O(new_n96_));
  nand2  g79(.a(new_n34_), .b(new_n20_), .O(new_n97_));
  aoi22  g80(.a(new_n97_), .b(new_n23_), .c(new_n96_), .d(new_n38_), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n19_), .c(new_n95_), .O(z5));
  nand2  g82(.a(new_n77_), .b(new_n32_), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(x1), .O(new_n101_));
  nand2  g84(.a(x3), .b(new_n32_), .O(new_n102_));
  oai21  g85(.a(new_n102_), .b(x1), .c(new_n101_), .O(z6));
  nand3  g86(.a(new_n102_), .b(new_n96_), .c(new_n30_), .O(z7));
