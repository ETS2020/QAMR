...
module FAU ( 
  ...
  aoi21  g30(.a(new_n47_), .b(new_n46_), .c(new_n22_), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(new_n45_), .c(x1), .O(new_n49_));
  nand2  g32(.a(x5), .b(x0), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n19_), .c(new_n21_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n44_), .O(z2));
  nand2  g36(.a(new_n19_), .b(new_n23_), .O(new_n54_));
  nand3  g37(.a(new_n18_), .b(x3), .c(new_n22_), .O(new_n55_));
  ...
  nand3  g41(.a(x6), .b(new_n18_), .c(new_n22_), .O(new_n59_));
  oai21  g42(.a(new_n58_), .b(new_n22_), .c(new_n59_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(x1), .O(new_n61_));
  nor2   g44(.a(new_n19_), .b(new_n46_), .O(new_n62_));
  xnor2a g45(.a(x5), .b(x0), .O(new_n63_));
  nand3  g46(.a(x5), .b(new_n47_), .c(new_n22_), .O(new_n64_));
  ...
  nand4  g50(.a(new_n18_), .b(new_n47_), .c(new_n46_), .d(x0), .O(new_n68_));
  ...
  aoi21  g56(.a(new_n73_), .b(new_n24_), .c(new_n19_), .O(new_n74_));
  ...
  nor2   g63(.a(new_n80_), .b(new_n19_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n79_), .c(new_n23_), .O(new_n82_));
  nor2   g65(.a(x6), .b(new_n21_), .O(new_n83_));
  ...
  oai21  g70(.a(new_n86_), .b(new_n23_), .c(new_n87_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n22_), .O(new_n89_));
  inv1   g72(.a(new_n24_), .O(new_n90_));
  ...
  nand3  g77(.a(x3), .b(new_n46_), .c(new_n23_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n94_), .c(new_n84_), .O(z6));
