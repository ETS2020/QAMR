...
module FAU ( 
  ...
  nand2  g46(.a(new_n24_), .b(new_n31_), .O(new_n64_));
  ...
  oai21  g56(.a(new_n24_), .b(new_n32_), .c(new_n31_), .O(new_n74_));
  inv1   g57(.a(x3), .O(new_n75_));
  nand3  g58(.a(new_n24_), .b(new_n75_), .c(new_n32_), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n74_), .c(new_n18_), .O(new_n77_));
  nor2   g60(.a(new_n70_), .b(x0), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n77_), .c(new_n28_), .O(new_n79_));
  nand4  g62(.a(new_n79_), .b(new_n73_), .c(new_n67_), .d(new_n44_), .O(z3));
  aoi21  g63(.a(new_n52_), .b(new_n19_), .c(new_n24_), .O(new_n81_));
  aoi21  g64(.a(new_n75_), .b(new_n32_), .c(new_n58_), .O(new_n82_));
  nor2   g65(.a(new_n82_), .b(x6), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n81_), .c(x1), .O(new_n84_));
  nor2   g67(.a(x3), .b(x0), .O(new_n85_));
  nor3   g68(.a(new_n85_), .b(x6), .c(new_n32_), .O(new_n86_));
  nor2   g69(.a(new_n85_), .b(new_n32_), .O(new_n87_));
  nor2   g70(.a(new_n87_), .b(new_n24_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n86_), .c(new_n31_), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n84_), .c(new_n44_), .O(z4));
  nand2  g73(.a(x3), .b(new_n32_), .O(new_n91_));
  nand2  g74(.a(new_n75_), .b(x2), .O(new_n92_));
  oai21  g75(.a(new_n91_), .b(new_n31_), .c(new_n92_), .O(new_n93_));
  ...
  nand3  g79(.a(new_n96_), .b(new_n94_), .c(new_n44_), .O(z5));
  nand2  g80(.a(new_n91_), .b(x1), .O(new_n98_));
  nand3  g81(.a(x3), .b(new_n32_), .c(new_n31_), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(new_n98_), .c(new_n44_), .O(z6));
  aoi21  g83(.a(new_n92_), .b(new_n91_), .c(new_n43_), .O(z7));
  nand2  g84(.a(new_n44_), .b(x3), .O(z8));
  nand2  g85(.a(new_n21_), .b(new_n18_), .O(new_n103_));
  nand4  g86(.a(new_n103_), .b(new_n24_), .c(x5), .d(x4), .O(new_n104_));
