...
module FAU ( 
  ...
  nand4  g48(.a(x6), .b(new_n18_), .c(x2), .d(new_n21_), .O(new_n66_));
  ...
  oai21  g54(.a(new_n19_), .b(new_n25_), .c(new_n26_), .O(new_n72_));
  nand2  g55(.a(new_n19_), .b(new_n25_), .O(new_n73_));
  aoi21  g56(.a(new_n73_), .b(new_n72_), .c(x0), .O(new_n74_));
  oai21  g57(.a(new_n74_), .b(new_n71_), .c(x5), .O(new_n75_));
  nand3  g58(.a(new_n57_), .b(new_n25_), .c(x0), .O(new_n76_));
  oai21  g59(.a(new_n25_), .b(x0), .c(new_n76_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(x6), .c(new_n18_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n75_), .c(new_n68_), .O(z3));
  nand2  g62(.a(new_n43_), .b(new_n57_), .O(new_n80_));
  ...
  nor3   g69(.a(new_n86_), .b(x6), .c(new_n57_), .O(new_n87_));
  nor2   g70(.a(new_n86_), .b(new_n57_), .O(new_n88_));
  nor2   g71(.a(new_n88_), .b(new_n19_), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n87_), .c(new_n25_), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n85_), .c(new_n64_), .O(z4));
  nand2  g74(.a(x3), .b(new_n57_), .O(new_n92_));
  nand2  g75(.a(new_n43_), .b(x2), .O(new_n93_));
  ...
  oai21  g79(.a(new_n96_), .b(new_n35_), .c(x0), .O(new_n97_));
  nand3  g80(.a(new_n97_), .b(new_n95_), .c(new_n64_), .O(z5));
  nand2  g81(.a(new_n92_), .b(x1), .O(new_n99_));
  nand3  g82(.a(x3), .b(new_n57_), .c(new_n25_), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(new_n99_), .c(new_n64_), .O(z6));
  aoi21  g84(.a(new_n93_), .b(new_n92_), .c(new_n63_), .O(z7));
  nor2   g85(.a(new_n63_), .b(x3), .O(z8));
  nand3  g86(.a(new_n53_), .b(x5), .c(x4), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n64_), .O(z9));
endmodule
