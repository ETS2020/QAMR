...
module FAU ( 
  ...
  aoi22  g76(.a(new_n93_), .b(x4), .c(new_n91_), .d(x6), .O(new_n94_));
  nor2   g77(.a(x3), .b(x0), .O(new_n95_));
  nor2   g78(.a(new_n95_), .b(x6), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(x4), .c(x2), .O(new_n97_));
  oai21  g80(.a(new_n95_), .b(new_n40_), .c(x6), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n28_), .O(new_n100_));
  oai21  g83(.a(new_n94_), .b(new_n28_), .c(new_n100_), .O(z4));
  nand2  g84(.a(x3), .b(new_n40_), .O(new_n102_));
  nand2  g85(.a(new_n81_), .b(x2), .O(new_n103_));
  oai21  g86(.a(new_n102_), .b(new_n28_), .c(new_n103_), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n31_), .O(new_n105_));
  aoi21  g88(.a(x3), .b(x1), .c(x2), .O(new_n106_));
  oai21  g89(.a(new_n106_), .b(new_n46_), .c(x0), .O(new_n107_));
  nand2  g90(.a(new_n33_), .b(new_n27_), .O(new_n108_));
  nand3  g91(.a(new_n108_), .b(new_n107_), .c(new_n105_), .O(z5));
  nand2  g92(.a(new_n102_), .b(x1), .O(new_n110_));
  nand3  g93(.a(x3), .b(new_n40_), .c(new_n28_), .O(new_n111_));
  nand3  g94(.a(new_n111_), .b(new_n110_), .c(new_n108_), .O(z6));
  nand3  g95(.a(new_n108_), .b(new_n103_), .c(new_n102_), .O(z7));
  nand2  g96(.a(new_n108_), .b(x3), .O(z8));
