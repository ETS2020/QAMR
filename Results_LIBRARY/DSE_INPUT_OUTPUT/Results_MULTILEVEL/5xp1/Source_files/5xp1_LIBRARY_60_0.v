...
module FAU ( 
  ...
  nor2   g77(.a(x6), .b(x5), .O(new_n95_));
  nand2  g78(.a(x3), .b(new_n84_), .O(new_n96_));
  nand2  g79(.a(new_n85_), .b(x2), .O(new_n97_));
  ...
  oai21  g83(.a(new_n100_), .b(new_n36_), .c(x0), .O(new_n101_));
  aoi21  g84(.a(new_n101_), .b(new_n99_), .c(new_n95_), .O(z5));
  ...
  nand3  g89(.a(new_n97_), .b(new_n96_), .c(new_n103_), .O(z7));
