...
module FAU ( 
  ...
  nand3  g38(.a(new_n55_), .b(new_n19_), .c(new_n24_), .O(new_n56_));
  nand2  g39(.a(x6), .b(new_n25_), .O(new_n57_));
  aoi21  g40(.a(new_n57_), .b(new_n24_), .c(new_n21_), .O(new_n58_));
  oai21  g41(.a(new_n30_), .b(new_n25_), .c(x4), .O(new_n59_));
  oai21  g42(.a(new_n19_), .b(x5), .c(new_n59_), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n58_), .c(new_n18_), .O(new_n61_));
  aoi21  g44(.a(x6), .b(new_n33_), .c(x4), .O(new_n62_));
  nand3  g45(.a(x4), .b(new_n48_), .c(new_n33_), .O(new_n63_));
  oai21  g46(.a(new_n62_), .b(x1), .c(new_n63_), .O(new_n64_));
  aoi21  g47(.a(new_n64_), .b(new_n30_), .c(new_n45_), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(new_n61_), .c(new_n56_), .O(z2));
  nand2  g49(.a(x6), .b(new_n24_), .O(new_n67_));
  ...
  nand3  g54(.a(new_n30_), .b(new_n33_), .c(new_n25_), .O(new_n72_));
  ...
  aoi21  g71(.a(new_n50_), .b(new_n20_), .c(new_n19_), .O(new_n89_));
  nand2  g72(.a(new_n20_), .b(new_n18_), .O(new_n90_));
  aoi21  g73(.a(new_n90_), .b(new_n49_), .c(x6), .O(new_n91_));
  ...
  nand2  g82(.a(new_n48_), .b(x2), .O(new_n100_));
  ...
  aoi21  g87(.a(new_n104_), .b(new_n102_), .c(new_n45_), .O(z5));
  nand2  g88(.a(new_n99_), .b(x1), .O(new_n106_));
  nand3  g89(.a(x3), .b(new_n33_), .c(new_n25_), .O(new_n107_));
  nand3  g90(.a(new_n107_), .b(new_n106_), .c(new_n46_), .O(z6));
  aoi21  g91(.a(new_n100_), .b(new_n99_), .c(new_n45_), .O(z7));
  nor2   g92(.a(new_n45_), .b(x3), .O(z8));
  nand2  g93(.a(new_n22_), .b(new_n18_), .O(new_n111_));
  nand4  g94(.a(new_n111_), .b(new_n19_), .c(x5), .d(x4), .O(new_n112_));
