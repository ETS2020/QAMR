...
module FAU ( 
  ...
  nor2   g74(.a(new_n20_), .b(new_n19_), .O(new_n92_));
  nand2  g75(.a(x3), .b(new_n29_), .O(new_n93_));
  nand2  g76(.a(new_n58_), .b(x2), .O(new_n94_));
  oai21  g77(.a(new_n93_), .b(new_n32_), .c(new_n94_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n23_), .O(new_n96_));
  aoi21  g79(.a(x3), .b(x1), .c(x2), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(new_n25_), .c(x0), .O(new_n98_));
  ...
  aoi21  g86(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(z7));
  nor2   g87(.a(new_n92_), .b(x3), .O(z8));
