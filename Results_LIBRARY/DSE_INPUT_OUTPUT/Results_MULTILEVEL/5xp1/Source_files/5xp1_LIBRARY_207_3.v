...
module FAU ( 
  ...
  aoi21  g33(.a(new_n49_), .b(new_n33_), .c(new_n50_), .O(new_n51_));
  aoi21  g34(.a(new_n51_), .b(new_n48_), .c(new_n24_), .O(new_n52_));
  ...
  oai21  g43(.a(new_n60_), .b(new_n59_), .c(new_n25_), .O(new_n61_));
  oai21  g44(.a(x5), .b(x0), .c(new_n61_), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(x6), .c(new_n24_), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(new_n58_), .O(z2));
  nand2  g47(.a(x6), .b(new_n24_), .O(new_n65_));
  oai21  g48(.a(x6), .b(new_n25_), .c(new_n65_), .O(new_n66_));
  nand3  g49(.a(new_n30_), .b(x3), .c(new_n18_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(new_n47_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n66_), .c(x2), .O(new_n69_));
  nand2  g52(.a(new_n60_), .b(new_n25_), .O(new_n70_));
  nand3  g53(.a(x6), .b(x5), .c(x1), .O(new_n71_));
  aoi21  g54(.a(new_n71_), .b(new_n70_), .c(new_n18_), .O(new_n72_));
  nand3  g55(.a(new_n20_), .b(x5), .c(new_n25_), .O(new_n73_));
  nand3  g56(.a(x6), .b(new_n30_), .c(x1), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n73_), .c(x0), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n72_), .c(new_n24_), .O(new_n76_));
  ...
  nand3  g65(.a(new_n20_), .b(x5), .c(new_n18_), .O(new_n83_));
  ...
  aoi21  g69(.a(new_n53_), .b(new_n20_), .c(new_n19_), .O(new_n87_));
  inv1   g70(.a(x3), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n33_), .c(new_n59_), .O(new_n89_));
  nor2   g72(.a(new_n89_), .b(x6), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n87_), .c(x1), .O(new_n91_));
  nor2   g74(.a(x3), .b(x0), .O(new_n92_));
  nor3   g75(.a(new_n92_), .b(x6), .c(new_n33_), .O(new_n93_));
  nor2   g76(.a(new_n92_), .b(new_n33_), .O(new_n94_));
  nor2   g77(.a(new_n94_), .b(new_n19_), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n93_), .c(new_n25_), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n91_), .c(new_n45_), .O(z4));
  nand2  g80(.a(x3), .b(new_n33_), .O(new_n98_));
  nand2  g81(.a(new_n88_), .b(x2), .O(new_n99_));
  ...
  nand3  g86(.a(new_n103_), .b(new_n101_), .c(new_n45_), .O(z5));
  nand2  g87(.a(new_n98_), .b(x1), .O(new_n105_));
  nand3  g88(.a(x3), .b(new_n33_), .c(new_n25_), .O(new_n106_));
  nand3  g89(.a(new_n106_), .b(new_n105_), .c(new_n45_), .O(z6));
  nand3  g90(.a(new_n99_), .b(new_n98_), .c(new_n45_), .O(z7));
  nand2  g91(.a(new_n45_), .b(x3), .O(z8));
  nand2  g92(.a(new_n22_), .b(new_n18_), .O(new_n110_));
  nand2  g93(.a(new_n110_), .b(x5), .O(new_n111_));
  aoi21  g94(.a(new_n111_), .b(new_n19_), .c(new_n24_), .O(z9));
endmodule
