...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n101_, new_n102_, new_n104_, new_n106_;
  ...
  aoi21  g67(.a(new_n84_), .b(new_n64_), .c(new_n30_), .O(new_n85_));
  nand2  g68(.a(x3), .b(x0), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n30_), .c(new_n33_), .O(new_n87_));
  ...
  oai21  g84(.a(new_n101_), .b(new_n34_), .c(x1), .O(new_n102_));
  oai21  g85(.a(new_n93_), .b(x1), .c(new_n102_), .O(z6));
  oai21  g86(.a(new_n30_), .b(new_n79_), .c(x2), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n93_), .O(z7));
  nand2  g88(.a(new_n30_), .b(x2), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(x3), .O(z8));
  oai21  g90(.a(new_n22_), .b(new_n18_), .c(new_n106_), .O(z9));
endmodule
