...
module FAU ( 
  ...
  nor2   g34(.a(new_n18_), .b(new_n43_), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n29_), .c(new_n22_), .O(new_n53_));
  ...
  oai21  g41(.a(new_n58_), .b(new_n50_), .c(x4), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n29_), .O(new_n61_));
  nor2   g44(.a(x1), .b(x0), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(x6), .c(new_n22_), .O(new_n63_));
  oai21  g46(.a(new_n25_), .b(x2), .c(new_n63_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n35_), .O(new_n65_));
  nand3  g48(.a(x6), .b(new_n20_), .c(new_n22_), .O(new_n66_));
  oai21  g49(.a(new_n22_), .b(x2), .c(new_n66_), .O(new_n67_));
  nand3  g50(.a(x5), .b(x4), .c(x1), .O(new_n68_));
  aoi21  g51(.a(new_n68_), .b(x2), .c(new_n29_), .O(new_n69_));
  aoi21  g52(.a(new_n67_), .b(new_n19_), .c(new_n69_), .O(new_n70_));
  nand4  g53(.a(new_n70_), .b(new_n65_), .c(new_n61_), .d(new_n55_), .O(z2));
  nand3  g54(.a(new_n20_), .b(x3), .c(new_n19_), .O(new_n72_));
  oai21  g55(.a(new_n20_), .b(new_n19_), .c(new_n72_), .O(new_n73_));
  oai21  g56(.a(new_n52_), .b(x6), .c(new_n73_), .O(new_n74_));
  nand3  g57(.a(x5), .b(x3), .c(x0), .O(new_n75_));
  nand3  g58(.a(x6), .b(new_n20_), .c(new_n19_), .O(new_n76_));
  ...
  oai21  g64(.a(new_n29_), .b(new_n35_), .c(new_n43_), .O(new_n82_));
  nor2   g65(.a(x6), .b(x3), .O(new_n83_));
  nor2   g66(.a(new_n83_), .b(new_n18_), .O(new_n84_));
  aoi21  g67(.a(new_n84_), .b(new_n82_), .c(new_n20_), .O(new_n85_));
  aoi22  g68(.a(new_n85_), .b(new_n19_), .c(x6), .d(new_n18_), .O(new_n86_));
  nand4  g69(.a(new_n86_), .b(new_n81_), .c(new_n78_), .d(new_n74_), .O(z3));
  xnor2a g70(.a(x6), .b(x1), .O(new_n88_));
  nand2  g71(.a(new_n35_), .b(new_n19_), .O(new_n89_));
  nor2   g72(.a(new_n29_), .b(x3), .O(new_n90_));
  aoi22  g73(.a(new_n90_), .b(new_n62_), .c(new_n89_), .d(new_n88_), .O(new_n91_));
  ...
  oai21  g87(.a(new_n104_), .b(new_n92_), .c(x0), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(new_n101_), .O(z5));
  oai21  g89(.a(new_n83_), .b(x2), .c(x1), .O(new_n107_));
  nand3  g90(.a(new_n98_), .b(new_n18_), .c(new_n43_), .O(new_n108_));
  nand2  g91(.a(new_n108_), .b(new_n107_), .O(z6));
  nand2  g92(.a(new_n98_), .b(new_n18_), .O(new_n110_));
  nand2  g93(.a(new_n110_), .b(new_n97_), .O(z7));
  aoi21  g94(.a(x6), .b(new_n18_), .c(x3), .O(z8));
