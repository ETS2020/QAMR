...
module FAU ( 
  ...
  oai21  g079(.a(new_n20_), .b(new_n56_), .c(new_n96_), .O(new_n97_));
  nand2  g080(.a(new_n97_), .b(x0), .O(new_n98_));
  nand2  g081(.a(new_n18_), .b(new_n35_), .O(new_n99_));
  oai21  g082(.a(new_n90_), .b(new_n18_), .c(new_n21_), .O(new_n100_));
  nand3  g083(.a(new_n100_), .b(new_n87_), .c(new_n99_), .O(new_n101_));
  nand2  g084(.a(new_n101_), .b(x1), .O(new_n102_));
  nand3  g085(.a(new_n20_), .b(x3), .c(x2), .O(new_n103_));
  oai21  g086(.a(new_n20_), .b(x2), .c(new_n103_), .O(new_n104_));
  nand2  g087(.a(new_n104_), .b(new_n56_), .O(new_n105_));
  nand2  g088(.a(x6), .b(new_n18_), .O(new_n106_));
  nand4  g089(.a(new_n106_), .b(new_n105_), .c(new_n102_), .d(new_n98_), .O(z4));
  nand2  g090(.a(x3), .b(new_n35_), .O(new_n108_));
  inv1   g091(.a(new_n108_), .O(new_n109_));
  nand2  g092(.a(new_n20_), .b(new_n18_), .O(new_n110_));
  inv1   g093(.a(new_n110_), .O(z8));
  aoi22  g094(.a(z8), .b(x2), .c(new_n109_), .d(x1), .O(new_n112_));
  aoi21  g095(.a(new_n35_), .b(x1), .c(new_n18_), .O(new_n113_));
  nor2   g096(.a(new_n110_), .b(x2), .O(new_n114_));
  ...
  nand2  g100(.a(new_n109_), .b(new_n56_), .O(new_n118_));
  nand3  g101(.a(new_n118_), .b(new_n117_), .c(new_n106_), .O(z6));
  nand2  g102(.a(new_n18_), .b(x2), .O(new_n120_));
  oai21  g103(.a(z8), .b(x2), .c(new_n120_), .O(z7));
  aoi21  g104(.a(x5), .b(x4), .c(new_n18_), .O(new_n122_));
  oai21  g105(.a(new_n39_), .b(new_n56_), .c(new_n21_), .O(new_n123_));
  nand3  g106(.a(new_n123_), .b(x5), .c(x4), .O(new_n124_));
  oai21  g107(.a(new_n122_), .b(new_n20_), .c(new_n124_), .O(z9));
endmodule
