...
module FAU ( 
  ...
  oai21  g79(.a(x2), .b(new_n25_), .c(x6), .O(new_n97_));
  nand3  g80(.a(new_n97_), .b(x3), .c(new_n24_), .O(new_n98_));
  nand2  g81(.a(x6), .b(x3), .O(z8));
  inv1   g82(.a(z8), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(x1), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n63_), .c(x0), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n98_), .c(new_n96_), .O(z5));
  nand2  g86(.a(new_n31_), .b(x3), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(x1), .O(new_n105_));
  nand3  g88(.a(new_n100_), .b(new_n63_), .c(new_n25_), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n105_), .O(z6));
  nand2  g90(.a(x3), .b(new_n63_), .O(new_n108_));
  oai21  g91(.a(new_n100_), .b(new_n63_), .c(new_n108_), .O(z7));
  oai21  g92(.a(x3), .b(new_n24_), .c(new_n39_), .O(new_n110_));
