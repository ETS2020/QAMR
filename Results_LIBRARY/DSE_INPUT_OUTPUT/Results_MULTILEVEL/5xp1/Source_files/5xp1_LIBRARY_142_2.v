...
module FAU ( 
  ...
  nand2  g60(.a(x6), .b(x3), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n30_), .c(new_n24_), .O(new_n79_));
  nand2  g62(.a(x3), .b(x0), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n42_), .O(new_n81_));
  ...
  nand3  g68(.a(new_n85_), .b(new_n83_), .c(new_n43_), .O(z4));
  ...
  inv1   g76(.a(new_n43_), .O(new_n94_));
  aoi21  g77(.a(new_n87_), .b(new_n25_), .c(new_n94_), .O(new_n95_));
  oai21  g78(.a(new_n87_), .b(new_n25_), .c(new_n95_), .O(z6));
  nand2  g79(.a(new_n78_), .b(x2), .O(new_n97_));
  oai21  g80(.a(new_n64_), .b(x2), .c(new_n97_), .O(z7));
  nor2   g81(.a(new_n94_), .b(x3), .O(z8));
  oai21  g82(.a(x6), .b(x0), .c(x5), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(new_n18_), .c(new_n43_), .O(z9));
endmodule
