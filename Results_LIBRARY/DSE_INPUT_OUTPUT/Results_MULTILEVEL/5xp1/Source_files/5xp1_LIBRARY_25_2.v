...
module FAU ( 
  ...
  aoi21  g54(.a(new_n71_), .b(new_n31_), .c(new_n29_), .O(new_n72_));
  nor2   g55(.a(new_n39_), .b(x2), .O(new_n73_));
  nor2   g56(.a(x6), .b(x3), .O(new_n74_));
  oai21  g57(.a(new_n74_), .b(new_n73_), .c(new_n25_), .O(new_n75_));
  nand2  g58(.a(new_n74_), .b(new_n63_), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n75_), .c(x5), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(new_n72_), .c(x0), .O(new_n78_));
  oai21  g61(.a(new_n39_), .b(x2), .c(x3), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n25_), .c(new_n74_), .O(new_n80_));
  nand2  g63(.a(new_n37_), .b(new_n25_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(x6), .c(new_n29_), .O(new_n82_));
  oai21  g65(.a(new_n80_), .b(new_n29_), .c(new_n82_), .O(new_n83_));
