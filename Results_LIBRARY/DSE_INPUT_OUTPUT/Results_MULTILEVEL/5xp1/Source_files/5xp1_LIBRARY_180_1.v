...
module FAU ( 
  ...
  oai21  g15(.a(new_n23_), .b(x0), .c(new_n32_), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(x4), .O(new_n34_));
  aoi21  g17(.a(new_n21_), .b(new_n18_), .c(x4), .O(new_n35_));
  aoi21  g18(.a(x6), .b(new_n18_), .c(new_n35_), .O(new_n36_));
  ...
  aoi21  g30(.a(new_n46_), .b(new_n29_), .c(new_n47_), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(new_n45_), .c(x6), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n42_), .c(x4), .O(new_n50_));
  ...
  nand2  g40(.a(new_n21_), .b(new_n43_), .O(new_n58_));
  ...
  nor2   g45(.a(new_n62_), .b(new_n20_), .O(new_n63_));
  nand2  g46(.a(x3), .b(x2), .O(new_n64_));
  nand2  g47(.a(x6), .b(x1), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  aoi21  g49(.a(new_n66_), .b(new_n58_), .c(x0), .O(new_n67_));
  oai21  g50(.a(new_n67_), .b(new_n63_), .c(x5), .O(new_n68_));
  oai21  g51(.a(new_n21_), .b(new_n29_), .c(new_n43_), .O(new_n69_));
  nand3  g52(.a(new_n21_), .b(new_n30_), .c(new_n29_), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(new_n69_), .c(new_n20_), .O(new_n71_));
  nor2   g54(.a(new_n65_), .b(x0), .O(new_n72_));
  oai21  g55(.a(new_n72_), .b(new_n71_), .c(new_n18_), .O(new_n73_));
  nand4  g56(.a(new_n73_), .b(new_n68_), .c(new_n61_), .d(new_n27_), .O(z3));
  aoi21  g57(.a(new_n52_), .b(new_n64_), .c(new_n21_), .O(new_n75_));
  nand2  g58(.a(new_n64_), .b(new_n20_), .O(new_n76_));
  ...
  nor2   g63(.a(new_n79_), .b(new_n29_), .O(new_n81_));
  nor2   g64(.a(new_n81_), .b(new_n21_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n80_), .c(new_n43_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n78_), .c(new_n27_), .O(z4));
  nand2  g67(.a(x3), .b(new_n29_), .O(new_n85_));
  nand2  g68(.a(new_n30_), .b(x2), .O(new_n86_));
  oai21  g69(.a(new_n85_), .b(new_n43_), .c(new_n86_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n20_), .O(new_n88_));
  inv1   g71(.a(new_n64_), .O(new_n89_));
  aoi21  g72(.a(x3), .b(x1), .c(x2), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n89_), .c(x0), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n88_), .c(new_n27_), .O(z5));
  nand2  g75(.a(new_n85_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n29_), .c(new_n43_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n93_), .c(new_n27_), .O(z6));
  aoi21  g78(.a(new_n86_), .b(new_n85_), .c(new_n26_), .O(z7));
  nand2  g79(.a(new_n27_), .b(x3), .O(z8));
