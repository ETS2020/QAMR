...
module FAU ( 
  ...
  aoi21  g46(.a(new_n33_), .b(x1), .c(x5), .O(new_n64_));
  nor2   g47(.a(new_n21_), .b(new_n31_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n64_), .c(x0), .O(new_n66_));
  nand2  g49(.a(x6), .b(new_n26_), .O(new_n67_));
  nand2  g50(.a(new_n21_), .b(x5), .O(new_n68_));
  aoi21  g51(.a(new_n68_), .b(new_n67_), .c(new_n39_), .O(new_n69_));
  nand3  g52(.a(new_n21_), .b(x5), .c(new_n26_), .O(new_n70_));
  inv1   g53(.a(new_n70_), .O(new_n71_));
  oai21  g54(.a(new_n71_), .b(new_n69_), .c(new_n20_), .O(new_n72_));
  nor2   g55(.a(new_n21_), .b(x5), .O(new_n73_));
  inv1   g56(.a(new_n73_), .O(new_n74_));
  nand4  g57(.a(new_n74_), .b(new_n72_), .c(new_n66_), .d(new_n63_), .O(z3));
  aoi21  g58(.a(new_n49_), .b(new_n27_), .c(new_n21_), .O(new_n76_));
  nand2  g59(.a(new_n27_), .b(new_n20_), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n33_), .c(x6), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n76_), .c(x1), .O(new_n79_));
  nor2   g62(.a(x3), .b(x0), .O(new_n80_));
  nor3   g63(.a(new_n80_), .b(x6), .c(new_n31_), .O(new_n81_));
  nor2   g64(.a(new_n80_), .b(new_n31_), .O(new_n82_));
  nor2   g65(.a(new_n82_), .b(new_n21_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n81_), .c(new_n26_), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(new_n79_), .c(new_n74_), .O(z4));
  ...
  nand3  g74(.a(new_n91_), .b(new_n89_), .c(new_n74_), .O(z5));
  nand2  g75(.a(new_n86_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n31_), .c(new_n26_), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n93_), .c(new_n73_), .O(z6));
  nand3  g78(.a(new_n87_), .b(new_n86_), .c(new_n74_), .O(z7));
