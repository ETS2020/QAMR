...
module FAU ( 
  ...
  aoi22  g17(.a(new_n24_), .b(new_n22_), .c(new_n18_), .d(new_n34_), .O(new_n35_));
  ...
  oai21  g32(.a(x4), .b(new_n23_), .c(new_n19_), .O(new_n50_));
  ...
  oai21  g36(.a(x4), .b(new_n38_), .c(new_n19_), .O(new_n54_));
  ...
  oai21  g41(.a(new_n58_), .b(new_n57_), .c(new_n24_), .O(new_n59_));
  nand2  g42(.a(new_n58_), .b(new_n23_), .O(new_n60_));
  aoi21  g43(.a(new_n60_), .b(new_n59_), .c(x0), .O(new_n61_));
  oai21  g44(.a(new_n61_), .b(new_n56_), .c(x5), .O(new_n62_));
  nand2  g45(.a(new_n19_), .b(new_n21_), .O(new_n63_));
  ...
  nand3  g51(.a(x6), .b(x1), .c(new_n22_), .O(new_n69_));
  ...
  aoi21  g55(.a(new_n40_), .b(new_n24_), .c(new_n19_), .O(new_n73_));
  nand2  g56(.a(new_n24_), .b(new_n22_), .O(new_n74_));
  ...
  nor3   g60(.a(new_n77_), .b(x6), .c(new_n34_), .O(new_n78_));
  nor2   g61(.a(new_n77_), .b(new_n34_), .O(new_n79_));
  ...
  nand3  g66(.a(new_n83_), .b(new_n81_), .c(new_n76_), .O(z4));
  nand2  g67(.a(x3), .b(new_n34_), .O(new_n85_));
  nand2  g68(.a(new_n38_), .b(x2), .O(new_n86_));
  ...
  aoi21  g74(.a(new_n91_), .b(new_n88_), .c(new_n82_), .O(z5));
  nand2  g75(.a(new_n85_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n34_), .c(new_n23_), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n93_), .c(new_n82_), .O(z6));
  aoi21  g78(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(z7));
  nand2  g79(.a(new_n83_), .b(x3), .O(z8));
