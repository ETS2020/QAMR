...
module FAU ( 
  ...
  nor2   g11(.a(x4), .b(x2), .O(new_n29_));
  aoi21  g12(.a(new_n20_), .b(x4), .c(new_n29_), .O(new_n30_));
  nand2  g13(.a(x3), .b(x2), .O(new_n31_));
  nand3  g14(.a(new_n31_), .b(new_n20_), .c(x4), .O(new_n32_));
  oai21  g15(.a(new_n30_), .b(x1), .c(new_n32_), .O(new_n33_));
  nor2   g16(.a(x6), .b(x4), .O(new_n34_));
  aoi21  g17(.a(new_n33_), .b(new_n19_), .c(new_n34_), .O(new_n35_));
  ...
  nand3  g22(.a(new_n39_), .b(x6), .c(new_n36_), .O(new_n40_));
  ...
  oai21  g28(.a(new_n35_), .b(new_n25_), .c(new_n45_), .O(z1));
  ...
  aoi21  g33(.a(new_n49_), .b(new_n36_), .c(new_n50_), .O(new_n51_));
  ...
  nand3  g48(.a(new_n65_), .b(x6), .c(new_n36_), .O(new_n66_));
  ...
  nand3  g56(.a(new_n73_), .b(new_n20_), .c(new_n36_), .O(new_n74_));
  nand2  g57(.a(new_n31_), .b(new_n20_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n25_), .c(new_n19_), .O(new_n76_));
  nand3  g59(.a(new_n20_), .b(new_n41_), .c(new_n36_), .O(new_n77_));
  ...
  nand3  g67(.a(x6), .b(x3), .c(new_n36_), .O(new_n85_));
  nand3  g68(.a(new_n20_), .b(x2), .c(new_n37_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(x0), .O(new_n88_));
  nand2  g71(.a(new_n31_), .b(new_n19_), .O(new_n89_));
  aoi21  g72(.a(new_n89_), .b(new_n42_), .c(new_n37_), .O(new_n90_));
  nor2   g73(.a(new_n31_), .b(x1), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n90_), .c(new_n20_), .O(new_n92_));
  nor2   g75(.a(new_n20_), .b(x2), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n37_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n92_), .c(new_n88_), .O(z4));
  nand2  g78(.a(x3), .b(new_n36_), .O(new_n96_));
  nand3  g79(.a(new_n20_), .b(new_n41_), .c(x2), .O(new_n97_));
  oai21  g80(.a(new_n96_), .b(new_n37_), .c(new_n97_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n19_), .O(new_n99_));
  oai21  g82(.a(new_n41_), .b(new_n37_), .c(new_n36_), .O(new_n100_));
  nand3  g83(.a(new_n20_), .b(x3), .c(x2), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(x0), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(new_n99_), .O(z5));
  inv1   g87(.a(new_n42_), .O(new_n105_));
  aoi21  g88(.a(new_n20_), .b(x2), .c(new_n105_), .O(new_n106_));
  nand3  g89(.a(x3), .b(new_n36_), .c(new_n37_), .O(new_n107_));
  oai21  g90(.a(new_n106_), .b(new_n37_), .c(new_n107_), .O(z6));
  nand2  g91(.a(new_n97_), .b(new_n96_), .O(z7));
  nand2  g92(.a(new_n27_), .b(x3), .O(z8));
  aoi21  g93(.a(new_n21_), .b(new_n19_), .c(x6), .O(new_n111_));
  oai21  g94(.a(new_n111_), .b(new_n93_), .c(x5), .O(new_n112_));
  nor2   g95(.a(new_n112_), .b(new_n38_), .O(z9));
endmodule
