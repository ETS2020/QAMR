...
module FAU ( 
  ...
  aoi21  g68(.a(new_n35_), .b(new_n21_), .c(new_n39_), .O(new_n86_));
  ...
  nand3  g72(.a(new_n87_), .b(x6), .c(new_n39_), .O(new_n90_));
  ...
  oai21  g78(.a(x2), .b(new_n19_), .c(new_n39_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(x6), .O(new_n97_));
  inv1   g80(.a(new_n20_), .O(new_n98_));
  aoi21  g81(.a(x3), .b(x1), .c(x2), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(new_n98_), .c(x0), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(new_n97_), .c(new_n95_), .O(z5));
  nand3  g84(.a(new_n92_), .b(new_n23_), .c(x1), .O(new_n102_));
  oai21  g85(.a(new_n92_), .b(x1), .c(new_n102_), .O(z6));
  aoi21  g86(.a(new_n93_), .b(new_n92_), .c(new_n30_), .O(z7));
  nand2  g87(.a(new_n29_), .b(x3), .O(z8));
  nor2   g88(.a(new_n23_), .b(x1), .O(new_n106_));
  aoi21  g89(.a(new_n24_), .b(new_n19_), .c(x6), .O(new_n107_));
  oai21  g90(.a(new_n107_), .b(new_n106_), .c(x5), .O(new_n108_));
  nor2   g91(.a(new_n108_), .b(new_n18_), .O(z9));
endmodule
