...
module FAU ( 
  ...
  nand4  g55(.a(x6), .b(new_n25_), .c(new_n39_), .d(x0), .O(new_n73_));
  ...
  nand3  g60(.a(new_n20_), .b(z8), .c(new_n39_), .O(new_n78_));
  ...
  oai22  g69(.a(new_n86_), .b(new_n19_), .c(z8), .d(x1), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(x2), .O(new_n88_));
  nand3  g71(.a(new_n20_), .b(z8), .c(x1), .O(new_n89_));
  oai21  g72(.a(new_n20_), .b(x1), .c(new_n89_), .O(new_n90_));
  oai21  g73(.a(new_n39_), .b(new_n19_), .c(new_n90_), .O(new_n91_));
  nand4  g74(.a(new_n20_), .b(new_n39_), .c(x1), .d(new_n19_), .O(new_n92_));
  nand4  g75(.a(new_n92_), .b(new_n91_), .c(new_n88_), .d(new_n30_), .O(z4));
  xnor2a g76(.a(x3), .b(x0), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(x2), .O(new_n95_));
  oai21  g78(.a(x2), .b(new_n31_), .c(new_n20_), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(x3), .c(new_n19_), .O(new_n97_));
  nor2   g80(.a(x6), .b(z8), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(x1), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(new_n39_), .c(x0), .O(new_n100_));
  ...
  nand2  g86(.a(new_n98_), .b(new_n39_), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(x1), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(new_n103_), .O(z6));
  nand2  g89(.a(x3), .b(new_n39_), .O(new_n107_));
  oai21  g90(.a(new_n98_), .b(new_n39_), .c(new_n107_), .O(z7));
  aoi21  g91(.a(new_n21_), .b(new_n19_), .c(x6), .O(new_n109_));
  nor2   g92(.a(new_n20_), .b(x3), .O(new_n110_));
  oai21  g93(.a(new_n110_), .b(new_n109_), .c(x5), .O(new_n111_));
  nor2   g94(.a(new_n111_), .b(new_n32_), .O(z9));
endmodule
