...
module FAU ( 
  ...
  nand2  g62(.a(new_n46_), .b(new_n24_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(x6), .c(new_n19_), .O(new_n81_));
  aoi21  g64(.a(new_n24_), .b(new_n23_), .c(new_n69_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(x6), .c(new_n81_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(x1), .O(new_n84_));
  nand2  g67(.a(new_n58_), .b(new_n23_), .O(new_n85_));
  ...
  nand2  g88(.a(new_n26_), .b(new_n23_), .O(new_n106_));
