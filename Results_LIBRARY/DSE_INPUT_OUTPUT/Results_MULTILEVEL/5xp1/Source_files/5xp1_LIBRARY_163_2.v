...
module FAU ( 
  ...
  nand3  g64(.a(x6), .b(new_n19_), .c(new_n24_), .O(new_n82_));
  ...
  oai21  g68(.a(new_n29_), .b(x2), .c(new_n85_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n24_), .O(new_n87_));
  aoi21  g70(.a(new_n32_), .b(new_n19_), .c(new_n23_), .O(new_n88_));
  nand2  g71(.a(new_n70_), .b(new_n25_), .O(new_n89_));
  ...
  aoi21  g82(.a(new_n62_), .b(new_n24_), .c(new_n29_), .O(new_n100_));
  nand2  g83(.a(x6), .b(x3), .O(z8));
  oai21  g84(.a(z8), .b(x2), .c(x1), .O(new_n102_));
  oai21  g85(.a(new_n100_), .b(new_n19_), .c(new_n102_), .O(z6));
  nand2  g86(.a(z8), .b(x2), .O(new_n104_));
  oai21  g87(.a(new_n19_), .b(x2), .c(new_n104_), .O(z7));
  oai21  g88(.a(x3), .b(new_n23_), .c(new_n29_), .O(new_n106_));
