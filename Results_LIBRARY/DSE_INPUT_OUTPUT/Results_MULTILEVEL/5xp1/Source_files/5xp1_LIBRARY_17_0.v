...
module FAU ( 
  ...
  aoi21  g68(.a(new_n85_), .b(x5), .c(new_n82_), .O(new_n86_));
  nand2  g69(.a(new_n43_), .b(new_n18_), .O(new_n87_));
  nand4  g70(.a(new_n87_), .b(new_n19_), .c(x5), .d(x2), .O(new_n88_));
  nor2   g71(.a(x3), .b(x0), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n57_), .c(x6), .O(new_n90_));
  ...
  nand2  g76(.a(x3), .b(new_n57_), .O(new_n94_));
  nand2  g77(.a(new_n43_), .b(x2), .O(new_n95_));
  ...
  nand3  g84(.a(x3), .b(new_n57_), .c(new_n23_), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(new_n101_), .c(new_n63_), .O(z6));
  nand3  g86(.a(new_n95_), .b(new_n94_), .c(new_n64_), .O(z7));
  nand2  g87(.a(new_n64_), .b(x3), .O(z8));
  nand3  g88(.a(new_n53_), .b(x5), .c(x4), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n64_), .O(z9));
endmodule
