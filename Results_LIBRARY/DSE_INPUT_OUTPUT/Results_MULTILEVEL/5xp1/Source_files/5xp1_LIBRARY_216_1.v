...
module FAU ( 
  ...
  nor2   g68(.a(new_n29_), .b(x2), .O(new_n86_));
  aoi21  g69(.a(new_n85_), .b(new_n19_), .c(new_n86_), .O(new_n87_));
  nand4  g70(.a(new_n87_), .b(new_n81_), .c(new_n78_), .d(new_n74_), .O(z3));
  xnor2a g71(.a(x6), .b(x1), .O(new_n89_));
  nand2  g72(.a(new_n35_), .b(new_n19_), .O(new_n90_));
  nor2   g73(.a(new_n29_), .b(x3), .O(new_n91_));
  aoi22  g74(.a(new_n91_), .b(new_n62_), .c(new_n90_), .d(new_n89_), .O(new_n92_));
  nor2   g75(.a(new_n35_), .b(new_n18_), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(x0), .c(new_n79_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n29_), .c(x1), .O(new_n95_));
  ...
  nand3  g86(.a(new_n103_), .b(new_n101_), .c(new_n97_), .O(z5));
  ...
  inv1   g91(.a(new_n100_), .O(new_n109_));
  oai21  g92(.a(new_n83_), .b(x2), .c(new_n109_), .O(z7));
  nor2   g93(.a(new_n86_), .b(x3), .O(z8));
  aoi21  g94(.a(x5), .b(x4), .c(new_n18_), .O(new_n112_));
  nand2  g95(.a(new_n30_), .b(new_n19_), .O(new_n113_));
  nand3  g96(.a(new_n113_), .b(x5), .c(x4), .O(new_n114_));
  oai21  g97(.a(new_n112_), .b(new_n29_), .c(new_n114_), .O(z9));
endmodule
