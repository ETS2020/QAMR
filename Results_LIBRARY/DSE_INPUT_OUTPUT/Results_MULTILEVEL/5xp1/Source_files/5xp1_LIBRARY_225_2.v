...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n101_, new_n103_, new_n105_, new_n107_, new_n108_;
  ...
  oai21  g70(.a(new_n87_), .b(new_n84_), .c(new_n82_), .O(new_n88_));
  ...
  nand2  g84(.a(x6), .b(x3), .O(z8));
  aoi21  g85(.a(x6), .b(x2), .c(new_n82_), .O(new_n103_));
  oai22  g86(.a(new_n103_), .b(new_n25_), .c(z8), .d(new_n101_), .O(z6));
  nand2  g87(.a(z8), .b(x2), .O(new_n105_));
  oai21  g88(.a(new_n82_), .b(x2), .c(new_n105_), .O(z7));
  oai21  g89(.a(x3), .b(new_n24_), .c(new_n39_), .O(new_n107_));
