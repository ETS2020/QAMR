...
module FAU ( 
  ...
  nand2  g56(.a(new_n46_), .b(new_n28_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(x0), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(new_n21_), .O(new_n76_));
  nand2  g59(.a(new_n21_), .b(new_n19_), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n74_), .c(x6), .O(new_n78_));
  aoi22  g61(.a(new_n78_), .b(new_n56_), .c(new_n76_), .d(x6), .O(new_n79_));
  nor2   g62(.a(x3), .b(x0), .O(new_n80_));
  nor2   g63(.a(new_n80_), .b(x6), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n56_), .c(x2), .O(new_n82_));
  ...
  oai21  g68(.a(new_n79_), .b(new_n20_), .c(new_n85_), .O(z4));
  inv1   g69(.a(new_n71_), .O(new_n87_));
  nand2  g70(.a(x3), .b(new_n28_), .O(new_n88_));
  nand2  g71(.a(new_n46_), .b(x2), .O(new_n89_));
  ...
  nand3  g76(.a(new_n93_), .b(new_n91_), .c(new_n87_), .O(z5));
  nand2  g77(.a(new_n88_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n28_), .c(new_n20_), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n95_), .c(new_n71_), .O(z6));
  aoi21  g80(.a(new_n89_), .b(new_n88_), .c(new_n71_), .O(z7));
  nand2  g81(.a(new_n87_), .b(x3), .O(z8));
