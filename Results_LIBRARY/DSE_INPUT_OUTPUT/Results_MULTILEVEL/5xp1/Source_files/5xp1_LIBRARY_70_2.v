...
module FAU ( 
  ...
  oai21  g76(.a(new_n92_), .b(new_n22_), .c(new_n93_), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n21_), .O(new_n95_));
  aoi21  g78(.a(x3), .b(x1), .c(x2), .O(new_n96_));
  oai21  g79(.a(new_n96_), .b(new_n65_), .c(x0), .O(new_n97_));
  aoi21  g80(.a(new_n97_), .b(new_n95_), .c(new_n76_), .O(z5));
  inv1   g81(.a(new_n76_), .O(new_n99_));
  nand2  g82(.a(new_n92_), .b(x1), .O(new_n100_));
  nand3  g83(.a(x3), .b(new_n33_), .c(new_n22_), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(z6));
  nand3  g85(.a(new_n93_), .b(new_n92_), .c(new_n99_), .O(z7));
  nand2  g86(.a(new_n99_), .b(x3), .O(z8));
