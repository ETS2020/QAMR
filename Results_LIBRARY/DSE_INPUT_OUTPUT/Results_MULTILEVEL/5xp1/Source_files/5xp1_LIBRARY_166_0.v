...
module FAU ( 
  ...
  nand2  g76(.a(x3), .b(new_n82_), .O(new_n94_));
  nand2  g77(.a(new_n83_), .b(x2), .O(new_n95_));
  oai21  g78(.a(new_n94_), .b(new_n26_), .c(new_n95_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n22_), .O(new_n97_));
  aoi21  g80(.a(x3), .b(x1), .c(x2), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n34_), .c(x0), .O(new_n99_));
  aoi21  g82(.a(new_n99_), .b(new_n97_), .c(new_n93_), .O(z5));
  nand2  g83(.a(new_n94_), .b(x1), .O(new_n101_));
  nand3  g84(.a(x3), .b(new_n82_), .c(new_n26_), .O(new_n102_));
