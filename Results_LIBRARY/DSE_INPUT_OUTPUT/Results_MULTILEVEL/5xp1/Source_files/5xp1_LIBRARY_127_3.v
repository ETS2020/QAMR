...
module FAU ( 
  ...
  nand2  g25(.a(new_n35_), .b(new_n19_), .O(new_n43_));
  nand4  g26(.a(new_n43_), .b(new_n22_), .c(x4), .d(x1), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n21_), .c(new_n42_), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n18_), .O(new_n46_));
  oai21  g29(.a(new_n39_), .b(new_n18_), .c(new_n46_), .O(z1));
  ...
  aoi21  g34(.a(new_n51_), .b(new_n50_), .c(new_n22_), .O(new_n52_));
  nand2  g35(.a(x5), .b(x0), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n40_), .O(new_n54_));
  oai21  g37(.a(x5), .b(x3), .c(x0), .O(new_n55_));
  aoi21  g38(.a(x5), .b(x3), .c(x0), .O(new_n56_));
  aoi21  g39(.a(new_n55_), .b(new_n19_), .c(new_n56_), .O(new_n57_));
  ...
  nand2  g44(.a(new_n22_), .b(x3), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n19_), .c(new_n21_), .O(new_n63_));
  nand3  g46(.a(x5), .b(x3), .c(x2), .O(new_n64_));
  inv1   g47(.a(new_n64_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n63_), .c(x1), .O(new_n66_));
  nand3  g49(.a(new_n22_), .b(x5), .c(x0), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n66_), .c(new_n61_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(new_n32_), .O(new_n69_));
  nor2   g52(.a(new_n22_), .b(new_n19_), .O(new_n70_));
  inv1   g53(.a(new_n70_), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n69_), .c(new_n59_), .O(z2));
  nand3  g55(.a(new_n18_), .b(x3), .c(new_n21_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n53_), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(x2), .c(x1), .O(new_n75_));
  nand2  g58(.a(new_n43_), .b(x1), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n18_), .c(x0), .O(new_n77_));
  nor2   g60(.a(new_n35_), .b(new_n19_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(x1), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(x5), .c(new_n21_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n77_), .c(new_n75_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n22_), .O(new_n82_));
  nand2  g65(.a(x5), .b(new_n40_), .O(new_n83_));
  nand3  g66(.a(x6), .b(new_n18_), .c(x1), .O(new_n84_));
  aoi21  g67(.a(new_n84_), .b(new_n83_), .c(x0), .O(new_n85_));
  nand2  g68(.a(new_n22_), .b(new_n35_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(x5), .c(x1), .O(new_n87_));
  aoi21  g70(.a(new_n87_), .b(new_n49_), .c(new_n21_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n85_), .c(new_n19_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n82_), .O(z3));
  oai22  g73(.a(new_n22_), .b(new_n35_), .c(new_n19_), .d(x1), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(x0), .O(new_n92_));
  oai21  g75(.a(new_n78_), .b(x0), .c(new_n43_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n22_), .c(x1), .O(new_n94_));
  aoi21  g77(.a(new_n36_), .b(new_n40_), .c(new_n70_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n94_), .c(new_n92_), .O(z4));
  nand2  g79(.a(x3), .b(new_n19_), .O(new_n97_));
  oai22  g80(.a(new_n97_), .b(new_n40_), .c(new_n86_), .d(new_n19_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n21_), .O(new_n99_));
  oai21  g82(.a(new_n35_), .b(new_n40_), .c(new_n19_), .O(new_n100_));
  oai21  g83(.a(new_n62_), .b(new_n19_), .c(new_n100_), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(x0), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n99_), .O(z5));
  nand2  g86(.a(new_n97_), .b(x1), .O(new_n104_));
  nand3  g87(.a(x3), .b(new_n19_), .c(new_n40_), .O(new_n105_));
  nand3  g88(.a(new_n105_), .b(new_n104_), .c(new_n71_), .O(z6));
  nand2  g89(.a(new_n62_), .b(x2), .O(new_n107_));
  nand2  g90(.a(new_n107_), .b(new_n97_), .O(z7));
  nand2  g91(.a(new_n71_), .b(x3), .O(z8));
  nor2   g92(.a(new_n22_), .b(x2), .O(new_n110_));
  aoi21  g93(.a(new_n79_), .b(new_n21_), .c(x6), .O(new_n111_));
