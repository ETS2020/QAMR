...
module FAU ( 
  ...
  nand2  g53(.a(new_n65_), .b(new_n35_), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n70_), .c(x2), .O(new_n72_));
  nand2  g55(.a(new_n71_), .b(x2), .O(new_n73_));
  nor2   g56(.a(new_n65_), .b(new_n29_), .O(new_n74_));
  aoi22  g57(.a(new_n74_), .b(x0), .c(new_n73_), .d(new_n29_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n24_), .c(new_n72_), .O(z4));
  nand3  g59(.a(new_n56_), .b(new_n65_), .c(x2), .O(new_n77_));
  nand2  g60(.a(new_n30_), .b(x1), .O(new_n78_));
  nand2  g61(.a(x6), .b(x3), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n35_), .O(new_n81_));
  aoi21  g64(.a(new_n65_), .b(x2), .c(x1), .O(new_n82_));
  nand2  g65(.a(new_n65_), .b(new_n30_), .O(new_n83_));
  aoi21  g66(.a(new_n83_), .b(new_n37_), .c(new_n24_), .O(new_n84_));
  ...
  nand2  g72(.a(new_n65_), .b(x2), .O(new_n90_));
  nand3  g73(.a(new_n88_), .b(new_n90_), .c(new_n56_), .O(z7));
  nand2  g74(.a(new_n56_), .b(x3), .O(z8));
