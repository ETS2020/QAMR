...
module FAU ( 
  ...
  nor2   g37(.a(new_n51_), .b(x0), .O(new_n55_));
  nand4  g38(.a(new_n20_), .b(new_n51_), .c(new_n25_), .d(x0), .O(new_n56_));
  inv1   g39(.a(new_n56_), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n55_), .c(new_n34_), .O(new_n58_));
  nand3  g41(.a(new_n51_), .b(new_n24_), .c(x0), .O(new_n59_));
  inv1   g42(.a(new_n59_), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n55_), .c(new_n25_), .O(new_n61_));
  nand3  g44(.a(new_n20_), .b(new_n51_), .c(x0), .O(new_n62_));
  inv1   g45(.a(new_n62_), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n55_), .c(new_n24_), .O(new_n64_));
  nand3  g47(.a(new_n35_), .b(x5), .c(x0), .O(new_n65_));
  nand3  g48(.a(new_n51_), .b(x3), .c(x2), .O(new_n66_));
  ...
  aoi21  g55(.a(new_n72_), .b(new_n51_), .c(new_n20_), .O(new_n73_));
  aoi21  g56(.a(new_n69_), .b(x1), .c(new_n73_), .O(new_n74_));
  nand4  g57(.a(new_n74_), .b(new_n64_), .c(new_n61_), .d(new_n58_), .O(z3));
  nand2  g58(.a(new_n35_), .b(x0), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n70_), .c(new_n20_), .O(new_n77_));
  nand2  g60(.a(new_n70_), .b(new_n19_), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n35_), .c(x6), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n77_), .c(x1), .O(new_n80_));
  nor2   g63(.a(x3), .b(x0), .O(new_n81_));
  nor3   g64(.a(new_n81_), .b(x6), .c(new_n25_), .O(new_n82_));
  nor2   g65(.a(new_n81_), .b(new_n25_), .O(new_n83_));
  nor2   g66(.a(new_n83_), .b(new_n20_), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n82_), .c(new_n24_), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n80_), .c(new_n53_), .O(z4));
  nand2  g69(.a(x3), .b(new_n25_), .O(new_n87_));
  nand2  g70(.a(new_n34_), .b(x2), .O(new_n88_));
  oai21  g71(.a(new_n87_), .b(new_n24_), .c(new_n88_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n19_), .O(new_n90_));
  aoi21  g73(.a(x3), .b(x1), .c(x2), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n71_), .c(x0), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n90_), .c(new_n53_), .O(z5));
  nand2  g76(.a(new_n87_), .b(x1), .O(new_n94_));
  nand3  g77(.a(x3), .b(new_n25_), .c(new_n24_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n94_), .c(new_n53_), .O(z6));
  aoi21  g79(.a(new_n88_), .b(new_n87_), .c(new_n52_), .O(z7));
  nand2  g80(.a(new_n53_), .b(x3), .O(z8));
  nand2  g81(.a(new_n21_), .b(new_n19_), .O(new_n99_));
  nand4  g82(.a(new_n99_), .b(new_n20_), .c(x5), .d(x4), .O(new_n100_));
