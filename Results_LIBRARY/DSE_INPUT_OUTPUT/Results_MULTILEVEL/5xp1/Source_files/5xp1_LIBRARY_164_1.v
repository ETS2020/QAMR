...
module FAU ( 
  ...
  nand3  g079(.a(new_n29_), .b(x2), .c(new_n37_), .O(new_n97_));
  oai21  g080(.a(new_n29_), .b(new_n37_), .c(new_n97_), .O(new_n98_));
  nand2  g081(.a(new_n98_), .b(x0), .O(new_n99_));
  oai21  g082(.a(x6), .b(x2), .c(x3), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(new_n19_), .O(new_n101_));
  nand3  g084(.a(new_n101_), .b(new_n89_), .c(new_n76_), .O(new_n102_));
  ...
  aoi21  g088(.a(new_n105_), .b(new_n37_), .c(new_n52_), .O(new_n106_));
  nand3  g089(.a(new_n106_), .b(new_n103_), .c(new_n99_), .O(z4));
  nand2  g090(.a(x3), .b(new_n45_), .O(new_n108_));
  nor2   g091(.a(x6), .b(x3), .O(z8));
  nand2  g092(.a(z8), .b(x2), .O(new_n110_));
  oai21  g093(.a(new_n108_), .b(new_n37_), .c(new_n110_), .O(new_n111_));
  nand2  g094(.a(new_n111_), .b(new_n19_), .O(new_n112_));
  aoi21  g095(.a(new_n45_), .b(x1), .c(new_n18_), .O(new_n113_));
  nor3   g096(.a(x6), .b(x3), .c(x2), .O(new_n114_));
  oai21  g097(.a(new_n114_), .b(new_n113_), .c(x0), .O(new_n115_));
  nand2  g098(.a(new_n115_), .b(new_n112_), .O(z5));
  oai21  g099(.a(z8), .b(new_n31_), .c(x1), .O(new_n117_));
  oai21  g100(.a(new_n108_), .b(x1), .c(new_n117_), .O(z6));
  nand2  g101(.a(new_n110_), .b(new_n108_), .O(z7));
  aoi21  g102(.a(x5), .b(x4), .c(new_n18_), .O(new_n120_));
  nand2  g103(.a(new_n32_), .b(new_n19_), .O(new_n121_));
  nand3  g104(.a(new_n121_), .b(x5), .c(x4), .O(new_n122_));
  oai21  g105(.a(new_n120_), .b(new_n29_), .c(new_n122_), .O(z9));
endmodule
