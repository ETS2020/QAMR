...
module FAU ( 
  ...
  nand2  g53(.a(new_n41_), .b(new_n26_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(x1), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(new_n25_), .c(x0), .O(new_n73_));
  nand3  g56(.a(new_n21_), .b(x5), .c(new_n19_), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(new_n73_), .c(new_n70_), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(new_n20_), .O(new_n76_));
  nand2  g59(.a(x5), .b(new_n30_), .O(new_n77_));
  nand3  g60(.a(x6), .b(new_n25_), .c(x1), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n77_), .c(x0), .O(new_n79_));
  nand2  g62(.a(new_n20_), .b(new_n41_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(x5), .c(x1), .O(new_n81_));
  aoi21  g64(.a(new_n81_), .b(new_n60_), .c(new_n19_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n79_), .c(new_n26_), .O(new_n83_));
  ...
  nand2  g69(.a(new_n33_), .b(new_n19_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n71_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n20_), .c(x1), .O(new_n89_));
  nand2  g72(.a(new_n33_), .b(new_n20_), .O(new_n90_));
  aoi21  g73(.a(new_n90_), .b(new_n30_), .c(new_n27_), .O(new_n91_));
  ...
  aoi21  g83(.a(new_n94_), .b(new_n30_), .c(new_n27_), .O(new_n101_));
  oai21  g84(.a(new_n94_), .b(new_n30_), .c(new_n101_), .O(z6));
  oai21  g85(.a(x6), .b(new_n41_), .c(x2), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(new_n93_), .O(z7));
  nor2   g87(.a(new_n27_), .b(x3), .O(z8));
  nand4  g88(.a(x5), .b(x4), .c(x3), .d(x1), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n20_), .O(new_n107_));
  nand2  g90(.a(new_n107_), .b(x2), .O(new_n108_));
  nand2  g91(.a(new_n20_), .b(new_n19_), .O(new_n109_));
