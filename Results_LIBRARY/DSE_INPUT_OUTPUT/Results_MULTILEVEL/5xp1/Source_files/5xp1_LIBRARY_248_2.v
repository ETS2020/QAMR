...
module FAU ( 
  ...
  nand2  g67(.a(new_n63_), .b(x1), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n84_), .c(x6), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n83_), .c(new_n31_), .O(new_n87_));
  oai21  g70(.a(x3), .b(x2), .c(x0), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n58_), .c(new_n25_), .O(new_n89_));
  ...
  oai21  g84(.a(new_n35_), .b(new_n31_), .c(x1), .O(new_n102_));
  oai21  g85(.a(z8), .b(new_n100_), .c(new_n102_), .O(z6));
  nand2  g86(.a(z8), .b(x2), .O(new_n104_));
  oai21  g87(.a(new_n31_), .b(x2), .c(new_n104_), .O(z7));
  oai22  g88(.a(new_n22_), .b(new_n18_), .c(x6), .d(new_n31_), .O(z9));
endmodule
