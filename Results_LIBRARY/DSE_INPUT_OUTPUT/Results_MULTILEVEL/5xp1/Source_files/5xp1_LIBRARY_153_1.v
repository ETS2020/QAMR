...
module FAU ( 
  ...
  aoi22  g31(.a(new_n48_), .b(new_n18_), .c(new_n47_), .d(new_n32_), .O(new_n49_));
  ...
  oai21  g48(.a(new_n32_), .b(new_n18_), .c(x5), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(x6), .O(new_n67_));
  nand2  g50(.a(new_n34_), .b(x1), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n29_), .c(x0), .O(new_n69_));
  oai21  g52(.a(new_n19_), .b(new_n23_), .c(new_n24_), .O(new_n70_));
  nand2  g53(.a(new_n19_), .b(new_n23_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(x5), .c(new_n18_), .O(new_n73_));
  nand4  g56(.a(new_n73_), .b(new_n69_), .c(new_n67_), .d(new_n65_), .O(z3));
  nand2  g57(.a(new_n51_), .b(new_n24_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(x6), .c(x5), .O(new_n76_));
  nor2   g59(.a(x3), .b(x2), .O(new_n77_));
  aoi21  g60(.a(new_n24_), .b(new_n18_), .c(new_n77_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(x6), .c(new_n76_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(x1), .O(new_n80_));
  nand2  g63(.a(new_n33_), .b(new_n18_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n19_), .c(x2), .O(new_n82_));
  ...
  inv1   g70(.a(new_n42_), .O(new_n88_));
  ...
  nand3  g78(.a(new_n95_), .b(new_n92_), .c(new_n88_), .O(z5));
  nand2  g79(.a(new_n89_), .b(x1), .O(new_n97_));
  nand3  g80(.a(x3), .b(new_n32_), .c(new_n23_), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n97_), .c(new_n88_), .O(z6));
  nand3  g82(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(z7));
  nor2   g83(.a(new_n42_), .b(x3), .O(z8));
  aoi21  g84(.a(new_n20_), .b(new_n18_), .c(new_n29_), .O(new_n102_));
  oai21  g85(.a(new_n102_), .b(x6), .c(x4), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(new_n88_), .O(z9));
endmodule
