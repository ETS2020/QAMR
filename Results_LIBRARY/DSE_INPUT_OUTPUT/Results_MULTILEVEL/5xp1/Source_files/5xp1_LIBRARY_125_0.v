...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n107_, new_n108_, new_n110_, new_n113_, new_n114_;
  ...
  oai21  g06(.a(x4), .b(new_n23_), .c(new_n19_), .O(new_n24_));
  nand3  g07(.a(x3), .b(x2), .c(x1), .O(new_n25_));
  nand3  g08(.a(new_n25_), .b(new_n20_), .c(x5), .O(new_n26_));
  inv1   g09(.a(new_n26_), .O(new_n27_));
  nand3  g10(.a(new_n27_), .b(x4), .c(new_n23_), .O(new_n28_));
  ...
  aoi21  g19(.a(new_n34_), .b(new_n19_), .c(new_n36_), .O(new_n37_));
  oai22  g20(.a(new_n26_), .b(x0), .c(new_n20_), .d(x5), .O(new_n38_));
  ...
  nand3  g24(.a(new_n20_), .b(new_n18_), .c(x1), .O(new_n42_));
  ...
  nand3  g34(.a(new_n51_), .b(new_n20_), .c(new_n19_), .O(new_n52_));
  inv1   g35(.a(new_n52_), .O(new_n53_));
  oai21  g36(.a(new_n53_), .b(new_n50_), .c(x4), .O(new_n54_));
  nand4  g37(.a(x6), .b(new_n19_), .c(new_n18_), .d(new_n31_), .O(new_n55_));
  nand2  g38(.a(new_n20_), .b(new_n23_), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(new_n55_), .c(x1), .O(new_n57_));
  aoi21  g40(.a(new_n20_), .b(x5), .c(new_n23_), .O(new_n58_));
  nand3  g41(.a(x5), .b(x3), .c(x2), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(new_n20_), .c(new_n23_), .O(new_n60_));
  oai21  g43(.a(new_n58_), .b(x4), .c(new_n60_), .O(new_n61_));
  nor2   g44(.a(new_n61_), .b(new_n57_), .O(new_n62_));
  nand4  g45(.a(new_n62_), .b(new_n54_), .c(new_n47_), .d(new_n44_), .O(z2));
  nand2  g46(.a(new_n20_), .b(new_n30_), .O(new_n64_));
  nand3  g47(.a(new_n19_), .b(x3), .c(new_n23_), .O(new_n65_));
  oai21  g48(.a(new_n19_), .b(new_n23_), .c(new_n65_), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n64_), .c(x2), .O(new_n67_));
  oai21  g50(.a(x6), .b(x3), .c(x5), .O(new_n68_));
  nand3  g51(.a(x6), .b(new_n19_), .c(new_n23_), .O(new_n69_));
  oai21  g52(.a(new_n68_), .b(new_n23_), .c(new_n69_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(x1), .O(new_n71_));
  nor2   g54(.a(new_n20_), .b(new_n31_), .O(new_n72_));
  xnor2a g55(.a(x5), .b(x0), .O(new_n73_));
  inv1   g56(.a(x3), .O(new_n74_));
  nand3  g57(.a(x5), .b(new_n74_), .c(new_n23_), .O(new_n75_));
  oai21  g58(.a(new_n73_), .b(new_n72_), .c(new_n75_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n30_), .O(new_n77_));
  nand2  g60(.a(x3), .b(x2), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(x5), .c(new_n23_), .O(new_n79_));
  nand4  g62(.a(new_n19_), .b(new_n74_), .c(new_n31_), .d(x0), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nor2   g64(.a(x4), .b(x0), .O(new_n82_));
  aoi21  g65(.a(new_n81_), .b(new_n20_), .c(new_n82_), .O(new_n83_));
  nand4  g66(.a(new_n83_), .b(new_n77_), .c(new_n71_), .d(new_n67_), .O(z3));
  nand3  g67(.a(new_n78_), .b(new_n20_), .c(new_n23_), .O(new_n85_));
  ...
  nand3  g71(.a(new_n20_), .b(new_n74_), .c(new_n31_), .O(new_n89_));
  aoi21  g72(.a(new_n89_), .b(new_n88_), .c(new_n23_), .O(new_n90_));
  ...
  oai21  g80(.a(new_n97_), .b(new_n93_), .c(new_n30_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n91_), .O(z4));
  xor2a  g82(.a(x3), .b(x0), .O(new_n100_));
  nand2  g83(.a(x3), .b(x1), .O(new_n101_));
  xor2a  g84(.a(new_n101_), .b(new_n23_), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(new_n31_), .c(new_n82_), .O(new_n103_));
  oai21  g86(.a(new_n100_), .b(new_n31_), .c(new_n103_), .O(z5));
  inv1   g87(.a(new_n82_), .O(new_n105_));
  nand2  g88(.a(x3), .b(new_n31_), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(x1), .O(new_n107_));
  nand3  g90(.a(x3), .b(new_n31_), .c(new_n30_), .O(new_n108_));
  nand3  g91(.a(new_n108_), .b(new_n107_), .c(new_n105_), .O(z6));
  nand2  g92(.a(new_n74_), .b(x2), .O(new_n110_));
  nand3  g93(.a(new_n110_), .b(new_n106_), .c(new_n105_), .O(z7));
  nand2  g94(.a(new_n105_), .b(x3), .O(z8));
  nand3  g95(.a(new_n25_), .b(new_n20_), .c(new_n23_), .O(new_n113_));
