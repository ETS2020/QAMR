...
module FAU ( 
  ...
  aoi21  g68(.a(new_n85_), .b(new_n84_), .c(new_n32_), .O(new_n86_));
  nand2  g69(.a(new_n75_), .b(new_n19_), .O(new_n87_));
  aoi21  g70(.a(new_n87_), .b(x3), .c(x6), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n86_), .c(x1), .O(new_n89_));
  aoi21  g72(.a(new_n32_), .b(x3), .c(x2), .O(new_n90_));
  oai22  g73(.a(x6), .b(new_n75_), .c(x3), .d(x0), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n90_), .c(new_n33_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n89_), .O(z4));
  nand3  g76(.a(new_n75_), .b(x1), .c(new_n19_), .O(new_n94_));
  oai21  g77(.a(new_n75_), .b(new_n19_), .c(new_n94_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(x3), .O(new_n96_));
  aoi21  g79(.a(x6), .b(new_n75_), .c(x0), .O(new_n97_));
  nor2   g80(.a(x2), .b(new_n19_), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n97_), .c(z8), .O(new_n99_));
  ...
  inv1   g86(.a(new_n84_), .O(new_n104_));
  nor2   g87(.a(new_n32_), .b(x3), .O(new_n105_));
  oai21  g88(.a(new_n105_), .b(new_n104_), .c(x1), .O(new_n106_));
  nand2  g89(.a(x3), .b(new_n75_), .O(new_n107_));
  oai21  g90(.a(new_n107_), .b(x1), .c(new_n106_), .O(z6));
  nand2  g91(.a(new_n105_), .b(x2), .O(new_n109_));
  nand2  g92(.a(new_n109_), .b(new_n107_), .O(z7));
  inv1   g93(.a(new_n29_), .O(new_n111_));
