...
module FAU ( 
  ...
  aoi21  g76(.a(new_n83_), .b(x6), .c(new_n33_), .O(new_n94_));
  nor2   g77(.a(new_n72_), .b(x2), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(x0), .c(new_n94_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n93_), .O(z5));
  nor2   g80(.a(x3), .b(x2), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n34_), .c(x1), .O(new_n99_));
  oai21  g82(.a(new_n90_), .b(x1), .c(new_n99_), .O(z6));
  oai21  g83(.a(new_n30_), .b(new_n65_), .c(x2), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(new_n90_), .O(z7));
  aoi21  g85(.a(new_n30_), .b(x2), .c(x3), .O(z8));
  oai22  g86(.a(new_n22_), .b(new_n18_), .c(x6), .d(new_n33_), .O(z9));
endmodule
