...
module FAU ( 
  ...
  aoi21  g89(.a(new_n106_), .b(new_n105_), .c(new_n64_), .O(z6));
  nand3  g90(.a(new_n99_), .b(new_n98_), .c(new_n67_), .O(z7));
  nor2   g91(.a(new_n64_), .b(x3), .O(z8));
  nand4  g92(.a(new_n22_), .b(new_n30_), .c(x5), .d(x4), .O(new_n110_));
