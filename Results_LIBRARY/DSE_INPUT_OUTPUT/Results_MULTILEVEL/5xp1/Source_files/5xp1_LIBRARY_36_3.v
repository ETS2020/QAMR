...
module FAU ( 
  ...
  aoi21  g85(.a(new_n96_), .b(new_n37_), .c(new_n27_), .O(new_n103_));
  oai21  g86(.a(new_n96_), .b(new_n37_), .c(new_n103_), .O(z6));
  oai21  g87(.a(new_n79_), .b(new_n26_), .c(new_n95_), .O(z7));
  nor2   g88(.a(new_n27_), .b(x3), .O(z8));
  aoi21  g89(.a(new_n21_), .b(new_n19_), .c(x6), .O(new_n107_));
  oai21  g90(.a(new_n107_), .b(new_n92_), .c(x5), .O(new_n108_));
  nor2   g91(.a(new_n108_), .b(new_n38_), .O(z9));
endmodule
