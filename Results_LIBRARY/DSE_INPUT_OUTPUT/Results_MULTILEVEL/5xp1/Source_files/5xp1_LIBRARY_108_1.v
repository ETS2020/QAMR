...
module FAU ( 
  ...
  aoi21  g77(.a(new_n94_), .b(new_n93_), .c(new_n26_), .O(z6));
  aoi21  g78(.a(new_n86_), .b(new_n85_), .c(new_n26_), .O(z7));
  nor2   g79(.a(new_n26_), .b(x3), .O(z8));
  aoi21  g80(.a(new_n22_), .b(new_n20_), .c(new_n51_), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(x6), .c(x5), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n27_), .O(z9));
endmodule
