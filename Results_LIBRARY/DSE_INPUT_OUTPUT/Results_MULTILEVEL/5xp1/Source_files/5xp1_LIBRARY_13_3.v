...
module FAU ( 
  ...
  aoi21  g66(.a(new_n51_), .b(new_n21_), .c(new_n30_), .O(new_n84_));
  inv1   g67(.a(x3), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n46_), .c(new_n57_), .O(new_n86_));
  nor2   g69(.a(new_n86_), .b(x6), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n84_), .c(x1), .O(new_n88_));
  nor2   g71(.a(x3), .b(x0), .O(new_n89_));
  nor3   g72(.a(new_n89_), .b(x6), .c(new_n46_), .O(new_n90_));
  nor2   g73(.a(new_n89_), .b(new_n46_), .O(new_n91_));
  nor2   g74(.a(new_n91_), .b(new_n30_), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n90_), .c(new_n20_), .O(new_n93_));
  nor2   g76(.a(new_n30_), .b(new_n18_), .O(new_n94_));
  inv1   g77(.a(new_n94_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n93_), .c(new_n88_), .O(z4));
  nand2  g79(.a(x3), .b(new_n46_), .O(new_n97_));
  nand2  g80(.a(new_n85_), .b(x2), .O(new_n98_));
  ...
  nand3  g86(.a(new_n103_), .b(new_n100_), .c(new_n95_), .O(z5));
  nand2  g87(.a(new_n97_), .b(x1), .O(new_n105_));
  nand3  g88(.a(x3), .b(new_n46_), .c(new_n20_), .O(new_n106_));
  nand3  g89(.a(new_n106_), .b(new_n105_), .c(new_n95_), .O(z6));
  nand3  g90(.a(new_n98_), .b(new_n97_), .c(new_n95_), .O(z7));
  nor2   g91(.a(new_n94_), .b(x3), .O(z8));
