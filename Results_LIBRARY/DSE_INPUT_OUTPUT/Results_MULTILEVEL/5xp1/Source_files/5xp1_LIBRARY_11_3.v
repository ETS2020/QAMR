...
module FAU ( 
  ...
  nand4  g58(.a(new_n18_), .b(new_n19_), .c(new_n40_), .d(x0), .O(new_n76_));
  ...
  nor2   g66(.a(new_n83_), .b(new_n21_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(x5), .O(new_n85_));
  nand3  g68(.a(new_n18_), .b(new_n40_), .c(new_n32_), .O(new_n86_));
  aoi21  g69(.a(new_n86_), .b(new_n85_), .c(new_n24_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n82_), .c(new_n19_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n79_), .O(z3));
  xor2a  g72(.a(x6), .b(x1), .O(new_n90_));
  oai22  g73(.a(new_n90_), .b(new_n24_), .c(new_n19_), .d(x1), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(x2), .O(new_n92_));
  nand3  g75(.a(new_n21_), .b(new_n19_), .c(x1), .O(new_n93_));
  oai21  g76(.a(new_n21_), .b(x1), .c(new_n93_), .O(new_n94_));
  oai21  g77(.a(new_n40_), .b(new_n24_), .c(new_n94_), .O(new_n95_));
  nand4  g78(.a(new_n21_), .b(new_n40_), .c(x1), .d(new_n24_), .O(new_n96_));
  nand4  g79(.a(new_n96_), .b(new_n95_), .c(new_n92_), .d(new_n48_), .O(z4));
  xnor2a g80(.a(x3), .b(x0), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(x2), .O(new_n99_));
  oai21  g82(.a(x2), .b(new_n32_), .c(new_n21_), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(x3), .c(new_n24_), .O(new_n101_));
  nand3  g84(.a(new_n21_), .b(x3), .c(x1), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n40_), .c(x0), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n101_), .c(new_n99_), .O(z5));
  oai21  g87(.a(new_n83_), .b(x6), .c(x3), .O(new_n105_));
  nand3  g88(.a(new_n21_), .b(x3), .c(new_n40_), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(x1), .O(new_n107_));
  nand2  g90(.a(new_n107_), .b(new_n105_), .O(z6));
  oai21  g91(.a(x3), .b(new_n40_), .c(new_n106_), .O(z7));
  nand2  g92(.a(new_n21_), .b(x3), .O(z8));
  nand2  g93(.a(x5), .b(x4), .O(new_n111_));
  oai21  g94(.a(new_n111_), .b(new_n25_), .c(new_n21_), .O(new_n112_));
  nand2  g95(.a(new_n112_), .b(x3), .O(new_n113_));
  nand2  g96(.a(new_n21_), .b(new_n24_), .O(new_n114_));
