...
module FAU ( 
  ...
  nand3  g67(.a(x6), .b(new_n84_), .c(new_n25_), .O(new_n85_));
  ...
  aoi21  g73(.a(new_n31_), .b(new_n84_), .c(new_n24_), .O(new_n91_));
  ...
  oai22  g79(.a(z8), .b(new_n95_), .c(x3), .d(new_n63_), .O(new_n97_));
  ...
  aoi21  g85(.a(new_n63_), .b(new_n25_), .c(new_n39_), .O(new_n103_));
  oai21  g86(.a(z8), .b(x2), .c(x1), .O(new_n104_));
  oai21  g87(.a(new_n103_), .b(new_n84_), .c(new_n104_), .O(z6));
  nand2  g88(.a(z8), .b(x2), .O(new_n106_));
  oai21  g89(.a(new_n84_), .b(x2), .c(new_n106_), .O(z7));
  oai21  g90(.a(x3), .b(new_n24_), .c(new_n39_), .O(new_n108_));
