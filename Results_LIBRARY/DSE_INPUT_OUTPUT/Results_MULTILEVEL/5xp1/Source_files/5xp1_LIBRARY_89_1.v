...
module FAU ( 
  ...
  nor2   g65(.a(new_n34_), .b(new_n39_), .O(new_n83_));
  nor2   g66(.a(new_n83_), .b(new_n18_), .O(new_n84_));
  nor2   g67(.a(x3), .b(new_n25_), .O(new_n85_));
  nor3   g68(.a(new_n85_), .b(x6), .c(x1), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n84_), .c(x0), .O(new_n87_));
  nor2   g70(.a(new_n26_), .b(x2), .O(new_n88_));
  nor2   g71(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  nand3  g72(.a(new_n20_), .b(new_n26_), .c(x2), .O(new_n90_));
  oai21  g73(.a(new_n89_), .b(new_n18_), .c(new_n90_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n21_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n87_), .O(z5));
  oai21  g76(.a(new_n88_), .b(x6), .c(new_n18_), .O(new_n94_));
  oai21  g77(.a(new_n88_), .b(new_n18_), .c(new_n94_), .O(z6));
  oai21  g78(.a(new_n20_), .b(x1), .c(new_n89_), .O(z7));
  oai21  g79(.a(new_n20_), .b(x1), .c(x3), .O(z8));
  nand2  g80(.a(new_n27_), .b(x1), .O(new_n98_));
  oai21  g81(.a(x6), .b(new_n21_), .c(new_n98_), .O(new_n99_));
