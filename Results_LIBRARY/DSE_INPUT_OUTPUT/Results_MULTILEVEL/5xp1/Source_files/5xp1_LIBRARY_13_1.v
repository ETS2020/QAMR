...
module FAU ( 
  ...
  oai21  g38(.a(x6), .b(new_n40_), .c(new_n55_), .O(new_n56_));
  ...
  aoi21  g60(.a(new_n49_), .b(new_n63_), .c(new_n21_), .O(new_n78_));
  inv1   g61(.a(x3), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n43_), .O(new_n80_));
  nand2  g63(.a(new_n63_), .b(new_n20_), .O(new_n81_));
  ...
  nor3   g67(.a(new_n84_), .b(x6), .c(new_n43_), .O(new_n85_));
  nor2   g68(.a(new_n84_), .b(new_n43_), .O(new_n86_));
  nor2   g69(.a(new_n86_), .b(new_n21_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n85_), .c(new_n40_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n83_), .c(new_n27_), .O(z4));
  nand2  g72(.a(x3), .b(new_n43_), .O(new_n90_));
  nand2  g73(.a(new_n79_), .b(x2), .O(new_n91_));
  oai21  g74(.a(new_n90_), .b(new_n40_), .c(new_n91_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n20_), .O(new_n93_));
  inv1   g76(.a(new_n63_), .O(new_n94_));
  aoi21  g77(.a(x3), .b(x1), .c(x2), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n94_), .c(x0), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n93_), .c(new_n27_), .O(z5));
  nand2  g80(.a(new_n90_), .b(x1), .O(new_n98_));
  nand3  g81(.a(x3), .b(new_n43_), .c(new_n40_), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(new_n98_), .c(new_n27_), .O(z6));
  nand3  g83(.a(new_n91_), .b(new_n90_), .c(new_n27_), .O(z7));
  nor2   g84(.a(new_n26_), .b(x3), .O(z8));
  aoi21  g85(.a(new_n22_), .b(new_n20_), .c(new_n29_), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(x6), .c(x5), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n27_), .O(z9));
endmodule
