...
module FAU ( 
  ...
  nand2  g67(.a(x6), .b(new_n18_), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n84_), .c(new_n79_), .O(z4));
  nand2  g69(.a(x3), .b(new_n26_), .O(new_n87_));
  nand2  g70(.a(new_n27_), .b(x2), .O(new_n88_));
  oai21  g71(.a(new_n87_), .b(new_n39_), .c(new_n88_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n19_), .O(new_n90_));
  inv1   g73(.a(new_n61_), .O(new_n91_));
  ...
  nand3  g78(.a(x3), .b(new_n26_), .c(new_n39_), .O(new_n96_));
