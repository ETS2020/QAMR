...
module FAU ( 
  ...
  aoi21  g10(.a(new_n27_), .b(new_n23_), .c(new_n19_), .O(new_n28_));
  ...
  nand3  g16(.a(new_n33_), .b(new_n31_), .c(new_n22_), .O(z0));
  ...
  aoi21  g22(.a(new_n39_), .b(x2), .c(new_n32_), .O(new_n40_));
  aoi22  g23(.a(new_n40_), .b(new_n23_), .c(new_n38_), .d(new_n32_), .O(new_n41_));
  nor2   g24(.a(new_n28_), .b(new_n32_), .O(new_n42_));
  nand2  g25(.a(new_n32_), .b(x0), .O(new_n43_));
  ...
  oai21  g42(.a(x3), .b(x1), .c(x5), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n26_), .c(new_n23_), .O(new_n61_));
  nand2  g44(.a(new_n60_), .b(new_n23_), .O(new_n62_));
  ...
  aoi21  g50(.a(new_n67_), .b(new_n43_), .c(x1), .O(new_n68_));
  ...
  oai21  g58(.a(new_n75_), .b(new_n68_), .c(new_n19_), .O(new_n76_));
  nand3  g59(.a(new_n32_), .b(x3), .c(new_n23_), .O(new_n77_));
  aoi22  g60(.a(new_n77_), .b(new_n48_), .c(new_n19_), .d(new_n47_), .O(new_n78_));
  nand3  g61(.a(x5), .b(new_n35_), .c(new_n47_), .O(new_n79_));
  nand3  g62(.a(x6), .b(new_n32_), .c(x1), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(new_n79_), .c(x0), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n78_), .c(x2), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n76_), .O(z3));
  xor2a  g66(.a(x6), .b(x1), .O(new_n84_));
  nor2   g67(.a(x3), .b(x0), .O(new_n85_));
  nand4  g68(.a(x6), .b(new_n35_), .c(new_n47_), .d(new_n23_), .O(new_n86_));
  oai21  g69(.a(new_n85_), .b(new_n84_), .c(new_n86_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(x2), .O(new_n88_));
  inv1   g71(.a(new_n73_), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(x0), .c(new_n36_), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n19_), .c(x1), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n88_), .O(z4));
  nand3  g75(.a(x3), .b(new_n18_), .c(x1), .O(new_n93_));
  oai21  g76(.a(x3), .b(new_n18_), .c(new_n93_), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n23_), .O(new_n95_));
  aoi21  g78(.a(x3), .b(x1), .c(x2), .O(new_n96_));
  oai21  g79(.a(new_n96_), .b(new_n89_), .c(x0), .O(new_n97_));
  nand2  g80(.a(x6), .b(new_n18_), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n97_), .c(new_n95_), .O(z5));
  aoi21  g82(.a(x3), .b(new_n47_), .c(x6), .O(new_n100_));
  nand3  g83(.a(new_n19_), .b(x3), .c(new_n18_), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(x1), .O(new_n102_));
  oai21  g85(.a(new_n100_), .b(x2), .c(new_n102_), .O(z6));
  oai21  g86(.a(x3), .b(new_n18_), .c(new_n101_), .O(z7));
  nand2  g87(.a(new_n98_), .b(x3), .O(z8));
  nand2  g88(.a(new_n20_), .b(x2), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(x6), .O(new_n107_));
  oai21  g90(.a(new_n73_), .b(new_n47_), .c(new_n23_), .O(new_n108_));
