...
module FAU ( 
  ...
  aoi22  g60(.a(new_n77_), .b(new_n56_), .c(new_n75_), .d(x6), .O(new_n78_));
  nor2   g61(.a(x3), .b(x0), .O(new_n79_));
  nor2   g62(.a(new_n79_), .b(x6), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n56_), .c(x2), .O(new_n81_));
  oai21  g64(.a(new_n79_), .b(new_n28_), .c(x6), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n20_), .O(new_n84_));
  oai21  g67(.a(new_n78_), .b(new_n20_), .c(new_n84_), .O(z4));
  ...
  nor2   g74(.a(x6), .b(new_n56_), .O(new_n92_));
  inv1   g75(.a(new_n92_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n91_), .c(new_n89_), .O(z5));
  nand2  g77(.a(new_n86_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n28_), .c(new_n20_), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n95_), .c(new_n93_), .O(z6));
  aoi21  g80(.a(new_n87_), .b(new_n86_), .c(new_n92_), .O(z7));
  nor2   g81(.a(new_n92_), .b(x3), .O(z8));
  aoi21  g82(.a(x6), .b(new_n18_), .c(new_n56_), .O(z9));
endmodule
