...
module FAU ( 
  ...
  nor2   g75(.a(x3), .b(new_n19_), .O(new_n93_));
  aoi21  g76(.a(new_n92_), .b(x1), .c(new_n93_), .O(new_n94_));
  nand2  g77(.a(new_n84_), .b(x6), .O(new_n95_));
  aoi21  g78(.a(x3), .b(x1), .c(x2), .O(new_n96_));
  aoi22  g79(.a(new_n96_), .b(x0), .c(new_n95_), .d(x2), .O(new_n97_));
  oai21  g80(.a(new_n94_), .b(x0), .c(new_n97_), .O(z5));
  aoi21  g81(.a(new_n92_), .b(new_n24_), .c(new_n39_), .O(new_n99_));
  oai21  g82(.a(new_n92_), .b(new_n24_), .c(new_n99_), .O(z6));
  oai21  g83(.a(new_n29_), .b(new_n77_), .c(x2), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(new_n91_), .O(z7));
  nor2   g85(.a(new_n39_), .b(x3), .O(z8));
