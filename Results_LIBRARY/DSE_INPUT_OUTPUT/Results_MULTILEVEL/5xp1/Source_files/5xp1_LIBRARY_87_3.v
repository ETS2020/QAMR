...
module FAU ( 
  ...
  aoi21  g35(.a(new_n51_), .b(new_n33_), .c(new_n52_), .O(new_n53_));
  ...
  aoi21  g46(.a(x5), .b(x0), .c(x2), .O(new_n64_));
  oai21  g47(.a(new_n64_), .b(new_n52_), .c(new_n18_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(x6), .c(new_n40_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(new_n60_), .O(z2));
  nand2  g51(.a(new_n23_), .b(new_n40_), .O(new_n69_));
  ...
  oai21  g55(.a(new_n23_), .b(new_n40_), .c(new_n20_), .O(new_n73_));
  aoi21  g56(.a(new_n73_), .b(new_n69_), .c(x0), .O(new_n74_));
  ...
  nand3  g61(.a(new_n23_), .b(new_n29_), .c(new_n34_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n78_), .c(new_n23_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x1), .O(new_n81_));
  nand2  g64(.a(x6), .b(x2), .O(new_n82_));
  nand4  g65(.a(new_n82_), .b(new_n29_), .c(new_n40_), .d(x0), .O(new_n83_));
  nand4  g66(.a(new_n83_), .b(new_n81_), .c(new_n77_), .d(new_n72_), .O(z3));
  aoi21  g67(.a(new_n35_), .b(new_n21_), .c(new_n40_), .O(new_n85_));
  ...
  nand3  g71(.a(new_n86_), .b(x6), .c(new_n40_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n88_), .O(z4));
  nand2  g73(.a(x3), .b(new_n33_), .O(new_n91_));
  nand2  g74(.a(new_n34_), .b(x2), .O(new_n92_));
  oai21  g75(.a(new_n91_), .b(new_n40_), .c(new_n92_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n19_), .O(new_n94_));
  nand2  g77(.a(new_n78_), .b(new_n40_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(x6), .O(new_n96_));
  inv1   g79(.a(new_n20_), .O(new_n97_));
  ...
  nand2  g86(.a(x6), .b(x1), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n92_), .c(new_n91_), .O(z7));
  aoi21  g88(.a(x6), .b(x1), .c(x3), .O(z8));
  nor2   g89(.a(new_n29_), .b(new_n18_), .O(new_n107_));
  aoi21  g90(.a(new_n107_), .b(new_n97_), .c(x6), .O(new_n108_));
  nand2  g91(.a(new_n23_), .b(new_n19_), .O(new_n109_));
  nand3  g92(.a(new_n109_), .b(x5), .c(x4), .O(new_n110_));
  oai21  g93(.a(new_n108_), .b(new_n40_), .c(new_n110_), .O(z9));
endmodule
