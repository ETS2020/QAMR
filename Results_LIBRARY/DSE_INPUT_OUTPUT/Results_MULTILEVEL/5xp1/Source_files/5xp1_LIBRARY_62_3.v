...
module FAU ( 
  ...
  nand3  g60(.a(new_n77_), .b(new_n25_), .c(new_n21_), .O(new_n78_));
  nand4  g61(.a(x6), .b(x3), .c(x1), .d(new_n18_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x2), .O(new_n81_));
  xor2a  g64(.a(x6), .b(x1), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n22_), .c(new_n18_), .O(new_n83_));
  nand4  g66(.a(new_n25_), .b(new_n35_), .c(new_n34_), .d(x1), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(new_n83_), .c(new_n81_), .O(z4));
  nand2  g68(.a(x3), .b(new_n34_), .O(new_n86_));
  nand2  g69(.a(new_n35_), .b(x2), .O(new_n87_));
  oai21  g70(.a(new_n86_), .b(new_n21_), .c(new_n87_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n18_), .O(new_n89_));
  oai21  g72(.a(new_n35_), .b(new_n21_), .c(new_n34_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n22_), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n25_), .c(x0), .O(new_n92_));
  ...
  nand3  g80(.a(new_n97_), .b(new_n95_), .c(new_n94_), .O(z6));
  aoi21  g81(.a(new_n87_), .b(new_n86_), .c(new_n96_), .O(z7));
  nand2  g82(.a(new_n97_), .b(x3), .O(z8));
  aoi21  g83(.a(x5), .b(x4), .c(x6), .O(new_n101_));
  nand2  g84(.a(new_n26_), .b(new_n25_), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(x5), .c(x4), .O(new_n103_));
  oai21  g86(.a(new_n101_), .b(new_n18_), .c(new_n103_), .O(z9));
endmodule
