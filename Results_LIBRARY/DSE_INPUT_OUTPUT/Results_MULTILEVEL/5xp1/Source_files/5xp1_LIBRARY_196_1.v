...
module FAU ( 
  ...
  aoi21  g61(.a(new_n24_), .b(new_n20_), .c(new_n19_), .O(new_n80_));
  nand2  g62(.a(new_n24_), .b(new_n23_), .O(new_n81_));
  aoi21  g63(.a(new_n81_), .b(new_n41_), .c(x6), .O(new_n82_));
  oai21  g64(.a(new_n82_), .b(new_n80_), .c(x1), .O(new_n83_));
  nand2  g65(.a(new_n40_), .b(new_n23_), .O(new_n84_));
  nand4  g66(.a(new_n84_), .b(new_n19_), .c(x2), .d(new_n65_), .O(new_n85_));
  nand2  g67(.a(new_n85_), .b(new_n83_), .O(z4));
  aoi21  g68(.a(new_n24_), .b(new_n41_), .c(new_n65_), .O(new_n87_));
  nor2   g69(.a(x3), .b(new_n39_), .O(new_n88_));
  nor3   g70(.a(new_n88_), .b(x6), .c(x1), .O(new_n89_));
  oai21  g71(.a(new_n89_), .b(new_n87_), .c(x0), .O(new_n90_));
  nor2   g72(.a(new_n40_), .b(x2), .O(new_n91_));
  nor2   g73(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nand3  g74(.a(new_n19_), .b(new_n40_), .c(x2), .O(new_n93_));
  oai21  g75(.a(new_n92_), .b(new_n65_), .c(new_n93_), .O(new_n94_));
  nand2  g76(.a(new_n94_), .b(new_n23_), .O(new_n95_));
  nand2  g77(.a(new_n95_), .b(new_n90_), .O(z5));
  nand4  g78(.a(new_n19_), .b(x3), .c(new_n39_), .d(new_n65_), .O(new_n97_));
  oai21  g79(.a(new_n91_), .b(new_n65_), .c(new_n97_), .O(z6));
  nor2   g80(.a(new_n92_), .b(new_n44_), .O(z7));
  nor2   g81(.a(new_n44_), .b(x3), .O(z8));
  oai21  g82(.a(new_n25_), .b(x6), .c(x1), .O(new_n101_));
  oai21  g83(.a(x6), .b(new_n23_), .c(new_n101_), .O(new_n102_));
  nand3  g84(.a(new_n102_), .b(x5), .c(x4), .O(new_n103_));
  inv1   g85(.a(new_n103_), .O(z9));
endmodule
