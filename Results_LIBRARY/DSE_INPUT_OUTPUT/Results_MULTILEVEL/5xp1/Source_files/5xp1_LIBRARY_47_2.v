...
module FAU ( 
  ...
  oai21  g66(.a(new_n82_), .b(new_n23_), .c(new_n83_), .O(new_n84_));
  ...
  nand2  g71(.a(new_n19_), .b(x4), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n88_), .c(new_n85_), .O(z5));
  nand2  g73(.a(new_n82_), .b(x1), .O(new_n91_));
  nand3  g74(.a(x3), .b(new_n58_), .c(new_n23_), .O(new_n92_));
  aoi22  g75(.a(new_n92_), .b(new_n91_), .c(new_n19_), .d(x4), .O(z6));
  nand3  g76(.a(new_n89_), .b(new_n83_), .c(new_n82_), .O(z7));
  nand2  g77(.a(new_n89_), .b(x3), .O(z8));
  aoi21  g78(.a(x6), .b(new_n18_), .c(new_n21_), .O(z9));
endmodule
