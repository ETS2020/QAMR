...
module FAU ( 
  ...
  nand2  g45(.a(new_n19_), .b(new_n29_), .O(new_n63_));
  nand4  g46(.a(new_n63_), .b(new_n62_), .c(new_n55_), .d(new_n49_), .O(z2));
  nand3  g47(.a(new_n29_), .b(x2), .c(new_n18_), .O(new_n65_));
  oai21  g48(.a(new_n51_), .b(new_n18_), .c(new_n65_), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(x3), .O(new_n67_));
  inv1   g50(.a(new_n25_), .O(new_n68_));
  ...
  oai21  g56(.a(new_n58_), .b(new_n18_), .c(new_n73_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(new_n23_), .O(new_n75_));
  oai21  g58(.a(new_n23_), .b(x0), .c(x6), .O(new_n76_));
  nor2   g59(.a(new_n35_), .b(x6), .O(new_n77_));
  aoi22  g60(.a(new_n77_), .b(new_n18_), .c(new_n76_), .d(new_n29_), .O(new_n78_));
  ...
  nand3  g73(.a(new_n90_), .b(new_n85_), .c(new_n63_), .O(z4));
  ...
  nand3  g80(.a(new_n97_), .b(new_n95_), .c(new_n63_), .O(z5));
  nand2  g81(.a(new_n92_), .b(x1), .O(new_n99_));
  nand3  g82(.a(x3), .b(new_n57_), .c(new_n23_), .O(new_n100_));
