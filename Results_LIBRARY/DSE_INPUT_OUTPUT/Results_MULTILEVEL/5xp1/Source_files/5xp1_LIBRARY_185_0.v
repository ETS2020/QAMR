...
module FAU ( 
  ...
  nor2   g62(.a(new_n20_), .b(x3), .O(z8));
  nand2  g63(.a(z8), .b(new_n34_), .O(new_n81_));
  aoi21  g64(.a(new_n81_), .b(new_n79_), .c(new_n29_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n76_), .c(new_n19_), .O(new_n83_));
  oai21  g66(.a(new_n30_), .b(new_n34_), .c(new_n36_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(x5), .O(new_n85_));
  nand2  g68(.a(new_n20_), .b(x3), .O(new_n86_));
  oai21  g69(.a(new_n20_), .b(x2), .c(new_n86_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n29_), .c(new_n34_), .O(new_n88_));
  ...
  aoi21  g75(.a(new_n92_), .b(new_n72_), .c(new_n20_), .O(new_n93_));
  inv1   g76(.a(x2), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n19_), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(x3), .c(x6), .O(new_n96_));
  oai21  g79(.a(new_n96_), .b(new_n93_), .c(x1), .O(new_n97_));
  aoi21  g80(.a(new_n20_), .b(x3), .c(x2), .O(new_n98_));
  oai22  g81(.a(x6), .b(new_n94_), .c(x3), .d(x0), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(new_n98_), .c(new_n34_), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n97_), .O(z4));
  nand2  g84(.a(x3), .b(new_n94_), .O(new_n102_));
  inv1   g85(.a(new_n102_), .O(new_n103_));
  aoi22  g86(.a(new_n103_), .b(x1), .c(z8), .d(x2), .O(new_n104_));
  aoi21  g87(.a(new_n94_), .b(x1), .c(new_n18_), .O(new_n105_));
  nand2  g88(.a(z8), .b(new_n94_), .O(new_n106_));
  inv1   g89(.a(new_n106_), .O(new_n107_));
  oai21  g90(.a(new_n107_), .b(new_n105_), .c(x0), .O(new_n108_));
  oai21  g91(.a(new_n104_), .b(x0), .c(new_n108_), .O(z5));
  aoi21  g92(.a(new_n103_), .b(new_n34_), .c(new_n30_), .O(new_n110_));
  oai21  g93(.a(new_n103_), .b(new_n34_), .c(new_n110_), .O(z6));
  nand2  g94(.a(new_n18_), .b(x2), .O(new_n112_));
  oai21  g95(.a(z8), .b(x2), .c(new_n112_), .O(z7));
