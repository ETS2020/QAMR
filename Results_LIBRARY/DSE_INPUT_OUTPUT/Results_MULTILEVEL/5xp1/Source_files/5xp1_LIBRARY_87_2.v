...
module FAU ( 
  ...
  nor2   g31(.a(new_n20_), .b(new_n23_), .O(new_n49_));
  ...
  inv1   g36(.a(new_n49_), .O(new_n54_));
  ...
  nand2  g57(.a(x3), .b(new_n74_), .O(new_n75_));
  nand2  g58(.a(new_n67_), .b(x2), .O(new_n76_));
  oai21  g59(.a(new_n75_), .b(new_n19_), .c(new_n76_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n23_), .O(new_n78_));
  oai21  g61(.a(x2), .b(new_n23_), .c(new_n19_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n28_), .O(new_n80_));
  oai21  g63(.a(new_n71_), .b(x2), .c(new_n24_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(x0), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n80_), .c(new_n78_), .O(z5));
  nand2  g66(.a(x6), .b(x3), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(x2), .c(x1), .O(new_n85_));
  oai21  g68(.a(new_n75_), .b(x1), .c(new_n85_), .O(z6));
  nand3  g69(.a(new_n76_), .b(new_n75_), .c(new_n36_), .O(z7));
  aoi21  g70(.a(new_n28_), .b(x1), .c(x3), .O(z8));
  oai21  g71(.a(new_n21_), .b(new_n18_), .c(new_n36_), .O(z9));
endmodule
