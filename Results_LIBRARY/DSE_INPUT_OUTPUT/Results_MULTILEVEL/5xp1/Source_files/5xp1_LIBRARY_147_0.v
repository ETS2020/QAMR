...
module FAU ( 
  ...
  aoi21  g63(.a(new_n80_), .b(new_n27_), .c(new_n23_), .O(new_n81_));
  inv1   g64(.a(new_n57_), .O(new_n82_));
  ...
  nand2  g70(.a(new_n84_), .b(new_n22_), .O(new_n88_));
  nand4  g71(.a(new_n88_), .b(new_n23_), .c(x5), .d(x2), .O(new_n89_));
  inv1   g72(.a(new_n89_), .O(new_n90_));
  aoi21  g73(.a(new_n88_), .b(x2), .c(new_n23_), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n90_), .c(new_n26_), .O(new_n92_));
  oai21  g75(.a(new_n87_), .b(new_n26_), .c(new_n92_), .O(z4));
  nor2   g76(.a(x6), .b(x5), .O(new_n94_));
  nand2  g77(.a(x3), .b(new_n83_), .O(new_n95_));
  nand2  g78(.a(new_n84_), .b(x2), .O(new_n96_));
  oai21  g79(.a(new_n95_), .b(new_n26_), .c(new_n96_), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n22_), .O(new_n98_));
  aoi21  g81(.a(x3), .b(x1), .c(x2), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(new_n34_), .c(x0), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(new_n98_), .c(new_n94_), .O(z5));
  inv1   g84(.a(new_n94_), .O(new_n102_));
  nand2  g85(.a(new_n95_), .b(x1), .O(new_n103_));
  nand3  g86(.a(x3), .b(new_n83_), .c(new_n26_), .O(new_n104_));
