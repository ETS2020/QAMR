...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n106_, new_n107_, new_n109_, new_n110_, new_n114_;
  ...
  nand2  g69(.a(new_n45_), .b(new_n21_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(x6), .c(new_n18_), .O(new_n88_));
  nor2   g71(.a(x3), .b(x2), .O(new_n89_));
  aoi21  g72(.a(x3), .b(x2), .c(x0), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n89_), .c(new_n30_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(x1), .O(new_n93_));
  nand2  g76(.a(new_n60_), .b(new_n19_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n30_), .c(x2), .O(new_n95_));
  ...
  nand2  g81(.a(new_n98_), .b(new_n20_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n93_), .O(z4));
  inv1   g83(.a(new_n63_), .O(new_n101_));
  nand2  g84(.a(x3), .b(new_n58_), .O(new_n102_));
  nand2  g85(.a(new_n60_), .b(x2), .O(new_n103_));
  oai21  g86(.a(new_n102_), .b(new_n20_), .c(new_n103_), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n19_), .O(new_n105_));
  aoi21  g88(.a(x3), .b(x1), .c(x2), .O(new_n106_));
  oai21  g89(.a(new_n106_), .b(new_n52_), .c(x0), .O(new_n107_));
  nand3  g90(.a(new_n107_), .b(new_n105_), .c(new_n101_), .O(z5));
  nand2  g91(.a(new_n102_), .b(x1), .O(new_n109_));
  nand3  g92(.a(x3), .b(new_n58_), .c(new_n20_), .O(new_n110_));
  nand3  g93(.a(new_n110_), .b(new_n109_), .c(new_n101_), .O(z6));
  aoi21  g94(.a(new_n103_), .b(new_n102_), .c(new_n63_), .O(z7));
  nand2  g95(.a(new_n101_), .b(x3), .O(z8));
  nand2  g96(.a(new_n22_), .b(x5), .O(new_n114_));
  aoi21  g97(.a(new_n114_), .b(new_n30_), .c(new_n18_), .O(z9));
endmodule
