...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n86_, new_n88_, new_n89_, new_n91_, new_n94_, new_n95_;
  ...
  oai21  g18(.a(new_n23_), .b(new_n35_), .c(new_n24_), .O(new_n36_));
  nand2  g19(.a(x3), .b(x2), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n23_), .c(new_n35_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n36_), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(x5), .c(new_n29_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n34_), .O(z1));
  nand2  g24(.a(new_n18_), .b(new_n35_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(x1), .O(new_n43_));
  nor2   g26(.a(x5), .b(x2), .O(new_n44_));
  nand3  g27(.a(x5), .b(x3), .c(x2), .O(new_n45_));
  oai21  g28(.a(new_n44_), .b(new_n35_), .c(new_n45_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(x6), .O(new_n47_));
  oai21  g30(.a(new_n18_), .b(new_n35_), .c(new_n24_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n47_), .c(new_n43_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x4), .O(new_n50_));
  oai21  g33(.a(new_n44_), .b(new_n25_), .c(new_n29_), .O(new_n51_));
  ...
  nand2  g38(.a(new_n24_), .b(x1), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n55_), .c(new_n50_), .O(z2));
  nand3  g40(.a(new_n31_), .b(x5), .c(x0), .O(new_n58_));
  nand2  g41(.a(new_n37_), .b(new_n29_), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(new_n18_), .c(new_n35_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(x6), .O(new_n62_));
  nor2   g45(.a(new_n24_), .b(new_n30_), .O(new_n63_));
  xnor2a g46(.a(x5), .b(x0), .O(new_n64_));
  inv1   g47(.a(x3), .O(new_n65_));
  nand3  g48(.a(x5), .b(new_n65_), .c(new_n35_), .O(new_n66_));
  ...
  nand2  g52(.a(new_n65_), .b(new_n35_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(x2), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(x6), .c(new_n29_), .O(new_n72_));
  nand2  g55(.a(new_n65_), .b(new_n30_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(x0), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(new_n37_), .c(x6), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(x1), .O(new_n76_));
  nand3  g59(.a(new_n70_), .b(new_n24_), .c(x2), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n76_), .c(new_n72_), .O(z4));
  nand3  g61(.a(new_n56_), .b(new_n65_), .c(x2), .O(new_n79_));
  nand2  g62(.a(new_n30_), .b(x1), .O(new_n80_));
  nand2  g63(.a(x6), .b(x3), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n35_), .O(new_n83_));
  aoi21  g66(.a(new_n65_), .b(x2), .c(x1), .O(new_n84_));
  aoi21  g67(.a(new_n73_), .b(new_n37_), .c(new_n24_), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n84_), .c(x0), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n83_), .O(z5));
  oai21  g70(.a(new_n81_), .b(x2), .c(x1), .O(new_n88_));
  nand2  g71(.a(x3), .b(new_n30_), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(x1), .c(new_n88_), .O(z6));
  nand2  g73(.a(new_n65_), .b(x2), .O(new_n91_));
  nand3  g74(.a(new_n89_), .b(new_n91_), .c(new_n56_), .O(z7));
  nand2  g75(.a(new_n56_), .b(x3), .O(z8));
  oai21  g76(.a(x1), .b(new_n35_), .c(new_n24_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(x5), .c(x4), .O(new_n95_));
