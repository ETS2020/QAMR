...
module FAU ( 
  ...
  nand3  g75(.a(new_n92_), .b(new_n91_), .c(new_n27_), .O(z6));
  aoi21  g76(.a(new_n84_), .b(new_n83_), .c(new_n26_), .O(z7));
  nor2   g77(.a(new_n26_), .b(x3), .O(z8));
  nand2  g78(.a(new_n57_), .b(x4), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n25_), .c(new_n20_), .O(z9));
endmodule
