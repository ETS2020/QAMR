...
module FAU ( 
  ...
  nand2  g55(.a(new_n40_), .b(new_n24_), .O(new_n73_));
  nand2  g56(.a(new_n24_), .b(new_n22_), .O(new_n74_));
  aoi21  g57(.a(new_n39_), .b(new_n74_), .c(x6), .O(new_n75_));
  aoi22  g58(.a(new_n75_), .b(new_n21_), .c(new_n73_), .d(x6), .O(new_n76_));
  ...
  oai21  g65(.a(new_n76_), .b(new_n23_), .c(new_n82_), .O(z4));
