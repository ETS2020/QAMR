...
module FAU ( 
  ...
  nand3  g32(.a(new_n23_), .b(x4), .c(new_n38_), .O(new_n50_));
  ...
  aoi21  g37(.a(new_n54_), .b(new_n53_), .c(new_n23_), .O(new_n55_));
  ...
  nand3  g44(.a(new_n58_), .b(x6), .c(new_n19_), .O(new_n62_));
  nor2   g45(.a(x3), .b(x2), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n19_), .c(new_n54_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(x1), .O(new_n65_));
  nand2  g48(.a(new_n45_), .b(x0), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n65_), .c(new_n62_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(new_n18_), .O(new_n68_));
  nand4  g51(.a(new_n68_), .b(new_n61_), .c(new_n52_), .d(new_n30_), .O(z2));
  xor2a  g52(.a(x6), .b(x1), .O(new_n70_));
  nand3  g53(.a(new_n28_), .b(x3), .c(new_n19_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(new_n48_), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(new_n70_), .c(x2), .O(new_n73_));
  nand2  g56(.a(new_n30_), .b(new_n20_), .O(new_n74_));
  nand2  g57(.a(new_n23_), .b(new_n38_), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(new_n74_), .c(x0), .O(new_n76_));
  nor2   g59(.a(x6), .b(new_n33_), .O(new_n77_));
  ...
  nand3  g64(.a(new_n23_), .b(new_n33_), .c(new_n32_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n28_), .c(x0), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(new_n80_), .c(new_n73_), .O(z3));
  nor2   g68(.a(x3), .b(x0), .O(new_n86_));
  nor2   g69(.a(new_n86_), .b(x6), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(x2), .c(new_n38_), .O(new_n88_));
  nand3  g71(.a(new_n34_), .b(new_n21_), .c(new_n23_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(x1), .O(new_n90_));
  oai21  g73(.a(new_n86_), .b(new_n32_), .c(x6), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n90_), .c(new_n88_), .O(z4));
  nand3  g75(.a(new_n30_), .b(new_n33_), .c(x2), .O(new_n93_));
  nand3  g76(.a(new_n77_), .b(new_n32_), .c(x1), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n19_), .O(new_n96_));
  nand2  g79(.a(new_n33_), .b(x2), .O(new_n97_));
  nand2  g80(.a(new_n34_), .b(new_n20_), .O(new_n98_));
  aoi22  g81(.a(new_n98_), .b(new_n23_), .c(new_n97_), .d(new_n38_), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(new_n19_), .c(new_n96_), .O(z5));
  nand2  g83(.a(new_n77_), .b(new_n32_), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(x1), .O(new_n102_));
  nand2  g85(.a(x3), .b(new_n32_), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(x1), .c(new_n102_), .O(z6));
  nand3  g87(.a(new_n103_), .b(new_n97_), .c(new_n30_), .O(z7));
  nand2  g88(.a(new_n30_), .b(x3), .O(z8));
  nor2   g89(.a(new_n23_), .b(x1), .O(new_n107_));
  aoi21  g90(.a(new_n24_), .b(new_n19_), .c(x6), .O(new_n108_));
  oai21  g91(.a(new_n108_), .b(new_n107_), .c(x5), .O(new_n109_));
  nor2   g92(.a(new_n109_), .b(new_n18_), .O(z9));
endmodule
