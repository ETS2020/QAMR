...
module FAU ( 
  ...
  nand3  g32(.a(new_n49_), .b(new_n18_), .c(new_n19_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n44_), .O(z2));
  nand2  g34(.a(new_n18_), .b(new_n21_), .O(new_n52_));
  ...
  nand3  g39(.a(x6), .b(new_n25_), .c(new_n20_), .O(new_n57_));
  ...
  nand4  g50(.a(new_n25_), .b(new_n63_), .c(new_n60_), .d(x0), .O(new_n68_));
  ...
  aoi21  g54(.a(new_n45_), .b(new_n22_), .c(new_n18_), .O(new_n72_));
  inv1   g55(.a(new_n41_), .O(new_n73_));
  nand2  g56(.a(new_n63_), .b(new_n60_), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n73_), .c(x6), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(new_n19_), .c(new_n72_), .O(new_n76_));
  nand2  g59(.a(new_n63_), .b(new_n20_), .O(new_n77_));
  nand4  g60(.a(new_n77_), .b(new_n18_), .c(new_n19_), .d(x2), .O(new_n78_));
  inv1   g61(.a(new_n78_), .O(new_n79_));
  aoi21  g62(.a(new_n77_), .b(x2), .c(new_n18_), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n79_), .c(new_n21_), .O(new_n81_));
  oai21  g64(.a(new_n76_), .b(new_n21_), .c(new_n81_), .O(z4));
  nor2   g65(.a(x6), .b(new_n19_), .O(new_n83_));
  nand2  g66(.a(x3), .b(new_n60_), .O(new_n84_));
  ...
  aoi21  g73(.a(new_n90_), .b(new_n87_), .c(new_n83_), .O(z5));
  inv1   g74(.a(new_n83_), .O(new_n92_));
  nand2  g75(.a(new_n84_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n60_), .c(new_n21_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(z6));
  nand3  g78(.a(new_n85_), .b(new_n84_), .c(new_n92_), .O(z7));
