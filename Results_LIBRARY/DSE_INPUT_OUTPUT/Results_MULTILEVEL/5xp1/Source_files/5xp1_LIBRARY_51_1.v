...
module FAU ( 
  ...
  nand4  g76(.a(new_n20_), .b(x3), .c(new_n25_), .d(new_n18_), .O(new_n94_));
  oai21  g77(.a(new_n88_), .b(new_n18_), .c(new_n94_), .O(z6));
  oai21  g78(.a(new_n20_), .b(x1), .c(new_n89_), .O(z7));
  aoi21  g79(.a(x6), .b(new_n18_), .c(x3), .O(z8));
  aoi21  g80(.a(x5), .b(x4), .c(new_n18_), .O(new_n98_));
  nand2  g81(.a(new_n40_), .b(new_n21_), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(x5), .c(x4), .O(new_n100_));
  oai21  g83(.a(new_n98_), .b(new_n20_), .c(new_n100_), .O(z9));
endmodule
