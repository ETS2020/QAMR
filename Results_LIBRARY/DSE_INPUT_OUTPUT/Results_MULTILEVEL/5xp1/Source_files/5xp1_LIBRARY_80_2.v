...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n93_, new_n95_, new_n96_, new_n100_, new_n101_, new_n102_;
  ...
  nand2  g18(.a(new_n25_), .b(new_n26_), .O(new_n36_));
  nand2  g19(.a(new_n20_), .b(x4), .O(new_n37_));
  ...
  oai21  g23(.a(new_n40_), .b(x0), .c(new_n34_), .O(z1));
  nand2  g24(.a(x6), .b(x4), .O(new_n42_));
  nor2   g25(.a(x6), .b(x4), .O(new_n43_));
  nand4  g26(.a(new_n43_), .b(x3), .c(x2), .d(new_n18_), .O(new_n44_));
  aoi21  g27(.a(new_n44_), .b(new_n42_), .c(new_n26_), .O(new_n45_));
  aoi21  g28(.a(x3), .b(x2), .c(x0), .O(new_n46_));
  nor3   g29(.a(new_n46_), .b(new_n20_), .c(new_n25_), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(new_n45_), .c(x5), .O(new_n48_));
  inv1   g31(.a(x2), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n26_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(x6), .c(x0), .O(new_n51_));
  nand4  g34(.a(x5), .b(x3), .c(x2), .d(x1), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n20_), .c(new_n18_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(x4), .O(new_n55_));
  nor2   g38(.a(x5), .b(x2), .O(new_n56_));
  oai21  g39(.a(new_n56_), .b(new_n46_), .c(new_n26_), .O(new_n57_));
  oai21  g40(.a(x5), .b(x0), .c(new_n57_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(x6), .c(new_n25_), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(new_n55_), .c(new_n48_), .O(z2));
  nand2  g43(.a(new_n27_), .b(new_n20_), .O(new_n61_));
  nand3  g44(.a(x6), .b(x3), .c(x2), .O(new_n62_));
  inv1   g45(.a(new_n62_), .O(new_n63_));
  aoi21  g46(.a(new_n61_), .b(x1), .c(new_n63_), .O(new_n64_));
  nand3  g47(.a(new_n27_), .b(x5), .c(new_n26_), .O(new_n65_));
  oai21  g48(.a(new_n64_), .b(x5), .c(new_n65_), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n18_), .O(new_n67_));
  nand3  g50(.a(new_n31_), .b(new_n49_), .c(x0), .O(new_n68_));
  nand2  g51(.a(new_n20_), .b(x5), .O(new_n69_));
  aoi21  g52(.a(new_n69_), .b(new_n68_), .c(x1), .O(new_n70_));
  aoi21  g53(.a(new_n61_), .b(new_n32_), .c(new_n31_), .O(new_n71_));
  nor3   g54(.a(new_n71_), .b(new_n70_), .c(new_n19_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n67_), .O(z3));
  inv1   g56(.a(new_n19_), .O(new_n74_));
  xor2a  g57(.a(x6), .b(x1), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(new_n49_), .O(new_n76_));
  inv1   g59(.a(x3), .O(new_n77_));
  nand3  g60(.a(x6), .b(new_n77_), .c(new_n18_), .O(new_n78_));
  nand3  g61(.a(new_n20_), .b(x3), .c(x2), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n26_), .O(new_n81_));
  oai21  g64(.a(x3), .b(x2), .c(x0), .O(new_n82_));
  nand2  g65(.a(new_n20_), .b(new_n77_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n82_), .c(new_n62_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(x1), .O(new_n85_));
  nand4  g68(.a(new_n85_), .b(new_n81_), .c(new_n76_), .d(new_n74_), .O(z4));
  nand2  g69(.a(x3), .b(new_n49_), .O(new_n87_));
  nand2  g70(.a(new_n77_), .b(x2), .O(new_n88_));
  ...
  nand2  g74(.a(new_n27_), .b(x6), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n91_), .c(x0), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n90_), .O(z5));
  nand2  g77(.a(new_n87_), .b(x1), .O(new_n95_));
  nand3  g78(.a(x3), .b(new_n49_), .c(new_n26_), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n95_), .c(new_n19_), .O(z6));
  nand3  g80(.a(new_n88_), .b(new_n87_), .c(new_n74_), .O(z7));
  nand2  g81(.a(new_n74_), .b(x3), .O(z8));
  nand2  g82(.a(x1), .b(new_n18_), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(new_n27_), .c(new_n20_), .O(new_n101_));
