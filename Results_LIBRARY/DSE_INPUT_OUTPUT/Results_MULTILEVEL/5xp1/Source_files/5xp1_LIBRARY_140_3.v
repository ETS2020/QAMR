...
module FAU ( 
  ...
  aoi21  g34(.a(new_n50_), .b(new_n39_), .c(new_n51_), .O(new_n52_));
  aoi21  g35(.a(new_n52_), .b(new_n49_), .c(new_n32_), .O(new_n53_));
  ...
  nor3   g43(.a(x5), .b(x2), .c(x1), .O(new_n61_));
  oai21  g44(.a(new_n61_), .b(new_n60_), .c(new_n32_), .O(new_n62_));
  ...
  nand2  g49(.a(new_n66_), .b(new_n62_), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(x6), .c(new_n26_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(new_n59_), .O(z2));
  xor2a  g52(.a(x5), .b(x0), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(new_n31_), .O(new_n71_));
  oai21  g54(.a(x3), .b(x2), .c(x5), .O(new_n72_));
  nor2   g55(.a(new_n72_), .b(new_n19_), .O(new_n73_));
  nand4  g56(.a(new_n25_), .b(x3), .c(x2), .d(new_n19_), .O(new_n74_));
  inv1   g57(.a(new_n74_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n73_), .c(x1), .O(new_n76_));
  nand3  g59(.a(new_n34_), .b(x5), .c(new_n19_), .O(new_n77_));
  nand4  g60(.a(new_n25_), .b(new_n26_), .c(new_n39_), .d(x0), .O(new_n78_));
  and2   g61(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n76_), .c(new_n71_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n20_), .O(new_n81_));
  nand2  g64(.a(x5), .b(new_n31_), .O(new_n82_));
  nand3  g65(.a(x6), .b(new_n25_), .c(x1), .O(new_n83_));
  aoi21  g66(.a(new_n83_), .b(new_n82_), .c(x0), .O(new_n84_));
  inv1   g67(.a(new_n61_), .O(new_n85_));
  nand2  g68(.a(new_n39_), .b(new_n31_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(x6), .c(x5), .O(new_n87_));
  aoi21  g70(.a(new_n87_), .b(new_n85_), .c(new_n19_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n84_), .c(new_n26_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n81_), .O(z3));
  xor2a  g73(.a(x6), .b(x1), .O(new_n91_));
  oai22  g74(.a(new_n91_), .b(new_n19_), .c(new_n26_), .d(x1), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(x2), .O(new_n93_));
  nand3  g76(.a(new_n20_), .b(new_n26_), .c(x1), .O(new_n94_));
  oai21  g77(.a(new_n20_), .b(x1), .c(new_n94_), .O(new_n95_));
  oai21  g78(.a(new_n39_), .b(new_n19_), .c(new_n95_), .O(new_n96_));
  nand4  g79(.a(new_n20_), .b(new_n39_), .c(x1), .d(new_n19_), .O(new_n97_));
  nand4  g80(.a(new_n97_), .b(new_n96_), .c(new_n93_), .d(new_n30_), .O(z4));
  ...
  nand3  g85(.a(new_n20_), .b(x3), .c(x1), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n39_), .c(x0), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n102_), .c(new_n100_), .O(z5));
  nand2  g88(.a(new_n20_), .b(x3), .O(z8));
  aoi21  g89(.a(new_n20_), .b(x2), .c(new_n26_), .O(new_n107_));
  oai22  g90(.a(new_n107_), .b(new_n31_), .c(z8), .d(new_n86_), .O(z6));
  nand2  g91(.a(new_n26_), .b(x2), .O(new_n109_));
  oai21  g92(.a(z8), .b(x2), .c(new_n109_), .O(z7));
  nand4  g93(.a(x5), .b(x4), .c(x2), .d(x1), .O(new_n111_));
