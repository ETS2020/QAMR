...
module FAU ( 
  ...
  nor2   g47(.a(new_n64_), .b(new_n46_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x0), .O(new_n66_));
  nand3  g49(.a(new_n46_), .b(x3), .c(x2), .O(new_n67_));
  ...
  aoi21  g56(.a(new_n73_), .b(new_n46_), .c(new_n20_), .O(new_n74_));
  aoi21  g57(.a(new_n70_), .b(x1), .c(new_n74_), .O(new_n75_));
  nand4  g58(.a(new_n75_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(z3));
  nand2  g59(.a(new_n40_), .b(new_n71_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(x6), .c(new_n46_), .O(new_n78_));
  aoi21  g61(.a(new_n71_), .b(new_n19_), .c(new_n64_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(x6), .c(new_n78_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x1), .O(new_n81_));
  nand2  g64(.a(new_n53_), .b(new_n19_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n20_), .c(x2), .O(new_n83_));
  nand2  g66(.a(new_n82_), .b(x2), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(x6), .c(new_n46_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n24_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n81_), .O(z4));
  nor2   g71(.a(new_n20_), .b(new_n46_), .O(new_n89_));
  nand2  g72(.a(x3), .b(new_n25_), .O(new_n90_));
  nand2  g73(.a(new_n53_), .b(x2), .O(new_n91_));
  ...
  oai21  g77(.a(new_n94_), .b(new_n72_), .c(x0), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n93_), .c(new_n89_), .O(z5));
  inv1   g79(.a(new_n89_), .O(new_n97_));
  nand2  g80(.a(new_n90_), .b(x1), .O(new_n98_));
  nand3  g81(.a(x3), .b(new_n25_), .c(new_n24_), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(new_n98_), .c(new_n97_), .O(z6));
  aoi21  g83(.a(new_n91_), .b(new_n90_), .c(new_n89_), .O(z7));
  nor2   g84(.a(new_n89_), .b(x3), .O(z8));
  oai21  g85(.a(new_n30_), .b(x0), .c(x4), .O(new_n103_));
  aoi21  g86(.a(new_n103_), .b(new_n20_), .c(new_n46_), .O(z9));
endmodule
