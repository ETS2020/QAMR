...
module FAU ( 
  ...
  nor2   g84(.a(z8), .b(x2), .O(new_n102_));
  oai22  g85(.a(new_n102_), .b(new_n24_), .c(new_n100_), .d(new_n19_), .O(z6));
  inv1   g86(.a(new_n102_), .O(new_n104_));
  oai21  g87(.a(x3), .b(new_n62_), .c(new_n104_), .O(z7));
