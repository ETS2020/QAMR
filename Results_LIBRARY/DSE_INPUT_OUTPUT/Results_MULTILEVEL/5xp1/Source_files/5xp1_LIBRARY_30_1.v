...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n113_, new_n115_, new_n117_, new_n119_, new_n120_;
  ...
  aoi21  g007(.a(x2), .b(x1), .c(x6), .O(new_n25_));
  nand3  g008(.a(new_n25_), .b(x4), .c(new_n21_), .O(new_n26_));
  ...
  nand2  g082(.a(new_n39_), .b(new_n21_), .O(new_n100_));
  ...
  nand3  g088(.a(new_n105_), .b(x3), .c(new_n56_), .O(new_n106_));
  nand3  g089(.a(new_n106_), .b(new_n104_), .c(new_n98_), .O(z4));
  nor2   g090(.a(new_n18_), .b(x2), .O(new_n108_));
  nor2   g091(.a(x6), .b(x3), .O(z8));
  aoi22  g092(.a(z8), .b(x2), .c(new_n108_), .d(x1), .O(new_n110_));
  aoi21  g093(.a(new_n35_), .b(x1), .c(new_n18_), .O(new_n111_));
  nor3   g094(.a(x6), .b(x3), .c(x2), .O(new_n112_));
  oai21  g095(.a(new_n112_), .b(new_n111_), .c(x0), .O(new_n113_));
  oai21  g096(.a(new_n110_), .b(x0), .c(new_n113_), .O(z5));
  aoi22  g097(.a(new_n108_), .b(new_n56_), .c(x6), .d(new_n18_), .O(new_n115_));
  oai21  g098(.a(new_n108_), .b(new_n56_), .c(new_n115_), .O(z6));
  nand2  g099(.a(z8), .b(x2), .O(new_n117_));
  oai21  g100(.a(new_n18_), .b(x2), .c(new_n117_), .O(z7));
  oai22  g101(.a(new_n25_), .b(new_n18_), .c(x6), .d(new_n21_), .O(new_n119_));
