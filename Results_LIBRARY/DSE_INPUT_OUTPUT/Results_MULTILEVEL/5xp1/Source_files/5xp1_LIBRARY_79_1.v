...
module FAU ( 
  ...
  nor2   g55(.a(new_n19_), .b(new_n32_), .O(new_n73_));
  oai21  g56(.a(new_n73_), .b(new_n72_), .c(x0), .O(new_n74_));
  nand2  g57(.a(x6), .b(new_n23_), .O(new_n75_));
  nand2  g58(.a(new_n19_), .b(x5), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n75_), .c(new_n40_), .O(new_n77_));
  nand3  g60(.a(new_n19_), .b(x5), .c(new_n23_), .O(new_n78_));
  inv1   g61(.a(new_n78_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n77_), .c(new_n18_), .O(new_n80_));
  nand2  g63(.a(x6), .b(new_n29_), .O(new_n81_));
  nand4  g64(.a(new_n81_), .b(new_n80_), .c(new_n74_), .d(new_n71_), .O(z3));
  aoi21  g65(.a(new_n44_), .b(new_n24_), .c(new_n19_), .O(new_n83_));
  nand2  g66(.a(new_n24_), .b(new_n18_), .O(new_n84_));
  aoi21  g67(.a(new_n84_), .b(new_n34_), .c(x6), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n83_), .c(x1), .O(new_n86_));
  nor2   g69(.a(x3), .b(x0), .O(new_n87_));
  nor3   g70(.a(new_n87_), .b(x6), .c(new_n32_), .O(new_n88_));
  nor2   g71(.a(new_n87_), .b(new_n32_), .O(new_n89_));
  ...
  nand3  g83(.a(x3), .b(new_n32_), .c(new_n23_), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n100_), .c(new_n81_), .O(z6));
  nand3  g85(.a(new_n94_), .b(new_n93_), .c(new_n81_), .O(z7));
  nand2  g86(.a(new_n81_), .b(x3), .O(z8));
  nand3  g87(.a(new_n20_), .b(new_n19_), .c(new_n18_), .O(new_n105_));
