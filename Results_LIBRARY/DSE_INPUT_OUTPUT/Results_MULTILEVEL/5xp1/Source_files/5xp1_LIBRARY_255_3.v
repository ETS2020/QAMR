...
module FAU ( 
  ...
  oai21  g77(.a(new_n93_), .b(new_n39_), .c(new_n94_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n19_), .O(new_n96_));
  oai21  g79(.a(x2), .b(new_n19_), .c(new_n39_), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(x6), .O(new_n98_));
  inv1   g81(.a(new_n20_), .O(new_n99_));
  ...
  nand3  g85(.a(new_n93_), .b(new_n23_), .c(x1), .O(new_n103_));
  oai21  g86(.a(new_n93_), .b(x1), .c(new_n103_), .O(z6));
  aoi21  g87(.a(new_n94_), .b(new_n93_), .c(new_n30_), .O(z7));
  nand2  g88(.a(new_n29_), .b(x3), .O(z8));
  nor2   g89(.a(new_n28_), .b(new_n18_), .O(new_n107_));
  aoi21  g90(.a(new_n107_), .b(new_n99_), .c(x6), .O(new_n108_));
  nand2  g91(.a(new_n23_), .b(new_n19_), .O(new_n109_));
  nand3  g92(.a(new_n109_), .b(x5), .c(x4), .O(new_n110_));
  oai21  g93(.a(new_n108_), .b(new_n39_), .c(new_n110_), .O(z9));
endmodule
