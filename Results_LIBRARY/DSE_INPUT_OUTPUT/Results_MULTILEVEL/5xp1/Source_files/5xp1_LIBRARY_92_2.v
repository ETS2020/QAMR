...
module FAU ( 
  ...
  oai21  g83(.a(new_n91_), .b(new_n39_), .c(x3), .O(new_n101_));
  nand3  g84(.a(x6), .b(x3), .c(new_n63_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(x1), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(new_n101_), .O(z6));
  oai21  g87(.a(x3), .b(new_n63_), .c(new_n102_), .O(z7));
  oai21  g88(.a(x3), .b(new_n24_), .c(new_n39_), .O(new_n106_));
