...
module FAU ( 
  ...
  nand4  g79(.a(new_n20_), .b(x3), .c(new_n39_), .d(x1), .O(new_n97_));
  oai21  g80(.a(x3), .b(new_n39_), .c(new_n97_), .O(new_n98_));
  ...
  oai21  g86(.a(new_n82_), .b(x6), .c(x3), .O(new_n104_));
  nand3  g87(.a(new_n20_), .b(x3), .c(new_n39_), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(x1), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n104_), .O(z6));
  oai21  g90(.a(x3), .b(new_n39_), .c(new_n105_), .O(z7));
  nand2  g91(.a(new_n20_), .b(x3), .O(z8));
  nand4  g92(.a(x5), .b(x4), .c(x2), .d(x1), .O(new_n110_));
  nand2  g93(.a(new_n110_), .b(new_n20_), .O(new_n111_));
