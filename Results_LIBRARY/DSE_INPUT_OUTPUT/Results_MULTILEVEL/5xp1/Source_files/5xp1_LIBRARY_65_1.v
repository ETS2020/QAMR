...
module FAU ( 
  ...
  aoi21  g66(.a(new_n83_), .b(new_n81_), .c(new_n19_), .O(new_n84_));
  aoi22  g67(.a(new_n84_), .b(new_n21_), .c(x6), .d(new_n18_), .O(new_n85_));
  ...
  nand3  g80(.a(new_n97_), .b(new_n18_), .c(x1), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n21_), .O(new_n100_));
  nand2  g83(.a(x3), .b(x1), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n20_), .c(new_n18_), .O(new_n102_));
  inv1   g85(.a(new_n102_), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(new_n91_), .c(x0), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n100_), .O(z5));
  oai21  g88(.a(new_n82_), .b(x2), .c(x1), .O(new_n106_));
  nand3  g89(.a(new_n97_), .b(new_n18_), .c(new_n28_), .O(new_n107_));
  nand2  g90(.a(new_n107_), .b(new_n106_), .O(z6));
  nand2  g91(.a(new_n97_), .b(new_n18_), .O(new_n109_));
  nand2  g92(.a(new_n109_), .b(new_n96_), .O(z7));
  oai21  g93(.a(new_n20_), .b(x2), .c(x3), .O(z8));
  oai22  g94(.a(new_n25_), .b(new_n18_), .c(x6), .d(new_n21_), .O(new_n112_));
