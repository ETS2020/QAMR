...
module FAU ( 
  ...
  aoi21  g59(.a(new_n24_), .b(new_n18_), .c(new_n76_), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(x6), .c(new_n75_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(x1), .O(new_n79_));
  nand2  g62(.a(new_n33_), .b(new_n18_), .O(new_n80_));
  ...
  inv1   g69(.a(new_n42_), .O(new_n87_));
  ...
  inv1   g74(.a(new_n24_), .O(new_n92_));
  aoi21  g75(.a(x3), .b(x1), .c(x2), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n92_), .c(x0), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n91_), .c(new_n87_), .O(z5));
  nand2  g78(.a(new_n88_), .b(x1), .O(new_n96_));
  nand3  g79(.a(x3), .b(new_n32_), .c(new_n23_), .O(new_n97_));
  aoi21  g80(.a(new_n97_), .b(new_n96_), .c(new_n42_), .O(z6));
  aoi21  g81(.a(new_n89_), .b(new_n88_), .c(new_n42_), .O(z7));
  nor2   g82(.a(new_n42_), .b(x3), .O(z8));
  aoi21  g83(.a(new_n20_), .b(new_n18_), .c(new_n29_), .O(new_n101_));
  oai21  g84(.a(new_n101_), .b(x6), .c(x4), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n87_), .O(z9));
endmodule
