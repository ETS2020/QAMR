...
module FAU ( 
  ...
  aoi21  g27(.a(new_n18_), .b(new_n22_), .c(new_n21_), .O(new_n45_));
  ...
  oai21  g36(.a(new_n18_), .b(new_n22_), .c(new_n53_), .O(new_n54_));
  ...
  aoi21  g54(.a(new_n42_), .b(new_n24_), .c(new_n19_), .O(new_n72_));
  nand2  g55(.a(new_n24_), .b(new_n22_), .O(new_n73_));
  nand2  g56(.a(new_n63_), .b(new_n60_), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n73_), .c(x6), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n72_), .c(x1), .O(new_n76_));
  nand2  g59(.a(new_n63_), .b(new_n22_), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n19_), .c(x2), .O(new_n78_));
  nor2   g61(.a(x3), .b(x0), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n60_), .c(x6), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n23_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n76_), .c(new_n34_), .O(z4));
  ...
  nand3  g73(.a(new_n90_), .b(new_n87_), .c(new_n34_), .O(z5));
  nand2  g74(.a(new_n84_), .b(x1), .O(new_n92_));
  nand3  g75(.a(x3), .b(new_n60_), .c(new_n23_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n92_), .c(new_n34_), .O(z6));
  aoi22  g77(.a(new_n85_), .b(new_n84_), .c(new_n19_), .d(x4), .O(z7));
  nand2  g78(.a(new_n34_), .b(x3), .O(z8));
