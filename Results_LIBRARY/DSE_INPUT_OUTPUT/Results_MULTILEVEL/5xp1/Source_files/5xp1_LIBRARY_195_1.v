...
module FAU ( 
  ...
  nand3  g86(.a(new_n103_), .b(new_n102_), .c(new_n68_), .O(z6));
  nand3  g87(.a(new_n96_), .b(new_n95_), .c(new_n68_), .O(z7));
  nor2   g88(.a(new_n42_), .b(x3), .O(z8));
  aoi21  g89(.a(new_n20_), .b(new_n18_), .c(new_n29_), .O(new_n107_));
  oai21  g90(.a(new_n107_), .b(x6), .c(x4), .O(new_n108_));
  nand2  g91(.a(new_n108_), .b(new_n68_), .O(z9));
endmodule
