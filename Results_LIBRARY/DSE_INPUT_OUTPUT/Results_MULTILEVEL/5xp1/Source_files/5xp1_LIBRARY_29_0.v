...
module FAU ( 
  ...
  aoi21  g67(.a(new_n84_), .b(new_n24_), .c(new_n19_), .O(new_n85_));
  inv1   g68(.a(new_n58_), .O(new_n86_));
  ...
  nor3   g72(.a(new_n89_), .b(x6), .c(new_n81_), .O(new_n90_));
  nor2   g73(.a(new_n89_), .b(new_n81_), .O(new_n91_));
  ...
  nand2  g79(.a(x3), .b(new_n81_), .O(new_n97_));
  nand2  g80(.a(new_n82_), .b(x2), .O(new_n98_));
  oai21  g81(.a(new_n97_), .b(new_n23_), .c(new_n98_), .O(new_n99_));
