...
module FAU ( 
  ...
  nand4  g58(.a(x6), .b(x3), .c(new_n75_), .d(x1), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n23_), .O(new_n78_));
  aoi21  g61(.a(new_n67_), .b(x2), .c(x1), .O(new_n79_));
  nand2  g62(.a(new_n67_), .b(new_n75_), .O(new_n80_));
  ...
  nand2  g66(.a(x3), .b(new_n75_), .O(new_n84_));
  nand3  g67(.a(new_n84_), .b(x6), .c(x1), .O(new_n85_));
  oai21  g68(.a(new_n84_), .b(x1), .c(new_n85_), .O(z6));
  inv1   g69(.a(new_n36_), .O(new_n87_));
  nand2  g70(.a(new_n67_), .b(x2), .O(new_n88_));
  aoi21  g71(.a(new_n84_), .b(new_n88_), .c(new_n87_), .O(z7));
  nor2   g72(.a(new_n87_), .b(x3), .O(z8));
  oai21  g73(.a(x1), .b(new_n23_), .c(new_n28_), .O(new_n91_));
