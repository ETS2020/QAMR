...
module FAU ( 
  ...
  nor2   g74(.a(new_n29_), .b(new_n19_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(x1), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n58_), .c(x0), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n91_), .c(new_n89_), .O(z5));
  oai21  g78(.a(new_n33_), .b(new_n19_), .c(x1), .O(new_n96_));
  nand3  g79(.a(new_n92_), .b(new_n58_), .c(new_n28_), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n96_), .O(z6));
  nand2  g81(.a(new_n19_), .b(x2), .O(new_n99_));
  inv1   g82(.a(new_n92_), .O(z8));
  oai21  g83(.a(z8), .b(x2), .c(new_n99_), .O(z7));
