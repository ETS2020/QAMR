...
module FAU ( 
  ...
  oai21  g21(.a(new_n38_), .b(new_n37_), .c(new_n23_), .O(new_n39_));
  nand2  g22(.a(new_n18_), .b(new_n22_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(x6), .c(new_n21_), .O(new_n42_));
  ...
  nand2  g35(.a(new_n19_), .b(new_n23_), .O(new_n53_));
  ...
  nand3  g40(.a(x6), .b(new_n18_), .c(new_n22_), .O(new_n58_));
  ...
  nand3  g47(.a(x5), .b(new_n64_), .c(new_n22_), .O(new_n65_));
  oai21  g48(.a(new_n63_), .b(new_n62_), .c(new_n65_), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n23_), .O(new_n67_));
  nand3  g50(.a(new_n24_), .b(x5), .c(new_n22_), .O(new_n68_));
  nand4  g51(.a(new_n18_), .b(new_n64_), .c(new_n61_), .d(x0), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n68_), .c(new_n21_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(new_n19_), .O(new_n71_));
  nand4  g54(.a(new_n71_), .b(new_n67_), .c(new_n60_), .d(new_n56_), .O(z3));
  aoi21  g55(.a(new_n43_), .b(new_n24_), .c(new_n19_), .O(new_n73_));
  ...
  nand2  g60(.a(new_n64_), .b(new_n22_), .O(new_n78_));
  ...
  nand3  g66(.a(new_n83_), .b(new_n77_), .c(new_n35_), .O(z4));
  ...
  nand3  g76(.a(x3), .b(new_n61_), .c(new_n23_), .O(new_n94_));
