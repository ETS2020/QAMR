...
module FAU ( 
  ...
  aoi21  g82(.a(new_n99_), .b(new_n97_), .c(new_n63_), .O(z5));
  nand2  g83(.a(new_n94_), .b(x1), .O(new_n101_));
  nand3  g84(.a(x3), .b(new_n57_), .c(new_n25_), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n101_), .c(new_n64_), .O(z6));
