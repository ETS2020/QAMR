...
module FAU ( 
  ...
  aoi21  g56(.a(new_n73_), .b(new_n19_), .c(new_n70_), .O(new_n74_));
  nand2  g57(.a(new_n61_), .b(new_n20_), .O(new_n75_));
  nand4  g58(.a(new_n75_), .b(new_n18_), .c(new_n19_), .d(x2), .O(new_n76_));
  ...
  oai21  g63(.a(new_n74_), .b(new_n21_), .c(new_n80_), .O(z4));
  nand2  g64(.a(x3), .b(new_n58_), .O(new_n82_));
  nand2  g65(.a(new_n61_), .b(x2), .O(new_n83_));
  oai21  g66(.a(new_n82_), .b(new_n21_), .c(new_n83_), .O(new_n84_));
  ...
  nand2  g71(.a(new_n18_), .b(x4), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n88_), .c(new_n85_), .O(z5));
  nand2  g73(.a(new_n82_), .b(x1), .O(new_n91_));
  nand3  g74(.a(x3), .b(new_n58_), .c(new_n21_), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n91_), .c(new_n89_), .O(z6));
  nand3  g76(.a(new_n89_), .b(new_n83_), .c(new_n82_), .O(z7));
  nand2  g77(.a(new_n89_), .b(x3), .O(z8));
  aoi21  g78(.a(x6), .b(new_n25_), .c(new_n19_), .O(z9));
endmodule
