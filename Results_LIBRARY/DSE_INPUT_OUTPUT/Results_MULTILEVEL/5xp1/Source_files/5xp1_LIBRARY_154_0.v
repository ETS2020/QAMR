...
module FAU ( 
  ...
  oai21  g61(.a(x6), .b(new_n35_), .c(new_n29_), .O(new_n79_));
  oai22  g62(.a(new_n79_), .b(new_n23_), .c(new_n68_), .d(x3), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n18_), .O(new_n81_));
  nand4  g64(.a(new_n81_), .b(new_n78_), .c(new_n74_), .d(new_n52_), .O(z3));
  xor2a  g65(.a(x6), .b(x1), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n47_), .c(new_n18_), .O(new_n84_));
  nand2  g67(.a(new_n36_), .b(x1), .O(new_n85_));
  oai21  g68(.a(x6), .b(x1), .c(new_n85_), .O(new_n86_));
  oai21  g69(.a(x3), .b(x0), .c(new_n86_), .O(new_n87_));
  aoi21  g70(.a(x6), .b(x1), .c(x2), .O(new_n88_));
  nor2   g71(.a(new_n23_), .b(new_n18_), .O(new_n89_));
  nor2   g72(.a(new_n19_), .b(new_n47_), .O(new_n90_));
  aoi21  g73(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n87_), .c(new_n84_), .O(z4));
  nand3  g75(.a(x3), .b(new_n35_), .c(x1), .O(new_n93_));
  ...
  nand3  g82(.a(new_n99_), .b(new_n96_), .c(new_n52_), .O(z5));
  aoi21  g83(.a(x6), .b(new_n47_), .c(x2), .O(new_n101_));
  nand3  g84(.a(new_n90_), .b(new_n35_), .c(new_n23_), .O(new_n102_));
  oai21  g85(.a(new_n101_), .b(new_n23_), .c(new_n102_), .O(z6));
  or2    g86(.a(new_n101_), .b(new_n95_), .O(z7));
  nand2  g87(.a(new_n52_), .b(x3), .O(z8));
  nand3  g88(.a(new_n20_), .b(new_n19_), .c(new_n18_), .O(new_n106_));
  nand3  g89(.a(new_n106_), .b(x5), .c(x4), .O(new_n107_));
  nand2  g90(.a(new_n107_), .b(new_n52_), .O(z9));
endmodule
