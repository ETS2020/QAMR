...
module FAU ( 
  ...
  nand3  g68(.a(x6), .b(x3), .c(new_n26_), .O(new_n86_));
  nand3  g69(.a(new_n20_), .b(x2), .c(new_n30_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(x0), .O(new_n89_));
  nor2   g72(.a(x3), .b(x2), .O(new_n90_));
  aoi21  g73(.a(new_n33_), .b(new_n19_), .c(new_n90_), .O(new_n91_));
  nor2   g74(.a(new_n91_), .b(new_n30_), .O(new_n92_));
  nor2   g75(.a(new_n33_), .b(x1), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n92_), .c(new_n20_), .O(new_n94_));
  nand3  g77(.a(x6), .b(new_n26_), .c(new_n30_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n94_), .c(new_n89_), .O(z4));
  nand2  g79(.a(x3), .b(new_n26_), .O(new_n97_));
  nand3  g80(.a(new_n20_), .b(new_n41_), .c(x2), .O(new_n98_));
  oai21  g81(.a(new_n97_), .b(new_n30_), .c(new_n98_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n19_), .O(new_n100_));
  oai21  g83(.a(new_n41_), .b(new_n30_), .c(new_n26_), .O(new_n101_));
  oai21  g84(.a(new_n60_), .b(new_n26_), .c(new_n101_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(x0), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(new_n100_), .O(z5));
  aoi21  g87(.a(new_n20_), .b(x2), .c(new_n90_), .O(new_n105_));
  nand3  g88(.a(x3), .b(new_n26_), .c(new_n30_), .O(new_n106_));
  oai21  g89(.a(new_n105_), .b(new_n30_), .c(new_n106_), .O(z6));
  nand2  g90(.a(new_n60_), .b(x2), .O(new_n108_));
  nand2  g91(.a(new_n108_), .b(new_n97_), .O(z7));
  nor2   g92(.a(new_n27_), .b(x3), .O(z8));
  nand4  g93(.a(x5), .b(x4), .c(x3), .d(x1), .O(new_n111_));
  nand2  g94(.a(new_n111_), .b(new_n20_), .O(new_n112_));
  nand2  g95(.a(new_n112_), .b(x2), .O(new_n113_));
  nand2  g96(.a(new_n20_), .b(new_n19_), .O(new_n114_));
