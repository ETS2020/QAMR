...
module FAU ( 
  ...
  nor2   g63(.a(new_n19_), .b(x5), .O(new_n81_));
  inv1   g64(.a(new_n81_), .O(new_n82_));
  nand4  g65(.a(new_n82_), .b(new_n80_), .c(new_n74_), .d(new_n71_), .O(z3));
  aoi21  g66(.a(new_n44_), .b(new_n24_), .c(new_n19_), .O(new_n84_));
  nand2  g67(.a(new_n24_), .b(new_n18_), .O(new_n85_));
  ...
  nand3  g82(.a(new_n99_), .b(new_n97_), .c(new_n82_), .O(z5));
  nand2  g83(.a(new_n94_), .b(x1), .O(new_n101_));
  nand3  g84(.a(x3), .b(new_n32_), .c(new_n23_), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n101_), .c(new_n82_), .O(z6));
  aoi21  g86(.a(new_n95_), .b(new_n94_), .c(new_n81_), .O(z7));
