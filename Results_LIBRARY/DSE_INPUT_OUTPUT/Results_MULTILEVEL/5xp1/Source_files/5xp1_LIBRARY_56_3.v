...
module FAU ( 
  ...
  aoi21  g83(.a(new_n100_), .b(new_n99_), .c(new_n78_), .O(z6));
  nand3  g84(.a(new_n92_), .b(new_n91_), .c(new_n79_), .O(z7));
  nor2   g85(.a(new_n78_), .b(x3), .O(z8));
  nand2  g86(.a(new_n22_), .b(x5), .O(new_n104_));
  aoi21  g87(.a(new_n104_), .b(new_n30_), .c(new_n18_), .O(z9));
endmodule
