...
module FAU ( 
  ...
  nand4  g79(.a(x6), .b(x3), .c(new_n18_), .d(x1), .O(new_n97_));
  aoi21  g80(.a(new_n97_), .b(new_n96_), .c(x0), .O(new_n98_));
  nand3  g81(.a(new_n21_), .b(x6), .c(new_n18_), .O(new_n99_));
  aoi21  g82(.a(new_n99_), .b(new_n39_), .c(new_n19_), .O(new_n100_));
  or2    g83(.a(new_n100_), .b(new_n98_), .O(z5));
  ...
  nand2  g88(.a(new_n103_), .b(new_n96_), .O(z7));
  nand2  g89(.a(new_n30_), .b(x3), .O(z8));
  inv1   g90(.a(new_n21_), .O(new_n108_));
  oai21  g91(.a(new_n108_), .b(x0), .c(x2), .O(new_n109_));
