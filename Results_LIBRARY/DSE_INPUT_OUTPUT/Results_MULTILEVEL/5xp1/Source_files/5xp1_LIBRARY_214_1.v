...
module FAU ( 
  ...
  nand2  g60(.a(new_n49_), .b(new_n63_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(x6), .c(x4), .O(new_n79_));
  nor2   g62(.a(x3), .b(x2), .O(new_n80_));
  aoi21  g63(.a(new_n63_), .b(new_n20_), .c(new_n80_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(x6), .c(new_n79_), .O(new_n82_));
  ...
  nand2  g73(.a(new_n90_), .b(new_n83_), .O(z4));
  nand2  g74(.a(x3), .b(new_n43_), .O(new_n92_));
  nand2  g75(.a(new_n84_), .b(x2), .O(new_n93_));
  oai21  g76(.a(new_n92_), .b(new_n40_), .c(new_n93_), .O(new_n94_));
  ...
  aoi21  g81(.a(new_n98_), .b(new_n95_), .c(new_n26_), .O(z5));
  nand2  g82(.a(new_n92_), .b(x1), .O(new_n100_));
  nand3  g83(.a(x3), .b(new_n43_), .c(new_n40_), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n100_), .c(new_n27_), .O(z6));
  nand3  g85(.a(new_n93_), .b(new_n92_), .c(new_n27_), .O(z7));
