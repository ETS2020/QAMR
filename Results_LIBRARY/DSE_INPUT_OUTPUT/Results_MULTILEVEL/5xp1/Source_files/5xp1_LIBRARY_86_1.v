...
module FAU ( 
  ...
  nand2  g021(.a(new_n19_), .b(new_n35_), .O(new_n39_));
  aoi21  g022(.a(new_n39_), .b(x3), .c(new_n26_), .O(new_n40_));
  oai21  g023(.a(new_n40_), .b(new_n38_), .c(new_n23_), .O(new_n41_));
  nand2  g024(.a(new_n19_), .b(new_n26_), .O(new_n42_));
  nand2  g025(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g026(.a(new_n43_), .b(x5), .O(new_n44_));
  nand2  g027(.a(x4), .b(x1), .O(new_n45_));
  aoi21  g028(.a(new_n45_), .b(new_n19_), .c(new_n35_), .O(new_n46_));
  inv1   g029(.a(x1), .O(new_n47_));
  nand2  g030(.a(x4), .b(x3), .O(new_n48_));
  aoi21  g031(.a(new_n48_), .b(new_n19_), .c(new_n47_), .O(new_n49_));
  oai21  g032(.a(new_n49_), .b(new_n46_), .c(x0), .O(new_n50_));
  oai21  g033(.a(new_n19_), .b(new_n26_), .c(new_n50_), .O(new_n51_));
  nand2  g034(.a(new_n51_), .b(new_n32_), .O(new_n52_));
  nor2   g035(.a(new_n19_), .b(x3), .O(new_n53_));
  ...
  oai21  g040(.a(new_n56_), .b(new_n27_), .c(new_n57_), .O(new_n58_));
  nand3  g041(.a(new_n58_), .b(x6), .c(x3), .O(new_n59_));
  inv1   g042(.a(new_n59_), .O(new_n60_));
  nand2  g043(.a(new_n57_), .b(new_n47_), .O(new_n61_));
  oai21  g044(.a(x5), .b(x3), .c(x0), .O(new_n62_));
  aoi21  g045(.a(x5), .b(x3), .c(x0), .O(new_n63_));
  aoi21  g046(.a(new_n62_), .b(new_n35_), .c(new_n63_), .O(new_n64_));
  ...
  aoi22  g051(.a(new_n68_), .b(new_n47_), .c(new_n67_), .d(new_n23_), .O(new_n69_));
  oai21  g052(.a(new_n32_), .b(new_n35_), .c(new_n23_), .O(new_n70_));
  nand3  g053(.a(new_n70_), .b(new_n19_), .c(x1), .O(new_n71_));
  oai21  g054(.a(new_n69_), .b(new_n19_), .c(new_n71_), .O(new_n72_));
  aoi21  g055(.a(x2), .b(x1), .c(x5), .O(new_n73_));
  nor3   g056(.a(new_n73_), .b(x6), .c(new_n23_), .O(new_n74_));
  aoi21  g057(.a(new_n72_), .b(x3), .c(new_n74_), .O(new_n75_));
  oai21  g058(.a(new_n75_), .b(x4), .c(new_n66_), .O(z2));
  ...
  aoi21  g067(.a(new_n77_), .b(new_n47_), .c(new_n84_), .O(new_n85_));
  nand3  g068(.a(new_n77_), .b(new_n35_), .c(new_n47_), .O(new_n86_));
  nand2  g069(.a(x6), .b(x2), .O(new_n87_));
  nand2  g070(.a(new_n87_), .b(new_n47_), .O(new_n88_));
  nand3  g071(.a(new_n88_), .b(x5), .c(x0), .O(new_n89_));
  nor2   g072(.a(x6), .b(x2), .O(new_n90_));
  oai21  g073(.a(new_n90_), .b(new_n47_), .c(new_n87_), .O(new_n91_));
  ...
  nand3  g079(.a(new_n19_), .b(x2), .c(new_n47_), .O(new_n97_));
  nand2  g080(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g081(.a(new_n98_), .b(x0), .O(new_n99_));
  nand2  g082(.a(new_n82_), .b(new_n23_), .O(new_n100_));
  nand2  g083(.a(z8), .b(new_n35_), .O(new_n101_));
  ...
  nand3  g089(.a(new_n106_), .b(x3), .c(new_n47_), .O(new_n107_));
  nand3  g090(.a(new_n107_), .b(new_n105_), .c(new_n99_), .O(z4));
  nand2  g091(.a(x3), .b(new_n35_), .O(new_n109_));
  nand2  g092(.a(z8), .b(x2), .O(new_n110_));
  oai21  g093(.a(new_n109_), .b(new_n47_), .c(new_n110_), .O(new_n111_));
  nand2  g094(.a(new_n111_), .b(new_n23_), .O(new_n112_));
  inv1   g095(.a(new_n101_), .O(new_n113_));
  aoi21  g096(.a(new_n35_), .b(x1), .c(z8), .O(new_n114_));
  oai21  g097(.a(new_n114_), .b(new_n113_), .c(x0), .O(new_n115_));
  nand3  g098(.a(new_n115_), .b(new_n112_), .c(new_n54_), .O(z5));
  nand2  g099(.a(new_n109_), .b(x1), .O(new_n117_));
  nand3  g100(.a(x3), .b(new_n35_), .c(new_n47_), .O(new_n118_));
  nand3  g101(.a(new_n118_), .b(new_n117_), .c(new_n54_), .O(z6));
  nand3  g102(.a(new_n19_), .b(z8), .c(x2), .O(new_n120_));
  nand2  g103(.a(new_n120_), .b(new_n109_), .O(z7));
  nand2  g104(.a(new_n20_), .b(x3), .O(new_n122_));
  nand2  g105(.a(new_n122_), .b(x6), .O(new_n123_));
  oai21  g106(.a(new_n82_), .b(new_n47_), .c(new_n23_), .O(new_n124_));
