...
module FAU ( 
  ...
  aoi21  g56(.a(new_n73_), .b(new_n36_), .c(new_n18_), .O(new_n74_));
  oai21  g57(.a(new_n20_), .b(new_n27_), .c(new_n28_), .O(new_n75_));
  ...
  nand3  g61(.a(x6), .b(new_n19_), .c(new_n18_), .O(new_n79_));
  oai21  g62(.a(new_n32_), .b(new_n18_), .c(new_n79_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x1), .O(new_n81_));
  nand2  g64(.a(new_n36_), .b(new_n27_), .O(new_n82_));
  aoi21  g65(.a(new_n82_), .b(new_n72_), .c(new_n18_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(x3), .c(new_n19_), .O(new_n84_));
  ...
  aoi21  g71(.a(new_n88_), .b(new_n28_), .c(new_n20_), .O(new_n89_));
  aoi21  g72(.a(new_n87_), .b(new_n52_), .c(x6), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n89_), .c(x1), .O(new_n91_));
  nor3   g74(.a(new_n61_), .b(x6), .c(new_n71_), .O(new_n92_));
  ...
  nand3  g78(.a(new_n95_), .b(new_n94_), .c(new_n91_), .O(z4));
  nand2  g79(.a(new_n32_), .b(x2), .O(new_n97_));
  nand2  g80(.a(new_n71_), .b(x1), .O(new_n98_));
  nand2  g81(.a(x5), .b(x3), .O(z8));
  oai21  g82(.a(z8), .b(new_n98_), .c(new_n97_), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n18_), .O(new_n101_));
  aoi21  g84(.a(new_n71_), .b(x1), .c(new_n19_), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(x3), .c(new_n86_), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(new_n18_), .c(new_n101_), .O(z5));
  aoi21  g87(.a(new_n71_), .b(new_n27_), .c(new_n19_), .O(new_n105_));
  oai21  g88(.a(z8), .b(x2), .c(x1), .O(new_n106_));
  oai21  g89(.a(new_n105_), .b(new_n32_), .c(new_n106_), .O(z6));
  oai21  g90(.a(z8), .b(x2), .c(new_n97_), .O(z7));
