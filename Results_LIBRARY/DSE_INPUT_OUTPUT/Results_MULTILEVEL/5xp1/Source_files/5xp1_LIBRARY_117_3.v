...
module FAU ( 
  ...
  nand3  g59(.a(new_n19_), .b(new_n61_), .c(new_n33_), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n76_), .c(new_n18_), .O(new_n78_));
  nor2   g61(.a(new_n72_), .b(x0), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n78_), .c(new_n30_), .O(new_n80_));
  nand4  g63(.a(new_n80_), .b(new_n75_), .c(new_n69_), .d(new_n46_), .O(z3));
  nand2  g64(.a(new_n48_), .b(new_n20_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(x6), .c(new_n24_), .O(new_n83_));
  nor2   g66(.a(x3), .b(x2), .O(new_n84_));
  aoi21  g67(.a(new_n20_), .b(new_n18_), .c(new_n84_), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(x6), .c(new_n83_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(x1), .O(new_n87_));
  nand2  g70(.a(new_n61_), .b(new_n18_), .O(new_n88_));
  ...
  nand2  g78(.a(new_n61_), .b(x2), .O(new_n96_));
  ...
  aoi21  g83(.a(new_n100_), .b(new_n98_), .c(new_n45_), .O(z5));
  nand2  g84(.a(new_n95_), .b(x1), .O(new_n102_));
  nand3  g85(.a(x3), .b(new_n33_), .c(new_n25_), .O(new_n103_));
  aoi21  g86(.a(new_n103_), .b(new_n102_), .c(new_n45_), .O(z6));
  nand3  g87(.a(new_n96_), .b(new_n95_), .c(new_n46_), .O(z7));
  nand2  g88(.a(new_n46_), .b(x3), .O(z8));
  nand2  g89(.a(new_n22_), .b(new_n18_), .O(new_n107_));
  nand4  g90(.a(new_n107_), .b(new_n19_), .c(x5), .d(x4), .O(new_n108_));
