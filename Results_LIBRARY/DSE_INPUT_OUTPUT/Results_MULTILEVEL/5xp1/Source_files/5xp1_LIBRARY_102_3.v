...
module FAU ( 
  ...
  nand2  g57(.a(new_n23_), .b(new_n40_), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(new_n74_), .c(x0), .O(new_n76_));
  nand4  g59(.a(new_n23_), .b(x3), .c(x1), .d(x0), .O(new_n77_));
  inv1   g60(.a(new_n77_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n76_), .c(x5), .O(new_n79_));
  oai21  g62(.a(new_n23_), .b(new_n33_), .c(new_n40_), .O(new_n80_));
  nand3  g63(.a(new_n23_), .b(new_n34_), .c(new_n33_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n29_), .c(x0), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n79_), .c(new_n72_), .O(z3));
  ...
  nand3  g73(.a(new_n73_), .b(new_n34_), .c(x2), .O(new_n91_));
  nand4  g74(.a(new_n23_), .b(x3), .c(new_n33_), .d(x1), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n19_), .O(new_n94_));
  nand2  g77(.a(new_n34_), .b(x2), .O(new_n95_));
  nand2  g78(.a(new_n35_), .b(new_n20_), .O(new_n96_));
  aoi22  g79(.a(new_n96_), .b(new_n23_), .c(new_n95_), .d(new_n40_), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(new_n19_), .c(new_n94_), .O(z5));
  nand2  g81(.a(x3), .b(new_n33_), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(new_n23_), .c(x1), .O(new_n100_));
  oai21  g83(.a(new_n99_), .b(x1), .c(new_n100_), .O(z6));
  inv1   g84(.a(new_n73_), .O(new_n102_));
  aoi21  g85(.a(new_n99_), .b(new_n95_), .c(new_n102_), .O(z7));
  nand2  g86(.a(new_n73_), .b(x3), .O(z8));
  nor2   g87(.a(new_n23_), .b(x1), .O(new_n105_));
  aoi21  g88(.a(new_n37_), .b(new_n19_), .c(x6), .O(new_n106_));
