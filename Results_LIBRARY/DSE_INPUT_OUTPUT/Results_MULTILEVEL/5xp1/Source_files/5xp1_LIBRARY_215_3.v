...
module FAU ( 
  ...
  aoi21  g52(.a(new_n40_), .b(new_n62_), .c(new_n20_), .O(new_n70_));
  nand2  g53(.a(new_n62_), .b(new_n19_), .O(new_n71_));
  aoi21  g54(.a(new_n71_), .b(new_n54_), .c(x6), .O(new_n72_));
  oai21  g55(.a(new_n72_), .b(new_n70_), .c(x1), .O(new_n73_));
  nor2   g56(.a(x3), .b(x0), .O(new_n74_));
  nor3   g57(.a(new_n74_), .b(x6), .c(new_n25_), .O(new_n75_));
  ...
  nor2   g61(.a(new_n20_), .b(new_n46_), .O(new_n79_));
  inv1   g62(.a(new_n79_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n78_), .c(new_n73_), .O(z4));
  ...
  aoi21  g71(.a(new_n88_), .b(new_n85_), .c(new_n79_), .O(z5));
  nand2  g72(.a(new_n82_), .b(x1), .O(new_n90_));
  nand3  g73(.a(x3), .b(new_n25_), .c(new_n24_), .O(new_n91_));
  aoi21  g74(.a(new_n91_), .b(new_n90_), .c(new_n79_), .O(z6));
  aoi21  g75(.a(new_n83_), .b(new_n82_), .c(new_n79_), .O(z7));
  nor2   g76(.a(new_n79_), .b(x3), .O(z8));
  nand2  g77(.a(new_n56_), .b(x4), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(new_n20_), .c(new_n46_), .O(z9));
endmodule
