...
module FAU ( 
  ...
  nand3  g62(.a(x6), .b(z8), .c(new_n24_), .O(new_n80_));
  oai21  g63(.a(x6), .b(new_n24_), .c(new_n80_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n23_), .O(new_n82_));
  nand3  g65(.a(new_n40_), .b(x2), .c(x0), .O(new_n83_));
  oai21  g66(.a(new_n40_), .b(x2), .c(new_n83_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n24_), .O(new_n85_));
  aoi21  g68(.a(new_n30_), .b(z8), .c(new_n23_), .O(new_n86_));
  nand2  g69(.a(new_n68_), .b(new_n25_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n86_), .c(x1), .O(new_n88_));
  nand4  g71(.a(new_n88_), .b(new_n85_), .c(new_n82_), .d(new_n41_), .O(z4));
  xnor2a g72(.a(x3), .b(x0), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(x2), .O(new_n91_));
  oai21  g74(.a(x2), .b(new_n24_), .c(x6), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(x3), .c(new_n23_), .O(new_n93_));
  nor2   g76(.a(new_n40_), .b(z8), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(x1), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n60_), .c(x0), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n93_), .c(new_n91_), .O(z5));
  nand2  g80(.a(new_n30_), .b(x3), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(x1), .O(new_n99_));
  nand3  g82(.a(new_n94_), .b(new_n60_), .c(new_n24_), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n99_), .O(z6));
  nand2  g84(.a(x3), .b(new_n60_), .O(new_n102_));
  oai21  g85(.a(new_n94_), .b(new_n60_), .c(new_n102_), .O(z7));
  oai21  g86(.a(x6), .b(x0), .c(x5), .O(new_n104_));
  oai21  g87(.a(new_n104_), .b(new_n18_), .c(new_n41_), .O(z9));
endmodule
