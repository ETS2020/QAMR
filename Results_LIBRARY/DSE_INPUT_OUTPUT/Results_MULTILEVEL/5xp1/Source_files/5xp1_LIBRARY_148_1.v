...
module FAU ( 
  ...
  nand3  g056(.a(new_n73_), .b(x4), .c(new_n18_), .O(new_n74_));
  ...
  nand2  g081(.a(new_n18_), .b(new_n44_), .O(new_n99_));
  ...
  oai21  g099(.a(z8), .b(new_n116_), .c(x1), .O(new_n117_));
  ...
  oai21  g105(.a(new_n82_), .b(new_n35_), .c(new_n23_), .O(new_n123_));
