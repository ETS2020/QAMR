...
module FAU ( 
  ...
  nand4  g37(.a(new_n20_), .b(new_n53_), .c(new_n25_), .d(x0), .O(new_n55_));
  inv1   g38(.a(new_n55_), .O(new_n56_));
  oai21  g39(.a(new_n56_), .b(new_n54_), .c(new_n34_), .O(new_n57_));
  nand3  g40(.a(new_n53_), .b(new_n24_), .c(x0), .O(new_n58_));
  inv1   g41(.a(new_n58_), .O(new_n59_));
  oai21  g42(.a(new_n59_), .b(new_n54_), .c(new_n25_), .O(new_n60_));
  nand3  g43(.a(new_n20_), .b(new_n53_), .c(x0), .O(new_n61_));
  inv1   g44(.a(new_n61_), .O(new_n62_));
  oai21  g45(.a(new_n62_), .b(new_n54_), .c(new_n24_), .O(new_n63_));
  nand3  g46(.a(new_n35_), .b(x5), .c(x0), .O(new_n64_));
  nand3  g47(.a(new_n53_), .b(x3), .c(x2), .O(new_n65_));
  ...
  aoi21  g54(.a(new_n71_), .b(new_n53_), .c(new_n20_), .O(new_n72_));
  aoi21  g55(.a(new_n68_), .b(x1), .c(new_n72_), .O(new_n73_));
  nand4  g56(.a(new_n73_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(z3));
  nand2  g57(.a(new_n35_), .b(x0), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(new_n69_), .c(new_n20_), .O(new_n76_));
  nand2  g59(.a(new_n69_), .b(new_n19_), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n35_), .c(x6), .O(new_n78_));
  ...
  nand3  g67(.a(new_n84_), .b(new_n79_), .c(new_n51_), .O(z4));
  ...
  oai21  g73(.a(new_n90_), .b(new_n70_), .c(x0), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n89_), .c(new_n51_), .O(z5));
  nand2  g75(.a(new_n86_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n25_), .c(new_n24_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n93_), .c(new_n51_), .O(z6));
  nand3  g78(.a(new_n87_), .b(new_n86_), .c(new_n51_), .O(z7));
  nand2  g79(.a(new_n51_), .b(x3), .O(z8));
  nand2  g80(.a(new_n21_), .b(new_n19_), .O(new_n98_));
  nand4  g81(.a(new_n98_), .b(new_n20_), .c(x5), .d(x4), .O(new_n99_));
