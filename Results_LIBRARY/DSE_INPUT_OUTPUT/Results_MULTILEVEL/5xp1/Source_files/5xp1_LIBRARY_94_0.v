...
module FAU ( 
  ...
  nand3  g84(.a(new_n101_), .b(new_n99_), .c(new_n43_), .O(z5));
  ...
  aoi21  g88(.a(new_n97_), .b(new_n96_), .c(new_n42_), .O(z7));
  nand2  g89(.a(new_n43_), .b(x3), .O(z8));
  nand2  g90(.a(new_n22_), .b(new_n19_), .O(new_n108_));
  nand3  g91(.a(new_n108_), .b(x5), .c(x4), .O(new_n109_));
  nand2  g92(.a(new_n109_), .b(new_n43_), .O(z9));
endmodule
