...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n25_,
    ...
    new_n93_, new_n94_, new_n95_, new_n97_, new_n98_, new_n99_;
  ...
  nand3  g51(.a(new_n35_), .b(new_n46_), .c(new_n28_), .O(new_n69_));
  aoi21  g52(.a(new_n69_), .b(new_n68_), .c(new_n19_), .O(new_n70_));
  aoi21  g53(.a(new_n67_), .b(new_n19_), .c(new_n70_), .O(new_n71_));
  oai21  g54(.a(x2), .b(x1), .c(x0), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n22_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(x6), .c(x5), .O(new_n74_));
  oai21  g57(.a(new_n71_), .b(x5), .c(new_n74_), .O(z3));
  nand2  g58(.a(new_n46_), .b(new_n28_), .O(new_n76_));
  ...
  aoi22  g63(.a(new_n80_), .b(new_n42_), .c(new_n78_), .d(x6), .O(new_n81_));
  nor2   g64(.a(x3), .b(x0), .O(new_n82_));
  nor2   g65(.a(new_n82_), .b(x6), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n42_), .c(x2), .O(new_n84_));
  oai21  g67(.a(new_n82_), .b(new_n28_), .c(x6), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n20_), .O(new_n87_));
  oai21  g70(.a(new_n81_), .b(new_n20_), .c(new_n87_), .O(z4));
  nor2   g71(.a(x6), .b(new_n42_), .O(new_n89_));
  nand2  g72(.a(x3), .b(new_n28_), .O(new_n90_));
