...
module FAU ( 
  ...
  nand2  g65(.a(new_n54_), .b(new_n20_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(x6), .c(new_n24_), .O(new_n84_));
  nor2   g67(.a(x3), .b(x2), .O(new_n85_));
  oai21  g68(.a(new_n60_), .b(new_n85_), .c(new_n19_), .O(new_n86_));
  aoi21  g69(.a(new_n86_), .b(new_n84_), .c(new_n25_), .O(new_n87_));
  nand2  g70(.a(new_n77_), .b(new_n18_), .O(new_n88_));
  ...
  aoi21  g74(.a(new_n91_), .b(new_n89_), .c(x1), .O(new_n92_));
  or2    g75(.a(new_n92_), .b(new_n87_), .O(z4));
  nand2  g76(.a(x3), .b(new_n33_), .O(new_n94_));
  nand2  g77(.a(new_n77_), .b(x2), .O(new_n95_));
  ...
  aoi21  g82(.a(new_n99_), .b(new_n97_), .c(new_n45_), .O(z5));
  nand2  g83(.a(new_n94_), .b(x1), .O(new_n101_));
  nand3  g84(.a(x3), .b(new_n33_), .c(new_n25_), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(new_n101_), .c(new_n45_), .O(z6));
  aoi21  g86(.a(new_n95_), .b(new_n94_), .c(new_n45_), .O(z7));
  nand2  g87(.a(new_n46_), .b(x3), .O(z8));
  nand2  g88(.a(new_n22_), .b(new_n18_), .O(new_n106_));
  nand4  g89(.a(new_n106_), .b(new_n19_), .c(x5), .d(x4), .O(new_n107_));
