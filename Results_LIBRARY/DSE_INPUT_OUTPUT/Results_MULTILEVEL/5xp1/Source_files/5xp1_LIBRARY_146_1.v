...
module FAU ( 
  ...
  aoi21  g31(.a(new_n48_), .b(new_n45_), .c(new_n22_), .O(new_n49_));
  ...
  nand4  g38(.a(new_n24_), .b(new_n22_), .c(new_n23_), .d(new_n18_), .O(new_n56_));
  nand2  g39(.a(new_n25_), .b(x4), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(x6), .c(x5), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n55_), .O(z2));
  nand4  g43(.a(new_n19_), .b(new_n29_), .c(x3), .d(new_n18_), .O(new_n61_));
  ...
  nand3  g49(.a(new_n66_), .b(new_n29_), .c(x0), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(new_n36_), .O(new_n68_));
  nand3  g51(.a(x6), .b(x2), .c(x0), .O(new_n69_));
  aoi21  g52(.a(new_n69_), .b(new_n25_), .c(new_n29_), .O(new_n70_));
  aoi21  g53(.a(new_n68_), .b(new_n19_), .c(new_n70_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(new_n65_), .O(z3));
  aoi21  g55(.a(new_n50_), .b(new_n24_), .c(new_n19_), .O(new_n73_));
  nand2  g56(.a(new_n24_), .b(new_n18_), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n34_), .c(x6), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n73_), .c(x1), .O(new_n76_));
  nor2   g59(.a(x3), .b(x0), .O(new_n77_));
  nor3   g60(.a(new_n77_), .b(x6), .c(new_n32_), .O(new_n78_));
  nor2   g61(.a(new_n77_), .b(new_n32_), .O(new_n79_));
  nor2   g62(.a(new_n79_), .b(new_n19_), .O(new_n80_));
  oai21  g63(.a(new_n80_), .b(new_n78_), .c(new_n23_), .O(new_n81_));
  nand2  g64(.a(x6), .b(new_n29_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n81_), .c(new_n76_), .O(z4));
  nand2  g66(.a(x3), .b(new_n32_), .O(new_n84_));
  nand2  g67(.a(new_n33_), .b(x2), .O(new_n85_));
  ...
  oai21  g71(.a(new_n88_), .b(new_n40_), .c(x0), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n87_), .c(new_n82_), .O(z5));
  nand2  g73(.a(new_n84_), .b(x1), .O(new_n91_));
  nand3  g74(.a(x3), .b(new_n32_), .c(new_n23_), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n91_), .c(new_n82_), .O(z6));
  nand3  g76(.a(new_n85_), .b(new_n84_), .c(new_n82_), .O(z7));
  nand2  g77(.a(new_n82_), .b(x3), .O(z8));
  aoi21  g78(.a(new_n20_), .b(new_n18_), .c(new_n29_), .O(new_n96_));
  oai21  g79(.a(new_n96_), .b(x6), .c(x4), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n82_), .O(z9));
endmodule
