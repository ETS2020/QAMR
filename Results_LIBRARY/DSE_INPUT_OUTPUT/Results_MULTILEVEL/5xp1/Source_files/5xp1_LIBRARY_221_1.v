...
module FAU ( 
  ...
  oai22  g039(.a(x5), .b(x0), .c(x2), .d(x1), .O(new_n57_));
  ...
  aoi21  g048(.a(new_n64_), .b(new_n37_), .c(new_n65_), .O(new_n66_));
  ...
  oai21  g053(.a(new_n20_), .b(new_n37_), .c(new_n19_), .O(new_n71_));
  ...
  nand3  g065(.a(new_n30_), .b(x5), .c(new_n19_), .O(new_n83_));
  nand2  g066(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  aoi21  g067(.a(new_n78_), .b(new_n62_), .c(new_n84_), .O(new_n85_));
  nand3  g068(.a(new_n78_), .b(new_n37_), .c(new_n62_), .O(new_n86_));
  ...
  nand3  g078(.a(new_n29_), .b(x2), .c(new_n62_), .O(new_n96_));
  oai21  g079(.a(new_n47_), .b(new_n62_), .c(new_n96_), .O(new_n97_));
  nand2  g080(.a(new_n97_), .b(x0), .O(new_n98_));
  nand2  g081(.a(new_n30_), .b(new_n19_), .O(new_n99_));
  nand2  g082(.a(z8), .b(new_n37_), .O(new_n100_));
  ...
  nand3  g088(.a(new_n105_), .b(x3), .c(new_n62_), .O(new_n106_));
  nand3  g089(.a(new_n106_), .b(new_n104_), .c(new_n98_), .O(z4));
  nand2  g090(.a(x3), .b(new_n37_), .O(new_n108_));
  nor2   g091(.a(x6), .b(x3), .O(new_n109_));
  inv1   g092(.a(new_n109_), .O(new_n110_));
  oai22  g093(.a(new_n110_), .b(new_n37_), .c(new_n108_), .d(new_n62_), .O(new_n111_));
  nand2  g094(.a(new_n111_), .b(new_n19_), .O(new_n112_));
  aoi21  g095(.a(new_n37_), .b(x1), .c(z8), .O(new_n113_));
  ...
  oai21  g099(.a(new_n109_), .b(new_n31_), .c(x1), .O(new_n117_));
  oai21  g100(.a(new_n108_), .b(x1), .c(new_n117_), .O(z6));
  nand2  g101(.a(z8), .b(x2), .O(new_n119_));
  oai21  g102(.a(new_n109_), .b(x2), .c(new_n119_), .O(z7));
  aoi21  g103(.a(x5), .b(x4), .c(z8), .O(new_n121_));
  nand2  g104(.a(new_n32_), .b(new_n19_), .O(new_n122_));
  nand3  g105(.a(new_n122_), .b(x5), .c(x4), .O(new_n123_));
  oai21  g106(.a(new_n121_), .b(new_n29_), .c(new_n123_), .O(z9));
endmodule
