...
module FAU ( 
  ...
  aoi21  g65(.a(new_n35_), .b(new_n25_), .c(new_n18_), .O(new_n83_));
  nor2   g66(.a(x3), .b(new_n47_), .O(new_n84_));
  nor3   g67(.a(new_n84_), .b(x6), .c(x1), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n83_), .c(x0), .O(new_n86_));
  nor2   g69(.a(new_n79_), .b(x2), .O(new_n87_));
  nor2   g70(.a(new_n87_), .b(new_n84_), .O(new_n88_));
  nand3  g71(.a(new_n20_), .b(new_n79_), .c(x2), .O(new_n89_));
  oai21  g72(.a(new_n88_), .b(new_n18_), .c(new_n89_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n21_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n86_), .O(z5));
  oai21  g75(.a(new_n87_), .b(x6), .c(new_n18_), .O(new_n93_));
  oai21  g76(.a(new_n87_), .b(new_n18_), .c(new_n93_), .O(z6));
  oai21  g77(.a(new_n20_), .b(x1), .c(new_n88_), .O(z7));
  oai21  g78(.a(new_n20_), .b(x1), .c(x3), .O(z8));
