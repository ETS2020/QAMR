...
module FAU ( 
  ...
  nand2  g18(.a(new_n27_), .b(x6), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(x5), .c(new_n25_), .O(new_n37_));
  inv1   g20(.a(x6), .O(new_n38_));
  nor2   g21(.a(new_n38_), .b(x5), .O(new_n39_));
  inv1   g22(.a(new_n39_), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(new_n37_), .c(new_n35_), .O(z1));
  ...
  aoi22  g29(.a(new_n46_), .b(new_n20_), .c(new_n45_), .d(new_n44_), .O(new_n47_));
  aoi21  g30(.a(new_n47_), .b(new_n43_), .c(new_n25_), .O(new_n48_));
  ...
  aoi21  g35(.a(new_n52_), .b(new_n42_), .c(x4), .O(new_n53_));
  oai21  g36(.a(new_n53_), .b(new_n48_), .c(new_n38_), .O(new_n54_));
  ...
  aoi21  g43(.a(new_n60_), .b(new_n42_), .c(new_n44_), .O(new_n61_));
  aoi21  g44(.a(new_n46_), .b(new_n38_), .c(new_n20_), .O(new_n62_));
  oai21  g45(.a(new_n62_), .b(new_n61_), .c(x1), .O(new_n63_));
  oai21  g46(.a(new_n44_), .b(new_n20_), .c(x5), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(x6), .O(new_n65_));
  nand2  g48(.a(new_n31_), .b(x1), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n18_), .c(x0), .O(new_n67_));
  oai21  g50(.a(new_n38_), .b(new_n26_), .c(new_n21_), .O(new_n68_));
  ...
  nand2  g55(.a(new_n49_), .b(new_n21_), .O(new_n73_));
  nand3  g56(.a(new_n73_), .b(x6), .c(x5), .O(new_n74_));
  aoi21  g57(.a(new_n21_), .b(new_n20_), .c(new_n30_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(x6), .c(new_n74_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(x1), .O(new_n77_));
  inv1   g60(.a(x3), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n20_), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n38_), .c(x2), .O(new_n80_));
  ...
  nand2  g68(.a(x3), .b(new_n44_), .O(new_n86_));
  nand2  g69(.a(new_n78_), .b(x2), .O(new_n87_));
  ...
  oai21  g73(.a(new_n90_), .b(new_n22_), .c(x0), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n89_), .c(new_n40_), .O(z5));
  nand2  g75(.a(new_n86_), .b(x1), .O(new_n93_));
  nand3  g76(.a(x3), .b(new_n44_), .c(new_n26_), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n93_), .c(new_n39_), .O(z6));
  nand3  g78(.a(new_n87_), .b(new_n86_), .c(new_n40_), .O(z7));
  nand2  g79(.a(new_n40_), .b(x3), .O(z8));
