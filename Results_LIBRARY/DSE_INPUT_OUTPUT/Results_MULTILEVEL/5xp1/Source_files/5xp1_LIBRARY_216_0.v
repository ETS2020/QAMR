...
module FAU ( 
  ...
  oai22  g68(.a(new_n21_), .b(new_n19_), .c(x2), .d(x1), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(x6), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n85_), .c(new_n82_), .O(z4));
  nand3  g71(.a(x3), .b(new_n18_), .c(x1), .O(new_n89_));
  oai21  g72(.a(x3), .b(new_n18_), .c(new_n89_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n19_), .O(new_n91_));
  inv1   g74(.a(new_n21_), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(x2), .c(new_n43_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(x0), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n91_), .c(new_n31_), .O(z5));
  aoi21  g78(.a(x3), .b(new_n42_), .c(new_n20_), .O(new_n96_));
  nand2  g79(.a(x6), .b(x3), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(x2), .c(x1), .O(new_n98_));
  oai21  g81(.a(new_n96_), .b(x2), .c(new_n98_), .O(z6));
  oai21  g82(.a(new_n20_), .b(x3), .c(new_n18_), .O(new_n100_));
  oai21  g83(.a(x3), .b(new_n18_), .c(new_n100_), .O(z7));
  ...
  nand2  g87(.a(new_n104_), .b(new_n31_), .O(z9));
endmodule
