...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n93_, new_n95_, new_n96_, new_n97_, new_n101_;
  ...
  nand4  g41(.a(new_n38_), .b(new_n20_), .c(new_n18_), .d(x4), .O(new_n59_));
  inv1   g42(.a(new_n59_), .O(new_n60_));
  aoi21  g43(.a(new_n58_), .b(x6), .c(new_n60_), .O(new_n61_));
  nand4  g44(.a(new_n61_), .b(new_n53_), .c(new_n48_), .d(new_n42_), .O(z2));
  inv1   g45(.a(new_n23_), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(x6), .c(x1), .O(new_n64_));
  nand3  g47(.a(x6), .b(x3), .c(x2), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nor2   g49(.a(new_n63_), .b(new_n18_), .O(new_n67_));
  aoi22  g50(.a(new_n67_), .b(new_n22_), .c(new_n66_), .d(new_n18_), .O(new_n68_));
  nand2  g51(.a(new_n46_), .b(new_n22_), .O(new_n69_));
  nand3  g52(.a(new_n20_), .b(new_n49_), .c(new_n31_), .O(new_n70_));
  ...
  nand2  g57(.a(new_n49_), .b(new_n31_), .O(new_n75_));
  ...
  aoi22  g62(.a(new_n79_), .b(new_n18_), .c(new_n77_), .d(x6), .O(new_n80_));
  nor2   g63(.a(x3), .b(x0), .O(new_n81_));
  nor2   g64(.a(new_n81_), .b(x6), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n18_), .c(x2), .O(new_n83_));
  oai21  g66(.a(new_n81_), .b(new_n31_), .c(x6), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n22_), .O(new_n86_));
  oai21  g69(.a(new_n80_), .b(new_n22_), .c(new_n86_), .O(z4));
  ...
  aoi21  g76(.a(new_n93_), .b(new_n91_), .c(new_n72_), .O(z5));
  inv1   g77(.a(new_n72_), .O(new_n95_));
  ...
  aoi21  g81(.a(new_n89_), .b(new_n88_), .c(new_n72_), .O(z7));
  nor2   g82(.a(new_n72_), .b(x3), .O(z8));
