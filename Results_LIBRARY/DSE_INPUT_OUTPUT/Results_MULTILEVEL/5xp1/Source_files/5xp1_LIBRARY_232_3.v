...
module FAU ( 
  ...
  aoi21  g34(.a(new_n51_), .b(new_n47_), .c(new_n30_), .O(new_n52_));
  ...
  aoi21  g39(.a(new_n56_), .b(new_n46_), .c(x4), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n52_), .c(new_n20_), .O(new_n58_));
  nor2   g41(.a(x5), .b(x1), .O(new_n59_));
  inv1   g42(.a(new_n59_), .O(new_n60_));
  nor2   g43(.a(new_n25_), .b(new_n29_), .O(new_n61_));
  aoi21  g44(.a(new_n60_), .b(x0), .c(new_n61_), .O(new_n62_));
  aoi21  g45(.a(x5), .b(x1), .c(x0), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n59_), .c(new_n30_), .O(new_n64_));
  oai21  g47(.a(new_n62_), .b(new_n30_), .c(new_n64_), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(x6), .c(new_n48_), .O(new_n66_));
  ...
  nand2  g53(.a(new_n40_), .b(new_n48_), .O(new_n71_));
  ...
  nand2  g59(.a(x5), .b(new_n29_), .O(new_n77_));
  nand3  g60(.a(x6), .b(new_n25_), .c(x1), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n77_), .c(x0), .O(new_n79_));
  nand2  g62(.a(new_n20_), .b(new_n40_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(x5), .c(x1), .O(new_n81_));
  aoi21  g64(.a(new_n81_), .b(new_n60_), .c(new_n19_), .O(new_n82_));
  oai21  g65(.a(new_n82_), .b(new_n79_), .c(new_n48_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n76_), .O(z3));
  nand3  g67(.a(x6), .b(x3), .c(new_n48_), .O(new_n85_));
  nand3  g68(.a(new_n20_), .b(x2), .c(new_n29_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(x0), .O(new_n88_));
  nand2  g71(.a(new_n32_), .b(new_n19_), .O(new_n89_));
  aoi21  g72(.a(new_n89_), .b(new_n71_), .c(new_n29_), .O(new_n90_));
  nor2   g73(.a(new_n32_), .b(x1), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n90_), .c(new_n20_), .O(new_n92_));
  nand3  g75(.a(x6), .b(new_n48_), .c(new_n29_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n92_), .c(new_n88_), .O(z4));
  nand2  g77(.a(x3), .b(new_n48_), .O(new_n95_));
  inv1   g78(.a(new_n95_), .O(new_n96_));
  nor2   g79(.a(x3), .b(new_n48_), .O(new_n97_));
  aoi21  g80(.a(new_n96_), .b(x1), .c(new_n97_), .O(new_n98_));
  oai21  g81(.a(new_n40_), .b(new_n19_), .c(new_n20_), .O(new_n99_));
  aoi21  g82(.a(x3), .b(x1), .c(x2), .O(new_n100_));
  aoi22  g83(.a(new_n100_), .b(x0), .c(new_n99_), .d(x2), .O(new_n101_));
  oai21  g84(.a(new_n98_), .b(x0), .c(new_n101_), .O(z5));
  nand2  g85(.a(new_n95_), .b(x1), .O(new_n103_));
  nand2  g86(.a(new_n96_), .b(new_n29_), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n103_), .c(new_n27_), .O(z6));
  oai21  g88(.a(new_n80_), .b(new_n48_), .c(new_n95_), .O(z7));
  nand2  g89(.a(new_n27_), .b(x3), .O(z8));
