...
module FAU ( 
  ...
  nand3  g68(.a(new_n85_), .b(new_n50_), .c(new_n19_), .O(new_n86_));
  nand2  g69(.a(new_n71_), .b(x1), .O(new_n87_));
  oai21  g70(.a(x6), .b(x1), .c(new_n87_), .O(new_n88_));
  oai21  g71(.a(x3), .b(x0), .c(new_n88_), .O(new_n89_));
  aoi21  g72(.a(x6), .b(x1), .c(x2), .O(new_n90_));
  nor2   g73(.a(new_n33_), .b(new_n19_), .O(new_n91_));
  nand2  g74(.a(x6), .b(x3), .O(new_n92_));
  inv1   g75(.a(new_n92_), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(new_n91_), .c(new_n90_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n89_), .c(new_n86_), .O(z4));
  nand3  g78(.a(x3), .b(new_n18_), .c(x1), .O(new_n96_));
  inv1   g79(.a(new_n96_), .O(new_n97_));
  nor2   g80(.a(x3), .b(new_n18_), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n97_), .c(new_n19_), .O(new_n99_));
  inv1   g82(.a(new_n21_), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(x2), .c(new_n39_), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(x0), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n99_), .c(new_n70_), .O(z5));
  aoi21  g86(.a(x3), .b(new_n33_), .c(new_n20_), .O(new_n104_));
  nor2   g87(.a(new_n92_), .b(x2), .O(new_n105_));
  oai22  g88(.a(new_n105_), .b(new_n33_), .c(new_n104_), .d(x2), .O(z6));
  or2    g89(.a(new_n105_), .b(new_n98_), .O(z7));
  nand2  g90(.a(new_n70_), .b(x3), .O(z8));
  oai21  g91(.a(new_n100_), .b(x0), .c(x2), .O(new_n109_));
