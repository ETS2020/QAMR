...
module FAU ( 
  ...
  nor2   g103(.a(x6), .b(x3), .O(new_n121_));
  ...
  nand2  g107(.a(z8), .b(x2), .O(new_n125_));
  oai21  g108(.a(new_n121_), .b(x2), .c(new_n125_), .O(z7));
  oai22  g109(.a(new_n24_), .b(z8), .c(x6), .d(new_n23_), .O(new_n127_));
