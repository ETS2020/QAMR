...
module FAU ( 
  ...
  oai21  g029(.a(new_n63_), .b(new_n73_), .c(new_n60_), .O(z06));
  ...
  nand4  g044(.a(new_n88_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n89_));
  ...
  nor2   g048(.a(new_n50_), .b(x20), .O(new_n93_));
  aoi21  g049(.a(new_n92_), .b(x20), .c(new_n93_), .O(new_n94_));
  nand2  g050(.a(x21), .b(new_n47_), .O(new_n95_));
  oai21  g051(.a(new_n94_), .b(new_n47_), .c(new_n95_), .O(new_n96_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n69_), .O(z12));
  nand2  g063(.a(new_n64_), .b(x04), .O(new_n108_));
  ...
  nand4  g073(.a(new_n117_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n108_), .O(z13));
  nand2  g075(.a(new_n64_), .b(x05), .O(new_n120_));
  ...
  nand4  g083(.a(new_n127_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n128_));
  ...
  nand4  g091(.a(new_n135_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n136_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n99_), .c(new_n142_), .d(new_n79_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n77_), .O(z16));
endmodule
