...
module FAU ( 
  ...
  nor2   g009(.a(x24), .b(x22), .O(new_n54_));
  ...
  nor2   g015(.a(new_n59_), .b(new_n57_), .O(z02));
  ...
  nand2  g023(.a(new_n67_), .b(new_n58_), .O(z06));
  ...
  aoi21  g053(.a(x08), .b(x02), .c(new_n54_), .O(new_n98_));
  ...
  oai21  g057(.a(new_n101_), .b(new_n100_), .c(x24), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n74_), .O(new_n103_));
  nor2   g059(.a(new_n81_), .b(new_n89_), .O(new_n104_));
  inv1   g060(.a(new_n91_), .O(new_n105_));
  and2   g061(.a(x23), .b(x14), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(new_n73_), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n104_), .c(new_n74_), .O(new_n108_));
  ...
  nand2  g070(.a(new_n101_), .b(x23), .O(new_n115_));
  ...
  nand2  g078(.a(new_n100_), .b(x24), .O(new_n123_));
