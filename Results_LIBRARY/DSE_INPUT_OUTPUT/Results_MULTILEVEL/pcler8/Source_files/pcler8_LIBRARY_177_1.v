...
module FAU ( 
  ...
  nand4  g54(.a(new_n98_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n99_));
  ...
  nand4  g61(.a(new_n105_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n106_));
  oai21  g62(.a(new_n66_), .b(new_n65_), .c(new_n106_), .O(z12));
  ...
  nand4  g68(.a(new_n112_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n68_), .c(new_n47_), .O(z13));
  ...
  nand3  g79(.a(new_n123_), .b(new_n70_), .c(new_n47_), .O(z14));
  ...
  oai21  g87(.a(new_n66_), .b(new_n72_), .c(new_n131_), .O(z15));
  ...
  oai21  g97(.a(new_n66_), .b(new_n74_), .c(new_n141_), .O(z16));
endmodule
