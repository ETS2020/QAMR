...
module FAU ( 
  ...
  aoi21  g024(.a(x08), .b(x06), .c(new_n55_), .O(new_n69_));
  ...
  nand3  g032(.a(new_n76_), .b(x26), .c(x24), .O(new_n77_));
  ...
  nand3  g037(.a(x26), .b(x24), .c(x23), .O(new_n82_));
  ...
  nand2  g058(.a(new_n74_), .b(x21), .O(new_n103_));
  oai22  g059(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n74_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n105_));
  oai21  g061(.a(new_n46_), .b(new_n63_), .c(new_n105_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n56_), .O(new_n107_));
  inv1   g063(.a(x09), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(x08), .O(new_n109_));
  nand3  g065(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(new_n75_), .c(new_n74_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n109_), .c(x14), .d(new_n47_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n107_), .O(z12));
  ...
  oai21  g074(.a(new_n102_), .b(new_n118_), .c(x23), .O(new_n119_));
  nand3  g075(.a(new_n75_), .b(x22), .c(x21), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n102_), .c(new_n119_), .O(new_n121_));
  ...
  oai21  g082(.a(new_n126_), .b(new_n100_), .c(x25), .O(new_n127_));
  nand4  g083(.a(new_n101_), .b(new_n54_), .c(x23), .d(x22), .O(new_n128_));
  oai21  g084(.a(new_n127_), .b(new_n54_), .c(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n130_));
  oai21  g086(.a(new_n64_), .b(new_n67_), .c(new_n130_), .O(z14));
  aoi21  g087(.a(x26), .b(x17), .c(new_n54_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n101_), .c(new_n76_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(x25), .c(new_n47_), .d(x09), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(x08), .c(new_n69_), .O(z15));
  nor2   g091(.a(new_n102_), .b(x18), .O(new_n136_));
  nand3  g092(.a(x23), .b(x22), .c(x21), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n136_), .c(new_n45_), .O(new_n139_));
  nand4  g095(.a(new_n45_), .b(x24), .c(x23), .d(x22), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n100_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n139_), .c(x25), .O(new_n142_));
  nand2  g098(.a(x26), .b(new_n54_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n71_), .O(z16));
endmodule
