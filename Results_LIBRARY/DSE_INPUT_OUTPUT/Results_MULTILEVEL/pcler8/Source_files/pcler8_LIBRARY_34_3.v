...
module FAU ( 
  ...
  oai21  g026(.a(new_n46_), .b(new_n70_), .c(new_n59_), .O(z07));
  ...
  oai21  g056(.a(new_n99_), .b(new_n54_), .c(new_n100_), .O(z11));
  nor2   g057(.a(new_n85_), .b(new_n91_), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  nand2  g059(.a(x23), .b(x14), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n93_), .c(x21), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n103_), .c(x22), .O(new_n106_));
  nand3  g062(.a(new_n102_), .b(new_n75_), .c(x21), .O(new_n107_));
  ...
  nand2  g076(.a(new_n120_), .b(new_n66_), .O(z13));
  ...
  oai21  g092(.a(new_n136_), .b(new_n114_), .c(x25), .O(new_n137_));
  inv1   g093(.a(x25), .O(new_n138_));
  nand4  g094(.a(new_n126_), .b(new_n134_), .c(new_n138_), .d(x24), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n141_));
  oai21  g097(.a(new_n132_), .b(new_n70_), .c(new_n141_), .O(z15));
  ...
  nor2   g102(.a(new_n125_), .b(new_n133_), .O(new_n147_));
  nor2   g103(.a(x26), .b(new_n138_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n102_), .c(new_n147_), .d(new_n76_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n151_));
  oai21  g107(.a(new_n132_), .b(new_n72_), .c(new_n151_), .O(z16));
endmodule
