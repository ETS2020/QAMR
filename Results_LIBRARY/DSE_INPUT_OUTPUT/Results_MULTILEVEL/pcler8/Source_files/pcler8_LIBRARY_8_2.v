...
module FAU ( 
  ...
  oai21  g037(.a(new_n81_), .b(new_n74_), .c(x20), .O(new_n82_));
  ...
  nor2   g047(.a(new_n70_), .b(x20), .O(new_n92_));
  ...
  nand2  g052(.a(new_n77_), .b(x02), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n96_), .O(z11));
  nor2   g054(.a(new_n80_), .b(new_n88_), .O(new_n99_));
  ...
  aoi21  g071(.a(new_n115_), .b(new_n113_), .c(new_n71_), .O(new_n116_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n109_), .c(new_n110_), .O(z13));
  oai21  g076(.a(new_n47_), .b(x05), .c(x08), .O(new_n121_));
  ...
  nand3  g084(.a(new_n128_), .b(new_n47_), .c(x09), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n121_), .O(z14));
  oai21  g086(.a(new_n47_), .b(x06), .c(x08), .O(new_n131_));
  nor2   g087(.a(new_n117_), .b(new_n71_), .O(new_n132_));
  ...
  nor2   g100(.a(new_n125_), .b(new_n117_), .O(new_n145_));
  nor2   g101(.a(x26), .b(new_n136_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n99_), .c(new_n145_), .d(new_n72_), .O(new_n147_));
