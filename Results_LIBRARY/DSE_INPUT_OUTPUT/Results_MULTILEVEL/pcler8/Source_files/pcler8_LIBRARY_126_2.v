...
module FAU ( 
  ...
  nand3  g025(.a(new_n56_), .b(x08), .c(x06), .O(new_n70_));
  ...
  nand3  g037(.a(x23), .b(x22), .c(x21), .O(new_n82_));
  ...
  nand3  g042(.a(new_n86_), .b(new_n81_), .c(new_n76_), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n79_), .O(z09));
  xor2a  g044(.a(x20), .b(x19), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n90_));
  oai21  g046(.a(new_n46_), .b(new_n59_), .c(new_n90_), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n56_), .O(new_n92_));
  nand2  g048(.a(x19), .b(x12), .O(new_n93_));
  nor2   g049(.a(new_n93_), .b(x10), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n86_), .c(new_n76_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n92_), .O(z10));
  xnor2a g052(.a(x21), .b(x20), .O(new_n97_));
  nand2  g053(.a(x21), .b(new_n74_), .O(new_n98_));
  oai21  g054(.a(new_n97_), .b(new_n74_), .c(new_n98_), .O(new_n99_));
  ...
  nand3  g062(.a(new_n106_), .b(new_n104_), .c(new_n76_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n102_), .O(z11));
  nand3  g064(.a(x21), .b(x20), .c(x19), .O(new_n109_));
  and2   g065(.a(x24), .b(x14), .O(new_n110_));
  aoi22  g066(.a(new_n110_), .b(new_n84_), .c(new_n109_), .d(x23), .O(new_n111_));
  nand2  g067(.a(x20), .b(x19), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n54_), .c(x21), .O(new_n114_));
  oai21  g070(.a(new_n111_), .b(new_n54_), .c(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n64_), .c(new_n56_), .O(z12));
  inv1   g073(.a(new_n109_), .O(new_n118_));
  nand3  g074(.a(new_n84_), .b(x24), .c(x15), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n118_), .c(x22), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(x23), .c(new_n47_), .d(x09), .O(new_n121_));
  oai22  g077(.a(new_n121_), .b(x08), .c(new_n60_), .d(new_n66_), .O(z13));
  nand3  g078(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n123_));
  inv1   g079(.a(x24), .O(new_n124_));
  nand3  g080(.a(new_n113_), .b(new_n124_), .c(x21), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n123_), .c(x23), .O(new_n126_));
  ...
  aoi21  g086(.a(new_n130_), .b(new_n113_), .c(new_n124_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n127_), .c(new_n68_), .O(z14));
  inv1   g089(.a(x23), .O(new_n134_));
  nand2  g090(.a(x26), .b(x17), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n113_), .c(x24), .d(x21), .O(new_n136_));
  nand3  g092(.a(new_n83_), .b(x24), .c(x22), .O(new_n137_));
  nor2   g093(.a(new_n137_), .b(new_n109_), .O(new_n138_));
  ...
  nand3  g099(.a(new_n76_), .b(x19), .c(new_n47_), .O(new_n144_));
  nor2   g100(.a(x26), .b(new_n83_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(x24), .c(x21), .d(x20), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n144_), .c(x23), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x22), .O(new_n148_));
  nand4  g104(.a(x25), .b(x24), .c(x22), .d(x21), .O(new_n149_));
  nor3   g105(.a(new_n149_), .b(new_n112_), .c(x18), .O(new_n150_));
  nor2   g106(.a(new_n150_), .b(new_n45_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n148_), .c(new_n72_), .O(z16));
endmodule
