...
module FAU ( 
  ...
  oai21  g13(.a(new_n55_), .b(new_n57_), .c(new_n46_), .O(z04));
  inv1   g14(.a(x04), .O(new_n59_));
  nor2   g15(.a(new_n50_), .b(new_n59_), .O(z05));
  inv1   g16(.a(x05), .O(new_n61_));
  oai21  g17(.a(new_n55_), .b(new_n61_), .c(new_n46_), .O(z06));
  ...
  nor2   g22(.a(new_n50_), .b(new_n54_), .O(z11));
  nor2   g23(.a(new_n50_), .b(new_n57_), .O(z12));
  nor2   g24(.a(new_n50_), .b(new_n61_), .O(z14));
  nor2   g25(.a(new_n50_), .b(new_n63_), .O(z15));
  oai21  g26(.a(new_n55_), .b(new_n65_), .c(new_n46_), .O(z16));
  nor2   g27(.a(new_n50_), .b(new_n48_), .O(z09));
  nand2  g28(.a(new_n52_), .b(new_n46_), .O(z10));
  nor2   g29(.a(new_n50_), .b(new_n59_), .O(z13));
endmodule
