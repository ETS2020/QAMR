...
module FAU ( 
  ...
  aoi21  g033(.a(new_n77_), .b(new_n46_), .c(x10), .O(new_n78_));
  oai21  g034(.a(new_n78_), .b(new_n54_), .c(new_n57_), .O(z09));
  ...
  nand2  g041(.a(new_n85_), .b(new_n60_), .O(z10));
  ...
  oai21  g049(.a(new_n93_), .b(x10), .c(x09), .O(new_n94_));
  ...
  nand2  g059(.a(new_n103_), .b(new_n64_), .O(z12));
  nand2  g060(.a(new_n59_), .b(x04), .O(new_n105_));
  ...
  oai21  g081(.a(new_n117_), .b(new_n68_), .c(new_n125_), .O(z14));
  inv1   g082(.a(x23), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(new_n99_), .O(new_n128_));
  ...
  oai21  g091(.a(new_n117_), .b(new_n70_), .c(new_n135_), .O(z15));
  ...
  nand4  g098(.a(new_n142_), .b(new_n100_), .c(new_n141_), .d(new_n74_), .O(new_n143_));
