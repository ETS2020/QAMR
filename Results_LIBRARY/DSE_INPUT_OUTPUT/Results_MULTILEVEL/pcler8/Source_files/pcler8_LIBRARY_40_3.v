...
module FAU ( 
  ...
  nand2  g13(.a(new_n58_), .b(new_n55_), .O(z04));
  nand2  g14(.a(x08), .b(x04), .O(new_n60_));
  nand2  g15(.a(new_n60_), .b(new_n55_), .O(z05));
  ...
  nand3  g28(.a(new_n73_), .b(new_n68_), .c(new_n55_), .O(z09));
  ...
  aoi21  g45(.a(new_n90_), .b(new_n58_), .c(new_n49_), .O(z12));
  nand2  g46(.a(x22), .b(x21), .O(new_n92_));
  oai21  g47(.a(new_n92_), .b(new_n86_), .c(x23), .O(new_n93_));
  nand3  g48(.a(new_n47_), .b(x22), .c(x21), .O(new_n94_));
  oai21  g49(.a(new_n94_), .b(new_n86_), .c(new_n93_), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n60_), .c(new_n55_), .O(z13));
  nand3  g52(.a(new_n48_), .b(x23), .c(x22), .O(new_n98_));
  oai22  g53(.a(new_n98_), .b(new_n84_), .c(new_n48_), .d(x23), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n62_), .O(z14));
  ...
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n55_), .O(z16));
  zero   g62(.O(z00));
endmodule
