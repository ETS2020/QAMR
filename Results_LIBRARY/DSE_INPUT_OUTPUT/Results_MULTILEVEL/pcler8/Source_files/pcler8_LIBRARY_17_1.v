...
module FAU ( 
  ...
  nor2   g030(.a(new_n47_), .b(new_n74_), .O(z08));
  ...
  nand2  g037(.a(new_n78_), .b(x07), .O(new_n82_));
  inv1   g038(.a(new_n82_), .O(new_n83_));
  nand2  g039(.a(x20), .b(x11), .O(new_n84_));
  nor2   g040(.a(new_n84_), .b(x10), .O(new_n85_));
  nor2   g041(.a(new_n55_), .b(new_n46_), .O(new_n86_));
  ...
  oai21  g051(.a(new_n47_), .b(new_n60_), .c(new_n95_), .O(new_n96_));
  ...
  nand3  g068(.a(new_n78_), .b(x14), .c(new_n48_), .O(new_n113_));
  nand3  g069(.a(new_n89_), .b(x24), .c(x22), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n113_), .c(x07), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x23), .O(new_n116_));
  nand3  g072(.a(x21), .b(x20), .c(x19), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  and2   g074(.a(x20), .b(x19), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n46_), .c(x21), .O(new_n120_));
  ...
  nand4  g080(.a(new_n124_), .b(new_n119_), .c(x22), .d(x21), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x23), .c(x07), .O(new_n126_));
  nand4  g082(.a(new_n119_), .b(new_n55_), .c(x22), .d(x21), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n129_));
  oai21  g085(.a(new_n62_), .b(new_n68_), .c(new_n129_), .O(z13));
  nand2  g086(.a(new_n61_), .b(x05), .O(new_n131_));
  nand3  g087(.a(x26), .b(x25), .c(x16), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n119_), .c(x22), .d(x21), .O(new_n133_));
  ...
  nand2  g093(.a(x24), .b(new_n55_), .O(new_n138_));
  oai21  g094(.a(new_n137_), .b(new_n74_), .c(new_n138_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n131_), .O(z14));
  nand3  g097(.a(new_n78_), .b(x19), .c(new_n48_), .O(new_n142_));
  and2   g098(.a(x21), .b(x20), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n88_), .c(x24), .d(x22), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n142_), .c(x07), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x23), .O(new_n146_));
  nand2  g102(.a(x26), .b(x17), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n86_), .c(x24), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n118_), .c(new_n88_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n146_), .c(new_n72_), .O(z15));
  oai21  g108(.a(x23), .b(x07), .c(x08), .O(new_n153_));
  nand3  g109(.a(new_n119_), .b(new_n48_), .c(x09), .O(new_n154_));
  nor2   g110(.a(x26), .b(new_n88_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(x24), .c(x22), .d(x21), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n154_), .c(x07), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x23), .O(new_n158_));
  inv1   g114(.a(x18), .O(new_n159_));
  nand3  g115(.a(new_n143_), .b(x19), .c(new_n159_), .O(new_n160_));
  nand3  g116(.a(new_n86_), .b(x25), .c(x24), .O(new_n161_));
  nor2   g117(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nor2   g118(.a(new_n162_), .b(new_n45_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n158_), .c(new_n153_), .O(z16));
endmodule
