...
module FAU ( 
  ...
  oai21  g32(.a(new_n57_), .b(new_n54_), .c(new_n76_), .O(z09));
  inv1   g33(.a(x20), .O(new_n78_));
  nand3  g34(.a(x22), .b(x21), .c(x12), .O(new_n79_));
  oai21  g35(.a(new_n79_), .b(new_n74_), .c(x20), .O(new_n80_));
  nand2  g36(.a(new_n80_), .b(x19), .O(new_n81_));
  oai21  g37(.a(new_n78_), .b(x19), .c(new_n81_), .O(new_n82_));
  ...
  oai21  g48(.a(new_n92_), .b(new_n85_), .c(new_n47_), .O(new_n93_));
  nand2  g49(.a(x08), .b(x02), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n93_), .O(z11));
  nand2  g51(.a(x23), .b(x14), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n87_), .c(x21), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n90_), .c(x22), .O(new_n98_));
  ...
  oai21  g59(.a(new_n57_), .b(new_n62_), .c(new_n103_), .O(z12));
  nand4  g60(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x22), .c(x21), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n90_), .c(x23), .O(new_n107_));
  ...
  oai21  g66(.a(new_n110_), .b(new_n85_), .c(new_n47_), .O(new_n111_));
  ...
  oai21  g76(.a(new_n120_), .b(new_n85_), .c(new_n47_), .O(new_n121_));
  ...
  oai21  g86(.a(new_n130_), .b(new_n85_), .c(new_n47_), .O(new_n131_));
  ...
  oai21  g96(.a(new_n140_), .b(new_n85_), .c(new_n47_), .O(new_n141_));
  nand2  g97(.a(new_n141_), .b(new_n70_), .O(z16));
endmodule
