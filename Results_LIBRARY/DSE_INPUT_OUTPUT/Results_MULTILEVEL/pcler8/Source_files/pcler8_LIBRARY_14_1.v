...
module FAU ( 
  ...
  oai21  g23(.a(new_n47_), .b(new_n67_), .c(new_n46_), .O(z04));
  ...
  nor2   g31(.a(new_n60_), .b(new_n75_), .O(z08));
  ...
  oai21  g38(.a(new_n60_), .b(new_n59_), .c(new_n82_), .O(z09));
  ...
  nand2  g48(.a(new_n92_), .b(new_n90_), .O(z10));
  ...
  nand2  g53(.a(x21), .b(new_n87_), .O(new_n98_));
  oai21  g54(.a(new_n97_), .b(new_n87_), .c(new_n98_), .O(new_n99_));
  ...
  aoi21  g80(.a(x08), .b(x05), .c(new_n91_), .O(new_n125_));
  ...
  oai21  g99(.a(new_n60_), .b(new_n75_), .c(new_n143_), .O(z16));
endmodule
