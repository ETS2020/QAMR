...
module FAU ( 
  ...
  nand2  g075(.a(new_n119_), .b(new_n65_), .O(z13));
  ...
  oai21  g084(.a(new_n57_), .b(new_n67_), .c(new_n128_), .O(z14));
  ...
  nand4  g101(.a(new_n145_), .b(new_n100_), .c(new_n144_), .d(new_n75_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n71_), .c(new_n56_), .O(z16));
endmodule
