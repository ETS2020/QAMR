...
module FAU ( 
  ...
  aoi21  g016(.a(x10), .b(new_n60_), .c(new_n46_), .O(z04));
  nand3  g017(.a(x10), .b(x08), .c(x04), .O(new_n62_));
  inv1   g018(.a(new_n62_), .O(z05));
  oai21  g019(.a(new_n47_), .b(x05), .c(x08), .O(new_n64_));
  ...
  aoi21  g024(.a(x10), .b(new_n68_), .c(new_n46_), .O(z08));
  ...
  nand3  g037(.a(new_n81_), .b(new_n47_), .c(x09), .O(new_n82_));
  ...
  nand3  g045(.a(new_n89_), .b(new_n47_), .c(x09), .O(new_n90_));
  ...
  nor2   g055(.a(new_n47_), .b(new_n46_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n58_), .c(new_n99_), .O(z11));
  ...
  nand2  g077(.a(new_n100_), .b(x04), .O(new_n122_));
  ...
  nand4  g083(.a(new_n127_), .b(new_n76_), .c(x23), .d(x22), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n47_), .c(x09), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n64_), .O(z14));
  nor2   g087(.a(new_n75_), .b(new_n72_), .O(new_n132_));
