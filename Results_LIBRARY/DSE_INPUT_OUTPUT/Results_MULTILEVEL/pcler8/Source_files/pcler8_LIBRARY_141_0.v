...
module FAU ( 
  ...
  nand2  g023(.a(new_n62_), .b(x06), .O(new_n68_));
  inv1   g024(.a(new_n68_), .O(z07));
  nand2  g025(.a(x08), .b(x07), .O(new_n70_));
  nand2  g026(.a(new_n70_), .b(new_n55_), .O(z08));
  ...
  aoi21  g034(.a(new_n78_), .b(new_n46_), .c(new_n72_), .O(new_n79_));
  oai21  g035(.a(new_n79_), .b(x10), .c(new_n56_), .O(z09));
  ...
  oai21  g062(.a(new_n106_), .b(new_n72_), .c(new_n47_), .O(new_n107_));
  ...
  oai21  g071(.a(new_n115_), .b(new_n72_), .c(new_n47_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n64_), .O(z13));
  nand2  g073(.a(new_n62_), .b(x05), .O(new_n118_));
  ...
  nor2   g084(.a(new_n113_), .b(new_n74_), .O(new_n129_));
  ...
  oai21  g101(.a(new_n145_), .b(new_n72_), .c(new_n47_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n70_), .O(z16));
endmodule
