...
module FAU ( 
  ...
  nor2   g001(.a(x09), .b(new_n45_), .O(new_n46_));
  ...
  nand3  g017(.a(x09), .b(x08), .c(x00), .O(new_n62_));
  ...
  nand2  g024(.a(new_n47_), .b(x08), .O(new_n69_));
  nor2   g025(.a(new_n69_), .b(new_n68_), .O(z04));
  aoi21  g026(.a(x08), .b(x04), .c(new_n46_), .O(new_n71_));
  inv1   g027(.a(new_n71_), .O(z05));
  inv1   g028(.a(x05), .O(new_n73_));
  inv1   g029(.a(x08), .O(new_n74_));
  oai21  g030(.a(new_n74_), .b(new_n73_), .c(new_n47_), .O(z06));
  nand2  g031(.a(x08), .b(x06), .O(new_n76_));
  nand2  g032(.a(new_n76_), .b(new_n47_), .O(z07));
  inv1   g033(.a(x07), .O(new_n78_));
  nor2   g034(.a(new_n69_), .b(new_n78_), .O(z08));
  ...
  nand4  g040(.a(new_n84_), .b(new_n48_), .c(x09), .d(new_n74_), .O(new_n85_));
  oai21  g041(.a(new_n50_), .b(new_n45_), .c(new_n85_), .O(z09));
  nand3  g042(.a(x22), .b(x21), .c(x12), .O(new_n87_));
  oai21  g043(.a(new_n87_), .b(new_n83_), .c(x20), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(x19), .O(new_n89_));
  oai21  g045(.a(new_n52_), .b(x19), .c(new_n89_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n48_), .c(x09), .d(new_n74_), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n64_), .c(new_n47_), .O(z10));
  nand3  g048(.a(x23), .b(x22), .c(x13), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n58_), .c(x21), .O(new_n94_));
  nor2   g050(.a(new_n80_), .b(x20), .O(new_n95_));
  aoi21  g051(.a(new_n94_), .b(x20), .c(new_n95_), .O(new_n96_));
  nand2  g052(.a(x21), .b(new_n51_), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n51_), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n48_), .c(x09), .d(new_n74_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n66_), .c(new_n47_), .O(z11));
  inv1   g056(.a(new_n53_), .O(new_n101_));
  nand2  g057(.a(x23), .b(x14), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n58_), .c(x21), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n101_), .c(x22), .O(new_n104_));
  nand3  g060(.a(new_n53_), .b(new_n55_), .c(x21), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n48_), .c(x09), .d(new_n74_), .O(new_n107_));
  aoi21  g063(.a(x08), .b(x03), .c(new_n46_), .O(new_n108_));
  ...
  nand2  g072(.a(x23), .b(new_n55_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n48_), .c(x09), .d(new_n74_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n71_), .O(z13));
  ...
  nand4  g083(.a(new_n127_), .b(new_n48_), .c(x09), .d(new_n74_), .O(new_n128_));
  oai21  g084(.a(new_n69_), .b(new_n73_), .c(new_n128_), .O(z14));
  nand2  g085(.a(x26), .b(x17), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n57_), .c(x24), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n113_), .c(x25), .O(new_n132_));
  inv1   g088(.a(x25), .O(new_n133_));
  nand4  g089(.a(new_n125_), .b(new_n57_), .c(new_n133_), .d(x24), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n48_), .c(x09), .d(new_n74_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n76_), .c(new_n47_), .O(z15));
  inv1   g093(.a(x18), .O(new_n138_));
  nand4  g094(.a(x21), .b(x20), .c(x19), .d(new_n138_), .O(new_n139_));
  nand3  g095(.a(new_n57_), .b(x25), .c(x24), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(x26), .O(new_n141_));
  nor2   g097(.a(new_n124_), .b(new_n56_), .O(new_n142_));
  nor2   g098(.a(x26), .b(new_n133_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n142_), .c(new_n81_), .d(new_n53_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n48_), .c(x09), .d(new_n74_), .O(new_n146_));
  aoi21  g102(.a(x08), .b(x07), .c(new_n46_), .O(new_n147_));
