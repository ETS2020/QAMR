...
module FAU ( 
  ...
  nor3   g018(.a(new_n56_), .b(new_n47_), .c(new_n62_), .O(z03));
  nor2   g019(.a(new_n56_), .b(new_n47_), .O(new_n64_));
  and2   g020(.a(new_n64_), .b(x03), .O(z04));
  inv1   g021(.a(x04), .O(new_n66_));
  nor2   g022(.a(new_n47_), .b(new_n66_), .O(z05));
  and2   g023(.a(new_n64_), .b(x05), .O(z06));
  ...
  nand4  g042(.a(new_n86_), .b(new_n80_), .c(new_n75_), .d(x04), .O(new_n87_));
  ...
  nand3  g051(.a(new_n95_), .b(new_n60_), .c(new_n57_), .O(z10));
  ...
  oai21  g058(.a(new_n47_), .b(new_n62_), .c(new_n102_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n57_), .O(new_n104_));
  nor2   g060(.a(x08), .b(new_n66_), .O(new_n105_));
  inv1   g061(.a(x13), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(x10), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n86_), .c(new_n105_), .d(x09), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n104_), .O(z11));
  nand3  g065(.a(new_n75_), .b(x14), .c(new_n48_), .O(new_n110_));
  nand3  g066(.a(new_n84_), .b(x24), .c(x22), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n110_), .c(x04), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x23), .O(new_n113_));
  nand3  g069(.a(x21), .b(x20), .c(x19), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand2  g071(.a(new_n46_), .b(x21), .O(new_n116_));
  oai22  g072(.a(new_n116_), .b(new_n98_), .c(new_n115_), .d(new_n46_), .O(new_n117_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n115_), .c(new_n130_), .O(new_n137_));
  ...
  nand2  g096(.a(new_n64_), .b(x06), .O(new_n141_));
  ...
  nand4  g100(.a(new_n115_), .b(new_n81_), .c(new_n83_), .d(x24), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x04), .O(new_n147_));
  nand2  g103(.a(x25), .b(new_n55_), .O(new_n148_));
  ...
  nor2   g107(.a(new_n98_), .b(x18), .O(new_n152_));
  ...
  oai21  g114(.a(new_n158_), .b(new_n155_), .c(x04), .O(new_n159_));
  nand2  g115(.a(x26), .b(new_n55_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n71_), .O(z16));
endmodule
