...
module FAU ( 
  ...
  nand3  g034(.a(new_n78_), .b(x23), .c(x22), .O(new_n79_));
  ...
  oai21  g059(.a(new_n103_), .b(new_n101_), .c(x24), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(x19), .O(new_n105_));
  nand3  g061(.a(new_n78_), .b(x23), .c(x14), .O(new_n106_));
  ...
  nand3  g070(.a(new_n114_), .b(x21), .c(x20), .O(new_n115_));
  nand2  g071(.a(new_n74_), .b(x23), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x22), .c(x19), .O(new_n118_));
  oai21  g074(.a(new_n102_), .b(new_n55_), .c(x23), .O(new_n119_));
  ...
  oai22  g084(.a(new_n128_), .b(x08), .c(new_n58_), .d(new_n68_), .O(z14));
  inv1   g085(.a(x24), .O(new_n130_));
  nand2  g086(.a(x26), .b(x17), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n75_), .c(x23), .d(x22), .O(new_n132_));
  nand3  g088(.a(new_n77_), .b(x23), .c(x22), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n124_), .O(new_n134_));
  aoi21  g090(.a(new_n132_), .b(x25), .c(new_n134_), .O(new_n135_));
  nand2  g091(.a(x25), .b(new_n55_), .O(new_n136_));
  oai21  g092(.a(new_n135_), .b(new_n130_), .c(new_n136_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n70_), .O(z15));
  nand4  g095(.a(x20), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n140_));
  nor2   g096(.a(new_n102_), .b(new_n94_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n45_), .c(x25), .d(x23), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n140_), .c(x24), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x19), .O(new_n144_));
  nand2  g100(.a(x20), .b(x19), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(x18), .O(new_n146_));
  nand3  g102(.a(new_n141_), .b(x25), .c(x23), .O(new_n147_));
  ...
  nand3  g107(.a(new_n151_), .b(new_n150_), .c(new_n144_), .O(z16));
endmodule
