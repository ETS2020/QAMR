...
module FAU ( 
  ...
  nor2   g010(.a(x19), .b(new_n47_), .O(new_n55_));
  ...
  nor2   g028(.a(new_n62_), .b(new_n72_), .O(z08));
  ...
  nand3  g040(.a(new_n84_), .b(x19), .c(new_n47_), .O(new_n85_));
  oai21  g041(.a(new_n82_), .b(x19), .c(new_n85_), .O(new_n86_));
  nand3  g042(.a(new_n86_), .b(x09), .c(new_n46_), .O(new_n87_));
  nand3  g043(.a(new_n87_), .b(new_n58_), .c(new_n56_), .O(z10));
  ...
  oai21  g062(.a(new_n62_), .b(new_n64_), .c(new_n106_), .O(z12));
  ...
  oai21  g066(.a(new_n74_), .b(new_n82_), .c(x23), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x22), .c(x19), .O(new_n113_));
  oai21  g069(.a(new_n75_), .b(new_n89_), .c(x23), .O(new_n114_));
  ...
  nor2   g073(.a(new_n74_), .b(new_n82_), .O(new_n118_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n119_), .c(new_n122_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n68_), .O(z14));
  nand2  g083(.a(new_n61_), .b(x06), .O(new_n128_));
  inv1   g084(.a(x23), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(new_n75_), .O(new_n130_));
  nand2  g086(.a(x26), .b(x17), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n130_), .c(x24), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n119_), .c(x25), .O(new_n133_));
  inv1   g089(.a(x25), .O(new_n134_));
  nand3  g090(.a(new_n130_), .b(new_n134_), .c(x24), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n119_), .c(new_n133_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n128_), .O(z15));
  nor2   g094(.a(new_n89_), .b(x18), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n118_), .O(new_n140_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n99_), .c(new_n143_), .d(new_n76_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n147_));
  oai21  g103(.a(new_n62_), .b(new_n72_), .c(new_n147_), .O(z16));
endmodule
