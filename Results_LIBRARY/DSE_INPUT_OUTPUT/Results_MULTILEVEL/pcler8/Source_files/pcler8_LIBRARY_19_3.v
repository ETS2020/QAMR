...
module FAU ( 
  ...
  nand2  g023(.a(new_n67_), .b(new_n62_), .O(z03));
  ...
  oai21  g056(.a(new_n100_), .b(new_n45_), .c(new_n67_), .O(z11));
  ...
  nand2  g082(.a(new_n126_), .b(new_n73_), .O(z14));
  ...
  nand4  g089(.a(new_n133_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n134_));
  oai21  g090(.a(new_n79_), .b(new_n75_), .c(new_n134_), .O(z15));
  ...
  nand4  g097(.a(new_n141_), .b(new_n102_), .c(new_n140_), .d(new_n80_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n144_));
  oai21  g100(.a(new_n79_), .b(new_n77_), .c(new_n144_), .O(z16));
endmodule
