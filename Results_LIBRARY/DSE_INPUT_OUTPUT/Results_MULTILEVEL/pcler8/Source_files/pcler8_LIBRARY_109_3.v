...
module FAU ( 
  ...
  nand3  g29(.a(new_n74_), .b(x19), .c(new_n68_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(new_n76_));
  aoi22  g31(.a(new_n76_), .b(new_n71_), .c(x08), .d(x01), .O(new_n77_));
  nand2  g32(.a(x23), .b(x21), .O(new_n78_));
  nand4  g33(.a(new_n78_), .b(x20), .c(new_n69_), .d(new_n68_), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(new_n80_));
  nand3  g35(.a(new_n80_), .b(x09), .c(new_n52_), .O(new_n81_));
  oai21  g36(.a(new_n77_), .b(new_n48_), .c(new_n81_), .O(z10));
  nand2  g37(.a(new_n46_), .b(x20), .O(new_n83_));
  nand3  g38(.a(new_n47_), .b(x21), .c(new_n74_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(x19), .O(new_n86_));
  nand3  g41(.a(new_n47_), .b(x21), .c(new_n69_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n56_), .O(z11));
  nand2  g45(.a(new_n53_), .b(x03), .O(new_n91_));
  aoi21  g46(.a(x20), .b(x19), .c(x23), .O(new_n92_));
  oai21  g47(.a(new_n92_), .b(new_n46_), .c(x22), .O(new_n93_));
  nor2   g48(.a(new_n74_), .b(new_n69_), .O(new_n94_));
  nor2   g49(.a(x23), .b(x22), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n94_), .c(x21), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n93_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n91_), .O(z12));
  nand3  g54(.a(new_n94_), .b(x22), .c(x21), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n47_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n60_), .c(new_n49_), .O(z13));
  nand3  g58(.a(new_n71_), .b(x24), .c(new_n68_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n62_), .c(new_n49_), .O(z14));
  ...
  nand3  g64(.a(new_n71_), .b(x26), .c(new_n68_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n49_), .O(z16));
  zero   g66(.O(z00));
endmodule
