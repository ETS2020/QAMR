...
module FAU ( 
  ...
  nor2   g037(.a(new_n81_), .b(new_n54_), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(x26), .c(x25), .O(new_n83_));
  oai21  g039(.a(new_n83_), .b(new_n80_), .c(x19), .O(new_n84_));
  nand4  g040(.a(new_n84_), .b(new_n47_), .c(x09), .d(new_n77_), .O(new_n85_));
  inv1   g041(.a(new_n46_), .O(new_n86_));
  aoi21  g042(.a(x08), .b(x00), .c(new_n86_), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n85_), .O(z09));
  inv1   g044(.a(x20), .O(new_n89_));
  nor3   g045(.a(new_n78_), .b(new_n89_), .c(x10), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n57_), .c(new_n55_), .d(new_n49_), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(x13), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(x12), .O(new_n93_));
  xor2a  g049(.a(x20), .b(x19), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n47_), .c(x09), .d(new_n77_), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n93_), .c(new_n63_), .O(z10));
  nand3  g052(.a(x23), .b(x22), .c(x13), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n56_), .c(x21), .O(new_n98_));
  nor2   g054(.a(new_n78_), .b(x19), .O(new_n99_));
  aoi21  g055(.a(new_n98_), .b(x19), .c(new_n99_), .O(new_n100_));
  nand2  g056(.a(x21), .b(new_n89_), .O(new_n101_));
  oai21  g057(.a(new_n100_), .b(new_n89_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n47_), .c(x09), .d(new_n77_), .O(new_n103_));
  nand2  g059(.a(x08), .b(x02), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n103_), .c(new_n93_), .O(z11));
  ...
  aoi21  g067(.a(x08), .b(x03), .c(new_n86_), .O(new_n112_));
  ...
  oai21  g071(.a(new_n115_), .b(new_n50_), .c(x23), .O(new_n116_));
  nand4  g072(.a(new_n51_), .b(new_n54_), .c(x22), .d(x21), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n47_), .c(x09), .d(new_n77_), .O(new_n119_));
  nand2  g075(.a(x08), .b(x04), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n119_), .c(new_n86_), .O(z13));
  ...
  aoi21  g085(.a(x08), .b(x05), .c(new_n86_), .O(new_n130_));
  ...
  aoi21  g094(.a(new_n138_), .b(new_n73_), .c(new_n86_), .O(z15));
  ...
  nand4  g100(.a(new_n144_), .b(new_n82_), .c(new_n79_), .d(new_n51_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n47_), .c(x09), .d(new_n77_), .O(new_n147_));
  nand2  g103(.a(x08), .b(x07), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n147_), .c(new_n86_), .O(z16));
endmodule
