...
module FAU ( 
  ...
  nor2   g025(.a(new_n46_), .b(new_n54_), .O(z07));
  inv1   g026(.a(x07), .O(new_n71_));
  nor2   g027(.a(new_n62_), .b(new_n71_), .O(z08));
  ...
  nand2  g044(.a(new_n88_), .b(new_n59_), .O(new_n89_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n119_), .c(x06), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n55_), .O(new_n122_));
  ...
  nand3  g084(.a(new_n128_), .b(new_n122_), .c(new_n66_), .O(z13));
  nand3  g085(.a(new_n75_), .b(x24), .c(new_n47_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x06), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n55_), .O(new_n132_));
  nand2  g088(.a(x20), .b(x19), .O(new_n133_));
  nand3  g089(.a(x26), .b(x25), .c(x16), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(x22), .c(x21), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n133_), .c(x24), .O(new_n136_));
  nor2   g092(.a(x24), .b(new_n55_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n123_), .c(x22), .O(new_n138_));
  ...
  nand3  g097(.a(new_n141_), .b(new_n140_), .c(new_n132_), .O(z14));
  nand4  g098(.a(x25), .b(new_n55_), .c(new_n47_), .d(x09), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n46_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x06), .O(new_n145_));
  nand2  g101(.a(x26), .b(x17), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x24), .c(x22), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n108_), .c(x25), .O(new_n148_));
  inv1   g104(.a(x25), .O(new_n149_));
  nand4  g105(.a(new_n123_), .b(new_n149_), .c(x24), .d(x22), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n148_), .c(new_n55_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n145_), .O(z15));
  nand3  g109(.a(new_n75_), .b(x26), .c(new_n47_), .O(new_n154_));
  ...
  oai21  g117(.a(new_n161_), .b(new_n120_), .c(new_n160_), .O(new_n162_));
