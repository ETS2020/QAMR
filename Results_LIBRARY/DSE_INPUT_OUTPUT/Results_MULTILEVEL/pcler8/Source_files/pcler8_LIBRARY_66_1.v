...
module FAU ( 
  ...
  nor2   g016(.a(new_n46_), .b(new_n55_), .O(z03));
  inv1   g017(.a(x03), .O(new_n62_));
  oai21  g018(.a(new_n46_), .b(new_n62_), .c(new_n56_), .O(z04));
  inv1   g019(.a(x04), .O(new_n64_));
  nor2   g020(.a(new_n57_), .b(new_n64_), .O(z05));
  inv1   g021(.a(x05), .O(new_n66_));
  nor2   g022(.a(new_n57_), .b(new_n66_), .O(z06));
  inv1   g023(.a(x06), .O(new_n68_));
  nor2   g024(.a(new_n57_), .b(new_n68_), .O(z07));
  inv1   g025(.a(x07), .O(new_n70_));
  oai21  g026(.a(new_n46_), .b(new_n70_), .c(new_n56_), .O(z08));
  ...
  inv1   g041(.a(new_n56_), .O(new_n86_));
  aoi21  g042(.a(x08), .b(x01), .c(new_n86_), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n85_), .O(z10));
  ...
  nor2   g048(.a(new_n72_), .b(x20), .O(new_n93_));
  ...
  nor2   g053(.a(z03), .b(new_n86_), .O(new_n98_));
  ...
  aoi21  g071(.a(x08), .b(x04), .c(new_n86_), .O(new_n116_));
  ...
  oai21  g082(.a(new_n57_), .b(new_n66_), .c(new_n126_), .O(z14));
  ...
  nor2   g087(.a(new_n112_), .b(new_n73_), .O(new_n132_));
  ...
  aoi21  g091(.a(x08), .b(x06), .c(new_n86_), .O(new_n136_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n104_), .c(new_n142_), .d(new_n74_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n146_));
  oai21  g102(.a(new_n57_), .b(new_n70_), .c(new_n146_), .O(z16));
endmodule
