...
module FAU ( 
  ...
  oai21  g19(.a(new_n57_), .b(new_n63_), .c(new_n46_), .O(z07));
  inv1   g20(.a(x07), .O(new_n65_));
  nor2   g21(.a(new_n50_), .b(new_n65_), .O(z08));
  oai21  g22(.a(new_n57_), .b(new_n52_), .c(new_n46_), .O(z10));
  nor2   g23(.a(new_n50_), .b(new_n56_), .O(z12));
  oai21  g24(.a(new_n57_), .b(new_n61_), .c(new_n46_), .O(z14));
  nor2   g25(.a(new_n50_), .b(new_n63_), .O(z15));
  nor2   g26(.a(new_n50_), .b(new_n48_), .O(z09));
