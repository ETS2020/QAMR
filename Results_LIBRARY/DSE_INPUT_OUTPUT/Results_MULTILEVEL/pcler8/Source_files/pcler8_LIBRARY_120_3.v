...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_,
    ...
    new_n93_, new_n95_, new_n96_, new_n98_, new_n99_, new_n101_;
  ...
  nand2  g18(.a(new_n52_), .b(x06), .O(new_n63_));
  ...
  nand4  g29(.a(new_n73_), .b(new_n67_), .c(x09), .d(new_n51_), .O(new_n74_));
  nand2  g30(.a(x08), .b(x01), .O(new_n75_));
  aoi21  g31(.a(new_n75_), .b(new_n74_), .c(z00), .O(z10));
  xnor2a g32(.a(x21), .b(x20), .O(new_n77_));
  nand2  g33(.a(x21), .b(new_n68_), .O(new_n78_));
  oai21  g34(.a(new_n77_), .b(new_n68_), .c(new_n78_), .O(new_n79_));
  nand4  g35(.a(new_n79_), .b(new_n67_), .c(x09), .d(new_n51_), .O(new_n80_));
  nand2  g36(.a(x08), .b(x02), .O(new_n81_));
  aoi21  g37(.a(new_n81_), .b(new_n80_), .c(z00), .O(z11));
  nand3  g38(.a(x21), .b(x20), .c(x19), .O(new_n83_));
  nand3  g39(.a(new_n83_), .b(new_n46_), .c(x22), .O(new_n84_));
  nand2  g40(.a(x20), .b(x19), .O(new_n85_));
  nand2  g41(.a(new_n45_), .b(x21), .O(new_n86_));
  oai21  g42(.a(new_n86_), .b(new_n85_), .c(new_n84_), .O(new_n87_));
  nand4  g43(.a(new_n87_), .b(new_n67_), .c(x09), .d(new_n51_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n57_), .O(z12));
  nand2  g45(.a(new_n52_), .b(x04), .O(new_n90_));
  nand3  g46(.a(new_n46_), .b(x22), .c(x21), .O(new_n91_));
  oai22  g47(.a(new_n91_), .b(new_n85_), .c(new_n46_), .d(x22), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n67_), .c(x09), .d(new_n51_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n90_), .O(z13));
  nand2  g50(.a(x08), .b(x05), .O(new_n95_));
  nand3  g51(.a(new_n70_), .b(x24), .c(new_n67_), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(new_n95_), .c(new_n48_), .O(z14));
  nand2  g53(.a(x08), .b(x06), .O(new_n98_));
  nand3  g54(.a(new_n70_), .b(x25), .c(new_n67_), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(new_n98_), .c(new_n48_), .O(z15));
  nand3  g56(.a(new_n70_), .b(x26), .c(new_n67_), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(new_n65_), .c(new_n48_), .O(z16));
endmodule
