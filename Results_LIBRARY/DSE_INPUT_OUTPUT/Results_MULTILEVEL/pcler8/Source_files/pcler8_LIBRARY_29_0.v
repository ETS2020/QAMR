...
module FAU ( 
  ...
  nand2  g024(.a(new_n59_), .b(x08), .O(new_n69_));
  ...
  nand2  g029(.a(new_n73_), .b(new_n59_), .O(z07));
  inv1   g030(.a(x07), .O(new_n75_));
  nor2   g031(.a(new_n69_), .b(new_n75_), .O(z08));
  ...
  aoi21  g037(.a(new_n81_), .b(new_n77_), .c(new_n57_), .O(new_n82_));
  oai21  g038(.a(new_n82_), .b(x10), .c(new_n60_), .O(z09));
  ...
  aoi21  g052(.a(new_n96_), .b(new_n77_), .c(new_n57_), .O(new_n97_));
  ...
  nand3  g059(.a(new_n99_), .b(new_n50_), .c(x21), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n103_), .c(x08), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n57_), .c(new_n58_), .O(new_n106_));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n50_), .O(new_n113_));
  nor2   g069(.a(new_n51_), .b(x22), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n113_), .c(new_n77_), .O(new_n115_));
  ...
  oai21  g082(.a(new_n126_), .b(new_n57_), .c(new_n58_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n71_), .O(z14));
  ...
  nand4  g088(.a(new_n124_), .b(new_n52_), .c(new_n132_), .d(x24), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n131_), .c(x08), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n57_), .c(new_n58_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n73_), .O(z15));
  ...
  nand4  g098(.a(new_n142_), .b(new_n99_), .c(new_n141_), .d(new_n78_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n58_), .c(x09), .d(new_n77_), .O(new_n145_));
  oai21  g101(.a(new_n69_), .b(new_n75_), .c(new_n145_), .O(z16));
endmodule
