...
module FAU ( 
  ...
  nand2  g010(.a(x23), .b(new_n54_), .O(new_n55_));
  ...
  nor4   g039(.a(new_n83_), .b(new_n82_), .c(new_n54_), .d(new_n81_), .O(new_n84_));
  ...
  oai21  g059(.a(new_n103_), .b(new_n102_), .c(new_n82_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n54_), .O(new_n105_));
  inv1   g061(.a(new_n103_), .O(new_n106_));
  nand2  g062(.a(x23), .b(x14), .O(new_n107_));
  oai22  g063(.a(new_n107_), .b(new_n83_), .c(new_n106_), .d(new_n54_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n105_), .c(new_n62_), .O(z12));
  ...
  nand3  g071(.a(new_n112_), .b(new_n82_), .c(x21), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n115_), .c(new_n54_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n118_));
  oai21  g074(.a(new_n65_), .b(new_n64_), .c(new_n118_), .O(z13));
  inv1   g075(.a(x24), .O(new_n120_));
  nand3  g076(.a(new_n112_), .b(new_n120_), .c(x21), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n102_), .c(x22), .O(new_n122_));
  ...
  nand3  g084(.a(new_n128_), .b(new_n123_), .c(new_n67_), .O(z14));
  ...
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(x22), .O(new_n133_));
  ...
  aoi21  g093(.a(new_n137_), .b(new_n106_), .c(new_n131_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n134_), .c(new_n69_), .O(z15));
  nand3  g096(.a(new_n55_), .b(x08), .c(x07), .O(new_n141_));
  nor2   g097(.a(new_n111_), .b(x18), .O(new_n142_));
  nand3  g098(.a(x25), .b(x24), .c(x21), .O(new_n143_));
  ...
  nor2   g102(.a(new_n146_), .b(new_n103_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n145_), .c(x22), .O(new_n148_));
  nand2  g104(.a(x26), .b(new_n82_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n141_), .O(z16));
endmodule
