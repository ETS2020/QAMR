...
module FAU ( 
  ...
  oai21  g020(.a(new_n48_), .b(new_n64_), .c(new_n47_), .O(z03));
  ...
  oai21  g030(.a(new_n48_), .b(new_n74_), .c(new_n47_), .O(z08));
  nor2   g031(.a(new_n46_), .b(new_n48_), .O(new_n76_));
  ...
  oai21  g039(.a(new_n77_), .b(new_n60_), .c(new_n83_), .O(z09));
  ...
  oai21  g045(.a(new_n77_), .b(new_n62_), .c(new_n89_), .O(z10));
  ...
  oai21  g053(.a(new_n77_), .b(new_n64_), .c(new_n97_), .O(z11));
  ...
  nand3  g061(.a(new_n105_), .b(new_n66_), .c(new_n47_), .O(z12));
  nand2  g062(.a(new_n76_), .b(x04), .O(new_n107_));
  ...
  nand3  g090(.a(new_n134_), .b(new_n72_), .c(new_n47_), .O(z15));
  ...
  oai21  g100(.a(new_n77_), .b(new_n74_), .c(new_n144_), .O(z16));
endmodule
