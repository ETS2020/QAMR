...
module FAU ( 
  ...
  oai21  g14(.a(x25), .b(x08), .c(new_n58_), .O(z03));
  ...
  oai21  g20(.a(x25), .b(x08), .c(new_n64_), .O(z06));
  ...
  nand4  g31(.a(new_n75_), .b(x25), .c(new_n47_), .d(x09), .O(new_n76_));
  oai21  g32(.a(new_n76_), .b(x08), .c(new_n54_), .O(z09));
  ...
  aoi21  g40(.a(new_n84_), .b(new_n82_), .c(x10), .O(new_n85_));
  aoi21  g41(.a(new_n85_), .b(x09), .c(new_n78_), .O(new_n86_));
  oai21  g42(.a(new_n86_), .b(x08), .c(new_n56_), .O(z10));
  nand2  g43(.a(x22), .b(x13), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n80_), .c(x20), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n83_), .c(x21), .O(new_n90_));
  inv1   g46(.a(x21), .O(new_n91_));
  nand3  g47(.a(new_n91_), .b(x20), .c(x19), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(new_n90_), .c(new_n78_), .O(new_n93_));
  nand4  g49(.a(new_n93_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n58_), .O(z11));
  ...
  nand3  g56(.a(new_n97_), .b(new_n71_), .c(x21), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(new_n100_), .c(new_n78_), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n60_), .O(z12));
  nand3  g60(.a(x26), .b(x24), .c(x15), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x22), .c(x21), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n96_), .c(x23), .O(new_n107_));
  nand4  g63(.a(new_n97_), .b(new_n72_), .c(x22), .d(x21), .O(new_n108_));
  aoi21  g64(.a(new_n108_), .b(new_n107_), .c(x10), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(x09), .c(new_n78_), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(x08), .c(new_n62_), .O(z13));
  ...
  nor2   g72(.a(x24), .b(new_n72_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n116_), .c(x22), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n115_), .c(new_n78_), .O(new_n119_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n116_), .c(new_n73_), .d(x24), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(x25), .c(new_n47_), .d(x09), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(x08), .c(new_n66_), .O(z15));
  ...
  nand4  g85(.a(new_n116_), .b(new_n73_), .c(new_n45_), .d(x24), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n129_), .c(x10), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(x09), .c(new_n78_), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(x08), .c(new_n68_), .O(z16));
endmodule
