...
module FAU ( 
  ...
  nor2   g009(.a(x18), .b(new_n47_), .O(new_n54_));
  ...
  aoi21  g020(.a(x08), .b(x04), .c(new_n54_), .O(new_n65_));
  ...
  oai21  g051(.a(new_n63_), .b(new_n60_), .c(new_n95_), .O(z11));
  ...
  nand3  g057(.a(new_n97_), .b(new_n74_), .c(x21), .O(new_n102_));
  ...
  oai21  g081(.a(new_n63_), .b(new_n67_), .c(new_n125_), .O(z14));
  ...
  nand3  g091(.a(new_n135_), .b(new_n69_), .c(new_n55_), .O(z15));
  ...
  nand4  g098(.a(new_n142_), .b(new_n97_), .c(new_n141_), .d(new_n75_), .O(new_n143_));
