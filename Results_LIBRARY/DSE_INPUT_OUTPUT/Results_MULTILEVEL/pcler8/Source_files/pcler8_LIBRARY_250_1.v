...
module FAU ( 
  ...
  nor2   g009(.a(new_n47_), .b(x07), .O(new_n54_));
  ...
  nand2  g020(.a(new_n64_), .b(new_n55_), .O(z04));
  ...
  nor2   g026(.a(new_n60_), .b(new_n70_), .O(z07));
  and2   g027(.a(x08), .b(x07), .O(z08));
  ...
  oai21  g042(.a(new_n60_), .b(new_n58_), .c(new_n86_), .O(z10));
  ...
  nand3  g061(.a(new_n105_), .b(new_n64_), .c(new_n55_), .O(z12));
  ...
  nand3  g082(.a(new_n126_), .b(new_n68_), .c(new_n55_), .O(z14));
  inv1   g083(.a(x23), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(new_n74_), .O(new_n129_));
  ...
  oai21  g092(.a(new_n60_), .b(new_n70_), .c(new_n136_), .O(z15));
  oai21  g093(.a(x10), .b(x07), .c(x08), .O(new_n138_));
  ...
  nor2   g098(.a(new_n122_), .b(new_n128_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n133_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n98_), .c(new_n143_), .d(new_n75_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n138_), .c(new_n55_), .O(z16));
endmodule
