...
module FAU ( 
  ...
  oai21  g015(.a(new_n46_), .b(new_n59_), .c(new_n56_), .O(z02));
  ...
  oai21  g027(.a(new_n46_), .b(new_n71_), .c(new_n56_), .O(z08));
  ...
  nand3  g052(.a(new_n96_), .b(new_n61_), .c(new_n56_), .O(z11));
  ...
  nand3  g092(.a(new_n136_), .b(new_n69_), .c(new_n56_), .O(z15));
  ...
  oai21  g102(.a(new_n57_), .b(new_n71_), .c(new_n146_), .O(z16));
endmodule
