...
module FAU ( 
  ...
  nor2   g010(.a(x24), .b(x14), .O(new_n55_));
  ...
  oai21  g048(.a(new_n91_), .b(new_n73_), .c(new_n92_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n61_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n56_), .O(new_n96_));
  inv1   g052(.a(x09), .O(new_n97_));
  nor2   g053(.a(new_n97_), .b(x08), .O(new_n98_));
  nand2  g054(.a(x21), .b(x13), .O(new_n99_));
  nor2   g055(.a(new_n99_), .b(x10), .O(new_n100_));
  inv1   g056(.a(x23), .O(new_n101_));
  nand3  g057(.a(x26), .b(x25), .c(x24), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n101_), .c(new_n74_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n100_), .c(new_n98_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n96_), .O(z11));
  nand3  g061(.a(x21), .b(x20), .c(x19), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(x22), .O(new_n107_));
  nand2  g063(.a(new_n74_), .b(x21), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n90_), .c(new_n107_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n63_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n56_), .O(new_n112_));
  nand4  g068(.a(new_n103_), .b(new_n98_), .c(x14), .d(new_n47_), .O(new_n113_));
  ...
  oai21  g072(.a(new_n116_), .b(new_n90_), .c(x23), .O(new_n117_));
  nand4  g073(.a(new_n91_), .b(new_n101_), .c(x22), .d(x21), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n120_));
  aoi21  g076(.a(x08), .b(x04), .c(new_n55_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n120_), .O(z13));
  inv1   g078(.a(x24), .O(new_n123_));
  nand3  g079(.a(new_n98_), .b(x19), .c(new_n47_), .O(new_n124_));
  nor2   g080(.a(new_n101_), .b(new_n74_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x21), .c(x20), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n124_), .c(x14), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  inv1   g084(.a(new_n106_), .O(new_n129_));
  ...
  nand3  g090(.a(new_n134_), .b(new_n128_), .c(new_n67_), .O(z14));
  nand3  g091(.a(new_n98_), .b(x25), .c(new_n47_), .O(new_n136_));
  ...
  oai21  g096(.a(new_n140_), .b(new_n106_), .c(x25), .O(new_n141_));
  inv1   g097(.a(x25), .O(new_n142_));
  nand4  g098(.a(new_n129_), .b(new_n125_), .c(new_n142_), .d(x24), .O(new_n143_));
  ...
  nand3  g103(.a(new_n98_), .b(x26), .c(new_n47_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x14), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n123_), .O(new_n150_));
  inv1   g106(.a(x18), .O(new_n151_));
  nand2  g107(.a(new_n91_), .b(new_n151_), .O(new_n152_));
  nand4  g108(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(x26), .O(new_n154_));
  nor2   g110(.a(new_n123_), .b(new_n101_), .O(new_n155_));
  nor2   g111(.a(x26), .b(new_n142_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n91_), .c(new_n155_), .d(new_n75_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n150_), .c(new_n71_), .O(z16));
endmodule
