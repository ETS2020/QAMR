...
module FAU ( 
  ...
  nor2   g022(.a(new_n59_), .b(new_n66_), .O(z05));
  ...
  oai21  g036(.a(new_n59_), .b(new_n54_), .c(new_n80_), .O(z09));
  ...
  oai21  g064(.a(new_n59_), .b(new_n64_), .c(new_n108_), .O(z12));
  ...
  oai21  g083(.a(new_n59_), .b(new_n68_), .c(new_n127_), .O(z14));
  ...
  aoi21  g092(.a(x08), .b(x06), .c(new_n88_), .O(new_n137_));
  ...
  nor2   g098(.a(new_n123_), .b(new_n113_), .O(new_n143_));
  ...
  oai21  g103(.a(new_n59_), .b(new_n72_), .c(new_n147_), .O(z16));
endmodule
