...
module FAU ( 
  ...
  nand2  g21(.a(new_n65_), .b(new_n54_), .O(z08));
  ...
  aoi21  g26(.a(new_n70_), .b(new_n67_), .c(z00), .O(z09));
  ...
  nand3  g37(.a(new_n81_), .b(new_n55_), .c(new_n54_), .O(z11));
  inv1   g38(.a(x22), .O(new_n83_));
  nand3  g39(.a(x21), .b(x20), .c(x19), .O(new_n84_));
  inv1   g40(.a(new_n84_), .O(new_n85_));
  nand2  g41(.a(new_n83_), .b(x21), .O(new_n86_));
  oai22  g42(.a(new_n86_), .b(new_n76_), .c(new_n85_), .d(new_n83_), .O(new_n87_));
  nand4  g43(.a(new_n87_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n88_));
  nand3  g44(.a(new_n88_), .b(new_n57_), .c(new_n54_), .O(z12));
  ...
  aoi21  g52(.a(new_n96_), .b(new_n95_), .c(z00), .O(z13));
  nand3  g53(.a(x23), .b(x22), .c(x21), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n76_), .c(x24), .O(new_n99_));
  nand3  g55(.a(new_n45_), .b(x23), .c(x22), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n84_), .c(new_n99_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n61_), .c(new_n54_), .O(z14));
  nand4  g59(.a(x19), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n104_));
  inv1   g60(.a(x25), .O(new_n105_));
  and2   g61(.a(x21), .b(x20), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(new_n105_), .c(x23), .d(x22), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n104_), .c(new_n46_), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(x24), .O(new_n109_));
  nand3  g65(.a(x24), .b(x23), .c(x22), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n85_), .c(new_n105_), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n113_));
  nand2  g69(.a(x08), .b(x06), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(new_n109_), .O(z15));
  nand4  g71(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n84_), .c(new_n46_), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n65_), .c(new_n54_), .O(z16));
endmodule
