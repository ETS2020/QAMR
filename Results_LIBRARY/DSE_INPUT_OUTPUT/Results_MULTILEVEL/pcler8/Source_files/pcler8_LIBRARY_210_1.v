...
module FAU ( 
  ...
  nor2   g022(.a(new_n58_), .b(new_n66_), .O(z05));
  nand2  g023(.a(new_n57_), .b(x05), .O(new_n68_));
  inv1   g024(.a(new_n68_), .O(z06));
  nand2  g025(.a(new_n57_), .b(x06), .O(new_n70_));
  ...
  nand2  g034(.a(new_n78_), .b(new_n60_), .O(new_n79_));
  ...
  nand3  g040(.a(new_n84_), .b(new_n81_), .c(new_n76_), .O(new_n85_));
  ...
  nand3  g048(.a(new_n92_), .b(new_n84_), .c(new_n76_), .O(new_n93_));
  ...
  nand2  g054(.a(new_n98_), .b(new_n63_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n60_), .O(new_n100_));
  nand2  g056(.a(x19), .b(x13), .O(new_n101_));
  nor2   g057(.a(new_n101_), .b(x10), .O(new_n102_));
  nand3  g058(.a(x23), .b(x22), .c(x20), .O(new_n103_));
  nor2   g059(.a(new_n103_), .b(new_n83_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n102_), .c(new_n76_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n100_), .O(z11));
  inv1   g062(.a(x22), .O(new_n107_));
  nand3  g063(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n108_));
  nand3  g064(.a(x21), .b(x20), .c(x19), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n108_), .c(new_n55_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  nand2  g067(.a(new_n109_), .b(x22), .O(new_n112_));
  nand2  g068(.a(x23), .b(x14), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n83_), .c(new_n112_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n115_));
  nand2  g071(.a(x08), .b(x03), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n115_), .c(new_n111_), .O(z12));
  nand2  g073(.a(x20), .b(x19), .O(new_n118_));
  ...
  nand2  g098(.a(x25), .b(new_n55_), .O(new_n143_));
  oai21  g099(.a(new_n142_), .b(new_n107_), .c(new_n143_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n70_), .O(z15));
  nand2  g102(.a(new_n57_), .b(x07), .O(new_n147_));
  nor2   g103(.a(new_n118_), .b(x18), .O(new_n148_));
