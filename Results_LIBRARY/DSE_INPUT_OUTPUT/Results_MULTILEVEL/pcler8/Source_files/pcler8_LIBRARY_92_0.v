...
module FAU ( 
  ...
  nand2  g015(.a(new_n59_), .b(new_n57_), .O(z02));
  ...
  oai22  g036(.a(new_n80_), .b(new_n75_), .c(new_n65_), .d(new_n55_), .O(z09));
  ...
  aoi21  g044(.a(new_n88_), .b(new_n47_), .c(new_n75_), .O(new_n89_));
  ...
  nand3  g050(.a(x21), .b(new_n94_), .c(new_n47_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  aoi21  g052(.a(new_n93_), .b(x19), .c(new_n96_), .O(new_n97_));
  nand2  g053(.a(x21), .b(new_n86_), .O(new_n98_));
  oai21  g054(.a(new_n97_), .b(new_n86_), .c(new_n98_), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(x09), .c(new_n75_), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(x10), .c(new_n61_), .O(z11));
  nor2   g057(.a(new_n86_), .b(new_n94_), .O(new_n102_));
  ...
  nand2  g076(.a(new_n120_), .b(new_n67_), .O(z13));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n124_), .c(new_n82_), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n47_), .c(new_n75_), .O(new_n129_));
  oai22  g085(.a(new_n129_), .b(x10), .c(new_n47_), .d(new_n69_), .O(z14));
  ...
  oai21  g095(.a(new_n65_), .b(new_n71_), .c(new_n139_), .O(z15));
  ...
  nand4  g102(.a(new_n146_), .b(new_n102_), .c(new_n145_), .d(new_n76_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n144_), .c(new_n82_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n47_), .c(new_n75_), .O(new_n149_));
