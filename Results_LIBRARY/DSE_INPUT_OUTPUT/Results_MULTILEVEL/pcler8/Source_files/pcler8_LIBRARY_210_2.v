...
module FAU ( 
  ...
  nand2  g046(.a(new_n90_), .b(new_n61_), .O(new_n91_));
  ...
  nand3  g069(.a(new_n113_), .b(new_n55_), .c(x21), .O(new_n114_));
  oai21  g070(.a(new_n111_), .b(new_n55_), .c(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n116_));
  aoi21  g072(.a(x08), .b(x03), .c(new_n56_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n116_), .O(z12));
  ...
  oai22  g078(.a(new_n122_), .b(x08), .c(new_n58_), .d(new_n66_), .O(z13));
  inv1   g079(.a(x23), .O(new_n124_));
  nand3  g080(.a(x26), .b(x25), .c(x16), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n113_), .c(x21), .O(new_n126_));
  ...
  nand2  g089(.a(new_n133_), .b(new_n68_), .O(z14));
  ...
  oai21  g096(.a(new_n139_), .b(new_n124_), .c(new_n140_), .O(new_n141_));
