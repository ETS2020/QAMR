...
module FAU ( 
  ...
  nor2   g010(.a(x11), .b(new_n47_), .O(new_n55_));
  ...
  nand3  g062(.a(new_n106_), .b(new_n64_), .c(new_n59_), .O(z12));
  ...
  oai21  g081(.a(new_n57_), .b(new_n67_), .c(new_n125_), .O(z14));
  ...
  nor2   g086(.a(new_n111_), .b(new_n74_), .O(new_n131_));
  ...
  oai21  g090(.a(new_n57_), .b(new_n69_), .c(new_n134_), .O(z15));
  ...
  nor2   g095(.a(new_n121_), .b(new_n111_), .O(new_n140_));
  nor2   g096(.a(x26), .b(new_n130_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n103_), .c(new_n140_), .d(new_n75_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n71_), .c(new_n59_), .O(z16));
endmodule
