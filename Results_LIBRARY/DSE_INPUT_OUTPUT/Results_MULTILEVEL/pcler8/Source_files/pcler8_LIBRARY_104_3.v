...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_,
    ...
    new_n93_, new_n94_, new_n95_, new_n96_, new_n98_, new_n100_, new_n102_,
    new_n103_;
  ...
  nand3  g39(.a(new_n84_), .b(new_n56_), .c(new_n55_), .O(z11));
  ...
  oai21  g48(.a(new_n93_), .b(new_n79_), .c(new_n48_), .O(new_n94_));
  ...
  nand3  g52(.a(new_n70_), .b(x24), .c(new_n74_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n62_), .c(new_n49_), .O(z14));
  nand3  g54(.a(new_n70_), .b(x25), .c(new_n74_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n64_), .c(new_n55_), .O(z15));
  nand2  g56(.a(x08), .b(x07), .O(new_n102_));
  nand3  g57(.a(new_n70_), .b(x26), .c(new_n74_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n102_), .c(new_n49_), .O(z16));
  zero   g59(.O(z00));
endmodule
