...
module FAU ( 
  ...
  nand2  g11(.a(new_n55_), .b(new_n48_), .O(new_n56_));
  ...
  nand2  g33(.a(new_n77_), .b(x18), .O(new_n78_));
  ...
  oai21  g38(.a(new_n82_), .b(new_n75_), .c(x20), .O(new_n83_));
  ...
  aoi21  g43(.a(new_n87_), .b(new_n47_), .c(new_n55_), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(x10), .c(new_n59_), .O(z10));
  ...
  oai21  g53(.a(new_n64_), .b(new_n61_), .c(new_n97_), .O(z11));
  nand2  g54(.a(x20), .b(x19), .O(new_n99_));
  nand2  g55(.a(x23), .b(x14), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n91_), .c(x21), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n99_), .c(x22), .O(new_n102_));
  inv1   g58(.a(new_n99_), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n46_), .c(x21), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n102_), .c(new_n81_), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n47_), .c(new_n55_), .O(new_n106_));
  nand2  g62(.a(x08), .b(x03), .O(new_n107_));
  oai21  g63(.a(new_n106_), .b(x10), .c(new_n107_), .O(z12));
  ...
  nand4  g68(.a(new_n103_), .b(new_n112_), .c(x22), .d(x21), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n111_), .c(new_n81_), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n47_), .c(new_n55_), .O(new_n115_));
  ...
  aoi21  g79(.a(new_n123_), .b(new_n120_), .c(new_n55_), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n125_));
  oai21  g81(.a(new_n64_), .b(new_n68_), .c(new_n125_), .O(z14));
  ...
  nor2   g86(.a(new_n112_), .b(new_n46_), .O(new_n131_));
  nand4  g87(.a(new_n121_), .b(new_n131_), .c(new_n130_), .d(x24), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n129_), .c(new_n81_), .O(new_n133_));
  aoi21  g89(.a(new_n133_), .b(new_n47_), .c(new_n55_), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(x10), .c(new_n70_), .O(z15));
  nand3  g91(.a(new_n131_), .b(x25), .c(x24), .O(new_n136_));
