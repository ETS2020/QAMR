...
module FAU ( 
  ...
  and2   g17(.a(new_n59_), .b(x01), .O(z02));
  ...
  nand2  g46(.a(new_n59_), .b(x02), .O(new_n91_));
  ...
  nand2  g78(.a(new_n59_), .b(x06), .O(new_n123_));
  ...
  nand4  g83(.a(new_n118_), .b(new_n54_), .c(new_n127_), .d(x24), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n123_), .O(z15));
  ...
  nand4  g95(.a(new_n139_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n140_));
