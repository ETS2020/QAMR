...
module FAU ( 
  ...
  nand3  g062(.a(new_n80_), .b(new_n78_), .c(x24), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n106_), .c(new_n101_), .O(z11));
  ...
  oai22  g072(.a(new_n116_), .b(new_n95_), .c(new_n115_), .d(new_n113_), .O(new_n117_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n95_), .c(new_n122_), .O(new_n125_));
  ...
  nand3  g085(.a(new_n80_), .b(x24), .c(x23), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n103_), .c(x15), .d(new_n47_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n129_), .O(z13));
  nand3  g089(.a(new_n103_), .b(x19), .c(new_n47_), .O(new_n134_));
  nand2  g090(.a(new_n78_), .b(new_n75_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n134_), .c(new_n79_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n55_), .O(new_n137_));
  nor3   g093(.a(new_n95_), .b(new_n77_), .c(new_n74_), .O(new_n138_));
  nand2  g094(.a(new_n80_), .b(x16), .O(new_n139_));
  oai21  g095(.a(new_n138_), .b(new_n55_), .c(new_n139_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n137_), .c(new_n67_), .O(z14));
  nand2  g098(.a(x26), .b(x17), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(x23), .c(x22), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n114_), .c(x25), .O(new_n145_));
  nand4  g101(.a(new_n115_), .b(new_n79_), .c(x23), .d(x22), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n145_), .c(new_n55_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n148_));
  oai21  g104(.a(new_n57_), .b(new_n69_), .c(new_n148_), .O(z15));
  nand4  g105(.a(new_n75_), .b(new_n45_), .c(x23), .d(x22), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n134_), .c(x24), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x25), .O(new_n152_));
  nand4  g108(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n153_));
  nor3   g109(.a(new_n153_), .b(new_n95_), .c(x18), .O(new_n154_));
  nor2   g110(.a(new_n154_), .b(new_n45_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n152_), .c(new_n71_), .O(z16));
endmodule
