...
module FAU ( 
  ...
  nand2  g09(.a(x25), .b(x10), .O(new_n54_));
  ...
  oai21  g17(.a(new_n46_), .b(new_n61_), .c(new_n54_), .O(z03));
  ...
  nand3  g37(.a(new_n75_), .b(x19), .c(x12), .O(new_n82_));
  oai22  g38(.a(new_n82_), .b(new_n77_), .c(new_n81_), .d(x10), .O(new_n83_));
  nand3  g39(.a(new_n83_), .b(x09), .c(new_n46_), .O(new_n84_));
  nand2  g40(.a(x08), .b(x01), .O(new_n85_));
  nand3  g41(.a(new_n85_), .b(new_n84_), .c(new_n54_), .O(z10));
  ...
  oai21  g46(.a(new_n90_), .b(new_n87_), .c(x21), .O(new_n91_));
  ...
  oai21  g50(.a(new_n55_), .b(new_n61_), .c(new_n94_), .O(z11));
  nand3  g51(.a(x14), .b(x09), .c(new_n46_), .O(new_n96_));
  inv1   g52(.a(x23), .O(new_n97_));
  nor2   g53(.a(new_n97_), .b(new_n74_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(x26), .c(x24), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n96_), .c(new_n47_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(x25), .O(new_n101_));
  nand3  g57(.a(x21), .b(x20), .c(x19), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(new_n103_));
  nand2  g59(.a(x20), .b(x19), .O(new_n104_));
  nand2  g60(.a(new_n74_), .b(x21), .O(new_n105_));
  oai22  g61(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n74_), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(new_n101_), .c(new_n63_), .O(z12));
  nand4  g64(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(x22), .c(x21), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n104_), .c(x23), .O(new_n111_));
  inv1   g67(.a(new_n104_), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(new_n97_), .c(x22), .d(x21), .O(new_n113_));
  ...
  oai21  g74(.a(new_n118_), .b(new_n102_), .c(x24), .O(new_n119_));
  nor2   g75(.a(x24), .b(new_n97_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n103_), .c(x22), .O(new_n121_));
  ...
  oai21  g82(.a(new_n126_), .b(new_n102_), .c(x25), .O(new_n127_));
  inv1   g83(.a(x25), .O(new_n128_));
  nand4  g84(.a(new_n103_), .b(new_n98_), .c(new_n128_), .d(x24), .O(new_n129_));
  ...
  nand3  g88(.a(new_n112_), .b(x09), .c(new_n46_), .O(new_n133_));
  nand4  g89(.a(new_n75_), .b(new_n45_), .c(x24), .d(x23), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n133_), .c(new_n47_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(x25), .O(new_n136_));
  inv1   g92(.a(x18), .O(new_n137_));
  nand4  g93(.a(x21), .b(x20), .c(x19), .d(new_n137_), .O(new_n138_));
  nand4  g94(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n139_));
  ...
  nand3  g99(.a(new_n143_), .b(new_n142_), .c(new_n136_), .O(z16));
endmodule
