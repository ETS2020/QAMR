...
module FAU ( 
  ...
  nand2  g011(.a(x10), .b(new_n55_), .O(new_n56_));
  ...
  inv1   g043(.a(new_n56_), .O(new_n88_));
  aoi21  g044(.a(x08), .b(x01), .c(new_n88_), .O(new_n89_));
  ...
  oai21  g083(.a(new_n57_), .b(new_n68_), .c(new_n127_), .O(z14));
  ...
  nor2   g088(.a(new_n113_), .b(new_n75_), .O(new_n133_));
  ...
  oai21  g092(.a(new_n57_), .b(new_n70_), .c(new_n136_), .O(z15));
  ...
  nor2   g097(.a(new_n123_), .b(new_n113_), .O(new_n142_));
  ...
  nand3  g102(.a(new_n146_), .b(new_n72_), .c(new_n56_), .O(z16));
endmodule
