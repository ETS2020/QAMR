...
module FAU ( 
  ...
  oai21  g12(.a(new_n56_), .b(new_n55_), .c(new_n46_), .O(z04));
  inv1   g13(.a(x04), .O(new_n58_));
  nor2   g14(.a(new_n49_), .b(new_n58_), .O(z05));
  ...
  oai21  g20(.a(new_n56_), .b(new_n64_), .c(new_n46_), .O(z08));
  ...
  aoi21  g35(.a(new_n79_), .b(new_n56_), .c(x22), .O(new_n80_));
  nand2  g36(.a(x08), .b(x02), .O(new_n81_));
  oai21  g37(.a(new_n80_), .b(x10), .c(new_n81_), .O(z11));
  nand3  g38(.a(new_n45_), .b(x09), .c(new_n56_), .O(new_n83_));
  nand4  g39(.a(new_n71_), .b(x21), .c(x20), .d(x19), .O(new_n84_));
  oai22  g40(.a(new_n84_), .b(new_n83_), .c(new_n49_), .d(new_n55_), .O(z12));
  nand4  g41(.a(new_n67_), .b(x23), .c(new_n71_), .d(new_n45_), .O(new_n86_));
  oai21  g42(.a(new_n49_), .b(new_n58_), .c(new_n86_), .O(z13));
  ...
  oai21  g46(.a(new_n56_), .b(new_n60_), .c(new_n90_), .O(z14));
  nand2  g47(.a(x25), .b(x09), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(x08), .c(new_n71_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n45_), .O(new_n94_));
  oai21  g50(.a(new_n56_), .b(new_n62_), .c(new_n94_), .O(z15));
  nand4  g51(.a(new_n67_), .b(x26), .c(new_n71_), .d(new_n45_), .O(new_n96_));
  oai21  g52(.a(new_n49_), .b(new_n64_), .c(new_n96_), .O(z16));
endmodule
