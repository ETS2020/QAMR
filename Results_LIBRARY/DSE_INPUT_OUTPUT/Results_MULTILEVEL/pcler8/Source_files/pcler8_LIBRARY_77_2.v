...
module FAU ( 
  ...
  aoi21  g025(.a(x23), .b(new_n46_), .c(new_n54_), .O(z07));
  nand2  g026(.a(x08), .b(x07), .O(new_n71_));
  nand2  g027(.a(new_n71_), .b(new_n63_), .O(z08));
  ...
  nand2  g040(.a(x09), .b(new_n46_), .O(new_n85_));
  ...
  nand4  g048(.a(new_n92_), .b(new_n90_), .c(new_n87_), .d(x21), .O(new_n93_));
  ...
  nand2  g070(.a(new_n56_), .b(x04), .O(new_n115_));
  nand3  g071(.a(x21), .b(x20), .c(x19), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand3  g073(.a(new_n75_), .b(x24), .c(x15), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n117_), .c(x22), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x23), .O(new_n120_));
  nor2   g076(.a(x23), .b(new_n88_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n110_), .c(x21), .d(new_n54_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n115_), .O(z13));
  nand2  g081(.a(new_n56_), .b(x05), .O(new_n126_));
  nand3  g082(.a(x26), .b(x25), .c(x16), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n110_), .c(x22), .d(x21), .O(new_n128_));
  inv1   g084(.a(x24), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x22), .c(x21), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(new_n106_), .O(new_n131_));
  aoi21  g087(.a(new_n128_), .b(x24), .c(new_n131_), .O(new_n132_));
  nand3  g088(.a(x24), .b(new_n89_), .c(new_n54_), .O(new_n133_));
  oai21  g089(.a(new_n132_), .b(new_n89_), .c(new_n133_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n126_), .O(z14));
  inv1   g092(.a(z07), .O(new_n137_));
  nand2  g093(.a(x26), .b(x17), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n90_), .c(x24), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n116_), .c(x25), .O(new_n140_));
  nand4  g096(.a(new_n117_), .b(new_n90_), .c(new_n74_), .d(x24), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n137_), .O(z15));
  nand3  g100(.a(x26), .b(new_n89_), .c(new_n47_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n85_), .c(new_n71_), .O(new_n146_));
  ...
  and2   g107(.a(x24), .b(x22), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n117_), .c(new_n45_), .d(x25), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n71_), .O(new_n156_));
