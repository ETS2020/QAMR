...
module FAU ( 
  ...
  oai21  g044(.a(new_n46_), .b(new_n59_), .c(new_n88_), .O(new_n89_));
  ...
  nand3  g101(.a(new_n145_), .b(new_n144_), .c(new_n138_), .O(z15));
  nor2   g102(.a(new_n107_), .b(x18), .O(new_n147_));
