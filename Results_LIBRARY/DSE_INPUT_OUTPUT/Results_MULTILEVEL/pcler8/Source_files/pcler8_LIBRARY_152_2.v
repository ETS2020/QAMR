...
module FAU ( 
  ...
  nor2   g17(.a(new_n52_), .b(new_n61_), .O(z06));
  ...
  oai21  g22(.a(new_n59_), .b(new_n50_), .c(new_n46_), .O(z10));
  oai21  g23(.a(new_n59_), .b(new_n54_), .c(new_n46_), .O(z11));
  nor2   g24(.a(new_n52_), .b(new_n58_), .O(z13));
  nand2  g25(.a(new_n48_), .b(new_n46_), .O(z09));
  nor2   g26(.a(new_n52_), .b(new_n56_), .O(z12));
  nor2   g27(.a(new_n52_), .b(new_n61_), .O(z14));
