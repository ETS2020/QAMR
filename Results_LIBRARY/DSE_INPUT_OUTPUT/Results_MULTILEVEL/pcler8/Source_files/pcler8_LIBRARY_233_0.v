...
module FAU ( 
  ...
  nand4  g37(.a(new_n81_), .b(new_n59_), .c(x09), .d(new_n70_), .O(new_n82_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n59_), .c(x09), .d(new_n70_), .O(new_n96_));
  ...
  oai21  g60(.a(new_n104_), .b(new_n58_), .c(new_n59_), .O(new_n105_));
  ...
  nand4  g68(.a(new_n112_), .b(new_n59_), .c(x09), .d(new_n70_), .O(new_n113_));
  oai21  g69(.a(new_n61_), .b(new_n69_), .c(new_n113_), .O(z13));
  ...
  oai21  g86(.a(new_n130_), .b(new_n58_), .c(new_n59_), .O(new_n131_));
  ...
  oai21  g96(.a(new_n140_), .b(new_n58_), .c(new_n59_), .O(new_n141_));
