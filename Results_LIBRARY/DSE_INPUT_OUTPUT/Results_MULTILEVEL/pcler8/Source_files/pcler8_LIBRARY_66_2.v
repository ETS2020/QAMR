...
module FAU ( 
  ...
  oai21  g016(.a(x10), .b(new_n47_), .c(x08), .O(new_n61_));
  ...
  oai21  g029(.a(new_n48_), .b(new_n73_), .c(new_n57_), .O(z08));
  ...
  oai22  g036(.a(new_n80_), .b(x02), .c(new_n58_), .d(new_n56_), .O(z09));
  ...
  oai21  g046(.a(new_n89_), .b(x10), .c(new_n90_), .O(z10));
  oai21  g047(.a(new_n49_), .b(x08), .c(x02), .O(new_n92_));
  ...
  nor2   g051(.a(new_n75_), .b(x19), .O(new_n96_));
  ...
  nand3  g057(.a(new_n57_), .b(x08), .c(x03), .O(new_n102_));
  ...
  aoi21  g073(.a(new_n117_), .b(new_n48_), .c(x02), .O(new_n118_));
  nand2  g074(.a(x08), .b(x04), .O(new_n119_));
  oai21  g075(.a(new_n118_), .b(x10), .c(new_n119_), .O(z13));
  ...
  oai21  g085(.a(new_n58_), .b(new_n69_), .c(new_n129_), .O(z14));
  ...
  nand4  g091(.a(new_n126_), .b(new_n135_), .c(new_n134_), .d(x24), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n133_), .c(new_n82_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n48_), .c(x02), .O(new_n138_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n107_), .c(new_n145_), .d(new_n76_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n144_), .c(x10), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n149_));
  oai21  g105(.a(new_n58_), .b(new_n73_), .c(new_n149_), .O(z16));
endmodule
