...
module FAU ( 
  ...
  inv1   g052(.a(new_n55_), .O(new_n97_));
  ...
  nand3  g063(.a(new_n107_), .b(new_n63_), .c(new_n55_), .O(z12));
  ...
  oai21  g082(.a(new_n61_), .b(new_n67_), .c(new_n126_), .O(z14));
  ...
  oai21  g101(.a(new_n61_), .b(new_n71_), .c(new_n145_), .O(z16));
endmodule
