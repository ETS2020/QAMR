...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n61_, new_n63_, new_n64_, new_n66_, new_n69_, new_n71_,
  ...
  nand3  g009(.a(x26), .b(x25), .c(x23), .O(new_n54_));
  ...
  nor3   g023(.a(x24), .b(new_n58_), .c(new_n45_), .O(z04));
  ...
  nand2  g031(.a(new_n75_), .b(new_n63_), .O(z08));
  ...
  nand4  g044(.a(new_n88_), .b(new_n83_), .c(new_n49_), .d(new_n45_), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(new_n81_), .O(z09));
  xor2a  g046(.a(x20), .b(x19), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n47_), .c(x09), .d(new_n58_), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n64_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n63_), .O(new_n94_));
  nand2  g050(.a(x19), .b(x12), .O(new_n95_));
  nor2   g051(.a(new_n95_), .b(x10), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n88_), .c(new_n49_), .d(new_n45_), .O(new_n97_));
  ...
  oai21  g057(.a(new_n51_), .b(new_n52_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n47_), .c(x09), .d(new_n58_), .O(new_n103_));
  aoi21  g059(.a(x08), .b(x02), .c(new_n59_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n103_), .O(z11));
  oai21  g061(.a(x24), .b(x08), .c(x03), .O(new_n106_));
  nand2  g062(.a(x23), .b(x14), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n87_), .c(x21), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n50_), .c(x22), .O(new_n109_));
  nand3  g065(.a(new_n51_), .b(new_n53_), .c(x21), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n47_), .c(x09), .d(new_n58_), .O(new_n112_));
  ...
  nand3  g071(.a(new_n84_), .b(x22), .c(x21), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n50_), .c(new_n115_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n47_), .c(x09), .d(new_n58_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n69_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n63_), .O(new_n120_));
  nor2   g076(.a(x10), .b(new_n48_), .O(new_n121_));
  nand2  g077(.a(x23), .b(x15), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n87_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n121_), .c(new_n58_), .d(new_n45_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n120_), .O(z13));
  and2   g081(.a(x21), .b(x20), .O(new_n126_));
  ...
  nand3  g086(.a(new_n46_), .b(x23), .c(x22), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n127_), .c(new_n130_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n47_), .c(x09), .d(new_n58_), .O(new_n133_));
  aoi21  g089(.a(x08), .b(x05), .c(new_n59_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n133_), .O(z14));
  nand3  g091(.a(new_n49_), .b(x19), .c(new_n47_), .O(new_n136_));
  inv1   g092(.a(x25), .O(new_n137_));
  nand4  g093(.a(new_n126_), .b(new_n137_), .c(x23), .d(x22), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n136_), .c(new_n45_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x24), .O(new_n140_));
  nand2  g096(.a(x26), .b(x17), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n85_), .c(x24), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n127_), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n137_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n47_), .c(x09), .d(new_n58_), .O(new_n145_));
  ...
  oai21  g111(.a(new_n155_), .b(new_n153_), .c(new_n45_), .O(new_n156_));
  ...
  nand2  g115(.a(new_n159_), .b(new_n148_), .O(z16));
endmodule
