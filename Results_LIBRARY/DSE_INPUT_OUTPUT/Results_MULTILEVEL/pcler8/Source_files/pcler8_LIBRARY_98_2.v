...
module FAU ( 
  ...
  oai21  g022(.a(new_n48_), .b(new_n66_), .c(new_n58_), .O(z05));
  inv1   g023(.a(x05), .O(new_n68_));
  oai21  g024(.a(new_n48_), .b(new_n68_), .c(new_n58_), .O(z06));
  aoi21  g025(.a(x10), .b(new_n48_), .c(new_n47_), .O(z07));
  ...
  oai22  g035(.a(new_n79_), .b(x06), .c(new_n73_), .d(new_n56_), .O(z09));
  ...
  oai21  g043(.a(new_n73_), .b(new_n60_), .c(new_n87_), .O(z10));
  nand2  g044(.a(new_n64_), .b(x02), .O(new_n89_));
  ...
  nand2  g050(.a(x21), .b(new_n84_), .O(new_n95_));
  oai21  g051(.a(new_n94_), .b(new_n84_), .c(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(x06), .c(new_n89_), .O(z11));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n48_), .c(x06), .O(new_n107_));
  nand2  g063(.a(x08), .b(x03), .O(new_n108_));
  oai21  g064(.a(new_n107_), .b(x10), .c(new_n108_), .O(z12));
  ...
  oai21  g072(.a(new_n73_), .b(new_n66_), .c(new_n116_), .O(z13));
  ...
  oai21  g082(.a(new_n73_), .b(new_n68_), .c(new_n126_), .O(z14));
  inv1   g083(.a(z07), .O(new_n128_));
  nor2   g084(.a(new_n113_), .b(new_n46_), .O(new_n129_));
  ...
  nand4  g101(.a(new_n145_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n146_));
