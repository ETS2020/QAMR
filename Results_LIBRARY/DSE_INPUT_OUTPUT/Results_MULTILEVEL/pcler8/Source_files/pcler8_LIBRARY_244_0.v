...
module FAU ( 
  ...
  oai21  g23(.a(new_n67_), .b(new_n66_), .c(new_n59_), .O(z04));
  inv1   g24(.a(x04), .O(new_n69_));
  nand2  g25(.a(new_n59_), .b(x08), .O(new_n70_));
  ...
  aoi21  g37(.a(new_n81_), .b(new_n67_), .c(new_n57_), .O(new_n82_));
  ...
  nand2  g44(.a(new_n88_), .b(new_n58_), .O(new_n89_));
  ...
  aoi21  g52(.a(new_n96_), .b(new_n67_), .c(new_n57_), .O(new_n97_));
  ...
  nand4  g61(.a(new_n105_), .b(new_n58_), .c(x09), .d(new_n67_), .O(new_n106_));
  oai21  g62(.a(new_n70_), .b(new_n66_), .c(new_n106_), .O(z12));
  ...
  oai21  g68(.a(new_n112_), .b(new_n57_), .c(new_n58_), .O(new_n113_));
  ...
  oai21  g78(.a(new_n122_), .b(new_n57_), .c(new_n58_), .O(new_n123_));
  oai21  g79(.a(new_n67_), .b(new_n72_), .c(new_n123_), .O(z14));
  ...
  oai21  g86(.a(new_n130_), .b(new_n57_), .c(new_n58_), .O(new_n131_));
  ...
  oai21  g96(.a(new_n140_), .b(new_n57_), .c(new_n58_), .O(new_n141_));
