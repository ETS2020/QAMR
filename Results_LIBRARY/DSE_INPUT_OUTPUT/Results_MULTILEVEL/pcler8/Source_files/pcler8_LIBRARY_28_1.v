...
module FAU ( 
  ...
  nand2  g068(.a(new_n110_), .b(x22), .O(new_n113_));
  nand2  g069(.a(x23), .b(x14), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n84_), .c(new_n113_), .O(new_n115_));
  ...
  nand2  g092(.a(new_n57_), .b(x06), .O(new_n137_));
  nand2  g093(.a(x26), .b(x17), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n119_), .c(x24), .d(x21), .O(new_n139_));
  inv1   g095(.a(x25), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(x24), .c(x23), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n110_), .O(new_n142_));
  aoi21  g098(.a(new_n139_), .b(x25), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(x25), .b(new_n55_), .O(new_n144_));
  oai21  g100(.a(new_n143_), .b(new_n108_), .c(new_n144_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n137_), .O(z15));
  nand3  g103(.a(new_n77_), .b(x19), .c(new_n47_), .O(new_n148_));
  nor2   g104(.a(x26), .b(new_n140_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(x24), .c(x21), .d(x20), .O(new_n150_));
