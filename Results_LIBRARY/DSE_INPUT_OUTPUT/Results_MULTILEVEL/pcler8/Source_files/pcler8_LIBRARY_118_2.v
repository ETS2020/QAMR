...
module FAU ( 
  ...
  oai21  g018(.a(new_n46_), .b(new_n62_), .c(new_n55_), .O(z04));
  ...
  nor2   g023(.a(new_n65_), .b(new_n67_), .O(z06));
  inv1   g024(.a(x06), .O(new_n69_));
  oai21  g025(.a(new_n46_), .b(new_n69_), .c(new_n55_), .O(z07));
  inv1   g026(.a(x07), .O(new_n71_));
  nor2   g027(.a(new_n65_), .b(new_n71_), .O(z08));
  ...
  nand3  g042(.a(new_n86_), .b(new_n58_), .c(new_n55_), .O(z10));
  ...
  oai21  g051(.a(new_n65_), .b(new_n60_), .c(new_n95_), .O(z11));
  ...
  oai21  g060(.a(new_n65_), .b(new_n62_), .c(new_n104_), .O(z12));
  ...
  nand3  g069(.a(new_n113_), .b(new_n112_), .c(new_n55_), .O(z13));
  ...
  oai21  g079(.a(new_n65_), .b(new_n67_), .c(new_n123_), .O(z14));
  nand2  g080(.a(x26), .b(x17), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(x24), .c(x23), .d(x22), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n115_), .c(x25), .O(new_n127_));
  nor2   g083(.a(new_n109_), .b(new_n74_), .O(new_n128_));
  nand4  g084(.a(new_n120_), .b(new_n128_), .c(new_n54_), .d(x24), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n131_));
  oai21  g087(.a(new_n65_), .b(new_n69_), .c(new_n131_), .O(z15));
  nand2  g088(.a(x26), .b(x09), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(x08), .c(new_n47_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n54_), .O(new_n135_));
  nor2   g091(.a(new_n119_), .b(new_n109_), .O(new_n136_));
  nor2   g092(.a(new_n97_), .b(x18), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n136_), .c(new_n75_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x26), .O(new_n139_));
  nor2   g095(.a(x26), .b(new_n54_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n101_), .c(new_n136_), .d(new_n75_), .O(new_n141_));
  ...
  nand3  g100(.a(new_n144_), .b(new_n143_), .c(new_n135_), .O(z16));
endmodule
