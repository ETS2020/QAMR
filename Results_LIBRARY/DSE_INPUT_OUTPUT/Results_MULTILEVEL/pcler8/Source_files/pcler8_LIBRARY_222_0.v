...
module FAU ( 
  ...
  nor2   g022(.a(new_n61_), .b(new_n66_), .O(z03));
  ...
  aoi21  g037(.a(new_n81_), .b(new_n58_), .c(new_n77_), .O(new_n82_));
  oai22  g038(.a(new_n82_), .b(x10), .c(new_n58_), .d(new_n57_), .O(z09));
  ...
  nand4  g052(.a(new_n96_), .b(new_n84_), .c(x09), .d(new_n58_), .O(new_n97_));
  oai21  g053(.a(new_n61_), .b(new_n66_), .c(new_n97_), .O(z11));
  ...
  nand4  g061(.a(new_n105_), .b(new_n84_), .c(x09), .d(new_n58_), .O(new_n106_));
  oai21  g062(.a(new_n61_), .b(new_n68_), .c(new_n106_), .O(z12));
  ...
  nand4  g072(.a(new_n116_), .b(new_n84_), .c(x09), .d(new_n58_), .O(new_n117_));
  ...
  oai21  g081(.a(new_n125_), .b(new_n77_), .c(new_n84_), .O(new_n126_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n77_), .c(new_n84_), .O(new_n134_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n84_), .c(x09), .d(new_n58_), .O(new_n145_));
  oai21  g101(.a(new_n61_), .b(new_n75_), .c(new_n145_), .O(z16));
endmodule
