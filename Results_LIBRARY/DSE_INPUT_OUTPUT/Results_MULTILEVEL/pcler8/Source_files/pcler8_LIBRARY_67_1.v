...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n63_, new_n64_, new_n66_, new_n68_, new_n71_, new_n73_, new_n74_,
  ...
  and2   g025(.a(new_n63_), .b(x06), .O(z07));
  inv1   g026(.a(x07), .O(new_n71_));
  nor2   g027(.a(new_n64_), .b(new_n71_), .O(z08));
  ...
  oai21  g042(.a(new_n64_), .b(new_n58_), .c(new_n86_), .O(z10));
  ...
  oai21  g052(.a(new_n64_), .b(new_n60_), .c(new_n96_), .O(z11));
  ...
  oai21  g061(.a(new_n64_), .b(new_n62_), .c(new_n105_), .O(z12));
  ...
  oai21  g074(.a(x10), .b(x05), .c(x08), .O(new_n119_));
  nand3  g075(.a(x26), .b(x25), .c(x16), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(x23), .c(x22), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n111_), .c(x24), .O(new_n122_));
  ...
  nand3  g083(.a(new_n127_), .b(new_n119_), .c(new_n55_), .O(z14));
  ...
  oai21  g088(.a(new_n132_), .b(new_n111_), .c(x25), .O(new_n133_));
  ...
  aoi21  g093(.a(x08), .b(x06), .c(new_n54_), .O(new_n138_));
  ...
  nor2   g099(.a(new_n123_), .b(new_n129_), .O(new_n144_));
  nor2   g100(.a(x26), .b(new_n134_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n98_), .c(new_n144_), .d(new_n75_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n148_));
  oai21  g104(.a(new_n64_), .b(new_n71_), .c(new_n148_), .O(z16));
endmodule
