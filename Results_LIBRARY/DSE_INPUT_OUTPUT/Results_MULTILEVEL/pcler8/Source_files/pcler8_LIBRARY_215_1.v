...
module FAU ( 
  ...
  nor2   g20(.a(new_n54_), .b(new_n64_), .O(z08));
  inv1   g21(.a(x09), .O(new_n66_));
  nor2   g22(.a(new_n66_), .b(x08), .O(new_n67_));
  nor3   g23(.a(x21), .b(x19), .c(x10), .O(new_n68_));
  nand2  g24(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  oai21  g25(.a(new_n54_), .b(new_n48_), .c(new_n69_), .O(z09));
  inv1   g26(.a(x21), .O(new_n71_));
  xor2a  g27(.a(x20), .b(x19), .O(new_n72_));
  nand3  g28(.a(new_n72_), .b(x09), .c(new_n49_), .O(new_n73_));
  ...
  nand3  g32(.a(new_n45_), .b(x09), .c(new_n49_), .O(new_n77_));
  nand3  g33(.a(new_n71_), .b(x20), .c(x19), .O(new_n78_));
  oai22  g34(.a(new_n78_), .b(new_n77_), .c(new_n54_), .d(new_n53_), .O(z11));
  nand4  g35(.a(new_n67_), .b(x22), .c(new_n71_), .d(new_n45_), .O(new_n80_));
  oai21  g36(.a(new_n54_), .b(new_n56_), .c(new_n80_), .O(z12));
  nand4  g37(.a(new_n67_), .b(x23), .c(new_n71_), .d(new_n45_), .O(new_n82_));
  oai21  g38(.a(new_n54_), .b(new_n58_), .c(new_n82_), .O(z13));
  nand2  g39(.a(x24), .b(x09), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(x08), .c(new_n71_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n45_), .O(new_n86_));
  oai21  g42(.a(new_n49_), .b(new_n60_), .c(new_n86_), .O(z14));
  nand2  g43(.a(x25), .b(x09), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(x08), .c(new_n71_), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n45_), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n62_), .O(z15));
  nand4  g47(.a(new_n67_), .b(x26), .c(new_n71_), .d(new_n45_), .O(new_n92_));
  oai21  g48(.a(new_n54_), .b(new_n64_), .c(new_n92_), .O(z16));
endmodule
