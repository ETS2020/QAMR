...
module FAU ( 
  ...
  and2   g024(.a(new_n60_), .b(x05), .O(z06));
  ...
  oai21  g040(.a(new_n46_), .b(new_n59_), .c(new_n84_), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(new_n56_), .O(new_n86_));
  ...
  nand2  g046(.a(new_n76_), .b(x21), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  nand2  g048(.a(new_n78_), .b(x24), .O(new_n93_));
  inv1   g049(.a(new_n93_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n92_), .c(new_n90_), .d(new_n88_), .O(new_n95_));
  ...
  nand2  g061(.a(new_n76_), .b(x20), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n105_), .c(new_n94_), .d(new_n88_), .O(new_n108_));
  ...
  nand3  g068(.a(new_n112_), .b(new_n75_), .c(x21), .O(new_n113_));
  oai22  g069(.a(new_n113_), .b(new_n110_), .c(new_n46_), .d(new_n65_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n56_), .O(new_n115_));
  nand3  g071(.a(x21), .b(x20), .c(x19), .O(new_n116_));
  oai21  g072(.a(x24), .b(new_n54_), .c(new_n116_), .O(new_n117_));
  inv1   g073(.a(x21), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x20), .c(x19), .O(new_n119_));
  nand4  g075(.a(x26), .b(x25), .c(x23), .d(x14), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x24), .O(new_n122_));
  aoi21  g078(.a(new_n122_), .b(new_n117_), .c(new_n75_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n115_), .O(z12));
  nand2  g081(.a(new_n60_), .b(x04), .O(new_n126_));
  nand4  g082(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x23), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(x21), .c(x20), .d(x19), .O(new_n129_));
  nand3  g085(.a(new_n116_), .b(x24), .c(x23), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x22), .O(new_n132_));
  nand3  g088(.a(x24), .b(x23), .c(new_n75_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n126_), .O(z13));
  inv1   g092(.a(new_n116_), .O(new_n137_));
  nand2  g093(.a(new_n78_), .b(x16), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n137_), .c(x23), .d(x22), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(x24), .c(new_n47_), .d(x09), .O(new_n140_));
  aoi21  g096(.a(x08), .b(x05), .c(new_n55_), .O(new_n141_));
  oai21  g097(.a(new_n140_), .b(x08), .c(new_n141_), .O(z14));
  nand2  g098(.a(new_n60_), .b(x06), .O(new_n143_));
  inv1   g099(.a(x24), .O(new_n144_));
  nand2  g100(.a(x26), .b(x17), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n112_), .c(x22), .d(x21), .O(new_n146_));
  nand3  g102(.a(new_n77_), .b(x23), .c(x22), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n116_), .O(new_n148_));
  aoi21  g104(.a(new_n146_), .b(x25), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(x25), .b(new_n54_), .O(new_n150_));
  oai21  g106(.a(new_n149_), .b(new_n144_), .c(new_n150_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n143_), .O(z15));
  nand2  g109(.a(new_n60_), .b(x07), .O(new_n154_));
  nor2   g110(.a(new_n111_), .b(x18), .O(new_n155_));
  nand3  g111(.a(x25), .b(x22), .c(x21), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n155_), .c(new_n45_), .O(new_n158_));
  nand4  g114(.a(new_n45_), .b(x25), .c(x23), .d(x22), .O(new_n159_));
  nor2   g115(.a(new_n159_), .b(new_n116_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n158_), .c(x24), .O(new_n161_));
  nand2  g117(.a(x26), .b(new_n54_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n154_), .O(z16));
endmodule
