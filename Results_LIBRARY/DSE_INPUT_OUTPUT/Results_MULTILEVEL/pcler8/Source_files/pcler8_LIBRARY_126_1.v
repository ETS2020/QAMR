...
module FAU ( 
  ...
  oai21  g066(.a(new_n110_), .b(new_n109_), .c(new_n54_), .O(new_n111_));
  ...
  nand3  g078(.a(new_n119_), .b(new_n54_), .c(x21), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n122_), .c(new_n108_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n125_));
  oai21  g081(.a(new_n61_), .b(new_n67_), .c(new_n125_), .O(z13));
  inv1   g082(.a(x24), .O(new_n127_));
  nand3  g083(.a(new_n119_), .b(new_n127_), .c(x21), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n109_), .c(x22), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x23), .O(new_n130_));
  nand3  g086(.a(x26), .b(x25), .c(x16), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(x23), .c(x21), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n119_), .c(new_n127_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n130_), .c(new_n69_), .O(z14));
  ...
  nand2  g098(.a(x25), .b(new_n54_), .O(new_n143_));
  oai21  g099(.a(new_n142_), .b(new_n108_), .c(new_n143_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n71_), .O(z15));
  nand3  g102(.a(new_n77_), .b(x19), .c(new_n47_), .O(new_n147_));
  nor2   g103(.a(x26), .b(new_n139_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(x24), .c(x21), .d(x20), .O(new_n149_));
  ...
  nor3   g108(.a(new_n152_), .b(new_n118_), .c(x18), .O(new_n153_));
