...
module FAU ( 
  ...
  nand4  g015(.a(new_n59_), .b(new_n53_), .c(x09), .d(new_n48_), .O(new_n60_));
  nand2  g016(.a(new_n60_), .b(new_n47_), .O(z00));
  nor2   g017(.a(new_n46_), .b(new_n48_), .O(new_n62_));
  and2   g018(.a(new_n62_), .b(x00), .O(z01));
  inv1   g019(.a(x01), .O(new_n64_));
  inv1   g020(.a(new_n62_), .O(new_n65_));
  nor2   g021(.a(new_n65_), .b(new_n64_), .O(z02));
  inv1   g022(.a(x02), .O(new_n67_));
  nor2   g023(.a(new_n65_), .b(new_n67_), .O(z03));
  inv1   g024(.a(x03), .O(new_n69_));
  oai21  g025(.a(new_n48_), .b(new_n69_), .c(new_n47_), .O(z04));
  nand2  g026(.a(x08), .b(x04), .O(new_n71_));
  nand2  g027(.a(new_n71_), .b(new_n47_), .O(z05));
  inv1   g028(.a(x05), .O(new_n73_));
  oai21  g029(.a(new_n48_), .b(new_n73_), .c(new_n47_), .O(z06));
  nand2  g030(.a(x08), .b(x06), .O(new_n75_));
  nand2  g031(.a(new_n75_), .b(new_n47_), .O(z07));
  inv1   g032(.a(x07), .O(new_n77_));
  oai21  g033(.a(new_n48_), .b(new_n77_), .c(new_n47_), .O(z08));
  inv1   g034(.a(x21), .O(new_n79_));
  nor2   g035(.a(new_n54_), .b(new_n79_), .O(new_n80_));
  ...
  oai21  g045(.a(new_n50_), .b(x19), .c(new_n89_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n91_));
  oai21  g047(.a(new_n65_), .b(new_n64_), .c(new_n91_), .O(z10));
  nand3  g048(.a(x23), .b(x22), .c(x13), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n58_), .c(x21), .O(new_n94_));
  nor2   g050(.a(new_n79_), .b(x20), .O(new_n95_));
  aoi21  g051(.a(new_n94_), .b(x20), .c(new_n95_), .O(new_n96_));
  nand2  g052(.a(x21), .b(new_n49_), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n49_), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n99_));
  oai21  g055(.a(new_n65_), .b(new_n67_), .c(new_n99_), .O(z11));
  nand2  g056(.a(x23), .b(x14), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n58_), .c(x21), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n52_), .c(x22), .O(new_n103_));
  ...
  oai21  g062(.a(new_n65_), .b(new_n69_), .c(new_n106_), .O(z12));
  nand2  g063(.a(new_n62_), .b(x04), .O(new_n108_));
  ...
  nand2  g071(.a(x23), .b(new_n54_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n118_));
  ...
  nand4  g082(.a(new_n126_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n127_));
  oai21  g083(.a(new_n65_), .b(new_n73_), .c(new_n127_), .O(z14));
  inv1   g084(.a(x25), .O(new_n129_));
  nand3  g085(.a(new_n51_), .b(x09), .c(new_n48_), .O(new_n130_));
  nor2   g086(.a(new_n123_), .b(new_n55_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n80_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(new_n45_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n129_), .O(new_n134_));
  nand2  g090(.a(x26), .b(x17), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n56_), .c(x24), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n124_), .c(new_n129_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n134_), .c(new_n75_), .O(z15));
  inv1   g096(.a(x18), .O(new_n141_));
  nand4  g097(.a(x21), .b(x20), .c(x19), .d(new_n141_), .O(new_n142_));
  nand3  g098(.a(new_n56_), .b(x25), .c(x24), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(x26), .O(new_n144_));
  nor2   g100(.a(x26), .b(new_n129_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n131_), .c(new_n80_), .d(new_n51_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n148_));
  oai21  g104(.a(new_n65_), .b(new_n77_), .c(new_n148_), .O(z16));
endmodule
