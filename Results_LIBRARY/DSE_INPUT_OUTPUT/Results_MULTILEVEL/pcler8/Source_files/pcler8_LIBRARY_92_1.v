...
module FAU ( 
  ...
  and2   g023(.a(new_n63_), .b(x05), .O(z06));
  inv1   g024(.a(x06), .O(new_n69_));
  nor2   g025(.a(new_n64_), .b(new_n69_), .O(z07));
  ...
  nand3  g042(.a(new_n86_), .b(new_n58_), .c(new_n56_), .O(z10));
  ...
  oai21  g092(.a(new_n64_), .b(new_n69_), .c(new_n136_), .O(z15));
