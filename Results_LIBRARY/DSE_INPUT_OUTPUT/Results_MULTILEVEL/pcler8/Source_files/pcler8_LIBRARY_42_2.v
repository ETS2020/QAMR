...
module FAU ( 
  ...
  inv1   g023(.a(x10), .O(new_n68_));
  nand2  g024(.a(new_n68_), .b(x04), .O(new_n69_));
  nand3  g025(.a(new_n69_), .b(x08), .c(x03), .O(new_n70_));
  inv1   g026(.a(new_n70_), .O(z04));
  nand3  g027(.a(x10), .b(x08), .c(x04), .O(new_n72_));
  ...
  nand2  g032(.a(new_n76_), .b(new_n60_), .O(z07));
  nand2  g033(.a(x08), .b(x07), .O(new_n78_));
  nand2  g034(.a(new_n78_), .b(new_n60_), .O(z08));
  inv1   g035(.a(x21), .O(new_n80_));
  nor2   g036(.a(new_n50_), .b(new_n80_), .O(new_n81_));
  ...
  nand4  g040(.a(new_n84_), .b(new_n68_), .c(x09), .d(new_n58_), .O(new_n85_));
  oai22  g041(.a(new_n85_), .b(x04), .c(new_n64_), .d(new_n57_), .O(z09));
  ...
  oai21  g049(.a(new_n64_), .b(new_n62_), .c(new_n93_), .O(z10));
  ...
  nor2   g053(.a(new_n80_), .b(x20), .O(new_n98_));
  ...
  nand4  g057(.a(new_n101_), .b(new_n68_), .c(x09), .d(new_n58_), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(x04), .c(new_n95_), .O(z11));
  ...
  aoi21  g065(.a(new_n109_), .b(new_n107_), .c(new_n46_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n58_), .c(x04), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(x10), .c(new_n70_), .O(z12));
  ...
  nand4  g073(.a(new_n117_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n118_));
  ...
  nand4  g081(.a(new_n125_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n126_));
  oai21  g082(.a(new_n64_), .b(new_n74_), .c(new_n126_), .O(z14));
  ...
  aoi21  g089(.a(new_n133_), .b(new_n58_), .c(x04), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(x10), .c(new_n76_), .O(z15));
  nand2  g091(.a(new_n63_), .b(x07), .O(new_n136_));
  ...
  nor2   g096(.a(new_n123_), .b(new_n51_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n131_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n108_), .c(new_n141_), .d(new_n81_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n140_), .c(x10), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n145_));
