...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n62_, new_n64_, new_n66_, new_n68_, new_n71_, new_n72_, new_n74_,
  ...
  nor2   g010(.a(x10), .b(x00), .O(new_n55_));
  ...
  and2   g025(.a(new_n61_), .b(x06), .O(z07));
  inv1   g026(.a(x07), .O(new_n71_));
  inv1   g027(.a(new_n61_), .O(new_n72_));
  nor2   g028(.a(new_n72_), .b(new_n71_), .O(z08));
  inv1   g029(.a(x00), .O(new_n74_));
  ...
  aoi21  g035(.a(new_n79_), .b(x09), .c(new_n74_), .O(new_n80_));
  oai21  g036(.a(new_n80_), .b(x10), .c(new_n57_), .O(z09));
  ...
  aoi21  g044(.a(new_n88_), .b(new_n47_), .c(new_n74_), .O(new_n89_));
  oai21  g045(.a(new_n89_), .b(x10), .c(new_n59_), .O(z10));
  ...
  oai21  g049(.a(new_n93_), .b(new_n86_), .c(x21), .O(new_n94_));
  ...
  nand2  g053(.a(new_n97_), .b(new_n62_), .O(z11));
  ...
  nand4  g061(.a(new_n105_), .b(x09), .c(new_n47_), .d(x00), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n64_), .O(z12));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n82_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n47_), .c(new_n74_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(x10), .c(new_n66_), .O(z13));
  ...
  aoi21  g078(.a(new_n122_), .b(new_n119_), .c(new_n82_), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n47_), .c(new_n74_), .O(new_n124_));
  ...
  oai21  g083(.a(new_n127_), .b(new_n116_), .c(x25), .O(new_n128_));
  inv1   g084(.a(x25), .O(new_n129_));
  nor2   g085(.a(new_n111_), .b(new_n46_), .O(new_n130_));
  nand4  g086(.a(new_n121_), .b(new_n130_), .c(new_n129_), .d(x24), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n128_), .c(new_n82_), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n47_), .c(new_n74_), .O(new_n133_));
  nand2  g089(.a(x08), .b(x06), .O(new_n134_));
  oai21  g090(.a(new_n133_), .b(x10), .c(new_n134_), .O(z15));
  ...
  nand4  g097(.a(new_n141_), .b(new_n103_), .c(new_n140_), .d(new_n76_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n139_), .c(x10), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(x09), .c(new_n47_), .d(x00), .O(new_n144_));
  oai21  g100(.a(new_n72_), .b(new_n71_), .c(new_n144_), .O(z16));
endmodule
