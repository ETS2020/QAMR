...
module FAU ( 
  ...
  oai21  g043(.a(new_n57_), .b(new_n59_), .c(new_n87_), .O(z10));
  ...
  oai21  g053(.a(new_n57_), .b(new_n61_), .c(new_n97_), .O(z11));
  ...
  nand3  g062(.a(new_n106_), .b(new_n63_), .c(new_n56_), .O(z12));
  ...
  nand2  g073(.a(new_n117_), .b(new_n65_), .O(z13));
  ...
  aoi21  g082(.a(x08), .b(x05), .c(new_n55_), .O(new_n127_));
  ...
  nand3  g093(.a(new_n137_), .b(new_n69_), .c(new_n56_), .O(z15));
  ...
  nor2   g098(.a(new_n122_), .b(new_n129_), .O(new_n143_));
  ...
  oai21  g103(.a(new_n57_), .b(new_n71_), .c(new_n147_), .O(z16));
endmodule
