...
module FAU ( 
  ...
  xnor2a g34(.a(x21), .b(x19), .O(new_n80_));
  nand2  g35(.a(x21), .b(new_n79_), .O(new_n81_));
  oai21  g36(.a(new_n80_), .b(new_n79_), .c(new_n81_), .O(new_n82_));
  nand4  g37(.a(new_n82_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n83_));
  nand3  g38(.a(new_n83_), .b(new_n56_), .c(new_n55_), .O(z11));
  nand2  g39(.a(x24), .b(x23), .O(new_n85_));
  ...
  nand4  g45(.a(new_n90_), .b(new_n85_), .c(new_n74_), .d(x09), .O(new_n91_));
  oai21  g46(.a(new_n91_), .b(x08), .c(new_n58_), .O(z12));
  nand2  g47(.a(x20), .b(x19), .O(new_n93_));
  nand4  g48(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n48_), .c(x23), .O(new_n95_));
  nand3  g50(.a(new_n47_), .b(x22), .c(x21), .O(new_n96_));
  oai21  g51(.a(new_n96_), .b(new_n93_), .c(new_n95_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n60_), .O(z13));
  nand2  g54(.a(new_n50_), .b(x05), .O(new_n100_));
  nand3  g55(.a(new_n48_), .b(x23), .c(x22), .O(new_n101_));
  oai22  g56(.a(new_n101_), .b(new_n86_), .c(new_n48_), .d(x23), .O(new_n102_));
  ...
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n55_), .O(z15));
  nand3  g62(.a(new_n70_), .b(x26), .c(new_n74_), .O(new_n108_));
  aoi21  g63(.a(new_n108_), .b(new_n66_), .c(new_n49_), .O(z16));
  zero   g64(.O(z00));
endmodule
