...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n61_, new_n63_, new_n64_, new_n67_, new_n69_, new_n72_,
  ...
  and2   g21(.a(new_n60_), .b(x02), .O(z03));
  ...
  and2   g26(.a(new_n60_), .b(x05), .O(z06));
  ...
  nor2   g32(.a(new_n50_), .b(new_n48_), .O(new_n77_));
  ...
  nand4  g36(.a(new_n80_), .b(new_n76_), .c(x09), .d(new_n58_), .O(new_n81_));
  oai21  g37(.a(new_n61_), .b(new_n57_), .c(new_n81_), .O(z09));
  nand2  g38(.a(new_n60_), .b(x01), .O(new_n83_));
  ...
  nand4  g43(.a(new_n87_), .b(new_n76_), .c(x09), .d(new_n58_), .O(new_n88_));
  ...
  aoi21  g51(.a(new_n95_), .b(new_n93_), .c(x08), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n90_), .c(new_n76_), .O(new_n97_));
  ...
  nand4  g61(.a(new_n105_), .b(new_n76_), .c(x09), .d(new_n58_), .O(new_n106_));
  ...
  oai21  g68(.a(new_n112_), .b(new_n90_), .c(new_n76_), .O(new_n113_));
  ...
  oai21  g78(.a(new_n122_), .b(new_n90_), .c(new_n76_), .O(new_n123_));
  ...
  oai21  g87(.a(new_n131_), .b(new_n90_), .c(new_n76_), .O(new_n132_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n103_), .c(new_n138_), .d(new_n77_), .O(new_n140_));
  aoi21  g96(.a(new_n140_), .b(new_n137_), .c(x08), .O(new_n141_));
  oai21  g97(.a(new_n141_), .b(new_n90_), .c(new_n76_), .O(new_n142_));
