...
module FAU ( 
  ...
  nand2  g000(.a(x10), .b(x01), .O(new_n45_));
  ...
  nand2  g013(.a(new_n45_), .b(x08), .O(new_n58_));
  ...
  aoi21  g018(.a(new_n47_), .b(new_n46_), .c(new_n62_), .O(z02));
  ...
  oai21  g024(.a(new_n46_), .b(new_n68_), .c(new_n45_), .O(z05));
  ...
  and2   g030(.a(new_n74_), .b(new_n45_), .O(new_n75_));
  ...
  inv1   g038(.a(new_n45_), .O(new_n83_));
  ...
  nand3  g047(.a(new_n91_), .b(x09), .c(new_n46_), .O(new_n92_));
  nand2  g048(.a(x08), .b(x01), .O(new_n93_));
  aoi21  g049(.a(new_n93_), .b(new_n92_), .c(x10), .O(z10));
  oai21  g050(.a(new_n46_), .b(new_n64_), .c(new_n47_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(x01), .O(new_n96_));
  nand3  g052(.a(x23), .b(x22), .c(x13), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n54_), .c(x21), .O(new_n98_));
  nor2   g054(.a(new_n77_), .b(x20), .O(new_n99_));
  aoi21  g055(.a(new_n98_), .b(x20), .c(new_n99_), .O(new_n100_));
  ...
  nand3  g059(.a(x08), .b(x02), .c(new_n62_), .O(new_n104_));
  ...
  oai21  g063(.a(new_n107_), .b(new_n48_), .c(x22), .O(new_n108_));
  nand3  g064(.a(new_n49_), .b(new_n51_), .c(x21), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n111_));
  aoi21  g067(.a(x08), .b(x03), .c(new_n83_), .O(new_n112_));
  ...
  oai21  g071(.a(new_n115_), .b(new_n48_), .c(x23), .O(new_n116_));
  nand4  g072(.a(new_n49_), .b(new_n52_), .c(x22), .d(x21), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n119_));
  oai21  g075(.a(new_n58_), .b(new_n68_), .c(new_n119_), .O(z13));
  ...
  nor2   g098(.a(new_n125_), .b(new_n52_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n134_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n78_), .d(new_n49_), .O(new_n145_));
