...
module FAU ( 
  ...
  aoi22  g066(.a(new_n110_), .b(new_n77_), .c(new_n109_), .d(x23), .O(new_n111_));
  ...
  nand3  g072(.a(new_n116_), .b(new_n65_), .c(new_n56_), .O(z12));
  inv1   g073(.a(new_n109_), .O(new_n118_));
  nand3  g074(.a(new_n77_), .b(x24), .c(x15), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n118_), .c(x22), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(x23), .c(new_n47_), .d(x09), .O(new_n121_));
  oai22  g077(.a(new_n121_), .b(x08), .c(new_n63_), .d(new_n67_), .O(z13));
  ...
  nand3  g088(.a(new_n132_), .b(new_n127_), .c(new_n69_), .O(z14));
  nand2  g089(.a(new_n62_), .b(x06), .O(new_n134_));
  inv1   g090(.a(x23), .O(new_n135_));
  nand2  g091(.a(x26), .b(x17), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n113_), .c(x24), .d(x21), .O(new_n137_));
  nand3  g093(.a(new_n76_), .b(x24), .c(x22), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n109_), .O(new_n139_));
  aoi21  g095(.a(new_n137_), .b(x25), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(x25), .b(new_n54_), .O(new_n141_));
  oai21  g097(.a(new_n140_), .b(new_n135_), .c(new_n141_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n134_), .O(z15));
  nor2   g100(.a(new_n112_), .b(x18), .O(new_n145_));
  ...
  nor2   g105(.a(new_n149_), .b(new_n109_), .O(new_n150_));
