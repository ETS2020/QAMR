...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n61_, new_n64_, new_n65_, new_n69_, new_n71_, new_n73_, new_n74_,
  ...
  nand2  g21(.a(new_n65_), .b(new_n64_), .O(z04));
  and2   g22(.a(new_n59_), .b(x04), .O(z05));
  and2   g23(.a(new_n59_), .b(x05), .O(z06));
  nand2  g24(.a(x08), .b(x06), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n64_), .O(z07));
  nand2  g26(.a(x08), .b(x07), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(new_n64_), .O(z08));
  inv1   g28(.a(x09), .O(new_n73_));
  nor2   g29(.a(new_n50_), .b(new_n48_), .O(new_n74_));
  ...
  aoi21  g33(.a(new_n77_), .b(new_n57_), .c(new_n73_), .O(new_n78_));
  nand2  g34(.a(x08), .b(x00), .O(new_n79_));
  oai21  g35(.a(new_n78_), .b(x10), .c(new_n79_), .O(z09));
  ...
  oai21  g40(.a(new_n47_), .b(x19), .c(new_n84_), .O(new_n85_));
  nand4  g41(.a(new_n85_), .b(new_n81_), .c(x09), .d(new_n57_), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n61_), .O(z10));
  nand3  g43(.a(x23), .b(x22), .c(x13), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n53_), .c(x21), .O(new_n89_));
  nand3  g45(.a(new_n89_), .b(x20), .c(x19), .O(new_n90_));
  nand2  g46(.a(x20), .b(x19), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(x21), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(new_n90_), .c(x08), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n73_), .c(new_n81_), .O(new_n94_));
  ...
  aoi21  g76(.a(new_n120_), .b(new_n117_), .c(x08), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n73_), .c(new_n81_), .O(new_n122_));
  ...
  oai21  g86(.a(new_n130_), .b(new_n73_), .c(new_n81_), .O(new_n131_));
  ...
  oai21  g96(.a(new_n140_), .b(new_n73_), .c(new_n81_), .O(new_n141_));
