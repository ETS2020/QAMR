...
module FAU ( 
  ...
  nand4  g011(.a(new_n55_), .b(new_n52_), .c(new_n49_), .d(x22), .O(new_n56_));
  aoi21  g012(.a(new_n56_), .b(x23), .c(new_n45_), .O(z00));
  inv1   g013(.a(x00), .O(new_n58_));
  nor2   g014(.a(new_n45_), .b(x23), .O(new_n59_));
  ...
  nor2   g049(.a(new_n51_), .b(x20), .O(new_n94_));
  aoi21  g050(.a(new_n93_), .b(x20), .c(new_n94_), .O(new_n95_));
  nand2  g051(.a(x21), .b(new_n91_), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(new_n91_), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n98_));
  aoi21  g054(.a(x08), .b(x02), .c(new_n59_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n98_), .O(z11));
  nand3  g056(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n101_));
  nand3  g057(.a(new_n55_), .b(x22), .c(x14), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n101_), .c(x23), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x24), .O(new_n104_));
  inv1   g060(.a(x22), .O(new_n105_));
  nand2  g061(.a(new_n52_), .b(x19), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand2  g063(.a(x20), .b(x19), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n105_), .c(x21), .O(new_n110_));
  oai21  g066(.a(new_n107_), .b(new_n105_), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n112_));
  nand2  g068(.a(x08), .b(x03), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n112_), .c(new_n104_), .O(z12));
  inv1   g070(.a(x23), .O(new_n115_));
  nand3  g071(.a(new_n109_), .b(x22), .c(x21), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n101_), .c(new_n45_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand3  g074(.a(new_n52_), .b(x22), .c(x19), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x23), .O(new_n120_));
  nand3  g076(.a(new_n55_), .b(x24), .c(x15), .O(new_n121_));
  ...
  oai21  g083(.a(new_n127_), .b(new_n108_), .c(x24), .O(new_n128_));
  nand4  g084(.a(new_n109_), .b(new_n45_), .c(x22), .d(x21), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n128_), .c(new_n115_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n71_), .O(z14));
  nand3  g088(.a(new_n52_), .b(new_n53_), .c(x22), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n48_), .c(x23), .O(new_n134_));
  ...
  aoi21  g094(.a(new_n138_), .b(new_n107_), .c(new_n53_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n135_), .c(new_n73_), .O(z15));
  nand4  g097(.a(new_n52_), .b(new_n54_), .c(x25), .d(x22), .O(new_n142_));
  ...
  nor3   g101(.a(new_n145_), .b(new_n108_), .c(x18), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n54_), .O(new_n147_));
