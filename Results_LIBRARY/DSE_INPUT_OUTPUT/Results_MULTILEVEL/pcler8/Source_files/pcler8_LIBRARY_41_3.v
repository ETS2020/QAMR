...
module FAU ( 
  ...
  aoi21  g33(.a(new_n77_), .b(new_n46_), .c(x10), .O(new_n78_));
  nand2  g34(.a(x08), .b(x00), .O(new_n79_));
  oai21  g35(.a(new_n78_), .b(new_n73_), .c(new_n79_), .O(z09));
  ...
  inv1   g57(.a(new_n92_), .O(new_n102_));
  ...
  oai21  g65(.a(new_n109_), .b(new_n92_), .c(x23), .O(new_n110_));
  ...
  oai21  g80(.a(new_n55_), .b(new_n67_), .c(new_n124_), .O(z14));
  ...
  nor2   g85(.a(new_n111_), .b(new_n101_), .O(new_n130_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n102_), .c(new_n139_), .d(new_n74_), .O(new_n141_));
