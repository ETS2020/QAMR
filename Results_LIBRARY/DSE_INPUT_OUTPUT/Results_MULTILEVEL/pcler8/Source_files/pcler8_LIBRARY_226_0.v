...
module FAU ( 
  ...
  oai21  g046(.a(new_n46_), .b(new_n58_), .c(new_n90_), .O(new_n91_));
  ...
  nand2  g065(.a(new_n59_), .b(x03), .O(new_n110_));
  nand2  g066(.a(x20), .b(x19), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  inv1   g068(.a(x21), .O(new_n113_));
  nor2   g069(.a(x22), .b(new_n113_), .O(new_n114_));
  and2   g070(.a(x22), .b(x14), .O(new_n115_));
  aoi22  g071(.a(new_n115_), .b(new_n103_), .c(new_n114_), .d(new_n112_), .O(new_n116_));
  ...
  nand2  g076(.a(new_n120_), .b(new_n110_), .O(z12));
  ...
  oai21  g084(.a(new_n60_), .b(new_n66_), .c(new_n128_), .O(z13));
  nand2  g085(.a(x24), .b(new_n81_), .O(new_n130_));
  inv1   g086(.a(x24), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(x22), .c(x21), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n111_), .c(new_n130_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x23), .O(new_n134_));
  nand3  g090(.a(x26), .b(x25), .c(x16), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n112_), .c(x23), .d(x21), .O(new_n136_));
  ...
  oai21  g101(.a(new_n145_), .b(new_n117_), .c(x25), .O(new_n146_));
  inv1   g102(.a(x25), .O(new_n147_));
  nand4  g103(.a(new_n122_), .b(new_n83_), .c(new_n147_), .d(x24), .O(new_n148_));
  ...
  nand3  g107(.a(new_n151_), .b(new_n150_), .c(new_n143_), .O(z15));
  nand2  g108(.a(x26), .b(new_n81_), .O(new_n153_));
  nand4  g109(.a(new_n45_), .b(x25), .c(x24), .d(x22), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n117_), .c(new_n153_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x23), .O(new_n156_));
  nor2   g112(.a(new_n111_), .b(x18), .O(new_n157_));
  nor2   g113(.a(new_n147_), .b(new_n131_), .O(new_n158_));
