...
module FAU ( 
  ...
  oai21  g035(.a(new_n67_), .b(new_n54_), .c(new_n79_), .O(z09));
  ...
  nand3  g061(.a(new_n105_), .b(new_n74_), .c(x21), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n104_), .c(x08), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n100_), .c(new_n47_), .O(new_n108_));
  ...
  oai21  g073(.a(new_n67_), .b(new_n64_), .c(new_n117_), .O(z13));
  ...
  oai21  g083(.a(new_n67_), .b(new_n66_), .c(new_n127_), .O(z14));
  ...
  nand4  g099(.a(new_n143_), .b(new_n105_), .c(new_n142_), .d(new_n75_), .O(new_n144_));
