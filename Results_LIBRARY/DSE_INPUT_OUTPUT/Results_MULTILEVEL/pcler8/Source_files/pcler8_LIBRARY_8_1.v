...
module FAU ( 
  ...
  nor2   g47(.a(new_n70_), .b(x20), .O(new_n92_));
  ...
  oai21  g52(.a(new_n46_), .b(new_n58_), .c(new_n96_), .O(z11));
  nor2   g53(.a(new_n81_), .b(new_n88_), .O(new_n98_));
  ...
  nand3  g66(.a(new_n110_), .b(x23), .c(new_n47_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n109_), .c(new_n71_), .O(new_n112_));
  nor2   g68(.a(new_n74_), .b(x22), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n112_), .c(x09), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n47_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n46_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n62_), .O(z13));
  inv1   g73(.a(x09), .O(new_n118_));
  nand3  g74(.a(x26), .b(x25), .c(x16), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(x23), .c(x22), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n110_), .c(x24), .O(new_n121_));
  inv1   g77(.a(new_n110_), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n75_), .c(x23), .d(x22), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n121_), .c(new_n118_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(x10), .c(new_n46_), .O(new_n125_));
  oai21  g81(.a(new_n46_), .b(new_n64_), .c(new_n125_), .O(z14));
  ...
  oai21  g85(.a(new_n129_), .b(new_n110_), .c(x25), .O(new_n130_));
  inv1   g86(.a(x25), .O(new_n131_));
  nand4  g87(.a(new_n122_), .b(new_n127_), .c(new_n131_), .d(x24), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n130_), .c(new_n118_), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(x10), .c(new_n46_), .O(new_n134_));
  oai21  g90(.a(new_n46_), .b(new_n66_), .c(new_n134_), .O(z15));
  ...
  nand4  g96(.a(new_n140_), .b(new_n98_), .c(new_n76_), .d(new_n72_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n139_), .c(new_n118_), .O(new_n142_));
  oai21  g98(.a(new_n142_), .b(x10), .c(new_n46_), .O(new_n143_));
  nand2  g99(.a(new_n143_), .b(new_n68_), .O(z16));
endmodule
