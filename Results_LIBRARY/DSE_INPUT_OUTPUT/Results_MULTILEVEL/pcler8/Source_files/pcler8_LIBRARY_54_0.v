...
module FAU ( 
  ...
  and2   g16(.a(new_n56_), .b(x02), .O(z03));
  ...
  nand2  g21(.a(new_n65_), .b(new_n62_), .O(z05));
  nand2  g22(.a(x08), .b(x05), .O(new_n67_));
  nand2  g23(.a(new_n67_), .b(new_n62_), .O(z06));
  ...
  oai21  g33(.a(new_n57_), .b(new_n54_), .c(new_n77_), .O(z09));
  ...
  oai21  g49(.a(new_n93_), .b(new_n86_), .c(new_n47_), .O(new_n94_));
  nand2  g50(.a(x08), .b(x02), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n94_), .O(z11));
  nand2  g52(.a(x23), .b(x14), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n88_), .c(x21), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n91_), .c(x22), .O(new_n99_));
  inv1   g55(.a(x22), .O(new_n100_));
  inv1   g56(.a(new_n91_), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(new_n100_), .c(x21), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n99_), .c(x08), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n86_), .c(new_n47_), .O(new_n104_));
  ...
  aoi21  g66(.a(new_n110_), .b(new_n108_), .c(x08), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n86_), .c(new_n47_), .O(new_n112_));
  ...
  oai21  g77(.a(new_n121_), .b(new_n86_), .c(new_n47_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n67_), .O(z14));
  nor2   g79(.a(new_n109_), .b(new_n100_), .O(new_n124_));
  ...
  nand4  g84(.a(new_n119_), .b(new_n124_), .c(new_n128_), .d(x24), .O(new_n129_));
  ...
  nand4  g94(.a(new_n138_), .b(new_n101_), .c(new_n137_), .d(new_n73_), .O(new_n139_));
