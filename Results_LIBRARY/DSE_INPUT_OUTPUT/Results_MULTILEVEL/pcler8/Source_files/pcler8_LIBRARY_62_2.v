...
module FAU ( 
  ...
  nor2   g048(.a(new_n55_), .b(new_n92_), .O(new_n93_));
  nand4  g049(.a(new_n77_), .b(new_n93_), .c(x24), .d(x21), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n91_), .c(new_n86_), .O(z10));
  ...
  nand3  g062(.a(new_n77_), .b(x22), .c(x14), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n106_), .c(x24), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x23), .O(new_n109_));
  nand3  g065(.a(x21), .b(x20), .c(x19), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand2  g067(.a(new_n92_), .b(x21), .O(new_n112_));
  oai22  g068(.a(new_n112_), .b(new_n100_), .c(new_n111_), .d(new_n92_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n109_), .c(new_n64_), .O(z12));
  nand3  g071(.a(new_n57_), .b(x08), .c(x04), .O(new_n116_));
  nand3  g072(.a(x26), .b(x25), .c(x15), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x22), .c(x21), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n100_), .c(x24), .O(new_n119_));
  nand3  g075(.a(new_n55_), .b(x22), .c(x21), .O(new_n120_));
  oai22  g076(.a(new_n120_), .b(new_n100_), .c(new_n119_), .d(new_n55_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n116_), .O(z13));
  nand2  g079(.a(new_n77_), .b(x16), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n111_), .c(x23), .d(x22), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(x24), .c(new_n47_), .d(x09), .O(new_n126_));
  oai22  g082(.a(new_n126_), .b(x08), .c(new_n58_), .d(new_n68_), .O(z14));
  nand3  g083(.a(new_n88_), .b(x19), .c(new_n47_), .O(new_n128_));
  inv1   g084(.a(x25), .O(new_n129_));
  nand3  g085(.a(new_n74_), .b(new_n129_), .c(x22), .O(new_n130_));
  ...
  aoi21  g091(.a(new_n135_), .b(new_n111_), .c(new_n129_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n132_), .c(new_n70_), .O(z15));
  nand4  g094(.a(new_n74_), .b(new_n45_), .c(x25), .d(x22), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n128_), .c(x24), .O(new_n140_));
