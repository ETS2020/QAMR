...
module FAU ( 
  ...
  nand2  g018(.a(new_n55_), .b(x04), .O(new_n63_));
  inv1   g019(.a(new_n63_), .O(z05));
  nand2  g020(.a(x08), .b(x05), .O(new_n65_));
  nand2  g021(.a(new_n65_), .b(new_n57_), .O(z06));
  nand2  g022(.a(x08), .b(x06), .O(new_n67_));
  nand2  g023(.a(new_n67_), .b(new_n57_), .O(z07));
  nand2  g024(.a(x08), .b(x07), .O(new_n69_));
  nand2  g025(.a(new_n69_), .b(new_n57_), .O(z08));
  ...
  nand3  g051(.a(new_n95_), .b(new_n60_), .c(new_n57_), .O(z11));
  ...
  nand3  g057(.a(new_n97_), .b(new_n72_), .c(x21), .O(new_n102_));
  ...
  nand3  g081(.a(new_n125_), .b(new_n65_), .c(new_n57_), .O(z14));
  oai21  g082(.a(x10), .b(x06), .c(x08), .O(new_n127_));
  ...
  nand3  g092(.a(new_n136_), .b(new_n127_), .c(new_n57_), .O(z15));
  ...
  nor2   g098(.a(new_n121_), .b(new_n128_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n133_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n97_), .c(new_n143_), .d(new_n73_), .O(new_n145_));
