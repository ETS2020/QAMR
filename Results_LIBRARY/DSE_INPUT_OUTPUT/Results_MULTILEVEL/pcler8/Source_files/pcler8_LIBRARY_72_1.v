...
module FAU ( 
  ...
  oai21  g14(.a(new_n56_), .b(new_n58_), .c(new_n46_), .O(z05));
  ...
  nand4  g29(.a(new_n73_), .b(new_n66_), .c(new_n45_), .d(x09), .O(new_n74_));
  oai22  g30(.a(new_n74_), .b(x08), .c(new_n49_), .d(new_n51_), .O(z10));
  nand4  g31(.a(x20), .b(x19), .c(x09), .d(new_n56_), .O(new_n76_));
  nand2  g32(.a(new_n76_), .b(new_n66_), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(new_n45_), .O(new_n78_));
  nand2  g34(.a(x08), .b(x02), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n78_), .O(z11));
  inv1   g36(.a(x09), .O(new_n81_));
  nor2   g37(.a(new_n81_), .b(x08), .O(new_n82_));
  nand4  g38(.a(new_n82_), .b(x22), .c(new_n66_), .d(new_n45_), .O(new_n83_));
  oai21  g39(.a(new_n49_), .b(new_n55_), .c(new_n83_), .O(z12));
  nand4  g40(.a(new_n82_), .b(x23), .c(new_n66_), .d(new_n45_), .O(new_n85_));
  oai21  g41(.a(new_n49_), .b(new_n58_), .c(new_n85_), .O(z13));
  nand2  g42(.a(x24), .b(x09), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(x08), .c(new_n66_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n45_), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n60_), .O(z14));
  nand2  g46(.a(x25), .b(x09), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(x08), .c(new_n66_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n45_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n62_), .O(z15));
  nand4  g50(.a(new_n82_), .b(x26), .c(new_n66_), .d(new_n45_), .O(new_n95_));
  oai21  g51(.a(new_n49_), .b(new_n64_), .c(new_n95_), .O(z16));
endmodule
