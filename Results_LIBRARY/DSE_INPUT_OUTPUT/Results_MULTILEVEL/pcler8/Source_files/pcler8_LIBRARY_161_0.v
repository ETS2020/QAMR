...
module FAU ( 
  ...
  inv1   g021(.a(new_n61_), .O(new_n66_));
  ...
  nor2   g026(.a(new_n66_), .b(new_n70_), .O(z07));
  inv1   g027(.a(x07), .O(new_n72_));
  oai21  g028(.a(new_n47_), .b(new_n72_), .c(new_n56_), .O(z08));
  ...
  inv1   g038(.a(x11), .O(new_n83_));
  inv1   g039(.a(x09), .O(new_n84_));
  nand3  g040(.a(x22), .b(x21), .c(x12), .O(new_n85_));
  oai21  g041(.a(new_n85_), .b(new_n77_), .c(x19), .O(new_n86_));
  ...
  aoi21  g046(.a(new_n90_), .b(new_n47_), .c(new_n83_), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(x10), .c(new_n59_), .O(z10));
  ...
  nor2   g051(.a(new_n74_), .b(x19), .O(new_n96_));
  ...
  nand3  g055(.a(new_n99_), .b(x09), .c(new_n47_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(x11), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n48_), .O(new_n102_));
  ...
  oai21  g062(.a(new_n106_), .b(new_n94_), .c(x21), .O(new_n107_));
  ...
  aoi21  g066(.a(new_n110_), .b(new_n108_), .c(new_n84_), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n47_), .c(new_n83_), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(x10), .c(new_n63_), .O(z12));
  ...
  aoi21  g074(.a(new_n118_), .b(new_n116_), .c(new_n84_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n47_), .c(new_n83_), .O(new_n120_));
  oai22  g076(.a(new_n120_), .b(x10), .c(new_n47_), .d(new_n65_), .O(z13));
  ...
  aoi21  g084(.a(new_n128_), .b(new_n125_), .c(new_n83_), .O(new_n129_));
  ...
  aoi21  g093(.a(new_n137_), .b(new_n135_), .c(new_n83_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n139_));
  oai21  g095(.a(new_n66_), .b(new_n70_), .c(new_n139_), .O(z15));
  ...
  nor2   g100(.a(new_n126_), .b(new_n117_), .O(new_n145_));
  nor2   g101(.a(x26), .b(new_n136_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n109_), .c(new_n145_), .d(new_n75_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n144_), .c(new_n83_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n149_));
  oai21  g105(.a(new_n66_), .b(new_n72_), .c(new_n149_), .O(z16));
endmodule
