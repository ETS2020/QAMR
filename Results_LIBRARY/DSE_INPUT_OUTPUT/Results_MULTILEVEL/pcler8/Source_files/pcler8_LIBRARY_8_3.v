...
module FAU ( 
  ...
  oai21  g023(.a(x10), .b(x07), .c(x08), .O(new_n68_));
  ...
  aoi21  g032(.a(new_n76_), .b(new_n54_), .c(x10), .O(z09));
  ...
  aoi21  g039(.a(new_n83_), .b(new_n56_), .c(x10), .O(z10));
  ...
  aoi21  g049(.a(new_n93_), .b(new_n58_), .c(x10), .O(z11));
  nor2   g050(.a(new_n78_), .b(new_n85_), .O(new_n95_));
  ...
  nand3  g055(.a(new_n95_), .b(new_n71_), .c(x21), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(x09), .c(new_n46_), .O(new_n102_));
  nand2  g058(.a(x08), .b(x03), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n102_), .c(x10), .O(z12));
  oai21  g060(.a(x10), .b(x04), .c(x08), .O(new_n105_));
  ...
  nand2  g068(.a(x23), .b(new_n71_), .O(new_n113_));
  ...
  oai21  g072(.a(x10), .b(x05), .c(x08), .O(new_n117_));
  ...
  nor2   g084(.a(new_n128_), .b(new_n71_), .O(new_n129_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n95_), .c(new_n142_), .d(new_n72_), .O(new_n144_));
