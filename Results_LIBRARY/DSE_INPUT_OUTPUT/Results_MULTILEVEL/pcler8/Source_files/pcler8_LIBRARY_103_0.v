...
module FAU ( 
  ...
  oai21  g020(.a(new_n47_), .b(new_n64_), .c(new_n57_), .O(z04));
  nand2  g021(.a(x08), .b(x04), .O(new_n66_));
  nand2  g022(.a(new_n66_), .b(new_n57_), .O(z05));
  oai21  g023(.a(new_n47_), .b(new_n56_), .c(new_n57_), .O(z06));
  ...
  nand2  g034(.a(new_n78_), .b(x05), .O(new_n79_));
  ...
  nand2  g054(.a(new_n98_), .b(x05), .O(new_n99_));
  ...
  nand4  g065(.a(new_n109_), .b(x09), .c(new_n47_), .d(x05), .O(new_n110_));
  ...
  aoi21  g073(.a(new_n117_), .b(new_n47_), .c(new_n56_), .O(new_n118_));
  ...
  nand3  g083(.a(new_n127_), .b(new_n48_), .c(x09), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n47_), .c(new_n56_), .O(z14));
  ...
  nand4  g092(.a(new_n136_), .b(x09), .c(new_n47_), .d(x05), .O(new_n137_));
  oai21  g093(.a(new_n58_), .b(new_n69_), .c(new_n137_), .O(z15));
  ...
  nand4  g100(.a(new_n144_), .b(new_n107_), .c(new_n143_), .d(new_n74_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n142_), .c(new_n82_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n47_), .c(new_n56_), .O(new_n147_));
