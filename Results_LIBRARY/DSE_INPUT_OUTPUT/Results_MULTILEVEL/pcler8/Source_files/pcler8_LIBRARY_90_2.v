...
module FAU ( 
  ...
  nand2  g011(.a(new_n55_), .b(x14), .O(new_n56_));
  ...
  aoi21  g036(.a(x08), .b(x00), .c(new_n80_), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(new_n79_), .O(z09));
  inv1   g038(.a(x20), .O(new_n83_));
  nand3  g039(.a(x22), .b(x21), .c(x12), .O(new_n84_));
  oai21  g040(.a(new_n84_), .b(new_n77_), .c(x20), .O(new_n85_));
  ...
  aoi21  g044(.a(x08), .b(x01), .c(new_n80_), .O(new_n89_));
  ...
  oai21  g049(.a(new_n92_), .b(new_n73_), .c(new_n93_), .O(new_n94_));
  ...
  inv1   g053(.a(x09), .O(new_n98_));
  nor2   g054(.a(new_n98_), .b(x08), .O(new_n99_));
  ...
  nor3   g059(.a(new_n103_), .b(new_n102_), .c(new_n74_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n101_), .c(new_n99_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n97_), .O(z11));
  nand3  g062(.a(x21), .b(x20), .c(x19), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x22), .O(new_n108_));
  nand2  g064(.a(new_n74_), .b(x21), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n91_), .c(new_n108_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n63_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n56_), .O(new_n113_));
  nand4  g069(.a(new_n104_), .b(new_n99_), .c(x14), .d(new_n47_), .O(new_n114_));
  ...
  nand3  g103(.a(new_n99_), .b(x26), .c(new_n47_), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(x14), .c(new_n55_), .O(new_n150_));
  inv1   g106(.a(x18), .O(new_n151_));
  nand2  g107(.a(new_n92_), .b(new_n151_), .O(new_n152_));
  nand4  g108(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(x26), .O(new_n154_));
  nor2   g110(.a(new_n55_), .b(new_n102_), .O(new_n155_));
  nor2   g111(.a(x26), .b(new_n142_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n92_), .c(new_n155_), .d(new_n75_), .O(new_n157_));
