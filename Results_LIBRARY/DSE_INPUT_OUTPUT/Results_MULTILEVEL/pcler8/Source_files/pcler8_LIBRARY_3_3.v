...
module FAU ( 
  ...
  nand2  g000(.a(x13), .b(x10), .O(new_n45_));
  ...
  nand3  g007(.a(new_n51_), .b(new_n48_), .c(new_n46_), .O(new_n52_));
  ...
  oai21  g014(.a(new_n58_), .b(new_n52_), .c(new_n45_), .O(z00));
  inv1   g015(.a(x00), .O(new_n60_));
  inv1   g016(.a(x08), .O(new_n61_));
  oai21  g017(.a(new_n61_), .b(new_n60_), .c(new_n45_), .O(z01));
  inv1   g018(.a(new_n45_), .O(new_n63_));
  ...
  nand2  g026(.a(new_n64_), .b(x04), .O(new_n71_));
  ...
  oai21  g033(.a(new_n61_), .b(new_n77_), .c(new_n45_), .O(z08));
  ...
  nand4  g039(.a(new_n83_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n84_));
  oai21  g040(.a(new_n79_), .b(new_n60_), .c(new_n84_), .O(z09));
  ...
  oai21  g044(.a(new_n50_), .b(x19), .c(new_n88_), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n65_), .O(z10));
  nand4  g047(.a(new_n57_), .b(new_n55_), .c(new_n51_), .d(new_n48_), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n46_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(x13), .O(new_n94_));
  xnor2a g050(.a(x21), .b(x20), .O(new_n95_));
  nand2  g051(.a(x21), .b(new_n49_), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(new_n49_), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n98_));
  nand2  g054(.a(x08), .b(x02), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n98_), .c(new_n94_), .O(z11));
  inv1   g056(.a(new_n51_), .O(new_n101_));
  ...
  nand3  g060(.a(new_n51_), .b(new_n53_), .c(x21), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n69_), .O(z12));
  ...
  nand2  g071(.a(x23), .b(new_n53_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n118_));
  aoi21  g074(.a(x08), .b(x04), .c(new_n63_), .O(new_n119_));
  ...
  nand4  g083(.a(new_n127_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n128_));
  aoi21  g084(.a(x08), .b(x05), .c(new_n63_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n128_), .O(z14));
  nand2  g086(.a(x26), .b(x17), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n55_), .c(x24), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n112_), .c(x25), .O(new_n133_));
  inv1   g089(.a(x25), .O(new_n134_));
  nand4  g090(.a(new_n125_), .b(new_n55_), .c(new_n134_), .d(x24), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n137_));
  aoi21  g093(.a(x08), .b(x06), .c(new_n63_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n137_), .O(z15));
  inv1   g095(.a(x18), .O(new_n140_));
  nand4  g096(.a(x21), .b(x20), .c(x19), .d(new_n140_), .O(new_n141_));
  nand3  g097(.a(new_n55_), .b(x25), .c(x24), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n141_), .c(x26), .O(new_n143_));
  nor2   g099(.a(new_n124_), .b(new_n54_), .O(new_n144_));
  nor2   g100(.a(x26), .b(new_n134_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n144_), .c(new_n80_), .d(new_n51_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n148_));
  oai21  g104(.a(new_n79_), .b(new_n77_), .c(new_n148_), .O(z16));
endmodule
