...
module FAU ( 
  ...
  nand2  g000(.a(x10), .b(x02), .O(new_n45_));
  ...
  nand2  g019(.a(new_n63_), .b(new_n45_), .O(z02));
  nand2  g020(.a(x08), .b(x02), .O(new_n65_));
  nor2   g021(.a(new_n65_), .b(x10), .O(z03));
  ...
  nand2  g031(.a(new_n75_), .b(new_n45_), .O(z08));
  ...
  nand2  g039(.a(x10), .b(x02), .O(new_n84_));
  ...
  nor2   g049(.a(new_n77_), .b(x20), .O(new_n94_));
  aoi21  g050(.a(new_n93_), .b(x20), .c(new_n94_), .O(new_n95_));
  nand2  g051(.a(x21), .b(new_n48_), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(new_n48_), .c(new_n96_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(x09), .c(new_n46_), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n65_), .c(x10), .O(z11));
  ...
  nand2  g063(.a(new_n60_), .b(x04), .O(new_n108_));
  ...
  aoi21  g091(.a(x08), .b(x06), .c(new_n59_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n135_), .O(z15));
  nand2  g093(.a(new_n60_), .b(x07), .O(new_n138_));
  ...
  nor2   g098(.a(new_n123_), .b(new_n53_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n132_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n78_), .d(new_n50_), .O(new_n145_));
