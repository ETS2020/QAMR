...
module FAU ( 
  ...
  oai21  g017(.a(new_n47_), .b(new_n61_), .c(new_n58_), .O(z03));
  ...
  nand2  g035(.a(new_n79_), .b(x14), .O(new_n80_));
  ...
  oai21  g056(.a(new_n64_), .b(new_n61_), .c(new_n100_), .O(z11));
  and2   g057(.a(x20), .b(x19), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n77_), .c(x21), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x22), .O(new_n104_));
  nand3  g060(.a(new_n102_), .b(new_n46_), .c(x21), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n104_), .c(new_n84_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n107_));
  oai21  g063(.a(new_n64_), .b(new_n63_), .c(new_n107_), .O(z12));
  nand4  g064(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n102_), .c(x21), .O(new_n110_));
  inv1   g066(.a(x23), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(x21), .c(x20), .d(x19), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  aoi21  g069(.a(new_n110_), .b(x23), .c(new_n113_), .O(new_n114_));
  nand2  g070(.a(x23), .b(new_n46_), .O(new_n115_));
  oai21  g071(.a(new_n114_), .b(new_n46_), .c(new_n115_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(x14), .c(new_n48_), .d(x09), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(x08), .c(new_n66_), .O(z13));
  ...
  oai21  g083(.a(new_n64_), .b(new_n68_), .c(new_n127_), .O(z14));
  ...
  nor2   g088(.a(new_n111_), .b(new_n46_), .O(new_n133_));
  nand4  g089(.a(new_n124_), .b(new_n133_), .c(new_n132_), .d(x24), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n131_), .c(new_n85_), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n47_), .c(new_n84_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(x10), .c(new_n70_), .O(z15));
  ...
  nor2   g097(.a(new_n123_), .b(new_n111_), .O(new_n142_));
  nor2   g098(.a(x26), .b(new_n132_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n102_), .c(new_n142_), .d(new_n75_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n141_), .c(new_n85_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n47_), .c(new_n84_), .O(new_n146_));
  oai22  g102(.a(new_n146_), .b(x10), .c(new_n47_), .d(new_n72_), .O(z16));
endmodule
