...
module FAU ( 
  ...
  nand4  g37(.a(new_n81_), .b(new_n77_), .c(x09), .d(new_n58_), .O(new_n82_));
  oai21  g38(.a(new_n72_), .b(new_n57_), .c(new_n82_), .O(z09));
  ...
  nand2  g44(.a(new_n88_), .b(new_n77_), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n62_), .O(z10));
  ...
  nand4  g51(.a(new_n95_), .b(new_n77_), .c(x09), .d(new_n58_), .O(new_n96_));
  oai21  g52(.a(new_n72_), .b(new_n64_), .c(new_n96_), .O(z11));
  ...
  oai21  g61(.a(new_n105_), .b(new_n98_), .c(new_n77_), .O(new_n106_));
  ...
  oai21  g68(.a(new_n112_), .b(new_n98_), .c(new_n77_), .O(new_n113_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n77_), .c(x09), .d(new_n58_), .O(new_n123_));
  oai21  g79(.a(new_n72_), .b(new_n70_), .c(new_n123_), .O(z14));
  ...
  oai21  g86(.a(new_n130_), .b(new_n98_), .c(new_n77_), .O(new_n131_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n103_), .c(new_n138_), .d(new_n78_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n77_), .c(x09), .d(new_n58_), .O(new_n142_));
