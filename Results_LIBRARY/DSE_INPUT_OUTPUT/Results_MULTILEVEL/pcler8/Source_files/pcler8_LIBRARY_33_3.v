...
module FAU ( 
  ...
  nand2  g32(.a(new_n53_), .b(x02), .O(new_n78_));
  aoi21  g33(.a(x20), .b(x19), .c(x23), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(x21), .O(new_n80_));
  nand3  g35(.a(new_n46_), .b(x20), .c(x19), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand4  g37(.a(new_n82_), .b(new_n73_), .c(x09), .d(new_n52_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n78_), .O(z11));
  nand2  g39(.a(new_n53_), .b(x03), .O(new_n85_));
  oai21  g40(.a(new_n79_), .b(new_n46_), .c(x22), .O(new_n86_));
  nor2   g41(.a(x23), .b(x22), .O(new_n87_));
  nand4  g42(.a(new_n87_), .b(x21), .c(x20), .d(x19), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n73_), .c(x09), .d(new_n52_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n85_), .O(z12));
  nand2  g46(.a(new_n53_), .b(x04), .O(new_n92_));
  nand2  g47(.a(x20), .b(x19), .O(new_n93_));
  nand3  g48(.a(new_n47_), .b(x22), .c(x21), .O(new_n94_));
  oai22  g49(.a(new_n94_), .b(new_n93_), .c(new_n47_), .d(x21), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n73_), .c(x09), .d(new_n52_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n92_), .O(z13));
  nand2  g52(.a(x08), .b(x05), .O(new_n98_));
  nand3  g53(.a(new_n69_), .b(x24), .c(new_n73_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n98_), .c(new_n48_), .O(z14));
  nand3  g55(.a(new_n69_), .b(x25), .c(new_n73_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n64_), .c(new_n49_), .O(z15));
  nand2  g57(.a(x08), .b(x07), .O(new_n103_));
  nand3  g58(.a(new_n69_), .b(x26), .c(new_n73_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n103_), .c(new_n48_), .O(z16));
  zero   g60(.O(z00));
endmodule
