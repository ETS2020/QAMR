...
module FAU ( 
  ...
  aoi21  g57(.a(new_n101_), .b(new_n98_), .c(x08), .O(new_n102_));
  ...
  nor2   g78(.a(new_n108_), .b(new_n99_), .O(new_n123_));
  ...
  nand4  g93(.a(new_n137_), .b(new_n100_), .c(new_n136_), .d(new_n73_), .O(new_n138_));
