...
module FAU ( 
  ...
  nand2  g011(.a(new_n49_), .b(x06), .O(new_n56_));
  ...
  oai21  g039(.a(new_n83_), .b(new_n76_), .c(x20), .O(new_n84_));
  ...
  aoi21  g044(.a(new_n88_), .b(new_n48_), .c(x06), .O(new_n89_));
  ...
  aoi21  g071(.a(new_n115_), .b(new_n48_), .c(x06), .O(new_n116_));
  ...
  aoi21  g081(.a(new_n125_), .b(new_n48_), .c(x06), .O(new_n126_));
  ...
  aoi21  g100(.a(new_n144_), .b(new_n141_), .c(new_n82_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n48_), .c(x06), .O(new_n146_));
