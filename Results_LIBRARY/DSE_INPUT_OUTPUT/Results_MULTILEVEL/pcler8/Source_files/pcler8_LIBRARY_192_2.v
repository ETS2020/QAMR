...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n61_, new_n65_, new_n68_, new_n70_, new_n72_, new_n73_, new_n74_,
  ...
  nor2   g011(.a(x19), .b(new_n55_), .O(new_n56_));
  ...
  nand2  g023(.a(new_n57_), .b(x06), .O(new_n68_));
  inv1   g024(.a(new_n68_), .O(z07));
  nand2  g025(.a(x08), .b(x07), .O(new_n70_));
  nand2  g026(.a(new_n70_), .b(new_n60_), .O(z08));
  nand2  g027(.a(x21), .b(x20), .O(new_n72_));
  inv1   g028(.a(new_n72_), .O(new_n73_));
  nand3  g029(.a(new_n73_), .b(x19), .c(x11), .O(new_n74_));
  nand3  g030(.a(x26), .b(x25), .c(x24), .O(new_n75_));
  inv1   g031(.a(new_n75_), .O(new_n76_));
  nand3  g032(.a(new_n76_), .b(x23), .c(x22), .O(new_n77_));
  oai22  g033(.a(new_n77_), .b(new_n74_), .c(x19), .d(x13), .O(new_n78_));
  nand4  g034(.a(new_n78_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n79_));
  oai21  g035(.a(new_n58_), .b(new_n54_), .c(new_n79_), .O(z09));
  ...
  oai21  g041(.a(new_n81_), .b(x19), .c(new_n85_), .O(new_n86_));
  nand4  g042(.a(new_n86_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n87_));
  nand3  g043(.a(new_n87_), .b(new_n61_), .c(new_n60_), .O(z10));
  inv1   g044(.a(x09), .O(new_n89_));
  nor2   g045(.a(new_n89_), .b(x08), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(x20), .c(new_n47_), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n77_), .c(x19), .O(new_n92_));
  ...
  nand3  g055(.a(new_n99_), .b(new_n98_), .c(new_n93_), .O(z11));
  nand3  g056(.a(new_n90_), .b(x22), .c(new_n47_), .O(new_n101_));
  ...
  oai21  g060(.a(new_n104_), .b(new_n75_), .c(x21), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n81_), .c(x22), .O(new_n106_));
  ...
  nand3  g067(.a(new_n111_), .b(new_n110_), .c(new_n103_), .O(z12));
  nand3  g068(.a(new_n90_), .b(x23), .c(new_n47_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n55_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n94_), .O(new_n115_));
  ...
  nand2  g074(.a(new_n72_), .b(x23), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(x22), .c(x19), .O(new_n121_));
  nand2  g077(.a(x23), .b(new_n107_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n115_), .c(new_n65_), .O(z13));
  nand3  g081(.a(new_n90_), .b(x24), .c(new_n47_), .O(new_n126_));
  ...
  oai21  g086(.a(new_n130_), .b(new_n72_), .c(x24), .O(new_n131_));
  inv1   g087(.a(x23), .O(new_n132_));
  nor2   g088(.a(x24), .b(new_n132_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n73_), .c(x22), .d(x19), .O(new_n134_));
  ...
  nand3  g093(.a(new_n137_), .b(new_n136_), .c(new_n128_), .O(z14));
  nand3  g094(.a(x22), .b(x21), .c(x20), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  nand2  g096(.a(x26), .b(x17), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n140_), .c(x24), .d(x23), .O(new_n142_));
  inv1   g098(.a(x25), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(x24), .c(x23), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n139_), .O(new_n145_));
  aoi21  g101(.a(new_n142_), .b(x25), .c(new_n145_), .O(new_n146_));
  nand3  g102(.a(x25), .b(new_n94_), .c(new_n55_), .O(new_n147_));
  oai21  g103(.a(new_n146_), .b(new_n94_), .c(new_n147_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n68_), .O(z15));
  nand2  g106(.a(new_n57_), .b(x07), .O(new_n151_));
  nor2   g107(.a(new_n72_), .b(x18), .O(new_n152_));
  ...
  nand3  g114(.a(x26), .b(new_n94_), .c(new_n55_), .O(new_n159_));
