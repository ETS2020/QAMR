...
module FAU ( 
  ...
  and2   g023(.a(new_n56_), .b(x05), .O(z06));
  ...
  nand2  g062(.a(new_n56_), .b(x04), .O(new_n107_));
  ...
  nand3  g075(.a(x19), .b(new_n47_), .c(new_n46_), .O(new_n120_));
  inv1   g076(.a(x23), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n74_), .O(new_n122_));
  nor2   g078(.a(new_n73_), .b(new_n81_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n120_), .c(x09), .O(new_n125_));
  ...
  aoi21  g086(.a(new_n130_), .b(new_n127_), .c(new_n119_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n132_));
  nand2  g088(.a(x08), .b(x05), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(new_n126_), .O(z14));
  nand3  g090(.a(x25), .b(new_n47_), .c(new_n46_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x09), .O(new_n136_));
  ...
  oai21  g095(.a(new_n139_), .b(new_n111_), .c(x25), .O(new_n140_));
  inv1   g096(.a(x25), .O(new_n141_));
  nand4  g097(.a(new_n127_), .b(new_n122_), .c(new_n141_), .d(x24), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n137_), .c(new_n69_), .O(z15));
  nor2   g101(.a(new_n88_), .b(x18), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n123_), .O(new_n147_));
  nand3  g103(.a(new_n122_), .b(x25), .c(x24), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n147_), .c(x26), .O(new_n149_));
  nor2   g105(.a(new_n119_), .b(new_n121_), .O(new_n150_));
  nor2   g106(.a(x26), .b(new_n141_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n98_), .c(new_n150_), .d(new_n75_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n154_));
  oai21  g110(.a(new_n57_), .b(new_n71_), .c(new_n154_), .O(z16));
endmodule
