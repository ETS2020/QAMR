...
module FAU ( 
  ...
  oai21  g035(.a(new_n68_), .b(new_n54_), .c(new_n79_), .O(z09));
  ...
  oai21  g042(.a(new_n68_), .b(new_n58_), .c(new_n86_), .O(z10));
  ...
  nand3  g052(.a(new_n96_), .b(new_n60_), .c(new_n56_), .O(z11));
  ...
  oai21  g081(.a(new_n68_), .b(new_n67_), .c(new_n125_), .O(z14));
  ...
  aoi21  g101(.a(x08), .b(x07), .c(new_n55_), .O(new_n146_));
