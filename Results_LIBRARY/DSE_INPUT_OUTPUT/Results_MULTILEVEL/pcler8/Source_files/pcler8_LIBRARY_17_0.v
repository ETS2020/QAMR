...
module FAU ( 
  ...
  nor2   g019(.a(new_n54_), .b(new_n46_), .O(new_n64_));
  nand2  g020(.a(new_n64_), .b(x04), .O(new_n65_));
  ...
  nand2  g032(.a(new_n76_), .b(new_n55_), .O(new_n77_));
  ...
  oai21  g045(.a(new_n46_), .b(new_n58_), .c(new_n89_), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n55_), .O(new_n91_));
  ...
  nand2  g056(.a(new_n100_), .b(new_n55_), .O(new_n101_));
  ...
  nor2   g077(.a(x23), .b(new_n80_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n112_), .c(x21), .d(x07), .O(new_n123_));
  ...
  nand2  g082(.a(new_n64_), .b(x05), .O(new_n127_));
  nand3  g083(.a(x26), .b(x25), .c(x16), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n112_), .c(x22), .d(x21), .O(new_n129_));
  inv1   g085(.a(x24), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x22), .c(x21), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n108_), .O(new_n132_));
  aoi21  g088(.a(new_n129_), .b(x24), .c(new_n132_), .O(new_n133_));
  nand3  g089(.a(x24), .b(new_n81_), .c(x07), .O(new_n134_));
  oai21  g090(.a(new_n133_), .b(new_n81_), .c(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n127_), .O(z14));
  nand3  g093(.a(new_n74_), .b(x25), .c(new_n47_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x07), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n81_), .O(new_n140_));
  nand2  g096(.a(x26), .b(x17), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(x24), .c(x22), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n117_), .c(x25), .O(new_n143_));
  inv1   g099(.a(x25), .O(new_n144_));
  nand4  g100(.a(new_n118_), .b(new_n82_), .c(new_n144_), .d(x24), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n140_), .c(new_n69_), .O(z15));
  oai21  g104(.a(new_n81_), .b(x07), .c(x08), .O(new_n149_));
  nand3  g105(.a(x26), .b(new_n47_), .c(x09), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x07), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n81_), .O(new_n152_));
  inv1   g108(.a(x18), .O(new_n153_));
  nand2  g109(.a(new_n112_), .b(new_n153_), .O(new_n154_));
  nand4  g110(.a(x25), .b(x24), .c(x22), .d(x21), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n154_), .c(x26), .O(new_n156_));
  nand3  g112(.a(new_n112_), .b(x22), .c(x21), .O(new_n157_));
  nand4  g113(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n156_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n152_), .c(new_n149_), .O(z16));
endmodule
