...
module FAU ( 
  ...
  nand2  g19(.a(new_n64_), .b(new_n57_), .O(z07));
  ...
  nand2  g44(.a(new_n89_), .b(x21), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(new_n79_), .c(new_n88_), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n58_), .c(new_n57_), .O(z12));
  ...
  nand2  g55(.a(new_n50_), .b(x05), .O(new_n101_));
  nand3  g56(.a(new_n48_), .b(x23), .c(x22), .O(new_n102_));
  oai22  g57(.a(new_n102_), .b(new_n87_), .c(new_n48_), .d(x23), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n101_), .O(z14));
  nand3  g60(.a(new_n70_), .b(x25), .c(new_n74_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n64_), .c(new_n57_), .O(z15));
