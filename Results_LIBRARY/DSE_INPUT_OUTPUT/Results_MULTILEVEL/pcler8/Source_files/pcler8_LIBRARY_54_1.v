...
module FAU ( 
  ...
  nand3  g082(.a(new_n126_), .b(new_n67_), .c(new_n56_), .O(z14));
  ...
  oai21  g092(.a(new_n57_), .b(new_n69_), .c(new_n136_), .O(z15));
  ...
  nand4  g099(.a(new_n143_), .b(new_n99_), .c(new_n142_), .d(new_n75_), .O(new_n144_));
