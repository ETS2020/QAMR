...
module FAU ( 
  ...
  nand3  g38(.a(new_n83_), .b(new_n56_), .c(new_n49_), .O(z11));
  ...
  aoi21  g45(.a(new_n90_), .b(new_n58_), .c(new_n48_), .O(z12));
  nand2  g46(.a(new_n53_), .b(x04), .O(new_n92_));
  nand4  g47(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n47_), .c(x23), .O(new_n94_));
  nand3  g49(.a(new_n46_), .b(x22), .c(x21), .O(new_n95_));
  oai21  g50(.a(new_n95_), .b(new_n78_), .c(new_n94_), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n73_), .c(x09), .d(new_n52_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n92_), .O(z13));
  nand3  g53(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  oai21  g54(.a(new_n99_), .b(new_n78_), .c(new_n47_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n73_), .c(x09), .d(new_n52_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n62_), .c(new_n49_), .O(z14));
  nand3  g57(.a(new_n69_), .b(x25), .c(new_n73_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n64_), .c(new_n49_), .O(z15));
  nand2  g59(.a(x08), .b(x07), .O(new_n105_));
  nand3  g60(.a(new_n69_), .b(x26), .c(new_n73_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n105_), .c(new_n48_), .O(z16));
  zero   g62(.O(z00));
endmodule
