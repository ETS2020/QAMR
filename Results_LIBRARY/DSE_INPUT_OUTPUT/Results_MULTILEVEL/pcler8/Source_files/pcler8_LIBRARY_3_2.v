...
module FAU ( 
  ...
  nor2   g001(.a(x13), .b(new_n45_), .O(new_n46_));
  ...
  nor2   g025(.a(new_n63_), .b(new_n69_), .O(z05));
  ...
  oai21  g031(.a(new_n48_), .b(new_n75_), .c(new_n47_), .O(z08));
  ...
  oai21  g038(.a(new_n63_), .b(new_n60_), .c(new_n82_), .O(z09));
  ...
  aoi21  g082(.a(x08), .b(x05), .c(new_n46_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n126_), .O(z14));
  nand2  g084(.a(x26), .b(x17), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n55_), .c(x24), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n110_), .c(x25), .O(new_n131_));
  inv1   g087(.a(x25), .O(new_n132_));
  nand4  g088(.a(new_n123_), .b(new_n55_), .c(new_n132_), .d(x24), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n135_));
  aoi21  g091(.a(x08), .b(x06), .c(new_n46_), .O(new_n136_));
  ...
  nor2   g097(.a(new_n122_), .b(new_n54_), .O(new_n142_));
  ...
  oai21  g102(.a(new_n63_), .b(new_n75_), .c(new_n146_), .O(z16));
endmodule
