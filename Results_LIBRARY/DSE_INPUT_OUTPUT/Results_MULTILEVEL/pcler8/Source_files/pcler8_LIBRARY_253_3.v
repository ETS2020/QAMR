...
module FAU ( 
  ...
  nand2  g15(.a(new_n59_), .b(new_n56_), .O(z05));
  ...
  nand3  g27(.a(new_n46_), .b(x20), .c(new_n69_), .O(new_n72_));
  oai21  g28(.a(x20), .b(new_n69_), .c(new_n72_), .O(new_n73_));
  nand4  g29(.a(new_n73_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n74_));
  nand2  g30(.a(new_n74_), .b(new_n52_), .O(z10));
  xor2a  g31(.a(x21), .b(x19), .O(new_n76_));
  nand3  g32(.a(new_n76_), .b(new_n46_), .c(x20), .O(new_n77_));
  ...
  nand3  g37(.a(new_n68_), .b(x09), .c(new_n48_), .O(new_n82_));
  inv1   g38(.a(x22), .O(new_n83_));
  nand3  g39(.a(new_n83_), .b(x21), .c(x19), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n82_), .c(new_n46_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(x20), .O(new_n86_));
  nand3  g42(.a(x21), .b(x20), .c(x19), .O(new_n87_));
  inv1   g43(.a(new_n87_), .O(new_n88_));
  nor2   g44(.a(new_n88_), .b(new_n83_), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n90_));
  nand3  g46(.a(new_n90_), .b(new_n86_), .c(new_n57_), .O(z12));
  inv1   g47(.a(x23), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(x22), .c(x21), .d(x19), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n82_), .c(new_n46_), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(x20), .O(new_n95_));
  nand4  g51(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(x23), .c(new_n68_), .O(new_n97_));
  inv1   g53(.a(new_n97_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(x09), .c(new_n48_), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(new_n95_), .c(new_n59_), .O(z13));
  inv1   g56(.a(x24), .O(new_n101_));
  nand4  g57(.a(x23), .b(x22), .c(x21), .d(x19), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n46_), .c(new_n45_), .O(new_n103_));
  and2   g59(.a(x23), .b(x22), .O(new_n104_));
  nor2   g60(.a(x25), .b(x24), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n104_), .c(new_n88_), .O(new_n106_));
  oai21  g62(.a(new_n103_), .b(new_n101_), .c(new_n106_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n61_), .O(z14));
  nand3  g65(.a(x24), .b(x23), .c(x22), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n87_), .c(new_n46_), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n112_));
  aoi21  g68(.a(x08), .b(x06), .c(z00), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n112_), .O(z15));
  nand2  g70(.a(x08), .b(x07), .O(new_n115_));
  nand4  g71(.a(x26), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n116_));
  aoi21  g72(.a(new_n116_), .b(new_n115_), .c(z00), .O(z16));
endmodule
