...
module FAU ( 
  ...
  nand2  g017(.a(new_n61_), .b(new_n45_), .O(z02));
  inv1   g018(.a(x02), .O(new_n63_));
  oai21  g019(.a(new_n46_), .b(new_n63_), .c(new_n45_), .O(z03));
  ...
  nand2  g027(.a(new_n71_), .b(new_n45_), .O(z06));
  nand2  g028(.a(new_n66_), .b(x06), .O(new_n73_));
  inv1   g029(.a(new_n73_), .O(z07));
  nand2  g030(.a(new_n66_), .b(x07), .O(new_n75_));
  inv1   g031(.a(new_n75_), .O(z08));
  inv1   g032(.a(new_n66_), .O(new_n77_));
  ...
  nand3  g045(.a(new_n89_), .b(new_n61_), .c(new_n45_), .O(z10));
  ...
  aoi21  g060(.a(x08), .b(x03), .c(new_n65_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n104_), .O(z12));
  nand2  g062(.a(new_n66_), .b(x04), .O(new_n107_));
  ...
  nand3  g082(.a(new_n126_), .b(new_n71_), .c(new_n45_), .O(z14));
  ...
  aoi21  g090(.a(x08), .b(x06), .c(new_n65_), .O(new_n135_));
