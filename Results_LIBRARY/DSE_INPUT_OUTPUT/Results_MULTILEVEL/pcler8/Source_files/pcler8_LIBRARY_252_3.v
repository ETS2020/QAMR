...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_,
    ...
    new_n101_, new_n102_, new_n104_, new_n105_, new_n107_;
  ...
  aoi21  g52(.a(x08), .b(x04), .c(new_n49_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n97_), .O(z13));
  nand3  g54(.a(x23), .b(x22), .c(x21), .O(new_n100_));
  oai21  g55(.a(new_n100_), .b(new_n86_), .c(new_n48_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n62_), .c(new_n53_), .O(z14));
  nand2  g58(.a(x08), .b(x06), .O(new_n104_));
  nand3  g59(.a(new_n72_), .b(x25), .c(new_n69_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n104_), .c(new_n49_), .O(z15));
  nand3  g61(.a(new_n72_), .b(x26), .c(new_n69_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n66_), .c(new_n53_), .O(z16));
  zero   g63(.O(z00));
endmodule
