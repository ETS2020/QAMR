...
module FAU ( 
  ...
  nor2   g009(.a(new_n45_), .b(x09), .O(new_n54_));
  ...
  nand2  g029(.a(new_n73_), .b(x09), .O(new_n74_));
  ...
  oai21  g044(.a(new_n61_), .b(new_n58_), .c(new_n88_), .O(z10));
  ...
  nor2   g054(.a(new_n83_), .b(new_n73_), .O(new_n99_));
  ...
  nand2  g064(.a(new_n108_), .b(x09), .O(new_n109_));
  ...
  nand3  g069(.a(new_n113_), .b(x23), .c(x09), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(new_n76_), .O(new_n115_));
  nand3  g071(.a(x23), .b(new_n76_), .c(x09), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n115_), .c(new_n47_), .O(new_n118_));
  aoi21  g074(.a(x08), .b(x04), .c(new_n54_), .O(new_n119_));
  oai21  g075(.a(new_n118_), .b(x08), .c(new_n119_), .O(z13));
  nand2  g076(.a(new_n47_), .b(new_n46_), .O(new_n121_));
  nand3  g077(.a(x25), .b(x24), .c(x16), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n121_), .c(x09), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x26), .O(new_n124_));
  nor2   g080(.a(new_n108_), .b(new_n76_), .O(new_n125_));
  nand3  g081(.a(new_n99_), .b(new_n125_), .c(x21), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x24), .O(new_n127_));
  inv1   g083(.a(x24), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(x23), .c(x22), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n113_), .c(new_n127_), .O(new_n130_));
  ...
  nand2  g089(.a(x25), .b(x17), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n121_), .c(x09), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x26), .O(new_n136_));
  nor2   g092(.a(new_n128_), .b(new_n108_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x22), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n113_), .c(x25), .O(new_n139_));
  inv1   g095(.a(x25), .O(new_n140_));
  nand3  g096(.a(new_n125_), .b(new_n140_), .c(x24), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n113_), .c(new_n139_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n136_), .c(new_n69_), .O(z15));
  inv1   g100(.a(x18), .O(new_n145_));
  nand4  g101(.a(x21), .b(x20), .c(x19), .d(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n125_), .b(x25), .c(x24), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n146_), .c(x26), .O(new_n148_));
  nor2   g104(.a(x26), .b(new_n140_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n99_), .c(new_n137_), .d(new_n77_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n152_));
  oai21  g108(.a(new_n61_), .b(new_n71_), .c(new_n152_), .O(z16));
endmodule
