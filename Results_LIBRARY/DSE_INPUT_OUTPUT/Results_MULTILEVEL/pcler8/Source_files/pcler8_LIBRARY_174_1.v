...
module FAU ( 
  ...
  oai21  g22(.a(new_n48_), .b(new_n66_), .c(new_n47_), .O(z03));
  inv1   g23(.a(x03), .O(new_n68_));
  oai21  g24(.a(new_n48_), .b(new_n68_), .c(new_n47_), .O(z04));
  nand2  g25(.a(new_n61_), .b(x04), .O(new_n70_));
  inv1   g26(.a(new_n70_), .O(z05));
  inv1   g27(.a(x05), .O(new_n72_));
  oai21  g28(.a(new_n48_), .b(new_n72_), .c(new_n47_), .O(z06));
  inv1   g29(.a(x06), .O(new_n74_));
  oai21  g30(.a(new_n48_), .b(new_n74_), .c(new_n47_), .O(z07));
  and2   g31(.a(new_n61_), .b(x07), .O(z08));
  ...
  oai21  g38(.a(new_n62_), .b(new_n60_), .c(new_n82_), .O(z09));
  ...
  nand3  g44(.a(new_n88_), .b(new_n64_), .c(new_n47_), .O(z10));
  ...
  oai21  g51(.a(new_n62_), .b(new_n66_), .c(new_n95_), .O(z11));
  ...
  oai21  g59(.a(new_n62_), .b(new_n68_), .c(new_n103_), .O(z12));
  ...
  oai21  g79(.a(new_n62_), .b(new_n72_), .c(new_n123_), .O(z14));
  nand2  g80(.a(x26), .b(x17), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(new_n55_), .c(x24), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n108_), .c(x25), .O(new_n127_));
  inv1   g83(.a(x25), .O(new_n128_));
  nand4  g84(.a(new_n120_), .b(new_n55_), .c(new_n128_), .d(x24), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n131_));
  oai21  g87(.a(new_n62_), .b(new_n74_), .c(new_n131_), .O(z15));
  ...
  nor2   g92(.a(new_n119_), .b(new_n54_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n128_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n137_), .c(new_n78_), .d(new_n51_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n141_));
  aoi21  g97(.a(x08), .b(x07), .c(new_n46_), .O(new_n142_));
