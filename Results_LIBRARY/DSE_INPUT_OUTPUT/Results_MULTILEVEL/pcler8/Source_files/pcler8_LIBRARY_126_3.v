...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_,
    ...
    new_n94_, new_n96_, new_n97_, new_n99_;
  ...
  nand4  g42(.a(new_n87_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n88_));
  ...
  nand4  g46(.a(new_n91_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n92_));
  ...
  nand2  g50(.a(x08), .b(x06), .O(new_n96_));
  nand3  g51(.a(new_n71_), .b(x25), .c(new_n68_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n96_), .c(new_n48_), .O(z15));
  nand3  g53(.a(new_n71_), .b(x26), .c(new_n68_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n66_), .c(new_n49_), .O(z16));
  zero   g55(.O(z00));
endmodule
