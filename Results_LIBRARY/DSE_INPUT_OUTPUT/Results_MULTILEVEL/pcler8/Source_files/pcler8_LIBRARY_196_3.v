...
module FAU ( 
  ...
  xnor2a g31(.a(x21), .b(x19), .O(new_n77_));
  nand2  g32(.a(x21), .b(new_n76_), .O(new_n78_));
  oai21  g33(.a(new_n77_), .b(new_n76_), .c(new_n78_), .O(new_n79_));
  nand4  g34(.a(new_n79_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n80_));
  nand3  g35(.a(new_n80_), .b(new_n56_), .c(new_n53_), .O(z11));
  ...
  nand2  g40(.a(new_n85_), .b(x21), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(new_n84_), .c(new_n83_), .O(new_n87_));
  nand4  g42(.a(new_n87_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n88_));
  aoi21  g43(.a(x08), .b(x03), .c(new_n49_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n88_), .O(z12));
  ...
  oai21  g49(.a(new_n94_), .b(new_n84_), .c(new_n92_), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n60_), .c(new_n49_), .O(z13));
  ...
  oai21  g56(.a(new_n101_), .b(new_n82_), .c(new_n99_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n103_));
  aoi21  g58(.a(x08), .b(x05), .c(new_n49_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n103_), .O(z14));
  nand3  g60(.a(x24), .b(x23), .c(x22), .O(new_n106_));
  oai21  g61(.a(new_n106_), .b(new_n82_), .c(x25), .O(new_n107_));
  nand4  g62(.a(new_n47_), .b(x24), .c(x23), .d(x22), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n82_), .c(new_n107_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n110_));
  aoi21  g65(.a(x08), .b(x06), .c(new_n49_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n110_), .O(z15));
  nand4  g67(.a(new_n48_), .b(x25), .c(x24), .d(x23), .O(new_n113_));
  oai22  g68(.a(new_n113_), .b(new_n91_), .c(new_n48_), .d(x25), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n66_), .O(z16));
  zero   g71(.O(z00));
endmodule
