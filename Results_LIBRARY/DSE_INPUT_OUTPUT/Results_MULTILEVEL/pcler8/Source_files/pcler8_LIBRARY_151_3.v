...
module FAU ( 
  ...
  inv1   g015(.a(new_n45_), .O(new_n60_));
  ...
  nand2  g031(.a(new_n61_), .b(x00), .O(new_n76_));
  ...
  nand2  g042(.a(new_n78_), .b(x12), .O(new_n87_));
  ...
  aoi21  g049(.a(x08), .b(x01), .c(new_n60_), .O(new_n94_));
  ...
  nor2   g053(.a(new_n77_), .b(x20), .O(new_n98_));
  ...
  aoi21  g058(.a(x08), .b(x02), .c(new_n60_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n102_), .O(z11));
  nand2  g060(.a(x10), .b(x04), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x08), .c(x03), .O(new_n106_));
  nand2  g062(.a(x23), .b(x14), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n54_), .c(x21), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n48_), .c(x22), .O(new_n109_));
  nand3  g065(.a(new_n49_), .b(new_n51_), .c(x21), .O(new_n110_));
  ...
  nand2  g076(.a(x23), .b(new_n51_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x09), .c(new_n46_), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n68_), .c(x10), .O(z13));
  nand2  g080(.a(new_n61_), .b(x05), .O(new_n125_));
  nand2  g081(.a(new_n80_), .b(x16), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(x23), .c(x22), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n117_), .c(x24), .O(new_n128_));
  inv1   g084(.a(new_n117_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n81_), .c(x23), .d(x22), .O(new_n130_));
