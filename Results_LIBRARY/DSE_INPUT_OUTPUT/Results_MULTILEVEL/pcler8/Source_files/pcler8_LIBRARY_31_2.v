...
module FAU ( 
  ...
  nor2   g009(.a(x14), .b(new_n47_), .O(new_n54_));
  ...
  oai21  g016(.a(new_n46_), .b(new_n60_), .c(new_n57_), .O(z03));
  ...
  and2   g026(.a(new_n55_), .b(x07), .O(z08));
  ...
  oai21  g060(.a(new_n63_), .b(new_n62_), .c(new_n104_), .O(z12));
  ...
  oai21  g080(.a(new_n63_), .b(new_n67_), .c(new_n124_), .O(z14));
  ...
  nand3  g090(.a(new_n134_), .b(new_n69_), .c(new_n57_), .O(z15));
  ...
  nor2   g095(.a(new_n120_), .b(new_n126_), .O(new_n140_));
  nor2   g096(.a(x26), .b(new_n131_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n97_), .c(new_n140_), .d(new_n74_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n144_));
  aoi21  g100(.a(x08), .b(x07), .c(new_n54_), .O(new_n145_));
