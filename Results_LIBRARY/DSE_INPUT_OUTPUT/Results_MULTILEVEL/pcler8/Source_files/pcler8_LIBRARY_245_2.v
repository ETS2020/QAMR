...
module FAU ( 
  ...
  nand2  g026(.a(new_n70_), .b(new_n65_), .O(z05));
  inv1   g027(.a(x05), .O(new_n72_));
  oai21  g028(.a(new_n58_), .b(new_n72_), .c(new_n65_), .O(z06));
  and2   g029(.a(new_n60_), .b(x06), .O(z07));
  aoi21  g030(.a(x10), .b(new_n58_), .c(new_n45_), .O(z08));
  ...
  oai22  g037(.a(new_n81_), .b(x07), .c(new_n61_), .d(new_n57_), .O(z09));
  ...
  aoi21  g052(.a(new_n96_), .b(new_n58_), .c(x07), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(x10), .c(new_n66_), .O(z11));
  ...
  nand4  g071(.a(new_n115_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n107_), .O(z13));
  ...
  nand4  g079(.a(new_n123_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n124_));
  oai21  g080(.a(new_n61_), .b(new_n72_), .c(new_n124_), .O(z14));
  nand2  g081(.a(new_n76_), .b(x07), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(x08), .c(x06), .O(new_n127_));
  ...
  nand4  g089(.a(new_n133_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n134_));
  ...
  nand4  g099(.a(new_n143_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n144_));
  nand3  g100(.a(x10), .b(x08), .c(x07), .O(new_n145_));
