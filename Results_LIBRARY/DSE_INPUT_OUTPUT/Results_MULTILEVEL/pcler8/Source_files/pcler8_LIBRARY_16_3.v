...
module FAU ( 
  ...
  nand2  g031(.a(new_n75_), .b(new_n68_), .O(z07));
  ...
  aoi21  g052(.a(new_n96_), .b(new_n94_), .c(x08), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(x10), .c(x09), .O(new_n98_));
  ...
  oai21  g059(.a(new_n103_), .b(new_n95_), .c(x22), .O(new_n104_));
  inv1   g060(.a(new_n95_), .O(new_n105_));
  ...
  oai21  g067(.a(new_n111_), .b(new_n95_), .c(x23), .O(new_n112_));
  ...
  nand2  g091(.a(new_n135_), .b(new_n75_), .O(z15));
  ...
  nand4  g098(.a(new_n142_), .b(new_n105_), .c(new_n141_), .d(new_n79_), .O(new_n143_));
