...
module FAU ( 
  ...
  oai21  g015(.a(new_n47_), .b(new_n57_), .c(new_n59_), .O(z01));
  nor2   g016(.a(new_n58_), .b(new_n47_), .O(new_n61_));
  ...
  oai21  g022(.a(new_n47_), .b(new_n66_), .c(new_n59_), .O(z04));
  ...
  oai21  g028(.a(new_n47_), .b(new_n72_), .c(new_n59_), .O(z07));
  nand2  g029(.a(x08), .b(x07), .O(new_n74_));
  nand2  g030(.a(new_n74_), .b(new_n59_), .O(z08));
  inv1   g031(.a(new_n61_), .O(new_n76_));
  ...
  nand4  g035(.a(new_n79_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n80_));
  oai21  g036(.a(new_n76_), .b(new_n57_), .c(new_n80_), .O(z09));
  ...
  oai21  g040(.a(new_n49_), .b(x19), .c(new_n84_), .O(new_n85_));
  nand4  g041(.a(new_n85_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n62_), .O(z10));
  xor2a  g043(.a(x21), .b(x20), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(new_n45_), .O(new_n89_));
  inv1   g045(.a(new_n78_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(x22), .c(x20), .d(x13), .O(new_n91_));
  aoi21  g047(.a(new_n91_), .b(new_n89_), .c(new_n48_), .O(new_n92_));
  nand3  g048(.a(x21), .b(new_n48_), .c(new_n45_), .O(new_n93_));
  inv1   g049(.a(new_n93_), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n92_), .c(x09), .O(new_n95_));
  aoi21  g051(.a(x08), .b(x02), .c(new_n58_), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(x08), .c(new_n96_), .O(z11));
  inv1   g053(.a(new_n50_), .O(new_n98_));
  nand2  g054(.a(x23), .b(x14), .O(new_n99_));
  nand3  g055(.a(x26), .b(x25), .c(x24), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n99_), .c(x21), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n98_), .c(x22), .O(new_n102_));
  ...
  oai21  g061(.a(new_n76_), .b(new_n66_), .c(new_n105_), .O(z12));
  ...
  nor2   g078(.a(x24), .b(new_n122_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n121_), .c(x22), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n120_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n70_), .O(z14));
  nor2   g083(.a(new_n122_), .b(new_n52_), .O(new_n128_));
  ...
  nand4  g088(.a(new_n128_), .b(new_n121_), .c(new_n132_), .d(x24), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n135_));
  oai21  g091(.a(new_n76_), .b(new_n72_), .c(new_n135_), .O(z15));
  nor2   g092(.a(new_n51_), .b(new_n49_), .O(new_n137_));
  nor2   g093(.a(new_n48_), .b(x18), .O(new_n138_));
  ...
  nor2   g097(.a(new_n48_), .b(x10), .O(new_n142_));
  nand3  g098(.a(new_n46_), .b(x25), .c(x24), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n142_), .c(new_n128_), .d(new_n137_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x09), .c(new_n47_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n74_), .c(new_n59_), .O(z16));
endmodule
