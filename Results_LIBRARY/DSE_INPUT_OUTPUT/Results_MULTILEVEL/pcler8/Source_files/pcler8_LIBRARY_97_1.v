...
module FAU ( 
  ...
  nand3  g052(.a(new_n96_), .b(new_n62_), .c(new_n60_), .O(z11));
  ...
  nand2  g069(.a(x23), .b(new_n74_), .O(new_n114_));
  ...
  nor2   g083(.a(new_n127_), .b(new_n74_), .O(new_n128_));
  ...
  nand3  g102(.a(new_n146_), .b(new_n71_), .c(new_n60_), .O(z16));
endmodule
