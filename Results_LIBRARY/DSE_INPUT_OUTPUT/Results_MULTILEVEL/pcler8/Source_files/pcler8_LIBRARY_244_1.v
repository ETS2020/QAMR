...
module FAU ( 
  ...
  nor2   g027(.a(new_n69_), .b(new_n71_), .O(z06));
  ...
  nand3  g044(.a(new_n88_), .b(new_n62_), .c(new_n47_), .O(z10));
  ...
  nand3  g052(.a(new_n96_), .b(new_n64_), .c(new_n47_), .O(z11));
  ...
  oai21  g060(.a(new_n69_), .b(new_n66_), .c(new_n104_), .O(z12));
  ...
  aoi21  g071(.a(x08), .b(x04), .c(new_n46_), .O(new_n116_));
  ...
  aoi21  g081(.a(x08), .b(x05), .c(new_n46_), .O(new_n126_));
  ...
  nand4  g087(.a(new_n122_), .b(new_n55_), .c(new_n131_), .d(x24), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n73_), .c(new_n47_), .O(z15));
  ...
  nor2   g095(.a(new_n121_), .b(new_n54_), .O(new_n140_));
