...
module FAU ( 
  ...
  oai22  g35(.a(new_n79_), .b(x10), .c(new_n46_), .d(new_n54_), .O(z09));
  ...
  oai21  g61(.a(new_n105_), .b(new_n55_), .c(new_n47_), .O(new_n106_));
  oai21  g62(.a(new_n46_), .b(new_n63_), .c(new_n106_), .O(z12));
  ...
  oai21  g70(.a(new_n57_), .b(new_n65_), .c(new_n114_), .O(z13));
