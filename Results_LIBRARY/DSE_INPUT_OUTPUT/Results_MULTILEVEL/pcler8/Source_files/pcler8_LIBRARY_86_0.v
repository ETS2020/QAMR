...
module FAU ( 
  ...
  nand2  g024(.a(new_n68_), .b(new_n63_), .O(z04));
  inv1   g025(.a(x04), .O(new_n70_));
  oai21  g026(.a(new_n58_), .b(new_n70_), .c(new_n63_), .O(z05));
  and2   g027(.a(new_n60_), .b(x05), .O(z06));
  nand2  g028(.a(x08), .b(x06), .O(new_n73_));
  nand2  g029(.a(new_n73_), .b(new_n63_), .O(z07));
  and2   g030(.a(new_n60_), .b(x07), .O(z08));
  inv1   g031(.a(x10), .O(new_n76_));
  nor2   g032(.a(new_n50_), .b(new_n48_), .O(new_n77_));
  ...
  nand4  g036(.a(new_n80_), .b(new_n76_), .c(x09), .d(new_n58_), .O(new_n81_));
  oai21  g037(.a(new_n61_), .b(new_n57_), .c(new_n81_), .O(z09));
  nand2  g038(.a(new_n60_), .b(x01), .O(new_n83_));
  ...
  oai21  g042(.a(new_n47_), .b(x19), .c(new_n86_), .O(new_n87_));
  nand4  g043(.a(new_n87_), .b(new_n76_), .c(x09), .d(new_n58_), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(new_n83_), .O(z10));
  nand2  g045(.a(new_n60_), .b(x02), .O(new_n90_));
  nand3  g046(.a(x23), .b(x22), .c(x13), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n53_), .c(x21), .O(new_n92_));
  nor2   g048(.a(new_n48_), .b(x20), .O(new_n93_));
  ...
  nand4  g052(.a(new_n96_), .b(new_n76_), .c(x09), .d(new_n58_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n90_), .O(z11));
  ...
  oai21  g062(.a(new_n106_), .b(new_n99_), .c(new_n76_), .O(new_n107_));
  ...
  nand4  g069(.a(new_n113_), .b(new_n76_), .c(x09), .d(new_n58_), .O(new_n114_));
  oai21  g070(.a(new_n61_), .b(new_n70_), .c(new_n114_), .O(z13));
  ...
  aoi21  g078(.a(new_n122_), .b(new_n119_), .c(x08), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n99_), .c(new_n76_), .O(new_n124_));
  nand2  g080(.a(x08), .b(x05), .O(new_n125_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n99_), .c(new_n76_), .O(new_n133_));
  ...
  nor2   g094(.a(new_n120_), .b(new_n51_), .O(new_n139_));
  nor2   g095(.a(x26), .b(new_n130_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n104_), .c(new_n139_), .d(new_n77_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n138_), .c(x08), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n99_), .c(new_n76_), .O(new_n143_));
