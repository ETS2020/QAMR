...
module FAU ( 
  ...
  nand2  g024(.a(new_n60_), .b(x05), .O(new_n69_));
  ...
  nand2  g035(.a(new_n79_), .b(new_n56_), .O(new_n80_));
  ...
  nand3  g041(.a(new_n85_), .b(new_n82_), .c(new_n77_), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n80_), .O(z09));
  xor2a  g043(.a(x20), .b(x19), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n89_));
  oai21  g045(.a(new_n46_), .b(new_n59_), .c(new_n89_), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n56_), .O(new_n91_));
  nand2  g047(.a(x19), .b(x12), .O(new_n92_));
  nor2   g048(.a(new_n92_), .b(x10), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n85_), .c(new_n77_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n91_), .O(z10));
  xnor2a g051(.a(x21), .b(x20), .O(new_n96_));
  nand2  g052(.a(x21), .b(new_n75_), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n75_), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n99_));
  oai21  g055(.a(new_n46_), .b(new_n63_), .c(new_n99_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n56_), .O(new_n101_));
  nand2  g057(.a(x19), .b(x13), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(x10), .O(new_n103_));
  nand3  g059(.a(x23), .b(x22), .c(x20), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n84_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n103_), .c(new_n77_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n101_), .O(z11));
  nand2  g063(.a(x20), .b(x19), .O(new_n108_));
  nand2  g064(.a(x23), .b(x14), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n84_), .c(x21), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n108_), .c(x22), .O(new_n111_));
  inv1   g067(.a(x22), .O(new_n112_));
  inv1   g068(.a(new_n108_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n112_), .c(x21), .O(new_n114_));
  ...
  nand3  g075(.a(new_n113_), .b(x22), .c(x21), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n119_), .c(new_n54_), .O(new_n121_));
  ...
  nand3  g082(.a(new_n126_), .b(x23), .c(new_n47_), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(x09), .c(new_n46_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n122_), .c(new_n67_), .O(z13));
  nand3  g086(.a(x26), .b(x25), .c(x16), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n113_), .c(x22), .d(x21), .O(new_n132_));
  inv1   g088(.a(x24), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x22), .c(x21), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n108_), .O(new_n135_));
  aoi21  g091(.a(new_n132_), .b(x24), .c(new_n135_), .O(new_n136_));
  nand3  g092(.a(x24), .b(new_n118_), .c(new_n54_), .O(new_n137_));
  oai21  g093(.a(new_n136_), .b(new_n118_), .c(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n69_), .O(z14));
  nand2  g096(.a(new_n60_), .b(x06), .O(new_n141_));
  nand2  g097(.a(x26), .b(x17), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n124_), .c(x24), .d(x22), .O(new_n143_));
  inv1   g099(.a(x25), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(x24), .c(x22), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n123_), .O(new_n146_));
  aoi21  g102(.a(new_n143_), .b(x25), .c(new_n146_), .O(new_n147_));
  nand3  g103(.a(x25), .b(new_n118_), .c(new_n54_), .O(new_n148_));
  oai21  g104(.a(new_n147_), .b(new_n118_), .c(new_n148_), .O(new_n149_));
  ...
  nor2   g108(.a(new_n108_), .b(x18), .O(new_n153_));
  ...
  nand4  g112(.a(new_n45_), .b(x25), .c(x24), .d(x22), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n123_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(x23), .O(new_n159_));
  nand3  g115(.a(x26), .b(new_n118_), .c(new_n54_), .O(new_n160_));
