...
module FAU ( 
  ...
  nand3  g036(.a(x23), .b(x21), .c(x12), .O(new_n81_));
  ...
  nand2  g044(.a(x20), .b(x19), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(new_n90_));
  nand3  g046(.a(new_n88_), .b(x20), .c(x19), .O(new_n91_));
  oai21  g047(.a(new_n90_), .b(new_n88_), .c(new_n91_), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n93_));
  oai21  g049(.a(new_n46_), .b(new_n61_), .c(new_n93_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n56_), .O(new_n95_));
  nand2  g051(.a(x21), .b(x13), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(x10), .O(new_n97_));
  inv1   g053(.a(x22), .O(new_n98_));
  nor3   g054(.a(new_n82_), .b(new_n54_), .c(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n97_), .c(x09), .d(new_n46_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n95_), .O(z11));
  nand2  g057(.a(x23), .b(x14), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n82_), .c(x21), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n89_), .c(x22), .O(new_n104_));
  nand4  g060(.a(new_n90_), .b(new_n54_), .c(new_n98_), .d(x21), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n107_));
  oai21  g063(.a(new_n63_), .b(new_n65_), .c(new_n107_), .O(z12));
  nand4  g064(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n90_), .c(x21), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x23), .O(new_n111_));
  nand3  g067(.a(new_n90_), .b(new_n54_), .c(x21), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(new_n98_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n114_));
  oai21  g070(.a(new_n63_), .b(new_n67_), .c(new_n114_), .O(z13));
  nand2  g071(.a(new_n62_), .b(x05), .O(new_n116_));
  nand3  g072(.a(x26), .b(x25), .c(x16), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n90_), .c(x21), .O(new_n118_));
  inv1   g074(.a(x24), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x23), .c(x21), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n89_), .O(new_n121_));
  aoi21  g077(.a(new_n118_), .b(x24), .c(new_n121_), .O(new_n122_));
  nand2  g078(.a(x24), .b(new_n54_), .O(new_n123_));
  oai21  g079(.a(new_n122_), .b(new_n98_), .c(new_n123_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n116_), .O(z14));
  nand2  g082(.a(x26), .b(x17), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n90_), .c(x24), .d(x21), .O(new_n128_));
  ...
  aoi21  g088(.a(new_n128_), .b(x25), .c(new_n132_), .O(new_n133_));
  nand2  g089(.a(x25), .b(new_n54_), .O(new_n134_));
  oai21  g090(.a(new_n133_), .b(new_n98_), .c(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n71_), .O(z15));
  nor2   g093(.a(new_n89_), .b(x18), .O(new_n138_));
  nand3  g094(.a(x25), .b(x24), .c(x21), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n138_), .c(new_n45_), .O(new_n141_));
  nand4  g097(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n129_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n141_), .c(x22), .O(new_n144_));
  nand2  g100(.a(x26), .b(new_n54_), .O(new_n145_));
