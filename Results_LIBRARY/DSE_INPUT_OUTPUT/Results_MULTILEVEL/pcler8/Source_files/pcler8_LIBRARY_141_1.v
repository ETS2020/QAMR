...
module FAU ( 
  ...
  nor2   g017(.a(new_n54_), .b(new_n46_), .O(new_n62_));
  and2   g018(.a(new_n62_), .b(x03), .O(z04));
  nand2  g019(.a(x08), .b(x04), .O(new_n64_));
  nand2  g020(.a(new_n64_), .b(new_n55_), .O(z05));
  inv1   g021(.a(x05), .O(new_n66_));
  oai21  g022(.a(new_n46_), .b(new_n66_), .c(new_n55_), .O(z06));
  inv1   g023(.a(x06), .O(new_n68_));
  inv1   g024(.a(new_n62_), .O(new_n69_));
  nor2   g025(.a(new_n69_), .b(new_n68_), .O(z07));
  ...
  nand3  g035(.a(new_n79_), .b(new_n56_), .c(new_n55_), .O(z09));
  nand2  g036(.a(new_n62_), .b(x01), .O(new_n81_));
  ...
  nand2  g044(.a(new_n62_), .b(x02), .O(new_n89_));
  ...
  nor2   g049(.a(new_n73_), .b(x20), .O(new_n94_));
  aoi21  g050(.a(new_n93_), .b(x20), .c(new_n94_), .O(new_n95_));
  nand2  g051(.a(x21), .b(new_n90_), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(new_n90_), .c(new_n96_), .O(new_n97_));
  ...
  nand3  g072(.a(new_n116_), .b(new_n64_), .c(new_n55_), .O(z13));
  ...
  oai21  g082(.a(new_n69_), .b(new_n66_), .c(new_n126_), .O(z14));
  nand2  g083(.a(x26), .b(x17), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(x24), .c(x23), .d(x22), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n118_), .c(x25), .O(new_n130_));
  inv1   g086(.a(x25), .O(new_n131_));
  nor2   g087(.a(new_n113_), .b(new_n74_), .O(new_n132_));
  ...
  oai21  g091(.a(new_n69_), .b(new_n68_), .c(new_n135_), .O(z15));
  ...
  nor2   g096(.a(new_n122_), .b(new_n113_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n131_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n104_), .c(new_n141_), .d(new_n75_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n71_), .c(new_n55_), .O(z16));
endmodule
