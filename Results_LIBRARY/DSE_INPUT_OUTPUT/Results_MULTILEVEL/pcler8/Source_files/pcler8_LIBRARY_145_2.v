...
module FAU ( 
  ...
  nand2  g09(.a(new_n53_), .b(new_n46_), .O(z03));
  inv1   g10(.a(x03), .O(new_n55_));
  oai21  g11(.a(new_n49_), .b(new_n55_), .c(new_n46_), .O(z04));
  nand2  g12(.a(x08), .b(x04), .O(new_n57_));
  nand2  g13(.a(new_n57_), .b(new_n46_), .O(z05));
  inv1   g14(.a(x05), .O(new_n59_));
  inv1   g15(.a(x09), .O(new_n60_));
  oai21  g16(.a(x10), .b(new_n60_), .c(x08), .O(new_n61_));
  nor2   g17(.a(new_n61_), .b(new_n59_), .O(z06));
  inv1   g18(.a(x06), .O(new_n63_));
  nor2   g19(.a(new_n61_), .b(new_n63_), .O(z07));
  inv1   g20(.a(x07), .O(new_n65_));
  nor2   g21(.a(new_n61_), .b(new_n65_), .O(z08));
  nor2   g22(.a(new_n61_), .b(new_n48_), .O(z09));
  nor2   g23(.a(new_n61_), .b(new_n55_), .O(z12));
  oai21  g24(.a(new_n49_), .b(new_n63_), .c(new_n46_), .O(z15));
  oai21  g25(.a(new_n49_), .b(new_n65_), .c(new_n46_), .O(z16));
  nand2  g26(.a(new_n51_), .b(new_n46_), .O(z10));
  nand2  g27(.a(new_n53_), .b(new_n46_), .O(z11));
  nand2  g28(.a(new_n57_), .b(new_n46_), .O(z13));
