...
module FAU ( 
  ...
  nand3  g043(.a(new_n87_), .b(new_n86_), .c(new_n56_), .O(z10));
  ...
  oai21  g069(.a(new_n57_), .b(new_n65_), .c(new_n113_), .O(z13));
  ...
  nor2   g083(.a(new_n110_), .b(new_n74_), .O(new_n128_));
  nand4  g084(.a(new_n120_), .b(new_n128_), .c(new_n55_), .d(x24), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n131_));
  oai21  g087(.a(new_n57_), .b(new_n69_), .c(new_n131_), .O(z15));
  nand2  g088(.a(x26), .b(x09), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(x08), .c(new_n47_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n55_), .O(new_n135_));
  nor2   g091(.a(new_n119_), .b(new_n110_), .O(new_n136_));
  nor2   g092(.a(new_n98_), .b(x18), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n136_), .c(new_n75_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x26), .O(new_n139_));
  nor2   g095(.a(x26), .b(new_n55_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n102_), .c(new_n136_), .d(new_n75_), .O(new_n141_));
