...
module FAU ( 
  ...
  oai21  g18(.a(new_n63_), .b(new_n62_), .c(new_n51_), .O(z07));
  inv1   g19(.a(x07), .O(new_n65_));
  oai21  g20(.a(new_n63_), .b(new_n65_), .c(new_n51_), .O(z08));
  oai21  g21(.a(new_n63_), .b(new_n46_), .c(new_n51_), .O(z09));
  oai21  g22(.a(new_n63_), .b(new_n54_), .c(new_n51_), .O(z11));
  oai21  g23(.a(new_n63_), .b(new_n60_), .c(new_n51_), .O(z14));
  nor2   g24(.a(new_n48_), .b(new_n62_), .O(z15));
  nor2   g25(.a(new_n48_), .b(new_n65_), .O(z16));
  zero   g26(.O(z00));
  nand2  g27(.a(new_n52_), .b(new_n51_), .O(z10));
  nor2   g28(.a(new_n48_), .b(new_n56_), .O(z12));
  nor2   g29(.a(new_n48_), .b(new_n58_), .O(z13));
endmodule
