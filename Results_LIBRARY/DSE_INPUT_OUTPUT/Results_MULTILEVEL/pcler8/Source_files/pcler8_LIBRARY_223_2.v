...
module FAU ( 
  ...
  nand4  g32(.a(new_n76_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n77_));
  aoi21  g33(.a(x08), .b(x00), .c(new_n46_), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(new_n77_), .O(z09));
  nand3  g35(.a(x22), .b(x21), .c(x12), .O(new_n80_));
  oai21  g36(.a(new_n80_), .b(new_n75_), .c(x20), .O(new_n81_));
  ...
  nand2  g50(.a(new_n94_), .b(new_n62_), .O(z11));
  nand2  g51(.a(x23), .b(x14), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n55_), .c(x21), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n49_), .c(x22), .O(new_n98_));
  nand3  g54(.a(new_n50_), .b(new_n52_), .c(x21), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n101_));
  ...
  oai21  g61(.a(new_n105_), .b(new_n49_), .c(x23), .O(new_n106_));
  nand4  g62(.a(new_n50_), .b(new_n53_), .c(x22), .d(x21), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand4  g64(.a(new_n108_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n65_), .c(new_n47_), .O(z13));
  nand2  g66(.a(new_n59_), .b(x05), .O(new_n111_));
  ...
  nand2  g76(.a(new_n120_), .b(new_n111_), .O(z14));
  nand2  g77(.a(new_n59_), .b(x06), .O(new_n122_));
  ...
  nor2   g90(.a(new_n116_), .b(new_n53_), .O(new_n135_));
  nor2   g91(.a(x26), .b(new_n126_), .O(new_n136_));
  nand4  g92(.a(new_n136_), .b(new_n135_), .c(new_n73_), .d(new_n50_), .O(new_n137_));
  nand2  g93(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n139_));
  aoi21  g95(.a(x08), .b(x07), .c(new_n46_), .O(new_n140_));
