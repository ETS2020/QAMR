...
module FAU ( 
  ...
  nand2  g022(.a(new_n60_), .b(x06), .O(new_n67_));
  ...
  nand3  g039(.a(new_n83_), .b(new_n78_), .c(new_n73_), .O(new_n84_));
  ...
  nand2  g044(.a(new_n88_), .b(new_n55_), .O(new_n89_));
  nand2  g045(.a(x19), .b(x12), .O(new_n90_));
  nor2   g046(.a(new_n90_), .b(x10), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n83_), .c(new_n73_), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n89_), .O(z10));
  nand3  g049(.a(x23), .b(x22), .c(x13), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n82_), .c(x20), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n71_), .c(x21), .O(new_n96_));
  ...
  nor2   g072(.a(x23), .b(new_n80_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n106_), .c(x21), .d(x18), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n111_), .O(z13));
  nand3  g077(.a(new_n73_), .b(x24), .c(new_n47_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x18), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n81_), .O(new_n124_));
  nand3  g080(.a(x26), .b(x25), .c(x16), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x22), .c(x21), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n102_), .c(x24), .O(new_n127_));
  nor2   g083(.a(x24), .b(new_n81_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n113_), .c(x22), .O(new_n129_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n113_), .c(x24), .d(x22), .O(new_n135_));
  ...
  nand3  g095(.a(x25), .b(new_n81_), .c(x18), .O(new_n140_));
  oai21  g096(.a(new_n139_), .b(new_n81_), .c(new_n140_), .O(new_n141_));
