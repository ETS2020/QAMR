...
module FAU ( 
  ...
  nand3  g036(.a(new_n80_), .b(new_n79_), .c(new_n56_), .O(z09));
  ...
  nand3  g043(.a(new_n87_), .b(new_n59_), .c(new_n56_), .O(z10));
  ...
  nand3  g062(.a(x19), .b(x09), .c(new_n46_), .O(new_n107_));
  nand2  g063(.a(new_n75_), .b(x20), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n107_), .c(new_n47_), .O(new_n109_));
  ...
  nand3  g073(.a(new_n117_), .b(new_n110_), .c(new_n65_), .O(z13));
  ...
  nand4  g078(.a(new_n112_), .b(new_n122_), .c(x23), .d(x22), .O(new_n123_));
  ...
  nor2   g089(.a(new_n55_), .b(new_n74_), .O(new_n134_));
  nand4  g090(.a(new_n112_), .b(new_n134_), .c(new_n133_), .d(x24), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n129_), .c(new_n69_), .O(z15));
  ...
  nor2   g098(.a(new_n122_), .b(new_n55_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n133_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n102_), .c(new_n143_), .d(new_n75_), .O(new_n145_));
