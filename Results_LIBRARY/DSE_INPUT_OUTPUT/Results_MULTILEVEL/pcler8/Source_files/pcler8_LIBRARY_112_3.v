...
module FAU ( 
  ...
  nand2  g010(.a(x10), .b(x02), .O(new_n55_));
  oai21  g011(.a(new_n46_), .b(new_n54_), .c(new_n55_), .O(z01));
  nand2  g012(.a(x10), .b(x02), .O(new_n57_));
  nand3  g013(.a(new_n57_), .b(x08), .c(x01), .O(new_n58_));
  inv1   g014(.a(new_n58_), .O(z02));
  nand3  g015(.a(new_n47_), .b(x08), .c(x02), .O(new_n60_));
  inv1   g016(.a(new_n60_), .O(z03));
  inv1   g017(.a(new_n55_), .O(new_n62_));
  nor2   g018(.a(new_n62_), .b(new_n46_), .O(new_n63_));
  nand2  g019(.a(new_n63_), .b(x03), .O(new_n64_));
  inv1   g020(.a(new_n64_), .O(z04));
  nand2  g021(.a(x08), .b(x04), .O(new_n66_));
  and2   g022(.a(new_n66_), .b(new_n55_), .O(new_n67_));
  ...
  nand2  g030(.a(new_n63_), .b(x00), .O(new_n75_));
  ...
  oai21  g047(.a(x10), .b(x08), .c(x02), .O(new_n92_));
  ...
  nor2   g052(.a(new_n76_), .b(x20), .O(new_n97_));
  ...
  nand2  g057(.a(new_n101_), .b(new_n92_), .O(z11));
  nor2   g058(.a(new_n85_), .b(new_n93_), .O(new_n103_));
  ...
  nand3  g063(.a(new_n103_), .b(new_n77_), .c(x21), .O(new_n108_));
  ...
  nand2  g074(.a(x23), .b(new_n77_), .O(new_n119_));
  ...
  nand3  g086(.a(new_n130_), .b(new_n69_), .c(new_n55_), .O(z14));
  inv1   g087(.a(x23), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n77_), .O(new_n133_));
  ...
  aoi21  g096(.a(x08), .b(x06), .c(new_n62_), .O(new_n141_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n103_), .c(new_n147_), .d(new_n78_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n151_));
  aoi21  g107(.a(x08), .b(x07), .c(new_n62_), .O(new_n152_));
