...
module FAU ( 
  ...
  nand2  g011(.a(new_n55_), .b(x23), .O(new_n56_));
  ...
  nand3  g038(.a(new_n82_), .b(new_n81_), .c(new_n56_), .O(z09));
  ...
  nor3   g049(.a(new_n93_), .b(new_n92_), .c(new_n74_), .O(new_n94_));
  ...
  nor3   g062(.a(new_n93_), .b(new_n92_), .c(new_n73_), .O(new_n107_));
  ...
  nor2   g067(.a(new_n73_), .b(new_n97_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n111_), .c(x21), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n110_), .c(new_n63_), .O(new_n114_));
  ...
  inv1   g074(.a(new_n93_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x23), .c(x14), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n118_), .c(new_n111_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n115_), .O(z12));
  inv1   g079(.a(new_n117_), .O(new_n124_));
  nand3  g080(.a(x26), .b(x25), .c(x15), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n124_), .c(x22), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(x24), .c(x23), .O(new_n127_));
  nand4  g083(.a(new_n112_), .b(new_n116_), .c(x22), .d(x21), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n130_));
  oai21  g086(.a(new_n57_), .b(new_n65_), .c(new_n130_), .O(z13));
  nand2  g087(.a(new_n78_), .b(x16), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n124_), .c(x23), .d(x22), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(x24), .c(new_n47_), .d(x09), .O(new_n134_));
  oai22  g090(.a(new_n134_), .b(x08), .c(new_n57_), .d(new_n67_), .O(z14));
  nand3  g091(.a(new_n89_), .b(x19), .c(new_n47_), .O(new_n136_));
  nand3  g092(.a(new_n75_), .b(new_n77_), .c(x22), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n136_), .c(x24), .O(new_n138_));
  ...
  aoi21  g098(.a(new_n142_), .b(new_n124_), .c(new_n77_), .O(new_n143_));
  ...
  nand4  g102(.a(new_n75_), .b(new_n45_), .c(x25), .d(x22), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n136_), .c(x24), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x23), .O(new_n149_));
  nor3   g105(.a(new_n73_), .b(new_n97_), .c(x18), .O(new_n150_));
  nand4  g106(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n150_), .c(new_n45_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n149_), .c(new_n71_), .O(z16));
endmodule
