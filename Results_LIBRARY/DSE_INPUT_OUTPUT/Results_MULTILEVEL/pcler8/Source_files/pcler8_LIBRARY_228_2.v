...
module FAU ( 
  ...
  nand3  g062(.a(new_n106_), .b(new_n95_), .c(x21), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x23), .c(x22), .O(new_n108_));
  nand3  g064(.a(new_n95_), .b(new_n45_), .c(x21), .O(new_n109_));
  ...
  oai22  g073(.a(new_n117_), .b(x08), .c(new_n105_), .d(new_n66_), .O(z13));
  nand3  g074(.a(new_n46_), .b(x09), .c(new_n59_), .O(new_n119_));
  inv1   g075(.a(x24), .O(new_n120_));
  nand3  g076(.a(new_n95_), .b(new_n120_), .c(x21), .O(new_n121_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n95_), .c(new_n120_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n123_), .c(new_n68_), .O(z14));
  nand2  g085(.a(new_n60_), .b(x06), .O(new_n130_));
  nand2  g086(.a(x26), .b(x17), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n95_), .c(x24), .d(x21), .O(new_n132_));
  inv1   g088(.a(x25), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x24), .c(x22), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n113_), .O(new_n135_));
  aoi21  g091(.a(new_n132_), .b(x25), .c(new_n135_), .O(new_n136_));
  nand2  g092(.a(x25), .b(new_n45_), .O(new_n137_));
  oai21  g093(.a(new_n136_), .b(new_n81_), .c(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n130_), .O(z15));
  nand2  g096(.a(new_n60_), .b(x07), .O(new_n141_));
  inv1   g097(.a(x26), .O(new_n142_));
  nor2   g098(.a(new_n94_), .b(x18), .O(new_n143_));
  nand3  g099(.a(x25), .b(x24), .c(x21), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n143_), .c(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n142_), .b(x25), .c(x24), .d(x22), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n113_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n146_), .c(x23), .O(new_n149_));
  nand2  g105(.a(x26), .b(new_n45_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n141_), .O(z16));
endmodule
