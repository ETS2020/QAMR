...
module FAU ( 
  ...
  nand2  g11(.a(new_n56_), .b(new_n49_), .O(z03));
  ...
  nand4  g29(.a(new_n74_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n75_));
  nand2  g30(.a(x08), .b(x01), .O(new_n76_));
  aoi21  g31(.a(new_n76_), .b(new_n75_), .c(new_n48_), .O(z10));
  xnor2a g32(.a(x21), .b(x20), .O(new_n78_));
  nand2  g33(.a(x21), .b(new_n69_), .O(new_n79_));
  oai21  g34(.a(new_n78_), .b(new_n69_), .c(new_n79_), .O(new_n80_));
  nand4  g35(.a(new_n80_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(new_n56_), .c(new_n48_), .O(z11));
  nand3  g37(.a(new_n68_), .b(x09), .c(new_n52_), .O(new_n83_));
  nand2  g38(.a(x20), .b(x19), .O(new_n84_));
  inv1   g39(.a(x22), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(x21), .O(new_n86_));
  nor3   g41(.a(new_n86_), .b(new_n84_), .c(new_n83_), .O(new_n87_));
  aoi21  g42(.a(x08), .b(x03), .c(new_n87_), .O(new_n88_));
  ...
  nand3  g47(.a(new_n92_), .b(x09), .c(new_n52_), .O(new_n93_));
  oai21  g48(.a(new_n88_), .b(new_n48_), .c(new_n93_), .O(z12));
  nand2  g49(.a(new_n53_), .b(x04), .O(new_n95_));
  ...
  nand3  g58(.a(x23), .b(x22), .c(x21), .O(new_n104_));
  oai21  g59(.a(new_n104_), .b(new_n84_), .c(new_n47_), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n106_));
  aoi21  g61(.a(x08), .b(x05), .c(new_n48_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(z14));
  nand3  g63(.a(new_n71_), .b(x25), .c(new_n68_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n64_), .c(new_n48_), .O(z15));
  nand3  g65(.a(new_n71_), .b(x26), .c(new_n68_), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n66_), .c(new_n48_), .O(z16));
  zero   g67(.O(z00));
endmodule
