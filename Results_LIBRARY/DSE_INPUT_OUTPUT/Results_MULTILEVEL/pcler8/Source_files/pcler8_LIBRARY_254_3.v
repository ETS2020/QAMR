...
module FAU ( 
  ...
  oai21  g015(.a(new_n46_), .b(new_n59_), .c(new_n54_), .O(z02));
  ...
  nand3  g084(.a(new_n128_), .b(new_n67_), .c(new_n54_), .O(z14));
  ...
  nand2  g094(.a(new_n138_), .b(new_n69_), .O(z15));
  ...
  nand3  g106(.a(new_n150_), .b(new_n149_), .c(new_n142_), .O(z16));
endmodule
