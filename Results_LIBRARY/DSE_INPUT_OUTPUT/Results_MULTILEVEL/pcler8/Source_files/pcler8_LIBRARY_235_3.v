...
module FAU ( 
  ...
  nand2  g09(.a(x23), .b(x10), .O(new_n54_));
  ...
  oai22  g34(.a(new_n78_), .b(new_n76_), .c(x19), .d(x10), .O(new_n79_));
  nand3  g35(.a(new_n79_), .b(x09), .c(new_n46_), .O(new_n80_));
  nand2  g36(.a(x08), .b(x00), .O(new_n81_));
  nand3  g37(.a(new_n81_), .b(new_n80_), .c(new_n54_), .O(z09));
  xnor2a g38(.a(x20), .b(x19), .O(new_n83_));
  nand3  g39(.a(new_n75_), .b(x19), .c(x12), .O(new_n84_));
  oai22  g40(.a(new_n84_), .b(new_n78_), .c(new_n83_), .d(x10), .O(new_n85_));
  ...
  oai21  g51(.a(new_n55_), .b(new_n61_), .c(new_n95_), .O(z11));
  ...
  nor2   g64(.a(x23), .b(new_n74_), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n101_), .c(x21), .d(new_n47_), .O(new_n110_));
  ...
  nand3  g79(.a(new_n101_), .b(x09), .c(new_n46_), .O(new_n124_));
  inv1   g80(.a(x25), .O(new_n125_));
  nand3  g81(.a(new_n75_), .b(new_n125_), .c(x24), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n124_), .c(new_n47_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(x23), .O(new_n128_));
  nand2  g84(.a(x26), .b(x17), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(x24), .c(x23), .d(x22), .O(new_n130_));
  inv1   g86(.a(new_n130_), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n119_), .c(new_n125_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n133_));
  nand3  g89(.a(new_n133_), .b(new_n128_), .c(new_n69_), .O(z15));
  ...
  nand4  g95(.a(new_n139_), .b(new_n101_), .c(new_n77_), .d(new_n75_), .O(new_n140_));
