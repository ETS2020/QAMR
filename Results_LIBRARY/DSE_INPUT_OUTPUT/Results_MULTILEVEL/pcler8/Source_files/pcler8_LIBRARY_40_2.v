...
module FAU ( 
  ...
  nand3  g025(.a(new_n57_), .b(x08), .c(x06), .O(new_n70_));
  ...
  oai21  g044(.a(new_n74_), .b(x19), .c(new_n88_), .O(new_n89_));
  ...
  oai21  g051(.a(new_n94_), .b(new_n75_), .c(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n62_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n57_), .O(new_n99_));
  ...
  nand2  g060(.a(new_n79_), .b(x24), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n55_), .c(new_n104_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n103_), .c(new_n101_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n99_), .O(z11));
  nand3  g064(.a(x21), .b(x20), .c(x19), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand2  g066(.a(new_n104_), .b(x21), .O(new_n111_));
  oai22  g067(.a(new_n111_), .b(new_n93_), .c(new_n110_), .d(new_n104_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n64_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n57_), .O(new_n115_));
  nand4  g071(.a(new_n106_), .b(new_n101_), .c(x14), .d(new_n47_), .O(new_n116_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n93_), .c(x23), .O(new_n120_));
  nand4  g076(.a(new_n94_), .b(new_n55_), .c(x22), .d(x21), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n66_), .c(new_n57_), .O(z13));
  nand2  g080(.a(new_n79_), .b(x16), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n110_), .c(x23), .d(x22), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(x24), .c(new_n47_), .d(x09), .O(new_n127_));
  oai22  g083(.a(new_n127_), .b(x08), .c(new_n58_), .d(new_n68_), .O(z14));
  inv1   g084(.a(x24), .O(new_n129_));
  nand2  g085(.a(x26), .b(x17), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n94_), .c(x22), .d(x21), .O(new_n131_));
  nand3  g087(.a(new_n78_), .b(x23), .c(x22), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n109_), .O(new_n133_));
  aoi21  g089(.a(new_n131_), .b(x25), .c(new_n133_), .O(new_n134_));
  nand2  g090(.a(x25), .b(new_n55_), .O(new_n135_));
  oai21  g091(.a(new_n134_), .b(new_n129_), .c(new_n135_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n70_), .O(z15));
  nand3  g094(.a(new_n101_), .b(x19), .c(new_n47_), .O(new_n139_));
  nand4  g095(.a(new_n76_), .b(new_n45_), .c(x25), .d(x22), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(x24), .O(new_n141_));
