...
module FAU ( 
  ...
  nand2  g21(.a(new_n66_), .b(new_n57_), .O(z08));
  ...
  nand3  g32(.a(new_n77_), .b(new_n76_), .c(new_n57_), .O(z10));
  ...
  nand2  g39(.a(x08), .b(x02), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n84_), .c(new_n49_), .O(z11));
  ...
  nand3  g46(.a(new_n91_), .b(new_n58_), .c(new_n57_), .O(z12));
  ...
  nand3  g55(.a(new_n70_), .b(x25), .c(new_n74_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n57_), .O(z15));
  nand3  g57(.a(new_n70_), .b(x26), .c(new_n74_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n66_), .c(new_n49_), .O(z16));
  zero   g59(.O(z00));
endmodule
