...
module FAU ( 
  ...
  aoi21  g39(.a(new_n84_), .b(new_n56_), .c(new_n49_), .O(z11));
  nand3  g40(.a(x21), .b(x20), .c(x19), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(x22), .O(new_n87_));
  nand4  g42(.a(new_n47_), .b(x21), .c(x20), .d(x19), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n90_));
  aoi21  g45(.a(x08), .b(x03), .c(new_n49_), .O(new_n91_));
  ...
  nand3  g53(.a(new_n98_), .b(new_n62_), .c(new_n55_), .O(z14));
  ...
  nand3  g57(.a(new_n102_), .b(new_n66_), .c(new_n55_), .O(z16));
  zero   g58(.O(z00));
endmodule
