...
module FAU ( 
  ...
  nand2  g017(.a(new_n61_), .b(new_n57_), .O(z04));
  ...
  nor2   g046(.a(new_n72_), .b(new_n90_), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(x21), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand2  g049(.a(new_n76_), .b(x24), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n93_), .c(new_n89_), .d(new_n87_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n85_), .O(z10));
  ...
  nand2  g063(.a(new_n91_), .b(x20), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n107_), .c(new_n95_), .d(new_n87_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n105_), .O(z11));
  nand3  g067(.a(x21), .b(x20), .c(x19), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x22), .O(new_n113_));
  nand4  g069(.a(new_n90_), .b(x21), .c(x20), .d(x19), .O(new_n114_));
  ...
  nand3  g074(.a(new_n87_), .b(x14), .c(new_n47_), .O(new_n119_));
  nand2  g075(.a(new_n95_), .b(new_n91_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n119_), .c(new_n118_), .O(z12));
  nand2  g077(.a(new_n55_), .b(x04), .O(new_n122_));
  nand2  g078(.a(x20), .b(x19), .O(new_n123_));
  nand3  g079(.a(new_n72_), .b(x22), .c(x21), .O(new_n124_));
  nand4  g080(.a(x26), .b(x25), .c(x23), .d(x15), .O(new_n125_));
  oai21  g081(.a(new_n124_), .b(new_n123_), .c(new_n125_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x24), .O(new_n127_));
  oai21  g083(.a(new_n112_), .b(new_n90_), .c(x23), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n122_), .O(z13));
  nand2  g087(.a(new_n55_), .b(x05), .O(new_n132_));
  ...
  inv1   g091(.a(new_n112_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n73_), .c(x23), .d(x22), .O(new_n137_));
  ...
  nand3  g096(.a(new_n87_), .b(x25), .c(new_n47_), .O(new_n141_));
  ...
  oai21  g101(.a(new_n145_), .b(new_n112_), .c(x25), .O(new_n146_));
  nand4  g102(.a(new_n136_), .b(new_n91_), .c(new_n75_), .d(x24), .O(new_n147_));
  ...
  nand3  g106(.a(new_n150_), .b(new_n149_), .c(new_n143_), .O(z15));
  nand3  g107(.a(new_n87_), .b(x26), .c(new_n47_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x24), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n72_), .O(new_n154_));
  inv1   g110(.a(x18), .O(new_n155_));
  inv1   g111(.a(new_n123_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand3  g113(.a(new_n70_), .b(x25), .c(x24), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(x26), .O(new_n159_));
  nor2   g115(.a(x26), .b(new_n75_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n156_), .c(new_n74_), .d(new_n70_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n154_), .c(new_n68_), .O(z16));
endmodule
