...
module FAU ( 
  ...
  oai21  g021(.a(new_n46_), .b(new_n65_), .c(new_n56_), .O(z04));
  and2   g022(.a(new_n62_), .b(x04), .O(z05));
  nand2  g023(.a(x08), .b(x05), .O(new_n68_));
  nand2  g024(.a(new_n68_), .b(new_n56_), .O(z06));
  inv1   g025(.a(x06), .O(new_n70_));
  oai21  g026(.a(new_n46_), .b(new_n70_), .c(new_n56_), .O(z07));
  nand2  g027(.a(new_n62_), .b(x07), .O(new_n72_));
  ...
  nand2  g033(.a(new_n77_), .b(new_n57_), .O(new_n78_));
  nand2  g034(.a(new_n78_), .b(new_n56_), .O(new_n79_));
  ...
  nand3  g046(.a(x26), .b(x24), .c(x23), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n90_), .c(x20), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(x19), .O(new_n93_));
  nand2  g049(.a(x20), .b(new_n74_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n59_), .c(new_n56_), .O(z10));
  nand2  g053(.a(x22), .b(x13), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n91_), .c(x20), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n74_), .c(x25), .O(new_n100_));
  nand3  g056(.a(new_n54_), .b(x20), .c(x19), .O(new_n101_));
  oai21  g057(.a(new_n100_), .b(new_n54_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n103_));
  oai21  g059(.a(new_n63_), .b(new_n61_), .c(new_n103_), .O(z11));
  nand4  g060(.a(x26), .b(x24), .c(x23), .d(x14), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x20), .c(x19), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(x25), .c(new_n54_), .O(new_n107_));
  nand2  g063(.a(x20), .b(x19), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(x25), .c(new_n82_), .d(x21), .O(new_n110_));
  oai21  g066(.a(new_n107_), .b(new_n82_), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n112_));
  oai21  g068(.a(new_n63_), .b(new_n65_), .c(new_n112_), .O(z12));
  nand3  g069(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n114_));
  nand3  g070(.a(new_n109_), .b(new_n83_), .c(x22), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(x25), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x21), .O(new_n117_));
  nand3  g073(.a(x26), .b(x24), .c(x15), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x22), .c(x21), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n109_), .c(new_n83_), .O(new_n121_));
  ...
  nand2  g080(.a(new_n62_), .b(x05), .O(new_n125_));
  inv1   g081(.a(x24), .O(new_n126_));
  nand2  g082(.a(x26), .b(x16), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n109_), .c(x23), .d(x22), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(x25), .c(new_n54_), .O(new_n129_));
  nand3  g085(.a(x21), .b(x20), .c(x19), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n84_), .c(x25), .d(new_n126_), .O(new_n132_));
  oai21  g088(.a(new_n129_), .b(new_n126_), .c(new_n132_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n125_), .O(z14));
  aoi21  g091(.a(x26), .b(x17), .c(new_n126_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n131_), .c(new_n84_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(x25), .c(new_n47_), .d(x09), .O(new_n138_));
  oai22  g094(.a(new_n138_), .b(x08), .c(new_n63_), .d(new_n70_), .O(z15));
  nor2   g095(.a(new_n108_), .b(x18), .O(new_n140_));
  ...
  nand4  g099(.a(new_n45_), .b(x24), .c(x23), .d(x22), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n130_), .O(new_n145_));
