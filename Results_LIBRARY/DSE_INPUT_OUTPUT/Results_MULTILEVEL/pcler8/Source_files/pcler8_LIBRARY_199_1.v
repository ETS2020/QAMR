...
module FAU ( 
  ...
  aoi21  g061(.a(x08), .b(x03), .c(new_n54_), .O(new_n106_));
  ...
  oai21  g083(.a(x10), .b(x06), .c(x08), .O(new_n128_));
  ...
  nand3  g093(.a(new_n137_), .b(new_n128_), .c(new_n55_), .O(z15));
  ...
  nand3  g103(.a(new_n147_), .b(new_n71_), .c(new_n55_), .O(z16));
endmodule
