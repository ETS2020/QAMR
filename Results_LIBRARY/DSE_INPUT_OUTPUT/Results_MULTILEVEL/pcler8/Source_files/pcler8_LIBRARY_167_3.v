...
module FAU ( 
  ...
  nand3  g28(.a(new_n72_), .b(new_n67_), .c(new_n52_), .O(z09));
  nand2  g29(.a(new_n49_), .b(x01), .O(new_n74_));
  nand3  g30(.a(new_n46_), .b(x20), .c(new_n69_), .O(new_n75_));
  oai21  g31(.a(x20), .b(new_n69_), .c(new_n75_), .O(new_n76_));
  nand4  g32(.a(new_n76_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(new_n74_), .O(z10));
  nand2  g34(.a(new_n49_), .b(x02), .O(new_n79_));
  xor2a  g35(.a(x21), .b(x19), .O(new_n80_));
  nand3  g36(.a(new_n80_), .b(new_n46_), .c(x20), .O(new_n81_));
  nand2  g37(.a(x21), .b(new_n45_), .O(new_n82_));
  nand2  g38(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand4  g39(.a(new_n83_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n79_), .O(z11));
  nand2  g41(.a(new_n49_), .b(x03), .O(new_n86_));
  aoi21  g42(.a(x21), .b(x19), .c(x23), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n45_), .c(x22), .O(new_n88_));
  nor2   g44(.a(x23), .b(x22), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(x21), .c(x20), .d(x19), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand4  g47(.a(new_n91_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n86_), .O(z12));
  nand2  g49(.a(x20), .b(x19), .O(new_n94_));
  nand3  g50(.a(new_n46_), .b(x22), .c(x21), .O(new_n95_));
  oai22  g51(.a(new_n95_), .b(new_n94_), .c(new_n46_), .d(x20), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(new_n59_), .O(z13));
  nand2  g54(.a(x08), .b(x05), .O(new_n99_));
  nand3  g55(.a(new_n71_), .b(x24), .c(new_n68_), .O(new_n100_));
  nand3  g56(.a(new_n100_), .b(new_n99_), .c(new_n52_), .O(z14));
  nand2  g57(.a(x08), .b(x06), .O(new_n102_));
  nand3  g58(.a(new_n71_), .b(x25), .c(new_n68_), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n102_), .c(z00), .O(z15));
  nand3  g60(.a(new_n71_), .b(x26), .c(new_n68_), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n65_), .c(z00), .O(z16));
endmodule
