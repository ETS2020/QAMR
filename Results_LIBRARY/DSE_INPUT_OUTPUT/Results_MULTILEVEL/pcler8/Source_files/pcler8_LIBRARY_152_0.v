...
module FAU ( 
  ...
  nor2   g020(.a(new_n64_), .b(new_n61_), .O(z02));
  and2   g021(.a(new_n63_), .b(x02), .O(z03));
  inv1   g022(.a(x03), .O(new_n67_));
  nor2   g023(.a(new_n64_), .b(new_n67_), .O(z04));
  nand2  g024(.a(x08), .b(x04), .O(new_n69_));
  nand2  g025(.a(new_n69_), .b(new_n58_), .O(z05));
  inv1   g026(.a(x05), .O(new_n71_));
  nor2   g027(.a(new_n64_), .b(new_n71_), .O(z06));
  inv1   g028(.a(x06), .O(new_n73_));
  nor2   g029(.a(new_n64_), .b(new_n73_), .O(z07));
  inv1   g030(.a(x07), .O(new_n75_));
  nor2   g031(.a(new_n64_), .b(new_n75_), .O(z08));
  ...
  aoi21  g037(.a(new_n81_), .b(new_n62_), .c(new_n77_), .O(new_n82_));
  oai21  g038(.a(new_n82_), .b(x10), .c(new_n59_), .O(z09));
  inv1   g039(.a(x10), .O(new_n84_));
  nand3  g040(.a(x22), .b(x21), .c(x12), .O(new_n85_));
  oai21  g041(.a(new_n85_), .b(new_n80_), .c(x20), .O(new_n86_));
  nor2   g042(.a(new_n47_), .b(x19), .O(new_n87_));
  ...
  oai21  g046(.a(new_n62_), .b(new_n61_), .c(new_n90_), .O(z10));
  ...
  aoi21  g053(.a(new_n97_), .b(new_n62_), .c(new_n77_), .O(new_n98_));
  nand2  g054(.a(x08), .b(x02), .O(new_n99_));
  oai21  g055(.a(new_n98_), .b(x10), .c(new_n99_), .O(z11));
  nor2   g056(.a(new_n47_), .b(new_n45_), .O(new_n101_));
  ...
  nand3  g061(.a(new_n101_), .b(new_n50_), .c(x21), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n84_), .c(x09), .d(new_n62_), .O(new_n108_));
  oai21  g064(.a(new_n64_), .b(new_n67_), .c(new_n108_), .O(z12));
  nand2  g065(.a(new_n63_), .b(x04), .O(new_n110_));
  ...
  nand4  g075(.a(new_n119_), .b(new_n84_), .c(x09), .d(new_n62_), .O(new_n120_));
  ...
  nand4  g084(.a(new_n128_), .b(new_n84_), .c(x09), .d(new_n62_), .O(new_n129_));
  oai21  g085(.a(new_n64_), .b(new_n71_), .c(new_n129_), .O(z14));
  ...
  nand4  g090(.a(new_n126_), .b(new_n52_), .c(new_n134_), .d(x24), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n84_), .c(x09), .d(new_n62_), .O(new_n137_));
  oai21  g093(.a(new_n64_), .b(new_n73_), .c(new_n137_), .O(z15));
  nor2   g094(.a(new_n45_), .b(x18), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n49_), .O(new_n140_));
  nand3  g096(.a(new_n52_), .b(x25), .c(x24), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n140_), .c(x26), .O(new_n142_));
  nor2   g098(.a(new_n125_), .b(new_n51_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n134_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n101_), .c(new_n143_), .d(new_n78_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n84_), .c(x09), .d(new_n62_), .O(new_n147_));
  oai21  g103(.a(new_n64_), .b(new_n75_), .c(new_n147_), .O(z16));
endmodule
