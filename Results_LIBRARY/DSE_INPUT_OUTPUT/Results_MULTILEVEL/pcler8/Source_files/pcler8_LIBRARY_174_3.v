...
module FAU ( 
  ...
  oai21  g029(.a(new_n59_), .b(new_n73_), .c(new_n64_), .O(z06));
  inv1   g030(.a(x06), .O(new_n75_));
  oai21  g031(.a(new_n59_), .b(new_n75_), .c(new_n64_), .O(z07));
  ...
  oai21  g054(.a(new_n92_), .b(new_n67_), .c(new_n98_), .O(z11));
  nor2   g055(.a(new_n49_), .b(new_n47_), .O(new_n100_));
  ...
  nand3  g060(.a(new_n100_), .b(new_n52_), .c(x21), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n107_));
  oai21  g063(.a(new_n92_), .b(new_n69_), .c(new_n107_), .O(z12));
  ...
  nand4  g082(.a(new_n126_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n127_));
  oai21  g083(.a(new_n92_), .b(new_n73_), .c(new_n127_), .O(z14));
  ...
  oai21  g091(.a(new_n92_), .b(new_n75_), .c(new_n135_), .O(z15));
  ...
  nand4  g098(.a(new_n142_), .b(new_n100_), .c(new_n141_), .d(new_n79_), .O(new_n143_));
