...
module FAU ( 
  ...
  nand3  g081(.a(new_n125_), .b(new_n67_), .c(new_n56_), .O(z14));
  ...
  nand3  g091(.a(new_n98_), .b(x09), .c(new_n46_), .O(new_n136_));
  nand4  g092(.a(new_n75_), .b(x25), .c(x24), .d(x23), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n136_), .c(new_n47_), .O(new_n138_));
  ...
  nand3  g097(.a(new_n127_), .b(x25), .c(x24), .O(new_n142_));
