...
module FAU ( 
  ...
  nor2   g22(.a(new_n50_), .b(new_n52_), .O(z10));
  oai21  g23(.a(new_n53_), .b(new_n55_), .c(new_n46_), .O(z11));
  oai21  g24(.a(new_n53_), .b(new_n61_), .c(new_n46_), .O(z14));
  nor2   g25(.a(new_n50_), .b(new_n48_), .O(z09));
  nor2   g26(.a(new_n50_), .b(new_n57_), .O(z12));
