...
module FAU ( 
  ...
  nand2  g37(.a(new_n53_), .b(x03), .O(new_n83_));
  nand3  g38(.a(x21), .b(x20), .c(x19), .O(new_n84_));
  nand3  g39(.a(new_n84_), .b(new_n47_), .c(x22), .O(new_n85_));
  nand2  g40(.a(x20), .b(x19), .O(new_n86_));
  nand2  g41(.a(new_n46_), .b(x21), .O(new_n87_));
  oai21  g42(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n83_), .O(z12));
  nand3  g45(.a(new_n47_), .b(x22), .c(x21), .O(new_n91_));
  oai22  g46(.a(new_n91_), .b(new_n86_), .c(new_n47_), .d(x22), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n60_), .O(z13));
  nand2  g49(.a(x08), .b(x05), .O(new_n95_));
  nand3  g50(.a(new_n71_), .b(x24), .c(new_n68_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n95_), .c(new_n48_), .O(z14));
  nand2  g52(.a(x08), .b(x06), .O(new_n98_));
  nand3  g53(.a(new_n71_), .b(x25), .c(new_n68_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n49_), .O(z15));
  nand2  g55(.a(x08), .b(x07), .O(new_n101_));
  nand3  g56(.a(new_n71_), .b(x26), .c(new_n68_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n101_), .c(new_n48_), .O(z16));
  zero   g58(.O(z00));
endmodule
