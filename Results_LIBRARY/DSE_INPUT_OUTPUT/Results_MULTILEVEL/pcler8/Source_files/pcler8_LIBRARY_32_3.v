...
module FAU ( 
  ...
  oai21  g045(.a(new_n82_), .b(new_n59_), .c(new_n89_), .O(z10));
  ...
  nand3  g058(.a(new_n102_), .b(x26), .c(x24), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n100_), .c(new_n47_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(x25), .O(new_n105_));
  nand3  g061(.a(x21), .b(x20), .c(x19), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n75_), .b(x21), .c(x20), .d(x19), .O(new_n108_));
  oai21  g064(.a(new_n107_), .b(new_n75_), .c(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n105_), .c(new_n64_), .O(z12));
  nand2  g067(.a(new_n101_), .b(new_n47_), .O(new_n112_));
  ...
  nand3  g071(.a(new_n106_), .b(x23), .c(new_n47_), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n115_), .c(new_n75_), .O(new_n117_));
  nand3  g073(.a(x23), .b(new_n75_), .c(new_n47_), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n117_), .c(x09), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(x08), .c(new_n66_), .O(z13));
  nand3  g077(.a(x26), .b(x25), .c(x16), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x23), .c(x22), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n106_), .c(x24), .O(new_n124_));
  nor2   g080(.a(x24), .b(new_n101_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n107_), .c(x22), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n128_));
  oai21  g084(.a(new_n82_), .b(new_n68_), .c(new_n128_), .O(z14));
  nand2  g085(.a(x26), .b(x17), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n102_), .c(x24), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n106_), .c(x25), .O(new_n132_));
  nand4  g088(.a(new_n107_), .b(new_n102_), .c(new_n54_), .d(x24), .O(new_n133_));
  ...
  nand4  g092(.a(x20), .b(x19), .c(x09), .d(new_n46_), .O(new_n137_));
  nand4  g093(.a(new_n76_), .b(new_n45_), .c(x24), .d(x23), .O(new_n138_));
  ...
  nand3  g098(.a(new_n102_), .b(x25), .c(x24), .O(new_n143_));
  ...
  nand3  g103(.a(new_n147_), .b(new_n146_), .c(new_n140_), .O(z16));
endmodule
