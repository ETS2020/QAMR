...
module FAU ( 
  ...
  aoi21  g034(.a(new_n78_), .b(new_n46_), .c(new_n74_), .O(new_n79_));
  ...
  oai21  g050(.a(new_n94_), .b(new_n74_), .c(new_n47_), .O(new_n95_));
  ...
  oai21  g091(.a(new_n60_), .b(new_n70_), .c(new_n135_), .O(z15));
  ...
  nand4  g098(.a(new_n142_), .b(new_n101_), .c(new_n141_), .d(new_n75_), .O(new_n143_));
