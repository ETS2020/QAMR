...
module FAU ( 
  ...
  oai21  g021(.a(new_n47_), .b(new_n64_), .c(new_n65_), .O(z04));
  ...
  oai21  g029(.a(new_n47_), .b(new_n73_), .c(new_n65_), .O(z08));
  ...
  aoi21  g047(.a(new_n91_), .b(new_n47_), .c(x17), .O(new_n92_));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n97_), .c(x17), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n100_));
  oai21  g056(.a(new_n60_), .b(new_n62_), .c(new_n100_), .O(z11));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n105_), .c(x17), .O(new_n108_));
  ...
  aoi21  g075(.a(new_n119_), .b(new_n118_), .c(x17), .O(new_n120_));
  ...
  aoi21  g085(.a(new_n129_), .b(new_n47_), .c(x17), .O(new_n130_));
  oai22  g086(.a(new_n130_), .b(x10), .c(new_n47_), .d(new_n69_), .O(z14));
  inv1   g087(.a(x23), .O(new_n132_));
  nor2   g088(.a(new_n126_), .b(new_n132_), .O(new_n133_));
  nand3  g089(.a(new_n127_), .b(new_n133_), .c(x22), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x25), .O(new_n135_));
  inv1   g091(.a(x25), .O(new_n136_));
  nor2   g092(.a(new_n132_), .b(new_n46_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n136_), .c(x24), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n115_), .c(new_n135_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n49_), .c(new_n48_), .d(x09), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(x08), .c(new_n71_), .O(z15));
  ...
  nand4  g102(.a(new_n146_), .b(new_n106_), .c(new_n133_), .d(new_n76_), .O(new_n147_));
