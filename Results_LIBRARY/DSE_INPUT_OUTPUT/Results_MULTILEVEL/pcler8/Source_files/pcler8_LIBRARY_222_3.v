...
module FAU ( 
  ...
  nand2  g029(.a(new_n73_), .b(new_n64_), .O(z06));
  ...
  nand2  g054(.a(new_n98_), .b(new_n67_), .O(z11));
  nand2  g055(.a(new_n61_), .b(x03), .O(new_n100_));
  ...
  nand4  g074(.a(new_n118_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n119_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n123_), .c(x08), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(x10), .c(x09), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n73_), .O(z14));
  ...
  nor2   g098(.a(new_n124_), .b(new_n53_), .O(new_n143_));
