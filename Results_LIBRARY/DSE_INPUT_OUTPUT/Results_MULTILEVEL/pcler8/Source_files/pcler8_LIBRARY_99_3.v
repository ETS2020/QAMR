...
module FAU ( 
  ...
  nand2  g000(.a(x10), .b(x03), .O(new_n45_));
  ...
  oai21  g015(.a(new_n46_), .b(new_n59_), .c(new_n45_), .O(z01));
  inv1   g016(.a(x01), .O(new_n61_));
  oai21  g017(.a(new_n46_), .b(new_n61_), .c(new_n45_), .O(z02));
  ...
  nor2   g023(.a(new_n67_), .b(x10), .O(z04));
  ...
  inv1   g032(.a(new_n64_), .O(new_n77_));
  ...
  oai21  g039(.a(new_n77_), .b(new_n59_), .c(new_n83_), .O(z09));
  ...
  oai21  g043(.a(new_n49_), .b(x19), .c(new_n87_), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n89_));
  oai21  g045(.a(new_n77_), .b(new_n61_), .c(new_n89_), .O(z10));
  nand3  g046(.a(x23), .b(x22), .c(x13), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n55_), .c(x21), .O(new_n92_));
  nor2   g048(.a(new_n78_), .b(x20), .O(new_n93_));
  aoi21  g049(.a(new_n92_), .b(x20), .c(new_n93_), .O(new_n94_));
  nand2  g050(.a(x21), .b(new_n48_), .O(new_n95_));
  oai21  g051(.a(new_n94_), .b(new_n48_), .c(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n97_));
  aoi21  g053(.a(x08), .b(x02), .c(new_n63_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n97_), .O(z11));
  inv1   g055(.a(new_n50_), .O(new_n100_));
  ...
  nand3  g059(.a(new_n50_), .b(new_n52_), .c(x21), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x09), .c(new_n46_), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n67_), .c(x10), .O(z12));
  nand2  g063(.a(x10), .b(x03), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x08), .c(x04), .O(new_n109_));
  ...
  nand2  g072(.a(x23), .b(new_n52_), .O(new_n117_));
  ...
  nand2  g084(.a(new_n128_), .b(new_n71_), .O(z14));
  ...
  nor2   g097(.a(new_n124_), .b(new_n53_), .O(new_n142_));
  nor2   g098(.a(x26), .b(new_n133_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n142_), .c(new_n79_), .d(new_n50_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n146_));
  aoi21  g102(.a(x08), .b(x07), .c(new_n63_), .O(new_n147_));
