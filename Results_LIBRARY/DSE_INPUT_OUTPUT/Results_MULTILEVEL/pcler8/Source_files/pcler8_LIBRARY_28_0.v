// Benchmark "FAU" written by ABC on Fri Aug 14 02:19:17 2020
...
module FAU ( 
  ...
  aoi21  g018(.a(x08), .b(x03), .c(new_n55_), .O(new_n63_));
  ...
  nand2  g025(.a(new_n69_), .b(new_n59_), .O(z07));
  ...
  nand2  g044(.a(new_n88_), .b(new_n60_), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(new_n59_), .O(new_n90_));
  nand2  g046(.a(x19), .b(x12), .O(new_n91_));
  nor2   g047(.a(new_n91_), .b(x10), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n84_), .c(new_n75_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n90_), .O(z10));
  xnor2a g050(.a(x21), .b(x20), .O(new_n95_));
  nand2  g051(.a(x21), .b(new_n73_), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(new_n73_), .c(new_n96_), .O(new_n97_));
  ...
  nor3   g060(.a(new_n83_), .b(new_n82_), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g065(.a(new_n108_), .b(x22), .c(new_n109_), .O(new_n110_));
  inv1   g066(.a(new_n83_), .O(new_n111_));
  nand2  g067(.a(x20), .b(x19), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nor2   g069(.a(x22), .b(new_n81_), .O(new_n114_));
  and2   g070(.a(x22), .b(x14), .O(new_n115_));
  aoi22  g071(.a(new_n115_), .b(new_n111_), .c(new_n114_), .d(new_n113_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n108_), .c(new_n110_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n63_), .O(z12));
  ...
  nand4  g079(.a(new_n113_), .b(new_n108_), .c(x22), .d(x21), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n126_));
  oai21  g082(.a(new_n57_), .b(new_n65_), .c(new_n126_), .O(z13));
  inv1   g083(.a(x22), .O(new_n128_));
  nand2  g084(.a(x24), .b(new_n128_), .O(new_n129_));
  inv1   g085(.a(x24), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x22), .c(x21), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n112_), .c(new_n129_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(x23), .O(new_n133_));
  nand3  g089(.a(x26), .b(x25), .c(x16), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n113_), .c(x23), .d(x21), .O(new_n135_));
  ...
  nand2  g094(.a(new_n138_), .b(new_n67_), .O(z14));
  nand2  g095(.a(new_n56_), .b(x06), .O(new_n140_));
  nand2  g096(.a(x25), .b(new_n128_), .O(new_n141_));
  inv1   g097(.a(x25), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(x24), .c(x22), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n109_), .c(new_n141_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x23), .O(new_n145_));
  nand2  g101(.a(x26), .b(x17), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n120_), .c(x24), .d(x23), .O(new_n147_));
  ...
  nand2  g106(.a(new_n150_), .b(new_n140_), .O(z15));
  nand3  g107(.a(new_n75_), .b(x26), .c(new_n47_), .O(new_n152_));
  ...
  nand4  g112(.a(x25), .b(x24), .c(x23), .d(x21), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(x26), .O(new_n158_));
  nand3  g114(.a(new_n113_), .b(x22), .c(x21), .O(new_n159_));
