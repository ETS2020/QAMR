...
module FAU ( 
  ...
  nand2  g020(.a(new_n64_), .b(new_n62_), .O(z02));
  nand2  g021(.a(x08), .b(x02), .O(new_n66_));
  nand2  g022(.a(new_n66_), .b(new_n62_), .O(z03));
  inv1   g023(.a(x03), .O(new_n68_));
  oai21  g024(.a(new_n60_), .b(new_n68_), .c(new_n62_), .O(z04));
  nand2  g025(.a(x08), .b(x04), .O(new_n70_));
  nand2  g026(.a(new_n70_), .b(new_n62_), .O(z05));
  nor2   g027(.a(new_n61_), .b(new_n60_), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(x05), .O(new_n73_));
  inv1   g029(.a(new_n73_), .O(z06));
  nand2  g030(.a(new_n72_), .b(x06), .O(new_n75_));
  inv1   g031(.a(new_n75_), .O(z07));
  nand2  g032(.a(new_n72_), .b(x07), .O(new_n77_));
  inv1   g033(.a(new_n77_), .O(z08));
  inv1   g034(.a(new_n72_), .O(new_n79_));
  ...
  nand2  g047(.a(new_n91_), .b(new_n64_), .O(z10));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n60_), .c(x10), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n45_), .c(new_n66_), .O(z11));
  ...
  nand4  g063(.a(new_n107_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n108_));
  oai21  g064(.a(new_n79_), .b(new_n68_), .c(new_n108_), .O(z12));
  nand4  g065(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x22), .c(x21), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n102_), .c(x23), .O(new_n112_));
  nand4  g068(.a(new_n101_), .b(new_n53_), .c(x22), .d(x21), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n112_), .c(x08), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(x10), .c(x09), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n70_), .O(z13));
  ...
  nand4  g080(.a(new_n124_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n73_), .O(z14));
  ...
  nand4  g086(.a(new_n122_), .b(new_n54_), .c(new_n130_), .d(x24), .O(new_n131_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n101_), .c(new_n140_), .d(new_n80_), .O(new_n142_));
