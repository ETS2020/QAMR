...
module FAU ( 
  ...
  nor2   g055(.a(new_n82_), .b(new_n89_), .O(new_n100_));
  ...
  nand3  g063(.a(new_n107_), .b(new_n63_), .c(new_n56_), .O(z12));
  ...
  nand3  g083(.a(new_n127_), .b(new_n67_), .c(new_n56_), .O(z14));
  ...
  nand4  g100(.a(new_n144_), .b(new_n100_), .c(new_n143_), .d(new_n75_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n147_));
  aoi21  g103(.a(x08), .b(x07), .c(new_n55_), .O(new_n148_));
