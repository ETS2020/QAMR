...
module FAU ( 
  ...
  nand2  g018(.a(new_n56_), .b(x04), .O(new_n63_));
  inv1   g019(.a(new_n63_), .O(z05));
  nand2  g020(.a(x08), .b(x05), .O(new_n65_));
  nand2  g021(.a(new_n65_), .b(new_n58_), .O(z06));
  aoi21  g022(.a(x23), .b(new_n46_), .c(new_n54_), .O(z07));
  inv1   g023(.a(x07), .O(new_n68_));
  nor3   g024(.a(new_n55_), .b(new_n46_), .c(new_n68_), .O(z08));
  ...
  oai21  g032(.a(new_n76_), .b(new_n70_), .c(x19), .O(new_n77_));
  ...
  nand2  g038(.a(new_n82_), .b(new_n59_), .O(new_n83_));
  ...
  nor2   g044(.a(new_n71_), .b(new_n88_), .O(new_n89_));
  nand3  g045(.a(x26), .b(x25), .c(x24), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n89_), .c(new_n87_), .d(x21), .O(new_n92_));
  ...
  aoi21  g056(.a(x08), .b(x02), .c(new_n55_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n100_), .O(z11));
  nand2  g058(.a(x23), .b(x14), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n90_), .c(x21), .O(new_n104_));
  ...
  aoi21  g065(.a(x08), .b(x03), .c(new_n55_), .O(new_n110_));
  ...
  nor2   g072(.a(x23), .b(new_n88_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n106_), .c(x21), .d(new_n54_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n63_), .O(z13));
  nand2  g077(.a(new_n56_), .b(x05), .O(new_n122_));
  nand3  g078(.a(x26), .b(x25), .c(x16), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n106_), .c(x22), .d(x21), .O(new_n124_));
  nand3  g080(.a(new_n72_), .b(x22), .c(x21), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n97_), .O(new_n126_));
  aoi21  g082(.a(new_n124_), .b(x24), .c(new_n126_), .O(new_n127_));
  nand3  g083(.a(x24), .b(new_n71_), .c(new_n54_), .O(new_n128_));
  oai21  g084(.a(new_n127_), .b(new_n71_), .c(new_n128_), .O(new_n129_));
  ...
  nand4  g088(.a(new_n132_), .b(new_n113_), .c(x24), .d(x22), .O(new_n133_));
  nand3  g089(.a(new_n74_), .b(x24), .c(x22), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n112_), .O(new_n135_));
  aoi21  g091(.a(new_n133_), .b(x25), .c(new_n135_), .O(new_n136_));
  nand3  g092(.a(x25), .b(new_n71_), .c(new_n54_), .O(new_n137_));
  oai21  g093(.a(new_n136_), .b(new_n71_), .c(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n139_));
  nand3  g095(.a(x23), .b(x08), .c(x06), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n139_), .O(z15));
  oai21  g097(.a(new_n46_), .b(new_n68_), .c(x23), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x06), .O(new_n143_));
  inv1   g099(.a(x18), .O(new_n144_));
  nand4  g100(.a(x21), .b(x20), .c(x19), .d(new_n144_), .O(new_n145_));
  nand3  g101(.a(new_n89_), .b(x25), .c(x24), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n145_), .c(x26), .O(new_n147_));
  nand3  g103(.a(new_n106_), .b(x22), .c(x21), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n73_), .c(new_n45_), .d(x25), .O(new_n150_));
