...
module FAU ( 
  ...
  nor2   g30(.a(new_n65_), .b(new_n74_), .O(z08));
  ...
  oai21  g51(.a(new_n65_), .b(new_n64_), .c(new_n95_), .O(z11));
  ...
  nand3  g79(.a(new_n123_), .b(new_n71_), .c(new_n47_), .O(z14));
  ...
  aoi21  g87(.a(x08), .b(x06), .c(new_n46_), .O(new_n132_));
  ...
  oai21  g98(.a(new_n65_), .b(new_n74_), .c(new_n142_), .O(z16));
endmodule
