...
module FAU ( 
  ...
  nor2   g031(.a(new_n51_), .b(new_n49_), .O(new_n76_));
  ...
  oai21  g040(.a(x20), .b(new_n48_), .c(new_n84_), .O(new_n85_));
  ...
  nand3  g044(.a(new_n88_), .b(x21), .c(new_n45_), .O(new_n89_));
  nor2   g045(.a(new_n52_), .b(new_n51_), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(x13), .O(new_n91_));
  ...
  nand3  g050(.a(new_n94_), .b(x09), .c(new_n47_), .O(new_n95_));
  aoi21  g051(.a(x08), .b(x02), .c(new_n57_), .O(new_n96_));
  ...
  nand3  g058(.a(new_n98_), .b(new_n51_), .c(x21), .O(new_n103_));
  ...
  nand2  g069(.a(x23), .b(new_n51_), .O(new_n114_));
  ...
  nand3  g075(.a(new_n76_), .b(new_n119_), .c(x23), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(new_n45_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x20), .O(new_n122_));
  ...
  nand3  g087(.a(new_n131_), .b(new_n90_), .c(x24), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n110_), .c(x25), .O(new_n133_));
  inv1   g089(.a(x25), .O(new_n134_));
  nand4  g090(.a(new_n123_), .b(new_n90_), .c(new_n134_), .d(x24), .O(new_n135_));
