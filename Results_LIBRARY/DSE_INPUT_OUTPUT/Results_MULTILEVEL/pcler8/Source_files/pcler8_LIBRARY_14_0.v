...
module FAU ( 
  ...
  oai21  g24(.a(new_n68_), .b(new_n67_), .c(new_n60_), .O(z04));
  ...
  oai21  g30(.a(new_n68_), .b(new_n74_), .c(new_n60_), .O(z07));
  ...
  nand4  g37(.a(new_n81_), .b(new_n59_), .c(x09), .d(new_n68_), .O(new_n82_));
  ...
  oai21  g45(.a(new_n68_), .b(new_n63_), .c(new_n89_), .O(z10));
  ...
  aoi21  g52(.a(new_n96_), .b(new_n68_), .c(new_n58_), .O(new_n97_));
  ...
  nand4  g61(.a(new_n105_), .b(new_n59_), .c(x09), .d(new_n68_), .O(new_n106_));
  oai21  g62(.a(new_n61_), .b(new_n67_), .c(new_n106_), .O(z12));
  ...
  oai21  g78(.a(new_n122_), .b(new_n58_), .c(new_n59_), .O(new_n123_));
  oai21  g79(.a(new_n68_), .b(new_n72_), .c(new_n123_), .O(z14));
  ...
  nand4  g86(.a(new_n130_), .b(new_n59_), .c(x09), .d(new_n68_), .O(new_n131_));
  oai21  g87(.a(new_n61_), .b(new_n74_), .c(new_n131_), .O(z15));
  ...
  nand4  g96(.a(new_n140_), .b(new_n59_), .c(x09), .d(new_n68_), .O(new_n141_));
  oai21  g97(.a(new_n61_), .b(new_n76_), .c(new_n141_), .O(z16));
endmodule
