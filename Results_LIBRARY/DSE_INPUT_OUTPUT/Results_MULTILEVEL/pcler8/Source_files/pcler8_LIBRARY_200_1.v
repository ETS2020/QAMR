...
module FAU ( 
  ...
  nor3   g21(.a(new_n59_), .b(new_n57_), .c(new_n65_), .O(z04));
  ...
  nor2   g28(.a(new_n59_), .b(new_n57_), .O(new_n73_));
  and2   g29(.a(new_n73_), .b(x07), .O(z08));
  inv1   g30(.a(x10), .O(new_n75_));
  inv1   g31(.a(x21), .O(new_n76_));
  nor2   g32(.a(new_n49_), .b(new_n76_), .O(new_n77_));
  ...
  aoi21  g36(.a(new_n80_), .b(new_n75_), .c(new_n56_), .O(new_n81_));
  oai22  g37(.a(new_n81_), .b(new_n45_), .c(new_n57_), .d(new_n56_), .O(z09));
  ...
  aoi21  g44(.a(new_n88_), .b(new_n57_), .c(new_n56_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n45_), .c(new_n61_), .O(z10));
  nand3  g46(.a(x23), .b(x22), .c(x13), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n52_), .c(x21), .O(new_n92_));
  nor2   g48(.a(new_n76_), .b(x19), .O(new_n93_));
  aoi21  g49(.a(new_n92_), .b(x19), .c(new_n93_), .O(new_n94_));
  nand2  g50(.a(x21), .b(new_n86_), .O(new_n95_));
  oai21  g51(.a(new_n94_), .b(new_n86_), .c(new_n95_), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(new_n75_), .c(new_n57_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(x00), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(x09), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n63_), .O(z11));
  ...
  aoi21  g63(.a(new_n107_), .b(new_n57_), .c(new_n56_), .O(new_n108_));
  oai22  g64(.a(new_n108_), .b(new_n45_), .c(new_n57_), .d(new_n65_), .O(z12));
  ...
  aoi21  g70(.a(new_n114_), .b(new_n57_), .c(new_n56_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n45_), .c(new_n67_), .O(z13));
  nand2  g72(.a(new_n73_), .b(x05), .O(new_n117_));
  ...
  nand4  g79(.a(new_n123_), .b(x09), .c(new_n57_), .d(x00), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n117_), .O(z14));
  ...
  aoi21  g87(.a(new_n131_), .b(new_n57_), .c(new_n56_), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n45_), .c(new_n71_), .O(z15));
  ...
  nand4  g95(.a(new_n139_), .b(new_n105_), .c(new_n138_), .d(new_n77_), .O(new_n140_));
  aoi21  g96(.a(new_n140_), .b(new_n137_), .c(x10), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n57_), .c(new_n56_), .O(new_n142_));
  nand2  g98(.a(x08), .b(x07), .O(new_n143_));
  oai21  g99(.a(new_n142_), .b(new_n45_), .c(new_n143_), .O(z16));
endmodule
