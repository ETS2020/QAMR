...
module FAU ( 
  ...
  aoi21  g039(.a(new_n83_), .b(new_n46_), .c(new_n74_), .O(new_n84_));
  oai22  g040(.a(new_n84_), .b(x10), .c(new_n46_), .d(new_n54_), .O(z09));
  ...
  nor2   g052(.a(new_n75_), .b(x20), .O(new_n97_));
  ...
  oai21  g057(.a(new_n57_), .b(new_n61_), .c(new_n101_), .O(z11));
  ...
  oai21  g065(.a(new_n109_), .b(new_n74_), .c(new_n47_), .O(new_n110_));
  ...
  aoi21  g072(.a(new_n116_), .b(new_n114_), .c(new_n76_), .O(new_n117_));
  nor2   g073(.a(new_n79_), .b(x22), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n46_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x09), .O(new_n120_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n74_), .c(new_n47_), .O(new_n129_));
  oai21  g085(.a(new_n46_), .b(new_n68_), .c(new_n129_), .O(z14));
  nor2   g086(.a(new_n79_), .b(new_n76_), .O(new_n131_));
  ...
  oai21  g093(.a(new_n137_), .b(new_n74_), .c(new_n47_), .O(new_n138_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n103_), .c(new_n81_), .d(new_n77_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n147_));
  oai21  g103(.a(new_n57_), .b(new_n72_), .c(new_n147_), .O(z16));
endmodule
