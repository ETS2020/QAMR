...
module FAU ( 
  ...
  nand2  g021(.a(new_n65_), .b(new_n62_), .O(z05));
  ...
  nand2  g027(.a(new_n71_), .b(new_n62_), .O(z08));
  ...
  oai21  g038(.a(new_n46_), .b(new_n57_), .c(new_n82_), .O(new_n83_));
  ...
  nand3  g069(.a(new_n113_), .b(new_n63_), .c(new_n62_), .O(z12));
  nand2  g070(.a(new_n55_), .b(x04), .O(new_n115_));
  ...
  nand4  g077(.a(new_n121_), .b(new_n110_), .c(x21), .d(x06), .O(new_n122_));
  ...
  nand2  g081(.a(new_n55_), .b(x05), .O(new_n126_));
  ...
  nand3  g088(.a(x24), .b(new_n89_), .c(x06), .O(new_n133_));
  ...
  oai21  g092(.a(new_n89_), .b(x06), .c(x08), .O(new_n137_));
  nand3  g093(.a(x25), .b(new_n47_), .c(x09), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x06), .O(new_n139_));
  ...
  oai21  g098(.a(new_n142_), .b(new_n116_), .c(x25), .O(new_n143_));
  nand4  g099(.a(new_n117_), .b(new_n90_), .c(new_n74_), .d(x24), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n140_), .c(new_n137_), .O(z15));
  nand3  g103(.a(x26), .b(new_n89_), .c(new_n47_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n85_), .c(new_n71_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x06), .O(new_n150_));
  ...
  and2   g110(.a(x24), .b(x22), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n117_), .c(new_n45_), .d(x25), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n71_), .O(new_n159_));
