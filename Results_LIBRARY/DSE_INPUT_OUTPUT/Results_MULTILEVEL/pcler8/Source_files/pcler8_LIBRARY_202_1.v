...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n61_, new_n62_, new_n66_, new_n68_, new_n70_, new_n72_, new_n74_,
  ...
  aoi21  g012(.a(new_n56_), .b(x11), .c(new_n45_), .O(z00));
  nor2   g013(.a(new_n45_), .b(x11), .O(new_n58_));
  ...
  nand2  g030(.a(new_n52_), .b(x20), .O(new_n75_));
  nand4  g031(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n76_));
  oai21  g032(.a(new_n76_), .b(new_n75_), .c(x19), .O(new_n77_));
  nand4  g033(.a(new_n77_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n78_));
  ...
  nand4  g042(.a(new_n86_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n87_));
  ...
  nand4  g054(.a(x14), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n99_));
  and2   g055(.a(x23), .b(x22), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n55_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n99_), .c(x11), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(x24), .O(new_n103_));
  nand3  g059(.a(x21), .b(x20), .c(x19), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand2  g061(.a(new_n51_), .b(x21), .O(new_n106_));
  oai22  g062(.a(new_n106_), .b(new_n48_), .c(new_n105_), .d(new_n51_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n108_));
  nand2  g064(.a(x08), .b(x03), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n108_), .c(new_n103_), .O(z12));
  nand3  g066(.a(new_n74_), .b(x09), .c(new_n46_), .O(new_n111_));
  nand3  g067(.a(new_n55_), .b(x23), .c(x15), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n111_), .c(x11), .O(new_n113_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n48_), .c(new_n116_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n114_), .c(new_n66_), .O(z13));
  ...
  oai21  g081(.a(new_n125_), .b(new_n104_), .c(x24), .O(new_n126_));
  nand4  g082(.a(new_n105_), .b(new_n45_), .c(x23), .d(x22), .O(new_n127_));
  oai21  g083(.a(new_n126_), .b(new_n123_), .c(new_n127_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n122_), .O(z14));
  nand2  g086(.a(new_n59_), .b(x06), .O(new_n131_));
  ...
  nand4  g090(.a(new_n105_), .b(new_n100_), .c(new_n53_), .d(x24), .O(new_n135_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n131_), .O(z15));
  nand2  g097(.a(new_n59_), .b(x07), .O(new_n142_));
  nor2   g098(.a(new_n48_), .b(x18), .O(new_n143_));
  nand4  g099(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n143_), .c(new_n54_), .O(new_n146_));
  nand4  g102(.a(new_n54_), .b(x25), .c(x24), .d(x23), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n115_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n146_), .c(x11), .O(new_n149_));
  nand2  g105(.a(x26), .b(new_n45_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n142_), .O(z16));
endmodule
