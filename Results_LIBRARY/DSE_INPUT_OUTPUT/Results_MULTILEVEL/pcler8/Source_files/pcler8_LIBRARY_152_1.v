...
module FAU ( 
  ...
  nor2   g030(.a(new_n66_), .b(new_n74_), .O(z08));
  ...
  nand3  g037(.a(new_n81_), .b(new_n60_), .c(new_n47_), .O(z09));
  ...
  aoi21  g043(.a(x08), .b(x01), .c(new_n46_), .O(new_n88_));
  ...
  nor2   g047(.a(new_n76_), .b(x20), .O(new_n92_));
  ...
  oai21  g061(.a(new_n66_), .b(new_n65_), .c(new_n105_), .O(z12));
  nand2  g062(.a(new_n62_), .b(x04), .O(new_n107_));
  ...
  oai21  g082(.a(new_n66_), .b(new_n70_), .c(new_n126_), .O(z14));
  ...
  oai21  g090(.a(new_n66_), .b(new_n72_), .c(new_n134_), .O(z15));
  ...
  nand4  g097(.a(new_n141_), .b(new_n140_), .c(new_n77_), .d(new_n51_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n144_));
  oai21  g100(.a(new_n66_), .b(new_n74_), .c(new_n144_), .O(z16));
endmodule
