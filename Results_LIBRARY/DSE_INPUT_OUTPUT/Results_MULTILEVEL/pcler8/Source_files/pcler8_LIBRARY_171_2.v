...
module FAU ( 
  ...
  aoi21  g038(.a(x08), .b(x00), .c(new_n55_), .O(new_n83_));
  ...
  nand2  g048(.a(x23), .b(x22), .O(new_n93_));
  nand3  g049(.a(x26), .b(x25), .c(x24), .O(new_n94_));
  nor3   g050(.a(new_n94_), .b(new_n93_), .c(new_n71_), .O(new_n95_));
  ...
  oai21  g058(.a(new_n102_), .b(new_n71_), .c(new_n100_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n104_));
  aoi21  g060(.a(x08), .b(x02), .c(new_n55_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n104_), .O(z11));
  nand3  g062(.a(x21), .b(x20), .c(x19), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand2  g064(.a(new_n72_), .b(x21), .O(new_n109_));
  oai22  g065(.a(new_n109_), .b(new_n101_), .c(new_n108_), .d(new_n72_), .O(new_n110_));
  ...
  nor2   g069(.a(new_n94_), .b(new_n93_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n90_), .c(x14), .d(new_n47_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n113_), .O(z12));
  nand3  g072(.a(new_n79_), .b(x24), .c(x15), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n108_), .c(x22), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x23), .O(new_n119_));
  nor2   g075(.a(x23), .b(new_n72_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n102_), .c(x21), .d(new_n54_), .O(new_n121_));
  ...
  nand2  g080(.a(new_n56_), .b(x05), .O(new_n125_));
  nand3  g081(.a(x26), .b(x25), .c(x16), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n102_), .c(x22), .d(x21), .O(new_n127_));
  nand3  g083(.a(new_n76_), .b(x22), .c(x21), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(new_n101_), .O(new_n129_));
  aoi21  g085(.a(new_n127_), .b(x24), .c(new_n129_), .O(new_n130_));
  nand3  g086(.a(x24), .b(new_n75_), .c(new_n54_), .O(new_n131_));
  oai21  g087(.a(new_n130_), .b(new_n75_), .c(new_n131_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n125_), .O(z14));
  nand3  g090(.a(new_n79_), .b(new_n90_), .c(new_n47_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x23), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x17), .O(new_n137_));
  nand3  g093(.a(new_n108_), .b(new_n77_), .c(x22), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x25), .O(new_n139_));
  nand4  g095(.a(new_n78_), .b(x24), .c(x23), .d(x22), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n107_), .c(new_n139_), .O(new_n141_));
  ...
  nand3  g100(.a(new_n90_), .b(x26), .c(new_n47_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n54_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n75_), .O(new_n147_));
  inv1   g103(.a(x18), .O(new_n148_));
  nand2  g104(.a(new_n102_), .b(new_n148_), .O(new_n149_));
  nand3  g105(.a(new_n73_), .b(x25), .c(x24), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n149_), .c(x26), .O(new_n151_));
  nor2   g107(.a(x26), .b(new_n78_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n102_), .c(new_n77_), .d(new_n73_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n147_), .c(new_n69_), .O(z16));
endmodule
