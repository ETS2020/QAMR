...
module FAU ( 
  ...
  oai21  g26(.a(new_n70_), .b(new_n69_), .c(new_n60_), .O(z05));
  inv1   g27(.a(x05), .O(new_n72_));
  nor2   g28(.a(new_n61_), .b(new_n72_), .O(z06));
  nand2  g29(.a(x08), .b(x06), .O(new_n74_));
  nand2  g30(.a(new_n74_), .b(new_n60_), .O(z07));
  inv1   g31(.a(x07), .O(new_n76_));
  nor2   g32(.a(new_n61_), .b(new_n76_), .O(z08));
  ...
  aoi21  g37(.a(new_n81_), .b(new_n70_), .c(new_n58_), .O(new_n82_));
  oai22  g38(.a(new_n82_), .b(x10), .c(new_n70_), .d(new_n57_), .O(z09));
  ...
  nand2  g44(.a(new_n88_), .b(new_n59_), .O(new_n89_));
  oai21  g45(.a(new_n70_), .b(new_n63_), .c(new_n89_), .O(z10));
  ...
  aoi21  g52(.a(new_n96_), .b(new_n70_), .c(new_n58_), .O(new_n97_));
  ...
  aoi21  g61(.a(new_n105_), .b(new_n103_), .c(x08), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n58_), .c(new_n59_), .O(new_n107_));
  oai21  g63(.a(new_n70_), .b(new_n67_), .c(new_n107_), .O(z12));
  ...
  nand4  g69(.a(new_n113_), .b(new_n59_), .c(x09), .d(new_n70_), .O(new_n114_));
  ...
  nand4  g79(.a(new_n123_), .b(new_n59_), .c(x09), .d(new_n70_), .O(new_n124_));
  oai21  g80(.a(new_n61_), .b(new_n72_), .c(new_n124_), .O(z14));
  ...
  nand4  g95(.a(new_n139_), .b(new_n104_), .c(new_n138_), .d(new_n78_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n59_), .c(x09), .d(new_n70_), .O(new_n142_));
  oai21  g98(.a(new_n61_), .b(new_n76_), .c(new_n142_), .O(z16));
endmodule
