...
module FAU ( 
  ...
  nand2  g010(.a(new_n54_), .b(x18), .O(new_n55_));
  ...
  nor2   g037(.a(new_n54_), .b(new_n81_), .O(new_n82_));
  ...
  oai21  g068(.a(new_n46_), .b(new_n62_), .c(new_n112_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n55_), .O(new_n114_));
  nor3   g070(.a(new_n84_), .b(new_n54_), .c(new_n81_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n75_), .c(x14), .d(new_n47_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n114_), .O(z12));
  nand4  g073(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n118_));
  nor4   g074(.a(new_n118_), .b(x10), .c(new_n74_), .d(x08), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(x18), .c(new_n54_), .O(new_n120_));
  ...
  nand3  g084(.a(new_n75_), .b(x24), .c(new_n47_), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(x18), .c(new_n54_), .O(new_n131_));
  nand2  g087(.a(x20), .b(x19), .O(new_n132_));
  ...
  nor2   g091(.a(x24), .b(new_n54_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n121_), .c(x22), .O(new_n137_));
  ...
  nand3  g096(.a(new_n140_), .b(new_n139_), .c(new_n131_), .O(z14));
  nand3  g097(.a(new_n75_), .b(x25), .c(new_n47_), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(x18), .c(new_n54_), .O(new_n144_));
  nand2  g100(.a(x26), .b(x17), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(x24), .c(x22), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n108_), .c(x25), .O(new_n147_));
  inv1   g103(.a(x25), .O(new_n148_));
  nand4  g104(.a(new_n121_), .b(new_n82_), .c(new_n148_), .d(x24), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n144_), .c(new_n69_), .O(z15));
  nand3  g108(.a(new_n75_), .b(x26), .c(new_n47_), .O(new_n153_));
  ...
  oai21  g112(.a(new_n156_), .b(new_n108_), .c(x26), .O(new_n157_));
  nand4  g113(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n118_), .c(new_n157_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n155_), .c(new_n71_), .O(z16));
endmodule
