...
module FAU ( 
  ...
  aoi21  g39(.a(new_n83_), .b(new_n82_), .c(z00), .O(z11));
  ...
  nand3  g55(.a(new_n68_), .b(x25), .c(new_n72_), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(new_n99_), .c(z00), .O(z15));
  nand2  g57(.a(x08), .b(x07), .O(new_n102_));
  nand3  g58(.a(new_n68_), .b(x26), .c(new_n72_), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n102_), .c(z00), .O(z16));
endmodule
