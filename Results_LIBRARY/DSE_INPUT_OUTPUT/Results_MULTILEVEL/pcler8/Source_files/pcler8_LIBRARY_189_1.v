...
module FAU ( 
  ...
  nand2  g030(.a(new_n74_), .b(new_n69_), .O(z07));
  ...
  nand4  g038(.a(new_n82_), .b(new_n45_), .c(new_n77_), .d(x09), .O(new_n83_));
  oai22  g039(.a(new_n83_), .b(x08), .c(new_n61_), .d(new_n57_), .O(z09));
  ...
  aoi21  g046(.a(new_n90_), .b(new_n58_), .c(x17), .O(new_n91_));
  oai22  g047(.a(new_n91_), .b(x10), .c(new_n58_), .d(new_n63_), .O(z10));
  ...
  aoi21  g052(.a(new_n96_), .b(new_n95_), .c(x17), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n77_), .c(x09), .d(new_n58_), .O(new_n98_));
  ...
  aoi21  g061(.a(new_n105_), .b(new_n103_), .c(x17), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n77_), .c(x09), .d(new_n58_), .O(new_n107_));
  oai21  g063(.a(new_n61_), .b(new_n67_), .c(new_n107_), .O(z12));
  ...
  nand2  g068(.a(new_n48_), .b(x23), .O(new_n113_));
  ...
  aoi21  g072(.a(new_n116_), .b(new_n115_), .c(x17), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n77_), .c(x09), .d(new_n58_), .O(new_n118_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n122_), .c(x17), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n77_), .c(x09), .d(new_n58_), .O(new_n126_));
  oai21  g082(.a(new_n61_), .b(new_n72_), .c(new_n126_), .O(z14));
  nand2  g083(.a(new_n60_), .b(x06), .O(new_n128_));
  nor2   g084(.a(new_n123_), .b(new_n51_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n49_), .c(x22), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x25), .O(new_n131_));
  inv1   g087(.a(x25), .O(new_n132_));
  nand3  g088(.a(new_n52_), .b(new_n132_), .c(x24), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n48_), .c(new_n131_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n45_), .c(new_n77_), .d(x09), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(x08), .c(new_n128_), .O(z15));
  ...
  nor2   g096(.a(x26), .b(new_n132_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n104_), .c(new_n129_), .d(new_n79_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n140_), .c(new_n46_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n58_), .c(x17), .O(new_n144_));
