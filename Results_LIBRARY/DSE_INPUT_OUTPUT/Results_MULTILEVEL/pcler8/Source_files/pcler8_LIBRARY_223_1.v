...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n62_, new_n63_, new_n66_, new_n67_, new_n69_, new_n71_, new_n73_,
  ...
  and2   g20(.a(new_n59_), .b(x03), .O(z04));
  ...
  oai21  g25(.a(new_n57_), .b(new_n69_), .c(new_n66_), .O(z06));
  ...
  nand3  g36(.a(new_n80_), .b(x09), .c(new_n57_), .O(new_n81_));
  ...
  oai21  g42(.a(new_n86_), .b(new_n79_), .c(x20), .O(new_n87_));
  ...
  aoi21  g47(.a(new_n91_), .b(new_n57_), .c(x13), .O(new_n92_));
  nand2  g48(.a(x08), .b(x01), .O(new_n93_));
  oai21  g49(.a(new_n92_), .b(x10), .c(new_n93_), .O(z10));
  nand2  g50(.a(x20), .b(x19), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(x21), .O(new_n96_));
  nand3  g52(.a(new_n76_), .b(x20), .c(x19), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n96_), .c(x13), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n75_), .c(x09), .d(new_n57_), .O(new_n99_));
  oai21  g55(.a(new_n63_), .b(new_n62_), .c(new_n99_), .O(z11));
  ...
  aoi21  g62(.a(new_n106_), .b(new_n57_), .c(x13), .O(new_n107_));
  ...
  aoi21  g77(.a(new_n121_), .b(new_n119_), .c(x13), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n75_), .c(x09), .d(new_n57_), .O(new_n123_));
  oai21  g79(.a(new_n63_), .b(new_n69_), .c(new_n123_), .O(z14));
  nand2  g80(.a(new_n59_), .b(x06), .O(new_n125_));
  ...
  aoi21  g86(.a(new_n130_), .b(new_n128_), .c(x13), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n75_), .c(x09), .d(new_n57_), .O(new_n132_));
  ...
  aoi21  g96(.a(new_n140_), .b(new_n137_), .c(new_n46_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n57_), .c(x13), .O(new_n142_));
  oai22  g98(.a(new_n142_), .b(x10), .c(new_n57_), .d(new_n73_), .O(z16));
endmodule
