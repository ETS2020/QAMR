...
module FAU ( 
  ...
  and2   g018(.a(new_n58_), .b(x03), .O(z04));
  ...
  nor2   g025(.a(new_n65_), .b(new_n69_), .O(z07));
  ...
  oai21  g032(.a(new_n65_), .b(new_n54_), .c(new_n76_), .O(z09));
  ...
  aoi21  g061(.a(x08), .b(x03), .c(new_n55_), .O(new_n106_));
  ...
  oai21  g065(.a(new_n109_), .b(new_n97_), .c(x23), .O(new_n110_));
  ...
  oai21  g070(.a(new_n65_), .b(new_n64_), .c(new_n114_), .O(z13));
  ...
  nor2   g076(.a(x24), .b(new_n111_), .O(new_n121_));
  ...
  oai21  g080(.a(new_n65_), .b(new_n67_), .c(new_n124_), .O(z14));
  ...
  nor2   g085(.a(new_n111_), .b(new_n101_), .O(new_n130_));
  nand4  g086(.a(new_n120_), .b(new_n130_), .c(new_n129_), .d(x24), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n133_));
  oai21  g089(.a(new_n65_), .b(new_n69_), .c(new_n133_), .O(z15));
  nand3  g090(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nor3   g091(.a(new_n135_), .b(new_n101_), .c(new_n90_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n102_), .c(x09), .d(new_n46_), .O(new_n137_));
  ...
  nand3  g101(.a(new_n145_), .b(new_n139_), .c(new_n71_), .O(z16));
endmodule
