...
module FAU ( 
  ...
  inv1   g17(.a(new_n52_), .O(z12));
  inv1   g18(.a(new_n57_), .O(z15));
  inv1   g19(.a(new_n59_), .O(z16));
  zero   g20(.O(z00));
  oai21  g21(.a(x10), .b(x08), .c(new_n48_), .O(z10));
  and2   g22(.a(x08), .b(x04), .O(z13));
  oai21  g23(.a(x10), .b(x08), .c(new_n55_), .O(z14));
endmodule
