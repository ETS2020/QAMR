...
module FAU ( 
  ...
  nand3  g032(.a(new_n54_), .b(x26), .c(x25), .O(new_n77_));
  ...
  aoi21  g063(.a(x08), .b(x03), .c(new_n80_), .O(new_n108_));
  ...
  and2   g077(.a(x22), .b(x21), .O(new_n122_));
  nor2   g078(.a(x24), .b(new_n53_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n122_), .c(new_n50_), .d(new_n121_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n120_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n126_));
  oai21  g082(.a(new_n60_), .b(new_n70_), .c(new_n126_), .O(z14));
  ...
  nand4  g086(.a(new_n130_), .b(x25), .c(new_n48_), .d(x09), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(x08), .c(new_n72_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n46_), .O(new_n133_));
  nand3  g089(.a(x25), .b(new_n45_), .c(new_n121_), .O(new_n134_));
  nor2   g090(.a(x25), .b(new_n45_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n128_), .c(new_n54_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n133_), .O(z15));
  inv1   g095(.a(x18), .O(new_n140_));
  and2   g096(.a(x25), .b(x23), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n122_), .c(new_n50_), .d(new_n140_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(x26), .c(new_n48_), .d(x09), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(x08), .c(new_n74_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n46_), .O(new_n145_));
  nand3  g101(.a(x26), .b(new_n45_), .c(new_n121_), .O(new_n146_));
  nand2  g102(.a(new_n122_), .b(new_n50_), .O(new_n147_));
