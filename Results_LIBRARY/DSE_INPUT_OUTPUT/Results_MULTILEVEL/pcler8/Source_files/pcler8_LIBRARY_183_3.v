...
module FAU ( 
  ...
  aoi21  g29(.a(new_n74_), .b(new_n54_), .c(new_n49_), .O(z10));
  ...
  nand2  g34(.a(x08), .b(x02), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(new_n79_), .c(new_n49_), .O(z11));
  ...
  nand2  g45(.a(new_n82_), .b(x23), .O(new_n91_));
  ...
  nand2  g50(.a(x23), .b(new_n85_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n98_));
  nand2  g53(.a(x08), .b(x04), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n98_), .c(new_n49_), .O(z13));
  nand3  g55(.a(x23), .b(x22), .c(x21), .O(new_n101_));
  oai21  g56(.a(new_n101_), .b(new_n84_), .c(x24), .O(new_n102_));
  inv1   g57(.a(x24), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(x23), .c(x22), .O(new_n104_));
  oai21  g59(.a(new_n104_), .b(new_n82_), .c(new_n102_), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n106_));
  aoi21  g61(.a(x08), .b(x05), .c(new_n49_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(z14));
  nand3  g63(.a(x24), .b(x23), .c(x22), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n82_), .c(new_n48_), .O(new_n110_));
  nor2   g65(.a(new_n92_), .b(new_n85_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n47_), .c(x24), .O(new_n112_));
  oai22  g67(.a(new_n112_), .b(new_n82_), .c(new_n110_), .d(new_n47_), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n64_), .O(z15));
  nand3  g70(.a(new_n111_), .b(x25), .c(x24), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n82_), .c(new_n48_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n118_));
  aoi21  g73(.a(x08), .b(x07), .c(new_n49_), .O(new_n119_));
