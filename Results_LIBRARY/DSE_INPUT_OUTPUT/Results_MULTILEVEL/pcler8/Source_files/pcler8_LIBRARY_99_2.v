...
module FAU ( 
  ...
  nand2  g015(.a(new_n59_), .b(x03), .O(new_n60_));
  ...
  nand2  g020(.a(new_n60_), .b(x08), .O(new_n65_));
  nor2   g021(.a(new_n65_), .b(new_n64_), .O(z03));
  nand3  g022(.a(x10), .b(x08), .c(x03), .O(new_n67_));
  inv1   g023(.a(new_n67_), .O(z04));
  inv1   g024(.a(x04), .O(new_n69_));
  oai22  g025(.a(x10), .b(new_n45_), .c(new_n58_), .d(new_n69_), .O(z05));
  inv1   g026(.a(x05), .O(new_n71_));
  nor2   g027(.a(new_n65_), .b(new_n71_), .O(z06));
  inv1   g028(.a(x06), .O(new_n73_));
  nor2   g029(.a(new_n65_), .b(new_n73_), .O(z07));
  inv1   g030(.a(x07), .O(new_n75_));
  nor2   g031(.a(new_n65_), .b(new_n75_), .O(z08));
  ...
  nand4  g036(.a(new_n80_), .b(new_n59_), .c(x09), .d(new_n58_), .O(new_n81_));
  oai22  g037(.a(new_n81_), .b(x03), .c(new_n65_), .d(new_n57_), .O(z09));
  ...
  nand4  g044(.a(new_n88_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n89_));
  oai21  g045(.a(new_n65_), .b(new_n62_), .c(new_n89_), .O(z10));
  nand3  g046(.a(x23), .b(x22), .c(x13), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n53_), .c(x21), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(x20), .c(x19), .O(new_n93_));
  nand2  g049(.a(x20), .b(x19), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(x21), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(new_n93_), .c(new_n46_), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n58_), .c(x03), .O(new_n97_));
  oai22  g053(.a(new_n97_), .b(x10), .c(new_n58_), .d(new_n64_), .O(z11));
  nand2  g054(.a(x23), .b(x14), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n53_), .c(x21), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n94_), .c(x22), .O(new_n101_));
  inv1   g057(.a(new_n94_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n50_), .c(x21), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n101_), .c(x10), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n67_), .O(z12));
  nand2  g062(.a(new_n59_), .b(x03), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x08), .c(x04), .O(new_n108_));
  ...
  nand2  g067(.a(new_n48_), .b(x23), .O(new_n112_));
  ...
  nand4  g072(.a(new_n116_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n108_), .O(z13));
  ...
  nand4  g080(.a(new_n124_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n125_));
  oai21  g081(.a(new_n65_), .b(new_n71_), .c(new_n125_), .O(z14));
  ...
  nand4  g088(.a(new_n132_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n133_));
  oai21  g089(.a(new_n65_), .b(new_n73_), .c(new_n133_), .O(z15));
  inv1   g090(.a(x18), .O(new_n135_));
  nand4  g091(.a(x21), .b(x20), .c(x19), .d(new_n135_), .O(new_n136_));
  nand3  g092(.a(new_n52_), .b(x25), .c(x24), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n136_), .c(x26), .O(new_n138_));
  nor2   g094(.a(new_n122_), .b(new_n51_), .O(new_n139_));
  nor2   g095(.a(x26), .b(new_n130_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n102_), .c(new_n139_), .d(new_n77_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n138_), .c(new_n46_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n58_), .c(x03), .O(new_n143_));
  nand2  g099(.a(x08), .b(x07), .O(new_n144_));
  oai21  g100(.a(new_n143_), .b(x10), .c(new_n144_), .O(z16));
endmodule
