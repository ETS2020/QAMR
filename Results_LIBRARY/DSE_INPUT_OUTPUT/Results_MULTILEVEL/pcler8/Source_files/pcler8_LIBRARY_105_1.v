...
module FAU ( 
  ...
  nor2   g022(.a(new_n60_), .b(new_n66_), .O(new_n67_));
  and2   g023(.a(new_n67_), .b(x02), .O(z03));
  nand2  g024(.a(x08), .b(x03), .O(new_n69_));
  nand2  g025(.a(new_n69_), .b(new_n61_), .O(z04));
  nand2  g026(.a(x08), .b(x04), .O(new_n71_));
  nand2  g027(.a(new_n71_), .b(new_n61_), .O(z05));
  nand2  g028(.a(x08), .b(x05), .O(new_n73_));
  nand2  g029(.a(new_n73_), .b(new_n61_), .O(z06));
  and2   g030(.a(new_n67_), .b(x06), .O(z07));
  nand2  g031(.a(x08), .b(x07), .O(new_n76_));
  nand2  g032(.a(new_n76_), .b(new_n61_), .O(z08));
  ...
  nand4  g037(.a(new_n81_), .b(new_n78_), .c(x09), .d(new_n66_), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(new_n62_), .c(new_n61_), .O(z09));
  xor2a  g039(.a(x20), .b(x19), .O(new_n84_));
  nand4  g040(.a(new_n84_), .b(new_n78_), .c(x09), .d(new_n66_), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(new_n64_), .O(new_n86_));
  ...
  nand4  g047(.a(new_n91_), .b(new_n89_), .c(new_n57_), .d(new_n47_), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n87_), .O(z10));
  inv1   g049(.a(new_n48_), .O(new_n94_));
  nand4  g050(.a(x22), .b(x21), .c(x13), .d(x12), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n80_), .c(x21), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(x20), .c(x19), .O(new_n97_));
  oai21  g053(.a(new_n94_), .b(new_n50_), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n78_), .c(x09), .d(new_n66_), .O(new_n99_));
  aoi21  g055(.a(x08), .b(x02), .c(new_n60_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n99_), .O(z11));
  nand3  g057(.a(new_n47_), .b(x14), .c(new_n78_), .O(new_n102_));
  nand3  g058(.a(new_n55_), .b(x24), .c(x22), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n102_), .c(x12), .O(new_n104_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n78_), .c(x09), .d(new_n66_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n105_), .c(new_n69_), .O(z12));
  nand3  g067(.a(new_n55_), .b(x24), .c(x15), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n107_), .c(x22), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x23), .O(new_n114_));
  nand4  g070(.a(new_n94_), .b(new_n45_), .c(x22), .d(x21), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n78_), .c(x09), .d(new_n66_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n71_), .c(new_n61_), .O(z13));
  nand2  g074(.a(new_n67_), .b(x05), .O(new_n119_));
  inv1   g075(.a(x12), .O(new_n120_));
  nand3  g076(.a(x26), .b(x25), .c(x16), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n94_), .c(x22), .d(x21), .O(new_n122_));
  ...
  nand4  g084(.a(new_n128_), .b(new_n78_), .c(x09), .d(new_n66_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n119_), .O(z14));
  nand3  g086(.a(new_n47_), .b(x19), .c(new_n78_), .O(new_n131_));
  nor2   g087(.a(x25), .b(new_n123_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(x22), .c(x21), .d(x20), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n131_), .c(x12), .O(new_n134_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n78_), .c(x09), .d(new_n66_), .O(new_n140_));
  nand2  g096(.a(x08), .b(x06), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n140_), .c(new_n135_), .O(z15));
  nand2  g098(.a(new_n67_), .b(x07), .O(new_n143_));
  nor2   g099(.a(new_n48_), .b(x18), .O(new_n144_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n147_), .c(x12), .O(new_n151_));
  nand2  g107(.a(x26), .b(new_n45_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n78_), .c(x09), .d(new_n66_), .O(new_n154_));
