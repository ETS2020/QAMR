...
module FAU ( 
  ...
  nand2  g014(.a(new_n58_), .b(new_n45_), .O(z01));
  ...
  aoi21  g024(.a(new_n47_), .b(new_n46_), .c(new_n68_), .O(z05));
  nand2  g025(.a(new_n61_), .b(x05), .O(new_n70_));
  inv1   g026(.a(new_n70_), .O(z06));
  inv1   g027(.a(x06), .O(new_n72_));
  oai21  g028(.a(new_n46_), .b(new_n72_), .c(new_n45_), .O(z07));
  ...
  nand3  g037(.a(new_n81_), .b(new_n58_), .c(new_n45_), .O(z09));
  ...
  inv1   g045(.a(new_n45_), .O(new_n90_));
  aoi21  g046(.a(x08), .b(x01), .c(new_n90_), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n89_), .O(z10));
  ...
  aoi21  g055(.a(x08), .b(x02), .c(new_n90_), .O(new_n100_));
  ...
  oai21  g068(.a(new_n112_), .b(new_n48_), .c(x23), .O(new_n113_));
  nand4  g069(.a(new_n49_), .b(new_n52_), .c(x22), .d(x21), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x09), .c(new_n46_), .O(new_n116_));
  nand2  g072(.a(x08), .b(x04), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n116_), .c(x10), .O(z13));
  ...
  oai21  g091(.a(new_n60_), .b(new_n72_), .c(new_n135_), .O(z15));
  ...
  nor2   g096(.a(new_n123_), .b(new_n52_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n132_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n141_), .c(new_n77_), .d(new_n49_), .O(new_n143_));
