...
module FAU ( 
  ...
  oai21  g028(.a(new_n62_), .b(new_n72_), .c(new_n58_), .O(z06));
  ...
  aoi21  g038(.a(new_n82_), .b(new_n62_), .c(new_n78_), .O(new_n83_));
  oai21  g039(.a(new_n83_), .b(x10), .c(new_n59_), .O(z09));
  ...
  nand4  g045(.a(new_n89_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n90_));
  oai21  g046(.a(new_n64_), .b(new_n61_), .c(new_n90_), .O(z10));
  ...
  nand4  g053(.a(new_n97_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n98_));
  oai21  g054(.a(new_n64_), .b(new_n66_), .c(new_n98_), .O(z11));
  ...
  nand4  g062(.a(new_n106_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n107_));
  ...
  nand4  g074(.a(new_n118_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n119_));
  ...
  nand4  g083(.a(new_n127_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n128_));
  oai21  g084(.a(new_n64_), .b(new_n72_), .c(new_n128_), .O(z14));
  ...
  nand4  g091(.a(new_n135_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n136_));
  oai21  g092(.a(new_n64_), .b(new_n74_), .c(new_n136_), .O(z15));
  ...
  nand4  g101(.a(new_n145_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n146_));
  oai21  g102(.a(new_n64_), .b(new_n76_), .c(new_n146_), .O(z16));
endmodule
