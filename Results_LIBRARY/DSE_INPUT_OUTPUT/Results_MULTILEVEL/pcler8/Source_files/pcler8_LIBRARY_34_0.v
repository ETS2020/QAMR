...
module FAU ( 
  ...
  aoi21  g035(.a(new_n79_), .b(new_n46_), .c(new_n73_), .O(new_n80_));
  oai22  g036(.a(new_n80_), .b(x10), .c(new_n46_), .d(new_n54_), .O(z09));
  ...
  aoi21  g053(.a(new_n97_), .b(new_n46_), .c(new_n73_), .O(new_n98_));
  nand2  g054(.a(x08), .b(x02), .O(new_n99_));
  oai21  g055(.a(new_n98_), .b(x10), .c(new_n99_), .O(z11));
  nor2   g056(.a(new_n84_), .b(new_n90_), .O(new_n101_));
  ...
  oai21  g064(.a(new_n57_), .b(new_n63_), .c(new_n108_), .O(z12));
  ...
  oai21  g083(.a(new_n127_), .b(new_n73_), .c(new_n47_), .O(new_n128_));
  oai21  g084(.a(new_n46_), .b(new_n67_), .c(new_n128_), .O(z14));
  ...
  oai21  g094(.a(new_n57_), .b(new_n69_), .c(new_n138_), .O(z15));
  ...
  nand4  g101(.a(new_n145_), .b(new_n101_), .c(new_n144_), .d(new_n76_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n148_));
  oai21  g104(.a(new_n57_), .b(new_n71_), .c(new_n148_), .O(z16));
endmodule
