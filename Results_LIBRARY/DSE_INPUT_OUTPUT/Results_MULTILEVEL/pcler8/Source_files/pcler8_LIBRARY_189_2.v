...
module FAU ( 
  ...
  nor2   g21(.a(new_n62_), .b(new_n65_), .O(z03));
  ...
  nor2   g27(.a(new_n62_), .b(new_n71_), .O(z06));
  inv1   g28(.a(x06), .O(new_n73_));
  oai21  g29(.a(new_n48_), .b(new_n73_), .c(new_n47_), .O(z07));
  ...
  oai21  g51(.a(new_n62_), .b(new_n65_), .c(new_n95_), .O(z11));
  ...
  oai21  g59(.a(new_n62_), .b(new_n67_), .c(new_n103_), .O(z12));
  ...
  oai21  g80(.a(new_n62_), .b(new_n71_), .c(new_n124_), .O(z14));
  ...
  oai21  g88(.a(new_n62_), .b(new_n73_), .c(new_n132_), .O(z15));
