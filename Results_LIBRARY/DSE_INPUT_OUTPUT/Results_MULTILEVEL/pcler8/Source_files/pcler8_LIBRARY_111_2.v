...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n94_));
  oai21  g050(.a(new_n59_), .b(new_n62_), .c(new_n94_), .O(new_n95_));
  ...
  nor3   g055(.a(new_n51_), .b(new_n99_), .c(new_n45_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n98_), .c(new_n48_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n96_), .O(z11));
  nand4  g058(.a(x26), .b(x25), .c(x24), .d(x14), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n91_), .c(x21), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(x23), .c(x22), .O(new_n105_));
  nand3  g061(.a(new_n91_), .b(new_n45_), .c(x21), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n108_));
  oai21  g064(.a(new_n63_), .b(new_n65_), .c(new_n108_), .O(z12));
  nand3  g065(.a(x21), .b(x20), .c(x19), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n78_), .b(x24), .c(x15), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n111_), .c(x22), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(x23), .c(new_n46_), .d(x09), .O(new_n114_));
  oai22  g070(.a(new_n114_), .b(x08), .c(new_n63_), .d(new_n67_), .O(z13));
  nand3  g071(.a(new_n46_), .b(x09), .c(new_n59_), .O(new_n116_));
  inv1   g072(.a(x24), .O(new_n117_));
  nand3  g073(.a(new_n91_), .b(new_n117_), .c(x21), .O(new_n118_));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n91_), .c(new_n117_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n120_), .c(new_n69_), .O(z14));
  nand2  g082(.a(x26), .b(x17), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n91_), .c(x24), .d(x21), .O(new_n128_));
  nand3  g084(.a(new_n76_), .b(x24), .c(x22), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(new_n110_), .O(new_n130_));
  aoi21  g086(.a(new_n128_), .b(x25), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(x25), .b(new_n45_), .O(new_n132_));
  oai21  g088(.a(new_n131_), .b(new_n99_), .c(new_n132_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n71_), .O(z15));
  nor2   g091(.a(new_n90_), .b(x18), .O(new_n136_));
  nand3  g092(.a(x25), .b(x24), .c(x21), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n136_), .c(new_n77_), .O(new_n139_));
  nand4  g095(.a(new_n77_), .b(x25), .c(x24), .d(x22), .O(new_n140_));
