...
module FAU ( 
  ...
  oai21  g43(.a(new_n46_), .b(new_n58_), .c(new_n87_), .O(z10));
  ...
  oai21  g62(.a(new_n59_), .b(new_n63_), .c(new_n106_), .O(z12));
  ...
  oai21  g80(.a(new_n59_), .b(new_n67_), .c(new_n124_), .O(z14));
  ...
  nor2   g85(.a(new_n111_), .b(new_n74_), .O(new_n130_));
  nand4  g86(.a(new_n121_), .b(new_n130_), .c(new_n129_), .d(x24), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n128_), .c(x08), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n55_), .c(new_n47_), .O(new_n133_));
  oai21  g89(.a(new_n46_), .b(new_n69_), .c(new_n133_), .O(z15));
  ...
  oai21  g99(.a(new_n59_), .b(new_n71_), .c(new_n143_), .O(z16));
endmodule
