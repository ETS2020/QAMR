...
module FAU ( 
  ...
  nand2  g012(.a(new_n48_), .b(new_n56_), .O(new_n57_));
  ...
  oai21  g025(.a(new_n47_), .b(new_n56_), .c(new_n57_), .O(z07));
  inv1   g026(.a(x07), .O(new_n71_));
  oai21  g027(.a(new_n47_), .b(new_n71_), .c(new_n57_), .O(z08));
  ...
  nand2  g034(.a(new_n78_), .b(x06), .O(new_n79_));
  nand2  g035(.a(new_n79_), .b(new_n48_), .O(new_n80_));
  oai21  g036(.a(new_n47_), .b(new_n55_), .c(new_n80_), .O(z09));
  ...
  aoi21  g044(.a(new_n88_), .b(new_n47_), .c(new_n56_), .O(new_n89_));
  ...
  nand2  g054(.a(new_n98_), .b(x06), .O(new_n99_));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n105_), .c(new_n82_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n47_), .c(new_n56_), .O(new_n109_));
  oai22  g065(.a(new_n109_), .b(x10), .c(new_n47_), .d(new_n64_), .O(z12));
  ...
  oai21  g073(.a(new_n58_), .b(new_n66_), .c(new_n117_), .O(z13));
  ...
  aoi21  g081(.a(new_n125_), .b(new_n122_), .c(new_n82_), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n47_), .c(new_n56_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(x10), .c(new_n68_), .O(z14));
  oai21  g084(.a(new_n48_), .b(x06), .c(x08), .O(new_n129_));
  nor2   g085(.a(new_n114_), .b(new_n46_), .O(new_n130_));
  ...
  oai21  g092(.a(new_n136_), .b(new_n56_), .c(new_n48_), .O(new_n137_));
  ...
  nand4  g102(.a(new_n146_), .b(x09), .c(new_n47_), .d(x06), .O(new_n147_));
  oai21  g103(.a(new_n58_), .b(new_n71_), .c(new_n147_), .O(z16));
endmodule
