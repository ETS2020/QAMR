...
module FAU ( 
  ...
  aoi21  g10(.a(new_n54_), .b(x04), .c(x10), .O(z00));
  inv1   g11(.a(x00), .O(new_n56_));
  inv1   g12(.a(x08), .O(new_n57_));
  nor2   g13(.a(x10), .b(x04), .O(new_n58_));
  ...
  inv1   g20(.a(new_n58_), .O(new_n65_));
  nand2  g21(.a(x08), .b(x03), .O(new_n66_));
  nand2  g22(.a(new_n66_), .b(new_n65_), .O(z04));
  inv1   g23(.a(x04), .O(new_n68_));
  oai21  g24(.a(new_n57_), .b(new_n68_), .c(new_n65_), .O(z05));
  nand2  g25(.a(x08), .b(x05), .O(new_n70_));
  nand2  g26(.a(new_n70_), .b(new_n65_), .O(z06));
  inv1   g27(.a(x06), .O(new_n72_));
  oai21  g28(.a(new_n57_), .b(new_n72_), .c(new_n65_), .O(z07));
  inv1   g29(.a(x07), .O(new_n74_));
  oai21  g30(.a(new_n57_), .b(new_n74_), .c(new_n65_), .O(z08));
  ...
  oai22  g37(.a(new_n81_), .b(new_n68_), .c(new_n60_), .d(new_n56_), .O(z09));
  ...
  nand4  g44(.a(new_n88_), .b(x09), .c(new_n57_), .d(x04), .O(new_n89_));
  oai21  g45(.a(new_n60_), .b(new_n62_), .c(new_n89_), .O(z10));
  ...
  aoi21  g52(.a(new_n96_), .b(new_n57_), .c(new_n68_), .O(new_n97_));
  nand2  g53(.a(x08), .b(x02), .O(new_n98_));
  oai21  g54(.a(new_n97_), .b(x10), .c(new_n98_), .O(z11));
  nand2  g55(.a(new_n59_), .b(x03), .O(new_n100_));
  nand2  g56(.a(x23), .b(x14), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n52_), .c(x21), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n94_), .c(x22), .O(new_n103_));
  inv1   g59(.a(new_n94_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n49_), .c(x21), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n103_), .c(x10), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(x09), .c(new_n57_), .d(x04), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n100_), .O(z12));
  oai21  g64(.a(new_n76_), .b(x04), .c(x08), .O(new_n109_));
  nand4  g65(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(x22), .c(x21), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n94_), .c(x23), .O(new_n112_));
  nand4  g68(.a(new_n104_), .b(new_n50_), .c(x22), .d(x21), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n112_), .c(new_n45_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n68_), .c(new_n76_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n109_), .O(z13));
  ...
  aoi21  g78(.a(new_n122_), .b(new_n57_), .c(new_n68_), .O(new_n123_));
  ...
  aoi21  g85(.a(new_n129_), .b(new_n127_), .c(x10), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(x09), .c(new_n57_), .d(x04), .O(new_n131_));
  oai21  g87(.a(new_n60_), .b(new_n72_), .c(new_n131_), .O(z15));
  ...
  nor2   g92(.a(new_n120_), .b(new_n50_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n128_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n104_), .c(new_n137_), .d(new_n77_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n136_), .c(x10), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(x09), .c(new_n57_), .d(x04), .O(new_n141_));
  oai21  g97(.a(new_n60_), .b(new_n74_), .c(new_n141_), .O(z16));
endmodule
