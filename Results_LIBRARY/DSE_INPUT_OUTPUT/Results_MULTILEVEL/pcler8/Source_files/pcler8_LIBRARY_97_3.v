...
module FAU ( 
  ...
  oai21  g15(.a(new_n46_), .b(new_n59_), .c(new_n54_), .O(z02));
  ...
  oai21  g40(.a(new_n55_), .b(new_n59_), .c(new_n84_), .O(z10));
  ...
  nand2  g49(.a(new_n93_), .b(new_n61_), .O(z11));
  ...
  oai21  g78(.a(new_n55_), .b(new_n67_), .c(new_n122_), .O(z14));
