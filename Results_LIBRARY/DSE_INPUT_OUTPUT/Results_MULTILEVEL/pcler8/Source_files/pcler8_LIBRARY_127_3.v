...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_,
    ...
    new_n93_, new_n95_, new_n97_, new_n99_, new_n100_;
  ...
  xnor2a g33(.a(x21), .b(x19), .O(new_n78_));
  nand2  g34(.a(x21), .b(new_n77_), .O(new_n79_));
  oai21  g35(.a(new_n78_), .b(new_n77_), .c(new_n79_), .O(new_n80_));
  nand4  g36(.a(new_n80_), .b(new_n73_), .c(x09), .d(new_n48_), .O(new_n81_));
  ...
  nand4  g43(.a(new_n87_), .b(new_n73_), .c(x09), .d(new_n48_), .O(new_n88_));
  nand3  g44(.a(new_n88_), .b(new_n57_), .c(new_n52_), .O(z12));
  nand4  g45(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n46_), .O(new_n91_));
  nand4  g47(.a(new_n91_), .b(new_n73_), .c(x09), .d(new_n48_), .O(new_n92_));
  aoi21  g48(.a(x08), .b(x04), .c(z00), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n92_), .O(z13));
  nand3  g50(.a(new_n69_), .b(x24), .c(new_n73_), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(new_n61_), .c(new_n52_), .O(z14));
  nand3  g52(.a(new_n69_), .b(x25), .c(new_n73_), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(new_n63_), .c(new_n52_), .O(z15));
  nand2  g54(.a(x08), .b(x07), .O(new_n99_));
  nand3  g55(.a(new_n69_), .b(x26), .c(new_n73_), .O(new_n100_));
  nand3  g56(.a(new_n100_), .b(new_n99_), .c(new_n52_), .O(z16));
endmodule
