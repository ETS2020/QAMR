...
module FAU ( 
  ...
  nor2   g012(.a(new_n56_), .b(x18), .O(new_n57_));
  ...
  oai21  g025(.a(new_n47_), .b(new_n69_), .c(new_n58_), .O(z06));
  ...
  nand2  g051(.a(x21), .b(new_n84_), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(new_n84_), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n63_), .c(new_n58_), .O(z11));
  nand3  g055(.a(x21), .b(x20), .c(x19), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand2  g057(.a(x20), .b(x19), .O(new_n102_));
  nand2  g058(.a(new_n46_), .b(x21), .O(new_n103_));
  oai22  g059(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n46_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n65_), .O(new_n106_));
  ...
  nor2   g066(.a(new_n110_), .b(new_n46_), .O(new_n111_));
  inv1   g067(.a(new_n91_), .O(new_n112_));
  nand2  g068(.a(x18), .b(x14), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(x10), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n112_), .c(new_n111_), .d(new_n109_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n107_), .O(z12));
  nand4  g072(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x23), .O(new_n118_));
  nand3  g074(.a(new_n110_), .b(x22), .c(x21), .O(new_n119_));
  ...
  nor2   g080(.a(x10), .b(new_n108_), .O(new_n125_));
  nand3  g081(.a(x19), .b(x18), .c(x15), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  nor4   g083(.a(new_n91_), .b(new_n46_), .c(new_n93_), .d(new_n84_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n127_), .c(new_n125_), .d(new_n47_), .O(new_n129_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n100_), .c(x24), .O(new_n134_));
  nand4  g090(.a(new_n101_), .b(new_n56_), .c(x23), .d(x22), .O(new_n135_));
  oai21  g091(.a(new_n134_), .b(new_n131_), .c(new_n135_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n137_));
  oai21  g093(.a(new_n59_), .b(new_n69_), .c(new_n137_), .O(z14));
  nand3  g094(.a(new_n109_), .b(x19), .c(new_n48_), .O(new_n139_));
  inv1   g095(.a(x25), .O(new_n140_));
  nor2   g096(.a(new_n93_), .b(new_n84_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n140_), .c(x23), .d(x22), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n139_), .c(x18), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x24), .O(new_n144_));
  nand2  g100(.a(x26), .b(x17), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n111_), .c(x24), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n101_), .c(new_n140_), .O(new_n148_));
  ...
  nand3  g107(.a(new_n111_), .b(x25), .c(x24), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n100_), .c(new_n45_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n154_));
  aoi21  g110(.a(x08), .b(x07), .c(new_n57_), .O(new_n155_));
