...
module FAU ( 
  ...
  oai22  g38(.a(new_n82_), .b(new_n76_), .c(new_n62_), .d(new_n54_), .O(z09));
  ...
  oai21  g50(.a(new_n94_), .b(new_n80_), .c(x21), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(x20), .O(new_n96_));
  inv1   g52(.a(x20), .O(new_n97_));
  nand2  g53(.a(x21), .b(new_n97_), .O(new_n98_));
  aoi21  g54(.a(new_n98_), .b(new_n96_), .c(new_n93_), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n100_));
  oai21  g56(.a(new_n62_), .b(new_n60_), .c(new_n100_), .O(z11));
  nand2  g57(.a(x23), .b(x14), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n80_), .c(x21), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n97_), .c(x22), .O(new_n104_));
  nand3  g60(.a(new_n77_), .b(x21), .c(x20), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n104_), .c(new_n93_), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n107_));
  oai21  g63(.a(new_n62_), .b(new_n64_), .c(new_n107_), .O(z12));
  inv1   g64(.a(x21), .O(new_n109_));
  nand4  g65(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(x23), .c(new_n109_), .O(new_n111_));
  aoi21  g67(.a(x21), .b(x20), .c(new_n78_), .O(new_n112_));
  aoi21  g68(.a(new_n111_), .b(x20), .c(new_n112_), .O(new_n113_));
  nand2  g69(.a(x23), .b(new_n77_), .O(new_n114_));
  oai21  g70(.a(new_n113_), .b(new_n77_), .c(new_n114_), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(x19), .c(new_n47_), .d(x09), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(x08), .c(new_n66_), .O(z13));
  nand2  g73(.a(x21), .b(x20), .O(new_n118_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n85_), .c(x23), .d(x22), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n121_), .c(new_n93_), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n125_));
  oai21  g81(.a(new_n62_), .b(new_n68_), .c(new_n125_), .O(z14));
  ...
  nor2   g87(.a(x25), .b(new_n85_), .O(new_n132_));
  nand3  g88(.a(new_n132_), .b(new_n131_), .c(x23), .O(new_n133_));
  aoi21  g89(.a(new_n133_), .b(new_n130_), .c(new_n93_), .O(new_n134_));
  nand4  g90(.a(new_n134_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n135_));
  oai21  g91(.a(new_n62_), .b(new_n70_), .c(new_n135_), .O(z15));
  inv1   g92(.a(x18), .O(new_n137_));
  nand2  g93(.a(new_n122_), .b(new_n137_), .O(new_n138_));
  nand3  g94(.a(new_n79_), .b(x25), .c(x24), .O(new_n139_));
  oai21  g95(.a(new_n139_), .b(new_n138_), .c(x26), .O(new_n140_));
  nand4  g96(.a(new_n131_), .b(new_n86_), .c(new_n45_), .d(x25), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n140_), .c(new_n93_), .O(new_n142_));
