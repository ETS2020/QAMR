...
module FAU ( 
  ...
  nand2  g40(.a(new_n61_), .b(x01), .O(new_n85_));
  ...
  nand4  g45(.a(new_n89_), .b(new_n46_), .c(x09), .d(new_n78_), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n85_), .O(z10));
  nand3  g47(.a(x23), .b(x22), .c(x13), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n55_), .c(x21), .O(new_n93_));
  nand3  g49(.a(new_n93_), .b(x20), .c(x19), .O(new_n94_));
  nand2  g50(.a(x20), .b(x19), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(x21), .O(new_n96_));
  aoi21  g52(.a(new_n96_), .b(new_n94_), .c(x08), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(x10), .c(x09), .O(new_n98_));
  nand2  g54(.a(x08), .b(x02), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n98_), .O(z11));
  nand2  g56(.a(x23), .b(x14), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n55_), .c(x21), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n95_), .c(x22), .O(new_n103_));
  ...
  nand4  g62(.a(new_n106_), .b(new_n46_), .c(x09), .d(new_n78_), .O(new_n107_));
  ...
  oai21  g66(.a(new_n110_), .b(new_n95_), .c(x23), .O(new_n111_));
  ...
  nand2  g81(.a(new_n125_), .b(new_n124_), .O(z14));
