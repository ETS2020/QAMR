...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    new_n52_, new_n54_, new_n55_, new_n57_, new_n60_, new_n61_, new_n63_,
  ...
  and2   g24(.a(new_n55_), .b(x07), .O(z08));
  ...
  oai21  g65(.a(new_n109_), .b(new_n70_), .c(new_n47_), .O(new_n110_));
  ...
  aoi21  g74(.a(new_n118_), .b(new_n115_), .c(x08), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n70_), .c(new_n47_), .O(new_n120_));
  ...
  nand4  g92(.a(new_n136_), .b(new_n99_), .c(new_n135_), .d(new_n71_), .O(new_n137_));
  aoi21  g93(.a(new_n137_), .b(new_n134_), .c(x08), .O(new_n138_));
  oai21  g94(.a(new_n138_), .b(new_n70_), .c(new_n47_), .O(new_n139_));
