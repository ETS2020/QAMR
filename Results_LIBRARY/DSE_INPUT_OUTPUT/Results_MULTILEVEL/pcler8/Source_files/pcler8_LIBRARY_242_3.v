...
module FAU ( 
  ...
  nand3  g31(.a(new_n76_), .b(new_n52_), .c(new_n49_), .O(z10));
  ...
  nand4  g35(.a(new_n80_), .b(new_n68_), .c(x09), .d(new_n74_), .O(new_n81_));
  nand2  g36(.a(x08), .b(x02), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n81_), .c(new_n48_), .O(z11));
  ...
  nand4  g43(.a(new_n88_), .b(new_n68_), .c(x09), .d(new_n74_), .O(new_n89_));
  aoi21  g44(.a(x08), .b(x03), .c(new_n48_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n89_), .O(z12));
  nand2  g46(.a(new_n84_), .b(x23), .O(new_n92_));
  nand4  g47(.a(new_n46_), .b(x21), .c(x20), .d(x19), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(x22), .O(new_n95_));
  nand2  g50(.a(x23), .b(new_n86_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n68_), .c(x09), .d(new_n74_), .O(new_n98_));
  aoi21  g53(.a(x08), .b(x04), .c(new_n48_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n98_), .O(z13));
  nand3  g55(.a(new_n47_), .b(x23), .c(x22), .O(new_n101_));
  oai22  g56(.a(new_n101_), .b(new_n84_), .c(new_n47_), .d(x23), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n68_), .c(x09), .d(new_n74_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n62_), .O(z14));
  nand2  g59(.a(x08), .b(x06), .O(new_n105_));
  nand3  g60(.a(new_n71_), .b(x25), .c(new_n68_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n49_), .O(z15));
  nand2  g62(.a(x08), .b(x07), .O(new_n108_));
  nand3  g63(.a(new_n71_), .b(x26), .c(new_n68_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n108_), .c(new_n48_), .O(z16));
  zero   g65(.O(z00));
endmodule
