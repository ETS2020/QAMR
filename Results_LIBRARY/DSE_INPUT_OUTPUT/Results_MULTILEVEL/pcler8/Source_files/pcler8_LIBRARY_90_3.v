...
module FAU ( 
  ...
  aoi21  g045(.a(x08), .b(x01), .c(new_n57_), .O(new_n90_));
  ...
  oai21  g050(.a(new_n93_), .b(new_n76_), .c(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n64_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n63_), .O(new_n98_));
  inv1   g054(.a(x09), .O(new_n99_));
  nor2   g055(.a(new_n99_), .b(x08), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n49_), .c(x13), .d(new_n48_), .O(new_n101_));
  inv1   g057(.a(x25), .O(new_n102_));
  nor2   g058(.a(new_n45_), .b(new_n102_), .O(new_n103_));
  inv1   g059(.a(x23), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n46_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n103_), .c(x24), .d(x21), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n101_), .c(new_n98_), .O(z11));
  nand3  g063(.a(x21), .b(x20), .c(x19), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n46_), .b(x21), .O(new_n110_));
  oai22  g066(.a(new_n110_), .b(new_n92_), .c(new_n109_), .d(new_n46_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n66_), .c(new_n57_), .O(z12));
  nand3  g069(.a(new_n48_), .b(x09), .c(new_n47_), .O(new_n114_));
  nand3  g070(.a(new_n103_), .b(x23), .c(x15), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(new_n49_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x24), .O(new_n117_));
  nand2  g073(.a(new_n93_), .b(new_n77_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x23), .O(new_n119_));
  nand3  g075(.a(new_n104_), .b(x22), .c(x21), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n92_), .c(new_n119_), .O(new_n121_));
  ...
  oai21  g082(.a(new_n126_), .b(new_n108_), .c(x24), .O(new_n127_));
  nand4  g083(.a(new_n109_), .b(new_n56_), .c(x23), .d(x22), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n70_), .c(new_n63_), .O(z14));
  nand3  g087(.a(new_n100_), .b(x19), .c(new_n48_), .O(new_n132_));
  nor2   g088(.a(new_n76_), .b(new_n84_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n102_), .c(x23), .d(x22), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n132_), .c(new_n49_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x24), .O(new_n136_));
  nand2  g092(.a(x26), .b(x17), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n105_), .c(x24), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n109_), .c(new_n102_), .O(new_n140_));
  ...
  nand3  g099(.a(new_n93_), .b(new_n100_), .c(new_n48_), .O(new_n144_));
  nand4  g100(.a(new_n77_), .b(new_n45_), .c(x25), .d(x23), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n144_), .c(new_n49_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x24), .O(new_n147_));
  inv1   g103(.a(x18), .O(new_n148_));
  nand3  g104(.a(new_n133_), .b(x19), .c(new_n148_), .O(new_n149_));
  nand3  g105(.a(new_n105_), .b(x25), .c(x24), .O(new_n150_));
  ...
  nand3  g109(.a(new_n153_), .b(new_n147_), .c(new_n74_), .O(z16));
endmodule
