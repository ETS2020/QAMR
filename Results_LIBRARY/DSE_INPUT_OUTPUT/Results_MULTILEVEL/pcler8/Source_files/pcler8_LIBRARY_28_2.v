...
module FAU ( 
  ...
  nor2   g019(.a(new_n58_), .b(new_n63_), .O(z03));
  ...
  nand2  g090(.a(new_n57_), .b(x06), .O(new_n135_));
  nand2  g091(.a(x26), .b(x17), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n114_), .c(x24), .d(x21), .O(new_n137_));
  nand3  g093(.a(new_n84_), .b(x24), .c(x22), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n110_), .O(new_n139_));
  aoi21  g095(.a(new_n137_), .b(x25), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(x25), .b(new_n55_), .O(new_n141_));
  oai21  g097(.a(new_n140_), .b(new_n124_), .c(new_n141_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n135_), .O(z15));
  nand3  g100(.a(new_n77_), .b(x19), .c(new_n47_), .O(new_n145_));
  nor2   g101(.a(x26), .b(new_n84_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(x24), .c(x21), .d(x20), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n145_), .c(x23), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x22), .O(new_n149_));
  nand4  g105(.a(x25), .b(x24), .c(x22), .d(x21), .O(new_n150_));
  nor3   g106(.a(new_n150_), .b(new_n113_), .c(x18), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n45_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n149_), .c(new_n73_), .O(z16));
endmodule
