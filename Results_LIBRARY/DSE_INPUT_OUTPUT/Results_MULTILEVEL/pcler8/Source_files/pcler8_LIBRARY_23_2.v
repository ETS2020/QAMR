...
module FAU ( 
  ...
  nor2   g23(.a(new_n61_), .b(new_n53_), .O(z11));
  oai21  g24(.a(new_n49_), .b(new_n63_), .c(new_n46_), .O(z15));
  nand2  g25(.a(new_n51_), .b(new_n46_), .O(z10));
  nand2  g26(.a(new_n55_), .b(new_n46_), .O(z12));
  nand2  g27(.a(new_n57_), .b(new_n46_), .O(z13));
  nor2   g28(.a(new_n61_), .b(new_n59_), .O(z14));
  nor2   g29(.a(new_n61_), .b(new_n65_), .O(z16));
endmodule
