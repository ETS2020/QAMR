...
module FAU ( 
  ...
  oai21  g047(.a(new_n46_), .b(new_n58_), .c(new_n91_), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n55_), .O(new_n93_));
  ...
  nand2  g077(.a(new_n121_), .b(new_n83_), .O(new_n122_));
  ...
  nand4  g111(.a(new_n45_), .b(x25), .c(x24), .d(x22), .O(new_n156_));
  nor2   g112(.a(new_n156_), .b(new_n123_), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n155_), .c(x23), .O(new_n158_));
  nand3  g114(.a(x26), .b(new_n83_), .c(x17), .O(new_n159_));
