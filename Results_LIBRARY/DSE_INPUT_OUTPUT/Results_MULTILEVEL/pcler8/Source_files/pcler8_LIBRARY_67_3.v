...
module FAU ( 
  ...
  aoi21  g023(.a(new_n47_), .b(new_n46_), .c(new_n54_), .O(z06));
  nand2  g024(.a(new_n63_), .b(x06), .O(new_n69_));
  ...
  inv1   g036(.a(new_n63_), .O(new_n81_));
  ...
  oai21  g043(.a(new_n81_), .b(new_n59_), .c(new_n87_), .O(z10));
  ...
  oai21  g053(.a(new_n81_), .b(new_n61_), .c(new_n97_), .O(z11));
  ...
  nand2  g084(.a(new_n128_), .b(new_n120_), .O(z14));
  ...
  aoi21  g094(.a(x08), .b(x06), .c(new_n55_), .O(new_n139_));
