...
module FAU ( 
  ...
  nand2  g040(.a(x08), .b(x01), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n58_), .O(new_n87_));
  inv1   g043(.a(x09), .O(new_n88_));
  nand3  g044(.a(x19), .b(new_n49_), .c(x12), .O(new_n89_));
  nor4   g045(.a(new_n89_), .b(x10), .c(new_n88_), .d(x08), .O(new_n90_));
  and2   g046(.a(x23), .b(x22), .O(new_n91_));
  nand3  g047(.a(x26), .b(x25), .c(x24), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n91_), .c(new_n90_), .d(x21), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n87_), .O(z10));
  inv1   g051(.a(x21), .O(new_n96_));
  nand3  g052(.a(x23), .b(x22), .c(x13), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n92_), .c(x21), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(x20), .c(x19), .O(new_n99_));
  and2   g055(.a(x20), .b(x19), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n96_), .c(new_n99_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n64_), .c(new_n58_), .O(z11));
  nor2   g059(.a(new_n88_), .b(x08), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(x14), .c(new_n48_), .O(new_n105_));
  nand3  g061(.a(new_n78_), .b(x24), .c(x22), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n105_), .c(new_n49_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x23), .O(new_n108_));
  nand3  g064(.a(x21), .b(x20), .c(x19), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand3  g066(.a(new_n100_), .b(new_n46_), .c(x21), .O(new_n111_));
  oai21  g067(.a(new_n110_), .b(new_n46_), .c(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n108_), .c(new_n66_), .O(z12));
  nand2  g070(.a(new_n61_), .b(x04), .O(new_n115_));
  nand4  g071(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n100_), .c(x22), .d(x21), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x23), .c(new_n49_), .O(new_n118_));
  nand4  g074(.a(new_n100_), .b(new_n56_), .c(x22), .d(x21), .O(new_n119_));
  ...
  nand3  g078(.a(new_n104_), .b(x19), .c(new_n48_), .O(new_n123_));
  inv1   g079(.a(x24), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(x22), .c(x21), .d(x20), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n123_), .c(new_n49_), .O(new_n126_));
  ...
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(new_n127_), .O(z14));
  nand2  g090(.a(x26), .b(x17), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(x24), .c(x22), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n109_), .c(x25), .O(new_n137_));
  nand4  g093(.a(new_n110_), .b(new_n91_), .c(new_n77_), .d(x24), .O(new_n138_));
  ...
  nand2  g099(.a(new_n143_), .b(new_n72_), .O(z15));
  nand2  g100(.a(new_n61_), .b(x07), .O(new_n145_));
  nand3  g101(.a(x25), .b(x24), .c(x22), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n109_), .c(x26), .O(new_n147_));
  nand3  g103(.a(new_n100_), .b(x22), .c(x21), .O(new_n148_));
  ...
  nand2  g110(.a(new_n154_), .b(new_n145_), .O(z16));
endmodule
