...
module FAU ( 
  ...
  nand2  g009(.a(x10), .b(x07), .O(new_n54_));
  ...
  nand3  g026(.a(new_n47_), .b(x08), .c(x07), .O(new_n71_));
  inv1   g027(.a(new_n71_), .O(z08));
  nand2  g028(.a(x10), .b(x07), .O(new_n73_));
  nand3  g029(.a(new_n73_), .b(x08), .c(x00), .O(new_n74_));
  ...
  nand3  g037(.a(new_n81_), .b(new_n74_), .c(new_n54_), .O(z09));
  ...
  nand2  g064(.a(new_n58_), .b(x04), .O(new_n109_));
  ...
  nand2  g072(.a(x23), .b(new_n76_), .O(new_n117_));
  ...
  nor2   g086(.a(new_n130_), .b(new_n76_), .O(new_n131_));
  ...
  oai21  g095(.a(x10), .b(x08), .c(x07), .O(new_n140_));
