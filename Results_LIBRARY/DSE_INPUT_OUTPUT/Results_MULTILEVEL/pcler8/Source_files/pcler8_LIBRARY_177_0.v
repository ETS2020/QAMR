...
module FAU ( 
  ...
  nor2   g13(.a(x10), .b(x09), .O(new_n58_));
  ...
  nand2  g25(.a(new_n69_), .b(new_n63_), .O(z05));
  nand2  g26(.a(x08), .b(x05), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(new_n63_), .O(z06));
  inv1   g28(.a(x06), .O(new_n73_));
  oai21  g29(.a(new_n57_), .b(new_n73_), .c(new_n63_), .O(z07));
  inv1   g30(.a(x07), .O(new_n75_));
  oai21  g31(.a(new_n57_), .b(new_n75_), .c(new_n63_), .O(z08));
  ...
  aoi21  g37(.a(new_n81_), .b(new_n57_), .c(new_n77_), .O(new_n82_));
  nand2  g38(.a(x08), .b(x00), .O(new_n83_));
  oai21  g39(.a(new_n82_), .b(x10), .c(new_n83_), .O(z09));
  ...
  oai21  g44(.a(new_n47_), .b(x19), .c(new_n88_), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n85_), .c(x09), .d(new_n57_), .O(new_n90_));
  ...
  nor2   g50(.a(new_n48_), .b(x20), .O(new_n95_));
  ...
  nand4  g54(.a(new_n98_), .b(new_n85_), .c(x09), .d(new_n57_), .O(new_n99_));
  ...
  nand3  g61(.a(new_n105_), .b(new_n50_), .c(x21), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n85_), .c(x09), .d(new_n57_), .O(new_n108_));
  ...
  nand4  g68(.a(new_n105_), .b(new_n51_), .c(x22), .d(x21), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n112_), .c(x08), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n77_), .c(new_n85_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n69_), .O(z13));
  ...
  aoi21  g79(.a(new_n123_), .b(new_n120_), .c(x08), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n77_), .c(new_n85_), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n71_), .O(z14));
  ...
  nand4  g86(.a(new_n122_), .b(new_n52_), .c(new_n130_), .d(x24), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n85_), .c(x09), .d(new_n57_), .O(new_n133_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n105_), .c(new_n139_), .d(new_n78_), .O(new_n141_));
  nand2  g97(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand4  g98(.a(new_n142_), .b(new_n85_), .c(x09), .d(new_n57_), .O(new_n143_));
  oai21  g99(.a(new_n67_), .b(new_n75_), .c(new_n143_), .O(z16));
endmodule
