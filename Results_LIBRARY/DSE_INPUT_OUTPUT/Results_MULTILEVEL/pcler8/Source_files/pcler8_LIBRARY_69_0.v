...
module FAU ( 
  ...
  and2   g28(.a(new_n62_), .b(x06), .O(z07));
  and2   g29(.a(new_n62_), .b(x07), .O(z08));
  inv1   g30(.a(x09), .O(new_n75_));
  nor2   g31(.a(new_n50_), .b(new_n48_), .O(new_n76_));
  ...
  aoi21  g35(.a(new_n79_), .b(new_n61_), .c(new_n75_), .O(new_n80_));
  oai21  g36(.a(new_n80_), .b(x10), .c(new_n59_), .O(z09));
  inv1   g37(.a(x10), .O(new_n82_));
  nand3  g38(.a(x22), .b(x21), .c(x12), .O(new_n83_));
  oai21  g39(.a(new_n83_), .b(new_n78_), .c(x20), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(x19), .O(new_n85_));
  oai21  g41(.a(new_n47_), .b(x19), .c(new_n85_), .O(new_n86_));
  nand4  g42(.a(new_n86_), .b(new_n82_), .c(x09), .d(new_n61_), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n63_), .O(z10));
  nand2  g44(.a(new_n62_), .b(x02), .O(new_n89_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n82_), .c(x09), .d(new_n61_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n89_), .O(z11));
  ...
  oai21  g60(.a(new_n104_), .b(new_n75_), .c(new_n82_), .O(new_n105_));
  ...
  oai21  g67(.a(new_n111_), .b(new_n75_), .c(new_n82_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n69_), .O(z13));
  nand2  g69(.a(new_n62_), .b(x05), .O(new_n114_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n82_), .c(x09), .d(new_n61_), .O(new_n123_));
  ...
  oai21  g86(.a(new_n130_), .b(new_n75_), .c(new_n82_), .O(new_n131_));
  ...
  oai21  g97(.a(new_n141_), .b(new_n75_), .c(new_n82_), .O(new_n142_));
