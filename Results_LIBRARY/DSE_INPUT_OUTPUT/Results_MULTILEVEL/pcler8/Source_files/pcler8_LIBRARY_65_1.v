...
module FAU ( 
  ...
  nand2  g019(.a(new_n63_), .b(new_n60_), .O(z05));
  ...
  aoi21  g033(.a(x08), .b(x00), .c(new_n55_), .O(new_n78_));
  ...
  oai21  g039(.a(new_n71_), .b(x19), .c(new_n83_), .O(new_n84_));
  ...
  nand2  g060(.a(new_n104_), .b(new_n61_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n60_), .O(new_n106_));
  inv1   g062(.a(x09), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(x08), .O(new_n108_));
  inv1   g064(.a(x23), .O(new_n109_));
  nor3   g065(.a(new_n81_), .b(new_n109_), .c(new_n98_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n108_), .c(x14), .d(new_n47_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n106_), .O(z12));
  nand2  g068(.a(new_n56_), .b(x04), .O(new_n113_));
  nor2   g069(.a(new_n73_), .b(new_n98_), .O(new_n114_));
  ...
  nand4  g073(.a(new_n100_), .b(new_n54_), .c(new_n109_), .d(x22), .O(new_n118_));
  ...
  oai21  g079(.a(new_n123_), .b(new_n101_), .c(x24), .O(new_n124_));
  inv1   g080(.a(new_n101_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n54_), .c(x22), .d(x21), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n124_), .c(new_n109_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n128_));
  oai21  g084(.a(new_n66_), .b(new_n65_), .c(new_n128_), .O(z14));
  nand3  g085(.a(new_n108_), .b(x19), .c(new_n47_), .O(new_n130_));
  inv1   g086(.a(x25), .O(new_n131_));
  nand3  g087(.a(new_n73_), .b(new_n131_), .c(x22), .O(new_n132_));
  ...
  aoi21  g093(.a(new_n137_), .b(new_n100_), .c(new_n131_), .O(new_n138_));
  ...
  nor2   g097(.a(new_n101_), .b(x18), .O(new_n142_));
  ...
  nand4  g101(.a(new_n45_), .b(x25), .c(x24), .d(x22), .O(new_n146_));
  ...
  nand2  g107(.a(new_n151_), .b(new_n69_), .O(z16));
endmodule
