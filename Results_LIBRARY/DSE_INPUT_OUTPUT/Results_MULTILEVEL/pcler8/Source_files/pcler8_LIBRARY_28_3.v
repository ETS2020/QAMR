...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_,
    ...
    new_n93_, new_n95_, new_n96_, new_n98_, new_n100_;
  ...
  nand2  g41(.a(new_n47_), .b(x21), .O(new_n87_));
  oai21  g42(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n58_), .c(new_n53_), .O(z12));
  nand3  g45(.a(new_n48_), .b(x22), .c(x21), .O(new_n91_));
  oai22  g46(.a(new_n91_), .b(new_n86_), .c(new_n48_), .d(x22), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n60_), .O(z13));
  nand2  g49(.a(x08), .b(x05), .O(new_n95_));
  nand3  g50(.a(new_n72_), .b(x24), .c(new_n69_), .O(new_n96_));
  aoi21  g51(.a(new_n96_), .b(new_n95_), .c(new_n49_), .O(z14));
  nand3  g52(.a(new_n72_), .b(x25), .c(new_n69_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n64_), .c(new_n49_), .O(z15));
  nand3  g54(.a(new_n72_), .b(x26), .c(new_n69_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n66_), .c(new_n53_), .O(z16));
  zero   g56(.O(z00));
endmodule
