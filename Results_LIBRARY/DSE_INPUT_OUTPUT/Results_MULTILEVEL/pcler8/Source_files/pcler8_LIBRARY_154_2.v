...
module FAU ( 
  ...
  oai21  g050(.a(new_n93_), .b(new_n75_), .c(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n96_));
  oai21  g052(.a(new_n46_), .b(new_n62_), .c(new_n96_), .O(new_n97_));
  ...
  nand2  g059(.a(new_n79_), .b(x24), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n55_), .c(new_n103_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n102_), .c(new_n100_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n98_), .O(z11));
  nand3  g063(.a(x21), .b(x20), .c(x19), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n103_), .b(x21), .O(new_n110_));
  oai22  g066(.a(new_n110_), .b(new_n92_), .c(new_n109_), .d(new_n103_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n112_));
  oai21  g068(.a(new_n46_), .b(new_n64_), .c(new_n112_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n57_), .O(new_n114_));
  nand4  g070(.a(new_n105_), .b(new_n100_), .c(x14), .d(new_n47_), .O(new_n115_));
  ...
  nand3  g094(.a(new_n100_), .b(x19), .c(new_n47_), .O(new_n139_));
  ...
  nor3   g099(.a(new_n143_), .b(new_n92_), .c(x18), .O(new_n144_));
