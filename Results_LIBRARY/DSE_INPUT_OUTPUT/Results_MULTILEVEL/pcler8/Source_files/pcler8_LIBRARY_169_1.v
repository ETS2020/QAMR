...
module FAU ( 
  ...
  oai21  g14(.a(new_n58_), .b(new_n52_), .c(new_n46_), .O(z00));
  ...
  nand4  g68(.a(new_n51_), .b(new_n54_), .c(x22), .d(x21), .O(new_n113_));
  ...
  oai21  g81(.a(new_n63_), .b(new_n71_), .c(new_n125_), .O(z14));
  ...
  oai21  g89(.a(new_n63_), .b(new_n73_), .c(new_n133_), .O(z15));
  ...
  oai21  g99(.a(new_n63_), .b(new_n75_), .c(new_n143_), .O(z16));
endmodule
