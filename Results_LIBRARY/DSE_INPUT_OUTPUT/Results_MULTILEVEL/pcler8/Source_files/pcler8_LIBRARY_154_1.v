...
module FAU ( 
  ...
  nor3   g056(.a(new_n82_), .b(new_n100_), .c(new_n99_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n98_), .c(new_n96_), .O(new_n102_));
  ...
  oai22  g062(.a(new_n106_), .b(new_n88_), .c(new_n105_), .d(new_n99_), .O(new_n107_));
  ...
  nand2  g066(.a(new_n110_), .b(new_n58_), .O(new_n111_));
  nand4  g067(.a(new_n101_), .b(new_n96_), .c(x14), .d(new_n47_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(z12));
  nand3  g069(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n114_));
  nor2   g070(.a(new_n99_), .b(new_n73_), .O(new_n115_));
  nand2  g071(.a(new_n89_), .b(new_n115_), .O(new_n116_));
  ...
  oai22  g076(.a(new_n120_), .b(new_n119_), .c(new_n105_), .d(new_n100_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x22), .O(new_n122_));
  nand2  g078(.a(x23), .b(new_n99_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n118_), .c(new_n65_), .O(z13));
  nand3  g082(.a(x26), .b(x25), .c(x16), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x22), .c(x21), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n88_), .c(x24), .O(new_n129_));
  nand4  g085(.a(new_n89_), .b(new_n54_), .c(x22), .d(x21), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n129_), .c(new_n100_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n132_));
  oai21  g088(.a(new_n62_), .b(new_n67_), .c(new_n132_), .O(z14));
  nand2  g089(.a(new_n56_), .b(x06), .O(new_n134_));
  nand2  g090(.a(x26), .b(x17), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n89_), .c(x22), .d(x21), .O(new_n136_));
  inv1   g092(.a(x25), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(x24), .c(x22), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n104_), .O(new_n139_));
  aoi21  g095(.a(new_n136_), .b(x25), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(x25), .b(new_n54_), .O(new_n141_));
  oai21  g097(.a(new_n140_), .b(new_n100_), .c(new_n141_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n134_), .O(z15));
  nand3  g100(.a(new_n96_), .b(x19), .c(new_n47_), .O(new_n145_));
  nand4  g101(.a(new_n74_), .b(new_n45_), .c(x25), .d(x22), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n145_), .c(x23), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x24), .O(new_n148_));
  nor2   g104(.a(new_n88_), .b(x18), .O(new_n149_));
