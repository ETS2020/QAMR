...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n62_, new_n63_, new_n65_, new_n67_, new_n68_, new_n70_,
  ...
  inv1   g013(.a(x23), .O(new_n58_));
  nand2  g014(.a(new_n58_), .b(x22), .O(new_n59_));
  nand2  g015(.a(new_n59_), .b(x08), .O(new_n60_));
  nor2   g016(.a(new_n60_), .b(new_n57_), .O(z01));
  nand2  g017(.a(x08), .b(x01), .O(new_n62_));
  and2   g018(.a(new_n62_), .b(new_n59_), .O(new_n63_));
  inv1   g019(.a(new_n63_), .O(z02));
  inv1   g020(.a(x02), .O(new_n65_));
  nor2   g021(.a(new_n60_), .b(new_n65_), .O(z03));
  nand2  g022(.a(x08), .b(x03), .O(new_n67_));
  and2   g023(.a(new_n67_), .b(new_n59_), .O(new_n68_));
  inv1   g024(.a(new_n68_), .O(z04));
  inv1   g025(.a(x04), .O(new_n70_));
  nor2   g026(.a(new_n60_), .b(new_n70_), .O(z05));
  nand2  g027(.a(x08), .b(x05), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n59_), .O(z06));
  nand2  g029(.a(x08), .b(x06), .O(new_n74_));
  nand2  g030(.a(new_n74_), .b(new_n59_), .O(z07));
  inv1   g031(.a(x07), .O(new_n76_));
  nor2   g032(.a(new_n60_), .b(new_n76_), .O(z08));
  nand2  g033(.a(new_n52_), .b(x11), .O(new_n78_));
  nand4  g034(.a(x26), .b(x25), .c(x24), .d(x22), .O(new_n79_));
  ...
  aoi21  g038(.a(x08), .b(x00), .c(new_n82_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n81_), .O(z09));
  nand3  g040(.a(x22), .b(x21), .c(x12), .O(new_n85_));
  oai21  g041(.a(new_n85_), .b(new_n53_), .c(x20), .O(new_n86_));
  ...
  nand2  g045(.a(new_n89_), .b(new_n63_), .O(z10));
  ...
  aoi21  g054(.a(x08), .b(x02), .c(new_n82_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n98_), .O(z11));
  nor2   g056(.a(new_n50_), .b(new_n91_), .O(new_n101_));
  ...
  nand3  g060(.a(new_n101_), .b(new_n45_), .c(x21), .O(new_n105_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n101_), .c(new_n118_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n121_), .c(new_n72_), .O(z14));
  inv1   g083(.a(x25), .O(new_n128_));
  nand3  g084(.a(new_n52_), .b(new_n128_), .c(x24), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n48_), .c(x23), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x22), .O(new_n131_));
  nand2  g087(.a(new_n52_), .b(x19), .O(new_n132_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n133_), .c(new_n128_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n131_), .c(new_n74_), .O(z15));
  inv1   g095(.a(x26), .O(new_n140_));
  nand4  g096(.a(new_n52_), .b(new_n140_), .c(x25), .d(x24), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n48_), .c(x23), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x22), .O(new_n143_));
  nor3   g099(.a(new_n50_), .b(new_n91_), .c(x18), .O(new_n144_));
  ...
  nand3  g105(.a(new_n149_), .b(new_n148_), .c(new_n143_), .O(z16));
endmodule
