...
module FAU ( 
  ...
  oai21  g039(.a(new_n77_), .b(new_n57_), .c(new_n83_), .O(z09));
  nand2  g040(.a(new_n76_), .b(x01), .O(new_n85_));
  ...
  nand4  g045(.a(new_n89_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n85_), .O(z10));
  nand2  g047(.a(new_n76_), .b(x02), .O(new_n92_));
  nand3  g048(.a(x23), .b(x22), .c(x13), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n53_), .c(x21), .O(new_n94_));
  nor2   g050(.a(new_n48_), .b(x20), .O(new_n95_));
  aoi21  g051(.a(new_n94_), .b(x20), .c(new_n95_), .O(new_n96_));
  nand2  g052(.a(x21), .b(new_n45_), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n45_), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n99_));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n105_), .c(x08), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n101_), .c(new_n78_), .O(new_n109_));
  ...
  nand4  g071(.a(new_n115_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n116_));
  oai21  g072(.a(new_n77_), .b(new_n68_), .c(new_n116_), .O(z13));
  ...
  nand4  g081(.a(new_n125_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n126_));
  oai21  g082(.a(new_n77_), .b(new_n70_), .c(new_n126_), .O(z14));
  ...
  oai21  g089(.a(new_n133_), .b(new_n101_), .c(new_n78_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n72_), .O(z15));
  nand2  g091(.a(new_n76_), .b(x07), .O(new_n136_));
  nor2   g092(.a(new_n45_), .b(x18), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n49_), .O(new_n138_));
  nand3  g094(.a(new_n52_), .b(x25), .c(x24), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n138_), .c(x26), .O(new_n140_));
  nor2   g096(.a(new_n122_), .b(new_n51_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n131_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n106_), .c(new_n141_), .d(new_n79_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n136_), .O(z16));
endmodule
