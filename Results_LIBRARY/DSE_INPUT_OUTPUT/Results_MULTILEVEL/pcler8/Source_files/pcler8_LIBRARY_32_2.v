...
module FAU ( 
  ...
  nand3  g070(.a(new_n114_), .b(new_n66_), .c(new_n59_), .O(z13));
  ...
  nand4  g085(.a(new_n121_), .b(new_n129_), .c(new_n55_), .d(x24), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n132_));
  oai21  g088(.a(new_n57_), .b(new_n70_), .c(new_n132_), .O(z15));
  nand2  g089(.a(x26), .b(x09), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(x08), .c(new_n47_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n55_), .O(new_n136_));
  nor2   g092(.a(new_n120_), .b(new_n111_), .O(new_n137_));
  nor2   g093(.a(new_n99_), .b(x18), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n137_), .c(new_n75_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x26), .O(new_n140_));
  nor2   g096(.a(x26), .b(new_n55_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n103_), .c(new_n137_), .d(new_n75_), .O(new_n142_));
  ...
  nand3  g101(.a(new_n145_), .b(new_n144_), .c(new_n136_), .O(z16));
endmodule
