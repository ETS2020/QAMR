...
module FAU ( 
  ...
  nand2  g012(.a(new_n49_), .b(x06), .O(new_n57_));
  ...
  oai21  g027(.a(new_n48_), .b(new_n71_), .c(new_n57_), .O(z08));
  ...
  aoi21  g064(.a(new_n108_), .b(new_n48_), .c(x06), .O(new_n109_));
  oai22  g065(.a(new_n109_), .b(x10), .c(new_n48_), .d(new_n64_), .O(z12));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n48_), .c(x06), .O(new_n127_));
