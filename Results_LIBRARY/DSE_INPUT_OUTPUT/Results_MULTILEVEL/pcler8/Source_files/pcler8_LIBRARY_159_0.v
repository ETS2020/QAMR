...
module FAU ( 
  ...
  nor2   g39(.a(new_n83_), .b(x19), .O(new_n84_));
  aoi21  g40(.a(new_n82_), .b(x19), .c(new_n84_), .O(new_n85_));
  oai21  g41(.a(new_n85_), .b(x08), .c(x09), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n47_), .O(new_n87_));
  oai21  g43(.a(new_n46_), .b(new_n59_), .c(new_n87_), .O(z10));
  inv1   g44(.a(x19), .O(new_n89_));
  nand3  g45(.a(x23), .b(x22), .c(x13), .O(new_n90_));
  nand3  g46(.a(x26), .b(x25), .c(x24), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n90_), .c(x21), .O(new_n92_));
  nor2   g48(.a(new_n73_), .b(x20), .O(new_n93_));
  aoi21  g49(.a(new_n92_), .b(x20), .c(new_n93_), .O(new_n94_));
  nand2  g50(.a(x21), .b(new_n89_), .O(new_n95_));
  oai21  g51(.a(new_n94_), .b(new_n89_), .c(new_n95_), .O(new_n96_));
  aoi21  g52(.a(new_n96_), .b(new_n46_), .c(new_n55_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(x10), .c(new_n61_), .O(z11));
  ...
  nand3  g59(.a(new_n103_), .b(new_n74_), .c(x21), .O(new_n104_));
  ...
  oai21  g69(.a(new_n113_), .b(new_n55_), .c(new_n47_), .O(new_n114_));
  oai21  g70(.a(new_n46_), .b(new_n65_), .c(new_n114_), .O(z13));
  ...
  oai21  g80(.a(new_n57_), .b(new_n67_), .c(new_n124_), .O(z14));
  nor2   g81(.a(new_n111_), .b(new_n74_), .O(new_n126_));
  ...
  oai21  g98(.a(new_n142_), .b(new_n55_), .c(new_n47_), .O(new_n143_));
