...
module FAU ( 
  ...
  aoi21  g034(.a(x08), .b(x00), .c(new_n56_), .O(new_n79_));
  ...
  nand2  g038(.a(x08), .b(x01), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n62_), .O(new_n85_));
  nand3  g041(.a(new_n48_), .b(x09), .c(new_n47_), .O(new_n86_));
  nand3  g042(.a(x19), .b(new_n49_), .c(x12), .O(new_n87_));
  nor2   g043(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  and2   g044(.a(x23), .b(x22), .O(new_n89_));
  ...
  nand3  g055(.a(new_n99_), .b(new_n63_), .c(new_n62_), .O(z11));
  nand2  g056(.a(x23), .b(x14), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n90_), .c(x21), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n95_), .c(x22), .O(new_n103_));
  nand3  g059(.a(new_n96_), .b(new_n46_), .c(x21), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n65_), .c(new_n62_), .O(z12));
  ...
  nand4  g075(.a(new_n119_), .b(new_n96_), .c(x23), .d(x21), .O(new_n120_));
  ...
  nand2  g080(.a(x24), .b(new_n46_), .O(new_n125_));
  oai21  g081(.a(new_n124_), .b(x13), .c(new_n125_), .O(new_n126_));
  ...
  inv1   g087(.a(new_n111_), .O(new_n132_));
  nor2   g088(.a(x25), .b(new_n121_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(new_n89_), .O(new_n134_));
  ...
  nor2   g096(.a(new_n95_), .b(x18), .O(new_n141_));
  ...
  oai21  g103(.a(new_n147_), .b(new_n144_), .c(new_n49_), .O(new_n148_));
  nand2  g104(.a(x26), .b(new_n46_), .O(new_n149_));
