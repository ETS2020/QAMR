...
module FAU ( 
  ...
  nand2  g009(.a(x11), .b(x10), .O(new_n54_));
  ...
  nand2  g014(.a(new_n54_), .b(x08), .O(new_n59_));
  ...
  nand2  g020(.a(new_n60_), .b(x04), .O(new_n65_));
  ...
  nand3  g035(.a(new_n79_), .b(new_n55_), .c(new_n54_), .O(z09));
  ...
  nand3  g042(.a(new_n86_), .b(new_n57_), .c(new_n54_), .O(z10));
  ...
  inv1   g052(.a(new_n54_), .O(new_n97_));
  aoi21  g053(.a(x08), .b(x02), .c(new_n97_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n96_), .O(z11));
  ...
  nand3  g063(.a(new_n107_), .b(new_n63_), .c(new_n54_), .O(z12));
  ...
  aoi21  g071(.a(x08), .b(x04), .c(new_n97_), .O(new_n116_));
  ...
  oai21  g101(.a(new_n59_), .b(new_n71_), .c(new_n145_), .O(z16));
endmodule
