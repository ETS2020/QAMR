...
module FAU ( 
  ...
  and2   g018(.a(new_n60_), .b(x03), .O(z04));
  and2   g019(.a(new_n60_), .b(x04), .O(z05));
  and2   g020(.a(new_n60_), .b(x05), .O(z06));
  inv1   g021(.a(x06), .O(new_n66_));
  inv1   g022(.a(new_n60_), .O(new_n67_));
  nor2   g023(.a(new_n67_), .b(new_n66_), .O(z07));
  ...
  oai21  g033(.a(new_n67_), .b(new_n54_), .c(new_n77_), .O(z09));
  nand2  g034(.a(new_n60_), .b(x01), .O(new_n79_));
  ...
  aoi21  g060(.a(x08), .b(x03), .c(new_n55_), .O(new_n105_));
  ...
  nand4  g066(.a(new_n97_), .b(new_n110_), .c(x22), .d(x21), .O(new_n111_));
  ...
  nor2   g073(.a(new_n110_), .b(new_n72_), .O(new_n118_));
  ...
  oai21  g093(.a(new_n67_), .b(new_n66_), .c(new_n137_), .O(z15));
  ...
  nand4  g103(.a(new_n147_), .b(new_n97_), .c(new_n146_), .d(new_n73_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n141_), .c(new_n69_), .O(z16));
endmodule
