...
module FAU ( 
  ...
  nand4  g034(.a(new_n75_), .b(x20), .c(x11), .d(new_n47_), .O(new_n79_));
  ...
  oai21  g041(.a(new_n85_), .b(new_n79_), .c(new_n78_), .O(z09));
  ...
  aoi21  g049(.a(x08), .b(x01), .c(new_n55_), .O(new_n94_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n84_), .c(new_n82_), .d(new_n75_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n103_), .O(z11));
  nand3  g063(.a(x21), .b(x20), .c(x19), .O(new_n108_));
  oai21  g064(.a(new_n81_), .b(x22), .c(new_n108_), .O(new_n109_));
  nand3  g065(.a(new_n98_), .b(new_n80_), .c(x21), .O(new_n110_));
  nand3  g066(.a(new_n84_), .b(new_n82_), .c(x14), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n113_));
  aoi21  g069(.a(x08), .b(x03), .c(new_n55_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n113_), .O(z12));
  nand3  g071(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x23), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n80_), .O(new_n118_));
  nand4  g074(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  aoi21  g076(.a(new_n108_), .b(x22), .c(new_n120_), .O(new_n121_));
  nand3  g077(.a(new_n98_), .b(new_n81_), .c(x21), .O(new_n122_));
  oai21  g078(.a(new_n121_), .b(new_n81_), .c(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n124_));
  nand2  g080(.a(x08), .b(x04), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n124_), .c(new_n118_), .O(z13));
  nand3  g082(.a(new_n75_), .b(x24), .c(new_n47_), .O(new_n127_));
  ...
  nand3  g093(.a(new_n137_), .b(new_n129_), .c(new_n67_), .O(z14));
  nand3  g094(.a(new_n75_), .b(x25), .c(new_n47_), .O(new_n139_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n108_), .c(x25), .O(new_n144_));
  inv1   g100(.a(x25), .O(new_n145_));
  nand4  g101(.a(new_n134_), .b(new_n82_), .c(new_n145_), .d(x24), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n141_), .c(new_n69_), .O(z15));
  nand3  g105(.a(new_n75_), .b(x26), .c(new_n47_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x23), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n80_), .O(new_n152_));
  inv1   g108(.a(x18), .O(new_n153_));
  nand2  g109(.a(new_n98_), .b(new_n153_), .O(new_n154_));
  nand4  g110(.a(x25), .b(x24), .c(x23), .d(x21), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n154_), .c(x26), .O(new_n156_));
  nor2   g112(.a(new_n80_), .b(new_n96_), .O(new_n157_));
  nor2   g113(.a(new_n133_), .b(new_n81_), .O(new_n158_));
  nor2   g114(.a(x26), .b(new_n145_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n98_), .c(new_n158_), .d(new_n157_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n152_), .c(new_n71_), .O(z16));
endmodule
