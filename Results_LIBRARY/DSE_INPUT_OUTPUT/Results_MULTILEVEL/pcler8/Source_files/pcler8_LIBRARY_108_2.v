...
module FAU ( 
  ...
  and2   g023(.a(new_n67_), .b(x05), .O(z06));
  nand2  g024(.a(new_n67_), .b(x06), .O(new_n69_));
  ...
  oai21  g037(.a(new_n46_), .b(new_n59_), .c(new_n81_), .O(new_n82_));
  ...
  nand2  g050(.a(new_n94_), .b(new_n83_), .O(z10));
  ...
  oai21  g061(.a(new_n105_), .b(new_n99_), .c(x22), .O(new_n106_));
  nand2  g062(.a(new_n88_), .b(x21), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n99_), .c(new_n106_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n63_), .c(new_n56_), .O(z12));
  nand2  g066(.a(new_n67_), .b(x04), .O(new_n111_));
  ...
  nor2   g072(.a(new_n99_), .b(x18), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n89_), .c(x22), .d(x21), .O(new_n118_));
  ...
  nand2  g078(.a(new_n122_), .b(new_n54_), .O(new_n123_));
  ...
  nor2   g083(.a(x24), .b(new_n89_), .O(new_n128_));
  ...
  nand3  g091(.a(new_n74_), .b(x24), .c(x22), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n112_), .O(new_n137_));
  aoi21  g093(.a(new_n135_), .b(x25), .c(new_n137_), .O(new_n138_));
  nand3  g094(.a(x25), .b(new_n89_), .c(new_n54_), .O(new_n139_));
  oai21  g095(.a(new_n138_), .b(new_n89_), .c(new_n139_), .O(new_n140_));
  ...
  oai22  g100(.a(new_n144_), .b(new_n112_), .c(new_n45_), .d(new_n54_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x23), .O(new_n146_));
  nand4  g102(.a(new_n113_), .b(new_n90_), .c(x25), .d(x24), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(x26), .c(new_n54_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n143_), .O(z16));
endmodule
