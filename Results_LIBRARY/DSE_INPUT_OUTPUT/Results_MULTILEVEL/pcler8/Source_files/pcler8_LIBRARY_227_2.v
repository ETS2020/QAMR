...
module FAU ( 
  ...
  oai21  g21(.a(new_n66_), .b(new_n50_), .c(new_n57_), .O(z10));
  oai21  g22(.a(new_n66_), .b(new_n60_), .c(new_n57_), .O(z14));
  oai21  g23(.a(new_n66_), .b(new_n62_), .c(new_n57_), .O(z15));
  zero   g24(.O(z00));
  nor2   g25(.a(new_n48_), .b(new_n46_), .O(z09));
  nor2   g26(.a(new_n48_), .b(new_n52_), .O(z11));
  nor2   g27(.a(new_n48_), .b(new_n54_), .O(z12));
  nand2  g28(.a(new_n58_), .b(new_n57_), .O(z13));
