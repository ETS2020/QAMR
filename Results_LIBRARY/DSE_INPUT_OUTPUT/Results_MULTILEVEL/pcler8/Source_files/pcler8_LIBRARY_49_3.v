...
module FAU ( 
  ...
  nand2  g013(.a(new_n57_), .b(new_n55_), .O(z02));
  nand2  g014(.a(x08), .b(x02), .O(new_n59_));
  nand2  g015(.a(new_n59_), .b(new_n55_), .O(z03));
  ...
  nand2  g022(.a(new_n62_), .b(x05), .O(new_n67_));
  ...
  oai21  g072(.a(new_n61_), .b(new_n65_), .c(new_n116_), .O(z13));
