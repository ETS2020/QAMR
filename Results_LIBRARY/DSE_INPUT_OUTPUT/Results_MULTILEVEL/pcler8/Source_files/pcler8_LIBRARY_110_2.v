...
module FAU ( 
  ...
  aoi21  g011(.a(x08), .b(x00), .c(new_n55_), .O(new_n56_));
  ...
  nand2  g038(.a(new_n82_), .b(new_n56_), .O(z09));
  ...
  oai21  g043(.a(new_n74_), .b(x19), .c(new_n87_), .O(new_n88_));
  ...
  inv1   g078(.a(new_n114_), .O(new_n123_));
  ...
  nand3  g084(.a(new_n76_), .b(new_n78_), .c(x23), .O(new_n129_));
  ...
  nand3  g101(.a(new_n145_), .b(new_n140_), .c(new_n72_), .O(z16));
endmodule
