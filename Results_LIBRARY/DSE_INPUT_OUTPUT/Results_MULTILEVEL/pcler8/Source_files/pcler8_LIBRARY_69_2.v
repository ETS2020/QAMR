...
module FAU ( 
  ...
  oai21  g24(.a(new_n55_), .b(new_n63_), .c(new_n46_), .O(z15));
  oai21  g25(.a(new_n55_), .b(new_n65_), .c(new_n46_), .O(z16));
  nand2  g26(.a(new_n48_), .b(new_n46_), .O(z09));
  nor2   g27(.a(new_n52_), .b(new_n50_), .O(z10));
  nand2  g28(.a(new_n57_), .b(new_n46_), .O(z12));
  nand2  g29(.a(new_n59_), .b(new_n46_), .O(z13));
endmodule
