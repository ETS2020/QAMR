...
module FAU ( 
  ...
  oai21  g033(.a(new_n68_), .b(new_n54_), .c(new_n77_), .O(z09));
  ...
  oai21  g040(.a(new_n68_), .b(new_n58_), .c(new_n84_), .O(z10));
  ...
  nand2  g050(.a(new_n94_), .b(new_n60_), .O(z11));
  ...
  oai21  g059(.a(new_n68_), .b(new_n62_), .c(new_n103_), .O(z12));
  ...
  oai21  g079(.a(new_n68_), .b(new_n67_), .c(new_n123_), .O(z14));
  ...
  nand4  g096(.a(new_n140_), .b(new_n100_), .c(new_n139_), .d(new_n73_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n138_), .c(x08), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n86_), .c(new_n47_), .O(new_n143_));
