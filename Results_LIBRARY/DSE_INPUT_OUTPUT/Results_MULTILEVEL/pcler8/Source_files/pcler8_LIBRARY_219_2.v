...
module FAU ( 
  ...
  nand2  g021(.a(new_n65_), .b(new_n60_), .O(z04));
  ...
  nand2  g027(.a(new_n71_), .b(new_n60_), .O(z07));
  ...
  nand3  g051(.a(new_n95_), .b(new_n87_), .c(new_n77_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n93_), .O(z10));
  xnor2a g053(.a(x21), .b(x20), .O(new_n98_));
  nand2  g054(.a(x21), .b(new_n75_), .O(new_n99_));
  ...
  nand3  g061(.a(x23), .b(x22), .c(x20), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n86_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n105_), .c(new_n77_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n103_), .O(z11));
  nand3  g065(.a(x21), .b(x20), .c(x19), .O(new_n110_));
  and2   g066(.a(x24), .b(x14), .O(new_n111_));
  aoi22  g067(.a(new_n111_), .b(new_n85_), .c(new_n110_), .d(x23), .O(new_n112_));
  nand2  g068(.a(x20), .b(x19), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n55_), .c(x21), .O(new_n115_));
  oai21  g071(.a(new_n112_), .b(new_n55_), .c(new_n115_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n65_), .c(new_n60_), .O(z12));
  inv1   g074(.a(new_n110_), .O(new_n119_));
  nand3  g075(.a(new_n85_), .b(x24), .c(x15), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n119_), .c(x22), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(x23), .c(new_n47_), .d(x09), .O(new_n122_));
  oai22  g078(.a(new_n122_), .b(x08), .c(new_n58_), .d(new_n67_), .O(z13));
  inv1   g079(.a(x23), .O(new_n124_));
  nand3  g080(.a(x26), .b(x25), .c(x16), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n114_), .c(x21), .O(new_n126_));
  inv1   g082(.a(x24), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x22), .c(x21), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(new_n113_), .O(new_n129_));
  aoi21  g085(.a(new_n126_), .b(x24), .c(new_n129_), .O(new_n130_));
  nand2  g086(.a(x24), .b(new_n55_), .O(new_n131_));
  oai21  g087(.a(new_n130_), .b(new_n124_), .c(new_n131_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n69_), .O(z14));
  nand3  g090(.a(new_n77_), .b(x19), .c(new_n47_), .O(new_n135_));
  nand4  g091(.a(new_n84_), .b(x24), .c(x21), .d(x20), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n135_), .c(x23), .O(new_n137_));
  ...
  nor2   g105(.a(new_n149_), .b(new_n110_), .O(new_n150_));
