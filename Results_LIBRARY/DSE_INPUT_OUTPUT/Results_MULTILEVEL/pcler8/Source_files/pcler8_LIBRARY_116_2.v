...
module FAU ( 
  ...
  nor2   g009(.a(x20), .b(new_n47_), .O(new_n54_));
  ...
  inv1   g018(.a(new_n54_), .O(new_n63_));
  oai21  g019(.a(new_n46_), .b(new_n62_), .c(new_n63_), .O(z04));
  nand2  g020(.a(x08), .b(x04), .O(new_n65_));
  nand2  g021(.a(new_n65_), .b(new_n63_), .O(z05));
  and2   g022(.a(new_n55_), .b(x05), .O(z06));
  inv1   g023(.a(x06), .O(new_n68_));
  oai21  g024(.a(new_n46_), .b(new_n68_), .c(new_n63_), .O(z07));
  ...
  nand3  g041(.a(new_n85_), .b(x20), .c(new_n47_), .O(new_n86_));
  ...
  nand2  g046(.a(new_n90_), .b(new_n57_), .O(z10));
  ...
  oai21  g055(.a(new_n60_), .b(new_n59_), .c(new_n99_), .O(z11));
  ...
  nand2  g073(.a(x23), .b(new_n73_), .O(new_n118_));
  ...
  nand2  g077(.a(x24), .b(x09), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(x08), .c(new_n47_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n87_), .O(new_n124_));
  nand2  g080(.a(x21), .b(x19), .O(new_n125_));
  ...
  inv1   g084(.a(new_n114_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n77_), .c(x23), .d(x22), .O(new_n130_));
  ...
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(new_n124_), .O(z14));
  nor2   g090(.a(new_n76_), .b(new_n73_), .O(new_n135_));
  nand2  g091(.a(x26), .b(x17), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n135_), .c(x24), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n114_), .c(x25), .O(new_n138_));
  ...
  oai21  g098(.a(new_n60_), .b(new_n68_), .c(new_n142_), .O(z15));
  nand2  g099(.a(x26), .b(x09), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(x08), .c(new_n47_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n87_), .O(new_n146_));
  or2    g102(.a(new_n125_), .b(x18), .O(new_n147_));
  nand3  g103(.a(new_n135_), .b(x25), .c(x24), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n147_), .c(x26), .O(new_n149_));
  nor2   g105(.a(x26), .b(new_n139_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n105_), .c(new_n78_), .d(new_n74_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n146_), .c(new_n70_), .O(z16));
endmodule
