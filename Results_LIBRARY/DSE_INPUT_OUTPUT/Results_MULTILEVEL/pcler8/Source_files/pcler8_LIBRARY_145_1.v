...
module FAU ( 
  ...
  and2   g19(.a(new_n63_), .b(new_n46_), .O(new_n64_));
  ...
  nand2  g26(.a(new_n46_), .b(x08), .O(new_n71_));
  nor2   g27(.a(new_n71_), .b(new_n70_), .O(z06));
  inv1   g28(.a(x06), .O(new_n73_));
  nor2   g29(.a(new_n71_), .b(new_n73_), .O(z07));
  inv1   g30(.a(x07), .O(new_n75_));
  nor2   g31(.a(new_n71_), .b(new_n75_), .O(z08));
  ...
  oai21  g38(.a(new_n71_), .b(new_n59_), .c(new_n82_), .O(z09));
  ...
  nand3  g46(.a(new_n90_), .b(new_n61_), .c(new_n46_), .O(z10));
  nand3  g47(.a(x23), .b(x22), .c(x13), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n55_), .c(x21), .O(new_n93_));
  nor2   g49(.a(new_n77_), .b(x20), .O(new_n94_));
  aoi21  g50(.a(new_n93_), .b(x20), .c(new_n94_), .O(new_n95_));
  nand2  g51(.a(x21), .b(new_n87_), .O(new_n96_));
  oai21  g52(.a(new_n95_), .b(new_n87_), .c(new_n96_), .O(new_n97_));
  ...
  oai21  g61(.a(new_n71_), .b(new_n66_), .c(new_n105_), .O(z12));
  ...
  inv1   g86(.a(new_n46_), .O(new_n131_));
  aoi21  g87(.a(x08), .b(x06), .c(new_n131_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n130_), .O(z15));
  ...
  nor2   g93(.a(new_n118_), .b(new_n53_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n127_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n138_), .c(new_n78_), .d(new_n50_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n142_));
  aoi21  g98(.a(x08), .b(x07), .c(new_n131_), .O(new_n143_));
