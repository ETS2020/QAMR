...
module FAU ( 
  ...
  nor2   g10(.a(new_n47_), .b(x09), .O(new_n55_));
  ...
  and2   g21(.a(new_n58_), .b(x04), .O(z05));
  inv1   g22(.a(x05), .O(new_n67_));
  nor2   g23(.a(new_n64_), .b(new_n67_), .O(z06));
  inv1   g24(.a(x06), .O(new_n69_));
  oai21  g25(.a(new_n46_), .b(new_n69_), .c(new_n56_), .O(z07));
  inv1   g26(.a(x07), .O(new_n71_));
  nor2   g27(.a(new_n64_), .b(new_n71_), .O(z08));
  ...
  oai21  g35(.a(new_n64_), .b(new_n54_), .c(new_n79_), .O(z09));
  inv1   g36(.a(x20), .O(new_n81_));
  nand3  g37(.a(x22), .b(x21), .c(x12), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(new_n77_), .c(x20), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(x19), .O(new_n84_));
  oai21  g40(.a(new_n81_), .b(x19), .c(new_n84_), .O(new_n85_));
  ...
  oai21  g46(.a(new_n90_), .b(new_n89_), .c(x21), .O(new_n91_));
  nor2   g47(.a(new_n73_), .b(x20), .O(new_n92_));
  aoi21  g48(.a(new_n91_), .b(x20), .c(new_n92_), .O(new_n93_));
  nand2  g49(.a(x21), .b(new_n88_), .O(new_n94_));
  oai21  g50(.a(new_n93_), .b(new_n88_), .c(new_n94_), .O(new_n95_));
  ...
  oai21  g55(.a(new_n99_), .b(new_n90_), .c(x21), .O(new_n100_));
  ...
  oai21  g61(.a(new_n64_), .b(new_n63_), .c(new_n105_), .O(z12));
  ...
  aoi21  g69(.a(x08), .b(x04), .c(new_n55_), .O(new_n114_));
  ...
  oai21  g80(.a(new_n64_), .b(new_n67_), .c(new_n124_), .O(z14));
  ...
  nor2   g85(.a(new_n110_), .b(new_n74_), .O(new_n130_));
  ...
  oai21  g89(.a(new_n64_), .b(new_n69_), .c(new_n133_), .O(z15));
  ...
  nor2   g94(.a(new_n120_), .b(new_n110_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n129_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n102_), .c(new_n139_), .d(new_n75_), .O(new_n141_));
  nand2  g97(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand4  g98(.a(new_n142_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n143_));
  oai21  g99(.a(new_n64_), .b(new_n71_), .c(new_n143_), .O(z16));
endmodule
