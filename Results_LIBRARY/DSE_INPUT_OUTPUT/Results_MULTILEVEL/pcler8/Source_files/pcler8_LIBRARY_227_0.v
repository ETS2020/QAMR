...
module FAU ( 
  ...
  nand2  g011(.a(new_n47_), .b(new_n55_), .O(new_n56_));
  ...
  oai21  g037(.a(new_n81_), .b(new_n77_), .c(x20), .O(new_n82_));
  inv1   g038(.a(x20), .O(new_n83_));
  nor2   g039(.a(new_n83_), .b(x19), .O(new_n84_));
  aoi21  g040(.a(new_n82_), .b(x19), .c(new_n84_), .O(new_n85_));
  oai21  g041(.a(new_n85_), .b(x08), .c(x09), .O(new_n86_));
  ...
  oai21  g062(.a(new_n57_), .b(new_n63_), .c(new_n106_), .O(z12));
  ...
  oai21  g069(.a(new_n113_), .b(new_n55_), .c(new_n47_), .O(new_n114_));
  ...
  oai21  g079(.a(new_n123_), .b(new_n55_), .c(new_n47_), .O(new_n124_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n55_), .c(new_n47_), .O(new_n134_));
  ...
  oai21  g100(.a(new_n144_), .b(new_n55_), .c(new_n47_), .O(new_n145_));
