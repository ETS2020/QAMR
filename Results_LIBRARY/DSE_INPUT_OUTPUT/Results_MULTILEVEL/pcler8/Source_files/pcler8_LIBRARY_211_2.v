...
module FAU ( 
  ...
  nand2  g14(.a(new_n58_), .b(x04), .O(new_n59_));
  ...
  aoi21  g24(.a(x10), .b(new_n68_), .c(new_n45_), .O(z05));
  nand2  g25(.a(x08), .b(x05), .O(new_n70_));
  nand2  g26(.a(new_n70_), .b(new_n59_), .O(z06));
  inv1   g27(.a(x06), .O(new_n72_));
  oai21  g28(.a(new_n68_), .b(new_n72_), .c(new_n59_), .O(z07));
  inv1   g29(.a(x07), .O(new_n74_));
  oai21  g30(.a(new_n68_), .b(new_n74_), .c(new_n59_), .O(z08));
  ...
  nand4  g35(.a(new_n79_), .b(new_n58_), .c(x09), .d(new_n68_), .O(new_n80_));
  oai22  g36(.a(new_n80_), .b(x04), .c(new_n60_), .d(new_n57_), .O(z09));
  ...
  nand4  g43(.a(new_n87_), .b(x09), .c(new_n68_), .d(new_n45_), .O(new_n88_));
  oai21  g44(.a(new_n60_), .b(new_n62_), .c(new_n88_), .O(z10));
  nand3  g45(.a(x23), .b(x22), .c(x13), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n53_), .c(x21), .O(new_n91_));
  nand3  g47(.a(new_n91_), .b(x20), .c(x19), .O(new_n92_));
  nand2  g48(.a(x20), .b(x19), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(x21), .O(new_n94_));
  aoi21  g50(.a(new_n94_), .b(new_n92_), .c(new_n46_), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n68_), .c(x04), .O(new_n96_));
  nand2  g52(.a(x08), .b(x02), .O(new_n97_));
  oai21  g53(.a(new_n96_), .b(x10), .c(new_n97_), .O(z11));
  nand3  g54(.a(new_n59_), .b(x08), .c(x03), .O(new_n99_));
  nand2  g55(.a(x23), .b(x14), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n53_), .c(x21), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n93_), .c(x22), .O(new_n102_));
  ...
  nand4  g61(.a(new_n105_), .b(x09), .c(new_n68_), .d(new_n45_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n99_), .O(z12));
  inv1   g63(.a(z05), .O(new_n108_));
  ...
  nand4  g67(.a(new_n103_), .b(new_n51_), .c(x22), .d(x21), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(new_n58_), .c(x09), .d(new_n68_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n108_), .O(z13));
  ...
  aoi21  g76(.a(new_n120_), .b(new_n118_), .c(new_n46_), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n68_), .c(x04), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(x10), .c(new_n70_), .O(z14));
  ...
  aoi21  g84(.a(new_n128_), .b(new_n126_), .c(x10), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(x09), .c(new_n68_), .d(new_n45_), .O(new_n130_));
  oai21  g86(.a(new_n60_), .b(new_n72_), .c(new_n130_), .O(z15));
  ...
  nand4  g93(.a(new_n137_), .b(new_n103_), .c(new_n136_), .d(new_n76_), .O(new_n138_));
  aoi21  g94(.a(new_n138_), .b(new_n135_), .c(x10), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(x09), .c(new_n68_), .d(new_n45_), .O(new_n140_));
  oai21  g96(.a(new_n60_), .b(new_n74_), .c(new_n140_), .O(z16));
endmodule
