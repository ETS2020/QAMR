...
module FAU ( 
  ...
  nand4  g051(.a(new_n95_), .b(x14), .c(new_n48_), .d(x09), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(x08), .c(new_n63_), .O(z11));
  inv1   g053(.a(x09), .O(new_n98_));
  nand2  g054(.a(x20), .b(x19), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n76_), .c(x21), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(x22), .O(new_n102_));
  nand3  g058(.a(new_n100_), .b(new_n46_), .c(x21), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n102_), .c(new_n98_), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n47_), .c(new_n80_), .O(new_n105_));
  ...
  nand4  g066(.a(new_n100_), .b(new_n110_), .c(x22), .d(x21), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n109_), .c(new_n80_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n113_));
  oai21  g069(.a(new_n61_), .b(new_n67_), .c(new_n113_), .O(z13));
  ...
  aoi21  g077(.a(new_n121_), .b(new_n118_), .c(new_n80_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n123_));
  oai21  g079(.a(new_n61_), .b(new_n69_), .c(new_n123_), .O(z14));
  ...
  nor2   g084(.a(new_n110_), .b(new_n46_), .O(new_n129_));
  nand4  g085(.a(new_n120_), .b(new_n129_), .c(new_n128_), .d(x24), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n127_), .c(new_n98_), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n47_), .c(new_n80_), .O(new_n132_));
  ...
  nor2   g094(.a(new_n119_), .b(new_n110_), .O(new_n139_));
  nor2   g095(.a(x26), .b(new_n128_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n100_), .c(new_n139_), .d(new_n74_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n138_), .c(new_n98_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n47_), .c(new_n80_), .O(new_n143_));
