...
module FAU ( 
  ...
  inv1   g045(.a(new_n71_), .O(new_n90_));
  ...
  nand3  g049(.a(new_n93_), .b(x25), .c(x20), .O(new_n94_));
  oai21  g050(.a(x20), .b(new_n74_), .c(new_n94_), .O(new_n95_));
  ...
  nand2  g054(.a(x22), .b(x13), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n92_), .c(x21), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(x20), .c(x19), .O(new_n101_));
  nor2   g057(.a(new_n54_), .b(new_n74_), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n98_), .c(new_n101_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n61_), .c(new_n56_), .O(z11));
  nand4  g061(.a(x26), .b(x24), .c(x23), .d(x14), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x21), .c(x19), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(x25), .c(new_n54_), .O(new_n108_));
  nand4  g064(.a(new_n102_), .b(x25), .c(new_n82_), .d(x21), .O(new_n109_));
  oai21  g065(.a(new_n108_), .b(new_n82_), .c(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n111_));
  oai21  g067(.a(new_n90_), .b(new_n63_), .c(new_n111_), .O(z12));
  nand3  g068(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n113_));
  nand2  g069(.a(x21), .b(x19), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n83_), .c(x22), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n113_), .c(x25), .O(new_n117_));
  ...
  aoi21  g077(.a(new_n121_), .b(new_n102_), .c(new_n83_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n118_), .c(new_n65_), .O(z13));
  nand2  g080(.a(new_n71_), .b(x05), .O(new_n125_));
  inv1   g081(.a(x24), .O(new_n126_));
  nand2  g082(.a(x26), .b(x16), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n115_), .c(x23), .d(x22), .O(new_n128_));
  ...
  oai21  g094(.a(new_n138_), .b(x08), .c(new_n69_), .O(z15));
  nor2   g095(.a(new_n114_), .b(x18), .O(new_n140_));
