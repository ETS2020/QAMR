...
module FAU ( 
  ...
  nand3  g036(.a(new_n80_), .b(new_n56_), .c(new_n55_), .O(z09));
  ...
  nand3  g053(.a(new_n97_), .b(new_n62_), .c(new_n55_), .O(z11));
  ...
  oai21  g062(.a(new_n60_), .b(new_n64_), .c(new_n106_), .O(z12));
  ...
  nand3  g103(.a(new_n147_), .b(new_n72_), .c(new_n55_), .O(z16));
endmodule
