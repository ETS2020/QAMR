...
module FAU ( 
  ...
  oai21  g020(.a(new_n48_), .b(new_n64_), .c(new_n47_), .O(z02));
  inv1   g021(.a(x02), .O(new_n66_));
  oai21  g022(.a(new_n48_), .b(new_n66_), .c(new_n47_), .O(z03));
  ...
  oai21  g037(.a(new_n62_), .b(new_n60_), .c(new_n81_), .O(z09));
  ...
  oai21  g043(.a(new_n62_), .b(new_n64_), .c(new_n87_), .O(z10));
  ...
  oai21  g051(.a(new_n62_), .b(new_n66_), .c(new_n95_), .O(z11));
  inv1   g052(.a(new_n51_), .O(new_n97_));
  ...
  nand3  g056(.a(new_n51_), .b(new_n53_), .c(x21), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n68_), .c(new_n47_), .O(z12));
  nand2  g060(.a(new_n61_), .b(x04), .O(new_n105_));
  ...
  aoi21  g080(.a(x08), .b(x05), .c(new_n46_), .O(new_n125_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n109_), .c(x25), .O(new_n129_));
  ...
  nand3  g089(.a(new_n133_), .b(new_n73_), .c(new_n47_), .O(z15));
