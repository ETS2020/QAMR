...
module FAU ( 
  ...
  nor2   g009(.a(x26), .b(x09), .O(new_n54_));
  ...
  oai21  g027(.a(new_n46_), .b(new_n71_), .c(new_n55_), .O(z08));
  ...
  oai21  g042(.a(new_n61_), .b(new_n58_), .c(new_n86_), .O(z10));
  ...
  oai21  g052(.a(new_n61_), .b(new_n60_), .c(new_n96_), .O(z11));
  ...
  oai21  g061(.a(new_n61_), .b(new_n63_), .c(new_n105_), .O(z12));
  ...
  aoi21  g072(.a(x08), .b(x04), .c(new_n54_), .O(new_n117_));
  ...
  aoi21  g082(.a(x08), .b(x05), .c(new_n54_), .O(new_n127_));
  ...
  nand3  g093(.a(new_n137_), .b(new_n69_), .c(new_n55_), .O(z15));
  ...
  oai21  g103(.a(new_n61_), .b(new_n71_), .c(new_n147_), .O(z16));
endmodule
