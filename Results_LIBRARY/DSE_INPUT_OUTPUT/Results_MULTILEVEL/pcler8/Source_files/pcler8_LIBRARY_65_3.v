...
module FAU ( 
  ...
  aoi21  g38(.a(x08), .b(x02), .c(new_n49_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n83_), .O(z11));
  nand2  g40(.a(new_n50_), .b(x03), .O(new_n86_));
  nand2  g41(.a(x24), .b(x23), .O(new_n87_));
  nand3  g42(.a(x21), .b(x20), .c(x19), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(x22), .O(new_n89_));
  inv1   g44(.a(x22), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(x21), .c(x20), .d(x19), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n87_), .c(new_n74_), .d(x09), .O(new_n93_));
  oai21  g48(.a(new_n93_), .b(x08), .c(new_n86_), .O(z12));
  nand2  g49(.a(new_n50_), .b(x04), .O(new_n95_));
  nand2  g50(.a(x20), .b(x19), .O(new_n96_));
  nand4  g51(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n48_), .c(x23), .O(new_n98_));
  nand3  g53(.a(new_n47_), .b(x22), .c(x21), .O(new_n99_));
  oai21  g54(.a(new_n99_), .b(new_n96_), .c(new_n98_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n95_), .O(z13));
  nand3  g57(.a(new_n48_), .b(x23), .c(x22), .O(new_n103_));
  oai22  g58(.a(new_n103_), .b(new_n88_), .c(new_n48_), .d(x23), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n62_), .O(z14));
  nand2  g61(.a(x08), .b(x06), .O(new_n107_));
  nand3  g62(.a(new_n70_), .b(x25), .c(new_n74_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n57_), .O(z15));
  nand2  g64(.a(x08), .b(x07), .O(new_n110_));
  nand3  g65(.a(new_n70_), .b(x26), .c(new_n74_), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n110_), .c(new_n49_), .O(z16));
  zero   g67(.O(z00));
endmodule
