...
module FAU ( 
  ...
  nor2   g022(.a(new_n48_), .b(new_n66_), .O(z03));
  ...
  oai21  g038(.a(new_n62_), .b(new_n60_), .c(new_n82_), .O(z09));
  ...
  oai21  g044(.a(new_n62_), .b(new_n64_), .c(new_n88_), .O(z10));
  ...
  oai21  g052(.a(new_n48_), .b(new_n66_), .c(new_n96_), .O(z11));
  ...
  oai21  g060(.a(new_n62_), .b(new_n68_), .c(new_n104_), .O(z12));
  ...
  oai21  g081(.a(new_n62_), .b(new_n72_), .c(new_n125_), .O(z14));
  ...
  aoi21  g089(.a(x08), .b(x06), .c(new_n46_), .O(new_n134_));
  ...
  oai21  g100(.a(new_n62_), .b(new_n75_), .c(new_n144_), .O(z16));
endmodule
