...
module FAU ( 
  ...
  oai21  g036(.a(new_n80_), .b(x10), .c(new_n56_), .O(z09));
  ...
  nand2  g063(.a(new_n61_), .b(x04), .O(new_n108_));
  ...
  oai21  g083(.a(new_n62_), .b(new_n68_), .c(new_n127_), .O(z14));
  ...
  oai21  g093(.a(new_n62_), .b(new_n70_), .c(new_n137_), .O(z15));
