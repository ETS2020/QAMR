...
module FAU ( 
  ...
  nand3  g006(.a(x26), .b(x23), .c(x22), .O(new_n51_));
  nor3   g007(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n52_));
  nand4  g008(.a(new_n52_), .b(new_n48_), .c(x19), .d(new_n46_), .O(new_n53_));
  aoi21  g009(.a(new_n53_), .b(x25), .c(new_n45_), .O(z00));
  nor2   g010(.a(x25), .b(new_n45_), .O(new_n55_));
  ...
  oai21  g024(.a(new_n68_), .b(new_n67_), .c(new_n56_), .O(z06));
  inv1   g025(.a(x06), .O(new_n70_));
  nand2  g026(.a(new_n56_), .b(x08), .O(new_n71_));
  nor2   g027(.a(new_n71_), .b(new_n70_), .O(z07));
  nand2  g028(.a(x08), .b(x07), .O(new_n73_));
  nand2  g029(.a(new_n73_), .b(new_n56_), .O(z08));
  ...
  nand3  g036(.a(x23), .b(x22), .c(x21), .O(new_n81_));
  nand3  g037(.a(x26), .b(x25), .c(x24), .O(new_n82_));
  nor2   g038(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand3  g039(.a(new_n83_), .b(new_n80_), .c(new_n48_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n78_), .O(z09));
  xor2a  g041(.a(x20), .b(x19), .O(new_n86_));
  nand4  g042(.a(new_n86_), .b(new_n46_), .c(x09), .d(new_n68_), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n59_), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(new_n56_), .O(new_n89_));
  nand2  g045(.a(x19), .b(x12), .O(new_n90_));
  nor2   g046(.a(new_n90_), .b(x10), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n83_), .c(new_n48_), .O(new_n92_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n46_), .c(x09), .d(new_n68_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n61_), .c(new_n56_), .O(z11));
  nand3  g058(.a(new_n46_), .b(x09), .c(new_n68_), .O(new_n103_));
  ...
  nand2  g065(.a(new_n107_), .b(x21), .O(new_n110_));
  oai22  g066(.a(new_n110_), .b(new_n98_), .c(new_n109_), .d(new_n107_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n46_), .c(x09), .d(new_n68_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n106_), .c(new_n63_), .O(z12));
  ...
  oai21  g073(.a(new_n117_), .b(new_n98_), .c(new_n115_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n46_), .c(x09), .d(new_n68_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n65_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n56_), .O(new_n121_));
  nand3  g077(.a(new_n48_), .b(x15), .c(new_n46_), .O(new_n122_));
  nand4  g078(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(z13));
  nand2  g080(.a(x26), .b(x16), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x23), .c(x22), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n108_), .c(x25), .O(new_n127_));
  nand4  g083(.a(new_n109_), .b(new_n45_), .c(x23), .d(x22), .O(new_n128_));
  oai21  g084(.a(new_n127_), .b(new_n45_), .c(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n46_), .c(x09), .d(new_n68_), .O(new_n130_));
  oai21  g086(.a(new_n71_), .b(new_n67_), .c(new_n130_), .O(z14));
  aoi21  g087(.a(x26), .b(x17), .c(new_n45_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n109_), .c(x23), .d(x22), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(x25), .c(new_n46_), .d(x09), .O(new_n134_));
  oai22  g090(.a(new_n134_), .b(x08), .c(new_n71_), .d(new_n70_), .O(z15));
  nand3  g091(.a(new_n56_), .b(x08), .c(x07), .O(new_n136_));
  inv1   g092(.a(x26), .O(new_n137_));
  inv1   g093(.a(new_n81_), .O(new_n138_));
  nor2   g094(.a(new_n98_), .b(x18), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n138_), .c(new_n137_), .O(new_n140_));
  nand4  g096(.a(new_n137_), .b(x24), .c(x23), .d(x22), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n108_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n140_), .c(x25), .O(new_n143_));
  nand2  g099(.a(x26), .b(new_n45_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n46_), .c(x09), .d(new_n68_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n136_), .O(z16));
endmodule
