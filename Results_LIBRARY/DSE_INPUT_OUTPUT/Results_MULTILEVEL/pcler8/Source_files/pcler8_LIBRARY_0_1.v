...
module FAU ( 
  ...
  nor2   g19(.a(new_n46_), .b(new_n48_), .O(new_n64_));
  and2   g20(.a(new_n64_), .b(x02), .O(z03));
  inv1   g21(.a(x03), .O(new_n66_));
  oai21  g22(.a(new_n48_), .b(new_n66_), .c(new_n47_), .O(z04));
  nand2  g23(.a(new_n64_), .b(x04), .O(new_n68_));
  inv1   g24(.a(new_n68_), .O(z05));
  and2   g25(.a(new_n64_), .b(x05), .O(z06));
  nand2  g26(.a(x08), .b(x06), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(new_n47_), .O(z07));
  inv1   g28(.a(x07), .O(new_n73_));
  oai21  g29(.a(new_n48_), .b(new_n73_), .c(new_n47_), .O(z08));
  inv1   g30(.a(new_n64_), .O(new_n75_));
  ...
  oai21  g37(.a(new_n75_), .b(new_n60_), .c(new_n81_), .O(z09));
  ...
  nand2  g52(.a(new_n96_), .b(new_n95_), .O(z11));
  ...
  oai21  g60(.a(new_n75_), .b(new_n66_), .c(new_n104_), .O(z12));
  ...
  nand2  g71(.a(new_n115_), .b(new_n68_), .O(z13));
  ...
  aoi21  g80(.a(x08), .b(x05), .c(new_n46_), .O(new_n125_));
  ...
  oai21  g84(.a(new_n128_), .b(new_n109_), .c(x25), .O(new_n129_));
  inv1   g85(.a(x25), .O(new_n130_));
  nand4  g86(.a(new_n121_), .b(new_n55_), .c(new_n130_), .d(x24), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n133_));
  nand3  g89(.a(new_n133_), .b(new_n71_), .c(new_n47_), .O(z15));
  ...
  oai21  g99(.a(new_n75_), .b(new_n73_), .c(new_n143_), .O(z16));
endmodule
