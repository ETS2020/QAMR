...
module FAU ( 
  ...
  nand2  g056(.a(new_n100_), .b(new_n63_), .O(new_n101_));
  ...
  nand3  g090(.a(new_n76_), .b(x19), .c(new_n47_), .O(new_n135_));
  nand4  g091(.a(new_n83_), .b(x24), .c(x21), .d(x20), .O(new_n136_));
  ...
  aoi21  g097(.a(new_n141_), .b(new_n119_), .c(new_n83_), .O(new_n142_));
  ...
  nor2   g101(.a(new_n109_), .b(x18), .O(new_n146_));
  nand3  g102(.a(x25), .b(x24), .c(x21), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n146_), .c(new_n45_), .O(new_n149_));
  nand4  g105(.a(new_n45_), .b(x25), .c(x24), .d(x22), .O(new_n150_));
  nor2   g106(.a(new_n150_), .b(new_n118_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n149_), .c(x23), .O(new_n152_));
  nand2  g108(.a(x26), .b(new_n54_), .O(new_n153_));
