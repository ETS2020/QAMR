...
module FAU ( 
  ...
  nor4   g038(.a(new_n82_), .b(new_n81_), .c(new_n55_), .d(new_n80_), .O(new_n83_));
  ...
  nand3  g058(.a(new_n102_), .b(new_n98_), .c(x21), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(x23), .c(x22), .O(new_n104_));
  nand3  g060(.a(new_n98_), .b(new_n55_), .c(x21), .O(new_n105_));
  ...
  nand2  g064(.a(x26), .b(x25), .O(new_n109_));
  nand3  g065(.a(x21), .b(x20), .c(x19), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand2  g067(.a(x24), .b(x15), .O(new_n112_));
  oai22  g068(.a(new_n112_), .b(new_n109_), .c(new_n111_), .d(new_n81_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x22), .O(new_n114_));
  oai21  g070(.a(new_n81_), .b(x22), .c(new_n114_), .O(new_n115_));
  ...
  nand3  g076(.a(new_n120_), .b(new_n98_), .c(x21), .O(new_n121_));
  inv1   g077(.a(x24), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x22), .c(x21), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n97_), .O(new_n124_));
  aoi21  g080(.a(new_n121_), .b(x24), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(x24), .b(new_n55_), .O(new_n126_));
  oai21  g082(.a(new_n125_), .b(new_n81_), .c(new_n126_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n119_), .O(z14));
  nand3  g085(.a(new_n75_), .b(x19), .c(new_n47_), .O(new_n130_));
  inv1   g086(.a(x25), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(x24), .c(x21), .d(x20), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(x23), .O(new_n133_));
  ...
  aoi21  g093(.a(new_n137_), .b(new_n111_), .c(new_n131_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n134_), .c(new_n70_), .O(z15));
  nor2   g096(.a(new_n97_), .b(x18), .O(new_n141_));
  nand3  g097(.a(x25), .b(x24), .c(x21), .O(new_n142_));
  ...
  nor2   g101(.a(new_n145_), .b(new_n110_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n144_), .c(x23), .O(new_n147_));
  nand2  g103(.a(x26), .b(new_n55_), .O(new_n148_));
