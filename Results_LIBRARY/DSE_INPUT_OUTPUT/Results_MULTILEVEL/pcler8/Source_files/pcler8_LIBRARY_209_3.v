...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n49_, new_n51_, new_n53_, new_n55_, new_n57_,
    ...
    new_n108_, new_n110_;
  nand2  g00(.a(x25), .b(x23), .O(new_n45_));
  ...
  nand3  g12(.a(new_n45_), .b(x08), .c(x05), .O(new_n57_));
  ...
  nand4  g50(.a(x19), .b(new_n63_), .c(x09), .d(new_n69_), .O(new_n95_));
  inv1   g51(.a(x24), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(x22), .c(x21), .d(x20), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n95_), .c(new_n94_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(x23), .O(new_n99_));
  nand3  g55(.a(x23), .b(x22), .c(x21), .O(new_n100_));
  nor2   g56(.a(new_n100_), .b(new_n81_), .O(new_n101_));
  nor2   g57(.a(new_n101_), .b(new_n96_), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(new_n63_), .c(x09), .d(new_n69_), .O(new_n103_));
  nand2  g59(.a(x08), .b(x05), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n103_), .c(new_n99_), .O(z14));
  nand3  g61(.a(x24), .b(x23), .c(x22), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n79_), .c(new_n94_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n63_), .c(x09), .d(new_n69_), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(new_n59_), .c(new_n45_), .O(z15));
  nand3  g65(.a(new_n66_), .b(x26), .c(new_n63_), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(new_n61_), .c(new_n45_), .O(z16));
endmodule
