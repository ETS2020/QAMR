...
module FAU ( 
  ...
  oai21  g19(.a(new_n46_), .b(new_n62_), .c(new_n63_), .O(z04));
  and2   g20(.a(new_n56_), .b(x04), .O(z05));
  inv1   g21(.a(x05), .O(new_n66_));
  nor2   g22(.a(new_n57_), .b(new_n66_), .O(z06));
  nand2  g23(.a(x08), .b(x06), .O(new_n68_));
  nand2  g24(.a(new_n68_), .b(new_n63_), .O(z07));
  nand2  g25(.a(x08), .b(x07), .O(new_n70_));
  nand2  g26(.a(new_n70_), .b(new_n63_), .O(z08));
