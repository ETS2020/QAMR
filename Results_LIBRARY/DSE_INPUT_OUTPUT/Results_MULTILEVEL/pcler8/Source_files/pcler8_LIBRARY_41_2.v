...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n52_, new_n54_, new_n56_,
    new_n57_, new_n58_, new_n60_, new_n61_, new_n63_, new_n65_;
  ...
  oai21  g16(.a(new_n61_), .b(new_n60_), .c(new_n57_), .O(z06));
  ...
  oai21  g21(.a(new_n61_), .b(new_n46_), .c(new_n57_), .O(z09));
  oai21  g22(.a(new_n61_), .b(new_n52_), .c(new_n57_), .O(z11));
  oai21  g23(.a(new_n61_), .b(new_n54_), .c(new_n57_), .O(z12));
  nor2   g24(.a(new_n48_), .b(new_n60_), .O(z14));
  zero   g25(.O(z00));
