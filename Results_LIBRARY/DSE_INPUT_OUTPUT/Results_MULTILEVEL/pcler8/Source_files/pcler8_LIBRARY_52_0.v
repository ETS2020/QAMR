...
module FAU ( 
  ...
  nand2  g018(.a(new_n59_), .b(x03), .O(new_n63_));
  ...
  oai21  g053(.a(new_n97_), .b(new_n73_), .c(x21), .O(new_n98_));
  nand3  g054(.a(new_n81_), .b(x20), .c(x19), .O(new_n99_));
  ...
  nor2   g062(.a(x22), .b(new_n81_), .O(new_n107_));
  and2   g063(.a(x22), .b(x14), .O(new_n108_));
  aoi22  g064(.a(new_n108_), .b(new_n104_), .c(new_n107_), .d(new_n106_), .O(new_n109_));
  nand3  g065(.a(x21), .b(x20), .c(x19), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x22), .O(new_n111_));
  oai21  g067(.a(new_n109_), .b(new_n83_), .c(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n63_), .O(z12));
  ...
  nand4  g074(.a(new_n106_), .b(new_n83_), .c(x22), .d(x21), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n121_));
  oai21  g077(.a(new_n60_), .b(new_n65_), .c(new_n121_), .O(z13));
  nand2  g078(.a(new_n59_), .b(x05), .O(new_n123_));
  nand2  g079(.a(x24), .b(new_n82_), .O(new_n124_));
  inv1   g080(.a(x24), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x22), .c(x21), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n105_), .c(new_n124_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x23), .O(new_n128_));
  nand3  g084(.a(x26), .b(x25), .c(x16), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n106_), .c(x23), .d(x21), .O(new_n130_));
  ...
  nand2  g090(.a(x25), .b(new_n82_), .O(new_n135_));
  ...
  nand3  g101(.a(new_n75_), .b(x26), .c(new_n47_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x23), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n82_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n106_), .c(x22), .d(x21), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n148_), .c(new_n71_), .O(z16));
endmodule
