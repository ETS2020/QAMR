...
module FAU ( 
  ...
  aoi21  g10(.a(new_n54_), .b(x07), .c(x10), .O(z00));
  inv1   g11(.a(x00), .O(new_n56_));
  inv1   g12(.a(x08), .O(new_n57_));
  inv1   g13(.a(x07), .O(new_n58_));
  inv1   g14(.a(x10), .O(new_n59_));
  nand2  g15(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  oai21  g16(.a(new_n57_), .b(new_n56_), .c(new_n60_), .O(z01));
  inv1   g17(.a(x01), .O(new_n62_));
  oai21  g18(.a(new_n57_), .b(new_n62_), .c(new_n60_), .O(z02));
  nand2  g19(.a(x08), .b(x02), .O(new_n64_));
  nand2  g20(.a(new_n64_), .b(new_n60_), .O(z03));
  inv1   g21(.a(x03), .O(new_n66_));
  nand2  g22(.a(new_n60_), .b(x08), .O(new_n67_));
  ...
  oai21  g27(.a(new_n57_), .b(new_n71_), .c(new_n60_), .O(z06));
  nand2  g28(.a(x08), .b(x06), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n60_), .O(z07));
  nor2   g30(.a(new_n57_), .b(new_n58_), .O(z08));
  ...
  nand4  g35(.a(new_n79_), .b(new_n59_), .c(x09), .d(new_n57_), .O(new_n80_));
  oai22  g36(.a(new_n80_), .b(new_n58_), .c(new_n67_), .d(new_n56_), .O(z09));
  ...
  aoi21  g42(.a(new_n86_), .b(new_n84_), .c(x10), .O(new_n87_));
  nand4  g43(.a(new_n87_), .b(x09), .c(new_n57_), .d(x07), .O(new_n88_));
  ...
  aoi21  g51(.a(new_n95_), .b(new_n57_), .c(new_n58_), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(x10), .c(new_n64_), .O(z11));
  nand2  g53(.a(x23), .b(x14), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n52_), .c(x21), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n93_), .c(x22), .O(new_n100_));
  inv1   g56(.a(new_n93_), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(new_n49_), .c(x21), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n100_), .c(new_n45_), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n57_), .c(new_n58_), .O(new_n104_));
  ...
  oai21  g64(.a(new_n108_), .b(new_n93_), .c(x23), .O(new_n109_));
  nand4  g65(.a(new_n101_), .b(new_n50_), .c(x22), .d(x21), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n109_), .c(new_n45_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n57_), .c(new_n58_), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(x10), .c(new_n69_), .O(z13));
  ...
  nand4  g73(.a(new_n48_), .b(new_n117_), .c(x23), .d(x22), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n116_), .c(x10), .O(new_n119_));
  nand4  g75(.a(new_n119_), .b(x09), .c(new_n57_), .d(x07), .O(new_n120_));
  oai21  g76(.a(new_n67_), .b(new_n71_), .c(new_n120_), .O(z14));
  nand2  g77(.a(x26), .b(x17), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(x24), .c(x23), .d(x22), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n47_), .c(x25), .O(new_n124_));
  inv1   g80(.a(x25), .O(new_n125_));
  nand4  g81(.a(new_n51_), .b(new_n48_), .c(new_n125_), .d(x24), .O(new_n126_));
  aoi21  g82(.a(new_n126_), .b(new_n124_), .c(new_n45_), .O(new_n127_));
  aoi21  g83(.a(new_n127_), .b(new_n57_), .c(new_n58_), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(x10), .c(new_n73_), .O(z15));
  ...
  nor2   g89(.a(new_n117_), .b(new_n50_), .O(new_n134_));
  nor2   g90(.a(x26), .b(new_n125_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n101_), .c(new_n134_), .d(new_n76_), .O(new_n136_));
  nand2  g92(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g93(.a(new_n137_), .b(new_n59_), .c(x09), .O(new_n138_));
  aoi21  g94(.a(new_n138_), .b(new_n57_), .c(new_n58_), .O(z16));
endmodule
