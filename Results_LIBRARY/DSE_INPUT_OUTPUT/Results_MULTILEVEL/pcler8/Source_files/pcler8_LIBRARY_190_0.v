...
module FAU ( 
  ...
  nand3  g032(.a(new_n76_), .b(x26), .c(x25), .O(new_n77_));
  ...
  oai21  g056(.a(new_n100_), .b(new_n90_), .c(new_n98_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n102_));
  aoi21  g058(.a(x08), .b(x02), .c(new_n55_), .O(new_n103_));
  ...
  nor2   g068(.a(new_n92_), .b(new_n91_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n87_), .c(x14), .d(new_n47_), .O(new_n114_));
  ...
  nand2  g074(.a(new_n118_), .b(new_n74_), .O(new_n119_));
  inv1   g075(.a(new_n105_), .O(new_n120_));
  ...
  nand3  g081(.a(new_n125_), .b(new_n119_), .c(new_n65_), .O(z13));
  nand2  g082(.a(new_n116_), .b(x24), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n74_), .O(new_n128_));
  nand3  g084(.a(x26), .b(x25), .c(x16), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x22), .c(x21), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n99_), .c(x24), .O(new_n131_));
  nand4  g087(.a(new_n100_), .b(new_n75_), .c(x22), .d(x21), .O(new_n132_));
  ...
  nand3  g091(.a(new_n87_), .b(x25), .c(new_n47_), .O(new_n136_));
  ...
  oai21  g096(.a(new_n140_), .b(new_n105_), .c(x25), .O(new_n141_));
  nor2   g097(.a(x25), .b(new_n75_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n120_), .c(x23), .d(x22), .O(new_n143_));
  ...
  nand4  g111(.a(new_n155_), .b(new_n76_), .c(new_n45_), .d(x25), .O(new_n156_));
  ...
  nand3  g115(.a(new_n159_), .b(new_n158_), .c(new_n150_), .O(z16));
endmodule
