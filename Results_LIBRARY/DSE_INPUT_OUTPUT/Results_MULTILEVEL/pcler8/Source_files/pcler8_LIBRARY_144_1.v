...
module FAU ( 
  ...
  nand2  g011(.a(x25), .b(new_n55_), .O(new_n56_));
  ...
  nand2  g048(.a(new_n77_), .b(x21), .O(new_n93_));
  nand2  g049(.a(new_n79_), .b(x24), .O(new_n94_));
  nor2   g050(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n92_), .c(new_n90_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n88_), .O(z10));
  nand2  g053(.a(x22), .b(x13), .O(new_n98_));
  nand3  g054(.a(x26), .b(x25), .c(x23), .O(new_n99_));
  ...
  nand3  g061(.a(new_n105_), .b(new_n61_), .c(new_n56_), .O(z11));
  nand3  g062(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n107_));
  nand4  g063(.a(x26), .b(x23), .c(x22), .d(x14), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n107_), .c(x24), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x25), .O(new_n110_));
  nand3  g066(.a(x21), .b(x20), .c(x19), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand2  g068(.a(new_n75_), .b(x21), .O(new_n113_));
  oai22  g069(.a(new_n113_), .b(new_n102_), .c(new_n112_), .d(new_n75_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n110_), .c(new_n63_), .O(z12));
  nand4  g072(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x23), .O(new_n118_));
  nand3  g074(.a(new_n76_), .b(x22), .c(x21), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n102_), .c(new_n118_), .O(new_n120_));
  ...
  nand2  g079(.a(new_n123_), .b(new_n56_), .O(new_n124_));
  nand3  g080(.a(new_n79_), .b(x24), .c(x23), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n90_), .c(x15), .d(new_n47_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n124_), .O(z13));
  nand3  g084(.a(new_n90_), .b(x19), .c(new_n47_), .O(new_n129_));
  nand2  g085(.a(new_n77_), .b(new_n73_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n129_), .c(new_n78_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n55_), .O(new_n132_));
  oai21  g088(.a(new_n102_), .b(new_n93_), .c(x24), .O(new_n133_));
  nand2  g089(.a(new_n79_), .b(x16), .O(new_n134_));
  ...
  nand3  g093(.a(new_n137_), .b(new_n136_), .c(new_n132_), .O(z14));
  ...
  nand4  g097(.a(new_n112_), .b(new_n78_), .c(x23), .d(x22), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n141_), .c(new_n55_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n144_));
  oai21  g100(.a(new_n57_), .b(new_n69_), .c(new_n144_), .O(z15));
  nand4  g101(.a(new_n73_), .b(new_n45_), .c(x23), .d(x22), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n129_), .c(x24), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x25), .O(new_n148_));
  nand4  g104(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n149_));
  nor3   g105(.a(new_n149_), .b(new_n102_), .c(x18), .O(new_n150_));
  ...
  nand3  g109(.a(new_n153_), .b(new_n152_), .c(new_n148_), .O(z16));
endmodule
