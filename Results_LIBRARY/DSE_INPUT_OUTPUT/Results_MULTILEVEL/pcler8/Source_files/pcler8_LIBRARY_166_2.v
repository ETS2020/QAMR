...
module FAU ( 
  ...
  nor2   g030(.a(new_n54_), .b(new_n74_), .O(new_n75_));
  ...
  nand2  g045(.a(new_n75_), .b(x21), .O(new_n90_));
  ...
  nand3  g052(.a(x26), .b(x24), .c(x23), .O(new_n97_));
  ...
  nand3  g062(.a(new_n106_), .b(new_n74_), .c(x21), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n105_), .c(new_n63_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n56_), .O(new_n109_));
  nand3  g065(.a(x21), .b(x20), .c(x19), .O(new_n110_));
  oai21  g066(.a(x25), .b(new_n54_), .c(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n93_), .b(x23), .c(x14), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(new_n74_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n109_), .O(z12));
  inv1   g071(.a(new_n110_), .O(new_n116_));
  nand2  g072(.a(new_n77_), .b(x15), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n116_), .c(x22), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x25), .c(x23), .O(new_n119_));
  nand4  g075(.a(new_n106_), .b(new_n54_), .c(x22), .d(x21), .O(new_n120_));
  ...
  nand2  g079(.a(new_n65_), .b(x05), .O(new_n124_));
  nand2  g080(.a(x26), .b(x16), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n106_), .c(x22), .d(x21), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(x25), .c(new_n54_), .O(new_n127_));
  nand4  g083(.a(new_n116_), .b(new_n75_), .c(x25), .d(new_n76_), .O(new_n128_));
  oai21  g084(.a(new_n127_), .b(new_n76_), .c(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n124_), .O(z14));
  aoi21  g087(.a(x26), .b(x17), .c(new_n76_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n116_), .c(new_n75_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(x25), .c(new_n47_), .d(x09), .O(new_n134_));
  aoi21  g090(.a(x08), .b(x06), .c(new_n55_), .O(new_n135_));
  oai21  g091(.a(new_n134_), .b(x08), .c(new_n135_), .O(z15));
  nand3  g092(.a(new_n87_), .b(x19), .c(new_n47_), .O(new_n137_));
  nand4  g093(.a(new_n72_), .b(new_n45_), .c(x24), .d(x22), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(x25), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x23), .O(new_n140_));
  nand4  g096(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n141_));
  nor3   g097(.a(new_n141_), .b(new_n100_), .c(x18), .O(new_n142_));
