...
module FAU ( 
  ...
  aoi21  g23(.a(x08), .b(x04), .c(new_n46_), .O(new_n68_));
  inv1   g24(.a(new_n68_), .O(z05));
  inv1   g25(.a(x05), .O(new_n70_));
  nand2  g26(.a(new_n47_), .b(x08), .O(new_n71_));
  ...
  oai21  g38(.a(new_n71_), .b(new_n60_), .c(new_n82_), .O(z09));
  ...
  oai21  g51(.a(new_n71_), .b(new_n64_), .c(new_n95_), .O(z11));
  ...
  nand3  g59(.a(new_n103_), .b(new_n66_), .c(new_n47_), .O(z12));
  ...
  nand4  g95(.a(new_n139_), .b(new_n138_), .c(new_n78_), .d(new_n51_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n142_));
  oai21  g98(.a(new_n71_), .b(new_n75_), .c(new_n142_), .O(z16));
endmodule
