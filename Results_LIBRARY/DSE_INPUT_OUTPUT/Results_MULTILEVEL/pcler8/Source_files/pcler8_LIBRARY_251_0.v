...
module FAU ( 
  ...
  nor2   g009(.a(x23), .b(x11), .O(new_n54_));
  ...
  nand2  g015(.a(new_n59_), .b(new_n58_), .O(z03));
  nand2  g016(.a(x08), .b(x03), .O(new_n61_));
  nand2  g017(.a(new_n61_), .b(new_n58_), .O(z04));
  nand2  g018(.a(x08), .b(x04), .O(new_n63_));
  nand2  g019(.a(new_n63_), .b(new_n58_), .O(z05));
  nand2  g020(.a(new_n55_), .b(x05), .O(new_n65_));
  inv1   g021(.a(new_n65_), .O(z06));
  nand2  g022(.a(new_n55_), .b(x06), .O(new_n67_));
  inv1   g023(.a(new_n67_), .O(z07));
  nand2  g024(.a(new_n55_), .b(x07), .O(new_n69_));
  ...
  aoi21  g042(.a(x08), .b(x01), .c(new_n54_), .O(new_n87_));
  ...
  nand3  g052(.a(new_n96_), .b(new_n59_), .c(new_n58_), .O(z11));
  ...
  inv1   g068(.a(new_n100_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n73_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n112_), .c(x11), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n108_), .O(new_n116_));
  nand4  g072(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n99_), .c(x22), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x23), .c(new_n47_), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(x09), .c(new_n46_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n116_), .c(new_n63_), .O(z13));
  nand3  g078(.a(x26), .b(x25), .c(x16), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n113_), .c(x22), .d(x21), .O(new_n124_));
  inv1   g080(.a(x24), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x22), .c(x21), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n100_), .O(new_n127_));
  aoi21  g083(.a(new_n124_), .b(x24), .c(new_n127_), .O(new_n128_));
  nand3  g084(.a(x24), .b(new_n108_), .c(x11), .O(new_n129_));
  oai21  g085(.a(new_n128_), .b(new_n108_), .c(new_n129_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n65_), .O(z14));
  nand2  g088(.a(x26), .b(x17), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n99_), .c(x24), .d(x22), .O(new_n134_));
  inv1   g090(.a(x25), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(x24), .c(x22), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n98_), .O(new_n137_));
  aoi21  g093(.a(new_n134_), .b(x25), .c(new_n137_), .O(new_n138_));
  nand3  g094(.a(x25), .b(new_n108_), .c(x11), .O(new_n139_));
  oai21  g095(.a(new_n138_), .b(new_n108_), .c(new_n139_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n67_), .O(z15));
