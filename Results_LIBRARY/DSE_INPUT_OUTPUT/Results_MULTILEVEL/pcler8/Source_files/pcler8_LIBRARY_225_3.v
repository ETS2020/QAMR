...
module FAU ( 
  ...
  nand2  g019(.a(new_n56_), .b(x03), .O(new_n64_));
  inv1   g020(.a(new_n64_), .O(z04));
  inv1   g021(.a(x04), .O(new_n66_));
  oai21  g022(.a(new_n46_), .b(new_n66_), .c(new_n59_), .O(z05));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n46_), .c(x10), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n54_), .c(new_n62_), .O(z11));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(x08), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(x10), .c(x09), .O(new_n108_));
  ...
  oai21  g069(.a(new_n113_), .b(new_n102_), .c(x23), .O(new_n114_));
  inv1   g070(.a(x23), .O(new_n115_));
  nand4  g071(.a(new_n101_), .b(new_n115_), .c(x22), .d(x21), .O(new_n116_));
  ...
  oai21  g084(.a(new_n111_), .b(new_n68_), .c(new_n128_), .O(z14));
  nor2   g085(.a(new_n115_), .b(new_n75_), .O(new_n130_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n101_), .c(new_n143_), .d(new_n76_), .O(new_n145_));
