...
module FAU ( 
  ...
  nand2  g045(.a(new_n89_), .b(new_n61_), .O(new_n90_));
  ...
  oai21  g066(.a(new_n110_), .b(new_n109_), .c(new_n55_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  inv1   g068(.a(new_n110_), .O(new_n113_));
  nand2  g069(.a(x23), .b(x14), .O(new_n114_));
  oai22  g070(.a(new_n114_), .b(new_n84_), .c(new_n113_), .d(new_n108_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n112_), .c(new_n65_), .O(z12));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n122_), .c(new_n108_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n125_));
  oai21  g081(.a(new_n58_), .b(new_n67_), .c(new_n125_), .O(z13));
  ...
  oai21  g089(.a(new_n132_), .b(new_n108_), .c(new_n133_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n69_), .O(z14));
  nand3  g092(.a(new_n77_), .b(x19), .c(new_n47_), .O(new_n137_));
  inv1   g093(.a(x25), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(x24), .c(x21), .d(x20), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n137_), .c(x22), .O(new_n140_));
  ...
  aoi21  g100(.a(new_n144_), .b(new_n113_), .c(new_n138_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n141_), .c(new_n71_), .O(z15));
  ...
  nor2   g108(.a(new_n152_), .b(new_n110_), .O(new_n153_));
