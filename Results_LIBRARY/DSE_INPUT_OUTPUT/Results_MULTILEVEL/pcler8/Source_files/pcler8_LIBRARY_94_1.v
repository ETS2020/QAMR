...
module FAU ( 
  ...
  and2   g017(.a(new_n61_), .b(x02), .O(z03));
  inv1   g018(.a(x03), .O(new_n63_));
  inv1   g019(.a(new_n61_), .O(new_n64_));
  nor2   g020(.a(new_n64_), .b(new_n63_), .O(z04));
  and2   g021(.a(new_n61_), .b(x04), .O(z05));
  inv1   g022(.a(x05), .O(new_n67_));
  oai21  g023(.a(new_n46_), .b(new_n67_), .c(new_n56_), .O(z06));
  nand2  g024(.a(x08), .b(x06), .O(new_n69_));
  nand2  g025(.a(new_n69_), .b(new_n56_), .O(z07));
  nand2  g026(.a(new_n61_), .b(x07), .O(new_n71_));
  inv1   g027(.a(new_n71_), .O(z08));
  nand3  g028(.a(x21), .b(x20), .c(x11), .O(new_n73_));
  and2   g029(.a(x23), .b(x22), .O(new_n74_));
  nand3  g030(.a(new_n74_), .b(x26), .c(x25), .O(new_n75_));
  oai21  g031(.a(new_n75_), .b(new_n73_), .c(x19), .O(new_n76_));
  nand4  g032(.a(new_n76_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n77_));
  nand3  g033(.a(new_n77_), .b(new_n57_), .c(new_n56_), .O(z09));
  nand3  g034(.a(x22), .b(x21), .c(x12), .O(new_n79_));
  nand3  g035(.a(x26), .b(x25), .c(x23), .O(new_n80_));
  oai21  g036(.a(new_n80_), .b(new_n79_), .c(x20), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(x19), .O(new_n82_));
  inv1   g038(.a(x19), .O(new_n83_));
  nand2  g039(.a(x20), .b(new_n83_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand4  g041(.a(new_n85_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n86_));
  nand3  g042(.a(new_n86_), .b(new_n59_), .c(new_n56_), .O(z10));
  nand2  g043(.a(x22), .b(x13), .O(new_n88_));
  oai21  g044(.a(new_n88_), .b(new_n80_), .c(x21), .O(new_n89_));
  inv1   g045(.a(x21), .O(new_n90_));
  nor2   g046(.a(new_n90_), .b(x20), .O(new_n91_));
  aoi21  g047(.a(new_n89_), .b(x20), .c(new_n91_), .O(new_n92_));
  nand2  g048(.a(x21), .b(new_n83_), .O(new_n93_));
  oai21  g049(.a(new_n92_), .b(new_n83_), .c(new_n93_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n95_));
  aoi21  g051(.a(x08), .b(x02), .c(new_n55_), .O(new_n96_));
  ...
  nand2  g057(.a(new_n98_), .b(x21), .O(new_n102_));
  oai22  g058(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n98_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n104_));
  oai21  g060(.a(new_n46_), .b(new_n63_), .c(new_n104_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n56_), .O(new_n106_));
  inv1   g062(.a(x09), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(x08), .O(new_n108_));
  inv1   g064(.a(x23), .O(new_n109_));
  nand3  g065(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(new_n109_), .c(new_n98_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n108_), .c(x14), .d(new_n47_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n106_), .O(z12));
  nand3  g069(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n114_));
  nand3  g070(.a(x26), .b(x23), .c(x15), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(x24), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x25), .O(new_n117_));
  nand2  g073(.a(x22), .b(x21), .O(new_n118_));
  oai21  g074(.a(new_n101_), .b(new_n118_), .c(x23), .O(new_n119_));
  nand3  g075(.a(new_n109_), .b(x22), .c(x21), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n101_), .c(new_n119_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n122_));
  nand2  g078(.a(x08), .b(x04), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n122_), .c(new_n117_), .O(z13));
  nand3  g080(.a(x26), .b(x25), .c(x16), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x23), .c(x22), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n99_), .c(x24), .O(new_n127_));
  nor2   g083(.a(x25), .b(x24), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n100_), .c(new_n74_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n131_));
  oai21  g087(.a(new_n64_), .b(new_n67_), .c(new_n131_), .O(z14));
  nand2  g088(.a(x26), .b(x17), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x23), .c(x22), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n99_), .c(x25), .O(new_n135_));
  nand4  g091(.a(new_n100_), .b(new_n74_), .c(new_n54_), .d(x24), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n69_), .c(new_n56_), .O(z15));
  inv1   g095(.a(x18), .O(new_n140_));
  nand3  g096(.a(x20), .b(x19), .c(new_n140_), .O(new_n141_));
  nand3  g097(.a(x23), .b(x22), .c(x21), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n141_), .c(x26), .O(new_n143_));
  nand4  g099(.a(new_n100_), .b(new_n74_), .c(new_n45_), .d(x25), .O(new_n144_));
  ...
  nand2  g105(.a(new_n149_), .b(new_n71_), .O(z16));
endmodule
