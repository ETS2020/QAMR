...
module FAU ( 
  ...
  nor2   g012(.a(new_n56_), .b(x10), .O(z02));
  nand2  g013(.a(x08), .b(x02), .O(new_n58_));
  nor2   g014(.a(new_n58_), .b(x10), .O(z03));
  oai21  g015(.a(x10), .b(x03), .c(x08), .O(new_n60_));
  ...
  nor2   g020(.a(new_n64_), .b(x10), .O(z06));
  nand2  g021(.a(x08), .b(x06), .O(new_n66_));
  nor2   g022(.a(new_n66_), .b(x10), .O(z07));
  nand2  g023(.a(x08), .b(x07), .O(new_n68_));
  nor2   g024(.a(new_n68_), .b(x10), .O(z08));
  ...
  nand2  g036(.a(new_n80_), .b(new_n70_), .O(z09));
  oai21  g037(.a(x10), .b(x01), .c(x08), .O(new_n82_));
  nand2  g038(.a(new_n73_), .b(x12), .O(new_n83_));
  ...
  nand2  g045(.a(new_n89_), .b(new_n82_), .O(z10));
  oai21  g046(.a(x10), .b(x02), .c(x08), .O(new_n91_));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n64_), .c(x10), .O(z14));
  oai21  g084(.a(x10), .b(x06), .c(x08), .O(new_n129_));
  nor2   g085(.a(new_n75_), .b(new_n72_), .O(new_n130_));
  nand2  g086(.a(x26), .b(x17), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n130_), .c(x24), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n113_), .c(x25), .O(new_n133_));
  ...
  oai21  g094(.a(x10), .b(x07), .c(x08), .O(new_n139_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n105_), .c(new_n77_), .d(new_n73_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n139_), .O(z16));
endmodule
