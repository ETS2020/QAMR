...
module FAU ( 
  ...
  nor2   g009(.a(new_n47_), .b(x02), .O(new_n54_));
  ...
  nand3  g043(.a(new_n87_), .b(new_n58_), .c(new_n57_), .O(z10));
  ...
  nand2  g052(.a(new_n96_), .b(new_n60_), .O(z11));
  nor2   g053(.a(new_n82_), .b(new_n89_), .O(new_n98_));
  ...
  oai21  g061(.a(new_n63_), .b(new_n62_), .c(new_n105_), .O(z12));
  ...
  nand3  g082(.a(new_n126_), .b(new_n67_), .c(new_n57_), .O(z14));
  ...
  oai21  g092(.a(new_n63_), .b(new_n69_), .c(new_n136_), .O(z15));
  ...
  nand4  g099(.a(new_n143_), .b(new_n98_), .c(new_n142_), .d(new_n75_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n146_));
  oai21  g102(.a(new_n63_), .b(new_n71_), .c(new_n146_), .O(z16));
endmodule
