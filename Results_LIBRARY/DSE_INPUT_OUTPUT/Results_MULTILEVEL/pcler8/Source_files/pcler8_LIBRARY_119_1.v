...
module FAU ( 
  ...
  oai21  g28(.a(new_n47_), .b(new_n72_), .c(new_n46_), .O(z07));
  ...
  nand3  g70(.a(new_n114_), .b(new_n68_), .c(new_n46_), .O(z13));
  ...
  nand3  g80(.a(new_n124_), .b(new_n70_), .c(new_n46_), .O(z14));
  ...
  aoi21  g98(.a(x08), .b(x07), .c(new_n90_), .O(new_n143_));
