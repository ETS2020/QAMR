...
module FAU ( 
  ...
  nor2   g030(.a(x19), .b(x11), .O(new_n75_));
  nand4  g031(.a(new_n75_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n76_));
  oai21  g032(.a(new_n59_), .b(new_n56_), .c(new_n76_), .O(z09));
  ...
  aoi21  g039(.a(new_n83_), .b(new_n81_), .c(x11), .O(new_n84_));
  nand4  g040(.a(new_n84_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n85_));
  oai21  g041(.a(new_n59_), .b(new_n61_), .c(new_n85_), .O(z10));
  ...
  nand4  g050(.a(new_n94_), .b(new_n49_), .c(new_n48_), .d(x09), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(x08), .c(new_n64_), .O(z11));
  inv1   g052(.a(x09), .O(new_n97_));
  nand2  g053(.a(x20), .b(x19), .O(new_n98_));
  nand2  g054(.a(x23), .b(x14), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n88_), .c(x21), .O(new_n100_));
  ...
  aoi21  g059(.a(new_n103_), .b(new_n101_), .c(new_n97_), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n47_), .c(x11), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(x10), .c(new_n66_), .O(z12));
  ...
  aoi21  g067(.a(new_n111_), .b(new_n109_), .c(new_n97_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n47_), .c(x11), .O(new_n113_));
  nand2  g069(.a(x08), .b(x04), .O(new_n114_));
  oai21  g070(.a(new_n113_), .b(x10), .c(new_n114_), .O(z13));
  ...
  oai21  g080(.a(new_n59_), .b(new_n69_), .c(new_n124_), .O(z14));
  nand2  g081(.a(new_n58_), .b(x06), .O(new_n126_));
  nor2   g082(.a(new_n110_), .b(new_n46_), .O(new_n127_));
  ...
  nor2   g095(.a(new_n46_), .b(new_n90_), .O(new_n140_));
  ...
  aoi21  g099(.a(new_n143_), .b(new_n139_), .c(new_n97_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n47_), .c(x11), .O(new_n145_));
