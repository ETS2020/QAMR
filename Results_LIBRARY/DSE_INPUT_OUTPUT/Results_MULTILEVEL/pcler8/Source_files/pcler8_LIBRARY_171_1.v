...
module FAU ( 
  ...
  nand4  g004(.a(x17), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n49_));
  ...
  nor2   g011(.a(new_n55_), .b(x17), .O(new_n56_));
  ...
  and2   g017(.a(new_n57_), .b(x02), .O(z03));
  nand2  g018(.a(x08), .b(x03), .O(new_n63_));
  nand2  g019(.a(new_n63_), .b(new_n59_), .O(z04));
  nand2  g020(.a(new_n57_), .b(x04), .O(new_n65_));
  inv1   g021(.a(new_n65_), .O(z05));
  nand2  g022(.a(x08), .b(x05), .O(new_n67_));
  nand2  g023(.a(new_n67_), .b(new_n59_), .O(z06));
  ...
  nand3  g041(.a(new_n48_), .b(x09), .c(new_n47_), .O(new_n86_));
  nand3  g042(.a(x19), .b(x17), .c(x12), .O(new_n87_));
  nor2   g043(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nor2   g044(.a(new_n55_), .b(new_n46_), .O(new_n89_));
  nand3  g045(.a(x26), .b(x25), .c(x24), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n89_), .c(new_n88_), .d(x21), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n85_), .O(z10));
  nand3  g049(.a(x23), .b(x22), .c(x13), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n90_), .c(x21), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(x20), .c(x19), .O(new_n96_));
  and2   g052(.a(x20), .b(x19), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n72_), .c(new_n96_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n99_));
  aoi21  g055(.a(x08), .b(x02), .c(new_n56_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n99_), .O(z11));
  nand3  g057(.a(new_n97_), .b(new_n46_), .c(x21), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n86_), .c(new_n63_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n59_), .O(new_n104_));
  nand3  g060(.a(x21), .b(x20), .c(x19), .O(new_n105_));
  oai21  g061(.a(new_n55_), .b(x17), .c(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n91_), .b(x23), .c(x17), .d(x14), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n106_), .c(new_n46_), .O(new_n108_));
  ...
  nand3  g069(.a(new_n113_), .b(x23), .c(x17), .O(new_n114_));
  nand4  g070(.a(new_n97_), .b(new_n55_), .c(x22), .d(x21), .O(new_n115_));
  ...
  nand2  g074(.a(new_n57_), .b(x05), .O(new_n119_));
  inv1   g075(.a(x17), .O(new_n120_));
  nand3  g076(.a(x26), .b(x25), .c(x16), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n97_), .c(x22), .d(x21), .O(new_n122_));
  inv1   g078(.a(x24), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x23), .c(x22), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n105_), .O(new_n125_));
  aoi21  g081(.a(new_n122_), .b(x24), .c(new_n125_), .O(new_n126_));
  nand2  g082(.a(x24), .b(new_n55_), .O(new_n127_));
  oai21  g083(.a(new_n126_), .b(new_n120_), .c(new_n127_), .O(new_n128_));
  ...
  nor2   g087(.a(new_n131_), .b(x08), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(x19), .c(new_n48_), .O(new_n133_));
  and2   g089(.a(x21), .b(x20), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n75_), .c(x24), .d(x22), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n133_), .c(x17), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x23), .O(new_n137_));
  nand3  g093(.a(new_n89_), .b(new_n45_), .c(x24), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n111_), .c(new_n75_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n141_));
  nand2  g097(.a(x08), .b(x06), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n141_), .c(new_n137_), .O(z15));
  nand3  g099(.a(new_n97_), .b(new_n132_), .c(new_n48_), .O(new_n144_));
  nand4  g100(.a(new_n73_), .b(new_n45_), .c(x25), .d(x24), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n144_), .c(x17), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x23), .O(new_n147_));
  inv1   g103(.a(x18), .O(new_n148_));
  nand3  g104(.a(new_n134_), .b(x19), .c(new_n148_), .O(new_n149_));
  nand3  g105(.a(new_n89_), .b(x25), .c(x24), .O(new_n150_));
  ...
  nand3  g109(.a(new_n153_), .b(new_n147_), .c(new_n70_), .O(z16));
endmodule
