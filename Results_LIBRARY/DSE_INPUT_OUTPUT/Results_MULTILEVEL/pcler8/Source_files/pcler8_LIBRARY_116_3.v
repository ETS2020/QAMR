...
module FAU ( 
  ...
  aoi21  g014(.a(x08), .b(x01), .c(new_n55_), .O(new_n59_));
  ...
  oai21  g026(.a(new_n46_), .b(new_n70_), .c(new_n64_), .O(z07));
  ...
  nand3  g041(.a(new_n54_), .b(x19), .c(new_n47_), .O(new_n86_));
  ...
  oai21  g051(.a(new_n95_), .b(new_n74_), .c(new_n93_), .O(new_n96_));
  ...
  nand2  g070(.a(x23), .b(new_n75_), .O(new_n115_));
  ...
  nand3  g074(.a(x19), .b(x09), .c(new_n46_), .O(new_n119_));
  inv1   g075(.a(x24), .O(new_n120_));
  nand3  g076(.a(new_n76_), .b(new_n120_), .c(x23), .O(new_n121_));
  ...
  and2   g087(.a(x23), .b(x22), .O(new_n132_));
  nand2  g088(.a(x26), .b(x17), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(x24), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n111_), .c(x25), .O(new_n135_));
  nor2   g091(.a(x25), .b(new_n120_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n124_), .c(new_n132_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n139_));
  oai21  g095(.a(new_n99_), .b(new_n70_), .c(new_n139_), .O(z15));
  nand4  g096(.a(x21), .b(x19), .c(x09), .d(new_n46_), .O(new_n141_));
  nand4  g097(.a(new_n132_), .b(new_n45_), .c(x25), .d(x24), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n141_), .c(new_n47_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x20), .O(new_n144_));
  inv1   g100(.a(x18), .O(new_n145_));
  nand4  g101(.a(x21), .b(x20), .c(x19), .d(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n132_), .b(x25), .c(x24), .O(new_n147_));
