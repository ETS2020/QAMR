...
module FAU ( 
  ...
  oai21  g022(.a(new_n48_), .b(new_n66_), .c(new_n47_), .O(z04));
  ...
  nor2   g030(.a(new_n63_), .b(new_n74_), .O(z08));
  ...
  nand3  g045(.a(x22), .b(x20), .c(x13), .O(new_n90_));
  oai22  g046(.a(new_n90_), .b(new_n79_), .c(new_n76_), .d(x20), .O(new_n91_));
  aoi22  g047(.a(new_n91_), .b(new_n45_), .c(new_n76_), .d(x20), .O(new_n92_));
  nand3  g048(.a(x21), .b(new_n49_), .c(new_n45_), .O(new_n93_));
  oai21  g049(.a(new_n92_), .b(new_n49_), .c(new_n93_), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(x09), .c(new_n48_), .O(new_n95_));
  ...
  oai21  g060(.a(new_n63_), .b(new_n66_), .c(new_n104_), .O(z12));
  ...
  nand2  g075(.a(new_n119_), .b(new_n76_), .O(new_n120_));
  ...
  inv1   g080(.a(new_n110_), .O(new_n125_));
  ...
  nand3  g084(.a(new_n128_), .b(new_n120_), .c(new_n70_), .O(z14));
  nand2  g085(.a(x25), .b(x09), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(x08), .c(new_n45_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n76_), .O(new_n132_));
  nand3  g088(.a(x22), .b(x20), .c(x19), .O(new_n133_));
  ...
  nand4  g093(.a(new_n125_), .b(new_n55_), .c(new_n137_), .d(x24), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n132_), .c(new_n72_), .O(z15));
  inv1   g097(.a(x18), .O(new_n142_));
  nand4  g098(.a(x21), .b(x20), .c(x19), .d(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n55_), .b(x25), .c(x24), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n143_), .c(x26), .O(new_n145_));
  nor2   g101(.a(new_n124_), .b(new_n54_), .O(new_n146_));
  nor2   g102(.a(x26), .b(new_n137_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n146_), .c(new_n77_), .d(new_n51_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n150_));
  oai21  g106(.a(new_n63_), .b(new_n74_), .c(new_n150_), .O(z16));
endmodule
