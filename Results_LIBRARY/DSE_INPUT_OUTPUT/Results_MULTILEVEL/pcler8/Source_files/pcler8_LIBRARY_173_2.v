...
module FAU ( 
  ...
  oai21  g22(.a(new_n59_), .b(new_n48_), .c(new_n46_), .O(z09));
  oai21  g23(.a(new_n59_), .b(new_n52_), .c(new_n46_), .O(z10));
  oai21  g24(.a(new_n59_), .b(new_n54_), .c(new_n46_), .O(z11));
  oai21  g25(.a(new_n59_), .b(new_n56_), .c(new_n46_), .O(z12));
  nor2   g26(.a(new_n50_), .b(new_n58_), .O(z13));
  nor2   g27(.a(new_n50_), .b(new_n61_), .O(z14));
