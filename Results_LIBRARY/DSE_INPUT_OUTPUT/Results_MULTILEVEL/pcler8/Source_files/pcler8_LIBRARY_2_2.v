...
module FAU ( 
  ...
  nand2  g011(.a(new_n55_), .b(x10), .O(new_n56_));
  ...
  nand2  g054(.a(x23), .b(x10), .O(new_n99_));
  nand3  g055(.a(x21), .b(x20), .c(x19), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g057(.a(x23), .b(x14), .c(new_n47_), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n92_), .c(new_n101_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x22), .O(new_n104_));
  nor2   g060(.a(new_n90_), .b(x10), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n74_), .c(x21), .d(x20), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x09), .c(new_n46_), .O(new_n108_));
  aoi21  g064(.a(x08), .b(x03), .c(new_n80_), .O(new_n109_));
  ...
  nor2   g090(.a(new_n55_), .b(new_n74_), .O(new_n135_));
  nand4  g091(.a(new_n111_), .b(new_n135_), .c(new_n134_), .d(x24), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n130_), .c(new_n69_), .O(z15));
  nand2  g095(.a(x26), .b(x09), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(x08), .c(new_n47_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n55_), .O(new_n142_));
  inv1   g098(.a(x18), .O(new_n143_));
  nand3  g099(.a(x20), .b(x19), .c(new_n143_), .O(new_n144_));
  nand4  g100(.a(x25), .b(x24), .c(x22), .d(x21), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n144_), .c(x26), .O(new_n146_));
  nor2   g102(.a(new_n123_), .b(new_n55_), .O(new_n147_));
  nor2   g103(.a(x26), .b(new_n134_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n115_), .c(new_n147_), .d(new_n75_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n151_));
  nand2  g107(.a(x08), .b(x07), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n151_), .c(new_n142_), .O(z16));
endmodule
