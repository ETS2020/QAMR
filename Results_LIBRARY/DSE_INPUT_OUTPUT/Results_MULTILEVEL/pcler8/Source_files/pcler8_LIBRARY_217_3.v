...
module FAU ( 
  ...
  oai21  g50(.a(new_n94_), .b(new_n76_), .c(new_n92_), .O(new_n95_));
  nand4  g51(.a(new_n95_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n96_));
  nand2  g52(.a(x08), .b(x04), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n96_), .c(z00), .O(z13));
  nand2  g54(.a(new_n49_), .b(x05), .O(new_n99_));
  nand3  g55(.a(x23), .b(x22), .c(x21), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n76_), .c(new_n46_), .O(new_n101_));
  nand3  g57(.a(new_n45_), .b(x23), .c(x22), .O(new_n102_));
  oai22  g58(.a(new_n102_), .b(new_n83_), .c(new_n101_), .d(new_n45_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n99_), .O(z14));
  nand3  g61(.a(x24), .b(x23), .c(x22), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n83_), .c(new_n46_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n108_));
  aoi21  g64(.a(x08), .b(x06), .c(z00), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n108_), .O(z15));
  nand2  g66(.a(x08), .b(x07), .O(new_n111_));
  nand4  g67(.a(x26), .b(new_n68_), .c(x09), .d(new_n48_), .O(new_n112_));
  nand3  g68(.a(new_n112_), .b(new_n111_), .c(new_n54_), .O(z16));
endmodule
