...
module FAU ( 
  ...
  nand2  g41(.a(new_n86_), .b(x21), .O(new_n87_));
  oai21  g42(.a(new_n87_), .b(new_n85_), .c(new_n84_), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n89_));
  aoi21  g44(.a(new_n89_), .b(new_n58_), .c(new_n48_), .O(z12));
  nand2  g45(.a(x22), .b(x21), .O(new_n91_));
  oai21  g46(.a(new_n91_), .b(new_n85_), .c(x23), .O(new_n92_));
  nand3  g47(.a(new_n46_), .b(x22), .c(x21), .O(new_n93_));
  oai21  g48(.a(new_n93_), .b(new_n85_), .c(new_n92_), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n95_));
  aoi21  g50(.a(x08), .b(x04), .c(new_n48_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n95_), .O(z13));
  nand2  g52(.a(new_n53_), .b(x05), .O(new_n98_));
  nand3  g53(.a(new_n47_), .b(x23), .c(x22), .O(new_n99_));
  oai22  g54(.a(new_n99_), .b(new_n83_), .c(new_n47_), .d(x23), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n68_), .c(x09), .d(new_n52_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n98_), .O(z14));
  nand2  g57(.a(x08), .b(x06), .O(new_n103_));
  nand3  g58(.a(new_n71_), .b(x25), .c(new_n68_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n103_), .c(new_n48_), .O(z15));
  nand3  g60(.a(new_n71_), .b(x26), .c(new_n68_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n66_), .c(new_n49_), .O(z16));
  zero   g62(.O(z00));
endmodule
