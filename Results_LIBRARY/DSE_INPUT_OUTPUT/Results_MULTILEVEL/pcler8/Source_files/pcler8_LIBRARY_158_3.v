...
module FAU ( 
  ...
  aoi21  g27(.a(new_n72_), .b(new_n68_), .c(new_n49_), .O(z09));
  ...
  nand2  g32(.a(x20), .b(x19), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(x21), .O(new_n79_));
  inv1   g34(.a(x21), .O(new_n80_));
  nand3  g35(.a(new_n80_), .b(x20), .c(x19), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand4  g37(.a(new_n82_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n83_));
  nand2  g38(.a(x08), .b(x02), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n83_), .c(new_n49_), .O(z11));
  nand2  g40(.a(new_n50_), .b(x03), .O(new_n86_));
  nand3  g41(.a(x21), .b(x20), .c(x19), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n48_), .c(x22), .O(new_n88_));
  nand4  g43(.a(new_n47_), .b(x21), .c(x20), .d(x19), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n86_), .O(z12));
  nand2  g47(.a(x22), .b(x21), .O(new_n93_));
  oai21  g48(.a(new_n93_), .b(new_n78_), .c(new_n48_), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n74_), .c(x09), .d(new_n46_), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n60_), .c(new_n53_), .O(z13));
  nand3  g51(.a(new_n70_), .b(x24), .c(new_n74_), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n62_), .c(new_n53_), .O(z14));
  nand2  g53(.a(x08), .b(x06), .O(new_n99_));
  nand3  g54(.a(new_n70_), .b(x25), .c(new_n74_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(new_n99_), .c(new_n49_), .O(z15));
  nand3  g56(.a(new_n70_), .b(x26), .c(new_n74_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n66_), .c(new_n49_), .O(z16));
  zero   g58(.O(z00));
endmodule
