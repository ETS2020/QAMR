...
module FAU ( 
  ...
  aoi21  g010(.a(new_n47_), .b(new_n46_), .c(new_n54_), .O(z01));
  nor2   g011(.a(new_n47_), .b(new_n54_), .O(new_n56_));
  ...
  aoi21  g020(.a(x08), .b(x04), .c(new_n56_), .O(new_n65_));
  ...
  nand2  g036(.a(new_n80_), .b(new_n73_), .O(z09));
  ...
  nand3  g058(.a(new_n98_), .b(new_n75_), .c(x21), .O(new_n103_));
  ...
  nand2  g069(.a(x23), .b(new_n75_), .O(new_n114_));
  ...
  nand3  g081(.a(new_n125_), .b(new_n67_), .c(new_n57_), .O(z14));
  inv1   g082(.a(x23), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(new_n75_), .O(new_n128_));
  ...
  aoi21  g091(.a(x08), .b(x06), .c(new_n56_), .O(new_n136_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n98_), .c(new_n142_), .d(new_n76_), .O(new_n144_));
