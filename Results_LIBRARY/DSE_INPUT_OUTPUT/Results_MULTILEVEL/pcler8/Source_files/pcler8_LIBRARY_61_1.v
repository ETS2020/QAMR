...
module FAU ( 
  ...
  oai21  g41(.a(new_n46_), .b(new_n56_), .c(new_n85_), .O(z10));
  ...
  nor2   g46(.a(new_n70_), .b(x20), .O(new_n91_));
  aoi21  g47(.a(new_n90_), .b(x20), .c(new_n91_), .O(new_n92_));
  nand2  g48(.a(x21), .b(new_n87_), .O(new_n93_));
  oai21  g49(.a(new_n92_), .b(new_n87_), .c(new_n93_), .O(new_n94_));
  aoi21  g50(.a(new_n94_), .b(x09), .c(x10), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(x08), .c(new_n58_), .O(z11));
  nor2   g52(.a(new_n81_), .b(new_n87_), .O(new_n97_));
  inv1   g53(.a(new_n97_), .O(new_n98_));
  nand2  g54(.a(x23), .b(x14), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n89_), .c(x21), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n98_), .c(x22), .O(new_n101_));
  nand3  g57(.a(new_n97_), .b(new_n71_), .c(x21), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n101_), .c(new_n78_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(x10), .c(new_n46_), .O(new_n104_));
  ...
  nor2   g83(.a(new_n109_), .b(new_n71_), .O(new_n128_));
  nand4  g84(.a(new_n119_), .b(new_n128_), .c(new_n127_), .d(x24), .O(new_n129_));
  aoi21  g85(.a(new_n129_), .b(new_n126_), .c(new_n78_), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(x10), .c(new_n46_), .O(new_n131_));
  ...
  aoi21  g95(.a(new_n139_), .b(new_n136_), .c(new_n78_), .O(new_n140_));
