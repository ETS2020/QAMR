...
module FAU ( 
  ...
  and2   g28(.a(new_n61_), .b(x06), .O(z07));
  ...
  nand2  g45(.a(new_n61_), .b(x02), .O(new_n90_));
  nand3  g46(.a(x23), .b(x22), .c(x13), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n55_), .c(x21), .O(new_n92_));
  nor2   g48(.a(new_n75_), .b(x20), .O(new_n93_));
  ...
  oai21  g60(.a(new_n71_), .b(new_n66_), .c(new_n104_), .O(z12));
  ...
  oai21  g77(.a(new_n71_), .b(new_n70_), .c(new_n121_), .O(z14));
  ...
  aoi21  g85(.a(x08), .b(x06), .c(new_n46_), .O(new_n130_));
  ...
  aoi21  g96(.a(x08), .b(x07), .c(new_n46_), .O(new_n141_));
