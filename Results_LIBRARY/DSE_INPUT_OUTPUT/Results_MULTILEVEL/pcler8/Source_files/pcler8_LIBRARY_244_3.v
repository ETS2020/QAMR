...
module FAU ( 
  ...
  nand2  g021(.a(new_n65_), .b(new_n60_), .O(z03));
  nand2  g022(.a(x08), .b(x03), .O(new_n67_));
  nand2  g023(.a(new_n67_), .b(new_n60_), .O(z04));
  inv1   g024(.a(x08), .O(new_n69_));
  nor2   g025(.a(new_n59_), .b(new_n69_), .O(new_n70_));
  nand2  g026(.a(new_n70_), .b(x04), .O(new_n71_));
  inv1   g027(.a(new_n71_), .O(z05));
  nand2  g028(.a(new_n70_), .b(x05), .O(new_n73_));
  ...
  aoi21  g038(.a(new_n82_), .b(new_n69_), .c(x10), .O(new_n83_));
  ...
  aoi21  g053(.a(new_n97_), .b(new_n69_), .c(x10), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n45_), .c(new_n65_), .O(z11));
  nand2  g055(.a(new_n70_), .b(x03), .O(new_n100_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n46_), .c(x09), .d(new_n69_), .O(new_n108_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n101_), .c(new_n141_), .d(new_n79_), .O(new_n143_));
