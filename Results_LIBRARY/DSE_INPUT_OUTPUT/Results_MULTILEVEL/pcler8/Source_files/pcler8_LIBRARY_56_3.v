...
module FAU ( 
  ...
  oai21  g23(.a(new_n67_), .b(new_n66_), .c(new_n59_), .O(z03));
  nand2  g24(.a(x08), .b(x03), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n59_), .O(z04));
  nand2  g26(.a(x08), .b(x04), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(new_n59_), .O(z05));
  nand2  g28(.a(new_n61_), .b(x05), .O(new_n73_));
  inv1   g29(.a(new_n73_), .O(z06));
  nand2  g30(.a(x08), .b(x06), .O(new_n75_));
  nand2  g31(.a(new_n75_), .b(new_n59_), .O(z07));
  ...
  nand4  g38(.a(new_n82_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n83_));
  ...
  oai21  g50(.a(new_n94_), .b(new_n47_), .c(x21), .O(new_n95_));
  nand3  g51(.a(new_n50_), .b(x20), .c(x19), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n98_));
  oai21  g54(.a(new_n60_), .b(new_n66_), .c(new_n98_), .O(z11));
  ...
  nand3  g60(.a(new_n104_), .b(new_n52_), .c(x21), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n103_), .c(x08), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(x10), .c(x09), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n69_), .O(z12));
  ...
  nand4  g67(.a(new_n104_), .b(new_n53_), .c(x22), .d(x21), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n111_), .c(x08), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(x10), .c(x09), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n71_), .O(z13));
  ...
  nand4  g79(.a(new_n123_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n73_), .O(z14));
  nand2  g81(.a(new_n61_), .b(x06), .O(new_n126_));
  nand2  g82(.a(x26), .b(x17), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n54_), .c(x24), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n116_), .c(x25), .O(new_n129_));
  inv1   g85(.a(x25), .O(new_n130_));
  nand4  g86(.a(new_n121_), .b(new_n54_), .c(new_n130_), .d(x24), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n126_), .O(z15));
  nor2   g90(.a(new_n47_), .b(x18), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n51_), .O(new_n136_));
  nand3  g92(.a(new_n54_), .b(x25), .c(x24), .O(new_n137_));
  oai21  g93(.a(new_n137_), .b(new_n136_), .c(x26), .O(new_n138_));
  nor2   g94(.a(new_n120_), .b(new_n53_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n130_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n104_), .c(new_n139_), .d(new_n79_), .O(new_n141_));
  nand2  g97(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand4  g98(.a(new_n142_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n143_));
