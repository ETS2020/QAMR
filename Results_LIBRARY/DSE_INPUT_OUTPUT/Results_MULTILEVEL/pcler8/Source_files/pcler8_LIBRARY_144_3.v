...
module FAU ( 
  ...
  nand3  g36(.a(new_n81_), .b(new_n56_), .c(new_n53_), .O(z11));
  ...
  oai21  g41(.a(new_n86_), .b(new_n76_), .c(new_n84_), .O(new_n87_));
  ...
  aoi21  g51(.a(new_n96_), .b(new_n95_), .c(new_n49_), .O(z13));
  nand3  g52(.a(x23), .b(x22), .c(x21), .O(new_n98_));
  oai21  g53(.a(new_n98_), .b(new_n76_), .c(x24), .O(new_n99_));
  nand3  g54(.a(new_n47_), .b(x23), .c(x22), .O(new_n100_));
  oai21  g55(.a(new_n100_), .b(new_n83_), .c(new_n99_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n102_));
  aoi21  g57(.a(x08), .b(x05), .c(new_n49_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n102_), .O(z14));
  nand4  g59(.a(new_n48_), .b(x24), .c(x23), .d(x22), .O(new_n105_));
  oai22  g60(.a(new_n105_), .b(new_n83_), .c(new_n48_), .d(x24), .O(new_n106_));
  ...
  nand4  g64(.a(x26), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n53_), .O(z16));
  zero   g66(.O(z00));
endmodule
