...
module FAU ( 
  ...
  nand3  g062(.a(new_n106_), .b(new_n63_), .c(new_n54_), .O(z12));
  ...
  nand3  g071(.a(new_n115_), .b(new_n114_), .c(new_n54_), .O(z13));
  ...
  oai21  g090(.a(new_n55_), .b(new_n69_), .c(new_n134_), .O(z15));
  ...
  nand3  g100(.a(new_n144_), .b(new_n71_), .c(new_n54_), .O(z16));
endmodule
