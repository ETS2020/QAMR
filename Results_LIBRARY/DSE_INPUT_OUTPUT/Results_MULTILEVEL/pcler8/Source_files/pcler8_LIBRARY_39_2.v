...
module FAU ( 
  ...
  nor2   g010(.a(x14), .b(new_n47_), .O(new_n55_));
  ...
  and2   g025(.a(new_n59_), .b(x06), .O(z07));
  and2   g026(.a(new_n59_), .b(x07), .O(z08));
  ...
  nor2   g046(.a(new_n72_), .b(x20), .O(new_n91_));
  ...
  oai21  g051(.a(new_n60_), .b(new_n62_), .c(new_n95_), .O(z11));
  nor2   g052(.a(new_n80_), .b(new_n87_), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(new_n98_));
  nand2  g054(.a(x23), .b(x14), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n89_), .c(x21), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n98_), .c(x22), .O(new_n101_));
  nand3  g057(.a(new_n97_), .b(new_n73_), .c(x21), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n64_), .c(new_n56_), .O(z12));
  nand2  g061(.a(new_n59_), .b(x04), .O(new_n106_));
  ...
  oai21  g081(.a(new_n60_), .b(new_n68_), .c(new_n125_), .O(z14));
  ...
  nand4  g099(.a(new_n143_), .b(new_n97_), .c(new_n142_), .d(new_n74_), .O(new_n144_));
