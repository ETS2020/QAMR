...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_,
    ...
    new_n101_, new_n103_, new_n105_, new_n106_;
  ...
  nand3  g31(.a(new_n76_), .b(new_n54_), .c(new_n53_), .O(z10));
  ...
  nand2  g42(.a(new_n87_), .b(x21), .O(new_n88_));
  oai21  g43(.a(new_n88_), .b(new_n86_), .c(new_n85_), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n90_));
  nand2  g45(.a(x08), .b(x03), .O(new_n91_));
  aoi21  g46(.a(new_n91_), .b(new_n90_), .c(new_n49_), .O(z12));
  nand2  g47(.a(x22), .b(x21), .O(new_n93_));
  oai21  g48(.a(new_n93_), .b(new_n86_), .c(x23), .O(new_n94_));
  nand3  g49(.a(new_n47_), .b(x22), .c(x21), .O(new_n95_));
  oai21  g50(.a(new_n95_), .b(new_n86_), .c(new_n94_), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n60_), .c(new_n53_), .O(z13));
  nand3  g53(.a(new_n48_), .b(x23), .c(x22), .O(new_n99_));
  oai22  g54(.a(new_n99_), .b(new_n84_), .c(new_n48_), .d(x23), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n62_), .O(z14));
  nand3  g57(.a(new_n72_), .b(x25), .c(new_n69_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n64_), .c(new_n49_), .O(z15));
  nand2  g59(.a(x08), .b(x07), .O(new_n105_));
  nand3  g60(.a(new_n72_), .b(x26), .c(new_n69_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n53_), .O(z16));
  zero   g62(.O(z00));
endmodule
