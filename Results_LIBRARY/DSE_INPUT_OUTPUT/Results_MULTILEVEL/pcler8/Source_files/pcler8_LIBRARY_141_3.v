...
module FAU ( 
  ...
  nand2  g016(.a(new_n54_), .b(x08), .O(new_n61_));
  ...
  nand2  g037(.a(new_n62_), .b(x01), .O(new_n82_));
  ...
  nand2  g045(.a(new_n62_), .b(x02), .O(new_n90_));
  ...
  oai21  g083(.a(new_n61_), .b(new_n67_), .c(new_n127_), .O(z14));
  nor2   g084(.a(new_n114_), .b(new_n75_), .O(new_n129_));
