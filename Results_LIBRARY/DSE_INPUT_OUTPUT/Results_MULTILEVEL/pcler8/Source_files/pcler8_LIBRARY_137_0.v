...
module FAU ( 
  ...
  and2   g021(.a(new_n58_), .b(x04), .O(z05));
  inv1   g022(.a(x05), .O(new_n67_));
  nor2   g023(.a(new_n64_), .b(new_n67_), .O(z06));
  ...
  oai21  g035(.a(new_n64_), .b(new_n54_), .c(new_n79_), .O(z09));
  ...
  oai21  g069(.a(new_n113_), .b(new_n107_), .c(new_n47_), .O(new_n114_));
  ...
  oai21  g081(.a(new_n64_), .b(new_n67_), .c(new_n125_), .O(z14));
  ...
  oai21  g090(.a(new_n64_), .b(new_n69_), .c(new_n134_), .O(z15));
  ...
  nand4  g097(.a(new_n141_), .b(new_n102_), .c(new_n140_), .d(new_n75_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n144_));
  oai21  g100(.a(new_n64_), .b(new_n71_), .c(new_n144_), .O(z16));
endmodule
