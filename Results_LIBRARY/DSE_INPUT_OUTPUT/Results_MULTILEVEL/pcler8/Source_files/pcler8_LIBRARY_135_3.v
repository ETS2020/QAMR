...
module FAU ( 
  ...
  oai21  g015(.a(new_n46_), .b(new_n59_), .c(new_n54_), .O(z03));
  inv1   g016(.a(new_n54_), .O(new_n61_));
  nor2   g017(.a(new_n61_), .b(new_n46_), .O(new_n62_));
  nand2  g018(.a(new_n62_), .b(x03), .O(new_n63_));
  inv1   g019(.a(new_n63_), .O(z04));
  nand2  g020(.a(x08), .b(x04), .O(new_n65_));
  and2   g021(.a(new_n65_), .b(new_n54_), .O(new_n66_));
  inv1   g022(.a(new_n66_), .O(z05));
  nand2  g023(.a(new_n62_), .b(x05), .O(new_n68_));
  inv1   g024(.a(new_n68_), .O(z06));
  nand2  g025(.a(x08), .b(x06), .O(new_n70_));
  nand2  g026(.a(new_n70_), .b(new_n54_), .O(z07));
  nand2  g027(.a(x08), .b(x07), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n54_), .O(z08));
  ...
  nand3  g036(.a(new_n80_), .b(new_n55_), .c(new_n54_), .O(z09));
  ...
  nand3  g043(.a(new_n87_), .b(new_n57_), .c(new_n54_), .O(z10));
  ...
  nand2  g053(.a(new_n97_), .b(new_n89_), .O(z11));
  nor2   g054(.a(new_n82_), .b(new_n90_), .O(new_n99_));
  ...
  aoi21  g062(.a(x08), .b(x03), .c(new_n61_), .O(new_n107_));
