...
module FAU ( 
  ...
  nor2   g036(.a(new_n80_), .b(new_n55_), .O(new_n81_));
  ...
  nand4  g063(.a(x26), .b(x25), .c(x24), .d(x14), .O(new_n108_));
  ...
  nand3  g100(.a(new_n144_), .b(new_n143_), .c(new_n137_), .O(z15));
