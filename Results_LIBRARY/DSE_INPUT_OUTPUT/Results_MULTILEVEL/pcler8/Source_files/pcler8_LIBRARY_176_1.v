...
module FAU ( 
  ...
  oai21  g063(.a(x23), .b(x22), .c(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n97_), .b(new_n80_), .c(x21), .O(new_n109_));
  nand3  g065(.a(new_n85_), .b(x23), .c(x14), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n109_), .c(new_n108_), .O(new_n111_));
  ...
  nand4  g073(.a(new_n97_), .b(new_n54_), .c(x22), .d(x21), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n65_), .c(new_n56_), .O(z13));
  nand3  g077(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n122_));
  inv1   g078(.a(x24), .O(new_n123_));
  nand3  g079(.a(new_n97_), .b(new_n123_), .c(x21), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n122_), .c(x22), .O(new_n125_));
  ...
  aoi21  g085(.a(new_n129_), .b(new_n97_), .c(new_n123_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n131_));
  nand2  g087(.a(x08), .b(x05), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n131_), .c(new_n126_), .O(z14));
  nand2  g089(.a(new_n63_), .b(x06), .O(new_n134_));
  nand2  g090(.a(x26), .b(x17), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n97_), .c(x24), .d(x21), .O(new_n136_));
  inv1   g092(.a(x25), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(x24), .c(x23), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n107_), .O(new_n139_));
  ...
  nor2   g105(.a(new_n149_), .b(new_n107_), .O(new_n150_));
