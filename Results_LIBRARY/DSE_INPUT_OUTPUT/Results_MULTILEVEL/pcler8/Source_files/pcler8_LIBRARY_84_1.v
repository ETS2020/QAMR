...
module FAU ( 
  ...
  nor2   g010(.a(new_n47_), .b(x09), .O(new_n55_));
  inv1   g011(.a(new_n55_), .O(new_n56_));
  oai21  g012(.a(new_n46_), .b(new_n54_), .c(new_n56_), .O(z01));
  nand3  g013(.a(new_n56_), .b(x08), .c(x01), .O(new_n58_));
  ...
  oai21  g035(.a(new_n61_), .b(new_n54_), .c(new_n79_), .O(z09));
  ...
  nand2  g042(.a(new_n86_), .b(new_n58_), .O(z10));
  ...
  aoi21  g070(.a(x08), .b(x04), .c(new_n55_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(z13));
  ...
  aoi21  g081(.a(x08), .b(x05), .c(new_n55_), .O(new_n126_));
  ...
  nor2   g087(.a(new_n111_), .b(new_n74_), .O(new_n132_));
  nand4  g088(.a(new_n122_), .b(new_n132_), .c(new_n131_), .d(x24), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n135_));
  oai21  g091(.a(new_n61_), .b(new_n69_), .c(new_n135_), .O(z15));
  ...
  nor2   g096(.a(new_n121_), .b(new_n111_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n131_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n103_), .c(new_n141_), .d(new_n75_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n71_), .c(new_n56_), .O(z16));
endmodule
