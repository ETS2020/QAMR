...
module FAU ( 
  ...
  oai21  g27(.a(new_n46_), .b(new_n71_), .c(new_n54_), .O(z08));
  ...
  oai21  g53(.a(new_n97_), .b(new_n91_), .c(x22), .O(new_n98_));
  ...
  oai21  g62(.a(new_n106_), .b(new_n91_), .c(x23), .O(new_n107_));
  ...
  nor2   g83(.a(new_n108_), .b(new_n99_), .O(new_n128_));
  ...
  nand4  g94(.a(new_n138_), .b(new_n100_), .c(new_n137_), .d(new_n73_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n141_));
  oai21  g97(.a(new_n55_), .b(new_n71_), .c(new_n141_), .O(z16));
endmodule
