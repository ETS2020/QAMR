...
module FAU ( 
  ...
  oai21  g27(.a(new_n71_), .b(new_n70_), .c(new_n59_), .O(z05));
  nand2  g28(.a(x08), .b(x05), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n59_), .O(z06));
  ...
  nand4  g38(.a(new_n82_), .b(new_n46_), .c(x09), .d(new_n71_), .O(new_n83_));
  ...
  nand4  g52(.a(new_n96_), .b(new_n46_), .c(x09), .d(new_n71_), .O(new_n97_));
  ...
  nand4  g67(.a(new_n103_), .b(new_n53_), .c(x22), .d(x21), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(new_n46_), .c(x09), .d(new_n71_), .O(new_n114_));
  oai21  g70(.a(new_n60_), .b(new_n70_), .c(new_n114_), .O(z13));
