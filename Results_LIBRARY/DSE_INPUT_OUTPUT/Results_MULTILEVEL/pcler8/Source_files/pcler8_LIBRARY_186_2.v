...
module FAU ( 
  ...
  nor2   g11(.a(new_n54_), .b(new_n56_), .O(z04));
  ...
  oai21  g18(.a(new_n59_), .b(new_n63_), .c(new_n47_), .O(z07));
  inv1   g19(.a(x07), .O(new_n65_));
  nor2   g20(.a(new_n54_), .b(new_n65_), .O(z08));
  nor2   g21(.a(new_n54_), .b(new_n58_), .O(z13));
  nor2   g22(.a(new_n54_), .b(new_n63_), .O(z15));
  oai21  g23(.a(new_n59_), .b(new_n65_), .c(new_n47_), .O(z16));
  zero   g24(.O(z00));
  nand2  g25(.a(new_n48_), .b(new_n47_), .O(z09));
  nand2  g26(.a(new_n50_), .b(new_n47_), .O(z10));
  nor2   g27(.a(new_n54_), .b(new_n52_), .O(z11));
  nor2   g28(.a(new_n54_), .b(new_n56_), .O(z12));
  nor2   g29(.a(new_n54_), .b(new_n61_), .O(z14));
endmodule
