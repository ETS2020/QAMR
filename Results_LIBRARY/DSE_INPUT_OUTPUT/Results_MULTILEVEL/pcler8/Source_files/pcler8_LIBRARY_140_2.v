...
module FAU ( 
  ...
  nand3  g053(.a(new_n97_), .b(new_n61_), .c(new_n56_), .O(z11));
  nor2   g054(.a(new_n81_), .b(new_n89_), .O(new_n99_));
  ...
  aoi21  g083(.a(x08), .b(x05), .c(new_n55_), .O(new_n128_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n111_), .c(x25), .O(new_n134_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n99_), .c(new_n144_), .d(new_n75_), .O(new_n146_));
