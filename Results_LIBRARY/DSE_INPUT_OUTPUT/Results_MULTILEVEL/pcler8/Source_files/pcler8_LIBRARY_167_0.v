...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n61_, new_n63_, new_n65_, new_n67_, new_n70_, new_n71_, new_n73_,
  ...
  nand4  g012(.a(new_n56_), .b(new_n50_), .c(x09), .d(new_n47_), .O(new_n57_));
  nand2  g013(.a(new_n57_), .b(new_n46_), .O(z00));
  nor2   g014(.a(new_n45_), .b(new_n47_), .O(new_n59_));
  and2   g015(.a(new_n59_), .b(x00), .O(z01));
  inv1   g016(.a(x01), .O(new_n61_));
  oai21  g017(.a(new_n47_), .b(new_n61_), .c(new_n46_), .O(z02));
  inv1   g018(.a(x02), .O(new_n63_));
  oai21  g019(.a(new_n47_), .b(new_n63_), .c(new_n46_), .O(z03));
  ...
  and2   g024(.a(new_n59_), .b(x05), .O(z06));
  ...
  nand3  g042(.a(x23), .b(new_n49_), .c(x19), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n75_), .c(x09), .d(new_n47_), .O(new_n89_));
  oai21  g045(.a(new_n71_), .b(new_n61_), .c(new_n89_), .O(z10));
  ...
  nand3  g050(.a(x23), .b(x21), .c(new_n49_), .O(new_n95_));
  oai21  g051(.a(new_n94_), .b(new_n49_), .c(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n75_), .c(x09), .d(new_n47_), .O(new_n97_));
  oai21  g053(.a(new_n71_), .b(new_n63_), .c(new_n97_), .O(z11));
  nand2  g054(.a(new_n59_), .b(x03), .O(new_n99_));
  aoi21  g055(.a(x21), .b(x19), .c(new_n49_), .O(new_n100_));
  nand4  g056(.a(x26), .b(x25), .c(x24), .d(x14), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(x20), .c(new_n52_), .O(new_n102_));
  ...
  nand2  g062(.a(new_n106_), .b(new_n99_), .O(z12));
  nand4  g063(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x23), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(x21), .c(x19), .O(new_n110_));
  nand2  g066(.a(x21), .b(x19), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x23), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(x22), .c(x20), .O(new_n114_));
  oai21  g070(.a(new_n51_), .b(new_n49_), .c(x23), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n75_), .c(x09), .d(new_n47_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n67_), .O(z13));
  nand4  g074(.a(x24), .b(new_n75_), .c(x09), .d(new_n47_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x23), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n49_), .O(new_n121_));
  ...
  nand3  g086(.a(new_n130_), .b(new_n129_), .c(new_n121_), .O(z14));
  inv1   g087(.a(x25), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(x24), .c(x22), .O(new_n133_));
  oai22  g089(.a(new_n133_), .b(new_n125_), .c(new_n132_), .d(x20), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x23), .O(new_n135_));
  aoi21  g091(.a(x26), .b(x17), .c(new_n126_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n77_), .c(x23), .d(x19), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(x25), .c(x20), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n75_), .c(x09), .d(new_n47_), .O(new_n140_));
  oai21  g096(.a(new_n71_), .b(new_n70_), .c(new_n140_), .O(z15));
  nand2  g097(.a(new_n59_), .b(x07), .O(new_n142_));
  inv1   g098(.a(x26), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(x25), .c(x24), .d(x22), .O(new_n144_));
  oai22  g100(.a(new_n144_), .b(new_n125_), .c(new_n143_), .d(x20), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x23), .O(new_n146_));
  nor2   g102(.a(new_n111_), .b(x18), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n53_), .c(x25), .d(x24), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(x26), .c(x20), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n75_), .c(x09), .d(new_n47_), .O(new_n151_));
