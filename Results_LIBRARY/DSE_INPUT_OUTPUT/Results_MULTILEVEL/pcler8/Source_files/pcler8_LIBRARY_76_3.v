...
module FAU ( 
  ...
  nand2  g14(.a(new_n54_), .b(x04), .O(new_n59_));
  ...
  nand4  g29(.a(new_n73_), .b(new_n72_), .c(x09), .d(new_n53_), .O(new_n74_));
  nand3  g30(.a(new_n74_), .b(new_n51_), .c(new_n48_), .O(z10));
  ...
  nand4  g36(.a(new_n80_), .b(new_n72_), .c(x09), .d(new_n53_), .O(new_n81_));
  ...
  nand4  g41(.a(new_n45_), .b(x21), .c(x20), .d(x19), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand4  g43(.a(new_n87_), .b(new_n72_), .c(x09), .d(new_n53_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n57_), .O(z12));
  nand2  g45(.a(x23), .b(new_n45_), .O(new_n90_));
  nand3  g46(.a(new_n46_), .b(x22), .c(x21), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n76_), .c(new_n90_), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n72_), .c(x09), .d(new_n53_), .O(new_n93_));
  ...
  nand3  g53(.a(new_n68_), .b(x25), .c(new_n72_), .O(new_n98_));
  aoi21  g54(.a(new_n98_), .b(new_n97_), .c(z00), .O(z15));
  nand3  g55(.a(new_n68_), .b(x26), .c(new_n72_), .O(new_n100_));
