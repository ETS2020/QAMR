...
module FAU ( 
  ...
  oai21  g021(.a(new_n46_), .b(new_n65_), .c(new_n56_), .O(z05));
  ...
  inv1   g044(.a(new_n59_), .O(new_n89_));
  inv1   g045(.a(x19), .O(new_n90_));
  nand2  g046(.a(x22), .b(x13), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n82_), .c(x20), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(new_n90_), .c(x23), .O(new_n93_));
  nand3  g049(.a(new_n54_), .b(x20), .c(x19), .O(new_n94_));
  oai21  g050(.a(new_n93_), .b(new_n54_), .c(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n96_));
  oai21  g052(.a(new_n89_), .b(new_n61_), .c(new_n96_), .O(z11));
  nand2  g053(.a(new_n59_), .b(x03), .O(new_n98_));
  ...
  oai21  g059(.a(new_n103_), .b(new_n54_), .c(x22), .O(new_n104_));
  inv1   g060(.a(x22), .O(new_n105_));
  inv1   g061(.a(new_n100_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(x23), .c(new_n105_), .d(x21), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n104_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n98_), .O(z12));
  nand3  g066(.a(new_n75_), .b(x24), .c(x15), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n106_), .c(x22), .d(x21), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(x23), .c(new_n47_), .d(x09), .O(new_n113_));
  oai22  g069(.a(new_n113_), .b(x08), .c(new_n89_), .d(new_n65_), .O(z13));
  nand3  g070(.a(x26), .b(x25), .c(x16), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n106_), .c(x22), .O(new_n116_));
  inv1   g072(.a(x24), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x22), .c(x21), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n100_), .O(new_n119_));
  aoi21  g075(.a(new_n116_), .b(x24), .c(new_n119_), .O(new_n120_));
  nand2  g076(.a(x24), .b(new_n54_), .O(new_n121_));
  oai21  g077(.a(new_n120_), .b(new_n99_), .c(new_n121_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n67_), .O(z14));
  nand4  g080(.a(x19), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n125_));
  nand4  g081(.a(new_n74_), .b(x24), .c(x22), .d(x20), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n125_), .c(x23), .O(new_n127_));
  ...
  nor2   g088(.a(new_n132_), .b(new_n74_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n128_), .c(new_n69_), .O(z15));
  nor2   g091(.a(new_n100_), .b(x18), .O(new_n136_));
  nand3  g092(.a(x25), .b(x24), .c(x22), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n136_), .c(new_n45_), .O(new_n139_));
  nand4  g095(.a(new_n45_), .b(x25), .c(x24), .d(x22), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n129_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n139_), .c(x23), .O(new_n142_));
