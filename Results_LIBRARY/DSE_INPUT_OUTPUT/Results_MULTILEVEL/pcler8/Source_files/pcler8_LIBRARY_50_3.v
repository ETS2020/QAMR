...
module FAU ( 
  ...
  nand3  g26(.a(new_n71_), .b(new_n68_), .c(new_n55_), .O(z09));
  xor2a  g27(.a(x20), .b(x19), .O(new_n73_));
  nand4  g28(.a(new_n73_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n74_));
  nand2  g29(.a(x08), .b(x01), .O(new_n75_));
  nand3  g30(.a(new_n75_), .b(new_n74_), .c(new_n55_), .O(z10));
  xnor2a g31(.a(x21), .b(x20), .O(new_n77_));
  nand2  g32(.a(x21), .b(new_n70_), .O(new_n78_));
  oai21  g33(.a(new_n77_), .b(new_n70_), .c(new_n78_), .O(new_n79_));
  nand4  g34(.a(new_n79_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(new_n56_), .c(new_n49_), .O(z11));
  ...
  nand2  g51(.a(x08), .b(x04), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n96_), .c(new_n49_), .O(z13));
  nand3  g53(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  oai21  g54(.a(new_n99_), .b(new_n84_), .c(x24), .O(new_n100_));
  nand3  g55(.a(new_n47_), .b(x23), .c(x22), .O(new_n101_));
  oai21  g56(.a(new_n101_), .b(new_n82_), .c(new_n100_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n62_), .c(new_n55_), .O(z14));
  nand4  g59(.a(new_n48_), .b(x24), .c(x23), .d(x22), .O(new_n105_));
  oai22  g60(.a(new_n105_), .b(new_n82_), .c(new_n48_), .d(x24), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n64_), .O(z15));
  nand4  g63(.a(x26), .b(new_n69_), .c(x09), .d(new_n46_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n66_), .c(new_n55_), .O(z16));
  zero   g65(.O(z00));
endmodule
