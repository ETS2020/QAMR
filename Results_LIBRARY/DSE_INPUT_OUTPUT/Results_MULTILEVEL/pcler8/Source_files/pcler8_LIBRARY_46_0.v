...
module FAU ( 
  ...
  nor2   g054(.a(new_n84_), .b(new_n90_), .O(new_n99_));
  ...
  oai21  g082(.a(new_n57_), .b(new_n68_), .c(new_n126_), .O(z14));
  inv1   g083(.a(x23), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(new_n75_), .O(new_n129_));
  ...
  oai21  g091(.a(new_n135_), .b(new_n73_), .c(new_n47_), .O(new_n136_));
  ...
  oai21  g102(.a(new_n146_), .b(new_n73_), .c(new_n47_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n71_), .O(z16));
endmodule
