...
module FAU ( 
  ...
  oai22  g46(.a(new_n91_), .b(new_n85_), .c(new_n48_), .d(x22), .O(new_n92_));
  ...
  nand2  g52(.a(x08), .b(x06), .O(new_n98_));
  nand3  g53(.a(new_n72_), .b(x25), .c(new_n69_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n98_), .c(new_n49_), .O(z15));
  nand3  g55(.a(new_n72_), .b(x26), .c(new_n69_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n66_), .c(new_n49_), .O(z16));
  zero   g57(.O(z00));
endmodule
