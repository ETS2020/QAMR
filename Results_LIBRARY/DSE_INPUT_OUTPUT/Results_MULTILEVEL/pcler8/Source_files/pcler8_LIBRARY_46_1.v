...
module FAU ( 
  ...
  oai21  g023(.a(new_n46_), .b(new_n67_), .c(new_n57_), .O(z06));
  and2   g024(.a(new_n55_), .b(x06), .O(z07));
  ...
  aoi21  g034(.a(x08), .b(x00), .c(new_n54_), .O(new_n79_));
  ...
  nand3  g042(.a(new_n86_), .b(new_n58_), .c(new_n57_), .O(z10));
  ...
  nand3  g048(.a(new_n72_), .b(x20), .c(x19), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n95_));
  oai21  g051(.a(new_n61_), .b(new_n60_), .c(new_n95_), .O(z11));
  nor2   g052(.a(new_n81_), .b(new_n88_), .O(new_n97_));
  ...
  oai21  g060(.a(new_n61_), .b(new_n63_), .c(new_n104_), .O(z12));
  ...
  nand2  g068(.a(x23), .b(new_n73_), .O(new_n113_));
  ...
  oai21  g080(.a(new_n61_), .b(new_n67_), .c(new_n124_), .O(z14));
  inv1   g081(.a(x23), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n73_), .O(new_n127_));
  nand2  g083(.a(x26), .b(x17), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n127_), .c(x24), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n109_), .c(x25), .O(new_n130_));
