...
module FAU ( 
  ...
  and2   g009(.a(x26), .b(x25), .O(new_n54_));
  nand2  g010(.a(new_n54_), .b(x24), .O(new_n55_));
  nor2   g011(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  ...
  nor2   g015(.a(new_n46_), .b(new_n59_), .O(new_n60_));
  ...
  nand2  g034(.a(new_n78_), .b(new_n54_), .O(new_n79_));
  oai21  g035(.a(new_n79_), .b(new_n75_), .c(x19), .O(new_n80_));
  nand4  g036(.a(new_n80_), .b(new_n48_), .c(x09), .d(new_n59_), .O(new_n81_));
  aoi21  g037(.a(x08), .b(x00), .c(new_n46_), .O(new_n82_));
  nand2  g038(.a(new_n82_), .b(new_n81_), .O(z09));
  xor2a  g039(.a(x20), .b(x19), .O(new_n84_));
  nand4  g040(.a(new_n84_), .b(new_n48_), .c(x09), .d(new_n59_), .O(new_n85_));
  ...
  nand3  g045(.a(new_n89_), .b(new_n56_), .c(new_n50_), .O(new_n90_));
  ...
  nand4  g051(.a(new_n95_), .b(new_n48_), .c(x09), .d(new_n59_), .O(new_n96_));
  oai21  g052(.a(new_n59_), .b(new_n65_), .c(new_n96_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n47_), .O(new_n98_));
  ...
  nand3  g058(.a(new_n102_), .b(new_n100_), .c(new_n50_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n98_), .O(z11));
  nand3  g060(.a(new_n48_), .b(x09), .c(new_n59_), .O(new_n105_));
  nand3  g061(.a(new_n54_), .b(x24), .c(x22), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n105_), .c(x23), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x14), .O(new_n108_));
  inv1   g064(.a(x22), .O(new_n109_));
  nand3  g065(.a(x21), .b(x20), .c(x19), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand2  g067(.a(new_n109_), .b(x21), .O(new_n112_));
  oai22  g068(.a(new_n112_), .b(new_n51_), .c(new_n111_), .d(new_n109_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n48_), .c(x09), .d(new_n59_), .O(new_n114_));
  nand2  g070(.a(x08), .b(x03), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n114_), .c(new_n108_), .O(z12));
  nand3  g072(.a(new_n54_), .b(x24), .c(x15), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n111_), .c(x22), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x23), .O(new_n119_));
  nor2   g075(.a(x23), .b(new_n109_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n52_), .c(x21), .d(new_n45_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n48_), .c(x09), .d(new_n59_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n68_), .O(z13));
  nand3  g080(.a(new_n50_), .b(x24), .c(new_n48_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n45_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n76_), .O(new_n127_));
  nand3  g083(.a(x26), .b(x25), .c(x16), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(x22), .c(x21), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n51_), .c(x24), .O(new_n130_));
  nand4  g086(.a(new_n111_), .b(new_n77_), .c(x23), .d(x22), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n48_), .c(x09), .d(new_n59_), .O(new_n133_));
  nand2  g089(.a(x08), .b(x05), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n133_), .c(new_n127_), .O(z14));
  nand2  g091(.a(new_n60_), .b(x06), .O(new_n136_));
  nand2  g092(.a(x26), .b(x17), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n111_), .c(x24), .d(x22), .O(new_n138_));
  inv1   g094(.a(x25), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(x24), .c(x22), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n110_), .O(new_n141_));
  aoi21  g097(.a(new_n138_), .b(x25), .c(new_n141_), .O(new_n142_));
  nand3  g098(.a(x25), .b(new_n76_), .c(new_n45_), .O(new_n143_));
  oai21  g099(.a(new_n142_), .b(new_n76_), .c(new_n143_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n48_), .c(x09), .d(new_n59_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n136_), .O(z15));
  nand3  g102(.a(new_n50_), .b(x26), .c(new_n48_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n45_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n76_), .O(new_n149_));
  inv1   g105(.a(x18), .O(new_n150_));
  nand2  g106(.a(new_n52_), .b(new_n150_), .O(new_n151_));
  nand3  g107(.a(new_n74_), .b(x25), .c(x24), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n151_), .c(x26), .O(new_n153_));
  nor2   g109(.a(x26), .b(new_n139_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n78_), .c(new_n74_), .d(new_n52_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n48_), .c(x09), .d(new_n59_), .O(new_n157_));
