...
module FAU ( 
  ...
  aoi21  g011(.a(x10), .b(new_n48_), .c(new_n47_), .O(z01));
  ...
  nand2  g036(.a(new_n80_), .b(new_n74_), .O(z09));
  ...
  aoi21  g044(.a(new_n88_), .b(new_n48_), .c(x00), .O(new_n89_));
  ...
  aoi21  g069(.a(new_n113_), .b(new_n48_), .c(x00), .O(new_n114_));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n48_), .c(x00), .O(new_n124_));
  ...
  aoi21  g088(.a(new_n132_), .b(new_n48_), .c(x00), .O(new_n133_));
  ...
  nand4  g099(.a(new_n143_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n144_));
