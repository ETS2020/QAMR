...
module FAU ( 
  ...
  inv1   g022(.a(new_n60_), .O(new_n67_));
  oai21  g023(.a(new_n59_), .b(new_n66_), .c(new_n67_), .O(z03));
  nand2  g024(.a(new_n61_), .b(x03), .O(new_n69_));
  inv1   g025(.a(new_n69_), .O(z04));
  nand2  g026(.a(x08), .b(x04), .O(new_n71_));
  nand2  g027(.a(new_n71_), .b(new_n67_), .O(z05));
  inv1   g028(.a(x05), .O(new_n73_));
  oai21  g029(.a(new_n59_), .b(new_n73_), .c(new_n67_), .O(z06));
  inv1   g030(.a(x06), .O(new_n75_));
  oai21  g031(.a(new_n59_), .b(new_n75_), .c(new_n67_), .O(z07));
  nand2  g032(.a(x08), .b(x07), .O(new_n77_));
  nand2  g033(.a(new_n77_), .b(new_n67_), .O(z08));
  ...
  aoi21  g038(.a(new_n82_), .b(new_n59_), .c(x10), .O(new_n83_));
  nand2  g039(.a(x08), .b(x00), .O(new_n84_));
  oai21  g040(.a(new_n83_), .b(new_n45_), .c(new_n84_), .O(z09));
  ...
  nand4  g045(.a(new_n89_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n64_), .O(z10));
  inv1   g047(.a(new_n61_), .O(new_n92_));
  ...
  oai21  g055(.a(new_n92_), .b(new_n66_), .c(new_n99_), .O(z11));
  nor2   g056(.a(new_n49_), .b(new_n47_), .O(new_n101_));
  ...
  nand3  g061(.a(new_n101_), .b(new_n52_), .c(x21), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n69_), .O(z12));
  nand2  g065(.a(new_n61_), .b(x04), .O(new_n110_));
  ...
  nand2  g073(.a(x23), .b(new_n52_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n120_));
  ...
  oai21  g085(.a(new_n92_), .b(new_n73_), .c(new_n129_), .O(z14));
  nand2  g086(.a(x26), .b(x17), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n54_), .c(x24), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n114_), .c(x25), .O(new_n133_));
  ...
  nand4  g092(.a(new_n136_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n137_));
  oai21  g093(.a(new_n92_), .b(new_n75_), .c(new_n137_), .O(z15));
  nor2   g094(.a(new_n47_), .b(x18), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n51_), .O(new_n140_));
  nand3  g096(.a(new_n54_), .b(x25), .c(x24), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n140_), .c(x26), .O(new_n142_));
  nor2   g098(.a(new_n125_), .b(new_n53_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n134_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n101_), .c(new_n143_), .d(new_n79_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n142_), .c(x08), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(x10), .c(x09), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n77_), .O(z16));
endmodule
