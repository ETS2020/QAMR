...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n145_, new_n146_;
  nor2   g000(.a(x09), .b(x00), .O(new_n45_));
  ...
  nand3  g039(.a(new_n83_), .b(new_n77_), .c(new_n46_), .O(z09));
  ...
  nand3  g055(.a(new_n99_), .b(new_n62_), .c(new_n46_), .O(z11));
  nand2  g056(.a(x23), .b(x14), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n55_), .c(x21), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n49_), .c(x22), .O(new_n103_));
  ...
  aoi21  g062(.a(x08), .b(x03), .c(new_n45_), .O(new_n107_));
  ...
  nand2  g074(.a(new_n118_), .b(new_n67_), .O(z13));
  ...
  oai21  g083(.a(new_n65_), .b(new_n69_), .c(new_n127_), .O(z14));
  nand2  g084(.a(x26), .b(x17), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n54_), .c(x24), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n112_), .c(x25), .O(new_n131_));
  ...
  nand3  g091(.a(new_n135_), .b(new_n71_), .c(new_n46_), .O(z15));
  ...
  nand4  g098(.a(new_n142_), .b(new_n141_), .c(new_n79_), .d(new_n50_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n145_));
  aoi21  g101(.a(x08), .b(x07), .c(new_n45_), .O(new_n146_));
