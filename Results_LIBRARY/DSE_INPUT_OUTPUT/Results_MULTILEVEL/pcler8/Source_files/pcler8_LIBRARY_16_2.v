...
module FAU ( 
  ...
  oai21  g23(.a(new_n57_), .b(new_n54_), .c(new_n46_), .O(z11));
  nor2   g24(.a(new_n50_), .b(new_n56_), .O(z12));
  oai21  g25(.a(new_n57_), .b(new_n59_), .c(new_n46_), .O(z13));
  oai21  g26(.a(new_n57_), .b(new_n61_), .c(new_n46_), .O(z14));
