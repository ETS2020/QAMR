...
module FAU ( 
  ...
  nand2  g010(.a(x14), .b(x10), .O(new_n55_));
  ...
  oai21  g023(.a(new_n46_), .b(new_n67_), .c(new_n55_), .O(z06));
  ...
  nand3  g053(.a(x22), .b(x09), .c(new_n46_), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n77_), .c(new_n47_), .O(new_n99_));
  ...
  nand3  g062(.a(new_n106_), .b(new_n100_), .c(new_n63_), .O(z12));
  nand4  g063(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x22), .c(x21), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n103_), .c(x23), .O(new_n110_));
  inv1   g066(.a(x23), .O(new_n111_));
  inv1   g067(.a(new_n103_), .O(new_n112_));
  ...
  oai21  g071(.a(new_n57_), .b(new_n65_), .c(new_n115_), .O(z13));
  ...
  nand4  g076(.a(new_n102_), .b(new_n120_), .c(x23), .d(x22), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n123_));
  oai21  g079(.a(new_n57_), .b(new_n67_), .c(new_n123_), .O(z14));
  nand2  g080(.a(x26), .b(x17), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(x24), .c(x23), .d(x22), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n101_), .c(x25), .O(new_n127_));
  inv1   g083(.a(x25), .O(new_n128_));
  nor2   g084(.a(new_n111_), .b(new_n74_), .O(new_n129_));
  nand4  g085(.a(new_n102_), .b(new_n129_), .c(new_n128_), .d(x24), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n127_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n132_));
  inv1   g088(.a(new_n55_), .O(new_n133_));
  aoi21  g089(.a(x08), .b(x06), .c(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n132_), .O(z15));
  ...
  nand4  g097(.a(new_n141_), .b(new_n112_), .c(new_n140_), .d(new_n75_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n144_));
  aoi21  g100(.a(x08), .b(x07), .c(new_n133_), .O(new_n145_));
