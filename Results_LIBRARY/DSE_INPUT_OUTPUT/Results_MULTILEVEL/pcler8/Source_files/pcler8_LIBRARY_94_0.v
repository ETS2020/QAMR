...
module FAU ( 
  ...
  nand2  g020(.a(new_n64_), .b(new_n55_), .O(z06));
  ...
  nand3  g039(.a(new_n83_), .b(new_n58_), .c(new_n55_), .O(z10));
  ...
  nand2  g054(.a(new_n71_), .b(x21), .O(new_n99_));
  ...
  nor2   g061(.a(new_n105_), .b(x08), .O(new_n106_));
  inv1   g062(.a(x23), .O(new_n107_));
  nor3   g063(.a(new_n87_), .b(new_n107_), .c(new_n71_), .O(new_n108_));
  ...
  oai21  g068(.a(new_n112_), .b(new_n98_), .c(x23), .O(new_n113_));
  nand3  g069(.a(new_n107_), .b(x22), .c(x21), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n98_), .c(new_n113_), .O(new_n115_));
  ...
  nand3  g077(.a(x26), .b(x24), .c(x16), .O(new_n122_));
  oai21  g078(.a(new_n121_), .b(new_n96_), .c(new_n122_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x25), .O(new_n124_));
  nand3  g080(.a(x23), .b(x22), .c(x21), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n98_), .c(x24), .O(new_n126_));
  ...
  oai21  g090(.a(new_n134_), .b(new_n96_), .c(x25), .O(new_n135_));
  inv1   g091(.a(x25), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x23), .c(x22), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n96_), .c(new_n135_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n132_), .c(new_n66_), .O(z15));
  nand2  g096(.a(x26), .b(new_n136_), .O(new_n141_));
  nand4  g097(.a(new_n45_), .b(x25), .c(x23), .d(x22), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n96_), .c(new_n141_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x24), .O(new_n144_));
  nor2   g100(.a(new_n98_), .b(x18), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n72_), .c(x24), .d(x23), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x26), .c(x25), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n68_), .O(z16));
endmodule
