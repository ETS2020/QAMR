...
module FAU ( 
  ...
  nand2  g13(.a(new_n57_), .b(new_n46_), .O(z04));
  ...
  oai21  g22(.a(new_n55_), .b(new_n52_), .c(new_n46_), .O(z10));
  nor2   g23(.a(new_n50_), .b(new_n54_), .O(z11));
  nor2   g24(.a(new_n50_), .b(new_n63_), .O(z15));
  nor2   g25(.a(new_n50_), .b(new_n48_), .O(z09));
  nand2  g26(.a(new_n57_), .b(new_n46_), .O(z12));
