...
module FAU ( 
  ...
  oai21  g066(.a(new_n110_), .b(new_n101_), .c(new_n108_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n64_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n57_), .O(new_n114_));
  nor2   g070(.a(new_n93_), .b(new_n92_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n88_), .c(x14), .d(new_n47_), .O(new_n116_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n101_), .c(x23), .O(new_n120_));
  ...
  nand3  g085(.a(new_n88_), .b(x19), .c(new_n47_), .O(new_n130_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n125_), .c(new_n76_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n138_));
  nand2  g094(.a(x08), .b(x06), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n138_), .c(new_n133_), .O(z15));
  nand4  g096(.a(new_n74_), .b(new_n45_), .c(x25), .d(x22), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n130_), .c(x24), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x23), .O(new_n143_));
  nand4  g099(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n144_));
  nor3   g100(.a(new_n144_), .b(new_n101_), .c(x18), .O(new_n145_));
