...
module FAU ( 
  ...
  oai21  g13(.a(new_n46_), .b(new_n57_), .c(new_n55_), .O(z02));
  nand2  g14(.a(x08), .b(x02), .O(new_n59_));
  nand2  g15(.a(new_n59_), .b(new_n55_), .O(z03));
  inv1   g16(.a(x03), .O(new_n61_));
  oai21  g17(.a(new_n46_), .b(new_n61_), .c(new_n55_), .O(z04));
  nand2  g18(.a(new_n55_), .b(x08), .O(new_n63_));
  inv1   g19(.a(new_n63_), .O(new_n64_));
  nand2  g20(.a(new_n64_), .b(x04), .O(new_n65_));
  inv1   g21(.a(new_n65_), .O(z05));
  nand2  g22(.a(new_n64_), .b(x05), .O(new_n67_));
  inv1   g23(.a(new_n67_), .O(z06));
  nand2  g24(.a(x08), .b(x06), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n55_), .O(z07));
  nand2  g26(.a(new_n64_), .b(x07), .O(new_n71_));
  ...
  oai21  g33(.a(new_n63_), .b(new_n54_), .c(new_n77_), .O(z09));
  ...
  oai21  g40(.a(new_n63_), .b(new_n57_), .c(new_n84_), .O(z10));
  nand3  g41(.a(x23), .b(x22), .c(x13), .O(new_n86_));
  nand3  g42(.a(x26), .b(x25), .c(x24), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n86_), .c(x21), .O(new_n88_));
  nand3  g44(.a(new_n88_), .b(x20), .c(x19), .O(new_n89_));
  nand2  g45(.a(x20), .b(x19), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(x21), .O(new_n91_));
  aoi21  g47(.a(new_n91_), .b(new_n89_), .c(x08), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(x10), .c(x09), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n59_), .O(z11));
  nand2  g50(.a(x23), .b(x14), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n87_), .c(x21), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n90_), .c(x22), .O(new_n97_));
  ...
  oai21  g58(.a(new_n63_), .b(new_n61_), .c(new_n102_), .O(z12));
  nand4  g59(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(x23), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(x21), .c(x20), .d(x19), .O(new_n106_));
  ...
  nand2  g65(.a(new_n109_), .b(x22), .O(new_n110_));
  nand2  g66(.a(x23), .b(new_n98_), .O(new_n111_));
  ...
  oai21  g72(.a(new_n116_), .b(new_n107_), .c(x24), .O(new_n117_));
  inv1   g73(.a(x24), .O(new_n118_));
  inv1   g74(.a(new_n107_), .O(new_n119_));
  ...
  inv1   g79(.a(x23), .O(new_n124_));
  nor2   g80(.a(new_n124_), .b(new_n98_), .O(new_n125_));
  nand2  g81(.a(x26), .b(x17), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n125_), .c(x24), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n107_), .c(x25), .O(new_n128_));
  inv1   g84(.a(x25), .O(new_n129_));
  nand4  g85(.a(new_n119_), .b(new_n125_), .c(new_n129_), .d(x24), .O(new_n130_));
  ...
  nor2   g93(.a(new_n118_), .b(new_n124_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n129_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n99_), .c(new_n138_), .d(new_n73_), .O(new_n140_));
