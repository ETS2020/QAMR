...
module FAU ( 
  ...
  and2   g000(.a(x13), .b(x10), .O(new_n45_));
  ...
  aoi21  g046(.a(x08), .b(x01), .c(new_n45_), .O(new_n91_));
  ...
  nand2  g054(.a(new_n98_), .b(new_n64_), .O(z11));
  ...
  aoi21  g061(.a(x08), .b(x03), .c(new_n45_), .O(new_n106_));
  ...
  oai21  g065(.a(new_n109_), .b(new_n49_), .c(x23), .O(new_n110_));
  nand4  g066(.a(new_n50_), .b(new_n53_), .c(x22), .d(x21), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n68_), .c(new_n46_), .O(z13));
  nand2  g070(.a(new_n59_), .b(x05), .O(new_n115_));
  ...
  nand2  g081(.a(new_n59_), .b(x06), .O(new_n126_));
  ...
  nand2  g089(.a(new_n133_), .b(new_n126_), .O(z15));
  ...
  nand4  g096(.a(new_n140_), .b(new_n139_), .c(new_n77_), .d(new_n50_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n143_));
  aoi21  g099(.a(x08), .b(x07), .c(new_n45_), .O(new_n144_));
