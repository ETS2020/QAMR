...
module FAU ( 
  ...
  oai21  g017(.a(new_n46_), .b(new_n60_), .c(new_n61_), .O(z02));
  inv1   g018(.a(x02), .O(new_n63_));
  oai21  g019(.a(new_n46_), .b(new_n63_), .c(new_n61_), .O(z03));
  inv1   g020(.a(x03), .O(new_n65_));
  oai21  g021(.a(new_n46_), .b(new_n65_), .c(new_n61_), .O(z04));
  nand2  g022(.a(x08), .b(x04), .O(new_n67_));
  nand2  g023(.a(new_n67_), .b(new_n61_), .O(z05));
  and2   g024(.a(new_n57_), .b(x05), .O(z06));
  ...
  oai21  g043(.a(new_n58_), .b(new_n60_), .c(new_n87_), .O(z10));
  ...
  oai21  g053(.a(new_n58_), .b(new_n63_), .c(new_n97_), .O(z11));
  nor2   g054(.a(new_n82_), .b(new_n89_), .O(new_n99_));
  ...
  nand3  g059(.a(new_n99_), .b(new_n75_), .c(x21), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n106_));
  oai21  g062(.a(new_n58_), .b(new_n65_), .c(new_n106_), .O(z12));
  nand2  g063(.a(new_n57_), .b(x04), .O(new_n108_));
  ...
  nand2  g071(.a(x23), .b(new_n75_), .O(new_n116_));
  ...
  nor2   g079(.a(x24), .b(new_n123_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n99_), .c(new_n76_), .d(x09), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n47_), .c(new_n46_), .O(new_n127_));
  aoi21  g083(.a(x08), .b(x05), .c(new_n56_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n127_), .O(z14));
  nand3  g085(.a(new_n99_), .b(new_n47_), .c(new_n46_), .O(new_n130_));
  inv1   g086(.a(x25), .O(new_n131_));
  nand3  g087(.a(new_n76_), .b(new_n131_), .c(x23), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(x09), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x24), .O(new_n134_));
  nor2   g090(.a(new_n123_), .b(new_n75_), .O(new_n135_));
  nand2  g091(.a(x26), .b(x17), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n135_), .c(x24), .O(new_n137_));
  nor2   g093(.a(new_n137_), .b(new_n112_), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n131_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n134_), .c(new_n70_), .O(z15));
  inv1   g097(.a(x18), .O(new_n142_));
  nand4  g098(.a(x21), .b(x20), .c(x19), .d(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n135_), .b(x25), .c(x24), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n143_), .c(x26), .O(new_n145_));
  nor2   g101(.a(new_n55_), .b(new_n123_), .O(new_n146_));
  nor2   g102(.a(x26), .b(new_n131_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n99_), .c(new_n146_), .d(new_n76_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n150_));
  oai21  g106(.a(new_n58_), .b(new_n72_), .c(new_n150_), .O(z16));
endmodule
