...
module FAU ( 
  ...
  oai21  g016(.a(x10), .b(x02), .c(x08), .O(new_n61_));
  ...
  nor2   g024(.a(new_n58_), .b(new_n68_), .O(z05));
  inv1   g025(.a(x05), .O(new_n70_));
  nor2   g026(.a(new_n58_), .b(new_n70_), .O(z06));
  inv1   g027(.a(x06), .O(new_n72_));
  nor2   g028(.a(new_n58_), .b(new_n72_), .O(z07));
  nand2  g029(.a(x08), .b(x07), .O(new_n74_));
  nand2  g030(.a(new_n74_), .b(new_n66_), .O(z08));
  ...
  oai22  g036(.a(new_n80_), .b(new_n63_), .c(new_n58_), .d(new_n55_), .O(z09));
  ...
  aoi21  g044(.a(new_n88_), .b(new_n47_), .c(new_n63_), .O(new_n89_));
  oai22  g045(.a(new_n89_), .b(x10), .c(new_n47_), .d(new_n60_), .O(z10));
  ...
  nand3  g051(.a(x21), .b(new_n95_), .c(new_n47_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(new_n97_));
  aoi21  g053(.a(new_n94_), .b(x19), .c(new_n97_), .O(new_n98_));
  nand2  g054(.a(x21), .b(new_n86_), .O(new_n99_));
  oai21  g055(.a(new_n98_), .b(new_n86_), .c(new_n99_), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(x09), .c(new_n63_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(x10), .c(new_n91_), .O(z11));
  ...
  nand4  g065(.a(new_n109_), .b(x09), .c(new_n47_), .d(x02), .O(new_n110_));
  oai21  g066(.a(new_n58_), .b(new_n65_), .c(new_n110_), .O(z12));
  ...
  aoi21  g073(.a(new_n117_), .b(new_n47_), .c(new_n63_), .O(new_n118_));
  oai22  g074(.a(new_n118_), .b(x10), .c(new_n47_), .d(new_n68_), .O(z13));
  ...
  nand4  g083(.a(new_n127_), .b(x09), .c(new_n47_), .d(x02), .O(new_n128_));
  oai21  g084(.a(new_n58_), .b(new_n70_), .c(new_n128_), .O(z14));
  ...
  nor2   g089(.a(new_n115_), .b(new_n46_), .O(new_n134_));
  nand4  g090(.a(new_n125_), .b(new_n134_), .c(new_n133_), .d(x24), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n132_), .c(new_n82_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n47_), .c(new_n63_), .O(new_n137_));
  oai22  g093(.a(new_n137_), .b(x10), .c(new_n47_), .d(new_n72_), .O(z15));
  nand2  g094(.a(new_n57_), .b(x07), .O(new_n139_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n107_), .c(new_n144_), .d(new_n76_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n143_), .c(x10), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(x09), .c(new_n47_), .d(x02), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n139_), .O(z16));
endmodule
