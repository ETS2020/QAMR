...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n59_, new_n61_, new_n63_, new_n65_, new_n66_, new_n69_, new_n71_,
  ...
  and2   g023(.a(new_n66_), .b(x03), .O(z04));
  nand2  g024(.a(new_n66_), .b(x04), .O(new_n69_));
  ...
  nor3   g037(.a(new_n81_), .b(new_n45_), .c(x10), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(new_n58_), .c(new_n50_), .O(new_n83_));
  ...
  oai21  g044(.a(new_n81_), .b(x19), .c(new_n88_), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n48_), .c(x09), .d(new_n65_), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(new_n63_), .c(new_n47_), .O(z10));
  ...
  nand4  g054(.a(new_n98_), .b(new_n48_), .c(x09), .d(new_n65_), .O(new_n99_));
  ...
  nand4  g073(.a(new_n117_), .b(new_n48_), .c(x09), .d(new_n65_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n69_), .O(z13));
  nand3  g075(.a(new_n50_), .b(x24), .c(new_n48_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n45_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n54_), .O(new_n122_));
  nand3  g078(.a(x26), .b(x25), .c(x16), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x22), .c(x21), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n51_), .c(x24), .O(new_n125_));
  nor2   g081(.a(x24), .b(new_n54_), .O(new_n126_));
  ...
  nand3  g085(.a(new_n129_), .b(new_n122_), .c(new_n71_), .O(z14));
  ...
  nand4  g095(.a(new_n139_), .b(new_n48_), .c(x09), .d(new_n65_), .O(new_n140_));
  ...
  nand3  g106(.a(x26), .b(new_n54_), .c(new_n45_), .O(new_n151_));
