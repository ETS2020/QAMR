...
module FAU ( 
  ...
  oai21  g026(.a(new_n46_), .b(new_n70_), .c(new_n57_), .O(z08));
  ...
  nand3  g052(.a(new_n96_), .b(new_n60_), .c(new_n57_), .O(z11));
  ...
  nand3  g061(.a(new_n105_), .b(new_n62_), .c(new_n57_), .O(z12));
  ...
  oai21  g082(.a(new_n67_), .b(new_n66_), .c(new_n126_), .O(z14));
  inv1   g083(.a(x23), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(new_n73_), .O(new_n129_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n98_), .c(new_n143_), .d(new_n74_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n147_));
  oai21  g103(.a(new_n67_), .b(new_n70_), .c(new_n147_), .O(z16));
endmodule
