...
module FAU ( 
  ...
  oai21  g039(.a(new_n74_), .b(new_n54_), .c(new_n83_), .O(z09));
  ...
  oai21  g051(.a(new_n75_), .b(x20), .c(new_n95_), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(x24), .c(x19), .O(new_n97_));
  nand2  g053(.a(x21), .b(new_n55_), .O(new_n98_));
  ...
  nand3  g057(.a(new_n80_), .b(x23), .c(x14), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(x21), .c(x20), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(x24), .c(new_n55_), .O(new_n104_));
  nand2  g060(.a(x20), .b(x19), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(x24), .c(new_n76_), .d(x21), .O(new_n107_));
  oai21  g063(.a(new_n104_), .b(new_n76_), .c(new_n107_), .O(new_n108_));
  ...
  oai21  g070(.a(new_n75_), .b(new_n85_), .c(x23), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n76_), .O(new_n116_));
  inv1   g072(.a(x23), .O(new_n117_));
  nor2   g073(.a(new_n117_), .b(x22), .O(new_n118_));
  aoi21  g074(.a(new_n116_), .b(x19), .c(new_n118_), .O(new_n119_));
  nand2  g075(.a(x23), .b(new_n55_), .O(new_n120_));
  ...
  nand2  g081(.a(new_n80_), .b(x16), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n125_), .c(x23), .d(x22), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(x24), .c(new_n47_), .d(x09), .O(new_n128_));
  oai22  g084(.a(new_n128_), .b(x08), .c(new_n74_), .d(new_n68_), .O(z14));
  nand4  g085(.a(x20), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n130_));
  nand3  g086(.a(new_n77_), .b(new_n79_), .c(x23), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n130_), .c(x24), .O(new_n132_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n125_), .c(new_n79_), .O(new_n137_));
  ...
  oai21  g096(.a(new_n140_), .b(new_n130_), .c(x24), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x19), .O(new_n142_));
  nand3  g098(.a(new_n77_), .b(x25), .c(x23), .O(new_n143_));
  nor3   g099(.a(new_n143_), .b(new_n105_), .c(x18), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n45_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n142_), .c(new_n72_), .O(z16));
endmodule
