...
module FAU ( 
  ...
  nand2  g020(.a(new_n64_), .b(new_n59_), .O(z02));
  ...
  nand4  g038(.a(new_n82_), .b(new_n46_), .c(x09), .d(new_n71_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n62_), .O(z09));
  nand2  g040(.a(new_n61_), .b(x01), .O(new_n85_));
  ...
  nand2  g047(.a(new_n61_), .b(x02), .O(new_n92_));
  ...
  nand4  g054(.a(new_n98_), .b(new_n46_), .c(x09), .d(new_n71_), .O(new_n99_));
  ...
  nand4  g070(.a(new_n114_), .b(new_n46_), .c(x09), .d(new_n71_), .O(new_n115_));
  oai21  g071(.a(new_n60_), .b(new_n70_), .c(new_n115_), .O(z13));
  ...
  nand2  g090(.a(new_n134_), .b(new_n75_), .O(z15));
  ...
  nand4  g097(.a(new_n141_), .b(new_n105_), .c(new_n140_), .d(new_n79_), .O(new_n142_));
