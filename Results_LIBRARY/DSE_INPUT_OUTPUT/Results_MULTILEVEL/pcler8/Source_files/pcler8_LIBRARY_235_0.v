...
module FAU ( 
  ...
  nand3  g32(.a(new_n76_), .b(x09), .c(new_n46_), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(x23), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(new_n47_), .O(new_n79_));
  ...
  aoi21  g45(.a(new_n89_), .b(new_n46_), .c(new_n81_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(x10), .c(new_n60_), .O(z10));
  nand2  g47(.a(new_n56_), .b(x02), .O(new_n92_));
  nand2  g48(.a(x22), .b(x13), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n84_), .c(x20), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n87_), .c(x21), .O(new_n95_));
  inv1   g51(.a(x21), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(x20), .c(x19), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n95_), .c(new_n81_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n92_), .O(z11));
  nand2  g56(.a(x20), .b(x19), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(new_n102_));
  nand4  g58(.a(x26), .b(x25), .c(x24), .d(x14), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n102_), .c(x21), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(x22), .O(new_n105_));
  inv1   g61(.a(x22), .O(new_n106_));
  nand3  g62(.a(new_n102_), .b(new_n106_), .c(x21), .O(new_n107_));
  aoi21  g63(.a(new_n107_), .b(new_n105_), .c(new_n81_), .O(new_n108_));
  ...
  nand3  g70(.a(new_n114_), .b(x09), .c(new_n46_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n47_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n66_), .O(z13));
  nand3  g74(.a(x26), .b(x25), .c(x16), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(x22), .c(x21), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n101_), .c(x24), .O(new_n121_));
  inv1   g77(.a(x24), .O(new_n122_));
  nand4  g78(.a(new_n102_), .b(new_n122_), .c(x22), .d(x21), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n121_), .c(new_n81_), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n125_));
  oai21  g81(.a(new_n57_), .b(new_n68_), .c(new_n125_), .O(z14));
  nand2  g82(.a(x26), .b(x17), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(x24), .c(x22), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n111_), .c(x25), .O(new_n129_));
  inv1   g85(.a(new_n111_), .O(new_n130_));
  nor2   g86(.a(x25), .b(new_n122_), .O(new_n131_));
  nand3  g87(.a(new_n131_), .b(new_n130_), .c(x22), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n129_), .c(new_n82_), .O(new_n133_));
  aoi21  g89(.a(new_n133_), .b(new_n46_), .c(new_n81_), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(x10), .c(new_n70_), .O(z15));
  inv1   g91(.a(x18), .O(new_n136_));
  nand3  g92(.a(x20), .b(x19), .c(new_n136_), .O(new_n137_));
  nand4  g93(.a(x25), .b(x24), .c(x22), .d(x21), .O(new_n138_));
  oai21  g94(.a(new_n138_), .b(new_n137_), .c(x26), .O(new_n139_));
  nor2   g95(.a(new_n122_), .b(new_n106_), .O(new_n140_));
  nand4  g96(.a(new_n130_), .b(new_n140_), .c(new_n45_), .d(x25), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n139_), .c(new_n81_), .O(new_n142_));
  nand4  g98(.a(new_n142_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n143_));
  oai21  g99(.a(new_n57_), .b(new_n72_), .c(new_n143_), .O(z16));
endmodule
