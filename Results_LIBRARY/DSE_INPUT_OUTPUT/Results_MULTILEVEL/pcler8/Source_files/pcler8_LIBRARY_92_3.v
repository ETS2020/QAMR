...
module FAU ( 
  ...
  aoi21  g016(.a(new_n47_), .b(new_n46_), .c(new_n55_), .O(z03));
  ...
  nand2  g028(.a(new_n62_), .b(x00), .O(new_n73_));
  ...
  nand3  g043(.a(new_n87_), .b(new_n59_), .c(new_n57_), .O(z10));
  inv1   g044(.a(z03), .O(new_n89_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n100_), .c(new_n144_), .d(new_n76_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n71_), .c(new_n57_), .O(z16));
endmodule
