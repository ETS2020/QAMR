...
module FAU ( 
  ...
  nand2  g051(.a(new_n95_), .b(new_n60_), .O(z11));
  nand3  g052(.a(x21), .b(x20), .c(x19), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(x22), .O(new_n98_));
  nand4  g054(.a(new_n73_), .b(x21), .c(x20), .d(x19), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n101_));
  oai21  g057(.a(new_n46_), .b(new_n62_), .c(new_n101_), .O(new_n102_));
  ...
  nor3   g062(.a(new_n89_), .b(new_n106_), .c(new_n73_), .O(new_n107_));
  ...
  nand3  g066(.a(new_n106_), .b(x22), .c(x21), .O(new_n111_));
  nand4  g067(.a(x26), .b(x25), .c(x23), .d(x15), .O(new_n112_));
  oai21  g068(.a(new_n111_), .b(new_n110_), .c(new_n112_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x24), .O(new_n114_));
  oai21  g070(.a(new_n97_), .b(new_n73_), .c(x23), .O(new_n115_));
  ...
  oai21  g082(.a(new_n64_), .b(new_n68_), .c(new_n126_), .O(z14));
  nand3  g083(.a(new_n105_), .b(x25), .c(new_n47_), .O(new_n128_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n97_), .c(x25), .O(new_n133_));
  inv1   g089(.a(x25), .O(new_n134_));
  nor2   g090(.a(new_n106_), .b(new_n73_), .O(new_n135_));
  nand4  g091(.a(new_n123_), .b(new_n135_), .c(new_n134_), .d(x24), .O(new_n136_));
  ...
  nand3  g095(.a(new_n139_), .b(new_n138_), .c(new_n130_), .O(z15));
  nand3  g096(.a(new_n105_), .b(x26), .c(new_n47_), .O(new_n141_));
  ...
  nor2   g104(.a(new_n122_), .b(new_n106_), .O(new_n149_));
  nor2   g105(.a(x26), .b(new_n134_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n145_), .c(new_n149_), .d(new_n74_), .O(new_n151_));
