...
module FAU ( 
  ...
  aoi21  g39(.a(new_n84_), .b(new_n83_), .c(new_n48_), .O(z11));
  nand2  g40(.a(new_n53_), .b(x03), .O(new_n86_));
  nand3  g41(.a(x21), .b(x20), .c(x19), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n47_), .c(x22), .O(new_n88_));
  nand4  g43(.a(new_n46_), .b(x21), .c(x20), .d(x19), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n73_), .c(x09), .d(new_n52_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n86_), .O(z12));
  nand2  g47(.a(new_n53_), .b(x04), .O(new_n93_));
  nand2  g48(.a(x23), .b(new_n46_), .O(new_n94_));
  ...
  nand2  g53(.a(x08), .b(x05), .O(new_n99_));
  nand3  g54(.a(new_n69_), .b(x24), .c(new_n73_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(new_n99_), .c(new_n48_), .O(z14));
  nand3  g56(.a(new_n69_), .b(x25), .c(new_n73_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n64_), .c(new_n49_), .O(z15));
  nand2  g58(.a(x08), .b(x07), .O(new_n104_));
  nand3  g59(.a(new_n69_), .b(x26), .c(new_n73_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n104_), .c(new_n48_), .O(z16));
  zero   g61(.O(z00));
endmodule
