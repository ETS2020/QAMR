...
module FAU ( 
  ...
  nor2   g016(.a(new_n57_), .b(new_n47_), .O(new_n61_));
  ...
  nand3  g037(.a(new_n48_), .b(x09), .c(new_n47_), .O(new_n82_));
  inv1   g038(.a(new_n82_), .O(new_n83_));
  inv1   g039(.a(x20), .O(new_n84_));
  nor2   g040(.a(new_n84_), .b(x17), .O(new_n85_));
  inv1   g041(.a(x21), .O(new_n86_));
  nand2  g042(.a(x23), .b(x22), .O(new_n87_));
  inv1   g043(.a(x25), .O(new_n88_));
  nor2   g044(.a(new_n45_), .b(new_n88_), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(x24), .O(new_n90_));
  nor3   g046(.a(new_n90_), .b(new_n87_), .c(new_n86_), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n85_), .c(new_n83_), .d(x11), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n81_), .O(z09));
  xor2a  g049(.a(x20), .b(x19), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n95_));
  nand2  g051(.a(x08), .b(x01), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n58_), .O(new_n98_));
  nor2   g054(.a(new_n76_), .b(x17), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n91_), .c(new_n83_), .d(x12), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n98_), .O(z10));
  ...
  nand2  g061(.a(x08), .b(x02), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n58_), .O(new_n108_));
  nor3   g064(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n99_), .c(new_n83_), .d(x13), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n108_), .O(z11));
  nand3  g067(.a(new_n78_), .b(x14), .c(new_n48_), .O(new_n112_));
  nand3  g068(.a(new_n89_), .b(x24), .c(x22), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n112_), .c(new_n49_), .O(new_n114_));
  ...
  nand3  g078(.a(new_n89_), .b(x24), .c(x15), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n117_), .c(x22), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x23), .O(new_n125_));
  inv1   g081(.a(new_n118_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n56_), .c(x22), .d(x21), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n68_), .c(new_n58_), .O(z13));
  nand3  g086(.a(x26), .b(x25), .c(x16), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n126_), .c(x22), .d(x21), .O(new_n132_));
  inv1   g088(.a(x24), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x23), .c(x22), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n116_), .O(new_n135_));
  aoi21  g091(.a(new_n132_), .b(x24), .c(new_n135_), .O(new_n136_));
  nand2  g092(.a(x24), .b(new_n56_), .O(new_n137_));
  oai21  g093(.a(new_n136_), .b(x17), .c(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n70_), .O(z14));
  nand2  g096(.a(new_n61_), .b(x06), .O(new_n141_));
  nand3  g097(.a(x24), .b(x22), .c(x21), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n118_), .c(x25), .O(new_n143_));
  nand4  g099(.a(new_n88_), .b(x24), .c(x23), .d(x22), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n116_), .c(new_n143_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n49_), .O(new_n146_));
  nand2  g102(.a(x25), .b(new_n56_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n141_), .O(z15));
  nand2  g106(.a(new_n61_), .b(x07), .O(new_n151_));
  nor2   g107(.a(new_n118_), .b(x18), .O(new_n152_));
  nand4  g108(.a(x25), .b(x24), .c(x22), .d(x21), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n152_), .c(new_n45_), .O(new_n155_));
  nand4  g111(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n156_));
  nand4  g112(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n155_), .c(new_n49_), .O(new_n159_));
  nand2  g115(.a(x26), .b(new_n56_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n162_));
