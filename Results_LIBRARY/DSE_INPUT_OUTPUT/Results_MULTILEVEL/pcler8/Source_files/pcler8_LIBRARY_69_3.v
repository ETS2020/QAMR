...
module FAU ( 
  ...
  nand2  g017(.a(new_n59_), .b(x08), .O(new_n62_));
  ...
  nand2  g026(.a(new_n70_), .b(new_n59_), .O(z05));
  inv1   g027(.a(x05), .O(new_n72_));
  inv1   g028(.a(x08), .O(new_n73_));
  oai21  g029(.a(new_n73_), .b(new_n72_), .c(new_n59_), .O(z06));
  nand2  g030(.a(new_n63_), .b(x06), .O(new_n75_));
  inv1   g031(.a(new_n75_), .O(z07));
  nand2  g032(.a(new_n63_), .b(x07), .O(new_n77_));
  ...
  aoi21  g038(.a(new_n82_), .b(new_n73_), .c(x10), .O(new_n83_));
  oai21  g039(.a(new_n83_), .b(new_n45_), .c(new_n60_), .O(z09));
  ...
  nand4  g044(.a(new_n88_), .b(new_n46_), .c(x09), .d(new_n73_), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(new_n64_), .O(z10));
  nand2  g046(.a(new_n63_), .b(x02), .O(new_n91_));
  nand3  g047(.a(x23), .b(x22), .c(x13), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(new_n55_), .c(x21), .O(new_n93_));
  nor2   g049(.a(new_n50_), .b(x20), .O(new_n94_));
  aoi21  g050(.a(new_n93_), .b(x20), .c(new_n94_), .O(new_n95_));
  nand2  g051(.a(x21), .b(new_n47_), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(new_n47_), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n46_), .c(x09), .d(new_n73_), .O(new_n98_));
  ...
  nand3  g060(.a(new_n104_), .b(new_n52_), .c(x21), .O(new_n105_));
  ...
  nand4  g067(.a(new_n104_), .b(new_n53_), .c(x22), .d(x21), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(x08), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(x10), .c(x09), .O(new_n114_));
  ...
  oai21  g080(.a(new_n62_), .b(new_n72_), .c(new_n124_), .O(z14));
  ...
  nand4  g085(.a(new_n121_), .b(new_n54_), .c(new_n129_), .d(x24), .O(new_n130_));
  ...
  nor2   g094(.a(new_n120_), .b(new_n53_), .O(new_n139_));
  nor2   g095(.a(x26), .b(new_n129_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n104_), .c(new_n139_), .d(new_n79_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n138_), .c(x08), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(x10), .c(x09), .O(new_n143_));
