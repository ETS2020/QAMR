...
module FAU ( 
  ...
  oai21  g023(.a(new_n48_), .b(new_n67_), .c(new_n47_), .O(z04));
  ...
  aoi21  g053(.a(x08), .b(x02), .c(new_n46_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n97_), .O(z11));
  inv1   g055(.a(new_n51_), .O(new_n100_));
  ...
  aoi21  g073(.a(x08), .b(x04), .c(new_n46_), .O(new_n118_));
  ...
  aoi21  g083(.a(x08), .b(x05), .c(new_n46_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n127_), .O(z14));
  nand2  g085(.a(x26), .b(x17), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n55_), .c(x24), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n111_), .c(x25), .O(new_n132_));
  inv1   g088(.a(x25), .O(new_n133_));
  nand4  g089(.a(new_n124_), .b(new_n55_), .c(new_n133_), .d(x24), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n73_), .c(new_n47_), .O(z15));
  inv1   g093(.a(x18), .O(new_n138_));
  nand4  g094(.a(x21), .b(x20), .c(x19), .d(new_n138_), .O(new_n139_));
  nand3  g095(.a(new_n55_), .b(x25), .c(x24), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(x26), .O(new_n141_));
  nor2   g097(.a(new_n123_), .b(new_n54_), .O(new_n142_));
  nor2   g098(.a(x26), .b(new_n133_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n142_), .c(new_n78_), .d(new_n51_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n75_), .c(new_n47_), .O(z16));
endmodule
