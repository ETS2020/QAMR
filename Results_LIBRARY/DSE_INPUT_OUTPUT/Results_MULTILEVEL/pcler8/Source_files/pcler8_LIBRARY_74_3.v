...
module FAU ( 
  ...
  nand2  g010(.a(x18), .b(x10), .O(new_n55_));
  oai21  g011(.a(new_n46_), .b(new_n54_), .c(new_n55_), .O(z01));
  inv1   g012(.a(x01), .O(new_n57_));
  oai21  g013(.a(new_n46_), .b(new_n57_), .c(new_n55_), .O(z02));
  inv1   g014(.a(x02), .O(new_n59_));
  oai21  g015(.a(new_n46_), .b(new_n59_), .c(new_n55_), .O(z03));
  nand2  g016(.a(x08), .b(x03), .O(new_n61_));
  nand2  g017(.a(new_n61_), .b(new_n55_), .O(z04));
  nand2  g018(.a(x08), .b(x04), .O(new_n63_));
  and2   g019(.a(new_n63_), .b(new_n55_), .O(new_n64_));
  inv1   g020(.a(new_n64_), .O(z05));
  inv1   g021(.a(new_n55_), .O(new_n66_));
  nor2   g022(.a(new_n66_), .b(new_n46_), .O(new_n67_));
  nand2  g023(.a(new_n67_), .b(x05), .O(new_n68_));
  inv1   g024(.a(new_n68_), .O(z06));
  nand2  g025(.a(new_n67_), .b(x06), .O(new_n70_));
  ...
  oai21  g044(.a(new_n74_), .b(new_n57_), .c(new_n88_), .O(z10));
  ...
  oai21  g054(.a(new_n74_), .b(new_n59_), .c(new_n98_), .O(z11));
  nor2   g055(.a(new_n83_), .b(new_n90_), .O(new_n100_));
  ...
  aoi21  g093(.a(x08), .b(x06), .c(new_n66_), .O(new_n138_));
  ...
  nand3  g098(.a(new_n130_), .b(x25), .c(x24), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n112_), .c(x26), .O(new_n144_));
  nor2   g100(.a(new_n123_), .b(new_n129_), .O(new_n145_));
  nor2   g101(.a(x26), .b(new_n134_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n100_), .c(new_n145_), .d(new_n77_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n142_), .c(new_n72_), .O(z16));
endmodule
