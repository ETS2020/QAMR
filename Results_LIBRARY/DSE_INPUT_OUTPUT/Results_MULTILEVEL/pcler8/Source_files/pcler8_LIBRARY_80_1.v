...
module FAU ( 
  ...
  nor3   g059(.a(new_n83_), .b(new_n82_), .c(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n102_), .c(new_n75_), .O(new_n105_));
  ...
  nand2  g069(.a(new_n113_), .b(new_n63_), .O(new_n114_));
  ...
  nand4  g079(.a(new_n119_), .b(new_n123_), .c(new_n55_), .d(x22), .O(new_n124_));
  ...
  nand3  g083(.a(new_n75_), .b(x24), .c(new_n47_), .O(new_n128_));
  ...
  nor2   g089(.a(x24), .b(new_n55_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n119_), .c(x22), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n130_), .c(new_n67_), .O(z14));
  ...
  nand4  g097(.a(new_n119_), .b(new_n123_), .c(x24), .d(x22), .O(new_n142_));
  ...
  nand3  g101(.a(new_n75_), .b(x19), .c(new_n47_), .O(new_n146_));
  nor2   g102(.a(new_n81_), .b(new_n103_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n45_), .c(x24), .d(x22), .O(new_n148_));
  ...
  nor3   g107(.a(new_n151_), .b(new_n109_), .c(x18), .O(new_n152_));
