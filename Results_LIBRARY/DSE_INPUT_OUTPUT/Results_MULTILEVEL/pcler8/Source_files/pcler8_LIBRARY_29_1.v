...
module FAU ( 
  ...
  nand2  g24(.a(new_n47_), .b(x08), .O(new_n69_));
  ...
  nor2   g31(.a(new_n69_), .b(new_n75_), .O(z08));
  ...
  nand3  g38(.a(new_n82_), .b(new_n60_), .c(new_n47_), .O(z09));
  ...
  nand3  g60(.a(new_n104_), .b(new_n66_), .c(new_n47_), .O(z12));
  ...
  aoi21  g71(.a(x08), .b(x04), .c(new_n46_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n115_), .O(z13));
  ...
  inv1   g77(.a(new_n109_), .O(new_n122_));
  ...
  nand3  g81(.a(new_n125_), .b(new_n71_), .c(new_n47_), .O(z14));
  ...
  oai21  g99(.a(new_n69_), .b(new_n75_), .c(new_n143_), .O(z16));
endmodule
