...
module FAU ( 
  ...
  nand2  g036(.a(new_n80_), .b(x06), .O(new_n81_));
  ...
  oai21  g042(.a(new_n86_), .b(new_n78_), .c(x20), .O(new_n87_));
  ...
  oai22  g048(.a(new_n92_), .b(x10), .c(new_n47_), .d(new_n59_), .O(z10));
  inv1   g049(.a(x23), .O(new_n94_));
  nor2   g050(.a(new_n94_), .b(new_n46_), .O(new_n95_));
  ...
  aoi21  g056(.a(new_n100_), .b(new_n99_), .c(x10), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(x09), .c(new_n47_), .d(x06), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n63_), .O(z11));
  nand2  g059(.a(x20), .b(x19), .O(new_n104_));
  nand2  g060(.a(x23), .b(x14), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n97_), .c(x21), .O(new_n106_));
  ...
  aoi21  g065(.a(new_n109_), .b(new_n107_), .c(new_n85_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n47_), .c(new_n84_), .O(new_n111_));
  oai22  g067(.a(new_n111_), .b(x10), .c(new_n47_), .d(new_n65_), .O(z12));
  ...
  aoi21  g073(.a(new_n117_), .b(new_n115_), .c(new_n46_), .O(new_n118_));
  nor2   g074(.a(new_n94_), .b(x22), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n118_), .c(x09), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(x08), .c(x06), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n48_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n67_), .O(z13));
  nand3  g079(.a(x26), .b(x25), .c(x16), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(x23), .c(x22), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n116_), .c(x24), .O(new_n126_));
  inv1   g082(.a(x24), .O(new_n127_));
  inv1   g083(.a(new_n116_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n127_), .c(x23), .d(x22), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n126_), .c(new_n85_), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n47_), .c(new_n84_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(x10), .c(new_n69_), .O(z14));
  nand2  g088(.a(x26), .b(x17), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n95_), .c(x24), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n116_), .c(x25), .O(new_n135_));
  inv1   g091(.a(x25), .O(new_n136_));
  nand4  g092(.a(new_n128_), .b(new_n95_), .c(new_n136_), .d(x24), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n135_), .c(new_n85_), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n84_), .c(new_n48_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n71_), .O(z15));
  inv1   g096(.a(x18), .O(new_n141_));
  nand4  g097(.a(x21), .b(x20), .c(x19), .d(new_n141_), .O(new_n142_));
  nand3  g098(.a(new_n95_), .b(x25), .c(x24), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(x26), .O(new_n144_));
  nor2   g100(.a(new_n127_), .b(new_n94_), .O(new_n145_));
  nor2   g101(.a(x26), .b(new_n136_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n108_), .c(new_n145_), .d(new_n76_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n144_), .c(new_n85_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n47_), .c(new_n84_), .O(new_n149_));
