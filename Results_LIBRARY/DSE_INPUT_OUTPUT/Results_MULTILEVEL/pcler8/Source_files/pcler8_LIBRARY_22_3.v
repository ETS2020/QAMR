...
module FAU ( 
  ...
  aoi21  g025(.a(new_n47_), .b(new_n46_), .c(new_n54_), .O(z07));
  ...
  nand3  g053(.a(new_n97_), .b(new_n62_), .c(new_n59_), .O(z11));
  ...
  aoi21  g062(.a(x08), .b(x03), .c(new_n55_), .O(new_n107_));
  ...
  nand3  g083(.a(new_n127_), .b(new_n68_), .c(new_n59_), .O(z14));
  inv1   g084(.a(z07), .O(new_n129_));
  inv1   g085(.a(x23), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(new_n74_), .O(new_n131_));
  nand2  g087(.a(x26), .b(x17), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n131_), .c(x24), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n112_), .c(x25), .O(new_n134_));
  inv1   g090(.a(x25), .O(new_n135_));
  nand4  g091(.a(new_n124_), .b(new_n131_), .c(new_n135_), .d(x24), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n129_), .O(z15));
  nand2  g095(.a(new_n56_), .b(x07), .O(new_n140_));
  ...
  nor2   g100(.a(new_n123_), .b(new_n130_), .O(new_n145_));
  nor2   g101(.a(x26), .b(new_n135_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n99_), .c(new_n145_), .d(new_n75_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n140_), .O(z16));
endmodule
