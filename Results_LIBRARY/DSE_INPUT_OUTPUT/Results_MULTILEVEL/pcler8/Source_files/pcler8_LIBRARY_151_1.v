...
module FAU ( 
  ...
  oai22  g023(.a(new_n45_), .b(x04), .c(new_n48_), .d(new_n67_), .O(z04));
  ...
  oai21  g062(.a(new_n63_), .b(new_n67_), .c(new_n106_), .O(z12));
  ...
  aoi21  g090(.a(x08), .b(x06), .c(new_n46_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n134_), .O(z15));
  inv1   g092(.a(x18), .O(new_n137_));
  nand4  g093(.a(x21), .b(x20), .c(x19), .d(new_n137_), .O(new_n138_));
  nand3  g094(.a(new_n55_), .b(x25), .c(x24), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n138_), .c(x26), .O(new_n140_));
  nor2   g096(.a(new_n122_), .b(new_n54_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n131_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n141_), .c(new_n78_), .d(new_n51_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n145_));
  aoi21  g101(.a(x08), .b(x07), .c(new_n46_), .O(new_n146_));
