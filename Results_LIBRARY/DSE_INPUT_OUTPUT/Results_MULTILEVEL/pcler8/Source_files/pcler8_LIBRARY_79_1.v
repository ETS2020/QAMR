...
module FAU ( 
  ...
  nor2   g015(.a(new_n46_), .b(new_n48_), .O(new_n60_));
  ...
  oai21  g029(.a(new_n48_), .b(new_n73_), .c(new_n47_), .O(z07));
  ...
  aoi21  g038(.a(x08), .b(x00), .c(new_n46_), .O(new_n83_));
  ...
  oai21  g045(.a(new_n63_), .b(new_n62_), .c(new_n89_), .O(z10));
  ...
  oai21  g053(.a(new_n63_), .b(new_n65_), .c(new_n97_), .O(z11));
  ...
  oai21  g061(.a(new_n63_), .b(new_n67_), .c(new_n105_), .O(z12));
  ...
  oai21  g082(.a(new_n63_), .b(new_n71_), .c(new_n126_), .O(z14));
  ...
  oai21  g090(.a(new_n63_), .b(new_n73_), .c(new_n134_), .O(z15));
  ...
  nand4  g097(.a(new_n141_), .b(new_n140_), .c(new_n78_), .d(new_n51_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n75_), .c(new_n47_), .O(z16));
endmodule
