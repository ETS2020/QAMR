...
module FAU ( 
  ...
  aoi21  g012(.a(new_n56_), .b(x20), .c(new_n45_), .O(z00));
  inv1   g013(.a(x00), .O(new_n58_));
  inv1   g014(.a(x08), .O(new_n59_));
  nor2   g015(.a(new_n45_), .b(x20), .O(new_n60_));
  ...
  oai21  g023(.a(new_n59_), .b(new_n67_), .c(new_n64_), .O(z03));
  nand2  g024(.a(x08), .b(x03), .O(new_n69_));
  nand2  g025(.a(new_n69_), .b(new_n64_), .O(z04));
  ...
  nor4   g038(.a(new_n54_), .b(new_n45_), .c(new_n52_), .d(new_n51_), .O(new_n83_));
  nand3  g039(.a(new_n83_), .b(new_n82_), .c(new_n48_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n80_), .O(z09));
  inv1   g041(.a(x20), .O(new_n86_));
  oai21  g042(.a(new_n50_), .b(x23), .c(new_n86_), .O(new_n87_));
  nand2  g043(.a(new_n53_), .b(x12), .O(new_n88_));
  nand4  g044(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n89_));
  oai22  g045(.a(new_n89_), .b(new_n88_), .c(new_n86_), .d(x19), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n87_), .c(new_n65_), .O(z10));
  nand3  g048(.a(x23), .b(x22), .c(x13), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n54_), .c(x21), .O(new_n94_));
  nor2   g050(.a(new_n51_), .b(x19), .O(new_n95_));
  aoi21  g051(.a(new_n94_), .b(x19), .c(new_n95_), .O(new_n96_));
  nand3  g052(.a(new_n45_), .b(x21), .c(new_n86_), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n86_), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n99_));
  oai21  g055(.a(new_n62_), .b(new_n67_), .c(new_n99_), .O(z11));
  nand2  g056(.a(new_n61_), .b(x03), .O(new_n101_));
  nand2  g057(.a(x21), .b(x19), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  aoi21  g059(.a(x23), .b(new_n86_), .c(new_n103_), .O(new_n104_));
  nand3  g060(.a(x23), .b(x20), .c(x14), .O(new_n105_));
  oai22  g061(.a(new_n105_), .b(new_n54_), .c(x23), .d(x20), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n104_), .c(x22), .O(new_n107_));
  nand4  g063(.a(new_n52_), .b(x21), .c(x20), .d(x19), .O(new_n108_));
  ...
  nand3  g068(.a(new_n112_), .b(new_n103_), .c(x22), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x23), .O(new_n114_));
  nand3  g070(.a(new_n103_), .b(new_n45_), .c(x22), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n86_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n117_));
  oai21  g073(.a(new_n62_), .b(new_n71_), .c(new_n117_), .O(z13));
  nand3  g074(.a(new_n46_), .b(x09), .c(new_n59_), .O(new_n119_));
  inv1   g075(.a(x24), .O(new_n120_));
  nand3  g076(.a(new_n103_), .b(new_n120_), .c(x22), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n119_), .c(x20), .O(new_n122_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n103_), .c(new_n120_), .O(new_n127_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n49_), .c(x20), .O(new_n133_));
  ...
  nor2   g099(.a(new_n102_), .b(x18), .O(new_n144_));
  ...
  nand4  g103(.a(new_n143_), .b(x25), .c(x24), .d(x23), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n135_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n147_), .c(x20), .O(new_n150_));
