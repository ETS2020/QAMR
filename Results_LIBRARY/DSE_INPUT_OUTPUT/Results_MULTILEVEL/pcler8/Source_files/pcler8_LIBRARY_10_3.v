...
module FAU ( 
  ...
  nand2  g032(.a(new_n61_), .b(x08), .O(new_n77_));
  nor2   g033(.a(new_n52_), .b(new_n50_), .O(new_n78_));
  ...
  oai21  g038(.a(new_n77_), .b(new_n59_), .c(new_n82_), .O(z09));
  inv1   g039(.a(new_n77_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(x01), .O(new_n85_));
  ...
  nand2  g047(.a(new_n84_), .b(x02), .O(new_n92_));
  ...
  nand3  g061(.a(new_n105_), .b(new_n52_), .c(x21), .O(new_n106_));
  ...
  nand4  g068(.a(new_n105_), .b(new_n53_), .c(x22), .d(x21), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n115_));
  oai21  g071(.a(new_n77_), .b(new_n69_), .c(new_n115_), .O(z13));
  ...
  oai21  g081(.a(new_n77_), .b(new_n71_), .c(new_n125_), .O(z14));
  ...
  nand2  g090(.a(new_n84_), .b(x07), .O(new_n135_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n105_), .c(new_n140_), .d(new_n78_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n135_), .O(z16));
endmodule
