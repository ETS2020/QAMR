...
module FAU ( 
  ...
  nand4  g040(.a(new_n84_), .b(new_n76_), .c(x09), .d(new_n58_), .O(new_n85_));
  oai22  g041(.a(new_n85_), .b(x01), .c(new_n70_), .d(new_n57_), .O(z09));
  oai21  g042(.a(new_n76_), .b(x08), .c(x01), .O(new_n87_));
  inv1   g043(.a(x19), .O(new_n88_));
  nand2  g044(.a(new_n78_), .b(x12), .O(new_n89_));
  oai21  g045(.a(new_n89_), .b(new_n83_), .c(x19), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(x20), .O(new_n91_));
  oai21  g047(.a(x20), .b(new_n88_), .c(new_n91_), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n76_), .c(x09), .d(new_n58_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n87_), .O(z10));
  nand2  g050(.a(x08), .b(x02), .O(new_n95_));
  inv1   g051(.a(x20), .O(new_n96_));
  nand3  g052(.a(x23), .b(x22), .c(x13), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n53_), .c(x21), .O(new_n98_));
  nor2   g054(.a(new_n77_), .b(x19), .O(new_n99_));
  aoi21  g055(.a(new_n98_), .b(x19), .c(new_n99_), .O(new_n100_));
  nand2  g056(.a(x21), .b(new_n96_), .O(new_n101_));
  oai21  g057(.a(new_n100_), .b(new_n96_), .c(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(x09), .c(new_n58_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n45_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n76_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n95_), .O(z11));
  nor2   g062(.a(new_n96_), .b(new_n88_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand2  g064(.a(x23), .b(x14), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n53_), .c(x21), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n108_), .c(x22), .O(new_n111_));
  nand3  g067(.a(new_n107_), .b(new_n50_), .c(x21), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(new_n46_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n58_), .c(x01), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(x10), .c(new_n66_), .O(z12));
  nand4  g071(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x22), .c(x21), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n108_), .c(x23), .O(new_n118_));
  nand4  g074(.a(new_n107_), .b(new_n51_), .c(x22), .d(x21), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n118_), .c(x10), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n121_));
  oai21  g077(.a(new_n70_), .b(new_n68_), .c(new_n121_), .O(z13));
  nand2  g078(.a(new_n69_), .b(x05), .O(new_n123_));
  ...
  nand4  g082(.a(new_n49_), .b(new_n81_), .c(x23), .d(x22), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n126_), .c(x10), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(x09), .c(new_n58_), .d(new_n45_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n123_), .O(z14));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n58_), .c(x01), .O(new_n137_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n107_), .c(new_n82_), .d(new_n78_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n143_), .c(new_n46_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n58_), .c(x01), .O(new_n147_));
