...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    new_n52_, new_n54_, new_n55_, new_n58_, new_n59_, new_n61_, new_n62_,
  ...
  nor2   g009(.a(x17), .b(new_n47_), .O(new_n54_));
  ...
  nor2   g015(.a(new_n59_), .b(new_n58_), .O(z03));
  inv1   g016(.a(x03), .O(new_n61_));
  inv1   g017(.a(new_n54_), .O(new_n62_));
  oai21  g018(.a(new_n46_), .b(new_n61_), .c(new_n62_), .O(z04));
  nand2  g019(.a(x08), .b(x04), .O(new_n64_));
  nand2  g020(.a(new_n64_), .b(new_n62_), .O(z05));
  and2   g021(.a(new_n55_), .b(x05), .O(z06));
  inv1   g022(.a(x06), .O(new_n67_));
  nor2   g023(.a(new_n59_), .b(new_n67_), .O(z07));
  inv1   g024(.a(x07), .O(new_n69_));
  oai21  g025(.a(new_n46_), .b(new_n69_), .c(new_n62_), .O(z08));
  ...
  nand3  g048(.a(new_n71_), .b(x20), .c(x19), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n95_));
  oai21  g051(.a(new_n59_), .b(new_n58_), .c(new_n95_), .O(z11));
  nor2   g052(.a(new_n80_), .b(new_n88_), .O(new_n97_));
  ...
  oai21  g060(.a(new_n59_), .b(new_n61_), .c(new_n104_), .O(z12));
  nand2  g061(.a(new_n55_), .b(x04), .O(new_n106_));
  ...
  oai21  g092(.a(new_n59_), .b(new_n67_), .c(new_n136_), .O(z15));
  ...
  nand4  g099(.a(new_n143_), .b(new_n97_), .c(new_n142_), .d(new_n73_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n146_));
  oai21  g102(.a(new_n59_), .b(new_n69_), .c(new_n146_), .O(z16));
endmodule
