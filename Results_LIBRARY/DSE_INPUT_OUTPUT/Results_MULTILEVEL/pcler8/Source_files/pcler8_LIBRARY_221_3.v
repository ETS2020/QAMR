...
module FAU ( 
  ...
  nand2  g021(.a(new_n65_), .b(new_n45_), .O(z03));
  nand2  g022(.a(x08), .b(x03), .O(new_n67_));
  nand2  g023(.a(new_n67_), .b(new_n45_), .O(z04));
  ...
  nor2   g048(.a(new_n77_), .b(x20), .O(new_n93_));
  ...
  nand3  g053(.a(new_n97_), .b(new_n65_), .c(new_n45_), .O(z11));
  inv1   g054(.a(new_n50_), .O(new_n99_));
  ...
  nand3  g061(.a(new_n105_), .b(new_n67_), .c(new_n45_), .O(z12));
  ...
  nand2  g072(.a(new_n116_), .b(new_n69_), .O(z13));
  ...
  aoi21  g081(.a(x08), .b(x05), .c(new_n59_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n134_), .b(new_n73_), .c(new_n45_), .O(z15));
  nand2  g091(.a(x26), .b(x09), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(x08), .c(new_n47_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x18), .O(new_n138_));
  nand3  g094(.a(new_n54_), .b(x25), .c(x24), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n110_), .c(x26), .O(new_n140_));
  nor2   g096(.a(new_n121_), .b(new_n53_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n131_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n141_), .c(new_n78_), .d(new_n50_), .O(new_n143_));
  ...
  nand3  g102(.a(new_n146_), .b(new_n145_), .c(new_n138_), .O(z16));
endmodule
