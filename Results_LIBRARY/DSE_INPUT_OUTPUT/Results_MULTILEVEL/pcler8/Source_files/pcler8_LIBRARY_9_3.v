...
module FAU ( 
  ...
  nand3  g008(.a(x26), .b(x24), .c(x23), .O(new_n53_));
  ...
  inv1   g021(.a(new_n57_), .O(new_n66_));
  oai21  g022(.a(new_n47_), .b(new_n65_), .c(new_n66_), .O(z04));
  nand2  g023(.a(x08), .b(x04), .O(new_n68_));
  nand2  g024(.a(new_n68_), .b(new_n66_), .O(z05));
  inv1   g025(.a(x05), .O(new_n70_));
  oai21  g026(.a(new_n47_), .b(new_n70_), .c(new_n66_), .O(z06));
  nand2  g027(.a(x08), .b(x06), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n66_), .O(z07));
  inv1   g029(.a(x07), .O(new_n74_));
  oai21  g030(.a(new_n47_), .b(new_n74_), .c(new_n66_), .O(z08));
  ...
  oai22  g034(.a(new_n78_), .b(new_n77_), .c(x19), .d(x10), .O(new_n79_));
  nand3  g035(.a(new_n79_), .b(x09), .c(new_n47_), .O(new_n80_));
  aoi21  g036(.a(x08), .b(x00), .c(new_n57_), .O(new_n81_));
  ...
  oai21  g041(.a(new_n49_), .b(x19), .c(new_n85_), .O(new_n86_));
  nand4  g042(.a(new_n86_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n61_), .O(z10));
  ...
  nor2   g047(.a(new_n51_), .b(x20), .O(new_n92_));
  aoi21  g048(.a(new_n91_), .b(x20), .c(new_n92_), .O(new_n93_));
  nand2  g049(.a(x21), .b(new_n48_), .O(new_n94_));
  oai21  g050(.a(new_n93_), .b(new_n48_), .c(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n63_), .O(z11));
  inv1   g053(.a(new_n58_), .O(new_n98_));
  ...
  oai21  g061(.a(new_n98_), .b(new_n65_), .c(new_n105_), .O(z12));
  nand2  g062(.a(new_n58_), .b(x04), .O(new_n107_));
  ...
  oai21  g079(.a(new_n123_), .b(new_n111_), .c(new_n121_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n125_));
  oai21  g081(.a(new_n98_), .b(new_n70_), .c(new_n125_), .O(z14));
  ...
  oai21  g086(.a(new_n130_), .b(new_n111_), .c(x25), .O(new_n131_));
  nor2   g087(.a(new_n51_), .b(new_n49_), .O(new_n132_));
  nor2   g088(.a(new_n48_), .b(x10), .O(new_n133_));
  nor2   g089(.a(x25), .b(new_n122_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n128_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x09), .c(new_n47_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n72_), .c(new_n66_), .O(z15));
  nor2   g094(.a(new_n48_), .b(x18), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n132_), .O(new_n140_));
  nand3  g096(.a(new_n128_), .b(x25), .c(x24), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n140_), .c(x26), .O(new_n142_));
  nor2   g098(.a(new_n122_), .b(new_n127_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n46_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n76_), .d(new_n50_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n147_));
  oai21  g103(.a(new_n98_), .b(new_n74_), .c(new_n147_), .O(z16));
endmodule
