...
module FAU ( 
  ...
  oai21  g53(.a(new_n97_), .b(x10), .c(new_n65_), .O(z11));
  ...
  oai21  g62(.a(new_n72_), .b(new_n67_), .c(new_n106_), .O(z12));
  ...
  nand4  g78(.a(new_n122_), .b(new_n60_), .c(x09), .d(new_n58_), .O(new_n123_));
  oai21  g79(.a(new_n72_), .b(new_n71_), .c(new_n123_), .O(z14));
  ...
  oai21  g86(.a(new_n130_), .b(new_n59_), .c(new_n60_), .O(new_n131_));
  oai21  g87(.a(new_n58_), .b(new_n74_), .c(new_n131_), .O(z15));
  ...
  oai21  g96(.a(new_n140_), .b(new_n59_), .c(new_n60_), .O(new_n141_));
  oai21  g97(.a(new_n58_), .b(new_n76_), .c(new_n141_), .O(z16));
endmodule
