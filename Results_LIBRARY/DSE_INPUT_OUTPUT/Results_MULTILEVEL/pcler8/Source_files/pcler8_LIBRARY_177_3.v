...
module FAU ( 
  ...
  inv1   g30(.a(x08), .O(new_n75_));
  oai21  g31(.a(new_n75_), .b(new_n74_), .c(new_n59_), .O(z07));
  inv1   g32(.a(x07), .O(new_n77_));
  oai21  g33(.a(new_n75_), .b(new_n77_), .c(new_n59_), .O(z08));
  ...
  aoi21  g38(.a(new_n82_), .b(new_n75_), .c(x10), .O(new_n83_));
  nand2  g39(.a(x08), .b(x00), .O(new_n84_));
  oai21  g40(.a(new_n83_), .b(new_n45_), .c(new_n84_), .O(z09));
  nand3  g41(.a(x22), .b(x21), .c(x12), .O(new_n86_));
  oai21  g42(.a(new_n86_), .b(new_n81_), .c(x20), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(x19), .O(new_n88_));
  oai21  g44(.a(new_n49_), .b(x19), .c(new_n88_), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n46_), .c(x09), .d(new_n75_), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n64_), .O(z10));
  nand2  g47(.a(new_n61_), .b(x02), .O(new_n92_));
  nand3  g48(.a(x23), .b(x22), .c(x13), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n55_), .c(x21), .O(new_n94_));
  nor2   g50(.a(new_n50_), .b(x20), .O(new_n95_));
  aoi21  g51(.a(new_n94_), .b(x20), .c(new_n95_), .O(new_n96_));
  nand2  g52(.a(x21), .b(new_n47_), .O(new_n97_));
  oai21  g53(.a(new_n96_), .b(new_n47_), .c(new_n97_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n46_), .c(x09), .d(new_n75_), .O(new_n99_));
  ...
  nand3  g61(.a(new_n105_), .b(new_n52_), .c(x21), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n46_), .c(x09), .d(new_n75_), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n68_), .O(z12));
  ...
  nand4  g68(.a(new_n105_), .b(new_n53_), .c(x22), .d(x21), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n112_), .c(x08), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(x10), .c(x09), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n70_), .O(z13));
  ...
  oai21  g80(.a(new_n124_), .b(x10), .c(x09), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n72_), .O(z14));
  ...
  nand4  g88(.a(new_n132_), .b(new_n46_), .c(x09), .d(new_n75_), .O(new_n133_));
  oai21  g89(.a(new_n60_), .b(new_n74_), .c(new_n133_), .O(z15));
  ...
  nand4  g98(.a(new_n142_), .b(new_n46_), .c(x09), .d(new_n75_), .O(new_n143_));
  oai21  g99(.a(new_n60_), .b(new_n77_), .c(new_n143_), .O(z16));
endmodule
