...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n65_, new_n67_, new_n68_, new_n70_, new_n72_, new_n74_,
  ...
  and2   g017(.a(new_n60_), .b(x01), .O(z02));
  and2   g018(.a(new_n60_), .b(x02), .O(z03));
  and2   g019(.a(new_n60_), .b(x03), .O(z04));
  nand2  g020(.a(x08), .b(x04), .O(new_n65_));
  nand2  g021(.a(new_n65_), .b(new_n47_), .O(z05));
  ...
  nand2  g026(.a(new_n70_), .b(new_n47_), .O(z07));
  inv1   g027(.a(x07), .O(new_n72_));
  nor2   g028(.a(new_n68_), .b(new_n72_), .O(z08));
  ...
  aoi21  g035(.a(x08), .b(x00), .c(new_n46_), .O(new_n80_));
  ...
  aoi21  g042(.a(x08), .b(x01), .c(new_n46_), .O(new_n87_));
  ...
  nor2   g046(.a(new_n74_), .b(x20), .O(new_n91_));
  ...
  aoi21  g060(.a(x08), .b(x03), .c(new_n46_), .O(new_n105_));
  ...
  oai21  g082(.a(new_n68_), .b(new_n67_), .c(new_n126_), .O(z14));
  ...
  nand3  g090(.a(new_n134_), .b(new_n70_), .c(new_n47_), .O(z15));
  ...
  nand4  g097(.a(new_n141_), .b(new_n140_), .c(new_n75_), .d(new_n51_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n144_));
  oai21  g100(.a(new_n68_), .b(new_n72_), .c(new_n144_), .O(z16));
endmodule
