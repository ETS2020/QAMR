...
module FAU ( 
  ...
  oai21  g11(.a(new_n48_), .b(new_n55_), .c(new_n52_), .O(z03));
  inv1   g12(.a(x03), .O(new_n57_));
  oai21  g13(.a(new_n48_), .b(new_n57_), .c(new_n52_), .O(z04));
  ...
  nand3  g31(.a(new_n75_), .b(new_n53_), .c(new_n52_), .O(z10));
  inv1   g32(.a(new_n49_), .O(new_n77_));
  aoi21  g33(.a(x20), .b(x19), .c(x24), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(x21), .O(new_n79_));
  nand3  g35(.a(new_n45_), .b(x20), .c(x19), .O(new_n80_));
  nand2  g36(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand4  g37(.a(new_n81_), .b(new_n73_), .c(x09), .d(new_n48_), .O(new_n82_));
  oai21  g38(.a(new_n77_), .b(new_n55_), .c(new_n82_), .O(z11));
  nand2  g39(.a(x20), .b(x19), .O(new_n84_));
  oai21  g40(.a(new_n78_), .b(new_n45_), .c(x22), .O(new_n85_));
  inv1   g41(.a(x22), .O(new_n86_));
  nand3  g42(.a(new_n46_), .b(new_n86_), .c(x21), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n84_), .c(new_n85_), .O(new_n88_));
  nand4  g44(.a(new_n88_), .b(new_n73_), .c(x09), .d(new_n48_), .O(new_n89_));
  oai21  g45(.a(new_n77_), .b(new_n57_), .c(new_n89_), .O(z12));
  nand2  g46(.a(new_n49_), .b(x04), .O(new_n91_));
  aoi21  g47(.a(new_n84_), .b(x21), .c(new_n86_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(x24), .c(x21), .O(new_n93_));
  ...
  nand3  g53(.a(new_n97_), .b(new_n96_), .c(x22), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n94_), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n73_), .c(x09), .d(new_n48_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n91_), .O(z13));
  nand3  g57(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n84_), .c(new_n46_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n73_), .c(x09), .d(new_n48_), .O(new_n104_));
  aoi21  g60(.a(x08), .b(x05), .c(z00), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n104_), .O(z14));
  nand2  g62(.a(x08), .b(x06), .O(new_n107_));
  nand3  g63(.a(new_n69_), .b(x25), .c(new_n73_), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(new_n107_), .c(new_n52_), .O(z15));
  nand2  g65(.a(x08), .b(x07), .O(new_n110_));
  nand3  g66(.a(new_n69_), .b(x26), .c(new_n73_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n110_), .c(new_n52_), .O(z16));
endmodule
