...
module FAU ( 
  ...
  oai21  g020(.a(new_n46_), .b(new_n64_), .c(new_n58_), .O(z04));
  aoi21  g021(.a(x08), .b(x04), .c(new_n55_), .O(new_n66_));
  inv1   g022(.a(new_n66_), .O(z05));
  nand2  g023(.a(x08), .b(x05), .O(new_n68_));
  nand2  g024(.a(new_n68_), .b(new_n58_), .O(z06));
  nand2  g025(.a(new_n56_), .b(x06), .O(new_n70_));
  inv1   g026(.a(new_n70_), .O(z07));
  nand2  g027(.a(x08), .b(x07), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n58_), .O(z08));
  ...
  nand4  g041(.a(new_n85_), .b(new_n83_), .c(new_n79_), .d(new_n75_), .O(new_n86_));
  oai21  g042(.a(new_n77_), .b(new_n55_), .c(new_n86_), .O(z09));
  ...
  nand3  g049(.a(new_n93_), .b(new_n59_), .c(new_n58_), .O(z10));
  ...
  nand4  g060(.a(new_n104_), .b(new_n85_), .c(new_n81_), .d(new_n75_), .O(new_n105_));
  ...
  nand3  g064(.a(new_n108_), .b(x23), .c(x22), .O(new_n109_));
  ...
  nand3  g080(.a(new_n97_), .b(new_n124_), .c(x21), .O(new_n125_));
  ...
  aoi21  g086(.a(new_n130_), .b(new_n97_), .c(new_n124_), .O(new_n131_));
  ...
  nor2   g105(.a(new_n149_), .b(new_n115_), .O(new_n150_));
