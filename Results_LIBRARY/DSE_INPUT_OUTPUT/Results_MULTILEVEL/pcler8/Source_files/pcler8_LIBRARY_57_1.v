...
module FAU ( 
  ...
  nor2   g012(.a(new_n45_), .b(x10), .O(new_n57_));
  ...
  oai21  g023(.a(new_n67_), .b(new_n66_), .c(new_n58_), .O(z04));
  nand2  g024(.a(x08), .b(x04), .O(new_n69_));
  nand2  g025(.a(new_n69_), .b(new_n58_), .O(z05));
  inv1   g026(.a(x05), .O(new_n71_));
  nor2   g027(.a(new_n62_), .b(new_n71_), .O(z06));
  inv1   g028(.a(x06), .O(new_n73_));
  nor2   g029(.a(new_n62_), .b(new_n73_), .O(z07));
  inv1   g030(.a(x07), .O(new_n75_));
  nor2   g031(.a(new_n62_), .b(new_n75_), .O(z08));
  ...
  nand3  g036(.a(new_n80_), .b(x09), .c(new_n67_), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(new_n45_), .O(new_n82_));
  nand2  g038(.a(new_n82_), .b(new_n77_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n59_), .O(z09));
  ...
  aoi21  g045(.a(new_n89_), .b(new_n87_), .c(x17), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n77_), .c(x09), .d(new_n67_), .O(new_n91_));
  oai21  g047(.a(new_n62_), .b(new_n61_), .c(new_n91_), .O(z10));
  nand3  g048(.a(new_n58_), .b(x08), .c(x02), .O(new_n93_));
  nand3  g049(.a(x23), .b(x22), .c(x13), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n53_), .c(x21), .O(new_n95_));
  inv1   g051(.a(x21), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(x20), .O(new_n97_));
  aoi21  g053(.a(new_n95_), .b(x20), .c(new_n97_), .O(new_n98_));
  nand2  g054(.a(x21), .b(new_n88_), .O(new_n99_));
  oai21  g055(.a(new_n98_), .b(new_n88_), .c(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n45_), .c(new_n77_), .d(x09), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(x08), .c(new_n93_), .O(z11));
  ...
  aoi21  g064(.a(new_n108_), .b(new_n106_), .c(x17), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n77_), .c(x09), .d(new_n67_), .O(new_n110_));
  oai21  g066(.a(new_n62_), .b(new_n66_), .c(new_n110_), .O(z12));
  ...
  nand4  g070(.a(new_n107_), .b(new_n51_), .c(x22), .d(x21), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n46_), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n67_), .c(x17), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(x10), .c(new_n69_), .O(z13));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n121_), .c(x17), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n77_), .c(x09), .d(new_n67_), .O(new_n125_));
  oai21  g081(.a(new_n62_), .b(new_n71_), .c(new_n125_), .O(z14));
  nand3  g082(.a(x24), .b(x23), .c(x22), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n48_), .c(x25), .O(new_n128_));
  ...
  aoi21  g087(.a(new_n131_), .b(new_n67_), .c(x17), .O(new_n132_));
  oai22  g088(.a(new_n132_), .b(x10), .c(new_n67_), .d(new_n73_), .O(z15));
  ...
  nor2   g093(.a(new_n50_), .b(new_n96_), .O(new_n138_));
  nor2   g094(.a(new_n122_), .b(new_n51_), .O(new_n139_));
  nor2   g095(.a(x26), .b(new_n129_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n107_), .c(new_n139_), .d(new_n138_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n137_), .c(new_n46_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n67_), .c(x17), .O(new_n143_));
