...
module FAU ( 
  ...
  nand2  g017(.a(new_n57_), .b(x08), .O(new_n62_));
  ...
  oai21  g043(.a(new_n62_), .b(new_n59_), .c(new_n87_), .O(z10));
  ...
  oai21  g053(.a(new_n62_), .b(new_n61_), .c(new_n97_), .O(z11));
  nand3  g054(.a(x14), .b(new_n47_), .c(new_n46_), .O(new_n99_));
  inv1   g055(.a(x25), .O(new_n100_));
  nor2   g056(.a(new_n45_), .b(new_n100_), .O(new_n101_));
  inv1   g057(.a(x23), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n75_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n99_), .c(x09), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(x24), .O(new_n106_));
  nand3  g062(.a(x21), .b(x20), .c(x19), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nor2   g064(.a(new_n82_), .b(new_n89_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n75_), .c(x21), .O(new_n110_));
  oai21  g066(.a(new_n108_), .b(new_n75_), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n112_));
  nand2  g068(.a(x08), .b(x03), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n112_), .c(new_n106_), .O(z12));
  nand2  g070(.a(new_n102_), .b(x09), .O(new_n115_));
  ...
  nand3  g074(.a(new_n107_), .b(x23), .c(x09), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n118_), .c(new_n75_), .O(new_n120_));
  nand3  g076(.a(x23), .b(new_n75_), .c(x09), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n120_), .c(new_n47_), .O(new_n123_));
  aoi21  g079(.a(x08), .b(x04), .c(new_n56_), .O(new_n124_));
  oai21  g080(.a(new_n123_), .b(x08), .c(new_n124_), .O(z13));
  nand2  g081(.a(new_n101_), .b(x16), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(x23), .c(x22), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n107_), .c(x24), .O(new_n128_));
  nor2   g084(.a(x24), .b(new_n102_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n109_), .c(new_n76_), .d(x09), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n47_), .c(new_n46_), .O(new_n132_));
  aoi21  g088(.a(x08), .b(x05), .c(new_n56_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n132_), .O(z14));
  nand2  g090(.a(x26), .b(x17), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n103_), .c(x24), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n107_), .c(x25), .O(new_n137_));
  nand4  g093(.a(new_n108_), .b(new_n103_), .c(new_n100_), .d(x24), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n140_));
  oai21  g096(.a(new_n62_), .b(new_n70_), .c(new_n140_), .O(z15));
  nand3  g097(.a(new_n109_), .b(new_n47_), .c(new_n46_), .O(new_n142_));
  ...
  nand3  g103(.a(new_n103_), .b(x25), .c(x24), .O(new_n148_));
  ...
  nand3  g107(.a(new_n151_), .b(new_n145_), .c(new_n72_), .O(z16));
endmodule
