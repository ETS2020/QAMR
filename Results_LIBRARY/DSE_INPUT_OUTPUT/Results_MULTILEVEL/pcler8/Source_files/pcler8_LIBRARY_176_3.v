...
module FAU ( 
  ...
  oai21  g47(.a(new_n92_), .b(new_n77_), .c(new_n47_), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n73_), .c(x09), .d(new_n54_), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n60_), .c(new_n49_), .O(z13));
  nand2  g50(.a(x08), .b(x05), .O(new_n96_));
  nand3  g51(.a(new_n69_), .b(x24), .c(new_n73_), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n49_), .O(z14));
  nand3  g53(.a(new_n69_), .b(x25), .c(new_n73_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n64_), .c(new_n48_), .O(z15));
  nand2  g55(.a(x08), .b(x07), .O(new_n101_));
  nand3  g56(.a(new_n69_), .b(x26), .c(new_n73_), .O(new_n102_));
