...
module FAU ( 
  ...
  nor2   g07(.a(new_n50_), .b(new_n47_), .O(new_n53_));
  ...
  oai21  g17(.a(new_n47_), .b(new_n62_), .c(new_n51_), .O(z06));
  ...
  inv1   g22(.a(new_n53_), .O(new_n68_));
  ...
  nand2  g32(.a(new_n77_), .b(new_n54_), .O(z10));
  xor2a  g33(.a(x21), .b(x20), .O(new_n79_));
  nand3  g34(.a(new_n79_), .b(new_n49_), .c(x19), .O(new_n80_));
  nand2  g35(.a(x21), .b(new_n48_), .O(new_n81_));
  ...
  nor2   g42(.a(x24), .b(x22), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(x21), .c(x20), .d(x19), .O(new_n89_));
  oai21  g44(.a(new_n87_), .b(new_n85_), .c(new_n89_), .O(new_n90_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n69_), .c(x09), .d(new_n47_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n60_), .O(z13));
  nand3  g57(.a(new_n49_), .b(x23), .c(x22), .O(new_n103_));
  oai22  g58(.a(new_n103_), .b(new_n96_), .c(new_n49_), .d(x19), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n69_), .c(x09), .d(new_n47_), .O(new_n105_));
  oai21  g60(.a(new_n68_), .b(new_n62_), .c(new_n105_), .O(z14));
  nand3  g61(.a(new_n71_), .b(x25), .c(new_n69_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n64_), .c(new_n51_), .O(z15));
