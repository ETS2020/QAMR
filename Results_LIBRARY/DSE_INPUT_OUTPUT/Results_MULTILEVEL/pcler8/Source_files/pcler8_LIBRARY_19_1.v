...
module FAU ( 
  ...
  nor2   g23(.a(new_n62_), .b(new_n67_), .O(z04));
  nand2  g24(.a(x08), .b(x04), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n46_), .O(z05));
  nand2  g26(.a(x08), .b(x05), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(new_n46_), .O(z06));
  inv1   g28(.a(x06), .O(new_n73_));
  oai21  g29(.a(new_n47_), .b(new_n73_), .c(new_n46_), .O(z07));
  inv1   g30(.a(x07), .O(new_n75_));
  oai21  g31(.a(new_n47_), .b(new_n75_), .c(new_n46_), .O(z08));
  ...
  oai21  g38(.a(new_n62_), .b(new_n59_), .c(new_n82_), .O(z09));
  ...
  nand4  g45(.a(new_n89_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n90_));
  nand2  g46(.a(x08), .b(x01), .O(new_n91_));
  nand3  g47(.a(new_n91_), .b(new_n90_), .c(new_n46_), .O(z10));
  nand3  g48(.a(x23), .b(x22), .c(x13), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n55_), .c(x21), .O(new_n94_));
  nor2   g50(.a(new_n77_), .b(x20), .O(new_n95_));
  ...
  oai21  g58(.a(new_n102_), .b(new_n49_), .c(x22), .O(new_n103_));
  nand3  g59(.a(new_n50_), .b(new_n52_), .c(x21), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n106_));
  oai21  g62(.a(new_n62_), .b(new_n67_), .c(new_n106_), .O(z12));
  nand4  g63(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(x22), .c(x21), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n49_), .c(x23), .O(new_n110_));
  nand4  g66(.a(new_n50_), .b(new_n53_), .c(x22), .d(x21), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n69_), .c(new_n46_), .O(z13));
  ...
  nand4  g78(.a(new_n122_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n123_));
  nand3  g79(.a(new_n123_), .b(new_n71_), .c(new_n46_), .O(z14));
  ...
  oai21  g87(.a(new_n62_), .b(new_n73_), .c(new_n131_), .O(z15));
  ...
  nand4  g94(.a(new_n138_), .b(new_n137_), .c(new_n78_), .d(new_n50_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n141_));
  oai21  g97(.a(new_n62_), .b(new_n75_), .c(new_n141_), .O(z16));
endmodule
