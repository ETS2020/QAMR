...
module FAU ( 
  ...
  inv1   g026(.a(new_n60_), .O(new_n71_));
  oai21  g027(.a(new_n59_), .b(new_n70_), .c(new_n71_), .O(z05));
  nand2  g028(.a(new_n61_), .b(x05), .O(new_n73_));
  inv1   g029(.a(new_n73_), .O(z06));
  nand2  g030(.a(x08), .b(x06), .O(new_n75_));
  nand2  g031(.a(new_n75_), .b(new_n71_), .O(z07));
  ...
  aoi21  g055(.a(new_n99_), .b(new_n59_), .c(x10), .O(new_n100_));
  ...
  oai21  g071(.a(new_n115_), .b(new_n104_), .c(x23), .O(new_n116_));
  nand4  g072(.a(new_n103_), .b(new_n53_), .c(x22), .d(x21), .O(new_n117_));
  ...
  nand2  g085(.a(new_n129_), .b(new_n73_), .O(z14));
  ...
  nand4  g100(.a(new_n144_), .b(new_n103_), .c(new_n143_), .d(new_n79_), .O(new_n145_));
