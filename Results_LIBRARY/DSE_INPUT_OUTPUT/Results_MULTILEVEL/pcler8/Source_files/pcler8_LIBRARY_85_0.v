...
module FAU ( 
  ...
  aoi21  g49(.a(new_n93_), .b(new_n91_), .c(x08), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n87_), .c(new_n47_), .O(new_n95_));
  ...
  oai21  g67(.a(new_n111_), .b(new_n87_), .c(new_n47_), .O(new_n112_));
  ...
  oai21  g77(.a(new_n121_), .b(new_n87_), .c(new_n47_), .O(new_n122_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n101_), .c(new_n138_), .d(new_n73_), .O(new_n140_));
