...
module FAU ( 
  ...
  oai21  g21(.a(new_n66_), .b(new_n50_), .c(new_n53_), .O(z10));
  oai21  g22(.a(new_n66_), .b(new_n58_), .c(new_n53_), .O(z13));
  zero   g23(.O(z00));
  nor2   g24(.a(new_n48_), .b(new_n46_), .O(z09));
  nand2  g25(.a(new_n54_), .b(new_n53_), .O(z11));
  nor2   g26(.a(new_n48_), .b(new_n56_), .O(z12));
  nor2   g27(.a(new_n48_), .b(new_n60_), .O(z14));
  nor2   g28(.a(new_n48_), .b(new_n62_), .O(z15));
