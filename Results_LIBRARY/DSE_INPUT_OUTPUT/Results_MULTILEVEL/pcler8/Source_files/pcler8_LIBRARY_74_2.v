...
module FAU ( 
  ...
  oai21  g016(.a(new_n46_), .b(new_n60_), .c(new_n56_), .O(z03));
  ...
  nand2  g022(.a(new_n56_), .b(x08), .O(new_n67_));
  nor2   g023(.a(new_n67_), .b(new_n66_), .O(z06));
  inv1   g024(.a(x06), .O(new_n69_));
  nor2   g025(.a(new_n67_), .b(new_n69_), .O(z07));
  ...
  oai21  g042(.a(new_n67_), .b(new_n58_), .c(new_n86_), .O(z10));
  ...
  oai21  g052(.a(new_n67_), .b(new_n60_), .c(new_n96_), .O(z11));
  ...
  nand3  g061(.a(new_n105_), .b(new_n62_), .c(new_n56_), .O(z12));
  ...
  oai21  g081(.a(new_n67_), .b(new_n66_), .c(new_n125_), .O(z14));
  ...
  nand3  g102(.a(new_n146_), .b(new_n71_), .c(new_n56_), .O(z16));
endmodule
