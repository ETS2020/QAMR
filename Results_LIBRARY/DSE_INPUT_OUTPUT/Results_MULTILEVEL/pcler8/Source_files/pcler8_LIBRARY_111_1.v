...
module FAU ( 
  ...
  oai21  g023(.a(new_n59_), .b(new_n67_), .c(new_n56_), .O(z05));
  ...
  nand4  g033(.a(new_n77_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n78_));
  nand3  g034(.a(new_n78_), .b(new_n57_), .c(new_n56_), .O(z09));
  nand3  g035(.a(x23), .b(x21), .c(x12), .O(new_n80_));
  oai21  g036(.a(new_n80_), .b(new_n51_), .c(x20), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(x19), .O(new_n82_));
  oai21  g038(.a(new_n49_), .b(x19), .c(new_n82_), .O(new_n83_));
  nand4  g039(.a(new_n83_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n84_));
  aoi21  g040(.a(x08), .b(x01), .c(new_n55_), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(new_n84_), .O(z10));
  nand2  g042(.a(x20), .b(x19), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(new_n88_));
  nand3  g044(.a(new_n50_), .b(x20), .c(x19), .O(new_n89_));
  oai21  g045(.a(new_n88_), .b(new_n50_), .c(new_n89_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n91_));
  oai21  g047(.a(new_n59_), .b(new_n62_), .c(new_n91_), .O(new_n92_));
  ...
  nor3   g052(.a(new_n51_), .b(new_n45_), .c(new_n96_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n95_), .c(new_n48_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n93_), .O(z11));
  nand2  g055(.a(x23), .b(x14), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n51_), .c(x21), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n87_), .c(x22), .O(new_n102_));
  nand4  g058(.a(new_n88_), .b(new_n45_), .c(new_n96_), .d(x21), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n105_));
  oai21  g061(.a(new_n63_), .b(new_n65_), .c(new_n105_), .O(z12));
  nand4  g062(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n88_), .c(x21), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x23), .O(new_n109_));
  nand3  g065(.a(new_n88_), .b(new_n45_), .c(x21), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n109_), .c(new_n96_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n112_));
  oai21  g068(.a(new_n63_), .b(new_n67_), .c(new_n112_), .O(z13));
  nand3  g069(.a(new_n46_), .b(x09), .c(new_n59_), .O(new_n114_));
  inv1   g070(.a(x24), .O(new_n115_));
  nand3  g071(.a(new_n88_), .b(new_n115_), .c(x21), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n114_), .c(x22), .O(new_n117_));
  ...
  aoi21  g077(.a(new_n121_), .b(new_n88_), .c(new_n115_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n118_), .c(new_n69_), .O(z14));
  nand2  g080(.a(x26), .b(x17), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n88_), .c(x24), .d(x21), .O(new_n126_));
  ...
  aoi21  g086(.a(new_n126_), .b(x25), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(x25), .b(new_n45_), .O(new_n132_));
  oai21  g088(.a(new_n131_), .b(new_n96_), .c(new_n132_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n71_), .O(z15));
  inv1   g091(.a(x26), .O(new_n136_));
  nor2   g092(.a(new_n87_), .b(x18), .O(new_n137_));
  ...
  nand4  g096(.a(new_n136_), .b(x25), .c(x24), .d(x23), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n127_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n140_), .c(x22), .O(new_n143_));
  nand2  g099(.a(x26), .b(new_n45_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n146_));
