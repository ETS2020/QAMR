...
module FAU ( 
  ...
  oai21  g017(.a(new_n46_), .b(new_n61_), .c(new_n57_), .O(z03));
  nor2   g018(.a(new_n56_), .b(new_n46_), .O(new_n63_));
  nand2  g019(.a(new_n63_), .b(x03), .O(new_n64_));
  ...
  aoi21  g025(.a(new_n47_), .b(new_n46_), .c(new_n55_), .O(z07));
  nand2  g026(.a(new_n63_), .b(x07), .O(new_n71_));
  inv1   g027(.a(new_n71_), .O(z08));
  inv1   g028(.a(new_n63_), .O(new_n73_));
  ...
  oai21  g036(.a(new_n73_), .b(new_n54_), .c(new_n80_), .O(z09));
  ...
  oai21  g043(.a(new_n73_), .b(new_n59_), .c(new_n87_), .O(z10));
  ...
  oai21  g053(.a(new_n73_), .b(new_n61_), .c(new_n97_), .O(z11));
  ...
  nand2  g064(.a(new_n63_), .b(x04), .O(new_n109_));
  ...
  nand2  g072(.a(x23), .b(new_n75_), .O(new_n117_));
  ...
  oai21  g084(.a(new_n73_), .b(new_n68_), .c(new_n128_), .O(z14));
  inv1   g085(.a(z07), .O(new_n130_));
  ...
  nand2  g095(.a(new_n139_), .b(new_n130_), .O(z15));
  ...
  nand4  g102(.a(new_n146_), .b(new_n99_), .c(new_n145_), .d(new_n76_), .O(new_n147_));
