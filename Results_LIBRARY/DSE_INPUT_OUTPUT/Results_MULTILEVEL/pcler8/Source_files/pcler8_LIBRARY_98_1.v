...
module FAU ( 
  ...
  nor2   g010(.a(new_n47_), .b(x06), .O(new_n55_));
  ...
  nand2  g020(.a(new_n64_), .b(new_n56_), .O(z05));
  inv1   g021(.a(x05), .O(new_n66_));
  oai21  g022(.a(new_n46_), .b(new_n66_), .c(new_n56_), .O(z06));
  ...
  nor2   g027(.a(new_n71_), .b(new_n70_), .O(z08));
  ...
  oai21  g035(.a(new_n71_), .b(new_n54_), .c(new_n79_), .O(z09));
  ...
  oai21  g042(.a(new_n71_), .b(new_n58_), .c(new_n86_), .O(z10));
  ...
  oai21  g052(.a(new_n71_), .b(new_n60_), .c(new_n96_), .O(z11));
  ...
  oai21  g083(.a(new_n71_), .b(new_n66_), .c(new_n127_), .O(z14));
  ...
  nand3  g094(.a(new_n138_), .b(new_n129_), .c(new_n56_), .O(z15));
  ...
  nor2   g099(.a(new_n123_), .b(new_n130_), .O(new_n144_));
  ...
  oai21  g104(.a(new_n71_), .b(new_n70_), .c(new_n148_), .O(z16));
endmodule
