...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n61_, new_n62_, new_n64_, new_n66_, new_n67_, new_n69_, new_n71_,
  ...
  oai21  g27(.a(new_n62_), .b(new_n71_), .c(new_n58_), .O(z06));
  nand2  g28(.a(x08), .b(x06), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n58_), .O(z07));
  nand3  g30(.a(x10), .b(x08), .c(x07), .O(new_n75_));
  inv1   g31(.a(new_n75_), .O(z08));
  aoi21  g32(.a(new_n57_), .b(x07), .c(new_n62_), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(x00), .O(new_n78_));
  ...
  nand4  g38(.a(new_n82_), .b(new_n57_), .c(x09), .d(new_n62_), .O(new_n83_));
  oai21  g39(.a(new_n83_), .b(x07), .c(new_n78_), .O(z09));
  ...
  nand4  g46(.a(new_n90_), .b(x09), .c(new_n62_), .d(new_n45_), .O(new_n91_));
  oai21  g47(.a(new_n67_), .b(new_n61_), .c(new_n91_), .O(z10));
  nand3  g48(.a(x23), .b(x22), .c(x13), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n53_), .c(x21), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(x20), .c(x19), .O(new_n95_));
  nand2  g51(.a(x20), .b(x19), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(x21), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n95_), .c(new_n46_), .O(new_n98_));
  aoi21  g54(.a(new_n98_), .b(new_n62_), .c(x07), .O(new_n99_));
  ...
  oai21  g58(.a(new_n102_), .b(new_n96_), .c(x22), .O(new_n103_));
  inv1   g59(.a(new_n96_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n50_), .c(x21), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n103_), .c(new_n46_), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n62_), .c(x07), .O(new_n107_));
  nand2  g63(.a(x08), .b(x03), .O(new_n108_));
  oai21  g64(.a(new_n107_), .b(x10), .c(new_n108_), .O(z12));
  nand4  g65(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(x22), .c(x21), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n96_), .c(x23), .O(new_n112_));
  nand4  g68(.a(new_n104_), .b(new_n51_), .c(x22), .d(x21), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n112_), .c(new_n46_), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n62_), .c(x07), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(x10), .c(new_n69_), .O(z13));
  nand3  g72(.a(x26), .b(x25), .c(x16), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(x23), .c(x22), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n48_), .c(x24), .O(new_n119_));
  inv1   g75(.a(x24), .O(new_n120_));
  nand4  g76(.a(new_n49_), .b(new_n120_), .c(x23), .d(x22), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n119_), .c(x10), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(x09), .c(new_n62_), .d(new_n45_), .O(new_n123_));
  oai21  g79(.a(new_n67_), .b(new_n71_), .c(new_n123_), .O(z14));
  nand2  g80(.a(new_n77_), .b(x06), .O(new_n125_));
  ...
  aoi21  g86(.a(new_n130_), .b(new_n128_), .c(new_n46_), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n62_), .c(x07), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(x10), .c(new_n125_), .O(z15));
  ...
  nand4  g97(.a(new_n141_), .b(x09), .c(new_n62_), .d(new_n45_), .O(new_n142_));
