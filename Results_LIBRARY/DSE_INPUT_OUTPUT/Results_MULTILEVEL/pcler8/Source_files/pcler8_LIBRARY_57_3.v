...
module FAU ( 
  ...
  nand4  g010(.a(new_n54_), .b(new_n52_), .c(new_n49_), .d(x21), .O(new_n55_));
  nand2  g011(.a(new_n55_), .b(new_n45_), .O(z00));
  nand2  g012(.a(x08), .b(x00), .O(new_n57_));
  nand2  g013(.a(new_n57_), .b(new_n45_), .O(z01));
  nand2  g014(.a(new_n45_), .b(x08), .O(new_n59_));
  inv1   g015(.a(new_n59_), .O(new_n60_));
  nand2  g016(.a(new_n60_), .b(x01), .O(new_n61_));
  inv1   g017(.a(new_n61_), .O(z02));
  nand2  g018(.a(x08), .b(x02), .O(new_n63_));
  nand2  g019(.a(new_n63_), .b(new_n45_), .O(z03));
  inv1   g020(.a(x03), .O(new_n65_));
  oai21  g021(.a(new_n46_), .b(new_n65_), .c(new_n45_), .O(z04));
  nand2  g022(.a(x08), .b(x04), .O(new_n67_));
  nand2  g023(.a(new_n67_), .b(new_n45_), .O(z05));
  ...
  nand4  g036(.a(new_n80_), .b(new_n75_), .c(x09), .d(new_n46_), .O(new_n81_));
  nand3  g037(.a(new_n81_), .b(new_n57_), .c(new_n45_), .O(z09));
  ...
  nand2  g054(.a(new_n98_), .b(new_n91_), .O(z11));
  ...
  inv1   g058(.a(new_n48_), .O(new_n103_));
  ...
  oai21  g062(.a(new_n59_), .b(new_n65_), .c(new_n106_), .O(z12));
  nand4  g063(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x22), .c(x21), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n48_), .c(x23), .O(new_n110_));
  nand4  g066(.a(new_n103_), .b(new_n51_), .c(x22), .d(x21), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n75_), .c(x09), .d(new_n46_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n67_), .c(new_n45_), .O(z13));
  ...
  oai21  g076(.a(new_n120_), .b(new_n115_), .c(new_n118_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n75_), .c(x09), .d(new_n46_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n69_), .O(z14));
  nand2  g079(.a(x26), .b(x25), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n47_), .c(new_n75_), .O(new_n125_));
  ...
  oai21  g086(.a(new_n130_), .b(new_n115_), .c(new_n128_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n75_), .c(x09), .d(new_n46_), .O(new_n132_));
  nand2  g088(.a(x08), .b(x06), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(new_n126_), .O(z15));
  ...
  nor2   g094(.a(new_n119_), .b(new_n51_), .O(new_n139_));
  nor2   g095(.a(x26), .b(new_n129_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n139_), .c(new_n77_), .d(new_n103_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n75_), .c(x09), .d(new_n46_), .O(new_n143_));
  nand2  g099(.a(x08), .b(x07), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n143_), .c(new_n45_), .O(z16));
endmodule
