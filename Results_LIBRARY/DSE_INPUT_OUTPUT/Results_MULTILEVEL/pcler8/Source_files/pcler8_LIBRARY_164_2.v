...
module FAU ( 
  ...
  oai21  g27(.a(new_n47_), .b(new_n71_), .c(new_n46_), .O(z06));
  ...
  oai21  g41(.a(new_n85_), .b(new_n80_), .c(x20), .O(new_n86_));
  ...
  oai21  g47(.a(new_n60_), .b(new_n84_), .c(new_n91_), .O(z10));
  ...
  nand2  g52(.a(x21), .b(new_n88_), .O(new_n97_));
  oai21  g53(.a(new_n96_), .b(new_n88_), .c(new_n97_), .O(new_n98_));
  ...
  nand3  g62(.a(new_n106_), .b(new_n67_), .c(new_n46_), .O(z12));
  ...
  oai21  g79(.a(new_n60_), .b(new_n71_), .c(new_n123_), .O(z14));
  ...
  oai21  g97(.a(new_n60_), .b(new_n75_), .c(new_n141_), .O(z16));
endmodule
