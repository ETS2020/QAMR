...
module FAU ( 
  ...
  nand4  g065(.a(new_n97_), .b(new_n54_), .c(new_n80_), .d(x21), .O(new_n110_));
  ...
  aoi21  g074(.a(new_n118_), .b(new_n116_), .c(new_n80_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n66_), .c(new_n58_), .O(z13));
  ...
  nand3  g087(.a(new_n131_), .b(new_n126_), .c(new_n68_), .O(z14));
  nand2  g088(.a(x26), .b(x17), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n97_), .c(x24), .d(x21), .O(new_n134_));
  ...
  nand2  g109(.a(new_n153_), .b(new_n143_), .O(z16));
endmodule
