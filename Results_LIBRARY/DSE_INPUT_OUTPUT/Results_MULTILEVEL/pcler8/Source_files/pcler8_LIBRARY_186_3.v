...
module FAU ( 
  ...
  nand2  g084(.a(new_n61_), .b(x06), .O(new_n129_));
  ...
  aoi21  g102(.a(new_n146_), .b(new_n143_), .c(x08), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(x10), .c(x09), .O(new_n148_));
  nand2  g104(.a(x08), .b(x07), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n148_), .O(z16));
endmodule
