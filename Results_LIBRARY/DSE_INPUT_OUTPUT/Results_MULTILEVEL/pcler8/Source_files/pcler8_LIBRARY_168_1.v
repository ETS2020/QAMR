...
module FAU ( 
  ...
  nor2   g009(.a(new_n47_), .b(x00), .O(new_n54_));
  ...
  oai21  g027(.a(new_n47_), .b(x00), .c(x08), .O(new_n72_));
  nor2   g028(.a(new_n72_), .b(new_n71_), .O(z08));
  oai21  g029(.a(x10), .b(x00), .c(x08), .O(new_n74_));
  ...
  nand3  g037(.a(new_n81_), .b(new_n74_), .c(new_n55_), .O(z09));
  ...
  nand3  g044(.a(new_n88_), .b(new_n58_), .c(new_n55_), .O(z10));
  ...
  oai21  g053(.a(new_n61_), .b(new_n60_), .c(new_n97_), .O(z11));
  nor2   g054(.a(new_n83_), .b(new_n90_), .O(new_n99_));
  ...
  nand3  g059(.a(new_n99_), .b(new_n76_), .c(x21), .O(new_n104_));
  ...
  nand2  g070(.a(x23), .b(new_n76_), .O(new_n115_));
  ...
  nand3  g082(.a(new_n126_), .b(new_n67_), .c(new_n55_), .O(z14));
  inv1   g083(.a(x23), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(new_n76_), .O(new_n129_));
  ...
  aoi21  g092(.a(x08), .b(x06), .c(new_n54_), .O(new_n137_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n99_), .c(new_n143_), .d(new_n77_), .O(new_n145_));
