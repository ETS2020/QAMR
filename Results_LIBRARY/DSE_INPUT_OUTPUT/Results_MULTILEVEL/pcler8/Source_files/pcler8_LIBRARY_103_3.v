...
module FAU ( 
  ...
  nand2  g009(.a(x10), .b(x05), .O(new_n54_));
  ...
  aoi21  g023(.a(new_n47_), .b(new_n46_), .c(new_n67_), .O(z06));
  ...
  nor2   g050(.a(new_n73_), .b(x20), .O(new_n95_));
  ...
  aoi21  g055(.a(x08), .b(x02), .c(new_n80_), .O(new_n100_));
  ...
  oai21  g065(.a(new_n55_), .b(new_n63_), .c(new_n109_), .O(z12));
  ...
  nand3  g073(.a(new_n117_), .b(new_n65_), .c(new_n54_), .O(z13));
  ...
  nand3  g082(.a(new_n126_), .b(x09), .c(new_n46_), .O(new_n127_));
  nand2  g083(.a(x08), .b(x05), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n127_), .c(x10), .O(z14));
  ...
  nor2   g089(.a(new_n114_), .b(new_n74_), .O(new_n134_));
  nand4  g090(.a(new_n124_), .b(new_n134_), .c(new_n133_), .d(x24), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n69_), .O(z15));
  ...
  nand4  g100(.a(new_n144_), .b(new_n106_), .c(new_n143_), .d(new_n75_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n147_));
  aoi21  g103(.a(x08), .b(x07), .c(new_n80_), .O(new_n148_));
