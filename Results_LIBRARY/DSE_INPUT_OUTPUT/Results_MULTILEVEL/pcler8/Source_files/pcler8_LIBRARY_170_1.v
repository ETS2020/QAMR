...
module FAU ( 
  ...
  nor2   g040(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  ...
  nand3  g049(.a(new_n93_), .b(new_n85_), .c(new_n75_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n91_), .O(z10));
  xnor2a g051(.a(x21), .b(x20), .O(new_n96_));
  nand2  g052(.a(x21), .b(new_n73_), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n73_), .c(new_n97_), .O(new_n98_));
  ...
  nand3  g061(.a(new_n105_), .b(new_n103_), .c(new_n75_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n101_), .O(z11));
  nand3  g063(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n108_));
  nand3  g064(.a(new_n83_), .b(x22), .c(x14), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n108_), .c(x23), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x24), .O(new_n111_));
  nand3  g067(.a(x21), .b(x20), .c(x19), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x22), .O(new_n113_));
  nand2  g069(.a(x20), .b(x19), .O(new_n114_));
  inv1   g070(.a(x22), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x21), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n118_));
  nand2  g074(.a(x08), .b(x03), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n118_), .c(new_n111_), .O(z12));
  inv1   g076(.a(x23), .O(new_n121_));
  inv1   g077(.a(new_n114_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x22), .c(x21), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n108_), .c(new_n54_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  oai21  g081(.a(new_n112_), .b(new_n115_), .c(x23), .O(new_n126_));
  nand3  g082(.a(new_n83_), .b(x24), .c(x15), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n129_));
  nand2  g085(.a(x08), .b(x04), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n129_), .c(new_n125_), .O(z13));
  nand3  g087(.a(x26), .b(x25), .c(x16), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(x22), .c(x21), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n114_), .c(x24), .O(new_n134_));
  nand4  g090(.a(new_n122_), .b(new_n54_), .c(x22), .d(x21), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n134_), .c(new_n121_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n137_));
  oai21  g093(.a(new_n61_), .b(new_n67_), .c(new_n137_), .O(z14));
  nand2  g094(.a(x26), .b(x17), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n122_), .c(x22), .d(x21), .O(new_n140_));
  nand3  g096(.a(new_n82_), .b(x24), .c(x22), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n112_), .O(new_n142_));
  aoi21  g098(.a(new_n140_), .b(x25), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(x25), .b(new_n54_), .O(new_n144_));
  oai21  g100(.a(new_n143_), .b(new_n121_), .c(new_n144_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n69_), .O(z15));
  nand2  g103(.a(new_n60_), .b(x07), .O(new_n148_));
  nor2   g104(.a(new_n114_), .b(x18), .O(new_n149_));
  nand3  g105(.a(x25), .b(x22), .c(x21), .O(new_n150_));
  ...
  nor2   g109(.a(new_n153_), .b(new_n112_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n152_), .c(x23), .O(new_n155_));
  nand2  g111(.a(x26), .b(new_n54_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n148_), .O(z16));
endmodule
