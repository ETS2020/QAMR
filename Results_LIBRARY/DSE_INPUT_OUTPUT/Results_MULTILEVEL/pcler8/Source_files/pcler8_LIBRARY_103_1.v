...
module FAU ( 
  ...
  oai21  g065(.a(new_n57_), .b(new_n63_), .c(new_n109_), .O(z12));
  ...
  nand3  g073(.a(new_n117_), .b(new_n65_), .c(new_n56_), .O(z13));
  ...
  nand4  g099(.a(new_n143_), .b(new_n106_), .c(new_n142_), .d(new_n75_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n146_));
  aoi21  g102(.a(x08), .b(x07), .c(new_n80_), .O(new_n147_));
