...
module FAU ( 
  ...
  nand2  g42(.a(new_n46_), .b(x21), .O(new_n88_));
  oai21  g43(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  ...
  nand4  g49(.a(new_n94_), .b(x21), .c(x20), .d(x19), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(x22), .O(new_n97_));
  nand2  g52(.a(x23), .b(new_n46_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n73_), .c(x09), .d(new_n52_), .O(new_n100_));
  aoi21  g55(.a(x08), .b(x04), .c(new_n48_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n100_), .O(z13));
  nand3  g57(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  oai21  g58(.a(new_n103_), .b(new_n87_), .c(new_n47_), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n73_), .c(x09), .d(new_n52_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n62_), .c(new_n49_), .O(z14));
  nand3  g61(.a(new_n69_), .b(x25), .c(new_n73_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n64_), .c(new_n49_), .O(z15));
  nand3  g63(.a(new_n69_), .b(x26), .c(new_n73_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n66_), .c(new_n49_), .O(z16));
  zero   g65(.O(z00));
endmodule
