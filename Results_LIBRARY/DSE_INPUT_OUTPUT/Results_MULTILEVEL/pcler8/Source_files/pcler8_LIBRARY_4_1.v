...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(new_n89_), .c(new_n87_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n85_), .O(z10));
  nand2  g052(.a(x22), .b(x13), .O(new_n97_));
  ...
  nand2  g062(.a(new_n91_), .b(x21), .O(new_n107_));
  oai22  g063(.a(new_n107_), .b(new_n100_), .c(new_n106_), .d(new_n91_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n63_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n56_), .O(new_n111_));
  nor3   g067(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n87_), .c(x14), .d(new_n47_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n111_), .O(z12));
  nand2  g070(.a(new_n71_), .b(x04), .O(new_n115_));
  nand3  g071(.a(new_n77_), .b(x24), .c(x15), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n106_), .c(x22), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x23), .O(new_n118_));
  nand4  g074(.a(new_n106_), .b(new_n54_), .c(new_n92_), .d(x22), .O(new_n119_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n100_), .c(x24), .O(new_n125_));
  nand4  g081(.a(new_n106_), .b(new_n54_), .c(x23), .d(x22), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n67_), .c(new_n56_), .O(z14));
  nand3  g085(.a(new_n87_), .b(x19), .c(new_n47_), .O(new_n130_));
  nand3  g086(.a(new_n74_), .b(new_n76_), .c(x22), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n130_), .c(x23), .O(new_n132_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n106_), .c(new_n76_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n133_), .c(new_n69_), .O(z15));
  ...
  nor2   g100(.a(new_n144_), .b(new_n105_), .O(new_n145_));
