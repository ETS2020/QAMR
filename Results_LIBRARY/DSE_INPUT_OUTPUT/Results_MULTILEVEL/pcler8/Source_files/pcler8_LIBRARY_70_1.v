...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n63_, new_n65_, new_n67_, new_n68_, new_n70_, new_n74_,
  ...
  and2   g017(.a(x08), .b(x01), .O(z02));
  inv1   g018(.a(x02), .O(new_n63_));
  oai22  g019(.a(new_n45_), .b(x01), .c(new_n48_), .d(new_n63_), .O(z03));
  nand2  g020(.a(x08), .b(x03), .O(new_n65_));
  nand2  g021(.a(new_n65_), .b(new_n47_), .O(z04));
  ...
  oai21  g026(.a(new_n48_), .b(new_n70_), .c(new_n47_), .O(z06));
  and2   g027(.a(new_n67_), .b(x06), .O(z07));
  and2   g028(.a(new_n67_), .b(x07), .O(z08));
  inv1   g029(.a(new_n67_), .O(new_n74_));
  inv1   g030(.a(x21), .O(new_n75_));
  nor2   g031(.a(new_n53_), .b(new_n75_), .O(new_n76_));
  ...
  nand4  g035(.a(new_n79_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n80_));
  oai21  g036(.a(new_n74_), .b(new_n60_), .c(new_n80_), .O(z09));
  ...
  oai21  g040(.a(new_n50_), .b(x19), .c(new_n84_), .O(new_n85_));
  nand4  g041(.a(new_n85_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n86_));
  nor2   g042(.a(z02), .b(new_n46_), .O(new_n87_));
  ...
  nor2   g046(.a(new_n75_), .b(x20), .O(new_n91_));
  ...
  nand3  g060(.a(new_n104_), .b(new_n65_), .c(new_n47_), .O(z12));
  ...
  nand2  g071(.a(new_n115_), .b(new_n68_), .O(z13));
  ...
  oai21  g080(.a(new_n74_), .b(new_n70_), .c(new_n124_), .O(z14));
  ...
  nand4  g096(.a(new_n140_), .b(new_n139_), .c(new_n76_), .d(new_n51_), .O(new_n141_));
