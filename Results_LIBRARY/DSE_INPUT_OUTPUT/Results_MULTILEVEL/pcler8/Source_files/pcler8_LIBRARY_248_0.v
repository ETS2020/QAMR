...
module FAU ( 
  ...
  nor2   g000(.a(x23), .b(x01), .O(new_n45_));
  ...
  and2   g016(.a(x08), .b(x01), .O(z02));
  inv1   g017(.a(x02), .O(new_n62_));
  oai22  g018(.a(x23), .b(x01), .c(new_n48_), .d(new_n62_), .O(z03));
  ...
  nor2   g031(.a(new_n75_), .b(new_n53_), .O(new_n76_));
  ...
  nand4  g035(.a(new_n79_), .b(new_n47_), .c(x09), .d(new_n48_), .O(new_n80_));
  ...
  nand4  g043(.a(new_n87_), .b(new_n47_), .c(x09), .d(new_n48_), .O(new_n88_));
  nor2   g044(.a(z02), .b(new_n45_), .O(new_n89_));
  ...
  nor2   g048(.a(new_n53_), .b(x20), .O(new_n93_));
  ...
  nand4  g052(.a(new_n96_), .b(new_n47_), .c(x09), .d(new_n48_), .O(new_n97_));
  aoi21  g053(.a(x08), .b(x02), .c(new_n45_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n97_), .O(z11));
  nand3  g055(.a(x21), .b(x20), .c(x19), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand2  g057(.a(new_n75_), .b(x21), .O(new_n102_));
  oai22  g058(.a(new_n102_), .b(new_n51_), .c(new_n101_), .d(new_n75_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n47_), .c(x09), .d(new_n48_), .O(new_n104_));
  oai21  g060(.a(new_n48_), .b(new_n64_), .c(new_n104_), .O(new_n105_));
  ...
  nand2  g067(.a(new_n76_), .b(new_n52_), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n111_), .c(x01), .O(new_n113_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n49_), .c(x01), .O(new_n122_));
  ...
  nand3  g089(.a(x25), .b(new_n110_), .c(new_n47_), .O(new_n134_));
  ...
  nand3  g102(.a(x26), .b(new_n110_), .c(new_n47_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n49_), .c(new_n73_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x01), .O(new_n149_));
  ...
  nor2   g110(.a(new_n127_), .b(new_n75_), .O(new_n155_));
  ...
  nand2  g114(.a(new_n158_), .b(new_n73_), .O(new_n159_));
