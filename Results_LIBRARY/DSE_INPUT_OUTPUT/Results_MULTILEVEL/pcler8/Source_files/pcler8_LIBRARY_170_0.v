...
module FAU ( 
  ...
  and2   g017(.a(new_n59_), .b(x02), .O(z03));
  and2   g018(.a(new_n59_), .b(x03), .O(z04));
  and2   g019(.a(new_n59_), .b(x04), .O(z05));
  inv1   g020(.a(x05), .O(new_n65_));
  nor2   g021(.a(new_n60_), .b(new_n65_), .O(z06));
  nand2  g022(.a(new_n59_), .b(x06), .O(new_n67_));
  inv1   g023(.a(new_n67_), .O(z07));
  nand2  g024(.a(x08), .b(x07), .O(new_n69_));
  nand2  g025(.a(new_n69_), .b(new_n55_), .O(z08));
  ...
  nand3  g038(.a(new_n82_), .b(new_n78_), .c(new_n73_), .O(new_n83_));
  ...
  oai21  g042(.a(new_n46_), .b(new_n58_), .c(new_n86_), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n55_), .O(new_n88_));
  nand2  g044(.a(x19), .b(x12), .O(new_n89_));
  nor2   g045(.a(new_n89_), .b(x10), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(new_n82_), .c(new_n73_), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n88_), .O(z10));
  xnor2a g048(.a(x21), .b(x20), .O(new_n93_));
  nand2  g049(.a(x21), .b(new_n71_), .O(new_n94_));
  oai21  g050(.a(new_n93_), .b(new_n71_), .c(new_n94_), .O(new_n95_));
  ...
  nor3   g058(.a(new_n81_), .b(new_n80_), .c(new_n102_), .O(new_n103_));
  ...
  oai21  g063(.a(new_n107_), .b(new_n81_), .c(x21), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n106_), .c(x22), .O(new_n109_));
  inv1   g065(.a(x22), .O(new_n110_));
  inv1   g066(.a(new_n106_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n110_), .c(x21), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n114_));
  aoi21  g070(.a(x08), .b(x03), .c(new_n54_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(z12));
  inv1   g072(.a(x23), .O(new_n117_));
  nand3  g073(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n118_));
  nor2   g074(.a(new_n110_), .b(new_n79_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n111_), .O(new_n120_));
  ...
  nand3  g086(.a(new_n130_), .b(new_n129_), .c(new_n122_), .O(z13));
  nand3  g087(.a(x26), .b(x25), .c(x16), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(x23), .c(x22), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n123_), .c(x24), .O(new_n134_));
  nor2   g090(.a(x24), .b(new_n117_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n124_), .c(x22), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n138_));
  oai21  g094(.a(new_n60_), .b(new_n65_), .c(new_n138_), .O(z14));
  nand2  g095(.a(x25), .b(new_n117_), .O(new_n140_));
  inv1   g096(.a(x25), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(x23), .c(x22), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n123_), .c(new_n140_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x24), .O(new_n144_));
  nand2  g100(.a(x26), .b(x17), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n124_), .c(x24), .d(x22), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x25), .c(x23), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n67_), .O(z15));
  nand2  g106(.a(new_n59_), .b(x07), .O(new_n151_));
  nand2  g107(.a(x26), .b(new_n117_), .O(new_n152_));
  nand4  g108(.a(new_n45_), .b(x25), .c(x23), .d(x22), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n123_), .c(new_n152_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x24), .O(new_n155_));
  nor2   g111(.a(new_n106_), .b(x18), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n119_), .c(x25), .d(x24), .O(new_n157_));
