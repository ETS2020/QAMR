...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n62_, new_n63_, new_n64_, new_n67_, new_n69_, new_n72_,
  ...
  nand2  g024(.a(new_n63_), .b(x04), .O(new_n69_));
  inv1   g025(.a(new_n69_), .O(z05));
  and2   g026(.a(new_n63_), .b(x05), .O(z06));
  inv1   g027(.a(x06), .O(new_n72_));
  nor2   g028(.a(new_n64_), .b(new_n72_), .O(z07));
  inv1   g029(.a(x07), .O(new_n74_));
  nor2   g030(.a(new_n64_), .b(new_n74_), .O(z08));
  and2   g031(.a(x22), .b(x21), .O(new_n76_));
  ...
  nand3  g036(.a(new_n80_), .b(new_n60_), .c(new_n47_), .O(z09));
  ...
  oai21  g040(.a(x20), .b(new_n49_), .c(new_n84_), .O(new_n85_));
  nand4  g041(.a(new_n85_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n86_));
  oai21  g042(.a(new_n64_), .b(new_n62_), .c(new_n86_), .O(z10));
  nand3  g043(.a(x23), .b(x22), .c(x13), .O(new_n88_));
  oai21  g044(.a(new_n88_), .b(new_n56_), .c(x21), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(x19), .O(new_n90_));
  nand2  g046(.a(x21), .b(new_n49_), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(x20), .c(new_n45_), .O(new_n93_));
  nand2  g049(.a(x21), .b(new_n50_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(x09), .c(new_n48_), .O(new_n96_));
  aoi21  g052(.a(x08), .b(x02), .c(new_n46_), .O(new_n97_));
  ...
  oai21  g061(.a(new_n64_), .b(new_n67_), .c(new_n105_), .O(z12));
  ...
  nand2  g075(.a(new_n119_), .b(new_n50_), .O(new_n120_));
  ...
  oai21  g094(.a(new_n64_), .b(new_n72_), .c(new_n138_), .O(z15));
  ...
  nor2   g099(.a(new_n125_), .b(new_n54_), .O(new_n144_));
  nor2   g100(.a(x26), .b(new_n135_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n144_), .c(new_n76_), .d(new_n51_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n148_));
  oai21  g104(.a(new_n64_), .b(new_n74_), .c(new_n148_), .O(z16));
endmodule
