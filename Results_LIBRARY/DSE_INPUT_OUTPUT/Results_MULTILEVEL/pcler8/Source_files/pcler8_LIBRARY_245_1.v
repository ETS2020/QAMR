...
module FAU ( 
  ...
  nor2   g016(.a(new_n46_), .b(new_n48_), .O(new_n61_));
  inv1   g017(.a(new_n61_), .O(new_n62_));
  nor2   g018(.a(new_n62_), .b(new_n60_), .O(z01));
  ...
  oai21  g039(.a(new_n62_), .b(new_n60_), .c(new_n83_), .O(z09));
  ...
  oai21  g045(.a(new_n62_), .b(new_n64_), .c(new_n89_), .O(z10));
  ...
  nand3  g053(.a(new_n97_), .b(new_n66_), .c(new_n47_), .O(z11));
  ...
  oai21  g061(.a(new_n62_), .b(new_n68_), .c(new_n105_), .O(z12));
  nand2  g062(.a(new_n61_), .b(x04), .O(new_n107_));
  ...
  oai21  g082(.a(new_n62_), .b(new_n72_), .c(new_n126_), .O(z14));
  ...
  oai21  g090(.a(new_n62_), .b(new_n74_), .c(new_n134_), .O(z15));
