...
module FAU ( 
  ...
  oai21  g037(.a(new_n46_), .b(new_n58_), .c(new_n81_), .O(new_n82_));
  ...
  nand2  g047(.a(new_n91_), .b(new_n83_), .O(z10));
  ...
  oai21  g057(.a(new_n101_), .b(new_n89_), .c(x21), .O(new_n102_));
  ...
  nand3  g064(.a(new_n108_), .b(new_n62_), .c(new_n55_), .O(z12));
  nand4  g065(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x23), .O(new_n111_));
  nand3  g067(.a(new_n73_), .b(x22), .c(x21), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n96_), .c(new_n111_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n64_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n55_), .O(new_n116_));
  inv1   g072(.a(new_n76_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n85_), .c(x15), .d(new_n47_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n116_), .O(z13));
  nand3  g075(.a(new_n55_), .b(x08), .c(x05), .O(new_n120_));
  nand3  g076(.a(x21), .b(x20), .c(x19), .O(new_n121_));
  nand3  g077(.a(new_n74_), .b(x23), .c(x22), .O(new_n122_));
  nand3  g078(.a(x26), .b(x24), .c(x16), .O(new_n123_));
  oai21  g079(.a(new_n122_), .b(new_n121_), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x25), .O(new_n125_));
  oai21  g081(.a(new_n96_), .b(new_n88_), .c(x24), .O(new_n126_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n75_), .c(new_n45_), .d(x25), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n143_), .c(new_n70_), .O(z16));
endmodule
