...
module FAU ( 
  ...
  aoi21  g017(.a(new_n47_), .b(new_n46_), .c(new_n54_), .O(z03));
  ...
  oai21  g027(.a(new_n46_), .b(new_n71_), .c(new_n59_), .O(z08));
  ...
  nand2  g037(.a(x10), .b(x02), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(x08), .c(x01), .O(new_n83_));
  inv1   g039(.a(x20), .O(new_n84_));
  nand3  g040(.a(x22), .b(x21), .c(x12), .O(new_n85_));
  oai21  g041(.a(new_n85_), .b(new_n77_), .c(x20), .O(new_n86_));
  ...
  nand3  g045(.a(new_n89_), .b(new_n83_), .c(new_n59_), .O(z10));
  ...
  nand3  g051(.a(new_n73_), .b(x20), .c(x19), .O(new_n96_));
  ...
  aoi21  g055(.a(new_n99_), .b(new_n98_), .c(x10), .O(z11));
  ...
  nand2  g073(.a(x23), .b(new_n74_), .O(new_n118_));
  ...
  nand3  g085(.a(new_n129_), .b(new_n67_), .c(new_n59_), .O(z14));
  inv1   g086(.a(new_n56_), .O(new_n131_));
  ...
  oai21  g096(.a(new_n131_), .b(new_n69_), .c(new_n140_), .O(z15));
  ...
  nor2   g101(.a(new_n125_), .b(new_n132_), .O(new_n146_));
  nor2   g102(.a(x26), .b(new_n137_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n101_), .c(new_n146_), .d(new_n75_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n150_));
  oai21  g106(.a(new_n131_), .b(new_n71_), .c(new_n150_), .O(z16));
endmodule
