...
module FAU ( 
  ...
  nand2  g024(.a(new_n68_), .b(new_n47_), .O(z04));
  ...
  nand3  g061(.a(new_n52_), .b(new_n53_), .c(x21), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n48_), .c(x09), .d(new_n78_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n68_), .c(new_n47_), .O(z12));
  nand4  g065(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x23), .O(new_n111_));
  nand3  g067(.a(new_n54_), .b(x22), .c(x21), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n51_), .c(new_n111_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n48_), .c(x09), .d(new_n78_), .O(new_n114_));
  nand2  g070(.a(x08), .b(x04), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n47_), .O(new_n117_));
  nand4  g073(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n50_), .c(x15), .d(new_n48_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n117_), .O(z13));
  nand3  g077(.a(new_n50_), .b(x19), .c(new_n48_), .O(new_n122_));
  nand3  g078(.a(new_n55_), .b(x21), .c(x20), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n122_), .c(x26), .O(new_n124_));
  ...
  aoi21  g086(.a(new_n130_), .b(new_n127_), .c(new_n45_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n48_), .c(x09), .d(new_n78_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n125_), .c(new_n72_), .O(z14));
  nand3  g089(.a(new_n50_), .b(x25), .c(new_n48_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x26), .O(new_n135_));
  ...
  oai21  g094(.a(new_n138_), .b(new_n126_), .c(x25), .O(new_n139_));
  nor2   g095(.a(x25), .b(new_n45_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n127_), .c(new_n55_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n48_), .c(x09), .d(new_n78_), .O(new_n143_));
  nand2  g099(.a(x08), .b(x06), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n143_), .c(new_n136_), .O(z15));
  nand3  g101(.a(new_n48_), .b(x09), .c(new_n78_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x26), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n45_), .O(new_n148_));
  inv1   g104(.a(x18), .O(new_n149_));
  nand2  g105(.a(new_n52_), .b(new_n149_), .O(new_n150_));
  nand4  g106(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n150_), .c(x26), .O(new_n152_));
  nand4  g108(.a(new_n127_), .b(new_n55_), .c(new_n46_), .d(x25), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n48_), .c(x09), .d(new_n78_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n148_), .c(new_n76_), .O(z16));
endmodule
