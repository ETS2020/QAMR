...
module FAU ( 
  ...
  aoi21  g26(.a(new_n70_), .b(new_n49_), .c(z00), .O(z09));
  ...
  nand3  g31(.a(new_n75_), .b(new_n74_), .c(new_n48_), .O(z10));
  ...
  aoi21  g38(.a(new_n82_), .b(new_n55_), .c(z00), .O(z11));
  nand2  g39(.a(new_n52_), .b(x03), .O(new_n84_));
  nand3  g40(.a(x21), .b(x20), .c(x19), .O(new_n85_));
  nand3  g41(.a(new_n85_), .b(new_n46_), .c(x22), .O(new_n86_));
  nand4  g42(.a(new_n45_), .b(x21), .c(x20), .d(x19), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand4  g44(.a(new_n88_), .b(new_n72_), .c(x09), .d(new_n51_), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n84_), .O(z12));
  nand2  g46(.a(new_n52_), .b(x04), .O(new_n91_));
  nand2  g47(.a(x23), .b(new_n45_), .O(new_n92_));
  nand3  g48(.a(new_n46_), .b(x22), .c(x21), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n77_), .c(new_n92_), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(new_n72_), .c(x09), .d(new_n51_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n91_), .O(z13));
  nand3  g52(.a(new_n68_), .b(x24), .c(new_n72_), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(new_n61_), .c(new_n48_), .O(z14));
  nand3  g54(.a(new_n68_), .b(x25), .c(new_n72_), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(new_n63_), .c(z00), .O(z15));
  nand3  g56(.a(new_n68_), .b(x26), .c(new_n72_), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(new_n65_), .c(z00), .O(z16));
endmodule
