...
module FAU ( 
  ...
  aoi21  g014(.a(x08), .b(x01), .c(new_n56_), .O(new_n59_));
  inv1   g015(.a(new_n59_), .O(z02));
  nor2   g016(.a(new_n56_), .b(new_n46_), .O(new_n61_));
  ...
  oai21  g040(.a(new_n74_), .b(new_n54_), .c(new_n84_), .O(z09));
  ...
  nand3  g044(.a(x20), .b(new_n55_), .c(new_n47_), .O(new_n89_));
  ...
  oai21  g054(.a(new_n98_), .b(new_n75_), .c(new_n96_), .O(new_n99_));
  ...
  nand4  g079(.a(new_n123_), .b(new_n80_), .c(x23), .d(x22), .O(new_n124_));
  ...
  nor2   g083(.a(new_n79_), .b(new_n76_), .O(new_n128_));
  ...
  nand4  g088(.a(new_n123_), .b(new_n128_), .c(new_n132_), .d(x24), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n135_));
  oai21  g091(.a(new_n74_), .b(new_n70_), .c(new_n135_), .O(z15));
  ...
  nand4  g097(.a(new_n141_), .b(new_n98_), .c(new_n81_), .d(new_n77_), .O(new_n142_));
