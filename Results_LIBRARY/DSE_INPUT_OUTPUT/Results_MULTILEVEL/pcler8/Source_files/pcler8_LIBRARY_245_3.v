...
module FAU ( 
  ...
  nor2   g016(.a(new_n47_), .b(new_n49_), .O(new_n61_));
  ...
  nand4  g037(.a(new_n81_), .b(new_n46_), .c(x09), .d(new_n49_), .O(new_n82_));
  nand2  g038(.a(new_n82_), .b(new_n62_), .O(z09));
  ...
  nand4  g043(.a(new_n87_), .b(new_n46_), .c(x09), .d(new_n49_), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(new_n64_), .O(z10));
  nand3  g045(.a(x23), .b(x22), .c(x13), .O(new_n90_));
  oai21  g046(.a(new_n90_), .b(new_n57_), .c(x21), .O(new_n91_));
  nor2   g047(.a(new_n77_), .b(x20), .O(new_n92_));
  aoi21  g048(.a(new_n91_), .b(x20), .c(new_n92_), .O(new_n93_));
  nand2  g049(.a(x21), .b(new_n50_), .O(new_n94_));
  oai21  g050(.a(new_n93_), .b(new_n50_), .c(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n46_), .c(x09), .d(new_n49_), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n66_), .c(new_n48_), .O(z11));
  inv1   g053(.a(new_n52_), .O(new_n98_));
  nand2  g054(.a(x23), .b(x14), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n57_), .c(x21), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n98_), .c(x22), .O(new_n101_));
  nand3  g057(.a(new_n52_), .b(new_n54_), .c(x21), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n46_), .c(x09), .d(new_n49_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n68_), .O(z12));
  nand2  g061(.a(new_n61_), .b(x04), .O(new_n106_));
  ...
  nand2  g069(.a(x23), .b(new_n54_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n46_), .c(x09), .d(new_n49_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n106_), .O(z13));
  nand2  g073(.a(new_n61_), .b(x05), .O(new_n118_));
  ...
  nand4  g081(.a(new_n125_), .b(new_n46_), .c(x09), .d(new_n49_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n118_), .O(z14));
  nand2  g083(.a(x10), .b(x07), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(x08), .c(x06), .O(new_n129_));
  nand2  g085(.a(x26), .b(x17), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n56_), .c(x24), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n110_), .c(x25), .O(new_n132_));
  inv1   g088(.a(x25), .O(new_n133_));
  nand4  g089(.a(new_n123_), .b(new_n56_), .c(new_n133_), .d(x24), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n46_), .c(x09), .d(new_n49_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n129_), .O(z15));
  inv1   g093(.a(x18), .O(new_n138_));
  nand4  g094(.a(x21), .b(x20), .c(x19), .d(new_n138_), .O(new_n139_));
  nand3  g095(.a(new_n56_), .b(x25), .c(x24), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(x26), .O(new_n141_));
  nor2   g097(.a(new_n122_), .b(new_n55_), .O(new_n142_));
  nor2   g098(.a(x26), .b(new_n133_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n142_), .c(new_n78_), .d(new_n52_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(x09), .c(new_n49_), .O(new_n146_));
  nand2  g102(.a(x08), .b(x07), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n146_), .c(x10), .O(z16));
endmodule
