...
module FAU ( 
  ...
  nor2   g13(.a(new_n55_), .b(new_n46_), .O(new_n58_));
  ...
  and2   g21(.a(new_n58_), .b(x05), .O(z06));
  inv1   g22(.a(x06), .O(new_n67_));
  nor2   g23(.a(new_n63_), .b(new_n67_), .O(z07));
  ...
  oai21  g31(.a(new_n63_), .b(new_n54_), .c(new_n75_), .O(z09));
  inv1   g32(.a(x20), .O(new_n77_));
  nand3  g33(.a(x22), .b(x21), .c(x12), .O(new_n78_));
  oai21  g34(.a(new_n78_), .b(new_n73_), .c(x20), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(x19), .O(new_n80_));
  oai21  g36(.a(new_n77_), .b(x19), .c(new_n80_), .O(new_n81_));
  nand4  g37(.a(new_n81_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n82_));
  nand2  g38(.a(new_n82_), .b(new_n59_), .O(z10));
  ...
  aoi21  g46(.a(new_n90_), .b(new_n88_), .c(x08), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n84_), .c(new_n47_), .O(new_n92_));
  nand2  g48(.a(x08), .b(x02), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n92_), .O(z11));
  nand2  g50(.a(x23), .b(x14), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n86_), .c(x21), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n89_), .c(x22), .O(new_n97_));
  ...
  oai21  g58(.a(new_n63_), .b(new_n62_), .c(new_n102_), .O(z12));
  nand4  g59(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(x22), .c(x21), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n89_), .c(x23), .O(new_n106_));
  inv1   g62(.a(x23), .O(new_n107_));
  nand4  g63(.a(new_n99_), .b(new_n107_), .c(x22), .d(x21), .O(new_n108_));
  aoi21  g64(.a(new_n108_), .b(new_n106_), .c(x08), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n84_), .c(new_n47_), .O(new_n110_));
  nand2  g66(.a(x08), .b(x04), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n110_), .O(z13));
  ...
  aoi21  g75(.a(new_n119_), .b(new_n116_), .c(x08), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n84_), .c(new_n47_), .O(new_n121_));
  ...
  nor2   g83(.a(new_n107_), .b(new_n98_), .O(new_n128_));
  ...
  oai21  g87(.a(new_n63_), .b(new_n67_), .c(new_n131_), .O(z15));
  ...
  nor2   g92(.a(new_n117_), .b(new_n107_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n127_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n99_), .c(new_n137_), .d(new_n71_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n136_), .c(x08), .O(new_n140_));
  oai21  g96(.a(new_n140_), .b(new_n84_), .c(new_n47_), .O(new_n141_));
  nand2  g97(.a(new_n141_), .b(new_n69_), .O(z16));
endmodule
