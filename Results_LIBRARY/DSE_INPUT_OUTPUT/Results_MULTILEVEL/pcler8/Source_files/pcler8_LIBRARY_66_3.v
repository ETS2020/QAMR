...
module FAU ( 
  ...
  nand2  g009(.a(x10), .b(x02), .O(new_n54_));
  ...
  nand2  g014(.a(x10), .b(x02), .O(new_n59_));
  nand3  g015(.a(new_n59_), .b(x08), .c(x01), .O(new_n60_));
  inv1   g016(.a(new_n60_), .O(z02));
  nand3  g017(.a(new_n47_), .b(x08), .c(x02), .O(new_n62_));
  inv1   g018(.a(new_n62_), .O(z03));
  inv1   g019(.a(x03), .O(new_n64_));
  oai21  g020(.a(new_n46_), .b(new_n64_), .c(new_n54_), .O(z04));
  ...
  nor2   g051(.a(new_n74_), .b(x20), .O(new_n96_));
  ...
  oai21  g065(.a(new_n55_), .b(new_n64_), .c(new_n109_), .O(z12));
  ...
  aoi21  g073(.a(x08), .b(x04), .c(new_n88_), .O(new_n118_));
  ...
  nor2   g089(.a(new_n114_), .b(new_n75_), .O(new_n134_));
  ...
  aoi21  g093(.a(x08), .b(x06), .c(new_n88_), .O(new_n138_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n106_), .c(new_n144_), .d(new_n76_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n148_));
  oai21  g104(.a(new_n55_), .b(new_n72_), .c(new_n148_), .O(z16));
endmodule
