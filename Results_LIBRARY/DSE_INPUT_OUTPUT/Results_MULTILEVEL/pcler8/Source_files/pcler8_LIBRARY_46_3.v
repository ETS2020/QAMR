...
module FAU ( 
  ...
  oai21  g024(.a(new_n46_), .b(new_n68_), .c(new_n59_), .O(z06));
  ...
  oai21  g037(.a(new_n80_), .b(new_n54_), .c(new_n81_), .O(z09));
  ...
  nor2   g056(.a(new_n85_), .b(new_n91_), .O(new_n101_));
  ...
  oai21  g064(.a(new_n100_), .b(new_n64_), .c(new_n108_), .O(z12));
  ...
  oai21  g084(.a(new_n100_), .b(new_n68_), .c(new_n128_), .O(z14));
  inv1   g085(.a(x23), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(new_n75_), .O(new_n131_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n134_), .c(x08), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(x10), .c(x09), .O(new_n138_));
  nand2  g094(.a(x08), .b(x06), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n138_), .O(z15));
  ...
  nand4  g102(.a(new_n146_), .b(new_n101_), .c(new_n145_), .d(new_n76_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n144_), .c(x08), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(x10), .c(x09), .O(new_n149_));
