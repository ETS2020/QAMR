...
module FAU ( 
  ...
  nand2  g061(.a(new_n83_), .b(x20), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n105_), .c(new_n103_), .d(new_n75_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n102_), .O(z11));
  nand3  g065(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n110_));
  inv1   g066(.a(x20), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n73_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n81_), .c(x21), .O(new_n113_));
  ...
  oai21  g072(.a(x25), .b(new_n82_), .c(new_n116_), .O(new_n117_));
  nand3  g073(.a(new_n103_), .b(x23), .c(x14), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n117_), .c(new_n81_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n115_), .O(z12));
  inv1   g077(.a(new_n116_), .O(new_n122_));
  nand3  g078(.a(x26), .b(x24), .c(x15), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n122_), .c(x22), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(x25), .c(x23), .O(new_n125_));
  nand4  g081(.a(new_n112_), .b(new_n82_), .c(x22), .d(x21), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n128_));
  oai21  g084(.a(new_n57_), .b(new_n65_), .c(new_n128_), .O(z13));
  nand3  g085(.a(new_n75_), .b(x19), .c(new_n47_), .O(new_n130_));
  inv1   g086(.a(x24), .O(new_n131_));
  and2   g087(.a(x21), .b(x20), .O(new_n132_));
  ...
  nand2  g091(.a(x26), .b(x16), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x23), .c(x22), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n122_), .c(new_n131_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n135_), .c(new_n67_), .O(z14));
  aoi21  g097(.a(x26), .b(x17), .c(new_n131_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n122_), .c(new_n83_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(x25), .c(new_n47_), .d(x09), .O(new_n144_));
  oai22  g100(.a(new_n144_), .b(x08), .c(new_n57_), .d(new_n69_), .O(z15));
  nand4  g101(.a(new_n132_), .b(new_n45_), .c(x24), .d(x22), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n130_), .c(x25), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x23), .O(new_n148_));
  nor3   g104(.a(new_n111_), .b(new_n73_), .c(x18), .O(new_n149_));
  nand4  g105(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n150_));
  ...
  nand3  g110(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
endmodule
