...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(new_n89_), .c(x08), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(x10), .c(x09), .O(new_n93_));
  ...
  oai21  g053(.a(new_n97_), .b(new_n90_), .c(x22), .O(new_n98_));
  ...
  oai21  g059(.a(new_n55_), .b(new_n63_), .c(new_n103_), .O(z12));
  nand2  g060(.a(new_n56_), .b(x04), .O(new_n105_));
  ...
  oai21  g080(.a(new_n55_), .b(new_n67_), .c(new_n124_), .O(z14));
