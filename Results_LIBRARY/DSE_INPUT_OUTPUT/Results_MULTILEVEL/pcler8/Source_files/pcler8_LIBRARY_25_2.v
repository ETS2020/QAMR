...
module FAU ( 
  ...
  nor2   g01(.a(x13), .b(new_n45_), .O(new_n46_));
  ...
  oai21  g20(.a(new_n48_), .b(new_n64_), .c(new_n47_), .O(z03));
  nor2   g21(.a(new_n46_), .b(new_n48_), .O(new_n66_));
  and2   g22(.a(new_n66_), .b(x03), .O(z04));
  ...
  and2   g27(.a(new_n66_), .b(x06), .O(z07));
  inv1   g28(.a(x07), .O(new_n73_));
  inv1   g29(.a(new_n66_), .O(new_n74_));
  ...
  oai21  g37(.a(new_n74_), .b(new_n60_), .c(new_n81_), .O(z09));
  ...
  nand3  g43(.a(new_n87_), .b(new_n62_), .c(new_n47_), .O(z10));
  ...
  oai21  g50(.a(new_n74_), .b(new_n64_), .c(new_n94_), .O(z11));
  ...
  nand2  g60(.a(new_n66_), .b(x04), .O(new_n105_));
  ...
  nand3  g80(.a(new_n124_), .b(new_n70_), .c(new_n47_), .O(z14));
  ...
  aoi21  g88(.a(x08), .b(x06), .c(new_n46_), .O(new_n133_));
  ...
  nor2   g94(.a(new_n120_), .b(new_n54_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n129_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n139_), .c(new_n77_), .d(new_n51_), .O(new_n141_));
  nand2  g97(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand4  g98(.a(new_n142_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n143_));
  oai21  g99(.a(new_n74_), .b(new_n73_), .c(new_n143_), .O(z16));
endmodule
