...
module FAU ( 
  ...
  oai21  g16(.a(new_n59_), .b(new_n61_), .c(new_n47_), .O(z06));
  ...
  nor2   g21(.a(new_n52_), .b(new_n58_), .O(z13));
  nor2   g22(.a(new_n52_), .b(new_n61_), .O(z14));
  nor2   g23(.a(new_n52_), .b(new_n63_), .O(z15));
  zero   g24(.O(z00));
  nand2  g25(.a(new_n48_), .b(new_n47_), .O(z09));
  nor2   g26(.a(new_n52_), .b(new_n50_), .O(z10));
  nand2  g27(.a(new_n54_), .b(new_n47_), .O(z11));
  nor2   g28(.a(new_n52_), .b(new_n56_), .O(z12));
