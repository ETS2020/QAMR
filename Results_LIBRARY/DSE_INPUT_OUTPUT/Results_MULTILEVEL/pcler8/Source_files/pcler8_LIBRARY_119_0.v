...
module FAU ( 
  ...
  nor2   g32(.a(new_n64_), .b(new_n76_), .O(z08));
  ...
  nor2   g55(.a(new_n47_), .b(new_n45_), .O(new_n100_));
  ...
  nand3  g60(.a(new_n100_), .b(new_n50_), .c(x21), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(new_n60_), .c(x09), .d(new_n58_), .O(new_n107_));
  oai21  g63(.a(new_n64_), .b(new_n68_), .c(new_n107_), .O(z12));
  ...
  nand4  g67(.a(new_n100_), .b(new_n51_), .c(x22), .d(x21), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n111_), .c(x08), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n59_), .c(new_n60_), .O(new_n114_));
  ...
  oai21  g79(.a(new_n123_), .b(new_n59_), .c(new_n60_), .O(new_n124_));
  ...
  nand4  g87(.a(new_n131_), .b(new_n60_), .c(x09), .d(new_n58_), .O(new_n132_));
  oai21  g88(.a(new_n64_), .b(new_n74_), .c(new_n132_), .O(z15));
  ...
  nand4  g95(.a(new_n139_), .b(new_n100_), .c(new_n138_), .d(new_n78_), .O(new_n140_));
  aoi21  g96(.a(new_n140_), .b(new_n137_), .c(x08), .O(new_n141_));
  oai21  g97(.a(new_n141_), .b(new_n59_), .c(new_n60_), .O(new_n142_));
  oai21  g98(.a(new_n58_), .b(new_n76_), .c(new_n142_), .O(z16));
endmodule
