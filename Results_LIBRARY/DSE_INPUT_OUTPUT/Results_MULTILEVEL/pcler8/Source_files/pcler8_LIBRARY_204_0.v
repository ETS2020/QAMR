...
module FAU ( 
  ...
  nor2   g025(.a(new_n54_), .b(new_n46_), .O(new_n70_));
  nand2  g026(.a(new_n70_), .b(x07), .O(new_n71_));
  ...
  nand2  g042(.a(new_n70_), .b(x01), .O(new_n87_));
  ...
  nand3  g048(.a(x25), .b(new_n92_), .c(x19), .O(new_n93_));
  ...
  oai21  g053(.a(new_n97_), .b(new_n83_), .c(x21), .O(new_n98_));
  inv1   g054(.a(x21), .O(new_n99_));
  nor2   g055(.a(new_n99_), .b(x19), .O(new_n100_));
  aoi21  g056(.a(new_n98_), .b(x19), .c(new_n100_), .O(new_n101_));
  nand2  g057(.a(x21), .b(new_n92_), .O(new_n102_));
  oai21  g058(.a(new_n101_), .b(new_n92_), .c(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n60_), .c(new_n55_), .O(z11));
  nand2  g061(.a(new_n70_), .b(x03), .O(new_n106_));
  nor2   g062(.a(new_n99_), .b(new_n73_), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n92_), .O(new_n108_));
  inv1   g064(.a(x25), .O(new_n109_));
  nand4  g065(.a(x26), .b(x24), .c(x23), .d(x14), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x20), .c(new_n109_), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n108_), .c(x22), .O(new_n112_));
  ...
  nand2  g072(.a(new_n116_), .b(new_n106_), .O(z12));
  nand4  g073(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x23), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x21), .c(x19), .O(new_n120_));
  oai21  g076(.a(new_n99_), .b(new_n73_), .c(x23), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x22), .c(x20), .O(new_n123_));
  oai21  g079(.a(new_n113_), .b(new_n92_), .c(x23), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n64_), .O(z13));
  nand2  g083(.a(new_n70_), .b(x05), .O(new_n128_));
  inv1   g084(.a(x24), .O(new_n129_));
  nand2  g085(.a(x26), .b(x16), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(x20), .c(new_n109_), .O(new_n131_));
  nand3  g087(.a(new_n81_), .b(x21), .c(x19), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(x20), .c(new_n131_), .O(new_n133_));
  nand3  g089(.a(x21), .b(x20), .c(x19), .O(new_n134_));
  nand3  g090(.a(new_n129_), .b(x23), .c(x22), .O(new_n135_));
  oai22  g091(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n129_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n128_), .O(z14));
  nand3  g094(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x25), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n92_), .O(new_n141_));
  nand3  g097(.a(x22), .b(x21), .c(x19), .O(new_n142_));
  ...
  nand3  g101(.a(new_n109_), .b(x24), .c(x23), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n142_), .c(new_n145_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n141_), .c(new_n68_), .O(z15));
  nand4  g105(.a(new_n45_), .b(x24), .c(x23), .d(x22), .O(new_n150_));
  oai22  g106(.a(new_n150_), .b(new_n134_), .c(new_n45_), .d(x20), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x25), .O(new_n152_));
  inv1   g108(.a(x18), .O(new_n153_));
  nor2   g109(.a(new_n109_), .b(new_n129_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n107_), .c(new_n81_), .d(new_n153_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(x26), .c(x20), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n71_), .O(z16));
endmodule
