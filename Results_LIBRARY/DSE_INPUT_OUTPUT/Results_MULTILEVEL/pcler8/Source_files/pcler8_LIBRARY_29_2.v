...
module FAU ( 
  ...
  inv1   g11(.a(x04), .O(new_n56_));
  inv1   g12(.a(x09), .O(new_n57_));
  oai21  g13(.a(x10), .b(new_n57_), .c(x08), .O(new_n58_));
  nor2   g14(.a(new_n58_), .b(new_n56_), .O(z05));
