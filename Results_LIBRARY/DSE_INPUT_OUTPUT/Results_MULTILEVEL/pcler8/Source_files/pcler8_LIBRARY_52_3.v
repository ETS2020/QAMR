...
module FAU ( 
  ...
  aoi21  g26(.a(new_n71_), .b(new_n50_), .c(new_n48_), .O(z09));
  ...
  aoi21  g38(.a(x08), .b(x02), .c(new_n48_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n83_), .O(z11));
  nand3  g40(.a(x21), .b(x20), .c(x19), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n47_), .c(x22), .O(new_n87_));
  nand4  g42(.a(new_n46_), .b(x21), .c(x20), .d(x19), .O(new_n88_));
  ...
  nand2  g47(.a(x23), .b(new_n46_), .O(new_n93_));
  nand3  g48(.a(new_n47_), .b(x22), .c(x21), .O(new_n94_));
  oai21  g49(.a(new_n94_), .b(new_n78_), .c(new_n93_), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n73_), .c(x09), .d(new_n52_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n92_), .O(z13));
  nand3  g52(.a(new_n69_), .b(x24), .c(new_n73_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n62_), .c(new_n48_), .O(z14));
  nand2  g54(.a(x08), .b(x06), .O(new_n100_));
  nand3  g55(.a(new_n69_), .b(x25), .c(new_n73_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n100_), .c(new_n48_), .O(z15));
  nand3  g57(.a(new_n69_), .b(x26), .c(new_n73_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n66_), .c(new_n49_), .O(z16));
  zero   g59(.O(z00));
endmodule
