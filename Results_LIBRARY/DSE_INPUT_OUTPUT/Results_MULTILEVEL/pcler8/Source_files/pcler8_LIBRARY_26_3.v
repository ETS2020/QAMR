...
module FAU ( 
  ...
  nor2   g018(.a(new_n57_), .b(new_n47_), .O(new_n63_));
  ...
  nor2   g041(.a(new_n56_), .b(new_n46_), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(x21), .O(new_n87_));
  nand3  g043(.a(x26), .b(x25), .c(x24), .O(new_n88_));
  nor2   g044(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n85_), .c(new_n83_), .d(x11), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n81_), .O(z09));
  xor2a  g047(.a(x20), .b(x19), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n61_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n58_), .O(new_n95_));
  nor2   g051(.a(new_n76_), .b(x18), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n89_), .c(new_n83_), .d(x12), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n95_), .O(z10));
  inv1   g054(.a(x21), .O(new_n99_));
  nand3  g055(.a(x23), .b(x22), .c(x13), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n88_), .c(x21), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(x20), .c(x19), .O(new_n102_));
  nor2   g058(.a(new_n84_), .b(new_n76_), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n99_), .c(new_n102_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n105_));
  aoi21  g061(.a(x08), .b(x02), .c(new_n57_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n105_), .O(z11));
  nand3  g063(.a(new_n78_), .b(x14), .c(new_n48_), .O(new_n108_));
  nand4  g064(.a(x26), .b(x25), .c(x24), .d(x22), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n108_), .c(new_n49_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x23), .O(new_n111_));
  nand3  g067(.a(x21), .b(x20), .c(x19), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand3  g069(.a(new_n103_), .b(new_n46_), .c(x21), .O(new_n114_));
  oai21  g070(.a(new_n113_), .b(new_n46_), .c(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n111_), .c(new_n66_), .O(z12));
  nand2  g073(.a(new_n63_), .b(x04), .O(new_n118_));
  nand4  g074(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n103_), .c(x22), .d(x21), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(x23), .c(new_n49_), .O(new_n121_));
  nand4  g077(.a(new_n103_), .b(new_n56_), .c(x22), .d(x21), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n118_), .O(z13));
  nand3  g081(.a(new_n78_), .b(x19), .c(new_n48_), .O(new_n126_));
  inv1   g082(.a(x24), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(x22), .c(x21), .d(x20), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n126_), .c(new_n49_), .O(new_n129_));
  ...
  aoi21  g089(.a(new_n133_), .b(new_n113_), .c(new_n127_), .O(new_n134_));
  ...
  oai21  g095(.a(new_n139_), .b(new_n112_), .c(x25), .O(new_n140_));
  nor2   g096(.a(x25), .b(new_n127_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n113_), .c(new_n86_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n49_), .O(new_n144_));
  nand2  g100(.a(x25), .b(new_n56_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n72_), .O(z15));
  nand2  g104(.a(new_n63_), .b(x07), .O(new_n149_));
  nand3  g105(.a(x25), .b(x24), .c(x22), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n112_), .c(x26), .O(new_n151_));
  nand4  g107(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n152_));
  nand4  g108(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n151_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n49_), .O(new_n155_));
  nand2  g111(.a(x26), .b(new_n56_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n149_), .O(z16));
endmodule
