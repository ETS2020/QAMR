...
module FAU ( 
  ...
  oai21  g018(.a(new_n48_), .b(new_n62_), .c(new_n60_), .O(z03));
  inv1   g019(.a(x03), .O(new_n64_));
  oai21  g020(.a(new_n48_), .b(new_n64_), .c(new_n60_), .O(z04));
  nand2  g021(.a(x08), .b(x04), .O(new_n66_));
  nand2  g022(.a(new_n66_), .b(new_n60_), .O(z05));
  inv1   g023(.a(x05), .O(new_n68_));
  oai21  g024(.a(new_n48_), .b(new_n68_), .c(new_n60_), .O(z06));
  nand3  g025(.a(x10), .b(x08), .c(x06), .O(new_n70_));
  inv1   g026(.a(new_n70_), .O(z07));
  inv1   g027(.a(x07), .O(new_n72_));
  inv1   g028(.a(new_n57_), .O(new_n73_));
  ...
  nand3  g035(.a(new_n79_), .b(x09), .c(new_n48_), .O(new_n80_));
  ...
  nand4  g046(.a(new_n90_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n91_));
  oai21  g047(.a(new_n73_), .b(new_n59_), .c(new_n91_), .O(z10));
  ...
  nand4  g055(.a(new_n99_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n100_));
  oai22  g056(.a(new_n100_), .b(x06), .c(new_n73_), .d(new_n62_), .O(z11));
  ...
  nand4  g064(.a(new_n108_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n109_));
  oai21  g065(.a(new_n73_), .b(new_n64_), .c(new_n109_), .O(z12));
  nand2  g066(.a(new_n57_), .b(x04), .O(new_n111_));
  ...
  nand2  g074(.a(x23), .b(new_n46_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n118_), .c(x10), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n121_));
  ...
  aoi21  g084(.a(new_n128_), .b(new_n125_), .c(x10), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n130_));
  oai21  g086(.a(new_n73_), .b(new_n68_), .c(new_n130_), .O(z14));
  ...
  oai21  g091(.a(new_n135_), .b(new_n115_), .c(x25), .O(new_n136_));
  inv1   g092(.a(x25), .O(new_n137_));
  nand4  g093(.a(new_n127_), .b(new_n133_), .c(new_n137_), .d(x24), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n136_), .c(x10), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n140_));
  nand3  g096(.a(x10), .b(x08), .c(x06), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(z15));
  oai21  g098(.a(new_n48_), .b(new_n72_), .c(x10), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x06), .O(new_n144_));
  inv1   g100(.a(x18), .O(new_n145_));
  nand4  g101(.a(x21), .b(x20), .c(x19), .d(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n133_), .b(x25), .c(x24), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n146_), .c(x26), .O(new_n148_));
  nor2   g104(.a(new_n126_), .b(new_n132_), .O(new_n149_));
  nor2   g105(.a(x26), .b(new_n137_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n106_), .c(new_n149_), .d(new_n76_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n153_));
  nand3  g109(.a(x08), .b(x07), .c(new_n47_), .O(new_n154_));
