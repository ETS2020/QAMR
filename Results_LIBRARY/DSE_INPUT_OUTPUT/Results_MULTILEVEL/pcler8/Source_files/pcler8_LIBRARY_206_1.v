...
module FAU ( 
  ...
  oai21  g07(.a(new_n52_), .b(new_n51_), .c(new_n48_), .O(z02));
  nand2  g08(.a(x08), .b(x02), .O(new_n54_));
  nand2  g09(.a(new_n54_), .b(new_n48_), .O(z03));
  inv1   g10(.a(x03), .O(new_n56_));
  nor2   g11(.a(new_n49_), .b(new_n56_), .O(z04));
  ...
  nand3  g22(.a(new_n67_), .b(x09), .c(new_n52_), .O(new_n68_));
  nand2  g23(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand2  g24(.a(new_n69_), .b(new_n47_), .O(new_n70_));
  oai21  g25(.a(new_n52_), .b(new_n46_), .c(new_n70_), .O(z09));
  xor2a  g26(.a(x20), .b(x19), .O(new_n72_));
  nand4  g27(.a(new_n72_), .b(new_n66_), .c(new_n47_), .d(x09), .O(new_n73_));
  ...
  aoi21  g34(.a(new_n79_), .b(new_n77_), .c(new_n75_), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(new_n52_), .c(x23), .O(new_n81_));
  oai21  g36(.a(new_n81_), .b(x10), .c(new_n54_), .O(z11));
  ...
  aoi21  g41(.a(new_n86_), .b(new_n84_), .c(new_n75_), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(new_n52_), .c(x23), .O(new_n88_));
  nand2  g43(.a(x08), .b(x03), .O(new_n89_));
  oai21  g44(.a(new_n88_), .b(x10), .c(new_n89_), .O(z12));
  nand3  g45(.a(x19), .b(x09), .c(new_n52_), .O(new_n91_));
  nand3  g46(.a(x22), .b(x21), .c(x20), .O(new_n92_));
  oai21  g47(.a(new_n92_), .b(new_n91_), .c(new_n66_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n47_), .O(new_n94_));
  oai21  g49(.a(new_n52_), .b(new_n58_), .c(new_n94_), .O(z13));
  nand2  g50(.a(x24), .b(x09), .O(new_n96_));
  oai21  g51(.a(new_n96_), .b(x08), .c(new_n66_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n47_), .O(new_n98_));
  oai21  g53(.a(new_n52_), .b(new_n60_), .c(new_n98_), .O(z14));
  nand2  g54(.a(x09), .b(new_n52_), .O(new_n100_));
  nand3  g55(.a(x25), .b(new_n66_), .c(new_n47_), .O(new_n101_));
  oai22  g56(.a(new_n101_), .b(new_n100_), .c(new_n49_), .d(new_n62_), .O(z15));
  ...
  nand2  g60(.a(new_n105_), .b(new_n64_), .O(z16));
  zero   g61(.O(z00));
endmodule
