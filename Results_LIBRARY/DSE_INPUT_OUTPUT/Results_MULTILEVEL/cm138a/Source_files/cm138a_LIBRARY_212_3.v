...
module FAU ( 
  ...
  oai21  g23(.a(new_n37_), .b(new_n34_), .c(new_n20_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x2), .O(z5));
  nand2  g25(.a(x1), .b(new_n16_), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n34_), .c(new_n20_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(x2), .O(z6));
  nand3  g28(.a(new_n19_), .b(x3), .c(x1), .O(new_n43_));
  inv1   g29(.a(new_n43_), .O(new_n44_));
  nand4  g30(.a(new_n44_), .b(new_n20_), .c(x2), .d(x0), .O(z7));
endmodule
