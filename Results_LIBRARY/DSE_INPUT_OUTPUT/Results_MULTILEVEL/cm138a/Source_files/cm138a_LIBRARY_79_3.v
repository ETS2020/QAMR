...
module FAU ( 
  ...
  nand3  g19(.a(new_n20_), .b(x3), .c(new_n17_), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n19_), .c(x2), .d(new_n16_), .O(z4));
  nand2  g22(.a(new_n20_), .b(x3), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n25_), .c(new_n19_), .O(new_n38_));
  ...
  oai21  g29(.a(new_n43_), .b(new_n37_), .c(new_n19_), .O(new_n44_));
