...
module FAU ( 
  ...
  nand2  g16(.a(new_n30_), .b(new_n23_), .O(z2));
  nor2   g17(.a(new_n26_), .b(new_n17_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n25_), .c(new_n15_), .d(x0), .O(z3));
  nand2  g19(.a(new_n20_), .b(x3), .O(new_n34_));
  oai21  g20(.a(new_n34_), .b(new_n18_), .c(new_n19_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x2), .O(z4));
  nand2  g22(.a(new_n17_), .b(x0), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n34_), .c(new_n19_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x2), .O(z5));
  nand3  g25(.a(new_n20_), .b(x3), .c(x1), .O(new_n40_));
  inv1   g26(.a(new_n40_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n19_), .c(x2), .d(new_n16_), .O(z6));
  nand2  g28(.a(x1), .b(x0), .O(new_n43_));
  oai21  g29(.a(new_n43_), .b(new_n34_), .c(new_n19_), .O(new_n44_));
