...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n27_, new_n28_, new_n30_, new_n33_;
  ...
  nor2   g12(.a(x2), .b(new_n24_), .O(new_n27_));
  nor2   g13(.a(x5), .b(x4), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(new_n27_), .c(x3), .d(x0), .O(z3));
  nor2   g15(.a(new_n20_), .b(x1), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n28_), .c(x3), .d(new_n21_), .O(z4));
  nand2  g17(.a(x2), .b(x0), .O(z5));
  and2   g18(.a(x3), .b(x1), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n28_), .c(x2), .d(new_n21_), .O(z6));
  one    g20(.O(z7));
endmodule
