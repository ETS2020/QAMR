...
module FAU ( 
  ...
  nand4  g11(.a(x3), .b(x2), .c(new_n16_), .d(new_n15_), .O(new_n26_));
  ...
  nand4  g16(.a(new_n30_), .b(new_n19_), .c(new_n18_), .d(x0), .O(z5));
  nand4  g17(.a(x3), .b(x2), .c(x1), .d(new_n15_), .O(new_n32_));
  ...
  nand4  g22(.a(new_n36_), .b(new_n19_), .c(new_n18_), .d(x0), .O(z7));
endmodule
