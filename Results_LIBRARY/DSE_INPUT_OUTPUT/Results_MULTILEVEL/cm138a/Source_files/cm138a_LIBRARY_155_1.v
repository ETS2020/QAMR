...
module FAU ( 
  ...
  nand4  g04(.a(new_n18_), .b(new_n17_), .c(x3), .d(x2), .O(z4));
  ...
  nand3  g12(.a(new_n22_), .b(new_n21_), .c(x1), .O(new_n27_));
  inv1   g13(.a(new_n27_), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(x3), .c(x2), .d(new_n26_), .O(z6));
  nand4  g15(.a(new_n22_), .b(new_n21_), .c(x1), .d(x0), .O(new_n30_));
