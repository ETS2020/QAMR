...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n33_, new_n35_, new_n37_, new_n39_, new_n40_, new_n42_;
  ...
  nand4  g16(.a(new_n30_), .b(new_n29_), .c(new_n20_), .d(new_n15_), .O(z2));
  nand2  g17(.a(x1), .b(x0), .O(new_n32_));
  nor2   g18(.a(new_n32_), .b(x2), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n29_), .c(new_n20_), .O(z3));
  inv1   g20(.a(new_n18_), .O(new_n35_));
  nand4  g21(.a(new_n29_), .b(new_n35_), .c(new_n20_), .d(x2), .O(z4));
  inv1   g22(.a(new_n25_), .O(new_n37_));
  nand4  g23(.a(new_n29_), .b(new_n37_), .c(new_n20_), .d(x2), .O(z5));
  nand3  g24(.a(new_n19_), .b(x3), .c(x1), .O(new_n39_));
  inv1   g25(.a(new_n39_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n20_), .c(x2), .d(new_n16_), .O(z6));
  oai21  g27(.a(new_n32_), .b(new_n28_), .c(new_n20_), .O(new_n42_));
