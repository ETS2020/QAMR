...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_;
  ...
  nand4  g08(.a(new_n22_), .b(new_n16_), .c(x2), .d(new_n18_), .O(z4));
  ...
  nor2   g14(.a(new_n19_), .b(x0), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n28_), .c(new_n16_), .d(x2), .O(z6));
  nor2   g16(.a(new_n19_), .b(new_n18_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n28_), .c(new_n16_), .d(x2), .O(z7));
  buf    g18(.a(x0), .O(z0));
