...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n42_;
  ...
  oai21  g22(.a(new_n34_), .b(new_n24_), .c(x2), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n33_), .O(z5));
  oai21  g24(.a(new_n34_), .b(new_n27_), .c(x2), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n33_), .O(z6));
  nand2  g26(.a(x1), .b(x0), .O(new_n41_));
  oai21  g27(.a(new_n41_), .b(new_n34_), .c(x2), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n33_), .O(z7));
endmodule
