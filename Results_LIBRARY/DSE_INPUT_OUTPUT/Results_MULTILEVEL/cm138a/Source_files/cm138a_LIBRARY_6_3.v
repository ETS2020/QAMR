...
module FAU ( 
  ...
  nand3  g12(.a(new_n19_), .b(new_n18_), .c(x1), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n15_), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n26_), .c(new_n16_), .O(z2));
  ...
  nand4  g19(.a(new_n26_), .b(new_n33_), .c(new_n19_), .d(x2), .O(z4));
  nor2   g20(.a(x1), .b(new_n16_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n26_), .c(new_n19_), .d(x2), .O(z5));
  nor2   g22(.a(new_n17_), .b(x0), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n26_), .c(new_n19_), .d(x2), .O(z6));
  nor2   g24(.a(new_n17_), .b(new_n16_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n26_), .c(new_n19_), .d(x2), .O(z7));
endmodule
