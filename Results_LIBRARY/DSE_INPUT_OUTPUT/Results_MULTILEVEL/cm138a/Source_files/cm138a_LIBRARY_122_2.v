...
module FAU ( 
  ...
  oai21  g20(.a(new_n34_), .b(new_n18_), .c(x3), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x2), .O(z4));
  nor3   g22(.a(x5), .b(x4), .c(x1), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(x3), .c(x2), .d(x0), .O(z5));
  oai21  g24(.a(new_n28_), .b(new_n34_), .c(x3), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(x2), .O(z6));
  nand3  g26(.a(new_n31_), .b(x1), .c(x0), .O(new_n41_));
