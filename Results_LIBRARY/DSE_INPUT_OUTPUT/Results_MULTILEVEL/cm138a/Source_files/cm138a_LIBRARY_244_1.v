...
module FAU ( 
  ...
  nand2  g12(.a(new_n22_), .b(new_n26_), .O(new_n27_));
  ...
  nor2   g26(.a(new_n21_), .b(new_n19_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n17_), .c(x3), .d(new_n15_), .O(z6));
  oai21  g28(.a(new_n36_), .b(new_n32_), .c(x3), .O(new_n43_));
