...
module FAU ( 
  ...
  nand4  g17(.a(new_n31_), .b(new_n17_), .c(new_n16_), .d(x0), .O(z3));
  ...
  nand2  g27(.a(new_n41_), .b(new_n37_), .O(z6));
  nor2   g28(.a(new_n33_), .b(new_n18_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n35_), .c(x2), .d(x0), .O(z7));
endmodule
