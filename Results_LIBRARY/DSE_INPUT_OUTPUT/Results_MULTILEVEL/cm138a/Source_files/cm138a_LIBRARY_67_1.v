...
module FAU ( 
  ...
  nand2  g19(.a(new_n18_), .b(new_n15_), .O(new_n34_));
  nand3  g20(.a(new_n19_), .b(new_n17_), .c(x3), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n34_), .c(x2), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n33_), .O(z4));
  nor2   g23(.a(x5), .b(x4), .O(new_n38_));
  inv1   g24(.a(x3), .O(new_n39_));
  nor2   g25(.a(new_n39_), .b(x1), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n38_), .c(x2), .d(x0), .O(z5));
  oai21  g27(.a(new_n35_), .b(new_n27_), .c(x2), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n33_), .O(z6));
  nand2  g29(.a(x1), .b(x0), .O(new_n44_));
  oai21  g30(.a(new_n44_), .b(new_n35_), .c(x2), .O(new_n45_));
  nand2  g31(.a(new_n45_), .b(new_n33_), .O(z7));
endmodule
