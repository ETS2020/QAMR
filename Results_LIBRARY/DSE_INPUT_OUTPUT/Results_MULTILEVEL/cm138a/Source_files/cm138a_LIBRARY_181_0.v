...
module FAU ( 
  ...
  nand4  g14(.a(new_n21_), .b(x2), .c(new_n19_), .d(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x3), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n16_), .O(z4));
  nand3  g17(.a(new_n21_), .b(x2), .c(new_n19_), .O(new_n32_));
  inv1   g18(.a(new_n32_), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n16_), .c(x3), .d(x0), .O(z5));
  nand4  g20(.a(new_n21_), .b(x2), .c(x1), .d(new_n15_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x3), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n16_), .O(z6));
  nand4  g23(.a(new_n21_), .b(x2), .c(x1), .d(x0), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x3), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n16_), .O(z7));
endmodule
