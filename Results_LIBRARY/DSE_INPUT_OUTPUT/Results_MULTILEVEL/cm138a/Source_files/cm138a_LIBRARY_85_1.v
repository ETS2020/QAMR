...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n24_, new_n27_, new_n28_, new_n30_, new_n31_, new_n32_,
  ...
  nand2  g14(.a(new_n28_), .b(new_n18_), .O(z3));
  nand3  g15(.a(new_n16_), .b(new_n15_), .c(x2), .O(new_n30_));
  oai21  g16(.a(new_n30_), .b(new_n21_), .c(x3), .O(new_n31_));
  inv1   g17(.a(x3), .O(new_n32_));
  nand2  g18(.a(new_n16_), .b(new_n32_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n31_), .O(z4));
  nor2   g20(.a(x5), .b(x4), .O(new_n35_));
  nor2   g21(.a(new_n24_), .b(x1), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n35_), .c(x3), .d(x0), .O(z5));
  nor2   g23(.a(new_n24_), .b(new_n20_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n35_), .c(x3), .d(new_n19_), .O(z6));
  oai21  g25(.a(new_n30_), .b(new_n27_), .c(x3), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n33_), .O(z7));
endmodule
