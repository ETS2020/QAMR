...
module FAU ( 
  ...
  nand4  g08(.a(new_n19_), .b(new_n18_), .c(x3), .d(new_n17_), .O(new_n24_));
  nand2  g09(.a(new_n24_), .b(x1), .O(new_n25_));
  nand2  g10(.a(new_n25_), .b(new_n23_), .O(z2));
  inv1   g11(.a(new_n24_), .O(new_n27_));
  nand3  g12(.a(new_n27_), .b(x1), .c(x0), .O(z3));
  nand2  g13(.a(new_n16_), .b(new_n23_), .O(z4));
  nor2   g14(.a(x5), .b(x4), .O(new_n30_));
  and2   g15(.a(x3), .b(x2), .O(new_n31_));
  nand4  g16(.a(new_n31_), .b(new_n30_), .c(new_n16_), .d(x0), .O(z5));
  nand4  g17(.a(new_n21_), .b(x2), .c(x1), .d(new_n23_), .O(z6));
