...
module FAU ( 
  ...
  nand3  g17(.a(new_n31_), .b(new_n30_), .c(new_n21_), .O(z2));
  nand4  g18(.a(new_n30_), .b(new_n21_), .c(x1), .d(x0), .O(z3));
  nand4  g19(.a(new_n30_), .b(x2), .c(new_n19_), .d(new_n15_), .O(z4));
  nand4  g20(.a(new_n30_), .b(x2), .c(new_n19_), .d(x0), .O(z5));
