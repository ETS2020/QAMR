...
module FAU ( 
  ...
  nand4  g10(.a(new_n24_), .b(new_n22_), .c(new_n15_), .d(new_n20_), .O(z2));
  nand4  g11(.a(new_n16_), .b(x3), .c(x2), .d(new_n21_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n20_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n15_), .O(z4));
  and2   g14(.a(x2), .b(x1), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n24_), .c(new_n15_), .d(new_n20_), .O(z6));
