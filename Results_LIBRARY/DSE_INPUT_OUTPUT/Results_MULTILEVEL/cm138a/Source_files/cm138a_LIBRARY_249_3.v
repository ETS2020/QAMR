...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n25_, new_n28_, new_n29_, new_n32_, new_n33_;
  ...
  nand3  g13(.a(new_n19_), .b(new_n18_), .c(x3), .O(new_n28_));
  inv1   g14(.a(new_n28_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(x2), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g16(.a(new_n29_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nor2   g17(.a(x5), .b(x4), .O(new_n32_));
  and2   g18(.a(x3), .b(x2), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n32_), .c(x1), .d(new_n15_), .O(z6));
