...
module FAU ( 
  ...
  nand4  g13(.a(new_n21_), .b(new_n20_), .c(x1), .d(x0), .O(new_n28_));
  ...
  nand4  g21(.a(new_n35_), .b(new_n16_), .c(x3), .d(x0), .O(z5));
  ...
  nand3  g25(.a(new_n21_), .b(x2), .c(x1), .O(new_n40_));
  inv1   g26(.a(new_n40_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n16_), .c(x3), .d(x0), .O(z7));
endmodule
