...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n26_, new_n27_, new_n29_, new_n30_, new_n33_, new_n34_;
  ...
  nand3  g14(.a(new_n18_), .b(new_n17_), .c(x3), .O(new_n29_));
  inv1   g15(.a(new_n29_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(x2), .c(new_n23_), .d(new_n26_), .O(z4));
  nand4  g17(.a(new_n30_), .b(x2), .c(new_n23_), .d(x0), .O(z5));
  nor2   g18(.a(x5), .b(x4), .O(new_n33_));
  and2   g19(.a(x3), .b(x2), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n33_), .c(x1), .d(new_n26_), .O(z6));
