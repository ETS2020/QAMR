...
module FAU ( 
  ...
  nand3  g13(.a(new_n20_), .b(x3), .c(new_n17_), .O(new_n28_));
  inv1   g14(.a(new_n28_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n19_), .c(x1), .d(new_n16_), .O(z2));
  nand2  g16(.a(new_n20_), .b(x3), .O(new_n31_));
  oai21  g17(.a(new_n31_), .b(new_n25_), .c(new_n19_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x1), .O(z3));
  nand3  g19(.a(new_n20_), .b(new_n19_), .c(x3), .O(new_n34_));
  ...
  oai21  g24(.a(new_n38_), .b(new_n31_), .c(new_n19_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(x1), .O(z6));
  nand2  g26(.a(x2), .b(x0), .O(new_n41_));
  oai21  g27(.a(new_n41_), .b(new_n31_), .c(new_n19_), .O(new_n42_));
