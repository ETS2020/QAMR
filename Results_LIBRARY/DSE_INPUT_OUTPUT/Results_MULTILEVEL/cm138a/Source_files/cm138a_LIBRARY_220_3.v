...
module FAU ( 
  ...
  nand3  g12(.a(new_n18_), .b(new_n17_), .c(x1), .O(new_n27_));
  inv1   g13(.a(new_n27_), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(new_n19_), .c(x3), .d(x0), .O(z3));
  nand4  g15(.a(new_n18_), .b(x2), .c(new_n16_), .d(new_n15_), .O(new_n30_));
  ...
  nand3  g21(.a(new_n18_), .b(x2), .c(x1), .O(new_n36_));
  inv1   g22(.a(new_n36_), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n19_), .c(x3), .d(new_n15_), .O(z6));
