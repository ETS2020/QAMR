...
module FAU ( 
  ...
  nand4  g21(.a(new_n35_), .b(new_n34_), .c(new_n16_), .d(x2), .O(z4));
  nor2   g22(.a(x1), .b(new_n17_), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n34_), .c(new_n16_), .d(x2), .O(z5));
  ...
  oai21  g28(.a(new_n42_), .b(new_n28_), .c(x1), .O(new_n43_));
