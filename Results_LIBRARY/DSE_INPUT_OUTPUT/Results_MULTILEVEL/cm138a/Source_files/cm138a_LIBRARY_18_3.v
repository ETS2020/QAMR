...
module FAU ( 
  ...
  nand2  g08(.a(x3), .b(x0), .O(z1));
  nor2   g09(.a(x5), .b(x4), .O(new_n24_));
  nor2   g10(.a(x2), .b(new_n16_), .O(new_n25_));
  nand4  g11(.a(new_n25_), .b(new_n24_), .c(x3), .d(new_n15_), .O(z2));
  nor2   g12(.a(new_n17_), .b(x1), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(new_n24_), .c(x3), .d(new_n15_), .O(z4));
  nor2   g14(.a(new_n17_), .b(new_n16_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n24_), .c(x3), .d(new_n15_), .O(z6));
