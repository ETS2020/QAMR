...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n25_, new_n26_, new_n28_, new_n30_, new_n31_, new_n33_,
  ...
  nand4  g12(.a(new_n26_), .b(new_n16_), .c(x1), .d(x0), .O(z3));
  ...
  nand2  g18(.a(x2), .b(new_n18_), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(new_n25_), .c(x1), .O(new_n34_));
  nand2  g20(.a(x2), .b(new_n15_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n34_), .O(z6));
  nand2  g22(.a(x2), .b(x0), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n25_), .c(x1), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n35_), .O(z7));
  nand2  g25(.a(new_n16_), .b(new_n15_), .O(z1));
endmodule
