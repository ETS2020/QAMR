...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n26_, new_n29_, new_n30_, new_n31_, new_n32_,
    new_n33_;
  ...
  nand4  g08(.a(new_n19_), .b(new_n18_), .c(x3), .d(new_n17_), .O(new_n23_));
  inv1   g09(.a(new_n23_), .O(new_n24_));
  nand3  g10(.a(new_n24_), .b(new_n16_), .c(x0), .O(z1));
  nand2  g11(.a(new_n23_), .b(new_n15_), .O(new_n26_));
  ...
  nand3  g18(.a(new_n33_), .b(new_n32_), .c(new_n29_), .O(z4));
