...
module FAU ( 
  ...
  nand4  g19(.a(new_n33_), .b(new_n28_), .c(x1), .d(x0), .O(z3));
  nand4  g20(.a(new_n19_), .b(x3), .c(x2), .d(new_n15_), .O(new_n35_));
  ...
  nand2  g25(.a(new_n39_), .b(new_n16_), .O(z5));
  nor2   g26(.a(x4), .b(new_n32_), .O(new_n41_));
