...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n31_, new_n32_,
    new_n34_, new_n35_;
  ...
  nand4  g10(.a(new_n20_), .b(new_n19_), .c(x3), .d(new_n17_), .O(new_n25_));
  inv1   g11(.a(new_n25_), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n16_), .c(x0), .O(z1));
  nand2  g13(.a(new_n25_), .b(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x1), .O(z2));
  nand2  g15(.a(x1), .b(x0), .O(z3));
  nand2  g16(.a(x2), .b(new_n16_), .O(new_n31_));
  ...
  nand4  g21(.a(new_n35_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand4  g22(.a(new_n35_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  one    g23(.O(z7));
endmodule
