...
module FAU ( 
  ...
  nand4  g18(.a(new_n32_), .b(new_n27_), .c(new_n16_), .d(x2), .O(z4));
  nor2   g19(.a(x1), .b(new_n17_), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n27_), .c(new_n16_), .d(x2), .O(z5));
  nor2   g21(.a(new_n26_), .b(new_n18_), .O(new_n36_));
  nor2   g22(.a(x5), .b(x4), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n36_), .c(x1), .d(new_n17_), .O(z6));
  nand2  g24(.a(x2), .b(x0), .O(new_n39_));
  nand3  g25(.a(new_n16_), .b(new_n19_), .c(x3), .O(new_n40_));
