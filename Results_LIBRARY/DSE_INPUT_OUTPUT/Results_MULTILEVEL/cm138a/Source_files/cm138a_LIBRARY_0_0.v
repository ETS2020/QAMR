...
module FAU ( 
  ...
  nand4  g12(.a(new_n18_), .b(new_n24_), .c(x3), .d(new_n28_), .O(new_n29_));
  nand2  g13(.a(new_n29_), .b(x2), .O(new_n30_));
  nand2  g14(.a(new_n30_), .b(new_n21_), .O(z4));
  nand4  g15(.a(new_n18_), .b(new_n24_), .c(x3), .d(x0), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(x2), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(new_n21_), .O(z5));
  nand4  g18(.a(new_n26_), .b(x2), .c(x1), .d(new_n28_), .O(z6));
  nand2  g19(.a(new_n17_), .b(new_n21_), .O(new_n36_));
  nand2  g20(.a(new_n25_), .b(new_n36_), .O(new_n37_));
  oai21  g21(.a(new_n17_), .b(new_n28_), .c(x1), .O(new_n38_));
  nand2  g22(.a(x2), .b(new_n21_), .O(new_n39_));
  nand3  g23(.a(new_n39_), .b(new_n38_), .c(new_n37_), .O(z7));
  one    g24(.O(z0));
  one    g25(.O(z1));
endmodule
