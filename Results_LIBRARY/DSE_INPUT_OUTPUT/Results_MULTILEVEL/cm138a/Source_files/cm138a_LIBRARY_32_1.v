...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n24_, new_n26_, new_n27_, new_n28_, new_n29_, new_n33_,
  ...
  nand3  g13(.a(new_n21_), .b(new_n27_), .c(x3), .O(new_n28_));
  inv1   g14(.a(new_n28_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n15_), .c(x1), .d(new_n26_), .O(z2));
  nand4  g16(.a(new_n29_), .b(new_n15_), .c(x1), .d(x0), .O(z3));
  nand3  g17(.a(new_n29_), .b(new_n16_), .c(x2), .O(z4));
  inv1   g18(.a(x1), .O(new_n33_));
  nand4  g19(.a(new_n29_), .b(x2), .c(new_n33_), .d(x0), .O(z5));
  nand2  g20(.a(x1), .b(new_n26_), .O(new_n35_));
  nand3  g21(.a(new_n21_), .b(new_n27_), .c(x2), .O(new_n36_));
  oai21  g22(.a(new_n36_), .b(new_n35_), .c(x3), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n22_), .O(z6));
  nor2   g24(.a(new_n15_), .b(new_n33_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n17_), .c(x3), .d(x0), .O(z7));
endmodule
