...
module FAU ( 
  ...
  nand3  g12(.a(new_n16_), .b(new_n20_), .c(x3), .O(new_n27_));
  ...
  and2   g24(.a(x3), .b(x2), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n38_), .c(x1), .d(new_n17_), .O(z6));
  nand2  g26(.a(x2), .b(x0), .O(new_n41_));
  oai21  g27(.a(new_n41_), .b(new_n27_), .c(x1), .O(new_n42_));
