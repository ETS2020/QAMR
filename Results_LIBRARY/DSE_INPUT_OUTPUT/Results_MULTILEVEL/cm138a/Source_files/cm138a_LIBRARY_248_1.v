...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_,
    ...
    new_n32_, new_n33_, new_n37_, new_n38_, new_n39_, new_n41_;
  ...
  nand4  g20(.a(new_n30_), .b(x2), .c(new_n19_), .d(new_n15_), .O(z4));
  nand4  g21(.a(new_n30_), .b(x2), .c(new_n19_), .d(x0), .O(z5));
  nand2  g22(.a(x1), .b(new_n15_), .O(new_n37_));
  nand3  g23(.a(new_n23_), .b(new_n22_), .c(x2), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(new_n37_), .c(x3), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n27_), .O(z6));
  oai21  g26(.a(new_n38_), .b(new_n32_), .c(x3), .O(new_n41_));
