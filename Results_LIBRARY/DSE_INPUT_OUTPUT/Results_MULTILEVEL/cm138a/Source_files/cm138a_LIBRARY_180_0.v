...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n32_, new_n34_,
    new_n35_, new_n37_;
  ...
  nand4  g12(.a(new_n26_), .b(new_n17_), .c(x1), .d(new_n15_), .O(z2));
  nand4  g13(.a(new_n26_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  nand4  g14(.a(new_n19_), .b(new_n18_), .c(x2), .d(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x3), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(z4));
  inv1   g17(.a(new_n29_), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(x3), .c(x0), .O(z5));
  nand4  g19(.a(new_n19_), .b(new_n18_), .c(x2), .d(x1), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x3), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n15_), .O(z6));
  inv1   g22(.a(new_n34_), .O(new_n37_));
  nand3  g23(.a(new_n37_), .b(x3), .c(x0), .O(z7));
endmodule
