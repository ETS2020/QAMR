...
module FAU ( 
  ...
  nand2  g18(.a(x4), .b(new_n15_), .O(new_n33_));
  nand2  g19(.a(new_n30_), .b(new_n33_), .O(new_n34_));
  xor2a  g20(.a(x4), .b(x0), .O(new_n35_));
  ...
  nand2  g25(.a(new_n37_), .b(new_n33_), .O(new_n40_));
