...
module FAU ( 
  ...
  nand2  g14(.a(new_n21_), .b(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n23_), .b(x3), .O(new_n30_));
  oai21  g16(.a(new_n30_), .b(new_n29_), .c(new_n24_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x1), .O(z2));
  oai21  g18(.a(new_n30_), .b(new_n22_), .c(new_n24_), .O(new_n33_));
  ...
  nand3  g26(.a(new_n23_), .b(x3), .c(x2), .O(new_n41_));
  inv1   g27(.a(new_n41_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n24_), .c(x1), .d(new_n15_), .O(z6));
  oai21  g29(.a(new_n38_), .b(new_n30_), .c(new_n24_), .O(new_n44_));
  nand2  g30(.a(new_n44_), .b(x1), .O(z7));
endmodule
