...
module FAU ( 
  ...
  nand3  g14(.a(new_n23_), .b(x3), .c(new_n21_), .O(new_n29_));
  inv1   g15(.a(new_n29_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n24_), .c(x1), .d(new_n15_), .O(z2));
  nand2  g17(.a(new_n23_), .b(x3), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(new_n22_), .c(new_n24_), .O(new_n33_));
  ...
  nor2   g23(.a(new_n17_), .b(new_n21_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n19_), .c(new_n16_), .d(x0), .O(z5));
  nand3  g25(.a(new_n23_), .b(x3), .c(x2), .O(new_n40_));
  inv1   g26(.a(new_n40_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n24_), .c(x1), .d(new_n15_), .O(z6));
  nand2  g28(.a(x2), .b(x0), .O(new_n43_));
  oai21  g29(.a(new_n43_), .b(new_n32_), .c(new_n24_), .O(new_n44_));
