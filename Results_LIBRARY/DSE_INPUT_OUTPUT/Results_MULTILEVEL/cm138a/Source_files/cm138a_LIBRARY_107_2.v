...
module FAU ( 
  ...
  and2   g17(.a(x3), .b(x2), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n31_), .c(new_n16_), .d(x0), .O(z5));
  nand2  g19(.a(new_n31_), .b(x2), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x3), .O(new_n35_));
  nor2   g21(.a(new_n29_), .b(x0), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n35_), .O(z6));
  nand3  g23(.a(new_n31_), .b(x2), .c(x0), .O(new_n38_));
