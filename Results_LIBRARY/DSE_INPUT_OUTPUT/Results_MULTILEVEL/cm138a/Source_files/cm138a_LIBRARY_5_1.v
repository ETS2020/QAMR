...
module FAU ( 
  ...
  nand3  g14(.a(new_n24_), .b(x3), .c(new_n29_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(x0), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(x1), .O(z3));
  nand3  g17(.a(new_n24_), .b(x3), .c(x2), .O(new_n33_));
  inv1   g18(.a(new_n33_), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n19_), .c(new_n18_), .O(z4));
  nand2  g20(.a(x1), .b(new_n18_), .O(z6));
  nand2  g21(.a(z6), .b(new_n33_), .O(new_n37_));
  xor2a  g22(.a(x1), .b(x0), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n37_), .O(z5));
  nand2  g24(.a(new_n33_), .b(x0), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(x1), .O(z7));
  one    g26(.O(z2));
endmodule
