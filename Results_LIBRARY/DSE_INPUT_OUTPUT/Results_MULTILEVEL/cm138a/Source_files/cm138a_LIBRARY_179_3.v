...
module FAU ( 
  ...
  oai21  g20(.a(new_n34_), .b(new_n33_), .c(new_n16_), .O(new_n35_));
  nand2  g21(.a(new_n18_), .b(x1), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n35_), .O(z5));
  nand4  g23(.a(new_n19_), .b(x3), .c(x2), .d(new_n15_), .O(new_n38_));
