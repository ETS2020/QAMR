...
module FAU ( 
  ...
  nand3  g14(.a(new_n20_), .b(new_n15_), .c(x3), .O(new_n29_));
  inv1   g15(.a(new_n29_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n19_), .c(x1), .d(new_n16_), .O(z2));
  nand4  g17(.a(new_n30_), .b(new_n19_), .c(x1), .d(x0), .O(z3));
  ...
  oai21  g24(.a(new_n33_), .b(new_n38_), .c(new_n15_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n23_), .O(z6));
  nor2   g26(.a(new_n19_), .b(new_n17_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n26_), .c(new_n15_), .d(x0), .O(z7));
endmodule
