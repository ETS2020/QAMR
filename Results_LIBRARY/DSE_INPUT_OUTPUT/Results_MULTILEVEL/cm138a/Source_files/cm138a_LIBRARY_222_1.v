...
module FAU ( 
  ...
  nand2  g13(.a(new_n27_), .b(new_n16_), .O(z2));
  ...
  oai21  g23(.a(new_n37_), .b(x1), .c(new_n17_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n32_), .O(z5));
  nand3  g25(.a(x3), .b(x2), .c(x1), .O(new_n40_));
  inv1   g26(.a(new_n40_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z6));
  nand2  g28(.a(x1), .b(x0), .O(new_n43_));
  oai21  g29(.a(new_n43_), .b(new_n37_), .c(new_n17_), .O(new_n44_));
