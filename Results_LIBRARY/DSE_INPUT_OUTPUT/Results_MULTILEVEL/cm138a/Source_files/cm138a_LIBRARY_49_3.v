...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n24_, new_n28_, new_n29_, new_n30_, new_n32_, new_n33_,
  ...
  nand3  g13(.a(new_n16_), .b(x3), .c(x2), .O(new_n28_));
  oai21  g14(.a(new_n28_), .b(new_n21_), .c(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n16_), .b(x4), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n29_), .O(z4));
  inv1   g17(.a(x3), .O(new_n32_));
  nor2   g18(.a(x5), .b(new_n32_), .O(new_n33_));
  nor2   g19(.a(new_n24_), .b(x1), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n33_), .c(new_n15_), .d(x0), .O(z5));
  nand2  g21(.a(x1), .b(new_n19_), .O(new_n36_));
  oai21  g22(.a(new_n28_), .b(new_n36_), .c(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n30_), .O(z6));
  nor2   g24(.a(new_n24_), .b(new_n20_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n33_), .c(new_n15_), .d(x0), .O(z7));
endmodule
