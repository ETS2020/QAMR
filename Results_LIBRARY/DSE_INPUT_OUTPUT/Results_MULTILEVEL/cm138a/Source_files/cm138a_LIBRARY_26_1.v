...
module FAU ( 
  ...
  nand2  g18(.a(new_n19_), .b(new_n15_), .O(new_n33_));
  nand3  g19(.a(new_n23_), .b(new_n22_), .c(x2), .O(new_n34_));
  oai21  g20(.a(new_n34_), .b(new_n33_), .c(x3), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n27_), .O(z4));
  oai21  g22(.a(new_n34_), .b(new_n20_), .c(x3), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n27_), .O(z5));
  nand2  g24(.a(x1), .b(new_n15_), .O(new_n39_));
  oai21  g25(.a(new_n34_), .b(new_n39_), .c(x3), .O(new_n40_));
