...
module FAU ( 
  ...
  nand3  g11(.a(new_n18_), .b(new_n23_), .c(x3), .O(new_n26_));
  inv1   g12(.a(new_n26_), .O(new_n27_));
  nor2   g13(.a(new_n16_), .b(x0), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n27_), .c(new_n17_), .O(z2));
  nand4  g15(.a(new_n27_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  ...
  nand3  g25(.a(new_n39_), .b(new_n23_), .c(x0), .O(z7));
endmodule
