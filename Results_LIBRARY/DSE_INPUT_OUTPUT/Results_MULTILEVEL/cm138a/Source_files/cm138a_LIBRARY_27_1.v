...
module FAU ( 
  ...
  nand4  g14(.a(new_n28_), .b(new_n27_), .c(x1), .d(new_n17_), .O(z2));
  nand2  g15(.a(new_n16_), .b(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n18_), .b(x0), .O(new_n31_));
  nand3  g17(.a(new_n16_), .b(new_n19_), .c(x3), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(new_n31_), .c(x1), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n30_), .O(z3));
  nor2   g20(.a(x4), .b(new_n26_), .O(new_n35_));
  nor2   g21(.a(x1), .b(x0), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n35_), .c(new_n16_), .d(x2), .O(z4));
  nor2   g23(.a(x1), .b(new_n17_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n35_), .c(new_n16_), .d(x2), .O(z5));
  nand2  g25(.a(x2), .b(new_n17_), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n32_), .c(x1), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n30_), .O(z6));
  nand2  g28(.a(x2), .b(x0), .O(new_n43_));
  oai21  g29(.a(new_n43_), .b(new_n32_), .c(x1), .O(new_n44_));
  nand2  g30(.a(new_n44_), .b(new_n30_), .O(z7));
endmodule
