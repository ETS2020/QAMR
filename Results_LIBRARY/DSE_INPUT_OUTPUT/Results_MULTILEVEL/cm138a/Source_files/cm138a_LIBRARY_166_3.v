...
module FAU ( 
  ...
  oai21  g17(.a(new_n32_), .b(new_n21_), .c(new_n15_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n23_), .O(z4));
  nand3  g19(.a(new_n25_), .b(x3), .c(x2), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n16_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(x0), .O(z5));
  inv1   g22(.a(new_n35_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(x1), .c(new_n15_), .O(z6));
  one    g24(.O(z3));
  one    g25(.O(z7));
endmodule
