...
module FAU ( 
  ...
  oai21  g26(.a(new_n35_), .b(new_n26_), .c(x3), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n30_), .O(z6));
  nor2   g28(.a(new_n24_), .b(new_n20_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n32_), .c(x3), .d(x0), .O(z7));
endmodule
