...
module FAU ( 
  ...
  nor2   g17(.a(x2), .b(new_n21_), .O(new_n32_));
  ...
  oai21  g23(.a(new_n35_), .b(new_n22_), .c(new_n16_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n27_), .O(z5));
  oai21  g25(.a(new_n35_), .b(new_n29_), .c(new_n16_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n27_), .O(z6));
  nor2   g27(.a(new_n23_), .b(new_n21_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n19_), .c(new_n16_), .d(x0), .O(z7));
endmodule
