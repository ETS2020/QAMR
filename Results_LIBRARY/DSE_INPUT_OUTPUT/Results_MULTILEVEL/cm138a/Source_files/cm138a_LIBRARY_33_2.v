...
module FAU ( 
  ...
  nand4  g17(.a(x3), .b(x2), .c(x1), .d(new_n21_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n16_), .O(z6));
  nand3  g20(.a(x3), .b(x2), .c(x1), .O(new_n35_));
  inv1   g21(.a(new_n35_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n16_), .c(new_n31_), .d(x0), .O(z7));
endmodule
