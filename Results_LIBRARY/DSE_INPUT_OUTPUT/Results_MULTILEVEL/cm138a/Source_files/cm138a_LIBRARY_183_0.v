...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n34_, new_n37_, new_n38_, new_n40_;
  ...
  nand3  g15(.a(new_n29_), .b(x3), .c(new_n15_), .O(z2));
  nand2  g16(.a(new_n28_), .b(new_n24_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n26_), .O(z3));
  nand3  g18(.a(new_n19_), .b(new_n18_), .c(x3), .O(new_n33_));
  inv1   g19(.a(new_n33_), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(x2), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g21(.a(new_n34_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand4  g22(.a(new_n19_), .b(new_n18_), .c(x2), .d(x1), .O(new_n37_));
  inv1   g23(.a(new_n37_), .O(new_n38_));
  nand3  g24(.a(new_n38_), .b(x3), .c(new_n15_), .O(z6));
  nand2  g25(.a(new_n37_), .b(new_n24_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n26_), .O(z7));
endmodule
