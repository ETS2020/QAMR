...
module FAU ( 
  ...
  nand4  g15(.a(new_n29_), .b(new_n28_), .c(x1), .d(new_n15_), .O(z2));
  nand2  g16(.a(new_n17_), .b(new_n16_), .O(new_n31_));
  nand3  g17(.a(new_n17_), .b(new_n19_), .c(x3), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(new_n24_), .c(x1), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n31_), .O(z3));
  nand2  g20(.a(x2), .b(new_n15_), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n23_), .c(new_n17_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n16_), .O(z4));
  nand3  g23(.a(new_n19_), .b(x3), .c(x2), .O(new_n38_));
  inv1   g24(.a(new_n38_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n17_), .c(new_n16_), .d(x0), .O(z5));
  oai21  g26(.a(new_n35_), .b(new_n32_), .c(x1), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n31_), .O(z6));
  nor2   g28(.a(new_n27_), .b(new_n18_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n29_), .c(x1), .d(x0), .O(z7));
endmodule
