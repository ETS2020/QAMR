...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n26_, new_n27_;
  ...
  nand3  g11(.a(new_n19_), .b(new_n15_), .c(x3), .O(new_n26_));
  inv1   g12(.a(new_n26_), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(new_n16_), .c(x1), .d(new_n17_), .O(z2));
  nand4  g14(.a(new_n27_), .b(new_n16_), .c(x1), .d(x0), .O(z3));
  buf    g15(.a(x0), .O(z4));
  buf    g16(.a(x0), .O(z5));
  buf    g17(.a(x0), .O(z6));
  buf    g18(.a(x0), .O(z7));
