...
module FAU ( 
  ...
  nand3  g20(.a(new_n20_), .b(new_n15_), .c(x3), .O(new_n35_));
  inv1   g21(.a(new_n35_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(x2), .c(new_n17_), .d(new_n16_), .O(z4));
  nand4  g23(.a(new_n36_), .b(x2), .c(new_n17_), .d(x0), .O(z5));
  nand3  g24(.a(new_n20_), .b(x3), .c(x2), .O(new_n39_));
  oai21  g25(.a(new_n39_), .b(new_n29_), .c(new_n15_), .O(new_n40_));
