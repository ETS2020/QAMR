...
module FAU ( 
  ...
  nand3  g17(.a(new_n19_), .b(new_n16_), .c(x3), .O(new_n32_));
  ...
  nand4  g22(.a(new_n36_), .b(new_n16_), .c(new_n15_), .d(new_n17_), .O(z4));
  ...
  nand3  g26(.a(new_n19_), .b(new_n16_), .c(x3), .O(new_n41_));
  inv1   g27(.a(new_n41_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(x2), .c(x1), .d(new_n17_), .O(z6));
  nand4  g29(.a(new_n42_), .b(x2), .c(x1), .d(x0), .O(z7));
endmodule
