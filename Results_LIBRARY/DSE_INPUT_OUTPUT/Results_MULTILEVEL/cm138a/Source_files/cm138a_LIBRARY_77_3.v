...
module FAU ( 
  ...
  nand3  g12(.a(new_n18_), .b(new_n23_), .c(x3), .O(new_n27_));
  inv1   g13(.a(new_n27_), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(new_n17_), .c(x1), .d(new_n26_), .O(z2));
  nand4  g15(.a(new_n28_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  nand4  g16(.a(new_n18_), .b(x3), .c(x2), .d(new_n16_), .O(new_n31_));
  inv1   g17(.a(new_n31_), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n23_), .c(new_n26_), .O(z4));
  ...
  nand3  g23(.a(new_n37_), .b(new_n23_), .c(new_n26_), .O(z6));
