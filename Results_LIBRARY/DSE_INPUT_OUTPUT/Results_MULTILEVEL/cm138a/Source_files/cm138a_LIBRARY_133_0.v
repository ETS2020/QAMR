...
module FAU ( 
  ...
  nand4  g09(.a(new_n19_), .b(new_n18_), .c(new_n17_), .d(x1), .O(new_n24_));
  ...
  xnor2a g15(.a(x3), .b(x0), .O(new_n30_));
  ...
  nand3  g21(.a(new_n35_), .b(x3), .c(x0), .O(z5));
  ...
  nand2  g25(.a(new_n37_), .b(new_n28_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n30_), .O(z7));
endmodule
