...
module FAU ( 
  ...
  nand4  g21(.a(new_n35_), .b(new_n26_), .c(new_n15_), .d(new_n16_), .O(z4));
  nand2  g22(.a(new_n17_), .b(x0), .O(new_n37_));
  nand3  g23(.a(new_n20_), .b(x3), .c(x2), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(new_n37_), .c(new_n15_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n23_), .O(z5));
  nor2   g26(.a(new_n19_), .b(new_n17_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n26_), .c(new_n15_), .d(new_n16_), .O(z6));
  oai21  g28(.a(new_n38_), .b(new_n32_), .c(new_n15_), .O(new_n43_));
  nand2  g29(.a(new_n43_), .b(new_n23_), .O(z7));
endmodule
