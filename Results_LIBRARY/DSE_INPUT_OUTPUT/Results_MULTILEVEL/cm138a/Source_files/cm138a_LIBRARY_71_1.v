...
module FAU ( 
  ...
  oai21  g24(.a(new_n38_), .b(new_n21_), .c(new_n16_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n15_), .O(z5));
  nand2  g26(.a(x2), .b(new_n17_), .O(new_n41_));
  oai21  g27(.a(new_n41_), .b(new_n31_), .c(x1), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n33_), .O(z6));
