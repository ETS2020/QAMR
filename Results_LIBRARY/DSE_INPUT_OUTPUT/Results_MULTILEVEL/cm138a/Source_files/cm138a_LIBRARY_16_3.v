...
module FAU ( 
  ...
  nand3  g14(.a(new_n20_), .b(x3), .c(new_n17_), .O(new_n29_));
  inv1   g15(.a(new_n29_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n19_), .c(x1), .d(new_n16_), .O(z2));
  nand4  g17(.a(new_n20_), .b(x3), .c(new_n17_), .d(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n19_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x1), .O(z3));
  nor2   g20(.a(new_n26_), .b(new_n17_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n25_), .c(new_n15_), .d(new_n16_), .O(z4));
  nand2  g22(.a(x2), .b(x0), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n21_), .c(new_n15_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n23_), .O(z5));
  nand3  g25(.a(new_n20_), .b(new_n19_), .c(x3), .O(new_n40_));
  inv1   g26(.a(new_n40_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(x2), .c(x1), .d(new_n16_), .O(z6));
