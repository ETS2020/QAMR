...
module FAU ( 
  ...
  nand2  g22(.a(new_n20_), .b(x0), .O(new_n37_));
  oai21  g23(.a(new_n34_), .b(new_n37_), .c(new_n15_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n29_), .O(z5));
  oai21  g25(.a(new_n34_), .b(new_n26_), .c(new_n15_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n29_), .O(z6));
