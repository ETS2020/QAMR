...
module FAU ( 
  ...
  nor3   g13(.a(x5), .b(x4), .c(x0), .O(new_n28_));
  ...
  oai21  g19(.a(new_n33_), .b(x1), .c(new_n16_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n28_), .O(z4));
  ...
  nand4  g24(.a(x3), .b(x2), .c(x1), .d(new_n17_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n16_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n15_), .O(z6));
  nand3  g27(.a(x3), .b(x2), .c(x1), .O(new_n42_));
  inv1   g28(.a(new_n42_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n15_), .c(new_n16_), .d(x0), .O(z7));
endmodule
