...
module FAU ( 
  ...
  nand4  g13(.a(new_n27_), .b(new_n19_), .c(x1), .d(new_n17_), .O(z2));
  ...
  nand4  g19(.a(new_n33_), .b(new_n16_), .c(new_n15_), .d(new_n17_), .O(z4));
  ...
  nand4  g25(.a(new_n39_), .b(new_n16_), .c(new_n15_), .d(new_n17_), .O(z6));
  oai21  g26(.a(new_n32_), .b(new_n29_), .c(new_n16_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n15_), .O(z7));
endmodule
