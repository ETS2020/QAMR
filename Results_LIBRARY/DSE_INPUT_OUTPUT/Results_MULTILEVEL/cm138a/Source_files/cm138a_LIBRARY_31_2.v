...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n34_, new_n36_, new_n37_, new_n39_, new_n40_, new_n41_;
  ...
  nand4  g21(.a(x3), .b(x2), .c(x1), .d(new_n15_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n18_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n19_), .O(z6));
  nand2  g24(.a(x1), .b(x0), .O(new_n39_));
  nand2  g25(.a(x3), .b(x2), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n39_), .c(new_n18_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n19_), .O(z7));
endmodule
