...
module FAU ( 
  ...
  nand4  g15(.a(new_n21_), .b(x2), .c(new_n19_), .d(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x3), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n16_), .O(z4));
  nand3  g18(.a(new_n21_), .b(x2), .c(new_n19_), .O(new_n33_));
  inv1   g19(.a(new_n33_), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n16_), .c(x3), .d(x0), .O(z5));
  nand3  g21(.a(new_n27_), .b(new_n26_), .c(x2), .O(z6));
  nand4  g22(.a(new_n26_), .b(x2), .c(x1), .d(x0), .O(z7));
endmodule
