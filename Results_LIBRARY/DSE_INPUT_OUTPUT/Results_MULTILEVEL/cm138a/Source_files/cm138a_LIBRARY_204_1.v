...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n31_, new_n34_, new_n35_, new_n37_;
  ...
  nand3  g17(.a(new_n31_), .b(new_n30_), .c(new_n18_), .O(z2));
  nand4  g18(.a(new_n30_), .b(new_n18_), .c(x1), .d(x0), .O(z3));
  ...
  oai21  g22(.a(new_n34_), .b(new_n26_), .c(x3), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n24_), .O(z5));
