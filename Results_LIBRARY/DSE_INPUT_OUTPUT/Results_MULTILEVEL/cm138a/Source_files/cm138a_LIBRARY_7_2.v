...
module FAU ( 
  ...
  nand3  g08(.a(new_n19_), .b(new_n15_), .c(x3), .O(new_n23_));
  inv1   g09(.a(new_n23_), .O(new_n24_));
  nand4  g10(.a(new_n24_), .b(new_n16_), .c(new_n18_), .d(x0), .O(z1));
  nand4  g11(.a(new_n24_), .b(new_n16_), .c(x1), .d(new_n17_), .O(z2));
  inv1   g12(.a(x3), .O(new_n27_));
  nor2   g13(.a(x5), .b(new_n27_), .O(new_n28_));
  nor2   g14(.a(new_n18_), .b(new_n17_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n28_), .c(new_n15_), .d(new_n16_), .O(z3));
  nand2  g16(.a(new_n15_), .b(x2), .O(z4));
