...
module FAU ( 
  ...
  nor2   g18(.a(x5), .b(x4), .O(new_n35_));
  nand3  g19(.a(new_n35_), .b(x3), .c(new_n34_), .O(new_n36_));
  nand2  g20(.a(new_n36_), .b(x2), .O(new_n37_));
  nand2  g21(.a(new_n37_), .b(x1), .O(z6));
  nand3  g22(.a(new_n35_), .b(x3), .c(x0), .O(new_n39_));
  nand2  g23(.a(new_n39_), .b(x2), .O(new_n40_));
  nand2  g24(.a(new_n40_), .b(x1), .O(z7));
  one    g25(.O(z2));
  one    g26(.O(z3));
endmodule
