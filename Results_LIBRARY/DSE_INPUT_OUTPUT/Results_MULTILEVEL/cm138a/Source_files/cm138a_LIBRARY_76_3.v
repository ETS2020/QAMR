...
module FAU ( 
  ...
  nand4  g10(.a(new_n15_), .b(new_n20_), .c(x1), .d(new_n21_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n24_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x3), .O(z2));
  nand3  g13(.a(new_n15_), .b(new_n20_), .c(x1), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n24_), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n17_), .c(x0), .O(z3));
  inv1   g16(.a(x1), .O(new_n31_));
  nand3  g17(.a(new_n15_), .b(x2), .c(new_n31_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n24_), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n17_), .c(new_n21_), .O(z4));
  nand4  g20(.a(new_n15_), .b(x2), .c(new_n31_), .d(x0), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n24_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x3), .O(z5));
  nor2   g23(.a(new_n31_), .b(x0), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n17_), .c(new_n15_), .d(x2), .O(z6));
  nor2   g25(.a(new_n31_), .b(new_n21_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n17_), .c(new_n15_), .d(x2), .O(z7));
endmodule
