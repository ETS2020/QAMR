...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n25_, new_n26_, new_n28_, new_n29_;
  ...
  nand4  g09(.a(new_n23_), .b(x3), .c(x1), .d(new_n15_), .O(z2));
  nand4  g10(.a(new_n19_), .b(new_n18_), .c(x2), .d(new_n16_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n15_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x3), .O(z4));
  nand4  g13(.a(new_n19_), .b(new_n18_), .c(x2), .d(x1), .O(new_n28_));
