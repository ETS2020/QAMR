...
module FAU ( 
  ...
  nand2  g18(.a(new_n32_), .b(new_n18_), .O(z5));
  nand4  g19(.a(x3), .b(x2), .c(x1), .d(new_n15_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n19_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n18_), .O(z6));
  oai21  g22(.a(new_n28_), .b(new_n25_), .c(new_n19_), .O(new_n37_));
