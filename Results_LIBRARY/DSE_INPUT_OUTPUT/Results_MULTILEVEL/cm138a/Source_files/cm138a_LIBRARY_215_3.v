...
module FAU ( 
  ...
  nand4  g16(.a(new_n30_), .b(new_n28_), .c(new_n18_), .d(new_n15_), .O(z4));
  nand2  g17(.a(new_n16_), .b(x0), .O(new_n32_));
  nand3  g18(.a(new_n19_), .b(x3), .c(x2), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(new_n32_), .c(new_n18_), .O(new_n34_));
  nand2  g20(.a(new_n19_), .b(x4), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n34_), .O(z5));
  nor2   g22(.a(new_n17_), .b(new_n16_), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n30_), .c(new_n18_), .d(new_n15_), .O(z6));
  oai21  g24(.a(new_n33_), .b(new_n25_), .c(new_n18_), .O(new_n39_));
