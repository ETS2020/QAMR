...
module FAU ( 
  ...
  nand2  g10(.a(new_n19_), .b(new_n18_), .O(new_n25_));
  oai21  g11(.a(new_n25_), .b(new_n24_), .c(x3), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x1), .O(z2));
  nor3   g13(.a(x5), .b(x4), .c(x2), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(x3), .c(x1), .d(x0), .O(z3));
  nand2  g15(.a(x3), .b(x1), .O(new_n30_));
  nand2  g16(.a(x2), .b(new_n15_), .O(new_n31_));
  nand3  g17(.a(new_n19_), .b(new_n18_), .c(x3), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(new_n31_), .c(new_n16_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n30_), .O(z4));
  nand2  g20(.a(x2), .b(x0), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n32_), .c(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n30_), .O(z5));
  oai21  g23(.a(new_n31_), .b(new_n25_), .c(x3), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x1), .O(z6));
  oai21  g25(.a(new_n35_), .b(new_n25_), .c(x3), .O(new_n40_));
