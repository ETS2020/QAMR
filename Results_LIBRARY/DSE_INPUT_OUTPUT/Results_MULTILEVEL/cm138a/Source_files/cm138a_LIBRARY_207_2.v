...
module FAU ( 
  ...
  nand4  g13(.a(new_n27_), .b(new_n15_), .c(new_n16_), .d(new_n17_), .O(z2));
  ...
  nand3  g17(.a(new_n15_), .b(new_n16_), .c(x3), .O(new_n32_));
  ...
  nand4  g26(.a(new_n40_), .b(new_n15_), .c(new_n16_), .d(x0), .O(z7));
endmodule
