...
module FAU ( 
  ...
  nand4  g06(.a(new_n16_), .b(new_n15_), .c(new_n20_), .d(x1), .O(new_n21_));
  nand2  g07(.a(new_n21_), .b(new_n19_), .O(new_n22_));
  nand2  g08(.a(new_n22_), .b(x3), .O(z2));
  nand2  g09(.a(x3), .b(x0), .O(z3));
  ...
  nor2   g15(.a(new_n20_), .b(new_n25_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n29_), .c(x3), .d(new_n19_), .O(z6));
  buf    g17(.a(x0), .O(z1));
  buf    g18(.a(x0), .O(z5));
