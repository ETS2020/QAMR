...
module FAU ( 
  ...
  nand3  g10(.a(new_n19_), .b(new_n18_), .c(x1), .O(new_n25_));
  inv1   g11(.a(new_n25_), .O(new_n26_));
  nand4  g12(.a(new_n26_), .b(new_n15_), .c(x3), .d(new_n16_), .O(z2));
  ...
  nand3  g22(.a(new_n15_), .b(new_n19_), .c(x3), .O(new_n37_));
  inv1   g23(.a(new_n37_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(x2), .c(x1), .d(new_n16_), .O(z6));
