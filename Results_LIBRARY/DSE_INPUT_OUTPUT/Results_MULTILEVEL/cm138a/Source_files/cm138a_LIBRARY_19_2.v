...
module FAU ( 
  ...
  nor3   g20(.a(x5), .b(x4), .c(x1), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(x3), .c(x2), .d(new_n16_), .O(z4));
  nand3  g22(.a(new_n25_), .b(new_n17_), .c(x0), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x3), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x2), .O(z5));
  nand2  g25(.a(new_n20_), .b(new_n19_), .O(new_n40_));
  oai21  g26(.a(new_n29_), .b(new_n40_), .c(x3), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(x2), .O(z6));
  oai21  g28(.a(new_n32_), .b(new_n40_), .c(x3), .O(new_n43_));
