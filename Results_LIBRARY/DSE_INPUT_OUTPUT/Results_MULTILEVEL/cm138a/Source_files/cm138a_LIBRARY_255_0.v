...
module FAU ( 
  ...
  nand3  g13(.a(new_n27_), .b(x2), .c(new_n15_), .O(z4));
  nand2  g14(.a(new_n21_), .b(z0), .O(new_n29_));
  xnor2a g15(.a(x2), .b(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n29_), .O(z5));
  nand2  g17(.a(new_n24_), .b(x2), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n15_), .O(z6));
  nand2  g19(.a(new_n24_), .b(z0), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n30_), .O(z7));
