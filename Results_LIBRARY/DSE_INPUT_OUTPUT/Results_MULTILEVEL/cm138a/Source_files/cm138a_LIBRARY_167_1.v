...
module FAU ( 
  ...
  oai21  g23(.a(new_n37_), .b(new_n34_), .c(new_n18_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n16_), .O(z5));
  oai21  g25(.a(new_n33_), .b(new_n25_), .c(x1), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n27_), .O(z6));
  nor2   g27(.a(new_n30_), .b(new_n17_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n29_), .c(x1), .d(x0), .O(z7));
endmodule
