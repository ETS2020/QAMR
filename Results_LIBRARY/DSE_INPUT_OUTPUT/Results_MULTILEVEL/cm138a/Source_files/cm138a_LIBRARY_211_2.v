...
module FAU ( 
  ...
  nand3  g12(.a(x3), .b(new_n18_), .c(x1), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n16_), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n21_), .c(new_n15_), .O(z2));
  nand4  g15(.a(x3), .b(new_n18_), .c(x1), .d(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n23_), .O(z3));
  nand4  g18(.a(x3), .b(x2), .c(new_n17_), .d(new_n15_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n16_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n23_), .O(z4));
  nand2  g21(.a(x3), .b(x2), .O(new_n36_));
  oai21  g22(.a(new_n36_), .b(x1), .c(new_n16_), .O(new_n37_));
  nand3  g23(.a(new_n37_), .b(new_n21_), .c(x0), .O(z5));
  nand3  g24(.a(new_n23_), .b(new_n16_), .c(x3), .O(new_n39_));
  inv1   g25(.a(new_n39_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
