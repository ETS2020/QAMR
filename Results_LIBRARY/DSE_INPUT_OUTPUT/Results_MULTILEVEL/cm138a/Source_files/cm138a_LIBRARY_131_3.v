...
module FAU ( 
  ...
  nand4  g19(.a(new_n33_), .b(new_n32_), .c(new_n23_), .d(x2), .O(z4));
  inv1   g20(.a(x0), .O(new_n35_));
  nor2   g21(.a(x1), .b(new_n35_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n32_), .c(new_n23_), .d(x2), .O(z5));
  nand4  g23(.a(new_n18_), .b(x3), .c(x2), .d(x1), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n15_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n21_), .O(z6));
