...
module FAU ( 
  ...
  nand2  g26(.a(x1), .b(new_n16_), .O(new_n41_));
  oai21  g27(.a(new_n34_), .b(new_n41_), .c(new_n15_), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n23_), .O(z6));
  oai21  g29(.a(new_n34_), .b(new_n31_), .c(new_n15_), .O(new_n44_));
  nand2  g30(.a(new_n44_), .b(new_n23_), .O(z7));
endmodule
