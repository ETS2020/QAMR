...
module FAU ( 
  ...
  nand4  g22(.a(new_n36_), .b(new_n35_), .c(x3), .d(new_n15_), .O(z4));
  nand3  g23(.a(new_n20_), .b(new_n19_), .c(x2), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(new_n26_), .c(x3), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n24_), .O(z5));
  nand3  g26(.a(new_n20_), .b(new_n19_), .c(x3), .O(new_n41_));
  inv1   g27(.a(new_n41_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
