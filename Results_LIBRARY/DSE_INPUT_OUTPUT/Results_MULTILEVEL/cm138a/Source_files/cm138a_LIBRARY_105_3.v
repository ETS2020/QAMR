...
module FAU ( 
  ...
  nand4  g19(.a(new_n24_), .b(x3), .c(new_n21_), .d(new_n15_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n23_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x2), .O(z4));
  nand3  g22(.a(new_n24_), .b(x3), .c(new_n21_), .O(new_n37_));
  inv1   g23(.a(new_n37_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n23_), .c(x2), .d(x0), .O(z5));
