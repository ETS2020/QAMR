...
module FAU ( 
  ...
  nand2  g10(.a(new_n19_), .b(x3), .O(new_n25_));
  oai21  g11(.a(new_n25_), .b(new_n24_), .c(new_n18_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x1), .O(z2));
  nand3  g13(.a(new_n19_), .b(x3), .c(new_n17_), .O(new_n28_));
  inv1   g14(.a(new_n28_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n18_), .c(x1), .d(x0), .O(z3));
  ...
  oai21  g22(.a(new_n36_), .b(new_n33_), .c(new_n16_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n31_), .O(z5));
  oai21  g24(.a(new_n32_), .b(new_n25_), .c(new_n18_), .O(new_n39_));
