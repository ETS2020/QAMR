...
module FAU ( 
  ...
  nor2   g24(.a(new_n18_), .b(x1), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n38_), .c(x3), .d(x0), .O(z5));
  nor2   g26(.a(new_n18_), .b(new_n16_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n38_), .c(x3), .d(new_n15_), .O(z6));
  oai21  g28(.a(new_n35_), .b(new_n32_), .c(x3), .O(new_n43_));
