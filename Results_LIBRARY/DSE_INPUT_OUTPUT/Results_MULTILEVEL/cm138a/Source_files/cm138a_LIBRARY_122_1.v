...
module FAU ( 
  ...
  nor3   g09(.a(x5), .b(x4), .c(x1), .O(new_n24_));
  nand4  g10(.a(new_n24_), .b(x3), .c(x2), .d(x0), .O(z5));
  nand4  g11(.a(new_n20_), .b(new_n19_), .c(x1), .d(new_n17_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x2), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x3), .O(z6));
  nand4  g14(.a(new_n20_), .b(new_n19_), .c(x1), .d(x0), .O(new_n29_));
