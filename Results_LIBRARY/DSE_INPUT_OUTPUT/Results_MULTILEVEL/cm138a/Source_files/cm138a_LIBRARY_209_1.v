...
module FAU ( 
  ...
  nand4  g16(.a(new_n30_), .b(new_n18_), .c(x1), .d(new_n15_), .O(z2));
  nand4  g17(.a(new_n30_), .b(new_n18_), .c(x1), .d(x0), .O(z3));
  nand3  g18(.a(new_n20_), .b(new_n19_), .c(x2), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(new_n17_), .c(x3), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n24_), .O(z4));
  oai21  g21(.a(new_n33_), .b(new_n26_), .c(x3), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n24_), .O(z5));
  nand2  g23(.a(x1), .b(new_n15_), .O(new_n38_));
  oai21  g24(.a(new_n33_), .b(new_n38_), .c(x3), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n24_), .O(z6));
  nor2   g26(.a(x5), .b(x4), .O(new_n41_));
  nor2   g27(.a(new_n18_), .b(new_n16_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n41_), .c(x3), .d(x0), .O(z7));
endmodule
