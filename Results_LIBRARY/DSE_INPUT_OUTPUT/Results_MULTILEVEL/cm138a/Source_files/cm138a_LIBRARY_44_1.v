...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n33_, new_n35_, new_n36_, new_n39_, new_n40_, new_n41_,
    new_n43_;
  ...
  nand4  g14(.a(new_n28_), .b(new_n17_), .c(x3), .d(new_n26_), .O(z2));
  inv1   g15(.a(x4), .O(new_n30_));
  nand3  g16(.a(new_n21_), .b(new_n30_), .c(new_n15_), .O(new_n31_));
  nand2  g17(.a(x1), .b(x0), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(new_n31_), .c(x3), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n22_), .O(z3));
  nand3  g20(.a(new_n21_), .b(new_n30_), .c(x3), .O(new_n35_));
  inv1   g21(.a(new_n35_), .O(new_n36_));
  nand3  g22(.a(new_n36_), .b(new_n16_), .c(x2), .O(z4));
  nand4  g23(.a(new_n36_), .b(x2), .c(new_n27_), .d(x0), .O(z5));
  nand2  g24(.a(x1), .b(new_n26_), .O(new_n39_));
  nand3  g25(.a(new_n21_), .b(new_n30_), .c(x2), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n39_), .c(x3), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n22_), .O(z6));
  nor2   g28(.a(new_n15_), .b(new_n27_), .O(new_n43_));
