...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n24_, new_n27_, new_n28_, new_n30_, new_n31_;
  ...
  nand3  g10(.a(new_n24_), .b(new_n21_), .c(new_n17_), .O(z2));
  nand4  g11(.a(new_n21_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  nand2  g12(.a(x3), .b(x2), .O(new_n27_));
  nor2   g13(.a(new_n27_), .b(x1), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(new_n19_), .c(new_n18_), .d(new_n15_), .O(z4));
  nand4  g15(.a(x3), .b(x2), .c(new_n16_), .d(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n18_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n19_), .O(z5));
  nand3  g18(.a(new_n24_), .b(new_n21_), .c(x2), .O(z6));
