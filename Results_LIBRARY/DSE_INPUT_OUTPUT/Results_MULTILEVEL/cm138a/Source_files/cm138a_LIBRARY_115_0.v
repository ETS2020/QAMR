...
module FAU ( 
  ...
  nand4  g13(.a(new_n27_), .b(new_n26_), .c(new_n19_), .d(new_n18_), .O(z2));
  nor2   g14(.a(new_n17_), .b(new_n16_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n26_), .c(new_n19_), .d(new_n18_), .O(z3));
  ...
  nand4  g22(.a(new_n27_), .b(new_n26_), .c(new_n19_), .d(x2), .O(z6));
  nand4  g23(.a(new_n29_), .b(new_n26_), .c(new_n19_), .d(x2), .O(z7));
endmodule
