...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n34_, new_n35_, new_n38_, new_n39_, new_n40_, new_n42_;
  ...
  nor2   g14(.a(x2), .b(new_n17_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n26_), .c(new_n15_), .d(new_n16_), .O(z2));
  nand2  g16(.a(x1), .b(x0), .O(new_n31_));
  oai21  g17(.a(new_n31_), .b(new_n21_), .c(new_n15_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n23_), .O(z3));
  nand3  g19(.a(new_n20_), .b(new_n15_), .c(x3), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(x2), .c(new_n17_), .d(new_n16_), .O(z4));
  nand4  g22(.a(new_n35_), .b(x2), .c(new_n17_), .d(x0), .O(z5));
  nand2  g23(.a(x1), .b(new_n16_), .O(new_n38_));
  nand3  g24(.a(new_n20_), .b(x3), .c(x2), .O(new_n39_));
  oai21  g25(.a(new_n39_), .b(new_n38_), .c(new_n15_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n23_), .O(z6));
  oai21  g27(.a(new_n39_), .b(new_n31_), .c(new_n15_), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n23_), .O(z7));
endmodule
