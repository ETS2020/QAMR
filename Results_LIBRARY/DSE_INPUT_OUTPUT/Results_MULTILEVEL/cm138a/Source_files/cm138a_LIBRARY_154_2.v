...
module FAU ( 
  ...
  nand3  g15(.a(new_n19_), .b(new_n21_), .c(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x3), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x1), .O(z2));
  nand2  g18(.a(new_n24_), .b(new_n23_), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(x2), .c(x3), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(new_n27_), .c(x0), .O(z3));
  nand2  g21(.a(x2), .b(new_n15_), .O(new_n36_));
  oai21  g22(.a(new_n36_), .b(new_n25_), .c(new_n16_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n28_), .O(z4));
  nand2  g24(.a(x2), .b(x0), .O(new_n39_));
  oai21  g25(.a(new_n39_), .b(new_n25_), .c(new_n16_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n28_), .O(z5));
  oai21  g27(.a(new_n36_), .b(new_n33_), .c(x3), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(x1), .O(z6));
  oai21  g29(.a(new_n33_), .b(new_n21_), .c(x3), .O(new_n44_));
