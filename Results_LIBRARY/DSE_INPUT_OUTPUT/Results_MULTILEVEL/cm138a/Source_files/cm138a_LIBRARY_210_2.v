...
module FAU ( 
  ...
  nand3  g11(.a(new_n25_), .b(x3), .c(x0), .O(z1));
  nand4  g12(.a(new_n20_), .b(new_n19_), .c(new_n18_), .d(x1), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n16_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n23_), .O(z2));
  nand2  g15(.a(new_n27_), .b(x3), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x0), .O(z3));
  nand4  g17(.a(new_n20_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n32_));
