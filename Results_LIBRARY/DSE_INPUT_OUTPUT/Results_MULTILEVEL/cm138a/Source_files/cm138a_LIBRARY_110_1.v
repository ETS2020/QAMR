...
module FAU ( 
  ...
  nand3  g20(.a(new_n20_), .b(new_n19_), .c(x3), .O(new_n35_));
  inv1   g21(.a(new_n35_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(x2), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g23(.a(new_n36_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand3  g24(.a(new_n20_), .b(new_n19_), .c(x2), .O(new_n39_));
  oai21  g25(.a(new_n39_), .b(new_n29_), .c(x3), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n24_), .O(z6));
  oai21  g27(.a(new_n39_), .b(new_n32_), .c(x3), .O(new_n42_));
