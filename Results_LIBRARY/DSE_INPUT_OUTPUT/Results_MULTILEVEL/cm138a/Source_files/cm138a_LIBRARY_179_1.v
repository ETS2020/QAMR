...
module FAU ( 
  ...
  nand4  g19(.a(new_n33_), .b(new_n18_), .c(new_n16_), .d(new_n15_), .O(z4));
  ...
  nand2  g23(.a(x2), .b(new_n15_), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(new_n25_), .c(x1), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n27_), .O(z6));
  nor2   g26(.a(x5), .b(x4), .O(new_n41_));
  and2   g27(.a(x3), .b(x2), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n41_), .c(x1), .d(x0), .O(z7));
endmodule
