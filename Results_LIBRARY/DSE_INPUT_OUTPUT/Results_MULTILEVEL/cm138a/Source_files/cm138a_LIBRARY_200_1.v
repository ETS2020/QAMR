...
module FAU ( 
  ...
  nand2  g14(.a(x1), .b(new_n18_), .O(z2));
  nor2   g15(.a(x5), .b(x4), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(x3), .c(new_n23_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x1), .O(z3));
  nand3  g19(.a(new_n30_), .b(x3), .c(x2), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n19_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n18_), .O(z4));
  nand2  g22(.a(x2), .b(new_n19_), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n26_), .c(x0), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n20_), .O(z5));
  inv1   g25(.a(new_n34_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(x1), .c(x0), .O(z7));
  one    g27(.O(z6));
endmodule
