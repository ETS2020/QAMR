...
module FAU ( 
  ...
  nand3  g15(.a(new_n19_), .b(new_n16_), .c(x3), .O(new_n30_));
  inv1   g16(.a(new_n30_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(x2), .c(new_n17_), .d(new_n15_), .O(z4));
  nand4  g18(.a(new_n31_), .b(x2), .c(new_n17_), .d(x0), .O(z5));
  nand4  g19(.a(new_n19_), .b(x3), .c(x2), .d(x1), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n16_), .c(new_n15_), .O(z6));
  nand2  g22(.a(x4), .b(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n34_), .b(new_n37_), .O(new_n38_));
  xor2a  g24(.a(x4), .b(x0), .O(new_n39_));
