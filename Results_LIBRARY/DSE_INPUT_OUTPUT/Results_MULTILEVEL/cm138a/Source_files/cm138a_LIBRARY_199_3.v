...
module FAU ( 
  ...
  nand3  g19(.a(new_n23_), .b(x3), .c(new_n21_), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n24_), .c(x2), .d(new_n15_), .O(z4));
  nand2  g22(.a(new_n23_), .b(x3), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n22_), .c(new_n24_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x2), .O(z5));
  oai21  g25(.a(new_n37_), .b(new_n29_), .c(new_n24_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(x2), .O(z6));
  nand3  g27(.a(new_n23_), .b(x3), .c(x1), .O(new_n42_));
  inv1   g28(.a(new_n42_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n24_), .c(x2), .d(x0), .O(z7));
endmodule
