...
module FAU ( 
  ...
  nand4  g18(.a(new_n32_), .b(new_n26_), .c(x3), .d(x0), .O(z3));
  nor2   g19(.a(new_n18_), .b(x1), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n26_), .c(x3), .d(new_n15_), .O(z4));
  ...
  oai21  g25(.a(new_n37_), .b(new_n29_), .c(x3), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n24_), .O(z6));
  nand2  g27(.a(x1), .b(x0), .O(new_n42_));
  oai21  g28(.a(new_n42_), .b(new_n37_), .c(x3), .O(new_n43_));
