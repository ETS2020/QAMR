...
module FAU ( 
  ...
  nor2   g20(.a(new_n18_), .b(x1), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n26_), .c(x3), .d(new_n15_), .O(z4));
  nand2  g22(.a(new_n16_), .b(x0), .O(new_n37_));
  nand3  g23(.a(new_n20_), .b(new_n19_), .c(x2), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(new_n37_), .c(x3), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n24_), .O(z5));
  oai21  g26(.a(new_n38_), .b(new_n29_), .c(x3), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n24_), .O(z6));
