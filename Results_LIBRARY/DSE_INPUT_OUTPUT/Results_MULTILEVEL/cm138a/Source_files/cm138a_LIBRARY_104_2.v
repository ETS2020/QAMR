...
module FAU ( 
  ...
  nand2  g13(.a(new_n20_), .b(new_n19_), .O(new_n28_));
  oai21  g14(.a(new_n28_), .b(x2), .c(x3), .O(new_n29_));
  nor2   g15(.a(new_n23_), .b(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n29_), .O(z2));
  oai21  g17(.a(new_n25_), .b(new_n28_), .c(x3), .O(new_n32_));
  ...
  oai21  g25(.a(new_n28_), .b(new_n17_), .c(x3), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n30_), .O(z6));
  oai21  g27(.a(new_n37_), .b(new_n28_), .c(x3), .O(new_n42_));
