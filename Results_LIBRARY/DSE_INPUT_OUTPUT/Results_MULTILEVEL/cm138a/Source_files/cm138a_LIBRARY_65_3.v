...
module FAU ( 
  ...
  oai21  g19(.a(new_n33_), .b(new_n25_), .c(new_n16_), .O(new_n34_));
  ...
  nand3  g24(.a(new_n24_), .b(x3), .c(x2), .O(new_n39_));
  inv1   g25(.a(new_n39_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n23_), .c(x1), .d(new_n15_), .O(z6));
  nand2  g27(.a(new_n24_), .b(x3), .O(new_n42_));
  oai21  g28(.a(new_n42_), .b(new_n36_), .c(new_n23_), .O(new_n43_));
