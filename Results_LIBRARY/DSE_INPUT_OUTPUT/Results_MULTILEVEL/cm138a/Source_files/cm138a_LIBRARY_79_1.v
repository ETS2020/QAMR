...
module FAU ( 
  ...
  nand3  g15(.a(new_n20_), .b(x3), .c(x1), .O(new_n30_));
  inv1   g16(.a(new_n30_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n16_), .c(new_n15_), .d(x0), .O(z3));
  inv1   g18(.a(x3), .O(new_n33_));
  nor2   g19(.a(new_n33_), .b(x1), .O(new_n34_));
  nor2   g20(.a(x5), .b(x4), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n34_), .c(x2), .d(new_n17_), .O(z4));
  nand2  g22(.a(new_n16_), .b(new_n15_), .O(new_n37_));
  nand3  g23(.a(new_n20_), .b(new_n16_), .c(x3), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(new_n24_), .c(x2), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n37_), .O(z5));
  nor2   g26(.a(new_n33_), .b(new_n18_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n35_), .c(x2), .d(new_n17_), .O(z6));
  nand2  g28(.a(x1), .b(x0), .O(new_n43_));
  oai21  g29(.a(new_n43_), .b(new_n38_), .c(x2), .O(new_n44_));
  nand2  g30(.a(new_n44_), .b(new_n37_), .O(z7));
endmodule
