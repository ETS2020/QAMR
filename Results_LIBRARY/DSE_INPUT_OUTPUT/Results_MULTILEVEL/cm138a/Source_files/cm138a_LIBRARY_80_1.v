...
module FAU ( 
  ...
  nor2   g15(.a(x2), .b(new_n16_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n29_), .c(x3), .d(new_n15_), .O(z2));
  ...
  nand4  g21(.a(new_n35_), .b(new_n29_), .c(x3), .d(new_n15_), .O(z4));
  nand3  g22(.a(new_n20_), .b(new_n19_), .c(x2), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n26_), .c(x3), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n24_), .O(z5));
  nand2  g25(.a(x1), .b(new_n15_), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n37_), .c(x3), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n24_), .O(z6));
  nor2   g28(.a(new_n18_), .b(new_n16_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n29_), .c(x3), .d(x0), .O(z7));
endmodule
