...
module FAU ( 
  ...
  nand4  g14(.a(new_n28_), .b(new_n27_), .c(x3), .d(new_n15_), .O(z4));
  nand2  g15(.a(new_n16_), .b(x0), .O(new_n30_));
  nand3  g16(.a(new_n19_), .b(new_n18_), .c(x2), .O(new_n31_));
  oai21  g17(.a(new_n31_), .b(new_n30_), .c(x3), .O(new_n32_));
  inv1   g18(.a(x3), .O(new_n33_));
  nand2  g19(.a(new_n18_), .b(new_n33_), .O(new_n34_));
