...
module FAU ( 
  ...
  nand4  g22(.a(new_n36_), .b(new_n35_), .c(new_n15_), .d(new_n16_), .O(z4));
  nand3  g23(.a(new_n20_), .b(x3), .c(x2), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(new_n25_), .c(new_n15_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n23_), .O(z5));
  oai21  g26(.a(new_n38_), .b(new_n28_), .c(new_n15_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n23_), .O(z6));
  nor2   g28(.a(new_n19_), .b(new_n17_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n35_), .c(new_n15_), .d(x0), .O(z7));
endmodule
