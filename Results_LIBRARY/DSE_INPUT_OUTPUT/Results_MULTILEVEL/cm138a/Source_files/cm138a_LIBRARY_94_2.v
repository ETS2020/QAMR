...
module FAU ( 
  ...
  nand3  g08(.a(new_n19_), .b(new_n18_), .c(x3), .O(new_n24_));
  inv1   g09(.a(new_n24_), .O(new_n25_));
  nor2   g10(.a(new_n15_), .b(x0), .O(new_n26_));
  nand3  g11(.a(new_n26_), .b(new_n25_), .c(new_n17_), .O(z2));
  ...
  nand3  g17(.a(new_n26_), .b(new_n25_), .c(x2), .O(z6));
