...
module FAU ( 
  ...
  nand3  g13(.a(new_n20_), .b(new_n15_), .c(x3), .O(new_n28_));
  ...
  nand2  g24(.a(x1), .b(new_n16_), .O(new_n39_));
  oai21  g25(.a(new_n34_), .b(new_n39_), .c(new_n15_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n23_), .O(z6));
  oai21  g27(.a(new_n34_), .b(new_n31_), .c(new_n15_), .O(new_n42_));
