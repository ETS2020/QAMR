...
module FAU ( 
  ...
  nand4  g08(.a(new_n19_), .b(x3), .c(new_n18_), .d(x1), .O(new_n23_));
  ...
  nand4  g14(.a(new_n28_), .b(new_n27_), .c(new_n19_), .d(x2), .O(z4));
  nor2   g15(.a(x5), .b(new_n26_), .O(new_n30_));
  nor2   g16(.a(new_n18_), .b(new_n17_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n30_), .c(new_n15_), .d(new_n16_), .O(z6));
