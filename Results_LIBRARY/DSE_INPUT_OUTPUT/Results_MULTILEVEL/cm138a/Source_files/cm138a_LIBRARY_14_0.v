...
module FAU ( 
  ...
  nand3  g07(.a(new_n19_), .b(new_n18_), .c(x3), .O(new_n23_));
  inv1   g08(.a(new_n23_), .O(new_n24_));
  nor2   g09(.a(new_n16_), .b(x0), .O(new_n25_));
  nand3  g10(.a(new_n25_), .b(new_n24_), .c(new_n17_), .O(z2));
  nand4  g11(.a(new_n24_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  inv1   g12(.a(x0), .O(new_n28_));
  nand2  g13(.a(new_n16_), .b(new_n28_), .O(z4));
  nor2   g14(.a(x5), .b(x4), .O(new_n30_));
  and2   g15(.a(x3), .b(x2), .O(new_n31_));
  nand4  g16(.a(new_n31_), .b(new_n30_), .c(new_n16_), .d(x0), .O(z5));
  nand3  g17(.a(new_n25_), .b(new_n24_), .c(x2), .O(z6));
  nand4  g18(.a(new_n24_), .b(x2), .c(x1), .d(x0), .O(z7));
  one    g19(.O(z0));
endmodule
