...
module FAU ( 
  ...
  nand3  g11(.a(new_n19_), .b(new_n17_), .c(x3), .O(new_n26_));
  inv1   g12(.a(new_n26_), .O(new_n27_));
  nor2   g13(.a(new_n18_), .b(x0), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n27_), .c(new_n16_), .O(z2));
  nand4  g15(.a(new_n27_), .b(new_n16_), .c(x1), .d(x0), .O(z3));
  nand4  g16(.a(new_n27_), .b(x2), .c(new_n18_), .d(new_n15_), .O(z4));
