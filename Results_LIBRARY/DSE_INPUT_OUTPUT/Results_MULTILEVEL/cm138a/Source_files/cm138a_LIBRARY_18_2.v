...
module FAU ( 
  ...
  nand2  g10(.a(new_n21_), .b(x3), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x0), .O(z1));
  inv1   g12(.a(x0), .O(new_n27_));
  nand4  g13(.a(new_n20_), .b(new_n19_), .c(new_n18_), .d(x1), .O(new_n28_));
  inv1   g14(.a(new_n28_), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(x3), .c(new_n27_), .O(z2));
  nand2  g16(.a(new_n28_), .b(x3), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x0), .O(z3));
  nand4  g18(.a(new_n20_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n33_));
  inv1   g19(.a(new_n33_), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(x3), .c(new_n27_), .O(z4));
  nand2  g21(.a(new_n33_), .b(x3), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x0), .O(z5));
  nand4  g23(.a(new_n20_), .b(new_n19_), .c(x2), .d(x1), .O(new_n38_));
  inv1   g24(.a(new_n38_), .O(new_n39_));
  nand3  g25(.a(new_n39_), .b(x3), .c(new_n27_), .O(z6));
