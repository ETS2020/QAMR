...
module FAU ( 
  ...
  nand2  g13(.a(new_n19_), .b(new_n27_), .O(new_n28_));
  ...
  nand4  g20(.a(new_n34_), .b(new_n33_), .c(x3), .d(new_n15_), .O(z4));
  nand2  g21(.a(new_n16_), .b(x0), .O(new_n36_));
  nand3  g22(.a(new_n19_), .b(new_n18_), .c(x2), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n36_), .c(x3), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n28_), .O(z5));
  oai21  g25(.a(new_n37_), .b(new_n24_), .c(x3), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n28_), .O(z6));
  nor2   g27(.a(new_n17_), .b(new_n16_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n33_), .c(x3), .d(x0), .O(z7));
endmodule
