...
module FAU ( 
  ...
  nand3  g15(.a(new_n15_), .b(x2), .c(new_n24_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n29_), .O(new_n31_));
  nand3  g17(.a(new_n31_), .b(new_n17_), .c(new_n21_), .O(z4));
  nand4  g18(.a(new_n15_), .b(x2), .c(new_n24_), .d(x0), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n29_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x3), .O(z5));
  nand4  g21(.a(new_n25_), .b(new_n17_), .c(new_n15_), .d(x2), .O(z6));
  nand4  g22(.a(new_n27_), .b(new_n17_), .c(new_n15_), .d(x2), .O(z7));
endmodule
