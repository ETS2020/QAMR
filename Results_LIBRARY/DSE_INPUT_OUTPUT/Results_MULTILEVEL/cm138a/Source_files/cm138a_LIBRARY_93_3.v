...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n34_, new_n36_, new_n37_;
  ...
  nand3  g14(.a(new_n28_), .b(x3), .c(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n17_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x1), .O(z2));
  inv1   g17(.a(new_n21_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  nand2  g19(.a(new_n29_), .b(new_n15_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x2), .O(z4));
  nand3  g21(.a(new_n28_), .b(x3), .c(x0), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x2), .O(z5));
  nand2  g24(.a(x2), .b(x1), .O(z6));
  nand2  g25(.a(x2), .b(x1), .O(z7));
endmodule
