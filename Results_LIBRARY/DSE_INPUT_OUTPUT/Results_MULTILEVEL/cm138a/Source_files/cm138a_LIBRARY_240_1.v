...
module FAU ( 
  ...
  nand2  g11(.a(new_n25_), .b(new_n18_), .O(z2));
  ...
  nor2   g16(.a(new_n30_), .b(x1), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n19_), .c(new_n18_), .d(new_n15_), .O(z4));
  nand4  g18(.a(x3), .b(x2), .c(new_n16_), .d(x0), .O(new_n33_));
  ...
  nand4  g23(.a(new_n37_), .b(new_n19_), .c(new_n18_), .d(new_n15_), .O(z6));
  nand2  g24(.a(x1), .b(x0), .O(new_n39_));
  oai21  g25(.a(new_n30_), .b(new_n39_), .c(new_n19_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n18_), .O(z7));
endmodule
