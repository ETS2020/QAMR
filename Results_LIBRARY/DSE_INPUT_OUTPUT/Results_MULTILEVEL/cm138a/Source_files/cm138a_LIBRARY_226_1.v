...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n35_, new_n37_, new_n38_, new_n39_, new_n41_;
  ...
  nand4  g25(.a(new_n39_), .b(new_n38_), .c(new_n16_), .d(x2), .O(z6));
  nor2   g26(.a(new_n17_), .b(new_n15_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n38_), .c(new_n16_), .d(x2), .O(z7));
endmodule
