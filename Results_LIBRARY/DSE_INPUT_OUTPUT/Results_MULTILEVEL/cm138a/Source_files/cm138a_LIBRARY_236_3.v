...
module FAU ( 
  ...
  nand4  g11(.a(new_n18_), .b(x2), .c(new_n16_), .d(new_n15_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n19_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x3), .O(z4));
  nand4  g14(.a(new_n18_), .b(x2), .c(new_n16_), .d(x0), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n19_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x3), .O(z5));
  nand4  g17(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n19_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x3), .O(z6));
  nand3  g20(.a(new_n18_), .b(x2), .c(x1), .O(new_n35_));
  inv1   g21(.a(new_n35_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n19_), .c(x3), .d(x0), .O(z7));
endmodule
