...
module FAU ( 
  ...
  nand4  g16(.a(new_n30_), .b(new_n17_), .c(new_n16_), .d(x0), .O(z3));
  nand3  g17(.a(new_n17_), .b(new_n16_), .c(x3), .O(new_n32_));
  inv1   g18(.a(new_n32_), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(x2), .c(new_n18_), .d(new_n15_), .O(z4));
  nand4  g20(.a(new_n33_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
  nand4  g21(.a(new_n33_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
