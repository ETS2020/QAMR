...
module FAU ( 
  ...
  nand4  g11(.a(new_n25_), .b(new_n24_), .c(new_n15_), .d(new_n21_), .O(z2));
  nand2  g12(.a(x1), .b(x0), .O(new_n27_));
  inv1   g13(.a(x4), .O(new_n28_));
  nand3  g14(.a(new_n16_), .b(new_n28_), .c(x3), .O(new_n29_));
  oai21  g15(.a(new_n29_), .b(new_n27_), .c(new_n15_), .O(new_n30_));
  ...
  nand4  g19(.a(new_n22_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z5));
  nand4  g20(.a(new_n28_), .b(x3), .c(x1), .d(new_n21_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x2), .O(z6));
  nand3  g23(.a(new_n28_), .b(x3), .c(x1), .O(new_n38_));
  inv1   g24(.a(new_n38_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n16_), .c(x2), .d(x0), .O(z7));
endmodule
