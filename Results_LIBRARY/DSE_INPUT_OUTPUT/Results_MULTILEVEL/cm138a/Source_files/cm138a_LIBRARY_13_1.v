...
module FAU ( 
  ...
  oai21  g13(.a(new_n27_), .b(new_n19_), .c(x1), .O(new_n28_));
  ...
  nand4  g20(.a(new_n34_), .b(new_n16_), .c(new_n15_), .d(new_n17_), .O(z4));
  ...
  nand4  g26(.a(new_n40_), .b(new_n39_), .c(x1), .d(new_n17_), .O(z6));
  oai21  g27(.a(new_n36_), .b(new_n27_), .c(x1), .O(new_n42_));
