...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n27_, new_n29_;
  ...
  nand2  g11(.a(x3), .b(x1), .O(z2));
  nor2   g12(.a(new_n17_), .b(x0), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(new_n23_), .c(x3), .d(new_n15_), .O(z4));
  nor2   g14(.a(new_n17_), .b(new_n16_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n23_), .c(x3), .d(new_n15_), .O(z5));
  nand2  g16(.a(x3), .b(x1), .O(z3));
