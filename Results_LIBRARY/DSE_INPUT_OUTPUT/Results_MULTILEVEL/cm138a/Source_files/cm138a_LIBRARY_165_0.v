...
module FAU ( 
  ...
  nand4  g16(.a(new_n30_), .b(new_n15_), .c(x3), .d(x0), .O(z3));
  nand3  g17(.a(new_n15_), .b(new_n19_), .c(x3), .O(new_n32_));
  inv1   g18(.a(new_n32_), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(x2), .c(new_n17_), .d(new_n16_), .O(z4));
  nand4  g20(.a(new_n33_), .b(x2), .c(new_n17_), .d(x0), .O(z5));
  ...
  nand3  g24(.a(new_n19_), .b(x2), .c(x1), .O(new_n39_));
  inv1   g25(.a(new_n39_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n15_), .c(x3), .d(x0), .O(z7));
endmodule
