...
module FAU ( 
  ...
  nand2  g19(.a(new_n33_), .b(new_n17_), .O(z4));
  ...
  nand4  g25(.a(new_n39_), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z6));
  nand2  g26(.a(x1), .b(x0), .O(new_n41_));
  nand2  g27(.a(x3), .b(x2), .O(new_n42_));
  oai21  g28(.a(new_n42_), .b(new_n41_), .c(new_n16_), .O(new_n43_));
  nand2  g29(.a(new_n43_), .b(new_n17_), .O(z7));
endmodule
