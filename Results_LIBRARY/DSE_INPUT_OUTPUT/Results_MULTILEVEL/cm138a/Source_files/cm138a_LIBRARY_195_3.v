...
module FAU ( 
  ...
  oai21  g22(.a(new_n34_), .b(new_n25_), .c(new_n20_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x2), .O(z5));
  oai21  g24(.a(new_n34_), .b(new_n28_), .c(new_n20_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(x2), .O(z6));
  nand2  g26(.a(x1), .b(x0), .O(new_n41_));
  oai21  g27(.a(new_n41_), .b(new_n34_), .c(new_n20_), .O(new_n42_));
