...
module FAU ( 
  ...
  nand3  g10(.a(new_n19_), .b(new_n16_), .c(x3), .O(new_n25_));
  inv1   g11(.a(new_n25_), .O(new_n26_));
  nand4  g12(.a(new_n26_), .b(new_n18_), .c(x1), .d(new_n15_), .O(z2));
  ...
  nand2  g17(.a(x4), .b(new_n15_), .O(new_n32_));
  nand2  g18(.a(new_n29_), .b(new_n32_), .O(new_n33_));
  xor2a  g19(.a(x4), .b(x0), .O(new_n34_));
  ...
  nand3  g25(.a(new_n39_), .b(new_n16_), .c(x0), .O(z7));
endmodule
