...
module FAU ( 
  ...
  nand4  g10(.a(new_n24_), .b(x3), .c(new_n15_), .d(x1), .O(new_n25_));
  inv1   g11(.a(new_n25_), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n16_), .c(new_n21_), .O(z2));
  nand2  g13(.a(x5), .b(new_n21_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n25_), .O(new_n29_));
  xor2a  g15(.a(x5), .b(x0), .O(new_n30_));
  ...
  nand4  g19(.a(new_n24_), .b(x3), .c(x2), .d(x1), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n16_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n21_), .O(z6));
  nand2  g22(.a(new_n34_), .b(new_n28_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n30_), .O(z7));
endmodule
