...
module FAU ( 
  ...
  nand4  g16(.a(new_n31_), .b(new_n25_), .c(x1), .d(x0), .O(z3));
  nand3  g17(.a(new_n25_), .b(x3), .c(x2), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n20_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n19_), .O(z4));
  nand4  g20(.a(new_n18_), .b(x2), .c(new_n20_), .d(x0), .O(z5));
