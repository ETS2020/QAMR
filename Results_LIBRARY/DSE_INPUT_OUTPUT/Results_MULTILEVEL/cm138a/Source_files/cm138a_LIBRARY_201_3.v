...
module FAU ( 
  ...
  nand3  g14(.a(new_n19_), .b(x3), .c(new_n17_), .O(new_n29_));
  inv1   g15(.a(new_n29_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n20_), .c(x1), .d(new_n16_), .O(z2));
  nand2  g17(.a(new_n19_), .b(x3), .O(new_n32_));
  nand2  g18(.a(new_n17_), .b(x0), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(new_n32_), .c(new_n20_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x1), .O(z3));
  nand2  g21(.a(x2), .b(new_n16_), .O(new_n36_));
  oai21  g22(.a(new_n36_), .b(new_n21_), .c(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n23_), .O(z4));
  nor2   g24(.a(new_n26_), .b(new_n17_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n25_), .c(new_n15_), .d(x0), .O(z5));
  oai21  g26(.a(new_n36_), .b(new_n32_), .c(new_n20_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(x1), .O(z6));
  nand2  g28(.a(x2), .b(x0), .O(new_n43_));
  oai21  g29(.a(new_n43_), .b(new_n32_), .c(new_n20_), .O(new_n44_));
