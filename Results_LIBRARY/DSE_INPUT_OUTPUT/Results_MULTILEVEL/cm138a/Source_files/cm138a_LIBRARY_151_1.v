...
module FAU ( 
  ...
  nand2  g25(.a(x1), .b(new_n17_), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n34_), .c(x2), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n33_), .O(z6));
  nor2   g28(.a(x5), .b(x4), .O(new_n43_));
  and2   g29(.a(x3), .b(x1), .O(new_n44_));
  nand4  g30(.a(new_n44_), .b(new_n43_), .c(x2), .d(x0), .O(z7));
endmodule
