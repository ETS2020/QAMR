...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n35_, new_n37_, new_n38_, new_n39_, new_n40_;
  ...
  nand3  g12(.a(new_n26_), .b(x2), .c(new_n15_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x3), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n16_), .O(z4));
  nand2  g15(.a(new_n26_), .b(x2), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x3), .O(new_n31_));
  inv1   g17(.a(x3), .O(new_n32_));
  nor2   g18(.a(new_n32_), .b(x1), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n31_), .c(x0), .O(z5));
  nor2   g20(.a(new_n32_), .b(new_n17_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n26_), .c(x1), .d(new_n15_), .O(z6));
  inv1   g22(.a(new_n33_), .O(new_n37_));
  nand2  g23(.a(x2), .b(x0), .O(new_n38_));
  nand3  g24(.a(new_n19_), .b(new_n18_), .c(x3), .O(new_n39_));
  oai21  g25(.a(new_n39_), .b(new_n38_), .c(x1), .O(new_n40_));
