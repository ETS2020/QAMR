...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n25_, new_n26_, new_n28_, new_n29_, new_n31_;
  ...
  nand4  g10(.a(new_n19_), .b(new_n18_), .c(x3), .d(x0), .O(new_n25_));
  inv1   g11(.a(new_n25_), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n17_), .c(x1), .O(z3));
  nand4  g13(.a(new_n19_), .b(new_n18_), .c(x3), .d(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x2), .O(z4));
  nand2  g16(.a(new_n25_), .b(new_n16_), .O(new_n31_));
