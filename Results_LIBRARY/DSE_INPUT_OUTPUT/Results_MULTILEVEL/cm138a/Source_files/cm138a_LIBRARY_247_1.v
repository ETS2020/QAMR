...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n33_, new_n35_, new_n36_, new_n39_, new_n40_, new_n42_,
    new_n43_;
  ...
  nand3  g20(.a(new_n20_), .b(new_n16_), .c(x3), .O(new_n35_));
  inv1   g21(.a(new_n35_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(x2), .c(new_n15_), .d(new_n17_), .O(z4));
  nand4  g23(.a(new_n36_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand2  g24(.a(x2), .b(new_n17_), .O(new_n39_));
  oai21  g25(.a(new_n39_), .b(new_n31_), .c(x1), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n33_), .O(z6));
  nand2  g27(.a(x2), .b(x0), .O(new_n42_));
  oai21  g28(.a(new_n42_), .b(new_n31_), .c(x1), .O(new_n43_));
