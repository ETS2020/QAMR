...
module FAU ( 
  ...
  nand3  g19(.a(new_n19_), .b(x3), .c(new_n17_), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n20_), .c(x2), .d(new_n16_), .O(z4));
  nand4  g22(.a(new_n19_), .b(x3), .c(new_n17_), .d(x0), .O(new_n37_));
  ...
  nand4  g28(.a(new_n19_), .b(x3), .c(x1), .d(x0), .O(new_n43_));
