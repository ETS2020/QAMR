...
module FAU ( 
  ...
  nand2  g17(.a(new_n31_), .b(new_n18_), .O(z4));
  ...
  nand2  g23(.a(new_n37_), .b(new_n18_), .O(z6));
  nand2  g24(.a(x1), .b(x0), .O(new_n39_));
  nand2  g25(.a(x3), .b(x2), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n39_), .c(new_n19_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n18_), .O(z7));
endmodule
