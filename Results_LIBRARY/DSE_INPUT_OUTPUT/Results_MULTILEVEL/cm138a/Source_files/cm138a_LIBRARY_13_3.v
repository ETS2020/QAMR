...
module FAU ( 
  ...
  oai21  g14(.a(new_n28_), .b(new_n18_), .c(new_n19_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x1), .O(z2));
  oai21  g16(.a(new_n28_), .b(new_n25_), .c(new_n19_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x1), .O(z3));
  nor2   g18(.a(x5), .b(x4), .O(new_n33_));
  and2   g19(.a(x3), .b(x2), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n33_), .c(new_n15_), .d(new_n16_), .O(z4));
  ...
  nand4  g26(.a(new_n40_), .b(new_n19_), .c(x1), .d(new_n16_), .O(z6));
  oai21  g27(.a(new_n36_), .b(new_n28_), .c(new_n19_), .O(new_n42_));
