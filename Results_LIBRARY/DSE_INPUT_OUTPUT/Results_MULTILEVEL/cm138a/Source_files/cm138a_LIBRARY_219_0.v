...
module FAU ( 
  ...
  nand3  g09(.a(new_n23_), .b(x3), .c(x1), .O(new_n24_));
  inv1   g10(.a(new_n24_), .O(new_n25_));
  nand4  g11(.a(new_n25_), .b(new_n15_), .c(x2), .d(new_n20_), .O(z6));
  nand4  g12(.a(new_n23_), .b(x3), .c(x1), .d(x0), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x2), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n15_), .O(z7));
  buf    g15(.a(x0), .O(z0));
  buf    g16(.a(x0), .O(z1));
  buf    g17(.a(x0), .O(z2));
  buf    g18(.a(x0), .O(z3));
