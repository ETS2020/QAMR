...
module FAU ( 
  ...
  nand4  g13(.a(new_n27_), .b(new_n25_), .c(new_n18_), .d(new_n15_), .O(z2));
  nand2  g14(.a(x1), .b(x0), .O(new_n29_));
  nand3  g15(.a(new_n19_), .b(x3), .c(new_n17_), .O(new_n30_));
  oai21  g16(.a(new_n30_), .b(new_n29_), .c(new_n18_), .O(new_n31_));
  nand2  g17(.a(new_n19_), .b(x4), .O(new_n32_));
  ...
  nand2  g24(.a(new_n38_), .b(new_n32_), .O(z6));
  oai21  g25(.a(new_n37_), .b(new_n29_), .c(new_n18_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n32_), .O(z7));
endmodule
