...
module FAU ( 
  ...
  nor2   g24(.a(new_n23_), .b(new_n17_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n27_), .c(new_n15_), .d(x0), .O(z5));
  oai21  g26(.a(new_n36_), .b(new_n30_), .c(x3), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(x1), .O(z6));
  oai21  g28(.a(new_n30_), .b(new_n17_), .c(x3), .O(new_n43_));
  nand3  g29(.a(new_n43_), .b(new_n24_), .c(x0), .O(z7));
endmodule
