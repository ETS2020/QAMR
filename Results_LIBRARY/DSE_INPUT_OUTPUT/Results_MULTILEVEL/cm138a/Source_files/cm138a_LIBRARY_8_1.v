...
module FAU ( 
  ...
  nand3  g13(.a(new_n23_), .b(x3), .c(new_n28_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(x0), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(x1), .O(z3));
  nand3  g16(.a(new_n23_), .b(x3), .c(x2), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n20_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n19_), .O(z4));
  inv1   g19(.a(new_n32_), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n20_), .c(x0), .O(z5));
  nand2  g21(.a(x1), .b(new_n19_), .O(z6));
