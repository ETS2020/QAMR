...
module FAU ( 
  ...
  nand3  g10(.a(new_n19_), .b(new_n18_), .c(new_n17_), .O(new_n25_));
  oai21  g11(.a(new_n25_), .b(new_n24_), .c(x3), .O(new_n26_));
  ...
  nand4  g17(.a(new_n31_), .b(new_n30_), .c(x3), .d(x0), .O(z3));
  nor2   g18(.a(new_n17_), .b(x1), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n30_), .c(x3), .d(new_n15_), .O(z4));
  ...
  nand4  g24(.a(new_n21_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g25(.a(new_n21_), .b(x2), .c(x1), .d(x0), .O(z7));
endmodule
