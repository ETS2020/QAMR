...
module FAU ( 
  ...
  nand4  g06(.a(new_n16_), .b(new_n15_), .c(new_n20_), .d(x0), .O(new_n21_));
  nand2  g07(.a(new_n21_), .b(new_n19_), .O(new_n22_));
  nand2  g08(.a(new_n22_), .b(x3), .O(z1));
  ...
  nand4  g14(.a(new_n16_), .b(new_n15_), .c(x2), .d(x0), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n19_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x3), .O(z5));
  buf    g17(.a(x0), .O(z3));
  nand2  g18(.a(x3), .b(x1), .O(z6));
  buf    g19(.a(x0), .O(z7));
endmodule
