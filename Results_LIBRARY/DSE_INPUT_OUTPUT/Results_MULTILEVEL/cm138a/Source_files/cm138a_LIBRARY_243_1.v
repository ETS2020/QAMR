...
module FAU ( 
  ...
  nand3  g11(.a(x3), .b(new_n19_), .c(x1), .O(new_n26_));
  inv1   g12(.a(new_n26_), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(new_n16_), .c(new_n15_), .d(new_n17_), .O(z2));
  ...
  nand3  g17(.a(new_n16_), .b(new_n15_), .c(x3), .O(new_n32_));
  inv1   g18(.a(new_n32_), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(x2), .c(new_n18_), .d(new_n17_), .O(z4));
  nand4  g20(.a(new_n33_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
  nand4  g21(.a(x3), .b(x2), .c(x1), .d(new_n17_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n16_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n15_), .O(z6));
  nand3  g24(.a(x3), .b(x2), .c(x1), .O(new_n39_));
  inv1   g25(.a(new_n39_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n16_), .c(new_n15_), .d(x0), .O(z7));
endmodule
