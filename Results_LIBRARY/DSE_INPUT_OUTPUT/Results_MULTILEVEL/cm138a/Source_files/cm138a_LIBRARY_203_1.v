...
module FAU ( 
  ...
  nand2  g13(.a(new_n16_), .b(new_n17_), .O(new_n28_));
  oai21  g14(.a(new_n28_), .b(new_n24_), .c(x1), .O(new_n29_));
  ...
  nand2  g23(.a(new_n37_), .b(x2), .O(z7));
  nand2  g24(.a(x2), .b(new_n15_), .O(z5));
endmodule
