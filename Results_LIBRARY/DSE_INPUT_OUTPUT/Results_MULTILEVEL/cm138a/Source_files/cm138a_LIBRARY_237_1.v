...
module FAU ( 
  ...
  nor2   g14(.a(x1), .b(new_n22_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n28_), .c(new_n18_), .d(x2), .O(z5));
  nor2   g16(.a(new_n16_), .b(new_n15_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n24_), .c(x3), .d(x0), .O(z7));
  buf    g18(.a(x0), .O(z0));
  buf    g19(.a(x0), .O(z4));
  nand2  g20(.a(x3), .b(new_n22_), .O(z6));
endmodule
