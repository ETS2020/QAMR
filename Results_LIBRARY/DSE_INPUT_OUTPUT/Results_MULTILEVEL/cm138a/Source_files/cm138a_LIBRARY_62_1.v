...
module FAU ( 
  ...
  nand3  g19(.a(new_n28_), .b(x3), .c(x2), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n15_), .c(new_n31_), .d(new_n21_), .O(z4));
  nand4  g22(.a(new_n28_), .b(x3), .c(x2), .d(x0), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n15_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n31_), .O(z5));
  nand2  g25(.a(x2), .b(new_n21_), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n29_), .c(x1), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n32_), .O(z6));
  nor2   g28(.a(new_n16_), .b(new_n20_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n25_), .c(x1), .d(x0), .O(z7));
endmodule
