...
module FAU ( 
  ...
  nand3  g14(.a(new_n28_), .b(new_n16_), .c(new_n15_), .O(z2));
  nand2  g15(.a(new_n27_), .b(new_n23_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n25_), .O(z3));
  nand4  g17(.a(new_n19_), .b(x3), .c(x2), .d(new_n17_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n16_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n15_), .O(z4));
  nand2  g20(.a(new_n32_), .b(new_n23_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n25_), .O(z5));
  nand3  g22(.a(new_n19_), .b(new_n16_), .c(x3), .O(new_n37_));
  inv1   g23(.a(new_n37_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g25(.a(new_n38_), .b(x2), .c(x1), .d(x0), .O(z7));
endmodule
