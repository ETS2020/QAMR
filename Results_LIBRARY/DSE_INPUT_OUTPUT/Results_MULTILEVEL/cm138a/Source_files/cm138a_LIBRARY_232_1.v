...
module FAU ( 
  ...
  nand2  g12(.a(new_n16_), .b(x3), .O(new_n27_));
  oai21  g13(.a(new_n27_), .b(new_n26_), .c(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n24_), .O(z2));
  nand2  g15(.a(x1), .b(x0), .O(new_n30_));
  oai21  g16(.a(new_n30_), .b(new_n27_), .c(new_n15_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n24_), .O(z3));
  nand3  g18(.a(new_n16_), .b(new_n15_), .c(x3), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(new_n21_), .c(x2), .O(new_n34_));
  nand2  g20(.a(new_n15_), .b(new_n24_), .O(new_n35_));
  ...
  nor2   g26(.a(new_n38_), .b(new_n20_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n37_), .c(x2), .d(new_n19_), .O(z6));
  oai21  g28(.a(new_n33_), .b(new_n30_), .c(x2), .O(new_n43_));
