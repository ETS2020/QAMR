...
module FAU ( 
  ...
  nand3  g14(.a(new_n19_), .b(new_n18_), .c(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x3), .O(new_n30_));
  inv1   g16(.a(x3), .O(new_n31_));
  nor2   g17(.a(x4), .b(new_n31_), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n30_), .c(x0), .O(z3));
  nor2   g19(.a(x1), .b(x0), .O(new_n34_));
  nand4  g20(.a(new_n32_), .b(new_n34_), .c(new_n19_), .d(x2), .O(z4));
  nor2   g21(.a(x1), .b(new_n16_), .O(new_n36_));
  nand4  g22(.a(new_n32_), .b(new_n36_), .c(new_n19_), .d(x2), .O(z5));
