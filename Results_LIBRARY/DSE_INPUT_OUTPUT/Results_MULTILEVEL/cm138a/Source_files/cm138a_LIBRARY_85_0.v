...
module FAU ( 
  ...
  nand4  g16(.a(new_n30_), .b(new_n19_), .c(x3), .d(x0), .O(z5));
  nand3  g17(.a(new_n18_), .b(x2), .c(x1), .O(new_n32_));
  inv1   g18(.a(new_n32_), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n19_), .c(x3), .d(new_n15_), .O(z6));
  nand4  g20(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x3), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n19_), .O(z7));
endmodule
