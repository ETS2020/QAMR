...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n31_, new_n34_, new_n35_, new_n37_, new_n38_;
  ...
  nand3  g17(.a(new_n31_), .b(new_n30_), .c(new_n19_), .O(z2));
  nand4  g18(.a(new_n30_), .b(new_n19_), .c(x1), .d(x0), .O(z3));
  ...
  oai21  g23(.a(new_n37_), .b(new_n34_), .c(new_n15_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n23_), .O(z5));
  nand3  g25(.a(new_n31_), .b(new_n30_), .c(x2), .O(z6));
  nand4  g26(.a(new_n30_), .b(x2), .c(x1), .d(x0), .O(z7));
endmodule
