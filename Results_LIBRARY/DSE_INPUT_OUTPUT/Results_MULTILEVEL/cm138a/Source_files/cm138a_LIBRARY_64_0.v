...
module FAU ( 
  ...
  nand4  g10(.a(new_n18_), .b(new_n17_), .c(x1), .d(new_n15_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x3), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n19_), .O(z2));
  nand4  g13(.a(new_n18_), .b(new_n17_), .c(x1), .d(x0), .O(new_n28_));
  ...
  nand4  g20(.a(new_n34_), .b(new_n19_), .c(x3), .d(new_n15_), .O(z6));
  nand4  g21(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(new_n36_));
