...
module FAU ( 
  ...
  nand4  g21(.a(new_n35_), .b(new_n34_), .c(new_n15_), .d(new_n16_), .O(z4));
  ...
  oai21  g26(.a(new_n40_), .b(new_n31_), .c(new_n19_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(x1), .O(z6));
  nand3  g28(.a(new_n20_), .b(x3), .c(x2), .O(new_n43_));
  inv1   g29(.a(new_n43_), .O(new_n44_));
  nand4  g30(.a(new_n44_), .b(new_n19_), .c(x1), .d(x0), .O(z7));
endmodule
