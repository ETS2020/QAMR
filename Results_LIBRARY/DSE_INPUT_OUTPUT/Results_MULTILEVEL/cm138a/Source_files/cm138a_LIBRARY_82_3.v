...
module FAU ( 
  ...
  oai21  g24(.a(new_n35_), .b(new_n38_), .c(new_n15_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n29_), .O(z5));
  nor2   g26(.a(new_n24_), .b(new_n20_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n32_), .c(new_n15_), .d(new_n19_), .O(z6));
  nand2  g28(.a(x1), .b(x0), .O(new_n43_));
  oai21  g29(.a(new_n43_), .b(new_n35_), .c(new_n15_), .O(new_n44_));
  nand2  g30(.a(new_n44_), .b(new_n29_), .O(z7));
endmodule
