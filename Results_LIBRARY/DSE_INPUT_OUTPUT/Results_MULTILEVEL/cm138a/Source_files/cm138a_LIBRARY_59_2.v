...
module FAU ( 
  ...
  nand3  g09(.a(new_n23_), .b(new_n19_), .c(x3), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n16_), .O(new_n25_));
  nor2   g11(.a(x4), .b(x2), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n25_), .c(x0), .O(z1));
  nand4  g13(.a(new_n19_), .b(x3), .c(x1), .d(new_n17_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n15_), .O(z2));
  nand4  g16(.a(new_n19_), .b(x3), .c(x1), .d(x0), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n16_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n15_), .O(z3));
  nand2  g19(.a(new_n15_), .b(x2), .O(z4));
  nand2  g20(.a(new_n15_), .b(x2), .O(z5));
  buf    g21(.a(x0), .O(z6));
  buf    g22(.a(x0), .O(z7));
endmodule
