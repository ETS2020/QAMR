...
module FAU ( 
  ...
  nand2  g12(.a(new_n17_), .b(new_n16_), .O(new_n27_));
  nand2  g13(.a(new_n18_), .b(new_n15_), .O(new_n28_));
  nand3  g14(.a(new_n17_), .b(new_n19_), .c(x3), .O(new_n29_));
  oai21  g15(.a(new_n29_), .b(new_n28_), .c(x1), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n27_), .O(z2));
  oai21  g17(.a(new_n29_), .b(new_n24_), .c(x1), .O(new_n32_));
  ...
  oai21  g23(.a(new_n37_), .b(new_n23_), .c(new_n17_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n16_), .O(z5));
  nor2   g25(.a(x5), .b(x4), .O(new_n40_));
  and2   g26(.a(x3), .b(x2), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n40_), .c(x1), .d(new_n15_), .O(z6));
  oai21  g28(.a(new_n37_), .b(new_n29_), .c(x1), .O(new_n43_));
