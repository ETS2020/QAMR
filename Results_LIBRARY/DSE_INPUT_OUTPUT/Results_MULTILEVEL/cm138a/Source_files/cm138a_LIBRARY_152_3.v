...
module FAU ( 
  ...
  nor3   g08(.a(x5), .b(x2), .c(x1), .O(new_n23_));
  ...
  nand3  g15(.a(new_n19_), .b(new_n18_), .c(x1), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(new_n31_));
  nand3  g17(.a(new_n31_), .b(new_n29_), .c(x0), .O(z3));
  nand3  g18(.a(new_n19_), .b(x2), .c(new_n17_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n15_), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(new_n29_), .c(new_n16_), .O(z4));
  nand4  g21(.a(new_n19_), .b(x2), .c(new_n17_), .d(x0), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x3), .O(z5));
  nor2   g24(.a(new_n17_), .b(x0), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n29_), .c(new_n19_), .d(x2), .O(z6));
  nor2   g26(.a(new_n17_), .b(new_n16_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n29_), .c(new_n19_), .d(x2), .O(z7));
endmodule
