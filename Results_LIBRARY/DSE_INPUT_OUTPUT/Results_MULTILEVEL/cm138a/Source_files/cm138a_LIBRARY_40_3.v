...
module FAU ( 
  ...
  nand4  g16(.a(new_n30_), .b(new_n29_), .c(new_n15_), .d(new_n16_), .O(z2));
  nand2  g17(.a(x1), .b(x0), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(new_n21_), .c(new_n15_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n23_), .O(z3));
  nor2   g20(.a(new_n19_), .b(x1), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n29_), .c(new_n15_), .d(new_n16_), .O(z4));
  nand3  g22(.a(new_n20_), .b(x3), .c(x2), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n25_), .c(new_n15_), .O(new_n38_));
  ...
  nand2  g27(.a(new_n41_), .b(new_n23_), .O(z6));
  nor2   g28(.a(new_n19_), .b(new_n17_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n29_), .c(new_n15_), .d(x0), .O(z7));
endmodule
