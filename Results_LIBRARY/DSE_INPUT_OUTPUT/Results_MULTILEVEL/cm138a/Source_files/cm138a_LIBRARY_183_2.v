...
module FAU ( 
  ...
  nand3  g12(.a(new_n26_), .b(x3), .c(new_n15_), .O(z2));
  nand2  g13(.a(new_n25_), .b(x3), .O(new_n28_));
  ...
  nand4  g18(.a(new_n31_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand4  g19(.a(new_n19_), .b(new_n18_), .c(x2), .d(x1), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(x3), .c(new_n15_), .O(z6));
  nand2  g22(.a(new_n34_), .b(x3), .O(new_n37_));
