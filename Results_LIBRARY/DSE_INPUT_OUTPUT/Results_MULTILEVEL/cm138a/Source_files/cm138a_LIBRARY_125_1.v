...
module FAU ( 
  ...
  nand4  g24(.a(new_n38_), .b(new_n18_), .c(new_n16_), .d(x0), .O(z5));
  oai21  g25(.a(new_n33_), .b(new_n29_), .c(x1), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n31_), .O(z6));
  nor2   g27(.a(new_n24_), .b(new_n17_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n26_), .c(x1), .d(x0), .O(z7));
endmodule
