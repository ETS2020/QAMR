...
module FAU ( 
  ...
  nor2   g17(.a(new_n17_), .b(new_n24_), .O(new_n32_));
  nor2   g18(.a(x5), .b(x4), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n32_), .c(x2), .d(new_n21_), .O(z6));
  inv1   g20(.a(x4), .O(new_n35_));
  nand3  g21(.a(new_n16_), .b(new_n35_), .c(x3), .O(new_n36_));
  oai21  g22(.a(new_n36_), .b(new_n27_), .c(x2), .O(new_n37_));
