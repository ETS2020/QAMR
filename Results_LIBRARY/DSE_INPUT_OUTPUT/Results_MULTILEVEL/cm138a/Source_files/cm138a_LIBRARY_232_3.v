...
module FAU ( 
  ...
  nand3  g12(.a(new_n16_), .b(new_n15_), .c(x3), .O(new_n27_));
  oai21  g13(.a(new_n27_), .b(new_n26_), .c(new_n24_), .O(new_n28_));
  nand2  g14(.a(new_n15_), .b(x2), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n28_), .O(z2));
  nand2  g16(.a(x1), .b(x0), .O(new_n31_));
  oai21  g17(.a(new_n31_), .b(new_n27_), .c(new_n24_), .O(new_n32_));
  ...
  nand3  g25(.a(new_n16_), .b(x3), .c(x1), .O(new_n40_));
  inv1   g26(.a(new_n40_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n15_), .c(x2), .d(new_n19_), .O(z6));
  oai21  g28(.a(new_n34_), .b(new_n31_), .c(new_n15_), .O(new_n43_));
