...
module FAU ( 
  ...
  nand3  g16(.a(new_n16_), .b(new_n21_), .c(x3), .O(new_n31_));
  inv1   g17(.a(new_n31_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(x2), .c(new_n19_), .d(new_n15_), .O(z4));
  nand4  g19(.a(new_n32_), .b(x2), .c(new_n19_), .d(x0), .O(z5));
  nand4  g20(.a(new_n32_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g21(.a(new_n32_), .b(x2), .c(x1), .d(x0), .O(z7));
endmodule
