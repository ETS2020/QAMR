...
module FAU ( 
  ...
  oai21  g17(.a(new_n31_), .b(new_n17_), .c(new_n15_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n24_), .O(z3));
  nand3  g19(.a(new_n15_), .b(new_n16_), .c(x3), .O(new_n34_));
  oai21  g20(.a(new_n34_), .b(new_n21_), .c(x2), .O(new_n35_));
  nand2  g21(.a(new_n15_), .b(new_n24_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n35_), .O(z4));
  oai21  g23(.a(new_n34_), .b(new_n25_), .c(x2), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n36_), .O(z5));
  oai21  g25(.a(new_n34_), .b(new_n28_), .c(x2), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n36_), .O(z6));
  oai21  g27(.a(new_n34_), .b(new_n31_), .c(x2), .O(new_n42_));
