...
module FAU ( 
  ...
  nand4  g11(.a(new_n25_), .b(new_n18_), .c(x1), .d(new_n16_), .O(z2));
  ...
  nand2  g25(.a(x2), .b(new_n16_), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n31_), .c(x1), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n27_), .O(z6));
  nor2   g28(.a(new_n24_), .b(new_n17_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n18_), .c(x1), .d(x0), .O(z7));
endmodule
