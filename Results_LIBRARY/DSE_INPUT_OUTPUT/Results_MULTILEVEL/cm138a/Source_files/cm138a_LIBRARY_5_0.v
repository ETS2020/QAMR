...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n26_, new_n27_, new_n28_, new_n31_, new_n32_, new_n34_,
    new_n36_;
  ...
  nand4  g14(.a(new_n19_), .b(new_n18_), .c(x3), .d(x2), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(x0), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n16_), .O(z5));
  nand2  g17(.a(new_n31_), .b(x1), .O(new_n34_));
  nand2  g18(.a(new_n34_), .b(new_n23_), .O(z6));
  nand2  g19(.a(new_n31_), .b(new_n26_), .O(new_n36_));
  nand2  g20(.a(new_n36_), .b(new_n28_), .O(z7));
  one    g21(.O(z0));
  one    g22(.O(z4));
endmodule
