...
module FAU ( 
  ...
  nand3  g11(.a(new_n17_), .b(new_n16_), .c(x3), .O(new_n26_));
  inv1   g12(.a(new_n26_), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(new_n19_), .c(x1), .d(new_n15_), .O(z2));
  nand4  g14(.a(new_n27_), .b(new_n19_), .c(x1), .d(x0), .O(z3));
  nand4  g15(.a(new_n27_), .b(x2), .c(new_n18_), .d(new_n15_), .O(z4));
  nand4  g16(.a(new_n27_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
  ...
  nand4  g22(.a(new_n36_), .b(new_n17_), .c(new_n16_), .d(x0), .O(z7));
endmodule
