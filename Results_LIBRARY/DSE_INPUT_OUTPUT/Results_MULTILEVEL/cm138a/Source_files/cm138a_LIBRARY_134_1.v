...
module FAU ( 
  ...
  inv1   g25(.a(new_n21_), .O(new_n40_));
  nor2   g26(.a(new_n15_), .b(x0), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n40_), .c(new_n16_), .d(x2), .O(z6));
  nor2   g28(.a(new_n15_), .b(new_n17_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n40_), .c(new_n16_), .d(x2), .O(z7));
endmodule
