...
module FAU ( 
  ...
  nand2  g11(.a(new_n16_), .b(x3), .O(new_n26_));
  oai21  g12(.a(new_n26_), .b(new_n19_), .c(new_n15_), .O(new_n27_));
  nor3   g13(.a(x4), .b(x2), .c(x0), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n27_), .O(z2));
  oai21  g15(.a(new_n26_), .b(new_n22_), .c(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n21_), .O(z3));
  nand2  g17(.a(new_n21_), .b(x2), .O(z5));
  buf    g18(.a(x0), .O(z4));
  nand2  g19(.a(new_n21_), .b(x2), .O(z6));
  nand2  g20(.a(new_n21_), .b(x2), .O(z7));
endmodule
