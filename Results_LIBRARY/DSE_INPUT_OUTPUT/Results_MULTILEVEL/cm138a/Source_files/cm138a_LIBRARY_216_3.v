...
module FAU ( 
  ...
  nand4  g09(.a(new_n19_), .b(new_n17_), .c(x1), .d(new_n15_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n18_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x3), .O(z2));
  nand4  g12(.a(new_n19_), .b(new_n17_), .c(x1), .d(x0), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n18_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x3), .O(z3));
  nand4  g15(.a(new_n19_), .b(x2), .c(new_n16_), .d(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n18_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x3), .O(z4));
  nand4  g18(.a(new_n19_), .b(x2), .c(new_n16_), .d(x0), .O(new_n33_));
