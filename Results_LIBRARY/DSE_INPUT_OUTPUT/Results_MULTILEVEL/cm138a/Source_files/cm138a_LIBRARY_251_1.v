...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n31_, new_n32_, new_n34_, new_n35_, new_n39_, new_n41_, new_n42_;
  ...
  nand3  g16(.a(new_n24_), .b(new_n21_), .c(x3), .O(new_n31_));
  inv1   g17(.a(new_n31_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n15_), .c(x1), .d(new_n30_), .O(z2));
  nand2  g19(.a(x1), .b(x0), .O(new_n34_));
  nor2   g20(.a(new_n34_), .b(x2), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n32_), .O(z3));
  nand3  g22(.a(new_n32_), .b(new_n16_), .c(x2), .O(z4));
  nand4  g23(.a(new_n32_), .b(x2), .c(new_n26_), .d(x0), .O(z5));
  nor2   g24(.a(new_n15_), .b(new_n26_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n17_), .c(x3), .d(new_n30_), .O(z6));
  nand3  g26(.a(new_n24_), .b(new_n21_), .c(x2), .O(new_n41_));
  oai21  g27(.a(new_n41_), .b(new_n34_), .c(x3), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n22_), .O(z7));
endmodule
