...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    new_n23_, new_n24_, new_n28_, new_n29_;
  ...
  nand4  g08(.a(new_n22_), .b(x3), .c(new_n16_), .d(x1), .O(new_n23_));
  nand2  g09(.a(new_n23_), .b(new_n15_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n21_), .O(z2));
  nand2  g11(.a(new_n21_), .b(x0), .O(z3));
  ...
  nand2  g15(.a(new_n29_), .b(new_n21_), .O(z6));
  buf    g16(.a(x0), .O(z1));
  buf    g17(.a(x0), .O(z5));
  buf    g18(.a(x0), .O(z7));
endmodule
