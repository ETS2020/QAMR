...
module FAU ( 
  ...
  oai21  g16(.a(x02), .b(x00), .c(x08), .O(new_n50_));
  ...
  nand3  g22(.a(x08), .b(new_n55_), .c(x01), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n54_), .O(z09));
  nor2   g24(.a(new_n39_), .b(x08), .O(z10));
