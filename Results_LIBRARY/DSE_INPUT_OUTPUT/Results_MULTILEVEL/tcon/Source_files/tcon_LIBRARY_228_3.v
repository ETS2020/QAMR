...
module FAU ( 
  ...
  nand2  g01(.a(x09), .b(x00), .O(new_n35_));
  ...
  oai21  g14(.a(new_n46_), .b(x08), .c(new_n47_), .O(z08));
  and2   g15(.a(x09), .b(x00), .O(new_n49_));
  ...
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n49_), .O(z14));
