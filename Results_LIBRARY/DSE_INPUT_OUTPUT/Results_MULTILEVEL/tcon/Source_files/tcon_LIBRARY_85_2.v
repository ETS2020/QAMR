...
module FAU ( 
  ...
  nand2  g04(.a(new_n34_), .b(x04), .O(new_n38_));
  ...
  aoi21  g11(.a(new_n34_), .b(x04), .c(new_n44_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  aoi21  g13(.a(new_n34_), .b(x04), .c(new_n46_), .O(z05));
  ...
  nor2   g22(.a(x10), .b(x04), .O(new_n56_));
  ...
  oai21  g31(.a(new_n44_), .b(x08), .c(new_n53_), .O(z12));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand3  g33(.a(x14), .b(new_n34_), .c(new_n53_), .O(new_n67_));
  ...
  nor2   g38(.a(x16), .b(x04), .O(new_n72_));
