...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n38_, new_n40_, new_n42_, new_n43_, new_n44_, new_n47_,
  ...
  nand2  g00(.a(x16), .b(x09), .O(new_n34_));
  ...
  oai21  g11(.a(new_n44_), .b(new_n42_), .c(new_n43_), .O(z06));
  nor2   g12(.a(new_n44_), .b(x09), .O(z07));
  inv1   g13(.a(x08), .O(new_n47_));
  oai21  g14(.a(x16), .b(new_n47_), .c(x09), .O(new_n48_));
  nand2  g15(.a(x08), .b(x00), .O(new_n49_));
  nand2  g16(.a(new_n49_), .b(new_n48_), .O(z08));
  and2   g17(.a(x16), .b(x09), .O(new_n51_));
  ...
  aoi21  g23(.a(new_n56_), .b(new_n55_), .c(new_n51_), .O(z10));
  ...
  oai21  g36(.a(x09), .b(new_n47_), .c(x16), .O(new_n70_));
