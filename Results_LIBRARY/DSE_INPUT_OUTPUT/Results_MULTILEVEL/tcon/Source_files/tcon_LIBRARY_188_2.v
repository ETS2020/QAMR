...
module FAU ( 
  ...
  aoi21  g22(.a(new_n55_), .b(new_n53_), .c(new_n40_), .O(z08));
  ...
  aoi21  g33(.a(x08), .b(new_n39_), .c(x13), .O(new_n67_));
  ...
  oai21  g39(.a(x15), .b(x08), .c(x13), .O(new_n73_));
  nand3  g40(.a(x15), .b(new_n54_), .c(new_n39_), .O(new_n74_));
  oai21  g41(.a(new_n73_), .b(new_n39_), .c(new_n74_), .O(z14));
