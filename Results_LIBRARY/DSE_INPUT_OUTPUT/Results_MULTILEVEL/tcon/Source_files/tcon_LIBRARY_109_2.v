...
module FAU ( 
  ...
  oai21  g22(.a(x10), .b(x08), .c(x12), .O(new_n56_));
  nand3  g23(.a(x10), .b(new_n52_), .c(new_n39_), .O(new_n57_));
  oai21  g24(.a(new_n56_), .b(new_n39_), .c(new_n57_), .O(z09));
  ...
  aoi21  g29(.a(x08), .b(new_n39_), .c(x12), .O(new_n63_));
