...
module FAU ( 
  ...
  aoi21  g05(.a(x08), .b(x01), .c(new_n38_), .O(z02));
  ...
  nand3  g16(.a(x08), .b(new_n49_), .c(x00), .O(new_n50_));
  ...
  oai21  g30(.a(x06), .b(x01), .c(x08), .O(new_n64_));
  nand2  g31(.a(x15), .b(new_n47_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z14));
  oai21  g33(.a(x07), .b(x01), .c(x08), .O(new_n67_));
