...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n37_, new_n39_, new_n42_, new_n45_, new_n48_,
  ...
  nand2  g12(.a(new_n39_), .b(new_n45_), .O(z06));
  and2   g13(.a(new_n39_), .b(x16), .O(z07));
  ...
  nand3  g18(.a(new_n49_), .b(x08), .c(x01), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n37_), .O(z09));
  nand2  g20(.a(x11), .b(new_n36_), .O(new_n54_));
  nand3  g21(.a(new_n49_), .b(x08), .c(x02), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z10));
  nand2  g23(.a(x12), .b(new_n36_), .O(new_n57_));
  nand3  g24(.a(new_n49_), .b(x08), .c(x03), .O(new_n58_));
  ...
  oai21  g29(.a(x10), .b(x05), .c(x08), .O(new_n63_));
  nand2  g30(.a(x14), .b(new_n36_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z13));
  oai21  g32(.a(x10), .b(x06), .c(x08), .O(new_n66_));
  nand2  g33(.a(x15), .b(new_n36_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z14));
  nand2  g35(.a(x16), .b(new_n36_), .O(new_n69_));
  nand3  g36(.a(new_n49_), .b(x08), .c(x07), .O(new_n70_));
