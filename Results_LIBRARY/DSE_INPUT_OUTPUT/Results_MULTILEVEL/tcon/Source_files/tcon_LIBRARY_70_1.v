...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n48_, new_n49_, new_n51_, new_n53_, new_n54_, new_n55_,
  ...
  oai21  g04(.a(new_n35_), .b(x04), .c(new_n37_), .O(z01));
  ...
  nor2   g15(.a(new_n35_), .b(x04), .O(new_n49_));
  nor2   g16(.a(new_n49_), .b(new_n48_), .O(z06));
  inv1   g17(.a(x16), .O(new_n51_));
  nor2   g18(.a(new_n49_), .b(new_n51_), .O(z07));
  inv1   g19(.a(x08), .O(new_n53_));
  oai21  g20(.a(new_n53_), .b(new_n34_), .c(x09), .O(new_n54_));
