...
module FAU ( 
  ...
  nor2   g01(.a(x16), .b(x11), .O(new_n35_));
  ...
  nand2  g15(.a(new_n48_), .b(x11), .O(z07));
  ...
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n44_), .O(z09));
  inv1   g23(.a(x02), .O(new_n57_));
  inv1   g24(.a(x11), .O(new_n58_));
  aoi21  g25(.a(x16), .b(x08), .c(x11), .O(new_n59_));
  oai22  g26(.a(new_n59_), .b(new_n57_), .c(new_n58_), .d(x08), .O(z10));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  nand2  g28(.a(x12), .b(new_n51_), .O(new_n62_));
  aoi21  g29(.a(new_n62_), .b(new_n61_), .c(new_n35_), .O(z11));
