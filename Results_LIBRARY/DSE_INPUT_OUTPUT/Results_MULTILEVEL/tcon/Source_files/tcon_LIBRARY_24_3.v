...
module FAU ( 
  ...
  nand2  g03(.a(x14), .b(x12), .O(new_n37_));
  and2   g04(.a(new_n37_), .b(x11), .O(z02));
  inv1   g05(.a(x12), .O(new_n39_));
  nor2   g06(.a(x14), .b(new_n39_), .O(z03));
  inv1   g07(.a(x13), .O(new_n41_));
  aoi21  g08(.a(x14), .b(x12), .c(new_n41_), .O(z04));
  inv1   g09(.a(x14), .O(new_n43_));
  nor2   g10(.a(new_n43_), .b(x12), .O(z05));
  ...
  and2   g18(.a(x14), .b(x12), .O(new_n52_));
  ...
  nand3  g23(.a(new_n37_), .b(x11), .c(new_n48_), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n56_), .O(z10));
  nand3  g25(.a(new_n34_), .b(x08), .c(x03), .O(new_n59_));
  nand3  g26(.a(new_n43_), .b(x12), .c(new_n48_), .O(new_n60_));
  ...
  nand3  g31(.a(new_n34_), .b(x08), .c(x05), .O(new_n65_));
  nand3  g32(.a(x14), .b(new_n39_), .c(new_n48_), .O(new_n66_));
  ...
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n52_), .O(z15));
endmodule
