...
module FAU ( 
  ...
  nand2  g04(.a(new_n35_), .b(x05), .O(new_n38_));
  ...
  nand3  g36(.a(x14), .b(new_n53_), .c(new_n34_), .O(new_n70_));
  oai21  g37(.a(new_n69_), .b(new_n34_), .c(new_n70_), .O(z13));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(x15), .b(new_n53_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n45_), .O(z14));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand2  g42(.a(x16), .b(new_n53_), .O(new_n76_));
  aoi21  g43(.a(new_n76_), .b(new_n75_), .c(new_n45_), .O(z15));
endmodule
