...
module FAU ( 
  ...
  nand2  g09(.a(new_n42_), .b(new_n35_), .O(z03));
  inv1   g10(.a(x13), .O(new_n44_));
  nand2  g11(.a(new_n42_), .b(x00), .O(new_n45_));
  ...
  oai21  g19(.a(new_n42_), .b(x08), .c(x00), .O(new_n53_));
  ...
  aoi21  g24(.a(new_n57_), .b(new_n55_), .c(new_n36_), .O(z09));
  ...
  aoi21  g30(.a(x08), .b(new_n35_), .c(x12), .O(new_n64_));
  oai21  g31(.a(new_n64_), .b(new_n62_), .c(new_n63_), .O(z11));
