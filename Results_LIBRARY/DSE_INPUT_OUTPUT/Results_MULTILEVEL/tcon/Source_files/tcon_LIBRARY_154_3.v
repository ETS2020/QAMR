...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n43_, new_n45_, new_n46_, new_n48_,
  ...
  oai21  g14(.a(x09), .b(x01), .c(x08), .O(new_n48_));
  ...
  nand2  g27(.a(x14), .b(new_n49_), .O(new_n61_));
  nand3  g28(.a(new_n45_), .b(x08), .c(x05), .O(new_n62_));
