...
module FAU ( 
  ...
  nand3  g22(.a(x08), .b(x04), .c(x01), .O(new_n56_));
  oai21  g23(.a(new_n37_), .b(x08), .c(new_n56_), .O(z09));
  oai21  g24(.a(new_n34_), .b(x02), .c(x08), .O(new_n58_));
  nand2  g25(.a(x11), .b(new_n53_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  oai21  g27(.a(new_n34_), .b(x03), .c(x08), .O(new_n61_));
  nand2  g28(.a(x12), .b(new_n53_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z11));
  nand2  g30(.a(new_n44_), .b(new_n53_), .O(z12));
  oai21  g31(.a(x05), .b(new_n34_), .c(x08), .O(new_n65_));
