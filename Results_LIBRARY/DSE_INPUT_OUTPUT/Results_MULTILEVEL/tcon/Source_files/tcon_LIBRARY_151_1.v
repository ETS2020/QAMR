...
module FAU ( 
  ...
  oai21  g08(.a(new_n37_), .b(x08), .c(new_n41_), .O(z03));
  inv1   g09(.a(x13), .O(new_n43_));
  aoi21  g10(.a(x10), .b(new_n34_), .c(new_n43_), .O(z04));
  inv1   g11(.a(x14), .O(new_n45_));
  aoi21  g12(.a(x10), .b(new_n34_), .c(new_n45_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  aoi21  g14(.a(x10), .b(new_n34_), .c(new_n47_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  aoi21  g16(.a(x10), .b(new_n34_), .c(new_n49_), .O(z07));
  ...
  nand3  g28(.a(x13), .b(new_n37_), .c(new_n34_), .O(new_n62_));
  ...
  nand3  g34(.a(x15), .b(new_n37_), .c(new_n34_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z14));
  nand2  g36(.a(x08), .b(x07), .O(new_n70_));
  nand3  g37(.a(x16), .b(new_n37_), .c(new_n34_), .O(new_n71_));
