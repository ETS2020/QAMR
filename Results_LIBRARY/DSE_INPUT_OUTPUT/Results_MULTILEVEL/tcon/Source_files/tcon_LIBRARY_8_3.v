...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n37_, new_n40_, new_n42_, new_n45_, new_n46_, new_n47_,
  ...
  nand3  g19(.a(new_n49_), .b(x08), .c(x02), .O(new_n53_));
  ...
  oai21  g27(.a(x10), .b(x05), .c(x08), .O(new_n61_));
  ...
  nand3  g34(.a(new_n49_), .b(x08), .c(x07), .O(new_n68_));
