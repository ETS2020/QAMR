...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n36_, new_n39_, new_n40_, new_n42_, new_n45_,
  ...
  oai21  g03(.a(new_n36_), .b(new_n35_), .c(new_n34_), .O(z00));
  nor2   g04(.a(x11), .b(new_n35_), .O(z01));
  inv1   g05(.a(x12), .O(new_n39_));
  nand2  g06(.a(x11), .b(x10), .O(new_n40_));
  nand2  g07(.a(new_n40_), .b(new_n39_), .O(z03));
  inv1   g08(.a(x13), .O(new_n42_));
  nand2  g09(.a(new_n40_), .b(new_n42_), .O(z04));
  and2   g10(.a(new_n40_), .b(x14), .O(z05));
  inv1   g11(.a(x15), .O(new_n45_));
  nand2  g12(.a(new_n40_), .b(new_n45_), .O(z06));
  and2   g13(.a(new_n40_), .b(x16), .O(z07));
  and2   g14(.a(x11), .b(x10), .O(new_n48_));
  ...
  oai21  g19(.a(x11), .b(new_n50_), .c(x10), .O(new_n53_));
  nand2  g20(.a(x08), .b(x01), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n53_), .O(z09));
  oai21  g22(.a(x10), .b(new_n50_), .c(x11), .O(new_n56_));
  ...
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n40_), .O(z11));
  ...
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n48_), .O(z15));
  buf    g40(.a(x11), .O(z02));
endmodule
