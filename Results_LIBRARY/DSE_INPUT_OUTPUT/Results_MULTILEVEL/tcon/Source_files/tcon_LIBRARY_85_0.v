...
module FAU ( 
  ...
  oai21  g26(.a(x11), .b(new_n56_), .c(new_n53_), .O(new_n60_));
  ...
  nand2  g33(.a(new_n66_), .b(new_n38_), .O(z12));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  nand3  g35(.a(x14), .b(new_n53_), .c(x04), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z13));
  oai21  g37(.a(x15), .b(new_n56_), .c(new_n53_), .O(new_n71_));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n71_), .O(z14));
  oai21  g40(.a(x16), .b(new_n56_), .c(new_n53_), .O(new_n74_));
