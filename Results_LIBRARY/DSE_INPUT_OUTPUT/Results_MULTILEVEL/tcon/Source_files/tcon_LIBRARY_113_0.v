...
module FAU ( 
  ...
  nand2  g06(.a(x15), .b(new_n39_), .O(z02));
  ...
  oai21  g24(.a(new_n57_), .b(x11), .c(new_n51_), .O(new_n58_));
  ...
  aoi21  g37(.a(x11), .b(x08), .c(x15), .O(new_n71_));
  oai22  g38(.a(new_n71_), .b(new_n70_), .c(new_n57_), .d(x08), .O(z14));
