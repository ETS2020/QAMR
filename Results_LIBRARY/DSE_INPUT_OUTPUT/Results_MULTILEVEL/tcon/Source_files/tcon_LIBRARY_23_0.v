...
module FAU ( 
  ...
  nand2  g04(.a(x12), .b(new_n37_), .O(z01));
  ...
  aoi21  g23(.a(x12), .b(x08), .c(x10), .O(new_n57_));
  ...
  aoi21  g30(.a(x10), .b(x08), .c(x12), .O(new_n64_));
  ...
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n35_), .O(z12));
