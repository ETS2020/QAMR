...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n41_, new_n42_,
    new_n44_, new_n47_, new_n49_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  oai21  g14(.a(x16), .b(new_n35_), .c(new_n47_), .O(z05));
  inv1   g15(.a(x15), .O(new_n49_));
  nand2  g16(.a(new_n42_), .b(new_n49_), .O(z06));
  nand2  g17(.a(new_n41_), .b(new_n35_), .O(z07));
  ...
  oai21  g31(.a(new_n41_), .b(new_n52_), .c(x13), .O(new_n65_));
  ...
  oai21  g40(.a(x16), .b(x13), .c(new_n52_), .O(new_n74_));
