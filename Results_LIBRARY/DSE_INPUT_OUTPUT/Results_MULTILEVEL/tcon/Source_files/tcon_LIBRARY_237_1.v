...
module FAU ( 
  ...
  oai21  g29(.a(new_n44_), .b(x08), .c(new_n53_), .O(z12));
  nand3  g30(.a(x08), .b(x05), .c(x04), .O(new_n64_));
  oai21  g31(.a(new_n46_), .b(x08), .c(new_n64_), .O(z13));
  oai21  g32(.a(x06), .b(new_n35_), .c(x08), .O(new_n66_));
  nand2  g33(.a(x15), .b(new_n58_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z14));
  nand3  g35(.a(x08), .b(x07), .c(x04), .O(new_n69_));
