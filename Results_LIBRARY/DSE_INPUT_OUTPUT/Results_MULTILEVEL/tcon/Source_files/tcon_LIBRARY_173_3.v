...
module FAU ( 
  ...
  nand2  g01(.a(x16), .b(x03), .O(new_n35_));
  ...
  and2   g12(.a(x16), .b(x03), .O(new_n46_));
  ...
  oai21  g23(.a(x16), .b(x08), .c(x03), .O(new_n57_));
  oai21  g24(.a(new_n39_), .b(x08), .c(new_n57_), .O(z11));
  ...
  nand2  g31(.a(x15), .b(new_n48_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x06), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n35_), .O(z14));
  oai21  g34(.a(new_n48_), .b(x03), .c(x16), .O(new_n68_));
