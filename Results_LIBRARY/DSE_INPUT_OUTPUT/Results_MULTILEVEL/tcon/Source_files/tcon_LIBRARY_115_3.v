...
module FAU ( 
  ...
  oai21  g09(.a(new_n41_), .b(new_n38_), .c(new_n42_), .O(z03));
  ...
  nand2  g17(.a(x09), .b(new_n38_), .O(new_n51_));
  nand3  g18(.a(new_n41_), .b(x08), .c(x00), .O(new_n52_));
  ...
  oai21  g26(.a(x11), .b(x03), .c(x08), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z11));
  nand2  g28(.a(x13), .b(new_n38_), .O(new_n62_));
  nand3  g29(.a(new_n41_), .b(x08), .c(x04), .O(new_n63_));
  ...
  nand2  g34(.a(x15), .b(new_n38_), .O(new_n68_));
  nand3  g35(.a(new_n41_), .b(x08), .c(x06), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z14));
  nand2  g37(.a(x16), .b(new_n38_), .O(new_n71_));
  nand3  g38(.a(new_n41_), .b(x08), .c(x07), .O(new_n72_));
