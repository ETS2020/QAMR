// Benchmark "FAU" written by ABC on Fri Aug 14 01:49:38 2020
...
module FAU ( 
  ...
  nor2   g11(.a(new_n36_), .b(new_n44_), .O(z06));
  inv1   g12(.a(x16), .O(new_n46_));
  nor2   g13(.a(new_n36_), .b(new_n46_), .O(z07));
  inv1   g14(.a(x09), .O(new_n48_));
  nand2  g15(.a(x14), .b(new_n48_), .O(new_n49_));
  inv1   g16(.a(x08), .O(new_n50_));
  oai21  g17(.a(x14), .b(x09), .c(new_n50_), .O(new_n51_));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  nand3  g19(.a(new_n52_), .b(new_n51_), .c(new_n49_), .O(z08));
  nand2  g20(.a(x08), .b(x01), .O(new_n54_));
  nand2  g21(.a(x10), .b(new_n50_), .O(new_n55_));
  aoi21  g22(.a(new_n55_), .b(new_n54_), .c(new_n36_), .O(z09));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  nand2  g24(.a(x11), .b(new_n50_), .O(new_n58_));
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n36_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  nand2  g27(.a(x12), .b(new_n50_), .O(new_n61_));
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n36_), .O(z11));
  nand2  g29(.a(x13), .b(new_n50_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n49_), .O(z12));
  oai21  g32(.a(new_n48_), .b(new_n50_), .c(x14), .O(new_n66_));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n36_), .O(z14));
  nand2  g38(.a(x16), .b(new_n50_), .O(new_n72_));
  nand2  g39(.a(x08), .b(x07), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n49_), .O(z15));
  buf    g41(.a(x09), .O(z00));
  buf    g42(.a(x14), .O(z05));
endmodule
