...
module FAU ( 
  ...
  aoi21  g41(.a(new_n74_), .b(new_n73_), .c(new_n42_), .O(z14));
  nand2  g42(.a(x08), .b(x07), .O(new_n76_));
  nand2  g43(.a(x16), .b(new_n54_), .O(new_n77_));
  aoi21  g44(.a(new_n77_), .b(new_n76_), .c(new_n42_), .O(z15));
endmodule
