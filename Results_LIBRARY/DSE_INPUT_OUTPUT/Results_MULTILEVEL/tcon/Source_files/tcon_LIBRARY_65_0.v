...
module FAU ( 
  ...
  nor2   g01(.a(x12), .b(x10), .O(new_n35_));
  ...
  nand2  g07(.a(new_n40_), .b(x10), .O(z03));
  ...
  oai21  g20(.a(new_n40_), .b(x10), .c(new_n51_), .O(new_n54_));
  ...
  oai21  g27(.a(x12), .b(new_n60_), .c(new_n51_), .O(new_n61_));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n38_), .O(z14));
