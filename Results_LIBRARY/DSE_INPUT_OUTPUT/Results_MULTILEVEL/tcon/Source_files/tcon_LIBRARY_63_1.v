...
module FAU ( 
  ...
  oai21  g06(.a(new_n39_), .b(x09), .c(new_n38_), .O(z02));
  nor2   g07(.a(new_n39_), .b(new_n35_), .O(z03));
  inv1   g08(.a(x13), .O(new_n42_));
  nand2  g09(.a(new_n36_), .b(new_n42_), .O(z04));
  inv1   g10(.a(x14), .O(new_n44_));
  nor2   g11(.a(new_n39_), .b(x09), .O(new_n45_));
