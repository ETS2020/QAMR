...
module FAU ( 
  ...
  oai21  g24(.a(x02), .b(new_n35_), .c(x08), .O(new_n58_));
  ...
  nand2  g32(.a(x14), .b(new_n55_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z13));
  oai21  g34(.a(x06), .b(new_n35_), .c(x08), .O(new_n68_));
  nand2  g35(.a(x15), .b(new_n55_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z14));
  oai21  g37(.a(x07), .b(new_n35_), .c(x08), .O(new_n71_));
  nand2  g38(.a(x16), .b(new_n55_), .O(new_n72_));
