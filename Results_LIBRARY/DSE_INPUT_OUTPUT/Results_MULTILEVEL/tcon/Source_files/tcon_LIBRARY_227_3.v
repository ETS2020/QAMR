...
module FAU ( 
  ...
  nand3  g22(.a(new_n34_), .b(x08), .c(x03), .O(new_n56_));
  nand3  g23(.a(new_n40_), .b(x12), .c(new_n47_), .O(new_n57_));
  ...
  oai21  g28(.a(x12), .b(new_n47_), .c(x14), .O(new_n62_));
