...
module FAU ( 
  ...
  oai21  g19(.a(x15), .b(x02), .c(x08), .O(new_n53_));
  ...
  nand3  g24(.a(new_n57_), .b(x08), .c(x03), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n56_), .O(z11));
  nand2  g26(.a(x13), .b(new_n47_), .O(new_n60_));
  nand3  g27(.a(new_n57_), .b(x08), .c(x04), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z12));
  nand2  g29(.a(x14), .b(new_n47_), .O(new_n63_));
  nand3  g30(.a(new_n57_), .b(x08), .c(x05), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z13));
  nand2  g32(.a(x08), .b(x06), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n57_), .O(z14));
