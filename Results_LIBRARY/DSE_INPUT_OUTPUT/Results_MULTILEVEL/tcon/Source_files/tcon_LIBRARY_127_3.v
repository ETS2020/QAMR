...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n39_, new_n41_, new_n44_, new_n45_, new_n46_,
  ...
  nand3  g19(.a(new_n52_), .b(new_n51_), .c(new_n35_), .O(z10));
  oai21  g20(.a(x15), .b(new_n44_), .c(x12), .O(new_n54_));
  ...
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n35_), .O(z12));
  nand2  g26(.a(x14), .b(new_n44_), .O(new_n60_));
  nand2  g27(.a(x08), .b(x05), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n35_), .O(z13));
  nand3  g29(.a(new_n35_), .b(x08), .c(x06), .O(new_n63_));
  inv1   g30(.a(x12), .O(new_n64_));
  nand3  g31(.a(x15), .b(new_n64_), .c(new_n44_), .O(new_n65_));
