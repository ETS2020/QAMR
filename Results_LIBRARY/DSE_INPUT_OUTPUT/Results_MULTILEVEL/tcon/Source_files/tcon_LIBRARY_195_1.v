...
module FAU ( 
  ...
  nand2  g06(.a(x09), .b(new_n39_), .O(new_n40_));
  ...
  oai21  g19(.a(new_n52_), .b(new_n39_), .c(new_n35_), .O(z08));
  nand2  g20(.a(x10), .b(new_n52_), .O(new_n54_));
  ...
  nand2  g29(.a(x13), .b(new_n52_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n40_), .O(z12));
  nand2  g32(.a(x14), .b(new_n52_), .O(new_n66_));
  nand2  g33(.a(x08), .b(x05), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n40_), .O(z13));
  nand2  g35(.a(x15), .b(new_n52_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n40_), .O(z14));
  nand2  g38(.a(x16), .b(new_n52_), .O(new_n72_));
  nand2  g39(.a(x08), .b(x07), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n40_), .O(z15));
  buf    g41(.a(x09), .O(z00));
endmodule
