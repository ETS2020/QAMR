...
module FAU ( 
  ...
  nand2  g12(.a(new_n45_), .b(x09), .O(new_n46_));
  nand2  g13(.a(new_n46_), .b(new_n44_), .O(z05));
  nand2  g14(.a(new_n45_), .b(new_n35_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  nand2  g16(.a(new_n46_), .b(new_n49_), .O(z07));
  nand3  g17(.a(new_n46_), .b(x08), .c(x00), .O(new_n51_));
  inv1   g18(.a(x08), .O(new_n52_));
  nand3  g19(.a(x15), .b(x09), .c(new_n52_), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n51_), .O(z08));
  nand3  g21(.a(new_n46_), .b(x08), .c(x01), .O(new_n55_));
  nand2  g22(.a(new_n45_), .b(x09), .O(new_n56_));
  ...
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n46_), .O(z15));
  buf    g44(.a(x09), .O(z00));
endmodule
