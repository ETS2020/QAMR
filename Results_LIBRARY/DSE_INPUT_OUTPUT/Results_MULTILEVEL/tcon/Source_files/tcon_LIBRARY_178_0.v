...
module FAU ( 
  ...
  nand2  g01(.a(x12), .b(new_n34_), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nor2   g03(.a(x12), .b(x09), .O(new_n37_));
  ...
  oai21  g18(.a(new_n51_), .b(x09), .c(new_n50_), .O(new_n52_));
  nand2  g19(.a(x08), .b(x00), .O(new_n53_));
  nand3  g20(.a(new_n53_), .b(new_n52_), .c(new_n42_), .O(z08));
  ...
  oai21  g27(.a(x12), .b(new_n34_), .c(new_n50_), .O(new_n61_));
  ...
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n42_), .O(z12));
  nand2  g33(.a(x14), .b(new_n50_), .O(new_n67_));
