...
module FAU ( 
  ...
  nand2  g25(.a(x12), .b(x08), .O(new_n59_));
  oai22  g26(.a(new_n59_), .b(new_n58_), .c(new_n39_), .d(x08), .O(z10));
  oai21  g27(.a(new_n35_), .b(x03), .c(x08), .O(new_n61_));
  nand2  g28(.a(x12), .b(new_n42_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z11));
  inv1   g30(.a(x04), .O(new_n64_));
  oai22  g31(.a(new_n59_), .b(new_n64_), .c(new_n44_), .d(x08), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  oai22  g33(.a(new_n59_), .b(new_n66_), .c(new_n46_), .d(x08), .O(z13));
  inv1   g34(.a(x06), .O(new_n68_));
  oai22  g35(.a(new_n59_), .b(new_n68_), .c(new_n48_), .d(x08), .O(z14));
  oai21  g36(.a(new_n35_), .b(x07), .c(x08), .O(new_n70_));
  nand2  g37(.a(x16), .b(new_n42_), .O(new_n71_));
