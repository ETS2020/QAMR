...
module FAU ( 
  ...
  nand2  g01(.a(x10), .b(new_n34_), .O(z00));
  ...
  nor2   g07(.a(new_n37_), .b(new_n40_), .O(z03));
  ...
  aoi21  g17(.a(x10), .b(x08), .c(x09), .O(new_n51_));
  ...
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n37_), .O(z11));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  nand2  g30(.a(x13), .b(new_n53_), .O(new_n64_));
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n37_), .O(z12));
