...
module FAU ( 
  ...
  nand2  g13(.a(new_n46_), .b(x12), .O(z06));
  ...
  aoi21  g28(.a(x15), .b(x08), .c(x12), .O(new_n62_));
  oai22  g29(.a(new_n62_), .b(new_n60_), .c(new_n61_), .d(x08), .O(z11));
  ...
  oai21  g36(.a(x15), .b(new_n61_), .c(new_n51_), .O(new_n70_));
