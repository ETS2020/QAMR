...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n43_, new_n45_,
    new_n47_, new_n50_, new_n51_, new_n52_, new_n55_, new_n56_, new_n58_,
    new_n60_, new_n62_, new_n64_, new_n66_, new_n67_;
  inv1   g00(.a(x09), .O(new_n34_));
  nand2  g01(.a(x08), .b(x01), .O(new_n35_));
  nand2  g02(.a(new_n35_), .b(new_n34_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  aoi21  g04(.a(x08), .b(x01), .c(new_n37_), .O(z01));
  ...
  aoi21  g10(.a(x08), .b(x01), .c(new_n43_), .O(z04));
  ...
  oai21  g16(.a(x01), .b(x00), .c(x08), .O(new_n50_));
  inv1   g17(.a(x08), .O(new_n51_));
  nand2  g18(.a(x09), .b(new_n51_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n50_), .O(z08));
  oai21  g20(.a(new_n37_), .b(x08), .c(new_n35_), .O(z09));
  oai21  g21(.a(x02), .b(x01), .c(x08), .O(new_n55_));
  nand2  g22(.a(x11), .b(new_n51_), .O(new_n56_));
  ...
  nand2  g33(.a(x16), .b(new_n51_), .O(new_n67_));
