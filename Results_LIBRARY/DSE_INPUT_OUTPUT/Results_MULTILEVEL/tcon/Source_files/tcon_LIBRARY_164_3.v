...
module FAU ( 
  ...
  nand2  g01(.a(x09), .b(x01), .O(new_n35_));
  ...
  oai21  g14(.a(new_n47_), .b(x01), .c(x09), .O(new_n48_));
  nand2  g15(.a(x08), .b(x00), .O(new_n49_));
  nand2  g16(.a(new_n49_), .b(new_n48_), .O(z08));
  oai21  g17(.a(x09), .b(x08), .c(x01), .O(new_n51_));
  oai21  g18(.a(new_n34_), .b(x08), .c(new_n51_), .O(z09));
  and2   g19(.a(x09), .b(x01), .O(new_n53_));
  ...
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n53_), .O(z12));
  ...
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n35_), .O(z15));
  buf    g38(.a(x09), .O(z00));
endmodule
