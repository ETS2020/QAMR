...
module FAU ( 
  ...
  oai21  g27(.a(new_n34_), .b(new_n51_), .c(x12), .O(new_n61_));
  ...
  nor2   g33(.a(new_n35_), .b(x09), .O(new_n67_));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  nand2  g35(.a(x14), .b(new_n51_), .O(new_n69_));
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(z13));
  ...
  aoi21  g42(.a(new_n75_), .b(new_n74_), .c(new_n67_), .O(z15));
endmodule
