...
module FAU ( 
  ...
  oai21  g19(.a(new_n35_), .b(new_n52_), .c(x04), .O(new_n53_));
  ...
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n48_), .O(z10));
  ...
  nand3  g33(.a(x13), .b(new_n52_), .c(new_n47_), .O(new_n67_));
  oai21  g34(.a(new_n66_), .b(new_n47_), .c(new_n67_), .O(z12));
  ...
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n48_), .O(z14));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand2  g42(.a(x16), .b(new_n52_), .O(new_n76_));
  aoi21  g43(.a(new_n76_), .b(new_n75_), .c(new_n48_), .O(z15));
  buf    g44(.a(x09), .O(z00));
endmodule
