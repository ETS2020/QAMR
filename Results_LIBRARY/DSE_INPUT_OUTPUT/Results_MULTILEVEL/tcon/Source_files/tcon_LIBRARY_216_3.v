...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n37_, new_n40_, new_n42_, new_n44_, new_n46_, new_n47_,
    ...
    new_n69_, new_n70_;
  nand2  g00(.a(x15), .b(x14), .O(new_n34_));
  ...
  aoi21  g11(.a(x15), .b(x14), .c(new_n44_), .O(z07));
  ...
  and2   g19(.a(x15), .b(x14), .O(new_n53_));
  nand2  g20(.a(x08), .b(x02), .O(new_n54_));
  nand2  g21(.a(x11), .b(new_n46_), .O(new_n55_));
  ...
  nand3  g30(.a(new_n42_), .b(x14), .c(new_n46_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z13));
  oai21  g32(.a(x14), .b(new_n46_), .c(x15), .O(new_n66_));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n53_), .O(z15));
  buf    g38(.a(x14), .O(z05));
endmodule
