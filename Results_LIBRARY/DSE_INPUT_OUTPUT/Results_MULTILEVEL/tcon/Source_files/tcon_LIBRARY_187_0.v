...
module FAU ( 
  ...
  nand3  g33(.a(x13), .b(new_n53_), .c(x07), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z12));
  oai21  g35(.a(x14), .b(new_n56_), .c(new_n53_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x05), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z13));
  oai21  g38(.a(x15), .b(new_n56_), .c(new_n53_), .O(new_n72_));
  nand2  g39(.a(x08), .b(x06), .O(new_n73_));
  nand2  g40(.a(new_n73_), .b(new_n72_), .O(z14));
  oai21  g41(.a(x16), .b(new_n56_), .c(new_n53_), .O(new_n75_));
