...
module FAU ( 
  ...
  oai21  g09(.a(new_n35_), .b(x07), .c(new_n42_), .O(z02));
  nor2   g10(.a(new_n35_), .b(new_n39_), .O(z03));
  ...
  nand3  g29(.a(new_n40_), .b(x08), .c(x03), .O(new_n63_));
  nand3  g30(.a(x12), .b(new_n54_), .c(x07), .O(new_n64_));
  ...
  oai21  g41(.a(x16), .b(x08), .c(x07), .O(new_n75_));
