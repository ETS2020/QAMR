...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n48_, new_n50_, new_n51_, new_n53_, new_n55_, new_n57_,
  ...
  nand2  g17(.a(x16), .b(x08), .O(new_n51_));
  ...
  oai22  g22(.a(new_n51_), .b(new_n55_), .c(new_n40_), .d(x08), .O(z10));
  inv1   g23(.a(x03), .O(new_n57_));
  oai22  g24(.a(new_n51_), .b(new_n57_), .c(new_n42_), .d(x08), .O(z11));
  oai21  g25(.a(new_n35_), .b(x04), .c(x08), .O(new_n59_));
  inv1   g26(.a(x08), .O(new_n60_));
  nand2  g27(.a(x13), .b(new_n60_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n59_), .O(z12));
  oai21  g29(.a(new_n35_), .b(x05), .c(x08), .O(new_n63_));
  nand2  g30(.a(x14), .b(new_n60_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z13));
  inv1   g32(.a(x06), .O(new_n66_));
  oai22  g33(.a(new_n51_), .b(new_n66_), .c(new_n48_), .d(x08), .O(z14));
  oai21  g34(.a(new_n35_), .b(x07), .c(x08), .O(new_n68_));
  nand2  g35(.a(x16), .b(new_n60_), .O(new_n69_));
