...
module FAU ( 
  ...
  nand3  g27(.a(x11), .b(new_n53_), .c(x05), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z10));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand3  g30(.a(x12), .b(new_n53_), .c(x05), .O(new_n64_));
  ...
  aoi21  g35(.a(new_n46_), .b(new_n53_), .c(new_n56_), .O(z13));
  oai21  g36(.a(x15), .b(new_n56_), .c(new_n53_), .O(new_n70_));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n70_), .O(z14));
  oai21  g39(.a(x16), .b(new_n56_), .c(new_n53_), .O(new_n73_));
