...
module FAU ( 
  ...
  nand2  g06(.a(new_n39_), .b(x06), .O(new_n40_));
  ...
  oai21  g38(.a(x15), .b(x08), .c(x12), .O(new_n72_));
  nand3  g39(.a(x15), .b(new_n53_), .c(new_n35_), .O(new_n73_));
  oai21  g40(.a(new_n72_), .b(new_n35_), .c(new_n73_), .O(z14));
