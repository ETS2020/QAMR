...
module FAU ( 
  ...
  and2   g14(.a(new_n40_), .b(x15), .O(z06));
  and2   g15(.a(new_n40_), .b(x16), .O(z07));
  inv1   g16(.a(x08), .O(new_n50_));
  oai21  g17(.a(new_n50_), .b(x04), .c(x09), .O(new_n51_));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n51_), .O(z08));
  inv1   g20(.a(new_n40_), .O(new_n54_));
  ...
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n54_), .O(z10));
  nand2  g27(.a(x12), .b(new_n50_), .O(new_n61_));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n40_), .O(z11));
  nand2  g30(.a(new_n44_), .b(new_n50_), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n34_), .c(x04), .O(new_n65_));
  nand3  g32(.a(x13), .b(new_n50_), .c(new_n36_), .O(new_n66_));
  ...
  nand2  g38(.a(x15), .b(new_n50_), .O(new_n72_));
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n54_), .O(z14));
  nand2  g40(.a(x08), .b(x07), .O(new_n74_));
  nand2  g41(.a(x16), .b(new_n50_), .O(new_n75_));
  aoi21  g42(.a(new_n75_), .b(new_n74_), .c(new_n54_), .O(z15));
endmodule
