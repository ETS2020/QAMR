...
module FAU ( 
  ...
  nand3  g30(.a(x08), .b(x05), .c(x00), .O(new_n64_));
  oai21  g31(.a(new_n46_), .b(x08), .c(new_n64_), .O(z13));
  nand3  g32(.a(x08), .b(x06), .c(x00), .O(new_n66_));
  oai21  g33(.a(new_n48_), .b(x08), .c(new_n66_), .O(z14));
  oai21  g34(.a(x07), .b(new_n34_), .c(x08), .O(new_n68_));
  nand2  g35(.a(x16), .b(new_n52_), .O(new_n69_));
