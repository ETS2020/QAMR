...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x05), .O(new_n35_));
  ...
  nand2  g15(.a(new_n48_), .b(x05), .O(z06));
  ...
  nand3  g35(.a(x15), .b(x14), .c(new_n52_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z13));
  inv1   g37(.a(x05), .O(new_n71_));
  nand2  g38(.a(x15), .b(x08), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g40(.a(x08), .b(x06), .O(new_n74_));
  nand2  g41(.a(x15), .b(new_n52_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n73_), .O(z14));
  nand2  g43(.a(x08), .b(x07), .O(new_n77_));
  nand2  g44(.a(x16), .b(new_n52_), .O(new_n78_));
  aoi21  g45(.a(new_n78_), .b(new_n77_), .c(new_n35_), .O(z15));
endmodule
