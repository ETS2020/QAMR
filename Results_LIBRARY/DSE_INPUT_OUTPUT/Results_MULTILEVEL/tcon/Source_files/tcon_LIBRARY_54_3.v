...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n40_, new_n41_, new_n44_, new_n47_,
  ...
  nand2  g15(.a(x09), .b(new_n40_), .O(new_n49_));
  inv1   g16(.a(x12), .O(new_n50_));
  nand3  g17(.a(new_n50_), .b(x08), .c(x00), .O(new_n51_));
  nand2  g18(.a(new_n51_), .b(new_n49_), .O(z08));
  nand2  g19(.a(x10), .b(new_n40_), .O(new_n53_));
  nand3  g20(.a(new_n50_), .b(x08), .c(x01), .O(new_n54_));
  ...
  nand3  g25(.a(new_n50_), .b(x08), .c(x03), .O(new_n59_));
  ...
  oai21  g30(.a(x12), .b(x05), .c(x08), .O(new_n64_));
  nand2  g31(.a(x14), .b(new_n40_), .O(new_n65_));
