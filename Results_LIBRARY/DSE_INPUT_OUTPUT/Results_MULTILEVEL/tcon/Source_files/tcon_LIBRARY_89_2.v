...
module FAU ( 
  ...
  oai21  g22(.a(x10), .b(x09), .c(new_n52_), .O(new_n56_));
  ...
  aoi21  g27(.a(new_n60_), .b(new_n59_), .c(new_n39_), .O(z10));
  ...
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n39_), .O(z13));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand2  g38(.a(x15), .b(new_n52_), .O(new_n72_));
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n39_), .O(z14));
  nand2  g40(.a(x08), .b(x07), .O(new_n74_));
  nand2  g41(.a(x16), .b(new_n52_), .O(new_n75_));
  aoi21  g42(.a(new_n75_), .b(new_n74_), .c(new_n39_), .O(z15));
endmodule
