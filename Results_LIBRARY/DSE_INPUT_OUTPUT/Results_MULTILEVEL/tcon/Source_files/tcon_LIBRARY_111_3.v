...
module FAU ( 
  ...
  aoi21  g01(.a(x10), .b(x03), .c(new_n34_), .O(z00));
  ...
  oai21  g19(.a(new_n49_), .b(x03), .c(x10), .O(new_n53_));
  ...
  oai21  g25(.a(x10), .b(x08), .c(x03), .O(new_n59_));
  oai21  g26(.a(new_n41_), .b(x08), .c(new_n59_), .O(z11));
  and2   g27(.a(x10), .b(x03), .O(new_n61_));
  ...
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n61_), .O(z13));
  nand2  g34(.a(x15), .b(new_n49_), .O(new_n68_));
  nand2  g35(.a(x08), .b(x06), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n39_), .O(z14));
