...
module FAU ( 
  ...
  nand2  g22(.a(new_n37_), .b(new_n53_), .O(z09));
  nand3  g23(.a(x08), .b(x02), .c(x01), .O(new_n57_));
  oai21  g24(.a(new_n40_), .b(x08), .c(new_n57_), .O(z10));
  oai21  g25(.a(x03), .b(new_n34_), .c(x08), .O(new_n59_));
  nand2  g26(.a(x12), .b(new_n53_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z11));
  oai21  g28(.a(x04), .b(new_n34_), .c(x08), .O(new_n62_));
  ...
  nand3  g34(.a(x08), .b(x06), .c(x01), .O(new_n68_));
