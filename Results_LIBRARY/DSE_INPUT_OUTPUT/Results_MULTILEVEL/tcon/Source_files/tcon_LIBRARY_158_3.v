...
module FAU ( 
  ...
  oai21  g14(.a(new_n44_), .b(new_n46_), .c(new_n47_), .O(z07));
  oai21  g15(.a(x15), .b(x00), .c(x08), .O(new_n49_));
  nand2  g16(.a(x09), .b(new_n46_), .O(new_n50_));
  nand2  g17(.a(new_n50_), .b(new_n49_), .O(z08));
  oai21  g18(.a(x15), .b(x01), .c(x08), .O(new_n52_));
  nand2  g19(.a(x10), .b(new_n46_), .O(new_n53_));
  ...
  nand2  g34(.a(new_n67_), .b(new_n44_), .O(z14));
