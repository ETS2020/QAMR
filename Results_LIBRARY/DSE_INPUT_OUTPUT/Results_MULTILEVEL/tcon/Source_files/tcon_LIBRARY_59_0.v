...
module FAU ( 
  ...
  nand2  g17(.a(x15), .b(x09), .O(new_n51_));
  ...
  oai21  g27(.a(new_n54_), .b(x12), .c(new_n53_), .O(new_n61_));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z11));
  oai21  g30(.a(new_n54_), .b(x13), .c(new_n53_), .O(new_n64_));
  ...
  oai21  g37(.a(new_n54_), .b(x08), .c(new_n70_), .O(z14));
  oai21  g38(.a(x16), .b(new_n54_), .c(new_n53_), .O(new_n72_));
