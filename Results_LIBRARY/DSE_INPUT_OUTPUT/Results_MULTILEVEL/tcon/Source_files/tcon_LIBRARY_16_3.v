...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n37_, new_n39_, new_n41_, new_n44_, new_n49_,
  ...
  oai21  g22(.a(x03), .b(x00), .c(x08), .O(new_n56_));
  nand2  g23(.a(x12), .b(new_n50_), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n56_), .O(z11));
  oai21  g25(.a(x04), .b(x00), .c(x08), .O(new_n59_));
  nand2  g26(.a(x13), .b(new_n50_), .O(new_n60_));
  ...
  nand2  g35(.a(x16), .b(new_n50_), .O(new_n69_));
