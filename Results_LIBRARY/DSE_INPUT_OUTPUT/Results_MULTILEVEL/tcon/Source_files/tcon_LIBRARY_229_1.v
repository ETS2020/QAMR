...
module FAU ( 
  ...
  oai21  g15(.a(x12), .b(x09), .c(new_n48_), .O(new_n49_));
  ...
  aoi21  g41(.a(new_n74_), .b(new_n73_), .c(new_n53_), .O(z15));
  buf    g42(.a(x09), .O(z00));
  buf    g43(.a(x12), .O(z03));
endmodule
