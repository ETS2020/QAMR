...
module FAU ( 
  ...
  aoi21  g04(.a(x11), .b(new_n34_), .c(new_n37_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  nor2   g06(.a(new_n39_), .b(new_n34_), .O(z02));
  inv1   g07(.a(x12), .O(new_n41_));
  oai21  g08(.a(new_n39_), .b(x08), .c(new_n41_), .O(z03));
  inv1   g09(.a(x13), .O(new_n43_));
  nand2  g10(.a(x11), .b(new_n34_), .O(new_n44_));
  nand2  g11(.a(new_n44_), .b(new_n43_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  aoi21  g13(.a(x11), .b(new_n34_), .c(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n44_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  aoi21  g17(.a(x11), .b(new_n34_), .c(new_n50_), .O(z07));
  nor2   g18(.a(x11), .b(x09), .O(new_n52_));
  nand2  g19(.a(x08), .b(x00), .O(new_n53_));
  oai21  g20(.a(new_n52_), .b(x08), .c(new_n53_), .O(z08));
  nand2  g21(.a(x08), .b(x01), .O(new_n55_));
  nand3  g22(.a(new_n39_), .b(x10), .c(new_n34_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z09));
  and2   g24(.a(x08), .b(x02), .O(z10));
  nor2   g25(.a(x12), .b(x11), .O(new_n59_));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  oai21  g27(.a(new_n59_), .b(x08), .c(new_n60_), .O(z11));
  nand2  g28(.a(x08), .b(x04), .O(new_n62_));
  nand3  g29(.a(x13), .b(new_n39_), .c(new_n34_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  nand3  g32(.a(x14), .b(new_n39_), .c(new_n34_), .O(new_n66_));
  ...
  nand3  g38(.a(x16), .b(new_n39_), .c(new_n34_), .O(new_n72_));
