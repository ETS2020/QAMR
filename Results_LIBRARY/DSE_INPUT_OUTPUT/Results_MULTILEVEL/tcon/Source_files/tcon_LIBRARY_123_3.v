...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n38_, new_n41_, new_n42_, new_n43_, new_n46_,
  ...
  oai21  g10(.a(new_n43_), .b(new_n42_), .c(new_n41_), .O(z04));
  nor2   g11(.a(x16), .b(new_n42_), .O(z05));
  inv1   g12(.a(x15), .O(new_n46_));
  nand2  g13(.a(new_n35_), .b(new_n46_), .O(z06));
  and2   g14(.a(x16), .b(x14), .O(new_n48_));
  ...
  oai21  g31(.a(x16), .b(new_n50_), .c(x14), .O(new_n65_));
  ...
  nand3  g38(.a(x16), .b(new_n42_), .c(new_n50_), .O(new_n72_));
