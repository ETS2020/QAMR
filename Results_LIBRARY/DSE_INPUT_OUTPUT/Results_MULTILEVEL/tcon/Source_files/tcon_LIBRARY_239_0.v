...
module FAU ( 
  ...
  nand2  g15(.a(new_n48_), .b(x08), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nand2  g17(.a(new_n40_), .b(new_n50_), .O(z07));
  inv1   g18(.a(x08), .O(new_n52_));
  oai21  g19(.a(new_n48_), .b(x09), .c(new_n52_), .O(new_n53_));
  ...
  oai21  g38(.a(new_n48_), .b(x08), .c(new_n71_), .O(z14));
  oai21  g39(.a(x16), .b(new_n48_), .c(new_n52_), .O(new_n73_));
