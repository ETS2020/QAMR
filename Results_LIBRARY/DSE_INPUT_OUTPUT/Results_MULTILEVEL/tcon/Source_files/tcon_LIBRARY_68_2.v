...
module FAU ( 
  ...
  nand2  g33(.a(x14), .b(new_n34_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  nand2  g36(.a(x09), .b(x08), .O(new_n70_));
  oai22  g37(.a(new_n70_), .b(new_n69_), .c(new_n48_), .d(x08), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  oai22  g39(.a(new_n70_), .b(new_n72_), .c(new_n50_), .d(x08), .O(z15));
endmodule
