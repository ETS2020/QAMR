...
module FAU ( 
  ...
  oai21  g04(.a(x11), .b(new_n34_), .c(new_n37_), .O(z01));
  ...
  nor2   g11(.a(x11), .b(new_n34_), .O(new_n45_));
  ...
  nor2   g16(.a(new_n45_), .b(new_n49_), .O(z07));
  ...
  aoi21  g23(.a(new_n56_), .b(new_n55_), .c(new_n45_), .O(z09));
  inv1   g24(.a(x02), .O(new_n58_));
  aoi21  g25(.a(new_n34_), .b(x08), .c(x11), .O(new_n59_));
  ...
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n45_), .O(z14));
