...
module FAU ( 
  ...
  nand3  g33(.a(x14), .b(new_n35_), .c(new_n52_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z13));
  nand2  g35(.a(x08), .b(x06), .O(new_n69_));
  nand3  g36(.a(x15), .b(new_n35_), .c(new_n52_), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z14));
  nand2  g38(.a(x08), .b(x07), .O(new_n72_));
  nand3  g39(.a(x16), .b(new_n35_), .c(new_n52_), .O(new_n73_));
