...
module FAU ( 
  ...
  nor2   g10(.a(x16), .b(new_n43_), .O(new_n44_));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n44_), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  aoi21  g39(.a(new_n43_), .b(x08), .c(x16), .O(new_n73_));
