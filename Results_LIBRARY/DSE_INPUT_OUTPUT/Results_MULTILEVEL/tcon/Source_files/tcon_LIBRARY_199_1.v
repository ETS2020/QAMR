...
module FAU ( 
  ...
  nor2   g11(.a(new_n35_), .b(new_n34_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  oai21  g13(.a(new_n35_), .b(x09), .c(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nor2   g15(.a(new_n41_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nor2   g17(.a(new_n41_), .b(new_n50_), .O(z07));
  ...
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n41_), .O(z09));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  nand2  g27(.a(x11), .b(new_n54_), .O(new_n61_));
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n41_), .O(z10));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand2  g30(.a(x12), .b(new_n54_), .O(new_n64_));
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n41_), .O(z11));
  nand3  g32(.a(new_n38_), .b(x08), .c(x04), .O(new_n66_));
  ...
  aoi21  g43(.a(new_n76_), .b(new_n75_), .c(new_n41_), .O(z15));
endmodule
