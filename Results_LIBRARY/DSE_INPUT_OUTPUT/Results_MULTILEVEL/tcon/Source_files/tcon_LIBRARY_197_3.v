...
module FAU ( 
  ...
  nand2  g06(.a(x11), .b(x04), .O(new_n40_));
  ...
  and2   g15(.a(x11), .b(x04), .O(new_n49_));
  ...
  nand3  g25(.a(x11), .b(new_n51_), .c(new_n58_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n57_), .O(z10));
  nand3  g27(.a(new_n35_), .b(x08), .c(x03), .O(new_n61_));
  nand3  g28(.a(new_n40_), .b(x12), .c(new_n51_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z11));
  oai21  g30(.a(x11), .b(x08), .c(x04), .O(new_n64_));
  oai21  g31(.a(new_n42_), .b(x08), .c(new_n64_), .O(z12));
