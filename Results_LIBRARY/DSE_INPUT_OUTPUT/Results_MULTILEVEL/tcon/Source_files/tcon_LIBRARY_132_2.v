...
module FAU ( 
  ...
  nand3  g24(.a(x13), .b(x11), .c(new_n51_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z10));
  nand3  g26(.a(new_n36_), .b(x08), .c(x03), .O(new_n60_));
  nand2  g27(.a(new_n35_), .b(x11), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(x12), .c(new_n51_), .O(new_n62_));
