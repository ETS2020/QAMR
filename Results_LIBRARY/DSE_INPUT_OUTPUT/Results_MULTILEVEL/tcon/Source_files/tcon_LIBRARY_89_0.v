...
module FAU ( 
  ...
  nand2  g01(.a(new_n34_), .b(x09), .O(z01));
  inv1   g02(.a(x11), .O(new_n36_));
  nor2   g03(.a(x10), .b(x09), .O(new_n37_));
  ...
  nor2   g08(.a(new_n37_), .b(new_n41_), .O(z04));
  ...
  inv1   g14(.a(new_n37_), .O(new_n48_));
  nand2  g15(.a(new_n48_), .b(new_n47_), .O(z07));
  inv1   g16(.a(x08), .O(new_n50_));
  oai21  g17(.a(new_n34_), .b(x09), .c(new_n50_), .O(new_n51_));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  nand3  g19(.a(new_n52_), .b(new_n51_), .c(new_n48_), .O(z08));
  inv1   g20(.a(x09), .O(new_n54_));
  oai21  g21(.a(x10), .b(new_n54_), .c(new_n50_), .O(new_n55_));
  nand2  g22(.a(x08), .b(x01), .O(new_n56_));
  nand3  g23(.a(new_n56_), .b(new_n55_), .c(new_n48_), .O(z09));
