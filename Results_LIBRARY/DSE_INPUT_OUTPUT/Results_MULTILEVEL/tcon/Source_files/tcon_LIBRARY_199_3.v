...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n38_, new_n40_, new_n42_, new_n43_, new_n47_,
  ...
  nand2  g01(.a(x13), .b(x09), .O(new_n35_));
  ...
  nor2   g07(.a(new_n40_), .b(x09), .O(z04));
  ...
  nand3  g15(.a(new_n40_), .b(x09), .c(new_n48_), .O(new_n49_));
  nand2  g16(.a(new_n49_), .b(new_n47_), .O(z08));
  nand3  g17(.a(new_n35_), .b(x08), .c(x01), .O(new_n51_));
  nand2  g18(.a(x13), .b(x09), .O(new_n52_));
  nand3  g19(.a(new_n52_), .b(x10), .c(new_n48_), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n51_), .O(z09));
  and2   g21(.a(x13), .b(x09), .O(new_n55_));
  ...
  nand3  g29(.a(x13), .b(new_n42_), .c(new_n48_), .O(new_n63_));
