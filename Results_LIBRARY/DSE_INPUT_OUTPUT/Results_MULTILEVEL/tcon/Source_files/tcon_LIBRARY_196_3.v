...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n42_, new_n46_,
  ...
  aoi21  g09(.a(x11), .b(x08), .c(new_n42_), .O(z03));
  ...
  oai21  g15(.a(x11), .b(x00), .c(x08), .O(new_n49_));
  nand2  g16(.a(x09), .b(new_n39_), .O(new_n50_));
  nand2  g17(.a(new_n50_), .b(new_n49_), .O(z08));
  oai21  g18(.a(x11), .b(x01), .c(x08), .O(new_n52_));
  nand2  g19(.a(x10), .b(new_n39_), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n52_), .O(z09));
  inv1   g21(.a(x11), .O(new_n55_));
  nand3  g22(.a(new_n55_), .b(x08), .c(x02), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n40_), .O(z10));
  nand2  g24(.a(x12), .b(new_n39_), .O(new_n58_));
  nand3  g25(.a(new_n55_), .b(x08), .c(x03), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z11));
  oai21  g27(.a(x11), .b(x04), .c(x08), .O(new_n61_));
  nand2  g28(.a(x13), .b(new_n39_), .O(new_n62_));
