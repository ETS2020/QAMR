...
module FAU ( 
  ...
  nand2  g01(.a(new_n34_), .b(x01), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nor2   g03(.a(x09), .b(x01), .O(new_n37_));
  ...
  aoi21  g27(.a(new_n60_), .b(new_n59_), .c(new_n37_), .O(z10));
  ...
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n37_), .O(z12));
