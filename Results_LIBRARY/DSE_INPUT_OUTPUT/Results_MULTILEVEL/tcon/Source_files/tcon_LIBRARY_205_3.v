...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n40_, new_n44_, new_n46_, new_n47_,
  ...
  nor2   g11(.a(x16), .b(new_n44_), .O(z06));
  ...
  and2   g25(.a(x16), .b(x15), .O(new_n59_));
  nand2  g26(.a(x08), .b(x04), .O(new_n60_));
  nand2  g27(.a(x13), .b(new_n46_), .O(new_n61_));
  ...
  nand3  g32(.a(new_n35_), .b(x08), .c(x06), .O(new_n66_));
  inv1   g33(.a(x16), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(x15), .c(new_n46_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n66_), .O(z14));
  oai21  g36(.a(x15), .b(new_n46_), .c(x16), .O(new_n70_));
