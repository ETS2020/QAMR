...
module FAU ( 
  ...
  nand3  g35(.a(x15), .b(new_n56_), .c(new_n34_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z14));
  nand2  g37(.a(x08), .b(x07), .O(new_n71_));
  nand3  g38(.a(x16), .b(new_n56_), .c(new_n34_), .O(new_n72_));
