...
module FAU ( 
  ...
  nand2  g11(.a(x16), .b(new_n34_), .O(new_n45_));
  ...
  oai21  g16(.a(new_n35_), .b(x09), .c(new_n49_), .O(z06));
  nor2   g17(.a(new_n35_), .b(new_n34_), .O(z07));
  inv1   g18(.a(x08), .O(new_n52_));
  oai21  g19(.a(x16), .b(x09), .c(new_n52_), .O(new_n53_));
  nand2  g20(.a(x08), .b(x00), .O(new_n54_));
  nand3  g21(.a(new_n54_), .b(new_n53_), .c(new_n45_), .O(z08));
  ...
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n38_), .O(z12));
  ...
  oai21  g40(.a(new_n34_), .b(new_n52_), .c(x16), .O(new_n74_));
