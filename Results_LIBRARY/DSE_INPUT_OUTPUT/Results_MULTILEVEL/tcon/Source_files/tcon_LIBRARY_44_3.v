...
module FAU ( 
  ...
  oai21  g20(.a(x06), .b(x01), .c(x08), .O(new_n54_));
  ...
  nand3  g30(.a(x08), .b(new_n51_), .c(x04), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z12));
  nand2  g32(.a(x14), .b(new_n49_), .O(new_n66_));
  nand3  g33(.a(x08), .b(new_n51_), .c(x05), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z13));
  nor2   g35(.a(new_n45_), .b(x08), .O(z14));
  nand2  g36(.a(x08), .b(x07), .O(new_n70_));
  oai22  g37(.a(new_n70_), .b(x06), .c(new_n47_), .d(x08), .O(z15));
endmodule
