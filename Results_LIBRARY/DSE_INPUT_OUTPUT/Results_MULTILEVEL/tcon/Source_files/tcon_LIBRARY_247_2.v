...
module FAU ( 
  ...
  oai21  g34(.a(x14), .b(x08), .c(x16), .O(new_n68_));
  nand3  g35(.a(x14), .b(new_n52_), .c(new_n35_), .O(new_n69_));
  oai21  g36(.a(new_n68_), .b(new_n35_), .c(new_n69_), .O(z13));
  ...
  aoi21  g41(.a(x08), .b(new_n35_), .c(x16), .O(new_n75_));
