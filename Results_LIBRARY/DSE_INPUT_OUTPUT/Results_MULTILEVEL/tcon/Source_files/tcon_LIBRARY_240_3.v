...
module FAU ( 
  ...
  nand2  g07(.a(x15), .b(x11), .O(new_n41_));
  and2   g08(.a(new_n41_), .b(x12), .O(z03));
  and2   g09(.a(new_n35_), .b(x13), .O(z04));
  and2   g10(.a(new_n35_), .b(x14), .O(z05));
  inv1   g11(.a(x15), .O(new_n45_));
  nor2   g12(.a(new_n45_), .b(x11), .O(z06));
  inv1   g13(.a(x16), .O(new_n47_));
  oai21  g14(.a(new_n45_), .b(new_n39_), .c(new_n47_), .O(z07));
  ...
  and2   g19(.a(x15), .b(x11), .O(new_n53_));
  nand2  g20(.a(x08), .b(x01), .O(new_n54_));
  nand2  g21(.a(x10), .b(new_n49_), .O(new_n55_));
  aoi21  g22(.a(new_n55_), .b(new_n54_), .c(new_n53_), .O(z09));
  nand3  g23(.a(new_n35_), .b(x08), .c(x02), .O(new_n57_));
  nand3  g24(.a(new_n45_), .b(x11), .c(new_n49_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z10));
  nand3  g26(.a(new_n35_), .b(x08), .c(x03), .O(new_n60_));
  nand3  g27(.a(new_n41_), .b(x12), .c(new_n49_), .O(new_n61_));
  ...
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n53_), .O(z13));
  oai21  g35(.a(x11), .b(new_n49_), .c(x15), .O(new_n69_));
