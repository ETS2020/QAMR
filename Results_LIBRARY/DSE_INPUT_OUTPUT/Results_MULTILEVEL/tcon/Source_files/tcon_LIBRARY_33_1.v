...
module FAU ( 
  ...
  nand2  g11(.a(x14), .b(new_n40_), .O(new_n45_));
  ...
  nand3  g31(.a(new_n45_), .b(x08), .c(x04), .O(new_n65_));
  nand2  g32(.a(x14), .b(new_n40_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(x13), .c(new_n52_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n65_), .O(z12));
  nand3  g35(.a(new_n45_), .b(x08), .c(x05), .O(new_n69_));
  nand3  g36(.a(x14), .b(x11), .c(new_n52_), .O(new_n70_));
