...
module FAU ( 
  ...
  aoi21  g37(.a(new_n35_), .b(new_n52_), .c(new_n70_), .O(z14));
  nand2  g38(.a(x08), .b(x07), .O(new_n72_));
  nand2  g39(.a(x16), .b(x15), .O(new_n73_));
  oai21  g40(.a(new_n73_), .b(x08), .c(new_n72_), .O(new_n74_));
  nand2  g41(.a(new_n74_), .b(x06), .O(new_n75_));
  oai21  g42(.a(new_n49_), .b(x08), .c(new_n72_), .O(new_n76_));
  nand2  g43(.a(new_n76_), .b(new_n35_), .O(new_n77_));
  nand2  g44(.a(new_n77_), .b(new_n75_), .O(z15));
  buf    g45(.a(x15), .O(z06));
endmodule
