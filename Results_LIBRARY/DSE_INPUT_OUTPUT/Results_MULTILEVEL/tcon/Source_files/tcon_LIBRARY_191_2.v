...
module FAU ( 
  ...
  nand2  g07(.a(new_n36_), .b(new_n40_), .O(z04));
  inv1   g08(.a(x14), .O(new_n42_));
  nand2  g09(.a(new_n36_), .b(new_n42_), .O(z05));
  inv1   g10(.a(x15), .O(new_n44_));
  nand2  g11(.a(new_n36_), .b(new_n44_), .O(z06));
  inv1   g12(.a(x16), .O(new_n46_));
  nand2  g13(.a(new_n36_), .b(new_n46_), .O(z07));
  inv1   g14(.a(x08), .O(new_n48_));
  oai21  g15(.a(new_n35_), .b(new_n48_), .c(x09), .O(new_n49_));
  ...
  nand3  g20(.a(new_n53_), .b(new_n52_), .c(new_n36_), .O(z09));
  ...
  nor2   g31(.a(x12), .b(new_n64_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand2  g33(.a(x14), .b(new_n48_), .O(new_n67_));
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(z13));
  ...
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n65_), .O(z15));
  buf    g41(.a(x09), .O(z00));
  buf    g42(.a(x12), .O(z03));
endmodule
