...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n45_, new_n47_,
  ...
  nand2  g01(.a(x09), .b(x06), .O(new_n35_));
  ...
  oai21  g14(.a(new_n47_), .b(x06), .c(x09), .O(new_n48_));
  ...
  inv1   g20(.a(new_n35_), .O(new_n54_));
  ...
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n54_), .O(z11));
  ...
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n54_), .O(z13));
  nand3  g33(.a(new_n35_), .b(x15), .c(new_n47_), .O(new_n67_));
  ...
  aoi22  g39(.a(new_n72_), .b(new_n71_), .c(x09), .d(x06), .O(z15));
  buf    g40(.a(x09), .O(z00));
endmodule
