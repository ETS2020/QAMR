...
module FAU ( 
  ...
  nand2  g10(.a(new_n43_), .b(x08), .O(z04));
  ...
  oai21  g36(.a(x15), .b(new_n43_), .c(new_n69_), .O(new_n70_));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n70_), .O(z14));
  oai21  g39(.a(x16), .b(new_n43_), .c(new_n69_), .O(new_n73_));
