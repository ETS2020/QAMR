// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:40 2020
...
module FAU ( 
  ...
  oai21  g19(.a(new_n39_), .b(new_n52_), .c(x03), .O(new_n53_));
  nand2  g20(.a(x08), .b(x00), .O(new_n54_));
  nand2  g21(.a(x09), .b(new_n52_), .O(new_n55_));
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n53_), .O(z08));
  ...
  oai21  g29(.a(x12), .b(x08), .c(x09), .O(new_n63_));
  nand3  g30(.a(x12), .b(new_n52_), .c(new_n35_), .O(new_n64_));
  oai21  g31(.a(new_n63_), .b(new_n35_), .c(new_n64_), .O(z11));
  ...
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n40_), .O(z15));
  buf    g44(.a(x09), .O(z00));
endmodule
