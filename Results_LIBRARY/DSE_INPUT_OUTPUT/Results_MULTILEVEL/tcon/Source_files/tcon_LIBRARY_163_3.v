...
module FAU ( 
  ...
  nand2  g03(.a(x12), .b(x07), .O(new_n37_));
  and2   g04(.a(new_n37_), .b(x11), .O(z02));
  inv1   g05(.a(x12), .O(new_n39_));
  nor2   g06(.a(new_n39_), .b(x07), .O(z03));
  ...
  and2   g13(.a(x12), .b(x07), .O(new_n47_));
  ...
  oai21  g38(.a(x12), .b(x08), .c(x07), .O(new_n72_));
  oai21  g39(.a(new_n46_), .b(x08), .c(new_n72_), .O(z15));
endmodule
