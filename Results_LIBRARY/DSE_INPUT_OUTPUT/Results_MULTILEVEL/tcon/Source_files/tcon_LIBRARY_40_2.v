...
module FAU ( 
  ...
  aoi21  g04(.a(new_n34_), .b(x01), .c(new_n37_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  nand2  g06(.a(new_n34_), .b(x01), .O(new_n40_));
  nand2  g07(.a(new_n40_), .b(new_n39_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  aoi21  g09(.a(new_n34_), .b(x01), .c(new_n42_), .O(z03));
  ...
  aoi21  g17(.a(new_n34_), .b(x01), .c(new_n50_), .O(z07));
  ...
  nand3  g41(.a(x16), .b(new_n34_), .c(new_n53_), .O(new_n75_));
