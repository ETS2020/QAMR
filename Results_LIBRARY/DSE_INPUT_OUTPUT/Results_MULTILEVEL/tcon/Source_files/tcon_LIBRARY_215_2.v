...
module FAU ( 
  ...
  nor2   g11(.a(x09), .b(new_n34_), .O(new_n45_));
  ...
  oai21  g24(.a(new_n35_), .b(x08), .c(x01), .O(new_n58_));
  oai21  g25(.a(new_n37_), .b(x08), .c(new_n58_), .O(z09));
  nand2  g26(.a(x11), .b(new_n55_), .O(new_n60_));
  ...
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n45_), .O(z12));
