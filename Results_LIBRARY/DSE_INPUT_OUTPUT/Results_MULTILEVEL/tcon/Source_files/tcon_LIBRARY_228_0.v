...
module FAU ( 
  ...
  oai21  g21(.a(new_n34_), .b(new_n54_), .c(new_n53_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n52_), .O(z08));
  nand2  g23(.a(x08), .b(x01), .O(new_n57_));
  nand2  g24(.a(x10), .b(new_n54_), .O(new_n58_));
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n37_), .O(z09));
  ...
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n37_), .O(z14));
