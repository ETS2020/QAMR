...
module FAU ( 
  ...
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n44_), .O(z15));
  buf    g41(.a(x10), .O(z01));
  buf    g42(.a(x11), .O(z02));
endmodule
