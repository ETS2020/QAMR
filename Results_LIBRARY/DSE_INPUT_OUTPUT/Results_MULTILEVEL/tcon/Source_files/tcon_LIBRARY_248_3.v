...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n39_, new_n42_, new_n44_, new_n48_,
  ...
  and2   g12(.a(new_n42_), .b(x15), .O(z06));
  and2   g13(.a(new_n42_), .b(x16), .O(z07));
  ...
  nand3  g20(.a(new_n53_), .b(new_n52_), .c(new_n42_), .O(z09));
  nand2  g21(.a(x11), .b(new_n48_), .O(new_n55_));
  nand2  g22(.a(x08), .b(x02), .O(new_n56_));
  nand3  g23(.a(new_n56_), .b(new_n55_), .c(new_n42_), .O(z10));
  nand3  g24(.a(new_n42_), .b(x08), .c(x03), .O(new_n58_));
  nand3  g25(.a(x12), .b(new_n34_), .c(new_n48_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z11));
  nand2  g27(.a(x13), .b(new_n48_), .O(new_n61_));
  nand2  g28(.a(x08), .b(x04), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n42_), .O(z12));
  ...
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n42_), .O(z14));
