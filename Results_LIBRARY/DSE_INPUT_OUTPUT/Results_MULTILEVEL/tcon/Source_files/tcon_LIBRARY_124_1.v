...
module FAU ( 
  ...
  nand3  g36(.a(new_n40_), .b(x08), .c(x06), .O(new_n70_));
  nand2  g37(.a(x16), .b(new_n39_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(x15), .c(new_n51_), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n70_), .O(z14));
  nand3  g40(.a(new_n40_), .b(x08), .c(x07), .O(new_n74_));
  nand3  g41(.a(x16), .b(x14), .c(new_n51_), .O(new_n75_));
