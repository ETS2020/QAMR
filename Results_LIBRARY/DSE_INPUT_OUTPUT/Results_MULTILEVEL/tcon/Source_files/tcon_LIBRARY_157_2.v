...
module FAU ( 
  ...
  aoi21  g07(.a(new_n34_), .b(x01), .c(new_n40_), .O(z02));
  ...
  oai21  g22(.a(new_n37_), .b(x08), .c(new_n53_), .O(z09));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  nand3  g24(.a(x11), .b(new_n34_), .c(new_n53_), .O(new_n58_));
  ...
  nor2   g35(.a(x15), .b(x01), .O(new_n69_));
