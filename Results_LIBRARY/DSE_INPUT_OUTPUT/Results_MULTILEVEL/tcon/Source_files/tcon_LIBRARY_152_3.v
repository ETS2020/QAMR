...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n36_, new_n39_, new_n41_, new_n44_, new_n46_,
  ...
  nor2   g04(.a(x16), .b(new_n35_), .O(z01));
  ...
  oai21  g13(.a(new_n36_), .b(new_n35_), .c(new_n46_), .O(z06));
  nor2   g14(.a(new_n36_), .b(x10), .O(z07));
  ...
  oai21  g19(.a(x16), .b(new_n49_), .c(x10), .O(new_n53_));
  nand2  g20(.a(x08), .b(x01), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n53_), .O(z09));
  and2   g22(.a(x16), .b(x10), .O(new_n56_));
  ...
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n39_), .O(z13));
  nand2  g35(.a(x15), .b(new_n49_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n39_), .O(z14));
  oai21  g38(.a(x10), .b(new_n49_), .c(x16), .O(new_n72_));
