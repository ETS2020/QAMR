...
module FAU ( 
  ...
  aoi21  g17(.a(new_n50_), .b(new_n48_), .c(new_n36_), .O(z08));
  inv1   g18(.a(x14), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(x11), .O(new_n53_));
  nand2  g20(.a(x10), .b(new_n49_), .O(new_n54_));
  nand2  g21(.a(x08), .b(x01), .O(new_n55_));
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n53_), .O(z09));
  oai21  g23(.a(new_n52_), .b(new_n49_), .c(x11), .O(new_n57_));
  ...
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n53_), .O(z11));
  nand2  g29(.a(x13), .b(new_n49_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n53_), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  aoi21  g33(.a(new_n35_), .b(x08), .c(x14), .O(new_n67_));
  ...
  aoi21  g38(.a(new_n71_), .b(new_n70_), .c(new_n36_), .O(z14));
  nand2  g39(.a(x16), .b(new_n49_), .O(new_n73_));
  nand2  g40(.a(x08), .b(x07), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n53_), .O(z15));
  buf    g42(.a(x11), .O(z02));
  buf    g43(.a(x14), .O(z05));
endmodule
