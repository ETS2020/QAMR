...
module FAU ( 
  ...
  nand2  g10(.a(new_n43_), .b(x09), .O(z04));
  ...
  inv1   g16(.a(new_n37_), .O(new_n50_));
  nand2  g17(.a(new_n50_), .b(new_n49_), .O(z07));
  inv1   g18(.a(x00), .O(new_n52_));
  aoi21  g19(.a(x13), .b(x08), .c(x09), .O(new_n53_));
  ...
  aoi21  g24(.a(new_n57_), .b(new_n55_), .c(new_n37_), .O(z09));
  nand2  g25(.a(x11), .b(new_n56_), .O(new_n59_));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n50_), .O(z10));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand2  g29(.a(x12), .b(new_n56_), .O(new_n63_));
  aoi21  g30(.a(new_n63_), .b(new_n62_), .c(new_n37_), .O(z11));
  oai21  g31(.a(x13), .b(new_n34_), .c(new_n56_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n50_), .O(z12));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  nand2  g35(.a(x14), .b(new_n56_), .O(new_n69_));
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n37_), .O(z13));
  nand2  g37(.a(x15), .b(new_n56_), .O(new_n71_));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n50_), .O(z14));
  nand2  g40(.a(x16), .b(new_n56_), .O(new_n74_));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n50_), .O(z15));
endmodule
