...
module FAU ( 
  ...
  nand3  g20(.a(new_n53_), .b(new_n52_), .c(new_n46_), .O(z09));
  nand2  g21(.a(x11), .b(new_n49_), .O(new_n55_));
  nand2  g22(.a(x08), .b(x02), .O(new_n56_));
  nand3  g23(.a(new_n56_), .b(new_n55_), .c(new_n46_), .O(z10));
  nand2  g24(.a(x12), .b(new_n49_), .O(new_n58_));
  nand2  g25(.a(x08), .b(x03), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n46_), .O(z11));
  ...
  aoi21  g38(.a(x13), .b(x08), .c(x16), .O(new_n72_));
