...
module FAU ( 
  ...
  aoi21  g24(.a(new_n57_), .b(new_n56_), .c(new_n43_), .O(z09));
  nand2  g25(.a(x08), .b(x02), .O(new_n59_));
  nand2  g26(.a(x11), .b(new_n52_), .O(new_n60_));
  aoi21  g27(.a(new_n60_), .b(new_n59_), .c(new_n43_), .O(z10));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand2  g29(.a(x12), .b(new_n52_), .O(new_n63_));
  aoi21  g30(.a(new_n63_), .b(new_n62_), .c(new_n43_), .O(z11));
  ...
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n43_), .O(z14));
