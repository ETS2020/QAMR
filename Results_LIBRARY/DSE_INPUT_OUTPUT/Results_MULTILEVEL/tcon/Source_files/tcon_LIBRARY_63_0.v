...
module FAU ( 
  ...
  nor2   g09(.a(new_n35_), .b(new_n42_), .O(z05));
  ...
  aoi21  g15(.a(x12), .b(x08), .c(x09), .O(new_n49_));
  ...
  aoi21  g21(.a(new_n54_), .b(new_n53_), .c(new_n35_), .O(z09));
  nand2  g22(.a(x11), .b(new_n50_), .O(new_n56_));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n36_), .O(z10));
  ...
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n36_), .O(z13));
  ...
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n36_), .O(z15));
  buf    g40(.a(x09), .O(z00));
  buf    g41(.a(x12), .O(z03));
endmodule
