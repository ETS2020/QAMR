...
module FAU ( 
  ...
  nand3  g18(.a(x13), .b(x09), .c(new_n51_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n50_), .O(z08));
  nand3  g20(.a(new_n36_), .b(x08), .c(x01), .O(new_n54_));
  nand2  g21(.a(new_n35_), .b(x09), .O(new_n55_));
  nand3  g22(.a(new_n55_), .b(x10), .c(new_n51_), .O(new_n56_));
  ...
  aoi21  g31(.a(new_n39_), .b(x08), .c(x13), .O(new_n65_));
