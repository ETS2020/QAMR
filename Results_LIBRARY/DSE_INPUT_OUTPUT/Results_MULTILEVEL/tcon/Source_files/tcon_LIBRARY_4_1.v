...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n41_, new_n44_,
  ...
  oai21  g08(.a(new_n41_), .b(x08), .c(new_n40_), .O(z02));
  nor2   g09(.a(new_n41_), .b(new_n35_), .O(z03));
  ...
  nand3  g22(.a(new_n41_), .b(x10), .c(new_n35_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z09));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  nand3  g25(.a(new_n41_), .b(x11), .c(new_n35_), .O(new_n59_));
