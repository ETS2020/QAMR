...
module FAU ( 
  ...
  nand2  g06(.a(x16), .b(x10), .O(new_n40_));
  nand2  g07(.a(new_n40_), .b(new_n39_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  nand2  g09(.a(new_n40_), .b(new_n42_), .O(z03));
  and2   g10(.a(new_n40_), .b(x13), .O(z04));
  inv1   g11(.a(x14), .O(new_n45_));
  nand2  g12(.a(new_n40_), .b(new_n45_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  oai21  g14(.a(new_n36_), .b(new_n35_), .c(new_n47_), .O(z06));
  nor2   g15(.a(new_n36_), .b(x10), .O(z07));
  and2   g16(.a(x16), .b(x10), .O(new_n50_));
  ...
  oai21  g21(.a(x16), .b(new_n52_), .c(x10), .O(new_n55_));
  ...
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n50_), .O(z12));
  ...
  oai21  g39(.a(x10), .b(new_n52_), .c(x16), .O(new_n73_));
