// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:14 2020
...
module FAU ( 
  ...
  nand2  g01(.a(x12), .b(x09), .O(new_n35_));
  nand2  g02(.a(new_n35_), .b(new_n34_), .O(z01));
  inv1   g03(.a(x11), .O(new_n37_));
  aoi21  g04(.a(x12), .b(x09), .c(new_n37_), .O(z02));
  inv1   g05(.a(x12), .O(new_n39_));
  nor2   g06(.a(new_n39_), .b(x09), .O(z03));
  ...
  oai21  g15(.a(x12), .b(new_n48_), .c(x09), .O(new_n49_));
  nand2  g16(.a(x08), .b(x00), .O(new_n50_));
  nand2  g17(.a(new_n50_), .b(new_n49_), .O(z08));
  and2   g18(.a(x12), .b(x09), .O(new_n52_));
  ...
  nand3  g25(.a(new_n35_), .b(x08), .c(x03), .O(new_n59_));
  inv1   g26(.a(x09), .O(new_n60_));
  nand3  g27(.a(x12), .b(new_n60_), .c(new_n48_), .O(new_n61_));
  ...
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n35_), .O(z14));
