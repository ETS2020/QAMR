...
module FAU ( 
  ...
  nand3  g37(.a(new_n42_), .b(x08), .c(x06), .O(new_n71_));
  nand2  g38(.a(x16), .b(new_n41_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(x15), .c(new_n52_), .O(new_n73_));
  nand2  g40(.a(new_n73_), .b(new_n71_), .O(z14));
  nand3  g41(.a(new_n42_), .b(x08), .c(x07), .O(new_n75_));
  nand3  g42(.a(x16), .b(x14), .c(new_n52_), .O(new_n76_));
