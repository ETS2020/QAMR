...
module FAU ( 
  ...
  nand3  g29(.a(new_n46_), .b(x08), .c(x04), .O(new_n63_));
  nand3  g30(.a(x15), .b(x13), .c(new_n51_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z12));
  nand3  g32(.a(new_n46_), .b(x08), .c(x05), .O(new_n66_));
  nand2  g33(.a(new_n45_), .b(x13), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(x14), .c(new_n51_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n66_), .O(z13));
  oai21  g36(.a(x15), .b(x13), .c(new_n51_), .O(new_n70_));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n46_), .O(z14));
