...
module FAU ( 
  ...
  nor2   g06(.a(new_n38_), .b(new_n35_), .O(z02));
  inv1   g07(.a(x12), .O(new_n41_));
  oai21  g08(.a(new_n38_), .b(x10), .c(new_n41_), .O(z03));
  ...
  nor2   g14(.a(new_n38_), .b(x10), .O(new_n48_));
  ...
  oai21  g25(.a(new_n35_), .b(new_n52_), .c(x11), .O(new_n59_));
  ...
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n48_), .O(z14));
