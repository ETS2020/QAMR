...
module FAU ( 
  ...
  nor2   g01(.a(x16), .b(x09), .O(new_n35_));
  ...
  nand2  g13(.a(new_n44_), .b(new_n46_), .O(z06));
  inv1   g14(.a(x00), .O(new_n48_));
  aoi21  g15(.a(x16), .b(x08), .c(x09), .O(new_n49_));
  ...
  aoi21  g24(.a(new_n57_), .b(new_n56_), .c(new_n35_), .O(z10));
  nand2  g25(.a(x12), .b(new_n50_), .O(new_n59_));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n44_), .O(z11));
  ...
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n44_), .O(z14));
  nand2  g37(.a(x16), .b(new_n50_), .O(new_n71_));
  nand2  g38(.a(x08), .b(x07), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n44_), .O(z15));
  buf    g40(.a(x09), .O(z00));
  buf    g41(.a(x16), .O(z07));
endmodule
