...
module FAU ( 
  ...
  nand2  g00(.a(x09), .b(x02), .O(new_n34_));
  ...
  nand2  g25(.a(x12), .b(new_n46_), .O(new_n59_));
  aoi22  g26(.a(new_n59_), .b(new_n58_), .c(x09), .d(x02), .O(z11));
  ...
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n50_), .O(z14));
