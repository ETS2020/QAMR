// Benchmark "FAU" written by ABC on Fri Aug 14 01:51:10 2020
...
module FAU ( 
  ...
  nand2  g06(.a(x10), .b(new_n37_), .O(new_n40_));
  ...
  aoi21  g15(.a(x10), .b(new_n37_), .c(new_n48_), .O(z06));
