...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n38_, new_n39_, new_n40_, new_n43_, new_n45_,
  ...
  aoi21  g15(.a(x15), .b(x12), .c(new_n48_), .O(z07));
  ...
  and2   g20(.a(x15), .b(x12), .O(new_n54_));
  ...
  oai21  g27(.a(x15), .b(new_n50_), .c(x12), .O(new_n61_));
  ...
  oai21  g36(.a(x12), .b(new_n50_), .c(x15), .O(new_n70_));
