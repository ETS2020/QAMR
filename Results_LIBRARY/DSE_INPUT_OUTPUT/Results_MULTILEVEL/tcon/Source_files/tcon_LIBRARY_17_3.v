...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n43_, new_n47_,
  ...
  nand2  g05(.a(x15), .b(x12), .O(new_n39_));
  and2   g06(.a(new_n39_), .b(x11), .O(z02));
  inv1   g07(.a(x12), .O(new_n41_));
  nor2   g08(.a(x15), .b(new_n41_), .O(z03));
  ...
  and2   g13(.a(x15), .b(x12), .O(new_n47_));
  ...
  nand3  g22(.a(new_n39_), .b(x11), .c(new_n49_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z10));
  nand3  g24(.a(new_n35_), .b(x08), .c(x03), .O(new_n58_));
  inv1   g25(.a(x15), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(x12), .c(new_n49_), .O(new_n60_));
  ...
  oai21  g34(.a(x12), .b(new_n49_), .c(x15), .O(new_n68_));
