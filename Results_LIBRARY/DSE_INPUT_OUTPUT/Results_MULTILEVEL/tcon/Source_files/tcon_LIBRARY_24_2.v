...
module FAU ( 
  ...
  and2   g08(.a(new_n41_), .b(x11), .O(z02));
  nor2   g09(.a(new_n40_), .b(new_n35_), .O(z03));
  ...
  nand3  g24(.a(new_n47_), .b(x08), .c(x02), .O(new_n58_));
  nand3  g25(.a(new_n41_), .b(x11), .c(new_n51_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  nand3  g27(.a(new_n47_), .b(x08), .c(x03), .O(new_n61_));
  nand3  g28(.a(x14), .b(x12), .c(new_n51_), .O(new_n62_));
