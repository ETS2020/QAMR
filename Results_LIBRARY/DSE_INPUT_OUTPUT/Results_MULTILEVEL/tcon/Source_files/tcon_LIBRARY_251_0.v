...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_,
    new_n45_, new_n47_, new_n49_, new_n51_, new_n52_, new_n54_, new_n56_,
  ...
  aoi21  g14(.a(new_n36_), .b(new_n35_), .c(new_n47_), .O(z06));
  ...
  oai21  g22(.a(x11), .b(new_n36_), .c(new_n35_), .O(new_n56_));
