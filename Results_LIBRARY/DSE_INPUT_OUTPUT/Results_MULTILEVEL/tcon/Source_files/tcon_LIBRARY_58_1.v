...
module FAU ( 
  ...
  aoi21  g11(.a(x14), .b(new_n34_), .c(new_n44_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  nor2   g13(.a(new_n46_), .b(new_n34_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n40_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  aoi21  g17(.a(x14), .b(new_n34_), .c(new_n50_), .O(z07));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  nand3  g19(.a(new_n46_), .b(x09), .c(new_n34_), .O(new_n53_));
  ...
  nand3  g25(.a(new_n46_), .b(x11), .c(new_n34_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  nand3  g28(.a(new_n46_), .b(x12), .c(new_n34_), .O(new_n62_));
  ...
  nand2  g34(.a(new_n67_), .b(new_n40_), .O(z13));
