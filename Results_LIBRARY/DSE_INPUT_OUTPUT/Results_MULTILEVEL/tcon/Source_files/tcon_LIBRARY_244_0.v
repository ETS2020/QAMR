...
module FAU ( 
  ...
  nand2  g24(.a(x12), .b(x09), .O(new_n58_));
  oai21  g25(.a(new_n58_), .b(x08), .c(new_n57_), .O(z11));
  nand2  g26(.a(x08), .b(x04), .O(new_n60_));
  nand2  g27(.a(x13), .b(x09), .O(new_n61_));
  oai21  g28(.a(new_n61_), .b(x08), .c(new_n60_), .O(z12));
  inv1   g29(.a(x08), .O(new_n63_));
  inv1   g30(.a(x09), .O(new_n64_));
  oai21  g31(.a(x14), .b(new_n64_), .c(new_n63_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z13));
  oai21  g34(.a(x15), .b(new_n64_), .c(new_n63_), .O(new_n68_));
  nand2  g35(.a(x08), .b(x06), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z14));
  oai21  g37(.a(x16), .b(new_n64_), .c(new_n63_), .O(new_n71_));
