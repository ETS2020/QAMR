...
module FAU ( 
  ...
  oai21  g07(.a(new_n38_), .b(x09), .c(new_n40_), .O(z03));
  inv1   g08(.a(x13), .O(new_n42_));
  nand2  g09(.a(new_n36_), .b(new_n42_), .O(z04));
  inv1   g10(.a(x14), .O(new_n44_));
  nor2   g11(.a(new_n38_), .b(x09), .O(new_n45_));
  ...
  oai21  g18(.a(x11), .b(x09), .c(new_n51_), .O(new_n52_));
  ...
  nand3  g25(.a(x11), .b(x09), .c(new_n51_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  nand3  g27(.a(new_n36_), .b(x08), .c(x03), .O(new_n61_));
  nand2  g28(.a(x11), .b(new_n35_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(x12), .c(new_n51_), .O(new_n63_));
