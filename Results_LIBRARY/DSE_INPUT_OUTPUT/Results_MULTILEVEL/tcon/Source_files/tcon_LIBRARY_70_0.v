...
module FAU ( 
  ...
  nor2   g01(.a(x09), .b(x04), .O(new_n35_));
  ...
  nand2  g17(.a(x09), .b(x08), .O(new_n51_));
  ...
  nand3  g22(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(z08));
  nand2  g23(.a(x08), .b(x01), .O(new_n57_));
  nand2  g24(.a(x10), .b(new_n54_), .O(new_n58_));
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n35_), .O(z09));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  nand2  g27(.a(x11), .b(new_n54_), .O(new_n61_));
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n35_), .O(z10));
  ...
  nand3  g33(.a(x13), .b(x09), .c(new_n54_), .O(new_n67_));
  ...
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n35_), .O(z14));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand2  g42(.a(x16), .b(new_n54_), .O(new_n76_));
  aoi21  g43(.a(new_n76_), .b(new_n75_), .c(new_n35_), .O(z15));
  buf    g44(.a(x09), .O(z00));
endmodule
