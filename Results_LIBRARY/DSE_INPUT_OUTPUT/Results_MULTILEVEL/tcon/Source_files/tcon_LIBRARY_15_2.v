...
module FAU ( 
  ...
  nand2  g07(.a(new_n35_), .b(x05), .O(new_n41_));
  ...
  nand2  g14(.a(new_n41_), .b(new_n47_), .O(z05));
  ...
  aoi21  g20(.a(x08), .b(new_n34_), .c(x09), .O(new_n54_));
  inv1   g21(.a(x08), .O(new_n55_));
  nand2  g22(.a(x09), .b(new_n55_), .O(new_n56_));
  oai21  g23(.a(new_n54_), .b(new_n53_), .c(new_n56_), .O(z08));
  nand2  g24(.a(x10), .b(new_n55_), .O(new_n58_));
  nand2  g25(.a(x08), .b(x01), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n41_), .O(z09));
  nand2  g27(.a(x11), .b(new_n55_), .O(new_n61_));
  nand2  g28(.a(x08), .b(x02), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n41_), .O(z10));
  nand2  g30(.a(x08), .b(x03), .O(new_n64_));
  nand2  g31(.a(x12), .b(new_n55_), .O(new_n65_));
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n38_), .O(z11));
  nand2  g33(.a(x13), .b(new_n55_), .O(new_n67_));
  nand2  g34(.a(x08), .b(x04), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n41_), .O(z12));
  oai21  g36(.a(x14), .b(x08), .c(x09), .O(new_n70_));
  nand3  g37(.a(x14), .b(new_n55_), .c(new_n34_), .O(new_n71_));
  oai21  g38(.a(new_n70_), .b(new_n34_), .c(new_n71_), .O(z13));
  nand2  g39(.a(x15), .b(new_n55_), .O(new_n73_));
  nand2  g40(.a(x08), .b(x06), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n41_), .O(z14));
