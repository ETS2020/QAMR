...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n41_, new_n43_,
    new_n45_, new_n47_, new_n49_, new_n50_, new_n53_, new_n54_, new_n55_,
  ...
  aoi21  g17(.a(x16), .b(new_n49_), .c(new_n50_), .O(z06));
  nor2   g18(.a(new_n35_), .b(new_n49_), .O(z07));
  ...
  nand3  g36(.a(new_n35_), .b(x14), .c(new_n53_), .O(new_n70_));
  ...
  oai21  g42(.a(new_n35_), .b(x08), .c(new_n75_), .O(new_n76_));
  nand2  g43(.a(new_n76_), .b(x05), .O(new_n77_));
  nand3  g44(.a(new_n35_), .b(x08), .c(x07), .O(new_n78_));
