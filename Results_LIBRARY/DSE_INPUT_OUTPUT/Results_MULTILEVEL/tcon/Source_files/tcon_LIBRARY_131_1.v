...
module FAU ( 
  ...
  oai21  g17(.a(x09), .b(x08), .c(x00), .O(new_n51_));
  ...
  oai21  g28(.a(new_n40_), .b(x08), .c(new_n58_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n35_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n61_), .O(z10));
  nand2  g31(.a(x08), .b(x03), .O(new_n65_));
  oai21  g32(.a(new_n35_), .b(x08), .c(new_n65_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(x00), .O(new_n67_));
  nand3  g34(.a(new_n35_), .b(x08), .c(x03), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z11));
  nand2  g36(.a(x13), .b(new_n52_), .O(new_n70_));
  nand2  g37(.a(x08), .b(x04), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n43_), .O(z12));
  ...
  aoi21  g44(.a(new_n77_), .b(new_n76_), .c(new_n36_), .O(z14));
  nand2  g45(.a(x16), .b(new_n52_), .O(new_n79_));
  nand2  g46(.a(x08), .b(x07), .O(new_n80_));
  nand3  g47(.a(new_n80_), .b(new_n79_), .c(new_n43_), .O(z15));
  buf    g48(.a(x12), .O(z03));
endmodule
