...
module FAU ( 
  ...
  nor2   g01(.a(x16), .b(x15), .O(new_n35_));
  ...
  nand2  g15(.a(x16), .b(new_n48_), .O(z06));
  ...
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n38_), .O(z09));
  ...
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n35_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  aoi21  g36(.a(x16), .b(x08), .c(x15), .O(new_n70_));
  nand2  g37(.a(x15), .b(new_n51_), .O(new_n71_));
  oai21  g38(.a(new_n70_), .b(new_n69_), .c(new_n71_), .O(z14));
  inv1   g39(.a(x07), .O(new_n73_));
  aoi21  g40(.a(x15), .b(x08), .c(x16), .O(new_n74_));
  nand2  g41(.a(x16), .b(new_n51_), .O(new_n75_));
  oai21  g42(.a(new_n74_), .b(new_n73_), .c(new_n75_), .O(z15));
  buf    g43(.a(x16), .O(z07));
endmodule
