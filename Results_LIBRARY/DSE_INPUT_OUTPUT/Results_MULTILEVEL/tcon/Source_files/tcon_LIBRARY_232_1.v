...
module FAU ( 
  ...
  nor2   g12(.a(new_n42_), .b(new_n45_), .O(z04));
  ...
  aoi21  g23(.a(new_n56_), .b(new_n55_), .c(new_n42_), .O(z09));
  ...
  aoi21  g28(.a(new_n41_), .b(x08), .c(x12), .O(new_n62_));
  ...
  oai21  g37(.a(new_n35_), .b(new_n52_), .c(x15), .O(new_n71_));
