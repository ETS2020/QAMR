...
module FAU ( 
  ...
  oai22  g29(.a(new_n60_), .b(new_n62_), .c(new_n42_), .d(x08), .O(z12));
  inv1   g30(.a(x05), .O(new_n64_));
  oai22  g31(.a(new_n60_), .b(new_n64_), .c(new_n44_), .d(x08), .O(z13));
  inv1   g32(.a(x06), .O(new_n66_));
  oai22  g33(.a(new_n60_), .b(new_n66_), .c(new_n46_), .d(x08), .O(z14));
  inv1   g34(.a(x07), .O(new_n68_));
  oai22  g35(.a(new_n60_), .b(new_n68_), .c(new_n48_), .d(x08), .O(z15));
  buf    g36(.a(x10), .O(z01));
endmodule
