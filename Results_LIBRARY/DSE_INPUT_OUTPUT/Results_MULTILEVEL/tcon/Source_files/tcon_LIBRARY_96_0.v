...
module FAU ( 
  ...
  oai21  g01(.a(x15), .b(x08), .c(new_n34_), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nor2   g03(.a(x15), .b(x08), .O(new_n37_));
  ...
  oai21  g30(.a(new_n47_), .b(x13), .c(new_n54_), .O(new_n64_));
  nand2  g31(.a(x08), .b(x04), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z12));
  oai21  g33(.a(new_n47_), .b(x14), .c(new_n54_), .O(new_n67_));
