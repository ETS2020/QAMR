// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:17 2020
...
module FAU ( 
  ...
  nand2  g02(.a(new_n35_), .b(x12), .O(new_n36_));
  ...
  nand2  g14(.a(new_n35_), .b(new_n39_), .O(z06));
  ...
  oai21  g27(.a(new_n35_), .b(new_n51_), .c(x12), .O(new_n61_));
  ...
  aoi21  g37(.a(new_n39_), .b(x08), .c(x15), .O(new_n71_));
