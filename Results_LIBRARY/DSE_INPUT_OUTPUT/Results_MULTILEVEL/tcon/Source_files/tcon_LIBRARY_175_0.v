...
module FAU ( 
  ...
  nand3  g27(.a(x11), .b(new_n53_), .c(x00), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z10));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand3  g30(.a(x12), .b(new_n53_), .c(x00), .O(new_n64_));
