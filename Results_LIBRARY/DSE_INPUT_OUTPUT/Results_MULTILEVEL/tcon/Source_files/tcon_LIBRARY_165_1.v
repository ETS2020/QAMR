// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:33 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n59_, new_n61_, new_n63_, new_n65_, new_n67_, new_n68_;
  ...
  nand2  g24(.a(new_n40_), .b(new_n57_), .O(z10));
  nand3  g25(.a(x08), .b(x03), .c(x02), .O(new_n59_));
  oai21  g26(.a(new_n42_), .b(x08), .c(new_n59_), .O(z11));
  nand3  g27(.a(x08), .b(x04), .c(x02), .O(new_n61_));
  oai21  g28(.a(new_n44_), .b(x08), .c(new_n61_), .O(z12));
  nand3  g29(.a(x08), .b(x05), .c(x02), .O(new_n63_));
  oai21  g30(.a(new_n46_), .b(x08), .c(new_n63_), .O(z13));
  nand3  g31(.a(x08), .b(x06), .c(x02), .O(new_n65_));
  oai21  g32(.a(new_n48_), .b(x08), .c(new_n65_), .O(z14));
  oai21  g33(.a(x07), .b(new_n34_), .c(x08), .O(new_n67_));
  nand2  g34(.a(x16), .b(new_n57_), .O(new_n68_));
