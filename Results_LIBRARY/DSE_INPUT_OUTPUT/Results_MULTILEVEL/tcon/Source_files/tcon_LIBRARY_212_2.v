...
module FAU ( 
  ...
  nand2  g18(.a(new_n40_), .b(x01), .O(new_n52_));
  nand3  g19(.a(new_n52_), .b(x08), .c(x00), .O(new_n53_));
  inv1   g20(.a(x08), .O(new_n54_));
  nand2  g21(.a(new_n40_), .b(x01), .O(new_n55_));
  nand3  g22(.a(new_n55_), .b(x09), .c(new_n54_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n53_), .O(z08));
  nand3  g24(.a(new_n55_), .b(x10), .c(new_n54_), .O(new_n58_));
  nand3  g25(.a(x11), .b(x08), .c(x01), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z09));
  inv1   g27(.a(x02), .O(new_n61_));
  aoi21  g28(.a(x08), .b(new_n35_), .c(x11), .O(new_n62_));
  nand2  g29(.a(x11), .b(new_n54_), .O(new_n63_));
  oai21  g30(.a(new_n62_), .b(new_n61_), .c(new_n63_), .O(z10));
  nand2  g31(.a(x12), .b(new_n54_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x03), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n55_), .O(z11));
  nand2  g34(.a(x13), .b(new_n54_), .O(new_n68_));
  nand2  g35(.a(x08), .b(x04), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n55_), .O(z12));
  ...
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n55_), .O(z14));
  nand2  g43(.a(x08), .b(x07), .O(new_n77_));
  nand2  g44(.a(x16), .b(new_n54_), .O(new_n78_));
  aoi21  g45(.a(new_n78_), .b(new_n77_), .c(new_n36_), .O(z15));
endmodule
