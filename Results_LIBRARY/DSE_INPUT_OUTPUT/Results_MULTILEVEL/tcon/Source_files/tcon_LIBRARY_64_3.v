...
module FAU ( 
  ...
  nand2  g25(.a(new_n58_), .b(new_n46_), .O(z12));
  nand2  g26(.a(x14), .b(new_n44_), .O(new_n60_));
  nand3  g27(.a(new_n46_), .b(x08), .c(x05), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z13));
  oai21  g29(.a(x13), .b(x06), .c(x08), .O(new_n63_));
  nand2  g30(.a(x15), .b(new_n44_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z14));
  oai21  g32(.a(x13), .b(x07), .c(x08), .O(new_n66_));
