...
module FAU ( 
  ...
  nand2  g17(.a(x12), .b(x09), .O(new_n51_));
  ...
  oai21  g24(.a(new_n57_), .b(x11), .c(new_n56_), .O(new_n58_));
  nand2  g25(.a(x08), .b(x02), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  oai21  g28(.a(new_n57_), .b(x08), .c(new_n61_), .O(z11));
  oai21  g29(.a(x13), .b(new_n57_), .c(new_n56_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z12));
  oai21  g32(.a(x14), .b(new_n57_), .c(new_n56_), .O(new_n66_));
  ...
  oai21  g38(.a(x16), .b(new_n57_), .c(new_n56_), .O(new_n72_));
