...
module FAU ( 
  ...
  nand2  g15(.a(new_n48_), .b(x15), .O(z07));
  ...
  aoi21  g37(.a(x16), .b(x08), .c(x15), .O(new_n71_));
  oai22  g38(.a(new_n71_), .b(new_n69_), .c(new_n70_), .d(x08), .O(z14));
  oai21  g39(.a(x16), .b(new_n70_), .c(new_n50_), .O(new_n73_));
