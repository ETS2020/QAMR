...
module FAU ( 
  ...
  nand2  g17(.a(x11), .b(x09), .O(new_n51_));
  ...
  oai21  g25(.a(new_n54_), .b(x08), .c(new_n58_), .O(z10));
  oai21  g26(.a(x12), .b(new_n54_), .c(new_n53_), .O(new_n60_));
  ...
  oai21  g32(.a(x14), .b(new_n54_), .c(new_n53_), .O(new_n66_));
