...
module FAU ( 
  ...
  aoi21  g13(.a(new_n35_), .b(x14), .c(new_n46_), .O(z04));
  nor2   g14(.a(new_n35_), .b(new_n39_), .O(z05));
  ...
  nand3  g33(.a(new_n36_), .b(x08), .c(x05), .O(new_n67_));
  nand3  g34(.a(x16), .b(x14), .c(new_n51_), .O(new_n68_));
  ...
  aoi21  g40(.a(new_n39_), .b(x08), .c(x16), .O(new_n74_));
