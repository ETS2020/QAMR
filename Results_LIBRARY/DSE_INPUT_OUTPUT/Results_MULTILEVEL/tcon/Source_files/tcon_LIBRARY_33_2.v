...
module FAU ( 
  ...
  nand2  g12(.a(new_n43_), .b(new_n35_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  nand2  g14(.a(new_n44_), .b(new_n47_), .O(z06));
  ...
  nand3  g24(.a(new_n44_), .b(x08), .c(x02), .O(new_n58_));
  nand3  g25(.a(x14), .b(x11), .c(new_n52_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  nand3  g27(.a(new_n44_), .b(x08), .c(x03), .O(new_n61_));
  nand2  g28(.a(new_n43_), .b(x11), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(x12), .c(new_n52_), .O(new_n63_));
