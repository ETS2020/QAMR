...
module FAU ( 
  ...
  oai21  g33(.a(x14), .b(new_n42_), .c(new_n55_), .O(new_n67_));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z13));
  oai21  g36(.a(x15), .b(new_n42_), .c(new_n55_), .O(new_n70_));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n70_), .O(z14));
  oai21  g39(.a(x16), .b(new_n42_), .c(new_n55_), .O(new_n73_));
