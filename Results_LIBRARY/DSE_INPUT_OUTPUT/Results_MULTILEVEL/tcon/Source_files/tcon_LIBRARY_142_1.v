...
module FAU ( 
  ...
  nand2  g10(.a(new_n35_), .b(new_n41_), .O(z03));
  ...
  aoi21  g16(.a(x16), .b(new_n41_), .c(new_n49_), .O(z06));
  nor2   g17(.a(new_n35_), .b(new_n41_), .O(z07));
  ...
  oai21  g28(.a(x16), .b(x12), .c(new_n52_), .O(new_n62_));
  ...
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n42_), .O(z14));
  oai21  g40(.a(new_n41_), .b(new_n52_), .c(x16), .O(new_n74_));
