...
module FAU ( 
  ...
  nand2  g31(.a(x13), .b(new_n42_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z12));
  oai21  g33(.a(new_n35_), .b(x05), .c(x08), .O(new_n67_));
  nand2  g34(.a(x14), .b(new_n42_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z13));
  oai21  g36(.a(new_n35_), .b(x06), .c(x08), .O(new_n70_));
  nand2  g37(.a(x15), .b(new_n42_), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n70_), .O(z14));
  oai21  g39(.a(new_n35_), .b(x07), .c(x08), .O(new_n73_));
  nand2  g40(.a(x16), .b(new_n42_), .O(new_n74_));
