...
module FAU ( 
  ...
  nor2   g11(.a(new_n35_), .b(new_n39_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  oai21  g13(.a(new_n35_), .b(x11), .c(new_n46_), .O(z05));
  ...
  oai21  g25(.a(x13), .b(x11), .c(new_n52_), .O(new_n59_));
  ...
  oai21  g31(.a(new_n39_), .b(new_n52_), .c(x13), .O(new_n65_));
