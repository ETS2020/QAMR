...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n43_, new_n45_, new_n47_, new_n48_,
  ...
  nor2   g10(.a(new_n43_), .b(x05), .O(z06));
  inv1   g11(.a(x16), .O(new_n45_));
  aoi21  g12(.a(x15), .b(x05), .c(new_n45_), .O(z07));
  and2   g13(.a(x15), .b(x05), .O(new_n47_));
  ...
  nand2  g27(.a(x15), .b(x05), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(x08), .c(x04), .O(new_n62_));
  nand3  g29(.a(new_n35_), .b(x13), .c(new_n49_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z12));
  nand3  g31(.a(new_n35_), .b(x14), .c(new_n49_), .O(new_n65_));
  nand3  g32(.a(new_n43_), .b(x08), .c(x05), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z13));
  oai21  g34(.a(new_n49_), .b(x05), .c(x15), .O(new_n68_));
