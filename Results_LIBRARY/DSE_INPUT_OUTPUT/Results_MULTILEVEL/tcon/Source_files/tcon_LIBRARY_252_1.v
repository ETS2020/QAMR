...
module FAU ( 
  ...
  aoi21  g04(.a(x10), .b(new_n34_), .c(new_n37_), .O(z02));
  inv1   g05(.a(x12), .O(new_n39_));
  nand2  g06(.a(x10), .b(new_n34_), .O(new_n40_));
  ...
  nand2  g21(.a(new_n54_), .b(new_n40_), .O(z09));
  nand2  g22(.a(x08), .b(x02), .O(new_n56_));
  nand3  g23(.a(x11), .b(new_n51_), .c(new_n34_), .O(new_n57_));
  ...
  nand3  g32(.a(x14), .b(new_n51_), .c(new_n34_), .O(new_n66_));
