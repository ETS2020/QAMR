...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n47_, new_n50_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  nand2  g06(.a(new_n35_), .b(x12), .O(new_n40_));
  ...
  nor2   g13(.a(x15), .b(new_n42_), .O(new_n47_));
  nor2   g14(.a(new_n47_), .b(new_n46_), .O(z05));
  nand2  g15(.a(new_n35_), .b(new_n42_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nor2   g17(.a(new_n47_), .b(new_n50_), .O(z07));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  inv1   g19(.a(x08), .O(new_n53_));
  nand2  g20(.a(x09), .b(new_n53_), .O(new_n54_));
  aoi21  g21(.a(new_n54_), .b(new_n52_), .c(new_n47_), .O(z08));
  ...
  nand3  g26(.a(new_n40_), .b(x11), .c(new_n53_), .O(new_n60_));
  ...
  nand2  g37(.a(z06), .b(new_n53_), .O(new_n71_));
