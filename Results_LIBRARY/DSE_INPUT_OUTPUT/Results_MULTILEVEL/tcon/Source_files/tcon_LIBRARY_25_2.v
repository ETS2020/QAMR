...
module FAU ( 
  ...
  oai21  g20(.a(new_n34_), .b(x01), .c(x08), .O(new_n54_));
  nand2  g21(.a(x10), .b(new_n51_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z09));
  oai21  g23(.a(new_n34_), .b(x02), .c(x08), .O(new_n57_));
  nand2  g24(.a(x11), .b(new_n51_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z10));
  inv1   g26(.a(x03), .O(new_n60_));
  nand2  g27(.a(x09), .b(x08), .O(new_n61_));
  oai22  g28(.a(new_n61_), .b(new_n60_), .c(new_n39_), .d(x08), .O(z11));
  inv1   g29(.a(x04), .O(new_n63_));
  oai22  g30(.a(new_n61_), .b(new_n63_), .c(new_n41_), .d(x08), .O(z12));
  ...
  oai22  g38(.a(new_n61_), .b(new_n71_), .c(new_n48_), .d(x08), .O(z15));
  buf    g39(.a(x09), .O(z00));
endmodule
