...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n38_, new_n40_, new_n42_, new_n43_, new_n45_, new_n48_,
  ...
  nand2  g17(.a(x10), .b(new_n42_), .O(new_n51_));
  nand3  g18(.a(new_n40_), .b(x08), .c(x01), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n51_), .O(z09));
  nand2  g20(.a(x11), .b(new_n42_), .O(new_n54_));
  nand3  g21(.a(new_n40_), .b(x08), .c(x02), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z10));
  oai21  g23(.a(x13), .b(x03), .c(x08), .O(new_n57_));
  nand2  g24(.a(x12), .b(new_n42_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z11));
  nand2  g26(.a(x08), .b(x04), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n40_), .O(z12));
  nand2  g28(.a(x14), .b(new_n42_), .O(new_n62_));
  oai21  g29(.a(x13), .b(x05), .c(x08), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z13));
  nand2  g31(.a(x15), .b(new_n42_), .O(new_n65_));
  nand3  g32(.a(new_n40_), .b(x08), .c(x06), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z14));
  nand2  g34(.a(x16), .b(new_n42_), .O(new_n68_));
  nand3  g35(.a(new_n40_), .b(x08), .c(x07), .O(new_n69_));
