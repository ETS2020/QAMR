...
module FAU ( 
  ...
  nor2   g08(.a(new_n40_), .b(x07), .O(z03));
  ...
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n34_), .O(z09));
  nand2  g25(.a(x11), .b(new_n53_), .O(new_n59_));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n34_), .O(z10));
  nand3  g28(.a(new_n34_), .b(x08), .c(x03), .O(new_n62_));
  nand3  g29(.a(x12), .b(new_n53_), .c(new_n38_), .O(new_n63_));
  ...
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n51_), .O(z14));
  oai21  g40(.a(x12), .b(x08), .c(x07), .O(new_n74_));
  oai21  g41(.a(new_n49_), .b(x08), .c(new_n74_), .O(z15));
endmodule
