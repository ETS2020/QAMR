...
module FAU ( 
  ...
  nand2  g09(.a(new_n35_), .b(x11), .O(new_n43_));
  and2   g10(.a(new_n43_), .b(x12), .O(z03));
  ...
  nand3  g25(.a(x15), .b(x11), .c(new_n52_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  nand3  g27(.a(new_n36_), .b(x08), .c(x03), .O(new_n61_));
  nand3  g28(.a(new_n43_), .b(x12), .c(new_n52_), .O(new_n62_));
