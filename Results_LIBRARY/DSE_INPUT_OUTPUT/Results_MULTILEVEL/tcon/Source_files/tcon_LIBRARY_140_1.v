...
module FAU ( 
  ...
  nand2  g12(.a(x14), .b(new_n35_), .O(new_n46_));
  and2   g13(.a(new_n46_), .b(x13), .O(z04));
  ...
  nand3  g33(.a(new_n46_), .b(x13), .c(new_n54_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z12));
  nand3  g35(.a(new_n36_), .b(x08), .c(x05), .O(new_n69_));
  nand3  g36(.a(x14), .b(new_n54_), .c(x07), .O(new_n70_));
  ...
  nand3  g42(.a(x16), .b(new_n39_), .c(new_n54_), .O(new_n76_));
