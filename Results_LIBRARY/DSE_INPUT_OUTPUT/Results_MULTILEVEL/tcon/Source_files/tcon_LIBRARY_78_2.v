...
module FAU ( 
  ...
  nand2  g02(.a(new_n35_), .b(x09), .O(new_n36_));
  ...
  nand3  g16(.a(new_n36_), .b(x08), .c(x00), .O(new_n50_));
  inv1   g17(.a(x08), .O(new_n51_));
  nand3  g18(.a(x16), .b(x09), .c(new_n51_), .O(new_n52_));
  ...
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n46_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  nand2  g27(.a(x12), .b(new_n51_), .O(new_n61_));
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n46_), .O(z11));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n46_), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  aoi21  g39(.a(new_n45_), .b(x08), .c(x16), .O(new_n73_));
  nand2  g40(.a(x16), .b(new_n51_), .O(new_n74_));
  oai21  g41(.a(new_n73_), .b(new_n72_), .c(new_n74_), .O(z15));
  buf    g42(.a(x09), .O(z00));
  buf    g43(.a(x16), .O(z07));
endmodule
