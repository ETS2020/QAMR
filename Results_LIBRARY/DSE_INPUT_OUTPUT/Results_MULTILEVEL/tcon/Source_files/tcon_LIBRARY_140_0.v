// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:22 2020
...
module FAU ( 
  ...
  nor2   g01(.a(x14), .b(x07), .O(new_n35_));
  ...
  aoi21  g33(.a(x08), .b(x07), .c(x14), .O(new_n67_));
  ...
  nand3  g40(.a(x16), .b(x14), .c(new_n51_), .O(new_n74_));
