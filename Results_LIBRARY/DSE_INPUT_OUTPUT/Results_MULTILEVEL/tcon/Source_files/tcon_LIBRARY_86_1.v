...
module FAU ( 
  ...
  aoi21  g06(.a(x09), .b(new_n34_), .c(new_n39_), .O(z03));
  inv1   g07(.a(x13), .O(new_n41_));
  aoi21  g08(.a(x09), .b(new_n34_), .c(new_n41_), .O(z04));
  ...
  nand2  g17(.a(new_n50_), .b(new_n44_), .O(z08));
  ...
  nand3  g26(.a(x12), .b(new_n53_), .c(new_n34_), .O(new_n60_));
