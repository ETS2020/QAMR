...
module FAU ( 
  ...
  nand2  g08(.a(new_n39_), .b(new_n35_), .O(z03));
  ...
  nand3  g17(.a(new_n40_), .b(x08), .c(x00), .O(new_n51_));
  inv1   g18(.a(x08), .O(new_n52_));
  nand2  g19(.a(new_n39_), .b(x10), .O(new_n53_));
  nand3  g20(.a(new_n53_), .b(x09), .c(new_n52_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n51_), .O(z08));
  nand3  g22(.a(new_n40_), .b(x08), .c(x01), .O(new_n56_));
  nand3  g23(.a(x12), .b(x10), .c(new_n52_), .O(new_n57_));
