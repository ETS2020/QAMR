...
module FAU ( 
  ...
  aoi21  g11(.a(x14), .b(new_n40_), .c(new_n44_), .O(z04));
  nor2   g12(.a(new_n35_), .b(new_n40_), .O(z05));
  ...
  nand2  g21(.a(x14), .b(new_n40_), .O(new_n55_));
  nand2  g22(.a(x10), .b(new_n52_), .O(new_n56_));
  nand2  g23(.a(x08), .b(x01), .O(new_n57_));
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(z09));
  nand2  g25(.a(x11), .b(new_n52_), .O(new_n59_));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n55_), .O(z10));
  nand2  g28(.a(x12), .b(new_n52_), .O(new_n62_));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n55_), .O(z11));
  nand2  g31(.a(x13), .b(new_n52_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n55_), .O(z12));
  nand3  g34(.a(new_n55_), .b(x08), .c(x05), .O(new_n68_));
  nand3  g35(.a(x14), .b(x11), .c(new_n52_), .O(new_n69_));
  ...
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n55_), .O(z15));
endmodule
