...
module FAU ( 
  ...
  aoi21  g22(.a(new_n55_), .b(new_n54_), .c(new_n41_), .O(z09));
  nand2  g23(.a(x11), .b(new_n50_), .O(new_n57_));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n35_), .O(z10));
  oai21  g26(.a(x08), .b(x04), .c(x03), .O(new_n60_));
  oai21  g27(.a(new_n40_), .b(x08), .c(new_n60_), .O(z11));
  oai21  g28(.a(x08), .b(x03), .c(x04), .O(new_n62_));
  oai21  g29(.a(new_n43_), .b(x08), .c(new_n62_), .O(z12));
  ...
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n41_), .O(z14));
  nand2  g36(.a(x08), .b(x07), .O(new_n70_));
  nand2  g37(.a(x16), .b(new_n50_), .O(new_n71_));
  aoi21  g38(.a(new_n71_), .b(new_n70_), .c(new_n41_), .O(z15));
endmodule
