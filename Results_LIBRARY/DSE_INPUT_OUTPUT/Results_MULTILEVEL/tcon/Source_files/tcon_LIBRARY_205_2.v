...
module FAU ( 
  ...
  nor2   g16(.a(new_n35_), .b(new_n41_), .O(z06));
  nand2  g17(.a(new_n35_), .b(new_n41_), .O(z07));
  ...
  nand3  g38(.a(x16), .b(x15), .c(new_n52_), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n71_), .O(z14));
  nand2  g40(.a(z07), .b(new_n52_), .O(new_n74_));
