...
module FAU ( 
  ...
  nor2   g09(.a(new_n42_), .b(new_n40_), .O(z04));
  inv1   g10(.a(x14), .O(new_n44_));
  nor2   g11(.a(new_n42_), .b(new_n44_), .O(z05));
  ...
  oai21  g20(.a(x10), .b(x09), .c(new_n50_), .O(new_n54_));
  ...
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n42_), .O(z10));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n42_), .O(z14));
