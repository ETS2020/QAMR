...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n47_, new_n49_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n47_), .O(z09));
  nand3  g25(.a(new_n47_), .b(x08), .c(x02), .O(new_n59_));
  nand3  g26(.a(x16), .b(x11), .c(new_n53_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z10));
  nand3  g28(.a(new_n47_), .b(x08), .c(x03), .O(new_n62_));
  nand3  g29(.a(new_n42_), .b(x12), .c(new_n53_), .O(new_n63_));
