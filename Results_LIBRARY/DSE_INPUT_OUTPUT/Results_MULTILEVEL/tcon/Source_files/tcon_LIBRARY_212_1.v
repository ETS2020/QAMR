...
module FAU ( 
  ...
  nand3  g21(.a(new_n35_), .b(x10), .c(new_n51_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z09));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  oai21  g24(.a(new_n35_), .b(x08), .c(new_n57_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(x01), .O(new_n59_));
  nand3  g26(.a(new_n35_), .b(x08), .c(x02), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z10));
  inv1   g28(.a(new_n36_), .O(new_n62_));
  ...
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n62_), .O(z12));
