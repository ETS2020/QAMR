...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n57_, new_n59_, new_n61_, new_n63_, new_n65_, new_n68_;
  ...
  oai21  g33(.a(new_n48_), .b(x08), .c(new_n53_), .O(z14));
  nand3  g34(.a(x08), .b(x07), .c(x06), .O(new_n68_));
  oai21  g35(.a(new_n50_), .b(x08), .c(new_n68_), .O(z15));
endmodule
