...
module FAU ( 
  ...
  oai22  g34(.a(new_n56_), .b(new_n67_), .c(new_n46_), .d(x08), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  oai22  g36(.a(new_n56_), .b(new_n69_), .c(new_n48_), .d(x08), .O(z14));
  inv1   g37(.a(x07), .O(new_n71_));
  oai22  g38(.a(new_n56_), .b(new_n71_), .c(new_n50_), .d(x08), .O(z15));
endmodule
