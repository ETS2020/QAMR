...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n67_, new_n69_, new_n70_, new_n72_, new_n73_, new_n74_;
  inv1   g00(.a(x09), .O(new_n34_));
  nor2   g01(.a(x16), .b(x04), .O(new_n35_));
  ...
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n36_), .O(z10));
  nand2  g26(.a(x12), .b(new_n51_), .O(new_n60_));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n36_), .O(z11));
  oai21  g29(.a(x13), .b(x08), .c(x04), .O(new_n63_));
  nand3  g30(.a(x16), .b(x13), .c(new_n51_), .O(new_n64_));
  ...
  nand2  g35(.a(x15), .b(new_n51_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n36_), .O(z14));
  inv1   g38(.a(x07), .O(new_n72_));
  aoi21  g39(.a(x08), .b(x04), .c(x16), .O(new_n73_));
