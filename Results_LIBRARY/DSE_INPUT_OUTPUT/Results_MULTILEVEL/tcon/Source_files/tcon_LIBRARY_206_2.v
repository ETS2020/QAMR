...
module FAU ( 
  ...
  oai21  g29(.a(x12), .b(x08), .c(x13), .O(new_n63_));
  nand3  g30(.a(x12), .b(new_n53_), .c(new_n39_), .O(new_n64_));
  oai21  g31(.a(new_n63_), .b(new_n39_), .c(new_n64_), .O(z11));
  ...
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n40_), .O(z14));
