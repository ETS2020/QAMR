...
module FAU ( 
  ...
  nor2   g06(.a(new_n35_), .b(x01), .O(new_n40_));
  nor2   g07(.a(new_n40_), .b(new_n39_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  nand2  g09(.a(x09), .b(new_n34_), .O(new_n43_));
