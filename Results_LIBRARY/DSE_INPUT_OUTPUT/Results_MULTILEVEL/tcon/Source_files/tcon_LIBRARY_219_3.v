...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n37_, new_n38_, new_n39_, new_n43_, new_n45_, new_n48_,
  ...
  oai21  g06(.a(new_n39_), .b(new_n38_), .c(new_n37_), .O(z02));
  nor2   g07(.a(x16), .b(new_n38_), .O(z03));
  and2   g08(.a(new_n34_), .b(x13), .O(z04));
  inv1   g09(.a(x14), .O(new_n43_));
  nand2  g10(.a(new_n34_), .b(new_n43_), .O(z05));
  inv1   g11(.a(x15), .O(new_n45_));
  oai21  g12(.a(new_n39_), .b(new_n38_), .c(new_n45_), .O(z06));
  nor2   g13(.a(new_n39_), .b(x12), .O(z07));
  ...
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n34_), .O(z10));
  ...
  nand3  g38(.a(x16), .b(new_n38_), .c(new_n50_), .O(new_n72_));
