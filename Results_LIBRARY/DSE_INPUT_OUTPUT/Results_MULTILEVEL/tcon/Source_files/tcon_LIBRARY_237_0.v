...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n57_, new_n59_, new_n60_, new_n61_, new_n63_, new_n64_, new_n67_,
  ...
  nand3  g20(.a(x09), .b(new_n53_), .c(x04), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n52_), .O(z08));
  nand2  g22(.a(x08), .b(x01), .O(new_n56_));
  nand3  g23(.a(x10), .b(new_n53_), .c(x04), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n56_), .O(z09));
  inv1   g25(.a(x04), .O(new_n59_));
  oai21  g26(.a(x11), .b(new_n59_), .c(new_n53_), .O(new_n60_));
