...
module FAU ( 
  ...
  aoi21  g08(.a(x16), .b(x12), .c(new_n41_), .O(z06));
  inv1   g09(.a(x16), .O(new_n43_));
  nor2   g10(.a(new_n43_), .b(x12), .O(z07));
  ...
  oai21  g34(.a(x12), .b(new_n45_), .c(x16), .O(new_n68_));
