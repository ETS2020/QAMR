...
module FAU ( 
  ...
  nand2  g09(.a(x14), .b(new_n34_), .O(new_n43_));
  ...
  nor2   g14(.a(new_n38_), .b(new_n47_), .O(z06));
  ...
  aoi21  g24(.a(new_n57_), .b(new_n56_), .c(new_n38_), .O(z09));
  nand2  g25(.a(x11), .b(new_n53_), .O(new_n59_));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n43_), .O(z10));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand2  g29(.a(x12), .b(new_n53_), .O(new_n63_));
  aoi21  g30(.a(new_n63_), .b(new_n62_), .c(new_n38_), .O(z11));
  nand3  g31(.a(new_n43_), .b(x08), .c(x04), .O(new_n65_));
  nand2  g32(.a(x14), .b(new_n34_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(x13), .c(new_n53_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n65_), .O(z12));
  nand3  g35(.a(new_n43_), .b(x08), .c(x05), .O(new_n69_));
  nand3  g36(.a(x14), .b(x09), .c(new_n53_), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z13));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(x15), .b(new_n53_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n38_), .O(z14));
