...
module FAU ( 
  ...
  oai21  g25(.a(new_n35_), .b(x02), .c(x08), .O(new_n59_));
  ...
  oai22  g34(.a(new_n57_), .b(new_n67_), .c(new_n46_), .d(x08), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  oai22  g36(.a(new_n57_), .b(new_n69_), .c(new_n48_), .d(x08), .O(z14));
  nand2  g37(.a(new_n50_), .b(new_n53_), .O(z15));
endmodule
