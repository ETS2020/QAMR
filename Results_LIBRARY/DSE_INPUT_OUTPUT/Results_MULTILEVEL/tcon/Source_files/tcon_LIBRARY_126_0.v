...
module FAU ( 
  ...
  nand2  g07(.a(x14), .b(new_n40_), .O(z02));
  ...
  aoi21  g24(.a(x14), .b(x08), .c(x11), .O(new_n58_));
  ...
  aoi21  g34(.a(x11), .b(x08), .c(x14), .O(new_n68_));
  ...
  aoi21  g42(.a(new_n75_), .b(new_n74_), .c(new_n35_), .O(z15));
  buf    g43(.a(x14), .O(z05));
endmodule
