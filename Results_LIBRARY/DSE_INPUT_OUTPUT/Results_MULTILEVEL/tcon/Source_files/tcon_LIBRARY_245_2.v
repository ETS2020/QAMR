...
module FAU ( 
  ...
  oai21  g02(.a(x16), .b(new_n35_), .c(new_n34_), .O(z00));
  inv1   g03(.a(x16), .O(new_n37_));
  nor2   g04(.a(new_n37_), .b(new_n35_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  nand2  g06(.a(new_n37_), .b(x10), .O(new_n40_));
  nand2  g07(.a(new_n40_), .b(new_n39_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  nand2  g09(.a(new_n40_), .b(new_n42_), .O(z03));
  inv1   g10(.a(x13), .O(new_n44_));
  nor2   g11(.a(x16), .b(new_n35_), .O(new_n45_));
  ...
  aoi21  g20(.a(new_n53_), .b(new_n51_), .c(new_n45_), .O(z08));
  oai21  g21(.a(new_n37_), .b(new_n52_), .c(x10), .O(new_n55_));
  ...
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n45_), .O(z10));
