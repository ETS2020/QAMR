...
module FAU ( 
  ...
  aoi21  g14(.a(x08), .b(x07), .c(new_n47_), .O(z07));
  ...
  oai21  g32(.a(x07), .b(x05), .c(x08), .O(new_n66_));
  ...
  oai21  g38(.a(new_n47_), .b(x08), .c(new_n34_), .O(z15));
endmodule
