...
module FAU ( 
  ...
  oai21  g11(.a(x13), .b(x00), .c(x08), .O(new_n45_));
  ...
  nand2  g26(.a(new_n59_), .b(new_n50_), .O(z12));
  nand2  g27(.a(x14), .b(new_n46_), .O(new_n61_));
  nand3  g28(.a(new_n50_), .b(x08), .c(x05), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z13));
  oai21  g30(.a(x13), .b(x06), .c(x08), .O(new_n64_));
  nand2  g31(.a(x15), .b(new_n46_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z14));
  oai21  g33(.a(x13), .b(x07), .c(x08), .O(new_n67_));
