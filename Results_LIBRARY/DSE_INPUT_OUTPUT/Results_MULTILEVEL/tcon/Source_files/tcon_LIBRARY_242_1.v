...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n48_, new_n50_, new_n52_, new_n53_, new_n54_, new_n57_,
    new_n58_, new_n60_, new_n62_, new_n64_, new_n66_, new_n68_, new_n69_;
  ...
  nand2  g22(.a(new_n38_), .b(new_n53_), .O(z09));
  oai21  g23(.a(x02), .b(new_n35_), .c(x08), .O(new_n57_));
  nand2  g24(.a(x11), .b(new_n53_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z10));
  nand3  g26(.a(x08), .b(x03), .c(x01), .O(new_n60_));
  oai21  g27(.a(new_n42_), .b(x08), .c(new_n60_), .O(z11));
  nand3  g28(.a(x08), .b(x04), .c(x01), .O(new_n62_));
  oai21  g29(.a(new_n44_), .b(x08), .c(new_n62_), .O(z12));
  nand3  g30(.a(x08), .b(x05), .c(x01), .O(new_n64_));
  oai21  g31(.a(new_n46_), .b(x08), .c(new_n64_), .O(z13));
  nand3  g32(.a(x08), .b(x06), .c(x01), .O(new_n66_));
  oai21  g33(.a(new_n48_), .b(x08), .c(new_n66_), .O(z14));
  oai21  g34(.a(x07), .b(new_n35_), .c(x08), .O(new_n68_));
