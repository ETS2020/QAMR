...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n39_, new_n41_, new_n43_, new_n45_, new_n46_, new_n48_,
  ...
  nand2  g15(.a(x10), .b(new_n48_), .O(new_n49_));
  nand3  g16(.a(new_n45_), .b(x08), .c(x01), .O(new_n50_));
  nand2  g17(.a(new_n50_), .b(new_n49_), .O(z09));
  nand2  g18(.a(x11), .b(new_n48_), .O(new_n52_));
  nand3  g19(.a(new_n45_), .b(x08), .c(x02), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n52_), .O(z10));
  nand2  g21(.a(x12), .b(new_n48_), .O(new_n55_));
  nand3  g22(.a(new_n45_), .b(x08), .c(x03), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z11));
  oai21  g24(.a(x09), .b(x04), .c(x08), .O(new_n58_));
  nand2  g25(.a(x13), .b(new_n48_), .O(new_n59_));
  ...
  nand2  g30(.a(x15), .b(new_n48_), .O(new_n64_));
  nand3  g31(.a(new_n45_), .b(x08), .c(x06), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z14));
  nand2  g33(.a(x16), .b(new_n48_), .O(new_n67_));
  nand3  g34(.a(new_n45_), .b(x08), .c(x07), .O(new_n68_));
