...
module FAU ( 
  ...
  aoi21  g26(.a(x08), .b(new_n39_), .c(x11), .O(new_n60_));
  ...
  oai21  g32(.a(new_n35_), .b(x08), .c(x04), .O(new_n66_));
  oai21  g33(.a(new_n44_), .b(x08), .c(new_n66_), .O(z12));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  nand2  g35(.a(x14), .b(new_n53_), .O(new_n69_));
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n40_), .O(z13));
