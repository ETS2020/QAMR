// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:10 2020
...
module FAU ( 
  ...
  nor2   g01(.a(x11), .b(x03), .O(new_n35_));
  ...
  nand2  g24(.a(x11), .b(x08), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  nand2  g27(.a(x11), .b(new_n50_), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n59_), .O(z10));
  oai21  g29(.a(x12), .b(x08), .c(x03), .O(new_n63_));
  nand3  g30(.a(x12), .b(x11), .c(new_n50_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z11));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand2  g33(.a(x13), .b(new_n50_), .O(new_n67_));
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n35_), .O(z12));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  nand2  g36(.a(x14), .b(new_n50_), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n35_), .O(z13));
