...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n38_, new_n39_, new_n41_, new_n43_, new_n44_,
  ...
  nor2   g10(.a(new_n35_), .b(x09), .O(new_n44_));
  ...
  oai21  g19(.a(x10), .b(x09), .c(new_n52_), .O(new_n53_));
  nand2  g20(.a(x08), .b(x00), .O(new_n54_));
  nand3  g21(.a(new_n54_), .b(new_n53_), .c(new_n39_), .O(z08));
  oai21  g22(.a(new_n34_), .b(new_n52_), .c(x10), .O(new_n56_));
  ...
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n44_), .O(z14));
