// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:46 2020
...
module FAU ( 
  ...
  nand2  g26(.a(x11), .b(x08), .O(new_n60_));
  oai22  g27(.a(new_n60_), .b(new_n59_), .c(new_n40_), .d(x08), .O(z11));
  ...
  oai22  g35(.a(new_n60_), .b(new_n68_), .c(new_n46_), .d(x08), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  oai22  g37(.a(new_n60_), .b(new_n70_), .c(new_n48_), .d(x08), .O(z15));
  buf    g38(.a(x11), .O(z02));
endmodule
