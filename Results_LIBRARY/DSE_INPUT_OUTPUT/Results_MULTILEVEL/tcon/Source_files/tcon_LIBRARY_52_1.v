...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n57_, new_n59_, new_n61_, new_n63_, new_n64_, new_n67_, new_n68_,
    new_n70_, new_n71_;
  ...
  oai22  g28(.a(new_n53_), .b(new_n61_), .c(new_n42_), .d(x08), .O(z11));
  oai21  g29(.a(new_n34_), .b(x04), .c(x08), .O(new_n63_));
  nand2  g30(.a(x13), .b(new_n56_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z12));
  oai21  g32(.a(new_n46_), .b(x08), .c(new_n53_), .O(z13));
