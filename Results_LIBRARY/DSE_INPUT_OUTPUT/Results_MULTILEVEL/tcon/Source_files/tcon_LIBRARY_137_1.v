...
module FAU ( 
  ...
  nand3  g21(.a(new_n54_), .b(x10), .c(new_n35_), .O(new_n55_));
  ...
  nand3  g26(.a(x12), .b(new_n54_), .c(new_n35_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z11));
  nand2  g28(.a(x08), .b(x04), .O(new_n62_));
  nand3  g29(.a(x13), .b(new_n54_), .c(new_n35_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  nand3  g32(.a(x14), .b(new_n54_), .c(new_n35_), .O(new_n66_));
  ...
  nand3  g38(.a(x16), .b(new_n54_), .c(new_n35_), .O(new_n72_));
