...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n48_, new_n49_, new_n51_, new_n52_, new_n53_, new_n55_,
  ...
  nand2  g09(.a(new_n42_), .b(new_n35_), .O(z04));
  ...
  nand2  g15(.a(new_n42_), .b(x09), .O(new_n49_));
  nand2  g16(.a(new_n49_), .b(new_n48_), .O(z07));
  nand3  g17(.a(new_n49_), .b(x08), .c(x00), .O(new_n51_));
  inv1   g18(.a(x08), .O(new_n52_));
  nand3  g19(.a(x13), .b(x09), .c(new_n52_), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n51_), .O(z08));
  nand3  g21(.a(new_n49_), .b(x08), .c(x01), .O(new_n55_));
  nand2  g22(.a(new_n42_), .b(x09), .O(new_n56_));
  nand3  g23(.a(new_n56_), .b(x10), .c(new_n52_), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n55_), .O(z09));
  nand2  g25(.a(x11), .b(new_n52_), .O(new_n59_));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n49_), .O(z10));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand2  g29(.a(x12), .b(new_n52_), .O(new_n63_));
  aoi21  g30(.a(new_n63_), .b(new_n62_), .c(new_n36_), .O(z11));
  nand2  g31(.a(z04), .b(new_n52_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n49_), .O(z12));
  ...
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n49_), .O(z14));
  nand2  g40(.a(x16), .b(new_n52_), .O(new_n74_));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n49_), .O(z15));
  buf    g43(.a(x09), .O(z00));
endmodule
