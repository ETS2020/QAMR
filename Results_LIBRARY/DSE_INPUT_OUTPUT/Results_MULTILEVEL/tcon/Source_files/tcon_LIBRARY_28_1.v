...
module FAU ( 
  ...
  oai21  g16(.a(new_n35_), .b(x04), .c(new_n49_), .O(z06));
  and2   g17(.a(x16), .b(x04), .O(z07));
  ...
  nand3  g32(.a(new_n35_), .b(x13), .c(new_n53_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z12));
  nand2  g34(.a(x14), .b(new_n53_), .O(new_n68_));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n37_), .O(z13));
  nand2  g37(.a(x15), .b(new_n53_), .O(new_n71_));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n37_), .O(z14));
  nand2  g40(.a(x08), .b(x07), .O(new_n74_));
  oai21  g41(.a(new_n35_), .b(x08), .c(new_n74_), .O(new_n75_));
  nand2  g42(.a(new_n75_), .b(x04), .O(new_n76_));
  nand3  g43(.a(new_n35_), .b(x08), .c(x07), .O(new_n77_));
  nand2  g44(.a(new_n77_), .b(new_n76_), .O(z15));
endmodule
