...
module FAU ( 
  ...
  aoi21  g02(.a(new_n34_), .b(x01), .c(new_n35_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nand2  g04(.a(new_n34_), .b(x01), .O(new_n38_));
  ...
  aoi21  g11(.a(new_n34_), .b(x01), .c(new_n44_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  aoi21  g13(.a(new_n34_), .b(x01), .c(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  aoi21  g15(.a(new_n34_), .b(x01), .c(new_n48_), .O(z06));
