...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n45_, new_n46_, new_n48_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  nor2   g16(.a(new_n35_), .b(new_n45_), .O(z06));
  nand2  g17(.a(new_n35_), .b(new_n45_), .O(z07));
  ...
  aoi21  g41(.a(new_n45_), .b(x08), .c(x16), .O(new_n75_));
