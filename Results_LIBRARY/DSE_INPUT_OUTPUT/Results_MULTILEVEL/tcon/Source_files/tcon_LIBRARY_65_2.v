...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n43_, new_n44_,
  ...
  aoi21  g02(.a(new_n35_), .b(x10), .c(new_n34_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nor2   g04(.a(new_n35_), .b(new_n37_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  nand2  g06(.a(new_n35_), .b(x10), .O(new_n40_));
  nand2  g07(.a(new_n40_), .b(new_n39_), .O(z02));
  nand2  g08(.a(new_n35_), .b(new_n37_), .O(z03));
  inv1   g09(.a(x13), .O(new_n43_));
  nor2   g10(.a(x12), .b(new_n37_), .O(new_n44_));
  nor2   g11(.a(new_n44_), .b(new_n43_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  nor2   g13(.a(new_n44_), .b(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nor2   g15(.a(new_n44_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nor2   g17(.a(new_n44_), .b(new_n50_), .O(z07));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  inv1   g19(.a(x08), .O(new_n53_));
  nand2  g20(.a(x09), .b(new_n53_), .O(new_n54_));
  aoi21  g21(.a(new_n54_), .b(new_n52_), .c(new_n44_), .O(z08));
  oai21  g22(.a(new_n35_), .b(new_n53_), .c(x10), .O(new_n56_));
  ...
  aoi21  g27(.a(new_n60_), .b(new_n59_), .c(new_n44_), .O(z10));
  oai21  g28(.a(x12), .b(x10), .c(new_n53_), .O(new_n62_));
  ...
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n44_), .O(z12));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  nand2  g35(.a(x14), .b(new_n53_), .O(new_n69_));
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n44_), .O(z13));
  ...
  aoi21  g42(.a(new_n75_), .b(new_n74_), .c(new_n44_), .O(z15));
endmodule
