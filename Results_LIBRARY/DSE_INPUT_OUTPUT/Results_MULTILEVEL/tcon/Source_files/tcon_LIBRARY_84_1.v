...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n43_, new_n44_,
  ...
  nor2   g04(.a(new_n35_), .b(x09), .O(new_n38_));
  nor2   g05(.a(new_n38_), .b(new_n37_), .O(z01));
  inv1   g06(.a(x11), .O(new_n40_));
  oai21  g07(.a(new_n35_), .b(x09), .c(new_n40_), .O(z02));
  nor2   g08(.a(new_n35_), .b(new_n34_), .O(z03));
  inv1   g09(.a(x13), .O(new_n43_));
  nand2  g10(.a(x12), .b(new_n34_), .O(new_n44_));
  nand2  g11(.a(new_n44_), .b(new_n43_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  nand2  g13(.a(new_n44_), .b(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nor2   g15(.a(new_n38_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nor2   g17(.a(new_n38_), .b(new_n50_), .O(z07));
  ...
  nand3  g25(.a(new_n44_), .b(x08), .c(x02), .O(new_n59_));
  ...
  nand3  g29(.a(new_n44_), .b(x08), .c(x03), .O(new_n63_));
  nand3  g30(.a(x12), .b(x09), .c(new_n52_), .O(new_n64_));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n38_), .O(z13));
  ...
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n44_), .O(z15));
endmodule
