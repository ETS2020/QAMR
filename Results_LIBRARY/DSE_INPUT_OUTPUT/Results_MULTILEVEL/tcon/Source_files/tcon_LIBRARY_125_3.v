...
module FAU ( 
  ...
  and2   g13(.a(new_n34_), .b(x15), .O(z06));
  and2   g14(.a(new_n34_), .b(x16), .O(z07));
  and2   g15(.a(x12), .b(x03), .O(new_n49_));
  ...
  nand2  g23(.a(x12), .b(x03), .O(new_n57_));
  nand3  g24(.a(new_n57_), .b(x08), .c(x02), .O(new_n58_));
  nand2  g25(.a(x12), .b(x03), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(x11), .c(new_n51_), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n58_), .c(new_n34_), .O(z10));
  nand3  g28(.a(new_n40_), .b(x08), .c(x03), .O(new_n62_));
  nand3  g29(.a(x12), .b(new_n51_), .c(new_n38_), .O(new_n63_));
  ...
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n49_), .O(z13));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand2  g38(.a(x15), .b(new_n51_), .O(new_n72_));
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n49_), .O(z14));
