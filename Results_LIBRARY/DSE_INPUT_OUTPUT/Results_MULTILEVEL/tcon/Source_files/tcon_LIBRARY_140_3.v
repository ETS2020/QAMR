...
module FAU ( 
  ...
  nand2  g07(.a(x14), .b(x07), .O(new_n41_));
  and2   g08(.a(new_n41_), .b(x13), .O(z04));
  ...
  and2   g14(.a(x14), .b(x07), .O(new_n48_));
  ...
  nand3  g29(.a(new_n41_), .b(x13), .c(new_n50_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z12));
  nand3  g31(.a(new_n35_), .b(x08), .c(x05), .O(new_n65_));
  inv1   g32(.a(x07), .O(new_n66_));
  nand3  g33(.a(x14), .b(new_n50_), .c(new_n66_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n65_), .O(z13));
  nand2  g35(.a(x14), .b(x07), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(x08), .c(x06), .O(new_n70_));
  nand3  g37(.a(new_n35_), .b(x15), .c(new_n50_), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n70_), .O(z14));
  nand3  g39(.a(new_n35_), .b(x16), .c(new_n50_), .O(new_n73_));
