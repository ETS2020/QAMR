...
module FAU ( 
  ...
  aoi21  g07(.a(x15), .b(x11), .c(new_n40_), .O(z03));
  and2   g08(.a(new_n34_), .b(x13), .O(z04));
  and2   g09(.a(new_n34_), .b(x14), .O(z05));
  inv1   g10(.a(x15), .O(new_n44_));
  nor2   g11(.a(new_n44_), .b(x11), .O(z06));
  nand2  g12(.a(x15), .b(x11), .O(new_n46_));
  and2   g13(.a(new_n46_), .b(x16), .O(z07));
  and2   g14(.a(x15), .b(x11), .O(new_n48_));
  ...
  nand3  g23(.a(new_n44_), .b(x11), .c(new_n50_), .O(new_n57_));
  ...
  nand3  g35(.a(x15), .b(new_n38_), .c(new_n50_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z14));
  nand3  g37(.a(new_n34_), .b(x08), .c(x07), .O(new_n71_));
  nand3  g38(.a(new_n46_), .b(x16), .c(new_n50_), .O(new_n72_));
