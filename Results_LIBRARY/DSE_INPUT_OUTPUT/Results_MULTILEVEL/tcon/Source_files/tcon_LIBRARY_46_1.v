// Benchmark "FAU" written by ABC on Fri Aug 14 01:49:48 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n42_, new_n43_,
    new_n45_, new_n47_, new_n50_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  nor2   g09(.a(new_n35_), .b(x09), .O(new_n43_));
  ...
  nor2   g15(.a(new_n35_), .b(new_n34_), .O(z06));
  nand2  g16(.a(x15), .b(new_n34_), .O(new_n50_));
  and2   g17(.a(new_n50_), .b(x16), .O(z07));
  ...
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n38_), .O(z09));
  ...
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n38_), .O(z11));
  nand2  g31(.a(x08), .b(x04), .O(new_n65_));
  nand2  g32(.a(x13), .b(new_n52_), .O(new_n66_));
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n43_), .O(z12));
  nand2  g34(.a(x14), .b(new_n52_), .O(new_n68_));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n38_), .O(z13));
  nand3  g37(.a(new_n38_), .b(x08), .c(x06), .O(new_n71_));
  nand3  g38(.a(x15), .b(x09), .c(new_n52_), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n71_), .O(z14));
  nand3  g40(.a(new_n38_), .b(x08), .c(x07), .O(new_n74_));
  nand3  g41(.a(new_n50_), .b(x16), .c(new_n52_), .O(new_n75_));
