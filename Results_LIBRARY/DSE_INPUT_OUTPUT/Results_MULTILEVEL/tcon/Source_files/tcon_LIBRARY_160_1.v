...
module FAU ( 
  ...
  aoi21  g13(.a(x09), .b(new_n34_), .c(new_n46_), .O(z05));
  ...
  nand2  g19(.a(new_n52_), .b(new_n40_), .O(z08));
  nor2   g20(.a(x10), .b(x09), .O(new_n54_));
  ...
  nand3  g27(.a(x12), .b(new_n35_), .c(new_n34_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z11));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  nand3  g30(.a(x13), .b(new_n35_), .c(new_n34_), .O(new_n64_));
