...
module FAU ( 
  ...
  nand2  g23(.a(x08), .b(x07), .O(new_n57_));
  ...
  oai22  g28(.a(new_n57_), .b(new_n61_), .c(new_n42_), .d(x08), .O(z11));
  inv1   g29(.a(x04), .O(new_n63_));
  oai22  g30(.a(new_n57_), .b(new_n63_), .c(new_n44_), .d(x08), .O(z12));
  ...
  oai22  g35(.a(new_n57_), .b(new_n68_), .c(new_n48_), .d(x08), .O(z14));
  oai21  g36(.a(new_n50_), .b(x08), .c(new_n57_), .O(z15));
endmodule
