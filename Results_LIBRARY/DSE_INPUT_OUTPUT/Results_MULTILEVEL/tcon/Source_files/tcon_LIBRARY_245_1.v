...
module FAU ( 
  ...
  nor2   g10(.a(new_n43_), .b(x10), .O(new_n44_));
  nor2   g11(.a(new_n44_), .b(new_n42_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  nand2  g13(.a(new_n36_), .b(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  oai21  g15(.a(new_n43_), .b(x10), .c(new_n48_), .O(z06));
  nor2   g16(.a(new_n43_), .b(new_n35_), .O(z07));
  nand2  g17(.a(x08), .b(x00), .O(new_n51_));
  inv1   g18(.a(x08), .O(new_n52_));
  nand2  g19(.a(x09), .b(new_n52_), .O(new_n53_));
  aoi21  g20(.a(new_n53_), .b(new_n51_), .c(new_n44_), .O(z08));
  oai21  g21(.a(x16), .b(x10), .c(new_n52_), .O(new_n55_));
  ...
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n44_), .O(z10));
  ...
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n44_), .O(z12));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n36_), .O(z14));
  oai21  g39(.a(new_n35_), .b(new_n52_), .c(x16), .O(new_n73_));
