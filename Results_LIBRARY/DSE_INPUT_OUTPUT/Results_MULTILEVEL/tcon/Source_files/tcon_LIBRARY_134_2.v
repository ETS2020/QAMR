...
module FAU ( 
  ...
  aoi21  g07(.a(new_n34_), .b(x07), .c(new_n40_), .O(z02));
  ...
  nand3  g38(.a(x15), .b(new_n34_), .c(new_n62_), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n71_), .O(z14));
  nand2  g40(.a(x08), .b(x07), .O(new_n74_));
  nand3  g41(.a(x16), .b(new_n34_), .c(new_n62_), .O(new_n75_));
