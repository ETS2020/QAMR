...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n39_, new_n42_, new_n44_,
  ...
  oai21  g06(.a(new_n39_), .b(new_n37_), .c(new_n38_), .O(z02));
  ...
  oai21  g17(.a(x12), .b(new_n50_), .c(x09), .O(new_n51_));
  ...
  and2   g32(.a(x12), .b(x09), .O(new_n66_));
  nand2  g33(.a(x08), .b(x05), .O(new_n67_));
  nand2  g34(.a(x14), .b(new_n50_), .O(new_n68_));
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(z13));
  ...
  aoi21  g41(.a(new_n74_), .b(new_n73_), .c(new_n66_), .O(z15));
  buf    g42(.a(x09), .O(z00));
endmodule
