...
module FAU ( 
  ...
  aoi21  g10(.a(x14), .b(new_n42_), .c(new_n43_), .O(z04));
  nor2   g11(.a(new_n35_), .b(new_n42_), .O(z05));
  inv1   g12(.a(x15), .O(new_n46_));
  nand2  g13(.a(x14), .b(new_n42_), .O(new_n47_));
  ...
  nand3  g20(.a(new_n53_), .b(new_n52_), .c(new_n47_), .O(z08));
  ...
  aoi21  g28(.a(new_n35_), .b(x08), .c(x12), .O(new_n62_));
  ...
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n47_), .O(z12));
  nand3  g34(.a(new_n47_), .b(x08), .c(x05), .O(new_n68_));
  nand3  g35(.a(x14), .b(x12), .c(new_n51_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z13));
  nand2  g37(.a(x15), .b(new_n51_), .O(new_n71_));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n47_), .O(z14));
