...
module FAU ( 
  ...
  nand2  g01(.a(x16), .b(x06), .O(new_n35_));
  ...
  and2   g15(.a(x16), .b(x06), .O(new_n49_));
  ...
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n49_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  nand2  g27(.a(x12), .b(new_n51_), .O(new_n61_));
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(z11));
  ...
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n49_), .O(z13));
  oai21  g35(.a(x16), .b(x08), .c(x06), .O(new_n69_));
  oai21  g36(.a(new_n47_), .b(x08), .c(new_n69_), .O(z14));
  oai21  g37(.a(new_n51_), .b(x06), .c(x16), .O(new_n71_));
