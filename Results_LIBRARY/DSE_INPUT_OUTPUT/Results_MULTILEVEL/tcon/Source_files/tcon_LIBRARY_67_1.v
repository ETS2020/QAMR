...
module FAU ( 
  ...
  nand3  g20(.a(x10), .b(new_n53_), .c(new_n35_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n52_), .O(z09));
  nor2   g22(.a(x11), .b(x09), .O(new_n56_));
  ...
  nor2   g28(.a(x13), .b(x09), .O(new_n62_));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  oai21  g30(.a(new_n62_), .b(x08), .c(new_n63_), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  nand3  g32(.a(x14), .b(new_n53_), .c(new_n35_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z13));
  nand2  g34(.a(x08), .b(x06), .O(new_n68_));
  nand3  g35(.a(x15), .b(new_n53_), .c(new_n35_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z14));
  nand2  g37(.a(x08), .b(x07), .O(new_n71_));
  nand3  g38(.a(x16), .b(new_n53_), .c(new_n35_), .O(new_n72_));
