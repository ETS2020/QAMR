...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n39_, new_n41_, new_n43_, new_n44_, new_n47_, new_n48_,
  ...
  nor2   g06(.a(x16), .b(new_n39_), .O(z04));
  nand2  g07(.a(x16), .b(x13), .O(new_n41_));
  and2   g08(.a(new_n41_), .b(x14), .O(z05));
  inv1   g09(.a(x15), .O(new_n43_));
  inv1   g10(.a(x16), .O(new_n44_));
  oai21  g11(.a(new_n44_), .b(new_n39_), .c(new_n43_), .O(z06));
  nor2   g12(.a(new_n44_), .b(x13), .O(z07));
