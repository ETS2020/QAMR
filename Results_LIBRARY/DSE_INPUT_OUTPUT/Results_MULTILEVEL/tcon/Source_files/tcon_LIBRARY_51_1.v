...
module FAU ( 
  ...
  nand2  g01(.a(x10), .b(new_n34_), .O(new_n35_));
  ...
  nor2   g09(.a(new_n37_), .b(x03), .O(new_n43_));
  ...
  nand3  g19(.a(new_n40_), .b(x08), .c(x00), .O(new_n53_));
  inv1   g20(.a(x08), .O(new_n54_));
  nand3  g21(.a(new_n35_), .b(x09), .c(new_n54_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n53_), .O(z08));
  nand3  g23(.a(new_n40_), .b(x08), .c(x01), .O(new_n57_));
  nand3  g24(.a(x10), .b(new_n54_), .c(x03), .O(new_n58_));
  ...
  aoi21  g43(.a(new_n76_), .b(new_n75_), .c(new_n43_), .O(z15));
endmodule
