...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n38_, new_n39_, new_n40_, new_n42_, new_n45_,
  ...
  nand2  g08(.a(x12), .b(new_n38_), .O(new_n42_));
  ...
  nand2  g23(.a(x11), .b(new_n38_), .O(new_n57_));
  nand3  g24(.a(new_n40_), .b(x08), .c(x02), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z10));
  nand3  g26(.a(new_n40_), .b(x08), .c(x03), .O(new_n60_));
  ...
  oai21  g37(.a(x12), .b(x07), .c(x08), .O(new_n71_));
