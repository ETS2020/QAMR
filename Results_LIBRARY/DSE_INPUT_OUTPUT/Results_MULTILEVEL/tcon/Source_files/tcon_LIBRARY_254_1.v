...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n42_, new_n44_,
    ...
    new_n57_, new_n59_, new_n60_, new_n62_, new_n65_, new_n66_, new_n68_,
    new_n69_, new_n71_;
  ...
  oai22  g24(.a(new_n57_), .b(new_n56_), .c(new_n37_), .d(x08), .O(z09));
  ...
  oai22  g29(.a(new_n57_), .b(new_n62_), .c(new_n42_), .d(x08), .O(z11));
  ...
  oai21  g34(.a(x06), .b(new_n34_), .c(x08), .O(new_n68_));
  nand2  g35(.a(x15), .b(new_n53_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z14));
  nand3  g37(.a(x08), .b(x07), .c(x04), .O(new_n71_));
