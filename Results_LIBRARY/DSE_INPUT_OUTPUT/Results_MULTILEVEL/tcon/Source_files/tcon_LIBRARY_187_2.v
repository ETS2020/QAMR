...
module FAU ( 
  ...
  aoi21  g02(.a(new_n34_), .b(x07), .c(new_n35_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  aoi21  g04(.a(new_n34_), .b(x07), .c(new_n37_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  nand2  g06(.a(new_n34_), .b(x07), .O(new_n40_));
  nand2  g07(.a(new_n40_), .b(new_n39_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  aoi21  g09(.a(new_n34_), .b(x07), .c(new_n42_), .O(z03));
  inv1   g10(.a(x13), .O(new_n44_));
  aoi21  g11(.a(new_n34_), .b(x07), .c(new_n44_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  nand2  g13(.a(new_n40_), .b(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  aoi21  g15(.a(new_n34_), .b(x07), .c(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nand2  g17(.a(new_n40_), .b(new_n50_), .O(z07));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  inv1   g19(.a(x07), .O(new_n53_));
  nand3  g20(.a(x09), .b(new_n34_), .c(new_n53_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n52_), .O(z08));
  nor2   g22(.a(x10), .b(x07), .O(new_n56_));
  nand2  g23(.a(x08), .b(x01), .O(new_n57_));
  oai21  g24(.a(new_n56_), .b(x08), .c(new_n57_), .O(z09));
  nand2  g25(.a(x08), .b(x02), .O(new_n59_));
  nand3  g26(.a(x11), .b(new_n34_), .c(new_n53_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z10));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand3  g29(.a(x12), .b(new_n34_), .c(new_n53_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z11));
  nand2  g31(.a(x08), .b(x04), .O(new_n65_));
  nand3  g32(.a(x13), .b(new_n34_), .c(new_n53_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z12));
  nor2   g34(.a(x14), .b(x07), .O(new_n68_));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  oai21  g36(.a(new_n68_), .b(x08), .c(new_n69_), .O(z13));
  nor2   g37(.a(x15), .b(x07), .O(new_n71_));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  oai21  g39(.a(new_n71_), .b(x08), .c(new_n72_), .O(z14));
  oai21  g40(.a(new_n50_), .b(x08), .c(new_n53_), .O(z15));
endmodule
