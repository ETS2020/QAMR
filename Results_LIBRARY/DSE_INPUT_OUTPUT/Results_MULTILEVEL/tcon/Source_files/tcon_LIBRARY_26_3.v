...
module FAU ( 
  ...
  nand2  g04(.a(x16), .b(x12), .O(new_n38_));
  ...
  and2   g13(.a(x16), .b(x12), .O(new_n47_));
  ...
  nand3  g22(.a(new_n38_), .b(x11), .c(new_n49_), .O(new_n56_));
  ...
  oai21  g37(.a(x12), .b(new_n49_), .c(x16), .O(new_n71_));
