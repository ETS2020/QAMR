...
module FAU ( 
  ...
  aoi21  g05(.a(x09), .b(x08), .c(new_n38_), .O(z02));
  inv1   g06(.a(x12), .O(new_n40_));
  aoi21  g07(.a(x09), .b(x08), .c(new_n40_), .O(z03));
  inv1   g08(.a(x13), .O(new_n42_));
  aoi21  g09(.a(x09), .b(x08), .c(new_n42_), .O(z04));
  inv1   g10(.a(x14), .O(new_n44_));
  aoi21  g11(.a(x09), .b(x08), .c(new_n44_), .O(z05));
  inv1   g12(.a(x15), .O(new_n46_));
  aoi21  g13(.a(x09), .b(x08), .c(new_n46_), .O(z06));
  inv1   g14(.a(x16), .O(new_n48_));
  aoi21  g15(.a(x09), .b(x08), .c(new_n48_), .O(z07));
  ...
  nand3  g20(.a(new_n34_), .b(x08), .c(x01), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n53_), .O(z09));
  nand2  g22(.a(x11), .b(new_n52_), .O(new_n56_));
  nand3  g23(.a(new_n34_), .b(x08), .c(x02), .O(new_n57_));
