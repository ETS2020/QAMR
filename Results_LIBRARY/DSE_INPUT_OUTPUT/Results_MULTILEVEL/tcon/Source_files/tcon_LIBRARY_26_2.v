...
module FAU ( 
  ...
  nand2  g08(.a(new_n35_), .b(x12), .O(new_n42_));
  and2   g09(.a(new_n42_), .b(x11), .O(z02));
  ...
  nand3  g26(.a(new_n42_), .b(x11), .c(new_n53_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z10));
  nand3  g28(.a(new_n36_), .b(x08), .c(x03), .O(new_n62_));
  nand3  g29(.a(x16), .b(x12), .c(new_n53_), .O(new_n63_));
