// Benchmark "FAU" written by ABC on Fri Aug 14 01:49:56 2020
...
module FAU ( 
  ...
  nor2   g13(.a(new_n35_), .b(x09), .O(new_n47_));
  nor2   g14(.a(new_n47_), .b(new_n46_), .O(z05));
  nand2  g15(.a(x16), .b(new_n34_), .O(new_n49_));
  and2   g16(.a(new_n49_), .b(x15), .O(z06));
  nor2   g17(.a(new_n35_), .b(new_n34_), .O(z07));
  ...
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n38_), .O(z09));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  nand2  g27(.a(x11), .b(new_n54_), .O(new_n61_));
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n47_), .O(z10));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand2  g30(.a(x12), .b(new_n54_), .O(new_n64_));
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n47_), .O(z11));
  nand2  g32(.a(x13), .b(new_n54_), .O(new_n66_));
  nand2  g33(.a(x08), .b(x04), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n38_), .O(z12));
  nand2  g35(.a(x14), .b(new_n54_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x05), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n38_), .O(z13));
  nand3  g38(.a(new_n38_), .b(x08), .c(x06), .O(new_n72_));
  nand3  g39(.a(new_n49_), .b(x15), .c(new_n54_), .O(new_n73_));
  nand2  g40(.a(new_n73_), .b(new_n72_), .O(z14));
  nand3  g41(.a(new_n38_), .b(x08), .c(x07), .O(new_n75_));
  nand3  g42(.a(x16), .b(x09), .c(new_n54_), .O(new_n76_));
