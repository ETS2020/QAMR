...
module FAU ( 
  ...
  nand2  g14(.a(new_n47_), .b(x12), .O(new_n48_));
  ...
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n48_), .O(z10));
  nand3  g26(.a(new_n48_), .b(x08), .c(x03), .O(new_n60_));
  nand3  g27(.a(x14), .b(x12), .c(new_n51_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z11));
  nand2  g29(.a(x13), .b(new_n51_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n48_), .O(z12));
  nand2  g32(.a(x14), .b(new_n51_), .O(new_n66_));
  nand2  g33(.a(x08), .b(x05), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n48_), .O(z13));
  nand2  g35(.a(x15), .b(new_n51_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n48_), .O(z14));
  nand2  g38(.a(x16), .b(new_n51_), .O(new_n72_));
  nand2  g39(.a(x08), .b(x07), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n48_), .O(z15));
  buf    g41(.a(x12), .O(z03));
  buf    g42(.a(x14), .O(z05));
endmodule
