...
module FAU ( 
  ...
  nand2  g38(.a(new_n35_), .b(x07), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(x08), .c(x06), .O(new_n73_));
  nand3  g40(.a(new_n36_), .b(x15), .c(new_n53_), .O(new_n74_));
  nand2  g41(.a(new_n74_), .b(new_n73_), .O(z14));
  nand3  g42(.a(new_n36_), .b(x16), .c(new_n53_), .O(new_n76_));
  nand3  g43(.a(x14), .b(x08), .c(x07), .O(new_n77_));
