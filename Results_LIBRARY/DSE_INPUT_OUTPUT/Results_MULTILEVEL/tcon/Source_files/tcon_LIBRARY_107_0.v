...
module FAU ( 
  ...
  aoi21  g19(.a(x15), .b(x08), .c(x09), .O(new_n53_));
  ...
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n46_), .O(z10));
  ...
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n37_), .O(z12));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  nand2  g36(.a(x14), .b(new_n54_), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n37_), .O(z13));
  inv1   g38(.a(x06), .O(new_n72_));
  aoi21  g39(.a(x09), .b(x08), .c(x15), .O(new_n73_));
  ...
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n46_), .O(z15));
endmodule
