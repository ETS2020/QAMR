...
module FAU ( 
  ...
  aoi21  g02(.a(new_n34_), .b(x03), .c(new_n35_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nand2  g04(.a(new_n34_), .b(x03), .O(new_n38_));
  ...
  aoi21  g13(.a(new_n34_), .b(x03), .c(new_n46_), .O(z05));
  ...
  nor2   g29(.a(x13), .b(x03), .O(new_n63_));
