...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n46_, new_n47_,
  ...
  oai21  g12(.a(x13), .b(x00), .c(x08), .O(new_n46_));
  ...
  oai21  g19(.a(x13), .b(x02), .c(x08), .O(new_n53_));
  nand2  g20(.a(x11), .b(new_n47_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n53_), .O(z10));
  oai21  g22(.a(x13), .b(x03), .c(x08), .O(new_n56_));
