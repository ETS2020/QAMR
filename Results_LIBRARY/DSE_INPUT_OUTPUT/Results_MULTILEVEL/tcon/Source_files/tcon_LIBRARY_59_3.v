...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n39_, new_n43_, new_n44_, new_n46_, new_n47_,
  ...
  inv1   g11(.a(new_n44_), .O(z06));
  inv1   g12(.a(x15), .O(new_n46_));
  inv1   g13(.a(x16), .O(new_n47_));
  oai21  g14(.a(new_n46_), .b(new_n43_), .c(new_n47_), .O(z07));
  nand2  g15(.a(x09), .b(new_n43_), .O(new_n49_));
  nand3  g16(.a(new_n46_), .b(x08), .c(x00), .O(new_n50_));
  nand2  g17(.a(new_n50_), .b(new_n49_), .O(z08));
  oai21  g18(.a(x15), .b(x01), .c(x08), .O(new_n52_));
  nand2  g19(.a(x10), .b(new_n43_), .O(new_n53_));
  ...
  nand2  g25(.a(x12), .b(new_n43_), .O(new_n59_));
  ...
  nand3  g31(.a(new_n46_), .b(x08), .c(x05), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z13));
  nand3  g33(.a(new_n46_), .b(x08), .c(x06), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n44_), .O(z14));
  nand2  g35(.a(x16), .b(new_n43_), .O(new_n69_));
