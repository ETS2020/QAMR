...
module FAU ( 
  ...
  nand2  g10(.a(new_n35_), .b(new_n39_), .O(z03));
  inv1   g11(.a(x13), .O(new_n45_));
  oai21  g12(.a(new_n35_), .b(x12), .c(new_n45_), .O(z04));
  nor2   g13(.a(new_n35_), .b(new_n39_), .O(z05));
  ...
  oai21  g34(.a(new_n39_), .b(new_n53_), .c(x14), .O(new_n68_));
