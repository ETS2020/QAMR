...
module FAU ( 
  ...
  and2   g04(.a(x16), .b(x01), .O(new_n38_));
  ...
  aoi21  g22(.a(new_n55_), .b(new_n54_), .c(new_n38_), .O(z10));
  ...
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n38_), .O(z12));
  ...
  oai21  g35(.a(new_n48_), .b(x01), .c(x16), .O(new_n69_));
