...
module FAU ( 
  ...
  nor2   g09(.a(new_n40_), .b(x11), .O(new_n43_));
  nor2   g10(.a(new_n43_), .b(new_n42_), .O(z03));
  nor2   g11(.a(new_n40_), .b(new_n35_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  oai21  g13(.a(new_n40_), .b(x11), .c(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nor2   g15(.a(new_n43_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nor2   g17(.a(new_n43_), .b(new_n50_), .O(z07));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  inv1   g19(.a(x08), .O(new_n53_));
  nand2  g20(.a(x09), .b(new_n53_), .O(new_n54_));
  aoi21  g21(.a(new_n54_), .b(new_n52_), .c(new_n43_), .O(z08));
  ...
  aoi21  g26(.a(new_n40_), .b(x08), .c(x11), .O(new_n60_));
  ...
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n43_), .O(z11));
  nand3  g32(.a(new_n36_), .b(x08), .c(x04), .O(new_n66_));
  nand3  g33(.a(x13), .b(x11), .c(new_n53_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z12));
  nand3  g35(.a(new_n36_), .b(x08), .c(x05), .O(new_n69_));
  nand2  g36(.a(x13), .b(new_n35_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(x14), .c(new_n53_), .O(new_n71_));
