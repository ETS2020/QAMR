...
module FAU ( 
  ...
  nand2  g10(.a(x16), .b(x09), .O(new_n44_));
  and2   g11(.a(new_n44_), .b(x15), .O(z06));
  inv1   g12(.a(x16), .O(new_n46_));
  nor2   g13(.a(new_n46_), .b(x09), .O(z07));
  nand3  g14(.a(new_n35_), .b(x08), .c(x00), .O(new_n48_));
  inv1   g15(.a(x08), .O(new_n49_));
  nand3  g16(.a(new_n46_), .b(x09), .c(new_n49_), .O(new_n50_));
  ...
  and2   g21(.a(x16), .b(x09), .O(new_n55_));
