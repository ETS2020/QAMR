...
module FAU ( 
  ...
  nand2  g11(.a(x14), .b(new_n35_), .O(new_n45_));
  and2   g12(.a(new_n45_), .b(x13), .O(z04));
  nor2   g13(.a(new_n39_), .b(new_n35_), .O(z05));
  ...
  aoi21  g26(.a(new_n39_), .b(x08), .c(x11), .O(new_n60_));
  ...
  nand3  g33(.a(new_n45_), .b(x13), .c(new_n53_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z12));
  nand3  g35(.a(new_n36_), .b(x08), .c(x05), .O(new_n69_));
  nand3  g36(.a(x14), .b(x11), .c(new_n53_), .O(new_n70_));
