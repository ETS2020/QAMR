...
module FAU ( 
  ...
  nor2   g09(.a(new_n40_), .b(new_n42_), .O(z04));
  ...
  nand3  g20(.a(new_n36_), .b(x08), .c(x01), .O(new_n54_));
  nand3  g21(.a(x12), .b(x10), .c(new_n50_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z09));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  nand2  g24(.a(x11), .b(new_n50_), .O(new_n58_));
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n40_), .O(z10));
