...
module FAU ( 
  ...
  aoi21  g13(.a(new_n34_), .b(x02), .c(new_n46_), .O(z05));
  ...
  nand3  g27(.a(x12), .b(new_n34_), .c(new_n53_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z11));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  nand3  g30(.a(x13), .b(new_n34_), .c(new_n53_), .O(new_n64_));
  ...
  nand3  g36(.a(x15), .b(new_n34_), .c(new_n53_), .O(new_n70_));
