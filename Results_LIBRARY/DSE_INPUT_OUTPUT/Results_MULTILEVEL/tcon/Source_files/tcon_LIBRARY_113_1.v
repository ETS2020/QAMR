...
module FAU ( 
  ...
  nand2  g09(.a(x15), .b(new_n40_), .O(new_n43_));
  ...
  nor2   g15(.a(new_n35_), .b(new_n40_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  oai21  g17(.a(new_n35_), .b(x11), .c(new_n50_), .O(z07));
  ...
  oai21  g25(.a(x15), .b(x11), .c(new_n53_), .O(new_n59_));
  ...
  nand3  g37(.a(new_n43_), .b(x08), .c(x06), .O(new_n71_));
  nand3  g38(.a(x15), .b(x11), .c(new_n53_), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n71_), .O(z14));
  nand3  g40(.a(new_n43_), .b(x08), .c(x07), .O(new_n74_));
  nand2  g41(.a(x15), .b(new_n40_), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(x16), .c(new_n53_), .O(new_n76_));
  nand2  g43(.a(new_n76_), .b(new_n74_), .O(z15));
endmodule
