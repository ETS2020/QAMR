...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n41_, new_n43_, new_n44_, new_n45_, new_n46_,
  ...
  and2   g09(.a(x15), .b(x13), .O(new_n43_));
  ...
  nand2  g17(.a(x11), .b(new_n45_), .O(new_n51_));
  ...
  aoi21  g22(.a(new_n55_), .b(new_n54_), .c(new_n43_), .O(z11));
  oai21  g23(.a(x15), .b(new_n45_), .c(x13), .O(new_n57_));
  nand2  g24(.a(x08), .b(x04), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z12));
  nand2  g26(.a(x14), .b(new_n45_), .O(new_n60_));
  nand2  g27(.a(x08), .b(x05), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n34_), .O(z13));
  nand3  g29(.a(new_n34_), .b(x08), .c(x06), .O(new_n63_));
  inv1   g30(.a(x13), .O(new_n64_));
  nand3  g31(.a(x15), .b(new_n64_), .c(new_n45_), .O(new_n65_));
