...
module FAU ( 
  ...
  aoi21  g11(.a(x14), .b(new_n42_), .c(new_n44_), .O(z04));
  nor2   g12(.a(new_n35_), .b(new_n42_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  nor2   g14(.a(new_n36_), .b(new_n47_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  nand2  g16(.a(x14), .b(new_n42_), .O(new_n50_));
  ...
  oai21  g35(.a(new_n42_), .b(new_n53_), .c(x14), .O(new_n69_));
  ...
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n50_), .O(z15));
endmodule
