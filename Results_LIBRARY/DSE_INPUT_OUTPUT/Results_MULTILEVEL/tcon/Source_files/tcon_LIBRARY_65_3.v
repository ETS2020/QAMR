...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n39_, new_n45_, new_n46_, new_n47_,
  ...
  aoi21  g01(.a(x12), .b(x10), .c(new_n34_), .O(z00));
  ...
  and2   g07(.a(new_n39_), .b(x13), .O(z04));
  and2   g08(.a(new_n39_), .b(x14), .O(z05));
  and2   g09(.a(new_n39_), .b(x15), .O(z06));
  and2   g10(.a(new_n39_), .b(x16), .O(z07));
  and2   g11(.a(x12), .b(x10), .O(new_n45_));
  ...
  oai21  g16(.a(x12), .b(new_n47_), .c(x10), .O(new_n50_));
  ...
  oai21  g22(.a(x10), .b(new_n47_), .c(x12), .O(new_n56_));
  ...
  aoi21  g27(.a(new_n60_), .b(new_n59_), .c(new_n45_), .O(z12));
  ...
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n39_), .O(z14));
