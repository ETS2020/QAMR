...
module FAU ( 
  ...
  oai21  g02(.a(x11), .b(new_n35_), .c(new_n34_), .O(z00));
  inv1   g03(.a(x11), .O(new_n37_));
  nor2   g04(.a(new_n37_), .b(new_n35_), .O(z01));
  nand2  g05(.a(new_n37_), .b(new_n35_), .O(z02));
  inv1   g06(.a(x12), .O(new_n40_));
  nand2  g07(.a(new_n37_), .b(x10), .O(new_n41_));
  ...
  nor2   g12(.a(x11), .b(new_n35_), .O(new_n46_));
  nor2   g13(.a(new_n46_), .b(new_n45_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n41_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nor2   g17(.a(new_n46_), .b(new_n50_), .O(z07));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  inv1   g19(.a(x08), .O(new_n53_));
  nand2  g20(.a(x09), .b(new_n53_), .O(new_n54_));
  aoi21  g21(.a(new_n54_), .b(new_n52_), .c(new_n46_), .O(z08));
  oai21  g22(.a(new_n37_), .b(new_n53_), .c(x10), .O(new_n56_));
