...
module FAU ( 
  ...
  oai21  g16(.a(new_n49_), .b(x09), .c(new_n48_), .O(new_n50_));
  nand2  g17(.a(x08), .b(x00), .O(new_n51_));
  nand3  g18(.a(new_n51_), .b(new_n50_), .c(new_n36_), .O(z08));
  ...
  aoi21  g23(.a(x09), .b(x08), .c(x11), .O(new_n57_));
  oai22  g24(.a(new_n57_), .b(new_n56_), .c(new_n49_), .d(x08), .O(z10));
