// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:30 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n42_, new_n44_, new_n47_,
  ...
  nand2  g01(.a(x09), .b(x05), .O(new_n35_));
  ...
  oai21  g14(.a(new_n47_), .b(x05), .c(x09), .O(new_n48_));
  ...
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n35_), .O(z12));
  inv1   g29(.a(x09), .O(new_n63_));
  nand2  g30(.a(new_n42_), .b(new_n47_), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(x05), .O(new_n65_));
  inv1   g32(.a(x05), .O(new_n66_));
  nand3  g33(.a(x14), .b(new_n47_), .c(new_n66_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n65_), .O(z13));
  inv1   g35(.a(new_n35_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand2  g37(.a(x15), .b(new_n47_), .O(new_n71_));
  aoi21  g38(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(z14));
  nand2  g39(.a(x08), .b(x07), .O(new_n73_));
  nand2  g40(.a(x16), .b(new_n47_), .O(new_n74_));
  aoi21  g41(.a(new_n74_), .b(new_n73_), .c(new_n69_), .O(z15));
  buf    g42(.a(x09), .O(z00));
endmodule
