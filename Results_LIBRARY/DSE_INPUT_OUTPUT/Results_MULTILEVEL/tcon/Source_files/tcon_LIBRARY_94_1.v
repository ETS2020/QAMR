...
module FAU ( 
  ...
  nand2  g10(.a(x14), .b(new_n39_), .O(new_n44_));
  and2   g11(.a(new_n44_), .b(x13), .O(z04));
  ...
  nand3  g30(.a(new_n40_), .b(x08), .c(x04), .O(new_n64_));
  nand3  g31(.a(new_n44_), .b(x13), .c(new_n52_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z12));
  nand3  g33(.a(new_n40_), .b(x08), .c(x05), .O(new_n67_));
  nand3  g34(.a(x14), .b(x12), .c(new_n52_), .O(new_n68_));
