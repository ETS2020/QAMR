...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n39_, new_n42_, new_n45_, new_n47_,
  ...
  aoi21  g03(.a(x12), .b(x09), .c(new_n36_), .O(z01));
  inv1   g04(.a(x11), .O(new_n38_));
  inv1   g05(.a(x12), .O(new_n39_));
  oai21  g06(.a(new_n39_), .b(new_n34_), .c(new_n38_), .O(z02));
  nor2   g07(.a(new_n39_), .b(x09), .O(z03));
  nand2  g08(.a(x12), .b(x09), .O(new_n42_));
  and2   g09(.a(new_n42_), .b(x13), .O(z04));
  and2   g10(.a(new_n42_), .b(x14), .O(z05));
  inv1   g11(.a(x15), .O(new_n45_));
  nand2  g12(.a(new_n42_), .b(new_n45_), .O(z06));
  inv1   g13(.a(x16), .O(new_n47_));
  nand2  g14(.a(new_n42_), .b(new_n47_), .O(z07));
  inv1   g15(.a(x08), .O(new_n49_));
  oai21  g16(.a(x12), .b(new_n49_), .c(x09), .O(new_n50_));
  nand2  g17(.a(x08), .b(x00), .O(new_n51_));
  nand2  g18(.a(new_n51_), .b(new_n50_), .O(z08));
  and2   g19(.a(x12), .b(x09), .O(new_n53_));
  ...
  oai21  g26(.a(x09), .b(new_n49_), .c(x12), .O(new_n60_));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n53_), .O(z14));
  nand2  g38(.a(x08), .b(x07), .O(new_n72_));
  nand2  g39(.a(x16), .b(new_n49_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n53_), .O(z15));
endmodule
