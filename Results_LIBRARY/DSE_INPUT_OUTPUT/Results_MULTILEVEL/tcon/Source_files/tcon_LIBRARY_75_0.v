...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_, new_n45_,
    new_n47_, new_n49_, new_n51_, new_n53_, new_n54_, new_n55_, new_n57_,
  ...
  oai21  g10(.a(x09), .b(x08), .c(new_n43_), .O(z04));
  ...
  nor2   g16(.a(new_n37_), .b(new_n49_), .O(z07));
  inv1   g17(.a(x00), .O(new_n51_));
  nand2  g18(.a(x08), .b(new_n51_), .O(z08));
  inv1   g19(.a(x08), .O(new_n53_));
  oai21  g20(.a(x10), .b(new_n34_), .c(new_n53_), .O(new_n54_));
  ...
  oai21  g26(.a(x12), .b(new_n34_), .c(new_n53_), .O(new_n60_));
  ...
  oai21  g32(.a(x14), .b(new_n34_), .c(new_n53_), .O(new_n66_));
  nand2  g33(.a(x08), .b(x05), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z13));
  oai21  g35(.a(x15), .b(new_n34_), .c(new_n53_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z14));
  oai21  g38(.a(x16), .b(new_n34_), .c(new_n53_), .O(new_n72_));
