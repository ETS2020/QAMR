...
module FAU ( 
  ...
  nor2   g09(.a(new_n42_), .b(x03), .O(z04));
  inv1   g10(.a(x14), .O(new_n44_));
  aoi21  g11(.a(x13), .b(x03), .c(new_n44_), .O(z05));
  ...
  and2   g23(.a(x13), .b(x03), .O(new_n57_));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  nand2  g25(.a(x11), .b(new_n50_), .O(new_n59_));
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(z10));
  oai21  g27(.a(x13), .b(x08), .c(x03), .O(new_n61_));
  oai21  g28(.a(new_n40_), .b(x08), .c(new_n61_), .O(z11));
  oai21  g29(.a(new_n50_), .b(x03), .c(x13), .O(new_n63_));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n57_), .O(z14));
