...
module FAU ( 
  ...
  nand2  g32(.a(new_n35_), .b(x05), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(x08), .c(x04), .O(new_n67_));
  nand3  g34(.a(new_n36_), .b(x13), .c(new_n53_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z12));
  nand3  g36(.a(new_n36_), .b(x14), .c(new_n53_), .O(new_n70_));
  nand3  g37(.a(x15), .b(x08), .c(x05), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n70_), .O(z13));
  oai21  g39(.a(new_n35_), .b(new_n53_), .c(x05), .O(new_n73_));
  ...
  nand2  g44(.a(x16), .b(new_n53_), .O(new_n78_));
  aoi21  g45(.a(new_n78_), .b(new_n77_), .c(new_n40_), .O(z15));
endmodule
