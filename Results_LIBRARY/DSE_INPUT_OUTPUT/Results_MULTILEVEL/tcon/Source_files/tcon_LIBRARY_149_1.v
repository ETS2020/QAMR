...
module FAU ( 
  ...
  nand2  g11(.a(new_n44_), .b(new_n35_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  nand2  g13(.a(new_n36_), .b(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nor2   g15(.a(new_n44_), .b(x13), .O(new_n49_));
  ...
  aoi21  g23(.a(new_n56_), .b(new_n55_), .c(new_n49_), .O(z09));
  ...
  oai21  g30(.a(x16), .b(x13), .c(new_n51_), .O(new_n64_));
  ...
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n49_), .O(z13));
