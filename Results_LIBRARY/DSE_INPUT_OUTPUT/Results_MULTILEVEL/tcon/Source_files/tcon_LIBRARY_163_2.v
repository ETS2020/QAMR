...
module FAU ( 
  ...
  nand2  g10(.a(new_n43_), .b(x07), .O(new_n44_));
  ...
  aoi21  g29(.a(x08), .b(new_n35_), .c(x12), .O(new_n63_));
  ...
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n44_), .O(z14));
  oai21  g41(.a(new_n43_), .b(x08), .c(x07), .O(new_n75_));
  oai21  g42(.a(new_n50_), .b(x08), .c(new_n75_), .O(z15));
  buf    g43(.a(x12), .O(z03));
endmodule
