...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n37_, new_n39_, new_n42_, new_n43_, new_n45_, new_n47_,
  ...
  inv1   g09(.a(new_n34_), .O(new_n43_));
  nor2   g10(.a(new_n43_), .b(new_n42_), .O(z05));
  inv1   g11(.a(x15), .O(new_n45_));
  aoi21  g12(.a(x16), .b(x05), .c(new_n45_), .O(z06));
  inv1   g13(.a(x16), .O(new_n47_));
  nor2   g14(.a(new_n47_), .b(x05), .O(z07));
  ...
  aoi21  g21(.a(new_n54_), .b(new_n53_), .c(new_n43_), .O(z09));
  nand2  g22(.a(x08), .b(x02), .O(new_n56_));
  nand2  g23(.a(x11), .b(new_n49_), .O(new_n57_));
  aoi21  g24(.a(new_n57_), .b(new_n56_), .c(new_n43_), .O(z10));
  ...
  nand2  g31(.a(new_n42_), .b(new_n49_), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n47_), .c(x05), .O(new_n66_));
  inv1   g33(.a(x05), .O(new_n67_));
  nand3  g34(.a(x14), .b(new_n49_), .c(new_n67_), .O(new_n68_));
  ...
  oai21  g40(.a(new_n47_), .b(x08), .c(new_n73_), .O(new_n74_));
  nand2  g41(.a(new_n74_), .b(new_n67_), .O(new_n75_));
  nand3  g42(.a(new_n47_), .b(x08), .c(x07), .O(new_n76_));
