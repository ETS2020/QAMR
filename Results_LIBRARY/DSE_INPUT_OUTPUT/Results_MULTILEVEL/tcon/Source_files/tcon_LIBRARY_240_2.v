...
module FAU ( 
  ...
  nand2  g08(.a(new_n35_), .b(x11), .O(new_n42_));
  ...
  nand3  g24(.a(new_n36_), .b(x08), .c(x02), .O(new_n58_));
  nand3  g25(.a(x15), .b(x11), .c(new_n51_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  nand3  g27(.a(new_n36_), .b(x08), .c(x03), .O(new_n61_));
  nand3  g28(.a(new_n42_), .b(x12), .c(new_n51_), .O(new_n62_));
  ...
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n45_), .O(z13));
