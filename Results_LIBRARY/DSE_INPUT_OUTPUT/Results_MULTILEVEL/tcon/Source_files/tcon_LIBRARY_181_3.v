...
module FAU ( 
  ...
  and2   g16(.a(x12), .b(x07), .O(new_n50_));
  ...
  nand3  g29(.a(x12), .b(new_n52_), .c(new_n62_), .O(new_n63_));
  ...
  oai21  g40(.a(x12), .b(x08), .c(x07), .O(new_n74_));
  oai21  g41(.a(new_n48_), .b(x08), .c(new_n74_), .O(z15));
endmodule
