...
module FAU ( 
  ...
  nor2   g26(.a(x15), .b(x12), .O(new_n60_));
  ...
  nand3  g33(.a(new_n51_), .b(x14), .c(new_n35_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z13));
  nand2  g35(.a(x08), .b(x06), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n36_), .O(z14));
  nand2  g37(.a(x08), .b(x07), .O(new_n71_));
  nand3  g38(.a(x16), .b(new_n51_), .c(new_n35_), .O(new_n72_));
