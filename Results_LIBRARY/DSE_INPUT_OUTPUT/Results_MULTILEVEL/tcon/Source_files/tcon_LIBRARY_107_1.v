...
module FAU ( 
  ...
  nand2  g13(.a(x15), .b(new_n34_), .O(new_n47_));
  ...
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n47_), .O(z10));
  nand2  g28(.a(x12), .b(new_n53_), .O(new_n62_));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n47_), .O(z11));
  ...
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n38_), .O(z13));
  nand3  g37(.a(new_n47_), .b(x08), .c(x06), .O(new_n71_));
