// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:03 2020
...
module FAU ( 
  ...
  aoi21  g15(.a(x15), .b(x08), .c(new_n48_), .O(z07));
  nand2  g16(.a(x09), .b(new_n34_), .O(new_n50_));
  nand3  g17(.a(new_n36_), .b(x08), .c(x00), .O(new_n51_));
  nand2  g18(.a(new_n51_), .b(new_n50_), .O(z08));
  oai21  g19(.a(x15), .b(x01), .c(x08), .O(new_n53_));
  nand2  g20(.a(x10), .b(new_n34_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n53_), .O(z09));
  oai21  g22(.a(x15), .b(x02), .c(x08), .O(new_n56_));
  nand2  g23(.a(x11), .b(new_n34_), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n56_), .O(z10));
  oai21  g25(.a(x15), .b(x03), .c(x08), .O(new_n59_));
  ...
  nand2  g35(.a(new_n68_), .b(new_n36_), .O(z14));
