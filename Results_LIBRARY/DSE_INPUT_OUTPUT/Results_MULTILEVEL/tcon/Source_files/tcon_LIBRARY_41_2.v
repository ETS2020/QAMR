...
module FAU ( 
  ...
  nand2  g10(.a(new_n43_), .b(x09), .O(new_n44_));
  nand2  g11(.a(new_n44_), .b(new_n42_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  nand2  g13(.a(new_n44_), .b(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n44_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x08), .O(new_n50_));
  oai21  g17(.a(new_n43_), .b(new_n50_), .c(x09), .O(new_n51_));
