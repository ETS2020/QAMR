...
module FAU ( 
  ...
  aoi21  g20(.a(new_n53_), .b(new_n51_), .c(new_n35_), .O(z08));
  oai21  g21(.a(x10), .b(x08), .c(x01), .O(new_n55_));
  nand3  g22(.a(x11), .b(x10), .c(new_n52_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z09));
  inv1   g24(.a(x02), .O(new_n58_));
  aoi21  g25(.a(x08), .b(x01), .c(x11), .O(new_n59_));
