// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:01 2020
...
module FAU ( 
  ...
  aoi21  g23(.a(new_n38_), .b(x08), .c(x10), .O(new_n57_));
  ...
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n45_), .O(z10));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand2  g30(.a(x12), .b(new_n52_), .O(new_n64_));
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n45_), .O(z11));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n45_), .O(z13));
  nand3  g38(.a(new_n36_), .b(x08), .c(x06), .O(new_n72_));
  nand3  g39(.a(new_n49_), .b(x15), .c(new_n52_), .O(new_n73_));
  nand2  g40(.a(new_n73_), .b(new_n72_), .O(z14));
  nand3  g41(.a(new_n36_), .b(x08), .c(x07), .O(new_n75_));
  nand3  g42(.a(x16), .b(x10), .c(new_n52_), .O(new_n76_));
