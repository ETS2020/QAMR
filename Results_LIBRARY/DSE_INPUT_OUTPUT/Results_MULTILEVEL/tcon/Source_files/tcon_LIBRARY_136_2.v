...
module FAU ( 
  ...
  aoi21  g15(.a(new_n35_), .b(x02), .c(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nand2  g17(.a(new_n36_), .b(new_n50_), .O(z07));
  nor2   g18(.a(x09), .b(x02), .O(new_n52_));
  ...
  nand3  g26(.a(x11), .b(new_n35_), .c(new_n56_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z10));
  nor2   g28(.a(x12), .b(x02), .O(new_n62_));
