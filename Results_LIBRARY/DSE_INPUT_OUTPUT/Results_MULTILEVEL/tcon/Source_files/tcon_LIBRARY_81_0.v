...
module FAU ( 
  ...
  oai21  g19(.a(new_n46_), .b(x09), .c(new_n52_), .O(new_n53_));
  ...
  oai21  g25(.a(new_n46_), .b(x11), .c(new_n52_), .O(new_n59_));
  ...
  oai21  g31(.a(new_n46_), .b(x13), .c(new_n52_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z12));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  oai21  g35(.a(new_n46_), .b(x08), .c(new_n68_), .O(z13));
  oai21  g36(.a(x15), .b(new_n46_), .c(new_n52_), .O(new_n70_));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n70_), .O(z14));
  oai21  g39(.a(x16), .b(new_n46_), .c(new_n52_), .O(new_n73_));
