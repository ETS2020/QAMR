...
module FAU ( 
  ...
  nand2  g13(.a(x16), .b(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n40_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nand2  g17(.a(new_n50_), .b(x14), .O(z07));
  ...
  aoi21  g35(.a(x16), .b(x08), .c(x14), .O(new_n69_));
  ...
  aoi21  g42(.a(x14), .b(x08), .c(x16), .O(new_n76_));
  nand2  g43(.a(x16), .b(new_n53_), .O(new_n77_));
  oai21  g44(.a(new_n76_), .b(new_n75_), .c(new_n77_), .O(z15));
endmodule
