...
module FAU ( 
  ...
  nor2   g05(.a(x13), .b(new_n38_), .O(z02));
  inv1   g06(.a(x12), .O(new_n40_));
  aoi21  g07(.a(x13), .b(x11), .c(new_n40_), .O(z03));
  inv1   g08(.a(x13), .O(new_n42_));
  nor2   g09(.a(new_n42_), .b(x11), .O(z04));
  inv1   g10(.a(x14), .O(new_n44_));
  aoi21  g11(.a(x13), .b(x11), .c(new_n44_), .O(z05));
  ...
  oai21  g30(.a(x11), .b(new_n50_), .c(x13), .O(new_n64_));
