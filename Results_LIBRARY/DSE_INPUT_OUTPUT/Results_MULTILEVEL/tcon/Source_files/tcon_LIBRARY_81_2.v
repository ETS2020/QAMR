...
module FAU ( 
  ...
  nand2  g30(.a(x13), .b(new_n46_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  aoi21  g33(.a(x08), .b(new_n66_), .c(new_n35_), .O(z13));
