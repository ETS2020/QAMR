...
module FAU ( 
  ...
  nand2  g05(.a(new_n38_), .b(new_n35_), .O(z02));
  inv1   g06(.a(x12), .O(new_n40_));
  nand2  g07(.a(new_n38_), .b(x09), .O(new_n41_));
  ...
  nand3  g17(.a(new_n41_), .b(x08), .c(x00), .O(new_n51_));
  inv1   g18(.a(x08), .O(new_n52_));
  nand3  g19(.a(x11), .b(x09), .c(new_n52_), .O(new_n53_));
  ...
  oai21  g24(.a(x11), .b(x09), .c(new_n52_), .O(new_n58_));
