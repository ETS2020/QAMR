...
module FAU ( 
  ...
  wire new_n34_, new_n37_, new_n39_, new_n41_, new_n44_, new_n46_, new_n47_,
    ...
    new_n76_, new_n77_;
  nand2  g00(.a(x15), .b(x06), .O(new_n34_));
  ...
  nand3  g35(.a(x15), .b(new_n48_), .c(new_n68_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n67_), .O(z14));
  nand2  g37(.a(x08), .b(x07), .O(new_n71_));
  nand2  g38(.a(x16), .b(x15), .O(new_n72_));
  oai21  g39(.a(new_n72_), .b(x08), .c(new_n71_), .O(new_n73_));
  nand2  g40(.a(new_n73_), .b(new_n68_), .O(new_n74_));
  nand3  g41(.a(x08), .b(x07), .c(x06), .O(new_n75_));
  oai21  g42(.a(new_n44_), .b(x08), .c(new_n75_), .O(new_n76_));
  nand2  g43(.a(new_n76_), .b(new_n66_), .O(new_n77_));
  nand2  g44(.a(new_n77_), .b(new_n74_), .O(z15));
  buf    g45(.a(x15), .O(z06));
endmodule
