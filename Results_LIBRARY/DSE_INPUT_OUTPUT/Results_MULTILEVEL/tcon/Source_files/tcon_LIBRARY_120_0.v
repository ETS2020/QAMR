...
module FAU ( 
  ...
  oai21  g20(.a(x10), .b(new_n50_), .c(new_n53_), .O(new_n54_));
  nand2  g21(.a(x08), .b(x01), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z09));
  oai21  g23(.a(x11), .b(new_n50_), .c(new_n53_), .O(new_n57_));
