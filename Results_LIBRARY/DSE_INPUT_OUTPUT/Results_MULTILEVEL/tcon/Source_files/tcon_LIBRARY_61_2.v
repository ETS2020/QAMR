...
module FAU ( 
  ...
  nand2  g11(.a(new_n40_), .b(x01), .O(new_n45_));
  ...
  oai21  g23(.a(x10), .b(x08), .c(x11), .O(new_n57_));
  nand3  g24(.a(x10), .b(new_n53_), .c(new_n35_), .O(new_n58_));
  oai21  g25(.a(new_n57_), .b(new_n35_), .c(new_n58_), .O(z09));
  ...
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n45_), .O(z14));
