...
module FAU ( 
  ...
  nor2   g01(.a(x12), .b(x06), .O(new_n35_));
  ...
  aoi21  g27(.a(x08), .b(x06), .c(x12), .O(new_n61_));
  ...
  oai21  g36(.a(x15), .b(x08), .c(x06), .O(new_n70_));
  nand3  g37(.a(x15), .b(x12), .c(new_n51_), .O(new_n71_));
