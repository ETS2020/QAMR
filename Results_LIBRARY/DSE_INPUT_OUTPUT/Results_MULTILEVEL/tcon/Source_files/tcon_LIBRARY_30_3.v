...
module FAU ( 
  ...
  inv1   g06(.a(x06), .O(new_n40_));
  inv1   g07(.a(x12), .O(new_n41_));
  oai21  g08(.a(new_n38_), .b(new_n40_), .c(new_n41_), .O(z03));
  ...
  oai21  g24(.a(new_n50_), .b(x06), .c(x11), .O(new_n58_));
  ...
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n54_), .O(z13));
  nand2  g36(.a(new_n47_), .b(new_n50_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n38_), .c(x06), .O(new_n71_));
  nand3  g38(.a(x15), .b(new_n50_), .c(new_n40_), .O(new_n72_));
