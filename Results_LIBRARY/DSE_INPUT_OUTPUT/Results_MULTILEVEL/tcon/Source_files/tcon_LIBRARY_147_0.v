...
module FAU ( 
  ...
  nand2  g15(.a(new_n48_), .b(x13), .O(z07));
  ...
  oai21  g29(.a(new_n48_), .b(x13), .c(new_n50_), .O(new_n63_));
  ...
  inv1   g38(.a(x13), .O(new_n72_));
  oai21  g39(.a(x16), .b(new_n72_), .c(new_n50_), .O(new_n73_));
