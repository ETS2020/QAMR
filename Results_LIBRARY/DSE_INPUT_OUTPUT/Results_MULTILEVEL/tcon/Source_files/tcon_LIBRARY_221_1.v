...
module FAU ( 
  ...
  nand2  g06(.a(x12), .b(new_n34_), .O(new_n40_));
  ...
  nand3  g24(.a(new_n57_), .b(x11), .c(new_n34_), .O(new_n58_));
  ...
  nand3  g29(.a(x13), .b(new_n57_), .c(new_n34_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  nand3  g32(.a(x14), .b(new_n57_), .c(new_n34_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z13));
  nand2  g34(.a(x08), .b(x06), .O(new_n68_));
  nand3  g35(.a(x15), .b(new_n57_), .c(new_n34_), .O(new_n69_));
