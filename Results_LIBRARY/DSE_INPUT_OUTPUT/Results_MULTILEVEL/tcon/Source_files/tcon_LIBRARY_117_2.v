...
module FAU ( 
  ...
  nand2  g06(.a(new_n39_), .b(x13), .O(new_n40_));
  ...
  nand2  g14(.a(new_n39_), .b(new_n35_), .O(z06));
  ...
  oai21  g30(.a(new_n39_), .b(new_n52_), .c(x13), .O(new_n64_));
  ...
  aoi21  g37(.a(new_n35_), .b(x08), .c(x15), .O(new_n71_));
