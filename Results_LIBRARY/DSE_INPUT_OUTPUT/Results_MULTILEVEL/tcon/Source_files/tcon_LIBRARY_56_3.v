...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n43_, new_n44_, new_n45_, new_n46_,
  ...
  nand2  g03(.a(new_n34_), .b(new_n36_), .O(z03));
  ...
  nand3  g09(.a(new_n34_), .b(x08), .c(x00), .O(new_n43_));
  ...
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n54_), .O(z14));
  nand2  g33(.a(x08), .b(x07), .O(new_n67_));
  nand2  g34(.a(x16), .b(new_n44_), .O(new_n68_));
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n54_), .O(z15));
  buf    g36(.a(x09), .O(z00));
  buf    g37(.a(x11), .O(z02));
endmodule
