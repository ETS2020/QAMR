// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:38 2020
...
module FAU ( 
  ...
  nand2  g08(.a(new_n41_), .b(x09), .O(new_n42_));
  nand2  g09(.a(new_n42_), .b(new_n40_), .O(z03));
  ...
  nand3  g17(.a(new_n42_), .b(x08), .c(x00), .O(new_n51_));
  inv1   g18(.a(x08), .O(new_n52_));
  nand3  g19(.a(x14), .b(x09), .c(new_n52_), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n51_), .O(z08));
  nand3  g21(.a(new_n42_), .b(x08), .c(x01), .O(new_n55_));
  nand2  g22(.a(new_n41_), .b(x09), .O(new_n56_));
  ...
  aoi21  g35(.a(new_n35_), .b(x08), .c(x14), .O(new_n69_));
  ...
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n42_), .O(z15));
  buf    g44(.a(x09), .O(z00));
endmodule
