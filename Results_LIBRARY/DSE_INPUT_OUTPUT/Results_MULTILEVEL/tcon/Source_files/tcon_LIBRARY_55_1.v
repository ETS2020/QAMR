...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    new_n44_, new_n46_, new_n48_, new_n52_, new_n53_, new_n54_, new_n56_,
  ...
  nor2   g02(.a(new_n35_), .b(x15), .O(new_n36_));
  ...
  nor2   g17(.a(new_n35_), .b(new_n39_), .O(z07));
  ...
  nand3  g41(.a(new_n40_), .b(x08), .c(x07), .O(new_n75_));
  nand3  g42(.a(x16), .b(x15), .c(new_n53_), .O(new_n76_));
