// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:39 2020
...
module FAU ( 
  ...
  aoi21  g03(.a(x12), .b(x09), .c(new_n36_), .O(z02));
  inv1   g04(.a(x12), .O(new_n38_));
  nor2   g05(.a(new_n38_), .b(x09), .O(z03));
  ...
  and2   g17(.a(x12), .b(x09), .O(new_n51_));
  ...
  oai21  g24(.a(x09), .b(new_n47_), .c(x12), .O(new_n58_));
