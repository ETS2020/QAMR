...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n42_, new_n46_,
  ...
  nor2   g06(.a(new_n39_), .b(x02), .O(z02));
  inv1   g07(.a(x02), .O(new_n41_));
  inv1   g08(.a(x12), .O(new_n42_));
  oai21  g09(.a(new_n39_), .b(new_n41_), .c(new_n42_), .O(z03));
  ...
  and2   g15(.a(x11), .b(x02), .O(new_n49_));
  ...
  oai21  g24(.a(new_n39_), .b(x08), .c(new_n57_), .O(z10));
  ...
  aoi21  g30(.a(new_n63_), .b(new_n62_), .c(new_n49_), .O(z12));
  ...
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n49_), .O(z14));
  nand2  g37(.a(x08), .b(x07), .O(new_n71_));
  nand2  g38(.a(x16), .b(new_n51_), .O(new_n72_));
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n49_), .O(z15));
endmodule
