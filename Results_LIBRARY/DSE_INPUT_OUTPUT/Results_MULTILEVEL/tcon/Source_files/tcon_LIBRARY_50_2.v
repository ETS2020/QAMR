...
module FAU ( 
  ...
  oai21  g09(.a(x15), .b(new_n35_), .c(new_n42_), .O(z02));
  ...
  nand2  g25(.a(new_n39_), .b(x12), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(x11), .c(new_n52_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n58_), .O(z10));
  nand3  g28(.a(new_n40_), .b(x08), .c(x03), .O(new_n62_));
  nand3  g29(.a(x15), .b(x12), .c(new_n52_), .O(new_n63_));
