...
module FAU ( 
  ...
  nand2  g16(.a(new_n41_), .b(new_n35_), .O(z07));
  ...
  nand3  g30(.a(new_n42_), .b(x08), .c(x04), .O(new_n64_));
  nand2  g31(.a(new_n41_), .b(x14), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(x13), .c(new_n52_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n64_), .O(z12));
  nand3  g34(.a(new_n42_), .b(x08), .c(x05), .O(new_n68_));
  nand3  g35(.a(x16), .b(x14), .c(new_n52_), .O(new_n69_));
