...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_, new_n44_,
  ...
  nand2  g01(.a(new_n34_), .b(x02), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nor2   g03(.a(x09), .b(x02), .O(new_n37_));
  ...
  nand2  g23(.a(x09), .b(new_n56_), .O(new_n57_));
  nand3  g24(.a(new_n57_), .b(new_n55_), .c(new_n54_), .O(z08));
  nand2  g25(.a(x08), .b(x01), .O(new_n59_));
  nand2  g26(.a(x10), .b(new_n56_), .O(new_n60_));
  aoi21  g27(.a(new_n60_), .b(new_n59_), .c(new_n37_), .O(z09));
  oai21  g28(.a(x11), .b(x08), .c(x02), .O(new_n62_));
  nand3  g29(.a(x11), .b(x09), .c(new_n56_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z10));
  nand2  g31(.a(x08), .b(x03), .O(new_n65_));
  nand2  g32(.a(x12), .b(new_n56_), .O(new_n66_));
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n37_), .O(z11));
  nand2  g34(.a(x13), .b(new_n56_), .O(new_n68_));
  ...
  nand2  g41(.a(x15), .b(new_n56_), .O(new_n75_));
  aoi21  g42(.a(new_n75_), .b(new_n74_), .c(new_n37_), .O(z14));
