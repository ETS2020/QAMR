// Benchmark "FAU" written by ABC on Fri Aug 14 01:50:50 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n38_, new_n39_, new_n41_, new_n42_, new_n44_,
  ...
  nor2   g03(.a(new_n35_), .b(new_n34_), .O(z01));
  inv1   g04(.a(x11), .O(new_n38_));
  nand2  g05(.a(x10), .b(new_n34_), .O(new_n39_));
  nand2  g06(.a(new_n39_), .b(new_n38_), .O(z02));
  inv1   g07(.a(x12), .O(new_n41_));
  nor2   g08(.a(new_n35_), .b(x09), .O(new_n42_));
  nor2   g09(.a(new_n42_), .b(new_n41_), .O(z03));
  inv1   g10(.a(x13), .O(new_n44_));
  nand2  g11(.a(new_n39_), .b(new_n44_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  nor2   g13(.a(new_n42_), .b(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n39_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nor2   g17(.a(new_n42_), .b(new_n50_), .O(z07));
  inv1   g18(.a(x00), .O(new_n52_));
  aoi21  g19(.a(new_n35_), .b(x08), .c(x09), .O(new_n53_));
  inv1   g20(.a(x08), .O(new_n54_));
  nand2  g21(.a(x09), .b(new_n54_), .O(new_n55_));
  oai21  g22(.a(new_n53_), .b(new_n52_), .c(new_n55_), .O(z08));
  oai21  g23(.a(new_n34_), .b(new_n54_), .c(x10), .O(new_n57_));
