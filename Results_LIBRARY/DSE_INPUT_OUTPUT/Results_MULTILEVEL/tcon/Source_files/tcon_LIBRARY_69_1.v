...
module FAU ( 
  ...
  oai21  g13(.a(new_n35_), .b(x13), .c(new_n46_), .O(z05));
  nor2   g14(.a(new_n35_), .b(new_n44_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  oai21  g16(.a(new_n35_), .b(x13), .c(new_n49_), .O(z07));
  ...
  oai21  g37(.a(new_n44_), .b(new_n52_), .c(x15), .O(new_n71_));
