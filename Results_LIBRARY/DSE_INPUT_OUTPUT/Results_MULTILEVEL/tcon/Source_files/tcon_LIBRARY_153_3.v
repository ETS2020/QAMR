...
module FAU ( 
  ...
  nand2  g06(.a(x15), .b(x11), .O(new_n40_));
  and2   g07(.a(new_n40_), .b(x12), .O(z03));
  ...
  aoi21  g14(.a(x15), .b(x11), .c(new_n47_), .O(z07));
  and2   g15(.a(x15), .b(x11), .O(new_n49_));
  ...
  nand3  g24(.a(new_n45_), .b(x11), .c(new_n51_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z10));
  nand3  g26(.a(new_n35_), .b(x08), .c(x03), .O(new_n60_));
  nand3  g27(.a(new_n40_), .b(x12), .c(new_n51_), .O(new_n61_));
  ...
  nand3  g35(.a(new_n35_), .b(x08), .c(x06), .O(new_n69_));
  nand3  g36(.a(x15), .b(new_n38_), .c(new_n51_), .O(new_n70_));
