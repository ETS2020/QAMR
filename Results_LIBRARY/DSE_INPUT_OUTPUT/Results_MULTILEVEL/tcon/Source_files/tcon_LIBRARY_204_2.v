...
module FAU ( 
  ...
  nor2   g06(.a(x10), .b(new_n39_), .O(new_n40_));
  nor2   g07(.a(new_n40_), .b(new_n38_), .O(z03));
  ...
  nand3  g18(.a(x10), .b(x09), .c(new_n51_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n50_), .O(z08));
  oai21  g20(.a(x10), .b(x09), .c(new_n51_), .O(new_n54_));
