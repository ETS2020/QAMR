...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n40_, new_n42_, new_n45_, new_n46_,
  ...
  aoi21  g05(.a(x12), .b(x06), .c(new_n38_), .O(z02));
  inv1   g06(.a(x12), .O(new_n40_));
  nor2   g07(.a(new_n40_), .b(x06), .O(z03));
  ...
  nor2   g13(.a(new_n46_), .b(new_n45_), .O(z06));
  ...
  nand3  g18(.a(new_n51_), .b(new_n50_), .c(new_n34_), .O(z08));
  ...
  aoi21  g24(.a(new_n57_), .b(new_n56_), .c(new_n46_), .O(z10));
  oai21  g25(.a(new_n49_), .b(x06), .c(x12), .O(new_n59_));
  ...
  aoi21  g30(.a(new_n63_), .b(new_n62_), .c(new_n46_), .O(z12));
  nand2  g31(.a(x14), .b(new_n49_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n34_), .O(z13));
  nand2  g34(.a(new_n45_), .b(new_n49_), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n40_), .c(x06), .O(new_n69_));
  inv1   g36(.a(x06), .O(new_n70_));
  nand3  g37(.a(x15), .b(new_n49_), .c(new_n70_), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n69_), .O(z14));
