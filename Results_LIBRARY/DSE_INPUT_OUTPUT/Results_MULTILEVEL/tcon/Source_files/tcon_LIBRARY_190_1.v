...
module FAU ( 
  ...
  oai21  g13(.a(new_n35_), .b(x13), .c(new_n46_), .O(z06));
  ...
  nand3  g37(.a(new_n54_), .b(x08), .c(x06), .O(new_n71_));
  ...
  nand3  g41(.a(new_n54_), .b(x08), .c(x07), .O(new_n75_));
