...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n43_, new_n46_,
  ...
  aoi21  g04(.a(x09), .b(x08), .c(new_n37_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  nand2  g06(.a(x09), .b(x08), .O(new_n40_));
  nand2  g07(.a(new_n40_), .b(new_n39_), .O(z02));
  and2   g08(.a(new_n40_), .b(x12), .O(z03));
  inv1   g09(.a(x13), .O(new_n43_));
  nand2  g10(.a(new_n40_), .b(new_n43_), .O(z04));
  and2   g11(.a(new_n40_), .b(x14), .O(z05));
  inv1   g12(.a(x15), .O(new_n46_));
  nand2  g13(.a(new_n40_), .b(new_n46_), .O(z06));
  and2   g14(.a(new_n40_), .b(x16), .O(z07));
  inv1   g15(.a(x09), .O(new_n49_));
  nand3  g16(.a(new_n49_), .b(x08), .c(x00), .O(new_n50_));
  nand2  g17(.a(new_n50_), .b(new_n35_), .O(z08));
  nand2  g18(.a(x10), .b(new_n34_), .O(new_n52_));
  nand3  g19(.a(new_n49_), .b(x08), .c(x01), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n52_), .O(z09));
  oai21  g21(.a(x09), .b(x02), .c(x08), .O(new_n55_));
  nand2  g22(.a(x11), .b(new_n34_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z10));
  oai21  g24(.a(x09), .b(x03), .c(x08), .O(new_n58_));
  nand2  g25(.a(x12), .b(new_n34_), .O(new_n59_));
  ...
  nand2  g30(.a(x14), .b(new_n34_), .O(new_n64_));
  ...
  oai21  g36(.a(x09), .b(x07), .c(x08), .O(new_n70_));
