...
module FAU ( 
  ...
  nand2  g17(.a(x08), .b(new_n50_), .O(z08));
  inv1   g18(.a(x08), .O(new_n52_));
  inv1   g19(.a(x09), .O(new_n53_));
  oai21  g20(.a(x10), .b(new_n53_), .c(new_n52_), .O(new_n54_));
  ...
  oai21  g29(.a(x13), .b(new_n53_), .c(new_n52_), .O(new_n63_));
