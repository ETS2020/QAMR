...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n42_, new_n46_, new_n47_,
    new_n48_, new_n49_, new_n51_, new_n53_, new_n54_, new_n56_, new_n57_,
  ...
  nand3  g12(.a(new_n35_), .b(x08), .c(x00), .O(new_n46_));
  inv1   g13(.a(x01), .O(new_n47_));
  inv1   g14(.a(x08), .O(new_n48_));
  nand3  g15(.a(x09), .b(new_n48_), .c(new_n47_), .O(new_n49_));
  ...
  and2   g25(.a(x09), .b(x01), .O(new_n59_));
