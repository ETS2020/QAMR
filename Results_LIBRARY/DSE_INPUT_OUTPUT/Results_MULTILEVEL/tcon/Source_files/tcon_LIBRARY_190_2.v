...
module FAU ( 
  ...
  nand2  g12(.a(new_n44_), .b(x13), .O(new_n46_));
  and2   g13(.a(new_n46_), .b(x14), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n44_), .b(x13), .O(new_n49_));
  nand2  g16(.a(new_n49_), .b(new_n48_), .O(z06));
  ...
  nand3  g23(.a(new_n56_), .b(new_n55_), .c(new_n49_), .O(z09));
  nand2  g24(.a(x11), .b(new_n52_), .O(new_n58_));
  nand2  g25(.a(x08), .b(x02), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n49_), .O(z10));
  nand2  g27(.a(x12), .b(new_n52_), .O(new_n61_));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n49_), .O(z11));
  nand3  g30(.a(new_n49_), .b(x08), .c(x04), .O(new_n64_));
  nand3  g31(.a(x16), .b(x13), .c(new_n52_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z12));
  nand3  g33(.a(new_n49_), .b(x08), .c(x05), .O(new_n67_));
  nand3  g34(.a(new_n46_), .b(x14), .c(new_n52_), .O(new_n68_));
  ...
  aoi21  g40(.a(new_n35_), .b(x08), .c(x16), .O(new_n74_));
