...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n43_, new_n45_,
    new_n47_, new_n49_, new_n51_, new_n53_, new_n54_, new_n56_, new_n57_,
  ...
  aoi21  g08(.a(x09), .b(new_n34_), .c(new_n41_), .O(z03));
  inv1   g09(.a(x13), .O(new_n43_));
  aoi21  g10(.a(x09), .b(new_n34_), .c(new_n43_), .O(z04));
  inv1   g11(.a(x14), .O(new_n45_));
  aoi21  g12(.a(x09), .b(new_n34_), .c(new_n45_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  aoi21  g14(.a(x09), .b(new_n34_), .c(new_n47_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  aoi21  g16(.a(x09), .b(new_n34_), .c(new_n49_), .O(z07));
  nand2  g17(.a(x08), .b(x00), .O(new_n51_));
  oai21  g18(.a(new_n35_), .b(x08), .c(new_n51_), .O(z08));
  ...
  nand3  g26(.a(x12), .b(new_n35_), .c(new_n34_), .O(new_n60_));
