...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n47_, new_n48_, new_n51_, new_n52_, new_n53_, new_n55_,
  ...
  nand2  g16(.a(new_n35_), .b(new_n47_), .O(z07));
  ...
  aoi21  g23(.a(new_n56_), .b(new_n55_), .c(new_n48_), .O(z09));
  ...
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n48_), .O(z13));
