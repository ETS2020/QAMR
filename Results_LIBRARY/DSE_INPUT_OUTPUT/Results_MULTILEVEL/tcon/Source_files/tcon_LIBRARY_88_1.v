...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n57_, new_n59_, new_n61_, new_n62_, new_n65_, new_n66_, new_n68_,
    new_n70_;
  ...
  aoi21  g07(.a(x08), .b(new_n35_), .c(new_n40_), .O(z02));
  ...
  oai22  g24(.a(new_n57_), .b(new_n56_), .c(new_n38_), .d(x08), .O(z09));
  ...
  oai21  g30(.a(new_n44_), .b(x08), .c(new_n57_), .O(z12));
  oai21  g31(.a(x05), .b(new_n35_), .c(x08), .O(new_n65_));
  nand2  g32(.a(x14), .b(new_n53_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z13));
  nand3  g34(.a(x08), .b(x06), .c(x04), .O(new_n68_));
  oai21  g35(.a(new_n48_), .b(x08), .c(new_n68_), .O(z14));
  nand3  g36(.a(x08), .b(x07), .c(x04), .O(new_n70_));
