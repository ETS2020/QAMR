...
module FAU ( 
  ...
  oai21  g26(.a(new_n34_), .b(x03), .c(x08), .O(new_n60_));
  nand2  g27(.a(x12), .b(new_n51_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z11));
  nand3  g29(.a(x09), .b(x08), .c(x04), .O(new_n63_));
  oai21  g30(.a(new_n42_), .b(x08), .c(new_n63_), .O(z12));
  ...
  oai21  g37(.a(new_n34_), .b(x07), .c(x08), .O(new_n71_));
