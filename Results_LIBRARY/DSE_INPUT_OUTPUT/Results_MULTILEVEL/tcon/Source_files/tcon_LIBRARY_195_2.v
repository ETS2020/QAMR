...
module FAU ( 
  ...
  nor2   g04(.a(x09), .b(new_n34_), .O(new_n38_));
  nor2   g05(.a(new_n38_), .b(new_n37_), .O(z01));
  inv1   g06(.a(x11), .O(new_n40_));
  nand2  g07(.a(new_n35_), .b(x00), .O(new_n41_));
