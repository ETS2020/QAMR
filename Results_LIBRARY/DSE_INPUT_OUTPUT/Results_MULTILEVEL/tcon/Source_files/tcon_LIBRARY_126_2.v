...
module FAU ( 
  ...
  nor2   g15(.a(new_n40_), .b(new_n48_), .O(z07));
  ...
  nand3  g23(.a(new_n36_), .b(x08), .c(x02), .O(new_n57_));
  nand3  g24(.a(x14), .b(x11), .c(new_n51_), .O(new_n58_));
  ...
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n40_), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  aoi21  g33(.a(new_n39_), .b(x08), .c(x14), .O(new_n67_));
