...
module FAU ( 
  ...
  oai21  g16(.a(x15), .b(new_n49_), .c(x09), .O(new_n50_));
  ...
  nand3  g21(.a(new_n54_), .b(new_n53_), .c(new_n39_), .O(z09));
  and2   g22(.a(x15), .b(x09), .O(new_n56_));
  ...
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n39_), .O(z12));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand2  g33(.a(x14), .b(new_n49_), .O(new_n67_));
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n56_), .O(z13));
  oai21  g35(.a(x09), .b(new_n49_), .c(x15), .O(new_n69_));
  ...
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n39_), .O(z15));
  buf    g41(.a(x15), .O(z06));
endmodule
