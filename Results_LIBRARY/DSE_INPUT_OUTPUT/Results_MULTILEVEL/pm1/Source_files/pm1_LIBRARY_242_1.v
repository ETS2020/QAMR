...
module FAU ( 
  ...
  nand4  g28(.a(new_n43_), .b(x12), .c(x11), .d(new_n48_), .O(new_n59_));
  nor3   g29(.a(new_n59_), .b(new_n37_), .c(new_n47_), .O(z10));
  ...
  nand4  g35(.a(x11), .b(new_n48_), .c(new_n37_), .d(x00), .O(new_n66_));
