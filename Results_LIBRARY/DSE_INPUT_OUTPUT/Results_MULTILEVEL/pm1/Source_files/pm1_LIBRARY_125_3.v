...
module FAU ( 
  ...
  oai21  g06(.a(x13), .b(new_n35_), .c(x12), .O(z01));
  ...
  oai21  g10(.a(new_n39_), .b(x13), .c(x12), .O(z02));
  ...
  nand2  g14(.a(x13), .b(x12), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x14), .O(z04));
  nand2  g16(.a(x13), .b(new_n30_), .O(z05));
  nand3  g17(.a(new_n35_), .b(x09), .c(x01), .O(new_n47_));
  ...
  nand2  g27(.a(new_n41_), .b(x09), .O(new_n57_));
  oai21  g28(.a(new_n57_), .b(new_n50_), .c(new_n56_), .O(z08));
  ...
  nand4  g33(.a(new_n50_), .b(new_n32_), .c(x12), .d(x11), .O(new_n63_));
  ...
  nand4  g38(.a(new_n50_), .b(new_n32_), .c(x12), .d(x09), .O(new_n68_));
  ...
  nor3   g45(.a(new_n74_), .b(x13), .c(new_n30_), .O(z12));
endmodule
