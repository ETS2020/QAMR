...
module FAU ( 
  ...
  nand2  g16(.a(x13), .b(x12), .O(z05));
  and2   g17(.a(x03), .b(x02), .O(new_n47_));
  nand2  g18(.a(x12), .b(new_n37_), .O(new_n48_));
  ...
  nand3  g38(.a(new_n33_), .b(new_n30_), .c(new_n67_), .O(new_n68_));
  ...
  nand4  g42(.a(x11), .b(new_n53_), .c(new_n62_), .d(x00), .O(new_n72_));
