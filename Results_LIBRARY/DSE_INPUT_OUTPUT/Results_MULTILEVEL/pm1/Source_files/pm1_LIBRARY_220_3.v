...
module FAU ( 
  ...
  nand3  g04(.a(x12), .b(new_n31_), .c(new_n30_), .O(z01));
  nand2  g05(.a(x06), .b(x05), .O(new_n35_));
  nand3  g06(.a(x09), .b(x08), .c(x07), .O(new_n36_));
  nor2   g07(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  nand4  g08(.a(new_n37_), .b(x12), .c(x11), .d(new_n30_), .O(z02));
  ...
  nand2  g13(.a(x12), .b(x01), .O(new_n43_));
  nand2  g14(.a(new_n43_), .b(x14), .O(z04));
  aoi21  g15(.a(x12), .b(x01), .c(x13), .O(z05));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  nand4  g17(.a(new_n46_), .b(new_n32_), .c(x09), .d(x01), .O(new_n47_));
  ...
  nand3  g25(.a(x12), .b(x11), .c(new_n30_), .O(new_n55_));
  oai21  g26(.a(x12), .b(x11), .c(new_n55_), .O(new_n56_));
  nand3  g27(.a(new_n56_), .b(new_n50_), .c(x00), .O(new_n57_));
  inv1   g28(.a(new_n57_), .O(z09));
  nand3  g29(.a(new_n46_), .b(x11), .c(new_n50_), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(x09), .c(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(new_n30_), .c(new_n32_), .O(z10));
  nand2  g33(.a(new_n30_), .b(x00), .O(new_n63_));
  nand3  g34(.a(new_n32_), .b(x11), .c(new_n50_), .O(new_n64_));
  oai21  g35(.a(new_n64_), .b(new_n63_), .c(new_n43_), .O(z11));
  inv1   g36(.a(x09), .O(new_n66_));
  nand4  g37(.a(x11), .b(new_n50_), .c(new_n66_), .d(x00), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(new_n30_), .c(new_n32_), .O(z12));
endmodule
