...
module FAU ( 
  ...
  nand2  g08(.a(new_n30_), .b(x03), .O(new_n38_));
  ...
  aoi21  g15(.a(new_n30_), .b(new_n44_), .c(x14), .O(z04));
  nand2  g16(.a(new_n30_), .b(new_n44_), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(x13), .O(z05));
  aoi21  g18(.a(x09), .b(x01), .c(new_n30_), .O(new_n48_));
  nand3  g19(.a(z01), .b(x04), .c(x02), .O(new_n49_));
  nand3  g20(.a(new_n49_), .b(x09), .c(x01), .O(new_n50_));
  oai21  g21(.a(new_n48_), .b(x03), .c(new_n50_), .O(z06));
  ...
  nand4  g27(.a(new_n56_), .b(new_n53_), .c(new_n46_), .d(x00), .O(z08));
  ...
  nor3   g35(.a(new_n64_), .b(new_n54_), .c(new_n62_), .O(z10));
  nand4  g36(.a(new_n63_), .b(x12), .c(x09), .d(x01), .O(new_n66_));
  inv1   g37(.a(x01), .O(new_n67_));
  nand3  g38(.a(new_n30_), .b(x03), .c(new_n67_), .O(new_n68_));
  ...
  nand2  g42(.a(new_n54_), .b(x00), .O(new_n72_));
  nand3  g43(.a(x12), .b(x11), .c(new_n58_), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n72_), .c(new_n46_), .O(z12));
endmodule
