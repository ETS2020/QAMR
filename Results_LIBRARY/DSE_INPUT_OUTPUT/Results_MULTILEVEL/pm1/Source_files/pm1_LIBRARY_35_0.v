...
module FAU ( 
  ...
  nand2  g13(.a(new_n43_), .b(new_n35_), .O(new_n44_));
  ...
  nor2   g21(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand4  g22(.a(new_n52_), .b(x04), .c(x03), .d(x02), .O(new_n53_));
  ...
  nand4  g27(.a(new_n42_), .b(x12), .c(x11), .d(new_n49_), .O(new_n58_));
  nor3   g28(.a(new_n58_), .b(new_n50_), .c(new_n57_), .O(z10));
  nand4  g29(.a(new_n42_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  inv1   g30(.a(x01), .O(new_n61_));
  nand2  g31(.a(new_n51_), .b(new_n61_), .O(new_n62_));
  ...
  nor2   g36(.a(new_n66_), .b(new_n51_), .O(z12));
  one    g37(.O(z00));
  buf    g38(.a(x11), .O(z01));
endmodule
