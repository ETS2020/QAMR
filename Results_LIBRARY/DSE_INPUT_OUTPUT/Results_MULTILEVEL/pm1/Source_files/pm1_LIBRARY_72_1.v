...
module FAU ( 
  ...
  nand3  g27(.a(new_n56_), .b(new_n49_), .c(x00), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(z01), .O(z09));
  inv1   g29(.a(x09), .O(new_n59_));
  nand4  g30(.a(new_n44_), .b(x12), .c(x11), .d(new_n49_), .O(new_n60_));
  nor3   g31(.a(new_n60_), .b(new_n59_), .c(new_n48_), .O(z10));
  ...
  nand4  g37(.a(x11), .b(new_n49_), .c(new_n59_), .d(x00), .O(new_n67_));
