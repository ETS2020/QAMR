...
module FAU ( 
  ...
  nand3  g05(.a(x12), .b(new_n34_), .c(x05), .O(z01));
  nand4  g06(.a(x09), .b(x08), .c(x07), .d(x06), .O(new_n36_));
  oai21  g07(.a(new_n36_), .b(new_n34_), .c(x05), .O(new_n37_));
  nand2  g08(.a(new_n37_), .b(x12), .O(z02));
  nand3  g09(.a(x08), .b(x07), .c(x06), .O(new_n39_));
  nand3  g10(.a(new_n39_), .b(x11), .c(x09), .O(new_n40_));
  nand2  g11(.a(new_n40_), .b(x05), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(x12), .O(z03));
  aoi21  g13(.a(x12), .b(new_n30_), .c(x14), .O(z04));
  nand2  g14(.a(x12), .b(new_n30_), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x13), .O(z05));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  nand3  g18(.a(x12), .b(new_n34_), .c(x05), .O(new_n48_));
  ...
  nand2  g25(.a(new_n54_), .b(x05), .O(new_n55_));
  ...
  nand3  g31(.a(new_n46_), .b(x11), .c(new_n53_), .O(new_n61_));
  ...
  nand4  g42(.a(new_n53_), .b(new_n71_), .c(x05), .d(x00), .O(new_n72_));
