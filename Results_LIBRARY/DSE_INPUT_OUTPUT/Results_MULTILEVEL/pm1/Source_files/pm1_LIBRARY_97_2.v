...
module FAU ( 
  ...
  nor3   g08(.a(new_n37_), .b(new_n36_), .c(new_n32_), .O(new_n38_));
  nand2  g09(.a(new_n33_), .b(new_n31_), .O(new_n39_));
  oai21  g10(.a(new_n38_), .b(new_n33_), .c(new_n39_), .O(z02));
  ...
  nand3  g20(.a(x11), .b(x03), .c(x02), .O(new_n50_));
  aoi21  g21(.a(new_n50_), .b(x12), .c(new_n31_), .O(new_n51_));
  nor3   g22(.a(new_n51_), .b(new_n49_), .c(new_n30_), .O(z06));
  ...
  oai22  g29(.a(new_n58_), .b(new_n57_), .c(new_n56_), .d(new_n45_), .O(z08));
  ...
  nor3   g36(.a(new_n65_), .b(new_n49_), .c(new_n63_), .O(z10));
  nand3  g37(.a(x12), .b(x09), .c(x01), .O(new_n67_));
  inv1   g38(.a(new_n67_), .O(new_n68_));
  nor2   g39(.a(x12), .b(x01), .O(new_n69_));
  oai21  g40(.a(new_n69_), .b(new_n68_), .c(new_n31_), .O(new_n70_));
  nand4  g41(.a(new_n57_), .b(x12), .c(x09), .d(x01), .O(new_n71_));
  ...
  nand4  g45(.a(x11), .b(new_n54_), .c(new_n49_), .d(x00), .O(new_n75_));
  nor2   g46(.a(new_n75_), .b(new_n33_), .O(z12));
endmodule
