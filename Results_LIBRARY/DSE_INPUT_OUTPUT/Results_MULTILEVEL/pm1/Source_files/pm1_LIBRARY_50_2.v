...
module FAU ( 
  ...
  aoi21  g13(.a(new_n32_), .b(x11), .c(x14), .O(z04));
  nand2  g14(.a(new_n32_), .b(x11), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x13), .O(z05));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  oai21  g17(.a(x12), .b(new_n31_), .c(new_n46_), .O(new_n47_));
  ...
  nand3  g31(.a(new_n46_), .b(x12), .c(new_n53_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(x09), .c(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x12), .c(new_n31_), .O(z10));
  nand4  g35(.a(new_n46_), .b(x12), .c(x11), .d(new_n53_), .O(new_n65_));
  ...
  nand3  g40(.a(new_n53_), .b(new_n69_), .c(x00), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(x12), .c(new_n31_), .O(z12));
endmodule
