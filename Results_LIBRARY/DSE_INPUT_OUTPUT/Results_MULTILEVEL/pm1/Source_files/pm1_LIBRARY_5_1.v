...
module FAU ( 
  ...
  nand2  g13(.a(new_n43_), .b(x14), .O(z04));
  aoi21  g14(.a(x12), .b(new_n31_), .c(x13), .O(z05));
  nand3  g15(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  nand4  g16(.a(new_n46_), .b(new_n43_), .c(x09), .d(x01), .O(new_n47_));
  inv1   g17(.a(new_n47_), .O(z06));
  nand2  g18(.a(new_n43_), .b(x15), .O(z07));
  inv1   g19(.a(x00), .O(new_n50_));
  inv1   g20(.a(x10), .O(new_n51_));
  nand2  g21(.a(x03), .b(x02), .O(new_n52_));
  nand3  g22(.a(x12), .b(x09), .c(x04), .O(new_n53_));
  oai21  g23(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n54_));
  oai21  g24(.a(new_n54_), .b(new_n50_), .c(x11), .O(new_n55_));
  nand2  g25(.a(new_n32_), .b(new_n31_), .O(new_n56_));
  nand2  g26(.a(new_n56_), .b(new_n55_), .O(z08));
  nand2  g27(.a(new_n32_), .b(x11), .O(new_n58_));
  nand3  g28(.a(new_n58_), .b(new_n51_), .c(x00), .O(new_n59_));
  nand2  g29(.a(new_n59_), .b(new_n43_), .O(z09));
  inv1   g30(.a(x09), .O(new_n61_));
  nand4  g31(.a(new_n46_), .b(x12), .c(x11), .d(new_n51_), .O(new_n62_));
  nor3   g32(.a(new_n62_), .b(new_n61_), .c(new_n50_), .O(z10));
  nand4  g33(.a(new_n46_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  nand3  g34(.a(new_n32_), .b(x11), .c(new_n30_), .O(new_n65_));
  nand2  g35(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g36(.a(new_n66_), .b(new_n51_), .c(x00), .O(new_n67_));
  nand2  g37(.a(new_n67_), .b(new_n43_), .O(z11));
  nand3  g38(.a(new_n51_), .b(new_n61_), .c(x00), .O(new_n69_));
  aoi21  g39(.a(new_n69_), .b(x11), .c(new_n32_), .O(z12));
  one    g40(.O(z01));
endmodule
