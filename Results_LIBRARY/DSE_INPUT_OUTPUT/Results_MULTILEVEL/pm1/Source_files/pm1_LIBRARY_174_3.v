...
module FAU ( 
  ...
  oai21  g06(.a(x15), .b(new_n35_), .c(x12), .O(z01));
  ...
  aoi21  g14(.a(x15), .b(x12), .c(x14), .O(z04));
  aoi21  g15(.a(x15), .b(x12), .c(x13), .O(z05));
  nand3  g16(.a(new_n35_), .b(x09), .c(x01), .O(new_n46_));
  ...
  nand2  g22(.a(x15), .b(new_n30_), .O(z07));
  ...
  nand2  g28(.a(new_n30_), .b(new_n35_), .O(new_n58_));
  oai21  g29(.a(new_n33_), .b(new_n35_), .c(new_n58_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n53_), .c(x00), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z09));
  nand4  g32(.a(new_n49_), .b(new_n32_), .c(x12), .d(x11), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n53_), .c(x09), .d(x00), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(z10));
  inv1   g36(.a(x01), .O(new_n66_));
  nand4  g37(.a(new_n49_), .b(new_n32_), .c(x12), .d(x09), .O(new_n67_));
  nand2  g38(.a(new_n30_), .b(new_n66_), .O(new_n68_));
  oai21  g39(.a(new_n67_), .b(new_n66_), .c(new_n68_), .O(new_n69_));
  nand4  g40(.a(new_n69_), .b(x11), .c(new_n53_), .d(x00), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(z11));
  inv1   g42(.a(x09), .O(new_n72_));
  nand4  g43(.a(x11), .b(new_n53_), .c(new_n72_), .d(x00), .O(new_n73_));
  nor3   g44(.a(new_n73_), .b(x15), .c(new_n30_), .O(z12));
endmodule
