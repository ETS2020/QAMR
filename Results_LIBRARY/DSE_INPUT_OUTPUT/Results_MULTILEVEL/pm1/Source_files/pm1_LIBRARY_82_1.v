...
module FAU ( 
  ...
  nand2  g40(.a(new_n69_), .b(new_n51_), .O(z11));
  inv1   g41(.a(x09), .O(new_n71_));
  nand4  g42(.a(new_n53_), .b(new_n71_), .c(x06), .d(x00), .O(new_n72_));
