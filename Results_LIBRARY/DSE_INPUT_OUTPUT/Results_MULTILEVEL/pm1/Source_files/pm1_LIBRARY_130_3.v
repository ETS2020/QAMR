...
module FAU ( 
  ...
  oai21  g05(.a(x12), .b(new_n30_), .c(new_n34_), .O(z00));
  nand3  g06(.a(x12), .b(new_n31_), .c(new_n30_), .O(z01));
  ...
  nand4  g14(.a(new_n43_), .b(new_n42_), .c(x09), .d(new_n30_), .O(z03));
  nand2  g15(.a(x12), .b(x01), .O(new_n45_));
  ...
  aoi21  g21(.a(new_n50_), .b(new_n32_), .c(new_n30_), .O(z06));
  ...
  oai21  g29(.a(new_n41_), .b(x01), .c(new_n33_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n53_), .c(x00), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z09));
  nand3  g32(.a(new_n49_), .b(x11), .c(new_n53_), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nand3  g34(.a(new_n63_), .b(x09), .c(x00), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(new_n30_), .c(new_n32_), .O(z10));
  nand2  g36(.a(new_n30_), .b(x00), .O(new_n66_));
  nand3  g37(.a(new_n32_), .b(x11), .c(new_n53_), .O(new_n67_));
  oai21  g38(.a(new_n67_), .b(new_n66_), .c(new_n45_), .O(z11));
  inv1   g39(.a(x09), .O(new_n69_));
  nand4  g40(.a(x11), .b(new_n53_), .c(new_n69_), .d(x00), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(new_n30_), .c(new_n32_), .O(z12));
endmodule
