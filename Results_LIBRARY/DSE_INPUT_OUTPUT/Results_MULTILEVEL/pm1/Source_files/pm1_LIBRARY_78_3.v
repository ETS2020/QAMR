...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n40_, new_n41_, new_n42_,
  ...
  inv1   g08(.a(z02), .O(z10));
  nor2   g09(.a(z10), .b(x13), .O(z05));
  aoi21  g10(.a(x09), .b(x01), .c(x11), .O(new_n40_));
  nand3  g11(.a(x04), .b(x03), .c(x02), .O(new_n41_));
  nand3  g12(.a(new_n41_), .b(x09), .c(x01), .O(new_n42_));
  oai21  g13(.a(new_n40_), .b(new_n32_), .c(new_n42_), .O(z06));
  nand2  g14(.a(z02), .b(x15), .O(z07));
  inv1   g15(.a(x10), .O(new_n45_));
  nand4  g16(.a(new_n32_), .b(x11), .c(new_n45_), .d(x00), .O(z08));
  nand4  g17(.a(new_n32_), .b(new_n30_), .c(new_n45_), .d(x00), .O(new_n47_));
  inv1   g18(.a(new_n47_), .O(z09));
  inv1   g19(.a(x01), .O(new_n49_));
  nand3  g20(.a(new_n45_), .b(new_n49_), .c(x00), .O(new_n50_));
  aoi21  g21(.a(new_n50_), .b(new_n32_), .c(new_n30_), .O(z11));
  zero   g22(.O(z12));
