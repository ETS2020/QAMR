...
module FAU ( 
  ...
  nand2  g14(.a(new_n32_), .b(new_n39_), .O(new_n44_));
  ...
  aoi21  g20(.a(new_n32_), .b(new_n39_), .c(x15), .O(z07));
  ...
  nand2  g24(.a(new_n53_), .b(new_n39_), .O(z08));
  nand4  g25(.a(x12), .b(x11), .c(new_n39_), .d(x00), .O(new_n55_));
  inv1   g26(.a(new_n55_), .O(z09));
  inv1   g27(.a(x00), .O(new_n57_));
  inv1   g28(.a(x09), .O(new_n58_));
  nand3  g29(.a(x04), .b(x03), .c(x02), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(x12), .c(x11), .d(new_n39_), .O(new_n60_));
  ...
  nand3  g35(.a(x11), .b(new_n58_), .c(x00), .O(new_n65_));
