...
module FAU ( 
  ...
  nand2  g11(.a(new_n34_), .b(x12), .O(new_n41_));
  ...
  oai21  g23(.a(z07), .b(x15), .c(new_n52_), .O(new_n53_));
  ...
  nand3  g29(.a(new_n58_), .b(new_n51_), .c(x00), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n41_), .O(z09));
  nand4  g31(.a(new_n47_), .b(x15), .c(x12), .d(x11), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n51_), .c(x09), .d(x00), .O(new_n63_));
  ...
  nand2  g39(.a(new_n68_), .b(new_n41_), .O(z11));
  inv1   g40(.a(x09), .O(new_n70_));
  nand4  g41(.a(x11), .b(new_n51_), .c(new_n70_), .d(x00), .O(new_n71_));
  aoi21  g42(.a(new_n71_), .b(x15), .c(new_n32_), .O(z12));
endmodule
