...
module FAU ( 
  ...
  oai21  g08(.a(new_n37_), .b(x14), .c(x12), .O(z02));
  ...
  nand2  g25(.a(new_n54_), .b(z04), .O(new_n55_));
  ...
  nand4  g31(.a(new_n46_), .b(z04), .c(x12), .d(x11), .O(new_n61_));
  ...
  nand2  g39(.a(new_n68_), .b(new_n45_), .O(z11));
  inv1   g40(.a(x09), .O(new_n70_));
  nand4  g41(.a(x11), .b(new_n53_), .c(new_n70_), .d(x00), .O(new_n71_));
  nor3   g42(.a(new_n71_), .b(x14), .c(new_n32_), .O(z12));
endmodule
