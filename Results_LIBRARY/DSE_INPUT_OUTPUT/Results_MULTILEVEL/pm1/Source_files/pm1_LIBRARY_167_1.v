...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n36_, new_n37_, new_n38_,
    ...
    new_n50_, new_n51_, new_n54_, new_n55_, new_n57_, new_n60_, new_n61_;
  ...
  oai21  g14(.a(new_n31_), .b(x10), .c(x14), .O(z04));
  nor2   g15(.a(new_n31_), .b(x10), .O(new_n45_));
  nor2   g16(.a(new_n45_), .b(x13), .O(z05));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  oai21  g18(.a(new_n31_), .b(x10), .c(new_n47_), .O(new_n48_));
  nand3  g19(.a(x12), .b(new_n34_), .c(x10), .O(new_n49_));
  ...
  nand2  g26(.a(new_n55_), .b(new_n30_), .O(z08));
  nand2  g27(.a(new_n34_), .b(x00), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n31_), .c(x10), .O(z09));
  inv1   g29(.a(x01), .O(new_n60_));
  nand3  g30(.a(x11), .b(new_n60_), .c(x00), .O(new_n61_));
  aoi21  g31(.a(new_n61_), .b(new_n31_), .c(x10), .O(z11));
  zero   g32(.O(z10));
  zero   g33(.O(z12));
endmodule
