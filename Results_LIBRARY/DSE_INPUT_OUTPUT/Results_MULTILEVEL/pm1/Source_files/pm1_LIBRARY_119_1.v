...
module FAU ( 
  ...
  aoi21  g18(.a(x09), .b(x01), .c(x12), .O(new_n48_));
  ...
  nand3  g30(.a(x12), .b(x11), .c(x04), .O(new_n60_));
  oai21  g31(.a(x12), .b(x11), .c(new_n60_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(new_n54_), .c(x00), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z09));
  aoi21  g34(.a(x03), .b(x02), .c(new_n34_), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n54_), .c(x09), .d(x00), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(x04), .c(new_n31_), .O(z10));
  nand4  g37(.a(new_n57_), .b(x12), .c(x09), .d(x01), .O(new_n67_));
  inv1   g38(.a(x01), .O(new_n68_));
  nand2  g39(.a(new_n31_), .b(new_n68_), .O(new_n69_));
  ...
  aoi21  g45(.a(new_n74_), .b(x04), .c(new_n31_), .O(z12));
endmodule
