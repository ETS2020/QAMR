...
module FAU ( 
  ...
  nand4  g18(.a(z01), .b(new_n32_), .c(new_n49_), .d(x00), .O(new_n50_));
  inv1   g19(.a(new_n50_), .O(z09));
  inv1   g20(.a(x01), .O(new_n52_));
  nand4  g21(.a(x11), .b(new_n49_), .c(new_n52_), .d(x00), .O(new_n53_));
  nor2   g22(.a(new_n53_), .b(x12), .O(z11));
  one    g23(.O(z02));
  one    g24(.O(z03));
  inv1   g25(.a(new_n37_), .O(z12));
endmodule
