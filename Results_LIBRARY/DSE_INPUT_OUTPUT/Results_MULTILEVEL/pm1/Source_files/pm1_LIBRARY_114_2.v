...
module FAU ( 
  ...
  nor2   g23(.a(new_n31_), .b(new_n42_), .O(new_n53_));
  nand4  g24(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(new_n53_), .c(new_n52_), .d(x00), .O(z08));
  nand3  g26(.a(new_n47_), .b(new_n52_), .c(x00), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n44_), .O(z09));
  nand3  g28(.a(x04), .b(x03), .c(x02), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n52_), .c(x09), .d(x00), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(x12), .c(new_n42_), .O(z10));
  nand4  g31(.a(new_n58_), .b(x12), .c(x11), .d(new_n52_), .O(new_n61_));
  ...
  nand3  g36(.a(new_n52_), .b(new_n65_), .c(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x12), .c(new_n42_), .O(z12));
endmodule
