...
module FAU ( 
  ...
  nand4  g26(.a(new_n45_), .b(new_n49_), .c(x09), .d(x00), .O(new_n57_));
  aoi21  g27(.a(new_n57_), .b(x11), .c(new_n40_), .O(z10));
  nand4  g28(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n59_));
  nand2  g29(.a(new_n40_), .b(new_n30_), .O(new_n60_));
  ...
  nand4  g33(.a(x11), .b(new_n49_), .c(new_n50_), .d(x00), .O(new_n64_));
