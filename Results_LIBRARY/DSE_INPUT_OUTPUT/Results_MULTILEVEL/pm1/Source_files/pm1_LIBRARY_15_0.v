...
module FAU ( 
  ...
  nand2  g04(.a(x15), .b(new_n32_), .O(new_n34_));
  ...
  oai21  g21(.a(new_n49_), .b(new_n44_), .c(new_n50_), .O(new_n51_));
  ...
  nand4  g29(.a(new_n58_), .b(new_n55_), .c(new_n45_), .d(x00), .O(z08));
  inv1   g30(.a(x10), .O(new_n60_));
  oai21  g31(.a(new_n34_), .b(x11), .c(new_n35_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(new_n60_), .c(x00), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z09));
  nand4  g34(.a(new_n48_), .b(x12), .c(x11), .d(new_n60_), .O(new_n64_));
  ...
  nand3  g39(.a(x15), .b(new_n32_), .c(new_n30_), .O(new_n69_));
  ...
  nand2  g43(.a(new_n56_), .b(x00), .O(new_n73_));
  nand2  g44(.a(new_n41_), .b(new_n60_), .O(new_n74_));
