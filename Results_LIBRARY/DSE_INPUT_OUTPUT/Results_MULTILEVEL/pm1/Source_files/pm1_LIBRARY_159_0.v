...
module FAU ( 
  ...
  nand2  g04(.a(new_n32_), .b(x03), .O(new_n34_));
  ...
  nand3  g31(.a(new_n32_), .b(new_n31_), .c(x03), .O(new_n61_));
  ...
  nand3  g40(.a(new_n32_), .b(x03), .c(new_n30_), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand4  g42(.a(new_n71_), .b(x11), .c(new_n60_), .d(x00), .O(new_n72_));
