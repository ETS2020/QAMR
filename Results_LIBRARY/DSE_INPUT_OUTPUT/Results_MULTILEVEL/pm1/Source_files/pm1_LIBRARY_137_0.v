...
module FAU ( 
  ...
  oai21  g20(.a(new_n49_), .b(new_n45_), .c(z01), .O(new_n50_));
  ...
  nand3  g31(.a(new_n32_), .b(new_n31_), .c(x07), .O(new_n61_));
  oai21  g32(.a(new_n32_), .b(new_n31_), .c(new_n61_), .O(new_n62_));
  ...
  nor3   g37(.a(new_n66_), .b(new_n42_), .c(new_n65_), .O(z10));
  nand4  g38(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n68_));
  nand3  g39(.a(new_n32_), .b(x07), .c(new_n30_), .O(new_n69_));
  ...
  nand3  g44(.a(x12), .b(x11), .c(new_n55_), .O(new_n74_));
  oai21  g45(.a(new_n74_), .b(new_n73_), .c(new_n54_), .O(z12));
endmodule
