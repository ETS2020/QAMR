...
module FAU ( 
  ...
  nand2  g05(.a(x15), .b(new_n32_), .O(new_n35_));
  ...
  nand2  g32(.a(new_n61_), .b(new_n53_), .O(z09));
  ...
  nand2  g36(.a(new_n65_), .b(new_n53_), .O(z10));
  nand4  g37(.a(new_n47_), .b(x12), .c(x09), .d(x01), .O(new_n67_));
  nand3  g38(.a(x15), .b(new_n32_), .c(new_n30_), .O(new_n68_));
