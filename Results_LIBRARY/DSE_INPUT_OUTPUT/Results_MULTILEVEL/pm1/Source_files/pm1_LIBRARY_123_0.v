...
module FAU ( 
  ...
  nor2   g11(.a(x12), .b(x11), .O(new_n42_));
  ...
  oai21  g24(.a(x12), .b(x11), .c(new_n54_), .O(z09));
  inv1   g25(.a(x00), .O(new_n56_));
  nand4  g26(.a(new_n45_), .b(x12), .c(x11), .d(new_n51_), .O(new_n57_));
  nor3   g27(.a(new_n57_), .b(new_n36_), .c(new_n56_), .O(z10));
  ...
  nand4  g32(.a(new_n62_), .b(x11), .c(new_n51_), .d(x00), .O(new_n63_));
  inv1   g33(.a(new_n63_), .O(z11));
  nand4  g34(.a(x11), .b(new_n51_), .c(new_n36_), .d(x00), .O(new_n65_));
  nor2   g35(.a(new_n65_), .b(new_n37_), .O(z12));
  one    g36(.O(z00));
endmodule
