...
module FAU ( 
  ...
  nand4  g16(.a(new_n38_), .b(new_n30_), .c(new_n45_), .d(x00), .O(new_n47_));
  inv1   g17(.a(new_n47_), .O(z09));
  inv1   g18(.a(x01), .O(new_n50_));
  nand3  g19(.a(new_n45_), .b(new_n50_), .c(x00), .O(new_n51_));
  aoi21  g20(.a(new_n51_), .b(new_n38_), .c(new_n30_), .O(z11));
  one    g21(.O(z02));
  zero   g22(.O(z10));
  zero   g23(.O(z12));
endmodule
