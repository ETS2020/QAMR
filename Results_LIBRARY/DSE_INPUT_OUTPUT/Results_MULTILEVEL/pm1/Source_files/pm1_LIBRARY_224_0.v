...
module FAU ( 
  ...
  nor2   g22(.a(new_n38_), .b(new_n51_), .O(new_n52_));
  nand4  g23(.a(new_n52_), .b(x04), .c(x03), .d(x02), .O(new_n53_));
  nand4  g24(.a(new_n53_), .b(x11), .c(new_n50_), .d(x00), .O(z08));
  nand3  g25(.a(new_n39_), .b(new_n50_), .c(x00), .O(new_n55_));
  inv1   g26(.a(new_n55_), .O(z09));
  nand4  g27(.a(new_n44_), .b(x12), .c(x11), .d(new_n50_), .O(new_n57_));
  ...
  nand2  g33(.a(new_n38_), .b(new_n62_), .O(new_n63_));
  ...
  nand4  g37(.a(x11), .b(new_n50_), .c(new_n51_), .d(x00), .O(new_n67_));
  nor2   g38(.a(new_n67_), .b(new_n38_), .O(z12));
endmodule
