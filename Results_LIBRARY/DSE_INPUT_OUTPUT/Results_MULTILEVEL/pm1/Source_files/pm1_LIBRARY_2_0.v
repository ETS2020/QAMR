...
module FAU ( 
  ...
  nand2  g04(.a(new_n32_), .b(x10), .O(new_n34_));
  ...
  oai21  g14(.a(x12), .b(x10), .c(x14), .O(z04));
  ...
  nand2  g28(.a(x11), .b(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x12), .c(x10), .O(z09));
  nand3  g30(.a(new_n47_), .b(x11), .c(x09), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x12), .c(x10), .O(z10));
  nand3  g34(.a(new_n61_), .b(x01), .c(x00), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x12), .c(x10), .O(z11));
  inv1   g36(.a(x09), .O(new_n66_));
  nand3  g37(.a(x11), .b(new_n66_), .c(x00), .O(new_n67_));
