...
module FAU ( 
  ...
  aoi21  g15(.a(new_n31_), .b(x11), .c(x13), .O(z05));
  ...
  nor2   g21(.a(new_n31_), .b(new_n33_), .O(new_n51_));
  nand4  g22(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n52_));
  nand4  g23(.a(new_n52_), .b(new_n51_), .c(new_n50_), .d(x00), .O(z08));
  nand3  g24(.a(z01), .b(new_n50_), .c(x00), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(new_n43_), .O(z09));
  nand3  g26(.a(x04), .b(x03), .c(x02), .O(new_n56_));
  nand3  g27(.a(new_n56_), .b(new_n50_), .c(x09), .O(new_n57_));
  inv1   g28(.a(new_n57_), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(x00), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(x12), .c(new_n33_), .O(z10));
  nand3  g31(.a(new_n58_), .b(x01), .c(x00), .O(new_n61_));
