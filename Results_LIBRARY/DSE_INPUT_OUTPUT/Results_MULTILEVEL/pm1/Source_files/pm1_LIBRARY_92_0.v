...
module FAU ( 
  ...
  nand2  g04(.a(new_n30_), .b(x05), .O(new_n34_));
  ...
  oai21  g22(.a(new_n50_), .b(new_n46_), .c(new_n51_), .O(new_n52_));
  ...
  nor2   g27(.a(new_n33_), .b(x10), .O(new_n57_));
  nor2   g28(.a(new_n30_), .b(new_n43_), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(x04), .c(x03), .d(x02), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n57_), .c(new_n56_), .d(x00), .O(z08));
  inv1   g31(.a(x10), .O(new_n61_));
  xnor2a g32(.a(x12), .b(x11), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n61_), .c(x00), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n56_), .O(z09));
  ...
  nand2  g38(.a(new_n67_), .b(new_n56_), .O(z10));
  inv1   g39(.a(x01), .O(new_n69_));
  nand4  g40(.a(x11), .b(new_n61_), .c(new_n69_), .d(x00), .O(new_n70_));
  ...
  nand4  g45(.a(x11), .b(new_n61_), .c(new_n43_), .d(x00), .O(new_n75_));
