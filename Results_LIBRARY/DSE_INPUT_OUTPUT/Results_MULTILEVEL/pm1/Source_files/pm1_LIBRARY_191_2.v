...
module FAU ( 
  ...
  nand3  g31(.a(new_n60_), .b(x12), .c(new_n52_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(x09), .c(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x12), .c(new_n33_), .O(z10));
  nand3  g35(.a(new_n60_), .b(new_n52_), .c(x09), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(x01), .c(x00), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(x12), .c(new_n33_), .O(z11));
  inv1   g39(.a(x09), .O(new_n69_));
  nand4  g40(.a(x11), .b(new_n52_), .c(new_n69_), .d(x00), .O(new_n70_));
