...
module FAU ( 
  ...
  oai21  g05(.a(z05), .b(new_n31_), .c(x12), .O(z01));
  ...
  nand3  g28(.a(x13), .b(x12), .c(x11), .O(new_n58_));
  ...
  inv1   g36(.a(new_n44_), .O(new_n66_));
  ...
  nand4  g42(.a(x11), .b(new_n53_), .c(new_n36_), .d(x00), .O(new_n72_));
