...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n40_, new_n41_, new_n42_,
  ...
  nor2   g05(.a(z01), .b(new_n30_), .O(new_n35_));
  inv1   g06(.a(new_n35_), .O(z02));
  nor2   g07(.a(new_n35_), .b(x14), .O(z04));
  nor2   g08(.a(new_n35_), .b(x13), .O(z05));
  ...
  aoi21  g22(.a(new_n53_), .b(z01), .c(new_n30_), .O(z11));
  one    g23(.O(z03));
  zero   g24(.O(z10));
  zero   g25(.O(z12));
endmodule
