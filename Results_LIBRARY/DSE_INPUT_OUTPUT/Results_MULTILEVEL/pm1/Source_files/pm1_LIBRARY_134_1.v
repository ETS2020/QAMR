...
module FAU ( 
  ...
  nand3  g04(.a(x12), .b(new_n31_), .c(x05), .O(z01));
  nand4  g05(.a(x09), .b(x08), .c(x07), .d(x06), .O(new_n35_));
  oai21  g06(.a(new_n35_), .b(new_n31_), .c(x05), .O(new_n36_));
  nand2  g07(.a(new_n36_), .b(x12), .O(z02));
  nand3  g08(.a(x08), .b(x07), .c(x06), .O(new_n38_));
  nand3  g09(.a(new_n38_), .b(x11), .c(x09), .O(new_n39_));
  nand2  g10(.a(new_n39_), .b(x05), .O(new_n40_));
  ...
  nand2  g24(.a(new_n53_), .b(x05), .O(new_n54_));
  ...
  oai21  g29(.a(new_n32_), .b(x05), .c(new_n58_), .O(z09));
  ...
  aoi21  g33(.a(new_n62_), .b(x05), .c(new_n32_), .O(z10));
  nand4  g34(.a(new_n48_), .b(x12), .c(x09), .d(x05), .O(new_n64_));
  ...
  nand4  g40(.a(new_n52_), .b(new_n69_), .c(x05), .d(x00), .O(new_n70_));
