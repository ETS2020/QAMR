...
module FAU ( 
  ...
  nand2  g27(.a(new_n55_), .b(new_n38_), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(new_n49_), .c(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z09));
  nand3  g30(.a(new_n44_), .b(x11), .c(new_n49_), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(x09), .c(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x11), .c(new_n54_), .O(z10));
  nand4  g34(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  nand2  g35(.a(new_n54_), .b(new_n30_), .O(new_n65_));
  ...
  nand3  g40(.a(new_n49_), .b(new_n69_), .c(x00), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(x11), .c(new_n54_), .O(z12));
endmodule
