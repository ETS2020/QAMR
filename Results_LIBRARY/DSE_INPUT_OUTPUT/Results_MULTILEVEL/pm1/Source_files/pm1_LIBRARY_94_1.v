...
module FAU ( 
  ...
  xnor2a g20(.a(x12), .b(x11), .O(new_n51_));
  ...
  nand3  g26(.a(new_n47_), .b(x11), .c(new_n30_), .O(new_n57_));
  nand2  g27(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand3  g28(.a(new_n58_), .b(new_n45_), .c(x00), .O(new_n59_));
  nand2  g29(.a(new_n59_), .b(new_n38_), .O(z11));
