...
module FAU ( 
  ...
  nand3  g24(.a(new_n54_), .b(new_n49_), .c(x00), .O(new_n55_));
  inv1   g25(.a(new_n55_), .O(z09));
  inv1   g26(.a(x00), .O(new_n57_));
  nand4  g27(.a(new_n45_), .b(x12), .c(x11), .d(new_n49_), .O(new_n58_));
  nor3   g28(.a(new_n58_), .b(new_n50_), .c(new_n57_), .O(z10));
  nand4  g29(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  nand3  g30(.a(new_n40_), .b(x11), .c(new_n30_), .O(new_n61_));
  nand2  g31(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g32(.a(new_n62_), .b(new_n49_), .c(x00), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(new_n43_), .O(z11));
  nand4  g34(.a(x11), .b(new_n49_), .c(new_n50_), .d(x00), .O(new_n65_));
  nor2   g35(.a(new_n65_), .b(new_n40_), .O(z12));
  one    g36(.O(z01));
endmodule
