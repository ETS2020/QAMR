...
module FAU ( 
  ...
  nand4  g10(.a(new_n39_), .b(new_n37_), .c(x14), .d(x12), .O(z02));
  nand2  g11(.a(new_n38_), .b(new_n37_), .O(new_n41_));
  nand2  g12(.a(new_n41_), .b(x14), .O(new_n42_));
  nand2  g13(.a(new_n42_), .b(x12), .O(z03));
  aoi21  g14(.a(z04), .b(x12), .c(x13), .O(z05));
  nand2  g15(.a(z04), .b(x12), .O(new_n45_));
  ...
  nand4  g35(.a(new_n46_), .b(x14), .c(x12), .d(x09), .O(new_n65_));
  ...
  nand4  g40(.a(x11), .b(new_n53_), .c(new_n36_), .d(x00), .O(new_n70_));
