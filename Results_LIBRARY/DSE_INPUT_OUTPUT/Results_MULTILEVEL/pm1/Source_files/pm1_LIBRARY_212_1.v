...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n39_,
    new_n41_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
  ...
  aoi21  g13(.a(x15), .b(new_n30_), .c(x14), .O(z04));
  ...
  nand4  g21(.a(new_n46_), .b(x12), .c(x09), .d(x04), .O(new_n51_));
  ...
  nor2   g40(.a(new_n69_), .b(new_n30_), .O(z12));
endmodule
