...
module FAU ( 
  ...
  oai21  g12(.a(new_n41_), .b(new_n34_), .c(x09), .O(new_n42_));
  oai21  g13(.a(new_n30_), .b(x09), .c(new_n42_), .O(z03));
  ...
  inv1   g24(.a(new_n44_), .O(new_n54_));
  nor2   g25(.a(new_n48_), .b(x10), .O(new_n55_));
  ...
  nand3  g29(.a(new_n30_), .b(new_n48_), .c(x09), .O(new_n59_));
  ...
  nand4  g44(.a(x11), .b(new_n58_), .c(new_n33_), .d(x00), .O(new_n74_));
