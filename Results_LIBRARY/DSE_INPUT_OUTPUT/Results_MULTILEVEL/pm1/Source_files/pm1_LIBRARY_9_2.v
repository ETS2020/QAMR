...
module FAU ( 
  ...
  nand3  g29(.a(new_n48_), .b(new_n54_), .c(x00), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n52_), .O(z09));
  nand3  g31(.a(new_n46_), .b(new_n54_), .c(x09), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x12), .c(new_n31_), .O(z10));
  nand3  g35(.a(new_n62_), .b(x01), .c(x00), .O(new_n65_));
