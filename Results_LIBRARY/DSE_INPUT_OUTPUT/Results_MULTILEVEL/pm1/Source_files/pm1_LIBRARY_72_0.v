...
module FAU ( 
  ...
  nand2  g16(.a(new_n46_), .b(x11), .O(new_n47_));
  ...
  oai21  g22(.a(new_n46_), .b(new_n52_), .c(new_n37_), .O(z09));
  inv1   g23(.a(x00), .O(new_n54_));
  inv1   g24(.a(x09), .O(new_n55_));
  nand4  g25(.a(new_n41_), .b(x12), .c(x11), .d(new_n45_), .O(new_n56_));
  nor3   g26(.a(new_n56_), .b(new_n55_), .c(new_n54_), .O(z10));
  nand4  g27(.a(new_n41_), .b(x12), .c(x09), .d(x01), .O(new_n58_));
  inv1   g28(.a(x01), .O(new_n59_));
  nand2  g29(.a(new_n39_), .b(new_n59_), .O(new_n60_));
  nand2  g30(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nand4  g31(.a(new_n61_), .b(x11), .c(new_n45_), .d(x00), .O(new_n62_));
  inv1   g32(.a(new_n62_), .O(z11));
  nand4  g33(.a(x11), .b(new_n45_), .c(new_n55_), .d(x00), .O(new_n64_));
  nor2   g34(.a(new_n64_), .b(new_n39_), .O(z12));
  one    g35(.O(z00));
  buf    g36(.a(x11), .O(z01));
endmodule
