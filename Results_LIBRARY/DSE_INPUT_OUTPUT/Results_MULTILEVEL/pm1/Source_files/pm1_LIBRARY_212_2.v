...
module FAU ( 
  ...
  aoi21  g13(.a(new_n31_), .b(x12), .c(x14), .O(z04));
  nand2  g14(.a(new_n31_), .b(x12), .O(new_n44_));
  ...
  nor2   g22(.a(x15), .b(x12), .O(z07));
  inv1   g23(.a(x10), .O(new_n53_));
  nand3  g24(.a(x11), .b(new_n53_), .c(x00), .O(new_n54_));
  oai21  g25(.a(x15), .b(new_n30_), .c(new_n54_), .O(new_n55_));
  ...
  nand3  g33(.a(new_n49_), .b(x11), .c(new_n53_), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(x09), .c(x00), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(x15), .c(new_n30_), .O(z10));
  ...
  nor3   g45(.a(new_n74_), .b(new_n31_), .c(new_n30_), .O(z12));
endmodule
