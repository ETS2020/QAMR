...
module FAU ( 
  ...
  nand2  g07(.a(x13), .b(x11), .O(new_n37_));
  ...
  nand4  g12(.a(new_n41_), .b(x13), .c(x12), .d(x11), .O(z02));
  ...
  aoi21  g17(.a(new_n34_), .b(x11), .c(x14), .O(z04));
  nor2   g18(.a(x13), .b(x11), .O(z05));
  ...
  nand3  g34(.a(new_n63_), .b(x12), .c(new_n55_), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(x09), .c(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x13), .c(new_n31_), .O(z10));
  ...
  aoi21  g42(.a(new_n71_), .b(x13), .c(new_n31_), .O(z11));
  inv1   g43(.a(x09), .O(new_n73_));
  nand4  g44(.a(x12), .b(new_n55_), .c(new_n73_), .d(x00), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(x13), .c(new_n31_), .O(z12));
endmodule
