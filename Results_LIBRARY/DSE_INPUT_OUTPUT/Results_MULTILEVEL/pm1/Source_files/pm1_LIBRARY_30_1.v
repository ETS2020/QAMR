...
module FAU ( 
  ...
  aoi21  g15(.a(x13), .b(new_n30_), .c(x14), .O(z04));
  ...
  oai21  g27(.a(new_n43_), .b(x11), .c(new_n56_), .O(new_n57_));
  ...
  nand4  g36(.a(x11), .b(new_n55_), .c(new_n65_), .d(x00), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(z05), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n30_), .O(new_n68_));
  inv1   g39(.a(new_n63_), .O(new_n69_));
  nand4  g40(.a(new_n69_), .b(x09), .c(x01), .d(x00), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n68_), .O(z11));
  nand4  g42(.a(x11), .b(new_n55_), .c(new_n61_), .d(x00), .O(new_n72_));
