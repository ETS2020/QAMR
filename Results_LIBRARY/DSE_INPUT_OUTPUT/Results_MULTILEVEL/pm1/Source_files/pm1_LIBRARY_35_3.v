...
module FAU ( 
  ...
  nor2   g04(.a(z01), .b(new_n31_), .O(new_n34_));
  inv1   g05(.a(new_n34_), .O(z02));
  nor2   g06(.a(new_n34_), .b(x14), .O(z04));
  nor2   g07(.a(new_n34_), .b(x13), .O(z05));
  ...
  nand4  g16(.a(z01), .b(x11), .c(new_n46_), .d(x00), .O(z08));
  nand4  g17(.a(z01), .b(new_n31_), .c(new_n46_), .d(x00), .O(new_n48_));
  nand2  g18(.a(new_n48_), .b(z02), .O(z09));
  nand4  g19(.a(x11), .b(new_n46_), .c(new_n30_), .d(x00), .O(new_n51_));
