...
module FAU ( 
  ...
  aoi21  g13(.a(x12), .b(new_n31_), .c(x14), .O(z04));
  ...
  nand3  g28(.a(new_n57_), .b(new_n50_), .c(x00), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(z01), .O(z09));
  inv1   g30(.a(x09), .O(new_n60_));
  nand4  g31(.a(new_n45_), .b(x12), .c(x11), .d(new_n50_), .O(new_n61_));
  nor3   g32(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(z10));
  ...
  nand3  g36(.a(new_n65_), .b(new_n50_), .c(x00), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(z01), .O(z11));
  nand3  g38(.a(new_n50_), .b(new_n60_), .c(x00), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(x11), .c(new_n32_), .O(z12));
endmodule
