...
module FAU ( 
  ...
  nand2  g08(.a(new_n39_), .b(z01), .O(new_n40_));
  nand2  g09(.a(x12), .b(new_n31_), .O(new_n41_));
  nand2  g10(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand3  g11(.a(new_n42_), .b(x09), .c(x01), .O(new_n43_));
  inv1   g12(.a(new_n43_), .O(z06));
  nor2   g13(.a(z10), .b(x15), .O(z07));
  inv1   g14(.a(x00), .O(new_n46_));
  oai21  g15(.a(x10), .b(new_n46_), .c(z01), .O(new_n47_));
  nand2  g16(.a(new_n47_), .b(x11), .O(z08));
  inv1   g17(.a(x10), .O(new_n49_));
  nand4  g18(.a(z01), .b(new_n31_), .c(new_n49_), .d(x00), .O(new_n50_));
  inv1   g19(.a(new_n50_), .O(z09));
  nand3  g20(.a(new_n49_), .b(new_n30_), .c(x00), .O(new_n52_));
  aoi21  g21(.a(new_n52_), .b(z01), .c(new_n31_), .O(z11));
  one    g22(.O(z02));
  one    g23(.O(z03));
  nor2   g24(.a(z01), .b(new_n31_), .O(z12));
endmodule
