...
module FAU ( 
  ...
  nor2   g09(.a(new_n31_), .b(new_n38_), .O(new_n39_));
  nand3  g10(.a(new_n34_), .b(x08), .c(x07), .O(new_n40_));
  nand3  g11(.a(new_n40_), .b(new_n39_), .c(x09), .O(z03));
  nor2   g12(.a(x12), .b(new_n38_), .O(new_n42_));
  nor2   g13(.a(new_n42_), .b(x14), .O(z04));
  inv1   g14(.a(new_n42_), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x13), .O(z05));
  nand2  g16(.a(x12), .b(new_n38_), .O(new_n46_));
  ...
  nand3  g24(.a(new_n46_), .b(new_n51_), .c(x00), .O(new_n54_));
  ...
  nand3  g31(.a(new_n58_), .b(new_n51_), .c(x09), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(x01), .c(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x12), .c(new_n38_), .O(z11));
  nand4  g35(.a(x11), .b(new_n51_), .c(new_n57_), .d(x00), .O(new_n65_));
