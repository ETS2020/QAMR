...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n37_, new_n40_, new_n41_, new_n42_,
    new_n43_, new_n46_, new_n48_, new_n51_, new_n52_;
  ...
  nand2  g13(.a(new_n37_), .b(x15), .O(z07));
  ...
  inv1   g18(.a(new_n37_), .O(z10));
  inv1   g19(.a(x01), .O(new_n51_));
  nand3  g20(.a(new_n46_), .b(new_n51_), .c(x00), .O(new_n52_));
  aoi21  g21(.a(new_n52_), .b(new_n30_), .c(new_n32_), .O(z11));
  one    g22(.O(z02));
  one    g23(.O(z03));
  zero   g24(.O(z12));
endmodule
