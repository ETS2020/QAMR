...
module FAU ( 
  ...
  nand2  g12(.a(x13), .b(new_n30_), .O(new_n42_));
  nand2  g13(.a(new_n42_), .b(new_n41_), .O(z03));
  inv1   g14(.a(x13), .O(new_n44_));
  aoi21  g15(.a(new_n44_), .b(new_n30_), .c(x14), .O(z04));
  ...
  nand2  g20(.a(new_n44_), .b(new_n30_), .O(new_n50_));
  ...
  oai21  g28(.a(new_n42_), .b(x11), .c(new_n57_), .O(new_n58_));
