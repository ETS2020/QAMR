...
module FAU ( 
  ...
  nand2  g16(.a(new_n46_), .b(z01), .O(new_n47_));
  nand3  g17(.a(new_n47_), .b(x09), .c(x01), .O(new_n48_));
  inv1   g18(.a(new_n48_), .O(z06));
  aoi21  g19(.a(new_n37_), .b(new_n31_), .c(x15), .O(z07));
  inv1   g20(.a(x10), .O(new_n51_));
  nand4  g21(.a(new_n38_), .b(x04), .c(x03), .d(x02), .O(new_n52_));
  ...
  nand4  g25(.a(new_n45_), .b(x12), .c(x11), .d(new_n51_), .O(new_n56_));
  ...
  nand2  g31(.a(new_n37_), .b(new_n61_), .O(new_n62_));
  ...
  nand4  g35(.a(x11), .b(new_n51_), .c(new_n36_), .d(x00), .O(new_n66_));
  nor2   g36(.a(new_n66_), .b(new_n37_), .O(z12));
  one    g37(.O(z00));
endmodule
