...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n39_,
    new_n40_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
  ...
  nand4  g26(.a(new_n55_), .b(new_n52_), .c(new_n50_), .d(x00), .O(z08));
  inv1   g27(.a(x10), .O(new_n57_));
  nand3  g28(.a(x14), .b(new_n30_), .c(new_n33_), .O(new_n58_));
  ...
  nand2  g43(.a(new_n39_), .b(new_n57_), .O(new_n73_));
