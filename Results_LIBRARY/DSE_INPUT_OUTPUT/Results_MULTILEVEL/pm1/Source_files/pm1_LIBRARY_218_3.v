...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n38_, new_n39_, new_n40_, new_n43_, new_n44_,
  ...
  aoi21  g07(.a(x09), .b(x01), .c(x11), .O(new_n38_));
  nand3  g08(.a(x04), .b(x03), .c(x02), .O(new_n39_));
  nand3  g09(.a(new_n39_), .b(x09), .c(x01), .O(new_n40_));
  oai21  g10(.a(new_n38_), .b(z01), .c(new_n40_), .O(z06));
  nand2  g11(.a(z02), .b(x15), .O(z07));
  inv1   g12(.a(x00), .O(new_n43_));
  oai21  g13(.a(x10), .b(new_n43_), .c(z01), .O(new_n44_));
  nand2  g14(.a(new_n44_), .b(x11), .O(z08));
  inv1   g15(.a(x10), .O(new_n46_));
  nand4  g16(.a(z01), .b(new_n31_), .c(new_n46_), .d(x00), .O(new_n47_));
  nand2  g17(.a(new_n47_), .b(z02), .O(z09));
  nand4  g18(.a(x11), .b(new_n46_), .c(new_n30_), .d(x00), .O(new_n50_));
