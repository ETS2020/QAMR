...
module FAU ( 
  ...
  nand2  g04(.a(new_n30_), .b(x07), .O(new_n34_));
  ...
  nor2   g13(.a(x12), .b(x07), .O(new_n43_));
  ...
  nand2  g25(.a(new_n54_), .b(new_n46_), .O(new_n55_));
  ...
  nand2  g30(.a(new_n59_), .b(new_n46_), .O(z09));
  ...
  nand2  g35(.a(new_n64_), .b(new_n46_), .O(z10));
  ...
  nand2  g44(.a(new_n40_), .b(new_n53_), .O(new_n74_));
