...
module FAU ( 
  ...
  nand2  g20(.a(new_n39_), .b(new_n31_), .O(new_n50_));
  ...
  nand2  g28(.a(new_n39_), .b(x09), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n48_), .c(new_n57_), .O(z08));
  xnor2a g30(.a(x12), .b(x11), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(new_n55_), .c(x00), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n47_), .O(z09));
  nand3  g33(.a(new_n48_), .b(x11), .c(new_n55_), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(x09), .c(x00), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(x14), .c(new_n32_), .O(z10));
  nand4  g37(.a(new_n48_), .b(x14), .c(x12), .d(x09), .O(new_n67_));
  ...
  nor3   g44(.a(new_n73_), .b(new_n38_), .c(new_n32_), .O(z12));
endmodule
