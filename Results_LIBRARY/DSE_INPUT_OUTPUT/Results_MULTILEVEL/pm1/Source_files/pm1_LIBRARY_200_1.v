...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n39_,
    ...
    new_n51_, new_n54_, new_n55_, new_n56_, new_n58_, new_n61_;
  ...
  nand4  g28(.a(new_n32_), .b(new_n31_), .c(new_n54_), .d(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z09));
  nand4  g30(.a(x11), .b(new_n54_), .c(new_n30_), .d(x00), .O(new_n61_));
