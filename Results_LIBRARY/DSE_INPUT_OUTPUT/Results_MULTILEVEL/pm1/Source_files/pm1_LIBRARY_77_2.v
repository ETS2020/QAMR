...
module FAU ( 
  ...
  nor3   g10(.a(new_n39_), .b(new_n38_), .c(new_n32_), .O(new_n40_));
  oai21  g11(.a(new_n40_), .b(new_n33_), .c(new_n35_), .O(z02));
  ...
  oai21  g28(.a(new_n56_), .b(new_n44_), .c(new_n57_), .O(z08));
  nand2  g29(.a(new_n33_), .b(new_n32_), .O(new_n59_));
  nand2  g30(.a(new_n36_), .b(new_n59_), .O(new_n60_));
