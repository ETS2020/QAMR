...
module FAU ( 
  ...
  oai21  g20(.a(x12), .b(new_n38_), .c(new_n49_), .O(new_n50_));
  ...
  oai21  g26(.a(new_n33_), .b(new_n55_), .c(new_n38_), .O(new_n56_));
  ...
  nand3  g31(.a(x12), .b(x11), .c(new_n38_), .O(new_n61_));
  ...
  nor3   g37(.a(new_n66_), .b(new_n65_), .c(new_n55_), .O(z10));
  ...
  nand4  g45(.a(x11), .b(new_n38_), .c(new_n65_), .d(x00), .O(new_n75_));
