...
module FAU ( 
  ...
  nor2   g06(.a(new_n31_), .b(new_n34_), .O(new_n36_));
  ...
  aoi21  g15(.a(x09), .b(x01), .c(x12), .O(new_n45_));
  nand2  g16(.a(x12), .b(new_n34_), .O(new_n46_));
  nand3  g17(.a(new_n46_), .b(x03), .c(x02), .O(new_n47_));
  nand3  g18(.a(new_n47_), .b(x09), .c(x01), .O(new_n48_));
  oai21  g19(.a(new_n45_), .b(x04), .c(new_n48_), .O(z06));
  aoi21  g20(.a(x12), .b(new_n30_), .c(x15), .O(z07));
  inv1   g21(.a(x10), .O(new_n51_));
  nand3  g22(.a(x09), .b(x03), .c(x02), .O(new_n52_));
  ...
  nand3  g26(.a(x12), .b(x11), .c(x04), .O(new_n56_));
  oai21  g27(.a(x12), .b(x11), .c(new_n56_), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(new_n51_), .c(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z09));
  aoi21  g30(.a(x03), .b(x02), .c(new_n34_), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(new_n51_), .c(x09), .d(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x04), .c(new_n31_), .O(z10));
  inv1   g33(.a(x01), .O(new_n63_));
  nand2  g34(.a(x03), .b(x02), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(x12), .c(x09), .d(x04), .O(new_n65_));
  nand2  g36(.a(new_n31_), .b(new_n63_), .O(new_n66_));
  oai21  g37(.a(new_n65_), .b(new_n63_), .c(new_n66_), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x11), .c(new_n51_), .d(x00), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z11));
  inv1   g40(.a(x09), .O(new_n70_));
  nand4  g41(.a(x11), .b(new_n51_), .c(new_n70_), .d(x00), .O(new_n71_));
  aoi21  g42(.a(new_n71_), .b(x04), .c(new_n31_), .O(z12));
endmodule
