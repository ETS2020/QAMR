...
module FAU ( 
  ...
  nand2  g03(.a(z05), .b(x12), .O(new_n33_));
  ...
  nand4  g32(.a(new_n49_), .b(z05), .c(x12), .d(x11), .O(new_n62_));
  ...
  nand4  g37(.a(new_n49_), .b(z05), .c(x12), .d(x09), .O(new_n67_));
  ...
  nor3   g44(.a(new_n73_), .b(x13), .c(new_n30_), .O(z12));
endmodule
