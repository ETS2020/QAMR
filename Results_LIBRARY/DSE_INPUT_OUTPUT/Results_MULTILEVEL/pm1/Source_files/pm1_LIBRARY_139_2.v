...
module FAU ( 
  ...
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n45_), .O(z10));
  nand3  g33(.a(new_n60_), .b(x01), .c(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x12), .c(new_n45_), .O(z11));
