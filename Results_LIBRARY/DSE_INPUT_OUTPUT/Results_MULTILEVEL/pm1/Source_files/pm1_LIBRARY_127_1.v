...
module FAU ( 
  ...
  nand2  g24(.a(new_n53_), .b(z01), .O(z09));
  nand4  g25(.a(new_n43_), .b(new_n47_), .c(x09), .d(x00), .O(new_n55_));
  ...
  nand4  g30(.a(new_n59_), .b(x11), .c(new_n47_), .d(x00), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z11));
  nand4  g32(.a(x11), .b(new_n47_), .c(new_n48_), .d(x00), .O(new_n62_));
