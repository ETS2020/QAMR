...
module FAU ( 
  ...
  nand2  g09(.a(x15), .b(new_n32_), .O(new_n39_));
  ...
  nor2   g23(.a(x15), .b(new_n32_), .O(z07));
  ...
  nand4  g34(.a(new_n48_), .b(x12), .c(x11), .d(new_n59_), .O(new_n64_));
  ...
  nand4  g43(.a(x11), .b(new_n59_), .c(new_n55_), .d(x00), .O(new_n73_));
