...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n35_, new_n37_, new_n38_,
    new_n39_, new_n41_, new_n43_, new_n44_, new_n46_, new_n48_, new_n49_,
  ...
  nand3  g25(.a(new_n54_), .b(x11), .c(new_n53_), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(x12), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(x00), .O(z08));
  nand3  g28(.a(new_n34_), .b(new_n53_), .c(x00), .O(new_n58_));
  ...
  nor3   g33(.a(new_n62_), .b(new_n60_), .c(new_n43_), .O(z10));
  nand3  g34(.a(new_n61_), .b(x11), .c(new_n53_), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(x09), .c(x01), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x12), .c(new_n43_), .O(z11));
  nand4  g38(.a(x11), .b(new_n53_), .c(new_n60_), .d(x00), .O(new_n68_));
