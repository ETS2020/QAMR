...
module FAU ( 
  ...
  nand4  g30(.a(new_n43_), .b(x12), .c(x11), .d(new_n48_), .O(new_n60_));
  nor3   g31(.a(new_n60_), .b(new_n59_), .c(new_n47_), .O(z10));
  ...
  nand3  g37(.a(new_n48_), .b(new_n59_), .c(x00), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(x11), .c(new_n32_), .O(z12));
endmodule
