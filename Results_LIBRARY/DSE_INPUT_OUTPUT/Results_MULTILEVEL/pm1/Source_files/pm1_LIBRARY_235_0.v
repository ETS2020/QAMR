...
module FAU ( 
  ...
  aoi21  g17(.a(new_n39_), .b(new_n31_), .c(x15), .O(z07));
  ...
  nand2  g28(.a(new_n58_), .b(new_n40_), .O(z10));
  nand4  g29(.a(new_n43_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  inv1   g30(.a(x01), .O(new_n61_));
  nand2  g31(.a(new_n39_), .b(new_n61_), .O(new_n62_));
  nand2  g32(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand4  g33(.a(new_n63_), .b(x11), .c(new_n49_), .d(x00), .O(new_n64_));
