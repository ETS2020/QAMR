...
module FAU ( 
  ...
  nand2  g08(.a(new_n32_), .b(x07), .O(new_n38_));
  ...
  nand2  g17(.a(new_n32_), .b(new_n46_), .O(new_n47_));
  ...
  nor3   g36(.a(new_n65_), .b(new_n43_), .c(new_n63_), .O(z10));
  nand4  g37(.a(new_n64_), .b(x12), .c(x09), .d(x01), .O(new_n67_));
  nand3  g38(.a(new_n32_), .b(x07), .c(new_n30_), .O(new_n68_));
  ...
  nand2  g42(.a(new_n43_), .b(x00), .O(new_n72_));
  nand3  g43(.a(x12), .b(x11), .c(new_n58_), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n72_), .c(new_n47_), .O(z12));
endmodule
