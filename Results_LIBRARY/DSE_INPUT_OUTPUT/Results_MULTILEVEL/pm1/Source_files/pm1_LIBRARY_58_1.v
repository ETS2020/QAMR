...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(x06), .c(new_n34_), .O(new_n40_));
  nand4  g11(.a(new_n40_), .b(x12), .c(x11), .d(x09), .O(z03));
  nor2   g12(.a(new_n32_), .b(x05), .O(new_n42_));
  ...
  oai21  g21(.a(new_n32_), .b(x05), .c(x15), .O(z07));
  ...
  aoi21  g34(.a(new_n63_), .b(x05), .c(new_n32_), .O(z10));
  nand4  g35(.a(new_n48_), .b(x12), .c(x09), .d(x05), .O(new_n65_));
  ...
  aoi21  g42(.a(new_n71_), .b(x05), .c(new_n32_), .O(z12));
endmodule
