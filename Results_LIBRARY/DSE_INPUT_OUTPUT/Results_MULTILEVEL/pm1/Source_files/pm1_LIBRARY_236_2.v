...
module FAU ( 
  ...
  aoi21  g22(.a(new_n32_), .b(x11), .c(x15), .O(z07));
  ...
  nand3  g28(.a(z01), .b(new_n53_), .c(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z09));
  nand3  g30(.a(new_n46_), .b(x12), .c(new_n53_), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(x09), .c(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x12), .c(new_n31_), .O(z10));
  ...
  aoi21  g40(.a(new_n69_), .b(x12), .c(new_n31_), .O(z12));
endmodule
