...
module FAU ( 
  ...
  wire new_n31_, new_n33_, new_n34_, new_n36_, new_n37_, new_n39_, new_n40_,
  ...
  nor2   g06(.a(new_n36_), .b(new_n31_), .O(new_n37_));
  nand3  g07(.a(new_n37_), .b(new_n33_), .c(x09), .O(z03));
  ...
  aoi21  g12(.a(x09), .b(x01), .c(new_n36_), .O(new_n43_));
  ...
  nand2  g29(.a(new_n36_), .b(new_n59_), .O(new_n60_));
  ...
  nand2  g34(.a(new_n37_), .b(new_n48_), .O(new_n65_));
  oai21  g35(.a(new_n65_), .b(new_n64_), .c(new_n40_), .O(z12));
  one    g36(.O(z00));
endmodule
