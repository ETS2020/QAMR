...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_, new_n39_,
    new_n41_, new_n43_, new_n44_, new_n45_, new_n46_, new_n49_, new_n50_,
  ...
  aoi21  g09(.a(new_n39_), .b(new_n34_), .c(x14), .O(z04));
  nand2  g10(.a(new_n39_), .b(new_n34_), .O(new_n41_));
  ...
  nand2  g24(.a(new_n54_), .b(new_n41_), .O(z09));
  nand4  g25(.a(new_n43_), .b(x12), .c(x11), .d(new_n49_), .O(new_n56_));
  inv1   g26(.a(new_n56_), .O(new_n57_));
  nand3  g27(.a(new_n57_), .b(x09), .c(x00), .O(new_n58_));
  nand2  g28(.a(new_n58_), .b(new_n41_), .O(z10));
  ...
  nand4  g33(.a(new_n57_), .b(x09), .c(x01), .d(x00), .O(new_n64_));
  nand2  g34(.a(new_n64_), .b(new_n63_), .O(z11));
