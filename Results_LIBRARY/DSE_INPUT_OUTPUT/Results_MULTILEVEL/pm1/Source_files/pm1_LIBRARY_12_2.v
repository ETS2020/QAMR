...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n39_,
    new_n41_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
  ...
  oai21  g15(.a(x12), .b(new_n33_), .c(new_n44_), .O(new_n45_));
  ...
  inv1   g20(.a(new_n41_), .O(new_n50_));
  ...
  nand3  g27(.a(new_n46_), .b(new_n52_), .c(x00), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(new_n50_), .O(z09));
  nand4  g29(.a(new_n44_), .b(new_n52_), .c(x09), .d(x00), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(x12), .c(new_n33_), .O(z10));
  nand4  g31(.a(new_n44_), .b(x12), .c(x11), .d(new_n52_), .O(new_n61_));
