...
module FAU ( 
  ...
  wire new_n31_, new_n33_, new_n34_, new_n35_, new_n37_, new_n39_, new_n41_,
  ...
  aoi21  g09(.a(new_n39_), .b(new_n31_), .c(x14), .O(z04));
  nand2  g10(.a(new_n39_), .b(new_n31_), .O(new_n41_));
  ...
  nand4  g37(.a(x11), .b(new_n55_), .c(new_n58_), .d(x00), .O(new_n68_));
  nor2   g38(.a(new_n68_), .b(new_n39_), .O(z12));
  one    g39(.O(z00));
endmodule
