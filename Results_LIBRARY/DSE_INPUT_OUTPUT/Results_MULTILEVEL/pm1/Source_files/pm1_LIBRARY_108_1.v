...
module FAU ( 
  ...
  nand4  g32(.a(new_n44_), .b(x12), .c(x11), .d(new_n49_), .O(new_n62_));
  nor3   g33(.a(new_n62_), .b(new_n61_), .c(new_n48_), .O(z10));
  nand4  g34(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  nand3  g35(.a(new_n54_), .b(x11), .c(new_n30_), .O(new_n65_));
  ...
  nand4  g39(.a(x11), .b(new_n49_), .c(new_n61_), .d(x00), .O(new_n69_));
