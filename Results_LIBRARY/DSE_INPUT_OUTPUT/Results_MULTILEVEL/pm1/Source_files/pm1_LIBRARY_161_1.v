...
module FAU ( 
  ...
  nand4  g11(.a(new_n40_), .b(new_n39_), .c(x09), .d(x06), .O(z03));
  ...
  nand2  g16(.a(new_n45_), .b(new_n42_), .O(new_n46_));
  nand3  g17(.a(x12), .b(new_n34_), .c(x06), .O(new_n47_));
  ...
  nand3  g30(.a(new_n45_), .b(x11), .c(new_n52_), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(x09), .c(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x06), .c(new_n31_), .O(z10));
  inv1   g34(.a(x01), .O(new_n64_));
  nand4  g35(.a(new_n45_), .b(x12), .c(x09), .d(x06), .O(new_n65_));
  nand2  g36(.a(new_n31_), .b(new_n64_), .O(new_n66_));
  ...
  nand4  g41(.a(new_n52_), .b(new_n70_), .c(x06), .d(x00), .O(new_n71_));
  nor3   g42(.a(new_n71_), .b(new_n31_), .c(new_n34_), .O(z12));
endmodule
