...
module FAU ( 
  ...
  nand2  g03(.a(new_n30_), .b(x06), .O(new_n33_));
  ...
  nor2   g13(.a(x12), .b(x06), .O(new_n43_));
  ...
  nand4  g34(.a(new_n47_), .b(x12), .c(x11), .d(new_n59_), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(x09), .c(x00), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n44_), .O(z10));
