...
module FAU ( 
  ...
  oai21  g08(.a(new_n37_), .b(x10), .c(x12), .O(z02));
  ...
  nand3  g20(.a(x12), .b(new_n31_), .c(new_n39_), .O(new_n50_));
  ...
  nand4  g28(.a(new_n57_), .b(x11), .c(new_n39_), .d(x00), .O(z08));
  nor2   g29(.a(new_n32_), .b(new_n31_), .O(new_n59_));
  nor3   g30(.a(x12), .b(x11), .c(x10), .O(new_n60_));
  oai21  g31(.a(new_n60_), .b(new_n59_), .c(x00), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n44_), .O(z09));
  nand4  g33(.a(new_n48_), .b(x11), .c(x09), .d(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(new_n39_), .c(new_n32_), .O(z10));
  nand4  g35(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  nand3  g36(.a(new_n32_), .b(new_n39_), .c(new_n30_), .O(new_n66_));
  ...
  nand3  g40(.a(x11), .b(new_n55_), .c(x00), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(new_n39_), .c(new_n32_), .O(z12));
endmodule
