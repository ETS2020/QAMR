...
module FAU ( 
  ...
  nand4  g25(.a(new_n54_), .b(new_n53_), .c(new_n30_), .d(x00), .O(z08));
  inv1   g26(.a(x10), .O(new_n56_));
  nand2  g27(.a(new_n38_), .b(new_n34_), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(new_n56_), .c(x00), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n30_), .O(z09));
