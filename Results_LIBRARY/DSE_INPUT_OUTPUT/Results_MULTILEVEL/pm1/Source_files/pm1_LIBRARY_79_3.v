...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n40_, new_n41_, new_n42_, new_n45_,
  ...
  oai21  g12(.a(new_n40_), .b(z01), .c(new_n42_), .O(z06));
  ...
  nand4  g21(.a(x11), .b(new_n48_), .c(new_n51_), .d(x00), .O(new_n52_));
  nor2   g22(.a(new_n52_), .b(x12), .O(z11));
  one    g23(.O(z03));
