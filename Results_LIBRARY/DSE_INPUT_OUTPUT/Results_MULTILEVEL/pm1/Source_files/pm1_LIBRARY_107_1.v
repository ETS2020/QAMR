...
module FAU ( 
  ...
  nand4  g12(.a(new_n41_), .b(new_n40_), .c(x09), .d(x02), .O(z03));
  nor2   g13(.a(new_n31_), .b(x02), .O(new_n43_));
  ...
  nand4  g39(.a(new_n63_), .b(x12), .c(x09), .d(x02), .O(new_n69_));
  nand2  g40(.a(new_n31_), .b(new_n68_), .O(new_n70_));
