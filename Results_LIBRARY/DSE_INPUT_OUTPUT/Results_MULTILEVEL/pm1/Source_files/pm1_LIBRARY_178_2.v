...
module FAU ( 
  ...
  aoi21  g15(.a(new_n38_), .b(x12), .c(x14), .O(z04));
  nand2  g16(.a(new_n38_), .b(x12), .O(new_n46_));
  ...
  oai21  g27(.a(x15), .b(new_n32_), .c(new_n56_), .O(new_n57_));
  nand4  g28(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(x15), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(x12), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n57_), .O(z08));
  nand3  g32(.a(x15), .b(x12), .c(x11), .O(new_n62_));
  oai21  g33(.a(x12), .b(x11), .c(new_n62_), .O(new_n63_));
  nand3  g34(.a(new_n63_), .b(new_n55_), .c(x00), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(z09));
  nand3  g36(.a(new_n48_), .b(x11), .c(new_n55_), .O(new_n66_));
  inv1   g37(.a(new_n66_), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(x09), .c(x00), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(x15), .c(new_n32_), .O(z10));
  nand4  g40(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n70_));
  ...
  nand4  g46(.a(x11), .b(new_n55_), .c(new_n75_), .d(x00), .O(new_n76_));
  nor3   g47(.a(new_n76_), .b(new_n38_), .c(new_n32_), .O(z12));
endmodule
