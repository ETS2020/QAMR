...
module FAU ( 
  ...
  nand3  g05(.a(x12), .b(new_n34_), .c(x00), .O(z01));
  nand2  g06(.a(x06), .b(x05), .O(new_n36_));
  nand3  g07(.a(x09), .b(x08), .c(x07), .O(new_n37_));
  oai21  g08(.a(new_n37_), .b(new_n36_), .c(x11), .O(new_n38_));
  nor2   g09(.a(new_n31_), .b(new_n34_), .O(new_n39_));
  nand3  g10(.a(new_n39_), .b(new_n38_), .c(x00), .O(z02));
  ...
  nor2   g15(.a(new_n31_), .b(x00), .O(new_n45_));
  ...
  nor2   g25(.a(new_n45_), .b(x15), .O(z07));
  nand2  g26(.a(x03), .b(x02), .O(new_n56_));
  nand3  g27(.a(x12), .b(x09), .c(x04), .O(new_n57_));
  oai21  g28(.a(new_n57_), .b(new_n56_), .c(x11), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(x10), .c(x00), .O(new_n59_));
  nand2  g30(.a(new_n31_), .b(new_n30_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n59_), .O(z08));
  inv1   g32(.a(x10), .O(new_n62_));
  nand3  g33(.a(new_n31_), .b(new_n34_), .c(x00), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(new_n64_));
  oai21  g35(.a(new_n64_), .b(new_n39_), .c(new_n62_), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n46_), .O(z09));
  nand4  g37(.a(new_n52_), .b(x11), .c(new_n62_), .d(x09), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(x00), .c(new_n31_), .O(z10));
  nand4  g39(.a(new_n52_), .b(x12), .c(x09), .d(x01), .O(new_n69_));
  inv1   g40(.a(x01), .O(new_n70_));
  nand3  g41(.a(new_n31_), .b(new_n70_), .c(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand3  g43(.a(new_n72_), .b(x11), .c(new_n62_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n46_), .O(z11));
  inv1   g45(.a(x09), .O(new_n75_));
  nand4  g46(.a(x11), .b(new_n62_), .c(new_n75_), .d(x00), .O(new_n76_));
