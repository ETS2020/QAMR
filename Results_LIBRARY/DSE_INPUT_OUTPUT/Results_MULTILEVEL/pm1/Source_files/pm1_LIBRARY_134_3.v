...
module FAU ( 
  ...
  nand4  g32(.a(new_n46_), .b(x12), .c(x09), .d(new_n34_), .O(new_n62_));
  ...
  nand4  g37(.a(new_n50_), .b(new_n37_), .c(new_n34_), .d(x00), .O(new_n67_));
  nor3   g38(.a(new_n67_), .b(new_n32_), .c(new_n31_), .O(z12));
endmodule
