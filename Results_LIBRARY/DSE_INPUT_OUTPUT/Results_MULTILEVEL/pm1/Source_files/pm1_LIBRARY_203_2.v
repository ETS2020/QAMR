...
module FAU ( 
  ...
  oai21  g16(.a(x12), .b(new_n38_), .c(new_n45_), .O(new_n46_));
  nand2  g17(.a(x12), .b(new_n38_), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand3  g19(.a(new_n48_), .b(x09), .c(x01), .O(new_n49_));
  inv1   g20(.a(new_n49_), .O(z06));
  aoi21  g21(.a(new_n31_), .b(x11), .c(x15), .O(z07));
  ...
  aoi21  g37(.a(new_n66_), .b(x12), .c(new_n38_), .O(z12));
endmodule
