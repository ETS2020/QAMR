...
module FAU ( 
  ...
  nor3   g26(.a(new_n56_), .b(new_n38_), .c(new_n55_), .O(z10));
  ...
  nand3  g30(.a(new_n60_), .b(new_n48_), .c(x00), .O(new_n61_));
  nand2  g31(.a(new_n61_), .b(new_n41_), .O(z11));
  nand4  g32(.a(x11), .b(new_n48_), .c(new_n38_), .d(x00), .O(new_n63_));
