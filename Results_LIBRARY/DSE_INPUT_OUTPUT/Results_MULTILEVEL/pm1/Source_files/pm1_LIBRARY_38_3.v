...
module FAU ( 
  ...
  nand3  g11(.a(new_n40_), .b(new_n38_), .c(new_n34_), .O(z02));
  nand4  g12(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n42_));
  nand4  g13(.a(new_n42_), .b(new_n40_), .c(x09), .d(new_n34_), .O(z03));
  ...
  oai21  g25(.a(new_n39_), .b(x04), .c(new_n54_), .O(new_n55_));
  nand3  g26(.a(new_n55_), .b(new_n52_), .c(x00), .O(new_n56_));
  inv1   g27(.a(new_n56_), .O(z09));
  nand3  g28(.a(x09), .b(new_n34_), .c(x00), .O(new_n58_));
  nor3   g29(.a(new_n58_), .b(new_n39_), .c(x10), .O(z10));
