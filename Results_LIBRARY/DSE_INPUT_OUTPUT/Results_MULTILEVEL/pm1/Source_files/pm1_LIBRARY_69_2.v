...
module FAU ( 
  ...
  oai21  g13(.a(x12), .b(new_n33_), .c(x14), .O(z04));
  ...
  nand4  g32(.a(new_n46_), .b(x12), .c(x11), .d(new_n52_), .O(new_n62_));
  nor3   g33(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(z10));
  nand3  g34(.a(new_n46_), .b(new_n52_), .c(x09), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(x01), .c(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x12), .c(new_n33_), .O(z11));
  nand3  g38(.a(new_n52_), .b(new_n61_), .c(x00), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(x12), .c(new_n33_), .O(z12));
endmodule
