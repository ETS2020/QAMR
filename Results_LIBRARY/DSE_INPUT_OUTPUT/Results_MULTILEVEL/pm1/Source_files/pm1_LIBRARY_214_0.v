...
module FAU ( 
  ...
  nand2  g08(.a(new_n32_), .b(x02), .O(new_n38_));
  ...
  aoi21  g18(.a(x09), .b(x01), .c(new_n32_), .O(new_n48_));
  nand3  g19(.a(z01), .b(x04), .c(x03), .O(new_n49_));
  nand3  g20(.a(new_n49_), .b(x09), .c(x01), .O(new_n50_));
  oai21  g21(.a(new_n48_), .b(x02), .c(new_n50_), .O(z06));
  ...
  nand3  g29(.a(new_n32_), .b(new_n31_), .c(x02), .O(new_n59_));
  ...
  nand4  g36(.a(new_n65_), .b(x12), .c(x11), .d(new_n53_), .O(new_n66_));
  nor3   g37(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(z10));
  nand4  g38(.a(new_n65_), .b(x12), .c(x09), .d(x01), .O(new_n68_));
  nand3  g39(.a(new_n32_), .b(x02), .c(new_n30_), .O(new_n69_));
  ...
  nand4  g43(.a(x11), .b(new_n53_), .c(new_n64_), .d(x00), .O(new_n73_));
