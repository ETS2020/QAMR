...
module FAU ( 
  ...
  nor2   g28(.a(new_n57_), .b(new_n32_), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n56_), .c(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z09));
  inv1   g31(.a(x09), .O(new_n61_));
  nand4  g32(.a(new_n44_), .b(x12), .c(x11), .d(new_n56_), .O(new_n62_));
  nor3   g33(.a(new_n62_), .b(new_n61_), .c(new_n50_), .O(z10));
  inv1   g34(.a(x01), .O(new_n64_));
  nand3  g35(.a(new_n56_), .b(new_n64_), .c(x00), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(x11), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n57_), .O(new_n67_));
  inv1   g38(.a(new_n62_), .O(new_n68_));
  ...
  nand2  g42(.a(new_n58_), .b(new_n56_), .O(new_n72_));
  oai21  g43(.a(new_n72_), .b(new_n71_), .c(z00), .O(z12));
endmodule
