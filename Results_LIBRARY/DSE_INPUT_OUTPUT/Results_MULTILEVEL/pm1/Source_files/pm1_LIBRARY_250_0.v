...
module FAU ( 
  ...
  nand3  g28(.a(new_n32_), .b(new_n31_), .c(x08), .O(new_n58_));
  oai21  g29(.a(new_n32_), .b(new_n31_), .c(new_n58_), .O(new_n59_));
  ...
  nand4  g42(.a(x11), .b(new_n57_), .c(new_n42_), .d(x00), .O(new_n72_));
