...
module FAU ( 
  ...
  nand3  g19(.a(z01), .b(x03), .c(x02), .O(new_n49_));
  nand3  g20(.a(new_n49_), .b(x09), .c(x01), .O(new_n50_));
  oai21  g21(.a(new_n48_), .b(x04), .c(new_n50_), .O(z06));
  ...
  nand2  g34(.a(new_n63_), .b(new_n61_), .O(z09));
  nand4  g35(.a(new_n56_), .b(x12), .c(x11), .d(new_n53_), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(x09), .c(x00), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n61_), .O(z10));
  nand2  g39(.a(x01), .b(x00), .O(new_n69_));
  nand3  g40(.a(x11), .b(new_n53_), .c(x09), .O(new_n70_));
  ...
  nand2  g45(.a(new_n30_), .b(new_n74_), .O(new_n75_));
  nand2  g46(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand4  g47(.a(new_n76_), .b(x11), .c(new_n53_), .d(x00), .O(new_n77_));
  nand2  g48(.a(new_n77_), .b(new_n72_), .O(z11));
  inv1   g49(.a(x09), .O(new_n79_));
  nand4  g50(.a(x11), .b(new_n53_), .c(new_n79_), .d(x00), .O(new_n80_));
