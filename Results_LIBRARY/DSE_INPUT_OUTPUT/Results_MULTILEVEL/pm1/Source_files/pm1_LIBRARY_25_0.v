...
module FAU ( 
  ...
  nand4  g22(.a(new_n43_), .b(x12), .c(x11), .d(new_n47_), .O(new_n52_));
  inv1   g23(.a(new_n52_), .O(new_n53_));
  nand3  g24(.a(new_n53_), .b(x09), .c(x00), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(z00), .O(z10));
  inv1   g26(.a(x01), .O(new_n56_));
  nand3  g27(.a(new_n47_), .b(new_n56_), .c(x00), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(x11), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n35_), .O(new_n59_));
  nand4  g30(.a(new_n53_), .b(x09), .c(x01), .d(x00), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n59_), .O(z11));
