...
module FAU ( 
  ...
  nand2  g42(.a(new_n71_), .b(new_n67_), .O(z11));
  nand4  g43(.a(x11), .b(new_n54_), .c(new_n36_), .d(x00), .O(new_n73_));
  aoi21  g44(.a(new_n73_), .b(new_n35_), .c(new_n32_), .O(z12));
endmodule
