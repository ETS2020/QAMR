...
module FAU ( 
  ...
  nand2  g06(.a(x15), .b(x12), .O(new_n36_));
  ...
  nand3  g25(.a(new_n48_), .b(new_n37_), .c(x09), .O(new_n55_));
  oai21  g26(.a(new_n54_), .b(new_n44_), .c(new_n55_), .O(z08));
  nand2  g27(.a(new_n32_), .b(new_n31_), .O(new_n57_));
  oai21  g28(.a(new_n36_), .b(new_n31_), .c(new_n57_), .O(new_n58_));
  ...
  nor3   g42(.a(new_n71_), .b(z07), .c(new_n32_), .O(z12));
endmodule
