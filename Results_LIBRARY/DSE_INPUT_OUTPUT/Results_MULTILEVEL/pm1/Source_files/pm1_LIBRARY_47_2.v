...
module FAU ( 
  ...
  nor2   g13(.a(x12), .b(new_n38_), .O(new_n43_));
  nor2   g14(.a(new_n43_), .b(x14), .O(z04));
  nor2   g15(.a(new_n43_), .b(x13), .O(z05));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  oai21  g17(.a(x12), .b(new_n38_), .c(new_n46_), .O(new_n47_));
  ...
  nor2   g24(.a(new_n30_), .b(new_n53_), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(x04), .c(x03), .d(x02), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(x11), .c(new_n38_), .d(x00), .O(z08));
  nand2  g27(.a(x12), .b(x11), .O(new_n57_));
  nor2   g28(.a(new_n57_), .b(x10), .O(new_n58_));
  nor2   g29(.a(x12), .b(x11), .O(new_n59_));
  oai21  g30(.a(new_n59_), .b(new_n58_), .c(x00), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n51_), .O(z09));
  inv1   g32(.a(x00), .O(new_n62_));
  nand4  g33(.a(new_n46_), .b(x12), .c(x11), .d(new_n38_), .O(new_n63_));
  ...
  nand2  g37(.a(new_n30_), .b(new_n66_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n65_), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(x11), .c(new_n38_), .d(x00), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(z11));
  nand4  g41(.a(x11), .b(new_n38_), .c(new_n53_), .d(x00), .O(new_n71_));
