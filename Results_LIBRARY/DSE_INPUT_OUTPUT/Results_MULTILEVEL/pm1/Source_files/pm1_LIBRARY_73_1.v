...
module FAU ( 
  ...
  nor2   g12(.a(new_n31_), .b(x00), .O(new_n42_));
  ...
  nand4  g34(.a(new_n49_), .b(x12), .c(x11), .d(new_n59_), .O(new_n64_));
  nor3   g35(.a(new_n64_), .b(new_n63_), .c(new_n30_), .O(z10));
  ...
  nand4  g42(.a(x11), .b(new_n59_), .c(new_n63_), .d(x00), .O(new_n72_));
  nor2   g43(.a(new_n72_), .b(new_n31_), .O(z12));
endmodule
