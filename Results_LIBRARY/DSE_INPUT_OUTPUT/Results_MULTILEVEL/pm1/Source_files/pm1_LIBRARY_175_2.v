...
module FAU ( 
  ...
  oai21  g13(.a(x12), .b(x02), .c(new_n42_), .O(z03));
  aoi21  g14(.a(new_n33_), .b(x02), .c(x14), .O(z04));
  nand2  g15(.a(new_n33_), .b(x02), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(x13), .O(z05));
  inv1   g17(.a(x09), .O(new_n47_));
  nand3  g18(.a(x11), .b(x04), .c(x03), .O(new_n48_));
  ...
  nand4  g41(.a(x11), .b(new_n52_), .c(new_n47_), .d(x00), .O(new_n71_));
