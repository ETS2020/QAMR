...
module FAU ( 
  ...
  oai21  g03(.a(z04), .b(new_n30_), .c(new_n32_), .O(z00));
  inv1   g04(.a(x11), .O(new_n34_));
  oai21  g05(.a(z04), .b(new_n34_), .c(x12), .O(z01));
  nor2   g06(.a(z04), .b(new_n30_), .O(new_n36_));
  ...
  nor2   g13(.a(x14), .b(new_n30_), .O(new_n43_));
  inv1   g14(.a(new_n43_), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x13), .O(z05));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  inv1   g17(.a(new_n46_), .O(new_n47_));
  nand3  g18(.a(x14), .b(x12), .c(new_n34_), .O(new_n48_));
  oai21  g19(.a(new_n47_), .b(new_n43_), .c(new_n48_), .O(new_n49_));
  ...
  nand3  g26(.a(new_n47_), .b(new_n36_), .c(x09), .O(new_n56_));
  oai21  g27(.a(new_n55_), .b(new_n43_), .c(new_n56_), .O(z08));
  xnor2a g28(.a(x12), .b(x11), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n53_), .c(x00), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n44_), .O(z09));
  nand4  g31(.a(new_n46_), .b(x14), .c(x12), .d(x11), .O(new_n61_));
  ...
  nand2  g40(.a(new_n69_), .b(new_n44_), .O(z11));
  inv1   g41(.a(x09), .O(new_n71_));
  nand4  g42(.a(x11), .b(new_n53_), .c(new_n71_), .d(x00), .O(new_n72_));
  nor3   g43(.a(new_n72_), .b(z04), .c(new_n30_), .O(z12));
endmodule
