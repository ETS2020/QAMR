...
module FAU ( 
  ...
  nand4  g29(.a(new_n43_), .b(x12), .c(x11), .d(new_n48_), .O(new_n60_));
  nor3   g30(.a(new_n60_), .b(new_n37_), .c(new_n47_), .O(z10));
  nand4  g31(.a(new_n43_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  nand3  g32(.a(new_n53_), .b(x11), .c(new_n30_), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand3  g34(.a(new_n64_), .b(new_n48_), .c(x00), .O(new_n65_));
  nand2  g35(.a(new_n65_), .b(new_n40_), .O(z11));
  nand3  g36(.a(new_n48_), .b(new_n37_), .c(x00), .O(new_n67_));
  aoi21  g37(.a(new_n67_), .b(x11), .c(new_n53_), .O(z12));
  one    g38(.O(z01));
endmodule
