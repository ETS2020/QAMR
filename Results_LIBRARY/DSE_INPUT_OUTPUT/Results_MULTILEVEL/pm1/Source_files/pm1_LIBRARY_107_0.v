...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n36_, new_n37_, new_n38_,
    new_n39_, new_n41_, new_n42_, new_n44_, new_n46_, new_n48_, new_n49_,
  ...
  nor2   g14(.a(x12), .b(x02), .O(new_n44_));
  ...
  nand3  g30(.a(new_n30_), .b(new_n36_), .c(x02), .O(new_n60_));
  ...
  nand4  g37(.a(new_n66_), .b(x12), .c(x11), .d(new_n54_), .O(new_n67_));
  nor3   g38(.a(new_n67_), .b(new_n65_), .c(new_n64_), .O(z10));
  nand4  g39(.a(new_n66_), .b(x12), .c(x09), .d(x01), .O(new_n69_));
  inv1   g40(.a(x01), .O(new_n70_));
  nand3  g41(.a(new_n30_), .b(x02), .c(new_n70_), .O(new_n71_));
  ...
  nand2  g46(.a(new_n41_), .b(new_n54_), .O(new_n76_));
