...
module FAU ( 
  ...
  oai21  g10(.a(new_n39_), .b(new_n32_), .c(new_n35_), .O(z02));
  ...
  oai21  g17(.a(z04), .b(x12), .c(new_n46_), .O(new_n47_));
  ...
  nand2  g22(.a(x14), .b(new_n32_), .O(new_n52_));
  ...
  nand2  g32(.a(new_n61_), .b(new_n52_), .O(z09));
  inv1   g33(.a(x00), .O(new_n63_));
  nand4  g34(.a(new_n46_), .b(x12), .c(x11), .d(new_n59_), .O(new_n64_));
  nor3   g35(.a(new_n64_), .b(new_n55_), .c(new_n63_), .O(z10));
  nand4  g36(.a(x11), .b(new_n59_), .c(new_n30_), .d(x00), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(z04), .O(new_n67_));
