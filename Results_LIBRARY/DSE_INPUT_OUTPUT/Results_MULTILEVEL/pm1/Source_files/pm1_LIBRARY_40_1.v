...
module FAU ( 
  ...
  nand4  g12(.a(new_n41_), .b(new_n40_), .c(x09), .d(x08), .O(z03));
  ...
  nand3  g19(.a(x12), .b(new_n34_), .c(x08), .O(new_n49_));
  ...
  nand3  g27(.a(x12), .b(x09), .c(x08), .O(new_n57_));
  ...
  aoi21  g35(.a(new_n64_), .b(x08), .c(new_n31_), .O(z10));
  ...
  nand4  g43(.a(new_n54_), .b(new_n72_), .c(x08), .d(x00), .O(new_n73_));
