...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n40_, new_n41_, new_n42_,
    new_n45_, new_n46_, new_n48_, new_n49_, new_n51_, new_n52_;
  ...
  nor2   g06(.a(new_n32_), .b(new_n30_), .O(z10));
  ...
  nand4  g19(.a(new_n32_), .b(new_n30_), .c(new_n48_), .d(x00), .O(new_n49_));
  inv1   g20(.a(new_n49_), .O(z09));
  inv1   g21(.a(x01), .O(new_n51_));
  nand3  g22(.a(new_n48_), .b(new_n51_), .c(x00), .O(new_n52_));
  aoi21  g23(.a(new_n52_), .b(new_n32_), .c(new_n30_), .O(z11));
  zero   g24(.O(z12));
