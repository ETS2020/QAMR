...
module FAU ( 
  ...
  nor2   g11(.a(new_n31_), .b(new_n34_), .O(new_n41_));
  nand3  g12(.a(x08), .b(x06), .c(x05), .O(new_n42_));
  nand4  g13(.a(new_n42_), .b(new_n41_), .c(x09), .d(x07), .O(z03));
  ...
  nand3  g20(.a(x12), .b(new_n34_), .c(x07), .O(new_n50_));
  ...
  aoi21  g36(.a(new_n65_), .b(x07), .c(new_n31_), .O(z10));
