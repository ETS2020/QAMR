...
module FAU ( 
  ...
  nand2  g09(.a(z05), .b(new_n30_), .O(new_n39_));
  ...
  nand2  g15(.a(x13), .b(new_n30_), .O(new_n45_));
  ...
  nand2  g33(.a(new_n62_), .b(new_n45_), .O(z10));
