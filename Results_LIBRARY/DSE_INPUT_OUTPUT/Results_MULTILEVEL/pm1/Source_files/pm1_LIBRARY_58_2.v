...
module FAU ( 
  ...
  nor2   g15(.a(x12), .b(new_n31_), .O(new_n45_));
  ...
  nand3  g20(.a(new_n49_), .b(new_n35_), .c(x04), .O(new_n50_));
  ...
  nand3  g29(.a(new_n33_), .b(new_n32_), .c(new_n31_), .O(new_n59_));
  ...
  nand3  g39(.a(new_n33_), .b(new_n31_), .c(new_n30_), .O(new_n69_));
  ...
  nand2  g45(.a(new_n42_), .b(new_n54_), .O(new_n75_));
  oai21  g46(.a(new_n75_), .b(new_n74_), .c(new_n48_), .O(z12));
endmodule
