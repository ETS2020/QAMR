...
module FAU ( 
  ...
  nand2  g05(.a(new_n33_), .b(new_n32_), .O(new_n35_));
  ...
  nor3   g10(.a(new_n39_), .b(new_n38_), .c(new_n31_), .O(new_n40_));
  oai21  g11(.a(new_n40_), .b(new_n32_), .c(new_n35_), .O(z02));
  inv1   g12(.a(new_n36_), .O(new_n42_));
  nand4  g13(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n43_));
  nand3  g14(.a(new_n43_), .b(new_n42_), .c(x09), .O(z03));
  nor2   g15(.a(new_n33_), .b(x12), .O(new_n45_));
  ...
  nand2  g24(.a(x15), .b(x12), .O(z07));
  nor2   g25(.a(new_n31_), .b(x10), .O(new_n55_));
  nand4  g26(.a(new_n49_), .b(x12), .c(x09), .d(x04), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n55_), .c(new_n48_), .d(x00), .O(z08));
  inv1   g28(.a(x10), .O(new_n58_));
  oai21  g29(.a(new_n35_), .b(x11), .c(new_n36_), .O(new_n59_));
  ...
  nand4  g37(.a(x11), .b(new_n58_), .c(new_n30_), .d(x00), .O(new_n67_));
  ...
  nand2  g43(.a(new_n63_), .b(x00), .O(new_n73_));
  nand2  g44(.a(new_n42_), .b(new_n58_), .O(new_n74_));
  oai21  g45(.a(new_n74_), .b(new_n73_), .c(new_n48_), .O(z12));
endmodule
