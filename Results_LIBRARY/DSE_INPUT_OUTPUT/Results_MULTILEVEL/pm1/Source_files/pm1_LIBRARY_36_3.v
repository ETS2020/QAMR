...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n34_, new_n35_, new_n40_, new_n41_, new_n42_,
  ...
  nand4  g16(.a(new_n34_), .b(x11), .c(new_n46_), .d(x00), .O(z08));
  nand4  g17(.a(new_n34_), .b(new_n30_), .c(new_n46_), .d(x00), .O(new_n48_));
  inv1   g18(.a(new_n48_), .O(z09));
  inv1   g19(.a(x01), .O(new_n51_));
  nand3  g20(.a(new_n46_), .b(new_n51_), .c(x00), .O(new_n52_));
  aoi21  g21(.a(new_n52_), .b(new_n34_), .c(new_n30_), .O(z11));
  one    g22(.O(z03));
  zero   g23(.O(z10));
  zero   g24(.O(z12));
endmodule
