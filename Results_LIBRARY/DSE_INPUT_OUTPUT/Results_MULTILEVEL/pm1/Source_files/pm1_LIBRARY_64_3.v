...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n36_, new_n38_, new_n41_, new_n42_,
  ...
  oai21  g04(.a(new_n33_), .b(x07), .c(x12), .O(z01));
  nand2  g05(.a(x12), .b(x07), .O(z02));
  ...
  nand3  g11(.a(new_n33_), .b(x09), .c(x01), .O(new_n41_));
  ...
  nand3  g21(.a(x12), .b(x09), .c(new_n36_), .O(new_n51_));
  ...
  aoi21  g29(.a(new_n58_), .b(new_n36_), .c(new_n30_), .O(z10));
  inv1   g30(.a(x01), .O(new_n60_));
  nand4  g31(.a(new_n44_), .b(x12), .c(x09), .d(new_n36_), .O(new_n61_));
  nand2  g32(.a(new_n30_), .b(new_n60_), .O(new_n62_));
  ...
  nand4  g37(.a(x11), .b(new_n48_), .c(new_n66_), .d(x00), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(new_n36_), .c(new_n30_), .O(z12));
endmodule
