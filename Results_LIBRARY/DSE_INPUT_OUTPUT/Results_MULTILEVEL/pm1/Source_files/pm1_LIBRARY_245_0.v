...
module FAU ( 
  ...
  aoi21  g18(.a(new_n30_), .b(new_n41_), .c(x15), .O(z07));
  oai21  g19(.a(new_n33_), .b(x10), .c(x00), .O(new_n49_));
  ...
  nor3   g32(.a(new_n61_), .b(new_n59_), .c(new_n41_), .O(z10));
  nand2  g33(.a(x11), .b(new_n54_), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(x01), .c(x00), .O(new_n64_));
  ...
  nand4  g39(.a(x11), .b(new_n54_), .c(new_n59_), .d(x00), .O(new_n69_));
