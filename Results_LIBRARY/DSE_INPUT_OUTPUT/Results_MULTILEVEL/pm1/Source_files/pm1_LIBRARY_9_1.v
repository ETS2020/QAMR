...
module FAU ( 
  ...
  nand4  g17(.a(new_n47_), .b(new_n46_), .c(x09), .d(x01), .O(new_n48_));
  ...
  nand2  g28(.a(new_n32_), .b(x11), .O(new_n59_));
  nand3  g29(.a(new_n59_), .b(new_n52_), .c(x00), .O(new_n60_));
  nand2  g30(.a(new_n60_), .b(new_n46_), .O(z09));
  nand4  g31(.a(new_n47_), .b(new_n52_), .c(x09), .d(x00), .O(new_n62_));
  aoi21  g32(.a(new_n62_), .b(x11), .c(new_n32_), .O(z10));
  ...
  nand3  g36(.a(new_n66_), .b(new_n52_), .c(x00), .O(new_n67_));
  nand2  g37(.a(new_n67_), .b(new_n46_), .O(z11));
  inv1   g38(.a(x09), .O(new_n69_));
  nand4  g39(.a(x11), .b(new_n52_), .c(new_n69_), .d(x00), .O(new_n70_));
  nor2   g40(.a(new_n70_), .b(new_n32_), .O(z12));
  one    g41(.O(z01));
endmodule
