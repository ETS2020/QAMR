...
module FAU ( 
  ...
  nand2  g18(.a(x03), .b(x02), .O(new_n49_));
  nand3  g19(.a(x12), .b(x09), .c(x04), .O(new_n50_));
  oai21  g20(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n51_));
  oai21  g21(.a(new_n51_), .b(new_n47_), .c(x11), .O(new_n52_));
  inv1   g22(.a(x12), .O(new_n53_));
  nand2  g23(.a(new_n53_), .b(new_n31_), .O(new_n54_));
  nand2  g24(.a(new_n54_), .b(new_n52_), .O(z08));
  nand2  g25(.a(x12), .b(x11), .O(new_n56_));
  nand2  g26(.a(new_n54_), .b(new_n56_), .O(new_n57_));
  nand3  g27(.a(new_n57_), .b(new_n48_), .c(x00), .O(new_n58_));
  inv1   g28(.a(new_n58_), .O(z09));
  inv1   g29(.a(x09), .O(new_n60_));
  nand4  g30(.a(new_n43_), .b(x12), .c(x11), .d(new_n48_), .O(new_n61_));
  nor3   g31(.a(new_n61_), .b(new_n60_), .c(new_n47_), .O(z10));
  nand4  g32(.a(new_n43_), .b(x12), .c(x09), .d(x01), .O(new_n63_));
  nand3  g33(.a(new_n53_), .b(x11), .c(new_n30_), .O(new_n64_));
  nand2  g34(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand3  g35(.a(new_n65_), .b(new_n48_), .c(x00), .O(new_n66_));
  nand2  g36(.a(new_n66_), .b(new_n40_), .O(z11));
  nand4  g37(.a(x11), .b(new_n48_), .c(new_n60_), .d(x00), .O(new_n68_));
  nor2   g38(.a(new_n68_), .b(new_n53_), .O(z12));
  one    g39(.O(z01));
endmodule
