...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n38_, new_n41_, new_n42_, new_n43_,
  ...
  nand2  g10(.a(new_n41_), .b(new_n32_), .O(new_n42_));
  nand2  g11(.a(new_n42_), .b(z01), .O(new_n43_));
  ...
  nand3  g19(.a(new_n47_), .b(new_n30_), .c(x00), .O(new_n51_));
  aoi21  g20(.a(new_n51_), .b(new_n32_), .c(new_n31_), .O(z11));
  one    g21(.O(z02));
  one    g22(.O(z03));
  nor2   g23(.a(new_n32_), .b(new_n31_), .O(z12));
endmodule
