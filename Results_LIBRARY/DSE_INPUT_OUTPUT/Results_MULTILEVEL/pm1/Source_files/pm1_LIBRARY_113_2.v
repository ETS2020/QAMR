...
module FAU ( 
  ...
  nand3  g05(.a(x15), .b(x12), .c(new_n34_), .O(z01));
  ...
  oai21  g14(.a(x15), .b(new_n30_), .c(x14), .O(z04));
  nor2   g15(.a(x15), .b(new_n30_), .O(new_n45_));
  ...
  oai22  g28(.a(new_n57_), .b(new_n50_), .c(new_n56_), .d(new_n45_), .O(z08));
  ...
  and2   g33(.a(new_n50_), .b(x11), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n54_), .c(x09), .d(x00), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x15), .c(new_n30_), .O(z10));
  inv1   g36(.a(x01), .O(new_n66_));
  nand4  g37(.a(new_n50_), .b(x15), .c(x12), .d(x09), .O(new_n67_));
  ...
  nor3   g44(.a(new_n73_), .b(new_n31_), .c(new_n30_), .O(z12));
endmodule
