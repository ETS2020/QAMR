...
module FAU ( 
  ...
  nand2  g16(.a(new_n30_), .b(new_n45_), .O(new_n46_));
  ...
  nand4  g26(.a(new_n55_), .b(new_n54_), .c(new_n46_), .d(x00), .O(z08));
  ...
  nand4  g34(.a(new_n63_), .b(x12), .c(x11), .d(new_n57_), .O(new_n64_));
  nor3   g35(.a(new_n64_), .b(new_n42_), .c(new_n62_), .O(z10));
  ...
  nand2  g42(.a(new_n42_), .b(x00), .O(new_n72_));
  nand3  g43(.a(x12), .b(x11), .c(new_n57_), .O(new_n73_));
