...
module FAU ( 
  ...
  nand2  g24(.a(new_n32_), .b(new_n31_), .O(new_n55_));
  ...
  nand4  g30(.a(new_n45_), .b(new_n50_), .c(x09), .d(x00), .O(new_n61_));
  ...
  nand2  g36(.a(new_n66_), .b(new_n44_), .O(z11));
  nand4  g37(.a(x11), .b(new_n50_), .c(new_n38_), .d(x00), .O(new_n68_));
