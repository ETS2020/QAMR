...
module FAU ( 
  ...
  nand2  g18(.a(new_n48_), .b(new_n44_), .O(z06));
  ...
  nand3  g31(.a(new_n42_), .b(x11), .c(new_n30_), .O(new_n62_));
  nand2  g32(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand3  g33(.a(new_n63_), .b(new_n51_), .c(x00), .O(new_n64_));
  nand2  g34(.a(new_n64_), .b(new_n44_), .O(z11));
  nand4  g35(.a(x11), .b(new_n51_), .c(new_n52_), .d(x00), .O(new_n66_));
  nor2   g36(.a(new_n66_), .b(new_n42_), .O(z12));
  one    g37(.O(z01));
endmodule
