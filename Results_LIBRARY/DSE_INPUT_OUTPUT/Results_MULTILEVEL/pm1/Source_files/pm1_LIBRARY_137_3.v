...
module FAU ( 
  ...
  nand3  g14(.a(x12), .b(new_n31_), .c(new_n34_), .O(new_n45_));
  oai21  g15(.a(new_n44_), .b(new_n40_), .c(new_n45_), .O(new_n46_));
  ...
  nand3  g22(.a(x12), .b(x09), .c(new_n34_), .O(new_n53_));
  oai22  g23(.a(new_n53_), .b(new_n43_), .c(new_n52_), .d(new_n40_), .O(z08));
  nand3  g24(.a(x12), .b(x11), .c(new_n34_), .O(new_n55_));
  oai21  g25(.a(x12), .b(x11), .c(new_n55_), .O(new_n56_));
  nand3  g26(.a(new_n56_), .b(new_n50_), .c(x00), .O(new_n57_));
  inv1   g27(.a(new_n57_), .O(z09));
  nand4  g28(.a(new_n43_), .b(x12), .c(x11), .d(new_n50_), .O(new_n59_));
  inv1   g29(.a(new_n59_), .O(new_n60_));
  nand4  g30(.a(new_n60_), .b(x09), .c(new_n34_), .d(x00), .O(new_n61_));
  inv1   g31(.a(new_n61_), .O(z10));
  nand4  g32(.a(new_n43_), .b(x12), .c(x09), .d(new_n34_), .O(new_n63_));
  nand2  g33(.a(new_n32_), .b(new_n30_), .O(new_n64_));
  oai21  g34(.a(new_n63_), .b(new_n30_), .c(new_n64_), .O(new_n65_));
  nand4  g35(.a(new_n65_), .b(x11), .c(new_n50_), .d(x00), .O(new_n66_));
  inv1   g36(.a(new_n66_), .O(z11));
  nand4  g37(.a(x11), .b(new_n50_), .c(new_n37_), .d(x00), .O(new_n68_));
  aoi21  g38(.a(new_n68_), .b(new_n34_), .c(new_n32_), .O(z12));
  one    g39(.O(z02));
endmodule
