...
module FAU ( 
  ...
  nand4  g38(.a(new_n63_), .b(x12), .c(x09), .d(x02), .O(new_n68_));
  ...
  nand4  g44(.a(new_n53_), .b(new_n73_), .c(x02), .d(x00), .O(new_n74_));
  nor3   g45(.a(new_n74_), .b(new_n32_), .c(new_n31_), .O(z12));
endmodule
