...
module FAU ( 
  ...
  nand3  g09(.a(z04), .b(x12), .c(x11), .O(new_n39_));
  ...
  nand3  g21(.a(z04), .b(x12), .c(new_n31_), .O(new_n51_));
  ...
  nand4  g41(.a(new_n70_), .b(x11), .c(new_n56_), .d(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n46_), .O(z11));
  inv1   g43(.a(x09), .O(new_n73_));
  nand4  g44(.a(x11), .b(new_n56_), .c(new_n73_), .d(x00), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(z04), .c(new_n32_), .O(z12));
endmodule
