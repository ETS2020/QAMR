...
module FAU ( 
  ...
  nand3  g09(.a(new_n38_), .b(new_n37_), .c(x02), .O(z02));
  nand4  g10(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n40_));
  nand4  g11(.a(new_n40_), .b(new_n38_), .c(x09), .d(x02), .O(z03));
  ...
  nand3  g18(.a(new_n47_), .b(x04), .c(x03), .O(new_n48_));
  nand3  g19(.a(new_n48_), .b(x09), .c(x01), .O(new_n49_));
  oai21  g20(.a(new_n46_), .b(x02), .c(new_n49_), .O(z06));
  ...
  oai21  g27(.a(new_n56_), .b(new_n55_), .c(new_n54_), .O(z08));
  ...
  nand4  g34(.a(new_n63_), .b(x09), .c(x02), .d(x00), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(z10));
  nand4  g36(.a(new_n61_), .b(x12), .c(x09), .d(x02), .O(new_n66_));
  ...
  aoi21  g43(.a(new_n72_), .b(x02), .c(new_n32_), .O(z12));
endmodule
