...
module FAU ( 
  ...
  nand2  g03(.a(x14), .b(x08), .O(new_n33_));
  ...
  nand4  g24(.a(new_n53_), .b(new_n52_), .c(new_n33_), .d(x00), .O(z08));
  inv1   g25(.a(x10), .O(new_n55_));
  xnor2a g26(.a(x12), .b(x11), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n33_), .c(new_n55_), .d(x00), .O(new_n57_));
  ...
  nand2  g33(.a(new_n62_), .b(new_n33_), .O(z10));
  ...
  nand4  g38(.a(new_n67_), .b(new_n33_), .c(x11), .d(new_n55_), .O(new_n68_));
  nor2   g39(.a(new_n68_), .b(new_n64_), .O(z11));
  nand4  g40(.a(new_n33_), .b(x12), .c(x11), .d(new_n55_), .O(new_n70_));
  nor3   g41(.a(new_n70_), .b(x09), .c(new_n64_), .O(z12));
endmodule
