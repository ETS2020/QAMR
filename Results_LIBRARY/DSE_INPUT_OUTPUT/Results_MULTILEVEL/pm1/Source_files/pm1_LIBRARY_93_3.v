...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n37_, new_n40_, new_n41_, new_n42_,
  ...
  nand4  g17(.a(z01), .b(new_n32_), .c(new_n48_), .d(x00), .O(new_n49_));
  nand2  g18(.a(new_n49_), .b(new_n37_), .O(z09));
  inv1   g19(.a(x01), .O(new_n52_));
  nand4  g20(.a(x11), .b(new_n48_), .c(new_n52_), .d(x00), .O(new_n53_));
