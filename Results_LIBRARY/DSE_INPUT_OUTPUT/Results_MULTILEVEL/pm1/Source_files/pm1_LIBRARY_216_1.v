...
module FAU ( 
  ...
  nand2  g26(.a(new_n56_), .b(new_n54_), .O(z08));
  nand2  g27(.a(x12), .b(x11), .O(new_n58_));
  nand2  g28(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand3  g29(.a(new_n59_), .b(new_n50_), .c(x00), .O(new_n60_));
  inv1   g30(.a(new_n60_), .O(z09));
  nand4  g31(.a(new_n45_), .b(new_n50_), .c(x09), .d(x00), .O(new_n62_));
  aoi21  g32(.a(new_n62_), .b(x11), .c(new_n55_), .O(z10));
  nand4  g33(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  nand2  g34(.a(new_n55_), .b(new_n30_), .O(new_n65_));
  ...
  nand4  g39(.a(x11), .b(new_n50_), .c(new_n69_), .d(x00), .O(new_n70_));
  nor2   g40(.a(new_n70_), .b(new_n55_), .O(z12));
  one    g41(.O(z01));
endmodule
