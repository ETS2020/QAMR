...
module FAU ( 
  ...
  nand3  g10(.a(new_n39_), .b(new_n38_), .c(x11), .O(z02));
  ...
  nand2  g19(.a(new_n48_), .b(new_n45_), .O(new_n49_));
  ...
  aoi21  g36(.a(new_n65_), .b(z04), .c(new_n32_), .O(z10));
  nand4  g37(.a(new_n48_), .b(z04), .c(x12), .d(x09), .O(new_n67_));
  ...
  nor3   g44(.a(new_n73_), .b(x14), .c(new_n32_), .O(z12));
endmodule
