...
module FAU ( 
  ...
  oai21  g05(.a(x15), .b(new_n30_), .c(new_n34_), .O(z00));
  nand2  g06(.a(x12), .b(new_n31_), .O(new_n36_));
  nand2  g07(.a(x15), .b(x01), .O(new_n37_));
  and2   g08(.a(new_n37_), .b(new_n36_), .O(z01));
  nand2  g09(.a(x12), .b(x11), .O(new_n39_));
  inv1   g10(.a(new_n39_), .O(new_n40_));
  nand4  g11(.a(new_n37_), .b(x07), .c(x06), .d(x05), .O(new_n41_));
  inv1   g12(.a(new_n41_), .O(new_n42_));
  nand4  g13(.a(new_n42_), .b(new_n40_), .c(x09), .d(x08), .O(z02));
  nand4  g14(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n44_));
  nand4  g15(.a(new_n44_), .b(new_n40_), .c(new_n37_), .d(x09), .O(z03));
  nand2  g16(.a(new_n37_), .b(x14), .O(z04));
  nand2  g17(.a(new_n37_), .b(x13), .O(z05));
  ...
  aoi21  g22(.a(new_n51_), .b(new_n48_), .c(new_n30_), .O(z06));
  nand2  g23(.a(x15), .b(new_n30_), .O(z07));
  ...
  nand2  g28(.a(new_n39_), .b(new_n33_), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n37_), .c(new_n57_), .d(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z09));
  nand3  g31(.a(x04), .b(x03), .c(x02), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n37_), .c(x12), .d(x11), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n57_), .c(x09), .d(x00), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(z10));
  nand4  g36(.a(new_n61_), .b(new_n48_), .c(x12), .d(x09), .O(new_n66_));
  ...
  nand4  g42(.a(new_n37_), .b(x12), .c(x11), .d(new_n57_), .O(new_n72_));
