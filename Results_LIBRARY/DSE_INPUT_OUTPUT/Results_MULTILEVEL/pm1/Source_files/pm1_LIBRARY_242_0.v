...
module FAU ( 
  ...
  nand4  g31(.a(new_n44_), .b(x12), .c(x11), .d(new_n50_), .O(new_n61_));
  ...
  inv1   g37(.a(new_n61_), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x09), .c(x01), .d(x00), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n66_), .O(z11));
  nand4  g40(.a(x11), .b(new_n50_), .c(new_n60_), .d(x00), .O(new_n70_));
  nor2   g41(.a(new_n70_), .b(new_n31_), .O(z12));
endmodule
