...
module FAU ( 
  ...
  nor2   g05(.a(new_n35_), .b(new_n30_), .O(z10));
  ...
  oai21  g16(.a(x10), .b(new_n46_), .c(new_n35_), .O(new_n47_));
  nand2  g17(.a(new_n47_), .b(x11), .O(z08));
  inv1   g18(.a(x10), .O(new_n49_));
  nand4  g19(.a(new_n35_), .b(new_n30_), .c(new_n49_), .d(x00), .O(new_n50_));
  nand2  g20(.a(new_n50_), .b(z03), .O(z09));
  inv1   g21(.a(x01), .O(new_n52_));
  nand3  g22(.a(new_n49_), .b(new_n52_), .c(x00), .O(new_n53_));
  aoi21  g23(.a(new_n53_), .b(new_n35_), .c(new_n30_), .O(z11));
  one    g24(.O(z02));
  nor2   g25(.a(new_n35_), .b(new_n30_), .O(z12));
endmodule
