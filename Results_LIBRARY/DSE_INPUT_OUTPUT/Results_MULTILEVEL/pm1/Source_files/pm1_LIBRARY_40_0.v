...
module FAU ( 
  ...
  nor2   g13(.a(x12), .b(x08), .O(new_n43_));
  ...
  oai21  g21(.a(new_n48_), .b(new_n43_), .c(new_n50_), .O(new_n51_));
  nand3  g22(.a(new_n51_), .b(x09), .c(x01), .O(new_n52_));
  inv1   g23(.a(new_n52_), .O(z06));
  nor2   g24(.a(new_n43_), .b(x15), .O(z07));
  ...
  nand2  g31(.a(new_n30_), .b(new_n49_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n34_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n55_), .c(x00), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n45_), .O(z09));
  nand4  g35(.a(new_n47_), .b(x12), .c(x11), .d(new_n55_), .O(new_n65_));
  ...
  nand4  g43(.a(new_n66_), .b(x09), .c(x01), .d(x00), .O(new_n73_));
