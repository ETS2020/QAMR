...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n36_, new_n39_, new_n40_, new_n41_, new_n45_,
    new_n47_, new_n49_;
  ...
  inv1   g11(.a(new_n36_), .O(z10));
  nor2   g12(.a(z10), .b(x15), .O(z07));
  inv1   g13(.a(x10), .O(new_n45_));
  nand4  g14(.a(z01), .b(x11), .c(new_n45_), .d(x00), .O(z08));
  nand4  g15(.a(z01), .b(new_n31_), .c(new_n45_), .d(x00), .O(new_n47_));
  nand2  g16(.a(new_n47_), .b(new_n36_), .O(z09));
  nand4  g17(.a(x11), .b(new_n45_), .c(new_n30_), .d(x00), .O(new_n49_));
  nor2   g18(.a(new_n49_), .b(x12), .O(z11));
  one    g19(.O(z02));
  one    g20(.O(z03));
  zero   g21(.O(z12));
endmodule
