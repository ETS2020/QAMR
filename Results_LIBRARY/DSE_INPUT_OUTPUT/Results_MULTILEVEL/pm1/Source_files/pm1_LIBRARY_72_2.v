...
module FAU ( 
  ...
  nand3  g25(.a(new_n45_), .b(new_n50_), .c(x00), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(new_n43_), .O(z09));
  inv1   g27(.a(x00), .O(new_n57_));
  inv1   g28(.a(x09), .O(new_n58_));
  nand3  g29(.a(x04), .b(x03), .c(x02), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(x12), .c(x11), .d(new_n50_), .O(new_n60_));
  nor3   g31(.a(new_n60_), .b(new_n58_), .c(new_n57_), .O(z10));
  inv1   g32(.a(new_n60_), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(x09), .c(x01), .d(x00), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(z11));
  nand4  g35(.a(x11), .b(new_n50_), .c(new_n58_), .d(x00), .O(new_n65_));
