...
module FAU ( 
  ...
  nand2  g14(.a(z04), .b(x12), .O(new_n44_));
  ...
  nand4  g32(.a(new_n49_), .b(x14), .c(x12), .d(x11), .O(new_n62_));
  ...
  nand4  g37(.a(new_n49_), .b(x14), .c(x12), .d(x09), .O(new_n67_));
  ...
  aoi21  g44(.a(new_n73_), .b(x14), .c(new_n30_), .O(z12));
endmodule
