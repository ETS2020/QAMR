...
module FAU ( 
  ...
  aoi21  g17(.a(x09), .b(x01), .c(new_n39_), .O(new_n47_));
  nand3  g18(.a(x04), .b(x03), .c(x02), .O(new_n48_));
  nand3  g19(.a(new_n48_), .b(x09), .c(x01), .O(new_n49_));
  oai21  g20(.a(new_n47_), .b(x11), .c(new_n49_), .O(z06));
  ...
  nand2  g26(.a(new_n55_), .b(z00), .O(z09));
  nand4  g27(.a(new_n48_), .b(x12), .c(x11), .d(new_n52_), .O(new_n57_));
  ...
  nand2  g34(.a(new_n63_), .b(new_n39_), .O(new_n64_));
  nand4  g35(.a(new_n58_), .b(x09), .c(x01), .d(x00), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n64_), .O(z11));
  nand4  g37(.a(x11), .b(new_n52_), .c(new_n38_), .d(x00), .O(new_n67_));
  nor2   g38(.a(new_n67_), .b(new_n39_), .O(z12));
endmodule
