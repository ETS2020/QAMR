...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n35_, new_n37_, new_n38_,
    new_n39_, new_n41_, new_n42_, new_n43_, new_n46_, new_n47_, new_n49_,
  ...
  oai21  g20(.a(new_n34_), .b(x12), .c(new_n49_), .O(new_n50_));
  ...
  nand2  g34(.a(new_n63_), .b(new_n46_), .O(z09));
  ...
  nand3  g41(.a(new_n34_), .b(new_n30_), .c(new_n70_), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(x11), .c(new_n56_), .d(x00), .O(new_n73_));
  inv1   g44(.a(new_n73_), .O(z11));
  inv1   g45(.a(x09), .O(new_n75_));
  nand4  g46(.a(x11), .b(new_n56_), .c(new_n75_), .d(x00), .O(new_n76_));
