...
module FAU ( 
  ...
  nand3  g28(.a(x12), .b(x09), .c(x07), .O(new_n58_));
  oai22  g29(.a(new_n58_), .b(new_n51_), .c(new_n57_), .d(new_n44_), .O(z08));
  oai21  g30(.a(x12), .b(x11), .c(new_n37_), .O(new_n60_));
  ...
  nand4  g35(.a(new_n64_), .b(x09), .c(x07), .d(x00), .O(new_n65_));
  ...
  nand2  g41(.a(new_n70_), .b(new_n45_), .O(z11));
  inv1   g42(.a(x09), .O(new_n72_));
  nand4  g43(.a(x11), .b(new_n55_), .c(new_n72_), .d(x00), .O(new_n73_));
  aoi21  g44(.a(new_n73_), .b(x07), .c(new_n32_), .O(z12));
endmodule
