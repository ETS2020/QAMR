...
module FAU ( 
  ...
  nand2  g19(.a(new_n48_), .b(x04), .O(new_n49_));
  nand2  g20(.a(x11), .b(x04), .O(new_n50_));
  ...
  nor2   g25(.a(new_n44_), .b(x15), .O(z07));
  ...
  oai21  g30(.a(new_n59_), .b(new_n48_), .c(new_n58_), .O(z08));
  ...
  nand3  g40(.a(new_n32_), .b(x04), .c(new_n30_), .O(new_n70_));
  ...
  nand4  g44(.a(x11), .b(new_n56_), .c(new_n65_), .d(x00), .O(new_n74_));
