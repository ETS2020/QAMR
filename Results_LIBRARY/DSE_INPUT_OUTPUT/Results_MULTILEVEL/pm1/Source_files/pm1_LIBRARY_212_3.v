...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n36_, new_n37_, new_n38_, new_n40_,
    new_n41_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    new_n52_, new_n53_, new_n54_, new_n55_, new_n57_, new_n58_, new_n60_,
    new_n61_, new_n62_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_,
    new_n70_, new_n71_;
  inv1   g00(.a(x12), .O(new_n30_));
  oai21  g01(.a(x11), .b(x01), .c(new_n30_), .O(new_n31_));
  oai21  g02(.a(x15), .b(new_n30_), .c(new_n31_), .O(z00));
  inv1   g03(.a(x11), .O(new_n33_));
  inv1   g04(.a(x15), .O(z07));
  nand3  g05(.a(z07), .b(x12), .c(new_n33_), .O(z01));
  ...
  nand2  g24(.a(new_n53_), .b(z07), .O(new_n54_));
  ...
  nand3  g30(.a(new_n49_), .b(x11), .c(new_n52_), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(x09), .c(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(z07), .c(new_n30_), .O(z10));
  ...
  nor3   g42(.a(new_n71_), .b(x15), .c(new_n30_), .O(z12));
endmodule
