...
module FAU ( 
  ...
  nand3  g28(.a(x12), .b(x11), .c(x03), .O(new_n58_));
  ...
  nand4  g35(.a(new_n64_), .b(x09), .c(x03), .d(x00), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(z10));
  nand4  g37(.a(new_n62_), .b(x12), .c(x09), .d(x03), .O(new_n67_));
  ...
  aoi21  g44(.a(new_n73_), .b(x03), .c(new_n32_), .O(z12));
endmodule
