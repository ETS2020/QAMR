...
module FAU ( 
  ...
  aoi21  g14(.a(new_n31_), .b(x11), .c(x13), .O(z05));
  inv1   g15(.a(x11), .O(new_n45_));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  oai21  g17(.a(x12), .b(new_n45_), .c(new_n46_), .O(new_n47_));
  nand2  g18(.a(x12), .b(new_n45_), .O(new_n48_));
  ...
  nand3  g28(.a(new_n48_), .b(new_n53_), .c(x00), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n42_), .O(z09));
  inv1   g30(.a(x00), .O(new_n60_));
  inv1   g31(.a(x09), .O(new_n61_));
  nand4  g32(.a(new_n46_), .b(x12), .c(x11), .d(new_n53_), .O(new_n62_));
  nor3   g33(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(z10));
  nand3  g34(.a(new_n46_), .b(new_n53_), .c(x09), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(x01), .c(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x12), .c(new_n45_), .O(z11));
  nand3  g38(.a(new_n53_), .b(new_n61_), .c(x00), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(x12), .c(new_n45_), .O(z12));
endmodule
