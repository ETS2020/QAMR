...
module FAU ( 
  ...
  nand4  g08(.a(x09), .b(x08), .c(x07), .d(x05), .O(new_n38_));
  ...
  oai21  g14(.a(x12), .b(x06), .c(new_n43_), .O(z03));
  ...
  nand3  g39(.a(new_n30_), .b(new_n34_), .c(new_n68_), .O(new_n69_));
  ...
  nand4  g43(.a(x11), .b(new_n54_), .c(new_n63_), .d(x00), .O(new_n73_));
