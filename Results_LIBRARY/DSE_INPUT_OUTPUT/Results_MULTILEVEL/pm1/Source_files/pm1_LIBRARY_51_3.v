...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n36_, new_n37_, new_n38_,
    new_n40_, new_n41_, new_n43_, new_n46_, new_n47_, new_n50_, new_n52_,
  ...
  aoi21  g16(.a(x03), .b(x02), .c(x12), .O(new_n46_));
  ...
  aoi22  g21(.a(new_n50_), .b(x00), .c(x12), .d(x04), .O(z08));
  inv1   g22(.a(x10), .O(new_n52_));
  nand3  g23(.a(x12), .b(x11), .c(new_n34_), .O(new_n53_));
  ...
  nand4  g35(.a(new_n52_), .b(new_n64_), .c(new_n34_), .d(x00), .O(new_n65_));
