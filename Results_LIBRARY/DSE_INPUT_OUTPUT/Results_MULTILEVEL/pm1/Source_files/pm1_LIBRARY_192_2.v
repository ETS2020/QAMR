...
module FAU ( 
  ...
  oai21  g18(.a(x12), .b(new_n42_), .c(new_n47_), .O(new_n48_));
  nand2  g19(.a(x12), .b(new_n42_), .O(new_n49_));
  ...
  nand3  g29(.a(new_n49_), .b(new_n54_), .c(x00), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n45_), .O(z09));
  nand4  g31(.a(new_n47_), .b(new_n54_), .c(x09), .d(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n42_), .O(z10));
  nand4  g33(.a(new_n47_), .b(x12), .c(x11), .d(new_n54_), .O(new_n63_));
