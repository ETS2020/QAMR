...
module FAU ( 
  ...
  nor2   g22(.a(new_n33_), .b(new_n51_), .O(new_n52_));
  ...
  nand3  g28(.a(new_n46_), .b(x11), .c(new_n50_), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(x09), .c(x00), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(x11), .c(new_n33_), .O(z10));
  nand4  g32(.a(new_n46_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  nand3  g33(.a(new_n33_), .b(x11), .c(new_n30_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(new_n50_), .c(x00), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(z01), .O(z11));
  nand3  g37(.a(new_n50_), .b(new_n51_), .c(x00), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(x11), .c(new_n33_), .O(z12));
endmodule
