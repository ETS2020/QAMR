...
module FAU ( 
  ...
  nand2  g17(.a(x12), .b(new_n33_), .O(new_n47_));
  ...
  nand3  g29(.a(new_n58_), .b(new_n52_), .c(x09), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n33_), .O(z10));
  nand3  g33(.a(new_n60_), .b(x01), .c(x00), .O(new_n63_));
