...
module FAU ( 
  ...
  nand3  g28(.a(new_n32_), .b(x12), .c(x09), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n51_), .c(new_n57_), .O(z08));
  ...
  nand4  g34(.a(new_n51_), .b(new_n32_), .c(x12), .d(x11), .O(new_n64_));
  ...
  nand4  g39(.a(new_n51_), .b(new_n32_), .c(x12), .d(x09), .O(new_n69_));
  nand2  g40(.a(new_n30_), .b(new_n68_), .O(new_n70_));
  ...
  aoi21  g46(.a(new_n75_), .b(new_n32_), .c(new_n30_), .O(z12));
endmodule
