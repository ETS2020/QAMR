...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_, new_n38_,
    new_n40_, new_n41_, new_n42_, new_n43_, new_n44_, new_n46_, new_n50_,
  ...
  oai21  g06(.a(z07), .b(new_n30_), .c(new_n35_), .O(z00));
  nand2  g07(.a(x12), .b(new_n32_), .O(new_n37_));
  nand2  g08(.a(z07), .b(x01), .O(new_n38_));
  and2   g09(.a(new_n38_), .b(new_n37_), .O(z01));
  ...
  nand2  g19(.a(new_n38_), .b(x13), .O(z05));
  and2   g20(.a(x03), .b(x02), .O(new_n50_));
  nand3  g21(.a(new_n50_), .b(new_n37_), .c(x04), .O(new_n51_));
  nand2  g22(.a(new_n51_), .b(x09), .O(new_n52_));
  aoi21  g23(.a(new_n52_), .b(x15), .c(new_n30_), .O(z06));
  nor2   g24(.a(new_n32_), .b(x10), .O(new_n54_));
  nand4  g25(.a(new_n50_), .b(x12), .c(x09), .d(x04), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n54_), .c(new_n38_), .d(x00), .O(z08));
  inv1   g27(.a(x10), .O(new_n57_));
  nand2  g28(.a(new_n40_), .b(new_n34_), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n38_), .c(new_n57_), .d(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z09));
  nand3  g31(.a(x04), .b(x03), .c(x02), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n38_), .c(x12), .d(x11), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(new_n57_), .c(x09), .d(x00), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(z10));
  nand4  g36(.a(new_n61_), .b(x15), .c(x12), .d(x09), .O(new_n66_));
  nand2  g37(.a(new_n33_), .b(new_n30_), .O(new_n67_));
  ...
  nand4  g42(.a(new_n38_), .b(x12), .c(x11), .d(new_n57_), .O(new_n72_));
