...
module FAU ( 
  ...
  nand2  g19(.a(new_n48_), .b(x03), .O(new_n49_));
  oai21  g20(.a(new_n33_), .b(new_n44_), .c(x12), .O(new_n50_));
  ...
  nand4  g37(.a(new_n48_), .b(x12), .c(x11), .d(new_n60_), .O(new_n67_));
  ...
  nand3  g44(.a(new_n30_), .b(x03), .c(new_n73_), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(x11), .c(new_n60_), .d(x00), .O(new_n76_));
  inv1   g47(.a(new_n76_), .O(z11));
  nand4  g48(.a(x11), .b(new_n60_), .c(new_n56_), .d(x00), .O(new_n78_));
