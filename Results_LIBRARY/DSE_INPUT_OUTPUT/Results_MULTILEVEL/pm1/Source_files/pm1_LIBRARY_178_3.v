...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n36_, new_n37_, new_n38_, new_n39_,
    new_n40_, new_n42_, new_n43_, new_n44_, new_n47_, new_n49_, new_n50_,
  ...
  aoi21  g16(.a(x15), .b(x12), .c(x14), .O(z04));
  ...
  nand3  g21(.a(z07), .b(x12), .c(new_n31_), .O(new_n51_));
  ...
  nand2  g27(.a(new_n56_), .b(z07), .O(new_n57_));
  ...
  nand3  g33(.a(new_n49_), .b(x11), .c(new_n55_), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(x09), .c(x00), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(z07), .c(new_n32_), .O(z10));
  ...
  nand2  g41(.a(new_n70_), .b(new_n47_), .O(z11));
