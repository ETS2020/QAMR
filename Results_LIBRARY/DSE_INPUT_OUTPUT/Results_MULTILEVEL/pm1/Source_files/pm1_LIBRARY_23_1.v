...
module FAU ( 
  ...
  nand4  g05(.a(x09), .b(x08), .c(x07), .d(x05), .O(new_n35_));
  oai21  g06(.a(new_n35_), .b(new_n31_), .c(x06), .O(new_n36_));
  nand2  g07(.a(new_n36_), .b(x12), .O(z02));
  nand3  g08(.a(x08), .b(x07), .c(x05), .O(new_n38_));
  nand3  g09(.a(new_n38_), .b(x11), .c(x09), .O(new_n39_));
  nand2  g10(.a(new_n39_), .b(x06), .O(new_n40_));
  ...
  nand3  g26(.a(x12), .b(x09), .c(x06), .O(new_n56_));
  ...
  aoi21  g34(.a(new_n63_), .b(x06), .c(new_n32_), .O(z10));
  ...
  nand4  g41(.a(new_n53_), .b(new_n70_), .c(x06), .d(x00), .O(new_n71_));
