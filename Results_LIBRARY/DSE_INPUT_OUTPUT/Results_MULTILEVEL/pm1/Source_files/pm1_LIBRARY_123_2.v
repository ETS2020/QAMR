...
module FAU ( 
  ...
  nand3  g26(.a(z01), .b(new_n52_), .c(x00), .O(new_n56_));
  oai21  g27(.a(x12), .b(new_n31_), .c(new_n56_), .O(z09));
  inv1   g28(.a(x00), .O(new_n58_));
  inv1   g29(.a(x09), .O(new_n59_));
  nand4  g30(.a(new_n46_), .b(x12), .c(x11), .d(new_n52_), .O(new_n60_));
  ...
  nand4  g35(.a(x11), .b(new_n52_), .c(new_n59_), .d(x00), .O(new_n65_));
