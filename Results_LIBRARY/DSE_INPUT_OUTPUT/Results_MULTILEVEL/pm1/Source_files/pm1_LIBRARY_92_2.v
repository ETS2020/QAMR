...
module FAU ( 
  ...
  nand4  g08(.a(x09), .b(x08), .c(x07), .d(x06), .O(new_n38_));
  ...
  nand4  g44(.a(x11), .b(new_n60_), .c(new_n56_), .d(x00), .O(new_n74_));
