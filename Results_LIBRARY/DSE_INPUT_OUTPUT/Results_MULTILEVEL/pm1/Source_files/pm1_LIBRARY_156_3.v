...
module FAU ( 
  ...
  nor2   g11(.a(z07), .b(new_n32_), .O(new_n41_));
  ...
  nand2  g28(.a(new_n57_), .b(new_n55_), .O(z09));
  nand4  g29(.a(new_n47_), .b(z07), .c(x12), .d(x11), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(new_n50_), .c(x09), .d(x00), .O(new_n61_));
  ...
  nand2  g37(.a(new_n66_), .b(new_n55_), .O(z11));
  inv1   g38(.a(x09), .O(new_n68_));
  nand4  g39(.a(x11), .b(new_n50_), .c(new_n68_), .d(x00), .O(new_n69_));
  aoi21  g40(.a(new_n69_), .b(z07), .c(new_n32_), .O(z12));
endmodule
