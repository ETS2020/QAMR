...
module FAU ( 
  ...
  aoi21  g13(.a(new_n34_), .b(x01), .c(new_n30_), .O(new_n43_));
  nand3  g14(.a(x04), .b(x03), .c(x02), .O(new_n44_));
  nand3  g15(.a(new_n44_), .b(x09), .c(x01), .O(new_n45_));
  oai21  g16(.a(new_n43_), .b(new_n31_), .c(new_n45_), .O(z06));
  ...
  nor2   g21(.a(new_n31_), .b(new_n30_), .O(new_n51_));
  ...
  nand4  g28(.a(new_n44_), .b(x11), .c(new_n48_), .d(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x09), .c(new_n31_), .O(z10));
