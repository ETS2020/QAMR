...
module FAU ( 
  ...
  nand4  g31(.a(new_n46_), .b(new_n54_), .c(x09), .d(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n31_), .O(z10));
  nand4  g33(.a(new_n46_), .b(x12), .c(x11), .d(new_n54_), .O(new_n63_));
