...
module FAU ( 
  ...
  oai21  g06(.a(x15), .b(x12), .c(new_n35_), .O(z01));
  ...
  nand2  g14(.a(x15), .b(new_n32_), .O(new_n44_));
  ...
  nand2  g36(.a(new_n65_), .b(z07), .O(new_n66_));
  ...
  nand2  g42(.a(new_n41_), .b(new_n55_), .O(new_n72_));
