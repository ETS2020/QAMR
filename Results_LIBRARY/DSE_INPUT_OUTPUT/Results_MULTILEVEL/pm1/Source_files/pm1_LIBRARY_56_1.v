...
module FAU ( 
  ...
  nand3  g20(.a(new_n49_), .b(new_n38_), .c(x04), .O(new_n50_));
  ...
  nand4  g26(.a(new_n55_), .b(new_n54_), .c(new_n31_), .d(x00), .O(z08));
  inv1   g27(.a(x10), .O(new_n57_));
  nand2  g28(.a(new_n40_), .b(new_n35_), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n31_), .O(z09));
  ...
  nand2  g35(.a(new_n64_), .b(new_n31_), .O(z10));
  nand4  g36(.a(new_n61_), .b(x12), .c(x09), .d(x01), .O(new_n66_));
  inv1   g37(.a(x01), .O(new_n67_));
  nand2  g38(.a(new_n34_), .b(new_n67_), .O(new_n68_));
  ...
  nand4  g43(.a(new_n31_), .b(x12), .c(x11), .d(new_n57_), .O(new_n73_));
  nor3   g44(.a(new_n73_), .b(x09), .c(new_n72_), .O(z12));
endmodule
