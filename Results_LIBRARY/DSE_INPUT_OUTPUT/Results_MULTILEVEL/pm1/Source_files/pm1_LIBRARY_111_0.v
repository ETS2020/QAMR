...
module FAU ( 
  ...
  nor2   g12(.a(x12), .b(x05), .O(new_n42_));
  ...
  oai21  g20(.a(x12), .b(x05), .c(x15), .O(z07));
  ...
  nand3  g27(.a(new_n30_), .b(new_n33_), .c(x05), .O(new_n57_));
  ...
  nand3  g37(.a(new_n30_), .b(x05), .c(new_n66_), .O(new_n67_));
