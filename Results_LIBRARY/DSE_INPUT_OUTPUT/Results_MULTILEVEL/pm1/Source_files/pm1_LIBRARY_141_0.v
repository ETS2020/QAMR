// Benchmark "FAU" written by ABC on Fri Aug 14 01:53:21 2020
...
module FAU ( 
  ...
  nand2  g13(.a(new_n43_), .b(new_n37_), .O(new_n44_));
  nand3  g14(.a(new_n44_), .b(x09), .c(x01), .O(new_n45_));
  inv1   g15(.a(new_n45_), .O(z06));
  inv1   g16(.a(new_n39_), .O(new_n47_));
  nand2  g17(.a(new_n47_), .b(x15), .O(z07));
  ...
  nand2  g25(.a(new_n55_), .b(new_n47_), .O(z09));
  nand4  g26(.a(new_n42_), .b(x12), .c(x11), .d(new_n49_), .O(new_n57_));
  inv1   g27(.a(new_n57_), .O(new_n58_));
  nand3  g28(.a(new_n58_), .b(x09), .c(x00), .O(new_n59_));
  nand2  g29(.a(new_n59_), .b(new_n47_), .O(z10));
  nand4  g30(.a(new_n42_), .b(x12), .c(x09), .d(x01), .O(new_n61_));
  inv1   g31(.a(x01), .O(new_n62_));
  nand2  g32(.a(new_n51_), .b(new_n62_), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  nand4  g34(.a(new_n64_), .b(x11), .c(new_n49_), .d(x00), .O(new_n65_));
