...
module FAU ( 
  ...
  aoi21  g22(.a(z04), .b(new_n32_), .c(x15), .O(z07));
  ...
  oai21  g27(.a(new_n34_), .b(x11), .c(new_n35_), .O(new_n57_));
  ...
  nand2  g34(.a(new_n63_), .b(new_n45_), .O(z10));
  ...
  nand2  g42(.a(new_n41_), .b(new_n56_), .O(new_n72_));
