...
module FAU ( 
  ...
  oai21  g23(.a(new_n47_), .b(x10), .c(x00), .O(new_n53_));
  ...
  nand2  g29(.a(new_n30_), .b(new_n47_), .O(new_n59_));
  ...
  nor3   g36(.a(new_n65_), .b(new_n63_), .c(new_n33_), .O(z10));
  nand2  g37(.a(x11), .b(new_n58_), .O(new_n67_));
