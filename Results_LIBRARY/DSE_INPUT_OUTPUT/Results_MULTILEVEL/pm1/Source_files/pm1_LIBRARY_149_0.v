...
module FAU ( 
  ...
  nand2  g05(.a(x13), .b(new_n32_), .O(new_n35_));
  ...
  nand3  g36(.a(x13), .b(new_n32_), .c(new_n30_), .O(new_n66_));
  ...
  nand3  g41(.a(x12), .b(x11), .c(new_n56_), .O(new_n71_));
  oai21  g42(.a(new_n71_), .b(new_n70_), .c(new_n47_), .O(z12));
endmodule
