...
module FAU ( 
  ...
  oai21  g05(.a(z04), .b(new_n33_), .c(x12), .O(z01));
  ...
  nand2  g12(.a(new_n41_), .b(x14), .O(new_n42_));
  nand2  g13(.a(new_n42_), .b(x12), .O(z03));
  inv1   g14(.a(x12), .O(new_n44_));
  nor2   g15(.a(x14), .b(new_n44_), .O(new_n45_));
  nor2   g16(.a(new_n45_), .b(x13), .O(z05));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  inv1   g18(.a(new_n47_), .O(new_n48_));
  oai22  g19(.a(new_n48_), .b(new_n45_), .c(new_n31_), .d(x11), .O(new_n49_));
  ...
  nand3  g26(.a(x14), .b(x12), .c(x09), .O(new_n56_));
  oai22  g27(.a(new_n56_), .b(new_n47_), .c(new_n55_), .d(new_n45_), .O(z08));
  ...
  nor2   g32(.a(new_n48_), .b(new_n33_), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n53_), .c(x09), .d(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x14), .c(new_n44_), .O(z10));
  inv1   g35(.a(x01), .O(new_n65_));
  nand4  g36(.a(new_n47_), .b(x14), .c(x12), .d(x09), .O(new_n66_));
  nand2  g37(.a(new_n44_), .b(new_n65_), .O(new_n67_));
  ...
  nor3   g43(.a(new_n72_), .b(z04), .c(new_n44_), .O(z12));
endmodule
