...
module FAU ( 
  ...
  nand3  g23(.a(new_n45_), .b(new_n50_), .c(x00), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(new_n42_), .O(z09));
  nand3  g25(.a(x04), .b(x03), .c(x02), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n50_), .c(x09), .d(x00), .O(new_n56_));
  aoi21  g27(.a(new_n56_), .b(x12), .c(new_n33_), .O(z10));
  nand4  g28(.a(new_n55_), .b(x12), .c(x11), .d(new_n50_), .O(new_n58_));
  ...
  nand3  g33(.a(new_n50_), .b(new_n62_), .c(x00), .O(new_n63_));
