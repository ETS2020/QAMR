...
module FAU ( 
  ...
  nand4  g06(.a(x09), .b(x08), .c(x06), .d(x05), .O(new_n36_));
  ...
  nand4  g11(.a(new_n40_), .b(new_n39_), .c(x09), .d(x07), .O(z03));
  nor2   g12(.a(new_n31_), .b(x07), .O(new_n42_));
  ...
  nand3  g26(.a(x12), .b(x09), .c(x07), .O(new_n56_));
  oai22  g27(.a(new_n56_), .b(new_n48_), .c(new_n55_), .d(new_n42_), .O(z08));
  xnor2a g28(.a(x12), .b(x11), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n53_), .c(x00), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n51_), .O(z09));
  nand3  g31(.a(new_n48_), .b(x11), .c(new_n53_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(x09), .c(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x07), .c(new_n31_), .O(z10));
  inv1   g35(.a(x01), .O(new_n65_));
  nand4  g36(.a(new_n48_), .b(x12), .c(x09), .d(x07), .O(new_n66_));
  ...
  aoi21  g43(.a(new_n72_), .b(x07), .c(new_n31_), .O(z12));
endmodule
