...
module FAU ( 
  ...
  nand2  g14(.a(new_n43_), .b(z01), .O(new_n44_));
  ...
  nand4  g24(.a(x12), .b(x11), .c(new_n48_), .d(x00), .O(new_n54_));
  inv1   g25(.a(new_n54_), .O(z09));
  inv1   g26(.a(x00), .O(new_n56_));
  nand4  g27(.a(new_n42_), .b(x12), .c(x11), .d(new_n48_), .O(new_n57_));
  nor3   g28(.a(new_n57_), .b(new_n49_), .c(new_n56_), .O(z10));
  inv1   g29(.a(x01), .O(new_n59_));
  nand3  g30(.a(new_n48_), .b(new_n59_), .c(x00), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(x11), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n50_), .O(new_n62_));
  inv1   g33(.a(new_n57_), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(x09), .c(x01), .d(x00), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n62_), .O(z11));
  nand4  g36(.a(x11), .b(new_n48_), .c(new_n49_), .d(x00), .O(new_n66_));
  nor2   g37(.a(new_n66_), .b(new_n50_), .O(z12));
endmodule
