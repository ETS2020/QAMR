...
module FAU ( 
  ...
  nand4  g12(.a(new_n41_), .b(new_n40_), .c(x09), .d(x04), .O(z03));
  ...
  nand4  g41(.a(new_n53_), .b(new_n70_), .c(x04), .d(x00), .O(new_n71_));
