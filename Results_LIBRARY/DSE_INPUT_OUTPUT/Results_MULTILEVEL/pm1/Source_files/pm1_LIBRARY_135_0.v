...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_, new_n38_,
    ...
    new_n49_, new_n50_, new_n51_, new_n54_, new_n55_, new_n57_, new_n59_,
  ...
  nand2  g27(.a(new_n57_), .b(new_n45_), .O(z09));
  ...
  nand2  g37(.a(new_n37_), .b(x00), .O(new_n68_));
  nand3  g38(.a(x12), .b(x11), .c(new_n54_), .O(new_n69_));
  oai21  g39(.a(new_n69_), .b(new_n68_), .c(new_n45_), .O(z12));
  one    g40(.O(z00));
  buf    g41(.a(x11), .O(z01));
endmodule
