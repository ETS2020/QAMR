...
module FAU ( 
  ...
  nand4  g24(.a(new_n41_), .b(x12), .c(x11), .d(new_n45_), .O(new_n55_));
  nor3   g25(.a(new_n55_), .b(new_n46_), .c(new_n54_), .O(z10));
  nand4  g26(.a(new_n41_), .b(x12), .c(x09), .d(x01), .O(new_n57_));
  nand2  g27(.a(new_n47_), .b(new_n30_), .O(new_n58_));
  ...
  nor2   g32(.a(new_n62_), .b(new_n47_), .O(z12));
  one    g33(.O(z01));
endmodule
