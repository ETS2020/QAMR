...
module FAU ( 
  ...
  nor2   g09(.a(x14), .b(new_n32_), .O(new_n39_));
  nand4  g10(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n40_));
  nand4  g11(.a(new_n40_), .b(new_n39_), .c(x11), .d(x09), .O(z03));
  nand2  g12(.a(x14), .b(new_n32_), .O(z04));
  inv1   g13(.a(x14), .O(new_n43_));
  oai21  g14(.a(new_n43_), .b(new_n32_), .c(x13), .O(z05));
  ...
  aoi21  g21(.a(x14), .b(x12), .c(x15), .O(z07));
  ...
  nand3  g27(.a(new_n43_), .b(x12), .c(x11), .O(new_n57_));
  ...
  aoi21  g34(.a(new_n63_), .b(new_n43_), .c(new_n32_), .O(z10));
  nand4  g35(.a(new_n48_), .b(new_n43_), .c(x12), .d(x09), .O(new_n65_));
  ...
  aoi21  g42(.a(new_n71_), .b(new_n43_), .c(new_n32_), .O(z12));
endmodule
