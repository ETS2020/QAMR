...
module FAU ( 
  ...
  nor3   g27(.a(new_n56_), .b(new_n49_), .c(new_n55_), .O(z10));
  nand4  g28(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n58_));
  inv1   g29(.a(x01), .O(new_n59_));
  nand2  g30(.a(new_n42_), .b(new_n59_), .O(new_n60_));
  ...
  nand4  g34(.a(x11), .b(new_n48_), .c(new_n49_), .d(x00), .O(new_n64_));
  nor2   g35(.a(new_n64_), .b(new_n42_), .O(z12));
endmodule
