...
module FAU ( 
  ...
  nor2   g16(.a(new_n38_), .b(new_n46_), .O(new_n47_));
  ...
  nand4  g22(.a(new_n39_), .b(x12), .c(x11), .d(new_n45_), .O(new_n53_));
  ...
  nand2  g27(.a(new_n57_), .b(new_n38_), .O(new_n58_));
  inv1   g28(.a(new_n53_), .O(new_n59_));
  nand4  g29(.a(new_n59_), .b(x09), .c(x01), .d(x00), .O(new_n60_));
  nand2  g30(.a(new_n60_), .b(new_n58_), .O(z11));
  nand4  g31(.a(x11), .b(new_n45_), .c(new_n46_), .d(x00), .O(new_n62_));
  nor2   g32(.a(new_n62_), .b(new_n38_), .O(z12));
  one    g33(.O(z00));
  buf    g34(.a(x11), .O(z01));
endmodule
