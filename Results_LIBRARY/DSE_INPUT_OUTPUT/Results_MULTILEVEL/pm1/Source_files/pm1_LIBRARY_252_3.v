...
module FAU ( 
  ...
  oai21  g04(.a(new_n31_), .b(x06), .c(x12), .O(z01));
  inv1   g05(.a(x06), .O(new_n36_));
  ...
  oai22  g21(.a(new_n51_), .b(new_n44_), .c(new_n50_), .d(new_n38_), .O(z08));
  ...
  nand4  g30(.a(new_n44_), .b(x12), .c(x09), .d(new_n36_), .O(new_n61_));
  ...
  nand4  g36(.a(x11), .b(new_n48_), .c(new_n66_), .d(x00), .O(new_n67_));
  aoi21  g37(.a(new_n67_), .b(new_n36_), .c(new_n32_), .O(z12));
  one    g38(.O(z02));
endmodule
