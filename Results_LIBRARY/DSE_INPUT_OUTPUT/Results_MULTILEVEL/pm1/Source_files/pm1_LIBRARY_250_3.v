...
module FAU ( 
  ...
  nand2  g14(.a(new_n44_), .b(new_n34_), .O(new_n45_));
  ...
  nand2  g22(.a(new_n52_), .b(new_n34_), .O(new_n53_));
  nand2  g23(.a(new_n53_), .b(x12), .O(new_n54_));
  nand4  g24(.a(new_n54_), .b(x11), .c(new_n51_), .d(x00), .O(z08));
  nand3  g25(.a(x12), .b(x11), .c(new_n34_), .O(new_n56_));
  oai21  g26(.a(x12), .b(x11), .c(new_n56_), .O(new_n57_));
  nand3  g27(.a(new_n57_), .b(new_n51_), .c(x00), .O(new_n58_));
  inv1   g28(.a(new_n58_), .O(z09));
  nand3  g29(.a(new_n47_), .b(x11), .c(new_n51_), .O(new_n60_));
  inv1   g30(.a(new_n60_), .O(new_n61_));
  nand3  g31(.a(new_n61_), .b(x09), .c(x00), .O(new_n62_));
  aoi21  g32(.a(new_n62_), .b(new_n34_), .c(new_n32_), .O(z10));
  nand4  g33(.a(new_n47_), .b(x12), .c(x09), .d(new_n34_), .O(new_n64_));
  nand2  g34(.a(new_n32_), .b(new_n30_), .O(new_n65_));
  oai21  g35(.a(new_n64_), .b(new_n30_), .c(new_n65_), .O(new_n66_));
  nand4  g36(.a(new_n66_), .b(x11), .c(new_n51_), .d(x00), .O(new_n67_));
  inv1   g37(.a(new_n67_), .O(z11));
  nand4  g38(.a(new_n51_), .b(new_n37_), .c(new_n34_), .d(x00), .O(new_n69_));
  nor3   g39(.a(new_n69_), .b(new_n32_), .c(new_n31_), .O(z12));
  one    g40(.O(z02));
endmodule
