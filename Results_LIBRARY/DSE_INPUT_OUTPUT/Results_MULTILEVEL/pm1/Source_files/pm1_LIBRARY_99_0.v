...
module FAU ( 
  ...
  aoi21  g10(.a(x09), .b(x01), .c(new_n37_), .O(new_n41_));
  ...
  nor2   g17(.a(new_n37_), .b(new_n47_), .O(new_n48_));
  ...
  nand4  g22(.a(new_n42_), .b(x12), .c(x11), .d(new_n46_), .O(new_n53_));
  ...
  nand2  g29(.a(new_n59_), .b(new_n37_), .O(new_n60_));
  nand4  g30(.a(new_n54_), .b(x09), .c(x01), .d(x00), .O(new_n61_));
  nand2  g31(.a(new_n61_), .b(new_n60_), .O(z11));
  nand4  g32(.a(x11), .b(new_n46_), .c(new_n47_), .d(x00), .O(new_n63_));
  nor2   g33(.a(new_n63_), .b(new_n37_), .O(z12));
  one    g34(.O(z00));
endmodule
