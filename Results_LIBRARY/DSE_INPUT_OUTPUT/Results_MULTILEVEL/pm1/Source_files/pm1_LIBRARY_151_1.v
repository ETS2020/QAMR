...
module FAU ( 
  ...
  oai21  g04(.a(x14), .b(x12), .c(new_n33_), .O(z01));
  ...
  nand2  g12(.a(x14), .b(x12), .O(z04));
  aoi21  g13(.a(x14), .b(new_n30_), .c(x13), .O(z05));
  inv1   g14(.a(x14), .O(new_n44_));
  nand3  g15(.a(x04), .b(x03), .c(x02), .O(new_n45_));
  oai21  g16(.a(new_n44_), .b(x12), .c(new_n45_), .O(new_n46_));
  ...
  nand2  g22(.a(x14), .b(new_n30_), .O(new_n52_));
  ...
  nand2  g39(.a(new_n68_), .b(new_n44_), .O(new_n69_));
