...
module FAU ( 
  ...
  aoi21  g21(.a(new_n50_), .b(x00), .c(new_n35_), .O(new_n51_));
  inv1   g22(.a(x12), .O(new_n52_));
  nand4  g23(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n53_));
  aoi21  g24(.a(new_n53_), .b(x11), .c(new_n52_), .O(new_n54_));
  or2    g25(.a(new_n54_), .b(new_n51_), .O(z08));
  nand4  g26(.a(x12), .b(x11), .c(new_n50_), .d(x00), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(z00), .O(z09));
  nand4  g28(.a(new_n44_), .b(x12), .c(x11), .d(new_n50_), .O(new_n58_));
  ...
  nand2  g34(.a(new_n52_), .b(new_n63_), .O(new_n64_));
  ...
  nor2   g40(.a(new_n69_), .b(new_n52_), .O(z12));
  buf    g41(.a(x11), .O(z01));
endmodule
