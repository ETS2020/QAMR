...
module FAU ( 
  ...
  oai21  g13(.a(x13), .b(x12), .c(x14), .O(z04));
  nor2   g14(.a(x13), .b(new_n30_), .O(z05));
  and2   g15(.a(x03), .b(x02), .O(new_n45_));
  nand2  g16(.a(x12), .b(new_n36_), .O(new_n46_));
  ...
  nor2   g23(.a(new_n36_), .b(x10), .O(new_n53_));
  nand4  g24(.a(new_n45_), .b(x12), .c(x09), .d(x04), .O(new_n54_));
  ...
  nand4  g41(.a(x11), .b(new_n56_), .c(new_n61_), .d(x00), .O(new_n71_));
