...
module FAU ( 
  ...
  nor2   g14(.a(x12), .b(x10), .O(new_n44_));
  nor2   g15(.a(new_n44_), .b(x14), .O(z04));
  oai21  g16(.a(x12), .b(x10), .c(x13), .O(z05));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  inv1   g18(.a(new_n47_), .O(new_n48_));
  oai21  g19(.a(new_n48_), .b(new_n44_), .c(z01), .O(new_n49_));
  ...
  nand2  g26(.a(new_n55_), .b(new_n39_), .O(z08));
  nand2  g27(.a(x11), .b(x00), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(x12), .c(x10), .O(z09));
  inv1   g29(.a(x00), .O(new_n59_));
  inv1   g30(.a(x09), .O(new_n60_));
  nand4  g31(.a(new_n47_), .b(x12), .c(x11), .d(new_n39_), .O(new_n61_));
  nor3   g32(.a(new_n61_), .b(new_n60_), .c(new_n59_), .O(z10));
  nand3  g33(.a(new_n47_), .b(x11), .c(x09), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(new_n64_));
  nand3  g35(.a(new_n64_), .b(x01), .c(x00), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(x12), .c(x10), .O(z11));
  nand3  g37(.a(x11), .b(new_n60_), .c(x00), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(x12), .c(x10), .O(z12));
endmodule
