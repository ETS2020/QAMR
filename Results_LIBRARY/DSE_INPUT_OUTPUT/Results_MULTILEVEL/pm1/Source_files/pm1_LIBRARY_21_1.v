...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n34_, new_n35_, new_n37_, new_n38_, new_n41_,
  ...
  nand2  g28(.a(new_n48_), .b(new_n30_), .O(new_n59_));
  ...
  nand3  g32(.a(new_n47_), .b(new_n37_), .c(x00), .O(new_n63_));
  aoi21  g33(.a(new_n63_), .b(x11), .c(new_n48_), .O(z12));
  one    g34(.O(z01));
endmodule
