...
module FAU ( 
  ...
  nand3  g19(.a(x12), .b(new_n31_), .c(x07), .O(new_n49_));
  ...
  nand3  g27(.a(x12), .b(x09), .c(x07), .O(new_n57_));
  oai22  g28(.a(new_n57_), .b(new_n47_), .c(new_n56_), .d(new_n44_), .O(z08));
  oai21  g29(.a(x12), .b(x11), .c(new_n37_), .O(new_n59_));
  ...
  nand4  g36(.a(new_n47_), .b(x12), .c(x09), .d(x07), .O(new_n66_));
