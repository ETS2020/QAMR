...
module FAU ( 
  ...
  nand4  g09(.a(new_n38_), .b(new_n33_), .c(x12), .d(x11), .O(z02));
  nand4  g10(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n40_));
  nand4  g11(.a(new_n40_), .b(x12), .c(x11), .d(x09), .O(new_n41_));
  and2   g12(.a(new_n41_), .b(new_n33_), .O(z03));
  ...
  nand2  g19(.a(new_n48_), .b(new_n33_), .O(z06));
  ...
  aoi21  g25(.a(new_n54_), .b(new_n45_), .c(new_n31_), .O(new_n55_));
  aoi22  g26(.a(new_n55_), .b(new_n52_), .c(x15), .d(x14), .O(z08));
  inv1   g27(.a(x10), .O(new_n57_));
  xnor2a g28(.a(x12), .b(x11), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n33_), .O(z09));
  ...
  nand2  g35(.a(new_n64_), .b(new_n33_), .O(z10));
  ...
  nand2  g40(.a(new_n69_), .b(new_n33_), .O(z11));
  nand3  g41(.a(new_n33_), .b(x12), .c(x11), .O(new_n71_));
  nor4   g42(.a(new_n71_), .b(x10), .c(x09), .d(new_n51_), .O(z12));
endmodule
