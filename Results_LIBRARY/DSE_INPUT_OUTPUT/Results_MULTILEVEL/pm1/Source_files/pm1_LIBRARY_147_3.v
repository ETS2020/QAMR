...
module FAU ( 
  ...
  nand2  g15(.a(x13), .b(x12), .O(new_n45_));
  ...
  nand4  g35(.a(new_n48_), .b(new_n34_), .c(x12), .d(x11), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(new_n55_), .c(x09), .d(x00), .O(new_n67_));
  inv1   g38(.a(new_n67_), .O(z10));
  nand4  g39(.a(new_n48_), .b(new_n34_), .c(x12), .d(x09), .O(new_n69_));
  ...
  aoi21  g46(.a(new_n75_), .b(new_n34_), .c(new_n32_), .O(z12));
endmodule
