...
module FAU ( 
  ...
  nand2  g28(.a(new_n57_), .b(new_n48_), .O(new_n58_));
  ...
  nand4  g35(.a(new_n50_), .b(x12), .c(x11), .d(new_n56_), .O(new_n65_));
  ...
  nand2  g41(.a(new_n70_), .b(x05), .O(new_n71_));
  ...
  nand2  g45(.a(new_n43_), .b(x00), .O(new_n75_));
  nand3  g46(.a(x12), .b(x11), .c(new_n56_), .O(new_n76_));
