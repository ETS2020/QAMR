...
module FAU ( 
  ...
  nand4  g28(.a(new_n57_), .b(new_n50_), .c(x09), .d(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x12), .c(new_n33_), .O(z10));
  nand4  g30(.a(new_n57_), .b(x12), .c(x11), .d(new_n50_), .O(new_n60_));
  ...
  nand3  g35(.a(new_n50_), .b(new_n64_), .c(x00), .O(new_n65_));
