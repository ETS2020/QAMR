...
module FAU ( 
  ...
  nor2   g18(.a(new_n38_), .b(new_n48_), .O(new_n49_));
  ...
  aoi21  g25(.a(new_n55_), .b(x11), .c(new_n38_), .O(z10));
  ...
  nand4  g29(.a(new_n59_), .b(x11), .c(new_n47_), .d(x00), .O(new_n60_));
  inv1   g30(.a(new_n60_), .O(z11));
