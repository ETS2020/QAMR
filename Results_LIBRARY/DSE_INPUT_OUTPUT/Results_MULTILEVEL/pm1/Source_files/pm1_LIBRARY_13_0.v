...
module FAU ( 
  ...
  aoi21  g15(.a(new_n44_), .b(new_n32_), .c(x14), .O(z04));
  ...
  nand2  g20(.a(new_n44_), .b(new_n32_), .O(new_n50_));
  nand2  g21(.a(new_n50_), .b(new_n49_), .O(z06));
  nand2  g22(.a(new_n50_), .b(x15), .O(z07));
  nor2   g23(.a(new_n31_), .b(x10), .O(new_n53_));
  nand4  g24(.a(new_n47_), .b(x12), .c(x09), .d(x04), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(new_n53_), .c(new_n50_), .d(x00), .O(z08));
  inv1   g26(.a(x10), .O(new_n56_));
  nand2  g27(.a(x12), .b(x11), .O(new_n57_));
  oai21  g28(.a(new_n39_), .b(x11), .c(new_n57_), .O(new_n58_));
  ...
  nand2  g42(.a(new_n62_), .b(x00), .O(new_n72_));
  nand3  g43(.a(x12), .b(x11), .c(new_n56_), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n72_), .c(new_n50_), .O(z12));
endmodule
