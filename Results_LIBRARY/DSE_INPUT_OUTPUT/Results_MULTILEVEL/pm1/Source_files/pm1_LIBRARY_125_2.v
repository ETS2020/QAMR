...
module FAU ( 
  ...
  oai21  g03(.a(z05), .b(new_n30_), .c(new_n32_), .O(z00));
  inv1   g04(.a(x11), .O(new_n34_));
  oai21  g05(.a(z05), .b(new_n34_), .c(x12), .O(z01));
  ...
  oai21  g09(.a(new_n38_), .b(z05), .c(x12), .O(z02));
  nor2   g10(.a(z05), .b(new_n30_), .O(new_n40_));
  nand4  g11(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n41_));
  nand4  g12(.a(new_n41_), .b(new_n40_), .c(x11), .d(x09), .O(z03));
  nand2  g13(.a(z05), .b(x12), .O(new_n43_));
  ...
  nand2  g25(.a(new_n40_), .b(x09), .O(new_n55_));
  oai21  g26(.a(new_n55_), .b(new_n48_), .c(new_n54_), .O(z08));
  nand3  g27(.a(x13), .b(x12), .c(x11), .O(new_n57_));
  ...
  nand4  g36(.a(new_n48_), .b(x13), .c(x12), .d(x09), .O(new_n66_));
  ...
  nor3   g43(.a(new_n72_), .b(z05), .c(new_n30_), .O(z12));
endmodule
