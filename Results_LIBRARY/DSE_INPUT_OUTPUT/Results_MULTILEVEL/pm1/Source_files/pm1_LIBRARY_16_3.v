...
module FAU ( 
  ...
  nor2   g14(.a(new_n35_), .b(new_n32_), .O(new_n44_));
  nor2   g15(.a(new_n44_), .b(x14), .O(z04));
  nor2   g16(.a(new_n44_), .b(x13), .O(z05));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  inv1   g18(.a(new_n47_), .O(new_n48_));
  oai22  g19(.a(new_n48_), .b(new_n44_), .c(new_n36_), .d(x11), .O(new_n49_));
  ...
  nor3   g43(.a(new_n72_), .b(x15), .c(new_n32_), .O(z12));
endmodule
