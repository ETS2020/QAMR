...
module FAU ( 
  ...
  nand2  g05(.a(x12), .b(x09), .O(z03));
  inv1   g06(.a(z03), .O(z10));
  nor2   g07(.a(z10), .b(x14), .O(z04));
  nand2  g08(.a(z03), .b(x13), .O(z05));
  inv1   g09(.a(x09), .O(new_n40_));
  nand3  g10(.a(x04), .b(x03), .c(x02), .O(new_n41_));
  nand2  g11(.a(new_n41_), .b(x01), .O(new_n42_));
  aoi21  g12(.a(new_n42_), .b(new_n32_), .c(new_n40_), .O(z06));
  nand2  g13(.a(z03), .b(x15), .O(z07));
  inv1   g14(.a(x10), .O(new_n45_));
  nand3  g15(.a(x11), .b(new_n45_), .c(x00), .O(new_n46_));
  and2   g16(.a(new_n46_), .b(z03), .O(z08));
  xnor2a g17(.a(x12), .b(x11), .O(new_n48_));
  nand3  g18(.a(new_n48_), .b(new_n45_), .c(x00), .O(new_n49_));
  nand2  g19(.a(new_n49_), .b(z03), .O(z09));
  nand2  g20(.a(new_n30_), .b(x00), .O(new_n51_));
  nand3  g21(.a(new_n32_), .b(x11), .c(new_n45_), .O(new_n52_));
  oai21  g22(.a(new_n52_), .b(new_n51_), .c(z03), .O(z11));
  aoi21  g23(.a(new_n46_), .b(new_n40_), .c(new_n32_), .O(z12));
  one    g24(.O(z02));
endmodule
