...
module FAU ( 
  ...
  nor2   g14(.a(z07), .b(new_n32_), .O(new_n44_));
  ...
  nand3  g26(.a(z07), .b(x12), .c(x09), .O(new_n56_));
  oai22  g27(.a(new_n56_), .b(new_n50_), .c(new_n55_), .d(new_n44_), .O(z08));
  ...
  nand3  g32(.a(new_n50_), .b(x11), .c(new_n53_), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nand3  g34(.a(new_n63_), .b(x09), .c(x00), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(z07), .c(new_n32_), .O(z10));
  ...
  nand2  g40(.a(new_n69_), .b(new_n58_), .O(z11));
  inv1   g41(.a(x09), .O(new_n71_));
  nand4  g42(.a(x11), .b(new_n53_), .c(new_n71_), .d(x00), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(z07), .c(new_n32_), .O(z12));
endmodule
