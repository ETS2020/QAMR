...
module FAU ( 
  ...
  nand2  g13(.a(new_n33_), .b(x02), .O(new_n43_));
  ...
  nand4  g24(.a(new_n46_), .b(x12), .c(x09), .d(x04), .O(new_n54_));
  ...
  nand4  g32(.a(new_n61_), .b(x12), .c(x11), .d(new_n51_), .O(new_n62_));
  nor3   g33(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(z10));
  nand3  g34(.a(x12), .b(x09), .c(x01), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(new_n65_));
  nor2   g36(.a(x12), .b(x01), .O(new_n66_));
  oai21  g37(.a(new_n66_), .b(new_n65_), .c(new_n31_), .O(new_n67_));
  nand2  g38(.a(x04), .b(x03), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(x12), .c(x09), .d(x01), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand4  g41(.a(new_n70_), .b(x11), .c(new_n51_), .d(x00), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(z11));
  nand2  g43(.a(new_n60_), .b(x00), .O(new_n73_));
  nand2  g44(.a(new_n40_), .b(new_n51_), .O(new_n74_));
