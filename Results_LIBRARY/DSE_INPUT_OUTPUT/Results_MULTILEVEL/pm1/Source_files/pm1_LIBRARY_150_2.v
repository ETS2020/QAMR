...
module FAU ( 
  ...
  oai21  g13(.a(x12), .b(new_n42_), .c(x14), .O(z04));
  nor2   g14(.a(x12), .b(new_n42_), .O(new_n44_));
  ...
  nor2   g24(.a(new_n31_), .b(new_n42_), .O(new_n54_));
  ...
  nand3  g29(.a(new_n46_), .b(x12), .c(new_n53_), .O(new_n59_));
  ...
  aoi21  g36(.a(new_n65_), .b(x12), .c(new_n42_), .O(z11));
  inv1   g37(.a(x09), .O(new_n67_));
  nand3  g38(.a(new_n53_), .b(new_n67_), .c(x00), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(x12), .c(new_n42_), .O(z12));
endmodule
