...
module FAU ( 
  ...
  nand2  g17(.a(new_n46_), .b(z05), .O(new_n47_));
  ...
  aoi21  g22(.a(x13), .b(x12), .c(x15), .O(z07));
  inv1   g23(.a(x10), .O(new_n53_));
  nand4  g24(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(z05), .O(new_n55_));
  ...
  aoi21  g34(.a(new_n63_), .b(z05), .c(new_n30_), .O(z10));
  inv1   g35(.a(x01), .O(new_n65_));
  nand4  g36(.a(new_n49_), .b(z05), .c(x12), .d(x09), .O(new_n66_));
  ...
  aoi21  g43(.a(new_n72_), .b(z05), .c(new_n30_), .O(z12));
endmodule
