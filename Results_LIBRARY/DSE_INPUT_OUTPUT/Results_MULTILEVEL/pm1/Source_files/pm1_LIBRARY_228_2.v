...
module FAU ( 
  ...
  oai21  g06(.a(x12), .b(x10), .c(new_n35_), .O(z01));
  ...
  oai21  g16(.a(x12), .b(new_n31_), .c(x13), .O(z05));
  ...
  nand3  g32(.a(new_n61_), .b(new_n31_), .c(x00), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z09));
  inv1   g34(.a(x09), .O(new_n64_));
  nand4  g35(.a(new_n47_), .b(x12), .c(x11), .d(new_n31_), .O(new_n65_));
  ...
  nand4  g40(.a(new_n69_), .b(x11), .c(new_n31_), .d(x00), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(z11));
  nand4  g42(.a(x11), .b(new_n31_), .c(new_n64_), .d(x00), .O(new_n72_));
