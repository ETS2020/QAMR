...
module FAU ( 
  ...
  nand3  g07(.a(x04), .b(x03), .c(x02), .O(new_n38_));
  nand2  g08(.a(new_n38_), .b(z01), .O(new_n39_));
  ...
  nand4  g15(.a(z01), .b(x11), .c(new_n45_), .d(x00), .O(z08));
  nand4  g16(.a(z01), .b(new_n31_), .c(new_n45_), .d(x00), .O(new_n47_));
  nand2  g17(.a(new_n47_), .b(z03), .O(z09));
