// Benchmark "FAU" written by ABC on Fri Aug 14 01:52:26 2020
...
module FAU ( 
  ...
  nand2  g14(.a(new_n43_), .b(z05), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x12), .O(z03));
  aoi21  g16(.a(x13), .b(x12), .c(x14), .O(z04));
  nand3  g17(.a(new_n31_), .b(x09), .c(x01), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(z05), .O(new_n48_));
  ...
  nand2  g41(.a(new_n70_), .b(new_n53_), .O(z11));
  inv1   g42(.a(x09), .O(new_n72_));
  nand4  g43(.a(x11), .b(new_n55_), .c(new_n72_), .d(x00), .O(new_n73_));
  aoi21  g44(.a(new_n73_), .b(z05), .c(new_n32_), .O(z12));
endmodule
