...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n39_, new_n40_, new_n41_,
  ...
  oai21  g15(.a(x10), .b(new_n44_), .c(new_n32_), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(x11), .O(z08));
  inv1   g17(.a(x10), .O(new_n47_));
  nand4  g18(.a(new_n32_), .b(new_n30_), .c(new_n47_), .d(x00), .O(new_n48_));
  inv1   g19(.a(new_n48_), .O(z09));
  inv1   g20(.a(z02), .O(z10));
  inv1   g21(.a(x01), .O(new_n51_));
  nand4  g22(.a(x11), .b(new_n47_), .c(new_n51_), .d(x00), .O(new_n52_));
