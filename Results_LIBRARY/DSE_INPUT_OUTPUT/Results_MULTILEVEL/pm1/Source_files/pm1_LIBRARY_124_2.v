...
module FAU ( 
  ...
  nand3  g23(.a(z01), .b(new_n50_), .c(x00), .O(new_n53_));
  ...
  nand4  g28(.a(new_n57_), .b(x12), .c(x11), .d(new_n50_), .O(new_n58_));
  nor3   g29(.a(new_n58_), .b(new_n56_), .c(new_n55_), .O(z10));
  inv1   g30(.a(new_n58_), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(x09), .c(x01), .d(x00), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z11));
  nand3  g33(.a(new_n50_), .b(new_n56_), .c(x00), .O(new_n63_));
