...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_, new_n38_,
    new_n39_, new_n41_, new_n42_, new_n45_, new_n46_, new_n47_, new_n48_,
  ...
  aoi21  g13(.a(new_n41_), .b(new_n34_), .c(x13), .O(z05));
  ...
  nand2  g40(.a(new_n70_), .b(x00), .O(new_n71_));
