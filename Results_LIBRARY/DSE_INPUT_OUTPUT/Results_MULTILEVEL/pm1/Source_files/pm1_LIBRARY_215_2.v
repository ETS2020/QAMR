...
module FAU ( 
  ...
  nand2  g03(.a(x13), .b(x11), .O(new_n33_));
  ...
  nand4  g31(.a(new_n47_), .b(x13), .c(x12), .d(x11), .O(new_n61_));
  ...
  nand4  g36(.a(new_n47_), .b(x13), .c(x12), .d(x09), .O(new_n66_));
  nand2  g37(.a(new_n42_), .b(new_n65_), .O(new_n67_));
  ...
  nor3   g43(.a(new_n72_), .b(z05), .c(new_n42_), .O(z12));
endmodule
