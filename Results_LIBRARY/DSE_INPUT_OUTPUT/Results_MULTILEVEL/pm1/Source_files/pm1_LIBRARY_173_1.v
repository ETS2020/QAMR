...
module FAU ( 
  ...
  oai21  g10(.a(new_n39_), .b(new_n34_), .c(new_n35_), .O(z02));
  nor2   g11(.a(new_n34_), .b(new_n31_), .O(new_n41_));
  nand4  g12(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n42_));
  nand3  g13(.a(new_n42_), .b(new_n41_), .c(x09), .O(z03));
  nand2  g14(.a(x15), .b(new_n34_), .O(new_n44_));
  ...
  oai21  g20(.a(new_n48_), .b(x12), .c(new_n49_), .O(new_n50_));
  ...
  nand2  g45(.a(new_n41_), .b(new_n56_), .O(new_n75_));
  oai21  g46(.a(new_n75_), .b(new_n74_), .c(new_n44_), .O(z12));
endmodule
