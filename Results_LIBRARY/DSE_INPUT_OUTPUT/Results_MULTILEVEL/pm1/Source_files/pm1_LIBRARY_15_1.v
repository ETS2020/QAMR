...
module FAU ( 
  ...
  nand4  g30(.a(new_n59_), .b(new_n56_), .c(new_n46_), .d(x00), .O(z08));
  ...
  nand4  g35(.a(new_n49_), .b(x12), .c(x11), .d(new_n61_), .O(new_n65_));
  ...
  nand2  g45(.a(new_n43_), .b(new_n61_), .O(new_n75_));
