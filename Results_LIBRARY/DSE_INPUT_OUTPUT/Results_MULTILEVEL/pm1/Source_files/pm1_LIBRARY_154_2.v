...
module FAU ( 
  ...
  nor2   g13(.a(x14), .b(x12), .O(z04));
  oai21  g14(.a(x14), .b(new_n32_), .c(x13), .O(z05));
  nor2   g15(.a(x14), .b(new_n32_), .O(new_n45_));
  nand3  g16(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  inv1   g17(.a(new_n46_), .O(new_n47_));
  nand3  g18(.a(x14), .b(x12), .c(new_n31_), .O(new_n48_));
  ...
  nor3   g44(.a(new_n73_), .b(new_n71_), .c(new_n32_), .O(z12));
endmodule
