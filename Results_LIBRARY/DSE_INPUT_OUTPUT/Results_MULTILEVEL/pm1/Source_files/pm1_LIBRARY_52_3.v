...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n39_, new_n40_, new_n41_,
    new_n42_, new_n45_, new_n47_, new_n50_;
  ...
  inv1   g06(.a(new_n35_), .O(z02));
  nor2   g07(.a(new_n35_), .b(x14), .O(z04));
  ...
  nor2   g14(.a(new_n35_), .b(x15), .O(z07));
