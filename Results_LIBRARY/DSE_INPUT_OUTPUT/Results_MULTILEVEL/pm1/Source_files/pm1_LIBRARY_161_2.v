...
module FAU ( 
  ...
  nand4  g09(.a(x09), .b(x08), .c(x07), .d(x05), .O(new_n39_));
  oai21  g10(.a(new_n39_), .b(new_n34_), .c(x12), .O(new_n40_));
  ...
  nand2  g14(.a(new_n30_), .b(x06), .O(new_n44_));
  ...
  nand4  g27(.a(new_n56_), .b(new_n53_), .c(new_n44_), .d(x00), .O(z08));
  ...
  nand4  g33(.a(new_n47_), .b(x12), .c(x11), .d(new_n58_), .O(new_n63_));
  ...
  nand4  g43(.a(x11), .b(new_n58_), .c(new_n54_), .d(x00), .O(new_n73_));
