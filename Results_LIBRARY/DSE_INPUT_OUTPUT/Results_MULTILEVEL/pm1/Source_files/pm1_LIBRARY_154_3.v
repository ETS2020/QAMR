...
module FAU ( 
  ...
  oai21  g14(.a(z04), .b(new_n32_), .c(x13), .O(z05));
  nor2   g15(.a(z04), .b(new_n32_), .O(new_n45_));
  ...
  nor3   g43(.a(new_n72_), .b(x14), .c(new_n32_), .O(z12));
endmodule
