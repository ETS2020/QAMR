...
module FAU ( 
  ...
  nand4  g22(.a(x12), .b(x11), .c(new_n47_), .d(x00), .O(new_n53_));
  nand2  g23(.a(new_n53_), .b(new_n38_), .O(z09));
  inv1   g24(.a(x00), .O(new_n55_));
  nand4  g25(.a(new_n41_), .b(x12), .c(x11), .d(new_n47_), .O(new_n56_));
  ...
  nand2  g30(.a(new_n60_), .b(new_n49_), .O(new_n61_));
  inv1   g31(.a(new_n56_), .O(new_n62_));
  nand4  g32(.a(new_n62_), .b(x09), .c(x01), .d(x00), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(new_n61_), .O(z11));
  nand4  g34(.a(x11), .b(new_n47_), .c(new_n48_), .d(x00), .O(new_n65_));
  nor2   g35(.a(new_n65_), .b(new_n49_), .O(z12));
  one    g36(.O(z00));
endmodule
