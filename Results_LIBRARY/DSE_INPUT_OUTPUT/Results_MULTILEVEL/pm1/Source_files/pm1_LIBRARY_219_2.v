...
module FAU ( 
  ...
  oai22  g28(.a(new_n57_), .b(new_n56_), .c(new_n55_), .d(new_n44_), .O(z08));
  ...
  nand4  g35(.a(new_n47_), .b(x12), .c(x11), .d(new_n53_), .O(new_n65_));
  ...
  nand4  g42(.a(x11), .b(new_n53_), .c(new_n64_), .d(x00), .O(new_n72_));
