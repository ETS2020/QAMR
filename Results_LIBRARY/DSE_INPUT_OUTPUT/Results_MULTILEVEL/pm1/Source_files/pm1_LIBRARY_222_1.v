...
module FAU ( 
  ...
  nand4  g06(.a(x09), .b(x07), .c(x06), .d(x05), .O(new_n36_));
  oai21  g07(.a(new_n36_), .b(new_n31_), .c(x08), .O(new_n37_));
  nand2  g08(.a(new_n37_), .b(x12), .O(z02));
  nor2   g09(.a(new_n32_), .b(new_n31_), .O(new_n39_));
  nand3  g10(.a(x07), .b(x06), .c(x05), .O(new_n40_));
  nand4  g11(.a(new_n40_), .b(new_n39_), .c(x09), .d(x08), .O(z03));
  ...
  aoi21  g33(.a(new_n62_), .b(x08), .c(new_n32_), .O(z10));
  nand4  g34(.a(new_n48_), .b(x12), .c(x09), .d(x08), .O(new_n64_));
