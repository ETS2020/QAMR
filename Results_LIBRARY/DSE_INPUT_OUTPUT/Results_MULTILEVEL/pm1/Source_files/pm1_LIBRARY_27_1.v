...
module FAU ( 
  ...
  nand4  g33(.a(new_n46_), .b(x12), .c(x11), .d(new_n51_), .O(new_n63_));
  nor3   g34(.a(new_n63_), .b(new_n62_), .c(new_n50_), .O(z10));
  nand4  g35(.a(new_n46_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  nand3  g36(.a(new_n33_), .b(x11), .c(new_n30_), .O(new_n66_));
  ...
  nand3  g40(.a(new_n51_), .b(new_n62_), .c(x00), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(x11), .c(new_n33_), .O(z12));
endmodule
