...
module FAU ( 
  ...
  aoi21  g15(.a(new_n30_), .b(x03), .c(x14), .O(z04));
  nand2  g16(.a(new_n30_), .b(x03), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(x13), .O(z05));
  nand4  g18(.a(x11), .b(x04), .c(x03), .d(x02), .O(new_n48_));
  ...
  oai21  g38(.a(new_n67_), .b(new_n66_), .c(new_n38_), .O(new_n68_));
  ...
  nand2  g44(.a(new_n61_), .b(x00), .O(new_n74_));
