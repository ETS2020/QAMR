...
module FAU ( 
  ...
  nand2  g15(.a(new_n44_), .b(z01), .O(new_n45_));
  ...
  nor2   g21(.a(new_n31_), .b(new_n50_), .O(new_n51_));
  nand4  g22(.a(new_n51_), .b(x04), .c(x03), .d(x02), .O(new_n52_));
  nand4  g23(.a(new_n52_), .b(x11), .c(new_n49_), .d(x00), .O(z08));
  nand3  g24(.a(new_n38_), .b(new_n49_), .c(x00), .O(new_n54_));
  inv1   g25(.a(new_n54_), .O(z09));
  nand4  g26(.a(new_n43_), .b(x12), .c(x11), .d(new_n49_), .O(new_n56_));
  ...
  nand4  g36(.a(x11), .b(new_n49_), .c(new_n50_), .d(x00), .O(new_n66_));
