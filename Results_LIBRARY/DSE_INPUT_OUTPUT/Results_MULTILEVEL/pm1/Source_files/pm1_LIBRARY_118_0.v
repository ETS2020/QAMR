...
module FAU ( 
  ...
  inv1   g19(.a(new_n42_), .O(new_n50_));
  nand2  g20(.a(new_n50_), .b(x15), .O(z07));
  inv1   g21(.a(x10), .O(new_n52_));
  nand4  g22(.a(new_n36_), .b(x04), .c(x03), .d(x02), .O(new_n53_));
  ...
  nand4  g27(.a(new_n45_), .b(x12), .c(x11), .d(new_n52_), .O(new_n58_));
  nor3   g28(.a(new_n58_), .b(new_n34_), .c(new_n57_), .O(z10));
  nand4  g29(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  inv1   g30(.a(x01), .O(new_n61_));
  nand2  g31(.a(new_n35_), .b(new_n61_), .O(new_n62_));
  nand2  g32(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand4  g33(.a(new_n63_), .b(x11), .c(new_n52_), .d(x00), .O(new_n64_));
  inv1   g34(.a(new_n64_), .O(z11));
  nand2  g35(.a(new_n34_), .b(x00), .O(new_n66_));
  nand3  g36(.a(x12), .b(x11), .c(new_n52_), .O(new_n67_));
  oai21  g37(.a(new_n67_), .b(new_n66_), .c(new_n50_), .O(z12));
  one    g38(.O(z00));
  buf    g39(.a(x11), .O(z01));
endmodule
