...
module FAU ( 
  ...
  nor2   g09(.a(z05), .b(new_n32_), .O(new_n39_));
  ...
  nand2  g27(.a(new_n39_), .b(x09), .O(new_n57_));
  oai21  g28(.a(new_n57_), .b(new_n47_), .c(new_n56_), .O(z08));
  ...
  aoi21  g44(.a(new_n73_), .b(x13), .c(new_n32_), .O(z12));
endmodule
