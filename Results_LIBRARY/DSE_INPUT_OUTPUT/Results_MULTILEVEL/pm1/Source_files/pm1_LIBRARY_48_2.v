...
module FAU ( 
  ...
  oai21  g05(.a(new_n34_), .b(new_n33_), .c(x12), .O(z01));
  ...
  oai21  g14(.a(x13), .b(new_n43_), .c(x14), .O(z04));
  ...
  oai21  g22(.a(x13), .b(new_n43_), .c(x15), .O(z07));
  ...
  nand4  g32(.a(new_n49_), .b(x13), .c(x12), .d(x11), .O(new_n62_));
  ...
  nand4  g37(.a(new_n49_), .b(x13), .c(x12), .d(x09), .O(new_n67_));
  ...
  nor3   g44(.a(new_n73_), .b(new_n34_), .c(new_n43_), .O(z12));
endmodule
