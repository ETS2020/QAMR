...
module FAU ( 
  ...
  oai21  g06(.a(x12), .b(x04), .c(new_n35_), .O(z01));
  ...
  aoi21  g19(.a(new_n30_), .b(x04), .c(x15), .O(z07));
  inv1   g20(.a(x10), .O(new_n50_));
  nand3  g21(.a(x09), .b(x03), .c(x02), .O(new_n51_));
  ...
  nand3  g26(.a(new_n30_), .b(new_n33_), .c(new_n55_), .O(new_n56_));
  ...
  oai21  g38(.a(new_n67_), .b(new_n66_), .c(new_n55_), .O(new_n68_));
  ...
  nand4  g42(.a(new_n71_), .b(x11), .c(new_n50_), .d(x00), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(z11));
  inv1   g44(.a(x09), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(x00), .O(new_n75_));
  nand2  g46(.a(new_n34_), .b(new_n50_), .O(new_n76_));
  oai21  g47(.a(new_n76_), .b(new_n75_), .c(new_n43_), .O(z12));
endmodule
