...
module FAU ( 
  ...
  oai21  g23(.a(new_n49_), .b(x04), .c(new_n52_), .O(z06));
  ...
  nand3  g31(.a(new_n32_), .b(new_n31_), .c(x04), .O(new_n61_));
  ...
  nand4  g38(.a(new_n58_), .b(x12), .c(x11), .d(new_n55_), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(x09), .c(x00), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n67_), .O(z10));
  nand2  g42(.a(x01), .b(x00), .O(new_n72_));
  nand3  g43(.a(x11), .b(new_n55_), .c(x09), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n72_), .c(x12), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n45_), .O(new_n75_));
