...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n35_, new_n36_, new_n40_, new_n41_, new_n42_,
  ...
  nor2   g05(.a(new_n35_), .b(new_n30_), .O(new_n36_));
  inv1   g06(.a(new_n36_), .O(z03));
  nor2   g07(.a(new_n36_), .b(x14), .O(z04));
  ...
  nor2   g14(.a(new_n36_), .b(x15), .O(z07));
  ...
  aoi21  g21(.a(new_n52_), .b(new_n35_), .c(new_n30_), .O(z11));
  one    g22(.O(z02));
  zero   g23(.O(z10));
  zero   g24(.O(z12));
endmodule
