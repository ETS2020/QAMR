...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n37_, new_n38_,
    new_n39_, new_n40_, new_n42_, new_n43_, new_n48_, new_n49_, new_n50_,
  ...
  aoi21  g10(.a(x15), .b(new_n33_), .c(new_n32_), .O(new_n40_));
  nand3  g11(.a(new_n40_), .b(new_n39_), .c(x11), .O(z02));
  nand4  g12(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n42_));
  nand4  g13(.a(new_n42_), .b(x12), .c(x11), .d(x09), .O(new_n43_));
  and2   g14(.a(new_n43_), .b(new_n34_), .O(z03));
  nor2   g15(.a(x15), .b(x14), .O(z04));
  inv1   g16(.a(x15), .O(z07));
  oai21  g17(.a(z07), .b(x14), .c(x13), .O(z05));
  ...
  nand2  g22(.a(new_n51_), .b(new_n34_), .O(z06));
  ...
  aoi21  g27(.a(new_n56_), .b(new_n48_), .c(new_n31_), .O(new_n57_));
  aoi22  g28(.a(new_n57_), .b(new_n54_), .c(x15), .d(new_n33_), .O(z08));
  ...
  nand4  g34(.a(new_n63_), .b(x12), .c(x11), .d(new_n59_), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(x09), .c(x00), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n34_), .O(z10));
  ...
  nand2  g42(.a(new_n71_), .b(new_n34_), .O(z11));
  inv1   g43(.a(x09), .O(new_n73_));
  nand4  g44(.a(new_n40_), .b(x11), .c(new_n59_), .d(new_n73_), .O(new_n74_));
