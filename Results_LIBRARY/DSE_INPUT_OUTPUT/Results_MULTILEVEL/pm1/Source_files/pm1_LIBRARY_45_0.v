...
module FAU ( 
  ...
  oai21  g13(.a(new_n42_), .b(new_n40_), .c(x09), .O(new_n43_));
  oai21  g14(.a(x09), .b(new_n30_), .c(new_n43_), .O(z03));
  ...
  nand2  g25(.a(new_n54_), .b(new_n35_), .O(new_n55_));
  ...
  nor3   g35(.a(new_n64_), .b(new_n37_), .c(new_n62_), .O(z10));
  ...
  nand4  g39(.a(new_n68_), .b(x11), .c(new_n53_), .d(x09), .O(new_n69_));
  nor2   g40(.a(new_n69_), .b(new_n62_), .O(z11));
  nand4  g41(.a(new_n53_), .b(new_n37_), .c(x01), .d(x00), .O(new_n71_));
