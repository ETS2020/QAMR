...
module FAU ( 
  ...
  nand2  g08(.a(new_n32_), .b(x08), .O(new_n38_));
  ...
  nand3  g36(.a(new_n32_), .b(x08), .c(new_n30_), .O(new_n66_));
  ...
  nand2  g41(.a(new_n40_), .b(new_n52_), .O(new_n71_));
  oai21  g42(.a(new_n71_), .b(new_n70_), .c(new_n46_), .O(z12));
endmodule
