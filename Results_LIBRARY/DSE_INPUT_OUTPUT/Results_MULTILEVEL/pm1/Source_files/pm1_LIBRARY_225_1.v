...
module FAU ( 
  ...
  nand3  g09(.a(new_n38_), .b(new_n37_), .c(x00), .O(z02));
  nand4  g10(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n40_));
  nand4  g11(.a(new_n40_), .b(new_n38_), .c(x09), .d(x00), .O(z03));
  ...
  oai21  g17(.a(new_n32_), .b(x00), .c(new_n46_), .O(new_n47_));
  nand3  g18(.a(x12), .b(new_n31_), .c(x00), .O(new_n48_));
  ...
  nor2   g25(.a(new_n32_), .b(new_n54_), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(x04), .c(x03), .d(x02), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(x11), .c(new_n53_), .d(x00), .O(z08));
  nand3  g28(.a(new_n32_), .b(new_n31_), .c(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(new_n59_));
  oai21  g30(.a(new_n59_), .b(new_n38_), .c(new_n53_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n43_), .O(z09));
  nand4  g32(.a(new_n46_), .b(x11), .c(new_n53_), .d(x09), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x00), .c(new_n32_), .O(z10));
  ...
  nand3  g37(.a(new_n66_), .b(x11), .c(new_n53_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n43_), .O(z11));
  nand3  g39(.a(x11), .b(new_n53_), .c(new_n54_), .O(new_n69_));
  aoi21  g40(.a(new_n69_), .b(x00), .c(new_n32_), .O(z12));
endmodule
