...
module FAU ( 
  ...
  nand2  g04(.a(new_n30_), .b(x06), .O(new_n34_));
  ...
  nand4  g29(.a(new_n50_), .b(x12), .c(x09), .d(x04), .O(new_n59_));
  ...
  nor3   g37(.a(new_n66_), .b(new_n43_), .c(new_n64_), .O(z10));
  nand4  g38(.a(new_n65_), .b(x12), .c(x09), .d(x01), .O(new_n68_));
  inv1   g39(.a(x01), .O(new_n69_));
  nand3  g40(.a(new_n30_), .b(x06), .c(new_n69_), .O(new_n70_));
  ...
  nand4  g44(.a(x11), .b(new_n56_), .c(new_n43_), .d(x00), .O(new_n74_));
