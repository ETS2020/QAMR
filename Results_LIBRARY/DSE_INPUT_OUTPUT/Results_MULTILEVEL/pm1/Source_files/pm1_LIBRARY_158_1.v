...
module FAU ( 
  ...
  nand3  g05(.a(x06), .b(x05), .c(x03), .O(new_n35_));
  ...
  aoi21  g13(.a(x11), .b(new_n42_), .c(x14), .O(z04));
  nand2  g14(.a(x11), .b(new_n42_), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x13), .O(z05));
  aoi21  g16(.a(x04), .b(x02), .c(new_n42_), .O(new_n46_));
  aoi21  g17(.a(new_n32_), .b(x03), .c(x11), .O(new_n47_));
  oai21  g18(.a(new_n47_), .b(new_n46_), .c(x09), .O(new_n48_));
  nor2   g19(.a(new_n48_), .b(new_n30_), .O(z06));
  nand2  g20(.a(new_n44_), .b(x15), .O(z07));
  inv1   g21(.a(x10), .O(new_n51_));
  nand4  g22(.a(x12), .b(x09), .c(x04), .d(x02), .O(new_n52_));
  ...
  nand4  g32(.a(new_n61_), .b(x09), .c(x03), .d(x00), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z10));
  inv1   g34(.a(x00), .O(new_n64_));
  nand4  g35(.a(new_n59_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  nand2  g36(.a(new_n32_), .b(new_n30_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x11), .c(new_n51_), .d(x03), .O(new_n68_));
  nor2   g39(.a(new_n68_), .b(new_n64_), .O(z11));
  inv1   g40(.a(x09), .O(new_n70_));
  nand4  g41(.a(new_n51_), .b(new_n70_), .c(x03), .d(x00), .O(new_n71_));
