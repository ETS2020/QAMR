...
module FAU ( 
  ...
  oai21  g11(.a(new_n39_), .b(x11), .c(new_n41_), .O(new_n42_));
  ...
  oai21  g16(.a(x10), .b(new_n46_), .c(x11), .O(new_n47_));
  ...
  nand4  g24(.a(new_n40_), .b(x12), .c(x11), .d(new_n52_), .O(new_n55_));
  inv1   g25(.a(new_n55_), .O(new_n56_));
  nand3  g26(.a(new_n56_), .b(x09), .c(x00), .O(new_n57_));
  nand2  g27(.a(new_n57_), .b(new_n37_), .O(z10));
  inv1   g28(.a(x01), .O(new_n59_));
  nand3  g29(.a(new_n52_), .b(new_n59_), .c(x00), .O(new_n60_));
  nand2  g30(.a(new_n60_), .b(x11), .O(new_n61_));
  nand2  g31(.a(new_n61_), .b(new_n39_), .O(new_n62_));
  nand4  g32(.a(new_n56_), .b(x09), .c(x01), .d(x00), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(new_n62_), .O(z11));
  inv1   g34(.a(x09), .O(new_n65_));
  nand2  g35(.a(new_n65_), .b(x00), .O(new_n66_));
  nand3  g36(.a(x12), .b(x11), .c(new_n52_), .O(new_n67_));
  oai21  g37(.a(new_n67_), .b(new_n66_), .c(new_n37_), .O(z12));
  one    g38(.O(z00));
  buf    g39(.a(x11), .O(z01));
endmodule
