...
module FAU ( 
  ...
  nand2  g04(.a(new_n32_), .b(x08), .O(new_n34_));
  ...
  nand2  g22(.a(new_n51_), .b(new_n45_), .O(z06));
  ...
  nand2  g29(.a(new_n35_), .b(new_n58_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n57_), .c(x00), .O(new_n60_));
  ...
  nand2  g44(.a(new_n41_), .b(new_n57_), .O(new_n74_));
