...
module FAU ( 
  ...
  nand2  g24(.a(x15), .b(x01), .O(z07));
  nor2   g25(.a(new_n32_), .b(x10), .O(new_n55_));
  nand4  g26(.a(new_n50_), .b(x12), .c(x09), .d(x04), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n55_), .c(new_n38_), .d(x00), .O(z08));
  inv1   g28(.a(x10), .O(new_n58_));
  nand2  g29(.a(new_n40_), .b(new_n34_), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n38_), .c(new_n58_), .d(x00), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z09));
  nand3  g32(.a(x04), .b(x03), .c(x02), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n38_), .c(x12), .d(x11), .O(new_n63_));
  ...
  nand3  g38(.a(new_n31_), .b(new_n33_), .c(new_n30_), .O(new_n68_));
  ...
  nand4  g43(.a(new_n38_), .b(x12), .c(x11), .d(new_n58_), .O(new_n73_));
