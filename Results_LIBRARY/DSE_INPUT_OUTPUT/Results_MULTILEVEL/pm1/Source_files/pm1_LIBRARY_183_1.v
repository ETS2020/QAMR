...
module FAU ( 
  ...
  nand2  g11(.a(new_n40_), .b(x03), .O(new_n41_));
  ...
  oai21  g21(.a(new_n47_), .b(x03), .c(new_n50_), .O(z06));
  ...
  aoi21  g32(.a(x04), .b(x02), .c(new_n31_), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n53_), .c(x09), .d(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x03), .c(new_n32_), .O(z10));
  nand2  g35(.a(x04), .b(x02), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(x12), .c(x09), .d(x03), .O(new_n66_));
  ...
  nand4  g42(.a(new_n53_), .b(new_n71_), .c(x03), .d(x00), .O(new_n72_));
