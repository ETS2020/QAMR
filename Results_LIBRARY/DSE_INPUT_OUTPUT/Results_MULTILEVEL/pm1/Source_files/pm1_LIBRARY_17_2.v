...
module FAU ( 
  ...
  nand3  g08(.a(new_n34_), .b(x08), .c(x07), .O(new_n38_));
  ...
  nand2  g17(.a(new_n46_), .b(new_n40_), .O(z06));
  aoi21  g18(.a(new_n31_), .b(x11), .c(x15), .O(z07));
  ...
  nand3  g27(.a(new_n56_), .b(x12), .c(new_n49_), .O(new_n57_));
  inv1   g28(.a(new_n57_), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(x09), .c(x00), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(x12), .c(new_n43_), .O(z10));
  nand4  g31(.a(new_n56_), .b(x12), .c(x11), .d(new_n49_), .O(new_n61_));
  ...
  nand3  g36(.a(new_n49_), .b(new_n65_), .c(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x12), .c(new_n43_), .O(z12));
endmodule
