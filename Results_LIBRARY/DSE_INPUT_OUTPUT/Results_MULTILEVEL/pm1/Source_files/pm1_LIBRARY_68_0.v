...
module FAU ( 
  ...
  aoi21  g11(.a(new_n39_), .b(new_n34_), .c(x13), .O(z05));
  ...
  nand2  g19(.a(new_n49_), .b(x00), .O(new_n50_));
  ...
  oai21  g26(.a(new_n50_), .b(new_n56_), .c(new_n40_), .O(z09));
  inv1   g27(.a(x00), .O(new_n58_));
  inv1   g28(.a(x09), .O(new_n59_));
  nand4  g29(.a(new_n43_), .b(x12), .c(x11), .d(new_n49_), .O(new_n60_));
  nor3   g30(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(z10));
  inv1   g31(.a(x01), .O(new_n62_));
  nand3  g32(.a(new_n49_), .b(new_n62_), .c(x00), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(x11), .O(new_n64_));
  nand2  g34(.a(new_n64_), .b(new_n39_), .O(new_n65_));
  inv1   g35(.a(new_n60_), .O(new_n66_));
  nand4  g36(.a(new_n66_), .b(x09), .c(x01), .d(x00), .O(new_n67_));
  nand2  g37(.a(new_n67_), .b(new_n65_), .O(z11));
  nand4  g38(.a(x11), .b(new_n49_), .c(new_n59_), .d(x00), .O(new_n69_));
  nor2   g39(.a(new_n69_), .b(new_n39_), .O(z12));
  one    g40(.O(z00));
  buf    g41(.a(x11), .O(z01));
endmodule
