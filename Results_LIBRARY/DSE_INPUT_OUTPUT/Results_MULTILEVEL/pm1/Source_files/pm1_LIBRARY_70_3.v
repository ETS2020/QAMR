...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n38_, new_n39_, new_n40_, new_n41_, new_n42_,
    new_n45_, new_n47_, new_n50_, new_n51_;
  ...
  nand4  g17(.a(z01), .b(new_n30_), .c(new_n45_), .d(x00), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(z02), .O(z09));
  inv1   g19(.a(x01), .O(new_n50_));
  nand4  g20(.a(x11), .b(new_n45_), .c(new_n50_), .d(x00), .O(new_n51_));
  nor2   g21(.a(new_n51_), .b(x12), .O(z11));
  zero   g22(.O(z10));
  inv1   g23(.a(z12), .O(z03));
endmodule
