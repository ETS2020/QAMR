...
module FAU ( 
  ...
  oai21  g13(.a(x12), .b(x10), .c(new_n42_), .O(z03));
  nand2  g14(.a(new_n33_), .b(x10), .O(new_n44_));
  ...
  aoi21  g20(.a(new_n33_), .b(x10), .c(x15), .O(z07));
  inv1   g21(.a(x00), .O(new_n51_));
  oai21  g22(.a(new_n32_), .b(new_n51_), .c(new_n31_), .O(new_n52_));
  ...
  nand3  g28(.a(new_n57_), .b(new_n31_), .c(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z09));
  inv1   g30(.a(x09), .O(new_n60_));
  nand3  g31(.a(x04), .b(x03), .c(x02), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(x12), .c(x11), .d(new_n31_), .O(new_n62_));
  nor3   g33(.a(new_n62_), .b(new_n60_), .c(new_n51_), .O(z10));
  nand4  g34(.a(new_n61_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  nand2  g35(.a(new_n33_), .b(new_n30_), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(x11), .c(new_n31_), .d(x00), .O(new_n67_));
  inv1   g38(.a(new_n67_), .O(z11));
  nand2  g39(.a(new_n60_), .b(x00), .O(new_n69_));
  nand3  g40(.a(x12), .b(x11), .c(new_n31_), .O(new_n70_));
