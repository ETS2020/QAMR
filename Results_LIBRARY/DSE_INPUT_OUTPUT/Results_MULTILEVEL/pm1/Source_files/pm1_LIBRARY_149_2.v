...
module FAU ( 
  ...
  nor2   g13(.a(x13), .b(new_n32_), .O(new_n43_));
  ...
  oai21  g30(.a(x13), .b(new_n32_), .c(new_n59_), .O(z09));
  nand4  g31(.a(new_n49_), .b(x13), .c(x12), .d(x11), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(new_n53_), .c(x09), .d(x00), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(z10));
  nand4  g35(.a(new_n49_), .b(x13), .c(x12), .d(x09), .O(new_n65_));
  ...
  aoi21  g42(.a(new_n71_), .b(x13), .c(new_n32_), .O(z12));
endmodule
