...
module FAU ( 
  ...
  aoi21  g14(.a(new_n32_), .b(x11), .c(x13), .O(z05));
  ...
  nand3  g24(.a(z01), .b(new_n51_), .c(x00), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(new_n42_), .O(z09));
  nand3  g26(.a(new_n45_), .b(new_n51_), .c(x09), .O(new_n56_));
  inv1   g27(.a(new_n56_), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x12), .c(new_n31_), .O(z10));
  nand3  g30(.a(new_n57_), .b(x01), .c(x00), .O(new_n60_));
