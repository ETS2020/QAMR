...
module FAU ( 
  ...
  aoi21  g13(.a(new_n30_), .b(x04), .c(x14), .O(z04));
  nand2  g14(.a(new_n30_), .b(x04), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x13), .O(z05));
  inv1   g16(.a(x01), .O(new_n46_));
  inv1   g17(.a(x09), .O(new_n47_));
  nand3  g18(.a(x11), .b(x03), .c(x02), .O(new_n48_));
  aoi21  g19(.a(new_n48_), .b(x12), .c(new_n38_), .O(new_n49_));
  nor3   g20(.a(new_n49_), .b(new_n47_), .c(new_n46_), .O(z06));
  nand2  g21(.a(new_n44_), .b(x15), .O(z07));
  inv1   g22(.a(x10), .O(new_n52_));
  nand3  g23(.a(x09), .b(x03), .c(x02), .O(new_n53_));
  ...
  nand3  g27(.a(new_n30_), .b(new_n33_), .c(new_n38_), .O(new_n57_));
  ...
  nor3   g34(.a(new_n63_), .b(new_n47_), .c(new_n61_), .O(z10));
  ...
  nand4  g44(.a(x11), .b(new_n52_), .c(new_n47_), .d(x00), .O(new_n74_));
