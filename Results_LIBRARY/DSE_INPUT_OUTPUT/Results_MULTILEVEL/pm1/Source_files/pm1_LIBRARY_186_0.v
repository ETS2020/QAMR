...
module FAU ( 
  ...
  aoi21  g16(.a(x09), .b(x01), .c(new_n35_), .O(new_n46_));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  nand3  g18(.a(new_n47_), .b(x09), .c(x01), .O(new_n48_));
  oai21  g19(.a(new_n46_), .b(x11), .c(new_n48_), .O(z06));
  nor2   g20(.a(new_n30_), .b(x15), .O(z07));
  inv1   g21(.a(x10), .O(new_n51_));
  nand4  g22(.a(new_n36_), .b(x04), .c(x03), .d(x02), .O(new_n52_));
  nand4  g23(.a(new_n52_), .b(x11), .c(new_n51_), .d(x00), .O(z08));
  nand4  g24(.a(x12), .b(x11), .c(new_n51_), .d(x00), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(z00), .O(z09));
  nand4  g26(.a(new_n47_), .b(x12), .c(x11), .d(new_n51_), .O(new_n56_));
  ...
  nand3  g31(.a(new_n51_), .b(new_n60_), .c(x00), .O(new_n61_));
  ...
  nand2  g36(.a(new_n34_), .b(x00), .O(new_n66_));
  nand3  g37(.a(x12), .b(x11), .c(new_n51_), .O(new_n67_));
