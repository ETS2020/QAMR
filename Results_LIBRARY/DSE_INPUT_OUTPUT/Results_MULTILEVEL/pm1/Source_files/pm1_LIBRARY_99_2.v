...
module FAU ( 
  ...
  nand3  g23(.a(new_n52_), .b(new_n49_), .c(x00), .O(new_n53_));
  inv1   g24(.a(new_n53_), .O(z09));
  nand3  g25(.a(x04), .b(x03), .c(x02), .O(new_n55_));
  nand3  g26(.a(new_n55_), .b(x12), .c(new_n49_), .O(new_n56_));
  inv1   g27(.a(new_n56_), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(x09), .c(x00), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(x12), .c(new_n31_), .O(z10));
  nand3  g30(.a(new_n55_), .b(new_n49_), .c(x09), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(x01), .c(x00), .O(new_n62_));
