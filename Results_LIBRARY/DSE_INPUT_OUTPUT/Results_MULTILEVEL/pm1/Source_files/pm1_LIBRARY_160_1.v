...
module FAU ( 
  ...
  nand4  g30(.a(new_n46_), .b(new_n51_), .c(x09), .d(x00), .O(new_n61_));
  aoi21  g31(.a(new_n61_), .b(x11), .c(new_n32_), .O(z10));
  nand4  g32(.a(new_n46_), .b(x12), .c(x09), .d(x01), .O(new_n63_));
  nand3  g33(.a(new_n32_), .b(x11), .c(new_n30_), .O(new_n64_));
  nand2  g34(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand3  g35(.a(new_n65_), .b(new_n51_), .c(x00), .O(new_n66_));
  nand2  g36(.a(new_n66_), .b(new_n43_), .O(z11));
  inv1   g37(.a(x09), .O(new_n68_));
  nand3  g38(.a(new_n51_), .b(new_n68_), .c(x00), .O(new_n69_));
