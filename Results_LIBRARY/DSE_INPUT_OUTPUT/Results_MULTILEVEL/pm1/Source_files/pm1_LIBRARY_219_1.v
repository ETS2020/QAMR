...
module FAU ( 
  ...
  nand2  g04(.a(x11), .b(x05), .O(new_n34_));
  ...
  nand2  g11(.a(new_n38_), .b(x06), .O(new_n41_));
  nand4  g12(.a(new_n41_), .b(new_n40_), .c(x09), .d(x05), .O(z03));
  ...
  nand3  g18(.a(x12), .b(new_n31_), .c(x05), .O(new_n48_));
  ...
  oai22  g27(.a(new_n56_), .b(new_n46_), .c(new_n55_), .d(new_n43_), .O(z08));
  ...
  nand4  g36(.a(new_n46_), .b(x12), .c(x09), .d(x05), .O(new_n66_));
