...
module FAU ( 
  ...
  nand4  g29(.a(new_n45_), .b(x12), .c(x11), .d(new_n50_), .O(new_n60_));
  nor3   g30(.a(new_n60_), .b(new_n38_), .c(new_n49_), .O(z10));
  ...
  nand3  g34(.a(new_n64_), .b(new_n50_), .c(x00), .O(new_n65_));
  nand2  g35(.a(new_n65_), .b(new_n44_), .O(z11));
  nand3  g36(.a(new_n50_), .b(new_n38_), .c(x00), .O(new_n67_));
