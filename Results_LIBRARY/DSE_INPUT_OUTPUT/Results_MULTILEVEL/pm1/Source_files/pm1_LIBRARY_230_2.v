...
module FAU ( 
  ...
  nand2  g15(.a(x12), .b(new_n40_), .O(new_n45_));
  ...
  nand3  g25(.a(z01), .b(new_n50_), .c(x00), .O(new_n55_));
  ...
  nand3  g32(.a(new_n59_), .b(new_n50_), .c(x09), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nand3  g34(.a(new_n63_), .b(x01), .c(x00), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x12), .c(new_n40_), .O(z11));
  nand4  g36(.a(x11), .b(new_n50_), .c(new_n58_), .d(x00), .O(new_n66_));
