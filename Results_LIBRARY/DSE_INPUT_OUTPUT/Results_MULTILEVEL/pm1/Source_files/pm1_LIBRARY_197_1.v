...
module FAU ( 
  ...
  nor2   g19(.a(new_n40_), .b(new_n37_), .O(new_n50_));
  ...
  nor3   g27(.a(new_n57_), .b(new_n37_), .c(new_n56_), .O(z10));
  nand4  g28(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n59_));
  nand3  g29(.a(new_n40_), .b(x11), .c(new_n30_), .O(new_n60_));
  nand2  g30(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g31(.a(new_n61_), .b(new_n49_), .c(x00), .O(new_n62_));
  nand2  g32(.a(new_n62_), .b(new_n43_), .O(z11));
  nand4  g33(.a(x11), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n64_));
