...
module FAU ( 
  ...
  nand2  g01(.a(x13), .b(x12), .O(new_n31_));
  oai21  g02(.a(new_n30_), .b(x12), .c(new_n31_), .O(z00));
  inv1   g03(.a(x11), .O(new_n33_));
  nand3  g04(.a(x13), .b(x12), .c(new_n33_), .O(z01));
  ...
  nor2   g14(.a(x13), .b(new_n43_), .O(new_n44_));
  nor2   g15(.a(new_n44_), .b(x14), .O(z04));
  inv1   g16(.a(x13), .O(z05));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  inv1   g18(.a(new_n47_), .O(new_n48_));
  oai22  g19(.a(new_n48_), .b(new_n44_), .c(new_n31_), .d(x11), .O(new_n49_));
  ...
  nand3  g26(.a(x13), .b(x12), .c(x09), .O(new_n56_));
  oai22  g27(.a(new_n56_), .b(new_n47_), .c(new_n55_), .d(new_n44_), .O(z08));
  nand2  g28(.a(new_n43_), .b(new_n33_), .O(new_n58_));
  oai21  g29(.a(new_n31_), .b(new_n33_), .c(new_n58_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n53_), .c(x00), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z09));
  nand4  g32(.a(new_n47_), .b(x13), .c(x12), .d(x11), .O(new_n62_));
  ...
  nand2  g38(.a(new_n43_), .b(new_n66_), .O(new_n68_));
  ...
  aoi21  g44(.a(new_n73_), .b(x13), .c(new_n43_), .O(z12));
endmodule
