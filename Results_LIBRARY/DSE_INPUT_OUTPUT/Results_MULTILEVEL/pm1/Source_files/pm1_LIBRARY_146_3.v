...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n40_, new_n41_, new_n42_, new_n43_, new_n46_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n56_, new_n58_, new_n59_, new_n61_,
    new_n62_;
  ...
  nor2   g15(.a(new_n30_), .b(new_n40_), .O(z10));
  inv1   g16(.a(z10), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(x14), .O(z04));
  nor2   g18(.a(z10), .b(x13), .O(z05));
  nand3  g19(.a(new_n33_), .b(x09), .c(x01), .O(new_n49_));
  ...
  oai21  g26(.a(new_n33_), .b(x10), .c(new_n30_), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(x00), .O(z08));
  inv1   g28(.a(x10), .O(new_n58_));
  nand2  g29(.a(new_n33_), .b(new_n58_), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(new_n30_), .c(new_n40_), .O(z09));
  inv1   g31(.a(x01), .O(new_n61_));
  nand3  g32(.a(x11), .b(new_n58_), .c(new_n61_), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(new_n30_), .c(new_n40_), .O(z11));
  nor2   g34(.a(new_n30_), .b(new_n40_), .O(z12));
endmodule
