...
module FAU ( 
  ...
  nand2  g04(.a(z07), .b(new_n30_), .O(new_n34_));
  ...
  inv1   g20(.a(x11), .O(new_n50_));
  nand2  g21(.a(x12), .b(new_n50_), .O(new_n51_));
  nand3  g22(.a(new_n51_), .b(new_n49_), .c(x04), .O(new_n52_));
  nand3  g23(.a(new_n52_), .b(x09), .c(x01), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(new_n46_), .O(z06));
  ...
  oai21  g29(.a(new_n57_), .b(new_n45_), .c(new_n58_), .O(z08));
