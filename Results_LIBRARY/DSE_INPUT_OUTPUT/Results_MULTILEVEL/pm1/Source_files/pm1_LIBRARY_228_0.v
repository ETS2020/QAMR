...
module FAU ( 
  ...
  oai21  g07(.a(x12), .b(new_n34_), .c(new_n36_), .O(z01));
  ...
  nand3  g25(.a(new_n54_), .b(x11), .c(x00), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(x12), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n34_), .O(z08));
  nand3  g28(.a(new_n35_), .b(new_n34_), .c(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z09));
  inv1   g30(.a(x00), .O(new_n60_));
  inv1   g31(.a(x09), .O(new_n61_));
  nand4  g32(.a(new_n47_), .b(x12), .c(x11), .d(new_n34_), .O(new_n62_));
  ...
  nand4  g37(.a(x11), .b(new_n34_), .c(new_n61_), .d(x00), .O(new_n67_));
