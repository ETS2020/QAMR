...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n38_, new_n39_,
    new_n41_, new_n44_, new_n45_, new_n48_, new_n49_, new_n50_, new_n52_,
  ...
  nor2   g18(.a(new_n32_), .b(new_n38_), .O(new_n49_));
  nand4  g19(.a(new_n49_), .b(x04), .c(x03), .d(x02), .O(new_n50_));
  nand4  g20(.a(new_n50_), .b(x11), .c(new_n48_), .d(x00), .O(z08));
  xnor2a g21(.a(x12), .b(x11), .O(new_n52_));
  nand3  g22(.a(new_n52_), .b(new_n48_), .c(x00), .O(new_n53_));
  inv1   g23(.a(new_n53_), .O(z09));
  nand4  g24(.a(new_n44_), .b(new_n48_), .c(x09), .d(x00), .O(new_n55_));
  ...
  nand4  g29(.a(new_n59_), .b(x11), .c(new_n48_), .d(x00), .O(new_n60_));
  inv1   g30(.a(new_n60_), .O(z11));
  nand4  g31(.a(x11), .b(new_n48_), .c(new_n38_), .d(x00), .O(new_n62_));
