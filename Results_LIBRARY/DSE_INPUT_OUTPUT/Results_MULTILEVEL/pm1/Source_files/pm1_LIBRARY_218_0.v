...
module FAU ( 
  ...
  aoi21  g08(.a(new_n31_), .b(new_n38_), .c(x14), .O(z04));
  nand2  g09(.a(new_n31_), .b(new_n38_), .O(new_n40_));
  ...
  oai21  g24(.a(new_n48_), .b(new_n54_), .c(new_n40_), .O(z09));
  inv1   g25(.a(x00), .O(new_n56_));
  inv1   g26(.a(x09), .O(new_n57_));
  nand4  g27(.a(new_n43_), .b(x12), .c(x11), .d(new_n47_), .O(new_n58_));
  nor3   g28(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(z10));
  nand4  g29(.a(new_n43_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  inv1   g30(.a(x01), .O(new_n61_));
  nand2  g31(.a(new_n31_), .b(new_n61_), .O(new_n62_));
  nand2  g32(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand4  g33(.a(new_n63_), .b(x11), .c(new_n47_), .d(x00), .O(new_n64_));
  inv1   g34(.a(new_n64_), .O(z11));
  nand4  g35(.a(x11), .b(new_n47_), .c(new_n57_), .d(x00), .O(new_n66_));
  nor2   g36(.a(new_n66_), .b(new_n31_), .O(z12));
  one    g37(.O(z00));
  buf    g38(.a(x11), .O(z01));
endmodule
