...
module FAU ( 
  ...
  aoi21  g17(.a(new_n30_), .b(new_n44_), .c(x13), .O(z05));
  ...
  oai21  g23(.a(new_n33_), .b(x10), .c(x00), .O(new_n53_));
  ...
  nand3  g29(.a(x12), .b(x11), .c(x00), .O(new_n59_));
  ...
  nand2  g38(.a(x11), .b(new_n58_), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(x01), .c(x00), .O(new_n69_));
  ...
  nand3  g45(.a(x12), .b(x11), .c(new_n58_), .O(new_n75_));
  oai21  g46(.a(new_n75_), .b(new_n74_), .c(new_n45_), .O(z12));
endmodule
