...
module FAU ( 
  ...
  nand2  g17(.a(x12), .b(new_n42_), .O(new_n47_));
  ...
  nand3  g27(.a(z01), .b(new_n52_), .c(x00), .O(new_n57_));
  inv1   g28(.a(new_n57_), .O(z09));
  nand3  g29(.a(x04), .b(x03), .c(x02), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(x12), .c(new_n52_), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(x09), .c(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x12), .c(new_n42_), .O(z10));
  nand3  g34(.a(new_n59_), .b(new_n52_), .c(x09), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(x01), .c(x00), .O(new_n66_));
  aoi21  g37(.a(new_n66_), .b(x12), .c(new_n42_), .O(z11));
  inv1   g38(.a(x09), .O(new_n68_));
  nand3  g39(.a(new_n52_), .b(new_n68_), .c(x00), .O(new_n69_));
  aoi21  g40(.a(new_n69_), .b(x12), .c(new_n42_), .O(z12));
endmodule
