...
module FAU ( 
  ...
  aoi21  g21(.a(new_n50_), .b(x00), .c(new_n32_), .O(new_n51_));
  nand4  g22(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n52_));
  aoi21  g23(.a(new_n52_), .b(x11), .c(new_n44_), .O(new_n53_));
  or2    g24(.a(new_n53_), .b(new_n51_), .O(z08));
  nand4  g25(.a(x12), .b(x11), .c(new_n50_), .d(x00), .O(new_n55_));
  inv1   g26(.a(new_n55_), .O(z09));
  nand4  g27(.a(new_n46_), .b(x12), .c(x11), .d(new_n50_), .O(new_n57_));
  ...
  nand3  g32(.a(new_n50_), .b(new_n61_), .c(x00), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(x11), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n44_), .O(new_n64_));
  ...
  nor2   g39(.a(new_n68_), .b(new_n44_), .O(z12));
endmodule
