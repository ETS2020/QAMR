...
module FAU ( 
  ...
  nand4  g07(.a(x07), .b(x06), .c(x05), .d(x03), .O(new_n37_));
  ...
  nor2   g14(.a(new_n31_), .b(x03), .O(new_n44_));
  ...
  nand4  g38(.a(new_n67_), .b(x12), .c(x09), .d(x03), .O(new_n68_));
  nand2  g39(.a(new_n31_), .b(new_n66_), .O(new_n69_));
  oai21  g40(.a(new_n68_), .b(new_n66_), .c(new_n69_), .O(new_n70_));
  nand4  g41(.a(new_n70_), .b(x11), .c(new_n54_), .d(x00), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(z11));
  inv1   g43(.a(x09), .O(new_n73_));
  nand4  g44(.a(new_n54_), .b(new_n73_), .c(x03), .d(x00), .O(new_n74_));
  nor3   g45(.a(new_n74_), .b(new_n31_), .c(new_n34_), .O(z12));
endmodule
