...
module FAU ( 
  ...
  wire new_n31_, new_n33_, new_n34_, new_n36_, new_n37_, new_n38_, new_n39_,
    new_n40_, new_n42_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
  ...
  nand2  g36(.a(new_n36_), .b(x00), .O(new_n67_));
  nand3  g37(.a(x12), .b(x11), .c(new_n52_), .O(new_n68_));
  oai21  g38(.a(new_n68_), .b(new_n67_), .c(new_n50_), .O(z12));
  one    g39(.O(z00));
endmodule
