...
module FAU ( 
  ...
  nand2  g09(.a(new_n39_), .b(new_n36_), .O(new_n40_));
  ...
  aoi21  g17(.a(new_n39_), .b(new_n36_), .c(x15), .O(z07));
  inv1   g18(.a(x10), .O(new_n49_));
  aoi21  g19(.a(new_n49_), .b(x00), .c(new_n36_), .O(new_n50_));
  nand4  g20(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n51_));
  aoi21  g21(.a(new_n51_), .b(x11), .c(new_n39_), .O(new_n52_));
  or2    g22(.a(new_n52_), .b(new_n50_), .O(z08));
  ...
  nand2  g36(.a(new_n66_), .b(x00), .O(new_n67_));
  nand3  g37(.a(x12), .b(x11), .c(new_n49_), .O(new_n68_));
