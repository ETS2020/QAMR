...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n38_, new_n39_, new_n40_, new_n43_,
  ...
  oai21  g11(.a(new_n38_), .b(new_n32_), .c(new_n40_), .O(z06));
  nand2  g12(.a(z02), .b(x15), .O(z07));
  inv1   g13(.a(x00), .O(new_n43_));
  oai21  g14(.a(x10), .b(new_n43_), .c(new_n32_), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x11), .O(z08));
  inv1   g16(.a(x10), .O(new_n46_));
  nand4  g17(.a(new_n32_), .b(new_n31_), .c(new_n46_), .d(x00), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(z02), .O(z09));
  inv1   g19(.a(z02), .O(z10));
  nand3  g20(.a(new_n46_), .b(new_n30_), .c(x00), .O(new_n50_));
  aoi21  g21(.a(new_n50_), .b(new_n32_), .c(new_n31_), .O(z11));
