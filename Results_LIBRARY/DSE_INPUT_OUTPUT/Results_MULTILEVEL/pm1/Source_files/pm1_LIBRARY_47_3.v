...
module FAU ( 
  ...
  nand3  g19(.a(x12), .b(new_n34_), .c(new_n33_), .O(new_n49_));
  ...
  oai21  g29(.a(new_n58_), .b(new_n40_), .c(x00), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n43_), .O(z09));
  inv1   g31(.a(x00), .O(new_n61_));
  nand4  g32(.a(new_n47_), .b(x12), .c(x11), .d(new_n33_), .O(new_n62_));
  ...
  nand2  g36(.a(new_n30_), .b(new_n65_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x11), .c(new_n33_), .d(x00), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z11));
  nand4  g40(.a(x11), .b(new_n33_), .c(new_n54_), .d(x00), .O(new_n70_));
