...
module FAU ( 
  ...
  oai21  g22(.a(x12), .b(new_n31_), .c(x15), .O(z07));
  inv1   g23(.a(x10), .O(new_n53_));
  nor2   g24(.a(new_n32_), .b(new_n31_), .O(new_n54_));
  nand4  g25(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n54_), .c(new_n53_), .d(x00), .O(z08));
  nand3  g27(.a(z01), .b(new_n53_), .c(x00), .O(new_n57_));
  inv1   g28(.a(new_n57_), .O(z09));
  inv1   g29(.a(x00), .O(new_n59_));
  inv1   g30(.a(x09), .O(new_n60_));
  nand4  g31(.a(new_n46_), .b(x12), .c(x11), .d(new_n53_), .O(new_n61_));
  ...
  nand3  g36(.a(new_n53_), .b(new_n60_), .c(x00), .O(new_n66_));
