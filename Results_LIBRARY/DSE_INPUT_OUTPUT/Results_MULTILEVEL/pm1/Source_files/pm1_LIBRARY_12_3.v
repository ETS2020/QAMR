...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n34_, new_n40_, new_n41_, new_n42_, new_n43_,
  ...
  nand2  g10(.a(new_n40_), .b(new_n34_), .O(new_n41_));
  ...
  oai21  g16(.a(x10), .b(new_n46_), .c(new_n34_), .O(new_n47_));
  nand2  g17(.a(new_n47_), .b(x11), .O(z08));
  inv1   g18(.a(x10), .O(new_n49_));
  nand4  g19(.a(new_n34_), .b(new_n30_), .c(new_n49_), .d(x00), .O(new_n50_));
  nand2  g20(.a(new_n50_), .b(z02), .O(z09));
