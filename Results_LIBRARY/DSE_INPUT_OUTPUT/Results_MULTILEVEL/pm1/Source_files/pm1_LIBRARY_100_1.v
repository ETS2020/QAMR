...
module FAU ( 
  ...
  nand2  g21(.a(new_n48_), .b(x11), .O(new_n52_));
  ...
  aoi21  g25(.a(new_n55_), .b(x11), .c(new_n48_), .O(z10));
  nand4  g26(.a(new_n43_), .b(x12), .c(x09), .d(x01), .O(new_n57_));
  nand3  g27(.a(new_n48_), .b(x11), .c(new_n30_), .O(new_n58_));
  ...
  nand3  g31(.a(new_n47_), .b(new_n37_), .c(x00), .O(new_n62_));
  aoi21  g32(.a(new_n62_), .b(x11), .c(new_n48_), .O(z12));
  one    g33(.O(z01));
endmodule
