...
module FAU ( 
  ...
  nand3  g29(.a(new_n58_), .b(new_n49_), .c(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z09));
  nand3  g31(.a(new_n44_), .b(x11), .c(new_n49_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(x09), .c(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(x11), .c(new_n54_), .O(z10));
  nand4  g35(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  nand2  g36(.a(new_n54_), .b(new_n30_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x11), .c(new_n49_), .d(x00), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z11));
  inv1   g40(.a(x09), .O(new_n70_));
  nand3  g41(.a(new_n49_), .b(new_n70_), .c(x00), .O(new_n71_));
  aoi21  g42(.a(new_n71_), .b(x11), .c(new_n54_), .O(z12));
endmodule
