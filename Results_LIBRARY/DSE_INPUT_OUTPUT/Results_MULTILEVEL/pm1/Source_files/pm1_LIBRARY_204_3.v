...
module FAU ( 
  ...
  nor2   g07(.a(new_n32_), .b(new_n34_), .O(new_n38_));
  ...
  nand2  g12(.a(new_n42_), .b(new_n34_), .O(new_n43_));
  ...
  nand4  g29(.a(new_n59_), .b(x09), .c(new_n34_), .d(x00), .O(new_n60_));
  ...
  nand2  g35(.a(new_n65_), .b(new_n39_), .O(z11));
