...
module FAU ( 
  ...
  nand2  g08(.a(new_n30_), .b(x04), .O(new_n38_));
  ...
  aoi21  g13(.a(new_n30_), .b(new_n42_), .c(x14), .O(z04));
  nand2  g14(.a(new_n30_), .b(new_n42_), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x13), .O(z05));
  nand2  g16(.a(x03), .b(x02), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(x04), .O(new_n47_));
  oai21  g18(.a(new_n33_), .b(new_n42_), .c(x12), .O(new_n48_));
  ...
  or2    g25(.a(new_n54_), .b(new_n46_), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n53_), .c(new_n44_), .d(x00), .O(z08));
  inv1   g27(.a(x10), .O(new_n57_));
  nand3  g28(.a(new_n30_), .b(new_n33_), .c(x04), .O(new_n58_));
  oai21  g29(.a(new_n30_), .b(new_n33_), .c(new_n58_), .O(new_n59_));
  ...
  nand4  g35(.a(new_n64_), .b(x12), .c(x11), .d(new_n57_), .O(new_n65_));
  ...
  nand3  g39(.a(new_n30_), .b(x04), .c(new_n68_), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand4  g41(.a(new_n70_), .b(x11), .c(new_n57_), .d(x00), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(z11));
  nand4  g43(.a(x11), .b(new_n57_), .c(new_n63_), .d(x00), .O(new_n73_));
