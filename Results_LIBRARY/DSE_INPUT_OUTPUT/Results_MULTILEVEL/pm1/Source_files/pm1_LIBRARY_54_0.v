...
module FAU ( 
  ...
  nand2  g14(.a(new_n30_), .b(new_n39_), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(x14), .O(z04));
  aoi21  g16(.a(new_n30_), .b(new_n39_), .c(x13), .O(z05));
  nand2  g17(.a(x03), .b(x02), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(x04), .O(new_n48_));
  oai21  g19(.a(new_n33_), .b(new_n39_), .c(x12), .O(new_n49_));
  ...
  nor2   g24(.a(new_n33_), .b(x10), .O(new_n54_));
  nand3  g25(.a(x12), .b(x09), .c(x04), .O(new_n55_));
  or2    g26(.a(new_n55_), .b(new_n47_), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n54_), .c(new_n44_), .d(x00), .O(z08));
  inv1   g28(.a(x10), .O(new_n58_));
  nand3  g29(.a(new_n30_), .b(new_n33_), .c(x04), .O(new_n59_));
  oai21  g30(.a(new_n30_), .b(new_n33_), .c(new_n59_), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(new_n58_), .c(x00), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z09));
  inv1   g33(.a(x00), .O(new_n63_));
  inv1   g34(.a(x09), .O(new_n64_));
  nand3  g35(.a(x04), .b(x03), .c(x02), .O(new_n65_));
  nand4  g36(.a(new_n65_), .b(x12), .c(x11), .d(new_n58_), .O(new_n66_));
  ...
  nand3  g40(.a(new_n30_), .b(x04), .c(new_n69_), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n68_), .O(new_n71_));
  nand4  g42(.a(new_n71_), .b(x11), .c(new_n58_), .d(x00), .O(new_n72_));
  inv1   g43(.a(new_n72_), .O(z11));
  nand4  g44(.a(x11), .b(new_n58_), .c(new_n64_), .d(x00), .O(new_n74_));
