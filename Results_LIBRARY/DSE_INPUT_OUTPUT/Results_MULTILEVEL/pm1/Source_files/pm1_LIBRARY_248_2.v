...
module FAU ( 
  ...
  nor2   g14(.a(x14), .b(x12), .O(z04));
  aoi21  g15(.a(new_n34_), .b(x12), .c(x13), .O(z05));
  nand2  g16(.a(new_n34_), .b(x12), .O(new_n46_));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  nand2  g18(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand3  g19(.a(x14), .b(x12), .c(new_n31_), .O(new_n49_));
  ...
  nand4  g32(.a(new_n47_), .b(x14), .c(x12), .d(x11), .O(new_n62_));
  ...
  nand2  g40(.a(new_n69_), .b(new_n46_), .O(z11));
  inv1   g41(.a(x09), .O(new_n71_));
  nand4  g42(.a(x11), .b(new_n54_), .c(new_n71_), .d(x00), .O(new_n72_));
  nor3   g43(.a(new_n72_), .b(new_n34_), .c(new_n32_), .O(z12));
endmodule
