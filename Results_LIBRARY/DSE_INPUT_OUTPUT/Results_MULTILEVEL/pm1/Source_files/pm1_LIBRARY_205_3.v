...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n37_, new_n38_, new_n41_, new_n42_,
  ...
  oai21  g12(.a(new_n41_), .b(z01), .c(new_n43_), .O(z06));
  ...
  nand3  g19(.a(new_n46_), .b(new_n51_), .c(x00), .O(new_n52_));
  aoi21  g20(.a(new_n52_), .b(z01), .c(new_n32_), .O(z11));
  one    g21(.O(z02));
  one    g22(.O(z03));
  zero   g23(.O(z10));
  zero   g24(.O(z12));
