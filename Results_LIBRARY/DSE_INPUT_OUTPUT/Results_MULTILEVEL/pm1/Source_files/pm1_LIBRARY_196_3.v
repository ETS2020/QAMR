...
module FAU ( 
  ...
  nand2  g03(.a(z04), .b(x12), .O(new_n33_));
  nand2  g04(.a(new_n33_), .b(new_n31_), .O(z00));
  inv1   g05(.a(x11), .O(new_n35_));
  nand3  g06(.a(z04), .b(x12), .c(new_n35_), .O(z01));
  ...
  nand3  g11(.a(new_n40_), .b(new_n37_), .c(x11), .O(z02));
  ...
  oai21  g18(.a(new_n33_), .b(x11), .c(new_n47_), .O(new_n48_));
  ...
  nand2  g24(.a(new_n53_), .b(z04), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(x12), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(x11), .c(new_n52_), .d(x00), .O(z08));
  nand2  g27(.a(new_n30_), .b(new_n35_), .O(new_n57_));
  oai21  g28(.a(new_n33_), .b(new_n35_), .c(new_n57_), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n52_), .c(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z09));
  nand3  g31(.a(new_n46_), .b(x11), .c(new_n52_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(x09), .c(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(z04), .c(new_n30_), .O(z10));
  inv1   g35(.a(x01), .O(new_n65_));
  nand4  g36(.a(new_n46_), .b(z04), .c(x12), .d(x09), .O(new_n66_));
  ...
  aoi21  g43(.a(new_n72_), .b(z04), .c(new_n30_), .O(z12));
endmodule
