...
module FAU ( 
  ...
  nand2  g07(.a(z04), .b(new_n35_), .O(new_n37_));
  ...
  oai21  g11(.a(new_n40_), .b(new_n35_), .c(new_n37_), .O(z02));
  ...
  nor2   g43(.a(new_n72_), .b(new_n35_), .O(z12));
endmodule
