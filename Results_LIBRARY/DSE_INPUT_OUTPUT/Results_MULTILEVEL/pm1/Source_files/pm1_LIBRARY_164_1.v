...
module FAU ( 
  ...
  oai21  g10(.a(new_n39_), .b(new_n37_), .c(x08), .O(new_n40_));
  inv1   g11(.a(x14), .O(z04));
  nand2  g12(.a(z04), .b(new_n33_), .O(new_n42_));
  nand2  g13(.a(new_n42_), .b(new_n40_), .O(z02));
  nand4  g14(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n44_));
  nand4  g15(.a(new_n44_), .b(new_n38_), .c(new_n34_), .d(x09), .O(z03));
  aoi21  g16(.a(x14), .b(new_n33_), .c(x13), .O(z05));
