...
module FAU ( 
  ...
  nand2  g23(.a(new_n40_), .b(x11), .O(new_n54_));
  nand3  g24(.a(new_n54_), .b(new_n49_), .c(x00), .O(new_n55_));
  nand2  g25(.a(new_n55_), .b(new_n44_), .O(z09));
  ...
  nand2  g30(.a(new_n40_), .b(new_n30_), .O(new_n61_));
  nand2  g31(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand4  g32(.a(new_n62_), .b(x11), .c(new_n49_), .d(x00), .O(new_n63_));
