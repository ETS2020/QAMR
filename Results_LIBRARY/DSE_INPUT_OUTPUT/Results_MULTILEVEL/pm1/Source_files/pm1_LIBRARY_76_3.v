...
module FAU ( 
  ...
  oai21  g09(.a(new_n34_), .b(new_n38_), .c(new_n33_), .O(new_n39_));
  ...
  nand3  g15(.a(x12), .b(new_n34_), .c(new_n33_), .O(new_n45_));
  oai21  g16(.a(new_n44_), .b(new_n36_), .c(new_n45_), .O(new_n46_));
  ...
  nand3  g23(.a(x12), .b(x09), .c(new_n33_), .O(new_n53_));
  oai22  g24(.a(new_n53_), .b(new_n43_), .c(new_n52_), .d(new_n36_), .O(z08));
  ...
  aoi21  g31(.a(new_n60_), .b(new_n33_), .c(new_n30_), .O(z10));
  ...
  nand4  g38(.a(x11), .b(new_n50_), .c(new_n38_), .d(x00), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(new_n33_), .c(new_n30_), .O(z12));
endmodule
