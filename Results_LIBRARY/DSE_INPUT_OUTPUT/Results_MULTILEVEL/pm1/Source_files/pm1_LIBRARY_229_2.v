...
module FAU ( 
  ...
  nand4  g11(.a(new_n40_), .b(x12), .c(x11), .d(x08), .O(z02));
  ...
  oai21  g15(.a(x12), .b(x08), .c(new_n44_), .O(z03));
  ...
  nand3  g29(.a(new_n30_), .b(new_n34_), .c(new_n33_), .O(new_n59_));
  ...
  nand4  g39(.a(x11), .b(new_n58_), .c(new_n68_), .d(x00), .O(new_n69_));
  ...
  nand3  g46(.a(x12), .b(x11), .c(new_n58_), .O(new_n76_));
  oai21  g47(.a(new_n76_), .b(new_n75_), .c(new_n47_), .O(z12));
endmodule
