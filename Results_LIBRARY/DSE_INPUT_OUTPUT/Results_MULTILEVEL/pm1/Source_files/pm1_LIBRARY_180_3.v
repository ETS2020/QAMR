...
module FAU ( 
  ...
  nand2  g04(.a(x14), .b(x01), .O(new_n34_));
  ...
  nand4  g09(.a(new_n38_), .b(new_n34_), .c(x12), .d(x11), .O(z02));
  inv1   g10(.a(new_n34_), .O(new_n40_));
  nand4  g11(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n41_));
  and2   g12(.a(new_n41_), .b(x09), .O(new_n42_));
  nor2   g13(.a(new_n32_), .b(new_n31_), .O(new_n43_));
  aoi21  g14(.a(new_n43_), .b(new_n42_), .c(new_n40_), .O(z03));
  ...
  nand2  g43(.a(new_n43_), .b(new_n57_), .O(new_n73_));
