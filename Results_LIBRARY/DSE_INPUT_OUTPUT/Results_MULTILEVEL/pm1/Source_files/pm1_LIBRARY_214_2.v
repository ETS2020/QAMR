...
module FAU ( 
  ...
  oai21  g30(.a(new_n33_), .b(new_n32_), .c(new_n59_), .O(new_n60_));
  ...
  nor2   g40(.a(x12), .b(x01), .O(new_n70_));
  oai21  g41(.a(new_n70_), .b(new_n69_), .c(new_n31_), .O(new_n71_));
  nand2  g42(.a(x04), .b(x03), .O(new_n72_));
  ...
  nand4  g47(.a(x11), .b(new_n54_), .c(new_n64_), .d(x00), .O(new_n77_));
