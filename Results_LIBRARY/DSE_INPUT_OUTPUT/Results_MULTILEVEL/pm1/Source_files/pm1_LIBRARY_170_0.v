...
module FAU ( 
  ...
  aoi21  g15(.a(new_n31_), .b(new_n30_), .c(x13), .O(z05));
  ...
  nand4  g28(.a(new_n46_), .b(x12), .c(x11), .d(new_n52_), .O(new_n58_));
  nor3   g29(.a(new_n58_), .b(new_n39_), .c(new_n57_), .O(z10));
  inv1   g30(.a(x01), .O(new_n60_));
  nand3  g31(.a(new_n52_), .b(new_n60_), .c(x00), .O(new_n61_));
  ...
  nand4  g37(.a(x11), .b(new_n52_), .c(new_n39_), .d(x00), .O(new_n67_));
