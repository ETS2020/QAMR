// Benchmark "FAU" written by ABC on Fri Aug 14 01:52:50 2020
...
module FAU ( 
  ...
  nand4  g30(.a(new_n45_), .b(x12), .c(x11), .d(new_n50_), .O(new_n61_));
  nor3   g31(.a(new_n61_), .b(new_n37_), .c(new_n49_), .O(z10));
  nand4  g32(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n63_));
  nand3  g33(.a(new_n40_), .b(x11), .c(new_n30_), .O(new_n64_));
  nand2  g34(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand3  g35(.a(new_n65_), .b(new_n50_), .c(x00), .O(new_n66_));
  nand2  g36(.a(new_n66_), .b(new_n42_), .O(z11));
  nand3  g37(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n68_));
  aoi21  g38(.a(new_n68_), .b(x11), .c(new_n40_), .O(z12));
  one    g39(.O(z01));
endmodule
