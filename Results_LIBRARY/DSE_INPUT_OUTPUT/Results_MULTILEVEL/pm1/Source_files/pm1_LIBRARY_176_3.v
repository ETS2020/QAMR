...
module FAU ( 
  ...
  nand3  g15(.a(x12), .b(new_n34_), .c(new_n33_), .O(new_n46_));
  nand2  g16(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  ...
  nand2  g22(.a(new_n52_), .b(new_n33_), .O(new_n53_));
  ...
  nand2  g27(.a(new_n57_), .b(new_n40_), .O(z09));
  nand3  g28(.a(new_n44_), .b(x11), .c(new_n51_), .O(new_n59_));
  inv1   g29(.a(new_n59_), .O(new_n60_));
  nand3  g30(.a(new_n60_), .b(x09), .c(x00), .O(new_n61_));
  aoi21  g31(.a(new_n61_), .b(new_n33_), .c(new_n30_), .O(z10));
  inv1   g32(.a(x01), .O(new_n63_));
  nand4  g33(.a(new_n44_), .b(x12), .c(x09), .d(new_n33_), .O(new_n64_));
  ...
  nand4  g38(.a(x11), .b(new_n51_), .c(new_n37_), .d(x00), .O(new_n69_));
