...
module FAU ( 
  ...
  nand3  g21(.a(new_n50_), .b(x03), .c(x02), .O(new_n51_));
  nand3  g22(.a(new_n51_), .b(x09), .c(x01), .O(new_n52_));
  oai21  g23(.a(new_n48_), .b(x04), .c(new_n52_), .O(z06));
  ...
  nand3  g31(.a(new_n30_), .b(new_n49_), .c(x04), .O(new_n61_));
  ...
  nand4  g39(.a(new_n58_), .b(x12), .c(x11), .d(new_n55_), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(new_n70_));
  nand3  g41(.a(new_n70_), .b(x09), .c(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n68_), .O(z10));
  nand2  g43(.a(x01), .b(x00), .O(new_n73_));
  nand3  g44(.a(x11), .b(new_n55_), .c(x09), .O(new_n74_));
  oai21  g45(.a(new_n74_), .b(new_n73_), .c(x12), .O(new_n75_));
  nand2  g46(.a(new_n75_), .b(new_n65_), .O(new_n76_));
  nand4  g47(.a(new_n58_), .b(x12), .c(x09), .d(x01), .O(new_n77_));
  inv1   g48(.a(x01), .O(new_n78_));
  nand2  g49(.a(new_n30_), .b(new_n78_), .O(new_n79_));
  nand2  g50(.a(new_n79_), .b(new_n77_), .O(new_n80_));
  nand4  g51(.a(new_n80_), .b(x11), .c(new_n55_), .d(x00), .O(new_n81_));
  nand2  g52(.a(new_n81_), .b(new_n76_), .O(z11));
  inv1   g53(.a(x09), .O(new_n83_));
  nand2  g54(.a(new_n83_), .b(x00), .O(new_n84_));
  nand3  g55(.a(x12), .b(x11), .c(new_n55_), .O(new_n85_));
  oai21  g56(.a(new_n85_), .b(new_n84_), .c(new_n45_), .O(z12));
endmodule
