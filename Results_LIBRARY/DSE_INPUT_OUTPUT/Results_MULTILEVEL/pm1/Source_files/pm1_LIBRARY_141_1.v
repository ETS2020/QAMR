...
module FAU ( 
  ...
  nand2  g30(.a(new_n59_), .b(z01), .O(z09));
  nand4  g31(.a(new_n46_), .b(new_n51_), .c(x09), .d(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x11), .c(new_n32_), .O(z10));
