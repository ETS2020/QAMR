...
module FAU ( 
  ...
  oai21  g12(.a(x12), .b(x07), .c(new_n41_), .O(z03));
  ...
  oai21  g19(.a(x12), .b(new_n43_), .c(new_n48_), .O(new_n49_));
  ...
  nand4  g28(.a(new_n57_), .b(new_n54_), .c(new_n45_), .d(x00), .O(z08));
  ...
  nand4  g33(.a(new_n48_), .b(x12), .c(x11), .d(new_n59_), .O(new_n63_));
  ...
  nand3  g39(.a(new_n30_), .b(new_n43_), .c(new_n68_), .O(new_n69_));
  ...
  nand2  g43(.a(new_n55_), .b(x00), .O(new_n73_));
