...
module FAU ( 
  ...
  nand3  g29(.a(new_n59_), .b(new_n51_), .c(x00), .O(new_n60_));
  inv1   g30(.a(new_n60_), .O(z09));
  nand4  g31(.a(new_n46_), .b(new_n51_), .c(x09), .d(x00), .O(new_n62_));
  ...
  nand3  g39(.a(new_n51_), .b(new_n69_), .c(x00), .O(new_n70_));
  aoi21  g40(.a(new_n70_), .b(x11), .c(new_n32_), .O(z12));
  one    g41(.O(z01));
endmodule
