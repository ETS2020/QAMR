...
module FAU ( 
  ...
  oai21  g02(.a(new_n30_), .b(x10), .c(new_n31_), .O(z00));
  ...
  nor2   g10(.a(new_n30_), .b(new_n34_), .O(new_n40_));
  nand4  g11(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n41_));
  nand4  g12(.a(new_n41_), .b(new_n40_), .c(new_n33_), .d(x09), .O(z03));
  nor2   g13(.a(new_n30_), .b(new_n33_), .O(new_n43_));
  ...
  nand4  g27(.a(new_n56_), .b(x11), .c(new_n33_), .d(x00), .O(z08));
  xnor2a g28(.a(x12), .b(x11), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n33_), .c(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z09));
  nand3  g31(.a(new_n50_), .b(x11), .c(new_n33_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(x09), .c(x00), .O(new_n63_));
  aoi21  g34(.a(new_n63_), .b(new_n33_), .c(new_n30_), .O(z10));
  nand4  g35(.a(new_n50_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  inv1   g36(.a(x01), .O(new_n66_));
  nand3  g37(.a(new_n30_), .b(new_n33_), .c(new_n66_), .O(new_n67_));
  ...
  nand3  g41(.a(x11), .b(new_n54_), .c(x00), .O(new_n71_));
  aoi21  g42(.a(new_n71_), .b(new_n33_), .c(new_n30_), .O(z12));
endmodule
