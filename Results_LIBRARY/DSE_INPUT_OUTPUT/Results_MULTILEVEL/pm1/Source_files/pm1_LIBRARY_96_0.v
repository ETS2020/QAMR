...
module FAU ( 
  ...
  oai21  g17(.a(x15), .b(x14), .c(x13), .O(z05));
  ...
  aoi21  g29(.a(new_n58_), .b(new_n48_), .c(new_n31_), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(new_n56_), .c(new_n33_), .O(z08));
  inv1   g31(.a(x10), .O(new_n61_));
  xnor2a g32(.a(x12), .b(x11), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(new_n61_), .c(x00), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n34_), .O(z09));
  ...
  nand4  g43(.a(new_n72_), .b(x11), .c(new_n61_), .d(x00), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n34_), .O(z11));
  inv1   g45(.a(x09), .O(new_n75_));
  nand4  g46(.a(new_n40_), .b(x11), .c(new_n61_), .d(new_n75_), .O(new_n76_));
  nor2   g47(.a(new_n76_), .b(new_n55_), .O(z12));
endmodule
