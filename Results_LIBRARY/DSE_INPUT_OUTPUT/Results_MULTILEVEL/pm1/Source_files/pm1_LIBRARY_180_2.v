...
module FAU ( 
  ...
  nand2  g05(.a(z04), .b(x01), .O(new_n35_));
  ...
  nor2   g16(.a(new_n41_), .b(x13), .O(z05));
  ...
  nand2  g42(.a(new_n44_), .b(new_n56_), .O(new_n72_));
  oai21  g43(.a(new_n72_), .b(new_n71_), .c(new_n35_), .O(z12));
endmodule
