...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n39_, new_n40_, new_n41_, new_n42_, new_n43_,
    new_n46_, new_n47_, new_n49_, new_n50_, new_n52_, new_n53_;
  inv1   g00(.a(x11), .O(new_n30_));
  oai21  g01(.a(x12), .b(x01), .c(new_n30_), .O(new_n31_));
  oai21  g02(.a(x12), .b(new_n30_), .c(new_n31_), .O(z00));
  inv1   g03(.a(x12), .O(z01));
  nor2   g04(.a(z01), .b(new_n30_), .O(z10));
  inv1   g05(.a(z10), .O(z03));
  nand2  g06(.a(z03), .b(x14), .O(z04));
  nor2   g07(.a(z10), .b(x13), .O(z05));
  nand3  g08(.a(x04), .b(x03), .c(x02), .O(new_n39_));
  nand2  g09(.a(new_n39_), .b(z01), .O(new_n40_));
  nand2  g10(.a(x12), .b(new_n30_), .O(new_n41_));
  nand2  g11(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand3  g12(.a(new_n42_), .b(x09), .c(x01), .O(new_n43_));
  inv1   g13(.a(new_n43_), .O(z06));
  nand2  g14(.a(z03), .b(x15), .O(z07));
  inv1   g15(.a(x00), .O(new_n46_));
  oai21  g16(.a(x10), .b(new_n46_), .c(z01), .O(new_n47_));
  nand2  g17(.a(new_n47_), .b(x11), .O(z08));
  inv1   g18(.a(x10), .O(new_n49_));
  nand4  g19(.a(z01), .b(new_n30_), .c(new_n49_), .d(x00), .O(new_n50_));
  nand2  g20(.a(new_n50_), .b(z03), .O(z09));
  inv1   g21(.a(x01), .O(new_n52_));
  nand4  g22(.a(x11), .b(new_n49_), .c(new_n52_), .d(x00), .O(new_n53_));
  nor2   g23(.a(new_n53_), .b(x12), .O(z11));
  one    g24(.O(z02));
  zero   g25(.O(z12));
endmodule
