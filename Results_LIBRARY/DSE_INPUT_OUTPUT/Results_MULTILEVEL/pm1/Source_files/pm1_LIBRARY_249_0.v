...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n36_, new_n37_, new_n38_,
    new_n39_, new_n41_, new_n43_, new_n44_, new_n47_, new_n48_, new_n49_,
  ...
  nand2  g03(.a(new_n30_), .b(x09), .O(new_n33_));
  ...
  nand3  g28(.a(new_n30_), .b(new_n36_), .c(x09), .O(new_n58_));
  ...
  nand3  g38(.a(new_n62_), .b(x12), .c(x01), .O(new_n68_));
  inv1   g39(.a(x01), .O(new_n69_));
  nand2  g40(.a(new_n30_), .b(new_n69_), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n68_), .O(new_n71_));
  nand4  g42(.a(new_n71_), .b(x11), .c(new_n53_), .d(x09), .O(new_n72_));
  nor2   g43(.a(new_n72_), .b(new_n67_), .O(z11));
  nand4  g44(.a(x11), .b(new_n53_), .c(new_n43_), .d(x00), .O(new_n74_));
