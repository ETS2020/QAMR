...
module FAU ( 
  ...
  oai21  g31(.a(new_n38_), .b(x11), .c(new_n60_), .O(new_n61_));
  ...
  nand3  g40(.a(x13), .b(new_n30_), .c(new_n69_), .O(new_n70_));
  ...
  nand3  g45(.a(x12), .b(x11), .c(new_n54_), .O(new_n75_));
  oai21  g46(.a(new_n75_), .b(new_n74_), .c(new_n53_), .O(z12));
endmodule
