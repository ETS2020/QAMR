...
module FAU ( 
  ...
  nand2  g10(.a(z07), .b(new_n32_), .O(new_n40_));
  ...
  aoi21  g15(.a(x15), .b(new_n32_), .c(x14), .O(z04));
  nand2  g16(.a(x15), .b(new_n32_), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(x13), .O(z05));
  nand3  g18(.a(x04), .b(x03), .c(x02), .O(new_n48_));
  oai21  g19(.a(z07), .b(x12), .c(new_n48_), .O(new_n49_));
  ...
  oai21  g30(.a(new_n40_), .b(x11), .c(new_n59_), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(new_n58_), .c(x00), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z09));
  nand4  g33(.a(new_n48_), .b(x12), .c(x11), .d(new_n58_), .O(new_n63_));
