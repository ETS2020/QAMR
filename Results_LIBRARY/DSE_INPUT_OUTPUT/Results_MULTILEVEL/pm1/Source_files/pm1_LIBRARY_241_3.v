...
module FAU ( 
  ...
  nand4  g13(.a(new_n42_), .b(new_n41_), .c(x09), .d(new_n33_), .O(z03));
  aoi21  g14(.a(x12), .b(x04), .c(x14), .O(z04));
  nand2  g15(.a(x12), .b(x04), .O(new_n45_));
  ...
  nand4  g36(.a(new_n52_), .b(new_n65_), .c(new_n33_), .d(x00), .O(new_n66_));
  nor3   g37(.a(new_n66_), .b(new_n30_), .c(new_n34_), .O(z12));
endmodule
