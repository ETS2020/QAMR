...
module FAU ( 
  ...
  nand2  g14(.a(new_n33_), .b(x03), .O(new_n44_));
  ...
  aoi21  g20(.a(new_n33_), .b(x03), .c(x15), .O(z07));
  ...
  nand2  g27(.a(new_n40_), .b(new_n56_), .O(new_n57_));
  ...
  nand2  g34(.a(new_n63_), .b(new_n44_), .O(z10));
