...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n36_, new_n37_, new_n38_, new_n40_,
    new_n41_, new_n43_, new_n44_, new_n47_, new_n48_, new_n49_, new_n50_,
  ...
  nand2  g13(.a(z07), .b(x12), .O(new_n43_));
  ...
  nand2  g19(.a(new_n40_), .b(new_n31_), .O(new_n49_));
  ...
  nand2  g26(.a(new_n40_), .b(x09), .O(new_n56_));
  oai21  g27(.a(new_n56_), .b(new_n47_), .c(new_n55_), .O(z08));
  ...
  nand4  g35(.a(new_n47_), .b(x15), .c(x12), .d(x09), .O(new_n65_));
