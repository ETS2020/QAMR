...
module FAU ( 
  ...
  nand2  g14(.a(x15), .b(x12), .O(new_n44_));
  ...
  nand4  g37(.a(new_n48_), .b(new_n34_), .c(x12), .d(x09), .O(new_n67_));
  ...
  nor3   g44(.a(new_n73_), .b(x15), .c(new_n32_), .O(z12));
endmodule
