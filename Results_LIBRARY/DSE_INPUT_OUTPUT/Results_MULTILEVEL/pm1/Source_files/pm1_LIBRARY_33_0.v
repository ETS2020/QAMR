...
module FAU ( 
  ...
  wire new_n31_, new_n33_, new_n34_, new_n36_, new_n37_, new_n38_, new_n39_,
    new_n40_, new_n42_, new_n45_, new_n46_, new_n47_, new_n49_, new_n51_,
  ...
  inv1   g18(.a(new_n42_), .O(new_n49_));
  ...
  nand4  g26(.a(new_n46_), .b(x12), .c(x11), .d(new_n51_), .O(new_n57_));
  ...
  nand3  g35(.a(x12), .b(x11), .c(new_n51_), .O(new_n66_));
  oai21  g36(.a(new_n66_), .b(new_n65_), .c(new_n49_), .O(z12));
  one    g37(.O(z00));
endmodule
