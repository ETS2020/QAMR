...
module FAU ( 
  ...
  nand2  g35(.a(new_n64_), .b(new_n57_), .O(z10));
  nand4  g36(.a(x11), .b(new_n52_), .c(new_n30_), .d(x00), .O(new_n66_));
  ...
  nand2  g41(.a(new_n47_), .b(x00), .O(new_n71_));
  nand2  g42(.a(new_n41_), .b(new_n52_), .O(new_n72_));
  oai21  g43(.a(new_n72_), .b(new_n71_), .c(new_n57_), .O(z12));
endmodule
