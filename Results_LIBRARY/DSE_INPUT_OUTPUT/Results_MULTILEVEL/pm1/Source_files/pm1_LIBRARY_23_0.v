...
module FAU ( 
  ...
  nand2  g08(.a(new_n32_), .b(x06), .O(new_n38_));
  ...
  nand2  g27(.a(new_n56_), .b(new_n49_), .O(new_n57_));
  ...
  nand2  g32(.a(new_n61_), .b(new_n49_), .O(z09));
  ...
  nand4  g41(.a(new_n65_), .b(x09), .c(x01), .d(x00), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n70_), .O(z11));
  nand4  g43(.a(x11), .b(new_n55_), .c(new_n43_), .d(x00), .O(new_n73_));
  nor2   g44(.a(new_n73_), .b(new_n32_), .O(z12));
endmodule
