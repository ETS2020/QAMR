...
module FAU ( 
  ...
  nand2  g13(.a(new_n33_), .b(x04), .O(new_n43_));
  nand2  g14(.a(new_n43_), .b(x14), .O(z04));
  nand2  g15(.a(new_n43_), .b(x13), .O(z05));
  inv1   g16(.a(x09), .O(new_n46_));
  nand3  g17(.a(x11), .b(x03), .c(x02), .O(new_n47_));
  aoi21  g18(.a(new_n47_), .b(x12), .c(new_n31_), .O(new_n48_));
  nor3   g19(.a(new_n48_), .b(new_n46_), .c(new_n30_), .O(z06));
  ...
  oai21  g39(.a(new_n68_), .b(new_n67_), .c(new_n31_), .O(new_n69_));
  ...
  nand4  g44(.a(x11), .b(new_n51_), .c(new_n46_), .d(x00), .O(new_n74_));
