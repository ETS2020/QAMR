...
module FAU ( 
  ...
  oai21  g15(.a(x12), .b(new_n31_), .c(x13), .O(z05));
  ...
  nand3  g35(.a(new_n46_), .b(new_n53_), .c(x09), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(x01), .c(x00), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(x12), .c(new_n31_), .O(z11));
  inv1   g39(.a(x09), .O(new_n69_));
  nand4  g40(.a(x11), .b(new_n53_), .c(new_n69_), .d(x00), .O(new_n70_));
  nor2   g41(.a(new_n70_), .b(new_n32_), .O(z12));
endmodule
