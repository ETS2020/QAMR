...
module FAU ( 
  ...
  nand4  g06(.a(x09), .b(x08), .c(x07), .d(x05), .O(new_n36_));
  ...
  nor2   g13(.a(new_n31_), .b(x06), .O(new_n43_));
  ...
  nand3  g27(.a(x12), .b(x09), .c(x06), .O(new_n57_));
  ...
  nand4  g32(.a(new_n50_), .b(x12), .c(x11), .d(new_n54_), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nand4  g34(.a(new_n63_), .b(x09), .c(x06), .d(x00), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(z10));
  inv1   g36(.a(x01), .O(new_n66_));
  nand4  g37(.a(new_n50_), .b(x12), .c(x09), .d(x06), .O(new_n67_));
  nand2  g38(.a(new_n31_), .b(new_n66_), .O(new_n68_));
  ...
  nand4  g43(.a(new_n54_), .b(new_n72_), .c(x06), .d(x00), .O(new_n73_));
  nor3   g44(.a(new_n73_), .b(new_n31_), .c(new_n34_), .O(z12));
endmodule
