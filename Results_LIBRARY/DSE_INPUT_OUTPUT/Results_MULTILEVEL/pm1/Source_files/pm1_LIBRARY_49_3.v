...
module FAU ( 
  ...
  aoi21  g18(.a(x04), .b(x02), .c(x12), .O(new_n48_));
  ...
  nand4  g27(.a(x11), .b(new_n52_), .c(x09), .d(x00), .O(new_n57_));
  aoi21  g28(.a(new_n57_), .b(new_n33_), .c(new_n30_), .O(z10));
  nand4  g29(.a(x12), .b(x09), .c(new_n33_), .d(x01), .O(new_n59_));
  nand2  g30(.a(new_n30_), .b(new_n47_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(x11), .c(new_n52_), .d(x00), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z11));
  inv1   g34(.a(x09), .O(new_n64_));
  nand4  g35(.a(new_n52_), .b(new_n64_), .c(new_n33_), .d(x00), .O(new_n65_));
