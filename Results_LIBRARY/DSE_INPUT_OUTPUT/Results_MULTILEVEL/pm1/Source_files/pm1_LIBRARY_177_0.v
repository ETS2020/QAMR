...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_, new_n38_,
    new_n39_, new_n40_, new_n41_, new_n42_, new_n45_, new_n47_, new_n48_,
    new_n49_, new_n52_, new_n53_, new_n55_, new_n57_, new_n58_, new_n60_,
  ...
  nand2  g12(.a(new_n42_), .b(new_n35_), .O(z03));
  oai21  g13(.a(x12), .b(x11), .c(x14), .O(z04));
  nor2   g14(.a(x12), .b(x11), .O(new_n45_));
  nor2   g15(.a(new_n45_), .b(x13), .O(z05));
  ...
  nor2   g20(.a(new_n45_), .b(x15), .O(z07));
  ...
  nand4  g36(.a(x11), .b(new_n52_), .c(new_n37_), .d(x00), .O(new_n67_));
  nor2   g37(.a(new_n67_), .b(new_n38_), .O(z12));
  one    g38(.O(z00));
  buf    g39(.a(x11), .O(z01));
endmodule
