...
module FAU ( 
  ...
  nand4  g13(.a(new_n42_), .b(new_n41_), .c(x09), .d(x04), .O(z03));
  oai21  g14(.a(new_n32_), .b(x04), .c(x14), .O(z04));
  nor2   g15(.a(new_n32_), .b(x04), .O(new_n45_));
  ...
  oai21  g28(.a(x12), .b(x11), .c(new_n38_), .O(new_n58_));
  ...
  nand4  g34(.a(new_n63_), .b(x09), .c(x04), .d(x00), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(z10));
  nand4  g36(.a(new_n61_), .b(x12), .c(x09), .d(x04), .O(new_n66_));
