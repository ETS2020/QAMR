...
module FAU ( 
  ...
  nand3  g19(.a(x12), .b(new_n34_), .c(x05), .O(new_n49_));
  ...
  nand2  g26(.a(new_n55_), .b(x05), .O(new_n56_));
  ...
  aoi21  g35(.a(new_n64_), .b(x05), .c(new_n31_), .O(z10));
  ...
  nand4  g43(.a(new_n54_), .b(new_n72_), .c(x05), .d(x00), .O(new_n73_));
