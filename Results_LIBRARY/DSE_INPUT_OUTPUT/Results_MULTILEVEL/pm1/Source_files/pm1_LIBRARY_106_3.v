...
module FAU ( 
  ...
  nand4  g31(.a(new_n47_), .b(new_n32_), .c(x12), .d(x11), .O(new_n61_));
  ...
  nor3   g43(.a(new_n72_), .b(x14), .c(new_n30_), .O(z12));
endmodule
