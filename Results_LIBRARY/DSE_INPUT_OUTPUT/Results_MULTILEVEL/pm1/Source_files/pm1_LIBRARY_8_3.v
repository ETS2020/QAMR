...
module FAU ( 
  ...
  oai21  g08(.a(new_n37_), .b(x00), .c(x12), .O(z02));
  ...
  nand3  g19(.a(x12), .b(new_n33_), .c(new_n39_), .O(new_n49_));
  ...
  aoi21  g31(.a(new_n60_), .b(new_n30_), .c(new_n39_), .O(z11));
  inv1   g32(.a(new_n43_), .O(z12));
endmodule
