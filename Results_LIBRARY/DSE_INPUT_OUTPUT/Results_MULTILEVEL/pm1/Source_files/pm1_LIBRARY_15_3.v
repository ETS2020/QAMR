...
module FAU ( 
  ...
  oai21  g19(.a(new_n40_), .b(x11), .c(new_n48_), .O(new_n49_));
  ...
  nand2  g25(.a(new_n54_), .b(new_n39_), .O(new_n55_));
  ...
  aoi21  g35(.a(new_n64_), .b(new_n39_), .c(new_n32_), .O(z10));
  nand4  g36(.a(new_n47_), .b(new_n39_), .c(x12), .d(x09), .O(new_n66_));
  ...
  aoi21  g43(.a(new_n72_), .b(new_n39_), .c(new_n32_), .O(z12));
endmodule
