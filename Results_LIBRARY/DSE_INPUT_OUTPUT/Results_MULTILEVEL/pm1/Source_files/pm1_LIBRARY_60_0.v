...
module FAU ( 
  ...
  nor2   g12(.a(x12), .b(x07), .O(new_n42_));
  ...
  nand3  g28(.a(new_n30_), .b(new_n33_), .c(x07), .O(new_n58_));
  ...
  nand4  g32(.a(new_n46_), .b(x12), .c(x11), .d(new_n57_), .O(new_n62_));
  ...
  nand4  g37(.a(x11), .b(new_n57_), .c(new_n66_), .d(x00), .O(new_n67_));
