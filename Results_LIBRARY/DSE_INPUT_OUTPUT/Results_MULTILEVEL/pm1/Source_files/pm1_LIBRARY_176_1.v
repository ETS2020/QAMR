...
module FAU ( 
  ...
  nand3  g05(.a(x12), .b(new_n34_), .c(x07), .O(z01));
  nand4  g06(.a(x09), .b(x08), .c(x06), .d(x05), .O(new_n36_));
  inv1   g07(.a(new_n36_), .O(new_n37_));
  nand4  g08(.a(new_n37_), .b(x12), .c(x11), .d(x07), .O(z02));
  ...
  nand3  g19(.a(x12), .b(new_n34_), .c(x07), .O(new_n49_));
  ...
  aoi21  g35(.a(new_n64_), .b(x07), .c(new_n31_), .O(z10));
  inv1   g36(.a(x01), .O(new_n66_));
  nand4  g37(.a(new_n47_), .b(x12), .c(x09), .d(x07), .O(new_n67_));
  ...
  aoi21  g44(.a(new_n73_), .b(x07), .c(new_n31_), .O(z12));
endmodule
