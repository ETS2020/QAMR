...
module FAU ( 
  ...
  nand2  g12(.a(new_n41_), .b(z07), .O(new_n42_));
  nand2  g13(.a(new_n42_), .b(x12), .O(z03));
  nor2   g14(.a(z07), .b(new_n30_), .O(new_n44_));
  ...
  nand2  g27(.a(new_n37_), .b(x09), .O(new_n57_));
  oai21  g28(.a(new_n57_), .b(new_n51_), .c(new_n56_), .O(z08));
  ...
  nand4  g33(.a(new_n51_), .b(z07), .c(x12), .d(x11), .O(new_n63_));
  ...
  nand2  g42(.a(new_n71_), .b(new_n45_), .O(z11));
  inv1   g43(.a(x09), .O(new_n73_));
  nand4  g44(.a(x11), .b(new_n54_), .c(new_n73_), .d(x00), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(z07), .c(new_n30_), .O(z12));
endmodule
