...
module FAU ( 
  ...
  nand4  g22(.a(x12), .b(x11), .c(new_n47_), .d(x00), .O(new_n52_));
  inv1   g23(.a(new_n52_), .O(z09));
  inv1   g24(.a(x00), .O(new_n54_));
  nand4  g25(.a(new_n43_), .b(x12), .c(x11), .d(new_n47_), .O(new_n55_));
  nor3   g26(.a(new_n55_), .b(new_n48_), .c(new_n54_), .O(z10));
