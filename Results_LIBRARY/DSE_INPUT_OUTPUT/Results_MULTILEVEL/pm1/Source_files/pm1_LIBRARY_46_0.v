...
module FAU ( 
  ...
  nand2  g04(.a(x14), .b(new_n30_), .O(new_n34_));
  ...
  nor2   g15(.a(x14), .b(x12), .O(new_n45_));
  ...
  nand2  g33(.a(new_n62_), .b(new_n54_), .O(z09));
  nand4  g34(.a(new_n47_), .b(x12), .c(x11), .d(new_n55_), .O(new_n64_));
  inv1   g35(.a(new_n64_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(x09), .c(x00), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n54_), .O(z10));
  nand4  g38(.a(new_n47_), .b(x12), .c(x09), .d(x01), .O(new_n68_));
  inv1   g39(.a(x01), .O(new_n69_));
  nand3  g40(.a(x14), .b(new_n30_), .c(new_n69_), .O(new_n70_));
