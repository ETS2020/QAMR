...
module FAU ( 
  ...
  nand2  g14(.a(x12), .b(x10), .O(new_n44_));
  ...
  aoi21  g23(.a(x12), .b(x10), .c(x15), .O(z07));
  inv1   g24(.a(x00), .O(new_n54_));
  nand2  g25(.a(x03), .b(x02), .O(new_n55_));
  nand3  g26(.a(x12), .b(x09), .c(x04), .O(new_n56_));
  oai21  g27(.a(new_n56_), .b(new_n55_), .c(x11), .O(new_n57_));
  oai21  g28(.a(new_n57_), .b(new_n54_), .c(new_n34_), .O(new_n58_));
  nand2  g29(.a(new_n32_), .b(x10), .O(new_n59_));
  ...
  nand4  g35(.a(new_n50_), .b(x12), .c(x11), .d(new_n34_), .O(new_n65_));
  nor3   g36(.a(new_n65_), .b(new_n64_), .c(new_n54_), .O(z10));
  ...
  nand4  g40(.a(new_n69_), .b(x11), .c(new_n34_), .d(x00), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(z11));
  nand3  g42(.a(x11), .b(new_n64_), .c(x00), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(new_n34_), .c(new_n32_), .O(z12));
endmodule
