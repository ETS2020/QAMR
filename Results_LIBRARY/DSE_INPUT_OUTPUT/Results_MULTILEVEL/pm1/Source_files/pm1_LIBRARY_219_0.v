...
module FAU ( 
  ...
  nor2   g14(.a(x12), .b(x05), .O(new_n44_));
  ...
  oai21  g20(.a(new_n48_), .b(new_n44_), .c(new_n49_), .O(new_n50_));
  ...
  oai22  g29(.a(new_n58_), .b(new_n57_), .c(new_n56_), .d(new_n44_), .O(z08));
  nand3  g30(.a(new_n32_), .b(new_n31_), .c(x05), .O(new_n60_));
  ...
  nand3  g39(.a(new_n32_), .b(x05), .c(new_n30_), .O(new_n69_));
  ...
  nand4  g43(.a(x11), .b(new_n54_), .c(new_n65_), .d(x00), .O(new_n73_));
