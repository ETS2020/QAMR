...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n35_, new_n36_, new_n37_, new_n39_,
    new_n40_, new_n42_, new_n45_, new_n46_, new_n49_, new_n50_, new_n52_,
  ...
  nand2  g23(.a(new_n52_), .b(new_n42_), .O(z09));
  nand3  g24(.a(x04), .b(x03), .c(x02), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(new_n49_), .c(x09), .d(x00), .O(new_n55_));
  aoi21  g26(.a(new_n55_), .b(x12), .c(new_n33_), .O(z10));
  nand4  g27(.a(new_n54_), .b(x12), .c(x11), .d(new_n49_), .O(new_n57_));
  inv1   g28(.a(new_n57_), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(x09), .c(x01), .d(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z11));
  inv1   g31(.a(x09), .O(new_n61_));
  nand4  g32(.a(x11), .b(new_n49_), .c(new_n61_), .d(x00), .O(new_n62_));
  nor2   g33(.a(new_n62_), .b(new_n31_), .O(z12));
endmodule
