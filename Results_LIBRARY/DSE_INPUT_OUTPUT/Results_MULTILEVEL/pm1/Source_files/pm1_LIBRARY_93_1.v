...
module FAU ( 
  ...
  aoi21  g15(.a(x12), .b(new_n31_), .c(x15), .O(z07));
  ...
  nand4  g29(.a(new_n42_), .b(x12), .c(x11), .d(new_n47_), .O(new_n59_));
  nor3   g30(.a(new_n59_), .b(new_n58_), .c(new_n46_), .O(z10));
  nand4  g31(.a(new_n42_), .b(x12), .c(x09), .d(x01), .O(new_n61_));
  nand2  g32(.a(new_n52_), .b(new_n30_), .O(new_n62_));
  ...
  nand4  g36(.a(x11), .b(new_n47_), .c(new_n58_), .d(x00), .O(new_n66_));
  nor2   g37(.a(new_n66_), .b(new_n52_), .O(z12));
endmodule
