...
module FAU ( 
  ...
  nor2   g06(.a(x08), .b(x01), .O(new_n36_));
  ...
  oai21  g12(.a(x08), .b(new_n30_), .c(new_n41_), .O(z02));
  inv1   g13(.a(new_n40_), .O(new_n43_));
  nand4  g14(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n44_));
  oai21  g15(.a(new_n43_), .b(new_n36_), .c(new_n44_), .O(z03));
  nor2   g16(.a(new_n36_), .b(x14), .O(z04));
  ...
  nand4  g26(.a(new_n55_), .b(new_n54_), .c(new_n37_), .d(x00), .O(z08));
  inv1   g27(.a(x10), .O(new_n57_));
  nand2  g28(.a(x12), .b(x11), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n33_), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n37_), .c(new_n57_), .d(x00), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z09));
  nand3  g32(.a(x04), .b(x03), .c(x02), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(x12), .c(x11), .d(new_n57_), .O(new_n63_));
  ...
  nand3  g38(.a(new_n32_), .b(x08), .c(new_n30_), .O(new_n68_));
  ...
  nor2   g44(.a(new_n36_), .b(new_n32_), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(x11), .c(new_n57_), .d(new_n73_), .O(new_n75_));
  nor2   g46(.a(new_n75_), .b(new_n72_), .O(z12));
endmodule
