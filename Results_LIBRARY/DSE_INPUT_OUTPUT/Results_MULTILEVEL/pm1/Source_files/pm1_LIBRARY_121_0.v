...
module FAU ( 
  ...
  nand2  g21(.a(new_n45_), .b(new_n32_), .O(new_n51_));
  nand2  g22(.a(new_n51_), .b(new_n50_), .O(z06));
  nand2  g23(.a(new_n51_), .b(x15), .O(z07));
  nor2   g24(.a(new_n31_), .b(x10), .O(new_n54_));
  nand4  g25(.a(new_n47_), .b(x12), .c(x09), .d(x04), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n54_), .c(new_n51_), .d(x00), .O(z08));
  inv1   g27(.a(x10), .O(new_n57_));
  oai21  g28(.a(new_n34_), .b(x11), .c(new_n35_), .O(new_n58_));
  ...
  nand2  g35(.a(new_n64_), .b(new_n51_), .O(z10));
  nand4  g36(.a(x11), .b(new_n57_), .c(new_n30_), .d(x00), .O(new_n66_));
  ...
  nand4  g42(.a(x11), .b(new_n57_), .c(new_n71_), .d(x00), .O(new_n72_));
