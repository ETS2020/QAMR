...
module FAU ( 
  ...
  aoi21  g10(.a(new_n33_), .b(x14), .c(new_n32_), .O(new_n40_));
  ...
  aoi21  g27(.a(new_n56_), .b(new_n47_), .c(new_n31_), .O(new_n57_));
  aoi22  g28(.a(new_n57_), .b(new_n54_), .c(new_n33_), .d(x14), .O(z08));
