...
module FAU ( 
  ...
  oai21  g16(.a(z04), .b(x12), .c(new_n45_), .O(new_n46_));
  ...
  nand3  g27(.a(z04), .b(new_n30_), .c(new_n33_), .O(new_n57_));
  ...
  nand4  g31(.a(new_n45_), .b(x12), .c(x11), .d(new_n56_), .O(new_n61_));
  ...
  nand3  g37(.a(z04), .b(new_n30_), .c(new_n66_), .O(new_n67_));
  ...
  nand2  g42(.a(new_n39_), .b(new_n56_), .O(new_n72_));
