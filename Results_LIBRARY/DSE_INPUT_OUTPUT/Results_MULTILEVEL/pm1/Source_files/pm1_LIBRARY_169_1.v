...
module FAU ( 
  ...
  oai21  g03(.a(new_n31_), .b(new_n30_), .c(x12), .O(z01));
  inv1   g04(.a(x12), .O(new_n34_));
  nor2   g05(.a(new_n34_), .b(new_n31_), .O(new_n35_));
  nand4  g06(.a(x07), .b(x06), .c(x05), .d(x01), .O(new_n36_));
  inv1   g07(.a(new_n36_), .O(new_n37_));
  nand4  g08(.a(new_n37_), .b(new_n35_), .c(x09), .d(x08), .O(z02));
  ...
  nand3  g30(.a(new_n59_), .b(x11), .c(new_n51_), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(x09), .c(x00), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(x01), .c(new_n34_), .O(z10));
  nand4  g34(.a(new_n59_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  nand2  g35(.a(new_n34_), .b(new_n30_), .O(new_n65_));
  ...
  nand4  g40(.a(new_n51_), .b(new_n69_), .c(x01), .d(x00), .O(new_n70_));
  nor3   g41(.a(new_n70_), .b(new_n34_), .c(new_n31_), .O(z12));
endmodule
