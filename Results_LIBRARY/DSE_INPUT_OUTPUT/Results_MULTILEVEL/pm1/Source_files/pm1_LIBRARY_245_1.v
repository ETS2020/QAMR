...
module FAU ( 
  ...
  nand4  g12(.a(new_n41_), .b(new_n39_), .c(x09), .d(x00), .O(z03));
  ...
  aoi21  g22(.a(x12), .b(new_n30_), .c(x15), .O(z07));
  ...
  oai21  g32(.a(new_n61_), .b(new_n39_), .c(new_n59_), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n43_), .O(z09));
  inv1   g34(.a(x09), .O(new_n64_));
  nand4  g35(.a(new_n49_), .b(x12), .c(x11), .d(new_n59_), .O(new_n65_));
  nor3   g36(.a(new_n65_), .b(new_n64_), .c(new_n30_), .O(z10));
  ...
  nand3  g41(.a(new_n70_), .b(x11), .c(new_n59_), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n43_), .O(z11));
  nand4  g43(.a(x11), .b(new_n59_), .c(new_n64_), .d(x00), .O(new_n73_));
