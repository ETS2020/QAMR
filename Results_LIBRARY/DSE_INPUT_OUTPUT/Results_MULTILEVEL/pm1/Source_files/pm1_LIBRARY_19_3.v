...
module FAU ( 
  ...
  oai21  g06(.a(x13), .b(new_n31_), .c(new_n35_), .O(z01));
  ...
  nand4  g11(.a(new_n40_), .b(z05), .c(x12), .d(x11), .O(z02));
  ...
  aoi21  g16(.a(x13), .b(x11), .c(x14), .O(z04));
  ...
  nand3  g32(.a(new_n61_), .b(x12), .c(new_n53_), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(new_n63_));
  nand3  g34(.a(new_n63_), .b(x09), .c(x00), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(z05), .c(new_n31_), .O(z10));
  ...
  aoi21  g40(.a(new_n69_), .b(z05), .c(new_n31_), .O(z11));
  inv1   g41(.a(x09), .O(new_n71_));
  nand4  g42(.a(x12), .b(new_n53_), .c(new_n71_), .d(x00), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(z05), .c(new_n31_), .O(z12));
endmodule
