...
module FAU ( 
  ...
  nand2  g13(.a(new_n30_), .b(x07), .O(new_n43_));
  ...
  inv1   g25(.a(x07), .O(new_n55_));
  nand3  g26(.a(new_n30_), .b(new_n33_), .c(new_n55_), .O(new_n56_));
  oai21  g27(.a(new_n30_), .b(new_n33_), .c(new_n56_), .O(new_n57_));
  ...
  nand3  g37(.a(new_n30_), .b(new_n55_), .c(new_n66_), .O(new_n67_));
  ...
  oai21  g43(.a(new_n72_), .b(new_n71_), .c(new_n43_), .O(z12));
endmodule
