...
module FAU ( 
  ...
  aoi21  g26(.a(new_n56_), .b(x11), .c(new_n40_), .O(z10));
  nand4  g27(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n58_));
  nand3  g28(.a(new_n40_), .b(x11), .c(new_n30_), .O(new_n59_));
  ...
  nand4  g32(.a(x11), .b(new_n49_), .c(new_n37_), .d(x00), .O(new_n63_));
  nor2   g33(.a(new_n63_), .b(new_n40_), .O(z12));
  one    g34(.O(z01));
endmodule
