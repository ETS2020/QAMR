...
module FAU ( 
  ...
  nand3  g30(.a(new_n32_), .b(new_n31_), .c(x06), .O(new_n60_));
  oai21  g31(.a(new_n32_), .b(new_n31_), .c(new_n60_), .O(new_n61_));
  ...
  nand4  g44(.a(x11), .b(new_n55_), .c(new_n43_), .d(x00), .O(new_n74_));
