...
module FAU ( 
  ...
  nand2  g10(.a(z04), .b(new_n32_), .O(new_n40_));
  ...
  nor2   g15(.a(z04), .b(x12), .O(new_n45_));
  nor2   g16(.a(new_n45_), .b(x13), .O(z05));
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n47_));
  oai21  g18(.a(z04), .b(x12), .c(new_n47_), .O(new_n48_));
  ...
  oai21  g31(.a(new_n40_), .b(x11), .c(new_n60_), .O(new_n61_));
  ...
  nand2  g39(.a(new_n68_), .b(z04), .O(new_n69_));
