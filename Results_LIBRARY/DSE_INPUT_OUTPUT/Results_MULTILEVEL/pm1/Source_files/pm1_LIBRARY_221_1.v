...
module FAU ( 
  ...
  oai21  g21(.a(new_n50_), .b(x15), .c(new_n49_), .O(new_n51_));
  ...
  nand2  g26(.a(x15), .b(x04), .O(z07));
  inv1   g27(.a(new_n31_), .O(new_n57_));
  nor2   g28(.a(new_n32_), .b(x10), .O(new_n58_));
  inv1   g29(.a(x09), .O(new_n59_));
  nor2   g30(.a(new_n33_), .b(new_n59_), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(x04), .c(x03), .d(x02), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(new_n58_), .c(new_n57_), .d(x00), .O(z08));
  inv1   g33(.a(x10), .O(new_n63_));
  nand2  g34(.a(new_n41_), .b(new_n34_), .O(new_n64_));
  nand4  g35(.a(new_n64_), .b(new_n57_), .c(new_n63_), .d(x00), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(z09));
  inv1   g37(.a(x00), .O(new_n67_));
  nand2  g38(.a(x03), .b(x02), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(x04), .O(new_n69_));
  nand2  g40(.a(new_n30_), .b(new_n49_), .O(new_n70_));
  aoi21  g41(.a(new_n70_), .b(new_n69_), .c(new_n33_), .O(new_n71_));
  nand4  g42(.a(new_n71_), .b(x11), .c(new_n63_), .d(x09), .O(new_n72_));
  nor2   g43(.a(new_n72_), .b(new_n67_), .O(z10));
  nand3  g44(.a(x09), .b(x01), .c(x00), .O(new_n74_));
  nand3  g45(.a(x12), .b(x11), .c(new_n63_), .O(new_n75_));
  oai21  g46(.a(new_n75_), .b(new_n74_), .c(new_n30_), .O(new_n76_));
  ...
  nand4  g50(.a(new_n79_), .b(x11), .c(new_n63_), .d(x00), .O(new_n80_));
  nand2  g51(.a(new_n80_), .b(new_n77_), .O(z11));
  nand2  g52(.a(new_n59_), .b(x00), .O(new_n82_));
  oai21  g53(.a(new_n82_), .b(new_n75_), .c(new_n57_), .O(z12));
endmodule
