...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n36_, new_n37_, new_n38_,
    ...
    new_n50_, new_n53_, new_n55_, new_n58_;
  ...
  nand2  g17(.a(new_n46_), .b(new_n43_), .O(new_n47_));
  nand3  g18(.a(x12), .b(new_n31_), .c(new_n34_), .O(new_n48_));
  ...
  nand4  g24(.a(new_n32_), .b(x11), .c(new_n53_), .d(x00), .O(z08));
  nand2  g25(.a(new_n31_), .b(new_n53_), .O(new_n55_));
  aoi21  g26(.a(new_n55_), .b(new_n32_), .c(new_n34_), .O(z09));
  inv1   g27(.a(new_n43_), .O(z10));
  nand3  g28(.a(x11), .b(new_n53_), .c(new_n30_), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(new_n32_), .c(new_n34_), .O(z11));
  inv1   g30(.a(new_n43_), .O(z12));
endmodule
