...
module FAU ( 
  ...
  oai21  g14(.a(x13), .b(x12), .c(x14), .O(z04));
  nor2   g15(.a(x13), .b(new_n30_), .O(z05));
  ...
  aoi21  g22(.a(new_n49_), .b(new_n30_), .c(x15), .O(z07));
  ...
  nand2  g34(.a(new_n63_), .b(new_n50_), .O(z10));
  nand4  g35(.a(new_n60_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
