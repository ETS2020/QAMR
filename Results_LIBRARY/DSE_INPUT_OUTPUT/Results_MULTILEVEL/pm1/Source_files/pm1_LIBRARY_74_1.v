...
module FAU ( 
  ...
  nor2   g14(.a(new_n31_), .b(x02), .O(new_n44_));
  ...
  oai21  g21(.a(new_n47_), .b(x02), .c(new_n50_), .O(z06));
  ...
  nand3  g29(.a(x12), .b(x11), .c(x02), .O(new_n59_));
  ...
  nand4  g36(.a(new_n65_), .b(x09), .c(x02), .d(x00), .O(new_n66_));
  ...
  nand2  g43(.a(new_n72_), .b(new_n52_), .O(z11));
  inv1   g44(.a(x09), .O(new_n74_));
  nand4  g45(.a(x11), .b(new_n54_), .c(new_n74_), .d(x00), .O(new_n75_));
  aoi21  g46(.a(new_n75_), .b(x02), .c(new_n31_), .O(z12));
endmodule
