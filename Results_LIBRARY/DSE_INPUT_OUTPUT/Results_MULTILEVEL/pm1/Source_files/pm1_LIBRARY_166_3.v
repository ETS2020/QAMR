...
module FAU ( 
  ...
  aoi22  g23(.a(new_n52_), .b(x00), .c(x12), .d(x04), .O(z08));
  inv1   g24(.a(x10), .O(new_n54_));
  nand3  g25(.a(x12), .b(x11), .c(new_n40_), .O(new_n55_));
  ...
  aoi21  g31(.a(new_n60_), .b(new_n40_), .c(new_n32_), .O(z10));
  ...
  aoi21  g38(.a(new_n67_), .b(new_n40_), .c(new_n32_), .O(z12));
endmodule
