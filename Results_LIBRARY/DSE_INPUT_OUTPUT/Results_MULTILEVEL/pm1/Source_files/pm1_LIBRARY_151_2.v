...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n34_, new_n36_, new_n37_, new_n38_, new_n42_,
  ...
  nand4  g28(.a(new_n43_), .b(x14), .c(x12), .d(x11), .O(new_n58_));
  ...
  nand2  g37(.a(new_n66_), .b(new_n42_), .O(z11));
  inv1   g38(.a(x09), .O(new_n68_));
  nand4  g39(.a(x11), .b(new_n50_), .c(new_n68_), .d(x00), .O(new_n69_));
  nor3   g40(.a(new_n69_), .b(z04), .c(new_n30_), .O(z12));
endmodule
