...
module FAU ( 
  ...
  nand3  g12(.a(new_n38_), .b(x08), .c(x07), .O(new_n42_));
  ...
  nand4  g19(.a(x11), .b(x04), .c(x03), .d(x02), .O(new_n49_));
  ...
  nand3  g24(.a(x09), .b(x04), .c(x02), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(x12), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(x03), .O(new_n56_));
  ...
  nand4  g44(.a(new_n73_), .b(x11), .c(new_n53_), .d(x00), .O(new_n74_));
  inv1   g45(.a(new_n74_), .O(z11));
  nand2  g46(.a(new_n63_), .b(x00), .O(new_n76_));
  nand3  g47(.a(x12), .b(x11), .c(new_n53_), .O(new_n77_));
