...
module FAU ( 
  ...
  nor2   g14(.a(new_n32_), .b(x08), .O(new_n44_));
  ...
  oai21  g23(.a(new_n32_), .b(x08), .c(x15), .O(z07));
  ...
  nand4  g42(.a(new_n54_), .b(new_n71_), .c(x08), .d(x00), .O(new_n72_));
