...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n33_, new_n34_, new_n35_, new_n36_, new_n37_,
    new_n39_, new_n40_, new_n41_, new_n43_, new_n45_, new_n47_, new_n49_,
  ...
  nor3   g11(.a(new_n40_), .b(new_n39_), .c(new_n35_), .O(new_n41_));
  oai21  g12(.a(new_n41_), .b(new_n30_), .c(new_n34_), .O(z02));
  nand4  g13(.a(x08), .b(x07), .c(x06), .d(x05), .O(new_n43_));
  nand3  g14(.a(new_n43_), .b(new_n36_), .c(x09), .O(z03));
  ...
  nand3  g29(.a(new_n30_), .b(new_n35_), .c(new_n33_), .O(new_n59_));
  ...
  nand2  g47(.a(new_n64_), .b(x00), .O(new_n77_));
  nand2  g48(.a(new_n36_), .b(new_n54_), .O(new_n78_));
