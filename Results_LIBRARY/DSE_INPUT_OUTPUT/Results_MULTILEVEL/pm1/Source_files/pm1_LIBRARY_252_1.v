...
module FAU ( 
  ...
  aoi21  g10(.a(new_n38_), .b(x05), .c(new_n34_), .O(new_n40_));
  ...
  nand3  g25(.a(x12), .b(x09), .c(x06), .O(new_n55_));
  oai22  g26(.a(new_n55_), .b(new_n48_), .c(new_n54_), .d(new_n42_), .O(z08));
  nand3  g27(.a(x12), .b(x11), .c(x06), .O(new_n57_));
  oai21  g28(.a(x12), .b(x11), .c(new_n57_), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(new_n52_), .c(x00), .O(new_n59_));
  inv1   g30(.a(new_n59_), .O(z09));
  nand4  g31(.a(new_n48_), .b(x12), .c(x11), .d(new_n52_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(new_n62_));
  nand4  g33(.a(new_n62_), .b(x09), .c(x06), .d(x00), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(z10));
  nand4  g35(.a(new_n48_), .b(x12), .c(x09), .d(x06), .O(new_n65_));
  nand2  g36(.a(new_n32_), .b(new_n30_), .O(new_n66_));
  oai21  g37(.a(new_n65_), .b(new_n30_), .c(new_n66_), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x11), .c(new_n52_), .d(x00), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z11));
  inv1   g40(.a(x09), .O(new_n70_));
  nand4  g41(.a(x11), .b(new_n52_), .c(new_n70_), .d(x00), .O(new_n71_));
  aoi21  g42(.a(new_n71_), .b(x06), .c(new_n32_), .O(z12));
endmodule
