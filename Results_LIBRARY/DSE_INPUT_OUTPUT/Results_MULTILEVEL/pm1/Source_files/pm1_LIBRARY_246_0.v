...
module FAU ( 
  ...
  nand4  g23(.a(new_n41_), .b(x12), .c(x11), .d(new_n51_), .O(new_n54_));
  inv1   g24(.a(new_n54_), .O(new_n55_));
  nand3  g25(.a(new_n55_), .b(x09), .c(x00), .O(new_n56_));
  nand2  g26(.a(new_n56_), .b(new_n37_), .O(z10));
  inv1   g27(.a(x01), .O(new_n58_));
  nand3  g28(.a(new_n51_), .b(new_n58_), .c(x00), .O(new_n59_));
  nand2  g29(.a(new_n59_), .b(x11), .O(new_n60_));
  nand2  g30(.a(new_n60_), .b(new_n39_), .O(new_n61_));
  ...
  nor2   g35(.a(new_n65_), .b(new_n39_), .O(z12));
  one    g36(.O(z00));
  buf    g37(.a(x11), .O(z01));
endmodule
