...
module FAU ( 
  ...
  aoi21  g17(.a(x03), .b(x02), .c(x12), .O(new_n47_));
  ...
  aoi21  g22(.a(new_n51_), .b(x00), .c(new_n44_), .O(z08));
  inv1   g23(.a(new_n44_), .O(new_n53_));
  inv1   g24(.a(x10), .O(new_n54_));
  xnor2a g25(.a(x12), .b(x11), .O(new_n55_));
  nand3  g26(.a(new_n55_), .b(new_n54_), .c(x00), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n53_), .O(z09));
  nand4  g28(.a(new_n54_), .b(x09), .c(new_n34_), .d(x00), .O(new_n58_));
  nor3   g29(.a(new_n58_), .b(new_n32_), .c(new_n31_), .O(z10));
  ...
  nand2  g33(.a(new_n62_), .b(new_n53_), .O(z11));
