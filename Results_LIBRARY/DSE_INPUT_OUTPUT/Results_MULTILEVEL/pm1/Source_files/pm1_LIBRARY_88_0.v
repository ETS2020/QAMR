...
module FAU ( 
  ...
  nand2  g08(.a(new_n32_), .b(x09), .O(new_n38_));
  ...
  nor2   g12(.a(x12), .b(x09), .O(new_n42_));
  ...
  nand4  g30(.a(new_n59_), .b(x12), .c(x11), .d(new_n51_), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(x09), .c(x00), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n43_), .O(z10));
  inv1   g34(.a(x00), .O(new_n64_));
  nand3  g35(.a(new_n59_), .b(x12), .c(x01), .O(new_n65_));
  ...
  nor2   g39(.a(new_n68_), .b(new_n64_), .O(z11));
