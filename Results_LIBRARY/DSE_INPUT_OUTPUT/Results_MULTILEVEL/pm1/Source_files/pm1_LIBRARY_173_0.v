...
module FAU ( 
  ...
  nor2   g13(.a(x15), .b(x12), .O(new_n43_));
  ...
  nand4  g35(.a(new_n46_), .b(x12), .c(x11), .d(new_n54_), .O(new_n65_));
  ...
  nand2  g42(.a(new_n64_), .b(x00), .O(new_n72_));
  nand2  g43(.a(new_n40_), .b(new_n54_), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n72_), .c(new_n53_), .O(z12));
endmodule
