...
module FAU ( 
  ...
  nand4  g033(.a(new_n84_), .b(new_n83_), .c(new_n69_), .d(new_n52_), .O(new_n85_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n69_), .O(new_n94_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n76_), .c(new_n83_), .d(new_n52_), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(x25), .O(new_n103_));
  nor2   g052(.a(x21), .b(x20), .O(new_n104_));
  nor2   g053(.a(x25), .b(x24), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n84_), .c(new_n104_), .d(new_n55_), .O(new_n106_));
  aoi21  g055(.a(new_n106_), .b(new_n103_), .c(new_n58_), .O(new_n107_));
  nor2   g056(.a(x16), .b(x09), .O(new_n108_));
  oai21  g057(.a(new_n108_), .b(new_n107_), .c(new_n100_), .O(new_n109_));
  nand2  g058(.a(x18), .b(new_n97_), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(new_n109_), .O(z06));
  inv1   g060(.a(x26), .O(new_n112_));
  inv1   g061(.a(x25), .O(new_n113_));
  nand4  g062(.a(new_n113_), .b(new_n93_), .c(new_n92_), .d(new_n91_), .O(new_n114_));
  nor2   g063(.a(new_n114_), .b(new_n70_), .O(new_n115_));
  nor2   g064(.a(x18), .b(x17), .O(new_n116_));
  nand2  g065(.a(new_n92_), .b(new_n91_), .O(new_n117_));
  ...
  nand4  g069(.a(new_n120_), .b(new_n116_), .c(new_n104_), .d(new_n53_), .O(new_n121_));
  oai21  g070(.a(new_n115_), .b(new_n112_), .c(new_n121_), .O(new_n122_));
  ...
  nand2  g075(.a(new_n120_), .b(new_n71_), .O(new_n127_));
  ...
  nand4  g085(.a(new_n136_), .b(new_n105_), .c(new_n112_), .d(new_n92_), .O(new_n137_));
  oai22  g086(.a(new_n137_), .b(new_n77_), .c(new_n130_), .d(new_n135_), .O(new_n138_));
  ...
  oai21  g091(.a(new_n137_), .b(new_n77_), .c(x29), .O(new_n143_));
  inv1   g092(.a(new_n119_), .O(new_n144_));
  nor3   g093(.a(x29), .b(x28), .c(x27), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n144_), .c(new_n86_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n143_), .c(new_n58_), .O(new_n147_));
  nor2   g096(.a(x16), .b(x05), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n147_), .c(new_n100_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(new_n110_), .O(z10));
  nor2   g099(.a(x30), .b(x29), .O(new_n151_));
  nand4  g100(.a(new_n151_), .b(new_n136_), .c(new_n118_), .d(new_n93_), .O(new_n152_));
  ...
  oai21  g106(.a(new_n152_), .b(new_n85_), .c(x31), .O(new_n158_));
  nor2   g107(.a(x29), .b(x28), .O(new_n159_));
  nor2   g108(.a(x31), .b(x30), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  inv1   g110(.a(new_n161_), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n128_), .c(new_n95_), .O(new_n163_));
  aoi21  g112(.a(new_n163_), .b(new_n158_), .c(new_n58_), .O(new_n164_));
  nor2   g113(.a(x16), .b(x03), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n164_), .c(new_n100_), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(new_n110_), .O(z12));
  nor2   g116(.a(x27), .b(x26), .O(new_n168_));
  nand4  g117(.a(new_n160_), .b(new_n159_), .c(new_n168_), .d(new_n113_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n102_), .c(x32), .O(new_n170_));
  nor2   g119(.a(x32), .b(x31), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n151_), .c(new_n136_), .d(new_n118_), .O(new_n172_));
  ...
  oai21  g125(.a(new_n176_), .b(new_n175_), .c(new_n100_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n110_), .O(z13));
  oai21  g127(.a(new_n172_), .b(new_n102_), .c(x33), .O(new_n179_));
  nor2   g128(.a(x33), .b(x32), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n160_), .c(new_n159_), .d(new_n168_), .O(new_n181_));
  ...
  oai21  g134(.a(new_n185_), .b(new_n184_), .c(new_n100_), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(new_n110_), .O(z14));
  oai21  g136(.a(new_n181_), .b(new_n106_), .c(x34), .O(new_n188_));
  nand2  g137(.a(new_n159_), .b(new_n168_), .O(new_n189_));
  ...
  nand3  g147(.a(new_n198_), .b(new_n190_), .c(new_n115_), .O(new_n199_));
  aoi21  g148(.a(new_n199_), .b(new_n188_), .c(new_n58_), .O(new_n200_));
  nor2   g149(.a(x16), .b(x00), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n200_), .c(new_n100_), .O(new_n202_));
  nand2  g151(.a(new_n202_), .b(new_n110_), .O(z15));
endmodule
