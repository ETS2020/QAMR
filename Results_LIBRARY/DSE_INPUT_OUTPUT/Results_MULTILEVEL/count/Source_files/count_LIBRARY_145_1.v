...
module FAU ( 
  ...
  aoi21  g030(.a(new_n76_), .b(new_n81_), .c(x18), .O(new_n82_));
  oai21  g031(.a(new_n80_), .b(new_n76_), .c(new_n82_), .O(z03));
  ...
  aoi21  g038(.a(new_n76_), .b(new_n89_), .c(x18), .O(new_n90_));
  oai21  g039(.a(new_n88_), .b(new_n76_), .c(new_n90_), .O(z04));
  nor2   g040(.a(x23), .b(x22), .O(new_n92_));
  nand4  g041(.a(new_n92_), .b(new_n70_), .c(new_n69_), .d(new_n63_), .O(new_n93_));
  nor2   g042(.a(x24), .b(x23), .O(new_n94_));
  nand4  g043(.a(new_n94_), .b(new_n78_), .c(new_n70_), .d(new_n63_), .O(new_n95_));
  inv1   g044(.a(new_n95_), .O(new_n96_));
  aoi21  g045(.a(new_n93_), .b(x24), .c(new_n96_), .O(new_n97_));
  inv1   g046(.a(x10), .O(new_n98_));
  aoi21  g047(.a(new_n76_), .b(new_n98_), .c(x18), .O(new_n99_));
  oai21  g048(.a(new_n97_), .b(new_n76_), .c(new_n99_), .O(z05));
  nor2   g049(.a(x21), .b(x20), .O(new_n101_));
  nor2   g050(.a(x25), .b(x24), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n92_), .c(new_n101_), .d(new_n54_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(new_n52_), .O(new_n104_));
  aoi21  g053(.a(new_n95_), .b(x25), .c(new_n104_), .O(new_n105_));
  oai22  g054(.a(new_n105_), .b(new_n76_), .c(new_n59_), .d(x09), .O(z06));
  nand2  g055(.a(new_n103_), .b(x26), .O(new_n107_));
  nor3   g056(.a(x26), .b(x25), .c(x24), .O(new_n108_));
  nand4  g057(.a(new_n108_), .b(new_n92_), .c(new_n101_), .d(new_n54_), .O(new_n109_));
  nand3  g058(.a(new_n109_), .b(new_n107_), .c(new_n52_), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(x16), .O(new_n111_));
  oai21  g060(.a(new_n59_), .b(x08), .c(new_n111_), .O(z07));
  ...
  oai21  g068(.a(new_n117_), .b(new_n76_), .c(new_n119_), .O(z08));
  oai21  g069(.a(new_n115_), .b(new_n79_), .c(x28), .O(new_n121_));
  inv1   g070(.a(x26), .O(new_n122_));
  nor2   g071(.a(x28), .b(x27), .O(new_n123_));
  nand4  g072(.a(new_n123_), .b(new_n102_), .c(new_n122_), .d(new_n85_), .O(new_n124_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n108_), .c(new_n87_), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n130_), .c(new_n52_), .O(new_n133_));
  ...
  nand4  g089(.a(new_n140_), .b(new_n123_), .c(new_n139_), .d(new_n138_), .O(new_n141_));
  nor2   g090(.a(new_n141_), .b(new_n93_), .O(new_n142_));
  aoi21  g091(.a(new_n132_), .b(x30), .c(new_n142_), .O(new_n143_));
  inv1   g092(.a(x04), .O(new_n144_));
  aoi21  g093(.a(new_n76_), .b(new_n144_), .c(x18), .O(new_n145_));
  oai21  g094(.a(new_n143_), .b(new_n76_), .c(new_n145_), .O(z11));
  nand2  g095(.a(new_n140_), .b(new_n123_), .O(new_n147_));
  inv1   g096(.a(new_n147_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n108_), .c(new_n87_), .O(new_n149_));
  ...
  oai21  g101(.a(new_n152_), .b(new_n95_), .c(new_n52_), .O(new_n153_));
  aoi21  g102(.a(new_n149_), .b(x31), .c(new_n153_), .O(new_n154_));
  inv1   g103(.a(x03), .O(new_n155_));
  nand2  g104(.a(new_n58_), .b(new_n155_), .O(new_n156_));
  oai21  g105(.a(new_n154_), .b(new_n76_), .c(new_n156_), .O(z12));
  oai21  g106(.a(new_n152_), .b(new_n95_), .c(x32), .O(new_n158_));
  nor2   g107(.a(x32), .b(x31), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n140_), .c(new_n123_), .d(new_n139_), .O(new_n160_));
  ...
  aoi21  g117(.a(new_n161_), .b(new_n96_), .c(new_n168_), .O(new_n169_));
  nor2   g118(.a(x33), .b(x32), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n151_), .c(new_n150_), .d(new_n114_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(new_n103_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n169_), .c(x16), .O(new_n173_));
  inv1   g122(.a(x01), .O(new_n174_));
  aoi21  g123(.a(new_n76_), .b(new_n174_), .c(x18), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(new_n173_), .O(z14));
  oai21  g125(.a(new_n171_), .b(new_n103_), .c(x34), .O(new_n177_));
  nand4  g126(.a(new_n113_), .b(new_n138_), .c(new_n85_), .d(new_n84_), .O(new_n178_));
  nor2   g127(.a(new_n178_), .b(new_n72_), .O(new_n179_));
  nand2  g128(.a(new_n150_), .b(new_n114_), .O(new_n180_));
  ...
  nand3  g135(.a(new_n186_), .b(new_n168_), .c(new_n185_), .O(new_n187_));
  nor2   g136(.a(new_n187_), .b(new_n184_), .O(new_n188_));
  nand3  g137(.a(new_n188_), .b(new_n181_), .c(new_n179_), .O(new_n189_));
  nand3  g138(.a(new_n189_), .b(new_n177_), .c(new_n52_), .O(new_n190_));
