...
module FAU ( 
  ...
  oai21  g018(.a(new_n69_), .b(new_n57_), .c(new_n52_), .O(z02));
  nor3   g019(.a(x22), .b(x21), .c(x20), .O(new_n71_));
  aoi22  g020(.a(new_n71_), .b(new_n53_), .c(new_n67_), .d(x22), .O(new_n72_));
  oai21  g021(.a(new_n72_), .b(new_n57_), .c(new_n52_), .O(z03));
  nor2   g022(.a(x22), .b(x21), .O(new_n74_));
  nand3  g023(.a(new_n74_), .b(new_n53_), .c(new_n65_), .O(new_n75_));
  nand2  g024(.a(new_n75_), .b(x23), .O(new_n76_));
  nor2   g025(.a(x23), .b(x22), .O(new_n77_));
  nand3  g026(.a(new_n77_), .b(new_n58_), .c(new_n66_), .O(new_n78_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n77_), .c(new_n92_), .d(new_n53_), .O(new_n94_));
  nand2  g043(.a(new_n94_), .b(x26), .O(new_n95_));
  nor3   g044(.a(x26), .b(x25), .c(x24), .O(new_n96_));
  nand3  g045(.a(new_n96_), .b(new_n77_), .c(new_n68_), .O(new_n97_));
  ...
  nand3  g050(.a(new_n101_), .b(new_n81_), .c(new_n87_), .O(new_n102_));
  nor2   g051(.a(new_n102_), .b(new_n75_), .O(new_n103_));
  aoi21  g052(.a(new_n97_), .b(x27), .c(new_n103_), .O(new_n104_));
  oai21  g053(.a(new_n104_), .b(new_n57_), .c(new_n52_), .O(z08));
  ...
  oai21  g058(.a(new_n103_), .b(new_n106_), .c(new_n109_), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(x16), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(new_n52_), .O(z09));
  nand2  g061(.a(new_n109_), .b(x29), .O(new_n113_));
  inv1   g062(.a(x27), .O(new_n114_));
  nor2   g063(.a(x29), .b(x28), .O(new_n115_));
  nand3  g064(.a(new_n115_), .b(new_n96_), .c(new_n114_), .O(new_n116_));
  or2    g065(.a(new_n116_), .b(new_n78_), .O(new_n117_));
  nand4  g066(.a(new_n117_), .b(new_n113_), .c(new_n52_), .d(x16), .O(z10));
  oai21  g067(.a(new_n116_), .b(new_n78_), .c(x30), .O(new_n119_));
  nor2   g068(.a(x28), .b(x27), .O(new_n120_));
  nor2   g069(.a(x30), .b(x29), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n120_), .c(new_n96_), .O(new_n122_));
  or2    g071(.a(new_n122_), .b(new_n78_), .O(new_n123_));
  nand4  g072(.a(new_n123_), .b(new_n119_), .c(new_n52_), .d(x16), .O(z11));
  oai21  g073(.a(new_n122_), .b(new_n78_), .c(x31), .O(new_n125_));
  inv1   g074(.a(new_n82_), .O(new_n126_));
  nor3   g075(.a(x27), .b(x26), .c(x25), .O(new_n127_));
  nor2   g076(.a(x31), .b(x30), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n115_), .c(new_n127_), .d(new_n126_), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n125_), .c(new_n52_), .d(x16), .O(z12));
  nand2  g079(.a(new_n129_), .b(x32), .O(new_n131_));
  nor2   g080(.a(x26), .b(x25), .O(new_n132_));
  nor2   g081(.a(x32), .b(x31), .O(new_n133_));
  nand4  g082(.a(new_n133_), .b(new_n121_), .c(new_n120_), .d(new_n132_), .O(new_n134_));
  or2    g083(.a(new_n134_), .b(new_n82_), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n131_), .c(new_n52_), .d(x16), .O(z13));
  oai21  g085(.a(new_n134_), .b(new_n82_), .c(x33), .O(new_n137_));
  nor2   g086(.a(x33), .b(x32), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n128_), .c(new_n115_), .d(new_n101_), .O(new_n139_));
  ...
  nand2  g092(.a(new_n143_), .b(new_n52_), .O(z14));
  oai21  g093(.a(new_n139_), .b(new_n94_), .c(x34), .O(new_n145_));
  nand2  g094(.a(new_n115_), .b(new_n101_), .O(new_n146_));
  ...
  nand3  g104(.a(new_n155_), .b(new_n147_), .c(new_n89_), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n145_), .O(new_n157_));
