...
module FAU ( 
  ...
  aoi21  g029(.a(x23), .b(x16), .c(x18), .O(new_n81_));
  ...
  oai21  g039(.a(new_n90_), .b(new_n89_), .c(new_n82_), .O(new_n91_));
  oai21  g040(.a(new_n81_), .b(new_n53_), .c(new_n91_), .O(z04));
  nand2  g041(.a(x24), .b(x16), .O(new_n93_));
  nand2  g042(.a(new_n93_), .b(new_n82_), .O(new_n94_));
  nand2  g043(.a(new_n94_), .b(x19), .O(new_n95_));
  inv1   g044(.a(x21), .O(new_n96_));
  nor2   g045(.a(x23), .b(x22), .O(new_n97_));
  nand3  g046(.a(new_n97_), .b(new_n84_), .c(new_n96_), .O(new_n98_));
  nand2  g047(.a(new_n98_), .b(x24), .O(new_n99_));
  nor2   g048(.a(x24), .b(x23), .O(new_n100_));
  nand3  g049(.a(new_n100_), .b(new_n83_), .c(new_n62_), .O(new_n101_));
  aoi21  g050(.a(new_n101_), .b(new_n99_), .c(new_n58_), .O(new_n102_));
  nor2   g051(.a(x16), .b(x10), .O(new_n103_));
  oai21  g052(.a(new_n103_), .b(new_n102_), .c(new_n82_), .O(new_n104_));
  nand2  g053(.a(new_n104_), .b(new_n95_), .O(z05));
  nand2  g054(.a(x25), .b(x16), .O(new_n106_));
  nand2  g055(.a(new_n106_), .b(new_n82_), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(x19), .O(new_n108_));
  nand2  g057(.a(new_n69_), .b(new_n52_), .O(new_n109_));
  inv1   g058(.a(x22), .O(new_n110_));
  nand2  g059(.a(new_n100_), .b(new_n110_), .O(new_n111_));
  oai21  g060(.a(new_n111_), .b(new_n109_), .c(x25), .O(new_n112_));
  nor2   g061(.a(x25), .b(x24), .O(new_n113_));
  nand4  g062(.a(new_n113_), .b(new_n97_), .c(new_n69_), .d(new_n55_), .O(new_n114_));
  aoi21  g063(.a(new_n114_), .b(new_n112_), .c(new_n58_), .O(new_n115_));
  nor2   g064(.a(x16), .b(x09), .O(new_n116_));
  oai21  g065(.a(new_n116_), .b(new_n115_), .c(new_n82_), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n108_), .O(z06));
  inv1   g067(.a(x26), .O(new_n119_));
  inv1   g068(.a(new_n114_), .O(new_n120_));
  nand4  g069(.a(new_n69_), .b(new_n53_), .c(new_n82_), .d(new_n52_), .O(new_n121_));
  nor3   g070(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n97_), .O(new_n123_));
  oai22  g072(.a(new_n123_), .b(new_n121_), .c(new_n120_), .d(new_n119_), .O(new_n124_));
  ...
  nand3  g077(.a(new_n122_), .b(new_n97_), .c(new_n71_), .O(new_n129_));
  nand2  g078(.a(new_n76_), .b(new_n55_), .O(new_n130_));
  ...
  oai21  g086(.a(new_n132_), .b(new_n130_), .c(x28), .O(new_n138_));
  nor3   g087(.a(x25), .b(x24), .c(x23), .O(new_n139_));
  nor3   g088(.a(x28), .b(x27), .c(x26), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n139_), .c(new_n76_), .d(new_n55_), .O(new_n141_));
  ...
  nand2  g095(.a(x29), .b(x16), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(new_n82_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(x19), .O(new_n149_));
  nor2   g098(.a(x28), .b(x27), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n113_), .c(new_n119_), .O(new_n151_));
  oai21  g100(.a(new_n151_), .b(new_n98_), .c(x29), .O(new_n152_));
  nor3   g101(.a(x29), .b(x28), .c(x27), .O(new_n153_));
  nand4  g102(.a(new_n153_), .b(new_n122_), .c(new_n87_), .d(new_n62_), .O(new_n154_));
  aoi21  g103(.a(new_n154_), .b(new_n152_), .c(new_n58_), .O(new_n155_));
  nor2   g104(.a(x16), .b(x05), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n155_), .c(new_n82_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n149_), .O(z10));
  nor2   g107(.a(x30), .b(x29), .O(new_n159_));
  nand3  g108(.a(new_n159_), .b(new_n150_), .c(new_n122_), .O(new_n160_));
  ...
  oai21  g114(.a(new_n160_), .b(new_n88_), .c(x31), .O(new_n166_));
  nand2  g115(.a(new_n100_), .b(new_n83_), .O(new_n167_));
  nor2   g116(.a(new_n167_), .b(new_n68_), .O(new_n168_));
  nor2   g117(.a(x29), .b(x28), .O(new_n169_));
  nor2   g118(.a(x31), .b(x30), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n169_), .c(new_n131_), .d(new_n168_), .O(new_n171_));
  ...
  nand3  g125(.a(new_n170_), .b(new_n169_), .c(new_n131_), .O(new_n177_));
  ...
  nand4  g131(.a(new_n182_), .b(new_n150_), .c(new_n179_), .d(new_n168_), .O(new_n183_));
  ...
  nand4  g137(.a(new_n180_), .b(new_n159_), .c(new_n150_), .d(new_n179_), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(new_n101_), .c(x33), .O(new_n190_));
  nor2   g139(.a(x27), .b(x26), .O(new_n191_));
  nor2   g140(.a(x33), .b(x32), .O(new_n192_));
  nand4  g141(.a(new_n192_), .b(new_n170_), .c(new_n169_), .d(new_n191_), .O(new_n193_));
  or2    g142(.a(new_n193_), .b(new_n114_), .O(new_n194_));
  ...
  oai21  g148(.a(new_n193_), .b(new_n114_), .c(x34), .O(new_n200_));
  nand2  g149(.a(new_n169_), .b(new_n191_), .O(new_n201_));
  inv1   g150(.a(new_n201_), .O(new_n202_));
  nor3   g151(.a(x34), .b(x33), .c(x32), .O(new_n203_));
  nand3  g152(.a(new_n203_), .b(new_n202_), .c(new_n170_), .O(new_n204_));
  oai21  g153(.a(new_n204_), .b(new_n114_), .c(new_n200_), .O(new_n205_));
