...
module FAU ( 
  ...
  oai21  g004(.a(new_n55_), .b(x03), .c(new_n52_), .O(z00));
  ...
  oai21  g023(.a(new_n74_), .b(x03), .c(new_n52_), .O(z02));
  ...
  aoi21  g027(.a(new_n78_), .b(new_n76_), .c(new_n67_), .O(new_n79_));
  nor2   g028(.a(x16), .b(x12), .O(new_n80_));
  oai21  g029(.a(new_n80_), .b(new_n79_), .c(new_n57_), .O(new_n81_));
  ...
  nand4  g041(.a(new_n92_), .b(new_n77_), .c(new_n84_), .d(new_n61_), .O(new_n93_));
  aoi21  g042(.a(new_n93_), .b(new_n91_), .c(new_n67_), .O(new_n94_));
  nor2   g043(.a(x16), .b(x10), .O(new_n95_));
  oai21  g044(.a(new_n95_), .b(new_n94_), .c(new_n57_), .O(new_n96_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n70_), .O(new_n102_));
  ...
  oai21  g055(.a(new_n103_), .b(new_n98_), .c(new_n106_), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(x16), .O(new_n108_));
  inv1   g057(.a(x09), .O(new_n109_));
  aoi21  g058(.a(new_n67_), .b(new_n109_), .c(x18), .O(new_n110_));
  nand3  g059(.a(new_n110_), .b(new_n108_), .c(new_n57_), .O(z06));
  inv1   g060(.a(x26), .O(new_n112_));
  nand4  g061(.a(new_n98_), .b(new_n101_), .c(new_n100_), .d(new_n99_), .O(new_n113_));
  ...
  nand3  g071(.a(new_n122_), .b(new_n92_), .c(new_n98_), .O(new_n123_));
  ...
  nor3   g075(.a(new_n126_), .b(x18), .c(x03), .O(new_n127_));
  oai21  g076(.a(new_n125_), .b(new_n67_), .c(new_n127_), .O(z08));
  inv1   g077(.a(x28), .O(new_n129_));
  nor2   g078(.a(x28), .b(x27), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n105_), .c(new_n112_), .d(new_n100_), .O(new_n131_));
  ...
  nor3   g083(.a(new_n134_), .b(x18), .c(x03), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n133_), .O(z09));
  oai21  g085(.a(new_n131_), .b(new_n78_), .c(x29), .O(new_n137_));
  inv1   g086(.a(x27), .O(new_n138_));
  nand3  g087(.a(new_n100_), .b(new_n99_), .c(new_n70_), .O(new_n139_));
  nor2   g088(.a(new_n139_), .b(new_n63_), .O(new_n140_));
  nor2   g089(.a(x29), .b(x28), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n115_), .c(new_n140_), .d(new_n138_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n137_), .c(new_n67_), .O(new_n143_));
  nor2   g092(.a(x16), .b(x05), .O(new_n144_));
  oai21  g093(.a(new_n144_), .b(new_n143_), .c(new_n57_), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n52_), .O(z10));
  nor2   g095(.a(x26), .b(x25), .O(new_n147_));
  nand4  g096(.a(new_n141_), .b(new_n147_), .c(new_n138_), .d(new_n101_), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n86_), .c(x30), .O(new_n149_));
  nor2   g098(.a(x30), .b(x29), .O(new_n150_));
  nand4  g099(.a(new_n150_), .b(new_n130_), .c(new_n115_), .d(new_n140_), .O(new_n151_));
  aoi21  g100(.a(new_n151_), .b(new_n149_), .c(new_n67_), .O(new_n152_));
  ...
  nor2   g105(.a(new_n67_), .b(x03), .O(new_n157_));
  nor2   g106(.a(x31), .b(x30), .O(new_n158_));
  nand4  g107(.a(new_n158_), .b(new_n141_), .c(new_n122_), .d(new_n98_), .O(new_n159_));
  or2    g108(.a(new_n159_), .b(new_n93_), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n157_), .c(new_n156_), .d(new_n52_), .O(z12));
  oai21  g110(.a(new_n159_), .b(new_n93_), .c(x32), .O(new_n162_));
  nand2  g111(.a(new_n130_), .b(new_n147_), .O(new_n163_));
  inv1   g112(.a(new_n163_), .O(new_n164_));
  inv1   g113(.a(x31), .O(new_n165_));
  inv1   g114(.a(x32), .O(new_n166_));
  nand3  g115(.a(new_n150_), .b(new_n166_), .c(new_n165_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nand3  g117(.a(new_n168_), .b(new_n164_), .c(new_n103_), .O(new_n169_));
  aoi21  g118(.a(new_n169_), .b(new_n162_), .c(new_n67_), .O(new_n170_));
  nor2   g119(.a(x16), .b(x02), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n170_), .c(new_n57_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n52_), .O(z13));
  nand2  g122(.a(new_n169_), .b(x33), .O(new_n174_));
  nor2   g123(.a(x33), .b(x32), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n158_), .c(new_n141_), .d(new_n122_), .O(new_n176_));
  or2    g125(.a(new_n176_), .b(new_n106_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n174_), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(x16), .O(new_n179_));
  nor2   g128(.a(x16), .b(x01), .O(new_n180_));
  nor3   g129(.a(new_n180_), .b(x18), .c(x03), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n179_), .O(z14));
  oai21  g131(.a(new_n176_), .b(new_n106_), .c(x34), .O(new_n183_));
  nand2  g132(.a(new_n141_), .b(new_n122_), .O(new_n184_));
  inv1   g133(.a(new_n184_), .O(new_n185_));
  inv1   g134(.a(x30), .O(new_n186_));
  nand2  g135(.a(new_n165_), .b(new_n186_), .O(new_n187_));
  inv1   g136(.a(x33), .O(new_n188_));
  inv1   g137(.a(x34), .O(new_n189_));
  nand3  g138(.a(new_n189_), .b(new_n188_), .c(new_n166_), .O(new_n190_));
  nor2   g139(.a(new_n190_), .b(new_n187_), .O(new_n191_));
  nand3  g140(.a(new_n191_), .b(new_n185_), .c(new_n114_), .O(new_n192_));
  aoi21  g141(.a(new_n192_), .b(new_n183_), .c(new_n67_), .O(new_n193_));
  nor2   g142(.a(x16), .b(x00), .O(new_n194_));
  oai21  g143(.a(new_n194_), .b(new_n193_), .c(new_n57_), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n52_), .O(z15));
endmodule
