...
module FAU ( 
  ...
  nand4  g045(.a(new_n96_), .b(new_n78_), .c(new_n84_), .d(new_n52_), .O(new_n97_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n90_), .c(new_n92_), .d(new_n91_), .O(new_n104_));
  ...
  nand3  g060(.a(new_n111_), .b(new_n85_), .c(new_n72_), .O(new_n112_));
  ...
  nand3  g067(.a(new_n118_), .b(new_n96_), .c(new_n103_), .O(new_n119_));
  ...
  nand4  g076(.a(new_n127_), .b(new_n126_), .c(new_n110_), .d(new_n92_), .O(new_n128_));
  oai22  g077(.a(new_n128_), .b(new_n79_), .c(new_n120_), .d(new_n125_), .O(new_n129_));
  ...
  nand4  g085(.a(new_n136_), .b(new_n111_), .c(new_n94_), .d(new_n135_), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n134_), .c(new_n63_), .O(new_n138_));
  ...
  nand4  g092(.a(new_n136_), .b(new_n143_), .c(new_n135_), .d(new_n90_), .O(new_n144_));
  ...
  nand3  g097(.a(new_n148_), .b(new_n111_), .c(new_n94_), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n145_), .c(new_n63_), .O(new_n150_));
  ...
  nand4  g104(.a(new_n155_), .b(new_n136_), .c(new_n118_), .d(new_n103_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n97_), .c(new_n63_), .O(new_n157_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n146_), .c(new_n127_), .d(new_n143_), .O(new_n165_));
  ...
  oai21  g121(.a(new_n165_), .b(new_n97_), .c(x33), .O(new_n173_));
  nor2   g122(.a(x33), .b(x32), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n155_), .c(new_n136_), .d(new_n118_), .O(new_n175_));
  ...
  nor2   g131(.a(x21), .b(x20), .O(new_n183_));
  nand4  g132(.a(new_n126_), .b(new_n85_), .c(new_n183_), .d(new_n55_), .O(new_n184_));
  oai21  g133(.a(new_n175_), .b(new_n184_), .c(x34), .O(new_n185_));
