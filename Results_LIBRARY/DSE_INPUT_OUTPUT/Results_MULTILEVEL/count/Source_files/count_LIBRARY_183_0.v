...
module FAU ( 
  ...
  nand3  g016(.a(new_n67_), .b(new_n65_), .c(x02), .O(z01));
  ...
  oai21  g038(.a(new_n89_), .b(new_n88_), .c(x02), .O(new_n90_));
  ...
  nand3  g051(.a(new_n102_), .b(new_n100_), .c(x02), .O(z05));
  ...
  nand3  g059(.a(new_n110_), .b(new_n108_), .c(x02), .O(z06));
  ...
  nand3  g068(.a(new_n119_), .b(new_n117_), .c(x02), .O(z07));
  ...
  oai21  g082(.a(new_n133_), .b(new_n132_), .c(x02), .O(new_n134_));
  ...
  aoi21  g090(.a(new_n141_), .b(new_n139_), .c(new_n58_), .O(new_n142_));
  nor2   g091(.a(x16), .b(x05), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(new_n142_), .c(x02), .O(new_n144_));
  ...
  oai21  g104(.a(new_n155_), .b(new_n154_), .c(x02), .O(new_n156_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n162_), .c(new_n161_), .d(new_n64_), .O(new_n169_));
  aoi21  g118(.a(new_n169_), .b(new_n159_), .c(new_n58_), .O(new_n170_));
  nor2   g119(.a(x16), .b(x03), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n170_), .c(x02), .O(new_n172_));
  ...
  nand3  g127(.a(new_n178_), .b(x16), .c(x02), .O(new_n179_));
  ...
  aoi21  g138(.a(new_n189_), .b(new_n181_), .c(new_n58_), .O(new_n190_));
  nor2   g139(.a(x16), .b(x01), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n190_), .c(x02), .O(new_n192_));
  ...
  nor3   g149(.a(new_n200_), .b(x18), .c(new_n69_), .O(new_n201_));
