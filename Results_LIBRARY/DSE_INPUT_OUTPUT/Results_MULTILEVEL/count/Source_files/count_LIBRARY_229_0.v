...
module FAU ( 
  ...
  oai21  g017(.a(new_n68_), .b(new_n67_), .c(x28), .O(new_n69_));
  ...
  oai21  g032(.a(new_n83_), .b(new_n82_), .c(x28), .O(new_n84_));
  ...
  oai21  g039(.a(new_n90_), .b(new_n89_), .c(x28), .O(new_n91_));
  ...
  nand3  g046(.a(new_n97_), .b(new_n80_), .c(new_n72_), .O(new_n98_));
  aoi21  g047(.a(new_n98_), .b(new_n96_), .c(new_n61_), .O(new_n99_));
  nor2   g048(.a(x16), .b(x10), .O(new_n100_));
  oai21  g049(.a(new_n100_), .b(new_n99_), .c(x28), .O(new_n101_));
  ...
  nand2  g056(.a(x28), .b(new_n52_), .O(new_n108_));
  nor2   g057(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  oai21  g058(.a(new_n106_), .b(new_n61_), .c(new_n109_), .O(z06));
  inv1   g059(.a(x26), .O(new_n111_));
  nor3   g060(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n87_), .c(new_n73_), .d(new_n55_), .O(new_n113_));
  oai21  g062(.a(new_n105_), .b(new_n111_), .c(new_n113_), .O(new_n114_));
  nand2  g063(.a(new_n114_), .b(x16), .O(new_n115_));
  nor2   g064(.a(x16), .b(x08), .O(new_n116_));
  nor2   g065(.a(new_n116_), .b(new_n108_), .O(new_n117_));
  ...
  nand4  g077(.a(new_n128_), .b(new_n97_), .c(new_n127_), .d(new_n55_), .O(new_n129_));
  nor2   g078(.a(x16), .b(x06), .O(new_n130_));
  aoi21  g079(.a(new_n129_), .b(x16), .c(new_n130_), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n53_), .c(new_n52_), .O(z09));
  inv1   g081(.a(new_n108_), .O(new_n133_));
  nand2  g082(.a(x29), .b(x16), .O(new_n134_));
  inv1   g083(.a(x05), .O(new_n135_));
  nand2  g084(.a(new_n61_), .b(new_n135_), .O(new_n136_));
  nand3  g085(.a(new_n136_), .b(new_n134_), .c(new_n133_), .O(z10));
  nor2   g086(.a(x16), .b(x04), .O(new_n138_));
  and2   g087(.a(x30), .b(x16), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n138_), .c(x28), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n52_), .O(z11));
  nand2  g090(.a(x31), .b(x16), .O(new_n142_));
  inv1   g091(.a(x03), .O(new_n143_));
  nand2  g092(.a(new_n61_), .b(new_n143_), .O(new_n144_));
  nand3  g093(.a(new_n144_), .b(new_n142_), .c(new_n133_), .O(z12));
  nor2   g094(.a(x16), .b(x02), .O(new_n146_));
  and2   g095(.a(x32), .b(x16), .O(new_n147_));
  ...
  oai21  g100(.a(new_n151_), .b(new_n150_), .c(x28), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n52_), .O(z14));
  nor2   g102(.a(x16), .b(x00), .O(new_n154_));
  and2   g103(.a(x34), .b(x16), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n154_), .c(x28), .O(new_n156_));
