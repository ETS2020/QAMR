...
module FAU ( 
  ...
  nand2  g016(.a(x18), .b(x03), .O(new_n68_));
  ...
  aoi21  g041(.a(new_n86_), .b(new_n71_), .c(new_n92_), .O(new_n93_));
  ...
  nand4  g050(.a(new_n95_), .b(new_n79_), .c(new_n63_), .d(new_n52_), .O(new_n102_));
  ...
  aoi21  g056(.a(new_n107_), .b(new_n103_), .c(new_n58_), .O(new_n108_));
  ...
  nand4  g062(.a(new_n113_), .b(new_n105_), .c(new_n104_), .d(new_n55_), .O(new_n114_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n113_), .c(new_n86_), .d(new_n71_), .O(new_n138_));
  ...
  oai22  g104(.a(new_n155_), .b(new_n102_), .c(new_n145_), .d(new_n150_), .O(new_n156_));
  ...
  oai21  g109(.a(new_n155_), .b(new_n102_), .c(x32), .O(new_n161_));
  inv1   g110(.a(new_n102_), .O(new_n162_));
  nor2   g111(.a(x26), .b(x25), .O(new_n163_));
  nor2   g112(.a(x32), .b(x31), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n143_), .c(new_n129_), .d(new_n163_), .O(new_n165_));
  ...
  nand2  g119(.a(new_n170_), .b(new_n68_), .O(z13));
  oai21  g120(.a(new_n165_), .b(new_n102_), .c(x33), .O(new_n172_));
  inv1   g121(.a(x22), .O(new_n173_));
  nand4  g122(.a(new_n151_), .b(new_n92_), .c(new_n127_), .d(new_n173_), .O(new_n174_));
  nor2   g123(.a(new_n174_), .b(new_n73_), .O(new_n175_));
  nor2   g124(.a(x33), .b(x32), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n177_));
  ...
  nand2  g131(.a(new_n182_), .b(new_n68_), .O(z14));
  oai21  g132(.a(new_n177_), .b(new_n107_), .c(x34), .O(new_n184_));
  nand2  g133(.a(new_n153_), .b(new_n152_), .O(new_n185_));
  inv1   g134(.a(new_n185_), .O(new_n186_));
  inv1   g135(.a(x30), .O(new_n187_));
  nand2  g136(.a(new_n150_), .b(new_n187_), .O(new_n188_));
  ...
  nand2  g146(.a(new_n197_), .b(new_n68_), .O(z15));
endmodule
