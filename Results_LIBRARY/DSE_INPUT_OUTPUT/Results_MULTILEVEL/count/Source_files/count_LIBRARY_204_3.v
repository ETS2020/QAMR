...
module FAU ( 
  ...
  nand2  g025(.a(new_n62_), .b(new_n58_), .O(new_n77_));
  ...
  nand2  g030(.a(new_n73_), .b(new_n54_), .O(new_n82_));
  nor2   g031(.a(x22), .b(x21), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n54_), .c(new_n67_), .O(new_n84_));
  inv1   g033(.a(new_n84_), .O(new_n85_));
  aoi21  g034(.a(new_n82_), .b(x22), .c(new_n85_), .O(new_n86_));
  inv1   g035(.a(x12), .O(new_n87_));
  aoi21  g036(.a(new_n66_), .b(new_n87_), .c(x18), .O(new_n88_));
  oai21  g037(.a(new_n86_), .b(new_n66_), .c(new_n88_), .O(z03));
  inv1   g038(.a(new_n77_), .O(new_n90_));
  nor3   g039(.a(x23), .b(x22), .c(x21), .O(new_n91_));
  aoi22  g040(.a(new_n91_), .b(new_n90_), .c(new_n84_), .d(x23), .O(new_n92_));
  inv1   g041(.a(x11), .O(new_n93_));
  aoi21  g042(.a(new_n66_), .b(new_n93_), .c(x18), .O(new_n94_));
  oai21  g043(.a(new_n92_), .b(new_n66_), .c(new_n94_), .O(z04));
  nor2   g044(.a(x24), .b(x23), .O(new_n96_));
  nand3  g045(.a(new_n96_), .b(new_n83_), .c(new_n64_), .O(new_n97_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n62_), .c(new_n100_), .d(new_n58_), .O(new_n102_));
  ...
  nand2  g054(.a(new_n105_), .b(new_n99_), .O(z05));
  ...
  nand4  g059(.a(new_n96_), .b(new_n83_), .c(new_n62_), .d(new_n58_), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(x25), .c(x16), .O(new_n112_));
  oai21  g061(.a(x16), .b(x09), .c(new_n112_), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(new_n52_), .O(new_n114_));
  nand2  g063(.a(new_n114_), .b(new_n110_), .O(z06));
  ...
  nand4  g068(.a(new_n107_), .b(new_n101_), .c(new_n73_), .d(new_n54_), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(x26), .c(x16), .O(new_n121_));
  oai21  g070(.a(x16), .b(x08), .c(new_n121_), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n52_), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(new_n119_), .O(z07));
  oai21  g073(.a(new_n117_), .b(new_n82_), .c(x27), .O(new_n125_));
  inv1   g074(.a(x25), .O(new_n126_));
  nor2   g075(.a(x27), .b(x26), .O(new_n127_));
  nand3  g076(.a(new_n127_), .b(new_n96_), .c(new_n126_), .O(new_n128_));
  or2    g077(.a(new_n128_), .b(new_n84_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n125_), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(x16), .O(new_n131_));
  inv1   g080(.a(x07), .O(new_n132_));
  aoi21  g081(.a(new_n66_), .b(new_n132_), .c(x18), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n131_), .O(z08));
  nand4  g083(.a(new_n83_), .b(new_n67_), .c(new_n72_), .d(x16), .O(new_n135_));
  inv1   g084(.a(x23), .O(new_n136_));
  inv1   g085(.a(x26), .O(new_n137_));
  nor2   g086(.a(x28), .b(x27), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n107_), .c(new_n137_), .d(new_n136_), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n135_), .c(new_n52_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n58_), .O(new_n141_));
  oai21  g090(.a(new_n128_), .b(new_n84_), .c(x28), .O(new_n142_));
  inv1   g091(.a(x06), .O(new_n143_));
  nand2  g092(.a(new_n66_), .b(new_n143_), .O(new_n144_));
  oai21  g093(.a(new_n142_), .b(new_n66_), .c(new_n144_), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n52_), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n141_), .O(z09));
  oai21  g096(.a(new_n139_), .b(new_n84_), .c(x29), .O(new_n148_));
  nor3   g097(.a(x29), .b(x28), .c(x27), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n116_), .c(new_n91_), .d(new_n90_), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(x16), .O(new_n152_));
  inv1   g101(.a(x05), .O(new_n153_));
  aoi21  g102(.a(new_n66_), .b(new_n153_), .c(x18), .O(new_n154_));
  ...
  nand4  g107(.a(new_n158_), .b(new_n138_), .c(new_n157_), .d(new_n156_), .O(new_n159_));
  nor2   g108(.a(new_n159_), .b(new_n102_), .O(new_n160_));
  aoi21  g109(.a(new_n150_), .b(x30), .c(new_n160_), .O(new_n161_));
  inv1   g110(.a(x04), .O(new_n162_));
  aoi21  g111(.a(new_n66_), .b(new_n162_), .c(x18), .O(new_n163_));
  oai21  g112(.a(new_n161_), .b(new_n66_), .c(new_n163_), .O(z11));
  nor2   g113(.a(x29), .b(x28), .O(new_n165_));
  nor2   g114(.a(x31), .b(x30), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n165_), .c(new_n127_), .d(new_n126_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n97_), .c(new_n52_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n58_), .O(new_n169_));
  oai21  g118(.a(new_n159_), .b(new_n102_), .c(x31), .O(new_n170_));
  inv1   g119(.a(x03), .O(new_n171_));
  nand2  g120(.a(new_n66_), .b(new_n171_), .O(new_n172_));
  ...
  oai21  g124(.a(new_n167_), .b(new_n111_), .c(x32), .O(new_n176_));
  nor2   g125(.a(x32), .b(x31), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n158_), .c(new_n138_), .d(new_n157_), .O(new_n178_));
  ...
  oai21  g132(.a(new_n178_), .b(new_n111_), .c(x33), .O(new_n184_));
  nor2   g133(.a(x33), .b(x32), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n166_), .c(new_n165_), .d(new_n127_), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(new_n120_), .c(new_n184_), .O(new_n187_));
  nand2  g136(.a(new_n187_), .b(x16), .O(new_n188_));
  inv1   g137(.a(x01), .O(new_n189_));
  aoi21  g138(.a(new_n66_), .b(new_n189_), .c(x18), .O(new_n190_));
  nand2  g139(.a(new_n190_), .b(new_n188_), .O(z14));
  oai21  g140(.a(new_n186_), .b(new_n120_), .c(x34), .O(new_n192_));
  inv1   g141(.a(new_n120_), .O(new_n193_));
  nand2  g142(.a(new_n165_), .b(new_n127_), .O(new_n194_));
  ...
  nor2   g148(.a(new_n199_), .b(new_n196_), .O(new_n200_));
  nand3  g149(.a(new_n200_), .b(new_n195_), .c(new_n193_), .O(new_n201_));
  nand2  g150(.a(new_n201_), .b(new_n192_), .O(new_n202_));
  nand2  g151(.a(new_n202_), .b(x16), .O(new_n203_));
  inv1   g152(.a(x00), .O(new_n204_));
  aoi21  g153(.a(new_n66_), .b(new_n204_), .c(x18), .O(new_n205_));
