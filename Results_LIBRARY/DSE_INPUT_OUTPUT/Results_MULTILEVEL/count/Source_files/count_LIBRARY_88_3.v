...
module FAU ( 
  ...
  nand4  g024(.a(new_n75_), .b(new_n61_), .c(new_n74_), .d(new_n63_), .O(new_n76_));
  nor3   g025(.a(x22), .b(x21), .c(x20), .O(new_n77_));
  aoi22  g026(.a(new_n77_), .b(new_n62_), .c(new_n76_), .d(x22), .O(new_n78_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n90_), .c(new_n100_), .d(new_n99_), .O(new_n102_));
  ...
  oai21  g080(.a(new_n129_), .b(new_n56_), .c(new_n131_), .O(z09));
  inv1   g081(.a(x05), .O(new_n133_));
  oai21  g082(.a(x18), .b(new_n133_), .c(new_n56_), .O(new_n134_));
  ...
  oai21  g087(.a(new_n128_), .b(new_n135_), .c(new_n138_), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n52_), .c(x16), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n134_), .O(z10));
  nand4  g090(.a(new_n111_), .b(new_n64_), .c(new_n75_), .d(new_n63_), .O(new_n142_));
  nor2   g091(.a(x30), .b(x29), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n126_), .c(new_n112_), .d(new_n90_), .O(new_n144_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n143_), .c(new_n126_), .d(new_n112_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n94_), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  nand3  g119(.a(new_n170_), .b(new_n52_), .c(x16), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n162_), .O(z13));
  inv1   g121(.a(x33), .O(new_n173_));
  aoi21  g122(.a(new_n168_), .b(new_n94_), .c(new_n173_), .O(new_n174_));
  nand4  g123(.a(new_n125_), .b(new_n111_), .c(new_n69_), .d(new_n62_), .O(new_n175_));
  nor2   g124(.a(x33), .b(x32), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n154_), .c(new_n153_), .d(new_n163_), .O(new_n177_));
  ...
  oai21  g132(.a(x18), .b(new_n183_), .c(new_n56_), .O(new_n184_));
  oai21  g133(.a(new_n177_), .b(new_n175_), .c(x34), .O(new_n185_));
  nand2  g134(.a(new_n153_), .b(new_n163_), .O(new_n186_));
  ...
  nand3  g141(.a(new_n192_), .b(new_n173_), .c(new_n191_), .O(new_n193_));
  nor2   g142(.a(new_n193_), .b(new_n190_), .O(new_n194_));
  nand3  g143(.a(new_n194_), .b(new_n187_), .c(new_n103_), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n185_), .O(new_n196_));
  nand3  g145(.a(new_n196_), .b(new_n52_), .c(x16), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(new_n184_), .O(z15));
endmodule
