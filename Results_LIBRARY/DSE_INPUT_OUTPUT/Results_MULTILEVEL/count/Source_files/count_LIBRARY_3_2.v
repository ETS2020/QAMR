...
module FAU ( 
  ...
  nand2  g003(.a(x33), .b(x18), .O(new_n55_));
  ...
  aoi21  g032(.a(new_n78_), .b(new_n58_), .c(new_n83_), .O(new_n84_));
  ...
  nand4  g053(.a(new_n104_), .b(new_n85_), .c(new_n103_), .d(new_n58_), .O(new_n105_));
  aoi21  g054(.a(new_n105_), .b(new_n102_), .c(new_n66_), .O(new_n106_));
  nor2   g055(.a(x16), .b(x09), .O(new_n107_));
  oai21  g056(.a(new_n107_), .b(new_n106_), .c(new_n60_), .O(new_n108_));
  nand2  g057(.a(new_n108_), .b(new_n55_), .O(z06));
  nand2  g058(.a(new_n105_), .b(x26), .O(new_n110_));
  nor3   g059(.a(x26), .b(x25), .c(x24), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(new_n85_), .c(new_n73_), .O(new_n112_));
  ...
  nand4  g070(.a(new_n121_), .b(new_n94_), .c(new_n78_), .d(new_n58_), .O(new_n122_));
  aoi21  g071(.a(new_n122_), .b(new_n120_), .c(new_n66_), .O(new_n123_));
  nor2   g072(.a(x16), .b(x07), .O(new_n124_));
  oai21  g073(.a(new_n124_), .b(new_n123_), .c(new_n60_), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n55_), .O(z08));
  ...
  nand4  g086(.a(new_n137_), .b(new_n111_), .c(new_n87_), .d(new_n136_), .O(new_n138_));
  ...
  nand4  g093(.a(new_n144_), .b(new_n143_), .c(new_n118_), .d(new_n117_), .O(new_n145_));
  ...
  nand4  g103(.a(new_n154_), .b(new_n121_), .c(new_n96_), .d(new_n92_), .O(new_n155_));
  aoi21  g104(.a(new_n155_), .b(new_n151_), .c(new_n66_), .O(new_n156_));
  nor2   g105(.a(x16), .b(x03), .O(new_n157_));
  oai21  g106(.a(new_n157_), .b(new_n156_), .c(new_n60_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n55_), .O(z12));
  nor2   g108(.a(x32), .b(x31), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n144_), .c(new_n143_), .d(new_n118_), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(new_n101_), .O(new_n162_));
  aoi21  g111(.a(new_n155_), .b(x32), .c(new_n162_), .O(new_n163_));
  inv1   g112(.a(x02), .O(new_n164_));
  aoi21  g113(.a(new_n66_), .b(new_n164_), .c(x18), .O(new_n165_));
  oai21  g114(.a(new_n163_), .b(new_n66_), .c(new_n165_), .O(z13));
  inv1   g115(.a(x33), .O(new_n167_));
  nor2   g116(.a(new_n162_), .b(new_n167_), .O(new_n168_));
  nor2   g117(.a(x27), .b(x26), .O(new_n169_));
  nand2  g118(.a(new_n137_), .b(new_n169_), .O(new_n170_));
  inv1   g119(.a(x32), .O(new_n171_));
  nand3  g120(.a(new_n152_), .b(new_n167_), .c(new_n171_), .O(new_n172_));
  nor3   g121(.a(new_n172_), .b(new_n170_), .c(new_n105_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n168_), .c(x16), .O(new_n174_));
  ...
  oai21  g127(.a(new_n178_), .b(new_n66_), .c(new_n60_), .O(new_n179_));
  nand2  g128(.a(new_n179_), .b(x33), .O(new_n180_));
  oai21  g129(.a(new_n161_), .b(new_n101_), .c(x34), .O(new_n181_));
  inv1   g130(.a(x22), .O(new_n182_));
  inv1   g131(.a(x25), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n117_), .c(new_n83_), .d(new_n182_), .O(new_n184_));
  ...
  nand3  g138(.a(new_n178_), .b(new_n167_), .c(new_n171_), .O(new_n190_));
  nor2   g139(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  nand3  g140(.a(new_n191_), .b(new_n186_), .c(new_n185_), .O(new_n192_));
  ...
  nand2  g144(.a(new_n195_), .b(new_n180_), .O(z15));
endmodule
