...
module FAU ( 
  ...
  nand2  g030(.a(x34), .b(new_n52_), .O(new_n82_));
  ...
  oai21  g051(.a(new_n102_), .b(new_n101_), .c(x34), .O(new_n103_));
  ...
  nand4  g057(.a(new_n108_), .b(new_n96_), .c(new_n73_), .d(new_n55_), .O(new_n109_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n99_), .c(new_n79_), .d(new_n55_), .O(new_n127_));
  ...
  nand4  g085(.a(new_n136_), .b(new_n135_), .c(new_n79_), .d(new_n55_), .O(new_n137_));
  aoi21  g086(.a(new_n137_), .b(new_n134_), .c(new_n61_), .O(new_n138_));
  nor2   g087(.a(x16), .b(x06), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n138_), .c(x34), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n52_), .O(z09));
  ...
  nor2   g096(.a(new_n147_), .b(new_n82_), .O(new_n148_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n116_), .c(new_n90_), .O(new_n155_));
  aoi21  g104(.a(new_n155_), .b(new_n150_), .c(new_n61_), .O(new_n156_));
  nor2   g105(.a(x16), .b(x04), .O(new_n157_));
  oai21  g106(.a(new_n157_), .b(new_n156_), .c(x34), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n52_), .O(z11));
  nand2  g108(.a(new_n155_), .b(x31), .O(new_n160_));
  nor2   g109(.a(x31), .b(x30), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n143_), .c(new_n126_), .d(new_n107_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(x16), .O(new_n164_));
  nor2   g113(.a(x16), .b(x03), .O(new_n165_));
  nor2   g114(.a(new_n165_), .b(new_n82_), .O(new_n166_));
  ...
  nor2   g121(.a(new_n172_), .b(new_n82_), .O(new_n173_));
  oai21  g122(.a(new_n171_), .b(new_n61_), .c(new_n173_), .O(z13));
  oai21  g123(.a(new_n169_), .b(new_n100_), .c(x33), .O(new_n175_));
  nor2   g124(.a(x33), .b(x32), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n161_), .c(new_n143_), .d(new_n132_), .O(new_n177_));
  or2    g126(.a(new_n177_), .b(new_n109_), .O(new_n178_));
  ...
  aoi21  g133(.a(new_n178_), .b(x16), .c(new_n184_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n53_), .c(new_n52_), .O(z15));
endmodule
