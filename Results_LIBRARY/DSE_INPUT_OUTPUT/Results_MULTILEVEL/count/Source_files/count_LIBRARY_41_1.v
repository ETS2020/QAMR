...
module FAU ( 
  ...
  oai21  g071(.a(new_n120_), .b(new_n69_), .c(new_n122_), .O(z08));
  ...
  nand3  g077(.a(new_n128_), .b(new_n124_), .c(new_n52_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(x16), .O(new_n130_));
  oai21  g079(.a(new_n59_), .b(x06), .c(new_n130_), .O(z09));
  nor3   g080(.a(x29), .b(x28), .c(x27), .O(new_n132_));
  and2   g081(.a(new_n132_), .b(new_n109_), .O(new_n133_));
  aoi22  g082(.a(new_n133_), .b(new_n93_), .c(new_n128_), .d(x29), .O(new_n134_));
  inv1   g083(.a(x05), .O(new_n135_));
  aoi21  g084(.a(new_n69_), .b(new_n135_), .c(x18), .O(new_n136_));
  oai21  g085(.a(new_n134_), .b(new_n69_), .c(new_n136_), .O(z10));
  nand3  g086(.a(new_n132_), .b(new_n109_), .c(new_n93_), .O(new_n138_));
  ...
  aoi21  g092(.a(new_n138_), .b(x30), .c(new_n143_), .O(new_n144_));
  inv1   g093(.a(x04), .O(new_n145_));
  aoi21  g094(.a(new_n69_), .b(new_n145_), .c(x18), .O(new_n146_));
  oai21  g095(.a(new_n144_), .b(new_n69_), .c(new_n146_), .O(z11));
  nand2  g096(.a(new_n141_), .b(new_n140_), .O(new_n148_));
  inv1   g097(.a(new_n148_), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n109_), .c(new_n93_), .O(new_n150_));
  nor2   g099(.a(x29), .b(x28), .O(new_n151_));
  nor2   g100(.a(x31), .b(x30), .O(new_n152_));
  nand4  g101(.a(new_n152_), .b(new_n151_), .c(new_n117_), .d(new_n116_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n96_), .c(new_n52_), .O(new_n154_));
  ...
  oai21  g106(.a(new_n155_), .b(new_n69_), .c(new_n157_), .O(z12));
  oai21  g107(.a(new_n153_), .b(new_n96_), .c(x32), .O(new_n159_));
  inv1   g108(.a(new_n96_), .O(new_n160_));
  nor2   g109(.a(x32), .b(x31), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n141_), .c(new_n140_), .d(new_n139_), .O(new_n162_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n96_), .c(x33), .O(new_n170_));
  nand4  g119(.a(new_n116_), .b(new_n90_), .c(new_n91_), .d(new_n77_), .O(new_n171_));
  ...
  nand3  g142(.a(new_n193_), .b(new_n182_), .c(new_n52_), .O(new_n194_));
