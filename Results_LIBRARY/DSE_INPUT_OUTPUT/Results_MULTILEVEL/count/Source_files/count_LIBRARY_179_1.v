...
module FAU ( 
  ...
  nand4  g041(.a(new_n92_), .b(new_n79_), .c(new_n86_), .d(new_n52_), .O(new_n93_));
  nand2  g042(.a(new_n93_), .b(new_n78_), .O(new_n94_));
  aoi21  g043(.a(new_n88_), .b(x24), .c(new_n94_), .O(new_n95_));
  oai22  g044(.a(new_n95_), .b(new_n58_), .c(new_n84_), .d(x10), .O(z05));
  inv1   g045(.a(x23), .O(new_n97_));
  inv1   g046(.a(x24), .O(new_n98_));
  inv1   g047(.a(x25), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n76_), .O(new_n100_));
  ...
  nand3  g060(.a(new_n111_), .b(new_n109_), .c(new_n78_), .O(new_n112_));
  ...
  nand3  g066(.a(new_n117_), .b(new_n92_), .c(new_n99_), .O(new_n118_));
  ...
  oai21  g076(.a(new_n127_), .b(new_n80_), .c(new_n124_), .O(new_n128_));
  ...
  oai21  g081(.a(new_n127_), .b(new_n80_), .c(x29), .O(new_n133_));
  nor3   g082(.a(x23), .b(x22), .c(x21), .O(new_n134_));
  nor3   g083(.a(x29), .b(x28), .c(x27), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n110_), .c(new_n134_), .d(new_n64_), .O(new_n136_));
  nand3  g085(.a(new_n136_), .b(new_n133_), .c(new_n78_), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(x16), .O(new_n138_));
  inv1   g087(.a(x05), .O(new_n139_));
  nand2  g088(.a(new_n83_), .b(new_n139_), .O(new_n140_));
  ...
  nand4  g099(.a(new_n98_), .b(new_n97_), .c(new_n76_), .d(new_n69_), .O(new_n151_));
  nor2   g100(.a(new_n151_), .b(new_n63_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n157_), .b(new_n153_), .c(new_n152_), .O(new_n158_));
  ...
  nand4  g112(.a(new_n155_), .b(new_n154_), .c(new_n117_), .d(new_n99_), .O(new_n164_));
  oai21  g113(.a(new_n164_), .b(new_n93_), .c(x32), .O(new_n165_));
  nor2   g114(.a(x32), .b(x31), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n143_), .c(new_n126_), .d(new_n142_), .O(new_n167_));
  ...
  nand2  g134(.a(new_n154_), .b(new_n117_), .O(new_n186_));
