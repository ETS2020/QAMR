...
module FAU ( 
  ...
  nand3  g039(.a(new_n90_), .b(new_n63_), .c(x16), .O(new_n91_));
  ...
  nand4  g057(.a(new_n108_), .b(new_n88_), .c(new_n107_), .d(new_n55_), .O(new_n109_));
  nand2  g058(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  nand3  g059(.a(new_n110_), .b(new_n63_), .c(x16), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(new_n105_), .O(z06));
  ...
  nand3  g065(.a(new_n116_), .b(new_n88_), .c(new_n71_), .O(new_n117_));
  ...
  nand3  g071(.a(new_n122_), .b(new_n99_), .c(new_n121_), .O(new_n123_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n116_), .c(new_n98_), .O(new_n155_));
  ...
  nand4  g109(.a(new_n152_), .b(new_n151_), .c(new_n140_), .d(new_n95_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n89_), .c(x31), .O(new_n162_));
  inv1   g111(.a(new_n65_), .O(new_n163_));
  nand2  g112(.a(new_n99_), .b(new_n79_), .O(new_n164_));
  ...
  nand4  g135(.a(new_n180_), .b(new_n152_), .c(new_n151_), .d(new_n140_), .O(new_n187_));
  oai21  g136(.a(new_n187_), .b(new_n100_), .c(x33), .O(new_n188_));
  nand4  g137(.a(new_n121_), .b(new_n95_), .c(new_n96_), .d(new_n78_), .O(new_n189_));
  nor2   g138(.a(new_n189_), .b(new_n70_), .O(new_n190_));
  nor2   g139(.a(x33), .b(x32), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n167_), .c(new_n141_), .d(new_n122_), .O(new_n192_));
  ...
  oai21  g148(.a(new_n192_), .b(new_n109_), .c(x34), .O(new_n200_));
  nand2  g149(.a(new_n141_), .b(new_n122_), .O(new_n201_));
  ...
  nand3  g159(.a(new_n210_), .b(new_n202_), .c(new_n190_), .O(new_n211_));
