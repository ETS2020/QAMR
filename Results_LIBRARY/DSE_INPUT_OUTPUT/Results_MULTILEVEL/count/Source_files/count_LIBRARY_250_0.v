...
module FAU ( 
  ...
  nand4  g039(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n87_), .O(new_n91_));
  nor2   g040(.a(new_n91_), .b(new_n67_), .O(new_n92_));
  inv1   g041(.a(new_n92_), .O(new_n93_));
  nand4  g042(.a(new_n93_), .b(new_n86_), .c(new_n52_), .d(x16), .O(z06));
  ...
  nand3  g048(.a(new_n99_), .b(new_n81_), .c(new_n90_), .O(new_n100_));
  nor2   g049(.a(new_n100_), .b(new_n76_), .O(new_n101_));
  aoi21  g050(.a(new_n97_), .b(x27), .c(new_n101_), .O(new_n102_));
  ...
  oai21  g056(.a(new_n101_), .b(new_n104_), .c(new_n107_), .O(new_n108_));
  nand2  g057(.a(new_n108_), .b(x16), .O(new_n109_));
  nand2  g058(.a(new_n109_), .b(new_n52_), .O(z09));
  nand2  g059(.a(new_n107_), .b(x29), .O(new_n111_));
  inv1   g060(.a(x27), .O(new_n112_));
  nor2   g061(.a(x29), .b(x28), .O(new_n113_));
  nand3  g062(.a(new_n113_), .b(new_n96_), .c(new_n112_), .O(new_n114_));
  ...
  or2    g069(.a(new_n120_), .b(new_n79_), .O(new_n121_));
  nand4  g070(.a(new_n121_), .b(new_n117_), .c(new_n52_), .d(x16), .O(z11));
  oai21  g071(.a(new_n120_), .b(new_n79_), .c(x31), .O(new_n123_));
  nor3   g072(.a(x27), .b(x26), .c(x25), .O(new_n124_));
  nor2   g073(.a(x31), .b(x30), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n113_), .c(new_n124_), .d(new_n83_), .O(new_n126_));
  nand4  g075(.a(new_n126_), .b(new_n123_), .c(new_n52_), .d(x16), .O(z12));
  nand2  g076(.a(new_n126_), .b(x32), .O(new_n128_));
  nor2   g077(.a(x26), .b(x25), .O(new_n129_));
  nor2   g078(.a(x32), .b(x31), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n119_), .c(new_n118_), .d(new_n129_), .O(new_n131_));
  or2    g080(.a(new_n131_), .b(new_n82_), .O(new_n132_));
  nand4  g081(.a(new_n132_), .b(new_n128_), .c(new_n52_), .d(x16), .O(z13));
  ...
  nand4  g086(.a(new_n137_), .b(new_n104_), .c(new_n112_), .d(new_n136_), .O(new_n138_));
  inv1   g087(.a(new_n138_), .O(new_n139_));
  inv1   g088(.a(x30), .O(new_n140_));
  inv1   g089(.a(x31), .O(new_n141_));
  inv1   g090(.a(x32), .O(new_n142_));
  inv1   g091(.a(x33), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n140_), .O(new_n144_));
  inv1   g093(.a(new_n144_), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n139_), .c(new_n135_), .d(new_n68_), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n134_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n52_), .O(z14));
  nand2  g098(.a(new_n146_), .b(x34), .O(new_n150_));
  nor3   g099(.a(x34), .b(x33), .c(x32), .O(new_n151_));
  nand4  g100(.a(new_n151_), .b(new_n139_), .c(new_n125_), .d(new_n92_), .O(new_n152_));
