...
module FAU ( 
  ...
  nand3  g020(.a(new_n71_), .b(new_n56_), .c(new_n66_), .O(new_n72_));
  ...
  nand4  g024(.a(new_n75_), .b(new_n60_), .c(new_n67_), .d(new_n53_), .O(new_n76_));
  nand4  g025(.a(new_n76_), .b(new_n74_), .c(new_n52_), .d(x16), .O(z04));
  nand2  g026(.a(new_n76_), .b(x24), .O(new_n78_));
  nor2   g027(.a(x24), .b(x23), .O(new_n79_));
  nand4  g028(.a(new_n79_), .b(new_n71_), .c(new_n60_), .d(new_n53_), .O(new_n80_));
  ...
  nand4  g033(.a(new_n84_), .b(new_n75_), .c(new_n83_), .d(new_n56_), .O(new_n85_));
  nand4  g034(.a(new_n85_), .b(new_n82_), .c(new_n52_), .d(x16), .O(z06));
  nand2  g035(.a(new_n85_), .b(x26), .O(new_n87_));
  inv1   g036(.a(new_n68_), .O(new_n88_));
  nor3   g037(.a(x26), .b(x25), .c(x24), .O(new_n89_));
  nand3  g038(.a(new_n89_), .b(new_n75_), .c(new_n88_), .O(new_n90_));
  ...
  nand4  g045(.a(new_n96_), .b(new_n79_), .c(new_n95_), .d(new_n56_), .O(new_n97_));
  ...
  nand4  g051(.a(new_n102_), .b(new_n84_), .c(new_n101_), .d(new_n100_), .O(new_n103_));
  nor2   g052(.a(new_n103_), .b(new_n72_), .O(new_n104_));
  aoi21  g053(.a(new_n97_), .b(x28), .c(new_n104_), .O(new_n105_));
  oai21  g054(.a(new_n105_), .b(new_n99_), .c(new_n52_), .O(z09));
  oai21  g055(.a(new_n103_), .b(new_n72_), .c(x29), .O(new_n107_));
  inv1   g056(.a(x27), .O(new_n108_));
  inv1   g057(.a(x28), .O(new_n109_));
  inv1   g058(.a(x29), .O(new_n110_));
  nand4  g059(.a(new_n89_), .b(new_n110_), .c(new_n109_), .d(new_n108_), .O(new_n111_));
  or2    g060(.a(new_n111_), .b(new_n76_), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n107_), .c(new_n52_), .d(x16), .O(z10));
  oai21  g062(.a(new_n111_), .b(new_n76_), .c(x30), .O(new_n114_));
  inv1   g063(.a(x24), .O(new_n115_));
  nor2   g064(.a(x26), .b(x25), .O(new_n116_));
  nor2   g065(.a(x30), .b(x29), .O(new_n117_));
  nand4  g066(.a(new_n117_), .b(new_n102_), .c(new_n116_), .d(new_n115_), .O(new_n118_));
  or2    g067(.a(new_n118_), .b(new_n76_), .O(new_n119_));
  nand4  g068(.a(new_n119_), .b(new_n114_), .c(new_n52_), .d(x16), .O(z11));
  oai21  g069(.a(new_n118_), .b(new_n76_), .c(x31), .O(new_n121_));
  inv1   g070(.a(x22), .O(new_n122_));
  nand4  g071(.a(new_n115_), .b(new_n100_), .c(new_n122_), .d(new_n67_), .O(new_n123_));
  inv1   g072(.a(new_n123_), .O(new_n124_));
  inv1   g073(.a(x30), .O(new_n125_));
  inv1   g074(.a(x31), .O(new_n126_));
  nand4  g075(.a(new_n126_), .b(new_n125_), .c(new_n110_), .d(new_n109_), .O(new_n127_));
  inv1   g076(.a(new_n127_), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n96_), .c(new_n124_), .d(new_n63_), .O(new_n129_));
  ...
  nand4  g083(.a(new_n134_), .b(new_n117_), .c(new_n102_), .d(new_n116_), .O(new_n135_));
  or2    g084(.a(new_n135_), .b(new_n80_), .O(new_n136_));
  nand4  g085(.a(new_n136_), .b(new_n133_), .c(new_n52_), .d(x16), .O(z13));
  oai21  g086(.a(new_n135_), .b(new_n80_), .c(x33), .O(new_n138_));
  inv1   g087(.a(x25), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n115_), .c(new_n100_), .d(new_n122_), .O(new_n140_));
  inv1   g089(.a(new_n140_), .O(new_n141_));
  nand4  g090(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n101_), .O(new_n142_));
  inv1   g091(.a(new_n142_), .O(new_n143_));
  inv1   g092(.a(x32), .O(new_n144_));
  inv1   g093(.a(x33), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n144_), .c(new_n126_), .d(new_n125_), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n143_), .c(new_n141_), .d(new_n88_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n138_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(x16), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(new_n52_), .O(z14));
  nand2  g100(.a(new_n148_), .b(x34), .O(new_n152_));
  inv1   g101(.a(new_n85_), .O(new_n153_));
  nor2   g102(.a(x31), .b(x30), .O(new_n154_));
  nor3   g103(.a(x34), .b(x33), .c(x32), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n143_), .c(new_n154_), .d(new_n153_), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n152_), .c(new_n52_), .d(x16), .O(z15));
endmodule
