...
module FAU ( 
  ...
  nand4  g048(.a(new_n99_), .b(new_n78_), .c(new_n88_), .d(new_n56_), .O(new_n100_));
  ...
  nand3  g053(.a(new_n104_), .b(new_n81_), .c(new_n96_), .O(new_n105_));
  nor2   g054(.a(new_n105_), .b(new_n72_), .O(new_n106_));
  aoi21  g055(.a(new_n100_), .b(x27), .c(new_n106_), .O(new_n107_));
  oai21  g056(.a(new_n107_), .b(new_n74_), .c(new_n52_), .O(z08));
  oai21  g057(.a(new_n105_), .b(new_n72_), .c(x28), .O(new_n109_));
  nor2   g058(.a(x28), .b(x27), .O(new_n110_));
  nand4  g059(.a(new_n110_), .b(new_n89_), .c(new_n92_), .d(new_n94_), .O(new_n111_));
  or2    g060(.a(new_n111_), .b(new_n72_), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n109_), .c(new_n52_), .d(x16), .O(z09));
  nand2  g062(.a(new_n112_), .b(x29), .O(new_n114_));
  nor3   g063(.a(x29), .b(x28), .c(x27), .O(new_n115_));
  nand4  g064(.a(new_n115_), .b(new_n99_), .c(new_n75_), .d(new_n61_), .O(new_n116_));
  ...
  nand4  g068(.a(new_n119_), .b(new_n110_), .c(new_n118_), .d(new_n95_), .O(new_n120_));
  nor2   g069(.a(new_n120_), .b(new_n79_), .O(new_n121_));
  aoi21  g070(.a(new_n116_), .b(x30), .c(new_n121_), .O(new_n122_));
  oai21  g071(.a(new_n122_), .b(new_n74_), .c(new_n52_), .O(z11));
  oai21  g072(.a(new_n120_), .b(new_n79_), .c(x31), .O(new_n124_));
  inv1   g073(.a(new_n86_), .O(new_n125_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n124_), .c(new_n52_), .d(x16), .O(z12));
  nand2  g079(.a(new_n129_), .b(x32), .O(new_n131_));
  nor2   g080(.a(x32), .b(x31), .O(new_n132_));
  nand4  g081(.a(new_n132_), .b(new_n119_), .c(new_n110_), .d(new_n118_), .O(new_n133_));
  or2    g082(.a(new_n133_), .b(new_n86_), .O(new_n134_));
  nand4  g083(.a(new_n134_), .b(new_n131_), .c(new_n52_), .d(x16), .O(z13));
  oai21  g084(.a(new_n133_), .b(new_n86_), .c(x33), .O(new_n136_));
  nor2   g085(.a(x33), .b(x32), .O(new_n137_));
  nand4  g086(.a(new_n137_), .b(new_n128_), .c(new_n127_), .d(new_n104_), .O(new_n138_));
  ...
  oai21  g092(.a(new_n138_), .b(new_n90_), .c(x34), .O(new_n144_));
  nand2  g093(.a(new_n127_), .b(new_n104_), .O(new_n145_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n146_), .c(new_n98_), .O(new_n155_));
