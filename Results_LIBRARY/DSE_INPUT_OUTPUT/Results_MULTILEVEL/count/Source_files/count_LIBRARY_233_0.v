...
module FAU ( 
  ...
  oai21  g07(.a(x16), .b(x14), .c(new_n58_), .O(new_n59_));
  nand2  g08(.a(new_n59_), .b(x20), .O(new_n60_));
  nand2  g09(.a(new_n60_), .b(new_n52_), .O(z01));
  nor2   g10(.a(x16), .b(x13), .O(new_n62_));
  and2   g11(.a(x21), .b(x16), .O(new_n63_));
  oai21  g12(.a(new_n63_), .b(new_n62_), .c(x20), .O(new_n64_));
  nand2  g13(.a(new_n64_), .b(new_n52_), .O(z02));
  nor2   g14(.a(x16), .b(x12), .O(new_n66_));
  and2   g15(.a(x22), .b(x16), .O(new_n67_));
  oai21  g16(.a(new_n67_), .b(new_n66_), .c(x20), .O(new_n68_));
  nand2  g17(.a(new_n68_), .b(new_n52_), .O(z03));
  nor2   g18(.a(new_n53_), .b(x18), .O(new_n70_));
  ...
  nand2  g30(.a(new_n73_), .b(new_n81_), .O(new_n82_));
  nand3  g31(.a(new_n82_), .b(new_n80_), .c(new_n70_), .O(z06));
  nor2   g32(.a(x16), .b(x08), .O(new_n84_));
  and2   g33(.a(x26), .b(x16), .O(new_n85_));
  oai21  g34(.a(new_n85_), .b(new_n84_), .c(x20), .O(new_n86_));
