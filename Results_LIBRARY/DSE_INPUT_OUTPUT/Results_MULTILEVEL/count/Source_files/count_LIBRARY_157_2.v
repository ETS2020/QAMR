...
module FAU ( 
  ...
  nand2  g001(.a(new_n52_), .b(x30), .O(new_n53_));
  ...
  aoi22  g038(.a(new_n89_), .b(new_n80_), .c(new_n82_), .d(x22), .O(new_n90_));
  nor2   g039(.a(x16), .b(x12), .O(new_n91_));
  nor2   g040(.a(new_n91_), .b(new_n86_), .O(new_n92_));
  oai21  g041(.a(new_n90_), .b(new_n56_), .c(new_n92_), .O(z03));
  nand2  g042(.a(new_n89_), .b(new_n80_), .O(new_n94_));
  inv1   g043(.a(x21), .O(new_n95_));
  nor2   g044(.a(x23), .b(x22), .O(new_n96_));
  nand4  g045(.a(new_n96_), .b(new_n78_), .c(new_n95_), .d(new_n58_), .O(new_n97_));
  inv1   g046(.a(new_n97_), .O(new_n98_));
  aoi21  g047(.a(new_n94_), .b(x23), .c(new_n98_), .O(new_n99_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n104_), .c(new_n78_), .d(new_n58_), .O(new_n106_));
  oai21  g055(.a(new_n98_), .b(new_n103_), .c(new_n106_), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(x16), .O(new_n108_));
  inv1   g057(.a(x10), .O(new_n109_));
  aoi21  g058(.a(new_n56_), .b(new_n109_), .c(x18), .O(new_n110_));
  aoi21  g059(.a(new_n110_), .b(new_n108_), .c(new_n54_), .O(z05));
  ...
  nand4  g064(.a(new_n115_), .b(new_n103_), .c(new_n114_), .d(new_n113_), .O(new_n116_));
  ...
  nand3  g074(.a(new_n125_), .b(new_n96_), .c(new_n83_), .O(new_n126_));
  ...
  nand4  g090(.a(new_n141_), .b(new_n140_), .c(new_n89_), .d(new_n80_), .O(new_n142_));
  ...
  aoi22  g102(.a(new_n153_), .b(new_n98_), .c(new_n142_), .d(x29), .O(new_n154_));
  nor2   g103(.a(x16), .b(x05), .O(new_n155_));
  nor2   g104(.a(new_n155_), .b(new_n86_), .O(new_n156_));
  oai21  g105(.a(new_n154_), .b(new_n56_), .c(new_n156_), .O(z10));
  inv1   g106(.a(x30), .O(new_n158_));
  aoi21  g107(.a(new_n153_), .b(new_n98_), .c(new_n158_), .O(new_n159_));
  inv1   g108(.a(x29), .O(new_n160_));
  nor2   g109(.a(x28), .b(x27), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n125_), .c(new_n158_), .d(new_n160_), .O(new_n162_));
  ...
  oai21  g117(.a(new_n168_), .b(new_n56_), .c(x34), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(x30), .O(new_n170_));
  aoi21  g119(.a(new_n153_), .b(new_n98_), .c(new_n168_), .O(new_n171_));
  nand4  g120(.a(new_n151_), .b(new_n132_), .c(new_n168_), .d(new_n158_), .O(new_n172_));
  nor2   g121(.a(new_n172_), .b(new_n106_), .O(new_n173_));
  ...
  nand3  g125(.a(new_n176_), .b(new_n174_), .c(new_n170_), .O(z12));
  nor2   g126(.a(new_n54_), .b(x02), .O(new_n178_));
  nor2   g127(.a(new_n52_), .b(new_n59_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n178_), .c(new_n56_), .O(new_n180_));
  oai21  g129(.a(new_n52_), .b(x32), .c(x30), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(x18), .O(new_n182_));
  nor2   g131(.a(x31), .b(x29), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n161_), .c(new_n148_), .d(new_n103_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n97_), .c(x32), .O(new_n185_));
  nor3   g134(.a(x20), .b(x19), .c(x17), .O(new_n186_));
  nand4  g135(.a(new_n103_), .b(new_n114_), .c(new_n113_), .d(new_n95_), .O(new_n187_));
  inv1   g136(.a(new_n187_), .O(new_n188_));
  inv1   g137(.a(x32), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n168_), .c(new_n160_), .d(new_n139_), .O(new_n190_));
  inv1   g139(.a(new_n190_), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n132_), .c(new_n188_), .d(new_n186_), .O(new_n192_));
  aoi21  g141(.a(new_n192_), .b(new_n185_), .c(x30), .O(new_n193_));
  nand3  g142(.a(x34), .b(x32), .c(x30), .O(new_n194_));
  inv1   g143(.a(new_n194_), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n193_), .c(x16), .O(new_n196_));
  nand3  g145(.a(new_n196_), .b(new_n182_), .c(new_n180_), .O(z13));
  nor2   g146(.a(new_n54_), .b(x01), .O(new_n198_));
  oai21  g147(.a(new_n198_), .b(new_n179_), .c(new_n56_), .O(new_n199_));
  oai21  g148(.a(new_n52_), .b(x33), .c(x30), .O(new_n200_));
  nand2  g149(.a(new_n200_), .b(x18), .O(new_n201_));
  nor2   g150(.a(x27), .b(x26), .O(new_n202_));
  nor2   g151(.a(x32), .b(x31), .O(new_n203_));
  nand4  g152(.a(new_n203_), .b(new_n151_), .c(new_n202_), .d(new_n115_), .O(new_n204_));
  oai21  g153(.a(new_n204_), .b(new_n106_), .c(x33), .O(new_n205_));
  inv1   g154(.a(x26), .O(new_n206_));
  nand4  g155(.a(new_n139_), .b(new_n150_), .c(new_n206_), .d(new_n115_), .O(new_n207_));
  inv1   g156(.a(new_n207_), .O(new_n208_));
  inv1   g157(.a(x33), .O(new_n209_));
  nand4  g158(.a(new_n209_), .b(new_n189_), .c(new_n168_), .d(new_n160_), .O(new_n210_));
  inv1   g159(.a(new_n210_), .O(new_n211_));
  nand4  g160(.a(new_n211_), .b(new_n208_), .c(new_n188_), .d(new_n186_), .O(new_n212_));
  aoi21  g161(.a(new_n212_), .b(new_n205_), .c(x30), .O(new_n213_));
  nand3  g162(.a(x34), .b(x33), .c(x30), .O(new_n214_));
  inv1   g163(.a(new_n214_), .O(new_n215_));
  oai21  g164(.a(new_n215_), .b(new_n213_), .c(x16), .O(new_n216_));
  nand3  g165(.a(new_n216_), .b(new_n201_), .c(new_n199_), .O(z14));
  oai21  g166(.a(new_n52_), .b(x16), .c(x30), .O(new_n218_));
  nand2  g167(.a(new_n212_), .b(x34), .O(new_n219_));
  nand2  g168(.a(new_n151_), .b(new_n202_), .O(new_n220_));
  nand3  g169(.a(new_n203_), .b(new_n52_), .c(new_n209_), .O(new_n221_));
  nor2   g170(.a(new_n221_), .b(new_n220_), .O(new_n222_));
  nand3  g171(.a(new_n222_), .b(new_n117_), .c(new_n83_), .O(new_n223_));
  nand2  g172(.a(new_n223_), .b(new_n219_), .O(new_n224_));
  nand2  g173(.a(new_n224_), .b(x16), .O(new_n225_));
  inv1   g174(.a(x00), .O(new_n226_));
  aoi21  g175(.a(new_n56_), .b(new_n226_), .c(x18), .O(new_n227_));
  nand3  g176(.a(new_n227_), .b(new_n225_), .c(new_n218_), .O(z15));
endmodule
