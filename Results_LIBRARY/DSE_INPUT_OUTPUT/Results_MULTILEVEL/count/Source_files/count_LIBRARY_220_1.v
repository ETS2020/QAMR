...
module FAU ( 
  ...
  nand2  g006(.a(x18), .b(x08), .O(new_n58_));
  ...
  nand4  g044(.a(new_n95_), .b(new_n94_), .c(new_n86_), .d(new_n63_), .O(new_n96_));
  aoi21  g045(.a(new_n96_), .b(new_n93_), .c(new_n61_), .O(new_n97_));
  nor2   g046(.a(x16), .b(x10), .O(new_n98_));
  oai21  g047(.a(new_n98_), .b(new_n97_), .c(new_n60_), .O(new_n99_));
  nand2  g048(.a(new_n99_), .b(new_n58_), .O(z05));
  nand2  g049(.a(new_n96_), .b(x25), .O(new_n101_));
  nor2   g050(.a(x21), .b(x20), .O(new_n102_));
  nor2   g051(.a(x25), .b(x24), .O(new_n103_));
  nand4  g052(.a(new_n103_), .b(new_n87_), .c(new_n102_), .d(new_n53_), .O(new_n104_));
  ...
  nand3  g059(.a(new_n110_), .b(new_n87_), .c(new_n73_), .O(new_n111_));
  ...
  nand2  g081(.a(new_n132_), .b(new_n58_), .O(z09));
  nand2  g082(.a(new_n129_), .b(x29), .O(new_n134_));
  inv1   g083(.a(x27), .O(new_n135_));
  inv1   g084(.a(x22), .O(new_n136_));
  inv1   g085(.a(x23), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n136_), .c(new_n71_), .O(new_n138_));
  nor2   g087(.a(new_n138_), .b(new_n66_), .O(new_n139_));
  nor2   g088(.a(x29), .b(x28), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n110_), .c(new_n139_), .d(new_n135_), .O(new_n141_));
  aoi21  g090(.a(new_n141_), .b(new_n134_), .c(new_n61_), .O(new_n142_));
  nor2   g091(.a(x16), .b(x05), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(new_n142_), .c(new_n60_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n58_), .O(z10));
  nand4  g094(.a(new_n140_), .b(new_n117_), .c(new_n135_), .d(new_n116_), .O(new_n146_));
  oai21  g095(.a(new_n146_), .b(new_n88_), .c(x30), .O(new_n147_));
  nor2   g096(.a(x28), .b(x27), .O(new_n148_));
  nor2   g097(.a(x30), .b(x29), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n148_), .c(new_n110_), .d(new_n139_), .O(new_n150_));
  aoi21  g099(.a(new_n150_), .b(new_n147_), .c(new_n61_), .O(new_n151_));
  nor2   g100(.a(x16), .b(x04), .O(new_n152_));
  oai21  g101(.a(new_n152_), .b(new_n151_), .c(new_n60_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(new_n58_), .O(z11));
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n117_), .d(new_n116_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n88_), .c(x31), .O(new_n156_));
  inv1   g105(.a(new_n66_), .O(new_n157_));
  ...
  nand4  g111(.a(new_n162_), .b(new_n120_), .c(new_n159_), .d(new_n157_), .O(new_n163_));
  aoi21  g112(.a(new_n163_), .b(new_n156_), .c(new_n61_), .O(new_n164_));
  nor2   g113(.a(x16), .b(x03), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n164_), .c(new_n60_), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(new_n58_), .O(z12));
  inv1   g116(.a(x25), .O(new_n168_));
  nor2   g117(.a(x27), .b(x26), .O(new_n169_));
  nand4  g118(.a(new_n160_), .b(new_n140_), .c(new_n169_), .d(new_n168_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n96_), .c(x32), .O(new_n171_));
  nand2  g120(.a(new_n148_), .b(new_n117_), .O(new_n172_));
  inv1   g121(.a(new_n172_), .O(new_n173_));
  inv1   g122(.a(x31), .O(new_n174_));
  inv1   g123(.a(x32), .O(new_n175_));
  nand3  g124(.a(new_n149_), .b(new_n175_), .c(new_n174_), .O(new_n176_));
  inv1   g125(.a(new_n176_), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n173_), .c(new_n159_), .d(new_n157_), .O(new_n178_));
  aoi21  g127(.a(new_n178_), .b(new_n171_), .c(new_n61_), .O(new_n179_));
  nor2   g128(.a(x16), .b(x02), .O(new_n180_));
  oai21  g129(.a(new_n180_), .b(new_n179_), .c(new_n60_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n58_), .O(z13));
  nand2  g131(.a(new_n178_), .b(x33), .O(new_n183_));
  nor2   g132(.a(x33), .b(x32), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n160_), .c(new_n140_), .d(new_n169_), .O(new_n185_));
  or2    g134(.a(new_n185_), .b(new_n104_), .O(new_n186_));
  ...
  oai21  g140(.a(new_n185_), .b(new_n104_), .c(x34), .O(new_n192_));
  nand4  g141(.a(new_n168_), .b(new_n116_), .c(new_n137_), .d(new_n136_), .O(new_n193_));
  nor2   g142(.a(new_n193_), .b(new_n72_), .O(new_n194_));
  nand2  g143(.a(new_n140_), .b(new_n169_), .O(new_n195_));
  inv1   g144(.a(new_n195_), .O(new_n196_));
  inv1   g145(.a(x30), .O(new_n197_));
  nand2  g146(.a(new_n174_), .b(new_n197_), .O(new_n198_));
  inv1   g147(.a(x33), .O(new_n199_));
  inv1   g148(.a(x34), .O(new_n200_));
  nand3  g149(.a(new_n200_), .b(new_n199_), .c(new_n175_), .O(new_n201_));
  nor2   g150(.a(new_n201_), .b(new_n198_), .O(new_n202_));
  nand3  g151(.a(new_n202_), .b(new_n196_), .c(new_n194_), .O(new_n203_));
