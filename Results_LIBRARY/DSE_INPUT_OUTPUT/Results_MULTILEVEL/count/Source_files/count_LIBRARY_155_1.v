...
module FAU ( 
  ...
  nand4  g052(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n58_), .O(new_n104_));
  nand2  g053(.a(new_n104_), .b(new_n92_), .O(new_n105_));
  ...
  nand3  g058(.a(new_n109_), .b(new_n102_), .c(new_n70_), .O(new_n110_));
  nand3  g059(.a(new_n110_), .b(new_n108_), .c(new_n92_), .O(new_n111_));
  ...
  oai21  g071(.a(new_n120_), .b(new_n65_), .c(new_n122_), .O(z08));
  ...
  nand4  g075(.a(new_n126_), .b(new_n125_), .c(new_n75_), .d(new_n58_), .O(new_n127_));
  nand3  g076(.a(new_n127_), .b(new_n124_), .c(new_n92_), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(x16), .O(new_n129_));
  oai21  g078(.a(new_n55_), .b(x06), .c(new_n129_), .O(z09));
  nand2  g079(.a(new_n127_), .b(x29), .O(new_n131_));
  inv1   g080(.a(x27), .O(new_n132_));
  nor2   g081(.a(x29), .b(x28), .O(new_n133_));
  nand4  g082(.a(new_n133_), .b(new_n109_), .c(new_n85_), .d(new_n132_), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n131_), .c(new_n92_), .O(new_n135_));
  ...
  nand4  g088(.a(new_n102_), .b(new_n93_), .c(new_n68_), .d(new_n59_), .O(new_n140_));
  nor2   g089(.a(x26), .b(x25), .O(new_n141_));
  nand4  g090(.a(new_n133_), .b(new_n141_), .c(new_n132_), .d(new_n90_), .O(new_n142_));
  oai21  g091(.a(new_n142_), .b(new_n140_), .c(x30), .O(new_n143_));
  nor2   g092(.a(x28), .b(x27), .O(new_n144_));
  nor2   g093(.a(x30), .b(x29), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n144_), .c(new_n109_), .d(new_n85_), .O(new_n146_));
  nand3  g095(.a(new_n146_), .b(new_n143_), .c(new_n92_), .O(new_n147_));
  ...
  nand4  g100(.a(new_n145_), .b(new_n144_), .c(new_n141_), .d(new_n90_), .O(new_n152_));
  oai21  g101(.a(new_n152_), .b(new_n140_), .c(x31), .O(new_n153_));
  inv1   g102(.a(new_n95_), .O(new_n154_));
  nor3   g103(.a(x27), .b(x26), .c(x25), .O(new_n155_));
  nor2   g104(.a(x31), .b(x30), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n133_), .O(new_n157_));
  ...
  nand4  g113(.a(new_n156_), .b(new_n133_), .c(new_n117_), .d(new_n116_), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n95_), .c(x32), .O(new_n166_));
  nor2   g115(.a(x32), .b(x31), .O(new_n167_));
  nand4  g116(.a(new_n167_), .b(new_n145_), .c(new_n144_), .d(new_n141_), .O(new_n168_));
  ...
  aoi21  g122(.a(new_n65_), .b(new_n173_), .c(x18), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n172_), .O(z13));
  inv1   g124(.a(x33), .O(new_n176_));
  aoi21  g125(.a(new_n169_), .b(new_n154_), .c(new_n176_), .O(new_n177_));
  nor2   g126(.a(x33), .b(x32), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n156_), .c(new_n133_), .d(new_n117_), .O(new_n179_));
  ...
  aoi21  g131(.a(new_n65_), .b(new_n182_), .c(x18), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(new_n181_), .O(z14));
  oai21  g133(.a(new_n179_), .b(new_n104_), .c(x34), .O(new_n185_));
  nand4  g134(.a(new_n116_), .b(new_n90_), .c(new_n83_), .d(new_n82_), .O(new_n186_));
  nor2   g135(.a(new_n186_), .b(new_n69_), .O(new_n187_));
  nand2  g136(.a(new_n133_), .b(new_n117_), .O(new_n188_));
  ...
  nand3  g143(.a(new_n194_), .b(new_n176_), .c(new_n193_), .O(new_n195_));
  nor2   g144(.a(new_n195_), .b(new_n192_), .O(new_n196_));
  nand3  g145(.a(new_n196_), .b(new_n189_), .c(new_n187_), .O(new_n197_));
  nand3  g146(.a(new_n197_), .b(new_n185_), .c(new_n92_), .O(new_n198_));
