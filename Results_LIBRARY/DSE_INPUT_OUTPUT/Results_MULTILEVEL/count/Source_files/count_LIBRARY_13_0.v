...
module FAU ( 
  ...
  aoi22  g014(.a(new_n65_), .b(new_n56_), .c(new_n64_), .d(x21), .O(new_n66_));
  oai21  g015(.a(new_n66_), .b(new_n63_), .c(new_n52_), .O(z02));
  nand2  g016(.a(new_n65_), .b(new_n56_), .O(new_n68_));
  nor3   g017(.a(x22), .b(x21), .c(x20), .O(new_n69_));
  aoi22  g018(.a(new_n69_), .b(new_n56_), .c(new_n68_), .d(x22), .O(new_n70_));
  ...
  nand4  g024(.a(new_n56_), .b(new_n75_), .c(new_n74_), .d(new_n73_), .O(new_n76_));
  nor3   g025(.a(x23), .b(x22), .c(x21), .O(new_n77_));
  aoi22  g026(.a(new_n77_), .b(new_n72_), .c(new_n76_), .d(x23), .O(new_n78_));
  oai21  g027(.a(new_n78_), .b(new_n63_), .c(new_n52_), .O(z04));
  inv1   g028(.a(x24), .O(new_n80_));
  aoi21  g029(.a(new_n77_), .b(new_n72_), .c(new_n80_), .O(new_n81_));
  inv1   g030(.a(x23), .O(new_n82_));
  nand4  g031(.a(new_n80_), .b(new_n82_), .c(new_n75_), .d(new_n74_), .O(new_n83_));
  ...
  oai21  g035(.a(new_n83_), .b(new_n64_), .c(x25), .O(new_n87_));
  inv1   g036(.a(x25), .O(new_n88_));
  nor2   g037(.a(x23), .b(x22), .O(new_n89_));
  nand3  g038(.a(new_n89_), .b(new_n88_), .c(new_n80_), .O(new_n90_));
  nor2   g039(.a(new_n90_), .b(new_n68_), .O(new_n91_));
  nor2   g040(.a(new_n91_), .b(x18), .O(new_n92_));
  nand3  g041(.a(new_n92_), .b(new_n87_), .c(x16), .O(z06));
  inv1   g042(.a(x26), .O(new_n94_));
  nor3   g043(.a(x26), .b(x25), .c(x24), .O(new_n95_));
  nand4  g044(.a(new_n95_), .b(new_n89_), .c(new_n65_), .d(new_n56_), .O(new_n96_));
  oai21  g045(.a(new_n91_), .b(new_n94_), .c(new_n96_), .O(new_n97_));
  nand2  g046(.a(new_n97_), .b(x16), .O(new_n98_));
  nand2  g047(.a(new_n98_), .b(new_n52_), .O(z07));
  nor2   g048(.a(x27), .b(x26), .O(new_n100_));
  nand4  g049(.a(new_n100_), .b(new_n88_), .c(new_n80_), .d(new_n82_), .O(new_n101_));
  nor2   g050(.a(new_n101_), .b(new_n76_), .O(new_n102_));
  aoi21  g051(.a(new_n96_), .b(x27), .c(new_n102_), .O(new_n103_));
  oai21  g052(.a(new_n103_), .b(new_n63_), .c(new_n52_), .O(z08));
  oai21  g053(.a(new_n101_), .b(new_n76_), .c(x28), .O(new_n105_));
  nor3   g054(.a(x25), .b(x24), .c(x23), .O(new_n106_));
  nor3   g055(.a(x28), .b(x27), .c(x26), .O(new_n107_));
  nand4  g056(.a(new_n107_), .b(new_n106_), .c(new_n69_), .d(new_n56_), .O(new_n108_));
  nand4  g057(.a(new_n108_), .b(new_n105_), .c(new_n52_), .d(x16), .O(z09));
  nand4  g058(.a(new_n89_), .b(new_n60_), .c(new_n74_), .d(new_n53_), .O(new_n110_));
  inv1   g059(.a(x27), .O(new_n111_));
  nor2   g060(.a(x26), .b(x25), .O(new_n112_));
  nor2   g061(.a(x29), .b(x28), .O(new_n113_));
  nand4  g062(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(new_n80_), .O(new_n114_));
  nor2   g063(.a(new_n114_), .b(new_n110_), .O(new_n115_));
  aoi21  g064(.a(new_n108_), .b(x29), .c(new_n115_), .O(new_n116_));
  oai21  g065(.a(new_n116_), .b(new_n63_), .c(new_n52_), .O(z10));
  nor3   g066(.a(x29), .b(x28), .c(x27), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n95_), .c(new_n77_), .d(new_n72_), .O(new_n119_));
  nor2   g068(.a(x28), .b(x27), .O(new_n120_));
  nor2   g069(.a(x30), .b(x29), .O(new_n121_));
  nand4  g070(.a(new_n121_), .b(new_n120_), .c(new_n112_), .d(new_n80_), .O(new_n122_));
  nor2   g071(.a(new_n122_), .b(new_n110_), .O(new_n123_));
  aoi21  g072(.a(new_n119_), .b(x30), .c(new_n123_), .O(new_n124_));
  oai21  g073(.a(new_n124_), .b(new_n63_), .c(new_n52_), .O(z11));
  oai21  g074(.a(new_n122_), .b(new_n110_), .c(x31), .O(new_n126_));
  inv1   g075(.a(new_n83_), .O(new_n127_));
  ...
  nand4  g083(.a(new_n134_), .b(new_n128_), .c(new_n127_), .d(new_n72_), .O(new_n135_));
  ...
  nand3  g089(.a(new_n121_), .b(new_n140_), .c(new_n132_), .O(new_n141_));
  inv1   g090(.a(new_n141_), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n120_), .c(new_n112_), .d(new_n84_), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n139_), .c(new_n52_), .d(x16), .O(z13));
  nand2  g093(.a(new_n143_), .b(x33), .O(new_n145_));
  nand2  g094(.a(new_n113_), .b(new_n100_), .O(new_n146_));
  nor2   g095(.a(x31), .b(x30), .O(new_n147_));
  nor2   g096(.a(x33), .b(x32), .O(new_n148_));
  ...
  nand4  g100(.a(new_n151_), .b(new_n145_), .c(new_n52_), .d(x16), .O(z14));
  nand2  g101(.a(new_n151_), .b(x34), .O(new_n153_));
  inv1   g102(.a(new_n146_), .O(new_n154_));
  nor3   g103(.a(x34), .b(x33), .c(x32), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n154_), .c(new_n147_), .d(new_n91_), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n153_), .c(new_n52_), .d(x16), .O(z15));
endmodule
