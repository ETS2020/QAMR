...
module FAU ( 
  ...
  oai21  g023(.a(new_n74_), .b(new_n68_), .c(new_n57_), .O(z02));
  ...
  aoi21  g027(.a(new_n78_), .b(new_n76_), .c(new_n56_), .O(new_n79_));
  ...
  nand3  g033(.a(new_n84_), .b(new_n63_), .c(new_n69_), .O(new_n85_));
  ...
  nand2  g041(.a(new_n84_), .b(new_n69_), .O(new_n93_));
  oai21  g042(.a(new_n93_), .b(new_n92_), .c(x24), .O(new_n94_));
  nor2   g043(.a(x24), .b(x23), .O(new_n95_));
  nand4  g044(.a(new_n95_), .b(new_n77_), .c(new_n91_), .d(new_n90_), .O(new_n96_));
  ...
  or2    g062(.a(new_n113_), .b(new_n111_), .O(z07));
