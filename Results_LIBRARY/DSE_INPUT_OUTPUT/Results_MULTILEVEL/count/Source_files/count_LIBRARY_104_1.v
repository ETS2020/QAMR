...
module FAU ( 
  ...
  nand4  g053(.a(new_n104_), .b(new_n85_), .c(new_n103_), .d(new_n54_), .O(new_n105_));
  ...
  nand3  g059(.a(new_n110_), .b(new_n85_), .c(new_n72_), .O(new_n111_));
  ...
  nand3  g067(.a(new_n118_), .b(new_n96_), .c(new_n117_), .O(new_n119_));
  ...
  aoi21  g071(.a(new_n69_), .b(new_n122_), .c(x18), .O(new_n123_));
  oai21  g072(.a(new_n121_), .b(new_n69_), .c(new_n123_), .O(z08));
  ...
  nand4  g085(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n90_), .O(new_n137_));
  ...
  nand3  g092(.a(new_n143_), .b(new_n110_), .c(new_n94_), .O(new_n144_));
  nor2   g093(.a(x28), .b(x27), .O(new_n145_));
  nor2   g094(.a(x30), .b(x29), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n145_), .c(new_n135_), .d(new_n90_), .O(new_n147_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n110_), .c(new_n94_), .O(new_n155_));
  nor2   g104(.a(x31), .b(x30), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n136_), .c(new_n118_), .d(new_n117_), .O(new_n157_));
  oai21  g106(.a(new_n157_), .b(new_n97_), .c(new_n52_), .O(new_n158_));
  ...
  oai21  g111(.a(new_n157_), .b(new_n97_), .c(x32), .O(new_n163_));
  inv1   g112(.a(new_n97_), .O(new_n164_));
  nor2   g113(.a(x32), .b(x31), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n146_), .c(new_n145_), .d(new_n135_), .O(new_n166_));
  ...
  aoi21  g123(.a(new_n167_), .b(new_n164_), .c(new_n174_), .O(new_n175_));
  nor2   g124(.a(x33), .b(x32), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n156_), .c(new_n136_), .d(new_n118_), .O(new_n177_));
  nor2   g126(.a(new_n177_), .b(new_n105_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n175_), .c(x16), .O(new_n179_));
  inv1   g128(.a(x01), .O(new_n180_));
  aoi21  g129(.a(new_n69_), .b(new_n180_), .c(x18), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n179_), .O(z14));
  oai21  g131(.a(new_n177_), .b(new_n105_), .c(x34), .O(new_n183_));
  nand4  g132(.a(new_n117_), .b(new_n90_), .c(new_n92_), .d(new_n91_), .O(new_n184_));
  nor2   g133(.a(new_n184_), .b(new_n71_), .O(new_n185_));
  nand2  g134(.a(new_n136_), .b(new_n118_), .O(new_n186_));
  ...
  nand3  g141(.a(new_n192_), .b(new_n174_), .c(new_n191_), .O(new_n193_));
  nor2   g142(.a(new_n193_), .b(new_n190_), .O(new_n194_));
  nand3  g143(.a(new_n194_), .b(new_n187_), .c(new_n185_), .O(new_n195_));
  nand3  g144(.a(new_n195_), .b(new_n183_), .c(new_n52_), .O(new_n196_));
