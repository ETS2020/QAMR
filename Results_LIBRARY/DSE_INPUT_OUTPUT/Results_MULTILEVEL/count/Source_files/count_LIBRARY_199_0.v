...
module FAU ( 
  ...
  oai21  g017(.a(new_n68_), .b(new_n67_), .c(x29), .O(new_n69_));
  ...
  nand2  g030(.a(x29), .b(new_n52_), .O(new_n82_));
  ...
  nand3  g037(.a(new_n88_), .b(new_n72_), .c(new_n71_), .O(new_n89_));
  aoi21  g038(.a(new_n89_), .b(new_n87_), .c(new_n61_), .O(new_n90_));
  nor2   g039(.a(x16), .b(x11), .O(new_n91_));
  oai21  g040(.a(new_n91_), .b(new_n90_), .c(x29), .O(new_n92_));
  ...
  oai21  g045(.a(new_n96_), .b(new_n66_), .c(x24), .O(new_n97_));
  nor2   g046(.a(x20), .b(x19), .O(new_n98_));
  nor2   g047(.a(x24), .b(x23), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n85_), .c(new_n98_), .d(new_n63_), .O(new_n100_));
  aoi21  g049(.a(new_n100_), .b(new_n97_), .c(new_n61_), .O(new_n101_));
  nor2   g050(.a(x16), .b(x10), .O(new_n102_));
  oai21  g051(.a(new_n102_), .b(new_n101_), .c(x29), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(new_n52_), .O(z05));
  nand2  g053(.a(new_n100_), .b(x25), .O(new_n105_));
  nor2   g054(.a(x25), .b(x24), .O(new_n106_));
  nand4  g055(.a(new_n106_), .b(new_n88_), .c(new_n73_), .d(new_n55_), .O(new_n107_));
  aoi21  g056(.a(new_n107_), .b(new_n105_), .c(new_n61_), .O(new_n108_));
  nor2   g057(.a(x16), .b(x09), .O(new_n109_));
  oai21  g058(.a(new_n109_), .b(new_n108_), .c(x29), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(new_n52_), .O(z06));
  nand2  g060(.a(new_n107_), .b(x26), .O(new_n112_));
  nor3   g061(.a(x26), .b(x25), .c(x24), .O(new_n113_));
  nand4  g062(.a(new_n113_), .b(new_n88_), .c(new_n73_), .d(new_n55_), .O(new_n114_));
  aoi21  g063(.a(new_n114_), .b(new_n112_), .c(new_n61_), .O(new_n115_));
  inv1   g064(.a(new_n82_), .O(new_n116_));
  oai21  g065(.a(x16), .b(x08), .c(new_n116_), .O(new_n117_));
  or2    g066(.a(new_n117_), .b(new_n115_), .O(z07));
  inv1   g067(.a(x25), .O(new_n119_));
  nor2   g068(.a(x27), .b(x26), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n99_), .c(new_n119_), .O(new_n121_));
  ...
  aoi21  g085(.a(new_n130_), .b(x16), .c(new_n136_), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n53_), .c(new_n52_), .O(z10));
  nand2  g087(.a(x30), .b(x16), .O(new_n139_));
  inv1   g088(.a(x04), .O(new_n140_));
  nand2  g089(.a(new_n61_), .b(new_n140_), .O(new_n141_));
  nand3  g090(.a(new_n141_), .b(new_n139_), .c(new_n116_), .O(z11));
  nor2   g091(.a(x16), .b(x03), .O(new_n143_));
  and2   g092(.a(x31), .b(x16), .O(new_n144_));
  oai21  g093(.a(new_n144_), .b(new_n143_), .c(x29), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n52_), .O(z12));
  nor2   g095(.a(x16), .b(x02), .O(new_n147_));
  and2   g096(.a(x32), .b(x16), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n147_), .c(x29), .O(new_n149_));
  ...
  nand3  g102(.a(new_n153_), .b(new_n151_), .c(new_n116_), .O(z14));
  nor2   g103(.a(x16), .b(x00), .O(new_n155_));
  and2   g104(.a(x34), .b(x16), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n155_), .c(x29), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n52_), .O(z15));
endmodule
