...
module FAU ( 
  ...
  nand3  g022(.a(new_n73_), .b(new_n56_), .c(new_n65_), .O(new_n74_));
  ...
  nand4  g045(.a(new_n87_), .b(new_n80_), .c(new_n96_), .d(new_n95_), .O(new_n97_));
  nor2   g046(.a(new_n97_), .b(new_n67_), .O(new_n98_));
  nor3   g047(.a(x26), .b(x25), .c(x24), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n75_), .c(new_n88_), .d(new_n56_), .O(new_n100_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n82_), .c(new_n70_), .d(new_n56_), .O(new_n106_));
  nand4  g055(.a(new_n106_), .b(new_n104_), .c(new_n52_), .d(x16), .O(z08));
  nor2   g056(.a(x28), .b(x27), .O(new_n108_));
  nand4  g057(.a(new_n108_), .b(new_n89_), .c(new_n94_), .d(new_n96_), .O(new_n109_));
  nor2   g058(.a(new_n109_), .b(new_n74_), .O(new_n110_));
  aoi21  g059(.a(new_n106_), .b(x28), .c(new_n110_), .O(new_n111_));
  oai21  g060(.a(new_n111_), .b(new_n69_), .c(new_n52_), .O(z09));
  oai21  g061(.a(new_n109_), .b(new_n74_), .c(x29), .O(new_n113_));
  ...
  nand4  g070(.a(new_n121_), .b(new_n108_), .c(new_n120_), .d(new_n80_), .O(new_n122_));
  ...
  nand4  g079(.a(new_n130_), .b(new_n105_), .c(new_n127_), .d(new_n126_), .O(new_n131_));
  ...
  nand4  g088(.a(new_n139_), .b(new_n108_), .c(new_n120_), .d(new_n84_), .O(new_n140_));
  ...
  nand4  g093(.a(new_n144_), .b(new_n128_), .c(new_n115_), .d(new_n143_), .O(new_n145_));
  or2    g094(.a(new_n145_), .b(new_n90_), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n142_), .c(new_n52_), .d(x16), .O(z14));
  oai21  g096(.a(new_n145_), .b(new_n90_), .c(x34), .O(new_n148_));
  nand2  g097(.a(new_n115_), .b(new_n143_), .O(new_n149_));
  ...
  nand3  g105(.a(new_n156_), .b(new_n150_), .c(new_n98_), .O(new_n157_));
