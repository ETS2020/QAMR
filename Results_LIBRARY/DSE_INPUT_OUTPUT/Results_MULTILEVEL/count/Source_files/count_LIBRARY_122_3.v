...
module FAU ( 
  ...
  oai21  g017(.a(new_n68_), .b(new_n67_), .c(new_n61_), .O(new_n69_));
  nand2  g018(.a(new_n69_), .b(new_n59_), .O(z01));
  nor2   g019(.a(x21), .b(x20), .O(new_n71_));
  aoi22  g020(.a(new_n71_), .b(new_n53_), .c(new_n66_), .d(x21), .O(new_n72_));
  inv1   g021(.a(x13), .O(new_n73_));
  aoi21  g022(.a(new_n62_), .b(new_n73_), .c(x18), .O(new_n74_));
  oai21  g023(.a(new_n72_), .b(new_n62_), .c(new_n74_), .O(z02));
  nand2  g024(.a(new_n71_), .b(new_n53_), .O(new_n76_));
  nor3   g025(.a(x22), .b(x21), .c(x20), .O(new_n77_));
  aoi22  g026(.a(new_n77_), .b(new_n53_), .c(new_n76_), .d(x22), .O(new_n78_));
  ...
  nor3   g034(.a(x20), .b(x19), .c(x17), .O(new_n86_));
  nor3   g035(.a(x23), .b(x22), .c(x21), .O(new_n87_));
  nand2  g036(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  aoi21  g037(.a(new_n88_), .b(new_n85_), .c(new_n62_), .O(new_n89_));
  nor2   g038(.a(x16), .b(x11), .O(new_n90_));
  oai21  g039(.a(new_n90_), .b(new_n89_), .c(new_n61_), .O(new_n91_));
  nand2  g040(.a(new_n91_), .b(new_n59_), .O(z04));
  inv1   g041(.a(x24), .O(new_n93_));
  aoi21  g042(.a(new_n87_), .b(new_n86_), .c(new_n93_), .O(new_n94_));
  nand3  g043(.a(new_n65_), .b(new_n61_), .c(new_n64_), .O(new_n95_));
  ...
  aoi21  g049(.a(new_n62_), .b(new_n100_), .c(x18), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(new_n99_), .O(z05));
  nand4  g051(.a(new_n96_), .b(new_n83_), .c(new_n65_), .d(new_n64_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(x25), .O(new_n104_));
  nor2   g053(.a(x23), .b(x22), .O(new_n105_));
  nor2   g054(.a(x25), .b(x24), .O(new_n106_));
  nand4  g055(.a(new_n106_), .b(new_n105_), .c(new_n71_), .d(new_n53_), .O(new_n107_));
  ...
  nand4  g062(.a(new_n113_), .b(new_n105_), .c(new_n71_), .d(new_n53_), .O(new_n114_));
  aoi21  g063(.a(new_n114_), .b(new_n112_), .c(new_n62_), .O(new_n115_));
  nor2   g064(.a(x16), .b(x08), .O(new_n116_));
  oai21  g065(.a(new_n116_), .b(new_n115_), .c(new_n61_), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n59_), .O(z07));
  ...
  nand4  g084(.a(new_n135_), .b(new_n113_), .c(new_n87_), .d(new_n86_), .O(new_n136_));
  inv1   g085(.a(new_n136_), .O(new_n137_));
  aoi21  g086(.a(new_n129_), .b(x29), .c(new_n137_), .O(new_n138_));
  inv1   g087(.a(x05), .O(new_n139_));
  aoi21  g088(.a(new_n62_), .b(new_n139_), .c(x18), .O(new_n140_));
  oai21  g089(.a(new_n138_), .b(new_n62_), .c(new_n140_), .O(z10));
  ...
  nor2   g094(.a(new_n145_), .b(new_n88_), .O(new_n146_));
  ...
  oai21  g098(.a(new_n147_), .b(new_n62_), .c(new_n149_), .O(z11));
  oai21  g099(.a(new_n145_), .b(new_n88_), .c(x31), .O(new_n151_));
  inv1   g100(.a(new_n103_), .O(new_n152_));
  nor2   g101(.a(x29), .b(x28), .O(new_n153_));
  nor2   g102(.a(x31), .b(x30), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  inv1   g104(.a(new_n155_), .O(new_n156_));
  nand3  g105(.a(new_n156_), .b(new_n119_), .c(new_n152_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n151_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(x16), .O(new_n159_));
  inv1   g108(.a(x03), .O(new_n160_));
  aoi21  g109(.a(new_n62_), .b(new_n160_), .c(x18), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n159_), .O(z12));
  nor2   g111(.a(x32), .b(x31), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n164_));
  nor2   g113(.a(new_n164_), .b(new_n103_), .O(new_n165_));
  aoi21  g114(.a(new_n157_), .b(x32), .c(new_n165_), .O(new_n166_));
  inv1   g115(.a(x02), .O(new_n167_));
  aoi21  g116(.a(new_n62_), .b(new_n167_), .c(x18), .O(new_n168_));
  oai21  g117(.a(new_n166_), .b(new_n62_), .c(new_n168_), .O(z13));
  oai21  g118(.a(new_n164_), .b(new_n103_), .c(x33), .O(new_n170_));
  nor2   g119(.a(x27), .b(x26), .O(new_n171_));
  nor2   g120(.a(x33), .b(x32), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n154_), .c(new_n153_), .d(new_n171_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n107_), .c(new_n170_), .O(new_n174_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n96_), .c(new_n83_), .d(new_n65_), .O(new_n180_));
  nor3   g129(.a(x34), .b(x33), .c(x32), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n154_), .c(new_n153_), .d(new_n142_), .O(new_n182_));
  oai21  g131(.a(new_n182_), .b(new_n180_), .c(new_n61_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(new_n58_), .O(new_n184_));
  oai21  g133(.a(new_n173_), .b(new_n107_), .c(x34), .O(new_n185_));
  inv1   g134(.a(x00), .O(new_n186_));
  nand2  g135(.a(new_n62_), .b(new_n186_), .O(new_n187_));
  oai21  g136(.a(new_n185_), .b(new_n62_), .c(new_n187_), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(new_n61_), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(new_n184_), .O(z15));
endmodule
