...
module FAU ( 
  ...
  nand2  g022(.a(x30), .b(x18), .O(new_n74_));
  ...
  nand3  g034(.a(new_n85_), .b(new_n63_), .c(new_n68_), .O(new_n86_));
  ...
  nand2  g038(.a(new_n89_), .b(new_n74_), .O(z04));
  ...
  oai21  g047(.a(new_n98_), .b(new_n97_), .c(new_n76_), .O(new_n99_));
  nand2  g048(.a(new_n99_), .b(new_n74_), .O(z05));
  ...
  aoi21  g052(.a(new_n103_), .b(new_n101_), .c(new_n58_), .O(new_n104_));
  nor2   g053(.a(x16), .b(x09), .O(new_n105_));
  oai21  g054(.a(new_n105_), .b(new_n104_), .c(new_n76_), .O(new_n106_));
  nand2  g055(.a(new_n106_), .b(new_n74_), .O(z06));
  nand4  g056(.a(new_n69_), .b(new_n53_), .c(new_n76_), .d(new_n52_), .O(new_n108_));
  ...
  nand4  g064(.a(new_n109_), .b(new_n85_), .c(new_n69_), .d(new_n55_), .O(new_n116_));
  ...
  oai21  g080(.a(new_n131_), .b(new_n130_), .c(new_n76_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n74_), .O(z09));
  nor2   g082(.a(new_n93_), .b(new_n92_), .O(new_n134_));
  nor3   g083(.a(x29), .b(x28), .c(x27), .O(new_n135_));
  and2   g084(.a(new_n135_), .b(new_n109_), .O(new_n136_));
  aoi22  g085(.a(new_n136_), .b(new_n134_), .c(new_n129_), .d(x29), .O(new_n137_));
  ...
  nand3  g089(.a(new_n135_), .b(new_n109_), .c(new_n134_), .O(new_n141_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n143_), .c(new_n142_), .d(new_n163_), .O(new_n165_));
  or2    g114(.a(new_n165_), .b(new_n96_), .O(new_n166_));
  ...
  oai21  g123(.a(new_n174_), .b(new_n103_), .c(new_n172_), .O(new_n175_));
  ...
  nor2   g129(.a(new_n174_), .b(new_n103_), .O(new_n181_));
  nor2   g130(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand2  g131(.a(new_n153_), .b(new_n118_), .O(new_n183_));
  inv1   g132(.a(x32), .O(new_n184_));
  nor2   g133(.a(x34), .b(x33), .O(new_n185_));
  nand3  g134(.a(new_n185_), .b(new_n154_), .c(new_n184_), .O(new_n186_));
  nor3   g135(.a(new_n186_), .b(new_n183_), .c(new_n103_), .O(new_n187_));
