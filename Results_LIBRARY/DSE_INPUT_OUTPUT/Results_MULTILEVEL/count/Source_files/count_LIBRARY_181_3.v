...
module FAU ( 
  ...
  inv1   g020(.a(new_n64_), .O(new_n72_));
  ...
  aoi21  g059(.a(new_n110_), .b(new_n104_), .c(new_n58_), .O(new_n111_));
  nor2   g060(.a(x16), .b(x09), .O(new_n112_));
  oai21  g061(.a(new_n112_), .b(new_n111_), .c(new_n61_), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(new_n69_), .O(z06));
  oai21  g063(.a(x18), .b(new_n58_), .c(new_n68_), .O(new_n115_));
  inv1   g064(.a(x26), .O(new_n116_));
  nor2   g065(.a(new_n108_), .b(new_n73_), .O(new_n117_));
  nor3   g066(.a(x26), .b(x25), .c(x24), .O(new_n118_));
  nand3  g067(.a(new_n118_), .b(new_n94_), .c(new_n105_), .O(new_n119_));
  ...
  nand3  g101(.a(new_n152_), .b(new_n118_), .c(new_n88_), .O(new_n153_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n149_), .c(new_n140_), .d(new_n106_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n95_), .c(x31), .O(new_n159_));
  nand4  g108(.a(new_n106_), .b(new_n86_), .c(new_n85_), .d(new_n71_), .O(new_n160_));
  inv1   g109(.a(new_n160_), .O(new_n161_));
  inv1   g110(.a(x29), .O(new_n162_));
  inv1   g111(.a(x30), .O(new_n163_));
  inv1   g112(.a(x31), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n163_), .c(new_n162_), .d(new_n130_), .O(new_n165_));
  inv1   g114(.a(new_n165_), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n123_), .c(new_n161_), .d(new_n72_), .O(new_n167_));
  ...
  nand4  g122(.a(new_n173_), .b(new_n150_), .c(new_n149_), .d(new_n140_), .O(new_n174_));
  or2    g123(.a(new_n174_), .b(new_n99_), .O(new_n175_));
  ...
  oai21  g129(.a(new_n174_), .b(new_n99_), .c(x33), .O(new_n181_));
  nand4  g130(.a(new_n162_), .b(new_n130_), .c(new_n139_), .d(new_n116_), .O(new_n182_));
  inv1   g131(.a(new_n182_), .O(new_n183_));
  inv1   g132(.a(x32), .O(new_n184_));
  inv1   g133(.a(x33), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n184_), .c(new_n164_), .d(new_n163_), .O(new_n186_));
  inv1   g135(.a(new_n186_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n183_), .c(new_n109_), .d(new_n105_), .O(new_n188_));
