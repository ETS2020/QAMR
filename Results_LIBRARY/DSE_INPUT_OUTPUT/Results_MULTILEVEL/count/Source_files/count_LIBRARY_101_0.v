...
module FAU ( 
  ...
  nand3  g017(.a(new_n68_), .b(new_n65_), .c(x04), .O(z01));
  ...
  oai21  g023(.a(new_n74_), .b(new_n52_), .c(new_n53_), .O(z02));
  ...
  nor3   g029(.a(new_n80_), .b(x18), .c(new_n52_), .O(new_n81_));
  ...
  nand2  g038(.a(new_n89_), .b(new_n53_), .O(z04));
  inv1   g039(.a(x24), .O(new_n91_));
  nor3   g040(.a(x23), .b(x22), .c(x21), .O(new_n92_));
  aoi21  g041(.a(new_n92_), .b(new_n64_), .c(new_n91_), .O(new_n93_));
  inv1   g042(.a(x22), .O(new_n94_));
  inv1   g043(.a(x23), .O(new_n95_));
  nand4  g044(.a(new_n91_), .b(new_n95_), .c(new_n94_), .d(new_n70_), .O(new_n96_));
  ...
  nand3  g049(.a(new_n100_), .b(new_n98_), .c(x04), .O(z05));
  nor2   g050(.a(x24), .b(x23), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n77_), .c(new_n84_), .d(new_n61_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(x25), .O(new_n104_));
  nor2   g053(.a(x21), .b(x20), .O(new_n105_));
  nor2   g054(.a(x25), .b(x24), .O(new_n106_));
  nand4  g055(.a(new_n106_), .b(new_n85_), .c(new_n105_), .d(new_n59_), .O(new_n107_));
  aoi21  g056(.a(new_n107_), .b(new_n104_), .c(new_n67_), .O(new_n108_));
  nor2   g057(.a(x16), .b(x09), .O(new_n109_));
  oai21  g058(.a(new_n109_), .b(new_n108_), .c(x04), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(new_n53_), .O(z06));
  inv1   g060(.a(x26), .O(new_n112_));
  inv1   g061(.a(x25), .O(new_n113_));
  nand4  g062(.a(new_n113_), .b(new_n91_), .c(new_n95_), .d(new_n94_), .O(new_n114_));
  nor2   g063(.a(new_n114_), .b(new_n71_), .O(new_n115_));
  nor3   g064(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nand4  g065(.a(new_n116_), .b(new_n85_), .c(new_n105_), .d(new_n59_), .O(new_n117_));
  ...
  aoi21  g069(.a(new_n67_), .b(new_n120_), .c(x18), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n119_), .c(x04), .O(z07));
  ...
  nor3   g076(.a(new_n127_), .b(x18), .c(new_n52_), .O(new_n128_));
  oai21  g077(.a(new_n126_), .b(new_n67_), .c(new_n128_), .O(z08));
  inv1   g078(.a(x28), .O(new_n130_));
  nor2   g079(.a(x28), .b(x27), .O(new_n131_));
  nand4  g080(.a(new_n131_), .b(new_n106_), .c(new_n112_), .d(new_n95_), .O(new_n132_));
  oai22  g081(.a(new_n132_), .b(new_n78_), .c(new_n125_), .d(new_n130_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(x16), .O(new_n134_));
  nor2   g083(.a(x16), .b(x06), .O(new_n135_));
  nor3   g084(.a(new_n135_), .b(x18), .c(new_n52_), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(new_n134_), .O(z09));
  oai21  g086(.a(new_n132_), .b(new_n78_), .c(x29), .O(new_n138_));
  nor3   g087(.a(x29), .b(x28), .c(x27), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n116_), .c(new_n92_), .d(new_n64_), .O(new_n140_));
  aoi21  g089(.a(new_n140_), .b(new_n138_), .c(new_n67_), .O(new_n141_));
  nor2   g090(.a(x16), .b(x05), .O(new_n142_));
  oai21  g091(.a(new_n142_), .b(new_n141_), .c(x04), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n53_), .O(z10));
  nor2   g093(.a(x26), .b(x25), .O(new_n145_));
  nor2   g094(.a(x30), .b(x29), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n131_), .c(new_n145_), .d(new_n91_), .O(new_n147_));
  ...
  oai21  g099(.a(new_n149_), .b(new_n67_), .c(new_n150_), .O(z11));
  oai21  g100(.a(new_n147_), .b(new_n86_), .c(x31), .O(new_n152_));
  nor2   g101(.a(x29), .b(x28), .O(new_n153_));
  nor2   g102(.a(x31), .b(x30), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  inv1   g104(.a(new_n155_), .O(new_n156_));
  nand3  g105(.a(new_n156_), .b(new_n123_), .c(new_n97_), .O(new_n157_));
  aoi21  g106(.a(new_n157_), .b(new_n152_), .c(new_n67_), .O(new_n158_));
  nor2   g107(.a(x16), .b(x03), .O(new_n159_));
  oai21  g108(.a(new_n159_), .b(new_n158_), .c(x04), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n53_), .O(z12));
  nor2   g110(.a(x27), .b(x26), .O(new_n162_));
  nand4  g111(.a(new_n154_), .b(new_n153_), .c(new_n162_), .d(new_n113_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n103_), .c(x32), .O(new_n164_));
  nor2   g113(.a(x32), .b(x31), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n146_), .c(new_n131_), .d(new_n145_), .O(new_n166_));
  ...
  oai21  g119(.a(new_n170_), .b(new_n169_), .c(x04), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n53_), .O(z13));
  oai21  g121(.a(new_n166_), .b(new_n103_), .c(x33), .O(new_n173_));
  nor2   g122(.a(x33), .b(x32), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n154_), .c(new_n153_), .d(new_n162_), .O(new_n175_));
  inv1   g124(.a(new_n175_), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(new_n115_), .O(new_n177_));
  aoi21  g126(.a(new_n177_), .b(new_n173_), .c(new_n67_), .O(new_n178_));
  nor2   g127(.a(x16), .b(x01), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n178_), .c(x04), .O(new_n180_));
  nand2  g129(.a(new_n180_), .b(new_n53_), .O(z14));
  oai21  g130(.a(new_n175_), .b(new_n107_), .c(x34), .O(new_n182_));
  ...
  nand3  g141(.a(new_n192_), .b(new_n184_), .c(new_n115_), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n182_), .c(new_n67_), .O(new_n194_));
  nor2   g143(.a(x16), .b(x00), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n194_), .c(x04), .O(new_n196_));
