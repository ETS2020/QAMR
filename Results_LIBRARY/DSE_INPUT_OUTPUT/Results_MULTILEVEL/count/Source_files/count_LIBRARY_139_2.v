...
module FAU ( 
  ...
  oai21  g024(.a(new_n75_), .b(x08), .c(new_n70_), .O(z02));
  ...
  nand2  g031(.a(new_n82_), .b(new_n70_), .O(z03));
  nor2   g032(.a(x20), .b(x19), .O(new_n84_));
  nor2   g033(.a(x23), .b(x22), .O(new_n85_));
  nand4  g034(.a(new_n85_), .b(new_n84_), .c(new_n71_), .d(new_n53_), .O(new_n86_));
  ...
  nand4  g043(.a(new_n94_), .b(new_n93_), .c(new_n84_), .d(new_n53_), .O(new_n95_));
  ...
  nor3   g056(.a(new_n107_), .b(x18), .c(x08), .O(new_n108_));
  oai21  g057(.a(new_n106_), .b(new_n59_), .c(new_n108_), .O(z06));
  nor2   g058(.a(x21), .b(x20), .O(new_n110_));
  nor2   g059(.a(x25), .b(x24), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n85_), .c(new_n110_), .d(new_n56_), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(x26), .O(new_n113_));
  nor2   g062(.a(new_n59_), .b(x08), .O(new_n114_));
  nor2   g063(.a(x17), .b(new_n59_), .O(new_n115_));
  nor2   g064(.a(x26), .b(x25), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n85_), .c(new_n92_), .O(new_n117_));
  inv1   g066(.a(new_n117_), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n115_), .c(new_n110_), .d(new_n54_), .O(new_n119_));
  nand4  g068(.a(new_n119_), .b(new_n114_), .c(new_n113_), .d(new_n70_), .O(z07));
  oai21  g069(.a(new_n117_), .b(new_n72_), .c(x27), .O(new_n121_));
  nor3   g070(.a(x27), .b(x26), .c(x25), .O(new_n122_));
  nand4  g071(.a(new_n122_), .b(new_n94_), .c(new_n78_), .d(new_n56_), .O(new_n123_));
  aoi21  g072(.a(new_n123_), .b(new_n121_), .c(new_n59_), .O(new_n124_));
  nor2   g073(.a(x16), .b(x07), .O(new_n125_));
  oai21  g074(.a(new_n125_), .b(new_n124_), .c(new_n52_), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n70_), .O(z08));
  nand2  g076(.a(new_n123_), .b(x28), .O(new_n128_));
  nor3   g077(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nor3   g078(.a(x28), .b(x27), .c(x26), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n129_), .c(new_n78_), .d(new_n56_), .O(new_n131_));
  ...
  nand2  g084(.a(new_n131_), .b(x29), .O(new_n136_));
  inv1   g085(.a(x27), .O(new_n137_));
  nor3   g086(.a(x26), .b(x25), .c(x24), .O(new_n138_));
  nor2   g087(.a(x29), .b(x28), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n138_), .c(new_n87_), .d(new_n137_), .O(new_n140_));
  and2   g089(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nor2   g090(.a(x16), .b(x05), .O(new_n142_));
  nor3   g091(.a(new_n142_), .b(x18), .c(x08), .O(new_n143_));
  oai21  g092(.a(new_n141_), .b(new_n59_), .c(new_n143_), .O(z10));
  nor2   g093(.a(x28), .b(x27), .O(new_n145_));
  nor2   g094(.a(x30), .b(x29), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n145_), .c(new_n116_), .d(new_n92_), .O(new_n147_));
  ...
  nor3   g099(.a(new_n150_), .b(x18), .c(x08), .O(new_n151_));
  oai21  g100(.a(new_n149_), .b(new_n59_), .c(new_n151_), .O(z11));
  oai21  g101(.a(new_n147_), .b(new_n86_), .c(x31), .O(new_n153_));
  nand2  g102(.a(new_n94_), .b(new_n93_), .O(new_n154_));
  inv1   g103(.a(new_n154_), .O(new_n155_));
  nor2   g104(.a(x31), .b(x30), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n139_), .O(new_n157_));
  inv1   g106(.a(new_n157_), .O(new_n158_));
  nand4  g107(.a(new_n158_), .b(new_n122_), .c(new_n155_), .d(new_n65_), .O(new_n159_));
  aoi21  g108(.a(new_n159_), .b(new_n153_), .c(new_n59_), .O(new_n160_));
  nor2   g109(.a(x16), .b(x03), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n160_), .c(new_n52_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n70_), .O(z12));
  nor2   g112(.a(x27), .b(x26), .O(new_n164_));
  nand4  g113(.a(new_n156_), .b(new_n139_), .c(new_n164_), .d(new_n103_), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n95_), .c(x32), .O(new_n166_));
  nand2  g115(.a(new_n145_), .b(new_n116_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nor2   g117(.a(x32), .b(x31), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n146_), .O(new_n170_));
  inv1   g119(.a(new_n170_), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n168_), .c(new_n155_), .d(new_n65_), .O(new_n172_));
  aoi21  g121(.a(new_n172_), .b(new_n166_), .c(new_n59_), .O(new_n173_));
  nor2   g122(.a(x16), .b(x02), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(new_n173_), .c(new_n52_), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(new_n70_), .O(z13));
  nand4  g125(.a(new_n169_), .b(new_n146_), .c(new_n145_), .d(new_n116_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n95_), .c(x33), .O(new_n178_));
  nor2   g127(.a(x33), .b(x32), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n156_), .c(new_n139_), .d(new_n164_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n105_), .O(new_n182_));
  aoi21  g131(.a(new_n182_), .b(new_n178_), .c(new_n59_), .O(new_n183_));
  nor2   g132(.a(x16), .b(x01), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n183_), .c(new_n52_), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(new_n70_), .O(z14));
  oai21  g135(.a(new_n180_), .b(new_n112_), .c(x34), .O(new_n187_));
  nand2  g136(.a(new_n139_), .b(new_n164_), .O(new_n188_));
  ...
  nand3  g146(.a(new_n197_), .b(new_n189_), .c(new_n105_), .O(new_n198_));
  aoi21  g147(.a(new_n198_), .b(new_n187_), .c(new_n59_), .O(new_n199_));
  nor2   g148(.a(x16), .b(x00), .O(new_n200_));
  oai21  g149(.a(new_n200_), .b(new_n199_), .c(new_n52_), .O(new_n201_));
  nand2  g150(.a(new_n201_), .b(new_n70_), .O(z15));
endmodule
