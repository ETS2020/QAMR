...
module FAU ( 
  ...
  nand4  g049(.a(new_n100_), .b(new_n77_), .c(new_n99_), .d(new_n63_), .O(new_n101_));
  ...
  oai21  g078(.a(new_n122_), .b(new_n78_), .c(x28), .O(new_n130_));
  inv1   g079(.a(x26), .O(new_n131_));
  nor2   g080(.a(x28), .b(x27), .O(new_n132_));
  nand4  g081(.a(new_n132_), .b(new_n111_), .c(new_n131_), .d(new_n92_), .O(new_n133_));
  ...
  oai21  g087(.a(new_n133_), .b(new_n78_), .c(x29), .O(new_n139_));
  nor3   g088(.a(x29), .b(x28), .c(x27), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n114_), .c(new_n84_), .d(new_n83_), .O(new_n141_));
  ...
  nand4  g093(.a(new_n110_), .b(new_n99_), .c(new_n69_), .d(new_n63_), .O(new_n145_));
  nor2   g094(.a(x26), .b(x25), .O(new_n146_));
  nor2   g095(.a(x30), .b(x29), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n132_), .c(new_n146_), .d(new_n89_), .O(new_n148_));
  ...
  oai21  g102(.a(new_n148_), .b(new_n145_), .c(x31), .O(new_n154_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n147_), .c(new_n132_), .d(new_n146_), .O(new_n169_));
  ...
  oai21  g126(.a(x18), .b(new_n177_), .c(new_n56_), .O(new_n178_));
  oai21  g127(.a(new_n169_), .b(new_n101_), .c(x33), .O(new_n179_));
  inv1   g128(.a(new_n103_), .O(new_n180_));
  nand2  g129(.a(new_n156_), .b(new_n121_), .O(new_n181_));
  ...
  nand2  g137(.a(new_n188_), .b(new_n178_), .O(z14));
  nand4  g138(.a(new_n183_), .b(new_n157_), .c(new_n156_), .d(new_n121_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n112_), .c(x34), .O(new_n191_));
  ...
  nand3  g148(.a(new_n199_), .b(new_n182_), .c(new_n104_), .O(new_n200_));
