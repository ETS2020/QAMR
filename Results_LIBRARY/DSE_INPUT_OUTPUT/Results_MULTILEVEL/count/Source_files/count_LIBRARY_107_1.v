...
module FAU ( 
  ...
  aoi21  g079(.a(new_n65_), .b(new_n130_), .c(x18), .O(new_n131_));
  ...
  nand4  g084(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n89_), .O(new_n136_));
  ...
  aoi21  g088(.a(new_n65_), .b(new_n139_), .c(x18), .O(new_n140_));
  oai21  g089(.a(new_n138_), .b(new_n65_), .c(new_n140_), .O(z10));
  ...
  nand3  g095(.a(new_n146_), .b(new_n108_), .c(new_n92_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n142_), .c(new_n77_), .O(new_n148_));
  ...
  nand4  g101(.a(new_n144_), .b(new_n143_), .c(new_n134_), .d(new_n89_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n85_), .c(x31), .O(new_n154_));
  nand4  g103(.a(new_n89_), .b(new_n90_), .c(new_n75_), .d(new_n68_), .O(new_n155_));
  ...
  nand4  g115(.a(new_n158_), .b(new_n135_), .c(new_n116_), .d(new_n115_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n95_), .c(x32), .O(new_n168_));
  nor2   g117(.a(x32), .b(x31), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n144_), .c(new_n143_), .d(new_n134_), .O(new_n170_));
  ...
  aoi21  g124(.a(new_n65_), .b(new_n175_), .c(x18), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(new_n174_), .O(z13));
  oai21  g126(.a(new_n170_), .b(new_n95_), .c(x33), .O(new_n178_));
  nand4  g127(.a(new_n115_), .b(new_n89_), .c(new_n90_), .d(new_n75_), .O(new_n179_));
  nor2   g128(.a(new_n179_), .b(new_n69_), .O(new_n180_));
  nor2   g129(.a(x33), .b(x32), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n158_), .c(new_n135_), .d(new_n116_), .O(new_n182_));
  ...
  aoi21  g136(.a(new_n65_), .b(new_n187_), .c(x18), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(new_n186_), .O(z14));
  oai21  g138(.a(new_n182_), .b(new_n103_), .c(x34), .O(new_n190_));
  nand2  g139(.a(new_n135_), .b(new_n116_), .O(new_n191_));
