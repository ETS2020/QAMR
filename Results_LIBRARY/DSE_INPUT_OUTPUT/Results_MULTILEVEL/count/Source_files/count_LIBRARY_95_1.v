...
module FAU ( 
  ...
  nand2  g006(.a(x18), .b(x04), .O(new_n58_));
  ...
  nand4  g045(.a(new_n96_), .b(new_n86_), .c(new_n85_), .d(new_n71_), .O(new_n97_));
  nor2   g046(.a(new_n97_), .b(new_n66_), .O(new_n98_));
  aoi21  g047(.a(new_n95_), .b(x24), .c(new_n98_), .O(new_n99_));
  inv1   g048(.a(x10), .O(new_n100_));
  aoi21  g049(.a(new_n61_), .b(new_n100_), .c(x18), .O(new_n101_));
  oai21  g050(.a(new_n99_), .b(new_n61_), .c(new_n101_), .O(z05));
  oai21  g051(.a(new_n97_), .b(new_n66_), .c(x25), .O(new_n103_));
  nor2   g052(.a(x21), .b(x20), .O(new_n104_));
  nor2   g053(.a(x25), .b(x24), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n94_), .c(new_n104_), .d(new_n53_), .O(new_n106_));
  aoi21  g055(.a(new_n106_), .b(new_n103_), .c(new_n61_), .O(new_n107_));
  nor2   g056(.a(x16), .b(x09), .O(new_n108_));
  oai21  g057(.a(new_n108_), .b(new_n107_), .c(new_n60_), .O(new_n109_));
  nand2  g058(.a(new_n109_), .b(new_n58_), .O(z06));
  nand2  g059(.a(new_n106_), .b(x26), .O(new_n111_));
  nor3   g060(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n94_), .c(new_n104_), .d(new_n53_), .O(new_n113_));
  aoi21  g062(.a(new_n113_), .b(new_n111_), .c(new_n61_), .O(new_n114_));
  ...
  nand4  g068(.a(new_n119_), .b(new_n118_), .c(new_n96_), .d(new_n86_), .O(new_n120_));
  ...
  aoi21  g072(.a(new_n61_), .b(new_n123_), .c(x18), .O(new_n124_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n53_), .O(new_n130_));
  aoi21  g079(.a(new_n130_), .b(new_n126_), .c(new_n61_), .O(new_n131_));
  nor2   g080(.a(x16), .b(x06), .O(new_n132_));
  oai21  g081(.a(new_n132_), .b(new_n131_), .c(new_n60_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n58_), .O(z09));
  inv1   g083(.a(x27), .O(new_n135_));
  nor2   g084(.a(x26), .b(x25), .O(new_n136_));
  nor2   g085(.a(x29), .b(x28), .O(new_n137_));
  nand4  g086(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n96_), .O(new_n138_));
  nor2   g087(.a(new_n138_), .b(new_n95_), .O(new_n139_));
  ...
  oai21  g092(.a(new_n138_), .b(new_n95_), .c(x30), .O(new_n144_));
  nor2   g093(.a(x28), .b(x27), .O(new_n145_));
  nor2   g094(.a(x30), .b(x29), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n145_), .c(new_n112_), .d(new_n88_), .O(new_n147_));
  aoi21  g096(.a(new_n147_), .b(new_n144_), .c(new_n61_), .O(new_n148_));
  nor2   g097(.a(x16), .b(x04), .O(new_n149_));
  oai21  g098(.a(new_n149_), .b(new_n148_), .c(new_n60_), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(new_n58_), .O(z11));
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n136_), .d(new_n96_), .O(new_n152_));
  oai21  g101(.a(new_n152_), .b(new_n95_), .c(x31), .O(new_n153_));
  ...
  nand3  g106(.a(new_n157_), .b(new_n154_), .c(new_n98_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n153_), .c(new_n61_), .O(new_n159_));
  nor2   g108(.a(x16), .b(x03), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n159_), .c(new_n60_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n58_), .O(z12));
  nand2  g111(.a(new_n158_), .b(x32), .O(new_n163_));
  inv1   g112(.a(x31), .O(new_n164_));
  inv1   g113(.a(x32), .O(new_n165_));
  nand3  g114(.a(new_n146_), .b(new_n165_), .c(new_n164_), .O(new_n166_));
  inv1   g115(.a(new_n166_), .O(new_n167_));
  nand4  g116(.a(new_n167_), .b(new_n145_), .c(new_n136_), .d(new_n98_), .O(new_n168_));
  ...
  nand4  g123(.a(new_n174_), .b(new_n155_), .c(new_n137_), .d(new_n119_), .O(new_n175_));
  ...
  oai21  g128(.a(new_n177_), .b(new_n61_), .c(new_n179_), .O(z14));
  oai21  g129(.a(new_n175_), .b(new_n106_), .c(x34), .O(new_n181_));
  nand4  g130(.a(new_n118_), .b(new_n96_), .c(new_n86_), .d(new_n85_), .O(new_n182_));
  nor2   g131(.a(new_n182_), .b(new_n73_), .O(new_n183_));
  nand2  g132(.a(new_n137_), .b(new_n119_), .O(new_n184_));
  ...
  aoi21  g141(.a(new_n192_), .b(new_n181_), .c(new_n61_), .O(new_n193_));
  nor2   g142(.a(x16), .b(x00), .O(new_n194_));
  oai21  g143(.a(new_n194_), .b(new_n193_), .c(new_n60_), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n58_), .O(z15));
endmodule
