...
module FAU ( 
  ...
  nor2   g022(.a(x18), .b(x16), .O(new_n74_));
  inv1   g023(.a(new_n74_), .O(new_n75_));
  oai21  g024(.a(new_n75_), .b(x13), .c(new_n73_), .O(z02));
  inv1   g025(.a(x22), .O(new_n77_));
  nor2   g026(.a(x21), .b(x20), .O(new_n78_));
  aoi21  g027(.a(new_n78_), .b(new_n55_), .c(new_n77_), .O(new_n79_));
  ...
  oai21  g032(.a(new_n75_), .b(x12), .c(new_n83_), .O(z03));
  ...
  nand4  g042(.a(new_n93_), .b(new_n80_), .c(new_n92_), .d(new_n52_), .O(new_n94_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n100_), .c(new_n78_), .d(new_n55_), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(new_n70_), .O(new_n103_));
  aoi21  g052(.a(new_n94_), .b(x25), .c(new_n103_), .O(new_n104_));
  oai22  g053(.a(new_n104_), .b(new_n58_), .c(new_n75_), .d(x09), .O(z06));
  nor2   g054(.a(x26), .b(x25), .O(new_n106_));
  nand3  g055(.a(new_n106_), .b(new_n100_), .c(new_n90_), .O(new_n107_));
  ...
  oai21  g077(.a(new_n123_), .b(new_n81_), .c(x29), .O(new_n129_));
  nor3   g078(.a(x26), .b(x25), .c(x24), .O(new_n130_));
  nor3   g079(.a(x29), .b(x28), .c(x27), .O(new_n131_));
  nand4  g080(.a(new_n131_), .b(new_n130_), .c(new_n85_), .d(new_n63_), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n129_), .c(new_n70_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(x16), .O(new_n134_));
  inv1   g083(.a(x05), .O(new_n135_));
  nand2  g084(.a(new_n74_), .b(new_n135_), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(new_n134_), .O(z10));
  nand4  g086(.a(new_n100_), .b(new_n92_), .c(new_n68_), .d(new_n52_), .O(new_n138_));
  nor2   g087(.a(x30), .b(x29), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n122_), .c(new_n106_), .d(new_n90_), .O(new_n140_));
  ...
  nand4  g107(.a(new_n148_), .b(new_n147_), .c(new_n158_), .d(new_n157_), .O(new_n159_));
  oai21  g108(.a(new_n159_), .b(new_n94_), .c(x32), .O(new_n160_));
  nor2   g109(.a(x32), .b(x31), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n139_), .c(new_n122_), .d(new_n106_), .O(new_n162_));
  inv1   g111(.a(new_n162_), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n95_), .O(new_n164_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n94_), .c(x33), .O(new_n170_));
  nand4  g119(.a(new_n157_), .b(new_n90_), .c(new_n120_), .d(new_n77_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(new_n71_), .O(new_n172_));
  nor2   g121(.a(x33), .b(x32), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n148_), .c(new_n147_), .d(new_n158_), .O(new_n174_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n102_), .c(x34), .O(new_n182_));
  nand2  g131(.a(new_n147_), .b(new_n158_), .O(new_n183_));
