...
module FAU ( 
  ...
  aoi22  g023(.a(new_n74_), .b(new_n58_), .c(new_n73_), .d(x23), .O(new_n75_));
  oai21  g024(.a(new_n75_), .b(new_n68_), .c(new_n52_), .O(z04));
  ...
  nand4  g032(.a(new_n83_), .b(new_n77_), .c(new_n62_), .d(x16), .O(new_n84_));
  nand4  g033(.a(new_n84_), .b(new_n80_), .c(new_n52_), .d(x16), .O(z05));
  nand4  g034(.a(new_n81_), .b(new_n72_), .c(new_n77_), .d(new_n62_), .O(new_n86_));
  nand2  g035(.a(new_n86_), .b(x25), .O(new_n87_));
  nor2   g036(.a(x21), .b(x20), .O(new_n88_));
  nor2   g037(.a(x25), .b(x24), .O(new_n89_));
  nand4  g038(.a(new_n89_), .b(new_n78_), .c(new_n88_), .d(new_n53_), .O(new_n90_));
  nand4  g039(.a(new_n90_), .b(new_n87_), .c(new_n52_), .d(x16), .O(z06));
  inv1   g040(.a(x26), .O(new_n92_));
  ...
  nand4  g048(.a(new_n99_), .b(new_n78_), .c(new_n88_), .d(new_n53_), .O(new_n100_));
  oai21  g049(.a(new_n98_), .b(new_n92_), .c(new_n100_), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(x16), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(new_n52_), .O(z07));
  nand2  g052(.a(new_n100_), .b(x27), .O(new_n104_));
  nor3   g053(.a(x27), .b(x26), .c(x25), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n81_), .c(new_n69_), .d(new_n53_), .O(new_n106_));
  nand4  g055(.a(new_n106_), .b(new_n104_), .c(new_n52_), .d(x16), .O(z08));
  nand2  g056(.a(new_n106_), .b(x28), .O(new_n108_));
  nor2   g057(.a(x28), .b(x27), .O(new_n109_));
  nand4  g058(.a(new_n109_), .b(new_n89_), .c(new_n92_), .d(new_n94_), .O(new_n110_));
  or2    g059(.a(new_n110_), .b(new_n73_), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n108_), .c(new_n52_), .d(x16), .O(z09));
  nand2  g061(.a(new_n111_), .b(x29), .O(new_n113_));
  nor3   g062(.a(x29), .b(x28), .c(x27), .O(new_n114_));
  nand4  g063(.a(new_n114_), .b(new_n99_), .c(new_n74_), .d(new_n58_), .O(new_n115_));
  ...
  nand4  g067(.a(new_n118_), .b(new_n109_), .c(new_n117_), .d(new_n95_), .O(new_n119_));
  nor2   g068(.a(new_n119_), .b(new_n79_), .O(new_n120_));
  aoi21  g069(.a(new_n115_), .b(x30), .c(new_n120_), .O(new_n121_));
  oai21  g070(.a(new_n121_), .b(new_n68_), .c(new_n52_), .O(z11));
  ...
  nand4  g076(.a(new_n127_), .b(new_n105_), .c(new_n83_), .d(new_n58_), .O(new_n128_));
  ...
  nand4  g081(.a(new_n125_), .b(new_n124_), .c(new_n132_), .d(new_n96_), .O(new_n133_));
  oai21  g082(.a(new_n133_), .b(new_n86_), .c(x32), .O(new_n134_));
  nand2  g083(.a(new_n109_), .b(new_n117_), .O(new_n135_));
  inv1   g084(.a(new_n135_), .O(new_n136_));
  nor2   g085(.a(x32), .b(x31), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n118_), .O(new_n138_));
  inv1   g087(.a(new_n138_), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n136_), .c(new_n83_), .d(new_n58_), .O(new_n140_));
  ...
  nand4  g094(.a(new_n145_), .b(new_n125_), .c(new_n124_), .d(new_n132_), .O(new_n146_));
  or2    g095(.a(new_n146_), .b(new_n90_), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n144_), .c(new_n52_), .d(x16), .O(z14));
  oai21  g097(.a(new_n146_), .b(new_n90_), .c(x34), .O(new_n149_));
  nand2  g098(.a(new_n124_), .b(new_n132_), .O(new_n150_));
  ...
  nand3  g108(.a(new_n159_), .b(new_n151_), .c(new_n98_), .O(new_n160_));
