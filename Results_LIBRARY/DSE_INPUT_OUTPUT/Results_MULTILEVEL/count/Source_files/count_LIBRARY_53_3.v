...
module FAU ( 
  ...
  oai21  g081(.a(new_n121_), .b(new_n129_), .c(new_n132_), .O(new_n133_));
  nand3  g082(.a(new_n133_), .b(new_n128_), .c(x16), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n127_), .O(z09));
  nand4  g084(.a(new_n108_), .b(new_n68_), .c(new_n70_), .d(new_n52_), .O(new_n136_));
  ...
  nand4  g095(.a(new_n146_), .b(new_n112_), .c(new_n84_), .d(new_n63_), .O(new_n147_));
  nor2   g096(.a(x28), .b(x27), .O(new_n148_));
  nor2   g097(.a(x30), .b(x29), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n148_), .c(new_n138_), .d(new_n89_), .O(new_n150_));
  ...
  nand4  g115(.a(new_n158_), .b(new_n139_), .c(new_n119_), .d(new_n100_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n92_), .c(x32), .O(new_n168_));
  ...
  oai21  g128(.a(new_n170_), .b(new_n92_), .c(x33), .O(new_n180_));
  nor2   g129(.a(x33), .b(x32), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n158_), .c(new_n139_), .d(new_n119_), .O(new_n182_));
  inv1   g131(.a(new_n182_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(new_n102_), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n180_), .O(new_n185_));
  nand3  g134(.a(new_n185_), .b(new_n128_), .c(x16), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(new_n179_), .O(z14));
  inv1   g136(.a(x00), .O(new_n188_));
  oai21  g137(.a(x18), .b(new_n188_), .c(new_n58_), .O(new_n189_));
  oai21  g138(.a(new_n182_), .b(new_n110_), .c(x34), .O(new_n190_));
  nand2  g139(.a(new_n139_), .b(new_n119_), .O(new_n191_));
  ...
  nand3  g151(.a(new_n202_), .b(new_n128_), .c(x16), .O(new_n203_));
