...
module FAU ( 
  ...
  oai21  g016(.a(new_n67_), .b(new_n66_), .c(x29), .O(new_n68_));
  ...
  oai21  g031(.a(new_n82_), .b(new_n81_), .c(x29), .O(new_n83_));
  ...
  nand4  g058(.a(new_n109_), .b(new_n87_), .c(new_n70_), .d(new_n55_), .O(new_n110_));
  aoi21  g059(.a(new_n110_), .b(new_n108_), .c(new_n58_), .O(new_n111_));
  nor2   g060(.a(x16), .b(x08), .O(new_n112_));
  oai21  g061(.a(new_n112_), .b(new_n111_), .c(x29), .O(new_n113_));
  ...
  oai21  g084(.a(new_n135_), .b(new_n133_), .c(new_n59_), .O(z10));
  inv1   g085(.a(new_n60_), .O(new_n137_));
  nand2  g086(.a(x30), .b(x16), .O(new_n138_));
  ...
  and2   g091(.a(x31), .b(x16), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(new_n142_), .c(x29), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n59_), .O(z12));
  nand2  g094(.a(x32), .b(x16), .O(new_n146_));
  inv1   g095(.a(x02), .O(new_n147_));
  nand2  g096(.a(new_n58_), .b(new_n147_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n146_), .c(new_n137_), .O(z13));
  nor2   g098(.a(x16), .b(x01), .O(new_n150_));
  and2   g099(.a(x33), .b(x16), .O(new_n151_));
  oai21  g100(.a(new_n151_), .b(new_n150_), .c(x29), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n59_), .O(z14));
  nand2  g102(.a(x34), .b(x16), .O(new_n154_));
  inv1   g103(.a(x00), .O(new_n155_));
  nand2  g104(.a(new_n58_), .b(new_n155_), .O(new_n156_));
  nand3  g105(.a(new_n156_), .b(new_n154_), .c(new_n137_), .O(z15));
endmodule
