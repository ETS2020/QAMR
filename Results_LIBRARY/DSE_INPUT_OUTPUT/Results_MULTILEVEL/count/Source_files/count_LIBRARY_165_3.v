...
module FAU ( 
  ...
  aoi22  g046(.a(new_n97_), .b(new_n91_), .c(new_n94_), .d(x24), .O(new_n98_));
  ...
  nand4  g050(.a(new_n95_), .b(new_n81_), .c(new_n92_), .d(new_n52_), .O(new_n102_));
  inv1   g051(.a(x24), .O(new_n103_));
  inv1   g052(.a(x25), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n103_), .c(new_n84_), .d(new_n83_), .O(new_n105_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n93_), .c(new_n113_), .d(new_n55_), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(x26), .O(new_n116_));
  nor3   g065(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n93_), .c(new_n71_), .O(new_n118_));
  ...
  nand3  g071(.a(new_n122_), .b(new_n95_), .c(new_n104_), .O(new_n123_));
  ...
  oai21  g083(.a(new_n124_), .b(new_n131_), .c(new_n134_), .O(new_n135_));
  ...
  nand4  g089(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n103_), .O(new_n141_));
  ...
  nand4  g108(.a(new_n151_), .b(new_n150_), .c(new_n139_), .d(new_n103_), .O(new_n160_));
  ...
  nand4  g131(.a(new_n176_), .b(new_n151_), .c(new_n150_), .d(new_n139_), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n102_), .c(x33), .O(new_n184_));
  nor2   g133(.a(x33), .b(x32), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n163_), .c(new_n140_), .d(new_n122_), .O(new_n186_));
  ...
  nand2  g143(.a(new_n140_), .b(new_n122_), .O(new_n195_));
