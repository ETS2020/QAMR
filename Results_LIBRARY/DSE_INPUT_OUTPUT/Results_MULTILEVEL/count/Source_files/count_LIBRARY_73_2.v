...
module FAU ( 
  ...
  nand2  g006(.a(x34), .b(x18), .O(new_n58_));
  ...
  nand3  g034(.a(new_n85_), .b(new_n53_), .c(new_n65_), .O(new_n86_));
  inv1   g035(.a(x22), .O(new_n87_));
  inv1   g036(.a(x23), .O(new_n88_));
  nand3  g037(.a(new_n88_), .b(new_n87_), .c(new_n71_), .O(new_n89_));
  nor2   g038(.a(new_n89_), .b(new_n66_), .O(new_n90_));
  aoi21  g039(.a(new_n86_), .b(x23), .c(new_n90_), .O(new_n91_));
  inv1   g040(.a(x11), .O(new_n92_));
  aoi21  g041(.a(new_n61_), .b(new_n92_), .c(x18), .O(new_n93_));
  oai21  g042(.a(new_n91_), .b(new_n61_), .c(new_n93_), .O(z04));
  nor2   g043(.a(x20), .b(x19), .O(new_n95_));
  nor2   g044(.a(x23), .b(x22), .O(new_n96_));
  nand4  g045(.a(new_n96_), .b(new_n95_), .c(new_n71_), .d(new_n63_), .O(new_n97_));
  nand2  g046(.a(new_n97_), .b(x24), .O(new_n98_));
  nor2   g047(.a(x24), .b(x23), .O(new_n99_));
  nand3  g048(.a(new_n99_), .b(new_n85_), .c(new_n72_), .O(new_n100_));
  aoi21  g049(.a(new_n100_), .b(new_n98_), .c(new_n61_), .O(new_n101_));
  nor2   g050(.a(x16), .b(x10), .O(new_n102_));
  oai21  g051(.a(new_n102_), .b(new_n101_), .c(new_n60_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(new_n58_), .O(z05));
  inv1   g053(.a(x25), .O(new_n105_));
  nand2  g054(.a(new_n99_), .b(new_n85_), .O(new_n106_));
  nor2   g055(.a(new_n106_), .b(new_n66_), .O(new_n107_));
  nor2   g056(.a(x25), .b(x24), .O(new_n108_));
  nand4  g057(.a(new_n108_), .b(new_n96_), .c(new_n73_), .d(new_n53_), .O(new_n109_));
  oai21  g058(.a(new_n107_), .b(new_n105_), .c(new_n109_), .O(new_n110_));
  ...
  nand4  g065(.a(new_n116_), .b(new_n96_), .c(new_n73_), .d(new_n53_), .O(new_n117_));
  ...
  nand2  g069(.a(new_n120_), .b(new_n58_), .O(z07));
  inv1   g070(.a(x24), .O(new_n122_));
  nor2   g071(.a(x26), .b(x25), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n96_), .c(new_n122_), .O(new_n124_));
  oai21  g073(.a(new_n124_), .b(new_n74_), .c(x27), .O(new_n125_));
  nor3   g074(.a(x27), .b(x26), .c(x25), .O(new_n126_));
  nand4  g075(.a(new_n126_), .b(new_n99_), .c(new_n80_), .d(new_n53_), .O(new_n127_));
  aoi21  g076(.a(new_n127_), .b(new_n125_), .c(new_n61_), .O(new_n128_));
  nor2   g077(.a(x16), .b(x07), .O(new_n129_));
  oai21  g078(.a(new_n129_), .b(new_n128_), .c(new_n60_), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(new_n58_), .O(z08));
  nor2   g080(.a(x27), .b(x26), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n99_), .c(new_n105_), .O(new_n133_));
  ...
  nand4  g085(.a(new_n136_), .b(new_n135_), .c(new_n80_), .d(new_n53_), .O(new_n137_));
  ...
  nand2  g089(.a(new_n140_), .b(new_n58_), .O(z09));
  inv1   g090(.a(x27), .O(new_n142_));
  nor2   g091(.a(x29), .b(x28), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n123_), .c(new_n142_), .d(new_n122_), .O(new_n144_));
  ...
  oai21  g097(.a(new_n146_), .b(new_n61_), .c(new_n148_), .O(z10));
  oai21  g098(.a(new_n144_), .b(new_n97_), .c(x30), .O(new_n150_));
  ...
  nand3  g104(.a(new_n155_), .b(new_n116_), .c(new_n90_), .O(new_n156_));
  aoi21  g105(.a(new_n156_), .b(new_n150_), .c(new_n61_), .O(new_n157_));
  nor2   g106(.a(x16), .b(x04), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n157_), .c(new_n60_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n58_), .O(z11));
  nand2  g109(.a(new_n156_), .b(x31), .O(new_n161_));
  nor2   g110(.a(x31), .b(x30), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n143_), .c(new_n126_), .d(new_n107_), .O(new_n163_));
  ...
  nand3  g117(.a(new_n162_), .b(new_n143_), .c(new_n126_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n100_), .c(x32), .O(new_n170_));
  nor2   g119(.a(x32), .b(x31), .O(new_n171_));
  nand3  g120(.a(new_n171_), .b(new_n152_), .c(new_n151_), .O(new_n172_));
  inv1   g121(.a(new_n172_), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n153_), .c(new_n123_), .d(new_n107_), .O(new_n174_));
  ...
  nand4  g129(.a(new_n180_), .b(new_n162_), .c(new_n143_), .d(new_n132_), .O(new_n181_));
  nor2   g130(.a(new_n181_), .b(new_n109_), .O(new_n182_));
  ...
  oai21  g134(.a(new_n183_), .b(new_n61_), .c(new_n185_), .O(z14));
  nor2   g135(.a(x17), .b(new_n61_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n135_), .c(new_n85_), .d(new_n95_), .O(new_n188_));
  nor3   g137(.a(x34), .b(x33), .c(x32), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n162_), .c(new_n143_), .d(new_n132_), .O(new_n190_));
  oai22  g139(.a(new_n190_), .b(new_n188_), .c(x16), .d(x00), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(new_n60_), .O(new_n192_));
  oai21  g141(.a(new_n182_), .b(new_n61_), .c(new_n60_), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(x34), .O(new_n194_));
