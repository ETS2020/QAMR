...
module FAU ( 
  ...
  nand3  g017(.a(new_n68_), .b(new_n65_), .c(x02), .O(z01));
  ...
  nand3  g050(.a(new_n101_), .b(new_n99_), .c(x02), .O(z05));
  ...
  oai21  g057(.a(new_n108_), .b(new_n107_), .c(x02), .O(new_n109_));
  ...
  oai21  g065(.a(new_n116_), .b(new_n115_), .c(x02), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n53_), .O(z07));
  ...
  nor3   g072(.a(new_n123_), .b(x18), .c(new_n52_), .O(new_n124_));
  ...
  nand3  g082(.a(new_n133_), .b(new_n131_), .c(x02), .O(z09));
  ...
  oai21  g088(.a(new_n139_), .b(new_n138_), .c(x02), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n53_), .O(z10));
  ...
  oai21  g101(.a(new_n152_), .b(new_n151_), .c(x02), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(new_n53_), .O(z11));
  ...
  nor3   g110(.a(new_n161_), .b(x18), .c(new_n52_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n160_), .O(z12));
  nor2   g112(.a(x32), .b(x31), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n147_), .c(new_n128_), .d(new_n143_), .O(new_n165_));
  ...
  oai21  g117(.a(new_n167_), .b(new_n67_), .c(new_n168_), .O(z13));
  oai21  g118(.a(new_n165_), .b(new_n97_), .c(x33), .O(new_n170_));
  ...
  oai21  g135(.a(new_n186_), .b(new_n185_), .c(x02), .O(new_n187_));
  nand2  g136(.a(new_n187_), .b(new_n53_), .O(z14));
