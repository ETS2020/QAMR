...
module FAU ( 
  ...
  nand3  g061(.a(new_n112_), .b(new_n110_), .c(new_n71_), .O(new_n113_));
  ...
  nand3  g079(.a(new_n130_), .b(new_n126_), .c(new_n71_), .O(new_n131_));
  nand2  g080(.a(new_n131_), .b(x16), .O(new_n132_));
  oai21  g081(.a(new_n76_), .b(x06), .c(new_n132_), .O(z09));
  inv1   g082(.a(x27), .O(new_n134_));
  nor2   g083(.a(x26), .b(x25), .O(new_n135_));
  nor2   g084(.a(x29), .b(x28), .O(new_n136_));
  nand4  g085(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n92_), .O(new_n137_));
  ...
  nand3  g092(.a(new_n143_), .b(new_n111_), .c(new_n95_), .O(new_n144_));
  nor2   g093(.a(x28), .b(x27), .O(new_n145_));
  nor2   g094(.a(x30), .b(x29), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n145_), .c(new_n135_), .d(new_n92_), .O(new_n147_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n111_), .c(new_n95_), .O(new_n155_));
  nor2   g104(.a(x31), .b(x30), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n136_), .c(new_n119_), .d(new_n118_), .O(new_n157_));
  ...
  nand4  g125(.a(new_n176_), .b(new_n156_), .c(new_n136_), .d(new_n119_), .O(new_n177_));
  ...
  oai21  g131(.a(new_n177_), .b(new_n106_), .c(x34), .O(new_n183_));
  nand4  g132(.a(new_n118_), .b(new_n92_), .c(new_n93_), .d(new_n78_), .O(new_n184_));
  nor2   g133(.a(new_n184_), .b(new_n72_), .O(new_n185_));
  nand2  g134(.a(new_n136_), .b(new_n119_), .O(new_n186_));
  ...
  nand3  g144(.a(new_n195_), .b(new_n183_), .c(new_n71_), .O(new_n196_));
