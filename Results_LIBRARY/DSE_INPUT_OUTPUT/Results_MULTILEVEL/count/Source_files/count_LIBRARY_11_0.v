...
module FAU ( 
  ...
  nand3  g008(.a(new_n59_), .b(new_n56_), .c(x04), .O(z00));
  ...
  oai21  g015(.a(new_n66_), .b(new_n65_), .c(x04), .O(new_n67_));
  ...
  aoi22  g026(.a(new_n77_), .b(new_n55_), .c(new_n70_), .d(x22), .O(new_n78_));
  nor2   g027(.a(x16), .b(x12), .O(new_n79_));
  nor3   g028(.a(new_n79_), .b(x18), .c(new_n73_), .O(new_n80_));
  oai21  g029(.a(new_n78_), .b(new_n58_), .c(new_n80_), .O(z03));
  nand2  g030(.a(new_n77_), .b(new_n55_), .O(new_n82_));
  nand2  g031(.a(new_n82_), .b(x23), .O(new_n83_));
  nor3   g032(.a(x20), .b(x19), .c(x17), .O(new_n84_));
  nor2   g033(.a(x23), .b(x22), .O(new_n85_));
  nand3  g034(.a(new_n85_), .b(new_n84_), .c(new_n69_), .O(new_n86_));
  aoi21  g035(.a(new_n86_), .b(new_n83_), .c(new_n58_), .O(new_n87_));
  nor2   g036(.a(x16), .b(x11), .O(new_n88_));
  oai21  g037(.a(new_n88_), .b(new_n87_), .c(x04), .O(new_n89_));
  ...
  nand3  g042(.a(new_n93_), .b(new_n92_), .c(new_n84_), .O(new_n94_));
  aoi21  g043(.a(new_n94_), .b(new_n91_), .c(new_n58_), .O(new_n95_));
  nor2   g044(.a(x16), .b(x10), .O(new_n96_));
  oai21  g045(.a(new_n96_), .b(new_n95_), .c(x04), .O(new_n97_));
  nand2  g046(.a(new_n97_), .b(new_n61_), .O(z05));
  nand2  g047(.a(new_n94_), .b(x25), .O(new_n99_));
  nor2   g048(.a(x21), .b(x20), .O(new_n100_));
  nor2   g049(.a(x25), .b(x24), .O(new_n101_));
  nand4  g050(.a(new_n101_), .b(new_n85_), .c(new_n100_), .d(new_n55_), .O(new_n102_));
  aoi21  g051(.a(new_n102_), .b(new_n99_), .c(new_n58_), .O(new_n103_));
  nor2   g052(.a(x16), .b(x09), .O(new_n104_));
  oai21  g053(.a(new_n104_), .b(new_n103_), .c(x04), .O(new_n105_));
  nand2  g054(.a(new_n105_), .b(new_n61_), .O(z06));
  nand2  g055(.a(new_n102_), .b(x26), .O(new_n107_));
  nor3   g056(.a(x26), .b(x25), .c(x24), .O(new_n108_));
  nand3  g057(.a(new_n108_), .b(new_n85_), .c(new_n71_), .O(new_n109_));
  aoi21  g058(.a(new_n109_), .b(new_n107_), .c(new_n58_), .O(new_n110_));
  nor2   g059(.a(x16), .b(x08), .O(new_n111_));
  oai21  g060(.a(new_n111_), .b(new_n110_), .c(x04), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(new_n61_), .O(z07));
  inv1   g062(.a(x24), .O(new_n114_));
  nor2   g063(.a(x26), .b(x25), .O(new_n115_));
  nand3  g064(.a(new_n115_), .b(new_n85_), .c(new_n114_), .O(new_n116_));
  oai21  g065(.a(new_n116_), .b(new_n70_), .c(x27), .O(new_n117_));
  nor3   g066(.a(x27), .b(x26), .c(x25), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n93_), .c(new_n77_), .d(new_n55_), .O(new_n119_));
  aoi21  g068(.a(new_n119_), .b(new_n117_), .c(new_n58_), .O(new_n120_));
  nor2   g069(.a(x16), .b(x07), .O(new_n121_));
  oai21  g070(.a(new_n121_), .b(new_n120_), .c(x04), .O(new_n122_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n125_), .c(new_n77_), .d(new_n55_), .O(new_n127_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n129_), .c(x04), .O(z09));
  inv1   g081(.a(x27), .O(new_n133_));
  nor2   g082(.a(x29), .b(x28), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n108_), .c(new_n133_), .O(new_n135_));
  ...
  nor3   g087(.a(new_n138_), .b(x18), .c(new_n73_), .O(new_n139_));
  ...
  nand3  g092(.a(new_n143_), .b(new_n142_), .c(new_n108_), .O(new_n144_));
  oai22  g093(.a(new_n144_), .b(new_n86_), .c(new_n136_), .d(new_n141_), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(x16), .c(x04), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n61_), .O(z11));
  oai21  g096(.a(new_n144_), .b(new_n86_), .c(x31), .O(new_n148_));
  nor2   g097(.a(x31), .b(x30), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n134_), .c(new_n118_), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n94_), .c(new_n148_), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(x16), .O(new_n152_));
  inv1   g101(.a(x03), .O(new_n153_));
  aoi21  g102(.a(new_n58_), .b(new_n153_), .c(x18), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n152_), .c(x04), .O(z12));
  oai21  g104(.a(new_n150_), .b(new_n94_), .c(x32), .O(new_n156_));
  nor2   g105(.a(x32), .b(x31), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n143_), .c(new_n142_), .d(new_n115_), .O(new_n158_));
  ...
  nand3  g111(.a(new_n162_), .b(new_n160_), .c(x04), .O(z13));
  oai21  g112(.a(new_n158_), .b(new_n94_), .c(x33), .O(new_n164_));
  nor2   g113(.a(x27), .b(x26), .O(new_n165_));
  nor2   g114(.a(x33), .b(x32), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n149_), .c(new_n134_), .d(new_n165_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n102_), .c(new_n164_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(x16), .O(new_n169_));
  inv1   g118(.a(x01), .O(new_n170_));
  aoi21  g119(.a(new_n58_), .b(new_n170_), .c(x18), .O(new_n171_));
  nand3  g120(.a(new_n171_), .b(new_n169_), .c(x04), .O(z14));
  oai21  g121(.a(new_n167_), .b(new_n102_), .c(x34), .O(new_n173_));
  inv1   g122(.a(x22), .O(new_n174_));
  inv1   g123(.a(x23), .O(new_n175_));
  inv1   g124(.a(x25), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n114_), .c(new_n175_), .d(new_n174_), .O(new_n177_));
  nor2   g126(.a(new_n177_), .b(new_n70_), .O(new_n178_));
  nand2  g127(.a(new_n134_), .b(new_n165_), .O(new_n179_));
  inv1   g128(.a(new_n179_), .O(new_n180_));
  inv1   g129(.a(x31), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n141_), .O(new_n182_));
  ...
  nand3  g136(.a(new_n187_), .b(new_n180_), .c(new_n178_), .O(new_n188_));
  aoi21  g137(.a(new_n188_), .b(new_n173_), .c(new_n58_), .O(new_n189_));
  nor2   g138(.a(x16), .b(x00), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n189_), .c(x04), .O(new_n191_));
