...
module FAU ( 
  ...
  nand4  g042(.a(new_n93_), .b(new_n84_), .c(new_n65_), .d(new_n64_), .O(new_n94_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n100_), .c(new_n71_), .d(new_n53_), .O(new_n102_));
  aoi21  g051(.a(new_n102_), .b(new_n99_), .c(new_n62_), .O(new_n103_));
  ...
  oai21  g055(.a(x18), .b(new_n62_), .c(new_n58_), .O(new_n107_));
  inv1   g056(.a(x26), .O(new_n108_));
  inv1   g057(.a(new_n102_), .O(new_n109_));
  inv1   g058(.a(x24), .O(new_n110_));
  nor2   g059(.a(x26), .b(x25), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(new_n100_), .c(new_n110_), .O(new_n112_));
  oai22  g061(.a(new_n112_), .b(new_n76_), .c(new_n109_), .d(new_n108_), .O(new_n113_));
  nand3  g062(.a(new_n113_), .b(new_n61_), .c(x16), .O(new_n114_));
  nand2  g063(.a(new_n114_), .b(new_n107_), .O(z07));
  oai21  g064(.a(new_n112_), .b(new_n76_), .c(x27), .O(new_n116_));
  ...
  aoi21  g078(.a(new_n129_), .b(new_n126_), .c(new_n62_), .O(new_n130_));
  ...
  nand4  g084(.a(new_n135_), .b(new_n101_), .c(new_n108_), .d(new_n134_), .O(new_n136_));
  ...
  nand4  g088(.a(new_n139_), .b(new_n138_), .c(new_n86_), .d(new_n82_), .O(new_n140_));
  aoi21  g089(.a(new_n140_), .b(new_n137_), .c(new_n62_), .O(new_n141_));
  ...
  nand4  g095(.a(new_n135_), .b(new_n138_), .c(new_n146_), .d(new_n145_), .O(new_n147_));
  ...
  oai21  g112(.a(new_n163_), .b(new_n94_), .c(x32), .O(new_n164_));
  nor2   g113(.a(x32), .b(x31), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n146_), .c(new_n145_), .O(new_n166_));
  inv1   g115(.a(new_n166_), .O(new_n167_));
  nand4  g116(.a(new_n167_), .b(new_n135_), .c(new_n111_), .d(new_n154_), .O(new_n168_));
  ...
  oai21  g128(.a(new_n177_), .b(new_n62_), .c(new_n179_), .O(z14));
  ...
  oai22  g134(.a(new_n185_), .b(new_n102_), .c(new_n176_), .d(new_n181_), .O(new_n186_));
