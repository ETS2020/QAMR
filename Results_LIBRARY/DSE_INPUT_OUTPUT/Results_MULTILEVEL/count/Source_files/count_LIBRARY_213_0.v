...
module FAU ( 
  ...
  oai21  g016(.a(new_n67_), .b(new_n66_), .c(x28), .O(new_n68_));
  nand2  g017(.a(new_n68_), .b(new_n59_), .O(z01));
  inv1   g018(.a(x28), .O(new_n70_));
  ...
  nand3  g035(.a(new_n86_), .b(new_n72_), .c(new_n71_), .O(new_n87_));
  ...
  nand3  g051(.a(new_n86_), .b(new_n100_), .c(new_n102_), .O(new_n103_));
  ...
  nand3  g059(.a(new_n110_), .b(new_n86_), .c(new_n102_), .O(new_n111_));
  oai22  g060(.a(new_n111_), .b(new_n73_), .c(new_n104_), .d(new_n109_), .O(new_n112_));
  ...
  oai21  g071(.a(new_n122_), .b(new_n121_), .c(x28), .O(new_n123_));
  ...
  and2   g078(.a(x29), .b(x16), .O(new_n130_));
  oai21  g079(.a(new_n130_), .b(new_n129_), .c(x28), .O(new_n131_));
  nand2  g080(.a(new_n131_), .b(new_n59_), .O(z10));
  nor2   g081(.a(x16), .b(x04), .O(new_n133_));
  and2   g082(.a(x30), .b(x16), .O(new_n134_));
  oai21  g083(.a(new_n134_), .b(new_n133_), .c(x28), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n59_), .O(z11));
  nand2  g085(.a(x31), .b(x16), .O(new_n137_));
  inv1   g086(.a(x03), .O(new_n138_));
  nand2  g087(.a(new_n58_), .b(new_n138_), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n137_), .c(x28), .d(new_n59_), .O(z12));
  nor2   g089(.a(x16), .b(x02), .O(new_n141_));
  and2   g090(.a(x32), .b(x16), .O(new_n142_));
  oai21  g091(.a(new_n142_), .b(new_n141_), .c(x28), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n59_), .O(z13));
  nor2   g093(.a(x16), .b(x01), .O(new_n145_));
  and2   g094(.a(x33), .b(x16), .O(new_n146_));
  oai21  g095(.a(new_n146_), .b(new_n145_), .c(x28), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(new_n59_), .O(z14));
  nor2   g097(.a(x16), .b(x00), .O(new_n149_));
  and2   g098(.a(x34), .b(x16), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n149_), .c(x28), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n59_), .O(z15));
endmodule
