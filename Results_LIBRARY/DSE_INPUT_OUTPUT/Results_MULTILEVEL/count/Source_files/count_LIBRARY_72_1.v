...
module FAU ( 
  ...
  nand3  g035(.a(new_n86_), .b(new_n76_), .c(new_n69_), .O(new_n87_));
  ...
  nand4  g051(.a(new_n96_), .b(new_n79_), .c(new_n93_), .d(new_n52_), .O(new_n103_));
  nor2   g052(.a(x21), .b(x20), .O(new_n104_));
  nor2   g053(.a(x25), .b(x24), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n94_), .c(new_n104_), .d(new_n55_), .O(new_n106_));
  nand2  g055(.a(new_n106_), .b(new_n78_), .O(new_n107_));
  aoi21  g056(.a(new_n103_), .b(x25), .c(new_n107_), .O(new_n108_));
  oai22  g057(.a(new_n108_), .b(new_n58_), .c(new_n84_), .d(x09), .O(z06));
  nand2  g058(.a(new_n106_), .b(x26), .O(new_n110_));
  nor3   g059(.a(x26), .b(x25), .c(x24), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(new_n94_), .c(new_n71_), .O(new_n112_));
  nand3  g061(.a(new_n112_), .b(new_n110_), .c(new_n78_), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(x16), .O(new_n114_));
  inv1   g063(.a(x08), .O(new_n115_));
  nand2  g064(.a(new_n83_), .b(new_n115_), .O(new_n116_));
  ...
  nand3  g095(.a(new_n146_), .b(new_n111_), .c(new_n88_), .O(new_n147_));
  nor2   g096(.a(x28), .b(x27), .O(new_n148_));
  nor2   g097(.a(x30), .b(x29), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n148_), .c(new_n138_), .d(new_n136_), .O(new_n150_));
  nor2   g099(.a(new_n150_), .b(new_n95_), .O(new_n151_));
  ...
  nand2  g104(.a(new_n149_), .b(new_n148_), .O(new_n156_));
  inv1   g105(.a(new_n156_), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n111_), .c(new_n88_), .O(new_n158_));
  nor2   g107(.a(x31), .b(x30), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n139_), .c(new_n119_), .d(new_n118_), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n103_), .c(new_n78_), .O(new_n161_));
  aoi21  g110(.a(new_n158_), .b(x31), .c(new_n161_), .O(new_n162_));
  inv1   g111(.a(x03), .O(new_n163_));
  nand2  g112(.a(new_n83_), .b(new_n163_), .O(new_n164_));
  oai21  g113(.a(new_n162_), .b(new_n58_), .c(new_n164_), .O(z12));
  oai21  g114(.a(new_n160_), .b(new_n103_), .c(x32), .O(new_n166_));
  nand2  g115(.a(new_n148_), .b(new_n138_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nor2   g117(.a(x32), .b(x31), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n149_), .O(new_n170_));
  inv1   g119(.a(new_n170_), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n168_), .c(new_n98_), .d(new_n64_), .O(new_n172_));
  nand3  g121(.a(new_n172_), .b(new_n166_), .c(new_n78_), .O(new_n173_));
  ...
  nand4  g126(.a(new_n169_), .b(new_n149_), .c(new_n148_), .d(new_n138_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n103_), .c(x33), .O(new_n179_));
  nand2  g128(.a(new_n105_), .b(new_n94_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nand2  g130(.a(new_n139_), .b(new_n119_), .O(new_n182_));
  inv1   g131(.a(new_n182_), .O(new_n183_));
  nor2   g132(.a(x33), .b(x32), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n159_), .O(new_n185_));
  inv1   g134(.a(new_n185_), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n183_), .c(new_n181_), .d(new_n71_), .O(new_n187_));
  nand3  g136(.a(new_n187_), .b(new_n179_), .c(new_n78_), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(x16), .O(new_n189_));
  inv1   g138(.a(x01), .O(new_n190_));
  nand2  g139(.a(new_n83_), .b(new_n190_), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(new_n189_), .O(z14));
  nand4  g141(.a(new_n184_), .b(new_n159_), .c(new_n139_), .d(new_n119_), .O(new_n193_));
  oai21  g142(.a(new_n193_), .b(new_n106_), .c(x34), .O(new_n194_));
  ...
  nand4  g151(.a(new_n202_), .b(new_n183_), .c(new_n181_), .d(new_n71_), .O(new_n203_));
