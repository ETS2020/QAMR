...
module FAU ( 
  ...
  nand2  g31(.a(new_n66_), .b(new_n82_), .O(new_n83_));
  nand3  g32(.a(new_n83_), .b(new_n81_), .c(new_n68_), .O(z05));
  ...
  nand2  g43(.a(new_n66_), .b(new_n94_), .O(new_n95_));
  nand3  g44(.a(new_n95_), .b(new_n93_), .c(new_n68_), .O(z08));
  ...
  nor2   g53(.a(x16), .b(x04), .O(new_n105_));
  and2   g54(.a(x30), .b(x16), .O(new_n106_));
  oai21  g55(.a(new_n106_), .b(new_n105_), .c(x21), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(new_n52_), .O(z11));
  nand2  g57(.a(x31), .b(x16), .O(new_n109_));
  inv1   g58(.a(x03), .O(new_n110_));
  nand2  g59(.a(new_n66_), .b(new_n110_), .O(new_n111_));
  nand3  g60(.a(new_n111_), .b(new_n109_), .c(new_n68_), .O(z12));
