...
module FAU ( 
  ...
  nand2  g003(.a(x18), .b(x14), .O(new_n55_));
  ...
  nand4  g035(.a(new_n86_), .b(new_n61_), .c(new_n71_), .d(new_n59_), .O(new_n87_));
  ...
  nand4  g053(.a(new_n104_), .b(new_n83_), .c(new_n61_), .d(new_n59_), .O(new_n105_));
  ...
  nand2  g067(.a(new_n118_), .b(new_n55_), .O(z07));
  ...
  nand4  g072(.a(new_n123_), .b(new_n104_), .c(new_n78_), .d(new_n58_), .O(new_n124_));
  ...
  nand2  g076(.a(new_n127_), .b(new_n55_), .O(z08));
  ...
  nand4  g082(.a(new_n133_), .b(new_n132_), .c(new_n78_), .d(new_n58_), .O(new_n134_));
  ...
  nand2  g086(.a(new_n137_), .b(new_n55_), .O(z09));
  ...
  nand2  g104(.a(new_n155_), .b(new_n55_), .O(z11));
  ...
  nand2  g119(.a(new_n170_), .b(new_n55_), .O(z12));
  ...
  nand2  g133(.a(new_n184_), .b(new_n55_), .O(z13));
  ...
  nand2  g147(.a(new_n198_), .b(new_n55_), .O(z14));
