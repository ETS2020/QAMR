...
module FAU ( 
  ...
  oai21  g024(.a(new_n72_), .b(new_n71_), .c(new_n75_), .O(new_n76_));
  ...
  nand3  g030(.a(new_n81_), .b(new_n71_), .c(new_n65_), .O(new_n82_));
  ...
  nand3  g037(.a(new_n88_), .b(new_n73_), .c(new_n65_), .O(new_n89_));
  ...
  aoi21  g042(.a(new_n93_), .b(new_n90_), .c(new_n63_), .O(new_n94_));
  nor2   g043(.a(x16), .b(x11), .O(new_n95_));
  oai21  g044(.a(new_n95_), .b(new_n94_), .c(new_n62_), .O(new_n96_));
  nand2  g045(.a(new_n96_), .b(new_n60_), .O(z04));
  nand2  g046(.a(new_n93_), .b(x24), .O(new_n98_));
  nor2   g047(.a(x24), .b(x23), .O(new_n99_));
  nand3  g048(.a(new_n99_), .b(new_n88_), .c(new_n72_), .O(new_n100_));
  aoi21  g049(.a(new_n100_), .b(new_n98_), .c(new_n63_), .O(new_n101_));
  nor2   g050(.a(x16), .b(x10), .O(new_n102_));
  oai21  g051(.a(new_n102_), .b(new_n101_), .c(new_n62_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(new_n60_), .O(z05));
  nand2  g053(.a(new_n100_), .b(x25), .O(new_n105_));
  nor2   g054(.a(x25), .b(x24), .O(new_n106_));
  nand4  g055(.a(new_n106_), .b(new_n92_), .c(new_n74_), .d(new_n73_), .O(new_n107_));
  ...
  nand4  g060(.a(new_n74_), .b(new_n54_), .c(new_n62_), .d(new_n53_), .O(new_n112_));
  ...
  oai21  g068(.a(new_n117_), .b(new_n63_), .c(new_n119_), .O(z07));
  oai21  g069(.a(new_n115_), .b(new_n75_), .c(x27), .O(new_n121_));
  nor2   g070(.a(new_n82_), .b(new_n55_), .O(new_n122_));
  nor3   g071(.a(x27), .b(x26), .c(x25), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n99_), .c(new_n122_), .O(new_n124_));
  aoi21  g073(.a(new_n124_), .b(new_n121_), .c(new_n63_), .O(new_n125_));
  nor2   g074(.a(x16), .b(x07), .O(new_n126_));
  oai21  g075(.a(new_n126_), .b(new_n125_), .c(new_n62_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(new_n60_), .O(z08));
  inv1   g077(.a(x25), .O(new_n129_));
  nor2   g078(.a(x27), .b(x26), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n99_), .c(new_n129_), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n89_), .c(x28), .O(new_n132_));
  nor3   g081(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nor3   g082(.a(x28), .b(x27), .c(x26), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n133_), .c(new_n122_), .O(new_n135_));
  aoi21  g084(.a(new_n135_), .b(new_n132_), .c(new_n63_), .O(new_n136_));
  nor2   g085(.a(x16), .b(x06), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n136_), .c(new_n62_), .O(new_n138_));
  nand2  g087(.a(new_n138_), .b(new_n60_), .O(z09));
  inv1   g088(.a(x27), .O(new_n140_));
  nor2   g089(.a(x29), .b(x28), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n114_), .c(new_n140_), .d(new_n113_), .O(new_n142_));
  ...
  oai21  g095(.a(new_n144_), .b(new_n63_), .c(new_n146_), .O(z10));
  oai21  g096(.a(new_n142_), .b(new_n93_), .c(x30), .O(new_n148_));
  inv1   g097(.a(x23), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n81_), .c(new_n71_), .O(new_n150_));
  ...
  aoi21  g106(.a(new_n157_), .b(new_n148_), .c(new_n63_), .O(new_n158_));
  nor2   g107(.a(x16), .b(x04), .O(new_n159_));
  oai21  g108(.a(new_n159_), .b(new_n158_), .c(new_n62_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n60_), .O(z11));
  nand2  g110(.a(new_n157_), .b(x31), .O(new_n162_));
  nand2  g111(.a(new_n99_), .b(new_n88_), .O(new_n163_));
  nor2   g112(.a(new_n163_), .b(new_n66_), .O(new_n164_));
  nor2   g113(.a(x31), .b(x30), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n141_), .c(new_n123_), .d(new_n164_), .O(new_n166_));
  ...
  nand4  g121(.a(new_n172_), .b(new_n154_), .c(new_n153_), .d(new_n114_), .O(new_n173_));
  nor2   g122(.a(new_n173_), .b(new_n100_), .O(new_n174_));
  aoi21  g123(.a(new_n166_), .b(x32), .c(new_n174_), .O(new_n175_));
  inv1   g124(.a(x02), .O(new_n176_));
  aoi21  g125(.a(new_n63_), .b(new_n176_), .c(x18), .O(new_n177_));
  oai21  g126(.a(new_n175_), .b(new_n63_), .c(new_n177_), .O(z13));
  oai21  g127(.a(x18), .b(new_n63_), .c(new_n59_), .O(new_n179_));
  oai21  g128(.a(new_n173_), .b(new_n100_), .c(x33), .O(new_n180_));
  nor2   g129(.a(x33), .b(x32), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n165_), .c(new_n141_), .d(new_n130_), .O(new_n182_));
  or2    g131(.a(new_n182_), .b(new_n107_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(new_n180_), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n62_), .c(x16), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(new_n179_), .O(z14));
  oai21  g135(.a(new_n182_), .b(new_n107_), .c(x34), .O(new_n187_));
  nand2  g136(.a(new_n141_), .b(new_n130_), .O(new_n188_));
  inv1   g137(.a(new_n188_), .O(new_n189_));
  nor3   g138(.a(x34), .b(x33), .c(x32), .O(new_n190_));
  nand3  g139(.a(new_n190_), .b(new_n189_), .c(new_n165_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n107_), .c(new_n187_), .O(new_n192_));
  nand2  g141(.a(new_n192_), .b(x16), .O(new_n193_));
  inv1   g142(.a(x00), .O(new_n194_));
  aoi21  g143(.a(new_n63_), .b(new_n194_), .c(x18), .O(new_n195_));
