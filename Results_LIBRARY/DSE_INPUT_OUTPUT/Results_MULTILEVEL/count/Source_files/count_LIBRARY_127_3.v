...
module FAU ( 
  ...
  nand4  g036(.a(new_n87_), .b(new_n86_), .c(new_n67_), .d(new_n52_), .O(new_n88_));
  ...
  nand4  g045(.a(new_n96_), .b(new_n83_), .c(new_n86_), .d(new_n52_), .O(new_n97_));
  aoi21  g046(.a(new_n97_), .b(new_n95_), .c(new_n58_), .O(new_n98_));
  nor2   g047(.a(x16), .b(x10), .O(new_n99_));
  oai21  g048(.a(new_n99_), .b(new_n98_), .c(new_n81_), .O(new_n100_));
  nand2  g049(.a(new_n100_), .b(new_n93_), .O(z05));
  nand2  g050(.a(new_n97_), .b(x25), .O(new_n102_));
  nor2   g051(.a(x25), .b(x24), .O(new_n103_));
  nand4  g052(.a(new_n103_), .b(new_n87_), .c(new_n69_), .d(new_n55_), .O(new_n104_));
  aoi21  g053(.a(new_n104_), .b(new_n102_), .c(new_n58_), .O(new_n105_));
  nor2   g054(.a(x16), .b(x09), .O(new_n106_));
  oai21  g055(.a(new_n106_), .b(new_n105_), .c(new_n81_), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(new_n93_), .O(z06));
  nand4  g057(.a(new_n69_), .b(new_n53_), .c(new_n81_), .d(new_n52_), .O(new_n109_));
  inv1   g058(.a(x24), .O(new_n110_));
  nor2   g059(.a(x26), .b(x25), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(new_n87_), .c(new_n110_), .O(new_n112_));
  nor2   g061(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  aoi21  g062(.a(new_n104_), .b(x26), .c(new_n113_), .O(new_n114_));
  ...
  oai21  g066(.a(new_n112_), .b(new_n70_), .c(x27), .O(new_n118_));
  nor3   g067(.a(x27), .b(x26), .c(x25), .O(new_n119_));
  nand4  g068(.a(new_n119_), .b(new_n96_), .c(new_n76_), .d(new_n55_), .O(new_n120_));
  aoi21  g069(.a(new_n120_), .b(new_n118_), .c(new_n58_), .O(new_n121_));
  nor2   g070(.a(x16), .b(x07), .O(new_n122_));
  oai21  g071(.a(new_n122_), .b(new_n121_), .c(new_n81_), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(new_n93_), .O(z08));
  ...
  oai21  g082(.a(new_n133_), .b(new_n132_), .c(new_n81_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n93_), .O(z09));
  ...
  nand4  g088(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n62_), .O(new_n140_));
  ...
  nand4  g095(.a(new_n146_), .b(new_n145_), .c(new_n111_), .d(new_n110_), .O(new_n147_));
  ...
  nand4  g101(.a(new_n87_), .b(new_n69_), .c(new_n55_), .d(x16), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n147_), .c(new_n81_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n92_), .O(new_n155_));
  oai21  g104(.a(new_n147_), .b(new_n88_), .c(x31), .O(new_n156_));
  inv1   g105(.a(x03), .O(new_n157_));
  nand2  g106(.a(new_n58_), .b(new_n157_), .O(new_n158_));
  oai21  g107(.a(new_n156_), .b(new_n58_), .c(new_n158_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n81_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n155_), .O(z12));
  nor2   g110(.a(x29), .b(x28), .O(new_n162_));
  nor2   g111(.a(x32), .b(x30), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n162_), .c(new_n126_), .d(new_n103_), .O(new_n164_));
  oai21  g113(.a(new_n164_), .b(new_n153_), .c(new_n81_), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(new_n92_), .O(new_n166_));
  nor2   g115(.a(x31), .b(x30), .O(new_n167_));
  nand4  g116(.a(new_n167_), .b(new_n162_), .c(new_n126_), .d(new_n125_), .O(new_n168_));
  ...
  nand2  g122(.a(new_n173_), .b(new_n166_), .O(z13));
  nor2   g123(.a(x17), .b(new_n58_), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n96_), .c(new_n83_), .d(new_n86_), .O(new_n176_));
  nand2  g125(.a(new_n145_), .b(new_n111_), .O(new_n177_));
  inv1   g126(.a(new_n177_), .O(new_n178_));
  nor2   g127(.a(x33), .b(x32), .O(new_n179_));
  nand3  g128(.a(new_n179_), .b(new_n178_), .c(new_n146_), .O(new_n180_));
  oai21  g129(.a(new_n180_), .b(new_n176_), .c(new_n81_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n92_), .O(new_n182_));
  nor2   g131(.a(x32), .b(x31), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n146_), .c(new_n145_), .d(new_n111_), .O(new_n184_));
  ...
  oai21  g136(.a(new_n185_), .b(new_n58_), .c(new_n187_), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(new_n81_), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(new_n182_), .O(z14));
  nor3   g139(.a(x34), .b(x33), .c(x32), .O(new_n191_));
  nand3  g140(.a(new_n191_), .b(new_n178_), .c(new_n146_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n176_), .c(new_n81_), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(new_n92_), .O(new_n194_));
  nand4  g143(.a(new_n179_), .b(new_n167_), .c(new_n162_), .d(new_n126_), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n104_), .c(x34), .O(new_n196_));
  inv1   g145(.a(x00), .O(new_n197_));
  nand2  g146(.a(new_n58_), .b(new_n197_), .O(new_n198_));
  oai21  g147(.a(new_n196_), .b(new_n58_), .c(new_n198_), .O(new_n199_));
