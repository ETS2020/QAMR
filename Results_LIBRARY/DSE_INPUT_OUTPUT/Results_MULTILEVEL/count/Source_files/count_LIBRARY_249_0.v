...
module FAU ( 
  ...
  nand2  g08(.a(x24), .b(new_n59_), .O(new_n60_));
  ...
  nor3   g24(.a(x22), .b(x21), .c(x20), .O(new_n76_));
  aoi22  g25(.a(new_n76_), .b(new_n55_), .c(new_n75_), .d(x22), .O(new_n77_));
  nor2   g26(.a(x16), .b(x12), .O(new_n78_));
  nor2   g27(.a(new_n78_), .b(new_n60_), .O(new_n79_));
  oai21  g28(.a(new_n77_), .b(new_n58_), .c(new_n79_), .O(z03));
  nor3   g29(.a(x20), .b(x19), .c(x17), .O(new_n81_));
  nor2   g30(.a(x22), .b(x21), .O(new_n82_));
  nand3  g31(.a(new_n82_), .b(new_n55_), .c(new_n64_), .O(new_n83_));
  nor3   g32(.a(x23), .b(x22), .c(x21), .O(new_n84_));
  aoi22  g33(.a(new_n84_), .b(new_n81_), .c(new_n83_), .d(x23), .O(new_n85_));
  nor2   g34(.a(x16), .b(x11), .O(new_n86_));
  nor2   g35(.a(new_n86_), .b(new_n60_), .O(new_n87_));
  oai21  g36(.a(new_n85_), .b(new_n58_), .c(new_n87_), .O(z04));
  inv1   g37(.a(x24), .O(new_n89_));
  inv1   g38(.a(x21), .O(new_n90_));
  nor2   g39(.a(x20), .b(x19), .O(new_n91_));
  nor2   g40(.a(x23), .b(x22), .O(new_n92_));
  nand4  g41(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n52_), .O(new_n93_));
  nor2   g42(.a(x16), .b(x10), .O(new_n94_));
  aoi21  g43(.a(new_n93_), .b(x16), .c(new_n94_), .O(new_n95_));
  oai21  g44(.a(new_n95_), .b(new_n89_), .c(new_n59_), .O(z05));
  inv1   g45(.a(new_n60_), .O(new_n97_));
  nand2  g46(.a(x25), .b(x16), .O(new_n98_));
  inv1   g47(.a(x09), .O(new_n99_));
  nand2  g48(.a(new_n58_), .b(new_n99_), .O(new_n100_));
  nand3  g49(.a(new_n100_), .b(new_n98_), .c(new_n97_), .O(z06));
  nand2  g50(.a(x26), .b(x16), .O(new_n102_));
  inv1   g51(.a(x08), .O(new_n103_));
  nand2  g52(.a(new_n58_), .b(new_n103_), .O(new_n104_));
  nand3  g53(.a(new_n104_), .b(new_n102_), .c(new_n97_), .O(z07));
  nand2  g54(.a(x27), .b(x16), .O(new_n106_));
  inv1   g55(.a(x07), .O(new_n107_));
  nand2  g56(.a(new_n58_), .b(new_n107_), .O(new_n108_));
  nand3  g57(.a(new_n108_), .b(new_n106_), .c(new_n97_), .O(z08));
  nor2   g58(.a(x16), .b(x06), .O(new_n110_));
  and2   g59(.a(x28), .b(x16), .O(new_n111_));
  oai21  g60(.a(new_n111_), .b(new_n110_), .c(x24), .O(new_n112_));
  nand2  g61(.a(new_n112_), .b(new_n59_), .O(z09));
  nand2  g62(.a(x29), .b(x16), .O(new_n114_));
  inv1   g63(.a(x05), .O(new_n115_));
  nand2  g64(.a(new_n58_), .b(new_n115_), .O(new_n116_));
  nand3  g65(.a(new_n116_), .b(new_n114_), .c(new_n97_), .O(z10));
  nor2   g66(.a(x16), .b(x04), .O(new_n118_));
  and2   g67(.a(x30), .b(x16), .O(new_n119_));
  oai21  g68(.a(new_n119_), .b(new_n118_), .c(x24), .O(new_n120_));
  nand2  g69(.a(new_n120_), .b(new_n59_), .O(z11));
  nor2   g70(.a(x16), .b(x03), .O(new_n122_));
  and2   g71(.a(x31), .b(x16), .O(new_n123_));
  oai21  g72(.a(new_n123_), .b(new_n122_), .c(x24), .O(new_n124_));
  nand2  g73(.a(new_n124_), .b(new_n59_), .O(z12));
  nand2  g74(.a(x32), .b(x16), .O(new_n126_));
  inv1   g75(.a(x02), .O(new_n127_));
  nand2  g76(.a(new_n58_), .b(new_n127_), .O(new_n128_));
  nand3  g77(.a(new_n128_), .b(new_n126_), .c(new_n97_), .O(z13));
  nand2  g78(.a(x33), .b(x16), .O(new_n130_));
  inv1   g79(.a(x01), .O(new_n131_));
  nand2  g80(.a(new_n58_), .b(new_n131_), .O(new_n132_));
  nand3  g81(.a(new_n132_), .b(new_n130_), .c(new_n97_), .O(z14));
  nor2   g82(.a(x16), .b(x00), .O(new_n134_));
  and2   g83(.a(x34), .b(x16), .O(new_n135_));
  oai21  g84(.a(new_n135_), .b(new_n134_), .c(x24), .O(new_n136_));
