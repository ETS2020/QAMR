...
module FAU ( 
  ...
  nand2  g016(.a(x18), .b(x12), .O(new_n68_));
  ...
  nand4  g053(.a(new_n104_), .b(new_n95_), .c(new_n85_), .d(new_n84_), .O(new_n105_));
  ...
  nand3  g064(.a(new_n115_), .b(new_n93_), .c(new_n72_), .O(new_n116_));
  ...
  oai21  g075(.a(new_n121_), .b(new_n79_), .c(x28), .O(new_n127_));
  ...
  nand2  g111(.a(new_n162_), .b(new_n68_), .O(z12));
  ...
  nand2  g124(.a(new_n175_), .b(new_n68_), .O(z13));
