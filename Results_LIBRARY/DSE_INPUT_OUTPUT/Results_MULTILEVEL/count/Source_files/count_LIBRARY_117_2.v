...
module FAU ( 
  ...
  oai21  g004(.a(new_n55_), .b(x13), .c(new_n52_), .O(z00));
  ...
  nand4  g019(.a(new_n67_), .b(new_n58_), .c(new_n70_), .d(new_n69_), .O(new_n71_));
  nand2  g020(.a(new_n71_), .b(x16), .O(new_n72_));
  oai21  g021(.a(new_n72_), .b(new_n68_), .c(new_n57_), .O(new_n73_));
  ...
  aoi21  g026(.a(new_n77_), .b(new_n75_), .c(new_n64_), .O(new_n78_));
  nor2   g027(.a(x16), .b(x12), .O(new_n79_));
  oai21  g028(.a(new_n79_), .b(new_n78_), .c(new_n57_), .O(new_n80_));
  nand2  g029(.a(new_n80_), .b(new_n52_), .O(z03));
  nand2  g030(.a(new_n77_), .b(x23), .O(new_n82_));
  nor2   g031(.a(x23), .b(x22), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n61_), .c(new_n67_), .O(new_n84_));
  aoi21  g033(.a(new_n84_), .b(new_n82_), .c(new_n64_), .O(new_n85_));
  nor2   g034(.a(x16), .b(x11), .O(new_n86_));
  oai21  g035(.a(new_n86_), .b(new_n85_), .c(new_n57_), .O(new_n87_));
  ...
  nand3  g040(.a(new_n91_), .b(new_n90_), .c(new_n61_), .O(new_n92_));
  aoi21  g041(.a(new_n92_), .b(new_n89_), .c(new_n64_), .O(new_n93_));
  nor2   g042(.a(x16), .b(x10), .O(new_n94_));
  oai21  g043(.a(new_n94_), .b(new_n93_), .c(new_n57_), .O(new_n95_));
  ...
  nand4  g049(.a(new_n100_), .b(new_n83_), .c(new_n99_), .d(new_n59_), .O(new_n101_));
  oai21  g050(.a(new_n98_), .b(new_n97_), .c(new_n101_), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(x16), .O(new_n103_));
  inv1   g052(.a(x09), .O(new_n104_));
  aoi21  g053(.a(new_n64_), .b(new_n104_), .c(x18), .O(new_n105_));
  nand3  g054(.a(new_n105_), .b(new_n103_), .c(new_n57_), .O(z06));
  nand2  g055(.a(new_n101_), .b(x26), .O(new_n107_));
  inv1   g056(.a(x24), .O(new_n108_));
  nor2   g057(.a(x26), .b(x25), .O(new_n109_));
  nand3  g058(.a(new_n109_), .b(new_n83_), .c(new_n108_), .O(new_n110_));
  oai21  g059(.a(new_n110_), .b(new_n71_), .c(new_n107_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(x16), .O(new_n112_));
  inv1   g061(.a(x08), .O(new_n113_));
  aoi21  g062(.a(new_n64_), .b(new_n113_), .c(x18), .O(new_n114_));
  nand3  g063(.a(new_n114_), .b(new_n112_), .c(new_n57_), .O(z07));
  oai21  g064(.a(new_n110_), .b(new_n71_), .c(x27), .O(new_n116_));
  nor3   g065(.a(x27), .b(x26), .c(x25), .O(new_n117_));
  nand4  g066(.a(new_n117_), .b(new_n91_), .c(new_n76_), .d(new_n59_), .O(new_n118_));
  aoi21  g067(.a(new_n118_), .b(new_n116_), .c(new_n64_), .O(new_n119_));
  ...
  nand2  g071(.a(new_n118_), .b(x28), .O(new_n123_));
  nor3   g072(.a(x25), .b(x24), .c(x23), .O(new_n124_));
  nor3   g073(.a(x28), .b(x27), .c(x26), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n124_), .c(new_n76_), .d(new_n59_), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(x16), .O(new_n128_));
  inv1   g077(.a(x06), .O(new_n129_));
  aoi21  g078(.a(new_n64_), .b(new_n129_), .c(x18), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n128_), .c(new_n57_), .O(z09));
  nand2  g080(.a(new_n126_), .b(x29), .O(new_n132_));
  nor3   g081(.a(x23), .b(x22), .c(x21), .O(new_n133_));
  nor3   g082(.a(x26), .b(x25), .c(x24), .O(new_n134_));
  nor3   g083(.a(x29), .b(x28), .c(x27), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n61_), .O(new_n136_));
  and2   g085(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nor2   g086(.a(x16), .b(x05), .O(new_n138_));
  nor3   g087(.a(new_n138_), .b(x18), .c(x13), .O(new_n139_));
  oai21  g088(.a(new_n137_), .b(new_n64_), .c(new_n139_), .O(z10));
  ...
  nor3   g095(.a(new_n146_), .b(x18), .c(x13), .O(new_n147_));
  oai21  g096(.a(new_n145_), .b(new_n64_), .c(new_n147_), .O(z11));
  ...
  oai22  g101(.a(new_n152_), .b(new_n92_), .c(new_n144_), .d(new_n149_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(x16), .O(new_n154_));
  nor2   g103(.a(x16), .b(x03), .O(new_n155_));
  nor3   g104(.a(new_n155_), .b(x18), .c(x13), .O(new_n156_));
  ...
  oai21  g109(.a(new_n160_), .b(new_n92_), .c(new_n158_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(x16), .O(new_n162_));
  inv1   g111(.a(x02), .O(new_n163_));
  aoi21  g112(.a(new_n64_), .b(new_n163_), .c(x18), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n162_), .c(new_n57_), .O(z13));
  oai21  g114(.a(new_n160_), .b(new_n92_), .c(x33), .O(new_n166_));
  nor2   g115(.a(x27), .b(x26), .O(new_n167_));
  nor2   g116(.a(x33), .b(x32), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n151_), .c(new_n150_), .d(new_n167_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n101_), .c(new_n166_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(x16), .O(new_n171_));
  inv1   g120(.a(x01), .O(new_n172_));
  aoi21  g121(.a(new_n64_), .b(new_n172_), .c(x18), .O(new_n173_));
  nand3  g122(.a(new_n173_), .b(new_n171_), .c(new_n57_), .O(z14));
  oai21  g123(.a(new_n169_), .b(new_n101_), .c(x34), .O(new_n175_));
  inv1   g124(.a(x22), .O(new_n176_));
  inv1   g125(.a(x23), .O(new_n177_));
  nand4  g126(.a(new_n97_), .b(new_n108_), .c(new_n177_), .d(new_n176_), .O(new_n178_));
  nor2   g127(.a(new_n178_), .b(new_n71_), .O(new_n179_));
  nand2  g128(.a(new_n150_), .b(new_n167_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  inv1   g130(.a(x30), .O(new_n182_));
  nand2  g131(.a(new_n149_), .b(new_n182_), .O(new_n183_));
  ...
  nand3  g137(.a(new_n188_), .b(new_n181_), .c(new_n179_), .O(new_n189_));
  aoi21  g138(.a(new_n189_), .b(new_n175_), .c(new_n64_), .O(new_n190_));
