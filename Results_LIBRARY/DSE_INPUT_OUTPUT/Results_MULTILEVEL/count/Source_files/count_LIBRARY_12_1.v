...
module FAU ( 
  ...
  aoi21  g056(.a(new_n65_), .b(new_n107_), .c(x18), .O(new_n108_));
  ...
  oai21  g066(.a(new_n112_), .b(new_n79_), .c(x28), .O(new_n118_));
  inv1   g067(.a(x23), .O(new_n119_));
  inv1   g068(.a(x26), .O(new_n120_));
  nor2   g069(.a(x28), .b(x27), .O(new_n121_));
  nand4  g070(.a(new_n121_), .b(new_n97_), .c(new_n120_), .d(new_n119_), .O(new_n122_));
  oai21  g071(.a(new_n122_), .b(new_n79_), .c(new_n118_), .O(new_n123_));
  ...
  oai21  g076(.a(new_n122_), .b(new_n79_), .c(x29), .O(new_n128_));
  nand3  g077(.a(new_n119_), .b(new_n75_), .c(new_n68_), .O(new_n129_));
  ...
  nand2  g084(.a(new_n54_), .b(new_n135_), .O(new_n136_));
  ...
  nand3  g095(.a(new_n146_), .b(new_n103_), .c(new_n130_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n143_), .c(new_n77_), .O(new_n148_));
  ...
  nand4  g102(.a(new_n153_), .b(new_n141_), .c(new_n111_), .d(new_n110_), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n90_), .c(new_n77_), .O(new_n155_));
  aoi21  g104(.a(new_n147_), .b(x31), .c(new_n155_), .O(new_n156_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n144_), .c(new_n121_), .d(new_n140_), .O(new_n162_));
  ...
  aoi21  g116(.a(new_n65_), .b(new_n167_), .c(x18), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n166_), .O(z13));
  oai21  g118(.a(new_n162_), .b(new_n90_), .c(x33), .O(new_n170_));
  nand4  g119(.a(new_n110_), .b(new_n138_), .c(new_n119_), .d(new_n75_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(new_n69_), .O(new_n172_));
  nor2   g121(.a(x33), .b(x32), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n153_), .c(new_n141_), .d(new_n111_), .O(new_n174_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n98_), .c(x34), .O(new_n182_));
  nand2  g131(.a(new_n141_), .b(new_n111_), .O(new_n183_));
  ...
  aoi21  g145(.a(new_n65_), .b(new_n196_), .c(x18), .O(new_n197_));
