...
module FAU ( 
  ...
  nand4  g043(.a(new_n94_), .b(new_n93_), .c(new_n71_), .d(new_n52_), .O(new_n95_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n79_), .c(new_n93_), .d(new_n52_), .O(new_n104_));
  nand2  g053(.a(new_n104_), .b(x25), .O(new_n105_));
  nor2   g054(.a(x21), .b(x20), .O(new_n106_));
  nor2   g055(.a(x25), .b(x24), .O(new_n107_));
  nand4  g056(.a(new_n107_), .b(new_n94_), .c(new_n106_), .d(new_n55_), .O(new_n108_));
  ...
  nand2  g060(.a(new_n111_), .b(new_n69_), .O(z06));
  ...
  nand4  g067(.a(new_n118_), .b(new_n114_), .c(new_n106_), .d(new_n53_), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(new_n113_), .O(new_n120_));
  nand2  g069(.a(new_n120_), .b(x16), .O(new_n121_));
  aoi21  g070(.a(new_n58_), .b(new_n68_), .c(x18), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n121_), .O(z07));
  nand2  g072(.a(new_n118_), .b(new_n73_), .O(new_n124_));
  inv1   g073(.a(x25), .O(new_n125_));
  nor2   g074(.a(x27), .b(x26), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n103_), .c(new_n125_), .O(new_n127_));
  ...
  oai21  g081(.a(new_n127_), .b(new_n80_), .c(x28), .O(new_n133_));
  ...
  aoi21  g086(.a(new_n137_), .b(new_n133_), .c(new_n58_), .O(new_n138_));
  nor2   g087(.a(x16), .b(x06), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n138_), .c(new_n61_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n69_), .O(z09));
  nand2  g090(.a(new_n137_), .b(x29), .O(new_n142_));
  inv1   g091(.a(x27), .O(new_n143_));
  inv1   g092(.a(new_n117_), .O(new_n144_));
  nor2   g093(.a(x29), .b(x28), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n144_), .c(new_n88_), .d(new_n143_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n142_), .c(new_n58_), .O(new_n147_));
  nor2   g096(.a(x16), .b(x05), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n147_), .c(new_n61_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(new_n69_), .O(z10));
  nand4  g099(.a(new_n145_), .b(new_n116_), .c(new_n143_), .d(new_n96_), .O(new_n151_));
  oai21  g100(.a(new_n151_), .b(new_n95_), .c(x30), .O(new_n152_));
  nor2   g101(.a(x28), .b(x27), .O(new_n153_));
  nor2   g102(.a(x30), .b(x29), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n153_), .c(new_n144_), .d(new_n88_), .O(new_n155_));
  ...
  nand2  g107(.a(new_n158_), .b(new_n69_), .O(z11));
  nand4  g108(.a(new_n154_), .b(new_n153_), .c(new_n116_), .d(new_n96_), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n95_), .c(x31), .O(new_n161_));
  nor3   g110(.a(x27), .b(x26), .c(x25), .O(new_n162_));
  nor2   g111(.a(x31), .b(x30), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n145_), .O(new_n164_));
  inv1   g113(.a(new_n164_), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n162_), .c(new_n98_), .O(new_n166_));
  aoi21  g115(.a(new_n166_), .b(new_n161_), .c(new_n58_), .O(new_n167_));
  nor2   g116(.a(x16), .b(x03), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n167_), .c(new_n61_), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n69_), .O(z12));
  nand4  g119(.a(new_n163_), .b(new_n145_), .c(new_n126_), .d(new_n125_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n104_), .c(x32), .O(new_n172_));
  nand2  g121(.a(new_n153_), .b(new_n116_), .O(new_n173_));
  inv1   g122(.a(new_n173_), .O(new_n174_));
  inv1   g123(.a(x31), .O(new_n175_));
  inv1   g124(.a(x32), .O(new_n176_));
  nand3  g125(.a(new_n154_), .b(new_n176_), .c(new_n175_), .O(new_n177_));
  inv1   g126(.a(new_n177_), .O(new_n178_));
  nand3  g127(.a(new_n178_), .b(new_n174_), .c(new_n98_), .O(new_n179_));
  aoi21  g128(.a(new_n179_), .b(new_n172_), .c(new_n58_), .O(new_n180_));
  nor2   g129(.a(x16), .b(x02), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n180_), .c(new_n61_), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n69_), .O(z13));
  nand2  g132(.a(new_n179_), .b(x33), .O(new_n184_));
  nor2   g133(.a(x33), .b(x32), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n163_), .c(new_n145_), .d(new_n126_), .O(new_n186_));
  or2    g135(.a(new_n186_), .b(new_n108_), .O(new_n187_));
  ...
  oai21  g141(.a(new_n186_), .b(new_n108_), .c(x34), .O(new_n193_));
  nand4  g142(.a(new_n125_), .b(new_n96_), .c(new_n86_), .d(new_n85_), .O(new_n194_));
  nor2   g143(.a(new_n194_), .b(new_n72_), .O(new_n195_));
  nand2  g144(.a(new_n145_), .b(new_n126_), .O(new_n196_));
  inv1   g145(.a(new_n196_), .O(new_n197_));
  inv1   g146(.a(x30), .O(new_n198_));
  nand2  g147(.a(new_n175_), .b(new_n198_), .O(new_n199_));
  ...
  nand3  g152(.a(new_n203_), .b(new_n197_), .c(new_n195_), .O(new_n204_));
  aoi21  g153(.a(new_n204_), .b(new_n193_), .c(new_n58_), .O(new_n205_));
  nor2   g154(.a(x16), .b(x00), .O(new_n206_));
  oai21  g155(.a(new_n206_), .b(new_n205_), .c(new_n61_), .O(new_n207_));
  nand2  g156(.a(new_n207_), .b(new_n69_), .O(z15));
endmodule
