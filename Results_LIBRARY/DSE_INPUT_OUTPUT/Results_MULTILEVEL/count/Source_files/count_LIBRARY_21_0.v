...
module FAU ( 
  ...
  nand3  g017(.a(new_n68_), .b(new_n65_), .c(x01), .O(z01));
  ...
  nor3   g028(.a(new_n79_), .b(x18), .c(new_n52_), .O(new_n80_));
  oai21  g029(.a(new_n78_), .b(new_n67_), .c(new_n80_), .O(z03));
  nand2  g030(.a(new_n77_), .b(new_n59_), .O(new_n82_));
  ...
  nand4  g043(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n61_), .O(new_n95_));
  oai21  g044(.a(new_n86_), .b(new_n91_), .c(new_n95_), .O(new_n96_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n91_), .c(new_n84_), .d(new_n83_), .O(new_n102_));
  ...
  nor3   g054(.a(new_n105_), .b(x18), .c(new_n52_), .O(new_n106_));
  oai21  g055(.a(new_n104_), .b(new_n67_), .c(new_n106_), .O(z06));
  nor2   g056(.a(x23), .b(x22), .O(new_n108_));
  nor2   g057(.a(x25), .b(x24), .O(new_n109_));
  nand4  g058(.a(new_n109_), .b(new_n108_), .c(new_n70_), .d(new_n59_), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(x26), .O(new_n111_));
  nor2   g060(.a(x26), .b(x25), .O(new_n112_));
  nand3  g061(.a(new_n112_), .b(new_n108_), .c(new_n91_), .O(new_n113_));
  oai21  g062(.a(new_n113_), .b(new_n76_), .c(new_n111_), .O(new_n114_));
  nand2  g063(.a(new_n114_), .b(x16), .O(new_n115_));
  inv1   g064(.a(x08), .O(new_n116_));
  aoi21  g065(.a(new_n67_), .b(new_n116_), .c(x18), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n115_), .c(x01), .O(z07));
  oai21  g067(.a(new_n113_), .b(new_n76_), .c(x27), .O(new_n119_));
  nor3   g068(.a(x27), .b(x26), .c(x25), .O(new_n120_));
  nand4  g069(.a(new_n120_), .b(new_n94_), .c(new_n77_), .d(new_n59_), .O(new_n121_));
  aoi21  g070(.a(new_n121_), .b(new_n119_), .c(new_n67_), .O(new_n122_));
  nor2   g071(.a(x16), .b(x07), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n122_), .c(x01), .O(new_n124_));
  ...
  nand4  g077(.a(new_n128_), .b(new_n127_), .c(new_n77_), .d(new_n59_), .O(new_n129_));
  ...
  nand3  g082(.a(new_n133_), .b(new_n131_), .c(x01), .O(z09));
  nand4  g083(.a(new_n108_), .b(new_n92_), .c(new_n75_), .d(new_n61_), .O(new_n135_));
  inv1   g084(.a(x27), .O(new_n136_));
  nor2   g085(.a(x29), .b(x28), .O(new_n137_));
  nand4  g086(.a(new_n137_), .b(new_n112_), .c(new_n136_), .d(new_n91_), .O(new_n138_));
  ...
  nor3   g090(.a(new_n141_), .b(x18), .c(new_n52_), .O(new_n142_));
  oai21  g091(.a(new_n140_), .b(new_n67_), .c(new_n142_), .O(z10));
  oai21  g092(.a(new_n138_), .b(new_n135_), .c(x30), .O(new_n144_));
  nor3   g093(.a(x26), .b(x25), .c(x24), .O(new_n145_));
  nor2   g094(.a(x28), .b(x27), .O(new_n146_));
  nor2   g095(.a(x30), .b(x29), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n86_), .O(new_n148_));
  aoi21  g097(.a(new_n148_), .b(new_n144_), .c(new_n67_), .O(new_n149_));
  nor2   g098(.a(x16), .b(x04), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n149_), .c(x01), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n53_), .O(z11));
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n112_), .d(new_n91_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n135_), .c(x31), .O(new_n154_));
  nand2  g103(.a(new_n94_), .b(new_n93_), .O(new_n155_));
  ...
  aoi21  g109(.a(new_n160_), .b(new_n154_), .c(new_n67_), .O(new_n161_));
  nor2   g110(.a(x16), .b(x03), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n161_), .c(x01), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n53_), .O(z12));
  nor2   g113(.a(x27), .b(x26), .O(new_n165_));
  nand4  g114(.a(new_n157_), .b(new_n137_), .c(new_n165_), .d(new_n101_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n95_), .c(x32), .O(new_n167_));
  nand2  g116(.a(new_n146_), .b(new_n112_), .O(new_n168_));
  inv1   g117(.a(new_n168_), .O(new_n169_));
  inv1   g118(.a(x31), .O(new_n170_));
  inv1   g119(.a(x32), .O(new_n171_));
  nand3  g120(.a(new_n147_), .b(new_n171_), .c(new_n170_), .O(new_n172_));
  inv1   g121(.a(new_n172_), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n169_), .c(new_n156_), .d(new_n64_), .O(new_n174_));
  aoi21  g123(.a(new_n174_), .b(new_n167_), .c(new_n67_), .O(new_n175_));
  nor2   g124(.a(x16), .b(x02), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n175_), .c(x01), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n53_), .O(z13));
  nand2  g127(.a(new_n174_), .b(x33), .O(new_n179_));
  nor2   g128(.a(x33), .b(x32), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n157_), .c(new_n137_), .d(new_n165_), .O(new_n181_));
  or2    g130(.a(new_n181_), .b(new_n110_), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n179_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(x16), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n53_), .c(x01), .O(z14));
  oai21  g134(.a(new_n181_), .b(new_n110_), .c(x34), .O(new_n186_));
  nand2  g135(.a(new_n137_), .b(new_n165_), .O(new_n187_));
  inv1   g136(.a(new_n187_), .O(new_n188_));
  inv1   g137(.a(x30), .O(new_n189_));
  nand2  g138(.a(new_n170_), .b(new_n189_), .O(new_n190_));
  inv1   g139(.a(x33), .O(new_n191_));
  inv1   g140(.a(x34), .O(new_n192_));
  nand3  g141(.a(new_n192_), .b(new_n191_), .c(new_n171_), .O(new_n193_));
  nor2   g142(.a(new_n193_), .b(new_n190_), .O(new_n194_));
  nand3  g143(.a(new_n194_), .b(new_n188_), .c(new_n103_), .O(new_n195_));
  aoi21  g144(.a(new_n195_), .b(new_n186_), .c(new_n67_), .O(new_n196_));
  nor2   g145(.a(x16), .b(x00), .O(new_n197_));
  oai21  g146(.a(new_n197_), .b(new_n196_), .c(x01), .O(new_n198_));
  nand2  g147(.a(new_n198_), .b(new_n53_), .O(z15));
endmodule
