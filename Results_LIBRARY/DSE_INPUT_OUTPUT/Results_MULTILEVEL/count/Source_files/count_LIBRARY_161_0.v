...
module FAU ( 
  ...
  nand4  g027(.a(new_n78_), .b(new_n60_), .c(new_n66_), .d(new_n53_), .O(new_n79_));
  nand2  g028(.a(new_n79_), .b(x24), .O(new_n80_));
  nor2   g029(.a(x24), .b(x23), .O(new_n81_));
  nand2  g030(.a(new_n81_), .b(new_n70_), .O(new_n82_));
  or2    g031(.a(new_n82_), .b(new_n61_), .O(new_n83_));
  nand4  g032(.a(new_n83_), .b(new_n80_), .c(new_n52_), .d(x16), .O(z05));
  nand4  g033(.a(new_n81_), .b(new_n70_), .c(new_n60_), .d(new_n53_), .O(new_n85_));
  nand2  g034(.a(new_n85_), .b(x25), .O(new_n86_));
  nor2   g035(.a(x21), .b(x20), .O(new_n87_));
  nor2   g036(.a(x25), .b(x24), .O(new_n88_));
  nand4  g037(.a(new_n88_), .b(new_n78_), .c(new_n87_), .d(new_n56_), .O(new_n89_));
  ...
  nand4  g041(.a(new_n92_), .b(new_n78_), .c(new_n87_), .d(new_n56_), .O(new_n93_));
  ...
  oai21  g048(.a(new_n99_), .b(new_n73_), .c(new_n52_), .O(z08));
  oai21  g049(.a(new_n97_), .b(new_n71_), .c(x28), .O(new_n101_));
  inv1   g050(.a(x23), .O(new_n102_));
  inv1   g051(.a(x26), .O(new_n103_));
  nor2   g052(.a(x28), .b(x27), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n88_), .c(new_n103_), .d(new_n102_), .O(new_n105_));
  or2    g054(.a(new_n105_), .b(new_n71_), .O(new_n106_));
  ...
  nand4  g058(.a(new_n109_), .b(new_n92_), .c(new_n75_), .d(new_n74_), .O(new_n110_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n104_), .c(new_n113_), .d(new_n112_), .O(new_n115_));
  nor2   g064(.a(new_n115_), .b(new_n79_), .O(new_n116_));
  aoi21  g065(.a(new_n110_), .b(x30), .c(new_n116_), .O(new_n117_));
  oai21  g066(.a(new_n117_), .b(new_n73_), .c(new_n52_), .O(z11));
  oai21  g067(.a(new_n115_), .b(new_n79_), .c(x31), .O(new_n119_));
  ...
  nor2   g075(.a(x32), .b(x31), .O(new_n127_));
  nand4  g076(.a(new_n127_), .b(new_n114_), .c(new_n104_), .d(new_n113_), .O(new_n128_));
  or2    g077(.a(new_n128_), .b(new_n85_), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n126_), .c(new_n52_), .d(x16), .O(z13));
  oai21  g079(.a(new_n128_), .b(new_n85_), .c(x33), .O(new_n131_));
  inv1   g080(.a(x22), .O(new_n132_));
  nand4  g081(.a(new_n95_), .b(new_n112_), .c(new_n102_), .d(new_n132_), .O(new_n133_));
  nor2   g082(.a(new_n133_), .b(new_n67_), .O(new_n134_));
  nor2   g083(.a(x33), .b(x32), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n123_), .c(new_n122_), .d(new_n96_), .O(new_n136_));
  ...
  nand2  g089(.a(new_n140_), .b(new_n52_), .O(z14));
  oai21  g090(.a(new_n136_), .b(new_n89_), .c(x34), .O(new_n142_));
  nand2  g091(.a(new_n122_), .b(new_n96_), .O(new_n143_));
  ...
  nand3  g101(.a(new_n152_), .b(new_n144_), .c(new_n134_), .O(new_n153_));
