...
module FAU ( 
  ...
  aoi21  g028(.a(new_n79_), .b(new_n76_), .c(new_n58_), .O(new_n80_));
  ...
  nand4  g045(.a(new_n96_), .b(new_n78_), .c(new_n63_), .d(new_n52_), .O(new_n97_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n93_), .c(new_n70_), .d(new_n55_), .O(new_n104_));
  ...
  nand2  g056(.a(new_n107_), .b(new_n68_), .O(z06));
  nand4  g057(.a(new_n70_), .b(new_n53_), .c(new_n61_), .d(new_n52_), .O(new_n109_));
  ...
  oai21  g066(.a(new_n112_), .b(new_n75_), .c(x27), .O(new_n118_));
  nor3   g067(.a(x22), .b(x21), .c(x20), .O(new_n119_));
  nor3   g068(.a(x27), .b(x26), .c(x25), .O(new_n120_));
  nand4  g069(.a(new_n120_), .b(new_n96_), .c(new_n119_), .d(new_n55_), .O(new_n121_));
  aoi21  g070(.a(new_n121_), .b(new_n118_), .c(new_n58_), .O(new_n122_));
  ...
  nand4  g077(.a(new_n128_), .b(new_n127_), .c(new_n119_), .d(new_n55_), .O(new_n129_));
  and2   g078(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  ...
  nand4  g085(.a(new_n136_), .b(new_n135_), .c(new_n86_), .d(new_n85_), .O(new_n137_));
  ...
  oai21  g098(.a(new_n144_), .b(new_n87_), .c(x31), .O(new_n150_));
  inv1   g099(.a(new_n97_), .O(new_n151_));
  nor2   g100(.a(x29), .b(x28), .O(new_n152_));
  nor2   g101(.a(x31), .b(x30), .O(new_n153_));
  nand4  g102(.a(new_n153_), .b(new_n152_), .c(new_n120_), .d(new_n151_), .O(new_n154_));
  ...
  nand3  g108(.a(new_n153_), .b(new_n152_), .c(new_n120_), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n97_), .c(x32), .O(new_n161_));
  nor2   g110(.a(x32), .b(x31), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n143_), .c(new_n142_), .d(new_n111_), .O(new_n163_));
  or2    g112(.a(new_n163_), .b(new_n97_), .O(new_n164_));
  ...
  oai21  g118(.a(new_n163_), .b(new_n97_), .c(x33), .O(new_n170_));
  ...
  oai21  g122(.a(new_n173_), .b(new_n104_), .c(new_n170_), .O(new_n174_));
  ...
  nor2   g128(.a(new_n173_), .b(new_n104_), .O(new_n180_));
  nor2   g129(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand2  g130(.a(new_n152_), .b(new_n171_), .O(new_n182_));
  inv1   g131(.a(x32), .O(new_n183_));
  nor2   g132(.a(x34), .b(x33), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n153_), .c(new_n183_), .O(new_n185_));
  nor3   g134(.a(new_n185_), .b(new_n182_), .c(new_n104_), .O(new_n186_));
