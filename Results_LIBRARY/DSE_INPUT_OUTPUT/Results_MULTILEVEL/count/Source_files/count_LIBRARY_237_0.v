...
module FAU ( 
  ...
  nor2   g06(.a(x18), .b(new_n57_), .O(new_n58_));
  ...
  oai21  g38(.a(new_n89_), .b(new_n88_), .c(x17), .O(new_n90_));
  nand2  g39(.a(new_n90_), .b(new_n52_), .O(z08));
  nand2  g40(.a(x28), .b(x16), .O(new_n92_));
  inv1   g41(.a(x06), .O(new_n93_));
  nand2  g42(.a(new_n61_), .b(new_n93_), .O(new_n94_));
  nand3  g43(.a(new_n94_), .b(new_n92_), .c(new_n58_), .O(z09));
  ...
  nand2  g50(.a(new_n61_), .b(new_n101_), .O(new_n102_));
  nand3  g51(.a(new_n102_), .b(new_n100_), .c(new_n58_), .O(z11));
  nand2  g52(.a(x31), .b(x16), .O(new_n104_));
  inv1   g53(.a(x03), .O(new_n105_));
  nand2  g54(.a(new_n61_), .b(new_n105_), .O(new_n106_));
  nand3  g55(.a(new_n106_), .b(new_n104_), .c(new_n58_), .O(z12));
  nand2  g56(.a(x32), .b(x16), .O(new_n108_));
  inv1   g57(.a(x02), .O(new_n109_));
  nand2  g58(.a(new_n61_), .b(new_n109_), .O(new_n110_));
  nand3  g59(.a(new_n110_), .b(new_n108_), .c(new_n58_), .O(z13));
  ...
  nand2  g66(.a(new_n61_), .b(new_n117_), .O(new_n118_));
  nand3  g67(.a(new_n118_), .b(new_n116_), .c(new_n58_), .O(z15));
endmodule
