...
module FAU ( 
  ...
  nand4  g039(.a(new_n90_), .b(new_n78_), .c(new_n84_), .d(new_n52_), .O(new_n91_));
  ...
  nand3  g064(.a(new_n115_), .b(new_n90_), .c(new_n100_), .O(new_n116_));
  ...
  nand4  g073(.a(new_n124_), .b(new_n123_), .c(new_n107_), .d(new_n98_), .O(new_n125_));
  oai22  g074(.a(new_n125_), .b(new_n79_), .c(new_n117_), .d(new_n122_), .O(new_n126_));
  ...
  nand3  g081(.a(new_n98_), .b(new_n97_), .c(new_n70_), .O(new_n133_));
  nor2   g082(.a(new_n133_), .b(new_n64_), .O(new_n134_));
  nor2   g083(.a(x29), .b(x28), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n108_), .c(new_n134_), .d(new_n132_), .O(new_n136_));
  nand3  g085(.a(new_n136_), .b(new_n131_), .c(new_n63_), .O(new_n137_));
  ...
  nand4  g091(.a(new_n135_), .b(new_n142_), .c(new_n132_), .d(new_n99_), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(new_n86_), .c(x30), .O(new_n144_));
  nor2   g093(.a(x30), .b(x29), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n124_), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n108_), .c(new_n134_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n144_), .c(new_n63_), .O(new_n149_));
  ...
  nand4  g103(.a(new_n154_), .b(new_n135_), .c(new_n115_), .d(new_n100_), .O(new_n155_));
  ...
  nand4  g111(.a(new_n162_), .b(new_n145_), .c(new_n124_), .d(new_n142_), .O(new_n163_));
  ...
  nand4  g121(.a(new_n172_), .b(new_n154_), .c(new_n135_), .d(new_n115_), .O(new_n173_));
  inv1   g122(.a(new_n173_), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n102_), .O(new_n175_));
  nand3  g124(.a(new_n175_), .b(new_n171_), .c(new_n63_), .O(new_n176_));
  ...
  nor2   g129(.a(x21), .b(x20), .O(new_n181_));
  nand4  g130(.a(new_n123_), .b(new_n85_), .c(new_n181_), .d(new_n55_), .O(new_n182_));
  oai21  g131(.a(new_n173_), .b(new_n182_), .c(x34), .O(new_n183_));
  nand2  g132(.a(new_n135_), .b(new_n115_), .O(new_n184_));
