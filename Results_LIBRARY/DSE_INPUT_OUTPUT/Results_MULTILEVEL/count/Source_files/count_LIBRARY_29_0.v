...
module FAU ( 
  ...
  nor2   g14(.a(new_n53_), .b(x18), .O(new_n66_));
  ...
  nand2  g30(.a(new_n69_), .b(new_n81_), .O(new_n82_));
  nand3  g31(.a(new_n82_), .b(new_n80_), .c(new_n66_), .O(z06));
  nand2  g32(.a(x26), .b(x16), .O(new_n84_));
  inv1   g33(.a(x08), .O(new_n85_));
  nand2  g34(.a(new_n69_), .b(new_n85_), .O(new_n86_));
  nand3  g35(.a(new_n86_), .b(new_n84_), .c(new_n66_), .O(z07));
  ...
  nand2  g42(.a(new_n69_), .b(new_n93_), .O(new_n94_));
  nand3  g43(.a(new_n94_), .b(new_n92_), .c(new_n66_), .O(z09));
