...
module FAU ( 
  ...
  nand4  g039(.a(new_n90_), .b(new_n79_), .c(new_n84_), .d(new_n63_), .O(new_n91_));
  ...
  oai21  g059(.a(new_n108_), .b(new_n103_), .c(new_n110_), .O(new_n111_));
  ...
  nand3  g065(.a(new_n116_), .b(new_n90_), .c(new_n106_), .O(new_n117_));
  ...
  oai21  g070(.a(new_n119_), .b(new_n69_), .c(new_n121_), .O(z08));
  inv1   g071(.a(x28), .O(new_n123_));
  nor2   g072(.a(x28), .b(x27), .O(new_n124_));
  nand4  g073(.a(new_n124_), .b(new_n98_), .c(new_n103_), .d(new_n104_), .O(new_n125_));
  oai22  g074(.a(new_n125_), .b(new_n80_), .c(new_n118_), .d(new_n123_), .O(new_n126_));
  ...
  nand3  g081(.a(new_n104_), .b(new_n77_), .c(new_n70_), .O(new_n133_));
  nor2   g082(.a(new_n133_), .b(new_n65_), .O(new_n134_));
  nor2   g083(.a(x29), .b(x28), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n109_), .c(new_n134_), .d(new_n132_), .O(new_n136_));
  nand3  g085(.a(new_n136_), .b(new_n131_), .c(new_n52_), .O(new_n137_));
  ...
  nand4  g091(.a(new_n135_), .b(new_n142_), .c(new_n132_), .d(new_n105_), .O(new_n143_));
  ...
  nand3  g096(.a(new_n147_), .b(new_n109_), .c(new_n134_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n144_), .c(new_n52_), .O(new_n149_));
  ...
  nand4  g103(.a(new_n154_), .b(new_n135_), .c(new_n116_), .d(new_n106_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n91_), .c(new_n52_), .O(new_n156_));
  ...
  aoi21  g120(.a(new_n164_), .b(new_n92_), .c(new_n171_), .O(new_n172_));
  nor2   g121(.a(x33), .b(x32), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n154_), .c(new_n135_), .d(new_n116_), .O(new_n174_));
  ...
  oai21  g128(.a(new_n174_), .b(new_n99_), .c(x34), .O(new_n180_));
  nand2  g129(.a(new_n135_), .b(new_n116_), .O(new_n181_));
  ...
  nand3  g139(.a(new_n190_), .b(new_n180_), .c(new_n52_), .O(new_n191_));
