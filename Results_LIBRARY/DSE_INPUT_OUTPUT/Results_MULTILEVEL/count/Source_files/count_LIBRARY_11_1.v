...
module FAU ( 
  ...
  nand2  g016(.a(x18), .b(x04), .O(new_n68_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n92_), .c(new_n84_), .d(new_n52_), .O(new_n94_));
  ...
  oai21  g077(.a(x16), .b(x06), .c(new_n61_), .O(new_n129_));
  or2    g078(.a(new_n129_), .b(new_n128_), .O(z09));
  inv1   g079(.a(x27), .O(new_n131_));
  nor2   g080(.a(x29), .b(x28), .O(new_n132_));
  nand4  g081(.a(new_n132_), .b(new_n115_), .c(new_n131_), .d(new_n114_), .O(new_n133_));
  ...
  nand3  g090(.a(new_n141_), .b(new_n140_), .c(new_n70_), .O(new_n142_));
  ...
  oai21  g108(.a(new_n153_), .b(new_n94_), .c(x32), .O(new_n160_));
  nor2   g109(.a(x32), .b(x31), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n145_), .c(new_n144_), .d(new_n115_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n94_), .c(new_n160_), .O(new_n163_));
  ...
  oai21  g116(.a(new_n162_), .b(new_n94_), .c(x33), .O(new_n168_));
  nor2   g117(.a(x27), .b(x26), .O(new_n169_));
  nor2   g118(.a(x33), .b(x32), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n152_), .c(new_n132_), .d(new_n169_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n102_), .c(new_n168_), .O(new_n172_));
  ...
  oai21  g125(.a(new_n171_), .b(new_n102_), .c(x34), .O(new_n177_));
  inv1   g126(.a(x25), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n114_), .c(new_n141_), .d(new_n140_), .O(new_n179_));
  nor2   g128(.a(new_n179_), .b(new_n71_), .O(new_n180_));
  nand2  g129(.a(new_n132_), .b(new_n169_), .O(new_n181_));
  ...
  aoi21  g140(.a(new_n191_), .b(new_n177_), .c(new_n58_), .O(new_n192_));
