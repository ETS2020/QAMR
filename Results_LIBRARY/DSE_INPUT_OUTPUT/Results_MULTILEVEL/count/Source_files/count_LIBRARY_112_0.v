...
module FAU ( 
  ...
  nand4  g049(.a(new_n100_), .b(new_n83_), .c(new_n71_), .d(new_n56_), .O(new_n101_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n104_), .c(new_n71_), .d(new_n56_), .O(new_n106_));
  ...
  oai21  g062(.a(new_n113_), .b(new_n70_), .c(new_n52_), .O(z10));
  nor3   g063(.a(x29), .b(x28), .c(x27), .O(new_n115_));
  nand4  g064(.a(new_n115_), .b(new_n94_), .c(new_n80_), .d(new_n63_), .O(new_n116_));
  nor2   g065(.a(x28), .b(x27), .O(new_n117_));
  nor2   g066(.a(x30), .b(x29), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n117_), .c(new_n109_), .d(new_n79_), .O(new_n119_));
  nor2   g068(.a(new_n119_), .b(new_n77_), .O(new_n120_));
  aoi21  g069(.a(new_n116_), .b(x30), .c(new_n120_), .O(new_n121_));
  oai21  g070(.a(new_n121_), .b(new_n70_), .c(new_n52_), .O(z11));
  oai21  g071(.a(new_n119_), .b(new_n77_), .c(x31), .O(new_n123_));
  nor2   g072(.a(x31), .b(x30), .O(new_n124_));
  nand2  g073(.a(new_n124_), .b(new_n110_), .O(new_n125_));
  inv1   g074(.a(new_n125_), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n100_), .c(new_n85_), .O(new_n127_));
  ...
  nand4  g081(.a(new_n132_), .b(new_n118_), .c(new_n117_), .d(new_n109_), .O(new_n133_));
  or2    g082(.a(new_n133_), .b(new_n84_), .O(new_n134_));
  nand4  g083(.a(new_n134_), .b(new_n131_), .c(new_n52_), .d(x16), .O(z13));
  oai21  g084(.a(new_n133_), .b(new_n84_), .c(x33), .O(new_n136_));
  inv1   g085(.a(x22), .O(new_n137_));
  inv1   g086(.a(x23), .O(new_n138_));
  inv1   g087(.a(x25), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n79_), .c(new_n138_), .d(new_n137_), .O(new_n140_));
  nor2   g089(.a(new_n140_), .b(new_n68_), .O(new_n141_));
  nor2   g090(.a(x27), .b(x26), .O(new_n142_));
  nor2   g091(.a(x33), .b(x32), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n124_), .c(new_n110_), .d(new_n142_), .O(new_n144_));
  ...
  nand2  g099(.a(new_n110_), .b(new_n142_), .O(new_n151_));
  ...
  nand3  g109(.a(new_n160_), .b(new_n152_), .c(new_n141_), .O(new_n161_));
