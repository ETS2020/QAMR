...
module FAU ( 
  ...
  nand4  g038(.a(new_n89_), .b(new_n76_), .c(new_n88_), .d(new_n53_), .O(new_n90_));
  ...
  nand4  g044(.a(new_n95_), .b(new_n79_), .c(new_n94_), .d(new_n93_), .O(new_n96_));
  nor2   g045(.a(new_n96_), .b(new_n66_), .O(new_n97_));
  nor3   g046(.a(x26), .b(x25), .c(x24), .O(new_n98_));
  nand4  g047(.a(new_n98_), .b(new_n76_), .c(new_n88_), .d(new_n53_), .O(new_n99_));
  ...
  nand4  g053(.a(new_n104_), .b(new_n82_), .c(new_n69_), .d(new_n53_), .O(new_n105_));
  ...
  nand4  g057(.a(new_n108_), .b(new_n89_), .c(new_n92_), .d(new_n94_), .O(new_n109_));
  ...
  nand4  g062(.a(new_n113_), .b(new_n98_), .c(new_n80_), .d(new_n58_), .O(new_n114_));
  ...
  nand3  g075(.a(new_n126_), .b(new_n104_), .c(new_n84_), .O(new_n127_));
  ...
  nand2  g079(.a(new_n127_), .b(x32), .O(new_n131_));
  nor2   g080(.a(x32), .b(x31), .O(new_n132_));
  nand4  g081(.a(new_n132_), .b(new_n117_), .c(new_n108_), .d(new_n116_), .O(new_n133_));
  or2    g082(.a(new_n133_), .b(new_n83_), .O(new_n134_));
  nand4  g083(.a(new_n134_), .b(new_n131_), .c(new_n52_), .d(x16), .O(z13));
  oai21  g084(.a(new_n133_), .b(new_n83_), .c(x33), .O(new_n136_));
  nor2   g085(.a(x27), .b(x26), .O(new_n137_));
  nor2   g086(.a(x33), .b(x32), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n124_), .c(new_n123_), .d(new_n137_), .O(new_n139_));
  ...
  oai21  g093(.a(new_n139_), .b(new_n90_), .c(x34), .O(new_n145_));
  nand2  g094(.a(new_n123_), .b(new_n137_), .O(new_n146_));
  ...
  nand3  g104(.a(new_n155_), .b(new_n147_), .c(new_n97_), .O(new_n156_));
