...
module FAU ( 
  ...
  nand4  g043(.a(new_n94_), .b(new_n85_), .c(new_n77_), .d(new_n70_), .O(new_n95_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n80_), .c(new_n71_), .d(new_n52_), .O(new_n102_));
  inv1   g051(.a(x25), .O(new_n103_));
  nand4  g052(.a(new_n103_), .b(new_n94_), .c(new_n85_), .d(new_n77_), .O(new_n104_));
  ...
  nand3  g063(.a(new_n114_), .b(new_n92_), .c(new_n78_), .O(new_n115_));
  ...
  nand3  g070(.a(new_n121_), .b(new_n101_), .c(new_n103_), .O(new_n122_));
  ...
  nand3  g088(.a(new_n139_), .b(new_n137_), .c(new_n63_), .O(new_n140_));
  ...
  nand4  g096(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n94_), .O(new_n148_));
  ...
  nand3  g102(.a(new_n153_), .b(new_n149_), .c(new_n63_), .O(new_n154_));
  ...
  nand4  g107(.a(new_n150_), .b(new_n130_), .c(new_n146_), .d(new_n94_), .O(new_n159_));
  oai21  g108(.a(new_n159_), .b(new_n93_), .c(x31), .O(new_n160_));
  nor3   g109(.a(x27), .b(x26), .c(x25), .O(new_n161_));
  nor2   g110(.a(x31), .b(x30), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n147_), .O(new_n163_));
  inv1   g112(.a(new_n163_), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n161_), .c(new_n96_), .O(new_n165_));
  ...
  nand4  g119(.a(new_n162_), .b(new_n147_), .c(new_n121_), .d(new_n103_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n102_), .c(x32), .O(new_n172_));
  nor2   g121(.a(x32), .b(x31), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n150_), .c(new_n130_), .d(new_n146_), .O(new_n174_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n102_), .c(x33), .O(new_n182_));
  nor2   g131(.a(x33), .b(x32), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n162_), .c(new_n147_), .d(new_n121_), .O(new_n184_));
  ...
  nand2  g141(.a(new_n147_), .b(new_n121_), .O(new_n193_));
  ...
  nand3  g151(.a(new_n202_), .b(new_n194_), .c(new_n105_), .O(new_n203_));
