...
module FAU ( 
  ...
  aoi22  g034(.a(new_n85_), .b(new_n84_), .c(new_n79_), .d(x23), .O(new_n86_));
  ...
  nand4  g040(.a(new_n91_), .b(new_n62_), .c(new_n90_), .d(new_n61_), .O(new_n92_));
  and2   g041(.a(new_n92_), .b(x24), .O(new_n93_));
  nor2   g042(.a(x24), .b(x23), .O(new_n94_));
  nand4  g043(.a(new_n94_), .b(new_n78_), .c(new_n62_), .d(new_n61_), .O(new_n95_));
  ...
  nand4  g051(.a(new_n102_), .b(new_n91_), .c(new_n70_), .d(new_n53_), .O(new_n103_));
  ...
  nand2  g055(.a(new_n106_), .b(new_n68_), .O(z06));
  nand2  g056(.a(new_n103_), .b(x26), .O(new_n108_));
  nor3   g057(.a(x26), .b(x25), .c(x24), .O(new_n109_));
  nand4  g058(.a(new_n109_), .b(new_n91_), .c(new_n70_), .d(new_n53_), .O(new_n110_));
  ...
  nand2  g062(.a(new_n113_), .b(new_n68_), .O(z07));
  ...
  nand4  g075(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n53_), .O(new_n127_));
  aoi21  g076(.a(new_n127_), .b(new_n123_), .c(new_n56_), .O(new_n128_));
  nor2   g077(.a(x16), .b(x06), .O(new_n129_));
  oai21  g078(.a(new_n129_), .b(new_n128_), .c(new_n59_), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(new_n68_), .O(z09));
  nand2  g080(.a(new_n127_), .b(x29), .O(new_n132_));
  nor3   g081(.a(x29), .b(x28), .c(x27), .O(new_n133_));
  nand4  g082(.a(new_n133_), .b(new_n109_), .c(new_n85_), .d(new_n84_), .O(new_n134_));
  ...
  nand4  g097(.a(new_n91_), .b(new_n70_), .c(new_n53_), .d(x16), .O(new_n149_));
  nor2   g098(.a(x31), .b(x30), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n141_), .c(new_n109_), .O(new_n151_));
  oai21  g100(.a(new_n151_), .b(new_n149_), .c(new_n59_), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n67_), .O(new_n153_));
  oai21  g102(.a(new_n143_), .b(new_n92_), .c(x31), .O(new_n154_));
  inv1   g103(.a(x03), .O(new_n155_));
  nand2  g104(.a(new_n56_), .b(new_n155_), .O(new_n156_));
  oai21  g105(.a(new_n154_), .b(new_n56_), .c(new_n156_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n59_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n153_), .O(z12));
  nor2   g108(.a(x29), .b(x28), .O(new_n160_));
  nand4  g109(.a(new_n150_), .b(new_n160_), .c(new_n116_), .d(new_n115_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n95_), .c(x32), .O(new_n162_));
  nor2   g111(.a(x32), .b(x31), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n142_), .c(new_n141_), .d(new_n140_), .O(new_n164_));
  oai21  g113(.a(new_n164_), .b(new_n95_), .c(new_n162_), .O(new_n165_));
  ...
  nand4  g120(.a(new_n171_), .b(new_n150_), .c(new_n160_), .d(new_n116_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n103_), .c(new_n170_), .O(new_n173_));
  ...
  nor2   g127(.a(new_n172_), .b(new_n103_), .O(new_n179_));
  nor2   g128(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g129(.a(new_n160_), .b(new_n116_), .O(new_n181_));
  inv1   g130(.a(x32), .O(new_n182_));
  nor2   g131(.a(x34), .b(x33), .O(new_n183_));
  nand3  g132(.a(new_n183_), .b(new_n150_), .c(new_n182_), .O(new_n184_));
  nor3   g133(.a(new_n184_), .b(new_n181_), .c(new_n103_), .O(new_n185_));
