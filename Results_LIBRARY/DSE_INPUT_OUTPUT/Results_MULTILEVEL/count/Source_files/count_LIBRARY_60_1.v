...
module FAU ( 
  ...
  nand2  g021(.a(new_n64_), .b(new_n53_), .O(new_n73_));
  inv1   g022(.a(new_n73_), .O(new_n74_));
  nand4  g023(.a(new_n72_), .b(new_n61_), .c(new_n54_), .d(new_n53_), .O(new_n75_));
  ...
  nand3  g030(.a(new_n81_), .b(new_n72_), .c(new_n61_), .O(new_n82_));
  ...
  nand3  g037(.a(new_n88_), .b(new_n62_), .c(new_n61_), .O(new_n89_));
  nor2   g038(.a(x23), .b(x22), .O(new_n90_));
  nand4  g039(.a(new_n90_), .b(new_n64_), .c(new_n72_), .d(new_n53_), .O(new_n91_));
  ...
  aoi21  g052(.a(new_n69_), .b(new_n103_), .c(x18), .O(new_n104_));
  ...
  nand4  g058(.a(new_n109_), .b(new_n97_), .c(new_n108_), .d(new_n81_), .O(new_n110_));
  nor2   g059(.a(new_n110_), .b(new_n75_), .O(new_n111_));
  aoi21  g060(.a(new_n107_), .b(x25), .c(new_n111_), .O(new_n112_));
  inv1   g061(.a(x09), .O(new_n113_));
  aoi21  g062(.a(new_n69_), .b(new_n113_), .c(x18), .O(new_n114_));
  oai21  g063(.a(new_n112_), .b(new_n69_), .c(new_n114_), .O(z06));
  nor2   g064(.a(x21), .b(x20), .O(new_n116_));
  nor2   g065(.a(x25), .b(x24), .O(new_n117_));
  nand4  g066(.a(new_n117_), .b(new_n90_), .c(new_n116_), .d(new_n62_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(x26), .O(new_n119_));
  nor3   g068(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g069(.a(new_n120_), .b(new_n90_), .c(new_n116_), .d(new_n62_), .O(new_n121_));
  aoi21  g070(.a(new_n121_), .b(new_n119_), .c(new_n69_), .O(new_n122_));
  nor2   g071(.a(x16), .b(x08), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n122_), .c(new_n63_), .O(new_n124_));
  nand2  g073(.a(new_n124_), .b(new_n59_), .O(z07));
  nand2  g074(.a(new_n121_), .b(x27), .O(new_n126_));
  nor2   g075(.a(new_n82_), .b(new_n55_), .O(new_n127_));
  nor3   g076(.a(x27), .b(x26), .c(x25), .O(new_n128_));
  nand3  g077(.a(new_n128_), .b(new_n99_), .c(new_n127_), .O(new_n129_));
  ...
  nand2  g081(.a(new_n132_), .b(new_n59_), .O(z08));
  nor2   g082(.a(x27), .b(x26), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n99_), .c(new_n109_), .O(new_n135_));
  oai21  g084(.a(new_n135_), .b(new_n89_), .c(x28), .O(new_n136_));
  nor3   g085(.a(x28), .b(x27), .c(x26), .O(new_n137_));
  nand4  g086(.a(new_n137_), .b(new_n117_), .c(new_n127_), .d(new_n108_), .O(new_n138_));
  aoi21  g087(.a(new_n138_), .b(new_n136_), .c(new_n69_), .O(new_n139_));
  ...
  nand3  g093(.a(new_n144_), .b(new_n120_), .c(new_n143_), .O(new_n145_));
  ...
  aoi21  g097(.a(new_n69_), .b(new_n148_), .c(x18), .O(new_n149_));
  oai21  g098(.a(new_n147_), .b(new_n69_), .c(new_n149_), .O(z10));
  nand4  g099(.a(new_n144_), .b(new_n120_), .c(new_n92_), .d(new_n143_), .O(new_n151_));
  nor2   g100(.a(x26), .b(x25), .O(new_n152_));
  nor2   g101(.a(x28), .b(x27), .O(new_n153_));
  nor2   g102(.a(x30), .b(x29), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n153_), .c(new_n152_), .d(new_n97_), .O(new_n155_));
  ...
  aoi21  g107(.a(new_n69_), .b(new_n158_), .c(x18), .O(new_n159_));
  oai21  g108(.a(new_n157_), .b(new_n69_), .c(new_n159_), .O(z11));
  oai21  g109(.a(new_n155_), .b(new_n91_), .c(x31), .O(new_n161_));
  nor2   g110(.a(x31), .b(x30), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n144_), .O(new_n163_));
  inv1   g112(.a(new_n163_), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n128_), .c(new_n106_), .d(new_n74_), .O(new_n165_));
  aoi21  g114(.a(new_n165_), .b(new_n161_), .c(new_n69_), .O(new_n166_));
  nor2   g115(.a(x16), .b(x03), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n166_), .c(new_n63_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n59_), .O(z12));
  nand2  g118(.a(new_n165_), .b(x32), .O(new_n170_));
  nor2   g119(.a(x32), .b(x31), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n154_), .O(new_n172_));
  inv1   g121(.a(new_n172_), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n153_), .c(new_n152_), .d(new_n101_), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(x16), .O(new_n176_));
  inv1   g125(.a(x02), .O(new_n177_));
  aoi21  g126(.a(new_n69_), .b(new_n177_), .c(x18), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(new_n176_), .O(z13));
  nand3  g128(.a(new_n173_), .b(new_n153_), .c(new_n152_), .O(new_n180_));
  oai21  g129(.a(new_n180_), .b(new_n107_), .c(x33), .O(new_n181_));
  nor2   g130(.a(x33), .b(x32), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n162_), .c(new_n144_), .d(new_n134_), .O(new_n183_));
  or2    g132(.a(new_n183_), .b(new_n118_), .O(new_n184_));
  ...
  oai21  g138(.a(new_n183_), .b(new_n118_), .c(x34), .O(new_n190_));
  nand2  g139(.a(new_n144_), .b(new_n134_), .O(new_n191_));
  ...
  nand3  g149(.a(new_n200_), .b(new_n192_), .c(new_n111_), .O(new_n201_));
  aoi21  g150(.a(new_n201_), .b(new_n190_), .c(new_n69_), .O(new_n202_));
  nor2   g151(.a(x16), .b(x00), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(new_n202_), .c(new_n63_), .O(new_n204_));
  nand2  g153(.a(new_n204_), .b(new_n59_), .O(z15));
endmodule
