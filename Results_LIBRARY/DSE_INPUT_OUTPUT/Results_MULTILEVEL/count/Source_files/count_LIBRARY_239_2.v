...
module FAU ( 
  ...
  oai21  g024(.a(new_n75_), .b(x05), .c(new_n62_), .O(z02));
  ...
  nand3  g034(.a(new_n85_), .b(new_n84_), .c(new_n71_), .O(new_n86_));
  ...
  nand4  g062(.a(new_n113_), .b(new_n93_), .c(new_n104_), .d(new_n56_), .O(new_n114_));
  ...
  nand4  g069(.a(new_n120_), .b(new_n97_), .c(new_n78_), .d(new_n56_), .O(new_n121_));
  aoi21  g070(.a(new_n121_), .b(new_n119_), .c(new_n59_), .O(new_n122_));
  nor2   g071(.a(x16), .b(x07), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n122_), .c(new_n52_), .O(new_n124_));
  nand2  g073(.a(new_n124_), .b(new_n62_), .O(z08));
  nand2  g074(.a(new_n121_), .b(x28), .O(new_n126_));
  nor3   g075(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nor3   g076(.a(x28), .b(x27), .c(x26), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n127_), .c(new_n78_), .d(new_n56_), .O(new_n129_));
  ...
  or2    g089(.a(new_n140_), .b(new_n94_), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n135_), .c(new_n134_), .d(new_n62_), .O(z10));
  oai21  g091(.a(new_n140_), .b(new_n94_), .c(x30), .O(new_n143_));
  nor2   g092(.a(x28), .b(x27), .O(new_n144_));
  nor2   g093(.a(x30), .b(x29), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n144_), .c(new_n113_), .d(new_n87_), .O(new_n146_));
  ...
  nand3  g101(.a(new_n152_), .b(new_n139_), .c(new_n120_), .O(new_n153_));
  or2    g102(.a(new_n153_), .b(new_n98_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(x16), .O(new_n156_));
  nor2   g105(.a(x16), .b(x03), .O(new_n157_));
  nor3   g106(.a(new_n157_), .b(x18), .c(x05), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n156_), .O(z12));
  oai21  g108(.a(new_n153_), .b(new_n98_), .c(x32), .O(new_n160_));
  nor2   g109(.a(x32), .b(x31), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n145_), .c(new_n144_), .d(new_n138_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n98_), .c(new_n160_), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(x16), .O(new_n164_));
  inv1   g113(.a(x02), .O(new_n165_));
  aoi21  g114(.a(new_n59_), .b(new_n165_), .c(x18), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n164_), .c(new_n52_), .O(z13));
  oai21  g116(.a(new_n162_), .b(new_n98_), .c(x33), .O(new_n168_));
  inv1   g117(.a(x25), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n136_), .c(new_n85_), .d(new_n84_), .O(new_n170_));
  nor2   g119(.a(new_n170_), .b(new_n72_), .O(new_n171_));
  nor2   g120(.a(x27), .b(x26), .O(new_n172_));
  nor2   g121(.a(x33), .b(x32), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n152_), .c(new_n139_), .d(new_n172_), .O(new_n174_));
  inv1   g123(.a(new_n174_), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  aoi21  g125(.a(new_n176_), .b(new_n168_), .c(new_n59_), .O(new_n177_));
  ...
  oai21  g129(.a(new_n174_), .b(new_n106_), .c(x34), .O(new_n181_));
  nand2  g130(.a(new_n139_), .b(new_n172_), .O(new_n182_));
  ...
  nand3  g140(.a(new_n191_), .b(new_n183_), .c(new_n171_), .O(new_n192_));
