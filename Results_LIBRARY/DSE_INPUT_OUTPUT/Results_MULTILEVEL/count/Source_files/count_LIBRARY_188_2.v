...
module FAU ( 
  ...
  nand2  g003(.a(x25), .b(x18), .O(new_n55_));
  ...
  nand2  g041(.a(new_n92_), .b(new_n55_), .O(z04));
  ...
  nand4  g051(.a(new_n96_), .b(new_n79_), .c(new_n61_), .d(new_n59_), .O(new_n103_));
  inv1   g052(.a(x25), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n94_), .c(new_n86_), .d(new_n85_), .O(new_n105_));
  ...
  nand3  g062(.a(new_n113_), .b(new_n112_), .c(new_n73_), .O(new_n114_));
  ...
  nand2  g069(.a(new_n120_), .b(new_n96_), .O(new_n121_));
  ...
  nand3  g077(.a(new_n128_), .b(new_n112_), .c(new_n94_), .O(new_n129_));
  oai21  g078(.a(new_n129_), .b(new_n72_), .c(x28), .O(new_n130_));
  nor3   g079(.a(x22), .b(x21), .c(x20), .O(new_n131_));
  nor3   g080(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nor3   g081(.a(x28), .b(x27), .c(x26), .O(new_n133_));
  nand4  g082(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n58_), .O(new_n134_));
  aoi21  g083(.a(new_n134_), .b(new_n130_), .c(new_n66_), .O(new_n135_));
  nor2   g084(.a(x16), .b(x06), .O(new_n136_));
  oai21  g085(.a(new_n136_), .b(new_n135_), .c(new_n60_), .O(new_n137_));
  oai21  g086(.a(new_n127_), .b(new_n104_), .c(new_n137_), .O(z09));
  nand2  g087(.a(x29), .b(x16), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n60_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(x25), .O(new_n141_));
  nor2   g090(.a(x28), .b(x27), .O(new_n142_));
  nand3  g091(.a(new_n142_), .b(new_n96_), .c(new_n111_), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(new_n80_), .c(x29), .O(new_n144_));
  inv1   g093(.a(x27), .O(new_n145_));
  nor2   g094(.a(x29), .b(x28), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n113_), .c(new_n88_), .d(new_n145_), .O(new_n147_));
  aoi21  g096(.a(new_n147_), .b(new_n144_), .c(new_n66_), .O(new_n148_));
  ...
  oai21  g101(.a(new_n152_), .b(new_n66_), .c(new_n60_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(x25), .O(new_n154_));
  nor2   g103(.a(x26), .b(x24), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n146_), .c(new_n145_), .d(new_n86_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n80_), .c(x30), .O(new_n157_));
  nor2   g106(.a(x30), .b(x29), .O(new_n158_));
  nand4  g107(.a(new_n158_), .b(new_n142_), .c(new_n113_), .d(new_n88_), .O(new_n159_));
  ...
  nand3  g114(.a(new_n165_), .b(new_n146_), .c(new_n120_), .O(new_n166_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n158_), .c(new_n142_), .d(new_n174_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n103_), .c(new_n173_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(x16), .O(new_n178_));
  inv1   g127(.a(x02), .O(new_n179_));
  aoi21  g128(.a(new_n66_), .b(new_n179_), .c(x18), .O(new_n180_));
  nand2  g129(.a(new_n180_), .b(new_n178_), .O(z13));
  inv1   g130(.a(new_n106_), .O(new_n182_));
  oai21  g131(.a(new_n176_), .b(new_n103_), .c(x33), .O(new_n183_));
  nor2   g132(.a(x33), .b(x32), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n165_), .c(new_n146_), .d(new_n128_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n182_), .c(new_n183_), .O(new_n186_));
  ...
  nand2  g141(.a(new_n192_), .b(x25), .O(new_n193_));
  oai21  g142(.a(new_n185_), .b(new_n103_), .c(x34), .O(new_n194_));
  nand2  g143(.a(new_n146_), .b(new_n128_), .O(new_n195_));
  inv1   g144(.a(new_n195_), .O(new_n196_));
  inv1   g145(.a(x31), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(new_n152_), .O(new_n198_));
  inv1   g147(.a(x32), .O(new_n199_));
  inv1   g148(.a(x33), .O(new_n200_));
  nand3  g149(.a(new_n191_), .b(new_n200_), .c(new_n199_), .O(new_n201_));
  nor2   g150(.a(new_n201_), .b(new_n198_), .O(new_n202_));
  nand3  g151(.a(new_n202_), .b(new_n196_), .c(new_n106_), .O(new_n203_));
  aoi21  g152(.a(new_n203_), .b(new_n194_), .c(new_n66_), .O(new_n204_));
  nor2   g153(.a(x16), .b(x00), .O(new_n205_));
  oai21  g154(.a(new_n205_), .b(new_n204_), .c(new_n60_), .O(new_n206_));
  nand2  g155(.a(new_n206_), .b(new_n193_), .O(z15));
endmodule
