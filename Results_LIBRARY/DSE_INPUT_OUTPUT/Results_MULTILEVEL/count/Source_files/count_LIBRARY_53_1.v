...
module FAU ( 
  ...
  nand3  g061(.a(new_n112_), .b(new_n108_), .c(new_n72_), .O(new_n113_));
  ...
  oai21  g075(.a(new_n120_), .b(new_n83_), .c(x28), .O(new_n127_));
  ...
  nor2   g082(.a(x18), .b(x16), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n132_), .O(z09));
  nand4  g085(.a(new_n108_), .b(new_n68_), .c(new_n70_), .d(new_n52_), .O(new_n137_));
  ...
  aoi21  g091(.a(new_n130_), .b(x29), .c(new_n142_), .O(new_n143_));
  ...
  nand4  g096(.a(new_n147_), .b(new_n112_), .c(new_n84_), .d(new_n63_), .O(new_n148_));
  ...
  nand3  g110(.a(new_n161_), .b(new_n158_), .c(new_n93_), .O(new_n162_));
  ...
  nand4  g116(.a(new_n159_), .b(new_n140_), .c(new_n119_), .d(new_n100_), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n92_), .c(x32), .O(new_n169_));
  nor2   g118(.a(x32), .b(x31), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n150_), .c(new_n149_), .d(new_n139_), .O(new_n171_));
  inv1   g120(.a(new_n171_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n93_), .O(new_n173_));
  ...
  oai21  g127(.a(new_n171_), .b(new_n92_), .c(x33), .O(new_n179_));
  nor2   g128(.a(x33), .b(x32), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n159_), .c(new_n140_), .d(new_n119_), .O(new_n181_));
  inv1   g130(.a(new_n181_), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n102_), .O(new_n183_));
  nand3  g132(.a(new_n183_), .b(new_n179_), .c(new_n126_), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(x16), .O(new_n185_));
  inv1   g134(.a(x01), .O(new_n186_));
  nand2  g135(.a(new_n134_), .b(new_n186_), .O(new_n187_));
  nand2  g136(.a(new_n187_), .b(new_n185_), .O(z14));
  oai21  g137(.a(new_n181_), .b(new_n110_), .c(x34), .O(new_n189_));
  nand2  g138(.a(new_n140_), .b(new_n119_), .O(new_n190_));
  ...
  nand3  g149(.a(new_n200_), .b(new_n189_), .c(new_n126_), .O(new_n201_));
  nand2  g150(.a(new_n201_), .b(x16), .O(new_n202_));
  inv1   g151(.a(x00), .O(new_n203_));
  nand2  g152(.a(new_n134_), .b(new_n203_), .O(new_n204_));
