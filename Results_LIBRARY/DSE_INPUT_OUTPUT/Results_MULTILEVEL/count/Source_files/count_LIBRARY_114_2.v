...
module FAU ( 
  ...
  nand3  g05(.a(new_n52_), .b(new_n56_), .c(x12), .O(z03));
  oai21  g06(.a(x16), .b(x11), .c(new_n52_), .O(z04));
  nand3  g07(.a(new_n52_), .b(new_n56_), .c(x10), .O(z05));
  oai21  g08(.a(x16), .b(x09), .c(new_n52_), .O(z06));
  nand3  g09(.a(new_n52_), .b(new_n56_), .c(x08), .O(z07));
  nand3  g10(.a(new_n52_), .b(new_n56_), .c(x07), .O(z08));
  nand3  g11(.a(new_n52_), .b(new_n56_), .c(x06), .O(z09));
  nand3  g12(.a(new_n52_), .b(new_n56_), .c(x05), .O(z10));
  oai21  g13(.a(x16), .b(x04), .c(new_n52_), .O(z11));
  nand3  g14(.a(new_n52_), .b(new_n56_), .c(x03), .O(z12));
