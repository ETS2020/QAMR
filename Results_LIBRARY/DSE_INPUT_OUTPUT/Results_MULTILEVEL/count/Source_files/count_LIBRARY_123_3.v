...
module FAU ( 
  ...
  nand3  g023(.a(new_n74_), .b(new_n63_), .c(x16), .O(new_n75_));
  ...
  nand3  g048(.a(new_n99_), .b(new_n63_), .c(x16), .O(new_n100_));
  ...
  nand4  g064(.a(new_n115_), .b(new_n89_), .c(new_n114_), .d(new_n55_), .O(new_n116_));
  nand2  g065(.a(new_n116_), .b(x26), .O(new_n117_));
  nor2   g066(.a(x26), .b(x25), .O(new_n118_));
  nand3  g067(.a(new_n118_), .b(new_n89_), .c(new_n104_), .O(new_n119_));
  oai21  g068(.a(new_n119_), .b(new_n73_), .c(new_n117_), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n63_), .c(x16), .O(new_n121_));
  nand2  g070(.a(new_n121_), .b(new_n113_), .O(z07));
  inv1   g071(.a(x07), .O(new_n123_));
  oai21  g072(.a(x18), .b(new_n123_), .c(new_n58_), .O(new_n124_));
  oai21  g073(.a(new_n119_), .b(new_n73_), .c(x27), .O(new_n125_));
  nor2   g074(.a(x27), .b(x26), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n97_), .c(new_n105_), .O(new_n127_));
  oai21  g076(.a(new_n127_), .b(new_n81_), .c(new_n125_), .O(new_n128_));
  nand3  g077(.a(new_n128_), .b(new_n63_), .c(x16), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n124_), .O(z08));
  inv1   g079(.a(x06), .O(new_n131_));
  oai21  g080(.a(x18), .b(new_n131_), .c(new_n58_), .O(new_n132_));
  oai21  g081(.a(new_n127_), .b(new_n81_), .c(x28), .O(new_n133_));
  nor3   g082(.a(x22), .b(x21), .c(x20), .O(new_n134_));
  nor3   g083(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  nor3   g084(.a(x28), .b(x27), .c(x26), .O(new_n136_));
  nand4  g085(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n55_), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand3  g087(.a(new_n138_), .b(new_n63_), .c(x16), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n132_), .O(z09));
  inv1   g089(.a(x27), .O(new_n141_));
  nor2   g090(.a(x29), .b(x28), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n118_), .c(new_n141_), .d(new_n104_), .O(new_n143_));
  ...
  nand4  g100(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n65_), .O(new_n152_));
  nor2   g101(.a(x28), .b(x27), .O(new_n153_));
  nor2   g102(.a(x30), .b(x29), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n153_), .c(new_n118_), .d(new_n104_), .O(new_n155_));
  nor2   g104(.a(new_n155_), .b(new_n90_), .O(new_n156_));
  aoi21  g105(.a(new_n152_), .b(x30), .c(new_n156_), .O(new_n157_));
  ...
  oai21  g111(.a(new_n155_), .b(new_n90_), .c(x31), .O(new_n163_));
  nand2  g112(.a(new_n97_), .b(new_n80_), .O(new_n164_));
  inv1   g113(.a(new_n164_), .O(new_n165_));
  nor3   g114(.a(x27), .b(x26), .c(x25), .O(new_n166_));
  nor2   g115(.a(x31), .b(x30), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n142_), .O(new_n168_));
  inv1   g117(.a(new_n168_), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n166_), .c(new_n165_), .d(new_n65_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n163_), .O(new_n171_));
  nand3  g120(.a(new_n171_), .b(new_n63_), .c(x16), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n162_), .O(z12));
  nand4  g122(.a(new_n167_), .b(new_n142_), .c(new_n126_), .d(new_n105_), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(new_n98_), .c(x32), .O(new_n175_));
  nand2  g124(.a(new_n153_), .b(new_n118_), .O(new_n176_));
  inv1   g125(.a(new_n176_), .O(new_n177_));
  nor2   g126(.a(x32), .b(x31), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(new_n154_), .O(new_n179_));
  inv1   g128(.a(new_n179_), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n177_), .c(new_n165_), .d(new_n65_), .O(new_n181_));
  ...
  nand4  g135(.a(new_n178_), .b(new_n154_), .c(new_n153_), .d(new_n118_), .O(new_n187_));
  oai21  g136(.a(new_n187_), .b(new_n98_), .c(x33), .O(new_n188_));
  nor2   g137(.a(x33), .b(x32), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n167_), .c(new_n142_), .d(new_n126_), .O(new_n190_));
  ...
  oai21  g146(.a(new_n190_), .b(new_n116_), .c(x34), .O(new_n198_));
  nand2  g147(.a(new_n142_), .b(new_n126_), .O(new_n199_));
  ...
  nand3  g157(.a(new_n208_), .b(new_n200_), .c(new_n107_), .O(new_n209_));
