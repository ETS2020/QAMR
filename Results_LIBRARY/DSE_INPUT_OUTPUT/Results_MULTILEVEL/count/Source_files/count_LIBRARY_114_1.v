...
module FAU ( 
  ...
  nand4  g033(.a(new_n84_), .b(new_n70_), .c(new_n69_), .d(new_n63_), .O(new_n85_));
  nand2  g034(.a(new_n85_), .b(new_n52_), .O(new_n86_));
  aoi21  g035(.a(new_n83_), .b(x23), .c(new_n86_), .O(new_n87_));
  oai22  g036(.a(new_n87_), .b(new_n76_), .c(new_n59_), .d(x11), .O(z04));
  nor2   g037(.a(x24), .b(x23), .O(new_n89_));
  nand4  g038(.a(new_n89_), .b(new_n82_), .c(new_n70_), .d(new_n63_), .O(new_n90_));
  inv1   g039(.a(new_n90_), .O(new_n91_));
  aoi21  g040(.a(new_n85_), .b(x24), .c(new_n91_), .O(new_n92_));
  inv1   g041(.a(x10), .O(new_n93_));
  aoi21  g042(.a(new_n76_), .b(new_n93_), .c(x18), .O(new_n94_));
  oai21  g043(.a(new_n92_), .b(new_n76_), .c(new_n94_), .O(z05));
  nor2   g044(.a(x21), .b(x20), .O(new_n96_));
  nor2   g045(.a(x25), .b(x24), .O(new_n97_));
  nand4  g046(.a(new_n97_), .b(new_n84_), .c(new_n96_), .d(new_n54_), .O(new_n98_));
  nand2  g047(.a(new_n98_), .b(new_n52_), .O(new_n99_));
  aoi21  g048(.a(new_n90_), .b(x25), .c(new_n99_), .O(new_n100_));
  oai22  g049(.a(new_n100_), .b(new_n76_), .c(new_n59_), .d(x09), .O(z06));
  nand2  g050(.a(new_n98_), .b(x26), .O(new_n102_));
  nor3   g051(.a(x26), .b(x25), .c(x24), .O(new_n103_));
  nand4  g052(.a(new_n103_), .b(new_n84_), .c(new_n96_), .d(new_n54_), .O(new_n104_));
  aoi21  g053(.a(new_n104_), .b(new_n102_), .c(new_n76_), .O(new_n105_));
  oai21  g054(.a(x16), .b(x08), .c(new_n52_), .O(new_n106_));
  or2    g055(.a(new_n106_), .b(new_n105_), .O(z07));
  inv1   g056(.a(x25), .O(new_n108_));
  nor2   g057(.a(x27), .b(x26), .O(new_n109_));
  nand3  g058(.a(new_n109_), .b(new_n89_), .c(new_n108_), .O(new_n110_));
  ...
  aoi21  g062(.a(new_n76_), .b(new_n113_), .c(x18), .O(new_n114_));
  oai21  g063(.a(new_n112_), .b(new_n76_), .c(new_n114_), .O(z08));
  inv1   g064(.a(x28), .O(new_n116_));
  nor3   g065(.a(x25), .b(x24), .c(x23), .O(new_n117_));
  nor3   g066(.a(x28), .b(x27), .c(x26), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n117_), .c(new_n77_), .d(new_n54_), .O(new_n119_));
  ...
  aoi21  g071(.a(new_n76_), .b(new_n122_), .c(x18), .O(new_n123_));
  ...
  aoi21  g079(.a(new_n119_), .b(x29), .c(new_n130_), .O(new_n131_));
  inv1   g080(.a(x05), .O(new_n132_));
  aoi21  g081(.a(new_n76_), .b(new_n132_), .c(x18), .O(new_n133_));
  oai21  g082(.a(new_n131_), .b(new_n76_), .c(new_n133_), .O(z10));
  oai21  g083(.a(new_n129_), .b(new_n85_), .c(x30), .O(new_n135_));
  inv1   g084(.a(x22), .O(new_n136_));
  inv1   g085(.a(x23), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n136_), .c(new_n69_), .O(new_n138_));
  nor2   g087(.a(new_n138_), .b(new_n65_), .O(new_n139_));
  nor2   g088(.a(x28), .b(x27), .O(new_n140_));
  nor2   g089(.a(x30), .b(x29), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n140_), .c(new_n103_), .d(new_n139_), .O(new_n142_));
  nand3  g091(.a(new_n142_), .b(new_n135_), .c(new_n52_), .O(new_n143_));
  ...
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n127_), .d(new_n125_), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n85_), .c(x31), .O(new_n149_));
  ...
  nand3  g102(.a(new_n153_), .b(new_n150_), .c(new_n91_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n149_), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(x16), .O(new_n156_));
  inv1   g105(.a(x03), .O(new_n157_));
  aoi21  g106(.a(new_n76_), .b(new_n157_), .c(x18), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n156_), .O(z12));
  nand4  g108(.a(new_n151_), .b(new_n128_), .c(new_n109_), .d(new_n108_), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n90_), .c(x32), .O(new_n161_));
  nor2   g110(.a(x32), .b(x31), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n141_), .c(new_n140_), .d(new_n127_), .O(new_n163_));
  inv1   g112(.a(new_n163_), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(new_n91_), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n161_), .c(new_n52_), .O(new_n166_));
  ...
  nand4  g120(.a(new_n108_), .b(new_n125_), .c(new_n137_), .d(new_n136_), .O(new_n172_));
  nor2   g121(.a(new_n172_), .b(new_n72_), .O(new_n173_));
  nor2   g122(.a(x33), .b(x32), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n151_), .c(new_n128_), .d(new_n109_), .O(new_n175_));
  ...
  oai21  g131(.a(new_n175_), .b(new_n98_), .c(x34), .O(new_n183_));
  nand2  g132(.a(new_n128_), .b(new_n109_), .O(new_n184_));
