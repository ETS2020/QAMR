...
module FAU ( 
  ...
  nand4  g065(.a(new_n116_), .b(new_n88_), .c(new_n115_), .d(new_n55_), .O(new_n117_));
  ...
  nand3  g075(.a(new_n126_), .b(new_n100_), .c(new_n108_), .O(new_n127_));
  ...
  nand3  g106(.a(new_n157_), .b(new_n119_), .c(new_n97_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n153_), .O(new_n159_));
  nand3  g108(.a(new_n159_), .b(new_n83_), .c(x16), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n152_), .O(z11));
  inv1   g110(.a(x03), .O(new_n162_));
  oai21  g111(.a(x18), .b(new_n162_), .c(new_n58_), .O(new_n163_));
  nand4  g112(.a(new_n155_), .b(new_n154_), .c(new_n143_), .d(new_n93_), .O(new_n164_));
  oai21  g113(.a(new_n164_), .b(new_n89_), .c(x31), .O(new_n165_));
  ...
  nand3  g134(.a(new_n185_), .b(new_n83_), .c(x16), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(new_n176_), .O(z13));
  inv1   g136(.a(x01), .O(new_n188_));
  oai21  g137(.a(x18), .b(new_n188_), .c(new_n58_), .O(new_n189_));
  nand4  g138(.a(new_n181_), .b(new_n155_), .c(new_n154_), .d(new_n143_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n107_), .c(x33), .O(new_n191_));
  inv1   g140(.a(new_n109_), .O(new_n192_));
  nand2  g141(.a(new_n144_), .b(new_n126_), .O(new_n193_));
  ...
  nand3  g148(.a(new_n199_), .b(new_n83_), .c(x16), .O(new_n200_));
  nand2  g149(.a(new_n200_), .b(new_n189_), .O(z14));
  nand4  g150(.a(new_n195_), .b(new_n168_), .c(new_n144_), .d(new_n126_), .O(new_n202_));
  oai21  g151(.a(new_n202_), .b(new_n117_), .c(x34), .O(new_n203_));
  ...
  nand3  g160(.a(new_n211_), .b(new_n194_), .c(new_n110_), .O(new_n212_));
