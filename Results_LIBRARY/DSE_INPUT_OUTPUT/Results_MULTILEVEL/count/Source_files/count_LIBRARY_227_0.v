...
module FAU ( 
  ...
  and2   g042(.a(new_n89_), .b(x24), .O(new_n94_));
  ...
  oai21  g072(.a(new_n118_), .b(new_n86_), .c(x28), .O(new_n124_));
  ...
  oai21  g078(.a(new_n129_), .b(new_n128_), .c(x29), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(new_n52_), .O(z09));
  nor2   g080(.a(x16), .b(x05), .O(new_n132_));
  aoi21  g081(.a(new_n127_), .b(x16), .c(new_n132_), .O(new_n133_));
  oai21  g082(.a(new_n133_), .b(new_n53_), .c(new_n52_), .O(z10));
  ...
  nand3  g087(.a(new_n138_), .b(new_n136_), .c(new_n135_), .O(z11));
  nor2   g088(.a(x16), .b(x03), .O(new_n140_));
  and2   g089(.a(x31), .b(x16), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n140_), .c(x29), .O(new_n142_));
