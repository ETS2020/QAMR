...
module FAU ( 
  ...
  oai21  g022(.a(new_n73_), .b(x18), .c(new_n58_), .O(z02));
  ...
  nand2  g030(.a(new_n81_), .b(new_n58_), .O(z03));
  ...
  nand2  g046(.a(new_n97_), .b(new_n58_), .O(z05));
  nor2   g047(.a(x25), .b(x24), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n86_), .c(new_n69_), .d(new_n53_), .O(new_n100_));
  inv1   g049(.a(new_n100_), .O(new_n101_));
  aoi21  g050(.a(new_n94_), .b(x25), .c(new_n101_), .O(new_n102_));
  inv1   g051(.a(x09), .O(new_n103_));
  aoi21  g052(.a(new_n61_), .b(new_n103_), .c(x18), .O(new_n104_));
  oai21  g053(.a(new_n102_), .b(new_n61_), .c(new_n104_), .O(z06));
  nand2  g054(.a(new_n100_), .b(x26), .O(new_n106_));
  nor3   g055(.a(x26), .b(x25), .c(x24), .O(new_n107_));
  nand4  g056(.a(new_n107_), .b(new_n86_), .c(new_n69_), .d(new_n53_), .O(new_n108_));
  aoi21  g057(.a(new_n108_), .b(new_n106_), .c(new_n61_), .O(new_n109_));
  ...
  oai21  g064(.a(new_n115_), .b(new_n70_), .c(x27), .O(new_n116_));
  nor3   g065(.a(x22), .b(x21), .c(x20), .O(new_n117_));
  nor3   g066(.a(x27), .b(x26), .c(x25), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n93_), .c(new_n117_), .d(new_n53_), .O(new_n119_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n99_), .c(new_n136_), .d(new_n135_), .O(new_n138_));
  oai21  g087(.a(new_n138_), .b(new_n78_), .c(x29), .O(new_n139_));
  nor3   g088(.a(x23), .b(x22), .c(x21), .O(new_n140_));
  nor3   g089(.a(x29), .b(x28), .c(x27), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n107_), .c(new_n140_), .d(new_n62_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n139_), .c(new_n61_), .O(new_n143_));
  nor2   g092(.a(x16), .b(x05), .O(new_n144_));
  oai21  g093(.a(new_n144_), .b(new_n143_), .c(new_n60_), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n58_), .O(z10));
  nor2   g095(.a(x30), .b(x29), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n137_), .c(new_n114_), .d(new_n113_), .O(new_n148_));
  ...
  aoi21  g100(.a(new_n61_), .b(new_n151_), .c(x18), .O(new_n152_));
  ...
  nand4  g104(.a(new_n113_), .b(new_n135_), .c(new_n155_), .d(new_n68_), .O(new_n156_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n118_), .c(new_n157_), .d(new_n62_), .O(new_n164_));
  aoi21  g113(.a(new_n164_), .b(new_n154_), .c(new_n61_), .O(new_n165_));
  nor2   g114(.a(x16), .b(x03), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n165_), .c(new_n60_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n58_), .O(z12));
  nor2   g117(.a(x29), .b(x28), .O(new_n169_));
  nor2   g118(.a(x31), .b(x30), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n169_), .c(new_n125_), .d(new_n124_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n94_), .c(x32), .O(new_n172_));
  inv1   g121(.a(x27), .O(new_n173_));
  nand4  g122(.a(new_n158_), .b(new_n173_), .c(new_n136_), .d(new_n124_), .O(new_n174_));
  inv1   g123(.a(new_n174_), .O(new_n175_));
  inv1   g124(.a(x32), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n161_), .c(new_n160_), .d(new_n159_), .O(new_n177_));
  inv1   g126(.a(new_n177_), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n175_), .c(new_n157_), .d(new_n62_), .O(new_n179_));
  aoi21  g128(.a(new_n179_), .b(new_n172_), .c(new_n61_), .O(new_n180_));
  nor2   g129(.a(x16), .b(x02), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n180_), .c(new_n60_), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n58_), .O(z13));
  nand2  g132(.a(new_n179_), .b(x33), .O(new_n184_));
  nor2   g133(.a(x33), .b(x32), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n170_), .c(new_n169_), .d(new_n125_), .O(new_n186_));
  or2    g135(.a(new_n186_), .b(new_n100_), .O(new_n187_));
  ...
  oai21  g141(.a(new_n186_), .b(new_n100_), .c(x34), .O(new_n193_));
  nand2  g142(.a(new_n169_), .b(new_n125_), .O(new_n194_));
  inv1   g143(.a(new_n194_), .O(new_n195_));
  nor3   g144(.a(x34), .b(x33), .c(x32), .O(new_n196_));
  nand3  g145(.a(new_n196_), .b(new_n195_), .c(new_n170_), .O(new_n197_));
  oai21  g146(.a(new_n197_), .b(new_n100_), .c(new_n193_), .O(new_n198_));
