...
module FAU ( 
  ...
  nand4  g044(.a(new_n95_), .b(new_n79_), .c(new_n62_), .d(new_n61_), .O(new_n96_));
  ...
  nand3  g067(.a(new_n118_), .b(new_n95_), .c(new_n103_), .O(new_n119_));
  ...
  oai21  g072(.a(new_n121_), .b(new_n56_), .c(new_n123_), .O(z08));
  inv1   g073(.a(x28), .O(new_n125_));
  nor2   g074(.a(x25), .b(x24), .O(new_n126_));
  nor2   g075(.a(x28), .b(x27), .O(new_n127_));
  nand4  g076(.a(new_n127_), .b(new_n126_), .c(new_n110_), .d(new_n86_), .O(new_n128_));
  ...
  nand4  g101(.a(new_n148_), .b(new_n127_), .c(new_n145_), .d(new_n102_), .O(new_n153_));
  ...
  nand4  g115(.a(new_n156_), .b(new_n138_), .c(new_n118_), .d(new_n103_), .O(new_n167_));
  ...
  nand2  g120(.a(new_n171_), .b(new_n97_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n168_), .O(new_n173_));
  nand3  g122(.a(new_n173_), .b(new_n52_), .c(x16), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n166_), .O(z13));
  inv1   g124(.a(x33), .O(new_n176_));
  aoi21  g125(.a(new_n171_), .b(new_n97_), .c(new_n176_), .O(new_n177_));
  nor2   g126(.a(x21), .b(x20), .O(new_n178_));
  nand4  g127(.a(new_n126_), .b(new_n93_), .c(new_n178_), .d(new_n60_), .O(new_n179_));
  nor2   g128(.a(x33), .b(x32), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n156_), .c(new_n138_), .d(new_n118_), .O(new_n181_));
  ...
  oai21  g137(.a(new_n181_), .b(new_n179_), .c(x34), .O(new_n189_));
  nand2  g138(.a(new_n138_), .b(new_n118_), .O(new_n190_));
  ...
  nand3  g145(.a(new_n196_), .b(new_n176_), .c(new_n195_), .O(new_n197_));
  nor2   g146(.a(new_n197_), .b(new_n194_), .O(new_n198_));
  nand3  g147(.a(new_n198_), .b(new_n191_), .c(new_n105_), .O(new_n199_));
