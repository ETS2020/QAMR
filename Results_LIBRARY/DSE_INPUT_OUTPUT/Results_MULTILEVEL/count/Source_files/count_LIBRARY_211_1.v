...
module FAU ( 
  ...
  nand4  g035(.a(new_n86_), .b(new_n85_), .c(new_n69_), .d(new_n63_), .O(new_n87_));
  nand2  g036(.a(new_n87_), .b(new_n52_), .O(new_n88_));
  aoi21  g037(.a(new_n80_), .b(x23), .c(new_n88_), .O(new_n89_));
  oai22  g038(.a(new_n89_), .b(new_n84_), .c(new_n59_), .d(x11), .O(z04));
  inv1   g039(.a(x24), .O(new_n91_));
  inv1   g040(.a(x23), .O(new_n92_));
  nand3  g041(.a(new_n92_), .b(new_n76_), .c(new_n69_), .O(new_n93_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n96_), .c(new_n85_), .d(new_n63_), .O(new_n98_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n86_), .c(new_n104_), .d(new_n54_), .O(new_n106_));
  nand2  g055(.a(new_n106_), .b(new_n52_), .O(new_n107_));
  aoi21  g056(.a(new_n98_), .b(x25), .c(new_n107_), .O(new_n108_));
  oai22  g057(.a(new_n108_), .b(new_n84_), .c(new_n59_), .d(x09), .O(z06));
  nand2  g058(.a(new_n106_), .b(x26), .O(new_n110_));
  nor3   g059(.a(x26), .b(x25), .c(x24), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(new_n86_), .c(new_n77_), .O(new_n112_));
  nand3  g061(.a(new_n112_), .b(new_n110_), .c(new_n52_), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(x16), .O(new_n114_));
  inv1   g063(.a(x08), .O(new_n115_));
  nand2  g064(.a(new_n58_), .b(new_n115_), .O(new_n116_));
  ...
  nand4  g070(.a(new_n121_), .b(new_n97_), .c(new_n79_), .d(new_n54_), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n120_), .c(new_n52_), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(x16), .O(new_n124_));
  oai21  g073(.a(new_n59_), .b(x07), .c(new_n124_), .O(z08));
  nand2  g074(.a(new_n122_), .b(x28), .O(new_n126_));
  nor3   g075(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nor3   g076(.a(x28), .b(x27), .c(x26), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n127_), .c(new_n79_), .d(new_n54_), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n126_), .c(new_n52_), .O(new_n130_));
  ...
  nand4  g085(.a(new_n136_), .b(new_n118_), .c(new_n135_), .d(new_n91_), .O(new_n137_));
  ...
  oai21  g090(.a(new_n139_), .b(new_n84_), .c(new_n141_), .O(z10));
  oai21  g091(.a(new_n137_), .b(new_n87_), .c(x30), .O(new_n143_));
  nor2   g092(.a(x28), .b(x27), .O(new_n144_));
  nor2   g093(.a(x30), .b(x29), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n144_), .c(new_n111_), .d(new_n94_), .O(new_n146_));
  nand3  g095(.a(new_n146_), .b(new_n143_), .c(new_n52_), .O(new_n147_));
  ...
  nand4  g100(.a(new_n145_), .b(new_n144_), .c(new_n118_), .d(new_n91_), .O(new_n152_));
  oai21  g101(.a(new_n152_), .b(new_n87_), .c(x31), .O(new_n153_));
  nand2  g102(.a(new_n97_), .b(new_n96_), .O(new_n154_));
  inv1   g103(.a(new_n154_), .O(new_n155_));
  nor2   g104(.a(x31), .b(x30), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n136_), .O(new_n157_));
  inv1   g106(.a(new_n157_), .O(new_n158_));
  nand4  g107(.a(new_n158_), .b(new_n121_), .c(new_n155_), .d(new_n70_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n153_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(x16), .O(new_n161_));
  inv1   g110(.a(x03), .O(new_n162_));
  aoi21  g111(.a(new_n84_), .b(new_n162_), .c(x18), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n161_), .O(z12));
  inv1   g113(.a(x25), .O(new_n165_));
  nor2   g114(.a(x27), .b(x26), .O(new_n166_));
  nand4  g115(.a(new_n156_), .b(new_n136_), .c(new_n166_), .d(new_n165_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n98_), .c(x32), .O(new_n168_));
  nor2   g117(.a(x32), .b(x31), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n145_), .c(new_n144_), .d(new_n118_), .O(new_n170_));
  inv1   g119(.a(new_n170_), .O(new_n171_));
  nand3  g120(.a(new_n171_), .b(new_n155_), .c(new_n70_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n168_), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(x16), .O(new_n174_));
  inv1   g123(.a(x02), .O(new_n175_));
  aoi21  g124(.a(new_n84_), .b(new_n175_), .c(x18), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(new_n174_), .O(z13));
  oai21  g126(.a(new_n170_), .b(new_n98_), .c(x33), .O(new_n178_));
  nand4  g127(.a(new_n165_), .b(new_n91_), .c(new_n92_), .d(new_n76_), .O(new_n179_));
  nor2   g128(.a(new_n179_), .b(new_n72_), .O(new_n180_));
  nor2   g129(.a(x33), .b(x32), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n156_), .c(new_n136_), .d(new_n166_), .O(new_n182_));
  inv1   g131(.a(new_n182_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(new_n180_), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n178_), .c(new_n52_), .O(new_n185_));
  ...
  oai21  g138(.a(new_n182_), .b(new_n106_), .c(x34), .O(new_n190_));
  nand2  g139(.a(new_n136_), .b(new_n166_), .O(new_n191_));
  ...
  nand3  g149(.a(new_n200_), .b(new_n192_), .c(new_n180_), .O(new_n201_));
  nand3  g150(.a(new_n201_), .b(new_n190_), .c(new_n52_), .O(new_n202_));
