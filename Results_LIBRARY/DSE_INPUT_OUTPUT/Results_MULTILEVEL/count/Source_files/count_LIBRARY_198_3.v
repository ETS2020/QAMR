...
module FAU ( 
  ...
  oai21  g059(.a(x18), .b(new_n58_), .c(new_n68_), .O(new_n111_));
  nand2  g060(.a(new_n106_), .b(x26), .O(new_n112_));
  inv1   g061(.a(x24), .O(new_n113_));
  nor2   g062(.a(x26), .b(x25), .O(new_n114_));
  nand3  g063(.a(new_n114_), .b(new_n104_), .c(new_n113_), .O(new_n115_));
  oai21  g064(.a(new_n115_), .b(new_n73_), .c(new_n112_), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n61_), .c(x16), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n111_), .O(z07));
  oai21  g067(.a(new_n115_), .b(new_n73_), .c(x27), .O(new_n119_));
  nor3   g068(.a(x27), .b(x26), .c(x25), .O(new_n120_));
  nand4  g069(.a(new_n120_), .b(new_n96_), .c(new_n80_), .d(new_n55_), .O(new_n121_));
  ...
  nand4  g085(.a(new_n136_), .b(new_n135_), .c(new_n87_), .d(new_n63_), .O(new_n137_));
  ...
  nand2  g089(.a(new_n140_), .b(new_n69_), .O(z10));
  ...
  nand3  g101(.a(new_n152_), .b(new_n151_), .c(new_n120_), .O(new_n153_));
  oai22  g102(.a(new_n153_), .b(new_n97_), .c(new_n145_), .d(new_n150_), .O(new_n154_));
  ...
  oai21  g107(.a(new_n153_), .b(new_n97_), .c(x32), .O(new_n159_));
  nor2   g108(.a(x32), .b(x31), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n143_), .c(new_n142_), .d(new_n114_), .O(new_n161_));
  ...
  nand4  g119(.a(new_n170_), .b(new_n113_), .c(new_n169_), .d(new_n168_), .O(new_n171_));
  ...
  nand2  g129(.a(new_n180_), .b(new_n69_), .O(z14));
  ...
  nand2  g144(.a(new_n195_), .b(new_n69_), .O(z15));
endmodule
