...
module FAU ( 
  ...
  nand4  g041(.a(new_n92_), .b(new_n73_), .c(new_n91_), .d(new_n52_), .O(new_n93_));
  ...
  nand3  g050(.a(new_n101_), .b(new_n83_), .c(new_n68_), .O(new_n102_));
  ...
  aoi21  g055(.a(new_n106_), .b(new_n104_), .c(new_n61_), .O(z05));
  nor2   g056(.a(x25), .b(x24), .O(new_n108_));
  nand2  g057(.a(new_n108_), .b(new_n92_), .O(new_n109_));
  inv1   g058(.a(new_n109_), .O(new_n110_));
  aoi22  g059(.a(new_n110_), .b(new_n77_), .c(new_n102_), .d(x25), .O(new_n111_));
  ...
  aoi21  g064(.a(new_n110_), .b(new_n77_), .c(new_n115_), .O(new_n116_));
  nor3   g065(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n92_), .O(new_n118_));
  nor2   g067(.a(new_n118_), .b(new_n76_), .O(new_n119_));
  ...
  aoi21  g071(.a(new_n122_), .b(new_n120_), .c(new_n61_), .O(z07));
  ...
  nand4  g075(.a(new_n126_), .b(new_n101_), .c(new_n125_), .d(new_n55_), .O(new_n127_));
  ...
  aoi21  g080(.a(new_n131_), .b(new_n129_), .c(new_n61_), .O(z08));
  nor3   g081(.a(x25), .b(x24), .c(x23), .O(new_n133_));
  nor3   g082(.a(x28), .b(x27), .c(x26), .O(new_n134_));
  nand4  g083(.a(new_n134_), .b(new_n133_), .c(new_n125_), .d(new_n55_), .O(new_n135_));
  inv1   g084(.a(new_n135_), .O(new_n136_));
  aoi21  g085(.a(new_n127_), .b(x28), .c(new_n136_), .O(new_n137_));
  ...
  oai21  g089(.a(x16), .b(x05), .c(new_n59_), .O(new_n141_));
  nand2  g090(.a(new_n141_), .b(new_n62_), .O(new_n142_));
  nand3  g091(.a(new_n135_), .b(x31), .c(x29), .O(new_n143_));
  inv1   g092(.a(x27), .O(new_n144_));
  nor2   g093(.a(x29), .b(x28), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n117_), .c(new_n100_), .d(new_n144_), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n142_), .O(z10));
  nor2   g098(.a(new_n61_), .b(x04), .O(new_n150_));
  inv1   g099(.a(x31), .O(new_n151_));
  nor2   g100(.a(new_n151_), .b(new_n59_), .O(new_n152_));
  oai21  g101(.a(new_n152_), .b(new_n150_), .c(new_n58_), .O(new_n153_));
  oai21  g102(.a(new_n151_), .b(x30), .c(x29), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(x18), .O(new_n155_));
  inv1   g104(.a(x23), .O(new_n156_));
  nor2   g105(.a(x28), .b(x27), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n108_), .c(new_n115_), .d(new_n156_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n84_), .c(x30), .O(new_n159_));
  nor3   g108(.a(x23), .b(x22), .c(x21), .O(new_n160_));
  nor3   g109(.a(x30), .b(x28), .c(x27), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n117_), .c(new_n160_), .d(new_n68_), .O(new_n162_));
  aoi21  g111(.a(new_n162_), .b(new_n159_), .c(x29), .O(new_n163_));
  nand3  g112(.a(x31), .b(x30), .c(x29), .O(new_n164_));
  inv1   g113(.a(new_n164_), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n163_), .c(x16), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n155_), .c(new_n153_), .O(z11));
  oai21  g116(.a(x16), .b(x03), .c(new_n59_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n62_), .O(new_n169_));
  inv1   g118(.a(x30), .O(new_n170_));
  nand4  g119(.a(new_n157_), .b(new_n117_), .c(new_n170_), .d(new_n60_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n93_), .c(x31), .O(new_n172_));
  nand4  g121(.a(new_n99_), .b(new_n156_), .c(new_n82_), .d(new_n91_), .O(new_n173_));
  nor2   g122(.a(new_n173_), .b(new_n74_), .O(new_n174_));
  nor2   g123(.a(x31), .b(x30), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n145_), .c(new_n126_), .d(new_n174_), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(new_n172_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(x16), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(new_n169_), .O(z12));
  oai21  g128(.a(x16), .b(x02), .c(new_n59_), .O(new_n180_));
  nand2  g129(.a(new_n180_), .b(new_n62_), .O(new_n181_));
  nor2   g130(.a(x26), .b(x25), .O(new_n182_));
  nor2   g131(.a(x30), .b(x28), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n182_), .c(new_n144_), .d(new_n99_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n93_), .c(x32), .O(new_n185_));
  inv1   g134(.a(new_n173_), .O(new_n186_));
  inv1   g135(.a(x28), .O(new_n187_));
  inv1   g136(.a(x32), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n151_), .c(new_n170_), .d(new_n187_), .O(new_n189_));
  inv1   g138(.a(new_n189_), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n126_), .c(new_n186_), .d(new_n68_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n185_), .c(x29), .O(new_n192_));
  nor2   g141(.a(new_n188_), .b(new_n151_), .O(new_n193_));
  oai21  g142(.a(new_n193_), .b(new_n192_), .c(x16), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n181_), .O(z13));
  inv1   g144(.a(x33), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n58_), .c(x31), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(x29), .O(new_n198_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n199_));
  nor2   g148(.a(x33), .b(x32), .O(new_n200_));
  nand2  g149(.a(new_n200_), .b(new_n175_), .O(new_n201_));
  inv1   g150(.a(new_n201_), .O(new_n202_));
  nand4  g151(.a(new_n202_), .b(new_n157_), .c(new_n182_), .d(new_n174_), .O(new_n203_));
  ...
  nand3  g156(.a(new_n207_), .b(new_n205_), .c(new_n198_), .O(z14));
  inv1   g157(.a(x34), .O(new_n209_));
  oai21  g158(.a(new_n209_), .b(new_n58_), .c(x31), .O(new_n210_));
  nand2  g159(.a(new_n210_), .b(x29), .O(new_n211_));
  nand4  g160(.a(new_n200_), .b(new_n175_), .c(new_n157_), .d(new_n182_), .O(new_n212_));
  oai21  g161(.a(new_n212_), .b(new_n102_), .c(x34), .O(new_n213_));
  nand3  g162(.a(new_n183_), .b(new_n144_), .c(new_n115_), .O(new_n214_));
  nand4  g163(.a(new_n209_), .b(new_n196_), .c(new_n188_), .d(new_n151_), .O(new_n215_));
  nor2   g164(.a(new_n215_), .b(new_n214_), .O(new_n216_));
  nand3  g165(.a(new_n216_), .b(new_n110_), .c(new_n77_), .O(new_n217_));
  ...
  nand3  g170(.a(new_n221_), .b(new_n219_), .c(new_n211_), .O(z15));
endmodule
