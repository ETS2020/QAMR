...
module FAU ( 
  ...
  nand3  g017(.a(new_n68_), .b(new_n65_), .c(x09), .O(z01));
  ...
  oai21  g048(.a(new_n99_), .b(new_n98_), .c(x09), .O(new_n100_));
  nand2  g049(.a(new_n100_), .b(new_n53_), .O(z05));
  nor2   g050(.a(x25), .b(x24), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n92_), .c(new_n70_), .d(new_n59_), .O(new_n103_));
  inv1   g052(.a(new_n103_), .O(new_n104_));
  aoi21  g053(.a(new_n97_), .b(x25), .c(new_n104_), .O(new_n105_));
  nor2   g054(.a(x18), .b(new_n52_), .O(new_n106_));
  oai21  g055(.a(new_n105_), .b(new_n67_), .c(new_n106_), .O(z06));
  ...
  oai21  g070(.a(new_n121_), .b(new_n120_), .c(x09), .O(new_n122_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n129_), .c(x09), .O(z09));
  ...
  oai21  g099(.a(new_n150_), .b(new_n149_), .c(x09), .O(new_n151_));
  ...
  nand4  g115(.a(new_n143_), .b(new_n133_), .c(new_n108_), .d(new_n154_), .O(new_n167_));
  ...
  oai21  g124(.a(new_n175_), .b(new_n174_), .c(x09), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(new_n53_), .O(z13));
  ...
  oai21  g135(.a(new_n180_), .b(new_n103_), .c(x34), .O(new_n187_));
  ...
  nand3  g144(.a(new_n195_), .b(new_n193_), .c(x09), .O(z15));
endmodule
