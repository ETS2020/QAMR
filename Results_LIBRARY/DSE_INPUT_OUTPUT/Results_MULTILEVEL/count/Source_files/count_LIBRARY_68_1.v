...
module FAU ( 
  ...
  oai21  g036(.a(new_n68_), .b(x11), .c(new_n87_), .O(z04));
  inv1   g037(.a(x24), .O(new_n89_));
  inv1   g038(.a(x22), .O(new_n90_));
  nand3  g039(.a(new_n82_), .b(new_n90_), .c(new_n70_), .O(new_n91_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n84_), .c(new_n102_), .d(new_n55_), .O(new_n104_));
  ...
  nand4  g058(.a(new_n109_), .b(new_n84_), .c(new_n102_), .d(new_n55_), .O(new_n110_));
  nand3  g059(.a(new_n110_), .b(new_n108_), .c(new_n63_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(x16), .O(new_n112_));
  oai21  g061(.a(new_n68_), .b(x08), .c(new_n112_), .O(z07));
  nor2   g062(.a(x26), .b(x25), .O(new_n114_));
  nand3  g063(.a(new_n114_), .b(new_n84_), .c(new_n89_), .O(new_n115_));
  oai21  g064(.a(new_n115_), .b(new_n73_), .c(x27), .O(new_n116_));
  ...
  oai21  g069(.a(new_n68_), .b(x07), .c(new_n120_), .O(z08));
  ...
  and2   g080(.a(new_n131_), .b(new_n109_), .O(new_n132_));
  aoi22  g081(.a(new_n132_), .b(new_n92_), .c(new_n125_), .d(x29), .O(new_n133_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n109_), .c(new_n92_), .O(new_n137_));
  nor2   g086(.a(x28), .b(x27), .O(new_n138_));
  nor2   g087(.a(x30), .b(x29), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n138_), .c(new_n114_), .d(new_n89_), .O(new_n140_));
  ...
  nand2  g094(.a(new_n139_), .b(new_n138_), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n109_), .c(new_n92_), .O(new_n148_));
  ...
  aoi21  g103(.a(new_n148_), .b(x31), .c(new_n154_), .O(new_n155_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n139_), .c(new_n138_), .d(new_n114_), .O(new_n162_));
  ...
  nand4  g119(.a(new_n149_), .b(new_n89_), .c(new_n82_), .d(new_n90_), .O(new_n171_));
  ...
  nand3  g142(.a(new_n193_), .b(new_n182_), .c(new_n63_), .O(new_n194_));
