...
module FAU ( 
  ...
  oai21  g026(.a(new_n77_), .b(new_n70_), .c(new_n59_), .O(z02));
  ...
  nand4  g044(.a(new_n95_), .b(new_n94_), .c(new_n71_), .d(new_n52_), .O(new_n96_));
  nand2  g045(.a(new_n96_), .b(x24), .O(new_n97_));
  nor2   g046(.a(x24), .b(x23), .O(new_n98_));
  nand3  g047(.a(new_n98_), .b(new_n84_), .c(new_n72_), .O(new_n99_));
  aoi21  g048(.a(new_n99_), .b(new_n97_), .c(new_n58_), .O(new_n100_));
  nor2   g049(.a(x16), .b(x10), .O(new_n101_));
  oai21  g050(.a(new_n101_), .b(new_n100_), .c(x31), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(new_n59_), .O(z05));
  nand2  g052(.a(new_n99_), .b(x25), .O(new_n104_));
  nor2   g053(.a(x25), .b(x24), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n95_), .c(new_n73_), .d(new_n55_), .O(new_n106_));
  aoi21  g055(.a(new_n106_), .b(new_n104_), .c(new_n58_), .O(new_n107_));
  nor2   g056(.a(x16), .b(x09), .O(new_n108_));
  oai21  g057(.a(new_n108_), .b(new_n107_), .c(x31), .O(new_n109_));
  nand2  g058(.a(new_n109_), .b(new_n59_), .O(z06));
  nand2  g059(.a(new_n106_), .b(x26), .O(new_n111_));
  nor3   g060(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n95_), .c(new_n73_), .d(new_n55_), .O(new_n113_));
  aoi21  g062(.a(new_n113_), .b(new_n111_), .c(new_n58_), .O(new_n114_));
  nor2   g063(.a(x16), .b(x08), .O(new_n115_));
  oai21  g064(.a(new_n115_), .b(new_n114_), .c(x31), .O(new_n116_));
  nand2  g065(.a(new_n116_), .b(new_n59_), .O(z07));
  inv1   g066(.a(x24), .O(new_n118_));
  nor2   g067(.a(x26), .b(x25), .O(new_n119_));
  nand3  g068(.a(new_n119_), .b(new_n95_), .c(new_n118_), .O(new_n120_));
  oai21  g069(.a(new_n120_), .b(new_n74_), .c(x27), .O(new_n121_));
  nor3   g070(.a(x27), .b(x26), .c(x25), .O(new_n122_));
  nand4  g071(.a(new_n122_), .b(new_n98_), .c(new_n79_), .d(new_n55_), .O(new_n123_));
  aoi21  g072(.a(new_n123_), .b(new_n121_), .c(new_n58_), .O(new_n124_));
  nor2   g073(.a(x16), .b(x07), .O(new_n125_));
  oai21  g074(.a(new_n125_), .b(new_n124_), .c(x31), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n59_), .O(z08));
  inv1   g076(.a(x26), .O(new_n128_));
  nor2   g077(.a(x28), .b(x27), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n105_), .c(new_n128_), .d(new_n87_), .O(new_n130_));
  ...
  oai21  g084(.a(new_n130_), .b(new_n85_), .c(x29), .O(new_n136_));
  nor3   g085(.a(x29), .b(x28), .c(x27), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n112_), .c(new_n89_), .O(new_n138_));
  aoi21  g087(.a(new_n138_), .b(new_n136_), .c(new_n58_), .O(new_n139_));
  nor2   g088(.a(x16), .b(x05), .O(new_n140_));
  oai21  g089(.a(new_n140_), .b(new_n139_), .c(x31), .O(new_n141_));
  nand2  g090(.a(new_n141_), .b(new_n59_), .O(z10));
  inv1   g091(.a(x27), .O(new_n143_));
  nor2   g092(.a(x29), .b(x28), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n119_), .c(new_n143_), .d(new_n118_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n96_), .c(x30), .O(new_n146_));
  ...
  nand2  g102(.a(new_n153_), .b(new_n59_), .O(z11));
  nand2  g103(.a(new_n150_), .b(x16), .O(new_n155_));
  nor2   g104(.a(x16), .b(x03), .O(new_n156_));
  nor2   g105(.a(new_n156_), .b(new_n60_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n155_), .O(z12));
  inv1   g107(.a(new_n60_), .O(new_n159_));
  nand2  g108(.a(x32), .b(x16), .O(new_n160_));
  inv1   g109(.a(x02), .O(new_n161_));
  nand2  g110(.a(new_n58_), .b(new_n161_), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n160_), .c(new_n159_), .O(z13));
  nand2  g112(.a(x33), .b(x16), .O(new_n164_));
  inv1   g113(.a(x01), .O(new_n165_));
  nand2  g114(.a(new_n58_), .b(new_n165_), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n164_), .c(new_n159_), .O(z14));
  nand2  g116(.a(x34), .b(x16), .O(new_n168_));
  inv1   g117(.a(x00), .O(new_n169_));
  nand2  g118(.a(new_n58_), .b(new_n169_), .O(new_n170_));
  nand3  g119(.a(new_n170_), .b(new_n168_), .c(new_n159_), .O(z15));
endmodule
