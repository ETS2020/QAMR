...
module FAU ( 
  ...
  aoi22  g17(.a(new_n68_), .b(new_n54_), .c(new_n65_), .d(x22), .O(new_n69_));
  oai21  g18(.a(new_n69_), .b(new_n67_), .c(new_n52_), .O(z03));
  nor3   g19(.a(x20), .b(x19), .c(x17), .O(new_n71_));
  nand2  g20(.a(new_n68_), .b(new_n54_), .O(new_n72_));
  nor3   g21(.a(x23), .b(x22), .c(x21), .O(new_n73_));
  aoi22  g22(.a(new_n73_), .b(new_n71_), .c(new_n72_), .d(x23), .O(new_n74_));
  oai21  g23(.a(new_n74_), .b(new_n67_), .c(new_n52_), .O(z04));
  inv1   g24(.a(x24), .O(new_n76_));
  aoi21  g25(.a(new_n73_), .b(new_n71_), .c(new_n76_), .O(new_n77_));
  nor2   g26(.a(x22), .b(x21), .O(new_n78_));
  nor2   g27(.a(x24), .b(x23), .O(new_n79_));
  nand3  g28(.a(new_n79_), .b(new_n78_), .c(new_n71_), .O(new_n80_));
  inv1   g29(.a(new_n80_), .O(new_n81_));
  oai21  g30(.a(new_n81_), .b(new_n77_), .c(x16), .O(new_n82_));
  ...
  nor2   g35(.a(new_n86_), .b(new_n65_), .O(new_n87_));
  aoi21  g36(.a(new_n80_), .b(x25), .c(new_n87_), .O(new_n88_));
  oai21  g37(.a(new_n88_), .b(new_n67_), .c(new_n52_), .O(z06));
  inv1   g38(.a(x26), .O(new_n90_));
  nor3   g39(.a(x26), .b(x25), .c(x24), .O(new_n91_));
  nand4  g40(.a(new_n91_), .b(new_n84_), .c(new_n64_), .d(new_n54_), .O(new_n92_));
  ...
  nand2  g44(.a(new_n92_), .b(x27), .O(new_n96_));
  nor3   g45(.a(x27), .b(x26), .c(x25), .O(new_n97_));
  nand4  g46(.a(new_n97_), .b(new_n79_), .c(new_n68_), .d(new_n54_), .O(new_n98_));
  nand4  g47(.a(new_n98_), .b(new_n96_), .c(new_n52_), .d(x16), .O(z08));
  nand2  g48(.a(new_n98_), .b(x28), .O(new_n100_));
  inv1   g49(.a(x23), .O(new_n101_));
  nor2   g50(.a(x28), .b(x27), .O(new_n102_));
  nand4  g51(.a(new_n102_), .b(new_n85_), .c(new_n90_), .d(new_n101_), .O(new_n103_));
  ...
  nand4  g56(.a(new_n107_), .b(new_n91_), .c(new_n73_), .d(new_n71_), .O(new_n108_));
  nand4  g57(.a(new_n108_), .b(new_n106_), .c(new_n52_), .d(x16), .O(z10));
  inv1   g58(.a(x21), .O(new_n110_));
  nand4  g59(.a(new_n84_), .b(new_n59_), .c(new_n110_), .d(new_n58_), .O(new_n111_));
  nor2   g60(.a(x26), .b(x25), .O(new_n112_));
  nor2   g61(.a(x30), .b(x29), .O(new_n113_));
  nand4  g62(.a(new_n113_), .b(new_n102_), .c(new_n112_), .d(new_n76_), .O(new_n114_));
  nor2   g63(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  aoi21  g64(.a(new_n108_), .b(x30), .c(new_n115_), .O(new_n116_));
  oai21  g65(.a(new_n116_), .b(new_n67_), .c(new_n52_), .O(z11));
  oai21  g66(.a(new_n114_), .b(new_n111_), .c(x31), .O(new_n118_));
  nor2   g67(.a(x29), .b(x28), .O(new_n119_));
  nor2   g68(.a(x31), .b(x30), .O(new_n120_));
  nand3  g69(.a(new_n120_), .b(new_n119_), .c(new_n97_), .O(new_n121_));
  or2    g70(.a(new_n121_), .b(new_n80_), .O(new_n122_));
  nand4  g71(.a(new_n122_), .b(new_n118_), .c(new_n52_), .d(x16), .O(z12));
  oai21  g72(.a(new_n121_), .b(new_n80_), .c(x32), .O(new_n124_));
  nor2   g73(.a(x32), .b(x31), .O(new_n125_));
  nand2  g74(.a(new_n125_), .b(new_n113_), .O(new_n126_));
  inv1   g75(.a(new_n126_), .O(new_n127_));
  nand4  g76(.a(new_n127_), .b(new_n102_), .c(new_n112_), .d(new_n81_), .O(new_n128_));
  nand4  g77(.a(new_n128_), .b(new_n124_), .c(new_n52_), .d(x16), .O(z13));
  nand3  g78(.a(new_n127_), .b(new_n102_), .c(new_n112_), .O(new_n130_));
  oai21  g79(.a(new_n130_), .b(new_n80_), .c(x33), .O(new_n131_));
  nor2   g80(.a(x27), .b(x26), .O(new_n132_));
  nand2  g81(.a(new_n119_), .b(new_n132_), .O(new_n133_));
  ...
  nand2  g85(.a(new_n136_), .b(new_n87_), .O(new_n137_));
  nand4  g86(.a(new_n137_), .b(new_n131_), .c(new_n52_), .d(x16), .O(z14));
  nand2  g87(.a(new_n137_), .b(x34), .O(new_n139_));
  inv1   g88(.a(new_n133_), .O(new_n140_));
  nor3   g89(.a(x34), .b(x33), .c(x32), .O(new_n141_));
  nand4  g90(.a(new_n141_), .b(new_n140_), .c(new_n120_), .d(new_n87_), .O(new_n142_));
