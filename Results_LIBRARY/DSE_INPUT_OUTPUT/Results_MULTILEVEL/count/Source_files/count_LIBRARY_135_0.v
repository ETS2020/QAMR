...
module FAU ( 
  ...
  oai21  g015(.a(new_n66_), .b(new_n65_), .c(x34), .O(new_n67_));
  ...
  nand2  g025(.a(x34), .b(new_n52_), .O(new_n77_));
  ...
  oai21  g068(.a(new_n119_), .b(new_n118_), .c(x34), .O(new_n120_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n104_), .c(new_n125_), .d(new_n55_), .O(new_n127_));
  aoi21  g076(.a(new_n127_), .b(new_n124_), .c(new_n61_), .O(new_n128_));
  nor2   g077(.a(x16), .b(x07), .O(new_n129_));
  oai21  g078(.a(new_n129_), .b(new_n128_), .c(x34), .O(new_n130_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n136_), .c(new_n125_), .d(new_n55_), .O(new_n138_));
  ...
  oai21  g099(.a(new_n150_), .b(new_n149_), .c(x34), .O(new_n151_));
  ...
  oai21  g131(.a(new_n182_), .b(new_n181_), .c(x34), .O(new_n183_));
  ...
  oai21  g146(.a(new_n197_), .b(new_n196_), .c(x34), .O(new_n198_));
  nand2  g147(.a(new_n198_), .b(new_n52_), .O(z14));
  nand2  g148(.a(new_n195_), .b(x16), .O(new_n200_));
