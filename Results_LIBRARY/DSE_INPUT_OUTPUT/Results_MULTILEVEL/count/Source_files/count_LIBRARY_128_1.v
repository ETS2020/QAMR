...
module FAU ( 
  ...
  nand3  g012(.a(new_n63_), .b(new_n61_), .c(new_n52_), .O(new_n64_));
  nand2  g013(.a(new_n64_), .b(x16), .O(new_n65_));
  oai21  g014(.a(new_n59_), .b(x14), .c(new_n65_), .O(z01));
  inv1   g015(.a(x21), .O(new_n67_));
  nor2   g016(.a(new_n62_), .b(new_n67_), .O(new_n68_));
  inv1   g017(.a(x17), .O(new_n69_));
  inv1   g018(.a(x19), .O(new_n70_));
  inv1   g019(.a(x20), .O(new_n71_));
  nand4  g020(.a(new_n67_), .b(new_n71_), .c(new_n70_), .d(new_n69_), .O(new_n72_));
  nand2  g021(.a(new_n72_), .b(new_n52_), .O(new_n73_));
  oai21  g022(.a(new_n73_), .b(new_n68_), .c(x16), .O(new_n74_));
  ...
  aoi21  g031(.a(new_n77_), .b(new_n54_), .c(new_n82_), .O(new_n83_));
  nor2   g032(.a(x20), .b(x19), .O(new_n84_));
  nor2   g033(.a(x23), .b(x22), .O(new_n85_));
  nand4  g034(.a(new_n85_), .b(new_n84_), .c(new_n67_), .d(new_n69_), .O(new_n86_));
  nand2  g035(.a(new_n86_), .b(new_n52_), .O(new_n87_));
  oai21  g036(.a(new_n87_), .b(new_n83_), .c(x16), .O(new_n88_));
  oai21  g037(.a(new_n59_), .b(x11), .c(new_n88_), .O(z04));
  nor2   g038(.a(x22), .b(x21), .O(new_n90_));
  nor2   g039(.a(x24), .b(x23), .O(new_n91_));
  nand4  g040(.a(new_n91_), .b(new_n90_), .c(new_n84_), .d(new_n69_), .O(new_n92_));
  nand2  g041(.a(new_n92_), .b(new_n52_), .O(new_n93_));
  aoi21  g042(.a(new_n86_), .b(x24), .c(new_n93_), .O(new_n94_));
  oai22  g043(.a(new_n94_), .b(new_n76_), .c(new_n59_), .d(x10), .O(z05));
  inv1   g044(.a(x22), .O(new_n96_));
  inv1   g045(.a(x24), .O(new_n97_));
  inv1   g046(.a(x25), .O(new_n98_));
  nand4  g047(.a(new_n98_), .b(new_n97_), .c(new_n82_), .d(new_n96_), .O(new_n99_));
  nor2   g048(.a(new_n99_), .b(new_n72_), .O(new_n100_));
  aoi21  g049(.a(new_n92_), .b(x25), .c(new_n100_), .O(new_n101_));
  inv1   g050(.a(x09), .O(new_n102_));
  aoi21  g051(.a(new_n76_), .b(new_n102_), .c(x18), .O(new_n103_));
  oai21  g052(.a(new_n101_), .b(new_n76_), .c(new_n103_), .O(z06));
  nor2   g053(.a(x21), .b(x20), .O(new_n105_));
  nor2   g054(.a(x25), .b(x24), .O(new_n106_));
  nand4  g055(.a(new_n106_), .b(new_n85_), .c(new_n105_), .d(new_n54_), .O(new_n107_));
  nor2   g056(.a(x26), .b(x25), .O(new_n108_));
  nand3  g057(.a(new_n108_), .b(new_n85_), .c(new_n97_), .O(new_n109_));
  nor2   g058(.a(new_n109_), .b(new_n72_), .O(new_n110_));
  aoi21  g059(.a(new_n107_), .b(x26), .c(new_n110_), .O(new_n111_));
  inv1   g060(.a(x08), .O(new_n112_));
  aoi21  g061(.a(new_n76_), .b(new_n112_), .c(x18), .O(new_n113_));
  oai21  g062(.a(new_n111_), .b(new_n76_), .c(new_n113_), .O(z07));
  oai21  g063(.a(new_n109_), .b(new_n72_), .c(x27), .O(new_n115_));
  nor3   g064(.a(x27), .b(x26), .c(x25), .O(new_n116_));
  nand4  g065(.a(new_n116_), .b(new_n91_), .c(new_n77_), .d(new_n54_), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n115_), .c(new_n52_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(x16), .O(new_n119_));
  oai21  g068(.a(new_n59_), .b(x07), .c(new_n119_), .O(z08));
  nand2  g069(.a(new_n117_), .b(x28), .O(new_n121_));
  nor3   g070(.a(x25), .b(x24), .c(x23), .O(new_n122_));
  nor3   g071(.a(x28), .b(x27), .c(x26), .O(new_n123_));
  nand4  g072(.a(new_n123_), .b(new_n122_), .c(new_n77_), .d(new_n54_), .O(new_n124_));
  nand2  g073(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(x16), .O(new_n126_));
  inv1   g075(.a(x06), .O(new_n127_));
  aoi21  g076(.a(new_n76_), .b(new_n127_), .c(x18), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n126_), .O(z09));
  inv1   g078(.a(x27), .O(new_n130_));
  nor2   g079(.a(x29), .b(x28), .O(new_n131_));
  nand4  g080(.a(new_n131_), .b(new_n108_), .c(new_n130_), .d(new_n97_), .O(new_n132_));
  ...
  aoi21  g084(.a(new_n76_), .b(new_n135_), .c(x18), .O(new_n136_));
  oai21  g085(.a(new_n134_), .b(new_n76_), .c(new_n136_), .O(z10));
  nor3   g086(.a(x23), .b(x22), .c(x21), .O(new_n138_));
  nor3   g087(.a(x26), .b(x25), .c(x24), .O(new_n139_));
  nor3   g088(.a(x29), .b(x28), .c(x27), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n62_), .O(new_n141_));
  nor2   g090(.a(x28), .b(x27), .O(new_n142_));
  nor2   g091(.a(x30), .b(x29), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n142_), .c(new_n108_), .d(new_n97_), .O(new_n144_));
  nor2   g093(.a(new_n144_), .b(new_n86_), .O(new_n145_));
  aoi21  g094(.a(new_n141_), .b(x30), .c(new_n145_), .O(new_n146_));
  inv1   g095(.a(x04), .O(new_n147_));
  aoi21  g096(.a(new_n76_), .b(new_n147_), .c(x18), .O(new_n148_));
  oai21  g097(.a(new_n146_), .b(new_n76_), .c(new_n148_), .O(z11));
  oai21  g098(.a(new_n144_), .b(new_n86_), .c(x31), .O(new_n150_));
  nand2  g099(.a(new_n91_), .b(new_n90_), .O(new_n151_));
  inv1   g100(.a(new_n151_), .O(new_n152_));
  nor2   g101(.a(x31), .b(x30), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(new_n131_), .O(new_n154_));
  inv1   g103(.a(new_n154_), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n116_), .c(new_n152_), .d(new_n62_), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n150_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(x16), .O(new_n158_));
  inv1   g107(.a(x03), .O(new_n159_));
  aoi21  g108(.a(new_n76_), .b(new_n159_), .c(x18), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n158_), .O(z12));
  nor2   g110(.a(x27), .b(x26), .O(new_n162_));
  nand4  g111(.a(new_n153_), .b(new_n131_), .c(new_n162_), .d(new_n98_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n92_), .c(x32), .O(new_n164_));
  nand2  g113(.a(new_n142_), .b(new_n108_), .O(new_n165_));
  inv1   g114(.a(new_n165_), .O(new_n166_));
  nor2   g115(.a(x32), .b(x31), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n143_), .O(new_n168_));
  inv1   g117(.a(new_n168_), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n166_), .c(new_n152_), .d(new_n62_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n164_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(x16), .O(new_n172_));
  inv1   g121(.a(x02), .O(new_n173_));
  aoi21  g122(.a(new_n76_), .b(new_n173_), .c(x18), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n172_), .O(z13));
  nand4  g124(.a(new_n167_), .b(new_n143_), .c(new_n142_), .d(new_n108_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n92_), .c(x33), .O(new_n177_));
  inv1   g126(.a(new_n72_), .O(new_n178_));
  inv1   g127(.a(new_n99_), .O(new_n179_));
  nand2  g128(.a(new_n131_), .b(new_n162_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nor2   g130(.a(x33), .b(x32), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n153_), .O(new_n183_));
  inv1   g132(.a(new_n183_), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n181_), .c(new_n179_), .d(new_n178_), .O(new_n185_));
  nand3  g134(.a(new_n185_), .b(new_n177_), .c(new_n52_), .O(new_n186_));
  ...
  nand4  g139(.a(new_n182_), .b(new_n153_), .c(new_n131_), .d(new_n162_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n107_), .c(x34), .O(new_n192_));
