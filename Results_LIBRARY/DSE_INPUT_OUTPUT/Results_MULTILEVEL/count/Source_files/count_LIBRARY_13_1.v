...
module FAU ( 
  ...
  nand3  g063(.a(new_n114_), .b(new_n112_), .c(new_n71_), .O(new_n115_));
  ...
  nand4  g073(.a(new_n124_), .b(new_n95_), .c(new_n123_), .d(new_n58_), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n122_), .c(new_n71_), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(x16), .O(new_n127_));
  oai21  g076(.a(new_n55_), .b(x07), .c(new_n127_), .O(z08));
  inv1   g077(.a(x26), .O(new_n129_));
  nor2   g078(.a(x28), .b(x27), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n110_), .c(new_n129_), .d(new_n91_), .O(new_n131_));
  ...
  oai21  g084(.a(new_n133_), .b(new_n66_), .c(new_n135_), .O(z09));
  oai21  g085(.a(new_n131_), .b(new_n80_), .c(x29), .O(new_n137_));
  nor3   g086(.a(x29), .b(x28), .c(x27), .O(new_n138_));
  nand3  g087(.a(new_n138_), .b(new_n113_), .c(new_n93_), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n137_), .c(new_n71_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(x16), .O(new_n141_));
  inv1   g090(.a(x05), .O(new_n142_));
  nand2  g091(.a(new_n54_), .b(new_n142_), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n141_), .O(z10));
  inv1   g093(.a(x27), .O(new_n145_));
  nor2   g094(.a(x29), .b(x28), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n120_), .c(new_n145_), .d(new_n90_), .O(new_n147_));
  ...
  nand3  g100(.a(new_n151_), .b(new_n113_), .c(new_n93_), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n148_), .c(new_n71_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(x16), .O(new_n154_));
  inv1   g103(.a(x04), .O(new_n155_));
  nand2  g104(.a(new_n54_), .b(new_n155_), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n154_), .O(z11));
  nor2   g106(.a(x27), .b(x26), .O(new_n158_));
  nor2   g107(.a(x31), .b(x30), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n146_), .c(new_n158_), .d(new_n102_), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n96_), .c(new_n71_), .O(new_n161_));
  aoi21  g110(.a(new_n152_), .b(x31), .c(new_n161_), .O(new_n162_));
  inv1   g111(.a(x03), .O(new_n163_));
  nand2  g112(.a(new_n54_), .b(new_n163_), .O(new_n164_));
  oai21  g113(.a(new_n162_), .b(new_n66_), .c(new_n164_), .O(z12));
  oai21  g114(.a(new_n160_), .b(new_n96_), .c(x32), .O(new_n166_));
  inv1   g115(.a(new_n96_), .O(new_n167_));
  nor2   g116(.a(x32), .b(x31), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n149_), .c(new_n130_), .d(new_n120_), .O(new_n169_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n159_), .c(new_n146_), .d(new_n158_), .O(new_n179_));
  ...
  nand2  g136(.a(new_n146_), .b(new_n158_), .O(new_n188_));
