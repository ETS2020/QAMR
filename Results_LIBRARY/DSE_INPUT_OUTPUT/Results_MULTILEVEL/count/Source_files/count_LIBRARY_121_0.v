...
module FAU ( 
  ...
  nand2  g12(.a(x26), .b(new_n52_), .O(new_n64_));
  nor2   g13(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g14(.a(new_n65_), .b(new_n62_), .O(z01));
  inv1   g15(.a(x21), .O(new_n67_));
  nand3  g16(.a(new_n59_), .b(new_n67_), .c(new_n58_), .O(new_n68_));
  oai21  g17(.a(new_n61_), .b(new_n67_), .c(new_n68_), .O(new_n69_));
  nor2   g18(.a(x16), .b(x13), .O(new_n70_));
  aoi21  g19(.a(new_n69_), .b(x16), .c(new_n70_), .O(new_n71_));
  oai21  g20(.a(new_n71_), .b(new_n53_), .c(new_n52_), .O(z02));
  inv1   g21(.a(x16), .O(new_n73_));
  nand2  g22(.a(new_n68_), .b(x22), .O(new_n74_));
  nor2   g23(.a(x22), .b(x21), .O(new_n75_));
  nand3  g24(.a(new_n75_), .b(new_n59_), .c(new_n58_), .O(new_n76_));
  and2   g25(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nor2   g26(.a(x16), .b(x12), .O(new_n78_));
  nor2   g27(.a(new_n78_), .b(new_n64_), .O(new_n79_));
  oai21  g28(.a(new_n77_), .b(new_n73_), .c(new_n79_), .O(z03));
  nand2  g29(.a(new_n76_), .b(x23), .O(new_n81_));
  nor3   g30(.a(x23), .b(x22), .c(x21), .O(new_n82_));
  nand2  g31(.a(new_n82_), .b(new_n61_), .O(new_n83_));
  aoi21  g32(.a(new_n83_), .b(new_n81_), .c(new_n73_), .O(new_n84_));
  nor2   g33(.a(x16), .b(x11), .O(new_n85_));
  oai21  g34(.a(new_n85_), .b(new_n84_), .c(x26), .O(new_n86_));
  nand2  g35(.a(new_n86_), .b(new_n52_), .O(z04));
  inv1   g36(.a(x24), .O(new_n88_));
  aoi21  g37(.a(new_n82_), .b(new_n61_), .c(new_n88_), .O(new_n89_));
  inv1   g38(.a(x23), .O(new_n90_));
  nand4  g39(.a(new_n75_), .b(new_n61_), .c(new_n88_), .d(new_n90_), .O(new_n91_));
  inv1   g40(.a(new_n91_), .O(new_n92_));
  oai21  g41(.a(new_n92_), .b(new_n89_), .c(x16), .O(new_n93_));
  nor2   g42(.a(x16), .b(x10), .O(new_n94_));
  nor2   g43(.a(new_n94_), .b(new_n64_), .O(new_n95_));
  nand2  g44(.a(new_n95_), .b(new_n93_), .O(z05));
  inv1   g45(.a(new_n68_), .O(new_n97_));
  inv1   g46(.a(x22), .O(new_n98_));
  inv1   g47(.a(x25), .O(new_n99_));
  nand4  g48(.a(new_n99_), .b(new_n88_), .c(new_n90_), .d(new_n98_), .O(new_n100_));
  inv1   g49(.a(new_n100_), .O(new_n101_));
  aoi22  g50(.a(new_n101_), .b(new_n97_), .c(new_n91_), .d(x25), .O(new_n102_));
  nor2   g51(.a(x16), .b(x09), .O(new_n103_));
  nor2   g52(.a(new_n103_), .b(new_n64_), .O(new_n104_));
  oai21  g53(.a(new_n102_), .b(new_n73_), .c(new_n104_), .O(z06));
  nand2  g54(.a(new_n101_), .b(new_n97_), .O(new_n106_));
  nor2   g55(.a(x16), .b(x08), .O(new_n107_));
  aoi21  g56(.a(new_n106_), .b(x16), .c(new_n107_), .O(new_n108_));
  oai21  g57(.a(new_n108_), .b(new_n53_), .c(new_n52_), .O(z07));
  ...
  inv1   g66(.a(new_n64_), .O(new_n118_));
  nand2  g67(.a(x29), .b(x16), .O(new_n119_));
  inv1   g68(.a(x05), .O(new_n120_));
  nand2  g69(.a(new_n73_), .b(new_n120_), .O(new_n121_));
  nand3  g70(.a(new_n121_), .b(new_n119_), .c(new_n118_), .O(z10));
  nand2  g71(.a(x30), .b(x16), .O(new_n123_));
  inv1   g72(.a(x04), .O(new_n124_));
  nand2  g73(.a(new_n73_), .b(new_n124_), .O(new_n125_));
  nand3  g74(.a(new_n125_), .b(new_n123_), .c(new_n118_), .O(z11));
  nor2   g75(.a(x16), .b(x03), .O(new_n127_));
  and2   g76(.a(x31), .b(x16), .O(new_n128_));
  oai21  g77(.a(new_n128_), .b(new_n127_), .c(x26), .O(new_n129_));
  nand2  g78(.a(new_n129_), .b(new_n52_), .O(z12));
  ...
  oai21  g85(.a(new_n136_), .b(new_n135_), .c(x26), .O(new_n137_));
  nand2  g86(.a(new_n137_), .b(new_n52_), .O(z14));
  nand2  g87(.a(x34), .b(x16), .O(new_n139_));
  inv1   g88(.a(x00), .O(new_n140_));
  nand2  g89(.a(new_n73_), .b(new_n140_), .O(new_n141_));
