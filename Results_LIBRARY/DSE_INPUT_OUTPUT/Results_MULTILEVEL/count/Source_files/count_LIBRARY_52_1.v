// Benchmark "FAU" written by ABC on Thu Aug 13 14:55:43 2020
...
module FAU ( 
  ...
  nand2  g017(.a(x18), .b(x11), .O(new_n69_));
  ...
  nand3  g029(.a(new_n80_), .b(new_n71_), .c(new_n64_), .O(new_n81_));
  ...
  oai21  g035(.a(new_n81_), .b(new_n62_), .c(x23), .O(new_n87_));
  ...
  nand2  g042(.a(new_n93_), .b(new_n69_), .O(z04));
  inv1   g043(.a(x24), .O(new_n95_));
  inv1   g044(.a(x23), .O(new_n96_));
  nand3  g045(.a(new_n96_), .b(new_n80_), .c(new_n71_), .O(new_n97_));
  nor2   g046(.a(new_n97_), .b(new_n65_), .O(new_n98_));
  nor2   g047(.a(new_n98_), .b(new_n95_), .O(new_n99_));
  nand3  g048(.a(new_n88_), .b(new_n61_), .c(new_n52_), .O(new_n100_));
  nand4  g049(.a(new_n95_), .b(new_n96_), .c(new_n80_), .d(new_n71_), .O(new_n101_));
  ...
  oai21  g055(.a(new_n101_), .b(new_n65_), .c(x25), .O(new_n107_));
  nor2   g056(.a(x25), .b(x24), .O(new_n108_));
  nand4  g057(.a(new_n108_), .b(new_n89_), .c(new_n73_), .d(new_n55_), .O(new_n109_));
  ...
  nand2  g061(.a(new_n112_), .b(new_n69_), .O(z06));
  nand2  g062(.a(new_n109_), .b(x26), .O(new_n114_));
  nor3   g063(.a(x26), .b(x25), .c(x24), .O(new_n115_));
  nand4  g064(.a(new_n115_), .b(new_n89_), .c(new_n73_), .d(new_n55_), .O(new_n116_));
  ...
  nand2  g068(.a(new_n119_), .b(new_n69_), .O(z07));
  nor2   g069(.a(x26), .b(x25), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n89_), .c(new_n95_), .O(new_n122_));
  oai21  g071(.a(new_n122_), .b(new_n74_), .c(x27), .O(new_n123_));
  nor2   g072(.a(new_n81_), .b(new_n62_), .O(new_n124_));
  ...
  nand2  g079(.a(new_n130_), .b(new_n69_), .O(z08));
  nand2  g080(.a(new_n127_), .b(x28), .O(new_n132_));
  nor3   g081(.a(x28), .b(x27), .c(x26), .O(new_n133_));
  nand4  g082(.a(new_n133_), .b(new_n108_), .c(new_n124_), .d(new_n96_), .O(new_n134_));
  ...
  nand4  g090(.a(new_n141_), .b(new_n121_), .c(new_n140_), .d(new_n95_), .O(new_n142_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n149_), .c(new_n121_), .d(new_n95_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n90_), .c(x31), .O(new_n159_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n126_), .c(new_n160_), .d(new_n72_), .O(new_n167_));
  ...
  nand2  g119(.a(new_n170_), .b(new_n69_), .O(z12));
  nand2  g120(.a(new_n167_), .b(x32), .O(new_n172_));
  nand2  g121(.a(new_n149_), .b(new_n121_), .O(new_n173_));
  ...
  nand3  g125(.a(new_n176_), .b(new_n160_), .c(new_n72_), .O(new_n177_));
  ...
  nor2   g135(.a(new_n186_), .b(new_n109_), .O(new_n187_));
  ...
  oai22  g145(.a(new_n196_), .b(new_n109_), .c(new_n187_), .d(new_n192_), .O(new_n197_));
