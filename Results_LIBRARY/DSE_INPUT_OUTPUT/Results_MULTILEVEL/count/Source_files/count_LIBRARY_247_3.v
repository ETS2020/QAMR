...
module FAU ( 
  ...
  nand3  g037(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  aoi21  g038(.a(new_n89_), .b(new_n85_), .c(new_n62_), .O(new_n90_));
  nor2   g039(.a(x16), .b(x11), .O(new_n91_));
  oai21  g040(.a(new_n91_), .b(new_n90_), .c(new_n58_), .O(new_n92_));
  nand2  g041(.a(new_n92_), .b(new_n60_), .O(z04));
  nand2  g042(.a(new_n89_), .b(x24), .O(new_n94_));
  nor2   g043(.a(x22), .b(x21), .O(new_n95_));
  nor2   g044(.a(x24), .b(x23), .O(new_n96_));
  nand3  g045(.a(new_n96_), .b(new_n95_), .c(new_n87_), .O(new_n97_));
  aoi21  g046(.a(new_n97_), .b(new_n94_), .c(new_n62_), .O(new_n98_));
  nor2   g047(.a(x16), .b(x10), .O(new_n99_));
  oai21  g048(.a(new_n99_), .b(new_n98_), .c(new_n58_), .O(new_n100_));
  nand2  g049(.a(new_n100_), .b(new_n60_), .O(z05));
  ...
  nand4  g056(.a(new_n107_), .b(new_n66_), .c(new_n65_), .d(new_n64_), .O(new_n108_));
  nand3  g057(.a(new_n97_), .b(x25), .c(new_n58_), .O(new_n109_));
  ...
  nand4  g065(.a(new_n116_), .b(new_n88_), .c(new_n72_), .d(new_n53_), .O(new_n117_));
  inv1   g066(.a(new_n117_), .O(new_n118_));
  nor3   g067(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand3  g068(.a(new_n119_), .b(new_n88_), .c(new_n74_), .O(new_n120_));
  ...
  nand4  g074(.a(new_n72_), .b(new_n65_), .c(new_n64_), .d(x16), .O(new_n126_));
  nor2   g075(.a(x27), .b(x25), .O(new_n127_));
  nand3  g076(.a(new_n127_), .b(new_n88_), .c(new_n104_), .O(new_n128_));
  oai21  g077(.a(new_n128_), .b(new_n126_), .c(new_n58_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n115_), .O(new_n130_));
  nand3  g079(.a(new_n120_), .b(x27), .c(x16), .O(new_n131_));
  inv1   g080(.a(x07), .O(new_n132_));
  nand2  g081(.a(new_n62_), .b(new_n132_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n58_), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n130_), .O(z08));
  nor3   g085(.a(x27), .b(x26), .c(x25), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n96_), .O(new_n138_));
  oai21  g087(.a(new_n138_), .b(new_n84_), .c(x28), .O(new_n139_));
  nor3   g088(.a(x25), .b(x24), .c(x23), .O(new_n140_));
  nor3   g089(.a(x28), .b(x27), .c(x26), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n140_), .c(new_n79_), .d(new_n53_), .O(new_n142_));
  ...
  nand3  g096(.a(new_n79_), .b(new_n53_), .c(x16), .O(new_n148_));
  nor3   g097(.a(x29), .b(x28), .c(x27), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(new_n140_), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n148_), .c(new_n58_), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n115_), .O(new_n152_));
  nand3  g101(.a(new_n142_), .b(x29), .c(x16), .O(new_n153_));
  oai21  g102(.a(x16), .b(x05), .c(new_n153_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n58_), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(new_n152_), .O(z10));
  inv1   g105(.a(new_n89_), .O(new_n157_));
  nand3  g106(.a(new_n149_), .b(new_n119_), .c(new_n157_), .O(new_n158_));
  nor2   g107(.a(x28), .b(x27), .O(new_n159_));
  nor2   g108(.a(x30), .b(x29), .O(new_n160_));
  nand3  g109(.a(new_n160_), .b(new_n159_), .c(new_n119_), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(new_n89_), .O(new_n162_));
  aoi21  g111(.a(new_n158_), .b(x30), .c(new_n162_), .O(new_n163_));
  inv1   g112(.a(x04), .O(new_n164_));
  aoi21  g113(.a(new_n62_), .b(new_n164_), .c(x18), .O(new_n165_));
  oai21  g114(.a(new_n163_), .b(new_n62_), .c(new_n165_), .O(z11));
  oai21  g115(.a(new_n161_), .b(new_n89_), .c(x31), .O(new_n167_));
  nor2   g116(.a(x29), .b(x28), .O(new_n168_));
  nor2   g117(.a(x31), .b(x30), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n168_), .c(new_n137_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n97_), .c(new_n167_), .O(new_n171_));
  ...
  oai21  g124(.a(new_n170_), .b(new_n97_), .c(x32), .O(new_n176_));
  nor2   g125(.a(x26), .b(x25), .O(new_n177_));
  nor2   g126(.a(x32), .b(x31), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n160_), .c(new_n159_), .d(new_n177_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n97_), .c(new_n176_), .O(new_n180_));
  ...
  oai21  g133(.a(new_n179_), .b(new_n97_), .c(x33), .O(new_n185_));
  nor2   g134(.a(x27), .b(x26), .O(new_n186_));
  nand2  g135(.a(new_n168_), .b(new_n186_), .O(new_n187_));
  ...
  nand4  g148(.a(new_n199_), .b(new_n198_), .c(new_n169_), .d(new_n118_), .O(new_n200_));
