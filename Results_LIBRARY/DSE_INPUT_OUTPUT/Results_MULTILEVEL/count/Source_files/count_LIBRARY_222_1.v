...
module FAU ( 
  ...
  nand2  g022(.a(x18), .b(x03), .O(new_n74_));
  ...
  oai21  g048(.a(new_n99_), .b(new_n98_), .c(new_n76_), .O(new_n100_));
  nand2  g049(.a(new_n100_), .b(new_n74_), .O(z05));
  ...
  nand4  g063(.a(new_n114_), .b(new_n93_), .c(new_n110_), .d(new_n55_), .O(new_n115_));
  aoi21  g064(.a(new_n115_), .b(new_n113_), .c(new_n58_), .O(new_n116_));
  nor2   g065(.a(x16), .b(x08), .O(new_n117_));
  oai21  g066(.a(new_n117_), .b(new_n116_), .c(new_n76_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(new_n74_), .O(z07));
  ...
  nand2  g075(.a(new_n126_), .b(new_n74_), .O(z08));
  inv1   g076(.a(x26), .O(new_n128_));
  nor2   g077(.a(x28), .b(x27), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n111_), .c(new_n128_), .d(new_n85_), .O(new_n130_));
  ...
  nand4  g087(.a(new_n138_), .b(new_n114_), .c(new_n87_), .d(new_n137_), .O(new_n139_));
  ...
  nand2  g091(.a(new_n142_), .b(new_n74_), .O(z10));
  nor2   g092(.a(x26), .b(x25), .O(new_n144_));
  nand4  g093(.a(new_n138_), .b(new_n144_), .c(new_n137_), .d(new_n102_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n94_), .c(x30), .O(new_n146_));
  nor2   g095(.a(x30), .b(x29), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n129_), .c(new_n114_), .d(new_n87_), .O(new_n148_));
  ...
  oai21  g110(.a(new_n155_), .b(new_n97_), .c(x32), .O(new_n162_));
  nor2   g111(.a(x32), .b(x31), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n147_), .c(new_n129_), .d(new_n144_), .O(new_n164_));
  ...
  nand2  g123(.a(new_n174_), .b(new_n105_), .O(new_n175_));
  aoi21  g124(.a(new_n175_), .b(new_n170_), .c(new_n58_), .O(new_n176_));
  nor2   g125(.a(x16), .b(x01), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n176_), .c(new_n76_), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(new_n74_), .O(z14));
  oai21  g128(.a(new_n173_), .b(new_n112_), .c(x34), .O(new_n180_));
  ...
  nand3  g139(.a(new_n190_), .b(new_n182_), .c(new_n105_), .O(new_n191_));
  ...
  nand2  g143(.a(new_n194_), .b(new_n74_), .O(z15));
endmodule
