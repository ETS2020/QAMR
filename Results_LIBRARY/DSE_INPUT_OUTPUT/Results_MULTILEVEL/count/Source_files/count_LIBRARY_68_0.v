...
module FAU ( 
  ...
  aoi22  g033(.a(new_n84_), .b(new_n61_), .c(new_n78_), .d(x24), .O(new_n85_));
  oai21  g034(.a(new_n85_), .b(new_n57_), .c(new_n52_), .O(z05));
  nand4  g035(.a(new_n82_), .b(new_n75_), .c(new_n59_), .d(new_n58_), .O(new_n87_));
  ...
  oai21  g043(.a(new_n94_), .b(new_n57_), .c(new_n52_), .O(z06));
  nor2   g044(.a(x21), .b(x20), .O(new_n96_));
  nor2   g045(.a(x25), .b(x24), .O(new_n97_));
  nand4  g046(.a(new_n97_), .b(new_n77_), .c(new_n96_), .d(new_n53_), .O(new_n98_));
  nand2  g047(.a(new_n98_), .b(x26), .O(new_n99_));
  nor3   g048(.a(x26), .b(x25), .c(x24), .O(new_n100_));
  nand3  g049(.a(new_n100_), .b(new_n77_), .c(new_n68_), .O(new_n101_));
  ...
  oai21  g071(.a(new_n120_), .b(new_n78_), .c(x30), .O(new_n123_));
  ...
  or2    g076(.a(new_n127_), .b(new_n78_), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n123_), .c(new_n52_), .d(x16), .O(z11));
  oai21  g078(.a(new_n127_), .b(new_n78_), .c(x31), .O(new_n130_));
  ...
  nand4  g083(.a(new_n134_), .b(new_n131_), .c(new_n84_), .d(new_n61_), .O(new_n135_));
  ...
  nand4  g089(.a(new_n140_), .b(new_n126_), .c(new_n125_), .d(new_n124_), .O(new_n141_));
  or2    g090(.a(new_n141_), .b(new_n87_), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n139_), .c(new_n52_), .d(x16), .O(z13));
  oai21  g092(.a(new_n141_), .b(new_n87_), .c(x33), .O(new_n144_));
  nor2   g093(.a(x33), .b(x32), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n132_), .c(new_n119_), .d(new_n105_), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(new_n93_), .O(new_n148_));
  ...
  oai21  g100(.a(new_n146_), .b(new_n98_), .c(x34), .O(new_n152_));
  nand2  g101(.a(new_n119_), .b(new_n105_), .O(new_n153_));
  ...
  nand3  g111(.a(new_n162_), .b(new_n154_), .c(new_n93_), .O(new_n163_));
