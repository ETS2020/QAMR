...
module FAU ( 
  ...
  nand2  g021(.a(x23), .b(x18), .O(new_n73_));
  oai21  g022(.a(new_n72_), .b(x18), .c(new_n73_), .O(z02));
  nor3   g023(.a(x19), .b(x18), .c(x17), .O(new_n75_));
  nor3   g024(.a(x22), .b(x21), .c(x20), .O(new_n76_));
  aoi22  g025(.a(new_n76_), .b(new_n75_), .c(new_n69_), .d(x22), .O(new_n77_));
  ...
  nand4  g032(.a(new_n83_), .b(new_n68_), .c(new_n55_), .d(x16), .O(new_n84_));
  ...
  nand3  g037(.a(new_n88_), .b(new_n55_), .c(new_n87_), .O(new_n89_));
  aoi21  g038(.a(new_n89_), .b(x16), .c(x18), .O(new_n90_));
  oai21  g039(.a(new_n90_), .b(new_n81_), .c(new_n86_), .O(z04));
  inv1   g040(.a(x24), .O(new_n92_));
  oai21  g041(.a(new_n92_), .b(new_n58_), .c(new_n82_), .O(new_n93_));
  nand2  g042(.a(new_n93_), .b(x23), .O(new_n94_));
  nand2  g043(.a(new_n89_), .b(x24), .O(new_n95_));
  inv1   g044(.a(x22), .O(new_n96_));
  nand4  g045(.a(new_n92_), .b(new_n81_), .c(new_n96_), .d(new_n67_), .O(new_n97_));
  inv1   g046(.a(new_n97_), .O(new_n98_));
  nand2  g047(.a(new_n98_), .b(new_n62_), .O(new_n99_));
  aoi21  g048(.a(new_n99_), .b(new_n95_), .c(new_n58_), .O(new_n100_));
  nor2   g049(.a(x16), .b(x10), .O(new_n101_));
  oai21  g050(.a(new_n101_), .b(new_n100_), .c(new_n82_), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(new_n94_), .O(z05));
  nor2   g052(.a(x25), .b(x24), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n83_), .c(new_n68_), .d(new_n55_), .O(new_n105_));
  ...
  oai21  g060(.a(new_n111_), .b(new_n58_), .c(new_n82_), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(x23), .O(new_n113_));
  nand3  g062(.a(new_n104_), .b(new_n88_), .c(new_n62_), .O(new_n114_));
  nand2  g063(.a(new_n114_), .b(x26), .O(new_n115_));
  nor3   g064(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nand4  g065(.a(new_n116_), .b(new_n83_), .c(new_n68_), .d(new_n55_), .O(new_n117_));
  aoi21  g066(.a(new_n117_), .b(new_n115_), .c(new_n58_), .O(new_n118_));
  nor2   g067(.a(x16), .b(x08), .O(new_n119_));
  oai21  g068(.a(new_n119_), .b(new_n118_), .c(new_n82_), .O(new_n120_));
  nand2  g069(.a(new_n120_), .b(new_n113_), .O(z07));
  inv1   g070(.a(x25), .O(new_n122_));
  nor2   g071(.a(x27), .b(x26), .O(new_n123_));
  nand4  g072(.a(new_n123_), .b(new_n122_), .c(new_n92_), .d(new_n81_), .O(new_n124_));
  nor2   g073(.a(new_n124_), .b(new_n89_), .O(new_n125_));
  ...
  nand4  g080(.a(new_n131_), .b(new_n104_), .c(new_n111_), .d(new_n81_), .O(new_n132_));
  oai22  g081(.a(new_n132_), .b(new_n89_), .c(new_n125_), .d(new_n130_), .O(new_n133_));
  ...
  oai21  g087(.a(new_n138_), .b(new_n58_), .c(new_n82_), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(x23), .O(new_n140_));
  nand3  g089(.a(new_n131_), .b(new_n104_), .c(new_n111_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n89_), .c(x29), .O(new_n142_));
  nor3   g091(.a(x23), .b(x22), .c(x21), .O(new_n143_));
  nor3   g092(.a(x29), .b(x28), .c(x27), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n143_), .c(new_n116_), .d(new_n62_), .O(new_n145_));
  aoi21  g094(.a(new_n145_), .b(new_n142_), .c(new_n58_), .O(new_n146_));
  nor2   g095(.a(x16), .b(x05), .O(new_n147_));
  oai21  g096(.a(new_n147_), .b(new_n146_), .c(new_n82_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n140_), .O(z10));
  nand2  g098(.a(new_n143_), .b(new_n62_), .O(new_n150_));
  nor2   g099(.a(x30), .b(x29), .O(new_n151_));
  nand3  g100(.a(new_n151_), .b(new_n131_), .c(new_n116_), .O(new_n152_));
  nor2   g101(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  aoi21  g102(.a(new_n145_), .b(x30), .c(new_n153_), .O(new_n154_));
  ...
  oai21  g106(.a(new_n152_), .b(new_n150_), .c(x31), .O(new_n158_));
  nor2   g107(.a(x29), .b(x28), .O(new_n159_));
  nor2   g108(.a(x31), .b(x30), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n159_), .c(new_n123_), .d(new_n122_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n99_), .c(new_n158_), .O(new_n162_));
  ...
  oai21  g116(.a(new_n167_), .b(new_n58_), .c(new_n82_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(x23), .O(new_n169_));
  nor2   g118(.a(x20), .b(x19), .O(new_n170_));
  nor2   g119(.a(x24), .b(x22), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n170_), .c(new_n67_), .d(new_n52_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n161_), .c(x32), .O(new_n173_));
  inv1   g122(.a(x27), .O(new_n174_));
  nand4  g123(.a(new_n130_), .b(new_n174_), .c(new_n111_), .d(new_n122_), .O(new_n175_));
  inv1   g124(.a(new_n175_), .O(new_n176_));
  inv1   g125(.a(x30), .O(new_n177_));
  inv1   g126(.a(x31), .O(new_n178_));
  nand4  g127(.a(new_n167_), .b(new_n178_), .c(new_n177_), .d(new_n138_), .O(new_n179_));
  inv1   g128(.a(new_n179_), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n176_), .c(new_n98_), .d(new_n62_), .O(new_n181_));
  aoi21  g130(.a(new_n181_), .b(new_n173_), .c(new_n58_), .O(new_n182_));
  nor2   g131(.a(x16), .b(x02), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n182_), .c(new_n82_), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n169_), .O(z13));
  nand2  g134(.a(new_n181_), .b(x33), .O(new_n186_));
  nor2   g135(.a(x33), .b(x32), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n160_), .c(new_n159_), .d(new_n123_), .O(new_n188_));
  or2    g137(.a(new_n188_), .b(new_n105_), .O(new_n189_));
  ...
  oai21  g143(.a(new_n188_), .b(new_n105_), .c(x34), .O(new_n195_));
  nand2  g144(.a(new_n159_), .b(new_n123_), .O(new_n196_));
  inv1   g145(.a(new_n196_), .O(new_n197_));
  nor3   g146(.a(x34), .b(x33), .c(x32), .O(new_n198_));
  nand3  g147(.a(new_n198_), .b(new_n197_), .c(new_n160_), .O(new_n199_));
  oai21  g148(.a(new_n199_), .b(new_n105_), .c(new_n195_), .O(new_n200_));
