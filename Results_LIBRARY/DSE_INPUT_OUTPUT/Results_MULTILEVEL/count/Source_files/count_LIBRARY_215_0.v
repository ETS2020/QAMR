...
module FAU ( 
  ...
  oai21  g017(.a(new_n68_), .b(new_n67_), .c(x01), .O(new_n69_));
  ...
  oai21  g026(.a(new_n77_), .b(new_n52_), .c(new_n53_), .O(z02));
  ...
  nor3   g030(.a(new_n81_), .b(x18), .c(new_n52_), .O(new_n82_));
  ...
  oai21  g040(.a(new_n91_), .b(new_n90_), .c(x01), .O(new_n92_));
  nand2  g041(.a(new_n92_), .b(new_n53_), .O(z04));
  nand2  g042(.a(new_n89_), .b(x24), .O(new_n94_));
  nor2   g043(.a(x24), .b(x23), .O(new_n95_));
  nand3  g044(.a(new_n95_), .b(new_n84_), .c(new_n72_), .O(new_n96_));
  aoi21  g045(.a(new_n96_), .b(new_n94_), .c(new_n61_), .O(new_n97_));
  nor2   g046(.a(x16), .b(x10), .O(new_n98_));
  oai21  g047(.a(new_n98_), .b(new_n97_), .c(x01), .O(new_n99_));
  nand2  g048(.a(new_n99_), .b(new_n53_), .O(z05));
  nand2  g049(.a(new_n96_), .b(x25), .O(new_n101_));
  nor2   g050(.a(x25), .b(x24), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n88_), .c(new_n73_), .d(new_n55_), .O(new_n103_));
  aoi21  g052(.a(new_n103_), .b(new_n101_), .c(new_n61_), .O(new_n104_));
  ...
  oai21  g060(.a(new_n111_), .b(new_n74_), .c(new_n108_), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(x16), .O(new_n113_));
  inv1   g062(.a(x08), .O(new_n114_));
  aoi21  g063(.a(new_n61_), .b(new_n114_), .c(x18), .O(new_n115_));
  nand3  g064(.a(new_n115_), .b(new_n113_), .c(x01), .O(z07));
  oai21  g065(.a(new_n111_), .b(new_n74_), .c(x27), .O(new_n117_));
  nor3   g066(.a(x27), .b(x26), .c(x25), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n95_), .c(new_n79_), .d(new_n55_), .O(new_n119_));
  aoi21  g068(.a(new_n119_), .b(new_n117_), .c(new_n61_), .O(new_n120_));
  nor2   g069(.a(x16), .b(x07), .O(new_n121_));
  oai21  g070(.a(new_n121_), .b(new_n120_), .c(x01), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n53_), .O(z08));
  ...
  nand4  g078(.a(new_n129_), .b(new_n128_), .c(new_n79_), .d(new_n55_), .O(new_n130_));
  aoi21  g079(.a(new_n130_), .b(new_n127_), .c(new_n61_), .O(new_n131_));
  nor2   g080(.a(x16), .b(x06), .O(new_n132_));
  oai21  g081(.a(new_n132_), .b(new_n131_), .c(x01), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n53_), .O(z09));
  inv1   g083(.a(x27), .O(new_n135_));
  nor2   g084(.a(x29), .b(x28), .O(new_n136_));
  nand4  g085(.a(new_n136_), .b(new_n110_), .c(new_n135_), .d(new_n109_), .O(new_n137_));
  ...
  nor3   g089(.a(new_n140_), .b(x18), .c(new_n52_), .O(new_n141_));
  oai21  g090(.a(new_n139_), .b(new_n61_), .c(new_n141_), .O(z10));
  oai21  g091(.a(new_n137_), .b(new_n89_), .c(x30), .O(new_n143_));
  inv1   g092(.a(x22), .O(new_n144_));
  inv1   g093(.a(x23), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n144_), .c(new_n71_), .O(new_n146_));
  ...
  nand3  g101(.a(new_n152_), .b(new_n148_), .c(new_n147_), .O(new_n153_));
  aoi21  g102(.a(new_n153_), .b(new_n143_), .c(new_n61_), .O(new_n154_));
  nor2   g103(.a(x16), .b(x04), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n154_), .c(x01), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n53_), .O(z11));
  nand2  g106(.a(new_n153_), .b(x31), .O(new_n158_));
  nand2  g107(.a(new_n95_), .b(new_n84_), .O(new_n159_));
  nor2   g108(.a(new_n159_), .b(new_n66_), .O(new_n160_));
  nor2   g109(.a(x31), .b(x30), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n136_), .c(new_n118_), .d(new_n160_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n158_), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(x16), .O(new_n164_));
  nor2   g113(.a(x16), .b(x03), .O(new_n165_));
  nor3   g114(.a(new_n165_), .b(x18), .c(new_n52_), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(new_n164_), .O(z12));
  nand3  g116(.a(new_n161_), .b(new_n136_), .c(new_n118_), .O(new_n168_));
  ...
  nand4  g121(.a(new_n172_), .b(new_n149_), .c(new_n110_), .d(new_n160_), .O(new_n173_));
  ...
  nand3  g126(.a(new_n177_), .b(new_n175_), .c(x01), .O(z13));
  nand4  g127(.a(new_n170_), .b(new_n150_), .c(new_n149_), .d(new_n110_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n96_), .c(x33), .O(new_n180_));
  nor2   g129(.a(x33), .b(x32), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n161_), .c(new_n136_), .d(new_n125_), .O(new_n182_));
  or2    g131(.a(new_n182_), .b(new_n103_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(new_n180_), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(x16), .c(x01), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(new_n53_), .O(z14));
  oai21  g135(.a(new_n182_), .b(new_n103_), .c(x34), .O(new_n187_));
  nand2  g136(.a(new_n136_), .b(new_n125_), .O(new_n188_));
  inv1   g137(.a(new_n188_), .O(new_n189_));
  nor3   g138(.a(x34), .b(x33), .c(x32), .O(new_n190_));
  nand3  g139(.a(new_n190_), .b(new_n189_), .c(new_n161_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n103_), .c(new_n187_), .O(new_n192_));
  nand2  g141(.a(new_n192_), .b(x16), .O(new_n193_));
  inv1   g142(.a(x00), .O(new_n194_));
  aoi21  g143(.a(new_n61_), .b(new_n194_), .c(x18), .O(new_n195_));
  nand3  g144(.a(new_n195_), .b(new_n193_), .c(x01), .O(z15));
endmodule
