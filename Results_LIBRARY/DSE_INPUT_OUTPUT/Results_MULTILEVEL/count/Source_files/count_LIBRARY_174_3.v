...
module FAU ( 
  ...
  oai21  g017(.a(x18), .b(new_n62_), .c(new_n58_), .O(new_n69_));
  ...
  nand3  g022(.a(new_n73_), .b(new_n61_), .c(x16), .O(new_n74_));
  nand2  g023(.a(new_n74_), .b(new_n69_), .O(z02));
  nand2  g024(.a(new_n72_), .b(x22), .O(new_n76_));
  ...
  nand4  g036(.a(new_n87_), .b(new_n86_), .c(new_n70_), .d(new_n85_), .O(new_n88_));
  ...
  nand4  g043(.a(new_n94_), .b(new_n78_), .c(new_n86_), .d(new_n85_), .O(new_n95_));
  ...
  oai21  g054(.a(new_n103_), .b(new_n62_), .c(new_n105_), .O(z06));
  ...
  nand4  g068(.a(new_n119_), .b(new_n94_), .c(new_n118_), .d(new_n53_), .O(new_n120_));
  aoi21  g069(.a(new_n120_), .b(new_n117_), .c(new_n62_), .O(new_n121_));
  ...
  oai21  g076(.a(new_n127_), .b(new_n79_), .c(x28), .O(new_n128_));
  nor3   g077(.a(x25), .b(x24), .c(x23), .O(new_n129_));
  nor3   g078(.a(x28), .b(x27), .c(x26), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n129_), .c(new_n118_), .d(new_n53_), .O(new_n131_));
  aoi21  g080(.a(new_n131_), .b(new_n128_), .c(new_n62_), .O(new_n132_));
  nor2   g081(.a(x16), .b(x06), .O(new_n133_));
  oai21  g082(.a(new_n133_), .b(new_n132_), .c(new_n61_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n59_), .O(z09));
  ...
  nand4  g091(.a(new_n142_), .b(new_n108_), .c(new_n141_), .d(new_n63_), .O(new_n143_));
  ...
  nand2  g095(.a(new_n146_), .b(new_n59_), .O(z10));
  ...
  aoi21  g101(.a(new_n62_), .b(new_n152_), .c(x18), .O(new_n153_));
  oai21  g102(.a(new_n151_), .b(new_n62_), .c(new_n153_), .O(z11));
  oai21  g103(.a(new_n149_), .b(new_n88_), .c(x31), .O(new_n155_));
  inv1   g104(.a(x22), .O(new_n156_));
  nand4  g105(.a(new_n114_), .b(new_n136_), .c(new_n156_), .d(new_n70_), .O(new_n157_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n119_), .c(new_n158_), .d(new_n63_), .O(new_n165_));
  aoi21  g114(.a(new_n165_), .b(new_n155_), .c(new_n62_), .O(new_n166_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n176_), .c(new_n158_), .d(new_n63_), .O(new_n180_));
  aoi21  g129(.a(new_n180_), .b(new_n173_), .c(new_n62_), .O(new_n181_));
  nor2   g130(.a(x16), .b(x02), .O(new_n182_));
  oai21  g131(.a(new_n182_), .b(new_n181_), .c(new_n61_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(new_n59_), .O(z13));
