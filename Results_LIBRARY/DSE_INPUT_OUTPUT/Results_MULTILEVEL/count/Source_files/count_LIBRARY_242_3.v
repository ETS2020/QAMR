...
module FAU ( 
  ...
  nand4  g021(.a(new_n70_), .b(new_n58_), .c(new_n72_), .d(new_n60_), .O(new_n73_));
  ...
  oai21  g025(.a(new_n76_), .b(x18), .c(new_n56_), .O(z02));
  ...
  aoi21  g030(.a(new_n67_), .b(new_n81_), .c(x18), .O(new_n82_));
  ...
  nand3  g034(.a(new_n58_), .b(new_n72_), .c(new_n60_), .O(new_n86_));
  ...
  aoi21  g041(.a(new_n67_), .b(new_n92_), .c(x18), .O(new_n93_));
  oai21  g042(.a(new_n91_), .b(new_n67_), .c(new_n93_), .O(z04));
  inv1   g043(.a(x24), .O(new_n95_));
  nor2   g044(.a(x24), .b(x23), .O(new_n96_));
  nand3  g045(.a(new_n96_), .b(new_n84_), .c(new_n71_), .O(new_n97_));
  oai21  g046(.a(new_n90_), .b(new_n95_), .c(new_n97_), .O(new_n98_));
  ...
  nand4  g055(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n59_), .O(new_n107_));
  aoi21  g056(.a(new_n107_), .b(new_n103_), .c(new_n67_), .O(new_n108_));
  nor2   g057(.a(x16), .b(x09), .O(new_n109_));
  oai21  g058(.a(new_n109_), .b(new_n108_), .c(new_n61_), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(new_n56_), .O(z06));
  nand2  g060(.a(new_n107_), .b(x26), .O(new_n112_));
  nor3   g061(.a(x26), .b(x25), .c(x24), .O(new_n113_));
  nand4  g062(.a(new_n113_), .b(new_n105_), .c(new_n104_), .d(new_n59_), .O(new_n114_));
  aoi21  g063(.a(new_n114_), .b(new_n112_), .c(new_n67_), .O(new_n115_));
  nor2   g064(.a(x16), .b(x08), .O(new_n116_));
  oai21  g065(.a(new_n116_), .b(new_n115_), .c(new_n61_), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n56_), .O(z07));
  inv1   g067(.a(x25), .O(new_n119_));
  nor2   g068(.a(x27), .b(x26), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n96_), .c(new_n119_), .O(new_n121_));
  ...
  aoi21  g073(.a(new_n67_), .b(new_n124_), .c(x18), .O(new_n125_));
  oai21  g074(.a(new_n123_), .b(new_n67_), .c(new_n125_), .O(z08));
  oai21  g075(.a(new_n121_), .b(new_n85_), .c(x28), .O(new_n127_));
  nor3   g076(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nor3   g077(.a(x28), .b(x27), .c(x26), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n128_), .c(new_n79_), .d(new_n59_), .O(new_n130_));
  aoi21  g079(.a(new_n130_), .b(new_n127_), .c(new_n67_), .O(new_n131_));
  nor2   g080(.a(x16), .b(x06), .O(new_n132_));
  oai21  g081(.a(new_n132_), .b(new_n131_), .c(new_n61_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n56_), .O(z09));
  nand2  g083(.a(new_n130_), .b(x29), .O(new_n135_));
  inv1   g084(.a(x27), .O(new_n136_));
  nor2   g085(.a(x29), .b(x28), .O(new_n137_));
  nand4  g086(.a(new_n137_), .b(new_n113_), .c(new_n90_), .d(new_n136_), .O(new_n138_));
  ...
  nand2  g090(.a(new_n141_), .b(new_n56_), .O(z10));
  nand4  g091(.a(new_n105_), .b(new_n62_), .c(new_n70_), .d(new_n60_), .O(new_n143_));
  nor2   g092(.a(x26), .b(x25), .O(new_n144_));
  nand4  g093(.a(new_n137_), .b(new_n144_), .c(new_n136_), .d(new_n95_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n143_), .c(x30), .O(new_n146_));
  nor2   g095(.a(x28), .b(x27), .O(new_n147_));
  nor2   g096(.a(x30), .b(x29), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n147_), .c(new_n113_), .d(new_n90_), .O(new_n149_));
  ...
  nand2  g101(.a(new_n152_), .b(new_n56_), .O(z11));
  nand2  g102(.a(new_n149_), .b(x31), .O(new_n154_));
  nor2   g103(.a(x31), .b(x30), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n137_), .c(new_n120_), .d(new_n119_), .O(new_n156_));
  ...
  oai21  g111(.a(new_n156_), .b(new_n97_), .c(x32), .O(new_n163_));
  nand2  g112(.a(new_n147_), .b(new_n144_), .O(new_n164_));
  inv1   g113(.a(x31), .O(new_n165_));
  inv1   g114(.a(x32), .O(new_n166_));
  nand3  g115(.a(new_n148_), .b(new_n166_), .c(new_n165_), .O(new_n167_));
  nor2   g116(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n96_), .c(new_n84_), .d(new_n71_), .O(new_n169_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n155_), .c(new_n137_), .d(new_n120_), .O(new_n176_));
  nor2   g125(.a(new_n176_), .b(new_n107_), .O(new_n177_));
  aoi21  g126(.a(new_n169_), .b(x33), .c(new_n177_), .O(new_n178_));
  aoi21  g127(.a(new_n67_), .b(new_n55_), .c(x18), .O(new_n179_));
  oai21  g128(.a(new_n178_), .b(new_n67_), .c(new_n179_), .O(z14));
  oai21  g129(.a(new_n176_), .b(new_n107_), .c(x34), .O(new_n181_));
  nand4  g130(.a(new_n119_), .b(new_n95_), .c(new_n88_), .d(new_n87_), .O(new_n182_));
  nor2   g131(.a(new_n182_), .b(new_n73_), .O(new_n183_));
  nand2  g132(.a(new_n137_), .b(new_n120_), .O(new_n184_));
  ...
  aoi21  g141(.a(new_n192_), .b(new_n181_), .c(new_n67_), .O(new_n193_));
  nor2   g142(.a(x16), .b(x00), .O(new_n194_));
  oai21  g143(.a(new_n194_), .b(new_n193_), .c(new_n61_), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n56_), .O(z15));
endmodule
