...
module FAU ( 
  ...
  nor3   g039(.a(new_n90_), .b(x18), .c(new_n69_), .O(new_n91_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n83_), .c(new_n93_), .d(new_n52_), .O(new_n98_));
  aoi21  g047(.a(new_n98_), .b(new_n96_), .c(new_n58_), .O(new_n99_));
  nor2   g048(.a(x16), .b(x10), .O(new_n100_));
  oai21  g049(.a(new_n100_), .b(new_n99_), .c(x03), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(new_n61_), .O(z05));
  nand2  g051(.a(new_n98_), .b(x25), .O(new_n103_));
  nor2   g052(.a(x25), .b(x24), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n94_), .c(new_n72_), .d(new_n55_), .O(new_n105_));
  ...
  nand3  g062(.a(new_n113_), .b(new_n94_), .c(new_n112_), .O(new_n114_));
  oai22  g063(.a(new_n114_), .b(new_n73_), .c(new_n111_), .d(new_n110_), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(x16), .O(new_n116_));
  inv1   g065(.a(x08), .O(new_n117_));
  aoi21  g066(.a(new_n58_), .b(new_n117_), .c(x18), .O(new_n118_));
  nand3  g067(.a(new_n118_), .b(new_n116_), .c(x03), .O(z07));
  ...
  oai21  g073(.a(new_n124_), .b(new_n123_), .c(x03), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n61_), .O(z08));
  nand2  g075(.a(new_n122_), .b(x28), .O(new_n127_));
  nor2   g076(.a(x28), .b(x27), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n104_), .c(new_n110_), .d(new_n86_), .O(new_n129_));
  oai21  g078(.a(new_n129_), .b(new_n84_), .c(new_n127_), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(x16), .O(new_n131_));
  inv1   g080(.a(x06), .O(new_n132_));
  aoi21  g081(.a(new_n58_), .b(new_n132_), .c(x18), .O(new_n133_));
  nand3  g082(.a(new_n133_), .b(new_n131_), .c(x03), .O(z09));
  oai21  g083(.a(new_n129_), .b(new_n84_), .c(x29), .O(new_n135_));
  nor3   g084(.a(x26), .b(x25), .c(x24), .O(new_n136_));
  nor3   g085(.a(x29), .b(x28), .c(x27), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n136_), .c(new_n88_), .O(new_n138_));
  aoi21  g087(.a(new_n138_), .b(new_n135_), .c(new_n58_), .O(new_n139_));
  nor2   g088(.a(x16), .b(x05), .O(new_n140_));
  oai21  g089(.a(new_n140_), .b(new_n139_), .c(x03), .O(new_n141_));
  nand2  g090(.a(new_n141_), .b(new_n61_), .O(z10));
  inv1   g091(.a(x27), .O(new_n143_));
  nor2   g092(.a(x29), .b(x28), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n113_), .c(new_n143_), .d(new_n112_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n95_), .c(x30), .O(new_n146_));
  inv1   g095(.a(x29), .O(new_n147_));
  inv1   g096(.a(x30), .O(new_n148_));
  nand3  g097(.a(new_n128_), .b(new_n148_), .c(new_n147_), .O(new_n149_));
  inv1   g098(.a(new_n149_), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n136_), .c(new_n88_), .O(new_n151_));
  aoi21  g100(.a(new_n151_), .b(new_n146_), .c(new_n58_), .O(new_n152_));
  nor2   g101(.a(x16), .b(x04), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n152_), .c(x03), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n61_), .O(z11));
  ...
  nand4  g108(.a(new_n159_), .b(new_n144_), .c(new_n158_), .d(new_n157_), .O(new_n160_));
  or2    g109(.a(new_n160_), .b(new_n98_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n156_), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(x16), .c(x03), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n61_), .O(z12));
  oai21  g113(.a(new_n160_), .b(new_n98_), .c(x32), .O(new_n165_));
  nand4  g114(.a(new_n112_), .b(new_n86_), .c(new_n85_), .d(new_n70_), .O(new_n166_));
  inv1   g115(.a(new_n166_), .O(new_n167_));
  inv1   g116(.a(x28), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n143_), .c(new_n110_), .d(new_n157_), .O(new_n169_));
  inv1   g118(.a(new_n169_), .O(new_n170_));
  inv1   g119(.a(x31), .O(new_n171_));
  inv1   g120(.a(x32), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n171_), .c(new_n148_), .d(new_n147_), .O(new_n173_));
  inv1   g122(.a(new_n173_), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n170_), .c(new_n167_), .d(new_n71_), .O(new_n175_));
  aoi21  g124(.a(new_n175_), .b(new_n165_), .c(new_n58_), .O(new_n176_));
  nor2   g125(.a(x16), .b(x02), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n176_), .c(x03), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(new_n61_), .O(z13));
  nand2  g128(.a(new_n175_), .b(x33), .O(new_n180_));
  nor2   g129(.a(x33), .b(x32), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n159_), .c(new_n144_), .d(new_n158_), .O(new_n182_));
  or2    g131(.a(new_n182_), .b(new_n105_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(new_n180_), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(x16), .O(new_n185_));
  nor2   g134(.a(x16), .b(x01), .O(new_n186_));
  nor3   g135(.a(new_n186_), .b(x18), .c(new_n69_), .O(new_n187_));
  nand2  g136(.a(new_n187_), .b(new_n185_), .O(z14));
  oai21  g137(.a(new_n182_), .b(new_n105_), .c(x34), .O(new_n189_));
  nand2  g138(.a(new_n144_), .b(new_n158_), .O(new_n190_));
  inv1   g139(.a(new_n190_), .O(new_n191_));
  nor3   g140(.a(x34), .b(x33), .c(x32), .O(new_n192_));
  nand3  g141(.a(new_n192_), .b(new_n191_), .c(new_n159_), .O(new_n193_));
  oai21  g142(.a(new_n193_), .b(new_n105_), .c(new_n189_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(x16), .O(new_n195_));
  inv1   g144(.a(x00), .O(new_n196_));
  aoi21  g145(.a(new_n58_), .b(new_n196_), .c(x18), .O(new_n197_));
  nand3  g146(.a(new_n197_), .b(new_n195_), .c(x03), .O(z15));
endmodule
