...
module FAU ( 
  ...
  aoi22  g017(.a(new_n68_), .b(new_n58_), .c(new_n61_), .d(x21), .O(new_n69_));
  inv1   g018(.a(x13), .O(new_n70_));
  aoi21  g019(.a(new_n65_), .b(new_n70_), .c(x18), .O(new_n71_));
  oai21  g020(.a(new_n69_), .b(new_n65_), .c(new_n71_), .O(z02));
  inv1   g021(.a(x21), .O(new_n73_));
  nand4  g022(.a(new_n73_), .b(new_n57_), .c(new_n60_), .d(new_n59_), .O(new_n74_));
  nor3   g023(.a(x22), .b(x21), .c(x20), .O(new_n75_));
  aoi22  g024(.a(new_n75_), .b(new_n58_), .c(new_n74_), .d(x22), .O(new_n76_));
  ...
  nand2  g028(.a(new_n75_), .b(new_n58_), .O(new_n80_));
  inv1   g029(.a(x18), .O(new_n81_));
  nor2   g030(.a(x20), .b(x19), .O(new_n82_));
  nor2   g031(.a(x23), .b(x22), .O(new_n83_));
  nand4  g032(.a(new_n83_), .b(new_n82_), .c(new_n73_), .d(new_n59_), .O(new_n84_));
  nand2  g033(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  aoi21  g034(.a(new_n80_), .b(x23), .c(new_n85_), .O(new_n86_));
  oai22  g035(.a(new_n86_), .b(new_n65_), .c(new_n55_), .d(x11), .O(z04));
  ...
  nand4  g044(.a(new_n95_), .b(new_n94_), .c(new_n82_), .d(new_n59_), .O(new_n96_));
  ...
  nand4  g051(.a(new_n102_), .b(new_n83_), .c(new_n68_), .d(new_n58_), .O(new_n103_));
  ...
  nand3  g056(.a(new_n107_), .b(new_n83_), .c(new_n88_), .O(new_n108_));
  ...
  oai21  g061(.a(new_n110_), .b(new_n65_), .c(new_n112_), .O(z07));
  oai21  g062(.a(new_n108_), .b(new_n74_), .c(x27), .O(new_n114_));
  nor3   g063(.a(x27), .b(x26), .c(x25), .O(new_n115_));
  nand4  g064(.a(new_n115_), .b(new_n95_), .c(new_n75_), .d(new_n58_), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n114_), .c(new_n81_), .O(new_n117_));
  ...
  nand4  g071(.a(new_n122_), .b(new_n121_), .c(new_n75_), .d(new_n58_), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n120_), .c(new_n81_), .O(new_n124_));
  nand2  g073(.a(new_n124_), .b(x16), .O(new_n125_));
  inv1   g074(.a(x06), .O(new_n126_));
  nand2  g075(.a(new_n54_), .b(new_n126_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(new_n125_), .O(z09));
  nand2  g077(.a(new_n123_), .b(x29), .O(new_n129_));
  inv1   g078(.a(x27), .O(new_n130_));
  nor3   g079(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nor2   g080(.a(x29), .b(x28), .O(new_n132_));
  nand4  g081(.a(new_n132_), .b(new_n131_), .c(new_n92_), .d(new_n130_), .O(new_n133_));
  nand3  g082(.a(new_n133_), .b(new_n129_), .c(new_n81_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(x16), .O(new_n135_));
  inv1   g084(.a(x05), .O(new_n136_));
  nand2  g085(.a(new_n54_), .b(new_n136_), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n135_), .O(z10));
  nand4  g087(.a(new_n132_), .b(new_n107_), .c(new_n130_), .d(new_n88_), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n84_), .c(x30), .O(new_n140_));
  nor2   g089(.a(x28), .b(x27), .O(new_n141_));
  nor2   g090(.a(x30), .b(x29), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  inv1   g092(.a(new_n143_), .O(new_n144_));
  nand3  g093(.a(new_n144_), .b(new_n131_), .c(new_n92_), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n140_), .c(new_n81_), .O(new_n146_));
  ...
  nand4  g102(.a(new_n153_), .b(new_n132_), .c(new_n152_), .d(new_n151_), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n96_), .c(new_n81_), .O(new_n155_));
  ...
  inv1   g109(.a(new_n96_), .O(new_n161_));
  nor2   g110(.a(x32), .b(x31), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n142_), .c(new_n141_), .d(new_n107_), .O(new_n163_));
  inv1   g112(.a(new_n163_), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n160_), .c(new_n81_), .O(new_n166_));
  ...
  nand4  g122(.a(new_n173_), .b(new_n153_), .c(new_n132_), .d(new_n152_), .O(new_n174_));
  ...
  nand4  g129(.a(new_n151_), .b(new_n88_), .c(new_n90_), .d(new_n89_), .O(new_n181_));
  nor2   g130(.a(new_n181_), .b(new_n74_), .O(new_n182_));
  nand2  g131(.a(new_n132_), .b(new_n152_), .O(new_n183_));
  ...
  nand3  g141(.a(new_n192_), .b(new_n180_), .c(new_n81_), .O(new_n193_));
