...
module FAU ( 
  ...
  nand3  g032(.a(new_n83_), .b(new_n71_), .c(x16), .O(new_n84_));
  nand2  g033(.a(new_n84_), .b(new_n78_), .O(z03));
  inv1   g034(.a(x23), .O(new_n86_));
  nand3  g035(.a(new_n86_), .b(new_n79_), .c(new_n72_), .O(new_n87_));
  ...
  nand4  g051(.a(new_n96_), .b(new_n81_), .c(new_n93_), .d(new_n52_), .O(new_n103_));
  inv1   g052(.a(x24), .O(new_n104_));
  inv1   g053(.a(x25), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n104_), .c(new_n86_), .d(new_n79_), .O(new_n106_));
  ...
  oai22  g065(.a(new_n116_), .b(new_n73_), .c(new_n107_), .d(new_n114_), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n71_), .c(x16), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(new_n113_), .O(z07));
  inv1   g068(.a(x07), .O(new_n120_));
  oai21  g069(.a(x18), .b(new_n120_), .c(new_n58_), .O(new_n121_));
  oai21  g070(.a(new_n116_), .b(new_n73_), .c(x27), .O(new_n122_));
  nor3   g071(.a(x22), .b(x21), .c(x20), .O(new_n123_));
  nor3   g072(.a(x27), .b(x26), .c(x25), .O(new_n124_));
  nand4  g073(.a(new_n124_), .b(new_n96_), .c(new_n123_), .d(new_n55_), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n71_), .c(x16), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(new_n121_), .O(z08));
  nor2   g077(.a(x25), .b(x24), .O(new_n129_));
  nor2   g078(.a(x28), .b(x27), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n129_), .c(new_n114_), .d(new_n86_), .O(new_n131_));
  nor2   g080(.a(new_n131_), .b(new_n82_), .O(new_n132_));
  aoi21  g081(.a(new_n125_), .b(x28), .c(new_n132_), .O(new_n133_));
  ...
  oai21  g087(.a(new_n131_), .b(new_n82_), .c(x29), .O(new_n139_));
  ...
  nand2  g101(.a(new_n152_), .b(new_n130_), .O(new_n153_));
  inv1   g102(.a(new_n153_), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n140_), .c(new_n88_), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(new_n151_), .O(new_n156_));
  nand3  g105(.a(new_n156_), .b(new_n71_), .c(x16), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n147_), .O(z11));
  inv1   g107(.a(x03), .O(new_n159_));
  oai21  g108(.a(x18), .b(new_n159_), .c(new_n58_), .O(new_n160_));
  nand4  g109(.a(new_n152_), .b(new_n130_), .c(new_n115_), .d(new_n104_), .O(new_n161_));
  ...
  nand4  g114(.a(new_n165_), .b(new_n124_), .c(new_n98_), .d(new_n64_), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(new_n162_), .O(new_n167_));
  nand3  g116(.a(new_n167_), .b(new_n71_), .c(x16), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n160_), .O(z12));
  nor2   g118(.a(x27), .b(x26), .O(new_n170_));
  nand4  g119(.a(new_n163_), .b(new_n149_), .c(new_n170_), .d(new_n105_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n103_), .c(x32), .O(new_n172_));
  nand2  g121(.a(new_n130_), .b(new_n115_), .O(new_n173_));
  inv1   g122(.a(new_n173_), .O(new_n174_));
  nor2   g123(.a(x32), .b(x31), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(new_n152_), .O(new_n176_));
  inv1   g125(.a(new_n176_), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n174_), .c(new_n98_), .d(new_n64_), .O(new_n178_));
  ...
  nand4  g134(.a(new_n175_), .b(new_n152_), .c(new_n130_), .d(new_n115_), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(new_n103_), .c(x33), .O(new_n187_));
  inv1   g136(.a(new_n106_), .O(new_n188_));
  nand2  g137(.a(new_n149_), .b(new_n170_), .O(new_n189_));
  inv1   g138(.a(new_n189_), .O(new_n190_));
  nor2   g139(.a(x33), .b(x32), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(new_n163_), .O(new_n192_));
  inv1   g141(.a(new_n192_), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n190_), .c(new_n188_), .d(new_n80_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n187_), .O(new_n195_));
  nand3  g144(.a(new_n195_), .b(new_n71_), .c(x16), .O(new_n196_));
  nand2  g145(.a(new_n196_), .b(new_n185_), .O(z14));
  nor2   g146(.a(x21), .b(x20), .O(new_n198_));
  nand4  g147(.a(new_n129_), .b(new_n94_), .c(new_n198_), .d(new_n55_), .O(new_n199_));
  nand4  g148(.a(new_n191_), .b(new_n163_), .c(new_n149_), .d(new_n170_), .O(new_n200_));
