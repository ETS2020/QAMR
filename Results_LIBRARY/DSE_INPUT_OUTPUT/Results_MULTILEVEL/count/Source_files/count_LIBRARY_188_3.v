...
module FAU ( 
  ...
  nand2  g019(.a(new_n63_), .b(new_n61_), .O(new_n71_));
  ...
  aoi21  g030(.a(new_n81_), .b(new_n79_), .c(new_n68_), .O(new_n82_));
  nor2   g031(.a(x16), .b(x12), .O(new_n83_));
  oai21  g032(.a(new_n83_), .b(new_n82_), .c(new_n62_), .O(new_n84_));
  ...
  aoi21  g038(.a(new_n89_), .b(new_n86_), .c(new_n68_), .O(new_n90_));
  ...
  nand4  g049(.a(new_n94_), .b(new_n80_), .c(new_n63_), .d(new_n61_), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(x25), .O(new_n102_));
  nor2   g051(.a(x23), .b(x22), .O(new_n103_));
  nor2   g052(.a(x25), .b(x24), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n103_), .c(new_n72_), .d(new_n59_), .O(new_n105_));
  and2   g054(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  inv1   g055(.a(x09), .O(new_n107_));
  aoi21  g056(.a(new_n68_), .b(new_n107_), .c(x18), .O(new_n108_));
  oai21  g057(.a(new_n106_), .b(new_n68_), .c(new_n108_), .O(z06));
  nand2  g058(.a(new_n105_), .b(x26), .O(new_n110_));
  nor3   g059(.a(x26), .b(x25), .c(x24), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(new_n103_), .c(new_n74_), .O(new_n112_));
  ...
  nand3  g067(.a(new_n118_), .b(new_n94_), .c(new_n55_), .O(new_n119_));
  ...
  aoi21  g071(.a(new_n68_), .b(new_n122_), .c(x18), .O(new_n123_));
  oai21  g072(.a(new_n121_), .b(new_n68_), .c(new_n123_), .O(z08));
  inv1   g073(.a(x19), .O(new_n125_));
  nor2   g074(.a(x17), .b(new_n68_), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n72_), .c(new_n125_), .O(new_n127_));
  ...
  oai21  g081(.a(new_n119_), .b(new_n81_), .c(x28), .O(new_n133_));
  inv1   g082(.a(x06), .O(new_n134_));
  nand2  g083(.a(new_n68_), .b(new_n134_), .O(new_n135_));
  oai21  g084(.a(new_n133_), .b(new_n68_), .c(new_n135_), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(new_n62_), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n132_), .O(z09));
  nor3   g087(.a(x22), .b(x21), .c(x20), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n59_), .c(x16), .O(new_n140_));
  nor3   g089(.a(x26), .b(x24), .c(x23), .O(new_n141_));
  nor3   g090(.a(x29), .b(x28), .c(x27), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(new_n140_), .c(new_n62_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n55_), .O(new_n145_));
  nor3   g094(.a(x25), .b(x24), .c(x23), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n129_), .c(new_n139_), .d(new_n59_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(x29), .c(x16), .O(new_n148_));
  inv1   g097(.a(x05), .O(new_n149_));
  nand2  g098(.a(new_n68_), .b(new_n149_), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n62_), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n145_), .O(z10));
  nor2   g102(.a(x28), .b(x27), .O(new_n154_));
  nor2   g103(.a(x30), .b(x29), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n141_), .c(new_n154_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n140_), .c(new_n62_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n55_), .O(new_n158_));
  nand4  g107(.a(new_n142_), .b(new_n111_), .c(new_n88_), .d(new_n87_), .O(new_n159_));
  nand3  g108(.a(new_n159_), .b(x30), .c(x16), .O(new_n160_));
  ...
  nand2  g113(.a(new_n164_), .b(new_n158_), .O(z11));
  inv1   g114(.a(x24), .O(new_n166_));
  nor2   g115(.a(x26), .b(x25), .O(new_n167_));
  nand4  g116(.a(new_n155_), .b(new_n154_), .c(new_n167_), .d(new_n166_), .O(new_n168_));
  ...
  nand4  g123(.a(new_n174_), .b(new_n170_), .c(new_n96_), .d(new_n87_), .O(new_n175_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n155_), .c(new_n154_), .d(new_n167_), .O(new_n182_));
  nor2   g131(.a(new_n182_), .b(new_n101_), .O(new_n183_));
  aoi21  g132(.a(new_n175_), .b(x32), .c(new_n183_), .O(new_n184_));
  inv1   g133(.a(x02), .O(new_n185_));
  aoi21  g134(.a(new_n68_), .b(new_n185_), .c(x18), .O(new_n186_));
  oai21  g135(.a(new_n184_), .b(new_n68_), .c(new_n186_), .O(z13));
  oai21  g136(.a(new_n182_), .b(new_n101_), .c(x33), .O(new_n188_));
  nor2   g137(.a(x33), .b(x32), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n172_), .c(new_n171_), .d(new_n118_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n105_), .c(new_n188_), .O(new_n191_));
  ...
  nand3  g144(.a(new_n126_), .b(new_n96_), .c(new_n63_), .O(new_n196_));
  nor3   g145(.a(x34), .b(x33), .c(x32), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n172_), .c(new_n171_), .d(new_n118_), .O(new_n198_));
  oai21  g147(.a(new_n198_), .b(new_n196_), .c(new_n62_), .O(new_n199_));
  nand2  g148(.a(new_n199_), .b(new_n55_), .O(new_n200_));
  oai21  g149(.a(new_n190_), .b(new_n105_), .c(x34), .O(new_n201_));
  inv1   g150(.a(x00), .O(new_n202_));
  nand2  g151(.a(new_n68_), .b(new_n202_), .O(new_n203_));
  oai21  g152(.a(new_n201_), .b(new_n68_), .c(new_n203_), .O(new_n204_));
  nand2  g153(.a(new_n204_), .b(new_n62_), .O(new_n205_));
  nand2  g154(.a(new_n205_), .b(new_n200_), .O(z15));
endmodule
