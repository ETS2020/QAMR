...
module FAU ( 
  ...
  nand3  g037(.a(new_n88_), .b(new_n55_), .c(new_n64_), .O(new_n89_));
  inv1   g038(.a(x23), .O(new_n90_));
  nand3  g039(.a(new_n90_), .b(new_n81_), .c(new_n72_), .O(new_n91_));
  ...
  nand4  g047(.a(new_n98_), .b(new_n97_), .c(new_n72_), .d(new_n52_), .O(new_n99_));
  nand2  g048(.a(new_n99_), .b(x24), .O(new_n100_));
  nor2   g049(.a(x24), .b(x23), .O(new_n101_));
  nand4  g050(.a(new_n101_), .b(new_n88_), .c(new_n97_), .d(new_n52_), .O(new_n102_));
  aoi21  g051(.a(new_n102_), .b(new_n100_), .c(new_n58_), .O(new_n103_));
  nor2   g052(.a(x16), .b(x10), .O(new_n104_));
  oai21  g053(.a(new_n104_), .b(new_n103_), .c(new_n61_), .O(new_n105_));
  nand2  g054(.a(new_n105_), .b(new_n70_), .O(z05));
  nand2  g055(.a(new_n102_), .b(x25), .O(new_n107_));
  nor2   g056(.a(x25), .b(x24), .O(new_n108_));
  nand4  g057(.a(new_n108_), .b(new_n98_), .c(new_n74_), .d(new_n55_), .O(new_n109_));
  ...
  nand2  g061(.a(new_n112_), .b(new_n70_), .O(z06));
  nand4  g062(.a(new_n74_), .b(new_n53_), .c(new_n61_), .d(new_n52_), .O(new_n114_));
  inv1   g063(.a(x24), .O(new_n115_));
  nor2   g064(.a(x26), .b(x25), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n98_), .c(new_n115_), .O(new_n117_));
  ...
  oai21  g071(.a(new_n117_), .b(new_n75_), .c(x27), .O(new_n123_));
  nor3   g072(.a(x27), .b(x26), .c(x25), .O(new_n124_));
  nand4  g073(.a(new_n124_), .b(new_n101_), .c(new_n83_), .d(new_n55_), .O(new_n125_));
  aoi21  g074(.a(new_n125_), .b(new_n123_), .c(new_n58_), .O(new_n126_));
  nor2   g075(.a(x16), .b(x07), .O(new_n127_));
  oai21  g076(.a(new_n127_), .b(new_n126_), .c(new_n61_), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n70_), .O(z08));
  nand2  g078(.a(new_n125_), .b(x28), .O(new_n130_));
  inv1   g079(.a(x26), .O(new_n131_));
  nor2   g080(.a(x28), .b(x27), .O(new_n132_));
  nand4  g081(.a(new_n132_), .b(new_n108_), .c(new_n131_), .d(new_n90_), .O(new_n133_));
  or2    g082(.a(new_n133_), .b(new_n89_), .O(new_n134_));
  ...
  oai21  g088(.a(new_n133_), .b(new_n89_), .c(x29), .O(new_n140_));
  nor3   g089(.a(x26), .b(x25), .c(x24), .O(new_n141_));
  nor3   g090(.a(x29), .b(x28), .c(x27), .O(new_n142_));
  nand3  g091(.a(new_n142_), .b(new_n141_), .c(new_n92_), .O(new_n143_));
  aoi21  g092(.a(new_n143_), .b(new_n140_), .c(new_n58_), .O(new_n144_));
  nor2   g093(.a(x16), .b(x05), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n144_), .c(new_n61_), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n70_), .O(z10));
  inv1   g096(.a(x27), .O(new_n148_));
  nor2   g097(.a(x29), .b(x28), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n116_), .c(new_n148_), .d(new_n115_), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n99_), .c(x30), .O(new_n151_));
  inv1   g100(.a(x29), .O(new_n152_));
  inv1   g101(.a(x30), .O(new_n153_));
  nand3  g102(.a(new_n132_), .b(new_n153_), .c(new_n152_), .O(new_n154_));
  inv1   g103(.a(new_n154_), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n141_), .c(new_n92_), .O(new_n156_));
  aoi21  g105(.a(new_n156_), .b(new_n151_), .c(new_n58_), .O(new_n157_));
  nor2   g106(.a(x16), .b(x04), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n157_), .c(new_n61_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n70_), .O(z11));
  oai21  g109(.a(x18), .b(new_n58_), .c(new_n69_), .O(new_n161_));
  nand2  g110(.a(new_n156_), .b(x31), .O(new_n162_));
  inv1   g111(.a(x25), .O(new_n163_));
  nor2   g112(.a(x27), .b(x26), .O(new_n164_));
  nor2   g113(.a(x31), .b(x30), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n149_), .c(new_n164_), .d(new_n163_), .O(new_n166_));
  or2    g115(.a(new_n166_), .b(new_n102_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n162_), .O(new_n168_));
  nand3  g117(.a(new_n168_), .b(new_n61_), .c(x16), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n161_), .O(z12));
  oai21  g119(.a(new_n166_), .b(new_n102_), .c(x32), .O(new_n171_));
  nand4  g120(.a(new_n115_), .b(new_n90_), .c(new_n81_), .d(new_n72_), .O(new_n172_));
  inv1   g121(.a(new_n172_), .O(new_n173_));
  inv1   g122(.a(x28), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n148_), .c(new_n131_), .d(new_n163_), .O(new_n175_));
  inv1   g124(.a(new_n175_), .O(new_n176_));
  inv1   g125(.a(x31), .O(new_n177_));
  inv1   g126(.a(x32), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n177_), .c(new_n153_), .d(new_n152_), .O(new_n179_));
  inv1   g128(.a(new_n179_), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n176_), .c(new_n173_), .d(new_n73_), .O(new_n181_));
  aoi21  g130(.a(new_n181_), .b(new_n171_), .c(new_n58_), .O(new_n182_));
  nor2   g131(.a(x16), .b(x02), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n182_), .c(new_n61_), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n70_), .O(z13));
  nand2  g134(.a(new_n181_), .b(x33), .O(new_n186_));
  nor2   g135(.a(x33), .b(x32), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n165_), .c(new_n149_), .d(new_n164_), .O(new_n188_));
  or2    g137(.a(new_n188_), .b(new_n109_), .O(new_n189_));
  ...
  oai21  g143(.a(new_n188_), .b(new_n109_), .c(x34), .O(new_n195_));
  nand2  g144(.a(new_n149_), .b(new_n164_), .O(new_n196_));
  inv1   g145(.a(new_n196_), .O(new_n197_));
  nor3   g146(.a(x34), .b(x33), .c(x32), .O(new_n198_));
  nand3  g147(.a(new_n198_), .b(new_n197_), .c(new_n165_), .O(new_n199_));
  oai21  g148(.a(new_n199_), .b(new_n109_), .c(new_n195_), .O(new_n200_));
