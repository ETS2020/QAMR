...
module FAU ( 
  ...
  aoi22  g020(.a(new_n71_), .b(new_n54_), .c(new_n66_), .d(x21), .O(new_n72_));
  nor2   g021(.a(x16), .b(x13), .O(new_n73_));
  nor3   g022(.a(new_n73_), .b(x18), .c(x08), .O(new_n74_));
  ...
  nand4  g051(.a(new_n102_), .b(new_n87_), .c(new_n71_), .d(new_n54_), .O(new_n103_));
  ...
  nor2   g057(.a(x17), .b(new_n61_), .O(new_n109_));
  nor3   g058(.a(x21), .b(x20), .c(x19), .O(new_n110_));
  nor3   g059(.a(x26), .b(x25), .c(x24), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n110_), .c(new_n109_), .d(new_n87_), .O(new_n112_));
  ...
  oai21  g067(.a(new_n118_), .b(new_n77_), .c(x27), .O(new_n119_));
  nor3   g068(.a(x27), .b(x26), .c(x25), .O(new_n120_));
  nand4  g069(.a(new_n120_), .b(new_n95_), .c(new_n79_), .d(new_n54_), .O(new_n121_));
  ...
  nand3  g086(.a(new_n137_), .b(new_n136_), .c(new_n76_), .O(new_n138_));
  nor2   g087(.a(new_n138_), .b(new_n66_), .O(new_n139_));
  nor2   g088(.a(x29), .b(x28), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n111_), .c(new_n139_), .d(new_n135_), .O(new_n141_));
  ...
  nand4  g098(.a(new_n149_), .b(new_n148_), .c(new_n111_), .d(new_n139_), .O(new_n150_));
