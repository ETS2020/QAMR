...
module FAU ( 
  ...
  aoi22  g024(.a(new_n75_), .b(new_n61_), .c(new_n72_), .d(x23), .O(new_n76_));
  oai21  g025(.a(new_n76_), .b(new_n74_), .c(new_n52_), .O(z04));
  ...
  nand4  g030(.a(new_n81_), .b(new_n80_), .c(new_n64_), .d(new_n53_), .O(new_n82_));
  ...
  oai21  g040(.a(new_n91_), .b(new_n74_), .c(new_n52_), .O(z06));
  nor2   g041(.a(x21), .b(x20), .O(new_n93_));
  nor2   g042(.a(x23), .b(x22), .O(new_n94_));
  nor2   g043(.a(x25), .b(x24), .O(new_n95_));
  nand4  g044(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n56_), .O(new_n96_));
  nand2  g045(.a(new_n96_), .b(x26), .O(new_n97_));
  nor3   g046(.a(x26), .b(x25), .c(x24), .O(new_n98_));
  nand4  g047(.a(new_n98_), .b(new_n94_), .c(new_n93_), .d(new_n56_), .O(new_n99_));
  ...
  nand4  g053(.a(new_n104_), .b(new_n81_), .c(new_n71_), .d(new_n56_), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n103_), .c(new_n52_), .d(x16), .O(z08));
  nand2  g055(.a(new_n105_), .b(x28), .O(new_n107_));
  nor3   g056(.a(x25), .b(x24), .c(x23), .O(new_n108_));
  nor3   g057(.a(x28), .b(x27), .c(x26), .O(new_n109_));
  nand4  g058(.a(new_n109_), .b(new_n108_), .c(new_n71_), .d(new_n56_), .O(new_n110_));
  nand4  g059(.a(new_n110_), .b(new_n107_), .c(new_n52_), .d(x16), .O(z09));
  nand4  g060(.a(new_n94_), .b(new_n64_), .c(new_n67_), .d(new_n53_), .O(new_n112_));
  ...
  oai21  g067(.a(new_n118_), .b(new_n74_), .c(new_n52_), .O(z10));
  nor3   g068(.a(x29), .b(x28), .c(x27), .O(new_n120_));
  nand4  g069(.a(new_n120_), .b(new_n98_), .c(new_n75_), .d(new_n61_), .O(new_n121_));
  ...
  nand2  g090(.a(new_n141_), .b(new_n52_), .O(z13));
  nand2  g091(.a(new_n139_), .b(x33), .O(new_n143_));
  nor2   g092(.a(x33), .b(x32), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n130_), .c(new_n115_), .d(new_n129_), .O(new_n145_));
  or2    g094(.a(new_n145_), .b(new_n96_), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n143_), .c(new_n52_), .d(x16), .O(z14));
  oai21  g096(.a(new_n145_), .b(new_n96_), .c(x34), .O(new_n148_));
  nand2  g097(.a(new_n115_), .b(new_n129_), .O(new_n149_));
  ...
  nand3  g107(.a(new_n158_), .b(new_n150_), .c(new_n90_), .O(new_n159_));
