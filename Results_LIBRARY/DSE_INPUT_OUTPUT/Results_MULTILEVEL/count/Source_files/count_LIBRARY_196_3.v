...
module FAU ( 
  ...
  nand4  g046(.a(new_n97_), .b(new_n81_), .c(new_n62_), .d(new_n61_), .O(new_n98_));
  ...
  nand4  g055(.a(new_n106_), .b(new_n105_), .c(new_n80_), .d(new_n71_), .O(new_n107_));
  ...
  nand4  g084(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n60_), .O(new_n136_));
  oai21  g085(.a(new_n125_), .b(new_n132_), .c(new_n136_), .O(new_n137_));
  ...
  nand4  g091(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n106_), .O(new_n143_));
  ...
  nand4  g100(.a(new_n151_), .b(new_n118_), .c(new_n150_), .d(new_n149_), .O(new_n152_));
  nor2   g101(.a(x28), .b(x27), .O(new_n153_));
  nor2   g102(.a(x30), .b(x29), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n153_), .c(new_n141_), .d(new_n106_), .O(new_n155_));
  ...
  nand3  g116(.a(new_n167_), .b(new_n164_), .c(new_n108_), .O(new_n168_));
  ...
  nand4  g120(.a(new_n165_), .b(new_n142_), .c(new_n123_), .d(new_n104_), .O(new_n172_));
  ...
  aoi21  g132(.a(new_n176_), .b(new_n108_), .c(new_n183_), .O(new_n184_));
  nor2   g133(.a(x33), .b(x32), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n165_), .c(new_n142_), .d(new_n123_), .O(new_n186_));
  nor2   g135(.a(new_n186_), .b(new_n111_), .O(new_n187_));
  ...
  nand4  g143(.a(new_n104_), .b(new_n106_), .c(new_n105_), .d(new_n80_), .O(new_n195_));
  nor2   g144(.a(new_n195_), .b(new_n72_), .O(new_n196_));
  nand2  g145(.a(new_n142_), .b(new_n123_), .O(new_n197_));
