...
module FAU ( 
  ...
  oai21  g007(.a(new_n58_), .b(x01), .c(new_n52_), .O(z00));
  inv1   g008(.a(x01), .O(new_n60_));
  ...
  oai21  g026(.a(new_n77_), .b(x01), .c(new_n52_), .O(z02));
  ...
  nor3   g030(.a(new_n81_), .b(x18), .c(x01), .O(new_n82_));
  ...
  nand4  g051(.a(new_n102_), .b(new_n88_), .c(new_n73_), .d(new_n54_), .O(new_n103_));
  aoi21  g052(.a(new_n103_), .b(new_n101_), .c(new_n61_), .O(new_n104_));
  nor2   g053(.a(x16), .b(x09), .O(new_n105_));
  oai21  g054(.a(new_n105_), .b(new_n104_), .c(new_n60_), .O(new_n106_));
  ...
  nand3  g064(.a(new_n115_), .b(new_n113_), .c(new_n60_), .O(z07));
  oai21  g065(.a(new_n111_), .b(new_n74_), .c(x27), .O(new_n117_));
  nor3   g066(.a(x27), .b(x26), .c(x25), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n95_), .c(new_n79_), .d(new_n54_), .O(new_n119_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n128_), .c(new_n79_), .d(new_n54_), .O(new_n130_));
  ...
  nor3   g089(.a(new_n140_), .b(x18), .c(x01), .O(new_n141_));
  ...
  nor3   g114(.a(new_n165_), .b(x18), .c(x01), .O(new_n166_));
  ...
  nand3  g126(.a(new_n177_), .b(new_n175_), .c(new_n60_), .O(z13));
  ...
  nand3  g144(.a(new_n195_), .b(new_n193_), .c(new_n60_), .O(z15));
endmodule
