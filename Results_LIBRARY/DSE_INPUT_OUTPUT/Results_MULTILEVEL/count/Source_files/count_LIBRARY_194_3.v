...
module FAU ( 
  ...
  aoi21  g022(.a(new_n67_), .b(new_n73_), .c(x18), .O(new_n74_));
  ...
  nand4  g045(.a(new_n96_), .b(new_n82_), .c(new_n62_), .d(new_n60_), .O(new_n97_));
  aoi21  g046(.a(new_n97_), .b(new_n95_), .c(new_n67_), .O(new_n98_));
  ...
  nand4  g051(.a(new_n102_), .b(new_n93_), .c(new_n71_), .d(new_n59_), .O(new_n103_));
  ...
  nand4  g059(.a(new_n110_), .b(new_n93_), .c(new_n71_), .d(new_n59_), .O(new_n111_));
  ...
  nand3  g066(.a(new_n117_), .b(new_n96_), .c(new_n116_), .O(new_n118_));
  ...
  oai21  g071(.a(new_n120_), .b(new_n67_), .c(new_n122_), .O(z08));
  oai21  g072(.a(new_n118_), .b(new_n83_), .c(x28), .O(new_n124_));
  ...
  nand2  g079(.a(new_n130_), .b(new_n56_), .O(z09));
  nand2  g080(.a(new_n127_), .b(x29), .O(new_n132_));
  nor3   g081(.a(x29), .b(x28), .c(x27), .O(new_n133_));
  nand4  g082(.a(new_n133_), .b(new_n110_), .c(new_n86_), .d(new_n85_), .O(new_n134_));
  and2   g083(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  inv1   g084(.a(x05), .O(new_n136_));
  aoi21  g085(.a(new_n67_), .b(new_n136_), .c(x18), .O(new_n137_));
  oai21  g086(.a(new_n135_), .b(new_n67_), .c(new_n137_), .O(z10));
  nand3  g087(.a(new_n77_), .b(new_n59_), .c(x16), .O(new_n139_));
  nor2   g088(.a(x30), .b(x28), .O(new_n140_));
  nand3  g089(.a(new_n140_), .b(new_n125_), .c(new_n117_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n139_), .c(new_n61_), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(new_n55_), .O(new_n143_));
  nand3  g092(.a(new_n134_), .b(x30), .c(x16), .O(new_n144_));
  inv1   g093(.a(x04), .O(new_n145_));
  nand2  g094(.a(new_n67_), .b(new_n145_), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(new_n61_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n143_), .O(z11));
  nor2   g098(.a(x28), .b(x27), .O(new_n150_));
  nor2   g099(.a(x30), .b(x29), .O(new_n151_));
  nand3  g100(.a(new_n151_), .b(new_n150_), .c(new_n110_), .O(new_n152_));
  oai21  g101(.a(new_n152_), .b(new_n87_), .c(x31), .O(new_n153_));
  nor2   g102(.a(x29), .b(x28), .O(new_n154_));
  nor2   g103(.a(x31), .b(x30), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n154_), .c(new_n117_), .d(new_n116_), .O(new_n156_));
  ...
  nand4  g111(.a(new_n93_), .b(new_n71_), .c(new_n59_), .d(x16), .O(new_n163_));
  nor2   g112(.a(x32), .b(x31), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n140_), .c(new_n117_), .d(new_n102_), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n163_), .c(new_n61_), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(new_n55_), .O(new_n167_));
  oai21  g116(.a(new_n156_), .b(new_n97_), .c(x32), .O(new_n168_));
  inv1   g117(.a(x02), .O(new_n169_));
  nand2  g118(.a(new_n67_), .b(new_n169_), .O(new_n170_));
  oai21  g119(.a(new_n168_), .b(new_n67_), .c(new_n170_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n61_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n167_), .O(z13));
  nor2   g122(.a(x26), .b(x25), .O(new_n174_));
  nand4  g123(.a(new_n164_), .b(new_n151_), .c(new_n150_), .d(new_n174_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n97_), .c(x33), .O(new_n176_));
  nor2   g125(.a(x33), .b(x32), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n155_), .c(new_n154_), .d(new_n117_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n103_), .c(new_n176_), .O(new_n179_));
  ...
  oai21  g132(.a(new_n178_), .b(new_n103_), .c(x34), .O(new_n184_));
  nand2  g133(.a(new_n154_), .b(new_n117_), .O(new_n185_));
  inv1   g134(.a(new_n185_), .O(new_n186_));
  nor3   g135(.a(x34), .b(x33), .c(x32), .O(new_n187_));
  nand3  g136(.a(new_n187_), .b(new_n186_), .c(new_n155_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n103_), .c(new_n184_), .O(new_n189_));
