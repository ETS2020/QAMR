...
module FAU ( 
  ...
  nand2  g047(.a(new_n67_), .b(new_n98_), .O(new_n99_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n55_), .O(new_n104_));
  nand2  g053(.a(new_n104_), .b(new_n63_), .O(new_n105_));
  aoi21  g054(.a(new_n95_), .b(x25), .c(new_n105_), .O(new_n106_));
  oai22  g055(.a(new_n106_), .b(new_n58_), .c(new_n68_), .d(x09), .O(z06));
  nor2   g056(.a(x26), .b(x25), .O(new_n108_));
  nand3  g057(.a(new_n108_), .b(new_n102_), .c(new_n92_), .O(new_n109_));
  nor2   g058(.a(new_n109_), .b(new_n73_), .O(new_n110_));
  ...
  oai21  g063(.a(new_n109_), .b(new_n73_), .c(x27), .O(new_n115_));
  nor3   g064(.a(x27), .b(x26), .c(x25), .O(new_n116_));
  nand4  g065(.a(new_n116_), .b(new_n94_), .c(new_n77_), .d(new_n55_), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n115_), .c(new_n63_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(x16), .O(new_n119_));
  oai21  g068(.a(new_n68_), .b(x07), .c(new_n119_), .O(z08));
  inv1   g069(.a(x25), .O(new_n121_));
  nor2   g070(.a(x27), .b(x26), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n94_), .c(new_n121_), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n83_), .c(x28), .O(new_n124_));
  ...
  nand3  g076(.a(new_n127_), .b(new_n124_), .c(new_n63_), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(x16), .O(new_n129_));
  oai21  g078(.a(new_n68_), .b(x06), .c(new_n129_), .O(z09));
  nand4  g079(.a(new_n102_), .b(new_n71_), .c(new_n70_), .d(new_n52_), .O(new_n131_));
  inv1   g080(.a(x27), .O(new_n132_));
  nor2   g081(.a(x29), .b(x28), .O(new_n133_));
  nand4  g082(.a(new_n133_), .b(new_n108_), .c(new_n132_), .d(new_n92_), .O(new_n134_));
  ...
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x30), .O(new_n140_));
  ...
  nand3  g094(.a(new_n145_), .b(new_n141_), .c(new_n87_), .O(new_n146_));
  nand3  g095(.a(new_n146_), .b(new_n140_), .c(new_n63_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(x16), .O(new_n148_));
  inv1   g097(.a(x04), .O(new_n149_));
  nand2  g098(.a(new_n67_), .b(new_n149_), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(new_n148_), .O(z11));
  nor2   g100(.a(x31), .b(x30), .O(new_n152_));
  nand4  g101(.a(new_n152_), .b(new_n133_), .c(new_n122_), .d(new_n121_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n95_), .c(new_n63_), .O(new_n154_));
  aoi21  g103(.a(new_n146_), .b(x31), .c(new_n154_), .O(new_n155_));
  inv1   g104(.a(x03), .O(new_n156_));
  nand2  g105(.a(new_n67_), .b(new_n156_), .O(new_n157_));
  oai21  g106(.a(new_n155_), .b(new_n58_), .c(new_n157_), .O(z12));
  oai21  g107(.a(new_n153_), .b(new_n95_), .c(x32), .O(new_n159_));
  inv1   g108(.a(new_n95_), .O(new_n160_));
  nor2   g109(.a(x32), .b(x31), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n143_), .c(new_n142_), .d(new_n108_), .O(new_n162_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n95_), .c(x33), .O(new_n170_));
  nand4  g119(.a(new_n121_), .b(new_n92_), .c(new_n85_), .d(new_n84_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(new_n73_), .O(new_n172_));
  nor2   g121(.a(x33), .b(x32), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n152_), .c(new_n133_), .d(new_n122_), .O(new_n174_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n104_), .c(x34), .O(new_n182_));
  nand2  g131(.a(new_n133_), .b(new_n122_), .O(new_n183_));
  ...
  nand3  g141(.a(new_n192_), .b(new_n184_), .c(new_n172_), .O(new_n193_));
