...
module FAU ( 
  ...
  nand2  g016(.a(x18), .b(x13), .O(new_n68_));
  ...
  aoi21  g040(.a(new_n85_), .b(new_n63_), .c(new_n91_), .O(new_n92_));
  ...
  nand3  g067(.a(new_n118_), .b(new_n114_), .c(new_n73_), .O(new_n119_));
  ...
  nand2  g071(.a(new_n122_), .b(new_n68_), .O(z07));
  nor2   g072(.a(x26), .b(x25), .O(new_n124_));
  nand3  g073(.a(new_n124_), .b(new_n114_), .c(new_n91_), .O(new_n125_));
  oai21  g074(.a(new_n125_), .b(new_n72_), .c(x27), .O(new_n126_));
  nor3   g075(.a(x27), .b(x26), .c(x25), .O(new_n127_));
  nand4  g076(.a(new_n127_), .b(new_n96_), .c(new_n78_), .d(new_n55_), .O(new_n128_));
  ...
  nand4  g091(.a(new_n142_), .b(new_n118_), .c(new_n85_), .d(new_n63_), .O(new_n143_));
  ...
  nand3  g107(.a(new_n158_), .b(new_n157_), .c(new_n127_), .O(new_n159_));
  oai22  g108(.a(new_n159_), .b(new_n103_), .c(new_n151_), .d(new_n156_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n159_), .b(new_n103_), .c(x32), .O(new_n165_));
  nor2   g114(.a(x32), .b(x31), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n149_), .c(new_n148_), .d(new_n124_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n103_), .c(new_n165_), .O(new_n168_));
  ...
  oai21  g121(.a(new_n167_), .b(new_n103_), .c(x33), .O(new_n173_));
  ...
  aoi21  g127(.a(new_n178_), .b(new_n173_), .c(new_n58_), .O(new_n179_));
  nor2   g128(.a(x16), .b(x01), .O(new_n180_));
  oai21  g129(.a(new_n180_), .b(new_n179_), .c(new_n61_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n68_), .O(z14));
  oai21  g131(.a(new_n176_), .b(new_n116_), .c(x34), .O(new_n183_));
  ...
  nand3  g141(.a(new_n192_), .b(new_n185_), .c(new_n108_), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n183_), .c(new_n58_), .O(new_n194_));
  nor2   g143(.a(x16), .b(x00), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n194_), .c(new_n61_), .O(new_n196_));
  nand2  g145(.a(new_n196_), .b(new_n68_), .O(z15));
endmodule
