...
module FAU ( 
  ...
  oai21  g017(.a(new_n68_), .b(new_n67_), .c(x08), .O(new_n69_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n83_), .c(new_n93_), .d(new_n63_), .O(new_n98_));
  aoi21  g047(.a(new_n98_), .b(new_n96_), .c(new_n61_), .O(new_n99_));
  nor2   g048(.a(x16), .b(x10), .O(new_n100_));
  oai21  g049(.a(new_n100_), .b(new_n99_), .c(x08), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(new_n53_), .O(z05));
  inv1   g051(.a(x25), .O(new_n103_));
  inv1   g052(.a(x24), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n86_), .c(new_n85_), .d(new_n71_), .O(new_n105_));
  nor2   g054(.a(new_n105_), .b(new_n66_), .O(new_n106_));
  nor2   g055(.a(x21), .b(x20), .O(new_n107_));
  nor2   g056(.a(x25), .b(x24), .O(new_n108_));
  nand4  g057(.a(new_n108_), .b(new_n94_), .c(new_n107_), .d(new_n55_), .O(new_n109_));
  ...
  nand3  g062(.a(new_n113_), .b(new_n111_), .c(x08), .O(z06));
  nand2  g063(.a(new_n109_), .b(x26), .O(new_n115_));
  nor3   g064(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n94_), .c(new_n73_), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(x16), .O(new_n119_));
  nand3  g068(.a(new_n119_), .b(new_n53_), .c(x08), .O(z07));
  nor2   g069(.a(x27), .b(x26), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n97_), .c(new_n103_), .O(new_n122_));
  ...
  nor3   g074(.a(new_n125_), .b(x18), .c(new_n52_), .O(new_n126_));
  oai21  g075(.a(new_n124_), .b(new_n61_), .c(new_n126_), .O(z08));
  oai21  g076(.a(new_n122_), .b(new_n84_), .c(x28), .O(new_n128_));
  ...
  nand2  g083(.a(new_n134_), .b(new_n53_), .O(z09));
  inv1   g084(.a(x27), .O(new_n136_));
  nor2   g085(.a(x26), .b(x25), .O(new_n137_));
  nor2   g086(.a(x29), .b(x28), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n104_), .O(new_n139_));
  nor2   g088(.a(new_n139_), .b(new_n95_), .O(new_n140_));
  aoi21  g089(.a(new_n131_), .b(x29), .c(new_n140_), .O(new_n141_));
  nor2   g090(.a(x16), .b(x05), .O(new_n142_));
  nor3   g091(.a(new_n142_), .b(x18), .c(new_n52_), .O(new_n143_));
  oai21  g092(.a(new_n141_), .b(new_n61_), .c(new_n143_), .O(z10));
  oai21  g093(.a(new_n139_), .b(new_n95_), .c(x30), .O(new_n145_));
  ...
  aoi21  g097(.a(new_n148_), .b(new_n145_), .c(new_n61_), .O(new_n149_));
  nor2   g098(.a(x16), .b(x04), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n149_), .c(x08), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n53_), .O(z11));
  nand2  g101(.a(new_n148_), .b(x31), .O(new_n153_));
  nor2   g102(.a(x31), .b(x30), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n138_), .c(new_n121_), .d(new_n103_), .O(new_n155_));
  or2    g104(.a(new_n155_), .b(new_n98_), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(x16), .O(new_n158_));
  nor2   g107(.a(x16), .b(x03), .O(new_n159_));
  nor3   g108(.a(new_n159_), .b(x18), .c(new_n52_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n158_), .O(z12));
  oai21  g110(.a(new_n155_), .b(new_n98_), .c(x32), .O(new_n162_));
  nand2  g111(.a(new_n146_), .b(new_n137_), .O(new_n163_));
  inv1   g112(.a(new_n163_), .O(new_n164_));
  inv1   g113(.a(x31), .O(new_n165_));
  inv1   g114(.a(x32), .O(new_n166_));
  nand3  g115(.a(new_n147_), .b(new_n166_), .c(new_n165_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nand3  g117(.a(new_n168_), .b(new_n164_), .c(new_n106_), .O(new_n169_));
  aoi21  g118(.a(new_n169_), .b(new_n162_), .c(new_n61_), .O(new_n170_));
  nor2   g119(.a(x16), .b(x02), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n170_), .c(x08), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n53_), .O(z13));
  nand2  g122(.a(new_n169_), .b(x33), .O(new_n174_));
  nor2   g123(.a(x33), .b(x32), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n154_), .c(new_n138_), .d(new_n121_), .O(new_n176_));
  or2    g125(.a(new_n176_), .b(new_n109_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n174_), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(x16), .O(new_n179_));
  nor2   g128(.a(x16), .b(x01), .O(new_n180_));
  nor3   g129(.a(new_n180_), .b(x18), .c(new_n52_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n179_), .O(z14));
  oai21  g131(.a(new_n176_), .b(new_n109_), .c(x34), .O(new_n183_));
  nand4  g132(.a(new_n103_), .b(new_n104_), .c(new_n86_), .d(new_n85_), .O(new_n184_));
  nor2   g133(.a(new_n184_), .b(new_n72_), .O(new_n185_));
  nand2  g134(.a(new_n138_), .b(new_n121_), .O(new_n186_));
  inv1   g135(.a(new_n186_), .O(new_n187_));
  inv1   g136(.a(x30), .O(new_n188_));
  nand2  g137(.a(new_n165_), .b(new_n188_), .O(new_n189_));
  ...
  nand3  g142(.a(new_n193_), .b(new_n187_), .c(new_n185_), .O(new_n194_));
  aoi21  g143(.a(new_n194_), .b(new_n183_), .c(new_n61_), .O(new_n195_));
  nor2   g144(.a(x16), .b(x00), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n195_), .c(x08), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(new_n53_), .O(z15));
endmodule
