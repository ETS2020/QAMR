...
module FAU ( 
  ...
  nand4  g19(.a(new_n70_), .b(new_n64_), .c(new_n53_), .d(new_n52_), .O(new_n71_));
  inv1   g20(.a(new_n71_), .O(new_n72_));
  aoi21  g21(.a(new_n65_), .b(x21), .c(new_n72_), .O(new_n73_));
  nor2   g22(.a(x16), .b(x13), .O(new_n74_));
  nor2   g23(.a(new_n74_), .b(new_n60_), .O(new_n75_));
  oai21  g24(.a(new_n73_), .b(new_n58_), .c(new_n75_), .O(z02));
  nand2  g25(.a(new_n71_), .b(x22), .O(new_n77_));
  nor2   g26(.a(x22), .b(x21), .O(new_n78_));
  nand3  g27(.a(new_n78_), .b(new_n55_), .c(new_n64_), .O(new_n79_));
  aoi21  g28(.a(new_n79_), .b(new_n77_), .c(new_n58_), .O(new_n80_));
  nor2   g29(.a(x16), .b(x12), .O(new_n81_));
  oai21  g30(.a(new_n81_), .b(new_n80_), .c(x23), .O(new_n82_));
  nand2  g31(.a(new_n82_), .b(new_n59_), .O(z03));
  inv1   g32(.a(x23), .O(new_n84_));
  nor2   g33(.a(x16), .b(x11), .O(new_n85_));
  aoi21  g34(.a(new_n79_), .b(x16), .c(new_n85_), .O(new_n86_));
  oai21  g35(.a(new_n86_), .b(new_n84_), .c(new_n59_), .O(z04));
  inv1   g36(.a(new_n60_), .O(new_n88_));
  ...
  nand3  g44(.a(new_n95_), .b(new_n93_), .c(new_n88_), .O(z06));
  ...
  nand2  g49(.a(x27), .b(x16), .O(new_n101_));
  inv1   g50(.a(x07), .O(new_n102_));
  nand2  g51(.a(new_n58_), .b(new_n102_), .O(new_n103_));
  nand3  g52(.a(new_n103_), .b(new_n101_), .c(new_n88_), .O(z08));
  nor2   g53(.a(x16), .b(x06), .O(new_n105_));
  and2   g54(.a(x28), .b(x16), .O(new_n106_));
  oai21  g55(.a(new_n106_), .b(new_n105_), .c(x23), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(new_n59_), .O(z09));
