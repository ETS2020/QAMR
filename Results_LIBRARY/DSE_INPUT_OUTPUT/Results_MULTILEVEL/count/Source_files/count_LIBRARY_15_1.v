...
module FAU ( 
  ...
  nand4  g040(.a(new_n91_), .b(new_n78_), .c(new_n85_), .d(new_n52_), .O(new_n92_));
  ...
  nand4  g057(.a(new_n108_), .b(new_n86_), .c(new_n107_), .d(new_n55_), .O(new_n109_));
  nand2  g058(.a(new_n109_), .b(x26), .O(new_n110_));
  nor3   g059(.a(x26), .b(x25), .c(x24), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(new_n86_), .c(new_n70_), .O(new_n112_));
  nand3  g061(.a(new_n112_), .b(new_n110_), .c(new_n77_), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(x16), .O(new_n114_));
  inv1   g063(.a(x08), .O(new_n115_));
  nand2  g064(.a(new_n82_), .b(new_n115_), .O(new_n116_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n99_), .O(new_n138_));
  nor2   g087(.a(new_n138_), .b(new_n87_), .O(new_n139_));
  aoi21  g088(.a(new_n129_), .b(x29), .c(new_n139_), .O(new_n140_));
  ...
  nand3  g093(.a(new_n98_), .b(new_n75_), .c(new_n68_), .O(new_n145_));
  nor2   g094(.a(new_n145_), .b(new_n62_), .O(new_n146_));
  nor2   g095(.a(x28), .b(x27), .O(new_n147_));
  nor2   g096(.a(x30), .b(x29), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  inv1   g098(.a(new_n149_), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n111_), .c(new_n146_), .O(new_n151_));
  nand3  g100(.a(new_n151_), .b(new_n144_), .c(new_n77_), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(x16), .O(new_n153_));
  inv1   g102(.a(x04), .O(new_n154_));
  nand2  g103(.a(new_n82_), .b(new_n154_), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(new_n153_), .O(z11));
  nor2   g105(.a(x31), .b(x30), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n137_), .c(new_n118_), .d(new_n100_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n92_), .c(new_n77_), .O(new_n159_));
  aoi21  g108(.a(new_n151_), .b(x31), .c(new_n159_), .O(new_n160_));
  inv1   g109(.a(x03), .O(new_n161_));
  nand2  g110(.a(new_n82_), .b(new_n161_), .O(new_n162_));
  oai21  g111(.a(new_n160_), .b(new_n58_), .c(new_n162_), .O(z12));
  oai21  g112(.a(new_n158_), .b(new_n92_), .c(x32), .O(new_n164_));
  nor2   g113(.a(x32), .b(x31), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n148_), .c(new_n147_), .d(new_n136_), .O(new_n166_));
  inv1   g115(.a(new_n166_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n93_), .O(new_n168_));
  nand3  g117(.a(new_n168_), .b(new_n164_), .c(new_n77_), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(x16), .O(new_n170_));
  inv1   g119(.a(x02), .O(new_n171_));
  nand2  g120(.a(new_n82_), .b(new_n171_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n170_), .O(z13));
  inv1   g122(.a(x33), .O(new_n174_));
  aoi21  g123(.a(new_n167_), .b(new_n93_), .c(new_n174_), .O(new_n175_));
  nor2   g124(.a(x33), .b(x32), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n157_), .c(new_n137_), .d(new_n118_), .O(new_n177_));
  nor2   g126(.a(new_n177_), .b(new_n109_), .O(new_n178_));
  ...
  oai21  g131(.a(new_n177_), .b(new_n109_), .c(x34), .O(new_n183_));
  nand2  g132(.a(new_n137_), .b(new_n118_), .O(new_n184_));
  ...
  nand3  g141(.a(new_n192_), .b(new_n185_), .c(new_n102_), .O(new_n193_));
  nand3  g142(.a(new_n193_), .b(new_n183_), .c(new_n77_), .O(new_n194_));
