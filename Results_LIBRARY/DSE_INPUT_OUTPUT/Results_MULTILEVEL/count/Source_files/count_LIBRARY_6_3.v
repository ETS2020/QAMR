...
module FAU ( 
  ...
  aoi22  g033(.a(new_n84_), .b(new_n63_), .c(new_n79_), .d(x23), .O(new_n85_));
  ...
  nand4  g040(.a(new_n91_), .b(new_n78_), .c(new_n68_), .d(new_n52_), .O(new_n92_));
  ...
  inv1   g067(.a(x18), .O(new_n119_));
  oai21  g068(.a(new_n111_), .b(new_n76_), .c(x27), .O(new_n120_));
  nor2   g069(.a(x27), .b(x26), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n91_), .c(new_n100_), .O(new_n122_));
  oai21  g071(.a(new_n122_), .b(new_n79_), .c(new_n120_), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n119_), .c(x16), .O(new_n124_));
  nand2  g073(.a(new_n124_), .b(new_n118_), .O(z08));
  ...
  nand4  g079(.a(new_n130_), .b(new_n108_), .c(new_n129_), .d(new_n99_), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n79_), .c(new_n128_), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n119_), .c(x16), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n127_), .O(z09));
  inv1   g083(.a(x05), .O(new_n135_));
  oai21  g084(.a(x18), .b(new_n135_), .c(new_n58_), .O(new_n136_));
  ...
  nand4  g088(.a(new_n139_), .b(new_n138_), .c(new_n84_), .d(new_n63_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g090(.a(new_n141_), .b(new_n119_), .c(x16), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(new_n136_), .O(z10));
  nand4  g092(.a(new_n107_), .b(new_n68_), .c(new_n75_), .d(new_n52_), .O(new_n144_));
  nor2   g093(.a(x30), .b(x29), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n130_), .c(new_n110_), .d(new_n89_), .O(new_n146_));
  nor2   g095(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  aoi21  g096(.a(new_n140_), .b(x30), .c(new_n147_), .O(new_n148_));
  ...
  oai21  g100(.a(new_n146_), .b(new_n144_), .c(x31), .O(new_n152_));
  ...
  nand3  g106(.a(new_n157_), .b(new_n153_), .c(new_n93_), .O(new_n158_));
  ...
  nand4  g112(.a(new_n155_), .b(new_n154_), .c(new_n121_), .d(new_n100_), .O(new_n164_));
  oai21  g113(.a(new_n164_), .b(new_n92_), .c(x32), .O(new_n165_));
  nor2   g114(.a(x32), .b(x31), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n145_), .c(new_n130_), .d(new_n110_), .O(new_n167_));
  ...
  oai21  g123(.a(new_n167_), .b(new_n92_), .c(x33), .O(new_n175_));
  nor2   g124(.a(x33), .b(x32), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n155_), .c(new_n154_), .d(new_n121_), .O(new_n177_));
  ...
  oai21  g133(.a(new_n177_), .b(new_n109_), .c(x34), .O(new_n185_));
  nand2  g134(.a(new_n154_), .b(new_n121_), .O(new_n186_));
  ...
  nand3  g144(.a(new_n195_), .b(new_n187_), .c(new_n102_), .O(new_n196_));
