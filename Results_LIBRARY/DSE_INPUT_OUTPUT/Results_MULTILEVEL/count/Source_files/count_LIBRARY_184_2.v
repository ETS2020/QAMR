...
module FAU ( 
  ...
  nand2  g031(.a(new_n82_), .b(new_n74_), .O(z03));
  ...
  nand2  g050(.a(new_n101_), .b(new_n74_), .O(z05));
  ...
  nand3  g062(.a(new_n113_), .b(new_n93_), .c(new_n112_), .O(new_n114_));
  ...
  nand4  g096(.a(new_n147_), .b(new_n146_), .c(new_n113_), .d(new_n87_), .O(new_n148_));
  aoi21  g097(.a(new_n148_), .b(new_n145_), .c(new_n58_), .O(new_n149_));
  nor2   g098(.a(x16), .b(x04), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n149_), .c(new_n76_), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n74_), .O(z11));
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n137_), .d(new_n103_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n94_), .c(x31), .O(new_n154_));
  nand2  g103(.a(new_n97_), .b(new_n96_), .O(new_n155_));
  inv1   g104(.a(new_n155_), .O(new_n156_));
  nor2   g105(.a(x31), .b(x30), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n138_), .O(new_n158_));
  inv1   g107(.a(new_n158_), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n120_), .c(new_n156_), .d(new_n64_), .O(new_n160_));
  aoi21  g109(.a(new_n160_), .b(new_n154_), .c(new_n58_), .O(new_n161_));
  nor2   g110(.a(x16), .b(x03), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n161_), .c(new_n76_), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n74_), .O(z12));
  nand4  g113(.a(new_n156_), .b(new_n92_), .c(new_n52_), .d(x16), .O(new_n165_));
  nor2   g114(.a(x32), .b(x31), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n147_), .c(new_n146_), .d(new_n137_), .O(new_n167_));
  oai22  g116(.a(new_n167_), .b(new_n165_), .c(x16), .d(x02), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n76_), .O(new_n169_));
  nand2  g118(.a(new_n160_), .b(x16), .O(new_n170_));
  ...
  oai21  g123(.a(new_n174_), .b(new_n58_), .c(new_n76_), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(x32), .O(new_n176_));
  nor2   g125(.a(x27), .b(x26), .O(new_n177_));
  nand4  g126(.a(new_n157_), .b(new_n138_), .c(new_n177_), .d(new_n104_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n98_), .c(x33), .O(new_n179_));
  nand2  g128(.a(new_n138_), .b(new_n177_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  inv1   g130(.a(x32), .O(new_n182_));
  nand3  g131(.a(new_n157_), .b(new_n174_), .c(new_n182_), .O(new_n183_));
  inv1   g132(.a(new_n183_), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n181_), .c(new_n106_), .O(new_n185_));
  aoi21  g134(.a(new_n185_), .b(new_n179_), .c(new_n58_), .O(new_n186_));
  nor2   g135(.a(x16), .b(x01), .O(new_n187_));
  oai21  g136(.a(new_n187_), .b(new_n186_), .c(new_n76_), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(new_n176_), .O(z14));
  inv1   g138(.a(x34), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n58_), .c(new_n76_), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(x32), .O(new_n192_));
  nor2   g141(.a(x33), .b(x31), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n147_), .c(new_n146_), .d(new_n137_), .O(new_n194_));
  oai21  g143(.a(new_n194_), .b(new_n98_), .c(x34), .O(new_n195_));
  inv1   g144(.a(x30), .O(new_n196_));
  inv1   g145(.a(x31), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  nand3  g147(.a(new_n190_), .b(new_n174_), .c(new_n182_), .O(new_n199_));
  nor2   g148(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  nand3  g149(.a(new_n200_), .b(new_n181_), .c(new_n106_), .O(new_n201_));
  aoi21  g150(.a(new_n201_), .b(new_n195_), .c(new_n58_), .O(new_n202_));
  nor2   g151(.a(x16), .b(x00), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(new_n202_), .c(new_n76_), .O(new_n204_));
  nand2  g153(.a(new_n204_), .b(new_n192_), .O(z15));
endmodule
