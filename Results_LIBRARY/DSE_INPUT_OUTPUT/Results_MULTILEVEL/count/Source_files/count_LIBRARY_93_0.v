...
module FAU ( 
  ...
  nor2   g01(.a(new_n52_), .b(x18), .O(new_n53_));
  nand2  g02(.a(x17), .b(x16), .O(new_n54_));
  ...
  nand3  g18(.a(new_n69_), .b(new_n67_), .c(new_n53_), .O(z03));
  ...
  nand2  g47(.a(new_n98_), .b(new_n71_), .O(z10));
  ...
  nand3  g63(.a(new_n114_), .b(new_n112_), .c(new_n53_), .O(z14));
