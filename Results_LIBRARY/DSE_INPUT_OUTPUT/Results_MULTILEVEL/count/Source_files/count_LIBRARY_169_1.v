...
module FAU ( 
  ...
  nor2   g029(.a(new_n80_), .b(new_n67_), .O(new_n81_));
  oai21  g030(.a(new_n79_), .b(new_n58_), .c(new_n81_), .O(z03));
  inv1   g031(.a(x18), .O(new_n83_));
  inv1   g032(.a(x27), .O(new_n84_));
  inv1   g033(.a(x21), .O(new_n85_));
  inv1   g034(.a(x22), .O(new_n86_));
  nand4  g035(.a(new_n55_), .b(new_n86_), .c(new_n85_), .d(new_n62_), .O(new_n87_));
  ...
  nand2  g043(.a(new_n94_), .b(new_n83_), .O(z04));
  inv1   g044(.a(x24), .O(new_n96_));
  inv1   g045(.a(x23), .O(new_n97_));
  nand3  g046(.a(new_n97_), .b(new_n86_), .c(new_n85_), .O(new_n98_));
  nor2   g047(.a(new_n98_), .b(new_n64_), .O(new_n99_));
  nor2   g048(.a(new_n99_), .b(new_n96_), .O(new_n100_));
  nand4  g049(.a(new_n96_), .b(new_n97_), .c(new_n86_), .d(new_n85_), .O(new_n101_));
  ...
  nand4  g057(.a(new_n108_), .b(new_n90_), .c(new_n71_), .d(new_n55_), .O(new_n109_));
  ...
  nand3  g065(.a(new_n116_), .b(new_n90_), .c(new_n96_), .O(new_n117_));
  inv1   g066(.a(new_n117_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(new_n73_), .O(new_n119_));
  aoi21  g068(.a(new_n119_), .b(new_n115_), .c(new_n58_), .O(new_n120_));
  nor2   g069(.a(x16), .b(x08), .O(new_n121_));
  oai21  g070(.a(new_n121_), .b(new_n120_), .c(new_n84_), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n83_), .O(z07));
  inv1   g072(.a(x07), .O(new_n124_));
  nand2  g073(.a(new_n58_), .b(new_n124_), .O(new_n125_));
  nor2   g074(.a(x17), .b(new_n58_), .O(new_n126_));
  nand4  g075(.a(new_n126_), .b(new_n118_), .c(new_n71_), .d(new_n53_), .O(new_n127_));
  nand3  g076(.a(new_n127_), .b(new_n125_), .c(new_n60_), .O(z08));
  oai21  g077(.a(new_n117_), .b(new_n72_), .c(x28), .O(new_n129_));
  nor2   g078(.a(x24), .b(x23), .O(new_n130_));
  nor3   g079(.a(x28), .b(x26), .c(x25), .O(new_n131_));
  ...
  oai21  g083(.a(new_n134_), .b(new_n133_), .c(new_n84_), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n83_), .O(z09));
  nor2   g085(.a(x28), .b(x26), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n130_), .c(new_n107_), .O(new_n138_));
  oai21  g087(.a(new_n138_), .b(new_n87_), .c(x29), .O(new_n139_));
  nor3   g088(.a(x25), .b(x24), .c(x23), .O(new_n140_));
  nor3   g089(.a(x29), .b(x28), .c(x26), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n140_), .c(new_n78_), .d(new_n55_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n139_), .c(new_n58_), .O(new_n143_));
  nor2   g092(.a(x16), .b(x05), .O(new_n144_));
  oai21  g093(.a(new_n144_), .b(new_n143_), .c(new_n84_), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n83_), .O(z10));
  inv1   g095(.a(x28), .O(new_n147_));
  nor2   g096(.a(x30), .b(x29), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n116_), .c(new_n147_), .d(new_n96_), .O(new_n149_));
  ...
  oai21  g103(.a(new_n149_), .b(new_n91_), .c(x31), .O(new_n155_));
  ...
  nand3  g109(.a(new_n160_), .b(new_n156_), .c(new_n99_), .O(new_n161_));
  aoi21  g110(.a(new_n161_), .b(new_n155_), .c(new_n58_), .O(new_n162_));
  nor2   g111(.a(x16), .b(x03), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n162_), .c(new_n84_), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(new_n83_), .O(z12));
  nand4  g114(.a(new_n158_), .b(new_n157_), .c(new_n116_), .d(new_n96_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n91_), .c(x32), .O(new_n167_));
  inv1   g116(.a(new_n101_), .O(new_n168_));
  ...
  nand4  g123(.a(new_n174_), .b(new_n131_), .c(new_n168_), .d(new_n65_), .O(new_n175_));
  aoi21  g124(.a(new_n175_), .b(new_n167_), .c(new_n58_), .O(new_n176_));
  nor2   g125(.a(x16), .b(x02), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n176_), .c(new_n84_), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(new_n83_), .O(z13));
  ...
  nand4  g132(.a(new_n183_), .b(new_n157_), .c(new_n116_), .d(new_n102_), .O(new_n184_));
  ...
  nand2  g138(.a(new_n168_), .b(new_n65_), .O(new_n190_));
  nand4  g139(.a(new_n181_), .b(new_n158_), .c(new_n157_), .d(new_n116_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n190_), .c(x34), .O(new_n192_));
  nand2  g141(.a(new_n148_), .b(new_n137_), .O(new_n193_));
  nor2   g142(.a(x34), .b(x33), .O(new_n194_));
  nand3  g143(.a(new_n194_), .b(new_n172_), .c(new_n171_), .O(new_n195_));
  nor2   g144(.a(new_n195_), .b(new_n193_), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n108_), .c(new_n90_), .d(new_n73_), .O(new_n197_));
