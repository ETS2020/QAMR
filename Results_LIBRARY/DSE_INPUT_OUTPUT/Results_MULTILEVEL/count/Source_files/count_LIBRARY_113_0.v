...
module FAU ( 
  ...
  oai21  g038(.a(new_n89_), .b(new_n88_), .c(x15), .O(new_n90_));
  nand2  g039(.a(new_n90_), .b(new_n52_), .O(z04));
  inv1   g040(.a(x24), .O(new_n92_));
  aoi21  g041(.a(new_n86_), .b(new_n85_), .c(new_n92_), .O(new_n93_));
  ...
  nor3   g047(.a(new_n98_), .b(x18), .c(new_n69_), .O(new_n99_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n102_), .c(new_n71_), .d(new_n54_), .O(new_n104_));
  ...
  nand4  g070(.a(new_n121_), .b(new_n94_), .c(new_n120_), .d(new_n54_), .O(new_n122_));
  ...
  nand3  g076(.a(new_n127_), .b(new_n94_), .c(new_n101_), .O(new_n128_));
  oai21  g077(.a(new_n128_), .b(new_n79_), .c(x28), .O(new_n129_));
  nor3   g078(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nor3   g079(.a(x28), .b(x27), .c(x26), .O(new_n131_));
  nand4  g080(.a(new_n131_), .b(new_n130_), .c(new_n120_), .d(new_n54_), .O(new_n132_));
  aoi21  g081(.a(new_n132_), .b(new_n129_), .c(new_n59_), .O(new_n133_));
  nor2   g082(.a(x16), .b(x06), .O(new_n134_));
  oai21  g083(.a(new_n134_), .b(new_n133_), .c(x15), .O(new_n135_));
  ...
  nand4  g088(.a(new_n139_), .b(new_n103_), .c(new_n138_), .d(new_n137_), .O(new_n140_));
  oai21  g089(.a(new_n140_), .b(new_n79_), .c(x29), .O(new_n141_));
  nor3   g090(.a(x29), .b(x28), .c(x27), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n111_), .c(new_n86_), .d(new_n85_), .O(new_n143_));
  aoi21  g092(.a(new_n143_), .b(new_n141_), .c(new_n59_), .O(new_n144_));
  nor2   g093(.a(x16), .b(x05), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n144_), .c(x15), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n52_), .O(z10));
  nor2   g096(.a(x30), .b(x29), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n139_), .c(new_n111_), .O(new_n149_));
  ...
  nor3   g101(.a(new_n152_), .b(x18), .c(new_n69_), .O(new_n153_));
  oai21  g102(.a(new_n151_), .b(new_n59_), .c(new_n153_), .O(z11));
  oai21  g103(.a(new_n149_), .b(new_n87_), .c(x31), .O(new_n155_));
  nor2   g104(.a(x29), .b(x28), .O(new_n156_));
  nor2   g105(.a(x31), .b(x30), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n156_), .c(new_n121_), .d(new_n96_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(x16), .O(new_n160_));
  inv1   g109(.a(x03), .O(new_n161_));
  aoi21  g110(.a(new_n59_), .b(new_n161_), .c(x18), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n160_), .c(x15), .O(z12));
  nand3  g112(.a(new_n94_), .b(new_n78_), .c(new_n85_), .O(new_n164_));
  nand3  g113(.a(new_n157_), .b(new_n156_), .c(new_n121_), .O(new_n165_));
  ...
  nand4  g118(.a(new_n169_), .b(new_n139_), .c(new_n117_), .d(new_n96_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n166_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(x16), .O(new_n172_));
  inv1   g121(.a(x02), .O(new_n173_));
  aoi21  g122(.a(new_n59_), .b(new_n173_), .c(x18), .O(new_n174_));
  nand3  g123(.a(new_n174_), .b(new_n172_), .c(x15), .O(z13));
  nand4  g124(.a(new_n167_), .b(new_n148_), .c(new_n139_), .d(new_n117_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n164_), .c(x33), .O(new_n177_));
  nor2   g126(.a(x33), .b(x32), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n157_), .c(new_n156_), .d(new_n127_), .O(new_n179_));
  or2    g128(.a(new_n179_), .b(new_n104_), .O(new_n180_));
  ...
  nand3  g133(.a(new_n184_), .b(new_n182_), .c(x15), .O(z14));
  oai21  g134(.a(new_n179_), .b(new_n104_), .c(x34), .O(new_n186_));
  nand2  g135(.a(new_n156_), .b(new_n127_), .O(new_n187_));
  inv1   g136(.a(new_n187_), .O(new_n188_));
  nor3   g137(.a(x34), .b(x33), .c(x32), .O(new_n189_));
  nand3  g138(.a(new_n189_), .b(new_n188_), .c(new_n157_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n104_), .c(new_n186_), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(x16), .O(new_n192_));
  inv1   g141(.a(x00), .O(new_n193_));
  aoi21  g142(.a(new_n59_), .b(new_n193_), .c(x18), .O(new_n194_));
  nand3  g143(.a(new_n194_), .b(new_n192_), .c(x15), .O(z15));
endmodule
