...
module FAU ( 
  ...
  nand2  g012(.a(new_n56_), .b(new_n63_), .O(new_n64_));
  nand3  g013(.a(new_n64_), .b(new_n62_), .c(new_n52_), .O(z01));
  inv1   g014(.a(x21), .O(new_n66_));
  nor2   g015(.a(new_n61_), .b(new_n66_), .O(new_n67_));
  nand3  g016(.a(new_n66_), .b(new_n59_), .c(new_n53_), .O(new_n68_));
  ...
  nand2  g022(.a(new_n73_), .b(new_n70_), .O(z02));
  inv1   g023(.a(x18), .O(new_n75_));
  inv1   g024(.a(x22), .O(new_n76_));
  nand3  g025(.a(new_n61_), .b(new_n76_), .c(new_n66_), .O(new_n77_));
  ...
  oai21  g029(.a(new_n80_), .b(x17), .c(new_n75_), .O(z03));
  inv1   g030(.a(x17), .O(new_n82_));
  nand2  g031(.a(new_n77_), .b(x23), .O(new_n83_));
  nor2   g032(.a(x23), .b(x22), .O(new_n84_));
  nand3  g033(.a(new_n84_), .b(new_n61_), .c(new_n66_), .O(new_n85_));
  aoi21  g034(.a(new_n85_), .b(new_n83_), .c(new_n56_), .O(new_n86_));
  nor2   g035(.a(x16), .b(x11), .O(new_n87_));
  oai21  g036(.a(new_n87_), .b(new_n86_), .c(new_n82_), .O(new_n88_));
  nand2  g037(.a(new_n88_), .b(new_n75_), .O(z04));
  nand2  g038(.a(new_n85_), .b(x24), .O(new_n90_));
  nor2   g039(.a(x21), .b(x20), .O(new_n91_));
  nor2   g040(.a(x24), .b(x23), .O(new_n92_));
  nand4  g041(.a(new_n92_), .b(new_n91_), .c(new_n76_), .d(new_n53_), .O(new_n93_));
  aoi21  g042(.a(new_n93_), .b(new_n90_), .c(new_n56_), .O(new_n94_));
  nor2   g043(.a(x16), .b(x10), .O(new_n95_));
  oai21  g044(.a(new_n95_), .b(new_n94_), .c(new_n82_), .O(new_n96_));
  nand2  g045(.a(new_n96_), .b(new_n75_), .O(z05));
  ...
  aoi22  g051(.a(new_n102_), .b(new_n69_), .c(new_n93_), .d(x25), .O(new_n103_));
  ...
  nand4  g056(.a(new_n107_), .b(new_n84_), .c(new_n91_), .d(new_n53_), .O(new_n108_));
  nand2  g057(.a(new_n108_), .b(x26), .O(new_n109_));
  inv1   g058(.a(new_n77_), .O(new_n110_));
  ...
  aoi21  g063(.a(new_n114_), .b(new_n109_), .c(new_n56_), .O(new_n115_));
  nor2   g064(.a(x16), .b(x08), .O(new_n116_));
  oai21  g065(.a(new_n116_), .b(new_n115_), .c(new_n82_), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n75_), .O(z07));
  nor2   g067(.a(x27), .b(x26), .O(new_n119_));
  nand3  g068(.a(new_n119_), .b(new_n92_), .c(new_n100_), .O(new_n120_));
  ...
  oai21  g074(.a(new_n120_), .b(new_n77_), .c(x28), .O(new_n126_));
  nor3   g075(.a(x23), .b(x22), .c(x21), .O(new_n127_));
  nor3   g076(.a(x28), .b(x27), .c(x26), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n107_), .c(new_n127_), .d(new_n61_), .O(new_n129_));
  aoi21  g078(.a(new_n129_), .b(new_n126_), .c(new_n56_), .O(new_n130_));
  nor2   g079(.a(x16), .b(x06), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n130_), .c(new_n82_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n75_), .O(z09));
  inv1   g082(.a(x26), .O(new_n134_));
  nor2   g083(.a(x28), .b(x27), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n107_), .c(new_n134_), .O(new_n136_));
  ...
  nand4  g088(.a(new_n139_), .b(new_n138_), .c(new_n127_), .d(new_n61_), .O(new_n140_));
  aoi21  g089(.a(new_n140_), .b(new_n137_), .c(new_n56_), .O(new_n141_));
  nor2   g090(.a(x16), .b(x05), .O(new_n142_));
  oai21  g091(.a(new_n142_), .b(new_n141_), .c(new_n82_), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n75_), .O(z10));
  inv1   g093(.a(x27), .O(new_n145_));
  nor2   g094(.a(x29), .b(x28), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n111_), .c(new_n145_), .d(new_n99_), .O(new_n147_));
  oai21  g096(.a(new_n147_), .b(new_n85_), .c(x30), .O(new_n148_));
  nand3  g097(.a(new_n99_), .b(new_n98_), .c(new_n76_), .O(new_n149_));
  ...
  aoi21  g102(.a(new_n153_), .b(new_n148_), .c(new_n56_), .O(new_n154_));
  nor2   g103(.a(x16), .b(x04), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n154_), .c(new_n82_), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n75_), .O(z11));
  inv1   g106(.a(x28), .O(new_n158_));
  nor2   g107(.a(x30), .b(x29), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n119_), .c(new_n158_), .d(new_n100_), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n93_), .c(x31), .O(new_n161_));
  inv1   g110(.a(x30), .O(new_n162_));
  inv1   g111(.a(x31), .O(new_n163_));
  nand3  g112(.a(new_n146_), .b(new_n163_), .c(new_n162_), .O(new_n164_));
  inv1   g113(.a(new_n164_), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n151_), .c(new_n150_), .O(new_n166_));
  aoi21  g115(.a(new_n166_), .b(new_n161_), .c(new_n56_), .O(new_n167_));
  nor2   g116(.a(x16), .b(x03), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n167_), .c(new_n82_), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n75_), .O(z12));
  nand2  g119(.a(new_n166_), .b(x32), .O(new_n171_));
  nor2   g120(.a(x32), .b(x31), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n159_), .c(new_n135_), .d(new_n134_), .O(new_n173_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n158_), .c(new_n145_), .d(new_n134_), .O(new_n182_));
  inv1   g131(.a(new_n182_), .O(new_n183_));
  inv1   g132(.a(x32), .O(new_n184_));
  inv1   g133(.a(x33), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n184_), .c(new_n163_), .d(new_n162_), .O(new_n186_));
  inv1   g135(.a(new_n186_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n183_), .c(new_n102_), .d(new_n69_), .O(new_n188_));
  aoi21  g137(.a(new_n188_), .b(new_n180_), .c(new_n56_), .O(new_n189_));
  nor2   g138(.a(x16), .b(x01), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n189_), .c(new_n82_), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(new_n75_), .O(z14));
  nand2  g141(.a(new_n188_), .b(x34), .O(new_n193_));
  nand2  g142(.a(new_n159_), .b(new_n135_), .O(new_n194_));
