...
module FAU ( 
  ...
  nand3  g19(.a(new_n70_), .b(new_n67_), .c(new_n66_), .O(z03));
  nand2  g20(.a(x23), .b(x16), .O(new_n72_));
  inv1   g21(.a(x11), .O(new_n73_));
  nand2  g22(.a(new_n69_), .b(new_n73_), .O(new_n74_));
  nand3  g23(.a(new_n74_), .b(new_n72_), .c(new_n66_), .O(z04));
  ...
  oai21  g30(.a(new_n81_), .b(new_n80_), .c(x17), .O(new_n82_));
  ...
  nand2  g38(.a(new_n69_), .b(new_n89_), .O(new_n90_));
  nand3  g39(.a(new_n90_), .b(new_n88_), .c(new_n66_), .O(z08));
  ...
  nand2  g46(.a(new_n69_), .b(new_n97_), .O(new_n98_));
  nand3  g47(.a(new_n98_), .b(new_n96_), .c(new_n66_), .O(z10));
  nand2  g48(.a(x30), .b(x16), .O(new_n100_));
  inv1   g49(.a(x04), .O(new_n101_));
  nand2  g50(.a(new_n69_), .b(new_n101_), .O(new_n102_));
  nand3  g51(.a(new_n102_), .b(new_n100_), .c(new_n66_), .O(z11));
  ...
  nand2  g58(.a(new_n69_), .b(new_n109_), .O(new_n110_));
  nand3  g59(.a(new_n110_), .b(new_n108_), .c(new_n66_), .O(z13));
  nand2  g60(.a(x33), .b(x16), .O(new_n112_));
  inv1   g61(.a(x01), .O(new_n113_));
  nand2  g62(.a(new_n69_), .b(new_n113_), .O(new_n114_));
  nand3  g63(.a(new_n114_), .b(new_n112_), .c(new_n66_), .O(z14));
  nand2  g64(.a(x34), .b(x16), .O(new_n116_));
  inv1   g65(.a(x00), .O(new_n117_));
  nand2  g66(.a(new_n69_), .b(new_n117_), .O(new_n118_));
  nand3  g67(.a(new_n118_), .b(new_n116_), .c(new_n66_), .O(z15));
endmodule
