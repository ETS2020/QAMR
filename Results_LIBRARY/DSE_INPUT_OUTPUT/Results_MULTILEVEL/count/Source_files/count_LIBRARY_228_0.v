...
module FAU ( 
  ...
  nand3  g016(.a(new_n67_), .b(new_n65_), .c(x08), .O(z01));
  ...
  nor3   g039(.a(new_n90_), .b(x18), .c(new_n73_), .O(new_n91_));
  ...
  nand4  g044(.a(new_n95_), .b(new_n79_), .c(new_n94_), .d(new_n52_), .O(new_n96_));
  ...
  nand3  g049(.a(new_n100_), .b(new_n98_), .c(x08), .O(z05));
  ...
  nor3   g055(.a(new_n106_), .b(x18), .c(new_n73_), .O(new_n107_));
  ...
  nand3  g060(.a(new_n111_), .b(new_n110_), .c(new_n93_), .O(new_n112_));
  oai22  g061(.a(new_n112_), .b(new_n70_), .c(new_n104_), .d(new_n109_), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(x16), .O(new_n114_));
  nand3  g063(.a(new_n114_), .b(new_n77_), .c(x08), .O(z07));
  oai21  g064(.a(new_n112_), .b(new_n70_), .c(x27), .O(new_n116_));
  nor3   g065(.a(x22), .b(x21), .c(x20), .O(new_n117_));
  nor3   g066(.a(x27), .b(x26), .c(x25), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n95_), .c(new_n117_), .d(new_n55_), .O(new_n119_));
  ...
  nand2  g071(.a(new_n122_), .b(new_n77_), .O(z08));
  nor2   g072(.a(x27), .b(x26), .O(new_n124_));
  nand3  g073(.a(new_n124_), .b(new_n95_), .c(new_n102_), .O(new_n125_));
  oai21  g074(.a(new_n125_), .b(new_n80_), .c(x28), .O(new_n126_));
  nor3   g075(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nor3   g076(.a(x28), .b(x27), .c(x26), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n127_), .c(new_n117_), .d(new_n55_), .O(new_n129_));
  ...
  nand2  g081(.a(new_n132_), .b(new_n77_), .O(z09));
  nor2   g082(.a(x25), .b(x24), .O(new_n134_));
  nor2   g083(.a(x28), .b(x27), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n134_), .c(new_n109_), .d(new_n86_), .O(new_n136_));
  oai21  g085(.a(new_n136_), .b(new_n80_), .c(x29), .O(new_n137_));
  ...
  oai21  g091(.a(new_n142_), .b(new_n141_), .c(x08), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n77_), .O(z10));
  nand4  g093(.a(new_n110_), .b(new_n94_), .c(new_n69_), .d(new_n52_), .O(new_n145_));
  inv1   g094(.a(x27), .O(new_n146_));
  nor2   g095(.a(x29), .b(x28), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n111_), .c(new_n146_), .d(new_n93_), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n145_), .c(x30), .O(new_n149_));
  nor2   g098(.a(x30), .b(x29), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(new_n135_), .O(new_n151_));
  inv1   g100(.a(new_n151_), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n138_), .c(new_n88_), .O(new_n153_));
  aoi21  g102(.a(new_n153_), .b(new_n149_), .c(new_n58_), .O(new_n154_));
  nor2   g103(.a(x16), .b(x04), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n154_), .c(x08), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n77_), .O(z11));
  nand4  g106(.a(new_n150_), .b(new_n135_), .c(new_n111_), .d(new_n93_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n145_), .c(x31), .O(new_n159_));
  nand4  g108(.a(new_n93_), .b(new_n86_), .c(new_n85_), .d(new_n69_), .O(new_n160_));
  ...
  nand4  g116(.a(new_n167_), .b(new_n118_), .c(new_n161_), .d(new_n64_), .O(new_n168_));
  aoi21  g117(.a(new_n168_), .b(new_n159_), .c(new_n58_), .O(new_n169_));
  nor2   g118(.a(x16), .b(x03), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n169_), .c(x08), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n77_), .O(z12));
  nor2   g121(.a(x31), .b(x30), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n147_), .c(new_n124_), .d(new_n102_), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(new_n96_), .c(x32), .O(new_n175_));
  nand4  g124(.a(new_n162_), .b(new_n146_), .c(new_n109_), .d(new_n102_), .O(new_n176_));
  inv1   g125(.a(new_n176_), .O(new_n177_));
  inv1   g126(.a(x32), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n165_), .c(new_n164_), .d(new_n163_), .O(new_n179_));
  inv1   g128(.a(new_n179_), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n177_), .c(new_n161_), .d(new_n64_), .O(new_n181_));
  aoi21  g130(.a(new_n181_), .b(new_n175_), .c(new_n58_), .O(new_n182_));
  nor2   g131(.a(x16), .b(x02), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n182_), .c(x08), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n77_), .O(z13));
  nor2   g134(.a(x32), .b(x31), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n150_), .c(new_n135_), .d(new_n111_), .O(new_n187_));
  oai21  g136(.a(new_n187_), .b(new_n96_), .c(x33), .O(new_n188_));
  inv1   g137(.a(new_n103_), .O(new_n189_));
  nand4  g138(.a(new_n163_), .b(new_n162_), .c(new_n146_), .d(new_n109_), .O(new_n190_));
  inv1   g139(.a(new_n190_), .O(new_n191_));
  inv1   g140(.a(x33), .O(new_n192_));
  nand4  g141(.a(new_n192_), .b(new_n178_), .c(new_n165_), .d(new_n164_), .O(new_n193_));
  inv1   g142(.a(new_n193_), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n191_), .c(new_n189_), .d(new_n71_), .O(new_n195_));
  aoi21  g144(.a(new_n195_), .b(new_n188_), .c(new_n58_), .O(new_n196_));
  nor2   g145(.a(x16), .b(x01), .O(new_n197_));
  oai21  g146(.a(new_n197_), .b(new_n196_), .c(x08), .O(new_n198_));
  nand2  g147(.a(new_n198_), .b(new_n77_), .O(z14));
  nand2  g148(.a(new_n195_), .b(x34), .O(new_n200_));
  nor3   g149(.a(x34), .b(x33), .c(x32), .O(new_n201_));
  nand4  g150(.a(new_n201_), .b(new_n191_), .c(new_n173_), .d(new_n104_), .O(new_n202_));
  nand2  g151(.a(new_n202_), .b(new_n200_), .O(new_n203_));
  nand2  g152(.a(new_n203_), .b(x16), .O(new_n204_));
  nor2   g153(.a(x16), .b(x00), .O(new_n205_));
  nor3   g154(.a(new_n205_), .b(x18), .c(new_n73_), .O(new_n206_));
