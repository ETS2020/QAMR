...
module FAU ( 
  ...
  nand3  g030(.a(new_n81_), .b(new_n70_), .c(x16), .O(new_n82_));
  nand2  g031(.a(new_n82_), .b(new_n77_), .O(z03));
  nor3   g032(.a(x23), .b(x22), .c(x21), .O(new_n84_));
  aoi22  g033(.a(new_n84_), .b(new_n63_), .c(new_n80_), .d(x23), .O(new_n85_));
  ...
  nand4  g041(.a(new_n92_), .b(new_n79_), .c(new_n91_), .d(new_n52_), .O(new_n93_));
  ...
  nand3  g055(.a(new_n106_), .b(new_n70_), .c(x16), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(new_n100_), .O(z06));
  nand4  g057(.a(new_n102_), .b(new_n53_), .c(new_n70_), .d(new_n52_), .O(new_n109_));
  nor2   g058(.a(x26), .b(x25), .O(new_n110_));
  nand3  g059(.a(new_n110_), .b(new_n103_), .c(new_n89_), .O(new_n111_));
  nor2   g060(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  aoi21  g061(.a(new_n105_), .b(x26), .c(new_n112_), .O(new_n113_));
  ...
  oai21  g067(.a(new_n111_), .b(new_n72_), .c(x27), .O(new_n119_));
  nor3   g068(.a(x22), .b(x21), .c(x20), .O(new_n120_));
  nor3   g069(.a(x27), .b(x26), .c(x25), .O(new_n121_));
  nand4  g070(.a(new_n121_), .b(new_n92_), .c(new_n120_), .d(new_n55_), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n70_), .c(x16), .O(new_n124_));
  ...
  nand4  g077(.a(new_n128_), .b(new_n104_), .c(new_n127_), .d(new_n126_), .O(new_n129_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n80_), .c(x29), .O(new_n137_));
  ...
  nand3  g090(.a(new_n141_), .b(new_n70_), .c(x16), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(new_n136_), .O(z10));
  nand4  g092(.a(new_n103_), .b(new_n91_), .c(new_n71_), .d(new_n52_), .O(new_n144_));
  nor2   g093(.a(x30), .b(x29), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n128_), .c(new_n110_), .d(new_n89_), .O(new_n146_));
  ...
  nand4  g112(.a(new_n154_), .b(new_n153_), .c(new_n163_), .d(new_n101_), .O(new_n164_));
  oai21  g113(.a(new_n164_), .b(new_n93_), .c(x32), .O(new_n165_));
  nor2   g114(.a(x32), .b(x31), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n145_), .c(new_n128_), .d(new_n110_), .O(new_n167_));
  ...
  nand4  g125(.a(new_n101_), .b(new_n89_), .c(new_n126_), .d(new_n176_), .O(new_n177_));
  nor2   g126(.a(new_n177_), .b(new_n72_), .O(new_n178_));
  nor2   g127(.a(x33), .b(x32), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n154_), .c(new_n153_), .d(new_n163_), .O(new_n180_));
  ...
  nand2  g137(.a(new_n153_), .b(new_n163_), .O(new_n189_));
