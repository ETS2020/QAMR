...
module FAU ( 
  ...
  aoi21  g013(.a(new_n64_), .b(new_n61_), .c(new_n60_), .O(new_n65_));
  nor2   g014(.a(x16), .b(x14), .O(new_n66_));
  oai21  g015(.a(new_n66_), .b(new_n65_), .c(new_n53_), .O(new_n67_));
  ...
  nor3   g020(.a(new_n71_), .b(x18), .c(x15), .O(new_n72_));
  ...
  nand4  g025(.a(new_n76_), .b(new_n75_), .c(new_n74_), .d(new_n62_), .O(new_n77_));
  ...
  nor3   g029(.a(new_n80_), .b(x18), .c(x15), .O(new_n81_));
  oai21  g030(.a(new_n79_), .b(new_n60_), .c(new_n81_), .O(z03));
  nor2   g031(.a(x22), .b(x21), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n55_), .c(new_n75_), .O(new_n84_));
  nor3   g033(.a(x20), .b(x19), .c(x17), .O(new_n85_));
  nor2   g034(.a(x23), .b(x22), .O(new_n86_));
  nand3  g035(.a(new_n86_), .b(new_n85_), .c(new_n76_), .O(new_n87_));
  inv1   g036(.a(new_n87_), .O(new_n88_));
  aoi21  g037(.a(new_n84_), .b(x23), .c(new_n88_), .O(new_n89_));
  nor2   g038(.a(x16), .b(x11), .O(new_n90_));
  nor3   g039(.a(new_n90_), .b(x18), .c(x15), .O(new_n91_));
  oai21  g040(.a(new_n89_), .b(new_n60_), .c(new_n91_), .O(z04));
  inv1   g041(.a(x24), .O(new_n93_));
  nor2   g042(.a(x24), .b(x23), .O(new_n94_));
  nand4  g043(.a(new_n94_), .b(new_n83_), .c(new_n63_), .d(new_n62_), .O(new_n95_));
  ...
  nand3  g048(.a(new_n99_), .b(new_n97_), .c(new_n53_), .O(z05));
  nand2  g049(.a(new_n95_), .b(x25), .O(new_n101_));
  nor2   g050(.a(x25), .b(x24), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n86_), .c(new_n69_), .d(new_n55_), .O(new_n103_));
  ...
  nand3  g056(.a(new_n107_), .b(new_n105_), .c(new_n53_), .O(z06));
  inv1   g057(.a(x26), .O(new_n109_));
  inv1   g058(.a(x22), .O(new_n110_));
  inv1   g059(.a(x23), .O(new_n111_));
  inv1   g060(.a(x25), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n93_), .c(new_n111_), .d(new_n110_), .O(new_n113_));
  nor2   g062(.a(new_n113_), .b(new_n77_), .O(new_n114_));
  nor2   g063(.a(x26), .b(x25), .O(new_n115_));
  nand3  g064(.a(new_n115_), .b(new_n86_), .c(new_n93_), .O(new_n116_));
  oai22  g065(.a(new_n116_), .b(new_n77_), .c(new_n114_), .d(new_n109_), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(x16), .O(new_n118_));
  inv1   g067(.a(x08), .O(new_n119_));
  aoi21  g068(.a(new_n60_), .b(new_n119_), .c(x18), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n118_), .c(new_n53_), .O(z07));
  oai21  g070(.a(new_n116_), .b(new_n77_), .c(x27), .O(new_n122_));
  nor3   g071(.a(x27), .b(x26), .c(x25), .O(new_n123_));
  nand4  g072(.a(new_n123_), .b(new_n94_), .c(new_n78_), .d(new_n55_), .O(new_n124_));
  ...
  nand4  g079(.a(new_n130_), .b(new_n102_), .c(new_n109_), .d(new_n111_), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n84_), .c(new_n129_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(x16), .O(new_n133_));
  inv1   g082(.a(x06), .O(new_n134_));
  aoi21  g083(.a(new_n60_), .b(new_n134_), .c(x18), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n133_), .c(new_n53_), .O(z09));
  oai21  g085(.a(new_n131_), .b(new_n84_), .c(x29), .O(new_n137_));
  nand2  g086(.a(new_n111_), .b(new_n110_), .O(new_n138_));
  nor2   g087(.a(new_n138_), .b(x21), .O(new_n139_));
  nor3   g088(.a(x26), .b(x25), .c(x24), .O(new_n140_));
  nor3   g089(.a(x29), .b(x28), .c(x27), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(new_n85_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n137_), .c(new_n60_), .O(new_n143_));
  nor2   g092(.a(x16), .b(x05), .O(new_n144_));
  oai21  g093(.a(new_n144_), .b(new_n143_), .c(new_n53_), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n52_), .O(z10));
  nor2   g095(.a(x30), .b(x29), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n130_), .c(new_n140_), .O(new_n148_));
  ...
  nor3   g100(.a(new_n151_), .b(x18), .c(x15), .O(new_n152_));
  oai21  g101(.a(new_n150_), .b(new_n60_), .c(new_n152_), .O(z11));
  inv1   g102(.a(x31), .O(new_n154_));
  nor2   g103(.a(x29), .b(x28), .O(new_n155_));
  nor2   g104(.a(x31), .b(x30), .O(new_n156_));
  nand3  g105(.a(new_n156_), .b(new_n155_), .c(new_n123_), .O(new_n157_));
  oai22  g106(.a(new_n157_), .b(new_n95_), .c(new_n149_), .d(new_n154_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(x16), .O(new_n159_));
  nor2   g108(.a(x16), .b(x03), .O(new_n160_));
  nor3   g109(.a(new_n160_), .b(x18), .c(x15), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n159_), .O(z12));
  oai21  g111(.a(new_n157_), .b(new_n95_), .c(x32), .O(new_n163_));
  nor2   g112(.a(x32), .b(x31), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n147_), .c(new_n130_), .d(new_n115_), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n95_), .c(new_n163_), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(x16), .O(new_n167_));
  inv1   g116(.a(x02), .O(new_n168_));
  aoi21  g117(.a(new_n60_), .b(new_n168_), .c(x18), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n167_), .c(new_n53_), .O(z13));
  oai21  g119(.a(new_n165_), .b(new_n95_), .c(x33), .O(new_n171_));
  nor2   g120(.a(x27), .b(x26), .O(new_n172_));
  nor2   g121(.a(x33), .b(x32), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n156_), .c(new_n155_), .d(new_n172_), .O(new_n174_));
  inv1   g123(.a(new_n174_), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(new_n114_), .O(new_n176_));
  aoi21  g125(.a(new_n176_), .b(new_n171_), .c(new_n60_), .O(new_n177_));
  nor2   g126(.a(x16), .b(x01), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n177_), .c(new_n53_), .O(new_n179_));
  nand2  g128(.a(new_n179_), .b(new_n52_), .O(z14));
  oai21  g129(.a(new_n174_), .b(new_n103_), .c(x34), .O(new_n181_));
  nand2  g130(.a(new_n155_), .b(new_n172_), .O(new_n182_));
  inv1   g131(.a(new_n182_), .O(new_n183_));
  inv1   g132(.a(x30), .O(new_n184_));
  nand2  g133(.a(new_n154_), .b(new_n184_), .O(new_n185_));
  ...
  nand3  g139(.a(new_n190_), .b(new_n183_), .c(new_n114_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n181_), .c(new_n60_), .O(new_n192_));
  nor2   g141(.a(x16), .b(x00), .O(new_n193_));
  oai21  g142(.a(new_n193_), .b(new_n192_), .c(new_n53_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n52_), .O(z15));
endmodule
