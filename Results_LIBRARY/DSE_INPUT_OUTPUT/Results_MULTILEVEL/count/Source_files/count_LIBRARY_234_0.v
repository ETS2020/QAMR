...
module FAU ( 
  ...
  inv1   g28(.a(new_n60_), .O(new_n80_));
  ...
  nand2  g36(.a(new_n87_), .b(new_n59_), .O(z05));
  ...
  nand2  g44(.a(new_n95_), .b(new_n59_), .O(z07));
  ...
  nand2  g60(.a(new_n111_), .b(new_n59_), .O(z11));
  ...
  nand3  g72(.a(new_n123_), .b(new_n121_), .c(new_n80_), .O(z14));
