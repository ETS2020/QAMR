...
module FAU ( 
  ...
  nand2  g016(.a(x18), .b(x05), .O(new_n68_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n96_), .c(new_n92_), .d(new_n52_), .O(new_n98_));
  aoi21  g047(.a(new_n98_), .b(new_n95_), .c(new_n58_), .O(new_n99_));
  ...
  nand2  g068(.a(new_n119_), .b(new_n68_), .O(z07));
  nand2  g069(.a(new_n116_), .b(x27), .O(new_n121_));
  nor3   g070(.a(x27), .b(x26), .c(x25), .O(new_n122_));
  nand4  g071(.a(new_n122_), .b(new_n97_), .c(new_n78_), .d(new_n55_), .O(new_n123_));
  ...
  nand2  g075(.a(new_n126_), .b(new_n68_), .O(z08));
  ...
  nand2  g083(.a(new_n134_), .b(new_n68_), .O(z09));
  ...
  nor2   g088(.a(new_n139_), .b(new_n94_), .O(new_n140_));
  ...
  oai21  g093(.a(new_n139_), .b(new_n94_), .c(x30), .O(new_n145_));
  nor2   g094(.a(x28), .b(x27), .O(new_n146_));
  nor2   g095(.a(x30), .b(x29), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n146_), .c(new_n115_), .d(new_n87_), .O(new_n148_));
  ...
  nand2  g100(.a(new_n151_), .b(new_n68_), .O(z11));
  nand2  g101(.a(new_n148_), .b(x31), .O(new_n153_));
  nor2   g102(.a(x31), .b(x30), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n138_), .c(new_n122_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n147_), .c(new_n146_), .d(new_n137_), .O(new_n164_));
  oai21  g113(.a(new_n164_), .b(new_n98_), .c(new_n162_), .O(new_n165_));
  ...
  oai21  g118(.a(new_n164_), .b(new_n98_), .c(x33), .O(new_n170_));
  nor2   g119(.a(x27), .b(x26), .O(new_n171_));
  nor2   g120(.a(x33), .b(x32), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n154_), .c(new_n138_), .d(new_n171_), .O(new_n173_));
  ...
  oai21  g128(.a(new_n173_), .b(new_n113_), .c(x34), .O(new_n180_));
  nand2  g129(.a(new_n138_), .b(new_n171_), .O(new_n181_));
  ...
  nand3  g139(.a(new_n190_), .b(new_n182_), .c(new_n106_), .O(new_n191_));
  ...
  nand2  g143(.a(new_n194_), .b(new_n68_), .O(z15));
endmodule
