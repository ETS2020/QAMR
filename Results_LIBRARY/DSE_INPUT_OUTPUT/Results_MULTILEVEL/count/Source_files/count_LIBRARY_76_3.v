...
module FAU ( 
  ...
  oai21  g008(.a(new_n56_), .b(x07), .c(new_n59_), .O(z00));
  ...
  aoi21  g017(.a(new_n68_), .b(new_n64_), .c(new_n58_), .O(new_n69_));
  oai21  g018(.a(new_n69_), .b(x18), .c(new_n63_), .O(new_n70_));
  ...
  nand3  g034(.a(new_n85_), .b(new_n53_), .c(new_n67_), .O(new_n86_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n92_), .c(new_n72_), .d(new_n65_), .O(new_n94_));
  nand2  g043(.a(new_n94_), .b(new_n63_), .O(new_n95_));
  aoi21  g044(.a(new_n86_), .b(x23), .c(new_n95_), .O(new_n96_));
  inv1   g045(.a(x11), .O(new_n97_));
  aoi21  g046(.a(new_n58_), .b(new_n97_), .c(x18), .O(new_n98_));
  oai21  g047(.a(new_n96_), .b(new_n58_), .c(new_n98_), .O(z04));
  inv1   g048(.a(x24), .O(new_n100_));
  inv1   g049(.a(x23), .O(new_n101_));
  nand3  g050(.a(new_n101_), .b(new_n82_), .c(new_n72_), .O(new_n102_));
  nor2   g051(.a(new_n102_), .b(new_n68_), .O(new_n103_));
  nor2   g052(.a(new_n103_), .b(new_n100_), .O(new_n104_));
  nor2   g053(.a(x24), .b(x23), .O(new_n105_));
  nand3  g054(.a(new_n105_), .b(new_n85_), .c(new_n73_), .O(new_n106_));
  ...
  nand2  g062(.a(new_n106_), .b(x25), .O(new_n114_));
  nor2   g063(.a(x25), .b(x24), .O(new_n115_));
  nand4  g064(.a(new_n115_), .b(new_n93_), .c(new_n75_), .d(new_n53_), .O(new_n116_));
  aoi21  g065(.a(new_n116_), .b(new_n114_), .c(new_n58_), .O(new_n117_));
  oai21  g066(.a(new_n117_), .b(x18), .c(new_n63_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(new_n113_), .O(z06));
  nor3   g068(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n93_), .c(new_n83_), .O(new_n121_));
  nand2  g070(.a(new_n121_), .b(new_n63_), .O(new_n122_));
  aoi21  g071(.a(new_n116_), .b(x26), .c(new_n122_), .O(new_n123_));
  inv1   g072(.a(x08), .O(new_n124_));
  aoi21  g073(.a(new_n58_), .b(new_n124_), .c(x18), .O(new_n125_));
  oai21  g074(.a(new_n123_), .b(new_n58_), .c(new_n125_), .O(z07));
  nand2  g075(.a(new_n121_), .b(x27), .O(new_n127_));
  inv1   g076(.a(x25), .O(new_n128_));
  nor2   g077(.a(x27), .b(x26), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n105_), .c(new_n128_), .O(new_n130_));
  or2    g079(.a(new_n130_), .b(new_n86_), .O(new_n131_));
  nand3  g080(.a(new_n131_), .b(new_n127_), .c(x16), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n63_), .O(new_n133_));
  aoi21  g082(.a(x16), .b(x07), .c(x18), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n133_), .O(z08));
  inv1   g084(.a(x06), .O(new_n136_));
  oai21  g085(.a(x18), .b(new_n136_), .c(new_n58_), .O(new_n137_));
  oai21  g086(.a(new_n130_), .b(new_n86_), .c(x28), .O(new_n138_));
  nor3   g087(.a(x22), .b(x21), .c(x20), .O(new_n139_));
  nor3   g088(.a(x25), .b(x24), .c(x23), .O(new_n140_));
  nor3   g089(.a(x28), .b(x27), .c(x26), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(new_n53_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n138_), .c(new_n58_), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(x18), .c(new_n63_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n137_), .O(z09));
  nand2  g094(.a(new_n142_), .b(x29), .O(new_n146_));
  inv1   g095(.a(x27), .O(new_n147_));
  nor2   g096(.a(x26), .b(x25), .O(new_n148_));
  nor2   g097(.a(x29), .b(x28), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n100_), .O(new_n150_));
  or2    g099(.a(new_n150_), .b(new_n94_), .O(new_n151_));
  ...
  oai21  g107(.a(new_n150_), .b(new_n94_), .c(x30), .O(new_n159_));
  nor2   g108(.a(x28), .b(x27), .O(new_n160_));
  nor2   g109(.a(x30), .b(x29), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  inv1   g111(.a(new_n162_), .O(new_n163_));
  nand3  g112(.a(new_n163_), .b(new_n120_), .c(new_n103_), .O(new_n164_));
  aoi21  g113(.a(new_n164_), .b(new_n159_), .c(new_n58_), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(x18), .c(new_n63_), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(new_n158_), .O(z11));
  nor2   g116(.a(x31), .b(x30), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n149_), .c(new_n129_), .d(new_n128_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n106_), .c(new_n63_), .O(new_n170_));
  aoi21  g119(.a(new_n164_), .b(x31), .c(new_n170_), .O(new_n171_));
  ...
  oai21  g123(.a(new_n169_), .b(new_n106_), .c(x32), .O(new_n175_));
  nor2   g124(.a(x32), .b(x31), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n161_), .c(new_n160_), .d(new_n148_), .O(new_n177_));
  inv1   g126(.a(new_n177_), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n105_), .c(new_n85_), .d(new_n73_), .O(new_n179_));
  nand3  g128(.a(new_n179_), .b(new_n175_), .c(new_n63_), .O(new_n180_));
  ...
  oai21  g133(.a(new_n177_), .b(new_n106_), .c(x33), .O(new_n185_));
  nor2   g134(.a(x33), .b(x32), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n168_), .c(new_n149_), .d(new_n129_), .O(new_n187_));
  or2    g136(.a(new_n187_), .b(new_n116_), .O(new_n188_));
  nand3  g137(.a(new_n188_), .b(new_n185_), .c(new_n63_), .O(new_n189_));
  ...
  oai21  g142(.a(new_n187_), .b(new_n116_), .c(x34), .O(new_n194_));
  inv1   g143(.a(new_n116_), .O(new_n195_));
  nand2  g144(.a(new_n149_), .b(new_n129_), .O(new_n196_));
  inv1   g145(.a(new_n196_), .O(new_n197_));
  nor3   g146(.a(x34), .b(x33), .c(x32), .O(new_n198_));
  nand4  g147(.a(new_n198_), .b(new_n197_), .c(new_n168_), .d(new_n195_), .O(new_n199_));
  nand3  g148(.a(new_n199_), .b(new_n194_), .c(new_n63_), .O(new_n200_));
