...
module FAU ( 
  ...
  nand4  g038(.a(new_n89_), .b(new_n80_), .c(new_n83_), .d(new_n59_), .O(new_n90_));
  ...
  oai21  g053(.a(new_n102_), .b(new_n65_), .c(new_n104_), .O(z06));
  nor2   g054(.a(x21), .b(x20), .O(new_n106_));
  nor2   g055(.a(x25), .b(x24), .O(new_n107_));
  nand4  g056(.a(new_n107_), .b(new_n84_), .c(new_n106_), .d(new_n58_), .O(new_n108_));
  ...
  aoi21  g063(.a(new_n65_), .b(new_n114_), .c(x18), .O(new_n115_));
  ...
  nand3  g080(.a(new_n97_), .b(new_n96_), .c(new_n68_), .O(new_n132_));
  ...
  nand3  g084(.a(new_n135_), .b(new_n131_), .c(new_n82_), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(x16), .O(new_n137_));
  inv1   g086(.a(x05), .O(new_n138_));
  nand2  g087(.a(new_n54_), .b(new_n138_), .O(new_n139_));
  ...
  nand4  g092(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n98_), .O(new_n144_));
  ...
  nand3  g100(.a(new_n151_), .b(new_n110_), .c(new_n133_), .O(new_n152_));
  nor2   g101(.a(x29), .b(x28), .O(new_n153_));
  nor2   g102(.a(x31), .b(x30), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n153_), .c(new_n117_), .d(new_n99_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n90_), .c(new_n82_), .O(new_n156_));
  ...
  oai21  g108(.a(new_n157_), .b(new_n65_), .c(new_n159_), .O(z12));
  oai21  g109(.a(new_n155_), .b(new_n90_), .c(x32), .O(new_n161_));
  ...
  nand3  g114(.a(new_n165_), .b(new_n161_), .c(new_n82_), .O(new_n166_));
  ...
  nand4  g121(.a(new_n172_), .b(new_n154_), .c(new_n153_), .d(new_n117_), .O(new_n173_));
  inv1   g122(.a(new_n173_), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n101_), .O(new_n175_));
  nand3  g124(.a(new_n175_), .b(new_n171_), .c(new_n82_), .O(new_n176_));
  ...
  oai21  g129(.a(new_n173_), .b(new_n108_), .c(x34), .O(new_n181_));
  nand2  g130(.a(new_n153_), .b(new_n117_), .O(new_n182_));
  ...
  nand3  g141(.a(new_n192_), .b(new_n181_), .c(new_n82_), .O(new_n193_));
