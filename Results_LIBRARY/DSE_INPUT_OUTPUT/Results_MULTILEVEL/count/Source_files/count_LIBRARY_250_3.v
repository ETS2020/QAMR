...
module FAU ( 
  ...
  nand4  g118(.a(new_n161_), .b(new_n139_), .c(new_n124_), .d(new_n104_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n97_), .c(x32), .O(new_n171_));
  nand2  g120(.a(new_n149_), .b(new_n114_), .O(new_n172_));
  ...
  nand4  g133(.a(new_n174_), .b(new_n150_), .c(new_n149_), .d(new_n114_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n97_), .c(x33), .O(new_n186_));
  inv1   g135(.a(new_n73_), .O(new_n187_));
  inv1   g136(.a(new_n105_), .O(new_n188_));
  nand2  g137(.a(new_n139_), .b(new_n124_), .O(new_n189_));
  inv1   g138(.a(new_n189_), .O(new_n190_));
  nor2   g139(.a(x33), .b(x32), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(new_n161_), .O(new_n192_));
  inv1   g141(.a(new_n192_), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n190_), .c(new_n188_), .d(new_n187_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n186_), .O(new_n195_));
  nand3  g144(.a(new_n195_), .b(new_n63_), .c(x16), .O(new_n196_));
  nand2  g145(.a(new_n196_), .b(new_n184_), .O(z14));
  nand4  g146(.a(new_n191_), .b(new_n161_), .c(new_n139_), .d(new_n124_), .O(new_n198_));
  ...
  nand3  g156(.a(new_n207_), .b(new_n190_), .c(new_n106_), .O(new_n208_));
