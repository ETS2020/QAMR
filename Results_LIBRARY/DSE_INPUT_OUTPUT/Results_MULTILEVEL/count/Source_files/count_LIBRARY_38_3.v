...
module FAU ( 
  ...
  aoi21  g024(.a(new_n58_), .b(new_n68_), .c(x18), .O(new_n76_));
  oai21  g025(.a(new_n75_), .b(new_n58_), .c(new_n76_), .O(z02));
  ...
  nand2  g071(.a(new_n122_), .b(new_n69_), .O(z07));
  nor2   g072(.a(x26), .b(x25), .O(new_n124_));
  nand3  g073(.a(new_n124_), .b(new_n114_), .c(new_n91_), .O(new_n125_));
  oai21  g074(.a(new_n125_), .b(new_n73_), .c(x27), .O(new_n126_));
  ...
  nand2  g080(.a(new_n131_), .b(new_n69_), .O(z08));
  ...
  nand2  g095(.a(new_n146_), .b(new_n69_), .O(z10));
  ...
  nand2  g130(.a(new_n181_), .b(new_n69_), .O(z14));
  ...
  nand2  g145(.a(new_n196_), .b(new_n69_), .O(z15));
endmodule
