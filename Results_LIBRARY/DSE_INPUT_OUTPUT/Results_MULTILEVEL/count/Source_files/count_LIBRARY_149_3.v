...
module FAU ( 
  ...
  oai21  g026(.a(x18), .b(new_n58_), .c(new_n68_), .O(new_n78_));
  inv1   g027(.a(x22), .O(new_n79_));
  nor2   g028(.a(x22), .b(x21), .O(new_n80_));
  nand3  g029(.a(new_n80_), .b(new_n55_), .c(new_n63_), .O(new_n81_));
  oai21  g030(.a(new_n73_), .b(new_n79_), .c(new_n81_), .O(new_n82_));
  nand3  g031(.a(new_n82_), .b(new_n61_), .c(x16), .O(new_n83_));
  nand2  g032(.a(new_n83_), .b(new_n78_), .O(z03));
  inv1   g033(.a(x23), .O(new_n85_));
  nand3  g034(.a(new_n85_), .b(new_n79_), .c(new_n71_), .O(new_n86_));
  ...
  nand4  g044(.a(new_n95_), .b(new_n85_), .c(new_n79_), .d(new_n71_), .O(new_n96_));
  ...
  nand4  g051(.a(new_n102_), .b(new_n80_), .c(new_n92_), .d(new_n52_), .O(new_n103_));
  inv1   g052(.a(x25), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n95_), .c(new_n85_), .d(new_n79_), .O(new_n105_));
  ...
  nand3  g064(.a(new_n115_), .b(new_n93_), .c(new_n73_), .O(new_n116_));
  aoi21  g065(.a(new_n116_), .b(new_n114_), .c(new_n58_), .O(new_n117_));
  oai21  g066(.a(x16), .b(x08), .c(new_n61_), .O(new_n118_));
  or2    g067(.a(new_n118_), .b(new_n117_), .O(z07));
  nor2   g068(.a(x27), .b(x26), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n102_), .c(new_n104_), .O(new_n121_));
  ...
  nand4  g079(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n55_), .O(new_n131_));
  aoi21  g080(.a(new_n131_), .b(new_n127_), .c(new_n58_), .O(new_n132_));
  ...
  nand4  g087(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n95_), .O(new_n139_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n137_), .d(new_n95_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n94_), .c(x31), .O(new_n154_));
  ...
  nand3  g107(.a(new_n158_), .b(new_n155_), .c(new_n97_), .O(new_n159_));
  ...
  nand2  g111(.a(new_n162_), .b(new_n69_), .O(z12));
  nand4  g112(.a(new_n156_), .b(new_n138_), .c(new_n120_), .d(new_n104_), .O(new_n164_));
  oai21  g113(.a(new_n164_), .b(new_n103_), .c(x32), .O(new_n165_));
  ...
  nand2  g124(.a(new_n175_), .b(new_n69_), .O(z13));
  nand2  g125(.a(new_n172_), .b(x33), .O(new_n177_));
  nor2   g126(.a(x33), .b(x32), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n156_), .c(new_n138_), .d(new_n120_), .O(new_n179_));
  or2    g128(.a(new_n179_), .b(new_n113_), .O(new_n180_));
  ...
  oai21  g134(.a(new_n179_), .b(new_n113_), .c(x34), .O(new_n186_));
  nand2  g135(.a(new_n138_), .b(new_n120_), .O(new_n187_));
  ...
  nand3  g143(.a(new_n194_), .b(new_n188_), .c(new_n106_), .O(new_n195_));
  aoi21  g144(.a(new_n195_), .b(new_n186_), .c(new_n58_), .O(new_n196_));
  nor2   g145(.a(x16), .b(x00), .O(new_n197_));
  oai21  g146(.a(new_n197_), .b(new_n196_), .c(new_n61_), .O(new_n198_));
  nand2  g147(.a(new_n198_), .b(new_n69_), .O(z15));
endmodule
