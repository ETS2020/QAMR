...
module FAU ( 
  ...
  nand3  g035(.a(new_n86_), .b(new_n63_), .c(new_n68_), .O(new_n87_));
  aoi21  g036(.a(new_n87_), .b(new_n85_), .c(new_n58_), .O(new_n88_));
  nor2   g037(.a(x16), .b(x11), .O(new_n89_));
  oai21  g038(.a(new_n89_), .b(new_n88_), .c(new_n77_), .O(new_n90_));
  nand2  g039(.a(new_n90_), .b(new_n75_), .O(z04));
  nor2   g040(.a(x20), .b(x19), .O(new_n92_));
  nand2  g041(.a(new_n92_), .b(new_n52_), .O(new_n93_));
  nand2  g042(.a(new_n86_), .b(new_n68_), .O(new_n94_));
  oai21  g043(.a(new_n94_), .b(new_n93_), .c(x24), .O(new_n95_));
  nor2   g044(.a(x24), .b(x23), .O(new_n96_));
  nand4  g045(.a(new_n96_), .b(new_n79_), .c(new_n92_), .d(new_n52_), .O(new_n97_));
  aoi21  g046(.a(new_n97_), .b(new_n95_), .c(new_n58_), .O(new_n98_));
  nor2   g047(.a(x16), .b(x10), .O(new_n99_));
  oai21  g048(.a(new_n99_), .b(new_n98_), .c(new_n77_), .O(new_n100_));
  nand2  g049(.a(new_n100_), .b(new_n75_), .O(z05));
  nand2  g050(.a(new_n97_), .b(x25), .O(new_n102_));
  nor2   g051(.a(x25), .b(x24), .O(new_n103_));
  nand4  g052(.a(new_n103_), .b(new_n86_), .c(new_n69_), .d(new_n55_), .O(new_n104_));
  aoi21  g053(.a(new_n104_), .b(new_n102_), .c(new_n58_), .O(new_n105_));
  nor2   g054(.a(x16), .b(x09), .O(new_n106_));
  oai21  g055(.a(new_n106_), .b(new_n105_), .c(new_n77_), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(new_n75_), .O(z06));
  nand4  g057(.a(new_n69_), .b(new_n53_), .c(new_n77_), .d(new_n52_), .O(new_n109_));
  nor3   g058(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(new_n86_), .O(new_n111_));
  ...
  nand4  g065(.a(new_n110_), .b(new_n86_), .c(new_n69_), .d(new_n55_), .O(new_n117_));
  inv1   g066(.a(x25), .O(new_n118_));
  nor2   g067(.a(x27), .b(x26), .O(new_n119_));
  nand3  g068(.a(new_n119_), .b(new_n96_), .c(new_n118_), .O(new_n120_));
  nor2   g069(.a(new_n120_), .b(new_n80_), .O(new_n121_));
  aoi21  g070(.a(new_n117_), .b(x27), .c(new_n121_), .O(new_n122_));
  ...
  nand2  g082(.a(new_n133_), .b(new_n75_), .O(z09));
  nor2   g083(.a(new_n94_), .b(new_n93_), .O(new_n135_));
  nor3   g084(.a(x29), .b(x28), .c(x27), .O(new_n136_));
  and2   g085(.a(new_n136_), .b(new_n110_), .O(new_n137_));
  aoi22  g086(.a(new_n137_), .b(new_n135_), .c(new_n130_), .d(x29), .O(new_n138_));
  ...
  nand3  g090(.a(new_n136_), .b(new_n110_), .c(new_n135_), .O(new_n142_));
  nor2   g091(.a(x28), .b(x27), .O(new_n143_));
  nor2   g092(.a(x30), .b(x29), .O(new_n144_));
  nand3  g093(.a(new_n144_), .b(new_n143_), .c(new_n110_), .O(new_n145_));
  ...
  oai21  g099(.a(new_n145_), .b(new_n87_), .c(x31), .O(new_n151_));
  inv1   g100(.a(new_n97_), .O(new_n152_));
  ...
  nand3  g110(.a(new_n155_), .b(new_n154_), .c(new_n153_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n97_), .c(x32), .O(new_n163_));
  nor2   g112(.a(x26), .b(x25), .O(new_n164_));
  nor2   g113(.a(x32), .b(x31), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n144_), .c(new_n143_), .d(new_n164_), .O(new_n166_));
  or2    g115(.a(new_n166_), .b(new_n97_), .O(new_n167_));
  ...
  oai21  g121(.a(new_n166_), .b(new_n97_), .c(x33), .O(new_n173_));
  nor2   g122(.a(x33), .b(x32), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n155_), .c(new_n154_), .d(new_n119_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n104_), .c(new_n173_), .O(new_n176_));
  ...
  nor2   g130(.a(new_n175_), .b(new_n104_), .O(new_n182_));
  nor2   g131(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g132(.a(new_n154_), .b(new_n119_), .O(new_n184_));
  inv1   g133(.a(x32), .O(new_n185_));
  nor2   g134(.a(x34), .b(x33), .O(new_n186_));
  nand3  g135(.a(new_n186_), .b(new_n155_), .c(new_n185_), .O(new_n187_));
  nor3   g136(.a(new_n187_), .b(new_n184_), .c(new_n104_), .O(new_n188_));
