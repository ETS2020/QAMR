...
module FAU ( 
  ...
  aoi22  g012(.a(new_n63_), .b(new_n53_), .c(new_n60_), .d(x21), .O(new_n64_));
  oai21  g013(.a(new_n64_), .b(new_n62_), .c(new_n52_), .O(z02));
  nand2  g014(.a(new_n63_), .b(new_n53_), .O(new_n66_));
  nand2  g015(.a(new_n66_), .b(x22), .O(new_n67_));
  nor3   g016(.a(x22), .b(x21), .c(x20), .O(new_n68_));
  nand3  g017(.a(new_n68_), .b(new_n53_), .c(x16), .O(new_n69_));
  nand4  g018(.a(new_n69_), .b(new_n67_), .c(new_n52_), .d(x16), .O(z03));
  inv1   g019(.a(x20), .O(new_n71_));
  inv1   g020(.a(x21), .O(new_n72_));
  inv1   g021(.a(x22), .O(new_n73_));
  nand4  g022(.a(new_n53_), .b(new_n73_), .c(new_n72_), .d(new_n71_), .O(new_n74_));
  nor2   g023(.a(x23), .b(x22), .O(new_n75_));
  nand4  g024(.a(new_n75_), .b(new_n59_), .c(new_n72_), .d(new_n58_), .O(new_n76_));
  inv1   g025(.a(new_n76_), .O(new_n77_));
  aoi21  g026(.a(new_n74_), .b(x23), .c(new_n77_), .O(new_n78_));
  oai21  g027(.a(new_n78_), .b(new_n62_), .c(new_n52_), .O(z04));
  and2   g028(.a(new_n76_), .b(x24), .O(new_n80_));
  inv1   g029(.a(x23), .O(new_n81_));
  inv1   g030(.a(x24), .O(new_n82_));
  nand4  g031(.a(new_n82_), .b(new_n81_), .c(new_n73_), .d(new_n72_), .O(new_n83_));
  ...
  oai21  g035(.a(new_n83_), .b(new_n60_), .c(x25), .O(new_n87_));
  inv1   g036(.a(x25), .O(new_n88_));
  nand3  g037(.a(new_n75_), .b(new_n88_), .c(new_n82_), .O(new_n89_));
  nor2   g038(.a(new_n89_), .b(new_n66_), .O(new_n90_));
  nor2   g039(.a(new_n90_), .b(x18), .O(new_n91_));
  nand3  g040(.a(new_n91_), .b(new_n87_), .c(x16), .O(z06));
  inv1   g041(.a(x26), .O(new_n93_));
  nor3   g042(.a(x26), .b(x25), .c(x24), .O(new_n94_));
  nand4  g043(.a(new_n94_), .b(new_n75_), .c(new_n63_), .d(new_n53_), .O(new_n95_));
  oai21  g044(.a(new_n90_), .b(new_n93_), .c(new_n95_), .O(new_n96_));
  nand2  g045(.a(new_n96_), .b(x16), .O(new_n97_));
  nand2  g046(.a(new_n97_), .b(new_n52_), .O(z07));
  nor2   g047(.a(x27), .b(x26), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n88_), .c(new_n82_), .d(new_n81_), .O(new_n100_));
  nor2   g049(.a(new_n100_), .b(new_n74_), .O(new_n101_));
  aoi21  g050(.a(new_n95_), .b(x27), .c(new_n101_), .O(new_n102_));
  oai21  g051(.a(new_n102_), .b(new_n62_), .c(new_n52_), .O(z08));
  ...
  nand4  g055(.a(new_n106_), .b(new_n105_), .c(new_n68_), .d(new_n53_), .O(new_n107_));
  ...
  nand4  g060(.a(new_n111_), .b(new_n110_), .c(new_n109_), .d(new_n82_), .O(new_n112_));
  nor2   g061(.a(new_n112_), .b(new_n76_), .O(new_n113_));
  aoi21  g062(.a(new_n107_), .b(x29), .c(new_n113_), .O(new_n114_));
  oai21  g063(.a(new_n114_), .b(new_n62_), .c(new_n52_), .O(z10));
  oai21  g064(.a(new_n112_), .b(new_n76_), .c(x30), .O(new_n116_));
  nor2   g065(.a(x28), .b(x27), .O(new_n117_));
  nor2   g066(.a(x30), .b(x29), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n117_), .c(new_n110_), .d(new_n82_), .O(new_n119_));
  or2    g068(.a(new_n119_), .b(new_n76_), .O(new_n120_));
  nand4  g069(.a(new_n120_), .b(new_n116_), .c(new_n52_), .d(x16), .O(z11));
  oai21  g070(.a(new_n119_), .b(new_n76_), .c(x31), .O(new_n122_));
  nor3   g071(.a(x20), .b(x19), .c(x17), .O(new_n123_));
  inv1   g072(.a(new_n83_), .O(new_n124_));
  ...
  nand4  g080(.a(new_n131_), .b(new_n125_), .c(new_n124_), .d(new_n123_), .O(new_n132_));
  ...
  nand3  g086(.a(new_n118_), .b(new_n137_), .c(new_n129_), .O(new_n138_));
  inv1   g087(.a(new_n138_), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n117_), .c(new_n110_), .d(new_n84_), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n136_), .c(new_n52_), .d(x16), .O(z13));
  nand2  g090(.a(new_n140_), .b(x33), .O(new_n142_));
  nand2  g091(.a(new_n111_), .b(new_n99_), .O(new_n143_));
  ...
  nand2  g096(.a(new_n147_), .b(new_n90_), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n142_), .c(new_n52_), .d(x16), .O(z14));
  nand2  g098(.a(new_n148_), .b(x34), .O(new_n150_));
  inv1   g099(.a(new_n143_), .O(new_n151_));
  nor3   g100(.a(x34), .b(x33), .c(x32), .O(new_n152_));
  nand4  g101(.a(new_n152_), .b(new_n151_), .c(new_n144_), .d(new_n90_), .O(new_n153_));
  nand4  g102(.a(new_n153_), .b(new_n150_), .c(new_n52_), .d(x16), .O(z15));
endmodule
