...
module FAU ( 
  ...
  oai21  g091(.a(new_n137_), .b(new_n92_), .c(x30), .O(new_n143_));
  ...
  nand3  g097(.a(new_n148_), .b(new_n143_), .c(new_n108_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(x16), .O(new_n150_));
  inv1   g099(.a(x04), .O(new_n151_));
  nand2  g100(.a(new_n54_), .b(new_n151_), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n150_), .O(z11));
  nor2   g102(.a(x31), .b(x30), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n136_), .c(new_n120_), .d(new_n101_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n94_), .c(new_n108_), .O(new_n156_));
  ...
  oai21  g109(.a(new_n155_), .b(new_n94_), .c(x32), .O(new_n161_));
  nor2   g110(.a(x32), .b(x31), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n145_), .c(new_n144_), .d(new_n135_), .O(new_n163_));
  ...
  oai21  g119(.a(new_n163_), .b(new_n94_), .c(x33), .O(new_n171_));
  inv1   g120(.a(new_n102_), .O(new_n172_));
  nand2  g121(.a(new_n136_), .b(new_n120_), .O(new_n173_));
  inv1   g122(.a(new_n173_), .O(new_n174_));
  nor2   g123(.a(x33), .b(x32), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(new_n154_), .O(new_n176_));
  inv1   g125(.a(new_n176_), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n174_), .c(new_n172_), .d(new_n70_), .O(new_n178_));
  nand3  g127(.a(new_n178_), .b(new_n171_), .c(new_n108_), .O(new_n179_));
  ...
  nand4  g132(.a(new_n175_), .b(new_n154_), .c(new_n136_), .d(new_n120_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n111_), .c(x34), .O(new_n185_));
  ...
  nand3  g142(.a(new_n193_), .b(new_n174_), .c(new_n103_), .O(new_n194_));
