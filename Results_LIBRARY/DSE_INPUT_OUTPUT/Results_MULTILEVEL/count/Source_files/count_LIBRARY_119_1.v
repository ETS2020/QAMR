...
module FAU ( 
  ...
  nand3  g070(.a(new_n121_), .b(new_n110_), .c(new_n92_), .O(new_n122_));
  oai21  g071(.a(new_n122_), .b(new_n69_), .c(x27), .O(new_n123_));
  nor3   g072(.a(x22), .b(x21), .c(x20), .O(new_n124_));
  nor3   g073(.a(x27), .b(x26), .c(x25), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n95_), .c(new_n124_), .d(new_n55_), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n123_), .c(new_n77_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(x16), .O(new_n128_));
  oai21  g077(.a(new_n83_), .b(x07), .c(new_n128_), .O(z08));
  inv1   g078(.a(x26), .O(new_n130_));
  nor2   g079(.a(x28), .b(x27), .O(new_n131_));
  nand4  g080(.a(new_n131_), .b(new_n111_), .c(new_n130_), .d(new_n85_), .O(new_n132_));
  nor2   g081(.a(new_n132_), .b(new_n79_), .O(new_n133_));
  aoi21  g082(.a(new_n126_), .b(x28), .c(new_n133_), .O(new_n134_));
  ...
  nand2  g092(.a(new_n82_), .b(new_n143_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n142_), .O(z10));
  nand4  g094(.a(new_n110_), .b(new_n94_), .c(new_n68_), .d(new_n52_), .O(new_n146_));
  nor2   g095(.a(x30), .b(x29), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n131_), .c(new_n121_), .d(new_n92_), .O(new_n148_));
  ...
  nand2  g102(.a(new_n147_), .b(new_n131_), .O(new_n154_));
  inv1   g103(.a(new_n154_), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n114_), .c(new_n87_), .O(new_n156_));
  nor2   g105(.a(x27), .b(x26), .O(new_n157_));
  nor2   g106(.a(x29), .b(x28), .O(new_n158_));
  nor2   g107(.a(x31), .b(x30), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n158_), .c(new_n157_), .d(new_n102_), .O(new_n160_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n147_), .c(new_n131_), .d(new_n121_), .O(new_n169_));
  ...
  aoi21  g126(.a(new_n170_), .b(new_n167_), .c(new_n177_), .O(new_n178_));
  nor2   g127(.a(x33), .b(x32), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n159_), .c(new_n158_), .d(new_n157_), .O(new_n180_));
  nor2   g129(.a(new_n180_), .b(new_n112_), .O(new_n181_));
  ...
  oai21  g134(.a(new_n180_), .b(new_n112_), .c(x34), .O(new_n186_));
  nand2  g135(.a(new_n158_), .b(new_n157_), .O(new_n187_));
  ...
  nand3  g142(.a(new_n193_), .b(new_n177_), .c(new_n192_), .O(new_n194_));
  nor2   g143(.a(new_n194_), .b(new_n191_), .O(new_n195_));
  nand3  g144(.a(new_n195_), .b(new_n188_), .c(new_n104_), .O(new_n196_));
  nand3  g145(.a(new_n196_), .b(new_n186_), .c(new_n77_), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(x16), .O(new_n198_));
  inv1   g147(.a(x00), .O(new_n199_));
  nand2  g148(.a(new_n82_), .b(new_n199_), .O(new_n200_));
