...
module FAU ( 
  ...
  oai21  g030(.a(new_n81_), .b(new_n80_), .c(x05), .O(new_n82_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n93_), .c(new_n104_), .d(new_n55_), .O(new_n106_));
  ...
  nand3  g059(.a(new_n110_), .b(new_n108_), .c(x05), .O(z06));
  nand2  g060(.a(new_n106_), .b(x26), .O(new_n112_));
  nor3   g061(.a(x26), .b(x25), .c(x24), .O(new_n113_));
  nand4  g062(.a(new_n113_), .b(new_n93_), .c(new_n104_), .d(new_n55_), .O(new_n114_));
  ...
  nand2  g066(.a(new_n117_), .b(new_n61_), .O(z07));
  nand2  g067(.a(new_n114_), .b(x27), .O(new_n119_));
  nor3   g068(.a(x27), .b(x26), .c(x25), .O(new_n120_));
  nand4  g069(.a(new_n120_), .b(new_n97_), .c(new_n78_), .d(new_n55_), .O(new_n121_));
  ...
  nor2   g087(.a(new_n138_), .b(new_n94_), .O(new_n139_));
  aoi21  g088(.a(new_n129_), .b(x29), .c(new_n139_), .O(new_n140_));
  nor2   g089(.a(x18), .b(new_n69_), .O(new_n141_));
  oai21  g090(.a(new_n140_), .b(new_n58_), .c(new_n141_), .O(z10));
  oai21  g091(.a(new_n138_), .b(new_n94_), .c(x30), .O(new_n143_));
  ...
  nand2  g098(.a(new_n149_), .b(new_n61_), .O(z11));
  nand2  g099(.a(new_n146_), .b(x31), .O(new_n151_));
  nor2   g100(.a(x31), .b(x30), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n137_), .c(new_n120_), .O(new_n153_));
  ...
  nor3   g106(.a(new_n157_), .b(x18), .c(new_n69_), .O(new_n158_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n145_), .c(new_n144_), .d(new_n136_), .O(new_n162_));
  ...
  oai21  g127(.a(new_n178_), .b(new_n177_), .c(x05), .O(new_n179_));
  ...
  oai21  g143(.a(new_n194_), .b(new_n193_), .c(x05), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n61_), .O(z15));
endmodule
