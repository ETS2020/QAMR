...
module FAU ( 
  ...
  nand4  g049(.a(new_n100_), .b(new_n81_), .c(new_n62_), .d(new_n61_), .O(new_n101_));
  ...
  nand4  g056(.a(new_n96_), .b(new_n97_), .c(new_n80_), .d(new_n71_), .O(new_n108_));
  ...
  nand3  g073(.a(new_n124_), .b(new_n100_), .c(new_n107_), .O(new_n125_));
  ...
  nand3  g105(.a(new_n156_), .b(new_n119_), .c(new_n99_), .O(new_n157_));
  ...
  nand4  g109(.a(new_n154_), .b(new_n153_), .c(new_n142_), .d(new_n96_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n90_), .c(x31), .O(new_n162_));
  ...
  nand3  g115(.a(new_n166_), .b(new_n163_), .c(new_n109_), .O(new_n167_));
  ...
  nand4  g121(.a(new_n164_), .b(new_n143_), .c(new_n124_), .d(new_n107_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n101_), .c(x32), .O(new_n174_));
  nor2   g123(.a(x32), .b(x31), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n154_), .c(new_n153_), .d(new_n142_), .O(new_n176_));
  ...
  nand4  g133(.a(new_n107_), .b(new_n96_), .c(new_n97_), .d(new_n80_), .O(new_n185_));
  nor2   g134(.a(new_n185_), .b(new_n72_), .O(new_n186_));
  nor2   g135(.a(x33), .b(x32), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n164_), .c(new_n143_), .d(new_n124_), .O(new_n188_));
