...
module FAU ( 
  ...
  nand4  g041(.a(new_n92_), .b(new_n83_), .c(new_n65_), .d(new_n52_), .O(new_n93_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n102_), .c(new_n70_), .d(new_n55_), .O(new_n104_));
  oai21  g053(.a(new_n94_), .b(new_n101_), .c(new_n104_), .O(new_n105_));
  nand3  g054(.a(new_n105_), .b(new_n63_), .c(x16), .O(new_n106_));
  nand2  g055(.a(new_n106_), .b(new_n100_), .O(z06));
  nand4  g056(.a(new_n70_), .b(new_n53_), .c(new_n63_), .d(new_n52_), .O(new_n108_));
  nor2   g057(.a(x26), .b(x25), .O(new_n109_));
  nand3  g058(.a(new_n109_), .b(new_n102_), .c(new_n90_), .O(new_n110_));
  nor2   g059(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  aoi21  g060(.a(new_n104_), .b(x26), .c(new_n111_), .O(new_n112_));
  ...
  oai21  g065(.a(x18), .b(new_n116_), .c(new_n58_), .O(new_n117_));
  oai21  g066(.a(new_n110_), .b(new_n71_), .c(x27), .O(new_n118_));
  nor3   g067(.a(x27), .b(x26), .c(x25), .O(new_n119_));
  nand4  g068(.a(new_n119_), .b(new_n92_), .c(new_n77_), .d(new_n55_), .O(new_n120_));
  nand2  g069(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n63_), .c(x16), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n117_), .O(z08));
  inv1   g072(.a(x23), .O(new_n124_));
  inv1   g073(.a(x26), .O(new_n125_));
  nor2   g074(.a(x28), .b(x27), .O(new_n126_));
  nand4  g075(.a(new_n126_), .b(new_n103_), .c(new_n125_), .d(new_n124_), .O(new_n127_));
  nor2   g076(.a(new_n127_), .b(new_n84_), .O(new_n128_));
  ...
  oai21  g082(.a(x18), .b(new_n133_), .c(new_n58_), .O(new_n134_));
  oai21  g083(.a(new_n127_), .b(new_n84_), .c(x29), .O(new_n135_));
  nor3   g084(.a(x26), .b(x25), .c(x24), .O(new_n136_));
  nor3   g085(.a(x29), .b(x28), .c(x27), .O(new_n137_));
  nand4  g086(.a(new_n137_), .b(new_n136_), .c(new_n85_), .d(new_n82_), .O(new_n138_));
  nand2  g087(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n63_), .c(x16), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n134_), .O(z10));
  inv1   g090(.a(x21), .O(new_n142_));
  nand4  g091(.a(new_n102_), .b(new_n65_), .c(new_n142_), .d(new_n52_), .O(new_n143_));
  nor2   g092(.a(x30), .b(x29), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n126_), .c(new_n109_), .d(new_n90_), .O(new_n145_));
  nor2   g094(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  aoi21  g095(.a(new_n138_), .b(x30), .c(new_n146_), .O(new_n147_));
  ...
  nand4  g111(.a(new_n153_), .b(new_n152_), .c(new_n162_), .d(new_n101_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n93_), .c(x32), .O(new_n164_));
  nor2   g113(.a(x32), .b(x31), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n144_), .c(new_n126_), .d(new_n109_), .O(new_n166_));
  inv1   g115(.a(new_n166_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n94_), .O(new_n168_));
  ...
  oai21  g123(.a(x18), .b(new_n174_), .c(new_n58_), .O(new_n175_));
  oai21  g124(.a(new_n166_), .b(new_n93_), .c(x33), .O(new_n176_));
  nand2  g125(.a(new_n103_), .b(new_n102_), .O(new_n177_));
  inv1   g126(.a(new_n177_), .O(new_n178_));
  nand2  g127(.a(new_n152_), .b(new_n162_), .O(new_n179_));
  inv1   g128(.a(new_n179_), .O(new_n180_));
  nor2   g129(.a(x33), .b(x32), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n153_), .O(new_n182_));
  inv1   g131(.a(new_n182_), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n180_), .c(new_n178_), .d(new_n72_), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n176_), .O(new_n185_));
  nand3  g134(.a(new_n185_), .b(new_n63_), .c(x16), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(new_n175_), .O(z14));
  nand4  g136(.a(new_n181_), .b(new_n153_), .c(new_n152_), .d(new_n162_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n104_), .c(x34), .O(new_n189_));
  ...
  nand4  g146(.a(new_n197_), .b(new_n180_), .c(new_n178_), .d(new_n72_), .O(new_n198_));
