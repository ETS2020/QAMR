...
module FAU ( 
  ...
  nand4  g047(.a(new_n98_), .b(new_n78_), .c(new_n63_), .d(new_n52_), .O(new_n99_));
  ...
  nand4  g055(.a(new_n106_), .b(new_n105_), .c(new_n69_), .d(new_n55_), .O(new_n107_));
  ...
  nand3  g062(.a(new_n113_), .b(new_n105_), .c(new_n94_), .O(new_n114_));
  ...
  nor2   g068(.a(x17), .b(new_n58_), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n69_), .c(new_n53_), .O(new_n121_));
  inv1   g070(.a(x25), .O(new_n122_));
  nor2   g071(.a(x27), .b(x26), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n98_), .c(new_n122_), .O(new_n124_));
  oai21  g073(.a(new_n124_), .b(new_n121_), .c(new_n61_), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n76_), .O(new_n126_));
  oai21  g075(.a(new_n114_), .b(new_n70_), .c(x27), .O(new_n127_));
  ...
  nand4  g084(.a(new_n135_), .b(new_n106_), .c(new_n134_), .d(new_n133_), .O(new_n136_));
  oai21  g085(.a(new_n136_), .b(new_n121_), .c(new_n61_), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n76_), .O(new_n138_));
  oai21  g087(.a(new_n124_), .b(new_n79_), .c(x28), .O(new_n139_));
  inv1   g088(.a(x06), .O(new_n140_));
  nand2  g089(.a(new_n58_), .b(new_n140_), .O(new_n141_));
  oai21  g090(.a(new_n139_), .b(new_n58_), .c(new_n141_), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(new_n61_), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n138_), .O(z09));
  oai21  g093(.a(new_n136_), .b(new_n79_), .c(x29), .O(new_n145_));
  nor3   g094(.a(x26), .b(x25), .c(x24), .O(new_n146_));
  nor3   g095(.a(x29), .b(x28), .c(x27), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n146_), .c(new_n96_), .d(new_n95_), .O(new_n148_));
  ...
  nand3  g116(.a(new_n167_), .b(new_n163_), .c(new_n100_), .O(new_n168_));
  ...
  nand4  g122(.a(new_n98_), .b(new_n69_), .c(new_n55_), .d(x16), .O(new_n174_));
  nor2   g123(.a(x32), .b(x31), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n155_), .c(new_n135_), .d(new_n113_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n174_), .c(new_n61_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n76_), .O(new_n178_));
  nand4  g127(.a(new_n165_), .b(new_n164_), .c(new_n123_), .d(new_n122_), .O(new_n179_));
  ...
  oai21  g131(.a(new_n180_), .b(new_n58_), .c(new_n182_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(new_n61_), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n178_), .O(z13));
  nand4  g134(.a(new_n120_), .b(new_n106_), .c(new_n86_), .d(new_n63_), .O(new_n186_));
  nor2   g135(.a(x33), .b(x32), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n165_), .c(new_n164_), .d(new_n123_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n186_), .c(new_n61_), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(new_n76_), .O(new_n190_));
  oai21  g139(.a(new_n176_), .b(new_n99_), .c(x33), .O(new_n191_));
  inv1   g140(.a(x01), .O(new_n192_));
  nand2  g141(.a(new_n58_), .b(new_n192_), .O(new_n193_));
  oai21  g142(.a(new_n191_), .b(new_n58_), .c(new_n193_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n61_), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n190_), .O(z14));
  oai21  g145(.a(new_n188_), .b(new_n107_), .c(x34), .O(new_n197_));
  ...
  nand3  g153(.a(new_n204_), .b(new_n199_), .c(new_n108_), .O(new_n205_));
