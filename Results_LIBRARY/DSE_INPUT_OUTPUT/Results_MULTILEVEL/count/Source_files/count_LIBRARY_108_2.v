...
module FAU ( 
  ...
  nand2  g003(.a(x31), .b(x18), .O(new_n55_));
  ...
  nand4  g036(.a(new_n87_), .b(new_n61_), .c(new_n86_), .d(new_n59_), .O(new_n88_));
  aoi21  g037(.a(new_n88_), .b(new_n85_), .c(new_n66_), .O(new_n89_));
  ...
  aoi21  g052(.a(new_n66_), .b(new_n103_), .c(x18), .O(new_n104_));
  nand2  g053(.a(new_n104_), .b(new_n102_), .O(z05));
  nand4  g054(.a(new_n99_), .b(new_n83_), .c(new_n61_), .d(new_n59_), .O(new_n106_));
  nand2  g055(.a(new_n106_), .b(x25), .O(new_n107_));
  nor2   g056(.a(x25), .b(x24), .O(new_n108_));
  nand4  g057(.a(new_n108_), .b(new_n87_), .c(new_n71_), .d(new_n58_), .O(new_n109_));
  ...
  nand2  g061(.a(new_n112_), .b(new_n55_), .O(z06));
  nand2  g062(.a(new_n109_), .b(x26), .O(new_n114_));
  nor3   g063(.a(x26), .b(x25), .c(x24), .O(new_n115_));
  nand3  g064(.a(new_n115_), .b(new_n87_), .c(new_n73_), .O(new_n116_));
  aoi21  g065(.a(new_n116_), .b(new_n114_), .c(new_n66_), .O(new_n117_));
  nor2   g066(.a(x16), .b(x08), .O(new_n118_));
  oai21  g067(.a(new_n118_), .b(new_n117_), .c(new_n60_), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(new_n55_), .O(z07));
  nor2   g069(.a(x26), .b(x25), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n87_), .c(new_n93_), .O(new_n122_));
  oai21  g071(.a(new_n122_), .b(new_n72_), .c(x27), .O(new_n123_));
  nor3   g072(.a(x27), .b(x26), .c(x25), .O(new_n124_));
  nand4  g073(.a(new_n124_), .b(new_n99_), .c(new_n78_), .d(new_n58_), .O(new_n125_));
  aoi21  g074(.a(new_n125_), .b(new_n123_), .c(new_n66_), .O(new_n126_));
  nor2   g075(.a(x16), .b(x07), .O(new_n127_));
  oai21  g076(.a(new_n127_), .b(new_n126_), .c(new_n60_), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n55_), .O(z08));
  ...
  nand4  g084(.a(new_n135_), .b(new_n134_), .c(new_n78_), .d(new_n58_), .O(new_n136_));
  aoi21  g085(.a(new_n136_), .b(new_n133_), .c(new_n66_), .O(new_n137_));
  nor2   g086(.a(x16), .b(x06), .O(new_n138_));
  oai21  g087(.a(new_n138_), .b(new_n137_), .c(new_n60_), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n55_), .O(z09));
  inv1   g089(.a(x26), .O(new_n141_));
  nor2   g090(.a(x28), .b(x27), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n108_), .c(new_n141_), .d(new_n95_), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(new_n84_), .c(x29), .O(new_n144_));
  nor3   g093(.a(x29), .b(x28), .c(x27), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n115_), .c(new_n97_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n144_), .c(new_n66_), .O(new_n147_));
  nor2   g096(.a(x16), .b(x05), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n147_), .c(new_n60_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(new_n55_), .O(z10));
  inv1   g099(.a(x27), .O(new_n151_));
  nor2   g100(.a(x29), .b(x28), .O(new_n152_));
  nand4  g101(.a(new_n152_), .b(new_n121_), .c(new_n151_), .d(new_n93_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n88_), .c(x30), .O(new_n154_));
  inv1   g103(.a(x29), .O(new_n155_));
  inv1   g104(.a(x30), .O(new_n156_));
  nand3  g105(.a(new_n142_), .b(new_n156_), .c(new_n155_), .O(new_n157_));
  inv1   g106(.a(new_n157_), .O(new_n158_));
  nand3  g107(.a(new_n158_), .b(new_n115_), .c(new_n97_), .O(new_n159_));
  aoi21  g108(.a(new_n159_), .b(new_n154_), .c(new_n66_), .O(new_n160_));
  nor2   g109(.a(x16), .b(x04), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n160_), .c(new_n60_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n55_), .O(z11));
  nand2  g112(.a(new_n159_), .b(x31), .O(new_n164_));
  inv1   g113(.a(new_n106_), .O(new_n165_));
  nor2   g114(.a(x31), .b(x30), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n152_), .c(new_n124_), .d(new_n165_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(x16), .O(new_n169_));
  inv1   g118(.a(x03), .O(new_n170_));
  aoi21  g119(.a(new_n66_), .b(new_n170_), .c(x18), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n169_), .O(z12));
  nand3  g121(.a(new_n166_), .b(new_n152_), .c(new_n124_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n106_), .c(x32), .O(new_n174_));
  nor2   g123(.a(x32), .b(x31), .O(new_n175_));
  nand3  g124(.a(new_n175_), .b(new_n156_), .c(new_n155_), .O(new_n176_));
  inv1   g125(.a(new_n176_), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n142_), .c(new_n121_), .d(new_n165_), .O(new_n178_));
  ...
  nand4  g133(.a(new_n184_), .b(new_n166_), .c(new_n152_), .d(new_n131_), .O(new_n185_));
  nor2   g134(.a(new_n185_), .b(new_n109_), .O(new_n186_));
  aoi21  g135(.a(new_n178_), .b(x33), .c(new_n186_), .O(new_n187_));
  inv1   g136(.a(x01), .O(new_n188_));
  aoi21  g137(.a(new_n66_), .b(new_n188_), .c(x18), .O(new_n189_));
  oai21  g138(.a(new_n187_), .b(new_n66_), .c(new_n189_), .O(z14));
  inv1   g139(.a(x34), .O(new_n191_));
  nand2  g140(.a(new_n152_), .b(new_n131_), .O(new_n192_));
  inv1   g141(.a(new_n192_), .O(new_n193_));
  nor3   g142(.a(x34), .b(x33), .c(x32), .O(new_n194_));
  nand3  g143(.a(new_n194_), .b(new_n193_), .c(new_n166_), .O(new_n195_));
  oai22  g144(.a(new_n195_), .b(new_n109_), .c(new_n186_), .d(new_n191_), .O(new_n196_));
