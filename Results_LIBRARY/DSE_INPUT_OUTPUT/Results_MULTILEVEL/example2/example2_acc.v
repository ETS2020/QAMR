// Benchmark "FAU" written by ABC on Thu Aug 13 10:16:23 2020
...
module FAU ( 
  ...
  aoi21  g010(.a(new_n152_), .b(new_n160_), .c(new_n161_), .O(new_n162_));
  ...
  nand4  g020(.a(new_n161_), .b(x78), .c(x52), .d(new_n164_), .O(new_n172_));
  ...
  nand4  g076(.a(new_n227_), .b(new_n169_), .c(x79), .d(new_n225_), .O(new_n228_));
  ...
  or2    g082(.a(new_n233_), .b(new_n231_), .O(new_n234_));
  nand3  g083(.a(new_n234_), .b(x77), .c(new_n229_), .O(new_n235_));
  ...
  nand3  g088(.a(new_n161_), .b(x05), .c(new_n239_), .O(new_n240_));
  nand3  g089(.a(new_n240_), .b(new_n164_), .c(x00), .O(z23));
  aoi21  g090(.a(new_n159_), .b(x79), .c(x43), .O(new_n242_));
  ...
  nand4  g101(.a(new_n252_), .b(new_n229_), .c(x05), .d(new_n239_), .O(new_n253_));
  nor2   g102(.a(new_n253_), .b(x01), .O(z25));
  nand4  g103(.a(new_n252_), .b(x44), .c(new_n229_), .d(new_n239_), .O(new_n255_));
  nor2   g104(.a(new_n255_), .b(x01), .O(z26));
  nand4  g105(.a(new_n252_), .b(x45), .c(new_n229_), .d(new_n239_), .O(new_n257_));
  nor2   g106(.a(new_n257_), .b(x01), .O(z27));
  nand4  g107(.a(new_n252_), .b(x46), .c(new_n229_), .d(new_n239_), .O(new_n259_));
  nor2   g108(.a(new_n259_), .b(x01), .O(z28));
  nand4  g109(.a(new_n252_), .b(x47), .c(new_n229_), .d(new_n239_), .O(new_n261_));
  nor2   g110(.a(new_n261_), .b(x01), .O(z29));
  nand4  g111(.a(new_n252_), .b(x48), .c(new_n229_), .d(new_n239_), .O(new_n263_));
  nor2   g112(.a(new_n263_), .b(x01), .O(z30));
  nand4  g113(.a(new_n252_), .b(x49), .c(new_n229_), .d(new_n239_), .O(new_n265_));
  nor2   g114(.a(new_n265_), .b(x01), .O(z31));
  nand4  g115(.a(new_n252_), .b(x50), .c(new_n229_), .d(new_n239_), .O(new_n267_));
  nor2   g116(.a(new_n267_), .b(x01), .O(z32));
  nand2  g117(.a(x83), .b(new_n247_), .O(new_n269_));
  nand2  g118(.a(new_n232_), .b(x81), .O(new_n270_));
  ...
  aoi21  g129(.a(new_n280_), .b(new_n275_), .c(new_n161_), .O(new_n281_));
  nand4  g130(.a(new_n281_), .b(x78), .c(x77), .d(new_n239_), .O(new_n282_));
  nor2   g131(.a(new_n282_), .b(x01), .O(z33));
  nor2   g132(.a(new_n232_), .b(new_n229_), .O(new_n284_));
  nand3  g133(.a(x83), .b(x81), .c(x42), .O(new_n285_));
  oai21  g134(.a(new_n284_), .b(x81), .c(new_n285_), .O(new_n286_));
  nand2  g135(.a(new_n286_), .b(new_n248_), .O(new_n287_));
  oai22  g136(.a(new_n284_), .b(new_n247_), .c(new_n269_), .d(new_n229_), .O(new_n288_));
  nand2  g137(.a(new_n288_), .b(new_n245_), .O(new_n289_));
  aoi21  g138(.a(new_n289_), .b(new_n287_), .c(new_n161_), .O(new_n290_));
  ...
  nand4  g143(.a(new_n290_), .b(x78), .c(x77), .d(x54), .O(new_n295_));
  nor3   g144(.a(new_n295_), .b(x04), .c(x01), .O(z36));
  nand4  g145(.a(new_n290_), .b(x78), .c(x77), .d(x55), .O(new_n297_));
  nor3   g146(.a(new_n297_), .b(x04), .c(x01), .O(z37));
  nand4  g147(.a(new_n290_), .b(x78), .c(x77), .d(x56), .O(new_n299_));
  nor3   g148(.a(new_n299_), .b(x04), .c(x01), .O(z38));
  nand4  g149(.a(new_n290_), .b(x78), .c(x77), .d(x57), .O(new_n301_));
  nor3   g150(.a(new_n301_), .b(x04), .c(x01), .O(z39));
  nand4  g151(.a(new_n290_), .b(x78), .c(x77), .d(x58), .O(new_n303_));
  nor3   g152(.a(new_n303_), .b(x04), .c(x01), .O(z40));
  nand4  g153(.a(new_n290_), .b(x78), .c(x77), .d(x59), .O(new_n305_));
  nor3   g154(.a(new_n305_), .b(x04), .c(x01), .O(z41));
  nand4  g155(.a(new_n290_), .b(x78), .c(x77), .d(x60), .O(new_n307_));
  nor3   g156(.a(new_n307_), .b(x04), .c(x01), .O(z42));
  nand4  g157(.a(new_n290_), .b(x78), .c(x77), .d(x61), .O(new_n309_));
  nor3   g158(.a(new_n309_), .b(x04), .c(x01), .O(z43));
  nand4  g159(.a(new_n290_), .b(x78), .c(x77), .d(x62), .O(new_n311_));
  nor3   g160(.a(new_n311_), .b(x04), .c(x01), .O(z44));
  nand4  g161(.a(new_n290_), .b(x78), .c(x77), .d(x63), .O(new_n313_));
  nor3   g162(.a(new_n313_), .b(x04), .c(x01), .O(z45));
  nand4  g163(.a(new_n290_), .b(x78), .c(x77), .d(x64), .O(new_n315_));
  nor3   g164(.a(new_n315_), .b(x04), .c(x01), .O(z46));
  nand2  g165(.a(x52), .b(x15), .O(new_n317_));
  inv1   g166(.a(x52), .O(new_n318_));
  nand2  g167(.a(new_n318_), .b(x07), .O(new_n319_));
  aoi21  g168(.a(new_n319_), .b(new_n317_), .c(x79), .O(new_n320_));
  nand4  g169(.a(new_n320_), .b(x78), .c(new_n160_), .d(x04), .O(new_n321_));
  nor2   g170(.a(x75), .b(x67), .O(new_n322_));
  nor2   g171(.a(new_n322_), .b(new_n226_), .O(new_n323_));
  nand4  g172(.a(new_n323_), .b(x79), .c(new_n152_), .d(x77), .O(new_n324_));
  aoi21  g173(.a(new_n324_), .b(new_n321_), .c(x01), .O(z47));
  nand2  g174(.a(x52), .b(x16), .O(new_n326_));
  nand2  g175(.a(new_n318_), .b(x08), .O(new_n327_));
  aoi21  g176(.a(new_n327_), .b(new_n326_), .c(x79), .O(new_n328_));
  nand4  g177(.a(new_n328_), .b(x78), .c(new_n160_), .d(x04), .O(new_n329_));
  nand4  g178(.a(new_n227_), .b(x79), .c(new_n152_), .d(x77), .O(new_n330_));
  ...
  nand2  g213(.a(new_n318_), .b(x14), .O(new_n365_));
  ...
  nand2  g221(.a(new_n372_), .b(new_n247_), .O(new_n373_));
  nor4   g222(.a(new_n373_), .b(new_n369_), .c(new_n232_), .d(x82), .O(z55));
  nand2  g223(.a(x84), .b(new_n247_), .O(new_n375_));
  nand2  g224(.a(new_n369_), .b(x81), .O(new_n376_));
  nand2  g225(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  or2    g226(.a(new_n377_), .b(x76), .O(new_n378_));
  nand3  g227(.a(new_n378_), .b(new_n159_), .c(x79), .O(new_n379_));
  aoi21  g228(.a(new_n152_), .b(new_n160_), .c(x01), .O(new_n380_));
  nand3  g229(.a(new_n380_), .b(new_n379_), .c(x00), .O(z56));
  inv1   g230(.a(x02), .O(new_n382_));
  nand4  g231(.a(x03), .b(new_n382_), .c(new_n164_), .d(x00), .O(new_n383_));
  inv1   g232(.a(new_n383_), .O(z57));
  nand4  g233(.a(x80), .b(new_n230_), .c(x43), .d(new_n229_), .O(new_n385_));
  oai22  g234(.a(new_n385_), .b(new_n233_), .c(new_n229_), .d(x40), .O(new_n386_));
  nand4  g235(.a(new_n386_), .b(x79), .c(x78), .d(x04), .O(new_n387_));
  nand4  g236(.a(new_n161_), .b(new_n152_), .c(new_n229_), .d(x40), .O(new_n388_));
  nand2  g237(.a(new_n388_), .b(new_n387_), .O(new_n389_));
  nand2  g238(.a(new_n389_), .b(x77), .O(new_n390_));
  oai21  g239(.a(new_n165_), .b(new_n239_), .c(new_n161_), .O(new_n391_));
  ...
  nand3  g243(.a(new_n234_), .b(new_n229_), .c(x04), .O(new_n395_));
  aoi21  g244(.a(new_n395_), .b(x79), .c(new_n152_), .O(new_n396_));
  oai21  g245(.a(new_n396_), .b(new_n394_), .c(x77), .O(new_n397_));
  nand2  g246(.a(new_n161_), .b(new_n239_), .O(new_n398_));
  aoi21  g247(.a(new_n398_), .b(new_n397_), .c(x01), .O(z59));
  nand3  g248(.a(x79), .b(new_n152_), .c(x77), .O(new_n400_));
  inv1   g249(.a(new_n400_), .O(new_n401_));
  oai21  g250(.a(new_n401_), .b(new_n165_), .c(new_n377_), .O(new_n402_));
  oai21  g251(.a(x78), .b(new_n239_), .c(new_n161_), .O(new_n403_));
  nand3  g252(.a(new_n232_), .b(x82), .c(x81), .O(new_n404_));
  oai21  g253(.a(new_n404_), .b(new_n231_), .c(x77), .O(new_n405_));
  nand2  g254(.a(new_n405_), .b(new_n376_), .O(new_n406_));
  nand4  g255(.a(new_n406_), .b(x78), .c(new_n229_), .d(x04), .O(new_n407_));
  nand3  g256(.a(new_n407_), .b(new_n403_), .c(new_n402_), .O(new_n408_));
  and2   g257(.a(new_n408_), .b(new_n164_), .O(z60));
  nor2   g258(.a(new_n167_), .b(new_n165_), .O(new_n410_));
  oai22  g259(.a(new_n410_), .b(new_n226_), .c(new_n159_), .d(x04), .O(new_n411_));
  nand4  g260(.a(new_n411_), .b(x80), .c(x79), .d(new_n164_), .O(new_n412_));
  inv1   g261(.a(new_n412_), .O(z61));
  nand3  g262(.a(new_n247_), .b(x77), .c(new_n229_), .O(new_n414_));
  nand2  g263(.a(new_n414_), .b(x79), .O(new_n415_));
  nand2  g264(.a(new_n415_), .b(x04), .O(new_n416_));
  nand2  g265(.a(new_n369_), .b(new_n229_), .O(new_n417_));
  aoi21  g266(.a(new_n417_), .b(x04), .c(new_n160_), .O(new_n418_));
  nand2  g267(.a(new_n230_), .b(x43), .O(new_n419_));
  nand3  g268(.a(new_n232_), .b(x82), .c(x80), .O(new_n420_));
  oai21  g269(.a(new_n420_), .b(new_n419_), .c(new_n229_), .O(new_n421_));
  aoi21  g270(.a(new_n421_), .b(x77), .c(new_n369_), .O(new_n422_));
  oai21  g271(.a(new_n422_), .b(new_n418_), .c(x81), .O(new_n423_));
  oai21  g272(.a(new_n423_), .b(new_n161_), .c(new_n416_), .O(new_n424_));
  nand2  g273(.a(new_n424_), .b(x78), .O(new_n425_));
  nand4  g274(.a(new_n167_), .b(x84), .c(x81), .d(x79), .O(new_n426_));
  aoi21  g275(.a(new_n426_), .b(new_n425_), .c(x01), .O(z62));
  nand4  g276(.a(new_n411_), .b(x82), .c(x79), .d(new_n164_), .O(new_n428_));
  inv1   g277(.a(new_n428_), .O(z63));
  nand3  g278(.a(new_n411_), .b(x83), .c(x79), .O(new_n430_));
  nand3  g279(.a(new_n153_), .b(new_n160_), .c(x04), .O(new_n431_));
  aoi21  g280(.a(new_n431_), .b(new_n430_), .c(x01), .O(z64));
  nor2   g281(.a(new_n152_), .b(x04), .O(new_n433_));
  nor2   g282(.a(new_n247_), .b(x78), .O(new_n434_));
  oai21  g283(.a(new_n434_), .b(new_n433_), .c(x77), .O(new_n435_));
  nand3  g284(.a(x81), .b(x78), .c(new_n160_), .O(new_n436_));
  nand2  g285(.a(new_n436_), .b(new_n435_), .O(new_n437_));
  nand4  g286(.a(new_n437_), .b(x84), .c(x79), .d(new_n164_), .O(new_n438_));
