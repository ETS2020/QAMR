...
module FAU ( 
  ...
  oai21  g018(.a(x34), .b(new_n160_), .c(new_n169_), .O(new_n170_));
  ...
  oai21  g065(.a(new_n169_), .b(new_n155_), .c(x34), .O(new_n217_));
  ...
  aoi21  g101(.a(x05), .b(new_n252_), .c(x34), .O(new_n253_));
  ...
  nand4  g128(.a(new_n279_), .b(new_n240_), .c(new_n252_), .d(new_n160_), .O(new_n280_));
  nand2  g129(.a(new_n280_), .b(new_n154_), .O(z30));
  ...
  nand4  g134(.a(new_n285_), .b(new_n240_), .c(new_n252_), .d(new_n160_), .O(new_n286_));
  ...
  nand4  g182(.a(new_n313_), .b(x62), .c(new_n252_), .d(new_n160_), .O(new_n334_));
  ...
  nand4  g186(.a(new_n313_), .b(x64), .c(new_n252_), .d(new_n160_), .O(new_n338_));
  ...
  nand4  g201(.a(new_n352_), .b(new_n169_), .c(x78), .d(new_n161_), .O(new_n353_));
  ...
  nand3  g205(.a(new_n356_), .b(new_n162_), .c(x77), .O(new_n357_));
  ...
  aoi21  g251(.a(new_n402_), .b(new_n401_), .c(new_n162_), .O(new_n403_));
  ...
  nand4  g271(.a(new_n169_), .b(new_n162_), .c(new_n240_), .d(x40), .O(new_n423_));
  ...
  nand4  g308(.a(new_n447_), .b(x82), .c(x79), .d(new_n160_), .O(new_n460_));
  inv1   g309(.a(new_n460_), .O(z63));
  nand3  g310(.a(new_n447_), .b(x83), .c(x79), .O(new_n462_));
  nor2   g311(.a(x34), .b(new_n252_), .O(new_n463_));
  nand4  g312(.a(new_n463_), .b(new_n169_), .c(x78), .d(new_n161_), .O(new_n464_));
