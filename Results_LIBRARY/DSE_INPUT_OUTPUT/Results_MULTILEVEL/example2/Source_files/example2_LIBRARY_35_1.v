...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n158_,
    ...
    new_n224_, new_n225_, new_n227_, new_n239_, new_n240_, new_n241_,
  ...
  aoi21  g019(.a(new_n171_), .b(new_n170_), .c(z25), .O(z05));
  ...
  nand3  g043(.a(new_n195_), .b(new_n194_), .c(new_n158_), .O(z13));
  ...
  nand4  g068(.a(new_n156_), .b(x78), .c(x04), .d(new_n160_), .O(new_n221_));
  ...
  oai21  g073(.a(new_n225_), .b(x79), .c(new_n160_), .O(z23));
  nand3  g074(.a(x05), .b(new_n224_), .c(new_n160_), .O(new_n227_));
  ...
  nand2  g118(.a(new_n281_), .b(new_n239_), .O(new_n282_));
  nand3  g119(.a(new_n282_), .b(z01), .c(x00), .O(z56));
  inv1   g120(.a(x02), .O(new_n284_));
  nand3  g121(.a(x03), .b(new_n284_), .c(x00), .O(new_n285_));
  aoi21  g122(.a(new_n285_), .b(new_n156_), .c(x01), .O(z57));
  aoi21  g123(.a(x78), .b(new_n239_), .c(new_n224_), .O(new_n287_));
  ...
  and2   g127(.a(new_n290_), .b(new_n160_), .O(z58));
  ...
  aoi21  g136(.a(new_n301_), .b(new_n156_), .c(x01), .O(z64));
  zero   g137(.O(z02));
  zero   g138(.O(z28));
  zero   g139(.O(z29));
  zero   g140(.O(z30));
