...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n172_, new_n176_, new_n177_, new_n178_, new_n180_, new_n181_,
  ...
  nor2   g023(.a(new_n163_), .b(x01), .O(z04));
  ...
  aoi21  g030(.a(new_n181_), .b(new_n180_), .c(z03), .O(z06));
  nand2  g031(.a(new_n152_), .b(x25), .O(new_n183_));
  nand2  g032(.a(x63), .b(x40), .O(new_n184_));
  aoi21  g033(.a(new_n184_), .b(new_n183_), .c(z03), .O(z07));
  ...
  nand3  g060(.a(new_n211_), .b(new_n210_), .c(new_n176_), .O(z16));
  ...
  nand3  g066(.a(new_n217_), .b(new_n216_), .c(new_n176_), .O(z18));
  ...
  nand3  g072(.a(new_n223_), .b(new_n222_), .c(new_n176_), .O(z20));
  ...
  nor2   g085(.a(new_n236_), .b(new_n162_), .O(new_n237_));
  nand4  g086(.a(new_n237_), .b(x77), .c(new_n231_), .d(x04), .O(new_n238_));
  nand3  g087(.a(new_n238_), .b(new_n230_), .c(x79), .O(new_n239_));
  and2   g088(.a(new_n239_), .b(new_n166_), .O(z22));
  nand2  g089(.a(new_n166_), .b(x00), .O(new_n241_));
  inv1   g090(.a(new_n241_), .O(new_n242_));
  nand2  g091(.a(new_n242_), .b(x79), .O(z23));
  inv1   g092(.a(x04), .O(new_n244_));
  nor2   g093(.a(new_n160_), .b(x43), .O(new_n245_));
  ...
  nand4  g104(.a(new_n255_), .b(new_n231_), .c(x05), .d(new_n244_), .O(new_n256_));
  nor2   g105(.a(new_n256_), .b(x01), .O(z25));
  nand4  g106(.a(new_n255_), .b(x44), .c(new_n231_), .d(new_n244_), .O(new_n258_));
  nor2   g107(.a(new_n258_), .b(x01), .O(z26));
  nand3  g108(.a(new_n253_), .b(x78), .c(x77), .O(new_n260_));
  inv1   g109(.a(new_n260_), .O(new_n261_));
  nand4  g110(.a(new_n261_), .b(x45), .c(new_n231_), .d(new_n244_), .O(new_n262_));
  aoi21  g111(.a(new_n262_), .b(x79), .c(x01), .O(z27));
  nand4  g112(.a(new_n261_), .b(x46), .c(new_n231_), .d(new_n244_), .O(new_n264_));
  aoi21  g113(.a(new_n264_), .b(x79), .c(x01), .O(z28));
  nand4  g114(.a(new_n261_), .b(x47), .c(new_n231_), .d(new_n244_), .O(new_n266_));
  aoi21  g115(.a(new_n266_), .b(x79), .c(x01), .O(z29));
  nand4  g116(.a(new_n261_), .b(x48), .c(new_n231_), .d(new_n244_), .O(new_n268_));
  aoi21  g117(.a(new_n268_), .b(x79), .c(x01), .O(z30));
  nand4  g118(.a(new_n255_), .b(x49), .c(new_n231_), .d(new_n244_), .O(new_n270_));
  nor2   g119(.a(new_n270_), .b(x01), .O(z31));
  nand4  g120(.a(new_n261_), .b(x50), .c(new_n231_), .d(new_n244_), .O(new_n272_));
  aoi21  g121(.a(new_n272_), .b(x79), .c(x01), .O(z32));
  xor2a  g122(.a(x83), .b(x81), .O(new_n274_));
  nand3  g123(.a(new_n274_), .b(x42), .c(x05), .O(new_n275_));
  nand3  g124(.a(x81), .b(x51), .c(new_n231_), .O(new_n276_));
  ...
  nand3  g129(.a(new_n250_), .b(x51), .c(new_n231_), .O(new_n281_));
  nand2  g130(.a(new_n281_), .b(new_n280_), .O(new_n282_));
  nand2  g131(.a(new_n282_), .b(new_n251_), .O(new_n283_));
  aoi21  g132(.a(new_n283_), .b(new_n278_), .c(new_n163_), .O(new_n284_));
  nand4  g133(.a(new_n284_), .b(x78), .c(x77), .d(new_n244_), .O(new_n285_));
  ...
  nand4  g145(.a(new_n296_), .b(x77), .c(x52), .d(new_n244_), .O(new_n297_));
  aoi21  g146(.a(new_n297_), .b(x79), .c(x01), .O(z34));
  nand4  g147(.a(new_n296_), .b(x77), .c(x53), .d(new_n244_), .O(new_n299_));
  aoi21  g148(.a(new_n299_), .b(x79), .c(x01), .O(z35));
  aoi21  g149(.a(new_n295_), .b(new_n290_), .c(new_n163_), .O(new_n301_));
  nand4  g150(.a(new_n301_), .b(x78), .c(x77), .d(x54), .O(new_n302_));
  nor3   g151(.a(new_n302_), .b(x04), .c(x01), .O(z36));
  nand4  g152(.a(new_n296_), .b(x77), .c(x55), .d(new_n244_), .O(new_n304_));
  aoi21  g153(.a(new_n304_), .b(x79), .c(x01), .O(z37));
  nand4  g154(.a(new_n296_), .b(x77), .c(x56), .d(new_n244_), .O(new_n306_));
  aoi21  g155(.a(new_n306_), .b(x79), .c(x01), .O(z38));
  nand4  g156(.a(new_n296_), .b(x77), .c(x57), .d(new_n244_), .O(new_n308_));
  aoi21  g157(.a(new_n308_), .b(x79), .c(x01), .O(z39));
  nand4  g158(.a(new_n296_), .b(x77), .c(x58), .d(new_n244_), .O(new_n310_));
  aoi21  g159(.a(new_n310_), .b(x79), .c(x01), .O(z40));
  nand4  g160(.a(new_n296_), .b(x77), .c(x59), .d(new_n244_), .O(new_n312_));
  aoi21  g161(.a(new_n312_), .b(x79), .c(x01), .O(z41));
  nand4  g162(.a(new_n296_), .b(x77), .c(x60), .d(new_n244_), .O(new_n314_));
  aoi21  g163(.a(new_n314_), .b(x79), .c(x01), .O(z42));
  nand4  g164(.a(new_n296_), .b(x77), .c(x61), .d(new_n244_), .O(new_n316_));
  aoi21  g165(.a(new_n316_), .b(x79), .c(x01), .O(z43));
  nand4  g166(.a(new_n301_), .b(x78), .c(x77), .d(x62), .O(new_n318_));
  ...
  nand4  g170(.a(new_n296_), .b(x77), .c(x64), .d(new_n244_), .O(new_n322_));
  aoi21  g171(.a(new_n322_), .b(x79), .c(x01), .O(z46));
  inv1   g172(.a(x67), .O(new_n324_));
  nand2  g173(.a(new_n168_), .b(new_n324_), .O(new_n325_));
  nand4  g174(.a(new_n325_), .b(new_n229_), .c(x79), .d(new_n162_), .O(new_n326_));
  nor3   g175(.a(new_n326_), .b(new_n161_), .c(x01), .O(z47));
  inv1   g176(.a(x68), .O(new_n328_));
  nand4  g177(.a(new_n229_), .b(x79), .c(new_n162_), .d(x77), .O(new_n329_));
  nor3   g178(.a(new_n329_), .b(new_n328_), .c(x01), .O(z48));
  nand3  g179(.a(new_n229_), .b(new_n162_), .c(x77), .O(new_n331_));
  inv1   g180(.a(new_n331_), .O(new_n332_));
  nand2  g181(.a(new_n332_), .b(x69), .O(new_n333_));
  aoi21  g182(.a(new_n333_), .b(x79), .c(x01), .O(z49));
  nand2  g183(.a(new_n332_), .b(x70), .O(new_n335_));
  aoi21  g184(.a(new_n335_), .b(x79), .c(x01), .O(z50));
  inv1   g185(.a(x71), .O(new_n337_));
  nor3   g186(.a(new_n329_), .b(new_n337_), .c(x01), .O(z51));
  ...
  nor2   g191(.a(new_n161_), .b(x04), .O(new_n343_));
  nor2   g192(.a(x80), .b(new_n162_), .O(new_n344_));
  nor2   g193(.a(x82), .b(x81), .O(new_n345_));
  inv1   g194(.a(x84), .O(new_n346_));
  nor2   g195(.a(new_n346_), .b(new_n234_), .O(new_n347_));
  nand4  g196(.a(new_n347_), .b(new_n345_), .c(new_n344_), .d(new_n343_), .O(new_n348_));
  aoi21  g197(.a(new_n348_), .b(x79), .c(x01), .O(z55));
  xor2a  g198(.a(x84), .b(x81), .O(new_n350_));
  oai21  g199(.a(new_n350_), .b(x76), .c(new_n160_), .O(new_n351_));
  nand3  g200(.a(new_n351_), .b(new_n242_), .c(new_n164_), .O(z56));
  inv1   g201(.a(x03), .O(new_n353_));
  nor4   g202(.a(new_n241_), .b(new_n163_), .c(new_n353_), .d(x02), .O(z57));
  nand4  g203(.a(x80), .b(new_n232_), .c(x43), .d(new_n231_), .O(new_n355_));
  oai22  g204(.a(new_n355_), .b(new_n235_), .c(new_n231_), .d(x40), .O(new_n356_));
  nand4  g205(.a(new_n356_), .b(x79), .c(x78), .d(x77), .O(new_n357_));
  nor3   g206(.a(new_n357_), .b(new_n244_), .c(x01), .O(z58));
  oai21  g207(.a(new_n235_), .b(new_n233_), .c(new_n231_), .O(new_n359_));
  aoi21  g208(.a(new_n359_), .b(new_n152_), .c(new_n163_), .O(new_n360_));
  nand4  g209(.a(new_n360_), .b(x78), .c(x77), .d(x04), .O(new_n361_));
  nor2   g210(.a(new_n361_), .b(x01), .O(z59));
  nand2  g211(.a(new_n170_), .b(new_n169_), .O(new_n363_));
  nand2  g212(.a(new_n363_), .b(new_n350_), .O(new_n364_));
  oai21  g213(.a(new_n235_), .b(new_n233_), .c(x79), .O(new_n365_));
  nor2   g214(.a(new_n365_), .b(new_n162_), .O(new_n366_));
  nand4  g215(.a(new_n366_), .b(x77), .c(new_n231_), .d(x04), .O(new_n367_));
  nand3  g216(.a(new_n367_), .b(new_n364_), .c(x79), .O(new_n368_));
  and2   g217(.a(new_n368_), .b(new_n166_), .O(z60));
  nand2  g218(.a(new_n363_), .b(new_n229_), .O(new_n370_));
  oai21  g219(.a(new_n160_), .b(x04), .c(new_n370_), .O(new_n371_));
  nand4  g220(.a(new_n371_), .b(x80), .c(x79), .d(new_n166_), .O(new_n372_));
  inv1   g221(.a(new_n372_), .O(z61));
  nand2  g222(.a(x78), .b(new_n244_), .O(new_n374_));
  nand2  g223(.a(x84), .b(new_n162_), .O(new_n375_));
  aoi21  g224(.a(new_n375_), .b(new_n374_), .c(new_n161_), .O(new_n376_));
  nor3   g225(.a(new_n346_), .b(new_n162_), .c(x77), .O(new_n377_));
  oai21  g226(.a(new_n377_), .b(new_n376_), .c(x81), .O(new_n378_));
  nand2  g227(.a(new_n378_), .b(new_n238_), .O(new_n379_));
  nand3  g228(.a(new_n379_), .b(x79), .c(new_n166_), .O(new_n380_));
  inv1   g229(.a(new_n380_), .O(z62));
  nand2  g230(.a(new_n371_), .b(x82), .O(new_n382_));
  aoi21  g231(.a(new_n382_), .b(x79), .c(x01), .O(z63));
  nand2  g232(.a(new_n371_), .b(x83), .O(new_n384_));
  aoi21  g233(.a(new_n384_), .b(x79), .c(x01), .O(z64));
  nand2  g234(.a(x81), .b(new_n162_), .O(new_n386_));
  aoi21  g235(.a(new_n386_), .b(new_n374_), .c(new_n161_), .O(new_n387_));
  nor3   g236(.a(new_n250_), .b(new_n162_), .c(x77), .O(new_n388_));
  oai21  g237(.a(new_n388_), .b(new_n387_), .c(x84), .O(new_n389_));
  aoi21  g238(.a(new_n389_), .b(x79), .c(x01), .O(z65));
