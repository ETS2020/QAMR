...
module FAU ( 
  ...
  nand3  g012(.a(x77), .b(x66), .c(new_n153_), .O(new_n164_));
  ...
  oai21  g077(.a(x01), .b(new_n228_), .c(new_n155_), .O(new_n229_));
  ...
  nand4  g087(.a(new_n247_), .b(x78), .c(new_n159_), .d(x04), .O(new_n248_));
  xor2a  g088(.a(x84), .b(x81), .O(new_n249_));
  nor2   g089(.a(x75), .b(x67), .O(new_n250_));
  nor2   g090(.a(new_n250_), .b(new_n249_), .O(new_n251_));
  nand4  g091(.a(new_n251_), .b(x79), .c(new_n163_), .d(x77), .O(new_n252_));
  aoi21  g092(.a(new_n252_), .b(new_n248_), .c(x01), .O(z47));
  inv1   g093(.a(x08), .O(new_n254_));
  nand2  g094(.a(x52), .b(x16), .O(new_n255_));
  oai21  g095(.a(x52), .b(new_n254_), .c(new_n255_), .O(new_n256_));
  nand4  g096(.a(new_n256_), .b(x78), .c(new_n159_), .d(x04), .O(new_n257_));
  nand4  g097(.a(new_n222_), .b(x79), .c(x77), .d(x68), .O(new_n258_));
  nand2  g098(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  nand2  g099(.a(new_n259_), .b(new_n153_), .O(new_n260_));
  nand2  g100(.a(new_n260_), .b(new_n155_), .O(z48));
  inv1   g101(.a(x09), .O(new_n262_));
  nand2  g102(.a(x52), .b(x17), .O(new_n263_));
  oai21  g103(.a(x52), .b(new_n262_), .c(new_n263_), .O(new_n264_));
  nand4  g104(.a(new_n264_), .b(x78), .c(new_n159_), .d(x04), .O(new_n265_));
  nand4  g105(.a(new_n222_), .b(x79), .c(x77), .d(x69), .O(new_n266_));
  nand2  g106(.a(new_n266_), .b(new_n265_), .O(new_n267_));
  nand2  g107(.a(new_n267_), .b(new_n153_), .O(new_n268_));
  nand2  g108(.a(new_n268_), .b(new_n155_), .O(z49));
  nand2  g109(.a(x52), .b(x18), .O(new_n270_));
  nand2  g110(.a(new_n245_), .b(x10), .O(new_n271_));
  aoi21  g111(.a(new_n271_), .b(new_n270_), .c(x79), .O(new_n272_));
  nand4  g112(.a(new_n272_), .b(x78), .c(new_n159_), .d(x04), .O(new_n273_));
  nor2   g113(.a(new_n249_), .b(new_n160_), .O(new_n274_));
  nand4  g114(.a(new_n274_), .b(new_n163_), .c(x77), .d(x70), .O(new_n275_));
  aoi21  g115(.a(new_n275_), .b(new_n273_), .c(x01), .O(z50));
  nand2  g116(.a(x52), .b(x19), .O(new_n277_));
  nand2  g117(.a(new_n245_), .b(x11), .O(new_n278_));
  aoi21  g118(.a(new_n278_), .b(new_n277_), .c(x79), .O(new_n279_));
  nand4  g119(.a(new_n279_), .b(x78), .c(new_n159_), .d(x04), .O(new_n280_));
  nand4  g120(.a(new_n274_), .b(new_n163_), .c(x77), .d(x71), .O(new_n281_));
  aoi21  g121(.a(new_n281_), .b(new_n280_), .c(x01), .O(z51));
  inv1   g122(.a(x12), .O(new_n283_));
  nand2  g123(.a(x52), .b(x20), .O(new_n284_));
  oai21  g124(.a(x52), .b(new_n283_), .c(new_n284_), .O(new_n285_));
  nand4  g125(.a(new_n285_), .b(x78), .c(new_n159_), .d(x04), .O(new_n286_));
  nand4  g126(.a(new_n222_), .b(x79), .c(x77), .d(x72), .O(new_n287_));
  nand2  g127(.a(new_n287_), .b(new_n286_), .O(new_n288_));
  nand2  g128(.a(new_n288_), .b(new_n153_), .O(new_n289_));
  nand2  g129(.a(new_n289_), .b(new_n155_), .O(z52));
  nand2  g130(.a(x52), .b(x21), .O(new_n291_));
  nand2  g131(.a(new_n245_), .b(x13), .O(new_n292_));
  aoi21  g132(.a(new_n292_), .b(new_n291_), .c(x79), .O(new_n293_));
  nand4  g133(.a(new_n293_), .b(x78), .c(new_n159_), .d(x04), .O(new_n294_));
  nand4  g134(.a(new_n274_), .b(new_n163_), .c(x77), .d(x73), .O(new_n295_));
  aoi21  g135(.a(new_n295_), .b(new_n294_), .c(x01), .O(z53));
  nand2  g136(.a(x52), .b(x22), .O(new_n297_));
  nand2  g137(.a(new_n245_), .b(x14), .O(new_n298_));
  aoi21  g138(.a(new_n298_), .b(new_n297_), .c(x79), .O(new_n299_));
  nand4  g139(.a(new_n299_), .b(x78), .c(new_n159_), .d(x04), .O(new_n300_));
  nor2   g140(.a(new_n300_), .b(x01), .O(z54));
  inv1   g141(.a(x76), .O(new_n302_));
  nand2  g142(.a(new_n163_), .b(new_n302_), .O(new_n303_));
  xor2a  g143(.a(x84), .b(x81), .O(new_n304_));
  oai21  g144(.a(new_n304_), .b(new_n303_), .c(x79), .O(new_n305_));
  aoi21  g145(.a(new_n163_), .b(new_n159_), .c(x01), .O(new_n306_));
  nand3  g146(.a(new_n306_), .b(new_n305_), .c(x00), .O(z56));
  inv1   g147(.a(x02), .O(new_n308_));
  nand4  g148(.a(x03), .b(new_n308_), .c(new_n153_), .d(x00), .O(new_n309_));
  nand2  g149(.a(new_n309_), .b(new_n155_), .O(z57));
  nand2  g150(.a(x78), .b(new_n159_), .O(new_n311_));
  inv1   g151(.a(x42), .O(new_n312_));
  nand4  g152(.a(new_n163_), .b(x77), .c(new_n312_), .d(x40), .O(new_n313_));
  nand3  g153(.a(new_n313_), .b(new_n311_), .c(x04), .O(new_n314_));
  nand3  g154(.a(new_n314_), .b(new_n160_), .c(new_n153_), .O(new_n315_));
  inv1   g155(.a(new_n315_), .O(z58));
  oai21  g156(.a(x78), .b(x40), .c(x77), .O(new_n317_));
  nand2  g157(.a(new_n317_), .b(x04), .O(new_n318_));
  nand3  g158(.a(new_n318_), .b(new_n160_), .c(new_n153_), .O(new_n319_));
  nand2  g159(.a(new_n319_), .b(new_n155_), .O(z59));
  nand4  g160(.a(new_n304_), .b(x79), .c(new_n163_), .d(x77), .O(new_n321_));
  ...
  and2   g166(.a(x84), .b(x81), .O(new_n327_));
  nand4  g167(.a(new_n327_), .b(x79), .c(new_n163_), .d(x77), .O(new_n328_));
  aoi21  g168(.a(new_n328_), .b(new_n326_), .c(x01), .O(z62));
  nand4  g169(.a(new_n222_), .b(x82), .c(x77), .d(new_n153_), .O(new_n330_));
  aoi21  g170(.a(new_n330_), .b(new_n163_), .c(new_n160_), .O(z63));
  inv1   g171(.a(x83), .O(new_n332_));
  nor2   g172(.a(new_n249_), .b(new_n332_), .O(new_n333_));
  nand4  g173(.a(new_n333_), .b(x79), .c(new_n163_), .d(x77), .O(new_n334_));
  nand4  g174(.a(new_n160_), .b(x78), .c(new_n159_), .d(x04), .O(new_n335_));
  aoi21  g175(.a(new_n335_), .b(new_n334_), .c(x01), .O(z64));
  nand3  g176(.a(new_n327_), .b(x77), .c(new_n153_), .O(new_n337_));
  aoi21  g177(.a(new_n337_), .b(new_n163_), .c(new_n160_), .O(z65));
  zero   g178(.O(z25));
  zero   g179(.O(z29));
  zero   g180(.O(z32));
  zero   g181(.O(z33));
  ...
  zero   g185(.O(z41));
  zero   g186(.O(z45));
  inv1   g187(.a(new_n155_), .O(z27));
  inv1   g188(.a(new_n155_), .O(z28));
  inv1   g189(.a(new_n155_), .O(z30));
  inv1   g190(.a(new_n155_), .O(z31));
  inv1   g191(.a(new_n155_), .O(z35));
  inv1   g192(.a(new_n155_), .O(z37));
  inv1   g193(.a(new_n155_), .O(z39));
  inv1   g194(.a(new_n155_), .O(z40));
  inv1   g195(.a(new_n155_), .O(z42));
  inv1   g196(.a(new_n155_), .O(z43));
  inv1   g197(.a(new_n155_), .O(z44));
  inv1   g198(.a(new_n155_), .O(z46));
  inv1   g199(.a(new_n155_), .O(z55));
endmodule
