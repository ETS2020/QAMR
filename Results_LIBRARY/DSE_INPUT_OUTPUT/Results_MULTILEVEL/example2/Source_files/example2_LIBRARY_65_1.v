...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n158_,
    ...
    new_n223_, new_n224_, new_n225_, new_n227_, new_n241_, new_n242_,
    ...
    new_n280_, new_n283_, new_n285_, new_n286_, new_n288_, new_n289_,
  ...
  inv1   g077(.a(x77), .O(new_n241_));
  nand2  g078(.a(x52), .b(x15), .O(new_n242_));
  nand2  g079(.a(new_n153_), .b(x07), .O(new_n243_));
  aoi21  g080(.a(new_n243_), .b(new_n242_), .c(x79), .O(new_n244_));
  nand4  g081(.a(new_n244_), .b(x78), .c(new_n241_), .d(x04), .O(new_n245_));
  nor2   g082(.a(new_n245_), .b(x01), .O(z47));
  inv1   g083(.a(x08), .O(new_n247_));
  nand2  g084(.a(x52), .b(x16), .O(new_n248_));
  oai21  g085(.a(x52), .b(new_n247_), .c(new_n248_), .O(new_n249_));
  nand4  g086(.a(new_n249_), .b(x78), .c(new_n241_), .d(x04), .O(new_n250_));
  aoi21  g087(.a(new_n250_), .b(new_n156_), .c(x01), .O(z48));
  inv1   g088(.a(x09), .O(new_n252_));
  nand2  g089(.a(x52), .b(x17), .O(new_n253_));
  oai21  g090(.a(x52), .b(new_n252_), .c(new_n253_), .O(new_n254_));
  nand4  g091(.a(new_n254_), .b(x78), .c(new_n241_), .d(x04), .O(new_n255_));
  aoi21  g092(.a(new_n255_), .b(new_n156_), .c(x01), .O(z49));
  inv1   g093(.a(x10), .O(new_n257_));
  nand2  g094(.a(x52), .b(x18), .O(new_n258_));
  oai21  g095(.a(x52), .b(new_n257_), .c(new_n258_), .O(new_n259_));
  nand4  g096(.a(new_n259_), .b(x78), .c(new_n241_), .d(x04), .O(new_n260_));
  aoi21  g097(.a(new_n260_), .b(new_n156_), .c(x01), .O(z50));
  nand2  g098(.a(x52), .b(x19), .O(new_n262_));
  nand2  g099(.a(new_n153_), .b(x11), .O(new_n263_));
  aoi21  g100(.a(new_n263_), .b(new_n262_), .c(x79), .O(new_n264_));
  nand4  g101(.a(new_n264_), .b(x78), .c(new_n241_), .d(x04), .O(new_n265_));
  nor2   g102(.a(new_n265_), .b(x01), .O(z51));
  inv1   g103(.a(x12), .O(new_n267_));
  nand2  g104(.a(x52), .b(x20), .O(new_n268_));
  oai21  g105(.a(x52), .b(new_n267_), .c(new_n268_), .O(new_n269_));
  nand4  g106(.a(new_n269_), .b(x78), .c(new_n241_), .d(x04), .O(new_n270_));
  aoi21  g107(.a(new_n270_), .b(new_n156_), .c(x01), .O(z52));
  nand2  g108(.a(x52), .b(x21), .O(new_n272_));
  nand2  g109(.a(new_n153_), .b(x13), .O(new_n273_));
  aoi21  g110(.a(new_n273_), .b(new_n272_), .c(x79), .O(new_n274_));
  nand4  g111(.a(new_n274_), .b(x78), .c(new_n241_), .d(x04), .O(new_n275_));
  nor2   g112(.a(new_n275_), .b(x01), .O(z53));
  inv1   g113(.a(x14), .O(new_n277_));
  nand2  g114(.a(x52), .b(x22), .O(new_n278_));
  oai21  g115(.a(x52), .b(new_n277_), .c(new_n278_), .O(new_n279_));
  nand4  g116(.a(new_n279_), .b(x78), .c(new_n241_), .d(x04), .O(new_n280_));
  aoi21  g117(.a(new_n280_), .b(new_n156_), .c(x01), .O(z54));
  aoi21  g118(.a(new_n167_), .b(new_n241_), .c(new_n223_), .O(new_n283_));
  oai21  g119(.a(new_n283_), .b(x79), .c(new_n160_), .O(z56));
  inv1   g120(.a(x02), .O(new_n285_));
  nand4  g121(.a(x03), .b(new_n285_), .c(new_n160_), .d(x00), .O(new_n286_));
  nor2   g122(.a(new_n286_), .b(x79), .O(z57));
  aoi21  g123(.a(x78), .b(new_n241_), .c(new_n224_), .O(new_n288_));
  ...
  oai21  g132(.a(x78), .b(new_n224_), .c(new_n156_), .O(new_n297_));
  nor2   g133(.a(new_n297_), .b(x01), .O(z60));
  nand4  g134(.a(new_n156_), .b(x78), .c(x04), .d(new_n160_), .O(new_n299_));
  inv1   g135(.a(new_n299_), .O(z62));
  nand3  g136(.a(x78), .b(new_n241_), .c(x04), .O(new_n302_));
  aoi21  g137(.a(new_n302_), .b(new_n156_), .c(x01), .O(z64));
  zero   g138(.O(z25));
  zero   g139(.O(z27));
  zero   g140(.O(z30));
  zero   g141(.O(z31));
