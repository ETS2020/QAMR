...
module FAU ( 
  ...
  aoi21  g067(.a(new_n218_), .b(new_n217_), .c(new_n155_), .O(z18));
  ...
  aoi21  g113(.a(new_n264_), .b(new_n153_), .c(new_n154_), .O(z26));
  ...
  aoi21  g155(.a(new_n299_), .b(new_n294_), .c(new_n158_), .O(new_n307_));
  nand4  g156(.a(new_n307_), .b(x77), .c(x55), .d(new_n247_), .O(new_n308_));
  ...
  nand4  g166(.a(new_n307_), .b(x77), .c(x60), .d(new_n247_), .O(new_n318_));
  ...
  nand4  g196(.a(new_n347_), .b(new_n154_), .c(x78), .d(new_n164_), .O(new_n348_));
  inv1   g197(.a(new_n348_), .O(new_n349_));
  nand3  g198(.a(new_n349_), .b(x04), .c(new_n153_), .O(new_n350_));
  nand3  g199(.a(new_n230_), .b(new_n158_), .c(x77), .O(new_n351_));
  ...
  nand4  g206(.a(new_n357_), .b(new_n154_), .c(x78), .d(new_n164_), .O(new_n358_));
  ...
  oai21  g210(.a(new_n361_), .b(new_n154_), .c(new_n360_), .O(z50));
  nand2  g211(.a(x52), .b(x19), .O(new_n363_));
  nand2  g212(.a(new_n329_), .b(x11), .O(new_n364_));
  ...
  aoi21  g223(.a(new_n352_), .b(x72), .c(x01), .O(new_n375_));
  oai21  g224(.a(new_n375_), .b(new_n154_), .c(new_n374_), .O(z52));
  nand2  g225(.a(x52), .b(x21), .O(new_n377_));
  nand2  g226(.a(new_n329_), .b(x13), .O(new_n378_));
  ...
  nand2  g232(.a(new_n329_), .b(x14), .O(new_n384_));
  ...
  oai21  g256(.a(new_n169_), .b(new_n247_), .c(new_n154_), .O(new_n408_));
  ...
  oai22  g278(.a(new_n429_), .b(new_n229_), .c(new_n163_), .d(x04), .O(new_n430_));
  nand2  g279(.a(new_n430_), .b(x80), .O(new_n431_));
  aoi21  g280(.a(new_n431_), .b(new_n153_), .c(new_n154_), .O(z61));
  ...
  nand3  g291(.a(new_n159_), .b(new_n164_), .c(x04), .O(new_n443_));
  ...
  nand3  g295(.a(x81), .b(x78), .c(new_n164_), .O(new_n447_));
