...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n158_,
    ...
    new_n271_, new_n273_, new_n274_, new_n275_, new_n276_, new_n279_,
  ...
  nand2  g077(.a(new_n153_), .b(x07), .O(new_n239_));
  aoi21  g078(.a(new_n239_), .b(new_n238_), .c(x79), .O(new_n240_));
  nand4  g079(.a(new_n240_), .b(x78), .c(new_n237_), .d(x04), .O(new_n241_));
  nor2   g080(.a(new_n241_), .b(x01), .O(z47));
  ...
  aoi21  g085(.a(new_n246_), .b(new_n156_), .c(x01), .O(z48));
  nand2  g086(.a(x52), .b(x17), .O(new_n248_));
  nand2  g087(.a(new_n153_), .b(x09), .O(new_n249_));
  ...
  nand2  g092(.a(new_n153_), .b(x10), .O(new_n254_));
  ...
  nand2  g097(.a(new_n153_), .b(x11), .O(new_n259_));
  aoi21  g098(.a(new_n259_), .b(new_n258_), .c(x79), .O(new_n260_));
  nand4  g099(.a(new_n260_), .b(x78), .c(new_n237_), .d(x04), .O(new_n261_));
  nor2   g100(.a(new_n261_), .b(x01), .O(z51));
  nand2  g101(.a(x52), .b(x20), .O(new_n263_));
  nand2  g102(.a(new_n153_), .b(x12), .O(new_n264_));
  aoi21  g103(.a(new_n264_), .b(new_n263_), .c(x79), .O(new_n265_));
  nand4  g104(.a(new_n265_), .b(x78), .c(new_n237_), .d(x04), .O(new_n266_));
  nor2   g105(.a(new_n266_), .b(x01), .O(z52));
  nand2  g106(.a(x52), .b(x21), .O(new_n268_));
  nand2  g107(.a(new_n153_), .b(x13), .O(new_n269_));
  ...
  nand2  g111(.a(x52), .b(x22), .O(new_n273_));
  nand2  g112(.a(new_n153_), .b(x14), .O(new_n274_));
  aoi21  g113(.a(new_n274_), .b(new_n273_), .c(x79), .O(new_n275_));
  nand4  g114(.a(new_n275_), .b(x78), .c(new_n237_), .d(x04), .O(new_n276_));
  nor2   g115(.a(new_n276_), .b(x01), .O(z54));
  oai21  g116(.a(x78), .b(x77), .c(x00), .O(new_n279_));
  nand2  g117(.a(new_n279_), .b(new_n156_), .O(new_n280_));
  nand2  g118(.a(new_n280_), .b(z01), .O(z56));
  inv1   g119(.a(x02), .O(new_n282_));
  nand3  g120(.a(x03), .b(new_n282_), .c(x00), .O(new_n283_));
  aoi21  g121(.a(new_n283_), .b(new_n156_), .c(x01), .O(z57));
  aoi21  g122(.a(x78), .b(new_n237_), .c(new_n222_), .O(new_n285_));
  inv1   g123(.a(x42), .O(new_n286_));
  nand4  g124(.a(new_n166_), .b(x77), .c(new_n286_), .d(x40), .O(new_n287_));
  nand3  g125(.a(new_n287_), .b(new_n285_), .c(new_n156_), .O(new_n288_));
  and2   g126(.a(new_n288_), .b(z01), .O(z58));
  oai21  g127(.a(x78), .b(x40), .c(x77), .O(new_n290_));
  nand2  g128(.a(new_n290_), .b(x04), .O(new_n291_));
  nand3  g129(.a(new_n291_), .b(new_n156_), .c(z01), .O(new_n292_));
  inv1   g130(.a(new_n292_), .O(z59));
  nor2   g131(.a(x79), .b(new_n222_), .O(new_n294_));
  aoi21  g132(.a(new_n294_), .b(new_n166_), .c(x01), .O(z60));
  nand3  g133(.a(x78), .b(new_n237_), .c(x04), .O(new_n297_));
  aoi21  g134(.a(new_n297_), .b(new_n156_), .c(x01), .O(z64));
  zero   g135(.O(z27));
  zero   g136(.O(z30));
  zero   g137(.O(z31));
  zero   g138(.O(z32));
  ...
  zero   g145(.O(z55));
  zero   g146(.O(z63));
  nor2   g147(.a(new_n156_), .b(x01), .O(z25));
  nor2   g148(.a(new_n156_), .b(x01), .O(z26));
  nor2   g149(.a(new_n156_), .b(x01), .O(z28));
  ...
  nor2   g154(.a(new_n156_), .b(x01), .O(z39));
  ...
  aoi21  g160(.a(new_n220_), .b(new_n156_), .c(x01), .O(z62));
