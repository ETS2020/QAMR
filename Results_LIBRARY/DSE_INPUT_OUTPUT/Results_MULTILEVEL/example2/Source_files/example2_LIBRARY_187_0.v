...
module FAU ( 
  ...
  nand4  g025(.a(x78), .b(x63), .c(x52), .d(new_n153_), .O(new_n177_));
  nor2   g026(.a(new_n177_), .b(x79), .O(z03));
  inv1   g027(.a(new_n165_), .O(new_n179_));
  nand2  g028(.a(new_n179_), .b(x63), .O(new_n180_));
  ...
  oai21  g036(.a(new_n162_), .b(x63), .c(x40), .O(new_n188_));
  ...
  aoi21  g100(.a(x05), .b(new_n251_), .c(new_n161_), .O(new_n252_));
  ...
  nand3  g198(.a(new_n349_), .b(x63), .c(x04), .O(new_n350_));
  ...
  nand3  g235(.a(new_n386_), .b(x63), .c(x04), .O(new_n387_));
  ...
  nand3  g244(.a(new_n395_), .b(x63), .c(x04), .O(new_n396_));
  ...
  aoi21  g259(.a(new_n410_), .b(x63), .c(x79), .O(z54));
  ...
  nand3  g294(.a(new_n445_), .b(new_n162_), .c(x63), .O(new_n446_));
  ...
  nand3  g312(.a(new_n155_), .b(x63), .c(x04), .O(new_n464_));
  aoi21  g313(.a(new_n464_), .b(new_n463_), .c(x01), .O(z62));
  nand4  g314(.a(new_n454_), .b(x82), .c(x79), .d(new_n153_), .O(new_n466_));
  nand2  g315(.a(new_n466_), .b(new_n169_), .O(z63));
  nand3  g316(.a(new_n454_), .b(x83), .c(x79), .O(new_n468_));
  nand4  g317(.a(new_n155_), .b(new_n164_), .c(x63), .d(x04), .O(new_n469_));
  aoi21  g318(.a(new_n469_), .b(new_n468_), .c(x01), .O(z64));
  oai21  g319(.a(new_n241_), .b(x78), .c(new_n457_), .O(new_n471_));
