...
module FAU ( 
  ...
  nand2  g017(.a(new_n155_), .b(x23), .O(new_n170_));
  nand2  g018(.a(x65), .b(x40), .O(new_n171_));
  nor2   g019(.a(x79), .b(x01), .O(z54));
  aoi21  g020(.a(new_n171_), .b(new_n170_), .c(z54), .O(z05));
  inv1   g021(.a(z54), .O(new_n174_));
  nand2  g022(.a(x64), .b(x40), .O(new_n175_));
  nand2  g023(.a(new_n155_), .b(x24), .O(new_n176_));
  nand3  g024(.a(new_n176_), .b(new_n175_), .c(new_n174_), .O(z06));
  nand2  g025(.a(new_n155_), .b(x25), .O(new_n178_));
  nand2  g026(.a(x63), .b(x40), .O(new_n179_));
  aoi21  g027(.a(new_n179_), .b(new_n178_), .c(z54), .O(z07));
  nand2  g028(.a(x62), .b(x40), .O(new_n181_));
  nand2  g029(.a(new_n155_), .b(x26), .O(new_n182_));
  nand3  g030(.a(new_n182_), .b(new_n181_), .c(new_n174_), .O(z08));
  nand2  g031(.a(x61), .b(x40), .O(new_n184_));
  nand2  g032(.a(new_n155_), .b(x27), .O(new_n185_));
  nand3  g033(.a(new_n185_), .b(new_n184_), .c(new_n174_), .O(z09));
  nand2  g034(.a(x60), .b(x40), .O(new_n187_));
  nand2  g035(.a(new_n155_), .b(x28), .O(new_n188_));
  nand3  g036(.a(new_n188_), .b(new_n187_), .c(new_n174_), .O(z10));
  nand2  g037(.a(x59), .b(x40), .O(new_n190_));
  nand2  g038(.a(new_n155_), .b(x29), .O(new_n191_));
  nand3  g039(.a(new_n191_), .b(new_n190_), .c(new_n174_), .O(z11));
  nand2  g040(.a(new_n155_), .b(x30), .O(new_n193_));
  nand2  g041(.a(x58), .b(x40), .O(new_n194_));
  aoi21  g042(.a(new_n194_), .b(new_n193_), .c(z54), .O(z12));
  nand2  g043(.a(new_n155_), .b(x31), .O(new_n196_));
  nand2  g044(.a(x57), .b(x40), .O(new_n197_));
  aoi21  g045(.a(new_n197_), .b(new_n196_), .c(z54), .O(z13));
  nand2  g046(.a(x51), .b(x40), .O(new_n199_));
  nand2  g047(.a(new_n155_), .b(x32), .O(new_n200_));
  nand3  g048(.a(new_n200_), .b(new_n199_), .c(new_n174_), .O(z14));
  nand2  g049(.a(new_n155_), .b(x33), .O(new_n202_));
  nand2  g050(.a(x50), .b(x40), .O(new_n203_));
  aoi21  g051(.a(new_n203_), .b(new_n202_), .c(z54), .O(z15));
  nand2  g052(.a(new_n155_), .b(x34), .O(new_n205_));
  nand2  g053(.a(x49), .b(x40), .O(new_n206_));
  aoi21  g054(.a(new_n206_), .b(new_n205_), .c(z54), .O(z16));
  nand2  g055(.a(x48), .b(x40), .O(new_n208_));
  nand2  g056(.a(new_n155_), .b(x35), .O(new_n209_));
  nand3  g057(.a(new_n209_), .b(new_n208_), .c(new_n174_), .O(z17));
  nand2  g058(.a(new_n155_), .b(x36), .O(new_n211_));
  nand2  g059(.a(x47), .b(x40), .O(new_n212_));
  aoi21  g060(.a(new_n212_), .b(new_n211_), .c(z54), .O(z18));
  nand2  g061(.a(new_n155_), .b(x37), .O(new_n214_));
  nand2  g062(.a(x46), .b(x40), .O(new_n215_));
  aoi21  g063(.a(new_n215_), .b(new_n214_), .c(z54), .O(z19));
  nand2  g064(.a(x45), .b(x40), .O(new_n217_));
  nand2  g065(.a(new_n155_), .b(x38), .O(new_n218_));
  nand3  g066(.a(new_n218_), .b(new_n217_), .c(new_n174_), .O(z20));
  nand2  g067(.a(new_n155_), .b(x39), .O(new_n220_));
  nand2  g068(.a(x44), .b(x40), .O(new_n221_));
  aoi21  g069(.a(new_n221_), .b(new_n220_), .c(z54), .O(z21));
  inv1   g070(.a(x41), .O(new_n223_));
  xnor2a g071(.a(x84), .b(x81), .O(new_n224_));
  nand2  g072(.a(new_n166_), .b(x66), .O(new_n225_));
  nand2  g073(.a(new_n225_), .b(new_n165_), .O(new_n226_));
  nand3  g074(.a(new_n226_), .b(new_n224_), .c(new_n223_), .O(new_n227_));
  inv1   g075(.a(x42), .O(new_n228_));
  ...
  nand4  g080(.a(x84), .b(new_n232_), .c(x82), .d(x81), .O(new_n233_));
  inv1   g081(.a(new_n233_), .O(new_n234_));
  nand2  g082(.a(new_n234_), .b(new_n231_), .O(new_n235_));
  nand4  g083(.a(new_n235_), .b(x78), .c(x77), .d(new_n228_), .O(new_n236_));
  inv1   g084(.a(new_n236_), .O(new_n237_));
  aoi21  g085(.a(new_n237_), .b(x04), .c(new_n153_), .O(new_n238_));
  aoi21  g086(.a(new_n238_), .b(new_n227_), .c(x01), .O(z22));
  oai21  g087(.a(new_n153_), .b(x00), .c(z04), .O(z23));
  inv1   g088(.a(x43), .O(new_n241_));
  nor2   g089(.a(x04), .b(x01), .O(new_n242_));
  nand4  g090(.a(new_n242_), .b(x77), .c(new_n241_), .d(x05), .O(new_n243_));
  nor3   g091(.a(new_n243_), .b(new_n153_), .c(new_n161_), .O(z24));
  ...
  nand4  g101(.a(new_n253_), .b(new_n228_), .c(x05), .d(new_n245_), .O(new_n254_));
  aoi21  g102(.a(new_n254_), .b(x79), .c(x01), .O(z25));
  nand4  g103(.a(new_n251_), .b(x79), .c(x78), .d(x77), .O(new_n256_));
  inv1   g104(.a(new_n256_), .O(new_n257_));
  nand4  g105(.a(new_n257_), .b(x44), .c(new_n228_), .d(new_n245_), .O(new_n258_));
  nor2   g106(.a(new_n258_), .b(x01), .O(z26));
  nand4  g107(.a(new_n257_), .b(x45), .c(new_n228_), .d(new_n245_), .O(new_n260_));
  nor2   g108(.a(new_n260_), .b(x01), .O(z27));
  nand4  g109(.a(new_n257_), .b(x46), .c(new_n228_), .d(new_n245_), .O(new_n262_));
  nor2   g110(.a(new_n262_), .b(x01), .O(z28));
  nand4  g111(.a(new_n253_), .b(x47), .c(new_n228_), .d(new_n245_), .O(new_n264_));
  aoi21  g112(.a(new_n264_), .b(x79), .c(x01), .O(z29));
  nand4  g113(.a(new_n253_), .b(x48), .c(new_n228_), .d(new_n245_), .O(new_n266_));
  aoi21  g114(.a(new_n266_), .b(x79), .c(x01), .O(z30));
  nand4  g115(.a(new_n253_), .b(x49), .c(new_n228_), .d(new_n245_), .O(new_n268_));
  aoi21  g116(.a(new_n268_), .b(x79), .c(x01), .O(z31));
  nand4  g117(.a(new_n257_), .b(x50), .c(new_n228_), .d(new_n245_), .O(new_n270_));
  nor2   g118(.a(new_n270_), .b(x01), .O(z32));
  xor2a  g119(.a(x83), .b(x81), .O(new_n272_));
  nand3  g120(.a(new_n272_), .b(x42), .c(x05), .O(new_n273_));
  nand3  g121(.a(x81), .b(x51), .c(new_n228_), .O(new_n274_));
  ...
  nand3  g126(.a(new_n248_), .b(x51), .c(new_n228_), .O(new_n279_));
  ...
  nand4  g130(.a(new_n282_), .b(x78), .c(x77), .d(new_n245_), .O(new_n283_));
  ...
  nand4  g142(.a(new_n294_), .b(x77), .c(x52), .d(new_n245_), .O(new_n295_));
  aoi21  g143(.a(new_n295_), .b(x79), .c(x01), .O(z34));
  nand4  g144(.a(new_n294_), .b(x77), .c(x53), .d(new_n245_), .O(new_n297_));
  aoi21  g145(.a(new_n297_), .b(x79), .c(x01), .O(z35));
  nand4  g146(.a(new_n294_), .b(x77), .c(x54), .d(new_n245_), .O(new_n299_));
  aoi21  g147(.a(new_n299_), .b(x79), .c(x01), .O(z36));
  aoi21  g148(.a(new_n293_), .b(new_n288_), .c(new_n153_), .O(new_n301_));
  nand4  g149(.a(new_n301_), .b(x78), .c(x77), .d(x55), .O(new_n302_));
  nor3   g150(.a(new_n302_), .b(x04), .c(x01), .O(z37));
  nand4  g151(.a(new_n301_), .b(x78), .c(x77), .d(x56), .O(new_n304_));
  nor3   g152(.a(new_n304_), .b(x04), .c(x01), .O(z38));
  nand4  g153(.a(new_n294_), .b(x77), .c(x57), .d(new_n245_), .O(new_n306_));
  aoi21  g154(.a(new_n306_), .b(x79), .c(x01), .O(z39));
  nand4  g155(.a(new_n301_), .b(x78), .c(x77), .d(x58), .O(new_n308_));
  nor3   g156(.a(new_n308_), .b(x04), .c(x01), .O(z40));
  nand4  g157(.a(new_n301_), .b(x78), .c(x77), .d(x59), .O(new_n310_));
  nor3   g158(.a(new_n310_), .b(x04), .c(x01), .O(z41));
  nand4  g159(.a(new_n301_), .b(x78), .c(x77), .d(x60), .O(new_n312_));
  nor3   g160(.a(new_n312_), .b(x04), .c(x01), .O(z42));
  nand4  g161(.a(new_n301_), .b(x78), .c(x77), .d(x61), .O(new_n314_));
  nor3   g162(.a(new_n314_), .b(x04), .c(x01), .O(z43));
  nand4  g163(.a(new_n294_), .b(x77), .c(x62), .d(new_n245_), .O(new_n316_));
  aoi21  g164(.a(new_n316_), .b(x79), .c(x01), .O(z44));
  nand4  g165(.a(new_n301_), .b(x78), .c(x77), .d(x63), .O(new_n318_));
  nor3   g166(.a(new_n318_), .b(x04), .c(x01), .O(z45));
  nand4  g167(.a(new_n301_), .b(x78), .c(x77), .d(x64), .O(new_n320_));
  nor3   g168(.a(new_n320_), .b(x04), .c(x01), .O(z46));
  or2    g169(.a(x75), .b(x67), .O(new_n322_));
  nand4  g170(.a(new_n322_), .b(new_n224_), .c(x79), .d(new_n161_), .O(new_n323_));
  nor3   g171(.a(new_n323_), .b(new_n160_), .c(x01), .O(z47));
  inv1   g172(.a(x68), .O(new_n325_));
  nand4  g173(.a(new_n224_), .b(x79), .c(new_n161_), .d(x77), .O(new_n326_));
  ...
  nand3  g179(.a(new_n224_), .b(new_n161_), .c(x77), .O(new_n332_));
  inv1   g180(.a(new_n332_), .O(new_n333_));
  nand2  g181(.a(new_n333_), .b(x71), .O(new_n334_));
  aoi21  g182(.a(new_n334_), .b(x79), .c(x01), .O(z51));
  nand2  g183(.a(new_n333_), .b(x72), .O(new_n336_));
  aoi21  g184(.a(new_n336_), .b(x79), .c(x01), .O(z52));
  inv1   g185(.a(x73), .O(new_n338_));
  nor3   g186(.a(new_n326_), .b(new_n338_), .c(x01), .O(z53));
  inv1   g187(.a(x84), .O(new_n340_));
  nand4  g188(.a(new_n242_), .b(x79), .c(x78), .d(x77), .O(new_n341_));
  nor2   g189(.a(new_n341_), .b(x80), .O(new_n342_));
  nand2  g190(.a(new_n342_), .b(new_n248_), .O(new_n343_));
  nor4   g191(.a(new_n343_), .b(new_n340_), .c(new_n232_), .d(x82), .O(z55));
  xor2a  g192(.a(x84), .b(x81), .O(new_n345_));
  oai21  g193(.a(new_n345_), .b(x76), .c(new_n159_), .O(new_n346_));
  nand4  g194(.a(new_n346_), .b(new_n162_), .c(z04), .d(x00), .O(z56));
  inv1   g195(.a(x02), .O(new_n348_));
  nand4  g196(.a(x03), .b(new_n348_), .c(z04), .d(x00), .O(new_n349_));
  nor2   g197(.a(new_n349_), .b(new_n153_), .O(z57));
  nand4  g198(.a(x80), .b(new_n229_), .c(x43), .d(new_n228_), .O(new_n351_));
  oai22  g199(.a(new_n351_), .b(new_n233_), .c(new_n228_), .d(x40), .O(new_n352_));
  nand4  g200(.a(new_n352_), .b(x79), .c(x78), .d(x77), .O(new_n353_));
  nor3   g201(.a(new_n353_), .b(new_n245_), .c(x01), .O(z58));
  nand2  g202(.a(new_n235_), .b(new_n228_), .O(new_n355_));
  aoi21  g203(.a(new_n355_), .b(new_n155_), .c(new_n153_), .O(new_n356_));
  nand4  g204(.a(new_n356_), .b(x78), .c(x77), .d(x04), .O(new_n357_));
  nor2   g205(.a(new_n357_), .b(x01), .O(z59));
  oai21  g206(.a(new_n166_), .b(new_n164_), .c(new_n345_), .O(new_n359_));
  oai21  g207(.a(new_n233_), .b(new_n230_), .c(x79), .O(new_n360_));
  nor2   g208(.a(new_n360_), .b(new_n161_), .O(new_n361_));
  nand4  g209(.a(new_n361_), .b(x77), .c(new_n228_), .d(x04), .O(new_n362_));
  nand3  g210(.a(new_n362_), .b(new_n359_), .c(x79), .O(new_n363_));
  and2   g211(.a(new_n363_), .b(z04), .O(z60));
  oai21  g212(.a(new_n166_), .b(new_n164_), .c(new_n224_), .O(new_n365_));
  oai21  g213(.a(new_n159_), .b(x04), .c(new_n365_), .O(new_n366_));
  nand4  g214(.a(new_n366_), .b(x80), .c(x79), .d(z04), .O(new_n367_));
  inv1   g215(.a(new_n367_), .O(z61));
  nand2  g216(.a(x78), .b(new_n245_), .O(new_n369_));
  nand2  g217(.a(x84), .b(new_n161_), .O(new_n370_));
  aoi21  g218(.a(new_n370_), .b(new_n369_), .c(new_n160_), .O(new_n371_));
  nor3   g219(.a(new_n340_), .b(new_n161_), .c(x77), .O(new_n372_));
  oai21  g220(.a(new_n372_), .b(new_n371_), .c(x81), .O(new_n373_));
  aoi21  g221(.a(new_n373_), .b(new_n238_), .c(x01), .O(z62));
  nand2  g222(.a(new_n366_), .b(x82), .O(new_n375_));
  aoi21  g223(.a(new_n375_), .b(x79), .c(x01), .O(z63));
  nand2  g224(.a(new_n366_), .b(x83), .O(new_n377_));
  aoi21  g225(.a(new_n377_), .b(x79), .c(x01), .O(z64));
  nand2  g226(.a(x81), .b(new_n161_), .O(new_n379_));
  aoi21  g227(.a(new_n379_), .b(new_n369_), .c(new_n160_), .O(new_n380_));
  nor3   g228(.a(new_n248_), .b(new_n161_), .c(x77), .O(new_n381_));
  oai21  g229(.a(new_n381_), .b(new_n380_), .c(x84), .O(new_n382_));
  aoi21  g230(.a(new_n382_), .b(x79), .c(x01), .O(z65));
  zero   g231(.O(z03));
endmodule
