...
module FAU ( 
  ...
  nand2  g020(.a(new_n155_), .b(x23), .O(new_n173_));
  nand2  g021(.a(x65), .b(x40), .O(new_n174_));
  nor2   g022(.a(x79), .b(x01), .O(new_n175_));
  aoi21  g023(.a(new_n174_), .b(new_n173_), .c(new_n175_), .O(z05));
  inv1   g024(.a(new_n175_), .O(new_n177_));
  ...
  aoi21  g030(.a(new_n182_), .b(new_n181_), .c(new_n175_), .O(z07));
  nand2  g031(.a(new_n155_), .b(x26), .O(new_n184_));
  nand2  g032(.a(x62), .b(x40), .O(new_n185_));
  aoi21  g033(.a(new_n185_), .b(new_n184_), .c(new_n175_), .O(z08));
  nand2  g034(.a(new_n155_), .b(x27), .O(new_n187_));
  nand2  g035(.a(x61), .b(x40), .O(new_n188_));
  aoi21  g036(.a(new_n188_), .b(new_n187_), .c(new_n175_), .O(z09));
  ...
  aoi21  g045(.a(new_n197_), .b(new_n196_), .c(new_n175_), .O(z12));
  nand2  g046(.a(new_n155_), .b(x31), .O(new_n199_));
  nand2  g047(.a(x57), .b(x40), .O(new_n200_));
  aoi21  g048(.a(new_n200_), .b(new_n199_), .c(new_n175_), .O(z13));
  ...
  aoi21  g069(.a(new_n221_), .b(new_n220_), .c(new_n175_), .O(z20));
  nand2  g070(.a(x44), .b(x40), .O(new_n223_));
  nand2  g071(.a(new_n155_), .b(x39), .O(new_n224_));
  nand3  g072(.a(new_n224_), .b(new_n223_), .c(new_n177_), .O(z21));
  ...
  nand4  g102(.a(new_n254_), .b(new_n231_), .c(x05), .d(new_n246_), .O(new_n255_));
  ...
  nand4  g106(.a(new_n258_), .b(x44), .c(new_n231_), .d(new_n246_), .O(new_n259_));
  nor2   g107(.a(new_n259_), .b(x01), .O(z26));
  nand4  g108(.a(new_n254_), .b(x45), .c(new_n231_), .d(new_n246_), .O(new_n261_));
  aoi21  g109(.a(new_n261_), .b(x79), .c(x01), .O(z27));
  nand4  g110(.a(new_n254_), .b(x46), .c(new_n231_), .d(new_n246_), .O(new_n263_));
  aoi21  g111(.a(new_n263_), .b(x79), .c(x01), .O(z28));
  nand4  g112(.a(new_n258_), .b(x47), .c(new_n231_), .d(new_n246_), .O(new_n265_));
  nor2   g113(.a(new_n265_), .b(x01), .O(z29));
  nand4  g114(.a(new_n258_), .b(x48), .c(new_n231_), .d(new_n246_), .O(new_n267_));
  nor2   g115(.a(new_n267_), .b(x01), .O(z30));
  nand4  g116(.a(new_n254_), .b(x49), .c(new_n231_), .d(new_n246_), .O(new_n269_));
  aoi21  g117(.a(new_n269_), .b(x79), .c(x01), .O(z31));
  nand4  g118(.a(new_n258_), .b(x50), .c(new_n231_), .d(new_n246_), .O(new_n271_));
  ...
  aoi21  g142(.a(new_n294_), .b(new_n289_), .c(new_n153_), .O(new_n295_));
  nand4  g143(.a(new_n295_), .b(x78), .c(x77), .d(x52), .O(new_n296_));
  nor3   g144(.a(new_n296_), .b(x04), .c(x01), .O(z34));
  aoi21  g145(.a(new_n294_), .b(new_n289_), .c(new_n161_), .O(new_n298_));
  nand4  g146(.a(new_n298_), .b(x77), .c(x53), .d(new_n246_), .O(new_n299_));
  aoi21  g147(.a(new_n299_), .b(x79), .c(x01), .O(z35));
  nand4  g148(.a(new_n295_), .b(x78), .c(x77), .d(x54), .O(new_n301_));
  nor3   g149(.a(new_n301_), .b(x04), .c(x01), .O(z36));
  nand4  g150(.a(new_n298_), .b(x77), .c(x55), .d(new_n246_), .O(new_n303_));
  aoi21  g151(.a(new_n303_), .b(x79), .c(x01), .O(z37));
  nand4  g152(.a(new_n295_), .b(x78), .c(x77), .d(x56), .O(new_n305_));
  nor3   g153(.a(new_n305_), .b(x04), .c(x01), .O(z38));
  nand4  g154(.a(new_n298_), .b(x77), .c(x57), .d(new_n246_), .O(new_n307_));
  aoi21  g155(.a(new_n307_), .b(x79), .c(x01), .O(z39));
  nand4  g156(.a(new_n295_), .b(x78), .c(x77), .d(x58), .O(new_n309_));
  nor3   g157(.a(new_n309_), .b(x04), .c(x01), .O(z40));
  nand4  g158(.a(new_n298_), .b(x77), .c(x59), .d(new_n246_), .O(new_n311_));
  aoi21  g159(.a(new_n311_), .b(x79), .c(x01), .O(z41));
  nand4  g160(.a(new_n298_), .b(x77), .c(x60), .d(new_n246_), .O(new_n313_));
  aoi21  g161(.a(new_n313_), .b(x79), .c(x01), .O(z42));
  nand4  g162(.a(new_n298_), .b(x77), .c(x61), .d(new_n246_), .O(new_n315_));
  aoi21  g163(.a(new_n315_), .b(x79), .c(x01), .O(z43));
  nand4  g164(.a(new_n298_), .b(x77), .c(x62), .d(new_n246_), .O(new_n317_));
  aoi21  g165(.a(new_n317_), .b(x79), .c(x01), .O(z44));
  nand4  g166(.a(new_n295_), .b(x78), .c(x77), .d(x63), .O(new_n319_));
  nor3   g167(.a(new_n319_), .b(x04), .c(x01), .O(z45));
  nand4  g168(.a(new_n295_), .b(x78), .c(x77), .d(x64), .O(new_n321_));
  nor3   g169(.a(new_n321_), .b(x04), .c(x01), .O(z46));
  or2    g170(.a(x75), .b(x67), .O(new_n323_));
  nand4  g171(.a(new_n323_), .b(new_n227_), .c(new_n161_), .d(x77), .O(new_n324_));
  aoi21  g172(.a(new_n324_), .b(x79), .c(x01), .O(z47));
  inv1   g173(.a(x68), .O(new_n326_));
  nand4  g174(.a(new_n227_), .b(x79), .c(new_n161_), .d(x77), .O(new_n327_));
  nor3   g175(.a(new_n327_), .b(new_n326_), .c(x01), .O(z48));
  nand3  g176(.a(new_n227_), .b(new_n161_), .c(x77), .O(new_n329_));
  ...
  nor3   g181(.a(new_n327_), .b(new_n333_), .c(x01), .O(z50));
  nand2  g182(.a(new_n330_), .b(x71), .O(new_n335_));
  aoi21  g183(.a(new_n335_), .b(x79), .c(x01), .O(z51));
  nand2  g184(.a(new_n330_), .b(x72), .O(new_n337_));
  aoi21  g185(.a(new_n337_), .b(x79), .c(x01), .O(z52));
  ...
  nor4   g192(.a(new_n345_), .b(new_n342_), .c(new_n234_), .d(x82), .O(z55));
  ...
  oai21  g197(.a(new_n350_), .b(new_n153_), .c(new_n152_), .O(z56));
  inv1   g198(.a(x02), .O(new_n352_));
  nand4  g199(.a(x03), .b(new_n352_), .c(new_n152_), .d(x00), .O(new_n353_));
  nor2   g200(.a(new_n353_), .b(new_n153_), .O(z57));
  nand4  g201(.a(x80), .b(new_n232_), .c(x43), .d(new_n231_), .O(new_n355_));
  oai22  g202(.a(new_n355_), .b(new_n235_), .c(new_n231_), .d(x40), .O(new_n356_));
  nand4  g203(.a(new_n356_), .b(x78), .c(x77), .d(x04), .O(new_n357_));
  aoi21  g204(.a(new_n357_), .b(x79), .c(x01), .O(z58));
  oai21  g205(.a(new_n235_), .b(new_n233_), .c(new_n231_), .O(new_n359_));
  ...
  oai21  g209(.a(new_n168_), .b(new_n166_), .c(new_n347_), .O(new_n363_));
  oai21  g210(.a(new_n235_), .b(new_n233_), .c(x79), .O(new_n364_));
  nor2   g211(.a(new_n364_), .b(new_n161_), .O(new_n365_));
  nand4  g212(.a(new_n365_), .b(x77), .c(new_n231_), .d(x04), .O(new_n366_));
  nand3  g213(.a(new_n366_), .b(new_n363_), .c(x79), .O(new_n367_));
  and2   g214(.a(new_n367_), .b(new_n152_), .O(z60));
  oai21  g215(.a(new_n168_), .b(new_n166_), .c(new_n227_), .O(new_n369_));
  oai21  g216(.a(new_n159_), .b(x04), .c(new_n369_), .O(new_n370_));
  nand4  g217(.a(new_n370_), .b(x80), .c(x79), .d(new_n152_), .O(new_n371_));
  inv1   g218(.a(new_n371_), .O(z61));
  nand2  g219(.a(x78), .b(new_n246_), .O(new_n373_));
  nand2  g220(.a(x84), .b(new_n161_), .O(new_n374_));
  aoi21  g221(.a(new_n374_), .b(new_n373_), .c(new_n160_), .O(new_n375_));
  nor3   g222(.a(new_n342_), .b(new_n161_), .c(x77), .O(new_n376_));
  oai21  g223(.a(new_n376_), .b(new_n375_), .c(x81), .O(new_n377_));
  nand2  g224(.a(new_n377_), .b(new_n238_), .O(new_n378_));
  nand3  g225(.a(new_n378_), .b(x79), .c(new_n152_), .O(new_n379_));
  inv1   g226(.a(new_n379_), .O(z62));
  nand2  g227(.a(new_n370_), .b(x82), .O(new_n381_));
  aoi21  g228(.a(new_n381_), .b(x79), .c(x01), .O(z63));
  nand4  g229(.a(new_n370_), .b(x83), .c(x79), .d(new_n152_), .O(new_n383_));
  inv1   g230(.a(new_n383_), .O(z64));
  nand2  g231(.a(x81), .b(new_n161_), .O(new_n385_));
  aoi21  g232(.a(new_n385_), .b(new_n373_), .c(new_n160_), .O(new_n386_));
  nor3   g233(.a(new_n249_), .b(new_n161_), .c(x77), .O(new_n387_));
