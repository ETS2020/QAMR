...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n157_, new_n158_,
    ...
    new_n231_, new_n232_, new_n246_, new_n247_, new_n248_, new_n249_,
  ...
  nor2   g079(.a(x79), .b(x43), .O(new_n231_));
  nand4  g080(.a(new_n231_), .b(x05), .c(new_n228_), .d(new_n164_), .O(new_n232_));
  nand2  g081(.a(new_n232_), .b(new_n157_), .O(z24));
  inv1   g082(.a(x07), .O(new_n246_));
  nand2  g083(.a(x52), .b(x15), .O(new_n247_));
  oai21  g084(.a(x52), .b(new_n246_), .c(new_n247_), .O(new_n248_));
  nand4  g085(.a(new_n248_), .b(x78), .c(new_n153_), .d(x04), .O(new_n249_));
  or2    g086(.a(x75), .b(x67), .O(new_n250_));
  nand4  g087(.a(new_n250_), .b(new_n222_), .c(x79), .d(x77), .O(new_n251_));
  nand2  g088(.a(new_n251_), .b(new_n249_), .O(new_n252_));
  nand2  g089(.a(new_n252_), .b(new_n164_), .O(new_n253_));
  nand2  g090(.a(new_n253_), .b(new_n157_), .O(z47));
  nand2  g091(.a(x52), .b(x16), .O(new_n255_));
  inv1   g092(.a(x52), .O(new_n256_));
  nand2  g093(.a(new_n256_), .b(x08), .O(new_n257_));
  aoi21  g094(.a(new_n257_), .b(new_n255_), .c(x79), .O(new_n258_));
  nand4  g095(.a(new_n258_), .b(x78), .c(new_n153_), .d(x04), .O(new_n259_));
  nand2  g096(.a(new_n224_), .b(x68), .O(new_n260_));
  aoi21  g097(.a(new_n260_), .b(new_n259_), .c(x01), .O(z48));
  inv1   g098(.a(x09), .O(new_n262_));
  nand2  g099(.a(x52), .b(x17), .O(new_n263_));
  oai21  g100(.a(x52), .b(new_n262_), .c(new_n263_), .O(new_n264_));
  nand4  g101(.a(new_n264_), .b(x78), .c(new_n153_), .d(x04), .O(new_n265_));
  xor2a  g102(.a(x84), .b(x81), .O(new_n266_));
  nor2   g103(.a(new_n266_), .b(new_n154_), .O(new_n267_));
  nand3  g104(.a(new_n267_), .b(x77), .c(x69), .O(new_n268_));
  nand2  g105(.a(new_n268_), .b(new_n265_), .O(new_n269_));
  nand2  g106(.a(new_n269_), .b(new_n164_), .O(new_n270_));
  nand2  g107(.a(new_n270_), .b(new_n157_), .O(z49));
  inv1   g108(.a(x10), .O(new_n272_));
  nand2  g109(.a(x52), .b(x18), .O(new_n273_));
  oai21  g110(.a(x52), .b(new_n272_), .c(new_n273_), .O(new_n274_));
  nand4  g111(.a(new_n274_), .b(x78), .c(new_n153_), .d(x04), .O(new_n275_));
  nand3  g112(.a(new_n267_), .b(x77), .c(x70), .O(new_n276_));
  nand2  g113(.a(new_n276_), .b(new_n275_), .O(new_n277_));
  nand2  g114(.a(new_n277_), .b(new_n164_), .O(new_n278_));
  nand2  g115(.a(new_n278_), .b(new_n157_), .O(z50));
  nand2  g116(.a(x52), .b(x19), .O(new_n280_));
  nand2  g117(.a(new_n256_), .b(x11), .O(new_n281_));
  aoi21  g118(.a(new_n281_), .b(new_n280_), .c(x79), .O(new_n282_));
  nand4  g119(.a(new_n282_), .b(x78), .c(new_n153_), .d(x04), .O(new_n283_));
  nand2  g120(.a(new_n224_), .b(x71), .O(new_n284_));
  aoi21  g121(.a(new_n284_), .b(new_n283_), .c(x01), .O(z51));
  nand2  g122(.a(x52), .b(x20), .O(new_n286_));
  nand2  g123(.a(new_n256_), .b(x12), .O(new_n287_));
  aoi21  g124(.a(new_n287_), .b(new_n286_), .c(x79), .O(new_n288_));
  nand4  g125(.a(new_n288_), .b(x78), .c(new_n153_), .d(x04), .O(new_n289_));
  nand2  g126(.a(new_n224_), .b(x72), .O(new_n290_));
  aoi21  g127(.a(new_n290_), .b(new_n289_), .c(x01), .O(z52));
  ...
  nand3  g132(.a(new_n267_), .b(x77), .c(x73), .O(new_n296_));
  ...
  nand2  g137(.a(x52), .b(x22), .O(new_n301_));
  oai21  g138(.a(x52), .b(new_n300_), .c(new_n301_), .O(new_n302_));
  nand4  g139(.a(new_n302_), .b(new_n153_), .c(x04), .d(new_n164_), .O(new_n303_));
  aoi21  g140(.a(new_n303_), .b(new_n154_), .c(new_n161_), .O(z54));
  inv1   g141(.a(x76), .O(new_n306_));
  nand2  g142(.a(new_n161_), .b(new_n306_), .O(new_n307_));
  xor2a  g143(.a(x84), .b(x81), .O(new_n308_));
  oai21  g144(.a(new_n308_), .b(new_n307_), .c(x79), .O(new_n309_));
  nand4  g145(.a(new_n309_), .b(new_n162_), .c(new_n164_), .d(x00), .O(z56));
  inv1   g146(.a(x00), .O(new_n311_));
  nand2  g147(.a(new_n157_), .b(x03), .O(new_n312_));
  nor4   g148(.a(new_n312_), .b(x02), .c(x01), .d(new_n311_), .O(z57));
  nand2  g149(.a(x78), .b(new_n153_), .O(new_n314_));
  nor2   g150(.a(x42), .b(new_n152_), .O(new_n315_));
  nor2   g151(.a(x78), .b(new_n153_), .O(new_n316_));
  nand2  g152(.a(new_n316_), .b(new_n315_), .O(new_n317_));
  nand3  g153(.a(new_n317_), .b(new_n314_), .c(x04), .O(new_n318_));
  nand3  g154(.a(new_n318_), .b(new_n154_), .c(new_n164_), .O(new_n319_));
  inv1   g155(.a(new_n319_), .O(z58));
  ...
  nand2  g159(.a(new_n323_), .b(new_n157_), .O(z59));
  nand4  g160(.a(new_n308_), .b(x79), .c(new_n161_), .d(x77), .O(new_n325_));
  oai21  g161(.a(x78), .b(new_n228_), .c(new_n154_), .O(new_n326_));
  aoi21  g162(.a(new_n326_), .b(new_n325_), .c(x01), .O(z60));
  nand4  g163(.a(new_n222_), .b(x80), .c(x79), .d(new_n161_), .O(new_n328_));
  nor3   g164(.a(new_n328_), .b(new_n153_), .c(x01), .O(z61));
  inv1   g165(.a(x81), .O(new_n330_));
  inv1   g166(.a(x84), .O(new_n331_));
  nor2   g167(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  nand3  g168(.a(new_n316_), .b(new_n332_), .c(x79), .O(new_n333_));
  aoi21  g169(.a(new_n333_), .b(new_n226_), .c(x01), .O(z62));
  nand4  g170(.a(new_n222_), .b(x82), .c(x79), .d(new_n161_), .O(new_n335_));
  nor3   g171(.a(new_n335_), .b(new_n153_), .c(x01), .O(z63));
  nand2  g172(.a(new_n331_), .b(new_n330_), .O(new_n337_));
  nand3  g173(.a(x84), .b(x81), .c(new_n161_), .O(new_n338_));
  nand2  g174(.a(new_n338_), .b(new_n337_), .O(new_n339_));
  nand4  g175(.a(new_n339_), .b(x83), .c(x79), .d(x77), .O(new_n340_));
  nand3  g176(.a(x78), .b(new_n153_), .c(x04), .O(new_n341_));
  nand2  g177(.a(new_n341_), .b(new_n340_), .O(new_n342_));
  nand2  g178(.a(new_n342_), .b(new_n164_), .O(new_n343_));
  nand2  g179(.a(new_n343_), .b(new_n157_), .O(z64));
  nand2  g180(.a(new_n332_), .b(x79), .O(new_n345_));
  nand2  g181(.a(new_n316_), .b(new_n164_), .O(new_n346_));
  nor2   g182(.a(new_n346_), .b(new_n345_), .O(z65));
  zero   g183(.O(z25));
  zero   g184(.O(z27));
  zero   g185(.O(z29));
  zero   g186(.O(z30));
  ...
  zero   g194(.O(z45));
  zero   g195(.O(z55));
  inv1   g196(.a(new_n157_), .O(z28));
  inv1   g197(.a(new_n157_), .O(z32));
  inv1   g198(.a(new_n157_), .O(z36));
  inv1   g199(.a(new_n157_), .O(z37));
  inv1   g200(.a(new_n157_), .O(z39));
  inv1   g201(.a(new_n157_), .O(z40));
  inv1   g202(.a(new_n157_), .O(z42));
  inv1   g203(.a(new_n157_), .O(z44));
  inv1   g204(.a(new_n157_), .O(z46));
endmodule
