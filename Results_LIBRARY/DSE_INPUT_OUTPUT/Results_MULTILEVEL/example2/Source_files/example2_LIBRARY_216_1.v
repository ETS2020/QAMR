...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n158_,
    ...
    new_n223_, new_n224_, new_n225_, new_n227_, new_n238_, new_n239_,
  ...
  nand2  g079(.a(new_n153_), .b(x07), .O(new_n240_));
  aoi21  g080(.a(new_n240_), .b(new_n239_), .c(x79), .O(new_n241_));
  nand4  g081(.a(new_n241_), .b(x78), .c(new_n238_), .d(x04), .O(new_n242_));
  nor2   g082(.a(new_n242_), .b(x01), .O(z47));
  ...
  nand2  g089(.a(new_n153_), .b(x09), .O(new_n250_));
  ...
  aoi21  g117(.a(new_n277_), .b(new_n156_), .c(x01), .O(z54));
  nand2  g118(.a(new_n167_), .b(new_n238_), .O(new_n280_));
  nand3  g119(.a(new_n280_), .b(z01), .c(x00), .O(z56));
  inv1   g120(.a(x02), .O(new_n282_));
  nand3  g121(.a(x03), .b(new_n282_), .c(x00), .O(new_n283_));
  aoi21  g122(.a(new_n283_), .b(new_n156_), .c(x01), .O(z57));
  ...
  nand3  g127(.a(new_n288_), .b(new_n156_), .c(new_n160_), .O(new_n289_));
  inv1   g128(.a(new_n289_), .O(z58));
  oai21  g129(.a(x78), .b(x40), .c(x77), .O(new_n291_));
  nor2   g130(.a(x79), .b(new_n224_), .O(new_n292_));
  aoi21  g131(.a(new_n292_), .b(new_n291_), .c(x01), .O(z59));
  oai21  g132(.a(x78), .b(new_n224_), .c(new_n156_), .O(new_n294_));
  nor2   g133(.a(new_n294_), .b(x01), .O(z60));
  nand3  g134(.a(x78), .b(new_n238_), .c(x04), .O(new_n297_));
  aoi21  g135(.a(new_n297_), .b(new_n156_), .c(x01), .O(z64));
  zero   g136(.O(z25));
  zero   g137(.O(z26));
  zero   g138(.O(z32));
  zero   g139(.O(z33));
  ...
  zero   g146(.O(z61));
  zero   g147(.O(z65));
  nor2   g148(.a(new_n156_), .b(x01), .O(z27));
  ...
  nor2   g157(.a(new_n156_), .b(x01), .O(z42));
