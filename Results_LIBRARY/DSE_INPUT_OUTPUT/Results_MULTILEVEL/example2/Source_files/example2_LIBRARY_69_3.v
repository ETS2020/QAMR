...
module FAU ( 
  ...
  aoi21  g013(.a(new_n164_), .b(new_n159_), .c(new_n162_), .O(z02));
  ...
  nand4  g088(.a(new_n251_), .b(x78), .c(new_n158_), .d(x04), .O(new_n252_));
  xor2a  g089(.a(x84), .b(x81), .O(new_n253_));
  nor2   g090(.a(x75), .b(x67), .O(new_n254_));
  nor2   g091(.a(new_n254_), .b(new_n253_), .O(new_n255_));
  nand4  g092(.a(new_n255_), .b(x79), .c(new_n159_), .d(x77), .O(new_n256_));
  aoi21  g093(.a(new_n256_), .b(new_n252_), .c(x01), .O(z47));
  inv1   g094(.a(x08), .O(new_n258_));
  nand2  g095(.a(x52), .b(x16), .O(new_n259_));
  oai21  g096(.a(x52), .b(new_n258_), .c(new_n259_), .O(new_n260_));
  nand4  g097(.a(new_n260_), .b(x78), .c(new_n158_), .d(x04), .O(new_n261_));
  nand4  g098(.a(new_n222_), .b(x79), .c(x77), .d(x68), .O(new_n262_));
  nand2  g099(.a(new_n262_), .b(new_n261_), .O(new_n263_));
  nand2  g100(.a(new_n263_), .b(new_n163_), .O(new_n264_));
  nand2  g101(.a(new_n264_), .b(new_n156_), .O(z48));
  inv1   g102(.a(x09), .O(new_n266_));
  nand2  g103(.a(x52), .b(x17), .O(new_n267_));
  oai21  g104(.a(x52), .b(new_n266_), .c(new_n267_), .O(new_n268_));
  nand4  g105(.a(new_n268_), .b(x78), .c(new_n158_), .d(x04), .O(new_n269_));
  nand4  g106(.a(new_n222_), .b(x79), .c(x77), .d(x69), .O(new_n270_));
  nand2  g107(.a(new_n270_), .b(new_n269_), .O(new_n271_));
  nand2  g108(.a(new_n271_), .b(new_n163_), .O(new_n272_));
  nand2  g109(.a(new_n272_), .b(new_n156_), .O(z49));
  inv1   g110(.a(x10), .O(new_n274_));
  nand2  g111(.a(x52), .b(x18), .O(new_n275_));
  oai21  g112(.a(x52), .b(new_n274_), .c(new_n275_), .O(new_n276_));
  nand4  g113(.a(new_n276_), .b(x78), .c(new_n158_), .d(x04), .O(new_n277_));
  nand4  g114(.a(new_n222_), .b(x79), .c(x77), .d(x70), .O(new_n278_));
  nand2  g115(.a(new_n278_), .b(new_n277_), .O(new_n279_));
  nand2  g116(.a(new_n279_), .b(new_n163_), .O(new_n280_));
  nand2  g117(.a(new_n280_), .b(new_n156_), .O(z50));
  inv1   g118(.a(x11), .O(new_n282_));
  nand2  g119(.a(x52), .b(x19), .O(new_n283_));
  oai21  g120(.a(x52), .b(new_n282_), .c(new_n283_), .O(new_n284_));
  nand4  g121(.a(new_n284_), .b(x78), .c(new_n158_), .d(x04), .O(new_n285_));
  nand4  g122(.a(new_n222_), .b(x79), .c(x77), .d(x71), .O(new_n286_));
  nand2  g123(.a(new_n286_), .b(new_n285_), .O(new_n287_));
  nand2  g124(.a(new_n287_), .b(new_n163_), .O(new_n288_));
  nand2  g125(.a(new_n288_), .b(new_n156_), .O(z51));
  inv1   g126(.a(x12), .O(new_n290_));
  nand2  g127(.a(x52), .b(x20), .O(new_n291_));
  oai21  g128(.a(x52), .b(new_n290_), .c(new_n291_), .O(new_n292_));
  nand4  g129(.a(new_n292_), .b(x78), .c(new_n158_), .d(x04), .O(new_n293_));
  nand4  g130(.a(new_n222_), .b(x79), .c(x77), .d(x72), .O(new_n294_));
  nand2  g131(.a(new_n294_), .b(new_n293_), .O(new_n295_));
  nand2  g132(.a(new_n295_), .b(new_n163_), .O(new_n296_));
  nand2  g133(.a(new_n296_), .b(new_n156_), .O(z52));
  nand2  g134(.a(x52), .b(x21), .O(new_n298_));
  nand2  g135(.a(new_n249_), .b(x13), .O(new_n299_));
  aoi21  g136(.a(new_n299_), .b(new_n298_), .c(x79), .O(new_n300_));
  nand4  g137(.a(new_n300_), .b(x78), .c(new_n158_), .d(x04), .O(new_n301_));
  nor2   g138(.a(new_n253_), .b(new_n162_), .O(new_n302_));
  nand4  g139(.a(new_n302_), .b(new_n159_), .c(x77), .d(x73), .O(new_n303_));
  aoi21  g140(.a(new_n303_), .b(new_n301_), .c(x01), .O(z53));
  inv1   g141(.a(x14), .O(new_n305_));
  nand2  g142(.a(x52), .b(x22), .O(new_n306_));
  oai21  g143(.a(x52), .b(new_n305_), .c(new_n306_), .O(new_n307_));
  nand4  g144(.a(new_n307_), .b(new_n158_), .c(x04), .d(new_n163_), .O(new_n308_));
  aoi21  g145(.a(new_n308_), .b(new_n162_), .c(new_n159_), .O(z54));
  inv1   g146(.a(x76), .O(new_n310_));
  xnor2a g147(.a(x84), .b(x81), .O(new_n311_));
  nand2  g148(.a(new_n311_), .b(new_n310_), .O(new_n312_));
  aoi21  g149(.a(new_n312_), .b(x79), .c(new_n158_), .O(new_n313_));
  oai21  g150(.a(new_n313_), .b(x78), .c(new_n229_), .O(z56));
  nand2  g151(.a(new_n156_), .b(x03), .O(new_n315_));
  nor4   g152(.a(new_n315_), .b(x02), .c(x01), .d(new_n228_), .O(z57));
  nor2   g153(.a(x77), .b(x01), .O(new_n317_));
  oai21  g154(.a(new_n317_), .b(x79), .c(x78), .O(new_n318_));
  inv1   g155(.a(x42), .O(new_n319_));
  nand4  g156(.a(new_n159_), .b(x77), .c(new_n319_), .d(x40), .O(new_n320_));
  nand2  g157(.a(new_n320_), .b(x04), .O(new_n321_));
  nand3  g158(.a(new_n321_), .b(new_n162_), .c(new_n163_), .O(new_n322_));
  nand2  g159(.a(new_n322_), .b(new_n318_), .O(z58));
  oai21  g160(.a(x78), .b(x40), .c(x77), .O(new_n324_));
  nand2  g161(.a(new_n324_), .b(x04), .O(new_n325_));
  nand3  g162(.a(new_n325_), .b(new_n162_), .c(new_n163_), .O(new_n326_));
  nand2  g163(.a(new_n326_), .b(new_n156_), .O(z59));
  nor2   g164(.a(new_n311_), .b(new_n162_), .O(new_n328_));
  nand3  g165(.a(new_n328_), .b(new_n159_), .c(x77), .O(new_n329_));
  oai21  g166(.a(x78), .b(new_n230_), .c(new_n162_), .O(new_n330_));
  aoi21  g167(.a(new_n330_), .b(new_n329_), .c(x01), .O(z60));
  nand4  g168(.a(new_n222_), .b(x80), .c(x79), .d(new_n159_), .O(new_n332_));
  nor3   g169(.a(new_n332_), .b(new_n158_), .c(x01), .O(z61));
  nand3  g170(.a(new_n162_), .b(x78), .c(x04), .O(new_n334_));
  and2   g171(.a(x84), .b(x81), .O(new_n335_));
  nand4  g172(.a(new_n335_), .b(x79), .c(new_n159_), .d(x77), .O(new_n336_));
  aoi21  g173(.a(new_n336_), .b(new_n334_), .c(x01), .O(z62));
  nand4  g174(.a(new_n222_), .b(x82), .c(x77), .d(new_n163_), .O(new_n338_));
  aoi21  g175(.a(new_n338_), .b(new_n159_), .c(new_n162_), .O(z63));
  nand4  g176(.a(new_n222_), .b(x83), .c(x79), .d(x77), .O(new_n340_));
  nand3  g177(.a(x78), .b(new_n158_), .c(x04), .O(new_n341_));
  nand2  g178(.a(new_n341_), .b(new_n340_), .O(new_n342_));
  nand2  g179(.a(new_n342_), .b(new_n163_), .O(new_n343_));
  nand2  g180(.a(new_n343_), .b(new_n156_), .O(z64));
  nand3  g181(.a(new_n335_), .b(x77), .c(new_n163_), .O(new_n345_));
  aoi21  g182(.a(new_n345_), .b(new_n159_), .c(new_n162_), .O(z65));
  zero   g183(.O(z25));
  zero   g184(.O(z26));
  zero   g185(.O(z28));
  zero   g186(.O(z29));
  ...
  inv1   g198(.a(new_n156_), .O(z37));
  inv1   g199(.a(new_n156_), .O(z38));
  inv1   g200(.a(new_n156_), .O(z39));
  inv1   g201(.a(new_n156_), .O(z40));
  inv1   g202(.a(new_n156_), .O(z43));
  inv1   g203(.a(new_n156_), .O(z45));
