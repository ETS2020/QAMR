...
module FAU ( 
  ...
  nand3  g010(.a(new_n161_), .b(x40), .c(new_n160_), .O(new_n162_));
  ...
  nand2  g015(.a(new_n161_), .b(new_n160_), .O(new_n168_));
  inv1   g016(.a(new_n168_), .O(z04));
  ...
  aoi21  g058(.a(new_n210_), .b(new_n209_), .c(z27), .O(z18));
  nand2  g059(.a(new_n152_), .b(x37), .O(new_n212_));
  nand2  g060(.a(x46), .b(x40), .O(new_n213_));
  aoi21  g061(.a(new_n213_), .b(new_n212_), .c(z27), .O(z19));
  ...
  aoi21  g067(.a(new_n219_), .b(new_n218_), .c(z27), .O(z21));
  ...
  oai21  g117(.a(x78), .b(x77), .c(x00), .O(new_n283_));
  nand2  g118(.a(new_n283_), .b(new_n156_), .O(new_n284_));
  nand2  g119(.a(new_n284_), .b(new_n160_), .O(z56));
  inv1   g120(.a(x02), .O(new_n286_));
  nand4  g121(.a(x03), .b(new_n286_), .c(new_n160_), .d(x00), .O(new_n287_));
  nor2   g122(.a(new_n287_), .b(x79), .O(z57));
  aoi21  g123(.a(x78), .b(new_n241_), .c(new_n223_), .O(new_n289_));
  inv1   g124(.a(x42), .O(new_n290_));
  inv1   g125(.a(x78), .O(new_n291_));
  nand4  g126(.a(new_n291_), .b(x77), .c(new_n290_), .d(x40), .O(new_n292_));
  nand3  g127(.a(new_n292_), .b(new_n289_), .c(new_n156_), .O(new_n293_));
  and2   g128(.a(new_n293_), .b(new_n160_), .O(z58));
  oai21  g129(.a(x78), .b(x40), .c(x77), .O(new_n295_));
  nor2   g130(.a(x79), .b(new_n223_), .O(new_n296_));
  aoi21  g131(.a(new_n296_), .b(new_n295_), .c(x01), .O(z59));
  nor2   g132(.a(x79), .b(x78), .O(new_n298_));
  aoi21  g133(.a(new_n298_), .b(x04), .c(x01), .O(z60));
  nand4  g134(.a(x78), .b(new_n241_), .c(x04), .d(new_n160_), .O(new_n301_));
  ...
  zero   g150(.O(z63));
  zero   g151(.O(z65));
  nor2   g152(.a(new_n156_), .b(x01), .O(z29));
  nor2   g153(.a(new_n156_), .b(x01), .O(z31));
  nor2   g154(.a(new_n156_), .b(x01), .O(z32));
  nor2   g155(.a(new_n156_), .b(x01), .O(z36));
  ...
  aoi21  g162(.a(new_n221_), .b(new_n156_), .c(x01), .O(z62));
endmodule
