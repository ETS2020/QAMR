...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n223_, new_n225_, new_n240_, new_n241_, new_n242_, new_n243_,
  ...
  nand2  g026(.a(new_n153_), .b(x26), .O(new_n178_));
  ...
  nand2  g064(.a(new_n153_), .b(x39), .O(new_n216_));
  ...
  nand2  g077(.a(new_n156_), .b(x07), .O(new_n242_));
  ...
  nand2  g082(.a(new_n156_), .b(x08), .O(new_n247_));
  ...
  nand2  g087(.a(new_n156_), .b(x09), .O(new_n252_));
  ...
  nand2  g091(.a(x52), .b(x18), .O(new_n256_));
  nand2  g092(.a(new_n156_), .b(x10), .O(new_n257_));
  aoi21  g093(.a(new_n257_), .b(new_n256_), .c(x79), .O(new_n258_));
  nand4  g094(.a(new_n258_), .b(x78), .c(new_n240_), .d(x04), .O(new_n259_));
  nor2   g095(.a(new_n259_), .b(x01), .O(z50));
  ...
  aoi21  g100(.a(new_n264_), .b(new_n160_), .c(x01), .O(z51));
  inv1   g101(.a(x12), .O(new_n266_));
  nand2  g102(.a(x52), .b(x20), .O(new_n267_));
  oai21  g103(.a(x52), .b(new_n266_), .c(new_n267_), .O(new_n268_));
  nand4  g104(.a(new_n268_), .b(x78), .c(new_n240_), .d(x04), .O(new_n269_));
  aoi21  g105(.a(new_n269_), .b(new_n160_), .c(x01), .O(z52));
  nand2  g106(.a(x52), .b(x21), .O(new_n271_));
  nand2  g107(.a(new_n156_), .b(x13), .O(new_n272_));
  aoi21  g108(.a(new_n272_), .b(new_n271_), .c(x79), .O(new_n273_));
  nand4  g109(.a(new_n273_), .b(x78), .c(new_n240_), .d(x04), .O(new_n274_));
  nor2   g110(.a(new_n274_), .b(x01), .O(z53));
  ...
  aoi21  g115(.a(new_n279_), .b(new_n160_), .c(x01), .O(z54));
  nand2  g116(.a(new_n164_), .b(new_n240_), .O(new_n282_));
  nand4  g117(.a(new_n282_), .b(new_n160_), .c(z01), .d(x00), .O(z56));
  inv1   g118(.a(x02), .O(new_n284_));
  nand4  g119(.a(x03), .b(new_n284_), .c(z01), .d(x00), .O(new_n285_));
  nor2   g120(.a(new_n285_), .b(x79), .O(z57));
  nand2  g121(.a(x78), .b(new_n240_), .O(new_n287_));
  inv1   g122(.a(x42), .O(new_n288_));
  nand4  g123(.a(new_n164_), .b(x77), .c(new_n288_), .d(x40), .O(new_n289_));
  nand3  g124(.a(new_n289_), .b(new_n287_), .c(x04), .O(new_n290_));
  nand3  g125(.a(new_n290_), .b(new_n160_), .c(z01), .O(new_n291_));
  inv1   g126(.a(new_n291_), .O(z58));
  oai21  g127(.a(x78), .b(x40), .c(x77), .O(new_n293_));
  nand2  g128(.a(new_n293_), .b(x04), .O(new_n294_));
  nand3  g129(.a(new_n294_), .b(new_n160_), .c(z01), .O(new_n295_));
  inv1   g130(.a(new_n295_), .O(z59));
  nor2   g131(.a(x79), .b(new_n222_), .O(new_n297_));
  aoi21  g132(.a(new_n297_), .b(new_n164_), .c(x01), .O(z60));
  nand3  g133(.a(x78), .b(new_n240_), .c(x04), .O(new_n300_));
  aoi21  g134(.a(new_n300_), .b(new_n160_), .c(x01), .O(z64));
  zero   g135(.O(z26));
  zero   g136(.O(z27));
  zero   g137(.O(z28));
  zero   g138(.O(z32));
  ...
  zero   g148(.O(z55));
  zero   g149(.O(z61));
  nor2   g150(.a(new_n160_), .b(x01), .O(z25));
  nor2   g151(.a(new_n160_), .b(x01), .O(z29));
  nor2   g152(.a(new_n160_), .b(x01), .O(z30));
  nor2   g153(.a(new_n160_), .b(x01), .O(z31));
  nor2   g154(.a(new_n160_), .b(x01), .O(z34));
  nor2   g155(.a(new_n160_), .b(x01), .O(z35));
  nor2   g156(.a(new_n160_), .b(x01), .O(z36));
  nor2   g157(.a(new_n160_), .b(x01), .O(z39));
  nor2   g158(.a(new_n160_), .b(x01), .O(z44));
  aoi21  g159(.a(new_n219_), .b(new_n160_), .c(x01), .O(z62));
