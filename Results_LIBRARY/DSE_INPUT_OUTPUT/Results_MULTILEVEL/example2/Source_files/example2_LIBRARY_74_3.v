...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n158_,
    ...
    new_n230_, new_n232_, new_n233_, new_n244_, new_n245_, new_n246_,
  ...
  inv1   g083(.a(x07), .O(new_n244_));
  nand2  g084(.a(x52), .b(x15), .O(new_n245_));
  oai21  g085(.a(x52), .b(new_n244_), .c(new_n245_), .O(new_n246_));
  nand4  g086(.a(new_n246_), .b(x78), .c(new_n158_), .d(x04), .O(new_n247_));
  or2    g087(.a(x75), .b(x67), .O(new_n248_));
  nand4  g088(.a(new_n248_), .b(new_n223_), .c(x79), .d(x77), .O(new_n249_));
  nand2  g089(.a(new_n249_), .b(new_n247_), .O(new_n250_));
  nand2  g090(.a(new_n250_), .b(new_n163_), .O(new_n251_));
  nand2  g091(.a(new_n251_), .b(new_n156_), .O(z47));
  nand2  g092(.a(x52), .b(x16), .O(new_n253_));
  inv1   g093(.a(x52), .O(new_n254_));
  nand2  g094(.a(new_n254_), .b(x08), .O(new_n255_));
  aoi21  g095(.a(new_n255_), .b(new_n253_), .c(x79), .O(new_n256_));
  nand4  g096(.a(new_n256_), .b(x78), .c(new_n158_), .d(x04), .O(new_n257_));
  nand2  g097(.a(new_n225_), .b(x68), .O(new_n258_));
  aoi21  g098(.a(new_n258_), .b(new_n257_), .c(x01), .O(z48));
  nand2  g099(.a(x52), .b(x17), .O(new_n260_));
  nand2  g100(.a(new_n254_), .b(x09), .O(new_n261_));
  aoi21  g101(.a(new_n261_), .b(new_n260_), .c(x79), .O(new_n262_));
  nand4  g102(.a(new_n262_), .b(x78), .c(new_n158_), .d(x04), .O(new_n263_));
  nand2  g103(.a(new_n225_), .b(x69), .O(new_n264_));
  aoi21  g104(.a(new_n264_), .b(new_n263_), .c(x01), .O(z49));
  nand2  g105(.a(x52), .b(x18), .O(new_n266_));
  nand2  g106(.a(new_n254_), .b(x10), .O(new_n267_));
  aoi21  g107(.a(new_n267_), .b(new_n266_), .c(x79), .O(new_n268_));
  nand4  g108(.a(new_n268_), .b(x78), .c(new_n158_), .d(x04), .O(new_n269_));
  nand2  g109(.a(new_n225_), .b(x70), .O(new_n270_));
  aoi21  g110(.a(new_n270_), .b(new_n269_), .c(x01), .O(z50));
  inv1   g111(.a(x11), .O(new_n272_));
  nand2  g112(.a(x52), .b(x19), .O(new_n273_));
  oai21  g113(.a(x52), .b(new_n272_), .c(new_n273_), .O(new_n274_));
  nand4  g114(.a(new_n274_), .b(x78), .c(new_n158_), .d(x04), .O(new_n275_));
  nand4  g115(.a(new_n223_), .b(x79), .c(x77), .d(x71), .O(new_n276_));
  nand2  g116(.a(new_n276_), .b(new_n275_), .O(new_n277_));
  nand2  g117(.a(new_n277_), .b(new_n163_), .O(new_n278_));
  nand2  g118(.a(new_n278_), .b(new_n156_), .O(z51));
  inv1   g119(.a(x12), .O(new_n280_));
  nand2  g120(.a(x52), .b(x20), .O(new_n281_));
  oai21  g121(.a(x52), .b(new_n280_), .c(new_n281_), .O(new_n282_));
  nand4  g122(.a(new_n282_), .b(x78), .c(new_n158_), .d(x04), .O(new_n283_));
  nand4  g123(.a(new_n223_), .b(x79), .c(x77), .d(x72), .O(new_n284_));
  nand2  g124(.a(new_n284_), .b(new_n283_), .O(new_n285_));
  nand2  g125(.a(new_n285_), .b(new_n163_), .O(new_n286_));
  nand2  g126(.a(new_n286_), .b(new_n156_), .O(z52));
  nand2  g127(.a(x52), .b(x21), .O(new_n288_));
  nand2  g128(.a(new_n254_), .b(x13), .O(new_n289_));
  aoi21  g129(.a(new_n289_), .b(new_n288_), .c(x79), .O(new_n290_));
  nand4  g130(.a(new_n290_), .b(x78), .c(new_n158_), .d(x04), .O(new_n291_));
  nand2  g131(.a(new_n225_), .b(x73), .O(new_n292_));
  aoi21  g132(.a(new_n292_), .b(new_n291_), .c(x01), .O(z53));
  nand2  g133(.a(x52), .b(x22), .O(new_n294_));
  nand2  g134(.a(new_n254_), .b(x14), .O(new_n295_));
  aoi21  g135(.a(new_n295_), .b(new_n294_), .c(x79), .O(new_n296_));
  nand4  g136(.a(new_n296_), .b(x78), .c(new_n158_), .d(x04), .O(new_n297_));
  nor2   g137(.a(new_n297_), .b(x01), .O(z54));
  inv1   g138(.a(x76), .O(new_n300_));
  nand2  g139(.a(new_n159_), .b(new_n300_), .O(new_n301_));
  xor2a  g140(.a(x84), .b(x81), .O(new_n302_));
  oai21  g141(.a(new_n302_), .b(new_n301_), .c(x79), .O(new_n303_));
  nand4  g142(.a(new_n303_), .b(new_n160_), .c(new_n163_), .d(x00), .O(z56));
  inv1   g143(.a(x00), .O(new_n305_));
  nand2  g144(.a(new_n156_), .b(x03), .O(new_n306_));
  nor4   g145(.a(new_n306_), .b(x02), .c(x01), .d(new_n305_), .O(z57));
  nor2   g146(.a(x77), .b(x01), .O(new_n308_));
  oai21  g147(.a(new_n308_), .b(x79), .c(x78), .O(new_n309_));
  inv1   g148(.a(x42), .O(new_n310_));
  nand4  g149(.a(new_n159_), .b(x77), .c(new_n310_), .d(x40), .O(new_n311_));
  nand2  g150(.a(new_n311_), .b(x04), .O(new_n312_));
  nand3  g151(.a(new_n312_), .b(new_n162_), .c(new_n163_), .O(new_n313_));
  nand2  g152(.a(new_n313_), .b(new_n309_), .O(z58));
  oai21  g153(.a(x79), .b(new_n154_), .c(new_n159_), .O(new_n315_));
  aoi22  g154(.a(new_n315_), .b(x77), .c(new_n162_), .d(new_n229_), .O(new_n316_));
  oai21  g155(.a(new_n316_), .b(x01), .c(new_n156_), .O(z59));
  nand3  g156(.a(new_n302_), .b(x79), .c(x77), .O(new_n318_));
  aoi21  g157(.a(new_n162_), .b(new_n229_), .c(x78), .O(new_n319_));
  nand2  g158(.a(new_n319_), .b(new_n318_), .O(new_n320_));
  nand2  g159(.a(new_n320_), .b(new_n163_), .O(new_n321_));
  nand2  g160(.a(new_n321_), .b(new_n156_), .O(z60));
  nand2  g161(.a(x84), .b(x81), .O(new_n323_));
  or2    g162(.a(x84), .b(x81), .O(new_n324_));
  oai21  g163(.a(new_n323_), .b(x78), .c(new_n324_), .O(new_n325_));
  nand4  g164(.a(new_n325_), .b(x80), .c(x77), .d(new_n163_), .O(new_n326_));
  aoi21  g165(.a(new_n326_), .b(new_n159_), .c(new_n162_), .O(z61));
  inv1   g166(.a(new_n323_), .O(new_n328_));
  nand4  g167(.a(new_n328_), .b(x79), .c(new_n159_), .d(x77), .O(new_n329_));
  aoi21  g168(.a(new_n329_), .b(new_n227_), .c(x01), .O(z62));
  nand4  g169(.a(new_n223_), .b(x82), .c(x77), .d(new_n163_), .O(new_n331_));
  aoi21  g170(.a(new_n331_), .b(new_n159_), .c(new_n162_), .O(z63));
  nand4  g171(.a(new_n223_), .b(x83), .c(x79), .d(x77), .O(new_n333_));
  nand3  g172(.a(x78), .b(new_n158_), .c(x04), .O(new_n334_));
  nand2  g173(.a(new_n334_), .b(new_n333_), .O(new_n335_));
  nand2  g174(.a(new_n335_), .b(new_n163_), .O(new_n336_));
  nand2  g175(.a(new_n336_), .b(new_n156_), .O(z64));
  nand3  g176(.a(new_n328_), .b(x77), .c(new_n163_), .O(new_n338_));
  aoi21  g177(.a(new_n338_), .b(new_n159_), .c(new_n162_), .O(z65));
  zero   g178(.O(z26));
  zero   g179(.O(z30));
  zero   g180(.O(z32));
  zero   g181(.O(z33));
  ...
  zero   g186(.O(z43));
  zero   g187(.O(z55));
  inv1   g188(.a(new_n156_), .O(z27));
  inv1   g189(.a(new_n156_), .O(z28));
  inv1   g190(.a(new_n156_), .O(z29));
  inv1   g191(.a(new_n156_), .O(z31));
  inv1   g192(.a(new_n156_), .O(z34));
  inv1   g193(.a(new_n156_), .O(z35));
  inv1   g194(.a(new_n156_), .O(z40));
  inv1   g195(.a(new_n156_), .O(z41));
  inv1   g196(.a(new_n156_), .O(z42));
  inv1   g197(.a(new_n156_), .O(z44));
  inv1   g198(.a(new_n156_), .O(z45));
