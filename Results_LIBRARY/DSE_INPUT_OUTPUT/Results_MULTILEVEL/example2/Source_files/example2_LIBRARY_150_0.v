...
module FAU ( 
  ...
  nand3  g036(.a(new_n187_), .b(new_n186_), .c(new_n185_), .O(z09));
  ...
  nand3  g042(.a(new_n193_), .b(new_n192_), .c(new_n185_), .O(z11));
  nand2  g043(.a(x58), .b(x40), .O(new_n195_));
  nand2  g044(.a(new_n152_), .b(x30), .O(new_n196_));
  nand3  g045(.a(new_n196_), .b(new_n195_), .c(new_n185_), .O(z12));
  nand2  g046(.a(x57), .b(x40), .O(new_n198_));
  nand2  g047(.a(new_n152_), .b(x31), .O(new_n199_));
  nand3  g048(.a(new_n199_), .b(new_n198_), .c(new_n185_), .O(z13));
  nand2  g049(.a(x51), .b(x40), .O(new_n201_));
  nand2  g050(.a(new_n152_), .b(x32), .O(new_n202_));
  nand3  g051(.a(new_n202_), .b(new_n201_), .c(new_n185_), .O(z14));
  nand2  g052(.a(x50), .b(x40), .O(new_n204_));
  nand2  g053(.a(new_n152_), .b(x33), .O(new_n205_));
  nand3  g054(.a(new_n205_), .b(new_n204_), .c(new_n185_), .O(z15));
  nand2  g055(.a(x49), .b(x40), .O(new_n207_));
  nand2  g056(.a(new_n152_), .b(x34), .O(new_n208_));
  nand3  g057(.a(new_n208_), .b(new_n207_), .c(new_n185_), .O(z16));
  nand2  g058(.a(x48), .b(x40), .O(new_n210_));
  nand2  g059(.a(new_n152_), .b(x35), .O(new_n211_));
  nand3  g060(.a(new_n211_), .b(new_n210_), .c(new_n185_), .O(z17));
  nand2  g061(.a(new_n152_), .b(x36), .O(new_n213_));
  nand2  g062(.a(x47), .b(x40), .O(new_n214_));
  aoi21  g063(.a(new_n214_), .b(new_n213_), .c(z03), .O(z18));
  nand2  g064(.a(x46), .b(x40), .O(new_n216_));
  nand2  g065(.a(new_n152_), .b(x37), .O(new_n217_));
  nand3  g066(.a(new_n217_), .b(new_n216_), .c(new_n185_), .O(z19));
  nand2  g067(.a(new_n152_), .b(x38), .O(new_n219_));
  nand2  g068(.a(x45), .b(x40), .O(new_n220_));
  aoi21  g069(.a(new_n220_), .b(new_n219_), .c(z03), .O(z20));
  nand2  g070(.a(new_n152_), .b(x39), .O(new_n222_));
  ...
  nand2  g088(.a(z04), .b(x00), .O(new_n240_));
  inv1   g089(.a(new_n240_), .O(new_n241_));
  nand2  g090(.a(new_n241_), .b(x79), .O(z23));
  inv1   g091(.a(x04), .O(new_n243_));
  nor2   g092(.a(new_n160_), .b(x43), .O(new_n244_));
  ...
  nand4  g103(.a(new_n254_), .b(new_n230_), .c(x05), .d(new_n243_), .O(new_n255_));
  aoi21  g104(.a(new_n255_), .b(x79), .c(x01), .O(z25));
  nand4  g105(.a(new_n254_), .b(x44), .c(new_n230_), .d(new_n243_), .O(new_n257_));
  aoi21  g106(.a(new_n257_), .b(x79), .c(x01), .O(z26));
  nand4  g107(.a(new_n254_), .b(x45), .c(new_n230_), .d(new_n243_), .O(new_n259_));
  aoi21  g108(.a(new_n259_), .b(x79), .c(x01), .O(z27));
  nand4  g109(.a(new_n252_), .b(x79), .c(x78), .d(x77), .O(new_n261_));
  inv1   g110(.a(new_n261_), .O(new_n262_));
  nand4  g111(.a(new_n262_), .b(x46), .c(new_n230_), .d(new_n243_), .O(new_n263_));
  nor2   g112(.a(new_n263_), .b(x01), .O(z28));
  nand4  g113(.a(new_n254_), .b(x47), .c(new_n230_), .d(new_n243_), .O(new_n265_));
  aoi21  g114(.a(new_n265_), .b(x79), .c(x01), .O(z29));
  nand4  g115(.a(new_n254_), .b(x48), .c(new_n230_), .d(new_n243_), .O(new_n267_));
  aoi21  g116(.a(new_n267_), .b(x79), .c(x01), .O(z30));
  nand4  g117(.a(new_n254_), .b(x49), .c(new_n230_), .d(new_n243_), .O(new_n269_));
  aoi21  g118(.a(new_n269_), .b(x79), .c(x01), .O(z31));
  nand4  g119(.a(new_n262_), .b(x50), .c(new_n230_), .d(new_n243_), .O(new_n271_));
  ...
  nand4  g144(.a(new_n295_), .b(x77), .c(x52), .d(new_n243_), .O(new_n296_));
  ...
  nand4  g151(.a(new_n295_), .b(x77), .c(x55), .d(new_n243_), .O(new_n303_));
  aoi21  g152(.a(new_n303_), .b(x79), .c(x01), .O(z37));
  nand4  g153(.a(new_n295_), .b(x77), .c(x56), .d(new_n243_), .O(new_n305_));
  aoi21  g154(.a(new_n305_), .b(x79), .c(x01), .O(z38));
  nand4  g155(.a(new_n295_), .b(x77), .c(x57), .d(new_n243_), .O(new_n307_));
  ...
  nand4  g161(.a(new_n298_), .b(x78), .c(x77), .d(x60), .O(new_n313_));
  nor3   g162(.a(new_n313_), .b(x04), .c(x01), .O(z42));
  nand4  g163(.a(new_n295_), .b(x77), .c(x61), .d(new_n243_), .O(new_n315_));
  aoi21  g164(.a(new_n315_), .b(x79), .c(x01), .O(z43));
  nand4  g165(.a(new_n295_), .b(x77), .c(x62), .d(new_n243_), .O(new_n317_));
  aoi21  g166(.a(new_n317_), .b(x79), .c(x01), .O(z44));
  nand4  g167(.a(new_n295_), .b(x77), .c(x63), .d(new_n243_), .O(new_n319_));
  aoi21  g168(.a(new_n319_), .b(x79), .c(x01), .O(z45));
  nand4  g169(.a(new_n295_), .b(x77), .c(x64), .d(new_n243_), .O(new_n321_));
  aoi21  g170(.a(new_n321_), .b(x79), .c(x01), .O(z46));
  or2    g171(.a(x75), .b(x67), .O(new_n323_));
  nand4  g172(.a(new_n323_), .b(new_n226_), .c(new_n162_), .d(x77), .O(new_n324_));
  aoi21  g173(.a(new_n324_), .b(x79), .c(x01), .O(z47));
  inv1   g174(.a(x68), .O(new_n326_));
  nand4  g175(.a(new_n226_), .b(x79), .c(new_n162_), .d(x77), .O(new_n327_));
  nor3   g176(.a(new_n327_), .b(new_n326_), .c(x01), .O(z48));
  nand3  g177(.a(new_n226_), .b(new_n162_), .c(x77), .O(new_n329_));
  ...
  nor3   g188(.a(new_n327_), .b(new_n339_), .c(x01), .O(z53));
  ...
  nor4   g194(.a(new_n346_), .b(new_n342_), .c(new_n233_), .d(x82), .O(z55));
  xor2a  g195(.a(x84), .b(x81), .O(new_n348_));
  oai21  g196(.a(new_n348_), .b(x76), .c(new_n160_), .O(new_n349_));
  nand3  g197(.a(new_n349_), .b(new_n241_), .c(new_n164_), .O(z56));
  inv1   g198(.a(x03), .O(new_n351_));
  nor4   g199(.a(new_n240_), .b(new_n163_), .c(new_n351_), .d(x02), .O(z57));
  nand4  g200(.a(x80), .b(new_n231_), .c(x43), .d(new_n230_), .O(new_n353_));
  oai22  g201(.a(new_n353_), .b(new_n234_), .c(new_n230_), .d(x40), .O(new_n354_));
  nand4  g202(.a(new_n354_), .b(x79), .c(x78), .d(x77), .O(new_n355_));
  nor3   g203(.a(new_n355_), .b(new_n243_), .c(x01), .O(z58));
  oai21  g204(.a(new_n234_), .b(new_n232_), .c(x79), .O(new_n357_));
  oai21  g205(.a(new_n357_), .b(x42), .c(new_n152_), .O(new_n358_));
  nand4  g206(.a(new_n358_), .b(x78), .c(x77), .d(x04), .O(new_n359_));
  aoi21  g207(.a(new_n359_), .b(x79), .c(x01), .O(z59));
  oai21  g208(.a(new_n168_), .b(new_n166_), .c(new_n348_), .O(new_n361_));
  nand2  g209(.a(new_n361_), .b(new_n237_), .O(new_n362_));
  nand3  g210(.a(new_n362_), .b(x79), .c(z04), .O(new_n363_));
  inv1   g211(.a(new_n363_), .O(z60));
  oai21  g212(.a(new_n168_), .b(new_n166_), .c(new_n226_), .O(new_n365_));
  oai21  g213(.a(new_n160_), .b(x04), .c(new_n365_), .O(new_n366_));
  nand4  g214(.a(new_n366_), .b(x80), .c(x79), .d(z04), .O(new_n367_));
  inv1   g215(.a(new_n367_), .O(z61));
  nand2  g216(.a(x78), .b(new_n243_), .O(new_n369_));
  nand2  g217(.a(x84), .b(new_n162_), .O(new_n370_));
  aoi21  g218(.a(new_n370_), .b(new_n369_), .c(new_n161_), .O(new_n371_));
  nor3   g219(.a(new_n342_), .b(new_n162_), .c(x77), .O(new_n372_));
  oai21  g220(.a(new_n372_), .b(new_n371_), .c(x81), .O(new_n373_));
  nand2  g221(.a(new_n373_), .b(new_n237_), .O(new_n374_));
  nand3  g222(.a(new_n374_), .b(x79), .c(z04), .O(new_n375_));
  inv1   g223(.a(new_n375_), .O(z62));
  nand2  g224(.a(new_n366_), .b(x82), .O(new_n377_));
  aoi21  g225(.a(new_n377_), .b(x79), .c(x01), .O(z63));
  nand2  g226(.a(new_n366_), .b(x83), .O(new_n379_));
  aoi21  g227(.a(new_n379_), .b(x79), .c(x01), .O(z64));
  nand2  g228(.a(x81), .b(new_n162_), .O(new_n381_));
  aoi21  g229(.a(new_n381_), .b(new_n369_), .c(new_n161_), .O(new_n382_));
  nor3   g230(.a(new_n249_), .b(new_n162_), .c(x77), .O(new_n383_));
