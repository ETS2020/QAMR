...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n158_,
    ...
    new_n224_, new_n225_, new_n227_, new_n240_, new_n241_, new_n242_,
  ...
  aoi21  g022(.a(new_n174_), .b(new_n173_), .c(z26), .O(z06));
  ...
  nand3  g028(.a(new_n180_), .b(new_n179_), .c(new_n158_), .O(z08));
  nand2  g029(.a(new_n152_), .b(x27), .O(new_n182_));
  nand2  g030(.a(x61), .b(x40), .O(new_n183_));
  aoi21  g031(.a(new_n183_), .b(new_n182_), .c(z26), .O(z09));
  ...
  oai21  g073(.a(new_n225_), .b(x79), .c(z01), .O(z23));
  nand3  g074(.a(x05), .b(new_n224_), .c(z01), .O(new_n227_));
  nor3   g075(.a(new_n227_), .b(x79), .c(x43), .O(z24));
  ...
  inv1   g097(.a(x11), .O(new_n261_));
  nand2  g098(.a(x52), .b(x19), .O(new_n262_));
  oai21  g099(.a(x52), .b(new_n261_), .c(new_n262_), .O(new_n263_));
  nand4  g100(.a(new_n263_), .b(x78), .c(new_n240_), .d(x04), .O(new_n264_));
  aoi21  g101(.a(new_n264_), .b(new_n156_), .c(x01), .O(z51));
  ...
  nand2  g108(.a(new_n153_), .b(x13), .O(new_n272_));
  aoi21  g109(.a(new_n272_), .b(new_n271_), .c(x79), .O(new_n273_));
  nand4  g110(.a(new_n273_), .b(x78), .c(new_n240_), .d(x04), .O(new_n274_));
  nor2   g111(.a(new_n274_), .b(x01), .O(z53));
  ...
  aoi21  g117(.a(new_n167_), .b(new_n240_), .c(new_n223_), .O(new_n281_));
  oai21  g118(.a(new_n281_), .b(x79), .c(z01), .O(z56));
  inv1   g119(.a(x02), .O(new_n283_));
  nand4  g120(.a(x03), .b(new_n283_), .c(z01), .d(x00), .O(new_n284_));
  nor2   g121(.a(new_n284_), .b(x79), .O(z57));
  nand2  g122(.a(x78), .b(new_n240_), .O(new_n286_));
  ...
  nand3  g126(.a(new_n289_), .b(new_n156_), .c(z01), .O(new_n290_));
  inv1   g127(.a(new_n290_), .O(z58));
  oai21  g128(.a(x78), .b(x40), .c(x77), .O(new_n292_));
  nor2   g129(.a(x79), .b(new_n224_), .O(new_n293_));
  aoi21  g130(.a(new_n293_), .b(new_n292_), .c(x01), .O(z59));
  oai21  g131(.a(x78), .b(new_n224_), .c(new_n156_), .O(new_n295_));
  nor2   g132(.a(new_n295_), .b(x01), .O(z60));
  nand2  g133(.a(x78), .b(x04), .O(new_n298_));
  aoi21  g134(.a(new_n298_), .b(new_n156_), .c(x01), .O(z62));
  nand4  g135(.a(x78), .b(new_n240_), .c(x04), .d(z01), .O(new_n301_));
  nor2   g136(.a(new_n301_), .b(x79), .O(z64));
  zero   g137(.O(z02));
  zero   g138(.O(z25));
  zero   g139(.O(z28));
  zero   g140(.O(z29));
  ...
  nor2   g153(.a(new_n156_), .b(x01), .O(z32));
