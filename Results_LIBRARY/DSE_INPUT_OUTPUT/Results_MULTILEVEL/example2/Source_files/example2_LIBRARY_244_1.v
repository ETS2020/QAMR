...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n225_, new_n236_, new_n237_, new_n238_, new_n239_, new_n240_,
  ...
  nor2   g013(.a(new_n161_), .b(x01), .O(z27));
  inv1   g014(.a(z27), .O(new_n167_));
  nand2  g015(.a(x65), .b(x40), .O(new_n168_));
  nand2  g016(.a(new_n154_), .b(x23), .O(new_n169_));
  nand3  g017(.a(new_n169_), .b(new_n168_), .c(new_n167_), .O(z05));
  nand2  g018(.a(x64), .b(x40), .O(new_n171_));
  nand2  g019(.a(new_n154_), .b(x24), .O(new_n172_));
  nand3  g020(.a(new_n172_), .b(new_n171_), .c(new_n167_), .O(z06));
  nand2  g021(.a(new_n154_), .b(x25), .O(new_n174_));
  nand2  g022(.a(x63), .b(x40), .O(new_n175_));
  aoi21  g023(.a(new_n175_), .b(new_n174_), .c(z27), .O(z07));
  nand2  g024(.a(new_n154_), .b(x26), .O(new_n177_));
  nand2  g025(.a(x62), .b(x40), .O(new_n178_));
  aoi21  g026(.a(new_n178_), .b(new_n177_), .c(z27), .O(z08));
  nand2  g027(.a(x61), .b(x40), .O(new_n180_));
  nand2  g028(.a(new_n154_), .b(x27), .O(new_n181_));
  nand3  g029(.a(new_n181_), .b(new_n180_), .c(new_n167_), .O(z09));
  nand2  g030(.a(new_n154_), .b(x28), .O(new_n183_));
  nand2  g031(.a(x60), .b(x40), .O(new_n184_));
  aoi21  g032(.a(new_n184_), .b(new_n183_), .c(z27), .O(z10));
  nand2  g033(.a(x59), .b(x40), .O(new_n186_));
  nand2  g034(.a(new_n154_), .b(x29), .O(new_n187_));
  nand3  g035(.a(new_n187_), .b(new_n186_), .c(new_n167_), .O(z11));
  nand2  g036(.a(new_n154_), .b(x30), .O(new_n189_));
  nand2  g037(.a(x58), .b(x40), .O(new_n190_));
  aoi21  g038(.a(new_n190_), .b(new_n189_), .c(z27), .O(z12));
  nand2  g039(.a(x57), .b(x40), .O(new_n192_));
  nand2  g040(.a(new_n154_), .b(x31), .O(new_n193_));
  nand3  g041(.a(new_n193_), .b(new_n192_), .c(new_n167_), .O(z13));
  nand2  g042(.a(x51), .b(x40), .O(new_n195_));
  nand2  g043(.a(new_n154_), .b(x32), .O(new_n196_));
  nand3  g044(.a(new_n196_), .b(new_n195_), .c(new_n167_), .O(z14));
  nand2  g045(.a(x50), .b(x40), .O(new_n198_));
  nand2  g046(.a(new_n154_), .b(x33), .O(new_n199_));
  nand3  g047(.a(new_n199_), .b(new_n198_), .c(new_n167_), .O(z15));
  nand2  g048(.a(x49), .b(x40), .O(new_n201_));
  nand2  g049(.a(new_n154_), .b(x34), .O(new_n202_));
  nand3  g050(.a(new_n202_), .b(new_n201_), .c(new_n167_), .O(z16));
  nand2  g051(.a(new_n154_), .b(x35), .O(new_n204_));
  nand2  g052(.a(x48), .b(x40), .O(new_n205_));
  aoi21  g053(.a(new_n205_), .b(new_n204_), .c(z27), .O(z17));
  nand2  g054(.a(new_n154_), .b(x36), .O(new_n207_));
  nand2  g055(.a(x47), .b(x40), .O(new_n208_));
  aoi21  g056(.a(new_n208_), .b(new_n207_), .c(z27), .O(z18));
  nand2  g057(.a(x46), .b(x40), .O(new_n210_));
  nand2  g058(.a(new_n154_), .b(x37), .O(new_n211_));
  nand3  g059(.a(new_n211_), .b(new_n210_), .c(new_n167_), .O(z19));
  nand2  g060(.a(new_n154_), .b(x38), .O(new_n213_));
  nand2  g061(.a(x45), .b(x40), .O(new_n214_));
  aoi21  g062(.a(new_n214_), .b(new_n213_), .c(z27), .O(z20));
  nand2  g063(.a(x44), .b(x40), .O(new_n216_));
  nand2  g064(.a(new_n154_), .b(x39), .O(new_n217_));
  nand3  g065(.a(new_n217_), .b(new_n216_), .c(new_n167_), .O(z21));
  nand2  g066(.a(x78), .b(x04), .O(new_n219_));
  aoi21  g067(.a(new_n219_), .b(new_n161_), .c(x01), .O(z22));
  inv1   g068(.a(x00), .O(new_n221_));
  inv1   g069(.a(x04), .O(new_n222_));
  aoi21  g070(.a(x05), .b(new_n222_), .c(new_n221_), .O(new_n223_));
  oai21  g071(.a(new_n223_), .b(x79), .c(z01), .O(z23));
  nand3  g072(.a(x05), .b(new_n222_), .c(z01), .O(new_n225_));
  nor3   g073(.a(new_n225_), .b(x79), .c(x43), .O(z24));
  inv1   g074(.a(x77), .O(new_n236_));
  nand2  g075(.a(x52), .b(x15), .O(new_n237_));
  nand2  g076(.a(new_n155_), .b(x07), .O(new_n238_));
  aoi21  g077(.a(new_n238_), .b(new_n237_), .c(x79), .O(new_n239_));
  nand4  g078(.a(new_n239_), .b(x78), .c(new_n236_), .d(x04), .O(new_n240_));
  nor2   g079(.a(new_n240_), .b(x01), .O(z47));
  inv1   g080(.a(x08), .O(new_n242_));
  nand2  g081(.a(x52), .b(x16), .O(new_n243_));
  oai21  g082(.a(x52), .b(new_n242_), .c(new_n243_), .O(new_n244_));
  nand4  g083(.a(new_n244_), .b(x78), .c(new_n236_), .d(x04), .O(new_n245_));
  aoi21  g084(.a(new_n245_), .b(new_n161_), .c(x01), .O(z48));
  ...
  aoi21  g089(.a(new_n250_), .b(new_n161_), .c(x01), .O(z49));
  ...
  aoi21  g099(.a(new_n260_), .b(new_n161_), .c(x01), .O(z51));
  ...
  aoi21  g104(.a(new_n265_), .b(new_n161_), .c(x01), .O(z52));
  ...
  aoi21  g109(.a(new_n270_), .b(new_n161_), .c(x01), .O(z53));
  ...
  inv1   g115(.a(x78), .O(new_n278_));
  nand2  g116(.a(new_n278_), .b(new_n236_), .O(new_n279_));
  nand4  g117(.a(new_n279_), .b(new_n161_), .c(z01), .d(x00), .O(z56));
  inv1   g118(.a(x02), .O(new_n281_));
  nand4  g119(.a(x03), .b(new_n281_), .c(z01), .d(x00), .O(new_n282_));
  nor2   g120(.a(new_n282_), .b(x79), .O(z57));
  aoi21  g121(.a(x78), .b(new_n236_), .c(new_n222_), .O(new_n284_));
  inv1   g122(.a(x42), .O(new_n285_));
  nand4  g123(.a(new_n278_), .b(x77), .c(new_n285_), .d(x40), .O(new_n286_));
  nand3  g124(.a(new_n286_), .b(new_n284_), .c(new_n161_), .O(new_n287_));
  and2   g125(.a(new_n287_), .b(z01), .O(z58));
  oai21  g126(.a(x78), .b(x40), .c(x77), .O(new_n289_));
  nand2  g127(.a(new_n289_), .b(x04), .O(new_n290_));
  nand3  g128(.a(new_n290_), .b(new_n161_), .c(z01), .O(new_n291_));
  inv1   g129(.a(new_n291_), .O(z59));
  oai21  g130(.a(x78), .b(new_n222_), .c(new_n161_), .O(new_n293_));
  nor2   g131(.a(new_n293_), .b(x01), .O(z60));
  nand4  g132(.a(new_n161_), .b(x78), .c(x04), .d(z01), .O(new_n295_));
  inv1   g133(.a(new_n295_), .O(z62));
  nand4  g134(.a(x78), .b(new_n236_), .c(x04), .d(z01), .O(new_n297_));
  nor2   g135(.a(new_n297_), .b(x79), .O(z64));
  zero   g136(.O(z02));
  zero   g137(.O(z25));
  zero   g138(.O(z26));
  zero   g139(.O(z30));
  ...
  zero   g145(.O(z46));
  zero   g146(.O(z55));
  nor2   g147(.a(new_n161_), .b(x01), .O(z28));
  nor2   g148(.a(new_n161_), .b(x01), .O(z29));
  nor2   g149(.a(new_n161_), .b(x01), .O(z31));
  nor2   g150(.a(new_n161_), .b(x01), .O(z33));
  nor2   g151(.a(new_n161_), .b(x01), .O(z34));
  nor2   g152(.a(new_n161_), .b(x01), .O(z35));
  nor2   g153(.a(new_n161_), .b(x01), .O(z36));
  nor2   g154(.a(new_n161_), .b(x01), .O(z37));
  nor2   g155(.a(new_n161_), .b(x01), .O(z38));
  nor2   g156(.a(new_n161_), .b(x01), .O(z39));
  nor2   g157(.a(new_n161_), .b(x01), .O(z43));
  nor2   g158(.a(new_n161_), .b(x01), .O(z45));
  nor2   g159(.a(new_n161_), .b(x01), .O(z61));
  nor2   g160(.a(new_n161_), .b(x01), .O(z63));
  nor2   g161(.a(new_n161_), .b(x01), .O(z65));
endmodule
