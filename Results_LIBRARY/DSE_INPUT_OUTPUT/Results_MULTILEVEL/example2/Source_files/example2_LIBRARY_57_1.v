...
module FAU ( 
  ...
  nand2  g015(.a(new_n161_), .b(new_n160_), .O(new_n167_));
  ...
  nand2  g082(.a(new_n153_), .b(x08), .O(new_n246_));
  ...
  nand2  g087(.a(new_n153_), .b(x09), .O(new_n251_));
  ...
  aoi21  g095(.a(new_n258_), .b(new_n156_), .c(x01), .O(z50));
  ...
  aoi21  g100(.a(new_n263_), .b(new_n156_), .c(x01), .O(z51));
  ...
  aoi21  g105(.a(new_n268_), .b(new_n156_), .c(x01), .O(z52));
  ...
  aoi21  g110(.a(new_n273_), .b(new_n156_), .c(x01), .O(z53));
  nand2  g111(.a(x52), .b(x22), .O(new_n275_));
  nand2  g112(.a(new_n153_), .b(x14), .O(new_n276_));
  ...
  nand2  g117(.a(new_n281_), .b(new_n239_), .O(new_n282_));
  nand3  g118(.a(new_n282_), .b(z01), .c(x00), .O(z56));
  inv1   g119(.a(x02), .O(new_n284_));
  nand3  g120(.a(x03), .b(new_n284_), .c(x00), .O(new_n285_));
  aoi21  g121(.a(new_n285_), .b(new_n156_), .c(x01), .O(z57));
  ...
  nand3  g126(.a(new_n290_), .b(new_n156_), .c(new_n160_), .O(new_n291_));
  ...
  oai21  g132(.a(x78), .b(new_n222_), .c(new_n156_), .O(new_n297_));
  nor2   g133(.a(new_n297_), .b(x01), .O(z60));
  nand4  g134(.a(new_n156_), .b(x78), .c(x04), .d(new_n160_), .O(new_n300_));
  inv1   g135(.a(new_n300_), .O(z62));
  nand4  g136(.a(x78), .b(new_n239_), .c(x04), .d(new_n160_), .O(new_n302_));
  nor2   g137(.a(new_n302_), .b(x79), .O(z64));
  zero   g138(.O(z26));
  zero   g139(.O(z28));
  zero   g140(.O(z29));
  zero   g141(.O(z30));
  ...
  zero   g150(.O(z55));
  zero   g151(.O(z61));
  nor2   g152(.a(new_n156_), .b(x01), .O(z25));
