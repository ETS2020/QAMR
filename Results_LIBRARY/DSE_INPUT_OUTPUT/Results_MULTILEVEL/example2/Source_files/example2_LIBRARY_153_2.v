...
module FAU ( 
  ...
  nor2   g017(.a(x79), .b(x17), .O(new_n169_));
  ...
  nand3  g102(.a(new_n183_), .b(new_n152_), .c(x04), .O(new_n254_));
  ...
  nand4  g120(.a(new_n271_), .b(x05), .c(new_n238_), .d(new_n160_), .O(new_n272_));
  ...
  nand4  g170(.a(new_n321_), .b(x52), .c(new_n238_), .d(new_n160_), .O(new_n322_));
  nand2  g171(.a(new_n322_), .b(new_n154_), .O(z34));
  nand4  g172(.a(new_n321_), .b(x53), .c(new_n238_), .d(new_n160_), .O(new_n324_));
  nand2  g173(.a(new_n324_), .b(new_n154_), .O(z35));
  nand4  g174(.a(new_n321_), .b(x54), .c(new_n238_), .d(new_n160_), .O(new_n326_));
  ...
  nand4  g180(.a(new_n321_), .b(x57), .c(new_n238_), .d(new_n160_), .O(new_n332_));
  ...
  nand4  g184(.a(new_n321_), .b(x59), .c(new_n238_), .d(new_n160_), .O(new_n336_));
  ...
  nand4  g192(.a(new_n321_), .b(x63), .c(new_n238_), .d(new_n160_), .O(new_n344_));
  ...
  nand4  g219(.a(new_n370_), .b(new_n183_), .c(new_n174_), .d(x04), .O(new_n371_));
  ...
  nand3  g264(.a(new_n415_), .b(new_n238_), .c(new_n160_), .O(new_n416_));
  ...
  nand2  g277(.a(x42), .b(new_n155_), .O(new_n429_));
  ...
  aoi21  g286(.a(new_n162_), .b(x04), .c(x17), .O(new_n438_));
  nor2   g287(.a(new_n174_), .b(new_n155_), .O(new_n439_));
  oai21  g288(.a(new_n439_), .b(new_n438_), .c(new_n161_), .O(new_n440_));
  oai21  g289(.a(new_n248_), .b(new_n245_), .c(x79), .O(new_n441_));
  oai21  g290(.a(new_n441_), .b(x42), .c(new_n155_), .O(new_n442_));
  ...
  oai21  g307(.a(new_n458_), .b(x01), .c(new_n152_), .O(new_n459_));
  ...
  oai21  g317(.a(new_n468_), .b(new_n461_), .c(new_n160_), .O(new_n469_));
  nand2  g318(.a(new_n469_), .b(new_n460_), .O(z62));
  nand4  g319(.a(new_n455_), .b(x82), .c(x79), .d(new_n160_), .O(new_n471_));
