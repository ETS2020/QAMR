...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n224_, new_n225_, new_n237_, new_n238_, new_n239_, new_n240_,
  ...
  nand3  g024(.a(new_n175_), .b(new_n174_), .c(new_n170_), .O(z07));
  nand2  g025(.a(x62), .b(x40), .O(new_n177_));
  nand2  g026(.a(new_n154_), .b(x26), .O(new_n178_));
  nand3  g027(.a(new_n178_), .b(new_n177_), .c(new_n170_), .O(z08));
  nand2  g028(.a(x61), .b(x40), .O(new_n180_));
  nand2  g029(.a(new_n154_), .b(x27), .O(new_n181_));
  nand3  g030(.a(new_n181_), .b(new_n180_), .c(new_n170_), .O(z09));
  ...
  nand2  g077(.a(new_n155_), .b(x07), .O(new_n239_));
  ...
  aoi21  g090(.a(new_n251_), .b(new_n160_), .c(x01), .O(z49));
  ...
  nand2  g112(.a(new_n155_), .b(x14), .O(new_n274_));
  ...
  oai21  g128(.a(x78), .b(x40), .c(x77), .O(new_n290_));
  nand2  g129(.a(new_n290_), .b(x04), .O(new_n291_));
  nand3  g130(.a(new_n291_), .b(new_n160_), .c(new_n164_), .O(new_n292_));
  inv1   g131(.a(new_n292_), .O(z59));
  nor2   g132(.a(x79), .b(new_n221_), .O(new_n294_));
  aoi21  g133(.a(new_n294_), .b(new_n278_), .c(x01), .O(z60));
  nand3  g134(.a(x78), .b(new_n237_), .c(x04), .O(new_n298_));
  aoi21  g135(.a(new_n298_), .b(new_n160_), .c(x01), .O(z64));
  zero   g136(.O(z26));
  zero   g137(.O(z29));
  zero   g138(.O(z31));
  zero   g139(.O(z32));
  ...
  nor2   g152(.a(new_n160_), .b(x01), .O(z30));
  nor2   g153(.a(new_n160_), .b(x01), .O(z33));
  nor2   g154(.a(new_n160_), .b(x01), .O(z34));
  ...
  aoi21  g162(.a(new_n219_), .b(new_n160_), .c(x01), .O(z62));
endmodule
