...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n303_, new_n304_, new_n306_, new_n308_, new_n310_, new_n312_,
  ...
  nor2   g020(.a(new_n163_), .b(x01), .O(z04));
  ...
  aoi21  g086(.a(new_n237_), .b(new_n234_), .c(new_n162_), .O(new_n238_));
  nand4  g087(.a(new_n238_), .b(x77), .c(new_n231_), .d(x04), .O(new_n239_));
  nand3  g088(.a(new_n239_), .b(new_n230_), .c(x79), .O(new_n240_));
  and2   g089(.a(new_n240_), .b(new_n225_), .O(z22));
  nand3  g090(.a(x79), .b(new_n225_), .c(x00), .O(z23));
  ...
  nand4  g104(.a(new_n255_), .b(new_n231_), .c(x05), .d(new_n247_), .O(new_n256_));
  nor2   g105(.a(new_n256_), .b(x01), .O(z25));
  nand3  g106(.a(new_n253_), .b(x78), .c(x77), .O(new_n258_));
  inv1   g107(.a(new_n258_), .O(new_n259_));
  nand4  g108(.a(new_n259_), .b(x44), .c(new_n231_), .d(new_n247_), .O(new_n260_));
  aoi21  g109(.a(new_n260_), .b(x79), .c(x01), .O(z26));
  nand4  g110(.a(new_n259_), .b(x45), .c(new_n231_), .d(new_n247_), .O(new_n262_));
  aoi21  g111(.a(new_n262_), .b(x79), .c(x01), .O(z27));
  nand4  g112(.a(new_n259_), .b(x46), .c(new_n231_), .d(new_n247_), .O(new_n264_));
  aoi21  g113(.a(new_n264_), .b(x79), .c(x01), .O(z28));
  nand4  g114(.a(new_n255_), .b(x47), .c(new_n231_), .d(new_n247_), .O(new_n266_));
  nor2   g115(.a(new_n266_), .b(x01), .O(z29));
  nand4  g116(.a(new_n259_), .b(x48), .c(new_n231_), .d(new_n247_), .O(new_n268_));
  aoi21  g117(.a(new_n268_), .b(x79), .c(x01), .O(z30));
  nand4  g118(.a(new_n255_), .b(x49), .c(new_n231_), .d(new_n247_), .O(new_n270_));
  nor2   g119(.a(new_n270_), .b(x01), .O(z31));
  nand4  g120(.a(new_n255_), .b(x50), .c(new_n231_), .d(new_n247_), .O(new_n272_));
  ...
  aoi21  g151(.a(new_n295_), .b(new_n290_), .c(new_n162_), .O(new_n303_));
  nand4  g152(.a(new_n303_), .b(x77), .c(x55), .d(new_n247_), .O(new_n304_));
  ...
  nand4  g156(.a(new_n296_), .b(x78), .c(x77), .d(x57), .O(new_n308_));
  ...
  nand4  g162(.a(new_n303_), .b(x77), .c(x60), .d(new_n247_), .O(new_n314_));
  ...
  nand4  g166(.a(new_n296_), .b(x78), .c(x77), .d(x62), .O(new_n318_));
  ...
  nand4  g170(.a(new_n296_), .b(x78), .c(x77), .d(x64), .O(new_n322_));
  nor3   g171(.a(new_n322_), .b(x04), .c(x01), .O(z46));
  or2    g172(.a(x75), .b(x67), .O(new_n324_));
  nand4  g173(.a(new_n324_), .b(new_n227_), .c(x79), .d(new_n162_), .O(new_n325_));
  nor3   g174(.a(new_n325_), .b(new_n161_), .c(x01), .O(z47));
  inv1   g175(.a(x68), .O(new_n327_));
  nand4  g176(.a(new_n227_), .b(x79), .c(new_n162_), .d(x77), .O(new_n328_));
  nor3   g177(.a(new_n328_), .b(new_n327_), .c(x01), .O(z48));
  nand3  g178(.a(new_n227_), .b(new_n162_), .c(x77), .O(new_n330_));
  inv1   g179(.a(new_n330_), .O(new_n331_));
  nand2  g180(.a(new_n331_), .b(x69), .O(new_n332_));
  aoi21  g181(.a(new_n332_), .b(x79), .c(x01), .O(z49));
  nand2  g182(.a(new_n331_), .b(x70), .O(new_n334_));
  aoi21  g183(.a(new_n334_), .b(x79), .c(x01), .O(z50));
  inv1   g184(.a(x71), .O(new_n336_));
  nor3   g185(.a(new_n328_), .b(new_n336_), .c(x01), .O(z51));
  nand2  g186(.a(new_n331_), .b(x72), .O(new_n338_));
  aoi21  g187(.a(new_n338_), .b(x79), .c(x01), .O(z52));
  inv1   g188(.a(x73), .O(new_n340_));
  nor3   g189(.a(new_n328_), .b(new_n340_), .c(x01), .O(z53));
  inv1   g190(.a(x80), .O(new_n342_));
  nand4  g191(.a(new_n342_), .b(x78), .c(x77), .d(new_n247_), .O(new_n343_));
  inv1   g192(.a(new_n343_), .O(new_n344_));
  nor2   g193(.a(x82), .b(x81), .O(new_n345_));
  nand4  g194(.a(new_n345_), .b(new_n344_), .c(x84), .d(x83), .O(new_n346_));
  aoi21  g195(.a(new_n346_), .b(x79), .c(x01), .O(z55));
  xor2a  g196(.a(x84), .b(x81), .O(new_n348_));
  oai21  g197(.a(new_n348_), .b(x76), .c(new_n160_), .O(new_n349_));
  nand4  g198(.a(new_n349_), .b(new_n164_), .c(new_n225_), .d(x00), .O(z56));
  inv1   g199(.a(x02), .O(new_n351_));
  nand3  g200(.a(x03), .b(new_n351_), .c(x00), .O(new_n352_));
  aoi21  g201(.a(new_n352_), .b(x79), .c(x01), .O(z57));
  nand4  g202(.a(x80), .b(new_n232_), .c(x43), .d(new_n231_), .O(new_n354_));
  oai22  g203(.a(new_n354_), .b(new_n236_), .c(new_n231_), .d(x40), .O(new_n355_));
  nand4  g204(.a(new_n355_), .b(x79), .c(x78), .d(x77), .O(new_n356_));
  nor3   g205(.a(new_n356_), .b(new_n247_), .c(x01), .O(z58));
  oai21  g206(.a(new_n236_), .b(new_n233_), .c(x79), .O(new_n358_));
  oai21  g207(.a(new_n358_), .b(x42), .c(new_n152_), .O(new_n359_));
  nand4  g208(.a(new_n359_), .b(x78), .c(x77), .d(x04), .O(new_n360_));
  aoi21  g209(.a(new_n360_), .b(x79), .c(x01), .O(z59));
  or2    g210(.a(new_n168_), .b(new_n166_), .O(new_n362_));
  nand2  g211(.a(new_n362_), .b(new_n348_), .O(new_n363_));
  nand2  g212(.a(new_n363_), .b(new_n239_), .O(new_n364_));
  nand3  g213(.a(new_n364_), .b(x79), .c(new_n225_), .O(new_n365_));
  inv1   g214(.a(new_n365_), .O(z60));
  nand2  g215(.a(new_n362_), .b(new_n227_), .O(new_n367_));
  nand3  g216(.a(x78), .b(x77), .c(new_n247_), .O(new_n368_));
  nand2  g217(.a(new_n368_), .b(new_n367_), .O(new_n369_));
  nand2  g218(.a(new_n369_), .b(x80), .O(new_n370_));
  aoi21  g219(.a(new_n370_), .b(x79), .c(x01), .O(z61));
  nand2  g220(.a(new_n362_), .b(x84), .O(new_n372_));
  nand3  g221(.a(x84), .b(new_n235_), .c(x82), .O(new_n373_));
  oai21  g222(.a(new_n373_), .b(new_n233_), .c(new_n231_), .O(new_n374_));
  nand2  g223(.a(new_n374_), .b(x04), .O(new_n375_));
  nand3  g224(.a(new_n375_), .b(x78), .c(x77), .O(new_n376_));
  nand2  g225(.a(new_n376_), .b(new_n372_), .O(new_n377_));
  nand2  g226(.a(new_n377_), .b(x81), .O(new_n378_));
  nand3  g227(.a(new_n250_), .b(x78), .c(x77), .O(new_n379_));
  nor3   g228(.a(new_n379_), .b(x42), .c(new_n247_), .O(new_n380_));
  nor2   g229(.a(new_n380_), .b(new_n163_), .O(new_n381_));
  aoi21  g230(.a(new_n381_), .b(new_n378_), .c(x01), .O(z62));
  nand4  g231(.a(new_n369_), .b(x82), .c(x79), .d(new_n225_), .O(new_n383_));
  inv1   g232(.a(new_n383_), .O(z63));
  nand4  g233(.a(new_n369_), .b(x83), .c(x79), .d(new_n225_), .O(new_n385_));
  inv1   g234(.a(new_n385_), .O(z64));
  nor2   g235(.a(new_n162_), .b(x04), .O(new_n387_));
  nor2   g236(.a(new_n250_), .b(x78), .O(new_n388_));
  oai21  g237(.a(new_n388_), .b(new_n387_), .c(x77), .O(new_n389_));
  nand3  g238(.a(x81), .b(x78), .c(new_n161_), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(new_n389_), .O(new_n391_));
  nand4  g240(.a(new_n391_), .b(x84), .c(x79), .d(new_n225_), .O(new_n392_));
