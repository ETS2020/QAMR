...
module FAU ( 
  ...
  nand3  g03(.a(new_n27_), .b(new_n26_), .c(x02), .O(new_n28_));
  ...
  nand4  g08(.a(new_n32_), .b(new_n27_), .c(x02), .d(x01), .O(new_n33_));
  ...
  nand2  g32(.a(new_n46_), .b(new_n56_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n27_), .c(x00), .O(new_n58_));
  ...
  oai22  g38(.a(new_n62_), .b(x00), .c(new_n61_), .d(new_n56_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n44_), .O(z3));
  nand3  g40(.a(x09), .b(x08), .c(x00), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n56_), .O(new_n66_));
  nand2  g42(.a(new_n61_), .b(x07), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n44_), .O(z4));
  nor2   g44(.a(x07), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n62_), .d(new_n27_), .O(z5));
  nand2  g46(.a(x08), .b(x00), .O(new_n71_));
  nand2  g47(.a(x09), .b(new_n36_), .O(new_n72_));
  nand2  g48(.a(new_n48_), .b(x03), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n25_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n71_), .c(new_n40_), .O(new_n75_));
  aoi21  g51(.a(x14), .b(x01), .c(x00), .O(new_n76_));
  nor2   g52(.a(x08), .b(new_n35_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n76_), .c(x02), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n75_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n27_), .c(new_n56_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(x03), .b(new_n40_), .c(new_n25_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n46_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n40_), .d(new_n25_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n27_), .d(new_n56_), .O(z7));
  nand4  g61(.a(new_n62_), .b(x03), .c(new_n40_), .d(new_n25_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n48_), .b(new_n35_), .c(x10), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n56_), .O(z8));
endmodule
