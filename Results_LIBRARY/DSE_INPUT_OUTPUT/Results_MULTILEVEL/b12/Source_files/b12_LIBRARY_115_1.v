...
module FAU ( 
  ...
  nand2  g09(.a(x08), .b(new_n33_), .O(new_n34_));
  ...
  nand3  g21(.a(x07), .b(new_n37_), .c(new_n45_), .O(new_n46_));
  nand2  g22(.a(new_n46_), .b(new_n25_), .O(new_n47_));
  nand2  g23(.a(new_n47_), .b(new_n36_), .O(new_n48_));
  nand2  g24(.a(x10), .b(new_n37_), .O(new_n49_));
  ...
  nand2  g32(.a(new_n53_), .b(new_n33_), .O(new_n57_));
  ...
  nor2   g37(.a(x08), .b(x00), .O(new_n62_));
  inv1   g38(.a(x13), .O(new_n63_));
  nor2   g39(.a(new_n63_), .b(x12), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n62_), .c(new_n50_), .d(new_n33_), .O(z5));
  nand2  g41(.a(x14), .b(x02), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(x00), .c(x01), .O(new_n67_));
  xor2a  g43(.a(x09), .b(x03), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x02), .c(new_n45_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n50_), .c(new_n53_), .d(new_n33_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(z6));
  nor2   g48(.a(x10), .b(x09), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n53_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n33_), .O(z7));
  inv1   g52(.a(x12), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n78_));
  oai21  g54(.a(x09), .b(x00), .c(new_n50_), .O(new_n79_));
  aoi21  g55(.a(new_n78_), .b(x09), .c(new_n79_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x08), .c(new_n33_), .O(z8));
endmodule
