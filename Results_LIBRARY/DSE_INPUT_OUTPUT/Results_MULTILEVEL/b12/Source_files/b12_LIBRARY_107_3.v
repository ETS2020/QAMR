...
module FAU ( 
  ...
  oai21  g10(.a(new_n30_), .b(x00), .c(new_n34_), .O(z0));
  ...
  nand3  g22(.a(x07), .b(new_n37_), .c(new_n46_), .O(new_n47_));
  aoi21  g23(.a(new_n47_), .b(new_n25_), .c(new_n33_), .O(new_n48_));
  inv1   g24(.a(x07), .O(new_n49_));
  nand4  g25(.a(new_n32_), .b(x09), .c(new_n49_), .d(new_n46_), .O(new_n50_));
  inv1   g26(.a(new_n50_), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n48_), .c(new_n36_), .O(new_n52_));
  nand2  g28(.a(new_n32_), .b(x09), .O(new_n53_));
  nand2  g29(.a(x10), .b(new_n37_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n53_), .c(x01), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(x02), .c(new_n31_), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(x07), .c(new_n52_), .O(z2));
  nand2  g33(.a(x11), .b(x07), .O(new_n58_));
  nand2  g34(.a(x12), .b(new_n36_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n58_), .c(new_n34_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(z3));
  oai21  g37(.a(x10), .b(x09), .c(x08), .O(new_n62_));
  nand2  g38(.a(x10), .b(new_n31_), .O(new_n63_));
  oai21  g39(.a(x10), .b(x00), .c(new_n63_), .O(new_n64_));
  aoi21  g40(.a(new_n62_), .b(x00), .c(new_n64_), .O(new_n65_));
  inv1   g41(.a(x11), .O(new_n66_));
  nand3  g42(.a(new_n34_), .b(new_n66_), .c(x07), .O(new_n67_));
  ...
  nand3  g48(.a(new_n72_), .b(new_n32_), .c(new_n36_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n63_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n49_), .O(new_n75_));
  nand2  g51(.a(new_n34_), .b(x07), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n70_), .O(z5));
  nand2  g53(.a(x08), .b(x00), .O(new_n78_));
  nand2  g54(.a(x09), .b(new_n37_), .O(new_n79_));
  inv1   g55(.a(x09), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x03), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n79_), .c(new_n25_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n78_), .c(new_n46_), .O(new_n83_));
  aoi21  g59(.a(x14), .b(x02), .c(x00), .O(new_n84_));
  nor2   g60(.a(x08), .b(new_n36_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(x01), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n83_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n32_), .c(new_n49_), .O(new_n88_));
  inv1   g64(.a(new_n88_), .O(z6));
  nand3  g65(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n31_), .O(new_n91_));
  nand4  g67(.a(x09), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n32_), .d(new_n49_), .O(z7));
  nand4  g69(.a(new_n71_), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  aoi21  g71(.a(new_n80_), .b(new_n36_), .c(x10), .O(new_n96_));
  nand3  g72(.a(new_n96_), .b(new_n95_), .c(new_n49_), .O(z8));
endmodule
