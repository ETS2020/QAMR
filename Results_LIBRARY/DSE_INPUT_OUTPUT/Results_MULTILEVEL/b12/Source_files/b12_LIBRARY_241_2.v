...
module FAU ( 
  ...
  nand3  g29(.a(x13), .b(x10), .c(new_n35_), .O(new_n54_));
  ...
  aoi22  g43(.a(new_n67_), .b(new_n65_), .c(new_n31_), .d(x10), .O(z4));
  ...
  nand2  g59(.a(x13), .b(x10), .O(new_n84_));
  nand3  g60(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n85_));
  ...
  nand4  g65(.a(new_n69_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  aoi21  g67(.a(new_n74_), .b(new_n34_), .c(x10), .O(new_n92_));
