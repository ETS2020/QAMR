...
module FAU ( 
  ...
  nand3  g55(.a(new_n79_), .b(new_n25_), .c(new_n58_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n82_));
  nor2   g58(.a(x02), .b(x01), .O(new_n83_));
  nor2   g59(.a(new_n72_), .b(new_n27_), .O(new_n84_));
  aoi22  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n53_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x07), .c(new_n25_), .O(z7));
  nand3  g62(.a(new_n83_), .b(new_n60_), .c(x03), .O(new_n87_));
