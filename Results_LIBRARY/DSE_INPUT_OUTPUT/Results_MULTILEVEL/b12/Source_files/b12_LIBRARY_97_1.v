...
module FAU ( 
  ...
  nand2  g37(.a(new_n54_), .b(x08), .O(new_n62_));
  nand2  g38(.a(new_n50_), .b(new_n25_), .O(new_n63_));
  ...
  nand2  g47(.a(x10), .b(x08), .O(new_n72_));
  inv1   g48(.a(x13), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x12), .c(new_n50_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n49_), .c(new_n38_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n71_), .c(new_n70_), .O(z5));
  nand2  g53(.a(x08), .b(x00), .O(new_n78_));
  nand2  g54(.a(x09), .b(new_n27_), .O(new_n79_));
  nand2  g55(.a(new_n54_), .b(x03), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n28_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n78_), .c(new_n33_), .O(new_n82_));
  ...
  oai21  g64(.a(new_n42_), .b(x01), .c(new_n25_), .O(new_n89_));
  nand4  g65(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n50_), .d(new_n49_), .O(z7));
  nand4  g67(.a(new_n59_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n92_));
  oai21  g68(.a(x09), .b(x00), .c(new_n49_), .O(new_n93_));
  aoi21  g69(.a(new_n92_), .b(x09), .c(new_n93_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x10), .c(new_n72_), .O(z8));
endmodule
