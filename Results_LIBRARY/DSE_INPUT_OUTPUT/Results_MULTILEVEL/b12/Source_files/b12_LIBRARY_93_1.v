...
module FAU ( 
  ...
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n68_), .d(new_n52_), .O(z5));
  ...
  nand3  g51(.a(new_n75_), .b(new_n71_), .c(new_n43_), .O(new_n76_));
  ...
  nand3  g56(.a(new_n80_), .b(new_n52_), .c(new_n46_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand2  g58(.a(x10), .b(x04), .O(new_n83_));
  nand3  g59(.a(x03), .b(new_n25_), .c(new_n43_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n46_), .O(new_n86_));
  aoi21  g62(.a(new_n84_), .b(new_n47_), .c(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x10), .c(new_n83_), .O(z7));
  nand4  g64(.a(new_n68_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n73_), .b(new_n34_), .c(x10), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n46_), .O(z8));
endmodule
