...
module FAU ( 
  ...
  aoi21  g40(.a(x13), .b(new_n64_), .c(x07), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x00), .c(new_n47_), .O(new_n66_));
  ...
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n47_), .d(new_n25_), .O(z7));
  nand4  g58(.a(new_n64_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n83_));
