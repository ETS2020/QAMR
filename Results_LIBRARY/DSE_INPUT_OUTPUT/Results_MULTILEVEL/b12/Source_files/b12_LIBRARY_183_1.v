...
module FAU ( 
  ...
  nand2  g01(.a(x08), .b(new_n25_), .O(new_n26_));
  ...
  oai21  g39(.a(x08), .b(new_n51_), .c(new_n25_), .O(new_n64_));
  ...
  nand3  g44(.a(x13), .b(new_n61_), .c(new_n52_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n26_), .c(new_n51_), .d(new_n38_), .O(z5));
  aoi21  g47(.a(x06), .b(new_n38_), .c(new_n55_), .O(new_n72_));
  ...
  nand3  g53(.a(new_n55_), .b(x01), .c(x00), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n52_), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(x07), .O(z6));
  oai21  g57(.a(x10), .b(x07), .c(new_n26_), .O(new_n82_));
  nand4  g58(.a(x06), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n83_));
  ...
  nand2  g62(.a(new_n86_), .b(new_n55_), .O(new_n87_));
  ...
  aoi21  g67(.a(new_n91_), .b(new_n38_), .c(x10), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n90_), .c(new_n26_), .d(new_n51_), .O(z8));
endmodule
