...
module FAU ( 
  ...
  oai21  g20(.a(new_n44_), .b(x01), .c(new_n25_), .O(new_n45_));
  nand2  g21(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  inv1   g22(.a(x01), .O(new_n47_));
  oai21  g23(.a(x09), .b(x07), .c(new_n34_), .O(new_n48_));
  inv1   g24(.a(x07), .O(new_n49_));
  nand2  g25(.a(x09), .b(new_n49_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n48_), .c(x00), .O(new_n51_));
  inv1   g27(.a(x08), .O(new_n52_));
  nand3  g28(.a(x09), .b(new_n52_), .c(new_n49_), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n51_), .c(new_n47_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n46_), .c(new_n31_), .O(z2));
  ...
  nand2  g38(.a(new_n57_), .b(x07), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n31_), .O(z4));
  nor2   g40(.a(x07), .b(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n58_), .d(new_n44_), .O(z5));
  ...
  oai21  g46(.a(new_n68_), .b(x10), .c(new_n70_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n67_), .c(new_n47_), .O(new_n72_));
  nand2  g48(.a(x14), .b(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n33_), .O(new_n74_));
  oai21  g50(.a(x08), .b(new_n33_), .c(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n44_), .c(x01), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n72_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n49_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n31_), .O(z6));
  nand3  g55(.a(x03), .b(new_n25_), .c(new_n47_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n52_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n44_), .d(new_n49_), .O(z7));
  oai21  g59(.a(x10), .b(x09), .c(new_n34_), .O(new_n84_));
  nor2   g60(.a(x12), .b(x02), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n47_), .c(new_n69_), .O(new_n86_));
  oai21  g62(.a(x09), .b(x00), .c(new_n49_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n86_), .c(new_n44_), .O(new_n88_));
