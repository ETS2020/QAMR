...
module FAU ( 
  ...
  oai21  g54(.a(new_n42_), .b(x01), .c(new_n51_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n60_), .d(new_n25_), .O(z7));
  nand4  g57(.a(new_n56_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n82_));
