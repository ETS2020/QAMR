...
module FAU ( 
  ...
  oai22  g38(.a(new_n62_), .b(new_n34_), .c(new_n59_), .d(x10), .O(new_n63_));
  nand3  g39(.a(new_n32_), .b(new_n58_), .c(x07), .O(new_n64_));
  ...
  nor2   g59(.a(x12), .b(x10), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n50_), .O(z7));
  nand2  g61(.a(new_n81_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n71_), .b(new_n34_), .c(x07), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(z8));
endmodule
