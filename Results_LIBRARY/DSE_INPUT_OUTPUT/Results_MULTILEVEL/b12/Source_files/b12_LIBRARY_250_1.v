...
module FAU ( 
  ...
  aoi22  g21(.a(new_n45_), .b(new_n25_), .c(x10), .d(new_n31_), .O(new_n46_));
  nand3  g22(.a(x10), .b(x08), .c(new_n35_), .O(new_n47_));
  ...
  oai21  g27(.a(new_n51_), .b(new_n46_), .c(new_n34_), .O(new_n52_));
  inv1   g28(.a(x09), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(x01), .c(new_n25_), .O(new_n54_));
  nand4  g30(.a(new_n54_), .b(new_n49_), .c(new_n31_), .d(new_n48_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n52_), .O(z2));
  nand2  g32(.a(x11), .b(x07), .O(new_n57_));
  nand2  g33(.a(x12), .b(new_n34_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n57_), .c(new_n32_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(z3));
  inv1   g36(.a(x11), .O(new_n61_));
  nand3  g37(.a(new_n32_), .b(new_n61_), .c(x07), .O(new_n62_));
  aoi21  g38(.a(x09), .b(x00), .c(new_n31_), .O(new_n63_));
  aoi21  g39(.a(new_n49_), .b(new_n31_), .c(new_n63_), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(x07), .c(new_n62_), .O(z4));
  inv1   g41(.a(x12), .O(new_n66_));
  nor2   g42(.a(x07), .b(x00), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n66_), .d(new_n49_), .O(z5));
  oai21  g44(.a(x10), .b(x00), .c(x08), .O(new_n69_));
  nand2  g45(.a(x09), .b(new_n35_), .O(new_n70_));
  nand2  g46(.a(new_n53_), .b(x03), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n25_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n69_), .c(new_n44_), .O(new_n73_));
  nand2  g49(.a(x14), .b(x02), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n49_), .c(new_n34_), .O(new_n75_));
  nand2  g51(.a(new_n31_), .b(x00), .O(new_n76_));
  ...
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n49_), .d(new_n48_), .O(z7));
  nand4  g61(.a(new_n66_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n53_), .b(new_n34_), .c(x10), .O(new_n88_));
