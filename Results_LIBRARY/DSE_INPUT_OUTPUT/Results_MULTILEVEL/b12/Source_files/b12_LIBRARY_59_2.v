...
module FAU ( 
  ...
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n51_), .d(new_n50_), .O(z7));
  nand4  g58(.a(new_n31_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n70_), .b(new_n34_), .c(x10), .O(new_n85_));
