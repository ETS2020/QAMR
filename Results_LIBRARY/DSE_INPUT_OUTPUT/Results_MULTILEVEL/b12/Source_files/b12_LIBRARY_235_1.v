...
module FAU ( 
  ...
  nor2   g52(.a(x14), .b(new_n33_), .O(new_n77_));
  aoi21  g53(.a(new_n76_), .b(new_n33_), .c(new_n77_), .O(new_n78_));
  nor2   g54(.a(x02), .b(x00), .O(new_n79_));
  nor2   g55(.a(x08), .b(new_n38_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n79_), .c(x01), .O(new_n81_));
  oai21  g57(.a(new_n78_), .b(new_n72_), .c(new_n81_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n52_), .c(new_n51_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n26_), .O(z6));
  oai21  g60(.a(new_n42_), .b(x01), .c(new_n55_), .O(new_n85_));
  nand4  g61(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n86_));
  aoi21  g62(.a(x14), .b(new_n25_), .c(x10), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n51_), .O(z7));
  nand4  g64(.a(new_n69_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n74_), .b(new_n38_), .c(x07), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n87_), .O(z8));
endmodule
