...
module FAU ( 
  ...
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n33_), .O(z4));
  nor2   g42(.a(x07), .b(x00), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n60_), .d(new_n31_), .O(z5));
  nand2  g44(.a(x08), .b(x00), .O(new_n69_));
  nand2  g45(.a(x09), .b(new_n37_), .O(new_n70_));
  inv1   g46(.a(x09), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x03), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(new_n25_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n69_), .c(new_n36_), .O(new_n74_));
  aoi21  g50(.a(x14), .b(x02), .c(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n35_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(x01), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(x13), .c(new_n31_), .d(new_n51_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  oai21  g56(.a(new_n42_), .b(x01), .c(new_n54_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n81_), .c(new_n51_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x13), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n31_), .O(z7));
  nand4  g61(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n71_), .b(new_n35_), .c(x07), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(x13), .d(new_n31_), .O(z8));
endmodule
