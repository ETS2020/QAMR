...
module FAU ( 
  ...
  nand3  g48(.a(new_n72_), .b(new_n61_), .c(new_n33_), .O(new_n73_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n56_), .c(new_n25_), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  oai21  g55(.a(new_n42_), .b(x01), .c(new_n51_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n56_), .d(new_n25_), .O(z7));
  nand4  g58(.a(new_n65_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n70_), .b(new_n38_), .c(x10), .O(new_n85_));
