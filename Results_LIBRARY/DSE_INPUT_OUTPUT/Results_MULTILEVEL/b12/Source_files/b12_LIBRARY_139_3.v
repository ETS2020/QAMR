...
module FAU ( 
  ...
  nand3  g21(.a(x10), .b(new_n36_), .c(new_n45_), .O(new_n46_));
  nand2  g22(.a(new_n46_), .b(new_n25_), .O(new_n47_));
  oai21  g23(.a(new_n44_), .b(new_n35_), .c(new_n47_), .O(new_n48_));
  ...
  nand3  g29(.a(new_n53_), .b(new_n48_), .c(new_n33_), .O(z2));
  ...
  nand3  g34(.a(new_n33_), .b(x11), .c(x07), .O(z4));
  oai21  g35(.a(x08), .b(new_n44_), .c(x00), .O(new_n60_));
  inv1   g36(.a(x13), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(x12), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(new_n60_), .c(new_n50_), .d(new_n44_), .O(z5));
  inv1   g39(.a(x08), .O(new_n64_));
  nand2  g40(.a(new_n50_), .b(new_n44_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n45_), .c(new_n64_), .O(new_n66_));
  ...
  oai21  g46(.a(new_n70_), .b(x02), .c(new_n45_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n50_), .c(new_n44_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n67_), .O(z6));
  nand3  g50(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x08), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x09), .O(new_n77_));
  nand3  g53(.a(new_n33_), .b(new_n50_), .c(new_n44_), .O(new_n78_));
  aoi21  g54(.a(new_n75_), .b(new_n64_), .c(new_n78_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n77_), .O(z7));
  inv1   g56(.a(x09), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(x08), .c(x00), .O(new_n82_));
  nand4  g58(.a(new_n55_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  aoi22  g60(.a(new_n65_), .b(new_n33_), .c(new_n81_), .d(new_n35_), .O(new_n85_));
