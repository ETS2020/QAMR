...
module FAU ( 
  ...
  nand3  g24(.a(x10), .b(new_n29_), .c(new_n35_), .O(new_n49_));
  ...
  aoi21  g36(.a(new_n60_), .b(new_n51_), .c(new_n27_), .O(z2));
  oai21  g37(.a(x12), .b(new_n53_), .c(x11), .O(new_n62_));
  oai21  g38(.a(new_n26_), .b(x00), .c(new_n25_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n62_), .O(z3));
  oai21  g40(.a(x12), .b(x07), .c(x11), .O(new_n65_));
  nand3  g41(.a(x09), .b(x08), .c(x00), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  oai21  g43(.a(x11), .b(new_n53_), .c(new_n67_), .O(z4));
  nor2   g44(.a(x07), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n26_), .d(new_n54_), .O(z5));
  ...
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n30_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n71_), .c(new_n35_), .O(new_n76_));
  aoi21  g52(.a(x14), .b(x02), .c(x00), .O(new_n77_));
  nor2   g53(.a(x08), .b(new_n40_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n77_), .c(x01), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n28_), .c(new_n54_), .d(new_n53_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand3  g58(.a(x03), .b(new_n30_), .c(new_n35_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n57_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n30_), .d(new_n35_), .O(new_n85_));
  nor2   g61(.a(new_n27_), .b(x10), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n53_), .O(z7));
  oai21  g63(.a(x11), .b(x09), .c(x12), .O(new_n88_));
  nand2  g64(.a(new_n83_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n73_), .b(new_n40_), .c(x10), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n53_), .O(z8));
endmodule
