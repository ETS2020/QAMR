...
module FAU ( 
  ...
  nor2   g07(.a(new_n31_), .b(x12), .O(new_n32_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n54_), .c(new_n36_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n49_), .c(new_n33_), .O(z2));
  ...
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n33_), .O(z4));
  nor3   g43(.a(x10), .b(x07), .c(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n31_), .c(x13), .d(new_n61_), .O(z5));
  nor2   g45(.a(new_n55_), .b(new_n35_), .O(new_n70_));
  nand2  g46(.a(x14), .b(x12), .O(new_n71_));
  nand2  g47(.a(new_n25_), .b(new_n36_), .O(new_n72_));
  xor2a  g48(.a(x09), .b(x03), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n74_));
  oai21  g50(.a(new_n73_), .b(x02), .c(new_n36_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(new_n70_), .O(new_n76_));
  nand2  g52(.a(new_n25_), .b(new_n35_), .O(new_n77_));
  nand2  g53(.a(new_n55_), .b(x00), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n77_), .c(new_n36_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n76_), .c(new_n52_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x07), .c(new_n33_), .O(z6));
  oai21  g57(.a(new_n42_), .b(x01), .c(new_n55_), .O(new_n82_));
  inv1   g58(.a(new_n72_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(x09), .c(x03), .O(new_n84_));
  nor2   g60(.a(new_n32_), .b(x10), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n82_), .d(new_n51_), .O(z7));
  oai21  g62(.a(new_n61_), .b(x09), .c(x14), .O(new_n87_));
  nand2  g63(.a(new_n61_), .b(x03), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n72_), .c(x09), .O(new_n89_));
  inv1   g65(.a(x09), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n35_), .c(x10), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n89_), .c(new_n87_), .d(new_n51_), .O(z8));
endmodule
