...
module FAU ( 
  ...
  oai22  g39(.a(new_n63_), .b(new_n25_), .c(new_n52_), .d(new_n27_), .O(new_n64_));
  nand3  g40(.a(new_n35_), .b(new_n59_), .c(x07), .O(new_n65_));
  oai21  g41(.a(new_n64_), .b(x07), .c(new_n65_), .O(z4));
  oai21  g42(.a(x07), .b(x00), .c(new_n35_), .O(new_n67_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n46_), .c(new_n25_), .O(new_n72_));
  ...
  nand3  g61(.a(x03), .b(new_n26_), .c(new_n43_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n47_), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n26_), .d(new_n43_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n52_), .d(new_n46_), .O(z7));
  nand4  g65(.a(new_n60_), .b(x03), .c(new_n26_), .d(new_n43_), .O(new_n90_));
