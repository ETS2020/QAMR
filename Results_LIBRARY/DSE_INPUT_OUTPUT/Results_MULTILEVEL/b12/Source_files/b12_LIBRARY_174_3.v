...
module FAU ( 
  ...
  inv1   g26(.a(x06), .O(new_n51_));
  nand3  g27(.a(x10), .b(new_n51_), .c(new_n34_), .O(new_n52_));
  inv1   g28(.a(x10), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(x09), .c(new_n46_), .O(new_n54_));
  ...
  oai22  g40(.a(new_n64_), .b(new_n33_), .c(new_n53_), .d(new_n51_), .O(new_n65_));
  inv1   g41(.a(x11), .O(new_n66_));
  nand3  g42(.a(new_n31_), .b(new_n66_), .c(x07), .O(new_n67_));
  oai21  g43(.a(new_n65_), .b(x07), .c(new_n67_), .O(z4));
  oai21  g44(.a(x07), .b(x00), .c(new_n31_), .O(new_n69_));
  inv1   g45(.a(x13), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x12), .c(new_n53_), .O(new_n71_));
  oai21  g47(.a(new_n53_), .b(x06), .c(new_n71_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n46_), .c(new_n33_), .O(new_n73_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n53_), .c(new_n46_), .O(new_n85_));
  ...
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n53_), .d(new_n46_), .O(z7));
  inv1   g66(.a(x12), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  aoi21  g69(.a(new_n77_), .b(new_n33_), .c(x10), .O(new_n94_));
