...
module FAU ( 
  ...
  nand3  g18(.a(new_n33_), .b(x10), .c(x04), .O(new_n43_));
  ...
  nand3  g24(.a(x10), .b(new_n28_), .c(new_n37_), .O(new_n49_));
  ...
  nand3  g29(.a(new_n29_), .b(x09), .c(new_n53_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n52_), .c(x00), .O(new_n55_));
  inv1   g31(.a(x08), .O(new_n56_));
  nand4  g32(.a(new_n29_), .b(x09), .c(new_n56_), .d(new_n53_), .O(new_n57_));
  ...
  aoi21  g59(.a(new_n83_), .b(new_n32_), .c(x10), .O(z6));
  nand3  g60(.a(x03), .b(new_n25_), .c(new_n37_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n56_), .O(new_n86_));
  nor2   g62(.a(x07), .b(x04), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n25_), .d(new_n37_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n29_), .O(z7));
  ...
  oai21  g68(.a(new_n92_), .b(x04), .c(new_n29_), .O(z8));
endmodule
