...
module FAU ( 
  ...
  nand2  g08(.a(new_n32_), .b(new_n31_), .O(z5));
  oai21  g09(.a(new_n30_), .b(x00), .c(z5), .O(z0));
  ...
  nand2  g19(.a(new_n43_), .b(z5), .O(z1));
  ...
  nand3  g27(.a(new_n51_), .b(x09), .c(new_n31_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n50_), .c(x00), .O(new_n53_));
  inv1   g29(.a(x08), .O(new_n54_));
  nand4  g30(.a(new_n51_), .b(x09), .c(new_n54_), .d(new_n31_), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n53_), .c(new_n46_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n49_), .c(z5), .O(z2));
  aoi22  g34(.a(x12), .b(new_n35_), .c(x11), .d(x07), .O(z3));
  ...
  aoi21  g49(.a(new_n73_), .b(x12), .c(x07), .O(z6));
  nand3  g50(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n75_));
  nand4  g51(.a(x09), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n51_), .O(new_n77_));
  aoi21  g53(.a(new_n75_), .b(new_n54_), .c(new_n77_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n32_), .c(new_n31_), .O(z7));
  nand3  g55(.a(new_n51_), .b(new_n65_), .c(x00), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x12), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n31_), .O(z8));
endmodule
