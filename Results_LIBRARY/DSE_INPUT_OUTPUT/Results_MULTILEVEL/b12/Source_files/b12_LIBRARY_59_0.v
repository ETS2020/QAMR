...
module FAU ( 
  ...
  oai21  g53(.a(new_n42_), .b(x01), .c(new_n54_), .O(new_n79_));
  nand4  g54(.a(x09), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n80_));
  nor2   g55(.a(new_n32_), .b(x10), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(new_n51_), .O(z7));
  nand4  g57(.a(new_n81_), .b(new_n69_), .c(new_n51_), .d(x00), .O(z8));
  one    g58(.O(z5));
endmodule
