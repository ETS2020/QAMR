...
module FAU ( 
  ...
  nand3  g24(.a(x12), .b(new_n48_), .c(x09), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n46_), .O(new_n51_));
  inv1   g27(.a(x12), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(x10), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(x09), .c(new_n38_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n51_), .c(x07), .O(new_n55_));
  aoi21  g31(.a(x12), .b(x07), .c(x10), .O(new_n56_));
  nor3   g32(.a(new_n56_), .b(x03), .c(x00), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n55_), .c(new_n33_), .O(new_n58_));
  ...
  oai22  g39(.a(new_n52_), .b(x00), .c(new_n63_), .d(new_n62_), .O(new_n64_));
  ...
  aoi21  g44(.a(new_n68_), .b(new_n67_), .c(new_n25_), .O(z4));
  nand2  g45(.a(x08), .b(x00), .O(new_n71_));
  nand2  g46(.a(x09), .b(new_n27_), .O(new_n72_));
  inv1   g47(.a(x09), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(x03), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n72_), .c(new_n28_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n71_), .c(new_n33_), .O(new_n76_));
  aoi21  g51(.a(x14), .b(x02), .c(x00), .O(new_n77_));
  nor2   g52(.a(x08), .b(new_n38_), .O(new_n78_));
  oai21  g53(.a(new_n78_), .b(new_n77_), .c(x01), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n62_), .O(new_n81_));
  aoi21  g56(.a(new_n81_), .b(x12), .c(x10), .O(z6));
  nand3  g57(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n46_), .O(new_n84_));
  nand4  g59(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n85_));
  nand4  g60(.a(new_n85_), .b(new_n84_), .c(new_n53_), .d(new_n62_), .O(z7));
  nand3  g61(.a(new_n73_), .b(new_n62_), .c(x00), .O(new_n87_));
  nand2  g62(.a(new_n87_), .b(x12), .O(new_n88_));
  nand2  g63(.a(new_n88_), .b(new_n48_), .O(z8));
  one    g64(.O(z5));
endmodule
