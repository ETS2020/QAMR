...
module FAU ( 
  ...
  nand2  g06(.a(x10), .b(x09), .O(new_n31_));
  ...
  oai21  g30(.a(new_n54_), .b(new_n51_), .c(new_n34_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n47_), .c(new_n31_), .O(z2));
  ...
  oai21  g36(.a(x10), .b(x08), .c(x09), .O(new_n61_));
  ...
  nand2  g48(.a(x13), .b(new_n72_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n33_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n63_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n49_), .O(new_n76_));
  nand2  g52(.a(new_n31_), .b(x07), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n70_), .O(z5));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  nand2  g55(.a(x09), .b(new_n35_), .O(new_n80_));
  nand2  g56(.a(new_n62_), .b(x03), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n25_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n79_), .c(new_n34_), .O(new_n83_));
  aoi21  g59(.a(x14), .b(x02), .c(x00), .O(new_n84_));
  nor2   g60(.a(x08), .b(new_n33_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(x01), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n83_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n71_), .c(new_n49_), .O(new_n88_));
  inv1   g64(.a(new_n88_), .O(z6));
  oai21  g65(.a(new_n40_), .b(x01), .c(new_n52_), .O(new_n90_));
  nand4  g66(.a(x09), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n90_), .c(new_n71_), .d(new_n49_), .O(z7));
  nand4  g68(.a(new_n72_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n62_), .b(new_n33_), .c(x10), .O(new_n95_));
