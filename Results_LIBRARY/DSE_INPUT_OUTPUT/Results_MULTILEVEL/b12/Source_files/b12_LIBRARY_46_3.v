...
module FAU ( 
  ...
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(x13), .d(new_n60_), .O(z5));
  oai21  g45(.a(new_n67_), .b(new_n27_), .c(x01), .O(new_n70_));
  nand2  g46(.a(x14), .b(x01), .O(new_n71_));
  xor2a  g47(.a(x09), .b(x03), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(x02), .c(new_n71_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n70_), .c(x00), .O(new_n74_));
  oai21  g50(.a(new_n67_), .b(x00), .c(x01), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n73_), .c(x08), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n74_), .c(new_n51_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(x07), .c(new_n25_), .O(z6));
  inv1   g54(.a(new_n25_), .O(new_n79_));
  oai21  g55(.a(new_n41_), .b(x01), .c(new_n54_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n51_), .c(new_n50_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n80_), .c(new_n79_), .O(z7));
  ...
  aoi21  g64(.a(new_n88_), .b(new_n86_), .c(new_n79_), .O(z8));
endmodule
