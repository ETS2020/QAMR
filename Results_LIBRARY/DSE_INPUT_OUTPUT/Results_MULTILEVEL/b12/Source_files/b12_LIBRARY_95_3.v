...
module FAU ( 
  ...
  nand2  g35(.a(new_n51_), .b(new_n46_), .O(new_n60_));
  aoi22  g36(.a(new_n60_), .b(x11), .c(x12), .d(new_n33_), .O(z3));
  oai21  g37(.a(new_n53_), .b(x10), .c(x07), .O(new_n62_));
  ...
  nand2  g41(.a(new_n53_), .b(x10), .O(new_n66_));
  ...
  nand2  g62(.a(new_n86_), .b(new_n66_), .O(z7));
  nand4  g63(.a(new_n67_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n46_), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x10), .c(new_n66_), .O(z8));
endmodule
