...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n49_, new_n50_, new_n53_, new_n55_, new_n56_;
  ...
  nand3  g20(.a(new_n44_), .b(z5), .c(new_n39_), .O(new_n45_));
  ...
  inv1   g27(.a(z5), .O(z6));
  aoi22  g28(.a(x12), .b(new_n39_), .c(x11), .d(x07), .O(new_n53_));
  or2    g29(.a(new_n53_), .b(z6), .O(z3));
  ...
  nand2  g33(.a(new_n26_), .b(new_n25_), .O(z7));
  nand2  g34(.a(new_n26_), .b(new_n25_), .O(z8));
endmodule
