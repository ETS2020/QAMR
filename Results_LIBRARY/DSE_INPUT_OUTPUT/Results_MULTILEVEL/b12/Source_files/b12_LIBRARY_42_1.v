...
module FAU ( 
  ...
  aoi21  g38(.a(x10), .b(new_n25_), .c(new_n57_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n49_), .c(new_n62_), .O(z4));
  inv1   g40(.a(x13), .O(new_n65_));
  nor2   g41(.a(new_n65_), .b(x12), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n50_), .c(new_n49_), .d(new_n38_), .O(z5));
  ...
  aoi21  g58(.a(new_n80_), .b(new_n25_), .c(new_n82_), .O(new_n83_));
  nand2  g59(.a(x10), .b(x08), .O(new_n84_));
