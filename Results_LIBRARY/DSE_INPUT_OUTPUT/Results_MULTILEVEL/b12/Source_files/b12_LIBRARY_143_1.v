...
module FAU ( 
  ...
  nand3  g37(.a(new_n61_), .b(new_n56_), .c(new_n33_), .O(new_n62_));
  ...
  nor2   g56(.a(new_n69_), .b(new_n37_), .O(new_n81_));
  aoi22  g57(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(new_n51_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x10), .c(new_n33_), .O(z7));
  nand3  g59(.a(new_n80_), .b(new_n64_), .c(x03), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n69_), .b(new_n36_), .c(x10), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n33_), .O(z8));
endmodule
