...
module FAU ( 
  ...
  oai21  g36(.a(x07), .b(new_n34_), .c(x10), .O(new_n61_));
  inv1   g37(.a(x12), .O(new_n62_));
  nand3  g38(.a(x13), .b(new_n62_), .c(new_n34_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n44_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n61_), .O(z5));
