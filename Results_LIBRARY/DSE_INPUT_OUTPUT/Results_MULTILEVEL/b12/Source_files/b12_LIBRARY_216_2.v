...
module FAU ( 
  ...
  oai22  g41(.a(new_n65_), .b(new_n25_), .c(x10), .d(new_n29_), .O(new_n66_));
  ...
  nand4  g46(.a(x13), .b(new_n70_), .c(new_n52_), .d(new_n25_), .O(new_n71_));
  ...
  nand3  g54(.a(new_n78_), .b(new_n74_), .c(new_n52_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n29_), .c(x10), .O(z6));
  oai21  g56(.a(new_n26_), .b(x02), .c(new_n56_), .O(new_n81_));
  nor2   g57(.a(x07), .b(x01), .O(new_n82_));
  nand3  g58(.a(x09), .b(x03), .c(new_n27_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n36_), .O(z7));
  nand3  g60(.a(new_n70_), .b(x03), .c(new_n27_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n76_), .b(new_n25_), .c(x10), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n82_), .O(z8));
endmodule
