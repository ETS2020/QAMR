...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n55_, new_n57_, new_n58_, new_n59_, new_n62_, new_n63_, new_n65_,
  ...
  nand4  g37(.a(x13), .b(new_n57_), .c(new_n50_), .d(new_n36_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n53_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n33_), .O(z5));
  and2   g40(.a(x14), .b(x02), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n36_), .c(new_n45_), .O(new_n66_));
  xnor2a g42(.a(x09), .b(x03), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n25_), .c(x01), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n66_), .c(new_n50_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n53_), .c(x07), .O(z6));
  nor3   g46(.a(x10), .b(x09), .c(x08), .O(new_n71_));
  nor2   g47(.a(x02), .b(x01), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n71_), .c(new_n33_), .d(x03), .O(z7));
  nand3  g49(.a(new_n72_), .b(new_n57_), .c(x03), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x09), .O(new_n75_));
  inv1   g51(.a(x09), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n36_), .c(x10), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(new_n75_), .c(new_n53_), .d(new_n33_), .O(z8));
endmodule
