...
module FAU ( 
  ...
  inv1   g38(.a(new_n25_), .O(new_n63_));
  ...
  aoi21  g43(.a(new_n67_), .b(new_n65_), .c(new_n63_), .O(z4));
  inv1   g44(.a(x12), .O(new_n69_));
  nor2   g45(.a(x07), .b(x00), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(x13), .c(new_n69_), .d(new_n51_), .O(z5));
  ...
  nand2  g61(.a(new_n85_), .b(new_n50_), .O(new_n86_));
  aoi21  g62(.a(new_n84_), .b(new_n54_), .c(new_n86_), .O(new_n87_));
  inv1   g63(.a(x14), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x10), .O(new_n89_));
  oai21  g65(.a(new_n87_), .b(x10), .c(new_n89_), .O(z7));
  nand4  g66(.a(new_n69_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n91_));
