...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n73_, new_n74_, new_n75_, new_n77_, new_n78_;
  ...
  aoi21  g53(.a(new_n77_), .b(new_n69_), .c(x07), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x09), .c(new_n25_), .O(z7));
  nand4  g55(.a(new_n25_), .b(new_n58_), .c(new_n62_), .d(x00), .O(z8));
endmodule
