...
module FAU ( 
  ...
  aoi22  g44(.a(new_n68_), .b(new_n66_), .c(x10), .d(new_n28_), .O(z4));
  inv1   g45(.a(x12), .O(new_n70_));
  nor2   g46(.a(x07), .b(x00), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(x13), .c(new_n70_), .d(new_n53_), .O(z5));
  ...
  nand3  g52(.a(new_n76_), .b(new_n74_), .c(new_n41_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n47_), .O(new_n78_));
  aoi21  g54(.a(x14), .b(x02), .c(x00), .O(new_n79_));
  nor2   g55(.a(x08), .b(new_n36_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n79_), .c(x01), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n53_), .c(new_n52_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n29_), .O(z6));
  nand3  g60(.a(x03), .b(new_n41_), .c(new_n47_), .O(new_n85_));
  nand4  g61(.a(x09), .b(x03), .c(new_n41_), .d(new_n47_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n52_), .O(new_n87_));
  aoi21  g63(.a(new_n85_), .b(new_n56_), .c(new_n87_), .O(new_n88_));
  nand2  g64(.a(x10), .b(x05), .O(new_n89_));
  oai21  g65(.a(new_n88_), .b(x10), .c(new_n89_), .O(z7));
  nand4  g66(.a(new_n70_), .b(x03), .c(new_n41_), .d(new_n47_), .O(new_n91_));
  oai21  g67(.a(x09), .b(x00), .c(new_n52_), .O(new_n92_));
  aoi21  g68(.a(new_n91_), .b(x09), .c(new_n92_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x10), .c(new_n89_), .O(z8));
endmodule
