...
module FAU ( 
  ...
  aoi22  g43(.a(new_n67_), .b(new_n65_), .c(new_n25_), .d(x10), .O(z4));
  ...
  nand3  g57(.a(new_n81_), .b(new_n52_), .c(new_n51_), .O(new_n82_));
  ...
  nand2  g63(.a(x14), .b(x10), .O(new_n88_));
  oai21  g64(.a(new_n87_), .b(x10), .c(new_n88_), .O(z7));
  nand4  g65(.a(new_n69_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n51_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x10), .c(new_n88_), .O(z8));
endmodule
