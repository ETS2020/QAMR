...
module FAU ( 
  ...
  nand3  g22(.a(new_n46_), .b(new_n32_), .c(x02), .O(new_n47_));
  ...
  oai21  g31(.a(new_n55_), .b(new_n52_), .c(new_n37_), .O(new_n56_));
  ...
  oai22  g39(.a(new_n63_), .b(new_n62_), .c(new_n37_), .d(x01), .O(new_n64_));
  nand3  g40(.a(new_n32_), .b(new_n58_), .c(x07), .O(new_n65_));
  ...
  nand3  g46(.a(new_n70_), .b(new_n50_), .c(new_n62_), .O(new_n71_));
  ...
  nor2   g55(.a(x08), .b(new_n62_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n79_), .c(x01), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n37_), .c(new_n50_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  nand3  g60(.a(x03), .b(new_n25_), .c(new_n31_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n53_), .O(new_n86_));
  nand4  g62(.a(x09), .b(x03), .c(new_n25_), .d(new_n31_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n37_), .d(new_n50_), .O(z7));
  oai21  g64(.a(x10), .b(x09), .c(x01), .O(new_n89_));
  nand3  g65(.a(new_n59_), .b(x03), .c(new_n25_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n50_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x10), .c(new_n89_), .O(z8));
endmodule
