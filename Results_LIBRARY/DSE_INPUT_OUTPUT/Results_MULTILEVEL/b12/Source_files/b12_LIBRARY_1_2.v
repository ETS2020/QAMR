...
module FAU ( 
  ...
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n31_), .d(new_n57_), .O(z7));
  nand4  g61(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n72_), .b(new_n34_), .c(x10), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n57_), .O(z8));
endmodule
