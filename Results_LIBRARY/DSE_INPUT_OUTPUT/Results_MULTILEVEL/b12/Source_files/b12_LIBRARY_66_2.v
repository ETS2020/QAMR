...
module FAU ( 
  ...
  oai22  g39(.a(new_n63_), .b(new_n34_), .c(x14), .d(new_n51_), .O(new_n64_));
  inv1   g40(.a(x11), .O(new_n65_));
  nand3  g41(.a(new_n32_), .b(new_n65_), .c(x07), .O(new_n66_));
  oai21  g42(.a(new_n64_), .b(x07), .c(new_n66_), .O(z4));
  oai21  g43(.a(x07), .b(x00), .c(new_n32_), .O(new_n68_));
  nand2  g44(.a(x14), .b(x10), .O(new_n69_));
  inv1   g45(.a(x13), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x12), .c(new_n51_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n50_), .c(new_n34_), .O(new_n73_));
  ...
  oai21  g62(.a(new_n41_), .b(x01), .c(new_n54_), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n50_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n51_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n69_), .O(z7));
  inv1   g67(.a(x12), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n77_), .b(new_n34_), .c(x10), .O(new_n95_));
