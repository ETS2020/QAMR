...
module FAU ( 
  ...
  nand4  g44(.a(x13), .b(new_n61_), .c(new_n51_), .d(new_n68_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n52_), .O(new_n70_));
  oai21  g46(.a(new_n52_), .b(new_n31_), .c(new_n70_), .O(z5));
  nand2  g47(.a(x08), .b(x00), .O(new_n72_));
  nand2  g48(.a(x09), .b(new_n46_), .O(new_n73_));
  ...
  nor2   g54(.a(x08), .b(new_n68_), .O(new_n79_));
  ...
  nand3  g59(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n55_), .O(new_n85_));
  nand4  g61(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n52_), .d(new_n51_), .O(z7));
  nand4  g63(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n74_), .b(new_n68_), .c(x10), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n89_), .c(new_n51_), .O(z8));
endmodule
