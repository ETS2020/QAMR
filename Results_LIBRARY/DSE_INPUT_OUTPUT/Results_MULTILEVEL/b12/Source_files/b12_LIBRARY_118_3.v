...
module FAU ( 
  ...
  oai21  g35(.a(new_n55_), .b(new_n57_), .c(new_n59_), .O(z4));
  inv1   g36(.a(x13), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(x12), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(new_n46_), .c(new_n57_), .d(new_n33_), .O(z5));
  ...
  nand3  g43(.a(new_n67_), .b(new_n44_), .c(new_n34_), .O(new_n68_));
  ...
  nand3  g48(.a(new_n72_), .b(new_n46_), .c(new_n57_), .O(new_n73_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n46_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n57_), .O(new_n79_));
  nand2  g55(.a(new_n46_), .b(x07), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n79_), .O(z7));
  inv1   g57(.a(x12), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n83_));
  oai21  g59(.a(x09), .b(x00), .c(new_n46_), .O(new_n84_));
  aoi21  g60(.a(new_n83_), .b(x09), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x07), .c(new_n80_), .O(z8));
endmodule
