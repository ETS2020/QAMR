...
module FAU ( 
  ...
  nand3  g38(.a(new_n43_), .b(x11), .c(x07), .O(z4));
  nand4  g39(.a(x13), .b(new_n59_), .c(new_n51_), .d(new_n50_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n34_), .O(new_n65_));
  oai21  g41(.a(x08), .b(new_n34_), .c(new_n65_), .O(z5));
  nand3  g42(.a(new_n51_), .b(new_n50_), .c(x01), .O(new_n67_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n51_), .c(new_n50_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n69_), .O(z6));
  nand3  g52(.a(x03), .b(new_n27_), .c(new_n25_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x08), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x09), .O(new_n79_));
  nand3  g55(.a(new_n43_), .b(new_n51_), .c(new_n50_), .O(new_n80_));
  aoi21  g56(.a(new_n77_), .b(new_n54_), .c(new_n80_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n79_), .O(z7));
  inv1   g58(.a(x09), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x00), .c(x08), .O(new_n84_));
  nand4  g60(.a(new_n59_), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n83_), .b(new_n34_), .c(x10), .O(new_n87_));
