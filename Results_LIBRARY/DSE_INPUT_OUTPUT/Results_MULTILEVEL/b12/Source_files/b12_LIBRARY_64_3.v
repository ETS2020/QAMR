...
module FAU ( 
  ...
  oai21  g56(.a(new_n40_), .b(x01), .c(new_n53_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n81_), .c(new_n49_), .O(new_n83_));
  ...
  nand4  g63(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n88_));
