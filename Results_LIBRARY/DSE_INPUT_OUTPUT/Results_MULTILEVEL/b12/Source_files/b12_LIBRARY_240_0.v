...
module FAU ( 
  ...
  nor2   g08(.a(new_n32_), .b(x02), .O(new_n33_));
  oai21  g09(.a(new_n33_), .b(new_n29_), .c(x01), .O(new_n34_));
  nand4  g10(.a(x10), .b(new_n27_), .c(x03), .d(x02), .O(new_n35_));
  aoi21  g11(.a(new_n35_), .b(new_n34_), .c(x00), .O(z0));
  nand3  g12(.a(new_n31_), .b(new_n25_), .c(x01), .O(new_n37_));
  nand3  g13(.a(x06), .b(x05), .c(x01), .O(new_n38_));
  nand3  g14(.a(new_n38_), .b(x10), .c(x02), .O(new_n39_));
  ...
  nand4  g21(.a(new_n45_), .b(new_n30_), .c(x09), .d(x04), .O(new_n46_));
  inv1   g22(.a(x03), .O(new_n47_));
  inv1   g23(.a(x08), .O(new_n48_));
  nand3  g24(.a(x10), .b(new_n48_), .c(new_n47_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n46_), .c(x07), .O(new_n50_));
  aoi21  g26(.a(x07), .b(x04), .c(x10), .O(new_n51_));
  nor3   g27(.a(new_n51_), .b(x03), .c(x00), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n50_), .c(new_n44_), .O(new_n53_));
  oai21  g29(.a(x08), .b(x07), .c(x00), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n31_), .c(x02), .O(new_n55_));
  ...
  nand3  g35(.a(new_n59_), .b(new_n57_), .c(new_n31_), .O(new_n60_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n31_), .O(z4));
  inv1   g43(.a(x12), .O(new_n68_));
  nand4  g44(.a(x13), .b(new_n68_), .c(new_n62_), .d(new_n58_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x04), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n30_), .O(z5));
  nand2  g47(.a(x09), .b(new_n47_), .O(new_n72_));
  inv1   g48(.a(x09), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x03), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n25_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n45_), .c(new_n44_), .O(new_n76_));
  aoi21  g52(.a(x14), .b(x02), .c(x00), .O(new_n77_));
  nor2   g53(.a(x08), .b(new_n58_), .O(new_n78_));
  ...
  aoi21  g57(.a(new_n81_), .b(x04), .c(x10), .O(z6));
  nand3  g58(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n62_), .O(new_n85_));
  aoi21  g61(.a(new_n83_), .b(new_n48_), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n27_), .c(new_n30_), .O(z7));
  nand4  g63(.a(new_n68_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n62_), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n27_), .c(new_n30_), .O(z8));
endmodule
