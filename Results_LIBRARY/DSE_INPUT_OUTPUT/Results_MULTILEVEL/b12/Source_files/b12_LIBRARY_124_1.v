...
module FAU ( 
  ...
  nor2   g07(.a(new_n31_), .b(x09), .O(new_n32_));
  ...
  oai21  g40(.a(new_n32_), .b(new_n59_), .c(x07), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(z4));
  inv1   g42(.a(x13), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(x12), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n31_), .c(new_n51_), .d(new_n35_), .O(z5));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  aoi21  g46(.a(x09), .b(new_n37_), .c(x02), .O(new_n71_));
  inv1   g47(.a(x09), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x03), .O(new_n73_));
  oai21  g49(.a(new_n71_), .b(x10), .c(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n70_), .c(new_n36_), .O(new_n75_));
  nand2  g51(.a(x14), .b(x02), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n35_), .O(new_n77_));
  oai21  g53(.a(x08), .b(new_n35_), .c(new_n77_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n31_), .c(x01), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n75_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n51_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n33_), .O(z6));
  oai21  g58(.a(new_n42_), .b(x01), .c(new_n54_), .O(new_n83_));
  nor2   g59(.a(x02), .b(x01), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(x09), .c(x03), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n83_), .c(new_n31_), .d(new_n51_), .O(z7));
  nand2  g62(.a(new_n33_), .b(x07), .O(new_n87_));
  nand4  g63(.a(new_n84_), .b(new_n60_), .c(new_n31_), .d(x03), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  nand3  g65(.a(new_n31_), .b(new_n72_), .c(new_n35_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n89_), .c(new_n87_), .O(z8));
endmodule
