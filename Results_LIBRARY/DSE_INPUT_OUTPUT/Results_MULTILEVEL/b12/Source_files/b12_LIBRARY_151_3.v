...
module FAU ( 
  ...
  oai21  g41(.a(x10), .b(new_n58_), .c(new_n65_), .O(z5));
  ...
  nand3  g51(.a(new_n75_), .b(new_n47_), .c(new_n58_), .O(new_n76_));
  ...
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n47_), .d(new_n58_), .O(z7));
  ...
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n58_), .O(z8));
endmodule
