...
module FAU ( 
  ...
  oai22  g40(.a(new_n64_), .b(new_n39_), .c(x13), .d(x10), .O(new_n65_));
  nand3  g41(.a(new_n27_), .b(new_n60_), .c(x07), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x07), .c(new_n66_), .O(z4));
  nor3   g43(.a(x12), .b(x07), .c(x00), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n26_), .c(new_n25_), .O(z5));
  ...
  aoi21  g56(.a(new_n80_), .b(x13), .c(x10), .O(z6));
  ...
  oai21  g61(.a(new_n85_), .b(new_n26_), .c(new_n25_), .O(z7));
  nand4  g62(.a(new_n61_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n72_), .b(new_n39_), .c(x07), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(x13), .d(new_n25_), .O(z8));
endmodule
