...
module FAU ( 
  ...
  oai21  g42(.a(x07), .b(new_n38_), .c(x10), .O(new_n67_));
  nand3  g43(.a(x13), .b(new_n60_), .c(new_n38_), .O(new_n68_));
  ...
  oai21  g54(.a(x08), .b(new_n38_), .c(new_n78_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(x01), .c(x07), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n76_), .c(x10), .O(z6));
  ...
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n25_), .d(new_n58_), .O(z7));
