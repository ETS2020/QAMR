...
module FAU ( 
  ...
  nand3  g22(.a(new_n46_), .b(x09), .c(new_n31_), .O(new_n47_));
  aoi21  g23(.a(new_n47_), .b(new_n45_), .c(x01), .O(new_n48_));
  oai21  g24(.a(new_n48_), .b(x02), .c(new_n35_), .O(new_n49_));
  ...
  oai21  g32(.a(x11), .b(new_n31_), .c(new_n56_), .O(z4));
  nand4  g33(.a(x13), .b(new_n51_), .c(new_n46_), .d(new_n35_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(x08), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n31_), .O(z5));
  ...
  nand4  g42(.a(new_n66_), .b(new_n46_), .c(x08), .d(new_n31_), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(x00), .O(z6));
  nand4  g44(.a(x09), .b(x03), .c(new_n25_), .d(new_n63_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n46_), .c(x08), .d(new_n31_), .O(z7));
  nand4  g46(.a(new_n51_), .b(x03), .c(new_n25_), .d(new_n63_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x09), .O(new_n72_));
  inv1   g48(.a(x09), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n35_), .c(x10), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n72_), .c(x08), .d(new_n31_), .O(z8));
endmodule
