...
module FAU ( 
  ...
  oai21  g64(.a(x10), .b(x07), .c(new_n56_), .O(new_n89_));
  nand3  g65(.a(new_n81_), .b(x08), .c(new_n55_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(z8));
endmodule
