...
module FAU ( 
  ...
  nand3  g49(.a(new_n73_), .b(new_n45_), .c(new_n31_), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(z6));
  nand3  g51(.a(x03), .b(new_n25_), .c(new_n64_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n50_), .O(new_n77_));
  nand4  g53(.a(x09), .b(x03), .c(new_n25_), .d(new_n64_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n45_), .d(new_n31_), .O(z7));
  nand4  g55(.a(new_n55_), .b(x03), .c(new_n25_), .d(new_n64_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x09), .O(new_n81_));
  aoi21  g57(.a(new_n51_), .b(new_n34_), .c(x10), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n81_), .c(new_n31_), .O(z8));
endmodule
