...
module FAU ( 
  ...
  aoi21  g37(.a(x12), .b(new_n35_), .c(new_n61_), .O(new_n62_));
  ...
  nand4  g46(.a(new_n70_), .b(x13), .c(new_n69_), .d(new_n30_), .O(z5));
  ...
  nand3  g57(.a(new_n81_), .b(new_n30_), .c(new_n52_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n25_), .O(z6));
  nand3  g59(.a(x03), .b(new_n26_), .c(new_n47_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n26_), .d(new_n47_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n52_), .O(new_n86_));
  aoi21  g62(.a(new_n84_), .b(new_n55_), .c(new_n86_), .O(new_n87_));
  nand2  g63(.a(x10), .b(new_n37_), .O(new_n88_));
  oai21  g64(.a(new_n87_), .b(x10), .c(new_n88_), .O(z7));
  nand4  g65(.a(new_n69_), .b(x03), .c(new_n26_), .d(new_n47_), .O(new_n90_));
