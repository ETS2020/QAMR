...
module FAU ( 
  ...
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n57_), .d(new_n47_), .O(z5));
  ...
  nand3  g45(.a(new_n69_), .b(new_n66_), .c(new_n33_), .O(new_n70_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n47_), .c(new_n25_), .O(new_n75_));
