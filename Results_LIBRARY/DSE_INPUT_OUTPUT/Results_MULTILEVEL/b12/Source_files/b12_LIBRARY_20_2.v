...
module FAU ( 
  ...
  nand3  g30(.a(x14), .b(x10), .c(new_n27_), .O(new_n55_));
  ...
  nand4  g46(.a(x13), .b(new_n70_), .c(new_n48_), .d(new_n38_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n53_), .O(new_n72_));
  oai21  g48(.a(new_n25_), .b(new_n53_), .c(new_n72_), .O(z5));
  ...
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n53_), .d(new_n48_), .O(z7));
  nand4  g67(.a(new_n70_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  aoi21  g69(.a(new_n79_), .b(new_n38_), .c(x10), .O(new_n94_));
