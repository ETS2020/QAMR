...
module FAU ( 
  ...
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n55_), .d(new_n59_), .O(z5));
  ...
  nand3  g45(.a(new_n69_), .b(new_n65_), .c(new_n46_), .O(new_n70_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n59_), .c(new_n31_), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(z6));
  nand3  g52(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n50_), .O(new_n78_));
  nand4  g54(.a(x09), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n78_), .c(new_n59_), .d(new_n31_), .O(z7));
  nand4  g56(.a(new_n55_), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x09), .O(new_n82_));
  aoi21  g58(.a(new_n67_), .b(new_n34_), .c(x10), .O(new_n83_));
