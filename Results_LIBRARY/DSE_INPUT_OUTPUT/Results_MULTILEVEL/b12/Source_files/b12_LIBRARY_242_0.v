...
module FAU ( 
  ...
  nor2   g06(.a(x12), .b(x10), .O(new_n31_));
  inv1   g07(.a(new_n31_), .O(z5));
  ...
  nand3  g23(.a(x12), .b(new_n47_), .c(x09), .O(new_n48_));
  ...
  aoi21  g30(.a(x12), .b(x07), .c(x10), .O(new_n55_));
  ...
  nand3  g34(.a(new_n58_), .b(z5), .c(x02), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n57_), .O(z2));
  inv1   g36(.a(x07), .O(new_n61_));
  inv1   g37(.a(x11), .O(new_n62_));
  oai22  g38(.a(new_n51_), .b(x00), .c(new_n62_), .d(new_n61_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(z5), .O(z3));
  nand3  g40(.a(x09), .b(x08), .c(x00), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n61_), .O(new_n66_));
  nand2  g42(.a(new_n62_), .b(x07), .O(new_n67_));
  ...
  nand4  g54(.a(new_n78_), .b(x12), .c(new_n47_), .d(new_n61_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand3  g56(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n45_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n52_), .d(new_n61_), .O(z7));
  nand3  g60(.a(new_n71_), .b(new_n61_), .c(x00), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x12), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n47_), .O(z8));
endmodule
