...
module FAU ( 
  ...
  nand2  g40(.a(new_n33_), .b(new_n38_), .O(new_n65_));
  nor2   g41(.a(x03), .b(x02), .O(new_n66_));
  inv1   g42(.a(x08), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x00), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n65_), .c(new_n66_), .O(new_n69_));
  nand2  g45(.a(x14), .b(x02), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n38_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n68_), .c(new_n33_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n69_), .c(new_n52_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n58_), .c(x10), .O(z6));
  nand3  g50(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n67_), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n25_), .c(new_n58_), .d(new_n52_), .O(z7));
  nand4  g53(.a(new_n25_), .b(new_n58_), .c(new_n52_), .d(x00), .O(z8));
endmodule
