...
module FAU ( 
  ...
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n25_), .O(z4));
  nand4  g42(.a(x13), .b(new_n60_), .c(new_n50_), .d(new_n37_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n51_), .O(new_n68_));
  nand2  g44(.a(new_n60_), .b(x10), .O(new_n69_));
  ...
  oai21  g62(.a(new_n86_), .b(x10), .c(new_n69_), .O(z7));
  nand4  g63(.a(new_n60_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n50_), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x10), .c(new_n69_), .O(z8));
endmodule
