...
module FAU ( 
  ...
  oai21  g38(.a(x08), .b(new_n50_), .c(x14), .O(new_n63_));
  ...
  nand3  g46(.a(x13), .b(new_n70_), .c(new_n51_), .O(new_n71_));
  nor3   g47(.a(new_n71_), .b(x07), .c(x00), .O(new_n72_));
  nor2   g48(.a(new_n72_), .b(new_n69_), .O(z5));
  nand2  g49(.a(new_n54_), .b(new_n32_), .O(new_n74_));
  inv1   g50(.a(x14), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n37_), .O(new_n76_));
  xnor2a g52(.a(x09), .b(x03), .O(new_n77_));
  aoi22  g53(.a(new_n77_), .b(new_n27_), .c(new_n76_), .d(new_n74_), .O(new_n78_));
  oai21  g54(.a(new_n27_), .b(x00), .c(new_n54_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n76_), .c(new_n32_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n78_), .c(new_n51_), .O(new_n81_));
  nor2   g57(.a(new_n81_), .b(x07), .O(z6));
  oai21  g58(.a(x10), .b(x07), .c(new_n25_), .O(new_n83_));
  nand4  g59(.a(new_n75_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n84_));
  ...
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n83_), .O(z7));
  ...
  nor3   g67(.a(new_n91_), .b(x10), .c(x07), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n90_), .c(new_n69_), .O(z8));
endmodule
