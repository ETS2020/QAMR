...
module FAU ( 
  ...
  nand2  g06(.a(x11), .b(x10), .O(new_n31_));
  ...
  oai22  g36(.a(new_n60_), .b(x00), .c(new_n53_), .d(new_n46_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n31_), .O(z3));
  nor2   g38(.a(x11), .b(new_n51_), .O(new_n63_));
  nor2   g39(.a(x10), .b(x07), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n63_), .c(new_n33_), .O(new_n65_));
  nand2  g41(.a(x09), .b(x08), .O(new_n66_));
  oai21  g42(.a(x10), .b(x07), .c(x11), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(x00), .O(new_n68_));
  nand2  g44(.a(new_n53_), .b(x07), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n65_), .O(z4));
  oai21  g46(.a(x07), .b(x00), .c(new_n31_), .O(new_n71_));
  aoi21  g47(.a(x13), .b(new_n60_), .c(x10), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n46_), .c(new_n63_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x00), .c(new_n71_), .O(z5));
  nand2  g50(.a(x08), .b(x00), .O(new_n75_));
  nand2  g51(.a(x09), .b(new_n34_), .O(new_n76_));
  inv1   g52(.a(x09), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x03), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n25_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n75_), .c(new_n43_), .O(new_n80_));
  aoi21  g56(.a(x14), .b(x02), .c(x00), .O(new_n81_));
  nor2   g57(.a(x08), .b(new_n33_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n81_), .c(x01), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n80_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n51_), .c(new_n46_), .O(new_n85_));
  inv1   g61(.a(new_n85_), .O(z6));
  nand3  g62(.a(x03), .b(new_n25_), .c(new_n43_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n47_), .O(new_n88_));
  nand4  g64(.a(x09), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n51_), .d(new_n46_), .O(z7));
  nand4  g66(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n77_), .b(new_n33_), .c(x10), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n46_), .O(z8));
endmodule
