...
module FAU ( 
  ...
  nand2  g06(.a(x08), .b(x07), .O(new_n31_));
  ...
  oai21  g39(.a(new_n58_), .b(x08), .c(x07), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n63_), .O(z4));
  nand4  g41(.a(x13), .b(new_n59_), .c(new_n50_), .d(new_n33_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n49_), .O(new_n67_));
  oai21  g43(.a(x08), .b(new_n49_), .c(new_n67_), .O(z5));
  ...
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n50_), .d(new_n49_), .O(z7));
  nand4  g60(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n85_));
