...
module FAU ( 
  ...
  nand3  g36(.a(new_n26_), .b(new_n57_), .c(x07), .O(new_n61_));
  aoi21  g37(.a(x09), .b(x00), .c(new_n25_), .O(new_n62_));
  aoi21  g38(.a(new_n50_), .b(new_n25_), .c(new_n62_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x07), .c(new_n61_), .O(z4));
  nor2   g40(.a(x07), .b(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n58_), .d(new_n50_), .O(z5));
  ...
  nand3  g52(.a(new_n76_), .b(new_n50_), .c(new_n49_), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(z6));
  nand3  g54(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n50_), .d(new_n49_), .O(z7));
  nand4  g58(.a(new_n58_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n83_));
  oai21  g59(.a(x09), .b(x00), .c(new_n49_), .O(new_n84_));
  aoi21  g60(.a(new_n83_), .b(x09), .c(new_n84_), .O(new_n85_));
  nand2  g61(.a(x10), .b(x08), .O(new_n86_));
  oai21  g62(.a(new_n85_), .b(x10), .c(new_n86_), .O(z8));
endmodule
