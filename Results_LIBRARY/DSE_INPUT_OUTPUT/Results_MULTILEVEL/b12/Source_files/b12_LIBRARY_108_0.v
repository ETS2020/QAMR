...
module FAU ( 
  ...
  nand2  g10(.a(new_n34_), .b(new_n33_), .O(z7));
  oai21  g11(.a(new_n32_), .b(x00), .c(z7), .O(z0));
  ...
  nand2  g30(.a(new_n54_), .b(z7), .O(z3));
  nand4  g31(.a(x10), .b(x09), .c(x08), .d(x00), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n33_), .O(new_n57_));
  oai21  g33(.a(x11), .b(new_n33_), .c(new_n57_), .O(z4));
  one    g34(.O(z5));
  zero   g35(.O(z6));
  nand2  g36(.a(new_n34_), .b(new_n33_), .O(z8));
endmodule
