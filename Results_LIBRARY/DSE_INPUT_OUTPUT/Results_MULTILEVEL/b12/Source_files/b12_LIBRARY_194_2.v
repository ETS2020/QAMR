...
module FAU ( 
  ...
  nand2  g07(.a(new_n31_), .b(x11), .O(new_n32_));
  ...
  oai21  g37(.a(new_n31_), .b(new_n59_), .c(x07), .O(new_n62_));
  ...
  nand4  g41(.a(x13), .b(new_n51_), .c(new_n50_), .d(new_n34_), .O(new_n66_));
  ...
  nand4  g54(.a(new_n78_), .b(new_n32_), .c(new_n51_), .d(new_n50_), .O(new_n79_));
  ...
  aoi21  g59(.a(new_n31_), .b(x11), .c(x10), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n50_), .O(z7));
  nor2   g61(.a(x11), .b(x09), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x12), .c(new_n34_), .O(new_n87_));
  oai21  g63(.a(x10), .b(x07), .c(new_n32_), .O(new_n88_));
  nand2  g64(.a(new_n81_), .b(new_n59_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n31_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n88_), .c(new_n87_), .O(z8));
endmodule
