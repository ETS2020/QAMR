...
module FAU ( 
  ...
  nand3  g42(.a(new_n25_), .b(new_n58_), .c(x07), .O(new_n67_));
  oai21  g43(.a(new_n66_), .b(x07), .c(new_n67_), .O(z4));
  oai21  g44(.a(x09), .b(x07), .c(x10), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x00), .O(new_n70_));
  inv1   g46(.a(x10), .O(new_n71_));
  nand2  g47(.a(x13), .b(new_n59_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n37_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n64_), .O(new_n74_));
  ...
  aoi21  g54(.a(new_n63_), .b(x03), .c(x02), .O(new_n79_));
  nand2  g55(.a(x09), .b(new_n26_), .O(new_n80_));
  oai21  g56(.a(new_n79_), .b(x10), .c(new_n80_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n78_), .c(new_n32_), .O(new_n82_));
  nand2  g58(.a(x14), .b(x02), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n37_), .O(new_n84_));
  oai21  g60(.a(x08), .b(new_n37_), .c(new_n84_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n71_), .c(x01), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n82_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n50_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n25_), .O(z6));
  nand3  g65(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n53_), .O(new_n91_));
  nand4  g67(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n71_), .d(new_n50_), .O(z7));
  nand4  g69(.a(new_n59_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  aoi21  g71(.a(new_n63_), .b(new_n37_), .c(x10), .O(new_n96_));
