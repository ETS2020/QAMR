...
module FAU ( 
  ...
  oai22  g33(.a(new_n57_), .b(x00), .c(new_n56_), .d(new_n55_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n25_), .O(z3));
  nand3  g35(.a(x09), .b(x08), .c(x00), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n55_), .O(new_n61_));
  nand3  g37(.a(new_n56_), .b(new_n47_), .c(x07), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n61_), .O(z4));
  nand4  g39(.a(x13), .b(new_n57_), .c(new_n47_), .d(new_n37_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n55_), .O(new_n65_));
  oai21  g41(.a(x10), .b(new_n55_), .c(new_n65_), .O(z5));
  nand2  g42(.a(x09), .b(new_n26_), .O(new_n67_));
  inv1   g43(.a(x09), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x03), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n27_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n45_), .c(new_n32_), .O(new_n71_));
  aoi21  g47(.a(x14), .b(x02), .c(x00), .O(new_n72_));
  nor2   g48(.a(x08), .b(new_n37_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n72_), .c(x01), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n71_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n47_), .c(new_n55_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n25_), .O(z6));
  inv1   g53(.a(x08), .O(new_n78_));
  nand3  g54(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n47_), .d(new_n55_), .O(z7));
  nand4  g58(.a(new_n57_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n68_), .b(new_n37_), .c(x10), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n55_), .O(z8));
endmodule
