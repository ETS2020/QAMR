...
module FAU ( 
  ...
  oai22  g33(.a(new_n57_), .b(x00), .c(new_n56_), .d(new_n51_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n27_), .O(z3));
  oai21  g35(.a(new_n26_), .b(new_n51_), .c(new_n25_), .O(new_n60_));
  inv1   g36(.a(x09), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n39_), .c(new_n51_), .O(new_n62_));
  nand2  g38(.a(new_n56_), .b(x07), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n60_), .O(z4));
  nand4  g40(.a(x13), .b(new_n57_), .c(new_n51_), .d(new_n39_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x08), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n26_), .O(z5));
  nand2  g43(.a(x14), .b(x02), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x01), .O(new_n69_));
  xor2a  g45(.a(x09), .b(x03), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x02), .c(new_n34_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n26_), .c(x08), .d(new_n51_), .O(new_n73_));
  nor2   g49(.a(new_n73_), .b(x00), .O(z6));
  nor2   g50(.a(x02), .b(x01), .O(new_n75_));
  nor2   g51(.a(new_n61_), .b(new_n28_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n75_), .c(x07), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n25_), .c(new_n26_), .O(z7));
  nand3  g54(.a(new_n75_), .b(new_n57_), .c(x03), .O(new_n79_));
  oai21  g55(.a(x09), .b(x00), .c(new_n51_), .O(new_n80_));
  aoi21  g56(.a(new_n79_), .b(x09), .c(new_n80_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n25_), .c(new_n26_), .O(z8));
endmodule
