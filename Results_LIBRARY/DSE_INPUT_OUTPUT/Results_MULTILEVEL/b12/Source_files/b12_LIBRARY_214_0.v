...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n49_, new_n52_, new_n54_, new_n55_;
  ...
  inv1   g26(.a(z5), .O(z6));
  aoi22  g27(.a(x12), .b(new_n39_), .c(x11), .d(x07), .O(new_n52_));
  or2    g28(.a(new_n52_), .b(z6), .O(z3));
  nand3  g29(.a(x09), .b(x08), .c(x00), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(x10), .c(new_n25_), .O(new_n55_));
  oai21  g31(.a(x11), .b(new_n25_), .c(new_n55_), .O(z4));
  nand2  g32(.a(new_n26_), .b(new_n25_), .O(z7));
  nand2  g33(.a(new_n26_), .b(new_n25_), .O(z8));
endmodule
