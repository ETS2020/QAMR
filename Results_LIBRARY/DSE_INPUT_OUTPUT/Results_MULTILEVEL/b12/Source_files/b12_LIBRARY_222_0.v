...
module FAU ( 
  ...
  nand3  g19(.a(new_n43_), .b(z5), .c(new_n35_), .O(new_n44_));
  ...
  nand4  g26(.a(x12), .b(new_n31_), .c(x09), .d(new_n35_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n50_), .c(x07), .O(new_n52_));
  aoi21  g28(.a(x12), .b(x07), .c(x10), .O(new_n53_));
  ...
  nand3  g32(.a(new_n56_), .b(z5), .c(x02), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n55_), .O(z2));
  inv1   g34(.a(x07), .O(new_n59_));
  inv1   g35(.a(x11), .O(new_n60_));
  oai22  g36(.a(new_n32_), .b(x00), .c(new_n60_), .d(new_n59_), .O(new_n61_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n67_), .c(new_n36_), .O(new_n72_));
  ...
  oai21  g54(.a(new_n42_), .b(x01), .c(new_n46_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n59_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x12), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n31_), .O(z7));
  nand3  g59(.a(new_n69_), .b(new_n59_), .c(x00), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x12), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n31_), .O(z8));
endmodule
