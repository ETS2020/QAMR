...
module FAU ( 
  ...
  nand2  g41(.a(x10), .b(new_n52_), .O(new_n66_));
  oai21  g42(.a(x10), .b(x00), .c(new_n66_), .O(new_n67_));
  aoi21  g43(.a(new_n65_), .b(x00), .c(new_n67_), .O(new_n68_));
  nand3  g44(.a(new_n25_), .b(new_n61_), .c(x07), .O(new_n69_));
  oai21  g45(.a(new_n68_), .b(x07), .c(new_n69_), .O(z4));
  oai21  g46(.a(x09), .b(x07), .c(x10), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x00), .O(new_n72_));
  nand2  g48(.a(x13), .b(new_n62_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n54_), .c(new_n37_), .O(new_n74_));
  ...
  aoi21  g55(.a(new_n52_), .b(x03), .c(x02), .O(new_n80_));
  nand2  g56(.a(x09), .b(new_n26_), .O(new_n81_));
  oai21  g57(.a(new_n80_), .b(x10), .c(new_n81_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n79_), .c(new_n32_), .O(new_n83_));
  nand2  g59(.a(x14), .b(x02), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n37_), .O(new_n85_));
  oai21  g61(.a(x08), .b(new_n37_), .c(new_n85_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n54_), .c(x01), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n83_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n47_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n25_), .O(z6));
  oai21  g66(.a(new_n41_), .b(x01), .c(new_n48_), .O(new_n91_));
  nand4  g67(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n54_), .d(new_n47_), .O(z7));
  nand4  g69(.a(new_n62_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  aoi21  g71(.a(new_n52_), .b(new_n37_), .c(x10), .O(new_n96_));
