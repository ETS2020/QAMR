...
module FAU ( 
  ...
  oai21  g36(.a(new_n56_), .b(x10), .c(x07), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n60_), .O(z4));
  inv1   g38(.a(x12), .O(new_n63_));
  nand4  g39(.a(x13), .b(new_n63_), .c(new_n49_), .d(new_n37_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n50_), .O(new_n65_));
  oai21  g41(.a(x10), .b(new_n50_), .c(new_n65_), .O(z5));
  ...
  nand3  g46(.a(new_n70_), .b(new_n53_), .c(new_n32_), .O(new_n71_));
  ...
  nand3  g51(.a(new_n75_), .b(new_n49_), .c(new_n50_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(z6));
  inv1   g53(.a(x08), .O(new_n78_));
  oai21  g54(.a(new_n41_), .b(x01), .c(new_n78_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n49_), .d(new_n50_), .O(z7));
  nand4  g57(.a(new_n63_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n68_), .b(new_n37_), .c(x10), .O(new_n84_));
