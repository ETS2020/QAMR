...
module FAU ( 
  ...
  nand4  g43(.a(x13), .b(new_n67_), .c(new_n50_), .d(new_n25_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n27_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n35_), .O(z5));
  ...
  nand3  g50(.a(new_n74_), .b(new_n45_), .c(new_n44_), .O(new_n75_));
  ...
  nand4  g55(.a(new_n79_), .b(new_n35_), .c(new_n50_), .d(new_n27_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(x03), .b(new_n26_), .c(new_n44_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n47_), .O(new_n83_));
  nor2   g59(.a(x07), .b(x04), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n26_), .d(new_n44_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n35_), .O(z7));
  nand4  g62(.a(new_n67_), .b(x03), .c(new_n26_), .d(new_n44_), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n50_), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x04), .c(new_n35_), .O(z8));
endmodule
