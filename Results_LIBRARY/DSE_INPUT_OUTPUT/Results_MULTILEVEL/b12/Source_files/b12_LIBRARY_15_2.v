...
module FAU ( 
  ...
  nand3  g27(.a(x07), .b(new_n27_), .c(new_n33_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n28_), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(x11), .c(new_n38_), .O(new_n54_));
  oai21  g30(.a(new_n51_), .b(x07), .c(new_n54_), .O(z2));
  inv1   g31(.a(x07), .O(new_n56_));
  inv1   g32(.a(x12), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(x00), .c(new_n56_), .O(new_n58_));
  ...
  nand4  g40(.a(new_n64_), .b(new_n48_), .c(new_n56_), .d(new_n38_), .O(z5));
  nand2  g41(.a(x09), .b(new_n27_), .O(new_n66_));
  inv1   g42(.a(x09), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x03), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n66_), .c(new_n28_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n46_), .c(new_n33_), .O(new_n70_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n48_), .c(new_n56_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n26_), .O(z6));
  ...
  nand2  g57(.a(x11), .b(x07), .O(new_n82_));
  oai21  g58(.a(new_n81_), .b(x07), .c(new_n82_), .O(z7));
  nand4  g59(.a(new_n57_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n84_));
  oai21  g60(.a(x09), .b(x00), .c(new_n48_), .O(new_n85_));
  aoi21  g61(.a(new_n84_), .b(x09), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x07), .c(new_n82_), .O(z8));
endmodule
