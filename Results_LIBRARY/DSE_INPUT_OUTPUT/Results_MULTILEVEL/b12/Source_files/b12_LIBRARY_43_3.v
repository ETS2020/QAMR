...
module FAU ( 
  ...
  nand2  g06(.a(x10), .b(x02), .O(new_n31_));
  ...
  nand4  g13(.a(new_n37_), .b(new_n36_), .c(new_n33_), .d(x02), .O(new_n38_));
  ...
  nor2   g18(.a(new_n33_), .b(x03), .O(new_n43_));
  ...
  nand3  g30(.a(new_n54_), .b(new_n33_), .c(x00), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(x02), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n52_), .O(z2));
  nand2  g33(.a(x11), .b(x07), .O(new_n58_));
  nand2  g34(.a(x12), .b(new_n47_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n58_), .c(new_n31_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(z3));
  nand2  g37(.a(x09), .b(x08), .O(new_n62_));
  oai22  g38(.a(new_n62_), .b(new_n47_), .c(new_n33_), .d(new_n25_), .O(new_n63_));
  inv1   g39(.a(x11), .O(new_n64_));
  nand3  g40(.a(new_n31_), .b(new_n64_), .c(x07), .O(new_n65_));
  oai21  g41(.a(new_n63_), .b(x07), .c(new_n65_), .O(z4));
  oai21  g42(.a(x07), .b(x00), .c(new_n31_), .O(new_n67_));
  inv1   g43(.a(x13), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x12), .c(new_n33_), .O(new_n69_));
  oai21  g45(.a(new_n33_), .b(x02), .c(new_n69_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n53_), .c(new_n47_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n67_), .O(z5));
  nand2  g48(.a(x08), .b(x00), .O(new_n73_));
  nand2  g49(.a(x09), .b(new_n34_), .O(new_n74_));
  nand2  g50(.a(new_n44_), .b(x03), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n41_), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n73_), .c(new_n33_), .d(new_n25_), .O(new_n77_));
  aoi21  g53(.a(x14), .b(x01), .c(x00), .O(new_n78_));
  nor2   g54(.a(x08), .b(new_n47_), .O(new_n79_));
  ...
  oai21  g60(.a(new_n84_), .b(x01), .c(new_n33_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n25_), .O(new_n86_));
  nand3  g62(.a(x03), .b(new_n25_), .c(new_n41_), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n42_), .c(x07), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x10), .c(new_n86_), .O(z7));
  inv1   g65(.a(x12), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(x03), .c(new_n25_), .d(new_n41_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n44_), .b(new_n47_), .c(x10), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n53_), .O(z8));
endmodule
