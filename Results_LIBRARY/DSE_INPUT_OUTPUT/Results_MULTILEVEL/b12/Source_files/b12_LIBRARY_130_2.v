...
module FAU ( 
  ...
  nand3  g05(.a(new_n26_), .b(new_n29_), .c(x01), .O(new_n30_));
  ...
  oai21  g11(.a(x05), .b(new_n31_), .c(x02), .O(new_n36_));
  ...
  nand4  g15(.a(new_n32_), .b(x10), .c(x04), .d(x02), .O(new_n40_));
  inv1   g16(.a(new_n40_), .O(new_n41_));
  nor2   g17(.a(new_n41_), .b(new_n34_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(x00), .O(z1));
  oai21  g19(.a(x08), .b(x07), .c(x00), .O(new_n44_));
  nand3  g20(.a(x10), .b(new_n28_), .c(new_n35_), .O(new_n45_));
  nand2  g21(.a(new_n45_), .b(new_n29_), .O(new_n46_));
  nand2  g22(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  nand2  g23(.a(x07), .b(new_n28_), .O(new_n48_));
  ...
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n26_), .O(z4));
  inv1   g41(.a(x12), .O(new_n66_));
  nor3   g42(.a(x07), .b(x04), .c(x00), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n66_), .d(new_n25_), .O(z5));
  ...
  aoi21  g55(.a(new_n79_), .b(new_n31_), .c(x10), .O(z6));
  nand3  g56(.a(x03), .b(new_n29_), .c(new_n35_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n29_), .d(new_n35_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n49_), .O(new_n83_));
  aoi21  g59(.a(new_n81_), .b(new_n52_), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x04), .c(new_n25_), .O(z7));
  nand4  g61(.a(new_n66_), .b(x03), .c(new_n29_), .d(new_n35_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n71_), .b(new_n27_), .c(x10), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n49_), .d(new_n31_), .O(z8));
endmodule
