...
module FAU ( 
  ...
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n33_), .O(z4));
  ...
  nand4  g63(.a(new_n68_), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n77_), .b(new_n35_), .c(x07), .O(new_n90_));
