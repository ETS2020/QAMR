...
module FAU ( 
  ...
  nand2  g06(.a(x12), .b(x07), .O(new_n31_));
  ...
  oai21  g34(.a(x12), .b(new_n58_), .c(x07), .O(new_n59_));
  inv1   g35(.a(x12), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(x00), .c(new_n49_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n59_), .O(z3));
  nand3  g38(.a(x09), .b(x08), .c(x00), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n49_), .O(new_n64_));
  oai21  g40(.a(x12), .b(new_n58_), .c(x07), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(z4));
  nand4  g42(.a(x13), .b(new_n60_), .c(new_n50_), .d(new_n33_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n49_), .O(new_n68_));
  nand2  g44(.a(new_n60_), .b(x07), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(z5));
  ...
  nand3  g51(.a(new_n75_), .b(new_n71_), .c(new_n44_), .O(new_n76_));
  ...
  nand3  g56(.a(new_n80_), .b(new_n50_), .c(new_n49_), .O(new_n81_));
  ...
  oai21  g62(.a(new_n86_), .b(x07), .c(new_n69_), .O(z7));
  nand4  g63(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n50_), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x07), .c(new_n69_), .O(z8));
endmodule
