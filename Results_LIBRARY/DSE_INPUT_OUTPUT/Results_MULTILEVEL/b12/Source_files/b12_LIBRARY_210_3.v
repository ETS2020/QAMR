...
module FAU ( 
  ...
  nand2  g34(.a(new_n51_), .b(new_n50_), .O(new_n59_));
  aoi22  g35(.a(new_n59_), .b(x11), .c(x12), .d(new_n37_), .O(z3));
  inv1   g36(.a(x11), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(x10), .c(x07), .O(new_n62_));
  ...
  nand2  g60(.a(new_n61_), .b(x10), .O(new_n85_));
