...
module FAU ( 
  ...
  nand4  g41(.a(new_n65_), .b(new_n46_), .c(new_n54_), .d(new_n33_), .O(z5));
  ...
  nand3  g46(.a(new_n70_), .b(new_n44_), .c(new_n34_), .O(new_n71_));
  ...
  nand3  g51(.a(new_n75_), .b(new_n46_), .c(new_n54_), .O(new_n76_));
  ...
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n46_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n54_), .O(new_n82_));
  nand2  g58(.a(new_n46_), .b(x07), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n82_), .O(z7));
  nand4  g60(.a(new_n56_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n46_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x07), .c(new_n83_), .O(z8));
endmodule
