...
module FAU ( 
  ...
  nand3  g45(.a(new_n26_), .b(new_n69_), .c(x07), .O(new_n70_));
  ...
  oai21  g51(.a(new_n75_), .b(x12), .c(new_n52_), .O(new_n76_));
  oai21  g52(.a(new_n52_), .b(new_n25_), .c(new_n76_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n51_), .c(new_n38_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n74_), .c(new_n73_), .O(z5));
  nand2  g55(.a(x08), .b(x00), .O(new_n80_));
  aoi21  g56(.a(x09), .b(new_n27_), .c(x02), .O(new_n81_));
  nand2  g57(.a(new_n25_), .b(x03), .O(new_n82_));
  oai21  g58(.a(new_n81_), .b(x10), .c(new_n82_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n80_), .c(new_n33_), .O(new_n84_));
  nand2  g60(.a(x14), .b(x02), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n38_), .O(new_n86_));
  oai21  g62(.a(x08), .b(new_n38_), .c(new_n86_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n52_), .c(x01), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n84_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n51_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n26_), .O(z6));
  nand3  g67(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n52_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n92_), .b(new_n55_), .c(x07), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x10), .c(new_n94_), .O(z7));
  inv1   g72(.a(x12), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(x09), .O(new_n99_));
  aoi21  g75(.a(new_n25_), .b(new_n38_), .c(x10), .O(new_n100_));
  nand3  g76(.a(new_n100_), .b(new_n99_), .c(new_n51_), .O(z8));
endmodule
