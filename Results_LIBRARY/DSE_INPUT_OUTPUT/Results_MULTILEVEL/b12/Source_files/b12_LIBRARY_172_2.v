...
module FAU ( 
  ...
  nor2   g59(.a(new_n71_), .b(new_n27_), .O(new_n84_));
  aoi22  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n81_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x07), .c(new_n25_), .O(z7));
  nand3  g62(.a(new_n83_), .b(new_n65_), .c(x03), .O(new_n87_));
  nor2   g63(.a(x09), .b(x00), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x07), .c(new_n25_), .O(z8));
endmodule
