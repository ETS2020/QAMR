...
module FAU ( 
  ...
  nand4  g34(.a(new_n45_), .b(x09), .c(x08), .d(x00), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n31_), .O(new_n60_));
  oai21  g36(.a(x11), .b(new_n31_), .c(new_n60_), .O(z4));
  inv1   g37(.a(x13), .O(new_n62_));
  nor2   g38(.a(new_n62_), .b(x12), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(new_n45_), .c(new_n31_), .d(new_n34_), .O(z5));
  ...
  nand3  g52(.a(x03), .b(new_n25_), .c(new_n65_), .O(new_n77_));
  nor2   g53(.a(x02), .b(x01), .O(new_n78_));
  nor2   g54(.a(new_n51_), .b(new_n35_), .O(new_n79_));
  aoi22  g55(.a(new_n79_), .b(new_n78_), .c(new_n77_), .d(new_n50_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x10), .c(new_n31_), .O(z7));
  nand3  g57(.a(new_n78_), .b(new_n55_), .c(x03), .O(new_n82_));
  nor2   g58(.a(x09), .b(x00), .O(new_n83_));
  aoi21  g59(.a(new_n82_), .b(x09), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x10), .c(new_n31_), .O(z8));
endmodule
