...
module FAU ( 
  ...
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n32_), .O(z4));
  nand4  g42(.a(x13), .b(new_n60_), .c(new_n51_), .d(new_n34_), .O(new_n67_));
  ...
  nand3  g49(.a(new_n73_), .b(new_n46_), .c(new_n44_), .O(new_n74_));
  ...
  aoi21  g55(.a(new_n79_), .b(new_n45_), .c(x10), .O(z6));
  nand3  g56(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n51_), .O(new_n83_));
  aoi21  g59(.a(new_n81_), .b(new_n48_), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x06), .c(new_n31_), .O(z7));
  nand4  g61(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n86_));
  oai21  g62(.a(x09), .b(x00), .c(new_n51_), .O(new_n87_));
  aoi21  g63(.a(new_n86_), .b(x09), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x06), .c(new_n31_), .O(z8));
endmodule
