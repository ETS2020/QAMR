...
module FAU ( 
  ...
  oai22  g39(.a(new_n63_), .b(new_n25_), .c(new_n39_), .d(new_n29_), .O(new_n64_));
  inv1   g40(.a(x11), .O(new_n65_));
  nand3  g41(.a(new_n36_), .b(new_n65_), .c(x07), .O(new_n66_));
  oai21  g42(.a(new_n64_), .b(x07), .c(new_n66_), .O(z4));
  oai21  g43(.a(x07), .b(x00), .c(new_n36_), .O(new_n68_));
  inv1   g44(.a(x13), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x12), .c(new_n39_), .O(new_n70_));
  oai21  g46(.a(new_n39_), .b(x01), .c(new_n70_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n51_), .c(new_n25_), .O(new_n72_));
  ...
  nand4  g54(.a(new_n78_), .b(new_n74_), .c(new_n39_), .d(new_n29_), .O(new_n79_));
  ...
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n39_), .d(new_n51_), .O(z7));
  inv1   g65(.a(x12), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n76_), .b(new_n25_), .c(x10), .O(new_n93_));
