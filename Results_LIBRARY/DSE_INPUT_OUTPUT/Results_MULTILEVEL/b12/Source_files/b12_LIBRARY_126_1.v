...
module FAU ( 
  ...
  nand3  g02(.a(new_n26_), .b(new_n25_), .c(x01), .O(new_n27_));
  ...
  nand4  g15(.a(new_n26_), .b(x03), .c(new_n25_), .d(x01), .O(new_n40_));
  ...
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n47_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n67_), .c(new_n25_), .O(new_n72_));
  aoi21  g48(.a(x14), .b(x01), .c(x00), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n34_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(x02), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n72_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n26_), .c(new_n49_), .O(new_n77_));
  ...
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n26_), .d(new_n49_), .O(z7));
  nand4  g58(.a(new_n58_), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n69_), .b(new_n34_), .c(x10), .O(new_n85_));
