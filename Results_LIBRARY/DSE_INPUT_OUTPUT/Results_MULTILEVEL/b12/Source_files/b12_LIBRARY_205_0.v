...
module FAU ( 
  ...
  oai21  g36(.a(new_n59_), .b(new_n50_), .c(new_n60_), .O(new_n61_));
  ...
  aoi21  g41(.a(new_n65_), .b(new_n64_), .c(new_n31_), .O(z4));
  nor2   g42(.a(x12), .b(x10), .O(new_n67_));
  nor2   g43(.a(new_n36_), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(x13), .d(new_n50_), .O(z5));
  ...
  oai21  g61(.a(new_n85_), .b(new_n36_), .c(new_n51_), .O(z7));
  inv1   g62(.a(x12), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n72_), .b(new_n34_), .c(x10), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n50_), .d(x04), .O(z8));
endmodule
