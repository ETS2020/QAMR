...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n66_, new_n67_, new_n68_, new_n71_;
  ...
  aoi21  g22(.a(new_n41_), .b(new_n33_), .c(x02), .O(new_n47_));
  ...
  oai21  g27(.a(new_n51_), .b(new_n47_), .c(new_n35_), .O(z2));
  nand2  g28(.a(x11), .b(x07), .O(new_n53_));
  nand2  g29(.a(x12), .b(new_n48_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n53_), .c(new_n35_), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(z3));
  nand2  g32(.a(x09), .b(x08), .O(new_n57_));
  oai22  g33(.a(new_n57_), .b(new_n48_), .c(x10), .d(x01), .O(new_n58_));
  inv1   g34(.a(x11), .O(new_n59_));
  nand3  g35(.a(new_n35_), .b(new_n59_), .c(x07), .O(new_n60_));
  oai21  g36(.a(new_n58_), .b(x07), .c(new_n60_), .O(z4));
  inv1   g37(.a(x12), .O(new_n62_));
  nand4  g38(.a(x13), .b(new_n62_), .c(new_n49_), .d(new_n48_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(x01), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n34_), .O(z5));
  aoi21  g41(.a(x14), .b(x02), .c(x00), .O(new_n66_));
  nor2   g42(.a(x08), .b(new_n48_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n66_), .c(new_n49_), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(x01), .c(x10), .O(z6));
  nand4  g45(.a(new_n34_), .b(x08), .c(new_n49_), .d(x01), .O(z7));
  nor2   g46(.a(x10), .b(x09), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n49_), .c(x01), .d(x00), .O(z8));
endmodule
