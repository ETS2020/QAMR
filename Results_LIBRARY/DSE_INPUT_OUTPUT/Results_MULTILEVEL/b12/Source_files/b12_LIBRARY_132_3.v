...
module FAU ( 
  ...
  nor3   g42(.a(x12), .b(x07), .c(x00), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x10), .c(x13), .O(z5));
  ...
  nand4  g63(.a(new_n87_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n71_), .b(new_n33_), .c(x10), .O(new_n90_));
