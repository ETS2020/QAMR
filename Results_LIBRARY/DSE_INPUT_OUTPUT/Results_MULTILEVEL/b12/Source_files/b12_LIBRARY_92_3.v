...
module FAU ( 
  ...
  nand2  g38(.a(x10), .b(new_n37_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(z4));
  inv1   g40(.a(x13), .O(new_n65_));
  nor2   g41(.a(new_n65_), .b(x12), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n49_), .c(new_n50_), .d(new_n37_), .O(z5));
  ...
  nand4  g57(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n49_), .d(new_n50_), .O(z7));
  nand4  g59(.a(new_n57_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n69_), .b(new_n37_), .c(x10), .O(new_n86_));
