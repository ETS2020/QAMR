// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:06 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n63_, new_n64_, new_n66_, new_n67_, new_n68_, new_n70_, new_n72_,
  ...
  nand4  g09(.a(new_n33_), .b(x10), .c(x02), .d(x01), .O(new_n34_));
  ...
  aoi21  g14(.a(x06), .b(x05), .c(new_n26_), .O(new_n39_));
  ...
  nand4  g52(.a(new_n76_), .b(new_n72_), .c(new_n45_), .d(new_n53_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(x01), .O(z6));
  aoi21  g54(.a(x03), .b(new_n28_), .c(x08), .O(new_n79_));
  nand2  g55(.a(x09), .b(x03), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x02), .c(new_n53_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n79_), .c(new_n25_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n45_), .O(z7));
  nand3  g59(.a(new_n63_), .b(x03), .c(new_n28_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n74_), .b(new_n36_), .c(x10), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n53_), .d(new_n25_), .O(z8));
endmodule
