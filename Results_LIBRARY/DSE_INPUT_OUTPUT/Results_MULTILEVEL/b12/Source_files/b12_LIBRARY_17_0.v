...
module FAU ( 
  ...
  oai22  g39(.a(new_n63_), .b(new_n35_), .c(x10), .d(x06), .O(new_n64_));
  nand3  g40(.a(new_n33_), .b(new_n59_), .c(x07), .O(new_n65_));
  oai21  g41(.a(new_n64_), .b(x07), .c(new_n65_), .O(z4));
  nand4  g42(.a(x13), .b(new_n60_), .c(new_n51_), .d(new_n35_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x06), .O(new_n68_));
