...
module FAU ( 
  ...
  nand3  g44(.a(x13), .b(new_n48_), .c(new_n38_), .O(new_n69_));
  ...
  oai21  g59(.a(new_n42_), .b(x01), .c(new_n49_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n53_), .d(new_n48_), .O(z7));
  nand4  g62(.a(new_n25_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n74_), .b(new_n38_), .c(x10), .O(new_n89_));
