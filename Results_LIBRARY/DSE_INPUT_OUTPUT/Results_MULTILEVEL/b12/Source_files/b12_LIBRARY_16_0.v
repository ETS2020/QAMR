...
module FAU ( 
  ...
  nand2  g40(.a(new_n64_), .b(new_n36_), .O(z5));
  ...
  nand3  g45(.a(new_n69_), .b(new_n49_), .c(new_n48_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(x00), .c(x10), .O(z6));
  oai21  g47(.a(new_n40_), .b(x01), .c(new_n49_), .O(new_n72_));
  nand3  g48(.a(new_n66_), .b(x09), .c(x03), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n48_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x00), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n64_), .O(z7));
  nand3  g52(.a(new_n66_), .b(new_n55_), .c(x03), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x09), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n64_), .c(new_n48_), .d(x00), .O(z8));
endmodule
