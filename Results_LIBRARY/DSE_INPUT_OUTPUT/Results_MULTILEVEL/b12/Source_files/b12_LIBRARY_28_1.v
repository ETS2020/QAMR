...
module FAU ( 
  ...
  oai21  g39(.a(x11), .b(new_n25_), .c(new_n63_), .O(z4));
  nand3  g40(.a(x13), .b(new_n57_), .c(new_n38_), .O(new_n65_));
  ...
  nand3  g46(.a(new_n70_), .b(new_n62_), .c(new_n33_), .O(new_n71_));
