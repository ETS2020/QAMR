...
module FAU ( 
  ...
  oai21  g37(.a(x11), .b(new_n38_), .c(new_n59_), .O(new_n62_));
  oai21  g38(.a(new_n61_), .b(new_n54_), .c(new_n62_), .O(new_n63_));
  nand2  g39(.a(new_n59_), .b(x11), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n38_), .O(new_n65_));
  inv1   g41(.a(x11), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x07), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n63_), .O(z4));
  inv1   g44(.a(x12), .O(new_n69_));
  nand4  g45(.a(x13), .b(new_n69_), .c(new_n51_), .d(new_n38_), .O(new_n70_));
  ...
  nand2  g50(.a(new_n61_), .b(x03), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n28_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n73_), .c(new_n33_), .O(new_n77_));
