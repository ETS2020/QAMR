...
module FAU ( 
  ...
  and2   g39(.a(new_n34_), .b(x11), .O(new_n64_));
  ...
  nand4  g46(.a(new_n70_), .b(new_n68_), .c(new_n46_), .d(new_n36_), .O(z5));
  ...
  oai21  g55(.a(new_n79_), .b(x08), .c(new_n33_), .O(z7));
  inv1   g56(.a(x12), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n54_), .b(new_n36_), .c(x10), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n52_), .d(new_n46_), .O(z8));
endmodule
