...
module FAU ( 
  ...
  oai21  g41(.a(x07), .b(new_n38_), .c(x10), .O(new_n66_));
  inv1   g42(.a(x12), .O(new_n67_));
  nand3  g43(.a(x13), .b(new_n67_), .c(new_n38_), .O(new_n68_));
  ...
  nand3  g56(.a(new_n80_), .b(new_n25_), .c(new_n61_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  oai21  g58(.a(new_n42_), .b(x01), .c(new_n53_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n25_), .d(new_n61_), .O(z7));
  nand4  g61(.a(new_n67_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n86_));
