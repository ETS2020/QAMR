...
module FAU ( 
  ...
  nor2   g20(.a(x13), .b(x10), .O(new_n45_));
  ...
  oai21  g24(.a(x13), .b(new_n44_), .c(new_n31_), .O(new_n49_));
  ...
  aoi22  g39(.a(new_n63_), .b(new_n61_), .c(x13), .d(new_n31_), .O(z4));
  inv1   g40(.a(x01), .O(new_n66_));
  nand2  g41(.a(x08), .b(x00), .O(new_n67_));
  nand2  g42(.a(x09), .b(new_n35_), .O(new_n68_));
  inv1   g43(.a(x09), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(x03), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(new_n68_), .c(new_n25_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(new_n67_), .c(new_n66_), .O(new_n72_));
  aoi21  g47(.a(x14), .b(x02), .c(x00), .O(new_n73_));
  nor2   g48(.a(x08), .b(new_n34_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(new_n73_), .c(x01), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n72_), .c(x13), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(new_n31_), .c(new_n44_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z6));
  inv1   g53(.a(x08), .O(new_n79_));
  nand3  g54(.a(x03), .b(new_n25_), .c(new_n66_), .O(new_n80_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n66_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n44_), .O(new_n82_));
  aoi21  g57(.a(new_n80_), .b(new_n79_), .c(new_n82_), .O(new_n83_));
  oai21  g58(.a(new_n83_), .b(x13), .c(new_n31_), .O(z7));
  inv1   g59(.a(x12), .O(new_n85_));
  nand4  g60(.a(new_n85_), .b(x03), .c(new_n25_), .d(new_n66_), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g62(.a(new_n69_), .b(new_n34_), .c(x07), .O(new_n88_));
  nand3  g63(.a(new_n88_), .b(new_n87_), .c(new_n45_), .O(z8));
  one    g64(.O(z5));
endmodule
