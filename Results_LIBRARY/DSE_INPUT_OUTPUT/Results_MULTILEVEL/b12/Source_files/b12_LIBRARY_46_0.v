...
module FAU ( 
  ...
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n26_), .O(z4));
  ...
  nand2  g56(.a(new_n80_), .b(new_n26_), .O(z6));
  oai21  g57(.a(new_n42_), .b(x01), .c(new_n55_), .O(new_n82_));
  ...
  aoi21  g61(.a(new_n85_), .b(new_n82_), .c(new_n25_), .O(z7));
  nand4  g62(.a(new_n61_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  nor2   g64(.a(x09), .b(x00), .O(new_n89_));
  nor3   g65(.a(new_n89_), .b(x10), .c(x07), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n88_), .c(new_n25_), .O(z8));
endmodule
