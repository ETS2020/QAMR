...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n56_, new_n57_, new_n58_, new_n61_, new_n63_, new_n64_, new_n65_,
  ...
  nor2   g32(.a(x08), .b(new_n55_), .O(new_n57_));
  aoi21  g33(.a(new_n56_), .b(new_n55_), .c(new_n57_), .O(new_n58_));
  aoi21  g34(.a(x11), .b(x07), .c(new_n58_), .O(z3));
  aoi22  g35(.a(x11), .b(x07), .c(x08), .d(x00), .O(z4));
  nor2   g36(.a(x07), .b(x00), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(x13), .c(new_n56_), .d(new_n47_), .O(z5));
  nand2  g38(.a(x09), .b(new_n33_), .O(new_n63_));
  inv1   g39(.a(x09), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(x03), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n25_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n31_), .c(new_n41_), .O(new_n67_));
  aoi21  g43(.a(x14), .b(x02), .c(x00), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n57_), .c(x01), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n47_), .c(new_n46_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(z6));
  nand3  g48(.a(x03), .b(new_n25_), .c(new_n41_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x08), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x09), .O(new_n75_));
  nand3  g51(.a(new_n31_), .b(new_n47_), .c(new_n46_), .O(new_n76_));
  aoi21  g52(.a(new_n73_), .b(new_n50_), .c(new_n76_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n75_), .O(z7));
  oai21  g54(.a(new_n64_), .b(x08), .c(x00), .O(new_n79_));
  nand4  g55(.a(new_n56_), .b(x03), .c(new_n25_), .d(new_n41_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g57(.a(new_n47_), .b(new_n46_), .O(new_n82_));
  aoi22  g58(.a(new_n82_), .b(new_n31_), .c(new_n64_), .d(new_n55_), .O(new_n83_));
