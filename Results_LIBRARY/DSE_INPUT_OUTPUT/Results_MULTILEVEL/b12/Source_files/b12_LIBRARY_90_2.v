...
module FAU ( 
  ...
  nand4  g44(.a(x13), .b(new_n68_), .c(new_n50_), .d(new_n34_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n51_), .O(new_n70_));
  oai21  g46(.a(new_n31_), .b(new_n51_), .c(new_n70_), .O(z5));
  ...
  nand3  g55(.a(new_n79_), .b(new_n75_), .c(new_n35_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n74_), .c(x10), .O(new_n81_));
  nand3  g57(.a(new_n31_), .b(x01), .c(new_n34_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n81_), .c(new_n50_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n32_), .O(z6));
  oai21  g61(.a(new_n41_), .b(x01), .c(new_n54_), .O(new_n86_));
  nand4  g62(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n51_), .d(new_n50_), .O(z7));
  nand4  g64(.a(new_n68_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n77_), .b(new_n34_), .c(x10), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n50_), .O(z8));
endmodule
