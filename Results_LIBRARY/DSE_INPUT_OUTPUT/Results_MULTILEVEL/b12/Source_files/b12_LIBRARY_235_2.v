...
module FAU ( 
  ...
  nand2  g01(.a(new_n25_), .b(x13), .O(new_n26_));
  ...
  oai21  g59(.a(new_n42_), .b(x01), .c(new_n55_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n85_));
  aoi21  g61(.a(new_n25_), .b(x13), .c(x10), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n51_), .O(z7));
  nand4  g63(.a(new_n69_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n74_), .b(new_n38_), .c(x07), .O(new_n90_));
