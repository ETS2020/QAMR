...
module FAU ( 
  ...
  nor2   g54(.a(new_n53_), .b(new_n27_), .O(new_n79_));
  aoi22  g55(.a(new_n79_), .b(new_n78_), .c(new_n77_), .d(new_n52_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x10), .c(new_n25_), .O(z7));
  nand3  g57(.a(new_n78_), .b(new_n57_), .c(x03), .O(new_n82_));
