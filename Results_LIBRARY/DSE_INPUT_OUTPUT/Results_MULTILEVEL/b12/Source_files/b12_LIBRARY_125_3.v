...
module FAU ( 
  ...
  nor3   g43(.a(x12), .b(x07), .c(x00), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x10), .c(x13), .O(z5));
  ...
  nand3  g55(.a(new_n79_), .b(new_n51_), .c(new_n50_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n54_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n51_), .d(new_n50_), .O(z7));
  inv1   g61(.a(x12), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n72_), .b(new_n37_), .c(x10), .O(new_n89_));
