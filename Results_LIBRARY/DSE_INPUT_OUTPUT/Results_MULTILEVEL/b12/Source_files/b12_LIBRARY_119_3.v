...
module FAU ( 
  ...
  oai22  g35(.a(new_n59_), .b(x00), .c(new_n58_), .d(new_n53_), .O(new_n60_));
  ...
  nand2  g42(.a(x10), .b(new_n25_), .O(new_n67_));
  ...
  nand2  g47(.a(new_n71_), .b(new_n66_), .O(z5));
  ...
  nand3  g57(.a(new_n81_), .b(new_n33_), .c(new_n53_), .O(new_n82_));
  ...
  nand4  g65(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n41_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n53_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x10), .c(new_n67_), .O(z8));
endmodule
