...
module FAU ( 
  ...
  nand2  g36(.a(x11), .b(new_n48_), .O(new_n61_));
  nand2  g37(.a(new_n25_), .b(new_n53_), .O(new_n62_));
  aoi22  g38(.a(new_n62_), .b(new_n61_), .c(x12), .d(new_n38_), .O(z3));
  ...
  nand4  g45(.a(x13), .b(new_n69_), .c(new_n48_), .d(new_n38_), .O(new_n70_));
  ...
  nand3  g52(.a(new_n76_), .b(new_n74_), .c(new_n28_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n33_), .O(new_n78_));
  aoi21  g54(.a(x14), .b(x02), .c(x00), .O(new_n79_));
  nor2   g55(.a(x08), .b(new_n38_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n79_), .c(x01), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n53_), .c(new_n48_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n26_), .O(z6));
  nand3  g60(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n49_), .O(new_n86_));
  nand4  g62(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n53_), .d(new_n48_), .O(z7));
  nand4  g64(.a(new_n69_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n89_));
  oai21  g65(.a(x09), .b(x00), .c(new_n48_), .O(new_n90_));
