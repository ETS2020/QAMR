...
module FAU ( 
  ...
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n47_), .d(new_n55_), .O(z7));
  nand4  g57(.a(new_n57_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n68_), .b(new_n37_), .c(x10), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n55_), .O(z8));
endmodule
