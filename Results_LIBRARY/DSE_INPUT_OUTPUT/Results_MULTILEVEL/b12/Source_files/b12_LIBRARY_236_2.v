...
module FAU ( 
  ...
  oai22  g32(.a(new_n56_), .b(x00), .c(new_n55_), .d(new_n44_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n32_), .O(z3));
  nand3  g34(.a(x09), .b(x08), .c(x00), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n44_), .O(new_n60_));
  nand3  g36(.a(new_n55_), .b(x10), .c(x07), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n60_), .O(z4));
  oai21  g38(.a(x07), .b(new_n34_), .c(x10), .O(new_n63_));
  nand3  g39(.a(x13), .b(new_n56_), .c(new_n34_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n44_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n63_), .O(z5));
  ...
  nand3  g53(.a(new_n77_), .b(new_n31_), .c(new_n44_), .O(new_n78_));
  ...
  nor2   g58(.a(new_n70_), .b(new_n35_), .O(new_n83_));
  aoi22  g59(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n80_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x07), .c(new_n31_), .O(z7));
  nand3  g61(.a(new_n82_), .b(new_n56_), .c(x03), .O(new_n86_));
  nor2   g62(.a(x09), .b(x00), .O(new_n87_));
  aoi21  g63(.a(new_n86_), .b(x09), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x07), .c(new_n31_), .O(z8));
endmodule
