...
module FAU ( 
  ...
  nand2  g58(.a(x10), .b(new_n27_), .O(new_n83_));
  nand3  g59(.a(x03), .b(new_n26_), .c(new_n43_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n26_), .d(new_n43_), .O(new_n85_));
  ...
  nand4  g64(.a(new_n68_), .b(x03), .c(new_n26_), .d(new_n43_), .O(new_n89_));
