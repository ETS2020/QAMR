...
module FAU ( 
  ...
  oai21  g36(.a(new_n25_), .b(x00), .c(new_n60_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n26_), .O(z3));
  inv1   g38(.a(x09), .O(new_n63_));
  nand2  g39(.a(new_n60_), .b(new_n63_), .O(new_n64_));
  inv1   g40(.a(x11), .O(new_n65_));
  aoi21  g41(.a(x08), .b(x00), .c(x07), .O(new_n66_));
  aoi21  g42(.a(new_n65_), .b(x07), .c(new_n66_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n25_), .c(new_n64_), .O(z4));
  nor3   g44(.a(x09), .b(x07), .c(x00), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n25_), .d(new_n52_), .O(z5));
  nand2  g46(.a(new_n33_), .b(new_n38_), .O(new_n71_));
  nand2  g47(.a(new_n55_), .b(x00), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g49(.a(x09), .b(new_n27_), .O(new_n74_));
  nand2  g50(.a(new_n63_), .b(x03), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n28_), .O(new_n76_));
  ...
  nand2  g62(.a(new_n52_), .b(new_n51_), .O(new_n87_));
  aoi21  g63(.a(new_n84_), .b(new_n55_), .c(new_n87_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n86_), .O(z7));
  oai21  g65(.a(new_n87_), .b(new_n38_), .c(new_n63_), .O(new_n90_));
  oai21  g66(.a(new_n25_), .b(new_n63_), .c(new_n90_), .O(z8));
endmodule
