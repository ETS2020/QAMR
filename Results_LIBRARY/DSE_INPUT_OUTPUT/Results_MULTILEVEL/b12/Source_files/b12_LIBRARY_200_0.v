...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n48_, new_n49_, new_n52_, new_n54_, new_n55_;
  ...
  inv1   g26(.a(new_n35_), .O(z6));
  aoi22  g27(.a(x12), .b(new_n37_), .c(x11), .d(x07), .O(new_n52_));
  or2    g28(.a(new_n52_), .b(z6), .O(z3));
  nand4  g29(.a(x10), .b(x09), .c(x08), .d(x00), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n33_), .O(new_n55_));
  oai21  g31(.a(x11), .b(new_n33_), .c(new_n55_), .O(z4));
  one    g32(.O(z5));
  one    g33(.O(z7));
  one    g34(.O(z8));
endmodule
