...
module FAU ( 
  ...
  aoi22  g40(.a(new_n64_), .b(new_n63_), .c(x12), .d(new_n25_), .O(z4));
  nor2   g41(.a(x07), .b(x00), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n59_), .d(new_n25_), .O(z5));
  ...
  aoi21  g54(.a(new_n78_), .b(new_n59_), .c(x10), .O(z6));
  ...
  oai21  g60(.a(x09), .b(x00), .c(new_n46_), .O(new_n85_));
  aoi21  g61(.a(new_n81_), .b(x09), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x12), .c(new_n25_), .O(z8));
endmodule
