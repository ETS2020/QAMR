...
module FAU ( 
  ...
  nand3  g23(.a(x14), .b(new_n31_), .c(x09), .O(new_n48_));
  nand2  g24(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n46_), .O(new_n50_));
  nand4  g26(.a(x14), .b(new_n31_), .c(x09), .d(new_n35_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n50_), .c(x07), .O(new_n52_));
  aoi21  g28(.a(x14), .b(x07), .c(x10), .O(new_n53_));
  ...
  nand4  g43(.a(x13), .b(new_n61_), .c(new_n59_), .d(new_n35_), .O(new_n68_));
  ...
  nand2  g61(.a(new_n85_), .b(x14), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n31_), .O(z7));
  nand4  g63(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n88_));
