...
module FAU ( 
  ...
  nand2  g22(.a(new_n46_), .b(new_n28_), .O(new_n47_));
  ...
  nand3  g27(.a(new_n51_), .b(x12), .c(new_n33_), .O(new_n52_));
  ...
  nand2  g33(.a(new_n57_), .b(new_n33_), .O(new_n58_));
  ...
  oai22  g38(.a(new_n25_), .b(x00), .c(new_n62_), .d(new_n55_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n26_), .O(z3));
  nand3  g40(.a(new_n26_), .b(new_n62_), .c(x07), .O(new_n65_));
  nand2  g41(.a(x09), .b(x00), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(x12), .c(new_n56_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x07), .c(new_n65_), .O(z4));
  nand4  g44(.a(x13), .b(new_n49_), .c(new_n55_), .d(new_n38_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n56_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n25_), .O(z5));
  aoi21  g47(.a(x12), .b(new_n38_), .c(new_n56_), .O(new_n72_));
  nand2  g48(.a(x14), .b(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x01), .O(new_n74_));
  xor2a  g50(.a(x09), .b(x03), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x02), .c(new_n33_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n74_), .c(new_n72_), .O(new_n77_));
  nand3  g53(.a(new_n56_), .b(x01), .c(x00), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n49_), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(x07), .O(z6));
  oai21  g57(.a(x10), .b(x07), .c(new_n26_), .O(new_n82_));
  nand4  g58(.a(x12), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x08), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  nand3  g61(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n56_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n85_), .c(new_n82_), .O(z7));
  oai21  g64(.a(new_n25_), .b(x09), .c(x08), .O(new_n89_));
  nand4  g65(.a(new_n25_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  inv1   g67(.a(x09), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n38_), .c(x10), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n91_), .c(new_n89_), .d(new_n55_), .O(z8));
endmodule
