...
module FAU ( 
  ...
  nand4  g28(.a(new_n35_), .b(x09), .c(new_n52_), .d(new_n49_), .O(new_n53_));
  ...
  nand3  g35(.a(new_n59_), .b(new_n57_), .c(new_n32_), .O(new_n60_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n35_), .c(new_n49_), .O(new_n80_));
  ...
  nand4  g63(.a(new_n67_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n88_));
