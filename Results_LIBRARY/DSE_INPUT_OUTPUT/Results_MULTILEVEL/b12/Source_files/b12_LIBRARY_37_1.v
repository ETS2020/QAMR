...
module FAU ( 
  ...
  aoi22  g42(.a(new_n66_), .b(new_n64_), .c(x14), .d(new_n25_), .O(z4));
  ...
  nand4  g53(.a(new_n77_), .b(new_n72_), .c(new_n69_), .d(new_n25_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(x07), .O(z6));
  nand3  g55(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n80_));
  nand3  g56(.a(new_n73_), .b(x09), .c(x03), .O(new_n81_));
