...
module FAU ( 
  ...
  nand3  g35(.a(new_n59_), .b(new_n50_), .c(new_n34_), .O(z2));
  oai21  g36(.a(x12), .b(new_n52_), .c(x11), .O(new_n61_));
  oai21  g37(.a(new_n32_), .b(x00), .c(new_n31_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n61_), .O(z3));
  oai21  g39(.a(x12), .b(new_n31_), .c(x07), .O(new_n64_));
  ...
  nand4  g43(.a(x13), .b(new_n53_), .c(new_n52_), .d(new_n36_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n32_), .O(new_n69_));
  oai21  g45(.a(new_n32_), .b(x11), .c(new_n69_), .O(z5));
  ...
  nand4  g56(.a(new_n80_), .b(new_n34_), .c(new_n53_), .d(new_n52_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand3  g58(.a(x03), .b(new_n25_), .c(new_n47_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n56_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n85_));
  nor2   g61(.a(new_n33_), .b(x10), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n52_), .O(z7));
  nor2   g63(.a(new_n33_), .b(x00), .O(new_n88_));
  nor2   g64(.a(x10), .b(x07), .O(new_n89_));
  nor2   g65(.a(new_n89_), .b(x11), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n88_), .c(new_n73_), .O(new_n91_));
  nand2  g67(.a(new_n83_), .b(x09), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n32_), .O(new_n94_));
  nand3  g70(.a(x12), .b(new_n31_), .c(x09), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n94_), .c(new_n91_), .O(z8));
endmodule
