...
module FAU ( 
  ...
  aoi21  g43(.a(new_n67_), .b(new_n65_), .c(new_n44_), .O(z4));
  nand2  g44(.a(x08), .b(x00), .O(new_n70_));
  nand2  g45(.a(x09), .b(new_n35_), .O(new_n71_));
  inv1   g46(.a(x09), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(x03), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(new_n71_), .c(new_n25_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n70_), .c(new_n46_), .O(new_n75_));
  aoi21  g50(.a(x14), .b(x02), .c(x00), .O(new_n76_));
  nor2   g51(.a(x08), .b(new_n34_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(new_n76_), .c(x01), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n75_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n32_), .c(new_n52_), .d(new_n51_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z6));
  nand3  g56(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n82_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(new_n52_), .c(new_n51_), .O(new_n84_));
  aoi21  g59(.a(new_n82_), .b(new_n55_), .c(new_n84_), .O(new_n85_));
  nor2   g60(.a(new_n85_), .b(new_n44_), .O(z7));
  oai21  g61(.a(new_n31_), .b(x09), .c(x13), .O(new_n87_));
  nand4  g62(.a(new_n31_), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n88_));
  nand2  g63(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g64(.a(new_n72_), .b(new_n34_), .c(x10), .O(new_n90_));
  nand4  g65(.a(new_n90_), .b(new_n89_), .c(new_n87_), .d(new_n51_), .O(z8));
  one    g66(.O(z5));
endmodule
