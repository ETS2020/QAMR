...
module FAU ( 
  ...
  nand4  g41(.a(new_n65_), .b(new_n47_), .c(new_n58_), .d(new_n37_), .O(z5));
  ...
  aoi21  g61(.a(new_n68_), .b(new_n37_), .c(x10), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n58_), .O(z8));
endmodule
