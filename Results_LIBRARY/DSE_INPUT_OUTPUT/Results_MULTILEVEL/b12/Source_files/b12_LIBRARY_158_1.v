...
module FAU ( 
  ...
  nand2  g01(.a(x13), .b(new_n25_), .O(z5));
  ...
  nand3  g36(.a(new_n60_), .b(new_n59_), .c(z5), .O(new_n61_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(z5), .O(z4));
