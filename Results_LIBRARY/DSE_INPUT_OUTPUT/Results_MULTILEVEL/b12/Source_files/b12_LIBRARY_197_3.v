...
module FAU ( 
  ...
  oai22  g40(.a(new_n64_), .b(new_n37_), .c(new_n63_), .d(new_n51_), .O(new_n65_));
  nand3  g41(.a(new_n25_), .b(new_n59_), .c(x07), .O(new_n66_));
  ...
  nand2  g56(.a(new_n80_), .b(new_n25_), .O(z6));
  ...
  nand2  g61(.a(new_n63_), .b(x10), .O(new_n86_));
