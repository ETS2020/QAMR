...
module FAU ( 
  ...
  nand2  g58(.a(x12), .b(x10), .O(new_n83_));
  ...
  oai21  g64(.a(x10), .b(x09), .c(x12), .O(new_n89_));
  oai21  g65(.a(x09), .b(x00), .c(new_n48_), .O(new_n90_));
  aoi21  g66(.a(new_n84_), .b(x09), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x10), .c(new_n89_), .O(z8));
endmodule
