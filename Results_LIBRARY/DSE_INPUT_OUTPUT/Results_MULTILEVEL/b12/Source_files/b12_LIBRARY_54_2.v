...
module FAU ( 
  ...
  nor2   g29(.a(new_n31_), .b(new_n52_), .O(new_n54_));
  ...
  inv1   g44(.a(new_n54_), .O(new_n69_));
  nand4  g45(.a(x13), .b(new_n62_), .c(new_n47_), .d(new_n34_), .O(new_n70_));
  ...
  nand2  g52(.a(x09), .b(new_n36_), .O(new_n77_));
  inv1   g53(.a(x09), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x03), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n25_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n76_), .c(new_n35_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n75_), .c(x10), .O(new_n82_));
  nand3  g58(.a(new_n31_), .b(x01), .c(new_n34_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n82_), .c(new_n47_), .O(new_n85_));
  ...
  nand4  g67(.a(new_n62_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n92_));
