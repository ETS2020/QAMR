...
module FAU ( 
  ...
  aoi21  g65(.a(new_n87_), .b(new_n59_), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x07), .c(new_n86_), .O(z7));
  ...
  oai21  g71(.a(new_n95_), .b(x07), .c(new_n86_), .O(z8));
endmodule
