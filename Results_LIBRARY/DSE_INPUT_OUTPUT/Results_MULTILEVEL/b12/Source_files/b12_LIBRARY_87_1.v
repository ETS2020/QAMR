...
module FAU ( 
  ...
  nor2   g07(.a(new_n31_), .b(x10), .O(new_n32_));
  ...
  aoi21  g42(.a(new_n66_), .b(new_n65_), .c(new_n32_), .O(z4));
  ...
  nand3  g48(.a(new_n73_), .b(new_n69_), .c(new_n46_), .O(new_n74_));
  ...
  nand2  g53(.a(new_n78_), .b(new_n51_), .O(new_n79_));
  aoi21  g54(.a(new_n79_), .b(new_n31_), .c(x10), .O(z6));
  nand3  g55(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n81_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n51_), .O(new_n83_));
  aoi21  g58(.a(new_n81_), .b(new_n55_), .c(new_n83_), .O(new_n84_));
  oai21  g59(.a(new_n84_), .b(x13), .c(new_n52_), .O(z7));
  nand4  g60(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n86_));
  oai21  g61(.a(x09), .b(x00), .c(new_n51_), .O(new_n87_));
  aoi21  g62(.a(new_n86_), .b(x09), .c(new_n87_), .O(new_n88_));
  oai21  g63(.a(new_n88_), .b(x13), .c(new_n52_), .O(z8));
  one    g64(.O(z5));
endmodule
