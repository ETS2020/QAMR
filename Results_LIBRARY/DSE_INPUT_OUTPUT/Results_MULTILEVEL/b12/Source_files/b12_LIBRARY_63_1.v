...
module FAU ( 
  ...
  aoi21  g34(.a(x10), .b(new_n50_), .c(new_n58_), .O(new_n59_));
  aoi21  g35(.a(x12), .b(new_n34_), .c(new_n59_), .O(z3));
  nand3  g36(.a(x09), .b(x08), .c(x00), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(new_n62_));
  oai22  g38(.a(new_n62_), .b(new_n59_), .c(x11), .d(new_n50_), .O(z4));
  inv1   g39(.a(x12), .O(new_n64_));
  nor3   g40(.a(x10), .b(x07), .c(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n64_), .d(new_n58_), .O(z5));
  ...
  aoi21  g53(.a(new_n77_), .b(new_n58_), .c(x10), .O(z6));
  ...
  oai21  g58(.a(new_n82_), .b(x11), .c(new_n31_), .O(z7));
  nand4  g59(.a(new_n64_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n69_), .b(new_n34_), .c(x07), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n58_), .d(new_n31_), .O(z8));
endmodule
