...
module FAU ( 
  ...
  nand3  g37(.a(new_n61_), .b(new_n47_), .c(new_n25_), .O(new_n62_));
  oai21  g38(.a(x11), .b(new_n25_), .c(new_n62_), .O(z4));
  aoi21  g39(.a(x13), .b(new_n57_), .c(x07), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(x00), .c(new_n47_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n25_), .O(z5));
  nand2  g42(.a(x08), .b(x00), .O(new_n67_));
  nand2  g43(.a(x09), .b(new_n27_), .O(new_n68_));
  nand2  g44(.a(new_n53_), .b(x03), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n28_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n67_), .c(new_n33_), .O(new_n71_));
  nand2  g47(.a(x14), .b(x02), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n38_), .O(new_n73_));
  oai21  g49(.a(x08), .b(new_n38_), .c(new_n73_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(x01), .c(x10), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n71_), .c(x07), .O(z6));
  nand3  g52(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n52_), .O(new_n78_));
  nand4  g54(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n78_), .c(new_n47_), .d(new_n25_), .O(z7));
  nand4  g56(.a(new_n57_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x09), .O(new_n82_));
  aoi21  g58(.a(new_n53_), .b(new_n38_), .c(x10), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n25_), .O(z8));
endmodule
