...
module FAU ( 
  ...
  nor2   g56(.a(new_n70_), .b(new_n34_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(x10), .O(new_n82_));
  nand3  g58(.a(new_n80_), .b(new_n49_), .c(x03), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n53_), .O(new_n84_));
  oai21  g60(.a(new_n82_), .b(x07), .c(new_n84_), .O(z7));
  inv1   g61(.a(x12), .O(new_n86_));
  nand3  g62(.a(new_n80_), .b(new_n86_), .c(x03), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n50_), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  nand2  g65(.a(new_n53_), .b(x07), .O(new_n90_));
  oai21  g66(.a(new_n89_), .b(x07), .c(new_n90_), .O(z8));
endmodule
