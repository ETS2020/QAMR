...
module FAU ( 
  ...
  nand2  g36(.a(new_n58_), .b(new_n50_), .O(new_n61_));
  inv1   g37(.a(x11), .O(new_n62_));
  aoi21  g38(.a(x09), .b(x00), .c(x07), .O(new_n63_));
  aoi21  g39(.a(new_n62_), .b(x07), .c(new_n63_), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n25_), .c(new_n61_), .O(z4));
  nor3   g41(.a(x08), .b(x07), .c(x00), .O(new_n66_));
  ...
  oai21  g46(.a(new_n70_), .b(x02), .c(new_n33_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n25_), .c(new_n50_), .d(new_n49_), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(z6));
  nor3   g50(.a(x10), .b(x09), .c(x08), .O(new_n75_));
  nor2   g51(.a(x02), .b(x01), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n75_), .c(new_n49_), .d(x03), .O(z7));
  nand3  g53(.a(new_n76_), .b(new_n57_), .c(x03), .O(new_n78_));
  oai21  g54(.a(x09), .b(x00), .c(new_n49_), .O(new_n79_));
  aoi21  g55(.a(new_n78_), .b(x09), .c(new_n79_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x08), .c(new_n25_), .O(z8));
endmodule
