...
module FAU ( 
  ...
  oai22  g35(.a(new_n59_), .b(x00), .c(new_n31_), .d(new_n50_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n32_), .O(z3));
  oai21  g37(.a(x10), .b(x07), .c(new_n31_), .O(new_n62_));
  ...
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n59_), .d(new_n51_), .O(z5));
  ...
  oai21  g55(.a(new_n41_), .b(x01), .c(new_n54_), .O(new_n80_));
  ...
  nand2  g60(.a(new_n84_), .b(new_n83_), .O(z7));
  nand4  g61(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n86_));
