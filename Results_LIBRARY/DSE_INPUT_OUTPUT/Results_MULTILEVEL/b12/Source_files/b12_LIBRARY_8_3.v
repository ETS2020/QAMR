...
module FAU ( 
  ...
  nand4  g37(.a(new_n32_), .b(x09), .c(x08), .d(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n49_), .O(new_n63_));
  inv1   g39(.a(x11), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(x07), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n34_), .O(z4));
  inv1   g42(.a(x12), .O(new_n67_));
  nand2  g43(.a(x13), .b(new_n67_), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n36_), .c(x10), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n34_), .c(new_n49_), .d(new_n36_), .O(z5));
  ...
  nand3  g56(.a(new_n80_), .b(new_n32_), .c(new_n49_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n34_), .O(z6));
  nor2   g58(.a(x02), .b(x01), .O(new_n83_));
  nor2   g59(.a(new_n73_), .b(new_n37_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(x07), .O(new_n85_));
  nand3  g61(.a(new_n83_), .b(new_n32_), .c(x03), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n31_), .O(new_n87_));
  oai21  g63(.a(new_n85_), .b(x10), .c(new_n87_), .O(z7));
  nand3  g64(.a(new_n83_), .b(new_n67_), .c(x03), .O(new_n89_));
