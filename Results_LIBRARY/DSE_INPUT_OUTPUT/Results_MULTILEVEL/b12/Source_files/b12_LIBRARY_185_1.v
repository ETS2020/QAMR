...
module FAU ( 
  ...
  oai21  g37(.a(x11), .b(new_n33_), .c(new_n61_), .O(z4));
  aoi21  g38(.a(x13), .b(new_n56_), .c(x07), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x00), .c(new_n46_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n33_), .O(z5));
  ...
  nor2   g55(.a(new_n52_), .b(new_n37_), .O(new_n80_));
  aoi22  g56(.a(new_n80_), .b(new_n79_), .c(new_n78_), .d(new_n51_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(x10), .c(new_n33_), .O(z7));
