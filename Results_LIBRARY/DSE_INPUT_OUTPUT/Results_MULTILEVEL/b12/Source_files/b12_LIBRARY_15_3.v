...
module FAU ( 
  ...
  nand3  g29(.a(new_n53_), .b(new_n51_), .c(new_n37_), .O(new_n54_));
  oai21  g30(.a(new_n50_), .b(x07), .c(new_n54_), .O(z2));
  nand3  g31(.a(new_n25_), .b(x12), .c(new_n37_), .O(z3));
  inv1   g32(.a(x07), .O(new_n57_));
  nand4  g33(.a(x09), .b(x08), .c(new_n57_), .d(x00), .O(z4));
  inv1   g34(.a(x13), .O(new_n59_));
  nor2   g35(.a(new_n59_), .b(x12), .O(new_n60_));
  nand4  g36(.a(new_n60_), .b(new_n47_), .c(new_n57_), .d(new_n37_), .O(z5));
  ...
  nand3  g41(.a(new_n65_), .b(new_n45_), .c(new_n32_), .O(new_n66_));
  aoi21  g42(.a(x14), .b(x02), .c(x00), .O(new_n67_));
  nor2   g43(.a(x08), .b(new_n37_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n67_), .c(x01), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n66_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n47_), .c(new_n57_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n25_), .O(z6));
  inv1   g48(.a(x08), .O(new_n73_));
  nand3  g49(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n74_));
  nand4  g50(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n47_), .O(new_n76_));
  aoi21  g52(.a(new_n74_), .b(new_n73_), .c(new_n76_), .O(new_n77_));
  nand2  g53(.a(new_n51_), .b(x07), .O(new_n78_));
  oai21  g54(.a(new_n77_), .b(x07), .c(new_n78_), .O(z7));
  inv1   g55(.a(x12), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n81_));
  oai21  g57(.a(x09), .b(x00), .c(new_n47_), .O(new_n82_));
  aoi21  g58(.a(new_n81_), .b(x09), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x07), .c(new_n78_), .O(z8));
endmodule
