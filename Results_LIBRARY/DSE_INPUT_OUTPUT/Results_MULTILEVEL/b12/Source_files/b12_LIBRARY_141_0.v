...
module FAU ( 
  ...
  nand4  g42(.a(x13), .b(new_n60_), .c(new_n52_), .d(new_n39_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x11), .O(new_n68_));
  oai21  g44(.a(new_n26_), .b(new_n52_), .c(x10), .O(new_n69_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n52_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x11), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n25_), .O(z7));
  nand4  g63(.a(new_n60_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n73_), .b(new_n39_), .c(x07), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(x11), .d(new_n25_), .O(z8));
endmodule
