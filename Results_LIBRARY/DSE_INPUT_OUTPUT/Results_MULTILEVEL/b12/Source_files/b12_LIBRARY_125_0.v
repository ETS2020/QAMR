...
module FAU ( 
  ...
  nand4  g56(.a(new_n80_), .b(x13), .c(new_n25_), .d(new_n52_), .O(new_n81_));
  ...
  aoi21  g66(.a(new_n73_), .b(new_n39_), .c(x07), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n86_), .O(z8));
endmodule
