...
module FAU ( 
  ...
  oai21  g22(.a(x10), .b(x07), .c(new_n35_), .O(new_n47_));
  ...
  nand3  g27(.a(x09), .b(new_n31_), .c(new_n48_), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n51_), .c(new_n46_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n45_), .c(new_n32_), .O(z2));
  nand2  g31(.a(x11), .b(x07), .O(new_n56_));
  nand2  g32(.a(x12), .b(new_n34_), .O(new_n57_));
  ...
  nand2  g37(.a(new_n49_), .b(new_n31_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n61_), .c(new_n34_), .O(new_n63_));
  aoi21  g39(.a(x10), .b(new_n31_), .c(x00), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n63_), .c(new_n48_), .O(new_n65_));
  inv1   g41(.a(x11), .O(new_n66_));
  nand3  g42(.a(new_n32_), .b(new_n66_), .c(x07), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n65_), .O(z4));
  oai21  g44(.a(x10), .b(x07), .c(new_n31_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x00), .O(new_n70_));
  nand2  g46(.a(new_n32_), .b(x07), .O(new_n71_));
  inv1   g47(.a(x13), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(x12), .c(new_n49_), .O(new_n73_));
  oai21  g49(.a(new_n49_), .b(new_n31_), .c(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n48_), .c(new_n34_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n71_), .c(new_n70_), .O(z5));
  oai21  g52(.a(x10), .b(x00), .c(x08), .O(new_n77_));
  nand2  g53(.a(x09), .b(new_n35_), .O(new_n78_));
  nand2  g54(.a(new_n60_), .b(x03), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n25_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n77_), .c(new_n46_), .O(new_n81_));
  nand2  g57(.a(x14), .b(x02), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n49_), .c(new_n34_), .O(new_n83_));
  nand2  g59(.a(new_n31_), .b(x00), .O(new_n84_));
  ...
  nand2  g64(.a(new_n88_), .b(new_n32_), .O(z6));
  ...
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n49_), .d(new_n48_), .O(z7));
  inv1   g69(.a(x12), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(x09), .O(new_n96_));
  aoi21  g72(.a(new_n60_), .b(new_n34_), .c(x10), .O(new_n97_));
