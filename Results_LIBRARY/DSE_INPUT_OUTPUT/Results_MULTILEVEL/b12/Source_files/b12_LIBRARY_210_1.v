...
module FAU ( 
  ...
  nand3  g27(.a(new_n25_), .b(x09), .c(new_n51_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n50_), .c(x00), .O(new_n53_));
  inv1   g29(.a(x08), .O(new_n54_));
  nand4  g30(.a(new_n25_), .b(x09), .c(new_n54_), .d(new_n51_), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n53_), .c(new_n33_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n49_), .c(new_n26_), .O(z2));
  nand2  g34(.a(x10), .b(new_n51_), .O(new_n59_));
  aoi22  g35(.a(new_n59_), .b(x11), .c(x12), .d(new_n38_), .O(z3));
  inv1   g36(.a(x11), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n25_), .c(x07), .O(new_n62_));
  ...
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n66_), .d(new_n61_), .O(z5));
  ...
  nand4  g54(.a(new_n78_), .b(new_n61_), .c(new_n25_), .d(new_n51_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  oai21  g56(.a(new_n42_), .b(x01), .c(new_n54_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n81_), .c(new_n51_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n61_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n25_), .O(z7));
  nand4  g61(.a(new_n66_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n71_), .b(new_n38_), .c(x07), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n61_), .d(new_n25_), .O(z8));
endmodule
