...
module FAU ( 
  ...
  aoi21  g11(.a(new_n35_), .b(x06), .c(new_n34_), .O(new_n36_));
  oai21  g12(.a(new_n28_), .b(new_n34_), .c(x10), .O(new_n37_));
  aoi21  g13(.a(new_n37_), .b(x06), .c(new_n25_), .O(new_n38_));
  oai21  g14(.a(new_n38_), .b(new_n36_), .c(x03), .O(new_n39_));
  nand2  g15(.a(new_n37_), .b(x06), .O(new_n40_));
  ...
  nand4  g20(.a(new_n44_), .b(new_n31_), .c(x09), .d(new_n43_), .O(new_n45_));
  inv1   g21(.a(x03), .O(new_n46_));
  inv1   g22(.a(x08), .O(new_n47_));
  nand3  g23(.a(x10), .b(new_n47_), .c(new_n46_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n45_), .c(x07), .O(new_n49_));
  inv1   g25(.a(x00), .O(new_n50_));
  inv1   g26(.a(x07), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(x06), .c(new_n31_), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(new_n46_), .c(new_n50_), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n49_), .c(new_n34_), .O(new_n55_));
  ...
  oai22  g39(.a(new_n63_), .b(new_n50_), .c(x10), .d(new_n43_), .O(new_n64_));
  nand3  g40(.a(new_n32_), .b(new_n59_), .c(x07), .O(new_n65_));
  oai21  g41(.a(new_n64_), .b(x07), .c(new_n65_), .O(z4));
  nand4  g42(.a(x13), .b(new_n60_), .c(new_n51_), .d(new_n50_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n43_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n31_), .O(z5));
  nand2  g45(.a(x09), .b(new_n46_), .O(new_n70_));
  inv1   g46(.a(x09), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x03), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(new_n25_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n44_), .c(new_n34_), .O(new_n74_));
  aoi21  g50(.a(x14), .b(x02), .c(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n50_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(x01), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n31_), .c(new_n51_), .d(new_n43_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand3  g56(.a(x03), .b(new_n25_), .c(new_n34_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n51_), .O(new_n83_));
  aoi21  g59(.a(new_n81_), .b(new_n47_), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x06), .c(new_n31_), .O(z7));
  nand4  g61(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n86_));
