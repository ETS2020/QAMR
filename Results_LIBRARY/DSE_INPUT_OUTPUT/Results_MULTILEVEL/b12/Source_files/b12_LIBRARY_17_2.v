...
module FAU ( 
  ...
  oai21  g12(.a(new_n36_), .b(new_n25_), .c(x01), .O(new_n37_));
  ...
  nand3  g16(.a(new_n38_), .b(x04), .c(x02), .O(new_n41_));
  inv1   g17(.a(new_n41_), .O(new_n42_));
  oai21  g18(.a(new_n42_), .b(new_n40_), .c(new_n34_), .O(new_n43_));
  ...
  nand3  g33(.a(new_n57_), .b(new_n49_), .c(new_n32_), .O(z2));
  ...
  oai22  g39(.a(new_n63_), .b(new_n34_), .c(x10), .d(new_n36_), .O(new_n64_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n70_), .c(new_n46_), .O(new_n75_));
  ...
  nand4  g55(.a(new_n79_), .b(new_n31_), .c(new_n51_), .d(new_n36_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n54_), .O(new_n83_));
  nor2   g59(.a(x07), .b(x06), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n31_), .O(z7));
  nand4  g62(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n72_), .b(new_n34_), .c(x10), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n84_), .O(z8));
endmodule
