...
module FAU ( 
  ...
  oai21  g38(.a(x10), .b(x07), .c(x11), .O(new_n63_));
  nand3  g39(.a(x09), .b(x08), .c(x00), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  oai21  g41(.a(x11), .b(new_n50_), .c(new_n65_), .O(z4));
  ...
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n51_), .d(new_n50_), .O(z7));
  nand4  g60(.a(new_n60_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n50_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  nand2  g63(.a(new_n59_), .b(x10), .O(new_n88_));
  oai21  g64(.a(new_n87_), .b(x10), .c(new_n88_), .O(z8));
endmodule
