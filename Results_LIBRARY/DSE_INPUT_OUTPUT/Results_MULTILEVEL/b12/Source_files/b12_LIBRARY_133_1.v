// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:01 2020
...
module FAU ( 
  ...
  aoi22  g34(.a(new_n58_), .b(new_n56_), .c(x12), .d(new_n34_), .O(z3));
  nand4  g35(.a(new_n55_), .b(x09), .c(x08), .d(x00), .O(new_n60_));
  ...
  nand4  g40(.a(new_n64_), .b(new_n55_), .c(new_n31_), .d(new_n34_), .O(z5));
  ...
  nand3  g46(.a(new_n70_), .b(new_n66_), .c(new_n46_), .O(new_n71_));
  ...
  nand3  g51(.a(new_n75_), .b(new_n55_), .c(new_n31_), .O(new_n76_));
  ...
  aoi21  g61(.a(new_n68_), .b(new_n34_), .c(x10), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n31_), .O(z8));
endmodule
