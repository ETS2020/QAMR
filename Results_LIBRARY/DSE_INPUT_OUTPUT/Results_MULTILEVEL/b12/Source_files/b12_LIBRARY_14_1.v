...
module FAU ( 
  ...
  nor2   g22(.a(x12), .b(x10), .O(new_n47_));
  ...
  oai21  g26(.a(x12), .b(new_n46_), .c(new_n25_), .O(new_n51_));
  ...
  nand2  g33(.a(x10), .b(x00), .O(new_n58_));
  aoi22  g34(.a(new_n58_), .b(x12), .c(x11), .d(x07), .O(z3));
  inv1   g35(.a(x12), .O(new_n60_));
  nand2  g36(.a(x09), .b(x08), .O(new_n61_));
  oai22  g37(.a(new_n61_), .b(new_n38_), .c(new_n60_), .d(x10), .O(new_n62_));
  inv1   g38(.a(x11), .O(new_n63_));
  nand3  g39(.a(new_n26_), .b(new_n63_), .c(x07), .O(new_n64_));
  oai21  g40(.a(new_n62_), .b(x07), .c(new_n64_), .O(z4));
  nand3  g41(.a(x13), .b(new_n46_), .c(new_n38_), .O(new_n66_));
  ...
  nand2  g61(.a(new_n82_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n71_), .b(new_n38_), .c(x07), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n47_), .O(z8));
endmodule
