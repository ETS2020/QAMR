...
module FAU ( 
  ...
  aoi21  g26(.a(new_n50_), .b(new_n25_), .c(x07), .O(new_n51_));
  nor2   g27(.a(new_n25_), .b(x00), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n51_), .c(new_n31_), .O(new_n53_));
  oai21  g29(.a(x10), .b(x07), .c(new_n36_), .O(new_n54_));
  inv1   g30(.a(x07), .O(new_n55_));
  nand2  g31(.a(new_n49_), .b(new_n55_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n54_), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(new_n25_), .c(new_n45_), .d(new_n35_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n53_), .O(z2));
  inv1   g35(.a(x11), .O(new_n60_));
  aoi21  g36(.a(x12), .b(new_n35_), .c(new_n32_), .O(new_n61_));
  oai21  g37(.a(new_n60_), .b(new_n55_), .c(new_n61_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(z3));
  oai21  g39(.a(x08), .b(new_n55_), .c(x02), .O(new_n64_));
  nand3  g40(.a(x09), .b(x08), .c(x00), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n55_), .O(new_n66_));
  nand2  g42(.a(new_n60_), .b(x07), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n64_), .O(z4));
  inv1   g44(.a(x12), .O(new_n69_));
  nand3  g45(.a(x13), .b(new_n69_), .c(new_n46_), .O(new_n70_));
  nor3   g46(.a(new_n70_), .b(x07), .c(x00), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(new_n32_), .O(z5));
  xor2a  g48(.a(x09), .b(x03), .O(new_n73_));
  oai22  g49(.a(new_n73_), .b(x01), .c(new_n31_), .d(new_n35_), .O(new_n74_));
  nand2  g50(.a(x14), .b(x01), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x00), .c(x02), .O(new_n76_));
  oai21  g52(.a(new_n74_), .b(x02), .c(new_n76_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n46_), .c(new_n55_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n33_), .O(z6));
  nand3  g55(.a(x09), .b(x03), .c(new_n45_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n46_), .c(new_n55_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n25_), .O(new_n82_));
  nand3  g58(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n31_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n82_), .O(z7));
  oai21  g61(.a(x09), .b(x08), .c(x02), .O(new_n86_));
  nand3  g62(.a(new_n69_), .b(x03), .c(new_n45_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n48_), .b(new_n35_), .c(x10), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n86_), .d(new_n55_), .O(z8));
endmodule
