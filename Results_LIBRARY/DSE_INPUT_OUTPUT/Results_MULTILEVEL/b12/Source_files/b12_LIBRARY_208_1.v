...
module FAU ( 
  ...
  nand3  g34(.a(new_n58_), .b(new_n49_), .c(z5), .O(z2));
  ...
  nand4  g55(.a(new_n79_), .b(z5), .c(new_n52_), .d(new_n51_), .O(new_n80_));
  ...
  aoi21  g61(.a(new_n85_), .b(new_n82_), .c(new_n64_), .O(z7));
  oai21  g62(.a(new_n25_), .b(x09), .c(x13), .O(new_n87_));
  nand4  g63(.a(new_n25_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n88_));
