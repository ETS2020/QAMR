...
module FAU ( 
  ...
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n57_), .d(new_n31_), .O(z5));
  ...
  nand4  g52(.a(new_n76_), .b(new_n57_), .c(new_n31_), .d(new_n44_), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(z6));
  inv1   g54(.a(x08), .O(new_n79_));
  nand3  g55(.a(x03), .b(new_n25_), .c(new_n66_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n66_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n44_), .O(new_n82_));
  aoi21  g58(.a(new_n80_), .b(new_n79_), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x12), .c(new_n31_), .O(z7));
