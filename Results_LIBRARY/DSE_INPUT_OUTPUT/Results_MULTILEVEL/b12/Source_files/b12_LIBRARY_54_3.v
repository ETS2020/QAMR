...
module FAU ( 
  ...
  nand2  g06(.a(x14), .b(x10), .O(new_n31_));
  ...
  nand3  g19(.a(x07), .b(new_n35_), .c(new_n34_), .O(new_n44_));
  ...
  inv1   g28(.a(x14), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(x10), .c(new_n35_), .O(new_n54_));
  ...
  nand4  g44(.a(x13), .b(new_n61_), .c(new_n46_), .d(new_n33_), .O(new_n69_));
  ...
  nand3  g57(.a(new_n81_), .b(new_n51_), .c(new_n46_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n31_), .O(z6));
  oai21  g59(.a(new_n40_), .b(x01), .c(new_n47_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n46_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n51_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n68_), .O(z7));
  nand4  g64(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n89_));
