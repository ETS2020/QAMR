...
module FAU ( 
  ...
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n49_), .d(new_n50_), .O(z7));
  nand4  g58(.a(new_n57_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n69_), .b(new_n37_), .c(x10), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n50_), .O(z8));
endmodule
