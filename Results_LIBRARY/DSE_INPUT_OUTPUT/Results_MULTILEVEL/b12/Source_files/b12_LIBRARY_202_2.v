...
module FAU ( 
  ...
  nand2  g51(.a(new_n75_), .b(new_n38_), .O(new_n76_));
  oai21  g52(.a(x08), .b(new_n38_), .c(new_n76_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(x01), .c(x07), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n74_), .c(x10), .O(z6));
  inv1   g55(.a(x08), .O(new_n80_));
  nand3  g56(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n25_), .d(new_n46_), .O(z7));
  nand4  g60(.a(new_n58_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n71_), .b(new_n38_), .c(x10), .O(new_n87_));
