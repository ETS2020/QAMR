...
module FAU ( 
  ...
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n61_), .d(new_n51_), .O(z5));
  ...
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n51_), .d(new_n46_), .O(z7));
  nand2  g61(.a(new_n53_), .b(x10), .O(new_n86_));
  nand4  g62(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n46_), .O(new_n88_));
