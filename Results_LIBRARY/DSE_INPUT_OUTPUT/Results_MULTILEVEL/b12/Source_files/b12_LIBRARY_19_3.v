...
module FAU ( 
  ...
  nand3  g35(.a(new_n59_), .b(new_n58_), .c(new_n31_), .O(new_n60_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n31_), .O(z4));
  ...
  nor2   g52(.a(x08), .b(new_n33_), .O(new_n77_));
  ...
  nand2  g56(.a(new_n80_), .b(new_n31_), .O(z6));
  oai21  g57(.a(new_n40_), .b(x01), .c(new_n53_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n49_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n50_), .O(new_n85_));
  oai21  g61(.a(x13), .b(new_n50_), .c(new_n85_), .O(z7));
  nand4  g62(.a(new_n67_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n72_), .b(new_n33_), .c(x10), .O(new_n89_));
