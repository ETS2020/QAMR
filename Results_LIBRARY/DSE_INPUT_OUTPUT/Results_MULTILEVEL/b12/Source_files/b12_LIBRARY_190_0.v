...
module FAU ( 
  ...
  nand3  g42(.a(x13), .b(new_n66_), .c(new_n26_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n60_), .c(new_n51_), .d(new_n39_), .O(z5));
  ...
  nand4  g50(.a(new_n74_), .b(new_n26_), .c(x08), .d(new_n51_), .O(new_n75_));
  nor2   g51(.a(new_n75_), .b(x00), .O(z6));
