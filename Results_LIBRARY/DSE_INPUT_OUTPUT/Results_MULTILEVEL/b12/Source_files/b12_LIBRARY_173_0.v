...
module FAU ( 
  ...
  nand3  g37(.a(new_n56_), .b(new_n58_), .c(x07), .O(new_n62_));
  nand2  g38(.a(x09), .b(x08), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(x00), .O(new_n64_));
  oai21  g40(.a(new_n30_), .b(x00), .c(new_n64_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n48_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n62_), .O(z4));
  nand3  g43(.a(x13), .b(new_n59_), .c(new_n49_), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n55_), .c(x07), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n30_), .c(new_n55_), .O(z5));
  nand3  g46(.a(x08), .b(new_n25_), .c(new_n55_), .O(new_n71_));
  nand2  g47(.a(new_n30_), .b(x00), .O(new_n72_));
  xnor2a g48(.a(x09), .b(x03), .O(new_n73_));
  aoi22  g49(.a(new_n73_), .b(new_n27_), .c(new_n72_), .d(new_n71_), .O(new_n74_));
  nand2  g50(.a(x14), .b(x02), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(x08), .c(new_n55_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n72_), .c(new_n25_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n74_), .c(new_n49_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(x07), .O(z6));
  oai21  g55(.a(x10), .b(x07), .c(new_n56_), .O(new_n80_));
  nand4  g56(.a(x08), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n72_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  nand2  g59(.a(new_n40_), .b(new_n25_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n30_), .c(x00), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n83_), .c(new_n80_), .O(z7));
  nand2  g62(.a(new_n63_), .b(new_n55_), .O(new_n87_));
  nand4  g63(.a(new_n59_), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n87_), .c(new_n49_), .d(new_n48_), .O(z8));
endmodule
