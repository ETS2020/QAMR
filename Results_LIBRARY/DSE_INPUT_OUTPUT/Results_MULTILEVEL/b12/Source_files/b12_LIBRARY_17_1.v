// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:18 2020
...
module FAU ( 
  ...
  oai22  g39(.a(new_n63_), .b(new_n34_), .c(new_n51_), .d(x06), .O(new_n64_));
  ...
  oai21  g44(.a(new_n68_), .b(x12), .c(new_n51_), .O(new_n69_));
  oai21  g45(.a(new_n51_), .b(new_n31_), .c(new_n69_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n50_), .c(new_n34_), .O(new_n71_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n45_), .O(new_n78_));
  ...
  nand3  g58(.a(new_n82_), .b(new_n51_), .c(new_n50_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  nand3  g60(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n54_), .O(new_n86_));
  nand4  g62(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n51_), .d(new_n50_), .O(z7));
  nand4  g64(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n75_), .b(new_n34_), .c(x10), .O(new_n91_));
