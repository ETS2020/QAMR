...
module FAU ( 
  ...
  oai21  g30(.a(new_n54_), .b(new_n51_), .c(new_n35_), .O(new_n55_));
  ...
  oai21  g39(.a(new_n58_), .b(new_n31_), .c(x07), .O(new_n64_));
  ...
  nand3  g49(.a(new_n73_), .b(new_n69_), .c(new_n35_), .O(new_n74_));
  ...
  oai21  g56(.a(new_n41_), .b(x01), .c(new_n52_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n31_), .d(new_n57_), .O(z7));
  nand4  g59(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n71_), .b(new_n34_), .c(x10), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n57_), .O(z8));
endmodule
