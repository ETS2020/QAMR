// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:43 2020
...
module FAU ( 
  ...
  nand4  g36(.a(new_n56_), .b(x09), .c(x08), .d(x00), .O(new_n61_));
  ...
  nand4  g41(.a(new_n65_), .b(new_n56_), .c(new_n25_), .d(new_n38_), .O(z5));
  ...
  nand2  g49(.a(new_n73_), .b(new_n38_), .O(new_n74_));
  oai21  g50(.a(x08), .b(new_n38_), .c(new_n74_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(x01), .c(x10), .O(new_n76_));
  ...
  nor2   g55(.a(new_n69_), .b(new_n27_), .O(new_n80_));
  aoi22  g56(.a(new_n80_), .b(new_n79_), .c(new_n78_), .d(new_n51_), .O(new_n81_));
  ...
  oai21  g62(.a(new_n86_), .b(x10), .c(new_n25_), .O(z8));
endmodule
