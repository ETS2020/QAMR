...
module FAU ( 
  ...
  oai21  g18(.a(new_n42_), .b(new_n37_), .c(new_n41_), .O(new_n43_));
  ...
  oai21  g38(.a(new_n57_), .b(new_n33_), .c(x07), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n62_), .O(z4));
  oai21  g40(.a(x07), .b(new_n36_), .c(x10), .O(new_n65_));
  nand3  g41(.a(x13), .b(new_n58_), .c(new_n36_), .O(new_n66_));
  ...
  nand3  g49(.a(new_n73_), .b(new_n69_), .c(new_n37_), .O(new_n74_));
  ...
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n37_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n33_), .d(new_n46_), .O(z7));
  nand4  g59(.a(new_n58_), .b(x03), .c(new_n25_), .d(new_n37_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n71_), .b(new_n36_), .c(x10), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n46_), .O(z8));
endmodule
