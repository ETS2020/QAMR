...
module FAU ( 
  ...
  nand2  g09(.a(x04), .b(new_n33_), .O(new_n34_));
  ...
  oai21  g31(.a(new_n55_), .b(new_n52_), .c(new_n48_), .O(new_n56_));
  ...
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n59_), .d(new_n35_), .O(z5));
  nand2  g43(.a(x08), .b(x00), .O(new_n68_));
  nand2  g44(.a(x09), .b(new_n33_), .O(new_n69_));
  inv1   g45(.a(x09), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x03), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n25_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n68_), .c(new_n48_), .O(new_n73_));
  aoi21  g49(.a(x14), .b(x02), .c(x00), .O(new_n74_));
  inv1   g50(.a(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n75_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n74_), .c(x01), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n73_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n35_), .c(new_n50_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  oai21  g56(.a(x10), .b(new_n53_), .c(new_n33_), .O(new_n81_));
  oai21  g57(.a(x02), .b(x01), .c(new_n53_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n25_), .d(new_n48_), .O(new_n83_));
  ...
  oai21  g62(.a(x10), .b(x09), .c(new_n33_), .O(new_n87_));
  nor2   g63(.a(x12), .b(x02), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n48_), .c(new_n70_), .O(new_n89_));
  oai21  g65(.a(x09), .b(x00), .c(new_n50_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(new_n35_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n87_), .O(z8));
endmodule
