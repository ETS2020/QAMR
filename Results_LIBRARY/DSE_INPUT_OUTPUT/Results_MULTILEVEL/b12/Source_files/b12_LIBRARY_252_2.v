...
module FAU ( 
  ...
  oai21  g35(.a(new_n55_), .b(new_n31_), .c(x07), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n59_), .O(z4));
  inv1   g37(.a(x13), .O(new_n62_));
  nor2   g38(.a(new_n62_), .b(x12), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(new_n31_), .c(new_n44_), .d(new_n34_), .O(z5));
  ...
  nand3  g51(.a(new_n75_), .b(new_n31_), .c(new_n44_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(z6));
  inv1   g53(.a(x08), .O(new_n78_));
  nand3  g54(.a(x03), .b(new_n25_), .c(new_n65_), .O(new_n79_));
  nor2   g55(.a(x02), .b(x01), .O(new_n80_));
  nor2   g56(.a(new_n68_), .b(new_n35_), .O(new_n81_));
  aoi22  g57(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(new_n78_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x07), .c(new_n31_), .O(z7));
