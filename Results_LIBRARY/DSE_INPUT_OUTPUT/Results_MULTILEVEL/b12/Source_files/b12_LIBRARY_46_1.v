...
module FAU ( 
  ...
  oai21  g46(.a(new_n70_), .b(new_n28_), .c(x01), .O(new_n71_));
  nand2  g47(.a(x14), .b(x01), .O(new_n72_));
  xor2a  g48(.a(x09), .b(x03), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x02), .c(new_n72_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n71_), .c(x00), .O(new_n75_));
  oai21  g51(.a(new_n70_), .b(x00), .c(x01), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n74_), .c(x08), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n75_), .c(new_n52_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x07), .c(new_n26_), .O(z6));
  inv1   g55(.a(new_n26_), .O(new_n80_));
  ...
  aoi21  g60(.a(new_n84_), .b(new_n81_), .c(new_n80_), .O(z7));
  ...
  nor3   g64(.a(new_n88_), .b(x10), .c(x07), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n87_), .c(new_n80_), .O(z8));
endmodule
