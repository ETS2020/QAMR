...
module FAU ( 
  ...
  nand4  g53(.a(x09), .b(x03), .c(new_n25_), .d(new_n49_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n45_), .d(new_n57_), .O(z7));
  inv1   g55(.a(x12), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(x03), .c(new_n25_), .d(new_n49_), .O(new_n81_));
