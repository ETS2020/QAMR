...
module FAU ( 
  ...
  oai22  g40(.a(new_n64_), .b(new_n38_), .c(x13), .d(new_n52_), .O(new_n65_));
  nand3  g41(.a(new_n26_), .b(new_n60_), .c(x07), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x07), .c(new_n66_), .O(z4));
  oai21  g43(.a(x07), .b(x00), .c(new_n26_), .O(new_n68_));
  nand2  g44(.a(x13), .b(x10), .O(new_n69_));
  oai21  g45(.a(new_n25_), .b(x12), .c(new_n52_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n51_), .c(new_n38_), .O(new_n72_));
  ...
  nand2  g60(.a(new_n84_), .b(new_n26_), .O(z6));
  ...
  nand4  g66(.a(new_n61_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n76_), .b(new_n38_), .c(x10), .O(new_n93_));
