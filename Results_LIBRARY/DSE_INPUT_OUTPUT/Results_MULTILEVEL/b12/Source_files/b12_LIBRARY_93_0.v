...
module FAU ( 
  ...
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n33_), .O(z4));
  nor2   g41(.a(x12), .b(x10), .O(new_n66_));
  nor2   g42(.a(new_n31_), .b(x00), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n66_), .c(x13), .d(new_n60_), .O(z5));
  ...
  nand4  g53(.a(new_n77_), .b(new_n32_), .c(new_n60_), .d(x04), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  nand3  g55(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n60_), .O(new_n82_));
  aoi21  g58(.a(new_n80_), .b(new_n47_), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n31_), .c(new_n32_), .O(z7));
  inv1   g60(.a(x12), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n70_), .b(new_n35_), .c(x10), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n60_), .d(x04), .O(z8));
endmodule
