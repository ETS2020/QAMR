...
module FAU ( 
  ...
  nand4  g37(.a(x13), .b(new_n61_), .c(new_n45_), .d(new_n33_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n57_), .O(new_n63_));
  nand2  g39(.a(new_n45_), .b(x07), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n63_), .O(z5));
  ...
  oai21  g57(.a(new_n81_), .b(x07), .c(new_n64_), .O(z7));
  nand4  g58(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n49_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n67_), .b(new_n33_), .c(x10), .O(new_n85_));
