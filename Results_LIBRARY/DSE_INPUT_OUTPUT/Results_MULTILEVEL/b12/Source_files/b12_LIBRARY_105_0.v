...
module FAU ( 
  ...
  nand4  g23(.a(new_n47_), .b(new_n26_), .c(x09), .d(x06), .O(new_n48_));
  inv1   g24(.a(x08), .O(new_n49_));
  nand3  g25(.a(x10), .b(new_n49_), .c(new_n28_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n48_), .c(x07), .O(new_n51_));
  aoi21  g27(.a(x07), .b(x06), .c(x10), .O(new_n52_));
  ...
  nand3  g31(.a(new_n55_), .b(new_n27_), .c(x02), .O(new_n56_));
  ...
  aoi22  g41(.a(new_n65_), .b(new_n64_), .c(new_n26_), .d(new_n25_), .O(z4));
  ...
  nand3  g49(.a(new_n73_), .b(new_n47_), .c(new_n34_), .O(new_n74_));
  ...
  nand4  g54(.a(new_n78_), .b(new_n26_), .c(new_n58_), .d(x06), .O(new_n79_));
  ...
  oai21  g60(.a(new_n84_), .b(new_n25_), .c(new_n26_), .O(z7));
  nand4  g61(.a(new_n60_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n71_), .b(new_n39_), .c(x10), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n58_), .d(x06), .O(z8));
endmodule
