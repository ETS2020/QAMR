...
module FAU ( 
  ...
  nand2  g14(.a(new_n31_), .b(new_n28_), .O(new_n39_));
  ...
  aoi21  g20(.a(new_n44_), .b(x01), .c(new_n42_), .O(new_n45_));
  oai21  g21(.a(new_n45_), .b(x00), .c(new_n27_), .O(z1));
  ...
  aoi21  g52(.a(new_n61_), .b(x00), .c(new_n76_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n34_), .c(new_n75_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n26_), .c(x09), .d(new_n58_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand2  g56(.a(x08), .b(new_n58_), .O(new_n81_));
  aoi21  g57(.a(new_n44_), .b(new_n34_), .c(new_n81_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n25_), .c(new_n26_), .O(z7));
  nand4  g59(.a(new_n58_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n53_), .c(new_n26_), .d(x09), .O(z8));
endmodule
