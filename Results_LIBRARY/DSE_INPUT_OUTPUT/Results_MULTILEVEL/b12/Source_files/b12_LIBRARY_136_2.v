...
module FAU ( 
  ...
  nand3  g29(.a(x11), .b(x10), .c(new_n35_), .O(new_n54_));
  ...
  oai22  g36(.a(new_n60_), .b(x00), .c(new_n31_), .d(new_n47_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n32_), .O(z3));
  nand2  g38(.a(x09), .b(x08), .O(new_n63_));
  oai22  g39(.a(new_n63_), .b(new_n34_), .c(x11), .d(new_n52_), .O(new_n64_));
  nand3  g40(.a(new_n31_), .b(new_n52_), .c(x07), .O(new_n65_));
  ...
  oai21  g47(.a(new_n31_), .b(new_n52_), .c(new_n71_), .O(new_n72_));
  ...
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n52_), .d(new_n47_), .O(z7));
  nand4  g66(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n77_), .b(new_n34_), .c(x10), .O(new_n93_));
