...
module FAU ( 
  ...
  oai21  g35(.a(new_n55_), .b(x10), .c(x07), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n59_), .O(z4));
  inv1   g37(.a(x12), .O(new_n62_));
  nand4  g38(.a(x13), .b(new_n62_), .c(new_n48_), .d(new_n33_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n49_), .O(new_n64_));
  nand2  g40(.a(new_n48_), .b(x07), .O(new_n65_));
  ...
  nand3  g46(.a(new_n70_), .b(new_n52_), .c(new_n47_), .O(new_n71_));
  ...
  nand2  g52(.a(new_n76_), .b(new_n31_), .O(z6));
  ...
  nand4  g59(.a(new_n62_), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n68_), .b(new_n33_), .c(x10), .O(new_n86_));
