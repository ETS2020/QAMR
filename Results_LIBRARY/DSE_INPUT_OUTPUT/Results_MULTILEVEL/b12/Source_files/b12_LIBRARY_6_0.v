...
module FAU ( 
  ...
  nor3   g13(.a(new_n31_), .b(x02), .c(new_n25_), .O(new_n38_));
  inv1   g14(.a(x02), .O(new_n39_));
  nand2  g15(.a(x06), .b(x01), .O(new_n40_));
  nand2  g16(.a(new_n40_), .b(x05), .O(new_n41_));
  nand2  g17(.a(x10), .b(new_n26_), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(new_n41_), .c(new_n39_), .O(new_n43_));
  ...
  nand4  g24(.a(new_n48_), .b(new_n34_), .c(x09), .d(x05), .O(new_n49_));
  inv1   g25(.a(x08), .O(new_n50_));
  nand3  g26(.a(x10), .b(new_n50_), .c(new_n30_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n49_), .c(x07), .O(new_n52_));
  aoi21  g28(.a(x07), .b(x05), .c(x10), .O(new_n53_));
  nor3   g29(.a(new_n53_), .b(x03), .c(x00), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n52_), .c(new_n25_), .O(new_n55_));
  inv1   g31(.a(new_n31_), .O(new_n56_));
  oai21  g32(.a(x08), .b(x07), .c(x00), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n56_), .c(x02), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n55_), .O(z2));
  inv1   g35(.a(x07), .O(new_n60_));
  inv1   g36(.a(x11), .O(new_n61_));
  inv1   g37(.a(x12), .O(new_n62_));
  oai22  g38(.a(new_n62_), .b(x00), .c(new_n61_), .d(new_n60_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n56_), .O(z3));
  nand3  g40(.a(x09), .b(x08), .c(x00), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n60_), .O(new_n66_));
  nand2  g42(.a(new_n61_), .b(x07), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n56_), .O(z4));
  inv1   g44(.a(x00), .O(new_n69_));
  nand4  g45(.a(x13), .b(new_n62_), .c(new_n60_), .d(new_n69_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x05), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n34_), .O(z5));
  nand2  g48(.a(x09), .b(new_n30_), .O(new_n73_));
  inv1   g49(.a(x09), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x03), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n73_), .c(new_n39_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n48_), .c(new_n25_), .O(new_n77_));
  aoi21  g53(.a(x14), .b(x02), .c(x00), .O(new_n78_));
  nor2   g54(.a(x08), .b(new_n69_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n78_), .c(x01), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n77_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n34_), .c(new_n60_), .d(x05), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(z6));
  nand3  g59(.a(x03), .b(new_n39_), .c(new_n25_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n50_), .O(new_n85_));
  nor2   g61(.a(x07), .b(new_n26_), .O(new_n86_));
  nand4  g62(.a(x09), .b(x03), .c(new_n39_), .d(new_n25_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n34_), .O(z7));
  nand4  g64(.a(new_n62_), .b(x03), .c(new_n39_), .d(new_n25_), .O(new_n89_));
  oai21  g65(.a(x09), .b(x00), .c(new_n60_), .O(new_n90_));
  aoi21  g66(.a(new_n89_), .b(x09), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n26_), .c(new_n34_), .O(z8));
endmodule
