...
module FAU ( 
  ...
  nor2   g23(.a(new_n26_), .b(x03), .O(new_n48_));
  nor2   g24(.a(x10), .b(new_n25_), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n50_));
  nand2  g26(.a(new_n49_), .b(new_n39_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n50_), .c(x07), .O(new_n52_));
  aoi21  g28(.a(x09), .b(x07), .c(x10), .O(new_n53_));
  nor3   g29(.a(new_n53_), .b(x03), .c(x00), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n52_), .c(new_n34_), .O(new_n55_));
  ...
  nor2   g40(.a(x11), .b(new_n64_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n63_), .c(new_n27_), .O(new_n66_));
  nand3  g42(.a(x09), .b(new_n47_), .c(x00), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(new_n68_));
  nor2   g44(.a(new_n26_), .b(x09), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(new_n64_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n66_), .O(z4));
  nand2  g47(.a(new_n27_), .b(x07), .O(new_n72_));
  inv1   g48(.a(x13), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x12), .c(x09), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n26_), .c(x00), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n69_), .c(new_n64_), .O(new_n76_));
  nand2  g52(.a(x09), .b(x00), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n72_), .O(z5));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n43_), .c(new_n34_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(new_n81_));
  nand2  g57(.a(x14), .b(x02), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n39_), .O(new_n83_));
  nand2  g59(.a(new_n47_), .b(x00), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(new_n34_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n81_), .c(new_n64_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(x09), .c(x10), .O(z6));
  nand3  g63(.a(x03), .b(new_n29_), .c(new_n34_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n49_), .c(x08), .d(new_n64_), .O(z7));
  nor2   g65(.a(x07), .b(new_n28_), .O(new_n90_));
  nor2   g66(.a(x02), .b(x01), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n90_), .c(new_n49_), .d(new_n59_), .O(z8));
endmodule
