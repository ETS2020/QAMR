...
module FAU ( 
  ...
  nand4  g31(.a(new_n26_), .b(x09), .c(new_n55_), .d(new_n52_), .O(new_n56_));
  ...
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(x13), .d(new_n52_), .O(z5));
  ...
  nand4  g57(.a(new_n81_), .b(new_n26_), .c(new_n52_), .d(x06), .O(new_n82_));
  ...
  oai21  g63(.a(new_n87_), .b(new_n25_), .c(new_n26_), .O(z7));
  inv1   g64(.a(x12), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n52_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n25_), .c(new_n26_), .O(z8));
endmodule
