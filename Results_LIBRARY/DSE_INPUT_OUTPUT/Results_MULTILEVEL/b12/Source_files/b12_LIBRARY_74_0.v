...
module FAU ( 
  ...
  nor2   g09(.a(new_n33_), .b(new_n30_), .O(new_n34_));
  oai21  g10(.a(new_n34_), .b(new_n29_), .c(x02), .O(new_n35_));
  oai21  g11(.a(new_n31_), .b(x02), .c(new_n26_), .O(new_n36_));
  ...
  nand2  g22(.a(new_n46_), .b(new_n32_), .O(z1));
  ...
  oai22  g41(.a(new_n65_), .b(new_n39_), .c(x10), .d(x05), .O(new_n66_));
  inv1   g42(.a(x11), .O(new_n67_));
  nand3  g43(.a(new_n32_), .b(new_n67_), .c(x07), .O(new_n68_));
  oai21  g44(.a(new_n66_), .b(x07), .c(new_n68_), .O(z4));
  inv1   g45(.a(x12), .O(new_n70_));
  nand4  g46(.a(x13), .b(new_n70_), .c(new_n53_), .d(new_n39_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x05), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n31_), .O(z5));
  ...
  nand3  g53(.a(new_n77_), .b(new_n75_), .c(new_n43_), .O(new_n78_));
  ...
  nand3  g61(.a(x03), .b(new_n43_), .c(new_n25_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n56_), .O(new_n87_));
  nor2   g63(.a(x07), .b(new_n26_), .O(new_n88_));
  nand4  g64(.a(x09), .b(x03), .c(new_n43_), .d(new_n25_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(new_n31_), .O(z7));
  nand4  g66(.a(new_n70_), .b(x03), .c(new_n43_), .d(new_n25_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n76_), .b(new_n39_), .c(x10), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n88_), .O(z8));
endmodule
