...
module FAU ( 
  ...
  nand2  g42(.a(new_n53_), .b(x10), .O(new_n67_));
  nand4  g43(.a(x13), .b(new_n53_), .c(new_n46_), .d(new_n33_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n51_), .O(new_n69_));
  ...
  nand3  g51(.a(new_n75_), .b(new_n71_), .c(new_n34_), .O(new_n76_));
  aoi21  g52(.a(x14), .b(x02), .c(x00), .O(new_n77_));
  nor2   g53(.a(x08), .b(new_n33_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n77_), .c(x01), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n51_), .c(new_n46_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n31_), .O(z6));
  oai21  g58(.a(new_n40_), .b(x01), .c(new_n47_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n46_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n51_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n67_), .O(z7));
  nand4  g63(.a(new_n53_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n46_), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x10), .c(new_n67_), .O(z8));
endmodule
