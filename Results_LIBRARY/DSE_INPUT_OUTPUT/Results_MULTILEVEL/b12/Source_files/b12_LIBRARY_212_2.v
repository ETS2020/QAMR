...
module FAU ( 
  ...
  aoi21  g59(.a(new_n31_), .b(x12), .c(x10), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n50_), .O(z7));
  ...
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n50_), .O(z8));
endmodule
