...
module FAU ( 
  ...
  oai21  g22(.a(new_n46_), .b(new_n38_), .c(x02), .O(new_n47_));
  oai21  g23(.a(x08), .b(x07), .c(new_n38_), .O(new_n48_));
  ...
  nand3  g28(.a(new_n25_), .b(x09), .c(new_n49_), .O(new_n53_));
  ...
  oai21  g36(.a(x08), .b(new_n49_), .c(new_n25_), .O(new_n61_));
  ...
  oai21  g47(.a(new_n71_), .b(x02), .c(new_n33_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n25_), .c(new_n50_), .d(new_n49_), .O(new_n74_));
