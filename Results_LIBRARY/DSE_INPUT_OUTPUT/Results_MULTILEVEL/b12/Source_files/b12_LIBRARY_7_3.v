...
module FAU ( 
  ...
  oai21  g40(.a(x10), .b(new_n54_), .c(new_n64_), .O(z5));
  ...
  nand3  g50(.a(new_n74_), .b(new_n45_), .c(new_n54_), .O(new_n75_));
  ...
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n45_), .d(new_n54_), .O(z7));
  nand4  g57(.a(new_n56_), .b(x03), .c(new_n25_), .d(new_n49_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n67_), .b(new_n33_), .c(x10), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n54_), .O(z8));
endmodule
