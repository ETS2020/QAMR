...
module FAU ( 
  ...
  nand2  g36(.a(new_n60_), .b(new_n50_), .O(new_n61_));
  nand3  g37(.a(new_n56_), .b(new_n49_), .c(x07), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n61_), .O(z4));
  nand4  g39(.a(x13), .b(new_n57_), .c(new_n49_), .d(new_n37_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n50_), .O(new_n65_));
  nand2  g41(.a(new_n49_), .b(x07), .O(new_n66_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n53_), .c(new_n32_), .O(new_n72_));
  ...
  nand3  g52(.a(new_n76_), .b(new_n49_), .c(new_n50_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n25_), .O(z6));
  inv1   g54(.a(x08), .O(new_n79_));
  oai21  g55(.a(new_n41_), .b(x01), .c(new_n79_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n49_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n50_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n66_), .O(z7));
  nand4  g60(.a(new_n57_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n49_), .O(new_n86_));
