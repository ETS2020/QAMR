...
module FAU ( 
  ...
  nand3  g35(.a(new_n27_), .b(new_n56_), .c(x07), .O(new_n60_));
  aoi21  g36(.a(x09), .b(x00), .c(new_n25_), .O(new_n61_));
  nor2   g37(.a(new_n26_), .b(x08), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n61_), .c(new_n51_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n60_), .O(z4));
  nor2   g40(.a(x12), .b(x10), .O(new_n65_));
  nor2   g41(.a(x07), .b(x00), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(x13), .d(x08), .O(z5));
  ...
  nand3  g48(.a(new_n72_), .b(new_n51_), .c(new_n39_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(x08), .c(x10), .O(z6));
  nor2   g50(.a(x02), .b(x01), .O(new_n75_));
  and2   g51(.a(x09), .b(x03), .O(new_n76_));
