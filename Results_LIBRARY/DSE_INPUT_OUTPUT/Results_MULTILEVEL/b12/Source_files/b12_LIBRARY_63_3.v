...
module FAU ( 
  ...
  aoi21  g34(.a(new_n50_), .b(new_n49_), .c(new_n58_), .O(new_n59_));
  aoi21  g35(.a(x12), .b(new_n33_), .c(new_n59_), .O(z3));
  nand3  g36(.a(x09), .b(x08), .c(x00), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(new_n62_));
  oai22  g38(.a(new_n62_), .b(new_n59_), .c(x11), .d(new_n49_), .O(z4));
  inv1   g39(.a(x12), .O(new_n64_));
  nor2   g40(.a(x07), .b(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n64_), .d(new_n50_), .O(z5));
  ...
  nand3  g47(.a(new_n71_), .b(new_n67_), .c(new_n44_), .O(new_n72_));
  aoi21  g48(.a(x14), .b(x02), .c(x00), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n33_), .O(new_n74_));
  ...
  nand2  g53(.a(new_n77_), .b(new_n31_), .O(z6));
  nand3  g54(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n49_), .O(new_n81_));
  aoi21  g57(.a(new_n79_), .b(new_n53_), .c(new_n81_), .O(new_n82_));
  nand2  g58(.a(new_n58_), .b(x10), .O(new_n83_));
  oai21  g59(.a(new_n82_), .b(x10), .c(new_n83_), .O(z7));
  nand4  g60(.a(new_n64_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n69_), .b(new_n33_), .c(x10), .O(new_n87_));
