...
module FAU ( 
  ...
  nand2  g41(.a(x14), .b(new_n55_), .O(new_n66_));
  ...
  nand3  g45(.a(new_n26_), .b(new_n60_), .c(x07), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(z4));
  aoi21  g47(.a(x14), .b(new_n51_), .c(x08), .O(new_n72_));
  nand3  g48(.a(x13), .b(new_n61_), .c(new_n52_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n38_), .c(x07), .O(new_n74_));
  oai22  g50(.a(new_n74_), .b(new_n25_), .c(new_n72_), .d(new_n38_), .O(z5));
  oai21  g51(.a(new_n55_), .b(x00), .c(new_n66_), .O(new_n76_));
  nand2  g52(.a(x09), .b(new_n27_), .O(new_n77_));
  nand2  g53(.a(new_n64_), .b(x03), .O(new_n78_));
