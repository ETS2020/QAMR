...
module FAU ( 
  ...
  oai22  g33(.a(new_n57_), .b(x00), .c(new_n56_), .d(new_n45_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n34_), .O(z3));
  nand3  g35(.a(x09), .b(x08), .c(x00), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n45_), .O(new_n61_));
  nand3  g37(.a(new_n56_), .b(x10), .c(x07), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n61_), .O(z4));
  oai21  g39(.a(x07), .b(new_n36_), .c(x10), .O(new_n64_));
  nand3  g40(.a(x13), .b(new_n57_), .c(new_n36_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n45_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n64_), .O(z5));
