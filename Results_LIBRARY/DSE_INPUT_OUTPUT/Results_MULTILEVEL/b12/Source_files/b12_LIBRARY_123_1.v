...
module FAU ( 
  ...
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n59_), .d(new_n31_), .O(z5));
  ...
  nand4  g53(.a(new_n77_), .b(new_n59_), .c(new_n31_), .d(new_n50_), .O(new_n78_));
