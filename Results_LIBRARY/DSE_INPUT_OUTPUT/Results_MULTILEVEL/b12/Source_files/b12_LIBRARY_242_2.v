...
module FAU ( 
  ...
  oai22  g39(.a(new_n63_), .b(new_n34_), .c(x12), .d(new_n52_), .O(new_n64_));
  nand3  g40(.a(new_n32_), .b(new_n60_), .c(x07), .O(new_n65_));
  oai21  g41(.a(new_n64_), .b(x07), .c(new_n65_), .O(z4));
  nand3  g42(.a(x13), .b(new_n47_), .c(new_n34_), .O(new_n67_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n52_), .c(new_n47_), .O(new_n80_));
  ...
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n52_), .d(new_n47_), .O(z7));
  oai21  g61(.a(x10), .b(x09), .c(x12), .O(new_n86_));
  oai21  g62(.a(x09), .b(x00), .c(new_n47_), .O(new_n87_));
  aoi21  g63(.a(new_n82_), .b(x09), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x10), .c(new_n86_), .O(z8));
endmodule
