...
module FAU ( 
  ...
  nand3  g19(.a(x10), .b(new_n35_), .c(new_n25_), .O(new_n44_));
  ...
  nand4  g27(.a(new_n49_), .b(x09), .c(new_n30_), .d(new_n48_), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n51_), .c(new_n25_), .O(new_n54_));
  inv1   g30(.a(x00), .O(new_n55_));
  nand2  g31(.a(new_n30_), .b(new_n55_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n54_), .c(new_n46_), .O(z2));
  ...
  oai21  g37(.a(new_n30_), .b(new_n48_), .c(new_n55_), .O(new_n62_));
  oai21  g38(.a(x09), .b(new_n55_), .c(x08), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n48_), .O(new_n64_));
  nand2  g40(.a(new_n58_), .b(x07), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n62_), .O(z4));
  nand3  g42(.a(x13), .b(new_n59_), .c(new_n49_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(x08), .c(new_n48_), .d(new_n55_), .O(z5));
  oai21  g45(.a(x01), .b(x00), .c(x08), .O(new_n70_));
  xor2a  g46(.a(x09), .b(x03), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x02), .c(new_n70_), .O(new_n72_));
  aoi21  g48(.a(x14), .b(x02), .c(x00), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n30_), .c(x01), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n49_), .c(new_n48_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n56_), .O(z6));
  oai21  g53(.a(x10), .b(x07), .c(new_n56_), .O(new_n78_));
  nand4  g54(.a(x08), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n79_));
  oai21  g55(.a(x08), .b(new_n55_), .c(new_n79_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x09), .O(new_n81_));
  nand2  g57(.a(new_n40_), .b(new_n25_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n30_), .c(x00), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n81_), .c(new_n78_), .O(z7));
  nand2  g60(.a(x09), .b(x00), .O(new_n85_));
  oai21  g61(.a(new_n30_), .b(x00), .c(new_n85_), .O(new_n86_));
  nand4  g62(.a(new_n59_), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  inv1   g64(.a(x09), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(x08), .c(new_n55_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n88_), .c(new_n78_), .O(z8));
endmodule
