...
module FAU ( 
  ...
  oai21  g22(.a(new_n43_), .b(new_n33_), .c(new_n46_), .O(new_n47_));
  nand3  g23(.a(x07), .b(new_n34_), .c(new_n33_), .O(new_n48_));
  inv1   g24(.a(x10), .O(new_n49_));
  nand3  g25(.a(new_n49_), .b(x09), .c(new_n43_), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n44_), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(new_n47_), .c(new_n31_), .O(z2));
  ...
  and2   g33(.a(new_n55_), .b(new_n31_), .O(z4));
  nor2   g34(.a(x07), .b(x00), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(x13), .c(new_n54_), .d(new_n49_), .O(z5));
  ...
  nand3  g40(.a(new_n64_), .b(new_n31_), .c(new_n44_), .O(new_n65_));
  aoi21  g41(.a(x14), .b(x02), .c(x00), .O(new_n66_));
  nor2   g42(.a(x08), .b(new_n33_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n66_), .c(x01), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n65_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n49_), .c(new_n43_), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(z6));
  nand3  g47(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x08), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x09), .O(new_n74_));
  inv1   g50(.a(x08), .O(new_n75_));
  nand3  g51(.a(new_n31_), .b(new_n49_), .c(new_n43_), .O(new_n76_));
  aoi21  g52(.a(new_n72_), .b(new_n75_), .c(new_n76_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(z7));
  oai21  g54(.a(new_n62_), .b(x00), .c(x08), .O(new_n79_));
  nand4  g55(.a(new_n54_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x09), .O(new_n81_));
  aoi21  g57(.a(new_n62_), .b(new_n33_), .c(x10), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n79_), .d(new_n43_), .O(z8));
endmodule
