...
module FAU ( 
  ...
  nor2   g39(.a(new_n25_), .b(x07), .O(new_n64_));
  nor2   g40(.a(x11), .b(new_n38_), .O(new_n65_));
  oai22  g41(.a(new_n65_), .b(new_n64_), .c(new_n63_), .d(new_n54_), .O(new_n66_));
  oai21  g42(.a(new_n64_), .b(new_n59_), .c(new_n38_), .O(new_n67_));
  nand2  g43(.a(new_n59_), .b(x07), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(z4));
  nand4  g45(.a(x13), .b(new_n60_), .c(new_n51_), .d(new_n38_), .O(new_n70_));
  ...
  aoi21  g58(.a(new_n82_), .b(new_n59_), .c(x10), .O(z6));
  ...
  nand2  g62(.a(new_n86_), .b(new_n59_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n25_), .O(z7));
  nand4  g64(.a(new_n60_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n63_), .b(new_n38_), .c(x07), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n90_), .c(new_n59_), .d(new_n25_), .O(z8));
endmodule
