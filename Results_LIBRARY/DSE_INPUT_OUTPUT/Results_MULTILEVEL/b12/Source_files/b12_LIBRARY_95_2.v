...
module FAU ( 
  ...
  nand3  g29(.a(x11), .b(x10), .c(new_n36_), .O(new_n54_));
  ...
  nand2  g35(.a(x11), .b(new_n47_), .O(new_n60_));
  nand2  g36(.a(new_n31_), .b(new_n52_), .O(new_n61_));
  aoi22  g37(.a(new_n61_), .b(new_n60_), .c(x12), .d(new_n34_), .O(z3));
  oai21  g38(.a(x10), .b(x07), .c(new_n31_), .O(new_n63_));
  nand3  g39(.a(x09), .b(x08), .c(x00), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n47_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n63_), .O(z4));
  nand2  g42(.a(x11), .b(x10), .O(new_n67_));
  inv1   g43(.a(x12), .O(new_n68_));
  nand4  g44(.a(x13), .b(new_n68_), .c(new_n47_), .d(new_n34_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n52_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n67_), .O(z5));
  ...
  nor2   g54(.a(x08), .b(new_n34_), .O(new_n79_));
  ...
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n47_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n52_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n67_), .O(z7));
  ...
  oai21  g67(.a(new_n91_), .b(x10), .c(new_n67_), .O(z8));
endmodule
