...
module FAU ( 
  ...
  nand2  g37(.a(new_n61_), .b(new_n25_), .O(z3));
  oai21  g38(.a(new_n59_), .b(x10), .c(x07), .O(new_n63_));
  nand3  g39(.a(x09), .b(x08), .c(x00), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n50_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n25_), .O(z4));
  ...
  nand3  g56(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n81_));
  ...
  nand2  g60(.a(new_n59_), .b(x10), .O(new_n85_));
  oai21  g61(.a(new_n84_), .b(x10), .c(new_n85_), .O(z7));
  nand4  g62(.a(new_n60_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n71_), .b(new_n37_), .c(x10), .O(new_n89_));
