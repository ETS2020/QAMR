...
module FAU ( 
  ...
  oai21  g47(.a(new_n25_), .b(new_n52_), .c(new_n71_), .O(z5));
  ...
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n52_), .d(new_n51_), .O(z7));
  nand4  g64(.a(new_n69_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n75_), .b(new_n38_), .c(x10), .O(new_n91_));
