...
module FAU ( 
  ...
  oai22  g36(.a(new_n60_), .b(x00), .c(new_n25_), .d(new_n51_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n26_), .O(z3));
  nand2  g38(.a(x09), .b(x08), .O(new_n63_));
  oai22  g39(.a(new_n63_), .b(new_n38_), .c(x11), .d(new_n52_), .O(new_n64_));
  nand3  g40(.a(new_n25_), .b(new_n52_), .c(x07), .O(new_n65_));
  oai21  g41(.a(new_n64_), .b(x07), .c(new_n65_), .O(z4));
  nor2   g42(.a(x10), .b(x07), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x11), .c(x00), .O(new_n68_));
  oai21  g44(.a(x11), .b(new_n52_), .c(x07), .O(new_n69_));
  nand2  g45(.a(x11), .b(x10), .O(new_n70_));
  inv1   g46(.a(x13), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x12), .c(new_n52_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n51_), .c(new_n38_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n69_), .c(new_n68_), .O(z5));
  ...
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n28_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n76_), .c(new_n33_), .O(new_n81_));
  ...
  oai21  g63(.a(new_n42_), .b(x01), .c(new_n55_), .O(new_n88_));
  nand4  g64(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n51_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n52_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n70_), .O(z7));
  nand4  g68(.a(new_n60_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n78_), .b(new_n38_), .c(x10), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n94_), .c(new_n51_), .O(z8));
endmodule
