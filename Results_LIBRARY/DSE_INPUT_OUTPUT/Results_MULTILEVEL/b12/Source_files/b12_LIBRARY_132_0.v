...
module FAU ( 
  ...
  nand4  g55(.a(new_n79_), .b(x13), .c(new_n31_), .d(new_n51_), .O(new_n80_));
  ...
  oai21  g61(.a(new_n85_), .b(new_n32_), .c(new_n31_), .O(z7));
  inv1   g62(.a(x12), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n72_), .b(new_n35_), .c(x07), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(x13), .d(new_n31_), .O(z8));
endmodule
