...
module FAU ( 
  ...
  nand3  g23(.a(x12), .b(new_n31_), .c(x09), .O(new_n48_));
  nand2  g24(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n46_), .O(new_n50_));
  nor2   g26(.a(new_n32_), .b(x10), .O(new_n51_));
  nand3  g27(.a(new_n51_), .b(x09), .c(new_n35_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n50_), .c(x07), .O(new_n53_));
  aoi21  g29(.a(x12), .b(x07), .c(x10), .O(new_n54_));
  ...
  nand3  g33(.a(new_n57_), .b(new_n33_), .c(x02), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n56_), .O(z2));
  inv1   g35(.a(x07), .O(new_n60_));
  inv1   g36(.a(x11), .O(new_n61_));
  oai22  g37(.a(new_n32_), .b(x00), .c(new_n61_), .d(new_n60_), .O(new_n62_));
  ...
  nand3  g48(.a(new_n73_), .b(new_n69_), .c(new_n45_), .O(new_n74_));
  aoi21  g49(.a(x14), .b(x02), .c(x00), .O(new_n75_));
  nor2   g50(.a(x08), .b(new_n35_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(new_n75_), .c(x01), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(x12), .c(new_n31_), .d(new_n60_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z6));
  nand3  g55(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n81_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n60_), .O(new_n83_));
  aoi21  g58(.a(new_n81_), .b(new_n46_), .c(new_n83_), .O(new_n84_));
  oai21  g59(.a(new_n84_), .b(new_n32_), .c(new_n31_), .O(z7));
  nand4  g60(.a(new_n51_), .b(new_n71_), .c(new_n60_), .d(x00), .O(z8));
  one    g61(.O(z5));
endmodule
