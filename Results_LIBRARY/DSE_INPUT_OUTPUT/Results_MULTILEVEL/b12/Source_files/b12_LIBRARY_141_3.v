...
module FAU ( 
  ...
  nor2   g39(.a(x11), .b(new_n51_), .O(new_n64_));
  ...
  nand2  g44(.a(new_n59_), .b(x07), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n65_), .O(z4));
  oai21  g46(.a(x07), .b(x00), .c(new_n25_), .O(new_n71_));
  aoi21  g47(.a(x13), .b(new_n60_), .c(x10), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n50_), .c(new_n64_), .O(new_n73_));
  ...
  inv1   g62(.a(new_n64_), .O(new_n87_));
  oai21  g63(.a(new_n41_), .b(x01), .c(new_n54_), .O(new_n88_));
  nand4  g64(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n50_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n51_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n87_), .O(z7));
  nand4  g68(.a(new_n60_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n93_));
