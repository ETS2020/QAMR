...
module FAU ( 
  ...
  inv1   g45(.a(new_n26_), .O(new_n70_));
  inv1   g46(.a(x12), .O(new_n71_));
  nand3  g47(.a(x13), .b(new_n71_), .c(new_n52_), .O(new_n72_));
  nor3   g48(.a(new_n72_), .b(x07), .c(x00), .O(new_n73_));
  nor2   g49(.a(new_n73_), .b(new_n70_), .O(z5));
  oai21  g50(.a(new_n25_), .b(x00), .c(x08), .O(new_n75_));
  nand2  g51(.a(x09), .b(new_n27_), .O(new_n76_));
  inv1   g52(.a(x09), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x03), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n28_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n75_), .c(new_n33_), .O(new_n80_));
  aoi21  g56(.a(x14), .b(new_n38_), .c(x08), .O(new_n81_));
  nand3  g57(.a(x14), .b(new_n28_), .c(new_n38_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n81_), .c(x01), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n80_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n52_), .c(new_n51_), .O(new_n86_));
  inv1   g62(.a(new_n86_), .O(z6));
  oai21  g63(.a(x10), .b(x07), .c(new_n26_), .O(new_n88_));
  nand4  g64(.a(x14), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x08), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  oai21  g67(.a(new_n42_), .b(x01), .c(new_n55_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n91_), .c(new_n88_), .O(z7));
  ...
  aoi21  g73(.a(new_n97_), .b(new_n95_), .c(new_n70_), .O(z8));
endmodule
