...
module FAU ( 
  ...
  nand2  g00(.a(x12), .b(x08), .O(new_n25_));
  ...
  nand3  g27(.a(new_n51_), .b(new_n48_), .c(new_n32_), .O(new_n52_));
  ...
  nand2  g33(.a(new_n57_), .b(new_n32_), .O(new_n58_));
  ...
  oai22  g38(.a(new_n48_), .b(x00), .c(new_n62_), .d(new_n55_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n25_), .O(z3));
  oai21  g40(.a(x12), .b(x09), .c(x08), .O(new_n65_));
  nand2  g41(.a(x12), .b(new_n56_), .O(new_n66_));
  oai21  g42(.a(x12), .b(x00), .c(new_n66_), .O(new_n67_));
  aoi21  g43(.a(new_n65_), .b(x00), .c(new_n67_), .O(new_n68_));
  nand3  g44(.a(new_n25_), .b(new_n62_), .c(x07), .O(new_n69_));
  oai21  g45(.a(new_n68_), .b(x07), .c(new_n69_), .O(z4));
  oai21  g46(.a(x08), .b(x07), .c(x12), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x00), .O(new_n72_));
  nand2  g48(.a(x13), .b(new_n49_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n48_), .c(new_n37_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n66_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n55_), .O(new_n76_));
  nand2  g52(.a(new_n25_), .b(x07), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n72_), .O(z5));
  aoi21  g54(.a(new_n48_), .b(new_n37_), .c(new_n56_), .O(new_n79_));
  nand2  g55(.a(x14), .b(x02), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x01), .O(new_n81_));
  xor2a  g57(.a(x09), .b(x03), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x02), .c(new_n32_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n81_), .c(new_n79_), .O(new_n84_));
  nand3  g60(.a(new_n56_), .b(x01), .c(x00), .O(new_n85_));
  inv1   g61(.a(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n84_), .c(new_n49_), .O(new_n87_));
  nor2   g63(.a(new_n87_), .b(x07), .O(z6));
  oai21  g64(.a(x10), .b(x07), .c(new_n25_), .O(new_n89_));
  nand4  g65(.a(new_n48_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x08), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  nand3  g68(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n56_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n92_), .c(new_n89_), .O(z7));
  oai21  g71(.a(x09), .b(x08), .c(x12), .O(new_n96_));
  nand2  g72(.a(new_n93_), .b(x09), .O(new_n97_));
  inv1   g73(.a(x09), .O(new_n98_));
  aoi21  g74(.a(new_n98_), .b(new_n37_), .c(x10), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(new_n97_), .c(new_n96_), .d(new_n55_), .O(z8));
endmodule
