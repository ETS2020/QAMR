...
module FAU ( 
  ...
  nand4  g44(.a(new_n68_), .b(new_n33_), .c(new_n58_), .d(new_n36_), .O(z5));
  ...
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n33_), .d(new_n58_), .O(z7));
  nand4  g61(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n72_), .b(new_n36_), .c(x10), .O(new_n88_));
