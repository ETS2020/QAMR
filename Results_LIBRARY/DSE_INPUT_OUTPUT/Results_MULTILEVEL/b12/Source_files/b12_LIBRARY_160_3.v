...
module FAU ( 
  ...
  oai21  g34(.a(x10), .b(x07), .c(x11), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  aoi21  g36(.a(x12), .b(new_n37_), .c(new_n60_), .O(z3));
  nor2   g37(.a(x10), .b(x07), .O(new_n62_));
  nor2   g38(.a(x11), .b(new_n51_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n62_), .c(new_n37_), .O(new_n64_));
  nand2  g40(.a(x09), .b(x08), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n59_), .c(x00), .O(new_n66_));
  inv1   g42(.a(x11), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x07), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n66_), .c(new_n64_), .O(z4));
  oai21  g45(.a(x07), .b(x00), .c(new_n25_), .O(new_n70_));
  inv1   g46(.a(x12), .O(new_n71_));
  aoi21  g47(.a(x13), .b(new_n71_), .c(x10), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n50_), .c(new_n63_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x00), .c(new_n70_), .O(z5));
  ...
  nand3  g62(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n54_), .O(new_n88_));
  nand4  g64(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n51_), .d(new_n50_), .O(z7));
  inv1   g66(.a(new_n63_), .O(new_n91_));
  nand4  g67(.a(new_n71_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n92_));
  oai21  g68(.a(x09), .b(x00), .c(new_n50_), .O(new_n93_));
  aoi21  g69(.a(new_n92_), .b(x09), .c(new_n93_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x10), .c(new_n91_), .O(z8));
endmodule
