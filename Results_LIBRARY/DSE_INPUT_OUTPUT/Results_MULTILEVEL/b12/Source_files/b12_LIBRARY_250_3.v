...
module FAU ( 
  ...
  aoi22  g20(.a(new_n44_), .b(new_n25_), .c(x10), .d(x08), .O(new_n45_));
  inv1   g21(.a(x07), .O(new_n46_));
  inv1   g22(.a(x10), .O(new_n47_));
  nand4  g23(.a(new_n47_), .b(x09), .c(new_n46_), .d(new_n43_), .O(new_n48_));
  inv1   g24(.a(new_n48_), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n45_), .c(new_n33_), .O(new_n50_));
  inv1   g26(.a(x08), .O(new_n51_));
  nand2  g27(.a(new_n47_), .b(x09), .O(new_n52_));
  ...
  oai21  g31(.a(new_n55_), .b(x07), .c(new_n50_), .O(z2));
  ...
  nand3  g49(.a(new_n73_), .b(new_n69_), .c(new_n43_), .O(new_n74_));
  ...
  nand3  g54(.a(new_n78_), .b(new_n47_), .c(new_n46_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n31_), .O(z6));
  nand3  g56(.a(x03), .b(new_n25_), .c(new_n43_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n51_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n47_), .d(new_n46_), .O(z7));
  nand4  g60(.a(new_n66_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n71_), .b(new_n33_), .c(x10), .O(new_n87_));
