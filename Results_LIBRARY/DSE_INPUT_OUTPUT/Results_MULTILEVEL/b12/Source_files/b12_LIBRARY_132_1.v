...
module FAU ( 
  ...
  nand3  g35(.a(new_n59_), .b(new_n58_), .c(z5), .O(new_n60_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(z5), .O(z4));
  ...
  nand4  g53(.a(new_n77_), .b(new_n67_), .c(new_n31_), .d(new_n50_), .O(new_n78_));
  ...
  aoi21  g58(.a(new_n80_), .b(new_n53_), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x13), .c(new_n31_), .O(z7));
  inv1   g60(.a(x12), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n70_), .b(new_n34_), .c(x07), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n67_), .d(new_n31_), .O(z8));
endmodule
