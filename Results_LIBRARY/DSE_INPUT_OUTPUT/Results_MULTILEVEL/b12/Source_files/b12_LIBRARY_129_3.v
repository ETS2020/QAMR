...
module FAU ( 
  ...
  nand4  g42(.a(new_n66_), .b(new_n47_), .c(new_n55_), .d(new_n37_), .O(z5));
  ...
  nand2  g59(.a(new_n47_), .b(x07), .O(new_n84_));
  oai21  g60(.a(new_n83_), .b(x07), .c(new_n84_), .O(z7));
  nand4  g61(.a(new_n57_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n86_));
  oai21  g62(.a(x09), .b(x00), .c(new_n47_), .O(new_n87_));
  aoi21  g63(.a(new_n86_), .b(x09), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x07), .c(new_n84_), .O(z8));
endmodule
