// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:50 2020
...
module FAU ( 
  ...
  oai22  g37(.a(new_n54_), .b(x00), .c(new_n61_), .d(new_n47_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n25_), .O(z3));
  nand2  g39(.a(x09), .b(x08), .O(new_n64_));
  oai22  g40(.a(new_n64_), .b(new_n37_), .c(new_n54_), .d(new_n52_), .O(new_n65_));
  nand3  g41(.a(new_n25_), .b(new_n61_), .c(x07), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x07), .c(new_n66_), .O(z4));
  oai21  g43(.a(x07), .b(x00), .c(new_n25_), .O(new_n68_));
  nand2  g44(.a(new_n54_), .b(x10), .O(new_n69_));
  inv1   g45(.a(x13), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x12), .c(new_n52_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n47_), .c(new_n37_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n68_), .O(z5));
  ...
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n27_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n75_), .c(new_n32_), .O(new_n80_));
  aoi21  g56(.a(x14), .b(x02), .c(x00), .O(new_n81_));
  nor2   g57(.a(x08), .b(new_n37_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n81_), .c(x01), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n80_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n52_), .c(new_n47_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n25_), .O(z6));
  oai21  g62(.a(new_n41_), .b(x01), .c(new_n48_), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n47_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n52_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n69_), .O(z7));
  nand4  g67(.a(new_n54_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n92_));
  oai21  g68(.a(x09), .b(x00), .c(new_n47_), .O(new_n93_));
  aoi21  g69(.a(new_n92_), .b(x09), .c(new_n93_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x10), .c(new_n69_), .O(z8));
endmodule
