...
module FAU ( 
  ...
  oai22  g27(.a(new_n51_), .b(x00), .c(new_n50_), .d(new_n43_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n34_), .O(z3));
  oai21  g29(.a(new_n43_), .b(x00), .c(new_n33_), .O(new_n54_));
  inv1   g30(.a(x00), .O(new_n55_));
  inv1   g31(.a(x09), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n55_), .c(new_n43_), .O(new_n57_));
  nand2  g33(.a(new_n50_), .b(x07), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n57_), .c(new_n54_), .O(z4));
  nand4  g35(.a(x13), .b(new_n51_), .c(new_n44_), .d(new_n43_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n55_), .O(new_n61_));
  oai21  g37(.a(new_n33_), .b(new_n55_), .c(new_n61_), .O(z5));
  nand2  g38(.a(x14), .b(x02), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(x01), .O(new_n64_));
  xor2a  g40(.a(x09), .b(x03), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x02), .c(new_n42_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n44_), .c(new_n43_), .d(new_n55_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n34_), .O(z6));
  nand4  g45(.a(x03), .b(new_n25_), .c(new_n42_), .d(new_n55_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n33_), .O(new_n71_));
  nor2   g47(.a(x02), .b(x01), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(x09), .c(x03), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n71_), .c(new_n44_), .d(new_n43_), .O(z7));
  oai21  g50(.a(new_n56_), .b(x00), .c(new_n33_), .O(new_n75_));
  nand3  g51(.a(new_n72_), .b(new_n51_), .c(x03), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x09), .O(new_n77_));
  aoi21  g53(.a(new_n56_), .b(new_n55_), .c(x10), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n75_), .d(new_n43_), .O(z8));
endmodule
