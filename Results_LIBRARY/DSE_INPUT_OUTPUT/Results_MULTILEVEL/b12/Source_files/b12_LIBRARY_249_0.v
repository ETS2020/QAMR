...
module FAU ( 
  ...
  nand3  g24(.a(x11), .b(new_n25_), .c(x09), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n48_), .c(x08), .O(new_n50_));
  nand4  g26(.a(x11), .b(new_n25_), .c(x09), .d(new_n39_), .O(new_n51_));
  ...
  nand3  g31(.a(new_n55_), .b(new_n28_), .c(new_n39_), .O(new_n56_));
  ...
  oai21  g38(.a(new_n62_), .b(x00), .c(new_n54_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n27_), .O(z3));
  oai21  g40(.a(new_n25_), .b(x07), .c(new_n26_), .O(new_n65_));
  nand3  g41(.a(x09), .b(x08), .c(x00), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n47_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n65_), .O(z4));
  nand4  g44(.a(x13), .b(new_n62_), .c(new_n47_), .d(new_n39_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x11), .O(new_n70_));
  ...
  nand3  g60(.a(x03), .b(new_n29_), .c(new_n34_), .O(new_n85_));
  nand4  g61(.a(x09), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n47_), .O(new_n87_));
  aoi21  g63(.a(new_n85_), .b(new_n84_), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n26_), .c(new_n25_), .O(z7));
  nand4  g65(.a(new_n62_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  aoi21  g67(.a(new_n74_), .b(new_n39_), .c(x07), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(x11), .d(new_n25_), .O(z8));
endmodule
