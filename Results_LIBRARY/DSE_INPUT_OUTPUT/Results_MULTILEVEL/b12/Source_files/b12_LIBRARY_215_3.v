...
module FAU ( 
  ...
  nand2  g06(.a(x14), .b(x08), .O(new_n31_));
  ...
  oai21  g43(.a(x08), .b(new_n49_), .c(x14), .O(new_n68_));
  ...
  nand4  g50(.a(new_n74_), .b(new_n31_), .c(new_n49_), .d(new_n33_), .O(z5));
  ...
  nand3  g55(.a(new_n79_), .b(new_n76_), .c(new_n43_), .O(new_n80_));
  ...
  oai21  g62(.a(x10), .b(x07), .c(new_n31_), .O(new_n87_));
  nand4  g63(.a(new_n47_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x08), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  nand3  g66(.a(x03), .b(new_n25_), .c(new_n43_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n56_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n90_), .c(new_n87_), .O(z7));
  nand4  g69(.a(new_n65_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  aoi21  g71(.a(new_n58_), .b(new_n33_), .c(x07), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n95_), .c(new_n31_), .d(new_n50_), .O(z8));
endmodule
