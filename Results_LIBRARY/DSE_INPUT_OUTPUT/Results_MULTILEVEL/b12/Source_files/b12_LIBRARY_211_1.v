...
module FAU ( 
  ...
  nand3  g21(.a(new_n45_), .b(new_n36_), .c(x02), .O(new_n46_));
  ...
  nor2   g26(.a(new_n49_), .b(x07), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n50_), .c(new_n25_), .O(new_n52_));
  inv1   g28(.a(x08), .O(new_n53_));
  nand3  g29(.a(x09), .b(new_n53_), .c(new_n48_), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n52_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n47_), .c(new_n31_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n46_), .O(z2));
  inv1   g33(.a(x11), .O(new_n58_));
  inv1   g34(.a(x12), .O(new_n59_));
  oai22  g35(.a(new_n59_), .b(x00), .c(new_n58_), .d(new_n48_), .O(new_n60_));
  ...
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n36_), .O(z4));
  nand4  g41(.a(x13), .b(new_n59_), .c(new_n48_), .d(new_n25_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n47_), .O(new_n67_));
  nand2  g43(.a(x10), .b(x03), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(z5));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  aoi21  g46(.a(new_n49_), .b(x03), .c(x02), .O(new_n71_));
  nand2  g47(.a(x09), .b(new_n35_), .O(new_n72_));
  oai21  g48(.a(new_n71_), .b(x10), .c(new_n72_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n70_), .c(new_n31_), .O(new_n74_));
  nand2  g50(.a(x14), .b(x02), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n25_), .O(new_n76_));
  oai21  g52(.a(x08), .b(new_n25_), .c(new_n76_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n47_), .c(x01), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n74_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n48_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n36_), .O(z6));
  nand3  g57(.a(x03), .b(new_n26_), .c(new_n31_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n53_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n26_), .d(new_n31_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n47_), .d(new_n48_), .O(z7));
  nand4  g61(.a(new_n59_), .b(x03), .c(new_n26_), .d(new_n31_), .O(new_n86_));
  oai21  g62(.a(x09), .b(x00), .c(new_n48_), .O(new_n87_));
  aoi21  g63(.a(new_n86_), .b(x09), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x10), .c(new_n68_), .O(z8));
endmodule
