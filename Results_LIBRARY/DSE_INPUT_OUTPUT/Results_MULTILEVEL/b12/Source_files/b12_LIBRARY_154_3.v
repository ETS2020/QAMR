...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(x12), .O(new_n31_));
  ...
  inv1   g18(.a(new_n31_), .O(new_n43_));
  ...
  aoi21  g33(.a(new_n57_), .b(new_n48_), .c(new_n43_), .O(z2));
  ...
  aoi21  g41(.a(new_n65_), .b(new_n63_), .c(new_n43_), .O(z4));
  nor2   g42(.a(new_n59_), .b(x12), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n51_), .c(new_n50_), .d(new_n33_), .O(z5));
  ...
  nand4  g54(.a(new_n78_), .b(new_n31_), .c(new_n51_), .d(new_n50_), .O(new_n79_));
  ...
  nor2   g60(.a(new_n84_), .b(new_n43_), .O(z7));
  oai21  g61(.a(x13), .b(x09), .c(x12), .O(new_n86_));
  nand2  g62(.a(new_n81_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n71_), .b(new_n33_), .c(x10), .O(new_n88_));
