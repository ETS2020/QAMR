...
module FAU ( 
  ...
  nand4  g53(.a(new_n77_), .b(new_n58_), .c(new_n31_), .d(new_n50_), .O(new_n78_));
  ...
  aoi21  g62(.a(new_n70_), .b(new_n34_), .c(x07), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n58_), .d(new_n31_), .O(z8));
endmodule
