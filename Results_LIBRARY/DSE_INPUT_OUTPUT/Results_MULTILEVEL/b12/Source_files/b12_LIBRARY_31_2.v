// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:25 2020
...
module FAU ( 
  ...
  nand3  g07(.a(x03), .b(new_n26_), .c(x01), .O(new_n32_));
  ...
  nand3  g15(.a(new_n39_), .b(new_n29_), .c(x02), .O(new_n40_));
  ...
  nand4  g21(.a(new_n45_), .b(new_n35_), .c(x09), .d(new_n27_), .O(new_n46_));
  inv1   g22(.a(x08), .O(new_n47_));
  nand3  g23(.a(x10), .b(new_n47_), .c(new_n38_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n46_), .c(x07), .O(new_n49_));
  inv1   g25(.a(x07), .O(new_n50_));
  oai21  g26(.a(new_n50_), .b(x04), .c(new_n35_), .O(new_n51_));
  nand3  g27(.a(new_n51_), .b(new_n38_), .c(new_n25_), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n49_), .c(new_n44_), .O(new_n54_));
  oai21  g30(.a(x08), .b(x07), .c(x00), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n36_), .c(x02), .O(new_n56_));
  ...
  oai22  g38(.a(new_n62_), .b(new_n25_), .c(x10), .d(new_n27_), .O(new_n63_));
  nand3  g39(.a(new_n36_), .b(new_n58_), .c(x07), .O(new_n64_));
  oai21  g40(.a(new_n63_), .b(x07), .c(new_n64_), .O(z4));
  nand4  g41(.a(x13), .b(new_n59_), .c(new_n50_), .d(new_n25_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n27_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n35_), .O(z5));
  nand2  g44(.a(x09), .b(new_n38_), .O(new_n69_));
  inv1   g45(.a(x09), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x03), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n26_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n45_), .c(new_n44_), .O(new_n73_));
  ...
  nand4  g53(.a(new_n77_), .b(new_n35_), .c(new_n50_), .d(new_n27_), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  nand3  g55(.a(x03), .b(new_n26_), .c(new_n44_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n47_), .O(new_n81_));
  nor2   g57(.a(x07), .b(x04), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n26_), .d(new_n44_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n35_), .O(z7));
  nand4  g60(.a(new_n59_), .b(x03), .c(new_n26_), .d(new_n44_), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n50_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x04), .c(new_n35_), .O(z8));
endmodule
