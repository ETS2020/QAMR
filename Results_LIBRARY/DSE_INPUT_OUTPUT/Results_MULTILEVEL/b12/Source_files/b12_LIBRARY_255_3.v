...
module FAU ( 
  ...
  oai21  g37(.a(x08), .b(new_n47_), .c(x10), .O(new_n62_));
  ...
  nand4  g44(.a(x13), .b(new_n68_), .c(new_n47_), .d(new_n37_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n48_), .O(new_n70_));
  nand2  g46(.a(x10), .b(new_n52_), .O(new_n71_));
  ...
  nand3  g58(.a(new_n82_), .b(new_n48_), .c(new_n47_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n25_), .O(z6));
  nor2   g60(.a(x02), .b(x01), .O(new_n85_));
  nor2   g61(.a(new_n75_), .b(new_n26_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n85_), .c(x07), .O(new_n87_));
  nand3  g63(.a(new_n85_), .b(new_n48_), .c(x03), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n52_), .O(new_n89_));
  oai21  g65(.a(new_n87_), .b(x10), .c(new_n89_), .O(z7));
  nand3  g66(.a(new_n85_), .b(new_n68_), .c(x03), .O(new_n91_));
  oai21  g67(.a(x09), .b(x00), .c(new_n47_), .O(new_n92_));
  aoi21  g68(.a(new_n91_), .b(x09), .c(new_n92_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x10), .c(new_n71_), .O(z8));
endmodule
