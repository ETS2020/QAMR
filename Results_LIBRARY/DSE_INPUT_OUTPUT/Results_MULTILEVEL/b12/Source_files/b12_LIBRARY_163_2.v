...
module FAU ( 
  ...
  oai21  g37(.a(x07), .b(new_n34_), .c(x10), .O(new_n62_));
  ...
  nand4  g60(.a(new_n63_), .b(x03), .c(new_n25_), .d(new_n67_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n70_), .b(new_n34_), .c(x10), .O(new_n87_));
