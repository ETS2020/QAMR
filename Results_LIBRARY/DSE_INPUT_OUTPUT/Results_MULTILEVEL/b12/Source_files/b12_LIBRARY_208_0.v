...
module FAU ( 
  ...
  nand2  g36(.a(x12), .b(x00), .O(new_n61_));
  nand2  g37(.a(x13), .b(new_n25_), .O(new_n62_));
  aoi22  g38(.a(new_n62_), .b(new_n61_), .c(x11), .d(x07), .O(z3));
  nand2  g39(.a(x09), .b(x08), .O(new_n64_));
  oai22  g40(.a(new_n64_), .b(new_n39_), .c(x13), .d(x12), .O(new_n65_));
  inv1   g41(.a(x11), .O(new_n66_));
  nand3  g42(.a(new_n27_), .b(new_n66_), .c(x07), .O(new_n67_));
  ...
  nand4  g56(.a(new_n80_), .b(new_n27_), .c(new_n53_), .d(new_n52_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  inv1   g58(.a(new_n27_), .O(new_n83_));
  oai21  g59(.a(new_n43_), .b(x01), .c(new_n56_), .O(new_n84_));
  ...
  aoi21  g63(.a(new_n87_), .b(new_n84_), .c(new_n83_), .O(z7));
  oai21  g64(.a(new_n25_), .b(x09), .c(new_n26_), .O(new_n89_));
  nand4  g65(.a(new_n25_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  aoi21  g67(.a(new_n73_), .b(new_n39_), .c(x10), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n89_), .d(new_n52_), .O(z8));
endmodule
