...
module FAU ( 
  ...
  nand3  g36(.a(new_n60_), .b(new_n46_), .c(new_n33_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n58_), .O(z4));
  inv1   g38(.a(x12), .O(new_n63_));
  nor2   g39(.a(x07), .b(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n63_), .d(new_n46_), .O(z5));
  ...
  nand4  g57(.a(new_n63_), .b(x03), .c(new_n25_), .d(new_n66_), .O(new_n82_));
