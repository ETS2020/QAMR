// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:27 2020
...
module FAU ( 
  ...
  nand2  g36(.a(x12), .b(new_n39_), .O(new_n61_));
  ...
  aoi22  g43(.a(new_n67_), .b(new_n65_), .c(new_n26_), .d(new_n25_), .O(z4));
  inv1   g44(.a(x12), .O(new_n69_));
  nor3   g45(.a(x10), .b(x07), .c(x00), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(x14), .c(x13), .d(new_n69_), .O(z5));
  nor2   g47(.a(x02), .b(x00), .O(new_n72_));
  nor2   g48(.a(x08), .b(new_n39_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n72_), .c(x01), .O(new_n74_));
  nand2  g50(.a(x08), .b(x00), .O(new_n75_));
  nand2  g51(.a(x09), .b(new_n28_), .O(new_n76_));
  inv1   g52(.a(x09), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x03), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n29_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n75_), .c(new_n34_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n74_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(x14), .c(new_n25_), .d(new_n52_), .O(new_n82_));
  ...
  nand4  g64(.a(new_n69_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n89_));
