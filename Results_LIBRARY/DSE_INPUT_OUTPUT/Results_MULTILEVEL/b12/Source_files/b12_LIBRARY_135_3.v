...
module FAU ( 
  ...
  nand2  g43(.a(x10), .b(new_n51_), .O(new_n68_));
  ...
  nand3  g52(.a(new_n76_), .b(new_n72_), .c(new_n43_), .O(new_n77_));
  ...
  nand3  g57(.a(new_n81_), .b(new_n53_), .c(new_n46_), .O(new_n82_));
  ...
  nand4  g64(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n89_));
