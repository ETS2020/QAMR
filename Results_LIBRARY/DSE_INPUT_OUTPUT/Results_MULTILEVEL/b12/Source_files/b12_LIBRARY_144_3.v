...
module FAU ( 
  ...
  nand3  g50(.a(new_n74_), .b(new_n70_), .c(new_n25_), .O(new_n75_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n29_), .c(new_n52_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand2  g57(.a(x09), .b(x03), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x02), .c(new_n29_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n25_), .O(new_n84_));
  nand3  g60(.a(x03), .b(new_n28_), .c(new_n25_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n55_), .c(x07), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x10), .c(new_n84_), .O(z7));
  nand4  g63(.a(new_n61_), .b(x03), .c(new_n28_), .d(new_n25_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n72_), .b(new_n37_), .c(x10), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n89_), .c(new_n52_), .O(z8));
endmodule
