...
module FAU ( 
  ...
  nand2  g38(.a(new_n59_), .b(new_n62_), .O(new_n63_));
  ...
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n58_), .d(new_n46_), .O(z5));
  ...
  nand3  g49(.a(new_n73_), .b(new_n48_), .c(new_n32_), .O(new_n74_));
  ...
  nand3  g54(.a(new_n78_), .b(new_n46_), .c(new_n45_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand3  g56(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n62_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n46_), .d(new_n45_), .O(z7));
  nand4  g60(.a(new_n58_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n45_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  nand2  g63(.a(x10), .b(new_n62_), .O(new_n88_));
