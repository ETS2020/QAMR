...
module FAU ( 
  ...
  oai21  g54(.a(new_n42_), .b(x01), .c(new_n78_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n37_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n33_), .d(new_n46_), .O(z7));
  inv1   g57(.a(x12), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(x03), .c(new_n25_), .d(new_n37_), .O(new_n83_));
  nor2   g59(.a(x09), .b(x00), .O(new_n84_));
  aoi21  g60(.a(new_n83_), .b(x09), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x07), .c(new_n33_), .O(z8));
endmodule
