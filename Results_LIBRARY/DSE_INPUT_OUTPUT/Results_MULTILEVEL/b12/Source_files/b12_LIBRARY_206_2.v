...
module FAU ( 
  ...
  aoi21  g52(.a(new_n76_), .b(x01), .c(x07), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n73_), .c(x10), .O(z6));
  ...
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n25_), .d(new_n61_), .O(z7));
  inv1   g58(.a(x12), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n70_), .b(new_n38_), .c(x10), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n61_), .O(z8));
endmodule
