...
module FAU ( 
  ...
  nand3  g45(.a(x08), .b(new_n25_), .c(new_n55_), .O(new_n70_));
  nand2  g46(.a(new_n30_), .b(x00), .O(new_n71_));
  xnor2a g47(.a(x09), .b(x03), .O(new_n72_));
  aoi22  g48(.a(new_n72_), .b(new_n27_), .c(new_n71_), .d(new_n70_), .O(new_n73_));
  nand2  g49(.a(x14), .b(x02), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(x08), .c(new_n55_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n71_), .c(new_n25_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n73_), .c(new_n49_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(x07), .O(z6));
  nand3  g54(.a(new_n40_), .b(new_n25_), .c(x00), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n30_), .O(new_n80_));
  nor2   g56(.a(x02), .b(x01), .O(new_n81_));
  and2   g57(.a(x09), .b(x03), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n81_), .c(x10), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n80_), .c(new_n48_), .O(z7));
  nand2  g60(.a(new_n63_), .b(new_n55_), .O(new_n85_));
  nand3  g61(.a(new_n81_), .b(new_n58_), .c(x03), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n85_), .c(new_n49_), .d(new_n48_), .O(z8));
endmodule
