...
module FAU ( 
  ...
  aoi21  g37(.a(x12), .b(new_n37_), .c(new_n61_), .O(new_n62_));
  oai21  g38(.a(new_n60_), .b(new_n52_), .c(new_n62_), .O(new_n63_));
  ...
  aoi21  g43(.a(new_n67_), .b(new_n66_), .c(new_n61_), .O(z4));
  ...
  nand3  g57(.a(new_n81_), .b(new_n29_), .c(new_n52_), .O(new_n82_));
  ...
  aoi21  g67(.a(new_n74_), .b(new_n37_), .c(x10), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n91_), .c(new_n52_), .O(z8));
endmodule
