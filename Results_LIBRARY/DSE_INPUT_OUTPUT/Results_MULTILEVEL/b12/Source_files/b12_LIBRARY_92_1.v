...
module FAU ( 
  ...
  nand4  g36(.a(new_n60_), .b(x09), .c(x08), .d(x00), .O(new_n61_));
  ...
  nand4  g41(.a(new_n65_), .b(new_n60_), .c(new_n25_), .d(new_n38_), .O(z5));
  ...
  nand3  g52(.a(new_n76_), .b(new_n60_), .c(new_n25_), .O(new_n77_));
  ...
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n60_), .d(new_n25_), .O(z7));
  nand4  g58(.a(new_n56_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n69_), .b(new_n38_), .c(x10), .O(new_n85_));
