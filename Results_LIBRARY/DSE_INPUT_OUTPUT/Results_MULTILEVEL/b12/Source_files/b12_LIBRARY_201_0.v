...
module FAU ( 
  ...
  nand3  g33(.a(new_n57_), .b(new_n48_), .c(z5), .O(z2));
  ...
  oai21  g54(.a(new_n41_), .b(x01), .c(new_n54_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n80_));
  nor2   g56(.a(new_n60_), .b(x10), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(new_n50_), .O(z7));
  nand4  g58(.a(new_n81_), .b(new_n69_), .c(new_n50_), .d(x00), .O(z8));
endmodule
