...
module FAU ( 
  ...
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n36_), .O(z4));
  inv1   g42(.a(x12), .O(new_n67_));
  nor3   g43(.a(x07), .b(x04), .c(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n67_), .d(new_n35_), .O(z5));
  ...
  nand3  g49(.a(new_n73_), .b(new_n45_), .c(new_n44_), .O(new_n74_));
  ...
  nand4  g54(.a(new_n78_), .b(new_n35_), .c(new_n50_), .d(new_n27_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand3  g56(.a(x03), .b(new_n26_), .c(new_n44_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n26_), .d(new_n44_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n50_), .O(new_n83_));
  aoi21  g59(.a(new_n81_), .b(new_n47_), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x04), .c(new_n35_), .O(z7));
  nand4  g61(.a(new_n67_), .b(x03), .c(new_n26_), .d(new_n44_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n71_), .b(new_n25_), .c(x10), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n50_), .d(new_n27_), .O(z8));
endmodule
