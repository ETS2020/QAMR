...
module FAU ( 
  ...
  nand4  g57(.a(new_n81_), .b(x11), .c(new_n25_), .d(new_n52_), .O(new_n82_));
  ...
  nor2   g62(.a(new_n26_), .b(x10), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n52_), .O(z7));
