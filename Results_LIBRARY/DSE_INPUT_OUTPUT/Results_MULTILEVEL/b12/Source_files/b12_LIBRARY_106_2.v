...
module FAU ( 
  ...
  nand3  g50(.a(new_n74_), .b(new_n70_), .c(new_n35_), .O(new_n75_));
  ...
  oai21  g57(.a(new_n41_), .b(x01), .c(new_n52_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n31_), .d(new_n57_), .O(z7));
  nand4  g60(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n72_), .b(new_n34_), .c(x10), .O(new_n87_));
