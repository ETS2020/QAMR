// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:41 2020
...
module FAU ( 
  ...
  oai21  g37(.a(new_n58_), .b(new_n31_), .c(x07), .O(new_n62_));
  nand3  g38(.a(x09), .b(x08), .c(x00), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n50_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n32_), .O(z4));
  nor3   g41(.a(x10), .b(x07), .c(x00), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n59_), .d(new_n58_), .O(z5));
  ...
  nand3  g48(.a(new_n72_), .b(new_n68_), .c(new_n35_), .O(new_n73_));
  ...
  aoi21  g54(.a(new_n78_), .b(new_n58_), .c(x10), .O(z6));
  oai21  g55(.a(new_n41_), .b(x01), .c(new_n53_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n81_));
  nor2   g57(.a(x11), .b(x10), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n50_), .O(z7));
  nand4  g59(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n70_), .b(new_n34_), .c(x07), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(z8));
endmodule
