...
module FAU ( 
  ...
  aoi21  g36(.a(new_n25_), .b(x08), .c(new_n57_), .O(new_n61_));
  nand4  g37(.a(x10), .b(x09), .c(x08), .d(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n49_), .O(new_n63_));
  oai21  g39(.a(new_n61_), .b(new_n49_), .c(new_n63_), .O(z4));
  nor2   g40(.a(x10), .b(x08), .O(new_n65_));
  inv1   g41(.a(x13), .O(new_n66_));
  nor2   g42(.a(new_n66_), .b(x12), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n65_), .c(new_n49_), .d(new_n38_), .O(z5));
  and2   g44(.a(x14), .b(x02), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n38_), .c(new_n33_), .O(new_n70_));
  xnor2a g46(.a(x09), .b(x03), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n28_), .c(x01), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n70_), .c(new_n49_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n50_), .c(x10), .O(z6));
  nor2   g50(.a(x09), .b(x07), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n50_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n25_), .O(z7));
  nand4  g54(.a(new_n58_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n79_));
  oai21  g55(.a(x09), .b(x00), .c(new_n49_), .O(new_n80_));
  aoi21  g56(.a(new_n79_), .b(x09), .c(new_n80_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(x08), .c(new_n25_), .O(z8));
endmodule
