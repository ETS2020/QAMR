...
module FAU ( 
  ...
  nand2  g07(.a(new_n31_), .b(x07), .O(new_n32_));
  ...
  nand2  g25(.a(new_n31_), .b(x09), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n49_), .c(x00), .O(new_n51_));
  inv1   g27(.a(x08), .O(new_n52_));
  nand3  g28(.a(new_n31_), .b(x09), .c(new_n52_), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n51_), .c(new_n45_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n48_), .c(new_n32_), .O(z2));
  ...
  nand2  g38(.a(new_n62_), .b(new_n57_), .O(new_n63_));
  nand3  g39(.a(new_n58_), .b(x10), .c(x07), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n63_), .O(z4));
  inv1   g41(.a(x13), .O(new_n66_));
  nor2   g42(.a(new_n66_), .b(x12), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n31_), .c(new_n57_), .d(new_n34_), .O(z5));
  nand2  g44(.a(x08), .b(x00), .O(new_n69_));
  nand2  g45(.a(x09), .b(new_n35_), .O(new_n70_));
  inv1   g46(.a(x09), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x03), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(new_n25_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n69_), .c(new_n45_), .O(new_n74_));
  aoi21  g50(.a(x14), .b(x02), .c(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n34_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(x01), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n31_), .c(new_n57_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand3  g56(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n52_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n31_), .d(new_n57_), .O(z7));
  nand4  g60(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n71_), .b(new_n34_), .c(x10), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n57_), .O(z8));
endmodule
