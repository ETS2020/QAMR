...
module FAU ( 
  ...
  oai22  g35(.a(new_n59_), .b(x00), .c(new_n32_), .d(new_n51_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n33_), .O(z3));
  oai21  g37(.a(new_n31_), .b(x07), .c(new_n32_), .O(new_n62_));
  ...
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n59_), .d(x11), .O(z5));
  ...
  nand3  g48(.a(new_n72_), .b(new_n68_), .c(new_n36_), .O(new_n73_));
  ...
  nand4  g53(.a(new_n77_), .b(x11), .c(new_n31_), .d(new_n51_), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  oai21  g55(.a(new_n42_), .b(x01), .c(new_n54_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n51_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x11), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n31_), .O(z7));
  nand4  g60(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n85_));
