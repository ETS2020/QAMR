...
module FAU ( 
  ...
  nor2   g07(.a(x14), .b(new_n31_), .O(new_n32_));
  ...
  aoi21  g42(.a(new_n66_), .b(new_n64_), .c(new_n32_), .O(z4));
  inv1   g43(.a(x12), .O(new_n68_));
  nor2   g44(.a(x07), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n68_), .d(new_n31_), .O(z5));
  nor2   g46(.a(x02), .b(x00), .O(new_n71_));
  nor2   g47(.a(x08), .b(new_n35_), .O(new_n72_));
  ...
  nand3  g54(.a(new_n78_), .b(new_n74_), .c(new_n36_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n73_), .c(x10), .O(new_n80_));
  inv1   g56(.a(x14), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x01), .c(new_n35_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n80_), .c(new_n51_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n33_), .O(z6));
  oai21  g61(.a(new_n42_), .b(x01), .c(new_n54_), .O(new_n86_));
  nand4  g62(.a(x09), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n31_), .d(new_n51_), .O(z7));
  nand4  g64(.a(new_n68_), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n76_), .b(new_n35_), .c(x10), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n51_), .O(z8));
endmodule
