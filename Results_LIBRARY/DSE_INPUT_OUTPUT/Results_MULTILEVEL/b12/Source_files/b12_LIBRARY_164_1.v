...
module FAU ( 
  ...
  aoi21  g23(.a(new_n47_), .b(new_n27_), .c(new_n37_), .O(new_n48_));
  nand3  g24(.a(new_n25_), .b(x09), .c(new_n32_), .O(new_n49_));
  inv1   g25(.a(new_n49_), .O(new_n50_));
  oai21  g26(.a(new_n50_), .b(new_n48_), .c(new_n46_), .O(new_n51_));
  nand4  g27(.a(new_n25_), .b(x09), .c(new_n32_), .d(new_n37_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n45_), .O(new_n54_));
  nand3  g30(.a(x07), .b(new_n26_), .c(new_n32_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n27_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n25_), .c(new_n37_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n54_), .O(z2));
  inv1   g34(.a(x12), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n25_), .O(new_n60_));
  aoi22  g36(.a(new_n60_), .b(new_n37_), .c(x11), .d(x07), .O(z3));
  oai21  g37(.a(x10), .b(new_n45_), .c(new_n37_), .O(new_n62_));
  inv1   g38(.a(x09), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n46_), .c(new_n45_), .O(new_n64_));
  inv1   g40(.a(x11), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x07), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n62_), .O(z4));
  nand3  g43(.a(x13), .b(new_n59_), .c(new_n45_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n25_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n37_), .O(z5));
  ...
  oai21  g57(.a(new_n41_), .b(x01), .c(new_n46_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n45_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n25_), .O(new_n85_));
  oai21  g61(.a(new_n25_), .b(new_n37_), .c(new_n85_), .O(z7));
  nand4  g62(.a(new_n59_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n63_), .b(new_n37_), .c(x10), .O(new_n89_));
