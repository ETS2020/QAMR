...
module FAU ( 
  ...
  nor2   g06(.a(x14), .b(x01), .O(new_n31_));
  ...
  nand2  g13(.a(x14), .b(new_n37_), .O(new_n38_));
  ...
  nand4  g23(.a(x14), .b(x10), .c(new_n40_), .d(new_n37_), .O(new_n48_));
  oai21  g24(.a(new_n31_), .b(new_n25_), .c(new_n48_), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  nand2  g26(.a(x07), .b(new_n40_), .O(new_n51_));
  ...
  oai21  g34(.a(new_n58_), .b(new_n55_), .c(x14), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(x01), .c(new_n50_), .O(z2));
  ...
  nor3   g44(.a(new_n31_), .b(x07), .c(x00), .O(new_n69_));
  ...
  nand4  g51(.a(new_n75_), .b(new_n71_), .c(x14), .d(new_n37_), .O(new_n76_));
  aoi21  g52(.a(x14), .b(x02), .c(x00), .O(new_n77_));
  inv1   g53(.a(x00), .O(new_n78_));
  nor2   g54(.a(x08), .b(new_n78_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(x01), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n76_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n53_), .c(new_n52_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(z6));
  nand2  g59(.a(x09), .b(x03), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x02), .c(x14), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n37_), .O(new_n86_));
  nand3  g62(.a(x03), .b(new_n25_), .c(new_n37_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n56_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n86_), .c(new_n53_), .d(new_n52_), .O(z7));
  oai21  g65(.a(x09), .b(new_n37_), .c(new_n41_), .O(new_n90_));
  nand4  g66(.a(new_n62_), .b(x03), .c(new_n25_), .d(new_n37_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n73_), .b(new_n78_), .c(x10), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n90_), .d(new_n52_), .O(z8));
endmodule
