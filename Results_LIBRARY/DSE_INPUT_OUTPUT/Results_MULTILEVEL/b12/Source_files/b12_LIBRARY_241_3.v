...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(x10), .O(new_n31_));
  ...
  nand2  g36(.a(x12), .b(new_n33_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n60_), .c(new_n31_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(z3));
  inv1   g39(.a(new_n31_), .O(new_n64_));
  ...
  aoi21  g44(.a(new_n68_), .b(new_n66_), .c(new_n64_), .O(z4));
  inv1   g45(.a(x12), .O(new_n70_));
  nor2   g46(.a(x07), .b(x00), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(x13), .c(new_n70_), .d(new_n51_), .O(z5));
  nand2  g48(.a(x08), .b(x00), .O(new_n73_));
  nand2  g49(.a(x09), .b(new_n34_), .O(new_n74_));
  ...
  nor2   g55(.a(x08), .b(new_n33_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n79_), .c(x01), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n51_), .c(new_n46_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  nand2  g60(.a(new_n53_), .b(x10), .O(new_n85_));
  ...
  aoi21  g64(.a(new_n86_), .b(new_n47_), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x10), .c(new_n85_), .O(z7));
  nand4  g66(.a(new_n70_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n75_), .b(new_n33_), .c(x10), .O(new_n93_));
