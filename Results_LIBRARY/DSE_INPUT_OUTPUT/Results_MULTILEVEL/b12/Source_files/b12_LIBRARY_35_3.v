...
module FAU ( 
  ...
  nand4  g38(.a(x13), .b(new_n56_), .c(new_n46_), .d(new_n33_), .O(new_n63_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n46_), .c(new_n54_), .O(new_n75_));
  ...
  nand4  g55(.a(new_n79_), .b(new_n78_), .c(new_n46_), .d(new_n54_), .O(z7));
  nand4  g56(.a(new_n56_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x09), .O(new_n82_));
  aoi21  g58(.a(new_n67_), .b(new_n33_), .c(x10), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n54_), .O(z8));
endmodule
