...
module FAU ( 
  ...
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n67_), .d(x11), .O(z5));
  ...
  nand4  g55(.a(new_n79_), .b(x11), .c(new_n25_), .d(new_n52_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  oai21  g57(.a(new_n43_), .b(x01), .c(new_n55_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n52_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x11), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n25_), .O(z7));
  nand4  g62(.a(new_n67_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n72_), .b(new_n39_), .c(x07), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(x11), .d(new_n25_), .O(z8));
endmodule
