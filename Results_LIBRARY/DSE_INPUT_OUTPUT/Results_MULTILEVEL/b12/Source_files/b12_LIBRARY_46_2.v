...
module FAU ( 
  ...
  nand4  g44(.a(new_n68_), .b(x14), .c(x13), .d(new_n61_), .O(z5));
  ...
  inv1   g57(.a(new_n26_), .O(new_n82_));
  oai21  g58(.a(new_n42_), .b(x01), .c(new_n55_), .O(new_n83_));
  ...
  aoi21  g62(.a(new_n86_), .b(new_n83_), .c(new_n82_), .O(z7));
  nand4  g63(.a(new_n61_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  nor2   g65(.a(x09), .b(x00), .O(new_n90_));
  nor3   g66(.a(new_n90_), .b(x10), .c(x07), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n89_), .c(new_n82_), .O(z8));
endmodule
