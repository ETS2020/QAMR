...
module FAU ( 
  ...
  nand2  g39(.a(new_n60_), .b(new_n52_), .O(new_n64_));
  inv1   g40(.a(x11), .O(new_n65_));
  aoi21  g41(.a(x09), .b(x00), .c(x07), .O(new_n66_));
  aoi21  g42(.a(new_n65_), .b(x07), .c(new_n66_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n33_), .c(new_n64_), .O(z4));
  inv1   g44(.a(x12), .O(new_n69_));
  nor3   g45(.a(x08), .b(x07), .c(x00), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(x13), .c(new_n69_), .d(new_n33_), .O(z5));
  and2   g47(.a(x14), .b(x02), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n36_), .c(new_n45_), .O(new_n73_));
  xnor2a g49(.a(x09), .b(x03), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n25_), .c(x01), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n73_), .c(new_n46_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n52_), .c(x10), .O(z6));
  nor3   g53(.a(x10), .b(x09), .c(x08), .O(new_n78_));
  nor2   g54(.a(x02), .b(x01), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n78_), .c(new_n46_), .d(x03), .O(z7));
  nand3  g56(.a(new_n79_), .b(new_n69_), .c(x03), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x09), .O(new_n82_));
  aoi21  g58(.a(new_n54_), .b(new_n36_), .c(x10), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n52_), .d(new_n46_), .O(z8));
endmodule
