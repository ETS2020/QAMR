...
module FAU ( 
  ...
  nand4  g47(.a(x03), .b(new_n25_), .c(new_n66_), .d(new_n36_), .O(new_n72_));
  ...
  oai21  g53(.a(new_n77_), .b(new_n33_), .c(x00), .O(new_n78_));
  nand3  g54(.a(new_n74_), .b(new_n53_), .c(x03), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  oai21  g56(.a(x10), .b(x07), .c(new_n34_), .O(new_n81_));
  nand2  g57(.a(new_n77_), .b(new_n36_), .O(new_n82_));
