...
module FAU ( 
  ...
  nand4  g40(.a(new_n64_), .b(new_n25_), .c(new_n46_), .d(new_n38_), .O(z5));
  ...
  oai21  g53(.a(new_n42_), .b(x01), .c(new_n77_), .O(new_n78_));
  nand4  g54(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n78_), .c(new_n25_), .d(new_n46_), .O(z7));
  inv1   g56(.a(x12), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n82_));
  nor2   g58(.a(x09), .b(x00), .O(new_n83_));
  aoi21  g59(.a(new_n82_), .b(x09), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x07), .c(new_n25_), .O(z8));
endmodule
