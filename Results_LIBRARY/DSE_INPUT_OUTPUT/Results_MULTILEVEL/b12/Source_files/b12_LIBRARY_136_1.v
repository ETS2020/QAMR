...
module FAU ( 
  ...
  nor2   g20(.a(x11), .b(x10), .O(new_n45_));
  ...
  nand2  g26(.a(new_n50_), .b(new_n31_), .O(new_n51_));
  nand3  g27(.a(new_n51_), .b(new_n35_), .c(new_n34_), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  aoi21  g29(.a(new_n48_), .b(new_n44_), .c(new_n53_), .O(new_n54_));
  oai21  g30(.a(x08), .b(x07), .c(x00), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n32_), .c(x02), .O(new_n56_));
  oai21  g32(.a(new_n54_), .b(x01), .c(new_n56_), .O(z2));
  inv1   g33(.a(x12), .O(new_n58_));
  oai22  g34(.a(new_n58_), .b(x00), .c(new_n49_), .d(new_n44_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n32_), .O(z3));
  inv1   g36(.a(x08), .O(new_n61_));
  inv1   g37(.a(x09), .O(new_n62_));
  nor2   g38(.a(new_n31_), .b(x07), .O(new_n63_));
  nor2   g39(.a(x11), .b(new_n34_), .O(new_n64_));
  oai22  g40(.a(new_n64_), .b(new_n63_), .c(new_n62_), .d(new_n61_), .O(new_n65_));
  oai21  g41(.a(new_n63_), .b(new_n49_), .c(new_n34_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n50_), .O(z4));
  nand4  g43(.a(x13), .b(new_n58_), .c(new_n44_), .d(new_n34_), .O(new_n68_));
  ...
  nand2  g49(.a(new_n62_), .b(x03), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n25_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n72_), .c(new_n71_), .O(new_n76_));
  ...
  nand4  g56(.a(new_n80_), .b(new_n49_), .c(new_n31_), .d(new_n44_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand3  g58(.a(x03), .b(new_n25_), .c(new_n71_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n61_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n71_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n45_), .d(new_n44_), .O(z7));
  nand4  g62(.a(new_n58_), .b(x03), .c(new_n25_), .d(new_n71_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n62_), .b(new_n34_), .c(x07), .O(new_n89_));
