...
module FAU ( 
  ...
  nand2  g01(.a(x10), .b(x05), .O(new_n26_));
  ...
  oai21  g06(.a(new_n30_), .b(new_n27_), .c(x01), .O(new_n31_));
  inv1   g07(.a(x04), .O(new_n32_));
  nand3  g08(.a(new_n32_), .b(x03), .c(x02), .O(new_n33_));
  aoi21  g09(.a(new_n33_), .b(new_n31_), .c(x00), .O(z0));
  inv1   g10(.a(x00), .O(new_n35_));
  nand2  g11(.a(new_n32_), .b(new_n28_), .O(new_n36_));
  ...
  nand4  g22(.a(new_n46_), .b(new_n42_), .c(x09), .d(new_n32_), .O(new_n47_));
  inv1   g23(.a(x08), .O(new_n48_));
  nand3  g24(.a(x10), .b(new_n48_), .c(new_n28_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n47_), .c(x07), .O(new_n50_));
  inv1   g26(.a(x07), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(x04), .c(new_n42_), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(new_n28_), .c(new_n35_), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n50_), .c(new_n45_), .O(new_n55_));
  ...
  nand3  g48(.a(new_n72_), .b(new_n46_), .c(new_n45_), .O(new_n73_));
  ...
  nand4  g53(.a(new_n77_), .b(new_n42_), .c(new_n51_), .d(new_n32_), .O(new_n78_));
  ...
  aoi21  g58(.a(new_n80_), .b(new_n48_), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x04), .c(new_n42_), .O(z7));
  nand4  g60(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n70_), .b(new_n35_), .c(x10), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n51_), .d(new_n32_), .O(z8));
endmodule
