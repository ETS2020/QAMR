...
module FAU ( 
  ...
  nand4  g69(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n72_), .d(new_n50_), .O(z7));
  oai21  g71(.a(x10), .b(new_n37_), .c(new_n63_), .O(new_n96_));
  nand4  g72(.a(new_n73_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n97_));
  nand3  g73(.a(new_n97_), .b(new_n72_), .c(x09), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n96_), .c(new_n78_), .O(z8));
endmodule
