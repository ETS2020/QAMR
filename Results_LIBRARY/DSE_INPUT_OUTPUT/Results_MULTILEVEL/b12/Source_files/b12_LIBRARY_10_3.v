...
module FAU ( 
  ...
  nand2  g34(.a(new_n51_), .b(x00), .O(new_n59_));
  aoi22  g35(.a(new_n59_), .b(x12), .c(x11), .d(x07), .O(z3));
  ...
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n25_), .O(z4));
  inv1   g41(.a(x12), .O(new_n66_));
  nor2   g42(.a(x07), .b(x00), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n66_), .d(new_n51_), .O(z5));
  ...
  oai21  g56(.a(new_n41_), .b(x01), .c(new_n54_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n81_), .c(new_n50_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n51_), .O(new_n84_));
  nand2  g60(.a(new_n66_), .b(x10), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n84_), .O(z7));
  nand4  g62(.a(new_n66_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n50_), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x10), .c(new_n85_), .O(z8));
endmodule
