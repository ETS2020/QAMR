...
module FAU ( 
  ...
  aoi21  g33(.a(new_n57_), .b(new_n48_), .c(new_n31_), .O(z2));
  nand2  g34(.a(x12), .b(x00), .O(new_n59_));
  inv1   g35(.a(x12), .O(new_n60_));
  nand2  g36(.a(x13), .b(new_n60_), .O(new_n61_));
  ...
  inv1   g43(.a(new_n61_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n51_), .c(new_n50_), .d(new_n34_), .O(z5));
  ...
  nand4  g55(.a(new_n79_), .b(new_n32_), .c(new_n51_), .d(new_n50_), .O(new_n80_));
  ...
  nand3  g59(.a(new_n83_), .b(new_n51_), .c(new_n50_), .O(new_n84_));
  aoi21  g60(.a(new_n82_), .b(new_n54_), .c(new_n84_), .O(new_n85_));
  nor2   g61(.a(new_n85_), .b(new_n31_), .O(z7));
  inv1   g62(.a(x13), .O(new_n87_));
  oai21  g63(.a(new_n60_), .b(x09), .c(new_n87_), .O(new_n88_));
  nand4  g64(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n72_), .b(new_n34_), .c(x10), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n90_), .c(new_n88_), .d(new_n50_), .O(z8));
endmodule
