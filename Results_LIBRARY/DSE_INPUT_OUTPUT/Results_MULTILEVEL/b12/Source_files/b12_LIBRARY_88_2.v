...
module FAU ( 
  ...
  oai21  g22(.a(new_n31_), .b(new_n34_), .c(new_n46_), .O(new_n47_));
  ...
  nand3  g28(.a(new_n50_), .b(x09), .c(new_n31_), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n52_), .c(new_n44_), .O(new_n55_));
  ...
  nand4  g40(.a(x13), .b(new_n58_), .c(new_n50_), .d(new_n34_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n49_), .O(new_n66_));
  oai21  g42(.a(new_n31_), .b(new_n49_), .c(new_n66_), .O(z5));
  oai21  g43(.a(x07), .b(x00), .c(x08), .O(new_n68_));
  ...
  nand4  g61(.a(new_n58_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n86_));
