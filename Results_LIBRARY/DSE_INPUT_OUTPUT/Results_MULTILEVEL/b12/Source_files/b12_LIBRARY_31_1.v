...
module FAU ( 
  ...
  oai22  g36(.a(new_n60_), .b(x00), .c(new_n59_), .d(new_n46_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n32_), .O(z3));
  nand2  g38(.a(x09), .b(x08), .O(new_n63_));
  oai22  g39(.a(new_n63_), .b(new_n34_), .c(new_n52_), .d(x04), .O(new_n64_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n46_), .c(new_n34_), .O(new_n72_));
  ...
  nand3  g59(.a(new_n83_), .b(new_n52_), .c(new_n46_), .O(new_n84_));
  ...
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n52_), .d(new_n46_), .O(z7));
  nand4  g65(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n90_));
