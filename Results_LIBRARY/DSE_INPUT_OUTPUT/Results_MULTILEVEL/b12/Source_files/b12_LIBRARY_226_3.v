...
module FAU ( 
  ...
  oai21  g38(.a(x08), .b(new_n50_), .c(x10), .O(new_n63_));
  ...
  nand4  g43(.a(x13), .b(new_n60_), .c(new_n50_), .d(new_n40_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n26_), .O(new_n69_));
  nand2  g45(.a(x10), .b(new_n25_), .O(new_n70_));
