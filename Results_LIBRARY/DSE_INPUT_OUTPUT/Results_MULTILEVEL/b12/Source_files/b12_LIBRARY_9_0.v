...
module FAU ( 
  ...
  oai21  g62(.a(new_n43_), .b(x01), .c(new_n47_), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n65_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x14), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n25_), .O(z7));
  nand4  g67(.a(new_n71_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  aoi21  g69(.a(new_n80_), .b(new_n39_), .c(x07), .O(new_n94_));
