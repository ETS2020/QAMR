...
module FAU ( 
  ...
  oai21  g36(.a(new_n25_), .b(x00), .c(new_n52_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(x11), .O(z3));
  ...
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n25_), .d(new_n53_), .O(z5));
  ...
  oai21  g62(.a(new_n65_), .b(x09), .c(x12), .O(new_n87_));
  nand2  g63(.a(new_n82_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n72_), .b(new_n39_), .c(x10), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(new_n52_), .O(z8));
endmodule
