...
module FAU ( 
  ...
  oai21  g31(.a(new_n52_), .b(new_n46_), .c(new_n36_), .O(new_n56_));
  nor2   g32(.a(x09), .b(x07), .O(new_n57_));
  aoi22  g33(.a(new_n57_), .b(x00), .c(new_n52_), .d(x07), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n33_), .c(new_n56_), .O(z4));
  oai21  g35(.a(x11), .b(new_n33_), .c(x00), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(x07), .O(new_n61_));
  nand3  g37(.a(x13), .b(new_n53_), .c(new_n47_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n46_), .c(new_n36_), .O(new_n63_));
  nand2  g39(.a(x08), .b(x00), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n61_), .O(z5));
  ...
  oai21  g45(.a(new_n69_), .b(x02), .c(new_n68_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n67_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n47_), .c(new_n46_), .d(new_n36_), .O(new_n72_));
  inv1   g48(.a(new_n72_), .O(z6));
  oai21  g49(.a(x10), .b(x07), .c(new_n34_), .O(new_n74_));
  nand4  g50(.a(x08), .b(x03), .c(new_n25_), .d(new_n68_), .O(new_n75_));
  oai21  g51(.a(x08), .b(x00), .c(new_n75_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x09), .O(new_n77_));
  nand3  g53(.a(x03), .b(new_n25_), .c(new_n68_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n33_), .c(new_n36_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n74_), .O(z7));
  inv1   g56(.a(x09), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(x00), .c(new_n33_), .O(new_n82_));
  nand4  g58(.a(new_n53_), .b(x03), .c(new_n25_), .d(new_n68_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n81_), .b(new_n36_), .c(x10), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n82_), .d(new_n46_), .O(z8));
endmodule
