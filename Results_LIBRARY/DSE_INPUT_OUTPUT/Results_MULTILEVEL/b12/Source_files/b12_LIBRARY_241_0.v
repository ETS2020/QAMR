...
module FAU ( 
  ...
  nor2   g06(.a(x13), .b(x10), .O(new_n31_));
  ...
  nand2  g21(.a(x10), .b(new_n35_), .O(new_n46_));
  inv1   g22(.a(x10), .O(new_n47_));
  nand3  g23(.a(x13), .b(new_n47_), .c(x09), .O(new_n48_));
  nand2  g24(.a(new_n48_), .b(new_n46_), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n45_), .O(new_n50_));
  inv1   g26(.a(x13), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(x10), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(x09), .c(new_n34_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n50_), .c(x07), .O(new_n54_));
  aoi21  g30(.a(x13), .b(x07), .c(x10), .O(new_n55_));
  nor3   g31(.a(new_n55_), .b(x03), .c(x00), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n54_), .c(new_n44_), .O(new_n57_));
  oai21  g33(.a(x08), .b(x07), .c(x00), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n32_), .c(x02), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n57_), .O(z2));
  nand2  g36(.a(x11), .b(x07), .O(new_n61_));
  nand2  g37(.a(x12), .b(new_n34_), .O(new_n62_));
  ...
  aoi21  g45(.a(new_n69_), .b(new_n67_), .c(new_n31_), .O(z4));
  inv1   g46(.a(x12), .O(new_n71_));
  nor2   g47(.a(x07), .b(x00), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(x13), .c(new_n71_), .d(new_n47_), .O(z5));
  nand2  g49(.a(x08), .b(x00), .O(new_n74_));
  nand2  g50(.a(x09), .b(new_n35_), .O(new_n75_));
  inv1   g51(.a(x09), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x03), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n75_), .c(new_n25_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n74_), .c(new_n44_), .O(new_n79_));
  aoi21  g55(.a(x14), .b(x02), .c(x00), .O(new_n80_));
  nor2   g56(.a(x08), .b(new_n34_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n80_), .c(x01), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(x13), .c(new_n47_), .d(new_n65_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand3  g61(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n86_));
  nand4  g62(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n65_), .O(new_n88_));
  aoi21  g64(.a(new_n86_), .b(new_n45_), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n51_), .c(new_n47_), .O(z7));
  nand4  g66(.a(new_n71_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n76_), .b(new_n34_), .c(x07), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n52_), .O(z8));
endmodule
