...
module FAU ( 
  ...
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n47_), .O(z4));
  nand4  g43(.a(x13), .b(new_n61_), .c(new_n46_), .d(new_n38_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n52_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n25_), .O(z5));
  nand2  g46(.a(x14), .b(x02), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x00), .c(x01), .O(new_n72_));
  xor2a  g48(.a(x09), .b(x03), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x02), .c(new_n33_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n25_), .c(new_n52_), .d(new_n46_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(z6));
  nand3  g53(.a(new_n54_), .b(new_n46_), .c(x03), .O(new_n78_));
  nor3   g54(.a(new_n78_), .b(x02), .c(x01), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(x08), .c(new_n25_), .O(z7));
  nand4  g56(.a(new_n61_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n81_));
  oai21  g57(.a(x09), .b(x00), .c(new_n46_), .O(new_n82_));
  aoi21  g58(.a(new_n81_), .b(x09), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x08), .c(new_n25_), .O(z8));
endmodule
