...
module FAU ( 
  ...
  nand2  g50(.a(new_n74_), .b(new_n25_), .O(z6));
  inv1   g51(.a(x08), .O(new_n76_));
  nand3  g52(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand4  g54(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n78_), .c(new_n49_), .d(new_n50_), .O(z7));
  inv1   g56(.a(x12), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n82_));
  oai21  g58(.a(x09), .b(x00), .c(new_n49_), .O(new_n83_));
  aoi21  g59(.a(new_n82_), .b(x09), .c(new_n83_), .O(new_n84_));
  nand2  g60(.a(new_n49_), .b(x07), .O(new_n85_));
