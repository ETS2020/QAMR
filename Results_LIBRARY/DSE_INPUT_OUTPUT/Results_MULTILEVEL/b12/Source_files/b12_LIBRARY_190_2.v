...
module FAU ( 
  ...
  oai21  g22(.a(x08), .b(new_n46_), .c(new_n25_), .O(new_n47_));
  nand3  g23(.a(new_n47_), .b(new_n27_), .c(new_n33_), .O(new_n48_));
  nand2  g24(.a(new_n26_), .b(x02), .O(new_n49_));
  ...
  oai21  g31(.a(new_n55_), .b(new_n53_), .c(new_n33_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n28_), .O(new_n57_));
  ...
  and2   g39(.a(new_n26_), .b(x11), .O(new_n64_));
  nand4  g40(.a(x10), .b(x09), .c(x08), .d(x00), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n46_), .O(new_n66_));
  oai21  g42(.a(new_n64_), .b(new_n46_), .c(new_n66_), .O(z4));
  nor2   g43(.a(x10), .b(x08), .O(new_n68_));
  inv1   g44(.a(x13), .O(new_n69_));
  nor2   g45(.a(new_n69_), .b(x12), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n68_), .c(new_n46_), .d(new_n38_), .O(z5));
  nand2  g47(.a(x14), .b(x02), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(x00), .c(x01), .O(new_n73_));
  xor2a  g49(.a(x09), .b(x03), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(x02), .c(new_n33_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n25_), .c(new_n52_), .d(new_n46_), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(z6));
  nand3  g54(.a(new_n54_), .b(new_n46_), .c(x03), .O(new_n79_));
  nor3   g55(.a(new_n79_), .b(x02), .c(x01), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x08), .c(new_n25_), .O(z7));
  inv1   g57(.a(x12), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n83_));
  oai21  g59(.a(x09), .b(x00), .c(new_n46_), .O(new_n84_));
  aoi21  g60(.a(new_n83_), .b(x09), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x08), .c(new_n25_), .O(z8));
endmodule
