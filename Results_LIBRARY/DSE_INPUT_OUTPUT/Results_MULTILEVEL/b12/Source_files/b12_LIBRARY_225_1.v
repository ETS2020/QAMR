...
module FAU ( 
  ...
  nand3  g18(.a(new_n42_), .b(z5), .c(new_n34_), .O(new_n43_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n67_), .c(new_n35_), .O(new_n72_));
  ...
  aoi21  g53(.a(new_n77_), .b(new_n66_), .c(x10), .O(z6));
  oai21  g54(.a(new_n41_), .b(x01), .c(new_n53_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n50_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n66_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n31_), .O(z7));
