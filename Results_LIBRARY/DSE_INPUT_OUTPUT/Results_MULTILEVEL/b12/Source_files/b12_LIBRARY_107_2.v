...
module FAU ( 
  ...
  oai21  g22(.a(x08), .b(new_n46_), .c(new_n33_), .O(new_n47_));
  nand3  g23(.a(new_n47_), .b(new_n37_), .c(new_n45_), .O(new_n48_));
  nand2  g24(.a(new_n34_), .b(x02), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n36_), .O(new_n51_));
  inv1   g27(.a(x08), .O(new_n52_));
  nor2   g28(.a(new_n33_), .b(x03), .O(new_n53_));
  inv1   g29(.a(x09), .O(new_n54_));
  nor2   g30(.a(x10), .b(new_n54_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n53_), .c(new_n45_), .O(new_n56_));
  ...
  nand2  g36(.a(x12), .b(new_n36_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n60_), .c(new_n34_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(z3));
  inv1   g39(.a(x11), .O(new_n64_));
  nand3  g40(.a(new_n34_), .b(new_n64_), .c(x07), .O(new_n65_));
  nand2  g41(.a(x09), .b(x00), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(x10), .c(new_n52_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x07), .c(new_n65_), .O(z4));
  inv1   g44(.a(x12), .O(new_n69_));
  nand4  g45(.a(x13), .b(new_n69_), .c(new_n46_), .d(new_n36_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n52_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n33_), .O(z5));
  nand2  g48(.a(x14), .b(x02), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x00), .c(x01), .O(new_n74_));
  ...
  nand4  g53(.a(new_n77_), .b(new_n33_), .c(new_n52_), .d(new_n46_), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  nor3   g55(.a(x10), .b(x09), .c(x08), .O(new_n80_));
  nor2   g56(.a(x02), .b(x01), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n46_), .d(x03), .O(z7));
  nand3  g58(.a(new_n81_), .b(new_n69_), .c(x03), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n54_), .b(new_n36_), .c(x10), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n52_), .d(new_n46_), .O(z8));
endmodule
