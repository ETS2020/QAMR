...
module FAU ( 
  ...
  nand3  g70(.a(new_n94_), .b(x09), .c(x03), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n93_), .c(new_n52_), .d(new_n51_), .O(z7));
  nor2   g72(.a(x12), .b(x10), .O(new_n97_));
  nand3  g73(.a(new_n97_), .b(new_n94_), .c(x03), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(x09), .O(new_n99_));
  nand3  g75(.a(new_n52_), .b(new_n25_), .c(new_n38_), .O(new_n100_));
  nand3  g76(.a(new_n100_), .b(new_n99_), .c(new_n74_), .O(z8));
endmodule
