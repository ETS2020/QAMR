...
module FAU ( 
  ...
  oai21  g37(.a(new_n58_), .b(new_n46_), .c(new_n61_), .O(z4));
  oai21  g38(.a(x07), .b(new_n38_), .c(x10), .O(new_n63_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n25_), .c(new_n46_), .O(new_n78_));
  ...
  nand4  g60(.a(new_n64_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n85_));
