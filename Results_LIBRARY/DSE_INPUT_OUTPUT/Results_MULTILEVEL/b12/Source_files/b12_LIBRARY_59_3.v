...
module FAU ( 
  ...
  nand3  g48(.a(new_n72_), .b(new_n68_), .c(new_n34_), .O(new_n73_));
  ...
  oai21  g55(.a(new_n40_), .b(x01), .c(new_n53_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n50_), .d(new_n49_), .O(z7));
  nand4  g58(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n70_), .b(new_n33_), .c(x10), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n49_), .O(z8));
endmodule
