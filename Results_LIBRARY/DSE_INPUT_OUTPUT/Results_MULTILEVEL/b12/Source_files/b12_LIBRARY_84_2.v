...
module FAU ( 
  ...
  nand4  g40(.a(new_n64_), .b(new_n31_), .c(new_n44_), .d(new_n34_), .O(z5));
  ...
  nand3  g47(.a(new_n71_), .b(new_n67_), .c(new_n66_), .O(new_n72_));
  ...
  nand3  g52(.a(new_n76_), .b(new_n31_), .c(new_n44_), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(z6));
  inv1   g54(.a(x08), .O(new_n79_));
  nand3  g55(.a(x03), .b(new_n25_), .c(new_n66_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n66_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n31_), .d(new_n44_), .O(z7));
  nand4  g59(.a(new_n56_), .b(x03), .c(new_n25_), .d(new_n66_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n69_), .b(new_n34_), .c(x10), .O(new_n86_));
