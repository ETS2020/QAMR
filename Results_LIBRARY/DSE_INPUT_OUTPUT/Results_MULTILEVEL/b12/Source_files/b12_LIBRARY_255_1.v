...
module FAU ( 
  ...
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n62_), .O(z4));
  nand2  g42(.a(x10), .b(x08), .O(new_n67_));
  inv1   g43(.a(x12), .O(new_n68_));
  nand4  g44(.a(x13), .b(new_n68_), .c(new_n49_), .d(new_n38_), .O(new_n69_));
  ...
  nand2  g49(.a(new_n54_), .b(x03), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n28_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n72_), .c(new_n33_), .O(new_n76_));
  nand2  g52(.a(x14), .b(x02), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n50_), .c(new_n38_), .O(new_n78_));
  nand2  g54(.a(new_n25_), .b(x00), .O(new_n79_));
  ...
  oai21  g60(.a(new_n42_), .b(x01), .c(new_n25_), .O(new_n85_));
  nand4  g61(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n49_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n50_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n67_), .O(z7));
  nand4  g65(.a(new_n68_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n90_));
