...
module FAU ( 
  ...
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n56_), .d(new_n25_), .O(z7));
  nand4  g57(.a(new_n64_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n69_), .b(new_n38_), .c(x10), .O(new_n84_));
