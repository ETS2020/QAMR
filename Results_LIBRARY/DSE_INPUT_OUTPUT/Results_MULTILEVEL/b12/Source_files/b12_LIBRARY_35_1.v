...
module FAU ( 
  ...
  nand2  g20(.a(x07), .b(new_n37_), .O(new_n45_));
  inv1   g21(.a(x10), .O(new_n46_));
  nand3  g22(.a(new_n46_), .b(x09), .c(new_n33_), .O(new_n47_));
  aoi21  g23(.a(new_n47_), .b(new_n45_), .c(x01), .O(new_n48_));
  aoi21  g24(.a(x10), .b(new_n33_), .c(new_n25_), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n48_), .c(new_n36_), .O(new_n50_));
  inv1   g26(.a(x08), .O(new_n51_));
  inv1   g27(.a(x09), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(x01), .c(new_n25_), .O(new_n53_));
  nand4  g29(.a(new_n53_), .b(new_n46_), .c(new_n51_), .d(new_n33_), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n50_), .O(z2));
  ...
  nand2  g35(.a(new_n46_), .b(x09), .O(new_n60_));
  nand2  g36(.a(x08), .b(x00), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n60_), .c(new_n33_), .O(new_n62_));
  oai21  g38(.a(x11), .b(new_n33_), .c(new_n62_), .O(z4));
  nand3  g39(.a(x13), .b(new_n56_), .c(new_n36_), .O(new_n64_));
  ...
  nand2  g44(.a(new_n52_), .b(x03), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n25_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n61_), .c(new_n67_), .O(new_n71_));
  nand2  g47(.a(x14), .b(x02), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n36_), .O(new_n73_));
  nand2  g49(.a(new_n51_), .b(x00), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(x01), .c(x10), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n71_), .c(x07), .O(z6));
  nand3  g53(.a(x03), .b(new_n25_), .c(new_n67_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n51_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n67_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n46_), .d(new_n33_), .O(z7));
  nand4  g57(.a(new_n56_), .b(x03), .c(new_n25_), .d(new_n67_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n52_), .b(new_n36_), .c(x10), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n33_), .O(z8));
endmodule
