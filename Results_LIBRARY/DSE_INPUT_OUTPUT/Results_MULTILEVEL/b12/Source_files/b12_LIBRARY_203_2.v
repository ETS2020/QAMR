...
module FAU ( 
  ...
  aoi21  g36(.a(x11), .b(new_n51_), .c(new_n60_), .O(new_n61_));
  aoi21  g37(.a(x12), .b(new_n38_), .c(new_n61_), .O(z3));
  ...
  aoi21  g66(.a(new_n88_), .b(new_n55_), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x10), .c(new_n70_), .O(z7));
  inv1   g68(.a(x12), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n94_));
  oai21  g70(.a(x09), .b(x00), .c(new_n51_), .O(new_n95_));
  aoi21  g71(.a(new_n94_), .b(x09), .c(new_n95_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(x10), .c(new_n70_), .O(z8));
endmodule
