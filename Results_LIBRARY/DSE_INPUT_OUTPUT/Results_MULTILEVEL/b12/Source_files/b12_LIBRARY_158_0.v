...
module FAU ( 
  ...
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n27_), .O(z4));
  nor3   g44(.a(x12), .b(x07), .c(x00), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n26_), .c(new_n25_), .O(z5));
  ...
  aoi21  g57(.a(new_n81_), .b(x13), .c(x10), .O(z6));
  ...
  nor2   g61(.a(new_n26_), .b(x10), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n52_), .O(z7));
