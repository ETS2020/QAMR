...
module FAU ( 
  ...
  nor2   g27(.a(new_n26_), .b(x10), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(x09), .c(new_n39_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n51_), .c(x07), .O(new_n54_));
  aoi21  g30(.a(x14), .b(x07), .c(x10), .O(new_n55_));
  ...
  nand4  g47(.a(x13), .b(new_n71_), .c(new_n65_), .d(new_n39_), .O(new_n72_));
  ...
  nand2  g54(.a(x09), .b(new_n28_), .O(new_n79_));
  inv1   g55(.a(x09), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x03), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n79_), .c(new_n29_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n78_), .c(new_n34_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n77_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n65_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(x14), .c(x10), .O(z6));
  nand3  g62(.a(x03), .b(new_n29_), .c(new_n34_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n47_), .O(new_n88_));
  nand4  g64(.a(x09), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n52_), .d(new_n65_), .O(z7));
  nand4  g66(.a(new_n71_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n91_));
  oai21  g67(.a(x09), .b(x00), .c(new_n65_), .O(new_n92_));
