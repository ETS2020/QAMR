...
module FAU ( 
  ...
  nand2  g21(.a(new_n43_), .b(x09), .O(new_n46_));
  inv1   g22(.a(x08), .O(new_n47_));
  nand2  g23(.a(new_n47_), .b(new_n42_), .O(new_n48_));
  oai22  g24(.a(new_n48_), .b(new_n46_), .c(new_n43_), .d(x03), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n45_), .c(new_n25_), .O(new_n50_));
  inv1   g26(.a(x00), .O(new_n51_));
  aoi21  g27(.a(new_n27_), .b(new_n51_), .c(new_n43_), .O(new_n52_));
  nand2  g28(.a(new_n48_), .b(x00), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(x02), .c(new_n52_), .O(new_n54_));
  ...
  oai21  g34(.a(new_n43_), .b(new_n51_), .c(new_n58_), .O(z3));
  nand2  g35(.a(new_n57_), .b(new_n51_), .O(new_n60_));
  inv1   g36(.a(x11), .O(new_n61_));
  aoi21  g37(.a(x09), .b(x08), .c(x07), .O(new_n62_));
  aoi21  g38(.a(new_n61_), .b(x07), .c(new_n62_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x10), .c(new_n60_), .O(z4));
  nor2   g40(.a(x07), .b(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n56_), .d(new_n43_), .O(z5));
  ...
  nor2   g49(.a(x08), .b(new_n51_), .O(new_n74_));
  ...
  nand4  g56(.a(x09), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n43_), .d(new_n42_), .O(z7));
  nand4  g58(.a(new_n56_), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n69_), .b(new_n51_), .c(x10), .O(new_n85_));
