...
module FAU ( 
  ...
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n41_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n71_), .c(new_n47_), .O(new_n76_));
  aoi21  g52(.a(x14), .b(x02), .c(x00), .O(new_n77_));
  nor2   g53(.a(x08), .b(new_n36_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n77_), .c(x01), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n53_), .c(new_n52_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n29_), .O(z6));
  nand3  g58(.a(x03), .b(new_n41_), .c(new_n47_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n41_), .d(new_n47_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n52_), .O(new_n85_));
  aoi21  g61(.a(new_n83_), .b(new_n56_), .c(new_n85_), .O(new_n86_));
  nand2  g62(.a(x10), .b(x05), .O(new_n87_));
  oai21  g63(.a(new_n86_), .b(x10), .c(new_n87_), .O(z7));
  nand4  g64(.a(new_n62_), .b(x03), .c(new_n41_), .d(new_n47_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n73_), .b(new_n36_), .c(x10), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n52_), .O(z8));
endmodule
