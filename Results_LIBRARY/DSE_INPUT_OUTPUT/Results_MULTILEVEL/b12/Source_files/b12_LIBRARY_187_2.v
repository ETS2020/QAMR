...
module FAU ( 
  ...
  oai22  g36(.a(new_n25_), .b(x00), .c(new_n60_), .d(new_n51_), .O(new_n61_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n26_), .O(z4));
  nand3  g42(.a(x13), .b(new_n51_), .c(new_n38_), .O(new_n67_));
  ...
  nand2  g61(.a(x12), .b(x10), .O(new_n86_));
  oai21  g62(.a(new_n85_), .b(x10), .c(new_n86_), .O(z7));
  oai21  g63(.a(x10), .b(x09), .c(x12), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n51_), .O(new_n89_));
  aoi21  g65(.a(new_n82_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x10), .c(new_n88_), .O(z8));
endmodule
