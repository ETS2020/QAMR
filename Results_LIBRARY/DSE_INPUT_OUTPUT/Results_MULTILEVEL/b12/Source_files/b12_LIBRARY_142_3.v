...
module FAU ( 
  ...
  nand2  g06(.a(x12), .b(x08), .O(new_n31_));
  ...
  nand3  g16(.a(new_n40_), .b(new_n31_), .c(new_n33_), .O(new_n41_));
  ...
  oai22  g25(.a(new_n49_), .b(x07), .c(new_n48_), .d(x03), .O(new_n50_));
  nand3  g26(.a(new_n50_), .b(new_n47_), .c(new_n43_), .O(new_n51_));
  ...
  oai21  g31(.a(new_n48_), .b(x03), .c(new_n49_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n43_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n25_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n55_), .c(new_n54_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n53_), .O(z2));
  nand2  g36(.a(x11), .b(x07), .O(new_n61_));
  oai21  g37(.a(new_n47_), .b(x00), .c(new_n61_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n31_), .O(z3));
  nand2  g39(.a(new_n61_), .b(new_n55_), .O(new_n64_));
  inv1   g40(.a(x11), .O(new_n65_));
  aoi21  g41(.a(x09), .b(x00), .c(x07), .O(new_n66_));
  aoi21  g42(.a(new_n65_), .b(x07), .c(new_n66_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x12), .c(new_n64_), .O(z4));
  nor2   g44(.a(x07), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n47_), .d(new_n48_), .O(z5));
  aoi21  g46(.a(new_n47_), .b(new_n33_), .c(new_n55_), .O(new_n71_));
  nand2  g47(.a(x14), .b(x02), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x01), .O(new_n73_));
  xor2a  g49(.a(x09), .b(x03), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(x02), .c(new_n43_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n73_), .c(new_n71_), .O(new_n76_));
  nand3  g52(.a(new_n55_), .b(x01), .c(x00), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n76_), .c(new_n48_), .O(new_n79_));
  nor2   g55(.a(new_n79_), .b(x07), .O(z6));
  oai21  g56(.a(x10), .b(x07), .c(new_n31_), .O(new_n81_));
  nand4  g57(.a(new_n47_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n82_));
  ...
  aoi21  g64(.a(x12), .b(x08), .c(x00), .O(new_n89_));
  nor2   g65(.a(x10), .b(x07), .O(new_n90_));
  nor2   g66(.a(new_n90_), .b(x08), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n89_), .c(new_n88_), .O(new_n92_));
  nand2  g68(.a(new_n85_), .b(x09), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n47_), .O(new_n95_));
  nand3  g71(.a(x12), .b(x09), .c(new_n55_), .O(new_n96_));
