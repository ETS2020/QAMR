...
module FAU ( 
  ...
  nand2  g36(.a(new_n53_), .b(x08), .O(new_n61_));
  ...
  nand3  g56(.a(new_n80_), .b(new_n77_), .c(new_n44_), .O(new_n81_));
  aoi21  g57(.a(x14), .b(x02), .c(x00), .O(new_n82_));
  nor2   g58(.a(x08), .b(new_n34_), .O(new_n83_));
  ...
  nand2  g64(.a(new_n88_), .b(new_n31_), .O(new_n89_));
  nand4  g65(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n49_), .d(new_n48_), .O(z7));
  inv1   g67(.a(x12), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n53_), .b(new_n34_), .c(x10), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n94_), .c(new_n48_), .O(z8));
endmodule
