...
module FAU ( 
  ...
  nand2  g31(.a(new_n46_), .b(new_n33_), .O(new_n56_));
  inv1   g32(.a(x11), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(x07), .O(new_n58_));
  aoi22  g34(.a(new_n58_), .b(new_n56_), .c(x12), .d(new_n36_), .O(z3));
  nand4  g35(.a(new_n46_), .b(x09), .c(x08), .d(x00), .O(new_n60_));
  ...
  nand4  g40(.a(new_n64_), .b(new_n46_), .c(new_n33_), .d(new_n36_), .O(z5));
  ...
  nand3  g46(.a(new_n70_), .b(new_n67_), .c(new_n66_), .O(new_n71_));
