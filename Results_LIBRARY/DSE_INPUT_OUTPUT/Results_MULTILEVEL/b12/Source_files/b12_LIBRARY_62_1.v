...
module FAU ( 
  ...
  oai21  g23(.a(x13), .b(new_n47_), .c(new_n25_), .O(new_n48_));
  nand3  g24(.a(new_n48_), .b(new_n27_), .c(new_n33_), .O(new_n49_));
  inv1   g25(.a(new_n49_), .O(new_n50_));
  aoi21  g26(.a(x13), .b(new_n25_), .c(new_n28_), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n50_), .c(new_n46_), .O(new_n52_));
  inv1   g28(.a(x07), .O(new_n53_));
  nand3  g29(.a(new_n47_), .b(x09), .c(new_n53_), .O(new_n54_));
  inv1   g30(.a(x13), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(x07), .c(new_n27_), .O(new_n56_));
  aoi21  g32(.a(new_n56_), .b(new_n54_), .c(x00), .O(new_n57_));
  inv1   g33(.a(x08), .O(new_n58_));
  nand4  g34(.a(new_n47_), .b(x09), .c(new_n58_), .d(new_n53_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n57_), .c(new_n33_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n52_), .O(z2));
  inv1   g38(.a(x11), .O(new_n63_));
  inv1   g39(.a(x12), .O(new_n64_));
  oai22  g40(.a(new_n64_), .b(x00), .c(new_n63_), .d(new_n53_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n26_), .O(z3));
  oai21  g42(.a(x13), .b(new_n53_), .c(new_n25_), .O(new_n67_));
  oai21  g43(.a(new_n58_), .b(new_n38_), .c(new_n53_), .O(new_n68_));
  nand2  g44(.a(new_n63_), .b(x07), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(z4));
  nand3  g46(.a(x13), .b(new_n64_), .c(new_n47_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n67_), .c(new_n53_), .d(new_n38_), .O(z5));
  nand2  g49(.a(new_n58_), .b(x00), .O(new_n74_));
  nand2  g50(.a(new_n33_), .b(new_n38_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g52(.a(x09), .b(new_n27_), .O(new_n77_));
  nand2  g53(.a(new_n25_), .b(x03), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n28_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nor2   g56(.a(x08), .b(new_n38_), .O(new_n81_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n47_), .c(new_n53_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n26_), .O(z6));
  oai21  g62(.a(x10), .b(x07), .c(new_n26_), .O(new_n87_));
  nand3  g63(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x08), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  nand3  g66(.a(new_n88_), .b(new_n55_), .c(new_n58_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n87_), .O(z7));
  nand4  g68(.a(new_n64_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand3  g70(.a(new_n55_), .b(new_n25_), .c(new_n38_), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n94_), .c(new_n87_), .O(z8));
endmodule
