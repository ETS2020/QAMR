...
module FAU ( 
  ...
  nand2  g32(.a(x12), .b(new_n39_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n56_), .c(new_n27_), .O(new_n58_));
  ...
  nand4  g42(.a(x13), .b(new_n66_), .c(new_n51_), .d(new_n39_), .O(new_n67_));
  ...
  oai21  g48(.a(new_n72_), .b(x02), .c(new_n34_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n51_), .c(new_n39_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(x08), .c(x10), .O(z6));
  nor2   g52(.a(x02), .b(x01), .O(new_n77_));
  nor2   g53(.a(new_n61_), .b(new_n28_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n77_), .c(x07), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n25_), .c(new_n26_), .O(z7));
  nand3  g56(.a(new_n77_), .b(new_n66_), .c(x03), .O(new_n81_));
  oai21  g57(.a(x09), .b(x00), .c(new_n51_), .O(new_n82_));
  aoi21  g58(.a(new_n81_), .b(x09), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n25_), .c(new_n26_), .O(z8));
endmodule
