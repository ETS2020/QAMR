...
module FAU ( 
  ...
  nand4  g30(.a(new_n52_), .b(x09), .c(new_n25_), .d(new_n51_), .O(new_n55_));
  ...
  oai21  g38(.a(x14), .b(new_n51_), .c(new_n25_), .O(new_n63_));
  inv1   g39(.a(x09), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n38_), .c(new_n51_), .O(new_n65_));
  inv1   g41(.a(x11), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x07), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n63_), .O(z4));
  inv1   g44(.a(new_n26_), .O(new_n69_));
  inv1   g45(.a(x12), .O(new_n70_));
  nand3  g46(.a(x13), .b(new_n70_), .c(new_n52_), .O(new_n71_));
  nor3   g47(.a(new_n71_), .b(x07), .c(x00), .O(new_n72_));
  nor2   g48(.a(new_n72_), .b(new_n69_), .O(z5));
  nand3  g49(.a(x08), .b(new_n33_), .c(new_n38_), .O(new_n74_));
  ...
  nand2  g54(.a(new_n64_), .b(x03), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n28_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n77_), .O(new_n81_));
  nor2   g57(.a(x14), .b(x08), .O(new_n82_));
  oai21  g58(.a(new_n25_), .b(x02), .c(x14), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n38_), .c(new_n82_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n33_), .c(new_n81_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n52_), .c(new_n51_), .O(new_n86_));
  inv1   g62(.a(new_n86_), .O(z6));
  oai21  g63(.a(x10), .b(x07), .c(new_n26_), .O(new_n88_));
  nand4  g64(.a(x08), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n76_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  nand3  g67(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n75_), .c(new_n25_), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n91_), .c(new_n88_), .O(z7));
  nand4  g70(.a(new_n70_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(x09), .O(new_n96_));
  nor2   g72(.a(x09), .b(x00), .O(new_n97_));
  nor3   g73(.a(new_n97_), .b(x10), .c(x07), .O(new_n98_));
  aoi21  g74(.a(new_n98_), .b(new_n96_), .c(new_n69_), .O(z8));
endmodule
