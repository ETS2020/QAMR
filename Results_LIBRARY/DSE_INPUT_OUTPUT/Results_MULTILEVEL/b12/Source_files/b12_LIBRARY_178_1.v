...
module FAU ( 
  ...
  aoi21  g16(.a(new_n40_), .b(x01), .c(x10), .O(new_n41_));
  ...
  nand2  g28(.a(new_n25_), .b(x09), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n51_), .c(new_n46_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n50_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n32_), .O(new_n57_));
  nand2  g33(.a(x10), .b(new_n45_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n57_), .c(new_n44_), .O(z2));
  inv1   g35(.a(x11), .O(new_n60_));
  inv1   g36(.a(x12), .O(new_n61_));
  oai22  g37(.a(new_n61_), .b(x00), .c(new_n60_), .d(new_n46_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n58_), .O(z3));
  nand3  g39(.a(x09), .b(x08), .c(x00), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n46_), .O(new_n65_));
  nand2  g41(.a(new_n60_), .b(x07), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n58_), .O(z4));
  inv1   g43(.a(x13), .O(new_n68_));
  nor2   g44(.a(new_n68_), .b(x12), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n25_), .c(new_n46_), .d(new_n45_), .O(z5));
  nand2  g46(.a(x08), .b(x00), .O(new_n71_));
  nand2  g47(.a(x09), .b(new_n26_), .O(new_n72_));
  nand2  g48(.a(new_n48_), .b(x03), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n27_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n71_), .c(new_n32_), .O(new_n75_));
  aoi21  g51(.a(x14), .b(x02), .c(x00), .O(new_n76_));
  nor2   g52(.a(x08), .b(new_n45_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n76_), .c(x01), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n75_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n25_), .c(new_n46_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  aoi21  g57(.a(new_n40_), .b(new_n32_), .c(x08), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n46_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n82_), .c(new_n25_), .O(new_n85_));
  nand2  g61(.a(x10), .b(x00), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(z7));
  nand4  g63(.a(new_n61_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n46_), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x10), .c(new_n86_), .O(z8));
endmodule
