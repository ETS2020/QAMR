// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:28 2020
...
module FAU ( 
  ...
  nand2  g07(.a(new_n31_), .b(x10), .O(new_n32_));
  ...
  nand3  g20(.a(x07), .b(new_n36_), .c(new_n35_), .O(new_n45_));
  ...
  nand3  g29(.a(x14), .b(x10), .c(new_n36_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n53_), .c(x00), .O(new_n55_));
  nand2  g31(.a(new_n52_), .b(x09), .O(new_n56_));
  ...
  oai22  g37(.a(new_n61_), .b(x00), .c(new_n60_), .d(new_n47_), .O(new_n62_));
  ...
  aoi22  g42(.a(new_n66_), .b(new_n65_), .c(new_n31_), .d(x10), .O(z4));
  nor2   g43(.a(x07), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n61_), .d(new_n52_), .O(z5));
  nor2   g45(.a(x02), .b(x00), .O(new_n70_));
  nor2   g46(.a(x08), .b(new_n34_), .O(new_n71_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n35_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n72_), .c(x10), .O(new_n79_));
  nand3  g55(.a(new_n31_), .b(x01), .c(new_n34_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n79_), .c(new_n47_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n32_), .O(z6));
  oai21  g59(.a(new_n41_), .b(x01), .c(new_n48_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n52_), .d(new_n47_), .O(z7));
  nand2  g62(.a(x14), .b(x10), .O(new_n87_));
  nand4  g63(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n47_), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x10), .c(new_n87_), .O(z8));
endmodule
