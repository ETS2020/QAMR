...
module FAU ( 
  ...
  nand3  g40(.a(new_n64_), .b(x10), .c(x07), .O(new_n65_));
  oai21  g41(.a(new_n63_), .b(x07), .c(new_n65_), .O(z4));
  oai21  g42(.a(x07), .b(new_n38_), .c(x10), .O(new_n67_));
  nand3  g43(.a(x13), .b(new_n58_), .c(new_n38_), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x07), .c(new_n67_), .O(z5));
  ...
  nor2   g59(.a(new_n73_), .b(new_n27_), .O(new_n84_));
