// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:38 2020
...
module FAU ( 
  ...
  oai21  g24(.a(new_n48_), .b(x02), .c(new_n44_), .O(new_n49_));
  nand3  g25(.a(x07), .b(new_n35_), .c(new_n34_), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n25_), .O(new_n51_));
  nand3  g27(.a(new_n51_), .b(new_n46_), .c(new_n33_), .O(new_n52_));
  oai21  g28(.a(new_n49_), .b(x07), .c(new_n52_), .O(z2));
  ...
  nand2  g36(.a(x10), .b(new_n33_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n60_), .c(new_n59_), .O(z4));
  inv1   g38(.a(x13), .O(new_n63_));
  nor2   g39(.a(new_n63_), .b(x12), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n46_), .c(new_n57_), .d(new_n33_), .O(z5));
  ...
  nand3  g45(.a(new_n69_), .b(new_n44_), .c(new_n34_), .O(new_n70_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n46_), .c(new_n57_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n31_), .O(z6));
  inv1   g52(.a(x08), .O(new_n77_));
  oai21  g53(.a(new_n40_), .b(x01), .c(new_n77_), .O(new_n78_));
  nand4  g54(.a(x09), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n78_), .c(new_n46_), .d(new_n57_), .O(z7));
  inv1   g56(.a(x12), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n82_));
  oai21  g58(.a(x09), .b(x00), .c(new_n46_), .O(new_n83_));
  aoi21  g59(.a(new_n82_), .b(x09), .c(new_n83_), .O(new_n84_));
  nand2  g60(.a(new_n46_), .b(x07), .O(new_n85_));
  oai21  g61(.a(new_n84_), .b(x07), .c(new_n85_), .O(z8));
endmodule
