...
module FAU ( 
  ...
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(x13), .d(new_n51_), .O(z5));
  ...
  nand4  g58(.a(x09), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n83_));
  ...
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n51_), .d(x06), .O(z8));
endmodule
