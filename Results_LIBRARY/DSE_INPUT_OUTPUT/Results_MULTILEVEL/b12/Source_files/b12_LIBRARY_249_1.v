...
module FAU ( 
  ...
  oai21  g37(.a(new_n58_), .b(new_n25_), .c(x07), .O(new_n62_));
  ...
  nand4  g41(.a(x13), .b(new_n59_), .c(new_n46_), .d(new_n38_), .O(new_n66_));
  ...
  aoi21  g60(.a(new_n82_), .b(new_n81_), .c(new_n84_), .O(new_n85_));
  ...
  aoi21  g64(.a(new_n71_), .b(new_n38_), .c(x07), .O(new_n89_));
