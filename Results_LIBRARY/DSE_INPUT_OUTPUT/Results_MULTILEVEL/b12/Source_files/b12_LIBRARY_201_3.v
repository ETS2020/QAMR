// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:30 2020
...
module FAU ( 
  ...
  nand3  g20(.a(x10), .b(new_n35_), .c(new_n34_), .O(new_n45_));
  ...
  oai21  g31(.a(new_n55_), .b(new_n52_), .c(new_n34_), .O(new_n56_));
  ...
  oai22  g38(.a(new_n62_), .b(new_n33_), .c(new_n59_), .d(new_n50_), .O(new_n63_));
  nand3  g39(.a(new_n31_), .b(new_n58_), .c(x07), .O(new_n64_));
  oai21  g40(.a(new_n63_), .b(x07), .c(new_n64_), .O(z4));
  oai21  g41(.a(x07), .b(x00), .c(new_n31_), .O(new_n66_));
  inv1   g42(.a(x13), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x12), .c(new_n50_), .O(new_n68_));
  oai21  g44(.a(x12), .b(new_n50_), .c(new_n68_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n49_), .c(new_n33_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n66_), .O(z5));
  nand2  g47(.a(x08), .b(x00), .O(new_n72_));
  nand2  g48(.a(x09), .b(new_n35_), .O(new_n73_));
  ...
  nor2   g54(.a(x08), .b(new_n33_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n78_), .c(x01), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n77_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n50_), .c(new_n49_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n31_), .O(z6));
  oai21  g59(.a(new_n40_), .b(x01), .c(new_n53_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n50_), .d(new_n49_), .O(z7));
  nand4  g62(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n74_), .b(new_n33_), .c(x10), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n49_), .O(z8));
endmodule
