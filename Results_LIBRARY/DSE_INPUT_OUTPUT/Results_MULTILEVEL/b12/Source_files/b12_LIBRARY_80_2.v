...
module FAU ( 
  ...
  oai21  g40(.a(new_n59_), .b(new_n25_), .c(x07), .O(new_n65_));
  ...
  oai21  g57(.a(new_n42_), .b(x01), .c(new_n53_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n25_), .d(new_n58_), .O(z7));
  nand4  g60(.a(new_n60_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n72_), .b(new_n38_), .c(x10), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n58_), .O(z8));
endmodule
