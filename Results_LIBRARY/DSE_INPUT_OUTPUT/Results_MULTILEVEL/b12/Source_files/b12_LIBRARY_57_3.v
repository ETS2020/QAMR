...
module FAU ( 
  ...
  nand4  g41(.a(new_n65_), .b(new_n47_), .c(new_n55_), .d(new_n37_), .O(z5));
  ...
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n47_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n55_), .O(new_n82_));
  nand2  g58(.a(new_n47_), .b(x07), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n82_), .O(z7));
  nand4  g60(.a(new_n57_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n68_), .b(new_n37_), .c(x10), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n55_), .O(z8));
endmodule
