...
module FAU ( 
  ...
  nand3  g10(.a(new_n34_), .b(x10), .c(new_n27_), .O(new_n35_));
  aoi21  g11(.a(new_n35_), .b(new_n33_), .c(new_n30_), .O(new_n36_));
  oai21  g12(.a(new_n36_), .b(new_n29_), .c(x01), .O(new_n37_));
  nor2   g13(.a(new_n25_), .b(x01), .O(new_n38_));
  nand4  g14(.a(new_n38_), .b(x10), .c(new_n27_), .d(x03), .O(new_n39_));
  aoi21  g15(.a(new_n39_), .b(new_n37_), .c(x00), .O(z0));
  aoi21  g16(.a(x10), .b(x03), .c(x04), .O(new_n41_));
  nand2  g17(.a(new_n34_), .b(x04), .O(new_n42_));
  oai21  g18(.a(new_n41_), .b(x01), .c(new_n42_), .O(new_n43_));
  nand2  g19(.a(new_n43_), .b(x02), .O(new_n44_));
  nand2  g20(.a(new_n36_), .b(x01), .O(new_n45_));
  aoi21  g21(.a(new_n45_), .b(new_n44_), .c(x00), .O(z1));
  oai21  g22(.a(x08), .b(x07), .c(x00), .O(new_n47_));
  inv1   g23(.a(x01), .O(new_n48_));
  nand3  g24(.a(x10), .b(new_n30_), .c(new_n48_), .O(new_n49_));
  ...
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n32_), .O(z4));
  inv1   g44(.a(x00), .O(new_n69_));
  nand4  g45(.a(x13), .b(new_n62_), .c(new_n53_), .d(new_n69_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x04), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n31_), .O(z5));
  ...
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n48_), .O(new_n78_));
  ...
  aoi21  g59(.a(new_n83_), .b(x04), .c(x10), .O(z6));
  nand3  g60(.a(x03), .b(new_n25_), .c(new_n48_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n56_), .O(new_n86_));
  nor2   g62(.a(x07), .b(new_n27_), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n25_), .d(new_n48_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n31_), .O(z7));
  nand4  g65(.a(new_n62_), .b(x03), .c(new_n25_), .d(new_n48_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n53_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n27_), .c(new_n31_), .O(z8));
endmodule
