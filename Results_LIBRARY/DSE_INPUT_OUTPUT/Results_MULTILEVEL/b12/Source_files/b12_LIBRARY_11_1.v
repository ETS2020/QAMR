...
module FAU ( 
  ...
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n56_), .d(new_n60_), .O(z5));
  ...
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n28_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n66_), .c(new_n33_), .O(new_n71_));
  ...
  nor2   g54(.a(new_n68_), .b(new_n27_), .O(new_n79_));
  aoi22  g55(.a(new_n79_), .b(new_n78_), .c(new_n77_), .d(new_n51_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x10), .c(new_n25_), .O(z7));
  nand3  g57(.a(new_n78_), .b(new_n56_), .c(x03), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n68_), .b(new_n38_), .c(x10), .O(new_n84_));
