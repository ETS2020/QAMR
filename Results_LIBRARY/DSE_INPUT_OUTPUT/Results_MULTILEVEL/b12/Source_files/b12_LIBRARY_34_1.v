...
module FAU ( 
  ...
  aoi21  g37(.a(x13), .b(new_n55_), .c(x07), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(x00), .c(new_n45_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n31_), .O(z5));
  ...
  nand4  g54(.a(x09), .b(x03), .c(new_n25_), .d(new_n65_), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n78_), .c(new_n45_), .d(new_n31_), .O(z7));
  nand4  g56(.a(new_n55_), .b(x03), .c(new_n25_), .d(new_n65_), .O(new_n81_));
  nor2   g57(.a(x09), .b(x00), .O(new_n82_));
  aoi21  g58(.a(new_n81_), .b(x09), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x10), .c(new_n31_), .O(z8));
endmodule
