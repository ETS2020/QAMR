...
module FAU ( 
  ...
  oai22  g30(.a(new_n54_), .b(x00), .c(new_n53_), .d(new_n49_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n45_), .O(z3));
  nand3  g32(.a(x09), .b(x08), .c(x00), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n49_), .O(new_n58_));
  nand2  g34(.a(new_n53_), .b(x07), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n58_), .c(new_n45_), .O(z4));
  ...
  oai21  g41(.a(x08), .b(new_n34_), .c(new_n65_), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n44_), .c(new_n49_), .d(x01), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(z6));
  oai21  g44(.a(new_n50_), .b(x07), .c(x01), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n44_), .O(z7));
