...
module FAU ( 
  ...
  oai21  g35(.a(new_n59_), .b(new_n50_), .c(x00), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(x12), .O(z3));
  nand3  g37(.a(x09), .b(x08), .c(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n50_), .O(new_n63_));
  oai21  g39(.a(new_n31_), .b(new_n59_), .c(x07), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n63_), .O(z4));
  oai21  g41(.a(x07), .b(new_n34_), .c(x12), .O(new_n66_));
  nand3  g42(.a(x13), .b(new_n51_), .c(new_n34_), .O(new_n67_));
  ...
  nand2  g61(.a(x12), .b(x07), .O(new_n86_));
  oai21  g62(.a(new_n85_), .b(x07), .c(new_n86_), .O(z7));
  oai21  g63(.a(x09), .b(x07), .c(x12), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n51_), .O(new_n89_));
  aoi21  g65(.a(new_n82_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x07), .c(new_n88_), .O(z8));
endmodule
