...
module FAU ( 
  ...
  oai22  g35(.a(new_n32_), .b(x00), .c(new_n59_), .d(new_n51_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n33_), .O(z3));
  nand3  g37(.a(x09), .b(x08), .c(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n51_), .O(new_n63_));
  nand2  g39(.a(new_n59_), .b(x07), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n33_), .O(z4));
  nand2  g41(.a(x08), .b(x00), .O(new_n67_));
  nand2  g42(.a(x09), .b(new_n36_), .O(new_n68_));
  inv1   g43(.a(x09), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(x03), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(new_n68_), .c(new_n25_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(new_n67_), .c(new_n46_), .O(new_n72_));
  aoi21  g47(.a(x14), .b(x02), .c(x00), .O(new_n73_));
  nor2   g48(.a(x08), .b(new_n35_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(new_n73_), .c(x01), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n72_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(x12), .c(new_n31_), .d(new_n51_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z6));
  nand3  g53(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n54_), .O(new_n80_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n81_));
  nor2   g56(.a(new_n32_), .b(x10), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n51_), .O(z7));
  nand3  g58(.a(new_n69_), .b(new_n51_), .c(x00), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(x12), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n31_), .O(z8));
  one    g61(.O(z5));
endmodule
