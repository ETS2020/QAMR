...
module FAU ( 
  ...
  aoi22  g45(.a(new_n69_), .b(new_n67_), .c(new_n45_), .d(x01), .O(z4));
  ...
  aoi21  g63(.a(new_n76_), .b(new_n36_), .c(x10), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n53_), .d(new_n25_), .O(z8));
endmodule
