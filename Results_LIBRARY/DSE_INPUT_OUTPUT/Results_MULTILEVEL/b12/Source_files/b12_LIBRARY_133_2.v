...
module FAU ( 
  ...
  oai21  g38(.a(new_n57_), .b(new_n31_), .c(x07), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n62_), .O(z4));
  inv1   g40(.a(x13), .O(new_n65_));
  nor2   g41(.a(new_n65_), .b(x12), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n31_), .c(new_n60_), .d(new_n34_), .O(z5));
  ...
  nand3  g53(.a(new_n77_), .b(new_n31_), .c(new_n60_), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  nand3  g55(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n80_));
  nor2   g56(.a(x02), .b(x01), .O(new_n81_));
  nor2   g57(.a(new_n70_), .b(new_n35_), .O(new_n82_));
  aoi22  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n52_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x07), .c(new_n31_), .O(z7));
  ...
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n60_), .O(z8));
endmodule
