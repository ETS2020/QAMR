...
module FAU ( 
  ...
  nand3  g51(.a(new_n75_), .b(new_n71_), .c(new_n45_), .O(new_n76_));
  ...
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n51_), .d(new_n50_), .O(z7));
  ...
  oai21  g65(.a(new_n89_), .b(x10), .c(new_n69_), .O(z8));
endmodule
