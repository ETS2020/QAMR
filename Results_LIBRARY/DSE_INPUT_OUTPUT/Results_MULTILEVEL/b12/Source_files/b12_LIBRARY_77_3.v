...
module FAU ( 
  ...
  aoi21  g43(.a(new_n67_), .b(new_n66_), .c(new_n64_), .O(z4));
  nor2   g44(.a(x07), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n61_), .d(new_n30_), .O(z5));
  ...
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n26_), .O(new_n75_));
  ...
  nand3  g56(.a(new_n80_), .b(new_n30_), .c(new_n52_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n25_), .O(z6));
  nand3  g58(.a(x03), .b(new_n26_), .c(new_n47_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n55_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n26_), .d(new_n47_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n52_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n30_), .O(new_n87_));
  oai21  g63(.a(new_n30_), .b(x05), .c(new_n87_), .O(z7));
  nand4  g64(.a(new_n61_), .b(x03), .c(new_n26_), .d(new_n47_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n73_), .b(new_n35_), .c(x10), .O(new_n91_));
