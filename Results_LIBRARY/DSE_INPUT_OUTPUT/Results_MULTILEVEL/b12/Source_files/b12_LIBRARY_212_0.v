...
module FAU ( 
  ...
  nor2   g06(.a(x14), .b(x12), .O(new_n31_));
  ...
  nand4  g43(.a(new_n67_), .b(x14), .c(x13), .d(new_n60_), .O(z5));
  ...
  nor2   g58(.a(new_n31_), .b(x10), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n50_), .O(z7));
  inv1   g60(.a(x14), .O(new_n85_));
  oai21  g61(.a(new_n60_), .b(x09), .c(new_n85_), .O(new_n86_));
  ...
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n86_), .d(new_n50_), .O(z8));
endmodule
