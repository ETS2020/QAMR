...
module FAU ( 
  ...
  nand4  g43(.a(x13), .b(new_n67_), .c(new_n49_), .d(new_n33_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n50_), .O(new_n69_));
  oai21  g45(.a(x14), .b(new_n50_), .c(new_n69_), .O(z5));
  ...
  oai21  g58(.a(new_n40_), .b(x01), .c(new_n53_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n50_), .d(new_n49_), .O(z7));
  nand4  g61(.a(new_n67_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n73_), .b(new_n33_), .c(x10), .O(new_n88_));
