...
module FAU ( 
  ...
  nor2   g21(.a(x11), .b(x10), .O(new_n46_));
  ...
  oai21  g25(.a(x11), .b(new_n45_), .c(new_n31_), .O(new_n50_));
  ...
  nand2  g32(.a(x10), .b(new_n45_), .O(new_n57_));
  aoi22  g33(.a(new_n57_), .b(x11), .c(x12), .d(new_n34_), .O(z3));
  inv1   g34(.a(x11), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n31_), .c(x07), .O(new_n60_));
  ...
  nand4  g40(.a(x13), .b(new_n64_), .c(new_n45_), .d(new_n34_), .O(new_n65_));
  ...
  oai21  g56(.a(new_n41_), .b(x01), .c(new_n80_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n81_), .c(new_n45_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n59_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n31_), .O(z7));
  nand4  g61(.a(new_n64_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n86_));
  oai21  g62(.a(x09), .b(x00), .c(new_n45_), .O(new_n87_));
  aoi21  g63(.a(new_n86_), .b(x09), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x11), .c(new_n31_), .O(z8));
endmodule
