...
module FAU ( 
  ...
  nand4  g48(.a(new_n72_), .b(new_n69_), .c(new_n42_), .d(new_n56_), .O(new_n73_));
  nor2   g49(.a(new_n73_), .b(x02), .O(z6));
  ...
  oai21  g55(.a(x09), .b(x00), .c(new_n56_), .O(new_n80_));
  aoi21  g56(.a(new_n79_), .b(x09), .c(new_n80_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(x02), .c(new_n42_), .O(z8));
endmodule
