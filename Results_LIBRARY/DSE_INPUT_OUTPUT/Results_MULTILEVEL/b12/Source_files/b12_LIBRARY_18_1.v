...
module FAU ( 
  ...
  aoi21  g17(.a(new_n41_), .b(x01), .c(x08), .O(new_n42_));
  ...
  nand3  g22(.a(x07), .b(new_n26_), .c(new_n32_), .O(new_n47_));
  ...
  nand4  g29(.a(new_n53_), .b(new_n25_), .c(new_n50_), .d(new_n32_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n49_), .c(new_n45_), .O(z2));
  inv1   g31(.a(x11), .O(new_n56_));
  inv1   g32(.a(x12), .O(new_n57_));
  oai22  g33(.a(new_n57_), .b(x00), .c(new_n56_), .d(new_n50_), .O(new_n58_));
  nand2  g34(.a(x08), .b(new_n46_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n58_), .O(z3));
  nor2   g36(.a(x09), .b(x07), .O(new_n61_));
  aoi21  g37(.a(new_n56_), .b(x07), .c(new_n61_), .O(new_n62_));
  aoi21  g38(.a(new_n56_), .b(new_n46_), .c(new_n50_), .O(new_n63_));
  oai22  g39(.a(new_n63_), .b(x08), .c(new_n62_), .d(new_n46_), .O(z4));
  inv1   g40(.a(x10), .O(new_n65_));
  nor3   g41(.a(x08), .b(x07), .c(x00), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n57_), .d(new_n65_), .O(z5));
  ...
  nand4  g48(.a(new_n72_), .b(new_n65_), .c(new_n25_), .d(new_n50_), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(z6));
  nand2  g50(.a(new_n65_), .b(new_n50_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n59_), .O(new_n76_));
  nand2  g52(.a(new_n32_), .b(x00), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n40_), .c(x08), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x09), .O(new_n79_));
  oai21  g55(.a(new_n40_), .b(x01), .c(new_n25_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n76_), .O(z7));
  oai21  g57(.a(new_n51_), .b(x08), .c(new_n46_), .O(new_n82_));
  nand4  g58(.a(new_n57_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(x09), .c(new_n75_), .O(new_n84_));
