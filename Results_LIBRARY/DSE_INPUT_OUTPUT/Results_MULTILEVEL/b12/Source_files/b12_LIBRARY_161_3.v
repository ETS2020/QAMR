...
module FAU ( 
  ...
  nand4  g39(.a(new_n63_), .b(new_n47_), .c(new_n58_), .d(new_n37_), .O(z5));
  ...
  nand3  g44(.a(new_n68_), .b(new_n45_), .c(new_n32_), .O(new_n69_));
  ...
  nand3  g49(.a(new_n73_), .b(new_n47_), .c(new_n58_), .O(new_n74_));
  ...
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n47_), .d(new_n58_), .O(z7));
