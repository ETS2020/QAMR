...
module FAU ( 
  ...
  nand3  g34(.a(new_n58_), .b(new_n49_), .c(new_n44_), .O(z2));
  aoi22  g35(.a(x12), .b(new_n34_), .c(x11), .d(x07), .O(z3));
  nand3  g36(.a(x09), .b(x08), .c(x00), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n51_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(x11), .O(z4));
  ...
  oai21  g43(.a(new_n67_), .b(x08), .c(x00), .O(new_n68_));
  ...
  nand3  g48(.a(new_n72_), .b(new_n68_), .c(new_n25_), .O(new_n73_));
  nand2  g49(.a(x14), .b(x02), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n34_), .O(new_n75_));
  nand3  g51(.a(x11), .b(new_n55_), .c(x00), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x01), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n73_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n52_), .c(new_n51_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(x03), .b(new_n27_), .c(new_n25_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n52_), .c(new_n51_), .O(new_n84_));
  aoi21  g60(.a(new_n82_), .b(new_n55_), .c(new_n84_), .O(new_n85_));
  nor2   g61(.a(new_n85_), .b(new_n43_), .O(z7));
  oai21  g62(.a(new_n67_), .b(new_n34_), .c(new_n70_), .O(new_n87_));
  nand4  g63(.a(new_n64_), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  nor2   g65(.a(new_n43_), .b(x10), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n87_), .d(new_n51_), .O(z8));
endmodule
