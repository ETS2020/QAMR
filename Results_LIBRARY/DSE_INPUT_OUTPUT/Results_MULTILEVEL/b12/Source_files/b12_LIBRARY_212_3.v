...
module FAU ( 
  ...
  nand2  g06(.a(x14), .b(x12), .O(new_n31_));
  ...
  nor2   g43(.a(new_n53_), .b(new_n33_), .O(new_n68_));
  ...
  nor2   g48(.a(x14), .b(new_n44_), .O(new_n73_));
  aoi21  g49(.a(new_n72_), .b(new_n44_), .c(new_n73_), .O(new_n74_));
  nor2   g50(.a(x02), .b(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n33_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(x01), .O(new_n77_));
  oai21  g53(.a(new_n74_), .b(new_n68_), .c(new_n77_), .O(new_n78_));
  ...
  aoi21  g59(.a(x14), .b(x12), .c(x10), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n49_), .O(z7));
  oai21  g61(.a(x14), .b(x09), .c(x12), .O(new_n86_));
  nand2  g62(.a(new_n81_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n70_), .b(new_n33_), .c(x10), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n49_), .O(z8));
endmodule
