...
module FAU ( 
  ...
  nor2   g56(.a(new_n53_), .b(new_n27_), .O(new_n81_));
  aoi22  g57(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(new_n52_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x10), .c(new_n25_), .O(z7));
  nand3  g59(.a(new_n80_), .b(new_n65_), .c(x03), .O(new_n84_));
