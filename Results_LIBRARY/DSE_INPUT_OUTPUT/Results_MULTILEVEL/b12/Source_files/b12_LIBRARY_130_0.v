...
module FAU ( 
  ...
  nand3  g10(.a(new_n33_), .b(new_n25_), .c(x01), .O(new_n35_));
  nand3  g11(.a(x06), .b(x05), .c(x01), .O(new_n36_));
  nand3  g12(.a(new_n36_), .b(x10), .c(x02), .O(new_n37_));
  nand2  g13(.a(new_n37_), .b(new_n35_), .O(new_n38_));
  nand2  g14(.a(new_n38_), .b(x03), .O(new_n39_));
  nand3  g15(.a(new_n36_), .b(x04), .c(x02), .O(new_n40_));
  ...
  nand2  g22(.a(new_n46_), .b(new_n42_), .O(new_n47_));
  nand2  g23(.a(x07), .b(new_n44_), .O(new_n48_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n33_), .O(z4));
  nor2   g42(.a(x12), .b(x10), .O(new_n67_));
  nor2   g43(.a(new_n31_), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(x13), .d(new_n49_), .O(z5));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  nand2  g46(.a(x09), .b(new_n44_), .O(new_n71_));
  inv1   g47(.a(x09), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x03), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n25_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n70_), .c(new_n43_), .O(new_n75_));
  aoi21  g51(.a(x14), .b(x02), .c(x00), .O(new_n76_));
  nor2   g52(.a(x08), .b(new_n58_), .O(new_n77_));
  ...
  aoi21  g56(.a(new_n80_), .b(x04), .c(x10), .O(z6));
  nand3  g57(.a(x03), .b(new_n25_), .c(new_n43_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n49_), .O(new_n84_));
  aoi21  g60(.a(new_n82_), .b(new_n52_), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n31_), .c(new_n32_), .O(z7));
  inv1   g62(.a(x12), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n72_), .b(new_n58_), .c(x10), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n49_), .d(x04), .O(z8));
endmodule
