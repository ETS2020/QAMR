...
module FAU ( 
  ...
  aoi21  g42(.a(new_n66_), .b(new_n64_), .c(new_n62_), .O(z4));
  inv1   g43(.a(x12), .O(new_n68_));
  nor2   g44(.a(x07), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n68_), .d(new_n50_), .O(z5));
  ...
  nand4  g61(.a(new_n68_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n86_));
