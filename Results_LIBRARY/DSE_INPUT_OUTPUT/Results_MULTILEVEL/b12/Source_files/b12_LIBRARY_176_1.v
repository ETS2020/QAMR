...
module FAU ( 
  ...
  nand2  g39(.a(new_n63_), .b(new_n59_), .O(z3));
  nand3  g40(.a(new_n62_), .b(new_n25_), .c(new_n37_), .O(new_n65_));
  inv1   g41(.a(x11), .O(new_n66_));
  aoi21  g42(.a(x09), .b(x08), .c(x07), .O(new_n67_));
  aoi21  g43(.a(new_n66_), .b(x07), .c(new_n67_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n37_), .c(new_n65_), .O(z4));
  nor2   g45(.a(x07), .b(x00), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(x13), .c(new_n61_), .d(new_n25_), .O(z5));
  ...
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n25_), .d(new_n47_), .O(z7));
  nand4  g61(.a(new_n61_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n49_), .b(new_n37_), .c(x10), .O(new_n88_));
