...
module FAU ( 
  ...
  oai22  g36(.a(new_n60_), .b(new_n34_), .c(new_n57_), .d(x10), .O(new_n61_));
  nand3  g37(.a(new_n32_), .b(new_n56_), .c(x07), .O(new_n62_));
  ...
  nand4  g53(.a(new_n77_), .b(new_n57_), .c(new_n31_), .d(new_n44_), .O(new_n78_));
  ...
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n45_), .d(new_n44_), .O(z7));
  oai21  g60(.a(x09), .b(x00), .c(new_n44_), .O(new_n85_));
  aoi21  g61(.a(new_n81_), .b(x09), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x12), .c(new_n31_), .O(z8));
endmodule
