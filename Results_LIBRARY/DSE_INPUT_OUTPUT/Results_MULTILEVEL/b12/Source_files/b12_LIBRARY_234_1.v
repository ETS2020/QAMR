...
module FAU ( 
  ...
  aoi22  g41(.a(new_n65_), .b(new_n63_), .c(x10), .d(new_n25_), .O(z4));
  ...
  nand3  g55(.a(new_n79_), .b(new_n27_), .c(new_n47_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  oai21  g57(.a(x10), .b(new_n48_), .c(x01), .O(new_n82_));
  oai21  g58(.a(new_n50_), .b(x02), .c(new_n48_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n36_), .d(new_n25_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n47_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n27_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n82_), .O(z7));
  nand4  g63(.a(new_n67_), .b(x03), .c(new_n36_), .d(new_n25_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n72_), .b(new_n35_), .c(x10), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n89_), .c(new_n47_), .O(z8));
endmodule
