...
module FAU ( 
  ...
  oai21  g26(.a(new_n50_), .b(new_n48_), .c(new_n37_), .O(new_n51_));
  ...
  nand3  g31(.a(new_n55_), .b(new_n52_), .c(new_n47_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n51_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n32_), .O(new_n58_));
  nand2  g34(.a(x10), .b(new_n37_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n58_), .c(new_n46_), .O(z2));
  inv1   g36(.a(x12), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n25_), .O(new_n62_));
  aoi22  g38(.a(new_n62_), .b(new_n37_), .c(x11), .d(x07), .O(z3));
  inv1   g39(.a(x11), .O(new_n64_));
  nand3  g40(.a(new_n59_), .b(new_n64_), .c(x07), .O(new_n65_));
  aoi21  g41(.a(x09), .b(x08), .c(new_n37_), .O(new_n66_));
  aoi21  g42(.a(new_n25_), .b(new_n37_), .c(new_n66_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x07), .c(new_n65_), .O(z4));
  nand2  g44(.a(x13), .b(new_n61_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n37_), .c(x07), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x10), .c(new_n37_), .O(z5));
  oai21  g47(.a(x10), .b(x08), .c(x00), .O(new_n72_));
  nand2  g48(.a(x09), .b(new_n26_), .O(new_n73_));
  nand2  g49(.a(new_n49_), .b(x03), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n27_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n72_), .c(new_n32_), .O(new_n76_));
  nand2  g52(.a(x14), .b(x02), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n37_), .O(new_n78_));
  nand3  g54(.a(new_n25_), .b(new_n52_), .c(x00), .O(new_n79_));
  ...
  nand2  g58(.a(new_n82_), .b(new_n47_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n59_), .O(z6));
  oai21  g60(.a(new_n41_), .b(x01), .c(new_n52_), .O(new_n85_));
  nand4  g61(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n47_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n25_), .O(new_n88_));
  nand2  g64(.a(x10), .b(x00), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n88_), .O(z7));
  nand4  g66(.a(new_n61_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n49_), .b(new_n37_), .c(x10), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n47_), .O(z8));
endmodule
