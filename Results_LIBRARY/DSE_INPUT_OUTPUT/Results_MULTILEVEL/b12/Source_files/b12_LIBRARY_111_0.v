...
module FAU ( 
  ...
  nand4  g23(.a(new_n47_), .b(new_n46_), .c(x09), .d(x04), .O(new_n48_));
  inv1   g24(.a(x08), .O(new_n49_));
  nand3  g25(.a(x10), .b(new_n49_), .c(new_n30_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n48_), .c(x07), .O(new_n51_));
  aoi21  g27(.a(x07), .b(x04), .c(x10), .O(new_n52_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n36_), .O(z4));
  nor2   g42(.a(x12), .b(x10), .O(new_n67_));
  nor2   g43(.a(new_n27_), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(x13), .d(new_n58_), .O(z5));
  ...
  nand3  g49(.a(new_n73_), .b(new_n47_), .c(new_n45_), .O(new_n74_));
  ...
  nand4  g54(.a(new_n78_), .b(new_n46_), .c(new_n58_), .d(x04), .O(new_n79_));
  ...
  oai21  g60(.a(new_n84_), .b(new_n27_), .c(new_n46_), .O(z7));
  nand4  g61(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n71_), .b(new_n37_), .c(x10), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n58_), .d(x04), .O(z8));
endmodule
