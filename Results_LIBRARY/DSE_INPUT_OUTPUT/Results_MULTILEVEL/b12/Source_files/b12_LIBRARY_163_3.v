...
module FAU ( 
  ...
  nand3  g45(.a(new_n69_), .b(new_n43_), .c(new_n49_), .O(new_n70_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n45_), .c(new_n57_), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(z6));
  inv1   g52(.a(x08), .O(new_n77_));
  nand3  g53(.a(x03), .b(new_n25_), .c(new_n49_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n49_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n45_), .d(new_n57_), .O(z7));
  nand4  g57(.a(new_n62_), .b(x03), .c(new_n25_), .d(new_n49_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n67_), .b(new_n33_), .c(x10), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n57_), .O(z8));
endmodule
