...
module FAU ( 
  ...
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n53_), .d(new_n51_), .O(z5));
  ...
  nand3  g54(.a(new_n78_), .b(new_n51_), .c(new_n46_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand2  g56(.a(new_n53_), .b(x10), .O(new_n81_));
  ...
  aoi21  g60(.a(new_n82_), .b(new_n47_), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x10), .c(new_n81_), .O(z7));
  nand4  g62(.a(new_n53_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n87_));
