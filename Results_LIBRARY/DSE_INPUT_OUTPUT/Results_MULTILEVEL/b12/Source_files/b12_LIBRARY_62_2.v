...
module FAU ( 
  ...
  nand2  g29(.a(x13), .b(x09), .O(new_n54_));
  oai21  g30(.a(new_n53_), .b(x09), .c(new_n54_), .O(new_n55_));
  oai21  g31(.a(x08), .b(x07), .c(x00), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n55_), .c(new_n27_), .O(new_n57_));
  aoi21  g33(.a(x08), .b(x00), .c(new_n25_), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n53_), .c(x09), .d(new_n48_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n33_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n52_), .O(z2));
  ...
  nand4  g42(.a(x13), .b(x09), .c(x08), .d(x00), .O(new_n67_));
  ...
  nand2  g46(.a(new_n64_), .b(new_n53_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n38_), .c(new_n25_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n26_), .c(new_n48_), .d(new_n38_), .O(z5));
  nand2  g49(.a(new_n33_), .b(new_n38_), .O(new_n74_));
  nand2  g50(.a(new_n49_), .b(x00), .O(new_n75_));
  ...
  nand3  g61(.a(new_n85_), .b(new_n53_), .c(new_n48_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n26_), .O(z6));
  nand2  g63(.a(new_n53_), .b(new_n48_), .O(new_n88_));
  aoi22  g64(.a(new_n88_), .b(x13), .c(new_n26_), .d(new_n49_), .O(new_n89_));
  nand3  g65(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(new_n91_));
  nand3  g67(.a(x13), .b(x09), .c(x03), .O(new_n92_));
  nor3   g68(.a(new_n92_), .b(x02), .c(x01), .O(new_n93_));
  aoi21  g69(.a(new_n88_), .b(new_n78_), .c(new_n93_), .O(new_n94_));
  oai21  g70(.a(new_n91_), .b(new_n89_), .c(new_n94_), .O(z7));
  nand2  g71(.a(new_n88_), .b(new_n26_), .O(new_n96_));
  nand4  g72(.a(new_n64_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n97_));
  nand3  g73(.a(new_n97_), .b(x13), .c(x09), .O(new_n98_));
  nand2  g74(.a(new_n78_), .b(new_n38_), .O(new_n99_));
  nand3  g75(.a(new_n99_), .b(new_n98_), .c(new_n96_), .O(z8));
endmodule
