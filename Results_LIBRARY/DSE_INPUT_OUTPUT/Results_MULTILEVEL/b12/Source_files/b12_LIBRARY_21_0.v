...
module FAU ( 
  ...
  aoi21  g37(.a(x12), .b(new_n39_), .c(new_n31_), .O(new_n62_));
  oai21  g38(.a(new_n61_), .b(new_n53_), .c(new_n62_), .O(new_n63_));
  ...
  nand4  g65(.a(new_n89_), .b(x03), .c(new_n43_), .d(new_n25_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n53_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n26_), .c(new_n34_), .O(z8));
endmodule
