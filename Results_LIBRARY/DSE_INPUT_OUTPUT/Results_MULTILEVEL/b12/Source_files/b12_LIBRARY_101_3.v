...
module FAU ( 
  ...
  nand4  g44(.a(x13), .b(new_n54_), .c(new_n47_), .d(new_n37_), .O(new_n69_));
  ...
  nand4  g63(.a(new_n54_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n47_), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x10), .c(new_n68_), .O(z8));
endmodule
