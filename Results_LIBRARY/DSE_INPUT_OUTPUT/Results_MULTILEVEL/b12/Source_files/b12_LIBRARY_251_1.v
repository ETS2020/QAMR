...
module FAU ( 
  ...
  nand3  g19(.a(x07), .b(new_n35_), .c(new_n43_), .O(new_n44_));
  ...
  oai21  g25(.a(new_n49_), .b(new_n45_), .c(new_n32_), .O(new_n50_));
  nand3  g26(.a(x10), .b(x04), .c(new_n35_), .O(new_n51_));
  inv1   g27(.a(x10), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(x09), .c(new_n46_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n51_), .c(x00), .O(new_n54_));
  nand2  g30(.a(new_n52_), .b(x09), .O(new_n55_));
  aoi21  g31(.a(new_n55_), .b(new_n51_), .c(x08), .O(new_n56_));
  aoi21  g32(.a(new_n56_), .b(new_n46_), .c(new_n54_), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(x01), .c(new_n50_), .O(z2));
  ...
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n32_), .O(z4));
  nand2  g43(.a(x10), .b(x04), .O(new_n68_));
  inv1   g44(.a(x12), .O(new_n69_));
  nand4  g45(.a(x13), .b(new_n69_), .c(new_n46_), .d(new_n34_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n52_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n68_), .O(z5));
  ...
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n43_), .O(new_n78_));
  ...
  nand3  g58(.a(new_n82_), .b(new_n52_), .c(new_n46_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  nand3  g60(.a(x03), .b(new_n25_), .c(new_n43_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n47_), .O(new_n86_));
  nand4  g62(.a(x09), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n52_), .d(new_n46_), .O(z7));
  nand4  g64(.a(new_n69_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n89_));
  oai21  g65(.a(x09), .b(x00), .c(new_n46_), .O(new_n90_));
  aoi21  g66(.a(new_n89_), .b(x09), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x10), .c(new_n68_), .O(z8));
endmodule
