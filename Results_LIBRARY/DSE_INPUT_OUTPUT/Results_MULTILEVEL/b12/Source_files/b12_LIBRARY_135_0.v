...
module FAU ( 
  ...
  nand4  g41(.a(x13), .b(new_n59_), .c(new_n57_), .d(new_n35_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x06), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n32_), .O(z5));
  ...
  oai21  g61(.a(x09), .b(x00), .c(new_n57_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n31_), .c(new_n32_), .O(z8));
endmodule
