// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:21 2020
...
module FAU ( 
  ...
  nand2  g23(.a(x07), .b(new_n37_), .O(new_n48_));
  nand2  g24(.a(x09), .b(new_n33_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n48_), .c(x00), .O(new_n50_));
  inv1   g26(.a(x08), .O(new_n51_));
  nand3  g27(.a(x09), .b(new_n51_), .c(new_n33_), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n50_), .c(new_n47_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n46_), .c(new_n34_), .O(z2));
  inv1   g31(.a(x10), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n33_), .O(new_n57_));
  inv1   g33(.a(x11), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(x07), .O(new_n59_));
  aoi22  g35(.a(new_n59_), .b(new_n57_), .c(x12), .d(new_n36_), .O(z3));
  nand2  g36(.a(x08), .b(x00), .O(new_n61_));
  nand2  g37(.a(new_n56_), .b(x09), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n61_), .c(new_n33_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n59_), .O(z4));
  inv1   g40(.a(x12), .O(new_n65_));
  nand3  g41(.a(x13), .b(new_n65_), .c(new_n36_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n56_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n33_), .O(z5));
  ...
  nand3  g48(.a(new_n72_), .b(new_n61_), .c(new_n47_), .O(new_n73_));
  nand2  g49(.a(x14), .b(x02), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n36_), .O(new_n75_));
  nand2  g51(.a(new_n51_), .b(x00), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(x01), .c(x10), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n73_), .c(x07), .O(z6));
  nand3  g55(.a(x03), .b(new_n25_), .c(new_n47_), .O(new_n80_));
  nor2   g56(.a(x02), .b(x01), .O(new_n81_));
  nor2   g57(.a(new_n70_), .b(new_n37_), .O(new_n82_));
  aoi22  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n51_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x10), .c(new_n33_), .O(z7));
  nand3  g60(.a(new_n81_), .b(new_n65_), .c(x03), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n70_), .b(new_n36_), .c(x10), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n33_), .O(z8));
endmodule
