...
module FAU ( 
  ...
  nand2  g34(.a(new_n58_), .b(new_n34_), .O(z3));
  inv1   g35(.a(x10), .O(new_n60_));
  nand3  g36(.a(x09), .b(x08), .c(x00), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n60_), .c(new_n33_), .O(new_n62_));
  oai21  g38(.a(x11), .b(new_n33_), .c(new_n62_), .O(z4));
  aoi21  g39(.a(x13), .b(new_n56_), .c(x07), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(x00), .c(new_n60_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n33_), .O(z5));
  ...
  aoi21  g52(.a(new_n76_), .b(x01), .c(x10), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n72_), .c(x07), .O(z6));
  nand3  g54(.a(x03), .b(new_n25_), .c(new_n47_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n51_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n60_), .d(new_n33_), .O(z7));
  nand4  g58(.a(new_n56_), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n69_), .b(new_n36_), .c(x10), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n33_), .O(z8));
endmodule
