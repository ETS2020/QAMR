...
module FAU ( 
  ...
  nand2  g37(.a(new_n61_), .b(x09), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n60_), .c(new_n25_), .O(new_n63_));
  oai21  g39(.a(x11), .b(new_n25_), .c(new_n63_), .O(z4));
  nand3  g40(.a(x13), .b(new_n56_), .c(new_n38_), .O(new_n65_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n60_), .c(new_n33_), .O(new_n72_));
