// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:24 2020
...
module FAU ( 
  ...
  nand2  g12(.a(new_n31_), .b(new_n36_), .O(new_n37_));
  ...
  nand4  g21(.a(new_n45_), .b(new_n32_), .c(x09), .d(x04), .O(new_n46_));
  inv1   g22(.a(x08), .O(new_n47_));
  nand3  g23(.a(x10), .b(new_n47_), .c(new_n36_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n46_), .c(x07), .O(new_n49_));
  aoi21  g25(.a(x07), .b(x04), .c(x10), .O(new_n50_));
  ...
  nand3  g29(.a(new_n53_), .b(new_n33_), .c(x02), .O(new_n54_));
  ...
  nand2  g35(.a(new_n59_), .b(new_n33_), .O(z3));
  nand2  g36(.a(x09), .b(x08), .O(new_n61_));
  oai22  g37(.a(new_n61_), .b(new_n35_), .c(x10), .d(x04), .O(new_n62_));
  nand3  g38(.a(new_n33_), .b(new_n57_), .c(x07), .O(new_n63_));
  oai21  g39(.a(new_n62_), .b(x07), .c(new_n63_), .O(z4));
  nand4  g40(.a(x13), .b(new_n58_), .c(new_n56_), .d(new_n35_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x04), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n32_), .O(z5));
  ...
  nand3  g47(.a(new_n71_), .b(new_n45_), .c(new_n44_), .O(new_n72_));
  aoi21  g48(.a(x14), .b(x02), .c(x00), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n35_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(x01), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n72_), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n32_), .c(new_n56_), .d(x04), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(z6));
  nand3  g54(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n47_), .O(new_n80_));
  nor2   g56(.a(x07), .b(new_n31_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n32_), .O(z7));
  nand4  g59(.a(new_n58_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n84_));
  oai21  g60(.a(x09), .b(x00), .c(new_n56_), .O(new_n85_));
  aoi21  g61(.a(new_n84_), .b(x09), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n31_), .c(new_n32_), .O(z8));
endmodule
