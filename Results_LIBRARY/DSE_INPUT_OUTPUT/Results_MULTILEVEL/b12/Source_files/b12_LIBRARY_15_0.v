...
module FAU ( 
  ...
  nor2   g30(.a(new_n48_), .b(x03), .O(new_n55_));
  ...
  nand4  g35(.a(new_n59_), .b(x11), .c(new_n54_), .d(new_n25_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n53_), .O(z2));
  inv1   g37(.a(x12), .O(new_n62_));
  oai22  g38(.a(new_n62_), .b(x00), .c(new_n26_), .d(new_n25_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n27_), .O(z3));
  nand3  g40(.a(x09), .b(x08), .c(x00), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n25_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x11), .O(z4));
  nor3   g43(.a(x10), .b(x07), .c(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n62_), .d(x11), .O(z5));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  nand2  g46(.a(x09), .b(new_n28_), .O(new_n71_));
  nand2  g47(.a(new_n56_), .b(x03), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n29_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n70_), .c(new_n34_), .O(new_n74_));
  ...
  nand2  g54(.a(new_n78_), .b(new_n48_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(x11), .c(x07), .O(z6));
  ...
  nand4  g61(.a(new_n62_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n86_));
