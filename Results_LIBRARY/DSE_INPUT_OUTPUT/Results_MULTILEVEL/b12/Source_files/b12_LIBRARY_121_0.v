...
module FAU ( 
  ...
  aoi21  g29(.a(x14), .b(x07), .c(x10), .O(new_n54_));
  nor3   g30(.a(new_n54_), .b(x03), .c(x00), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n53_), .c(new_n34_), .O(new_n56_));
  ...
  nor3   g46(.a(x10), .b(x07), .c(x00), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(x14), .c(x13), .d(new_n70_), .O(z5));
  ...
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n29_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n76_), .c(new_n34_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n75_), .O(new_n82_));
  ...
  nand4  g65(.a(new_n70_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n64_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n26_), .c(new_n25_), .O(z8));
endmodule
