...
module FAU ( 
  ...
  oai21  g37(.a(x08), .b(new_n45_), .c(x10), .O(new_n62_));
  ...
  nand4  g42(.a(x13), .b(new_n59_), .c(new_n45_), .d(new_n37_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n46_), .O(new_n68_));
  oai21  g44(.a(new_n46_), .b(x08), .c(new_n68_), .O(z5));
  ...
  nand4  g61(.a(new_n59_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n86_));
