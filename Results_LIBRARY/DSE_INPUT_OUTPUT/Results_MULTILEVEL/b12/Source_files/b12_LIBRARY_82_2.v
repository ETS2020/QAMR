...
module FAU ( 
  ...
  nand2  g28(.a(x12), .b(new_n38_), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(new_n52_), .c(new_n26_), .O(new_n54_));
  inv1   g30(.a(new_n54_), .O(z3));
  inv1   g31(.a(x11), .O(new_n56_));
  nand3  g32(.a(new_n26_), .b(new_n56_), .c(x07), .O(new_n57_));
  ...
  nand4  g39(.a(x13), .b(new_n63_), .c(new_n62_), .d(new_n38_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n58_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n25_), .O(z5));
  nand2  g42(.a(new_n33_), .b(new_n38_), .O(new_n67_));
  nor2   g43(.a(x03), .b(x02), .O(new_n68_));
  inv1   g44(.a(x08), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x00), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n67_), .c(new_n68_), .O(new_n71_));
  nand2  g47(.a(x14), .b(x02), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n38_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n70_), .c(new_n33_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n71_), .c(new_n62_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n58_), .c(x10), .O(z6));
  nand3  g52(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n69_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n25_), .c(new_n58_), .d(new_n62_), .O(z7));
  oai21  g55(.a(x07), .b(new_n38_), .c(new_n58_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n25_), .O(z8));
endmodule
