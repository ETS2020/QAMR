...
module FAU ( 
  ...
  nand2  g28(.a(new_n52_), .b(new_n48_), .O(z3));
  nand2  g29(.a(x09), .b(x08), .O(new_n54_));
  oai22  g30(.a(new_n54_), .b(new_n27_), .c(x10), .d(x02), .O(new_n55_));
  nand3  g31(.a(new_n48_), .b(new_n50_), .c(x07), .O(new_n56_));
  oai21  g32(.a(new_n55_), .b(x07), .c(new_n56_), .O(z4));
  nand4  g33(.a(x13), .b(new_n51_), .c(new_n44_), .d(new_n27_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(x02), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n47_), .O(z5));
  nand2  g36(.a(x14), .b(x01), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n27_), .O(new_n62_));
  nand2  g38(.a(new_n45_), .b(x00), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n47_), .c(new_n44_), .d(x02), .O(new_n65_));
  ...
  nand3  g45(.a(new_n69_), .b(new_n44_), .c(x00), .O(new_n70_));
