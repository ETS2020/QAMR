...
module FAU ( 
  ...
  nor2   g35(.a(x11), .b(new_n48_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n48_), .c(new_n46_), .O(new_n61_));
  nand2  g37(.a(x09), .b(x08), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n48_), .c(new_n60_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n49_), .c(new_n61_), .O(z4));
  oai21  g40(.a(x11), .b(new_n49_), .c(x00), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x07), .O(new_n66_));
  nand3  g42(.a(x13), .b(new_n57_), .c(new_n49_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n46_), .O(new_n68_));
  nand2  g44(.a(new_n62_), .b(x10), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n48_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n66_), .c(new_n56_), .O(z5));
  aoi21  g48(.a(x14), .b(x02), .c(new_n25_), .O(new_n73_));
  xnor2a g49(.a(x09), .b(x03), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n27_), .c(x01), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n73_), .c(new_n48_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n46_), .c(x10), .O(z6));
  aoi21  g53(.a(new_n39_), .b(new_n25_), .c(x08), .O(new_n78_));
  nand4  g54(.a(x09), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n48_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n78_), .c(new_n46_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n49_), .O(z7));
  nand4  g58(.a(new_n57_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n39_), .c(new_n25_), .d(new_n46_), .O(z8));
endmodule
