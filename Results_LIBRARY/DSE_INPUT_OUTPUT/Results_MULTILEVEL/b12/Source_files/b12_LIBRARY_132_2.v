...
module FAU ( 
  ...
  nand2  g46(.a(x13), .b(x10), .O(new_n71_));
  ...
  nand4  g61(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n50_), .O(new_n87_));
  aoi21  g63(.a(new_n85_), .b(new_n54_), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x10), .c(new_n71_), .O(z7));
  nand4  g65(.a(new_n68_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  aoi21  g67(.a(new_n75_), .b(new_n34_), .c(x10), .O(new_n92_));
