...
module FAU ( 
  ...
  nand2  g38(.a(new_n58_), .b(new_n62_), .O(new_n63_));
  nand2  g39(.a(x08), .b(x00), .O(new_n64_));
  nor2   g40(.a(x11), .b(new_n50_), .O(new_n65_));
  aoi21  g41(.a(new_n64_), .b(new_n50_), .c(new_n65_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(x10), .c(new_n63_), .O(z4));
  inv1   g43(.a(x10), .O(new_n68_));
  inv1   g44(.a(x12), .O(new_n69_));
  nor2   g45(.a(x07), .b(x00), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(x13), .c(new_n69_), .d(new_n68_), .O(z5));
  nand2  g47(.a(x09), .b(new_n26_), .O(new_n72_));
  nand2  g48(.a(new_n62_), .b(x03), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n27_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n64_), .c(new_n32_), .O(new_n75_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n68_), .c(new_n50_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  oai21  g57(.a(new_n41_), .b(x01), .c(new_n53_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n68_), .d(new_n50_), .O(z7));
  nand4  g60(.a(new_n69_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n62_), .b(new_n37_), .c(x10), .O(new_n87_));
