...
module FAU ( 
  ...
  nand2  g43(.a(x10), .b(x06), .O(new_n68_));
  nand4  g44(.a(x13), .b(new_n61_), .c(new_n47_), .d(new_n34_), .O(new_n69_));
  ...
  nand3  g52(.a(new_n76_), .b(new_n72_), .c(new_n44_), .O(new_n77_));
  ...
  nand3  g57(.a(new_n81_), .b(new_n53_), .c(new_n47_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n32_), .O(z6));
  nand3  g59(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n85_));
  ...
  nand4  g64(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n89_));
