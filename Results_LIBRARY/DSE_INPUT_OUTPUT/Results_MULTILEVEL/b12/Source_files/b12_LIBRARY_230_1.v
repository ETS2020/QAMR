...
module FAU ( 
  ...
  nand4  g36(.a(new_n47_), .b(x09), .c(x08), .d(x00), .O(new_n61_));
  ...
  nand4  g41(.a(new_n65_), .b(new_n47_), .c(new_n25_), .d(new_n38_), .O(z5));
  ...
  oai21  g52(.a(new_n42_), .b(x01), .c(new_n52_), .O(new_n77_));
  nand4  g53(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n47_), .d(new_n25_), .O(z7));
  inv1   g55(.a(x12), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n81_));
