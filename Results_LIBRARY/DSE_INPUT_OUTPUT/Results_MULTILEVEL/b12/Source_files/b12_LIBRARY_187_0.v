...
module FAU ( 
  ...
  nand3  g34(.a(new_n58_), .b(new_n50_), .c(z5), .O(z2));
  inv1   g35(.a(x11), .O(new_n60_));
  oai22  g36(.a(new_n26_), .b(x00), .c(new_n60_), .d(new_n52_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(z5), .O(z3));
  nand3  g38(.a(x09), .b(x08), .c(x00), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n52_), .O(new_n64_));
  nand2  g40(.a(new_n60_), .b(x07), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(z5), .O(z4));
  ...
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n29_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n67_), .c(new_n34_), .O(new_n72_));
  aoi21  g48(.a(x14), .b(x02), .c(x00), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n39_), .O(new_n74_));
  ...
  aoi21  g53(.a(new_n77_), .b(x12), .c(x10), .O(z6));
  nand3  g54(.a(x03), .b(new_n29_), .c(new_n34_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n52_), .O(new_n81_));
  aoi21  g57(.a(new_n79_), .b(new_n55_), .c(new_n81_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n26_), .c(new_n25_), .O(z7));
  nand3  g59(.a(new_n69_), .b(new_n52_), .c(x00), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x12), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n25_), .O(z8));
endmodule
