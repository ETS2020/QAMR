...
module FAU ( 
  ...
  nand3  g20(.a(x10), .b(new_n44_), .c(new_n34_), .O(new_n45_));
  ...
  nand4  g28(.a(new_n31_), .b(x09), .c(new_n52_), .d(new_n49_), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n51_), .c(new_n34_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n47_), .c(new_n32_), .O(z2));
  ...
  inv1   g37(.a(x06), .O(new_n62_));
  nand2  g38(.a(x09), .b(x08), .O(new_n63_));
  oai22  g39(.a(new_n63_), .b(new_n61_), .c(x10), .d(new_n62_), .O(new_n64_));
  nand3  g40(.a(new_n32_), .b(new_n57_), .c(x07), .O(new_n65_));
  oai21  g41(.a(new_n64_), .b(x07), .c(new_n65_), .O(z4));
  nand4  g42(.a(x13), .b(new_n58_), .c(new_n49_), .d(new_n61_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n62_), .O(new_n68_));
  ...
  nor2   g52(.a(x08), .b(new_n61_), .O(new_n77_));
  ...
  aoi21  g56(.a(new_n80_), .b(new_n62_), .c(x10), .O(z6));
  ...
  nand4  g62(.a(new_n58_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n49_), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x06), .c(new_n31_), .O(z8));
endmodule
