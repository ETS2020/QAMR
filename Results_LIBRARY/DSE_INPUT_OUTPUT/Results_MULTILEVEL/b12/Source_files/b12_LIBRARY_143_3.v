...
module FAU ( 
  ...
  nand4  g52(.a(x09), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n48_), .O(new_n78_));
  aoi21  g54(.a(new_n76_), .b(new_n75_), .c(new_n78_), .O(new_n79_));
  nand2  g55(.a(new_n48_), .b(x07), .O(new_n80_));
  oai21  g56(.a(new_n79_), .b(x07), .c(new_n80_), .O(z7));
  inv1   g57(.a(x12), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n65_), .b(new_n33_), .c(x10), .O(new_n85_));
