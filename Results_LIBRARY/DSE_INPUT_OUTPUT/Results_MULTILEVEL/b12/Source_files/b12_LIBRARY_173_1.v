...
module FAU ( 
  ...
  nor2   g36(.a(x09), .b(x07), .O(new_n61_));
  aoi21  g37(.a(new_n56_), .b(x07), .c(new_n61_), .O(new_n62_));
  oai21  g38(.a(new_n56_), .b(new_n50_), .c(new_n46_), .O(new_n63_));
  oai21  g39(.a(new_n62_), .b(new_n45_), .c(new_n63_), .O(z4));
  inv1   g40(.a(x10), .O(new_n65_));
  nand4  g41(.a(x13), .b(new_n57_), .c(new_n65_), .d(new_n50_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n46_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n45_), .O(z5));
  ...
  nand2  g51(.a(new_n65_), .b(new_n50_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n59_), .O(new_n77_));
  nand2  g53(.a(new_n25_), .b(x00), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n39_), .c(x08), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(x09), .O(new_n80_));
  oai21  g56(.a(new_n39_), .b(x01), .c(new_n46_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n77_), .O(z7));
  oai21  g58(.a(new_n51_), .b(x08), .c(new_n45_), .O(new_n83_));
  nand4  g59(.a(new_n57_), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(x09), .c(new_n76_), .O(new_n85_));
