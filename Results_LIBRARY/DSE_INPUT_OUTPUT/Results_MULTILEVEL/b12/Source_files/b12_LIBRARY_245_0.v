...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n89_, new_n90_;
  nor2   g00(.a(x09), .b(x08), .O(new_n25_));
  ...
  oai21  g25(.a(new_n49_), .b(new_n27_), .c(new_n48_), .O(new_n50_));
  nand3  g26(.a(new_n49_), .b(x09), .c(new_n38_), .O(new_n51_));
  ...
  nand2  g33(.a(x12), .b(new_n38_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n57_), .c(new_n26_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(z3));
  inv1   g36(.a(x11), .O(new_n61_));
  nand3  g37(.a(new_n26_), .b(new_n61_), .c(x07), .O(new_n62_));
  inv1   g38(.a(x07), .O(new_n63_));
  aoi21  g39(.a(x09), .b(x00), .c(new_n48_), .O(new_n64_));
  inv1   g40(.a(x09), .O(new_n65_));
  nor2   g41(.a(new_n65_), .b(x08), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n62_), .O(z4));
  inv1   g44(.a(x12), .O(new_n69_));
  nor3   g45(.a(new_n25_), .b(x07), .c(x00), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(x13), .c(new_n69_), .d(new_n49_), .O(z5));
  nand2  g47(.a(x14), .b(x02), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x01), .O(new_n73_));
  nand2  g49(.a(x02), .b(new_n33_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n73_), .c(new_n25_), .O(new_n75_));
  nand2  g51(.a(x09), .b(new_n27_), .O(new_n76_));
  nand3  g52(.a(new_n65_), .b(x08), .c(x03), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n76_), .c(x01), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n75_), .c(new_n38_), .O(new_n79_));
  oai21  g55(.a(new_n27_), .b(x02), .c(new_n33_), .O(new_n80_));
  oai21  g56(.a(new_n33_), .b(new_n38_), .c(new_n80_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x09), .c(new_n48_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n49_), .c(new_n63_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand4  g61(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n49_), .c(x08), .d(new_n63_), .O(z7));
  oai21  g63(.a(new_n48_), .b(new_n38_), .c(new_n65_), .O(new_n88_));
  nand4  g64(.a(new_n69_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n88_), .c(new_n53_), .O(z8));
endmodule
