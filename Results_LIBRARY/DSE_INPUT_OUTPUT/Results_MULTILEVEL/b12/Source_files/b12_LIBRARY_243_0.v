...
module FAU ( 
  ...
  oai21  g56(.a(new_n43_), .b(x01), .c(new_n55_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n82_));
  nor2   g58(.a(new_n26_), .b(x10), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n52_), .O(z7));
  nand4  g60(.a(new_n60_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n52_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n26_), .c(new_n25_), .O(z8));
endmodule
