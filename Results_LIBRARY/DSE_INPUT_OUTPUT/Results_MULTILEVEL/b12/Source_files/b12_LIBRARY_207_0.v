...
module FAU ( 
  ...
  nand3  g35(.a(new_n59_), .b(z5), .c(x02), .O(new_n60_));
  ...
  nand2  g40(.a(new_n64_), .b(z5), .O(z3));
  ...
  aoi21  g56(.a(new_n80_), .b(x12), .c(x10), .O(z6));
  oai21  g57(.a(new_n42_), .b(x01), .c(new_n46_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n53_), .d(new_n62_), .O(z7));
  nand4  g60(.a(new_n53_), .b(new_n72_), .c(new_n62_), .d(x00), .O(z8));
endmodule
