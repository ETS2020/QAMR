...
module FAU ( 
  ...
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n67_), .d(new_n37_), .O(z5));
  ...
  nand4  g63(.a(new_n67_), .b(x03), .c(new_n25_), .d(new_n31_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n72_), .b(new_n46_), .c(x10), .O(new_n90_));
