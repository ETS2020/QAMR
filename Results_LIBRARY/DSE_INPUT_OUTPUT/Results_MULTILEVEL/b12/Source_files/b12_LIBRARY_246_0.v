...
module FAU ( 
  ...
  inv1   g20(.a(new_n33_), .O(new_n45_));
  ...
  aoi21  g35(.a(new_n59_), .b(new_n50_), .c(new_n45_), .O(z2));
  ...
  oai22  g40(.a(new_n64_), .b(new_n35_), .c(x13), .d(x12), .O(new_n65_));
  nand3  g41(.a(new_n33_), .b(new_n61_), .c(x07), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x07), .c(new_n66_), .O(z4));
  nor3   g43(.a(x10), .b(x07), .c(x00), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n32_), .c(new_n31_), .O(z5));
  ...
  nand2  g56(.a(new_n80_), .b(new_n33_), .O(z6));
  ...
  nor2   g61(.a(new_n85_), .b(new_n45_), .O(z7));
  oai21  g62(.a(new_n32_), .b(x09), .c(new_n31_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n35_), .O(new_n88_));
  oai21  g64(.a(x10), .b(x07), .c(new_n33_), .O(new_n89_));
  nand2  g65(.a(new_n82_), .b(x13), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n31_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n89_), .c(new_n88_), .O(z8));
endmodule
