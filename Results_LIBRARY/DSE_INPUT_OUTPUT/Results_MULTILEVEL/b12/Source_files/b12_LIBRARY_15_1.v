...
module FAU ( 
  ...
  aoi21  g21(.a(x11), .b(new_n25_), .c(new_n28_), .O(new_n46_));
  inv1   g22(.a(x10), .O(new_n47_));
  oai21  g23(.a(x11), .b(new_n47_), .c(new_n25_), .O(new_n48_));
  nand2  g24(.a(new_n48_), .b(new_n27_), .O(new_n49_));
  inv1   g25(.a(x11), .O(new_n50_));
  nand4  g26(.a(new_n50_), .b(new_n47_), .c(x09), .d(new_n25_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n49_), .c(x01), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n46_), .c(new_n38_), .O(new_n53_));
  inv1   g29(.a(x08), .O(new_n54_));
  nor2   g30(.a(new_n47_), .b(x03), .O(new_n55_));
  ...
  nand4  g35(.a(new_n59_), .b(new_n50_), .c(new_n54_), .d(new_n25_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n53_), .O(z2));
  inv1   g37(.a(x12), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(x00), .c(new_n50_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n26_), .O(z3));
  nand4  g40(.a(new_n50_), .b(x09), .c(x08), .d(x00), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n25_), .O(new_n66_));
  oai21  g42(.a(x11), .b(new_n25_), .c(new_n66_), .O(z4));
  nand3  g43(.a(x13), .b(new_n62_), .c(new_n47_), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n50_), .c(new_n25_), .d(new_n38_), .O(z5));
  nand2  g46(.a(x08), .b(x00), .O(new_n71_));
  nand2  g47(.a(x09), .b(new_n27_), .O(new_n72_));
  nand2  g48(.a(new_n56_), .b(x03), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n28_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n71_), .c(new_n33_), .O(new_n75_));
  ...
  aoi21  g56(.a(new_n80_), .b(new_n50_), .c(x07), .O(z6));
  nand3  g57(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n47_), .O(new_n84_));
  aoi21  g60(.a(new_n82_), .b(new_n54_), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x11), .c(new_n25_), .O(z7));
  nand4  g62(.a(new_n62_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n47_), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x11), .c(new_n25_), .O(z8));
endmodule
