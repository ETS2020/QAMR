...
module FAU ( 
  ...
  oai21  g11(.a(new_n35_), .b(new_n25_), .c(x01), .O(new_n36_));
  ...
  oai22  g39(.a(new_n63_), .b(new_n33_), .c(new_n51_), .d(new_n35_), .O(new_n64_));
  ...
  oai21  g45(.a(new_n51_), .b(x06), .c(new_n69_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n50_), .c(new_n33_), .O(new_n71_));
  ...
  aoi21  g66(.a(new_n75_), .b(new_n33_), .c(x10), .O(new_n91_));
