...
module FAU ( 
  ...
  nand3  g15(.a(x03), .b(new_n26_), .c(x01), .O(new_n40_));
  nand2  g16(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nand3  g17(.a(new_n41_), .b(x08), .c(new_n36_), .O(new_n42_));
  inv1   g18(.a(new_n42_), .O(z1));
  inv1   g19(.a(x08), .O(new_n44_));
  inv1   g20(.a(x07), .O(new_n45_));
  nand3  g21(.a(new_n44_), .b(new_n45_), .c(x00), .O(new_n46_));
  oai21  g22(.a(new_n44_), .b(x00), .c(new_n46_), .O(new_n47_));
  ...
  nand2  g26(.a(x07), .b(new_n25_), .O(new_n51_));
  inv1   g27(.a(x10), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(x09), .c(new_n45_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n51_), .c(new_n44_), .O(new_n54_));
  nand2  g30(.a(new_n45_), .b(x00), .O(new_n55_));
  nand3  g31(.a(new_n52_), .b(x09), .c(new_n44_), .O(new_n56_));
  nor2   g32(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  aoi21  g33(.a(new_n54_), .b(new_n36_), .c(new_n57_), .O(new_n58_));
  ...
  oai21  g38(.a(x08), .b(x00), .c(new_n62_), .O(z3));
  nand3  g39(.a(new_n61_), .b(x08), .c(new_n36_), .O(new_n64_));
  nand2  g40(.a(x09), .b(x08), .O(new_n65_));
  nor2   g41(.a(x11), .b(new_n45_), .O(new_n66_));
  aoi21  g42(.a(new_n65_), .b(new_n45_), .c(new_n66_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n36_), .c(new_n64_), .O(z4));
  nor2   g44(.a(x12), .b(x10), .O(new_n69_));
  nor2   g45(.a(x07), .b(x00), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(x13), .d(x08), .O(z5));
  nand3  g47(.a(x08), .b(new_n31_), .c(new_n36_), .O(new_n72_));
  nand2  g48(.a(new_n44_), .b(x00), .O(new_n73_));
  ...
  nand3  g52(.a(new_n76_), .b(x08), .c(new_n36_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n73_), .c(new_n31_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n75_), .c(new_n52_), .O(new_n79_));
  ...
  nand3  g60(.a(x03), .b(new_n26_), .c(new_n31_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n44_), .c(x00), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n84_), .c(new_n81_), .O(z7));
  nand2  g63(.a(new_n65_), .b(new_n36_), .O(new_n88_));
  nand4  g64(.a(new_n60_), .b(x03), .c(new_n26_), .d(new_n31_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n88_), .c(new_n52_), .d(new_n45_), .O(z8));
endmodule
