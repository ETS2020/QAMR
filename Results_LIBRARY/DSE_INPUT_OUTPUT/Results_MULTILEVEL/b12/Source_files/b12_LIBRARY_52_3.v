...
module FAU ( 
  ...
  oai22  g24(.a(new_n48_), .b(x07), .c(new_n47_), .d(x03), .O(new_n49_));
  nand3  g25(.a(new_n49_), .b(new_n28_), .c(new_n43_), .O(new_n50_));
  ...
  nand3  g44(.a(x13), .b(new_n61_), .c(new_n47_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n31_), .c(new_n53_), .d(new_n33_), .O(z5));
  aoi21  g47(.a(new_n28_), .b(new_n33_), .c(new_n54_), .O(new_n72_));
  nand2  g48(.a(x14), .b(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x01), .O(new_n74_));
  xor2a  g50(.a(x09), .b(x03), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x02), .c(new_n43_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n74_), .c(new_n72_), .O(new_n77_));
  nand3  g53(.a(new_n54_), .b(x01), .c(x00), .O(new_n78_));
  ...
  nand3  g60(.a(new_n31_), .b(new_n47_), .c(new_n53_), .O(new_n85_));
  aoi21  g61(.a(new_n82_), .b(new_n54_), .c(new_n85_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n84_), .O(z7));
  nand4  g63(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  inv1   g65(.a(x09), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n33_), .c(x10), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n89_), .c(new_n31_), .d(new_n53_), .O(z8));
endmodule
