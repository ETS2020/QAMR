...
module FAU ( 
  ...
  aoi22  g41(.a(new_n65_), .b(new_n64_), .c(x13), .d(new_n25_), .O(z4));
  ...
  oai21  g59(.a(new_n83_), .b(x13), .c(new_n25_), .O(z7));
  nand4  g60(.a(new_n60_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n70_), .b(new_n38_), .c(x07), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n67_), .d(new_n25_), .O(z8));
endmodule
