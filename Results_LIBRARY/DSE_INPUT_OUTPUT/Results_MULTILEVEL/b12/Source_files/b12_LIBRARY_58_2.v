...
module FAU ( 
  ...
  nand3  g28(.a(new_n52_), .b(x11), .c(new_n44_), .O(new_n53_));
  ...
  nand2  g40(.a(new_n31_), .b(new_n56_), .O(new_n65_));
  aoi22  g41(.a(new_n65_), .b(new_n64_), .c(x12), .d(new_n34_), .O(z3));
  oai21  g42(.a(new_n31_), .b(new_n49_), .c(new_n56_), .O(new_n67_));
  nand2  g43(.a(x09), .b(x00), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(x11), .c(new_n49_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n67_), .O(z4));
  nor2   g46(.a(x08), .b(x07), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x11), .c(x00), .O(new_n72_));
  oai21  g48(.a(x11), .b(new_n56_), .c(x07), .O(new_n73_));
  oai21  g49(.a(new_n31_), .b(x00), .c(x08), .O(new_n74_));
  inv1   g50(.a(x12), .O(new_n75_));
  nand3  g51(.a(x13), .b(new_n75_), .c(new_n50_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n74_), .c(new_n49_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n72_), .O(z5));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  nand2  g55(.a(x09), .b(new_n35_), .O(new_n80_));
  nand2  g56(.a(new_n58_), .b(x03), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n25_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n79_), .c(new_n44_), .O(new_n83_));
  aoi21  g59(.a(x14), .b(x02), .c(x00), .O(new_n84_));
  nor2   g60(.a(x08), .b(new_n34_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(x01), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n83_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n50_), .c(new_n49_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n32_), .O(z6));
  nand3  g65(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x08), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  nand2  g68(.a(new_n90_), .b(new_n56_), .O(new_n93_));
  inv1   g69(.a(new_n32_), .O(new_n94_));
  nor2   g70(.a(new_n94_), .b(x10), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n93_), .c(new_n92_), .d(new_n49_), .O(z7));
  nand4  g72(.a(new_n75_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  nor2   g74(.a(x09), .b(x00), .O(new_n99_));
  nor3   g75(.a(new_n99_), .b(x10), .c(x07), .O(new_n100_));
  aoi21  g76(.a(new_n100_), .b(new_n98_), .c(new_n94_), .O(z8));
endmodule
