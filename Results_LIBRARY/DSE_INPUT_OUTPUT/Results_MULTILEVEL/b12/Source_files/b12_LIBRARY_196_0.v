...
module FAU ( 
  ...
  nand2  g21(.a(x10), .b(new_n36_), .O(new_n46_));
  inv1   g22(.a(x10), .O(new_n47_));
  nand3  g23(.a(x14), .b(new_n47_), .c(x09), .O(new_n48_));
  ...
  oai21  g32(.a(new_n56_), .b(new_n54_), .c(new_n35_), .O(new_n57_));
  ...
  nand2  g40(.a(new_n64_), .b(new_n32_), .O(z3));
  nand3  g41(.a(x09), .b(x08), .c(x00), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n61_), .O(new_n67_));
  nand2  g43(.a(new_n62_), .b(x07), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n67_), .c(new_n31_), .O(z4));
  nor3   g45(.a(x10), .b(x07), .c(x00), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(x14), .c(x13), .d(new_n63_), .O(z5));
  ...
  nand2  g57(.a(new_n81_), .b(new_n61_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(x14), .c(x10), .O(z6));
  oai21  g59(.a(new_n41_), .b(x01), .c(new_n45_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n52_), .d(new_n61_), .O(z7));
  nand4  g62(.a(new_n63_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n61_), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n51_), .c(new_n47_), .O(z8));
endmodule
