...
module FAU ( 
  ...
  nand4  g38(.a(x13), .b(new_n62_), .c(new_n49_), .d(new_n37_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n50_), .O(new_n64_));
  nand2  g40(.a(new_n49_), .b(x07), .O(new_n65_));
  ...
  nand4  g59(.a(new_n62_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n84_));
