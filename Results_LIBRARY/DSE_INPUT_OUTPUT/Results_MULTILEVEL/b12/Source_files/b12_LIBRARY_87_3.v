...
module FAU ( 
  ...
  nand3  g49(.a(new_n73_), .b(new_n69_), .c(new_n44_), .O(new_n74_));
  aoi21  g50(.a(x14), .b(x02), .c(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n33_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(x01), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n50_), .c(new_n49_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n31_), .O(z6));
  nand3  g56(.a(x03), .b(new_n25_), .c(new_n44_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n49_), .O(new_n83_));
  aoi21  g59(.a(new_n81_), .b(new_n53_), .c(new_n83_), .O(new_n84_));
  inv1   g60(.a(x13), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x10), .O(new_n86_));
  oai21  g62(.a(new_n84_), .b(x10), .c(new_n86_), .O(z7));
  nand4  g63(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n88_));
