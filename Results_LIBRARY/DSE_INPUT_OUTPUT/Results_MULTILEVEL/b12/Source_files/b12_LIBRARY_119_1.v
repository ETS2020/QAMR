...
module FAU ( 
  ...
  nand3  g35(.a(new_n52_), .b(new_n54_), .c(x07), .O(new_n60_));
  oai21  g36(.a(new_n59_), .b(x07), .c(new_n60_), .O(z4));
  oai21  g37(.a(x07), .b(x00), .c(new_n52_), .O(new_n62_));
  inv1   g38(.a(x13), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x12), .c(new_n39_), .O(new_n64_));
  oai21  g40(.a(new_n39_), .b(new_n38_), .c(new_n64_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n45_), .c(new_n28_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n62_), .O(z5));
  ...
  nand3  g48(.a(new_n72_), .b(new_n68_), .c(new_n38_), .O(new_n73_));
  aoi21  g49(.a(x14), .b(x01), .c(x00), .O(new_n74_));
  nor2   g50(.a(x08), .b(new_n28_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n74_), .c(x02), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n73_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n39_), .c(new_n45_), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  oai21  g55(.a(x10), .b(new_n48_), .c(x02), .O(new_n80_));
  oai21  g56(.a(new_n29_), .b(x01), .c(new_n48_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n81_), .c(new_n45_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n39_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n80_), .O(z7));
  oai21  g61(.a(x10), .b(x09), .c(x02), .O(new_n86_));
  nand3  g62(.a(new_n55_), .b(x03), .c(new_n25_), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n45_), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x10), .c(new_n86_), .O(z8));
endmodule
