...
module FAU ( 
  ...
  nand2  g07(.a(new_n31_), .b(x12), .O(new_n32_));
  ...
  inv1   g19(.a(new_n32_), .O(new_n44_));
  oai21  g20(.a(x08), .b(x07), .c(x00), .O(new_n45_));
  inv1   g21(.a(x01), .O(new_n46_));
  nand3  g22(.a(x10), .b(new_n35_), .c(new_n46_), .O(new_n47_));
  ...
  aoi21  g34(.a(new_n58_), .b(new_n49_), .c(new_n44_), .O(z2));
  nand2  g35(.a(x13), .b(x00), .O(new_n60_));
  ...
  aoi21  g41(.a(new_n65_), .b(new_n63_), .c(new_n44_), .O(z4));
  nor2   g42(.a(new_n31_), .b(x12), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n52_), .c(new_n51_), .d(new_n34_), .O(z5));
  ...
  nand3  g49(.a(new_n73_), .b(new_n69_), .c(new_n46_), .O(new_n74_));
  ...
  nand4  g54(.a(new_n78_), .b(new_n32_), .c(new_n52_), .d(new_n51_), .O(new_n79_));
  ...
  nor2   g60(.a(new_n84_), .b(new_n44_), .O(z7));
  oai21  g61(.a(new_n31_), .b(x09), .c(x12), .O(new_n86_));
  nand2  g62(.a(new_n81_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n71_), .b(new_n34_), .c(x10), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n51_), .O(z8));
endmodule
