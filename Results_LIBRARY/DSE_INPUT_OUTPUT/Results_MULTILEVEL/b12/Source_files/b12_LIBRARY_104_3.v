...
module FAU ( 
  ...
  nand2  g45(.a(new_n54_), .b(x10), .O(new_n70_));
  inv1   g46(.a(x12), .O(new_n71_));
  nand4  g47(.a(x13), .b(new_n71_), .c(new_n47_), .d(new_n37_), .O(new_n72_));
  ...
  nand4  g66(.a(new_n71_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n91_));
