...
module FAU ( 
  ...
  nand3  g58(.a(new_n80_), .b(new_n46_), .c(x03), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(new_n84_));
  oai22  g60(.a(new_n84_), .b(x08), .c(new_n82_), .d(x10), .O(z7));
  nand3  g61(.a(new_n80_), .b(new_n59_), .c(x03), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n70_), .b(new_n37_), .c(x10), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n45_), .O(z8));
endmodule
