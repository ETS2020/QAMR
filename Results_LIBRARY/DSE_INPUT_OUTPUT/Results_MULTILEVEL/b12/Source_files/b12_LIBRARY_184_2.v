// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:23 2020
...
module FAU ( 
  ...
  nand2  g37(.a(new_n61_), .b(new_n34_), .O(z3));
  nand3  g38(.a(x09), .b(x08), .c(x00), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n58_), .O(new_n64_));
  oai21  g40(.a(new_n59_), .b(new_n33_), .c(x07), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(z4));
  oai21  g42(.a(x07), .b(new_n36_), .c(x10), .O(new_n67_));
  nand3  g43(.a(x13), .b(new_n60_), .c(new_n36_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n58_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n67_), .O(z5));
  ...
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n33_), .d(new_n58_), .O(z7));
  nand4  g62(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n87_));
  nor2   g63(.a(x09), .b(x00), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x07), .c(new_n33_), .O(z8));
endmodule
