...
module FAU ( 
  ...
  oai21  g24(.a(new_n46_), .b(new_n38_), .c(new_n48_), .O(new_n49_));
  ...
  nand3  g30(.a(new_n46_), .b(new_n52_), .c(x09), .O(new_n55_));
  ...
  nand3  g38(.a(new_n26_), .b(new_n59_), .c(x07), .O(new_n63_));
  inv1   g39(.a(x08), .O(new_n64_));
  nand2  g40(.a(x09), .b(x00), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(x14), .c(new_n64_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(x07), .c(new_n63_), .O(z4));
  oai21  g43(.a(new_n46_), .b(x14), .c(x00), .O(new_n68_));
  nand2  g44(.a(new_n26_), .b(x07), .O(new_n69_));
  oai21  g45(.a(new_n25_), .b(x00), .c(x08), .O(new_n70_));
  nand3  g46(.a(x13), .b(new_n60_), .c(new_n52_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n51_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n69_), .c(new_n68_), .O(z5));
  ...
  nand3  g53(.a(new_n77_), .b(new_n70_), .c(new_n33_), .O(new_n78_));
  aoi21  g54(.a(x14), .b(new_n38_), .c(x08), .O(new_n79_));
  nand3  g55(.a(x14), .b(new_n28_), .c(new_n38_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n79_), .c(x01), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n78_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n52_), .c(new_n51_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  oai21  g61(.a(x10), .b(x07), .c(new_n26_), .O(new_n86_));
  nand4  g62(.a(x14), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n87_));
  ...
  nand2  g66(.a(new_n90_), .b(new_n64_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n89_), .c(new_n86_), .O(z7));
  inv1   g68(.a(new_n26_), .O(new_n93_));
  nand4  g69(.a(new_n60_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  nor2   g71(.a(x09), .b(x00), .O(new_n96_));
  nor3   g72(.a(new_n96_), .b(x10), .c(x07), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n95_), .c(new_n93_), .O(z8));
endmodule
