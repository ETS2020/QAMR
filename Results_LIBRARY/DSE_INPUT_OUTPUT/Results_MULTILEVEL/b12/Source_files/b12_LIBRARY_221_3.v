...
module FAU ( 
  ...
  nand2  g00(.a(x10), .b(x09), .O(new_n25_));
  ...
  aoi21  g27(.a(new_n51_), .b(new_n49_), .c(x00), .O(new_n52_));
  inv1   g28(.a(x08), .O(new_n53_));
  nand3  g29(.a(x09), .b(new_n53_), .c(new_n50_), .O(new_n54_));
  inv1   g30(.a(new_n54_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n52_), .c(new_n32_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n48_), .c(new_n25_), .O(z2));
  nand2  g33(.a(x11), .b(x07), .O(new_n58_));
  nand2  g34(.a(x12), .b(new_n37_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n58_), .c(new_n25_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(z3));
  oai21  g37(.a(x10), .b(x08), .c(x09), .O(new_n62_));
  inv1   g38(.a(x09), .O(new_n63_));
  nand2  g39(.a(x10), .b(new_n63_), .O(new_n64_));
  oai21  g40(.a(x10), .b(x00), .c(new_n64_), .O(new_n65_));
  aoi21  g41(.a(new_n62_), .b(x00), .c(new_n65_), .O(new_n66_));
  inv1   g42(.a(x11), .O(new_n67_));
  nand3  g43(.a(new_n25_), .b(new_n67_), .c(x07), .O(new_n68_));
  oai21  g44(.a(new_n66_), .b(x07), .c(new_n68_), .O(z4));
  oai21  g45(.a(x09), .b(x07), .c(x10), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x00), .O(new_n71_));
  inv1   g47(.a(x10), .O(new_n72_));
  inv1   g48(.a(x12), .O(new_n73_));
  nand2  g49(.a(x13), .b(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n37_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n64_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n50_), .O(new_n77_));
  nand2  g53(.a(new_n25_), .b(x07), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n71_), .O(z5));
  nand2  g55(.a(x08), .b(x00), .O(new_n80_));
  aoi21  g56(.a(new_n63_), .b(x03), .c(x02), .O(new_n81_));
  nand2  g57(.a(x09), .b(new_n26_), .O(new_n82_));
  oai21  g58(.a(new_n81_), .b(x10), .c(new_n82_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n80_), .c(new_n32_), .O(new_n84_));
  nand2  g60(.a(x14), .b(x02), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n37_), .O(new_n86_));
  oai21  g62(.a(x08), .b(new_n37_), .c(new_n86_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n72_), .c(x01), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n84_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n50_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n25_), .O(z6));
  nand3  g67(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n92_));
  nand4  g68(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n50_), .O(new_n94_));
  aoi21  g70(.a(new_n92_), .b(new_n53_), .c(new_n94_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x10), .c(new_n64_), .O(z7));
  nand4  g72(.a(new_n73_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  aoi21  g74(.a(new_n63_), .b(new_n37_), .c(x10), .O(new_n99_));
  nand3  g75(.a(new_n99_), .b(new_n98_), .c(new_n50_), .O(z8));
endmodule
