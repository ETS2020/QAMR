...
module FAU ( 
  ...
  nor2   g06(.a(x11), .b(x08), .O(new_n31_));
  ...
  oai21  g20(.a(x11), .b(x08), .c(x07), .O(new_n45_));
  ...
  nand2  g30(.a(x10), .b(new_n35_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand4  g32(.a(new_n56_), .b(x11), .c(new_n53_), .d(new_n48_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n52_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n44_), .O(new_n59_));
  nand2  g35(.a(x11), .b(x07), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n53_), .c(x00), .O(new_n61_));
  nand3  g37(.a(x11), .b(new_n53_), .c(new_n48_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n61_), .c(x02), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n59_), .O(z2));
  nand2  g41(.a(x11), .b(new_n48_), .O(new_n66_));
  inv1   g42(.a(x11), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x08), .O(new_n68_));
  aoi22  g44(.a(new_n68_), .b(new_n66_), .c(x12), .d(new_n34_), .O(z3));
  nand2  g45(.a(x11), .b(new_n53_), .O(new_n70_));
  inv1   g46(.a(x09), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x08), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n70_), .c(new_n34_), .O(new_n73_));
  nor2   g49(.a(new_n31_), .b(x00), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(new_n48_), .O(new_n75_));
  oai21  g51(.a(new_n68_), .b(new_n48_), .c(new_n75_), .O(z4));
  inv1   g52(.a(x12), .O(new_n77_));
  nand3  g53(.a(x13), .b(new_n77_), .c(new_n49_), .O(new_n78_));
  oai22  g54(.a(new_n78_), .b(x00), .c(x11), .d(x08), .O(new_n79_));
  oai21  g55(.a(x11), .b(x08), .c(x07), .O(new_n80_));
  oai21  g56(.a(new_n79_), .b(x07), .c(new_n80_), .O(z5));
  nand2  g57(.a(x08), .b(x00), .O(new_n82_));
  nand2  g58(.a(x09), .b(new_n35_), .O(new_n83_));
  nand2  g59(.a(new_n71_), .b(x03), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n25_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n82_), .c(new_n44_), .O(new_n86_));
  aoi21  g62(.a(x14), .b(x02), .c(x00), .O(new_n87_));
  nor2   g63(.a(x08), .b(new_n34_), .O(new_n88_));
  ...
  nand2  g67(.a(new_n91_), .b(new_n32_), .O(z6));
  nor2   g68(.a(x02), .b(x01), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(x11), .c(x03), .O(new_n94_));
