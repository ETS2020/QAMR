...
module FAU ( 
  ...
  aoi21  g37(.a(new_n55_), .b(new_n34_), .c(new_n45_), .O(new_n62_));
  oai22  g38(.a(new_n62_), .b(x08), .c(new_n61_), .d(new_n34_), .O(z4));
  nor3   g39(.a(x08), .b(x07), .c(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n56_), .d(new_n50_), .O(z5));
  nand2  g41(.a(x01), .b(new_n34_), .O(new_n66_));
  ...
  nand4  g47(.a(new_n71_), .b(new_n50_), .c(new_n35_), .d(new_n45_), .O(new_n72_));
  inv1   g48(.a(new_n72_), .O(z6));
  nand3  g49(.a(x03), .b(new_n27_), .c(new_n25_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x08), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x09), .O(new_n76_));
  nand2  g52(.a(new_n74_), .b(new_n35_), .O(new_n77_));
  nand2  g53(.a(new_n58_), .b(new_n50_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(x07), .O(new_n79_));
  ...
  oai21  g60(.a(x10), .b(x07), .c(new_n58_), .O(new_n85_));
  inv1   g61(.a(x09), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n35_), .c(new_n34_), .O(new_n87_));
