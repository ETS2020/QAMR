...
module FAU ( 
  ...
  nor2   g26(.a(new_n50_), .b(new_n43_), .O(new_n51_));
  ...
  aoi21  g31(.a(new_n55_), .b(new_n52_), .c(new_n51_), .O(z3));
  nor2   g32(.a(x09), .b(x07), .O(new_n57_));
  aoi21  g33(.a(new_n50_), .b(x07), .c(new_n57_), .O(new_n58_));
  oai22  g34(.a(new_n58_), .b(new_n33_), .c(new_n51_), .d(x00), .O(z4));
  nor2   g35(.a(x07), .b(x00), .O(new_n60_));
  nand4  g36(.a(new_n60_), .b(x13), .c(new_n54_), .d(new_n44_), .O(z5));
  ...
  nand4  g42(.a(new_n66_), .b(new_n44_), .c(new_n43_), .d(new_n53_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(z6));
  nand4  g44(.a(x03), .b(new_n25_), .c(new_n42_), .d(new_n53_), .O(new_n69_));
  ...
  nand3  g51(.a(new_n71_), .b(new_n54_), .c(x03), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  oai21  g53(.a(x10), .b(x07), .c(new_n34_), .O(new_n78_));
  nand2  g54(.a(new_n74_), .b(new_n53_), .O(new_n79_));
