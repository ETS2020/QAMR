...
module FAU ( 
  ...
  nand3  g52(.a(new_n76_), .b(new_n49_), .c(x03), .O(new_n77_));
  nor3   g53(.a(new_n77_), .b(x02), .c(x01), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x08), .c(new_n25_), .O(z7));
  nand4  g55(.a(new_n58_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x09), .O(new_n81_));
  aoi21  g57(.a(new_n76_), .b(new_n38_), .c(x10), .O(new_n82_));
