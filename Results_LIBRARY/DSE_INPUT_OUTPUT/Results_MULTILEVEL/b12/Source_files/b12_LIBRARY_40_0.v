// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:28 2020
...
module FAU ( 
  ...
  oai22  g36(.a(new_n60_), .b(x00), .c(new_n26_), .d(new_n52_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n27_), .O(z3));
  oai21  g38(.a(new_n25_), .b(x07), .c(new_n26_), .O(new_n63_));
  nand3  g39(.a(x09), .b(x08), .c(x00), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n52_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n63_), .O(z4));
  nor3   g42(.a(x10), .b(x07), .c(x00), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n60_), .d(x11), .O(z5));
  nand2  g44(.a(x08), .b(x00), .O(new_n69_));
  nand2  g45(.a(x09), .b(new_n28_), .O(new_n70_));
  inv1   g46(.a(x09), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x03), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(new_n29_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n69_), .c(new_n34_), .O(new_n74_));
  aoi21  g50(.a(x14), .b(x02), .c(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n39_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(x01), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(x11), .c(new_n25_), .d(new_n52_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand3  g56(.a(x03), .b(new_n29_), .c(new_n34_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n52_), .O(new_n83_));
  aoi21  g59(.a(new_n81_), .b(new_n55_), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n26_), .c(new_n25_), .O(z7));
  nand4  g61(.a(new_n60_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n71_), .b(new_n39_), .c(x07), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(x11), .d(new_n25_), .O(z8));
endmodule
