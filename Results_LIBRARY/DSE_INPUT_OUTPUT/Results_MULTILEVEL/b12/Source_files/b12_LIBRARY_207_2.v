...
module FAU ( 
  ...
  nand3  g30(.a(x12), .b(x10), .c(new_n27_), .O(new_n55_));
  ...
  oai22  g37(.a(new_n25_), .b(x00), .c(new_n61_), .d(new_n48_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n26_), .O(z3));
  nand2  g39(.a(x09), .b(x08), .O(new_n64_));
  oai22  g40(.a(new_n64_), .b(new_n38_), .c(x12), .d(new_n53_), .O(new_n65_));
  nand3  g41(.a(new_n26_), .b(new_n61_), .c(x07), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x07), .c(new_n66_), .O(z4));
  nand3  g43(.a(x13), .b(new_n48_), .c(new_n38_), .O(new_n68_));
  ...
  nand3  g56(.a(new_n80_), .b(new_n53_), .c(new_n48_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n26_), .O(z6));
  oai21  g58(.a(new_n42_), .b(x01), .c(new_n49_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n53_), .d(new_n48_), .O(z7));
  nand4  g61(.a(new_n25_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n73_), .b(new_n38_), .c(x10), .O(new_n88_));
