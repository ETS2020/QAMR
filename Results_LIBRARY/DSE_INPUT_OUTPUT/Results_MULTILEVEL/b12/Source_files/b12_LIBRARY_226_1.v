...
module FAU ( 
  ...
  oai21  g37(.a(x10), .b(new_n49_), .c(new_n25_), .O(new_n62_));
  oai21  g38(.a(new_n54_), .b(new_n38_), .c(new_n49_), .O(new_n63_));
  nand2  g39(.a(new_n58_), .b(x07), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n62_), .O(z4));
  nand2  g41(.a(x10), .b(x08), .O(new_n66_));
  nand4  g42(.a(x13), .b(new_n59_), .c(new_n49_), .d(new_n38_), .O(new_n67_));
  ...
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n28_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n70_), .c(new_n33_), .O(new_n74_));
  ...
  oai21  g56(.a(new_n42_), .b(x01), .c(new_n25_), .O(new_n81_));
  ...
  nand2  g60(.a(new_n84_), .b(new_n66_), .O(z7));
  nand4  g61(.a(new_n59_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n86_));
  oai21  g62(.a(x09), .b(x00), .c(new_n49_), .O(new_n87_));
  aoi21  g63(.a(new_n86_), .b(x09), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x10), .c(new_n66_), .O(z8));
endmodule
