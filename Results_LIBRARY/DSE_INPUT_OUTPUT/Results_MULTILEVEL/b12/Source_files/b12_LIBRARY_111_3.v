...
module FAU ( 
  ...
  nand2  g12(.a(new_n33_), .b(new_n29_), .O(new_n37_));
  ...
  nand2  g18(.a(x10), .b(x04), .O(new_n43_));
  ...
  oai21  g27(.a(new_n51_), .b(new_n47_), .c(new_n43_), .O(new_n52_));
  nand3  g28(.a(x10), .b(new_n33_), .c(new_n29_), .O(new_n53_));
  nand3  g29(.a(new_n26_), .b(x09), .c(new_n48_), .O(new_n54_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n43_), .O(z4));
  nor2   g43(.a(x07), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n61_), .d(new_n26_), .O(z5));
  ...
  nand3  g55(.a(new_n79_), .b(new_n26_), .c(new_n48_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand2  g57(.a(x10), .b(new_n33_), .O(new_n82_));
  nand3  g58(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n48_), .O(new_n85_));
  aoi21  g61(.a(new_n83_), .b(new_n49_), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x10), .c(new_n82_), .O(z7));
  nand4  g63(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n72_), .b(new_n36_), .c(x10), .O(new_n90_));
