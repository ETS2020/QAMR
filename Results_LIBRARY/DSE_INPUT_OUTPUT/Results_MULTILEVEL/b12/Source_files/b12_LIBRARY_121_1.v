...
module FAU ( 
  ...
  nand3  g52(.a(new_n76_), .b(new_n71_), .c(new_n46_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n68_), .c(x10), .O(z6));
  inv1   g54(.a(x08), .O(new_n79_));
  nand3  g55(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n80_));
  nand3  g56(.a(new_n72_), .b(x09), .c(x03), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n46_), .O(new_n82_));
  aoi21  g58(.a(new_n80_), .b(new_n79_), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x14), .c(new_n25_), .O(z7));
  nand3  g60(.a(new_n72_), .b(new_n67_), .c(x03), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n46_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x14), .c(new_n25_), .O(z8));
endmodule
