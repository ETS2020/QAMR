...
module FAU ( 
  ...
  aoi22  g38(.a(new_n62_), .b(new_n60_), .c(x10), .d(new_n25_), .O(z4));
  ...
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n43_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n67_), .c(new_n25_), .O(new_n72_));
  aoi21  g48(.a(x14), .b(x01), .c(x00), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n55_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(x02), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n72_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n26_), .c(new_n45_), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(z6));
  nand3  g54(.a(x03), .b(new_n25_), .c(new_n43_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n48_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n26_), .d(new_n45_), .O(z7));
  oai21  g58(.a(x10), .b(x09), .c(x02), .O(new_n83_));
  nand3  g59(.a(new_n64_), .b(x03), .c(new_n43_), .O(new_n84_));
  oai21  g60(.a(x09), .b(x00), .c(new_n45_), .O(new_n85_));
  aoi21  g61(.a(new_n84_), .b(x09), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x10), .c(new_n83_), .O(z8));
endmodule
