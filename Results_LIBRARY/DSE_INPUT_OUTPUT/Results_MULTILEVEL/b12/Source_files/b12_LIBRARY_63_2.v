...
module FAU ( 
  ...
  nand2  g34(.a(x11), .b(new_n50_), .O(new_n59_));
  nand2  g35(.a(new_n31_), .b(new_n51_), .O(new_n60_));
  aoi22  g36(.a(new_n60_), .b(new_n59_), .c(x12), .d(new_n34_), .O(z3));
  nand3  g37(.a(x09), .b(x08), .c(x00), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n32_), .c(new_n50_), .O(new_n63_));
  oai21  g39(.a(new_n60_), .b(new_n50_), .c(new_n63_), .O(z4));
  inv1   g40(.a(x12), .O(new_n65_));
  nor2   g41(.a(x07), .b(x00), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n65_), .d(new_n51_), .O(z5));
  ...
  nand3  g48(.a(new_n72_), .b(new_n68_), .c(new_n45_), .O(new_n73_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n51_), .c(new_n50_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n32_), .O(z6));
  nand3  g55(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n80_));
  ...
  nand2  g59(.a(x11), .b(x10), .O(new_n84_));
  oai21  g60(.a(new_n83_), .b(x10), .c(new_n84_), .O(z7));
  nand4  g61(.a(new_n65_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n70_), .b(new_n34_), .c(x10), .O(new_n88_));
