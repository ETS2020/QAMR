...
module FAU ( 
  ...
  nand4  g41(.a(new_n65_), .b(new_n31_), .c(new_n60_), .d(new_n34_), .O(z5));
  ...
  nand3  g52(.a(new_n76_), .b(new_n31_), .c(new_n60_), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(z6));
  nand3  g54(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n52_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n31_), .d(new_n60_), .O(z7));
  inv1   g58(.a(x12), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n84_));
  nor2   g60(.a(x09), .b(x00), .O(new_n85_));
  aoi21  g61(.a(new_n84_), .b(x09), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x07), .c(new_n31_), .O(z8));
endmodule
