...
module FAU ( 
  ...
  oai22  g40(.a(new_n64_), .b(new_n36_), .c(new_n63_), .d(x10), .O(new_n65_));
  ...
  nand2  g46(.a(new_n70_), .b(new_n63_), .O(new_n71_));
  ...
  nand4  g54(.a(new_n78_), .b(new_n73_), .c(new_n63_), .d(new_n33_), .O(new_n79_));
  ...
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n51_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n63_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n33_), .O(z7));
  nand3  g62(.a(new_n74_), .b(new_n69_), .c(x03), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n76_), .b(new_n36_), .c(x07), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n63_), .d(new_n33_), .O(z8));
endmodule
