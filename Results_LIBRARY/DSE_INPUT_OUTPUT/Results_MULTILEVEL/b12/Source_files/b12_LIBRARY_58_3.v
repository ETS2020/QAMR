// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:36 2020
...
module FAU ( 
  ...
  nand2  g06(.a(x11), .b(x08), .O(new_n31_));
  ...
  nand3  g28(.a(new_n52_), .b(new_n47_), .c(new_n43_), .O(new_n53_));
  ...
  oai21  g35(.a(new_n59_), .b(new_n57_), .c(new_n43_), .O(new_n60_));
  ...
  nand2  g39(.a(new_n56_), .b(new_n49_), .O(new_n64_));
  aoi22  g40(.a(new_n64_), .b(x11), .c(x12), .d(new_n33_), .O(z3));
  nand3  g41(.a(x09), .b(new_n49_), .c(x00), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n47_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n64_), .O(z4));
  nand2  g44(.a(new_n64_), .b(x11), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x00), .O(new_n70_));
  nand2  g46(.a(new_n31_), .b(x07), .O(new_n71_));
  oai21  g47(.a(x11), .b(x00), .c(new_n64_), .O(new_n72_));
  inv1   g48(.a(x12), .O(new_n73_));
  nand3  g49(.a(x13), .b(new_n73_), .c(new_n50_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n71_), .c(new_n70_), .O(z5));
  nand2  g52(.a(x08), .b(x00), .O(new_n77_));
  nand2  g53(.a(x09), .b(new_n34_), .O(new_n78_));
  nand2  g54(.a(new_n58_), .b(x03), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n25_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n77_), .c(new_n43_), .O(new_n81_));
  aoi21  g57(.a(x14), .b(x02), .c(x00), .O(new_n82_));
  nor2   g58(.a(x08), .b(new_n33_), .O(new_n83_));
  ...
  nand2  g62(.a(new_n86_), .b(new_n31_), .O(z6));
  nand3  g63(.a(x03), .b(new_n25_), .c(new_n43_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x08), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  nand3  g66(.a(new_n31_), .b(new_n50_), .c(new_n49_), .O(new_n91_));
  aoi21  g67(.a(new_n88_), .b(new_n56_), .c(new_n91_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n90_), .O(z7));
  inv1   g69(.a(new_n31_), .O(new_n94_));
  nand4  g70(.a(new_n73_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(x09), .O(new_n96_));
  nor2   g72(.a(x09), .b(x00), .O(new_n97_));
  nor3   g73(.a(new_n97_), .b(x10), .c(x07), .O(new_n98_));
  aoi21  g74(.a(new_n98_), .b(new_n96_), .c(new_n94_), .O(z8));
endmodule
