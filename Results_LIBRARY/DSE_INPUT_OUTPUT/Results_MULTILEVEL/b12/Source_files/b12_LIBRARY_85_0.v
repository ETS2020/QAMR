...
module FAU ( 
  ...
  nand4  g29(.a(new_n51_), .b(x09), .c(new_n30_), .d(new_n50_), .O(new_n54_));
  inv1   g30(.a(new_n54_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n53_), .c(new_n25_), .O(new_n56_));
  nand2  g32(.a(new_n30_), .b(new_n35_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n56_), .c(new_n48_), .O(z2));
  inv1   g34(.a(x11), .O(new_n59_));
  inv1   g35(.a(x12), .O(new_n60_));
  oai22  g36(.a(new_n60_), .b(x00), .c(new_n59_), .d(new_n50_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n57_), .O(z3));
  oai21  g38(.a(new_n30_), .b(new_n50_), .c(new_n35_), .O(new_n63_));
  oai21  g39(.a(x09), .b(new_n35_), .c(x08), .O(new_n64_));
  ...
  nand3  g43(.a(x13), .b(new_n60_), .c(new_n51_), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(x08), .c(new_n50_), .d(new_n35_), .O(z5));
  oai21  g46(.a(x01), .b(x00), .c(x08), .O(new_n71_));
  xor2a  g47(.a(x09), .b(x03), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(x02), .c(new_n71_), .O(new_n73_));
  aoi21  g49(.a(x14), .b(x02), .c(x00), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n30_), .c(x01), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n51_), .c(new_n50_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n57_), .O(z6));
  nand4  g54(.a(x03), .b(new_n27_), .c(new_n25_), .d(x00), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n30_), .O(new_n80_));
  nor2   g56(.a(x02), .b(x01), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x09), .c(x03), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n80_), .c(new_n51_), .d(new_n50_), .O(z7));
  nand2  g59(.a(x09), .b(x08), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n35_), .O(new_n85_));
  nand3  g61(.a(new_n81_), .b(new_n60_), .c(x03), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n85_), .c(new_n51_), .d(new_n50_), .O(z8));
endmodule
