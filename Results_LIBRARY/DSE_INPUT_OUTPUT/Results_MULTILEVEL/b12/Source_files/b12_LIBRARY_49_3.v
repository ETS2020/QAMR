...
module FAU ( 
  ...
  nand2  g55(.a(new_n63_), .b(x03), .O(new_n80_));
  ...
  nor2   g59(.a(x08), .b(new_n37_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n83_), .c(x01), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n71_), .c(new_n50_), .O(new_n87_));
  inv1   g63(.a(new_n87_), .O(z6));
  nand3  g64(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n89_));
  nand4  g65(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n50_), .O(new_n91_));
  aoi21  g67(.a(new_n89_), .b(new_n53_), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x10), .c(new_n64_), .O(z7));
