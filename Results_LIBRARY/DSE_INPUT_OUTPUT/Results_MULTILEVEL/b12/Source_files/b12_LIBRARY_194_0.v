...
module FAU ( 
  ...
  aoi22  g35(.a(x12), .b(new_n35_), .c(x11), .d(x07), .O(z3));
  oai21  g36(.a(new_n32_), .b(x07), .c(new_n31_), .O(new_n61_));
  nand3  g37(.a(x09), .b(x08), .c(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n51_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n61_), .O(z4));
  nand4  g40(.a(x13), .b(new_n52_), .c(new_n51_), .d(new_n35_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x11), .O(new_n66_));
  ...
  nand4  g53(.a(new_n77_), .b(new_n33_), .c(new_n52_), .d(new_n51_), .O(new_n78_));
  ...
  aoi21  g58(.a(new_n32_), .b(new_n31_), .c(x10), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n51_), .O(z7));
  oai21  g60(.a(new_n31_), .b(x09), .c(new_n32_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n35_), .O(new_n86_));
  oai21  g62(.a(x10), .b(x07), .c(new_n33_), .O(new_n87_));
  nand2  g63(.a(new_n80_), .b(x11), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n32_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n87_), .c(new_n86_), .O(z8));
endmodule
