...
module FAU ( 
  ...
  oai21  g26(.a(new_n50_), .b(x02), .c(new_n34_), .O(new_n51_));
  ...
  nand2  g32(.a(new_n54_), .b(new_n34_), .O(new_n57_));
  inv1   g33(.a(x09), .O(new_n58_));
  nor2   g34(.a(x11), .b(new_n47_), .O(new_n59_));
  aoi21  g35(.a(new_n58_), .b(new_n47_), .c(new_n59_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n43_), .c(new_n57_), .O(z4));
  nor2   g37(.a(x07), .b(x00), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(x13), .c(new_n53_), .d(new_n48_), .O(z5));
  ...
  nand4  g44(.a(new_n68_), .b(new_n48_), .c(new_n47_), .d(new_n34_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(z6));
  oai21  g46(.a(x10), .b(x07), .c(new_n44_), .O(new_n71_));
  ...
  nand3  g51(.a(new_n75_), .b(new_n43_), .c(new_n34_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n74_), .c(new_n71_), .O(z7));
  oai21  g53(.a(new_n58_), .b(x00), .c(new_n43_), .O(new_n78_));
  nand4  g54(.a(new_n53_), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(x09), .O(new_n80_));
  aoi21  g56(.a(new_n58_), .b(new_n34_), .c(x10), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n78_), .d(new_n47_), .O(z8));
endmodule
