...
module FAU ( 
  ...
  nor2   g34(.a(x11), .b(new_n49_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n58_), .c(new_n33_), .O(new_n60_));
  inv1   g36(.a(x09), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(x08), .c(x00), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(new_n63_));
  nor2   g39(.a(new_n32_), .b(x08), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n63_), .c(new_n49_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n60_), .O(z4));
  nand2  g42(.a(new_n33_), .b(x07), .O(new_n67_));
  inv1   g43(.a(x13), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x12), .c(x08), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n32_), .c(x00), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n64_), .c(new_n49_), .O(new_n71_));
  ...
  nand4  g55(.a(new_n79_), .b(new_n32_), .c(x08), .d(new_n49_), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(x00), .O(z6));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n76_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n32_), .c(x08), .d(new_n49_), .O(z7));
  inv1   g59(.a(x12), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(x03), .c(new_n25_), .d(new_n76_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n61_), .b(new_n35_), .c(x10), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(x08), .d(new_n49_), .O(z8));
endmodule
