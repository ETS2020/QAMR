...
module FAU ( 
  ...
  nand2  g13(.a(new_n37_), .b(x10), .O(new_n38_));
  ...
  nand3  g21(.a(x10), .b(new_n45_), .c(new_n34_), .O(new_n46_));
  ...
  nor2   g52(.a(x08), .b(new_n62_), .O(new_n77_));
  ...
  aoi21  g56(.a(new_n80_), .b(new_n28_), .c(x10), .O(z6));
  nand3  g57(.a(x03), .b(new_n25_), .c(new_n34_), .O(new_n82_));
  ...
  oai21  g61(.a(new_n85_), .b(x05), .c(new_n31_), .O(z7));
  ...
  oai21  g65(.a(new_n89_), .b(x05), .c(new_n31_), .O(z8));
endmodule
