...
module FAU ( 
  ...
  nand3  g19(.a(new_n43_), .b(new_n34_), .c(new_n36_), .O(new_n44_));
  ...
  aoi21  g35(.a(new_n59_), .b(new_n50_), .c(new_n33_), .O(z2));
  inv1   g36(.a(x11), .O(new_n61_));
  oai22  g37(.a(new_n31_), .b(x00), .c(new_n61_), .d(new_n52_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n34_), .O(z3));
  nand2  g39(.a(x09), .b(x08), .O(new_n64_));
  oai22  g40(.a(new_n64_), .b(new_n36_), .c(new_n32_), .d(new_n31_), .O(new_n65_));
  nand3  g41(.a(new_n34_), .b(new_n61_), .c(x07), .O(new_n66_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n70_), .c(new_n47_), .O(new_n75_));
  aoi21  g51(.a(x14), .b(x02), .c(x00), .O(new_n76_));
  nor2   g52(.a(x08), .b(new_n36_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n76_), .c(x01), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n75_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n53_), .c(new_n52_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n34_), .O(z6));
  nand3  g57(.a(x03), .b(new_n25_), .c(new_n47_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n53_), .c(new_n52_), .O(new_n84_));
  aoi21  g60(.a(new_n82_), .b(new_n56_), .c(new_n84_), .O(new_n85_));
  nor2   g61(.a(new_n85_), .b(new_n33_), .O(z7));
  nor2   g62(.a(new_n33_), .b(x00), .O(new_n87_));
  nor2   g63(.a(x10), .b(x07), .O(new_n88_));
  nor2   g64(.a(new_n88_), .b(x13), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n87_), .c(new_n72_), .O(new_n90_));
  nand2  g66(.a(new_n82_), .b(x09), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n31_), .O(new_n93_));
  nand3  g69(.a(new_n32_), .b(x12), .c(x09), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n93_), .c(new_n90_), .O(z8));
endmodule
