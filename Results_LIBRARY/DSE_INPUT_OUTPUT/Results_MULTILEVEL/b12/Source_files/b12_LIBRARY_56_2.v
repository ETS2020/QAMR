...
module FAU ( 
  ...
  nor3   g42(.a(x07), .b(x06), .c(x00), .O(new_n67_));
  ...
  nand4  g54(.a(new_n78_), .b(new_n31_), .c(new_n51_), .d(new_n36_), .O(new_n79_));
  ...
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n51_), .d(new_n36_), .O(z8));
endmodule
