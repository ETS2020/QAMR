...
module FAU ( 
  ...
  nand2  g05(.a(x10), .b(x04), .O(new_n30_));
  ...
  nand3  g54(.a(new_n78_), .b(new_n74_), .c(new_n37_), .O(new_n79_));
  aoi21  g55(.a(x14), .b(x02), .c(x00), .O(new_n80_));
  nor2   g56(.a(x08), .b(new_n69_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n80_), .c(x01), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n26_), .c(new_n53_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n30_), .O(z6));
  nand3  g61(.a(x03), .b(new_n25_), .c(new_n37_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n56_), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n25_), .d(new_n37_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n26_), .d(new_n53_), .O(z7));
  nand4  g65(.a(new_n62_), .b(x03), .c(new_n25_), .d(new_n37_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n53_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x10), .c(new_n72_), .O(z8));
endmodule
