...
module FAU ( 
  ...
  nand2  g35(.a(x11), .b(new_n51_), .O(new_n60_));
  nand2  g36(.a(new_n25_), .b(new_n52_), .O(new_n61_));
  aoi22  g37(.a(new_n61_), .b(new_n60_), .c(x12), .d(new_n38_), .O(z3));
  ...
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n67_), .d(new_n52_), .O(z5));
  ...
  nand2  g61(.a(x11), .b(x10), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(z7));
  nand4  g63(.a(new_n67_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n72_), .b(new_n38_), .c(x10), .O(new_n90_));
