...
module FAU ( 
  ...
  nand2  g00(.a(x09), .b(x08), .O(new_n25_));
  ...
  nand2  g25(.a(new_n49_), .b(new_n37_), .O(new_n50_));
  inv1   g26(.a(x08), .O(new_n51_));
  nand3  g27(.a(x10), .b(new_n51_), .c(new_n47_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n50_), .c(x03), .O(new_n53_));
  ...
  nand3  g33(.a(new_n57_), .b(new_n46_), .c(new_n25_), .O(z2));
  ...
  and2   g38(.a(new_n59_), .b(new_n25_), .O(z4));
  inv1   g39(.a(x12), .O(new_n64_));
  nand3  g40(.a(x13), .b(new_n64_), .c(new_n54_), .O(new_n65_));
  inv1   g41(.a(new_n65_), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n25_), .c(new_n47_), .d(new_n37_), .O(z5));
  oai21  g43(.a(x09), .b(x00), .c(x08), .O(new_n68_));
  aoi21  g44(.a(x14), .b(x02), .c(new_n32_), .O(new_n69_));
  ...
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(x03), .O(new_n74_));
  nand3  g50(.a(x09), .b(new_n51_), .c(new_n26_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n32_), .O(new_n77_));
  nand3  g53(.a(new_n51_), .b(x01), .c(x00), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n71_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n54_), .c(new_n47_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n51_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n54_), .c(new_n72_), .d(new_n47_), .O(z7));
  nand2  g60(.a(new_n27_), .b(new_n32_), .O(new_n85_));
  nand3  g61(.a(new_n64_), .b(new_n51_), .c(x03), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n85_), .c(x09), .O(new_n87_));
  aoi21  g63(.a(new_n72_), .b(new_n37_), .c(x10), .O(new_n88_));
