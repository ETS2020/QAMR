// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:45 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n89_;
  or2    g00(.a(x14), .b(x13), .O(new_n25_));
  ...
  nand2  g35(.a(x12), .b(new_n37_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n59_), .c(new_n25_), .O(new_n61_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n25_), .O(z4));
  inv1   g43(.a(x12), .O(new_n68_));
  nor2   g44(.a(x07), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n68_), .d(new_n51_), .O(z5));
  ...
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n27_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n71_), .c(new_n32_), .O(new_n76_));
  ...
  nand3  g56(.a(new_n80_), .b(new_n51_), .c(new_n50_), .O(new_n81_));
  ...
  and2   g60(.a(new_n25_), .b(new_n51_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n50_), .O(z7));
  nand4  g62(.a(new_n68_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n73_), .b(new_n37_), .c(x07), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n85_), .O(z8));
endmodule
