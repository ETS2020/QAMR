...
module FAU ( 
  ...
  nand2  g06(.a(x10), .b(x01), .O(new_n31_));
  ...
  oai22  g39(.a(new_n63_), .b(new_n46_), .c(new_n35_), .d(new_n33_), .O(new_n64_));
  nand3  g40(.a(new_n31_), .b(new_n59_), .c(x07), .O(new_n65_));
  oai21  g41(.a(new_n64_), .b(x07), .c(new_n65_), .O(z4));
  oai21  g42(.a(x07), .b(x00), .c(new_n31_), .O(new_n67_));
  nand2  g43(.a(x10), .b(new_n33_), .O(new_n68_));
  inv1   g44(.a(x13), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x12), .c(new_n35_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n68_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n49_), .c(new_n46_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n67_), .O(z5));
  nand2  g49(.a(x08), .b(x00), .O(new_n74_));
  nand2  g50(.a(x09), .b(new_n47_), .O(new_n75_));
  ...
  nor2   g56(.a(x08), .b(new_n46_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n80_), .c(x01), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n35_), .c(new_n49_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand3  g61(.a(x03), .b(new_n25_), .c(new_n33_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n53_), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n25_), .d(new_n33_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n35_), .d(new_n49_), .O(z7));
  nand4  g65(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n33_), .O(new_n90_));
