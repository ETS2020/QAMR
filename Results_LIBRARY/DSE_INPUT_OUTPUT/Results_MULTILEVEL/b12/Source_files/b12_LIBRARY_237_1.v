...
module FAU ( 
  ...
  oai21  g13(.a(x10), .b(new_n27_), .c(new_n35_), .O(new_n38_));
  ...
  oai21  g28(.a(new_n52_), .b(new_n49_), .c(new_n31_), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(new_n44_), .c(new_n36_), .O(z2));
  inv1   g30(.a(x11), .O(new_n55_));
  inv1   g31(.a(x12), .O(new_n56_));
  oai22  g32(.a(new_n56_), .b(x00), .c(new_n55_), .d(new_n46_), .O(new_n57_));
  ...
  nand3  g37(.a(new_n61_), .b(new_n60_), .c(new_n36_), .O(z4));
  nor2   g38(.a(x07), .b(x00), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n56_), .d(new_n47_), .O(z5));
  inv1   g40(.a(x09), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n26_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n50_), .c(x00), .O(new_n67_));
  nand3  g43(.a(x09), .b(new_n31_), .c(new_n25_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n35_), .O(new_n70_));
  aoi21  g46(.a(new_n65_), .b(x03), .c(x02), .O(new_n71_));
  oai21  g47(.a(new_n65_), .b(x02), .c(new_n50_), .O(new_n72_));
  oai22  g48(.a(new_n72_), .b(new_n35_), .c(new_n71_), .d(x00), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n31_), .O(new_n74_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n74_), .c(new_n70_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n47_), .c(new_n46_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand3  g56(.a(x09), .b(new_n26_), .c(new_n31_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n47_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x03), .O(new_n83_));
  nand3  g59(.a(x03), .b(new_n26_), .c(new_n31_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n50_), .c(x07), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x10), .c(new_n83_), .O(z7));
  nand4  g62(.a(new_n56_), .b(x03), .c(new_n26_), .d(new_n31_), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n46_), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  nand2  g65(.a(x10), .b(x03), .O(new_n90_));
