...
module FAU ( 
  ...
  nor2   g48(.a(x08), .b(new_n38_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n72_), .c(x01), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n71_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n47_), .c(new_n25_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(z6));
  nand3  g53(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n78_));
  nor2   g54(.a(x02), .b(x01), .O(new_n79_));
  nor2   g55(.a(new_n53_), .b(new_n27_), .O(new_n80_));
  aoi22  g56(.a(new_n80_), .b(new_n79_), .c(new_n78_), .d(new_n52_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(x10), .c(new_n25_), .O(z7));
  nand3  g58(.a(new_n79_), .b(new_n57_), .c(x03), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n53_), .b(new_n38_), .c(x10), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n25_), .O(z8));
endmodule
