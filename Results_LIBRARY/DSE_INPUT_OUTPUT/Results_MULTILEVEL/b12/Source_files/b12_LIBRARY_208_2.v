...
module FAU ( 
  ...
  oai22  g39(.a(new_n63_), .b(new_n38_), .c(x13), .d(new_n62_), .O(new_n64_));
  inv1   g40(.a(x11), .O(new_n65_));
  nand3  g41(.a(new_n26_), .b(new_n65_), .c(x07), .O(new_n66_));
  oai21  g42(.a(new_n64_), .b(x07), .c(new_n66_), .O(z4));
  oai21  g43(.a(x07), .b(x00), .c(new_n26_), .O(new_n68_));
  oai21  g44(.a(new_n25_), .b(x10), .c(new_n62_), .O(new_n69_));
  oai21  g45(.a(new_n25_), .b(new_n62_), .c(new_n69_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n51_), .c(new_n38_), .O(new_n71_));
  ...
  nand4  g58(.a(new_n82_), .b(new_n26_), .c(new_n52_), .d(new_n51_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  inv1   g60(.a(new_n26_), .O(new_n85_));
  ...
  aoi21  g64(.a(new_n86_), .b(new_n55_), .c(new_n88_), .O(new_n89_));
  nor2   g65(.a(new_n89_), .b(new_n85_), .O(z7));
  oai21  g66(.a(new_n25_), .b(x09), .c(x12), .O(new_n91_));
  nand2  g67(.a(new_n86_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n75_), .b(new_n38_), .c(x10), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n51_), .O(z8));
endmodule
