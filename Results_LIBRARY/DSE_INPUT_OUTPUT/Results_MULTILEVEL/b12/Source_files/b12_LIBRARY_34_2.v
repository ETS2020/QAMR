...
module FAU ( 
  ...
  nand4  g58(.a(x09), .b(x03), .c(new_n25_), .d(new_n67_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n31_), .d(new_n44_), .O(z7));
  nand4  g60(.a(new_n56_), .b(x03), .c(new_n25_), .d(new_n67_), .O(new_n85_));
  nor2   g61(.a(x09), .b(x00), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x07), .c(new_n31_), .O(z8));
endmodule
