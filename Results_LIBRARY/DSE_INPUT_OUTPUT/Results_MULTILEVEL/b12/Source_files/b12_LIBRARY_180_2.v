...
module FAU ( 
  ...
  oai21  g41(.a(x07), .b(new_n34_), .c(x10), .O(new_n66_));
  nand3  g42(.a(x13), .b(new_n59_), .c(new_n34_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n57_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n66_), .O(z5));
  ...
  nand3  g50(.a(new_n74_), .b(new_n70_), .c(new_n45_), .O(new_n75_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n31_), .c(new_n57_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n82_));
  nor2   g58(.a(x02), .b(x01), .O(new_n83_));
  nor2   g59(.a(new_n72_), .b(new_n35_), .O(new_n84_));
  aoi22  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n52_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x07), .c(new_n31_), .O(z7));
  nand3  g62(.a(new_n83_), .b(new_n59_), .c(x03), .O(new_n87_));
  nor2   g63(.a(x09), .b(x00), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x07), .c(new_n31_), .O(z8));
endmodule
