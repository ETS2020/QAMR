...
module FAU ( 
  ...
  nand3  g43(.a(new_n67_), .b(new_n52_), .c(new_n47_), .O(new_n68_));
  ...
  nand3  g51(.a(x03), .b(new_n25_), .c(new_n47_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand4  g53(.a(x09), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n48_), .d(new_n49_), .O(z7));
  inv1   g55(.a(x12), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x09), .O(new_n82_));
  aoi21  g58(.a(new_n65_), .b(new_n33_), .c(x10), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n49_), .O(z8));
endmodule
