...
module FAU ( 
  ...
  nand4  g32(.a(new_n25_), .b(x09), .c(new_n56_), .d(new_n53_), .O(new_n57_));
  inv1   g33(.a(new_n57_), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n55_), .c(new_n33_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n51_), .c(new_n26_), .O(z2));
  nand2  g36(.a(x11), .b(x07), .O(new_n61_));
  nand2  g37(.a(x12), .b(new_n38_), .O(new_n62_));
  ...
  nor3   g46(.a(x07), .b(x06), .c(x00), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(x13), .c(new_n70_), .d(new_n25_), .O(z5));
  ...
  nand4  g58(.a(new_n82_), .b(new_n25_), .c(new_n53_), .d(new_n39_), .O(new_n83_));
  ...
  nand2  g62(.a(new_n86_), .b(new_n53_), .O(new_n87_));
  aoi21  g63(.a(new_n85_), .b(new_n56_), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x06), .c(new_n25_), .O(z7));
  nand4  g65(.a(new_n70_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n53_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x06), .c(new_n25_), .O(z8));
endmodule
