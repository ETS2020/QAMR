...
module FAU ( 
  ...
  oai21  g38(.a(x10), .b(x07), .c(new_n25_), .O(new_n63_));
  ...
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n60_), .d(new_n52_), .O(z5));
  ...
  nand3  g54(.a(new_n78_), .b(new_n52_), .c(new_n51_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  oai21  g56(.a(new_n42_), .b(x01), .c(new_n55_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n52_), .d(new_n51_), .O(z7));
  nand4  g59(.a(new_n60_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n84_));
  oai21  g60(.a(x09), .b(x00), .c(new_n51_), .O(new_n85_));
  aoi21  g61(.a(new_n84_), .b(x09), .c(new_n85_), .O(new_n86_));
  nand2  g62(.a(x11), .b(x10), .O(new_n87_));
