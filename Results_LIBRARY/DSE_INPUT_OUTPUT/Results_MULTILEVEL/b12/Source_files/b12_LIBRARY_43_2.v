...
module FAU ( 
  ...
  nand4  g13(.a(new_n37_), .b(new_n36_), .c(x10), .d(x02), .O(new_n38_));
  ...
  nor2   g18(.a(new_n31_), .b(x03), .O(new_n43_));
  inv1   g19(.a(x09), .O(new_n44_));
  nor2   g20(.a(x10), .b(new_n44_), .O(new_n45_));
  oai21  g21(.a(new_n45_), .b(new_n43_), .c(new_n42_), .O(new_n46_));
  ...
  oai21  g27(.a(new_n51_), .b(new_n49_), .c(new_n41_), .O(new_n52_));
  ...
  nand2  g32(.a(x12), .b(new_n47_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n56_), .c(new_n32_), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(z3));
  nand2  g35(.a(x09), .b(x08), .O(new_n60_));
  oai22  g36(.a(new_n60_), .b(new_n47_), .c(x10), .d(new_n25_), .O(new_n61_));
  inv1   g37(.a(x11), .O(new_n62_));
  nand3  g38(.a(new_n32_), .b(new_n62_), .c(x07), .O(new_n63_));
  oai21  g39(.a(new_n61_), .b(x07), .c(new_n63_), .O(z4));
  inv1   g40(.a(x07), .O(new_n65_));
  inv1   g41(.a(x12), .O(new_n66_));
  nand4  g42(.a(x13), .b(new_n66_), .c(new_n65_), .d(new_n47_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n25_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n31_), .O(z5));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  nand2  g46(.a(x09), .b(new_n34_), .O(new_n71_));
  nand2  g47(.a(new_n44_), .b(x03), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n41_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n70_), .c(new_n65_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n25_), .c(x10), .O(z6));
  aoi21  g51(.a(x03), .b(new_n41_), .c(x08), .O(new_n76_));
  nand2  g52(.a(x09), .b(x03), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(x01), .c(new_n65_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n76_), .c(new_n25_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n31_), .O(z7));
  nand3  g56(.a(new_n66_), .b(x03), .c(new_n41_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x09), .O(new_n82_));
  aoi21  g58(.a(new_n44_), .b(new_n47_), .c(x10), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n65_), .d(new_n25_), .O(z8));
endmodule
