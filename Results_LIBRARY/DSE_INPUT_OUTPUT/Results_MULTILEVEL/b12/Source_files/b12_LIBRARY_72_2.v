...
module FAU ( 
  ...
  nand4  g41(.a(x13), .b(new_n59_), .c(new_n51_), .d(new_n34_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n50_), .O(new_n67_));
  oai21  g43(.a(new_n31_), .b(new_n50_), .c(new_n67_), .O(z5));
  ...
  nand2  g56(.a(new_n80_), .b(new_n31_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n51_), .d(new_n50_), .O(z7));
