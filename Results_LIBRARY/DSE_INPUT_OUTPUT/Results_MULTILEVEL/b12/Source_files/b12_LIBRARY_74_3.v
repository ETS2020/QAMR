...
module FAU ( 
  ...
  oai21  g13(.a(new_n37_), .b(new_n26_), .c(x01), .O(new_n38_));
  ...
  oai22  g40(.a(new_n64_), .b(new_n35_), .c(new_n30_), .d(new_n37_), .O(new_n65_));
  inv1   g41(.a(x11), .O(new_n66_));
  nand3  g42(.a(new_n25_), .b(new_n66_), .c(x07), .O(new_n67_));
  oai21  g43(.a(new_n65_), .b(x07), .c(new_n67_), .O(z4));
  oai21  g44(.a(x07), .b(x00), .c(new_n25_), .O(new_n69_));
  inv1   g45(.a(x13), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x12), .c(new_n30_), .O(new_n71_));
  oai21  g47(.a(new_n30_), .b(x05), .c(new_n71_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n52_), .c(new_n35_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n69_), .O(z5));
  nand2  g50(.a(x08), .b(x00), .O(new_n75_));
  nand2  g51(.a(x09), .b(new_n36_), .O(new_n76_));
  inv1   g52(.a(x09), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x03), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n26_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n75_), .c(new_n47_), .O(new_n80_));
  aoi21  g56(.a(x14), .b(x02), .c(x00), .O(new_n81_));
  nor2   g57(.a(x08), .b(new_n35_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n81_), .c(x01), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n80_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n30_), .c(new_n52_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n25_), .O(z6));
  nand3  g62(.a(x03), .b(new_n26_), .c(new_n47_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n55_), .O(new_n88_));
  nand4  g64(.a(x09), .b(x03), .c(new_n26_), .d(new_n47_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n30_), .d(new_n52_), .O(z7));
  inv1   g66(.a(x12), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(x03), .c(new_n26_), .d(new_n47_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  aoi21  g69(.a(new_n77_), .b(new_n35_), .c(x10), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n93_), .c(new_n52_), .O(z8));
endmodule
