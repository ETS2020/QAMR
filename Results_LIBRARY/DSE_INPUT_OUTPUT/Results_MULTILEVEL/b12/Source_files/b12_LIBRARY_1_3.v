// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:12 2020
...
module FAU ( 
  ...
  nor3   g20(.a(x03), .b(x01), .c(x00), .O(new_n45_));
  oai21  g21(.a(new_n45_), .b(x10), .c(x07), .O(new_n46_));
  ...
  nand3  g28(.a(new_n52_), .b(new_n51_), .c(new_n47_), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(new_n46_), .c(new_n44_), .O(z2));
  ...
  nand4  g38(.a(x13), .b(new_n56_), .c(new_n48_), .d(new_n33_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n49_), .O(new_n64_));
  oai21  g40(.a(x10), .b(new_n49_), .c(new_n64_), .O(z5));
  nand2  g41(.a(x09), .b(new_n34_), .O(new_n66_));
  inv1   g42(.a(x09), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x03), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n66_), .c(new_n25_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n52_), .c(new_n47_), .O(new_n70_));
  aoi21  g46(.a(x14), .b(x02), .c(x00), .O(new_n71_));
  nor2   g47(.a(x08), .b(new_n33_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(x01), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n70_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n48_), .c(new_n49_), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(z6));
  inv1   g52(.a(x08), .O(new_n77_));
  nand3  g53(.a(x03), .b(new_n25_), .c(new_n47_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n48_), .d(new_n49_), .O(z7));
  nand4  g57(.a(new_n56_), .b(x03), .c(new_n25_), .d(new_n47_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n67_), .b(new_n33_), .c(x10), .O(new_n84_));
