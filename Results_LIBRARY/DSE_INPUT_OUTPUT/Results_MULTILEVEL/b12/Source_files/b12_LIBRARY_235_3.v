...
module FAU ( 
  ...
  nor2   g47(.a(new_n54_), .b(new_n37_), .O(new_n72_));
  ...
  nor2   g52(.a(x14), .b(new_n32_), .O(new_n77_));
  aoi21  g53(.a(new_n76_), .b(new_n32_), .c(new_n77_), .O(new_n78_));
  nor2   g54(.a(x02), .b(x00), .O(new_n79_));
  nor2   g55(.a(x08), .b(new_n37_), .O(new_n80_));
  ...
  oai21  g60(.a(new_n41_), .b(x01), .c(new_n54_), .O(new_n85_));
  nand4  g61(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n86_));
  aoi21  g62(.a(x14), .b(x13), .c(x10), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n50_), .O(z7));
  nand4  g64(.a(new_n68_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n74_), .b(new_n37_), .c(x07), .O(new_n91_));
