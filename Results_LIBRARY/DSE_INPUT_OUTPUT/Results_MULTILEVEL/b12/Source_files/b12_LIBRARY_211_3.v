...
module FAU ( 
  ...
  nand4  g43(.a(x13), .b(new_n60_), .c(new_n58_), .d(new_n33_), .O(new_n68_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n71_), .c(new_n43_), .O(new_n75_));
  nand2  g51(.a(x14), .b(x02), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n33_), .O(new_n77_));
  oai21  g53(.a(x08), .b(new_n33_), .c(new_n77_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n45_), .c(x01), .O(new_n79_));
  ...
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n45_), .d(new_n58_), .O(z7));
  oai21  g62(.a(x10), .b(x09), .c(new_n34_), .O(new_n87_));
  nor2   g63(.a(x12), .b(x02), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n43_), .c(new_n47_), .O(new_n89_));
  oai21  g65(.a(x09), .b(x00), .c(new_n58_), .O(new_n90_));
