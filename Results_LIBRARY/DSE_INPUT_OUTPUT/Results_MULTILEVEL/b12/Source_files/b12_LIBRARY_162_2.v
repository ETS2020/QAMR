...
module FAU ( 
  ...
  aoi21  g25(.a(new_n33_), .b(new_n49_), .c(x03), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n48_), .c(x02), .O(new_n51_));
  nand2  g27(.a(new_n48_), .b(new_n36_), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  nor2   g29(.a(new_n45_), .b(x03), .O(new_n54_));
  aoi22  g30(.a(new_n54_), .b(new_n53_), .c(new_n33_), .d(x03), .O(new_n55_));
  oai21  g31(.a(new_n51_), .b(new_n47_), .c(new_n55_), .O(z2));
  ...
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n34_), .O(z4));
  nor3   g40(.a(x07), .b(x03), .c(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n58_), .d(new_n33_), .O(z5));
  nor2   g42(.a(x09), .b(x02), .O(new_n67_));
  nand2  g43(.a(new_n46_), .b(x00), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n52_), .c(new_n67_), .O(new_n69_));
  nand2  g45(.a(x14), .b(x02), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n36_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n68_), .c(new_n48_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n69_), .c(new_n45_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n37_), .c(x10), .O(z6));
  nand4  g50(.a(new_n33_), .b(x08), .c(new_n45_), .d(new_n37_), .O(z7));
  nand3  g51(.a(new_n49_), .b(new_n45_), .c(x00), .O(new_n76_));
