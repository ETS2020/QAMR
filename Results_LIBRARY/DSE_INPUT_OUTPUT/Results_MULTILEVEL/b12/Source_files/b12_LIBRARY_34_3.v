...
module FAU ( 
  ...
  nand3  g36(.a(new_n55_), .b(new_n45_), .c(x07), .O(new_n61_));
  ...
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n49_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n45_), .d(new_n54_), .O(z7));
  nand4  g58(.a(new_n56_), .b(x03), .c(new_n25_), .d(new_n49_), .O(new_n83_));
