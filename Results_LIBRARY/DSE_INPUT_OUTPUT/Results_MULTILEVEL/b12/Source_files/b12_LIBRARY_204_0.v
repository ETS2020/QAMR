...
module FAU ( 
  ...
  nand2  g26(.a(new_n30_), .b(x09), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand4  g28(.a(new_n52_), .b(new_n49_), .c(new_n48_), .d(new_n25_), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(new_n47_), .c(new_n44_), .O(z2));
  inv1   g30(.a(x12), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(x10), .O(new_n56_));
  aoi22  g32(.a(new_n56_), .b(new_n45_), .c(x11), .d(x07), .O(z3));
  oai21  g33(.a(new_n30_), .b(new_n48_), .c(new_n45_), .O(new_n58_));
  inv1   g34(.a(x09), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n49_), .c(new_n48_), .O(new_n60_));
  ...
  nand2  g40(.a(x09), .b(new_n35_), .O(new_n66_));
  nand2  g41(.a(new_n59_), .b(x03), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(new_n49_), .c(new_n48_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(x00), .c(x10), .O(z6));
  nand2  g45(.a(new_n40_), .b(new_n25_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n49_), .O(new_n72_));
  nor2   g47(.a(x07), .b(new_n45_), .O(new_n73_));
  nand3  g48(.a(new_n65_), .b(x09), .c(x03), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n30_), .O(z7));
  nand3  g50(.a(new_n65_), .b(new_n55_), .c(x03), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(x09), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n30_), .c(new_n48_), .d(x00), .O(z8));
  one    g53(.O(z5));
endmodule
