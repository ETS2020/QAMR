...
module FAU ( 
  ...
  oai22  g37(.a(new_n61_), .b(x00), .c(new_n54_), .d(new_n47_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n25_), .O(z3));
  oai21  g39(.a(new_n54_), .b(x10), .c(x07), .O(new_n64_));
  ...
  nand2  g43(.a(new_n54_), .b(x10), .O(new_n68_));
  nand4  g44(.a(x13), .b(new_n61_), .c(new_n47_), .d(new_n37_), .O(new_n69_));
  ...
  nand3  g57(.a(new_n81_), .b(new_n52_), .c(new_n47_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n25_), .O(z6));
  nand3  g59(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n47_), .O(new_n86_));
  aoi21  g62(.a(new_n84_), .b(new_n48_), .c(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x10), .c(new_n68_), .O(z7));
  nand4  g64(.a(new_n61_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n74_), .b(new_n37_), .c(x10), .O(new_n91_));
