...
module FAU ( 
  ...
  nand3  g26(.a(new_n50_), .b(x09), .c(new_n31_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n49_), .c(x00), .O(new_n52_));
  inv1   g28(.a(x08), .O(new_n53_));
  nand4  g29(.a(new_n50_), .b(x09), .c(new_n53_), .d(new_n31_), .O(new_n54_));
  ...
  oai21  g35(.a(new_n59_), .b(x11), .c(x07), .O(z3));
  nand2  g36(.a(x08), .b(x00), .O(new_n61_));
  nand2  g37(.a(new_n58_), .b(x09), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n61_), .c(new_n31_), .O(new_n63_));
  oai21  g39(.a(x11), .b(new_n31_), .c(new_n63_), .O(z4));
  nand3  g40(.a(x13), .b(new_n50_), .c(new_n34_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n58_), .O(new_n66_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n61_), .c(new_n45_), .O(new_n72_));
  ...
  aoi21  g53(.a(new_n77_), .b(new_n58_), .c(x07), .O(z6));
  nand3  g54(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n50_), .O(new_n81_));
  aoi21  g57(.a(new_n79_), .b(new_n53_), .c(new_n81_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x12), .c(new_n31_), .O(z7));
  oai21  g59(.a(x09), .b(x00), .c(new_n50_), .O(new_n84_));
  aoi21  g60(.a(new_n79_), .b(x09), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x12), .c(new_n31_), .O(z8));
endmodule
