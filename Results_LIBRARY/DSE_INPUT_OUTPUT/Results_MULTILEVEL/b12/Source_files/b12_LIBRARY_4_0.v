...
module FAU ( 
  ...
  oai22  g36(.a(new_n60_), .b(x00), .c(new_n59_), .d(new_n43_), .O(new_n61_));
  nand2  g37(.a(new_n39_), .b(new_n49_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n61_), .O(z3));
  oai21  g39(.a(new_n39_), .b(new_n43_), .c(new_n49_), .O(new_n64_));
  nand2  g40(.a(x09), .b(x08), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n43_), .O(new_n66_));
  nand2  g42(.a(new_n59_), .b(x07), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n64_), .O(z4));
  nor2   g44(.a(x10), .b(x07), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(x13), .c(new_n60_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x08), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n49_), .O(z5));
  oai21  g48(.a(x01), .b(x00), .c(x08), .O(new_n73_));
  xor2a  g49(.a(x09), .b(x03), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(x02), .c(new_n73_), .O(new_n75_));
  aoi21  g51(.a(x14), .b(x02), .c(x00), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n39_), .c(x01), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n75_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n51_), .c(new_n43_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n62_), .O(z6));
  nand3  g56(.a(new_n40_), .b(new_n31_), .c(x00), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n39_), .O(new_n82_));
  nor2   g58(.a(x02), .b(x01), .O(new_n83_));
  and2   g59(.a(x09), .b(x03), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(x10), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n82_), .c(new_n43_), .O(z7));
  nand2  g62(.a(new_n65_), .b(new_n49_), .O(new_n87_));
  nand3  g63(.a(new_n83_), .b(new_n60_), .c(x03), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n69_), .O(z8));
endmodule
