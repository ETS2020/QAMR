...
module FAU ( 
  ...
  nand4  g32(.a(new_n47_), .b(x09), .c(new_n56_), .d(new_n53_), .O(new_n57_));
  ...
  nand3  g57(.a(new_n81_), .b(new_n47_), .c(new_n53_), .O(new_n82_));
  ...
  nand2  g62(.a(new_n84_), .b(new_n56_), .O(new_n87_));
  nand2  g63(.a(new_n26_), .b(new_n47_), .O(new_n88_));
  nor2   g64(.a(new_n88_), .b(x07), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n86_), .O(z7));
  oai21  g66(.a(x10), .b(x07), .c(new_n26_), .O(new_n91_));
  nand4  g67(.a(new_n62_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  nand3  g69(.a(new_n62_), .b(new_n25_), .c(new_n38_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n93_), .c(new_n91_), .O(z8));
endmodule
