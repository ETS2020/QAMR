...
module FAU ( 
  ...
  nor2   g07(.a(new_n31_), .b(x11), .O(new_n32_));
  ...
  nand4  g55(.a(new_n79_), .b(new_n33_), .c(new_n52_), .d(new_n51_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n55_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n84_));
  nor2   g60(.a(new_n32_), .b(x10), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n51_), .O(z7));
  nor2   g62(.a(new_n32_), .b(x00), .O(new_n87_));
  nor2   g63(.a(x10), .b(x07), .O(new_n88_));
  nor2   g64(.a(new_n88_), .b(new_n62_), .O(new_n89_));
  ...
  nand3  g69(.a(x12), .b(x11), .c(x09), .O(new_n94_));
