...
module FAU ( 
  ...
  oai22  g35(.a(new_n31_), .b(x00), .c(new_n59_), .d(new_n50_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n32_), .O(z3));
  nand2  g37(.a(x09), .b(x08), .O(new_n62_));
  oai22  g38(.a(new_n62_), .b(new_n34_), .c(x12), .d(new_n51_), .O(new_n63_));
  nand3  g39(.a(new_n32_), .b(new_n59_), .c(x07), .O(new_n64_));
  oai21  g40(.a(new_n63_), .b(x07), .c(new_n64_), .O(z4));
  nand3  g41(.a(x13), .b(new_n50_), .c(new_n34_), .O(new_n66_));
  ...
  nand4  g59(.a(new_n31_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n84_));
