...
module FAU ( 
  ...
  nand2  g37(.a(x12), .b(new_n37_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n25_), .O(new_n63_));
  ...
  nand4  g47(.a(new_n71_), .b(x13), .c(new_n70_), .d(new_n52_), .O(z5));
  ...
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n32_), .O(new_n78_));
  ...
  nand3  g58(.a(new_n82_), .b(new_n52_), .c(new_n47_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n25_), .O(z6));
  nand2  g60(.a(new_n54_), .b(x10), .O(new_n85_));
  ...
  aoi21  g64(.a(new_n86_), .b(new_n48_), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x10), .c(new_n85_), .O(z7));
  nand4  g66(.a(new_n70_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n91_));
  oai21  g67(.a(x09), .b(x00), .c(new_n47_), .O(new_n92_));
  aoi21  g68(.a(new_n91_), .b(x09), .c(new_n92_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x10), .c(new_n85_), .O(z8));
endmodule
