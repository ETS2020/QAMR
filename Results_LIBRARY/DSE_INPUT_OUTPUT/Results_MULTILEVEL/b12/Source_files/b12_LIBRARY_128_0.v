...
module FAU ( 
  ...
  nand2  g11(.a(new_n33_), .b(new_n25_), .O(new_n36_));
  nor2   g12(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  oai21  g13(.a(new_n28_), .b(new_n35_), .c(x06), .O(new_n38_));
  nand2  g14(.a(x10), .b(new_n31_), .O(new_n39_));
  aoi21  g15(.a(new_n39_), .b(new_n38_), .c(new_n25_), .O(new_n40_));
  oai21  g16(.a(new_n40_), .b(new_n37_), .c(x03), .O(new_n41_));
  nand2  g17(.a(new_n39_), .b(new_n38_), .O(new_n42_));
  nand3  g18(.a(new_n42_), .b(x04), .c(x02), .O(new_n43_));
  aoi21  g19(.a(new_n43_), .b(new_n41_), .c(x00), .O(z1));
  oai21  g20(.a(x08), .b(x07), .c(x00), .O(new_n45_));
  inv1   g21(.a(x03), .O(new_n46_));
  nand3  g22(.a(x10), .b(new_n46_), .c(new_n35_), .O(new_n47_));
  ...
  nand3  g27(.a(new_n32_), .b(x09), .c(new_n51_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n50_), .c(x00), .O(new_n53_));
  inv1   g29(.a(x08), .O(new_n54_));
  nand4  g30(.a(new_n32_), .b(x09), .c(new_n54_), .d(new_n51_), .O(new_n55_));
  ...
  oai22  g40(.a(new_n64_), .b(new_n63_), .c(x10), .d(x06), .O(new_n65_));
  nand3  g41(.a(new_n33_), .b(new_n59_), .c(x07), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x07), .c(new_n66_), .O(z4));
  nand4  g43(.a(x13), .b(new_n60_), .c(new_n51_), .d(new_n63_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x06), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n32_), .O(z5));
  ...
  nand3  g51(.a(new_n75_), .b(new_n71_), .c(new_n35_), .O(new_n76_));
  aoi21  g52(.a(x14), .b(x02), .c(x00), .O(new_n77_));
  nor2   g53(.a(x08), .b(new_n63_), .O(new_n78_));
  ...
  aoi21  g57(.a(new_n81_), .b(x06), .c(x10), .O(z6));
  nand3  g58(.a(x03), .b(new_n25_), .c(new_n35_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n54_), .O(new_n84_));
  nor2   g60(.a(x07), .b(new_n31_), .O(new_n85_));
  nand4  g61(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n32_), .O(z7));
  nand4  g63(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n51_), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n31_), .c(new_n32_), .O(z8));
endmodule
