...
module FAU ( 
  ...
  nand3  g28(.a(x10), .b(x06), .c(new_n27_), .O(new_n53_));
  ...
  nand2  g32(.a(new_n54_), .b(x09), .O(new_n57_));
  aoi21  g33(.a(new_n57_), .b(new_n53_), .c(x08), .O(new_n58_));
  ...
  oai22  g38(.a(new_n62_), .b(x00), .c(new_n61_), .d(new_n48_), .O(new_n63_));
  ...
  aoi22  g43(.a(new_n67_), .b(new_n66_), .c(x10), .d(new_n25_), .O(z4));
  nor2   g44(.a(x07), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n62_), .d(new_n54_), .O(z5));
  ...
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n28_), .O(new_n75_));
  ...
  nand2  g58(.a(x10), .b(x06), .O(new_n83_));
  ...
  nand4  g64(.a(new_n62_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n73_), .b(new_n38_), .c(x10), .O(new_n91_));
