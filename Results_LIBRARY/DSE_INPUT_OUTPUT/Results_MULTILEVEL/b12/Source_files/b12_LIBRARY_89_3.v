...
module FAU ( 
  ...
  nand2  g36(.a(new_n52_), .b(new_n47_), .O(new_n61_));
  aoi22  g37(.a(new_n61_), .b(x11), .c(x12), .d(new_n37_), .O(z3));
  oai21  g38(.a(new_n54_), .b(x10), .c(x07), .O(new_n63_));
  ...
  nand2  g42(.a(new_n54_), .b(x10), .O(new_n67_));
  ...
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n52_), .d(new_n47_), .O(z7));
  nand4  g63(.a(new_n68_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n88_));
