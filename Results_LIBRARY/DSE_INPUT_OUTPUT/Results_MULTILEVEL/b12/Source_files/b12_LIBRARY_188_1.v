...
module FAU ( 
  ...
  aoi22  g22(.a(new_n46_), .b(new_n28_), .c(x10), .d(new_n25_), .O(new_n47_));
  nand3  g23(.a(x10), .b(x08), .c(new_n27_), .O(new_n48_));
  ...
  oai21  g28(.a(new_n52_), .b(new_n47_), .c(new_n38_), .O(new_n53_));
  inv1   g29(.a(x09), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(x01), .c(new_n28_), .O(new_n55_));
  nand4  g31(.a(new_n55_), .b(new_n50_), .c(new_n25_), .d(new_n49_), .O(new_n56_));
  ...
  nand3  g37(.a(new_n26_), .b(new_n58_), .c(x07), .O(new_n62_));
  aoi21  g38(.a(x09), .b(x00), .c(new_n25_), .O(new_n63_));
  aoi21  g39(.a(new_n50_), .b(new_n25_), .c(new_n63_), .O(new_n64_));
  ...
  nand2  g45(.a(new_n54_), .b(x03), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n28_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n68_), .c(new_n33_), .O(new_n72_));
  nand2  g48(.a(x14), .b(x02), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n50_), .c(new_n38_), .O(new_n74_));
  nand2  g50(.a(new_n25_), .b(x00), .O(new_n75_));
  ...
  nand2  g55(.a(new_n79_), .b(new_n26_), .O(z6));
  nand2  g56(.a(x10), .b(x08), .O(new_n81_));
  ...
  aoi21  g60(.a(new_n82_), .b(new_n25_), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x10), .c(new_n81_), .O(z7));
  nand4  g62(.a(new_n59_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n49_), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x10), .c(new_n81_), .O(z8));
endmodule
