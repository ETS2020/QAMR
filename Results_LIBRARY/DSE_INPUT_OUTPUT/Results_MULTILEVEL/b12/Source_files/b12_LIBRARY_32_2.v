...
module FAU ( 
  ...
  oai21  g39(.a(new_n58_), .b(new_n25_), .c(x07), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n63_), .O(z4));
  inv1   g41(.a(x13), .O(new_n66_));
  nor2   g42(.a(new_n66_), .b(x12), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n25_), .c(new_n61_), .d(new_n38_), .O(z5));
  ...
  nand3  g62(.a(new_n82_), .b(new_n86_), .c(x03), .O(new_n87_));
