...
module FAU ( 
  ...
  nand2  g01(.a(x07), .b(new_n25_), .O(new_n26_));
  ...
  nand2  g13(.a(new_n26_), .b(new_n28_), .O(new_n38_));
  nor2   g14(.a(new_n38_), .b(new_n33_), .O(new_n39_));
  ...
  nand2  g21(.a(new_n43_), .b(new_n41_), .O(new_n46_));
  nand3  g22(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  aoi21  g23(.a(new_n47_), .b(new_n45_), .c(x00), .O(z1));
  inv1   g24(.a(x00), .O(new_n49_));
  aoi21  g25(.a(x07), .b(new_n25_), .c(new_n28_), .O(new_n50_));
  inv1   g26(.a(x10), .O(new_n51_));
  nand2  g27(.a(x07), .b(x06), .O(new_n52_));
  oai21  g28(.a(new_n51_), .b(x07), .c(new_n52_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n27_), .O(new_n54_));
  inv1   g30(.a(x09), .O(new_n55_));
  nor2   g31(.a(x10), .b(new_n55_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n42_), .O(new_n57_));
  aoi21  g33(.a(new_n57_), .b(new_n54_), .c(x01), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n50_), .c(new_n49_), .O(new_n59_));
  inv1   g35(.a(x08), .O(new_n60_));
  nor2   g36(.a(new_n51_), .b(x03), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n56_), .c(new_n33_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n28_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n60_), .c(new_n42_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n59_), .O(z2));
  inv1   g41(.a(x11), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x06), .O(new_n67_));
  aoi22  g43(.a(new_n67_), .b(x07), .c(x12), .d(new_n49_), .O(z3));
  nand3  g44(.a(x09), .b(x08), .c(x00), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n42_), .O(new_n70_));
  nand3  g46(.a(new_n66_), .b(x07), .c(x06), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(z4));
  inv1   g48(.a(x13), .O(new_n73_));
  nor2   g49(.a(new_n73_), .b(x12), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n51_), .c(new_n42_), .d(new_n49_), .O(z5));
  nand2  g51(.a(x08), .b(x00), .O(new_n76_));
  nand2  g52(.a(x09), .b(new_n27_), .O(new_n77_));
  nand2  g53(.a(new_n55_), .b(x03), .O(new_n78_));
  ...
  nor2   g57(.a(x08), .b(new_n49_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n81_), .c(x01), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n80_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n51_), .c(new_n42_), .O(new_n85_));
  inv1   g61(.a(new_n85_), .O(z6));
  nand3  g62(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n51_), .O(new_n89_));
  aoi21  g65(.a(new_n87_), .b(new_n60_), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x07), .c(new_n52_), .O(z7));
  inv1   g67(.a(x12), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n93_));
  oai21  g69(.a(x09), .b(x00), .c(new_n51_), .O(new_n94_));
  aoi21  g70(.a(new_n93_), .b(x09), .c(new_n94_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x07), .c(new_n52_), .O(z8));
endmodule
