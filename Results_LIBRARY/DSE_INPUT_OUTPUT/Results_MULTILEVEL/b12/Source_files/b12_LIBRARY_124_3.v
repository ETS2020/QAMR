...
module FAU ( 
  ...
  oai21  g19(.a(new_n43_), .b(new_n37_), .c(new_n42_), .O(new_n44_));
  nand3  g20(.a(new_n44_), .b(new_n34_), .c(new_n36_), .O(new_n45_));
  inv1   g21(.a(new_n45_), .O(z1));
  oai21  g22(.a(x08), .b(x07), .c(x00), .O(new_n47_));
  nand3  g23(.a(x10), .b(new_n38_), .c(new_n37_), .O(new_n48_));
  ...
  nand3  g31(.a(x09), .b(new_n55_), .c(new_n52_), .O(new_n56_));
  inv1   g32(.a(new_n56_), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n54_), .c(new_n37_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n50_), .c(new_n34_), .O(z2));
  inv1   g35(.a(x11), .O(new_n60_));
  inv1   g36(.a(x12), .O(new_n61_));
  oai22  g37(.a(new_n61_), .b(x00), .c(new_n60_), .d(new_n52_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n34_), .O(z3));
  nand4  g39(.a(new_n32_), .b(x09), .c(x08), .d(x00), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n52_), .O(new_n65_));
  nand2  g41(.a(new_n60_), .b(x07), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n34_), .O(z4));
  nand2  g43(.a(x13), .b(new_n61_), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n36_), .c(x10), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n34_), .c(new_n52_), .d(new_n36_), .O(z5));
  nand2  g46(.a(x08), .b(x00), .O(new_n71_));
  aoi21  g47(.a(new_n31_), .b(x03), .c(x02), .O(new_n72_));
  nand2  g48(.a(x09), .b(new_n38_), .O(new_n73_));
  oai21  g49(.a(new_n72_), .b(x10), .c(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n71_), .c(new_n37_), .O(new_n75_));
  nand2  g51(.a(x14), .b(x02), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n36_), .O(new_n77_));
  oai21  g53(.a(x08), .b(new_n36_), .c(new_n77_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n32_), .c(x01), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n75_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n52_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n34_), .O(z6));
  oai21  g58(.a(new_n43_), .b(x01), .c(new_n55_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n25_), .d(new_n37_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n32_), .d(new_n52_), .O(z7));
  nand2  g61(.a(new_n34_), .b(x07), .O(new_n86_));
  oai21  g62(.a(x10), .b(new_n36_), .c(new_n31_), .O(new_n87_));
  nand4  g63(.a(new_n61_), .b(x03), .c(new_n25_), .d(new_n37_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n32_), .c(x09), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n86_), .O(z8));
endmodule
