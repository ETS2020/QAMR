...
module FAU ( 
  ...
  oai21  g41(.a(new_n65_), .b(x00), .c(x01), .O(new_n66_));
  xor2a  g42(.a(x09), .b(x03), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x02), .c(new_n45_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n50_), .c(new_n53_), .d(new_n33_), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(z6));
  nor3   g47(.a(x10), .b(x09), .c(x08), .O(new_n72_));
  nor2   g48(.a(x02), .b(x01), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n72_), .c(new_n33_), .d(x03), .O(z7));
  nand3  g50(.a(new_n73_), .b(new_n57_), .c(x03), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x09), .O(new_n76_));
  inv1   g52(.a(x09), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n36_), .c(x10), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n76_), .c(new_n53_), .d(new_n33_), .O(z8));
endmodule
