...
module FAU ( 
  ...
  nand2  g22(.a(x07), .b(new_n36_), .O(new_n47_));
  ...
  oai21  g28(.a(new_n52_), .b(new_n49_), .c(new_n35_), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(new_n46_), .c(new_n32_), .O(z2));
  ...
  nand4  g35(.a(new_n59_), .b(x09), .c(x08), .d(x00), .O(new_n60_));
  ...
  nand4  g40(.a(new_n64_), .b(new_n59_), .c(new_n31_), .d(new_n34_), .O(z5));
  ...
  nand3  g46(.a(new_n70_), .b(new_n66_), .c(new_n35_), .O(new_n71_));
  ...
  nand3  g51(.a(new_n75_), .b(new_n59_), .c(new_n31_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(z6));
  oai21  g53(.a(new_n41_), .b(x01), .c(new_n50_), .O(new_n78_));
  nand4  g54(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n78_), .c(new_n59_), .d(new_n31_), .O(z7));
  nand4  g56(.a(new_n55_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x09), .O(new_n82_));
  aoi21  g58(.a(new_n68_), .b(new_n34_), .c(x10), .O(new_n83_));
