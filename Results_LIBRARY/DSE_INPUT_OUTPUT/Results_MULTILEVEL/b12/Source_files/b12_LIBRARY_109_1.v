...
module FAU ( 
  ...
  nand2  g11(.a(x12), .b(new_n35_), .O(new_n36_));
  ...
  nand3  g24(.a(new_n48_), .b(new_n35_), .c(new_n31_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n26_), .c(x12), .O(new_n50_));
  nor2   g26(.a(new_n35_), .b(new_n26_), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n50_), .c(new_n45_), .O(new_n52_));
  inv1   g28(.a(x07), .O(new_n53_));
  nand4  g29(.a(new_n47_), .b(x09), .c(new_n53_), .d(x03), .O(new_n54_));
  inv1   g30(.a(x12), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(x07), .c(new_n35_), .O(new_n56_));
  aoi21  g32(.a(new_n56_), .b(new_n54_), .c(x00), .O(new_n57_));
  inv1   g33(.a(x08), .O(new_n58_));
  nand3  g34(.a(new_n47_), .b(x09), .c(new_n58_), .O(new_n59_));
  ...
  oai22  g39(.a(new_n55_), .b(x00), .c(new_n63_), .d(new_n53_), .O(new_n64_));
  ...
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n36_), .O(z4));
  nand4  g45(.a(x13), .b(new_n47_), .c(new_n53_), .d(new_n25_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n55_), .O(new_n71_));
  oai21  g47(.a(new_n55_), .b(new_n35_), .c(new_n71_), .O(z5));
  ...
  oai21  g54(.a(new_n78_), .b(new_n76_), .c(new_n36_), .O(new_n79_));
  nand2  g55(.a(new_n46_), .b(new_n26_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n55_), .c(new_n35_), .d(x00), .O(new_n81_));
  ...
  nand2  g61(.a(new_n46_), .b(x03), .O(new_n86_));
  nand3  g62(.a(new_n55_), .b(x09), .c(new_n35_), .O(new_n87_));
  ...
  nand3  g66(.a(new_n90_), .b(new_n47_), .c(new_n53_), .O(new_n91_));
  inv1   g67(.a(new_n91_), .O(z6));
  oai21  g68(.a(x12), .b(new_n58_), .c(new_n35_), .O(new_n93_));
  oai21  g69(.a(x02), .b(x01), .c(new_n58_), .O(new_n94_));
  nor2   g70(.a(x02), .b(x01), .O(new_n95_));
  nor2   g71(.a(new_n46_), .b(new_n35_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n95_), .c(x10), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n94_), .c(new_n93_), .d(new_n53_), .O(z7));
  inv1   g74(.a(new_n86_), .O(new_n99_));
  nor2   g75(.a(x12), .b(x03), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(new_n99_), .c(new_n25_), .O(new_n101_));
  oai21  g77(.a(x10), .b(x07), .c(new_n36_), .O(new_n102_));
  nor2   g78(.a(x12), .b(x02), .O(new_n103_));
  aoi21  g79(.a(new_n103_), .b(new_n31_), .c(new_n35_), .O(new_n104_));
  oai21  g80(.a(new_n104_), .b(new_n100_), .c(x09), .O(new_n105_));
