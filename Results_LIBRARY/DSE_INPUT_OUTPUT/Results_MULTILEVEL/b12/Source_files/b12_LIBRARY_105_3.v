...
module FAU ( 
  ...
  nand3  g28(.a(x10), .b(new_n52_), .c(new_n26_), .O(new_n53_));
  inv1   g29(.a(x10), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(x09), .c(new_n47_), .O(new_n55_));
  ...
  oai22  g38(.a(new_n62_), .b(x00), .c(new_n61_), .d(new_n47_), .O(new_n63_));
  ...
  aoi21  g44(.a(new_n68_), .b(new_n67_), .c(new_n65_), .O(z4));
  nor2   g45(.a(x07), .b(x00), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(x13), .c(new_n62_), .d(new_n54_), .O(z5));
  ...
  nand3  g52(.a(new_n76_), .b(new_n72_), .c(new_n32_), .O(new_n77_));
  ...
  nand3  g57(.a(new_n81_), .b(new_n54_), .c(new_n47_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(z6));
  nand2  g59(.a(x10), .b(new_n52_), .O(new_n84_));
  nand3  g60(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n85_));
  nand4  g61(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n47_), .O(new_n87_));
  aoi21  g63(.a(new_n85_), .b(new_n48_), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x10), .c(new_n84_), .O(z7));
