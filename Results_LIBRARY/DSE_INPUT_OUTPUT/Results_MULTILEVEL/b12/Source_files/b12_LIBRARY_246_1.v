...
module FAU ( 
  ...
  nand3  g17(.a(new_n41_), .b(z5), .c(new_n34_), .O(new_n42_));
  inv1   g18(.a(new_n42_), .O(z1));
  inv1   g19(.a(z5), .O(new_n44_));
  ...
  aoi21  g41(.a(new_n65_), .b(new_n64_), .c(new_n44_), .O(z4));
  ...
  nand3  g47(.a(new_n71_), .b(new_n67_), .c(new_n46_), .O(new_n72_));
  ...
  nand3  g52(.a(new_n76_), .b(new_n52_), .c(new_n51_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(z5), .O(z6));
  nand3  g54(.a(x03), .b(new_n25_), .c(new_n46_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n52_), .c(new_n51_), .O(new_n81_));
  aoi21  g57(.a(new_n79_), .b(new_n55_), .c(new_n81_), .O(new_n82_));
  nor2   g58(.a(new_n82_), .b(new_n44_), .O(z7));
  nor2   g59(.a(x13), .b(x09), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x12), .c(new_n34_), .O(new_n85_));
  oai21  g61(.a(x10), .b(x07), .c(z5), .O(new_n86_));
  inv1   g62(.a(new_n79_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x13), .c(new_n31_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n86_), .c(new_n85_), .O(z8));
endmodule
