...
module FAU ( 
  ...
  oai22  g40(.a(new_n64_), .b(new_n35_), .c(x10), .d(new_n37_), .O(new_n65_));
  inv1   g41(.a(x11), .O(new_n66_));
  nand3  g42(.a(new_n26_), .b(new_n66_), .c(x07), .O(new_n67_));
  oai21  g43(.a(new_n65_), .b(x07), .c(new_n67_), .O(z4));
  inv1   g44(.a(x12), .O(new_n69_));
  nand4  g45(.a(x13), .b(new_n69_), .c(new_n52_), .d(new_n35_), .O(new_n70_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n47_), .O(new_n78_));
  ...
  aoi21  g59(.a(new_n83_), .b(new_n37_), .c(x10), .O(z6));
  nand3  g60(.a(x03), .b(new_n27_), .c(new_n47_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n55_), .O(new_n86_));
  nor2   g62(.a(x07), .b(x05), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n27_), .d(new_n47_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n25_), .O(z7));
  nand4  g65(.a(new_n69_), .b(x03), .c(new_n27_), .d(new_n47_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  aoi21  g67(.a(new_n75_), .b(new_n35_), .c(x10), .O(new_n92_));
