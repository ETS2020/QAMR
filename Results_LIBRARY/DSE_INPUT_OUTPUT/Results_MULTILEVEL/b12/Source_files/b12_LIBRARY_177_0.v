...
module FAU ( 
  ...
  aoi21  g34(.a(new_n58_), .b(new_n49_), .c(new_n25_), .O(z2));
  aoi22  g35(.a(x12), .b(new_n38_), .c(x11), .d(x07), .O(z3));
  nand3  g36(.a(x09), .b(x08), .c(x00), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n26_), .c(new_n51_), .O(new_n62_));
  inv1   g38(.a(x11), .O(new_n63_));
  nand3  g39(.a(x12), .b(new_n63_), .c(x07), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n62_), .O(z4));
  inv1   g41(.a(x12), .O(new_n66_));
  nor3   g42(.a(x10), .b(x07), .c(x00), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n66_), .d(x11), .O(z5));
  ...
  nand4  g54(.a(new_n78_), .b(new_n26_), .c(new_n52_), .d(new_n51_), .O(new_n79_));
  ...
  nor2   g59(.a(new_n25_), .b(x10), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n51_), .O(z7));
  oai21  g61(.a(new_n66_), .b(x09), .c(new_n63_), .O(new_n86_));
  nand4  g62(.a(new_n66_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n71_), .b(new_n38_), .c(x10), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n86_), .d(new_n51_), .O(z8));
endmodule
