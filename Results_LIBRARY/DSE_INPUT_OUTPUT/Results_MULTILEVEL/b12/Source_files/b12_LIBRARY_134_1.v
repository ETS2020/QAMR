...
module FAU ( 
  ...
  nand3  g36(.a(new_n60_), .b(new_n59_), .c(new_n31_), .O(new_n61_));
  oai21  g37(.a(x11), .b(new_n31_), .c(new_n61_), .O(z4));
  aoi21  g38(.a(x13), .b(new_n55_), .c(x07), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x00), .c(new_n59_), .O(new_n64_));
  ...
  aoi21  g60(.a(new_n68_), .b(new_n34_), .c(x10), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n31_), .O(z8));
endmodule
