...
module FAU ( 
  ...
  nand2  g38(.a(new_n52_), .b(x10), .O(new_n63_));
  ...
  aoi21  g45(.a(new_n69_), .b(new_n67_), .c(new_n25_), .O(z4));
  ...
  aoi21  g57(.a(new_n81_), .b(x12), .c(x10), .O(z6));
  oai21  g58(.a(new_n42_), .b(x01), .c(new_n46_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n53_), .d(new_n65_), .O(z7));
  nand4  g61(.a(new_n53_), .b(new_n73_), .c(new_n65_), .d(x00), .O(z8));
endmodule
