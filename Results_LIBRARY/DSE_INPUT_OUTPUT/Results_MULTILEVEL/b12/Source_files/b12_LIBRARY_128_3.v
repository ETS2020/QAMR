...
module FAU ( 
  ...
  oai22  g40(.a(new_n64_), .b(new_n63_), .c(new_n35_), .d(new_n34_), .O(new_n65_));
  nand3  g41(.a(new_n31_), .b(new_n59_), .c(x07), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x07), .c(new_n66_), .O(z4));
  oai21  g43(.a(x07), .b(x00), .c(new_n31_), .O(new_n68_));
  nand2  g44(.a(x10), .b(new_n34_), .O(new_n69_));
  inv1   g45(.a(x13), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x12), .c(new_n35_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n51_), .c(new_n63_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n68_), .O(z5));
  nand2  g50(.a(x08), .b(x00), .O(new_n75_));
  nand2  g51(.a(x09), .b(new_n46_), .O(new_n76_));
  ...
  nand4  g64(.a(x09), .b(x03), .c(new_n25_), .d(new_n33_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n35_), .d(new_n51_), .O(z7));
  nand4  g66(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n33_), .O(new_n91_));
  oai21  g67(.a(x09), .b(x00), .c(new_n51_), .O(new_n92_));
