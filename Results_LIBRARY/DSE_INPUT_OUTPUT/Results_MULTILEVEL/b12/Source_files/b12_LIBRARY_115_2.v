...
module FAU ( 
  ...
  nand3  g29(.a(new_n51_), .b(x09), .c(new_n31_), .O(new_n54_));
  ...
  nand2  g34(.a(new_n58_), .b(x08), .O(new_n59_));
  aoi22  g35(.a(new_n59_), .b(x07), .c(x12), .d(new_n34_), .O(z3));
  oai21  g36(.a(x09), .b(x07), .c(x08), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(x00), .O(new_n62_));
  oai21  g38(.a(new_n58_), .b(new_n31_), .c(x07), .O(new_n63_));
  nand2  g39(.a(new_n50_), .b(new_n34_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n62_), .O(z4));
  inv1   g41(.a(x13), .O(new_n66_));
  nor2   g42(.a(new_n66_), .b(x12), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n51_), .c(new_n50_), .d(new_n34_), .O(z5));
  ...
  nand3  g48(.a(new_n72_), .b(new_n44_), .c(new_n45_), .O(new_n73_));
  ...
  aoi21  g58(.a(new_n80_), .b(new_n31_), .c(new_n82_), .O(new_n83_));
  nand2  g59(.a(x08), .b(x07), .O(new_n84_));
  oai21  g60(.a(new_n83_), .b(x07), .c(new_n84_), .O(z7));
  inv1   g61(.a(x12), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n51_), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x07), .c(new_n84_), .O(z8));
endmodule
