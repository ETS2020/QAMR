...
module FAU ( 
  ...
  nor2   g11(.a(new_n35_), .b(new_n27_), .O(new_n36_));
  ...
  nand3  g16(.a(new_n40_), .b(new_n29_), .c(x02), .O(new_n41_));
  ...
  nand3  g22(.a(x10), .b(new_n39_), .c(new_n46_), .O(new_n47_));
  ...
  nand3  g54(.a(new_n78_), .b(new_n35_), .c(new_n51_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n37_), .O(z6));
  nand3  g56(.a(x03), .b(new_n26_), .c(new_n46_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n54_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n26_), .d(new_n46_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n35_), .d(new_n51_), .O(z7));
  nand4  g60(.a(new_n60_), .b(x03), .c(new_n26_), .d(new_n46_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n71_), .b(new_n25_), .c(x10), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n51_), .O(z8));
endmodule
