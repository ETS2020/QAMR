...
module FAU ( 
  ...
  aoi21  g15(.a(new_n39_), .b(x01), .c(x08), .O(new_n40_));
  ...
  nand3  g21(.a(x07), .b(new_n34_), .c(new_n25_), .O(new_n46_));
  ...
  nand4  g28(.a(new_n52_), .b(new_n45_), .c(new_n49_), .d(new_n25_), .O(new_n53_));
  ...
  oai21  g33(.a(new_n45_), .b(x00), .c(new_n57_), .O(z3));
  nor2   g34(.a(x09), .b(x07), .O(new_n59_));
  aoi21  g35(.a(new_n55_), .b(x07), .c(new_n59_), .O(new_n60_));
  aoi21  g36(.a(new_n55_), .b(new_n44_), .c(new_n49_), .O(new_n61_));
  oai22  g37(.a(new_n61_), .b(x08), .c(new_n60_), .d(new_n44_), .O(z4));
  inv1   g38(.a(x10), .O(new_n63_));
  nor3   g39(.a(x08), .b(x07), .c(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n56_), .d(new_n63_), .O(z5));
  nand2  g41(.a(x01), .b(new_n44_), .O(new_n66_));
  ...
  nand4  g47(.a(new_n71_), .b(new_n63_), .c(new_n45_), .d(new_n49_), .O(new_n72_));
  inv1   g48(.a(new_n72_), .O(z6));
  nand2  g49(.a(new_n39_), .b(new_n25_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x08), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x09), .O(new_n76_));
  nand2  g52(.a(new_n74_), .b(new_n45_), .O(new_n77_));
  aoi21  g53(.a(x08), .b(new_n44_), .c(x10), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n76_), .d(new_n49_), .O(z7));
  oai21  g55(.a(new_n50_), .b(x08), .c(new_n44_), .O(new_n80_));
  nand4  g56(.a(new_n56_), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x09), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n80_), .c(new_n63_), .d(new_n49_), .O(z8));
endmodule
