...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n73_, new_n74_, new_n76_, new_n78_, new_n79_, new_n80_;
  ...
  nand4  g41(.a(x13), .b(new_n58_), .c(new_n56_), .d(new_n39_), .O(new_n66_));
  ...
  nand4  g51(.a(x09), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n26_), .c(x08), .d(new_n56_), .O(z7));
  nand4  g53(.a(new_n58_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x09), .O(new_n79_));
  aoi21  g55(.a(new_n62_), .b(new_n39_), .c(x10), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(x08), .d(new_n56_), .O(z8));
endmodule
