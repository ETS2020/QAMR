...
module FAU ( 
  ...
  nand2  g20(.a(x10), .b(new_n35_), .O(new_n45_));
  nand3  g21(.a(new_n31_), .b(x09), .c(new_n44_), .O(new_n46_));
  aoi21  g22(.a(new_n46_), .b(new_n45_), .c(x00), .O(new_n47_));
  nand2  g23(.a(new_n31_), .b(x09), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n45_), .c(x08), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n44_), .c(new_n47_), .O(new_n50_));
  aoi21  g26(.a(new_n31_), .b(x07), .c(x00), .O(new_n51_));
  nor2   g27(.a(x08), .b(x07), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n51_), .c(x02), .O(new_n53_));
  oai21  g29(.a(new_n50_), .b(x01), .c(new_n53_), .O(z2));
  inv1   g30(.a(x11), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(x10), .O(new_n56_));
  aoi22  g32(.a(new_n56_), .b(x07), .c(x12), .d(new_n34_), .O(z3));
  nand3  g33(.a(x09), .b(x08), .c(x00), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n44_), .O(new_n59_));
  oai21  g35(.a(new_n56_), .b(new_n44_), .c(new_n59_), .O(z4));
  inv1   g36(.a(x13), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(x12), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(new_n31_), .c(new_n44_), .d(new_n34_), .O(z5));
  ...
  nand3  g45(.a(new_n69_), .b(new_n65_), .c(new_n64_), .O(new_n70_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n31_), .c(new_n44_), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(z6));
  inv1   g52(.a(x08), .O(new_n77_));
  nand3  g53(.a(x03), .b(new_n25_), .c(new_n64_), .O(new_n78_));
  nor2   g54(.a(x02), .b(x01), .O(new_n79_));
  nor2   g55(.a(new_n67_), .b(new_n35_), .O(new_n80_));
  aoi22  g56(.a(new_n80_), .b(new_n79_), .c(new_n78_), .d(new_n77_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(x07), .c(new_n31_), .O(z7));
  inv1   g58(.a(x12), .O(new_n83_));
  nand3  g59(.a(new_n79_), .b(new_n83_), .c(x03), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n67_), .b(new_n34_), .c(x10), .O(new_n86_));
