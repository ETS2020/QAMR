...
module FAU ( 
  ...
  nand2  g06(.a(x11), .b(x09), .O(new_n31_));
  ...
  nand3  g32(.a(new_n56_), .b(new_n55_), .c(new_n34_), .O(new_n57_));
  inv1   g33(.a(x10), .O(new_n58_));
  aoi21  g34(.a(x08), .b(x00), .c(x11), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(new_n58_), .c(x09), .d(new_n46_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n57_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n43_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n50_), .O(z2));
  nand2  g39(.a(new_n51_), .b(new_n46_), .O(new_n64_));
  aoi22  g40(.a(new_n64_), .b(x11), .c(x12), .d(new_n33_), .O(z3));
  oai21  g41(.a(new_n53_), .b(x09), .c(x07), .O(new_n66_));
  nand2  g42(.a(x08), .b(x00), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n54_), .c(new_n46_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n66_), .O(z4));
  inv1   g45(.a(x12), .O(new_n70_));
  nand3  g46(.a(x13), .b(new_n70_), .c(new_n58_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n31_), .c(new_n46_), .d(new_n33_), .O(z5));
  nand2  g49(.a(new_n43_), .b(new_n33_), .O(new_n74_));
  nand2  g50(.a(new_n47_), .b(x00), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g52(.a(x09), .b(new_n34_), .O(new_n77_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n58_), .c(new_n46_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n31_), .O(z6));
  aoi21  g62(.a(x11), .b(x09), .c(x08), .O(new_n87_));
  aoi21  g63(.a(new_n58_), .b(new_n46_), .c(x11), .O(new_n88_));
  nand3  g64(.a(x03), .b(new_n25_), .c(new_n43_), .O(new_n89_));
  oai21  g65(.a(new_n88_), .b(new_n87_), .c(new_n89_), .O(new_n90_));
  nand2  g66(.a(new_n58_), .b(new_n46_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n51_), .O(new_n92_));
  inv1   g68(.a(new_n54_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n92_), .c(new_n90_), .O(z7));
  nand2  g71(.a(new_n91_), .b(new_n31_), .O(new_n96_));
  nand4  g72(.a(new_n70_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n97_));
  nand3  g73(.a(new_n97_), .b(new_n53_), .c(x09), .O(new_n98_));
  nand2  g74(.a(new_n51_), .b(new_n33_), .O(new_n99_));
