...
module FAU ( 
  ...
  nand4  g46(.a(x13), .b(new_n70_), .c(new_n47_), .d(new_n37_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n52_), .O(new_n72_));
  oai21  g48(.a(x14), .b(new_n52_), .c(new_n72_), .O(z5));
  ...
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n52_), .d(new_n47_), .O(z7));
  nand4  g65(.a(new_n70_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  aoi21  g67(.a(new_n76_), .b(new_n37_), .c(x10), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n91_), .c(new_n47_), .O(z8));
endmodule
