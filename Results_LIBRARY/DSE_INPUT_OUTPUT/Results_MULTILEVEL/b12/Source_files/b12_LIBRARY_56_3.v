// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:35 2020
...
module FAU ( 
  ...
  nand2  g10(.a(x06), .b(x02), .O(new_n35_));
  ...
  nand3  g33(.a(new_n57_), .b(new_n48_), .c(new_n31_), .O(z2));
  ...
  nand3  g54(.a(new_n78_), .b(new_n51_), .c(new_n50_), .O(new_n79_));
  ...
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n50_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n51_), .O(new_n85_));
  oai21  g61(.a(new_n51_), .b(x06), .c(new_n85_), .O(z7));
  nand4  g62(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n71_), .b(new_n33_), .c(x10), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n50_), .O(z8));
endmodule
