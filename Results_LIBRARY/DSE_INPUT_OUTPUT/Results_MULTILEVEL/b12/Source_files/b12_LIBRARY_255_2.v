...
module FAU ( 
  ...
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n47_), .O(z4));
  inv1   g44(.a(x12), .O(new_n69_));
  nand4  g45(.a(x13), .b(new_n69_), .c(new_n46_), .d(new_n38_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n52_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n25_), .O(z5));
  and2   g48(.a(x14), .b(x02), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n38_), .c(new_n33_), .O(new_n74_));
  xnor2a g50(.a(x09), .b(x03), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n28_), .c(x01), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n74_), .c(new_n46_), .O(new_n77_));
  ...
  nand4  g57(.a(new_n69_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n82_));
  oai21  g58(.a(x09), .b(x00), .c(new_n46_), .O(new_n83_));
  aoi21  g59(.a(new_n82_), .b(x09), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x08), .c(new_n25_), .O(z8));
endmodule
