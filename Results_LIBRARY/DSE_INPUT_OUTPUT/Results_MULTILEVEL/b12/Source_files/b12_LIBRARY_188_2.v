...
module FAU ( 
  ...
  nand2  g39(.a(new_n61_), .b(new_n52_), .O(new_n64_));
  ...
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n60_), .d(new_n25_), .O(z5));
  and2   g46(.a(x14), .b(x02), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n38_), .c(new_n33_), .O(new_n72_));
  xnor2a g48(.a(x09), .b(x03), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n28_), .c(x01), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n72_), .c(new_n46_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n52_), .c(x10), .O(z6));
  nand3  g52(.a(new_n54_), .b(new_n46_), .c(x03), .O(new_n77_));
  nor3   g53(.a(new_n77_), .b(x02), .c(x01), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x08), .c(new_n25_), .O(z7));
  nand4  g55(.a(new_n60_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n80_));
  oai21  g56(.a(x09), .b(x00), .c(new_n46_), .O(new_n81_));
  aoi21  g57(.a(new_n80_), .b(x09), .c(new_n81_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x08), .c(new_n25_), .O(z8));
endmodule
