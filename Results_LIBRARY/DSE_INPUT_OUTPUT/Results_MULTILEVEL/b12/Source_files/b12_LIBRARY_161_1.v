...
module FAU ( 
  ...
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n64_), .d(new_n47_), .O(z5));
  ...
  nand4  g55(.a(new_n64_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n80_));
  nor2   g56(.a(x09), .b(x00), .O(new_n81_));
  aoi21  g57(.a(new_n80_), .b(x09), .c(new_n81_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x10), .c(new_n25_), .O(z8));
endmodule
