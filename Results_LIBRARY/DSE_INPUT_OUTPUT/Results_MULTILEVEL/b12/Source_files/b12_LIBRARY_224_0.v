...
module FAU ( 
  ...
  nor2   g58(.a(x10), .b(new_n25_), .O(new_n83_));
  nand3  g59(.a(x03), .b(new_n29_), .c(new_n34_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(x08), .d(new_n58_), .O(z7));
  nor2   g61(.a(x07), .b(new_n28_), .O(new_n86_));
  nor2   g62(.a(x02), .b(x01), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n83_), .d(new_n53_), .O(z8));
endmodule
