...
module FAU ( 
  ...
  nand2  g18(.a(x10), .b(x00), .O(new_n43_));
  ...
  nand3  g28(.a(new_n52_), .b(new_n50_), .c(new_n46_), .O(new_n53_));
  ...
  nand2  g32(.a(new_n27_), .b(new_n34_), .O(new_n57_));
  oai21  g33(.a(x08), .b(x07), .c(x00), .O(new_n58_));
  aoi22  g34(.a(new_n58_), .b(x02), .c(new_n57_), .d(x10), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n56_), .O(z2));
  inv1   g36(.a(x11), .O(new_n61_));
  inv1   g37(.a(x12), .O(new_n62_));
  oai22  g38(.a(new_n62_), .b(x00), .c(new_n61_), .d(new_n46_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n43_), .O(z3));
  oai21  g40(.a(new_n46_), .b(x00), .c(x10), .O(new_n65_));
  ...
  nand4  g47(.a(new_n71_), .b(new_n47_), .c(new_n46_), .d(new_n34_), .O(z5));
  nand2  g48(.a(x08), .b(x00), .O(new_n73_));
  nand2  g49(.a(x09), .b(new_n35_), .O(new_n74_));
  nand2  g50(.a(new_n51_), .b(x03), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n27_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n73_), .c(new_n25_), .O(new_n77_));
  ...
  nand3  g59(.a(x03), .b(new_n27_), .c(new_n25_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n46_), .O(new_n86_));
  aoi21  g62(.a(new_n84_), .b(new_n50_), .c(new_n86_), .O(new_n87_));
  nand2  g63(.a(x10), .b(new_n34_), .O(new_n88_));
  oai21  g64(.a(new_n87_), .b(x10), .c(new_n88_), .O(z7));
  nand4  g65(.a(new_n62_), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(x09), .c(x07), .O(new_n91_));
  oai22  g67(.a(new_n91_), .b(x10), .c(new_n52_), .d(x00), .O(z8));
endmodule
