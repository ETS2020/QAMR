// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:38 2020
...
module FAU ( 
  ...
  nand2  g07(.a(x13), .b(new_n31_), .O(z5));
  oai21  g08(.a(new_n30_), .b(x00), .c(z5), .O(z0));
  ...
  nand2  g18(.a(new_n42_), .b(z5), .O(z1));
  ...
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n25_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n67_), .c(new_n45_), .O(new_n72_));
  aoi21  g48(.a(x14), .b(x02), .c(x00), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n34_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(x01), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n72_), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n66_), .c(new_n31_), .d(new_n50_), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(z6));
  nand3  g54(.a(x03), .b(new_n25_), .c(new_n45_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n53_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n81_));
  nor2   g57(.a(x13), .b(x10), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n50_), .O(z7));
  nand4  g59(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n84_));
  oai21  g60(.a(x09), .b(x00), .c(new_n50_), .O(new_n85_));
  aoi21  g61(.a(new_n84_), .b(x09), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x13), .c(new_n31_), .O(z8));
endmodule
