...
module FAU ( 
  ...
  nand4  g22(.a(new_n46_), .b(new_n32_), .c(x09), .d(x06), .O(new_n47_));
  inv1   g23(.a(x08), .O(new_n48_));
  nand3  g24(.a(x10), .b(new_n48_), .c(new_n36_), .O(new_n49_));
  ...
  nand3  g30(.a(new_n54_), .b(new_n33_), .c(x02), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n53_), .O(z2));
  nand2  g32(.a(x11), .b(x07), .O(new_n57_));
  nand2  g33(.a(x12), .b(new_n35_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n57_), .c(new_n33_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(z3));
  nand2  g36(.a(x09), .b(x08), .O(new_n61_));
  oai22  g37(.a(new_n61_), .b(new_n35_), .c(x10), .d(x06), .O(new_n62_));
  inv1   g38(.a(x11), .O(new_n63_));
  nand3  g39(.a(new_n33_), .b(new_n63_), .c(x07), .O(new_n64_));
  oai21  g40(.a(new_n62_), .b(x07), .c(new_n64_), .O(z4));
  inv1   g41(.a(x07), .O(new_n66_));
  inv1   g42(.a(x12), .O(new_n67_));
  nand4  g43(.a(x13), .b(new_n67_), .c(new_n66_), .d(new_n35_), .O(new_n68_));
  ...
  nand2  g55(.a(new_n79_), .b(new_n66_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(x06), .c(x10), .O(z6));
  ...
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n32_), .O(z7));
  nand4  g62(.a(new_n67_), .b(x03), .c(new_n25_), .d(new_n45_), .O(new_n87_));
