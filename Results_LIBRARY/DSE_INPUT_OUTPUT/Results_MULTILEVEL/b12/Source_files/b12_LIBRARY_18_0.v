...
module FAU ( 
  ...
  nand4  g27(.a(new_n49_), .b(x09), .c(new_n39_), .d(new_n48_), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n51_), .c(new_n31_), .O(new_n54_));
  inv1   g30(.a(x00), .O(new_n55_));
  nand2  g31(.a(new_n39_), .b(new_n55_), .O(new_n56_));
  ...
  nand3  g37(.a(new_n59_), .b(x08), .c(new_n55_), .O(new_n62_));
  nand2  g38(.a(x09), .b(x08), .O(new_n63_));
  nor2   g39(.a(x11), .b(new_n48_), .O(new_n64_));
  aoi21  g40(.a(new_n63_), .b(new_n48_), .c(new_n64_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n55_), .c(new_n62_), .O(z4));
  nor2   g42(.a(x12), .b(x10), .O(new_n67_));
  nor2   g43(.a(x07), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(x13), .d(x08), .O(z5));
  nand3  g45(.a(x08), .b(new_n31_), .c(new_n55_), .O(new_n70_));
  nand2  g46(.a(new_n39_), .b(x00), .O(new_n71_));
  xnor2a g47(.a(x09), .b(x03), .O(new_n72_));
  aoi22  g48(.a(new_n72_), .b(new_n26_), .c(new_n71_), .d(new_n70_), .O(new_n73_));
  nand2  g49(.a(x14), .b(x02), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(x08), .c(new_n55_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n71_), .c(new_n31_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n73_), .c(new_n49_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(x07), .O(z6));
  oai21  g54(.a(x10), .b(x07), .c(new_n56_), .O(new_n79_));
  nand4  g55(.a(x08), .b(x03), .c(new_n26_), .d(new_n31_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n71_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x09), .O(new_n82_));
  nand2  g58(.a(new_n40_), .b(new_n31_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n39_), .c(x00), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(z7));
  nand2  g61(.a(new_n63_), .b(new_n55_), .O(new_n86_));
  nand4  g62(.a(new_n58_), .b(x03), .c(new_n26_), .d(new_n31_), .O(new_n87_));
