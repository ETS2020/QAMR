...
module FAU ( 
  ...
  nor2   g34(.a(new_n27_), .b(new_n39_), .O(new_n59_));
  aoi21  g35(.a(x12), .b(new_n47_), .c(new_n59_), .O(new_n60_));
  oai21  g36(.a(new_n58_), .b(new_n53_), .c(new_n60_), .O(new_n61_));
  ...
  nand4  g50(.a(new_n74_), .b(new_n71_), .c(new_n27_), .d(new_n39_), .O(new_n75_));
  ...
  nand2  g56(.a(new_n80_), .b(new_n70_), .O(z6));
  ...
  nand4  g61(.a(new_n67_), .b(x03), .c(new_n39_), .d(new_n25_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n44_), .b(new_n47_), .c(x10), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n53_), .O(z8));
endmodule
