...
module FAU ( 
  ...
  oai21  g32(.a(new_n56_), .b(new_n53_), .c(new_n34_), .O(new_n57_));
  ...
  nand4  g43(.a(x13), .b(new_n60_), .c(new_n50_), .d(new_n67_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x06), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n51_), .O(z5));
  nand2  g46(.a(x08), .b(x00), .O(new_n71_));
  nand2  g47(.a(x09), .b(new_n45_), .O(new_n72_));
  ...
  nor2   g60(.a(x07), .b(new_n37_), .O(new_n85_));
  nand4  g61(.a(x09), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n51_), .O(z7));
  nand4  g63(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n73_), .b(new_n67_), .c(x10), .O(new_n90_));
