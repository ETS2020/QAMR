...
module FAU ( 
  ...
  oai21  g11(.a(new_n35_), .b(new_n32_), .c(z5), .O(new_n36_));
  ...
  nand3  g19(.a(new_n43_), .b(z5), .c(new_n38_), .O(new_n44_));
  ...
  nand4  g27(.a(x12), .b(new_n48_), .c(x09), .d(new_n38_), .O(new_n52_));
  ...
  nand3  g33(.a(new_n57_), .b(z5), .c(x02), .O(new_n58_));
  ...
  aoi21  g43(.a(new_n67_), .b(new_n66_), .c(new_n25_), .O(z4));
  ...
  aoi21  g55(.a(new_n79_), .b(x12), .c(x10), .O(z6));
  oai21  g56(.a(new_n42_), .b(x01), .c(new_n46_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n81_), .c(new_n60_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x12), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n48_), .O(z7));
  nand3  g61(.a(new_n71_), .b(new_n60_), .c(x00), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x12), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n48_), .O(z8));
endmodule
