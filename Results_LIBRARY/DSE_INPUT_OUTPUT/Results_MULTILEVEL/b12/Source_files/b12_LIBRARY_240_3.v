...
module FAU ( 
  ...
  nand3  g20(.a(x07), .b(new_n29_), .c(new_n44_), .O(new_n45_));
  ...
  oai21  g26(.a(new_n50_), .b(new_n46_), .c(new_n36_), .O(new_n51_));
  nand3  g27(.a(x10), .b(new_n33_), .c(new_n29_), .O(new_n52_));
  nand3  g28(.a(new_n26_), .b(x09), .c(new_n47_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n52_), .c(x00), .O(new_n54_));
  nand2  g30(.a(new_n26_), .b(x09), .O(new_n55_));
  aoi21  g31(.a(new_n55_), .b(new_n52_), .c(x08), .O(new_n56_));
  aoi21  g32(.a(new_n56_), .b(new_n47_), .c(new_n54_), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(x01), .c(new_n51_), .O(z2));
  nand2  g34(.a(x11), .b(x07), .O(new_n59_));
  inv1   g35(.a(x00), .O(new_n60_));
  nand2  g36(.a(x12), .b(new_n60_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n59_), .c(new_n36_), .O(new_n62_));
  ...
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n36_), .O(z4));
  nand2  g44(.a(x10), .b(new_n33_), .O(new_n69_));
  inv1   g45(.a(x12), .O(new_n70_));
  nand4  g46(.a(x13), .b(new_n70_), .c(new_n47_), .d(new_n60_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n26_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n69_), .O(z5));
  nand2  g49(.a(x08), .b(x00), .O(new_n74_));
  nand2  g50(.a(x09), .b(new_n29_), .O(new_n75_));
  ...
  nor2   g56(.a(x08), .b(new_n60_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n80_), .c(x01), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n26_), .c(new_n47_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n36_), .O(z6));
  ...
  oai21  g65(.a(new_n89_), .b(x10), .c(new_n69_), .O(z7));
  nand4  g66(.a(new_n70_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n91_));
  oai21  g67(.a(x09), .b(x00), .c(new_n47_), .O(new_n92_));
  aoi21  g68(.a(new_n91_), .b(x09), .c(new_n92_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x10), .c(new_n69_), .O(z8));
endmodule
