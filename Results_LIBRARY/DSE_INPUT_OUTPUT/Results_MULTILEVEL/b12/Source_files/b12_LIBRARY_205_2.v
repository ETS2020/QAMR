...
module FAU ( 
  ...
  aoi22  g41(.a(new_n65_), .b(new_n63_), .c(new_n35_), .d(x04), .O(z4));
  ...
  aoi21  g56(.a(new_n80_), .b(new_n27_), .c(x10), .O(z6));
  nand3  g57(.a(x03), .b(new_n26_), .c(new_n45_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n26_), .d(new_n45_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n50_), .O(new_n84_));
  aoi21  g60(.a(new_n82_), .b(new_n53_), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x04), .c(new_n35_), .O(z7));
  nand4  g62(.a(new_n67_), .b(x03), .c(new_n26_), .d(new_n45_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n72_), .b(new_n25_), .c(x10), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n50_), .d(new_n27_), .O(z8));
endmodule
