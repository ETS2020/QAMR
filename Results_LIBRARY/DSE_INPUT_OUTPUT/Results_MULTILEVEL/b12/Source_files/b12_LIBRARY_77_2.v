...
module FAU ( 
  ...
  aoi22  g42(.a(new_n66_), .b(new_n65_), .c(new_n25_), .d(x05), .O(z4));
  nor3   g43(.a(x07), .b(x05), .c(x00), .O(new_n68_));
  ...
  aoi21  g56(.a(new_n80_), .b(new_n37_), .c(x10), .O(z6));
  nand3  g57(.a(x03), .b(new_n27_), .c(new_n47_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n27_), .d(new_n47_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n52_), .O(new_n84_));
  aoi21  g60(.a(new_n82_), .b(new_n55_), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x05), .c(new_n25_), .O(z7));
  nand4  g62(.a(new_n61_), .b(x03), .c(new_n27_), .d(new_n47_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n72_), .b(new_n35_), .c(x10), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n52_), .d(new_n37_), .O(z8));
endmodule
