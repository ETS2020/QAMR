...
module FAU ( 
  ...
  nand2  g00(.a(x08), .b(x06), .O(new_n25_));
  ...
  inv1   g13(.a(x06), .O(new_n38_));
  oai21  g14(.a(new_n38_), .b(new_n27_), .c(x01), .O(new_n39_));
  ...
  oai21  g20(.a(new_n44_), .b(new_n42_), .c(new_n37_), .O(new_n45_));
  nand2  g21(.a(new_n45_), .b(new_n25_), .O(z1));
  oai21  g22(.a(x08), .b(x07), .c(x00), .O(new_n47_));
  nand3  g23(.a(x10), .b(new_n26_), .c(new_n32_), .O(new_n48_));
  ...
  oai21  g34(.a(new_n58_), .b(new_n55_), .c(new_n32_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n50_), .c(new_n25_), .O(z2));
  ...
  oai21  g40(.a(x08), .b(new_n52_), .c(x06), .O(new_n65_));
  nand3  g41(.a(x09), .b(x08), .c(x00), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n52_), .O(new_n67_));
  nand2  g43(.a(new_n61_), .b(x07), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n65_), .O(z4));
  nand3  g45(.a(x13), .b(new_n62_), .c(new_n53_), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n25_), .c(new_n52_), .d(new_n37_), .O(z5));
  aoi21  g48(.a(new_n38_), .b(new_n37_), .c(new_n56_), .O(new_n73_));
  nand2  g49(.a(x14), .b(x02), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x01), .O(new_n75_));
  xor2a  g51(.a(x09), .b(x03), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(x02), .c(new_n32_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n75_), .c(new_n73_), .O(new_n78_));
  nand3  g54(.a(new_n56_), .b(x01), .c(x00), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n78_), .c(new_n53_), .O(new_n81_));
  nor2   g57(.a(new_n81_), .b(x07), .O(z6));
  oai21  g58(.a(x10), .b(x07), .c(new_n25_), .O(new_n83_));
  nand4  g59(.a(new_n38_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x08), .O(new_n85_));
  ...
  nand3  g64(.a(new_n88_), .b(new_n86_), .c(new_n83_), .O(z7));
  nand4  g65(.a(new_n62_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  inv1   g67(.a(x09), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n37_), .c(x10), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n91_), .c(new_n25_), .d(new_n52_), .O(z8));
endmodule
