...
module FAU ( 
  ...
  aoi21  g12(.a(new_n36_), .b(x05), .c(new_n35_), .O(new_n37_));
  nand2  g13(.a(x06), .b(x01), .O(new_n38_));
  nand2  g14(.a(new_n38_), .b(x10), .O(new_n39_));
  aoi21  g15(.a(new_n39_), .b(x05), .c(new_n27_), .O(new_n40_));
  oai21  g16(.a(new_n40_), .b(new_n37_), .c(x03), .O(new_n41_));
  nand2  g17(.a(new_n39_), .b(x05), .O(new_n42_));
  ...
  nand4  g22(.a(new_n46_), .b(new_n25_), .c(x09), .d(new_n45_), .O(new_n47_));
  ...
  oai21  g29(.a(new_n53_), .b(x05), .c(new_n25_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n48_), .c(new_n52_), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n51_), .c(new_n35_), .O(new_n57_));
  ...
  nand4  g44(.a(x13), .b(new_n62_), .c(new_n53_), .d(new_n52_), .O(new_n69_));
  ...
  nand3  g51(.a(new_n75_), .b(new_n46_), .c(new_n35_), .O(new_n76_));
  aoi21  g52(.a(x14), .b(x02), .c(x00), .O(new_n77_));
  nor2   g53(.a(x08), .b(new_n52_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n77_), .c(x01), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n25_), .c(new_n53_), .d(new_n45_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand3  g58(.a(x03), .b(new_n27_), .c(new_n35_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n49_), .O(new_n84_));
  nor2   g60(.a(x07), .b(x05), .O(new_n85_));
  nand4  g61(.a(x09), .b(x03), .c(new_n27_), .d(new_n35_), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n25_), .O(z7));
  nand4  g63(.a(new_n62_), .b(x03), .c(new_n27_), .d(new_n35_), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n53_), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x05), .c(new_n25_), .O(z8));
endmodule
