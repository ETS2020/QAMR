...
module FAU ( 
  ...
  nand2  g39(.a(new_n61_), .b(new_n51_), .O(new_n64_));
  nand2  g40(.a(x08), .b(x00), .O(new_n65_));
  nor2   g41(.a(x11), .b(new_n46_), .O(new_n66_));
  aoi21  g42(.a(new_n65_), .b(new_n46_), .c(new_n66_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x10), .c(new_n64_), .O(z4));
  nor2   g44(.a(x07), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n60_), .d(new_n53_), .O(z5));
  ...
  nand3  g49(.a(new_n73_), .b(new_n65_), .c(new_n43_), .O(new_n74_));
  ...
  nand3  g54(.a(new_n78_), .b(new_n53_), .c(new_n46_), .O(new_n79_));
  ...
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n53_), .d(new_n46_), .O(z7));
  nand4  g60(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n43_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n51_), .b(new_n33_), .c(x10), .O(new_n87_));
