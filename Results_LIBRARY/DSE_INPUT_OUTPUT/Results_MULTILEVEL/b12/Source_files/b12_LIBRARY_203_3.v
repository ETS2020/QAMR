...
module FAU ( 
  ...
  inv1   g62(.a(new_n63_), .O(new_n87_));
  nand3  g63(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n88_));
  ...
  oai21  g67(.a(new_n91_), .b(x10), .c(new_n87_), .O(z7));
  nand4  g68(.a(new_n71_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n93_));
  oai21  g69(.a(x09), .b(x00), .c(new_n50_), .O(new_n94_));
  aoi21  g70(.a(new_n93_), .b(x09), .c(new_n94_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x10), .c(new_n87_), .O(z8));
endmodule
