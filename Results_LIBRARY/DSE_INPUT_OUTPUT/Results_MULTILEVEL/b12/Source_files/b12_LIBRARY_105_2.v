...
module FAU ( 
  ...
  inv1   g21(.a(x06), .O(new_n46_));
  nand2  g22(.a(x08), .b(x00), .O(new_n47_));
  nand4  g23(.a(new_n47_), .b(new_n25_), .c(x09), .d(new_n46_), .O(new_n48_));
  inv1   g24(.a(x08), .O(new_n49_));
  nand3  g25(.a(x10), .b(new_n49_), .c(new_n27_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n48_), .c(x07), .O(new_n51_));
  inv1   g27(.a(x07), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(x06), .c(new_n25_), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(new_n27_), .c(new_n38_), .O(new_n54_));
  inv1   g30(.a(new_n54_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n51_), .c(new_n33_), .O(new_n56_));
  ...
  aoi22  g42(.a(new_n66_), .b(new_n65_), .c(new_n25_), .d(x06), .O(z4));
  nor3   g43(.a(x07), .b(x06), .c(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n61_), .d(new_n25_), .O(z5));
  ...
  nand3  g49(.a(new_n73_), .b(new_n47_), .c(new_n33_), .O(new_n74_));
  ...
  nand4  g54(.a(new_n78_), .b(new_n25_), .c(new_n52_), .d(new_n46_), .O(new_n79_));
  ...
  aoi21  g59(.a(new_n81_), .b(new_n49_), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x06), .c(new_n25_), .O(z7));
  nand4  g61(.a(new_n61_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n71_), .b(new_n38_), .c(x10), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n52_), .d(new_n46_), .O(z8));
endmodule
