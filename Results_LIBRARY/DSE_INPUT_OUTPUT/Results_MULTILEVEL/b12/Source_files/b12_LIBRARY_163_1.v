...
module FAU ( 
  ...
  nand2  g30(.a(new_n45_), .b(new_n31_), .O(new_n55_));
  inv1   g31(.a(x11), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(x07), .O(new_n57_));
  aoi22  g33(.a(new_n57_), .b(new_n55_), .c(x12), .d(new_n34_), .O(z3));
  ...
  nand2  g37(.a(new_n61_), .b(new_n57_), .O(z4));
  inv1   g38(.a(x12), .O(new_n63_));
  nand3  g39(.a(x13), .b(new_n63_), .c(new_n34_), .O(new_n64_));
  ...
  nand2  g44(.a(new_n51_), .b(x03), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n25_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n60_), .c(new_n67_), .O(new_n71_));
  ...
  nand3  g51(.a(new_n75_), .b(new_n45_), .c(new_n31_), .O(new_n76_));
  ...
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n45_), .d(new_n31_), .O(z7));
  nand4  g57(.a(new_n63_), .b(x03), .c(new_n25_), .d(new_n67_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n51_), .b(new_n34_), .c(x10), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n31_), .O(z8));
endmodule
