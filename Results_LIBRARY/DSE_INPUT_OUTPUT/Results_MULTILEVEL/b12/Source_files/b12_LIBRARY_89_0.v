...
module FAU ( 
  ...
  aoi21  g30(.a(x11), .b(x07), .c(x10), .O(new_n55_));
  ...
  aoi22  g39(.a(new_n63_), .b(new_n62_), .c(x12), .d(new_n39_), .O(z3));
  ...
  nand4  g45(.a(x13), .b(new_n69_), .c(new_n61_), .d(new_n39_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x11), .O(new_n71_));
  ...
  nand3  g52(.a(new_n76_), .b(new_n74_), .c(new_n29_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n34_), .O(new_n78_));
  ...
  aoi21  g59(.a(new_n83_), .b(x11), .c(x10), .O(z6));
  ...
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n52_), .d(new_n61_), .O(z7));
  nand4  g64(.a(new_n69_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n89_));
  oai21  g65(.a(x09), .b(x00), .c(new_n61_), .O(new_n90_));
