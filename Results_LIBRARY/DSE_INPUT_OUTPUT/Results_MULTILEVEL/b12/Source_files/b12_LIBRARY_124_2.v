...
module FAU ( 
  ...
  nor2   g09(.a(x10), .b(new_n33_), .O(new_n34_));
  ...
  nand3  g20(.a(new_n44_), .b(new_n35_), .c(new_n37_), .O(new_n45_));
  ...
  nand2  g26(.a(new_n38_), .b(new_n37_), .O(new_n51_));
  ...
  nand3  g31(.a(new_n55_), .b(new_n50_), .c(new_n35_), .O(z2));
  inv1   g32(.a(x11), .O(new_n57_));
  inv1   g33(.a(x12), .O(new_n58_));
  oai22  g34(.a(new_n58_), .b(x00), .c(new_n57_), .d(new_n53_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n35_), .O(z3));
  oai21  g36(.a(new_n34_), .b(new_n57_), .c(x07), .O(new_n61_));
  ...
  nor2   g40(.a(x10), .b(x09), .O(new_n65_));
  inv1   g41(.a(x13), .O(new_n66_));
  nor2   g42(.a(new_n66_), .b(x12), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n65_), .c(new_n53_), .d(new_n37_), .O(z5));
  nor2   g44(.a(x03), .b(x02), .O(new_n69_));
  inv1   g45(.a(x08), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x00), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n51_), .c(new_n69_), .O(new_n72_));
  nand2  g48(.a(x14), .b(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n37_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n71_), .c(new_n38_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n72_), .c(new_n53_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n33_), .c(x10), .O(z6));
  oai21  g53(.a(new_n43_), .b(x01), .c(new_n70_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n65_), .c(new_n53_), .O(z7));
  inv1   g55(.a(x10), .O(new_n80_));
  oai21  g56(.a(x07), .b(new_n37_), .c(new_n33_), .O(new_n81_));
