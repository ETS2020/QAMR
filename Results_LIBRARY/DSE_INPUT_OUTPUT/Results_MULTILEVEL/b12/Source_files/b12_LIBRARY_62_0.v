...
module FAU ( 
  ...
  oai21  g24(.a(new_n26_), .b(new_n48_), .c(new_n25_), .O(new_n49_));
  nand3  g25(.a(new_n49_), .b(new_n28_), .c(new_n34_), .O(new_n50_));
  nand2  g26(.a(new_n27_), .b(x02), .O(new_n51_));
  ...
  nand3  g31(.a(x13), .b(x07), .c(new_n28_), .O(new_n56_));
  ...
  oai21  g36(.a(new_n60_), .b(new_n57_), .c(new_n34_), .O(new_n61_));
  ...
  nand2  g43(.a(new_n67_), .b(new_n54_), .O(new_n68_));
  nand2  g44(.a(new_n27_), .b(x11), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x07), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n68_), .O(z4));
  nor2   g47(.a(new_n26_), .b(x12), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n48_), .c(new_n54_), .d(new_n39_), .O(z5));
  nand2  g49(.a(new_n34_), .b(new_n39_), .O(new_n74_));
  nand2  g50(.a(new_n58_), .b(x00), .O(new_n75_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n48_), .c(new_n54_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n27_), .O(z6));
  oai21  g62(.a(x10), .b(x07), .c(new_n27_), .O(new_n87_));
  ...
  nand3  g66(.a(new_n88_), .b(x13), .c(new_n58_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n87_), .O(z7));
  nand4  g68(.a(new_n63_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand3  g70(.a(x13), .b(new_n25_), .c(new_n39_), .O(new_n95_));
