// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:07 2020
...
module FAU ( 
  ...
  nand2  g06(.a(x10), .b(x06), .O(new_n31_));
  oai21  g07(.a(new_n30_), .b(x00), .c(new_n31_), .O(z0));
  inv1   g08(.a(x01), .O(new_n33_));
  inv1   g09(.a(x06), .O(new_n34_));
  inv1   g10(.a(x10), .O(new_n35_));
  aoi21  g11(.a(new_n35_), .b(new_n25_), .c(new_n34_), .O(new_n36_));
  nand2  g12(.a(x05), .b(x01), .O(new_n37_));
  aoi21  g13(.a(new_n37_), .b(new_n35_), .c(new_n34_), .O(new_n38_));
  oai22  g14(.a(new_n38_), .b(new_n25_), .c(new_n36_), .d(new_n33_), .O(new_n39_));
  nand2  g15(.a(new_n39_), .b(x03), .O(new_n40_));
  inv1   g16(.a(x04), .O(new_n41_));
  nor2   g17(.a(new_n38_), .b(new_n41_), .O(new_n42_));
  nand2  g18(.a(new_n42_), .b(x02), .O(new_n43_));
  aoi21  g19(.a(new_n43_), .b(new_n40_), .c(x00), .O(z1));
  oai21  g20(.a(x08), .b(x07), .c(x00), .O(new_n45_));
  inv1   g21(.a(x03), .O(new_n46_));
  nand3  g22(.a(x10), .b(new_n46_), .c(new_n33_), .O(new_n47_));
  ...
  nand3  g27(.a(new_n35_), .b(x09), .c(new_n51_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n50_), .c(x00), .O(new_n53_));
  inv1   g29(.a(x08), .O(new_n54_));
  nand4  g30(.a(new_n35_), .b(x09), .c(new_n54_), .d(new_n51_), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n53_), .c(new_n33_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n49_), .c(new_n31_), .O(z2));
  ...
  nand2  g40(.a(new_n59_), .b(x07), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n31_), .O(z4));
  inv1   g42(.a(x00), .O(new_n67_));
  nand4  g43(.a(x13), .b(new_n60_), .c(new_n51_), .d(new_n67_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n35_), .O(new_n69_));
  oai21  g45(.a(new_n35_), .b(x06), .c(new_n69_), .O(z5));
  nand2  g46(.a(x08), .b(x00), .O(new_n71_));
  nand2  g47(.a(x09), .b(new_n46_), .O(new_n72_));
  inv1   g48(.a(x09), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x03), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n25_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n71_), .c(new_n33_), .O(new_n76_));
  aoi21  g52(.a(x14), .b(x02), .c(x00), .O(new_n77_));
  nor2   g53(.a(x08), .b(new_n67_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n77_), .c(x01), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n35_), .c(new_n51_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n31_), .O(z6));
  nand3  g58(.a(x03), .b(new_n25_), .c(new_n33_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n54_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n25_), .d(new_n33_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n35_), .d(new_n51_), .O(z7));
  nand4  g62(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n33_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n73_), .b(new_n67_), .c(x10), .O(new_n89_));
