...
module FAU ( 
  ...
  nand3  g28(.a(x10), .b(new_n27_), .c(new_n33_), .O(new_n53_));
  ...
  aoi21  g39(.a(new_n63_), .b(x10), .c(new_n62_), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(x07), .c(new_n61_), .O(z4));
  nand4  g41(.a(x13), .b(new_n58_), .c(new_n46_), .d(new_n38_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n62_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n25_), .O(z5));
  nor2   g44(.a(x03), .b(x02), .O(new_n69_));
  nand2  g45(.a(new_n33_), .b(new_n38_), .O(new_n70_));
  nand2  g46(.a(new_n52_), .b(x00), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(new_n72_));
  nand2  g48(.a(x14), .b(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n38_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n71_), .c(new_n33_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n72_), .c(new_n46_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n62_), .c(x10), .O(z6));
  oai21  g53(.a(new_n42_), .b(x01), .c(new_n52_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n25_), .c(new_n62_), .d(new_n46_), .O(z7));
  nand4  g55(.a(new_n25_), .b(new_n62_), .c(new_n46_), .d(x00), .O(z8));
endmodule
