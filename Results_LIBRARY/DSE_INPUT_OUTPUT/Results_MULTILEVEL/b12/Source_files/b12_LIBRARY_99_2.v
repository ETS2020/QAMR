...
module FAU ( 
  ...
  nand3  g29(.a(x12), .b(x10), .c(new_n35_), .O(new_n54_));
  ...
  oai22  g36(.a(new_n31_), .b(x00), .c(new_n60_), .d(new_n47_), .O(new_n61_));
  ...
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n31_), .d(new_n52_), .O(z5));
  ...
  nand3  g54(.a(new_n78_), .b(new_n52_), .c(new_n47_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand2  g56(.a(x12), .b(x10), .O(new_n81_));
  ...
  aoi21  g60(.a(new_n82_), .b(new_n48_), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x10), .c(new_n81_), .O(z7));
  nand4  g62(.a(new_n31_), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n71_), .b(new_n34_), .c(x10), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n47_), .O(z8));
endmodule
