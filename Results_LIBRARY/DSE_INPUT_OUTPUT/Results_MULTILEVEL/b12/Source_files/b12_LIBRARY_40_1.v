...
module FAU ( 
  ...
  oai21  g38(.a(new_n59_), .b(new_n25_), .c(x07), .O(new_n63_));
  ...
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n60_), .d(new_n59_), .O(z5));
  ...
  nand4  g54(.a(new_n78_), .b(new_n59_), .c(new_n25_), .d(new_n51_), .O(new_n79_));
  ...
  aoi21  g59(.a(new_n81_), .b(new_n54_), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x11), .c(new_n25_), .O(z7));
  nand4  g61(.a(new_n60_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n71_), .b(new_n38_), .c(x07), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n59_), .d(new_n25_), .O(z8));
endmodule
