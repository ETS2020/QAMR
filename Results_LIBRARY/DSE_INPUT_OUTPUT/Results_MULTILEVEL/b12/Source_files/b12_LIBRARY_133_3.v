...
module FAU ( 
  ...
  nand3  g45(.a(new_n69_), .b(new_n52_), .c(new_n34_), .O(new_n70_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n48_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n49_), .O(new_n81_));
  nand2  g57(.a(new_n48_), .b(x07), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n81_), .O(z7));
  inv1   g59(.a(x12), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(x03), .c(new_n25_), .d(new_n34_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n67_), .b(new_n33_), .c(x10), .O(new_n87_));
