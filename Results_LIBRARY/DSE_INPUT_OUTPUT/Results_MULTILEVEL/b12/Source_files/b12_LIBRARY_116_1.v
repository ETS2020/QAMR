...
module FAU ( 
  ...
  nand2  g38(.a(x09), .b(new_n54_), .O(new_n63_));
  nand2  g39(.a(new_n51_), .b(new_n31_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n63_), .c(new_n34_), .O(new_n65_));
  aoi21  g41(.a(x10), .b(new_n31_), .c(x00), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n65_), .c(new_n50_), .O(new_n67_));
  inv1   g43(.a(x11), .O(new_n68_));
  nand3  g44(.a(new_n32_), .b(new_n68_), .c(x07), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n67_), .O(z4));
  oai21  g46(.a(x10), .b(x07), .c(new_n31_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x00), .O(new_n72_));
  nand2  g48(.a(new_n32_), .b(x07), .O(new_n73_));
  inv1   g49(.a(x13), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(x12), .c(new_n51_), .O(new_n75_));
  oai21  g51(.a(new_n51_), .b(new_n31_), .c(new_n75_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n50_), .c(new_n34_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n72_), .O(z5));
  nand2  g54(.a(new_n36_), .b(new_n25_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n54_), .c(x00), .O(new_n80_));
  nand3  g56(.a(x03), .b(new_n35_), .c(new_n34_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n31_), .O(new_n83_));
  aoi21  g59(.a(x09), .b(new_n36_), .c(x02), .O(new_n84_));
  oai21  g60(.a(new_n36_), .b(x02), .c(x09), .O(new_n85_));
  oai22  g61(.a(new_n85_), .b(x08), .c(new_n84_), .d(x00), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n35_), .O(new_n87_));
  aoi21  g63(.a(x14), .b(x02), .c(x00), .O(new_n88_));
  nor2   g64(.a(x08), .b(new_n34_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n88_), .c(x01), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n87_), .c(new_n83_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n51_), .c(new_n50_), .O(new_n92_));
  inv1   g68(.a(new_n92_), .O(z6));
  oai21  g69(.a(new_n41_), .b(x01), .c(new_n54_), .O(new_n94_));
  nand4  g70(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n51_), .d(new_n50_), .O(z7));
  inv1   g72(.a(x12), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(x09), .O(new_n99_));
  aoi21  g75(.a(new_n31_), .b(new_n34_), .c(x10), .O(new_n100_));
