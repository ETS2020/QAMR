...
module FAU ( 
  ...
  nand3  g50(.a(new_n74_), .b(new_n50_), .c(new_n38_), .O(new_n75_));
  nand2  g51(.a(new_n25_), .b(x00), .O(new_n76_));
  ...
  oai21  g57(.a(new_n42_), .b(x01), .c(new_n25_), .O(new_n82_));
  ...
  nand4  g63(.a(new_n58_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n88_));
