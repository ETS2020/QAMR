...
module FAU ( 
  ...
  nand2  g10(.a(x10), .b(x04), .O(new_n35_));
  nand2  g11(.a(new_n35_), .b(new_n34_), .O(z0));
  inv1   g12(.a(x03), .O(new_n37_));
  nand2  g13(.a(new_n27_), .b(new_n37_), .O(new_n38_));
  nand3  g14(.a(new_n38_), .b(new_n29_), .c(x02), .O(new_n39_));
  ...
  nand3  g19(.a(x07), .b(new_n37_), .c(new_n43_), .O(new_n44_));
  aoi21  g20(.a(new_n44_), .b(new_n26_), .c(x00), .O(new_n45_));
  ...
  oai21  g25(.a(new_n49_), .b(new_n45_), .c(new_n35_), .O(new_n50_));
  nand3  g26(.a(x10), .b(new_n27_), .c(new_n37_), .O(new_n51_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n35_), .O(z4));
  nand2  g43(.a(x10), .b(new_n27_), .O(new_n68_));
  inv1   g44(.a(x12), .O(new_n69_));
  nand4  g45(.a(x13), .b(new_n69_), .c(new_n46_), .d(new_n25_), .O(new_n70_));
  ...
  nand3  g52(.a(new_n76_), .b(new_n74_), .c(new_n26_), .O(new_n77_));
  ...
  nand3  g60(.a(x03), .b(new_n26_), .c(new_n43_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n47_), .O(new_n86_));
  nand4  g62(.a(x09), .b(x03), .c(new_n26_), .d(new_n43_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n52_), .d(new_n46_), .O(z7));
  nand4  g64(.a(new_n69_), .b(x03), .c(new_n26_), .d(new_n43_), .O(new_n89_));
