// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:08 2020
...
module FAU ( 
  ...
  nand4  g38(.a(x13), .b(new_n62_), .c(new_n47_), .d(new_n37_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n58_), .O(new_n64_));
  nand2  g40(.a(new_n47_), .b(x07), .O(new_n65_));
  ...
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n47_), .d(new_n58_), .O(z7));
  nand4  g58(.a(new_n62_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n83_));
  oai21  g59(.a(x09), .b(x00), .c(new_n47_), .O(new_n84_));
  aoi21  g60(.a(new_n83_), .b(x09), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x07), .c(new_n65_), .O(z8));
endmodule
