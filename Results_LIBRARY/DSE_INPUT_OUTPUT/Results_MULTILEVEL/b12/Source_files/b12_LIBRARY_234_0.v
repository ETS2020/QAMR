// Benchmark "FAU" written by ABC on Thu Aug 13 17:52:44 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n66_, new_n67_, new_n68_, new_n70_, new_n72_;
  ...
  nor2   g19(.a(x10), .b(x01), .O(new_n44_));
  ...
  aoi21  g29(.a(x12), .b(new_n34_), .c(new_n44_), .O(new_n54_));
  oai21  g30(.a(new_n53_), .b(new_n49_), .c(new_n54_), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(z3));
  nand3  g32(.a(x09), .b(x08), .c(x00), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n49_), .O(new_n58_));
  nand2  g34(.a(new_n53_), .b(x07), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n58_), .c(new_n44_), .O(z4));
  nor2   g36(.a(x12), .b(x10), .O(new_n61_));
  nor2   g37(.a(new_n25_), .b(x00), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(new_n61_), .c(x13), .d(new_n49_), .O(z5));
  ...
  nand4  g43(.a(new_n67_), .b(new_n64_), .c(new_n49_), .d(x01), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(z6));
  oai21  g45(.a(new_n50_), .b(x07), .c(x01), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n64_), .O(z7));
