...
module FAU ( 
  ...
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n32_), .O(z4));
  inv1   g42(.a(x13), .O(new_n68_));
  nand2  g43(.a(x08), .b(x00), .O(new_n69_));
  nand2  g44(.a(x09), .b(new_n36_), .O(new_n70_));
  inv1   g45(.a(x09), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(x03), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(new_n70_), .c(new_n25_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(new_n69_), .c(new_n35_), .O(new_n74_));
  aoi21  g49(.a(x14), .b(x02), .c(x00), .O(new_n75_));
  nor2   g50(.a(x08), .b(new_n34_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(new_n75_), .c(x01), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n50_), .O(new_n79_));
  aoi21  g54(.a(new_n79_), .b(new_n68_), .c(x10), .O(z6));
  oai21  g55(.a(new_n41_), .b(x01), .c(new_n53_), .O(new_n81_));
  nand4  g56(.a(x09), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(new_n81_), .c(new_n50_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n68_), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n31_), .O(z7));
  inv1   g60(.a(x12), .O(new_n86_));
  nand4  g61(.a(new_n86_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n87_));
  nand2  g62(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g63(.a(new_n71_), .b(new_n34_), .c(x07), .O(new_n89_));
  nand4  g64(.a(new_n89_), .b(new_n88_), .c(new_n68_), .d(new_n31_), .O(z8));
  one    g65(.O(z5));
endmodule
