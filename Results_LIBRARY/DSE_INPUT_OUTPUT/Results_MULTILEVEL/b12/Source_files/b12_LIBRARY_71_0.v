...
module FAU ( 
  ...
  nor2   g57(.a(new_n32_), .b(x10), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n51_), .O(z7));
  nand4  g59(.a(new_n59_), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n70_), .b(new_n35_), .c(x07), .O(new_n86_));
