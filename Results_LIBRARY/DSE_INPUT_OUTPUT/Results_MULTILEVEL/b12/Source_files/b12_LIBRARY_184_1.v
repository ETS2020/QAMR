...
module FAU ( 
  ...
  oai21  g38(.a(new_n62_), .b(new_n60_), .c(new_n33_), .O(new_n63_));
  oai21  g39(.a(x11), .b(new_n33_), .c(new_n63_), .O(z4));
  nand3  g40(.a(x13), .b(new_n56_), .c(new_n36_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n61_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n33_), .O(z5));
  ...
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n61_), .d(new_n33_), .O(z7));
