// Benchmark "FAU" written by ABC on Thu Aug 13 17:51:16 2020
...
module FAU ( 
  ...
  nand3  g40(.a(new_n59_), .b(x10), .c(x07), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(z4));
  inv1   g42(.a(x13), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(x12), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n25_), .c(new_n58_), .d(new_n38_), .O(z5));
  ...
  nand3  g61(.a(new_n82_), .b(new_n60_), .c(x03), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n72_), .b(new_n38_), .c(x10), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n58_), .O(z8));
endmodule
