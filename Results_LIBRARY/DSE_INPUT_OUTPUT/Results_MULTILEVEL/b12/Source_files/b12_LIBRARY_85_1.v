...
module FAU ( 
  ...
  nand3  g22(.a(x07), .b(new_n36_), .c(new_n25_), .O(new_n47_));
  ...
  nand4  g29(.a(new_n53_), .b(new_n35_), .c(new_n50_), .d(new_n25_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n49_), .c(new_n46_), .O(z2));
  inv1   g31(.a(x11), .O(new_n56_));
  inv1   g32(.a(x12), .O(new_n57_));
  oai22  g33(.a(new_n57_), .b(x00), .c(new_n56_), .d(new_n50_), .O(new_n58_));
  nand2  g34(.a(x08), .b(new_n34_), .O(new_n59_));
  ...
  nand4  g43(.a(new_n67_), .b(new_n35_), .c(new_n50_), .d(new_n34_), .O(z5));
  ...
  nand4  g49(.a(new_n73_), .b(new_n65_), .c(new_n35_), .d(new_n50_), .O(new_n74_));
