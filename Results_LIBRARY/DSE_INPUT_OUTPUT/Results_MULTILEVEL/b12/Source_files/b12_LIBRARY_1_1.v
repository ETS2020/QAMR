...
module FAU ( 
  ...
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n60_), .d(new_n31_), .O(z7));
  nand4  g57(.a(new_n55_), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n68_), .b(new_n34_), .c(x10), .O(new_n84_));
