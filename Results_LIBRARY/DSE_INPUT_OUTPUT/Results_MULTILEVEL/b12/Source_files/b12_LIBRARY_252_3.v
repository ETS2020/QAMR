...
module FAU ( 
  ...
  nand4  g40(.a(new_n64_), .b(new_n45_), .c(new_n57_), .d(new_n33_), .O(z5));
  ...
  nand4  g54(.a(x09), .b(x03), .c(new_n25_), .d(new_n49_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n45_), .O(new_n80_));
  aoi21  g56(.a(new_n78_), .b(new_n77_), .c(new_n80_), .O(new_n81_));
  nand2  g57(.a(new_n45_), .b(x07), .O(new_n82_));
  oai21  g58(.a(new_n81_), .b(x07), .c(new_n82_), .O(z7));
  inv1   g59(.a(x12), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(x03), .c(new_n25_), .d(new_n49_), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n45_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x07), .c(new_n82_), .O(z8));
endmodule
