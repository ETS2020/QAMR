...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n80_, new_n82_, new_n83_, new_n84_, new_n86_, new_n87_;
  ...
  nand3  g24(.a(x12), .b(new_n25_), .c(x09), .O(new_n49_));
  ...
  nand2  g37(.a(new_n26_), .b(x10), .O(new_n62_));
  ...
  nand3  g44(.a(new_n68_), .b(new_n66_), .c(z5), .O(z4));
  ...
  nand2  g55(.a(new_n79_), .b(new_n64_), .O(new_n80_));
  ...
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n52_), .d(new_n64_), .O(z7));
  nand3  g61(.a(new_n72_), .b(new_n64_), .c(x00), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x12), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n25_), .O(z8));
endmodule
