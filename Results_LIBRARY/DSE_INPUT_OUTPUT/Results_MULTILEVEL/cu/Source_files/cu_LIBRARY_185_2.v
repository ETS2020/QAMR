...
module FAU ( 
  ...
  nand4  g27(.a(new_n27_), .b(new_n45_), .c(new_n36_), .d(x02), .O(new_n54_));
  inv1   g28(.a(x07), .O(new_n55_));
  inv1   g29(.a(x12), .O(new_n56_));
  nor2   g30(.a(x08), .b(x01), .O(new_n57_));
  nor2   g31(.a(x10), .b(new_n26_), .O(new_n58_));
  oai21  g32(.a(new_n58_), .b(new_n57_), .c(new_n46_), .O(new_n59_));
  ...
  nand3  g41(.a(new_n45_), .b(x05), .c(new_n29_), .O(new_n68_));
