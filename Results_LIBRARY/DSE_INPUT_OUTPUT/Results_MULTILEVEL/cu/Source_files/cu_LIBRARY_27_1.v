...
module FAU ( 
  ...
  nand4  g23(.a(new_n37_), .b(new_n30_), .c(x01), .d(new_n48_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n43_), .c(x05), .d(new_n31_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nand2  g27(.a(x02), .b(new_n26_), .O(new_n53_));
  nand3  g28(.a(new_n30_), .b(x01), .c(x00), .O(new_n54_));
  nand4  g29(.a(new_n43_), .b(x05), .c(new_n31_), .d(new_n37_), .O(new_n55_));
  ...
  nand3  g36(.a(new_n61_), .b(new_n30_), .c(x01), .O(new_n62_));
  ...
  nand3  g42(.a(new_n67_), .b(new_n30_), .c(x01), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n48_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n64_), .c(new_n43_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n72_));
  nand3  g47(.a(new_n43_), .b(new_n27_), .c(x02), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x04), .c(new_n37_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n53_), .O(z06));
  nand3  g51(.a(new_n43_), .b(x05), .c(new_n31_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(new_n38_), .c(new_n53_), .O(z07));
  nor2   g53(.a(new_n31_), .b(x03), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(new_n43_), .c(new_n27_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(x01), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(x02), .O(new_n82_));
  nor2   g57(.a(new_n43_), .b(x12), .O(new_n83_));
  nand4  g58(.a(new_n83_), .b(new_n79_), .c(x05), .d(new_n30_), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n82_), .O(z08));
  nand2  g60(.a(x13), .b(x06), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(new_n53_), .O(z09));
  oai21  g62(.a(x05), .b(new_n26_), .c(x02), .O(new_n88_));
