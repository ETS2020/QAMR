...
module FAU ( 
  ...
  nand4  g27(.a(new_n52_), .b(new_n46_), .c(x05), .d(new_n35_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nand3  g29(.a(new_n30_), .b(x01), .c(x00), .O(new_n55_));
  nand4  g30(.a(new_n46_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n56_));
  ...
  oai21  g47(.a(new_n47_), .b(new_n72_), .c(new_n33_), .O(z07));
  ...
  aoi21  g52(.a(new_n46_), .b(x01), .c(new_n40_), .O(z09));
  nand2  g53(.a(x05), .b(x02), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(x06), .c(new_n26_), .d(x01), .O(new_n80_));
