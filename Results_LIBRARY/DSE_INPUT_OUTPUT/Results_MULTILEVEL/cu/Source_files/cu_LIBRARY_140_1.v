...
module FAU ( 
  ...
  nand4  g23(.a(new_n49_), .b(new_n45_), .c(x05), .d(new_n27_), .O(new_n50_));
  aoi21  g24(.a(new_n50_), .b(x00), .c(new_n43_), .O(z05));
  ...
  oai21  g30(.a(new_n56_), .b(new_n52_), .c(new_n43_), .O(new_n57_));
  nand2  g31(.a(new_n57_), .b(new_n32_), .O(new_n58_));
  inv1   g32(.a(x09), .O(new_n59_));
  nand3  g33(.a(new_n59_), .b(new_n43_), .c(x00), .O(new_n60_));
  ...
  nand3  g38(.a(new_n45_), .b(new_n30_), .c(x02), .O(new_n65_));
  ...
  nand2  g42(.a(new_n50_), .b(new_n33_), .O(z07));
  nand4  g43(.a(x13), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n65_), .O(new_n71_));
  ...
  nand3  g50(.a(new_n76_), .b(x06), .c(new_n26_), .O(new_n77_));
