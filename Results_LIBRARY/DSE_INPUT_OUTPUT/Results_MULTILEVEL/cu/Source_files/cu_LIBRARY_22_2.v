...
module FAU ( 
  ...
  nand2  g39(.a(new_n64_), .b(new_n40_), .O(z06));
  nand2  g40(.a(new_n26_), .b(new_n29_), .O(new_n66_));
  nand3  g41(.a(new_n43_), .b(x05), .c(new_n27_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n66_), .c(new_n40_), .O(z07));
  ...
  oai21  g47(.a(new_n43_), .b(new_n39_), .c(new_n40_), .O(z09));
