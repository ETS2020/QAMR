...
module FAU ( 
  ...
  oai21  g30(.a(new_n26_), .b(x01), .c(x00), .O(new_n56_));
  inv1   g31(.a(x08), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n51_), .c(new_n45_), .O(new_n58_));
  ...
  oai21  g37(.a(x08), .b(x01), .c(new_n60_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(x09), .c(new_n45_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n62_), .c(new_n48_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n54_), .c(new_n53_), .d(x05), .O(new_n66_));
  nand4  g41(.a(new_n27_), .b(new_n48_), .c(new_n36_), .d(x02), .O(new_n67_));
  ...
  nand3  g46(.a(new_n48_), .b(x05), .c(new_n29_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n71_), .c(new_n27_), .O(z07));
  nand4  g48(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n74_));
  nand3  g49(.a(new_n48_), .b(new_n36_), .c(x02), .O(new_n75_));
