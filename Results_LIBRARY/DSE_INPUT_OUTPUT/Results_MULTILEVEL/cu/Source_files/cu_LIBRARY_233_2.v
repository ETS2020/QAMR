...
module FAU ( 
  ...
  nand2  g40(.a(new_n44_), .b(new_n27_), .O(z07));
  nand4  g41(.a(x13), .b(new_n55_), .c(x05), .d(new_n31_), .O(new_n67_));
  ...
  nor3   g47(.a(z03), .b(new_n42_), .c(new_n72_), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n27_), .c(x06), .d(new_n35_), .O(new_n75_));
