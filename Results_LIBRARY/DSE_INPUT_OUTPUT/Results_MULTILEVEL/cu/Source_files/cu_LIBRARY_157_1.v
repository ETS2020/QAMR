...
module FAU ( 
  ...
  nand4  g24(.a(new_n50_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(x13), .O(z05));
  nand4  g26(.a(x05), .b(x04), .c(new_n35_), .d(new_n30_), .O(new_n53_));
  ...
  nor3   g51(.a(new_n27_), .b(new_n45_), .c(new_n77_), .O(z09));
  nand2  g52(.a(x05), .b(x02), .O(new_n79_));
  nand3  g53(.a(new_n79_), .b(x06), .c(new_n35_), .O(new_n80_));
