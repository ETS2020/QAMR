...
module FAU ( 
  ...
  oai21  g07(.a(new_n32_), .b(new_n30_), .c(new_n26_), .O(new_n33_));
  ...
  nor2   g32(.a(x10), .b(new_n42_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(new_n47_), .O(new_n59_));
  aoi21  g34(.a(x11), .b(x01), .c(x09), .O(new_n60_));
  ...
  nand3  g39(.a(new_n41_), .b(new_n29_), .c(x02), .O(new_n65_));
  ...
  nand4  g43(.a(x05), .b(new_n31_), .c(new_n26_), .d(new_n28_), .O(new_n69_));
  ...
  nand2  g54(.a(new_n79_), .b(new_n76_), .O(z10));
endmodule
