...
module FAU ( 
  ...
  nand3  g13(.a(new_n26_), .b(x04), .c(x02), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(new_n38_), .c(x03), .O(z01));
  inv1   g15(.a(x13), .O(new_n41_));
  inv1   g16(.a(x00), .O(new_n42_));
  inv1   g17(.a(x03), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n30_), .c(x01), .d(new_n42_), .O(new_n44_));
  ...
  nand4  g23(.a(new_n48_), .b(new_n43_), .c(new_n30_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x01), .c(new_n26_), .O(z05));
  ...
  nand4  g34(.a(new_n59_), .b(x05), .c(new_n30_), .d(x01), .O(new_n60_));
  nand3  g35(.a(new_n41_), .b(new_n26_), .c(x02), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(x04), .c(new_n43_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(z06));
  nand3  g39(.a(new_n37_), .b(new_n31_), .c(new_n43_), .O(new_n65_));
  nor3   g40(.a(new_n65_), .b(x13), .c(new_n26_), .O(z07));
  nand3  g41(.a(x13), .b(new_n52_), .c(x05), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n36_), .c(new_n61_), .O(new_n68_));
