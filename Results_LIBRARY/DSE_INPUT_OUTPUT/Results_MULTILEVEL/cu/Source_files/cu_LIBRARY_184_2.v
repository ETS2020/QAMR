...
module FAU ( 
  ...
  nand4  g19(.a(new_n34_), .b(new_n30_), .c(x01), .d(new_n26_), .O(new_n45_));
  ...
  nand3  g35(.a(new_n60_), .b(x01), .c(new_n26_), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n59_), .c(new_n41_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n53_), .c(new_n51_), .d(x05), .O(new_n63_));
  ...
  nand2  g41(.a(new_n66_), .b(new_n56_), .O(z06));
  nor2   g42(.a(z03), .b(x13), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n69_));
  ...
  nand4  g47(.a(new_n72_), .b(new_n35_), .c(x04), .d(new_n34_), .O(new_n73_));
