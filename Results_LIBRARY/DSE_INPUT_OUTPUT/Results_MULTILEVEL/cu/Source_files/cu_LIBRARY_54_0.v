...
module FAU ( 
  ...
  aoi21  g19(.a(new_n44_), .b(x01), .c(x00), .O(z04));
  nor3   g20(.a(x02), .b(new_n33_), .c(new_n32_), .O(new_n47_));
  nand4  g21(.a(new_n47_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n48_));
  nor2   g22(.a(new_n48_), .b(x13), .O(z05));
  nand4  g23(.a(new_n34_), .b(new_n42_), .c(new_n30_), .d(x02), .O(new_n50_));
  inv1   g24(.a(x07), .O(new_n51_));
  inv1   g25(.a(x12), .O(new_n52_));
  nor2   g26(.a(x09), .b(x01), .O(new_n53_));
  nor2   g27(.a(x11), .b(new_n33_), .O(new_n54_));
  oai21  g28(.a(new_n54_), .b(new_n53_), .c(x00), .O(new_n55_));
  inv1   g29(.a(x10), .O(new_n56_));
  nand3  g30(.a(new_n56_), .b(x01), .c(new_n32_), .O(new_n57_));
  aoi21  g31(.a(new_n57_), .b(new_n55_), .c(new_n42_), .O(new_n58_));
