...
module FAU ( 
  ...
  nand4  g19(.a(new_n35_), .b(new_n31_), .c(new_n44_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(x10), .c(x05), .d(new_n29_), .O(new_n47_));
  ...
  nand4  g27(.a(new_n52_), .b(new_n49_), .c(x05), .d(new_n29_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nor2   g29(.a(x03), .b(x02), .O(new_n55_));
  nor2   g30(.a(x13), .b(new_n36_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n55_), .c(new_n29_), .d(x01), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(x10), .c(new_n50_), .O(z05));
  ...
  nand3  g40(.a(new_n65_), .b(x10), .c(x00), .O(new_n66_));
  nor2   g41(.a(x08), .b(x01), .O(new_n67_));
  nor2   g42(.a(x10), .b(new_n44_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n67_), .c(new_n50_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n66_), .c(new_n49_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n71_));
  nor2   g46(.a(new_n28_), .b(x13), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(new_n36_), .c(x02), .O(new_n73_));
  ...
  nand4  g51(.a(new_n72_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n77_));
  nor2   g52(.a(new_n77_), .b(x02), .O(z07));
  nand4  g53(.a(x13), .b(new_n60_), .c(x05), .d(new_n31_), .O(new_n79_));
  nand3  g54(.a(new_n49_), .b(new_n36_), .c(x02), .O(new_n80_));
  ...
  nor3   g59(.a(new_n28_), .b(new_n49_), .c(new_n84_), .O(z09));
