...
module FAU ( 
  ...
  nand4  g26(.a(new_n27_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n52_));
  ...
  nand3  g36(.a(new_n61_), .b(new_n45_), .c(new_n50_), .O(new_n62_));
  ...
  nand3  g50(.a(x13), .b(new_n58_), .c(new_n26_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(new_n75_), .c(new_n69_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n36_), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z08));
  inv1   g54(.a(x06), .O(new_n80_));
  aoi21  g55(.a(new_n26_), .b(new_n80_), .c(new_n27_), .O(z09));
