...
module FAU ( 
  ...
  nand3  g37(.a(new_n62_), .b(new_n32_), .c(x01), .O(new_n63_));
  ...
  nand3  g43(.a(new_n68_), .b(new_n32_), .c(x01), .O(new_n69_));
  ...
  nand4  g47(.a(new_n72_), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n73_));
  ...
  nand2  g51(.a(new_n76_), .b(new_n34_), .O(z06));
  nand2  g52(.a(new_n26_), .b(new_n29_), .O(new_n78_));
  nand3  g53(.a(new_n51_), .b(x05), .c(new_n27_), .O(new_n79_));
  oai21  g54(.a(new_n79_), .b(new_n78_), .c(new_n34_), .O(z07));
  nand4  g55(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n74_), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(new_n34_), .c(x04), .d(new_n26_), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z08));
  inv1   g59(.a(x06), .O(new_n85_));
  nor3   g60(.a(new_n33_), .b(new_n51_), .c(new_n85_), .O(z09));
