...
module FAU ( 
  ...
  aoi21  g13(.a(new_n36_), .b(new_n29_), .c(new_n38_), .O(new_n39_));
  oai21  g14(.a(new_n39_), .b(x03), .c(new_n34_), .O(z01));
  ...
  nand3  g43(.a(new_n36_), .b(new_n26_), .c(new_n29_), .O(new_n70_));
  aoi21  g44(.a(new_n70_), .b(new_n32_), .c(x13), .O(z07));
