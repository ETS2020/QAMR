...
module FAU ( 
  ...
  nand3  g35(.a(new_n61_), .b(x04), .c(new_n33_), .O(new_n62_));
  inv1   g36(.a(new_n62_), .O(z06));
  nand2  g37(.a(new_n43_), .b(new_n34_), .O(z07));
  nand4  g38(.a(x13), .b(new_n53_), .c(x05), .d(new_n29_), .O(new_n65_));
  nand3  g39(.a(new_n41_), .b(new_n35_), .c(x02), .O(new_n66_));
  nand2  g40(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand4  g41(.a(new_n67_), .b(new_n34_), .c(x04), .d(new_n33_), .O(new_n68_));
  inv1   g42(.a(new_n68_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n34_), .O(z09));
  nand2  g45(.a(x05), .b(x02), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(new_n34_), .c(x06), .d(new_n33_), .O(new_n73_));
