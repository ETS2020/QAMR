...
module FAU ( 
  ...
  nand4  g23(.a(new_n33_), .b(new_n29_), .c(x01), .d(new_n40_), .O(new_n49_));
  ...
  nand4  g28(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n54_));
  ...
  nand3  g40(.a(new_n65_), .b(x06), .c(new_n58_), .O(new_n66_));
  ...
  nand4  g46(.a(new_n71_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n72_));
  nand4  g47(.a(new_n34_), .b(new_n42_), .c(new_n35_), .d(x02), .O(new_n73_));
  ...
  inv1   g51(.a(new_n41_), .O(new_n77_));
  oai21  g52(.a(new_n43_), .b(new_n77_), .c(new_n34_), .O(z07));
  nand4  g53(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n79_));
  nand3  g54(.a(new_n42_), .b(new_n35_), .c(x02), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n34_), .c(x04), .d(new_n33_), .O(new_n82_));
