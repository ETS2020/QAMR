...
module FAU ( 
  ...
  nand3  g39(.a(x13), .b(new_n52_), .c(x05), .O(new_n66_));
  nand2  g40(.a(new_n61_), .b(x02), .O(new_n67_));
  oai21  g41(.a(new_n66_), .b(new_n33_), .c(new_n67_), .O(new_n68_));
  ...
  aoi21  g46(.a(x06), .b(new_n26_), .c(new_n50_), .O(new_n73_));
