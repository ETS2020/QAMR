...
module FAU ( 
  ...
  nand3  g40(.a(new_n26_), .b(new_n36_), .c(x02), .O(new_n66_));
  ...
  nand2  g44(.a(new_n35_), .b(new_n30_), .O(new_n70_));
  nand3  g45(.a(new_n26_), .b(x05), .c(new_n28_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n34_), .O(z07));
  nand2  g47(.a(x05), .b(new_n30_), .O(new_n73_));
  nand3  g48(.a(x13), .b(new_n57_), .c(x06), .O(new_n74_));
