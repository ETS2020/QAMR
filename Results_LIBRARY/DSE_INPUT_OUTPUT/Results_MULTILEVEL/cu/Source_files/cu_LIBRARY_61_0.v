...
module FAU ( 
  ...
  nor2   g17(.a(x05), .b(x01), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  inv1   g19(.a(x00), .O(new_n45_));
  nand3  g20(.a(new_n27_), .b(x01), .c(new_n45_), .O(new_n46_));
  inv1   g21(.a(x13), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x05), .c(new_n33_), .d(new_n26_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n44_), .O(z04));
  ...
  aoi21  g36(.a(new_n61_), .b(new_n58_), .c(new_n47_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n55_), .c(new_n54_), .d(x05), .O(new_n63_));
  nand4  g38(.a(new_n47_), .b(new_n28_), .c(x02), .d(x01), .O(new_n64_));
  ...
  nand3  g43(.a(new_n47_), .b(x05), .c(new_n33_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n44_), .O(z07));
  nand2  g45(.a(x05), .b(new_n27_), .O(new_n71_));
  nand2  g46(.a(x13), .b(new_n55_), .O(new_n72_));
  nand3  g47(.a(new_n47_), .b(new_n28_), .c(x02), .O(new_n73_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x04), .c(new_n26_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n44_), .O(z08));
  inv1   g51(.a(x06), .O(new_n77_));
  nor3   g52(.a(new_n43_), .b(new_n47_), .c(new_n77_), .O(z09));
  oai21  g53(.a(x05), .b(new_n50_), .c(new_n71_), .O(new_n79_));
