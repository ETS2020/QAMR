...
module FAU ( 
  ...
  nand4  g19(.a(new_n35_), .b(new_n30_), .c(new_n44_), .d(x00), .O(new_n45_));
  ...
  nand4  g25(.a(new_n26_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n51_));
  ...
  nand4  g38(.a(new_n63_), .b(x13), .c(new_n57_), .d(x11), .O(new_n64_));
  ...
  nand3  g48(.a(x13), .b(new_n57_), .c(x11), .O(new_n74_));
  ...
  aoi21  g53(.a(x11), .b(new_n78_), .c(new_n26_), .O(z09));
