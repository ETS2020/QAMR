...
module FAU ( 
  ...
  nand3  g24(.a(new_n31_), .b(x01), .c(new_n49_), .O(new_n50_));
  ...
  oai21  g29(.a(new_n54_), .b(x01), .c(x00), .O(new_n55_));
  inv1   g30(.a(x10), .O(new_n56_));
  nor2   g31(.a(x08), .b(x01), .O(new_n57_));
  aoi22  g32(.a(new_n57_), .b(new_n49_), .c(new_n56_), .d(x01), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(new_n55_), .c(new_n46_), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(new_n26_), .c(new_n53_), .d(x05), .O(new_n60_));
  nand3  g35(.a(new_n46_), .b(new_n36_), .c(x02), .O(new_n61_));
  ...
  nand2  g39(.a(new_n35_), .b(new_n31_), .O(new_n65_));
  nand3  g40(.a(new_n46_), .b(x05), .c(new_n29_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(new_n27_), .O(z07));
  nand4  g42(.a(new_n27_), .b(new_n46_), .c(new_n36_), .d(x02), .O(new_n68_));
  inv1   g43(.a(x11), .O(new_n69_));
  nor2   g44(.a(new_n36_), .b(x02), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x13), .c(new_n26_), .d(new_n69_), .O(new_n71_));
