...
module FAU ( 
  ...
  nand2  g22(.a(new_n35_), .b(new_n30_), .O(new_n48_));
  ...
  aoi21  g27(.a(new_n52_), .b(x12), .c(new_n26_), .O(z04));
  nand4  g28(.a(new_n35_), .b(new_n30_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x12), .c(x05), .d(new_n28_), .O(new_n56_));
  ...
  nand3  g40(.a(new_n43_), .b(new_n36_), .c(x02), .O(new_n66_));
  ...
  oai21  g44(.a(new_n50_), .b(new_n48_), .c(new_n34_), .O(z07));
  nand4  g45(.a(x13), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n71_));
