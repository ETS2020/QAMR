...
module FAU ( 
  ...
  nand3  g34(.a(x11), .b(new_n59_), .c(new_n32_), .O(new_n60_));
  nand2  g35(.a(new_n33_), .b(x01), .O(new_n61_));
  ...
  nand3  g41(.a(x11), .b(new_n66_), .c(new_n32_), .O(new_n67_));
  ...
  nand4  g46(.a(new_n34_), .b(new_n51_), .c(new_n27_), .d(x02), .O(new_n72_));
  ...
  nand2  g50(.a(new_n26_), .b(new_n30_), .O(new_n76_));
  nand3  g51(.a(new_n51_), .b(x05), .c(new_n36_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(new_n76_), .c(new_n34_), .O(z07));
  nand4  g53(.a(x13), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n79_));
  nand3  g54(.a(new_n51_), .b(new_n27_), .c(x02), .O(new_n80_));
