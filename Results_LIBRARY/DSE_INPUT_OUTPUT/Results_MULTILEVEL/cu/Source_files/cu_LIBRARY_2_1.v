...
module FAU ( 
  ...
  nor3   g23(.a(x02), .b(new_n44_), .c(new_n32_), .O(new_n50_));
  ...
  oai21  g31(.a(new_n57_), .b(new_n53_), .c(new_n44_), .O(new_n58_));
  ...
  nand3  g39(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n66_));
  ...
  nand3  g44(.a(new_n43_), .b(x05), .c(new_n27_), .O(new_n71_));
