...
module FAU ( 
  ...
  oai21  g09(.a(new_n29_), .b(new_n26_), .c(new_n34_), .O(z00));
  nand3  g10(.a(x05), .b(new_n32_), .c(new_n30_), .O(new_n36_));
  nand4  g11(.a(new_n27_), .b(x04), .c(x02), .d(x01), .O(new_n37_));
  aoi21  g12(.a(new_n37_), .b(new_n36_), .c(x03), .O(z01));
  inv1   g13(.a(x00), .O(new_n39_));
  inv1   g14(.a(x13), .O(new_n40_));
  nand3  g15(.a(new_n40_), .b(x05), .c(new_n32_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nand3  g17(.a(new_n42_), .b(new_n31_), .c(new_n39_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n30_), .c(x01), .O(z02));
  nand3  g19(.a(new_n42_), .b(new_n31_), .c(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n30_), .c(x01), .O(z03));
  nand2  g21(.a(x02), .b(new_n26_), .O(new_n47_));
  nand3  g22(.a(new_n30_), .b(x01), .c(new_n39_), .O(new_n48_));
  nand4  g23(.a(new_n40_), .b(x05), .c(new_n32_), .d(new_n31_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(z04));
  nand3  g25(.a(new_n30_), .b(x01), .c(x00), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n49_), .c(new_n47_), .O(z05));
