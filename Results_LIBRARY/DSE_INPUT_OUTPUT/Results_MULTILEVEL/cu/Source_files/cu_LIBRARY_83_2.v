...
module FAU ( 
  ...
  nor2   g13(.a(x04), .b(new_n30_), .O(z05));
  ...
  nor2   g31(.a(x10), .b(new_n30_), .O(new_n58_));
  oai21  g32(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  aoi21  g33(.a(new_n59_), .b(new_n55_), .c(new_n45_), .O(new_n60_));
  nand4  g34(.a(new_n60_), .b(new_n52_), .c(new_n51_), .d(x05), .O(new_n61_));
  nand3  g35(.a(new_n45_), .b(new_n35_), .c(x02), .O(new_n62_));
  ...
  nand4  g39(.a(new_n45_), .b(x05), .c(new_n26_), .d(new_n29_), .O(new_n66_));
  aoi21  g40(.a(new_n66_), .b(new_n30_), .c(x04), .O(z07));
  ...
  nor3   g46(.a(z05), .b(new_n45_), .c(new_n72_), .O(z09));
