...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x11), .c(x05), .d(new_n36_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  nand4  g20(.a(new_n26_), .b(new_n30_), .c(new_n32_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x11), .c(x05), .d(new_n36_), .O(new_n48_));
  ...
  nand4  g27(.a(new_n52_), .b(new_n50_), .c(x05), .d(new_n36_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nor3   g29(.a(x02), .b(new_n32_), .c(new_n41_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n56_));
  nor2   g31(.a(new_n56_), .b(x13), .O(z05));
  inv1   g32(.a(x07), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  inv1   g34(.a(x09), .O(new_n60_));
  nand3  g35(.a(x11), .b(new_n60_), .c(new_n32_), .O(new_n61_));
  nand2  g36(.a(new_n33_), .b(x01), .O(new_n62_));
  ...
  nand3  g42(.a(x11), .b(new_n67_), .c(new_n32_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n41_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n64_), .c(new_n50_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n72_));
  nand4  g47(.a(new_n34_), .b(new_n50_), .c(new_n27_), .d(x02), .O(new_n73_));
  ...
  nand2  g51(.a(new_n26_), .b(new_n30_), .O(new_n77_));
  nand3  g52(.a(new_n50_), .b(x05), .c(new_n36_), .O(new_n78_));
  oai21  g53(.a(new_n78_), .b(new_n77_), .c(new_n34_), .O(z07));
  nand4  g54(.a(x13), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n80_));
  nand3  g55(.a(new_n50_), .b(new_n27_), .c(x02), .O(new_n81_));
  ...
  nand4  g62(.a(new_n87_), .b(new_n34_), .c(x06), .d(new_n26_), .O(new_n88_));
