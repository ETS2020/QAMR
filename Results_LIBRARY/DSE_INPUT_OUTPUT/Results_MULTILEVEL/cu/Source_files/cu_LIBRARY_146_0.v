...
module FAU ( 
  ...
  nand4  g38(.a(new_n63_), .b(new_n34_), .c(x05), .d(new_n29_), .O(new_n64_));
  nand3  g39(.a(new_n35_), .b(new_n30_), .c(x02), .O(new_n65_));
  ...
  nand3  g43(.a(new_n31_), .b(new_n26_), .c(new_n29_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(x07), .c(x13), .O(z07));
  inv1   g45(.a(x12), .O(new_n71_));
  nand4  g46(.a(x13), .b(new_n71_), .c(x05), .d(new_n29_), .O(new_n72_));
  ...
  nand2  g51(.a(new_n76_), .b(new_n36_), .O(z09));
  nand2  g52(.a(x05), .b(x02), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n36_), .c(x06), .d(new_n26_), .O(new_n79_));
