...
module FAU ( 
  ...
  nand3  g18(.a(new_n43_), .b(new_n35_), .c(new_n26_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n33_), .O(z02));
  inv1   g20(.a(x13), .O(new_n46_));
  nand4  g21(.a(new_n26_), .b(new_n30_), .c(new_n41_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n46_), .c(x05), .d(new_n35_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  nand4  g25(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n40_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x07), .c(x05), .d(new_n35_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nor2   g29(.a(x03), .b(x02), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n43_), .c(new_n35_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x07), .c(new_n41_), .O(z05));
  ...
  nand4  g42(.a(new_n67_), .b(x05), .c(new_n30_), .d(new_n41_), .O(new_n68_));
  ...
  nand3  g49(.a(new_n46_), .b(new_n27_), .c(x02), .O(new_n75_));
