...
module FAU ( 
  ...
  nand2  g11(.a(x03), .b(x01), .O(new_n37_));
  ...
  oai21  g18(.a(new_n43_), .b(new_n41_), .c(new_n37_), .O(z02));
  ...
  nand4  g24(.a(new_n42_), .b(new_n27_), .c(new_n29_), .d(new_n39_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n26_), .c(new_n40_), .O(z04));
  nor3   g26(.a(x02), .b(new_n40_), .c(new_n39_), .O(new_n52_));
  ...
  nand4  g39(.a(new_n45_), .b(new_n30_), .c(new_n26_), .d(x02), .O(new_n65_));
  ...
  nand4  g43(.a(x05), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x13), .O(z07));
  nand4  g45(.a(x13), .b(new_n56_), .c(x05), .d(new_n29_), .O(new_n71_));
  nand3  g46(.a(new_n45_), .b(new_n30_), .c(x02), .O(new_n72_));
  ...
  nand2  g51(.a(new_n76_), .b(new_n37_), .O(z09));
