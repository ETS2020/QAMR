...
module FAU ( 
  ...
  nand4  g23(.a(new_n35_), .b(new_n30_), .c(new_n48_), .d(x00), .O(new_n49_));
  ...
  nand4  g28(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n53_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n43_), .c(x05), .d(new_n28_), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(z04));
  nor3   g32(.a(x02), .b(new_n48_), .c(new_n53_), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n59_));
  nor2   g34(.a(new_n59_), .b(x13), .O(z05));
  inv1   g35(.a(x07), .O(new_n61_));
  inv1   g36(.a(x12), .O(new_n62_));
  nor2   g37(.a(x09), .b(x01), .O(new_n63_));
  nor2   g38(.a(x11), .b(new_n48_), .O(new_n64_));
  ...
  nand3  g45(.a(new_n26_), .b(new_n68_), .c(x01), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(new_n72_));
  aoi21  g47(.a(new_n70_), .b(new_n53_), .c(new_n72_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n65_), .c(new_n43_), .O(new_n74_));
  ...
  nand2  g53(.a(new_n78_), .b(new_n34_), .O(z06));
  oai21  g54(.a(new_n44_), .b(new_n41_), .c(new_n34_), .O(z07));
  nand4  g55(.a(x13), .b(new_n62_), .c(x05), .d(new_n30_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n76_), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n83_));
  ...
  nand2  g63(.a(new_n88_), .b(new_n34_), .O(z10));
endmodule
