...
module FAU ( 
  ...
  inv1   g13(.a(x13), .O(new_n41_));
  inv1   g14(.a(x00), .O(new_n42_));
  inv1   g15(.a(x03), .O(new_n43_));
  nand4  g16(.a(new_n43_), .b(new_n30_), .c(x01), .d(new_n42_), .O(new_n44_));
  inv1   g17(.a(new_n44_), .O(new_n45_));
  nand4  g18(.a(new_n45_), .b(new_n41_), .c(x05), .d(new_n31_), .O(new_n46_));
  inv1   g19(.a(new_n46_), .O(z04));
  nand2  g20(.a(x01), .b(x00), .O(new_n48_));
  nor2   g21(.a(new_n48_), .b(x02), .O(new_n49_));
  nand4  g22(.a(new_n49_), .b(x05), .c(new_n31_), .d(new_n43_), .O(new_n50_));
  nor2   g23(.a(new_n50_), .b(x13), .O(z05));
  inv1   g24(.a(x07), .O(new_n52_));
  inv1   g25(.a(x12), .O(new_n53_));
  inv1   g26(.a(x10), .O(new_n54_));
  nand2  g27(.a(new_n54_), .b(new_n42_), .O(new_n55_));
  inv1   g28(.a(x11), .O(new_n56_));
  nand2  g29(.a(new_n56_), .b(x00), .O(new_n57_));
  aoi21  g30(.a(new_n57_), .b(new_n55_), .c(new_n41_), .O(new_n58_));
  nand4  g31(.a(new_n58_), .b(new_n53_), .c(new_n52_), .d(x05), .O(new_n59_));
  nand3  g32(.a(new_n41_), .b(new_n26_), .c(x02), .O(new_n60_));
  oai21  g33(.a(new_n59_), .b(x02), .c(new_n60_), .O(new_n61_));
  nand3  g34(.a(new_n61_), .b(x04), .c(new_n43_), .O(new_n62_));
  nand2  g35(.a(new_n62_), .b(new_n28_), .O(z06));
  nand4  g36(.a(new_n41_), .b(new_n31_), .c(new_n43_), .d(new_n30_), .O(new_n64_));
  aoi21  g37(.a(new_n64_), .b(x01), .c(new_n26_), .O(z07));
  nand2  g38(.a(new_n30_), .b(x01), .O(new_n66_));
  nand3  g39(.a(x13), .b(new_n53_), .c(x05), .O(new_n67_));
  ...
  nor3   g44(.a(new_n27_), .b(new_n41_), .c(new_n71_), .O(z09));
  nand2  g45(.a(new_n66_), .b(x05), .O(new_n73_));
  nand3  g46(.a(new_n73_), .b(x06), .c(new_n43_), .O(new_n74_));
