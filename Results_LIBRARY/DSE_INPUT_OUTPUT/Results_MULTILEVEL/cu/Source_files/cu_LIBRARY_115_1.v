...
module FAU ( 
  ...
  nor2   g07(.a(new_n32_), .b(x10), .O(new_n33_));
  ...
  nand3  g23(.a(new_n29_), .b(x01), .c(new_n47_), .O(new_n49_));
  ...
  aoi21  g33(.a(new_n58_), .b(new_n56_), .c(new_n47_), .O(new_n59_));
  nor3   g34(.a(x08), .b(x01), .c(x00), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n59_), .c(new_n32_), .O(new_n61_));
  inv1   g36(.a(x10), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(x01), .c(new_n47_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n61_), .c(new_n42_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n54_), .c(x05), .d(new_n29_), .O(new_n65_));
  nand3  g40(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n66_));
  ...
  nand4  g44(.a(x13), .b(new_n32_), .c(x05), .d(new_n29_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n66_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n26_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n34_), .O(z08));
  inv1   g48(.a(x06), .O(new_n74_));
  nor3   g49(.a(new_n33_), .b(new_n42_), .c(new_n74_), .O(z09));
  nand2  g50(.a(x05), .b(x02), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n34_), .c(x06), .d(new_n26_), .O(new_n77_));
