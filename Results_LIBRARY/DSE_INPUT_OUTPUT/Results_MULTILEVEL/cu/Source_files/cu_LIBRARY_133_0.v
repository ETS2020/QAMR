...
module FAU ( 
  ...
  nand4  g22(.a(new_n33_), .b(new_n40_), .c(new_n35_), .d(x02), .O(new_n48_));
  inv1   g23(.a(x07), .O(new_n49_));
  inv1   g24(.a(x12), .O(new_n50_));
  nor2   g25(.a(x09), .b(x01), .O(new_n51_));
  inv1   g26(.a(x01), .O(new_n52_));
  nor2   g27(.a(x11), .b(new_n52_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n51_), .c(x00), .O(new_n54_));
  inv1   g29(.a(x00), .O(new_n55_));
  inv1   g30(.a(x10), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(x01), .c(new_n55_), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(new_n54_), .c(new_n40_), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n50_), .c(new_n49_), .d(x05), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(x02), .c(new_n48_), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(x04), .c(new_n34_), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(z06));
  nand2  g37(.a(new_n42_), .b(new_n33_), .O(z07));
  nand4  g38(.a(x13), .b(new_n50_), .c(x05), .d(new_n29_), .O(new_n64_));
  nand3  g39(.a(new_n40_), .b(new_n35_), .c(x02), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n33_), .c(x04), .d(new_n34_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n33_), .O(z09));
  nand2  g45(.a(x05), .b(x02), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n33_), .c(x06), .d(new_n34_), .O(new_n72_));
