...
module FAU ( 
  ...
  nand2  g13(.a(x12), .b(new_n28_), .O(new_n39_));
  ...
  nand4  g23(.a(new_n48_), .b(new_n44_), .c(x05), .d(new_n34_), .O(new_n49_));
  ...
  nand4  g37(.a(new_n62_), .b(new_n30_), .c(new_n55_), .d(x05), .O(new_n63_));
  ...
  nand4  g44(.a(x13), .b(new_n30_), .c(x05), .d(new_n27_), .O(new_n70_));
