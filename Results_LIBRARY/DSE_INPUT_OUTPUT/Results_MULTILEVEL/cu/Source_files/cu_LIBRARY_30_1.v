...
module FAU ( 
  ...
  nand3  g37(.a(new_n62_), .b(new_n44_), .c(x00), .O(new_n63_));
  oai21  g38(.a(new_n61_), .b(x00), .c(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(x13), .c(new_n58_), .d(x11), .O(new_n65_));
  ...
  nand3  g50(.a(x13), .b(new_n58_), .c(x11), .O(new_n76_));
  ...
  aoi21  g55(.a(x11), .b(new_n80_), .c(new_n43_), .O(z09));
