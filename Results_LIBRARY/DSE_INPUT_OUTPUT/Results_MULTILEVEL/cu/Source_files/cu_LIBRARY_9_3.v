...
module FAU ( 
  ...
  aoi21  g16(.a(new_n41_), .b(new_n30_), .c(new_n34_), .O(z02));
  nand4  g17(.a(new_n26_), .b(new_n29_), .c(new_n39_), .d(x00), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n30_), .c(x05), .d(new_n27_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z03));
  nand4  g21(.a(new_n40_), .b(new_n29_), .c(x01), .d(new_n38_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n30_), .c(new_n34_), .O(z04));
  nand4  g23(.a(new_n26_), .b(new_n29_), .c(x01), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n30_), .c(x05), .d(new_n27_), .O(new_n51_));
  ...
  aoi21  g35(.a(new_n60_), .b(new_n57_), .c(new_n54_), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(new_n53_), .c(x05), .d(new_n29_), .O(new_n62_));
  nand3  g37(.a(new_n54_), .b(new_n34_), .c(x02), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x04), .c(new_n26_), .O(new_n65_));
  nand2  g40(.a(x07), .b(x05), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(z06));
  nand4  g42(.a(new_n54_), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n30_), .c(new_n34_), .O(z07));
  nand4  g44(.a(x13), .b(new_n53_), .c(x05), .d(new_n29_), .O(new_n70_));
  ...
  nand2  g49(.a(new_n74_), .b(new_n66_), .O(z09));
  oai21  g50(.a(x07), .b(x02), .c(x05), .O(new_n76_));
