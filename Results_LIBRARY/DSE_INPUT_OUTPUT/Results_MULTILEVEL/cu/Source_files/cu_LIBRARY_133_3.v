...
module FAU ( 
  ...
  aoi21  g22(.a(new_n46_), .b(new_n40_), .c(new_n41_), .O(z04));
  inv1   g23(.a(x13), .O(new_n49_));
  nand4  g24(.a(new_n26_), .b(new_n49_), .c(new_n35_), .d(x02), .O(new_n50_));
  inv1   g25(.a(x07), .O(new_n51_));
  inv1   g26(.a(x12), .O(new_n52_));
  nor2   g27(.a(x08), .b(x01), .O(new_n53_));
  nor2   g28(.a(x10), .b(new_n41_), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n53_), .c(new_n40_), .O(new_n55_));
  inv1   g30(.a(x09), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n41_), .c(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(new_n55_), .c(new_n49_), .O(new_n58_));
  ...
  nand2  g37(.a(new_n46_), .b(new_n26_), .O(z07));
  nand4  g38(.a(x13), .b(new_n52_), .c(x05), .d(new_n30_), .O(new_n64_));
  nand3  g39(.a(new_n49_), .b(new_n35_), .c(x02), .O(new_n65_));
  ...
  nand4  g46(.a(new_n71_), .b(new_n26_), .c(x06), .d(new_n34_), .O(new_n72_));
