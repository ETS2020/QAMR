...
module FAU ( 
  ...
  nor2   g06(.a(x10), .b(x08), .O(new_n32_));
  ...
  nand3  g22(.a(new_n30_), .b(x01), .c(new_n40_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n44_), .c(new_n33_), .O(z04));
  nor2   g24(.a(new_n32_), .b(x13), .O(new_n50_));
  ...
  nor2   g28(.a(new_n53_), .b(new_n40_), .O(z05));
  inv1   g29(.a(x07), .O(new_n55_));
  inv1   g30(.a(x12), .O(new_n56_));
  inv1   g31(.a(x08), .O(new_n57_));
  nand3  g32(.a(x10), .b(new_n57_), .c(new_n41_), .O(new_n58_));
  inv1   g33(.a(x10), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(x08), .c(x01), .O(new_n60_));
  ...
  nand3  g50(.a(new_n43_), .b(new_n27_), .c(x02), .O(new_n76_));
  ...
  nor3   g55(.a(new_n32_), .b(new_n43_), .c(new_n80_), .O(z09));
