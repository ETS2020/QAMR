...
module FAU ( 
  ...
  nand3  g18(.a(new_n29_), .b(new_n32_), .c(x00), .O(new_n44_));
  ...
  aoi21  g24(.a(new_n49_), .b(x00), .c(new_n32_), .O(z05));
  inv1   g25(.a(x00), .O(new_n51_));
  nand3  g26(.a(new_n48_), .b(x05), .c(x04), .O(new_n52_));
  ...
  nand4  g46(.a(x13), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n72_));
