...
module FAU ( 
  ...
  nor3   g24(.a(x02), .b(new_n26_), .c(new_n50_), .O(new_n51_));
  nand4  g25(.a(new_n51_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n52_));
  nor2   g26(.a(new_n52_), .b(x13), .O(z05));
  nand4  g27(.a(x05), .b(x04), .c(new_n35_), .d(new_n30_), .O(new_n54_));
  ...
  oai21  g32(.a(new_n58_), .b(new_n54_), .c(new_n26_), .O(new_n59_));
  nand2  g33(.a(new_n59_), .b(new_n50_), .O(new_n60_));
  inv1   g34(.a(x09), .O(new_n61_));
  nand3  g35(.a(new_n61_), .b(new_n26_), .c(x00), .O(new_n62_));
  ...
  nand3  g40(.a(new_n44_), .b(new_n36_), .c(x02), .O(new_n67_));
  oai21  g41(.a(new_n66_), .b(x02), .c(new_n67_), .O(new_n68_));
  nand3  g42(.a(new_n68_), .b(x04), .c(new_n35_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n60_), .O(z06));
  nor2   g44(.a(new_n27_), .b(x13), .O(new_n71_));
  nand4  g45(.a(new_n71_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n72_));
  ...
  nand4  g54(.a(new_n80_), .b(new_n34_), .c(x06), .d(new_n35_), .O(new_n81_));
