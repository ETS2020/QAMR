...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(x13), .O(z02));
  inv1   g19(.a(x01), .O(new_n45_));
  nand4  g20(.a(new_n35_), .b(new_n29_), .c(new_n45_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n31_), .c(x05), .d(new_n26_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand3  g25(.a(x05), .b(new_n35_), .c(new_n29_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(x01), .c(new_n50_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n31_), .c(x04), .O(z04));
  nor3   g29(.a(x02), .b(new_n45_), .c(new_n50_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n56_));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n62_), .c(new_n31_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n67_));
  nand3  g42(.a(new_n31_), .b(new_n37_), .c(x02), .O(new_n68_));
  ...
  aoi21  g46(.a(new_n51_), .b(new_n31_), .c(x04), .O(z07));
  nand2  g47(.a(x13), .b(new_n59_), .O(new_n73_));
  nand4  g48(.a(new_n31_), .b(new_n37_), .c(x04), .d(x02), .O(new_n74_));
  oai21  g49(.a(new_n73_), .b(new_n32_), .c(new_n74_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n35_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n27_), .O(z08));
  inv1   g52(.a(x06), .O(new_n78_));
  aoi21  g53(.a(new_n78_), .b(x04), .c(new_n31_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n27_), .c(x06), .d(new_n35_), .O(new_n81_));
