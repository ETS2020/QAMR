...
module FAU ( 
  ...
  nand3  g19(.a(new_n44_), .b(new_n29_), .c(new_n35_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n43_), .c(new_n36_), .O(z02));
  inv1   g21(.a(x13), .O(new_n47_));
  nand4  g22(.a(new_n35_), .b(new_n31_), .c(new_n26_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n47_), .c(x05), .d(new_n29_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nor3   g26(.a(x03), .b(x02), .c(x00), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(new_n44_), .c(new_n29_), .O(new_n53_));
  ...
  nand3  g43(.a(new_n47_), .b(new_n37_), .c(x02), .O(new_n69_));
  ...
  nor2   g47(.a(new_n28_), .b(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n60_), .c(x05), .d(new_n31_), .O(new_n76_));
  ...
  aoi21  g54(.a(new_n47_), .b(new_n26_), .c(new_n27_), .O(z09));
  nand2  g55(.a(x05), .b(x02), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(x06), .c(new_n35_), .d(new_n26_), .O(new_n82_));
