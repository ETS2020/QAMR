...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n42_), .c(new_n28_), .d(new_n41_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n26_), .c(x01), .O(z02));
  nand4  g20(.a(new_n43_), .b(new_n42_), .c(new_n28_), .d(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n26_), .c(x01), .O(z03));
  inv1   g22(.a(x13), .O(new_n48_));
  nand4  g23(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n41_), .O(new_n49_));
  ...
  nand3  g28(.a(new_n43_), .b(new_n28_), .c(new_n35_), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n53_), .c(new_n34_), .O(z05));
  ...
  nand3  g39(.a(new_n64_), .b(new_n62_), .c(new_n59_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(x13), .c(new_n57_), .d(new_n56_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x05), .c(new_n30_), .O(new_n68_));
  nand3  g43(.a(new_n48_), .b(new_n36_), .c(x02), .O(new_n69_));
  ...
  nor2   g47(.a(new_n27_), .b(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n69_), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n78_));
