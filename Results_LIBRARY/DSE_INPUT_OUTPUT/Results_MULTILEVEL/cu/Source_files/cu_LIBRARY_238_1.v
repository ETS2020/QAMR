...
module FAU ( 
  ...
  nand4  g10(.a(new_n30_), .b(new_n28_), .c(x04), .d(x02), .O(new_n36_));
  ...
  nand2  g15(.a(x06), .b(new_n28_), .O(new_n41_));
  ...
  nand4  g36(.a(new_n44_), .b(new_n30_), .c(new_n28_), .d(x02), .O(new_n62_));
  ...
  nand3  g41(.a(new_n44_), .b(x05), .c(new_n34_), .O(new_n67_));
  ...
  nand4  g50(.a(x06), .b(x05), .c(new_n26_), .d(new_n27_), .O(new_n76_));
