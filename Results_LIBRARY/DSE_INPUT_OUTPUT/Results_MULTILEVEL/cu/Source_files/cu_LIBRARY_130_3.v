...
module FAU ( 
  ...
  nand4  g47(.a(new_n68_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x02), .O(z07));
  nand4  g49(.a(x13), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n75_));
  nand3  g50(.a(new_n45_), .b(new_n27_), .c(x02), .O(new_n76_));
