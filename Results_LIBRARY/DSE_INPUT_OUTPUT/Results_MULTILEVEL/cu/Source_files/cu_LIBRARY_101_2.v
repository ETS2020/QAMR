...
module FAU ( 
  ...
  nor2   g20(.a(x13), .b(new_n36_), .O(new_n46_));
  nand3  g21(.a(new_n46_), .b(new_n29_), .c(new_n35_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n27_), .O(z03));
  nor3   g23(.a(x03), .b(x02), .c(x00), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n46_), .c(new_n29_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x06), .c(new_n44_), .O(z04));
  nand4  g26(.a(new_n35_), .b(new_n31_), .c(x01), .d(x00), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x06), .c(x05), .d(new_n29_), .O(new_n54_));
  ...
  nand3  g36(.a(new_n61_), .b(x06), .c(x01), .O(new_n62_));
  ...
  nand3  g43(.a(new_n68_), .b(x06), .c(x01), .O(new_n69_));
  ...
  nand3  g49(.a(new_n74_), .b(new_n36_), .c(x02), .O(new_n75_));
  ...
  nand4  g53(.a(new_n74_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n79_));
  nor2   g54(.a(new_n79_), .b(x02), .O(z07));
  nand4  g55(.a(x13), .b(new_n57_), .c(x05), .d(new_n31_), .O(new_n81_));
  nand3  g56(.a(new_n58_), .b(new_n36_), .c(x02), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand4  g58(.a(new_n83_), .b(new_n27_), .c(x04), .d(new_n35_), .O(new_n84_));
  inv1   g59(.a(new_n84_), .O(z08));
  nor2   g60(.a(new_n58_), .b(new_n26_), .O(z09));
