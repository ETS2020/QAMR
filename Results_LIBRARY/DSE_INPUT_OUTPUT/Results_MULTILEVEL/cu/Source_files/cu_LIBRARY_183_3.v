...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(x05), .c(new_n37_), .d(new_n26_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(x13), .O(z02));
  inv1   g19(.a(x13), .O(new_n45_));
  nand4  g20(.a(new_n26_), .b(new_n30_), .c(new_n33_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n45_), .c(x05), .d(new_n37_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  nand4  g24(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n32_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n45_), .c(x05), .d(new_n37_), .O(new_n52_));
  ...
  oai21  g33(.a(new_n58_), .b(new_n54_), .c(new_n33_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(x00), .O(new_n60_));
  inv1   g35(.a(x08), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n33_), .c(new_n32_), .O(new_n62_));
  ...
  nor2   g45(.a(z05), .b(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n37_), .d(new_n26_), .O(new_n72_));
  ...
  nand4  g50(.a(new_n75_), .b(new_n35_), .c(x04), .d(new_n26_), .O(new_n76_));
