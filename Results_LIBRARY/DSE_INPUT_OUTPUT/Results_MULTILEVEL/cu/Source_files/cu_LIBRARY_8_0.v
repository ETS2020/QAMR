...
module FAU ( 
  ...
  nand4  g13(.a(new_n38_), .b(new_n37_), .c(new_n33_), .d(new_n26_), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(x05), .c(x01), .O(z02));
  ...
  nand4  g24(.a(new_n37_), .b(x05), .c(new_n33_), .d(new_n26_), .O(new_n50_));
  ...
  nor3   g58(.a(new_n46_), .b(new_n37_), .c(new_n83_), .O(z09));
  nand2  g59(.a(x05), .b(x02), .O(new_n85_));
  nand3  g60(.a(new_n85_), .b(x06), .c(new_n26_), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(new_n47_), .O(z10));
endmodule
