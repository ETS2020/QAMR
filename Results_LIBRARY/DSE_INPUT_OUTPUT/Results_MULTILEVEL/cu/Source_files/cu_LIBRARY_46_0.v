...
module FAU ( 
  ...
  aoi21  g20(.a(new_n45_), .b(x07), .c(x01), .O(z02));
  nand3  g21(.a(new_n44_), .b(new_n41_), .c(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(x07), .c(x01), .O(z03));
  ...
  nand3  g36(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n62_));
  ...
  inv1   g40(.a(new_n41_), .O(new_n66_));
  oai21  g41(.a(new_n43_), .b(new_n66_), .c(new_n33_), .O(z07));
  ...
  nor3   g47(.a(new_n32_), .b(new_n42_), .c(new_n72_), .O(z09));
