...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(x11), .c(x05), .d(new_n27_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand3  g28(.a(new_n43_), .b(x05), .c(new_n27_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x11), .c(new_n41_), .O(z05));
  ...
  oai21  g49(.a(new_n54_), .b(new_n74_), .c(new_n33_), .O(z07));
  ...
  nand2  g56(.a(new_n33_), .b(x13), .O(new_n82_));
