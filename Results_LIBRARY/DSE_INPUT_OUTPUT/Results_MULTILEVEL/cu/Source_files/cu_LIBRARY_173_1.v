...
module FAU ( 
  ...
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(new_n30_), .d(x05), .O(new_n68_));
  nand3  g43(.a(new_n53_), .b(new_n35_), .c(x02), .O(new_n69_));
  ...
  nand4  g48(.a(new_n73_), .b(new_n30_), .c(x05), .d(new_n27_), .O(new_n74_));
  ...
  nand2  g53(.a(new_n78_), .b(new_n40_), .O(z08));
  inv1   g54(.a(x06), .O(new_n80_));
  nor3   g55(.a(new_n39_), .b(new_n53_), .c(new_n80_), .O(z09));
  nand2  g56(.a(x05), .b(x02), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(new_n40_), .c(x06), .d(new_n26_), .O(new_n83_));
