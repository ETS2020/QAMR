...
module FAU ( 
  ...
  nand3  g06(.a(new_n31_), .b(x08), .c(x05), .O(new_n32_));
  ...
  nand4  g20(.a(new_n45_), .b(x08), .c(x05), .d(new_n30_), .O(new_n46_));
  ...
  nand4  g48(.a(new_n73_), .b(x08), .c(x05), .d(new_n30_), .O(new_n74_));
  ...
  oai21  g56(.a(new_n26_), .b(x02), .c(x05), .O(new_n82_));
