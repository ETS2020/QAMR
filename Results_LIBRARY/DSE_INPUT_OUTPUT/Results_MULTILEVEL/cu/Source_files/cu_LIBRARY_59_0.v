...
module FAU ( 
  ...
  nand4  g25(.a(new_n51_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n52_));
  nor2   g26(.a(new_n52_), .b(x13), .O(z05));
  nand4  g27(.a(new_n34_), .b(new_n41_), .c(new_n35_), .d(x02), .O(new_n54_));
  ...
  nand3  g34(.a(new_n60_), .b(x01), .c(new_n50_), .O(new_n61_));
  ...
  nand3  g38(.a(new_n64_), .b(x04), .c(new_n33_), .O(new_n65_));
  inv1   g39(.a(new_n65_), .O(z06));
  nand2  g40(.a(new_n48_), .b(new_n34_), .O(z07));
  nand4  g41(.a(x13), .b(new_n56_), .c(x05), .d(new_n29_), .O(new_n68_));
  nand3  g42(.a(new_n41_), .b(new_n35_), .c(x02), .O(new_n69_));
  ...
  nand4  g49(.a(new_n75_), .b(new_n34_), .c(x06), .d(new_n33_), .O(new_n76_));
