...
module FAU ( 
  ...
  nand4  g28(.a(x05), .b(x04), .c(new_n33_), .d(new_n29_), .O(new_n55_));
  ...
  nand3  g43(.a(new_n69_), .b(x04), .c(new_n33_), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n61_), .O(z06));
  nand2  g45(.a(new_n33_), .b(new_n29_), .O(new_n72_));
  nand3  g46(.a(new_n41_), .b(x05), .c(new_n27_), .O(new_n73_));
  oai21  g47(.a(new_n73_), .b(new_n72_), .c(new_n34_), .O(z07));
  ...
  nor3   g53(.a(new_n26_), .b(new_n41_), .c(new_n79_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n81_));
  nand4  g55(.a(new_n81_), .b(new_n34_), .c(x06), .d(new_n33_), .O(new_n82_));
