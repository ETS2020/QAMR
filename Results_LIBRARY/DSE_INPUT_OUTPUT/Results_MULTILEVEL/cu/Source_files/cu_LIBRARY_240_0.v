...
module FAU ( 
  ...
  nand4  g17(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n43_), .O(new_n44_));
  ...
  nand4  g39(.a(new_n27_), .b(new_n26_), .c(new_n29_), .d(x01), .O(new_n66_));
  nor3   g40(.a(new_n66_), .b(x13), .c(new_n34_), .O(z07));
  ...
  nor3   g46(.a(z03), .b(new_n42_), .c(new_n72_), .O(z09));
  nand2  g47(.a(x05), .b(x02), .O(new_n74_));
  nand4  g48(.a(new_n74_), .b(new_n39_), .c(x06), .d(new_n26_), .O(new_n75_));
