...
module FAU ( 
  ...
  nand4  g25(.a(new_n34_), .b(new_n30_), .c(x01), .d(new_n40_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n50_), .c(x05), .d(new_n28_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nand3  g29(.a(new_n43_), .b(x05), .c(new_n28_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n34_), .c(new_n30_), .d(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(new_n50_), .c(new_n41_), .O(z05));
  ...
  nand3  g42(.a(new_n67_), .b(new_n41_), .c(new_n40_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n66_), .c(new_n43_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n70_));
  nand4  g45(.a(new_n26_), .b(new_n43_), .c(new_n35_), .d(x02), .O(new_n71_));
  ...
  nand2  g49(.a(new_n34_), .b(new_n30_), .O(new_n75_));
  oai21  g50(.a(new_n55_), .b(new_n75_), .c(new_n26_), .O(z07));
