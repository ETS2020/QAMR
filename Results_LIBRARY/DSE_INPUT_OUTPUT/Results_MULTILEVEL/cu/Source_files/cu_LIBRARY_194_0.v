...
module FAU ( 
  ...
  nand4  g21(.a(new_n33_), .b(new_n29_), .c(x01), .d(new_n46_), .O(new_n47_));
  ...
  nand4  g26(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n34_), .O(z05));
  nand4  g28(.a(x05), .b(x04), .c(new_n33_), .d(new_n29_), .O(new_n54_));
  ...
  nand2  g45(.a(new_n33_), .b(new_n29_), .O(new_n71_));
  nand3  g46(.a(new_n40_), .b(x05), .c(new_n27_), .O(new_n72_));
