...
module FAU ( 
  ...
  nor3   g09(.a(x02), .b(x01), .c(x00), .O(new_n35_));
  nand4  g10(.a(new_n35_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n36_));
  nor2   g11(.a(new_n36_), .b(x13), .O(z02));
  inv1   g12(.a(x13), .O(new_n38_));
  inv1   g13(.a(x01), .O(new_n39_));
  nand4  g14(.a(new_n26_), .b(new_n29_), .c(new_n39_), .d(x00), .O(new_n40_));
  ...
  nand4  g21(.a(new_n46_), .b(new_n38_), .c(x05), .d(new_n27_), .O(new_n47_));
  ...
  aoi21  g26(.a(new_n51_), .b(new_n29_), .c(new_n49_), .O(z05));
  ...
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n44_), .O(new_n60_));
  aoi21  g35(.a(new_n60_), .b(new_n57_), .c(new_n38_), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(new_n54_), .c(new_n53_), .d(x05), .O(new_n62_));
  nand2  g37(.a(new_n38_), .b(x02), .O(new_n63_));
  ...
  nand3  g45(.a(new_n38_), .b(new_n49_), .c(x02), .O(new_n71_));
