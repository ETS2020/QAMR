...
module FAU ( 
  ...
  nand4  g19(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n26_), .O(new_n45_));
  ...
  nand4  g25(.a(new_n50_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z05));
  nand4  g27(.a(x05), .b(x04), .c(new_n35_), .d(new_n30_), .O(new_n53_));
  ...
  nor2   g44(.a(z03), .b(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n71_));
  ...
  nor3   g52(.a(z03), .b(new_n44_), .c(new_n77_), .O(z09));
