...
module FAU ( 
  ...
  nand4  g30(.a(new_n55_), .b(new_n49_), .c(x05), .d(new_n34_), .O(new_n56_));
  ...
  nand3  g46(.a(new_n42_), .b(x05), .c(new_n34_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n71_), .c(new_n32_), .O(z07));
  nand4  g48(.a(new_n32_), .b(new_n42_), .c(new_n27_), .d(x02), .O(new_n74_));
  nand4  g49(.a(x13), .b(new_n49_), .c(x05), .d(new_n30_), .O(new_n75_));
