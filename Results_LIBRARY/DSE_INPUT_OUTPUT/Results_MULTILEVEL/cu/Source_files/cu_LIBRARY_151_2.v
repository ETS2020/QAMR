...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n43_, new_n46_, new_n47_, new_n49_, new_n50_, new_n52_,
  ...
  nor3   g22(.a(x02), .b(new_n32_), .c(new_n40_), .O(new_n49_));
  nand4  g23(.a(new_n49_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n50_));
  nor2   g24(.a(new_n50_), .b(x13), .O(z05));
  nand4  g25(.a(new_n33_), .b(new_n41_), .c(new_n27_), .d(x02), .O(new_n52_));
  inv1   g26(.a(x07), .O(new_n53_));
  inv1   g27(.a(x12), .O(new_n54_));
  nor2   g28(.a(x08), .b(x01), .O(new_n55_));
  nor2   g29(.a(x10), .b(new_n32_), .O(new_n56_));
  oai21  g30(.a(new_n56_), .b(new_n55_), .c(new_n40_), .O(new_n57_));
  inv1   g31(.a(x11), .O(new_n58_));
  nand3  g32(.a(new_n58_), .b(x01), .c(x00), .O(new_n59_));
  aoi21  g33(.a(new_n59_), .b(new_n57_), .c(new_n41_), .O(new_n60_));
  ...
  nand2  g48(.a(new_n74_), .b(new_n33_), .O(z10));
  zero   g49(.O(z03));
endmodule
