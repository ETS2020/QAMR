...
module FAU ( 
  ...
  nor2   g07(.a(x13), .b(new_n32_), .O(z04));
  ...
  nand4  g17(.a(new_n36_), .b(new_n26_), .c(new_n29_), .d(new_n42_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n32_), .c(x13), .O(z02));
  nand4  g19(.a(new_n36_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n32_), .c(x13), .O(z03));
  inv1   g21(.a(x07), .O(new_n47_));
  inv1   g22(.a(x12), .O(new_n48_));
  inv1   g23(.a(x13), .O(new_n49_));
  nor2   g24(.a(x09), .b(x01), .O(new_n50_));
  nor2   g25(.a(x11), .b(new_n32_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(x00), .O(new_n52_));
  nor2   g27(.a(x08), .b(x01), .O(new_n53_));
  nor2   g28(.a(x10), .b(new_n32_), .O(new_n54_));
  ...
  nand4  g32(.a(new_n49_), .b(new_n30_), .c(x02), .d(new_n32_), .O(new_n58_));
