...
module FAU ( 
  ...
  nand3  g23(.a(new_n30_), .b(x01), .c(new_n41_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n45_), .c(new_n34_), .O(z04));
  nor2   g25(.a(new_n33_), .b(x13), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x02), .O(z07));
  nand2  g28(.a(z07), .b(x01), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(new_n41_), .O(z05));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x12), .O(new_n57_));
  aoi21  g32(.a(x08), .b(new_n42_), .c(x00), .O(new_n58_));
  inv1   g33(.a(x09), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(new_n42_), .c(x00), .O(new_n60_));
  inv1   g35(.a(x11), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(x01), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  oai21  g38(.a(new_n63_), .b(new_n58_), .c(new_n32_), .O(new_n64_));
  oai21  g39(.a(x09), .b(x01), .c(new_n62_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x08), .c(x00), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n64_), .c(new_n44_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n68_));
  nand3  g43(.a(new_n51_), .b(new_n27_), .c(x02), .O(new_n69_));
  ...
  nand4  g50(.a(new_n75_), .b(new_n34_), .c(x04), .d(new_n26_), .O(new_n76_));
