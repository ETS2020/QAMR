...
module FAU ( 
  ...
  nand3  g34(.a(new_n59_), .b(x06), .c(new_n41_), .O(new_n60_));
  ...
  aoi21  g45(.a(new_n70_), .b(new_n64_), .c(new_n58_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n72_));
  nor2   g47(.a(new_n26_), .b(x13), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(new_n35_), .c(x02), .O(new_n74_));
  ...
  nand4  g52(.a(new_n73_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n78_));
  nor2   g53(.a(new_n78_), .b(x02), .O(z07));
  nand4  g54(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n80_));
  nand3  g55(.a(new_n58_), .b(new_n35_), .c(x02), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(new_n33_), .c(x04), .d(new_n34_), .O(new_n83_));
