...
module FAU ( 
  ...
  oai21  g29(.a(new_n54_), .b(new_n44_), .c(new_n34_), .O(z05));
  ...
  nand4  g38(.a(new_n63_), .b(x13), .c(new_n57_), .d(x09), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n66_));
  nand3  g41(.a(new_n26_), .b(new_n36_), .c(x02), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(x04), .c(new_n35_), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z06));
  nand4  g45(.a(x05), .b(new_n28_), .c(new_n35_), .d(new_n30_), .O(new_n71_));
  ...
  nand3  g51(.a(x13), .b(x09), .c(x06), .O(new_n77_));
