...
module FAU ( 
  ...
  nand4  g20(.a(new_n33_), .b(new_n29_), .c(new_n41_), .d(x00), .O(new_n46_));
  ...
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n56_));
  nor2   g31(.a(new_n56_), .b(x13), .O(z05));
  nor2   g32(.a(new_n26_), .b(x13), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(new_n35_), .c(x02), .O(new_n59_));
