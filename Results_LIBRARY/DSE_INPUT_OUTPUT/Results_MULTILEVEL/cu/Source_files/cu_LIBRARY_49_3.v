...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(new_n27_), .c(new_n30_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n44_), .c(x05), .d(new_n34_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand3  g24(.a(new_n44_), .b(x05), .c(new_n26_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n27_), .c(new_n49_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n34_), .c(new_n30_), .O(z04));
  nand3  g28(.a(new_n51_), .b(new_n27_), .c(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n34_), .c(new_n30_), .O(z05));
  ...
  nand3  g38(.a(new_n44_), .b(new_n28_), .c(x02), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(x02), .c(new_n64_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(x04), .c(new_n26_), .d(new_n30_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(z06));
  nand2  g42(.a(new_n26_), .b(new_n27_), .O(new_n68_));
  nand3  g43(.a(new_n44_), .b(x05), .c(new_n34_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n39_), .O(z07));
  nand4  g45(.a(x13), .b(new_n57_), .c(x05), .d(new_n27_), .O(new_n71_));
