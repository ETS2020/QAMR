...
module FAU ( 
  ...
  nand4  g43(.a(new_n32_), .b(new_n41_), .c(new_n30_), .d(x02), .O(new_n69_));
  ...
  nand3  g47(.a(new_n35_), .b(new_n26_), .c(new_n29_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n41_), .c(x13), .O(z07));
  ...
  nand4  g56(.a(new_n81_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n82_));
