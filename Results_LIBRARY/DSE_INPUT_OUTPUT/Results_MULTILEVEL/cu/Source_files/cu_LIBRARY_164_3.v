...
module FAU ( 
  ...
  nor2   g02(.a(new_n27_), .b(new_n26_), .O(z09));
  ...
  aoi21  g08(.a(new_n33_), .b(new_n30_), .c(z09), .O(z00));
  inv1   g09(.a(z09), .O(new_n35_));
  ...
  nand3  g41(.a(new_n27_), .b(new_n37_), .c(x02), .O(new_n67_));
  ...
  nand2  g45(.a(new_n36_), .b(new_n31_), .O(new_n71_));
  nand3  g46(.a(new_n27_), .b(x05), .c(new_n29_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n71_), .c(new_n35_), .O(z07));
  nand2  g48(.a(x05), .b(new_n31_), .O(new_n74_));
  nand3  g49(.a(x13), .b(new_n58_), .c(new_n26_), .O(new_n75_));
  ...
  nand4  g54(.a(new_n79_), .b(new_n27_), .c(x06), .d(new_n36_), .O(new_n80_));
