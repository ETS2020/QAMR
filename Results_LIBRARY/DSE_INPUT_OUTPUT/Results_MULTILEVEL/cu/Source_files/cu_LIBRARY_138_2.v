...
module FAU ( 
  ...
  aoi21  g07(.a(new_n32_), .b(new_n29_), .c(z03), .O(z00));
  ...
  nand3  g18(.a(new_n30_), .b(x01), .c(new_n26_), .O(new_n44_));
  ...
  nor3   g23(.a(x02), .b(new_n48_), .c(new_n26_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z05));
  nand4  g26(.a(x05), .b(x04), .c(new_n35_), .d(new_n30_), .O(new_n52_));
  ...
  nand2  g34(.a(new_n59_), .b(new_n48_), .O(new_n60_));
  inv1   g35(.a(x10), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(x01), .c(new_n26_), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n60_), .c(new_n45_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n55_), .c(new_n53_), .d(x05), .O(new_n64_));
  nand3  g39(.a(new_n45_), .b(new_n36_), .c(x02), .O(new_n65_));
  ...
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n70_));
