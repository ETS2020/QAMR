...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(x07), .O(new_n32_));
  ...
  nand3  g23(.a(new_n30_), .b(x01), .c(new_n39_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n43_), .c(new_n32_), .O(z04));
  nand3  g25(.a(new_n30_), .b(x01), .c(x00), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n43_), .c(new_n32_), .O(z05));
  ...
  nor2   g32(.a(x10), .b(new_n40_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(new_n39_), .O(new_n59_));
  aoi21  g34(.a(new_n59_), .b(new_n56_), .c(new_n42_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n61_));
  nand3  g36(.a(new_n42_), .b(new_n27_), .c(x02), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(x04), .c(new_n26_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n32_), .O(z06));
  nand2  g40(.a(new_n26_), .b(new_n30_), .O(new_n66_));
  nand3  g41(.a(new_n42_), .b(x05), .c(new_n34_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n66_), .c(new_n32_), .O(z07));
  nand4  g43(.a(x13), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n62_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n26_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n32_), .O(z08));
  nor2   g47(.a(x07), .b(x06), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(new_n42_), .O(z09));
  nand2  g49(.a(x05), .b(x02), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n32_), .c(x06), .d(new_n26_), .O(new_n76_));
