...
module FAU ( 
  ...
  nand4  g20(.a(new_n35_), .b(new_n30_), .c(new_n26_), .d(x00), .O(new_n46_));
  ...
  nand4  g28(.a(new_n35_), .b(new_n30_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x11), .c(x05), .d(new_n28_), .O(new_n56_));
  ...
  nand3  g38(.a(new_n63_), .b(new_n26_), .c(x00), .O(new_n64_));
  ...
  nand2  g45(.a(new_n35_), .b(new_n30_), .O(new_n71_));
  nand3  g46(.a(new_n43_), .b(x05), .c(new_n28_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n71_), .c(new_n34_), .O(z07));
