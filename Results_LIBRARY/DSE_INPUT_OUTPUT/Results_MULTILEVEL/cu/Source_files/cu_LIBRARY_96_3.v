...
module FAU ( 
  ...
  inv1   g23(.a(new_n30_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n26_), .c(new_n29_), .d(new_n39_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n44_), .c(new_n40_), .O(z04));
  nand4  g26(.a(new_n49_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n44_), .c(new_n40_), .O(z05));
  ...
  nand3  g36(.a(new_n44_), .b(new_n34_), .c(x02), .O(new_n62_));
  ...
  nand3  g42(.a(x13), .b(new_n55_), .c(x05), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n41_), .c(new_n62_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x04), .c(new_n26_), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(z08));
  nand3  g46(.a(x13), .b(x06), .c(new_n40_), .O(new_n72_));
