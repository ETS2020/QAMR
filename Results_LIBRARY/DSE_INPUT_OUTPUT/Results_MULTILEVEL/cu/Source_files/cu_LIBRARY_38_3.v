...
module FAU ( 
  ...
  nand2  g00(.a(x11), .b(x09), .O(new_n26_));
  ...
  nor3   g17(.a(new_n42_), .b(x03), .c(x02), .O(new_n43_));
  ...
  nand3  g22(.a(new_n30_), .b(x01), .c(new_n46_), .O(new_n48_));
  nand4  g23(.a(new_n41_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n48_), .c(new_n26_), .O(z04));
  nand2  g25(.a(new_n43_), .b(x01), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(new_n46_), .O(z05));
  inv1   g27(.a(x07), .O(new_n53_));
  inv1   g28(.a(x12), .O(new_n54_));
  nor2   g29(.a(x08), .b(x01), .O(new_n55_));
  nor2   g30(.a(x10), .b(new_n40_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(new_n46_), .O(new_n57_));
  inv1   g32(.a(x09), .O(new_n58_));
  aoi21  g33(.a(x11), .b(x01), .c(new_n46_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n55_), .c(new_n58_), .O(new_n60_));
  aoi21  g35(.a(x10), .b(new_n46_), .c(new_n58_), .O(new_n61_));
  nor2   g36(.a(x11), .b(x10), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(x01), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n60_), .c(new_n57_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(x13), .c(new_n54_), .d(new_n53_), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x05), .c(new_n30_), .O(new_n67_));
  nand3  g42(.a(new_n41_), .b(new_n35_), .c(x02), .O(new_n68_));
  ...
  nand2  g46(.a(new_n34_), .b(new_n30_), .O(new_n72_));
  nand3  g47(.a(new_n41_), .b(x05), .c(new_n28_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n72_), .c(new_n26_), .O(z07));
  nand4  g49(.a(x13), .b(new_n54_), .c(x05), .d(new_n30_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n68_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n26_), .c(x04), .d(new_n34_), .O(new_n77_));
