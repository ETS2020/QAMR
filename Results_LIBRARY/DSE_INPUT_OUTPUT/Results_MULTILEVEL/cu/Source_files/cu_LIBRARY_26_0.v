...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(new_n31_), .c(new_n42_), .d(new_n40_), .O(new_n52_));
  ...
  nand4  g30(.a(new_n55_), .b(x11), .c(x05), .d(new_n27_), .O(new_n56_));
  ...
  nor2   g39(.a(x11), .b(new_n41_), .O(new_n65_));
  ...
  nand4  g43(.a(new_n60_), .b(x11), .c(new_n30_), .d(x02), .O(new_n69_));
  ...
  nand4  g48(.a(new_n73_), .b(x11), .c(x05), .d(new_n27_), .O(new_n74_));
