...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(new_n45_), .c(x05), .d(new_n29_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nand4  g28(.a(x05), .b(x04), .c(new_n36_), .d(new_n31_), .O(new_n55_));
  ...
  nand3  g41(.a(new_n45_), .b(new_n37_), .c(x02), .O(new_n68_));
  ...
  nor2   g45(.a(new_n28_), .b(x13), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n73_));
  nor2   g47(.a(new_n73_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n75_));
  ...
  nand2  g53(.a(new_n79_), .b(new_n35_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n81_));
  nand4  g55(.a(new_n81_), .b(new_n35_), .c(x06), .d(new_n36_), .O(new_n82_));
