...
module FAU ( 
  ...
  nand4  g24(.a(new_n39_), .b(new_n34_), .c(x01), .d(new_n49_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n43_), .c(x05), .d(new_n35_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nor3   g28(.a(x02), .b(new_n44_), .c(new_n49_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n35_), .d(new_n39_), .O(new_n55_));
  ...
  nand4  g46(.a(new_n71_), .b(new_n58_), .c(new_n57_), .d(new_n34_), .O(new_n72_));
  nand3  g47(.a(new_n43_), .b(new_n29_), .c(x02), .O(new_n73_));
  ...
  nand2  g51(.a(new_n39_), .b(new_n34_), .O(new_n77_));
  nand3  g52(.a(new_n43_), .b(x05), .c(new_n35_), .O(new_n78_));
  oai21  g53(.a(new_n78_), .b(new_n77_), .c(new_n27_), .O(z07));
  nand2  g54(.a(x02), .b(x01), .O(new_n80_));
  nand2  g55(.a(new_n43_), .b(new_n29_), .O(new_n81_));
  nand2  g56(.a(x05), .b(new_n34_), .O(new_n82_));
  nand2  g57(.a(x13), .b(new_n58_), .O(new_n83_));
  oai22  g58(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n80_), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x04), .c(new_n39_), .O(new_n85_));
  inv1   g60(.a(new_n85_), .O(z08));
  inv1   g61(.a(x06), .O(new_n87_));
  nor3   g62(.a(new_n26_), .b(new_n43_), .c(new_n87_), .O(z09));
  oai21  g63(.a(x05), .b(new_n44_), .c(new_n82_), .O(new_n89_));
  nand3  g64(.a(new_n89_), .b(x06), .c(new_n39_), .O(new_n90_));
