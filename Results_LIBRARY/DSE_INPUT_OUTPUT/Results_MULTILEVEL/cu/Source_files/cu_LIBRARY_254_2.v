...
module FAU ( 
  ...
  nand4  g28(.a(new_n53_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nor2   g30(.a(x02), .b(new_n43_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n35_), .c(new_n26_), .d(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(new_n41_), .c(x13), .O(z05));
  ...
  nor2   g39(.a(x11), .b(new_n43_), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(new_n64_), .c(x00), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n32_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n68_));
  nand3  g43(.a(new_n32_), .b(new_n30_), .c(x02), .O(new_n69_));
  ...
  nand4  g48(.a(new_n73_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x13), .O(z07));
  nand4  g50(.a(x13), .b(new_n60_), .c(x05), .d(new_n29_), .O(new_n76_));
  nand4  g51(.a(new_n32_), .b(new_n41_), .c(new_n30_), .d(x02), .O(new_n77_));
