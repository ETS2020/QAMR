...
module FAU ( 
  ...
  aoi21  g23(.a(new_n48_), .b(x06), .c(new_n34_), .O(z03));
  nand4  g24(.a(new_n47_), .b(new_n29_), .c(x01), .d(new_n41_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x06), .c(new_n34_), .O(z04));
  ...
  nand4  g43(.a(new_n68_), .b(new_n56_), .c(x06), .d(x05), .O(new_n69_));
  inv1   g44(.a(x13), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(new_n34_), .c(x02), .O(new_n71_));
  ...
  aoi21  g50(.a(new_n75_), .b(x06), .c(new_n34_), .O(z07));
  ...
  oai21  g56(.a(new_n70_), .b(new_n38_), .c(new_n39_), .O(z09));
