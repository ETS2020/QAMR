...
module FAU ( 
  ...
  aoi21  g43(.a(new_n68_), .b(new_n63_), .c(new_n47_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n70_));
  nand4  g45(.a(new_n27_), .b(new_n47_), .c(new_n36_), .d(x02), .O(new_n71_));
  ...
  nand2  g49(.a(new_n35_), .b(new_n31_), .O(new_n75_));
  oai21  g50(.a(new_n48_), .b(new_n75_), .c(new_n27_), .O(z07));
  nand4  g51(.a(x13), .b(new_n60_), .c(x05), .d(new_n31_), .O(new_n77_));
  ...
  nor3   g57(.a(new_n28_), .b(new_n47_), .c(new_n82_), .O(z09));
