...
module FAU ( 
  ...
  aoi21  g17(.a(new_n42_), .b(x09), .c(x01), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand4  g19(.a(new_n33_), .b(new_n29_), .c(new_n44_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(x09), .c(x05), .d(new_n27_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x13), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand4  g24(.a(new_n33_), .b(new_n29_), .c(x01), .d(new_n49_), .O(new_n50_));
  ...
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n55_));
  ...
  oai21  g35(.a(new_n60_), .b(new_n59_), .c(new_n49_), .O(new_n61_));
  ...
  nor2   g44(.a(new_n26_), .b(x13), .O(new_n70_));
  ...
  nor3   g52(.a(new_n26_), .b(new_n40_), .c(new_n77_), .O(z09));
  nand2  g53(.a(x05), .b(x02), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n34_), .c(x06), .d(new_n33_), .O(new_n80_));
