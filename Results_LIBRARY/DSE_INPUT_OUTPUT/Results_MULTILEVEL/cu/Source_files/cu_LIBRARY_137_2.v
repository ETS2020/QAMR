...
module FAU ( 
  ...
  nand3  g19(.a(new_n31_), .b(x01), .c(new_n44_), .O(new_n45_));
  nor2   g20(.a(x13), .b(new_n36_), .O(new_n46_));
  nand3  g21(.a(new_n46_), .b(new_n29_), .c(new_n35_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n27_), .O(z04));
  nand4  g23(.a(new_n46_), .b(new_n29_), .c(new_n35_), .d(new_n31_), .O(new_n49_));
  ...
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(new_n44_), .O(new_n58_));
  ...
  nand4  g40(.a(new_n51_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(x02), .O(z07));
  nand4  g42(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n68_));
  nand3  g43(.a(new_n55_), .b(new_n36_), .c(x02), .O(new_n69_));
  ...
  nor3   g48(.a(z03), .b(new_n55_), .c(new_n73_), .O(z09));
