...
module FAU ( 
  ...
  nand4  g15(.a(new_n26_), .b(new_n40_), .c(x05), .d(new_n28_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nand3  g17(.a(new_n42_), .b(new_n34_), .c(new_n30_), .O(new_n43_));
  nor3   g18(.a(new_n43_), .b(x01), .c(x00), .O(z02));
  inv1   g19(.a(x01), .O(new_n45_));
  nand3  g20(.a(new_n30_), .b(new_n45_), .c(x00), .O(new_n46_));
  nand4  g21(.a(new_n40_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n46_), .c(new_n26_), .O(z03));
  ...
  nand3  g42(.a(new_n40_), .b(x05), .c(new_n28_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n67_), .c(new_n26_), .O(z07));
  nand4  g44(.a(new_n26_), .b(new_n40_), .c(new_n35_), .d(x02), .O(new_n70_));
  ...
  nand2  g53(.a(new_n78_), .b(new_n26_), .O(z10));
endmodule
