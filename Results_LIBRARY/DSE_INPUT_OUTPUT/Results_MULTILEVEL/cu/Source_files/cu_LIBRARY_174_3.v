...
module FAU ( 
  ...
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n26_), .O(z04));
  nand3  g29(.a(new_n36_), .b(x01), .c(x00), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n53_), .c(new_n26_), .O(z05));
  ...
  nand3  g42(.a(new_n67_), .b(x05), .c(new_n36_), .O(new_n68_));
  nand3  g43(.a(new_n45_), .b(new_n29_), .c(x02), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n28_), .c(x04), .d(new_n35_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z06));
  nand4  g47(.a(x05), .b(new_n32_), .c(new_n35_), .d(new_n36_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x13), .O(z07));
  nand4  g49(.a(x13), .b(new_n58_), .c(x05), .d(new_n36_), .O(new_n75_));
