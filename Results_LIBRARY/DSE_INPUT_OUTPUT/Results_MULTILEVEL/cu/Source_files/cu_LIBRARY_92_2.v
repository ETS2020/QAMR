...
module FAU ( 
  ...
  nand3  g12(.a(new_n37_), .b(new_n26_), .c(new_n27_), .O(new_n38_));
  ...
  nand3  g32(.a(new_n43_), .b(new_n29_), .c(x02), .O(new_n59_));
  oai21  g33(.a(new_n58_), .b(x02), .c(new_n59_), .O(new_n60_));
  nand4  g34(.a(new_n60_), .b(x04), .c(new_n26_), .d(new_n27_), .O(new_n61_));
  inv1   g35(.a(new_n61_), .O(z06));
  nor2   g36(.a(x02), .b(x01), .O(new_n63_));
  nand4  g37(.a(new_n63_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n64_));
  nor2   g38(.a(new_n64_), .b(x13), .O(z07));
  nand4  g39(.a(x13), .b(new_n51_), .c(x05), .d(new_n28_), .O(new_n66_));
  nand2  g40(.a(new_n66_), .b(new_n59_), .O(new_n67_));
  nand4  g41(.a(new_n67_), .b(x04), .c(new_n26_), .d(new_n27_), .O(new_n68_));
  inv1   g42(.a(new_n68_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n70_));
  oai21  g44(.a(x03), .b(new_n27_), .c(new_n70_), .O(z09));
  nand2  g45(.a(x05), .b(x02), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(x06), .c(new_n26_), .d(new_n27_), .O(new_n73_));
