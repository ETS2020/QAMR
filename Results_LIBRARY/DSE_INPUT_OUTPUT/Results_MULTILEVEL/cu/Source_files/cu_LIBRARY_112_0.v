...
module FAU ( 
  ...
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n54_));
  ...
  nand3  g40(.a(new_n58_), .b(new_n27_), .c(x02), .O(new_n66_));
  ...
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n71_));
  ...
  nor3   g52(.a(new_n32_), .b(new_n58_), .c(new_n77_), .O(z09));
