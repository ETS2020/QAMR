...
module FAU ( 
  ...
  or2    g06(.a(x10), .b(x08), .O(new_n32_));
  ...
  inv1   g19(.a(new_n32_), .O(new_n45_));
  nor3   g20(.a(new_n45_), .b(x13), .c(new_n30_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n47_));
  ...
  nand2  g40(.a(new_n26_), .b(new_n29_), .O(new_n66_));
  nand3  g41(.a(new_n42_), .b(x05), .c(new_n27_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n66_), .c(new_n32_), .O(z07));
  nand4  g43(.a(x13), .b(new_n53_), .c(x05), .d(new_n29_), .O(new_n69_));
  ...
  nor3   g48(.a(new_n45_), .b(new_n42_), .c(new_n73_), .O(z09));
  nand2  g49(.a(x05), .b(x02), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x06), .c(new_n26_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n32_), .O(z10));
endmodule
