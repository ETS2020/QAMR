...
module FAU ( 
  ...
  nand4  g25(.a(new_n50_), .b(new_n44_), .c(x05), .d(new_n29_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(x09), .c(new_n45_), .O(z04));
  nand4  g27(.a(new_n35_), .b(new_n31_), .c(x01), .d(x00), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x09), .c(x05), .d(new_n29_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nand2  g33(.a(new_n26_), .b(new_n45_), .O(new_n59_));
  ...
  nand3  g42(.a(new_n67_), .b(x09), .c(x01), .O(new_n68_));
  ...
  nand3  g48(.a(new_n73_), .b(new_n36_), .c(x02), .O(new_n74_));
  ...
  nand4  g52(.a(new_n73_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n78_));
  nor2   g53(.a(new_n78_), .b(x02), .O(z07));
  nand4  g54(.a(x13), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n80_));
  nand3  g55(.a(new_n44_), .b(new_n36_), .c(x02), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(new_n27_), .c(x04), .d(new_n35_), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z08));
  inv1   g59(.a(x06), .O(new_n85_));
  nor3   g60(.a(new_n28_), .b(new_n44_), .c(new_n85_), .O(z09));
