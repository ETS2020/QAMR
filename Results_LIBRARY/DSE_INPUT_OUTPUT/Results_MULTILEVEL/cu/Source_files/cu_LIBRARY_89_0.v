...
module FAU ( 
  ...
  aoi21  g24(.a(new_n49_), .b(x11), .c(x01), .O(z03));
  ...
  nand4  g46(.a(new_n33_), .b(new_n46_), .c(new_n35_), .d(x02), .O(new_n72_));
  ...
  nand2  g50(.a(new_n34_), .b(new_n29_), .O(new_n76_));
  oai21  g51(.a(new_n47_), .b(new_n76_), .c(new_n33_), .O(z07));
  nand4  g52(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n78_));
  nand3  g53(.a(new_n46_), .b(new_n35_), .c(x02), .O(new_n79_));
  ...
  nand2  g58(.a(new_n83_), .b(new_n33_), .O(z09));
  nand2  g59(.a(x05), .b(x02), .O(new_n85_));
  nand4  g60(.a(new_n85_), .b(new_n33_), .c(x06), .d(new_n34_), .O(new_n86_));
