...
module FAU ( 
  ...
  nor2   g12(.a(x05), .b(new_n30_), .O(new_n38_));
  inv1   g13(.a(new_n38_), .O(new_n39_));
  inv1   g14(.a(x00), .O(new_n40_));
  nand3  g15(.a(new_n27_), .b(new_n30_), .c(new_n40_), .O(new_n41_));
  ...
  nor2   g23(.a(x02), .b(x00), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n42_), .c(new_n34_), .d(new_n26_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x05), .c(new_n30_), .O(z04));
  nor3   g26(.a(x02), .b(new_n30_), .c(new_n40_), .O(new_n52_));
  ...
  nand3  g45(.a(new_n42_), .b(new_n28_), .c(x02), .O(new_n71_));
  ...
  nand2  g51(.a(x02), .b(new_n30_), .O(new_n77_));
  nand2  g52(.a(new_n42_), .b(new_n28_), .O(new_n78_));
  ...
  nor3   g58(.a(new_n38_), .b(new_n42_), .c(new_n83_), .O(z09));
  nand2  g59(.a(x05), .b(x02), .O(new_n85_));
  nand3  g60(.a(new_n85_), .b(x06), .c(new_n26_), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(new_n39_), .O(z10));
endmodule
