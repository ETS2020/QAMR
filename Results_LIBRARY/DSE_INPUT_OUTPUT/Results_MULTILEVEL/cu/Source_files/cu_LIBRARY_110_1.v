...
module FAU ( 
  ...
  nand2  g25(.a(x04), .b(new_n42_), .O(new_n51_));
  nand3  g26(.a(new_n27_), .b(x01), .c(x00), .O(new_n52_));
  nand3  g27(.a(new_n38_), .b(new_n33_), .c(new_n26_), .O(new_n53_));
  ...
  nand2  g42(.a(new_n38_), .b(new_n33_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n67_), .c(new_n51_), .O(z07));
  ...
  nand2  g49(.a(new_n74_), .b(new_n51_), .O(z09));
  nand2  g50(.a(x05), .b(x02), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n51_), .c(x06), .d(new_n26_), .O(new_n77_));
