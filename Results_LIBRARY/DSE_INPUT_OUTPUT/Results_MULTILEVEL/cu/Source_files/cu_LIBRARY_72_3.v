...
module FAU ( 
  ...
  nand3  g29(.a(new_n45_), .b(x05), .c(new_n29_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n35_), .c(new_n31_), .d(x00), .O(new_n57_));
  ...
  nand2  g46(.a(new_n71_), .b(new_n36_), .O(z06));
  nand2  g47(.a(new_n35_), .b(new_n31_), .O(new_n73_));
  oai21  g48(.a(new_n55_), .b(new_n73_), .c(new_n36_), .O(z07));
  nand4  g49(.a(x13), .b(new_n60_), .c(x05), .d(new_n31_), .O(new_n75_));
  ...
  aoi21  g53(.a(new_n45_), .b(new_n26_), .c(new_n27_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(x06), .c(new_n35_), .d(new_n26_), .O(new_n81_));
