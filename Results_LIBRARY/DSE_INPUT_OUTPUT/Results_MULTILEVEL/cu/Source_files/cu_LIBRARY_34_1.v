...
module FAU ( 
  ...
  nand4  g25(.a(new_n50_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z05));
  nand4  g27(.a(x05), .b(x04), .c(new_n26_), .d(new_n30_), .O(new_n53_));
  ...
  nand2  g44(.a(new_n26_), .b(new_n30_), .O(new_n70_));
  nand3  g45(.a(new_n44_), .b(x05), .c(new_n36_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n34_), .O(z07));
