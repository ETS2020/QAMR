...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x05), .c(new_n37_), .d(new_n35_), .O(new_n44_));
  ...
  nand4  g28(.a(new_n53_), .b(new_n46_), .c(x05), .d(new_n37_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(z04));
  nor3   g30(.a(x02), .b(new_n26_), .c(new_n51_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x05), .c(new_n37_), .d(new_n35_), .O(new_n57_));
  ...
  nand4  g43(.a(new_n46_), .b(new_n30_), .c(x02), .d(new_n26_), .O(new_n69_));
  ...
  nand2  g47(.a(new_n35_), .b(new_n36_), .O(new_n73_));
  nand3  g48(.a(new_n46_), .b(x05), .c(new_n37_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(new_n73_), .c(new_n28_), .O(z07));
