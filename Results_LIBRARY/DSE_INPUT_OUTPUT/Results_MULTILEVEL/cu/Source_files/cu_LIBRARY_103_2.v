...
module FAU ( 
  ...
  nor3   g15(.a(new_n40_), .b(x13), .c(new_n27_), .O(new_n41_));
  nand4  g16(.a(new_n41_), .b(new_n35_), .c(new_n26_), .d(new_n30_), .O(new_n42_));
  nor3   g17(.a(new_n42_), .b(x01), .c(x00), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand3  g19(.a(new_n30_), .b(new_n44_), .c(x00), .O(new_n45_));
  inv1   g20(.a(x13), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n47_));
  ...
  nand3  g30(.a(new_n32_), .b(new_n55_), .c(new_n54_), .O(new_n56_));
  inv1   g31(.a(x11), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(x10), .c(x00), .O(new_n58_));
  ...
  nand3  g38(.a(new_n32_), .b(new_n63_), .c(new_n54_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand4  g40(.a(x10), .b(new_n63_), .c(new_n44_), .d(new_n54_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  aoi21  g42(.a(new_n65_), .b(new_n55_), .c(new_n67_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n60_), .c(new_n46_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n53_), .c(new_n52_), .d(x05), .O(new_n70_));
  nand4  g45(.a(new_n33_), .b(new_n46_), .c(new_n27_), .d(x02), .O(new_n71_));
  ...
  nand3  g50(.a(new_n46_), .b(x05), .c(new_n35_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(new_n75_), .c(new_n33_), .O(z07));
  nand4  g52(.a(x13), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n78_));
  nand3  g53(.a(new_n46_), .b(new_n27_), .c(x02), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x04), .c(new_n26_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n33_), .O(z08));
  inv1   g57(.a(x06), .O(new_n83_));
  nor3   g58(.a(new_n40_), .b(new_n46_), .c(new_n83_), .O(z09));
  nand2  g59(.a(x05), .b(x02), .O(new_n85_));
  nand3  g60(.a(new_n85_), .b(x06), .c(new_n26_), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(new_n33_), .O(z10));
endmodule
