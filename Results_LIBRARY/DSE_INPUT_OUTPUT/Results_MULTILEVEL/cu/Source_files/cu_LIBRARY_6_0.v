...
module FAU ( 
  ...
  nand4  g39(.a(new_n46_), .b(x06), .c(new_n28_), .d(x02), .O(new_n65_));
  ...
  oai21  g51(.a(new_n46_), .b(new_n38_), .c(new_n39_), .O(z09));
