...
module FAU ( 
  ...
  nand4  g25(.a(new_n50_), .b(x06), .c(x05), .d(new_n35_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z04));
  nand3  g27(.a(new_n45_), .b(x05), .c(new_n35_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n26_), .c(new_n30_), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x06), .c(new_n43_), .O(z05));
  ...
  oai21  g46(.a(new_n53_), .b(new_n71_), .c(new_n33_), .O(z07));
  ...
  oai21  g51(.a(new_n45_), .b(new_n32_), .c(new_n33_), .O(z09));
