...
module FAU ( 
  ...
  nand2  g00(.a(x08), .b(x04), .O(new_n26_));
  ...
  nand4  g11(.a(new_n28_), .b(new_n29_), .c(x04), .d(x02), .O(new_n37_));
  ...
  oai21  g19(.a(new_n44_), .b(new_n41_), .c(new_n26_), .O(z02));
  ...
  nand3  g42(.a(new_n67_), .b(x05), .c(new_n35_), .O(new_n68_));
  nand3  g43(.a(new_n43_), .b(new_n29_), .c(x02), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n28_), .c(x04), .d(new_n42_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z06));
  nand4  g47(.a(x05), .b(new_n32_), .c(new_n42_), .d(new_n35_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x13), .O(z07));
  nand4  g49(.a(x13), .b(new_n58_), .c(x05), .d(new_n35_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n69_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n42_), .O(new_n77_));
  aoi21  g52(.a(new_n77_), .b(new_n28_), .c(new_n32_), .O(z08));
