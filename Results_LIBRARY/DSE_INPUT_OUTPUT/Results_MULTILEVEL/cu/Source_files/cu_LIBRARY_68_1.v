...
module FAU ( 
  ...
  aoi21  g18(.a(new_n43_), .b(new_n32_), .c(x00), .O(z02));
  nand3  g19(.a(new_n29_), .b(new_n32_), .c(x00), .O(new_n45_));
  nand4  g20(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n45_), .c(new_n34_), .O(z03));
  aoi21  g22(.a(new_n43_), .b(x00), .c(new_n32_), .O(z05));
  inv1   g23(.a(x00), .O(new_n49_));
  nand3  g24(.a(new_n42_), .b(x05), .c(x04), .O(new_n50_));
  ...
  oai21  g29(.a(new_n54_), .b(new_n50_), .c(new_n32_), .O(new_n55_));
  nand2  g30(.a(new_n55_), .b(new_n49_), .O(new_n56_));
  inv1   g31(.a(x09), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n32_), .c(x00), .O(new_n58_));
  ...
  nor2   g41(.a(z04), .b(x13), .O(new_n67_));
  ...
  nand4  g46(.a(new_n71_), .b(new_n34_), .c(x04), .d(new_n26_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z08));
  inv1   g48(.a(x06), .O(new_n74_));
  nor3   g49(.a(z04), .b(new_n41_), .c(new_n74_), .O(z09));
