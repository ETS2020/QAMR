...
module FAU ( 
  ...
  nand4  g17(.a(new_n35_), .b(new_n30_), .c(new_n42_), .d(new_n41_), .O(new_n43_));
  ...
  nand4  g24(.a(new_n49_), .b(new_n35_), .c(new_n30_), .d(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n26_), .c(x01), .O(z03));
  nand3  g26(.a(new_n30_), .b(x01), .c(new_n41_), .O(new_n52_));
  nand4  g27(.a(new_n47_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n34_), .O(z04));
  nor3   g29(.a(x02), .b(new_n42_), .c(new_n41_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n56_));
  ...
  nand3  g41(.a(new_n47_), .b(new_n36_), .c(x02), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(x12), .O(new_n68_));
  nand4  g43(.a(new_n47_), .b(new_n36_), .c(x02), .d(x01), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n68_), .c(x04), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x03), .O(z06));
  nand2  g47(.a(new_n35_), .b(new_n30_), .O(new_n73_));
  oai21  g48(.a(new_n48_), .b(new_n73_), .c(new_n34_), .O(z07));
  ...
  nor3   g54(.a(new_n27_), .b(new_n47_), .c(new_n79_), .O(z09));
