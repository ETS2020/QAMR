...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n43_, new_n44_, new_n47_, new_n48_, new_n51_, new_n52_,
  ...
  nand3  g20(.a(new_n31_), .b(x01), .c(new_n41_), .O(new_n47_));
  nand4  g21(.a(new_n42_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n48_));
  oai21  g22(.a(new_n48_), .b(new_n47_), .c(new_n27_), .O(z04));
  aoi21  g23(.a(new_n44_), .b(x01), .c(new_n41_), .O(z05));
  nor2   g24(.a(new_n28_), .b(x13), .O(new_n51_));
  nand3  g25(.a(new_n51_), .b(new_n36_), .c(x02), .O(new_n52_));
  inv1   g26(.a(x07), .O(new_n53_));
  inv1   g27(.a(x12), .O(new_n54_));
  nor2   g28(.a(x08), .b(x01), .O(new_n55_));
  nor2   g29(.a(x10), .b(new_n26_), .O(new_n56_));
  oai21  g30(.a(new_n56_), .b(new_n55_), .c(new_n41_), .O(new_n57_));
  inv1   g31(.a(x11), .O(new_n58_));
  nand3  g32(.a(new_n58_), .b(x01), .c(x00), .O(new_n59_));
  aoi21  g33(.a(new_n59_), .b(new_n57_), .c(new_n42_), .O(new_n60_));
  nand4  g34(.a(new_n60_), .b(new_n54_), .c(new_n53_), .d(x05), .O(new_n61_));
  oai21  g35(.a(new_n61_), .b(x02), .c(new_n52_), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(x04), .c(new_n35_), .O(new_n63_));
  inv1   g37(.a(new_n63_), .O(z06));
  nand4  g38(.a(new_n51_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n65_));
  nor2   g39(.a(new_n65_), .b(x02), .O(z07));
  nand4  g40(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n67_));
  ...
  nand3  g48(.a(new_n74_), .b(x06), .c(new_n35_), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n27_), .O(z10));
  zero   g50(.O(z03));
endmodule
