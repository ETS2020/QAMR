...
module FAU ( 
  ...
  nor2   g19(.a(x13), .b(new_n35_), .O(new_n45_));
  nand3  g20(.a(new_n45_), .b(new_n28_), .c(new_n34_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n26_), .O(z03));
  inv1   g22(.a(x06), .O(new_n48_));
  nor3   g23(.a(x03), .b(x02), .c(x00), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n45_), .c(new_n28_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n48_), .c(new_n43_), .O(z04));
  nand4  g26(.a(new_n34_), .b(new_n30_), .c(x01), .d(x00), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n48_), .c(x05), .d(new_n28_), .O(new_n54_));
  ...
  nand2  g41(.a(new_n66_), .b(new_n43_), .O(new_n67_));
  inv1   g42(.a(x10), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(new_n48_), .c(x01), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n65_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n64_), .c(new_n58_), .O(new_n72_));
  ...
  nand4  g53(.a(new_n74_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n79_));
  nor2   g54(.a(new_n79_), .b(x02), .O(z07));
  nand4  g55(.a(x13), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n81_));
  nand3  g56(.a(new_n58_), .b(new_n35_), .c(x02), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand4  g58(.a(new_n83_), .b(new_n26_), .c(x04), .d(new_n34_), .O(new_n84_));
  inv1   g59(.a(new_n84_), .O(z08));
  nand3  g60(.a(x13), .b(x06), .c(new_n43_), .O(new_n86_));
  inv1   g61(.a(new_n86_), .O(z09));
  nand2  g62(.a(x05), .b(x02), .O(new_n88_));
  nand4  g63(.a(new_n88_), .b(x06), .c(new_n34_), .d(new_n43_), .O(new_n89_));
