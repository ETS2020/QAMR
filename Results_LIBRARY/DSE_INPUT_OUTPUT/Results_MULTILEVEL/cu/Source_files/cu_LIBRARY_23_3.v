...
module FAU ( 
  ...
  nand2  g06(.a(x12), .b(x01), .O(new_n32_));
  ...
  nand3  g17(.a(new_n29_), .b(new_n42_), .c(x00), .O(new_n43_));
  ...
  nand4  g25(.a(new_n50_), .b(new_n47_), .c(x05), .d(new_n27_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z04));
  nand4  g27(.a(new_n26_), .b(new_n29_), .c(x01), .d(x00), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n47_), .c(x05), .d(new_n27_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  nor2   g32(.a(x11), .b(new_n42_), .O(new_n58_));
  nor3   g33(.a(x12), .b(x09), .c(x01), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(x00), .O(new_n60_));
  nor2   g35(.a(x10), .b(new_n42_), .O(new_n61_));
  nor3   g36(.a(x12), .b(x08), .c(x01), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(new_n48_), .O(new_n63_));
  ...
  aoi21  g44(.a(x12), .b(x01), .c(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x02), .O(z07));
  nand3  g47(.a(new_n70_), .b(new_n30_), .c(x02), .O(new_n73_));
  nand4  g48(.a(x13), .b(new_n47_), .c(x05), .d(new_n29_), .O(new_n74_));
