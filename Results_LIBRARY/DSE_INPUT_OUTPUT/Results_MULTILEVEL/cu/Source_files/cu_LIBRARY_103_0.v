...
module FAU ( 
  ...
  nor2   g06(.a(x10), .b(x09), .O(new_n32_));
  ...
  nor3   g14(.a(new_n32_), .b(x13), .c(new_n27_), .O(new_n40_));
  nand4  g15(.a(new_n40_), .b(new_n35_), .c(new_n26_), .d(new_n30_), .O(new_n41_));
  ...
  nor3   g22(.a(new_n41_), .b(new_n43_), .c(x00), .O(z04));
  ...
  nand2  g29(.a(x08), .b(new_n43_), .O(new_n55_));
  ...
  aoi21  g35(.a(x11), .b(x01), .c(x09), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(x00), .O(new_n62_));
  inv1   g37(.a(x08), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n43_), .c(new_n53_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(x10), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n60_), .c(new_n45_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n52_), .c(new_n51_), .d(x05), .O(new_n68_));
  nand4  g43(.a(new_n33_), .b(new_n45_), .c(new_n27_), .d(x02), .O(new_n69_));
  ...
  nand3  g48(.a(new_n45_), .b(x05), .c(new_n35_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(new_n73_), .c(new_n33_), .O(z07));
  nand4  g50(.a(x13), .b(new_n52_), .c(x05), .d(new_n30_), .O(new_n76_));
  nand3  g51(.a(new_n45_), .b(new_n27_), .c(x02), .O(new_n77_));
  ...
  nor3   g56(.a(new_n32_), .b(new_n45_), .c(new_n81_), .O(z09));
