...
module FAU ( 
  ...
  nand4  g50(.a(new_n75_), .b(new_n32_), .c(x04), .d(new_n26_), .O(new_n76_));
  inv1   g51(.a(new_n76_), .O(z08));
  nand3  g52(.a(new_n32_), .b(x13), .c(x06), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n32_), .c(x06), .d(new_n26_), .O(new_n81_));
