...
module FAU ( 
  ...
  nor2   g31(.a(new_n26_), .b(x13), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n35_), .c(x02), .O(new_n58_));
  ...
  nand4  g46(.a(new_n57_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n60_), .c(x05), .d(new_n29_), .O(new_n74_));
  nand3  g49(.a(new_n40_), .b(new_n35_), .c(x02), .O(new_n75_));
