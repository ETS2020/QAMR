...
module FAU ( 
  ...
  nand2  g40(.a(new_n51_), .b(new_n26_), .O(z07));
  nand4  g41(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n68_));
  nand3  g42(.a(new_n43_), .b(new_n35_), .c(x02), .O(new_n69_));
