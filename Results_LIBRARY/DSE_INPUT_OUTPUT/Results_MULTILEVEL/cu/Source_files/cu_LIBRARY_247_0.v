...
module FAU ( 
  ...
  nand2  g14(.a(new_n34_), .b(new_n29_), .O(new_n40_));
  ...
  nand4  g22(.a(new_n34_), .b(new_n29_), .c(new_n47_), .d(x00), .O(new_n48_));
  ...
  nand4  g27(.a(new_n34_), .b(new_n29_), .c(x01), .d(new_n52_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n42_), .c(x05), .d(new_n27_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(z04));
  nor3   g31(.a(x02), .b(new_n47_), .c(new_n52_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n58_));
  ...
  nor2   g39(.a(x10), .b(new_n47_), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(new_n64_), .c(new_n52_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n42_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n68_));
  nand3  g43(.a(new_n42_), .b(new_n35_), .c(x02), .O(new_n69_));
  ...
  nand4  g48(.a(x13), .b(new_n61_), .c(x05), .d(new_n29_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n69_), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n33_), .c(x04), .d(new_n34_), .O(new_n76_));
