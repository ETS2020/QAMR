...
module FAU ( 
  ...
  nand3  g35(.a(new_n26_), .b(new_n60_), .c(x01), .O(new_n61_));
  ...
  nand3  g41(.a(new_n26_), .b(new_n66_), .c(x01), .O(new_n67_));
  ...
  nand4  g52(.a(x13), .b(new_n26_), .c(x05), .d(new_n30_), .O(new_n78_));
