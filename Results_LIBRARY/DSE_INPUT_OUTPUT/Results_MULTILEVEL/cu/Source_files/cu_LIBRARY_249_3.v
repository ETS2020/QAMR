...
module FAU ( 
  ...
  nand3  g23(.a(new_n43_), .b(x05), .c(new_n30_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand3  g25(.a(new_n50_), .b(new_n37_), .c(new_n48_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n29_), .c(new_n34_), .O(z04));
  nand3  g27(.a(new_n50_), .b(new_n37_), .c(x00), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n29_), .c(new_n34_), .O(z05));
  ...
  nand4  g39(.a(new_n43_), .b(new_n26_), .c(x02), .d(new_n34_), .O(new_n65_));
  ...
  nand2  g43(.a(x02), .b(x01), .O(new_n69_));
  oai21  g44(.a(new_n49_), .b(new_n38_), .c(new_n69_), .O(z07));
  ...
  nand3  g49(.a(new_n69_), .b(x13), .c(x06), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z09));
  oai21  g51(.a(x05), .b(x01), .c(x02), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x06), .c(new_n37_), .O(new_n78_));
