...
module FAU ( 
  ...
  nand4  g20(.a(new_n41_), .b(new_n34_), .c(new_n26_), .d(new_n39_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n27_), .c(new_n30_), .O(z04));
  nor3   g22(.a(x02), .b(new_n30_), .c(new_n39_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n49_));
  ...
  aoi21  g34(.a(new_n59_), .b(new_n56_), .c(new_n53_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(new_n52_), .c(new_n51_), .d(x05), .O(new_n61_));
  nand3  g36(.a(new_n53_), .b(new_n28_), .c(x02), .O(new_n62_));
  ...
  nor2   g42(.a(new_n34_), .b(x03), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(new_n53_), .c(new_n28_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n30_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(x02), .O(new_n71_));
  nor2   g46(.a(new_n53_), .b(x12), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n68_), .c(x05), .d(new_n27_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n71_), .O(z08));
  nand3  g49(.a(new_n38_), .b(x13), .c(x06), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z09));
  oai21  g51(.a(x05), .b(x01), .c(x02), .O(new_n77_));
