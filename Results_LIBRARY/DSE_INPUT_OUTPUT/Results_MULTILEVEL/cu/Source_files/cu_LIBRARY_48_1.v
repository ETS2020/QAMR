...
module FAU ( 
  ...
  nand4  g20(.a(new_n41_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n46_));
  ...
  nand3  g39(.a(new_n41_), .b(new_n36_), .c(x02), .O(new_n65_));
  ...
  nand4  g51(.a(new_n76_), .b(new_n34_), .c(x06), .d(new_n35_), .O(new_n77_));
