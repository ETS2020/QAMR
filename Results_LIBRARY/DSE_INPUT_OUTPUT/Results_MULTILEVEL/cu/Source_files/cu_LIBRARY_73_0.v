...
module FAU ( 
  ...
  nand4  g21(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n46_), .O(new_n47_));
  ...
  nand4  g26(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n33_), .O(z05));
  nor2   g28(.a(z02), .b(x13), .O(new_n54_));
  nand3  g29(.a(new_n54_), .b(new_n30_), .c(x02), .O(new_n55_));
  ...
  aoi21  g37(.a(new_n62_), .b(new_n60_), .c(new_n40_), .O(new_n63_));
  ...
  nand4  g42(.a(new_n54_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n70_));
  nand3  g45(.a(new_n40_), .b(new_n30_), .c(x02), .O(new_n71_));
