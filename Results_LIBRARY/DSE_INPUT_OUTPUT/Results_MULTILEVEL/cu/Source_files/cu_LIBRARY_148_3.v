...
module FAU ( 
  ...
  nand2  g06(.a(x10), .b(x07), .O(new_n32_));
  ...
  nand4  g17(.a(new_n42_), .b(new_n26_), .c(new_n30_), .d(new_n39_), .O(new_n43_));
  ...
  nand3  g36(.a(new_n40_), .b(new_n27_), .c(x02), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n61_), .c(x07), .O(new_n63_));
  inv1   g38(.a(x10), .O(new_n64_));
  nand4  g39(.a(new_n40_), .b(new_n64_), .c(new_n27_), .d(x02), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n63_), .c(x04), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x03), .O(z06));
  nand2  g43(.a(new_n26_), .b(new_n30_), .O(new_n69_));
  nand3  g44(.a(new_n40_), .b(x05), .c(new_n34_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n69_), .c(new_n32_), .O(z07));
  nand4  g46(.a(x13), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n62_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n26_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n32_), .O(z08));
  nand2  g50(.a(x13), .b(x06), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n32_), .O(z09));
