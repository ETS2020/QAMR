...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n44_), .c(x05), .d(new_n35_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z04));
  nor2   g24(.a(x03), .b(x02), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n44_), .c(x05), .d(new_n35_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(x01), .c(new_n45_), .O(z05));
  nand4  g27(.a(new_n33_), .b(new_n44_), .c(new_n27_), .d(x02), .O(new_n53_));
  ...
  nand2  g40(.a(new_n51_), .b(new_n33_), .O(z07));
  nand4  g41(.a(x13), .b(new_n55_), .c(x05), .d(new_n30_), .O(new_n67_));
  nand3  g42(.a(new_n44_), .b(new_n27_), .c(x02), .O(new_n68_));
  ...
  nor3   g47(.a(z03), .b(new_n44_), .c(new_n72_), .O(z09));
