...
module FAU ( 
  ...
  nand4  g22(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n42_), .O(new_n48_));
  ...
  nand4  g27(.a(new_n32_), .b(new_n44_), .c(new_n27_), .d(x02), .O(new_n53_));
  ...
  nand4  g49(.a(new_n74_), .b(new_n32_), .c(x06), .d(new_n26_), .O(new_n75_));
