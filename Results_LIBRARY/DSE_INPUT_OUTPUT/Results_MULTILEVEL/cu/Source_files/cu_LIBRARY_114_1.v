...
module FAU ( 
  ...
  nand4  g29(.a(new_n26_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n54_), .c(new_n35_), .O(z05));
  ...
  aoi21  g36(.a(new_n61_), .b(new_n59_), .c(new_n49_), .O(new_n62_));
  ...
  nand3  g45(.a(new_n26_), .b(new_n36_), .c(x02), .O(new_n71_));
  ...
  nand4  g49(.a(x05), .b(new_n28_), .c(new_n34_), .d(new_n30_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x13), .O(z07));
  inv1   g51(.a(x12), .O(new_n77_));
  nand4  g52(.a(x13), .b(new_n77_), .c(x05), .d(new_n30_), .O(new_n78_));
