...
module FAU ( 
  ...
  nand2  g36(.a(new_n32_), .b(new_n41_), .O(new_n62_));
  ...
  aoi21  g42(.a(new_n67_), .b(new_n58_), .c(new_n43_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n54_), .c(new_n53_), .d(x05), .O(new_n69_));
