...
module FAU ( 
  ...
  nand4  g27(.a(new_n52_), .b(new_n41_), .c(x05), .d(new_n28_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nor3   g29(.a(x02), .b(new_n45_), .c(new_n50_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n56_));
  ...
  nand4  g43(.a(new_n41_), .b(new_n36_), .c(x02), .d(x01), .O(new_n69_));
