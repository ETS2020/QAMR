...
module FAU ( 
  ...
  nor3   g23(.a(x02), .b(new_n44_), .c(new_n26_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z05));
  nand4  g26(.a(new_n27_), .b(new_n46_), .c(new_n36_), .d(x02), .O(new_n52_));
  ...
  nand3  g33(.a(new_n58_), .b(new_n44_), .c(new_n26_), .O(new_n59_));
  ...
  nand4  g42(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n68_));
  nand3  g43(.a(new_n46_), .b(new_n36_), .c(x02), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n27_), .c(x04), .d(new_n35_), .O(new_n71_));
  ...
  nand4  g50(.a(new_n75_), .b(new_n27_), .c(x06), .d(new_n35_), .O(new_n76_));
