...
module FAU ( 
  ...
  nand4  g24(.a(new_n50_), .b(new_n44_), .c(x05), .d(new_n27_), .O(new_n51_));
  aoi21  g25(.a(new_n51_), .b(x01), .c(new_n45_), .O(z05));
  aoi21  g26(.a(new_n32_), .b(x00), .c(x13), .O(new_n53_));
  ...
  nand3  g43(.a(new_n44_), .b(new_n30_), .c(x02), .O(new_n70_));
