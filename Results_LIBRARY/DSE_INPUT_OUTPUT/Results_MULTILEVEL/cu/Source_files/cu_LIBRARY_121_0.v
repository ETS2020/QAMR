...
module FAU ( 
  ...
  nor2   g00(.a(x11), .b(x00), .O(new_n26_));
  ...
  nor3   g15(.a(x03), .b(x02), .c(x01), .O(new_n41_));
  nand4  g16(.a(new_n41_), .b(new_n40_), .c(x05), .d(new_n27_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x11), .c(x00), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand4  g19(.a(new_n34_), .b(new_n29_), .c(new_n44_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n40_), .c(x05), .d(new_n27_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand4  g24(.a(new_n34_), .b(new_n29_), .c(x01), .d(new_n49_), .O(new_n50_));
  ...
  nand4  g29(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n55_));
  ...
  aoi21  g39(.a(new_n64_), .b(new_n61_), .c(new_n40_), .O(new_n65_));
  ...
  nor2   g45(.a(new_n26_), .b(x13), .O(new_n71_));
