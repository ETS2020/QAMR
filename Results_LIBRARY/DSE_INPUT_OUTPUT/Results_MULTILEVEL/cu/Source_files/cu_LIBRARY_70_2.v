...
module FAU ( 
  ...
  nand4  g22(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n41_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x12), .c(x05), .d(new_n27_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z04));
  nand4  g26(.a(new_n26_), .b(new_n29_), .c(x01), .d(x00), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x12), .c(x05), .d(new_n27_), .O(new_n54_));
