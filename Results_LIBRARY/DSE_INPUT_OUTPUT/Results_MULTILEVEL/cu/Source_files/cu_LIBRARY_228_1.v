...
module FAU ( 
  ...
  nand2  g30(.a(x08), .b(x01), .O(new_n56_));
  oai21  g31(.a(x09), .b(x08), .c(new_n56_), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n55_), .c(new_n54_), .O(new_n58_));
  inv1   g33(.a(x09), .O(new_n59_));
  nand2  g34(.a(x11), .b(x01), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(x00), .O(new_n61_));
  nand2  g36(.a(new_n32_), .b(new_n45_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  inv1   g38(.a(x11), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(x08), .c(x01), .d(x00), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(new_n66_));
  aoi21  g41(.a(new_n63_), .b(new_n59_), .c(new_n66_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n58_), .c(new_n40_), .O(new_n68_));
  ...
  nand2  g55(.a(new_n33_), .b(x13), .O(new_n81_));
