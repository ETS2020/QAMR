...
module FAU ( 
  ...
  nand4  g21(.a(new_n36_), .b(new_n31_), .c(new_n26_), .d(x00), .O(new_n47_));
  ...
  aoi22  g39(.a(new_n64_), .b(new_n42_), .c(new_n63_), .d(x01), .O(new_n65_));
  ...
  nand2  g46(.a(new_n36_), .b(new_n31_), .O(new_n72_));
  nand3  g47(.a(new_n44_), .b(x05), .c(new_n29_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n72_), .c(new_n35_), .O(z07));
  nand4  g49(.a(x13), .b(new_n60_), .c(x05), .d(new_n31_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n68_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n35_), .c(x04), .d(new_n36_), .O(new_n77_));
