...
module FAU ( 
  ...
  nand4  g27(.a(x05), .b(x04), .c(new_n34_), .d(new_n30_), .O(new_n54_));
  ...
  nand2  g44(.a(new_n34_), .b(new_n30_), .O(new_n71_));
  nand3  g45(.a(new_n44_), .b(x05), .c(new_n28_), .O(new_n72_));
  oai21  g46(.a(new_n72_), .b(new_n71_), .c(new_n35_), .O(z07));
  ...
  nor3   g52(.a(new_n27_), .b(new_n44_), .c(new_n78_), .O(z09));
  nand2  g53(.a(x05), .b(x02), .O(new_n80_));
  nand4  g54(.a(new_n80_), .b(new_n35_), .c(x06), .d(new_n34_), .O(new_n81_));
