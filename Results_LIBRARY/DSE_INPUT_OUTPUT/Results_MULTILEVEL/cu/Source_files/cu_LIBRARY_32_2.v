...
module FAU ( 
  ...
  nand4  g23(.a(new_n35_), .b(new_n31_), .c(x01), .d(new_n41_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(x06), .c(x05), .d(new_n29_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z04));
  nand3  g27(.a(new_n44_), .b(x05), .c(new_n29_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n35_), .c(new_n31_), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x06), .c(new_n42_), .O(z05));
  ...
  nand3  g42(.a(new_n67_), .b(x06), .c(x01), .O(new_n68_));
  ...
  oai21  g52(.a(new_n53_), .b(new_n77_), .c(new_n27_), .O(z07));
  nand4  g53(.a(x13), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n79_));
  nand3  g54(.a(new_n44_), .b(new_n36_), .c(x02), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n27_), .c(x04), .d(new_n35_), .O(new_n82_));
  inv1   g57(.a(new_n82_), .O(z08));
  oai21  g58(.a(new_n44_), .b(new_n26_), .c(new_n27_), .O(z09));
