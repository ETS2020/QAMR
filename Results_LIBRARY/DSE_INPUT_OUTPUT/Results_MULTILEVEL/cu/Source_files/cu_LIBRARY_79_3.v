...
module FAU ( 
  ...
  nand2  g44(.a(new_n47_), .b(new_n36_), .O(z07));
  nand4  g45(.a(x13), .b(new_n57_), .c(x05), .d(new_n31_), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n67_), .O(new_n73_));
  nand4  g47(.a(new_n73_), .b(new_n36_), .c(x04), .d(new_n35_), .O(new_n74_));
  inv1   g48(.a(new_n74_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n36_), .O(z09));
  nand2  g51(.a(x05), .b(x02), .O(new_n78_));
  nand4  g52(.a(new_n78_), .b(new_n36_), .c(x06), .d(new_n35_), .O(new_n79_));
