...
module FAU ( 
  ...
  nor2   g29(.a(x13), .b(new_n30_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n54_), .c(new_n27_), .d(x00), .O(new_n56_));
  ...
  nor3   g42(.a(x09), .b(x08), .c(x01), .O(new_n68_));
  aoi21  g43(.a(new_n67_), .b(new_n49_), .c(new_n68_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n62_), .c(new_n42_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n71_));
  nand3  g46(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n72_));
  oai21  g47(.a(new_n71_), .b(x02), .c(new_n72_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n26_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n32_), .O(z06));
  nand3  g50(.a(new_n32_), .b(new_n42_), .c(x05), .O(new_n76_));
  nor4   g51(.a(new_n76_), .b(x04), .c(x03), .d(x02), .O(z07));
  nand4  g52(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n78_));
