...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n75_, new_n77_, new_n78_, new_n79_, new_n80_, new_n83_;
  ...
  nand2  g13(.a(x06), .b(x05), .O(new_n39_));
  ...
  nand4  g22(.a(new_n47_), .b(new_n29_), .c(new_n42_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n30_), .c(new_n35_), .O(z03));
  nand4  g24(.a(new_n47_), .b(new_n29_), .c(x01), .d(new_n41_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n30_), .c(new_n35_), .O(z04));
  ...
  oai21  g41(.a(new_n66_), .b(new_n61_), .c(x13), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x12), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n56_), .c(new_n30_), .d(x05), .O(new_n69_));
  ...
  nand4  g49(.a(new_n70_), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n30_), .c(new_n35_), .O(z07));
  inv1   g51(.a(x12), .O(new_n77_));
  nand4  g52(.a(x13), .b(new_n77_), .c(x05), .d(new_n29_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n71_), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x04), .c(new_n26_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n39_), .O(z08));
  aoi21  g56(.a(new_n70_), .b(new_n35_), .c(new_n30_), .O(z09));
  nand3  g57(.a(x06), .b(new_n35_), .c(new_n26_), .O(new_n83_));
