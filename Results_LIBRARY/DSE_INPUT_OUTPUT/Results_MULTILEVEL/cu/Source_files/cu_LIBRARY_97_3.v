...
module FAU ( 
  ...
  nand3  g07(.a(new_n32_), .b(new_n30_), .c(new_n27_), .O(z00));
  nand3  g08(.a(x05), .b(new_n31_), .c(new_n28_), .O(new_n34_));
  ...
  nand4  g13(.a(new_n38_), .b(x05), .c(new_n31_), .d(new_n37_), .O(new_n39_));
  nor2   g14(.a(new_n39_), .b(x13), .O(z02));
  inv1   g15(.a(x13), .O(new_n41_));
  inv1   g16(.a(x01), .O(new_n42_));
  nand4  g17(.a(new_n37_), .b(new_n28_), .c(new_n42_), .d(x00), .O(new_n43_));
  ...
  nand4  g22(.a(new_n37_), .b(new_n28_), .c(x01), .d(new_n47_), .O(new_n48_));
  ...
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n31_), .d(new_n37_), .O(new_n53_));
  ...
  nand2  g39(.a(new_n41_), .b(x02), .O(new_n65_));
  ...
  nand3  g43(.a(new_n41_), .b(new_n31_), .c(new_n37_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n28_), .c(new_n29_), .O(z07));
  nand4  g45(.a(x13), .b(new_n56_), .c(x05), .d(new_n28_), .O(new_n71_));
  nand3  g46(.a(new_n41_), .b(new_n29_), .c(x02), .O(new_n72_));
  ...
  oai21  g53(.a(new_n78_), .b(x03), .c(new_n26_), .O(z10));
endmodule
