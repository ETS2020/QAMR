...
module FAU ( 
  ...
  nand2  g13(.a(x12), .b(x05), .O(new_n39_));
  ...
  aoi21  g19(.a(new_n44_), .b(new_n30_), .c(new_n35_), .O(z02));
  nand4  g20(.a(new_n26_), .b(new_n29_), .c(new_n42_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n30_), .c(x05), .d(new_n27_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(x13), .O(z03));
  nor2   g24(.a(x02), .b(new_n42_), .O(new_n50_));
  nand3  g25(.a(new_n50_), .b(new_n43_), .c(new_n41_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n30_), .c(new_n35_), .O(z04));
  nand3  g27(.a(new_n50_), .b(new_n43_), .c(x00), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n30_), .c(new_n35_), .O(z05));
  ...
  nand4  g38(.a(new_n63_), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n64_));
  nand3  g39(.a(new_n56_), .b(new_n35_), .c(x02), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n26_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n39_), .O(z06));
  nor2   g43(.a(x03), .b(x02), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n30_), .c(x05), .d(new_n27_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x13), .O(z07));
  nand3  g46(.a(x13), .b(x05), .c(new_n29_), .O(new_n72_));
  ...
  nand2  g54(.a(new_n79_), .b(new_n39_), .O(z10));
endmodule
