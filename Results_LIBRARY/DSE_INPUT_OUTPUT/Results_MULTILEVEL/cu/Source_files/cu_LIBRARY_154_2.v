...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n32_), .O(new_n46_));
  inv1   g20(.a(new_n46_), .O(new_n47_));
  nand4  g21(.a(new_n47_), .b(new_n45_), .c(x05), .d(new_n36_), .O(new_n48_));
  ...
  nand3  g40(.a(new_n45_), .b(new_n27_), .c(x02), .O(new_n67_));
