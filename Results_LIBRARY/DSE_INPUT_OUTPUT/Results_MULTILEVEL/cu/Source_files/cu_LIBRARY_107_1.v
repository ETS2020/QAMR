...
module FAU ( 
  ...
  nand3  g24(.a(new_n50_), .b(new_n30_), .c(x02), .O(new_n51_));
  ...
  nand4  g37(.a(new_n50_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n64_));
  nor2   g38(.a(new_n64_), .b(x02), .O(z07));
  nand4  g39(.a(x13), .b(new_n53_), .c(x05), .d(new_n29_), .O(new_n66_));
