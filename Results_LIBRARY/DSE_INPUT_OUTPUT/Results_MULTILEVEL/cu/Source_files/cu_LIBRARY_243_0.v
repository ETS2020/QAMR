...
module FAU ( 
  ...
  nand4  g24(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n49_), .c(new_n33_), .O(z05));
  nor2   g26(.a(z02), .b(x13), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(new_n35_), .c(x02), .O(new_n53_));
  ...
  inv1   g33(.a(x00), .O(new_n59_));
  inv1   g34(.a(x10), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(x01), .c(new_n59_), .O(new_n61_));
  ...
  nand4  g41(.a(new_n52_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n67_));
