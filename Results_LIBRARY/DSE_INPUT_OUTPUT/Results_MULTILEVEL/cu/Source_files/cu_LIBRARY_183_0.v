...
module FAU ( 
  ...
  nand4  g16(.a(new_n26_), .b(new_n30_), .c(new_n42_), .d(x00), .O(new_n43_));
  inv1   g17(.a(new_n43_), .O(new_n44_));
  nand4  g18(.a(new_n44_), .b(new_n41_), .c(x05), .d(new_n35_), .O(new_n45_));
  inv1   g19(.a(new_n45_), .O(z03));
  inv1   g20(.a(x00), .O(new_n47_));
  nand4  g21(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n47_), .O(new_n48_));
  inv1   g22(.a(new_n48_), .O(new_n49_));
  nand4  g23(.a(new_n49_), .b(new_n41_), .c(x05), .d(new_n35_), .O(new_n50_));
  inv1   g24(.a(new_n50_), .O(z04));
  nand3  g25(.a(new_n30_), .b(x01), .c(x00), .O(new_n52_));
  nand4  g26(.a(new_n41_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n53_));
  oai21  g27(.a(new_n53_), .b(new_n52_), .c(new_n33_), .O(z05));
  nand4  g28(.a(x05), .b(x04), .c(new_n26_), .d(new_n30_), .O(new_n55_));
  ...
  nand2  g34(.a(new_n60_), .b(new_n47_), .O(new_n61_));
  inv1   g35(.a(x09), .O(new_n62_));
  nand2  g36(.a(new_n62_), .b(new_n42_), .O(new_n63_));
  inv1   g37(.a(x11), .O(new_n64_));
  nand3  g38(.a(new_n64_), .b(x01), .c(x00), .O(new_n65_));
  aoi21  g39(.a(new_n65_), .b(new_n63_), .c(new_n41_), .O(new_n66_));
  nand4  g40(.a(new_n66_), .b(new_n58_), .c(new_n56_), .d(x05), .O(new_n67_));
  nand3  g41(.a(new_n41_), .b(new_n27_), .c(x02), .O(new_n68_));
  ...
  nor2   g45(.a(new_n32_), .b(x13), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n73_));
  nor2   g47(.a(new_n73_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n68_), .O(new_n76_));
  nand4  g50(.a(new_n76_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n77_));
  inv1   g51(.a(new_n77_), .O(z08));
  nand2  g52(.a(x13), .b(x06), .O(new_n79_));
  nand2  g53(.a(new_n79_), .b(new_n33_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n81_));
  nand3  g55(.a(new_n81_), .b(x06), .c(new_n26_), .O(new_n82_));
  nand2  g56(.a(new_n82_), .b(new_n33_), .O(z10));
  zero   g57(.O(z02));
endmodule
