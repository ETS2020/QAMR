...
module FAU ( 
  ...
  nor2   g06(.a(x12), .b(x01), .O(new_n32_));
  ...
  nor2   g21(.a(x13), .b(new_n30_), .O(new_n47_));
  ...
  nor2   g44(.a(new_n32_), .b(x13), .O(new_n70_));
  ...
  aoi21  g48(.a(new_n73_), .b(new_n66_), .c(new_n41_), .O(new_n74_));
  nand4  g49(.a(new_n50_), .b(x12), .c(new_n30_), .d(x02), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(new_n74_), .c(x04), .O(new_n77_));
  nor2   g52(.a(new_n77_), .b(x03), .O(z08));
