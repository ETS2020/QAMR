...
module FAU ( 
  ...
  nor2   g28(.a(new_n27_), .b(x13), .O(new_n55_));
  nand3  g29(.a(new_n55_), .b(new_n35_), .c(x02), .O(new_n56_));
  inv1   g30(.a(x07), .O(new_n57_));
  inv1   g31(.a(x12), .O(new_n58_));
  nor2   g32(.a(x08), .b(x01), .O(new_n59_));
  nor2   g33(.a(x10), .b(new_n44_), .O(new_n60_));
  oai21  g34(.a(new_n60_), .b(new_n59_), .c(new_n49_), .O(new_n61_));
  inv1   g35(.a(x09), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(new_n44_), .c(x00), .O(new_n63_));
  ...
  nand4  g42(.a(new_n55_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n69_));
  nor2   g43(.a(new_n69_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n71_));
  nand3  g45(.a(new_n43_), .b(new_n35_), .c(x02), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g47(.a(new_n73_), .b(x04), .c(new_n34_), .O(new_n74_));
  nand2  g48(.a(new_n74_), .b(new_n26_), .O(z08));
  nand3  g49(.a(new_n26_), .b(x13), .c(x06), .O(new_n76_));
  inv1   g50(.a(new_n76_), .O(z09));
  nand2  g51(.a(x05), .b(x02), .O(new_n78_));
  nand3  g52(.a(new_n78_), .b(x06), .c(new_n34_), .O(new_n79_));
  nand2  g53(.a(new_n79_), .b(new_n26_), .O(z10));
  zero   g54(.O(z05));
endmodule
