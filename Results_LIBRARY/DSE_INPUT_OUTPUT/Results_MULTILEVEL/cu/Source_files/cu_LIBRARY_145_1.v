...
module FAU ( 
  ...
  nand4  g23(.a(new_n48_), .b(new_n47_), .c(new_n28_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n26_), .c(x01), .O(z03));
  nand3  g25(.a(new_n30_), .b(x01), .c(new_n41_), .O(new_n51_));
  nand3  g26(.a(new_n48_), .b(new_n28_), .c(new_n35_), .O(new_n52_));
  ...
  nand4  g40(.a(new_n65_), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n66_));
  nand3  g41(.a(new_n58_), .b(new_n36_), .c(x02), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(x12), .O(new_n68_));
  nand4  g43(.a(new_n58_), .b(new_n36_), .c(x02), .d(x01), .O(new_n69_));
  ...
  nand3  g50(.a(new_n73_), .b(new_n36_), .c(x02), .O(new_n76_));
  ...
  nor3   g56(.a(new_n27_), .b(new_n58_), .c(new_n81_), .O(z09));
