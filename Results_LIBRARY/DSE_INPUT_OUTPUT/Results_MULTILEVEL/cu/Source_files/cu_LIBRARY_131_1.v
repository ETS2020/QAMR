...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(new_n34_), .c(new_n30_), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n26_), .c(x01), .O(z03));
  inv1   g21(.a(x00), .O(new_n47_));
  nand4  g22(.a(new_n34_), .b(new_n30_), .c(x01), .d(new_n47_), .O(new_n48_));
  ...
  nand4  g27(.a(new_n26_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n35_), .O(z05));
  ...
  nand2  g40(.a(new_n65_), .b(new_n35_), .O(z06));
  nand2  g41(.a(new_n34_), .b(new_n30_), .O(new_n67_));
  nand3  g42(.a(new_n26_), .b(x05), .c(new_n28_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n67_), .c(new_n35_), .O(z07));
  ...
  nand2  g47(.a(new_n72_), .b(new_n35_), .O(z08));
  nand3  g48(.a(x13), .b(x06), .c(x01), .O(new_n74_));
