...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n43_, new_n46_, new_n47_, new_n48_, new_n51_, new_n52_,
  ...
  inv1   g19(.a(new_n33_), .O(z03));
  nand4  g20(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n40_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z04));
  aoi21  g24(.a(new_n43_), .b(x01), .c(new_n40_), .O(z05));
  nor2   g25(.a(z03), .b(x13), .O(new_n51_));
  ...
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(new_n40_), .O(new_n57_));
  ...
  nand4  g39(.a(new_n51_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n65_));
