...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(new_n29_), .c(new_n41_), .d(new_n40_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(x07), .c(x05), .d(new_n27_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z02));
  nand4  g21(.a(new_n42_), .b(new_n29_), .c(new_n41_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x07), .c(x05), .d(new_n27_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  nand4  g25(.a(new_n42_), .b(new_n29_), .c(x01), .d(new_n40_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x07), .c(x05), .d(new_n27_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nor2   g29(.a(x02), .b(new_n41_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n31_), .c(new_n42_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x07), .c(x13), .O(z05));
  ...
  aoi21  g39(.a(new_n64_), .b(new_n61_), .c(x12), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n66_));
  inv1   g41(.a(x13), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(new_n30_), .c(x02), .O(new_n68_));
  ...
  nand4  g47(.a(new_n72_), .b(x07), .c(x05), .d(new_n27_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x13), .O(z07));
  inv1   g49(.a(x12), .O(new_n75_));
  nand4  g50(.a(x13), .b(new_n75_), .c(x05), .d(new_n29_), .O(new_n76_));
  ...
  nand3  g57(.a(new_n82_), .b(x06), .c(new_n42_), .O(new_n83_));
