...
module FAU ( 
  ...
  nand2  g06(.a(x08), .b(x01), .O(new_n32_));
  ...
  nand4  g25(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n39_), .O(new_n51_));
  ...
  nand4  g30(.a(new_n55_), .b(new_n42_), .c(new_n27_), .d(x00), .O(new_n56_));
  ...
  nand4  g49(.a(new_n70_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x02), .O(z07));
  nand4  g51(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n77_));
  nand3  g52(.a(new_n45_), .b(new_n30_), .c(x02), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n32_), .c(x04), .d(new_n26_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z08));
  nand2  g56(.a(x13), .b(x06), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n32_), .O(z09));
