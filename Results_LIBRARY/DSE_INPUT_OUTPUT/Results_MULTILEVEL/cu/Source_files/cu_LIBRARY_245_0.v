...
module FAU ( 
  ...
  aoi21  g17(.a(new_n42_), .b(x09), .c(x13), .O(z02));
  ...
  nand4  g24(.a(new_n40_), .b(new_n29_), .c(x01), .d(new_n49_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x09), .c(x05), .d(new_n27_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand4  g28(.a(new_n40_), .b(new_n29_), .c(x01), .d(x00), .O(new_n54_));
  ...
  nor2   g39(.a(x11), .b(new_n44_), .O(new_n65_));
