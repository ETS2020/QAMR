...
module FAU ( 
  ...
  nand2  g13(.a(x11), .b(x02), .O(new_n39_));
  inv1   g14(.a(x00), .O(new_n40_));
  inv1   g15(.a(x01), .O(new_n41_));
  nand3  g16(.a(new_n27_), .b(new_n41_), .c(new_n40_), .O(new_n42_));
  inv1   g17(.a(x13), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(x05), .c(new_n32_), .d(new_n31_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n39_), .O(z02));
  nand4  g20(.a(new_n31_), .b(new_n27_), .c(new_n41_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n43_), .c(x05), .d(new_n32_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  nand3  g24(.a(new_n27_), .b(x01), .c(new_n40_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n44_), .c(new_n39_), .O(z04));
  nand3  g26(.a(new_n27_), .b(x01), .c(x00), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n44_), .c(new_n39_), .O(z05));
  ...
  nand3  g40(.a(new_n65_), .b(x04), .c(new_n31_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n39_), .O(z06));
  nand2  g42(.a(new_n31_), .b(new_n27_), .O(new_n68_));
  nand3  g43(.a(new_n43_), .b(x05), .c(new_n32_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n39_), .O(z07));
  nand4  g45(.a(x13), .b(new_n55_), .c(x05), .d(new_n27_), .O(new_n71_));
  nand4  g46(.a(new_n43_), .b(new_n26_), .c(new_n28_), .d(x02), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n31_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z08));
  nand3  g50(.a(new_n39_), .b(x13), .c(x06), .O(new_n76_));
  inv1   g51(.a(new_n76_), .O(z09));
  nand2  g52(.a(x05), .b(x02), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x06), .c(new_n31_), .O(new_n79_));
