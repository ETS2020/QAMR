...
module FAU ( 
  ...
  nand4  g23(.a(new_n34_), .b(new_n30_), .c(x01), .d(new_n43_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n45_), .c(x05), .d(new_n28_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nand4  g27(.a(new_n26_), .b(new_n45_), .c(new_n35_), .d(x02), .O(new_n54_));
  inv1   g28(.a(x07), .O(new_n55_));
  inv1   g29(.a(x12), .O(new_n56_));
  nor2   g30(.a(x08), .b(x01), .O(new_n57_));
  nor2   g31(.a(x10), .b(new_n44_), .O(new_n58_));
  oai21  g32(.a(new_n58_), .b(new_n57_), .c(new_n43_), .O(new_n59_));
  inv1   g33(.a(x09), .O(new_n60_));
  nand3  g34(.a(new_n60_), .b(new_n44_), .c(x00), .O(new_n61_));
  aoi21  g35(.a(new_n61_), .b(new_n59_), .c(new_n45_), .O(new_n62_));
  nand4  g36(.a(new_n62_), .b(new_n56_), .c(new_n55_), .d(x05), .O(new_n63_));
  oai21  g37(.a(new_n63_), .b(x02), .c(new_n54_), .O(new_n64_));
  nand3  g38(.a(new_n64_), .b(x04), .c(new_n34_), .O(new_n65_));
  inv1   g39(.a(new_n65_), .O(z06));
  nand2  g40(.a(new_n47_), .b(new_n26_), .O(z07));
  nand4  g41(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n68_));
  nand3  g42(.a(new_n45_), .b(new_n35_), .c(x02), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand4  g44(.a(new_n70_), .b(new_n26_), .c(x04), .d(new_n34_), .O(new_n71_));
  inv1   g45(.a(new_n71_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n26_), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n75_));
  nand3  g49(.a(new_n75_), .b(x06), .c(new_n34_), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n26_), .O(z10));
  zero   g51(.O(z05));
endmodule
