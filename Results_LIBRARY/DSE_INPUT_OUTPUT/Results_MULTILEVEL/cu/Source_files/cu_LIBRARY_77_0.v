...
module FAU ( 
  ...
  nand4  g20(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n45_), .c(new_n33_), .O(z05));
  nor2   g22(.a(z02), .b(x13), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(new_n35_), .c(x02), .O(new_n49_));
  inv1   g24(.a(x07), .O(new_n50_));
  inv1   g25(.a(x12), .O(new_n51_));
  nor2   g26(.a(x09), .b(x01), .O(new_n52_));
  inv1   g27(.a(x01), .O(new_n53_));
  nor2   g28(.a(x11), .b(new_n53_), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n52_), .c(x00), .O(new_n55_));
  inv1   g30(.a(x00), .O(new_n56_));
  inv1   g31(.a(x10), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(x01), .c(new_n56_), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(new_n55_), .c(new_n40_), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(new_n51_), .c(new_n50_), .d(x05), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(x02), .c(new_n49_), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(x04), .c(new_n34_), .O(new_n62_));
  inv1   g37(.a(new_n62_), .O(z06));
  nand4  g38(.a(new_n48_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n64_));
  nor2   g39(.a(new_n64_), .b(x02), .O(z07));
  nand4  g40(.a(x13), .b(new_n51_), .c(x05), .d(new_n29_), .O(new_n66_));
