...
module FAU ( 
  ...
  nand4  g23(.a(new_n48_), .b(new_n45_), .c(x05), .d(new_n36_), .O(new_n49_));
  ...
  nand4  g43(.a(new_n45_), .b(new_n29_), .c(x02), .d(x01), .O(new_n69_));
  ...
  nand2  g47(.a(new_n34_), .b(new_n35_), .O(new_n73_));
  nand3  g48(.a(new_n45_), .b(x05), .c(new_n36_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(new_n73_), .c(new_n27_), .O(z07));
  nand4  g50(.a(x13), .b(new_n60_), .c(x05), .d(new_n35_), .O(new_n76_));
  ...
  nor3   g55(.a(new_n26_), .b(new_n45_), .c(new_n80_), .O(z09));
