...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(new_n40_), .c(x05), .d(new_n35_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nand3  g28(.a(new_n30_), .b(x01), .c(x00), .O(new_n54_));
  nand4  g29(.a(new_n40_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n54_), .c(new_n33_), .O(z05));
  nor2   g31(.a(new_n32_), .b(x13), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n27_), .c(x02), .O(new_n58_));
