...
module FAU ( 
  ...
  nand3  g18(.a(new_n30_), .b(x01), .c(new_n44_), .O(new_n45_));
  inv1   g19(.a(x13), .O(new_n46_));
  nand4  g20(.a(new_n46_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n47_));
  oai21  g21(.a(new_n47_), .b(new_n45_), .c(new_n33_), .O(z04));
  nor3   g22(.a(x02), .b(new_n32_), .c(new_n44_), .O(new_n49_));
  nand4  g23(.a(new_n49_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n50_));
  nor2   g24(.a(new_n50_), .b(x13), .O(z05));
  nand4  g25(.a(x05), .b(x04), .c(new_n26_), .d(new_n30_), .O(new_n52_));
  ...
  nand2  g42(.a(new_n26_), .b(new_n30_), .O(new_n69_));
  nand3  g43(.a(new_n46_), .b(x05), .c(new_n35_), .O(new_n70_));
  oai21  g44(.a(new_n70_), .b(new_n69_), .c(new_n33_), .O(z07));
  nand4  g45(.a(x13), .b(new_n55_), .c(x05), .d(new_n30_), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n65_), .O(new_n73_));
  nand3  g47(.a(new_n73_), .b(x04), .c(new_n26_), .O(new_n74_));
  ...
  nand3  g52(.a(new_n78_), .b(x06), .c(new_n26_), .O(new_n79_));
