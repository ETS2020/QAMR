...
module FAU ( 
  ...
  nand3  g25(.a(new_n42_), .b(x05), .c(new_n34_), .O(new_n51_));
  ...
  nand4  g31(.a(new_n56_), .b(new_n48_), .c(x05), .d(new_n34_), .O(new_n57_));
  ...
  nor2   g40(.a(x11), .b(x10), .O(new_n66_));
  aoi22  g41(.a(new_n66_), .b(x01), .c(new_n65_), .d(new_n64_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n63_), .c(new_n42_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n32_), .b(new_n42_), .c(new_n27_), .d(x02), .O(new_n70_));
  ...
  oai21  g48(.a(new_n51_), .b(new_n49_), .c(new_n32_), .O(z07));
  ...
  nand4  g52(.a(new_n77_), .b(new_n32_), .c(x04), .d(new_n26_), .O(new_n78_));
