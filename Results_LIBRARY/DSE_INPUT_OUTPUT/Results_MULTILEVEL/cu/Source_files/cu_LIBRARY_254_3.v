...
module FAU ( 
  ...
  nand4  g46(.a(x05), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x13), .O(z07));
  nand2  g48(.a(x05), .b(new_n29_), .O(new_n74_));
  inv1   g49(.a(x09), .O(new_n75_));
  nand3  g50(.a(x13), .b(new_n57_), .c(new_n75_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(new_n74_), .c(new_n68_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n26_), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z08));
  nand3  g54(.a(x13), .b(new_n75_), .c(x06), .O(new_n80_));
