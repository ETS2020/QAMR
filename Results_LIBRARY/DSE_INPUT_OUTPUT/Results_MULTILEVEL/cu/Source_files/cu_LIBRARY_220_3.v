...
module FAU ( 
  ...
  nand4  g20(.a(new_n27_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n45_), .c(new_n36_), .O(z03));
  inv1   g22(.a(x00), .O(new_n48_));
  nand4  g23(.a(new_n35_), .b(new_n31_), .c(x01), .d(new_n48_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n27_), .c(x05), .d(new_n29_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nor3   g27(.a(x02), .b(new_n26_), .c(new_n48_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n54_));
  ...
  aoi21  g36(.a(new_n61_), .b(new_n59_), .c(new_n27_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n63_));
  nand3  g38(.a(new_n27_), .b(new_n37_), .c(x02), .O(new_n64_));
  ...
  nand2  g42(.a(new_n35_), .b(new_n31_), .O(new_n68_));
  nand3  g43(.a(new_n27_), .b(x05), .c(new_n29_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n36_), .O(z07));
  nand4  g45(.a(x13), .b(new_n57_), .c(x05), .d(new_n31_), .O(new_n71_));
  ...
  aoi21  g50(.a(new_n75_), .b(new_n26_), .c(new_n27_), .O(z09));
  nand2  g51(.a(x05), .b(x02), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n36_), .c(x06), .d(new_n35_), .O(new_n78_));
