...
module FAU ( 
  ...
  nand4  g26(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n42_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x09), .c(x05), .d(new_n27_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nor2   g30(.a(x02), .b(new_n43_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n36_), .c(new_n26_), .d(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(x09), .c(x13), .O(z05));
  ...
  nor2   g51(.a(x03), .b(x02), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(x09), .c(x05), .d(new_n27_), .O(new_n78_));
  nor2   g53(.a(new_n78_), .b(x13), .O(z07));
  inv1   g54(.a(x12), .O(new_n80_));
  nand4  g55(.a(x13), .b(new_n80_), .c(x05), .d(new_n29_), .O(new_n81_));
  nand4  g56(.a(new_n33_), .b(x09), .c(new_n30_), .d(x02), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(x04), .c(new_n26_), .O(new_n84_));
  inv1   g59(.a(new_n84_), .O(z08));
  and2   g60(.a(x13), .b(x06), .O(z09));
