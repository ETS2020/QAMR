...
module FAU ( 
  ...
  nor2   g24(.a(z02), .b(x13), .O(new_n50_));
  ...
  nand3  g32(.a(new_n57_), .b(x01), .c(new_n45_), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(new_n56_), .c(new_n40_), .O(new_n59_));
  ...
  nand3  g41(.a(new_n40_), .b(new_n30_), .c(x02), .O(new_n67_));
