...
module FAU ( 
  ...
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n54_));
  ...
  nand2  g42(.a(new_n34_), .b(new_n30_), .O(new_n68_));
  nand3  g43(.a(new_n26_), .b(x05), .c(new_n28_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n35_), .O(z07));
