...
module FAU ( 
  ...
  nand3  g19(.a(new_n31_), .b(x01), .c(new_n45_), .O(new_n46_));
  inv1   g20(.a(x13), .O(new_n47_));
  nand4  g21(.a(new_n47_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n48_));
  oai21  g22(.a(new_n48_), .b(new_n46_), .c(new_n27_), .O(z04));
  nor3   g23(.a(x02), .b(new_n26_), .c(new_n45_), .O(new_n50_));
  ...
  nand3  g43(.a(new_n47_), .b(new_n36_), .c(x02), .O(new_n70_));
