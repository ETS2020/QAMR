...
module FAU ( 
  ...
  nand4  g20(.a(new_n26_), .b(new_n30_), .c(new_n45_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n32_), .c(x05), .d(new_n36_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(x13), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand4  g25(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n50_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n41_), .c(x05), .d(new_n36_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nand3  g29(.a(new_n30_), .b(x01), .c(x00), .O(new_n55_));
  nand4  g30(.a(new_n41_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n56_));
  ...
  nand3  g41(.a(new_n41_), .b(new_n27_), .c(x02), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(x07), .O(new_n68_));
  nand4  g43(.a(new_n41_), .b(new_n27_), .c(x02), .d(x01), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n68_), .c(x04), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x03), .O(z06));
  nor2   g47(.a(new_n33_), .b(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n76_));
  ...
  nand4  g57(.a(new_n82_), .b(new_n34_), .c(x06), .d(new_n26_), .O(new_n83_));
