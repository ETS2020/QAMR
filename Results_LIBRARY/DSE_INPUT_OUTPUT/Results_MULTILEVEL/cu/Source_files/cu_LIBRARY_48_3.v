...
module FAU ( 
  ...
  aoi21  g23(.a(new_n47_), .b(new_n26_), .c(new_n27_), .O(z04));
  ...
  oai21  g29(.a(new_n55_), .b(new_n51_), .c(new_n27_), .O(new_n56_));
  nand2  g30(.a(new_n56_), .b(x00), .O(new_n57_));
  inv1   g31(.a(x08), .O(new_n58_));
  nand3  g32(.a(new_n58_), .b(new_n27_), .c(new_n26_), .O(new_n59_));
  ...
  nand3  g37(.a(new_n43_), .b(new_n37_), .c(x02), .O(new_n64_));
  ...
  nand2  g41(.a(new_n47_), .b(new_n35_), .O(z07));
  nand4  g42(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n64_), .O(new_n70_));
  nand4  g44(.a(new_n70_), .b(new_n35_), .c(x04), .d(new_n36_), .O(new_n71_));
  inv1   g45(.a(new_n71_), .O(z08));
  nand3  g46(.a(new_n35_), .b(x13), .c(x06), .O(new_n73_));
  inv1   g47(.a(new_n73_), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n75_));
  nand4  g49(.a(new_n75_), .b(new_n35_), .c(x06), .d(new_n36_), .O(new_n76_));
