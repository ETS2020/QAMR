...
module FAU ( 
  ...
  nand4  g19(.a(new_n33_), .b(new_n29_), .c(x01), .d(new_n45_), .O(new_n46_));
  ...
  nand4  g24(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n51_));
  oai21  g25(.a(new_n51_), .b(new_n50_), .c(new_n34_), .O(z05));
  nand3  g26(.a(new_n42_), .b(x05), .c(x04), .O(new_n53_));
  ...
  nand2  g32(.a(new_n58_), .b(new_n45_), .O(new_n59_));
  inv1   g33(.a(x01), .O(new_n60_));
  ...
  nand4  g39(.a(new_n65_), .b(new_n56_), .c(new_n54_), .d(x05), .O(new_n66_));
  nand3  g40(.a(new_n41_), .b(new_n35_), .c(x02), .O(new_n67_));
  oai21  g41(.a(new_n66_), .b(x02), .c(new_n67_), .O(new_n68_));
  nand3  g42(.a(new_n68_), .b(x04), .c(new_n33_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n59_), .O(z06));
  ...
  nand4  g47(.a(new_n73_), .b(new_n34_), .c(x04), .d(new_n33_), .O(new_n74_));
  inv1   g48(.a(new_n74_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n34_), .O(z09));
