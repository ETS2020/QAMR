...
module FAU ( 
  ...
  nand4  g24(.a(new_n49_), .b(x09), .c(x05), .d(new_n35_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z03));
  inv1   g26(.a(x00), .O(new_n52_));
  nand3  g27(.a(new_n30_), .b(x01), .c(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n42_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n54_));
  ...
  nand3  g35(.a(x09), .b(new_n60_), .c(new_n47_), .O(new_n61_));
  ...
  nand4  g44(.a(new_n33_), .b(new_n42_), .c(new_n27_), .d(x02), .O(new_n70_));
  ...
  oai21  g48(.a(new_n43_), .b(new_n40_), .c(new_n33_), .O(z07));
  ...
  nor3   g55(.a(new_n32_), .b(new_n42_), .c(new_n80_), .O(z09));
