...
module FAU ( 
  ...
  aoi22  g38(.a(new_n63_), .b(x01), .c(new_n62_), .d(x00), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n61_), .c(new_n42_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n66_));
  nand4  g41(.a(new_n32_), .b(new_n42_), .c(new_n30_), .d(x02), .O(new_n67_));
  ...
  oai21  g46(.a(new_n51_), .b(new_n71_), .c(new_n32_), .O(z07));
