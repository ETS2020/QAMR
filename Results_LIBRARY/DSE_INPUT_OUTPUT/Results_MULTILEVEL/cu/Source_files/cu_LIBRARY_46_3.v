...
module FAU ( 
  ...
  nand3  g23(.a(new_n42_), .b(x05), .c(new_n27_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand3  g25(.a(new_n50_), .b(new_n48_), .c(new_n39_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n47_), .c(new_n40_), .O(z04));
  nand3  g27(.a(new_n50_), .b(new_n48_), .c(x00), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n47_), .c(new_n40_), .O(z05));
  inv1   g29(.a(x12), .O(new_n55_));
  nor3   g30(.a(x09), .b(x07), .c(x01), .O(new_n56_));
  nor2   g31(.a(x11), .b(new_n40_), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(x00), .O(new_n58_));
  nor3   g33(.a(x08), .b(x07), .c(x01), .O(new_n59_));
  ...
  oai21  g43(.a(new_n49_), .b(new_n68_), .c(new_n32_), .O(z07));
