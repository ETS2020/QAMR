...
module FAU ( 
  ...
  aoi21  g25(.a(new_n50_), .b(x05), .c(x13), .O(z04));
  ...
  nand4  g40(.a(new_n65_), .b(x04), .c(new_n34_), .d(new_n35_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n28_), .O(z06));
  nand4  g42(.a(x05), .b(new_n36_), .c(new_n34_), .d(new_n35_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x13), .O(z07));
  nand3  g44(.a(x04), .b(new_n34_), .c(new_n35_), .O(new_n70_));
  nand3  g45(.a(x13), .b(new_n56_), .c(x05), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n28_), .O(z08));
