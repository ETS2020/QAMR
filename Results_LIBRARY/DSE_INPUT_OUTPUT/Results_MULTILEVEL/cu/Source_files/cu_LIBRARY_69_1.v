...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n52_,
  ...
  nor2   g25(.a(new_n28_), .b(x13), .O(new_n52_));
  nand3  g26(.a(new_n52_), .b(new_n36_), .c(x02), .O(new_n53_));
  ...
  nand4  g39(.a(new_n52_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n66_));
  nor2   g40(.a(new_n66_), .b(x02), .O(z07));
  nand4  g41(.a(x13), .b(new_n55_), .c(x05), .d(new_n31_), .O(new_n68_));
  nand3  g42(.a(new_n42_), .b(new_n36_), .c(x02), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand4  g44(.a(new_n70_), .b(new_n27_), .c(x04), .d(new_n35_), .O(new_n71_));
  inv1   g45(.a(new_n71_), .O(z08));
  inv1   g46(.a(x06), .O(new_n73_));
  nor3   g47(.a(new_n28_), .b(new_n42_), .c(new_n73_), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n75_));
  nand3  g49(.a(new_n75_), .b(x06), .c(new_n35_), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n27_), .O(z10));
  zero   g51(.O(z04));
endmodule
