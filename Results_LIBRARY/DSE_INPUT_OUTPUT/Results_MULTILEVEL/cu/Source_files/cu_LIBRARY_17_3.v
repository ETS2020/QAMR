...
module FAU ( 
  ...
  nand2  g23(.a(new_n34_), .b(new_n30_), .O(new_n49_));
  ...
  nand4  g29(.a(new_n34_), .b(new_n30_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n48_), .c(x05), .d(new_n28_), .O(new_n57_));
  ...
  nand3  g39(.a(new_n64_), .b(x01), .c(new_n63_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n62_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n48_), .O(new_n67_));
  inv1   g42(.a(x08), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(new_n43_), .c(new_n63_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n67_), .c(new_n45_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n71_));
  nand4  g46(.a(new_n26_), .b(new_n45_), .c(new_n35_), .d(x02), .O(new_n72_));
  ...
  nand2  g60(.a(new_n85_), .b(new_n26_), .O(z10));
endmodule
