...
module FAU ( 
  ...
  nand3  g26(.a(new_n51_), .b(new_n42_), .c(new_n27_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n50_), .c(new_n40_), .O(z04));
  ...
  nand3  g41(.a(new_n45_), .b(new_n30_), .c(x02), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(x07), .O(new_n68_));
  nand4  g43(.a(new_n45_), .b(new_n30_), .c(x02), .d(new_n40_), .O(new_n69_));
