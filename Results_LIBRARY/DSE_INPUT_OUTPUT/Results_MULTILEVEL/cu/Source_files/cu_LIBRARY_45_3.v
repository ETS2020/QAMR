...
module FAU ( 
  ...
  nand4  g17(.a(new_n30_), .b(new_n29_), .c(new_n36_), .d(x00), .O(new_n43_));
  ...
  nand3  g22(.a(new_n42_), .b(x05), .c(new_n31_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n30_), .c(new_n47_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n29_), .c(new_n36_), .O(z04));
  nand3  g26(.a(new_n49_), .b(new_n30_), .c(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n29_), .c(new_n36_), .O(z05));
  ...
  nand4  g38(.a(new_n42_), .b(new_n26_), .c(x02), .d(new_n36_), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(x02), .c(new_n64_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x04), .c(new_n30_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(z06));
  nand2  g42(.a(x02), .b(x01), .O(new_n68_));
  nand2  g43(.a(new_n30_), .b(new_n29_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n48_), .c(new_n68_), .O(z07));
