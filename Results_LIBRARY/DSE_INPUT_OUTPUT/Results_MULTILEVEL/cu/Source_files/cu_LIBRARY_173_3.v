...
module FAU ( 
  ...
  nand4  g41(.a(new_n66_), .b(new_n30_), .c(x04), .d(new_n26_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z06));
  nand4  g43(.a(x05), .b(new_n34_), .c(new_n26_), .d(new_n27_), .O(new_n69_));
  ...
  aoi21  g48(.a(new_n73_), .b(new_n30_), .c(new_n34_), .O(z08));
  nand3  g49(.a(new_n39_), .b(x13), .c(x06), .O(new_n75_));
