...
module FAU ( 
  ...
  nand3  g21(.a(new_n29_), .b(x01), .c(new_n39_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n43_), .c(new_n32_), .O(z04));
  nand3  g23(.a(new_n29_), .b(x01), .c(x00), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n43_), .c(new_n32_), .O(z05));
  ...
  nand2  g38(.a(new_n63_), .b(new_n32_), .O(z06));
  aoi21  g39(.a(x12), .b(x08), .c(x13), .O(new_n65_));
