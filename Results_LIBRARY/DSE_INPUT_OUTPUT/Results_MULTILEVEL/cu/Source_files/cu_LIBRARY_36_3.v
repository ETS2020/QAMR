...
module FAU ( 
  ...
  nand4  g26(.a(new_n35_), .b(new_n31_), .c(x01), .d(new_n42_), .O(new_n52_));
  ...
  nand4  g31(.a(new_n56_), .b(new_n44_), .c(new_n29_), .d(x00), .O(new_n57_));
  ...
  nand4  g44(.a(new_n47_), .b(new_n37_), .c(x02), .d(new_n26_), .O(new_n70_));
