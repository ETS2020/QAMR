...
module FAU ( 
  ...
  nand4  g20(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n40_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n41_), .c(x05), .d(new_n35_), .O(new_n48_));
  ...
  nand4  g39(.a(new_n51_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n65_));
  ...
  nand4  g44(.a(new_n69_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n70_));
