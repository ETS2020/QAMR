...
module FAU ( 
  ...
  nand4  g23(.a(new_n32_), .b(new_n44_), .c(new_n30_), .d(x02), .O(new_n50_));
  inv1   g24(.a(x07), .O(new_n51_));
  inv1   g25(.a(x12), .O(new_n52_));
  nor2   g26(.a(x08), .b(x01), .O(new_n53_));
  nor2   g27(.a(x10), .b(new_n43_), .O(new_n54_));
  oai21  g28(.a(new_n54_), .b(new_n53_), .c(new_n42_), .O(new_n55_));
  inv1   g29(.a(x09), .O(new_n56_));
  nand3  g30(.a(new_n56_), .b(new_n43_), .c(x00), .O(new_n57_));
