...
module FAU ( 
  ...
  nor2   g21(.a(new_n33_), .b(x13), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(x02), .O(z07));
  nand2  g24(.a(z07), .b(new_n42_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(new_n41_), .O(z03));
  nand3  g26(.a(new_n29_), .b(x01), .c(new_n41_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n45_), .c(new_n34_), .O(z04));
  nand3  g28(.a(new_n29_), .b(x01), .c(x00), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n45_), .c(new_n34_), .O(z05));
  ...
  nand3  g37(.a(new_n62_), .b(x01), .c(new_n41_), .O(new_n63_));
  ...
  nand3  g41(.a(new_n66_), .b(x05), .c(new_n29_), .O(new_n67_));
  nand3  g42(.a(new_n44_), .b(new_n30_), .c(x02), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n67_), .c(x09), .O(new_n69_));
  nand4  g44(.a(new_n44_), .b(x12), .c(new_n30_), .d(x02), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n69_), .c(x04), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x03), .O(z06));
  nand3  g48(.a(new_n47_), .b(new_n30_), .c(x02), .O(new_n74_));
  nor2   g49(.a(new_n30_), .b(x02), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(x13), .c(new_n57_), .d(new_n32_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n26_), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z08));
  nand2  g54(.a(x13), .b(x06), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n34_), .O(z09));
