...
module FAU ( 
  ...
  nand4  g21(.a(new_n34_), .b(new_n29_), .c(x01), .d(new_n47_), .O(new_n48_));
  inv1   g22(.a(new_n48_), .O(new_n49_));
  nand4  g23(.a(new_n49_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n50_));
  inv1   g24(.a(new_n50_), .O(z04));
  nand3  g25(.a(new_n29_), .b(x01), .c(x00), .O(new_n52_));
  nand4  g26(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n53_));
  oai21  g27(.a(new_n53_), .b(new_n52_), .c(new_n33_), .O(z05));
  nand4  g28(.a(x05), .b(x04), .c(new_n34_), .d(new_n29_), .O(new_n55_));
  ...
  nand3  g41(.a(new_n41_), .b(new_n35_), .c(x02), .O(new_n68_));
  ...
  nor2   g45(.a(new_n26_), .b(x13), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n73_));
  nor2   g47(.a(new_n73_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n75_));
  ...
  nand4  g55(.a(new_n81_), .b(new_n33_), .c(x06), .d(new_n34_), .O(new_n82_));
