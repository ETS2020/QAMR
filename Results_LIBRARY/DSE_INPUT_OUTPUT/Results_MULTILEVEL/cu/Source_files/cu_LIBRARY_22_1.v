...
module FAU ( 
  ...
  nand3  g40(.a(new_n45_), .b(new_n28_), .c(x02), .O(new_n66_));
  ...
  nand4  g44(.a(new_n45_), .b(x05), .c(new_n34_), .d(new_n31_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n27_), .c(x03), .O(z07));
  nand4  g46(.a(x13), .b(new_n57_), .c(x05), .d(new_n31_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n66_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n27_), .c(x04), .d(new_n26_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z08));
  aoi21  g50(.a(new_n45_), .b(x03), .c(new_n27_), .O(z09));
  zero   g51(.O(z10));
endmodule
