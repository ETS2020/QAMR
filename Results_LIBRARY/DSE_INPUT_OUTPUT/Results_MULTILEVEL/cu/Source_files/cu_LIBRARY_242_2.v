...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n43_), .c(x05), .d(new_n27_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  nand4  g24(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n40_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x08), .c(x05), .d(new_n27_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand4  g28(.a(new_n26_), .b(new_n29_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x08), .c(x05), .d(new_n27_), .O(new_n56_));
  ...
  nand2  g40(.a(new_n32_), .b(new_n41_), .O(new_n66_));
  ...
  aoi21  g45(.a(new_n70_), .b(new_n65_), .c(new_n43_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n72_));
  nand4  g47(.a(new_n33_), .b(new_n43_), .c(new_n30_), .d(x02), .O(new_n73_));
  ...
  nand2  g51(.a(new_n26_), .b(new_n29_), .O(new_n77_));
  nand3  g52(.a(new_n43_), .b(x05), .c(new_n27_), .O(new_n78_));
  oai21  g53(.a(new_n78_), .b(new_n77_), .c(new_n33_), .O(z07));
  nand4  g54(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n80_));
  nand3  g55(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x04), .c(new_n26_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n33_), .O(z08));
