...
module FAU ( 
  ...
  nand2  g07(.a(x07), .b(new_n32_), .O(new_n33_));
  ...
  aoi21  g24(.a(new_n49_), .b(new_n40_), .c(x01), .O(z03));
  ...
  nand3  g34(.a(new_n59_), .b(new_n40_), .c(x01), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(x00), .O(new_n62_));
  inv1   g37(.a(x08), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n32_), .O(new_n64_));
  inv1   g39(.a(x10), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(new_n40_), .c(x01), .O(new_n66_));
  ...
  nand3  g45(.a(new_n46_), .b(new_n27_), .c(x02), .O(new_n71_));
  ...
  nand2  g49(.a(new_n26_), .b(new_n30_), .O(new_n75_));
  oai21  g50(.a(new_n47_), .b(new_n75_), .c(new_n33_), .O(z07));
  nand4  g51(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n71_), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n79_));
  ...
  nand4  g58(.a(new_n83_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n84_));
