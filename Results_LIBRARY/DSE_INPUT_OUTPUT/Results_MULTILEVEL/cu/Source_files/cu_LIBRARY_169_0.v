...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x11), .c(x05), .d(new_n27_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  nand4  g20(.a(new_n26_), .b(new_n29_), .c(new_n41_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x11), .c(x05), .d(new_n27_), .O(new_n48_));
  ...
  nand3  g33(.a(x11), .b(new_n58_), .c(new_n41_), .O(new_n59_));
  ...
  nand3  g41(.a(x11), .b(new_n66_), .c(new_n41_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n65_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n40_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n63_), .c(new_n51_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n71_));
  nor2   g46(.a(new_n32_), .b(x13), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(new_n30_), .c(x02), .O(new_n73_));
  ...
  nand4  g51(.a(new_n72_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n77_));
  nor2   g52(.a(new_n77_), .b(x02), .O(z07));
  nand4  g53(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n79_));
  nand3  g54(.a(new_n51_), .b(new_n30_), .c(x02), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n82_));
  inv1   g57(.a(new_n82_), .O(z08));
  inv1   g58(.a(x06), .O(new_n84_));
  nor3   g59(.a(new_n32_), .b(new_n51_), .c(new_n84_), .O(z09));
