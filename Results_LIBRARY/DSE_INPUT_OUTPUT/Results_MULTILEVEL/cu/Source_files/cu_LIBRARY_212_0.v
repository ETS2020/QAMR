...
module FAU ( 
  ...
  nand2  g17(.a(new_n31_), .b(new_n35_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n29_), .c(new_n42_), .d(new_n41_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x08), .c(x13), .O(z02));
  nand4  g21(.a(new_n44_), .b(new_n29_), .c(new_n42_), .d(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(x08), .c(x13), .O(z03));
  nor2   g23(.a(x02), .b(new_n42_), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n44_), .c(new_n41_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x08), .c(x13), .O(z04));
  nand3  g26(.a(new_n49_), .b(new_n44_), .c(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x08), .c(x13), .O(z05));
  ...
  aoi21  g34(.a(x10), .b(x01), .c(x08), .O(new_n60_));
  ...
  nand4  g39(.a(new_n56_), .b(x08), .c(new_n30_), .d(x02), .O(new_n65_));
