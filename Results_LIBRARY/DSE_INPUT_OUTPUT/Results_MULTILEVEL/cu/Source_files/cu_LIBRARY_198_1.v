...
module FAU ( 
  ...
  nand3  g37(.a(new_n62_), .b(new_n26_), .c(x01), .O(new_n63_));
  ...
  nand3  g43(.a(new_n68_), .b(new_n26_), .c(x01), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n41_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n65_), .c(new_n51_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n73_));
  nand3  g48(.a(new_n51_), .b(new_n36_), .c(x02), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x04), .c(new_n34_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n35_), .O(z06));
  nor2   g52(.a(new_n27_), .b(x13), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n79_));
  nor2   g54(.a(new_n79_), .b(x02), .O(z07));
  nand4  g55(.a(x13), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n74_), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(new_n35_), .c(x04), .d(new_n34_), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z08));
  inv1   g59(.a(x06), .O(new_n85_));
  nor3   g60(.a(new_n27_), .b(new_n51_), .c(new_n85_), .O(z09));
  nand2  g61(.a(x05), .b(x02), .O(new_n87_));
  nand4  g62(.a(new_n87_), .b(new_n35_), .c(x06), .d(new_n34_), .O(new_n88_));
