...
module FAU ( 
  ...
  nor2   g07(.a(new_n32_), .b(x08), .O(new_n33_));
  ...
  aoi21  g32(.a(new_n57_), .b(new_n55_), .c(new_n41_), .O(new_n58_));
  inv1   g33(.a(x10), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(x01), .c(new_n41_), .O(new_n60_));
  inv1   g35(.a(new_n60_), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(new_n58_), .c(new_n32_), .O(new_n62_));
  ...
  nand4  g40(.a(new_n65_), .b(new_n53_), .c(x05), .d(new_n29_), .O(new_n66_));
  nand3  g41(.a(new_n44_), .b(new_n30_), .c(x02), .O(new_n67_));
  ...
  nor2   g45(.a(new_n33_), .b(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand3  g48(.a(new_n71_), .b(new_n30_), .c(x02), .O(new_n74_));
  nand4  g49(.a(x13), .b(new_n32_), .c(x05), .d(new_n29_), .O(new_n75_));
  ...
  nor3   g54(.a(new_n33_), .b(new_n44_), .c(new_n79_), .O(z09));
