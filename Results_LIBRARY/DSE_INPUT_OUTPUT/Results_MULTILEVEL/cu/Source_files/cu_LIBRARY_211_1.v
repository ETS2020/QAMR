...
module FAU ( 
  ...
  nand3  g12(.a(new_n37_), .b(new_n27_), .c(new_n26_), .O(new_n38_));
  ...
  nand4  g18(.a(new_n43_), .b(new_n27_), .c(x05), .d(new_n31_), .O(new_n44_));
  ...
  nand4  g51(.a(new_n76_), .b(new_n27_), .c(x04), .d(new_n26_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z08));
  nand2  g53(.a(x13), .b(x06), .O(new_n79_));
  oai21  g54(.a(new_n27_), .b(x03), .c(new_n79_), .O(z09));
  oai21  g55(.a(new_n29_), .b(new_n28_), .c(x06), .O(new_n81_));
  aoi21  g56(.a(new_n81_), .b(new_n27_), .c(x03), .O(z10));
endmodule
