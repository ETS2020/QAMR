...
module FAU ( 
  ...
  nand3  g16(.a(new_n30_), .b(new_n41_), .c(new_n26_), .O(new_n42_));
  ...
  nand4  g22(.a(new_n47_), .b(x11), .c(x05), .d(new_n28_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(x13), .O(z03));
  inv1   g24(.a(x13), .O(new_n50_));
  nand4  g25(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n26_), .O(new_n51_));
  ...
  nand4  g30(.a(new_n55_), .b(new_n43_), .c(new_n28_), .d(x01), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x11), .c(new_n26_), .O(z05));
  nand4  g32(.a(x04), .b(new_n35_), .c(new_n30_), .d(new_n41_), .O(new_n58_));
  inv1   g33(.a(x07), .O(new_n59_));
  inv1   g34(.a(x09), .O(new_n60_));
  nor2   g35(.a(new_n50_), .b(x12), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n58_), .c(x11), .O(new_n63_));
  ...
  nand4  g45(.a(new_n70_), .b(x13), .c(new_n65_), .d(new_n59_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n73_));
  nand3  g48(.a(new_n50_), .b(new_n36_), .c(x02), .O(new_n74_));
  ...
  nand3  g55(.a(new_n61_), .b(x05), .c(new_n30_), .O(new_n81_));
