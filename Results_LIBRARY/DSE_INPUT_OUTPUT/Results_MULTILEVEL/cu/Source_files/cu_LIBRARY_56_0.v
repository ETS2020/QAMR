...
module FAU ( 
  ...
  aoi21  g20(.a(new_n45_), .b(x06), .c(x01), .O(z02));
  nand3  g21(.a(new_n44_), .b(new_n41_), .c(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(x06), .c(x01), .O(z03));
  nand3  g23(.a(new_n29_), .b(x01), .c(new_n40_), .O(new_n49_));
  nand4  g24(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n50_));
  ...
  nand3  g32(.a(new_n57_), .b(x06), .c(new_n56_), .O(new_n58_));
  ...
  aoi21  g43(.a(new_n68_), .b(new_n62_), .c(new_n42_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n55_), .c(new_n54_), .d(x05), .O(new_n70_));
  nand4  g45(.a(new_n34_), .b(new_n42_), .c(new_n35_), .d(x02), .O(new_n71_));
  ...
  inv1   g49(.a(new_n41_), .O(new_n75_));
  oai21  g50(.a(new_n43_), .b(new_n75_), .c(new_n34_), .O(z07));
  nand4  g51(.a(x13), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n77_));
  nand3  g52(.a(new_n42_), .b(new_n35_), .c(x02), .O(new_n78_));
