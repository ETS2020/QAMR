...
module FAU ( 
  ...
  aoi21  g25(.a(new_n50_), .b(new_n30_), .c(x04), .O(z03));
  ...
  aoi21  g31(.a(new_n56_), .b(new_n30_), .c(x04), .O(z05));
  ...
  nand4  g40(.a(new_n65_), .b(new_n58_), .c(new_n30_), .d(x05), .O(new_n66_));
  nand3  g41(.a(new_n47_), .b(new_n35_), .c(x02), .O(new_n67_));
