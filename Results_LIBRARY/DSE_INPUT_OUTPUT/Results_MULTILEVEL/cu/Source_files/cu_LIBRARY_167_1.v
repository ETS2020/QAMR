...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(new_n30_), .c(x05), .d(new_n27_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z03));
  nor2   g22(.a(x02), .b(new_n39_), .O(new_n48_));
  nor2   g23(.a(x13), .b(new_n34_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n48_), .c(new_n26_), .d(new_n38_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n30_), .c(x04), .O(z04));
  nand4  g26(.a(new_n26_), .b(new_n29_), .c(x01), .d(x00), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n30_), .c(x05), .d(new_n27_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z05));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x12), .O(new_n57_));
  inv1   g32(.a(x13), .O(new_n58_));
  nor2   g33(.a(x09), .b(x01), .O(new_n59_));
  nor2   g34(.a(x11), .b(new_n39_), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n59_), .c(x00), .O(new_n61_));
  nor2   g36(.a(x08), .b(x01), .O(new_n62_));
  nor2   g37(.a(x10), .b(new_n39_), .O(new_n63_));
  oai21  g38(.a(new_n63_), .b(new_n62_), .c(new_n38_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n61_), .c(new_n58_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n66_));
  nand3  g41(.a(new_n58_), .b(new_n34_), .c(x02), .O(new_n67_));
  oai21  g42(.a(new_n66_), .b(x02), .c(new_n67_), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(x04), .c(new_n26_), .O(new_n69_));
  nand2  g44(.a(x10), .b(new_n27_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(z06));
  nand3  g46(.a(new_n49_), .b(new_n26_), .c(new_n29_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n30_), .c(x04), .O(z07));
  ...
  nand2  g51(.a(new_n76_), .b(new_n70_), .O(z08));
  nand2  g52(.a(x13), .b(x06), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n70_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n70_), .c(x06), .d(new_n26_), .O(new_n81_));
