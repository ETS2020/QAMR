...
module FAU ( 
  ...
  nand4  g26(.a(new_n45_), .b(new_n30_), .c(x01), .d(new_n42_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n26_), .c(x13), .O(z04));
  nand4  g28(.a(new_n36_), .b(new_n30_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n26_), .c(x05), .d(new_n28_), .O(new_n56_));
  ...
  nand4  g51(.a(new_n60_), .b(new_n26_), .c(new_n31_), .d(x02), .O(new_n77_));
  ...
  nand2  g58(.a(new_n83_), .b(new_n37_), .O(z10));
endmodule
