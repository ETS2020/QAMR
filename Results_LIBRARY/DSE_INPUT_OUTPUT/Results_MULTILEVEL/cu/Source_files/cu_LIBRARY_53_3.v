...
module FAU ( 
  ...
  nand2  g08(.a(x13), .b(x01), .O(new_n34_));
  nand4  g09(.a(new_n34_), .b(new_n33_), .c(new_n28_), .d(new_n26_), .O(z00));
  nand3  g10(.a(new_n30_), .b(x04), .c(x02), .O(new_n36_));
  oai21  g11(.a(new_n32_), .b(x02), .c(new_n36_), .O(new_n37_));
  nand3  g12(.a(new_n37_), .b(new_n34_), .c(new_n26_), .O(new_n38_));
  ...
  nand4  g24(.a(new_n31_), .b(new_n26_), .c(new_n29_), .d(new_n49_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n43_), .c(new_n44_), .O(z04));
  nand4  g26(.a(new_n31_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n43_), .c(new_n44_), .O(z05));
  inv1   g28(.a(x07), .O(new_n54_));
  inv1   g29(.a(x12), .O(new_n55_));
  inv1   g30(.a(x08), .O(new_n56_));
  nand2  g31(.a(new_n56_), .b(new_n49_), .O(new_n57_));
  ...
  nand4  g37(.a(new_n62_), .b(x05), .c(new_n29_), .d(new_n44_), .O(new_n63_));
  ...
  nand3  g43(.a(new_n43_), .b(x05), .c(new_n27_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n34_), .O(z07));
  nand4  g45(.a(x13), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n71_));
  ...
  nand3  g49(.a(x13), .b(x06), .c(new_n44_), .O(new_n75_));
