...
module FAU ( 
  ...
  nand4  g30(.a(new_n44_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(new_n27_), .O(z05));
  ...
  nand4  g42(.a(new_n27_), .b(new_n44_), .c(new_n36_), .d(x02), .O(new_n68_));
  ...
  inv1   g46(.a(new_n43_), .O(new_n72_));
  oai21  g47(.a(new_n45_), .b(new_n72_), .c(new_n27_), .O(z07));
  nand4  g48(.a(x13), .b(new_n59_), .c(x05), .d(new_n31_), .O(new_n74_));
  nand3  g49(.a(new_n44_), .b(new_n36_), .c(x02), .O(new_n75_));
  ...
  aoi21  g53(.a(new_n44_), .b(x01), .c(new_n41_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(x06), .c(new_n35_), .d(x01), .O(new_n81_));
