...
module FAU ( 
  ...
  nor3   g23(.a(x02), .b(new_n43_), .c(new_n32_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z05));
  nand4  g26(.a(new_n33_), .b(new_n45_), .c(new_n30_), .d(x02), .O(new_n52_));
  ...
  aoi21  g34(.a(new_n59_), .b(new_n57_), .c(new_n45_), .O(new_n60_));
