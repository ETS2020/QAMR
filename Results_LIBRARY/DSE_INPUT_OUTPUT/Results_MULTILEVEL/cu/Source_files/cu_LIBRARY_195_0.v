...
module FAU ( 
  ...
  nand4  g21(.a(new_n34_), .b(new_n29_), .c(new_n41_), .d(x00), .O(new_n47_));
  ...
  nand4  g38(.a(x10), .b(new_n63_), .c(new_n41_), .d(new_n40_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n62_), .c(new_n46_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n66_));
  nor2   g41(.a(new_n26_), .b(x13), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(new_n35_), .c(x02), .O(new_n68_));
  ...
  nand4  g46(.a(new_n67_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n72_));
  ...
  nor3   g54(.a(new_n26_), .b(new_n46_), .c(new_n79_), .O(z09));
