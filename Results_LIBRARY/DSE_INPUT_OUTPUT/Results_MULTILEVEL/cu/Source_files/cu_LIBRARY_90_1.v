...
module FAU ( 
  ...
  nand4  g24(.a(new_n49_), .b(new_n40_), .c(x05), .d(new_n27_), .O(new_n50_));
  ...
  oai21  g47(.a(new_n44_), .b(new_n41_), .c(new_n33_), .O(z07));
  nand4  g48(.a(x13), .b(new_n61_), .c(x05), .d(new_n29_), .O(new_n74_));
  nand3  g49(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n75_));
