...
module FAU ( 
  ...
  nand2  g06(.a(x11), .b(x07), .O(new_n32_));
  ...
  nand4  g15(.a(new_n32_), .b(new_n40_), .c(x05), .d(new_n34_), .O(new_n41_));
  nor3   g16(.a(new_n41_), .b(x03), .c(x02), .O(z07));
  nand2  g17(.a(z07), .b(new_n39_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(x00), .O(z02));
  nand3  g19(.a(new_n30_), .b(new_n39_), .c(x00), .O(new_n45_));
  nand4  g20(.a(new_n40_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n45_), .c(new_n32_), .O(z03));
  nand2  g22(.a(z07), .b(x01), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(x00), .O(z04));
  inv1   g24(.a(x00), .O(new_n50_));
  nor2   g25(.a(new_n48_), .b(new_n50_), .O(z05));
  inv1   g26(.a(x12), .O(new_n52_));
  nor2   g27(.a(x08), .b(x01), .O(new_n53_));
  nor2   g28(.a(x10), .b(new_n39_), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n53_), .c(new_n50_), .O(new_n55_));
  aoi21  g30(.a(x11), .b(x01), .c(x09), .O(new_n56_));
  ...
  nand4  g34(.a(new_n59_), .b(new_n52_), .c(x05), .d(new_n30_), .O(new_n60_));
  ...
  nand4  g38(.a(new_n40_), .b(new_n63_), .c(new_n27_), .d(x02), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(new_n62_), .c(x04), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(x03), .O(z06));
  nand4  g42(.a(x13), .b(new_n52_), .c(x05), .d(new_n30_), .O(new_n68_));
