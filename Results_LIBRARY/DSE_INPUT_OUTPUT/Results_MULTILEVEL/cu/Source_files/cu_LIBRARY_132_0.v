...
module FAU ( 
  ...
  nand4  g22(.a(new_n48_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n49_));
  ...
  nand3  g37(.a(new_n41_), .b(new_n27_), .c(x02), .O(new_n64_));
  ...
  nand4  g42(.a(new_n68_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n69_));
