...
module FAU ( 
  ...
  nand4  g36(.a(x10), .b(new_n61_), .c(new_n41_), .d(new_n32_), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n60_), .c(new_n47_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n64_));
  nand4  g39(.a(new_n34_), .b(new_n47_), .c(new_n27_), .d(x02), .O(new_n65_));
  ...
  oai21  g44(.a(new_n50_), .b(new_n69_), .c(new_n34_), .O(z07));
