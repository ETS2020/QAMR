...
module FAU ( 
  ...
  nand4  g20(.a(new_n27_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n45_), .c(new_n35_), .O(z03));
  inv1   g22(.a(x00), .O(new_n48_));
  nand4  g23(.a(new_n36_), .b(new_n31_), .c(x01), .d(new_n48_), .O(new_n49_));
  ...
  nand4  g28(.a(new_n53_), .b(new_n36_), .c(new_n31_), .d(x00), .O(new_n54_));
  ...
  nand4  g42(.a(x05), .b(new_n29_), .c(new_n36_), .d(new_n31_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x13), .O(z07));
  nand4  g44(.a(x13), .b(new_n57_), .c(x05), .d(new_n31_), .O(new_n70_));
  ...
  nand3  g48(.a(x13), .b(x06), .c(new_n26_), .O(new_n74_));
