...
module FAU ( 
  ...
  nand3  g19(.a(new_n29_), .b(x01), .c(new_n32_), .O(new_n45_));
  ...
  nand3  g23(.a(new_n42_), .b(x05), .c(x04), .O(new_n49_));
  ...
  nand3  g34(.a(new_n59_), .b(x01), .c(new_n32_), .O(new_n60_));
  ...
  nor2   g41(.a(z03), .b(x13), .O(new_n67_));
  ...
  nor3   g49(.a(z03), .b(new_n41_), .c(new_n74_), .O(z09));
