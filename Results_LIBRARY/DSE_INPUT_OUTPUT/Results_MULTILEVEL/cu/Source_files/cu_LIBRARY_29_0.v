...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x06), .c(x05), .d(new_n27_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  nand4  g20(.a(new_n26_), .b(new_n29_), .c(new_n32_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x06), .c(x05), .d(new_n27_), .O(new_n48_));
  ...
  oai21  g48(.a(new_n73_), .b(new_n72_), .c(new_n34_), .O(z07));
  ...
  oai21  g53(.a(new_n50_), .b(new_n33_), .c(new_n34_), .O(z09));
