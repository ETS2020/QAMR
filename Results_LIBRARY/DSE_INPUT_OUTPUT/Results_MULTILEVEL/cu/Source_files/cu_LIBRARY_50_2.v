...
module FAU ( 
  ...
  nand3  g06(.a(x10), .b(new_n31_), .c(x04), .O(new_n32_));
  ...
  nand2  g12(.a(new_n26_), .b(new_n27_), .O(new_n38_));
  oai21  g13(.a(new_n38_), .b(new_n29_), .c(new_n37_), .O(z01));
  nor2   g14(.a(x10), .b(new_n27_), .O(new_n40_));
  ...
  nor3   g38(.a(x08), .b(x01), .c(x00), .O(new_n64_));
  oai21  g39(.a(new_n64_), .b(new_n63_), .c(new_n27_), .O(new_n65_));
  ...
  nand3  g44(.a(new_n45_), .b(new_n31_), .c(x02), .O(new_n70_));
  ...
  nor4   g48(.a(new_n38_), .b(x13), .c(new_n31_), .d(x04), .O(z07));
  nor2   g49(.a(new_n28_), .b(x03), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n45_), .c(new_n31_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(x10), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(x02), .O(new_n78_));
  nor2   g53(.a(new_n45_), .b(x12), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n75_), .c(x05), .d(new_n27_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n78_), .O(z08));
  inv1   g56(.a(x06), .O(new_n82_));
  nor3   g57(.a(new_n40_), .b(new_n45_), .c(new_n82_), .O(z09));
  nand2  g58(.a(x05), .b(x02), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x06), .c(new_n26_), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n41_), .O(z10));
endmodule
