...
module FAU ( 
  ...
  aoi21  g14(.a(new_n39_), .b(new_n29_), .c(new_n30_), .O(z02));
  ...
  nand4  g20(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n36_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z04));
  nor3   g24(.a(x02), .b(new_n37_), .c(new_n36_), .O(new_n50_));
  ...
  aoi21  g43(.a(new_n68_), .b(new_n29_), .c(new_n30_), .O(z07));
  nand4  g44(.a(x13), .b(new_n54_), .c(x05), .d(new_n29_), .O(new_n70_));
  nand3  g45(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n71_));
  ...
  oai21  g52(.a(new_n77_), .b(x03), .c(new_n66_), .O(z10));
endmodule
