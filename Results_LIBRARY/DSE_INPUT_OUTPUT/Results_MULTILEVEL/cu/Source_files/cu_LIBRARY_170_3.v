...
module FAU ( 
  ...
  nand4  g27(.a(new_n32_), .b(new_n44_), .c(new_n30_), .d(x02), .O(new_n53_));
  inv1   g28(.a(x07), .O(new_n54_));
  inv1   g29(.a(x12), .O(new_n55_));
  nor2   g30(.a(x08), .b(x01), .O(new_n56_));
  nor2   g31(.a(x10), .b(new_n43_), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(new_n42_), .O(new_n58_));
  inv1   g33(.a(x09), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(new_n43_), .c(x00), .O(new_n60_));
  ...
  nand2  g45(.a(new_n70_), .b(new_n32_), .O(z08));
  nand3  g46(.a(new_n32_), .b(x13), .c(x06), .O(new_n72_));
