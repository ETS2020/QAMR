...
module FAU ( 
  ...
  oai21  g03(.a(new_n28_), .b(x03), .c(x11), .O(new_n29_));
  ...
  nand3  g38(.a(new_n63_), .b(new_n26_), .c(new_n40_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n58_), .c(new_n43_), .O(new_n65_));
  ...
  nand2  g45(.a(new_n30_), .b(new_n26_), .O(new_n71_));
  nand3  g46(.a(new_n43_), .b(x05), .c(new_n31_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n71_), .c(new_n39_), .O(z07));
  nand4  g48(.a(x13), .b(new_n55_), .c(x05), .d(new_n26_), .O(new_n74_));
  nand4  g49(.a(new_n43_), .b(x11), .c(new_n27_), .d(x02), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x04), .c(new_n30_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z08));
  inv1   g53(.a(x06), .O(new_n79_));
  nor3   g54(.a(new_n38_), .b(new_n43_), .c(new_n79_), .O(z09));
  nand2  g55(.a(x05), .b(x02), .O(new_n81_));
  nand3  g56(.a(new_n81_), .b(x06), .c(new_n30_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n39_), .O(z10));
endmodule
