...
module FAU ( 
  ...
  aoi21  g23(.a(new_n48_), .b(new_n32_), .c(x01), .O(z03));
  nand3  g24(.a(new_n29_), .b(x01), .c(new_n41_), .O(new_n50_));
  nand4  g25(.a(new_n43_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(new_n34_), .O(z04));
  nand3  g27(.a(new_n29_), .b(x01), .c(x00), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n51_), .c(new_n34_), .O(z05));
  ...
  nand3  g34(.a(new_n59_), .b(new_n32_), .c(x01), .O(new_n60_));
  ...
  nand3  g40(.a(new_n65_), .b(new_n32_), .c(x01), .O(new_n66_));
  ...
  nand4  g44(.a(new_n69_), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n70_));
  ...
  oai21  g50(.a(new_n44_), .b(new_n75_), .c(new_n34_), .O(z07));
  ...
  nor3   g56(.a(new_n33_), .b(new_n43_), .c(new_n81_), .O(z09));
  nand2  g57(.a(x05), .b(x02), .O(new_n83_));
  nand4  g58(.a(new_n83_), .b(new_n34_), .c(x06), .d(new_n26_), .O(new_n84_));
