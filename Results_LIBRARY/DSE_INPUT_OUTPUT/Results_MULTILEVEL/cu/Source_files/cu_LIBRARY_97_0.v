...
module FAU ( 
  ...
  nand3  g06(.a(x05), .b(new_n27_), .c(new_n31_), .O(new_n32_));
  ...
  nand4  g12(.a(new_n37_), .b(x05), .c(new_n27_), .d(new_n36_), .O(new_n38_));
  nor2   g13(.a(new_n38_), .b(x13), .O(z02));
  inv1   g14(.a(x13), .O(new_n40_));
  inv1   g15(.a(x01), .O(new_n41_));
  nand4  g16(.a(new_n36_), .b(new_n31_), .c(new_n41_), .d(x00), .O(new_n42_));
  ...
  nand4  g21(.a(new_n36_), .b(new_n31_), .c(x01), .d(new_n46_), .O(new_n47_));
  ...
  nand4  g26(.a(new_n51_), .b(x05), .c(new_n27_), .d(new_n36_), .O(new_n52_));
  ...
  nand4  g40(.a(new_n40_), .b(new_n33_), .c(x04), .d(new_n36_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(z06));
  nand3  g42(.a(new_n40_), .b(new_n27_), .c(new_n36_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(x05), .c(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n55_), .c(x05), .d(new_n31_), .O(new_n70_));
  nand3  g45(.a(new_n40_), .b(new_n33_), .c(x02), .O(new_n71_));
  ...
  aoi21  g52(.a(x06), .b(new_n36_), .c(new_n33_), .O(new_n78_));
  nand3  g53(.a(x06), .b(new_n33_), .c(new_n36_), .O(new_n79_));
  oai21  g54(.a(new_n78_), .b(x02), .c(new_n79_), .O(z10));
endmodule
