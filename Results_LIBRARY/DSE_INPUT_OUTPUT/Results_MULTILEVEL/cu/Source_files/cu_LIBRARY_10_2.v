...
module FAU ( 
  ...
  nand3  g16(.a(new_n29_), .b(new_n41_), .c(x00), .O(new_n42_));
  inv1   g17(.a(x13), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n40_), .O(z03));
  inv1   g20(.a(x00), .O(new_n46_));
  nand3  g21(.a(new_n29_), .b(x01), .c(new_n46_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n44_), .c(new_n40_), .O(z04));
  ...
  aoi21  g33(.a(new_n58_), .b(new_n55_), .c(new_n43_), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(new_n52_), .c(new_n39_), .d(x05), .O(new_n60_));
  nand4  g35(.a(new_n43_), .b(new_n30_), .c(new_n26_), .d(x02), .O(new_n61_));
  oai21  g36(.a(new_n60_), .b(x02), .c(new_n61_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(x04), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n40_), .O(z06));
  nand2  g39(.a(new_n26_), .b(new_n29_), .O(new_n65_));
  nand3  g40(.a(new_n43_), .b(x05), .c(new_n27_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(new_n40_), .O(z07));
  nand4  g42(.a(x13), .b(new_n52_), .c(x05), .d(new_n29_), .O(new_n68_));
  nand3  g43(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n69_));
