...
module FAU ( 
  ...
  nand4  g20(.a(new_n27_), .b(new_n28_), .c(new_n45_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n44_), .c(x05), .d(new_n31_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  nand3  g24(.a(new_n44_), .b(x05), .c(new_n31_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n28_), .c(x01), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n27_), .c(x00), .O(z04));
  nor3   g28(.a(x02), .b(new_n45_), .c(new_n26_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n31_), .d(new_n27_), .O(new_n55_));
  ...
  oai21  g38(.a(new_n63_), .b(new_n62_), .c(new_n26_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n61_), .c(new_n44_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n66_));
  nand3  g41(.a(new_n44_), .b(new_n29_), .c(x02), .O(new_n67_));
  oai21  g42(.a(new_n66_), .b(x02), .c(new_n67_), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(x04), .c(new_n27_), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z06));
  nand2  g45(.a(new_n27_), .b(new_n28_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n50_), .c(new_n39_), .O(z07));
  nand4  g47(.a(x13), .b(new_n58_), .c(x05), .d(new_n28_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n67_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x04), .c(new_n27_), .O(new_n75_));
  ...
  nand3  g54(.a(new_n79_), .b(x06), .c(new_n27_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n39_), .O(z10));
endmodule
