...
module FAU ( 
  ...
  nand4  g40(.a(new_n65_), .b(new_n57_), .c(new_n38_), .d(x05), .O(new_n66_));
  nand4  g41(.a(new_n58_), .b(new_n34_), .c(x04), .d(x02), .O(new_n67_));
  ...
  nand3  g48(.a(new_n58_), .b(new_n34_), .c(x02), .O(new_n74_));
