...
module FAU ( 
  ...
  oai21  g32(.a(new_n58_), .b(new_n54_), .c(new_n43_), .O(new_n59_));
  nand2  g33(.a(new_n59_), .b(x00), .O(new_n60_));
  inv1   g34(.a(x08), .O(new_n61_));
  nand3  g35(.a(new_n61_), .b(new_n43_), .c(new_n48_), .O(new_n62_));
  ...
  oai21  g46(.a(new_n72_), .b(new_n71_), .c(new_n32_), .O(z07));
  nand4  g47(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n74_));
  nand2  g48(.a(new_n74_), .b(new_n67_), .O(new_n75_));
  nand4  g49(.a(new_n75_), .b(new_n32_), .c(x04), .d(new_n26_), .O(new_n76_));
  inv1   g50(.a(new_n76_), .O(z08));
  nand2  g51(.a(x13), .b(x06), .O(new_n78_));
  nand2  g52(.a(new_n78_), .b(new_n32_), .O(z09));
  nand2  g53(.a(x05), .b(x02), .O(new_n80_));
  nand4  g54(.a(new_n80_), .b(new_n32_), .c(x06), .d(new_n26_), .O(new_n81_));
