...
module FAU ( 
  ...
  nand4  g43(.a(new_n68_), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n69_));
  nand3  g44(.a(new_n27_), .b(new_n37_), .c(x02), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n36_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z06));
  nand4  g48(.a(x05), .b(new_n29_), .c(new_n36_), .d(new_n31_), .O(new_n74_));
