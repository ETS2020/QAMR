...
module FAU ( 
  ...
  nor2   g14(.a(x13), .b(x04), .O(new_n40_));
  nand4  g15(.a(new_n40_), .b(new_n26_), .c(new_n27_), .d(x00), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(x05), .c(x01), .O(z03));
  ...
  nand4  g25(.a(new_n50_), .b(x05), .c(new_n33_), .d(new_n26_), .O(new_n51_));
  ...
  nand3  g32(.a(new_n57_), .b(x05), .c(x01), .O(new_n58_));
  ...
  nand3  g38(.a(new_n63_), .b(x05), .c(x01), .O(new_n64_));
