...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n26_), .c(x05), .d(new_n32_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand3  g25(.a(x05), .b(new_n35_), .c(new_n36_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(x01), .c(new_n50_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n32_), .c(x13), .O(z04));
  ...
  nand4  g43(.a(new_n68_), .b(x05), .c(x04), .d(new_n35_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z06));
  aoi21  g45(.a(new_n51_), .b(new_n32_), .c(x13), .O(z07));
  nand4  g46(.a(new_n59_), .b(x05), .c(new_n35_), .d(new_n36_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(x13), .c(new_n32_), .O(z08));
