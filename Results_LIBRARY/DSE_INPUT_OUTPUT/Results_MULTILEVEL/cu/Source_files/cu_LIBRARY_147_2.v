...
module FAU ( 
  ...
  nand3  g10(.a(new_n35_), .b(new_n34_), .c(new_n26_), .O(new_n36_));
  and2   g11(.a(new_n36_), .b(new_n27_), .O(z01));
  inv1   g12(.a(x13), .O(new_n38_));
  nor2   g13(.a(x02), .b(x00), .O(new_n39_));
  nand4  g14(.a(new_n39_), .b(new_n38_), .c(x05), .d(new_n28_), .O(new_n40_));
  aoi21  g15(.a(new_n40_), .b(new_n26_), .c(x03), .O(z02));
  nand4  g16(.a(new_n27_), .b(new_n30_), .c(new_n26_), .d(x00), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n38_), .c(x05), .d(new_n28_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z03));
  nor2   g20(.a(x03), .b(new_n26_), .O(z04));
  ...
  aoi21  g28(.a(new_n54_), .b(new_n52_), .c(new_n38_), .O(new_n55_));
  nand4  g29(.a(new_n55_), .b(new_n49_), .c(new_n48_), .d(x05), .O(new_n56_));
  nand3  g30(.a(new_n38_), .b(new_n31_), .c(x02), .O(new_n57_));
  oai21  g31(.a(new_n56_), .b(x02), .c(new_n57_), .O(new_n58_));
  nand2  g32(.a(new_n58_), .b(x04), .O(new_n59_));
  aoi21  g33(.a(new_n59_), .b(new_n26_), .c(x03), .O(z06));
  nor2   g34(.a(x02), .b(x01), .O(new_n61_));
  nand4  g35(.a(new_n61_), .b(x05), .c(new_n28_), .d(new_n27_), .O(new_n62_));
  nor2   g36(.a(new_n62_), .b(x13), .O(z07));
  nand4  g37(.a(x13), .b(new_n49_), .c(x05), .d(new_n30_), .O(new_n64_));
  nand2  g38(.a(new_n64_), .b(new_n57_), .O(new_n65_));
  nand4  g39(.a(new_n65_), .b(x04), .c(new_n27_), .d(new_n26_), .O(new_n66_));
  inv1   g40(.a(new_n66_), .O(z08));
  nand2  g41(.a(x13), .b(x06), .O(new_n68_));
  oai21  g42(.a(x03), .b(new_n26_), .c(new_n68_), .O(z09));
  nand2  g43(.a(x05), .b(x02), .O(new_n70_));
  nand4  g44(.a(new_n70_), .b(x06), .c(new_n27_), .d(new_n26_), .O(new_n71_));
