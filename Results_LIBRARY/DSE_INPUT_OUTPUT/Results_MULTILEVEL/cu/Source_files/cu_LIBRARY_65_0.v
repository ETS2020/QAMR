...
module FAU ( 
  ...
  nand4  g23(.a(new_n48_), .b(new_n34_), .c(new_n29_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x12), .c(x01), .O(z03));
  nand3  g25(.a(new_n29_), .b(x01), .c(new_n40_), .O(new_n51_));
  nand4  g26(.a(new_n46_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n52_));
  ...
  nand4  g31(.a(new_n33_), .b(new_n46_), .c(new_n35_), .d(x02), .O(new_n57_));
  ...
  nand2  g45(.a(new_n34_), .b(new_n29_), .O(new_n71_));
  oai21  g46(.a(new_n47_), .b(new_n71_), .c(new_n33_), .O(z07));
  nand4  g47(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n73_));
  nand3  g48(.a(new_n46_), .b(new_n35_), .c(x02), .O(new_n74_));
  ...
  nor3   g53(.a(new_n26_), .b(new_n46_), .c(new_n78_), .O(z09));
