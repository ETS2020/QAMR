...
module FAU ( 
  ...
  nand4  g23(.a(new_n46_), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n49_));
  ...
  nand4  g40(.a(new_n51_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(x02), .O(z07));
  nand4  g42(.a(x13), .b(new_n54_), .c(x05), .d(new_n29_), .O(new_n68_));
  nand3  g43(.a(new_n55_), .b(new_n30_), .c(x02), .O(new_n69_));
