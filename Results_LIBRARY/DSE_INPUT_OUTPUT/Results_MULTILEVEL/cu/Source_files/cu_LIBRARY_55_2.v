...
module FAU ( 
  ...
  nand2  g30(.a(x09), .b(x01), .O(new_n56_));
  oai21  g31(.a(x09), .b(x08), .c(new_n56_), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n55_), .c(x00), .O(new_n58_));
  inv1   g33(.a(x08), .O(new_n59_));
  aoi21  g34(.a(x10), .b(x01), .c(x00), .O(new_n60_));
  nor2   g35(.a(x09), .b(x01), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(new_n60_), .c(new_n59_), .O(new_n62_));
  inv1   g37(.a(x10), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(x09), .c(x01), .d(new_n40_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(new_n62_), .c(new_n58_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(x13), .c(new_n54_), .d(new_n53_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x05), .c(new_n30_), .O(new_n68_));
  nand4  g43(.a(new_n33_), .b(new_n43_), .c(new_n27_), .d(x02), .O(new_n69_));
  ...
  nand3  g48(.a(new_n43_), .b(new_n27_), .c(x02), .O(new_n74_));
