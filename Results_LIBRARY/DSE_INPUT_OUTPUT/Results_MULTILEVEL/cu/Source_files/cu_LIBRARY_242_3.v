...
module FAU ( 
  ...
  nand4  g24(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n39_), .O(new_n50_));
  ...
  nand4  g30(.a(new_n55_), .b(new_n49_), .c(x05), .d(new_n27_), .O(new_n56_));
  ...
  nand3  g41(.a(new_n66_), .b(new_n49_), .c(new_n39_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n65_), .c(new_n42_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n32_), .b(new_n42_), .c(new_n30_), .d(x02), .O(new_n70_));
  ...
  nand2  g48(.a(new_n26_), .b(new_n29_), .O(new_n74_));
  nand3  g49(.a(new_n42_), .b(x05), .c(new_n27_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n74_), .c(new_n32_), .O(z07));
  nand4  g51(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n77_));
  nand3  g52(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n78_));
  ...
  nand4  g59(.a(new_n84_), .b(new_n32_), .c(x06), .d(new_n26_), .O(new_n85_));
