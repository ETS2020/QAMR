...
module FAU ( 
  ...
  nand4  g21(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n47_), .O(new_n48_));
  ...
  nand4  g26(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n53_));
  oai21  g27(.a(new_n53_), .b(new_n52_), .c(new_n33_), .O(z05));
  nor2   g28(.a(new_n32_), .b(x13), .O(new_n55_));
  nand3  g29(.a(new_n55_), .b(new_n30_), .c(x02), .O(new_n56_));
  ...
  nand4  g42(.a(new_n55_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n69_));
  nor2   g43(.a(new_n69_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n71_));
  nand3  g45(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand4  g47(.a(new_n73_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n74_));
  ...
  nand4  g52(.a(new_n78_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n79_));
