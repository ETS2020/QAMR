...
module FAU ( 
  ...
  nand3  g27(.a(x13), .b(new_n52_), .c(new_n32_), .O(new_n53_));
  ...
  nand3  g34(.a(x13), .b(new_n59_), .c(new_n32_), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n56_), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n55_), .c(x12), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n49_), .c(x05), .d(new_n30_), .O(new_n64_));
  ...
  nor2   g55(.a(x13), .b(new_n32_), .O(z05));
endmodule
