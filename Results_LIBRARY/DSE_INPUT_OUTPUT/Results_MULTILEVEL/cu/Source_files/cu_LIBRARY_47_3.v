...
module FAU ( 
  ...
  nor3   g16(.a(new_n41_), .b(x03), .c(x02), .O(new_n42_));
  ...
  oai21  g25(.a(new_n50_), .b(new_n49_), .c(new_n32_), .O(z05));
  ...
  nand4  g37(.a(new_n40_), .b(new_n52_), .c(new_n30_), .d(x02), .O(new_n63_));
  ...
  nand4  g44(.a(new_n32_), .b(new_n40_), .c(new_n30_), .d(x02), .O(new_n70_));
  nand4  g45(.a(x13), .b(new_n52_), .c(x05), .d(new_n29_), .O(new_n71_));
