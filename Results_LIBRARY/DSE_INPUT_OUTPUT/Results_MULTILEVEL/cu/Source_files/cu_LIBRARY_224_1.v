...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(new_n29_), .c(new_n32_), .d(x00), .O(new_n45_));
  ...
  nand3  g51(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n77_));
