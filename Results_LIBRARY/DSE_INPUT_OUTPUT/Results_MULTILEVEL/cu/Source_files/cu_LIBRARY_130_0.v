...
module FAU ( 
  ...
  nand4  g21(.a(new_n46_), .b(x11), .c(x05), .d(new_n35_), .O(new_n47_));
  ...
  nand3  g48(.a(new_n73_), .b(new_n27_), .c(x02), .O(new_n74_));
  ...
  nand4  g52(.a(new_n73_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n78_));
  nor2   g53(.a(new_n78_), .b(x02), .O(z07));
  nand4  g54(.a(x13), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n80_));
  nand3  g55(.a(new_n40_), .b(new_n27_), .c(x02), .O(new_n81_));
