...
module FAU ( 
  ...
  nor2   g16(.a(x13), .b(new_n35_), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(new_n41_), .c(new_n27_), .d(new_n40_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(x09), .c(x01), .O(z02));
  nand4  g19(.a(new_n42_), .b(new_n41_), .c(new_n27_), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x09), .c(x01), .O(z03));
  inv1   g21(.a(x13), .O(new_n47_));
  nand4  g22(.a(new_n34_), .b(new_n29_), .c(x01), .d(new_n40_), .O(new_n48_));
  ...
  nand3  g27(.a(new_n42_), .b(new_n27_), .c(new_n34_), .O(new_n53_));
  ...
  nor2   g33(.a(x10), .b(new_n58_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n57_), .c(new_n40_), .O(new_n60_));
  ...
  nand3  g39(.a(new_n47_), .b(new_n35_), .c(x02), .O(new_n65_));
  ...
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  nand4  g46(.a(x13), .b(new_n56_), .c(x05), .d(new_n29_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n65_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n33_), .c(x04), .d(new_n34_), .O(new_n74_));
