...
module FAU ( 
  ...
  nand4  g20(.a(new_n26_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n45_), .c(new_n37_), .O(z03));
  inv1   g22(.a(x00), .O(new_n48_));
  nand4  g23(.a(new_n36_), .b(new_n30_), .c(x01), .d(new_n48_), .O(new_n49_));
  ...
  oai21  g28(.a(new_n53_), .b(new_n46_), .c(new_n37_), .O(z05));
  ...
  nand4  g38(.a(new_n63_), .b(x05), .c(new_n30_), .d(x00), .O(new_n64_));
  nand3  g39(.a(new_n26_), .b(new_n31_), .c(x02), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n36_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z06));
  nand4  g43(.a(x05), .b(new_n28_), .c(new_n36_), .d(new_n30_), .O(new_n69_));
  ...
  nand3  g49(.a(x13), .b(x06), .c(x00), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z09));
  nand2  g51(.a(x05), .b(x02), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n37_), .c(x06), .d(new_n36_), .O(new_n78_));
