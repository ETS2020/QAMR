...
module FAU ( 
  ...
  nand4  g20(.a(new_n36_), .b(new_n31_), .c(new_n27_), .d(x00), .O(new_n46_));
  ...
  nand4  g47(.a(new_n72_), .b(new_n35_), .c(x04), .d(new_n36_), .O(new_n73_));
  ...
  nand4  g52(.a(new_n77_), .b(new_n35_), .c(x06), .d(new_n36_), .O(new_n78_));
