...
module FAU ( 
  ...
  nand4  g19(.a(new_n42_), .b(new_n34_), .c(new_n26_), .d(new_n30_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n40_), .c(new_n39_), .O(z03));
  inv1   g21(.a(x13), .O(new_n47_));
  nand4  g22(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n39_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n47_), .c(x05), .d(new_n34_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z04));
  inv1   g26(.a(new_n32_), .O(z05));
  nand4  g27(.a(new_n32_), .b(new_n47_), .c(new_n27_), .d(x02), .O(new_n53_));
  ...
  nand2  g40(.a(new_n45_), .b(new_n32_), .O(z07));
  nand4  g41(.a(x13), .b(new_n55_), .c(x05), .d(new_n30_), .O(new_n67_));
  nand3  g42(.a(new_n47_), .b(new_n27_), .c(x02), .O(new_n68_));
