...
module FAU ( 
  ...
  nand4  g16(.a(new_n41_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(new_n30_), .c(new_n35_), .O(z03));
  nor2   g18(.a(new_n35_), .b(new_n30_), .O(z04));
  ...
  nand4  g27(.a(new_n53_), .b(x13), .c(new_n47_), .d(new_n46_), .O(new_n54_));
  inv1   g28(.a(new_n54_), .O(new_n55_));
  nand4  g29(.a(new_n55_), .b(x05), .c(new_n29_), .d(new_n30_), .O(new_n56_));
  inv1   g30(.a(x13), .O(new_n57_));
  nand3  g31(.a(new_n57_), .b(new_n35_), .c(x02), .O(new_n58_));
  nand2  g32(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand3  g33(.a(new_n59_), .b(x04), .c(new_n26_), .O(new_n60_));
  inv1   g34(.a(new_n60_), .O(z06));
  nand3  g35(.a(new_n41_), .b(new_n26_), .c(new_n29_), .O(new_n62_));
  aoi21  g36(.a(new_n62_), .b(new_n30_), .c(new_n35_), .O(z07));
  inv1   g37(.a(z04), .O(new_n64_));
  nand4  g38(.a(x13), .b(new_n47_), .c(x05), .d(new_n29_), .O(new_n65_));
  ...
  nand3  g42(.a(new_n64_), .b(x13), .c(x06), .O(new_n69_));
  inv1   g43(.a(new_n69_), .O(z09));
  oai21  g44(.a(x02), .b(x01), .c(x05), .O(new_n71_));
