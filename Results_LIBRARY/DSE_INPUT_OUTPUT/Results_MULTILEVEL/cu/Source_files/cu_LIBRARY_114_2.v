...
module FAU ( 
  ...
  nand4  g31(.a(new_n56_), .b(new_n32_), .c(new_n36_), .d(x00), .O(new_n57_));
  ...
  nor2   g56(.a(new_n61_), .b(new_n26_), .O(z09));
  nand2  g57(.a(x05), .b(x02), .O(new_n83_));
  aoi21  g58(.a(new_n83_), .b(new_n36_), .c(new_n61_), .O(new_n84_));
  nor2   g59(.a(new_n84_), .b(new_n26_), .O(z10));
endmodule
