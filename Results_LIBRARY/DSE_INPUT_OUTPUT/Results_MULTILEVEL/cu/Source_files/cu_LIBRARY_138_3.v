...
module FAU ( 
  ...
  nand3  g37(.a(new_n45_), .b(new_n37_), .c(x02), .O(new_n64_));
  ...
  nor2   g41(.a(new_n28_), .b(x13), .O(new_n68_));
  nand4  g42(.a(new_n68_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n69_));
  nor2   g43(.a(new_n69_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n71_));
  ...
  nand3  g48(.a(new_n35_), .b(x13), .c(x06), .O(new_n75_));
