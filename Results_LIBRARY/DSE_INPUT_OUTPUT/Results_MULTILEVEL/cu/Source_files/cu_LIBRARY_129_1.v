...
module FAU ( 
  ...
  aoi21  g23(.a(new_n43_), .b(x00), .c(new_n32_), .O(z05));
  inv1   g24(.a(x00), .O(new_n50_));
  nand3  g25(.a(new_n42_), .b(x05), .c(x04), .O(new_n51_));
  ...
  oai21  g30(.a(new_n55_), .b(new_n51_), .c(new_n32_), .O(new_n56_));
  nand2  g31(.a(new_n56_), .b(new_n50_), .O(new_n57_));
  inv1   g32(.a(x09), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(new_n32_), .c(x00), .O(new_n59_));
  inv1   g34(.a(x11), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(x01), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n59_), .c(new_n41_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n54_), .c(new_n52_), .d(x05), .O(new_n63_));
  ...
  nand2  g41(.a(new_n66_), .b(new_n57_), .O(z06));
  nand2  g42(.a(new_n43_), .b(new_n34_), .O(z07));
