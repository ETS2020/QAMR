...
module FAU ( 
  ...
  aoi21  g07(.a(x04), .b(new_n26_), .c(x05), .O(new_n33_));
  oai22  g08(.a(new_n33_), .b(new_n29_), .c(new_n30_), .d(x03), .O(z01));
  ...
  aoi21  g14(.a(new_n39_), .b(new_n29_), .c(new_n35_), .O(z02));
  inv1   g15(.a(x13), .O(new_n41_));
  nand4  g16(.a(new_n26_), .b(new_n29_), .c(new_n37_), .d(x00), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z03));
  nand3  g20(.a(new_n38_), .b(x01), .c(new_n36_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n29_), .c(new_n35_), .O(z04));
  ...
  nand2  g35(.a(new_n41_), .b(x02), .O(new_n61_));
  ...
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(z06));
  nand4  g40(.a(x05), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(x13), .O(z07));
  nand4  g42(.a(x13), .b(new_n52_), .c(x05), .d(new_n29_), .O(new_n68_));
  nand3  g43(.a(new_n41_), .b(new_n35_), .c(x02), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n26_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z08));
  nand3  g47(.a(new_n64_), .b(x13), .c(x06), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(z09));
  nand3  g49(.a(new_n64_), .b(x06), .c(new_n26_), .O(new_n75_));
