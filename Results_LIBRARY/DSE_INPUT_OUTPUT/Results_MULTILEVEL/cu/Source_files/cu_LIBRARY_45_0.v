...
module FAU ( 
  ...
  nand3  g38(.a(x13), .b(new_n51_), .c(x05), .O(new_n66_));
  oai21  g39(.a(new_n66_), .b(new_n36_), .c(new_n60_), .O(new_n67_));
  nand3  g40(.a(new_n67_), .b(x04), .c(new_n31_), .O(new_n68_));
  inv1   g41(.a(new_n68_), .O(z08));
  inv1   g42(.a(x06), .O(new_n70_));
  oai21  g43(.a(x02), .b(x01), .c(x13), .O(new_n71_));
  nor2   g44(.a(new_n71_), .b(new_n70_), .O(z09));
  aoi21  g45(.a(x06), .b(new_n31_), .c(new_n26_), .O(new_n73_));
  nand3  g46(.a(x06), .b(new_n32_), .c(new_n31_), .O(new_n74_));
  oai21  g47(.a(new_n73_), .b(x02), .c(new_n74_), .O(z10));
  zero   g48(.O(z02));
  zero   g49(.O(z03));
endmodule
