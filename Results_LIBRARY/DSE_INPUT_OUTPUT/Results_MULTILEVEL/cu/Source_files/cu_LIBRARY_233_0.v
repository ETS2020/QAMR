...
module FAU ( 
  ...
  nand4  g27(.a(new_n34_), .b(new_n40_), .c(new_n35_), .d(x02), .O(new_n53_));
  inv1   g28(.a(x07), .O(new_n54_));
  inv1   g29(.a(x12), .O(new_n55_));
  nor2   g30(.a(x09), .b(x01), .O(new_n56_));
  nor2   g31(.a(x11), .b(new_n49_), .O(new_n57_));
  ...
  nand3  g38(.a(new_n63_), .b(x04), .c(new_n33_), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(z06));
  nand2  g40(.a(new_n42_), .b(new_n34_), .O(z07));
