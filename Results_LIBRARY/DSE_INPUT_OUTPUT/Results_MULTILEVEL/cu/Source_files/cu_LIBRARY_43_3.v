...
module FAU ( 
  ...
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n32_), .O(z03));
  nand4  g22(.a(new_n34_), .b(new_n26_), .c(new_n29_), .d(new_n40_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n43_), .c(new_n41_), .O(z04));
  nand4  g24(.a(new_n34_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n43_), .c(new_n41_), .O(z05));
  ...
  nand4  g35(.a(new_n60_), .b(x05), .c(new_n29_), .d(new_n41_), .O(new_n61_));
  ...
  nand3  g46(.a(x13), .b(x06), .c(new_n41_), .O(new_n72_));
