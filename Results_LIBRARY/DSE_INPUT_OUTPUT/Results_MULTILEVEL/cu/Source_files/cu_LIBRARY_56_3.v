...
module FAU ( 
  ...
  nand3  g24(.a(new_n43_), .b(x05), .c(new_n28_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n49_), .c(new_n40_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n48_), .c(new_n41_), .O(z04));
  nand3  g28(.a(new_n51_), .b(new_n49_), .c(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n48_), .c(new_n41_), .O(z05));
  ...
  nand3  g35(.a(new_n60_), .b(new_n48_), .c(x01), .O(new_n61_));
  ...
  nand3  g41(.a(new_n66_), .b(new_n48_), .c(x01), .O(new_n67_));
  ...
  nand4  g46(.a(new_n26_), .b(new_n43_), .c(new_n35_), .d(x02), .O(new_n72_));
  ...
  oai21  g51(.a(new_n50_), .b(new_n76_), .c(new_n26_), .O(z07));
  nand4  g52(.a(x13), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n78_));
  nand3  g53(.a(new_n43_), .b(new_n35_), .c(x02), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x04), .c(new_n34_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n26_), .O(z08));
  nand3  g57(.a(x13), .b(x06), .c(new_n41_), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z09));
  oai21  g59(.a(new_n35_), .b(new_n30_), .c(new_n34_), .O(new_n85_));
  aoi21  g60(.a(new_n85_), .b(new_n41_), .c(new_n48_), .O(z10));
endmodule
