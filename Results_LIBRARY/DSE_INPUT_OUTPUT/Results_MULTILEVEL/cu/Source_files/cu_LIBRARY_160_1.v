...
module FAU ( 
  ...
  nand4  g20(.a(new_n34_), .b(new_n30_), .c(new_n42_), .d(x00), .O(new_n46_));
  ...
  oai21  g25(.a(new_n50_), .b(new_n44_), .c(new_n35_), .O(z04));
  nor3   g26(.a(x02), .b(new_n42_), .c(new_n41_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n53_));
  ...
  nand3  g38(.a(new_n26_), .b(new_n36_), .c(x02), .O(new_n64_));
  ...
  nand4  g42(.a(x05), .b(new_n28_), .c(new_n34_), .d(new_n30_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x13), .O(z07));
  nand2  g44(.a(x05), .b(new_n30_), .O(new_n70_));
  nand3  g45(.a(x13), .b(new_n56_), .c(x11), .O(new_n71_));
