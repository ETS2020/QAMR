...
module FAU ( 
  ...
  nor2   g20(.a(x02), .b(x00), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n40_), .c(x05), .d(new_n30_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n26_), .c(new_n41_), .O(z04));
  ...
  nand4  g41(.a(x05), .b(new_n30_), .c(new_n26_), .d(new_n27_), .O(new_n67_));
  ...
  oai21  g48(.a(new_n26_), .b(new_n41_), .c(new_n73_), .O(z09));
