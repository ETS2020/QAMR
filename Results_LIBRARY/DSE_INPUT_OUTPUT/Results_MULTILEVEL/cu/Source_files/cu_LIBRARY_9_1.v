...
module FAU ( 
  ...
  nor2   g05(.a(x07), .b(x05), .O(new_n31_));
  ...
  nand2  g12(.a(x07), .b(new_n28_), .O(new_n38_));
  inv1   g13(.a(x00), .O(new_n39_));
  inv1   g14(.a(x01), .O(new_n40_));
  nand3  g15(.a(new_n27_), .b(new_n40_), .c(new_n39_), .O(new_n41_));
  inv1   g16(.a(x13), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n41_), .c(new_n38_), .O(z02));
  nand4  g19(.a(new_n26_), .b(new_n27_), .c(new_n40_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n42_), .c(x05), .d(new_n30_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  nand3  g23(.a(new_n27_), .b(x01), .c(new_n39_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n43_), .c(new_n38_), .O(z04));
  nor3   g25(.a(x02), .b(new_n40_), .c(new_n39_), .O(new_n51_));
  ...
  nand2  g41(.a(new_n66_), .b(new_n38_), .O(z06));
  nand2  g42(.a(new_n26_), .b(new_n27_), .O(new_n68_));
  nand3  g43(.a(new_n42_), .b(x05), .c(new_n30_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n38_), .O(z07));
  nand2  g45(.a(x05), .b(new_n27_), .O(new_n71_));
  nand2  g46(.a(x13), .b(new_n55_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n71_), .c(new_n64_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n26_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n38_), .O(z08));
  nand2  g50(.a(x13), .b(x06), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n38_), .O(z09));
  nand2  g52(.a(new_n71_), .b(new_n32_), .O(new_n78_));
