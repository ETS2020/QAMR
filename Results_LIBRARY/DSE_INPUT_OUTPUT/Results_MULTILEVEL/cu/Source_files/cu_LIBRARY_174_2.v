...
module FAU ( 
  ...
  nand4  g21(.a(new_n35_), .b(new_n36_), .c(new_n46_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n45_), .c(x05), .d(new_n32_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand3  g26(.a(new_n36_), .b(x01), .c(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n45_), .b(x05), .c(new_n32_), .d(new_n35_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n27_), .O(z04));
  nand3  g29(.a(new_n36_), .b(x01), .c(x00), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n53_), .c(new_n27_), .O(z05));
  ...
  nand3  g40(.a(new_n45_), .b(new_n29_), .c(x02), .O(new_n66_));
  oai21  g41(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(x08), .c(x04), .d(new_n35_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(z06));
  nand4  g44(.a(x05), .b(new_n32_), .c(new_n35_), .d(new_n36_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x13), .O(z07));
  nand4  g46(.a(x13), .b(new_n58_), .c(x05), .d(new_n36_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n66_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x08), .c(x04), .d(new_n35_), .O(new_n74_));
  ...
  nand4  g53(.a(new_n78_), .b(new_n27_), .c(x06), .d(new_n35_), .O(new_n79_));
