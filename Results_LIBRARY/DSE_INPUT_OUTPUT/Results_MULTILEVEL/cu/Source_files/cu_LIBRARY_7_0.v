...
module FAU ( 
  ...
  nand4  g25(.a(new_n34_), .b(new_n29_), .c(x01), .d(new_n40_), .O(new_n51_));
  ...
  nand4  g30(.a(new_n46_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n56_));
  ...
  nand4  g44(.a(new_n33_), .b(new_n46_), .c(new_n35_), .d(x02), .O(new_n70_));
  ...
  nand2  g48(.a(new_n34_), .b(new_n29_), .O(new_n74_));
  oai21  g49(.a(new_n47_), .b(new_n74_), .c(new_n33_), .O(z07));
