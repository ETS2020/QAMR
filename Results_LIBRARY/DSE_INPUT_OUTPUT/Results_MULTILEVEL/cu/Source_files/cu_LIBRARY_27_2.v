...
module FAU ( 
  ...
  nor2   g12(.a(x03), .b(new_n26_), .O(new_n38_));
  ...
  nand4  g16(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n30_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(x13), .O(z02));
  inv1   g18(.a(x13), .O(new_n44_));
  nand4  g19(.a(new_n30_), .b(new_n26_), .c(new_n35_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n44_), .c(x05), .d(new_n27_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  nor2   g23(.a(x02), .b(new_n35_), .O(z05));
  ...
  aoi21  g31(.a(new_n57_), .b(new_n55_), .c(new_n44_), .O(new_n58_));
  nand4  g32(.a(new_n58_), .b(new_n52_), .c(new_n51_), .d(x05), .O(new_n59_));
  nor2   g33(.a(new_n59_), .b(new_n27_), .O(new_n60_));
  aoi21  g34(.a(new_n60_), .b(new_n30_), .c(x01), .O(new_n61_));
  nand4  g35(.a(new_n38_), .b(new_n44_), .c(new_n31_), .d(x04), .O(new_n62_));
  oai21  g36(.a(new_n61_), .b(x02), .c(new_n62_), .O(z06));
  nand4  g37(.a(new_n44_), .b(x05), .c(new_n27_), .d(new_n30_), .O(new_n64_));
  aoi21  g38(.a(new_n64_), .b(new_n35_), .c(x02), .O(z07));
  nand2  g39(.a(x04), .b(new_n30_), .O(new_n66_));
  nand3  g40(.a(x13), .b(new_n52_), .c(x05), .O(new_n67_));
  oai21  g41(.a(new_n67_), .b(new_n66_), .c(new_n35_), .O(new_n68_));
  nand2  g42(.a(new_n68_), .b(new_n26_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n62_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n71_));
  oai21  g45(.a(x02), .b(new_n35_), .c(new_n71_), .O(z09));
  nand2  g46(.a(new_n26_), .b(new_n35_), .O(new_n73_));
  oai21  g47(.a(x05), .b(new_n26_), .c(new_n73_), .O(new_n74_));
  nand3  g48(.a(new_n74_), .b(x06), .c(new_n30_), .O(new_n75_));
