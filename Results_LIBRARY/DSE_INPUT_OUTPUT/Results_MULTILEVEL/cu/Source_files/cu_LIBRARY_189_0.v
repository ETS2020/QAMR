...
module FAU ( 
  ...
  nand3  g27(.a(new_n47_), .b(x05), .c(x04), .O(new_n54_));
  ...
  nand2  g35(.a(new_n61_), .b(new_n42_), .O(new_n62_));
  ...
  nor2   g44(.a(new_n32_), .b(x13), .O(new_n71_));
  nand4  g45(.a(new_n71_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n72_));
  ...
  nand4  g49(.a(new_n75_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n76_));
  inv1   g50(.a(new_n76_), .O(z08));
  nand2  g51(.a(x13), .b(x06), .O(new_n78_));
  nand2  g52(.a(new_n78_), .b(new_n33_), .O(z09));
