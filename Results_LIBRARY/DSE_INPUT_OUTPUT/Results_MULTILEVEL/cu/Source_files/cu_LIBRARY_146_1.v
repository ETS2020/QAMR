...
module FAU ( 
  ...
  nand2  g28(.a(new_n26_), .b(x02), .O(new_n54_));
  nand3  g29(.a(new_n43_), .b(new_n30_), .c(x04), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n54_), .c(new_n33_), .O(z06));
  nand2  g31(.a(new_n26_), .b(new_n29_), .O(new_n57_));
  nand3  g32(.a(new_n43_), .b(x05), .c(new_n27_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(new_n33_), .O(z07));
  inv1   g34(.a(x12), .O(new_n60_));
  nand4  g35(.a(x13), .b(new_n60_), .c(x05), .d(new_n29_), .O(new_n61_));
  nand3  g36(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(x04), .c(new_n26_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n33_), .O(z08));
  inv1   g40(.a(x06), .O(new_n66_));
  aoi21  g41(.a(x07), .b(new_n66_), .c(new_n43_), .O(z09));
  nand2  g42(.a(x05), .b(x02), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n69_));
