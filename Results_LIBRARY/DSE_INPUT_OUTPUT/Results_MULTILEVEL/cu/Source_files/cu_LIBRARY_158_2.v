...
module FAU ( 
  ...
  nand3  g18(.a(new_n43_), .b(new_n28_), .c(new_n35_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n34_), .O(z02));
  nand3  g20(.a(new_n30_), .b(new_n26_), .c(x00), .O(new_n46_));
  ...
  nand4  g24(.a(new_n49_), .b(x09), .c(x05), .d(new_n28_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z04));
  nor2   g26(.a(x03), .b(x02), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n43_), .c(new_n28_), .d(x00), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x09), .c(new_n26_), .O(z05));
  inv1   g29(.a(x07), .O(new_n55_));
  inv1   g30(.a(x12), .O(new_n56_));
  inv1   g31(.a(x13), .O(new_n57_));
  oai21  g32(.a(x11), .b(new_n26_), .c(x09), .O(new_n58_));
  ...
  aoi21  g37(.a(new_n62_), .b(new_n59_), .c(new_n57_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n56_), .c(new_n55_), .d(x05), .O(new_n64_));
  nand3  g39(.a(new_n57_), .b(new_n36_), .c(x02), .O(new_n65_));
  ...
  nor2   g43(.a(new_n27_), .b(x13), .O(new_n69_));
  ...
  nand4  g48(.a(new_n73_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n74_));
