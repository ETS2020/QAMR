...
module FAU ( 
  ...
  nand2  g14(.a(new_n33_), .b(new_n29_), .O(new_n40_));
  ...
  nand4  g22(.a(new_n33_), .b(new_n29_), .c(new_n47_), .d(x00), .O(new_n48_));
  ...
  nand4  g27(.a(new_n33_), .b(new_n29_), .c(x01), .d(new_n52_), .O(new_n53_));
  ...
  nand4  g32(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n58_));
  ...
  nand3  g37(.a(x09), .b(new_n62_), .c(new_n47_), .O(new_n63_));
  ...
  aoi21  g44(.a(new_n69_), .b(new_n67_), .c(new_n42_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n71_));
  nand4  g46(.a(new_n34_), .b(new_n42_), .c(new_n35_), .d(x02), .O(new_n72_));
  ...
  oai21  g50(.a(new_n43_), .b(new_n40_), .c(new_n34_), .O(z07));
  ...
  nand4  g54(.a(new_n79_), .b(new_n34_), .c(x04), .d(new_n33_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z08));
  inv1   g56(.a(x06), .O(new_n82_));
  nor3   g57(.a(new_n26_), .b(new_n42_), .c(new_n82_), .O(z09));
  nand2  g58(.a(x05), .b(x02), .O(new_n84_));
  nand4  g59(.a(new_n84_), .b(new_n34_), .c(x06), .d(new_n33_), .O(new_n85_));
