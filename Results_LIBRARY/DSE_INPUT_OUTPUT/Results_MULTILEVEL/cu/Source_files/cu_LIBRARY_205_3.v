...
module FAU ( 
  ...
  nand4  g38(.a(new_n63_), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n64_));
  nand3  g39(.a(new_n44_), .b(new_n27_), .c(x02), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n26_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n32_), .O(z06));
  inv1   g43(.a(new_n49_), .O(new_n69_));
  oai21  g44(.a(new_n50_), .b(new_n69_), .c(new_n32_), .O(z07));
  nand4  g45(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n65_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n32_), .c(x04), .d(new_n26_), .O(new_n73_));
