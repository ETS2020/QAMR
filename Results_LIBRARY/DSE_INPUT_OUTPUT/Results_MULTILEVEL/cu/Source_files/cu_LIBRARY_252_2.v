...
module FAU ( 
  ...
  aoi21  g28(.a(new_n53_), .b(x10), .c(new_n44_), .O(z04));
  nand3  g29(.a(new_n52_), .b(new_n50_), .c(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x10), .c(new_n44_), .O(z05));
  ...
  oai21  g48(.a(new_n51_), .b(new_n73_), .c(new_n33_), .O(z07));
  nand4  g49(.a(x13), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n75_));
  nand3  g50(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n76_));
