...
module FAU ( 
  ...
  nand3  g18(.a(new_n43_), .b(new_n30_), .c(new_n42_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x01), .c(new_n26_), .O(z04));
  nand3  g20(.a(new_n43_), .b(new_n30_), .c(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x01), .c(new_n26_), .O(z05));
  ...
  aoi21  g29(.a(new_n54_), .b(new_n52_), .c(new_n50_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n49_), .c(new_n48_), .d(x05), .O(new_n56_));
  nand3  g31(.a(new_n50_), .b(new_n26_), .c(x02), .O(new_n57_));
  oai21  g32(.a(new_n56_), .b(x02), .c(new_n57_), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(x04), .c(new_n36_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(new_n28_), .O(z06));
  nand4  g35(.a(new_n31_), .b(new_n36_), .c(new_n30_), .d(x01), .O(new_n61_));
  nor3   g36(.a(new_n61_), .b(x13), .c(new_n26_), .O(z07));
  nand4  g37(.a(x13), .b(new_n49_), .c(x05), .d(new_n30_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n57_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x04), .c(new_n36_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n28_), .O(z08));
  nand2  g41(.a(x13), .b(x06), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n28_), .O(z09));
  nand2  g43(.a(x05), .b(x02), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x06), .c(new_n36_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n28_), .O(z10));
  nor2   g46(.a(new_n26_), .b(x01), .O(z03));
endmodule
