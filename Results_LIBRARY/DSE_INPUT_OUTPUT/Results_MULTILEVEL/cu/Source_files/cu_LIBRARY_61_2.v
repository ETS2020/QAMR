...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n44_), .c(new_n34_), .d(new_n26_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x05), .c(new_n30_), .O(z04));
  inv1   g24(.a(x00), .O(new_n50_));
  nor3   g25(.a(x02), .b(new_n30_), .c(new_n50_), .O(new_n51_));
  ...
  nand4  g38(.a(new_n44_), .b(new_n28_), .c(x02), .d(new_n30_), .O(new_n64_));
  ...
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n42_), .O(z07));
  nand2  g45(.a(x05), .b(new_n27_), .O(new_n71_));
  nand2  g46(.a(x13), .b(new_n55_), .O(new_n72_));
  nand3  g47(.a(new_n44_), .b(new_n28_), .c(x02), .O(new_n73_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x04), .c(new_n26_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n42_), .O(z08));
  inv1   g51(.a(x06), .O(new_n77_));
  nor3   g52(.a(new_n41_), .b(new_n44_), .c(new_n77_), .O(z09));
  oai21  g53(.a(x05), .b(x01), .c(new_n71_), .O(new_n79_));
