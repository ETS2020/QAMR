...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(x08), .O(new_n32_));
  ...
  nand4  g22(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n47_), .O(new_n48_));
  ...
  nand4  g45(.a(x05), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x13), .O(z07));
  nand2  g47(.a(x05), .b(new_n29_), .O(new_n73_));
  inv1   g48(.a(x08), .O(new_n74_));
  nand3  g49(.a(x13), .b(new_n56_), .c(new_n74_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n73_), .c(new_n67_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x04), .c(new_n26_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z08));
  nand3  g53(.a(x13), .b(new_n74_), .c(x06), .O(new_n79_));
