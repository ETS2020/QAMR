...
module FAU ( 
  ...
  nand4  g16(.a(new_n26_), .b(new_n29_), .c(new_n42_), .d(x00), .O(new_n43_));
  ...
  nand3  g23(.a(new_n29_), .b(x01), .c(x00), .O(new_n50_));
  nand4  g24(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n51_));
  oai21  g25(.a(new_n51_), .b(new_n50_), .c(new_n33_), .O(z05));
  nor2   g26(.a(new_n32_), .b(x13), .O(new_n53_));
  nand3  g27(.a(new_n53_), .b(new_n30_), .c(x02), .O(new_n54_));
  ...
  inv1   g33(.a(x00), .O(new_n60_));
  inv1   g34(.a(x10), .O(new_n61_));
  nand3  g35(.a(new_n61_), .b(x01), .c(new_n60_), .O(new_n62_));
  aoi21  g36(.a(new_n62_), .b(new_n59_), .c(new_n41_), .O(new_n63_));
  nand4  g37(.a(new_n63_), .b(new_n56_), .c(new_n55_), .d(x05), .O(new_n64_));
  oai21  g38(.a(new_n64_), .b(x02), .c(new_n54_), .O(new_n65_));
  nand3  g39(.a(new_n65_), .b(x04), .c(new_n26_), .O(new_n66_));
  inv1   g40(.a(new_n66_), .O(z06));
  nand4  g41(.a(new_n53_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n68_));
  nor2   g42(.a(new_n68_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n56_), .c(x05), .d(new_n29_), .O(new_n70_));
  nand3  g44(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n71_));
  ...
  nand4  g51(.a(new_n77_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n78_));
