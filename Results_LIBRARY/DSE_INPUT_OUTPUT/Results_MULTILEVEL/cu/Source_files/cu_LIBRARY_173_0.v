...
module FAU ( 
  ...
  nor2   g12(.a(x07), .b(x04), .O(new_n38_));
  ...
  nand3  g29(.a(new_n54_), .b(new_n51_), .c(new_n41_), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x07), .c(x04), .O(z04));
  nand3  g31(.a(new_n54_), .b(new_n51_), .c(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(x07), .c(x04), .O(z05));
  ...
  nand3  g43(.a(new_n52_), .b(new_n34_), .c(x02), .O(new_n69_));
  ...
  nand4  g48(.a(new_n73_), .b(x07), .c(x05), .d(new_n27_), .O(new_n74_));
  ...
  nand2  g53(.a(new_n78_), .b(new_n39_), .O(z08));
  inv1   g54(.a(x06), .O(new_n80_));
  nor3   g55(.a(new_n38_), .b(new_n52_), .c(new_n80_), .O(z09));
  nand2  g56(.a(x05), .b(x02), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(new_n39_), .c(x06), .d(new_n26_), .O(new_n83_));
