...
module FAU ( 
  ...
  nand4  g24(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n51_));
  ...
  nand2  g33(.a(new_n59_), .b(new_n53_), .O(new_n60_));
  ...
  nand2  g44(.a(new_n48_), .b(new_n33_), .O(z07));
  nand4  g45(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n67_), .O(new_n73_));
  nand4  g47(.a(new_n73_), .b(new_n33_), .c(x04), .d(new_n34_), .O(new_n74_));
  ...
  nand4  g52(.a(new_n78_), .b(new_n33_), .c(x06), .d(new_n34_), .O(new_n79_));
