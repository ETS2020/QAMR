...
module FAU ( 
  ...
  nor2   g07(.a(x08), .b(new_n32_), .O(new_n33_));
  ...
  inv1   g44(.a(new_n50_), .O(new_n70_));
  oai21  g45(.a(new_n51_), .b(new_n70_), .c(new_n34_), .O(z07));
  nand4  g46(.a(x13), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n72_));
