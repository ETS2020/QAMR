...
module FAU ( 
  ...
  inv1   g23(.a(new_n32_), .O(z05));
  nor2   g24(.a(z05), .b(x13), .O(new_n50_));
  nand3  g25(.a(new_n50_), .b(new_n30_), .c(x02), .O(new_n51_));
  inv1   g26(.a(x07), .O(new_n52_));
  inv1   g27(.a(x12), .O(new_n53_));
  nor2   g28(.a(x08), .b(x01), .O(new_n54_));
  nor2   g29(.a(x10), .b(new_n43_), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n54_), .c(new_n42_), .O(new_n56_));
  inv1   g31(.a(x09), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n43_), .c(x00), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(new_n56_), .c(new_n44_), .O(new_n59_));
  ...
  nand4  g38(.a(new_n50_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n64_));
  nor2   g39(.a(new_n64_), .b(x02), .O(z07));
  nand4  g40(.a(x13), .b(new_n53_), .c(x05), .d(new_n29_), .O(new_n66_));
