...
module FAU ( 
  ...
  nand4  g23(.a(new_n34_), .b(new_n44_), .c(x05), .d(new_n27_), .O(new_n49_));
  ...
  nand3  g38(.a(new_n44_), .b(new_n30_), .c(x02), .O(new_n64_));
  ...
  nand4  g44(.a(new_n69_), .b(new_n34_), .c(x04), .d(new_n26_), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(z08));
  oai21  g46(.a(new_n44_), .b(new_n32_), .c(new_n34_), .O(z09));
