...
module FAU ( 
  ...
  nor3   g23(.a(x02), .b(new_n26_), .c(new_n48_), .O(new_n49_));
  ...
  oai21  g31(.a(new_n56_), .b(new_n52_), .c(new_n26_), .O(new_n57_));
  nand2  g32(.a(new_n57_), .b(new_n48_), .O(new_n58_));
  inv1   g33(.a(x09), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(new_n26_), .c(x00), .O(new_n60_));
  ...
  nand2  g43(.a(new_n34_), .b(new_n30_), .O(new_n69_));
  nand3  g44(.a(new_n45_), .b(x05), .c(new_n28_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n69_), .c(new_n35_), .O(z07));
  nand4  g46(.a(x13), .b(new_n55_), .c(x05), .d(new_n30_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n65_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n35_), .c(x04), .d(new_n34_), .O(new_n74_));
