...
module FAU ( 
  ...
  nand4  g23(.a(new_n48_), .b(new_n36_), .c(new_n26_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x08), .c(x13), .O(z03));
  ...
  nand4  g31(.a(new_n56_), .b(x08), .c(x05), .d(new_n27_), .O(new_n57_));
  ...
  oai21  g42(.a(new_n67_), .b(new_n64_), .c(x13), .O(new_n68_));
  nand3  g43(.a(new_n32_), .b(new_n43_), .c(new_n42_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n68_), .c(x12), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n71_));
  nand3  g46(.a(new_n33_), .b(new_n30_), .c(x02), .O(new_n72_));
  ...
  nor2   g50(.a(x03), .b(x02), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(x08), .c(x05), .d(new_n27_), .O(new_n77_));
  nor2   g52(.a(new_n77_), .b(x13), .O(z07));
  inv1   g53(.a(x12), .O(new_n79_));
  nand4  g54(.a(x13), .b(new_n79_), .c(x05), .d(new_n29_), .O(new_n80_));
  nand4  g55(.a(new_n33_), .b(x08), .c(new_n30_), .d(x02), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x04), .c(new_n26_), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z08));
  and2   g59(.a(x13), .b(x06), .O(z09));
