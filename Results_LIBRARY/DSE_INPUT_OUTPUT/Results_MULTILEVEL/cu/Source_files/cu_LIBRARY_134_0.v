...
module FAU ( 
  ...
  nand3  g27(.a(new_n53_), .b(new_n27_), .c(x02), .O(new_n54_));
  inv1   g28(.a(x07), .O(new_n55_));
  inv1   g29(.a(x12), .O(new_n56_));
  nor2   g30(.a(x09), .b(x01), .O(new_n57_));
  inv1   g31(.a(x01), .O(new_n58_));
  nor2   g32(.a(x11), .b(new_n58_), .O(new_n59_));
  oai21  g33(.a(new_n59_), .b(new_n57_), .c(x00), .O(new_n60_));
  ...
  nand4  g41(.a(new_n53_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n68_));
  nor2   g42(.a(new_n68_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n70_));
  nand3  g44(.a(new_n41_), .b(new_n27_), .c(x02), .O(new_n71_));
