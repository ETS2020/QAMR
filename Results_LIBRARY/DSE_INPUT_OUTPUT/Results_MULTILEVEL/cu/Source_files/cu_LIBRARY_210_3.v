...
module FAU ( 
  ...
  nand2  g14(.a(x03), .b(x02), .O(new_n40_));
  ...
  nand4  g23(.a(new_n48_), .b(new_n43_), .c(x05), .d(new_n30_), .O(new_n49_));
  ...
  nand3  g42(.a(new_n43_), .b(new_n26_), .c(x02), .O(new_n68_));
  ...
  nor4   g46(.a(new_n35_), .b(x13), .c(new_n26_), .d(x04), .O(z07));
  ...
  nand3  g52(.a(new_n40_), .b(x13), .c(x06), .O(new_n78_));
