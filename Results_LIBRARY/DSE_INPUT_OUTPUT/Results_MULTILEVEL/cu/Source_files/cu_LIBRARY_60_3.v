...
module FAU ( 
  ...
  nand3  g25(.a(new_n42_), .b(x05), .c(new_n27_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(new_n50_), .c(new_n39_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n49_), .c(new_n40_), .O(z04));
  nand3  g29(.a(new_n52_), .b(new_n50_), .c(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(new_n49_), .c(new_n40_), .O(z05));
  ...
  nand2  g36(.a(new_n49_), .b(new_n40_), .O(new_n62_));
  ...
  aoi21  g42(.a(new_n67_), .b(new_n61_), .c(new_n42_), .O(new_n68_));
  ...
  inv1   g48(.a(new_n50_), .O(new_n74_));
  oai21  g49(.a(new_n51_), .b(new_n74_), .c(new_n32_), .O(z07));
  ...
  nand3  g54(.a(new_n32_), .b(x13), .c(x06), .O(new_n80_));
