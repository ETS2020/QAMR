...
module FAU ( 
  ...
  nand4  g24(.a(new_n49_), .b(new_n34_), .c(new_n30_), .d(x00), .O(new_n50_));
  ...
  nand4  g31(.a(new_n47_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(new_n35_), .O(z05));
