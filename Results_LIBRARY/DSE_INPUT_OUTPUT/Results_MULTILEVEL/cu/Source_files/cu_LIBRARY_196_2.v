...
module FAU ( 
  ...
  nand4  g44(.a(new_n33_), .b(new_n43_), .c(new_n27_), .d(x02), .O(new_n70_));
  ...
  nand2  g48(.a(new_n26_), .b(new_n30_), .O(new_n74_));
  nand3  g49(.a(new_n43_), .b(x05), .c(new_n35_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n74_), .c(new_n33_), .O(z07));
  ...
  nand4  g59(.a(new_n84_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n85_));
