...
module FAU ( 
  ...
  nand2  g06(.a(x11), .b(x06), .O(new_n32_));
  ...
  oai21  g30(.a(new_n55_), .b(new_n54_), .c(new_n39_), .O(new_n56_));
  inv1   g31(.a(x11), .O(new_n57_));
  aoi21  g32(.a(x09), .b(new_n40_), .c(new_n39_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n55_), .c(new_n57_), .O(new_n59_));
  inv1   g34(.a(x09), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(new_n40_), .c(x00), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n59_), .c(new_n56_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(x13), .c(new_n53_), .d(new_n52_), .O(new_n63_));
  ...
  aoi21  g49(.a(new_n42_), .b(new_n57_), .c(new_n74_), .O(z09));
  oai21  g50(.a(new_n30_), .b(new_n29_), .c(new_n26_), .O(new_n76_));
  aoi21  g51(.a(new_n76_), .b(new_n57_), .c(new_n74_), .O(z10));
endmodule
