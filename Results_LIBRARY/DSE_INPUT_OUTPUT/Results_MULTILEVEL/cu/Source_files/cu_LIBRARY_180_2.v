...
module FAU ( 
  ...
  nand2  g29(.a(new_n32_), .b(new_n41_), .O(new_n55_));
  ...
  nand3  g40(.a(new_n65_), .b(new_n56_), .c(new_n40_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n60_), .c(new_n43_), .O(new_n67_));
  ...
  nand3  g48(.a(new_n43_), .b(x05), .c(new_n27_), .O(new_n74_));
