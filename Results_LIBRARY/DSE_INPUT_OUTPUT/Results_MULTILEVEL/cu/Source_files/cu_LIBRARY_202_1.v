...
module FAU ( 
  ...
  nand4  g20(.a(new_n34_), .b(new_n30_), .c(new_n45_), .d(x00), .O(new_n46_));
  ...
  nand4  g26(.a(new_n41_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n35_), .O(z04));
  nor3   g28(.a(x02), .b(new_n45_), .c(new_n50_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n55_));
  ...
  aoi21  g52(.a(new_n41_), .b(x01), .c(new_n26_), .O(z09));
  nand2  g53(.a(x05), .b(x02), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(x06), .c(new_n34_), .d(x01), .O(new_n80_));
