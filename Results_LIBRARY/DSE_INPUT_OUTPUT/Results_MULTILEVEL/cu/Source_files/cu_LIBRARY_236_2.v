...
module FAU ( 
  ...
  nor2   g14(.a(x03), .b(x00), .O(new_n40_));
  nand4  g15(.a(new_n40_), .b(new_n39_), .c(x05), .d(new_n27_), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(new_n30_), .c(x02), .O(z02));
  nand4  g17(.a(new_n26_), .b(new_n29_), .c(new_n30_), .d(x00), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n39_), .c(x05), .d(new_n27_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(z03));
  nor2   g21(.a(x02), .b(new_n30_), .O(z05));
  ...
  nor2   g31(.a(new_n57_), .b(new_n27_), .O(new_n58_));
  aoi21  g32(.a(new_n58_), .b(new_n26_), .c(x01), .O(new_n59_));
  nor2   g33(.a(x13), .b(x05), .O(new_n60_));
  nand4  g34(.a(new_n60_), .b(x04), .c(new_n26_), .d(x02), .O(new_n61_));
  oai21  g35(.a(new_n59_), .b(x02), .c(new_n61_), .O(z06));
  nand4  g36(.a(new_n34_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n63_));
  nor2   g37(.a(new_n63_), .b(x13), .O(z07));
  inv1   g38(.a(new_n34_), .O(new_n65_));
  nand3  g39(.a(x13), .b(new_n50_), .c(x05), .O(new_n66_));
  nand2  g40(.a(new_n60_), .b(x02), .O(new_n67_));
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(new_n67_), .O(new_n68_));
  nand3  g42(.a(new_n68_), .b(x04), .c(new_n26_), .O(new_n69_));
  inv1   g43(.a(new_n69_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n71_));
  oai21  g45(.a(x02), .b(new_n30_), .c(new_n71_), .O(z09));
  aoi21  g46(.a(x06), .b(new_n26_), .c(x01), .O(new_n73_));
  nand3  g47(.a(x06), .b(new_n36_), .c(new_n26_), .O(new_n74_));
  oai21  g48(.a(new_n73_), .b(x02), .c(new_n74_), .O(z10));
  zero   g49(.O(z04));
endmodule
