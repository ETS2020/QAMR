...
module FAU ( 
  ...
  aoi21  g47(.a(new_n72_), .b(new_n65_), .c(x01), .O(new_n73_));
  nand4  g48(.a(new_n45_), .b(x12), .c(new_n30_), .d(x02), .O(new_n74_));
