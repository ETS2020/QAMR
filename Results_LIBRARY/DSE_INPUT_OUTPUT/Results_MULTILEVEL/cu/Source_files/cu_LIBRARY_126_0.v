...
module FAU ( 
  ...
  nand3  g22(.a(new_n47_), .b(x05), .c(new_n26_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n29_), .c(new_n42_), .d(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x07), .c(x04), .O(z03));
  nand4  g26(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n41_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x07), .c(x05), .d(new_n27_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nand4  g30(.a(new_n49_), .b(new_n29_), .c(x01), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x07), .c(x04), .O(z05));
  ...
  nand4  g40(.a(new_n65_), .b(new_n58_), .c(new_n38_), .d(x05), .O(new_n66_));
  nand4  g41(.a(new_n47_), .b(new_n34_), .c(x04), .d(x02), .O(new_n67_));
  ...
  nand4  g45(.a(new_n47_), .b(x05), .c(new_n26_), .d(new_n29_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(x07), .c(x04), .O(z07));
  nand4  g47(.a(x13), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n73_));
  nand3  g48(.a(new_n47_), .b(new_n34_), .c(x02), .O(new_n74_));
  ...
  nand2  g53(.a(new_n78_), .b(new_n39_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n39_), .c(x06), .d(new_n26_), .O(new_n81_));
