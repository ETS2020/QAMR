...
module FAU ( 
  ...
  nand4  g31(.a(new_n51_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n57_));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n51_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n68_));
  nand3  g43(.a(new_n51_), .b(new_n36_), .c(x02), .O(new_n69_));
  ...
  nand2  g47(.a(new_n34_), .b(new_n30_), .O(new_n73_));
  nand3  g48(.a(new_n51_), .b(x05), .c(new_n28_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(new_n73_), .c(new_n35_), .O(z07));
  nand4  g50(.a(x13), .b(new_n60_), .c(x05), .d(new_n30_), .O(new_n76_));
  ...
  aoi21  g54(.a(new_n51_), .b(x01), .c(new_n26_), .O(z09));
  nand2  g55(.a(x05), .b(x02), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(x06), .c(new_n34_), .d(x01), .O(new_n82_));
