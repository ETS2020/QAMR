...
module FAU ( 
  ...
  nand2  g06(.a(x11), .b(x01), .O(new_n32_));
  ...
  nand4  g18(.a(new_n26_), .b(new_n30_), .c(new_n43_), .d(x00), .O(new_n44_));
  ...
  nand4  g26(.a(new_n51_), .b(new_n48_), .c(x05), .d(new_n34_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand4  g28(.a(new_n26_), .b(new_n30_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n48_), .c(x05), .d(new_n34_), .O(new_n56_));
  ...
  aoi22  g39(.a(new_n64_), .b(x01), .c(new_n63_), .d(new_n49_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n62_), .c(new_n42_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n67_));
  nand4  g42(.a(new_n32_), .b(new_n42_), .c(new_n27_), .d(x02), .O(new_n68_));
  ...
  nand3  g50(.a(new_n42_), .b(new_n27_), .c(x02), .O(new_n76_));
  ...
  nand4  g57(.a(new_n82_), .b(new_n32_), .c(x06), .d(new_n26_), .O(new_n83_));
