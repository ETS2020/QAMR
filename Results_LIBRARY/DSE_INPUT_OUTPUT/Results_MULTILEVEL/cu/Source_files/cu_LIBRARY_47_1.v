...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n51_,
  ...
  nand3  g18(.a(new_n43_), .b(new_n26_), .c(new_n29_), .O(new_n44_));
  ...
  nor3   g24(.a(new_n44_), .b(new_n40_), .c(x00), .O(z04));
  ...
  nand4  g35(.a(new_n60_), .b(new_n32_), .c(x05), .d(new_n29_), .O(new_n61_));
  nand3  g36(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n61_), .c(x12), .O(new_n63_));
  nand4  g38(.a(new_n41_), .b(x07), .c(new_n30_), .d(x02), .O(new_n64_));
  ...
  nand4  g45(.a(new_n33_), .b(new_n41_), .c(new_n30_), .d(x02), .O(new_n71_));
  ...
  nand4  g54(.a(new_n79_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n80_));
