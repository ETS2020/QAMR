...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(x07), .c(x05), .d(new_n29_), .O(new_n52_));
  ...
  aoi21  g31(.a(new_n56_), .b(x07), .c(new_n44_), .O(z05));
  nand4  g32(.a(new_n27_), .b(new_n46_), .c(new_n36_), .d(x02), .O(new_n58_));
  ...
  nand4  g39(.a(new_n64_), .b(x13), .c(new_n59_), .d(new_n26_), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(x05), .c(new_n31_), .d(new_n44_), .O(new_n67_));
  ...
  oai21  g46(.a(new_n54_), .b(new_n71_), .c(new_n27_), .O(z07));
  nand4  g47(.a(x13), .b(new_n59_), .c(x05), .d(new_n31_), .O(new_n73_));
  nand3  g48(.a(new_n46_), .b(new_n36_), .c(x02), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n27_), .c(x04), .d(new_n35_), .O(new_n76_));
