...
module FAU ( 
  ...
  nand3  g21(.a(new_n27_), .b(x01), .c(new_n39_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n43_), .c(new_n38_), .O(z04));
  nor3   g23(.a(x02), .b(new_n40_), .c(new_n39_), .O(new_n49_));
  ...
  nand4  g44(.a(new_n42_), .b(new_n52_), .c(new_n28_), .d(x02), .O(new_n70_));
  ...
  nand2  g50(.a(new_n68_), .b(new_n32_), .O(new_n76_));
