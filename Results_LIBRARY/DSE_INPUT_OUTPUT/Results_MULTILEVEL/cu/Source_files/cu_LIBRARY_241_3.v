...
module FAU ( 
  ...
  nand4  g28(.a(x05), .b(x04), .c(new_n35_), .d(new_n31_), .O(new_n55_));
  ...
  nand2  g45(.a(new_n35_), .b(new_n31_), .O(new_n72_));
  nand3  g46(.a(new_n45_), .b(x05), .c(new_n29_), .O(new_n73_));
  oai21  g47(.a(new_n73_), .b(new_n72_), .c(new_n36_), .O(z07));
  ...
  nand2  g51(.a(new_n77_), .b(new_n36_), .O(z08));
  nand3  g52(.a(new_n36_), .b(x13), .c(x06), .O(new_n79_));
  inv1   g53(.a(new_n79_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n81_));
  nand4  g55(.a(new_n81_), .b(new_n36_), .c(x06), .d(new_n35_), .O(new_n82_));
