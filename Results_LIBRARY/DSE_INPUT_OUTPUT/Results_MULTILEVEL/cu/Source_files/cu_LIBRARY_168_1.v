...
module FAU ( 
  ...
  oai21  g30(.a(new_n55_), .b(new_n51_), .c(new_n26_), .O(new_n56_));
  ...
  nor2   g42(.a(z04), .b(x13), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n69_));
  ...
  nor3   g50(.a(z04), .b(new_n41_), .c(new_n75_), .O(z09));
