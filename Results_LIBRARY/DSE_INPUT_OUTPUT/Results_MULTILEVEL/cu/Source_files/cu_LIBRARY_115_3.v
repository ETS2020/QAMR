...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n43_, new_n45_, new_n47_, new_n48_, new_n50_, new_n52_, new_n53_,
  ...
  nand3  g21(.a(new_n29_), .b(x01), .c(new_n45_), .O(new_n47_));
  nand4  g22(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n47_), .c(new_n32_), .O(z04));
  nand3  g24(.a(new_n29_), .b(x01), .c(x00), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n32_), .O(z05));
  ...
  nand3  g44(.a(new_n32_), .b(x13), .c(x06), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(z09));
  nand2  g46(.a(x05), .b(x02), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n32_), .c(x06), .d(new_n26_), .O(new_n73_));
