...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n40_), .c(x05), .d(new_n35_), .O(new_n48_));
  ...
  nor3   g28(.a(x02), .b(new_n32_), .c(new_n41_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  aoi21  g33(.a(x09), .b(new_n32_), .c(new_n41_), .O(new_n59_));
  ...
  nand4  g40(.a(new_n33_), .b(new_n51_), .c(new_n27_), .d(x02), .O(new_n66_));
