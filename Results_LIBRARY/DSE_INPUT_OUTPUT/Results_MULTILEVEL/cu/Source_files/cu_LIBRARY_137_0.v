...
module FAU ( 
  ...
  nand4  g20(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n47_));
  oai21  g21(.a(new_n47_), .b(new_n46_), .c(new_n34_), .O(z05));
  nor2   g22(.a(new_n26_), .b(x13), .O(new_n49_));
  nand3  g23(.a(new_n49_), .b(new_n35_), .c(x02), .O(new_n50_));
  inv1   g24(.a(x07), .O(new_n51_));
  inv1   g25(.a(x12), .O(new_n52_));
  nor2   g26(.a(x09), .b(x01), .O(new_n53_));
  inv1   g27(.a(x01), .O(new_n54_));
  nor2   g28(.a(x11), .b(new_n54_), .O(new_n55_));
  oai21  g29(.a(new_n55_), .b(new_n53_), .c(x00), .O(new_n56_));
  inv1   g30(.a(x00), .O(new_n57_));
  inv1   g31(.a(x10), .O(new_n58_));
  nand3  g32(.a(new_n58_), .b(x01), .c(new_n57_), .O(new_n59_));
  aoi21  g33(.a(new_n59_), .b(new_n56_), .c(new_n41_), .O(new_n60_));
  nand4  g34(.a(new_n60_), .b(new_n52_), .c(new_n51_), .d(x05), .O(new_n61_));
  oai21  g35(.a(new_n61_), .b(x02), .c(new_n50_), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(x04), .c(new_n33_), .O(new_n63_));
  inv1   g37(.a(new_n63_), .O(z06));
  nand4  g38(.a(new_n49_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n65_));
  ...
  nand4  g43(.a(new_n69_), .b(new_n34_), .c(x04), .d(new_n33_), .O(new_n70_));
  inv1   g44(.a(new_n70_), .O(z08));
  inv1   g45(.a(x06), .O(new_n72_));
  nor3   g46(.a(new_n26_), .b(new_n41_), .c(new_n72_), .O(z09));
  nand2  g47(.a(x05), .b(x02), .O(new_n74_));
  nand3  g48(.a(new_n74_), .b(x06), .c(new_n33_), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n34_), .O(z10));
  zero   g50(.O(z02));
endmodule
