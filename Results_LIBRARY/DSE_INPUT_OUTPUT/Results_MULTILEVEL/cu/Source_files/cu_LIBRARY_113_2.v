...
module FAU ( 
  ...
  nand4  g21(.a(new_n47_), .b(new_n41_), .c(x05), .d(new_n28_), .O(new_n48_));
  inv1   g22(.a(new_n48_), .O(z04));
  aoi21  g23(.a(new_n43_), .b(x01), .c(new_n26_), .O(z05));
  ...
  nand2  g41(.a(new_n67_), .b(new_n57_), .O(z06));
  ...
  nand4  g45(.a(x13), .b(new_n54_), .c(x05), .d(new_n30_), .O(new_n72_));
