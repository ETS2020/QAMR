...
module FAU ( 
  ...
  nor2   g26(.a(new_n28_), .b(x13), .O(new_n53_));
  nand3  g27(.a(new_n53_), .b(new_n36_), .c(x02), .O(new_n54_));
  ...
  nand3  g34(.a(new_n60_), .b(new_n41_), .c(new_n26_), .O(new_n61_));
  ...
  nand4  g40(.a(new_n53_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n67_));
  nor2   g41(.a(new_n67_), .b(x02), .O(z07));
  nand4  g42(.a(x13), .b(new_n56_), .c(x05), .d(new_n31_), .O(new_n69_));
  nand3  g43(.a(new_n42_), .b(new_n36_), .c(x02), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand4  g45(.a(new_n71_), .b(new_n27_), .c(x04), .d(new_n35_), .O(new_n72_));
  inv1   g46(.a(new_n72_), .O(z08));
  inv1   g47(.a(x06), .O(new_n74_));
  nor3   g48(.a(new_n28_), .b(new_n42_), .c(new_n74_), .O(z09));
  nand2  g49(.a(x05), .b(x02), .O(new_n76_));
  nand3  g50(.a(new_n76_), .b(x06), .c(new_n35_), .O(new_n77_));
