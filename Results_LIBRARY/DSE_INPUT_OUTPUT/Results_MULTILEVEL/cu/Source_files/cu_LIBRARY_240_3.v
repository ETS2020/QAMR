...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n39_), .O(z03));
  inv1   g22(.a(x00), .O(new_n48_));
  nand4  g23(.a(new_n26_), .b(new_n27_), .c(x01), .d(new_n48_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n45_), .c(x05), .d(new_n34_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nor3   g27(.a(x02), .b(new_n30_), .c(new_n48_), .O(new_n53_));
  ...
  nand3  g38(.a(new_n45_), .b(new_n28_), .c(x02), .O(new_n64_));
  ...
  nand4  g44(.a(x13), .b(new_n57_), .c(x05), .d(new_n27_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n64_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x04), .c(new_n26_), .d(new_n30_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z08));
  nand3  g48(.a(new_n39_), .b(x13), .c(x06), .O(new_n74_));
