...
module FAU ( 
  ...
  nor2   g14(.a(x13), .b(new_n28_), .O(new_n40_));
  nand4  g15(.a(new_n40_), .b(new_n33_), .c(new_n26_), .d(x00), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(new_n27_), .c(x01), .O(z03));
  ...
  nor2   g23(.a(new_n27_), .b(x01), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand3  g25(.a(new_n27_), .b(x01), .c(x00), .O(new_n51_));
  nand3  g26(.a(new_n40_), .b(new_n33_), .c(new_n26_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n50_), .O(z05));
  ...
  nand3  g45(.a(new_n43_), .b(new_n28_), .c(x02), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x04), .c(new_n26_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n50_), .O(z06));
  nand4  g49(.a(x05), .b(new_n33_), .c(new_n26_), .d(new_n27_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x13), .O(z07));
  nor2   g51(.a(new_n33_), .b(x03), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(new_n43_), .c(new_n28_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(x01), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(x02), .O(new_n80_));
  nor2   g55(.a(new_n43_), .b(x12), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n77_), .c(x05), .d(new_n27_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n80_), .O(z08));
  inv1   g58(.a(x06), .O(new_n84_));
  nor3   g59(.a(new_n49_), .b(new_n43_), .c(new_n84_), .O(z09));
  oai21  g60(.a(x05), .b(new_n56_), .c(x02), .O(new_n86_));
