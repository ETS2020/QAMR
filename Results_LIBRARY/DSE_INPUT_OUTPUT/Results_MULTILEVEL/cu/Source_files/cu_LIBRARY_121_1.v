...
module FAU ( 
  ...
  nor3   g16(.a(x03), .b(x02), .c(x01), .O(new_n42_));
  ...
  nand4  g25(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n50_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n26_), .c(x05), .d(new_n28_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nand3  g29(.a(new_n30_), .b(x01), .c(x00), .O(new_n55_));
  nand4  g30(.a(new_n41_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n56_));
  ...
  nor2   g38(.a(x11), .b(new_n45_), .O(new_n64_));
  oai21  g39(.a(new_n64_), .b(new_n63_), .c(x00), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n62_), .c(new_n41_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n67_));
  nand3  g42(.a(new_n41_), .b(new_n36_), .c(x02), .O(new_n68_));
  ...
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n73_));
  ...
  nand3  g56(.a(new_n81_), .b(x06), .c(new_n35_), .O(new_n82_));
