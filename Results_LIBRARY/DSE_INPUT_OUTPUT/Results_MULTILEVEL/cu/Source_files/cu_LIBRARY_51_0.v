...
module FAU ( 
  ...
  nand3  g22(.a(new_n35_), .b(x01), .c(new_n42_), .O(new_n48_));
  inv1   g23(.a(x13), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x05), .c(new_n36_), .d(new_n34_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n28_), .O(z04));
  nand3  g26(.a(new_n35_), .b(x01), .c(x00), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n50_), .c(new_n28_), .O(z05));
  ...
  aoi21  g42(.a(new_n67_), .b(new_n61_), .c(new_n49_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n55_), .c(new_n54_), .d(new_n35_), .O(new_n69_));
  nand3  g44(.a(new_n49_), .b(new_n27_), .c(x02), .O(new_n70_));
