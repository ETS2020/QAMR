...
module FAU ( 
  ...
  nand4  g27(.a(new_n52_), .b(x11), .c(x05), .d(new_n35_), .O(new_n53_));
  ...
  aoi21  g44(.a(new_n32_), .b(x01), .c(x13), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(new_n27_), .c(x02), .O(new_n71_));
  ...
  nand4  g49(.a(new_n70_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n75_));
