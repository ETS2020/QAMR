...
module FAU ( 
  ...
  nand4  g20(.a(new_n43_), .b(new_n28_), .c(new_n34_), .d(new_n30_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n41_), .c(new_n40_), .O(z03));
  ...
  aoi21  g36(.a(new_n62_), .b(new_n60_), .c(new_n48_), .O(new_n63_));
  ...
  nand3  g44(.a(new_n48_), .b(new_n35_), .c(x02), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(new_n26_), .c(x04), .d(new_n34_), .O(new_n73_));
