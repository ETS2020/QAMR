...
module FAU ( 
  ...
  nand2  g07(.a(x06), .b(new_n32_), .O(new_n33_));
  ...
  aoi21  g53(.a(new_n50_), .b(x01), .c(new_n40_), .O(z09));
  oai21  g54(.a(new_n30_), .b(new_n29_), .c(new_n26_), .O(new_n80_));
  aoi21  g55(.a(new_n80_), .b(x01), .c(new_n40_), .O(z10));
endmodule
