...
module FAU ( 
  ...
  aoi21  g26(.a(new_n51_), .b(new_n26_), .c(new_n27_), .O(z04));
  nand3  g27(.a(new_n50_), .b(x05), .c(x04), .O(new_n54_));
  ...
  aoi21  g38(.a(new_n64_), .b(new_n62_), .c(new_n43_), .O(new_n65_));
  nand4  g39(.a(new_n65_), .b(new_n57_), .c(new_n55_), .d(x05), .O(new_n66_));
  nand3  g40(.a(new_n43_), .b(new_n37_), .c(x02), .O(new_n67_));
  ...
  nand4  g45(.a(new_n71_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n72_));
  ...
  nand4  g49(.a(new_n75_), .b(new_n36_), .c(x04), .d(new_n35_), .O(new_n76_));
  inv1   g50(.a(new_n76_), .O(z08));
  nand2  g51(.a(x13), .b(x06), .O(new_n78_));
  nand2  g52(.a(new_n78_), .b(new_n36_), .O(z09));
  nand2  g53(.a(x05), .b(x02), .O(new_n80_));
  nand4  g54(.a(new_n80_), .b(new_n36_), .c(x06), .d(new_n35_), .O(new_n81_));
