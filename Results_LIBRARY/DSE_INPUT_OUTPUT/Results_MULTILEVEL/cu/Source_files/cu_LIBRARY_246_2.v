...
module FAU ( 
  ...
  nand4  g20(.a(new_n33_), .b(new_n43_), .c(x05), .d(new_n35_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand3  g22(.a(new_n47_), .b(new_n26_), .c(new_n30_), .O(new_n48_));
  ...
  nor3   g26(.a(new_n48_), .b(new_n41_), .c(new_n40_), .O(z05));
  inv1   g27(.a(x12), .O(new_n53_));
  nor3   g28(.a(x09), .b(x07), .c(x01), .O(new_n54_));
  ...
  nand3  g37(.a(new_n62_), .b(new_n57_), .c(new_n40_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n56_), .c(new_n43_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n65_));
  ...
  inv1   g44(.a(new_n48_), .O(z07));
  nand4  g45(.a(x13), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n71_));
  ...
  nand2  g50(.a(new_n75_), .b(new_n33_), .O(z09));
