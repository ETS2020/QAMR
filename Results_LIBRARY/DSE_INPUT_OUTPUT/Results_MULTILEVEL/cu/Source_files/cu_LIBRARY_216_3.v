...
module FAU ( 
  ...
  nor2   g13(.a(new_n35_), .b(new_n30_), .O(z04));
  ...
  nand4  g20(.a(new_n45_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n30_), .c(new_n35_), .O(z03));
  ...
  aoi21  g30(.a(new_n55_), .b(new_n53_), .c(new_n50_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n49_), .c(new_n48_), .d(x05), .O(new_n57_));
  nand3  g32(.a(new_n50_), .b(new_n35_), .c(x02), .O(new_n58_));
  oai21  g33(.a(new_n57_), .b(x02), .c(new_n58_), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(x04), .c(new_n26_), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(new_n40_), .O(z06));
  nand3  g36(.a(new_n45_), .b(new_n26_), .c(new_n29_), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n30_), .c(new_n35_), .O(z07));
  nand4  g38(.a(x13), .b(new_n49_), .c(x05), .d(new_n29_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n58_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x04), .c(new_n26_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n40_), .O(z08));
  nand3  g42(.a(new_n40_), .b(x13), .c(x06), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(z09));
  oai21  g44(.a(x02), .b(x01), .c(x05), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x06), .c(new_n26_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z10));
  nor2   g47(.a(new_n35_), .b(new_n30_), .O(z05));
endmodule
