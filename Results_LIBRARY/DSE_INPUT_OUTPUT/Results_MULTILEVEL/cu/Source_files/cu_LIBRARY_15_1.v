...
module FAU ( 
  ...
  nand4  g23(.a(new_n45_), .b(new_n35_), .c(new_n26_), .d(new_n30_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x00), .c(new_n43_), .O(z05));
  ...
  nand3  g33(.a(new_n58_), .b(new_n43_), .c(new_n32_), .O(new_n59_));
  ...
  nor3   g46(.a(z04), .b(new_n51_), .c(new_n71_), .O(z09));
