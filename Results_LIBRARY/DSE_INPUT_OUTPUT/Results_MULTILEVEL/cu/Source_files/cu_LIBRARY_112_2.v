...
module FAU ( 
  ...
  nand3  g23(.a(new_n48_), .b(new_n45_), .c(new_n36_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x10), .c(new_n32_), .O(z04));
  nand4  g25(.a(new_n26_), .b(new_n30_), .c(x01), .d(x00), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x10), .c(x05), .d(new_n36_), .O(new_n53_));
  ...
  nor2   g44(.a(new_n33_), .b(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n71_));
  ...
  nand4  g49(.a(new_n74_), .b(new_n34_), .c(x04), .d(new_n26_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z08));
  inv1   g51(.a(x06), .O(new_n77_));
  nor3   g52(.a(new_n33_), .b(new_n57_), .c(new_n77_), .O(z09));
  nand2  g53(.a(x05), .b(x02), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n34_), .c(x06), .d(new_n26_), .O(new_n80_));
