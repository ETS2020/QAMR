...
module FAU ( 
  ...
  nand4  g24(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n39_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n49_), .c(x05), .d(new_n34_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand3  g28(.a(new_n42_), .b(x05), .c(new_n34_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n26_), .c(new_n30_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n49_), .c(new_n40_), .O(z05));
  inv1   g32(.a(x07), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  inv1   g34(.a(x08), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(x01), .c(new_n39_), .O(new_n61_));
