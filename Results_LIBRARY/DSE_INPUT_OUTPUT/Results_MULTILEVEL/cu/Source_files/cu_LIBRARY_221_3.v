...
module FAU ( 
  ...
  nand2  g06(.a(x10), .b(x00), .O(new_n32_));
  ...
  nand3  g21(.a(new_n46_), .b(x05), .c(new_n34_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(new_n45_), .c(new_n44_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n43_), .c(new_n42_), .O(z03));
  nand3  g25(.a(new_n30_), .b(x01), .c(new_n42_), .O(new_n51_));
  nand4  g26(.a(new_n46_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n32_), .O(z04));
  nand3  g28(.a(new_n48_), .b(new_n45_), .c(x01), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n43_), .c(new_n42_), .O(z05));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n60_), .c(new_n46_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n68_));
  nand4  g43(.a(new_n32_), .b(new_n46_), .c(new_n27_), .d(x02), .O(new_n69_));
  ...
  oai21  g48(.a(new_n47_), .b(new_n73_), .c(new_n32_), .O(z07));
