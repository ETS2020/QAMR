...
module FAU ( 
  ...
  nor2   g30(.a(new_n32_), .b(x13), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n30_), .c(x02), .O(new_n57_));
  ...
  nand4  g45(.a(new_n56_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x02), .O(z07));
  nand4  g47(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n73_));
  nand3  g48(.a(new_n40_), .b(new_n30_), .c(x02), .O(new_n74_));
  ...
  nor3   g53(.a(new_n32_), .b(new_n40_), .c(new_n78_), .O(z09));
