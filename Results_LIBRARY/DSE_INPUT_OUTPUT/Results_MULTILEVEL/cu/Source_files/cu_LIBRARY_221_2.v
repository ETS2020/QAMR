...
module FAU ( 
  ...
  nand3  g21(.a(new_n46_), .b(x05), .c(new_n35_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(new_n45_), .c(new_n44_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x10), .c(new_n43_), .O(z03));
  nand3  g25(.a(new_n30_), .b(x01), .c(new_n43_), .O(new_n51_));
  nand4  g26(.a(new_n46_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n33_), .O(z04));
  nand3  g28(.a(new_n48_), .b(new_n45_), .c(x01), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x10), .c(new_n43_), .O(z05));
  ...
  nand3  g37(.a(new_n62_), .b(x10), .c(x00), .O(new_n63_));
  ...
  nand4  g43(.a(new_n33_), .b(new_n46_), .c(new_n27_), .d(x02), .O(new_n69_));
  ...
  inv1   g47(.a(new_n45_), .O(new_n73_));
  oai21  g48(.a(new_n47_), .b(new_n73_), .c(new_n33_), .O(z07));
  nand4  g49(.a(x13), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n75_));
  nand3  g50(.a(new_n46_), .b(new_n27_), .c(x02), .O(new_n76_));
  ...
  nand4  g57(.a(new_n82_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n83_));
