...
module FAU ( 
  ...
  nand3  g25(.a(new_n51_), .b(new_n27_), .c(x02), .O(new_n52_));
  ...
  nand4  g39(.a(new_n51_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n66_));
  nor2   g40(.a(new_n66_), .b(x02), .O(z07));
  nand4  g41(.a(x13), .b(new_n54_), .c(x05), .d(new_n30_), .O(new_n68_));
  nand3  g42(.a(new_n55_), .b(new_n27_), .c(x02), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand4  g44(.a(new_n70_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n71_));
