...
module FAU ( 
  ...
  oai21  g07(.a(x11), .b(new_n26_), .c(new_n32_), .O(z00));
  ...
  aoi21  g33(.a(x11), .b(x01), .c(x09), .O(new_n59_));
  ...
  nand4  g42(.a(x05), .b(new_n30_), .c(new_n26_), .d(new_n27_), .O(new_n68_));
  ...
  nand2  g49(.a(x11), .b(x03), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n74_), .O(z09));
  nand2  g51(.a(x05), .b(x02), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x06), .c(new_n26_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n75_), .O(z10));
endmodule
