...
module FAU ( 
  ...
  nand4  g24(.a(new_n49_), .b(new_n26_), .c(new_n29_), .d(new_n48_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n42_), .c(new_n43_), .O(z04));
  nand4  g26(.a(new_n49_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n42_), .c(new_n43_), .O(z05));
  ...
  nand3  g36(.a(new_n42_), .b(new_n34_), .c(x02), .O(new_n62_));
  ...
  nand3  g46(.a(x13), .b(x06), .c(new_n43_), .O(new_n72_));
