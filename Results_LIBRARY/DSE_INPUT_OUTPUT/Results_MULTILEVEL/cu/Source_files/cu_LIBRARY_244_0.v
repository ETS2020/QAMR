...
module FAU ( 
  ...
  nor2   g06(.a(x09), .b(x01), .O(new_n32_));
  ...
  aoi21  g20(.a(new_n45_), .b(x09), .c(x01), .O(z02));
  nand3  g21(.a(new_n44_), .b(new_n41_), .c(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(x09), .c(x01), .O(z03));
  ...
  nor3   g27(.a(x02), .b(new_n52_), .c(new_n40_), .O(new_n53_));
  ...
  nor2   g33(.a(x10), .b(new_n52_), .O(new_n59_));
  ...
  nand3  g39(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n65_));
  ...
  oai21  g44(.a(new_n43_), .b(new_n69_), .c(new_n33_), .O(z07));
  ...
  nor3   g50(.a(new_n32_), .b(new_n42_), .c(new_n75_), .O(z09));
