...
module FAU ( 
  ...
  nand3  g06(.a(x08), .b(new_n31_), .c(x04), .O(new_n32_));
  ...
  nand2  g18(.a(new_n43_), .b(x02), .O(new_n44_));
  ...
  nand4  g42(.a(new_n47_), .b(x08), .c(new_n31_), .d(x02), .O(new_n68_));
  ...
  oai21  g57(.a(new_n43_), .b(x05), .c(x02), .O(new_n83_));
