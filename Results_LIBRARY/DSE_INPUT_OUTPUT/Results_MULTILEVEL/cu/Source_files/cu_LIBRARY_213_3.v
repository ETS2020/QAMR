...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n85_;
  nand2  g00(.a(x09), .b(x01), .O(new_n26_));
  ...
  nand4  g25(.a(new_n50_), .b(new_n43_), .c(x05), .d(new_n28_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n49_), .c(new_n44_), .O(z04));
  nand4  g27(.a(new_n34_), .b(new_n30_), .c(x01), .d(x00), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n49_), .c(x05), .d(new_n28_), .O(new_n55_));
  ...
  nand3  g37(.a(new_n62_), .b(x01), .c(new_n61_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n60_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n49_), .O(new_n65_));
  inv1   g40(.a(x08), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(new_n44_), .c(new_n61_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n65_), .c(new_n43_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n69_));
  nor2   g44(.a(new_n27_), .b(x13), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(new_n35_), .c(x02), .O(new_n71_));
  ...
  nand4  g49(.a(new_n70_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x02), .O(z07));
  nand4  g51(.a(x13), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n77_));
  nand3  g52(.a(new_n43_), .b(new_n35_), .c(x02), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n26_), .c(x04), .d(new_n34_), .O(new_n80_));
  ...
  nand4  g59(.a(new_n84_), .b(new_n26_), .c(x06), .d(new_n34_), .O(new_n85_));
