...
module FAU ( 
  ...
  oai21  g29(.a(x11), .b(new_n51_), .c(x09), .O(new_n55_));
  ...
  nand3  g37(.a(new_n62_), .b(new_n59_), .c(x01), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  aoi21  g39(.a(new_n61_), .b(new_n45_), .c(new_n64_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n56_), .c(new_n48_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n54_), .c(new_n53_), .d(x05), .O(new_n67_));
  nand3  g42(.a(new_n48_), .b(new_n36_), .c(x02), .O(new_n68_));
  ...
  nand2  g46(.a(new_n35_), .b(new_n31_), .O(new_n72_));
  nand3  g47(.a(new_n48_), .b(x05), .c(new_n29_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n72_), .c(new_n27_), .O(z07));
  nand4  g49(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n68_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n27_), .c(x04), .d(new_n35_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z08));
  inv1   g53(.a(x06), .O(new_n79_));
  nor3   g54(.a(new_n28_), .b(new_n48_), .c(new_n79_), .O(z09));
