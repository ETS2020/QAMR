...
module FAU ( 
  ...
  nand4  g21(.a(new_n35_), .b(new_n30_), .c(new_n42_), .d(x00), .O(new_n47_));
  ...
  oai21  g28(.a(new_n53_), .b(new_n51_), .c(new_n34_), .O(z04));
  ...
  nand2  g34(.a(x11), .b(x01), .O(new_n60_));
  ...
  nand3  g39(.a(new_n64_), .b(x01), .c(new_n41_), .O(new_n65_));
  ...
  nand3  g43(.a(new_n68_), .b(x05), .c(new_n30_), .O(new_n69_));
  nand3  g44(.a(new_n52_), .b(new_n36_), .c(x02), .O(new_n70_));
  ...
  nand2  g48(.a(new_n35_), .b(new_n30_), .O(new_n74_));
  nand3  g49(.a(new_n52_), .b(x05), .c(new_n28_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n74_), .c(new_n34_), .O(z07));
  nand4  g51(.a(x13), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n70_), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z08));
  inv1   g55(.a(x06), .O(new_n81_));
  nor3   g56(.a(new_n27_), .b(new_n52_), .c(new_n81_), .O(z09));
  nand2  g57(.a(x05), .b(x02), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(x06), .c(new_n35_), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n34_), .O(z10));
endmodule
