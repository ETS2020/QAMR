...
module FAU ( 
  ...
  nand4  g17(.a(new_n35_), .b(new_n29_), .c(x01), .d(new_n43_), .O(new_n44_));
  inv1   g18(.a(new_n44_), .O(new_n45_));
  nand4  g19(.a(new_n45_), .b(new_n42_), .c(x05), .d(new_n27_), .O(new_n46_));
  inv1   g20(.a(new_n46_), .O(z04));
  nand4  g21(.a(new_n31_), .b(new_n35_), .c(new_n29_), .d(x00), .O(new_n48_));
  ...
  nand2  g36(.a(new_n62_), .b(new_n43_), .O(new_n63_));
  ...
  nand2  g42(.a(new_n68_), .b(new_n36_), .O(z06));
  nand3  g43(.a(new_n31_), .b(new_n35_), .c(new_n29_), .O(new_n70_));
  aoi21  g44(.a(new_n70_), .b(x01), .c(x13), .O(z07));
  ...
  nand3  g48(.a(new_n74_), .b(x04), .c(new_n35_), .O(new_n75_));
