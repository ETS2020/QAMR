...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x08), .c(x05), .d(new_n27_), .O(new_n44_));
  ...
  nand3  g35(.a(new_n60_), .b(x08), .c(new_n41_), .O(new_n61_));
  ...
  nand3  g41(.a(new_n66_), .b(x01), .c(new_n40_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n65_), .c(new_n46_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n34_), .b(new_n46_), .c(new_n35_), .d(x02), .O(new_n70_));
  ...
  nand2  g48(.a(new_n33_), .b(new_n29_), .O(new_n74_));
  oai21  g49(.a(new_n47_), .b(new_n74_), .c(new_n34_), .O(z07));
  nand4  g50(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n76_));
  nand3  g51(.a(new_n46_), .b(new_n35_), .c(x02), .O(new_n77_));
  ...
  nor3   g56(.a(new_n26_), .b(new_n46_), .c(new_n81_), .O(z09));
