...
module FAU ( 
  ...
  nand4  g24(.a(new_n49_), .b(new_n44_), .c(new_n34_), .d(new_n48_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n47_), .c(new_n42_), .O(z04));
  nand4  g26(.a(new_n49_), .b(new_n44_), .c(new_n34_), .d(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n47_), .c(new_n42_), .O(z05));
  inv1   g28(.a(x07), .O(new_n54_));
  inv1   g29(.a(x12), .O(new_n55_));
  inv1   g30(.a(x13), .O(new_n56_));
  inv1   g31(.a(x08), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(x01), .c(new_n48_), .O(new_n58_));
  inv1   g33(.a(x11), .O(new_n59_));
  nor2   g34(.a(x09), .b(x01), .O(new_n60_));
  aoi22  g35(.a(new_n60_), .b(x00), .c(new_n59_), .d(x01), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n58_), .c(new_n56_), .O(new_n62_));
  ...
  nand2  g41(.a(new_n66_), .b(new_n32_), .O(z06));
  nand3  g42(.a(new_n32_), .b(new_n56_), .c(x05), .O(new_n68_));
  nor4   g43(.a(new_n68_), .b(x04), .c(x03), .d(x02), .O(z07));
