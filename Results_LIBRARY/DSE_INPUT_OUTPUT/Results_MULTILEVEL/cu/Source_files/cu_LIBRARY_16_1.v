...
module FAU ( 
  ...
  nor3   g23(.a(x02), .b(new_n44_), .c(new_n26_), .O(new_n50_));
  nand4  g24(.a(new_n50_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(x13), .O(z05));
  nand4  g26(.a(new_n27_), .b(new_n46_), .c(new_n36_), .d(x02), .O(new_n53_));
  inv1   g27(.a(x07), .O(new_n54_));
  inv1   g28(.a(x12), .O(new_n55_));
  nor2   g29(.a(x09), .b(x01), .O(new_n56_));
  nor2   g30(.a(x11), .b(new_n44_), .O(new_n57_));
  oai21  g31(.a(new_n57_), .b(new_n56_), .c(x00), .O(new_n58_));
  inv1   g32(.a(x08), .O(new_n59_));
  nand3  g33(.a(new_n59_), .b(new_n44_), .c(new_n26_), .O(new_n60_));
  aoi21  g34(.a(new_n60_), .b(new_n58_), .c(new_n46_), .O(new_n61_));
  ...
  nand2  g39(.a(new_n35_), .b(new_n31_), .O(new_n66_));
  nand3  g40(.a(new_n46_), .b(x05), .c(new_n29_), .O(new_n67_));
  oai21  g41(.a(new_n67_), .b(new_n66_), .c(new_n27_), .O(z07));
  nand4  g42(.a(x13), .b(new_n55_), .c(x05), .d(new_n31_), .O(new_n69_));
  nand3  g43(.a(new_n46_), .b(new_n36_), .c(x02), .O(new_n70_));
