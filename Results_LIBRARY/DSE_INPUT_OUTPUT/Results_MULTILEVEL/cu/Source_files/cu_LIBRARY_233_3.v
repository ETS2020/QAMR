...
module FAU ( 
  ...
  nand4  g27(.a(new_n26_), .b(new_n48_), .c(new_n35_), .d(x02), .O(new_n54_));
  inv1   g28(.a(x07), .O(new_n55_));
  inv1   g29(.a(x12), .O(new_n56_));
  nor2   g30(.a(x08), .b(x01), .O(new_n57_));
  nor2   g31(.a(x10), .b(new_n41_), .O(new_n58_));
  oai21  g32(.a(new_n58_), .b(new_n57_), .c(new_n40_), .O(new_n59_));
  inv1   g33(.a(x09), .O(new_n60_));
  nand3  g34(.a(new_n60_), .b(new_n41_), .c(x00), .O(new_n61_));
  aoi21  g35(.a(new_n61_), .b(new_n59_), .c(new_n48_), .O(new_n62_));
  ...
  nand2  g40(.a(new_n46_), .b(new_n26_), .O(z07));
  nand4  g41(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n68_));
  nand3  g42(.a(new_n48_), .b(new_n35_), .c(x02), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand3  g44(.a(new_n70_), .b(x04), .c(new_n34_), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n26_), .O(z08));
  nand3  g46(.a(new_n26_), .b(x13), .c(x06), .O(new_n73_));
  inv1   g47(.a(new_n73_), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n75_));
  nand4  g49(.a(new_n75_), .b(new_n26_), .c(x06), .d(new_n34_), .O(new_n76_));
