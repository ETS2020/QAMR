...
module FAU ( 
  ...
  nor2   g20(.a(x13), .b(new_n37_), .O(new_n46_));
  nand3  g21(.a(new_n46_), .b(new_n29_), .c(new_n36_), .O(new_n47_));
  ...
  aoi21  g25(.a(new_n50_), .b(new_n27_), .c(new_n26_), .O(z04));
  nand4  g26(.a(new_n36_), .b(new_n31_), .c(x01), .d(x00), .O(new_n52_));
  ...
  aoi21  g39(.a(new_n64_), .b(new_n60_), .c(new_n57_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n56_), .c(x05), .d(new_n31_), .O(new_n66_));
  nand3  g41(.a(new_n57_), .b(new_n37_), .c(x02), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(x12), .O(new_n68_));
  nand4  g43(.a(new_n57_), .b(new_n37_), .c(x02), .d(new_n26_), .O(new_n69_));
  ...
  nand3  g50(.a(new_n73_), .b(new_n37_), .c(x02), .O(new_n76_));
