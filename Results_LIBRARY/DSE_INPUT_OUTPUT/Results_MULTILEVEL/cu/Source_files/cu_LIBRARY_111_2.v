...
module FAU ( 
  ...
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n35_), .O(z04));
  ...
  nand4  g26(.a(x05), .b(x04), .c(new_n34_), .d(new_n30_), .O(new_n52_));
  ...
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n70_));
  ...
  nand4  g53(.a(new_n78_), .b(new_n35_), .c(x06), .d(new_n34_), .O(new_n79_));
