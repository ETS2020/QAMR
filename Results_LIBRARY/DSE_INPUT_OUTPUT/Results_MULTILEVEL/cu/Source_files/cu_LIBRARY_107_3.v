...
module FAU ( 
  ...
  nand4  g22(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n39_), .O(new_n48_));
  ...
  nand3  g35(.a(new_n60_), .b(new_n40_), .c(x00), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n59_), .c(new_n47_), .O(new_n62_));
  ...
  nand3  g44(.a(new_n47_), .b(new_n30_), .c(x02), .O(new_n70_));
