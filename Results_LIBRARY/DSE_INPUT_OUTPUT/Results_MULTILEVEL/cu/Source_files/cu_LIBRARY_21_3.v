...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n51_, new_n52_,
  ...
  nand4  g24(.a(new_n26_), .b(new_n45_), .c(new_n35_), .d(x02), .O(new_n51_));
  inv1   g25(.a(x07), .O(new_n52_));
  inv1   g26(.a(x12), .O(new_n53_));
  nor2   g27(.a(x08), .b(x01), .O(new_n54_));
  nor2   g28(.a(x10), .b(new_n44_), .O(new_n55_));
  oai21  g29(.a(new_n55_), .b(new_n54_), .c(new_n43_), .O(new_n56_));
  inv1   g30(.a(x09), .O(new_n57_));
  nand3  g31(.a(new_n57_), .b(new_n44_), .c(x00), .O(new_n58_));
  ...
  nand3  g39(.a(new_n45_), .b(new_n35_), .c(x02), .O(new_n66_));
  nand2  g40(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand4  g41(.a(new_n67_), .b(new_n26_), .c(x04), .d(new_n34_), .O(new_n68_));
  inv1   g42(.a(new_n68_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n26_), .O(z09));
  nand2  g45(.a(x05), .b(x02), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(new_n26_), .c(x06), .d(new_n34_), .O(new_n73_));
