...
module FAU ( 
  ...
  nand4  g21(.a(new_n34_), .b(new_n44_), .c(x05), .d(new_n36_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(new_n26_), .c(new_n30_), .O(new_n49_));
  ...
  nor2   g30(.a(x10), .b(new_n42_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(new_n41_), .O(new_n57_));
  inv1   g32(.a(x09), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(new_n42_), .c(x00), .O(new_n59_));
  aoi21  g34(.a(new_n59_), .b(new_n57_), .c(new_n44_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(new_n54_), .c(new_n32_), .d(x05), .O(new_n61_));
  nand3  g36(.a(new_n44_), .b(new_n27_), .c(x02), .O(new_n62_));
