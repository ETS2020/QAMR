...
module FAU ( 
  ...
  oai21  g29(.a(new_n54_), .b(x01), .c(new_n46_), .O(new_n55_));
  inv1   g30(.a(x11), .O(new_n56_));
  nor2   g31(.a(x09), .b(x01), .O(new_n57_));
  aoi22  g32(.a(new_n57_), .b(x00), .c(new_n56_), .d(x01), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(new_n55_), .c(new_n41_), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(new_n32_), .c(new_n53_), .d(x05), .O(new_n60_));
  nand3  g35(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n61_));
  ...
  nand4  g39(.a(x13), .b(new_n32_), .c(x05), .d(new_n29_), .O(new_n65_));
  ...
  nand2  g44(.a(new_n33_), .b(x13), .O(new_n70_));
