...
module FAU ( 
  ...
  nand2  g44(.a(x02), .b(x01), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(z06));
  oai21  g46(.a(new_n53_), .b(new_n38_), .c(new_n70_), .O(z07));
  nor2   g47(.a(new_n30_), .b(x03), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(new_n43_), .c(new_n26_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n34_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(x02), .O(new_n76_));
  nor2   g51(.a(new_n43_), .b(x12), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n73_), .c(x05), .d(new_n29_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n76_), .O(z08));
  nand2  g54(.a(x13), .b(x06), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n70_), .O(z09));
  oai21  g56(.a(x05), .b(x01), .c(x02), .O(new_n82_));
