...
module FAU ( 
  ...
  nand3  g39(.a(new_n64_), .b(new_n57_), .c(new_n39_), .O(new_n65_));
  and2   g40(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n61_), .c(new_n42_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n53_), .c(new_n52_), .d(x05), .O(new_n68_));
  nand4  g43(.a(new_n32_), .b(new_n42_), .c(new_n27_), .d(x02), .O(new_n69_));
  ...
  nand4  g47(.a(x13), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n73_));
