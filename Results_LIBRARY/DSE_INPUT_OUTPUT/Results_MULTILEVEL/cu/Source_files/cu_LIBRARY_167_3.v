...
module FAU ( 
  ...
  nand2  g21(.a(x10), .b(x04), .O(new_n47_));
  inv1   g22(.a(x00), .O(new_n48_));
  nand3  g23(.a(new_n27_), .b(x01), .c(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n41_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n50_));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n30_), .c(new_n34_), .O(z06));
  nand2  g42(.a(new_n26_), .b(new_n27_), .O(new_n68_));
  nand3  g43(.a(new_n41_), .b(x05), .c(new_n34_), .O(new_n69_));
