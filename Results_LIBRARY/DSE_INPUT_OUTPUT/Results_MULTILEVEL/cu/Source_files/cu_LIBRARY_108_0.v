...
module FAU ( 
  ...
  nand4  g26(.a(new_n52_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n53_));
  nor2   g27(.a(new_n53_), .b(x13), .O(z05));
  nor2   g28(.a(new_n26_), .b(x13), .O(new_n55_));
  ...
  nor2   g33(.a(x11), .b(new_n42_), .O(new_n60_));
  ...
  nand4  g42(.a(new_n55_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n69_));
  nor2   g43(.a(new_n69_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n71_));
