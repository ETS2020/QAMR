...
module FAU ( 
  ...
  nand4  g24(.a(new_n32_), .b(new_n44_), .c(new_n27_), .d(x02), .O(new_n50_));
  inv1   g25(.a(x07), .O(new_n51_));
  inv1   g26(.a(x12), .O(new_n52_));
  nor2   g27(.a(x08), .b(x01), .O(new_n53_));
  nor2   g28(.a(x10), .b(new_n43_), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n53_), .c(new_n42_), .O(new_n55_));
  inv1   g30(.a(x09), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n43_), .c(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(new_n55_), .c(new_n44_), .O(new_n58_));
  ...
  nand2  g37(.a(new_n46_), .b(new_n32_), .O(z07));
  ...
  nand4  g41(.a(new_n66_), .b(new_n32_), .c(x04), .d(new_n26_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z08));
  nand3  g43(.a(new_n32_), .b(x13), .c(x06), .O(new_n69_));
