...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n33_,
    ...
    new_n69_, new_n70_, new_n71_, new_n72_, new_n75_, new_n76_;
  inv1   g00(.a(x03), .O(new_n26_));
  inv1   g01(.a(x02), .O(new_n27_));
  inv1   g02(.a(x05), .O(new_n28_));
  oai21  g03(.a(new_n28_), .b(x04), .c(new_n27_), .O(new_n29_));
  nand3  g04(.a(x06), .b(new_n28_), .c(x04), .O(new_n30_));
  ...
  nand4  g09(.a(x06), .b(new_n28_), .c(x04), .d(x02), .O(new_n35_));
  ...
  nand2  g15(.a(new_n40_), .b(new_n28_), .O(new_n41_));
  inv1   g16(.a(x01), .O(new_n42_));
  nand3  g17(.a(new_n27_), .b(new_n42_), .c(x00), .O(new_n43_));
  inv1   g18(.a(x13), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n33_), .d(new_n26_), .O(new_n45_));
  ...
  oai21  g25(.a(new_n50_), .b(new_n45_), .c(new_n41_), .O(z05));
  inv1   g26(.a(x07), .O(new_n52_));
  inv1   g27(.a(x12), .O(new_n53_));
  nor2   g28(.a(x09), .b(x01), .O(new_n54_));
  nor2   g29(.a(x11), .b(new_n42_), .O(new_n55_));
  ...
  aoi21  g34(.a(new_n59_), .b(new_n56_), .c(new_n44_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(new_n53_), .c(new_n52_), .d(x05), .O(new_n61_));
  nand4  g36(.a(new_n44_), .b(x06), .c(new_n28_), .d(x02), .O(new_n62_));
  ...
  nand2  g40(.a(new_n26_), .b(new_n27_), .O(new_n66_));
  nand3  g41(.a(new_n44_), .b(x05), .c(new_n33_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n66_), .c(new_n41_), .O(z07));
  ...
  nand2  g47(.a(new_n72_), .b(new_n41_), .O(z08));
  nor2   g48(.a(new_n44_), .b(new_n40_), .O(z09));
