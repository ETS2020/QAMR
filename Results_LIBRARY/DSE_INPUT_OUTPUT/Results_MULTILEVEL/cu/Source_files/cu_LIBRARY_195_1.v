...
module FAU ( 
  ...
  nand4  g17(.a(new_n35_), .b(new_n31_), .c(new_n42_), .d(new_n26_), .O(new_n43_));
  ...
  nand4  g22(.a(new_n35_), .b(new_n31_), .c(new_n42_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n47_), .c(x05), .d(new_n29_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nand4  g26(.a(new_n35_), .b(new_n31_), .c(x01), .d(new_n26_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n41_), .c(x05), .d(new_n29_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nand3  g30(.a(new_n31_), .b(x01), .c(x00), .O(new_n56_));
  nand4  g31(.a(new_n47_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n57_));
  ...
  nand2  g38(.a(x08), .b(new_n42_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(new_n41_), .c(new_n26_), .O(new_n65_));
  ...
  nand3  g50(.a(new_n47_), .b(new_n36_), .c(x02), .O(new_n76_));
