...
module FAU ( 
  ...
  nand3  g28(.a(new_n53_), .b(new_n27_), .c(x02), .O(new_n54_));
  ...
  nand4  g41(.a(new_n53_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n69_));
  nand3  g44(.a(new_n44_), .b(new_n27_), .c(x02), .O(new_n70_));
