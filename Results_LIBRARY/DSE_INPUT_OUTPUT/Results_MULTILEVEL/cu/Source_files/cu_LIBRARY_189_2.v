...
module FAU ( 
  ...
  nand3  g18(.a(new_n29_), .b(x01), .c(new_n32_), .O(new_n45_));
  ...
  nand3  g39(.a(new_n46_), .b(new_n30_), .c(x02), .O(new_n66_));
  ...
  nand4  g44(.a(new_n70_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n71_));
