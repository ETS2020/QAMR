...
module FAU ( 
  ...
  nand2  g23(.a(new_n35_), .b(new_n30_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x00), .O(new_n50_));
  nand3  g25(.a(new_n44_), .b(x05), .c(new_n28_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand2  g27(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x09), .c(new_n26_), .O(z04));
  nand4  g29(.a(new_n35_), .b(new_n30_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x09), .c(x05), .d(new_n28_), .O(new_n57_));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n62_), .c(new_n44_), .O(new_n67_));
  ...
  oai21  g47(.a(new_n51_), .b(new_n49_), .c(new_n34_), .O(z07));
