...
module FAU ( 
  ...
  nand4  g18(.a(new_n35_), .b(new_n30_), .c(new_n43_), .d(new_n42_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x08), .c(x05), .d(new_n26_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z02));
  nand4  g22(.a(new_n35_), .b(new_n30_), .c(new_n43_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x08), .c(x05), .d(new_n26_), .O(new_n50_));
  ...
  aoi21  g31(.a(new_n56_), .b(x08), .c(x04), .O(z04));
  nand3  g32(.a(new_n55_), .b(new_n52_), .c(x00), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(x08), .c(x04), .O(z05));
  ...
  nand4  g49(.a(new_n74_), .b(x08), .c(x05), .d(new_n26_), .O(new_n75_));
  ...
  nand2  g56(.a(new_n81_), .b(new_n28_), .O(z09));
  nand2  g57(.a(x05), .b(x02), .O(new_n83_));
  nand4  g58(.a(new_n83_), .b(new_n28_), .c(x06), .d(new_n35_), .O(new_n84_));
