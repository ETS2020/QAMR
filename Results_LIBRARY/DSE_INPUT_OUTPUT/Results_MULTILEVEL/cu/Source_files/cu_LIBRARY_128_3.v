...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(x01), .O(new_n32_));
  ...
  oai21  g10(.a(new_n30_), .b(x02), .c(new_n35_), .O(new_n36_));
  ...
  inv1   g27(.a(new_n30_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n42_), .c(new_n43_), .O(z05));
  ...
  nand3  g38(.a(new_n42_), .b(new_n34_), .c(x02), .O(new_n64_));
  ...
  nand4  g42(.a(x05), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x13), .O(z07));
  nand2  g44(.a(new_n29_), .b(new_n43_), .O(new_n70_));
  ...
  aoi21  g50(.a(new_n75_), .b(new_n43_), .c(new_n42_), .O(z09));
  nand2  g51(.a(x05), .b(x02), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n32_), .c(x06), .d(new_n26_), .O(new_n78_));
