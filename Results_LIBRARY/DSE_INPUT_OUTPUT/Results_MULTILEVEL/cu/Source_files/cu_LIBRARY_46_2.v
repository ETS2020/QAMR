...
module FAU ( 
  ...
  nand3  g23(.a(new_n43_), .b(x05), .c(new_n27_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand3  g25(.a(new_n50_), .b(new_n48_), .c(new_n41_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(x07), .c(new_n32_), .O(z04));
  nand3  g27(.a(new_n50_), .b(new_n48_), .c(x00), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x07), .c(new_n32_), .O(z05));
  ...
  inv1   g41(.a(new_n48_), .O(new_n67_));
  oai21  g42(.a(new_n49_), .b(new_n67_), .c(new_n34_), .O(z07));
  ...
  nor3   g48(.a(new_n33_), .b(new_n43_), .c(new_n73_), .O(z09));
