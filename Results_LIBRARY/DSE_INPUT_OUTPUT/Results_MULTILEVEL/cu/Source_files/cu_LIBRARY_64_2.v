...
module FAU ( 
  ...
  nand3  g18(.a(new_n29_), .b(x01), .c(new_n44_), .O(new_n45_));
  nor2   g19(.a(x13), .b(new_n30_), .O(new_n46_));
  nand3  g20(.a(new_n46_), .b(new_n27_), .c(new_n26_), .O(new_n47_));
  oai21  g21(.a(new_n47_), .b(new_n45_), .c(new_n33_), .O(z04));
  nand4  g22(.a(new_n46_), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n49_));
  aoi21  g23(.a(new_n49_), .b(x01), .c(new_n44_), .O(z05));
  aoi21  g24(.a(new_n32_), .b(x00), .c(x13), .O(new_n51_));
  ...
  oai21  g31(.a(new_n57_), .b(new_n56_), .c(new_n44_), .O(new_n58_));
