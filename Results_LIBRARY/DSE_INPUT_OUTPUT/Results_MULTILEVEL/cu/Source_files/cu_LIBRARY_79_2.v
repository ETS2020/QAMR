...
module FAU ( 
  ...
  nand4  g27(.a(x05), .b(x04), .c(new_n34_), .d(new_n30_), .O(new_n53_));
  ...
  nand2  g44(.a(new_n34_), .b(new_n30_), .O(new_n70_));
  nand3  g45(.a(new_n44_), .b(x05), .c(new_n28_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n35_), .O(z07));
