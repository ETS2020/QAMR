...
module FAU ( 
  ...
  nor3   g15(.a(x04), .b(x03), .c(x02), .O(new_n41_));
  ...
  nand4  g21(.a(new_n46_), .b(new_n29_), .c(x01), .d(new_n39_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n28_), .c(x05), .d(new_n30_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z04));
  nand3  g25(.a(new_n41_), .b(x01), .c(x00), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n28_), .c(new_n33_), .O(z05));
  nand2  g27(.a(new_n46_), .b(x02), .O(new_n53_));
  nand3  g28(.a(new_n28_), .b(new_n33_), .c(x04), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n53_), .c(new_n26_), .O(z06));
  nor2   g30(.a(new_n41_), .b(x13), .O(new_n56_));
  nor2   g31(.a(new_n56_), .b(new_n33_), .O(z07));
  nand4  g32(.a(new_n33_), .b(x04), .c(new_n46_), .d(x02), .O(new_n58_));
  nor2   g33(.a(new_n58_), .b(x13), .O(z08));
  nand3  g34(.a(x13), .b(x06), .c(new_n33_), .O(new_n60_));
  inv1   g35(.a(new_n60_), .O(z09));
  oai21  g36(.a(x13), .b(x02), .c(x05), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(x06), .c(new_n46_), .O(new_n63_));
