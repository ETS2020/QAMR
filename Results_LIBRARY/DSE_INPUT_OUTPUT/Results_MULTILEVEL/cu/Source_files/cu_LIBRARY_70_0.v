...
module FAU ( 
  ...
  aoi21  g19(.a(new_n44_), .b(x12), .c(x01), .O(z02));
  nand4  g20(.a(new_n43_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x12), .c(x01), .O(z03));
  nand4  g22(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n40_), .O(new_n48_));
  ...
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n69_));
