...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n40_), .O(new_n46_));
  inv1   g20(.a(new_n46_), .O(new_n47_));
  nand4  g21(.a(new_n47_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n48_));
  inv1   g22(.a(new_n48_), .O(z04));
  aoi21  g23(.a(new_n43_), .b(x01), .c(new_n40_), .O(z05));
  inv1   g24(.a(new_n33_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(x13), .O(new_n52_));
  nand3  g26(.a(new_n52_), .b(new_n30_), .c(x02), .O(new_n53_));
  inv1   g27(.a(x07), .O(new_n54_));
  inv1   g28(.a(x12), .O(new_n55_));
  nor2   g29(.a(x08), .b(x01), .O(new_n56_));
  nor2   g30(.a(x10), .b(new_n32_), .O(new_n57_));
  oai21  g31(.a(new_n57_), .b(new_n56_), .c(new_n40_), .O(new_n58_));
  ...
  nand4  g39(.a(new_n52_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n66_));
  nor2   g40(.a(new_n66_), .b(x02), .O(z07));
  nand4  g41(.a(x13), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n68_));
  nand3  g42(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n69_));
  ...
  nor3   g47(.a(new_n51_), .b(new_n41_), .c(new_n73_), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n75_));
  nand3  g49(.a(new_n75_), .b(x06), .c(new_n26_), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n33_), .O(z10));
  zero   g51(.O(z03));
endmodule
