...
module FAU ( 
  ...
  nand4  g42(.a(new_n32_), .b(new_n42_), .c(new_n30_), .d(x02), .O(new_n68_));
  ...
  oai21  g47(.a(new_n54_), .b(new_n72_), .c(new_n32_), .O(z07));
  nand4  g48(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n74_));
  nand3  g49(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n75_));
