...
module FAU ( 
  ...
  nor2   g35(.a(x10), .b(new_n57_), .O(new_n61_));
  ...
  nand4  g39(.a(new_n45_), .b(new_n29_), .c(x02), .d(x01), .O(new_n65_));
  ...
  nand4  g43(.a(x05), .b(new_n35_), .c(new_n46_), .d(new_n34_), .O(new_n69_));
  ...
  nor3   g50(.a(new_n26_), .b(new_n45_), .c(new_n75_), .O(z09));
  nand2  g51(.a(x05), .b(x02), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x06), .c(new_n46_), .O(new_n78_));
