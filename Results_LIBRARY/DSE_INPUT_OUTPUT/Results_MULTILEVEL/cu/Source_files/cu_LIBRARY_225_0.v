...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n28_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand3  g25(.a(new_n32_), .b(x01), .c(new_n50_), .O(new_n51_));
  ...
  nor2   g30(.a(x10), .b(new_n45_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(new_n50_), .O(new_n57_));
  inv1   g32(.a(x09), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(new_n45_), .c(x00), .O(new_n59_));
  aoi21  g34(.a(new_n59_), .b(new_n57_), .c(new_n47_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(new_n27_), .c(new_n54_), .d(x05), .O(new_n61_));
  nand3  g36(.a(new_n47_), .b(new_n37_), .c(x02), .O(new_n62_));
  oai21  g37(.a(new_n61_), .b(x02), .c(new_n62_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(x04), .c(new_n36_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n28_), .O(z06));
  nand2  g40(.a(new_n36_), .b(new_n32_), .O(new_n66_));
  nand3  g41(.a(new_n47_), .b(x05), .c(new_n30_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n66_), .c(new_n28_), .O(z07));
  nand4  g43(.a(new_n28_), .b(new_n47_), .c(new_n37_), .d(x02), .O(new_n69_));
  nor2   g44(.a(new_n37_), .b(x02), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x13), .c(new_n27_), .d(x11), .O(new_n71_));
  ...
  nand2  g50(.a(new_n75_), .b(new_n28_), .O(z09));
