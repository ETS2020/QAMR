...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n49_, new_n52_,
  ...
  nand4  g19(.a(new_n32_), .b(new_n42_), .c(x05), .d(new_n34_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand3  g21(.a(new_n46_), .b(new_n26_), .c(new_n30_), .O(new_n47_));
  ...
  nor3   g25(.a(new_n47_), .b(new_n40_), .c(new_n39_), .O(z05));
  ...
  inv1   g40(.a(new_n47_), .O(z07));
  nand4  g41(.a(x13), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n62_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n32_), .c(x04), .d(new_n26_), .O(new_n69_));
