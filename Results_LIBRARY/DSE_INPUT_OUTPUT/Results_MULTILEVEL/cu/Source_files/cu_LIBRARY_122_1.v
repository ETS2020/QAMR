...
module FAU ( 
  ...
  nand4  g19(.a(new_n30_), .b(x05), .c(new_n36_), .d(new_n34_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n44_), .c(new_n27_), .O(z02));
  nand4  g21(.a(new_n34_), .b(new_n35_), .c(new_n43_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n30_), .c(x05), .d(new_n36_), .O(new_n49_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n57_), .c(new_n56_), .d(new_n35_), .O(new_n65_));
  nand2  g40(.a(new_n26_), .b(x02), .O(new_n66_));
  ...
  nand3  g46(.a(x13), .b(new_n57_), .c(new_n35_), .O(new_n72_));
  ...
  oai21  g53(.a(x13), .b(x05), .c(new_n78_), .O(new_n79_));
