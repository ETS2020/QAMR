...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(new_n26_), .c(new_n29_), .d(new_n41_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n30_), .c(new_n35_), .O(z02));
  nand4  g19(.a(new_n42_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n30_), .c(new_n35_), .O(z03));
  ...
  nand4  g28(.a(new_n55_), .b(x13), .c(new_n50_), .d(new_n49_), .O(new_n56_));
  inv1   g29(.a(new_n56_), .O(new_n57_));
  nand4  g30(.a(new_n57_), .b(x05), .c(new_n29_), .d(new_n30_), .O(new_n58_));
  inv1   g31(.a(x13), .O(new_n59_));
  nand3  g32(.a(new_n59_), .b(new_n35_), .c(x02), .O(new_n60_));
  nand2  g33(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nand3  g34(.a(new_n61_), .b(x04), .c(new_n26_), .O(new_n62_));
  inv1   g35(.a(new_n62_), .O(z06));
  nand3  g36(.a(new_n42_), .b(new_n26_), .c(new_n29_), .O(new_n64_));
  aoi21  g37(.a(new_n64_), .b(new_n30_), .c(new_n35_), .O(z07));
  nand4  g38(.a(x13), .b(new_n50_), .c(x05), .d(new_n29_), .O(new_n66_));
  nand2  g39(.a(new_n66_), .b(new_n60_), .O(new_n67_));
  nand3  g40(.a(new_n67_), .b(x04), .c(new_n26_), .O(new_n68_));
  nand2  g41(.a(new_n68_), .b(new_n39_), .O(z08));
  nand3  g42(.a(new_n39_), .b(x13), .c(x06), .O(new_n70_));
  inv1   g43(.a(new_n70_), .O(z09));
  oai21  g44(.a(x02), .b(x01), .c(x05), .O(new_n72_));
  nand3  g45(.a(new_n72_), .b(x06), .c(new_n26_), .O(new_n73_));
