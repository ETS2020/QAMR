...
module FAU ( 
  ...
  nor2   g08(.a(new_n33_), .b(new_n32_), .O(new_n34_));
  inv1   g09(.a(new_n34_), .O(new_n35_));
  nand4  g10(.a(new_n35_), .b(new_n31_), .c(new_n29_), .d(new_n26_), .O(z00));
  inv1   g11(.a(x04), .O(new_n37_));
  nand3  g12(.a(x05), .b(new_n37_), .c(new_n30_), .O(new_n38_));
  oai21  g13(.a(new_n28_), .b(new_n30_), .c(new_n38_), .O(new_n39_));
  nand3  g14(.a(new_n39_), .b(new_n35_), .c(new_n26_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(z01));
  inv1   g16(.a(x00), .O(new_n42_));
  inv1   g17(.a(x01), .O(new_n43_));
  nand3  g18(.a(new_n30_), .b(new_n43_), .c(new_n42_), .O(new_n44_));
  inv1   g19(.a(x13), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n37_), .d(new_n26_), .O(new_n46_));
  ...
  nand3  g24(.a(new_n30_), .b(x01), .c(new_n42_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n46_), .c(new_n35_), .O(z04));
  nor2   g26(.a(new_n34_), .b(x13), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n37_), .d(new_n26_), .O(new_n53_));
  ...
  nand3  g34(.a(new_n33_), .b(new_n59_), .c(new_n43_), .O(new_n60_));
  inv1   g35(.a(x11), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n32_), .c(x01), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(x00), .O(new_n64_));
  nand2  g39(.a(new_n32_), .b(new_n43_), .O(new_n65_));
  nand2  g40(.a(new_n33_), .b(x01), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g42(.a(new_n59_), .b(new_n32_), .c(new_n43_), .O(new_n68_));
  nand3  g43(.a(new_n61_), .b(new_n33_), .c(x01), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  aoi21  g45(.a(new_n67_), .b(new_n42_), .c(new_n70_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n64_), .c(new_n45_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n73_));
  nand3  g48(.a(new_n52_), .b(new_n27_), .c(x02), .O(new_n74_));
  ...
  nand3  g53(.a(new_n45_), .b(new_n27_), .c(x02), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n35_), .c(x04), .d(new_n26_), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z08));
  nand3  g57(.a(new_n35_), .b(x13), .c(x06), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z09));
  nand2  g59(.a(x05), .b(x02), .O(new_n85_));
  nand4  g60(.a(new_n85_), .b(new_n35_), .c(x06), .d(new_n26_), .O(new_n86_));
