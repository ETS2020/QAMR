...
module FAU ( 
  ...
  aoi21  g23(.a(new_n48_), .b(new_n40_), .c(x01), .O(z03));
  ...
  nand2  g34(.a(new_n59_), .b(new_n32_), .O(new_n60_));
  inv1   g35(.a(x11), .O(new_n61_));
  nand3  g36(.a(new_n40_), .b(new_n61_), .c(x01), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(x00), .O(new_n64_));
  inv1   g39(.a(x08), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n32_), .O(new_n66_));
  inv1   g41(.a(x10), .O(new_n67_));
  nand3  g42(.a(new_n40_), .b(new_n67_), .c(x01), .O(new_n68_));
  ...
  nand4  g46(.a(new_n71_), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n72_));
  nand3  g47(.a(new_n50_), .b(new_n30_), .c(x02), .O(new_n73_));
  ...
  aoi21  g51(.a(x12), .b(new_n32_), .c(x13), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n78_));
  nor2   g53(.a(new_n78_), .b(x02), .O(z07));
  nand3  g54(.a(new_n77_), .b(new_n30_), .c(x02), .O(new_n80_));
  nand4  g55(.a(x13), .b(new_n40_), .c(x05), .d(new_n29_), .O(new_n81_));
