...
module FAU ( 
  ...
  nor2   g27(.a(x11), .b(new_n40_), .O(new_n54_));
  oai21  g28(.a(new_n54_), .b(new_n53_), .c(x00), .O(new_n55_));
  inv1   g29(.a(x08), .O(new_n56_));
  nand3  g30(.a(new_n56_), .b(new_n40_), .c(new_n32_), .O(new_n57_));
