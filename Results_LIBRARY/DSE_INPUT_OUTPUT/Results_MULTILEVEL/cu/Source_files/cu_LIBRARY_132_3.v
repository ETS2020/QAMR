...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(new_n44_), .c(x05), .d(new_n34_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n43_), .c(new_n42_), .O(z03));
  aoi21  g22(.a(new_n46_), .b(new_n42_), .c(new_n43_), .O(z04));
  ...
  oai21  g28(.a(new_n54_), .b(new_n50_), .c(new_n43_), .O(new_n55_));
  nand2  g29(.a(new_n55_), .b(x00), .O(new_n56_));
  inv1   g30(.a(x08), .O(new_n57_));
  nand3  g31(.a(new_n57_), .b(new_n43_), .c(new_n42_), .O(new_n58_));
  inv1   g32(.a(x10), .O(new_n59_));
  nand2  g33(.a(new_n59_), .b(x01), .O(new_n60_));
  aoi21  g34(.a(new_n60_), .b(new_n58_), .c(new_n44_), .O(new_n61_));
  nand4  g35(.a(new_n61_), .b(new_n53_), .c(new_n51_), .d(x05), .O(new_n62_));
  nand3  g36(.a(new_n44_), .b(new_n27_), .c(x02), .O(new_n63_));
  ...
  nand3  g40(.a(new_n32_), .b(new_n44_), .c(x05), .O(new_n67_));
  nor4   g41(.a(new_n67_), .b(x04), .c(x03), .d(x02), .O(z07));
  nand4  g42(.a(x13), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n63_), .O(new_n70_));
  nand3  g44(.a(new_n70_), .b(x04), .c(new_n26_), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n32_), .O(z08));
  nand3  g46(.a(new_n32_), .b(x13), .c(x06), .O(new_n73_));
  inv1   g47(.a(new_n73_), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n75_));
  nand3  g49(.a(new_n75_), .b(x06), .c(new_n26_), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n32_), .O(z10));
  zero   g51(.O(z05));
endmodule
