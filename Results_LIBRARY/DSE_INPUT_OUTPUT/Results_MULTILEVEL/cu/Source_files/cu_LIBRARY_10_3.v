...
module FAU ( 
  ...
  nand2  g13(.a(x07), .b(x03), .O(new_n39_));
  inv1   g14(.a(x01), .O(new_n40_));
  nand3  g15(.a(new_n29_), .b(new_n40_), .c(x00), .O(new_n41_));
  inv1   g16(.a(x13), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n41_), .c(new_n39_), .O(z03));
  inv1   g19(.a(x00), .O(new_n45_));
  nand3  g20(.a(new_n29_), .b(x01), .c(new_n45_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n43_), .c(new_n39_), .O(z04));
  nor3   g22(.a(x02), .b(new_n40_), .c(new_n45_), .O(new_n48_));
  ...
  nor2   g28(.a(x11), .b(new_n40_), .O(new_n54_));
  ...
  aoi21  g33(.a(new_n58_), .b(new_n55_), .c(new_n42_), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(new_n52_), .c(new_n51_), .d(x05), .O(new_n60_));
  nand3  g35(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n61_));
  oai21  g36(.a(new_n60_), .b(x02), .c(new_n61_), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(x04), .c(new_n26_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n39_), .O(z06));
  nand2  g39(.a(new_n26_), .b(new_n29_), .O(new_n65_));
  nand3  g40(.a(new_n42_), .b(x05), .c(new_n27_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(new_n39_), .O(z07));
  nand4  g42(.a(x13), .b(new_n52_), .c(x05), .d(new_n29_), .O(new_n68_));
  ...
  nand2  g50(.a(new_n75_), .b(new_n39_), .O(z10));
endmodule
