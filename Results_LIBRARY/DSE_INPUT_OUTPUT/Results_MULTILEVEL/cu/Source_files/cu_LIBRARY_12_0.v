...
module FAU ( 
  ...
  nor3   g16(.a(new_n41_), .b(x03), .c(x02), .O(z07));
  inv1   g17(.a(z07), .O(new_n43_));
  ...
  nor2   g30(.a(x11), .b(new_n45_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(x00), .O(new_n57_));
  inv1   g32(.a(x10), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(x01), .c(new_n49_), .O(new_n59_));
  ...
  nand4  g38(.a(new_n40_), .b(x12), .c(new_n30_), .d(x02), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  aoi21  g40(.a(new_n63_), .b(x08), .c(new_n65_), .O(new_n66_));
  nor3   g41(.a(new_n66_), .b(new_n27_), .c(x03), .O(z06));
  nand4  g42(.a(new_n33_), .b(new_n40_), .c(new_n30_), .d(x02), .O(new_n68_));
  nor2   g43(.a(new_n30_), .b(x02), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(x13), .c(new_n54_), .d(x08), .O(new_n70_));
  ...
  nor3   g49(.a(new_n32_), .b(new_n40_), .c(new_n74_), .O(z09));
