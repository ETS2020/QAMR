...
module FAU ( 
  ...
  nand4  g19(.a(new_n46_), .b(new_n35_), .c(x05), .d(new_n27_), .O(new_n47_));
  inv1   g20(.a(new_n47_), .O(z04));
  nand4  g21(.a(new_n31_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n49_));
  aoi21  g22(.a(new_n49_), .b(x01), .c(x13), .O(z05));
  inv1   g23(.a(x07), .O(new_n51_));
  inv1   g24(.a(x09), .O(new_n52_));
  nand2  g25(.a(new_n52_), .b(new_n34_), .O(new_n53_));
  ...
  nand2  g31(.a(new_n58_), .b(new_n34_), .O(new_n59_));
  ...
  nand2  g41(.a(new_n68_), .b(new_n36_), .O(z06));
  nand4  g42(.a(new_n27_), .b(new_n26_), .c(new_n29_), .d(x01), .O(new_n70_));
  nor3   g43(.a(new_n70_), .b(x13), .c(new_n30_), .O(z07));
  inv1   g44(.a(x12), .O(new_n72_));
  nand4  g45(.a(x13), .b(new_n72_), .c(x05), .d(new_n29_), .O(new_n73_));
  nand4  g46(.a(new_n35_), .b(new_n30_), .c(x02), .d(x01), .O(new_n74_));
  nand2  g47(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g48(.a(new_n75_), .b(x04), .c(new_n26_), .O(new_n76_));
  inv1   g49(.a(new_n76_), .O(z08));
  nand2  g50(.a(x13), .b(x06), .O(new_n78_));
  nand2  g51(.a(new_n78_), .b(new_n36_), .O(z09));
  nand2  g52(.a(x05), .b(x02), .O(new_n80_));
  nand4  g53(.a(new_n80_), .b(new_n36_), .c(x06), .d(new_n26_), .O(new_n81_));
