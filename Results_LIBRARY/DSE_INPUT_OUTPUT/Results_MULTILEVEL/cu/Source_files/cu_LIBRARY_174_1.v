...
module FAU ( 
  ...
  nand4  g18(.a(new_n35_), .b(new_n29_), .c(new_n43_), .d(new_n42_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n31_), .c(x05), .d(new_n26_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z02));
  nand4  g22(.a(new_n35_), .b(new_n29_), .c(new_n43_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n31_), .c(x05), .d(new_n26_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z03));
  nor2   g26(.a(x02), .b(new_n43_), .O(new_n52_));
  inv1   g27(.a(x13), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(x05), .c(new_n35_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand3  g30(.a(new_n55_), .b(new_n52_), .c(new_n42_), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n31_), .c(x04), .O(z04));
  nand3  g32(.a(new_n55_), .b(new_n52_), .c(x00), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(new_n31_), .c(x04), .O(z05));
  ...
  aoi21  g39(.a(x10), .b(x01), .c(x08), .O(new_n65_));
  ...
  nand3  g44(.a(new_n53_), .b(new_n37_), .c(x02), .O(new_n70_));
  ...
  nand4  g49(.a(new_n74_), .b(new_n31_), .c(x05), .d(new_n26_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x13), .O(z07));
  nand2  g51(.a(x13), .b(new_n61_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(new_n32_), .c(new_n70_), .O(new_n78_));
  ...
  nand4  g58(.a(new_n83_), .b(new_n27_), .c(x06), .d(new_n35_), .O(new_n84_));
