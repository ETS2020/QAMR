...
module FAU ( 
  ...
  nand4  g21(.a(new_n36_), .b(new_n31_), .c(new_n42_), .d(x00), .O(new_n47_));
  ...
  nand4  g26(.a(new_n36_), .b(new_n31_), .c(x01), .d(new_n26_), .O(new_n52_));
  ...
  nand4  g31(.a(new_n56_), .b(new_n44_), .c(new_n29_), .d(x01), .O(new_n57_));
