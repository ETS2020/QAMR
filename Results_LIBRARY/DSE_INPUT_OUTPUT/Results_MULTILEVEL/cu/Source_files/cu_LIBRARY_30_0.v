...
module FAU ( 
  ...
  aoi21  g32(.a(new_n57_), .b(x11), .c(x13), .O(z05));
  ...
  nand4  g43(.a(new_n33_), .b(x11), .c(new_n30_), .d(x02), .O(new_n69_));
  ...
  aoi21  g48(.a(new_n73_), .b(x11), .c(x13), .O(z07));
  ...
  nand4  g56(.a(new_n81_), .b(new_n34_), .c(x06), .d(new_n26_), .O(new_n82_));
