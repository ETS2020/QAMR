...
module FAU ( 
  ...
  nor2   g22(.a(x02), .b(x01), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n35_), .c(new_n26_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n41_), .c(x13), .O(z03));
  nand4  g25(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n42_), .O(new_n51_));
