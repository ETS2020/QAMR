...
module FAU ( 
  ...
  nor3   g31(.a(new_n56_), .b(x13), .c(new_n38_), .O(z06));
  nand4  g32(.a(x05), .b(new_n33_), .c(new_n26_), .d(new_n27_), .O(new_n58_));
  nor2   g33(.a(new_n58_), .b(x13), .O(z07));
  inv1   g34(.a(x12), .O(new_n60_));
  nand4  g35(.a(x13), .b(new_n60_), .c(x05), .d(new_n27_), .O(new_n61_));
  nand3  g36(.a(new_n44_), .b(new_n28_), .c(x02), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n26_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(x07), .c(new_n33_), .O(z08));
  inv1   g40(.a(x06), .O(new_n66_));
  nand2  g41(.a(new_n39_), .b(x13), .O(new_n67_));
