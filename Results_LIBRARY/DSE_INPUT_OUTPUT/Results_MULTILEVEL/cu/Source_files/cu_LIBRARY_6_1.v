...
module FAU ( 
  ...
  nand2  g13(.a(x06), .b(new_n28_), .O(new_n39_));
  ...
  nand3  g21(.a(new_n46_), .b(new_n34_), .c(new_n26_), .O(new_n47_));
  ...
  nand4  g40(.a(new_n57_), .b(new_n30_), .c(new_n28_), .d(x02), .O(new_n66_));
  ...
  nand2  g45(.a(new_n46_), .b(new_n34_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n39_), .O(z07));
  nand4  g47(.a(x13), .b(new_n56_), .c(x05), .d(new_n27_), .O(new_n73_));
  nand3  g48(.a(new_n57_), .b(new_n28_), .c(x02), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x04), .c(new_n26_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n39_), .O(z08));
  nor2   g52(.a(new_n46_), .b(new_n30_), .O(z09));
  nand4  g53(.a(x06), .b(x05), .c(new_n26_), .d(new_n27_), .O(new_n79_));
