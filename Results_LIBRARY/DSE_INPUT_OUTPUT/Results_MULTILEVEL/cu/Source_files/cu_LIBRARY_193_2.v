...
module FAU ( 
  ...
  nand3  g43(.a(new_n68_), .b(x09), .c(x01), .O(new_n69_));
  ...
  nand4  g48(.a(new_n27_), .b(new_n44_), .c(new_n36_), .d(x02), .O(new_n74_));
  ...
  nand2  g52(.a(new_n35_), .b(new_n31_), .O(new_n78_));
  oai21  g53(.a(new_n55_), .b(new_n78_), .c(new_n27_), .O(z07));
