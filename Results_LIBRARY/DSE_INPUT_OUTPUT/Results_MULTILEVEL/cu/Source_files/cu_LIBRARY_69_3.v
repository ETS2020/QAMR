...
module FAU ( 
  ...
  nand4  g42(.a(new_n54_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n70_));
  nand3  g45(.a(new_n43_), .b(new_n35_), .c(x02), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n26_), .c(x04), .d(new_n34_), .O(new_n73_));
