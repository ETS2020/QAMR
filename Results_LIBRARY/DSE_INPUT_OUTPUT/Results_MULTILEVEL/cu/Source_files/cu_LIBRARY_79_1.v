...
module FAU ( 
  ...
  nand3  g18(.a(new_n30_), .b(new_n26_), .c(x00), .O(new_n44_));
  ...
  nor3   g23(.a(x02), .b(new_n26_), .c(new_n49_), .O(new_n50_));
  nand4  g24(.a(new_n50_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(x13), .O(z05));
  nand4  g26(.a(x05), .b(x04), .c(new_n34_), .d(new_n30_), .O(new_n53_));
  ...
  oai21  g31(.a(new_n57_), .b(new_n53_), .c(new_n26_), .O(new_n58_));
  nand2  g32(.a(new_n58_), .b(new_n49_), .O(new_n59_));
  inv1   g33(.a(x09), .O(new_n60_));
  nand3  g34(.a(new_n60_), .b(new_n26_), .c(x00), .O(new_n61_));
  ...
  nand3  g39(.a(new_n45_), .b(new_n36_), .c(x02), .O(new_n66_));
  oai21  g40(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  nand3  g41(.a(new_n67_), .b(x04), .c(new_n34_), .O(new_n68_));
  nand2  g42(.a(new_n68_), .b(new_n59_), .O(z06));
  nand2  g43(.a(new_n34_), .b(new_n30_), .O(new_n70_));
  nand3  g44(.a(new_n45_), .b(x05), .c(new_n28_), .O(new_n71_));
  oai21  g45(.a(new_n71_), .b(new_n70_), .c(new_n35_), .O(z07));
  nand4  g46(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n66_), .O(new_n74_));
  nand4  g48(.a(new_n74_), .b(new_n35_), .c(x04), .d(new_n34_), .O(new_n75_));
  inv1   g49(.a(new_n75_), .O(z08));
  nand2  g50(.a(x13), .b(x06), .O(new_n77_));
  nand2  g51(.a(new_n77_), .b(new_n35_), .O(z09));
  nand2  g52(.a(x05), .b(x02), .O(new_n79_));
  nand4  g53(.a(new_n79_), .b(new_n35_), .c(x06), .d(new_n34_), .O(new_n80_));
