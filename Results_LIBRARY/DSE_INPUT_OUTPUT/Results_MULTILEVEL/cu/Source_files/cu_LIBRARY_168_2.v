...
module FAU ( 
  ...
  aoi21  g18(.a(new_n43_), .b(new_n26_), .c(x01), .O(z02));
  nand3  g19(.a(new_n30_), .b(x01), .c(new_n26_), .O(new_n46_));
  nand4  g20(.a(new_n41_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n47_));
  oai21  g21(.a(new_n47_), .b(new_n46_), .c(new_n34_), .O(z04));
  aoi21  g22(.a(new_n43_), .b(x01), .c(new_n26_), .O(z05));
  ...
  nand3  g34(.a(new_n60_), .b(x01), .c(new_n26_), .O(new_n61_));
  ...
  nand4  g42(.a(new_n68_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n69_));
  nor2   g43(.a(new_n69_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n71_));
  ...
  nor3   g49(.a(new_n27_), .b(new_n41_), .c(new_n75_), .O(z09));
