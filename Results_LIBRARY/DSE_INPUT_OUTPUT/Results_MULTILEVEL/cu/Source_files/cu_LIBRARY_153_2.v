...
module FAU ( 
  ...
  nor2   g11(.a(x12), .b(new_n26_), .O(new_n37_));
  ...
  nand4  g41(.a(new_n43_), .b(new_n30_), .c(new_n26_), .d(x02), .O(new_n67_));
  ...
  nand3  g48(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n74_));
  ...
  nor3   g53(.a(new_n37_), .b(new_n43_), .c(new_n78_), .O(z09));
