...
module FAU ( 
  ...
  nand3  g20(.a(new_n45_), .b(new_n35_), .c(new_n26_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n33_), .O(z03));
  nand4  g22(.a(new_n45_), .b(new_n35_), .c(new_n26_), .d(new_n30_), .O(new_n49_));
  aoi21  g23(.a(new_n49_), .b(x00), .c(new_n43_), .O(z05));
  inv1   g24(.a(x13), .O(new_n51_));
  nand4  g25(.a(new_n33_), .b(new_n51_), .c(new_n27_), .d(x02), .O(new_n52_));
  inv1   g26(.a(x07), .O(new_n53_));
  inv1   g27(.a(x12), .O(new_n54_));
  nor2   g28(.a(x09), .b(x01), .O(new_n55_));
  nor2   g29(.a(x11), .b(new_n43_), .O(new_n56_));
  oai21  g30(.a(new_n56_), .b(new_n55_), .c(x00), .O(new_n57_));
  inv1   g31(.a(x08), .O(new_n58_));
  nand3  g32(.a(new_n58_), .b(new_n43_), .c(new_n32_), .O(new_n59_));
  aoi21  g33(.a(new_n59_), .b(new_n57_), .c(new_n51_), .O(new_n60_));
  nand4  g34(.a(new_n60_), .b(new_n54_), .c(new_n53_), .d(x05), .O(new_n61_));
  oai21  g35(.a(new_n61_), .b(x02), .c(new_n52_), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(x04), .c(new_n26_), .O(new_n63_));
  inv1   g37(.a(new_n63_), .O(z06));
  nand2  g38(.a(new_n49_), .b(new_n33_), .O(z07));
  nand4  g39(.a(x13), .b(new_n54_), .c(x05), .d(new_n30_), .O(new_n66_));
  nand3  g40(.a(new_n51_), .b(new_n27_), .c(x02), .O(new_n67_));
  nand2  g41(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g42(.a(new_n68_), .b(x04), .c(new_n26_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n33_), .O(z08));
  inv1   g44(.a(x06), .O(new_n71_));
  nand2  g45(.a(new_n33_), .b(x13), .O(new_n72_));
  nor2   g46(.a(new_n72_), .b(new_n71_), .O(z09));
  nand2  g47(.a(x05), .b(x02), .O(new_n74_));
  nand4  g48(.a(new_n74_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n75_));
