...
module FAU ( 
  ...
  nand4  g20(.a(new_n26_), .b(new_n29_), .c(new_n34_), .d(x00), .O(new_n46_));
  ...
  nor2   g31(.a(x10), .b(new_n34_), .O(new_n57_));
  ...
  nand4  g35(.a(new_n45_), .b(new_n30_), .c(x02), .d(new_n34_), .O(new_n61_));
  ...
  nand3  g39(.a(new_n31_), .b(new_n26_), .c(new_n29_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n34_), .c(x13), .O(z07));
  ...
  nor2   g50(.a(x13), .b(new_n34_), .O(z05));
endmodule
