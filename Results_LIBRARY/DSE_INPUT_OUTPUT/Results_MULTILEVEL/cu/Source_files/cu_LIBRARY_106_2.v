...
module FAU ( 
  ...
  nand4  g20(.a(new_n26_), .b(new_n27_), .c(new_n30_), .d(x00), .O(new_n46_));
  ...
  nand3  g26(.a(new_n51_), .b(new_n27_), .c(new_n50_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x05), .c(new_n30_), .O(z04));
  nand3  g28(.a(new_n51_), .b(new_n27_), .c(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x05), .c(new_n30_), .O(z05));
  ...
  nand4  g40(.a(new_n45_), .b(new_n28_), .c(x02), .d(new_n30_), .O(new_n66_));
  ...
  nand3  g45(.a(new_n45_), .b(x05), .c(new_n34_), .O(new_n71_));
  ...
  nor3   g53(.a(new_n39_), .b(new_n45_), .c(new_n78_), .O(z09));
  oai21  g54(.a(x05), .b(x01), .c(new_n73_), .O(new_n80_));
