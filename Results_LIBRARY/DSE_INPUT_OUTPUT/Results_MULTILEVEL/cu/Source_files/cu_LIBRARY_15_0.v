...
module FAU ( 
  ...
  nand4  g38(.a(x13), .b(new_n51_), .c(x05), .d(new_n30_), .O(new_n65_));
  nand3  g39(.a(new_n41_), .b(new_n27_), .c(x02), .O(new_n66_));
  nand2  g40(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand4  g41(.a(new_n67_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n68_));
  inv1   g42(.a(new_n68_), .O(z08));
  inv1   g43(.a(x06), .O(new_n70_));
  nor3   g44(.a(new_n32_), .b(new_n41_), .c(new_n70_), .O(z09));
  nand2  g45(.a(x05), .b(x02), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n73_));
