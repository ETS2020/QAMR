...
module FAU ( 
  ...
  nand3  g05(.a(new_n30_), .b(x04), .c(x01), .O(new_n31_));
  ...
  aoi21  g17(.a(new_n42_), .b(new_n32_), .c(x01), .O(z02));
  nand4  g18(.a(new_n39_), .b(new_n35_), .c(new_n26_), .d(x00), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n40_), .c(x05), .d(new_n32_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z03));
  inv1   g22(.a(x00), .O(new_n48_));
  nand4  g23(.a(new_n39_), .b(new_n35_), .c(x01), .d(new_n48_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n40_), .c(x05), .d(new_n32_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nor3   g27(.a(x02), .b(new_n26_), .c(new_n48_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n32_), .d(new_n39_), .O(new_n54_));
  ...
  nand3  g38(.a(new_n40_), .b(new_n29_), .c(x02), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(x02), .c(new_n64_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(x04), .c(new_n39_), .d(x01), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(z06));
  nand4  g42(.a(x05), .b(new_n32_), .c(new_n39_), .d(new_n35_), .O(new_n68_));
  ...
  aoi21  g47(.a(new_n72_), .b(x01), .c(new_n32_), .O(z08));
  nand2  g48(.a(x13), .b(x06), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n27_), .O(z09));
  nand2  g50(.a(x05), .b(x02), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n27_), .c(x06), .d(new_n39_), .O(new_n77_));
