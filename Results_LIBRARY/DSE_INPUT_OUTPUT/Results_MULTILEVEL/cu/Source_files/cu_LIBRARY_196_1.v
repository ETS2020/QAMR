...
module FAU ( 
  ...
  aoi21  g34(.a(x09), .b(new_n32_), .c(new_n41_), .O(new_n60_));
  ...
  aoi21  g39(.a(new_n64_), .b(new_n62_), .c(new_n50_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n66_));
  nand4  g41(.a(new_n33_), .b(new_n50_), .c(new_n27_), .d(x02), .O(new_n67_));
