...
module FAU ( 
  ...
  nand3  g18(.a(new_n30_), .b(x01), .c(new_n26_), .O(new_n45_));
  inv1   g19(.a(x13), .O(new_n46_));
  nand4  g20(.a(new_n46_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n47_));
  oai21  g21(.a(new_n47_), .b(new_n45_), .c(new_n34_), .O(z04));
  nor2   g22(.a(x03), .b(x02), .O(new_n49_));
  nand4  g23(.a(new_n49_), .b(new_n46_), .c(x05), .d(new_n28_), .O(new_n50_));
  aoi21  g24(.a(new_n50_), .b(x01), .c(new_n26_), .O(z05));
  nand3  g25(.a(new_n49_), .b(x05), .c(x04), .O(new_n52_));
  ...
  oai21  g30(.a(new_n56_), .b(new_n52_), .c(x01), .O(new_n57_));
  nand2  g31(.a(new_n57_), .b(x00), .O(new_n58_));
  inv1   g32(.a(x01), .O(new_n59_));
  inv1   g33(.a(x08), .O(new_n60_));
  nand2  g34(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  inv1   g35(.a(x10), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(x01), .c(new_n26_), .O(new_n63_));
  aoi21  g37(.a(new_n63_), .b(new_n61_), .c(new_n46_), .O(new_n64_));
  nand4  g38(.a(new_n64_), .b(new_n55_), .c(new_n53_), .d(x05), .O(new_n65_));
  nand3  g39(.a(new_n46_), .b(new_n36_), .c(x02), .O(new_n66_));
  oai21  g40(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  nand3  g41(.a(new_n67_), .b(x04), .c(new_n35_), .O(new_n68_));
  nand2  g42(.a(new_n68_), .b(new_n58_), .O(z06));
  nand2  g43(.a(new_n50_), .b(new_n34_), .O(z07));
  nand4  g44(.a(x13), .b(new_n55_), .c(x05), .d(new_n30_), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n66_), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n73_));
  ...
  nand4  g51(.a(new_n77_), .b(new_n34_), .c(x06), .d(new_n35_), .O(new_n78_));
