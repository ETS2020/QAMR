...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n32_), .O(new_n45_));
  ...
  aoi21  g25(.a(new_n50_), .b(x01), .c(new_n32_), .O(z05));
  nand3  g26(.a(new_n49_), .b(x05), .c(x04), .O(new_n52_));
  ...
  nand3  g37(.a(new_n62_), .b(x01), .c(new_n32_), .O(new_n63_));
