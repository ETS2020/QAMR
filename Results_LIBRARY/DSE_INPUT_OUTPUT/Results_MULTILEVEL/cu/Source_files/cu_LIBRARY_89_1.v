...
module FAU ( 
  ...
  nand4  g24(.a(new_n49_), .b(new_n35_), .c(new_n31_), .d(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n41_), .c(x01), .O(z03));
  nand3  g26(.a(new_n31_), .b(x01), .c(new_n42_), .O(new_n52_));
  nand4  g27(.a(new_n47_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n53_));
  ...
  oai21  g45(.a(new_n48_), .b(new_n70_), .c(new_n27_), .O(z07));
  nand4  g46(.a(x13), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n72_));
  nand3  g47(.a(new_n47_), .b(new_n36_), .c(x02), .O(new_n73_));
  ...
  nand4  g54(.a(new_n79_), .b(new_n27_), .c(x06), .d(new_n35_), .O(new_n80_));
