...
module FAU ( 
  ...
  inv1   g16(.a(new_n30_), .O(new_n42_));
  ...
  aoi21  g20(.a(new_n45_), .b(new_n40_), .c(x01), .O(z03));
  ...
  nand2  g26(.a(new_n48_), .b(x00), .O(new_n52_));
  ...
  nand3  g36(.a(new_n40_), .b(new_n35_), .c(x02), .O(new_n62_));
  ...
  oai21  g43(.a(new_n68_), .b(new_n47_), .c(new_n62_), .O(new_n69_));
