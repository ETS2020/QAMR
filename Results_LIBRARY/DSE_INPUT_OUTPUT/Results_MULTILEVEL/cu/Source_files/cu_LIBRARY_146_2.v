...
module FAU ( 
  ...
  nand3  g27(.a(new_n52_), .b(new_n45_), .c(new_n42_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n41_), .c(x13), .O(z04));
  nand3  g29(.a(new_n52_), .b(new_n45_), .c(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(new_n41_), .c(x13), .O(z05));
  ...
  nand4  g39(.a(new_n64_), .b(new_n57_), .c(new_n41_), .d(x05), .O(new_n65_));
  nand3  g40(.a(new_n34_), .b(new_n30_), .c(x02), .O(new_n66_));
  ...
  nand3  g44(.a(new_n31_), .b(new_n26_), .c(new_n29_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n41_), .c(x13), .O(z07));
  nand4  g46(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n72_));
  ...
  nand2  g51(.a(new_n76_), .b(new_n35_), .O(z09));
  nand2  g52(.a(x05), .b(x02), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n35_), .c(x06), .d(new_n26_), .O(new_n79_));
