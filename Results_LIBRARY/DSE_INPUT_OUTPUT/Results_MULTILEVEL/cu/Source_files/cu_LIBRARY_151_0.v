...
module FAU ( 
  ...
  nand4  g25(.a(new_n50_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z05));
  nand4  g27(.a(new_n33_), .b(new_n40_), .c(new_n27_), .d(x02), .O(new_n53_));
  ...
  nand3  g34(.a(new_n59_), .b(x01), .c(new_n49_), .O(new_n60_));
  ...
  nand2  g40(.a(new_n47_), .b(new_n33_), .O(z07));
  nand4  g41(.a(x13), .b(new_n55_), .c(x05), .d(new_n30_), .O(new_n67_));
