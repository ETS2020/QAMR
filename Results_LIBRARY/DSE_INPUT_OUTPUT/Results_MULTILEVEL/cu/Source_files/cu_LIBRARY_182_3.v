...
module FAU ( 
  ...
  nand2  g06(.a(x12), .b(x07), .O(new_n32_));
  ...
  nand4  g14(.a(new_n32_), .b(new_n39_), .c(x05), .d(new_n34_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(new_n41_));
  nand3  g16(.a(new_n41_), .b(new_n26_), .c(new_n30_), .O(new_n42_));
  nor3   g17(.a(new_n42_), .b(x01), .c(x00), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand3  g19(.a(new_n30_), .b(new_n44_), .c(x00), .O(new_n45_));
  nand4  g20(.a(new_n39_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n46_));
  ...
  nor2   g27(.a(x11), .b(new_n44_), .O(new_n53_));
  ...
  aoi21  g33(.a(new_n58_), .b(new_n54_), .c(new_n39_), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(new_n51_), .c(x05), .d(new_n30_), .O(new_n60_));
  nand3  g35(.a(new_n39_), .b(new_n27_), .c(x02), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n60_), .c(x07), .O(new_n62_));
  nand4  g37(.a(new_n39_), .b(new_n51_), .c(new_n27_), .d(x02), .O(new_n63_));
  ...
  nand3  g42(.a(new_n39_), .b(x05), .c(new_n34_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n67_), .c(new_n32_), .O(z07));
  nand4  g44(.a(new_n32_), .b(new_n39_), .c(new_n27_), .d(x02), .O(new_n70_));
  nand4  g45(.a(x13), .b(new_n51_), .c(x05), .d(new_n30_), .O(new_n71_));
  ...
  nand2  g50(.a(new_n75_), .b(new_n32_), .O(z09));
