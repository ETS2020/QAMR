...
module FAU ( 
  ...
  nand4  g19(.a(new_n27_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n44_), .c(new_n36_), .O(z02));
  nand3  g21(.a(new_n31_), .b(new_n43_), .c(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n36_), .O(z03));
  nand3  g23(.a(new_n31_), .b(x01), .c(new_n42_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n45_), .c(new_n36_), .O(z04));
  nand3  g25(.a(new_n31_), .b(x01), .c(x00), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n45_), .c(new_n36_), .O(z05));
  ...
  nand4  g36(.a(new_n61_), .b(x13), .c(new_n54_), .d(new_n26_), .O(new_n62_));
  inv1   g37(.a(new_n62_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n53_), .c(x05), .d(new_n31_), .O(new_n64_));
  nand3  g39(.a(new_n27_), .b(new_n37_), .c(x02), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n35_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z06));
  nand4  g43(.a(x05), .b(new_n29_), .c(new_n35_), .d(new_n31_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x13), .O(z07));
  nand4  g45(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n71_));
