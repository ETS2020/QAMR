...
module FAU ( 
  ...
  nand4  g28(.a(new_n34_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n43_), .c(new_n44_), .O(z05));
  ...
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n32_), .O(z07));
