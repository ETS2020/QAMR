...
module FAU ( 
  ...
  nand4  g24(.a(new_n42_), .b(new_n34_), .c(new_n26_), .d(new_n30_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n39_), .c(new_n40_), .O(z04));
  nand4  g26(.a(new_n32_), .b(new_n45_), .c(new_n27_), .d(x02), .O(new_n53_));
  inv1   g27(.a(x07), .O(new_n54_));
  inv1   g28(.a(x12), .O(new_n55_));
  nor2   g29(.a(x08), .b(x01), .O(new_n56_));
  nor2   g30(.a(x10), .b(new_n40_), .O(new_n57_));
  oai21  g31(.a(new_n57_), .b(new_n56_), .c(new_n39_), .O(new_n58_));
  inv1   g32(.a(x09), .O(new_n59_));
  nand3  g33(.a(new_n59_), .b(new_n40_), .c(x00), .O(new_n60_));
  aoi21  g34(.a(new_n60_), .b(new_n58_), .c(new_n45_), .O(new_n61_));
  ...
  nand2  g39(.a(new_n50_), .b(new_n32_), .O(z07));
  nand4  g40(.a(x13), .b(new_n55_), .c(x05), .d(new_n30_), .O(new_n67_));
  ...
  nand2  g44(.a(new_n70_), .b(new_n32_), .O(z08));
  ...
  nand2  g49(.a(new_n75_), .b(new_n32_), .O(z10));
  zero   g50(.O(z05));
endmodule
