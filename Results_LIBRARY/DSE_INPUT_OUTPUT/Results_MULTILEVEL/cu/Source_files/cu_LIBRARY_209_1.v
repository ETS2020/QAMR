...
module FAU ( 
  ...
  oai21  g31(.a(new_n56_), .b(x01), .c(new_n41_), .O(new_n57_));
  ...
  nand4  g36(.a(new_n61_), .b(new_n55_), .c(new_n26_), .d(x05), .O(new_n62_));
  nand3  g37(.a(new_n44_), .b(new_n36_), .c(x02), .O(new_n63_));
  ...
  nor3   g46(.a(new_n28_), .b(new_n44_), .c(new_n71_), .O(z09));
