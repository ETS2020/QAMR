...
module FAU ( 
  ...
  aoi21  g28(.a(new_n53_), .b(x09), .c(new_n44_), .O(z04));
  nand4  g29(.a(new_n35_), .b(new_n31_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x09), .c(x05), .d(new_n29_), .O(new_n57_));
  ...
  nand3  g37(.a(new_n62_), .b(x09), .c(x01), .O(new_n63_));
  ...
  nand3  g44(.a(new_n69_), .b(x09), .c(x01), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n68_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n66_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n65_), .c(new_n46_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n74_));
  nand4  g49(.a(new_n27_), .b(new_n46_), .c(new_n36_), .d(x02), .O(new_n75_));
  ...
  oai21  g53(.a(new_n51_), .b(new_n49_), .c(new_n27_), .O(z07));
  nand4  g54(.a(x13), .b(new_n60_), .c(x05), .d(new_n31_), .O(new_n80_));
  nand3  g55(.a(new_n46_), .b(new_n36_), .c(x02), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x04), .c(new_n35_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n27_), .O(z08));
  inv1   g59(.a(x06), .O(new_n85_));
  nor3   g60(.a(new_n28_), .b(new_n46_), .c(new_n85_), .O(z09));
  nand2  g61(.a(x05), .b(x02), .O(new_n87_));
  nand4  g62(.a(new_n87_), .b(new_n27_), .c(x06), .d(new_n35_), .O(new_n88_));
