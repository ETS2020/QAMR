...
module FAU ( 
  ...
  nand2  g05(.a(x08), .b(x05), .O(new_n31_));
  ...
  nand2  g10(.a(new_n35_), .b(x08), .O(new_n36_));
  nand2  g11(.a(new_n36_), .b(new_n30_), .O(new_n37_));
  nand2  g12(.a(new_n26_), .b(x02), .O(new_n38_));
  oai21  g13(.a(new_n38_), .b(new_n28_), .c(new_n37_), .O(z01));
  inv1   g14(.a(x00), .O(new_n40_));
  inv1   g15(.a(x01), .O(new_n41_));
  nand4  g16(.a(new_n26_), .b(new_n30_), .c(new_n41_), .d(new_n40_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(x08), .c(x05), .d(new_n34_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  nor2   g20(.a(x03), .b(x01), .O(new_n46_));
  nor2   g21(.a(x13), .b(new_n27_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n46_), .c(new_n34_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x08), .c(x02), .O(z03));
  nand4  g24(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n40_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x08), .c(x05), .d(new_n34_), .O(new_n52_));
  ...
  oai21  g39(.a(new_n62_), .b(new_n40_), .c(new_n64_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(x13), .c(new_n59_), .d(x08), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n68_));
  ...
  nand3  g48(.a(new_n47_), .b(new_n34_), .c(new_n26_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(x08), .c(x02), .O(z07));
  nand2  g50(.a(x04), .b(new_n26_), .O(new_n76_));
  nand3  g51(.a(x13), .b(new_n59_), .c(x05), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(new_n76_), .c(x08), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n30_), .O(new_n79_));
  nand2  g54(.a(new_n69_), .b(x04), .O(new_n80_));
  oai21  g55(.a(new_n80_), .b(new_n38_), .c(new_n79_), .O(z08));
  nand2  g56(.a(x13), .b(x06), .O(new_n82_));
  oai21  g57(.a(x08), .b(x02), .c(new_n82_), .O(z09));
  nand2  g58(.a(x08), .b(new_n30_), .O(new_n84_));
  oai21  g59(.a(x05), .b(new_n30_), .c(new_n84_), .O(new_n85_));
