...
module FAU ( 
  ...
  nand4  g23(.a(new_n49_), .b(x05), .c(new_n27_), .d(new_n35_), .O(new_n50_));
  ...
  nand2  g43(.a(new_n69_), .b(new_n36_), .O(z06));
  nand3  g44(.a(new_n31_), .b(new_n35_), .c(new_n29_), .O(new_n71_));
  aoi21  g45(.a(new_n71_), .b(x01), .c(x13), .O(z07));
  inv1   g46(.a(x12), .O(new_n73_));
  nand4  g47(.a(x13), .b(new_n73_), .c(x05), .d(new_n29_), .O(new_n74_));
  nand2  g48(.a(new_n74_), .b(new_n67_), .O(new_n75_));
  nand3  g49(.a(new_n75_), .b(x04), .c(new_n35_), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n36_), .O(z08));
