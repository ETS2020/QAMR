...
module FAU ( 
  ...
  nand4  g25(.a(new_n44_), .b(new_n29_), .c(x01), .d(new_n41_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(x11), .c(x13), .O(z04));
  nand4  g27(.a(new_n35_), .b(new_n29_), .c(x01), .d(x00), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x11), .c(x05), .d(new_n27_), .O(new_n55_));
  ...
  nand4  g52(.a(new_n77_), .b(x11), .c(x05), .d(new_n27_), .O(new_n78_));
  nor2   g53(.a(new_n78_), .b(x13), .O(z07));
  inv1   g54(.a(x12), .O(new_n80_));
  nand4  g55(.a(x13), .b(new_n80_), .c(x05), .d(new_n29_), .O(new_n81_));
  nand4  g56(.a(new_n72_), .b(x11), .c(new_n30_), .d(x02), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(x04), .c(new_n35_), .O(new_n84_));
  ...
  nand2  g63(.a(new_n88_), .b(new_n36_), .O(z10));
endmodule
