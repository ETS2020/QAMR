...
module FAU ( 
  ...
  nand3  g19(.a(new_n29_), .b(x01), .c(new_n40_), .O(new_n46_));
  ...
  nand2  g31(.a(new_n57_), .b(new_n32_), .O(new_n58_));
  inv1   g32(.a(x10), .O(new_n59_));
  nand3  g33(.a(new_n59_), .b(x01), .c(new_n40_), .O(new_n60_));
  aoi21  g34(.a(new_n60_), .b(new_n58_), .c(new_n41_), .O(new_n61_));
  nand4  g35(.a(new_n61_), .b(new_n53_), .c(new_n51_), .d(x05), .O(new_n62_));
  nand3  g36(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n63_));
  ...
  nand4  g41(.a(x13), .b(new_n53_), .c(x05), .d(new_n29_), .O(new_n68_));
  nand2  g42(.a(new_n68_), .b(new_n63_), .O(new_n69_));
  nand4  g43(.a(new_n69_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n70_));
  inv1   g44(.a(new_n70_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n33_), .O(z09));
