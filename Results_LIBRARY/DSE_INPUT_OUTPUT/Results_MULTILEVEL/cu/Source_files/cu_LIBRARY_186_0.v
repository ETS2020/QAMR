...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(new_n41_), .c(new_n35_), .d(new_n40_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(x09), .c(x01), .O(z02));
  nand4  g19(.a(new_n42_), .b(new_n41_), .c(new_n35_), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x09), .c(x01), .O(z03));
  nand3  g21(.a(new_n30_), .b(x01), .c(new_n40_), .O(new_n47_));
  nand3  g22(.a(new_n42_), .b(new_n35_), .c(new_n26_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n47_), .c(new_n33_), .O(z04));
  inv1   g24(.a(x01), .O(new_n50_));
  nor3   g25(.a(x02), .b(new_n50_), .c(new_n40_), .O(new_n51_));
  ...
  nor2   g32(.a(x10), .b(new_n50_), .O(new_n58_));
  ...
  nor2   g42(.a(new_n32_), .b(x13), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n69_));
