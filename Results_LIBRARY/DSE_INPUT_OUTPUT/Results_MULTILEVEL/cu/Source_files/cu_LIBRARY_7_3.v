...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(new_n48_), .c(x05), .d(new_n28_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand3  g28(.a(new_n45_), .b(x05), .c(new_n28_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n34_), .c(new_n30_), .d(x00), .O(new_n56_));
  ...
  oai21  g49(.a(new_n54_), .b(new_n74_), .c(new_n26_), .O(z07));
