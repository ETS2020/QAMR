...
module FAU ( 
  ...
  nand3  g47(.a(new_n32_), .b(new_n43_), .c(new_n30_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n26_), .c(x13), .O(z07));
  nand4  g49(.a(x13), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n75_));
  nand4  g50(.a(new_n60_), .b(new_n26_), .c(new_n31_), .d(x02), .O(new_n76_));
  ...
  nand4  g55(.a(new_n80_), .b(x13), .c(x06), .d(new_n43_), .O(new_n81_));
