...
module FAU ( 
  ...
  nand3  g03(.a(new_n28_), .b(new_n26_), .c(x02), .O(new_n29_));
  inv1   g04(.a(x02), .O(new_n30_));
  inv1   g05(.a(x04), .O(new_n31_));
  nand3  g06(.a(x05), .b(new_n31_), .c(new_n26_), .O(new_n32_));
  nand2  g07(.a(new_n32_), .b(new_n30_), .O(new_n33_));
  nand2  g08(.a(new_n33_), .b(new_n29_), .O(z00));
  nand3  g09(.a(x05), .b(new_n31_), .c(new_n30_), .O(new_n35_));
  nand3  g10(.a(new_n27_), .b(x04), .c(x02), .O(new_n36_));
  aoi21  g11(.a(new_n36_), .b(new_n35_), .c(x03), .O(z01));
  nand2  g12(.a(x03), .b(x02), .O(new_n38_));
  ...
  nand4  g21(.a(new_n46_), .b(new_n42_), .c(x05), .d(new_n31_), .O(new_n47_));
  ...
  aoi21  g33(.a(new_n58_), .b(new_n56_), .c(new_n39_), .O(new_n59_));
  ...
  nand4  g41(.a(new_n66_), .b(new_n54_), .c(x05), .d(new_n26_), .O(new_n67_));
