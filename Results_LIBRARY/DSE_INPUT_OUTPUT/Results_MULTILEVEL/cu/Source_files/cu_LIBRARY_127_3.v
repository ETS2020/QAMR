...
module FAU ( 
  ...
  oai21  g07(.a(new_n26_), .b(x00), .c(new_n32_), .O(z00));
  ...
  nand2  g12(.a(x03), .b(x00), .O(new_n38_));
  ...
  nand4  g25(.a(new_n43_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(new_n38_), .O(z04));
  ...
  nand3  g45(.a(new_n43_), .b(x05), .c(new_n30_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n38_), .O(z07));
