...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n68_, new_n69_, new_n70_, new_n72_, new_n74_, new_n75_;
  ...
  nand4  g32(.a(new_n57_), .b(x13), .c(new_n51_), .d(new_n50_), .O(new_n58_));
  inv1   g33(.a(new_n58_), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(x05), .c(new_n29_), .d(new_n30_), .O(new_n60_));
  ...
  nand4  g39(.a(new_n45_), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n30_), .c(new_n35_), .O(z07));
  nand2  g41(.a(new_n29_), .b(new_n30_), .O(new_n67_));
  nand3  g42(.a(x13), .b(new_n51_), .c(x05), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n67_), .c(new_n61_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x04), .c(new_n26_), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(z08));
  nand3  g46(.a(new_n40_), .b(x13), .c(x06), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z09));
  nand2  g48(.a(new_n67_), .b(x05), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x06), .c(new_n26_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z10));
  nor2   g51(.a(new_n35_), .b(new_n30_), .O(z05));
endmodule
