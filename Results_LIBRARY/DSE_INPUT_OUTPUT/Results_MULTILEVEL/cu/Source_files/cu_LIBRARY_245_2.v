...
module FAU ( 
  ...
  nand3  g17(.a(new_n42_), .b(new_n32_), .c(new_n41_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n26_), .c(x13), .O(z02));
  ...
  nand4  g29(.a(new_n41_), .b(new_n30_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n26_), .c(x05), .d(new_n28_), .O(new_n57_));
  ...
  aoi21  g39(.a(x11), .b(x01), .c(x09), .O(new_n65_));
  nor2   g40(.a(x11), .b(new_n45_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(x00), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n64_), .c(new_n61_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n61_), .b(new_n26_), .c(new_n31_), .d(x02), .O(new_n70_));
  oai21  g45(.a(new_n69_), .b(x02), .c(new_n70_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n41_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z06));
  nor2   g48(.a(x03), .b(x02), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n26_), .c(x05), .d(new_n28_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x13), .O(z07));
  nand4  g51(.a(x13), .b(new_n60_), .c(x05), .d(new_n30_), .O(new_n77_));
  nand3  g52(.a(new_n61_), .b(new_n31_), .c(x02), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x04), .c(new_n41_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n36_), .O(z08));
  and2   g56(.a(x13), .b(x06), .O(z09));
  nand2  g57(.a(x05), .b(x02), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(x06), .c(new_n41_), .O(new_n84_));
