...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n30_), .c(new_n42_), .d(new_n41_), .O(new_n44_));
  ...
  nor2   g30(.a(x02), .b(new_n42_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n32_), .c(new_n43_), .d(x00), .O(new_n57_));
  ...
  nand4  g42(.a(new_n67_), .b(new_n59_), .c(new_n26_), .d(x05), .O(new_n68_));
  nand3  g43(.a(new_n60_), .b(new_n31_), .c(x02), .O(new_n69_));
  ...
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n43_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n36_), .O(z08));
  nand2  g54(.a(x13), .b(x06), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n36_), .O(z09));
