...
module FAU ( 
  ...
  nand4  g16(.a(new_n31_), .b(new_n26_), .c(new_n29_), .d(new_n41_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x01), .c(x13), .O(z04));
  nand4  g18(.a(new_n31_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n44_));
  ...
  nand3  g25(.a(x13), .b(new_n50_), .c(x01), .O(new_n51_));
  ...
  nand3  g31(.a(x13), .b(new_n56_), .c(x01), .O(new_n57_));
  ...
  nand4  g35(.a(new_n60_), .b(new_n46_), .c(x05), .d(new_n29_), .O(new_n61_));
  ...
  nand4  g41(.a(new_n27_), .b(new_n26_), .c(new_n29_), .d(x01), .O(new_n67_));
  nor3   g42(.a(new_n67_), .b(x13), .c(new_n30_), .O(z07));
  inv1   g43(.a(x12), .O(new_n69_));
  nand4  g44(.a(x13), .b(new_n69_), .c(x05), .d(new_n29_), .O(new_n70_));
  nand4  g45(.a(new_n62_), .b(new_n30_), .c(x02), .d(x01), .O(new_n71_));
