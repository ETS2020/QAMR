...
module FAU ( 
  ...
  aoi21  g20(.a(new_n45_), .b(x06), .c(x13), .O(z02));
  ...
  nand3  g46(.a(new_n31_), .b(new_n42_), .c(new_n29_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(x06), .c(x13), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n74_));
  nand4  g49(.a(new_n59_), .b(x06), .c(new_n30_), .d(x02), .O(new_n75_));
