...
module FAU ( 
  ...
  nand4  g20(.a(new_n43_), .b(new_n34_), .c(new_n41_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n30_), .c(x05), .d(new_n35_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  nand3  g24(.a(new_n34_), .b(x01), .c(new_n40_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n44_), .c(new_n27_), .O(z04));
  ...
  nand2  g38(.a(new_n37_), .b(x02), .O(new_n64_));
