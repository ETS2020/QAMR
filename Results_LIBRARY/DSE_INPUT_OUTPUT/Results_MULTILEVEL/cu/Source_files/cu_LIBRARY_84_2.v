...
module FAU ( 
  ...
  nand4  g19(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n26_), .O(new_n46_));
  inv1   g20(.a(new_n46_), .O(new_n47_));
  nand4  g21(.a(new_n47_), .b(new_n45_), .c(x05), .d(new_n28_), .O(new_n48_));
  inv1   g22(.a(new_n48_), .O(z04));
  nor2   g23(.a(x03), .b(x02), .O(new_n50_));
  nand4  g24(.a(new_n50_), .b(new_n45_), .c(x05), .d(new_n28_), .O(new_n51_));
  aoi21  g25(.a(new_n51_), .b(x01), .c(new_n26_), .O(z05));
  nand3  g26(.a(new_n50_), .b(x05), .c(x04), .O(new_n53_));
