...
module FAU ( 
  ...
  nand4  g10(.a(new_n35_), .b(new_n31_), .c(new_n28_), .d(new_n26_), .O(z00));
  nand3  g11(.a(x05), .b(new_n27_), .c(new_n29_), .O(new_n37_));
  ...
  nand3  g16(.a(new_n29_), .b(new_n33_), .c(new_n32_), .O(new_n42_));
  ...
  aoi21  g22(.a(new_n47_), .b(new_n33_), .c(new_n32_), .O(z03));
  aoi21  g23(.a(new_n47_), .b(new_n32_), .c(new_n33_), .O(z04));
  nand3  g24(.a(new_n46_), .b(x05), .c(x04), .O(new_n50_));
  ...
  oai21  g29(.a(new_n54_), .b(new_n50_), .c(new_n33_), .O(new_n55_));
  nand2  g30(.a(new_n55_), .b(x00), .O(new_n56_));
  inv1   g31(.a(x08), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n33_), .c(new_n32_), .O(new_n58_));
  inv1   g33(.a(x10), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(x01), .O(new_n60_));
  aoi21  g35(.a(new_n60_), .b(new_n58_), .c(new_n43_), .O(new_n61_));
  ...
  nor2   g41(.a(z05), .b(x13), .O(new_n67_));
  ...
  nand4  g46(.a(new_n71_), .b(new_n35_), .c(x04), .d(new_n26_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z08));
  nand3  g48(.a(new_n35_), .b(x13), .c(x06), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z09));
  nand2  g50(.a(x05), .b(x02), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n35_), .c(x06), .d(new_n26_), .O(new_n77_));
