...
module FAU ( 
  ...
  nand4  g17(.a(new_n35_), .b(new_n26_), .c(new_n29_), .d(new_n42_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n41_), .c(x01), .O(z02));
  nand4  g19(.a(new_n35_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n41_), .c(x01), .O(z03));
  nand3  g21(.a(new_n29_), .b(x01), .c(new_n42_), .O(new_n47_));
  nand4  g22(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n47_), .c(new_n33_), .O(z04));
  nand3  g24(.a(new_n29_), .b(x01), .c(x00), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n33_), .O(z05));
  ...
  nand4  g33(.a(new_n58_), .b(x13), .c(new_n53_), .d(new_n52_), .O(new_n59_));
  inv1   g34(.a(new_n59_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(x05), .c(new_n29_), .d(x01), .O(new_n61_));
  nand3  g36(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n62_));
  ...
  nand3  g46(.a(x13), .b(x06), .c(x01), .O(new_n72_));
