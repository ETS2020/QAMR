...
module FAU ( 
  ...
  aoi21  g42(.a(new_n67_), .b(new_n62_), .c(new_n47_), .O(new_n68_));
  ...
  nand2  g48(.a(new_n35_), .b(new_n31_), .O(new_n74_));
  oai21  g49(.a(new_n48_), .b(new_n74_), .c(new_n27_), .O(z07));
  ...
  nor3   g56(.a(new_n28_), .b(new_n47_), .c(new_n81_), .O(z09));
