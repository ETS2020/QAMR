...
module FAU ( 
  ...
  nor2   g08(.a(x02), .b(new_n33_), .O(new_n34_));
  ...
  nor2   g13(.a(new_n36_), .b(x01), .O(z02));
  inv1   g14(.a(x13), .O(new_n41_));
  nor2   g15(.a(x02), .b(x00), .O(new_n42_));
  nand4  g16(.a(new_n42_), .b(new_n41_), .c(new_n27_), .d(new_n26_), .O(new_n43_));
  aoi21  g17(.a(new_n43_), .b(x01), .c(new_n36_), .O(z04));
  inv1   g18(.a(x00), .O(new_n45_));
  nor3   g19(.a(x02), .b(new_n33_), .c(new_n45_), .O(new_n46_));
  nand4  g20(.a(new_n46_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(x13), .O(z05));
  inv1   g22(.a(z02), .O(new_n49_));
  inv1   g23(.a(x07), .O(new_n50_));
  inv1   g24(.a(x12), .O(new_n51_));
  inv1   g25(.a(x10), .O(new_n52_));
  nand2  g26(.a(new_n52_), .b(new_n45_), .O(new_n53_));
  ...
  nand3  g31(.a(new_n41_), .b(new_n36_), .c(x02), .O(new_n58_));
  ...
  nand3  g35(.a(new_n34_), .b(new_n27_), .c(new_n26_), .O(new_n62_));
  nor3   g36(.a(new_n62_), .b(x13), .c(new_n36_), .O(z07));
  inv1   g37(.a(new_n34_), .O(new_n64_));
  nand3  g38(.a(x13), .b(new_n51_), .c(x05), .O(new_n65_));
