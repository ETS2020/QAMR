...
module FAU ( 
  ...
  nor2   g18(.a(x03), .b(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n42_), .c(x05), .d(new_n27_), .O(new_n45_));
  ...
  aoi21  g28(.a(new_n54_), .b(new_n52_), .c(new_n42_), .O(new_n55_));
  ...
  nor3   g43(.a(z05), .b(new_n42_), .c(new_n69_), .O(z09));
