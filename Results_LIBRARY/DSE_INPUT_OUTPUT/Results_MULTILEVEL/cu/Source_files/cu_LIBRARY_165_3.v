...
module FAU ( 
  ...
  nand4  g20(.a(new_n36_), .b(new_n31_), .c(new_n45_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n27_), .c(x05), .d(new_n29_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand4  g25(.a(new_n36_), .b(new_n31_), .c(x01), .d(new_n50_), .O(new_n51_));
  ...
  nand4  g30(.a(new_n27_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(new_n35_), .O(z05));
  ...
  nand4  g45(.a(x05), .b(new_n29_), .c(new_n36_), .d(new_n31_), .O(new_n71_));
  ...
  aoi21  g52(.a(new_n26_), .b(new_n77_), .c(new_n27_), .O(z09));
