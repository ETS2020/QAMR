...
module FAU ( 
  ...
  nand4  g39(.a(new_n41_), .b(new_n30_), .c(x04), .d(new_n26_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(z06));
  inv1   g41(.a(new_n38_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(x05), .c(x02), .O(z07));
  ...
  aoi21  g51(.a(x06), .b(new_n26_), .c(new_n30_), .O(new_n77_));
  nand3  g52(.a(x06), .b(new_n30_), .c(new_n26_), .O(new_n78_));
