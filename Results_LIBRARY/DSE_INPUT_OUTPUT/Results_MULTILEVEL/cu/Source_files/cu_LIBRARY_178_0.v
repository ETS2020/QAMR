...
module FAU ( 
  ...
  nand4  g16(.a(new_n26_), .b(new_n30_), .c(new_n41_), .d(x00), .O(new_n42_));
  ...
  nand4  g21(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n46_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n40_), .c(x05), .d(new_n35_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z04));
  nor3   g25(.a(x02), .b(new_n41_), .c(new_n46_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z05));
  nand4  g28(.a(x05), .b(x04), .c(new_n26_), .d(new_n30_), .O(new_n54_));
  ...
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n74_));
