...
module FAU ( 
  ...
  nand4  g27(.a(new_n26_), .b(new_n48_), .c(new_n35_), .d(x02), .O(new_n53_));
  ...
  aoi21  g35(.a(new_n60_), .b(new_n58_), .c(new_n48_), .O(new_n61_));
  ...
  nand3  g42(.a(new_n48_), .b(new_n35_), .c(x02), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n26_), .c(x04), .d(new_n34_), .O(new_n70_));
