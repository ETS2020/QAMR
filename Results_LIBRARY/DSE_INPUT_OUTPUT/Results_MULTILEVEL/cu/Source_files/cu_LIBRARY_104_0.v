...
module FAU ( 
  ...
  aoi21  g32(.a(new_n57_), .b(x10), .c(x13), .O(z05));
  ...
  nand3  g47(.a(new_n36_), .b(new_n26_), .c(new_n29_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(x10), .c(x13), .O(z07));
  nand4  g49(.a(x13), .b(new_n60_), .c(x05), .d(new_n29_), .O(new_n75_));
