...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(new_n26_), .c(new_n29_), .d(new_n49_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x11), .c(new_n44_), .O(z04));
  nand4  g28(.a(new_n51_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x11), .c(new_n44_), .O(z05));
  ...
  nand3  g35(.a(x11), .b(new_n60_), .c(x01), .O(new_n61_));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(new_n43_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n67_));
  inv1   g42(.a(new_n33_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x13), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(new_n30_), .c(x02), .O(new_n70_));
  oai21  g45(.a(new_n67_), .b(x02), .c(new_n70_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n26_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z06));
  nand4  g48(.a(new_n69_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n76_));
  nand3  g51(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n77_));
  ...
  nor3   g56(.a(new_n68_), .b(new_n43_), .c(new_n81_), .O(z09));
