...
module FAU ( 
  ...
  nand4  g28(.a(new_n26_), .b(new_n43_), .c(new_n35_), .d(x02), .O(new_n55_));
  ...
  nand2  g41(.a(new_n34_), .b(new_n30_), .O(new_n68_));
  nand3  g42(.a(new_n43_), .b(x05), .c(new_n28_), .O(new_n69_));
  oai21  g43(.a(new_n69_), .b(new_n68_), .c(new_n26_), .O(z07));
