...
module FAU ( 
  ...
  nand4  g18(.a(new_n39_), .b(new_n29_), .c(new_n28_), .d(x00), .O(new_n44_));
  ...
  aoi21  g29(.a(new_n56_), .b(new_n54_), .c(new_n43_), .O(new_n57_));
  nand4  g30(.a(new_n57_), .b(new_n51_), .c(new_n50_), .d(x05), .O(new_n58_));
  nand3  g31(.a(new_n43_), .b(new_n33_), .c(x02), .O(new_n59_));
  oai21  g32(.a(new_n58_), .b(x02), .c(new_n59_), .O(new_n60_));
  nand3  g33(.a(new_n60_), .b(x04), .c(new_n39_), .O(new_n61_));
  nand2  g34(.a(new_n61_), .b(new_n26_), .O(z06));
  nand4  g35(.a(new_n43_), .b(new_n30_), .c(new_n39_), .d(new_n29_), .O(new_n63_));
  aoi21  g36(.a(new_n63_), .b(new_n28_), .c(new_n33_), .O(z07));
  nand2  g37(.a(new_n29_), .b(new_n28_), .O(new_n65_));
  nand3  g38(.a(x13), .b(new_n51_), .c(x05), .O(new_n66_));
  oai21  g39(.a(new_n66_), .b(new_n65_), .c(new_n59_), .O(new_n67_));
  nand3  g40(.a(new_n67_), .b(x04), .c(new_n39_), .O(new_n68_));
  inv1   g41(.a(new_n68_), .O(z08));
  nand3  g42(.a(new_n26_), .b(x13), .c(x06), .O(new_n70_));
  inv1   g43(.a(new_n70_), .O(z09));
  nand2  g44(.a(new_n65_), .b(x05), .O(new_n72_));
  nand3  g45(.a(new_n72_), .b(x06), .c(new_n39_), .O(new_n73_));
