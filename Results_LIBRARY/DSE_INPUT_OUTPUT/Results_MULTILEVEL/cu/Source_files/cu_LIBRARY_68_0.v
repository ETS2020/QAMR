...
module FAU ( 
  ...
  nand3  g23(.a(new_n41_), .b(x05), .c(x04), .O(new_n49_));
  inv1   g24(.a(x07), .O(new_n50_));
  inv1   g25(.a(x10), .O(new_n51_));
  inv1   g26(.a(x12), .O(new_n52_));
  nand4  g27(.a(x13), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n49_), .c(x01), .O(new_n54_));
  nand2  g29(.a(new_n54_), .b(new_n48_), .O(new_n55_));
  ...
  nand4  g36(.a(new_n61_), .b(new_n52_), .c(new_n50_), .d(x05), .O(new_n62_));
  ...
  nand2  g40(.a(new_n65_), .b(new_n55_), .O(z06));
  nor2   g41(.a(z02), .b(x13), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n52_), .c(x05), .d(new_n29_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n63_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n72_));
