...
module FAU ( 
  ...
  nand4  g16(.a(new_n33_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n26_), .c(new_n29_), .d(new_n40_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x00), .O(z02));
  nand3  g20(.a(new_n29_), .b(new_n40_), .c(x00), .O(new_n46_));
  nand4  g21(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n47_));
  ...
  nand2  g29(.a(new_n32_), .b(new_n40_), .O(new_n55_));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x11), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n56_), .c(x01), .O(new_n58_));
  ...
  nand3  g40(.a(new_n65_), .b(new_n56_), .c(new_n49_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n60_), .c(new_n41_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n54_), .c(x05), .d(new_n29_), .O(new_n68_));
  ...
  nand3  g48(.a(new_n41_), .b(x05), .c(new_n27_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(new_n73_), .c(new_n33_), .O(z07));
  nand4  g50(.a(x13), .b(new_n54_), .c(x05), .d(new_n29_), .O(new_n76_));
