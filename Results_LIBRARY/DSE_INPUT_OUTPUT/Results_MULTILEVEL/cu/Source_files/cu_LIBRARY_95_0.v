...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x06), .c(x05), .d(new_n36_), .O(new_n44_));
  ...
  nand3  g42(.a(new_n46_), .b(new_n27_), .c(x02), .O(new_n68_));
  ...
  oai21  g52(.a(new_n46_), .b(new_n33_), .c(new_n34_), .O(z09));
