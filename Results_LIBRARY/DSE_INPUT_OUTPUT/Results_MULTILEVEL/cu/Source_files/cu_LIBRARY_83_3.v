...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(new_n44_), .c(x05), .d(new_n34_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nor2   g28(.a(x13), .b(new_n28_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n26_), .c(new_n27_), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(new_n34_), .c(new_n30_), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  inv1   g33(.a(x08), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(new_n49_), .O(new_n60_));
  ...
  nand4  g41(.a(new_n66_), .b(x04), .c(new_n26_), .d(new_n30_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z06));
  nand2  g43(.a(new_n26_), .b(new_n27_), .O(new_n69_));
  nand2  g44(.a(new_n54_), .b(new_n34_), .O(new_n70_));
  ...
  nand2  g48(.a(new_n73_), .b(new_n26_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(new_n30_), .c(new_n34_), .O(z08));
