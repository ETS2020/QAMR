...
module FAU ( 
  ...
  nand2  g04(.a(x12), .b(x05), .O(new_n30_));
  ...
  aoi21  g19(.a(new_n44_), .b(x12), .c(new_n34_), .O(z02));
  nand4  g20(.a(new_n26_), .b(new_n29_), .c(new_n42_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x12), .c(x05), .d(new_n27_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(x13), .O(z03));
  nor2   g24(.a(x02), .b(new_n42_), .O(new_n50_));
  nand3  g25(.a(new_n50_), .b(new_n43_), .c(new_n41_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(x12), .c(new_n34_), .O(z04));
  nand3  g27(.a(new_n50_), .b(new_n43_), .c(x00), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x12), .c(new_n34_), .O(z05));
  nand2  g29(.a(new_n26_), .b(x02), .O(new_n55_));
  inv1   g30(.a(x13), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n34_), .c(x04), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n55_), .c(new_n39_), .O(z06));
  nor2   g33(.a(x03), .b(x02), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(x12), .c(x05), .d(new_n27_), .O(new_n60_));
  nor2   g35(.a(new_n60_), .b(x13), .O(z07));
  nand2  g36(.a(x13), .b(x06), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n39_), .O(z09));
  nand2  g38(.a(x05), .b(x02), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x06), .c(new_n26_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n39_), .O(z10));
  oai21  g41(.a(new_n57_), .b(new_n55_), .c(new_n39_), .O(z08));
endmodule
