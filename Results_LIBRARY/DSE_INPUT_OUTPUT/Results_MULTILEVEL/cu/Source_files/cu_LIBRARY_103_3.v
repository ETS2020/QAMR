...
module FAU ( 
  ...
  nand2  g06(.a(x10), .b(x09), .O(new_n32_));
  ...
  aoi21  g29(.a(x11), .b(x01), .c(new_n54_), .O(new_n55_));
  nor2   g30(.a(x08), .b(x01), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(new_n53_), .O(new_n57_));
  inv1   g32(.a(x10), .O(new_n58_));
  aoi21  g33(.a(x08), .b(new_n44_), .c(x00), .O(new_n59_));
  nor2   g34(.a(x11), .b(new_n44_), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n57_), .c(new_n39_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n52_), .c(new_n51_), .d(x05), .O(new_n63_));
  nand4  g38(.a(new_n32_), .b(new_n39_), .c(new_n27_), .d(x02), .O(new_n64_));
  ...
  nand3  g43(.a(new_n39_), .b(x05), .c(new_n34_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n32_), .O(z07));
  nand4  g45(.a(x13), .b(new_n52_), .c(x05), .d(new_n30_), .O(new_n71_));
  nand3  g46(.a(new_n39_), .b(new_n27_), .c(x02), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n26_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n32_), .O(z08));
  ...
  nand2  g54(.a(new_n79_), .b(new_n32_), .O(z10));
endmodule
