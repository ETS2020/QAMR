...
module FAU ( 
  ...
  nand3  g42(.a(new_n44_), .b(new_n37_), .c(x02), .O(new_n68_));
  ...
  oai21  g46(.a(new_n51_), .b(new_n49_), .c(new_n35_), .O(z07));
  nand4  g47(.a(x13), .b(new_n27_), .c(x05), .d(new_n31_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n68_), .O(new_n74_));
