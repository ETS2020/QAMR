...
module FAU ( 
  ...
  nand4  g21(.a(new_n46_), .b(new_n41_), .c(x05), .d(new_n35_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  inv1   g23(.a(new_n33_), .O(z04));
  aoi21  g24(.a(new_n43_), .b(x00), .c(new_n40_), .O(z05));
  nand4  g25(.a(new_n33_), .b(new_n41_), .c(new_n27_), .d(x02), .O(new_n51_));
  ...
  nand4  g39(.a(x13), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n65_));
