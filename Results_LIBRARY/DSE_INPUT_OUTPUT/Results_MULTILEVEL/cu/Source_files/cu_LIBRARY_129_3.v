...
module FAU ( 
  ...
  nand4  g20(.a(new_n26_), .b(new_n29_), .c(new_n33_), .d(x00), .O(new_n46_));
  ...
  nand4  g25(.a(new_n50_), .b(new_n43_), .c(x05), .d(new_n27_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n32_), .c(new_n33_), .O(z04));
  ...
  oai21  g32(.a(new_n57_), .b(new_n53_), .c(new_n33_), .O(new_n58_));
  nand2  g33(.a(new_n58_), .b(x00), .O(new_n59_));
  inv1   g34(.a(x08), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(new_n33_), .c(new_n32_), .O(new_n61_));
  ...
  nand3  g40(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n66_));
  ...
  nand2  g44(.a(new_n51_), .b(new_n35_), .O(z07));
  nand4  g45(.a(x13), .b(new_n56_), .c(x05), .d(new_n29_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n66_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n35_), .c(x04), .d(new_n26_), .O(new_n73_));
  ...
  nand4  g52(.a(new_n77_), .b(new_n35_), .c(x06), .d(new_n26_), .O(new_n78_));
