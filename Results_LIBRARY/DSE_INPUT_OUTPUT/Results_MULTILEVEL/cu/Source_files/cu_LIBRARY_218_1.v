...
module FAU ( 
  ...
  aoi21  g25(.a(new_n51_), .b(x00), .c(new_n44_), .O(z05));
  aoi21  g26(.a(x01), .b(new_n32_), .c(x13), .O(new_n53_));
  ...
  nor2   g31(.a(x11), .b(new_n44_), .O(new_n58_));
  oai21  g32(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n59_));
  inv1   g33(.a(x08), .O(new_n60_));
  nand3  g34(.a(new_n60_), .b(new_n44_), .c(new_n32_), .O(new_n61_));
  ...
  nand4  g40(.a(new_n53_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n67_));
  nor2   g41(.a(new_n67_), .b(x02), .O(z07));
  nand4  g42(.a(x13), .b(new_n56_), .c(x05), .d(new_n29_), .O(new_n69_));
  nand3  g43(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand4  g45(.a(new_n71_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n72_));
  ...
  nand4  g50(.a(new_n76_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n77_));
