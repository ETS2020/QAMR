...
module FAU ( 
  ...
  nand4  g21(.a(new_n27_), .b(new_n44_), .c(x05), .d(new_n29_), .O(new_n47_));
  ...
  oai21  g26(.a(new_n51_), .b(new_n45_), .c(new_n27_), .O(z04));
  nand3  g27(.a(new_n31_), .b(x01), .c(x00), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n45_), .c(new_n27_), .O(z05));
  ...
  nor2   g47(.a(new_n44_), .b(new_n26_), .O(z09));
