...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(new_n46_), .c(x05), .d(new_n34_), .O(new_n52_));
  ...
  nand3  g39(.a(new_n46_), .b(new_n28_), .c(x02), .O(new_n65_));
  ...
  nand3  g44(.a(new_n46_), .b(x05), .c(new_n34_), .O(new_n70_));
