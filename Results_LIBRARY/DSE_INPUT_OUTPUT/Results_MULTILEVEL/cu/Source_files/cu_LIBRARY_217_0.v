...
module FAU ( 
  ...
  nand3  g06(.a(new_n31_), .b(x09), .c(new_n30_), .O(new_n32_));
  ...
  nand4  g11(.a(x09), .b(new_n30_), .c(x04), .d(x02), .O(new_n37_));
  ...
  nand4  g19(.a(new_n39_), .b(new_n34_), .c(new_n44_), .d(x00), .O(new_n45_));
  ...
  nand4  g25(.a(new_n43_), .b(x05), .c(new_n35_), .d(new_n39_), .O(new_n51_));
  ...
  nand3  g42(.a(new_n67_), .b(x05), .c(new_n49_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n62_), .c(new_n43_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n56_), .c(new_n55_), .d(new_n34_), .O(new_n70_));
  nand3  g45(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x04), .c(new_n39_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n27_), .O(z06));
  nand2  g49(.a(new_n39_), .b(new_n34_), .O(new_n75_));
  nand3  g50(.a(new_n43_), .b(x05), .c(new_n35_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(new_n75_), .c(new_n27_), .O(z07));
  nand4  g52(.a(x13), .b(new_n56_), .c(x05), .d(new_n34_), .O(new_n78_));
  nand4  g53(.a(new_n43_), .b(x09), .c(new_n30_), .d(x02), .O(new_n79_));
