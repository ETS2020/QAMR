...
module FAU ( 
  ...
  inv1   g20(.a(new_n33_), .O(new_n46_));
  nor3   g21(.a(new_n46_), .b(x13), .c(new_n30_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n27_), .c(new_n26_), .d(new_n29_), .O(new_n48_));
  nor3   g23(.a(new_n48_), .b(x01), .c(new_n40_), .O(z03));
  nor3   g24(.a(new_n48_), .b(new_n41_), .c(x00), .O(z04));
  nand3  g25(.a(new_n29_), .b(x01), .c(x00), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n44_), .c(new_n33_), .O(z05));
  ...
  oai21  g32(.a(x10), .b(new_n41_), .c(x08), .O(new_n58_));
  nor2   g33(.a(x11), .b(x10), .O(new_n59_));
  aoi22  g34(.a(new_n59_), .b(x01), .c(new_n58_), .d(new_n40_), .O(new_n60_));
  ...
  nand3  g42(.a(new_n43_), .b(x05), .c(new_n27_), .O(new_n68_));
  ...
  nor3   g49(.a(new_n46_), .b(new_n43_), .c(new_n74_), .O(z09));
