...
module FAU ( 
  ...
  nor2   g13(.a(x04), .b(new_n30_), .O(new_n39_));
  ...
  nor2   g27(.a(x11), .b(new_n30_), .O(new_n55_));
  oai21  g28(.a(new_n55_), .b(new_n54_), .c(x00), .O(new_n56_));
  nor2   g29(.a(x08), .b(x01), .O(new_n57_));
  nor2   g30(.a(x10), .b(new_n30_), .O(new_n58_));
  oai21  g31(.a(new_n58_), .b(new_n57_), .c(new_n46_), .O(new_n59_));
  aoi21  g32(.a(new_n59_), .b(new_n56_), .c(new_n45_), .O(new_n60_));
  nand4  g33(.a(new_n60_), .b(new_n53_), .c(new_n52_), .d(x05), .O(new_n61_));
  nand3  g34(.a(new_n45_), .b(new_n35_), .c(x02), .O(new_n62_));
  ...
  nor2   g38(.a(x02), .b(x01), .O(new_n66_));
  nand4  g39(.a(new_n66_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n67_));
  nor2   g40(.a(new_n67_), .b(x13), .O(z07));
  ...
  nor3   g46(.a(new_n39_), .b(new_n45_), .c(new_n73_), .O(z09));
  nand2  g47(.a(x05), .b(x02), .O(new_n75_));
  nand4  g48(.a(new_n75_), .b(new_n40_), .c(x06), .d(new_n26_), .O(new_n76_));
