...
module FAU ( 
  ...
  oai21  g30(.a(new_n55_), .b(x01), .c(new_n49_), .O(new_n56_));
  inv1   g31(.a(x09), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n40_), .c(x00), .O(new_n58_));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n64_), .c(x10), .O(new_n66_));
  nand4  g41(.a(new_n41_), .b(x07), .c(new_n27_), .d(x02), .O(new_n67_));
  ...
  nand3  g46(.a(new_n41_), .b(x05), .c(new_n35_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n71_), .c(new_n33_), .O(z07));
  nand4  g48(.a(x13), .b(new_n54_), .c(x05), .d(new_n30_), .O(new_n74_));
