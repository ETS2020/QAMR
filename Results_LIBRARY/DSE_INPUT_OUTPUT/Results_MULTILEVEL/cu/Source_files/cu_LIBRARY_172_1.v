...
module FAU ( 
  ...
  nor2   g07(.a(new_n32_), .b(x09), .O(new_n33_));
  ...
  nand4  g38(.a(new_n63_), .b(new_n56_), .c(x05), .d(new_n29_), .O(new_n64_));
  nand3  g39(.a(new_n44_), .b(new_n30_), .c(x02), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n64_), .c(x12), .O(new_n66_));
  nand4  g41(.a(new_n44_), .b(x09), .c(new_n30_), .d(x02), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n66_), .c(x04), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x03), .O(z06));
  nand3  g45(.a(new_n47_), .b(new_n30_), .c(x02), .O(new_n71_));
  nand4  g46(.a(x13), .b(new_n32_), .c(x05), .d(new_n29_), .O(new_n72_));
