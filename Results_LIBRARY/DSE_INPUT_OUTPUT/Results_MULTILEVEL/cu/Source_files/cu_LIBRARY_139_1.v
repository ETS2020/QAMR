...
module FAU ( 
  ...
  nor3   g24(.a(x02), .b(new_n26_), .c(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z05));
  nand3  g27(.a(new_n42_), .b(x05), .c(x04), .O(new_n53_));
  ...
  nand3  g40(.a(new_n41_), .b(new_n36_), .c(x02), .O(new_n66_));
  ...
  nor2   g44(.a(z04), .b(x13), .O(new_n70_));
