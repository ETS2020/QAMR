...
module FAU ( 
  ...
  nand2  g00(.a(x10), .b(x07), .O(new_n26_));
  ...
  nand4  g20(.a(new_n26_), .b(new_n43_), .c(x05), .d(new_n28_), .O(new_n46_));
  ...
  oai21  g25(.a(new_n50_), .b(new_n44_), .c(new_n26_), .O(z04));
  nand3  g26(.a(new_n30_), .b(x01), .c(x00), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n44_), .c(new_n26_), .O(z05));
