...
module FAU ( 
  ...
  aoi21  g24(.a(new_n49_), .b(x09), .c(x01), .O(z03));
  nand3  g25(.a(new_n29_), .b(x01), .c(new_n40_), .O(new_n51_));
  nand4  g26(.a(new_n46_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n52_));
  ...
  nand4  g43(.a(new_n34_), .b(new_n46_), .c(new_n35_), .d(x02), .O(new_n69_));
  ...
  nand2  g47(.a(new_n33_), .b(new_n29_), .O(new_n73_));
  oai21  g48(.a(new_n47_), .b(new_n73_), .c(new_n34_), .O(z07));
  nand4  g49(.a(x13), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n75_));
  nand3  g50(.a(new_n46_), .b(new_n35_), .c(x02), .O(new_n76_));
  ...
  nor3   g55(.a(new_n26_), .b(new_n46_), .c(new_n80_), .O(z09));
