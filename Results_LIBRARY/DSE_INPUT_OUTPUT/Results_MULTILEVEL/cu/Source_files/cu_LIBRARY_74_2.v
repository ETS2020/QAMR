...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(x07), .c(x05), .d(new_n27_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand3  g28(.a(new_n44_), .b(x05), .c(new_n27_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x07), .c(new_n32_), .O(z05));
  ...
  oai21  g45(.a(new_n54_), .b(new_n70_), .c(new_n34_), .O(z07));
  ...
  nor3   g51(.a(new_n33_), .b(new_n44_), .c(new_n76_), .O(z09));
