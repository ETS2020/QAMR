...
module FAU ( 
  ...
  nand4  g26(.a(new_n27_), .b(new_n51_), .c(new_n36_), .d(x02), .O(new_n52_));
  ...
  nand2  g39(.a(new_n49_), .b(new_n27_), .O(z07));
  nand4  g40(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n66_));
  nand3  g41(.a(new_n51_), .b(new_n36_), .c(x02), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n27_), .c(x04), .d(new_n35_), .O(new_n69_));
