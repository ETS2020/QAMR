...
module FAU ( 
  ...
  nand4  g06(.a(new_n31_), .b(new_n29_), .c(x06), .d(new_n26_), .O(z00));
  ...
  nand3  g10(.a(new_n35_), .b(x06), .c(new_n26_), .O(new_n36_));
  ...
  nand4  g16(.a(new_n41_), .b(x06), .c(x05), .d(new_n33_), .O(new_n42_));
  ...
  aoi21  g24(.a(new_n49_), .b(x06), .c(x03), .O(z04));
  nand4  g25(.a(new_n26_), .b(new_n30_), .c(x01), .d(x00), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x06), .c(x05), .d(new_n33_), .O(new_n53_));
  ...
  nand4  g43(.a(new_n44_), .b(x05), .c(new_n33_), .d(new_n30_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(x06), .c(x03), .O(z07));
  nand4  g45(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n65_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x06), .c(x04), .d(new_n26_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(z08));
  nand2  g49(.a(x13), .b(x06), .O(new_n75_));
  oai21  g50(.a(x06), .b(x03), .c(new_n75_), .O(z09));
