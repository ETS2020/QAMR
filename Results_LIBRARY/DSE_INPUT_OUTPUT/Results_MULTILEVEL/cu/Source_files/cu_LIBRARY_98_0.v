...
module FAU ( 
  ...
  nand3  g06(.a(new_n31_), .b(x08), .c(new_n26_), .O(new_n32_));
  ...
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n28_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand3  g25(.a(new_n35_), .b(x01), .c(new_n50_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n48_), .c(new_n28_), .O(z04));
  ...
  nand4  g40(.a(new_n47_), .b(x08), .c(new_n26_), .d(x02), .O(new_n66_));
  ...
  nand2  g51(.a(new_n76_), .b(new_n28_), .O(z08));
  nand2  g52(.a(x13), .b(x06), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n28_), .O(z09));
  oai21  g54(.a(new_n27_), .b(x05), .c(new_n72_), .O(new_n80_));
