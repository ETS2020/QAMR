...
module FAU ( 
  ...
  nand3  g07(.a(new_n32_), .b(new_n26_), .c(new_n31_), .O(new_n33_));
  nand3  g08(.a(new_n33_), .b(new_n30_), .c(new_n29_), .O(z00));
  inv1   g09(.a(x02), .O(new_n35_));
  inv1   g10(.a(x04), .O(new_n36_));
  nand3  g11(.a(x05), .b(new_n36_), .c(new_n35_), .O(new_n37_));
  nand4  g12(.a(new_n26_), .b(new_n31_), .c(x04), .d(x02), .O(new_n38_));
  ...
  nand4  g20(.a(new_n40_), .b(new_n35_), .c(new_n45_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n44_), .c(x05), .d(new_n36_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand3  g25(.a(new_n35_), .b(x01), .c(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n44_), .b(x05), .c(new_n36_), .d(new_n40_), .O(new_n52_));
  ...
  nand3  g40(.a(new_n44_), .b(new_n31_), .c(x02), .O(new_n66_));
  oai21  g41(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x04), .c(new_n40_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n28_), .O(z06));
  nand2  g44(.a(new_n40_), .b(new_n35_), .O(new_n70_));
  nand3  g45(.a(new_n44_), .b(x05), .c(new_n36_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n28_), .O(z07));
  nand4  g47(.a(x13), .b(new_n57_), .c(x05), .d(new_n35_), .O(new_n73_));
  nand4  g48(.a(new_n44_), .b(new_n26_), .c(new_n31_), .d(x02), .O(new_n74_));
  ...
  nor3   g53(.a(new_n27_), .b(new_n44_), .c(new_n78_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x06), .c(new_n40_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n28_), .O(z10));
endmodule
