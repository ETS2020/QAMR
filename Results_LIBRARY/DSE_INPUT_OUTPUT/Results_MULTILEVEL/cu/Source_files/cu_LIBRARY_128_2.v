...
module FAU ( 
  ...
  nor2   g07(.a(x13), .b(new_n32_), .O(z05));
  ...
  nand3  g27(.a(x13), .b(new_n53_), .c(new_n32_), .O(new_n54_));
  ...
  nand2  g32(.a(new_n58_), .b(x01), .O(new_n59_));
  inv1   g33(.a(x08), .O(new_n60_));
  nand3  g34(.a(x13), .b(new_n60_), .c(new_n32_), .O(new_n61_));
  nand2  g35(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand2  g36(.a(new_n62_), .b(new_n57_), .O(new_n63_));
  aoi21  g37(.a(new_n63_), .b(new_n56_), .c(x12), .O(new_n64_));
  nand4  g38(.a(new_n64_), .b(new_n50_), .c(x05), .d(new_n30_), .O(new_n65_));
  nand3  g39(.a(new_n44_), .b(new_n27_), .c(x02), .O(new_n66_));
  ...
  nor2   g43(.a(x02), .b(x01), .O(new_n70_));
  nand4  g44(.a(new_n70_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n71_));
  nor2   g45(.a(new_n71_), .b(x13), .O(z07));
  inv1   g46(.a(x12), .O(new_n73_));
  nand4  g47(.a(x13), .b(new_n73_), .c(x05), .d(new_n30_), .O(new_n74_));
  nand4  g48(.a(new_n44_), .b(new_n27_), .c(x02), .d(new_n32_), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand3  g50(.a(new_n76_), .b(x04), .c(new_n26_), .O(new_n77_));
  inv1   g51(.a(new_n77_), .O(z08));
  nand2  g52(.a(x13), .b(x06), .O(new_n79_));
  nand2  g53(.a(new_n79_), .b(new_n34_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n81_));
  nand4  g55(.a(new_n81_), .b(new_n34_), .c(x06), .d(new_n26_), .O(new_n82_));
