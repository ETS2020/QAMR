...
module FAU ( 
  ...
  nand2  g29(.a(new_n55_), .b(new_n49_), .O(new_n56_));
  ...
  nor2   g41(.a(new_n32_), .b(x13), .O(new_n68_));
  ...
  nand4  g46(.a(new_n72_), .b(new_n33_), .c(x04), .d(new_n26_), .O(new_n73_));
  inv1   g47(.a(new_n73_), .O(z08));
  inv1   g48(.a(x06), .O(new_n75_));
  nor3   g49(.a(new_n32_), .b(new_n41_), .c(new_n75_), .O(z09));
