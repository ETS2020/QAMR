...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(new_n35_), .c(new_n30_), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n26_), .c(x01), .O(z03));
  inv1   g21(.a(x00), .O(new_n47_));
  nand4  g22(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n47_), .O(new_n48_));
  ...
  nand4  g27(.a(new_n26_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n34_), .O(z05));
  ...
  nand4  g41(.a(x05), .b(new_n28_), .c(new_n35_), .d(new_n30_), .O(new_n67_));
  ...
  nand2  g46(.a(new_n71_), .b(new_n34_), .O(z08));
