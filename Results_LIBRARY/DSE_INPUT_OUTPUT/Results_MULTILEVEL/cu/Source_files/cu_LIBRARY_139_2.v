...
module FAU ( 
  ...
  nand4  g20(.a(new_n41_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n47_));
  oai21  g21(.a(new_n47_), .b(new_n46_), .c(new_n35_), .O(z04));
  inv1   g22(.a(x01), .O(new_n49_));
  nor3   g23(.a(x02), .b(new_n49_), .c(new_n26_), .O(new_n50_));
  ...
  nand3  g39(.a(new_n41_), .b(new_n36_), .c(x02), .O(new_n66_));
  ...
  nand4  g44(.a(new_n70_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n71_));
  ...
  nand3  g48(.a(new_n74_), .b(x04), .c(new_n34_), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n35_), .O(z08));
  inv1   g50(.a(x06), .O(new_n77_));
  nor3   g51(.a(new_n27_), .b(new_n41_), .c(new_n77_), .O(z09));
  nand2  g52(.a(x05), .b(x02), .O(new_n79_));
  nand3  g53(.a(new_n79_), .b(x06), .c(new_n34_), .O(new_n80_));
  nand2  g54(.a(new_n80_), .b(new_n35_), .O(z10));
  zero   g55(.O(z03));
endmodule
