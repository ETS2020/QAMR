...
module FAU ( 
  ...
  nand4  g17(.a(new_n43_), .b(new_n42_), .c(x05), .d(new_n27_), .O(new_n44_));
  ...
  nand4  g21(.a(new_n47_), .b(new_n42_), .c(x05), .d(new_n27_), .O(new_n48_));
  inv1   g22(.a(new_n48_), .O(z04));
  nand3  g23(.a(new_n29_), .b(x01), .c(x00), .O(new_n50_));
  nand4  g24(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n51_));
  ...
  nand2  g43(.a(new_n44_), .b(new_n34_), .O(z07));
