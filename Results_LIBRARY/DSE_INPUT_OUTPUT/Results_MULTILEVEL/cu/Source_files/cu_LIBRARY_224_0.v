...
module FAU ( 
  ...
  aoi21  g17(.a(new_n42_), .b(x08), .c(x01), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand4  g19(.a(new_n26_), .b(new_n29_), .c(new_n44_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(x08), .c(x05), .d(new_n27_), .O(new_n47_));
  ...
  nand4  g29(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n54_), .c(new_n33_), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  inv1   g33(.a(x09), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(x08), .c(new_n44_), .O(new_n60_));
  ...
  nand3  g51(.a(new_n40_), .b(new_n30_), .c(x02), .O(new_n77_));
