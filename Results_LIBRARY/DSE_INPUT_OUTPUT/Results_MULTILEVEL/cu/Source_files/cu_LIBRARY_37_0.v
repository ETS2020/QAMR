...
module FAU ( 
  ...
  nand2  g23(.a(new_n50_), .b(new_n34_), .O(new_n51_));
  inv1   g24(.a(x11), .O(new_n52_));
  nand3  g25(.a(x13), .b(new_n52_), .c(x01), .O(new_n53_));
  nand2  g26(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  nand2  g27(.a(new_n54_), .b(x00), .O(new_n55_));
  inv1   g28(.a(x08), .O(new_n56_));
  nand2  g29(.a(new_n56_), .b(new_n34_), .O(new_n57_));
  inv1   g30(.a(x10), .O(new_n58_));
  nand3  g31(.a(x13), .b(new_n58_), .c(x01), .O(new_n59_));
  nand2  g32(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand2  g33(.a(new_n60_), .b(new_n44_), .O(new_n61_));
  aoi21  g34(.a(new_n61_), .b(new_n55_), .c(x12), .O(new_n62_));
  nand4  g35(.a(new_n62_), .b(new_n49_), .c(x05), .d(new_n29_), .O(new_n63_));
  nand3  g36(.a(new_n35_), .b(new_n30_), .c(x02), .O(new_n64_));
  nand2  g37(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand3  g38(.a(new_n65_), .b(x04), .c(new_n26_), .O(new_n66_));
  nand2  g39(.a(new_n66_), .b(new_n36_), .O(z06));
  nand4  g40(.a(new_n27_), .b(new_n26_), .c(new_n29_), .d(x01), .O(new_n68_));
  nor3   g41(.a(new_n68_), .b(x13), .c(new_n30_), .O(z07));
  inv1   g42(.a(x12), .O(new_n70_));
  nand4  g43(.a(x13), .b(new_n70_), .c(x05), .d(new_n29_), .O(new_n71_));
  nand2  g44(.a(new_n71_), .b(new_n64_), .O(new_n72_));
  nand3  g45(.a(new_n72_), .b(x04), .c(new_n26_), .O(new_n73_));
  nand2  g46(.a(new_n73_), .b(new_n36_), .O(z08));
  and2   g47(.a(x13), .b(x06), .O(z09));
  nand2  g48(.a(x05), .b(x02), .O(new_n76_));
  nand4  g49(.a(new_n76_), .b(new_n36_), .c(x06), .d(new_n26_), .O(new_n77_));
  inv1   g50(.a(new_n77_), .O(z10));
  zero   g51(.O(z02));
  zero   g52(.O(z03));
endmodule
