...
module FAU ( 
  ...
  nand3  g29(.a(new_n54_), .b(x09), .c(x00), .O(new_n55_));
  oai21  g30(.a(x10), .b(x00), .c(new_n55_), .O(new_n56_));
  ...
  nand4  g39(.a(x09), .b(new_n62_), .c(new_n44_), .d(new_n61_), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(new_n66_));
  aoi21  g41(.a(new_n64_), .b(new_n58_), .c(new_n66_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n57_), .c(new_n46_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n53_), .c(new_n52_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n33_), .b(new_n46_), .c(new_n27_), .d(x02), .O(new_n70_));
  ...
  nand3  g49(.a(new_n46_), .b(x05), .c(new_n35_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n74_), .c(new_n33_), .O(z07));
  nand4  g51(.a(x13), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n77_));
  nand3  g52(.a(new_n46_), .b(new_n27_), .c(x02), .O(new_n78_));
  ...
  nor3   g57(.a(new_n40_), .b(new_n46_), .c(new_n82_), .O(z09));
