...
module FAU ( 
  ...
  nand2  g07(.a(new_n32_), .b(x08), .O(new_n33_));
  ...
  nand2  g29(.a(x09), .b(x01), .O(new_n55_));
  oai21  g30(.a(x09), .b(x08), .c(new_n55_), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n54_), .c(x00), .O(new_n57_));
  inv1   g32(.a(x08), .O(new_n58_));
  aoi21  g33(.a(x10), .b(x01), .c(x00), .O(new_n59_));
  nor2   g34(.a(x09), .b(x01), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(new_n61_));
  inv1   g36(.a(x00), .O(new_n62_));
  inv1   g37(.a(x10), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(x09), .c(x01), .d(new_n62_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(new_n61_), .c(new_n57_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(x13), .c(new_n53_), .d(new_n52_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x05), .c(new_n29_), .O(new_n68_));
  ...
  inv1   g47(.a(new_n43_), .O(z07));
  nand4  g48(.a(x13), .b(new_n53_), .c(x05), .d(new_n29_), .O(new_n74_));
  nand3  g49(.a(new_n40_), .b(new_n30_), .c(x02), .O(new_n75_));
  ...
  nand2  g54(.a(new_n33_), .b(x13), .O(new_n80_));
  nor2   g55(.a(new_n80_), .b(new_n79_), .O(z09));
