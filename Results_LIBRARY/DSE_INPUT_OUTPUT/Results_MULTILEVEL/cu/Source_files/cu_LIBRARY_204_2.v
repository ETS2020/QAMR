...
module FAU ( 
  ...
  nand3  g48(.a(new_n48_), .b(x05), .c(new_n29_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(new_n73_), .c(new_n27_), .O(z07));
  nand4  g50(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n76_));
  nand3  g51(.a(new_n48_), .b(new_n36_), .c(x02), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n27_), .c(x04), .d(new_n35_), .O(new_n79_));
  ...
  nand2  g59(.a(new_n84_), .b(new_n27_), .O(z10));
endmodule
