...
module FAU ( 
  ...
  nand3  g37(.a(new_n43_), .b(new_n27_), .c(x02), .O(new_n63_));
  ...
  nand3  g42(.a(new_n43_), .b(x05), .c(new_n35_), .O(new_n68_));
  ...
  aoi21  g49(.a(new_n43_), .b(x08), .c(new_n74_), .O(z09));
  nand2  g50(.a(x05), .b(x02), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(x08), .c(x06), .d(new_n26_), .O(new_n77_));
