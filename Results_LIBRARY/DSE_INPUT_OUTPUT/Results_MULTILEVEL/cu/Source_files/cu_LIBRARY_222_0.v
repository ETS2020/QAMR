...
module FAU ( 
  ...
  nand4  g29(.a(new_n54_), .b(new_n43_), .c(x05), .d(new_n36_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(z04));
  nor3   g31(.a(x02), .b(new_n32_), .c(new_n52_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n58_));
  ...
  nand4  g40(.a(new_n65_), .b(new_n33_), .c(new_n60_), .d(x05), .O(new_n66_));
  ...
  oai21  g45(.a(new_n44_), .b(new_n41_), .c(new_n34_), .O(z07));
  nand4  g46(.a(x13), .b(new_n33_), .c(x05), .d(new_n30_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n67_), .c(new_n32_), .O(new_n73_));
  nand4  g48(.a(new_n43_), .b(x12), .c(new_n27_), .d(x02), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n73_), .c(x04), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(x03), .O(z08));
