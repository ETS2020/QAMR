...
module FAU ( 
  ...
  nand4  g21(.a(new_n35_), .b(new_n31_), .c(new_n43_), .d(x00), .O(new_n47_));
  ...
  oai21  g26(.a(new_n51_), .b(new_n45_), .c(new_n36_), .O(z04));
  ...
  aoi22  g36(.a(new_n61_), .b(new_n42_), .c(new_n60_), .d(x01), .O(new_n62_));
  ...
  nand3  g46(.a(x13), .b(new_n57_), .c(new_n26_), .O(new_n72_));
  ...
  nand3  g50(.a(x13), .b(new_n26_), .c(x06), .O(new_n76_));
