...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n33_), .O(z03));
  inv1   g22(.a(x00), .O(new_n48_));
  nor2   g23(.a(x03), .b(x02), .O(new_n49_));
  nand3  g24(.a(new_n45_), .b(x05), .c(new_n35_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n49_), .c(new_n48_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x07), .c(new_n43_), .O(z04));
  nand3  g28(.a(new_n51_), .b(new_n49_), .c(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x07), .c(new_n43_), .O(z05));
  ...
  nand4  g36(.a(new_n61_), .b(new_n56_), .c(new_n32_), .d(x05), .O(new_n62_));
  ...
  inv1   g41(.a(new_n49_), .O(new_n67_));
  oai21  g42(.a(new_n50_), .b(new_n67_), .c(new_n33_), .O(z07));
  ...
  nand4  g50(.a(new_n75_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n76_));
