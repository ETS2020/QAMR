...
module FAU ( 
  ...
  nand4  g19(.a(new_n34_), .b(new_n29_), .c(x01), .d(new_n45_), .O(new_n46_));
  ...
  nand2  g33(.a(new_n59_), .b(new_n45_), .O(new_n60_));
  ...
  nand3  g42(.a(new_n68_), .b(x04), .c(new_n34_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n60_), .O(z06));
  nor2   g44(.a(new_n26_), .b(x13), .O(new_n71_));
  nand4  g45(.a(new_n71_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n72_));
  ...
  nor3   g52(.a(new_n26_), .b(new_n41_), .c(new_n78_), .O(z09));
  nand2  g53(.a(x05), .b(x02), .O(new_n80_));
  nand3  g54(.a(new_n80_), .b(x06), .c(new_n34_), .O(new_n81_));
  nand2  g55(.a(new_n81_), .b(new_n33_), .O(z10));
  zero   g56(.O(z02));
endmodule
