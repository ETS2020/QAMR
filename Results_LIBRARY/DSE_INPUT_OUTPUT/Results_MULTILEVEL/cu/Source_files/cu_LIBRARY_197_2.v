...
module FAU ( 
  ...
  nor2   g07(.a(x07), .b(new_n32_), .O(new_n33_));
  ...
  nand4  g21(.a(new_n26_), .b(new_n29_), .c(new_n32_), .d(x00), .O(new_n47_));
  ...
  nand3  g26(.a(new_n51_), .b(new_n43_), .c(new_n27_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x07), .c(new_n32_), .O(z04));
  nand4  g28(.a(new_n26_), .b(new_n29_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x07), .c(x05), .d(new_n27_), .O(new_n56_));
  nor2   g31(.a(new_n56_), .b(x13), .O(z05));
  nor2   g32(.a(new_n33_), .b(x13), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(new_n30_), .c(x02), .O(new_n59_));
  ...
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n29_), .d(new_n32_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n59_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n26_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z06));
  nand4  g47(.a(new_n58_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x02), .O(z07));
  nand4  g49(.a(x13), .b(new_n61_), .c(x05), .d(new_n29_), .O(new_n75_));
  nand3  g50(.a(new_n46_), .b(new_n30_), .c(x02), .O(new_n76_));
  ...
  nor3   g55(.a(new_n33_), .b(new_n46_), .c(new_n80_), .O(z09));
