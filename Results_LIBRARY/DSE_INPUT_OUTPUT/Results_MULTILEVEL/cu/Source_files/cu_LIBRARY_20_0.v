...
module FAU ( 
  ...
  aoi21  g38(.a(new_n63_), .b(new_n61_), .c(new_n51_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n65_));
  nand3  g40(.a(new_n51_), .b(new_n35_), .c(x02), .O(new_n66_));
  ...
  nand2  g44(.a(new_n34_), .b(new_n29_), .O(new_n70_));
  nand3  g45(.a(new_n51_), .b(x05), .c(new_n27_), .O(new_n71_));
  ...
  nand4  g49(.a(new_n74_), .b(new_n33_), .c(x04), .d(new_n34_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z08));
  inv1   g51(.a(x06), .O(new_n77_));
  nor3   g52(.a(new_n26_), .b(new_n51_), .c(new_n77_), .O(z09));
