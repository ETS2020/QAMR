...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(new_n46_), .c(x05), .d(new_n33_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nand3  g28(.a(new_n27_), .b(x01), .c(x00), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n47_), .c(new_n39_), .O(z05));
  nand4  g30(.a(new_n46_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x07), .c(new_n33_), .O(z06));
  nand2  g32(.a(new_n26_), .b(new_n27_), .O(new_n58_));
  nand3  g33(.a(new_n46_), .b(x05), .c(new_n33_), .O(new_n59_));
  ...
  nand3  g37(.a(new_n46_), .b(new_n28_), .c(x02), .O(new_n63_));
