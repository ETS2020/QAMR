...
module FAU ( 
  ...
  nor2   g06(.a(x12), .b(x08), .O(new_n32_));
  ...
  oai21  g23(.a(new_n48_), .b(new_n44_), .c(new_n33_), .O(z04));
  nand3  g24(.a(new_n29_), .b(x01), .c(x00), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n44_), .c(new_n33_), .O(z05));
  ...
  nand3  g32(.a(new_n57_), .b(x01), .c(new_n40_), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(new_n56_), .c(new_n43_), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(new_n53_), .c(new_n52_), .d(x05), .O(new_n60_));
  nand3  g35(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n61_));
  oai21  g36(.a(new_n60_), .b(x02), .c(new_n61_), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(x04), .c(new_n26_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n33_), .O(z06));
  nor2   g39(.a(new_n32_), .b(x13), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(x02), .O(z07));
  nand3  g42(.a(new_n65_), .b(new_n30_), .c(x02), .O(new_n68_));
  nor2   g43(.a(new_n30_), .b(x02), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(x13), .c(new_n53_), .d(x08), .O(new_n70_));
  ...
  nor3   g49(.a(new_n32_), .b(new_n43_), .c(new_n74_), .O(z09));
