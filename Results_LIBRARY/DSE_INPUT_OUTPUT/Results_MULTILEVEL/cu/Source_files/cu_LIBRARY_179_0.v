...
module FAU ( 
  ...
  nand3  g21(.a(new_n29_), .b(new_n41_), .c(x00), .O(new_n47_));
  nand4  g22(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n48_));
  ...
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(new_n50_), .O(new_n58_));
  ...
  nand3  g37(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n63_));
  ...
  nand3  g42(.a(new_n42_), .b(x05), .c(new_n27_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n67_), .c(new_n34_), .O(z07));
