...
module FAU ( 
  ...
  nor2   g30(.a(x10), .b(new_n41_), .O(new_n56_));
  ...
  oai21  g34(.a(new_n59_), .b(new_n56_), .c(new_n58_), .O(new_n60_));
  inv1   g35(.a(x09), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n41_), .c(x00), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(new_n60_), .c(new_n57_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(x13), .c(new_n54_), .d(new_n53_), .O(new_n64_));
  ...
  nand4  g45(.a(x13), .b(new_n54_), .c(x05), .d(new_n29_), .O(new_n71_));
  ...
  oai21  g49(.a(new_n43_), .b(new_n32_), .c(new_n33_), .O(z09));
