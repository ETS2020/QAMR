...
module FAU ( 
  ...
  nand3  g04(.a(x12), .b(new_n28_), .c(x04), .O(new_n30_));
  ...
  oai21  g20(.a(new_n45_), .b(new_n43_), .c(new_n39_), .O(z02));
  nand4  g21(.a(new_n26_), .b(new_n27_), .c(new_n42_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n44_), .c(x05), .d(new_n33_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  nand3  g25(.a(new_n27_), .b(x01), .c(new_n41_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n45_), .c(new_n39_), .O(z04));
  nand3  g27(.a(new_n27_), .b(x01), .c(x00), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n45_), .c(new_n39_), .O(z05));
  ...
  nand4  g37(.a(new_n62_), .b(new_n38_), .c(new_n55_), .d(new_n27_), .O(new_n63_));
  ...
  nand3  g44(.a(x13), .b(new_n38_), .c(new_n27_), .O(new_n70_));
