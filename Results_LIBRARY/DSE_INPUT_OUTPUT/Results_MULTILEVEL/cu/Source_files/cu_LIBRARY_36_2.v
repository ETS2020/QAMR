...
module FAU ( 
  ...
  nand4  g25(.a(new_n34_), .b(new_n30_), .c(x01), .d(new_n41_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x07), .c(x05), .d(new_n28_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nor2   g29(.a(x03), .b(x02), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n43_), .c(new_n28_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x07), .c(new_n26_), .O(z05));
