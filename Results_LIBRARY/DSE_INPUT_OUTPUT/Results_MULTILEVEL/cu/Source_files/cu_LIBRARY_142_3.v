...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n30_), .c(new_n36_), .O(z03));
  ...
  nand3  g29(.a(new_n49_), .b(new_n36_), .c(x02), .O(new_n57_));
  oai21  g30(.a(new_n56_), .b(x02), .c(new_n57_), .O(new_n58_));
  nand3  g31(.a(new_n58_), .b(x04), .c(new_n26_), .O(new_n59_));
  nand2  g32(.a(x05), .b(x01), .O(new_n60_));
  nand2  g33(.a(new_n60_), .b(new_n59_), .O(z06));
  nand4  g34(.a(new_n34_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n62_));
  nor2   g35(.a(new_n62_), .b(x13), .O(z07));
  nand4  g36(.a(x13), .b(new_n48_), .c(x05), .d(new_n29_), .O(new_n64_));
  nand2  g37(.a(new_n64_), .b(new_n57_), .O(new_n65_));
  nand3  g38(.a(new_n65_), .b(x04), .c(new_n26_), .O(new_n66_));
  nand2  g39(.a(new_n66_), .b(new_n60_), .O(z08));
  nand3  g40(.a(new_n60_), .b(x13), .c(x06), .O(new_n68_));
  inv1   g41(.a(new_n68_), .O(z09));
  nand2  g42(.a(x05), .b(x02), .O(new_n70_));
  nand3  g43(.a(new_n70_), .b(x06), .c(new_n26_), .O(new_n71_));
  nand2  g44(.a(new_n71_), .b(new_n60_), .O(z10));
  zero   g45(.O(z04));
  zero   g46(.O(z05));
endmodule
