...
module FAU ( 
  ...
  nor2   g41(.a(new_n26_), .b(x13), .O(new_n68_));
  nand4  g42(.a(new_n68_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n69_));
  nor2   g43(.a(new_n69_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n54_), .c(x05), .d(new_n29_), .O(new_n71_));
  ...
  nor3   g49(.a(new_n26_), .b(new_n41_), .c(new_n75_), .O(z09));
  nand2  g50(.a(x05), .b(x02), .O(new_n77_));
  nand4  g51(.a(new_n77_), .b(new_n34_), .c(x06), .d(new_n33_), .O(new_n78_));
