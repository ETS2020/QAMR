...
module FAU ( 
  ...
  nor2   g15(.a(x05), .b(new_n30_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nand3  g17(.a(new_n27_), .b(new_n30_), .c(x00), .O(new_n43_));
  ...
  nand4  g24(.a(new_n49_), .b(new_n44_), .c(x05), .d(new_n34_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z04));
  nor3   g26(.a(x02), .b(new_n30_), .c(new_n47_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n53_));
  ...
  nand4  g49(.a(x05), .b(new_n34_), .c(new_n26_), .d(new_n27_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x13), .O(z07));
  nand4  g51(.a(x13), .b(new_n56_), .c(x05), .d(new_n27_), .O(new_n77_));
  ...
  nand2  g59(.a(new_n84_), .b(new_n42_), .O(z10));
endmodule
