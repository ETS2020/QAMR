...
module FAU ( 
  ...
  nand3  g48(.a(new_n74_), .b(x04), .c(new_n26_), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n32_), .O(z08));
  nand3  g50(.a(new_n32_), .b(x13), .c(x06), .O(new_n77_));
  inv1   g51(.a(new_n77_), .O(z09));
