...
module FAU ( 
  ...
  nor2   g08(.a(x03), .b(new_n26_), .O(new_n34_));
  ...
  nand4  g17(.a(new_n37_), .b(new_n26_), .c(new_n42_), .d(x00), .O(new_n43_));
  ...
  nand4  g22(.a(new_n37_), .b(new_n26_), .c(x01), .d(new_n47_), .O(new_n48_));
  ...
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n27_), .d(new_n37_), .O(new_n53_));
  ...
  aoi21  g37(.a(new_n62_), .b(new_n59_), .c(new_n41_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n56_), .c(new_n55_), .d(x05), .O(new_n64_));
  oai21  g39(.a(new_n64_), .b(new_n27_), .c(new_n37_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n26_), .O(new_n66_));
  nand4  g41(.a(new_n34_), .b(new_n41_), .c(new_n30_), .d(x04), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(z06));
  nand4  g43(.a(x05), .b(new_n27_), .c(new_n37_), .d(new_n26_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x13), .O(z07));
  nand4  g45(.a(x13), .b(new_n56_), .c(x05), .d(x04), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n37_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n26_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n67_), .O(z08));
  inv1   g49(.a(x06), .O(new_n75_));
  oai21  g50(.a(new_n37_), .b(x02), .c(x13), .O(new_n76_));
