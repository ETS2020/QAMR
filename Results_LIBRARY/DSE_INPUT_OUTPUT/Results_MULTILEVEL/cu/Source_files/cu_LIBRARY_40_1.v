...
module FAU ( 
  ...
  nand4  g23(.a(new_n26_), .b(new_n30_), .c(new_n48_), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n32_), .c(x05), .d(new_n36_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z03));
  inv1   g27(.a(x00), .O(new_n53_));
  nand4  g28(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n53_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n43_), .c(x05), .d(new_n36_), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(z04));
  nand3  g32(.a(new_n30_), .b(x01), .c(x00), .O(new_n58_));
  nand4  g33(.a(new_n43_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n34_), .O(z05));
  ...
  nand2  g42(.a(new_n32_), .b(x01), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  inv1   g44(.a(x11), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(new_n32_), .c(x01), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(new_n72_));
  aoi21  g47(.a(new_n69_), .b(new_n53_), .c(new_n72_), .O(new_n73_));
  ...
  nor3   g60(.a(new_n33_), .b(new_n43_), .c(new_n85_), .O(z09));
