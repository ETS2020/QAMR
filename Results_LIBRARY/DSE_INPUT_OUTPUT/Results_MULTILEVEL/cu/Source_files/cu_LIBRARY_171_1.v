...
module FAU ( 
  ...
  nor3   g28(.a(x02), .b(new_n32_), .c(new_n49_), .O(new_n54_));
  ...
  inv1   g40(.a(new_n33_), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(x13), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(new_n30_), .c(x02), .O(new_n68_));
  oai21  g43(.a(new_n65_), .b(x02), .c(new_n68_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x04), .c(new_n26_), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(z06));
  nand4  g46(.a(new_n67_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n74_));
  nand3  g49(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n75_));
  ...
  nor3   g54(.a(new_n66_), .b(new_n41_), .c(new_n79_), .O(z09));
