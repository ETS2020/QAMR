...
module FAU ( 
  ...
  nand4  g20(.a(new_n36_), .b(new_n31_), .c(new_n26_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n45_), .c(x05), .d(new_n29_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  nand2  g24(.a(new_n36_), .b(new_n31_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x00), .O(new_n51_));
  nand3  g26(.a(new_n45_), .b(x05), .c(new_n29_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand2  g28(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n27_), .c(new_n26_), .O(z04));
  nand4  g30(.a(new_n36_), .b(new_n31_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(new_n27_), .c(x05), .d(new_n29_), .O(new_n58_));
  ...
  nor3   g45(.a(x09), .b(x08), .c(x01), .O(new_n71_));
  aoi21  g46(.a(new_n70_), .b(new_n65_), .c(new_n71_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n64_), .c(new_n45_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n74_));
  nand3  g49(.a(new_n45_), .b(new_n37_), .c(x02), .O(new_n75_));
  ...
  oai21  g53(.a(new_n52_), .b(new_n50_), .c(new_n35_), .O(z07));
  nand4  g54(.a(x13), .b(new_n61_), .c(x05), .d(new_n31_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n75_), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n35_), .c(x04), .d(new_n36_), .O(new_n82_));
  inv1   g57(.a(new_n82_), .O(z08));
  nand3  g58(.a(new_n35_), .b(x13), .c(x06), .O(new_n84_));
