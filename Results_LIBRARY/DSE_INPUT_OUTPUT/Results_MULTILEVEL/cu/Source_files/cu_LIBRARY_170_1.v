...
module FAU ( 
  ...
  nand4  g25(.a(new_n33_), .b(new_n51_), .c(new_n30_), .d(x02), .O(new_n52_));
  ...
  nand4  g39(.a(x13), .b(new_n54_), .c(x05), .d(new_n29_), .O(new_n66_));
  nand3  g40(.a(new_n51_), .b(new_n30_), .c(x02), .O(new_n67_));
  ...
  nand2  g49(.a(new_n75_), .b(new_n33_), .O(z10));
  zero   g50(.O(z04));
endmodule
