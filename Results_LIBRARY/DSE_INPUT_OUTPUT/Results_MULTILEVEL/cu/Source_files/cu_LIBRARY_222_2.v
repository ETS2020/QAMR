...
module FAU ( 
  ...
  nand4  g38(.a(new_n63_), .b(new_n32_), .c(new_n58_), .d(x05), .O(new_n64_));
  ...
  nand3  g44(.a(new_n43_), .b(x05), .c(new_n35_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n69_), .c(new_n33_), .O(z07));
  nand4  g46(.a(x13), .b(new_n32_), .c(x05), .d(new_n30_), .O(new_n72_));
