...
module FAU ( 
  ...
  nand4  g11(.a(new_n31_), .b(x05), .c(new_n26_), .d(new_n29_), .O(new_n37_));
  ...
  aoi21  g17(.a(new_n42_), .b(new_n31_), .c(x04), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand4  g19(.a(new_n39_), .b(new_n29_), .c(new_n44_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n31_), .c(x05), .d(new_n26_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x13), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand4  g24(.a(new_n39_), .b(new_n29_), .c(x01), .d(new_n49_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n31_), .c(x05), .d(new_n26_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand4  g28(.a(new_n39_), .b(new_n29_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n31_), .c(x05), .d(new_n26_), .O(new_n56_));
  ...
  nand4  g47(.a(new_n72_), .b(new_n31_), .c(x05), .d(new_n26_), .O(new_n73_));
  ...
  nand2  g57(.a(new_n82_), .b(new_n27_), .O(z10));
endmodule
