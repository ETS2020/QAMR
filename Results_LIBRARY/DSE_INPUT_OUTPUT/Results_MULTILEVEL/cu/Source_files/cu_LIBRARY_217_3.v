...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n28_), .c(x05), .d(new_n30_), .O(new_n44_));
  ...
  aoi21  g29(.a(new_n54_), .b(new_n28_), .c(new_n33_), .O(z05));
  ...
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n41_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n26_), .O(z06));
  nand4  g47(.a(new_n68_), .b(new_n30_), .c(new_n41_), .d(new_n29_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n28_), .c(new_n33_), .O(z07));
  nand2  g49(.a(x05), .b(new_n29_), .O(new_n75_));
  nand3  g50(.a(x13), .b(new_n57_), .c(new_n28_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(new_n75_), .c(new_n69_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n41_), .O(new_n78_));
  ...
  nand3  g57(.a(new_n82_), .b(x06), .c(new_n41_), .O(new_n83_));
