...
module FAU ( 
  ...
  nand4  g39(.a(new_n42_), .b(new_n27_), .c(x02), .d(x01), .O(new_n65_));
  ...
  nand2  g43(.a(new_n31_), .b(new_n30_), .O(new_n69_));
  nand3  g44(.a(new_n42_), .b(x05), .c(new_n32_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n69_), .c(new_n48_), .O(z07));
  ...
  nor3   g51(.a(new_n47_), .b(new_n42_), .c(new_n76_), .O(z09));
  nand2  g52(.a(x05), .b(x02), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x06), .c(new_n31_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n48_), .O(z10));
endmodule
