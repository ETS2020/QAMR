...
module FAU ( 
  ...
  nand2  g20(.a(x02), .b(new_n45_), .O(new_n46_));
  ...
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n46_), .O(z05));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n59_), .c(new_n38_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n53_), .c(new_n52_), .d(x05), .O(new_n67_));
  nand3  g42(.a(new_n38_), .b(new_n28_), .c(x02), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x04), .c(new_n26_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n46_), .O(z06));
  nand4  g46(.a(x05), .b(new_n33_), .c(new_n26_), .d(new_n27_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x13), .O(z07));
  nand2  g48(.a(x02), .b(x01), .O(new_n74_));
  nand2  g49(.a(new_n38_), .b(new_n28_), .O(new_n75_));
  nand4  g50(.a(x13), .b(new_n53_), .c(x05), .d(new_n27_), .O(new_n76_));
