...
module FAU ( 
  ...
  nand4  g21(.a(new_n26_), .b(new_n30_), .c(new_n42_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n32_), .c(x05), .d(new_n36_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  inv1   g25(.a(x13), .O(new_n51_));
  nand4  g26(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n41_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n51_), .c(x05), .d(new_n36_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(z04));
  nor3   g30(.a(x02), .b(new_n42_), .c(new_n41_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n57_));
  ...
  nand3  g42(.a(new_n51_), .b(new_n27_), .c(x02), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n67_), .c(x07), .O(new_n69_));
  nand4  g44(.a(new_n51_), .b(new_n27_), .c(x02), .d(x01), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n69_), .c(x04), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x03), .O(z06));
  nor2   g48(.a(new_n33_), .b(x13), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n75_));
  ...
  nand4  g53(.a(new_n78_), .b(new_n34_), .c(x04), .d(new_n26_), .O(new_n79_));
