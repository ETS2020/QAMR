...
module FAU ( 
  ...
  oai21  g41(.a(new_n66_), .b(new_n36_), .c(new_n60_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x04), .c(new_n30_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(z08));
  inv1   g44(.a(x06), .O(new_n70_));
  nor3   g45(.a(z04), .b(new_n43_), .c(new_n70_), .O(z09));
  aoi21  g46(.a(x06), .b(new_n30_), .c(x01), .O(new_n72_));
  nand3  g47(.a(x06), .b(new_n31_), .c(new_n30_), .O(new_n73_));
  oai21  g48(.a(new_n72_), .b(x02), .c(new_n73_), .O(z10));
  nor2   g49(.a(x02), .b(new_n35_), .O(z05));
endmodule
