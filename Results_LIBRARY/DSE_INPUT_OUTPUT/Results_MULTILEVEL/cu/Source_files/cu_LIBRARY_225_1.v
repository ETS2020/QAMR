...
module FAU ( 
  ...
  nand3  g37(.a(new_n62_), .b(new_n57_), .c(new_n49_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n56_), .c(new_n46_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n53_), .c(x05), .d(new_n31_), .O(new_n65_));
  nand3  g40(.a(new_n46_), .b(new_n36_), .c(x02), .O(new_n66_));
  ...
  nand3  g45(.a(new_n46_), .b(x05), .c(new_n29_), .O(new_n71_));
