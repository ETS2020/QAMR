...
module FAU ( 
  ...
  nand2  g13(.a(x04), .b(new_n38_), .O(new_n39_));
  ...
  nand4  g19(.a(new_n26_), .b(new_n27_), .c(new_n38_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n44_), .c(x05), .d(new_n33_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand3  g24(.a(new_n27_), .b(x01), .c(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n44_), .b(x05), .c(new_n33_), .d(new_n26_), .O(new_n51_));
  ...
  nand4  g36(.a(new_n61_), .b(new_n56_), .c(new_n55_), .d(x05), .O(new_n62_));
  nand3  g37(.a(new_n44_), .b(new_n28_), .c(x02), .O(new_n63_));
  oai21  g38(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(x04), .c(new_n26_), .d(x01), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(z06));
  nand2  g41(.a(new_n26_), .b(new_n27_), .O(new_n67_));
  nand3  g42(.a(new_n44_), .b(x05), .c(new_n33_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n67_), .c(new_n39_), .O(z07));
  ...
  aoi21  g47(.a(new_n72_), .b(x01), .c(new_n33_), .O(z08));
