...
module FAU ( 
  ...
  nand4  g24(.a(new_n49_), .b(new_n42_), .c(x05), .d(new_n34_), .O(new_n50_));
  ...
  oai21  g31(.a(new_n57_), .b(new_n53_), .c(new_n43_), .O(new_n58_));
  nand2  g32(.a(new_n58_), .b(x00), .O(new_n59_));
  inv1   g33(.a(x08), .O(new_n60_));
  nand3  g34(.a(new_n60_), .b(new_n43_), .c(new_n48_), .O(new_n61_));
  ...
  nand4  g45(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n72_));
