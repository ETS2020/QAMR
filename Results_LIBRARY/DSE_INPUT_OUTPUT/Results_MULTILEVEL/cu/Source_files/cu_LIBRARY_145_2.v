...
module FAU ( 
  ...
  nor2   g19(.a(x13), .b(new_n36_), .O(new_n45_));
  ...
  nand3  g23(.a(new_n48_), .b(new_n45_), .c(new_n28_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x12), .c(new_n26_), .O(z04));
  nand4  g25(.a(new_n35_), .b(new_n30_), .c(x01), .d(x00), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x12), .c(x05), .d(new_n28_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z05));
  nor2   g29(.a(new_n27_), .b(x13), .O(new_n55_));
  nand3  g30(.a(new_n55_), .b(new_n36_), .c(x02), .O(new_n56_));
  ...
  nand4  g39(.a(new_n64_), .b(x13), .c(new_n58_), .d(new_n57_), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n56_), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(x04), .c(new_n35_), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z06));
  nand4  g45(.a(new_n55_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n71_));
  ...
  aoi21  g50(.a(new_n75_), .b(new_n73_), .c(x01), .O(new_n76_));
  nand4  g51(.a(new_n74_), .b(x12), .c(new_n36_), .d(x02), .O(new_n77_));
  ...
  nor3   g56(.a(new_n27_), .b(new_n74_), .c(new_n81_), .O(z09));
