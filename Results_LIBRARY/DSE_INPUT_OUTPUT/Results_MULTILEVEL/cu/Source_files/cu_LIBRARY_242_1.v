...
module FAU ( 
  ...
  nand3  g40(.a(new_n65_), .b(new_n40_), .c(new_n32_), .O(new_n66_));
  inv1   g41(.a(x11), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x01), .c(x00), .O(new_n68_));
  and2   g43(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n64_), .c(new_n43_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n71_));
  nand4  g46(.a(new_n33_), .b(new_n43_), .c(new_n30_), .d(x02), .O(new_n72_));
  ...
  oai21  g50(.a(new_n44_), .b(new_n41_), .c(new_n33_), .O(z07));
