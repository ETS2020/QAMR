...
module FAU ( 
  ...
  nor2   g06(.a(x08), .b(x01), .O(new_n32_));
  ...
  oai21  g29(.a(new_n54_), .b(new_n53_), .c(new_n33_), .O(z04));
  nand3  g30(.a(new_n29_), .b(x01), .c(x00), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n54_), .c(new_n33_), .O(z05));
  ...
  nand3  g38(.a(new_n63_), .b(x01), .c(new_n52_), .O(new_n64_));
  ...
  oai21  g45(.a(new_n43_), .b(new_n40_), .c(new_n33_), .O(z07));
  ...
  nor3   g51(.a(new_n32_), .b(new_n42_), .c(new_n76_), .O(z09));
