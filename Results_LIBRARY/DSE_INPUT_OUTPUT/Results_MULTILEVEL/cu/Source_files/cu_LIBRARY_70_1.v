...
module FAU ( 
  ...
  nand4  g21(.a(new_n44_), .b(new_n26_), .c(new_n29_), .d(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n32_), .c(x01), .O(z03));
  ...
  nand3  g35(.a(new_n32_), .b(new_n60_), .c(x01), .O(new_n61_));
  ...
  nand3  g41(.a(new_n32_), .b(new_n66_), .c(x01), .O(new_n67_));
  ...
  nand4  g45(.a(new_n70_), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n71_));
  ...
  nand4  g51(.a(new_n76_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n77_));
  nor2   g52(.a(new_n77_), .b(x02), .O(z07));
  nand4  g53(.a(x13), .b(new_n32_), .c(x05), .d(new_n29_), .O(new_n79_));
