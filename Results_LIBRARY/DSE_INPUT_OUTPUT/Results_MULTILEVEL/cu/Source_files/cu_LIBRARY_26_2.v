...
module FAU ( 
  ...
  nor2   g26(.a(x02), .b(new_n42_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n32_), .c(new_n43_), .d(new_n41_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n26_), .c(x13), .O(z04));
  nand4  g29(.a(new_n43_), .b(new_n30_), .c(x01), .d(x00), .O(new_n55_));
  ...
  nor2   g40(.a(x11), .b(new_n42_), .O(new_n66_));
  ...
  nand3  g58(.a(new_n83_), .b(x06), .c(new_n43_), .O(new_n84_));
