...
module FAU ( 
  ...
  nand2  g06(.a(x13), .b(x10), .O(new_n32_));
  ...
  oai21  g34(.a(new_n59_), .b(x01), .c(new_n48_), .O(new_n60_));
  inv1   g35(.a(x09), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n43_), .c(x00), .O(new_n62_));
  ...
  nand2  g59(.a(new_n84_), .b(new_n32_), .O(z10));
endmodule
