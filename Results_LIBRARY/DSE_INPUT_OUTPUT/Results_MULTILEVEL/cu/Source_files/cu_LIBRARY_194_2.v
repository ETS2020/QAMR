...
module FAU ( 
  ...
  nand4  g19(.a(new_n34_), .b(new_n30_), .c(x01), .d(new_n26_), .O(new_n46_));
  ...
  nand2  g42(.a(new_n43_), .b(new_n35_), .O(z07));
  nand4  g43(.a(x13), .b(new_n54_), .c(x05), .d(new_n30_), .O(new_n70_));
