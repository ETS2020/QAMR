...
module FAU ( 
  ...
  nand4  g25(.a(new_n51_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n52_));
  ...
  nand4  g45(.a(new_n71_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n72_));
  ...
  nand4  g54(.a(new_n80_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n81_));
