...
module FAU ( 
  ...
  nand3  g16(.a(new_n30_), .b(new_n32_), .c(new_n41_), .O(new_n42_));
  inv1   g17(.a(x13), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n34_), .O(z02));
  nand4  g20(.a(new_n26_), .b(new_n30_), .c(new_n32_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n43_), .c(x05), .d(new_n36_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  nand4  g24(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n41_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x10), .c(x05), .d(new_n36_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand3  g28(.a(new_n43_), .b(x05), .c(new_n36_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n26_), .c(new_n30_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x10), .c(new_n32_), .O(z05));
  ...
  oai21  g46(.a(new_n54_), .b(new_n71_), .c(new_n34_), .O(z07));
  ...
  nor3   g52(.a(new_n33_), .b(new_n43_), .c(new_n77_), .O(z09));
