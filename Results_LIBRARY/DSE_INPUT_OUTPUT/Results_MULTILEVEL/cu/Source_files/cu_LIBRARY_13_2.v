...
module FAU ( 
  ...
  nand4  g19(.a(new_n40_), .b(new_n35_), .c(new_n26_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n44_), .c(x05), .d(new_n36_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand4  g24(.a(new_n40_), .b(new_n35_), .c(x01), .d(new_n49_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n44_), .c(x05), .d(new_n36_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nor3   g28(.a(x02), .b(new_n26_), .c(new_n49_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n36_), .d(new_n40_), .O(new_n55_));
  ...
  nand4  g46(.a(new_n71_), .b(new_n58_), .c(new_n57_), .d(new_n35_), .O(new_n72_));
  ...
  nand2  g50(.a(new_n75_), .b(new_n28_), .O(z06));
  nand2  g51(.a(new_n40_), .b(new_n35_), .O(new_n77_));
  nand3  g52(.a(new_n44_), .b(x05), .c(new_n36_), .O(new_n78_));
  oai21  g53(.a(new_n78_), .b(new_n77_), .c(new_n28_), .O(z07));
  nand2  g54(.a(x02), .b(new_n26_), .O(new_n80_));
  nand2  g55(.a(new_n44_), .b(new_n30_), .O(new_n81_));
  nand2  g56(.a(x05), .b(new_n35_), .O(new_n82_));
  nand2  g57(.a(x13), .b(new_n58_), .O(new_n83_));
  oai22  g58(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n80_), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x04), .c(new_n40_), .O(new_n85_));
  inv1   g60(.a(new_n85_), .O(z08));
  inv1   g61(.a(x06), .O(new_n87_));
  nor3   g62(.a(new_n27_), .b(new_n44_), .c(new_n87_), .O(z09));
  oai21  g63(.a(x05), .b(x01), .c(new_n82_), .O(new_n89_));
  nand3  g64(.a(new_n89_), .b(x06), .c(new_n40_), .O(new_n90_));
