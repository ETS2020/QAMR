...
module FAU ( 
  ...
  nor2   g06(.a(x12), .b(x09), .O(new_n32_));
  ...
  nor2   g20(.a(new_n32_), .b(x13), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x02), .O(z07));
  nand2  g23(.a(z07), .b(new_n41_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n40_), .O(z03));
  nand3  g25(.a(new_n29_), .b(x01), .c(new_n40_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n44_), .c(new_n33_), .O(z04));
  nand3  g27(.a(new_n29_), .b(x01), .c(x00), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n44_), .c(new_n33_), .O(z05));
  ...
  nand3  g38(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(x02), .c(new_n64_), .O(new_n65_));
  nand4  g40(.a(new_n43_), .b(x12), .c(new_n30_), .d(x02), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  aoi21  g42(.a(new_n65_), .b(x09), .c(new_n67_), .O(new_n68_));
  nor3   g43(.a(new_n68_), .b(new_n27_), .c(x03), .O(z06));
  nand3  g44(.a(new_n46_), .b(new_n30_), .c(x02), .O(new_n70_));
  nor2   g45(.a(new_n30_), .b(x02), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x13), .c(new_n56_), .d(x09), .O(new_n72_));
