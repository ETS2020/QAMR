...
module FAU ( 
  ...
  aoi21  g27(.a(new_n52_), .b(new_n47_), .c(new_n40_), .O(z04));
  nand4  g28(.a(new_n26_), .b(new_n29_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n47_), .c(x05), .d(new_n27_), .O(new_n56_));
  ...
  aoi21  g43(.a(new_n67_), .b(new_n39_), .c(new_n68_), .O(new_n69_));
