...
module FAU ( 
  ...
  nand3  g27(.a(new_n46_), .b(x05), .c(x04), .O(new_n54_));
  ...
  oai21  g32(.a(new_n58_), .b(new_n54_), .c(new_n27_), .O(new_n59_));
  nand2  g33(.a(new_n59_), .b(x00), .O(new_n60_));
  inv1   g34(.a(x08), .O(new_n61_));
  nand3  g35(.a(new_n61_), .b(new_n27_), .c(new_n26_), .O(new_n62_));
  inv1   g36(.a(x10), .O(new_n63_));
  nand2  g37(.a(new_n63_), .b(x01), .O(new_n64_));
  aoi21  g38(.a(new_n64_), .b(new_n62_), .c(new_n45_), .O(new_n65_));
  nand4  g39(.a(new_n65_), .b(new_n57_), .c(new_n55_), .d(x05), .O(new_n66_));
  nand3  g40(.a(new_n45_), .b(new_n37_), .c(x02), .O(new_n67_));
  oai21  g41(.a(new_n66_), .b(x02), .c(new_n67_), .O(new_n68_));
  nand3  g42(.a(new_n68_), .b(x04), .c(new_n36_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n60_), .O(z06));
  nor2   g44(.a(new_n28_), .b(x13), .O(new_n71_));
  nand4  g45(.a(new_n71_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n72_));
  nor2   g46(.a(new_n72_), .b(x02), .O(z07));
  nand4  g47(.a(x13), .b(new_n57_), .c(x05), .d(new_n31_), .O(new_n74_));
  nand2  g48(.a(new_n74_), .b(new_n67_), .O(new_n75_));
  nand3  g49(.a(new_n75_), .b(x04), .c(new_n36_), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n35_), .O(z08));
  nand3  g51(.a(new_n35_), .b(x13), .c(x06), .O(new_n78_));
  inv1   g52(.a(new_n78_), .O(z09));
  nand2  g53(.a(x05), .b(x02), .O(new_n80_));
  nand3  g54(.a(new_n80_), .b(x06), .c(new_n36_), .O(new_n81_));
  nand2  g55(.a(new_n81_), .b(new_n35_), .O(z10));
  zero   g56(.O(z05));
endmodule
