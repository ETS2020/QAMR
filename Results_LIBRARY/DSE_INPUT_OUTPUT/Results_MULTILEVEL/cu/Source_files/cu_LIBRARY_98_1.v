...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(x05), .c(new_n36_), .d(new_n34_), .O(new_n48_));
  ...
  nand4  g40(.a(new_n47_), .b(new_n30_), .c(new_n26_), .d(x02), .O(new_n66_));
  ...
  nand4  g44(.a(x05), .b(new_n36_), .c(new_n34_), .d(new_n35_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x13), .O(z07));
  nand2  g46(.a(x05), .b(new_n35_), .O(new_n72_));
  nand2  g47(.a(x13), .b(new_n57_), .O(new_n73_));
  nand3  g48(.a(new_n47_), .b(new_n26_), .c(x02), .O(new_n74_));
  ...
  oai21  g54(.a(x08), .b(x05), .c(new_n72_), .O(new_n80_));
