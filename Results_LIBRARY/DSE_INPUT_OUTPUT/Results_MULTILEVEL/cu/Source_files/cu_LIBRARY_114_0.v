...
module FAU ( 
  ...
  nand4  g30(.a(new_n55_), .b(new_n31_), .c(new_n35_), .d(x00), .O(new_n56_));
  ...
  nand4  g43(.a(new_n60_), .b(x06), .c(new_n30_), .d(x02), .O(new_n69_));
  ...
  nand4  g48(.a(new_n73_), .b(x06), .c(x05), .d(new_n27_), .O(new_n74_));
