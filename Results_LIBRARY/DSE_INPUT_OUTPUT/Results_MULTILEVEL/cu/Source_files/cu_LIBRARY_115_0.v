...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n44_, new_n46_, new_n48_, new_n49_, new_n51_, new_n53_,
  ...
  nor2   g06(.a(x12), .b(x10), .O(new_n32_));
  ...
  nand3  g22(.a(new_n29_), .b(x01), .c(new_n46_), .O(new_n48_));
  nand4  g23(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n48_), .c(new_n33_), .O(z04));
  nand3  g25(.a(new_n29_), .b(x01), .c(x00), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n49_), .c(new_n33_), .O(z05));
  ...
  nand3  g33(.a(new_n58_), .b(new_n40_), .c(new_n46_), .O(new_n59_));
  ...
  nand4  g40(.a(x13), .b(new_n54_), .c(x05), .d(new_n29_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n62_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x04), .c(new_n26_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n33_), .O(z08));
  inv1   g44(.a(x06), .O(new_n70_));
  nor3   g45(.a(new_n32_), .b(new_n41_), .c(new_n70_), .O(z09));
  nand2  g46(.a(x05), .b(x02), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n33_), .c(x06), .d(new_n26_), .O(new_n73_));
