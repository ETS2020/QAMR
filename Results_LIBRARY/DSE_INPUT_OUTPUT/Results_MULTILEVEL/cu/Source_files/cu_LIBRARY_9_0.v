...
module FAU ( 
  ...
  nand4  g37(.a(new_n62_), .b(new_n55_), .c(new_n31_), .d(new_n27_), .O(new_n63_));
  ...
  nand3  g43(.a(new_n43_), .b(x05), .c(new_n30_), .O(new_n69_));
  ...
  nand2  g52(.a(new_n71_), .b(new_n33_), .O(new_n78_));
