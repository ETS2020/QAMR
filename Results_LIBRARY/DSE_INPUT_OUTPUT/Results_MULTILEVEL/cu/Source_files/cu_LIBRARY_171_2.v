...
module FAU ( 
  ...
  inv1   g44(.a(new_n33_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x13), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(new_n30_), .c(x02), .O(new_n72_));
  oai21  g47(.a(new_n69_), .b(x02), .c(new_n72_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n26_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z06));
  nand4  g50(.a(new_n71_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(x02), .O(z07));
  nand4  g52(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n78_));
  nand3  g53(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n79_));
  ...
  nor3   g58(.a(new_n70_), .b(new_n43_), .c(new_n83_), .O(z09));
