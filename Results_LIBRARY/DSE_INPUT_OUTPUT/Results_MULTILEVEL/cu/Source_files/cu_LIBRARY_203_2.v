...
module FAU ( 
  ...
  nand2  g25(.a(new_n51_), .b(new_n39_), .O(new_n52_));
  inv1   g26(.a(x09), .O(new_n53_));
  nand2  g27(.a(new_n53_), .b(x00), .O(new_n54_));
  aoi21  g28(.a(new_n54_), .b(new_n52_), .c(new_n40_), .O(new_n55_));
  nand4  g29(.a(new_n55_), .b(new_n50_), .c(new_n49_), .d(x05), .O(new_n56_));
  nor2   g30(.a(new_n56_), .b(new_n27_), .O(new_n57_));
  aoi21  g31(.a(new_n57_), .b(new_n26_), .c(x01), .O(new_n58_));
  nor2   g32(.a(x13), .b(x05), .O(new_n59_));
  nand4  g33(.a(new_n59_), .b(x04), .c(new_n26_), .d(x02), .O(new_n60_));
  oai21  g34(.a(new_n58_), .b(x02), .c(new_n60_), .O(z06));
  nand4  g35(.a(new_n34_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n62_));
  nor2   g36(.a(new_n62_), .b(x13), .O(z07));
  nand2  g37(.a(x04), .b(new_n26_), .O(new_n64_));
  nand3  g38(.a(x13), .b(new_n50_), .c(x05), .O(new_n65_));
  oai21  g39(.a(new_n65_), .b(new_n64_), .c(new_n30_), .O(new_n66_));
  nand2  g40(.a(new_n66_), .b(new_n29_), .O(new_n67_));
  nand2  g41(.a(new_n67_), .b(new_n60_), .O(z08));
  inv1   g42(.a(x06), .O(new_n69_));
  nor3   g43(.a(z04), .b(new_n40_), .c(new_n69_), .O(z09));
  inv1   g44(.a(new_n34_), .O(new_n71_));
  oai21  g45(.a(x05), .b(new_n29_), .c(new_n71_), .O(new_n72_));
  nand3  g46(.a(new_n72_), .b(x06), .c(new_n26_), .O(new_n73_));
