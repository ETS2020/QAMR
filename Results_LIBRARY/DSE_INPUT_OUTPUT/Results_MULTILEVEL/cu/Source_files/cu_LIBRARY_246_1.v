...
module FAU ( 
  ...
  aoi22  g32(.a(new_n57_), .b(new_n40_), .c(new_n56_), .d(x01), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(new_n55_), .c(new_n43_), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(new_n53_), .c(new_n32_), .d(x05), .O(new_n60_));
  nand3  g35(.a(new_n43_), .b(new_n27_), .c(x02), .O(new_n61_));
