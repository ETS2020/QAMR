...
module FAU ( 
  ...
  nand2  g035(.a(x6), .b(new_n26_), .O(new_n50_));
  ...
  nand2  g040(.a(new_n21_), .b(new_n48_), .O(new_n55_));
  nand2  g041(.a(new_n55_), .b(new_n23_), .O(new_n56_));
  nand3  g042(.a(new_n56_), .b(new_n51_), .c(x0), .O(new_n57_));
  nand3  g043(.a(new_n57_), .b(new_n54_), .c(new_n47_), .O(new_n58_));
  nand2  g044(.a(new_n58_), .b(new_n42_), .O(new_n59_));
  nand4  g045(.a(x8), .b(x6), .c(new_n19_), .d(new_n26_), .O(new_n60_));
  ...
  oai21  g050(.a(new_n51_), .b(new_n26_), .c(x1), .O(new_n65_));
  nand3  g051(.a(x8), .b(new_n34_), .c(x4), .O(new_n66_));
  aoi21  g052(.a(new_n66_), .b(new_n44_), .c(x3), .O(new_n67_));
  nor3   g053(.a(new_n20_), .b(new_n34_), .c(x4), .O(new_n68_));
  ...
  nand2  g058(.a(new_n21_), .b(x0), .O(new_n73_));
  nand2  g059(.a(new_n20_), .b(x3), .O(new_n74_));
  aoi21  g060(.a(new_n74_), .b(new_n31_), .c(x2), .O(new_n75_));
  nand2  g061(.a(new_n33_), .b(new_n15_), .O(new_n76_));
  ...
  nand3  g066(.a(new_n20_), .b(new_n43_), .c(x3), .O(new_n81_));
  nand2  g067(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand2  g068(.a(new_n82_), .b(new_n34_), .O(new_n83_));
  nand3  g069(.a(new_n48_), .b(x2), .c(x1), .O(new_n84_));
  nand2  g070(.a(new_n84_), .b(new_n17_), .O(new_n85_));
  nand2  g071(.a(new_n23_), .b(new_n21_), .O(new_n86_));
  ...
  nand2  g075(.a(new_n35_), .b(x2), .O(new_n90_));
  inv1   g076(.a(new_n31_), .O(new_n91_));
  nor2   g077(.a(x8), .b(x5), .O(new_n92_));
  aoi21  g078(.a(new_n92_), .b(x3), .c(new_n91_), .O(new_n93_));
  nand2  g079(.a(new_n79_), .b(x7), .O(new_n94_));
  aoi21  g080(.a(new_n94_), .b(new_n90_), .c(new_n93_), .O(new_n95_));
  nand3  g081(.a(new_n44_), .b(new_n26_), .c(x1), .O(new_n96_));
  nand2  g082(.a(new_n96_), .b(new_n35_), .O(new_n97_));
  nand3  g083(.a(new_n97_), .b(new_n86_), .c(new_n42_), .O(new_n98_));
  ...
  nand3  g088(.a(new_n102_), .b(new_n100_), .c(new_n89_), .O(z2));
  aoi21  g089(.a(new_n96_), .b(new_n35_), .c(new_n91_), .O(new_n104_));
  oai21  g090(.a(new_n104_), .b(new_n33_), .c(x6), .O(new_n105_));
  nand3  g091(.a(new_n35_), .b(new_n74_), .c(new_n27_), .O(new_n106_));
  oai21  g092(.a(new_n37_), .b(x8), .c(new_n19_), .O(new_n107_));
  nor2   g093(.a(new_n20_), .b(new_n34_), .O(new_n108_));
  aoi21  g094(.a(new_n108_), .b(new_n43_), .c(new_n51_), .O(new_n109_));
  nand3  g095(.a(new_n109_), .b(new_n107_), .c(new_n106_), .O(new_n110_));
  nand2  g096(.a(new_n110_), .b(x0), .O(new_n111_));
  oai21  g097(.a(new_n105_), .b(x0), .c(new_n111_), .O(new_n112_));
  nand2  g098(.a(new_n112_), .b(new_n42_), .O(new_n113_));
  nand2  g099(.a(new_n85_), .b(new_n21_), .O(new_n114_));
  nand2  g100(.a(new_n114_), .b(new_n23_), .O(new_n115_));
  nand3  g101(.a(new_n115_), .b(new_n51_), .c(new_n30_), .O(new_n116_));
  nand2  g102(.a(new_n116_), .b(new_n113_), .O(z3));
  aoi21  g103(.a(new_n105_), .b(new_n42_), .c(x0), .O(z4));
endmodule
