...
module FAU ( 
  ...
  nand2  g030(.a(new_n35_), .b(x4), .O(new_n45_));
  nand2  g031(.a(new_n39_), .b(new_n45_), .O(new_n46_));
  ...
  nand2  g036(.a(x6), .b(new_n34_), .O(new_n51_));
  ...
  nand4  g046(.a(x8), .b(x6), .c(new_n21_), .d(new_n34_), .O(new_n61_));
  ...
  oai21  g051(.a(new_n52_), .b(new_n34_), .c(x1), .O(new_n66_));
  nand3  g052(.a(x8), .b(new_n35_), .c(x4), .O(new_n67_));
  aoi21  g053(.a(new_n67_), .b(new_n39_), .c(x3), .O(new_n68_));
  ...
  nand2  g059(.a(new_n23_), .b(new_n16_), .O(new_n74_));
  aoi21  g060(.a(new_n32_), .b(new_n29_), .c(x2), .O(new_n75_));
  nand3  g061(.a(new_n22_), .b(x3), .c(new_n17_), .O(new_n76_));
  ...
  inv1   g075(.a(new_n29_), .O(new_n90_));
  aoi21  g076(.a(new_n33_), .b(x0), .c(new_n90_), .O(new_n91_));
  aoi21  g077(.a(new_n79_), .b(x7), .c(new_n36_), .O(new_n92_));
  nand3  g078(.a(new_n39_), .b(new_n34_), .c(x1), .O(new_n93_));
  nand2  g079(.a(new_n93_), .b(new_n45_), .O(new_n94_));
  nand3  g080(.a(new_n94_), .b(new_n86_), .c(x0), .O(new_n95_));
  oai21  g081(.a(new_n92_), .b(new_n91_), .c(new_n95_), .O(new_n96_));
  nand2  g082(.a(new_n96_), .b(x6), .O(new_n97_));
  nor2   g083(.a(new_n91_), .b(x4), .O(new_n98_));
  aoi22  g084(.a(new_n98_), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(new_n99_));
  nand3  g085(.a(new_n99_), .b(new_n97_), .c(new_n89_), .O(z2));
  aoi21  g086(.a(x7), .b(x4), .c(x2), .O(new_n101_));
  aoi21  g087(.a(x4), .b(x1), .c(x7), .O(new_n102_));
  oai21  g088(.a(new_n102_), .b(new_n101_), .c(new_n25_), .O(new_n103_));
  oai21  g089(.a(x4), .b(x1), .c(x3), .O(new_n104_));
  aoi21  g090(.a(new_n104_), .b(new_n22_), .c(new_n16_), .O(new_n105_));
  aoi21  g091(.a(new_n105_), .b(new_n103_), .c(new_n15_), .O(new_n106_));
  nand2  g092(.a(new_n85_), .b(new_n23_), .O(new_n107_));
  aoi21  g093(.a(new_n107_), .b(new_n25_), .c(new_n16_), .O(new_n108_));
  aoi21  g094(.a(new_n108_), .b(new_n15_), .c(new_n106_), .O(new_n109_));
  oai21  g095(.a(new_n35_), .b(new_n52_), .c(x4), .O(new_n110_));
  nand2  g096(.a(new_n110_), .b(new_n17_), .O(new_n111_));
  oai21  g097(.a(new_n35_), .b(x4), .c(new_n22_), .O(new_n112_));
  oai21  g098(.a(new_n112_), .b(new_n36_), .c(x6), .O(new_n113_));
  aoi21  g099(.a(new_n113_), .b(new_n111_), .c(x3), .O(new_n114_));
  aoi22  g100(.a(new_n35_), .b(x4), .c(new_n34_), .d(x1), .O(new_n115_));
  oai21  g101(.a(new_n115_), .b(new_n40_), .c(x8), .O(new_n116_));
  nor2   g102(.a(new_n116_), .b(new_n52_), .O(new_n117_));
  oai21  g103(.a(new_n117_), .b(new_n114_), .c(x0), .O(new_n118_));
  oai21  g104(.a(new_n109_), .b(x6), .c(new_n118_), .O(z3));
  nand3  g105(.a(new_n64_), .b(new_n25_), .c(new_n19_), .O(new_n120_));
  oai21  g106(.a(new_n18_), .b(new_n22_), .c(new_n21_), .O(new_n121_));
  nand3  g107(.a(new_n22_), .b(new_n35_), .c(new_n38_), .O(new_n122_));
