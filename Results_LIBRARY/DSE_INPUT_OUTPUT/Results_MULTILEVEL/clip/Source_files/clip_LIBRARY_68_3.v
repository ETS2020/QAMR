...
module FAU ( 
  ...
  inv1   g60(.a(new_n57_), .O(new_n75_));
  inv1   g61(.a(new_n56_), .O(new_n76_));
  ...
  and2   g84(.a(new_n78_), .b(new_n15_), .O(new_n99_));
  nand4  g85(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n16_), .O(new_n100_));
