...
module FAU ( 
  ...
  and2   g103(.a(new_n114_), .b(new_n37_), .O(new_n118_));
  nand3  g104(.a(new_n74_), .b(new_n53_), .c(new_n40_), .O(new_n119_));
  nand2  g105(.a(new_n101_), .b(new_n27_), .O(new_n120_));
  nand3  g106(.a(new_n22_), .b(new_n30_), .c(new_n33_), .O(new_n121_));
  nand4  g107(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n43_), .O(new_n122_));
