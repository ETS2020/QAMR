...
module FAU ( 
  ...
  oai21  g031(.a(new_n45_), .b(new_n34_), .c(new_n44_), .O(new_n46_));
  inv1   g032(.a(new_n35_), .O(new_n47_));
  nand2  g033(.a(new_n36_), .b(new_n47_), .O(new_n48_));
  ...
  nand2  g039(.a(new_n38_), .b(new_n47_), .O(new_n54_));
  nand2  g040(.a(new_n54_), .b(new_n40_), .O(new_n55_));
  nand3  g041(.a(new_n55_), .b(new_n50_), .c(new_n33_), .O(new_n56_));
  ...
  nand3  g050(.a(x8), .b(new_n26_), .c(x4), .O(new_n65_));
  aoi21  g051(.a(new_n65_), .b(new_n30_), .c(x3), .O(new_n66_));
  nor3   g052(.a(new_n24_), .b(new_n26_), .c(x4), .O(new_n67_));
  ...
  nand2  g057(.a(new_n38_), .b(new_n33_), .O(new_n72_));
  aoi21  g058(.a(new_n25_), .b(new_n21_), .c(x2), .O(new_n73_));
  nor2   g059(.a(x8), .b(new_n20_), .O(new_n74_));
  nand2  g060(.a(new_n74_), .b(new_n34_), .O(new_n75_));
  inv1   g061(.a(new_n75_), .O(new_n76_));
  oai21  g062(.a(new_n76_), .b(new_n73_), .c(new_n36_), .O(new_n77_));
  nand2  g063(.a(x4), .b(x1), .O(new_n78_));
  nand3  g064(.a(new_n78_), .b(x8), .c(new_n20_), .O(new_n79_));
  nand3  g065(.a(new_n24_), .b(new_n29_), .c(x3), .O(new_n80_));
  ...
  oai21  g069(.a(new_n83_), .b(new_n34_), .c(new_n36_), .O(new_n84_));
  nand2  g070(.a(new_n40_), .b(new_n38_), .O(new_n85_));
  nand2  g071(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand4  g072(.a(new_n86_), .b(new_n82_), .c(new_n77_), .d(new_n72_), .O(new_n87_));
  nand2  g073(.a(new_n87_), .b(new_n50_), .O(new_n88_));
  inv1   g074(.a(new_n21_), .O(new_n89_));
  aoi21  g075(.a(new_n74_), .b(x0), .c(new_n89_), .O(new_n90_));
  nand2  g076(.a(new_n78_), .b(x7), .O(new_n91_));
  aoi21  g077(.a(new_n91_), .b(new_n28_), .c(new_n90_), .O(new_n92_));
  nand3  g078(.a(new_n30_), .b(new_n15_), .c(x1), .O(new_n93_));
  nand2  g079(.a(new_n93_), .b(new_n27_), .O(new_n94_));
  nand3  g080(.a(new_n94_), .b(new_n85_), .c(x0), .O(new_n95_));
  inv1   g081(.a(new_n95_), .O(new_n96_));
  oai21  g082(.a(new_n96_), .b(new_n92_), .c(x6), .O(new_n97_));
  nor2   g083(.a(new_n90_), .b(x4), .O(new_n98_));
  aoi22  g084(.a(new_n98_), .b(new_n34_), .c(new_n33_), .d(new_n19_), .O(new_n99_));
  nand3  g085(.a(new_n99_), .b(new_n97_), .c(new_n88_), .O(z2));
  inv1   g086(.a(new_n40_), .O(new_n101_));
  aoi21  g087(.a(new_n84_), .b(new_n38_), .c(new_n101_), .O(new_n102_));
  nand3  g088(.a(new_n62_), .b(new_n40_), .c(new_n36_), .O(new_n103_));
  oai21  g089(.a(x7), .b(x4), .c(x8), .O(new_n104_));
  nand2  g090(.a(new_n104_), .b(new_n20_), .O(new_n105_));
  nand3  g091(.a(new_n24_), .b(new_n26_), .c(new_n29_), .O(new_n106_));
  ...
  nor2   g095(.a(x5), .b(new_n19_), .O(new_n110_));
  aoi21  g096(.a(new_n109_), .b(x5), .c(new_n110_), .O(new_n111_));
  nand3  g097(.a(new_n27_), .b(new_n25_), .c(new_n17_), .O(new_n112_));
  nand2  g098(.a(new_n30_), .b(new_n24_), .O(new_n113_));
  aoi21  g099(.a(new_n113_), .b(new_n20_), .c(new_n67_), .O(new_n114_));
  ...
  oai21  g104(.a(new_n118_), .b(new_n33_), .c(x0), .O(z4));
endmodule
