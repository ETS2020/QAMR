...
module FAU ( 
  ...
  aoi21  g067(.a(new_n81_), .b(new_n37_), .c(new_n17_), .O(new_n82_));
  oai21  g068(.a(new_n25_), .b(new_n15_), .c(new_n30_), .O(new_n83_));
  ...
  aoi21  g072(.a(new_n30_), .b(new_n25_), .c(x2), .O(new_n87_));
  nand3  g073(.a(new_n24_), .b(x3), .c(new_n48_), .O(new_n88_));
  inv1   g074(.a(new_n88_), .O(new_n89_));
  oai21  g075(.a(new_n89_), .b(new_n87_), .c(new_n45_), .O(new_n90_));
  nand2  g076(.a(x4), .b(x1), .O(new_n91_));
  nand3  g077(.a(new_n91_), .b(x8), .c(new_n29_), .O(new_n92_));
  nand3  g078(.a(new_n24_), .b(new_n36_), .c(x3), .O(new_n93_));
  nand2  g079(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g080(.a(new_n94_), .b(new_n26_), .O(new_n95_));
  nand3  g081(.a(new_n44_), .b(x2), .c(x1), .O(new_n96_));
  nand2  g082(.a(new_n96_), .b(new_n45_), .O(new_n97_));
  nand2  g083(.a(new_n20_), .b(new_n85_), .O(new_n98_));
  ...
  nand3  g087(.a(new_n37_), .b(new_n35_), .c(x1), .O(new_n102_));
  aoi21  g088(.a(new_n102_), .b(new_n27_), .c(new_n15_), .O(new_n103_));
  nand3  g089(.a(new_n26_), .b(new_n16_), .c(x4), .O(new_n104_));
  inv1   g090(.a(new_n104_), .O(new_n105_));
  oai21  g091(.a(new_n105_), .b(new_n103_), .c(new_n98_), .O(new_n106_));
  nand4  g092(.a(new_n27_), .b(new_n24_), .c(new_n16_), .d(x3), .O(new_n107_));
  nand2  g093(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g094(.a(new_n108_), .b(x6), .O(new_n109_));
  nand2  g095(.a(new_n16_), .b(new_n35_), .O(new_n110_));
  nand4  g096(.a(new_n110_), .b(new_n109_), .c(new_n101_), .d(new_n84_), .O(z2));
  aoi21  g097(.a(new_n45_), .b(new_n24_), .c(new_n29_), .O(new_n112_));
  ...
  nand2  g102(.a(new_n45_), .b(new_n35_), .O(new_n117_));
  nand2  g103(.a(new_n91_), .b(new_n26_), .O(new_n118_));
  aoi21  g104(.a(new_n118_), .b(new_n117_), .c(new_n116_), .O(new_n119_));
  nand2  g105(.a(new_n36_), .b(new_n48_), .O(new_n120_));
  aoi21  g106(.a(new_n120_), .b(x3), .c(x8), .O(new_n121_));
  oai21  g107(.a(new_n121_), .b(new_n119_), .c(x0), .O(new_n122_));
  aoi21  g108(.a(new_n122_), .b(new_n115_), .c(new_n16_), .O(new_n123_));
  oai21  g109(.a(x7), .b(x4), .c(x1), .O(new_n124_));
  aoi21  g110(.a(new_n124_), .b(new_n45_), .c(new_n18_), .O(new_n125_));
  oai21  g111(.a(new_n125_), .b(new_n116_), .c(new_n15_), .O(new_n126_));
  nand2  g112(.a(new_n16_), .b(x0), .O(new_n127_));
  aoi21  g113(.a(new_n127_), .b(new_n126_), .c(new_n35_), .O(new_n128_));
  oai21  g114(.a(new_n128_), .b(new_n123_), .c(new_n17_), .O(new_n129_));
  aoi21  g115(.a(new_n26_), .b(x4), .c(new_n24_), .O(new_n130_));
  nand3  g116(.a(new_n24_), .b(new_n26_), .c(x4), .O(new_n131_));
  oai21  g117(.a(new_n130_), .b(new_n29_), .c(new_n131_), .O(new_n132_));
  nand3  g118(.a(new_n132_), .b(new_n16_), .c(new_n15_), .O(new_n133_));
  nand2  g119(.a(new_n30_), .b(new_n28_), .O(new_n134_));
  nand2  g120(.a(new_n134_), .b(x0), .O(new_n135_));
  aoi21  g121(.a(new_n135_), .b(new_n133_), .c(new_n35_), .O(new_n136_));
  aoi21  g122(.a(new_n36_), .b(new_n48_), .c(new_n29_), .O(new_n137_));
  nand3  g123(.a(new_n91_), .b(new_n25_), .c(x7), .O(new_n138_));
  ...
  oai21  g127(.a(new_n141_), .b(new_n136_), .c(x6), .O(new_n142_));
  nor2   g128(.a(x1), .b(new_n15_), .O(new_n143_));
  nand4  g129(.a(new_n143_), .b(x5), .c(new_n36_), .d(new_n29_), .O(new_n144_));
  nand3  g130(.a(new_n144_), .b(new_n142_), .c(new_n129_), .O(z3));
  nand3  g131(.a(new_n132_), .b(x6), .c(x2), .O(new_n146_));
  ...
  nand3  g135(.a(new_n149_), .b(new_n45_), .c(new_n20_), .O(new_n150_));
  oai21  g136(.a(new_n19_), .b(new_n24_), .c(new_n29_), .O(new_n151_));
  nand3  g137(.a(new_n24_), .b(new_n26_), .c(new_n36_), .O(new_n152_));
  nand4  g138(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n17_), .O(new_n153_));
  nand2  g139(.a(new_n153_), .b(x5), .O(new_n154_));
  nand2  g140(.a(new_n154_), .b(new_n148_), .O(z4));
endmodule
