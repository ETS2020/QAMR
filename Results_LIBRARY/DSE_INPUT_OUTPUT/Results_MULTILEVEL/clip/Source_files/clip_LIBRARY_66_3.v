...
module FAU ( 
  ...
  oai21  g030(.a(new_n44_), .b(new_n32_), .c(new_n43_), .O(new_n45_));
  inv1   g031(.a(new_n33_), .O(new_n46_));
  nand2  g032(.a(new_n34_), .b(new_n46_), .O(new_n47_));
  ...
  nand2  g038(.a(new_n36_), .b(new_n46_), .O(new_n53_));
  nand2  g039(.a(new_n53_), .b(new_n38_), .O(new_n54_));
  nand3  g040(.a(new_n54_), .b(new_n49_), .c(x0), .O(new_n55_));
  nand3  g041(.a(new_n55_), .b(new_n52_), .c(new_n45_), .O(new_n56_));
  ...
  nand2  g045(.a(new_n59_), .b(new_n50_), .O(new_n60_));
  nand3  g046(.a(new_n60_), .b(new_n47_), .c(x1), .O(new_n61_));
  nand2  g047(.a(x2), .b(x1), .O(new_n62_));
  nand3  g048(.a(new_n62_), .b(new_n43_), .c(new_n49_), .O(new_n63_));
  oai21  g049(.a(new_n49_), .b(new_n15_), .c(x1), .O(new_n64_));
  nand3  g050(.a(x8), .b(new_n25_), .c(x4), .O(new_n65_));
  aoi21  g051(.a(new_n65_), .b(new_n29_), .c(x3), .O(new_n66_));
  nor3   g052(.a(new_n23_), .b(new_n25_), .c(x4), .O(new_n67_));
  ...
  nand2  g057(.a(new_n36_), .b(x0), .O(new_n72_));
  aoi21  g058(.a(new_n24_), .b(new_n20_), .c(x2), .O(new_n73_));
  nor2   g059(.a(x8), .b(new_n19_), .O(new_n74_));
  nand2  g060(.a(new_n74_), .b(new_n32_), .O(new_n75_));
  inv1   g061(.a(new_n75_), .O(new_n76_));
  oai21  g062(.a(new_n76_), .b(new_n73_), .c(new_n34_), .O(new_n77_));
  nand2  g063(.a(x4), .b(x1), .O(new_n78_));
  nand3  g064(.a(new_n78_), .b(x8), .c(new_n19_), .O(new_n79_));
  nand3  g065(.a(new_n23_), .b(new_n28_), .c(x3), .O(new_n80_));
  nand2  g066(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g067(.a(new_n81_), .b(new_n25_), .O(new_n82_));
  nand3  g068(.a(new_n46_), .b(x2), .c(x1), .O(new_n83_));
  nand2  g069(.a(new_n83_), .b(new_n34_), .O(new_n84_));
  nand2  g070(.a(new_n38_), .b(new_n36_), .O(new_n85_));
  nand2  g071(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand4  g072(.a(new_n86_), .b(new_n82_), .c(new_n77_), .d(new_n72_), .O(new_n87_));
  nand2  g073(.a(new_n87_), .b(new_n49_), .O(new_n88_));
  inv1   g074(.a(new_n20_), .O(new_n89_));
  nor2   g075(.a(x8), .b(x5), .O(new_n90_));
  aoi21  g076(.a(new_n90_), .b(x3), .c(new_n89_), .O(new_n91_));
  nand2  g077(.a(new_n78_), .b(x7), .O(new_n92_));
  aoi21  g078(.a(new_n92_), .b(new_n27_), .c(new_n91_), .O(new_n93_));
  nand3  g079(.a(new_n29_), .b(new_n15_), .c(x1), .O(new_n94_));
  nand2  g080(.a(new_n94_), .b(new_n26_), .O(new_n95_));
  nand3  g081(.a(new_n95_), .b(new_n85_), .c(new_n42_), .O(new_n96_));
  inv1   g082(.a(new_n96_), .O(new_n97_));
  oai21  g083(.a(new_n97_), .b(new_n93_), .c(x6), .O(new_n98_));
  nor2   g084(.a(new_n91_), .b(x4), .O(new_n99_));
  aoi22  g085(.a(new_n99_), .b(new_n32_), .c(x5), .d(x0), .O(new_n100_));
  nand3  g086(.a(new_n100_), .b(new_n98_), .c(new_n88_), .O(z2));
  aoi21  g087(.a(new_n94_), .b(new_n26_), .c(new_n89_), .O(new_n102_));
  oai21  g088(.a(new_n102_), .b(new_n74_), .c(x6), .O(new_n103_));
  ...
  nor2   g092(.a(new_n23_), .b(new_n25_), .O(new_n107_));
  aoi21  g093(.a(new_n107_), .b(new_n28_), .c(new_n49_), .O(new_n108_));
  nand3  g094(.a(new_n108_), .b(new_n106_), .c(new_n104_), .O(new_n109_));
  nand2  g095(.a(new_n109_), .b(x0), .O(new_n110_));
  oai21  g096(.a(new_n103_), .b(x0), .c(new_n110_), .O(new_n111_));
  nand2  g097(.a(new_n111_), .b(new_n42_), .O(new_n112_));
  nand2  g098(.a(new_n84_), .b(new_n36_), .O(new_n113_));
  nand2  g099(.a(new_n113_), .b(new_n38_), .O(new_n114_));
  nand3  g100(.a(new_n114_), .b(new_n49_), .c(new_n58_), .O(new_n115_));
  nand2  g101(.a(new_n115_), .b(new_n112_), .O(z3));
  aoi21  g102(.a(new_n103_), .b(new_n42_), .c(x0), .O(z4));
endmodule
