...
module FAU ( 
  ...
  nand2  g030(.a(new_n28_), .b(new_n36_), .O(new_n45_));
  ...
  aoi21  g035(.a(new_n49_), .b(new_n47_), .c(new_n19_), .O(new_n50_));
  nand2  g036(.a(new_n48_), .b(new_n15_), .O(new_n51_));
  nand2  g037(.a(new_n26_), .b(new_n36_), .O(new_n52_));
  nand2  g038(.a(new_n52_), .b(x3), .O(new_n53_));
  oai21  g039(.a(new_n26_), .b(new_n36_), .c(new_n53_), .O(new_n54_));
  ...
  oai21  g069(.a(new_n83_), .b(new_n80_), .c(new_n44_), .O(new_n84_));
  nand2  g070(.a(x4), .b(x1), .O(new_n85_));
  nand3  g071(.a(new_n85_), .b(x8), .c(new_n20_), .O(new_n86_));
  oai21  g072(.a(new_n52_), .b(new_n20_), .c(new_n86_), .O(new_n87_));
  nand2  g073(.a(new_n87_), .b(new_n28_), .O(new_n88_));
  nand3  g074(.a(new_n45_), .b(x2), .c(x1), .O(new_n89_));
  nand2  g075(.a(new_n89_), .b(new_n44_), .O(new_n90_));
  ...
  aoi21  g093(.a(new_n26_), .b(new_n20_), .c(new_n107_), .O(new_n108_));
  nand4  g094(.a(new_n108_), .b(x5), .c(x2), .d(x1), .O(new_n109_));
  aoi21  g095(.a(new_n109_), .b(new_n106_), .c(x0), .O(new_n110_));
  nand2  g096(.a(new_n44_), .b(new_n17_), .O(new_n111_));
  aoi21  g097(.a(new_n111_), .b(new_n45_), .c(new_n18_), .O(new_n112_));
  nor2   g098(.a(x7), .b(x1), .O(new_n113_));
  oai21  g099(.a(new_n113_), .b(new_n112_), .c(new_n91_), .O(new_n114_));
  nand2  g100(.a(new_n52_), .b(x5), .O(new_n115_));
  nor2   g101(.a(x8), .b(new_n18_), .O(new_n116_));
  aoi22  g102(.a(new_n116_), .b(new_n20_), .c(new_n115_), .d(new_n15_), .O(new_n117_));
  aoi21  g103(.a(new_n117_), .b(new_n114_), .c(new_n16_), .O(new_n118_));
  oai21  g104(.a(new_n118_), .b(new_n110_), .c(new_n19_), .O(new_n119_));
  aoi21  g105(.a(new_n28_), .b(x4), .c(new_n26_), .O(new_n120_));
  nor2   g106(.a(x8), .b(x7), .O(new_n121_));
  nand2  g107(.a(new_n121_), .b(x4), .O(new_n122_));
  oai21  g108(.a(new_n120_), .b(new_n20_), .c(new_n122_), .O(new_n123_));
  nand3  g109(.a(new_n123_), .b(new_n18_), .c(new_n16_), .O(new_n124_));
  nor2   g110(.a(new_n121_), .b(x3), .O(new_n125_));
  oai21  g111(.a(new_n125_), .b(new_n120_), .c(x0), .O(new_n126_));
  aoi21  g112(.a(new_n126_), .b(new_n124_), .c(x1), .O(new_n127_));
  aoi21  g113(.a(new_n74_), .b(new_n37_), .c(new_n81_), .O(new_n128_));
  oai21  g114(.a(new_n128_), .b(new_n32_), .c(x5), .O(new_n129_));
  nor2   g115(.a(new_n129_), .b(new_n16_), .O(new_n130_));
  oai21  g116(.a(new_n130_), .b(new_n127_), .c(x6), .O(new_n131_));
  nand4  g117(.a(new_n36_), .b(new_n20_), .c(new_n15_), .d(x0), .O(new_n132_));
  nand3  g118(.a(new_n132_), .b(new_n131_), .c(new_n119_), .O(z3));
  aoi21  g119(.a(new_n123_), .b(x6), .c(x5), .O(new_n134_));
  inv1   g120(.a(new_n104_), .O(new_n135_));
  nand3  g121(.a(new_n91_), .b(new_n62_), .c(new_n44_), .O(new_n136_));
  oai21  g122(.a(new_n107_), .b(new_n26_), .c(new_n20_), .O(new_n137_));
  aoi21  g123(.a(new_n121_), .b(new_n36_), .c(x6), .O(new_n138_));
