...
module FAU ( 
  ...
  inv1   g31(.a(new_n26_), .O(new_n46_));
  nor2   g32(.a(new_n25_), .b(x4), .O(new_n47_));
  oai22  g33(.a(new_n47_), .b(new_n46_), .c(new_n15_), .d(new_n32_), .O(new_n48_));
  ...
  nand2  g42(.a(new_n46_), .b(x2), .O(new_n57_));
  aoi21  g43(.a(new_n57_), .b(new_n56_), .c(new_n42_), .O(new_n58_));
  nand2  g44(.a(new_n46_), .b(new_n32_), .O(new_n59_));
  ...
  nand4  g49(.a(new_n63_), .b(new_n62_), .c(x7), .d(new_n28_), .O(new_n64_));
  ...
  nor2   g54(.a(x8), .b(new_n19_), .O(new_n69_));
  nand2  g55(.a(new_n69_), .b(new_n32_), .O(new_n70_));
  inv1   g56(.a(new_n70_), .O(new_n71_));
  oai21  g57(.a(new_n71_), .b(new_n68_), .c(new_n34_), .O(new_n72_));
  nand2  g58(.a(x4), .b(x1), .O(new_n73_));
  nand3  g59(.a(new_n73_), .b(x8), .c(new_n19_), .O(new_n74_));
  nand3  g60(.a(new_n23_), .b(new_n28_), .c(x3), .O(new_n75_));
  nand2  g61(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g62(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  nand3  g63(.a(new_n43_), .b(x2), .c(x1), .O(new_n78_));
  nand2  g64(.a(new_n78_), .b(new_n34_), .O(new_n79_));
  nand2  g65(.a(new_n38_), .b(new_n36_), .O(new_n80_));
  ...
  nand2  g71(.a(new_n73_), .b(x7), .O(new_n86_));
  aoi21  g72(.a(new_n86_), .b(new_n27_), .c(new_n85_), .O(new_n87_));
  nand3  g73(.a(new_n29_), .b(new_n15_), .c(x1), .O(new_n88_));
  nand2  g74(.a(new_n88_), .b(new_n26_), .O(new_n89_));
  nand3  g75(.a(new_n89_), .b(new_n80_), .c(new_n54_), .O(new_n90_));
  inv1   g76(.a(new_n90_), .O(new_n91_));
  oai21  g77(.a(new_n91_), .b(new_n87_), .c(x6), .O(new_n92_));
  nor2   g78(.a(new_n85_), .b(x4), .O(new_n93_));
  nand2  g79(.a(new_n93_), .b(new_n32_), .O(new_n94_));
  nand4  g80(.a(new_n94_), .b(new_n92_), .c(new_n83_), .d(new_n65_), .O(z2));
  aoi21  g81(.a(new_n88_), .b(new_n26_), .c(new_n55_), .O(new_n96_));
  oai21  g82(.a(new_n96_), .b(new_n69_), .c(x6), .O(new_n97_));
  nand3  g83(.a(new_n26_), .b(new_n24_), .c(new_n17_), .O(new_n98_));
  oai21  g84(.a(new_n47_), .b(x8), .c(new_n19_), .O(new_n99_));
  nor2   g85(.a(new_n23_), .b(new_n25_), .O(new_n100_));
  aoi21  g86(.a(new_n100_), .b(new_n28_), .c(new_n42_), .O(new_n101_));
  ...
  nand2  g90(.a(new_n104_), .b(new_n54_), .O(new_n105_));
  inv1   g91(.a(x0), .O(new_n106_));
  nand2  g92(.a(new_n79_), .b(new_n36_), .O(new_n107_));
  nand2  g93(.a(new_n107_), .b(new_n38_), .O(new_n108_));
  nand3  g94(.a(new_n108_), .b(new_n42_), .c(new_n106_), .O(new_n109_));
  nand2  g95(.a(new_n109_), .b(new_n105_), .O(z3));
  aoi21  g96(.a(new_n97_), .b(new_n54_), .c(x0), .O(z4));
endmodule
