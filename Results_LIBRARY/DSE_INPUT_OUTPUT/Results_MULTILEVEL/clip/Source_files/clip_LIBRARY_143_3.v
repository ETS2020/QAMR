...
module FAU ( 
  ...
  inv1   g33(.a(new_n27_), .O(new_n48_));
  ...
  nand3  g84(.a(new_n46_), .b(new_n24_), .c(new_n17_), .O(new_n99_));
  oai21  g85(.a(new_n48_), .b(x8), .c(new_n67_), .O(new_n100_));
  nand3  g86(.a(x8), .b(x7), .c(new_n25_), .O(new_n101_));
  nor2   g87(.a(new_n41_), .b(x5), .O(new_n102_));
  nand4  g88(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n99_), .O(new_n103_));
  nand2  g89(.a(new_n103_), .b(x0), .O(new_n104_));
  nand2  g90(.a(new_n69_), .b(new_n35_), .O(new_n105_));
  nand2  g91(.a(new_n105_), .b(new_n37_), .O(new_n106_));
  nand2  g92(.a(new_n106_), .b(new_n41_), .O(new_n107_));
  nand2  g93(.a(new_n73_), .b(new_n21_), .O(new_n108_));
  nand2  g94(.a(new_n108_), .b(new_n24_), .O(new_n109_));
  nand4  g95(.a(new_n109_), .b(x6), .c(new_n54_), .d(new_n82_), .O(new_n110_));
  nand3  g96(.a(new_n110_), .b(new_n107_), .c(new_n104_), .O(z3));
  nand3  g97(.a(new_n109_), .b(x6), .c(new_n82_), .O(new_n112_));
  nand2  g98(.a(new_n112_), .b(new_n54_), .O(z4));
endmodule
