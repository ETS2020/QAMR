...
module FAU ( 
  ...
  aoi21  g035(.a(x6), .b(x2), .c(new_n15_), .O(new_n50_));
  xor2a  g036(.a(x5), .b(x0), .O(new_n51_));
  or2    g037(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  ...
  aoi21  g045(.a(new_n59_), .b(new_n58_), .c(new_n50_), .O(new_n60_));
  aoi21  g046(.a(new_n60_), .b(new_n20_), .c(new_n55_), .O(new_n61_));
  nand2  g047(.a(new_n61_), .b(new_n49_), .O(z1));
  nand2  g048(.a(x7), .b(x6), .O(new_n63_));
  aoi21  g049(.a(new_n63_), .b(x4), .c(x1), .O(new_n64_));
  aoi21  g050(.a(new_n34_), .b(new_n32_), .c(new_n43_), .O(new_n65_));
  nand3  g051(.a(new_n21_), .b(new_n22_), .c(x3), .O(new_n66_));
  nand2  g052(.a(new_n66_), .b(new_n24_), .O(new_n67_));
  oai21  g053(.a(new_n65_), .b(new_n64_), .c(new_n67_), .O(new_n68_));
  oai21  g054(.a(new_n28_), .b(new_n23_), .c(new_n17_), .O(new_n69_));
  oai21  g055(.a(new_n29_), .b(x1), .c(new_n69_), .O(new_n70_));
  nand2  g056(.a(new_n70_), .b(new_n40_), .O(new_n71_));
  nand2  g057(.a(x4), .b(x1), .O(new_n72_));
  nand3  g058(.a(new_n72_), .b(x8), .c(new_n27_), .O(new_n73_));
  nand3  g059(.a(new_n22_), .b(new_n33_), .c(x3), .O(new_n74_));
  nand2  g060(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g061(.a(new_n75_), .b(new_n30_), .O(new_n76_));
  oai21  g062(.a(x7), .b(x4), .c(x2), .O(new_n77_));
  oai21  g063(.a(new_n77_), .b(new_n15_), .c(new_n40_), .O(new_n78_));
  nand2  g064(.a(x8), .b(x3), .O(new_n79_));
  nand2  g065(.a(new_n22_), .b(new_n27_), .O(new_n80_));
  ...
  nand3  g071(.a(new_n34_), .b(new_n17_), .c(x1), .O(new_n86_));
  nand2  g072(.a(new_n81_), .b(new_n21_), .O(new_n87_));
  aoi21  g073(.a(new_n86_), .b(new_n31_), .c(new_n87_), .O(new_n88_));
  aoi21  g074(.a(new_n88_), .b(x6), .c(new_n85_), .O(new_n89_));
  nand3  g075(.a(new_n89_), .b(new_n84_), .c(new_n68_), .O(z2));
  nand2  g076(.a(new_n72_), .b(x7), .O(new_n91_));
  aoi21  g077(.a(new_n91_), .b(new_n32_), .c(new_n28_), .O(new_n92_));
  nand2  g078(.a(new_n33_), .b(new_n15_), .O(new_n93_));
  aoi21  g079(.a(new_n93_), .b(x3), .c(new_n22_), .O(new_n94_));
  ...
  oai21  g085(.a(new_n99_), .b(new_n98_), .c(new_n43_), .O(new_n100_));
  nand2  g086(.a(new_n100_), .b(new_n97_), .O(new_n101_));
  nand2  g087(.a(new_n101_), .b(new_n27_), .O(new_n102_));
  nand2  g088(.a(new_n53_), .b(new_n40_), .O(new_n103_));
  nand2  g089(.a(new_n103_), .b(new_n41_), .O(new_n104_));
  nand3  g090(.a(new_n104_), .b(new_n22_), .c(new_n43_), .O(new_n105_));
  ...
  nand2  g095(.a(new_n109_), .b(new_n43_), .O(new_n110_));
  aoi21  g096(.a(new_n86_), .b(new_n31_), .c(new_n23_), .O(new_n111_));
  ...
  nand3  g102(.a(new_n79_), .b(new_n53_), .c(new_n40_), .O(new_n117_));
  nand2  g103(.a(new_n99_), .b(new_n27_), .O(new_n118_));
  nand3  g104(.a(new_n22_), .b(new_n30_), .c(new_n33_), .O(new_n119_));
  nand4  g105(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n43_), .O(new_n120_));
