...
module FAU ( 
  ...
  nand3  g072(.a(new_n44_), .b(new_n27_), .c(x1), .O(new_n87_));
  ...
  aoi21  g078(.a(new_n16_), .b(x4), .c(new_n20_), .O(new_n93_));
  nand2  g079(.a(new_n44_), .b(x6), .O(new_n94_));
  oai21  g080(.a(new_n94_), .b(new_n93_), .c(new_n15_), .O(new_n95_));
  nand2  g081(.a(new_n83_), .b(new_n30_), .O(new_n96_));
  aoi21  g082(.a(new_n96_), .b(new_n95_), .c(x8), .O(new_n97_));
  nand2  g083(.a(new_n44_), .b(x3), .O(new_n98_));
  ...
  nor2   g087(.a(x8), .b(new_n15_), .O(new_n102_));
  ...
  oai21  g094(.a(new_n65_), .b(x3), .c(new_n88_), .O(new_n109_));
  nand2  g095(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g096(.a(new_n110_), .b(x6), .c(new_n36_), .d(new_n25_), .O(new_n111_));
  nand3  g097(.a(new_n111_), .b(new_n107_), .c(new_n101_), .O(z3));
  inv1   g098(.a(new_n82_), .O(new_n113_));
  nor2   g099(.a(new_n15_), .b(new_n25_), .O(new_n114_));
  nand4  g100(.a(new_n114_), .b(new_n32_), .c(new_n65_), .d(new_n30_), .O(new_n115_));
  oai21  g101(.a(new_n115_), .b(new_n113_), .c(x5), .O(new_n116_));
  nand3  g102(.a(new_n110_), .b(x6), .c(new_n25_), .O(new_n117_));
