...
module FAU ( 
  ...
  nand3  g43(.a(new_n57_), .b(new_n27_), .c(x6), .O(new_n58_));
  nand3  g44(.a(new_n58_), .b(new_n52_), .c(new_n47_), .O(z1));
  inv1   g45(.a(x5), .O(new_n60_));
  nand3  g46(.a(x6), .b(new_n60_), .c(x2), .O(new_n61_));
  oai21  g47(.a(new_n18_), .b(new_n19_), .c(new_n61_), .O(new_n62_));
  nand3  g48(.a(new_n62_), .b(new_n25_), .c(x3), .O(new_n63_));
  nand4  g49(.a(x8), .b(x6), .c(new_n21_), .d(x2), .O(new_n64_));
  nand2  g50(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g51(.a(new_n65_), .b(new_n30_), .O(new_n66_));
  oai21  g52(.a(new_n37_), .b(x5), .c(new_n19_), .O(new_n67_));
  nand3  g53(.a(new_n67_), .b(new_n34_), .c(new_n15_), .O(new_n68_));
  nand3  g54(.a(new_n41_), .b(new_n37_), .c(x2), .O(new_n69_));
  aoi21  g55(.a(new_n69_), .b(new_n68_), .c(new_n17_), .O(new_n70_));
  nand2  g56(.a(new_n67_), .b(new_n32_), .O(new_n71_));
  nand2  g57(.a(x7), .b(new_n37_), .O(new_n72_));
  aoi21  g58(.a(new_n72_), .b(new_n71_), .c(new_n28_), .O(new_n73_));
  nor2   g59(.a(new_n25_), .b(new_n21_), .O(new_n74_));
  nor2   g60(.a(x8), .b(x3), .O(new_n75_));
  oai22  g61(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n70_), .O(new_n76_));
  nand4  g62(.a(new_n25_), .b(x7), .c(new_n28_), .d(x3), .O(new_n77_));
  nand2  g63(.a(new_n77_), .b(x6), .O(new_n78_));
  nand2  g64(.a(new_n78_), .b(x0), .O(new_n79_));
  oai21  g65(.a(new_n32_), .b(new_n37_), .c(x4), .O(new_n80_));
  nand2  g66(.a(new_n80_), .b(new_n17_), .O(new_n81_));
  nand3  g67(.a(x7), .b(x6), .c(new_n28_), .O(new_n82_));
  nand3  g68(.a(new_n25_), .b(new_n60_), .c(x3), .O(new_n83_));
  aoi22  g69(.a(new_n83_), .b(new_n22_), .c(new_n82_), .d(new_n81_), .O(new_n84_));
  aoi21  g70(.a(new_n26_), .b(new_n22_), .c(x2), .O(new_n85_));
  nand3  g71(.a(new_n25_), .b(x3), .c(new_n17_), .O(new_n86_));
  inv1   g72(.a(new_n86_), .O(new_n87_));
  oai21  g73(.a(new_n87_), .b(new_n85_), .c(new_n40_), .O(new_n88_));
  nand2  g74(.a(x4), .b(x1), .O(new_n89_));
  nand3  g75(.a(new_n89_), .b(x8), .c(new_n21_), .O(new_n90_));
  nand3  g76(.a(new_n25_), .b(new_n28_), .c(x3), .O(new_n91_));
  ...
  aoi21  g80(.a(new_n94_), .b(new_n37_), .c(new_n84_), .O(new_n95_));
  nand4  g81(.a(new_n95_), .b(new_n79_), .c(new_n76_), .d(new_n66_), .O(z2));
  inv1   g82(.a(new_n22_), .O(new_n97_));
  aoi21  g83(.a(x7), .b(new_n28_), .c(x2), .O(new_n98_));
  aoi21  g84(.a(new_n98_), .b(x1), .c(new_n29_), .O(new_n99_));
  oai21  g85(.a(new_n99_), .b(new_n97_), .c(new_n26_), .O(new_n100_));
  nand3  g86(.a(new_n100_), .b(new_n60_), .c(new_n19_), .O(new_n101_));
  nand3  g87(.a(new_n30_), .b(new_n26_), .c(new_n27_), .O(new_n102_));
  oai21  g88(.a(new_n33_), .b(x8), .c(new_n21_), .O(new_n103_));
  nand3  g89(.a(new_n103_), .b(new_n102_), .c(new_n56_), .O(new_n104_));
  nand2  g90(.a(new_n104_), .b(x0), .O(new_n105_));
  nand2  g91(.a(new_n105_), .b(new_n101_), .O(new_n106_));
  nand2  g92(.a(new_n106_), .b(x6), .O(new_n107_));
  nand3  g93(.a(new_n41_), .b(x2), .c(x1), .O(new_n108_));
  aoi21  g94(.a(new_n108_), .b(new_n40_), .c(new_n75_), .O(new_n109_));
  or2    g95(.a(new_n109_), .b(new_n74_), .O(new_n110_));
  nand3  g96(.a(new_n110_), .b(new_n37_), .c(new_n19_), .O(new_n111_));
  nand2  g97(.a(new_n111_), .b(new_n107_), .O(z3));
  nand3  g98(.a(new_n100_), .b(x6), .c(new_n19_), .O(new_n113_));
  nand3  g99(.a(new_n113_), .b(new_n38_), .c(new_n60_), .O(z4));
endmodule
