...
module FAU ( 
  ...
  nand2  g88(.a(x5), .b(x0), .O(new_n103_));
  nand2  g89(.a(new_n103_), .b(new_n87_), .O(new_n104_));
  nand2  g90(.a(new_n104_), .b(x6), .O(new_n105_));
  nand2  g91(.a(x2), .b(x1), .O(new_n106_));
  nand3  g92(.a(new_n106_), .b(new_n29_), .c(new_n22_), .O(new_n107_));
  oai21  g93(.a(new_n42_), .b(new_n27_), .c(new_n26_), .O(new_n108_));
  nand3  g94(.a(new_n27_), .b(new_n20_), .c(new_n19_), .O(new_n109_));
  nand3  g95(.a(new_n109_), .b(new_n108_), .c(new_n107_), .O(new_n110_));
  nand3  g96(.a(new_n110_), .b(x5), .c(x0), .O(new_n111_));
