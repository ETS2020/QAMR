...
module FAU ( 
  ...
  aoi21  g90(.a(new_n88_), .b(x6), .c(x5), .O(new_n105_));
  nand2  g91(.a(x2), .b(x1), .O(new_n106_));
  nand3  g92(.a(new_n106_), .b(new_n29_), .c(new_n22_), .O(new_n107_));
  oai21  g93(.a(new_n21_), .b(new_n25_), .c(new_n24_), .O(new_n108_));
  nand3  g94(.a(new_n25_), .b(new_n19_), .c(new_n18_), .O(new_n109_));
  nand4  g95(.a(new_n109_), .b(new_n108_), .c(new_n107_), .d(new_n16_), .O(new_n110_));
  nand2  g96(.a(new_n110_), .b(x5), .O(new_n111_));
  oai21  g97(.a(new_n105_), .b(x0), .c(new_n111_), .O(z4));
endmodule
