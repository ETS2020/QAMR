...
module FAU ( 
  ...
  oai21  g085(.a(new_n42_), .b(new_n19_), .c(new_n31_), .O(new_n100_));
  nand2  g086(.a(new_n70_), .b(new_n36_), .O(new_n101_));
  aoi21  g087(.a(new_n101_), .b(new_n38_), .c(x0), .O(new_n102_));
  nand3  g088(.a(new_n50_), .b(new_n38_), .c(new_n34_), .O(new_n103_));
  oai21  g089(.a(new_n33_), .b(new_n24_), .c(new_n20_), .O(new_n104_));
  nand3  g090(.a(new_n24_), .b(new_n46_), .c(new_n26_), .O(new_n105_));
  ...
  oai21  g094(.a(new_n108_), .b(new_n102_), .c(new_n42_), .O(new_n109_));
  ...
  nand3  g100(.a(new_n114_), .b(new_n109_), .c(new_n100_), .O(z3));
