...
module FAU ( 
  ...
  nand3  g132(.a(new_n136_), .b(x6), .c(new_n45_), .O(new_n147_));
  nand3  g133(.a(new_n125_), .b(new_n18_), .c(x5), .O(new_n148_));
  nand2  g134(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand2  g135(.a(new_n149_), .b(new_n44_), .O(new_n150_));
  nor2   g136(.a(new_n92_), .b(new_n90_), .O(new_n151_));
  nand3  g137(.a(new_n79_), .b(new_n16_), .c(x0), .O(new_n152_));
