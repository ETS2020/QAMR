...
module FAU ( 
  ...
  nand2  g089(.a(new_n73_), .b(new_n36_), .O(new_n104_));
  aoi21  g090(.a(new_n104_), .b(new_n38_), .c(x0), .O(new_n105_));
  nand3  g091(.a(new_n62_), .b(new_n38_), .c(new_n34_), .O(new_n106_));
  oai21  g092(.a(new_n33_), .b(new_n24_), .c(new_n20_), .O(new_n107_));
  ...
  oai21  g097(.a(new_n111_), .b(new_n105_), .c(new_n50_), .O(new_n112_));
  nand3  g098(.a(new_n43_), .b(new_n25_), .c(new_n17_), .O(new_n113_));
  nand2  g099(.a(new_n28_), .b(new_n24_), .O(new_n114_));
  aoi21  g100(.a(new_n114_), .b(new_n20_), .c(new_n67_), .O(new_n115_));
  nand2  g101(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand3  g102(.a(new_n116_), .b(x6), .c(x0), .O(new_n117_));
  nand3  g103(.a(new_n117_), .b(new_n112_), .c(new_n103_), .O(z3));
  aoi21  g104(.a(new_n109_), .b(x0), .c(x6), .O(new_n119_));
  oai21  g105(.a(new_n119_), .b(new_n31_), .c(x0), .O(z4));
endmodule
