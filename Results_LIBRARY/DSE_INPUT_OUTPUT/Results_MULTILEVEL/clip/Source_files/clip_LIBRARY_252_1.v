...
module FAU ( 
  ...
  oai21  g45(.a(new_n59_), .b(new_n17_), .c(new_n19_), .O(new_n60_));
  nand2  g46(.a(new_n25_), .b(new_n23_), .O(new_n61_));
  nand2  g47(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g48(.a(new_n62_), .b(new_n58_), .c(new_n39_), .O(new_n63_));
  nand2  g49(.a(new_n63_), .b(new_n16_), .O(new_n64_));
  aoi21  g50(.a(new_n36_), .b(x4), .c(new_n29_), .O(new_n65_));
  aoi21  g51(.a(x4), .b(x1), .c(new_n36_), .O(new_n66_));
  oai21  g52(.a(new_n66_), .b(new_n65_), .c(new_n55_), .O(new_n67_));
  nand3  g53(.a(new_n35_), .b(new_n29_), .c(x1), .O(new_n68_));
  ...
  nand3  g58(.a(new_n55_), .b(new_n34_), .c(new_n17_), .O(new_n73_));
  nand3  g59(.a(new_n73_), .b(new_n72_), .c(new_n64_), .O(z2));
  oai21  g60(.a(new_n57_), .b(new_n56_), .c(new_n25_), .O(new_n75_));
  oai21  g61(.a(x4), .b(x1), .c(x3), .O(new_n76_));
  aoi21  g62(.a(new_n76_), .b(new_n22_), .c(new_n15_), .O(new_n77_));
  aoi21  g63(.a(new_n77_), .b(new_n75_), .c(new_n31_), .O(new_n78_));
  nand2  g64(.a(new_n60_), .b(new_n23_), .O(new_n79_));
  aoi21  g65(.a(new_n79_), .b(new_n25_), .c(x0), .O(new_n80_));
  oai21  g66(.a(new_n80_), .b(new_n78_), .c(new_n16_), .O(new_n81_));
  oai21  g67(.a(new_n36_), .b(new_n16_), .c(x4), .O(new_n82_));
  nand2  g68(.a(new_n82_), .b(new_n17_), .O(new_n83_));
  oai21  g69(.a(new_n36_), .b(x4), .c(new_n22_), .O(new_n84_));
  oai21  g70(.a(new_n84_), .b(new_n65_), .c(x6), .O(new_n85_));
  aoi21  g71(.a(new_n85_), .b(new_n83_), .c(x3), .O(new_n86_));
  inv1   g72(.a(new_n35_), .O(new_n87_));
  aoi22  g73(.a(new_n36_), .b(x4), .c(new_n29_), .d(x1), .O(new_n88_));
  oai21  g74(.a(new_n88_), .b(new_n87_), .c(x8), .O(new_n89_));
  nor2   g75(.a(new_n89_), .b(new_n16_), .O(new_n90_));
  oai21  g76(.a(new_n90_), .b(new_n86_), .c(x0), .O(new_n91_));
  nand2  g77(.a(new_n91_), .b(new_n81_), .O(z3));
  nand2  g78(.a(x2), .b(x1), .O(new_n93_));
  nand3  g79(.a(new_n93_), .b(new_n25_), .c(new_n19_), .O(new_n94_));
  oai21  g80(.a(new_n18_), .b(new_n22_), .c(new_n21_), .O(new_n95_));
  nand3  g81(.a(new_n22_), .b(new_n36_), .c(new_n34_), .O(new_n96_));
  nand4  g82(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n16_), .O(new_n97_));
  nand2  g83(.a(new_n97_), .b(x0), .O(new_n98_));
  nand2  g84(.a(new_n16_), .b(new_n31_), .O(new_n99_));
